...
school_Student_m_validate: Method = Method(name="validate", parameters={Parameter(name='school_diagnostic', type=StringType), Parameter(name='school_context', type=StringType)}, type=BooleanType)
