...
# Classes
Families2Persons_MemberToPerson = Class(name="Families2Persons_MemberToPerson", is_abstract=True)
Families2Persons_Member = Class(name="Families2Persons_Member")
Families2Persons_Person = Class(name="Families2Persons_Person")
Families2Persons_Member2Male = Class(name="Families2Persons_Member2Male")
MemberToPerson = Class(name="MemberToPerson")
Families2Persons_Member2Female = Class(name="Families2Persons_Member2Female")
...
Families2Persons_MemberToPerson.attributes={Families2Persons_MemberToPerson_firstName, Families2Persons_MemberToPerson_familyName}
...
domain_model = DomainModel(
    ...
    types={Families2Persons_MemberToPerson, Families2Persons_Member, Families2Persons_Person, Families2Persons_Member2Male, MemberToPerson, Families2Persons_Member2Female},
