...
class uma_BreakdownElement(ProcessElement):
    ...
    def __init__(self, hasMultipleOccurrences: str, isOptional: str, prefix: str, isPlanned: str, uma_BreakdownElement115: set["uma_Concept"] = None, uma_BreakdownElement118: set["uma_Example"] = None, BreakdownElement: "uma_Activity" = None, uma_BreakdownElement121: set["uma_Guideline"] = None, uma_BreakdownElement124: set["uma_ReusableAsset"] = None, uma_BreakdownElement127: set["uma_SupportingMaterial"] = None, uma_BreakdownElement130: set["uma_Template"] = None, uma_BreakdownElement133: set["uma_Report"] = None, uma_BreakdownElement136: set["uma_EstimationConsiderations"] = None, uma_BreakdownElement139: set["uma_ToolMentor"] = None, uma_BreakdownElement: "uma_BreakdownElement" = None, uma_BreakdownElement103: "uma_BreakdownElement" = None, uma_BreakdownElement107: "uma_BreakdownElement" = None, uma_BreakdownElement105: "uma_BreakdownElement" = None, uma_BreakdownElement109: "uma_PlanningData" = None, breakdownElements: "uma_Activity" = None, uma_BreakdownElement112: set["uma_Checklist"] = None):
...
class uma_Activity(WorkBreakdownElement, FulfillableElement, WorkDefinition, VariabilityElement):
...
class uma_Point:
    ...
    def __init__(self, x: str, y: str, uma_Point278: "uma_GraphElement" = None, uma_Point: "uma_Diagram" = None, uma_Point292: "uma_DiagramLink" = None, uma_Point300: "uma_GraphEdge" = None, uma_Point317: "uma_Polyline" = None, uma_Point319: "uma_Ellipse" = None):
        self.x = x
        self.y = y
...
class uma_Diagram(GraphNode):
    ...
    def __init__(self, zoom: str, uma_Diagram: "uma_ProcessPackage" = None, diagram: set["uma_DiagramLink"] = None, diagram272: "uma_SemanticModelBridge" = None, uma_Diagram274: "uma_Point" = None, Diagram: "uma_DiagramLink" = None, Diagram304: "uma_SemanticModelBridge" = None):
        self.zoom = zoom
...
class uma_SemanticModelBridge(DiagramElement):
    ...
    def __init__(self, presentation: str, SemanticModelBridge: "uma_Diagram" = None, SemanticModelBridge285: "uma_GraphElement" = None, namespace: "uma_Diagram" = None, semanticModel: "uma_GraphElement" = None):
...
class uma_MethodPlugin(Package, MethodUnit):
    ...
    def __init__(self, supporting: bool, userChangeable: str, uma_MethodPlugin: "uma_MethodConfiguration" = None, uma_MethodPlugin246: set["uma_MethodPackage"] = None, uma_MethodPlugin250: "uma_MethodPlugin" = None, uma_MethodPlugin248: set["uma_MethodPlugin"] = None, uma_MethodPlugin323: "uma_MethodLibrary" = None):
...
class uma_WorkProductDescriptor(Descriptor):
    ...
    def __init__(self, activityEntryState: str, activityExitState: str, uma_WorkProductDescriptor182: "uma_RoleDescriptor" = None, uma_WorkProductDescriptor: "uma_Milestone" = None, uma_WorkProductDescriptor161: "uma_WorkProduct" = None, WorkProductDescriptor: "uma_WorkProductDescriptor" = None, impacts: set["uma_WorkProductDescriptor"] = None, WorkProductDescriptor167: "uma_WorkProductDescriptor" = None, impactedBy: set["uma_WorkProductDescriptor"] = None, uma_WorkProductDescriptor170: "uma_WorkProductDescriptor" = None, uma_WorkProductDescriptor168: set["uma_WorkProductDescriptor"] = None, uma_WorkProductDescriptor185: "uma_RoleDescriptor" = None, uma_WorkProductDescriptor196: "uma_TaskDescriptor" = None, uma_WorkProductDescriptor199: "uma_TaskDescriptor" = None, uma_WorkProductDescriptor202: "uma_TaskDescriptor" = None, uma_WorkProductDescriptor205: "uma_TaskDescriptor" = None, uma_WorkProductDescriptor312: "uma_ProcessComponentInterface" = None):
