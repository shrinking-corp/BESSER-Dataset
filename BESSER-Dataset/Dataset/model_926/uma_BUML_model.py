...
# Classes
uma_Package = Class(name="uma_Package")
Namespace = Class(name="Namespace")
uma_Namespace = Class(name="uma_Namespace", is_abstract=True)
uma_Constraint = Class(name="uma_Constraint")
MethodElement = Class(name="MethodElement")
uma_Classifier = Class(name="uma_Classifier", is_abstract=True)
Type = Class(name="Type")
uma_Type = Class(name="uma_Type", is_abstract=True)
PackageableElement = Class(name="PackageableElement")
uma_PackageableElement = Class(name="uma_PackageableElement", is_abstract=True)
NamedElement = Class(name="NamedElement")
uma_NamedElement = Class(name="uma_NamedElement", is_abstract=True)
Element = Class(name="Element")
uma_Element = Class(name="uma_Element", is_abstract=True)
ContentElement = Class(name="ContentElement")
uma_ApplicableMetaClassInfo = Class(name="uma_ApplicableMetaClassInfo")
uma_ContentElement = Class(name="uma_ContentElement", is_abstract=True)
DescribableElement = Class(name="DescribableElement")
VariabilityElement = Class(name="VariabilityElement")
uma_SupportingMaterial = Class(name="uma_SupportingMaterial")
uma_Concept = Class(name="uma_Concept")
uma_Checklist = Class(name="uma_Checklist")
uma_Guideline = Class(name="uma_Guideline")
uma_Example = Class(name="uma_Example")
uma_MethodElement = Class(name="uma_MethodElement", is_abstract=True)
uma_MethodElementProperty = Class(name="uma_MethodElementProperty")
uma_Kind = Class(name="uma_Kind")
Guidance = Class(name="Guidance")
uma_Guidance = Class(name="uma_Guidance", is_abstract=True)
uma_ReusableAsset = Class(name="uma_ReusableAsset")
uma_TermDefinition = Class(name="uma_TermDefinition")
uma_DescribableElement = Class(name="uma_DescribableElement", is_abstract=True)
Classifier = Class(name="Classifier")
uma_ContentDescription = Class(name="uma_ContentDescription")
MethodUnit = Class(name="MethodUnit")
uma_Section = Class(name="uma_Section")
uma_MethodUnit = Class(name="uma_MethodUnit", is_abstract=True)
uma_Artifact = Class(name="uma_Artifact")
WorkProduct = Class(name="WorkProduct")
uma_VariabilityElement = Class(name="uma_VariabilityElement", is_abstract=True)
uma_Deliverable = Class(name="uma_Deliverable")
uma_Outcome = Class(name="uma_Outcome")
uma_WorkProduct = Class(name="uma_WorkProduct")
FulfillableElement = Class(name="FulfillableElement")
uma_Report = Class(name="uma_Report")
uma_Template = Class(name="uma_Template")
uma_ToolMentor = Class(name="uma_ToolMentor")
uma_EstimationConsiderations = Class(name="uma_EstimationConsiderations")
uma_FulfillableElement = Class(name="uma_FulfillableElement")
uma_ArtifactDescription = Class(name="uma_ArtifactDescription")
WorkProductDescription = Class(name="WorkProductDescription")
uma_Step = Class(name="uma_Step")
Section = Class(name="Section")
WorkDefinition = Class(name="WorkDefinition")
uma_WorkDefinition = Class(name="uma_WorkDefinition", is_abstract=True)
uma_Whitepaper = Class(name="uma_Whitepaper")
Concept = Class(name="Concept")
uma_Task = Class(name="uma_Task")
uma_Role = Class(name="uma_Role")
uma_GuidanceDescription = Class(name="uma_GuidanceDescription")
uma_PracticeDescription = Class(name="uma_PracticeDescription")
uma_WorkProductDescription = Class(name="uma_WorkProductDescription")
ContentDescription = Class(name="ContentDescription")
uma_DeliverableDescription = Class(name="uma_DeliverableDescription")
uma_RoleDescription = Class(name="uma_RoleDescription")
uma_TaskDescription = Class(name="uma_TaskDescription")
uma_Discipline = Class(name="uma_Discipline")
uma_Activity = Class(name="uma_Activity")
uma_RoleSet = Class(name="uma_RoleSet")
ContentCategory = Class(name="ContentCategory")
uma_ContentCategory = Class(name="uma_ContentCategory", is_abstract=True)
uma_Domain = Class(name="uma_Domain")
uma_WorkProductType = Class(name="uma_WorkProductType")
uma_DisciplineGrouping = Class(name="uma_DisciplineGrouping")
uma_PlanningData = Class(name="uma_PlanningData")
WorkBreakdownElement = Class(name="WorkBreakdownElement")
uma_BreakdownElement = Class(name="uma_BreakdownElement", is_abstract=True)
uma_Roadmap = Class(name="uma_Roadmap")
uma_WorkBreakdownElement = Class(name="uma_WorkBreakdownElement", is_abstract=True)
BreakdownElement = Class(name="BreakdownElement")
uma_WorkOrder = Class(name="uma_WorkOrder")
ProcessElement = Class(name="ProcessElement")
uma_ProcessElement = Class(name="uma_ProcessElement", is_abstract=True)
uma_MethodPackage = Class(name="uma_MethodPackage", is_abstract=True)
Package = Class(name="Package")
uma_ContentPackage = Class(name="uma_ContentPackage")
MethodPackage = Class(name="MethodPackage")
uma_Milestone = Class(name="uma_Milestone")
uma_Tool = Class(name="uma_Tool")
uma_RoleSetGrouping = Class(name="uma_RoleSetGrouping")
uma_CustomCategory = Class(name="uma_CustomCategory")
uma_Iteration = Class(name="uma_Iteration")
Activity = Class(name="Activity")
uma_Phase = Class(name="uma_Phase")
uma_TeamProfile = Class(name="uma_TeamProfile")
uma_RoleDescriptor = Class(name="uma_RoleDescriptor")
uma_WorkProductDescriptor = Class(name="uma_WorkProductDescriptor")
Descriptor = Class(name="Descriptor")
uma_Descriptor = Class(name="uma_Descriptor", is_abstract=True)
uma_CompositeRole = Class(name="uma_CompositeRole")
RoleDescriptor = Class(name="RoleDescriptor")
uma_DeliveryProcess = Class(name="uma_DeliveryProcess")
Process = Class(name="Process")
uma_Process = Class(name="uma_Process", is_abstract=True)
uma_TaskDescriptor = Class(name="uma_TaskDescriptor")
uma_ProcessPlanningTemplate = Class(name="uma_ProcessPlanningTemplate")
uma_Practice = Class(name="uma_Practice")
uma_CapabilityPattern = Class(name="uma_CapabilityPattern")
uma_MethodConfiguration = Class(name="uma_MethodConfiguration")
uma_MethodPlugin = Class(name="uma_MethodPlugin")
uma_ProcessDescription = Class(name="uma_ProcessDescription")
ActivityDescription = Class(name="ActivityDescription")
uma_DescriptorDescription = Class(name="uma_DescriptorDescription")
uma_ProcessComponentDescriptor = Class(name="uma_ProcessComponentDescriptor")
uma_ProcessComponent = Class(name="uma_ProcessComponent")
uma_BreakdownElementDescription = Class(name="uma_BreakdownElementDescription")
uma_ActivityDescription = Class(name="uma_ActivityDescription")
BreakdownElementDescription = Class(name="BreakdownElementDescription")
uma_DeliveryProcessDescription = Class(name="uma_DeliveryProcessDescription")
ProcessDescription = Class(name="ProcessDescription")
uma_Dimension = Class(name="uma_Dimension")
uma_GraphElement = Class(name="uma_GraphElement", is_abstract=True)
DiagramElement = Class(name="DiagramElement")
uma_DiagramElement = Class(name="uma_DiagramElement", is_abstract=True)
uma_GraphConnector = Class(name="uma_GraphConnector")
ProcessPackage = Class(name="ProcessPackage")
uma_ProcessComponentInterface = Class(name="uma_ProcessComponentInterface")
uma_ProcessPackage = Class(name="uma_ProcessPackage")
uma_Diagram = Class(name="uma_Diagram")
GraphNode = Class(name="GraphNode")
uma_DiagramLink = Class(name="uma_DiagramLink")
uma_SemanticModelBridge = Class(name="uma_SemanticModelBridge", is_abstract=True)
uma_Point = Class(name="uma_Point")
uma_GraphNode = Class(name="uma_GraphNode")
GraphElement = Class(name="GraphElement")
uma_GraphEdge = Class(name="uma_GraphEdge")
uma_Reference = Class(name="uma_Reference")
uma_Property = Class(name="uma_Property")
uma_SimpleSemanticModelElement = Class(name="uma_SimpleSemanticModelElement")
SemanticModelBridge = Class(name="SemanticModelBridge")
uma_UMASemanticModelBridge = Class(name="uma_UMASemanticModelBridge")
uma_CoreSemanticModelBridge = Class(name="uma_CoreSemanticModelBridge")
uma_LeafElement = Class(name="uma_LeafElement", is_abstract=True)
uma_TextElement = Class(name="uma_TextElement")
LeafElement = Class(name="LeafElement")
uma_Image = Class(name="uma_Image")
uma_GraphicPrimitive = Class(name="uma_GraphicPrimitive", is_abstract=True)
uma_Polyline = Class(name="uma_Polyline")
GraphicPrimitive = Class(name="GraphicPrimitive")
uma_Ellipse = Class(name="uma_Ellipse")
uma_ProcessFamily = Class(name="uma_ProcessFamily")
MethodConfiguration = Class(name="MethodConfiguration")
uma_MethodLibrary = Class(name="uma_MethodLibrary")
...
uma_MethodElement.attributes={uma_MethodElement_guid, uma_MethodElement_suppressed, uma_MethodElement_orderingGuide, uma_MethodElement_presentationName, uma_MethodElement_briefDescription}
...
uma_ContentDescription.attributes={uma_ContentDescription_mainDescription, uma_ContentDescription_longPresentationName, uma_ContentDescription_keyConsiderations, uma_ContentDescription_externalId}
...
uma_ArtifactDescription.attributes={uma_ArtifactDescription_representation, uma_ArtifactDescription_briefOutline, uma_ArtifactDescription_notation, uma_ArtifactDescription_representationOptions}
...
uma_PracticeDescription.attributes={uma_PracticeDescription_goals, uma_PracticeDescription_levelsOfAdoption, uma_PracticeDescription_problem, uma_PracticeDescription_background, uma_PracticeDescription_additionalInfo, uma_PracticeDescription_application}
...
uma_BreakdownElement.attributes={uma_BreakdownElement_prefix, uma_BreakdownElement_isPlanned, uma_BreakdownElement_isOptional, uma_BreakdownElement_hasMultipleOccurrences}
...
uma_MethodPackage_global_: Property = Property(name="global_", type=StringType)
uma_MethodPackage.attributes={uma_MethodPackage_global_}
...
uma_Ellipse.attributes={uma_Ellipse_startAngle, uma_Ellipse_rotation, uma_Ellipse_radiusX, uma_Ellipse_endAngle, uma_Ellipse_radiusY}
...
domain_model = DomainModel(
    name="uma",
    types={uma_Package, Namespace, uma_Namespace, uma_Constraint, MethodElement, uma_Classifier, Type, uma_Type, PackageableElement, uma_PackageableElement, NamedElement, uma_NamedElement, Element, uma_Element, ContentElement, uma_ApplicableMetaClassInfo, uma_ContentElement, DescribableElement, VariabilityElement, uma_SupportingMaterial, uma_Concept, uma_Checklist, uma_Guideline, uma_Example, uma_MethodElement, uma_MethodElementProperty, uma_Kind, Guidance, uma_Guidance, uma_ReusableAsset, uma_TermDefinition, uma_DescribableElement, Classifier, uma_ContentDescription, MethodUnit, uma_Section, uma_MethodUnit, uma_Artifact, WorkProduct, uma_VariabilityElement, uma_Deliverable, uma_Outcome, uma_WorkProduct, FulfillableElement, uma_Report, uma_Template, uma_ToolMentor, uma_EstimationConsiderations, uma_FulfillableElement, uma_ArtifactDescription, WorkProductDescription, uma_Step, Section, WorkDefinition, uma_WorkDefinition, uma_Whitepaper, Concept, uma_Task, uma_Role, uma_GuidanceDescription, uma_PracticeDescription, uma_WorkProductDescription, ContentDescription, uma_DeliverableDescription, uma_RoleDescription, uma_TaskDescription, uma_Discipline, uma_Activity, uma_RoleSet, ContentCategory, uma_ContentCategory, uma_Domain, uma_WorkProductType, uma_DisciplineGrouping, uma_PlanningData, WorkBreakdownElement, uma_BreakdownElement, uma_Roadmap, uma_WorkBreakdownElement, BreakdownElement, uma_WorkOrder, ProcessElement, uma_ProcessElement, uma_MethodPackage, Package, uma_ContentPackage, MethodPackage, uma_Milestone, uma_Tool, uma_RoleSetGrouping, uma_CustomCategory, uma_Iteration, Activity, uma_Phase, uma_TeamProfile, uma_RoleDescriptor, uma_WorkProductDescriptor, Descriptor, uma_Descriptor, uma_CompositeRole, RoleDescriptor, uma_DeliveryProcess, Process, uma_Process, uma_TaskDescriptor, uma_ProcessPlanningTemplate, uma_Practice, uma_CapabilityPattern, uma_MethodConfiguration, uma_MethodPlugin, uma_ProcessDescription, ActivityDescription, uma_DescriptorDescription, uma_ProcessComponentDescriptor, uma_ProcessComponent, uma_BreakdownElementDescription, uma_ActivityDescription, BreakdownElementDescription, uma_DeliveryProcessDescription, ProcessDescription, uma_Dimension, uma_GraphElement, DiagramElement, uma_DiagramElement, uma_GraphConnector, ProcessPackage, uma_ProcessComponentInterface, uma_ProcessPackage, uma_Diagram, GraphNode, uma_DiagramLink, uma_SemanticModelBridge, uma_Point, uma_GraphNode, GraphElement, uma_GraphEdge, uma_Reference, uma_Property, uma_SimpleSemanticModelElement, SemanticModelBridge, uma_UMASemanticModelBridge, uma_CoreSemanticModelBridge, uma_LeafElement, uma_TextElement, LeafElement, uma_Image, uma_GraphicPrimitive, uma_Polyline, GraphicPrimitive, uma_Ellipse, uma_ProcessFamily, MethodConfiguration, uma_MethodLibrary, VariabilityType, WorkOrderType},
    associations={applicableMetaClassInfo5, supportingMaterials7, conceptsAndPapers8, checklists10, guidelines12, examples14, ownedRules0, methodElementProperty1, kind3, copyrightStatement23, assets16, termdefinition18, presentation20, sections21, subSections26, predecessor29, variabilityBasedOnElement32, deliveredWorkProducts47, containerArtifact34, containedArtifacts36, reports38, templates39, toolMentors41, estimationConsiderations43, estimationConsiderations72, fulfills46, modifies75, responsibleFor78, precondition49, postcondition51, performedBy54, mandatoryInput55, output58, additionallyPerformedBy61, optionalInput64, steps67, toolMentors69, disciplines90, tasks91, subdiscipline95, referenceWorkflows97, roles81, workProducts83, subdomains86, workProducts88, presentedAfter104, presentedBefore106, planningData108, superActivities110, checklists111, concepts114, examples117, breakdownElements99, roadmaps100, linkToPredecessor102, guidelines120, reusableAssets123, supportingMaterials126, templates129, reports132, estimationconsiderations135, toolmentor138, reusedPackages153, childPackages155, contentElements157, pred141, toolMentors144, roleSets146, categorizedElements148, subCategories150, teamRoles171, superTeam173, subTeam175, Role177, modifies180, requiredResults159, WorkProduct160, impactedBy164, impacts166, deliverableParts169, selectedSteps209, aggregatedRoles212, educationMaterials214, communicationsMaterials216, responsibleFor183, Task186, additionallyPerformedBy188, assistedBy191, externalInput194, mandatoryInput197, optionalInput200, output203, performedPrimarilyBy206, methodPackages245, bases249, basedOnProcesses251, subPractices254, contentReferences255, activityReferences258, includesPatterns219, defaultContext220, validContext222, methodPluginSelection225, methodPackageSelection227, processViews230, defaultView233, baseConfigurations237, subtractedCategory239, addedCategory242, _processComponent261, size275, contained276, position277, link279, anchorage281, interfaces262, process264, processElements267, diagrams268, diagramLink270, namespace271, viewpoint273, graphElement294, graphEdge296, graphElement297, semanticModel283, container286, reference287, property288, referenced289, viewport291, diagram293, element313, element315, waypoints299, anchor301, diagram303, graphElement305, interfaceSpecifications307, interfaceIO310, waypoints316, center318, deliveryProcesses320, methodPlugins322, predefinedConfigurations324},
    generalizations={gen_uma_Package_Namespace, gen_uma_Package_PackageableElement, gen_uma_Namespace_NamedElement, gen_uma_Constraint_MethodElement, gen_uma_Classifier_Type, gen_uma_Type_PackageableElement, gen_uma_PackageableElement_NamedElement, gen_uma_NamedElement_Element, gen_uma_Kind_ContentElement, gen_uma_ContentElement_DescribableElement, gen_uma_ContentElement_VariabilityElement, gen_uma_MethodElement_PackageableElement, gen_uma_MethodElementProperty_PackageableElement, gen_uma_SupportingMaterial_Guidance, gen_uma_Guidance_ContentElement, gen_uma_DescribableElement_MethodElement, gen_uma_DescribableElement_Classifier, gen_uma_ContentDescription_MethodUnit, gen_uma_MethodUnit_MethodElement, gen_uma_Concept_Guidance, gen_uma_Checklist_Guidance, gen_uma_Guideline_Guidance, gen_uma_Example_Guidance, gen_uma_ReusableAsset_Guidance, gen_uma_TermDefinition_Guidance, gen_uma_ApplicableMetaClassInfo_Classifier, gen_uma_Section_VariabilityElement, gen_uma_Artifact_WorkProduct, gen_uma_VariabilityElement_MethodElement, gen_uma_Template_Guidance, gen_uma_ToolMentor_Guidance, gen_uma_EstimationConsiderations_Guidance, gen_uma_Deliverable_WorkProduct, gen_uma_Outcome_WorkProduct, gen_uma_WorkProduct_ContentElement, gen_uma_WorkProduct_FulfillableElement, gen_uma_FulfillableElement_DescribableElement, gen_uma_Role_ContentElement, gen_uma_Role_FulfillableElement, gen_uma_Report_Guidance, gen_uma_ArtifactDescription_WorkProductDescription, gen_uma_Step_Section, gen_uma_Step_WorkDefinition, gen_uma_WorkDefinition_MethodElement, gen_uma_Whitepaper_Concept, gen_uma_Task_ContentElement, gen_uma_Task_WorkDefinition, gen_uma_GuidanceDescription_ContentDescription, gen_uma_PracticeDescription_ContentDescription, gen_uma_WorkProductDescription_ContentDescription, gen_uma_DeliverableDescription_WorkProductDescription, gen_uma_RoleDescription_ContentDescription, gen_uma_TaskDescription_ContentDescription, gen_uma_Discipline_ContentCategory, gen_uma_RoleSet_ContentCategory, gen_uma_ContentCategory_ContentElement, gen_uma_Domain_ContentCategory, gen_uma_WorkProductType_ContentCategory, gen_uma_DisciplineGrouping_ContentCategory, gen_uma_Activity_WorkBreakdownElement, gen_uma_Activity_FulfillableElement, gen_uma_Activity_VariabilityElement, gen_uma_Activity_WorkDefinition, gen_uma_WorkBreakdownElement_BreakdownElement, gen_uma_BreakdownElement_ProcessElement, gen_uma_ProcessElement_DescribableElement, gen_uma_PlanningData_ProcessElement, gen_uma_MethodPackage_MethodElement, gen_uma_MethodPackage_Package, gen_uma_ContentPackage_MethodPackage, gen_uma_WorkOrder_ProcessElement, gen_uma_Milestone_WorkBreakdownElement, gen_uma_Roadmap_Guidance, gen_uma_Tool_ContentCategory, gen_uma_RoleSetGrouping_ContentCategory, gen_uma_CustomCategory_ContentCategory, gen_uma_Iteration_Activity, gen_uma_Phase_Activity, gen_uma_TeamProfile_BreakdownElement, gen_uma_RoleDescriptor_Descriptor, gen_uma_WorkProductDescriptor_Descriptor, gen_uma_Descriptor_BreakdownElement, gen_uma_CompositeRole_RoleDescriptor, gen_uma_DeliveryProcess_Process, gen_uma_Process_Activity, gen_uma_TaskDescriptor_WorkBreakdownElement, gen_uma_TaskDescriptor_Descriptor, gen_uma_ProcessPlanningTemplate_Process, gen_uma_Practice_Guidance, gen_uma_CapabilityPattern_Process, gen_uma_MethodConfiguration_MethodUnit, gen_uma_MethodPlugin_MethodUnit, gen_uma_MethodPlugin_Package, gen_uma_ProcessDescription_ActivityDescription, gen_uma_DescriptorDescription_BreakdownElementDescription, gen_uma_ProcessComponentDescriptor_Descriptor, gen_uma_BreakdownElementDescription_ContentDescription, gen_uma_ActivityDescription_BreakdownElementDescription, gen_uma_DeliveryProcessDescription_ProcessDescription, gen_uma_GraphElement_DiagramElement, gen_uma_ProcessComponent_ProcessPackage, gen_uma_ProcessComponent_MethodUnit, gen_uma_ProcessPackage_MethodPackage, gen_uma_Diagram_GraphNode, gen_uma_GraphNode_GraphElement, gen_uma_GraphConnector_GraphElement, gen_uma_GraphEdge_GraphElement, gen_uma_DiagramElement_MethodElement, gen_uma_Reference_DiagramElement, gen_uma_Property_DiagramElement, gen_uma_DiagramLink_DiagramElement, gen_uma_SimpleSemanticModelElement_SemanticModelBridge, gen_uma_UMASemanticModelBridge_SemanticModelBridge, gen_uma_CoreSemanticModelBridge_SemanticModelBridge, gen_uma_LeafElement_DiagramElement, gen_uma_TextElement_LeafElement, gen_uma_SemanticModelBridge_DiagramElement, gen_uma_ProcessComponentInterface_BreakdownElement, gen_uma_Image_LeafElement, gen_uma_GraphicPrimitive_LeafElement, gen_uma_Polyline_GraphicPrimitive, gen_uma_Ellipse_GraphicPrimitive, gen_uma_ProcessFamily_MethodConfiguration, gen_uma_MethodLibrary_MethodUnit, gen_uma_MethodLibrary_Package},
    metadata=None
)
