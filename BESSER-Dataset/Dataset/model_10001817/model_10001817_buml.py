...
domain_model = DomainModel(
    name="_XrCsoHwxEeqXrfTaScKTQA",
    types={Boolean_external, Parking_Structure, Parking_Space, Vehicle_Interface, Car, Truck, Motorbike, Electric, Convertible, Parking_Level, Class_, Regular_Space, Handicapped_Space, Parking_Space_Type, Enumeration_, Enumeration2, Structure_Type},
