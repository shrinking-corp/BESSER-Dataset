...
def test_hyp_keywords_is_not_abstract():
    assert not inspect.isabstract(Keywords)


def test_hyp_keywords_constructor_exists():
    assert callable(Keywords.__init__)


def test_hyp_keywords_constructor_args():
...
def test_hyp_latex_citation_is_not_abstract():
    assert not inspect.isabstract(LaTeX_Citation)


def test_hyp_latex_citation_constructor_exists():
    assert callable(LaTeX_Citation.__init__)


def test_hyp_latex_citation_constructor_args():
    sig = inspect.signature(LaTeX_Citation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_latex_documentbody_is_not_abstract():
    assert not inspect.isabstract(LaTeX_DocumentBody)


def test_hyp_latex_documentbody_constructor_exists():
    assert callable(LaTeX_DocumentBody.__init__)


def test_hyp_latex_documentbody_constructor_args():
    sig = inspect.signature(LaTeX_DocumentBody.__init__)
    params = list(sig.parameters.keys())



def test_hyp_documentbody_is_not_abstract():
    assert not inspect.isabstract(DocumentBody)


def test_hyp_documentbody_constructor_exists():
    assert callable(DocumentBody.__init__)


def test_hyp_documentbody_constructor_args():
    sig = inspect.signature(DocumentBody.__init__)
    params = list(sig.parameters.keys())



def test_hyp_citation_is_not_abstract():
    assert not inspect.isabstract(Citation)


def test_hyp_citation_constructor_exists():
    assert callable(Citation.__init__)


def test_hyp_citation_constructor_args():
...
def test_hyp_bibliography_is_not_abstract():
    assert not inspect.isabstract(Bibliography)


def test_hyp_bibliography_constructor_exists():
    assert callable(Bibliography.__init__)


def test_hyp_bibliography_constructor_args():
...
def test_hyp_enumerate_is_not_abstract():
    assert not inspect.isabstract(Enumerate)


def test_hyp_enumerate_constructor_exists():
    assert callable(Enumerate.__init__)


def test_hyp_enumerate_constructor_args():
...
def test_hyp_sectionbody_is_not_abstract():
    assert not inspect.isabstract(SectionBody)


def test_hyp_sectionbody_constructor_exists():
    assert callable(SectionBody.__init__)


def test_hyp_sectionbody_constructor_args():
    sig = inspect.signature(SectionBody.__init__)
    params = list(sig.parameters.keys())



def test_hyp_latex_corps_is_not_abstract():
    assert not inspect.isabstract(LaTeX_Corps)


def test_hyp_latex_corps_constructor_exists():
    assert callable(LaTeX_Corps.__init__)


def test_hyp_latex_corps_constructor_args():
...
def test_hyp_corps_is_not_abstract():
    assert not inspect.isabstract(Corps)


def test_hyp_corps_constructor_exists():
    assert callable(Corps.__init__)


def test_hyp_corps_constructor_args():
...
def test_hyp_latex_items_is_not_abstract():
    assert not inspect.isabstract(LaTeX_Items)


def test_hyp_latex_items_constructor_exists():
    assert callable(LaTeX_Items.__init__)


def test_hyp_latex_items_constructor_args():
    sig = inspect.signature(LaTeX_Items.__init__)
    params = list(sig.parameters.keys())



def test_hyp_latex_figure_is_not_abstract():
    assert not inspect.isabstract(LaTeX_Figure)


def test_hyp_latex_figure_constructor_exists():
    assert callable(LaTeX_Figure.__init__)


def test_hyp_latex_figure_constructor_args():
    sig = inspect.signature(LaTeX_Figure.__init__)
    params = list(sig.parameters.keys())



def test_hyp_latex_sectionbody_is_not_abstract():
    assert not inspect.isabstract(LaTeX_SectionBody)


def test_hyp_latex_sectionbody_constructor_exists():
    assert callable(LaTeX_SectionBody.__init__)


def test_hyp_latex_sectionbody_constructor_args():
...
def test_hyp_adress_is_not_abstract():
    assert not inspect.isabstract(Adress)


def test_hyp_adress_constructor_exists():
    assert callable(Adress.__init__)


def test_hyp_adress_constructor_args():
...
def test_hyp_fax_is_not_abstract():
    assert not inspect.isabstract(Fax)


def test_hyp_fax_constructor_exists():
    assert callable(Fax.__init__)


def test_hyp_fax_constructor_args():
    sig = inspect.signature(Fax.__init__)
    params = list(sig.parameters.keys())



def test_hyp_phone_is_not_abstract():
    assert not inspect.isabstract(Phone)


def test_hyp_phone_constructor_exists():
    assert callable(Phone.__init__)


def test_hyp_phone_constructor_args():
    sig = inspect.signature(Phone.__init__)
    params = list(sig.parameters.keys())



def test_hyp_latex_heading_is_not_abstract():
    assert not inspect.isabstract(LaTeX_Heading)


def test_hyp_latex_heading_constructor_exists():
    assert callable(LaTeX_Heading.__init__)


def test_hyp_latex_heading_constructor_args():
    sig = inspect.signature(LaTeX_Heading.__init__)
    params = list(sig.parameters.keys())



def test_hyp_organisation_is_not_abstract():
    assert not inspect.isabstract(Organisation)


def test_hyp_organisation_constructor_exists():
    assert callable(Organisation.__init__)


def test_hyp_organisation_constructor_args():
...
def test_hyp_latex_organisation_is_not_abstract():
    assert not inspect.isabstract(LaTeX_Organisation)


def test_hyp_latex_organisation_constructor_exists():
    assert callable(LaTeX_Organisation.__init__)


def test_hyp_latex_organisation_constructor_args():
...
def test_hyp_latex_author_is_not_abstract():
    assert not inspect.isabstract(LaTeX_Author)


def test_hyp_latex_author_constructor_exists():
    assert callable(LaTeX_Author.__init__)


def test_hyp_latex_author_constructor_args():
...
def test_hyp_latex_path_is_not_abstract():
    assert not inspect.isabstract(LaTeX_Path)


def test_hyp_latex_path_constructor_exists():
    assert callable(LaTeX_Path.__init__)


def test_hyp_latex_path_constructor_args():
    sig = inspect.signature(LaTeX_Path.__init__)
    params = list(sig.parameters.keys())



def test_hyp_latex_adress_is_not_abstract():
    assert not inspect.isabstract(LaTeX_Adress)


def test_hyp_latex_adress_constructor_exists():
    assert callable(LaTeX_Adress.__init__)


def test_hyp_latex_adress_constructor_args():
    sig = inspect.signature(LaTeX_Adress.__init__)
    params = list(sig.parameters.keys())



def test_hyp_latex_email_is_not_abstract():
    assert not inspect.isabstract(LaTeX_EMail)


def test_hyp_latex_email_constructor_exists():
    assert callable(LaTeX_EMail.__init__)


def test_hyp_latex_email_constructor_args():
    sig = inspect.signature(LaTeX_EMail.__init__)
    params = list(sig.parameters.keys())



def test_hyp_latex_item_is_not_abstract():
    assert not inspect.isabstract(LaTeX_Item)


def test_hyp_latex_item_constructor_exists():
    assert callable(LaTeX_Item.__init__)


def test_hyp_latex_item_constructor_args():
    sig = inspect.signature(LaTeX_Item.__init__)
    params = list(sig.parameters.keys())



def test_hyp_latex_value_is_not_abstract():
    assert not inspect.isabstract(LaTeX_Value)


def test_hyp_latex_value_constructor_exists():
    assert callable(LaTeX_Value.__init__)


def test_hyp_latex_value_constructor_args():
    sig = inspect.signature(LaTeX_Value.__init__)
    params = list(sig.parameters.keys())



def test_hyp_latex_fax_is_not_abstract():
    assert not inspect.isabstract(LaTeX_Fax)


def test_hyp_latex_fax_constructor_exists():
    assert callable(LaTeX_Fax.__init__)


def test_hyp_latex_fax_constructor_args():
    sig = inspect.signature(LaTeX_Fax.__init__)
    params = list(sig.parameters.keys())



def test_hyp_latex_phone_is_not_abstract():
    assert not inspect.isabstract(LaTeX_Phone)


def test_hyp_latex_phone_constructor_exists():
    assert callable(LaTeX_Phone.__init__)


def test_hyp_latex_phone_constructor_args():
...
def test_hyp_latex_abstract_is_not_abstract():
    assert not inspect.isabstract(LaTeX_Abstract)


def test_hyp_latex_abstract_constructor_exists():
    assert callable(LaTeX_Abstract.__init__)


def test_hyp_latex_abstract_constructor_args():
    sig = inspect.signature(LaTeX_Abstract.__init__)
    params = list(sig.parameters.keys())



def test_hyp_latex_keywords_is_not_abstract():
    assert not inspect.isabstract(LaTeX_Keywords)


def test_hyp_latex_keywords_constructor_exists():
    assert callable(LaTeX_Keywords.__init__)


def test_hyp_latex_keywords_constructor_args():
    sig = inspect.signature(LaTeX_Keywords.__init__)
    params = list(sig.parameters.keys())



def test_hyp_latex_date_is_not_abstract():
    assert not inspect.isabstract(LaTeX_Date)


def test_hyp_latex_date_constructor_exists():
    assert callable(LaTeX_Date.__init__)


def test_hyp_latex_date_constructor_args():
    sig = inspect.signature(LaTeX_Date.__init__)
    params = list(sig.parameters.keys())



def test_hyp_latex_label_is_not_abstract():
    assert not inspect.isabstract(LaTeX_Label)


def test_hyp_latex_label_constructor_exists():
    assert callable(LaTeX_Label.__init__)


def test_hyp_latex_label_constructor_args():
    sig = inspect.signature(LaTeX_Label.__init__)
    params = list(sig.parameters.keys())



def test_hyp_latex_name_is_not_abstract():
    assert not inspect.isabstract(LaTeX_Name)


def test_hyp_latex_name_constructor_exists():
    assert callable(LaTeX_Name.__init__)


def test_hyp_latex_name_constructor_args():
    sig = inspect.signature(LaTeX_Name.__init__)
    params = list(sig.parameters.keys())



def test_hyp_latex_description_is_not_abstract():
    assert not inspect.isabstract(LaTeX_Description)


def test_hyp_latex_description_constructor_exists():
    assert callable(LaTeX_Description.__init__)


def test_hyp_latex_description_constructor_args():
    sig = inspect.signature(LaTeX_Description.__init__)
    params = list(sig.parameters.keys())



def test_hyp_latex_cite_is_not_abstract():
    assert not inspect.isabstract(LaTeX_Cite)


def test_hyp_latex_cite_constructor_exists():
    assert callable(LaTeX_Cite.__init__)


def test_hyp_latex_cite_constructor_args():
    sig = inspect.signature(LaTeX_Cite.__init__)
    params = list(sig.parameters.keys())



def test_hyp_latex_type_is_not_abstract():
    assert not inspect.isabstract(LaTeX_Type)


def test_hyp_latex_type_constructor_exists():
    assert callable(LaTeX_Type.__init__)


def test_hyp_latex_type_constructor_args():
    sig = inspect.signature(LaTeX_Type.__init__)
    params = list(sig.parameters.keys())



def test_hyp_latex_valuedelement_is_not_abstract():
    assert not inspect.isabstract(LaTeX_ValuedElement)


def test_hyp_latex_valuedelement_constructor_exists():
    assert callable(LaTeX_ValuedElement.__init__)


def test_hyp_latex_valuedelement_constructor_args():
...
def test_hyp_latex_valuedelement_value_setter(instance):
