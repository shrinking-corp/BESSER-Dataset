...
sgen_Property = Class(name="sgen_Property")
...
sgen_Expression = Class(name="sgen_Expression")
...
sgen_FeatureParameterValue_m_setValue: Method = Method(name="setValue", parameters={Parameter(name='sgen_value', type=StringType)})
sgen_FeatureParameterValue_m_getIntegerValue: Method = Method(name="getIntegerValue", parameters={}, type=IntegerType)
sgen_FeatureParameterValue.methods={sgen_FeatureParameterValue_m_getIntegerValue, sgen_FeatureParameterValue_m_setValue, sgen_FeatureParameterValue_m_setValue, sgen_FeatureParameterValue_m_setValue, sgen_FeatureParameterValue_m_getBooleanValue, sgen_FeatureParameterValue_m_getStringValue}
...
domain_model = DomainModel(
    name="sgen",
    types={sgen_FeatureParameterValue, sgen_EObject, sgen_GeneratorModel, sgen_GeneratorEntry, sgen_Property, sgen_GeneratorConfiguration, sgen_FeatureConfiguration, sgen_FeatureType, NamedElement, DeprecatableElement, sgen_FeatureParameter, sgen_FeatureTypeLibrary, sgen_Expression, sgen_DeprecatableElement, ParameterTypes},
    associations={parameterValues10, elementRef11, features13, entries0, properties1, configurations3, parameters4, library5, featureType6, type7, parameter16, featureConfiguration17, expression18, types20},
    generalizations={gen_sgen_FeatureType_NamedElement, gen_sgen_FeatureType_DeprecatableElement, gen_sgen_FeatureParameter_NamedElement, gen_sgen_FeatureParameter_DeprecatableElement},
    metadata=None
)
