...
class model_ArchimateConcept(Properties, ArchimateModelObject, Documentable, Cloneable):
    ...
    pass
class model_Folder(Documentable, Properties, ArchimateModelObject, FolderContainer):
...
class model_DiagramModelObject(LineObject, TextAlignment, Connectable, FontAttribute):
    ...
    def setBounds(self, model_x, model_y, model_width, model_height):
...
class DiagramModelContainer:
    ...
    pass
class model_DiagramModelArchimateObject(TextPosition, DiagramModelContainer, DiagramModelObject, DiagramModelArchimateComponent):
...
class TextContent:
    ...
    pass
class model_SketchModelSticky(TextPosition, DiagramModelObject, Properties, TextContent, DiagramModelContainer):
...
class model_DiagramModelGroup(Properties, Documentable, DiagramModelContainer, DiagramModelObject):
...
class model_DiagramModelComponent(Adapter, Nameable, Cloneable, Identifier):
