...
# Classes
model_Identifier = Class(name="model_Identifier", is_abstract=True)
model_Property = Class(name="model_Property")
model_Properties = Class(name="model_Properties", is_abstract=True)
model_Adapter = Class(name="model_Adapter", is_abstract=True)
model_FolderContainer = Class(name="model_FolderContainer", is_abstract=True)
model_Folder = Class(name="model_Folder")
...
model_EObject = Class(name="model_EObject")
model_Metadata = Class(name="model_Metadata")
model_Nameable = Class(name="model_Nameable", is_abstract=True)
model_TextContent = Class(name="model_TextContent", is_abstract=True)
model_Documentable = Class(name="model_Documentable", is_abstract=True)
model_Cloneable = Class(name="model_Cloneable", is_abstract=True)
PassiveStructureElement = Class(name="PassiveStructureElement")
model_PhysicalElement = Class(name="model_PhysicalElement", is_abstract=True)
model_MotivationElement = Class(name="model_MotivationElement", is_abstract=True)
model_ImplementationMigrationElement = Class(name="model_ImplementationMigrationElement", is_abstract=True)
model_CompositeElement = Class(name="model_CompositeElement", is_abstract=True)
model_BehaviorElement = Class(name="model_BehaviorElement", is_abstract=True)
model_StructureElement = Class(name="model_StructureElement", is_abstract=True)
model_ActiveStructureElement = Class(name="model_ActiveStructureElement")
StructureElement = Class(name="StructureElement")
model_PassiveStructureElement = Class(name="model_PassiveStructureElement")
model_StructuralRelationship = Class(name="model_StructuralRelationship", is_abstract=True)
ArchimateRelationship = Class(name="ArchimateRelationship")
model_DependendencyRelationship = Class(name="model_DependendencyRelationship", is_abstract=True)
model_ArchimateModelObject = Class(name="model_ArchimateModelObject", is_abstract=True)
Adapter = Class(name="Adapter")
Nameable = Class(name="Nameable")
Identifier = Class(name="Identifier")
model_ArchimateConcept = Class(name="model_ArchimateConcept", is_abstract=True)
Cloneable = Class(name="Cloneable")
model_ArchimateElement = Class(name="model_ArchimateElement", is_abstract=True)
ArchimateConcept = Class(name="ArchimateConcept")
model_ArchimateRelationship = Class(name="model_ArchimateRelationship", is_abstract=True)
model_JunctionElement = Class(name="model_JunctionElement", is_abstract=True)
ArchimateElement = Class(name="ArchimateElement")
model_StrategyElement = Class(name="model_StrategyElement", is_abstract=True)
model_BusinessElement = Class(name="model_BusinessElement", is_abstract=True)
model_ApplicationElement = Class(name="model_ApplicationElement", is_abstract=True)
model_TechnologyElement = Class(name="model_TechnologyElement", is_abstract=True)
model_TechnologyObject = Class(name="model_TechnologyObject", is_abstract=True)
TechnologyElement = Class(name="TechnologyElement")
model_ApplicationEvent = Class(name="model_ApplicationEvent")
BehaviorElement = Class(name="BehaviorElement")
model_ApplicationFunction = Class(name="model_ApplicationFunction")
model_ApplicationInteraction = Class(name="model_ApplicationInteraction")
model_ApplicationInterface = Class(name="model_ApplicationInterface")
model_ApplicationProcess = Class(name="model_ApplicationProcess")
model_ApplicationService = Class(name="model_ApplicationService")
model_Artifact = Class(name="model_Artifact")
TechnologyObject = Class(name="TechnologyObject")
model_Assessment = Class(name="model_Assessment")
MotivationElement = Class(name="MotivationElement")
model_BusinessActor = Class(name="model_BusinessActor")
BusinessElement = Class(name="BusinessElement")
model_BusinessCollaboration = Class(name="model_BusinessCollaboration")
model_DynamicRelationship = Class(name="model_DynamicRelationship", is_abstract=True)
model_OtherRelationship = Class(name="model_OtherRelationship", is_abstract=True)
model_ArchimateModel = Class(name="model_ArchimateModel")
model_AndJunction = Class(name="model_AndJunction")
JunctionElement = Class(name="JunctionElement")
model_ApplicationCollaboration = Class(name="model_ApplicationCollaboration")
ApplicationElement = Class(name="ApplicationElement")
ActiveStructureElement = Class(name="ActiveStructureElement")
model_ApplicationComponent = Class(name="model_ApplicationComponent")
model_Deliverable = Class(name="model_Deliverable")
ImplementationMigrationElement = Class(name="ImplementationMigrationElement")
model_Device = Class(name="model_Device")
model_DistributionNetwork = Class(name="model_DistributionNetwork")
PhysicalElement = Class(name="PhysicalElement")
model_Driver = Class(name="model_Driver")
model_Equipment = Class(name="model_Equipment")
model_Facility = Class(name="model_Facility")
model_Gap = Class(name="model_Gap")
model_Goal = Class(name="model_Goal")
model_Grouping = Class(name="model_Grouping")
CompositeElement = Class(name="CompositeElement")
model_ImplementationEvent = Class(name="model_ImplementationEvent")
model_BusinessEvent = Class(name="model_BusinessEvent")
model_BusinessFunction = Class(name="model_BusinessFunction")
model_BusinessInteraction = Class(name="model_BusinessInteraction")
model_BusinessInterface = Class(name="model_BusinessInterface")
model_BusinessObject = Class(name="model_BusinessObject")
model_BusinessProcess = Class(name="model_BusinessProcess")
model_BusinessRole = Class(name="model_BusinessRole")
model_BusinessService = Class(name="model_BusinessService")
model_Capability = Class(name="model_Capability")
StrategyElement = Class(name="StrategyElement")
model_CommunicationNetwork = Class(name="model_CommunicationNetwork")
model_Contract = Class(name="model_Contract")
model_Constraint = Class(name="model_Constraint")
model_CourseOfAction = Class(name="model_CourseOfAction")
model_DataObject = Class(name="model_DataObject")
model_TechnologyInteraction = Class(name="model_TechnologyInteraction")
model_TechnologyProcess = Class(name="model_TechnologyProcess")
model_TechnologyService = Class(name="model_TechnologyService")
model_Value = Class(name="model_Value")
model_WorkPackage = Class(name="model_WorkPackage")
model_AccessRelationship = Class(name="model_AccessRelationship")
DependendencyRelationship = Class(name="DependendencyRelationship")
model_AggregationRelationship = Class(name="model_AggregationRelationship")
StructuralRelationship = Class(name="StructuralRelationship")
model_AssignmentRelationship = Class(name="model_AssignmentRelationship")
model_AssociationRelationship = Class(name="model_AssociationRelationship")
OtherRelationship = Class(name="OtherRelationship")
model_Location = Class(name="model_Location")
model_Material = Class(name="model_Material")
model_Meaning = Class(name="model_Meaning")
model_Node = Class(name="model_Node")
model_Outcome = Class(name="model_Outcome")
model_OrJunction = Class(name="model_OrJunction")
model_Path = Class(name="model_Path")
model_Plateau = Class(name="model_Plateau")
model_Principle = Class(name="model_Principle")
model_Product = Class(name="model_Product")
model_Representation = Class(name="model_Representation")
model_Resource = Class(name="model_Resource")
model_Requirement = Class(name="model_Requirement")
model_Stakeholder = Class(name="model_Stakeholder")
model_SystemSoftware = Class(name="model_SystemSoftware")
model_TechnologyCollaboration = Class(name="model_TechnologyCollaboration")
model_TechnologyEvent = Class(name="model_TechnologyEvent")
model_TechnologyFunction = Class(name="model_TechnologyFunction")
model_TechnologyInterface = Class(name="model_TechnologyInterface")
model_DiagramModelConnection = Class(name="model_DiagramModelConnection")
model_DiagramModelContainer = Class(name="model_DiagramModelContainer", is_abstract=True)
model_DiagramModelObject = Class(name="model_DiagramModelObject", is_abstract=True)
model_CompositionRelationship = Class(name="model_CompositionRelationship")
model_FlowRelationship = Class(name="model_FlowRelationship")
DynamicRelationship = Class(name="DynamicRelationship")
model_InfluenceRelationship = Class(name="model_InfluenceRelationship")
model_RealizationRelationship = Class(name="model_RealizationRelationship")
model_ServingRelationship = Class(name="model_ServingRelationship")
model_SpecializationRelationship = Class(name="model_SpecializationRelationship")
model_TriggeringRelationship = Class(name="model_TriggeringRelationship")
model_DiagramModelComponent = Class(name="model_DiagramModelComponent", is_abstract=True)
model_Connectable = Class(name="model_Connectable", is_abstract=True)
DiagramModelComponent = Class(name="DiagramModelComponent")
model_DiagramModelGroup = Class(name="model_DiagramModelGroup")
model_DiagramModelNote = Class(name="model_DiagramModelNote")
TextContent = Class(name="TextContent")
model_DiagramModelImage = Class(name="model_DiagramModelImage")
BorderObject = Class(name="BorderObject")
DiagramModelImageProvider = Class(name="DiagramModelImageProvider")
model_DiagramModel = Class(name="model_DiagramModel", is_abstract=True)
DiagramModelContainer = Class(name="DiagramModelContainer")
model_DiagramModelReference = Class(name="model_DiagramModelReference")
...
model_Bounds = Class(name="model_Bounds")
model_FontAttribute = Class(name="model_FontAttribute", is_abstract=True)
model_TextPosition = Class(name="model_TextPosition", is_abstract=True)
model_TextAlignment = Class(name="model_TextAlignment", is_abstract=True)
model_BorderObject = Class(name="model_BorderObject", is_abstract=True)
model_DiagramModelBendpoint = Class(name="model_DiagramModelBendpoint")
model_LineObject = Class(name="model_LineObject", is_abstract=True)
model_DiagramModelArchimateObject = Class(name="model_DiagramModelArchimateObject")
DiagramModelArchimateComponent = Class(name="DiagramModelArchimateComponent")
model_DiagramModelArchimateConnection = Class(name="model_DiagramModelArchimateConnection")
DiagramModelConnection = Class(name="DiagramModelConnection")
model_SketchModel = Class(name="model_SketchModel")
model_DiagramModelImageProvider = Class(name="model_DiagramModelImageProvider", is_abstract=True)
model_Lockable = Class(name="model_Lockable", is_abstract=True)
model_ArchimateDiagramModel = Class(name="model_ArchimateDiagramModel")
DiagramModel = Class(name="DiagramModel")
model_DiagramModelArchimateComponent = Class(name="model_DiagramModelArchimateComponent", is_abstract=True)
model_SketchModelSticky = Class(name="model_SketchModelSticky")
model_SketchModelActor = Class(name="model_SketchModelActor")
...
model_Adapter_m_setAdapter: Method = Method(name="setAdapter", parameters={Parameter(name='model_object', type=StringType), Parameter(name='model_adapter', type=StringType)})
model_Adapter_m_getAdapter: Method = Method(name="getAdapter", parameters={Parameter(name='model_adapter', type=StringType)}, type=StringType)
...
model_ArchimateRelationship_m_connect: Method = Method(name="connect", parameters={Parameter(name='model_target', type=StringType), Parameter(name='model_source', type=StringType)})
...
model_ArchimateRelationship.methods={model_ArchimateRelationship_m_disconnect, model_ArchimateRelationship_m_connect, model_ArchimateRelationship_m_reconnect}
...
model_ArchimateModel_m_getDefaultFolderForObject: Method = Method(name="getDefaultFolderForObject", parameters={Parameter(name='model_object', type=StringType)}, type=StringType)
...
model_ArchimateModel_m_getFolder: Method = Method(name="getFolder", parameters={Parameter(name='model_type', type=StringType)}, type=StringType)
model_ArchimateModel.attributes={model_ArchimateModel_version, model_ArchimateModel_file, model_ArchimateModel_purpose}
model_ArchimateModel.methods={model_ArchimateModel_m_setDefaults, model_ArchimateModel_m_getDefaultDiagramModel, model_ArchimateModel_m_getDiagramModels, model_ArchimateModel_m_getDefaultFolderForObject, model_ArchimateModel_m_getFolder}
...
model_DiagramModelConnection_m_connect: Method = Method(name="connect", parameters={Parameter(name='model_target', type=StringType), Parameter(name='model_source', type=StringType)})
...
model_DiagramModelObject_m_setBounds: Method = Method(name="setBounds", parameters={Parameter(name='model_height', type=StringType), Parameter(name='model_width', type=StringType), Parameter(name='model_x', type=StringType), Parameter(name='model_y', type=StringType)})
...
model_Connectable_m_addConnection: Method = Method(name="addConnection", parameters={Parameter(name='model_connection', type=StringType)})
model_Connectable_m_removeConnection: Method = Method(name="removeConnection", parameters={Parameter(name='model_connection', type=StringType)})
...
model_Bounds_m_setLocation: Method = Method(name="setLocation", parameters={Parameter(name='model_y', type=StringType), Parameter(name='model_x', type=StringType)})
model_Bounds_m_setSize: Method = Method(name="setSize", parameters={Parameter(name='model_width', type=StringType), Parameter(name='model_height', type=StringType)})
model_Bounds_m_getCopy: Method = Method(name="getCopy", parameters={}, type=StringType)
model_Bounds.attributes={model_Bounds_height, model_Bounds_x, model_Bounds_width, model_Bounds_y}
...
model_DiagramModelBendpoint.attributes={model_DiagramModelBendpoint_endY, model_DiagramModelBendpoint_startX, model_DiagramModelBendpoint_endX, model_DiagramModelBendpoint_startY}
...
model_DiagramModelArchimateComponent_m_setArchimateConcept: Method = Method(name="setArchimateConcept", parameters={Parameter(name='model_concept', type=StringType)})
model_DiagramModelArchimateComponent_m_addArchimateConceptToModel: Method = Method(name="addArchimateConceptToModel", parameters={Parameter(name='model_parent', type=StringType)})
...
model_DiagramModelArchimateComponent.methods={model_DiagramModelArchimateComponent_m_removeArchimateConceptFromModel, model_DiagramModelArchimateComponent_m_getArchimateConcept, model_DiagramModelArchimateComponent_m_addArchimateConceptToModel, model_DiagramModelArchimateComponent_m_setArchimateConcept}
...
domain_model = DomainModel(
    name="model",
    types={model_Identifier, model_Property, model_Properties, model_Adapter, model_FolderContainer, model_Folder, ArchimateModelObject, FolderContainer, Documentable, Properties, model_EObject, model_Metadata, model_Nameable, model_TextContent, model_Documentable, model_Cloneable, PassiveStructureElement, model_PhysicalElement, model_MotivationElement, model_ImplementationMigrationElement, model_CompositeElement, model_BehaviorElement, model_StructureElement, model_ActiveStructureElement, StructureElement, model_PassiveStructureElement, model_StructuralRelationship, ArchimateRelationship, model_DependendencyRelationship, model_ArchimateModelObject, Adapter, Nameable, Identifier, model_ArchimateConcept, Cloneable, model_ArchimateElement, ArchimateConcept, model_ArchimateRelationship, model_JunctionElement, ArchimateElement, model_StrategyElement, model_BusinessElement, model_ApplicationElement, model_TechnologyElement, model_TechnologyObject, TechnologyElement, model_ApplicationEvent, BehaviorElement, model_ApplicationFunction, model_ApplicationInteraction, model_ApplicationInterface, model_ApplicationProcess, model_ApplicationService, model_Artifact, TechnologyObject, model_Assessment, MotivationElement, model_BusinessActor, BusinessElement, model_BusinessCollaboration, model_DynamicRelationship, model_OtherRelationship, model_ArchimateModel, model_AndJunction, JunctionElement, model_ApplicationCollaboration, ApplicationElement, ActiveStructureElement, model_ApplicationComponent, model_Deliverable, ImplementationMigrationElement, model_Device, model_DistributionNetwork, PhysicalElement, model_Driver, model_Equipment, model_Facility, model_Gap, model_Goal, model_Grouping, CompositeElement, model_ImplementationEvent, model_BusinessEvent, model_BusinessFunction, model_BusinessInteraction, model_BusinessInterface, model_BusinessObject, model_BusinessProcess, model_BusinessRole, model_BusinessService, model_Capability, StrategyElement, model_CommunicationNetwork, model_Contract, model_Constraint, model_CourseOfAction, model_DataObject, model_TechnologyInteraction, model_TechnologyProcess, model_TechnologyService, model_Value, model_WorkPackage, model_AccessRelationship, DependendencyRelationship, model_AggregationRelationship, StructuralRelationship, model_AssignmentRelationship, model_AssociationRelationship, OtherRelationship, model_Location, model_Material, model_Meaning, model_Node, model_Outcome, model_OrJunction, model_Path, model_Plateau, model_Principle, model_Product, model_Representation, model_Resource, model_Requirement, model_Stakeholder, model_SystemSoftware, model_TechnologyCollaboration, model_TechnologyEvent, model_TechnologyFunction, model_TechnologyInterface, model_DiagramModelConnection, model_DiagramModelContainer, model_DiagramModelObject, model_CompositionRelationship, model_FlowRelationship, DynamicRelationship, model_InfluenceRelationship, model_RealizationRelationship, model_ServingRelationship, model_SpecializationRelationship, model_TriggeringRelationship, model_DiagramModelComponent, model_Connectable, DiagramModelComponent, model_DiagramModelGroup, model_DiagramModelNote, TextContent, model_DiagramModelImage, BorderObject, DiagramModelImageProvider, model_DiagramModel, DiagramModelContainer, model_DiagramModelReference, DiagramModelObject, TextPosition, Connectable, FontAttribute, LineObject, TextAlignment, model_Bounds, model_FontAttribute, model_TextPosition, model_TextAlignment, model_BorderObject, model_DiagramModelBendpoint, model_LineObject, model_DiagramModelArchimateObject, DiagramModelArchimateComponent, model_DiagramModelArchimateConnection, DiagramModelConnection, model_SketchModel, model_DiagramModelImageProvider, model_Lockable, model_ArchimateDiagramModel, DiagramModel, model_DiagramModelArchimateComponent, model_SketchModelSticky, model_SketchModelActor, FolderType},
    associations={properties0, folders3, elements4, entries1, source6, target7, metadata10, sourceConnections12, targetConnections13, children16, referencedModel17, bounds18, source20, target23, bendpoints26, archimateElement28, archimateRelationship29},
    generalizations={gen_model_Folder_ArchimateModelObject, gen_model_Folder_FolderContainer, gen_model_Folder_Documentable, gen_model_Folder_Properties, gen_model_TechnologyObject_PassiveStructureElement, gen_model_PhysicalElement_ArchimateElement, gen_model_MotivationElement_ArchimateElement, gen_model_ImplementationMigrationElement_ArchimateElement, gen_model_CompositeElement_ArchimateElement, gen_model_BehaviorElement_ArchimateElement, gen_model_StructureElement_ArchimateElement, gen_model_ActiveStructureElement_StructureElement, gen_model_PassiveStructureElement_StructureElement, gen_model_StructuralRelationship_ArchimateRelationship, gen_model_DependendencyRelationship_ArchimateRelationship, gen_model_ArchimateModelObject_Adapter, gen_model_ArchimateModelObject_Nameable, gen_model_ArchimateModelObject_Identifier, gen_model_ArchimateConcept_ArchimateModelObject, gen_model_ArchimateConcept_Cloneable, gen_model_ArchimateConcept_Documentable, gen_model_ArchimateConcept_Properties, gen_model_ArchimateElement_ArchimateConcept, gen_model_ArchimateRelationship_ArchimateConcept, gen_model_JunctionElement_ArchimateElement, gen_model_StrategyElement_ArchimateElement, gen_model_BusinessElement_ArchimateElement, gen_model_ApplicationElement_ArchimateElement, gen_model_TechnologyElement_ArchimateElement, gen_model_TechnologyObject_TechnologyElement, gen_model_ApplicationEvent_ApplicationElement, gen_model_ApplicationEvent_BehaviorElement, gen_model_ApplicationFunction_ApplicationElement, gen_model_ApplicationFunction_BehaviorElement, gen_model_ApplicationInteraction_ApplicationElement, gen_model_ApplicationInteraction_BehaviorElement, gen_model_ApplicationInterface_ApplicationElement, gen_model_ApplicationInterface_ActiveStructureElement, gen_model_ApplicationProcess_ApplicationElement, gen_model_ApplicationProcess_BehaviorElement, gen_model_ApplicationService_ApplicationElement, gen_model_ApplicationService_BehaviorElement, gen_model_Artifact_TechnologyObject, gen_model_Assessment_MotivationElement, gen_model_BusinessActor_BusinessElement, gen_model_BusinessActor_ActiveStructureElement, gen_model_DynamicRelationship_ArchimateRelationship, gen_model_OtherRelationship_ArchimateRelationship, gen_model_ArchimateModel_FolderContainer, gen_model_ArchimateModel_ArchimateModelObject, gen_model_ArchimateModel_Properties, gen_model_AndJunction_JunctionElement, gen_model_ApplicationCollaboration_ApplicationElement, gen_model_ApplicationCollaboration_ActiveStructureElement, gen_model_ApplicationComponent_ApplicationElement, gen_model_ApplicationComponent_ActiveStructureElement, gen_model_DataObject_PassiveStructureElement, gen_model_Deliverable_ImplementationMigrationElement, gen_model_Deliverable_PassiveStructureElement, gen_model_Device_TechnologyElement, gen_model_Device_ActiveStructureElement, gen_model_DistributionNetwork_PhysicalElement, gen_model_DistributionNetwork_ActiveStructureElement, gen_model_Driver_MotivationElement, gen_model_Equipment_PhysicalElement, gen_model_Equipment_ActiveStructureElement, gen_model_Facility_PhysicalElement, gen_model_Facility_ActiveStructureElement, gen_model_Gap_ImplementationMigrationElement, gen_model_Gap_PassiveStructureElement, gen_model_Goal_MotivationElement, gen_model_Grouping_CompositeElement, gen_model_ImplementationEvent_ImplementationMigrationElement, gen_model_BusinessCollaboration_BusinessElement, gen_model_BusinessCollaboration_ActiveStructureElement, gen_model_BusinessEvent_BusinessElement, gen_model_BusinessEvent_BehaviorElement, gen_model_BusinessFunction_BusinessElement, gen_model_BusinessFunction_BehaviorElement, gen_model_BusinessInteraction_BusinessElement, gen_model_BusinessInteraction_BehaviorElement, gen_model_BusinessInterface_BusinessElement, gen_model_BusinessInterface_ActiveStructureElement, gen_model_BusinessObject_BusinessElement, gen_model_BusinessObject_PassiveStructureElement, gen_model_BusinessProcess_BusinessElement, gen_model_BusinessProcess_BehaviorElement, gen_model_BusinessRole_BusinessElement, gen_model_BusinessRole_ActiveStructureElement, gen_model_BusinessService_BusinessElement, gen_model_BusinessService_BehaviorElement, gen_model_Capability_StrategyElement, gen_model_Capability_BehaviorElement, gen_model_CommunicationNetwork_TechnologyElement, gen_model_CommunicationNetwork_ActiveStructureElement, gen_model_Contract_BusinessElement, gen_model_Contract_PassiveStructureElement, gen_model_Constraint_MotivationElement, gen_model_CourseOfAction_StrategyElement, gen_model_CourseOfAction_BehaviorElement, gen_model_DataObject_ApplicationElement, gen_model_TechnologyInterface_TechnologyElement, gen_model_TechnologyInterface_ActiveStructureElement, gen_model_TechnologyInteraction_TechnologyElement, gen_model_TechnologyInteraction_BehaviorElement, gen_model_TechnologyProcess_TechnologyElement, gen_model_TechnologyProcess_BehaviorElement, gen_model_TechnologyService_TechnologyElement, gen_model_TechnologyService_BehaviorElement, gen_model_Value_MotivationElement, gen_model_WorkPackage_ImplementationMigrationElement, gen_model_WorkPackage_BehaviorElement, gen_model_AccessRelationship_DependendencyRelationship, gen_model_AggregationRelationship_StructuralRelationship, gen_model_AssignmentRelationship_StructuralRelationship, gen_model_AssociationRelationship_OtherRelationship, gen_model_Location_CompositeElement, gen_model_Material_PhysicalElement, gen_model_Material_PassiveStructureElement, gen_model_Meaning_MotivationElement, gen_model_Node_TechnologyElement, gen_model_Node_ActiveStructureElement, gen_model_Outcome_MotivationElement, gen_model_OrJunction_JunctionElement, gen_model_Path_TechnologyElement, gen_model_Plateau_ImplementationMigrationElement, gen_model_Plateau_CompositeElement, gen_model_Principle_MotivationElement, gen_model_Product_BusinessElement, gen_model_Product_CompositeElement, gen_model_Representation_BusinessElement, gen_model_Representation_PassiveStructureElement, gen_model_Resource_StrategyElement, gen_model_Resource_StructureElement, gen_model_Requirement_MotivationElement, gen_model_Stakeholder_MotivationElement, gen_model_Stakeholder_ActiveStructureElement, gen_model_SystemSoftware_TechnologyElement, gen_model_SystemSoftware_ActiveStructureElement, gen_model_TechnologyCollaboration_TechnologyElement, gen_model_TechnologyCollaboration_ActiveStructureElement, gen_model_TechnologyEvent_TechnologyElement, gen_model_TechnologyEvent_BehaviorElement, gen_model_TechnologyFunction_TechnologyElement, gen_model_TechnologyFunction_BehaviorElement, gen_model_DiagramModelContainer_DiagramModelComponent, gen_model_CompositionRelationship_StructuralRelationship, gen_model_FlowRelationship_DynamicRelationship, gen_model_InfluenceRelationship_DependendencyRelationship, gen_model_RealizationRelationship_StructuralRelationship, gen_model_ServingRelationship_DependendencyRelationship, gen_model_SpecializationRelationship_OtherRelationship, gen_model_TriggeringRelationship_DynamicRelationship, gen_model_DiagramModelComponent_Identifier, gen_model_DiagramModelComponent_Cloneable, gen_model_DiagramModelComponent_Adapter, gen_model_DiagramModelComponent_Nameable, gen_model_Connectable_DiagramModelComponent, gen_model_DiagramModelGroup_DiagramModelObject, gen_model_DiagramModelGroup_DiagramModelContainer, gen_model_DiagramModelGroup_Documentable, gen_model_DiagramModelGroup_Properties, gen_model_DiagramModelNote_DiagramModelObject, gen_model_DiagramModelNote_TextContent, gen_model_DiagramModelNote_TextPosition, gen_model_DiagramModelImage_DiagramModelObject, gen_model_DiagramModelImage_BorderObject, gen_model_DiagramModelImage_DiagramModelImageProvider, gen_model_DiagramModelConnection_Connectable, gen_model_DiagramModelConnection_FontAttribute, gen_model_DiagramModelConnection_Properties, gen_model_DiagramModelConnection_Documentable, gen_model_DiagramModel_ArchimateModelObject, gen_model_DiagramModel_DiagramModelContainer, gen_model_DiagramModel_Documentable, gen_model_DiagramModel_Properties, gen_model_DiagramModelReference_DiagramModelObject, gen_model_DiagramModelReference_TextPosition, gen_model_DiagramModelObject_Connectable, gen_model_DiagramModelObject_FontAttribute, gen_model_DiagramModelObject_LineObject, gen_model_DiagramModelObject_TextAlignment, gen_model_DiagramModelConnection_LineObject, gen_model_DiagramModelBendpoint_Cloneable, gen_model_DiagramModelArchimateObject_DiagramModelObject, gen_model_DiagramModelArchimateObject_DiagramModelContainer, gen_model_DiagramModelArchimateObject_DiagramModelArchimateComponent, gen_model_DiagramModelArchimateObject_TextPosition, gen_model_DiagramModelArchimateConnection_DiagramModelConnection, gen_model_DiagramModelArchimateConnection_DiagramModelArchimateComponent, gen_model_SketchModel_DiagramModel, gen_model_ArchimateDiagramModel_DiagramModel, gen_model_DiagramModelArchimateComponent_Connectable, gen_model_SketchModelSticky_DiagramModelObject, gen_model_SketchModelSticky_DiagramModelContainer, gen_model_SketchModelSticky_TextContent, gen_model_SketchModelSticky_Properties, gen_model_SketchModelSticky_TextPosition, gen_model_SketchModelActor_DiagramModelObject, gen_model_SketchModelActor_Documentable, gen_model_SketchModelActor_Properties},
    metadata=None
)
