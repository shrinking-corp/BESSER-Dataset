...
class dataflow_Variable(Attributable):
    ...
    def __init__(self, name: str, shared: bool, dataflow_Variable62: "dataflow_Procedure" = None, dataflow_Variable67: "dataflow_Type" = None, dataflow_Variable69: "dataflow_Actor" = None, dataflow_Variable: "dataflow_Actor" = None):
        self.name = name
        self.shared = shared
...
class dataflow_Action(Attributable):
    ...
    def __init__(self, name: str, readers: set["dataflow_Port"] = None, dataflow_Action56: set["dataflow_Guard"] = None, dataflow_Action58: "dataflow_Actor" = None, Action: "dataflow_Port" = None, Action73: "dataflow_Port" = None, writers: set["dataflow_Port"] = None, dataflow_Action: "dataflow_Actor" = None, dataflow_Action92: "dataflow_Guard" = None):
        self.name = name
    ...
    def getGuard(self, dataflow_tag) :
        # TODO: Implement getGuard method
        pass

class dataflow_Procedure(Attributable):

    def __init__(self, name: str, dataflow_Procedure61: set["dataflow_Variable"] = None, dataflow_Procedure64: "dataflow_Actor" = None, dataflow_Procedure: "dataflow_Actor" = None):
        self.name = name
...
class dataflow_Network(Attributable):
    ...
    def __init__(self, name: str, sourceFile: str, project: str, dataflow_Network: set["dataflow_Actor"] = None, dataflow_Network2: set["dataflow_ActorClass"] = None, dataflow_Network4: set["dataflow_Buffer"] = None, dataflow_Network6: set["dataflow_Port"] = None, dataflow_Network8: set["dataflow_Port"] = None, dataflow_Network13: "dataflow_Version" = None, dataflow_Network36: "dataflow_Actor" = None, dataflow_Network89: "dataflow_Buffer" = None, dataflow_Network20: "dataflow_ActorClass" = None, dataflow_Network11: set["dataflow_SharedVariable"] = None):
        self.name = name
    ...
    def getOutputPort(self, dataflow_name) :
        # TODO: Implement getOutputPort method
        pass

    def getInputPort(self, dataflow_name) :
        # TODO: Implement getInputPort method
        pass

    def getSharedVariables(self, dataflow_tag) :
        # TODO: Implement getSharedVariables method
        pass

    def getActorClass(self, dataflow_name) :
        # TODO: Implement getActorClass method
        pass

    def getActor(self, dataflow_name) :
...
class dataflow_Port(Attributable):
    ...
    def __init__(self, name: str, dataflow_Port: "dataflow_Network" = None, dataflow_Port9: "dataflow_Network" = None, Port: "dataflow_Action" = None, outputPorts: set["dataflow_Action"] = None, inputPorts: set["dataflow_Action"] = None, target: "dataflow_Buffer" = None, Port54: "dataflow_Action" = None, source: set["dataflow_Buffer"] = None, dataflow_Port78: "dataflow_Actor" = None, Port81: "dataflow_Buffer" = None, Port83: "dataflow_Buffer" = None, dataflow_Port23: "dataflow_Actor" = None, dataflow_Port26: "dataflow_Actor" = None):
        self.name = name
...
class dataflow_ActorClass(Attributable):
    ...
    def __init__(self, name: str, sourceFile: str, nameSpace: str, sourceCode: str, dataflow_ActorClass: "dataflow_Network" = None, actorClass: set["dataflow_Actor"] = None, dataflow_ActorClass16: "dataflow_Version" = None, dataflow_ActorClass19: "dataflow_Network" = None, ActorClass: "dataflow_Actor" = None):
        self.name = name
        self.sourceFile = sourceFile
...
class dataflow_Actor(Attributable):
    ...
    def __init__(self, name: str, dataflow_Actor: "dataflow_Network" = None, dataflow_Actor35: "dataflow_Network" = None, dataflow_Actor38: set["dataflow_Buffer"] = None, dataflow_Actor41: set["dataflow_Buffer"] = None, dataflow_Actor44: set["dataflow_Buffer"] = None, dataflow_Actor48: "dataflow_Actor" = None, dataflow_Actor46: set["dataflow_Actor"] = None, dataflow_Actor51: "dataflow_Actor" = None, dataflow_Actor49: set["dataflow_Actor"] = None, dataflow_Actor59: "dataflow_Action" = None, dataflow_Actor65: "dataflow_Procedure" = None, dataflow_Actor70: "dataflow_Variable" = None, dataflow_Actor79: "dataflow_Port" = None, Actor: "dataflow_ActorClass" = None, dataflow_Actor22: set["dataflow_Port"] = None, dataflow_Actor25: set["dataflow_Port"] = None, dataflow_Actor28: set["dataflow_Variable"] = None, actors: "dataflow_ActorClass" = None, dataflow_Actor31: set["dataflow_Action"] = None, dataflow_Actor33: set["dataflow_Procedure"] = None):
        self.name = name
    ...
    def getSharedVariable(self, dataflow_tag) :
    ...
    def getVariable(self, dataflow_name) :
        # TODO: Implement getVariable method
        pass

    def getProcedure(self, dataflow_name) :
        # TODO: Implement getProcedure method
        pass

    def getAction(self, dataflow_name) :
