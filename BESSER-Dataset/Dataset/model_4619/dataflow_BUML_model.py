...
# Classes
dataflow_Actor = Class(name="dataflow_Actor")
dataflow_ActorClass = Class(name="dataflow_ActorClass")
dataflow_Buffer = Class(name="dataflow_Buffer")
dataflow_Port = Class(name="dataflow_Port")
dataflow_SharedVariable = Class(name="dataflow_SharedVariable")
dataflow_Network = Class(name="dataflow_Network")
Attributable = Class(name="Attributable")
dataflow_Version = Class(name="dataflow_Version")
dataflow_Variable = Class(name="dataflow_Variable")
dataflow_Action = Class(name="dataflow_Action")
dataflow_Procedure = Class(name="dataflow_Procedure")
dataflow_Guard = Class(name="dataflow_Guard")
dataflow_Type = Class(name="dataflow_Type", is_abstract=True)
Variable = Class(name="Variable")
dataflow_TypeUint = Class(name="dataflow_TypeUint")
Type = Class(name="Type")
dataflow_TypeInt = Class(name="dataflow_TypeInt")
dataflow_TypeString = Class(name="dataflow_TypeString")
dataflow_TypeBoolean = Class(name="dataflow_TypeBoolean")
dataflow_TypeDouble = Class(name="dataflow_TypeDouble")
dataflow_TypeUndefined = Class(name="dataflow_TypeUndefined")
dataflow_TypeList = Class(name="dataflow_TypeList")

# dataflow_Actor class attributes and methods
dataflow_Actor_name: Property = Property(name="name", type=StringType)
dataflow_Actor_m_getAction: Method = Method(name="getAction", parameters={Parameter(name='dataflow_name', type=StringType)}, type=StringType)
dataflow_Actor_m_getInputPort: Method = Method(name="getInputPort", parameters={Parameter(name='dataflow_name', type=StringType)}, type=StringType)
dataflow_Actor_m_getOutputPort: Method = Method(name="getOutputPort", parameters={Parameter(name='dataflow_name', type=StringType)}, type=StringType)
dataflow_Actor_m_getVariable: Method = Method(name="getVariable", parameters={Parameter(name='dataflow_name', type=StringType)}, type=StringType)
dataflow_Actor_m_getProcedure: Method = Method(name="getProcedure", parameters={Parameter(name='dataflow_name', type=StringType)}, type=StringType)
dataflow_Actor_m_getSharedVariable: Method = Method(name="getSharedVariable", parameters={Parameter(name='dataflow_tag', type=StringType)}, type=StringType)
dataflow_Actor.attributes={dataflow_Actor_name}
dataflow_Actor.methods={dataflow_Actor_m_getVariable, dataflow_Actor_m_getInputPort, dataflow_Actor_m_getOutputPort, dataflow_Actor_m_getSharedVariable, dataflow_Actor_m_getProcedure, dataflow_Actor_m_getAction}
...
dataflow_ActorClass.attributes={dataflow_ActorClass_nameSpace, dataflow_ActorClass_name, dataflow_ActorClass_sourceCode, dataflow_ActorClass_sourceFile}
...
dataflow_Network_m_getActor: Method = Method(name="getActor", parameters={Parameter(name='dataflow_name', type=StringType)}, type=StringType)
dataflow_Network_m_getActorClass: Method = Method(name="getActorClass", parameters={Parameter(name='dataflow_name', type=StringType)}, type=StringType)
dataflow_Network_m_getInputPort: Method = Method(name="getInputPort", parameters={Parameter(name='dataflow_name', type=StringType)}, type=StringType)
dataflow_Network_m_getOutputPort: Method = Method(name="getOutputPort", parameters={Parameter(name='dataflow_name', type=StringType)}, type=StringType)
dataflow_Network_m_getSharedVariables: Method = Method(name="getSharedVariables", parameters={Parameter(name='dataflow_tag', type=StringType)}, type=StringType)
dataflow_Network.attributes={dataflow_Network_sourceFile, dataflow_Network_name, dataflow_Network_project}
dataflow_Network.methods={dataflow_Network_m_getSharedVariables, dataflow_Network_m_getOutputPort, dataflow_Network_m_getInputPort, dataflow_Network_m_getActor, dataflow_Network_m_getActorClass}
...
dataflow_Variable.attributes={dataflow_Variable_name, dataflow_Variable_shared}

# dataflow_Action class attributes and methods
dataflow_Action_name: Property = Property(name="name", type=StringType)
dataflow_Action_m_getGuard: Method = Method(name="getGuard", parameters={Parameter(name='dataflow_tag', type=StringType)}, type=StringType)
...
dataflow_Type.attributes={dataflow_Type_etype, dataflow_Type_bits}
...
domain_model = DomainModel(
    name="dataflow",
    types={dataflow_Actor, dataflow_ActorClass, dataflow_Buffer, dataflow_Port, dataflow_SharedVariable, dataflow_Network, Attributable, dataflow_Version, dataflow_Variable, dataflow_Action, dataflow_Procedure, dataflow_Guard, dataflow_Type, Variable, dataflow_TypeUint, Type, dataflow_TypeInt, dataflow_TypeString, dataflow_TypeBoolean, dataflow_TypeDouble, dataflow_TypeUndefined, dataflow_TypeList},
    associations={actors0, actorClasses1, buffers3, inputPorts5, outputPorts7, version12, actors14, version15, owner18, inputPorts21, sharedVariables10, outputPorts24, variables27, actorClass29, actions30, procedures32, owner34, buffers37, incomingBuffers40, outgoingBuffers43, predecessors47, successors50, inputPorts52, guards55, owner57, variables60, owner63, type66, owner68, writers71, readers72, input74, outputPorts53, outputs75, owner77, source80, target82, type84, owner87, owner90, listType93},
    generalizations={gen_dataflow_Network_Attributable, gen_dataflow_ActorClass_Attributable, gen_dataflow_Actor_Attributable, gen_dataflow_Action_Attributable, gen_dataflow_Procedure_Attributable, gen_dataflow_Variable_Attributable, gen_dataflow_SharedVariable_Variable, gen_dataflow_Port_Attributable, gen_dataflow_Buffer_Attributable, gen_dataflow_Guard_Attributable, gen_dataflow_TypeUint_Type, gen_dataflow_TypeInt_Type, gen_dataflow_TypeString_Type, gen_dataflow_TypeBoolean_Type, gen_dataflow_TypeDouble_Type, gen_dataflow_TypeUndefined_Type, gen_dataflow_TypeList_Type},
    metadata=None
)
