...
# Classes
restaurant_Waiter = Class(name="restaurant_Waiter")
restaurant_Booking = Class(name="restaurant_Booking")
restaurant_Restaurant = Class(name="restaurant_Restaurant")
restaurant_Menu = Class(name="restaurant_Menu")
restaurant_Table = Class(name="restaurant_Table")
...
domain_model = DomainModel(
    name="restaurant",
    types={restaurant_Waiter, restaurant_Booking, restaurant_Restaurant, restaurant_Menu, restaurant_Table},
    associations={waiters3, bookings5, menus0, tables1},
    generalizations={},
    metadata=None
)
