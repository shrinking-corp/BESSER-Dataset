...
class avm_cad_Geometry(AnalysisConstruct):
    ...
    def __init__(self, GeometryQualifier: str, PartIntersectionModifier: str):
        ...
        pass
    @property
    def PartIntersectionModifier(self):
...
class avm_modelica_SolverSettings(Settings):
    ...
    @property
    def JobManagerToolSelection(self):
    ...
    @property
    def ToolSpecificAnnotations(self):
...
class DomainModel_:
    ...
    pass
class avm_cad_CADModel(DomainModel_):
...
class avm_modelica_ModelicaModel(DomainModel_):
...
class avm_modelica_Limit:
    ...
    def __init__(self, Notes: str, VariableLocator: str, BoundType: str, Name: str, ToleranceTimeWindow: str, avm_modelica_Limit: "modelica_avm_Value" = None):
        self.Notes = Notes
...
class avm_Workflow:
    ...
    def __init__(self, Name: str, avm_Workflow149: set["avm_WorkflowTaskBase"] = None, avm_Workflow: "avm_TestBench" = None):
        self.Name = Name
...
class avm_TestBench:
    ...
    def __init__(self, Name: str, avm_TestBench: "avm_TopLevelSystemUnderTest" = None, avm_TestBench131: set["avm_Parameter"] = None, avm_TestBench133: set["avm_Metric"] = None, avm_TestBench142: set["avm_Settings"] = None, avm_TestBench144: set["avm_DomainModel_"] = None, avm_TestBench135: set["avm_TestInjectionPoint"] = None, avm_TestBench137: set["avm_ComponentInstance"] = None, avm_TestBench140: "avm_Workflow" = None):
        self.Name = Name
...
class avm_ConnectorCompositionTarget:
    ...
    def __init__(self, ID: str, avm_ConnectorCompositionTarget121: set["avm_assemblyDetail"] = None, avm_ConnectorCompositionTarget: "avm_ConnectorCompositionTarget" = None, avm_ConnectorCompositionTarget118: set["avm_ConnectorCompositionTarget"] = None):
        self.ID = ID
...
class avm_Design:
    ...
    def __init__(self, DesignID: str, Name: str, DesignSpaceSrcID: str, SchemaVersion: str, avm_Design71: set["avm_DesignDomainFeature"] = None, avm_Design73: set["avm_Resource"] = None, avm_Design: "avm_Container" = None):
        self.DesignID = DesignID
        self.Name = Name
...
class avm_ComponentInstance:
    ...
    def __init__(self, ComponentID: str, ID: str, Name: str, DesignSpaceSrcComponentID: str, XPosition: str, YPosition: str, avm_ComponentInstance138: "avm_TestBench" = None, avm_ComponentInstance: "avm_Container" = None, avm_ComponentInstance108: set["avm_ComponentPortInstance"] = None, avm_ComponentInstance110: set["avm_ComponentPrimitivePropertyInstance"] = None, avm_ComponentInstance112: set["avm_ComponentConnectorInstance"] = None):
    ...
    @property
    def DesignSpaceSrcComponentID(self):
...
class avm_Value(ValueNode):
    ...
    def __init__(self, DimensionType: str, DataType: str, Dimensions: str, Unit: str, avm_Value: "avm_ValueExpressionType" = None, avm_Value22: set["avm_DataSource"] = None, avm_Value147: "avm_TestBenchValueBase" = None, avm_Value54: "avm_DomainModelMetric" = None, avm_Value56: "avm_PrimitiveProperty" = None, avm_Value115: "avm_ComponentPrimitivePropertyInstance" = None):
...
class avm_ValueFlowMux(ValueNode):
    ...
    pass
class avm_DomainModel_(ABC):

    def __init__(self, Author: str, Notes: str, XPosition: str, YPosition: str, Name: str, ID: str, avm_DomainModel18: set["avm_Resource"] = None, avm_DomainModel: "avm_Component" = None, avm_DomainModel145: "avm_TestBench" = None, avm_DomainModel102: "avm_Container" = None):
        self.Author = Author
        self.Notes = Notes
        self.XPosition = XPosition
        self.YPosition = YPosition
    ...
    def avm_DomainModel(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_avm_DomainModel___avm_DomainModel", None)
    ...
    def avm_DomainModel18(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_avm_DomainModel___avm_DomainModel18", None)
    ...
    def avm_DomainModel102(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_avm_DomainModel___avm_DomainModel102", None)
    ...
    def avm_DomainModel145(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_avm_DomainModel___avm_DomainModel145", None)
...
class avm_Connector(ConnectorCompositionTarget):
    ...
    def __init__(self, Definition: str, Name: str, XPosition: str, YPosition: str, Notes: str, avm_Connector: "avm_Component" = None, avm_Connector25: set["avm_Port"] = None, avm_Connector31: set["avm_assemblyDetail"] = None, avm_Connector34: "avm_Connector" = None, avm_Connector32: set["avm_Connector"] = None, avm_Connector36: set["avm_ConnectorFeature"] = None, avm_Connector28: set["avm_Property"] = None, avm_Connector88: "avm_Container" = None):
        self.Definition = Definition
        self.Name = Name
        self.XPosition = XPosition
        self.YPosition = YPosition
...
class avm_Resource:
    ...
    def __init__(self, Name: str, Path: str, Hash: str, ID: str, Notes: str, XPosition: str, YPosition: str, avm_Resource19: "avm_DomainModel_" = None, avm_Resource: "avm_Component" = None, avm_Resource105: "avm_Container" = None, avm_Resource74: "avm_Design" = None, avm_Resource99: "avm_Container" = None, avm_Resource68: "avm_DataSource" = None):
        self.Name = Name
        self.Path = Path
        self.Hash = Hash
        self.ID = ID
...
class avm_Component:
    ...
    def __init__(self, Name: str, Version: str, SchemaVersion: str, Classifications: str, ID: str, Supercedes: str, avm_Component6: set["avm_Connector"] = None, avm_Component8: set["avm_DistributionRestriction"] = None, avm_Component10: set["avm_Port"] = None, avm_Component12: set["avm_AnalysisConstruct"] = None, avm_Component14: set["avm_Formula"] = None, avm_Component16: set["avm_DomainMapping"] = None, avm_Component: set["avm_DomainModel_"] = None, avm_Component2: set["avm_Property"] = None, avm_Component4: set["avm_Resource"] = None):
        self.Name = Name
...
class avm_systemc_SystemCPort(DomainModelPort):
    ...
    def __init__(self, Directionality: str, Function: str, DataType: str, DataTypeDimension: str):
...
class avm_domainmapping_CAD2EDATransform(DomainMapping):
    ...
    def __init__(self, RotationX: str, ScaleX: str, ScaleY: str, ScaleZ: str, RotationY: str, RotationZ: str, TranslationX: str, TranslationY: str, TranslationZ: str, avm_domainmapping_CAD2EDATransform: "eda_EDAModel" = None, avm_domainmapping_CAD2EDATransform295: "CADModel" = None):
...
class RFPort:
    ...
    pass
class avm_rf_RFModel(DomainModel_):
...
class SystemCPort:
    ...
    pass
class avm_systemc_SystemCModel(DomainModel_):
...
class spice_Parameter:
    ...
    pass
class avm_eda_CircuitLayout(DomainModel_):
...
class avm_eda_EDAModel(SchematicModel):
    ...
    def __init__(self, Library: str, DeviceSet: str, Device: str, Package: str, HasMultiLayerFootprint: str, avm_eda_EDAModel: set["eda_Parameter"] = None):
        ...
        pass
    @property
    def HasMultiLayerFootprint(self):
...
class avm_eda_RangeLayoutConstraint(PcbLayoutConstraint):
    ...
    def __init__(self, XRangeMin: str, XRangeMax: str, YRangeMin: str, Type: str, YRangeMax: str, LayerRange: str, avm_eda_RangeLayoutConstraint: set["eda_avm_ComponentInstance"] = None, avm_eda_RangeLayoutConstraint262: set["eda_avm_Container"] = None):
...
class Pin:
    ...
    pass
class avm_schematic_SchematicModel(DomainModel_):

    pass
class avm_cyber_CyberModel(DomainModel_):
...
class avm_manufacturing_ManufacturingModel(DomainModel_):
