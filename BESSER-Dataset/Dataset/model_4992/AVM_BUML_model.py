...
avm_Component.attributes={avm_Component_ID, avm_Component_Name, avm_Component_Version, avm_Component_Classifications, avm_Component_SchemaVersion, avm_Component_Supercedes}
...
avm_Property.attributes={avm_Property_OnDataSheet, avm_Property_YPosition, avm_Property_Definition, avm_Property_ID, avm_Property_XPosition, avm_Property_Name, avm_Property_Notes}
...
avm_Resource.attributes={avm_Resource_ID, avm_Resource_Hash, avm_Resource_XPosition, avm_Resource_Name, avm_Resource_Path, avm_Resource_Notes, avm_Resource_YPosition}
...
avm_Connector.attributes={avm_Connector_Definition, avm_Connector_Name, avm_Connector_YPosition, avm_Connector_Notes, avm_Connector_XPosition}
...
avm_Port.attributes={avm_Port_Name, avm_Port_YPosition, avm_Port_Definition, avm_Port_Notes, avm_Port_XPosition}
...
avm_DomainModel.attributes={avm_DomainModel_ID, avm_DomainModel_Notes, avm_DomainModel_XPosition, avm_DomainModel_Name, avm_DomainModel_YPosition, avm_DomainModel_Author}
...
avm_Value.attributes={avm_Value_Unit, avm_Value_DataType, avm_Value_DimensionType, avm_Value_Dimensions}
...
avm_DomainModelParameter.attributes={avm_DomainModelParameter_YPosition, avm_DomainModelParameter_Notes, avm_DomainModelParameter_XPosition}
...
avm_ComponentInstance.attributes={avm_ComponentInstance_Name, avm_ComponentInstance_ComponentID, avm_ComponentInstance_DesignSpaceSrcComponentID, avm_ComponentInstance_YPosition, avm_ComponentInstance_ID, avm_ComponentInstance_XPosition}
...
avm_Design.attributes={avm_Design_DesignID, avm_Design_DesignSpaceSrcID, avm_Design_Name, avm_Design_SchemaVersion}
...
avm_Container.attributes={avm_Container_YPosition, avm_Container_Description, avm_Container_ID, avm_Container_Name, avm_Container_XPosition}
...
avm_TestBenchValueBase.attributes={avm_TestBenchValueBase_ID, avm_TestBenchValueBase_XPosition, avm_TestBenchValueBase_Name, avm_TestBenchValueBase_YPosition, avm_TestBenchValueBase_Notes}
...
avm_modelica_Limit.attributes={avm_modelica_Limit_Name, avm_modelica_Limit_Notes, avm_modelica_Limit_ToleranceTimeWindow, avm_modelica_Limit_VariableLocator, avm_modelica_Limit_BoundType}
...
avm_modelica_SolverSettings.attributes={avm_modelica_SolverSettings_StartTime, avm_modelica_SolverSettings_JobManagerToolSelection, avm_modelica_SolverSettings_IntervalLength, avm_modelica_SolverSettings_NumberOfIntervals, avm_modelica_SolverSettings_ToolSpecificAnnotations, avm_modelica_SolverSettings_Solver, avm_modelica_SolverSettings_Tolerance, avm_modelica_SolverSettings_IntervalMethod, avm_modelica_SolverSettings_StopTime}
...
avm_cyber_CyberModel.attributes={avm_cyber_CyberModel_Locator, avm_cyber_CyberModel_Class, avm_cyber_CyberModel_Type}
...
avm_schematic_Pin.attributes={avm_schematic_Pin_EDASymbolRotation, avm_schematic_Pin_EDAGate, avm_schematic_Pin_EDASymbolLocationY, avm_schematic_Pin_SPICEPortNumber, avm_schematic_Pin_EDASymbolLocationX}
...
avm_eda_PcbLayoutConstraint.attributes={avm_eda_PcbLayoutConstraint_XPosition, avm_eda_PcbLayoutConstraint_Notes, avm_eda_PcbLayoutConstraint_YPosition}
...
avm_eda_RangeLayoutConstraint.attributes={avm_eda_RangeLayoutConstraint_YRangeMin, avm_eda_RangeLayoutConstraint_LayerRange, avm_eda_RangeLayoutConstraint_XRangeMin, avm_eda_RangeLayoutConstraint_YRangeMax, avm_eda_RangeLayoutConstraint_XRangeMax, avm_eda_RangeLayoutConstraint_Type}
...
avm_eda_EDAModel.attributes={avm_eda_EDAModel_HasMultiLayerFootprint, avm_eda_EDAModel_Device, avm_eda_EDAModel_Library, avm_eda_EDAModel_Package, avm_eda_EDAModel_DeviceSet}
...
avm_eda_RelativeLayoutConstraint.attributes={avm_eda_RelativeLayoutConstraint_YOffset, avm_eda_RelativeLayoutConstraint_XOffset, avm_eda_RelativeLayoutConstraint_RelativeLayer, avm_eda_RelativeLayoutConstraint_RelativeRotation}
...
avm_eda_RelativeRangeLayoutConstraint.attributes={avm_eda_RelativeRangeLayoutConstraint_YRelativeRangeMin, avm_eda_RelativeRangeLayoutConstraint_XRelativeRangeMin, avm_eda_RelativeRangeLayoutConstraint_XRelativeRangeMax, avm_eda_RelativeRangeLayoutConstraint_RelativeLayer, avm_eda_RelativeRangeLayoutConstraint_YRelativeRangeMax}
...
avm_systemc_Parameter.attributes={avm_systemc_Parameter_ParamName, avm_systemc_Parameter_ParamPosition}
...
avm_rf_RFModel.attributes={avm_rf_RFModel_X, avm_rf_RFModel_Y, avm_rf_RFModel_Rotation}
...
avm_domainmapping_CAD2EDATransform.attributes={avm_domainmapping_CAD2EDATransform_RotationX, avm_domainmapping_CAD2EDATransform_RotationZ, avm_domainmapping_CAD2EDATransform_ScaleX, avm_domainmapping_CAD2EDATransform_RotationY, avm_domainmapping_CAD2EDATransform_ScaleZ, avm_domainmapping_CAD2EDATransform_TranslationY, avm_domainmapping_CAD2EDATransform_ScaleY, avm_domainmapping_CAD2EDATransform_TranslationZ, avm_domainmapping_CAD2EDATransform_TranslationX}
...
domain_model = DomainModel(
    name="avm",
    types={avm_Component, avm_Property, avm_Resource, avm_Connector, avm_DistributionRestriction, avm_Port, avm_AnalysisConstruct, avm_Formula, avm_DomainMapping, avm_DomainModel, ValueNode, avm_ValueExpressionType, avm_DataSource, avm_FixedValue, ValueExpressionType, avm_CalculatedValue, avm_DerivedValue, avm_ValueNode, ConnectorCompositionTarget, avm_Value, avm_assemblyDetail, avm_ConnectorFeature, PortMapTarget, avm_DomainModelPort, Port, avm_DomainModelParameter, avm_ParametricValue, avm_ProbabilisticValue, avm_NormalDistribution, ProbabilisticValue, avm_SecurityClassification, DistributionRestriction, avm_Proprietary, avm_ITAR, avm_DomainModelMetric, avm_UniformDistribution, avm_PrimitiveProperty, Property_, avm_CompoundProperty, avm_ParametricEnumeratedValue, avm_AbstractPort, avm_DesignDomainFeature, avm_ComponentInstance, avm_ContainerFeature, avm_Design, avm_Container, avm_ComponentPortInstance, avm_ComponentPrimitivePropertyInstance, avm_ComponentConnectorInstance, avm_DesignSpaceContainer, avm_PortMapTarget, avm_ConnectorCompositionTarget, avm_Compound, Container, avm_Optional, DesignSpaceContainer, avm_Alternative, avm_ValueFlowMux, avm_ComplexFormula, avm_Operand, avm_DoDDistributionStatement, avm_TestBench, avm_TopLevelSystemUnderTest, avm_Parameter, avm_Metric, avm_SimpleFormula, Formula, ContainerInstanceBase, TestBenchValueBase, avm_ContainerInstanceBase, avm_TestBenchValueBase, avm_WorkflowTaskBase, avm_InterpreterTask, WorkflowTaskBase, avm_ExecutionTask, avm_TestInjectionPoint, avm_Workflow, avm_Settings, Parameter_, Connector, Metric, Limit, Redeclare, avm_modelica_Connector, DomainModelPort, avm_modelica_Parameter, DomainModelParameter, modelica_avm_Value, avm_modelica_Metric, DomainModelMetric, avm_modelica_Limit, avm_modelica_ModelicaModel, DomainModel_, avm_modelica_Redeclare, avm_modelica_SolverSettings, Settings, Datum, avm_cad_Datum, avm_cad_Parameter, cad_avm_Value, avm_cad_Point, avm_cad_Axis, avm_cad_Plane, Plane, avm_cad_CoordinateSystem, avm_cad_Metric, avm_cad_Geometry, AnalysisConstruct, avm_cad_CADModel, avm_cad_Polygon, avm_cad_ExtrudedGeometry, Geometry3D, avm_cad_Sphere, avm_cad_CustomGeometry, CustomGeometryInput, avm_cad_CustomGeometryInput, avm_cad_PointReference, Point, avm_cad_Geometry2D, Geometry, avm_cad_Geometry3D, avm_cad_Circle, Geometry2D, PointReference, avm_cad_GuideDatum, ConnectorFeature, avm_cad_AssemblyRoot, DesignDomainFeature, cad_avm_ComponentInstance, avm_cad_KinematicJointSpec, avm_cad_RevoluteJointSpec, KinematicJointSpec, Axis, avm_cad_TranslationalJointSpec, avm_cad_Surface, PlaneReference, avm_cad_PlaneReference, avm_manufacturing_ManufacturingModel, avm_manufacturing_Parameter, manufacturing_avm_Value, avm_manufacturing_Metric, avm_cyber_CyberModel, avm_schematic_SchematicModel, Pin, avm_schematic_Pin, eda_Parameter, avm_eda_Parameter, eda_avm_Value, avm_eda_PcbLayoutConstraint, ContainerFeature, avm_eda_ExactLayoutConstraint, PcbLayoutConstraint, eda_avm_ComponentInstance, eda_avm_Container, avm_eda_RangeLayoutConstraint, avm_eda_EDAModel, SchematicModel, avm_eda_RelativeLayoutConstraint, avm_eda_RelativeRangeLayoutConstraint, avm_eda_CircuitLayout, avm_spice_SPICEModel, spice_Parameter, avm_spice_Parameter, spice_avm_Value, avm_systemc_SystemCModel, SystemCPort, avm_systemc_Parameter, avm_eda_GlobalLayoutConstraintException, avm_rf_RFModel, RFPort, avm_rf_RFPort, avm_domainmapping_CAD2EDATransform, DomainMapping, systemc_avm_Value, avm_systemc_SystemCPort, eda_EDAModel, CADModel, CalculationTypeEnum, DimensionTypeEnum, DataTypeEnum, SimpleFormulaOperation, DoDDistributionStatementEnum, BoundTypeEnum, RedeclareTypeEnum, IntervalMethod, JobManagerToolSelection, CustomGeometryInputOperationEnum, PartIntersectionEnum, GeometryQualifierEnum, FileFormat, ModelType, LayerEnum, LayerRangeEnum, RelativeLayerEnum, RangeConstraintTypeEnum, GlobalConstraintTypeEnum, RelativeRotationEnum, SystemCDataTypeEnum, DirectionalityEnum, FunctionEnum, RotationEnum, PortDirectionality},
    associations={Property1, ResourceDependency3, Connector5, DistributionRestriction7, Port9, AnalysisConstruct11, Formula13, DomainMapping15, UsesResource17, DomainModel0, ValueExpression20, DataSource21, ValueSource23, Role24, DefaultJoin30, Connector33, ConnectorFeature35, Default37, Maximum39, Minimum42, AssignedValue45, Mean48, StandardDeviation50, Property27, Value53, Value55, CompoundProperty58, PrimitiveProperty59, AssignedValue62, Enum63, DomainFeature70, ResourceDependency72, Container76, Property78, ComponentInstance81, Port83, Connector86, JoinData89, Formula92, ContainerFeature95, ResourceDependency97, DomainModel100, FromResource66, RootContainer69, ValueFlowMux106, PortInstance107, PrimitivePropertyInstance109, ConnectorInstance111, Value113, PortMap117, ConnectorComposition119, ApplyJoinData120, Resource103, Operand123, Operand125, ValueSource126, TopLevelSystemUnderTest129, Parameter130, Metric132, Settings141, TestStructure143, Value146, Task148, TestInjectionPoint134, TestComponent136, Workflow139, Parameter153, Connector154, Metric156, Limit158, Redeclare160, Parameter162, Redeclare164, Value167, Source150, Value170, TargetValue168, Datum172, Parameter173, ModelMetric176, DatumMetric179, Value181, SurfaceReverseMap182, Metric183, CircleEdge186, PolygonPoint189, ExtrusionHeight191, ExtrusionSurface193, SphereCenter195, SphereEdge197, CustomGeometryInput200, InputGeometry201, ReferredPoint202, CircleCenter185, ReferredPlane204, Datum206, AssemblyRootComponentInstance208, AlignmentPlane209, AlignmentAxis211, RotationLimitReference213, MinimumRotation216, DefaultRotation219, MaximumRotation222, AlignmentPlane225, AlignmentAxis227, ReferencePlane203, Parameter242, Metric244, Value247, Connector248, Parameter250, Pin253, MinimumTranslation230, DefaultTranslation233, MaximumTranslation236, TranslationLimitReference239, Parameter254, Value255, ConstraintTarget256, ContainerConstraintTarget257, ConstraintTarget264, Origin266, ContainerConstraintTarget269, ContainerConstraintTarget272, ConstraintTarget259, ContainerConstraintTarget261, ConstraintTarget280, ContainerConstraintTarget282, Parameter285, Value286, SystemCPort287, Parameter288, Origin274, ConstraintTarget277, RFPort292, Value291, EDAModel293, CADModel294},
    generalizations={gen_avm_Value_ValueNode, gen_avm_FixedValue_ValueExpressionType, gen_avm_CalculatedValue_ValueExpressionType, gen_avm_DerivedValue_ValueExpressionType, gen_avm_Connector_ConnectorCompositionTarget, gen_avm_Port_PortMapTarget, gen_avm_DomainModelPort_Port, gen_avm_ParametricValue_ValueExpressionType, gen_avm_ProbabilisticValue_ValueExpressionType, gen_avm_NormalDistribution_ProbabilisticValue, gen_avm_SecurityClassification_DistributionRestriction, gen_avm_Proprietary_DistributionRestriction, gen_avm_ITAR_DistributionRestriction, gen_avm_UniformDistribution_ProbabilisticValue, gen_avm_PrimitiveProperty_Property, gen_avm_CompoundProperty_Property, gen_avm_ParametricEnumeratedValue_ValueExpressionType, gen_avm_AbstractPort_Port, gen_avm_ComponentPortInstance_PortMapTarget, gen_avm_DesignSpaceContainer_Container, gen_avm_ComponentConnectorInstance_ConnectorCompositionTarget, gen_avm_Compound_Container, gen_avm_Optional_DesignSpaceContainer, gen_avm_Alternative_DesignSpaceContainer, gen_avm_ComplexFormula_Formula, gen_avm_DoDDistributionStatement_DistributionRestriction, gen_avm_Formula_ValueNode, gen_avm_SimpleFormula_Formula, gen_avm_TopLevelSystemUnderTest_ContainerInstanceBase, gen_avm_Parameter_TestBenchValueBase, gen_avm_Metric_TestBenchValueBase, gen_avm_TestInjectionPoint_ContainerInstanceBase, gen_avm_InterpreterTask_WorkflowTaskBase, gen_avm_ExecutionTask_WorkflowTaskBase, gen_avm_modelica_Connector_DomainModelPort, gen_avm_modelica_Parameter_DomainModelParameter, gen_avm_modelica_Metric_DomainModelMetric, gen_avm_ValueFlowMux_ValueNode, gen_avm_modelica_ModelicaModel_DomainModel, gen_avm_modelica_Redeclare_DomainModelParameter, gen_avm_modelica_SolverSettings_Settings, gen_avm_cad_Datum_DomainModelPort, gen_avm_cad_Parameter_DomainModelParameter, gen_avm_cad_Point_Datum, gen_avm_cad_Axis_Datum, gen_avm_cad_Plane_Datum, gen_avm_cad_CoordinateSystem_Datum, gen_avm_cad_Metric_DomainModelMetric, gen_avm_cad_Geometry_AnalysisConstruct, gen_avm_cad_CADModel_DomainModel, gen_avm_cad_Polygon_Geometry2D, gen_avm_cad_ExtrudedGeometry_Geometry3D, gen_avm_cad_Sphere_Geometry3D, gen_avm_cad_CustomGeometry_Geometry, gen_avm_cad_Geometry2D_Geometry, gen_avm_cad_Geometry3D_Geometry, gen_avm_cad_Circle_Geometry2D, gen_avm_cad_GuideDatum_ConnectorFeature, gen_avm_cad_AssemblyRoot_DesignDomainFeature, gen_avm_cad_KinematicJointSpec_ConnectorFeature, gen_avm_cad_RevoluteJointSpec_KinematicJointSpec, gen_avm_cad_TranslationalJointSpec_KinematicJointSpec, gen_avm_cad_Surface_Geometry3D, gen_avm_manufacturing_ManufacturingModel_DomainModel, gen_avm_manufacturing_Parameter_DomainModelParameter, gen_avm_manufacturing_Metric_DomainModelMetric, gen_avm_cyber_CyberModel_DomainModel, gen_avm_schematic_SchematicModel_DomainModel, gen_avm_schematic_Pin_DomainModelPort, gen_avm_eda_Parameter_DomainModelParameter, gen_avm_eda_PcbLayoutConstraint_ContainerFeature, gen_avm_eda_ExactLayoutConstraint_PcbLayoutConstraint, gen_avm_eda_RangeLayoutConstraint_PcbLayoutConstraint, gen_avm_eda_EDAModel_SchematicModel, gen_avm_eda_RelativeLayoutConstraint_PcbLayoutConstraint, gen_avm_eda_RelativeRangeLayoutConstraint_PcbLayoutConstraint, gen_avm_eda_CircuitLayout_DomainModel, gen_avm_spice_SPICEModel_SchematicModel, gen_avm_spice_Parameter_DomainModelParameter, gen_avm_systemc_SystemCModel_DomainModel, gen_avm_systemc_Parameter_DomainModelParameter, gen_avm_eda_GlobalLayoutConstraintException_PcbLayoutConstraint, gen_avm_rf_RFModel_DomainModel, gen_avm_rf_RFPort_DomainModelPort, gen_avm_domainmapping_CAD2EDATransform_DomainMapping, gen_avm_systemc_SystemCPort_DomainModelPort},
    metadata=None
)
