...
myDsl_DataType = Class(name="myDsl_DataType")
Type = Class(name="Type")
myDsl_Import = Class(name="myDsl_Import")
myDsl_Entity = Class(name="myDsl_Entity")
myDsl_Model = Class(name="myDsl_Model")
myDsl_AbstractElement = Class(name="myDsl_AbstractElement")
myDsl_PackageDeclaration = Class(name="myDsl_PackageDeclaration")
...
domain_model = DomainModel(
    name="myDsl",
    types={myDsl_Type, myDsl_DataType, Type, myDsl_Import, myDsl_Entity, myDsl_Model, myDsl_AbstractElement, myDsl_PackageDeclaration, AbstractElement, myDsl_Feature},
    associations={elements0, elements1, superType4, features5, type7},
    generalizations={gen_myDsl_Type_AbstractElement, gen_myDsl_DataType_Type, gen_myDsl_Import_AbstractElement, gen_myDsl_Entity_Type, gen_myDsl_PackageDeclaration_AbstractElement},
    metadata=None
)
