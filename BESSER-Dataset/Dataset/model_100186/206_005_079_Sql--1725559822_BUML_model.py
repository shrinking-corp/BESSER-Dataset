...
sql_Star = Class(name="sql_Star")
sql_Div = Class(name="sql_Div")
...
sql_FullExpression.attributes={sql_FullExpression_notPrm, sql_FullExpression_c, sql_FullExpression_isnull}
...
sql_ScalarOperand.attributes={sql_ScalarOperand_sodt, sql_ScalarOperand_sostr, sql_ScalarOperand_soint, sql_ScalarOperand_sodbl, sql_ScalarOperand_sodate, sql_ScalarOperand_sotime}
...
domain_model = DomainModel(
    name="sql",
    types={sql_SelectQuery, sql_FetchFirst, sql_IntegerValue, sql_Model, sql_SelectSubSet, sql_Select, SelectQuery, sql_Offset, sql_Limit, sql_OrGroupByColumn, sql_OrOrderByColumn, sql_OrColumn, sql_OrTable, sql_OrExpr, PivotForClause, sql_ColumnOrAlias, OrColumn, sql_Operands, sql_ColumnFull, sql_FromTable, OrTable, sql_TableOrAlias, sql_DbObjectName, sql_DbObjectNameAll, sql_TableFull, sql_SubQueryOperand, sql_PivotTable, sql_UnpivotTable, sql_FromTableJoin, sql_PivotForClause, sql_PivotInClause, sql_PivotFunctions, sql_UnpivotInClauseArgs, sql_PivotColumns, sql_UnpivotInClause, sql_PivotFunction, sql_UnpivotInClauseArg, UnpivotInClauseArgs, sql_Pivots, PivotColumns, sql_PivotCol, PivotFunction, Pivots, ColumnFull, PivotCol, TableFull, OrOrderByColumn, sql_GroupByColumnFull, OrGroupByColumn, sql_OpFunction, sql_OrderByColumnFull, OrExpr, sql_Between, sql_ExprGroup, sql_XExpr, sql_InOper, sql_ExistsOper, sql_FullExpression, sql_Like, sql_Comparison, sql_JRParameter, Prms, sql_Prms, sql_OpFunctionCast, sql_POperand, sql_LikeOperand, sql_OperandListGroup, sql_Operand, sql_OperandList, OpFunctionArgAgregate, sql_FunctionExtract, sql_SQLCaseOperand, sql_ColumnOperand, sql_OpFunctionArg, sql_FunctionAnalytical, sql_ExpOperand, sql_ScalarOperand, sql_OrderByClause, sql_WindowingClause, sql_WindowingClauseBetween, WindowingClause, sql_AnalyticClause, sql_QueryPartitionClause, sql_AnalyticExprArg, sql_WindowingClauseOperandPreceding, sql_WindowingClauseOperandFollowing, sql_AnalyticExprArgs, QueryPartitionClause, sql_OrderByClauseArgs, sql_OrderByClauseArg, OrderByClauseArgs, sql_OpFunctionArgOperand, OpFunctionArg, sql_OpFunctionArgAgregate, AnalyticExprArgs, OperandList, sql_SQLCaseWhens, sql_SqlCaseWhen, SQLCaseWhens, sql_Col, sql_uicargs, sql_pvcs, sql_pcols, sql_tbls, sql_UnipivotInClause, UnpivotInClause, sql_Plus, Operands, sql_Minus, sql_Star, sql_Div, sql_Concat, sql_OBCArgs, sql_AExpArgs, sql_OpList, sql_WhenList, sql_OpFList, EXTRACT_VALUES, XFunction},
    associations={query0, fetchFirst1, query4, op5, l22, groupByEntry14, havingEntry16, orderByEntry19, lim21, cols8, tbl10, whereExpression12, entries29, ce31, offset24, fetchFirst26, entries37, table39, colAlias33, dbAllCols35, tfull49, sq51, pivot53, unpivot55, fjoin41, onTable43, joinExpr46, pfun60, pfor62, pin64, tblAlias57, args69, pcols71, pfor73, inop76, sq66, cfuls80, pcols78, colOrder85, entries87, colGrBy89, gbFunction92, entries83, op1110, efrag97, expgroup99, exp102, xexp104, in_106, exists108, entries94, between113, like115, comp117, prm125, entries127, op2129, expr119, col122, fcast137, fparam139, op2141, op3144, op2132, fop2134, subquery147, opList150, subquery152, opList155, op1160, left163, right165, opGroup158, subq173, fcast176, fext179, func181, sqlcase184, param186, column168, xop171, args193, fan195, operand197, eparam189, scalar191, abc202, obc204, winc206, anClause200, exp211, expr213, wcoP208, wcoF209, col218, args220, args216, colAlias225, op228, op229, ce222, cfull232, sel235, when241, expr243, texp245, expr238, eexp248, entries251, entries255, entries257, entries258, args253, entries264, entries260, entries262, entries268, entries270, entries266},
    generalizations={gen_sql_Select_SelectQuery, gen_sql_OrColumn_PivotForClause, gen_sql_ColumnOrAlias_OrColumn, gen_sql_ColumnFull_PivotForClause, gen_sql_FromTable_OrTable, gen_sql_Pivots_PivotColumns, gen_sql_PivotCol_PivotFunction, gen_sql_PivotCol_PivotColumns, gen_sql_PivotCol_Pivots, gen_sql_DbObjectName_ColumnFull, gen_sql_DbObjectName_PivotCol, gen_sql_DbObjectName_TableFull, gen_sql_UnpivotInClauseArg_UnpivotInClauseArgs, gen_sql_OrderByColumnFull_OrOrderByColumn, gen_sql_GroupByColumnFull_OrGroupByColumn, gen_sql_FullExpression_OrExpr, gen_sql_JRParameter_Prms, gen_sql_Operands_OpFunctionArgAgregate, gen_sql_WindowingClauseBetween_WindowingClause, gen_sql_WindowingClauseOperandPreceding_WindowingClause, gen_sql_AnalyticExprArgs_QueryPartitionClause, gen_sql_OrderByClauseArg_OrderByClauseArgs, gen_sql_OpFunctionArgOperand_OpFunctionArg, gen_sql_AnalyticExprArg_AnalyticExprArgs, gen_sql_ScalarOperand_OperandList, gen_sql_SqlCaseWhen_SQLCaseWhens, gen_sql_Col_ColumnFull, gen_sql_uicargs_UnpivotInClauseArgs, gen_sql_pvcs_Pivots, gen_sql_pcols_PivotCol, gen_sql_tbls_TableFull, gen_sql_UnipivotInClause_UnpivotInClause, gen_sql_Plus_Operands, gen_sql_Minus_Operands, gen_sql_Star_Operands, gen_sql_Div_Operands, gen_sql_Concat_Operands, gen_sql_OBCArgs_OrderByClauseArgs, gen_sql_AExpArgs_AnalyticExprArgs, gen_sql_OpList_OperandList, gen_sql_OpFList_OpFunctionArg, gen_sql_WhenList_SQLCaseWhens},
    metadata=None
)
