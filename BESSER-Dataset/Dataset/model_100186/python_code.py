...
class sql_FunctionExtract:
    ...
    def __init__(self, v: str, sql_FunctionExtract: "sql_Operand" = None, sql_FunctionExtract198: "sql_Operands" = None):
        self.v = v
...
class sql_XExpr:
    ...
    def __init__(self, xf: str, sql_XExpr: "sql_FullExpression" = None, sql_XExpr126: "sql_Prms" = None, sql_XExpr123: "sql_Operands" = None):
        self.xf = xf
...
class sql_FullExpression(OrExpr):
    ...
    def __init__(self, isnull: str, c: str, notPrm: str, sql_FullExpression111: "sql_Operands" = None, sql_FullExpression98: "sql_FullExpression" = None, sql_FullExpression96: "sql_FullExpression" = None, sql_FullExpression100: "sql_ExprGroup" = None, sql_FullExpression103: "sql_FullExpression" = None, sql_FullExpression101: "sql_FullExpression" = None, sql_FullExpression105: "sql_XExpr" = None, sql_FullExpression107: "sql_InOper" = None, sql_FullExpression109: "sql_ExistsOper" = None, sql_FullExpression: "sql_OrExpr" = None, sql_FullExpression114: "sql_Between" = None, sql_FullExpression116: "sql_Like" = None, sql_FullExpression118: "sql_Comparison" = None):
        self.isnull = isnull
        self.c = c
        self.notPrm = notPrm
...
class sql_OpFunction:
    ...
    def __init__(self, fname: str, sql_OpFunction136: "sql_LikeOperand" = None, sql_OpFunction: "sql_GroupByColumnFull" = None, sql_OpFunction183: "sql_Operand" = None, sql_OpFunction194: "sql_OpFunctionArg" = None, sql_OpFunction196: "sql_FunctionAnalytical" = None):
        self.fname = fname
...
class PivotColumns:
    ...
    pass
class sql_PivotCol(Pivots, PivotColumns, PivotFunction):
...
class sql_PivotInClause:
    ...
    def __init__(self, pinany: str, sql_PivotInClause: "sql_PivotTable" = None, sql_PivotInClause70: "sql_UnpivotInClauseArgs" = None, sql_PivotInClause67: "sql_SubQueryOperand" = None):
        self.pinany = pinany
...
class sql_DbObjectName(PivotCol, ColumnFull, TableFull):
    ...
    def __init__(self, dbname: str, sql_DbObjectName: "sql_ColumnOrAlias" = None, sql_DbObjectName59: "sql_TableOrAlias" = None, sql_DbObjectName252: "sql_Col" = None, sql_DbObjectName227: "sql_AnalyticExprArg" = None, sql_DbObjectName259: "sql_pcols" = None, sql_DbObjectName261: "sql_tbls" = None):
        self.dbname = dbname
...
class sql_TableOrAlias:
    ...
    def __init__(self, alias: str, sql_TableOrAlias: "sql_FromTable" = None, sql_TableOrAlias50: "sql_TableFull" = None, sql_TableOrAlias52: "sql_SubQueryOperand" = None, sql_TableOrAlias54: "sql_PivotTable" = None, sql_TableOrAlias56: "sql_UnpivotTable" = None, sql_TableOrAlias45: "sql_FromTableJoin" = None, sql_TableOrAlias58: "sql_DbObjectName" = None):
        self.alias = alias
...
class sql_Select(SelectQuery):
    ...
    def __init__(self, select: str, sql_Select9: "sql_OrColumn" = None, sql_Select11: "sql_OrTable" = None, sql_Select: "sql_SelectSubSet" = None, sql_Select6: set["sql_SelectSubSet"] = None, sql_Select15: "sql_OrGroupByColumn" = None, sql_Select17: "sql_OrExpr" = None, sql_Select20: "sql_OrOrderByColumn" = None, sql_Select22: "sql_Limit" = None, sql_Select13: "sql_OrExpr" = None, sql_Select25: "sql_Offset" = None, sql_Select27: "sql_FetchFirst" = None):
        self.select = select
