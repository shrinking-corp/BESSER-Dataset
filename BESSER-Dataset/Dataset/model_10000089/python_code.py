...
class Account:
    ...
    def __init__(self, billingAddress: str, open: date, closed: date, isClosed: bool, p0: set["Payment"] = None, customer7: "Customer" = None, order16: set["Order"] = None, cart8: "ShoppingCart" = None):
...
class ShoppingCart:
    ...
    def __init__(self, creationDate: date, webUser3: "WebUser" = None, items10: "LineItem" = None, account9: "Account" = None):
