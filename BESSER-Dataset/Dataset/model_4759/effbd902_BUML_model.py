...
# Classes
effbd902_Description = Class(name="effbd902_Description")
effbd902_Function = Class(name="effbd902_Function")
SequenceNode = Class(name="SequenceNode")
ProcessNode = Class(name="ProcessNode")
AbstractFunction = Class(name="AbstractFunction")
effbd902_AbstractFunction = Class(name="effbd902_AbstractFunction", is_abstract=True)
effbd902_Sequence = Class(name="effbd902_Sequence", is_abstract=True)
effbd902_Flow = Class(name="effbd902_Flow")
effbd902_OutputPort = Class(name="effbd902_OutputPort")
effbd902_InputPort = Class(name="effbd902_InputPort")
effbd902_Token = Class(name="effbd902_Token")
effbd902_SequenceNode = Class(name="effbd902_SequenceNode", is_abstract=True)
effbd902_And = Class(name="effbd902_And")
Sequence = Class(name="Sequence")
effbd902_Or = Class(name="effbd902_Or")
effbd902_Start = Class(name="effbd902_Start")
effbd902_Final = Class(name="effbd902_Final")
effbd902_Loop = Class(name="effbd902_Loop")
Port = Class(name="Port")
effbd902_Port = Class(name="effbd902_Port", is_abstract=True)
effbd902_Item = Class(name="effbd902_Item")
effbd902_ProcessNode = Class(name="effbd902_ProcessNode", is_abstract=True)
effbd902_LoopExit = Class(name="effbd902_LoopExit")
effbd902_Iteration = Class(name="effbd902_Iteration")
...
effbd902_SequenceNode.attributes={effbd902_SequenceNode_tMin, effbd902_SequenceNode_name, effbd902_SequenceNode_tMax}
...
domain_model = DomainModel(
    name="effbd902",
    types={effbd902_Description, effbd902_Function, SequenceNode, ProcessNode, AbstractFunction, effbd902_AbstractFunction, effbd902_Sequence, effbd902_Flow, effbd902_OutputPort, effbd902_InputPort, effbd902_Token, effbd902_SequenceNode, effbd902_And, Sequence, effbd902_Or, effbd902_Start, effbd902_Final, effbd902_Loop, Port, effbd902_Port, effbd902_Item, effbd902_ProcessNode, effbd902_LoopExit, effbd902_Iteration, FunctionDomain},
    associations={inputPorts7, descriptions9, decompositions0, sequenceNodes1, flows3, outputPorts5, inputflowEdge15, tokens11, controlFlowEdge14, items18, outputflowEdge20},
    generalizations={gen_effbd902_Function_SequenceNode, gen_effbd902_Function_ProcessNode, gen_effbd902_Function_AbstractFunction, gen_effbd902_Flow_ProcessNode, gen_effbd902_Sequence_SequenceNode, gen_effbd902_And_Sequence, gen_effbd902_Or_Sequence, gen_effbd902_Start_Sequence, gen_effbd902_Final_Sequence, gen_effbd902_Loop_Sequence, gen_effbd902_InputPort_Port, gen_effbd902_OutputPort_Port, gen_effbd902_LoopExit_Sequence, gen_effbd902_Iteration_Sequence},
    metadata=None
)
