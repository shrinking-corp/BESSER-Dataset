...
class nocollectionowner_Product:
    ...
    def __init__(self, name: str, number: str, description: str, Product: "nocollectionowner_ProductCategory" = None, nocollectionowner_Product: "nocollectionowner_PriceCategory" = None, nocollectionowner_Product13: "nocollectionowner_Transaction" = None, products: "nocollectionowner_ProductCategory" = None):
        self.name = name
        self.number = number
