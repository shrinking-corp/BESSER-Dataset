...
# Classes
nocollectionowner_Product = Class(name="nocollectionowner_Product")
nocollectionowner_Customer = Class(name="nocollectionowner_Customer")
nocollectionowner_Order = Class(name="nocollectionowner_Order")
nocollectionowner_Transaction = Class(name="nocollectionowner_Transaction")
nocollectionowner_ProductCategory = Class(name="nocollectionowner_ProductCategory")
nocollectionowner_PriceCategory = Class(name="nocollectionowner_PriceCategory")
...
nocollectionowner_Product.attributes={nocollectionowner_Product_name, nocollectionowner_Product_description, nocollectionowner_Product_number}
...
nocollectionowner_Customer.attributes={nocollectionowner_Customer_hotel, nocollectionowner_Customer_surname, nocollectionowner_Customer_comments, nocollectionowner_Customer_telephoneNr, nocollectionowner_Customer_familyName, nocollectionowner_Customer_address}
...
nocollectionowner_Order.attributes={nocollectionowner_Order_comments, nocollectionowner_Order_number}
...
nocollectionowner_Transaction.attributes={nocollectionowner_Transaction_number, nocollectionowner_Transaction_paidDate, nocollectionowner_Transaction_endDate, nocollectionowner_Transaction_startDate, nocollectionowner_Transaction_price}
...
nocollectionowner_PriceCategory.attributes={nocollectionowner_PriceCategory_prices, nocollectionowner_PriceCategory_name}
...
domain_model = DomainModel(
    ...
    types={nocollectionowner_Product, nocollectionowner_Customer, nocollectionowner_Order, nocollectionowner_Transaction, nocollectionowner_ProductCategory, nocollectionowner_PriceCategory},
    associations={products2, subCategorys4, parent7, transactions9, customer10, order11, product12, productCategory0, priceCategory1},
    generalizations={},
    metadata=None
)
