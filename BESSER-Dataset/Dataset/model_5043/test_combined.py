...
def test_hyp_nocollectionowner_pricecategory_is_not_abstract():
    assert not inspect.isabstract(nocollectionowner_PriceCategory)


def test_hyp_nocollectionowner_pricecategory_constructor_exists():
    assert callable(nocollectionowner_PriceCategory.__init__)


def test_hyp_nocollectionowner_pricecategory_constructor_args():
...
def test_hyp_nocollectionowner_productcategory_is_not_abstract():
    assert not inspect.isabstract(nocollectionowner_ProductCategory)


def test_hyp_nocollectionowner_productcategory_constructor_exists():
    assert callable(nocollectionowner_ProductCategory.__init__)


def test_hyp_nocollectionowner_productcategory_constructor_args():
...
def test_hyp_nocollectionowner_transaction_is_not_abstract():
    assert not inspect.isabstract(nocollectionowner_Transaction)


def test_hyp_nocollectionowner_transaction_constructor_exists():
    assert callable(nocollectionowner_Transaction.__init__)


def test_hyp_nocollectionowner_transaction_constructor_args():
...
def test_hyp_nocollectionowner_order_is_not_abstract():
    assert not inspect.isabstract(nocollectionowner_Order)


def test_hyp_nocollectionowner_order_constructor_exists():
    assert callable(nocollectionowner_Order.__init__)


def test_hyp_nocollectionowner_order_constructor_args():
...
def test_hyp_nocollectionowner_customer_is_not_abstract():
    assert not inspect.isabstract(nocollectionowner_Customer)


def test_hyp_nocollectionowner_customer_constructor_exists():
    assert callable(nocollectionowner_Customer.__init__)


def test_hyp_nocollectionowner_customer_constructor_args():
...
def test_hyp_nocollectionowner_product_is_not_abstract():
    assert not inspect.isabstract(nocollectionowner_Product)


def test_hyp_nocollectionowner_product_constructor_exists():
    assert callable(nocollectionowner_Product.__init__)


def test_hyp_nocollectionowner_product_constructor_args():
...
def test_hyp_nocollectionowner_pricecategory_prices_setter(instance):
...
@given(instance=nocollectionowner_PriceCategory_strategy)
def test_hyp_nocollectionowner_pricecategory_name_setter(instance):
...
def test_hyp_nocollectionowner_productcategory_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_nocollectionowner_transaction_price_setter(instance):
...
@given(instance=nocollectionowner_Transaction_strategy)
def test_hyp_nocollectionowner_transaction_endDate_setter(instance):
...
@given(instance=nocollectionowner_Transaction_strategy)
def test_hyp_nocollectionowner_transaction_number_setter(instance):
...
@given(instance=nocollectionowner_Transaction_strategy)
def test_hyp_nocollectionowner_transaction_paidDate_setter(instance):
...
@given(instance=nocollectionowner_Transaction_strategy)
def test_hyp_nocollectionowner_transaction_startDate_setter(instance):
...
def test_hyp_nocollectionowner_order_number_setter(instance):
    original = instance.number
    instance.number = original
    assert instance.number == original
...
@given(instance=nocollectionowner_Order_strategy)
def test_hyp_nocollectionowner_order_comments_setter(instance):
...
def test_hyp_nocollectionowner_customer_comments_setter(instance):
    original = instance.comments
    instance.comments = original
    assert instance.comments == original
...
@given(instance=nocollectionowner_Customer_strategy)
def test_hyp_nocollectionowner_customer_hotel_setter(instance):
...
@given(instance=nocollectionowner_Customer_strategy)
def test_hyp_nocollectionowner_customer_telephoneNr_setter(instance):
...
@given(instance=nocollectionowner_Customer_strategy)
def test_hyp_nocollectionowner_customer_familyName_setter(instance):
...
@given(instance=nocollectionowner_Customer_strategy)
def test_hyp_nocollectionowner_customer_surname_setter(instance):
...
@given(instance=nocollectionowner_Customer_strategy)
def test_hyp_nocollectionowner_customer_address_setter(instance):
...
def test_hyp_nocollectionowner_product_number_setter(instance):
    original = instance.number
    instance.number = original
    assert instance.number == original
...
@given(instance=nocollectionowner_Product_strategy)
def test_hyp_nocollectionowner_product_description_setter(instance):
...
@given(instance=nocollectionowner_Product_strategy)
def test_hyp_nocollectionowner_product_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
