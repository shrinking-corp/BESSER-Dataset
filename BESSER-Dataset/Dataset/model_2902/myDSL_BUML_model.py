...
# Classes
myDSL_Type = Class(name="myDSL_Type", is_abstract=True)
...
myDSL_NamedElement = Class(name="myDSL_NamedElement", is_abstract=True)
myDSL_EntityModel = Class(name="myDSL_EntityModel")
...
domain_model = DomainModel(
    name="myDSL",
    types={myDSL_Type, NamedElement, myDSL_DataType, Type, myDSL_Entity, myDSL_Feature, myDSL_NamedElement, myDSL_EntityModel, FeatureKind},
    associations={features0, types1, type2},
    generalizations={gen_myDSL_Type_NamedElement, gen_myDSL_DataType_Type, gen_myDSL_Entity_Type, gen_myDSL_Feature_NamedElement},
    metadata=None
)
