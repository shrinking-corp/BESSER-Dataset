...
# Classes
cycle_A = Class(name="cycle_A")
cycle_B = Class(name="cycle_B")
cycle_C = Class(name="cycle_C")
...
cycle_A.attributes={cycle_A_j, cycle_A_i}
...
cycle_B.attributes={cycle_B_y, cycle_B_x}
