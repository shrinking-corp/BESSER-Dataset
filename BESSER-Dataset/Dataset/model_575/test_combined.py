...
def test_hyp_assistantmvc_openview_style_setter(instance):
...
def test_AssistantMVC_OpenView_style_value_roundtrip():
    instance = AssistantMVC_OpenView(style="sample_text")
...
AssistantMVC_OpenView_strategy = st.builds(AssistantMVC_OpenView, style=safe_text)
@given(instance=AssistantMVC_OpenView_strategy)
@settings(max_examples=25)
