...
class jointPackage_CPL2SPL_TrgSuccessResponse(TrgResponse):
    ...
    def __init__(self, successKind: str, TrgResponse: "jointPackage_CPL2SPL_TrgResponseConstant" = None):
        self.successKind = successKind
        
        pass
    @property
    def successKind(self):
...
class jointPackage_CPL2SPL_TrgPropertyCallPlace(TrgVariablePlace):
    ...
    def __init__(self, propName: str, jointPackage_CPL2SPL_TrgPropertyCallPlace: "TrgVariablePlace" = None, TrgVariablePlace: "jointPackage_CPL2SPL_TrgPropertyCallPlace" = None):
...
class jointPackage_CPL2SPL_TrgHeadedMessageField(TrgMessageField):
    ...
    def __init__(self, headerId: str, TrgMessageField: "jointPackage_CPL2SPL_TrgWithExp" = None):
...
class jointPackage_CPL2SPL_TrgStringConstant(TrgConstant):
    ...
    def __init__(self, value: str, TrgConstant: "jointPackage_CPL2SPL_TrgWhenHeader" = None, TrgConstant127: "jointPackage_CPL2SPL_TrgConstantExp" = None, TrgConstant151: "jointPackage_CPL2SPL_TrgSequenceConstant" = None, TrgConstant125: "jointPackage_CPL2SPL_TrgSelectCase" = None):
        self.value = value
...
class jointPackage_CPL2SPL_TrgURIConstant(TrgConstant):
    ...
    def __init__(self, uri: str, TrgConstant: "jointPackage_CPL2SPL_TrgWhenHeader" = None, TrgConstant127: "jointPackage_CPL2SPL_TrgConstantExp" = None, TrgConstant151: "jointPackage_CPL2SPL_TrgSequenceConstant" = None, TrgConstant125: "jointPackage_CPL2SPL_TrgSelectCase" = None):
        self.uri = uri
...
class jointPackage_CPL2SPL_TrgIntegerConstant(TrgConstant):
    ...
    def __init__(self, value: int, TrgConstant: "jointPackage_CPL2SPL_TrgWhenHeader" = None, TrgConstant127: "jointPackage_CPL2SPL_TrgConstantExp" = None, TrgConstant151: "jointPackage_CPL2SPL_TrgSequenceConstant" = None, TrgConstant125: "jointPackage_CPL2SPL_TrgSelectCase" = None):
        self.value = value
...
class jointPackage_CPL2SPL_TrgBooleanConstant(TrgConstant):
    ...
    def __init__(self, value: bool, TrgConstant: "jointPackage_CPL2SPL_TrgWhenHeader" = None, TrgConstant127: "jointPackage_CPL2SPL_TrgConstantExp" = None, TrgConstant151: "jointPackage_CPL2SPL_TrgSequenceConstant" = None, TrgConstant125: "jointPackage_CPL2SPL_TrgSelectCase" = None):
        self.value = value
...
class jointPackage_CPL2SPL_TrgRemoteFunctionDeclaration(TrgFunctionDeclaration):
    ...
    def __init__(self, functionLocation: str, TrgFunctionDeclaration: "jointPackage_CPL2SPL_TrgFunctionCall" = None):
...
class jointPackage_CPL2SPL_TrgSIPHeaderPlace(TrgPlace):
    ...
    def __init__(self, header: str, TrgPlace117: "jointPackage_CPL2SPL_TrgPushStat" = None, TrgPlace: "jointPackage_CPL2SPL_TrgSetStat" = None, TrgPlace142: "jointPackage_CPL2SPL_TrgPopExp" = None):
        self.header = header
...
class jointPackage_CPL2SPL_TrgForwardExp(TrgExpression):
    ...
    def __init__(self, isParallel: bool, jointPackage_CPL2SPL_TrgForwardExp: "TrgExpression" = None, TrgExpression110: "jointPackage_CPL2SPL_TrgSelectStat" = None, TrgExpression132: "jointPackage_CPL2SPL_TrgOperatorExp" = None, TrgExpression105: "jointPackage_CPL2SPL_TrgForeachStat" = None, TrgExpression136: "jointPackage_CPL2SPL_TrgWithExp" = None, TrgExpression134: "jointPackage_CPL2SPL_TrgForwardExp" = None, TrgExpression74: "jointPackage_CPL2SPL_TrgFunctionCall" = None, TrgExpression129: "jointPackage_CPL2SPL_TrgOperatorExp" = None, TrgExpression149: "jointPackage_CPL2SPL_TrgMessageField" = None, TrgExpression120: "jointPackage_CPL2SPL_TrgPushStat" = None, TrgExpression84: "jointPackage_CPL2SPL_TrgReturnStat" = None, TrgExpression140: "jointPackage_CPL2SPL_TrgBlockExp" = None, TrgExpression80: "jointPackage_CPL2SPL_TrgSetStat" = None, TrgExpression88: "jointPackage_CPL2SPL_TrgIfStat" = None, TrgExpression: "jointPackage_CPL2SPL_TrgVariableDeclaration" = None):
...
class jointPackage_CPL2SPL_TrgOperatorExp(TrgExpression):
    ...
    def __init__(self, opName: str, jointPackage_CPL2SPL_TrgOperatorExp: "TrgExpression" = None, jointPackage_CPL2SPL_TrgOperatorExp131: "TrgExpression" = None, TrgExpression110: "jointPackage_CPL2SPL_TrgSelectStat" = None, TrgExpression132: "jointPackage_CPL2SPL_TrgOperatorExp" = None, TrgExpression105: "jointPackage_CPL2SPL_TrgForeachStat" = None, TrgExpression136: "jointPackage_CPL2SPL_TrgWithExp" = None, TrgExpression134: "jointPackage_CPL2SPL_TrgForwardExp" = None, TrgExpression74: "jointPackage_CPL2SPL_TrgFunctionCall" = None, TrgExpression129: "jointPackage_CPL2SPL_TrgOperatorExp" = None, TrgExpression149: "jointPackage_CPL2SPL_TrgMessageField" = None, TrgExpression120: "jointPackage_CPL2SPL_TrgPushStat" = None, TrgExpression84: "jointPackage_CPL2SPL_TrgReturnStat" = None, TrgExpression140: "jointPackage_CPL2SPL_TrgBlockExp" = None, TrgExpression80: "jointPackage_CPL2SPL_TrgSetStat" = None, TrgExpression88: "jointPackage_CPL2SPL_TrgIfStat" = None, TrgExpression: "jointPackage_CPL2SPL_TrgVariableDeclaration" = None):
        self.opName = opName
...
class jointPackage_CPL2SPL_TrgControlMethodName(TrgMethodName):
    ...
    def __init__(self, name: str, TrgMethodName: "jointPackage_CPL2SPL_TrgMethod" = None):
        self.name = name
...
class jointPackage_CPL2SPL_TrgNamedBranch(TrgBranch):
    ...
    def __init__(self, name: str, TrgBranch: "jointPackage_CPL2SPL_TrgMethod" = None):
        self.name = name
...
class jointPackage_CPL2SPL_TrgForeachStat(TrgStatement):
    ...
    def __init__(self, iteratorName: str, jointPackage_CPL2SPL_TrgForeachStat: "TrgExpression" = None, jointPackage_CPL2SPL_TrgForeachStat107: set["TrgStatement"] = None, TrgStatement123: "jointPackage_CPL2SPL_TrgSelectMember" = None, TrgStatement76: "jointPackage_CPL2SPL_TrgCompoundStat" = None, TrgStatement68: "jointPackage_CPL2SPL_TrgLocalFunctionDeclaration" = None, TrgStatement91: "jointPackage_CPL2SPL_TrgIfStat" = None, TrgStatement108: "jointPackage_CPL2SPL_TrgForeachStat" = None, TrgStatement: "jointPackage_CPL2SPL_TrgMethod" = None, TrgStatement103: "jointPackage_CPL2SPL_TrgWhenStat" = None, TrgStatement57: "jointPackage_CPL2SPL_TrgBranch" = None, TrgStatement100: "jointPackage_CPL2SPL_TrgWhenStat" = None, TrgStatement94: "jointPackage_CPL2SPL_TrgIfStat" = None):
...
class jointPackage_CPL2SPL_TrgEvent(TrgSession):
    ...
    def __init__(self, eventId: str, jointPackage_CPL2SPL_TrgEvent: set["TrgDeclaration"] = None, jointPackage_CPL2SPL_TrgEvent44: set["TrgMethod"] = None, TrgSession: "jointPackage_CPL2SPL_TrgService" = None, TrgSession36: "jointPackage_CPL2SPL_TrgRegistration" = None):
...
class jointPackage_CPL2SPL_TrgMethod(TrgSession):
    ...
    def __init__(self, direction: str, jointPackage_CPL2SPL_TrgMethod53: set["TrgStatement"] = None, jointPackage_CPL2SPL_TrgMethod55: set["TrgBranch"] = None, jointPackage_CPL2SPL_TrgMethod: "TrgTypeExpression" = None, jointPackage_CPL2SPL_TrgMethod49: "TrgMethodName" = None, jointPackage_CPL2SPL_TrgMethod51: set["TrgArgument"] = None, TrgSession: "jointPackage_CPL2SPL_TrgService" = None, TrgSession36: "jointPackage_CPL2SPL_TrgRegistration" = None):
...
class jointPackage_CPL2SPL_TrgService(TrgLocatedElement):
    ...
    def __init__(self, name: str, jointPackage_CPL2SPL_TrgService: set["TrgDeclaration"] = None, jointPackage_CPL2SPL_TrgService31: set["TrgSession"] = None):
        self.name = name
...
class jointPackage_CPL2SPL_TrgSimpleType(TrgTypeExpression):
    ...
    def __init__(self, type: str, TrgTypeExpression63: "jointPackage_CPL2SPL_TrgFunctionDeclaration" = None, TrgTypeExpression47: "jointPackage_CPL2SPL_TrgMethod" = None, TrgTypeExpression59: "jointPackage_CPL2SPL_TrgVariableDeclaration" = None, TrgTypeExpression: "jointPackage_CPL2SPL_TrgStructureProperty" = None):
        self.type = type
...
class jointPackage_CPL2SPL_TrgDefinedType(TrgTypeExpression):
    ...
    def __init__(self, typeName: str, TrgTypeExpression63: "jointPackage_CPL2SPL_TrgFunctionDeclaration" = None, TrgTypeExpression47: "jointPackage_CPL2SPL_TrgMethod" = None, TrgTypeExpression59: "jointPackage_CPL2SPL_TrgVariableDeclaration" = None, TrgTypeExpression: "jointPackage_CPL2SPL_TrgStructureProperty" = None):
...
class jointPackage_CPL2SPL_TrgSequenceType(TrgTypeExpression):
    ...
    def __init__(self, modifier: str, type: str, size: int, TrgTypeExpression63: "jointPackage_CPL2SPL_TrgFunctionDeclaration" = None, TrgTypeExpression47: "jointPackage_CPL2SPL_TrgMethod" = None, TrgTypeExpression59: "jointPackage_CPL2SPL_TrgVariableDeclaration" = None, TrgTypeExpression: "jointPackage_CPL2SPL_TrgStructureProperty" = None):
...
class jointPackage_CPL2SPL_SrcSubCall(SrcNode):
    ...
    def __init__(self, ref: str, SrcNode: "jointPackage_CPL2SPL_SrcNodeContainer" = None):
        self.ref = ref
...
class jointPackage_CPL2SPL_SrcProxy(SrcSignallingAction):
    ...
    def __init__(self, timeout: str, recurse: str, ordering: str, jointPackage_CPL2SPL_SrcProxy: "SrcBusy" = None, jointPackage_CPL2SPL_SrcProxy16: "SrcNoAnswer" = None, jointPackage_CPL2SPL_SrcProxy18: "SrcRedirection" = None, jointPackage_CPL2SPL_SrcProxy20: "SrcFailure" = None, jointPackage_CPL2SPL_SrcProxy22: "SrcDefault" = None):
...
class jointPackage_CPL2SPL_SrcSwitchedString(SrcNodeContainer):
    ...
    def __init__(self, is_: str, contains: str):
        self.is_ = is_
...
class jointPackage_CPL2SPL_SrcDefault(SrcNodeContainer):
    ...
    pass
class jointPackage_CPL2SPL_SrcLocation(SrcNode, SrcNodeContainer):

    def __init__(self, url: str, priority: str, clear: str, SrcNode: "jointPackage_CPL2SPL_SrcNodeContainer" = None):
        self.url = url
...
class jointPackage_CPL2SPL_SrcSwitchedAddress(SrcNodeContainer):
    ...
    def __init__(self, is_: str, contains: str, subDomainOf: str):
        self.is_ = is_
        self.contains = contains
