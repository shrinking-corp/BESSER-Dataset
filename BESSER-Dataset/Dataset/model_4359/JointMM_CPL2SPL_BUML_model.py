...
# Classes
jointPackage_CPL2SPL_SrcAddressSwitch = Class(name="jointPackage_CPL2SPL_SrcAddressSwitch")
SrcSwitch = Class(name="SrcSwitch")
SrcSwitchedAddress = Class(name="SrcSwitchedAddress")
jointPackage_CPL2SPL_SrcStringSwitch = Class(name="jointPackage_CPL2SPL_SrcStringSwitch")
SrcSwitchedString = Class(name="SrcSwitchedString")
jointPackage_CPL2SPL_SrcLanguageSwitch = Class(name="jointPackage_CPL2SPL_SrcLanguageSwitch")
SrcSwitchedLanguage = Class(name="SrcSwitchedLanguage")
jointPackage_CPL2SPL_SrcTimeSwitch = Class(name="jointPackage_CPL2SPL_SrcTimeSwitch")
SrcSwitchedTime = Class(name="SrcSwitchedTime")
jointPackage_CPL2SPL_SrcPrioritySwitch = Class(name="jointPackage_CPL2SPL_SrcPrioritySwitch")
jointPackage_CPL2SPL_JointMM = Class(name="jointPackage_CPL2SPL_JointMM")
SrcReject = Class(name="SrcReject")
TrgServerErrorResponse = Class(name="TrgServerErrorResponse")
jointPackage_CPL2SPL_SrcCPLModel = Class(name="jointPackage_CPL2SPL_SrcCPLModel")
SrcElement = Class(name="SrcElement")
jointPackage_CPL2SPL_SrcCPL = Class(name="jointPackage_CPL2SPL_SrcCPL")
SrcSubAction = Class(name="SrcSubAction")
SrcOutgoing = Class(name="SrcOutgoing")
SrcIncoming = Class(name="SrcIncoming")
jointPackage_CPL2SPL_SrcSubAction = Class(name="jointPackage_CPL2SPL_SrcSubAction")
SrcNodeContainer = Class(name="SrcNodeContainer")
jointPackage_CPL2SPL_SrcOutgoing = Class(name="jointPackage_CPL2SPL_SrcOutgoing")
jointPackage_CPL2SPL_SrcIncoming = Class(name="jointPackage_CPL2SPL_SrcIncoming")
jointPackage_CPL2SPL_SrcNotPresent = Class(name="jointPackage_CPL2SPL_SrcNotPresent")
jointPackage_CPL2SPL_SrcOtherwise = Class(name="jointPackage_CPL2SPL_SrcOtherwise")
SrcSwitchedPriority = Class(name="SrcSwitchedPriority")
jointPackage_CPL2SPL_SrcProxy = Class(name="jointPackage_CPL2SPL_SrcProxy")
...
jointPackage_CPL2SPL_SrcRedirect = Class(name="jointPackage_CPL2SPL_SrcRedirect")
jointPackage_CPL2SPL_SrcReject = Class(name="jointPackage_CPL2SPL_SrcReject")
jointPackage_CPL2SPL_SrcElement = Class(name="jointPackage_CPL2SPL_SrcElement", is_abstract=True)
jointPackage_CPL2SPL_SrcNodeContainer = Class(name="jointPackage_CPL2SPL_SrcNodeContainer", is_abstract=True)
SrcNode = Class(name="SrcNode")
jointPackage_CPL2SPL_SrcSwitchedPriority = Class(name="jointPackage_CPL2SPL_SrcSwitchedPriority")
jointPackage_CPL2SPL_SrcBusy = Class(name="jointPackage_CPL2SPL_SrcBusy")
jointPackage_CPL2SPL_SrcSwitchedAddress = Class(name="jointPackage_CPL2SPL_SrcSwitchedAddress")
jointPackage_CPL2SPL_SrcSwitchedString = Class(name="jointPackage_CPL2SPL_SrcSwitchedString")
jointPackage_CPL2SPL_SrcSwitchedLanguage = Class(name="jointPackage_CPL2SPL_SrcSwitchedLanguage")
jointPackage_CPL2SPL_SrcSwitchedTime = Class(name="jointPackage_CPL2SPL_SrcSwitchedTime")
TrgTypeExpression = Class(name="TrgTypeExpression")
jointPackage_CPL2SPL_TrgClientErrorResponse = Class(name="jointPackage_CPL2SPL_TrgClientErrorResponse")
TrgErrorResponse = Class(name="TrgErrorResponse")
jointPackage_CPL2SPL_TrgGlobalErrorResponse = Class(name="jointPackage_CPL2SPL_TrgGlobalErrorResponse")
jointPackage_CPL2SPL_TrgRedirectionErrorResponse = Class(name="jointPackage_CPL2SPL_TrgRedirectionErrorResponse")
jointPackage_CPL2SPL_TrgServerErrorResponse = Class(name="jointPackage_CPL2SPL_TrgServerErrorResponse")
jointPackage_CPL2SPL_TrgLocatedElement = Class(name="jointPackage_CPL2SPL_TrgLocatedElement", is_abstract=True)
jointPackage_CPL2SPL_TrgService = Class(name="jointPackage_CPL2SPL_TrgService")
TrgDeclaration = Class(name="TrgDeclaration")
TrgSession = Class(name="TrgSession")
jointPackage_CPL2SPL_SrcNoAnswer = Class(name="jointPackage_CPL2SPL_SrcNoAnswer")
jointPackage_CPL2SPL_SrcRedirection = Class(name="jointPackage_CPL2SPL_SrcRedirection")
jointPackage_CPL2SPL_SrcFailure = Class(name="jointPackage_CPL2SPL_SrcFailure")
jointPackage_CPL2SPL_SrcDefault = Class(name="jointPackage_CPL2SPL_SrcDefault")
jointPackage_CPL2SPL_SrcNode = Class(name="jointPackage_CPL2SPL_SrcNode", is_abstract=True)
jointPackage_CPL2SPL_SrcSwitch = Class(name="jointPackage_CPL2SPL_SrcSwitch", is_abstract=True)
SrcNotPresent = Class(name="SrcNotPresent")
SrcOtherwise = Class(name="SrcOtherwise")
jointPackage_CPL2SPL_SrcLocation = Class(name="jointPackage_CPL2SPL_SrcLocation")
jointPackage_CPL2SPL_SrcSubCall = Class(name="jointPackage_CPL2SPL_SrcSubCall")
jointPackage_CPL2SPL_SrcAction = Class(name="jointPackage_CPL2SPL_SrcAction", is_abstract=True)
jointPackage_CPL2SPL_SrcSignallingAction = Class(name="jointPackage_CPL2SPL_SrcSignallingAction", is_abstract=True)
SrcAction = Class(name="SrcAction")
jointPackage_CPL2SPL_TrgProgram = Class(name="jointPackage_CPL2SPL_TrgProgram")
TrgLocatedElement = Class(name="TrgLocatedElement")
TrgService = Class(name="TrgService")
jointPackage_CPL2SPL_TrgStructureProperty = Class(name="jointPackage_CPL2SPL_TrgStructureProperty")
TrgStatement = Class(name="TrgStatement")
TrgBranch = Class(name="TrgBranch")
jointPackage_CPL2SPL_TrgArgument = Class(name="jointPackage_CPL2SPL_TrgArgument")
TrgVariableDeclaration = Class(name="TrgVariableDeclaration")
jointPackage_CPL2SPL_TrgMethodName = Class(name="jointPackage_CPL2SPL_TrgMethodName", is_abstract=True)
jointPackage_CPL2SPL_TrgSIPMethodName = Class(name="jointPackage_CPL2SPL_TrgSIPMethodName")
jointPackage_CPL2SPL_TrgControlMethodName = Class(name="jointPackage_CPL2SPL_TrgControlMethodName")
jointPackage_CPL2SPL_TrgBranch = Class(name="jointPackage_CPL2SPL_TrgBranch")
jointPackage_CPL2SPL_TrgDefaultBranch = Class(name="jointPackage_CPL2SPL_TrgDefaultBranch")
jointPackage_CPL2SPL_TrgNamedBranch = Class(name="jointPackage_CPL2SPL_TrgNamedBranch")
jointPackage_CPL2SPL_TrgTypeExpression = Class(name="jointPackage_CPL2SPL_TrgTypeExpression", is_abstract=True)
jointPackage_CPL2SPL_TrgSimpleType = Class(name="jointPackage_CPL2SPL_TrgSimpleType")
jointPackage_CPL2SPL_TrgSession = Class(name="jointPackage_CPL2SPL_TrgSession", is_abstract=True)
jointPackage_CPL2SPL_TrgRegistration = Class(name="jointPackage_CPL2SPL_TrgRegistration")
jointPackage_CPL2SPL_TrgDialog = Class(name="jointPackage_CPL2SPL_TrgDialog")
TrgMethod = Class(name="TrgMethod")
jointPackage_CPL2SPL_TrgEvent = Class(name="jointPackage_CPL2SPL_TrgEvent")
jointPackage_CPL2SPL_TrgMethod = Class(name="jointPackage_CPL2SPL_TrgMethod")
TrgMethodName = Class(name="TrgMethodName")
TrgArgument = Class(name="TrgArgument")
TrgExpression = Class(name="TrgExpression")
jointPackage_CPL2SPL_TrgFunctionDeclaration = Class(name="jointPackage_CPL2SPL_TrgFunctionDeclaration", is_abstract=True)
jointPackage_CPL2SPL_TrgSequenceType = Class(name="jointPackage_CPL2SPL_TrgSequenceType")
jointPackage_CPL2SPL_TrgDefinedType = Class(name="jointPackage_CPL2SPL_TrgDefinedType")
jointPackage_CPL2SPL_TrgStatement = Class(name="jointPackage_CPL2SPL_TrgStatement", is_abstract=True)
jointPackage_CPL2SPL_TrgDeclaration = Class(name="jointPackage_CPL2SPL_TrgDeclaration", is_abstract=True)
jointPackage_CPL2SPL_TrgCompoundStat = Class(name="jointPackage_CPL2SPL_TrgCompoundStat")
jointPackage_CPL2SPL_TrgVariableDeclaration = Class(name="jointPackage_CPL2SPL_TrgVariableDeclaration")
jointPackage_CPL2SPL_TrgSetStat = Class(name="jointPackage_CPL2SPL_TrgSetStat")
TrgPlace = Class(name="TrgPlace")
jointPackage_CPL2SPL_TrgRemoteFunctionDeclaration = Class(name="jointPackage_CPL2SPL_TrgRemoteFunctionDeclaration")
TrgFunctionDeclaration = Class(name="TrgFunctionDeclaration")
jointPackage_CPL2SPL_TrgLocalFunctionDeclaration = Class(name="jointPackage_CPL2SPL_TrgLocalFunctionDeclaration")
jointPackage_CPL2SPL_TrgStructureDeclaration = Class(name="jointPackage_CPL2SPL_TrgStructureDeclaration")
jointPackage_CPL2SPL_TrgFunctionCall = Class(name="jointPackage_CPL2SPL_TrgFunctionCall")
jointPackage_CPL2SPL_TrgWhenStat = Class(name="jointPackage_CPL2SPL_TrgWhenStat")
TrgVariable = Class(name="TrgVariable")
TrgWhenHeader = Class(name="TrgWhenHeader")
jointPackage_CPL2SPL_TrgForeachStat = Class(name="jointPackage_CPL2SPL_TrgForeachStat")
jointPackage_CPL2SPL_TrgDeclarationStat = Class(name="jointPackage_CPL2SPL_TrgDeclarationStat")
jointPackage_CPL2SPL_TrgReturnStat = Class(name="jointPackage_CPL2SPL_TrgReturnStat")
TrgNamedBranch = Class(name="TrgNamedBranch")
jointPackage_CPL2SPL_TrgIfStat = Class(name="jointPackage_CPL2SPL_TrgIfStat")
jointPackage_CPL2SPL_TrgWhenHeader = Class(name="jointPackage_CPL2SPL_TrgWhenHeader")
TrgConstant = Class(name="TrgConstant")
jointPackage_CPL2SPL_TrgSelectMember = Class(name="jointPackage_CPL2SPL_TrgSelectMember", is_abstract=True)
jointPackage_CPL2SPL_TrgSelectDefault = Class(name="jointPackage_CPL2SPL_TrgSelectDefault")
jointPackage_CPL2SPL_TrgSelectStat = Class(name="jointPackage_CPL2SPL_TrgSelectStat")
TrgSelectCase = Class(name="TrgSelectCase")
TrgSelectDefault = Class(name="TrgSelectDefault")
jointPackage_CPL2SPL_TrgFunctionCallStat = Class(name="jointPackage_CPL2SPL_TrgFunctionCallStat")
TrgFunctionCall = Class(name="TrgFunctionCall")
jointPackage_CPL2SPL_TrgContinueStat = Class(name="jointPackage_CPL2SPL_TrgContinueStat")
jointPackage_CPL2SPL_TrgBreakStat = Class(name="jointPackage_CPL2SPL_TrgBreakStat")
jointPackage_CPL2SPL_TrgPushStat = Class(name="jointPackage_CPL2SPL_TrgPushStat")
TrgMessageField = Class(name="TrgMessageField")
jointPackage_CPL2SPL_TrgBlockExp = Class(name="jointPackage_CPL2SPL_TrgBlockExp")
TrgSelectMember = Class(name="TrgSelectMember")
jointPackage_CPL2SPL_TrgSelectCase = Class(name="jointPackage_CPL2SPL_TrgSelectCase")
jointPackage_CPL2SPL_TrgExpression = Class(name="jointPackage_CPL2SPL_TrgExpression", is_abstract=True)
jointPackage_CPL2SPL_TrgConstantExp = Class(name="jointPackage_CPL2SPL_TrgConstantExp")
jointPackage_CPL2SPL_TrgOperatorExp = Class(name="jointPackage_CPL2SPL_TrgOperatorExp")
jointPackage_CPL2SPL_TrgForwardExp = Class(name="jointPackage_CPL2SPL_TrgForwardExp")
jointPackage_CPL2SPL_TrgWithExp = Class(name="jointPackage_CPL2SPL_TrgWithExp")
jointPackage_CPL2SPL_TrgVariable = Class(name="jointPackage_CPL2SPL_TrgVariable")
jointPackage_CPL2SPL_TrgMessageField = Class(name="jointPackage_CPL2SPL_TrgMessageField", is_abstract=True)
jointPackage_CPL2SPL_TrgReasonMessageField = Class(name="jointPackage_CPL2SPL_TrgReasonMessageField")
jointPackage_CPL2SPL_TrgHeadedMessageField = Class(name="jointPackage_CPL2SPL_TrgHeadedMessageField")
jointPackage_CPL2SPL_TrgConstant = Class(name="jointPackage_CPL2SPL_TrgConstant", is_abstract=True)
jointPackage_CPL2SPL_TrgBooleanConstant = Class(name="jointPackage_CPL2SPL_TrgBooleanConstant")
jointPackage_CPL2SPL_TrgReasonExp = Class(name="jointPackage_CPL2SPL_TrgReasonExp")
jointPackage_CPL2SPL_TrgBODYExp = Class(name="jointPackage_CPL2SPL_TrgBODYExp")
jointPackage_CPL2SPL_TrgRequestURIExp = Class(name="jointPackage_CPL2SPL_TrgRequestURIExp")
jointPackage_CPL2SPL_TrgPopExp = Class(name="jointPackage_CPL2SPL_TrgPopExp")
jointPackage_CPL2SPL_TrgFunctionCallExp = Class(name="jointPackage_CPL2SPL_TrgFunctionCallExp")
jointPackage_CPL2SPL_TrgPlace = Class(name="jointPackage_CPL2SPL_TrgPlace", is_abstract=True)
jointPackage_CPL2SPL_TrgSIPHeaderPlace = Class(name="jointPackage_CPL2SPL_TrgSIPHeaderPlace")
jointPackage_CPL2SPL_TrgVariablePlace = Class(name="jointPackage_CPL2SPL_TrgVariablePlace", is_abstract=True)
jointPackage_CPL2SPL_TrgPropertyCallPlace = Class(name="jointPackage_CPL2SPL_TrgPropertyCallPlace")
TrgVariablePlace = Class(name="TrgVariablePlace")
jointPackage_CPL2SPL_TrgIntegerConstant = Class(name="jointPackage_CPL2SPL_TrgIntegerConstant")
jointPackage_CPL2SPL_TrgStringConstant = Class(name="jointPackage_CPL2SPL_TrgStringConstant")
jointPackage_CPL2SPL_TrgURIConstant = Class(name="jointPackage_CPL2SPL_TrgURIConstant")
jointPackage_CPL2SPL_TrgSequenceConstant = Class(name="jointPackage_CPL2SPL_TrgSequenceConstant")
jointPackage_CPL2SPL_TrgResponseConstant = Class(name="jointPackage_CPL2SPL_TrgResponseConstant")
TrgResponse = Class(name="TrgResponse")
jointPackage_CPL2SPL_TrgResponse = Class(name="jointPackage_CPL2SPL_TrgResponse", is_abstract=True)
jointPackage_CPL2SPL_TrgSuccessResponse = Class(name="jointPackage_CPL2SPL_TrgSuccessResponse")
jointPackage_CPL2SPL_TrgErrorResponse = Class(name="jointPackage_CPL2SPL_TrgErrorResponse")
...
jointPackage_CPL2SPL_SrcAddressSwitch.attributes={jointPackage_CPL2SPL_SrcAddressSwitch_field, jointPackage_CPL2SPL_SrcAddressSwitch_subField}
...
jointPackage_CPL2SPL_SrcProxy.attributes={jointPackage_CPL2SPL_SrcProxy_recurse, jointPackage_CPL2SPL_SrcProxy_timeout, jointPackage_CPL2SPL_SrcProxy_ordering}
...
jointPackage_CPL2SPL_SrcSwitchedPriority.attributes={jointPackage_CPL2SPL_SrcSwitchedPriority_less, jointPackage_CPL2SPL_SrcSwitchedPriority_equal, jointPackage_CPL2SPL_SrcSwitchedPriority_greater}
...
jointPackage_CPL2SPL_SrcSwitchedAddress_is_: Property = Property(name="is_", type=StringType)
...
jointPackage_CPL2SPL_SrcSwitchedAddress.attributes={jointPackage_CPL2SPL_SrcSwitchedAddress_subDomainOf, jointPackage_CPL2SPL_SrcSwitchedAddress_contains, jointPackage_CPL2SPL_SrcSwitchedAddress_is_}

# jointPackage_CPL2SPL_SrcSwitchedString class attributes and methods
jointPackage_CPL2SPL_SrcSwitchedString_is_: Property = Property(name="is_", type=StringType)
jointPackage_CPL2SPL_SrcSwitchedString_contains: Property = Property(name="contains", type=StringType)
jointPackage_CPL2SPL_SrcSwitchedString.attributes={jointPackage_CPL2SPL_SrcSwitchedString_is_, jointPackage_CPL2SPL_SrcSwitchedString_contains}
...
jointPackage_CPL2SPL_SrcSwitchedTime.attributes={jointPackage_CPL2SPL_SrcSwitchedTime_interval, jointPackage_CPL2SPL_SrcSwitchedTime_until, jointPackage_CPL2SPL_SrcSwitchedTime_bySecond, jointPackage_CPL2SPL_SrcSwitchedTime_byYearDay, jointPackage_CPL2SPL_SrcSwitchedTime_byHour, jointPackage_CPL2SPL_SrcSwitchedTime_byMonthDay, jointPackage_CPL2SPL_SrcSwitchedTime_byMonth, jointPackage_CPL2SPL_SrcSwitchedTime_duration, jointPackage_CPL2SPL_SrcSwitchedTime_byWeekNo, jointPackage_CPL2SPL_SrcSwitchedTime_byMinute, jointPackage_CPL2SPL_SrcSwitchedTime_dtstart, jointPackage_CPL2SPL_SrcSwitchedTime_bySetPos, jointPackage_CPL2SPL_SrcSwitchedTime_wkst, jointPackage_CPL2SPL_SrcSwitchedTime_freq, jointPackage_CPL2SPL_SrcSwitchedTime_count, jointPackage_CPL2SPL_SrcSwitchedTime_byDay, jointPackage_CPL2SPL_SrcSwitchedTime_dtend}
...
jointPackage_CPL2SPL_TrgLocatedElement.attributes={jointPackage_CPL2SPL_TrgLocatedElement_location, jointPackage_CPL2SPL_TrgLocatedElement_commentsAfter, jointPackage_CPL2SPL_TrgLocatedElement_commentsBefore}
...
jointPackage_CPL2SPL_SrcLocation.attributes={jointPackage_CPL2SPL_SrcLocation_url, jointPackage_CPL2SPL_SrcLocation_priority, jointPackage_CPL2SPL_SrcLocation_clear}
...
domain_model = DomainModel(
    ...
    types={jointPackage_CPL2SPL_SrcAddressSwitch, SrcSwitch, SrcSwitchedAddress, jointPackage_CPL2SPL_SrcStringSwitch, SrcSwitchedString, jointPackage_CPL2SPL_SrcLanguageSwitch, SrcSwitchedLanguage, jointPackage_CPL2SPL_SrcTimeSwitch, SrcSwitchedTime, jointPackage_CPL2SPL_SrcPrioritySwitch, jointPackage_CPL2SPL_JointMM, SrcReject, TrgServerErrorResponse, jointPackage_CPL2SPL_SrcCPLModel, SrcElement, jointPackage_CPL2SPL_SrcCPL, SrcSubAction, SrcOutgoing, SrcIncoming, jointPackage_CPL2SPL_SrcSubAction, SrcNodeContainer, jointPackage_CPL2SPL_SrcOutgoing, jointPackage_CPL2SPL_SrcIncoming, jointPackage_CPL2SPL_SrcNotPresent, jointPackage_CPL2SPL_SrcOtherwise, SrcSwitchedPriority, jointPackage_CPL2SPL_SrcProxy, SrcSignallingAction, SrcBusy, SrcNoAnswer, SrcRedirection, SrcFailure, SrcDefault, jointPackage_CPL2SPL_SrcRedirect, jointPackage_CPL2SPL_SrcReject, jointPackage_CPL2SPL_SrcElement, jointPackage_CPL2SPL_SrcNodeContainer, SrcNode, jointPackage_CPL2SPL_SrcSwitchedPriority, jointPackage_CPL2SPL_SrcBusy, jointPackage_CPL2SPL_SrcSwitchedAddress, jointPackage_CPL2SPL_SrcSwitchedString, jointPackage_CPL2SPL_SrcSwitchedLanguage, jointPackage_CPL2SPL_SrcSwitchedTime, TrgTypeExpression, jointPackage_CPL2SPL_TrgClientErrorResponse, TrgErrorResponse, jointPackage_CPL2SPL_TrgGlobalErrorResponse, jointPackage_CPL2SPL_TrgRedirectionErrorResponse, jointPackage_CPL2SPL_TrgServerErrorResponse, jointPackage_CPL2SPL_TrgLocatedElement, jointPackage_CPL2SPL_TrgService, TrgDeclaration, TrgSession, jointPackage_CPL2SPL_SrcNoAnswer, jointPackage_CPL2SPL_SrcRedirection, jointPackage_CPL2SPL_SrcFailure, jointPackage_CPL2SPL_SrcDefault, jointPackage_CPL2SPL_SrcNode, jointPackage_CPL2SPL_SrcSwitch, SrcNotPresent, SrcOtherwise, jointPackage_CPL2SPL_SrcLocation, jointPackage_CPL2SPL_SrcSubCall, jointPackage_CPL2SPL_SrcAction, jointPackage_CPL2SPL_SrcSignallingAction, SrcAction, jointPackage_CPL2SPL_TrgProgram, TrgLocatedElement, TrgService, jointPackage_CPL2SPL_TrgStructureProperty, TrgStatement, TrgBranch, jointPackage_CPL2SPL_TrgArgument, TrgVariableDeclaration, jointPackage_CPL2SPL_TrgMethodName, jointPackage_CPL2SPL_TrgSIPMethodName, jointPackage_CPL2SPL_TrgControlMethodName, jointPackage_CPL2SPL_TrgBranch, jointPackage_CPL2SPL_TrgDefaultBranch, jointPackage_CPL2SPL_TrgNamedBranch, jointPackage_CPL2SPL_TrgTypeExpression, jointPackage_CPL2SPL_TrgSimpleType, jointPackage_CPL2SPL_TrgSession, jointPackage_CPL2SPL_TrgRegistration, jointPackage_CPL2SPL_TrgDialog, TrgMethod, jointPackage_CPL2SPL_TrgEvent, jointPackage_CPL2SPL_TrgMethod, TrgMethodName, TrgArgument, TrgExpression, jointPackage_CPL2SPL_TrgFunctionDeclaration, jointPackage_CPL2SPL_TrgSequenceType, jointPackage_CPL2SPL_TrgDefinedType, jointPackage_CPL2SPL_TrgStatement, jointPackage_CPL2SPL_TrgDeclaration, jointPackage_CPL2SPL_TrgCompoundStat, jointPackage_CPL2SPL_TrgVariableDeclaration, jointPackage_CPL2SPL_TrgSetStat, TrgPlace, jointPackage_CPL2SPL_TrgRemoteFunctionDeclaration, TrgFunctionDeclaration, jointPackage_CPL2SPL_TrgLocalFunctionDeclaration, jointPackage_CPL2SPL_TrgStructureDeclaration, jointPackage_CPL2SPL_TrgFunctionCall, jointPackage_CPL2SPL_TrgWhenStat, TrgVariable, TrgWhenHeader, jointPackage_CPL2SPL_TrgForeachStat, jointPackage_CPL2SPL_TrgDeclarationStat, jointPackage_CPL2SPL_TrgReturnStat, TrgNamedBranch, jointPackage_CPL2SPL_TrgIfStat, jointPackage_CPL2SPL_TrgWhenHeader, TrgConstant, jointPackage_CPL2SPL_TrgSelectMember, jointPackage_CPL2SPL_TrgSelectDefault, jointPackage_CPL2SPL_TrgSelectStat, TrgSelectCase, TrgSelectDefault, jointPackage_CPL2SPL_TrgFunctionCallStat, TrgFunctionCall, jointPackage_CPL2SPL_TrgContinueStat, jointPackage_CPL2SPL_TrgBreakStat, jointPackage_CPL2SPL_TrgPushStat, TrgMessageField, jointPackage_CPL2SPL_TrgBlockExp, TrgSelectMember, jointPackage_CPL2SPL_TrgSelectCase, jointPackage_CPL2SPL_TrgExpression, jointPackage_CPL2SPL_TrgConstantExp, jointPackage_CPL2SPL_TrgOperatorExp, jointPackage_CPL2SPL_TrgForwardExp, jointPackage_CPL2SPL_TrgWithExp, jointPackage_CPL2SPL_TrgVariable, jointPackage_CPL2SPL_TrgMessageField, jointPackage_CPL2SPL_TrgReasonMessageField, jointPackage_CPL2SPL_TrgHeadedMessageField, jointPackage_CPL2SPL_TrgConstant, jointPackage_CPL2SPL_TrgBooleanConstant, jointPackage_CPL2SPL_TrgReasonExp, jointPackage_CPL2SPL_TrgBODYExp, jointPackage_CPL2SPL_TrgRequestURIExp, jointPackage_CPL2SPL_TrgPopExp, jointPackage_CPL2SPL_TrgFunctionCallExp, jointPackage_CPL2SPL_TrgPlace, jointPackage_CPL2SPL_TrgSIPHeaderPlace, jointPackage_CPL2SPL_TrgVariablePlace, jointPackage_CPL2SPL_TrgPropertyCallPlace, TrgVariablePlace, jointPackage_CPL2SPL_TrgIntegerConstant, jointPackage_CPL2SPL_TrgStringConstant, jointPackage_CPL2SPL_TrgURIConstant, jointPackage_CPL2SPL_TrgSequenceConstant, jointPackage_CPL2SPL_TrgResponseConstant, TrgResponse, jointPackage_CPL2SPL_TrgResponse, jointPackage_CPL2SPL_TrgSuccessResponse, jointPackage_CPL2SPL_TrgErrorResponse, Direction, SIPMethod, ClientErrorKind, ControlMethod, PrimitiveType, Modifier, FunctionLocation, SIPHeader, SuccessKind, GlobalErrorKind, RedirectionErrorKind, ServerErrorKind},
    associations={addresses9, strings10, languages11, times12, sourceRoot0, targetRoot1, elements3, subActions4, outgoing5, incoming7, priorities13, busy14, noAnswer15, redirection17, failure19, default21, contents23, type28, declarations29, sessions30, notPresent24, otherwise25, service27, statements52, branches54, statements56, declarations32, sessions34, declarations37, methods39, declarations41, methods43, type46, methodName48, arguments50, type58, initExp60, returnType62, arguments64, statements75, target77, setValue78, statements67, properties69, function71, parameters72, idExp95, whenHeaders96, statements98, elseStatements101, sequenceExp104, declaration81, returnedValue83, branch85, condition87, thenStatements89, elseStatements92, target116, pushedValue118, value121, statements122, statements106, matchedExp109, selectCases111, selectDefault113, functionCall115, exp135, msgFields137, exp139, values124, value126, leftExp128, rightExp130, exp133, source146, exp148, source141, functionCall143, source145, values150, response152},
    generalizations={gen_jointPackage_CPL2SPL_SrcAddressSwitch_SrcSwitch, gen_jointPackage_CPL2SPL_SrcStringSwitch_SrcSwitch, gen_jointPackage_CPL2SPL_SrcLanguageSwitch_SrcSwitch, gen_jointPackage_CPL2SPL_SrcTimeSwitch_SrcSwitch, gen_jointPackage_CPL2SPL_SrcCPL_SrcElement, gen_jointPackage_CPL2SPL_SrcSubAction_SrcNodeContainer, gen_jointPackage_CPL2SPL_SrcOutgoing_SrcNodeContainer, gen_jointPackage_CPL2SPL_SrcIncoming_SrcNodeContainer, gen_jointPackage_CPL2SPL_SrcNotPresent_SrcNodeContainer, gen_jointPackage_CPL2SPL_SrcOtherwise_SrcNodeContainer, gen_jointPackage_CPL2SPL_SrcPrioritySwitch_SrcSwitch, gen_jointPackage_CPL2SPL_SrcProxy_SrcSignallingAction, gen_jointPackage_CPL2SPL_SrcRedirect_SrcSignallingAction, gen_jointPackage_CPL2SPL_SrcReject_SrcSignallingAction, gen_jointPackage_CPL2SPL_SrcNodeContainer_SrcElement, gen_jointPackage_CPL2SPL_SrcSwitchedPriority_SrcNodeContainer, gen_jointPackage_CPL2SPL_SrcBusy_SrcNodeContainer, gen_jointPackage_CPL2SPL_SrcSwitchedAddress_SrcNodeContainer, gen_jointPackage_CPL2SPL_SrcSwitchedString_SrcNodeContainer, gen_jointPackage_CPL2SPL_SrcSwitchedLanguage_SrcNodeContainer, gen_jointPackage_CPL2SPL_SrcSwitchedTime_SrcNodeContainer, gen_jointPackage_CPL2SPL_TrgClientErrorResponse_TrgErrorResponse, gen_jointPackage_CPL2SPL_TrgGlobalErrorResponse_TrgErrorResponse, gen_jointPackage_CPL2SPL_TrgRedirectionErrorResponse_TrgErrorResponse, gen_jointPackage_CPL2SPL_TrgServerErrorResponse_TrgErrorResponse, gen_jointPackage_CPL2SPL_TrgService_TrgLocatedElement, gen_jointPackage_CPL2SPL_SrcNoAnswer_SrcNodeContainer, gen_jointPackage_CPL2SPL_SrcRedirection_SrcNodeContainer, gen_jointPackage_CPL2SPL_SrcFailure_SrcNodeContainer, gen_jointPackage_CPL2SPL_SrcDefault_SrcNodeContainer, gen_jointPackage_CPL2SPL_SrcNode_SrcElement, gen_jointPackage_CPL2SPL_SrcSwitch_SrcNode, gen_jointPackage_CPL2SPL_SrcLocation_SrcNode, gen_jointPackage_CPL2SPL_SrcLocation_SrcNodeContainer, gen_jointPackage_CPL2SPL_SrcSubCall_SrcNode, gen_jointPackage_CPL2SPL_SrcAction_SrcNode, gen_jointPackage_CPL2SPL_SrcSignallingAction_SrcAction, gen_jointPackage_CPL2SPL_TrgProgram_TrgLocatedElement, gen_jointPackage_CPL2SPL_TrgStructureProperty_TrgLocatedElement, gen_jointPackage_CPL2SPL_TrgArgument_TrgVariableDeclaration, gen_jointPackage_CPL2SPL_TrgMethodName_TrgLocatedElement, gen_jointPackage_CPL2SPL_TrgSIPMethodName_TrgMethodName, gen_jointPackage_CPL2SPL_TrgControlMethodName_TrgMethodName, gen_jointPackage_CPL2SPL_TrgBranch_TrgLocatedElement, gen_jointPackage_CPL2SPL_TrgDefaultBranch_TrgBranch, gen_jointPackage_CPL2SPL_TrgNamedBranch_TrgBranch, gen_jointPackage_CPL2SPL_TrgTypeExpression_TrgLocatedElement, gen_jointPackage_CPL2SPL_TrgSimpleType_TrgTypeExpression, gen_jointPackage_CPL2SPL_TrgSession_TrgLocatedElement, gen_jointPackage_CPL2SPL_TrgRegistration_TrgSession, gen_jointPackage_CPL2SPL_TrgDialog_TrgSession, gen_jointPackage_CPL2SPL_TrgEvent_TrgSession, gen_jointPackage_CPL2SPL_TrgMethod_TrgSession, gen_jointPackage_CPL2SPL_TrgFunctionDeclaration_TrgDeclaration, gen_jointPackage_CPL2SPL_TrgSequenceType_TrgTypeExpression, gen_jointPackage_CPL2SPL_TrgDefinedType_TrgTypeExpression, gen_jointPackage_CPL2SPL_TrgStatement_TrgLocatedElement, gen_jointPackage_CPL2SPL_TrgDeclaration_TrgLocatedElement, gen_jointPackage_CPL2SPL_TrgCompoundStat_TrgStatement, gen_jointPackage_CPL2SPL_TrgVariableDeclaration_TrgDeclaration, gen_jointPackage_CPL2SPL_TrgSetStat_TrgStatement, gen_jointPackage_CPL2SPL_TrgRemoteFunctionDeclaration_TrgFunctionDeclaration, gen_jointPackage_CPL2SPL_TrgLocalFunctionDeclaration_TrgFunctionDeclaration, gen_jointPackage_CPL2SPL_TrgStructureDeclaration_TrgDeclaration, gen_jointPackage_CPL2SPL_TrgFunctionCall_TrgLocatedElement, gen_jointPackage_CPL2SPL_TrgWhenStat_TrgStatement, gen_jointPackage_CPL2SPL_TrgForeachStat_TrgStatement, gen_jointPackage_CPL2SPL_TrgDeclarationStat_TrgStatement, gen_jointPackage_CPL2SPL_TrgReturnStat_TrgStatement, gen_jointPackage_CPL2SPL_TrgIfStat_TrgStatement, gen_jointPackage_CPL2SPL_TrgWhenHeader_TrgVariableDeclaration, gen_jointPackage_CPL2SPL_TrgSelectMember_TrgLocatedElement, gen_jointPackage_CPL2SPL_TrgSelectStat_TrgStatement, gen_jointPackage_CPL2SPL_TrgFunctionCallStat_TrgStatement, gen_jointPackage_CPL2SPL_TrgContinueStat_TrgStatement, gen_jointPackage_CPL2SPL_TrgBreakStat_TrgStatement, gen_jointPackage_CPL2SPL_TrgPushStat_TrgStatement, gen_jointPackage_CPL2SPL_TrgBlockExp_TrgExpression, gen_jointPackage_CPL2SPL_TrgSelectDefault_TrgSelectMember, gen_jointPackage_CPL2SPL_TrgSelectCase_TrgSelectMember, gen_jointPackage_CPL2SPL_TrgExpression_TrgLocatedElement, gen_jointPackage_CPL2SPL_TrgConstantExp_TrgExpression, gen_jointPackage_CPL2SPL_TrgOperatorExp_TrgExpression, gen_jointPackage_CPL2SPL_TrgForwardExp_TrgExpression, gen_jointPackage_CPL2SPL_TrgWithExp_TrgExpression, gen_jointPackage_CPL2SPL_TrgVariable_TrgVariablePlace, gen_jointPackage_CPL2SPL_TrgMessageField_TrgLocatedElement, gen_jointPackage_CPL2SPL_TrgReasonMessageField_TrgMessageField, gen_jointPackage_CPL2SPL_TrgHeadedMessageField_TrgMessageField, gen_jointPackage_CPL2SPL_TrgConstant_TrgLocatedElement, gen_jointPackage_CPL2SPL_TrgBooleanConstant_TrgConstant, gen_jointPackage_CPL2SPL_TrgReasonExp_TrgExpression, gen_jointPackage_CPL2SPL_TrgBODYExp_TrgExpression, gen_jointPackage_CPL2SPL_TrgRequestURIExp_TrgExpression, gen_jointPackage_CPL2SPL_TrgPopExp_TrgExpression, gen_jointPackage_CPL2SPL_TrgFunctionCallExp_TrgExpression, gen_jointPackage_CPL2SPL_TrgPlace_TrgExpression, gen_jointPackage_CPL2SPL_TrgSIPHeaderPlace_TrgPlace, gen_jointPackage_CPL2SPL_TrgVariablePlace_TrgPlace, gen_jointPackage_CPL2SPL_TrgPropertyCallPlace_TrgVariablePlace, gen_jointPackage_CPL2SPL_TrgIntegerConstant_TrgConstant, gen_jointPackage_CPL2SPL_TrgStringConstant_TrgConstant, gen_jointPackage_CPL2SPL_TrgURIConstant_TrgConstant, gen_jointPackage_CPL2SPL_TrgSequenceConstant_TrgConstant, gen_jointPackage_CPL2SPL_TrgResponseConstant_TrgConstant, gen_jointPackage_CPL2SPL_TrgResponse_TrgLocatedElement, gen_jointPackage_CPL2SPL_TrgSuccessResponse_TrgResponse, gen_jointPackage_CPL2SPL_TrgErrorResponse_TrgResponse},
    metadata=None
)
