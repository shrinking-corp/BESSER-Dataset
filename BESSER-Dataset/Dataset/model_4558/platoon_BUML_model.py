...
platoon_routeCommand = Class(name="platoon_routeCommand", is_abstract=True)
platoon_LeaderVehicle = Class(name="platoon_LeaderVehicle")
platoon_FollowingVehicle = Class(name="platoon_FollowingVehicle")
platoon_Forward = Class(name="platoon_Forward")
platoon_Root = Class(name="platoon_Root")
...
domain_model = DomainModel(
    name="platoon",
    types={platoon_Platoon, platoon_Route, platoon_Constraints, platoon_routeCommand, platoon_LeaderVehicle, platoon_FollowingVehicle, platoon_Forward, platoon_Root, platoon_TurnRight, platoon_Vehicle, Vehicle, routeCommand, platoon_TurnLeft},
    associations={platoon0, route1, constraints3, routeCommands5, leaderVehicle7, followingVehicle9, following11, route13},
    generalizations={gen_platoon_TurnRight_routeCommand, gen_platoon_FollowingVehicle_Vehicle, gen_platoon_LeaderVehicle_Vehicle, gen_platoon_Forward_routeCommand, gen_platoon_TurnLeft_routeCommand},
    metadata=None
)
