...
# Classes
syswbeff106_Function = Class(name="syswbeff106_Function")
SequenceNode = Class(name="SequenceNode")
ProcessNode = Class(name="ProcessNode")
syswbeff106_SequenceNode = Class(name="syswbeff106_SequenceNode", is_abstract=True)
syswbeff106_Sequence = Class(name="syswbeff106_Sequence", is_abstract=True)
syswbeff106_Flow = Class(name="syswbeff106_Flow")
syswbeff106_OutputPort = Class(name="syswbeff106_OutputPort")
syswbeff106_InputPort = Class(name="syswbeff106_InputPort")
syswbeff106_Description = Class(name="syswbeff106_Description")
syswbeff106_Token = Class(name="syswbeff106_Token")
syswbeff106_FunctionProperty = Class(name="syswbeff106_FunctionProperty")
syswbeff106_Component = Class(name="syswbeff106_Component")
syswbeff106_Item = Class(name="syswbeff106_Item")
syswbeff106_And = Class(name="syswbeff106_And")
Sequence = Class(name="Sequence")
syswbeff106_Or = Class(name="syswbeff106_Or")
syswbeff106_Start = Class(name="syswbeff106_Start")
syswbeff106_Final = Class(name="syswbeff106_Final")
syswbeff106_Loop = Class(name="syswbeff106_Loop")
Port = Class(name="Port")
syswbeff106_Port = Class(name="syswbeff106_Port", is_abstract=True)
syswbeff106_Iteration = Class(name="syswbeff106_Iteration")
syswbeff106_RelatedTo = Class(name="syswbeff106_RelatedTo")
syswbeff106_Thing = Class(name="syswbeff106_Thing")
syswbeff106_ProcessNode = Class(name="syswbeff106_ProcessNode", is_abstract=True)
syswbeff106_LoopExit = Class(name="syswbeff106_LoopExit")
syswbeff106_Thoughts = Class(name="syswbeff106_Thoughts")
syswbeff106_System = Class(name="syswbeff106_System")
syswbeff106_PatternCatalog = Class(name="syswbeff106_PatternCatalog")
syswbeff106_Workbench = Class(name="syswbeff106_Workbench")
...
syswbeff106_SequenceNode.attributes={syswbeff106_SequenceNode_tMax, syswbeff106_SequenceNode_name, syswbeff106_SequenceNode_tMin}
...
domain_model = DomainModel(
    name="syswbeff106",
    types={syswbeff106_Function, SequenceNode, ProcessNode, syswbeff106_SequenceNode, syswbeff106_Sequence, syswbeff106_Flow, syswbeff106_OutputPort, syswbeff106_InputPort, syswbeff106_Description, syswbeff106_Token, syswbeff106_FunctionProperty, syswbeff106_Component, syswbeff106_Item, syswbeff106_And, Sequence, syswbeff106_Or, syswbeff106_Start, syswbeff106_Final, syswbeff106_Loop, Port, syswbeff106_Port, syswbeff106_Iteration, syswbeff106_RelatedTo, syswbeff106_Thing, syswbeff106_ProcessNode, syswbeff106_LoopExit, syswbeff106_Thoughts, syswbeff106_System, syswbeff106_PatternCatalog, syswbeff106_Workbench, FunctionDomain},
    associations={controlFlowEdge22, decompositions1, sequenceNodes2, flows4, outputPorts6, inputPorts8, descriptions10, tokens12, property14, associations17, allocatedTo19, fromThing31, inputflowEdge23, items26, outputflowEdge28, things59, thoughts61, systemView64, functionProperties67, catalog70, toThing32, relations35, relatedTo38, parent41, decompositions44, associations47, performs49, functionalArchitecture52, physicalArchitecture54, patterns57},
    generalizations={gen_syswbeff106_Function_SequenceNode, gen_syswbeff106_Function_ProcessNode, gen_syswbeff106_Flow_ProcessNode, gen_syswbeff106_Sequence_SequenceNode, gen_syswbeff106_And_Sequence, gen_syswbeff106_Or_Sequence, gen_syswbeff106_Start_Sequence, gen_syswbeff106_Final_Sequence, gen_syswbeff106_Loop_Sequence, gen_syswbeff106_InputPort_Port, gen_syswbeff106_Iteration_Sequence, gen_syswbeff106_OutputPort_Port, gen_syswbeff106_LoopExit_Sequence},
    metadata=None
)
