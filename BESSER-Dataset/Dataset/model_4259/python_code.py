...
class attroverridesecondarytable_Address:
    ...
    def __init__(self, name: str, street: str, city: str, attroverridesecondarytable_Address2: "attroverridesecondarytable_Employee" = None, attroverridesecondarytable_Address: "attroverridesecondarytable_Country" = None, attroverridesecondarytable_Address4: "attroverridesecondarytable_NonEmployee" = None):
        self.name = name
        self.street = street
        self.city = city
