...
class BibTeX_InProceedings(AuthoredEntry, Proceedings, BookTitledEntry):
    ...
    pass
class BibTeX_Book(AuthoredEntry, TitledEntry, DatedEntry):
...
class BibTeX_TechReport(AuthoredEntry, TitledEntry, DatedEntry):

    pass
class BibTeX_ThesisEntry(AuthoredEntry, TitledEntry, DatedEntry):
