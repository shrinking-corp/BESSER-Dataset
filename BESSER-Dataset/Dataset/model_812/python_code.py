...
class fsm_State(NamedElement):
    ...
    def __init__(self, fsm_State6: "fsm_StateMachine" = None, ownedStates: "fsm_StateMachine" = None, source: set["fsm_Transition"] = None, target: set["fsm_Transition"] = None, State12: "fsm_Transition" = None, State: "fsm_StateMachine" = None, fsm_State: "fsm_StateMachine" = None, State14: "fsm_Transition" = None):
...
class fsm_Buffer(NamedElement):
    ...
    def __init__(self, initialValue: str, currentValues: str, fsm_Buffer20: set["fsm_StateMachine"] = None, fsm_Buffer23: set["fsm_StateMachine"] = None, fsm_Buffer: "fsm_FSMSystem" = None):
...
class fsm_StateMachine(NamedElement):
    ...
    def __init__(self, unprocessedString: str, consummedString: str, producedString: str, fsm_StateMachine3: set["fsm_Transition"] = None, fsm_StateMachine5: "fsm_State" = None, StateMachine: "fsm_State" = None, owningFSM: set["fsm_State"] = None, fsm_StateMachine: "fsm_State" = None, fsm_StateMachine21: "fsm_Buffer" = None, fsm_StateMachine24: "fsm_Buffer" = None, fsm_StateMachine16: "fsm_FSMSystem" = None):
...
class fsm_Transition(NamedElement):
    ...
    def __init__(self, input: str, output: str, fsm_Transition: "fsm_StateMachine" = None, Transition: "fsm_State" = None, Transition10: "fsm_State" = None, outgoingTransitions: "fsm_State" = None, incomingTransitions: "fsm_State" = None):
        self.input = input
        self.output = output
