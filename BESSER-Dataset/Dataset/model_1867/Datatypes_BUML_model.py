...
datatypes_Import = Class(name="datatypes_Import")
datatypes_DataType = Class(name="datatypes_DataType")
datatypes_SimpleType = Class(name="datatypes_SimpleType")
DataType = Class(name="DataType")
datatypes_ComplexType = Class(name="datatypes_ComplexType")
datatypes_Field = Class(name="datatypes_Field")
datatypes_TypeModel = Class(name="datatypes_TypeModel")
datatypes_AbstractElement = Class(name="datatypes_AbstractElement")
datatypes_DataTypeLibrary = Class(name="datatypes_DataTypeLibrary")
...
datatypes_Field.attributes={datatypes_Field_name, datatypes_Field_many}
...
domain_model = DomainModel(
    name="datatypes",
    types={AbstractElement, datatypes_Import, datatypes_DataType, datatypes_SimpleType, DataType, datatypes_ComplexType, datatypes_Field, datatypes_TypeModel, datatypes_AbstractElement, datatypes_DataTypeLibrary},
    associations={elements1, superType4, fields5, elements0, type7},
