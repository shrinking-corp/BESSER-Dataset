...
# Classes
minuml2_ActivityPartition = Class(name="minuml2_ActivityPartition")
minuml2_Activity = Class(name="minuml2_Activity")
ModelElement = Class(name="ModelElement")
minuml2_ActivityNode = Class(name="minuml2_ActivityNode", is_abstract=True)
minuml2_ActivityEdge = Class(name="minuml2_ActivityEdge")
minuml2_OpaqueAction = Class(name="minuml2_OpaqueAction")
ActivityNode = Class(name="ActivityNode")
minuml2_InitialNode = Class(name="minuml2_InitialNode")
minuml2_DecisionNode = Class(name="minuml2_DecisionNode")
minuml2_ModelElement = Class(name="minuml2_ModelElement")
minuml2_OpaqueExpression = Class(name="minuml2_OpaqueExpression")
minuml2_ControlFlow = Class(name="minuml2_ControlFlow")
ActivityEdge = Class(name="ActivityEdge")
minuml2_ObjectFlow = Class(name="minuml2_ObjectFlow")
minuml2_ObjectNode = Class(name="minuml2_ObjectNode")
minuml2_ForkNode = Class(name="minuml2_ForkNode")
minuml2_JoinNode = Class(name="minuml2_JoinNode")
minuml2_ActivityFinalNode = Class(name="minuml2_ActivityFinalNode")
...
domain_model = DomainModel(
    name="minuml2",
    types={minuml2_ActivityPartition, minuml2_Activity, ModelElement, minuml2_ActivityNode, minuml2_ActivityEdge, minuml2_OpaqueAction, ActivityNode, minuml2_InitialNode, minuml2_DecisionNode, minuml2_ModelElement, minuml2_OpaqueExpression, minuml2_ControlFlow, ActivityEdge, minuml2_ObjectFlow, minuml2_ObjectNode, minuml2_ForkNode, minuml2_JoinNode, minuml2_ActivityFinalNode},
    associations={partition0, node1, edge2, group4, nodes7, edges10, outgoing13, incoming14, target17, guard19, type21, source16},
    generalizations={gen_minuml2_Activity_ModelElement, gen_minuml2_ActivityPartition_ModelElement, gen_minuml2_ActivityNode_ModelElement, gen_minuml2_OpaqueAction_ActivityNode, gen_minuml2_InitialNode_ActivityNode, gen_minuml2_DecisionNode_ActivityNode, gen_minuml2_ControlFlow_ActivityEdge, gen_minuml2_ObjectFlow_ActivityEdge, gen_minuml2_ObjectNode_ActivityNode, gen_minuml2_ForkNode_ActivityNode, gen_minuml2_JoinNode_ActivityNode, gen_minuml2_ActivityFinalNode_ActivityNode, gen_minuml2_ActivityEdge_ModelElement},
    metadata=None
)
