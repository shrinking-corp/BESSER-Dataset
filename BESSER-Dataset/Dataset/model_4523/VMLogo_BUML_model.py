...
# Classes
vmlogo_Context = Class(name="vmlogo_Context")
vmlogo_StackFrame = Class(name="vmlogo_StackFrame")
vmlogo_Turtle = Class(name="vmlogo_Turtle")
vmlogo_CallStack = Class(name="vmlogo_CallStack")
...
domain_model = DomainModel(
    name="vmlogo",
    types={vmlogo_Context, vmlogo_StackFrame, vmlogo_Turtle, vmlogo_CallStack, vmlogo_Point, vmlogo_Segment},
    associations={begin7, end10, frames13, turtle0, callStack1, position3, drawings5},
    generalizations={},
    metadata=None
)
