...
petrinetv1_Place.attributes={petrinetv1_Place_name, petrinetv1_Place_initialTokens, petrinetv1_Place_tokens}
...
domain_model = DomainModel(
    ...
    associations={input3, output6, places0, transitions1},
    generalizations={},
    metadata=None
)
