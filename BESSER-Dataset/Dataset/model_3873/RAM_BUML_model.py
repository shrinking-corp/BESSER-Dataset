...
# Classes
ram_MappableElement = Class(name="ram_MappableElement", is_abstract=True)
COREModelElement = Class(name="COREModelElement")
ram_Classifier = Class(name="ram_Classifier", is_abstract=True)
ram_Association = Class(name="ram_Association")
ram_Aspect = Class(name="ram_Aspect")
NamedElement = Class(name="NamedElement")
COREModel = Class(name="COREModel")
ram_StructuralView = Class(name="ram_StructuralView")
ram_AbstractMessageView = Class(name="ram_AbstractMessageView", is_abstract=True)
ram_Instantiation = Class(name="ram_Instantiation")
ram_Layout = Class(name="ram_Layout")
ram_StateView = Class(name="ram_StateView")
ram_WovenAspect = Class(name="ram_WovenAspect")
ram_NamedElement = Class(name="ram_NamedElement", is_abstract=True)
CORENamedElement = Class(name="CORENamedElement")
ram_Type = Class(name="ram_Type", is_abstract=True)
ram_Class = Class(name="ram_Class")
Classifier = Class(name="Classifier")
ram_Attribute = Class(name="ram_Attribute")
ram_AssociationEnd = Class(name="ram_AssociationEnd")
Property_ = Class(name="Property")
ram_COREModelReuse = Class(name="ram_COREModelReuse")
Type = Class(name="Type")
ram_RVoid = Class(name="ram_RVoid")
ram_RBoolean = Class(name="ram_RBoolean")
PrimitiveType = Class(name="PrimitiveType")
ram_Operation = Class(name="ram_Operation")
MappableElement = Class(name="MappableElement")
Traceable = Class(name="Traceable")
ram_Parameter = Class(name="ram_Parameter")
StructuralFeature = Class(name="StructuralFeature")
TemporaryProperty = Class(name="TemporaryProperty")
ram_ObjectType = Class(name="ram_ObjectType", is_abstract=True)
TypedElement = Class(name="TypedElement")
ram_PrimitiveType = Class(name="ram_PrimitiveType", is_abstract=True)
ObjectType = Class(name="ObjectType")
ImplementationClass = Class(name="ImplementationClass")
ram_MessageView = Class(name="ram_MessageView")
AbstractMessageView = Class(name="AbstractMessageView")
ram_Interaction = Class(name="ram_Interaction")
ram_MessageViewReference = Class(name="ram_MessageViewReference")
ram_RInt = Class(name="ram_RInt")
ram_RChar = Class(name="ram_RChar")
ram_RString = Class(name="ram_RString")
ram_RAny = Class(name="ram_RAny")
ram_REnum = Class(name="ram_REnum")
ram_REnumLiteral = Class(name="ram_REnumLiteral")
ram_AspectMessageView = Class(name="ram_AspectMessageView")
ram_MessageEnd = Class(name="ram_MessageEnd", is_abstract=True)
ram_StructuralFeature = Class(name="ram_StructuralFeature", is_abstract=True)
ram_ParameterValueMapping = Class(name="ram_ParameterValueMapping")
FragmentContainer = Class(name="FragmentContainer")
ram_Lifeline = Class(name="ram_Lifeline")
ram_Message = Class(name="ram_Message")
ram_Reference = Class(name="ram_Reference")
ram_Gate = Class(name="ram_Gate")
ram_TypedElement = Class(name="ram_TypedElement", is_abstract=True)
ram_InteractionFragment = Class(name="ram_InteractionFragment", is_abstract=True)
ram_CombinedFragment = Class(name="ram_CombinedFragment")
ram_InteractionOperand = Class(name="ram_InteractionOperand")
ram_OriginalBehaviorExecution = Class(name="ram_OriginalBehaviorExecution")
ram_ExecutionStatement = Class(name="ram_ExecutionStatement")
ram_ValueSpecification = Class(name="ram_ValueSpecification", is_abstract=True)
ram_TemporaryProperty = Class(name="ram_TemporaryProperty", is_abstract=True)
ram_MessageOccurrenceSpecification = Class(name="ram_MessageOccurrenceSpecification")
OccurrenceSpecification = Class(name="OccurrenceSpecification")
MessageEnd = Class(name="MessageEnd")
ram_OccurrenceSpecification = Class(name="ram_OccurrenceSpecification")
InteractionFragment = Class(name="InteractionFragment")
ram_DestructionOccurrenceSpecification = Class(name="ram_DestructionOccurrenceSpecification")
MessageOccurrenceSpecification = Class(name="MessageOccurrenceSpecification")
ram_FragmentContainer = Class(name="ram_FragmentContainer", is_abstract=True)
ram_RSet = Class(name="ram_RSet")
RCollection = Class(name="RCollection")
ram_RSequence = Class(name="ram_RSequence")
ram_ContainerMap = Class(name="ram_ContainerMap")
ram_StructuralFeatureValue = Class(name="ram_StructuralFeatureValue")
ValueSpecification = Class(name="ValueSpecification")
ram_ParameterValue = Class(name="ram_ParameterValue")
ram_OpaqueExpression = Class(name="ram_OpaqueExpression")
ram_LiteralSpecification = Class(name="ram_LiteralSpecification", is_abstract=True)
ram_LiteralString = Class(name="ram_LiteralString")
LiteralSpecification = Class(name="LiteralSpecification")
ram_LiteralInteger = Class(name="ram_LiteralInteger")
ram_RCollection = Class(name="ram_RCollection", is_abstract=True)
ram_EObject = Class(name="ram_EObject")
ram_ElementMap = Class(name="ram_ElementMap")
ram_NewLayoutElement = Class(name="ram_NewLayoutElement")
ram_TypeParameter = Class(name="ram_TypeParameter")
ram_ClassifierMapping = Class(name="ram_ClassifierMapping")
ram_OperationMapping = Class(name="ram_OperationMapping")
ram_AttributeMapping = Class(name="ram_AttributeMapping")
ram_ParameterMapping = Class(name="ram_ParameterMapping")
ram_ImplementationClass = Class(name="ram_ImplementationClass")
ram_Property = Class(name="ram_Property", is_abstract=True)
ram_LiteralBoolean = Class(name="ram_LiteralBoolean")
ram_RDouble = Class(name="ram_RDouble")
ram_StateMachine = Class(name="ram_StateMachine")
ram_CheckState = Class(name="ram_CheckState")
ram_Transition = Class(name="ram_Transition")
ram_Substitution = Class(name="ram_Substitution")
ram_Constraint = Class(name="ram_Constraint")
ram_Traceable = Class(name="ram_Traceable", is_abstract=True)
ram_RFloat = Class(name="ram_RFloat")
ram_TracingMap = Class(name="ram_TracingMap")
ram_TransitionSubstitution = Class(name="ram_TransitionSubstitution")
Substitution = Class(name="Substitution")
ram_RLong = Class(name="ram_RLong")
ram_RArray = Class(name="ram_RArray")
ram_LiteralDouble = Class(name="ram_LiteralDouble")
ram_LiteralNull = Class(name="ram_LiteralNull")
ram_EnumLiteralValue = Class(name="ram_EnumLiteralValue")
ram_AssignmentStatement = Class(name="ram_AssignmentStatement")
ram_RByte = Class(name="ram_RByte")
ram_LiteralLong = Class(name="ram_LiteralLong")
ram_LiteralFloat = Class(name="ram_LiteralFloat")
ram_LiteralByte = Class(name="ram_LiteralByte")
ram_LiteralChar = Class(name="ram_LiteralChar")
...
ram_Operation.attributes={ram_Operation_extendedVisibility, ram_Operation_static, ram_Operation_abstract, ram_Operation_operationType}
...
ram_NewLayoutElement.attributes={ram_NewLayoutElement_y, ram_NewLayoutElement_x}
...
ram_Property.attributes={ram_Property_lowerBound, ram_Property_upperBound, ram_Property_referenceType}
...
from_155: BinaryAssociation = BinaryAssociation(
    name="from_155",
    ends={
...
domain_model = DomainModel(
    name="ram",
    types={ram_MappableElement, COREModelElement, ram_Classifier, ram_Association, ram_Aspect, NamedElement, COREModel, ram_StructuralView, ram_AbstractMessageView, ram_Instantiation, ram_Layout, ram_StateView, ram_WovenAspect, ram_NamedElement, CORENamedElement, ram_Type, ram_Class, Classifier, ram_Attribute, ram_AssociationEnd, Property_, ram_COREModelReuse, Type, ram_RVoid, ram_RBoolean, PrimitiveType, ram_Operation, MappableElement, Traceable, ram_Parameter, StructuralFeature, TemporaryProperty, ram_ObjectType, TypedElement, ram_PrimitiveType, ObjectType, ImplementationClass, ram_MessageView, AbstractMessageView, ram_Interaction, ram_MessageViewReference, ram_RInt, ram_RChar, ram_RString, ram_RAny, ram_REnum, ram_REnumLiteral, ram_AspectMessageView, ram_MessageEnd, ram_StructuralFeature, ram_ParameterValueMapping, FragmentContainer, ram_Lifeline, ram_Message, ram_Reference, ram_Gate, ram_TypedElement, ram_InteractionFragment, ram_CombinedFragment, ram_InteractionOperand, ram_OriginalBehaviorExecution, ram_ExecutionStatement, ram_ValueSpecification, ram_TemporaryProperty, ram_MessageOccurrenceSpecification, OccurrenceSpecification, MessageEnd, ram_OccurrenceSpecification, InteractionFragment, ram_DestructionOccurrenceSpecification, MessageOccurrenceSpecification, ram_FragmentContainer, ram_RSet, RCollection, ram_RSequence, ram_ContainerMap, ram_StructuralFeatureValue, ValueSpecification, ram_ParameterValue, ram_OpaqueExpression, ram_LiteralSpecification, ram_LiteralString, LiteralSpecification, ram_LiteralInteger, ram_RCollection, ram_EObject, ram_ElementMap, ram_NewLayoutElement, ram_TypeParameter, ram_ClassifierMapping, ram_OperationMapping, ram_AttributeMapping, ram_ParameterMapping, ram_ImplementationClass, ram_Property, ram_LiteralBoolean, ram_RDouble, ram_StateMachine, ram_CheckState, ram_Transition, ram_Substitution, ram_Constraint, ram_Traceable, ram_RFloat, ram_TracingMap, ram_TransitionSubstitution, Substitution, ram_RLong, ram_RArray, ram_LiteralDouble, ram_LiteralNull, ram_EnumLiteralValue, ram_AssignmentStatement, ram_RByte, ram_LiteralLong, ram_LiteralFloat, ram_LiteralByte, ram_LiteralChar, RAMVisibilityType, ReferenceType, MessageSort, InteractionOperatorKind, InstantiationType, OperationType},
    associations={classes11, structuralView0, messageViews1, instantiations3, layout5, stateViews7, wovenAspects9, associations13, types15, attributes17, assoc18, classifier19, featureSelection20, ends21, returnType22, parameters24, type26, type28, specifies35, specification37, literals31, enum32, affectedBy33, sendEvent57, receiveEvent58, signature61, assignTo64, arguments66, references39, lifelines41, messages43, properties44, formalGates46, pointcut48, advice51, represents54, coveredBy56, operands78, interaction68, returns69, localProperties71, message73, covered76, container77, type96, containers98, specification79, interactionConstraint81, value84, parameter86, value89, parameter92, fragments94, key100, value102, key104, value107, operations109, associationEnds112, typeParameters114, operationMappings122, attributeMappings123, superTypes117, type119, outgoings150, parameterMappings125, stateMachines127, specifies129, start132, states134, transitions137, substitutions139, endState141, startState142, signature144, guard147, incomings149, comesFrom165, children169, Specification152, from_155, to157, genericType160, type163, wovenElements171, value173, assignTo174, value176, key179, value181},
    generalizations={gen_ram_MappableElement_NamedElement, gen_ram_MappableElement_COREModelElement, gen_ram_Aspect_NamedElement, gen_ram_Aspect_COREModel, gen_ram_NamedElement_CORENamedElement, gen_ram_Class_Classifier, gen_ram_AssociationEnd_Property, gen_ram_Association_NamedElement, gen_ram_ObjectType_Type, gen_ram_ObjectType_MappableElement, gen_ram_RVoid_Type, gen_ram_RBoolean_PrimitiveType, gen_ram_Operation_NamedElement, gen_ram_Operation_MappableElement, gen_ram_Operation_Traceable, gen_ram_Attribute_StructuralFeature, gen_ram_Attribute_TemporaryProperty, gen_ram_Attribute_MappableElement, gen_ram_Attribute_Traceable, gen_ram_Type_NamedElement, gen_ram_Parameter_TypedElement, gen_ram_Parameter_MappableElement, gen_ram_PrimitiveType_ObjectType, gen_ram_PrimitiveType_ImplementationClass, gen_ram_MessageView_AbstractMessageView, gen_ram_MessageViewReference_AbstractMessageView, gen_ram_RInt_PrimitiveType, gen_ram_RChar_PrimitiveType, gen_ram_RString_PrimitiveType, gen_ram_RAny_Type, gen_ram_REnum_PrimitiveType, gen_ram_REnumLiteral_NamedElement, gen_ram_Interaction_FragmentContainer, gen_ram_AspectMessageView_AbstractMessageView, gen_ram_AspectMessageView_NamedElement, gen_ram_CombinedFragment_InteractionFragment, gen_ram_OriginalBehaviorExecution_InteractionFragment, gen_ram_ExecutionStatement_InteractionFragment, gen_ram_MessageOccurrenceSpecification_OccurrenceSpecification, gen_ram_MessageOccurrenceSpecification_MessageEnd, gen_ram_OccurrenceSpecification_InteractionFragment, gen_ram_DestructionOccurrenceSpecification_MessageOccurrenceSpecification, gen_ram_RSet_RCollection, gen_ram_RSequence_RCollection, gen_ram_InteractionOperand_FragmentContainer, gen_ram_StructuralFeatureValue_ValueSpecification, gen_ram_ParameterValue_ValueSpecification, gen_ram_OpaqueExpression_ValueSpecification, gen_ram_LiteralSpecification_ValueSpecification, gen_ram_LiteralString_LiteralSpecification, gen_ram_LiteralInteger_LiteralSpecification, gen_ram_RCollection_Type, gen_ram_RCollection_ImplementationClass, gen_ram_Classifier_ObjectType, gen_ram_Classifier_Traceable, gen_ram_ImplementationClass_Classifier, gen_ram_StructuralFeature_TypedElement, gen_ram_Reference_Property, gen_ram_Reference_TemporaryProperty, gen_ram_Property_StructuralFeature, gen_ram_TypedElement_NamedElement, gen_ram_Gate_MessageEnd, gen_ram_Gate_NamedElement, gen_ram_LiteralBoolean_LiteralSpecification, gen_ram_RDouble_PrimitiveType, gen_ram_StateView_NamedElement, gen_ram_Transition_NamedElement, gen_ram_CheckState_NamedElement, gen_ram_WovenAspect_NamedElement, gen_ram_RFloat_PrimitiveType, gen_ram_TransitionSubstitution_Substitution, gen_ram_TypeParameter_Type, gen_ram_RLong_PrimitiveType, gen_ram_RArray_PrimitiveType, gen_ram_LiteralChar_LiteralSpecification, gen_ram_LiteralDouble_LiteralSpecification, gen_ram_LiteralNull_LiteralSpecification, gen_ram_EnumLiteralValue_ValueSpecification, gen_ram_AssignmentStatement_InteractionFragment, gen_ram_RByte_PrimitiveType, gen_ram_LiteralLong_LiteralSpecification, gen_ram_LiteralFloat_LiteralSpecification, gen_ram_LiteralByte_LiteralSpecification},
    metadata=None
)
