...
class sunBooks_BookType:
    ...
    def __init__(self, bookCategory: str, itemId: str, name: str, iSBN: str, price: str, description: str, publicationDate: str, sunBooks_BookType: "sunBooks_BooksType" = None, sunBooks_BookType2: "sunBooks_AuthorsType" = None, sunBooks_BookType4: "sunBooks_PromotionType" = None):
