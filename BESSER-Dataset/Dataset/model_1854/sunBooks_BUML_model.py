...
# Classes
sunBooks_BooksType = Class(name="sunBooks_BooksType")
sunBooks_AuthorsType = Class(name="sunBooks_AuthorsType")
sunBooks_CollectionType = Class(name="sunBooks_CollectionType")
sunBooks_BookType = Class(name="sunBooks_BookType")
sunBooks_PromotionType = Class(name="sunBooks_PromotionType")
sunBooks_DocumentRoot = Class(name="sunBooks_DocumentRoot")
sunBooks_EStringToStringMapEntry = Class(name="sunBooks_EStringToStringMapEntry")
...
sunBooks_BookType.attributes={sunBooks_BookType_price, sunBooks_BookType_description, sunBooks_BookType_itemId, sunBooks_BookType_iSBN, sunBooks_BookType_publicationDate, sunBooks_BookType_bookCategory, sunBooks_BookType_name}
...
domain_model = DomainModel(
    name="sunBooks",
    types={sunBooks_BooksType, sunBooks_AuthorsType, sunBooks_CollectionType, sunBooks_BookType, sunBooks_PromotionType, sunBooks_DocumentRoot, sunBooks_EStringToStringMapEntry, BookCategoryType, BookCategoryType1},
