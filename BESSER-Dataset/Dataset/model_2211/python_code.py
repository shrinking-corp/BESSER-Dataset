...
class StudyProgrammes_Specialization:
    ...
    def __init__(self, name: str, startSemester: int, lengthInSemesters: int, StudyProgrammes_Specialization: "StudyProgrammes_Programme" = None, StudyProgrammes_Specialization8: set["StudyProgrammes_Semester"] = None):
        self.name = name
...
class StudyProgrammes_Programme:
    ...
    def __init__(self, name: str, code: str, startYear: int, totalNumberOfSemesters: int, semestersBeforeSpecialization: int, StudyProgrammes_Programme: "StudyProgrammes_Department" = None, StudyProgrammes_Programme4: set["StudyProgrammes_Specialization"] = None, StudyProgrammes_Programme6: set["StudyProgrammes_Semester"] = None):
        self.name = name
        self.code = code
        ...
        pass
    @property
    def semestersBeforeSpecialization(self):
    ...
    @property
    def totalNumberOfSemesters(self):
