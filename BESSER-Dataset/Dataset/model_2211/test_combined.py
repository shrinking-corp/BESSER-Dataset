...
def test_hyp_studyprogrammes_courseaccess_is_not_abstract():
    assert not inspect.isabstract(StudyProgrammes_CourseAccess)


def test_hyp_studyprogrammes_courseaccess_constructor_exists():
    assert callable(StudyProgrammes_CourseAccess.__init__)


def test_hyp_studyprogrammes_courseaccess_constructor_args():
...
def test_hyp_studyprogrammes_semester_is_not_abstract():
    assert not inspect.isabstract(StudyProgrammes_Semester)


def test_hyp_studyprogrammes_semester_constructor_exists():
    assert callable(StudyProgrammes_Semester.__init__)


def test_hyp_studyprogrammes_semester_constructor_args():
...
def test_hyp_studyprogrammes_specialization_is_not_abstract():
    assert not inspect.isabstract(StudyProgrammes_Specialization)


def test_hyp_studyprogrammes_specialization_constructor_exists():
    assert callable(StudyProgrammes_Specialization.__init__)


def test_hyp_studyprogrammes_specialization_constructor_args():
...
def test_hyp_studyprogrammes_course_is_not_abstract():
    assert not inspect.isabstract(StudyProgrammes_Course)


def test_hyp_studyprogrammes_course_constructor_exists():
    assert callable(StudyProgrammes_Course.__init__)


def test_hyp_studyprogrammes_course_constructor_args():
...
def test_hyp_studyprogrammes_programme_is_not_abstract():
    assert not inspect.isabstract(StudyProgrammes_Programme)


def test_hyp_studyprogrammes_programme_constructor_exists():
    assert callable(StudyProgrammes_Programme.__init__)


def test_hyp_studyprogrammes_programme_constructor_args():
...
def test_hyp_studyprogrammes_department_is_not_abstract():
    assert not inspect.isabstract(StudyProgrammes_Department)


def test_hyp_studyprogrammes_department_constructor_exists():
    assert callable(StudyProgrammes_Department.__init__)


def test_hyp_studyprogrammes_department_constructor_args():
    sig = inspect.signature(StudyProgrammes_Department.__init__)
    params = list(sig.parameters.keys())
    assert "name" in params, "Missing parameter 'name'"


def test_hyp_semesterseason_exists():
    # Check that the Enumeration exists
    assert SemesterSeason is not None

def test_hyp_semesterseason_has_all_literals():
...
def test_hyp_studyprogrammes_courseaccess_access_setter(instance):
...
def test_hyp_studyprogrammes_semester_semesterSeason_setter(instance):
...
@given(instance=StudyProgrammes_Semester_strategy)
def test_hyp_studyprogrammes_semester_year_setter(instance):
...
@given(instance=StudyProgrammes_Semester_strategy)
def test_hyp_studyprogrammes_semester_code_setter(instance):
...
def test_hyp_studyprogrammes_specialization_startSemester_setter(instance):
...
@given(instance=StudyProgrammes_Specialization_strategy)
def test_hyp_studyprogrammes_specialization_name_setter(instance):
...
@given(instance=StudyProgrammes_Specialization_strategy)
def test_hyp_studyprogrammes_specialization_lengthInSemesters_setter(instance):
...
def test_hyp_studyprogrammes_course_code_setter(instance):
    original = instance.code
    instance.code = original
    assert instance.code == original
...
@given(instance=StudyProgrammes_Course_strategy)
def test_hyp_studyprogrammes_course_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=StudyProgrammes_Course_strategy)
def test_hyp_studyprogrammes_course_availableSemesters_setter(instance):
...
@given(instance=StudyProgrammes_Course_strategy)
def test_hyp_studyprogrammes_course_credits_setter(instance):
...
def test_hyp_studyprogrammes_programme_startYear_setter(instance):
...
@given(instance=StudyProgrammes_Programme_strategy)
def test_hyp_studyprogrammes_programme_semestersBeforeSpecialization_setter(instance):
...
@given(instance=StudyProgrammes_Programme_strategy)
def test_hyp_studyprogrammes_programme_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=StudyProgrammes_Programme_strategy)
def test_hyp_studyprogrammes_programme_code_setter(instance):
    original = instance.code
    instance.code = original
    assert instance.code == original
...
@given(instance=StudyProgrammes_Programme_strategy)
def test_hyp_studyprogrammes_programme_totalNumberOfSemesters_setter(instance):
...
def test_hyp_studyprogrammes_department_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
