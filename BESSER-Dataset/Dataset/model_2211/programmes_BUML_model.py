...
# Classes
StudyProgrammes_Department = Class(name="StudyProgrammes_Department")
StudyProgrammes_Programme = Class(name="StudyProgrammes_Programme")
StudyProgrammes_Course = Class(name="StudyProgrammes_Course")
StudyProgrammes_Specialization = Class(name="StudyProgrammes_Specialization")
StudyProgrammes_Semester = Class(name="StudyProgrammes_Semester")
StudyProgrammes_CourseAccess = Class(name="StudyProgrammes_CourseAccess")
...
StudyProgrammes_Programme.attributes={StudyProgrammes_Programme_name, StudyProgrammes_Programme_code, StudyProgrammes_Programme_totalNumberOfSemesters, StudyProgrammes_Programme_semestersBeforeSpecialization, StudyProgrammes_Programme_startYear}
...
StudyProgrammes_Course.attributes={StudyProgrammes_Course_availableSemesters, StudyProgrammes_Course_name, StudyProgrammes_Course_code, StudyProgrammes_Course_credits}
...
StudyProgrammes_Semester.attributes={StudyProgrammes_Semester_code, StudyProgrammes_Semester_semesterSeason, StudyProgrammes_Semester_year}
...
domain_model = DomainModel(
    ...
    types={StudyProgrammes_Department, StudyProgrammes_Programme, StudyProgrammes_Course, StudyProgrammes_Specialization, StudyProgrammes_Semester, StudyProgrammes_CourseAccess, Access, SemesterSeason},
    associations={programmes0, courses1, specializations3, semesters5, semesters7, courseAccesses10, course12},
    generalizations={},
    metadata=None
)
