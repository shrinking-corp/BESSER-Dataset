...
class logiclanguage_Type(TypeDescriptor):
    ...
    def __init__(self, isAbstract: bool, name: str, Type4: "logiclanguage_Type" = None, subtypes: set["logiclanguage_Type"] = None, Type: "logiclanguage_Type" = None, supertypes: set["logiclanguage_Type"] = None, logiclanguage_Type: "logiclanguage_ComplexTypeReference" = None):
