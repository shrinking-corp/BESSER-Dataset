...
# Classes
logiclanguage_DefinedElement = Class(name="logiclanguage_DefinedElement")
SymbolicDeclaration = Class(name="SymbolicDeclaration")
logiclanguage_TypeDefinition = Class(name="logiclanguage_TypeDefinition")
Type = Class(name="Type")
logiclanguage_TypeDeclaration = Class(name="logiclanguage_TypeDeclaration")
logiclanguage_TypeReference = Class(name="logiclanguage_TypeReference", is_abstract=True)
logiclanguage_ComplexTypeReference = Class(name="logiclanguage_ComplexTypeReference")
TypeReference = Class(name="TypeReference")
logiclanguage_Type = Class(name="logiclanguage_Type", is_abstract=True)
TypeDescriptor = Class(name="TypeDescriptor")
logiclanguage_AtomicTerm = Class(name="logiclanguage_AtomicTerm", is_abstract=True)
logiclanguage_IntLiteral = Class(name="logiclanguage_IntLiteral")
AtomicTerm = Class(name="AtomicTerm")
logiclanguage_BoolLiteral = Class(name="logiclanguage_BoolLiteral")
logiclanguage_RealLiteral = Class(name="logiclanguage_RealLiteral")
logiclanguage_Variable = Class(name="logiclanguage_Variable")
logiclanguage_QuantifiedExpression = Class(name="logiclanguage_QuantifiedExpression", is_abstract=True)
logiclanguage_Exists = Class(name="logiclanguage_Exists")
QuantifiedExpression = Class(name="QuantifiedExpression")
logiclanguage_PrimitiveTypeReference = Class(name="logiclanguage_PrimitiveTypeReference", is_abstract=True)
logiclanguage_IntTypeReference = Class(name="logiclanguage_IntTypeReference")
PrimitiveTypeReference = Class(name="PrimitiveTypeReference")
logiclanguage_BoolTypeReference = Class(name="logiclanguage_BoolTypeReference")
logiclanguage_RealTypeReference = Class(name="logiclanguage_RealTypeReference")
logiclanguage_Function = Class(name="logiclanguage_Function", is_abstract=True)
logiclanguage_FunctionAnnotation = Class(name="logiclanguage_FunctionAnnotation")
logiclanguage_Term = Class(name="logiclanguage_Term", is_abstract=True)
TermDescription = Class(name="TermDescription")
logiclanguage_SymbolicDeclaration = Class(name="logiclanguage_SymbolicDeclaration", is_abstract=True)
logiclanguage_SymbolicValue = Class(name="logiclanguage_SymbolicValue")
Term = Class(name="Term")
logiclanguage_PrimitiveRelation = Class(name="logiclanguage_PrimitiveRelation", is_abstract=True)
logiclanguage_Equals = Class(name="logiclanguage_Equals")
PrimitiveRelation = Class(name="PrimitiveRelation")
logiclanguage_Distinct = Class(name="logiclanguage_Distinct")
logiclanguage_LessThan = Class(name="logiclanguage_LessThan")
logiclanguage_MoreThan = Class(name="logiclanguage_MoreThan")
logiclanguage_Forall = Class(name="logiclanguage_Forall")
logiclanguage_BoolOperation = Class(name="logiclanguage_BoolOperation", is_abstract=True)
logiclanguage_And = Class(name="logiclanguage_And")
BoolOperation = Class(name="BoolOperation")
logiclanguage_Or = Class(name="logiclanguage_Or")
logiclanguage_Impl = Class(name="logiclanguage_Impl")
logiclanguage_Not = Class(name="logiclanguage_Not")
logiclanguage_Iff = Class(name="logiclanguage_Iff")
logiclanguage_Plus = Class(name="logiclanguage_Plus")
NumericOperation = Class(name="NumericOperation")
logiclanguage_Minus = Class(name="logiclanguage_Minus")
logiclanguage_Multiply = Class(name="logiclanguage_Multiply")
logiclanguage_Divison = Class(name="logiclanguage_Divison")
logiclanguage_Mod = Class(name="logiclanguage_Mod")
logiclanguage_TypeDescriptor = Class(name="logiclanguage_TypeDescriptor", is_abstract=True)
logiclanguage_TermDescription = Class(name="logiclanguage_TermDescription", is_abstract=True)
logiclanguage_Assertion = Class(name="logiclanguage_Assertion")
logiclanguage_AssertionAnnotation = Class(name="logiclanguage_AssertionAnnotation")
logiclanguage_Relation = Class(name="logiclanguage_Relation", is_abstract=True)
logiclanguage_RelationAnnotation = Class(name="logiclanguage_RelationAnnotation")
logiclanguage_LessOrEqualThan = Class(name="logiclanguage_LessOrEqualThan")
logiclanguage_MoreOrEqualThan = Class(name="logiclanguage_MoreOrEqualThan")
logiclanguage_NumericOperation = Class(name="logiclanguage_NumericOperation", is_abstract=True)
logiclanguage_RelationDeclaration = Class(name="logiclanguage_RelationDeclaration")
logiclanguage_FunctionDefinition = Class(name="logiclanguage_FunctionDefinition")
Function = Class(name="Function")
logiclanguage_FunctionDeclaration = Class(name="logiclanguage_FunctionDeclaration")
logiclanguage_IfThenElse = Class(name="logiclanguage_IfThenElse")
logiclanguage_Constant = Class(name="logiclanguage_Constant", is_abstract=True)
logiclanguage_ConstantAnnotation = Class(name="logiclanguage_ConstantAnnotation")
logiclanguage_ConstantDefinition = Class(name="logiclanguage_ConstantDefinition")
Constant = Class(name="Constant")
logiclanguage_ConstantDeclaration = Class(name="logiclanguage_ConstantDeclaration")
logiclanguage_RelationDefinition = Class(name="logiclanguage_RelationDefinition")
Relation = Class(name="Relation")
logiclanguage_Pow = Class(name="logiclanguage_Pow")
logiclanguage_AggregateExpression = Class(name="logiclanguage_AggregateExpression", is_abstract=True)
logiclanguage_AggregatedParameterSubstitution = Class(name="logiclanguage_AggregatedParameterSubstitution")
logiclanguage_Sum = Class(name="logiclanguage_Sum")
ProjectedAggregateExpression = Class(name="ProjectedAggregateExpression")
logiclanguage_Count = Class(name="logiclanguage_Count")
AggregateExpression = Class(name="AggregateExpression")
logiclanguage_Min = Class(name="logiclanguage_Min")
logiclanguage_Max = Class(name="logiclanguage_Max")
logiclanguage_ProjectedAggregateExpression = Class(name="logiclanguage_ProjectedAggregateExpression", is_abstract=True)
logiclanguage_UnknownBecauseUninterpreted = Class(name="logiclanguage_UnknownBecauseUninterpreted")
logiclanguage_InstanceOf = Class(name="logiclanguage_InstanceOf")
logiclanguage_StringTypeReference = Class(name="logiclanguage_StringTypeReference")
logiclanguage_StringLiteral = Class(name="logiclanguage_StringLiteral")
logiclanguage_TransitiveClosure = Class(name="logiclanguage_TransitiveClosure")
...
logiclanguage_Type.attributes={logiclanguage_Type_name, logiclanguage_Type_isAbstract}
...
domain_model = DomainModel(
    name="logiclanguage",
    types={logiclanguage_DefinedElement, SymbolicDeclaration, logiclanguage_TypeDefinition, Type, logiclanguage_TypeDeclaration, logiclanguage_TypeReference, logiclanguage_ComplexTypeReference, TypeReference, logiclanguage_Type, TypeDescriptor, logiclanguage_AtomicTerm, logiclanguage_IntLiteral, AtomicTerm, logiclanguage_BoolLiteral, logiclanguage_RealLiteral, logiclanguage_Variable, logiclanguage_QuantifiedExpression, logiclanguage_Exists, QuantifiedExpression, logiclanguage_PrimitiveTypeReference, logiclanguage_IntTypeReference, PrimitiveTypeReference, logiclanguage_BoolTypeReference, logiclanguage_RealTypeReference, logiclanguage_Function, logiclanguage_FunctionAnnotation, logiclanguage_Term, TermDescription, logiclanguage_SymbolicDeclaration, logiclanguage_SymbolicValue, Term, logiclanguage_PrimitiveRelation, logiclanguage_Equals, PrimitiveRelation, logiclanguage_Distinct, logiclanguage_LessThan, logiclanguage_MoreThan, logiclanguage_Forall, logiclanguage_BoolOperation, logiclanguage_And, BoolOperation, logiclanguage_Or, logiclanguage_Impl, logiclanguage_Not, logiclanguage_Iff, logiclanguage_Plus, NumericOperation, logiclanguage_Minus, logiclanguage_Multiply, logiclanguage_Divison, logiclanguage_Mod, logiclanguage_TypeDescriptor, logiclanguage_TermDescription, logiclanguage_Assertion, logiclanguage_AssertionAnnotation, logiclanguage_Relation, logiclanguage_RelationAnnotation, logiclanguage_LessOrEqualThan, logiclanguage_MoreOrEqualThan, logiclanguage_NumericOperation, logiclanguage_RelationDeclaration, logiclanguage_FunctionDefinition, Function, logiclanguage_FunctionDeclaration, logiclanguage_IfThenElse, logiclanguage_Constant, logiclanguage_ConstantAnnotation, logiclanguage_ConstantDefinition, Constant, logiclanguage_ConstantDeclaration, logiclanguage_RelationDefinition, Relation, logiclanguage_Pow, logiclanguage_AggregateExpression, logiclanguage_AggregatedParameterSubstitution, logiclanguage_Sum, ProjectedAggregateExpression, logiclanguage_Count, AggregateExpression, logiclanguage_Min, logiclanguage_Max, logiclanguage_ProjectedAggregateExpression, logiclanguage_UnknownBecauseUninterpreted, logiclanguage_InstanceOf, logiclanguage_StringTypeReference, logiclanguage_StringLiteral, logiclanguage_TransitiveClosure},
    associations={supertypes3, definedInType5, elements6, defines7, subtypes1, parameterSubstitutions15, range17, quantifiedVariables19, expression21, referred8, range9, parameters10, annotations13, symbolicReference14, rightOperand37, leftOperand40, rightOperand42, operands45, leftOperand47, rightOperand49, operands24, operands26, leftOperand28, rightOperand30, operand33, leftOperand35, rightOperand69, value72, annotations74, parameters76, leftOperand52, rightOperand54, leftOperand57, rightOperand59, leftOperand62, rightOperand64, leftOperand67, defines93, variable95, defines97, value99, condition102, ifTrue104, ifFalse107, annotations78, type80, annotations82, value84, defines86, variables88, value90, relation120, relation123, parameterSubstitution125, resultVariable127, value110, range112, leftOperand115, rightOperand117, variable130},
    generalizations={gen_logiclanguage_DefinedElement_SymbolicDeclaration, gen_logiclanguage_TypeDefinition_Type, gen_logiclanguage_TypeReference_TypeDescriptor, gen_logiclanguage_ComplexTypeReference_TypeReference, gen_logiclanguage_Type_TypeDescriptor, gen_logiclanguage_AtomicTerm_Term, gen_logiclanguage_IntLiteral_AtomicTerm, gen_logiclanguage_BoolLiteral_AtomicTerm, gen_logiclanguage_RealLiteral_AtomicTerm, gen_logiclanguage_Variable_SymbolicDeclaration, gen_logiclanguage_QuantifiedExpression_Term, gen_logiclanguage_Exists_QuantifiedExpression, gen_logiclanguage_PrimitiveTypeReference_TypeReference, gen_logiclanguage_IntTypeReference_PrimitiveTypeReference, gen_logiclanguage_BoolTypeReference_PrimitiveTypeReference, gen_logiclanguage_RealTypeReference_PrimitiveTypeReference, gen_logiclanguage_Function_SymbolicDeclaration, gen_logiclanguage_Term_TermDescription, gen_logiclanguage_SymbolicDeclaration_TermDescription, gen_logiclanguage_SymbolicValue_Term, gen_logiclanguage_PrimitiveRelation_Term, gen_logiclanguage_Equals_PrimitiveRelation, gen_logiclanguage_Distinct_PrimitiveRelation, gen_logiclanguage_LessThan_PrimitiveRelation, gen_logiclanguage_MoreThan_PrimitiveRelation, gen_logiclanguage_Forall_QuantifiedExpression, gen_logiclanguage_BoolOperation_Term, gen_logiclanguage_And_BoolOperation, gen_logiclanguage_Or_BoolOperation, gen_logiclanguage_Impl_BoolOperation, gen_logiclanguage_Not_BoolOperation, gen_logiclanguage_Iff_BoolOperation, gen_logiclanguage_Plus_NumericOperation, gen_logiclanguage_Minus_NumericOperation, gen_logiclanguage_Multiply_NumericOperation, gen_logiclanguage_Divison_NumericOperation, gen_logiclanguage_Mod_NumericOperation, gen_logiclanguage_Relation_SymbolicDeclaration, gen_logiclanguage_LessOrEqualThan_PrimitiveRelation, gen_logiclanguage_MoreOrEqualThan_PrimitiveRelation, gen_logiclanguage_NumericOperation_Term, gen_logiclanguage_FunctionDefinition_Function, gen_logiclanguage_IfThenElse_Term, gen_logiclanguage_ConstantDeclaration_Constant, gen_logiclanguage_RelationDeclaration_Relation, gen_logiclanguage_Constant_SymbolicDeclaration, gen_logiclanguage_ConstantDefinition_Constant, gen_logiclanguage_RelationDefinition_Relation, gen_logiclanguage_Pow_NumericOperation, gen_logiclanguage_AggregateExpression_Term, gen_logiclanguage_Sum_ProjectedAggregateExpression, gen_logiclanguage_Count_AggregateExpression, gen_logiclanguage_Min_ProjectedAggregateExpression, gen_logiclanguage_Max_ProjectedAggregateExpression, gen_logiclanguage_ProjectedAggregateExpression_AggregateExpression, gen_logiclanguage_FunctionDeclaration_Function, gen_logiclanguage_TypeDeclaration_Type, gen_logiclanguage_UnknownBecauseUninterpreted_Term, gen_logiclanguage_InstanceOf_Term, gen_logiclanguage_StringTypeReference_PrimitiveTypeReference, gen_logiclanguage_StringLiteral_AtomicTerm, gen_logiclanguage_TransitiveClosure_Term},
    metadata=None
)
