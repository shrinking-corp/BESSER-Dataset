...
def test_hyp_font_greeting_is_not_abstract():
    assert not inspect.isabstract(font_Greeting)


def test_hyp_font_greeting_constructor_exists():
    assert callable(font_Greeting.__init__)


def test_hyp_font_greeting_constructor_args():
...
def test_hyp_font_model_is_not_abstract():
    assert not inspect.isabstract(font_Model)


def test_hyp_font_model_constructor_exists():
    assert callable(font_Model.__init__)


def test_hyp_font_model_constructor_args():
...
def test_hyp_font_greeting_name_setter(instance):
