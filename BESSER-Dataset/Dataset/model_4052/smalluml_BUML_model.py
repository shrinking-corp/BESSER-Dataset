...
smalluml_Bool = Class(name="smalluml_Bool")
smalluml_Real = Class(name="smalluml_Real")
smalluml_UnlimitedNatural = Class(name="smalluml_UnlimitedNatural")
smalluml_Parameter = Class(name="smalluml_Parameter")
smalluml_Relation = Class(name="smalluml_Relation", is_abstract=True)
smalluml_Role = Class(name="smalluml_Role")
smalluml_Enumeration = Class(name="smalluml_Enumeration")
smalluml_Composition = Class(name="smalluml_Composition")
Relation = Class(name="Relation")
smalluml_Reference = Class(name="smalluml_Reference")
