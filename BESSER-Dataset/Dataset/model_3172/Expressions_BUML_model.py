...
domain_model = DomainModel(
    name="expressions",
    types={expressions_And, expressions_Equality, expressions_Comparison, expressions_ExpressionsModel, expressions_AbstractElement, expressions_Variable, AbstractElement, expressions_Expression, expressions_Or, Expression, expressions_Not, expressions_IntConstant, expressions_StringConstant, expressions_BoolConstant, expressions_VariableRef, expressions_Plus, expressions_Minus, expressions_MulOrDiv},
    associations={right4, left7, right9, left12, right14, left17, right19, elements0, expression1, left2, expression37, variable39, left22, right24, left27, right29, left32, right34},
    generalizations={gen_expressions_And_Expression, gen_expressions_Equality_Expression, gen_expressions_Comparison_Expression, gen_expressions_Variable_AbstractElement, gen_expressions_Expression_AbstractElement, gen_expressions_Or_Expression, gen_expressions_Not_Expression, gen_expressions_IntConstant_Expression, gen_expressions_StringConstant_Expression, gen_expressions_BoolConstant_Expression, gen_expressions_VariableRef_Expression, gen_expressions_Plus_Expression, gen_expressions_Minus_Expression, gen_expressions_MulOrDiv_Expression},
    metadata=None
)
