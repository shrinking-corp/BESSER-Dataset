...
def test_StateMachineTraverser_FSM_isa_FSM():
    instance = StateMachineTraverser_FSM()
    assert isinstance(instance, FSM)


def test_StateMachineTraverser_State_isa_State():
    instance = StateMachineTraverser_State()
...
StateMachineTraverser_FSM_strategy = st.builds(StateMachineTraverser_FSM)
...
StateMachineTraverser_State_strategy = st.builds(StateMachineTraverser_State)
