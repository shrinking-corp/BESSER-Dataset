...
university_Certificate = Class(name="university_Certificate")
...
university_University.attributes={university_University_name, university_University_averageLength, university_University_numberOfStudents}
...
domain_model = DomainModel(
    name="university",
    types={university_Course, university_Professor, university_Certificate, university_University, university_Student},
    associations={professor0, courseCertificates1, courses2, professors3, courses4, students6, studentCertificates10, student12, course13, certificates8},
    generalizations={},
    metadata=None
)
