...
class university_Course:
    ...
    def __init__(self, name: str, gradeAverage: float, numberOfAttendants: int, courses: "university_Professor" = None, course: set["university_Certificate"] = None, Course: "university_Professor" = None, university_Course: "university_University" = None, Course14: "university_Certificate" = None):
        self.name = name
...
class university_Student:
    ...
    def __init__(self, MNR: str, semester: int, university_Student: "university_University" = None, student: set["university_Certificate"] = None, Student: "university_Certificate" = None):
        self.MNR = MNR
...
class university_Certificate:
    ...
    def __init__(self, note: int, Certificate: "university_Course" = None, Certificate11: "university_Student" = None, studentCertificates: "university_Student" = None, courseCertificates: "university_Course" = None, university_Certificate: "university_University" = None):
        self.note = note
...
class university_Professor:
    ...
    def __init__(self, name: str, Professor: "university_Course" = None, professor: set["university_Course"] = None, university_Professor: "university_University" = None):
        self.name = name
