...
# Classes
dsl_Mover = Class(name="dsl_Mover")
dsl_Model = Class(name="dsl_Model")
dsl_Weapon = Class(name="dsl_Weapon")
dsl_Unit = Class(name="dsl_Unit")
dsl_Race = Class(name="dsl_Race")
dsl_Actor = Class(name="dsl_Actor")
dsl_Effect = Class(name="dsl_Effect")
dsl_Turrent = Class(name="dsl_Turrent")
dsl_Projectile = Class(name="dsl_Projectile")
dsl_ModelActor = Class(name="dsl_ModelActor")
Actor = Class(name="Actor")
dsl_ActorList = Class(name="dsl_ActorList")
dsl_ParticleActor = Class(name="dsl_ParticleActor")
dsl_Color = Class(name="dsl_Color")
dsl_AnimtationActor = Class(name="dsl_AnimtationActor")
dsl_UnitWeaponLink = Class(name="dsl_UnitWeaponLink")
dsl_PersistentEffect = Class(name="dsl_PersistentEffect")
Effect = Class(name="Effect")
dsl_DamageEffect = Class(name="dsl_DamageEffect")
dsl_LauncherEffect = Class(name="dsl_LauncherEffect")
...
dsl_Mover.attributes={dsl_Mover_name, dsl_Mover_standingMode, dsl_Mover_heightmap, dsl_Mover_pathfindingMode}
...
dsl_Weapon.attributes={dsl_Weapon_scanRange, dsl_Weapon_name, dsl_Weapon_sourceBone, dsl_Weapon_directionBone, dsl_Weapon_uIName, dsl_Weapon_period, dsl_Weapon_range}
...
dsl_Unit.attributes={dsl_Unit_sight, dsl_Unit_mass, dsl_Unit_uIName, dsl_Unit_maxHealth, dsl_Unit_name, dsl_Unit_speed, dsl_Unit_radius, dsl_Unit_separationRadius}
...
dsl_Turrent.attributes={dsl_Turrent_boneName, dsl_Turrent_onIdle, dsl_Turrent_idleSpeed, dsl_Turrent_name, dsl_Turrent_speed}
...
dsl_Projectile.attributes={dsl_Projectile_mass, dsl_Projectile_name, dsl_Projectile_precision, dsl_Projectile_speed}
...
dsl_ModelActor.attributes={dsl_ModelActor_scale, dsl_ModelActor_modelPath}
...
dsl_ParticleActor.attributes={dsl_ParticleActor_maxCount, dsl_ParticleActor_maxLife, dsl_ParticleActor_minLife, dsl_ParticleActor_startVariation, dsl_ParticleActor_nbRow, dsl_ParticleActor_add, dsl_ParticleActor_startSize, dsl_ParticleActor_endSize, dsl_ParticleActor_perSecond, dsl_ParticleActor_directionBone, dsl_ParticleActor_nbCol, dsl_ParticleActor_spritePath, dsl_ParticleActor_duration, dsl_ParticleActor_emissionBone}
...
dsl_Color.attributes={dsl_Color_b, dsl_Color_g, dsl_Color_r, dsl_Color_a}
...
dsl_AnimtationActor.attributes={dsl_AnimtationActor_speed, dsl_AnimtationActor_cycle, dsl_AnimtationActor_animName}
...
dsl_PersistentEffect.attributes={dsl_PersistentEffect_periodCount, dsl_PersistentEffect_ranges, dsl_PersistentEffect_durations}
...
domain_model = DomainModel(
    name="dsl",
    types={dsl_Mover, dsl_Model, dsl_Weapon, dsl_Unit, dsl_Race, dsl_Actor, dsl_Effect, dsl_Turrent, dsl_Projectile, dsl_ModelActor, Actor, dsl_ActorList, dsl_ParticleActor, dsl_Color, dsl_AnimtationActor, dsl_UnitWeaponLink, dsl_PersistentEffect, Effect, dsl_DamageEffect, dsl_LauncherEffect},
    associations={weapons0, units1, races3, movers5, actors7, effects9, turrents11, projectiles13, actorlist15, actor31, startColor16, endColor17, actor20, race23, mover26, weapons29, actor56, weapon34, turrent37, effect40, actor43, effects46, effects48, projectiles50, mover53},
