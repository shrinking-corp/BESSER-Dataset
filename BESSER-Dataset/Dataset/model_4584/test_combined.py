...
def test_hyp_dsl_launchereffect_is_not_abstract():
    assert not inspect.isabstract(dsl_LauncherEffect)


def test_hyp_dsl_launchereffect_constructor_exists():
    assert callable(dsl_LauncherEffect.__init__)


def test_hyp_dsl_launchereffect_constructor_args():
    sig = inspect.signature(dsl_LauncherEffect.__init__)
    params = list(sig.parameters.keys())



def test_hyp_dsl_damageeffect_is_not_abstract():
    assert not inspect.isabstract(dsl_DamageEffect)


def test_hyp_dsl_damageeffect_constructor_exists():
    assert callable(dsl_DamageEffect.__init__)


def test_hyp_dsl_damageeffect_constructor_args():
...
def test_hyp_dsl_persistenteffect_is_not_abstract():
    assert not inspect.isabstract(dsl_PersistentEffect)


def test_hyp_dsl_persistenteffect_constructor_exists():
    assert callable(dsl_PersistentEffect.__init__)


def test_hyp_dsl_persistenteffect_constructor_args():
...
def test_hyp_dsl_unitweaponlink_is_not_abstract():
    assert not inspect.isabstract(dsl_UnitWeaponLink)


def test_hyp_dsl_unitweaponlink_constructor_exists():
    assert callable(dsl_UnitWeaponLink.__init__)


def test_hyp_dsl_unitweaponlink_constructor_args():
    sig = inspect.signature(dsl_UnitWeaponLink.__init__)
    params = list(sig.parameters.keys())



def test_hyp_dsl_color_is_not_abstract():
    assert not inspect.isabstract(dsl_Color)


def test_hyp_dsl_color_constructor_exists():
    assert callable(dsl_Color.__init__)


def test_hyp_dsl_color_constructor_args():
...
def test_hyp_dsl_actorlist_is_not_abstract():
    assert not inspect.isabstract(dsl_ActorList)


def test_hyp_dsl_actorlist_constructor_exists():
    assert callable(dsl_ActorList.__init__)


def test_hyp_dsl_actorlist_constructor_args():
...
def test_hyp_dsl_particleactor_is_not_abstract():
    assert not inspect.isabstract(dsl_ParticleActor)


def test_hyp_dsl_particleactor_constructor_exists():
    assert callable(dsl_ParticleActor.__init__)


def test_hyp_dsl_particleactor_constructor_args():
...
def test_hyp_dsl_animtationactor_is_not_abstract():
    assert not inspect.isabstract(dsl_AnimtationActor)


def test_hyp_dsl_animtationactor_constructor_exists():
    assert callable(dsl_AnimtationActor.__init__)


def test_hyp_dsl_animtationactor_constructor_args():
...
def test_hyp_dsl_modelactor_is_not_abstract():
    assert not inspect.isabstract(dsl_ModelActor)


def test_hyp_dsl_modelactor_constructor_exists():
    assert callable(dsl_ModelActor.__init__)


def test_hyp_dsl_modelactor_constructor_args():
...
def test_hyp_dsl_projectile_is_not_abstract():
    assert not inspect.isabstract(dsl_Projectile)


def test_hyp_dsl_projectile_constructor_exists():
    assert callable(dsl_Projectile.__init__)


def test_hyp_dsl_projectile_constructor_args():
...
def test_hyp_dsl_turrent_is_not_abstract():
    assert not inspect.isabstract(dsl_Turrent)


def test_hyp_dsl_turrent_constructor_exists():
    assert callable(dsl_Turrent.__init__)


def test_hyp_dsl_turrent_constructor_args():
...
def test_hyp_dsl_effect_is_not_abstract():
    assert not inspect.isabstract(dsl_Effect)


def test_hyp_dsl_effect_constructor_exists():
    assert callable(dsl_Effect.__init__)


def test_hyp_dsl_effect_constructor_args():
...
def test_hyp_dsl_actor_is_not_abstract():
    assert not inspect.isabstract(dsl_Actor)


def test_hyp_dsl_actor_constructor_exists():
    assert callable(dsl_Actor.__init__)


def test_hyp_dsl_actor_constructor_args():
...
def test_hyp_dsl_race_is_not_abstract():
    assert not inspect.isabstract(dsl_Race)


def test_hyp_dsl_race_constructor_exists():
    assert callable(dsl_Race.__init__)


def test_hyp_dsl_race_constructor_args():
...
def test_hyp_dsl_unit_is_not_abstract():
    assert not inspect.isabstract(dsl_Unit)


def test_hyp_dsl_unit_constructor_exists():
    assert callable(dsl_Unit.__init__)


def test_hyp_dsl_unit_constructor_args():
...
def test_hyp_dsl_weapon_is_not_abstract():
    assert not inspect.isabstract(dsl_Weapon)


def test_hyp_dsl_weapon_constructor_exists():
    assert callable(dsl_Weapon.__init__)


def test_hyp_dsl_weapon_constructor_args():
...
def test_hyp_dsl_model_is_not_abstract():
    assert not inspect.isabstract(dsl_Model)


def test_hyp_dsl_model_constructor_exists():
    assert callable(dsl_Model.__init__)


def test_hyp_dsl_model_constructor_args():
    sig = inspect.signature(dsl_Model.__init__)
    params = list(sig.parameters.keys())



def test_hyp_dsl_mover_is_not_abstract():
    assert not inspect.isabstract(dsl_Mover)


def test_hyp_dsl_mover_constructor_exists():
    assert callable(dsl_Mover.__init__)


def test_hyp_dsl_mover_constructor_args():
...
def test_hyp_dsl_damageeffect_amount_setter(instance):
...
def test_hyp_dsl_persistenteffect_ranges_setter(instance):
...
@given(instance=dsl_PersistentEffect_strategy)
def test_hyp_dsl_persistenteffect_durations_setter(instance):
...
@given(instance=dsl_PersistentEffect_strategy)
def test_hyp_dsl_persistenteffect_periodCount_setter(instance):
...
def test_hyp_dsl_color_g_setter(instance):
    original = instance.g
    instance.g = original
...
@given(instance=dsl_Color_strategy)
def test_hyp_dsl_color_a_setter(instance):
    original = instance.a
    instance.a = original
...
@given(instance=dsl_Color_strategy)
def test_hyp_dsl_color_r_setter(instance):
    original = instance.r
    instance.r = original
...
@given(instance=dsl_Color_strategy)
def test_hyp_dsl_color_b_setter(instance):
    original = instance.b
    instance.b = original
...
def test_hyp_dsl_actorlist_trigger_setter(instance):
...
def test_hyp_dsl_particleactor_perSecond_setter(instance):
...
@given(instance=dsl_ParticleActor_strategy)
def test_hyp_dsl_particleactor_add_setter(instance):
...
@given(instance=dsl_ParticleActor_strategy)
def test_hyp_dsl_particleactor_nbCol_setter(instance):
...
@given(instance=dsl_ParticleActor_strategy)
def test_hyp_dsl_particleactor_duration_setter(instance):
...
@given(instance=dsl_ParticleActor_strategy)
def test_hyp_dsl_particleactor_nbRow_setter(instance):
...
@given(instance=dsl_ParticleActor_strategy)
def test_hyp_dsl_particleactor_emissionBone_setter(instance):
...
@given(instance=dsl_ParticleActor_strategy)
def test_hyp_dsl_particleactor_maxCount_setter(instance):
...
@given(instance=dsl_ParticleActor_strategy)
def test_hyp_dsl_particleactor_endSize_setter(instance):
...
@given(instance=dsl_ParticleActor_strategy)
def test_hyp_dsl_particleactor_startSize_setter(instance):
...
@given(instance=dsl_ParticleActor_strategy)
def test_hyp_dsl_particleactor_directionBone_setter(instance):
...
@given(instance=dsl_ParticleActor_strategy)
def test_hyp_dsl_particleactor_minLife_setter(instance):
...
@given(instance=dsl_ParticleActor_strategy)
def test_hyp_dsl_particleactor_startVariation_setter(instance):
...
@given(instance=dsl_ParticleActor_strategy)
def test_hyp_dsl_particleactor_spritePath_setter(instance):
...
@given(instance=dsl_ParticleActor_strategy)
def test_hyp_dsl_particleactor_maxLife_setter(instance):
...
def test_hyp_dsl_animtationactor_animName_setter(instance):
...
@given(instance=dsl_AnimtationActor_strategy)
def test_hyp_dsl_animtationactor_cycle_setter(instance):
...
@given(instance=dsl_AnimtationActor_strategy)
def test_hyp_dsl_animtationactor_speed_setter(instance):
...
def test_hyp_dsl_modelactor_modelPath_setter(instance):
...
@given(instance=dsl_ModelActor_strategy)
def test_hyp_dsl_modelactor_scale_setter(instance):
...
def test_hyp_dsl_projectile_name_setter(instance):
...
@given(instance=dsl_Projectile_strategy)
def test_hyp_dsl_projectile_mass_setter(instance):
...
@given(instance=dsl_Projectile_strategy)
def test_hyp_dsl_projectile_precision_setter(instance):
...
@given(instance=dsl_Projectile_strategy)
def test_hyp_dsl_projectile_speed_setter(instance):
    original = instance.speed
    instance.speed = original
    assert instance.speed == original
...
def test_hyp_dsl_turrent_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=dsl_Turrent_strategy)
def test_hyp_dsl_turrent_idleSpeed_setter(instance):
...
@given(instance=dsl_Turrent_strategy)
def test_hyp_dsl_turrent_boneName_setter(instance):
...
@given(instance=dsl_Turrent_strategy)
def test_hyp_dsl_turrent_onIdle_setter(instance):
...
@given(instance=dsl_Turrent_strategy)
def test_hyp_dsl_turrent_speed_setter(instance):
    original = instance.speed
    instance.speed = original
    assert instance.speed == original
...
def test_hyp_dsl_effect_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_dsl_actor_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_dsl_race_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_dsl_unit_radius_setter(instance):
...
@given(instance=dsl_Unit_strategy)
def test_hyp_dsl_unit_maxHealth_setter(instance):
...
@given(instance=dsl_Unit_strategy)
def test_hyp_dsl_unit_mass_setter(instance):
    original = instance.mass
    instance.mass = original
    assert instance.mass == original
...
@given(instance=dsl_Unit_strategy)
def test_hyp_dsl_unit_sight_setter(instance):
...
@given(instance=dsl_Unit_strategy)
def test_hyp_dsl_unit_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=dsl_Unit_strategy)
def test_hyp_dsl_unit_separationRadius_setter(instance):
...
@given(instance=dsl_Unit_strategy)
def test_hyp_dsl_unit_speed_setter(instance):
    original = instance.speed
    instance.speed = original
    assert instance.speed == original
...
@given(instance=dsl_Unit_strategy)
def test_hyp_dsl_unit_uIName_setter(instance):
...
def test_hyp_dsl_weapon_uIName_setter(instance):
    original = instance.uIName
    instance.uIName = original
    assert instance.uIName == original
...
@given(instance=dsl_Weapon_strategy)
def test_hyp_dsl_weapon_scanRange_setter(instance):
...
@given(instance=dsl_Weapon_strategy)
def test_hyp_dsl_weapon_range_setter(instance):
...
@given(instance=dsl_Weapon_strategy)
def test_hyp_dsl_weapon_sourceBone_setter(instance):
...
@given(instance=dsl_Weapon_strategy)
def test_hyp_dsl_weapon_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=dsl_Weapon_strategy)
def test_hyp_dsl_weapon_directionBone_setter(instance):
    original = instance.directionBone
    instance.directionBone = original
    assert instance.directionBone == original
...
@given(instance=dsl_Weapon_strategy)
def test_hyp_dsl_weapon_period_setter(instance):
...
def test_hyp_dsl_mover_pathfindingMode_setter(instance):
...
@given(instance=dsl_Mover_strategy)
def test_hyp_dsl_mover_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=dsl_Mover_strategy)
def test_hyp_dsl_mover_standingMode_setter(instance):
...
@given(instance=dsl_Mover_strategy)
def test_hyp_dsl_mover_heightmap_setter(instance):
