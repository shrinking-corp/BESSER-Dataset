...
class dsl_ParticleActor(Actor):
    ...
    def __init__(self, directionBone: str, maxCount: int, spritePath: str, nbCol: int, nbRow: int, add: str, emissionBone: str, perSecond: int, duration: int, startSize: str, endSize: str, minLife: str, maxLife: str, startVariation: str, dsl_ParticleActor: "dsl_Color" = None, dsl_ParticleActor18: "dsl_Color" = None):
...
class dsl_Projectile:
    ...
    def __init__(self, name: str, speed: int, mass: int, precision: str, dsl_Projectile: "dsl_Model" = None, dsl_Projectile57: "dsl_Actor" = None, dsl_Projectile52: "dsl_LauncherEffect" = None, dsl_Projectile54: "dsl_Mover" = None):
        self.name = name
        self.speed = speed
        self.mass = mass
...
class dsl_Effect:
    ...
    def __init__(self, name: str, dsl_Effect: "dsl_Model" = None, dsl_Effect42: "dsl_Weapon" = None, dsl_Effect47: "dsl_PersistentEffect" = None, dsl_Effect49: "dsl_LauncherEffect" = None):
        self.name = name
...
class dsl_Actor:
    ...
    def __init__(self, name: str, dsl_Actor: "dsl_Model" = None, dsl_Actor33: "dsl_Unit" = None, dsl_Actor22: "dsl_ActorList" = None, dsl_Actor58: "dsl_Projectile" = None, dsl_Actor45: "dsl_Weapon" = None):
        self.name = name
...
class dsl_Unit:
    ...
    def __init__(self, name: str, uIName: str, radius: str, separationRadius: str, speed: str, mass: str, maxHealth: int, sight: int, dsl_Unit: "dsl_Model" = None, dsl_Unit32: "dsl_Actor" = None, dsl_Unit24: "dsl_Race" = None, dsl_Unit27: "dsl_Mover" = None, dsl_Unit30: set["dsl_UnitWeaponLink"] = None):
        self.name = name
        self.uIName = uIName
        self.radius = radius
...
class dsl_Weapon:
    ...
    def __init__(self, name: str, uIName: str, range: str, scanRange: int, period: int, sourceBone: str, directionBone: str, dsl_Weapon36: "dsl_UnitWeaponLink" = None, dsl_Weapon41: "dsl_Effect" = None, dsl_Weapon44: "dsl_Actor" = None, dsl_Weapon: "dsl_Model" = None):
        self.name = name
        self.uIName = uIName
        self.range = range
