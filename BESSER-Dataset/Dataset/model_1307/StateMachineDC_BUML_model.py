...
# Classes
SimplStateMachineDC_StateMachine = Class(name="SimplStateMachineDC_StateMachine")
SimplStateMachineDC_Transition = Class(name="SimplStateMachineDC_Transition")
SimplStateMachineDC_PseudoState = Class(name="SimplStateMachineDC_PseudoState", is_abstract=True)
PseudoState = Class(name="PseudoState")
SimplStateMachineDC_State = Class(name="SimplStateMachineDC_State")
SimplStateMachineDC_CompositeState = Class(name="SimplStateMachineDC_CompositeState")
State = Class(name="State")
SimplStateMachineDC_InitialState = Class(name="SimplStateMachineDC_InitialState")
...
SimplStateMachineDC_State.attributes={SimplStateMachineDC_State_Ord, SimplStateMachineDC_State_name, SimplStateMachineDC_State_Inh, SimplStateMachineDC_State_OrdIf, SimplStateMachineDC_State_isActive, SimplStateMachineDC_State_InhIf}
...
domain_model = DomainModel(
    ...
    types={SimplStateMachineDC_StateMachine, SimplStateMachineDC_Transition, SimplStateMachineDC_PseudoState, PseudoState, SimplStateMachineDC_State, SimplStateMachineDC_CompositeState, State, SimplStateMachineDC_InitialState},
    associations={transitions0, referencedState6, source8, target11, states1, container3, states4, initialState5},
    generalizations={gen_SimplStateMachineDC_PseudoState_State, gen_SimplStateMachineDC_InitialState_PseudoState, gen_SimplStateMachineDC_CompositeState_State},
    metadata=None
)
