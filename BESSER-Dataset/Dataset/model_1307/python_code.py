...
class SimplStateMachineDC_State:
    ...
    def __init__(self, name: str, isActive: bool, Ord: str, Inh: str, OrdIf: str, InhIf: str, SimplStateMachineDC_State13: "SimplStateMachineDC_Transition" = None, SimplStateMachineDC_State: "SimplStateMachineDC_StateMachine" = None, states: "SimplStateMachineDC_CompositeState" = None, State: "SimplStateMachineDC_CompositeState" = None, SimplStateMachineDC_State7: "SimplStateMachineDC_PseudoState" = None, SimplStateMachineDC_State10: "SimplStateMachineDC_Transition" = None):
        self.name = name
...
class SimplStateMachineDC_Transition:
    ...
    def __init__(self, event: str, SimplStateMachineDC_Transition12: "SimplStateMachineDC_State" = None, SimplStateMachineDC_Transition: "SimplStateMachineDC_StateMachine" = None, SimplStateMachineDC_Transition9: "SimplStateMachineDC_State" = None):
        self.event = event
