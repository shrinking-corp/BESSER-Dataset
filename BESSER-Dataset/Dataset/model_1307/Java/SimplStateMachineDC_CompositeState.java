...
public class SimplStateMachineDC_CompositeState extends State {
    ...
    private SimplStateMachineDC_InitialState simplstatemachinedc_initialstate;
    ...
    public SimplStateMachineDC_InitialState getSimplstatemachinedc_initialstate() {
        return simplstatemachinedc_initialstate;
    }

    public void setSimplstatemachinedc_initialstate(SimplStateMachineDC_InitialState simplstatemachinedc_initialstate) {
        this.simplstatemachinedc_initialstate = simplstatemachinedc_initialstate;
    }
