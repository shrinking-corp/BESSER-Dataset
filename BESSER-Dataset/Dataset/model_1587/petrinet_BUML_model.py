...
domain_model = DomainModel(
    name="petrinet",
    types={petrinet_Arc, petrinet_Place, Node, petrinet_Token, petrinet_Transition, petrinet_Petrinet, petrinet_Node},
    associations={arcs1, in_3, out4, source6, target7, tokens9, nodes0},
