...
class library_Book:
    ...
    def __init__(self, title: str, pages: int, category: str, Book: "library_Writer" = None, books: "library_Writer" = None, book: set["library_Review"] = None, Book8: "library_Review" = None, library_Book12: "library_Opinion" = None, library_Book: "library_Library" = None):
        self.title = title
        self.pages = pages
...
class library_Writer:
    ...
    def __init__(self, name: str, author: set["library_Book"] = None, writer: set["library_Opinion"] = None, Writer: "library_Book" = None, Writer10: "library_Opinion" = None, library_Writer: "library_Library" = None):
        self.name = name
