...
# Classes
gtrace_TScenarioTrace = Class(name="gtrace_TScenarioTrace")
gtrace_TScenarioStepTrace = Class(name="gtrace_TScenarioStepTrace")
gtrace_TTrace = Class(name="gtrace_TTrace", is_abstract=True)
gtrace_TTraceModel = Class(name="gtrace_TTraceModel")
gtrace_TRequirementTrace = Class(name="gtrace_TRequirementTrace")
TTrace = Class(name="TTrace")
gtrace_RRequirement = Class(name="gtrace_RRequirement")
gtrace_MElement = Class(name="gtrace_MElement")
gtrace_RScenario = Class(name="gtrace_RScenario")
gtrace_MClassifier = Class(name="gtrace_MClassifier")
gtrace_MStateMachine = Class(name="gtrace_MStateMachine")
gtrace_RScenarioStep = Class(name="gtrace_RScenarioStep")
gtrace_MOperation = Class(name="gtrace_MOperation")
gtrace_MState = Class(name="gtrace_MState")
...
domain_model = DomainModel(
    name="gtrace",
    types={gtrace_TScenarioTrace, gtrace_TScenarioStepTrace, gtrace_TTrace, gtrace_TTraceModel, gtrace_TRequirementTrace, TTrace, gtrace_RRequirement, gtrace_MElement, gtrace_RScenario, gtrace_MClassifier, gtrace_MStateMachine, gtrace_RScenarioStep, gtrace_MOperation, gtrace_MState},
    associations={scenarioTrace1, scenarioStepTrace3, requirementTrace0, requirement5, structuralElement7, scenario9, classifier11, stateMachine13, scenarioStep15, operation17, state19},
