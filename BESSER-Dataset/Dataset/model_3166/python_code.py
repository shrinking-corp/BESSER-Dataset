...
class gtrace_TTraceModel:
    ...
    def __init__(self, name: str, gtrace_TTraceModel2: set["gtrace_TScenarioTrace"] = None, gtrace_TTraceModel4: set["gtrace_TScenarioStepTrace"] = None, gtrace_TTraceModel: set["gtrace_TRequirementTrace"] = None):
        self.name = name
