...
class services_Service:
    ...
    def __init__(self, serviceClass: str, serviceDescription: str, serviceName: str, serviceCategory: str, services_Service: set["services_CIID"] = None, services_Service7: "services_Service" = None, services_Service5: set["services_Service"] = None, services_Service9: set["services_ServiceForecast"] = None, services_Service11: set["services_ServiceMonitor"] = None, services_Service13: set["services_ServiceUser"] = None, services_Service15: "services_ServiceDistribution" = None):
