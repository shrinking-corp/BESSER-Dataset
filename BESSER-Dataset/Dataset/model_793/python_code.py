...
class timedfsm_Transition:
    ...
    def __init__(self, input: str, output: str, waitingTime: int, Transition: "timedfsm_State" = None, outgoingTransition: "timedfsm_State" = None, incomingTransition: "timedfsm_State" = None, Transition8: "timedfsm_State" = None):
        self.input = input
        self.output = output
    ...
    def Transition8(self, value):
        ...
        old_value = getattr(self, f"_timedfsm_Transition__Transition8", None)
    ...
    def Transition(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_timedfsm_Transition__Transition", None)
    ...
    def outgoingTransition(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_timedfsm_Transition__outgoingTransition", None)
    ...
    def incomingTransition(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_timedfsm_Transition__incomingTransition", None)
...
class timedfsm_State:
    ...
    def __init__(self, name: str, waitingTime: int, State: "timedfsm_FSM" = None, timedfsm_State: "timedfsm_FSM" = None, timedfsm_State4: "timedfsm_FSM" = None, ownedState: "timedfsm_FSM" = None, source: set["timedfsm_Transition"] = None, State12: "timedfsm_Transition" = None, target: set["timedfsm_Transition"] = None, State10: "timedfsm_Transition" = None):
        self.name = name
        self.waitingTime = waitingTime
        self.State = State
        self.timedfsm_State = timedfsm_State
        self.timedfsm_State4 = timedfsm_State4
    ...
    def ownedState(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_timedfsm_State__ownedState", None)
    ...
    def State(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_timedfsm_State__State", None)
        self.__State = value
    ...
    def source(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_timedfsm_State__source", None)
    ...
    def target(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_timedfsm_State__target", None)
    ...
    def State10(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_timedfsm_State__State10", None)
    ...
    @property
    def timedfsm_State4(self):
        return self.__timedfsm_State4

    @timedfsm_State4.setter
    def timedfsm_State4(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_timedfsm_State__timedfsm_State4", None)
        self.__timedfsm_State4 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "timedfsm_FSM3"):
                opp_val = getattr(old_value, "timedfsm_FSM3", None)
                if isinstance(opp_val, set):
                    opp_val.discard(self)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "timedfsm_FSM3"):
                opp_val = getattr(value, "timedfsm_FSM3", None)
                if opp_val is None:
                    setattr(value, "timedfsm_FSM3", set([self]))
                elif isinstance(opp_val, set):
                    opp_val.add(self)
    ...
    def State12(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_timedfsm_State__State12", None)
