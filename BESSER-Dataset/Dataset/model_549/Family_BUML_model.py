...
family_Male = Class(name="family_Male")
family_Female = Class(name="family_Female")
Person = Class(name="Person")
family_FamilyTree = Class(name="family_FamilyTree")
...
family_Person.attributes={family_Person_size, family_Person_weight, family_Person_name, family_Person_age}
...
domain_model = DomainModel(
    ...
    associations={father0, mother1, children4, people9, relative7},
