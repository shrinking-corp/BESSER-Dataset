...
class family_Person(ABC):
    ...
    def __init__(self, age: int, size: int, weight: int, name: str, family_Person: "family_Male" = None, family_Person2: "family_Female" = None, family_Person5: "family_Person" = None, family_Person3: set["family_Person"] = None, family_Person10: "family_FamilyTree" = None, family_Person8: "family_Person" = None, family_Person6: "family_Person" = None):
        self.age = age
        self.size = size
        self.weight = weight
        self.name = name
