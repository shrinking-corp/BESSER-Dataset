...
# Classes
serviceInterfaces_Package = Class(name="serviceInterfaces_Package")
Packageable = Class(name="Packageable")
serviceInterfaces_Interface = Class(name="serviceInterfaces_Interface", is_abstract=True)
serviceInterfaces_codegen_InjectorAcceptorInterfaceL1 = Class(name="serviceInterfaces_codegen_InjectorAcceptorInterfaceL1")
Interface = Class(name="Interface")
TransformationLibrary = Class(name="TransformationLibrary")
serviceInterfaces_codegen_TransformationLibrary = Class(name="serviceInterfaces_codegen_TransformationLibrary")
serviceInterfaces_codegen_SlotPlugInterfaceL1 = Class(name="serviceInterfaces_codegen_SlotPlugInterfaceL1")
Pointcut = Class(name="Pointcut")
serviceInterfaces_codegen_Pointcut = Class(name="serviceInterfaces_codegen_Pointcut", is_abstract=True)
serviceInterfaces_codegen_ClassPointcut = Class(name="serviceInterfaces_codegen_ClassPointcut")
serviceInterfaces_codegen_MethodPoincut = Class(name="serviceInterfaces_codegen_MethodPoincut")
serviceInterfaces_codegen_ImportElementPointcut = Class(name="serviceInterfaces_codegen_ImportElementPointcut")
serviceInterfaces_codegen_StatementPoincut = Class(name="serviceInterfaces_codegen_StatementPoincut")
serviceInterfaces_InterfaceRepository = Class(name="serviceInterfaces_InterfaceRepository")
serviceInterfaces_Packageable = Class(name="serviceInterfaces_Packageable", is_abstract=True)
serviceInterfaces_modelingenv_JavaInterface = Class(name="serviceInterfaces_modelingenv_JavaInterface")
Operation = Class(name="Operation")
serviceInterfaces_modelingenv_JavaClass = Class(name="serviceInterfaces_modelingenv_JavaClass")
serviceInterfaces_modelingenv_Operation = Class(name="serviceInterfaces_modelingenv_Operation")
serviceInterfaces_modelingenv_SlotPlugInterfaceL0 = Class(name="serviceInterfaces_modelingenv_SlotPlugInterfaceL0")
ExtensionPoint = Class(name="ExtensionPoint")
serviceInterfaces_modelingenv_ExtensionPoint = Class(name="serviceInterfaces_modelingenv_ExtensionPoint")
serviceInterfaces_modelingenv_InjectorAcceptorInterfaceL0 = Class(name="serviceInterfaces_modelingenv_InjectorAcceptorInterfaceL0")
JavaTypeDeclaration = Class(name="JavaTypeDeclaration")
serviceInterfaces_modelingenv_JavaTypeDeclaration = Class(name="serviceInterfaces_modelingenv_JavaTypeDeclaration", is_abstract=True)
...
domain_model = DomainModel(
    ...
    types={serviceInterfaces_Package, Packageable, serviceInterfaces_Interface, serviceInterfaces_codegen_InjectorAcceptorInterfaceL1, Interface, TransformationLibrary, serviceInterfaces_codegen_TransformationLibrary, serviceInterfaces_codegen_SlotPlugInterfaceL1, Pointcut, serviceInterfaces_codegen_Pointcut, serviceInterfaces_codegen_ClassPointcut, serviceInterfaces_codegen_MethodPoincut, serviceInterfaces_codegen_ImportElementPointcut, serviceInterfaces_codegen_StatementPoincut, serviceInterfaces_InterfaceRepository, serviceInterfaces_Packageable, serviceInterfaces_modelingenv_JavaInterface, Operation, serviceInterfaces_modelingenv_JavaClass, serviceInterfaces_modelingenv_Operation, serviceInterfaces_modelingenv_SlotPlugInterfaceL0, ExtensionPoint, serviceInterfaces_modelingenv_ExtensionPoint, serviceInterfaces_modelingenv_InjectorAcceptorInterfaceL0, JavaTypeDeclaration, serviceInterfaces_modelingenv_JavaTypeDeclaration, CodeGenLanguage, PointcutType, InjectionMode},
    associations={contents0, contents1, injectorProvides3, pointcuts4, operations6, operations7, slot9, injectorImplements5},
    generalizations={gen_serviceInterfaces_Package_Packageable, gen_serviceInterfaces_Interface_Packageable, gen_serviceInterfaces_codegen_InjectorAcceptorInterfaceL1_Interface, gen_serviceInterfaces_codegen_SlotPlugInterfaceL1_Interface, gen_serviceInterfaces_codegen_ClassPointcut_Pointcut, gen_serviceInterfaces_codegen_MethodPoincut_Pointcut, gen_serviceInterfaces_codegen_ImportElementPointcut_Pointcut, gen_serviceInterfaces_codegen_StatementPoincut_Pointcut, gen_serviceInterfaces_modelingenv_JavaInterface_JavaTypeDeclaration, gen_serviceInterfaces_modelingenv_JavaClass_JavaTypeDeclaration, gen_serviceInterfaces_modelingenv_SlotPlugInterfaceL0_Interface, gen_serviceInterfaces_modelingenv_InjectorAcceptorInterfaceL0_Interface},
    metadata=None
)
