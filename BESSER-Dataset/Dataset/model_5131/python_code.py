...
class caracteristica_InformacaoDeContexto(Elemento):
    ...
    def __init__(self, origem: str, validade: str, qualidade: str, tipoValor: str, valor: str, caracteristica_InformacaoDeContexto: "caracteristica_EventoRelacional" = None, InformacaoDeContexto: "caracteristica_EntidadeDeContexto" = None, informacoesDeContexto: "caracteristica_EntidadeDeContexto" = None):
        self.origem = origem
...
class caracteristica_Atributo(Elemento):
    ...
    def __init__(self, tipoValor: str, caracteristica_Atributo: "caracteristica_LPS" = None, atributo: "caracteristica_Caracteristica" = None, caracteristica_Atributo81: "caracteristica_Designar" = None, caracteristica_Atributo88: "caracteristica_ExpressaoRelacional" = None, Atributo: "caracteristica_Caracteristica" = None):
        self.tipoValor = tipoValor
...
class caracteristica_LPS:
    ...
    def __init__(self, valoresContextuais: str, erro: str, nome: str, caracteristica_LPS: set["caracteristica_PontoDeVariacao"] = None, caracteristica_LPS2: set["caracteristica_Elemento"] = None, caracteristica_LPS4: set["caracteristica_ElementoExterno"] = None, caracteristica_LPS6: set["caracteristica_Regra"] = None, caracteristica_LPS8: set["caracteristica_Produto"] = None, caracteristica_LPS10: set["caracteristica_Expressao"] = None, caracteristica_LPS12: set["caracteristica_ElementoDeProduto"] = None, LpsDoSistema: "caracteristica_CaracteristicaRaiz" = None, caracteristica_LPS15: set["caracteristica_Atributo"] = None, caracteristica_LPS17: set["caracteristica_Simulacao"] = None, caracteristica_LPS19: set["caracteristica_InconsistenciaRegraAdaptacao"] = None, LPS: "caracteristica_CaracteristicaRaiz" = None):
