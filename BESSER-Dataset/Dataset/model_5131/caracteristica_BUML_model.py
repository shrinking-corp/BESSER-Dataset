...
# Classes
caracteristica_LPS = Class(name="caracteristica_LPS")
caracteristica_PontoDeVariacao = Class(name="caracteristica_PontoDeVariacao")
caracteristica_Elemento = Class(name="caracteristica_Elemento")
caracteristica_ElementoExterno = Class(name="caracteristica_ElementoExterno")
caracteristica_Regra = Class(name="caracteristica_Regra")
caracteristica_Produto = Class(name="caracteristica_Produto")
caracteristica_Expressao = Class(name="caracteristica_Expressao")
caracteristica_ElementoDeProduto = Class(name="caracteristica_ElementoDeProduto")
caracteristica_CaracteristicaRaiz = Class(name="caracteristica_CaracteristicaRaiz")
caracteristica_Atributo = Class(name="caracteristica_Atributo")
caracteristica_Simulacao = Class(name="caracteristica_Simulacao")
caracteristica_InconsistenciaRegraAdaptacao = Class(name="caracteristica_InconsistenciaRegraAdaptacao")
Caracteristica = Class(name="Caracteristica")
caracteristica_CasoDeUso = Class(name="caracteristica_CasoDeUso")
ElementoExterno = Class(name="ElementoExterno")
caracteristica_CasoDeTeste = Class(name="caracteristica_CasoDeTeste")
caracteristica_ElementoCaracteristico = Class(name="caracteristica_ElementoCaracteristico")
Elemento = Class(name="Elemento")
caracteristica_Caracteristica = Class(name="caracteristica_Caracteristica")
caracteristica_Variacao = Class(name="caracteristica_Variacao")
caracteristica_CaracteristicaOpcional = Class(name="caracteristica_CaracteristicaOpcional")
ElementoCaracteristico = Class(name="ElementoCaracteristico")
caracteristica_CaracteristicaAgrupada = Class(name="caracteristica_CaracteristicaAgrupada")
caracteristica_CaracteristicaMandatoria = Class(name="caracteristica_CaracteristicaMandatoria")
caracteristica_VariacaoDois = Class(name="caracteristica_VariacaoDois")
PontoDeVariacao = Class(name="PontoDeVariacao")
caracteristica_Variante = Class(name="caracteristica_Variante")
caracteristica_RaizDeContexto = Class(name="caracteristica_RaizDeContexto")
caracteristica_EntidadeDeContexto = Class(name="caracteristica_EntidadeDeContexto")
caracteristica_InformacaoDeContexto = Class(name="caracteristica_InformacaoDeContexto")
caracteristica_CaracteristicaProduto = Class(name="caracteristica_CaracteristicaProduto")
ElementoDeProduto = Class(name="ElementoDeProduto")
caracteristica_AtributoProduto = Class(name="caracteristica_AtributoProduto")
caracteristica_CaracteristicaMandatoriaProduto = Class(name="caracteristica_CaracteristicaMandatoriaProduto")
CaracteristicaProduto = Class(name="CaracteristicaProduto")
caracteristica_CaracteristicaOpcionalProduto = Class(name="caracteristica_CaracteristicaOpcionalProduto")
caracteristica_VariacaoDoisProduto = Class(name="caracteristica_VariacaoDoisProduto")
caracteristica_CaracteristicaAgrupadaProduto = Class(name="caracteristica_CaracteristicaAgrupadaProduto")
caracteristica_VariacaoProduto = Class(name="caracteristica_VariacaoProduto")
caracteristica_VarianteProduto = Class(name="caracteristica_VarianteProduto")
Expressao = Class(name="Expressao")
caracteristica_RegraDeComposicao = Class(name="caracteristica_RegraDeComposicao")
Regra = Class(name="Regra")
caracteristica_Antecedente = Class(name="caracteristica_Antecedente")
caracteristica_RegraDeContexto = Class(name="caracteristica_RegraDeContexto")
caracteristica_Evento = Class(name="caracteristica_Evento")
caracteristica_Acao = Class(name="caracteristica_Acao")
caracteristica_EventoLogico = Class(name="caracteristica_EventoLogico")
Evento = Class(name="Evento")
caracteristica_EventoRelacional = Class(name="caracteristica_EventoRelacional")
caracteristica_AcaoLogico = Class(name="caracteristica_AcaoLogico")
Acao = Class(name="Acao")
caracteristica_LiteralAcao = Class(name="caracteristica_LiteralAcao")
caracteristica_Designar = Class(name="caracteristica_Designar")
caracteristica_ExpressaoLogica = Class(name="caracteristica_ExpressaoLogica")
Antecedente = Class(name="Antecedente")
caracteristica_ExpressaoRelacional = Class(name="caracteristica_ExpressaoRelacional")
caracteristica_LiteralComposicao = Class(name="caracteristica_LiteralComposicao")
caracteristica_Transicao = Class(name="caracteristica_Transicao")
caracteristica_Estado = Class(name="caracteristica_Estado")
...
caracteristica_LPS.attributes={caracteristica_LPS_valoresContextuais, caracteristica_LPS_erro, caracteristica_LPS_nome}
...
caracteristica_VariacaoDois.attributes={caracteristica_VariacaoDois_cardinalidadeMaximaOr, caracteristica_VariacaoDois_cardinalidadeMinimaOr, caracteristica_VariacaoDois_cardinalidadeMaxima}
...
caracteristica_InformacaoDeContexto.attributes={caracteristica_InformacaoDeContexto_qualidade, caracteristica_InformacaoDeContexto_origem, caracteristica_InformacaoDeContexto_validade, caracteristica_InformacaoDeContexto_valor, caracteristica_InformacaoDeContexto_tipoValor}
...
caracteristica_VariacaoDoisProduto.attributes={caracteristica_VariacaoDoisProduto_cardinalidadeMinimaOr, caracteristica_VariacaoDoisProduto_cardinalidadeMaxima, caracteristica_VariacaoDoisProduto_cardinalidadeMaximaOr}
...
caracteristica_EventoRelacional.attributes={caracteristica_EventoRelacional_valor, caracteristica_EventoRelacional_operadorRelacional}
...
caracteristica_Transicao.attributes={caracteristica_Transicao_etiqueta, caracteristica_Transicao_safe}
...
domain_model = DomainModel(
    name="caracteristica",
    types={caracteristica_LPS, caracteristica_PontoDeVariacao, caracteristica_Elemento, caracteristica_ElementoExterno, caracteristica_Regra, caracteristica_Produto, caracteristica_Expressao, caracteristica_ElementoDeProduto, caracteristica_CaracteristicaRaiz, caracteristica_Atributo, caracteristica_Simulacao, caracteristica_InconsistenciaRegraAdaptacao, Caracteristica, caracteristica_CasoDeUso, ElementoExterno, caracteristica_CasoDeTeste, caracteristica_ElementoCaracteristico, Elemento, caracteristica_Caracteristica, caracteristica_Variacao, caracteristica_CaracteristicaOpcional, ElementoCaracteristico, caracteristica_CaracteristicaAgrupada, caracteristica_CaracteristicaMandatoria, caracteristica_VariacaoDois, PontoDeVariacao, caracteristica_Variante, caracteristica_RaizDeContexto, caracteristica_EntidadeDeContexto, caracteristica_InformacaoDeContexto, caracteristica_CaracteristicaProduto, ElementoDeProduto, caracteristica_AtributoProduto, caracteristica_CaracteristicaMandatoriaProduto, CaracteristicaProduto, caracteristica_CaracteristicaOpcionalProduto, caracteristica_VariacaoDoisProduto, caracteristica_CaracteristicaAgrupadaProduto, caracteristica_VariacaoProduto, caracteristica_VarianteProduto, Expressao, caracteristica_RegraDeComposicao, Regra, caracteristica_Antecedente, caracteristica_RegraDeContexto, caracteristica_Evento, caracteristica_Acao, caracteristica_EventoLogico, Evento, caracteristica_EventoRelacional, caracteristica_AcaoLogico, Acao, caracteristica_LiteralAcao, caracteristica_Designar, caracteristica_ExpressaoLogica, Antecedente, caracteristica_ExpressaoRelacional, caracteristica_LiteralComposicao, caracteristica_Transicao, caracteristica_Estado, Origem, Validade, Qualidade, TipoValor, OperadorRelacional, OperadorLogico, OperadorAcaoLogico, CardinalidadeMaxima, Presenca},
    associations={pontosDeVariacao0, elementos1, externos3, regras5, produtos7, expressoes9, elementosDeProduto11, sistema13, atributos14, simulacoes16, inconsistenciaERA18, caracteristicaPai20, elementosExternos21, caracteristicaPai24, caracteristicaFilha27, variacoes29, atributo31, entidadesDeContexto39, LpsDoSistema33, variantes34, caracteristicaPai35, variacaoPai37, raiz40, informacoesDeContexto41, elementoPai42, elementoOriginal44, caracteristicaProdutoPai48, caracteristicaProdutoFilha50, atributoProduto52, caracteristicaProdutoPai54, variantesProduto56, caracteristicaProdutoPai57, variacaoProdutoPai58, LinhaDoProduto59, antecedente61, consequente62, evento65, acao66, ladoDireitoEvento68, ladoEsquerdoEvento70, variavelDeContexto73, ladoEsquerdoAcao74, ladoDireitoAcao76, elemento79, atributo80, ladoDireitoComposicao82, ladoEsquerdoComposicao84, variaveldaExpressao87, elemento89, transicoes91, estados93, eAntigo95, eNovo98, regrasQuebradas101, acoes104, produto107, regrasInconsistentes110, literaisInconsistentes113, atribuicoesInconsistentes116},
    generalizations={gen_caracteristica_CaracteristicaRaiz_Caracteristica, gen_caracteristica_CasoDeUso_ElementoExterno, gen_caracteristica_CasoDeTeste_ElementoExterno, gen_caracteristica_ElementoCaracteristico_Elemento, gen_caracteristica_Atributo_Elemento, gen_caracteristica_Caracteristica_Elemento, gen_caracteristica_CaracteristicaOpcional_Caracteristica, gen_caracteristica_CaracteristicaOpcional_ElementoCaracteristico, gen_caracteristica_CaracteristicaAgrupada_Caracteristica, gen_caracteristica_CaracteristicaAgrupada_ElementoCaracteristico, gen_caracteristica_CaracteristicaMandatoria_Caracteristica, gen_caracteristica_VariacaoDois_Caracteristica, gen_caracteristica_VariacaoDois_ElementoCaracteristico, gen_caracteristica_Variacao_PontoDeVariacao, gen_caracteristica_Variacao_Elemento, gen_caracteristica_Variante_PontoDeVariacao, gen_caracteristica_Variante_ElementoCaracteristico, gen_caracteristica_Variante_Caracteristica, gen_caracteristica_RaizDeContexto_Elemento, gen_caracteristica_AtributoProduto_ElementoDeProduto, gen_caracteristica_EntidadeDeContexto_Elemento, gen_caracteristica_InformacaoDeContexto_Elemento, gen_caracteristica_CaracteristicaProduto_ElementoDeProduto, gen_caracteristica_CaracteristicaMandatoriaProduto_CaracteristicaProduto, gen_caracteristica_CaracteristicaOpcionalProduto_CaracteristicaProduto, gen_caracteristica_VariacaoDoisProduto_CaracteristicaProduto, gen_caracteristica_CaracteristicaAgrupadaProduto_CaracteristicaProduto, gen_caracteristica_VariacaoProduto_ElementoDeProduto, gen_caracteristica_VarianteProduto_ElementoDeProduto, gen_caracteristica_Produto_CaracteristicaProduto, gen_caracteristica_Evento_Expressao, gen_caracteristica_RegraDeComposicao_Regra, gen_caracteristica_RegraDeContexto_Regra, gen_caracteristica_EventoLogico_Evento, gen_caracteristica_EventoRelacional_Evento, gen_caracteristica_Acao_Expressao, gen_caracteristica_AcaoLogico_Acao, gen_caracteristica_LiteralAcao_Acao, gen_caracteristica_Designar_Acao, gen_caracteristica_Antecedente_Expressao, gen_caracteristica_ExpressaoLogica_Antecedente, gen_caracteristica_ExpressaoRelacional_Antecedente, gen_caracteristica_LiteralComposicao_Antecedente},
    metadata=None
)
