...
# Classes
Data_Model = Class(name="Data_Model")
Data_Class = Class(name="Data_Class")
Data_Attribute = Class(name="Data_Attribute")
Data_Method = Class(name="Data_Method")
Data_Parameter = Class(name="Data_Parameter")
...
Data_Attribute.attributes={Data_Attribute_name, Data_Attribute_type, Data_Attribute_encapsulation}

# Data_Method class attributes and methods
Data_Method_name: Property = Property(name="name", type=StringType)
Data_Method_return_: Property = Property(name="return_", type=StringType)
Data_Method_encapsulation: Property = Property(name="encapsulation", type=StringType)
Data_Method.attributes={Data_Method_encapsulation, Data_Method_name, Data_Method_return_}
...
domain_model = DomainModel(
    ...
    associations={class_0, Parameters5, attributes1, methods3},
    generalizations={},
    metadata=None
)
