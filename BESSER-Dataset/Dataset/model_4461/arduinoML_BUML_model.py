...
arduinoML_Sensor = Class(name="arduinoML_Sensor")
...
arduinoML_SinkError = Class(name="arduinoML_SinkError")
arduinoML_Brick = Class(name="arduinoML_Brick", is_abstract=True)
NamedElement = Class(name="NamedElement")
arduinoML_BooleanCondition = Class(name="arduinoML_BooleanCondition")
...
arduinoML_BaseCondition = Class(name="arduinoML_BaseCondition")
...
arduinoML_Condition.attributes={arduinoML_Condition_comparator, arduinoML_Condition_analogvalue, arduinoML_Condition_value}
...
domain_model = DomainModel(
    name="arduinoML",
    types={arduinoML_Actuator, Brick, arduinoML_Sensor, arduinoML_App, arduinoML_State, arduinoML_Action, arduinoML_Transition, arduinoML_SinkError, arduinoML_Brick, NamedElement, arduinoML_BooleanCondition, arduinoML_NamedElement, arduinoML_Condition, Condition, arduinoML_BaseCondition, Signal, Operator, Type, Comparator},
    associations={bricks0, states1, initial3, actions6, transitions8, errors9, basecondition16, booleancondition18, sensor20, actuator11, next13, state15, basecondition21, booleancondition23, state26},
    generalizations={gen_arduinoML_Actuator_Brick, gen_arduinoML_Sensor_Brick, gen_arduinoML_App_NamedElement, gen_arduinoML_State_NamedElement, gen_arduinoML_Brick_NamedElement, gen_arduinoML_BaseCondition_Condition, gen_arduinoML_BooleanCondition_Condition},
    metadata=None
)
