...
domain_model = DomainModel(
    name="tfsm",
    types={tfsm_TFSM, NamedElement, tfsm_State, tfsm_FSMEvent, tfsm_FSMClock, tfsm_Transition, tfsm_EventGuard, tfsm_Guard, tfsm_NamedElement, tfsm_TemporalGuard, Guard, tfsm_TimedSystem, tfsm_EvaluateGuard},
    ...
    generalizations={gen_tfsm_TFSM_NamedElement, gen_tfsm_EventGuard_Guard, gen_tfsm_State_NamedElement, gen_tfsm_Transition_NamedElement, gen_tfsm_Guard_NamedElement, gen_tfsm_TemporalGuard_Guard, gen_tfsm_FSMEvent_NamedElement, gen_tfsm_FSMClock_NamedElement, gen_tfsm_TimedSystem_NamedElement, gen_tfsm_EvaluateGuard_Guard},
    metadata=None
)
