...
transaction_Payee.attributes={transaction_Payee_address2, transaction_Payee_city, transaction_Payee_phoneNum, transaction_Payee_address1, transaction_Payee_email, transaction_Payee_country, transaction_Payee_accountNum, transaction_Payee_zipcode, transaction_Payee_userID, transaction_Payee_state, transaction_Payee_name}
...
transaction_LoanPayment.attributes={transaction_LoanPayment_interest, transaction_LoanPayment_loanID, transaction_LoanPayment_principal}
...
account_Account.attributes={account_Account_pin, account_Account_userID, account_Account_balance, account_Account_type, account_Account_accountNum}
...
loan_LoanApplication.attributes={loan_LoanApplication_type, loan_LoanApplication_status, loan_LoanApplication_submissionTime, loan_LoanApplication_interestRate, loan_LoanApplication_applicationID, loan_LoanApplication_userID, loan_LoanApplication_term, loan_LoanApplication_amount}
...
loan_Loan.attributes={loan_Loan_loanID, loan_Loan_type, loan_Loan_userID, loan_Loan_interestRate, loan_Loan_status, loan_Loan_amount, loan_Loan_submissionTime, loan_Loan_term}
...
Profile.attributes={Profile_firstname, Profile_userID, Profile_IDNum, Profile_country, Profile_address1, Profile_zipcode, Profile_phoneNumber, Profile_email, Profile_address2, Profile_city, Profile_IDType, Profile_lastname, Profile_dateOfBirth, Profile_state}
...
transaction_Transaction.attributes={transaction_Transaction_comment, transaction_Transaction_transactionID, transaction_Transaction_time, transaction_Transaction_amount, transaction_Transaction_destinationAccountNum, transaction_Transaction_sourceAccountNum, transaction_Transaction_description, transaction_Transaction_type}
...
domain_model = DomainModel(
    name="_214aebd4_0201_4c31_a929_fcfa7e36c9b6",
    types={transaction_TransferTransaction, transaction_PaybillsTransaction, transaction_ExternalAccount, transaction_Payee, transaction_LoanPayment, account_SavingsAccount, account_Account, loan_LoanApplication, loan_Loan, loan_LoanApplicationFile, String, Profile, User, transaction_Transaction, transaction_DepositTransaction, transaction_TransactionType, account_AccountType, loan_ApplicationStatus, loan_LoanType, loan_LoanStatus},
    associations={Transaction_Account, TransferTransaction_ExternalAccount, PaybillsTransaction_Payee, Profile_User, Profile_Account, LoanApplication_LoanApplicationFile, LoanApplication_Loan, Profile_LoanApplication},
    generalizations={},
    metadata=None
)
