...
class database_Sequence(NamedElement):
    ...
    def __init__(self, start: str, increment: str, minValue: str, maxValue: str, cacheSize: str, cycle: bool, sequence: set["database_Column"] = None, database_Sequence: "database_TableContainer" = None, Sequence: "database_Column" = None):
        self.start = start
...
class database_Column(NamedElement):
    ...
    def __init__(self, nullable: bool, defaultValue: str, autoincrement: bool, inPrimaryKey: bool, inForeignKey: bool, unique: bool, database_Column49: "database_ForeignKeyElement" = None, Column51: "database_IndexElement" = None, Column46: "database_ForeignKeyElement" = None, Column55: "database_Sequence" = None, column: set["database_IndexElement"] = None, columns: "database_PrimaryKey" = None, database_Column8: set["database_ForeignKey"] = None, fkColumn: set["database_ForeignKeyElement"] = None, database_Column: set["database_Index"] = None, database_Column11: "database_Type" = None, columns13: "database_Sequence" = None, columns15: "database_Table" = None, Column: "database_Table" = None, Column35: "database_PrimaryKey" = None):
...
class database_Index(NamedElement):
    ...
    def __init__(self, unique: bool, cardinality: int, indexType: str, qualifier: str, database_Index: "database_Column" = None, indexes: "database_Table" = None, database_Index17: set["database_IndexElement"] = None, Index: "database_Table" = None):
        self.unique = unique
...
class database_Constraint(NamedElement):
    ...
    def __init__(self, expression: str, constraints: "database_Table" = None, Constraint: "database_Table" = None):
...
class database_ForeignKey(NamedElement):
    ...
    def __init__(self, database_ForeignKey40: set["database_ForeignKeyElement"] = None, foreignKeys: "database_Table" = None, database_ForeignKey44: "database_Table" = None, database_ForeignKey: "database_Column" = None, ForeignKey: "database_Table" = None):
...
class database_IndexElement(DatabaseElement):
    ...
    def __init__(self, asc: bool, indexElements: "database_Column" = None, IndexElement: "database_Column" = None, database_IndexElement: "database_Index" = None):
        self.asc = asc
