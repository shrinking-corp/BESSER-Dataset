...
public class database_Table extends AbstractTable {
    ...
    public database_Table(
        ArrayList<database_ForeignKey> database_foreignkeys,        ArrayList<database_Column> database_columns,        ArrayList<database_Constraint> database_constraints,        ArrayList<database_Index> database_indexs    ) {
