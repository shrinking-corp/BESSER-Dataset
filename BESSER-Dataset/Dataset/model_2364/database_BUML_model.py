...
database_Column.attributes={database_Column_autoincrement, database_Column_unique, database_Column_inPrimaryKey, database_Column_defaultValue, database_Column_inForeignKey, database_Column_nullable}
...
database_Index.attributes={database_Index_cardinality, database_Index_unique, database_Index_indexType, database_Index_qualifier}
...
database_Sequence.attributes={database_Sequence_maxValue, database_Sequence_start, database_Sequence_minValue, database_Sequence_cycle, database_Sequence_increment, database_Sequence_cacheSize}
...
database_DatabaseElement.attributes={database_DatabaseElement_ID, database_DatabaseElement_techID, database_DatabaseElement_comments}
...
domain_model = DomainModel(
    name="database",
    types={database_NamedElement, DatabaseElement, database_DataBase, TableContainer, TypesLibraryUser, database_IndexElement, database_PrimaryKey, database_ForeignKey, database_ForeignKeyElement, database_Schema, database_UserDefinedTypesLibrary, database_AbstractTable, NamedElement, database_TableContainer, database_Column, database_Index, database_View, AbstractTable, database_ViewElement, database_Type, database_Sequence, database_Table, database_Constraint, database_DatabaseElement},
    associations={indexElements5, primaryKey6, foreignKeys7, foreignKeyElements9, schemas0, defines1, owner3, indexes4, owner18, columns20, type10, sequence12, owner14, elements16, owner36, tables21, primaryKey24, foreignKeys26, constraints28, indexes30, columns32, columns34, pkColumn47, column50, owner52, elements39, owner41, target43, fkColumn45, columns54, tables56, sequences58},
    generalizations={gen_database_NamedElement_DatabaseElement, gen_database_DataBase_TableContainer, gen_database_DataBase_TypesLibraryUser, gen_database_AbstractTable_NamedElement, gen_database_Column_NamedElement, gen_database_View_AbstractTable, gen_database_Index_NamedElement, gen_database_ForeignKey_NamedElement, gen_database_Table_AbstractTable, gen_database_PrimaryKey_NamedElement, gen_database_IndexElement_DatabaseElement, gen_database_Constraint_NamedElement, gen_database_ForeignKeyElement_DatabaseElement, gen_database_TableContainer_NamedElement, gen_database_Schema_TableContainer, gen_database_Sequence_NamedElement},
    metadata=None
)
