...
# Classes
cgimodel_State = Class(name="cgimodel_State")
BaseState = Class(name="BaseState")
cgimodel_Expr = Class(name="cgimodel_Expr")
cgimodel_OrState = Class(name="cgimodel_OrState")
cgimodel_StateModel = Class(name="cgimodel_StateModel")
cgimodel_BaseState = Class(name="cgimodel_BaseState", is_abstract=True)
cgimodel_Transition = Class(name="cgimodel_Transition")
cgimodel_StateModels = Class(name="cgimodel_StateModels")
...
domain_model = DomainModel(
    name="cgimodel",
    types={cgimodel_State, BaseState, cgimodel_Expr, cgimodel_OrState, cgimodel_StateModel, cgimodel_BaseState, cgimodel_Transition, cgimodel_StateModels},
    associations={transitions1, expr3, states4, source6, states0, target9, condition12, stateModels15},
