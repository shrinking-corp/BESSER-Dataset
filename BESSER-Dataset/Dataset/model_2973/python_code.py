...
class cgimodel_BaseState(ABC):
    ...
    def __init__(self, name: str, cgimodel_BaseState5: "cgimodel_OrState" = None, cgimodel_BaseState8: "cgimodel_Transition" = None, cgimodel_BaseState: "cgimodel_StateModel" = None):
        self.name = name
...
class cgimodel_StateModel:
    ...
    def __init__(self, name: str, cgimodel_StateModel2: set["cgimodel_Transition"] = None, cgimodel_StateModel: set["cgimodel_BaseState"] = None, cgimodel_StateModel16: "cgimodel_StateModels" = None):
        self.name = name
