...
class mancoosimm_SharedLibrary:
    ...
    def __init__(self, name: str, version: str, sharedLibraries: "mancoosimm_LibraryCache" = None, SharedLibrary: "mancoosimm_LibraryCache" = None, mancoosimm_SharedLibrary: "mancoosimm_File" = None):
        self.name = name
        self.version = version
...
class mancoosimm_MimeType:
    ...
    def __init__(self, name: str, extension: str, MimeType: "mancoosimm_MimeTypeHandlerCache" = None, MimeType210: "mancoosimm_MimeTypeHandler" = None, type: set["mancoosimm_MimeTypeHandler"] = None, mimeTypes: "mancoosimm_MimeTypeHandlerCache" = None):
        self.name = name
...
class mancoosimm_ModuleCache:
    ...
    def __init__(self, version: str, ModuleCache: "mancoosimm_Environment" = None, moduleCache: set["mancoosimm_Module"] = None, moduleCache236: "mancoosimm_Environment" = None, ModuleCache241: "mancoosimm_Module" = None):
        self.version = version
...
class mancoosimm_Package(NamedElement):
    ...
    def __init__(self, architecture: str, version: str, mancoosimm_Package69: "mancoosimm_Dependence" = None, mancoosimm_Package: "mancoosimm_Configuration" = None, pkg: "mancoosimm_PackageSetting" = None, Package: "mancoosimm_PackageSetting" = None, mancoosimm_Package285: "mancoosimm_Conflict" = None):
...
class mancoosimm_File(NamedElement):
    ...
    def __init__(self, isMissing: bool, extension: str, description: str, size: int, checkSum: str, isDirectory: bool, suid: bool, guid: bool, permission: str, location: str, mancoosimm_File: "mancoosimm_InstalledPackage" = None, mancoosimm_File50: "mancoosimm_UnpackedPackage" = None, mancoosimm_File175: "mancoosimm_Group" = None, files: set["mancoosimm_PackageSetting"] = None, mancoosimm_File154: "mancoosimm_MenuEntry" = None, mancoosimm_File161: "mancoosimm_Service" = None, mancoosimm_File201: "mancoosimm_DesktopDB" = None, root: "mancoosimm_FileSystem" = None, mancoosimm_File208: "mancoosimm_MimeTypeHandler" = None, mancoosimm_File180: "mancoosimm_Alternative" = None, File: "mancoosimm_FileSystem" = None, mancoosimm_File140: "mancoosimm_GConf" = None, mancoosimm_File135: "mancoosimm_FileSystem" = None, mancoosimm_File137: "mancoosimm_GConf" = None, File168: "mancoosimm_File" = None, parent: set["mancoosimm_File"] = None, File171: "mancoosimm_File" = None, childs: "mancoosimm_File" = None, mancoosimm_File173: "mancoosimm_User" = None, mancoosimm_File247: "mancoosimm_SGMLDocument" = None, mancoosimm_File250: "mancoosimm_SGMLDocument" = None, mancoosimm_File183: "mancoosimm_Alternative" = None, File189: "mancoosimm_PackageSetting" = None, mancoosimm_File197: "mancoosimm_IconCache" = None, mancoosimm_File239: "mancoosimm_Module" = None, mancoosimm_File223: "mancoosimm_XFont" = None, mancoosimm_File225: "mancoosimm_LibraryCache" = None, mancoosimm_File231: "mancoosimm_SharedLibrary" = None, mancoosimm_File271: "mancoosimm_User" = None, mancoosimm_File256: "mancoosimm_SkeeperDocument" = None, mancoosimm_File259: "mancoosimm_SkeeperDocument" = None, mancoosimm_File261: "mancoosimm_EmacsPackage" = None):
...
class mancoosimm_ConfigFilesPackage(Package):
    ...
    def __init__(self, uploaders: str, maintainer: str, checkSum: str, description: str, section: str, tag: str, priority: str, mancoosimm_ConfigFilesPackage: "mancoosimm_Configuration" = None):
        self.uploaders = uploaders
        self.maintainer = maintainer
        self.checkSum = checkSum
        self.description = description
