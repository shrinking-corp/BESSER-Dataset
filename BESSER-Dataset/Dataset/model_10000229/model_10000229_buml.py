...
transaction_Transaction.attributes={transaction_Transaction_transactionTime, transaction_Transaction_id, transaction_Transaction_amount, transaction_Transaction_type}
...
account_Account.attributes={account_Account_accountNo, account_Account_type, account_Account_balance}
...
mypackage_Login.attributes={mypackage_Login_securityAnswer, mypackage_Login_password, mypackage_Login_username, mypackage_Login_lastLoginTime, mypackage_Login_securityQuestion}
...
mypackage_Customer.attributes={mypackage_Customer_address, mypackage_Customer_name, mypackage_Customer_dateOfBirth, mypackage_Customer_phoneNumber, mypackage_Customer_emailAddress}
...
domain_model = DomainModel(
    name="_1cd3069c_1e8f_40cf_a6cc_b37e77780571",
