...
public class mypackage_Customer  {
    ...
    public mypackage_Customer(
        String phoneNumber,        String address,        String name,        LocalDate dateOfBirth,        String emailAddress    ) {
    ...
    public mypackage_Customer(
        String phoneNumber,        String address,        String name,        LocalDate dateOfBirth,        String emailAddress        ArrayList<account_Account> account_accounts    ) {
        this.phoneNumber = phoneNumber;
        this.address = address;
        this.name = name;
        this.dateOfBirth = dateOfBirth;
