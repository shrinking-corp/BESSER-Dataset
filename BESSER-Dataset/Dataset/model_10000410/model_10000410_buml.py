...
GameView.attributes={GameView_bet, GameView_hitButton, GameView_showStrategy, GameView_splitButton, GameView_doubleButton, GameView_dealButton, GameView_standButton}
...
PlayerView.attributes={PlayerView_status, PlayerView_cardTotal, PlayerView_moneyBox, PlayerView_busted, PlayerView_player, PlayerView_cardLabels}
...
BlackjackGame.attributes={BlackjackGame_bet, BlackjackGame_player, BlackjackGame_deck, BlackjackGame_dealer}
...
Card.attributes={Card_valueHard, Card_avatar, Card_suit, Card_name, Card_valueSoft, Card_rank, Card_Count}
...
domain_model = DomainModel(
    name="_33c8b0d7_fdc9_44cd_af7f_4b7e2261647e",
    ...
    associations={Hand_Card, Deck_Card, LoginView_Profile2, GameLauncher_LoginView, Profile_Blackjack, Blackjack_GameView, Blackjack_Strategy, PlayerView_GameView, Player_Blackjack, Dealer_Blackjack, Blackjack_Deck, BasePlayer_PlayerView, Player_Profile, Dealer_Hand, Player_Hand},
    generalizations={},
    metadata=None
)
