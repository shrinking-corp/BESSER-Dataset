...
# Classes
helloworld2_Person = Class(name="helloworld2_Person")
helloworld2_Greeting = Class(name="helloworld2_Greeting")
helloworld2_GreetingMessage = Class(name="helloworld2_GreetingMessage")
...
domain_model = DomainModel(
    name="helloworld2",
    types={helloworld2_Person, helloworld2_Greeting, helloworld2_GreetingMessage},
    associations={person1, greetingMessage0},
    generalizations={},
    metadata=None
)
