...
def test_hyp_helloworld2_greetingmessage_is_not_abstract():
    assert not inspect.isabstract(helloworld2_GreetingMessage)


def test_hyp_helloworld2_greetingmessage_constructor_exists():
    assert callable(helloworld2_GreetingMessage.__init__)


def test_hyp_helloworld2_greetingmessage_constructor_args():
...
def test_hyp_helloworld2_greeting_is_not_abstract():
    assert not inspect.isabstract(helloworld2_Greeting)


def test_hyp_helloworld2_greeting_constructor_exists():
    assert callable(helloworld2_Greeting.__init__)


def test_hyp_helloworld2_greeting_constructor_args():
    sig = inspect.signature(helloworld2_Greeting.__init__)
    params = list(sig.parameters.keys())



def test_hyp_helloworld2_person_is_not_abstract():
    assert not inspect.isabstract(helloworld2_Person)


def test_hyp_helloworld2_person_constructor_exists():
    assert callable(helloworld2_Person.__init__)


def test_hyp_helloworld2_person_constructor_args():
...
def test_hyp_helloworld2_greetingmessage_text_setter(instance):
...
def test_hyp_helloworld2_person_name_setter(instance):
