...
camel_Model = Class(name="camel_Model", is_abstract=True)
camel_CamelModel = Class(name="camel_CamelModel")
Model = Class(name="Model")
camel_Action = Class(name="camel_Action")
camel_Application = Class(name="camel_Application")
...
camel_deployment_DeploymentElement = Class(name="camel_deployment_DeploymentElement", is_abstract=True)
camel_deployment_DeploymentModel = Class(name="camel_deployment_DeploymentModel")
...
camel_deployment_Configuration = Class(name="camel_deployment_Configuration")
VMRequirementSet = Class(name="VMRequirementSet")
camel_deployment_Component = Class(name="camel_deployment_Component", is_abstract=True)
...
camel_deployment_InternalComponent = Class(name="camel_deployment_InternalComponent")
Component = Class(name="Component")
RequiredCommunication = Class(name="RequiredCommunication")
RequiredHost = Class(name="RequiredHost")
camel_deployment_VM = Class(name="camel_deployment_VM")
camel_deployment_VMRequirementSet = Class(name="camel_deployment_VMRequirementSet")
LocationRequirement = Class(name="LocationRequirement")
ProviderRequirement = Class(name="ProviderRequirement")
camel_deployment_ComponentInstance = Class(name="camel_deployment_ComponentInstance", is_abstract=True)
...
camel_deployment_InternalComponentInstance = Class(name="camel_deployment_InternalComponentInstance")
ComponentInstance = Class(name="ComponentInstance")
camel_deployment_Communication = Class(name="camel_deployment_Communication")
camel_deployment_CommunicationPort = Class(name="camel_deployment_CommunicationPort", is_abstract=True)
camel_deployment_ProvidedCommunication = Class(name="camel_deployment_ProvidedCommunication")
CommunicationPort = Class(name="CommunicationPort")
camel_deployment_RequiredCommunication = Class(name="camel_deployment_RequiredCommunication")
camel_deployment_Hosting = Class(name="camel_deployment_Hosting")
camel_deployment_HostingPort = Class(name="camel_deployment_HostingPort", is_abstract=True)
camel_deployment_ProvidedHost = Class(name="camel_deployment_ProvidedHost")
HostingPort = Class(name="HostingPort")
camel_deployment_RequiredHost = Class(name="camel_deployment_RequiredHost")
camel_deployment_RequiredCommunicationInstance = Class(name="camel_deployment_RequiredCommunicationInstance")
camel_deployment_HostingInstance = Class(name="camel_deployment_HostingInstance")
...
camel_deployment_VMInstance = Class(name="camel_deployment_VMInstance")
Attribute = Class(name="Attribute")
SingleValue = Class(name="SingleValue")
camel_deployment_CommunicationInstance = Class(name="camel_deployment_CommunicationInstance")
camel_deployment_CommunicationPortInstance = Class(name="camel_deployment_CommunicationPortInstance")
MonetaryUnit = Class(name="MonetaryUnit")
camel_deployment_ProvidedCommunicationInstance = Class(name="camel_deployment_ProvidedCommunicationInstance")
CommunicationPortInstance = Class(name="CommunicationPortInstance")
RequirementGroup = Class(name="RequirementGroup")
camel_execution_Measurement = Class(name="camel_execution_Measurement")
camel_deployment_HostingPortInstance = Class(name="camel_deployment_HostingPortInstance", is_abstract=True)
camel_deployment_ProvidedHostInstance = Class(name="camel_deployment_ProvidedHostInstance")
HostingPortInstance = Class(name="HostingPortInstance")
camel_deployment_RequiredHostInstance = Class(name="camel_deployment_RequiredHostInstance")
camel_execution_ExecutionModel = Class(name="camel_execution_ExecutionModel")
...
camel_execution_ActionRealisation = Class(name="camel_execution_ActionRealisation")
execution_camel_Action = Class(name="execution_camel_Action")
camel_execution_ExecutionContext = Class(name="camel_execution_ExecutionContext")
execution_camel_Application = Class(name="execution_camel_Application")
camel_execution_SLOAssessment = Class(name="camel_execution_SLOAssessment")
camel_execution_RuleTrigger = Class(name="camel_execution_RuleTrigger")
MetricInstance = Class(name="MetricInstance")
ServiceLevelObjective = Class(name="ServiceLevelObjective")
camel_execution_ApplicationMeasurement = Class(name="camel_execution_ApplicationMeasurement")
camel_execution_InternalComponentMeasurement = Class(name="camel_execution_InternalComponentMeasurement")
camel_execution_CommunicationMeasurement = Class(name="camel_execution_CommunicationMeasurement")
camel_execution_VMMeasurement = Class(name="camel_execution_VMMeasurement")
camel_location_GeographicalRegion = Class(name="camel_location_GeographicalRegion")
camel_location_Country = Class(name="camel_location_Country")
ScalabilityRule = Class(name="ScalabilityRule")
camel_location_LocationModel = Class(name="camel_location_LocationModel")
CloudLocation = Class(name="CloudLocation")
Country = Class(name="Country")
GeographicalRegion = Class(name="GeographicalRegion")
camel_location_Location = Class(name="camel_location_Location", is_abstract=True)
camel_location_CloudLocation = Class(name="camel_location_CloudLocation")
Location = Class(name="Location")
camel_metric_Condition = Class(name="camel_metric_Condition", is_abstract=True)
camel_metric_MetricCondition = Class(name="camel_metric_MetricCondition")
Condition = Class(name="Condition")
MetricContext = Class(name="MetricContext")
camel_metric_PropertyCondition = Class(name="camel_metric_PropertyCondition")
PropertyContext = Class(name="PropertyContext")
TimeIntervalUnit = Class(name="TimeIntervalUnit")
Sensor = Class(name="Sensor")
camel_metric_MetricFormulaParameter = Class(name="camel_metric_MetricFormulaParameter")
camel_metric_MetricInstance = Class(name="camel_metric_MetricInstance", is_abstract=True)
...
camel_metric_CompositeMetricInstance = Class(name="camel_metric_CompositeMetricInstance")
camel_metric_RawMetricInstance = Class(name="camel_metric_RawMetricInstance")
MetricFormula = Class(name="MetricFormula")
camel_metric_RawMetric = Class(name="camel_metric_RawMetric")
camel_metric_MetricFormula = Class(name="camel_metric_MetricFormula")
MetricFormulaParameter = Class(name="MetricFormulaParameter")
camel_metric_Metric = Class(name="camel_metric_Metric", is_abstract=True)
ValueType = Class(name="ValueType")
Unit = Class(name="Unit")
Property_ = Class(name="Property")
camel_metric_CompositeMetric = Class(name="camel_metric_CompositeMetric")
camel_metric_Property = Class(name="camel_metric_Property")
camel_metric_Schedule = Class(name="camel_metric_Schedule")
camel_metric_MetricObjectBinding = Class(name="camel_metric_MetricObjectBinding", is_abstract=True)
camel_metric_MetricApplicationBinding = Class(name="camel_metric_MetricApplicationBinding")
camel_metric_MetricComponentBinding = Class(name="camel_metric_MetricComponentBinding")
camel_metric_MetricVMBinding = Class(name="camel_metric_MetricVMBinding")
camel_metric_ConditionContext = Class(name="camel_metric_ConditionContext", is_abstract=True)
metric_camel_Application = Class(name="metric_camel_Application")
camel_metric_Sensor = Class(name="camel_metric_Sensor")
camel_metric_Window = Class(name="camel_metric_Window")
camel_metric_CompositeMetricContext = Class(name="camel_metric_CompositeMetricContext")
camel_metric_RawMetricContext = Class(name="camel_metric_RawMetricContext")
camel_metric_MetricModel = Class(name="camel_metric_MetricModel")
ConditionContext = Class(name="ConditionContext")
camel_metric_MetricContext = Class(name="camel_metric_MetricContext", is_abstract=True)
Permission = Class(name="Permission")
ResourceFilter = Class(name="ResourceFilter")
camel_organisation_Credentials = Class(name="camel_organisation_Credentials", is_abstract=True)
camel_organisation_CloudCredentials = Class(name="camel_organisation_CloudCredentials")
Credentials = Class(name="Credentials")
camel_metric_PropertyContext = Class(name="camel_metric_PropertyContext")
camel_organisation_OrganisationModel = Class(name="camel_organisation_OrganisationModel")
...
camel_organisation_ExternalIdentifier = Class(name="camel_organisation_ExternalIdentifier")
camel_organisation_Permission = Class(name="camel_organisation_Permission")
camel_organisation_DataCenter = Class(name="camel_organisation_DataCenter")
camel_organisation_Entity = Class(name="camel_organisation_Entity")
camel_organisation_Organisation = Class(name="camel_organisation_Organisation")
camel_organisation_CloudProvider = Class(name="camel_organisation_CloudProvider")
SecurityCapability = Class(name="SecurityCapability")
camel_organisation_User = Class(name="camel_organisation_User")
CloudCredentials = Class(name="CloudCredentials")
camel_organisation_UserGroup = Class(name="camel_organisation_UserGroup")
camel_organisation_ResourceFilter = Class(name="camel_organisation_ResourceFilter", is_abstract=True)
camel_organisation_InformationResourceFilter = Class(name="camel_organisation_InformationResourceFilter")
camel_organisation_ServiceResourceFilter = Class(name="camel_organisation_ServiceResourceFilter")
camel_organisation_Role = Class(name="camel_organisation_Role")
camel_organisation_RoleAssignment = Class(name="camel_organisation_RoleAssignment")
camel_provider_Cardinality = Class(name="camel_provider_Cardinality", is_abstract=True)
camel_provider_FeatCardinality = Class(name="camel_provider_FeatCardinality")
Cardinality = Class(name="Cardinality")
camel_organisation_PaaSageCredentials = Class(name="camel_organisation_PaaSageCredentials")
camel_provider_ProviderModel = Class(name="camel_provider_ProviderModel")
Constraint = Class(name="Constraint")
Feature = Class(name="Feature")
camel_provider_Attribute = Class(name="camel_provider_Attribute")
camel_provider_AttributeConstraint = Class(name="camel_provider_AttributeConstraint")
camel_provider_Functional = Class(name="camel_provider_Functional")
Requires = Class(name="Requires")
camel_provider_GroupCardinality = Class(name="camel_provider_GroupCardinality")
camel_provider_Clone = Class(name="camel_provider_Clone")
Clone = Class(name="Clone")
camel_provider_Constraint = Class(name="camel_provider_Constraint", is_abstract=True)
AttributeConstraint = Class(name="AttributeConstraint")
camel_provider_Excludes = Class(name="camel_provider_Excludes")
camel_provider_Implies = Class(name="camel_provider_Implies")
camel_provider_Requires = Class(name="camel_provider_Requires")
Scope = Class(name="Scope")
FeatCardinality = Class(name="FeatCardinality")
Requirement = Class(name="Requirement")
camel_requirement_Requirement = Class(name="camel_requirement_Requirement", is_abstract=True)
camel_requirement_RequirementGroup = Class(name="camel_requirement_RequirementGroup")
camel_provider_Feature = Class(name="camel_provider_Feature")
camel_provider_Alternative = Class(name="camel_provider_Alternative")
GroupCardinality = Class(name="GroupCardinality")
camel_provider_Exclusive = Class(name="camel_provider_Exclusive")
Alternative = Class(name="Alternative")
camel_provider_Scope = Class(name="camel_provider_Scope", is_abstract=True)
camel_provider_Instance = Class(name="camel_provider_Instance")
camel_provider_Product = Class(name="camel_provider_Product")
camel_requirement_RequirementModel = Class(name="camel_requirement_RequirementModel")
camel_requirement_ServiceLevelObjective = Class(name="camel_requirement_ServiceLevelObjective")
HardRequirement = Class(name="HardRequirement")
requirement_camel_Application = Class(name="requirement_camel_Application")
camel_requirement_HardRequirement = Class(name="camel_requirement_HardRequirement", is_abstract=True)
camel_requirement_SoftRequirement = Class(name="camel_requirement_SoftRequirement", is_abstract=True)
camel_requirement_OptimisationRequirement = Class(name="camel_requirement_OptimisationRequirement")
SoftRequirement = Class(name="SoftRequirement")
camel_requirement_HardwareRequirement = Class(name="camel_requirement_HardwareRequirement", is_abstract=True)
camel_requirement_QualitativeHardwareRequirement = Class(name="camel_requirement_QualitativeHardwareRequirement")
HardwareRequirement = Class(name="HardwareRequirement")
camel_requirement_QuantitativeHardwareRequirement = Class(name="camel_requirement_QuantitativeHardwareRequirement")
camel_requirement_VerticalScaleRequirement = Class(name="camel_requirement_VerticalScaleRequirement")
camel_requirement_ProviderRequirement = Class(name="camel_requirement_ProviderRequirement")
camel_requirement_OSOrImageRequirement = Class(name="camel_requirement_OSOrImageRequirement", is_abstract=True)
camel_requirement_OSRequirement = Class(name="camel_requirement_OSRequirement")
camel_requirement_ImageRequirement = Class(name="camel_requirement_ImageRequirement")
camel_requirement_SecurityRequirement = Class(name="camel_requirement_SecurityRequirement")
SecurityControl = Class(name="SecurityControl")
camel_requirement_LocationRequirement = Class(name="camel_requirement_LocationRequirement")
camel_requirement_ScaleRequirement = Class(name="camel_requirement_ScaleRequirement", is_abstract=True)
camel_requirement_HorizontalScaleRequirement = Class(name="camel_requirement_HorizontalScaleRequirement")
ScaleRequirement = Class(name="ScaleRequirement")
camel_scalability_Event = Class(name="camel_scalability_Event")
camel_scalability_EventPattern = Class(name="camel_scalability_EventPattern", is_abstract=True)
camel_scalability_ScalabilityModel = Class(name="camel_scalability_ScalabilityModel")
Event = Class(name="Event")
ScalingAction = Class(name="ScalingAction")
EventPattern = Class(name="EventPattern")
Timer = Class(name="Timer")
camel_scalability_UnaryEventPattern = Class(name="camel_scalability_UnaryEventPattern")
camel_scalability_BinaryEventPattern = Class(name="camel_scalability_BinaryEventPattern")
scalability_camel_Action = Class(name="scalability_camel_Action")
camel_scalability_SimpleEvent = Class(name="camel_scalability_SimpleEvent")
camel_scalability_FunctionalEvent = Class(name="camel_scalability_FunctionalEvent")
SimpleEvent = Class(name="SimpleEvent")
camel_scalability_NonFunctionalEvent = Class(name="camel_scalability_NonFunctionalEvent")
MetricCondition = Class(name="MetricCondition")
camel_scalability_EventInstance = Class(name="camel_scalability_EventInstance")
camel_scalability_ScalabilityRule = Class(name="camel_scalability_ScalabilityRule")
camel_security_SecurityModel = Class(name="camel_security_SecurityModel")
SecurityRequirement = Class(name="SecurityRequirement")
SecurityProperty = Class(name="SecurityProperty")
camel_scalability_ScalingAction = Class(name="camel_scalability_ScalingAction", is_abstract=True)
Action = Class(name="Action")
camel_scalability_HorizontalScalingAction = Class(name="camel_scalability_HorizontalScalingAction")
camel_scalability_VerticalScalingAction = Class(name="camel_scalability_VerticalScalingAction")
camel_scalability_Timer = Class(name="camel_scalability_Timer")
...
camel_security_SecurityDomain = Class(name="camel_security_SecurityDomain")
camel_security_CompositeSecurityMetric = Class(name="camel_security_CompositeSecurityMetric")
CompositeMetric = Class(name="CompositeMetric")
camel_security_CompositeSecurityMetricInstance = Class(name="camel_security_CompositeSecurityMetricInstance")
CompositeMetricInstance = Class(name="CompositeMetricInstance")
camel_security_SecurityControl = Class(name="camel_security_SecurityControl")
camel_security_RawSecurityMetricInstance = Class(name="camel_security_RawSecurityMetricInstance")
RawMetricInstance = Class(name="RawMetricInstance")
camel_security_RawSecurityMetric = Class(name="camel_security_RawSecurityMetric")
RawMetric = Class(name="RawMetric")
camel_security_SecurityProperty = Class(name="camel_security_SecurityProperty")
camel_security_Certifiable = Class(name="camel_security_Certifiable")
camel_security_SecuritySLO = Class(name="camel_security_SecuritySLO")
camel_security_SecurityCapability = Class(name="camel_security_SecurityCapability")
camel_type_ValueType = Class(name="camel_type_ValueType", is_abstract=True)
camel_type_BooleanValueType = Class(name="camel_type_BooleanValueType")
camel_type_Enumeration = Class(name="camel_type_Enumeration")
camel_type_TypeModel = Class(name="camel_type_TypeModel")
camel_type_Limit = Class(name="camel_type_Limit")
NumericValue = Class(name="NumericValue")
camel_type_SingleValue = Class(name="camel_type_SingleValue", is_abstract=True)
camel_type_BoolValue = Class(name="camel_type_BoolValue")
camel_type_EnumerateValue = Class(name="camel_type_EnumerateValue")
camel_type_NumericValue = Class(name="camel_type_NumericValue", is_abstract=True)
camel_type_IntegerValue = Class(name="camel_type_IntegerValue")
camel_type_FloatsValue = Class(name="camel_type_FloatsValue")
camel_type_DoublePrecisionValue = Class(name="camel_type_DoublePrecisionValue")
camel_type_NegativeInf = Class(name="camel_type_NegativeInf")
camel_type_PositiveInf = Class(name="camel_type_PositiveInf")
camel_type_ValueToIncrease = Class(name="camel_type_ValueToIncrease")
camel_type_StringsValue = Class(name="camel_type_StringsValue")
camel_type_RangeUnion = Class(name="camel_type_RangeUnion")
EnumerateValue = Class(name="EnumerateValue")
camel_type_List = Class(name="camel_type_List")
camel_type_Range = Class(name="camel_type_Range")
Limit = Class(name="Limit")
camel_unit_UnitModel = Class(name="camel_unit_UnitModel")
Range = Class(name="Range")
camel_type_StringValueType = Class(name="camel_type_StringValueType")
camel_unit_Unit = Class(name="camel_unit_Unit", is_abstract=True)
camel_unit_CoreUnit = Class(name="camel_unit_CoreUnit")
camel_unit_Dimensionless = Class(name="camel_unit_Dimensionless")
camel_unit_MonetaryUnit = Class(name="camel_unit_MonetaryUnit")
camel_unit_RequestUnit = Class(name="camel_unit_RequestUnit")
camel_unit_StorageUnit = Class(name="camel_unit_StorageUnit")
camel_unit_ThroughputUnit = Class(name="camel_unit_ThroughputUnit")
camel_unit_TimeIntervalUnit = Class(name="camel_unit_TimeIntervalUnit")
camel_unit_TransactionUnit = Class(name="camel_unit_TransactionUnit")
...
camel_Model.attributes={camel_Model_name, camel_Model_importURI}
...
camel_Application.attributes={camel_Application_version, camel_Application_description, camel_Application_name}
...
camel_deployment_Configuration.attributes={camel_deployment_Configuration_downloadCommand, camel_deployment_Configuration_stopCommand, camel_deployment_Configuration_configureCommand, camel_deployment_Configuration_installCommand, camel_deployment_Configuration_startCommand, camel_deployment_Configuration_uploadCommand}
...
camel_deployment_InternalComponent_m_contains: Method = Method(name="contains", parameters={Parameter(name='camel_rc', type=StringType), Parameter(name='camel_ic', type=StringType)}, type=BooleanType)
...
camel_deployment_VMInstance_m_checkDates: Method = Method(name="checkDates", parameters={Parameter(name='camel_vm', type=StringType)}, type=BooleanType)
...
camel_execution_Measurement.attributes={camel_execution_Measurement_value, camel_execution_Measurement_rawData, camel_execution_Measurement_measurementTime, camel_execution_Measurement_name}
...
camel_execution_ActionRealisation.attributes={camel_execution_ActionRealisation_endTime, camel_execution_ActionRealisation_name, camel_execution_ActionRealisation_startTime, camel_execution_ActionRealisation_lowLevelActions}
...
camel_execution_ExecutionContext.attributes={camel_execution_ExecutionContext_endTime, camel_execution_ExecutionContext_startTime, camel_execution_ExecutionContext_name, camel_execution_ExecutionContext_totalCost}
...
camel_execution_SLOAssessment.attributes={camel_execution_SLOAssessment_assessmentTime, camel_execution_SLOAssessment_name, camel_execution_SLOAssessment_assessment}
...
camel_execution_RuleTrigger.attributes={camel_execution_RuleTrigger_trigerringTime, camel_execution_RuleTrigger_name}
...
camel_location_CloudLocation_m_checkRecursiveness: Method = Method(name="checkRecursiveness", parameters={Parameter(name='camel_cl2', type=StringType), Parameter(name='camel_cl1', type=StringType)}, type=BooleanType)
...
camel_metric_Condition.attributes={camel_metric_Condition_validity, camel_metric_Condition_comparisonOperator, camel_metric_Condition_name, camel_metric_Condition_threshold}
...
camel_metric_MetricInstance_m_checkRecursiveness: Method = Method(name="checkRecursiveness", parameters={Parameter(name='camel_m2', type=StringType), Parameter(name='camel_m1', type=StringType)}, type=BooleanType)
...
camel_metric_MetricFormula_m_containsMetric: Method = Method(name="containsMetric", parameters={Parameter(name='camel_m', type=StringType)}, type=BooleanType)
camel_metric_MetricFormula_m_hasMetric: Method = Method(name="hasMetric", parameters={}, type=BooleanType)
camel_metric_MetricFormula.attributes={camel_metric_MetricFormula_functionArity, camel_metric_MetricFormula_function, camel_metric_MetricFormula_functionPattern}
camel_metric_MetricFormula.methods={camel_metric_MetricFormula_m_hasMetric, camel_metric_MetricFormula_m_containsMetric}
...
camel_metric_Metric_m_checkRecursiveness: Method = Method(name="checkRecursiveness", parameters={Parameter(name='camel_mt2', type=StringType), Parameter(name='camel_mt1', type=StringType)}, type=BooleanType)
camel_metric_Metric.attributes={camel_metric_Metric_isVariable, camel_metric_Metric_valueDirection, camel_metric_Metric_layer, camel_metric_Metric_description}
...
camel_metric_CompositeMetric_m_greaterEqualThanLayer: Method = Method(name="greaterEqualThanLayer", parameters={Parameter(name='camel_l1', type=StringType), Parameter(name='camel_l2', type=StringType)}, type=BooleanType)
...
camel_metric_Property.attributes={camel_metric_Property_type, camel_metric_Property_description, camel_metric_Property_name}
...
camel_metric_Schedule_m_checkStartEndDates: Method = Method(name="checkStartEndDates", parameters={Parameter(name='camel_this', type=StringType)}, type=BooleanType)
camel_metric_Schedule_m_checkIntervalRepetitions: Method = Method(name="checkIntervalRepetitions", parameters={Parameter(name='camel_s', type=StringType)}, type=BooleanType)
camel_metric_Schedule.attributes={camel_metric_Schedule_name, camel_metric_Schedule_type, camel_metric_Schedule_end, camel_metric_Schedule_interval, camel_metric_Schedule_start, camel_metric_Schedule_repetitions}
camel_metric_Schedule.methods={camel_metric_Schedule_m_checkIntervalRepetitions, camel_metric_Schedule_m_checkStartEndDates}
...
camel_metric_ConditionContext.attributes={camel_metric_ConditionContext_isRelative, camel_metric_ConditionContext_minQuantity, camel_metric_ConditionContext_maxQuantity, camel_metric_ConditionContext_quantifier, camel_metric_ConditionContext_name}
...
camel_metric_Window.attributes={camel_metric_Window_windowType, camel_metric_Window_sizeType, camel_metric_Window_timeSize, camel_metric_Window_measurementSize, camel_metric_Window_name}
...
camel_organisation_Permission_m_checkStartEndDates: Method = Method(name="checkStartEndDates", parameters={Parameter(name='camel_this', type=StringType)}, type=BooleanType)
camel_organisation_Permission.attributes={camel_organisation_Permission_endTime, camel_organisation_Permission_startTime, camel_organisation_Permission_action, camel_organisation_Permission_name}
...
camel_organisation_DataCenter.attributes={camel_organisation_DataCenter_name, camel_organisation_DataCenter_codeName}
...
camel_organisation_Organisation.attributes={camel_organisation_Organisation_name, camel_organisation_Organisation_email, camel_organisation_Organisation_postalAddress, camel_organisation_Organisation_www}
...
camel_organisation_CloudProvider.attributes={camel_organisation_CloudProvider_public, camel_organisation_CloudProvider_IaaS, camel_organisation_CloudProvider_SaaS, camel_organisation_CloudProvider_PaaS}
...
camel_organisation_User.attributes={camel_organisation_User_lastName, camel_organisation_User_www, camel_organisation_User_email, camel_organisation_User_firstName, camel_organisation_User_name}
...
camel_organisation_ServiceResourceFilter.attributes={camel_organisation_ServiceResourceFilter_everyService, camel_organisation_ServiceResourceFilter_serviceURL}
...
camel_organisation_RoleAssignment_m_checkStartEndDates: Method = Method(name="checkStartEndDates", parameters={Parameter(name='camel_this', type=StringType)}, type=BooleanType)
camel_organisation_RoleAssignment_m_checkAssignedOnDates: Method = Method(name="checkAssignedOnDates", parameters={Parameter(name='camel_this', type=StringType)}, type=BooleanType)
camel_organisation_RoleAssignment.attributes={camel_organisation_RoleAssignment_assignmentTime, camel_organisation_RoleAssignment_endTime, camel_organisation_RoleAssignment_name, camel_organisation_RoleAssignment_startTime}
...
camel_provider_Cardinality.attributes={camel_provider_Cardinality_cardinalityMax, camel_provider_Cardinality_cardinalityMin}
...
camel_provider_Attribute_m_checkValue: Method = Method(name="checkValue", parameters={Parameter(name='camel_v', type=StringType), Parameter(name='camel_diff', type=StringType)}, type=BooleanType)
camel_provider_Attribute.attributes={camel_provider_Attribute_name, camel_provider_Attribute_unitType}
...
camel_provider_Functional.attributes={camel_provider_Functional_value, camel_provider_Functional_order, camel_provider_Functional_type}
...
camel_requirement_RequirementGroup_m_checkRecursiveness: Method = Method(name="checkRecursiveness", parameters={Parameter(name='camel_rg1', type=StringType), Parameter(name='camel_r', type=StringType), Parameter(name='camel_resources', type=StringType), Parameter(name='camel_context', type=StringType)}, type=BooleanType)
...
camel_requirement_QuantitativeHardwareRequirement.attributes={camel_requirement_QuantitativeHardwareRequirement_minStorage, camel_requirement_QuantitativeHardwareRequirement_minCores, camel_requirement_QuantitativeHardwareRequirement_minCPU, camel_requirement_QuantitativeHardwareRequirement_minRAM, camel_requirement_QuantitativeHardwareRequirement_maxCores, camel_requirement_QuantitativeHardwareRequirement_maxRAM, camel_requirement_QuantitativeHardwareRequirement_maxCPU, camel_requirement_QuantitativeHardwareRequirement_maxStorage}
...
camel_requirement_VerticalScaleRequirement.attributes={camel_requirement_VerticalScaleRequirement_maxRAM, camel_requirement_VerticalScaleRequirement_maxStorage, camel_requirement_VerticalScaleRequirement_maxCPU, camel_requirement_VerticalScaleRequirement_maxCores, camel_requirement_VerticalScaleRequirement_minRAM, camel_requirement_VerticalScaleRequirement_minStorage, camel_requirement_VerticalScaleRequirement_minCores, camel_requirement_VerticalScaleRequirement_minCPU}
...
camel_requirement_OSRequirement.attributes={camel_requirement_OSRequirement_is64os, camel_requirement_OSRequirement_os}
...
camel_scalability_EventPattern_m_includesEvent: Method = Method(name="includesEvent", parameters={Parameter(name='camel_e', type=StringType)}, type=BooleanType)
camel_scalability_EventPattern_m_includesLeftEvent: Method = Method(name="includesLeftEvent", parameters={Parameter(name='camel_e', type=StringType)}, type=BooleanType)
camel_scalability_EventPattern_m_includesRightEvent: Method = Method(name="includesRightEvent", parameters={Parameter(name='camel_e', type=StringType)}, type=BooleanType)
camel_scalability_EventPattern.methods={camel_scalability_EventPattern_m_includesEvent, camel_scalability_EventPattern_m_includesRightEvent, camel_scalability_EventPattern_m_includesLeftEvent}
...
camel_scalability_UnaryEventPattern.attributes={camel_scalability_UnaryEventPattern_operator, camel_scalability_UnaryEventPattern_occurrenceNum}
...
camel_scalability_EventInstance_m_equalLayer: Method = Method(name="equalLayer", parameters={Parameter(name='camel_l2', type=StringType), Parameter(name='camel_l1', type=StringType)}, type=BooleanType)
camel_scalability_EventInstance.attributes={camel_scalability_EventInstance_status, camel_scalability_EventInstance_name, camel_scalability_EventInstance_layer}
...
camel_scalability_VerticalScalingAction.attributes={camel_scalability_VerticalScalingAction_storageUpdate, camel_scalability_VerticalScalingAction_coreUpdate, camel_scalability_VerticalScalingAction_ioUpdate, camel_scalability_VerticalScalingAction_memoryUpdate, camel_scalability_VerticalScalingAction_CPUUpdate, camel_scalability_VerticalScalingAction_networkUpdate}
...
camel_scalability_Timer.attributes={camel_scalability_Timer_maxOccurrenceNum, camel_scalability_Timer_type, camel_scalability_Timer_name, camel_scalability_Timer_timeValue}
...
camel_type_Enumeration_m_includesName: Method = Method(name="includesName", parameters={Parameter(name='camel_name', type=StringType)}, type=BooleanType)
camel_type_Enumeration_m_includesValue: Method = Method(name="includesValue", parameters={Parameter(name='camel_value', type=StringType)}, type=BooleanType)
camel_type_Enumeration.methods={camel_type_Enumeration_m_includesValue, camel_type_Enumeration_m_includesName}
...
camel_type_SingleValue_m_valueEquals: Method = Method(name="valueEquals", parameters={Parameter(name='camel_v', type=StringType)}, type=BooleanType)
...
camel_type_EnumerateValue.attributes={camel_type_EnumerateValue_value, camel_type_EnumerateValue_name}
...
camel_type_RangeUnion_m_includesValue: Method = Method(name="includesValue", parameters={Parameter(name='camel_n', type=StringType)}, type=BooleanType)
camel_type_RangeUnion_m_invalidRangeSequence: Method = Method(name="invalidRangeSequence", parameters={Parameter(name='camel_ru', type=StringType)}, type=BooleanType)
camel_type_RangeUnion.attributes={camel_type_RangeUnion_primitiveType}
camel_type_RangeUnion.methods={camel_type_RangeUnion_m_invalidRangeSequence, camel_type_RangeUnion_m_includesValue}
...
camel_type_List_m_includesValue: Method = Method(name="includesValue", parameters={Parameter(name='camel_v', type=StringType)}, type=BooleanType)
camel_type_List_m_checkValueType: Method = Method(name="checkValueType", parameters={Parameter(name='camel_p', type=StringType)}, type=BooleanType)
...
camel_type_Range_m_checkType: Method = Method(name="checkType", parameters={Parameter(name='camel_l', type=StringType), Parameter(name='camel_lower', type=StringType), Parameter(name='camel_type', type=StringType)}, type=BooleanType)
camel_type_Range_m_includesValue: Method = Method(name="includesValue", parameters={Parameter(name='camel_n', type=StringType)}, type=BooleanType)
camel_type_Range.attributes={camel_type_Range_primitiveType}
camel_type_Range.methods={camel_type_Range_m_includesValue, camel_type_Range_m_checkType}
...
from_351: BinaryAssociation = BinaryAssociation(
    name="from_351",
    ends={
...
from_363: BinaryAssociation = BinaryAssociation(
    name="from_363",
    ends={
...
domain_model = DomainModel(
    name="camel",
    types={ProviderModel, RequirementModel, ScalabilityModel, SecurityModel, TypeModel, camel_Model, camel_CamelModel, Model, camel_Action, camel_Application, DeploymentModel, ExecutionModel, LocationModel, MetricModel, InternalComponentInstance, OrganisationModel, VM, VMInstance, Communication, CommunicationInstance, Hosting, HostingInstance, UnitModel, Entity, camel_deployment_DeploymentElement, camel_deployment_DeploymentModel, InternalComponent, QualitativeHardwareRequirement, QuantitativeHardwareRequirement, OSOrImageRequirement, camel_deployment_Configuration, VMRequirementSet, camel_deployment_Component, DeploymentElement, ProvidedCommunication, ProvidedHost, Configuration, camel_deployment_InternalComponent, Component, RequiredCommunication, RequiredHost, camel_deployment_VM, camel_deployment_VMRequirementSet, LocationRequirement, ProviderRequirement, camel_deployment_ComponentInstance, ProvidedCommunicationInstance, ProvidedHostInstance, camel_deployment_InternalComponentInstance, ComponentInstance, camel_deployment_Communication, camel_deployment_CommunicationPort, camel_deployment_ProvidedCommunication, CommunicationPort, camel_deployment_RequiredCommunication, camel_deployment_Hosting, camel_deployment_HostingPort, camel_deployment_ProvidedHost, HostingPort, camel_deployment_RequiredHost, camel_deployment_RequiredCommunicationInstance, camel_deployment_HostingInstance, RequiredCommunicationInstance, RequiredHostInstance, camel_deployment_VMInstance, Attribute, SingleValue, camel_deployment_CommunicationInstance, camel_deployment_CommunicationPortInstance, MonetaryUnit, camel_deployment_ProvidedCommunicationInstance, CommunicationPortInstance, RequirementGroup, camel_execution_Measurement, camel_deployment_HostingPortInstance, camel_deployment_ProvidedHostInstance, HostingPortInstance, camel_deployment_RequiredHostInstance, camel_execution_ExecutionModel, ActionRealisation, EventInstance, ExecutionContext, Measurement, SLOAssessment, RuleTrigger, camel_execution_ActionRealisation, execution_camel_Action, camel_execution_ExecutionContext, execution_camel_Application, camel_execution_SLOAssessment, camel_execution_RuleTrigger, MetricInstance, ServiceLevelObjective, camel_execution_ApplicationMeasurement, camel_execution_InternalComponentMeasurement, camel_execution_CommunicationMeasurement, camel_execution_VMMeasurement, camel_location_GeographicalRegion, camel_location_Country, ScalabilityRule, camel_location_LocationModel, CloudLocation, Country, GeographicalRegion, camel_location_Location, camel_location_CloudLocation, Location, camel_metric_Condition, camel_metric_MetricCondition, Condition, MetricContext, camel_metric_PropertyCondition, PropertyContext, TimeIntervalUnit, Sensor, camel_metric_MetricFormulaParameter, camel_metric_MetricInstance, Metric, Schedule, Window, MetricObjectBinding, camel_metric_CompositeMetricInstance, camel_metric_RawMetricInstance, MetricFormula, camel_metric_RawMetric, camel_metric_MetricFormula, MetricFormulaParameter, camel_metric_Metric, ValueType, Unit, Property_, camel_metric_CompositeMetric, camel_metric_Property, camel_metric_Schedule, camel_metric_MetricObjectBinding, camel_metric_MetricApplicationBinding, camel_metric_MetricComponentBinding, camel_metric_MetricVMBinding, camel_metric_ConditionContext, metric_camel_Application, camel_metric_Sensor, camel_metric_Window, camel_metric_CompositeMetricContext, camel_metric_RawMetricContext, camel_metric_MetricModel, ConditionContext, camel_metric_MetricContext, Permission, ResourceFilter, camel_organisation_Credentials, camel_organisation_CloudCredentials, Credentials, camel_metric_PropertyContext, camel_organisation_OrganisationModel, Organisation, CloudProvider, ExternalIdentifier, User, UserGroup, DataCenter, Role, RoleAssignment, PaaSageCredentials, camel_organisation_ExternalIdentifier, camel_organisation_Permission, camel_organisation_DataCenter, camel_organisation_Entity, camel_organisation_Organisation, camel_organisation_CloudProvider, SecurityCapability, camel_organisation_User, CloudCredentials, camel_organisation_UserGroup, camel_organisation_ResourceFilter, camel_organisation_InformationResourceFilter, camel_organisation_ServiceResourceFilter, camel_organisation_Role, camel_organisation_RoleAssignment, camel_provider_Cardinality, camel_provider_FeatCardinality, Cardinality, camel_organisation_PaaSageCredentials, camel_provider_ProviderModel, Constraint, Feature, camel_provider_Attribute, camel_provider_AttributeConstraint, camel_provider_Functional, Requires, camel_provider_GroupCardinality, camel_provider_Clone, Clone, camel_provider_Constraint, AttributeConstraint, camel_provider_Excludes, camel_provider_Implies, camel_provider_Requires, Scope, FeatCardinality, Requirement, camel_requirement_Requirement, camel_requirement_RequirementGroup, camel_provider_Feature, camel_provider_Alternative, GroupCardinality, camel_provider_Exclusive, Alternative, camel_provider_Scope, camel_provider_Instance, camel_provider_Product, camel_requirement_RequirementModel, camel_requirement_ServiceLevelObjective, HardRequirement, requirement_camel_Application, camel_requirement_HardRequirement, camel_requirement_SoftRequirement, camel_requirement_OptimisationRequirement, SoftRequirement, camel_requirement_HardwareRequirement, camel_requirement_QualitativeHardwareRequirement, HardwareRequirement, camel_requirement_QuantitativeHardwareRequirement, camel_requirement_VerticalScaleRequirement, camel_requirement_ProviderRequirement, camel_requirement_OSOrImageRequirement, camel_requirement_OSRequirement, camel_requirement_ImageRequirement, camel_requirement_SecurityRequirement, SecurityControl, camel_requirement_LocationRequirement, camel_requirement_ScaleRequirement, camel_requirement_HorizontalScaleRequirement, ScaleRequirement, camel_scalability_Event, camel_scalability_EventPattern, camel_scalability_ScalabilityModel, Event, ScalingAction, EventPattern, Timer, camel_scalability_UnaryEventPattern, camel_scalability_BinaryEventPattern, scalability_camel_Action, camel_scalability_SimpleEvent, camel_scalability_FunctionalEvent, SimpleEvent, camel_scalability_NonFunctionalEvent, MetricCondition, camel_scalability_EventInstance, camel_scalability_ScalabilityRule, camel_security_SecurityModel, SecurityRequirement, SecurityProperty, camel_scalability_ScalingAction, Action, camel_scalability_HorizontalScalingAction, camel_scalability_VerticalScalingAction, camel_scalability_Timer, RawSecurityMetric, CompositeSecurityMetric, RawSecurityMetricInstance, CompositeSecurityMetricInstance, SecurityDomain, SecuritySLO, camel_security_SecurityDomain, camel_security_CompositeSecurityMetric, CompositeMetric, camel_security_CompositeSecurityMetricInstance, CompositeMetricInstance, camel_security_SecurityControl, camel_security_RawSecurityMetricInstance, RawMetricInstance, camel_security_RawSecurityMetric, RawMetric, camel_security_SecurityProperty, camel_security_Certifiable, camel_security_SecuritySLO, camel_security_SecurityCapability, camel_type_ValueType, camel_type_BooleanValueType, camel_type_Enumeration, camel_type_TypeModel, camel_type_Limit, NumericValue, camel_type_SingleValue, camel_type_BoolValue, camel_type_EnumerateValue, camel_type_NumericValue, camel_type_IntegerValue, camel_type_FloatsValue, camel_type_DoublePrecisionValue, camel_type_NegativeInf, camel_type_PositiveInf, camel_type_ValueToIncrease, camel_type_StringsValue, camel_type_RangeUnion, EnumerateValue, camel_type_List, camel_type_Range, Limit, camel_unit_UnitModel, Range, camel_type_StringValueType, camel_unit_Unit, camel_unit_CoreUnit, camel_unit_Dimensionless, camel_unit_MonetaryUnit, camel_unit_RequestUnit, camel_unit_StorageUnit, camel_unit_ThroughputUnit, camel_unit_TimeIntervalUnit, camel_unit_TransactionUnit, ActionType, LayerType, CommunicationType, ComparisonOperatorType, MetricFunctionArityType, MetricFunctionType, PropertyType, WindowSizeType, WindowType, ScheduleType, QuantifierType, FunctionPatternType, SecurityLevel, ResourcePattern, Operator, RequirementOperatorType, BinaryPatternOperatorType, OptimisationFunctionType, TimerType, UnaryPatternOperatorType, StatusType, TypeEnum, UnitDimensionType, UnitType},
    associations={providerModels13, requirementModels15, scalabilityModels17, securityModels19, typeModels21, actions0, applications1, deploymentModels3, executionModels5, locationModels7, metricModels9, internalComponentInstances31, organisationModels11, vms33, vmInstances35, communications37, communicationInstances39, hostings41, hostingInstances43, unitModels23, owner25, deploymentModels27, internalComponents30, providerRequirement64, qualitativeHardwareRequirement66, quantitativeHardwareRequirement68, osOrImageRequirement70, vmRequirementSets45, globalVMRequirementSet47, providedCommunications50, providedHosts51, configurations53, compositeInternalComponents55, requiredCommunications57, requiredHost59, vmRequirementSet61, locationRequirement63, type94, providedCommunicationInstances95, providedHostInstances97, providedCommunication72, requiredCommunication74, providedPortConfiguration77, requiredPortConfiguration80, providedHost83, requiredHost85, providedHostConfiguration88, requiredHostConfiguration91, type114, providedHostInstance116, requiredHostInstance119, requiredCommunicationInstances99, requiredHostInstance100, vmType102, vmTypeValue103, type105, providedCommunicationInstance107, requiredCommunicationInstance110, type113, costUnit136, deploymentModel138, requirementGroup141, type122, executionContext143, actionRealisations123, eventInstances124, executionContexts126, measurements128, sloAssessessments130, ruleTriggers132, action134, application135, vmInstance161, slo163, executionContext165, measurement168, metricInstance145, slo147, eventInstance149, application152, internalComponentInstance154, sourceVMInstance156, destinationVMInstance158, subLocations186, parent188, geographicalRegion191, parentRegions194, scalabilityRule171, eventInstances172, actionRealisations175, executionContext178, cloudLocations181, countries182, regions184, metricContext196, propertyContext197, unit198, timeUnit201, sensor215, value216, metric203, schedule204, window206, objectBinding208, metricContext210, composingMetricInstances213, formula224, parameters218, valueType219, unit220, property222, subProperties233, sensors235, executionContext225, vmInstance227, componentInstance229, vmInstance231, component242, unit238, unit240, metric276, window278, schedule281, composingMetricContexts284, application244, contexts246, metrics247, metricInstances250, conditions253, properties255, bindings258, windows261, schedules264, parameters267, sensors270, units273, permissions305, resourceFilters307, cloudProvider309, sensor286, property288, organisation290, provider291, externalIdentifiers293, users295, userGroups297, dataCentres299, roles301, roleAssigments303, deploymentModels323, paasageCredentials326, location311, providerModel312, securityCapability314, externalIdentifiers316, requirementModels318, cloudCredentials321, user333, role335, userGroup338, role328, resourceFilter330, to353, fromValue356, toValue359, users341, constraints343, rootFeature344, value346, valueType348, from_351, cardFrom374, cardTo376, subClones362, from_363, to365, attributeConstraints368, scopeFrom370, scopeTo371, requirements396, attributes379, subFeatures381, featureCardinality384, clones387, groupCardinality390, variants391, feature394, customServiceLevel401, requirements397, application399, metric403, property405, application408, component411, metricContext414, component428, providers417, securityControls419, application420, component423, locations426, scaleRequirements445, vm430, rules432, events434, eventInstances436, actions439, patterns441, timers443, timer447, leftEvent449, rightEvent451, event461, actions463, entity465, scaleRequirements468, event454, metricCondition456, event457, metricInstance458, securityControls477, securityRequirements479, securityProperties481, vm471, internalComponent473, unit475, rawSecurityMetrics483, compositeSecurityMetrics485, rawSecurityMetricInstances487, compositeSecurityMetricInstances489, securityDomains491, securityCapabilities493, securitySLOs496, securityControls516, dataCenter518, subDomain498, domain500, subDomain502, securityProperties505, rawSecurityMetrics508, compositeSecurityMetrics511, domain514, dataTypes521, values523, value526, value527, upperLimit536, values529, values530, type532, lowerLimit535, ranges539, units540},
    generalizations={gen_camel_CamelModel_Model, gen_camel_deployment_DeploymentModel_Model, gen_camel_deployment_Configuration_DeploymentElement, gen_camel_deployment_Component_DeploymentElement, gen_camel_deployment_InternalComponent_Component, gen_camel_deployment_VM_Component, gen_camel_deployment_ComponentInstance_DeploymentElement, gen_camel_deployment_InternalComponentInstance_ComponentInstance, gen_camel_deployment_Communication_DeploymentElement, gen_camel_deployment_CommunicationPort_DeploymentElement, gen_camel_deployment_ProvidedCommunication_CommunicationPort, gen_camel_deployment_RequiredCommunication_CommunicationPort, gen_camel_deployment_Hosting_DeploymentElement, gen_camel_deployment_HostingPort_DeploymentElement, gen_camel_deployment_ProvidedHost_HostingPort, gen_camel_deployment_RequiredHost_HostingPort, gen_camel_deployment_RequiredCommunicationInstance_CommunicationPortInstance, gen_camel_deployment_HostingInstance_DeploymentElement, gen_camel_deployment_VMInstance_ComponentInstance, gen_camel_deployment_CommunicationInstance_DeploymentElement, gen_camel_deployment_CommunicationPortInstance_DeploymentElement, gen_camel_deployment_ProvidedCommunicationInstance_CommunicationPortInstance, gen_camel_deployment_HostingPortInstance_DeploymentElement, gen_camel_deployment_ProvidedHostInstance_HostingPortInstance, gen_camel_deployment_RequiredHostInstance_HostingPortInstance, gen_camel_execution_ExecutionModel_Model, gen_camel_execution_ApplicationMeasurement_Measurement, gen_camel_execution_InternalComponentMeasurement_Measurement, gen_camel_execution_CommunicationMeasurement_Measurement, gen_camel_execution_VMMeasurement_Measurement, gen_camel_location_GeographicalRegion_Location, gen_camel_location_Country_GeographicalRegion, gen_camel_location_LocationModel_Model, gen_camel_location_CloudLocation_Location, gen_camel_metric_MetricCondition_Condition, gen_camel_metric_PropertyCondition_Condition, gen_camel_metric_CompositeMetricInstance_MetricInstance, gen_camel_metric_RawMetricInstance_MetricInstance, gen_camel_metric_RawMetric_Metric, gen_camel_metric_MetricFormula_MetricFormulaParameter, gen_camel_metric_Metric_MetricFormulaParameter, gen_camel_metric_CompositeMetric_Metric, gen_camel_metric_MetricApplicationBinding_MetricObjectBinding, gen_camel_metric_MetricComponentBinding_MetricObjectBinding, gen_camel_metric_MetricVMBinding_MetricObjectBinding, gen_camel_metric_CompositeMetricContext_MetricContext, gen_camel_metric_RawMetricContext_MetricContext, gen_camel_metric_MetricModel_Model, gen_camel_metric_MetricContext_ConditionContext, gen_camel_organisation_CloudCredentials_Credentials, gen_camel_metric_PropertyContext_ConditionContext, gen_camel_organisation_OrganisationModel_Model, gen_camel_organisation_Organisation_Entity, gen_camel_organisation_CloudProvider_Organisation, gen_camel_organisation_User_Entity, gen_camel_organisation_InformationResourceFilter_ResourceFilter, gen_camel_organisation_ServiceResourceFilter_ResourceFilter, gen_camel_provider_FeatCardinality_Cardinality, gen_camel_organisation_PaaSageCredentials_Credentials, gen_camel_provider_ProviderModel_Model, gen_camel_provider_Functional_Requires, gen_camel_provider_GroupCardinality_Cardinality, gen_camel_provider_Excludes_Constraint, gen_camel_provider_Implies_Constraint, gen_camel_provider_Requires_Constraint, gen_camel_requirement_RequirementModel_Model, gen_camel_requirement_RequirementGroup_Requirement, gen_camel_provider_Alternative_Feature, gen_camel_provider_Exclusive_Alternative, gen_camel_provider_Instance_Scope, gen_camel_provider_Product_Scope, gen_camel_requirement_ServiceLevelObjective_HardRequirement, gen_camel_requirement_HardRequirement_Requirement, gen_camel_requirement_SoftRequirement_Requirement, gen_camel_requirement_OptimisationRequirement_SoftRequirement, gen_camel_requirement_HardwareRequirement_HardRequirement, gen_camel_requirement_QualitativeHardwareRequirement_HardwareRequirement, gen_camel_requirement_QuantitativeHardwareRequirement_HardwareRequirement, gen_camel_requirement_VerticalScaleRequirement_ScaleRequirement, gen_camel_requirement_ProviderRequirement_HardRequirement, gen_camel_requirement_OSOrImageRequirement_HardRequirement, gen_camel_requirement_OSRequirement_OSOrImageRequirement, gen_camel_requirement_ImageRequirement_OSOrImageRequirement, gen_camel_requirement_SecurityRequirement_HardRequirement, gen_camel_requirement_LocationRequirement_HardRequirement, gen_camel_requirement_ScaleRequirement_HardRequirement, gen_camel_requirement_HorizontalScaleRequirement_ScaleRequirement, gen_camel_scalability_EventPattern_Event, gen_camel_scalability_ScalabilityModel_Model, gen_camel_scalability_UnaryEventPattern_EventPattern, gen_camel_scalability_BinaryEventPattern_EventPattern, gen_camel_scalability_SimpleEvent_Event, gen_camel_scalability_FunctionalEvent_SimpleEvent, gen_camel_scalability_NonFunctionalEvent_SimpleEvent, gen_camel_security_SecurityModel_Model, gen_camel_scalability_ScalingAction_Action, gen_camel_scalability_HorizontalScalingAction_ScalingAction, gen_camel_scalability_VerticalScalingAction_ScalingAction, gen_camel_security_CompositeSecurityMetric_CompositeMetric, gen_camel_security_CompositeSecurityMetricInstance_CompositeMetricInstance, gen_camel_security_RawSecurityMetricInstance_RawMetricInstance, gen_camel_security_RawSecurityMetric_RawMetric, gen_camel_security_SecurityProperty_Property, gen_camel_security_Certifiable_SecurityProperty, gen_camel_security_SecuritySLO_ServiceLevelObjective, gen_camel_type_BooleanValueType_ValueType, gen_camel_type_Enumeration_ValueType, gen_camel_type_TypeModel_Model, gen_camel_type_BoolValue_SingleValue, gen_camel_type_EnumerateValue_SingleValue, gen_camel_type_NumericValue_SingleValue, gen_camel_type_IntegerValue_NumericValue, gen_camel_type_FloatsValue_NumericValue, gen_camel_type_DoublePrecisionValue_NumericValue, gen_camel_type_NegativeInf_NumericValue, gen_camel_type_PositiveInf_NumericValue, gen_camel_type_ValueToIncrease_NumericValue, gen_camel_type_StringsValue_SingleValue, gen_camel_type_RangeUnion_ValueType, gen_camel_type_List_ValueType, gen_camel_type_Range_ValueType, gen_camel_unit_UnitModel_Model, gen_camel_type_StringValueType_ValueType, gen_camel_unit_CoreUnit_Unit, gen_camel_unit_Dimensionless_Unit, gen_camel_unit_MonetaryUnit_Unit, gen_camel_unit_RequestUnit_Unit, gen_camel_unit_StorageUnit_Unit, gen_camel_unit_ThroughputUnit_Unit, gen_camel_unit_TimeIntervalUnit_Unit, gen_camel_unit_TransactionUnit_Unit},
    metadata=None
)
