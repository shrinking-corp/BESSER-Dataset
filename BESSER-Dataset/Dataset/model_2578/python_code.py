...
class camel_type_FloatsValue(NumericValue):
    ...
    def __init__(self, value: float, NumericValue528: "camel_type_ValueToIncrease" = None, NumericValue: "camel_type_Limit" = None):
        self.value = value
...
class camel_type_IntegerValue(NumericValue):
    ...
    def __init__(self, value: int, NumericValue528: "camel_type_ValueToIncrease" = None, NumericValue: "camel_type_Limit" = None):
        self.value = value
...
class camel_security_SecurityControl:
    ...
    def __init__(self, name: str, specification: str, camel_security_SecurityControl: "SecurityDomain" = None, camel_security_SecurityControl503: "SecurityDomain" = None, camel_security_SecurityControl506: set["SecurityProperty"] = None, camel_security_SecurityControl509: set["RawSecurityMetric"] = None, camel_security_SecurityControl512: set["CompositeSecurityMetric"] = None):
        self.name = name
...
class camel_scalability_EventInstance:
    ...
    def equalLayer(self, camel_l1, camel_l2) :
...
class camel_scalability_NonFunctionalEvent(SimpleEvent):
    ...
    def __init__(self, isViolation: bool, camel_scalability_NonFunctionalEvent: "MetricCondition" = None, SimpleEvent: "camel_scalability_EventInstance" = None):
...
class camel_scalability_FunctionalEvent(SimpleEvent):
    ...
    def __init__(self, functionalType: str, SimpleEvent: "camel_scalability_EventInstance" = None):
...
class camel_scalability_BinaryEventPattern(EventPattern):
    ...
    def __init__(self, lowerOccurrenceBound: int, upperOccurrenceBound: int, operator: str, camel_scalability_BinaryEventPattern: "Event" = None, camel_scalability_BinaryEventPattern452: "Event" = None, EventPattern: "camel_scalability_ScalabilityModel" = None):
...
class camel_scalability_UnaryEventPattern(EventPattern):
    ...
    def __init__(self, occurrenceNum: int, operator: str, camel_scalability_UnaryEventPattern: "Event" = None, EventPattern: "camel_scalability_ScalabilityModel" = None):
...
class camel_scalability_HorizontalScalingAction(ScalingAction):
    ...
    def __init__(self, count: int, camel_scalability_HorizontalScalingAction: "InternalComponent" = None, ScalingAction: "camel_scalability_ScalabilityModel" = None):
        self.count = count
...
class camel_scalability_VerticalScalingAction(ScalingAction):
    ...
    def __init__(self, memoryUpdate: int, CPUUpdate: float, coreUpdate: int, storageUpdate: int, ioUpdate: int, networkUpdate: int, ScalingAction: "camel_scalability_ScalabilityModel" = None):
...
class camel_scalability_EventPattern(Event):
    ...
    def __init__(self, camel_scalability_EventPattern: "Timer" = None, Event453: "camel_scalability_BinaryEventPattern" = None, Event450: "camel_scalability_BinaryEventPattern" = None, Event462: "camel_scalability_ScalabilityRule" = None, Event: "camel_scalability_ScalabilityModel" = None, Event455: "camel_scalability_UnaryEventPattern" = None):
    ...
    def includesEvent(self, camel_e) :
        # TODO: Implement includesEvent method
        pass

    def includesLeftEvent(self, camel_e) :
        # TODO: Implement includesLeftEvent method
        pass

    def includesRightEvent(self, camel_e) :
...
class camel_requirement_HorizontalScaleRequirement(ScaleRequirement):
    ...
    def __init__(self, minInstances: int, maxInstances: int, camel_requirement_HorizontalScaleRequirement: "InternalComponent" = None, ScaleRequirement470: "camel_scalability_ScalabilityRule" = None, ScaleRequirement: "camel_scalability_ScalabilityModel" = None):
...
class camel_requirement_VerticalScaleRequirement(ScaleRequirement):
    ...
    def __init__(self, minCPU: float, maxCPU: float, minCores: int, maxCores: int, minRAM: int, maxRAM: int, minStorage: int, maxStorage: int, camel_requirement_VerticalScaleRequirement: "VM" = None, ScaleRequirement470: "camel_scalability_ScalabilityRule" = None, ScaleRequirement: "camel_scalability_ScalabilityModel" = None):
        self.minCPU = minCPU
        self.maxCPU = maxCPU
...
class camel_requirement_QuantitativeHardwareRequirement(HardwareRequirement):
    ...
    def __init__(self, minCPU: float, maxCPU: float, minCores: int, maxCores: int, minRAM: int, maxRAM: int, minStorage: int, maxStorage: int):
        self.minCPU = minCPU
        self.maxCPU = maxCPU
        self.minCores = minCores
        self.maxCores = maxCores
...
class camel_requirement_OptimisationRequirement(SoftRequirement):
    ...
    def __init__(self, optimisationFunction: str, camel_requirement_OptimisationRequirement409: "requirement_camel_Application" = None, camel_requirement_OptimisationRequirement412: "Component" = None, camel_requirement_OptimisationRequirement415: "MetricContext" = None, camel_requirement_OptimisationRequirement: "Metric" = None, camel_requirement_OptimisationRequirement406: "Property" = None):
...
class camel_requirement_RequirementGroup(Requirement):
    ...
    def __init__(self, requirementOperator: str, camel_requirement_RequirementGroup: set["Requirement"] = None, camel_requirement_RequirementGroup400: set["requirement_camel_Application"] = None, Requirement398: "camel_requirement_RequirementGroup" = None, Requirement: "camel_requirement_RequirementModel" = None):
    ...
    def checkRecursiveness(self, camel_context, camel_r, camel_resources, camel_rg1) :
        # TODO: Implement checkRecursiveness method
        pass

class camel_requirement_SoftRequirement(Requirement):

    def __init__(self, priority: float, Requirement398: "camel_requirement_RequirementGroup" = None, Requirement: "camel_requirement_RequirementModel" = None):
...
class camel_provider_AttributeConstraint:
    ...
    def __init__(self, name: str, camel_provider_AttributeConstraint354: "Attribute" = None, camel_provider_AttributeConstraint357: "SingleValue" = None, camel_provider_AttributeConstraint360: "SingleValue" = None, camel_provider_AttributeConstraint: "Attribute" = None):
        self.name = name
...
class camel_provider_Attribute:
    ...
    def checkValue(self, camel_v, camel_diff) :
...
class camel_organisation_RoleAssignment:
    ...
    def checkStartEndDates(self, camel_this) :
        # TODO: Implement checkStartEndDates method
        pass

    def checkAssignedOnDates(self, camel_this) :
...
class camel_organisation_CloudProvider(Organisation):
    ...
    def __init__(self, public: bool, SaaS: bool, PaaS: bool, IaaS: bool, camel_organisation_CloudProvider: "ProviderModel" = None, camel_organisation_CloudProvider315: set["SecurityCapability"] = None, Organisation: "camel_organisation_OrganisationModel" = None):
        self.public = public
        self.SaaS = SaaS
        self.PaaS = PaaS
        self.IaaS = IaaS
...
class camel_organisation_ServiceResourceFilter(ResourceFilter):
    ...
    def __init__(self, serviceURL: str, everyService: bool, ResourceFilter332: "camel_organisation_Permission" = None, ResourceFilter: "camel_organisation_OrganisationModel" = None):
...
class camel_organisation_InformationResourceFilter(ResourceFilter):
    ...
    def __init__(self, informationResourcePath: str, everyInformationResource: bool, ResourceFilter332: "camel_organisation_Permission" = None, ResourceFilter: "camel_organisation_OrganisationModel" = None):
        self.informationResourcePath = informationResourcePath
        self.everyInformationResource = everyInformationResource
        
        pass
    @property
    def informationResourcePath(self):
    ...
    @property
    def everyInformationResource(self):
...
class camel_metric_Window:
    ...
    def __init__(self, timeSize: str, name: str, windowType: str, sizeType: str, measurementSize: str, camel_metric_Window: "TimeIntervalUnit" = None):
...
class camel_metric_ConditionContext(ABC):
    ...
    def __init__(self, name: str, quantifier: str, minQuantity: float, maxQuantity: float, isRelative: bool, camel_metric_ConditionContext: "Component" = None, camel_metric_ConditionContext245: "metric_camel_Application" = None):
        self.name = name
...
class camel_metric_Schedule:
    ...
    def __init__(self, name: str, start: date, end: date, type: str, repetitions: int, interval: str, camel_metric_Schedule: "TimeIntervalUnit" = None):
        self.name = name
        self.start = start
        self.end = end
        self.type = type
    ...
    def checkIntervalRepetitions(self, camel_s) :
...
class camel_type_StringValueType(ValueType):
    ...
    def __init__(self, primitiveType: str, ValueType: "camel_metric_Metric" = None, ValueType522: "camel_type_TypeModel" = None, ValueType534: "camel_type_List" = None, ValueType350: "camel_provider_Attribute" = None):
...
class camel_type_Range(ValueType):
    ...
    def __init__(self, primitiveType: str, camel_type_Range537: "Limit" = None, camel_type_Range: "Limit" = None, ValueType: "camel_metric_Metric" = None, ValueType522: "camel_type_TypeModel" = None, ValueType534: "camel_type_List" = None, ValueType350: "camel_provider_Attribute" = None):
        self.primitiveType = primitiveType
    ...
    def checkType(self, camel_type, camel_lower, camel_l) :
        # TODO: Implement checkType method
        pass

    def includesValue(self, camel_n) :
        # TODO: Implement includesValue method
        pass

class camel_type_Enumeration(ValueType):

    def __init__(self, camel_type_Enumeration: set["EnumerateValue"] = None, ValueType: "camel_metric_Metric" = None, ValueType522: "camel_type_TypeModel" = None, ValueType534: "camel_type_List" = None, ValueType350: "camel_provider_Attribute" = None):
    ...
    def includesValue(self, camel_value) :
        # TODO: Implement includesValue method
        pass

    def includesName(self, camel_name) :
        # TODO: Implement includesName method
        pass

class camel_type_RangeUnion(ValueType):

    def __init__(self, primitiveType: str, camel_type_RangeUnion: set["Range"] = None, ValueType: "camel_metric_Metric" = None, ValueType522: "camel_type_TypeModel" = None, ValueType534: "camel_type_List" = None, ValueType350: "camel_provider_Attribute" = None):
        self.primitiveType = primitiveType
    ...
    def invalidRangeSequence(self, camel_ru) :
...
class camel_type_List(ValueType):
    ...
    def __init__(self, primitiveType: str, camel_type_List: set["SingleValue"] = None, camel_type_List533: "ValueType" = None, ValueType: "camel_metric_Metric" = None, ValueType522: "camel_type_TypeModel" = None, ValueType534: "camel_type_List" = None, ValueType350: "camel_provider_Attribute" = None):
        self.primitiveType = primitiveType
    ...
    def checkValueType(self, camel_p) :
        # TODO: Implement checkValueType method
        pass

    def includesValue(self, camel_v) :
        # TODO: Implement includesValue method
        pass
...
class camel_metric_Metric(MetricFormulaParameter):
    ...
    def __init__(self, description: str, valueDirection: str, layer: str, isVariable: bool, camel_metric_Metric: "ValueType" = None, camel_metric_Metric221: "Unit" = None, camel_metric_Metric223: "Property" = None, MetricFormulaParameter269: "camel_metric_MetricModel" = None, MetricFormulaParameter: "camel_metric_MetricFormula" = None):
        self.description = description
    ...
    def checkRecursiveness(self, camel_mt1, camel_mt2) :
        # TODO: Implement checkRecursiveness method
        pass

class camel_metric_MetricFormula(MetricFormulaParameter):

    def __init__(self, function: str, functionArity: str, functionPattern: str, camel_metric_MetricFormula: set["MetricFormulaParameter"] = None, MetricFormulaParameter269: "camel_metric_MetricModel" = None, MetricFormulaParameter: "camel_metric_MetricFormula" = None):
    ...
    def containsMetric(self, camel_m) :
...
class camel_metric_CompositeMetric(Metric):
    ...
    def __init__(self, camel_metric_CompositeMetric: "MetricFormula" = None, Metric: "camel_metric_MetricInstance" = None, Metric404: "camel_requirement_OptimisationRequirement" = None, Metric249: "camel_metric_MetricModel" = None, Metric277: "camel_metric_MetricContext" = None):
    ...
    def greaterEqualThanLayer(self, camel_l1, camel_l2) :
        # TODO: Implement greaterEqualThanLayer method
        pass

class camel_metric_MetricInstance(ABC):

    def __init__(self, name: str, camel_metric_MetricInstance205: "Schedule" = None, camel_metric_MetricInstance207: "Window" = None, camel_metric_MetricInstance209: "MetricObjectBinding" = None, camel_metric_MetricInstance211: "MetricContext" = None, camel_metric_MetricInstance: "Metric" = None):
        self.name = name
    ...
    def checkRecursiveness(self, camel_m1, camel_m2) :
        # TODO: Implement checkRecursiveness method
        pass
...
class camel_location_CloudLocation(Location):
    ...
    def __init__(self, isAssignable: bool, camel_location_CloudLocation: set["CloudLocation"] = None, camel_location_CloudLocation189: "CloudLocation" = None, camel_location_CloudLocation192: "GeographicalRegion" = None, Location: "camel_organisation_DataCenter" = None, Location427: "camel_requirement_LocationRequirement" = None):
    ...
    def checkRecursiveness(self, camel_cl2, camel_cl1) :
        # TODO: Implement checkRecursiveness method
        pass
...
class camel_location_GeographicalRegion(Location):
    ...
    def __init__(self, name: str, alternativeNames: str, camel_location_GeographicalRegion: set["GeographicalRegion"] = None, Location: "camel_organisation_DataCenter" = None, Location427: "camel_requirement_LocationRequirement" = None):
        self.name = name
...
class camel_execution_ExecutionContext:
    ...
    def __init__(self, endTime: date, totalCost: float, name: str, startTime: date, camel_execution_ExecutionContext137: "MonetaryUnit" = None, camel_execution_ExecutionContext139: "DeploymentModel" = None, camel_execution_ExecutionContext142: "RequirementGroup" = None, camel_execution_ExecutionContext: "execution_camel_Application" = None):
        self.endTime = endTime
...
class camel_execution_ActionRealisation:
    ...
    def __init__(self, name: str, startTime: date, endTime: date, lowLevelActions: str, camel_execution_ActionRealisation: "execution_camel_Action" = None):
        self.name = name
        self.startTime = startTime
        self.endTime = endTime
...
class camel_type_EnumerateValue(SingleValue):
    ...
    def __init__(self, name: str, value: int, SingleValue525: "camel_type_TypeModel" = None, SingleValue361: "camel_provider_AttributeConstraint" = None, SingleValue347: "camel_provider_Attribute" = None, SingleValue: "camel_deployment_VMInstance" = None, SingleValue217: "camel_metric_MetricFormulaParameter" = None, SingleValue531: "camel_type_List" = None, SingleValue358: "camel_provider_AttributeConstraint" = None):
        self.name = name
        self.value = value
...
class camel_type_BoolValue(SingleValue):
    ...
    def __init__(self, value: bool, SingleValue525: "camel_type_TypeModel" = None, SingleValue361: "camel_provider_AttributeConstraint" = None, SingleValue347: "camel_provider_Attribute" = None, SingleValue: "camel_deployment_VMInstance" = None, SingleValue217: "camel_metric_MetricFormulaParameter" = None, SingleValue531: "camel_type_List" = None, SingleValue358: "camel_provider_AttributeConstraint" = None):
        self.value = value
...
class camel_type_StringsValue(SingleValue):
    ...
    def __init__(self, value: str, SingleValue525: "camel_type_TypeModel" = None, SingleValue361: "camel_provider_AttributeConstraint" = None, SingleValue347: "camel_provider_Attribute" = None, SingleValue: "camel_deployment_VMInstance" = None, SingleValue217: "camel_metric_MetricFormulaParameter" = None, SingleValue531: "camel_type_List" = None, SingleValue358: "camel_provider_AttributeConstraint" = None):
        self.value = value
...
class camel_deployment_RequiredCommunication(CommunicationPort):
    ...
    def __init__(self, isMandatory: bool, CommunicationPort: "camel_deployment_CommunicationPortInstance" = None):
...
class camel_Model(ABC):
    ...
    def __init__(self, importURI: str, name: str):
...
class camel_deployment_VMInstance(ComponentInstance):
    ...
    def __init__(self, ip: str, camel_deployment_VMInstance: "Attribute" = None, camel_deployment_VMInstance104: "SingleValue" = None, ComponentInstance: "camel_metric_MetricComponentBinding" = None):
        self.ip = ip
...
class camel_deployment_VMRequirementSet:
    ...
    def __init__(self, name: str, camel_deployment_VMRequirementSet65: "ProviderRequirement" = None, camel_deployment_VMRequirementSet67: "QualitativeHardwareRequirement" = None, camel_deployment_VMRequirementSet69: "QuantitativeHardwareRequirement" = None, camel_deployment_VMRequirementSet71: "OSOrImageRequirement" = None, camel_deployment_VMRequirementSet: "LocationRequirement" = None):
        self.name = name
...
class camel_deployment_InternalComponent(Component):
    ...
    def __init__(self, version: str, camel_deployment_InternalComponent: set["InternalComponent"] = None, camel_deployment_InternalComponent58: set["RequiredCommunication"] = None, camel_deployment_InternalComponent60: "RequiredHost" = None, Component413: "camel_requirement_OptimisationRequirement" = None, Component: "camel_deployment_ComponentInstance" = None, Component243: "camel_metric_ConditionContext" = None):
        self.version = version
    ...
    def contains(self, camel_rc, camel_ic) :
...
class camel_deployment_Communication(DeploymentElement):
    ...
    def __init__(self, type: str, camel_deployment_Communication: "ProvidedCommunication" = None, camel_deployment_Communication75: "RequiredCommunication" = None, camel_deployment_Communication78: "Configuration" = None, camel_deployment_Communication81: "Configuration" = None):
        self.type = type
...
class camel_requirement_OSRequirement(OSOrImageRequirement):
    ...
    def __init__(self, os: str, is64os: bool, OSOrImageRequirement: "camel_deployment_VMRequirementSet" = None):
        self.os = os
        self.is64os = is64os
...
class camel_requirement_ImageRequirement(OSOrImageRequirement):
    ...
    def __init__(self, imageId: str, OSOrImageRequirement: "camel_deployment_VMRequirementSet" = None):
...
class camel_organisation_User(Entity):
    ...
    def __init__(self, name: str, email: str, firstName: str, lastName: str, www: str, camel_organisation_User324: set["DeploymentModel"] = None, camel_organisation_User327: "PaaSageCredentials" = None, camel_organisation_User: set["ExternalIdentifier"] = None, camel_organisation_User319: set["RequirementModel"] = None, camel_organisation_User322: set["CloudCredentials"] = None, Entity: "camel_Application" = None, Entity467: "camel_scalability_ScalabilityRule" = None):
        self.name = name
        self.email = email
...
class camel_organisation_Organisation(Entity):
    ...
    def __init__(self, name: str, www: str, postalAddress: str, email: str, Entity: "camel_Application" = None, Entity467: "camel_scalability_ScalabilityRule" = None):
        self.name = name
        self.www = www
