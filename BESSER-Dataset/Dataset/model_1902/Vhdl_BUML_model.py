...
# Classes
vhdl_ContextItem = Class(name="vhdl_ContextItem")
vhdl_LibraryUnit = Class(name="vhdl_LibraryUnit")
vhdl_UseClause = Class(name="vhdl_UseClause")
ContextItem = Class(name="ContextItem")
vhdl_Library = Class(name="vhdl_Library")
vhdl_LibraryClause = Class(name="vhdl_LibraryClause")
vhdl_Package = Class(name="vhdl_Package")
LibraryUnit = Class(name="LibraryUnit")
vhdl_package_declarative_item = Class(name="vhdl_package_declarative_item")
vhdl_package_declarative_part = Class(name="vhdl_package_declarative_part")
vhdl_Architecture = Class(name="vhdl_Architecture")
vhdl_Entity = Class(name="vhdl_Entity")
vhdl_BlockDeclarativeItem = Class(name="vhdl_BlockDeclarativeItem")
vhdl_ArchitectureStatement = Class(name="vhdl_ArchitectureStatement")
vhdl_DesignFile = Class(name="vhdl_DesignFile")
vhdl_Expression = Class(name="vhdl_Expression")
vhdl_Generic = Class(name="vhdl_Generic")
vhdl_Alias = Class(name="vhdl_Alias")
BlockDeclarativeItem = Class(name="BlockDeclarativeItem")
vhdl_SignalDeclaration = Class(name="vhdl_SignalDeclaration")
package_declarative_item = Class(name="package_declarative_item")
vhdl_Signal = Class(name="vhdl_Signal")
vhdl_VariableDeclaration = Class(name="vhdl_VariableDeclaration")
vhdl_Var = Class(name="vhdl_Var")
vhdl_Generics = Class(name="vhdl_Generics")
vhdl_Ports = Class(name="vhdl_Ports")
vhdl_Port = Class(name="vhdl_Port")
Variable = Class(name="Variable")
vhdl_SubtypeIndication = Class(name="vhdl_SubtypeIndication")
vhdl_AttributeSpecification = Class(name="vhdl_AttributeSpecification")
vhdl_Component = Class(name="vhdl_Component")
vhdl_ProcessStatement = Class(name="vhdl_ProcessStatement")
ArchitectureStatement = Class(name="ArchitectureStatement")
vhdl_IdList = Class(name="vhdl_IdList")
vhdl_SequentialStatement = Class(name="vhdl_SequentialStatement")
vhdl_ComponentInstantiationStatement = Class(name="vhdl_ComponentInstantiationStatement")
vhdl_GenericMap = Class(name="vhdl_GenericMap")
vhdl_PortMap = Class(name="vhdl_PortMap")
vhdl_EntityInstantiationStatement = Class(name="vhdl_EntityInstantiationStatement")
vhdl_ConstantDeclaration = Class(name="vhdl_ConstantDeclaration")
vhdl_Constant = Class(name="vhdl_Constant")
vhdl_AttributeDeclaration = Class(name="vhdl_AttributeDeclaration")
vhdl_ConditionalSignalAssignmentStatement = Class(name="vhdl_ConditionalSignalAssignmentStatement")
vhdl_ForGenerateStatement = Class(name="vhdl_ForGenerateStatement")
vhdl_LoopVariable = Class(name="vhdl_LoopVariable")
vhdl_IfGenerateStatement = Class(name="vhdl_IfGenerateStatement")
vhdl_WaitStatement = Class(name="vhdl_WaitStatement")
SequentialStatement = Class(name="SequentialStatement")
vhdl_PortMapAssociation = Class(name="vhdl_PortMapAssociation")
vhdl_GenericMapAssociation = Class(name="vhdl_GenericMapAssociation")
vhdl_CaseStatement = Class(name="vhdl_CaseStatement")
vhdl_CaseAlternative = Class(name="vhdl_CaseAlternative")
vhdl_LoopStatement = Class(name="vhdl_LoopStatement")
vhdl_SequentialSignalAssignmentStatement = Class(name="vhdl_SequentialSignalAssignmentStatement")
vhdl_IterationScheme = Class(name="vhdl_IterationScheme")
vhdl_WhileIterationScheme = Class(name="vhdl_WhileIterationScheme")
IterationScheme = Class(name="IterationScheme")
vhdl_ForIterationScheme = Class(name="vhdl_ForIterationScheme")
vhdl_IfStatement = Class(name="vhdl_IfStatement")
vhdl_IfStatementTest = Class(name="vhdl_IfStatementTest")
Expression = Class(name="Expression")
vhdl_SubtypeDeclaration = Class(name="vhdl_SubtypeDeclaration")
Type = Class(name="Type")
vhdl_TypeDeclaration = Class(name="vhdl_TypeDeclaration")
vhdl_TypeDefinition = Class(name="vhdl_TypeDefinition")
vhdl_AccessTypeDefinition = Class(name="vhdl_AccessTypeDefinition")
TypeDefinition = Class(name="TypeDefinition")
vhdl_CompositeTypeDefinition = Class(name="vhdl_CompositeTypeDefinition")
vhdl_Type = Class(name="vhdl_Type")
vhdl_EnumerationTypeDefinition = Class(name="vhdl_EnumerationTypeDefinition")
vhdl_FileTypeDefinition = Class(name="vhdl_FileTypeDefinition")
vhdl_RecordField = Class(name="vhdl_RecordField")
vhdl_RecordTypeDefinition = Class(name="vhdl_RecordTypeDefinition")
vhdl_Variable = Class(name="vhdl_Variable")
vhdl_ArrayTypeDefinition = Class(name="vhdl_ArrayTypeDefinition")
CompositeTypeDefinition = Class(name="CompositeTypeDefinition")
vhdl_UnconstrainedArrayTypeDefinition = Class(name="vhdl_UnconstrainedArrayTypeDefinition")
ArrayTypeDefinition = Class(name="ArrayTypeDefinition")
vhdl_ConstrainedArrayTypeDefinition = Class(name="vhdl_ConstrainedArrayTypeDefinition")
vhdl_ValueExpression = Class(name="vhdl_ValueExpression")
vhdl_RangeExpression = Class(name="vhdl_RangeExpression")
vhdl_MultiExpression = Class(name="vhdl_MultiExpression")
vhdl_LogicalExpression = Class(name="vhdl_LogicalExpression")
vhdl_RelationalExpression = Class(name="vhdl_RelationalExpression")
vhdl_ConditionalWaveformExpression = Class(name="vhdl_ConditionalWaveformExpression")
vhdl_ShiftExpression = Class(name="vhdl_ShiftExpression")
vhdl_AddingExpression = Class(name="vhdl_AddingExpression")
vhdl_MultiplyingExpression = Class(name="vhdl_MultiplyingExpression")
vhdl_Factor = Class(name="vhdl_Factor")
vhdl_MemberExpression = Class(name="vhdl_MemberExpression")
vhdl_ChoiceExpression = Class(name="vhdl_ChoiceExpression")
vhdl_SliceExpression = Class(name="vhdl_SliceExpression")
vhdl_Value = Class(name="vhdl_Value")
vhdl_BuiltinFuncs = Class(name="vhdl_BuiltinFuncs")
vhdl_Boolean = Class(name="vhdl_Boolean")
vhdl_String = Class(name="vhdl_String")
vhdl_Char = Class(name="vhdl_Char")
vhdl_BitString = Class(name="vhdl_BitString")
vhdl_Others = Class(name="vhdl_Others")
vhdl_Open = Class(name="vhdl_Open")
vhdl_Member = Class(name="vhdl_Member")
vhdl_UnitValueExpression = Class(name="vhdl_UnitValueExpression")
...
vhdl_AttributeSpecification_class_: Property = Property(name="class_", type=StringType)
vhdl_AttributeSpecification.attributes={vhdl_AttributeSpecification_name, vhdl_AttributeSpecification_entity, vhdl_AttributeSpecification_class_}
...
vhdl_AttributeDeclaration.attributes={vhdl_AttributeDeclaration_type_id, vhdl_AttributeDeclaration_name, vhdl_AttributeDeclaration_type_keyword}
...
vhdl_ConditionalSignalAssignmentStatement.attributes={vhdl_ConditionalSignalAssignmentStatement_guarded, vhdl_ConditionalSignalAssignmentStatement_postponed}
...
vhdl_SequentialSignalAssignmentStatement.attributes={vhdl_SequentialSignalAssignmentStatement_label, vhdl_SequentialSignalAssignmentStatement_postponed, vhdl_SequentialSignalAssignmentStatement_guarded}
...
vhdl_Type.attributes={vhdl_Type_name, vhdl_Type_value}
...
vhdl_RangeExpression.attributes={vhdl_RangeExpression_direction, vhdl_RangeExpression_operator}
...
is_34: BinaryAssociation = BinaryAssociation(
    name="is_34",
    ends={
...
is_58: BinaryAssociation = BinaryAssociation(
    name="is_58",
    ends={
...
is_176: BinaryAssociation = BinaryAssociation(
    name="is_176",
    ends={
...
domain_model = DomainModel(
    name="vhdl",
    types={vhdl_ContextItem, vhdl_LibraryUnit, vhdl_UseClause, ContextItem, vhdl_Library, vhdl_LibraryClause, vhdl_Package, LibraryUnit, vhdl_package_declarative_item, vhdl_package_declarative_part, vhdl_Architecture, vhdl_Entity, vhdl_BlockDeclarativeItem, vhdl_ArchitectureStatement, vhdl_DesignFile, vhdl_Expression, vhdl_Generic, vhdl_Alias, BlockDeclarativeItem, vhdl_SignalDeclaration, package_declarative_item, vhdl_Signal, vhdl_VariableDeclaration, vhdl_Var, vhdl_Generics, vhdl_Ports, vhdl_Port, Variable, vhdl_SubtypeIndication, vhdl_AttributeSpecification, vhdl_Component, vhdl_ProcessStatement, ArchitectureStatement, vhdl_IdList, vhdl_SequentialStatement, vhdl_ComponentInstantiationStatement, vhdl_GenericMap, vhdl_PortMap, vhdl_EntityInstantiationStatement, vhdl_ConstantDeclaration, vhdl_Constant, vhdl_AttributeDeclaration, vhdl_ConditionalSignalAssignmentStatement, vhdl_ForGenerateStatement, vhdl_LoopVariable, vhdl_IfGenerateStatement, vhdl_WaitStatement, SequentialStatement, vhdl_PortMapAssociation, vhdl_GenericMapAssociation, vhdl_CaseStatement, vhdl_CaseAlternative, vhdl_LoopStatement, vhdl_SequentialSignalAssignmentStatement, vhdl_IterationScheme, vhdl_WhileIterationScheme, IterationScheme, vhdl_ForIterationScheme, vhdl_IfStatement, vhdl_IfStatementTest, Expression, vhdl_SubtypeDeclaration, Type, vhdl_TypeDeclaration, vhdl_TypeDefinition, vhdl_AccessTypeDefinition, TypeDefinition, vhdl_CompositeTypeDefinition, vhdl_Type, vhdl_EnumerationTypeDefinition, vhdl_FileTypeDefinition, vhdl_RecordField, vhdl_RecordTypeDefinition, vhdl_Variable, vhdl_ArrayTypeDefinition, CompositeTypeDefinition, vhdl_UnconstrainedArrayTypeDefinition, ArrayTypeDefinition, vhdl_ConstrainedArrayTypeDefinition, vhdl_ValueExpression, vhdl_RangeExpression, vhdl_MultiExpression, vhdl_LogicalExpression, vhdl_RelationalExpression, vhdl_ConditionalWaveformExpression, vhdl_ShiftExpression, vhdl_AddingExpression, vhdl_MultiplyingExpression, vhdl_Factor, vhdl_MemberExpression, vhdl_ChoiceExpression, vhdl_SliceExpression, vhdl_Value, vhdl_BuiltinFuncs, vhdl_Boolean, vhdl_String, vhdl_Char, vhdl_BitString, vhdl_Others, vhdl_Open, vhdl_Member, vhdl_UnitValueExpression, ValueExpression, BuiltinLibs, EString, ShiftOperator, RelationalOperator, LogicalOperator, AddingOperator, Sign, Purity, SignalKind, RangeDirection, Mode, UnaryOperator, MultiplyingOperator, EntityClass},
    associations={ContextItems0, LibraryUnits1, lib3, custom_lib4, package_declarative_item6, package_declarative_item7, entity9, declaration10, statement12, initial22, declaration24, type26, initial29, alias32, is_34, sig37, type38, initial41, var44, type45, initial48, generics14, ports16, declaration18, type20, is_58, generic60, port62, sensitivity65, statement66, genericMap68, portMap69, lib71, genericMap73, portMap76, constant51, type52, initial55, actual86, target89, waveform91, waveform95, exp98, after101, expression104, var106, range107, declaration110, statement113, condition116, declaration118, statement121, association79, actual81, association84, condition136, statement139, case142, when144, choice146, statement149, var152, range154, statements157, target160, waveform162, condition165, sensitivity124, until126, time129, test132, statement133, type174, is_176, type177, in_167, custom_type169, constraint171, constraint181, field183, type184, value188, id189, type179, left194, right196, left199, right201, choice192, right211, left214, right216, left219, right221, left224, right226, left229, left204, right231, left234, right206, left209, member239, slice241, left244, slice246, value249, right236},
    generalizations={gen_vhdl_UseClause_ContextItem, gen_vhdl_LibraryClause_ContextItem, gen_vhdl_Package_LibraryUnit, gen_vhdl_Architecture_LibraryUnit, gen_vhdl_Entity_LibraryUnit, gen_vhdl_Generic_Variable, gen_vhdl_Alias_BlockDeclarativeItem, gen_vhdl_Alias_Variable, gen_vhdl_SignalDeclaration_package_declarative_item, gen_vhdl_SignalDeclaration_BlockDeclarativeItem, gen_vhdl_Signal_Variable, gen_vhdl_VariableDeclaration_package_declarative_item, gen_vhdl_VariableDeclaration_BlockDeclarativeItem, gen_vhdl_Var_Variable, gen_vhdl_Port_Variable, gen_vhdl_AttributeSpecification_BlockDeclarativeItem, gen_vhdl_Component_package_declarative_item, gen_vhdl_Component_BlockDeclarativeItem, gen_vhdl_ProcessStatement_ArchitectureStatement, gen_vhdl_ComponentInstantiationStatement_ArchitectureStatement, gen_vhdl_EntityInstantiationStatement_ArchitectureStatement, gen_vhdl_ConstantDeclaration_package_declarative_item, gen_vhdl_ConstantDeclaration_BlockDeclarativeItem, gen_vhdl_Constant_Variable, gen_vhdl_AttributeDeclaration_BlockDeclarativeItem, gen_vhdl_ConditionalSignalAssignmentStatement_ArchitectureStatement, gen_vhdl_ForGenerateStatement_ArchitectureStatement, gen_vhdl_IfGenerateStatement_ArchitectureStatement, gen_vhdl_CaseStatement_SequentialStatement, gen_vhdl_LoopVariable_Variable, gen_vhdl_LoopStatement_SequentialStatement, gen_vhdl_SequentialSignalAssignmentStatement_SequentialStatement, gen_vhdl_WhileIterationScheme_IterationScheme, gen_vhdl_ForIterationScheme_IterationScheme, gen_vhdl_WaitStatement_SequentialStatement, gen_vhdl_IfStatement_SequentialStatement, gen_vhdl_Type_package_declarative_item, gen_vhdl_Type_BlockDeclarativeItem, gen_vhdl_Type_Expression, gen_vhdl_SubtypeDeclaration_Type, gen_vhdl_TypeDeclaration_Type, gen_vhdl_AccessTypeDefinition_TypeDefinition, gen_vhdl_CompositeTypeDefinition_TypeDefinition, gen_vhdl_EnumerationTypeDefinition_TypeDefinition, gen_vhdl_FileTypeDefinition_TypeDefinition, gen_vhdl_RecordTypeDefinition_CompositeTypeDefinition, gen_vhdl_Variable_Expression, gen_vhdl_ArrayTypeDefinition_CompositeTypeDefinition, gen_vhdl_UnconstrainedArrayTypeDefinition_ArrayTypeDefinition, gen_vhdl_ConstrainedArrayTypeDefinition_ArrayTypeDefinition, gen_vhdl_RangeExpression_Expression, gen_vhdl_MultiExpression_Expression, gen_vhdl_LogicalExpression_Expression, gen_vhdl_RelationalExpression_Expression, gen_vhdl_ConditionalWaveformExpression_Expression, gen_vhdl_ShiftExpression_Expression, gen_vhdl_AddingExpression_Expression, gen_vhdl_MultiplyingExpression_Expression, gen_vhdl_Factor_Expression, gen_vhdl_MemberExpression_Expression, gen_vhdl_ChoiceExpression_Expression, gen_vhdl_SliceExpression_Expression, gen_vhdl_Value_Expression, gen_vhdl_BuiltinFuncs_Expression, gen_vhdl_Boolean_Expression, gen_vhdl_String_Expression, gen_vhdl_Char_Expression, gen_vhdl_BitString_Expression, gen_vhdl_Others_Expression, gen_vhdl_Open_Expression, gen_vhdl_Member_Expression, gen_vhdl_UnitValueExpression_ValueExpression},
    metadata=None
)
