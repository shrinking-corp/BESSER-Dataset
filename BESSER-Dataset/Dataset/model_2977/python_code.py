...
class robochart_Connection:
    ...
    def __init__(self, async_: bool, bidirec: bool, robochart_Connection: "robochart_ControllerDef" = None, robochart_Connection135: "robochart_ConnectionNode" = None, robochart_Connection137: "robochart_ConnectionNode" = None, robochart_Connection140: "robochart_Event" = None, robochart_Connection143: "robochart_Event" = None, robochart_Connection149: "robochart_RCModule" = None):
        self.async_ = async_
...
class Member:
    ...
    pass
class robochart_Variable(NamedExpression, Member, TypedNamedElement):

    def __init__(self, modifier: str, robochart_Variable110: "robochart_Trigger" = None, robochart_Variable37: "robochart_Expression" = None, robochart_Variable: "robochart_VariableList" = None, robochart_Variable212: "robochart_LambdaExp" = None, robochart_Variable204: "robochart_QuantifierExpression" = None, robochart_Variable116: "robochart_Trigger" = None, robochart_Variable122: "robochart_Trigger" = None, robochart_Variable274: "robochart_SetComp" = None, robochart_Variable250: "robochart_VarExp" = None, robochart_Variable309: "robochart_VarRef" = None):
        self.modifier = modifier
...
class TypeDecl:
    ...
    pass
class robochart_Literal(NamedExpression, TypeDecl):
...
class robochart_OperationSig(NamedElement):
    ...
    def __init__(self, terminates: bool, robochart_OperationSig51: set["robochart_Expression"] = None, robochart_OperationSig54: set["robochart_Expression"] = None, robochart_OperationSig: set["robochart_Parameter"] = None, robochart_OperationSig62: "robochart_BasicContext" = None, robochart_OperationSig182: "robochart_Call" = None):
...
class robochart_Event(NamedElement):
    ...
    def __init__(self, broadcast: bool, robochart_Event107: "robochart_Trigger" = None, robochart_Event: "robochart_Type" = None, robochart_Event65: "robochart_BasicContext" = None, robochart_Event141: "robochart_Connection" = None, robochart_Event144: "robochart_Connection" = None):
...
class robochart_Function(NamedExpression, TypedNamedElement):
    ...
    pass
class robochart_OperationDef(Operation, StateMachineBody, OperationSig):
...
class robochart_RangeExp(Expression):
    ...
    def __init__(self, linterval: str, rinterval: str, robochart_RangeExp: "robochart_Expression" = None, robochart_RangeExp291: "robochart_Expression" = None):
