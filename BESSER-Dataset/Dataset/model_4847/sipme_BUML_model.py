...
# Classes
sipme_Application = Class(name="sipme_Application")
EnterpriseResource = Class(name="EnterpriseResource")
sipme_Domain = Class(name="sipme_Domain")
sipme_BusinessRules = Class(name="sipme_BusinessRules")
EnterpriseObject = Class(name="EnterpriseObject")
sipme_EnterpriseObject = Class(name="sipme_EnterpriseObject", is_abstract=True)
sipme_Capability = Class(name="sipme_Capability")
sipme_Capacity = Class(name="sipme_Capacity")
sipme_Activity = Class(name="sipme_Activity")
EnterpriseProcessor = Class(name="EnterpriseProcessor")
sipme_Task = Class(name="sipme_Task")
sipme_BusinessProcess = Class(name="sipme_BusinessProcess")
sipme_Device_Machine = Class(name="sipme_Device_Machine")
SIPME_object = Class(name="SIPME_object")
OrganisationCell = Class(name="OrganisationCell")
sipme_Enterprise = Class(name="sipme_Enterprise")
sipme_CompanyMember = Class(name="sipme_CompanyMember")
Stakeholder = Class(name="Stakeholder")
sipme_Workstation = Class(name="sipme_Workstation")
sipme_OrganisationCell = Class(name="sipme_OrganisationCell")
sipme_ObjectsFileView = Class(name="sipme_ObjectsFileView")
sipme_ObjectView = Class(name="sipme_ObjectView")
sipme_EnterpriseProcessor = Class(name="sipme_EnterpriseProcessor", is_abstract=True)
sipme_Event = Class(name="sipme_Event")
sipme_Objective = Class(name="sipme_Objective")
sipme_EnterpriseService = Class(name="sipme_EnterpriseService")
sipme_EnterpriseProduct = Class(name="sipme_EnterpriseProduct")
sipme_Role_Function = Class(name="sipme_Role_Function")
sipme_EnterpriseResource = Class(name="sipme_EnterpriseResource", is_abstract=True)
ObjectView = Class(name="ObjectView")
sipme_Requirement = Class(name="sipme_Requirement")
sipme_Stakeholder = Class(name="sipme_Stakeholder", is_abstract=True)
sipme_SIPME_object = Class(name="sipme_SIPME_object", is_abstract=True)
...
sipme_Domain.attributes={sipme_Domain_performanceIndicators, sipme_Domain_domainCharacterization}
...
sipme_Capacity.attributes={sipme_Capacity_unit, sipme_Capacity_value}
...
sipme_Activity.attributes={sipme_Activity_endingStatus, sipme_Activity_ActivityDuration}
...
sipme_Device_Machine.attributes={sipme_Device_Machine_manufacturer, sipme_Device_Machine_machineMaintainer}
...
sipme_Enterprise.attributes={sipme_Enterprise_acronym, sipme_Enterprise_status}
...
sipme_CompanyMember.attributes={sipme_CompanyMember_address, sipme_CompanyMember_fullName, sipme_CompanyMember_socialSecurityNumber}
...
sipme_ObjectsFileView.attributes={sipme_ObjectsFileView_fileState, sipme_ObjectsFileView_filePriority}
...
sipme_Event.attributes={sipme_Event_occurenceProbability, sipme_Event_source, sipme_Event_frequency, sipme_Event_timeStamp}
...
sipme_Requirement.attributes={sipme_Requirement_requirementStatus, sipme_Requirement_requirementPriority, sipme_Requirement_requirementStatement, sipme_Requirement_requirementDate, sipme_Requirement_requirementNature, sipme_Requirement_requirementOrigin, sipme_Requirement_requirementVersion, sipme_Requirement_requirementMaturity}
...
sipme_Stakeholder.attributes={sipme_Stakeholder_stakeholderOrganism, sipme_Stakeholder_stakeholderType}
...
domain_model = DomainModel(
    name="sipme",
    types={sipme_Application, EnterpriseResource, sipme_Domain, sipme_BusinessRules, EnterpriseObject, sipme_EnterpriseObject, sipme_Capability, sipme_Capacity, sipme_Activity, EnterpriseProcessor, sipme_Task, sipme_BusinessProcess, sipme_Device_Machine, SIPME_object, OrganisationCell, sipme_Enterprise, sipme_CompanyMember, Stakeholder, sipme_Workstation, sipme_OrganisationCell, sipme_ObjectsFileView, sipme_ObjectView, sipme_EnterpriseProcessor, sipme_Event, sipme_Objective, sipme_EnterpriseService, sipme_EnterpriseProduct, sipme_Role_Function, sipme_EnterpriseResource, ObjectView, sipme_Requirement, sipme_Stakeholder, sipme_SIPME_object, RequirementNature, RequirementOrigin, RoleType, ProductState, ServiceState, ProductNature, CapabilityType, EnterpriseObjectiveType, ObjectiveNature, Origin, StakeholderType},
    associations={activities2, businessProcessOf3, considers4, impacts5, defines8, tasks0, activityOf1, businessProcesses14, coveredBy17, induces19, inChargeOf9, responsibleOf10, responsibleOfCell12, responsibleOfFile13, partOf38, representedBy39, decomposedIn41, generates43, providesOutputs44, strategicObjectives22, concerns23, refers26, proposesServices29, proposesProducts31, companyMembers33, organizationCells35, executes60, plays61, isAbleToPlay63, providesCapability65, generatedBy68, initiates69, hasInputs45, initiatedBy48, hasControlInputs50, implements53, hasCapacity54, requiresCapabilities57, represents81, events83, workstations85, covers87, cellResponsible88, assignedTo90, priorTo72, hasAssociatedEvents73, subObjectives76, refines78, takenIntoAccountBy80, concernsResources105, concernsProcessors108, concernsActivity111, requiresTasks113, playedBy115, objectViews92, subFiles95, fileResponsible97, associatedObjective99, expresseCommonlydBy101, refinesRequirement103, respectsTaskRules126, taskOf129, operations132, organisationCell134, responsible136, canBePlayedBy116, implementedBy118, respectsRoleRules120, expresses123, owners138},
    generalizations={gen_sipme_Application_EnterpriseResource, gen_sipme_BusinessProcess_EnterpriseProcessor, gen_sipme_BusinessRules_EnterpriseObject, gen_sipme_Capability_EnterpriseObject, gen_sipme_Activity_EnterpriseProcessor, gen_sipme_Device_Machine_EnterpriseResource, gen_sipme_Domain_SIPME_object, gen_sipme_Domain_EnterpriseProcessor, gen_sipme_Domain_OrganisationCell, gen_sipme_Enterprise_EnterpriseProcessor, gen_sipme_Capacity_EnterpriseObject, gen_sipme_CompanyMember_EnterpriseResource, gen_sipme_CompanyMember_Stakeholder, gen_sipme_EnterpriseObject_SIPME_object, gen_sipme_EnterpriseProcessor_EnterpriseObject, gen_sipme_EnterpriseService_EnterpriseObject, gen_sipme_Event_SIPME_object, gen_sipme_EnterpriseProduct_EnterpriseObject, gen_sipme_EnterpriseResource_EnterpriseObject, gen_sipme_OrganisationCell_EnterpriseProcessor, gen_sipme_ObjectsFileView_ObjectView, gen_sipme_Objective_EnterpriseObject, gen_sipme_ObjectView_SIPME_object, gen_sipme_Role_Function_EnterpriseProcessor, gen_sipme_Requirement_SIPME_object, gen_sipme_Task_EnterpriseProcessor, gen_sipme_Workstation_EnterpriseProcessor, gen_sipme_Stakeholder_SIPME_object},
    metadata=None
)
