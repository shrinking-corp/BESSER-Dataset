...
def test_hyp_stakeholder_is_not_abstract():
    assert not inspect.isabstract(Stakeholder)


def test_hyp_stakeholder_constructor_exists():
    assert callable(Stakeholder.__init__)


def test_hyp_stakeholder_constructor_args():
    sig = inspect.signature(Stakeholder.__init__)
    params = list(sig.parameters.keys())



def test_hyp_organisationcell_is_not_abstract():
    assert not inspect.isabstract(OrganisationCell)


def test_hyp_organisationcell_constructor_exists():
    assert callable(OrganisationCell.__init__)


def test_hyp_organisationcell_constructor_args():
    sig = inspect.signature(OrganisationCell.__init__)
    params = list(sig.parameters.keys())



def test_hyp_sipme_object_is_not_abstract():
    assert not inspect.isabstract(SIPME_object)


def test_hyp_sipme_object_constructor_exists():
    assert callable(SIPME_object.__init__)


def test_hyp_sipme_object_constructor_args():
    sig = inspect.signature(SIPME_object.__init__)
    params = list(sig.parameters.keys())



def test_hyp_sipme_objectview_is_not_abstract():
    assert not inspect.isabstract(sipme_ObjectView)


def test_hyp_sipme_objectview_constructor_exists():
    assert callable(sipme_ObjectView.__init__)


def test_hyp_sipme_objectview_constructor_args():
...
def test_hyp_sipme_event_is_not_abstract():
    assert not inspect.isabstract(sipme_Event)


def test_hyp_sipme_event_constructor_exists():
    assert callable(sipme_Event.__init__)


def test_hyp_sipme_event_constructor_args():
...
def test_hyp_enterpriseprocessor_is_not_abstract():
    assert not inspect.isabstract(EnterpriseProcessor)


def test_hyp_enterpriseprocessor_constructor_exists():
    assert callable(EnterpriseProcessor.__init__)


def test_hyp_enterpriseprocessor_constructor_args():
    sig = inspect.signature(EnterpriseProcessor.__init__)
    params = list(sig.parameters.keys())



def test_hyp_sipme_task_is_not_abstract():
    assert not inspect.isabstract(sipme_Task)


def test_hyp_sipme_task_constructor_exists():
    assert callable(sipme_Task.__init__)


def test_hyp_sipme_task_constructor_args():
...
def test_hyp_sipme_role_function_is_not_abstract():
    assert not inspect.isabstract(sipme_Role_Function)


def test_hyp_sipme_role_function_constructor_exists():
    assert callable(sipme_Role_Function.__init__)


def test_hyp_sipme_role_function_constructor_args():
...
def test_hyp_sipme_businessprocess_is_not_abstract():
    assert not inspect.isabstract(sipme_BusinessProcess)


def test_hyp_sipme_businessprocess_constructor_exists():
    assert callable(sipme_BusinessProcess.__init__)


def test_hyp_sipme_businessprocess_constructor_args():
...
def test_hyp_sipme_workstation_is_not_abstract():
    assert not inspect.isabstract(sipme_Workstation)


def test_hyp_sipme_workstation_constructor_exists():
    assert callable(sipme_Workstation.__init__)


def test_hyp_sipme_workstation_constructor_args():
...
def test_hyp_sipme_organisationcell_is_not_abstract():
    assert not inspect.isabstract(sipme_OrganisationCell)


def test_hyp_sipme_organisationcell_constructor_exists():
    assert callable(sipme_OrganisationCell.__init__)


def test_hyp_sipme_organisationcell_constructor_args():
...
def test_hyp_sipme_enterprise_is_not_abstract():
    assert not inspect.isabstract(sipme_Enterprise)


def test_hyp_sipme_enterprise_constructor_exists():
    assert callable(sipme_Enterprise.__init__)


def test_hyp_sipme_enterprise_constructor_args():
...
def test_hyp_sipme_activity_is_not_abstract():
    assert not inspect.isabstract(sipme_Activity)


def test_hyp_sipme_activity_constructor_exists():
    assert callable(sipme_Activity.__init__)


def test_hyp_sipme_activity_constructor_args():
...
def test_hyp_sipme_enterpriseobject_is_not_abstract():
    assert not inspect.isabstract(sipme_EnterpriseObject)


def test_hyp_sipme_enterpriseobject_constructor_exists():
    assert callable(sipme_EnterpriseObject.__init__)


def test_hyp_sipme_enterpriseobject_constructor_args():
...
def test_hyp_enterpriseobject_is_not_abstract():
    assert not inspect.isabstract(EnterpriseObject)


def test_hyp_enterpriseobject_constructor_exists():
    assert callable(EnterpriseObject.__init__)


def test_hyp_enterpriseobject_constructor_args():
    sig = inspect.signature(EnterpriseObject.__init__)
    params = list(sig.parameters.keys())



def test_hyp_sipme_capacity_is_not_abstract():
    assert not inspect.isabstract(sipme_Capacity)


def test_hyp_sipme_capacity_constructor_exists():
    assert callable(sipme_Capacity.__init__)


def test_hyp_sipme_capacity_constructor_args():
...
def test_hyp_sipme_enterpriseprocessor_is_not_abstract():
    assert not inspect.isabstract(sipme_EnterpriseProcessor)


def test_hyp_sipme_enterpriseprocessor_constructor_exists():
    assert callable(sipme_EnterpriseProcessor.__init__)


def test_hyp_sipme_enterpriseprocessor_constructor_args():
...
def test_hyp_sipme_capability_is_not_abstract():
    assert not inspect.isabstract(sipme_Capability)


def test_hyp_sipme_capability_constructor_exists():
    assert callable(sipme_Capability.__init__)


def test_hyp_sipme_capability_constructor_args():
...
def test_hyp_sipme_enterpriseproduct_is_not_abstract():
    assert not inspect.isabstract(sipme_EnterpriseProduct)


def test_hyp_sipme_enterpriseproduct_constructor_exists():
    assert callable(sipme_EnterpriseProduct.__init__)


def test_hyp_sipme_enterpriseproduct_constructor_args():
...
def test_hyp_sipme_enterpriseservice_is_not_abstract():
    assert not inspect.isabstract(sipme_EnterpriseService)


def test_hyp_sipme_enterpriseservice_constructor_exists():
    assert callable(sipme_EnterpriseService.__init__)


def test_hyp_sipme_enterpriseservice_constructor_args():
...
def test_hyp_sipme_objective_is_not_abstract():
    assert not inspect.isabstract(sipme_Objective)


def test_hyp_sipme_objective_constructor_exists():
    assert callable(sipme_Objective.__init__)


def test_hyp_sipme_objective_constructor_args():
...
def test_hyp_sipme_businessrules_is_not_abstract():
    assert not inspect.isabstract(sipme_BusinessRules)


def test_hyp_sipme_businessrules_constructor_exists():
    assert callable(sipme_BusinessRules.__init__)


def test_hyp_sipme_businessrules_constructor_args():
    sig = inspect.signature(sipme_BusinessRules.__init__)
    params = list(sig.parameters.keys())



def test_hyp_sipme_domain_is_not_abstract():
    assert not inspect.isabstract(sipme_Domain)


def test_hyp_sipme_domain_constructor_exists():
    assert callable(sipme_Domain.__init__)


def test_hyp_sipme_domain_constructor_args():
...
def test_hyp_enterpriseresource_is_not_abstract():
    assert not inspect.isabstract(EnterpriseResource)


def test_hyp_enterpriseresource_constructor_exists():
    assert callable(EnterpriseResource.__init__)


def test_hyp_enterpriseresource_constructor_args():
    sig = inspect.signature(EnterpriseResource.__init__)
    params = list(sig.parameters.keys())



def test_hyp_sipme_device_machine_is_not_abstract():
    assert not inspect.isabstract(sipme_Device_Machine)


def test_hyp_sipme_device_machine_constructor_exists():
    assert callable(sipme_Device_Machine.__init__)


def test_hyp_sipme_device_machine_constructor_args():
...
def test_hyp_sipme_companymember_is_not_abstract():
    assert not inspect.isabstract(sipme_CompanyMember)


def test_hyp_sipme_companymember_constructor_exists():
    assert callable(sipme_CompanyMember.__init__)


def test_hyp_sipme_companymember_constructor_args():
...
def test_hyp_sipme_application_is_not_abstract():
    assert not inspect.isabstract(sipme_Application)


def test_hyp_sipme_application_constructor_exists():
    assert callable(sipme_Application.__init__)


def test_hyp_sipme_application_constructor_args():
...
def test_hyp_sipme_sipme_object_is_not_abstract():
    assert not inspect.isabstract(sipme_SIPME_object)


def test_hyp_sipme_sipme_object_constructor_exists():
    assert callable(sipme_SIPME_object.__init__)


def test_hyp_sipme_sipme_object_constructor_args():
...
def test_hyp_sipme_stakeholder_is_not_abstract():
    assert not inspect.isabstract(sipme_Stakeholder)


def test_hyp_sipme_stakeholder_constructor_exists():
    assert callable(sipme_Stakeholder.__init__)


def test_hyp_sipme_stakeholder_constructor_args():
...
def test_hyp_sipme_requirement_is_not_abstract():
    assert not inspect.isabstract(sipme_Requirement)


def test_hyp_sipme_requirement_constructor_exists():
    assert callable(sipme_Requirement.__init__)


def test_hyp_sipme_requirement_constructor_args():
...
def test_hyp_objectview_is_not_abstract():
    assert not inspect.isabstract(ObjectView)


def test_hyp_objectview_constructor_exists():
    assert callable(ObjectView.__init__)


def test_hyp_objectview_constructor_args():
    sig = inspect.signature(ObjectView.__init__)
    params = list(sig.parameters.keys())



def test_hyp_sipme_objectsfileview_is_not_abstract():
    assert not inspect.isabstract(sipme_ObjectsFileView)


def test_hyp_sipme_objectsfileview_constructor_exists():
    assert callable(sipme_ObjectsFileView.__init__)


def test_hyp_sipme_objectsfileview_constructor_args():
...
def test_hyp_productnature_exists():
    # Check that the Enumeration exists
    assert ProductNature is not None

def test_hyp_productnature_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_productstate_exists():
    # Check that the Enumeration exists
    assert ProductState is not None

def test_hyp_productstate_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_stakeholdertype_exists():
    # Check that the Enumeration exists
    assert StakeholderType is not None

def test_hyp_stakeholdertype_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_requirementnature_exists():
    # Check that the Enumeration exists
    assert RequirementNature is not None

def test_hyp_requirementnature_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_servicestate_exists():
    # Check that the Enumeration exists
    assert ServiceState is not None

def test_hyp_servicestate_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_capabilitytype_exists():
    # Check that the Enumeration exists
    assert CapabilityType is not None

def test_hyp_capabilitytype_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_enterpriseobjectivetype_exists():
    # Check that the Enumeration exists
    assert EnterpriseObjectiveType is not None

def test_hyp_enterpriseobjectivetype_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_sipme_objectview_viewPoint_setter(instance):
...
def test_hyp_sipme_event_frequency_setter(instance):
...
@given(instance=sipme_Event_strategy)
def test_hyp_sipme_event_source_setter(instance):
...
@given(instance=sipme_Event_strategy)
def test_hyp_sipme_event_timeStamp_setter(instance):
...
@given(instance=sipme_Event_strategy)
def test_hyp_sipme_event_occurenceProbability_setter(instance):
...
def test_hyp_sipme_task_taskDuration_setter(instance):
...
def test_hyp_sipme_role_function_roleType_setter(instance):
...
def test_hyp_sipme_businessprocess_ProcessPriority_setter(instance):
...
def test_hyp_sipme_workstation_ProfileDeescription_setter(instance):
...
def test_hyp_sipme_organisationcell_organisationLevel_setter(instance):
...
def test_hyp_sipme_enterprise_status_setter(instance):
...
@given(instance=sipme_Enterprise_strategy)
def test_hyp_sipme_enterprise_acronym_setter(instance):
...
def test_hyp_sipme_activity_endingStatus_setter(instance):
...
@given(instance=sipme_Activity_strategy)
def test_hyp_sipme_activity_ActivityDuration_setter(instance):
...
def test_hyp_sipme_enterpriseobject_properties_setter(instance):
...
@given(instance=sipme_EnterpriseObject_strategy)
def test_hyp_sipme_enterpriseobject_reference_setter(instance):
...
def test_hyp_sipme_capacity_value_setter(instance):
...
@given(instance=sipme_Capacity_strategy)
def test_hyp_sipme_capacity_unit_setter(instance):
...
def test_hyp_sipme_enterpriseprocessor_processorOrigin_setter(instance):
...
def test_hyp_sipme_capability_capabilityType_setter(instance):
...
def test_hyp_sipme_enterpriseproduct_productState_setter(instance):
...
@given(instance=sipme_EnterpriseProduct_strategy)
def test_hyp_sipme_enterpriseproduct_productNarure_setter(instance):
...
def test_hyp_sipme_enterpriseservice_serviceState_setter(instance):
...
def test_hyp_sipme_objective_objectiveNature_setter(instance):
...
@given(instance=sipme_Objective_strategy)
def test_hyp_sipme_objective_objectiveType_setter(instance):
...
def test_hyp_sipme_domain_domainCharacterization_setter(instance):
...
@given(instance=sipme_Domain_strategy)
def test_hyp_sipme_domain_performanceIndicators_setter(instance):
...
def test_hyp_sipme_device_machine_manufacturer_setter(instance):
...
@given(instance=sipme_Device_Machine_strategy)
def test_hyp_sipme_device_machine_machineMaintainer_setter(instance):
...
def test_hyp_sipme_companymember_fullName_setter(instance):
...
@given(instance=sipme_CompanyMember_strategy)
def test_hyp_sipme_companymember_address_setter(instance):
...
@given(instance=sipme_CompanyMember_strategy)
def test_hyp_sipme_companymember_socialSecurityNumber_setter(instance):
...
def test_hyp_sipme_application_applicationEditor_setter(instance):
...
@given(instance=sipme_Application_strategy)
def test_hyp_sipme_application_applicationMaintainer_setter(instance):
...
def test_hyp_sipme_sipme_object_description_setter(instance):
...
@given(instance=sipme_SIPME_object_strategy)
def test_hyp_sipme_sipme_object_UUID_setter(instance):
...
@given(instance=sipme_SIPME_object_strategy)
def test_hyp_sipme_sipme_object_name_setter(instance):
...
def test_hyp_sipme_stakeholder_stakeholderOrganism_setter(instance):
...
@given(instance=sipme_Stakeholder_strategy)
def test_hyp_sipme_stakeholder_stakeholderType_setter(instance):
...
def test_hyp_sipme_requirement_requirementVersion_setter(instance):
...
@given(instance=sipme_Requirement_strategy)
def test_hyp_sipme_requirement_requirementPriority_setter(instance):
...
@given(instance=sipme_Requirement_strategy)
def test_hyp_sipme_requirement_requirementStatus_setter(instance):
...
@given(instance=sipme_Requirement_strategy)
def test_hyp_sipme_requirement_requirementNature_setter(instance):
...
@given(instance=sipme_Requirement_strategy)
def test_hyp_sipme_requirement_requirementOrigin_setter(instance):
...
@given(instance=sipme_Requirement_strategy)
def test_hyp_sipme_requirement_requirementDate_setter(instance):
...
@given(instance=sipme_Requirement_strategy)
def test_hyp_sipme_requirement_requirementMaturity_setter(instance):
...
@given(instance=sipme_Requirement_strategy)
def test_hyp_sipme_requirement_requirementStatement_setter(instance):
...
def test_hyp_sipme_objectsfileview_filePriority_setter(instance):
...
@given(instance=sipme_ObjectsFileView_strategy)
def test_hyp_sipme_objectsfileview_fileState_setter(instance):
...
def test_hyp_sipme_enterpriseresource_resourceOrigin_setter(instance):
