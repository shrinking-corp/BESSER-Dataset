...
class sipme_Requirement(SIPME_object):
    ...
    def __init__(self, requirementVersion: str, requirementDate: date, requirementStatement: str, requirementPriority: int, requirementMaturity: int, requirementStatus: str, requirementOrigin: str, requirementNature: str, Requirement: "sipme_Objective" = None, sipme_Requirement106: set["sipme_EnterpriseResource"] = None, sipme_Requirement109: "sipme_EnterpriseProcessor" = None, sipme_Requirement112: "sipme_Activity" = None, sipme_Requirement125: "sipme_Stakeholder" = None, takenIntoAccountBy: "sipme_Objective" = None, sipme_Requirement: set["sipme_Stakeholder"] = None, sipme_Requirement104: "sipme_Requirement" = None, sipme_Requirement102: set["sipme_Requirement"] = None):
...
class sipme_Stakeholder(SIPME_object):
    ...
    def __init__(self, stakeholderType: str, stakeholderOrganism: str, sipme_Stakeholder124: set["sipme_Requirement"] = None, sipme_Stakeholder: "sipme_Requirement" = None):
...
class sipme_ObjectView(SIPME_object):
    ...
    def __init__(self, viewPoint: str, ObjectView: "sipme_EnterpriseObject" = None, sipme_ObjectView: "sipme_EnterpriseProcessor" = None, sipme_ObjectView47: "sipme_EnterpriseProcessor" = None, hasAssociatedEvents: set["sipme_Event"] = None, ObjectView74: "sipme_Event" = None, sipme_ObjectView93: "sipme_ObjectsFileView" = None, sipme_ObjectView52: "sipme_EnterpriseProcessor" = None, representedBy: "sipme_EnterpriseObject" = None):
...
class sipme_Event(SIPME_object):
    ...
    def __init__(self, occurenceProbability: str, frequency: str, timeStamp: date, source: str, Event: "sipme_EnterpriseProcessor" = None, generates: set["sipme_EnterpriseProcessor"] = None, initiatedBy: set["sipme_EnterpriseProcessor"] = None, Event84: "sipme_ObjectView" = None, sipme_Event: "sipme_Event" = None, sipme_Event71: set["sipme_Event"] = None, events: set["sipme_ObjectView"] = None, Event49: "sipme_EnterpriseProcessor" = None):
...
class sipme_Role_Function(EnterpriseProcessor):
    ...
    def __init__(self, roleType: str, Role_Function62: "sipme_EnterpriseResource" = None, Role_Function64: "sipme_EnterpriseResource" = None, sipme_Role_Function: set["sipme_Task"] = None, plays: set["sipme_EnterpriseResource"] = None, Role_Function: "sipme_EnterpriseProcessor" = None, isAbleToPlay: set["sipme_EnterpriseResource"] = None, implements: set["sipme_EnterpriseProcessor"] = None, sipme_Role_Function121: set["sipme_BusinessRules"] = None):
...
class sipme_BusinessProcess(EnterpriseProcessor):
    ...
    def __init__(self, ProcessPriority: int, BusinessProcess: "sipme_Activity" = None, sipme_BusinessProcess16: "sipme_Domain" = None, activityOf: set["sipme_Activity"] = None, sipme_BusinessProcess: "sipme_Domain" = None):
...
class sipme_Task(EnterpriseProcessor):
    ...
    def __init__(self, taskDuration: int, Task: "sipme_Activity" = None, sipme_Task: "sipme_EnterpriseResource" = None, sipme_Task114: "sipme_Role_Function" = None, sipme_Task133: "sipme_Task" = None, sipme_Task131: set["sipme_Task"] = None, sipme_Task127: "sipme_BusinessRules" = None, tasks: "sipme_Activity" = None):
...
class sipme_Activity(EnterpriseProcessor):
    ...
    def __init__(self, endingStatus: str, ActivityDuration: int, taskOf: set["sipme_Task"] = None, activities: "sipme_BusinessProcess" = None, Activity: "sipme_BusinessProcess" = None, sipme_Activity: "sipme_Requirement" = None, Activity130: "sipme_Task" = None):
...
class sipme_EnterpriseObject(SIPME_object):
    ...
    def __init__(self, reference: str, properties: str, sipme_EnterpriseObject7: "sipme_BusinessRules" = None, EnterpriseObject: "sipme_EnterpriseObject" = None, decomposedIn: "sipme_EnterpriseObject" = None, represents: set["sipme_ObjectView"] = None, EnterpriseObject42: "sipme_EnterpriseObject" = None, partOf: set["sipme_EnterpriseObject"] = None, sipme_EnterpriseObject28: "sipme_Enterprise" = None, sipme_EnterpriseObject: "sipme_BusinessRules" = None, EnterpriseObject82: "sipme_ObjectView" = None):
...
class sipme_EnterpriseProcessor(EnterpriseObject):
    ...
    def __init__(self, processorOrigin: str, generatedBy: set["sipme_Event"] = None, sipme_EnterpriseProcessor: set["sipme_ObjectView"] = None, EnterpriseProcessor: "sipme_Event" = None, EnterpriseProcessor70: "sipme_Event" = None, sipme_EnterpriseProcessor46: set["sipme_ObjectView"] = None, sipme_EnterpriseProcessor110: "sipme_Requirement" = None, initiates: set["sipme_Event"] = None, sipme_EnterpriseProcessor51: set["sipme_ObjectView"] = None, implementedBy: set["sipme_Role_Function"] = None, sipme_EnterpriseProcessor55: set["sipme_Capacity"] = None, sipme_EnterpriseProcessor58: set["sipme_Capability"] = None, EnterpriseProcessor119: "sipme_Role_Function" = None):
...
class sipme_Objective(EnterpriseObject):
    ...
    def __init__(self, objectiveType: str, objectiveNature: str, sipme_Objective: "sipme_Enterprise" = None, Objective: "sipme_Objective" = None, refines: set["sipme_Objective"] = None, Objective79: "sipme_Objective" = None, subObjectives: "sipme_Objective" = None, associatedObjective: set["sipme_Requirement"] = None, Objective100: "sipme_Requirement" = None):
...
class sipme_Capability(EnterpriseObject):
    ...
    def __init__(self, capabilityType: str, sipme_Capability: "sipme_Capacity" = None, sipme_Capability67: "sipme_EnterpriseResource" = None, sipme_Capability59: "sipme_EnterpriseProcessor" = None):
...
class sipme_Domain(OrganisationCell, SIPME_object, EnterpriseProcessor):
    ...
    def __init__(self, domainCharacterization: str, performanceIndicators: float, sipme_Domain15: set["sipme_BusinessProcess"] = None, covers: set["sipme_OrganisationCell"] = None, sipme_Domain20: set["sipme_BusinessRules"] = None, sipme_Domain25: "sipme_Enterprise" = None, sipme_Domain: "sipme_BusinessProcess" = None, Domain: "sipme_OrganisationCell" = None):
        ...
        pass
    @property
    def performanceIndicators(self):
    ...
    @property
    def domainCharacterization(self):
...
class sipme_CompanyMember(EnterpriseResource, Stakeholder):
    ...
    def __init__(self, fullName: str, socialSecurityNumber: int, address: str, owners: set["sipme_Workstation"] = None, responsible: set["sipme_Workstation"] = None, cellResponsible: set["sipme_OrganisationCell"] = None, fileResponsible: set["sipme_ObjectsFileView"] = None, sipme_CompanyMember: "sipme_Enterprise" = None, CompanyMember: "sipme_OrganisationCell" = None, CompanyMember137: "sipme_Workstation" = None, CompanyMember139: "sipme_Workstation" = None, CompanyMember98: "sipme_ObjectsFileView" = None):
...
class sipme_Application(EnterpriseResource):
    ...
    def __init__(self, applicationEditor: str, applicationMaintainer: str):
        ...
        pass
    @property
    def applicationMaintainer(self):
