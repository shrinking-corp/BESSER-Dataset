...
class library_Author:
    ...
    def __init__(self, firstname: str, secondname: str, library_Author: "library_AddAuthor" = None, library_Author5: "library_Add" = None, library_Author3: "library_ByAuthor" = None):
