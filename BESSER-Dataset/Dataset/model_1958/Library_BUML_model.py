...
library_Command = Class(name="library_Command")
library_Search = Class(name="library_Search")
Command = Class(name="Command")
library_AddAuthor = Class(name="library_AddAuthor")
library_Author = Class(name="library_Author")
library_ByYear = Class(name="library_ByYear")
Search = Class(name="Search")
library_Add = Class(name="library_Add")
library_AddUser = Class(name="library_AddUser")
library_Remove = Class(name="library_Remove")
library_Return = Class(name="library_Return")
library_Check = Class(name="library_Check")
library_Show = Class(name="library_Show")
library_ShowUserAccount = Class(name="library_ShowUserAccount")
library_ByAuthor = Class(name="library_ByAuthor")
library_Lend = Class(name="library_Lend")
...
library_Author.attributes={library_Author_secondname, library_Author_firstname}
...
library_Add.attributes={library_Add_year, library_Add_title, library_Add_isbn}
...
library_AddUser.attributes={library_AddUser_firstname, library_AddUser_secondname, library_AddUser_age}
...
library_Return.attributes={library_Return_secondname, library_Return_firstname, library_Return_isbn}
...
library_ShowUserAccount.attributes={library_ShowUserAccount_secondname, library_ShowUserAccount_firstname}
...
domain_model = DomainModel(
    name="library",
    types={library_Model, library_Command, library_Search, Command, library_AddAuthor, library_Author, library_ByYear, Search, library_Add, library_AddUser, library_Remove, library_Return, library_Check, library_Show, library_ShowUserAccount, library_ByAuthor, library_Lend},
    associations={commands0, author1, authors4, author2},
    generalizations={gen_library_Search_Command, gen_library_AddAuthor_Command, gen_library_ByYear_Search, gen_library_Add_Command, gen_library_AddUser_Command, gen_library_Remove_Command, gen_library_Return_Command, gen_library_Check_Command, gen_library_Show_Command, gen_library_ShowUserAccount_Command, gen_library_ByAuthor_Search, gen_library_Lend_Command},
    metadata=None
)
