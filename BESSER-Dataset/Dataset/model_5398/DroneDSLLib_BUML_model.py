...
# Classes
droneDSLLib_Model = Class(name="droneDSLLib_Model")
droneDSLLib_FonctionDecl = Class(name="droneDSLLib_FonctionDecl")
droneDSLLib_SecondeConst = Class(name="droneDSLLib_SecondeConst")
SecondeExp = Class(name="SecondeExp")
droneDSLLib_VarDecl = Class(name="droneDSLLib_VarDecl")
droneDSLLib_RefSecondeVar = Class(name="droneDSLLib_RefSecondeVar")
droneDSLLib_RefPourcentVar = Class(name="droneDSLLib_RefPourcentVar")
droneDSLLib_PourcentExp = Class(name="droneDSLLib_PourcentExp")
droneDSLLib_SecondeExp = Class(name="droneDSLLib_SecondeExp")
droneDSLLib_Decoller = Class(name="droneDSLLib_Decoller")
DecollerAtterrir = Class(name="DecollerAtterrir")
droneDSLLib_Atterrir = Class(name="droneDSLLib_Atterrir")
droneDSLLib_Monter = Class(name="droneDSLLib_Monter")
Mouvement = Class(name="Mouvement")
CommandeBasique = Class(name="CommandeBasique")
MD = Class(name="MD")
droneDSLLib_Descendre = Class(name="droneDSLLib_Descendre")
droneDSLLib_Avancer = Class(name="droneDSLLib_Avancer")
droneDSLLib_PourcentConst = Class(name="droneDSLLib_PourcentConst")
PourcentExp = Class(name="PourcentExp")
droneDSLLib_SecondeDecl = Class(name="droneDSLLib_SecondeDecl")
VarDecl = Class(name="VarDecl")
droneDSLLib_PourcentDecl = Class(name="droneDSLLib_PourcentDecl")
droneDSLLib_Gauche = Class(name="droneDSLLib_Gauche")
GDr = Class(name="GDr")
droneDSLLib_Droite = Class(name="droneDSLLib_Droite")
droneDSLLib_RotationGauche = Class(name="droneDSLLib_RotationGauche")
RGRD = Class(name="RGRD")
droneDSLLib_RotationDroite = Class(name="droneDSLLib_RotationDroite")
AR = Class(name="AR")
droneDSLLib_Reculer = Class(name="droneDSLLib_Reculer")
droneDSLLib_EObject = Class(name="droneDSLLib_EObject")
droneDSLLib_FonctionCall = Class(name="droneDSLLib_FonctionCall")
droneDSLLib_FonctionCallInterne = Class(name="droneDSLLib_FonctionCallInterne")
FonctionCall = Class(name="FonctionCall")
droneDSLLib_MD = Class(name="droneDSLLib_MD")
droneDSLLib_GDr = Class(name="droneDSLLib_GDr")
droneDSLLib_RGRD = Class(name="droneDSLLib_RGRD")
droneDSLLib_AR = Class(name="droneDSLLib_AR")
droneDSLLib_Pause = Class(name="droneDSLLib_Pause")
droneDSLLib_Parallele = Class(name="droneDSLLib_Parallele")
droneDSLLib_Mouvement = Class(name="droneDSLLib_Mouvement")
droneDSLLib_DecollerAtterrir = Class(name="droneDSLLib_DecollerAtterrir")
droneDSLLib_CommandeBasique = Class(name="droneDSLLib_CommandeBasique")
droneDSLLib_Parallele2 = Class(name="droneDSLLib_Parallele2")
Parallele = Class(name="Parallele")
droneDSLLib_Parallele3 = Class(name="droneDSLLib_Parallele3")
droneDSLLib_Parallele4 = Class(name="droneDSLLib_Parallele4")
...
domain_model = DomainModel(
    name="droneDSLLib",
    types={droneDSLLib_Model, droneDSLLib_FonctionDecl, droneDSLLib_SecondeConst, SecondeExp, droneDSLLib_VarDecl, droneDSLLib_RefSecondeVar, droneDSLLib_RefPourcentVar, droneDSLLib_PourcentExp, droneDSLLib_SecondeExp, droneDSLLib_Decoller, DecollerAtterrir, droneDSLLib_Atterrir, droneDSLLib_Monter, Mouvement, CommandeBasique, MD, droneDSLLib_Descendre, droneDSLLib_Avancer, droneDSLLib_PourcentConst, PourcentExp, droneDSLLib_SecondeDecl, VarDecl, droneDSLLib_PourcentDecl, droneDSLLib_Gauche, GDr, droneDSLLib_Droite, droneDSLLib_RotationGauche, RGRD, droneDSLLib_RotationDroite, AR, droneDSLLib_Reculer, droneDSLLib_EObject, droneDSLLib_FonctionCall, droneDSLLib_FonctionCallInterne, FonctionCall, droneDSLLib_MD, droneDSLLib_GDr, droneDSLLib_RGRD, droneDSLLib_AR, droneDSLLib_Pause, droneDSLLib_Parallele, droneDSLLib_Mouvement, droneDSLLib_DecollerAtterrir, droneDSLLib_CommandeBasique, droneDSLLib_Parallele2, Parallele, droneDSLLib_Parallele3, droneDSLLib_Parallele4},
    associations={fonctions0, val2, var3, var5, duree7, vitesse8, duree10, vitesse12, val1, vitesse22, duree25, vitesse27, duree30, vitesse32, duree35, vitesse37, duree40, vitesse42, duree15, vitesse17, duree20, body47, ref49, duree45, a51, b53, t56, c58, c60, d62},
    generalizations={gen_droneDSLLib_SecondeConst_SecondeExp, gen_droneDSLLib_RefSecondeVar_SecondeExp, gen_droneDSLLib_RefPourcentVar_PourcentExp, gen_droneDSLLib_Decoller_DecollerAtterrir, gen_droneDSLLib_Atterrir_DecollerAtterrir, gen_droneDSLLib_Monter_Mouvement, gen_droneDSLLib_Monter_CommandeBasique, gen_droneDSLLib_Monter_MD, gen_droneDSLLib_Descendre_Mouvement, gen_droneDSLLib_Descendre_CommandeBasique, gen_droneDSLLib_Descendre_MD, gen_droneDSLLib_PourcentConst_PourcentExp, gen_droneDSLLib_SecondeDecl_VarDecl, gen_droneDSLLib_PourcentDecl_VarDecl, gen_droneDSLLib_Gauche_Mouvement, gen_droneDSLLib_Gauche_CommandeBasique, gen_droneDSLLib_Gauche_GDr, gen_droneDSLLib_Droite_Mouvement, gen_droneDSLLib_Droite_CommandeBasique, gen_droneDSLLib_Droite_GDr, gen_droneDSLLib_RotationGauche_Mouvement, gen_droneDSLLib_RotationGauche_CommandeBasique, gen_droneDSLLib_RotationGauche_RGRD, gen_droneDSLLib_RotationDroite_Mouvement, gen_droneDSLLib_RotationDroite_CommandeBasique, gen_droneDSLLib_RotationDroite_RGRD, gen_droneDSLLib_Avancer_Mouvement, gen_droneDSLLib_Avancer_CommandeBasique, gen_droneDSLLib_Avancer_AR, gen_droneDSLLib_Reculer_Mouvement, gen_droneDSLLib_Reculer_CommandeBasique, gen_droneDSLLib_Reculer_AR, gen_droneDSLLib_FonctionCallInterne_FonctionCall, gen_droneDSLLib_Pause_CommandeBasique, gen_droneDSLLib_Parallele_Mouvement, gen_droneDSLLib_Parallele2_Parallele, gen_droneDSLLib_Parallele3_Parallele, gen_droneDSLLib_Parallele4_Parallele},
    metadata=None
)
