...
class VorkursModel_Address:
    ...
    def __init__(self, zip: str, street: str, city: str, state: str, VorkursModel_Address: "VorkursModel_Contact" = None):
        self.zip = zip
        self.street = street
        self.city = city
        self.state = state
...
class VorkursModel_Qualification:
    ...
    @property
    def hasProgrammingExperience(self):
...
class VorkursModel_Contact:
    ...
    def __init__(self, phonenumber: str, Email: str, VorkursModel_Contact9: "VorkursModel_Address" = None, VorkursModel_Contact: "VorkursModel_Person" = None):
