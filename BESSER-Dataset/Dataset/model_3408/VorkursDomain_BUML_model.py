...
VorkursModel_Room.attributes={VorkursModel_Room_hasComputers, VorkursModel_Room_sockets, VorkursModel_Room_roomNr, VorkursModel_Room_seats}
...
VorkursModel_Person.attributes={VorkursModel_Person_subject, VorkursModel_Person_lastname, VorkursModel_Person_firstname, VorkursModel_Person_gender}
...
VorkursModel_Address.attributes={VorkursModel_Address_zip, VorkursModel_Address_state, VorkursModel_Address_city, VorkursModel_Address_street}
...
domain_model = DomainModel(
    name="VorkursModel",
    types={VorkursModel_RegistrationSystem, VorkursModel_Student, VorkursModel_TeachingAssistant, Person, VorkursModel_Room, VorkursModel_Person, VorkursModel_Contact, VorkursModel_Notebook, VorkursModel_Qualification, VorkursModel_Address, Nationality, Subject, Gender, ProgrammingLanguage, OperatingSystem},
    associations={students0, teachingAssistants1, address8, room10, contactinfo3, notebook4, qualification6},
