...
class ER_RelshipEnd:
    ...
    def __init__(self, name: str, RelshipEnd11: "ER_Relship" = None, ends: "ER_Relship" = None, ends17: "ER_Entity" = None, RelshipEnd: "ER_Entity" = None):
        self.name = name
...
class ER_ERAttribute:
    ...
    def __init__(self, name: str, isKey: bool, ERAttribute8: "ER_Relship" = None, attrs: "ER_Entity" = None, attrs22: "ER_Relship" = None, ERAttribute: "ER_Entity" = None):
        self.name = name
        self.isKey = isKey
...
class ER_Entity:
    ...
    def __init__(self, name: str, Entity: "ER_ERSchema" = None, entities: "ER_ERSchema" = None, Entity18: "ER_RelshipEnd" = None, Entity20: "ER_ERAttribute" = None, entity: set["ER_ERAttribute"] = None, entity5: set["ER_RelshipEnd"] = None):
        self.name = name
        self.Entity = Entity
