...
ccsl_CompositeRule = Class(name="ccsl_CompositeRule")
Rule = Class(name="Rule")
ccsl_AtomicRule = Class(name="ccsl_AtomicRule")
Element = Class(name="Element")
Context = Class(name="Context")
ccsl_Rule = Class(name="ccsl_Rule", is_abstract=True)
ccsl_namedElements_NamedElement = Class(name="ccsl_namedElements_NamedElement")
ccsl_namedElements_Package = Class(name="ccsl_namedElements_Package")
namedElements_NamedElement = Class(name="namedElements_NamedElement")
import_ImportableElement = Class(name="import_ImportableElement")
complexType_DeclaredType = Class(name="complexType_DeclaredType")
ccsl_variable_Variable = Class(name="ccsl_variable_Variable")
NamedElement = Class(name="NamedElement")
datatype_DataType = Class(name="datatype_DataType")
ccsl_variable_ParameterVariable = Class(name="ccsl_variable_ParameterVariable")
variable_Variable = Class(name="variable_Variable")
annotation_AnnotableElement = Class(name="annotation_AnnotableElement")
ccsl_variable_LocalVariable = Class(name="ccsl_variable_LocalVariable")
InitializableVariable = Class(name="InitializableVariable")
ccsl_variable_InitializableVariable = Class(name="ccsl_variable_InitializableVariable")
Variable = Class(name="Variable")
ccsl_Root = Class(name="ccsl_Root", is_abstract=True)
ccsl_FaultTypeDescription = Class(name="ccsl_FaultTypeDescription")
InjectionAction = Class(name="InjectionAction")
InjectionStrategy = Class(name="InjectionStrategy")
ccsl_elements_Element = Class(name="ccsl_elements_Element")
ccsl_complexType_DeclaredType = Class(name="ccsl_complexType_DeclaredType")
complexType_JInterface = Class(name="complexType_JInterface")
import_ImportStatement = Class(name="import_ImportStatement")
ccsl_complexType_ComplexType = Class(name="ccsl_complexType_ComplexType")
variable_FieldVariable = Class(name="variable_FieldVariable")
method_Method = Class(name="method_Method")
ccsl_complexType_AnnotationType = Class(name="ccsl_complexType_AnnotationType")
DeclaredType = Class(name="DeclaredType")
statements_Statement = Class(name="statements_Statement")
ccsl_variable_FieldVariable = Class(name="ccsl_variable_FieldVariable")
variable_InitializableVariable = Class(name="variable_InitializableVariable")
ccsl_complexType_JInterface = Class(name="ccsl_complexType_JInterface")
complexType_ComplexType = Class(name="complexType_ComplexType")
ccsl_complexType_AnonymousClass = Class(name="ccsl_complexType_AnonymousClass")
ComplexType = Class(name="ComplexType")
datatype_ObjectType = Class(name="datatype_ObjectType")
ccsl_complexType_JClass = Class(name="ccsl_complexType_JClass")
method_Constructor = Class(name="method_Constructor")
complexType_JClass = Class(name="complexType_JClass")
ccsl_statements_VariableAccess = Class(name="ccsl_statements_VariableAccess")
Access = Class(name="Access")
ccsl_statements_DataTypeAccess = Class(name="ccsl_statements_DataTypeAccess")
ccsl_statements_ControlFlow = Class(name="ccsl_statements_ControlFlow")
ccsl_statements_Block = Class(name="ccsl_statements_Block")
ccsl_statements_VarDeclaration = Class(name="ccsl_statements_VarDeclaration")
ccsl_statements_InstanceCreation = Class(name="ccsl_statements_InstanceCreation")
ccsl_method_Constructor = Class(name="ccsl_method_Constructor")
SimpleMethod = Class(name="SimpleMethod")
ccsl_method_SimpleMethod = Class(name="ccsl_method_SimpleMethod")
elements_Element = Class(name="elements_Element")
variable_ParameterVariable = Class(name="variable_ParameterVariable")
ccsl_method_Method = Class(name="ccsl_method_Method")
method_SimpleMethod = Class(name="method_SimpleMethod")
ccsl_statements_Statement = Class(name="ccsl_statements_Statement")
ccsl_statements_NamedElementAccess = Class(name="ccsl_statements_NamedElementAccess")
ccsl_statements_EmptyStatement = Class(name="ccsl_statements_EmptyStatement")
Statement = Class(name="Statement")
ccsl_statements_InstanceOf = Class(name="ccsl_statements_InstanceOf")
ccsl_statements_ReturnStatement = Class(name="ccsl_statements_ReturnStatement")
ccsl_statements_ThisStatement = Class(name="ccsl_statements_ThisStatement")
ccsl_statements_BreakStatement = Class(name="ccsl_statements_BreakStatement")
ccsl_statements_ContinueStatement = Class(name="ccsl_statements_ContinueStatement")
ccsl_expressions_OperatorExpression = Class(name="ccsl_expressions_OperatorExpression")
ccsl_expressions_ParenthesizedExpression = Class(name="ccsl_expressions_ParenthesizedExpression")
ccsl_statements_Access = Class(name="ccsl_statements_Access")
ccsl_statements_ArrayCreation = Class(name="ccsl_statements_ArrayCreation")
ccsl_statements_SynchronizedBlock = Class(name="ccsl_statements_SynchronizedBlock")
ccsl_statements_ThrowStatement = Class(name="ccsl_statements_ThrowStatement")
ccsl_literalValues_LiteralValue = Class(name="ccsl_literalValues_LiteralValue")
ccsl_literalValues_NullLiteral = Class(name="ccsl_literalValues_NullLiteral")
LiteralValue = Class(name="LiteralValue")
ccsl_literalValues_CharacterLiteral = Class(name="ccsl_literalValues_CharacterLiteral")
ccsl_literalValues_StringLiteral = Class(name="ccsl_literalValues_StringLiteral")
ccsl_literalValues_NumberLiteral = Class(name="ccsl_literalValues_NumberLiteral")
ccsl_literalValues_BooleanLiteral = Class(name="ccsl_literalValues_BooleanLiteral")
ccsl_controlFlow_SwitchStatement = Class(name="ccsl_controlFlow_SwitchStatement")
ControlFlow = Class(name="ControlFlow")
controlFlow_SwitchCaseBlock = Class(name="controlFlow_SwitchCaseBlock")
ccsl_controlFlow_SwitchCaseBlock = Class(name="ccsl_controlFlow_SwitchCaseBlock")
Block = Class(name="Block")
ccsl_controlFlow_IfStatement = Class(name="ccsl_controlFlow_IfStatement")
ccsl_expressions_StringConcatenation = Class(name="ccsl_expressions_StringConcatenation")
OperatorExpression = Class(name="OperatorExpression")
ccsl_expressions_InfixExpression = Class(name="ccsl_expressions_InfixExpression")
ccsl_expressions_BooleanExpression = Class(name="ccsl_expressions_BooleanExpression")
ccsl_expressions_ArithmeticExpression = Class(name="ccsl_expressions_ArithmeticExpression")
ccsl_assignment_AbstractAssignment = Class(name="ccsl_assignment_AbstractAssignment")
ccsl_assignment_Assignment = Class(name="ccsl_assignment_Assignment")
AbstractAssignment = Class(name="AbstractAssignment")
ccsl_assignment_UnaryAssignment = Class(name="ccsl_assignment_UnaryAssignment")
ccsl_assignment_PrefixUnaryAssignment = Class(name="ccsl_assignment_PrefixUnaryAssignment")
UnaryAssignment = Class(name="UnaryAssignment")
ccsl_assignment_PostfixUnaryAssignment = Class(name="ccsl_assignment_PostfixUnaryAssignment")
ccsl_controlFlow_LoopStatement = Class(name="ccsl_controlFlow_LoopStatement")
ccsl_tryCatch_TryStatement = Class(name="ccsl_tryCatch_TryStatement")
tryCatch_CatchClause = Class(name="tryCatch_CatchClause")
statements_Block = Class(name="statements_Block")
ccsl_tryCatch_CatchClause = Class(name="ccsl_tryCatch_CatchClause")
ccsl_annotation_Annotation = Class(name="ccsl_annotation_Annotation")
complexType_AnnotationType = Class(name="complexType_AnnotationType")
ccsl_annotation_AnnotableElement = Class(name="ccsl_annotation_AnnotableElement")
annotation_Annotation = Class(name="annotation_Annotation")
ccsl_datatype_DataType = Class(name="ccsl_datatype_DataType")
ccsl_datatype_PrimitiveType = Class(name="ccsl_datatype_PrimitiveType")
DataType = Class(name="DataType")
ccsl_datatype_StringPrimitiveType = Class(name="ccsl_datatype_StringPrimitiveType")
PrimitiveType = Class(name="PrimitiveType")
ccsl_datatype_BooleanPrimitiveType = Class(name="ccsl_datatype_BooleanPrimitiveType")
ccsl_datatype_ShortPrimitiveType = Class(name="ccsl_datatype_ShortPrimitiveType")
ccsl_invocation_MethodInvocation = Class(name="ccsl_invocation_MethodInvocation")
SimpleMethodInvocation = Class(name="SimpleMethodInvocation")
ccsl_invocation_SuperMethodInvocation = Class(name="ccsl_invocation_SuperMethodInvocation")
ccsl_invocation_Invocation = Class(name="ccsl_invocation_Invocation")
ccsl_invocation_ConstructorInvocation = Class(name="ccsl_invocation_ConstructorInvocation")
Invocation = Class(name="Invocation")
ccsl_invocation_SimpleMethodInvocation = Class(name="ccsl_invocation_SimpleMethodInvocation")
ccsl_import_ImportableElement = Class(name="ccsl_import_ImportableElement")
ccsl_import_ImportStatement = Class(name="ccsl_import_ImportStatement")
ccsl_faultTypeDescription_InjectionStrategy = Class(name="ccsl_faultTypeDescription_InjectionStrategy", is_abstract=True)
ccsl_action_DeleteAction = Class(name="ccsl_action_DeleteAction")
ccsl_action_MoveScopeUpAction = Class(name="ccsl_action_MoveScopeUpAction")
ccsl_action_DeleteInfixOperatorAction = Class(name="ccsl_action_DeleteInfixOperatorAction")
ccsl_action_ChangeLiteralValueAction = Class(name="ccsl_action_ChangeLiteralValueAction")
ccsl_action_DeleteRandomStatementAction = Class(name="ccsl_action_DeleteRandomStatementAction")
ccsl_action_ReplaceVariableAccessAction = Class(name="ccsl_action_ReplaceVariableAccessAction")
ccsl_action_ReplaceArithmeticOperatorAction = Class(name="ccsl_action_ReplaceArithmeticOperatorAction")
action_ArithmeticOperatorMap = Class(name="action_ArithmeticOperatorMap")
ccsl_action_ArithmeticOperatorMap = Class(name="ccsl_action_ArithmeticOperatorMap")
ccsl_strategy_AllStrategy = Class(name="ccsl_strategy_AllStrategy")
ccsl_functions_CcslFunction = Class(name="ccsl_functions_CcslFunction", is_abstract=True)
ccsl_datatype_ObjectType = Class(name="ccsl_datatype_ObjectType")
ccsl_datatype_ParameterizedType = Class(name="ccsl_datatype_ParameterizedType")
ObjectType = Class(name="ObjectType")
ccsl_datatype_GenericType = Class(name="ccsl_datatype_GenericType")
ccsl_datatype_IntPrimitiveType = Class(name="ccsl_datatype_IntPrimitiveType")
ccsl_datatype_ArrayType = Class(name="ccsl_datatype_ArrayType")
ccsl_datatype_VoidType = Class(name="ccsl_datatype_VoidType")
ccsl_context_Context = Class(name="ccsl_context_Context")
filters_Filter = Class(name="filters_Filter")
ccsl_faultTypeDescription_InjectionAction = Class(name="ccsl_faultTypeDescription_InjectionAction", is_abstract=True)
ccsl_filters_CountFilter = Class(name="ccsl_filters_CountFilter")
ccsl_filters_RegexMatch = Class(name="ccsl_filters_RegexMatch")
ccsl_filters_ImplicityOperandFilter = Class(name="ccsl_filters_ImplicityOperandFilter")
TemplateFilter = Class(name="TemplateFilter")
expressions_OperatorExpression = Class(name="expressions_OperatorExpression")
ccsl_filters_ImplicityContainerFilter = Class(name="ccsl_filters_ImplicityContainerFilter")
ccsl_booleanFunctions_CcslBooleanFunction = Class(name="ccsl_booleanFunctions_CcslBooleanFunction", is_abstract=True)
CcslFunction = Class(name="CcslFunction")
ccsl_filters_Filter = Class(name="ccsl_filters_Filter", is_abstract=True)
CcslBooleanFunction = Class(name="CcslBooleanFunction")
ccsl_filters_AtomicFilter = Class(name="ccsl_filters_AtomicFilter")
Filter = Class(name="Filter")
ccsl_filters_CompositeFilter = Class(name="ccsl_filters_CompositeFilter")
ccsl_filters_PropertyFilter = Class(name="ccsl_filters_PropertyFilter")
AtomicFilter = Class(name="AtomicFilter")
ccsl_filters_TemplateFilter = Class(name="ccsl_filters_TemplateFilter")
ccsl_filters_SameNameFilter = Class(name="ccsl_filters_SameNameFilter")
ccsl_filters_ChildClosureComplexTypeFilter = Class(name="ccsl_filters_ChildClosureComplexTypeFilter")
ccsl_filters_IsStringFilter = Class(name="ccsl_filters_IsStringFilter")
ccsl_filters_EquationFilter = Class(name="ccsl_filters_EquationFilter")
numberFunctions_CcslNumberFunction = Class(name="numberFunctions_CcslNumberFunction")
ccsl_filters_IsKindOfFilter = Class(name="ccsl_filters_IsKindOfFilter")
ccsl_filters_SuperMethodClosureFilter = Class(name="ccsl_filters_SuperMethodClosureFilter")
ccsl_filters_IsTypeOfFilter = Class(name="ccsl_filters_IsTypeOfFilter")
ccsl_filters_HasSameReferenceFilter = Class(name="ccsl_filters_HasSameReferenceFilter")
ccsl_numberFunctions_CcslNumberFunction = Class(name="ccsl_numberFunctions_CcslNumberFunction", is_abstract=True)
ccsl_numberFunctions_CcslIntegerLiteral = Class(name="ccsl_numberFunctions_CcslIntegerLiteral")
CcslNumberFunction = Class(name="CcslNumberFunction")
ccsl_numberFunctions_GetIndexOf = Class(name="ccsl_numberFunctions_GetIndexOf")
ccsl_filters_FromClosureFilter = Class(name="ccsl_filters_FromClosureFilter")
statements_Access = Class(name="statements_Access")
ccsl_filters_SuperClassClosureFilter = Class(name="ccsl_filters_SuperClassClosureFilter")
ccsl_filters_BlockLastStatementFilter = Class(name="ccsl_filters_BlockLastStatementFilter")
...
ccsl_namedElements_NamedElement.attributes={ccsl_namedElements_NamedElement_avaliableInSourceCode, ccsl_namedElements_NamedElement_name}
...
ccsl_complexType_DeclaredType.attributes={ccsl_complexType_DeclaredType_visibility, ccsl_complexType_DeclaredType_static}
...
ccsl_variable_FieldVariable.attributes={ccsl_variable_FieldVariable_visibility, ccsl_variable_FieldVariable_static}
...
ccsl_method_Method.attributes={ccsl_method_Method_final, ccsl_method_Method_inheritance, ccsl_method_Method_static, ccsl_method_Method_abstract}
...
ccsl_action_ArithmeticOperatorMap.attributes={ccsl_action_ArithmeticOperatorMap_oldArithmeticOperator, ccsl_action_ArithmeticOperatorMap_newArithmeticOperator}
...
ccsl_filters_CountFilter.attributes={ccsl_filters_CountFilter_min, ccsl_filters_CountFilter_max}
...
from_29: BinaryAssociation = BinaryAssociation(
    name="from_29",
    ends={
...
from_46: BinaryAssociation = BinaryAssociation(
    name="from_46",
    ends={
...
from_174: BinaryAssociation = BinaryAssociation(
    name="from_174",
    ends={
...
domain_model = DomainModel(
    name="ccsl",
    types={Root, ccsl_CompositeRule, Rule, ccsl_AtomicRule, Element, Context, ccsl_Rule, ccsl_namedElements_NamedElement, ccsl_namedElements_Package, namedElements_NamedElement, import_ImportableElement, complexType_DeclaredType, ccsl_variable_Variable, NamedElement, datatype_DataType, ccsl_variable_ParameterVariable, variable_Variable, annotation_AnnotableElement, ccsl_variable_LocalVariable, InitializableVariable, ccsl_variable_InitializableVariable, Variable, ccsl_Root, ccsl_FaultTypeDescription, InjectionAction, InjectionStrategy, ccsl_elements_Element, ccsl_complexType_DeclaredType, complexType_JInterface, import_ImportStatement, ccsl_complexType_ComplexType, variable_FieldVariable, method_Method, ccsl_complexType_AnnotationType, DeclaredType, statements_Statement, ccsl_variable_FieldVariable, variable_InitializableVariable, ccsl_complexType_JInterface, complexType_ComplexType, ccsl_complexType_AnonymousClass, ComplexType, datatype_ObjectType, ccsl_complexType_JClass, method_Constructor, complexType_JClass, ccsl_statements_VariableAccess, Access, ccsl_statements_DataTypeAccess, ccsl_statements_ControlFlow, ccsl_statements_Block, ccsl_statements_VarDeclaration, ccsl_statements_InstanceCreation, ccsl_method_Constructor, SimpleMethod, ccsl_method_SimpleMethod, elements_Element, variable_ParameterVariable, ccsl_method_Method, method_SimpleMethod, ccsl_statements_Statement, ccsl_statements_NamedElementAccess, ccsl_statements_EmptyStatement, Statement, ccsl_statements_InstanceOf, ccsl_statements_ReturnStatement, ccsl_statements_ThisStatement, ccsl_statements_BreakStatement, ccsl_statements_ContinueStatement, ccsl_expressions_OperatorExpression, ccsl_expressions_ParenthesizedExpression, ccsl_statements_Access, ccsl_statements_ArrayCreation, ccsl_statements_SynchronizedBlock, ccsl_statements_ThrowStatement, ccsl_literalValues_LiteralValue, ccsl_literalValues_NullLiteral, LiteralValue, ccsl_literalValues_CharacterLiteral, ccsl_literalValues_StringLiteral, ccsl_literalValues_NumberLiteral, ccsl_literalValues_BooleanLiteral, ccsl_controlFlow_SwitchStatement, ControlFlow, controlFlow_SwitchCaseBlock, ccsl_controlFlow_SwitchCaseBlock, Block, ccsl_controlFlow_IfStatement, ccsl_expressions_StringConcatenation, OperatorExpression, ccsl_expressions_InfixExpression, ccsl_expressions_BooleanExpression, ccsl_expressions_ArithmeticExpression, ccsl_assignment_AbstractAssignment, ccsl_assignment_Assignment, AbstractAssignment, ccsl_assignment_UnaryAssignment, ccsl_assignment_PrefixUnaryAssignment, UnaryAssignment, ccsl_assignment_PostfixUnaryAssignment, ccsl_controlFlow_LoopStatement, ccsl_tryCatch_TryStatement, tryCatch_CatchClause, statements_Block, ccsl_tryCatch_CatchClause, ccsl_annotation_Annotation, complexType_AnnotationType, ccsl_annotation_AnnotableElement, annotation_Annotation, ccsl_datatype_DataType, ccsl_datatype_PrimitiveType, DataType, ccsl_datatype_StringPrimitiveType, PrimitiveType, ccsl_datatype_BooleanPrimitiveType, ccsl_datatype_ShortPrimitiveType, ccsl_invocation_MethodInvocation, SimpleMethodInvocation, ccsl_invocation_SuperMethodInvocation, ccsl_invocation_Invocation, ccsl_invocation_ConstructorInvocation, Invocation, ccsl_invocation_SimpleMethodInvocation, ccsl_import_ImportableElement, ccsl_import_ImportStatement, ccsl_faultTypeDescription_InjectionStrategy, ccsl_action_DeleteAction, ccsl_action_MoveScopeUpAction, ccsl_action_DeleteInfixOperatorAction, ccsl_action_ChangeLiteralValueAction, ccsl_action_DeleteRandomStatementAction, ccsl_action_ReplaceVariableAccessAction, ccsl_action_ReplaceArithmeticOperatorAction, action_ArithmeticOperatorMap, ccsl_action_ArithmeticOperatorMap, ccsl_strategy_AllStrategy, ccsl_functions_CcslFunction, ccsl_datatype_ObjectType, ccsl_datatype_ParameterizedType, ObjectType, ccsl_datatype_GenericType, ccsl_datatype_IntPrimitiveType, ccsl_datatype_ArrayType, ccsl_datatype_VoidType, ccsl_context_Context, filters_Filter, ccsl_faultTypeDescription_InjectionAction, ccsl_filters_CountFilter, ccsl_filters_RegexMatch, ccsl_filters_ImplicityOperandFilter, TemplateFilter, expressions_OperatorExpression, ccsl_filters_ImplicityContainerFilter, ccsl_booleanFunctions_CcslBooleanFunction, CcslFunction, ccsl_filters_Filter, CcslBooleanFunction, ccsl_filters_AtomicFilter, Filter, ccsl_filters_CompositeFilter, ccsl_filters_PropertyFilter, AtomicFilter, ccsl_filters_TemplateFilter, ccsl_filters_SameNameFilter, ccsl_filters_ChildClosureComplexTypeFilter, ccsl_filters_IsStringFilter, ccsl_filters_EquationFilter, numberFunctions_CcslNumberFunction, ccsl_filters_IsKindOfFilter, ccsl_filters_SuperMethodClosureFilter, ccsl_filters_IsTypeOfFilter, ccsl_filters_HasSameReferenceFilter, ccsl_numberFunctions_CcslNumberFunction, ccsl_numberFunctions_CcslIntegerLiteral, CcslNumberFunction, ccsl_numberFunctions_GetIndexOf, ccsl_filters_FromClosureFilter, statements_Access, ccsl_filters_SuperClassClosureFilter, ccsl_filters_BlockLastStatementFilter, LogicOperator, CollectionKind, Visibility, Inheritance, BooleanOperator, ArithmeticOperator, AssignmentOperator, UnaryAssignmentOperator, EquationOperator},
    associations={rules0, subject1, context2, declaredTypes10, type11, rule4, actions6, strategy8, superInterfaces17, imports18, nestedTypes20, fields23, methods24, initialValue12, type13, constructors14, superClass15, from_29, condition31, statements33, variable35, type36, params26, returnType27, leftOperand58, rightOperand60, statement63, operands65, constructor38, args41, elementAccessed44, from_46, type49, bodyStatements51, key53, expression56, cases69, expression67, leftHandSide88, rightHandSide90, thenStatement70, elseStatement72, body75, catchClauses77, finallyBlock78, body80, variable82, handledExceptions85, importedElement100, type101, annotations102, from_92, args94, constructor96, method98, replaceMap116, typeArguments103, type105, type108, contextElements110, filters112, target114, context127, container129, field132, implicityOperand135, operatorExpression137, targets117, filters119, targetTemplate121, context123, elements126, superComplexType162, childComplexType163, context166, leftHandSide169, rightHandSide170, implicityContainer139, implicityField141, context144, context147, type149, context152, superMethod154, context157, type159, container193, field195, access173, from_174, context177, superClass180, subClass182, context185, lastStatement188, context190},
    generalizations={gen_ccsl_Rule_Root, gen_ccsl_CompositeRule_Rule, gen_ccsl_AtomicRule_Rule, gen_ccsl_namedElements_NamedElement_Element, gen_ccsl_namedElements_Package_namedElements_NamedElement, gen_ccsl_namedElements_Package_import_ImportableElement, gen_ccsl_variable_Variable_NamedElement, gen_ccsl_variable_ParameterVariable_variable_Variable, gen_ccsl_variable_ParameterVariable_annotation_AnnotableElement, gen_ccsl_variable_LocalVariable_InitializableVariable, gen_ccsl_variable_InitializableVariable_Variable, gen_ccsl_FaultTypeDescription_Root, gen_ccsl_complexType_DeclaredType_namedElements_NamedElement, gen_ccsl_complexType_DeclaredType_datatype_ObjectType, gen_ccsl_complexType_DeclaredType_import_ImportableElement, gen_ccsl_complexType_ComplexType_Element, gen_ccsl_complexType_AnnotationType_DeclaredType, gen_ccsl_variable_FieldVariable_variable_InitializableVariable, gen_ccsl_variable_FieldVariable_annotation_AnnotableElement, gen_ccsl_complexType_JInterface_complexType_DeclaredType, gen_ccsl_complexType_JInterface_complexType_ComplexType, gen_ccsl_complexType_JInterface_annotation_AnnotableElement, gen_ccsl_complexType_AnonymousClass_ComplexType, gen_ccsl_complexType_JClass_complexType_DeclaredType, gen_ccsl_complexType_JClass_complexType_ComplexType, gen_ccsl_complexType_JClass_annotation_AnnotableElement, gen_ccsl_statements_VariableAccess_Access, gen_ccsl_statements_DataTypeAccess_Access, gen_ccsl_statements_ControlFlow_Statement, gen_ccsl_statements_Block_Statement, gen_ccsl_statements_VarDeclaration_Statement, gen_ccsl_statements_InstanceCreation_Statement, gen_ccsl_method_Constructor_SimpleMethod, gen_ccsl_method_SimpleMethod_elements_Element, gen_ccsl_method_SimpleMethod_annotation_AnnotableElement, gen_ccsl_method_Method_namedElements_NamedElement, gen_ccsl_method_Method_method_SimpleMethod, gen_ccsl_statements_Statement_Element, gen_ccsl_statements_EmptyStatement_Statement, gen_ccsl_statements_NamedElementAccess_Statement, gen_ccsl_statements_InstanceOf_Statement, gen_ccsl_statements_ReturnStatement_Statement, gen_ccsl_statements_ThisStatement_Statement, gen_ccsl_statements_BreakStatement_Statement, gen_ccsl_statements_ContinueStatement_Statement, gen_ccsl_expressions_OperatorExpression_Statement, gen_ccsl_expressions_ParenthesizedExpression_Statement, gen_ccsl_statements_Access_Statement, gen_ccsl_statements_ArrayCreation_Statement, gen_ccsl_statements_SynchronizedBlock_Statement, gen_ccsl_literalValues_LiteralValue_Statement, gen_ccsl_literalValues_NullLiteral_LiteralValue, gen_ccsl_literalValues_CharacterLiteral_LiteralValue, gen_ccsl_literalValues_StringLiteral_LiteralValue, gen_ccsl_literalValues_NumberLiteral_LiteralValue, gen_ccsl_literalValues_BooleanLiteral_LiteralValue, gen_ccsl_controlFlow_SwitchStatement_ControlFlow, gen_ccsl_controlFlow_SwitchCaseBlock_Block, gen_ccsl_controlFlow_IfStatement_ControlFlow, gen_ccsl_expressions_StringConcatenation_OperatorExpression, gen_ccsl_expressions_InfixExpression_OperatorExpression, gen_ccsl_expressions_BooleanExpression_OperatorExpression, gen_ccsl_expressions_ArithmeticExpression_OperatorExpression, gen_ccsl_assignment_AbstractAssignment_Statement, gen_ccsl_assignment_Assignment_AbstractAssignment, gen_ccsl_assignment_UnaryAssignment_AbstractAssignment, gen_ccsl_assignment_PrefixUnaryAssignment_UnaryAssignment, gen_ccsl_assignment_PostfixUnaryAssignment_UnaryAssignment, gen_ccsl_controlFlow_LoopStatement_ControlFlow, gen_ccsl_tryCatch_TryStatement_Statement, gen_ccsl_tryCatch_CatchClause_Statement, gen_ccsl_annotation_Annotation_Statement, gen_ccsl_annotation_AnnotableElement_Element, gen_ccsl_datatype_DataType_Element, gen_ccsl_datatype_PrimitiveType_DataType, gen_ccsl_datatype_StringPrimitiveType_PrimitiveType, gen_ccsl_datatype_BooleanPrimitiveType_PrimitiveType, gen_ccsl_datatype_ShortPrimitiveType_PrimitiveType, gen_ccsl_invocation_MethodInvocation_SimpleMethodInvocation, gen_ccsl_invocation_SuperMethodInvocation_SimpleMethodInvocation, gen_ccsl_invocation_Invocation_Statement, gen_ccsl_invocation_ConstructorInvocation_Invocation, gen_ccsl_invocation_SimpleMethodInvocation_Invocation, gen_ccsl_import_ImportableElement_Element, gen_ccsl_import_ImportStatement_Statement, gen_ccsl_action_DeleteAction_InjectionAction, gen_ccsl_action_MoveScopeUpAction_InjectionAction, gen_ccsl_action_DeleteInfixOperatorAction_InjectionAction, gen_ccsl_action_ChangeLiteralValueAction_InjectionAction, gen_ccsl_action_DeleteRandomStatementAction_InjectionAction, gen_ccsl_action_ReplaceVariableAccessAction_InjectionAction, gen_ccsl_action_ReplaceArithmeticOperatorAction_InjectionAction, gen_ccsl_strategy_AllStrategy_InjectionStrategy, gen_ccsl_datatype_ObjectType_DataType, gen_ccsl_datatype_ParameterizedType_ObjectType, gen_ccsl_datatype_GenericType_ComplexType, gen_ccsl_datatype_IntPrimitiveType_PrimitiveType, gen_ccsl_datatype_ArrayType_ObjectType, gen_ccsl_datatype_VoidType_PrimitiveType, gen_ccsl_filters_CountFilter_AtomicFilter, gen_ccsl_filters_RegexMatch_AtomicFilter, gen_ccsl_filters_ImplicityOperandFilter_TemplateFilter, gen_ccsl_filters_ImplicityContainerFilter_AtomicFilter, gen_ccsl_booleanFunctions_CcslBooleanFunction_CcslFunction, gen_ccsl_filters_Filter_CcslBooleanFunction, gen_ccsl_filters_AtomicFilter_Filter, gen_ccsl_filters_CompositeFilter_Filter, gen_ccsl_filters_PropertyFilter_AtomicFilter, gen_ccsl_filters_TemplateFilter_AtomicFilter, gen_ccsl_filters_SameNameFilter_AtomicFilter, gen_ccsl_filters_ChildClosureComplexTypeFilter_AtomicFilter, gen_ccsl_filters_IsStringFilter_AtomicFilter, gen_ccsl_filters_IsKindOfFilter_AtomicFilter, gen_ccsl_filters_SuperMethodClosureFilter_AtomicFilter, gen_ccsl_filters_IsTypeOfFilter_AtomicFilter, gen_ccsl_filters_HasSameReferenceFilter_AtomicFilter, gen_ccsl_numberFunctions_CcslNumberFunction_CcslFunction, gen_ccsl_numberFunctions_CcslIntegerLiteral_CcslNumberFunction, gen_ccsl_numberFunctions_GetIndexOf_CcslNumberFunction, gen_ccsl_filters_FromClosureFilter_AtomicFilter, gen_ccsl_filters_SuperClassClosureFilter_AtomicFilter, gen_ccsl_filters_BlockLastStatementFilter_AtomicFilter},
    metadata=None
)
