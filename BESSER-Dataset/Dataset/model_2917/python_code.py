...
class persistence_DataTypeAttribute(EntityAttribute):
    ...
    def __init__(self, caseInsensitive: bool, encrypt: bool, obfuscateFormFields: bool, persistence_DataTypeAttribute: "persistence_DataType" = None):
...
class persistence_AssociationKey:
    ...
    def __init__(self, targetColumnName: str, AssociationKey: "persistence_EntityAssociation" = None, keys: "persistence_EntityAssociation" = None, persistence_AssociationKey: "persistence_EntityFeature" = None, persistence_AssociationKey65: "persistence_EntityFeature" = None):
...
class EntityFeature:
    ...
    pass
class persistence_EntityAttribute(Attribute, EntityFeature):
...
class NamedDisplayElement:
    ...
    pass
class persistence_ViewAssociation(NamedDisplayElement, Association, ViewFeature):
...
class persistence_EntityAssociation(EntityFeature, Association):
    ...
    def __init__(self, bidirectional: bool, pivotTableName: str, targetFeatureName: str, targetPrimaryKey: bool, targetDisplayLabel: str, targetHeaderClass: str, targetInputClass: str, targetDisplayClass: str, targetFooterClass: str, persistence_EntityAssociation: "persistence_ModelLabelAssociation" = None, EntityAssociation: "persistence_Entity" = None, keyFor: set["persistence_AssociationKey"] = None, associationEnds: "persistence_Entity" = None, EntityAssociation62: "persistence_AssociationKey" = None):
...
class persistence_EncapsulatedAssociation(EncapsulatedFeature, Association):
    ...
    def __init__(self, isSourceAssociation: bool, cardinality: str, name: str, EncapsulatedAssociation: "persistence_Association" = None, persistence_EncapsulatedAssociation78: "persistence_Entity" = None, persistence_EncapsulatedAssociation80: "persistence_Entity" = None, persistence_EncapsulatedAssociation83: "persistence_ViewAssociation" = None, encapsulatedBy: "persistence_Association" = None, persistence_EncapsulatedAssociation: "persistence_EncapsulatedAssociation" = None, persistence_EncapsulatedAssociation75: "persistence_EncapsulatedAssociation" = None):
        self.isSourceAssociation = isSourceAssociation
        self.cardinality = cardinality
        self.name = name
...
class persistence_Feature(ABC):
    ...
    def __init__(self, headerClass: str, displayClass: str, footerClass: str, title: str, collectionAllowAdd: bool, collectionAllowRemove: bool, nullDisplayValue: str, encodeUriKey: bool, persistence_Feature16: "persistence_EntityOrView" = None, persistence_Feature19: "persistence_EntityOrView" = None, persistence_Feature: "persistence_EntityOrView" = None, persistence_Feature9: "persistence_EntityOrView" = None, persistence_Feature12: "persistence_EntityOrView" = None, persistence_Feature28: set["persistence_SerializationGroup"] = None):
...
class persistence_ModelLabel(NamedElement, Label):
    ...
    def __init__(self, format: str, ModelLabel: "persistence_EntityOrView" = None, labels: "persistence_EntityOrView" = None, partOf: set["persistence_ModelLabelFeature"] = None, persistence_ModelLabel: set["persistence_SerializationGroup"] = None, persistence_ModelLabel50: "persistence_ModelLabelAssociation" = None, ModelLabel44: "persistence_ModelLabelFeature" = None):
        self.format = format
...
class persistence_EntityOrView(Classifier):
    ...
    def __init__(self, singletonName: str, pluralisedName: str, tableName: str, autoKeyName: str, autoKeyPersistentType: str, autoKeyGenerationStrategy: str, implementsUserInterface: bool, labelFor: set["persistence_ModelLabel"] = None, persistence_EntityOrView15: set["persistence_Feature"] = None, persistence_EntityOrView18: set["persistence_Feature"] = None, persistence_EntityOrView21: set["persistence_Attribute"] = None, persistence_EntityOrView23: set["persistence_Association"] = None, persistence_EntityOrView: "persistence_Persistence" = None, persistence_EntityOrView6: set["persistence_Feature"] = None, persistence_EntityOrView8: set["persistence_Feature"] = None, persistence_EntityOrView11: set["persistence_Feature"] = None, persistence_EntityOrView25: set["persistence_Association"] = None, persistence_EntityOrView35: "persistence_Association" = None, persistence_EntityOrView38: "persistence_Association" = None, EntityOrView: "persistence_ModelLabel" = None, persistence_EntityOrView68: "persistence_View" = None):
        self.singletonName = singletonName
        self.pluralisedName = pluralisedName
...
class persistence_Persistence:
    ...
    def __init__(self, ormTechnology: str, databaseTechnology: str, databasePrefix: str, databaseHost: str, databaseName: str, databasePort: str, databaseUsername: str, databasePassword: str, timestampCreation: bool, timestampUpdates: bool, persistence_Persistence: set["persistence_SerializationGroup"] = None, persistence_Persistence2: set["persistence_DataType"] = None, persistence_Persistence4: set["persistence_EntityOrView"] = None):
