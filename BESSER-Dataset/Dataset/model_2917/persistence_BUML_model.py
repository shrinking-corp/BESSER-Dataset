...
# Classes
persistence_Persistence = Class(name="persistence_Persistence")
persistence_SerializationGroup = Class(name="persistence_SerializationGroup")
persistence_DataType = Class(name="persistence_DataType")
persistence_EntityOrView = Class(name="persistence_EntityOrView", is_abstract=True)
NamedElement = Class(name="NamedElement")
Classifier = Class(name="Classifier")
persistence_Feature = Class(name="persistence_Feature", is_abstract=True)
persistence_ModelLabel = Class(name="persistence_ModelLabel")
persistence_Attribute = Class(name="persistence_Attribute", is_abstract=True)
persistence_Association = Class(name="persistence_Association", is_abstract=True)
Feature = Class(name="Feature")
Label = Class(name="Label")
persistence_Expression = Class(name="persistence_Expression")
persistence_EncapsulatedAssociation = Class(name="persistence_EncapsulatedAssociation")
persistence_Label = Class(name="persistence_Label", is_abstract=True)
persistence_ModelLabelFeature = Class(name="persistence_ModelLabelFeature", is_abstract=True)
persistence_ModelLabelAssociation = Class(name="persistence_ModelLabelAssociation")
persistence_EntityAssociation = Class(name="persistence_EntityAssociation", is_abstract=True)
persistence_Entity = Class(name="persistence_Entity")
EntityOrView = Class(name="EntityOrView")
persistence_EntityFeature = Class(name="persistence_EntityFeature", is_abstract=True)
NamedDisplayElement = Class(name="NamedDisplayElement")
persistence_EntityAttribute = Class(name="persistence_EntityAttribute", is_abstract=True)
EntityFeature = Class(name="EntityFeature")
Attribute = Class(name="Attribute")
persistence_ModelLabelAttribute = Class(name="persistence_ModelLabelAttribute")
ModelLabelFeature = Class(name="ModelLabelFeature")
persistence_DateAttribute = Class(name="persistence_DateAttribute")
persistence_UrlAttribute = Class(name="persistence_UrlAttribute")
persistence_ResourceAttribute = Class(name="persistence_ResourceAttribute", is_abstract=True)
persistence_PathElement = Class(name="persistence_PathElement", is_abstract=True)
persistence_StaticPathElement = Class(name="persistence_StaticPathElement")
PathElement = Class(name="PathElement")
persistence_DatePathElement = Class(name="persistence_DatePathElement")
persistence_FileAttribute = Class(name="persistence_FileAttribute")
ResourceAttribute = Class(name="ResourceAttribute")
persistence_ImageAttribute = Class(name="persistence_ImageAttribute")
persistence_LocationAttribute = Class(name="persistence_LocationAttribute")
Association = Class(name="Association")
persistence_AssociationKey = Class(name="persistence_AssociationKey")
persistence_DataTypeAttribute = Class(name="persistence_DataTypeAttribute")
EntityAttribute = Class(name="EntityAttribute")
persistence_AssociationWithContainment = Class(name="persistence_AssociationWithContainment")
persistence_View = Class(name="persistence_View")
persistence_ViewFeature = Class(name="persistence_ViewFeature", is_abstract=True)
persistence_EncapsulatedFeature = Class(name="persistence_EncapsulatedFeature")
ViewFeature = Class(name="ViewFeature")
persistence_EncapsulatedAttribute = Class(name="persistence_EncapsulatedAttribute")
EncapsulatedFeature = Class(name="EncapsulatedFeature")
persistence_AssociationWithoutContainment = Class(name="persistence_AssociationWithoutContainment")
EntityAssociation = Class(name="EntityAssociation")
persistence_ViewAssociation = Class(name="persistence_ViewAssociation")
...
persistence_Persistence.attributes={persistence_Persistence_databaseHost, persistence_Persistence_databaseUsername, persistence_Persistence_ormTechnology, persistence_Persistence_databasePrefix, persistence_Persistence_databasePassword, persistence_Persistence_databaseName, persistence_Persistence_databasePort, persistence_Persistence_timestampUpdates, persistence_Persistence_timestampCreation, persistence_Persistence_databaseTechnology}
...
persistence_EntityOrView.attributes={persistence_EntityOrView_implementsUserInterface, persistence_EntityOrView_singletonName, persistence_EntityOrView_autoKeyName, persistence_EntityOrView_autoKeyGenerationStrategy, persistence_EntityOrView_autoKeyPersistentType, persistence_EntityOrView_pluralisedName, persistence_EntityOrView_tableName}
...
persistence_Feature.attributes={persistence_Feature_nullDisplayValue, persistence_Feature_displayClass, persistence_Feature_collectionAllowAdd, persistence_Feature_footerClass, persistence_Feature_title, persistence_Feature_collectionAllowRemove, persistence_Feature_encodeUriKey, persistence_Feature_headerClass}
...
persistence_Attribute.attributes={persistence_Attribute_inputClass, persistence_Attribute_validationPattern, persistence_Attribute_placeholder}
...
persistence_Association.attributes={persistence_Association_pseudo, persistence_Association_inputClass, persistence_Association_serializationMaxDepth}
...
persistence_EncapsulatedAssociation.attributes={persistence_EncapsulatedAssociation_cardinality, persistence_EncapsulatedAssociation_name, persistence_EncapsulatedAssociation_isSourceAssociation}
...
persistence_EntityAssociation.attributes={persistence_EntityAssociation_targetHeaderClass, persistence_EntityAssociation_targetFooterClass, persistence_EntityAssociation_targetPrimaryKey, persistence_EntityAssociation_bidirectional, persistence_EntityAssociation_targetFeatureName, persistence_EntityAssociation_targetDisplayClass, persistence_EntityAssociation_pivotTableName, persistence_EntityAssociation_targetInputClass, persistence_EntityAssociation_targetDisplayLabel}
...
persistence_EntityFeature.attributes={persistence_EntityFeature_columnName, persistence_EntityFeature_pluralisedName, persistence_EntityFeature_singletonName, persistence_EntityFeature_booleanIsHasChoice, persistence_EntityFeature_ordered, persistence_EntityFeature_cardinality, persistence_EntityFeature_unique}
...
persistence_EntityAttribute.attributes={persistence_EntityAttribute_ormType, persistence_EntityAttribute_interfaceType, persistence_EntityAttribute_primaryKey, persistence_EntityAttribute_containerUnique, persistence_EntityAttribute_persistentType}
...
persistence_DateAttribute.attributes={persistence_DateAttribute_format, persistence_DateAttribute_details}
...
persistence_ResourceAttribute.attributes={persistence_ResourceAttribute_maximumUploadSize, persistence_ResourceAttribute_uploadsWithinWebsite, persistence_ResourceAttribute_validUploadMimeTypes, persistence_ResourceAttribute_validUploadExtensions}
...
persistence_DataTypeAttribute.attributes={persistence_DataTypeAttribute_encrypt, persistence_DataTypeAttribute_obfuscateFormFields, persistence_DataTypeAttribute_caseInsensitive}
...
domain_model = DomainModel(
    name="persistence",
    types={persistence_Persistence, persistence_SerializationGroup, persistence_DataType, persistence_EntityOrView, NamedElement, Classifier, persistence_Feature, persistence_ModelLabel, persistence_Attribute, persistence_Association, Feature, Label, persistence_Expression, persistence_EncapsulatedAssociation, persistence_Label, persistence_ModelLabelFeature, persistence_ModelLabelAssociation, persistence_EntityAssociation, persistence_Entity, EntityOrView, persistence_EntityFeature, NamedDisplayElement, persistence_EntityAttribute, EntityFeature, Attribute, persistence_ModelLabelAttribute, ModelLabelFeature, persistence_DateAttribute, persistence_UrlAttribute, persistence_ResourceAttribute, persistence_PathElement, persistence_StaticPathElement, PathElement, persistence_DatePathElement, persistence_FileAttribute, ResourceAttribute, persistence_ImageAttribute, persistence_LocationAttribute, Association, persistence_AssociationKey, persistence_DataTypeAttribute, EntityAttribute, persistence_AssociationWithContainment, persistence_View, persistence_ViewFeature, persistence_EncapsulatedFeature, ViewFeature, persistence_EncapsulatedAttribute, EncapsulatedFeature, persistence_AssociationWithoutContainment, EntityAssociation, persistence_ViewAssociation, DatabaseTechnologies, OrmTechnologies, Cardinality, isHasChoices, DateDetails},
    associations={serializationGroups0, dataTypes1, entities3, keys5, unique7, containerUnique10, labels13, features14, allFeatures17, attributes20, associations22, allAssociations24, serializationGroups27, defaultValue30, encapsulatedBy32, sourceEntityX33, targetEntityX36, labelFor39, features40, serializationGroups41, association47, dynamicLabel48, entityFeatures51, associationEnds53, partOf54, partOf43, attribute45, uploadPath57, keys58, targetEntity59, dataType55, keyFor61, sourceFeature63, targetFeature64, encapsulates67, viewFeatures69, partOf71, attribute72, sourceEntity77, targetEntity79, opposite82, association74, encapsulatedTarget76},
    generalizations={gen_persistence_SerializationGroup_NamedElement, gen_persistence_EntityOrView_Classifier, gen_persistence_Attribute_Feature, gen_persistence_Attribute_Label, gen_persistence_Association_Feature, gen_persistence_ModelLabel_NamedElement, gen_persistence_ModelLabel_Label, gen_persistence_ModelLabelAssociation_ModelLabelFeature, gen_persistence_Entity_EntityOrView, gen_persistence_EntityFeature_NamedDisplayElement, gen_persistence_EntityFeature_Feature, gen_persistence_EntityAttribute_EntityFeature, gen_persistence_EntityAttribute_Attribute, gen_persistence_ModelLabelAttribute_ModelLabelFeature, gen_persistence_DateAttribute_EntityAttribute, gen_persistence_UrlAttribute_EntityAttribute, gen_persistence_ResourceAttribute_EntityAttribute, gen_persistence_StaticPathElement_PathElement, gen_persistence_DatePathElement_PathElement, gen_persistence_FileAttribute_ResourceAttribute, gen_persistence_ImageAttribute_ResourceAttribute, gen_persistence_LocationAttribute_EntityAttribute, gen_persistence_EntityAssociation_EntityFeature, gen_persistence_EntityAssociation_Association, gen_persistence_DataTypeAttribute_EntityAttribute, gen_persistence_AssociationWithContainment_EntityAssociation, gen_persistence_View_EntityOrView, gen_persistence_ViewFeature_Feature, gen_persistence_EncapsulatedFeature_ViewFeature, gen_persistence_EncapsulatedAttribute_EncapsulatedFeature, gen_persistence_EncapsulatedAttribute_Attribute, gen_persistence_EncapsulatedAssociation_EncapsulatedFeature, gen_persistence_EncapsulatedAssociation_Association, gen_persistence_AssociationWithoutContainment_EntityAssociation, gen_persistence_ViewAssociation_NamedDisplayElement, gen_persistence_ViewAssociation_ViewFeature, gen_persistence_ViewAssociation_Association},
    metadata=None
)
