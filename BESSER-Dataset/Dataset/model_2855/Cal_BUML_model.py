...
cal_Function = Class(name="cal_Function")
cal_AstProcedure = Class(name="cal_AstProcedure")
cal_Variable = Class(name="cal_Variable")
...
cal_LocalFsm = Class(name="cal_LocalFsm")
cal_ScheduleFsm = Class(name="cal_ScheduleFsm")
cal_RegExp = Class(name="cal_RegExp")
cal_Priority = Class(name="cal_Priority")
cal_Statement = Class(name="cal_Statement")
cal_AstTag = Class(name="cal_AstTag")
cal_Inequality = Class(name="cal_Inequality")
cal_AstState = Class(name="cal_AstState")
cal_Fsm = Class(name="cal_Fsm")
cal_AstTransition = Class(name="cal_AstTransition")
cal_ExternalTarget = Class(name="cal_ExternalTarget")
cal_StatementForeach = Class(name="cal_StatementForeach")
cal_InputPattern = Class(name="cal_InputPattern")
cal_OutputPattern = Class(name="cal_OutputPattern")
cal_Guard = Class(name="cal_Guard")
cal_StatementAssign = Class(name="cal_StatementAssign")
Statement = Class(name="Statement")
cal_VariableReference = Class(name="cal_VariableReference")
cal_ExpressionIf = Class(name="cal_ExpressionIf")
cal_StatementCall = Class(name="cal_StatementCall")
cal_StatementIf = Class(name="cal_StatementIf")
cal_StatementElsif = Class(name="cal_StatementElsif")
cal_StatementWhile = Class(name="cal_StatementWhile")
cal_ExpressionCall = Class(name="cal_ExpressionCall")
AstExpression = Class(name="AstExpression")
cal_ExpressionIndex = Class(name="cal_ExpressionIndex")
cal_AstTypeList = Class(name="cal_AstTypeList")
cal_ExpressionElsif = Class(name="cal_ExpressionElsif")
cal_ExpressionList = Class(name="cal_ExpressionList")
cal_Generator = Class(name="cal_Generator")
cal_ExpressionVariable = Class(name="cal_ExpressionVariable")
cal_ExpressionLiteral = Class(name="cal_ExpressionLiteral")
cal_ExpressionBoolean = Class(name="cal_ExpressionBoolean")
ExpressionLiteral = Class(name="ExpressionLiteral")
cal_ExpressionFloat = Class(name="cal_ExpressionFloat")
cal_ExpressionInteger = Class(name="cal_ExpressionInteger")
cal_ExpressionString = Class(name="cal_ExpressionString")
cal_AstTypeBool = Class(name="cal_AstTypeBool")
AstType = Class(name="AstType")
cal_AstTypeFloat = Class(name="cal_AstTypeFloat")
cal_AstTypeHalf = Class(name="cal_AstTypeHalf")
cal_AstTypeDouble = Class(name="cal_AstTypeDouble")
cal_AstTypeInt = Class(name="cal_AstTypeInt")
cal_AstTypeString = Class(name="cal_AstTypeString")
cal_AstTypeUint = Class(name="cal_AstTypeUint")
cal_AnnotationArgument = Class(name="cal_AnnotationArgument")
cal_RegExpBinary = Class(name="cal_RegExpBinary")
RegExp = Class(name="RegExp")
cal_RegExpUnary = Class(name="cal_RegExpUnary")
cal_RegExpTag = Class(name="cal_RegExpTag")
cal_ExpressionBinary = Class(name="cal_ExpressionBinary")
cal_ExpressionUnary = Class(name="cal_ExpressionUnary")
...
cal_AstEntity.attributes={cal_AstEntity_package, cal_AstEntity_name}
...
cal_AstState.attributes={cal_AstState_name, cal_AstState_node}
...
from_115: BinaryAssociation = BinaryAssociation(
    name="from_115",
    ends={
...
else_196: BinaryAssociation = BinaryAssociation(
    name="else_196",
    ends={
...
else_233: BinaryAssociation = BinaryAssociation(
    name="else_233",
    ends={
...
domain_model = DomainModel(
    name="cal",
    types={cal_AstEntity, cal_Import, cal_AstAnnotation, cal_AstActor, cal_AstUnit, cal_Function, cal_AstProcedure, cal_Variable, cal_AstExpression, cal_AstType, cal_AstPort, cal_AstAction, cal_LocalFsm, cal_ScheduleFsm, cal_RegExp, cal_Priority, cal_Statement, cal_AstTag, cal_Inequality, cal_AstState, cal_Fsm, cal_AstTransition, cal_ExternalTarget, cal_StatementForeach, cal_InputPattern, cal_OutputPattern, cal_Guard, cal_StatementAssign, Statement, cal_VariableReference, cal_ExpressionIf, cal_StatementCall, cal_StatementIf, cal_StatementElsif, cal_StatementWhile, cal_ExpressionCall, AstExpression, cal_ExpressionIndex, cal_AstTypeList, cal_ExpressionElsif, cal_ExpressionList, cal_Generator, cal_ExpressionVariable, cal_ExpressionLiteral, cal_ExpressionBoolean, ExpressionLiteral, cal_ExpressionFloat, cal_ExpressionInteger, cal_ExpressionString, cal_AstTypeBool, AstType, cal_AstTypeFloat, cal_AstTypeHalf, cal_AstTypeDouble, cal_AstTypeInt, cal_AstTypeString, cal_AstTypeUint, cal_AnnotationArgument, cal_RegExpBinary, RegExp, cal_RegExpUnary, cal_RegExpTag, cal_ExpressionBinary, cal_ExpressionUnary},
    associations={imports0, annotations1, actor3, unit5, functions7, procedures9, variables11, value13, annotations15, type18, expression71, dimensions20, annotations74, parameters23, inputs26, outputs28, functions31, procedures34, actions37, initializes39, stateVariables42, localFsms45, scheduleFsm47, scheduleRegExp49, priorities51, annotations53, type56, annotations59, parameters62, type65, variables68, exp122, parameters77, variables80, statements83, tags85, inequalities86, initialState89, contents91, transitions93, states95, source98, tag101, target104, externalTarget107, fsm109, state112, from_115, to118, procedure173, arguments175, contents124, annotations127, tag130, inputs133, outputs135, guard137, variables139, statements142, port145, tokens148, repeat151, port154, values157, repeat160, expressions163, target166, indexes167, value170, condition226, then228, variable178, lower180, higher183, statements186, condition189, then191, elsifs194, else_196, condition199, then202, condition205, statements207, annotations210, annotations213, function215, parameters218, source221, indexes223, type259, size261, elsifs231, else_233, condition236, then239, expressions242, generators244, variable246, lower249, higher252, value255, size257, size264, variable266, arguments269, left271, right273, child276, tag278, left280, right282, expression285},
    generalizations={gen_cal_StatementCall_Statement, gen_cal_StatementAssign_Statement, gen_cal_ExpressionIf_AstExpression, gen_cal_StatementForeach_Statement, gen_cal_StatementIf_Statement, gen_cal_StatementWhile_Statement, gen_cal_ExpressionCall_AstExpression, gen_cal_ExpressionIndex_AstExpression, gen_cal_AstTypeList_AstType, gen_cal_ExpressionList_AstExpression, gen_cal_ExpressionVariable_AstExpression, gen_cal_ExpressionLiteral_AstExpression, gen_cal_ExpressionBoolean_ExpressionLiteral, gen_cal_ExpressionFloat_ExpressionLiteral, gen_cal_ExpressionInteger_ExpressionLiteral, gen_cal_ExpressionString_ExpressionLiteral, gen_cal_AstTypeBool_AstType, gen_cal_AstTypeFloat_AstType, gen_cal_AstTypeHalf_AstType, gen_cal_AstTypeDouble_AstType, gen_cal_AstTypeInt_AstType, gen_cal_AstTypeString_AstType, gen_cal_AstTypeUint_AstType, gen_cal_RegExpBinary_RegExp, gen_cal_RegExpUnary_RegExp, gen_cal_RegExpTag_RegExp, gen_cal_ExpressionBinary_AstExpression, gen_cal_ExpressionUnary_AstExpression},
    metadata=None
)
