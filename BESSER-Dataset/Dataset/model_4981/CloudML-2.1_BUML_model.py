...
# Classes
cloudml_core_CloudMLElementWithProperties = Class(name="cloudml_core_CloudMLElementWithProperties", is_abstract=True)
Property_ = Class(name="Property")
Resource = Class(name="Resource")
cloudml_core_CloudMLElement = Class(name="cloudml_core_CloudMLElement", is_abstract=True)
cloudml_core_Property = Class(name="cloudml_core_Property")
...
cloudml_core_Resource = Class(name="cloudml_core_Resource")
CloudMLElementWithProperties = Class(name="CloudMLElementWithProperties")
cloudml_core_CloudMLModel = Class(name="cloudml_core_CloudMLModel")
...
cloudml_core_RequiredPort = Class(name="cloudml_core_RequiredPort")
Port = Class(name="Port")
ResourcesPool = Class(name="ResourcesPool")
cloudml_core_VM = Class(name="cloudml_core_VM")
VMPort = Class(name="VMPort")
cloudml_core_VMPort = Class(name="cloudml_core_VMPort")
cloudml_core_Provider = Class(name="cloudml_core_Provider")
cloudml_core_Component = Class(name="cloudml_core_Component", is_abstract=True)
ProvidedPort = Class(name="ProvidedPort")
ProvidedExecutionPlatform = Class(name="ProvidedExecutionPlatform")
cloudml_core_InternalComponent = Class(name="cloudml_core_InternalComponent")
RequiredPort = Class(name="RequiredPort")
RequiredExecutionPlatform = Class(name="RequiredExecutionPlatform")
cloudml_core_Port = Class(name="cloudml_core_Port", is_abstract=True)
cloudml_core_RequiredPortInstance = Class(name="cloudml_core_RequiredPortInstance")
PortInstance = Class(name="PortInstance")
cloudml_core_ProvidedPortInstance = Class(name="cloudml_core_ProvidedPortInstance")
cloudml_core_ProvidedPort = Class(name="cloudml_core_ProvidedPort")
cloudml_core_Relationship = Class(name="cloudml_core_Relationship")
cloudml_core_Cloud = Class(name="cloudml_core_Cloud")
cloudml_core_VMInstance = Class(name="cloudml_core_VMInstance")
VMPortInstance = Class(name="VMPortInstance")
cloudml_core_VMPortInstance = Class(name="cloudml_core_VMPortInstance")
cloudml_core_ComponentInstance = Class(name="cloudml_core_ComponentInstance", is_abstract=True)
...
cloudml_core_InternalComponentInstance = Class(name="cloudml_core_InternalComponentInstance")
...
cloudml_core_PortInstance = Class(name="cloudml_core_PortInstance")
cloudml_core_RequiredExecutionPlatform = Class(name="cloudml_core_RequiredExecutionPlatform")
cloudml_core_RequiredExecutionPlatformInstance = Class(name="cloudml_core_RequiredExecutionPlatformInstance")
cloudml_core_ExecuteInstance = Class(name="cloudml_core_ExecuteInstance")
cloudml_core_RelationshipInstance = Class(name="cloudml_core_RelationshipInstance")
cloudml_core_ExternalComponent = Class(name="cloudml_core_ExternalComponent")
cloudml_core_ExternalComponentInstance = Class(name="cloudml_core_ExternalComponentInstance")
cloudml_core_ExecutionPlatform = Class(name="cloudml_core_ExecutionPlatform", is_abstract=True)
cloudml_core_ExecutionPlatformInstance = Class(name="cloudml_core_ExecutionPlatformInstance", is_abstract=True)
ExecutionPlatform = Class(name="ExecutionPlatform")
cloudml_core_ProvidedExecutionPlatform = Class(name="cloudml_core_ProvidedExecutionPlatform")
cloudml_core_ProvidedExecutionPlatformInstance = Class(name="cloudml_core_ProvidedExecutionPlatformInstance")
ExecutionPlatformInstance = Class(name="ExecutionPlatformInstance")
cloudml_core_PuppetResource = Class(name="cloudml_core_PuppetResource")
cloudml_core_ResourcesPool = Class(name="cloudml_core_ResourcesPool")
cloudml_core_DockerResource = Class(name="cloudml_core_DockerResource")
...
cloudml_core_Resource.attributes={cloudml_core_Resource_startCommand, cloudml_core_Resource_installCommand, cloudml_core_Resource_uploadCommand, cloudml_core_Resource_downloadCommand, cloudml_core_Resource_configureCommand, cloudml_core_Resource_executeLocally, cloudml_core_Resource_stopCommand, cloudml_core_Resource_requireCredentials}
...
cloudml_core_VM.attributes={cloudml_core_VM_is64os, cloudml_core_VM_privateKey, cloudml_core_VM_securityGroup, cloudml_core_VM_minRam, cloudml_core_VM_maxRam, cloudml_core_VM_minStorage, cloudml_core_VM_os, cloudml_core_VM_imageId, cloudml_core_VM_maxStorage, cloudml_core_VM_groupName, cloudml_core_VM_sshKey, cloudml_core_VM_maxCores, cloudml_core_VM_providerSpecificTypeName, cloudml_core_VM_minCores}
...
cloudml_core_Provider.attributes={cloudml_core_Provider_login, cloudml_core_Provider_credentials, cloudml_core_Provider_password}
...
cloudml_core_ExternalComponent.attributes={cloudml_core_ExternalComponent_serviceType, cloudml_core_ExternalComponent_location, cloudml_core_ExternalComponent_login, cloudml_core_ExternalComponent_passwd, cloudml_core_ExternalComponent_Region, cloudml_core_ExternalComponent_endPoint}
...
cloudml_core_PuppetResource.attributes={cloudml_core_PuppetResource_repositoryKey, cloudml_core_PuppetResource_masterEndpoint, cloudml_core_PuppetResource_configureHostnameCommand, cloudml_core_PuppetResource_username, cloudml_core_PuppetResource_manifestEntry, cloudml_core_PuppetResource_configurationFile, cloudml_core_PuppetResource_repositoryEndpoint}
...
cloudml_core_ResourcesPool.attributes={cloudml_core_ResourcesPool_maxReplicats, cloudml_core_ResourcesPool_nbReplicats, cloudml_core_ResourcesPool_type, cloudml_core_ResourcesPool_minReplicats}
...
domain_model = DomainModel(
    name="cloudml",
    types={cloudml_core_CloudMLElementWithProperties, Property_, Resource, cloudml_core_CloudMLElement, cloudml_core_Property, CloudMLElement, Relationship, RelationshipInstance, ExecuteInstance, PuppetResource, DockerResource, cloudml_core_Resource, CloudMLElementWithProperties, cloudml_core_CloudMLModel, Provider, Component, Cloud, ComponentInstance, InternalComponent, ExternalComponent, InternalComponentInstance, ExternalComponentInstance, VM, VMInstance, cloudml_core_RequiredPort, Port, ResourcesPool, cloudml_core_VM, VMPort, cloudml_core_VMPort, cloudml_core_Provider, cloudml_core_Component, ProvidedPort, ProvidedExecutionPlatform, cloudml_core_InternalComponent, RequiredPort, RequiredExecutionPlatform, cloudml_core_Port, cloudml_core_RequiredPortInstance, PortInstance, cloudml_core_ProvidedPortInstance, cloudml_core_ProvidedPort, cloudml_core_Relationship, cloudml_core_Cloud, cloudml_core_VMInstance, VMPortInstance, cloudml_core_VMPortInstance, cloudml_core_ComponentInstance, ProvidedPortInstance, ProvidedExecutionPlatformInstance, cloudml_core_InternalComponentInstance, RequiredPortInstance, RequiredExecutionPlatformInstance, cloudml_core_PortInstance, cloudml_core_RequiredExecutionPlatform, cloudml_core_RequiredExecutionPlatformInstance, cloudml_core_ExecuteInstance, cloudml_core_RelationshipInstance, cloudml_core_ExternalComponent, cloudml_core_ExternalComponentInstance, cloudml_core_ExecutionPlatform, cloudml_core_ExecutionPlatformInstance, ExecutionPlatform, cloudml_core_ProvidedExecutionPlatform, cloudml_core_ProvidedExecutionPlatformInstance, ExecutionPlatformInstance, cloudml_core_PuppetResource, cloudml_core_ResourcesPool, cloudml_core_DockerResource},
    associations={properties0, resources1, relationships26, relationshipInstances28, executesInstances30, puppetResources3, dockerResources5, providers7, components8, clouds10, componentInstances12, internalComponents14, externalComponents16, internalComponentInstances18, externalComponentInstances20, vms22, vmInstances24, component44, resourcePools32, provided34, providedPorts35, providedExecutionPlatforms36, requiredPorts38, compositeInternalComponents39, requiredExecutionPlatform42, type71, componentInstance72, requiredPort46, providedPort48, requiredPortResource51, providedPortResource54, vmInstances57, provided59, type60, providedPortInstances62, type63, providedExecutionPlatformInstances66, requiredPortInstances68, requiredExecutionPlatformInstance69, demands98, type75, requiredPortInstance77, providedPortInstance80, provider83, provide85, provide88, owner90, owner92, type94, offers96, providedExecutionPlatformInstance100, requiredExecutionPlatformInstance102, baseInstances105, replicats107},
    generalizations={gen_cloudml_core_CloudMLElementWithProperties_CloudMLElement, gen_cloudml_core_Property_CloudMLElement, gen_cloudml_core_Resource_CloudMLElementWithProperties, gen_cloudml_core_CloudMLModel_CloudMLElementWithProperties, gen_cloudml_core_Port_CloudMLElementWithProperties, gen_cloudml_core_RequiredPort_Port, gen_cloudml_core_VM_ExternalComponent, gen_cloudml_core_VMPort_CloudMLElementWithProperties, gen_cloudml_core_Provider_CloudMLElementWithProperties, gen_cloudml_core_Component_CloudMLElementWithProperties, gen_cloudml_core_InternalComponent_Component, gen_cloudml_core_RequiredPortInstance_PortInstance, gen_cloudml_core_ProvidedPortInstance_PortInstance, gen_cloudml_core_ProvidedPort_Port, gen_cloudml_core_Relationship_CloudMLElementWithProperties, gen_cloudml_core_Cloud_CloudMLElementWithProperties, gen_cloudml_core_VMInstance_ExternalComponentInstance, gen_cloudml_core_VMPortInstance_CloudMLElementWithProperties, gen_cloudml_core_ComponentInstance_CloudMLElementWithProperties, gen_cloudml_core_InternalComponentInstance_ComponentInstance, gen_cloudml_core_PortInstance_CloudMLElementWithProperties, gen_cloudml_core_RequiredExecutionPlatform_ExecutionPlatform, gen_cloudml_core_RequiredExecutionPlatformInstance_ExecutionPlatformInstance, gen_cloudml_core_ExecuteInstance_CloudMLElementWithProperties, gen_cloudml_core_RelationshipInstance_CloudMLElementWithProperties, gen_cloudml_core_ExternalComponent_Component, gen_cloudml_core_ExternalComponentInstance_ComponentInstance, gen_cloudml_core_ExecutionPlatform_CloudMLElementWithProperties, gen_cloudml_core_ExecutionPlatformInstance_CloudMLElementWithProperties, gen_cloudml_core_ProvidedExecutionPlatform_ExecutionPlatform, gen_cloudml_core_ProvidedExecutionPlatformInstance_ExecutionPlatformInstance, gen_cloudml_core_PuppetResource_Resource, gen_cloudml_core_ResourcesPool_CloudMLElementWithProperties, gen_cloudml_core_DockerResource_Resource},
    metadata=None
)
