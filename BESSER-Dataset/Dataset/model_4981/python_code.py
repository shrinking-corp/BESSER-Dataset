...
class cloudml_core_VMInstance(ExternalComponentInstance):
    ...
    def __init__(self, publicAddress: str, id: str, cloudml_core_VMInstance: set["VMPortInstance"] = None, ExternalComponentInstance: "cloudml_core_CloudMLModel" = None):
...
class cloudml_core_ExternalComponentInstance(ComponentInstance):
    ...
    def __init__(self, ips: str, cloudml_core_ExternalComponentInstance: set["VMPortInstance"] = None, ComponentInstance74: "cloudml_core_PortInstance" = None, ComponentInstance: "cloudml_core_CloudMLModel" = None, ComponentInstance93: "cloudml_core_ExecutionPlatformInstance" = None):
        self.ips = ips
...
class cloudml_core_PuppetResource(Resource):
    ...
    def __init__(self, masterEndpoint: str, repositoryEndpoint: str, configureHostnameCommand: str, username: str, repositoryKey: str, configurationFile: str, manifestEntry: str, Resource56: "cloudml_core_Relationship" = None, Resource: "cloudml_core_CloudMLElementWithProperties" = None, Resource53: "cloudml_core_Relationship" = None):
...
class cloudml_core_DockerResource(Resource):
    ...
    def __init__(self, image: str, dockerFilePath: str, Resource56: "cloudml_core_Relationship" = None, Resource: "cloudml_core_CloudMLElementWithProperties" = None, Resource53: "cloudml_core_Relationship" = None):
        self.image = image
