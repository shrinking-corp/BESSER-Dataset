...
# Classes
graphEditor_Graph = Class(name="graphEditor_Graph")
graphEditor_Node = Class(name="graphEditor_Node", is_abstract=True)
graphEditor_Edge = Class(name="graphEditor_Edge")
graphEditor_Message = Class(name="graphEditor_Message")
graphEditor_GraphElement = Class(name="graphEditor_GraphElement", is_abstract=True)
GraphElement = Class(name="GraphElement")
graphEditor_Factornode = Class(name="graphEditor_Factornode")
Node = Class(name="Node")
graphEditor_Variablenode = Class(name="graphEditor_Variablenode")
...
graphEditor_Graph_m_getGraphElement: Method = Method(name="getGraphElement", parameters={Parameter(name='graphEditor_id', type=StringType)}, type=StringType)
graphEditor_Graph_m_getConnectingVariablenodes: Method = Method(name="getConnectingVariablenodes", parameters={Parameter(name='graphEditor_node', type=StringType)}, type=StringType)
graphEditor_Graph.attributes={graphEditor_Graph_result, graphEditor_Graph_name}
graphEditor_Graph.methods={graphEditor_Graph_m_getGraphElement, graphEditor_Graph_m_getConnectingVariablenodes}
...
graphEditor_Variablenode.attributes={graphEditor_Variablenode_values, graphEditor_Variablenode_isKnown, graphEditor_Variablenode_type}
...
domain_model = DomainModel(
    ...
    associations={nodes0, edges1, messages3, from_11, to14, from_5, to8},
    generalizations={gen_graphEditor_Node_GraphElement, gen_graphEditor_Factornode_Node, gen_graphEditor_Variablenode_Node, gen_graphEditor_Edge_GraphElement, gen_graphEditor_Message_GraphElement},
    metadata=None
)
