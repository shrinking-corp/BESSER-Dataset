...
class graphEditor_Message(GraphElement):
    ...
    def __init__(self, type: str, count: int, graphEditor_Message: "graphEditor_Graph" = None, graphEditor_Message6: "graphEditor_Node" = None, graphEditor_Message9: "graphEditor_Node" = None):
        self.type = type
        self.count = count
...
class graphEditor_Node(GraphElement):
    ...
    def __init__(self, name: str, graphEditor_Node: "graphEditor_Graph" = None, graphEditor_Node13: "graphEditor_Edge" = None, graphEditor_Node16: "graphEditor_Edge" = None, graphEditor_Node7: "graphEditor_Message" = None, graphEditor_Node10: "graphEditor_Message" = None):
        self.name = name
