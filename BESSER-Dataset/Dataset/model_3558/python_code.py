...
class xs_OrExpression(Expression):
    ...
    def __init__(self, op: str, xs_OrExpression: "xs_Expression" = None, xs_OrExpression67: "xs_Expression" = None):
        self.op = op
...
class xs_ParameterDeclaration(VarDeclaration):
    ...
    pass
class xs_LocalVarDeclaration(Statement, VarDeclaration):
...
class xs_VarDeclaration:
    ...
    def __init__(self, name: str, xs_VarDeclaration26: "xs_Var" = None, xs_VarDeclaration28: "xs_PostfixStatement" = None, xs_VarDeclaration: "xs_Expression" = None):
        self.name = name
...
class xs_FunctionDeclaration(Declaration):
    ...
    def __init__(self, name: str, mutable: bool, xs_FunctionDeclaration: "xs_Type" = None, xs_FunctionDeclaration10: set["xs_ParameterDeclaration"] = None, xs_FunctionDeclaration13: "xs_Block" = None, xs_FunctionDeclaration95: "xs_Call" = None):
        self.name = name
