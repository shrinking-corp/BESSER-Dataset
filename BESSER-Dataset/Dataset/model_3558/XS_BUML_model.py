...
# Classes
xs_Block = Class(name="xs_Block")
xs_RuleDeclaration = Class(name="xs_RuleDeclaration")
xs_Program = Class(name="xs_Program")
xs_Declaration = Class(name="xs_Declaration")
xs_IncludeDeclaration = Class(name="xs_IncludeDeclaration")
Declaration = Class(name="Declaration")
xs_VarDeclaration = Class(name="xs_VarDeclaration")
xs_Expression = Class(name="xs_Expression")
xs_LocalVarDeclaration = Class(name="xs_LocalVarDeclaration")
VarDeclaration = Class(name="VarDeclaration")
Statement = Class(name="Statement")
xs_Type = Class(name="xs_Type")
xs_GlobalVarDeclaration = Class(name="xs_GlobalVarDeclaration")
xs_ParameterDeclaration = Class(name="xs_ParameterDeclaration")
xs_ForVarDeclaration = Class(name="xs_ForVarDeclaration")
xs_FunctionDeclaration = Class(name="xs_FunctionDeclaration")
xs_SwitchStatement = Class(name="xs_SwitchStatement")
xs_Statement = Class(name="xs_Statement")
xs_SwitchCase = Class(name="xs_SwitchCase")
xs_SwitchDefault = Class(name="xs_SwitchDefault")
xs_Var = Class(name="xs_Var")
Expression = Class(name="Expression")
xs_Literal = Class(name="xs_Literal")
xs_PostfixStatement = Class(name="xs_PostfixStatement")
xs_IfElseStatement = Class(name="xs_IfElseStatement")
xs_WhileStatement = Class(name="xs_WhileStatement")
xs_ForStatement = Class(name="xs_ForStatement")
xs_Term = Class(name="xs_Term")
xs_ReturnStatement = Class(name="xs_ReturnStatement")
xs_ContinueStatement = Class(name="xs_ContinueStatement")
xs_BreakStatement = Class(name="xs_BreakStatement")
xs_Assign = Class(name="xs_Assign")
xs_OrExpression = Class(name="xs_OrExpression")
xs_AndExpression = Class(name="xs_AndExpression")
xs_EqualsExpression = Class(name="xs_EqualsExpression")
xs_ComparisonExpression = Class(name="xs_ComparisonExpression")
xs_Factor = Class(name="xs_Factor")
xs_Call = Class(name="xs_Call")
xs_LiteralString = Class(name="xs_LiteralString")
Literal = Class(name="Literal")
xs_LiteralInt = Class(name="xs_LiteralInt")
xs_LiteralFloat = Class(name="xs_LiteralFloat")
xs_LiteralBool = Class(name="xs_LiteralBool")
xs_VectorLiteral = Class(name="xs_VectorLiteral")
xs_IntType = Class(name="xs_IntType")
Type = Class(name="Type")
xs_FloatType = Class(name="xs_FloatType")
xs_BoolType = Class(name="xs_BoolType")
xs_VectorType = Class(name="xs_VectorType")
xs_StringType = Class(name="xs_StringType")
xs_VoidType = Class(name="xs_VoidType")
...
xs_RuleDeclaration.attributes={xs_RuleDeclaration_runImmediately, xs_RuleDeclaration_active, xs_RuleDeclaration_highFrequency, xs_RuleDeclaration_priority, xs_RuleDeclaration_group, xs_RuleDeclaration_minInterval, xs_RuleDeclaration_maxInterval, xs_RuleDeclaration_name}
...
domain_model = DomainModel(
    name="xs",
    types={xs_Block, xs_RuleDeclaration, xs_Program, xs_Declaration, xs_IncludeDeclaration, Declaration, xs_VarDeclaration, xs_Expression, xs_LocalVarDeclaration, VarDeclaration, Statement, xs_Type, xs_GlobalVarDeclaration, xs_ParameterDeclaration, xs_ForVarDeclaration, xs_FunctionDeclaration, xs_SwitchStatement, xs_Statement, xs_SwitchCase, xs_SwitchDefault, xs_Var, Expression, xs_Literal, xs_PostfixStatement, xs_IfElseStatement, xs_WhileStatement, xs_ForStatement, xs_Term, xs_ReturnStatement, xs_ContinueStatement, xs_BreakStatement, xs_Assign, xs_OrExpression, xs_AndExpression, xs_EqualsExpression, xs_ComparisonExpression, xs_Factor, xs_Call, xs_LiteralString, Literal, xs_LiteralInt, xs_LiteralFloat, xs_LiteralBool, xs_VectorLiteral, xs_IntType, Type, xs_FloatType, xs_BoolType, xs_VectorType, xs_StringType, xs_VoidType},
    associations={type7, parameters9, body12, declarations0, value1, type2, type3, type5, var42, end43, statement46, body14, contents16, value18, statement20, statement23, declaration25, var27, condition29, thenStatement31, elseStatement34, condition37, statement39, right81, left84, expression49, cases51, default54, expression57, var59, expression61, left64, right66, left69, right71, left74, right76, left79, right86, left89, right91, function94, arguments96, x99, y101, z104},
    generalizations={gen_xs_RuleDeclaration_Declaration, gen_xs_IncludeDeclaration_Declaration, gen_xs_LocalVarDeclaration_VarDeclaration, gen_xs_LocalVarDeclaration_Statement, gen_xs_GlobalVarDeclaration_Declaration, gen_xs_GlobalVarDeclaration_VarDeclaration, gen_xs_ParameterDeclaration_VarDeclaration, gen_xs_ForVarDeclaration_VarDeclaration, gen_xs_FunctionDeclaration_Declaration, gen_xs_ForStatement_Statement, gen_xs_SwitchStatement_Statement, gen_xs_Block_Statement, gen_xs_Expression_Statement, gen_xs_Var_Expression, gen_xs_Literal_Expression, gen_xs_PostfixStatement_Statement, gen_xs_IfElseStatement_Statement, gen_xs_WhileStatement_Statement, gen_xs_Term_Expression, gen_xs_ReturnStatement_Statement, gen_xs_ContinueStatement_Statement, gen_xs_BreakStatement_Statement, gen_xs_Assign_Expression, gen_xs_OrExpression_Expression, gen_xs_AndExpression_Expression, gen_xs_EqualsExpression_Expression, gen_xs_ComparisonExpression_Expression, gen_xs_Factor_Expression, gen_xs_Call_Expression, gen_xs_LiteralString_Literal, gen_xs_LiteralInt_Literal, gen_xs_LiteralFloat_Literal, gen_xs_LiteralBool_Literal, gen_xs_VectorLiteral_Literal, gen_xs_IntType_Type, gen_xs_FloatType_Type, gen_xs_BoolType_Type, gen_xs_VectorType_Type, gen_xs_StringType_Type, gen_xs_VoidType_Type},
    metadata=None
)
