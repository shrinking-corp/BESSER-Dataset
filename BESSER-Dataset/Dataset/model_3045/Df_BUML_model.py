...
# Classes
df_Unit = Class(name="df_Unit")
Attributable = Class(name="Attributable")
df_Var = Class(name="df_Var")
df_Procedure = Class(name="df_Procedure")
df_Port = Class(name="df_Port")
Vertex = Class(name="Vertex")
df_Type = Class(name="df_Type")
df_Instance = Class(name="df_Instance")
Adaptable = Class(name="Adaptable")
df_Argument = Class(name="df_Argument")
df_EObject = Class(name="df_EObject")
df_Entity = Class(name="df_Entity")
df_Network = Class(name="df_Network")
Graph = Class(name="Graph")
df_Actor = Class(name="df_Actor")
df_Action = Class(name="df_Action")
df_FSM = Class(name="df_FSM")
df_MoC = Class(name="df_MoC")
df_PortToEIntegerObjectMapEntry = Class(name="df_PortToEIntegerObjectMapEntry")
df_Vertex = Class(name="df_Vertex")
df_Connection = Class(name="df_Connection")
Edge = Class(name="Edge")
df_Pattern = Class(name="df_Pattern")
df_Tag = Class(name="df_Tag")
df_State = Class(name="df_State")
df_PortToVarMapEntry = Class(name="df_PortToVarMapEntry")
df_VarToPortMapEntry = Class(name="df_VarToPortMapEntry")
df_Transition = Class(name="df_Transition")
df_Expression = Class(name="df_Expression")
...
df_Unit.attributes={df_Unit_name, df_Unit_lineNumber, df_Unit_fileName}
...
df_Port.attributes={df_Port_numTokensConsumed, df_Port_name, df_Port_numTokensProduced}
...
df_Entity.attributes={df_Entity_incomingPortMap, df_Entity_name, df_Entity_outgoingPortMap}
...
df_Network.attributes={df_Network_name, df_Network_fileName}
...
df_Actor.attributes={df_Actor_lineNumber, df_Actor_native, df_Actor_name, df_Actor_fileName}
...
domain_model = DomainModel(
    name="df",
    types={df_Unit, Attributable, df_Var, df_Procedure, df_Port, Vertex, df_Type, df_Instance, Adaptable, df_Argument, df_EObject, df_Entity, df_Network, Graph, df_Actor, df_Action, df_FSM, df_MoC, df_PortToEIntegerObjectMapEntry, df_Vertex, df_Connection, Edge, df_Pattern, df_Tag, df_State, df_PortToVarMapEntry, df_VarToPortMapEntry, df_Transition, df_Expression},
    associations={inputs7, constants0, procedures1, type3, arguments4, entity5, outputs9, parameters12, actions15, actionsOutsideFsm16, fsm19, initializes21, inputs24, moC27, outputs29, parameters32, procs35, stateVars38, numTokensMap80, children41, inputs42, moC45, outputs48, parameters51, variables54, sourcePort57, targetPort59, body62, inputPattern65, outputPattern67, peekPattern70, scheduler73, tag76, initialState78, variable111, ports82, portToVarMap85, variables87, varToPortMap90, actions92, key94, key97, value100, key103, value106, value109},
    generalizations={gen_df_Unit_Attributable, gen_df_Port_Vertex, gen_df_Instance_Vertex, gen_df_Instance_Adaptable, gen_df_Entity_Attributable, gen_df_Entity_Adaptable, gen_df_Network_Graph, gen_df_Network_Adaptable, gen_df_Actor_Vertex, gen_df_Actor_Adaptable, gen_df_Connection_Edge, gen_df_Action_Attributable, gen_df_FSM_Graph, gen_df_State_Vertex, gen_df_Transition_Edge},
    metadata=None
)
