...
class df_Instance(Vertex, Adaptable):
    ...
    def __init__(self, name: str, df_Instance6: "df_EObject" = None, df_Instance: set["df_Argument"] = None):
        self.name = name
...
class df_Actor(Vertex, Adaptable):
    ...
    def __init__(self, fileName: str, lineNumber: int, native: bool, name: str, df_Actor: set["df_Action"] = None, df_Actor17: set["df_Action"] = None, df_Actor20: "df_FSM" = None, df_Actor22: set["df_Action"] = None, df_Actor25: set["df_Port"] = None, df_Actor28: "df_MoC" = None, df_Actor30: set["df_Port"] = None, df_Actor33: set["df_Var"] = None, df_Actor36: set["df_Procedure"] = None, df_Actor39: set["df_Var"] = None):
        self.fileName = fileName
...
class df_Port(Vertex):
    ...
    def __init__(self, name: str, numTokensConsumed: int, numTokensProduced: int, df_Port11: "df_Entity" = None, df_Port26: "df_Actor" = None, df_Port31: "df_Actor" = None, df_Port8: "df_Entity" = None, df_Port: "df_Type" = None, df_Port84: "df_Pattern" = None, df_Port96: "df_PortToEIntegerObjectMapEntry" = None, df_Port99: "df_PortToVarMapEntry" = None, df_Port44: "df_Network" = None, df_Port50: "df_Network" = None, df_Port58: "df_Connection" = None, df_Port61: "df_Connection" = None, df_Port108: "df_VarToPortMapEntry" = None):
        self.name = name
...
class Attributable:
    ...
    pass
class df_Entity(Attributable, Adaptable):

    def __init__(self, name: str, incomingPortMap: str, outgoingPortMap: str, df_Entity10: set["df_Port"] = None, df_Entity13: set["df_Var"] = None, df_Entity: set["df_Port"] = None):
        self.name = name
