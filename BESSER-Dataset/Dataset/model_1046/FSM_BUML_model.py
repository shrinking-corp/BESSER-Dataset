...
domain_model = DomainModel(
    name="FSM",
    types={FSM_Transition, MgaObject, FSM_MgaObject, FSM_RootFolder, FSM_StateMachine, FSM_AssociationStateState, FSM_State},
    associations={associationStateStatesrc7, rootFolder9, stateMachine0, associationStateState1, stateMachine3, associationStateStatedst5, transition18, dstTransition20, srcTransition22, state10, transition12, rootFolders15, stateMachine16},
    generalizations={gen_FSM_Transition_MgaObject, gen_FSM_StateMachine_MgaObject, gen_FSM_State_MgaObject},
    metadata=None
)
