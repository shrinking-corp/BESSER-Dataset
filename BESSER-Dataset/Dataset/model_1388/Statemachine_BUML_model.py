...
statemachine_ComplexState = Class(name="statemachine_ComplexState")
...
statemachine_LabeledTransition = Class(name="statemachine_LabeledTransition")
...
statemachine_ComplexState.methods={statemachine_ComplexState_m_innerTransitions, statemachine_ComplexState_m_directSubStates, statemachine_ComplexState_m_realInitialStates}
...
domain_model = DomainModel(
    name="statemachine",
    types={statemachine_Vertex, statemachine_Transition, statemachine_State, Vertex, statemachine_ComplexState, statemachine_Region, statemachine_Statemachine, Region, statemachine_Action, statemachine_Pseudostate, State, statemachine_LabeledTransition, Transition, PseudostateKind},
    associations={outgoings0, super1, region2, source4, target7, transitions10, actions12, states14, initial17, action19},
    generalizations={gen_statemachine_State_Vertex, gen_statemachine_Statemachine_Region, gen_statemachine_Pseudostate_Vertex, gen_statemachine_ComplexState_State, gen_statemachine_LabeledTransition_Transition},
    metadata=None
)
