...
def test_hyp_statemachine_region_realinitialstate_changes_state(instance):
...
@given(instance=statemachine_ComplexState_strategy)
@settings(max_examples=30)
def test_hyp_statemachine_complexstate_innertransitions_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
...
@given(instance=statemachine_ComplexState_strategy)
@settings(max_examples=30)
def test_hyp_statemachine_complexstate_realinitialstates_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
...
def test_assoc_initial17_link_reassign_clear():
    a = statemachine_Region()
    b1 = statemachine_Pseudostate(id="sample_text", kind="sample_text")
    b2 = statemachine_Pseudostate(id="sample_text_2", kind="sample_text_2")
    _safe_set(a, 'statemachine_Region18', b1)
    assert _is_linked(a, 'statemachine_Region18', b1)
    if hasattr(b1, 'statemachine_Pseudostate'):
        assert _is_linked(b1, 'statemachine_Pseudostate', a)
    _safe_set(a, 'statemachine_Region18', b2)
    assert _is_linked(a, 'statemachine_Region18', b2)
    if hasattr(b1, 'statemachine_Pseudostate'):
    ...
    _safe_set(a, 'statemachine_Region18', None)
    assert not _is_linked(a, 'statemachine_Region18', b2)
    if hasattr(b2, 'statemachine_Pseudostate'):
...
def test_assoc_region2_link_reassign_clear():
    ...
    if hasattr(b1, 'statemachine_ComplexState3'):
        assert _is_linked(b1, 'statemachine_ComplexState3', a)
    _safe_set(a, 'statemachine_Region', b2)
    assert _is_linked(a, 'statemachine_Region', b2)
    if hasattr(b1, 'statemachine_ComplexState3'):
        assert not _is_linked(b1, 'statemachine_ComplexState3', a)
    if hasattr(b2, 'statemachine_ComplexState3'):
        assert _is_linked(b2, 'statemachine_ComplexState3', a)
    _safe_set(a, 'statemachine_Region', None)
    assert not _is_linked(a, 'statemachine_Region', b2)
    if hasattr(b2, 'statemachine_ComplexState3'):
        assert not _is_linked(b2, 'statemachine_ComplexState3', a)
