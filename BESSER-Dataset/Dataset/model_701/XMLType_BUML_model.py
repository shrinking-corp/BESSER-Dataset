...
type_XMLTypeDocumentRoot.attributes={type_XMLTypeDocumentRoot_text, type_XMLTypeDocumentRoot_cDATA, type_XMLTypeDocumentRoot_mixed, type_XMLTypeDocumentRoot_comment}
...
domain_model = DomainModel(
    name="type",
    types={type_AnyType, type_ProcessingInstruction, type_XMLTypeDocumentRoot, type_SimpleAnyType, AnyType, type_EDataType, type_EStringToStringMapEntry},
