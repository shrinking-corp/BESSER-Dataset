...
class fsm_Transition:
    ...
    def __init__(self, event: str, outgoing: "fsm_State" = None, incoming: "fsm_State" = None, Transition: "fsm_Machine" = None, Transition5: "fsm_State" = None, Transition7: "fsm_State" = None, transitions: "fsm_Machine" = None):
        self.event = event
...
class fsm_State:
    ...
    def __init__(self, name: str, State13: "fsm_Transition" = None, State: "fsm_Machine" = None, states: "fsm_Machine" = None, target: set["fsm_Transition"] = None, source: set["fsm_Transition"] = None, State11: "fsm_Transition" = None):
        self.name = name
...
class fsm_Machine:
    ...
    def __init__(self, name: str, owning: set["fsm_State"] = None, owning2: set["fsm_Transition"] = None, Machine: "fsm_State" = None, Machine9: "fsm_Transition" = None):
        self.name = name
