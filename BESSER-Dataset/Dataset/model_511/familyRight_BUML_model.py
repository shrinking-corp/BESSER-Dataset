...
# Classes
familyright_Son = Class(name="familyright_Son")
familyright_Daughter = Class(name="familyright_Daughter")
familyright_Father = Class(name="familyright_Father")
familyright_Family = Class(name="familyright_Family")
familyright_Mother = Class(name="familyright_Mother")
...
familyright_Son.attributes={familyright_Son_name, familyright_Son_age}
...
familyright_Daughter.attributes={familyright_Daughter_name, familyright_Daughter_age}
...
domain_model = DomainModel(
    name="familyright",
    types={familyright_Son, familyright_Daughter, familyright_Father, familyright_Family, familyright_Mother},
    associations={family1, family3, family5, family0, father7, mother8, sons10, daughters12},
    generalizations={},
    metadata=None
)
