...
class statesml_Function:
    ...
    def __init__(self, name: str, statesml_Function: "statesml_RegularState" = None, statesml_Function28: "statesml_SystemUnit" = None, statesml_Function30: set["statesml_Parameter"] = None, statesml_Function32: "statesml_Parameter" = None, statesml_Function35: "statesml_DataType" = None):
        self.name = name
...
class statesml_Node(ABC):
    ...
    def __init__(self, name: str, Node: "statesml_Transition" = None, node: set["statesml_Transition"] = None, statesml_Node: "statesml_StatesMLModel" = None, statesml_Node18: "statesml_Edge" = None, statesml_Node21: "statesml_Edge" = None):
        self.name = name
        self.Node = Node
