...
domain_model = DomainModel(
    name="services",
    types={services_CIID, Base, services_CFSService, Service, services_DerivedResource, BaseResource, services_Value, services_DistributionEntry, services_NetXResource, services_Lifecycle, services_RFSService, services_Node, services_Tolerance, services_Service, services_ServiceForecast, services_ServiceMonitor, services_ServiceUser, services_ServiceDistribution, services_ReferenceRelationship, services_Expression, services_ServiceFlow, services_ServiceFlowRelationship, services_Protocol, services_Message, services_DateTimeRange, services_ServiceForecastUsers, services_ResourceForecast, services_ResourceMonitor, services_ServiceProfile, ResourceOriginType, ServiceClassType, ServiceFlowDirection},
    associations={distribution8, values0, forecastValues1, trendedValues4, resourceRef7, lifecycle15, services18, nodes11, toleranceRefs12, cIID14, serviceForecasts20, serviceMonitors22, serviceUserRefs24, serviceDistribution26, referenceRelationship34, serviceFlow36, distributionEntries28, expressionRefs31, serviceFlowRelationships33, protocol39, message41, period43, serviceForecastUsers45, resourceForecasts47, profileResources60, userValues49, serviceUserRef52, period55, resourceMonitors58, serviceProfile62, expressionRef65},
    generalizations={gen_services_CIID_Base, gen_services_CFSService_Service, gen_services_DerivedResource_BaseResource, gen_services_DistributionEntry_Base, gen_services_RFSService_Service, gen_services_Service_Base, gen_services_ServiceDistribution_Base, gen_services_ServiceFlow_Base, gen_services_ServiceFlowRelationship_Base, gen_services_ServiceForecastUsers_Base, gen_services_ServiceForecast_Base, gen_services_ServiceMonitor_Base, gen_services_ServiceProfile_Base, gen_services_ServiceUser_Base},
    metadata=None
)
