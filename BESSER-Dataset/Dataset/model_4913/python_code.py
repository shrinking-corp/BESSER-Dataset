...
class services_ServiceUser(Base):
    ...
    def __init__(self, description: str, name: str, services_ServiceUser54: "services_ServiceForecastUsers" = None, services_ServiceUser63: "services_ServiceProfile" = None, services_ServiceUser66: "services_Expression" = None, services_ServiceUser: "services_Service" = None):
...
class services_Service(Base):
    ...
    def __init__(self, serviceCategory: str, serviceClass: str, serviceDescription: str, serviceName: str, services_Service16: "services_Lifecycle" = None, services_Service19: "services_Service" = None, services_Service17: set["services_Service"] = None, services_Service: set["services_CIID"] = None, services_Service21: set["services_ServiceForecast"] = None, services_Service23: set["services_ServiceMonitor"] = None, services_Service25: set["services_ServiceUser"] = None, services_Service27: "services_ServiceDistribution" = None):
...
class services_ServiceFlowRelationship(Base):
    ...
    def __init__(self, direction: str, services_ServiceFlowRelationship: "services_ServiceFlow" = None, services_ServiceFlowRelationship40: "services_Protocol" = None, services_ServiceFlowRelationship42: "services_Message" = None, services_ServiceFlowRelationship35: "services_ReferenceRelationship" = None, services_ServiceFlowRelationship37: "services_ServiceFlow" = None):
