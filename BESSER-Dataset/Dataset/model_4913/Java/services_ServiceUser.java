...
public class services_ServiceUser extends Base {
    ...
    private services_Expression services_expression;
    ...
    public services_Expression getServices_expression() {
        return services_expression;
    }

    public void setServices_expression(services_Expression services_expression) {
        this.services_expression = services_expression;
    }
