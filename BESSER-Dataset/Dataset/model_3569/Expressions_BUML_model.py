...
# Classes
expressions_Imply = Class(name="expressions_Imply")
expressions_Or = Class(name="expressions_Or")
expressions_Expression = Class(name="expressions_Expression")
expressions_LExpression = Class(name="expressions_LExpression")
Expression = Class(name="Expression")
expressions_CExpression = Class(name="expressions_CExpression")
LExpression = Class(name="LExpression")
expressions_SomeValue = Class(name="expressions_SomeValue")
CExpression = Class(name="CExpression")
expressions_AExpression = Class(name="expressions_AExpression")
SomeValue = Class(name="SomeValue")
expressions_NumberValue = Class(name="expressions_NumberValue")
AExpression = Class(name="AExpression")
expressions_BooleanValue = Class(name="expressions_BooleanValue")
expressions_StringValue = Class(name="expressions_StringValue")
expressions_Variable = Class(name="expressions_Variable")
expressions_Equivalent = Class(name="expressions_Equivalent")
expressions_Greater = Class(name="expressions_Greater")
expressions_Equal = Class(name="expressions_Equal")
expressions_Xor = Class(name="expressions_Xor")
expressions_And = Class(name="expressions_And")
expressions_Not = Class(name="expressions_Not")
expressions_LessOrEqual = Class(name="expressions_LessOrEqual")
expressions_Less = Class(name="expressions_Less")
expressions_GreaterOrEqual = Class(name="expressions_GreaterOrEqual")
expressions_Div = Class(name="expressions_Div")
expressions_Mod = Class(name="expressions_Mod")
expressions_Unequal = Class(name="expressions_Unequal")
expressions_Approx = Class(name="expressions_Approx")
expressions_Plus = Class(name="expressions_Plus")
expressions_Minus = Class(name="expressions_Minus")
expressions_Multi = Class(name="expressions_Multi")
expressions_Pow = Class(name="expressions_Pow")
...
not_24: BinaryAssociation = BinaryAssociation(
    name="not_24",
    ends={
...
domain_model = DomainModel(
    name="expressions",
    types={expressions_Imply, expressions_Or, expressions_Expression, expressions_LExpression, Expression, expressions_CExpression, LExpression, expressions_SomeValue, CExpression, expressions_AExpression, SomeValue, expressions_NumberValue, AExpression, expressions_BooleanValue, expressions_StringValue, expressions_Variable, expressions_Equivalent, expressions_Greater, expressions_Equal, expressions_Xor, expressions_And, expressions_Not, expressions_LessOrEqual, expressions_Less, expressions_GreaterOrEqual, expressions_Div, expressions_Mod, expressions_Unequal, expressions_Approx, expressions_Plus, expressions_Minus, expressions_Multi, expressions_Pow},
    associations={left4, right6, left9, right11, left0, right1, right37, left40, right42, left14, right16, left19, right21, not_24, left26, right27, left30, right32, left35, left74, right76, left79, left45, right47, left50, right52, left55, right57, left60, right61, left64, right66, left69, right71, right81, left84, right86},
    generalizations={gen_expressions_Imply_LExpression, gen_expressions_Or_LExpression, gen_expressions_LExpression_Expression, gen_expressions_CExpression_LExpression, gen_expressions_SomeValue_CExpression, gen_expressions_AExpression_Expression, gen_expressions_AExpression_SomeValue, gen_expressions_NumberValue_AExpression, gen_expressions_BooleanValue_LExpression, gen_expressions_BooleanValue_SomeValue, gen_expressions_StringValue_SomeValue, gen_expressions_Variable_LExpression, gen_expressions_Variable_AExpression, gen_expressions_Equivalent_LExpression, gen_expressions_Greater_CExpression, gen_expressions_Equal_CExpression, gen_expressions_Xor_LExpression, gen_expressions_And_LExpression, gen_expressions_Not_LExpression, gen_expressions_LessOrEqual_CExpression, gen_expressions_Less_CExpression, gen_expressions_GreaterOrEqual_CExpression, gen_expressions_Div_AExpression, gen_expressions_Mod_AExpression, gen_expressions_Unequal_CExpression, gen_expressions_Approx_CExpression, gen_expressions_Plus_AExpression, gen_expressions_Minus_AExpression, gen_expressions_Multi_AExpression, gen_expressions_Pow_AExpression},
    metadata=None
)
