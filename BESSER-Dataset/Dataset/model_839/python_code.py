...
class tfsm_plaink3_Transition(NamedElement):
    ...
    def __init__(self, action: str, tfsm_plaink3_Transition27: "tfsm_plaink3_FSMEvent" = None, incomingTransitions: "tfsm_plaink3_State" = None, tfsm_plaink3_Transition17: "tfsm_plaink3_Guard" = None, tfsm_plaink3_Transition19: set["tfsm_plaink3_FSMEvent"] = None, tfsm_plaink3_Transition: "tfsm_plaink3_TFSM" = None, Transition: "tfsm_plaink3_State" = None, Transition11: "tfsm_plaink3_State" = None, outgoingTransitions: "tfsm_plaink3_State" = None):
        self.action = action
