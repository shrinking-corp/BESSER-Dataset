...
domain_model = DomainModel(
    name="tfsm_plaink3",
    types={tfsm_plaink3_TFSM, NamedElement, tfsm_plaink3_State, tfsm_plaink3_FSMEvent, tfsm_plaink3_FSMClock, tfsm_plaink3_Transition, tfsm_plaink3_EventGuard, tfsm_plaink3_Guard, tfsm_plaink3_TimedSystem, tfsm_plaink3_NamedElement, tfsm_plaink3_EvaluateGuard, tfsm_plaink3_TemporalGuard, Guard},
    associations={ownedStates0, initialState1, localEvents2, localClock4, ownedTransitions6, owningFSM8, outgoingTransitions9, incomingTransitions10, triggeringEvent23, source12, sollicitingTransitions25, target14, ownedGuard16, generatedEvents18, tfsms28, globalClocks30, globalEvents33, onClock21},
    generalizations={gen_tfsm_plaink3_TFSM_NamedElement, gen_tfsm_plaink3_State_NamedElement, gen_tfsm_plaink3_EventGuard_Guard, gen_tfsm_plaink3_Transition_NamedElement, gen_tfsm_plaink3_FSMEvent_NamedElement, gen_tfsm_plaink3_FSMClock_NamedElement, gen_tfsm_plaink3_TimedSystem_NamedElement, gen_tfsm_plaink3_Guard_NamedElement, gen_tfsm_plaink3_EvaluateGuard_Guard, gen_tfsm_plaink3_TemporalGuard_Guard},
    metadata=None
)
