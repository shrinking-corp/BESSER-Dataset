...
def test_tfsm_plaink3_FSMClock_isa_NamedElement():
    instance = tfsm_plaink3_FSMClock()
    assert isinstance(instance, NamedElement)


def test_tfsm_plaink3_FSMEvent_isa_NamedElement():
    instance = tfsm_plaink3_FSMEvent()
    assert isinstance(instance, NamedElement)
...
def test_assoc_generatedEvents18_link_reassign_clear():
    ...
    b1 = tfsm_plaink3_FSMEvent()
    b2 = tfsm_plaink3_FSMEvent()
    _safe_set(a, 'tfsm_plaink3_Transition19', {b1})
    assert _is_linked(a, 'tfsm_plaink3_Transition19', b1)
    if hasattr(b1, 'tfsm_plaink3_FSMEvent20'):
        assert _is_linked(b1, 'tfsm_plaink3_FSMEvent20', a)
    _safe_set(a, 'tfsm_plaink3_Transition19', {b2})
    assert _is_linked(a, 'tfsm_plaink3_Transition19', b2)
    if hasattr(b1, 'tfsm_plaink3_FSMEvent20'):
        assert not _is_linked(b1, 'tfsm_plaink3_FSMEvent20', a)
    if hasattr(b2, 'tfsm_plaink3_FSMEvent20'):
        assert _is_linked(b2, 'tfsm_plaink3_FSMEvent20', a)
    _safe_set(a, 'tfsm_plaink3_Transition19', set())
    assert not _is_linked(a, 'tfsm_plaink3_Transition19', b2)
    if hasattr(b2, 'tfsm_plaink3_FSMEvent20'):
        assert not _is_linked(b2, 'tfsm_plaink3_FSMEvent20', a)
...
def test_assoc_onClock21_link_reassign_clear():
    ...
    b1 = tfsm_plaink3_FSMClock()
    b2 = tfsm_plaink3_FSMClock()
    _safe_set(a, 'tfsm_plaink3_TemporalGuard', b1)
    assert _is_linked(a, 'tfsm_plaink3_TemporalGuard', b1)
    if hasattr(b1, 'tfsm_plaink3_FSMClock22'):
        assert _is_linked(b1, 'tfsm_plaink3_FSMClock22', a)
    _safe_set(a, 'tfsm_plaink3_TemporalGuard', b2)
    assert _is_linked(a, 'tfsm_plaink3_TemporalGuard', b2)
    if hasattr(b1, 'tfsm_plaink3_FSMClock22'):
        assert not _is_linked(b1, 'tfsm_plaink3_FSMClock22', a)
    if hasattr(b2, 'tfsm_plaink3_FSMClock22'):
        assert _is_linked(b2, 'tfsm_plaink3_FSMClock22', a)
    _safe_set(a, 'tfsm_plaink3_TemporalGuard', None)
    assert not _is_linked(a, 'tfsm_plaink3_TemporalGuard', b2)
    if hasattr(b2, 'tfsm_plaink3_FSMClock22'):
        assert not _is_linked(b2, 'tfsm_plaink3_FSMClock22', a)
...
def test_assoc_ownedGuard16_link_reassign_clear():
    ...
    _safe_set(a, 'tfsm_plaink3_Transition17', b1)
    assert _is_linked(a, 'tfsm_plaink3_Transition17', b1)
    if hasattr(b1, 'tfsm_plaink3_Guard'):
        assert _is_linked(b1, 'tfsm_plaink3_Guard', a)
    _safe_set(a, 'tfsm_plaink3_Transition17', b2)
    assert _is_linked(a, 'tfsm_plaink3_Transition17', b2)
    if hasattr(b1, 'tfsm_plaink3_Guard'):
        assert not _is_linked(b1, 'tfsm_plaink3_Guard', a)
    if hasattr(b2, 'tfsm_plaink3_Guard'):
        assert _is_linked(b2, 'tfsm_plaink3_Guard', a)
    _safe_set(a, 'tfsm_plaink3_Transition17', None)
    assert not _is_linked(a, 'tfsm_plaink3_Transition17', b2)
    if hasattr(b2, 'tfsm_plaink3_Guard'):
...
def test_assoc_sollicitingTransitions25_link_reassign_clear():
    ...
    b1 = tfsm_plaink3_FSMEvent()
    b2 = tfsm_plaink3_FSMEvent()
    _safe_set(a, 'tfsm_plaink3_Transition27', b1)
    assert _is_linked(a, 'tfsm_plaink3_Transition27', b1)
    if hasattr(b1, 'tfsm_plaink3_FSMEvent26'):
        assert _is_linked(b1, 'tfsm_plaink3_FSMEvent26', a)
    _safe_set(a, 'tfsm_plaink3_Transition27', b2)
    assert _is_linked(a, 'tfsm_plaink3_Transition27', b2)
    if hasattr(b1, 'tfsm_plaink3_FSMEvent26'):
        assert not _is_linked(b1, 'tfsm_plaink3_FSMEvent26', a)
    if hasattr(b2, 'tfsm_plaink3_FSMEvent26'):
        assert _is_linked(b2, 'tfsm_plaink3_FSMEvent26', a)
    _safe_set(a, 'tfsm_plaink3_Transition27', None)
    assert not _is_linked(a, 'tfsm_plaink3_Transition27', b2)
    if hasattr(b2, 'tfsm_plaink3_FSMEvent26'):
        assert not _is_linked(b2, 'tfsm_plaink3_FSMEvent26', a)
...
tfsm_plaink3_FSMClock_strategy = st.builds(tfsm_plaink3_FSMClock)
...
tfsm_plaink3_FSMEvent_strategy = st.builds(tfsm_plaink3_FSMEvent)
