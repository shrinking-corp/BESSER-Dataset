...
public class xhtml_AContent  {
    ...
    public xhtml_AContent(
        String mixed,        String group        ArrayList<xhtml_KbdType> xhtml_kbdtypes,        ArrayList<xhtml_SampType> xhtml_samptypes,        ArrayList<xhtml_DfnType> xhtml_dfntypes,        ArrayList<xhtml_UType> xhtml_utypes,        ArrayList<xhtml_AbbrType> xhtml_abbrtypes,        ArrayList<xhtml_TtType> xhtml_tttypes,        ArrayList<xhtml_CodeType> xhtml_codetypes,        ArrayList<xhtml_EmType> xhtml_emtypes,        ArrayList<xhtml_BrType> xhtml_brtypes,        ArrayList<xhtml_QType> xhtml_qtypes,        ArrayList<xhtml_BType> xhtml_btypes,        ArrayList<xhtml_IType> xhtml_itypes,        ArrayList<xhtml_CiteType> xhtml_citetypes,        ArrayList<xhtml_StrikeType> xhtml_striketypes,        ArrayList<xhtml_SpanType> xhtml_spantypes,        ArrayList<xhtml_SupType> xhtml_suptypes,        ArrayList<xhtml_StrongType> xhtml_strongtypes,        ArrayList<xhtml_VarType> xhtml_vartypes,        ArrayList<xhtml_BigType> xhtml_bigtypes,        ArrayList<xhtml_SmallType> xhtml_smalltypes,        ArrayList<xhtml_AcronymType> xhtml_acronymtypes,        ArrayList<xhtml_SubType> xhtml_subtypes    ) {
        this.mixed = mixed;
        this.group = group;
