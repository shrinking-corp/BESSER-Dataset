...
def test_hyp_checked_out_usecase_is_not_abstract():
    assert not inspect.isabstract(Checked_Out_UseCase)


def test_hyp_checked_out_usecase_constructor_exists():
    assert callable(Checked_Out_UseCase.__init__)


def test_hyp_checked_out_usecase_constructor_args():
    sig = inspect.signature(Checked_Out_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_checked_in_usecase_is_not_abstract():
    assert not inspect.isabstract(Checked_In_UseCase)


def test_hyp_checked_in_usecase_constructor_exists():
    assert callable(Checked_In_UseCase.__init__)


def test_hyp_checked_in_usecase_constructor_args():
    sig = inspect.signature(Checked_In_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_acquired_usecase_is_not_abstract():
    assert not inspect.isabstract(Acquired_UseCase)


def test_hyp_acquired_usecase_constructor_exists():
    assert callable(Acquired_UseCase.__init__)


def test_hyp_acquired_usecase_constructor_args():
    sig = inspect.signature(Acquired_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_retired_usecase_is_not_abstract():
    assert not inspect.isabstract(Retired_UseCase)


def test_hyp_retired_usecase_constructor_exists():
    assert callable(Retired_UseCase.__init__)


def test_hyp_retired_usecase_constructor_args():
    sig = inspect.signature(Retired_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_book_actor_is_not_abstract():
    assert not inspect.isabstract(Book_Actor)


def test_hyp_book_actor_constructor_exists():
    assert callable(Book_Actor.__init__)


def test_hyp_book_actor_constructor_args():
...
def test_hyp_retirement_of_books_usecase_is_not_abstract():
    assert not inspect.isabstract(Retirement_of_Books_UseCase)


def test_hyp_retirement_of_books_usecase_constructor_exists():
    assert callable(Retirement_of_Books_UseCase.__init__)


def test_hyp_retirement_of_books_usecase_constructor_args():
    sig = inspect.signature(Retirement_of_Books_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_acquisition_of_books_usecase_is_not_abstract():
    assert not inspect.isabstract(Acquisition_of_Books_UseCase)


def test_hyp_acquisition_of_books_usecase_constructor_exists():
    assert callable(Acquisition_of_Books_UseCase.__init__)


def test_hyp_acquisition_of_books_usecase_constructor_args():
    sig = inspect.signature(Acquisition_of_Books_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mail_2_week_reminders_usecase_is_not_abstract():
    assert not inspect.isabstract(Mail_2_Week_Reminders_UseCase)


def test_hyp_mail_2_week_reminders_usecase_constructor_exists():
    assert callable(Mail_2_Week_Reminders_UseCase.__init__)


def test_hyp_mail_2_week_reminders_usecase_constructor_args():
...
def test_hyp_reserve_book_usecase_is_not_abstract():
    assert not inspect.isabstract(Reserve_Book_UseCase)


def test_hyp_reserve_book_usecase_constructor_exists():
    assert callable(Reserve_Book_UseCase.__init__)


def test_hyp_reserve_book_usecase_constructor_args():
...
def test_hyp_library_librarian_id_setter(instance):
...
@given(instance=Library_strategy)
def test_hyp_library_id_setter(instance):
...
def test_hyp_book_creation_date_setter(instance):
...
@given(instance=Book_strategy)
def test_hyp_book_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
@given(instance=Book_strategy)
def test_hyp_book_status_setter(instance):
...
def test_hyp_patron_status_setter(instance):
    original = instance.status
    instance.status = original
    assert instance.status == original
...
@given(instance=Patron_strategy)
def test_hyp_patron_num_books_checked_out_setter(instance):
