...
# Classes
helloworldsaved_World = Class(name="helloworldsaved_World")
helloworldsaved_Thing = Class(name="helloworldsaved_Thing")
NamedElement = Class(name="NamedElement")
helloworldsaved_RelatedTo = Class(name="helloworldsaved_RelatedTo")
helloworldsaved_NamedElement = Class(name="helloworldsaved_NamedElement", is_abstract=True)
helloworldsaved_Alias = Class(name="helloworldsaved_Alias")
...
domain_model = DomainModel(
    ...
    types={helloworldsaved_World, helloworldsaved_Thing, NamedElement, helloworldsaved_RelatedTo, helloworldsaved_NamedElement, helloworldsaved_Alias},
    associations={things0, toThing4, relations1, aliases2, fromThing3},
