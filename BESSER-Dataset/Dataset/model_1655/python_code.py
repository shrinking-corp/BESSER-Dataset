...
class helloworldsaved_RelatedTo(NamedElement):
    ...
    def __init__(self, since: str, helloworldsaved_RelatedTo: "helloworldsaved_Thing" = None, RelatedTo: "helloworldsaved_Thing" = None, relations: "helloworldsaved_Thing" = None):
        self.since = since
...
class helloworldsaved_Thing(NamedElement):
    ...
    def __init__(self, id: int, helloworldsaved_Thing: "helloworldsaved_World" = None, helloworldsaved_Thing5: "helloworldsaved_RelatedTo" = None, fromThing: set["helloworldsaved_RelatedTo"] = None, Thing: "helloworldsaved_RelatedTo" = None):
        self.id = id
