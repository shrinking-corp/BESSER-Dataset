...
# Classes
publication_PublicationProcess = Class(name="publication_PublicationProcess")
Named = Class(name="Named")
publication_PublicationPhase = Class(name="publication_PublicationPhase")
publication_Rule = Class(name="publication_Rule")
publication_Sequence = Class(name="publication_Sequence")
publication_PlaceHolderRule = Class(name="publication_PlaceHolderRule")
publication_Write = Class(name="publication_Write")
publication_Review = Class(name="publication_Review")
publication_Researcher = Class(name="publication_Researcher")
publication_PlaceHolderPP = Class(name="publication_PlaceHolderPP")
publication_ReviewNote = Class(name="publication_ReviewNote")
publication_PlaceHolderRn = Class(name="publication_PlaceHolderRn")
Labelled = Class(name="Labelled")
publication_Paper = Class(name="publication_Paper")
publication_PlaceHolderRs = Class(name="publication_PlaceHolderRs")
publication_Paragraph = Class(name="publication_Paragraph")
publication_Progress = Class(name="publication_Progress")
Counted = Class(name="Counted")
publication_Named = Class(name="publication_Named", is_abstract=True)
publication_Counted = Class(name="publication_Counted", is_abstract=True)
publication_Labelled = Class(name="publication_Labelled", is_abstract=True)
PlaceHolder = Class(name="PlaceHolder")
publication_PlaceHolder = Class(name="publication_PlaceHolder", is_abstract=True)
publication_PublicationStructure = Class(name="publication_PublicationStructure")
publication_PublicationSystem = Class(name="publication_PublicationSystem")
...
publication_PublicationProcess.attributes={publication_PublicationProcess_minTime, publication_PublicationProcess_maxTime}
...
publication_PublicationPhase.attributes={publication_PublicationPhase_minTime, publication_PublicationPhase_name, publication_PublicationPhase_maxTime}
...
publication_Rule.attributes={publication_Rule_key, publication_Rule_text}
...
publication_Researcher.attributes={publication_Researcher_forName, publication_Researcher_position, publication_Researcher_name}
...
domain_model = DomainModel(
    name="publication",
    types={publication_PublicationProcess, Named, publication_PublicationPhase, publication_Rule, publication_Sequence, publication_PlaceHolderRule, publication_Write, publication_Review, publication_Researcher, publication_PlaceHolderPP, publication_ReviewNote, publication_PlaceHolderRn, Labelled, publication_Paper, publication_PlaceHolderRs, publication_Paragraph, publication_Progress, Counted, publication_Named, publication_Counted, publication_Labelled, PlaceHolder, publication_PlaceHolder, publication_PublicationStructure, publication_PublicationSystem, SequenceType},
    associations={phases0, publicationRules1, successor11, predecessor14, placeholder17, phaseParticipation19, writes20, reviews21, linksToSuccessors3, neededPerson5, rules6, placeholder9, reviews30, placeholder32, process34, paper36, paragraph38, papers23, placeholder24, paragraphs26, progress27, authors28, structuralView51, reviewNote41, researchers44, papers46, processView49},
    generalizations={gen_publication_PublicationProcess_Named, gen_publication_ReviewNote_Named, gen_publication_Progress_Labelled, gen_publication_Write_Labelled, gen_publication_Review_Labelled, gen_publication_Paper_Named, gen_publication_Paragraph_Counted, gen_publication_Paragraph_Named, gen_publication_PlaceHolderRs_PlaceHolder, gen_publication_PlaceHolderRule_PlaceHolder, gen_publication_PlaceHolderRn_PlaceHolder, gen_publication_PlaceHolderPP_PlaceHolder, gen_publication_PublicationStructure_Named},
    metadata=None
)
