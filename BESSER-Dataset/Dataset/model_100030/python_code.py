...
class publication_Progress(Labelled):
    ...
    def __init__(self, percent: int, time: int, publication_Progress: "publication_PublicationProcess" = None, progress: "publication_Paper" = None, Progress: "publication_Paper" = None):
...
class publication_Researcher:
    ...
    def __init__(self, name: str, forName: str, position: str, publication_Researcher45: "publication_PublicationStructure" = None, neededPerson: set["publication_PublicationPhase"] = None, publication_Researcher: set["publication_Write"] = None, publication_Researcher22: set["publication_Review"] = None, Researcher: "publication_PublicationPhase" = None, authors: set["publication_Paper"] = None, publication_Researcher25: "publication_PlaceHolderRs" = None, Researcher29: "publication_Paper" = None):
        self.name = name
...
class publication_Rule:
    ...
    def __init__(self, text: str, key: str, publication_Rule: "publication_PublicationProcess" = None, publication_Rule18: "publication_PlaceHolderRule" = None, publication_Rule8: "publication_PublicationPhase" = None):
        self.text = text
        self.key = key
...
class publication_PublicationPhase:
    ...
    def __init__(self, name: str, minTime: int, maxTime: int, publication_PublicationPhase: "publication_PublicationProcess" = None, publication_PublicationPhase13: "publication_Sequence" = None, publication_PublicationPhase16: "publication_Sequence" = None, PublicationPhase: "publication_Researcher" = None, publication_PublicationPhase4: set["publication_Sequence"] = None, phaseParticipation: set["publication_Researcher"] = None, publication_PublicationPhase7: set["publication_Rule"] = None, publication_PublicationPhase10: "publication_PlaceHolderPP" = None):
        self.name = name
...
class publication_ReviewNote(Named):
    ...
    def __init__(self, content: str, publication_ReviewNote43: "publication_Review" = None, publication_ReviewNote: "publication_Paragraph" = None, publication_ReviewNote33: "publication_PlaceHolderRn" = None):
...
class publication_Paper(Named):
    ...
    pass
class publication_Paragraph(Counted, Named):

    def __init__(self, content: str, publication_Paragraph31: set["publication_ReviewNote"] = None, publication_Paragraph40: "publication_Write" = None, publication_Paragraph: "publication_Paper" = None):
        self.content = content
...
class publication_PublicationProcess(Named):
    ...
    def __init__(self, minTime: int, maxTime: int, publication_PublicationProcess: set["publication_PublicationPhase"] = None, publication_PublicationProcess2: set["publication_Rule"] = None, publication_PublicationProcess35: "publication_Progress" = None, publication_PublicationProcess50: "publication_PublicationSystem" = None):
        self.minTime = minTime
        self.maxTime = maxTime
