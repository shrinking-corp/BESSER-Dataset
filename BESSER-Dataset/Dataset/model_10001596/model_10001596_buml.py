...
Registration.attributes={Registration_UserName, Registration_name, Registration_LastName, Registration_Password, Registration_Email, Registration_DOB, Registration_Address, Registration_Phone}
...
Person.attributes={Person_Name, Person_DOB, Person_Phone, Person_Email, Person_Address, Person_LastName}
...
Product.attributes={Product_color, Product_price, Product_pID, Product_name, Product_expiry, Product_manufecturedDate, Product_manufecturer}
...
Order.attributes={Order_orderStatus, Order_id, Order_orderDate, Order_quantity}
...
Admin.attributes={Admin_password, Admin_userName, Admin_id}
...
Customer.attributes={Customer_password, Customer_id, Customer_userName}
...
Medicine.attributes={Medicine_potency, Medicine_name, Medicine_formula, Medicine_id}
...
MediDevices.attributes={MediDevices_type, MediDevices_name, MediDevices_id}
...
ExerciseMachine.attributes={ExerciseMachine_name, ExerciseMachine_size, ExerciseMachine_id, ExerciseMachine_type}
...
PaymentMethod.attributes={PaymentMethod_paymentType, PaymentMethod_online, PaymentMethod_cashOnDelievery}
