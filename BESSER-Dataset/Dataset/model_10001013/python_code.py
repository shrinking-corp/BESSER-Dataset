...
class Item:
    ...
    def __init__(self, item_code: int, item_name: str, stock20: "Stock" = None, order31: set["Order"] = None):
...
class Order:
    ...
    def __init__(self, Order_id: int, Cust_id: int, Customer_Order_11: "Customer" = None, manager23: "Manager" = None, item30: set["Item"] = None):
