...
def test_hyp_kasu4_classb_is_not_abstract():
    assert not inspect.isabstract(Kasu4_ClassB)


def test_hyp_kasu4_classb_constructor_exists():
    assert callable(Kasu4_ClassB.__init__)


def test_hyp_kasu4_classb_constructor_args():
...
def test_hyp_kasu4_classa_is_not_abstract():
    assert not inspect.isabstract(Kasu4_ClassA)


def test_hyp_kasu4_classa_constructor_exists():
    assert callable(Kasu4_ClassA.__init__)


def test_hyp_kasu4_classa_constructor_args():
...
def test_hyp_kasu4_classb_Name_setter(instance):
...
def test_hyp_kasu4_classa_Name_setter(instance):
    original = instance.Name
    instance.Name = original
    assert instance.Name == original
