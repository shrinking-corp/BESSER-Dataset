...
class Employee_DB:
    ...
    def __init__(self, Password: str, Employee_ID: int, Address: str, Telephone: int, E_Mail: str, Date_of_Birth: int, Name__1st_and_last_: Employee_Actor, Username: Log_In_UseCase, SSN: int, Title: Employee_Title__Non_Admin, Supervisor: Administrator_Actor, Salary: int, employee_Title__Non_Admin22: "Employee_Title__Non_Admin" = None, administration24: "Administration" = None):
