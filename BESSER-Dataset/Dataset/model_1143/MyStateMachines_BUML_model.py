...
# Classes
myStateMachines_Statemachine = Class(name="myStateMachines_Statemachine")
myStateMachines_Event = Class(name="myStateMachines_Event")
myStateMachines_Transition = Class(name="myStateMachines_Transition")
myStateMachines_State = Class(name="myStateMachines_State")
...
myStateMachines_State.attributes={myStateMachines_State_actions, myStateMachines_State_name}
...
domain_model = DomainModel(
    ...
    types={myStateMachines_Statemachine, myStateMachines_Event, myStateMachines_Transition, myStateMachines_State},
    associations={events0, refinement3, transitions6, event8, state11, states1},
    generalizations={},
    metadata=None
)
