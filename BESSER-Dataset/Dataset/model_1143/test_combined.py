...
def test_hyp_mystatemachines_state_is_not_abstract():
    assert not inspect.isabstract(myStateMachines_State)


def test_hyp_mystatemachines_state_constructor_exists():
    assert callable(myStateMachines_State.__init__)


def test_hyp_mystatemachines_state_constructor_args():
...
def test_hyp_mystatemachines_transition_is_not_abstract():
    assert not inspect.isabstract(myStateMachines_Transition)


def test_hyp_mystatemachines_transition_constructor_exists():
    assert callable(myStateMachines_Transition.__init__)


def test_hyp_mystatemachines_transition_constructor_args():
    sig = inspect.signature(myStateMachines_Transition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mystatemachines_event_is_not_abstract():
    assert not inspect.isabstract(myStateMachines_Event)


def test_hyp_mystatemachines_event_constructor_exists():
    assert callable(myStateMachines_Event.__init__)


def test_hyp_mystatemachines_event_constructor_args():
...
def test_hyp_mystatemachines_statemachine_is_not_abstract():
    assert not inspect.isabstract(myStateMachines_Statemachine)


def test_hyp_mystatemachines_statemachine_constructor_exists():
    assert callable(myStateMachines_Statemachine.__init__)


def test_hyp_mystatemachines_statemachine_constructor_args():
...
def test_hyp_mystatemachines_state_name_setter(instance):
...
@given(instance=myStateMachines_State_strategy)
def test_hyp_mystatemachines_state_actions_setter(instance):
...
def test_hyp_mystatemachines_event_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
