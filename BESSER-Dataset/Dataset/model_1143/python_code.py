...
class myStateMachines_State:
    ...
    def __init__(self, actions: str, name: str, myStateMachines_State4: "myStateMachines_Statemachine" = None, myStateMachines_State7: set["myStateMachines_Transition"] = None, myStateMachines_State13: "myStateMachines_Transition" = None, myStateMachines_State: "myStateMachines_Statemachine" = None):
...
class myStateMachines_Event:
    ...
    def __init__(self, name: str, myStateMachines_Event: "myStateMachines_Statemachine" = None, myStateMachines_Event10: "myStateMachines_Transition" = None):
        self.name = name
