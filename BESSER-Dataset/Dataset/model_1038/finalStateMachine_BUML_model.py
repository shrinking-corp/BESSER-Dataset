...
# Classes
finalStateMachine_FinalState = Class(name="finalStateMachine_FinalState")
State = Class(name="State")
finalStateMachine_InitialState = Class(name="finalStateMachine_InitialState")
finalStateMachine_FSM = Class(name="finalStateMachine_FSM")
finalStateMachine_Transition = Class(name="finalStateMachine_Transition")
finalStateMachine_State = Class(name="finalStateMachine_State")
...
domain_model = DomainModel(
    ...
    types={finalStateMachine_FinalState, State, finalStateMachine_InitialState, finalStateMachine_FSM, finalStateMachine_Transition, finalStateMachine_State},
    associations={input3, output6, transition0, state1},
