...
class finalStateMachine_State:
    ...
    def __init__(self, name: str, finalStateMachine_State5: "finalStateMachine_Transition" = None, finalStateMachine_State8: "finalStateMachine_Transition" = None, finalStateMachine_State: "finalStateMachine_FSM" = None):
        self.name = name
...
class finalStateMachine_Transition:
    ...
    def __init__(self, name: str, finalStateMachine_Transition4: "finalStateMachine_State" = None, finalStateMachine_Transition7: "finalStateMachine_State" = None, finalStateMachine_Transition: "finalStateMachine_FSM" = None):
        self.name = name
