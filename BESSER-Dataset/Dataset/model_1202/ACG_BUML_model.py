...
ACG_LocatedElement.attributes={ACG_LocatedElement_commentsAfter, ACG_LocatedElement_commentsBefore, ACG_LocatedElement_location}
...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={ACG_Parameter, VariableDecl, ACG_Node, StatementBlock, ACG_LocatedElement, ACG_ACG, LocatedElement, ACGElement, ACG_ACGElement, ACG, ACG_Function, Parameter_, Expression, ACG_Attribute, ACG_AnalyzeStat, ACG_ReportStat, ACG_ASMNode, Node, ACG_CodeNode, ACG_SimpleNode, ACG_StatementBlock, Statement, ACG_Statement, ACG_CompoundStat, ACG_ForEachStat, CompoundStat, ACG_OnceStat, ACG_VariableStat, ACG_OperationStat, ACG_ConditionalStat, ACG_LetStat, ACG_PushStat, EmitWithOperandStat, ACG_PushIStat, ACG_PushDStat, ACG_LoadStat, ACG_FieldStat, ACG_ParamStat, ACG_EmitStat, ACG_LabelStat, EmitStat, ACG_NewStat, ACG_NewinStat, ACG_DeleteStat, ACG_DupStat, ACG_DupX1Stat, ACG_PopStat, ACG_SwapStat, ACG_IterateStat, ACG_EndIterateStat, ACG_GetAsmStat, ACG_FindMEStat, ACG_PushTStat, ACG_PushFStat, ACG_EmitWithOperandStat, ACG_LetExp, ACG_StoreStat, ACG_CallStat, ACG_PCallStat, ACG_SuperCallStat, ACG_GetStat, ACG_SetStat, ACG_EmitWithLabelRefStat, LabelStat, ACG_IfStat, EmitWithLabelRefStat, ACG_GotoStat, ACG_VariableDecl, ACG_Expression, ACG_VariableExp, ACG_SelfExp, ACG_LastExp, ACG_IfExp, ACG_IsAExp, ACG_PropertyCallExp, ACG_NavigationExp, PropertyCallExp, ACG_IteratorExp, ACG_OperationCallExp, ACG_OperatorCallExp, OperationCallExp, ACG_LiteralExp, ACG_OclUndefinedExp, LiteralExp, ACG_CollectionExp, ACG_SequenceExp, CollectionExp, ACG_BooleanExp, ACG_IntegerExp, ACG_StringExp, Severity},
    associations={guard7, elements0, acg1, parameters2, body3, body5, target36, name9, statements11, iterator12, collection13, definition16, name18, context21, name23, condition26, elseStatements28, variable31, value33, operand52, message38, name40, type42, name45, type47, id50, variable67, label54, variable55, condition57, thenExp59, elseExp62, source65, value69, in_72, source75, iterator77, body79, arguments82, elements84},
    generalizations={gen_ACG_Parameter_VariableDecl, gen_ACG_Node_ACGElement, gen_ACG_Node_StatementBlock, gen_ACG_ACG_LocatedElement, gen_ACG_ACGElement_LocatedElement, gen_ACG_Function_ACGElement, gen_ACG_Attribute_ACGElement, gen_ACG_AnalyzeStat_CompoundStat, gen_ACG_ReportStat_Statement, gen_ACG_ASMNode_Node, gen_ACG_CodeNode_Node, gen_ACG_SimpleNode_Node, gen_ACG_StatementBlock_LocatedElement, gen_ACG_Statement_LocatedElement, gen_ACG_CompoundStat_Statement, gen_ACG_CompoundStat_StatementBlock, gen_ACG_ForEachStat_CompoundStat, gen_ACG_OnceStat_CompoundStat, gen_ACG_VariableStat_CompoundStat, gen_ACG_OperationStat_CompoundStat, gen_ACG_ConditionalStat_CompoundStat, gen_ACG_LetStat_CompoundStat, gen_ACG_EmitWithOperandStat_EmitStat, gen_ACG_PushStat_EmitWithOperandStat, gen_ACG_PushIStat_EmitWithOperandStat, gen_ACG_PushDStat_EmitWithOperandStat, gen_ACG_FieldStat_Statement, gen_ACG_ParamStat_Statement, gen_ACG_EmitStat_Statement, gen_ACG_LabelStat_EmitStat, gen_ACG_NewStat_EmitStat, gen_ACG_NewinStat_EmitStat, gen_ACG_DeleteStat_EmitStat, gen_ACG_DupStat_EmitStat, gen_ACG_DupX1Stat_EmitStat, gen_ACG_PopStat_EmitStat, gen_ACG_SwapStat_EmitStat, gen_ACG_IterateStat_EmitStat, gen_ACG_EndIterateStat_EmitStat, gen_ACG_GetAsmStat_EmitStat, gen_ACG_FindMEStat_EmitStat, gen_ACG_PushTStat_EmitStat, gen_ACG_PushFStat_EmitStat, gen_ACG_LetExp_Expression, gen_ACG_LoadStat_EmitWithOperandStat, gen_ACG_StoreStat_EmitWithOperandStat, gen_ACG_CallStat_EmitWithOperandStat, gen_ACG_PCallStat_EmitWithOperandStat, gen_ACG_SuperCallStat_EmitWithOperandStat, gen_ACG_GetStat_EmitWithOperandStat, gen_ACG_SetStat_EmitWithOperandStat, gen_ACG_EmitWithLabelRefStat_EmitStat, gen_ACG_IfStat_EmitWithLabelRefStat, gen_ACG_GotoStat_EmitWithLabelRefStat, gen_ACG_VariableDecl_LocatedElement, gen_ACG_Expression_LocatedElement, gen_ACG_VariableExp_Expression, gen_ACG_SelfExp_Expression, gen_ACG_LastExp_Expression, gen_ACG_IfExp_Expression, gen_ACG_IsAExp_Expression, gen_ACG_PropertyCallExp_Expression, gen_ACG_NavigationExp_PropertyCallExp, gen_ACG_IteratorExp_PropertyCallExp, gen_ACG_OperationCallExp_PropertyCallExp, gen_ACG_OperatorCallExp_OperationCallExp, gen_ACG_LiteralExp_Expression, gen_ACG_OclUndefinedExp_LiteralExp, gen_ACG_CollectionExp_LiteralExp, gen_ACG_SequenceExp_CollectionExp, gen_ACG_BooleanExp_LiteralExp, gen_ACG_IntegerExp_LiteralExp, gen_ACG_StringExp_LiteralExp},
    metadata=None
)
