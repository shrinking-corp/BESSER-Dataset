...
User.attributes={User_Position, User_Roles___, User_Linkedin_link, User_TitleID, User_DepartmentID, User_Firstname, User_Facebook_link, User_Google_plus_link, User_Email, User_Dateofbirth, User_UserID, User_Password, User_About, User_Lastname, User_Settings, User_Hiredate, User_Active, User_Username, User_Phone}
...
Project.attributes={Project_Author, Project_Title, Project_StatusID, Project_Team___, Project_PriorityID, Project_Attachments___, Project_ProjectManager, Project_Created, Project_Comments___, Project_Activities___, Project_PorjectID, Project_Description, Project_Assignee, Project_Deadline, Project_Subscriptions___}
...
Activity.attributes={Activity_Seen, Activity_ActivityType, Activity_ActivitySubType, Activity_User, Activity_PrevValue, Activity_Project, Activity_NewValue, Activity_ActivityID}
...
Comment.attributes={Comment_Created, Comment_Content, Comment_User, Comment_Project, Comment_CommentID}
...
Attachment.attributes={Attachment_Path, Attachment_AttachmentID, Attachment_Name, Attachment_Project, Attachment_User, Attachment_Extension, Attachment_Created, Attachment_Size}
...
domain_model = DomainModel(
    name="ba552462_60a9_40d1_8d00_bdaa35413ba9",
