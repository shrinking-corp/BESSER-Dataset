...
class publication2014_Progress(Labelled):
    ...
    def __init__(self, percent: int, time: int, publication2014_Progress: "publication2014_PublicationProcess" = None, progress: "publication2014_Paper" = None, Progress: "publication2014_Paper" = None):
...
class publication2014_PublicationPhase:
    ...
    def __init__(self, name: str, minTime: int, maxTime: int, publication2014_PublicationPhase4: set["publication2014_Sequence"] = None, phaseParticipation: set["publication2014_Researcher"] = None, publication2014_PublicationPhase7: set["publication2014_Rule"] = None, publication2014_PublicationPhase10: "publication2014_PlaceHolderPP" = None, publication2014_PublicationPhase13: "publication2014_Sequence" = None, publication2014_PublicationPhase: "publication2014_PublicationProcess" = None, publication2014_PublicationPhase16: "publication2014_Sequence" = None, PublicationPhase: "publication2014_Researcher" = None):
        self.name = name
...
class publication2014_ReviewNote(Named):
    ...
    def __init__(self, content: str, publication2014_ReviewNote33: "publication2014_PlaceHolderRn" = None, publication2014_ReviewNote: "publication2014_Paragraph" = None, publication2014_ReviewNote43: "publication2014_Review" = None):
...
class publication2014_Paragraph(Counted, Named):

    def __init__(self, content: str, publication2014_Paragraph31: set["publication2014_ReviewNote"] = None, publication2014_Paragraph40: "publication2014_Write" = None, publication2014_Paragraph: "publication2014_Paper" = None):
        self.content = content
...
class publication2014_Researcher:
    ...
    def __init__(self, name: str, forName: str, position: str, Researcher: "publication2014_PublicationPhase" = None, publication2014_Researcher: set["publication2014_Write"] = None, publication2014_Researcher22: set["publication2014_Review"] = None, authors: set["publication2014_Paper"] = None, publication2014_Researcher45: "publication2014_PublicationStructure" = None, publication2014_Researcher25: "publication2014_PlaceHolderRs" = None, Researcher29: "publication2014_Paper" = None, neededPerson: set["publication2014_PublicationPhase"] = None):
        self.name = name
...
class publication2014_Sequence:
    ...
    def __init__(self, sequenceType: str, publication2014_Sequence: "publication2014_PublicationPhase" = None, publication2014_Sequence12: "publication2014_PublicationPhase" = None, publication2014_Sequence15: "publication2014_PublicationPhase" = None):
