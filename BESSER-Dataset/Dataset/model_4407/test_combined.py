...
def test_arduino_BluetoothTransceiver_isa_ArduinoCommunicationModule():
    instance = arduino_BluetoothTransceiver()
...
def test_assoc_variable31_link_reassign_clear():
    a = arduino_IntegerVariable(initialValue=7)
...
def test_assoc_variable39_link_reassign_clear():
    a = arduino_BooleanVariable(initialValue=True)
...
arduino_BluetoothTransceiver_strategy = st.builds(arduino_BluetoothTransceiver)
...
arduino_Pin_strategy = st.builds(arduino_Pin)
