...
domain_model = DomainModel(
    name="MARTE_Library",
    types={MARTE_Library_TimeLibrary_IdealClock, AreaUnitKind, WeightUnitKind, PowerUnitKind, FrequencyUnitKind, DataSizeUnitKind, DataTxRateUnitKind, EnergyUnitKind, LengthUnitKind, SourceKind, DirectionKind, SchedPolicyKind, ProtectProtocolKind, PeriodicServerKind, TransmModeKind, TimeNatureKind, TimeInterpretationKind, EventKind, TimeStandardKind, StatisticalQualifierKind, TimeUnitKind, LogicalTimeUnit},
    associations={},
    generalizations={},
    metadata=None
)
