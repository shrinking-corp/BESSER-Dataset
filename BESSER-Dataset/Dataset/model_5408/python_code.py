...
class emfta_Event:
    ...
    def __init__(self, type: str, name: str, probability: float, description: str, relatedObject: str, referenceCount: int, emfta_Event: "emfta_Gate" = None, emfta_Event3: "emfta_Gate" = None, emfta_Event5: "emfta_FTAModel" = None, emfta_Event8: "emfta_FTAModel" = None):
        self.type = type
        self.name = name
