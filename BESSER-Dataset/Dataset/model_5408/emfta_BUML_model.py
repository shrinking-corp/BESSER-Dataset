...
# Classes
emfta_FTAModel = Class(name="emfta_FTAModel")
emfta_Event = Class(name="emfta_Event")
emfta_Gate = Class(name="emfta_Gate")
...
emfta_FTAModel.attributes={emfta_FTAModel_comments, emfta_FTAModel_name, emfta_FTAModel_description}
...
emfta_Event.attributes={emfta_Event_referenceCount, emfta_Event_name, emfta_Event_description, emfta_Event_relatedObject, emfta_Event_probability, emfta_Event_type}
...
emfta_Gate.attributes={emfta_Gate_description, emfta_Gate_nbOccurrences, emfta_Gate_type}
...
domain_model = DomainModel(
    name="emfta",
    types={emfta_FTAModel, emfta_Event, emfta_Gate, EventType, GateType},
