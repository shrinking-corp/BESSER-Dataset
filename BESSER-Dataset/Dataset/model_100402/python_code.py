...
class SpecificationElement:
    ...
    pass
class sgraph_State(CompositeElement, ScopedElement, RegularState, ReactiveElement, SpecificationElement):

    def __init__(self, substatechartId: str, subchart: bool, simple: bool, composite: bool, leaf: bool, orthogonal: bool, sgraph_State: "sgraph_Statechart" = None):
...
class sgraph_Region(NamedElement):
    ...
    def __init__(self, priority: int, Region: "sgraph_Vertex" = None, regions: "sgraph_CompositeElement" = None, parentRegion: set["sgraph_Vertex"] = None, Region27: "sgraph_CompositeElement" = None):
        self.priority = priority
        self.Region = Region
...
class sgraph_Statechart(CompositeElement, NamedElement, ScopedElement, ReactiveElement, SpecificationElement):
