...
domain_model = DomainModel(
    name="_AoMKYD6LEeqTDpmqRhKD9Q",
    types={Vendor1Sound, Vendor2Sound, ExtensionBoard, FastCard, CPU, Processor, AcceleratorCard, Cache, RAM, Machine, Program, Instruction, Memory_Interface, DeviceCard, Card, Sound, GenericSound, Vendor1Adapter, Vendor2Adapter},
