...
# Classes
Elements_IdentifiedElement = Class(name="Elements_IdentifiedElement", is_abstract=True)
Elements_NamedElement = Class(name="Elements_NamedElement", is_abstract=True)
IdentifiedElement = Class(name="IdentifiedElement")
Elements_Root = Class(name="Elements_Root")
Elements_Element = Class(name="Elements_Element")
NamedElement = Class(name="NamedElement")
Elements_StrictElement = Class(name="Elements_StrictElement")
Element = Class(name="Element")
Elements_Node = Class(name="Elements_Node")
Elements_Edge = Class(name="Elements_Edge")
Elements_ReferencingNode = Class(name="Elements_ReferencingNode")
...
Elements_Element.attributes={Elements_Element_value, Elements_Element_values}
...
Elements_StrictElement.attributes={Elements_StrictElement_sValue, Elements_StrictElement_sValues}
...
domain_model = DomainModel(
    name="Elements",
    types={Elements_IdentifiedElement, Elements_NamedElement, IdentifiedElement, Elements_Root, Elements_Element, NamedElement, Elements_StrictElement, Element, Elements_Node, Elements_Edge, Elements_ReferencingNode, Node},
    associations={sManyContent41, content0, manyContent2, singleContent4, manyContentWithUp7, upFromManyContent9, singleContentWithUp12, upFromSingleContent15, manyRef18, singleRef21, singleFromSingleRef124, singleFromSingleRef227, manyFromSingleRef30, singleFromManyRef33, manyFromManyRef136, manyFromManyRef239, sSingleContent43, sManyRef46, sSingleRef49, sManyFromSingleRef53, sSingleFromManyRef55, sManyFromManyRef158, sManyFromManyRef261, incoming63, outgoing64, subNodes66, target68, source69, referenced71},
    generalizations={gen_Elements_NamedElement_IdentifiedElement, gen_Elements_Root_IdentifiedElement, gen_Elements_Element_NamedElement, gen_Elements_StrictElement_Element, gen_Elements_Node_NamedElement, gen_Elements_Edge_NamedElement, gen_Elements_ReferencingNode_Node},
    metadata=None
)
