...
def test_hyp_elements_identifiedelement_is_not_abstract():
    assert not inspect.isabstract(Elements_IdentifiedElement)


def test_hyp_elements_identifiedelement_constructor_exists():
    assert callable(Elements_IdentifiedElement.__init__)


def test_hyp_elements_identifiedelement_constructor_args():
...
def test_hyp_elements_referencingnode_is_not_abstract():
    assert not inspect.isabstract(Elements_ReferencingNode)


def test_hyp_elements_referencingnode_constructor_exists():
    assert callable(Elements_ReferencingNode.__init__)


def test_hyp_elements_referencingnode_constructor_args():
...
def test_hyp_elements_strictelement_is_not_abstract():
    assert not inspect.isabstract(Elements_StrictElement)


def test_hyp_elements_strictelement_constructor_exists():
    assert callable(Elements_StrictElement.__init__)


def test_hyp_elements_strictelement_constructor_args():
...
def test_hyp_elements_node_is_not_abstract():
    assert not inspect.isabstract(Elements_Node)


def test_hyp_elements_node_constructor_exists():
    assert callable(Elements_Node.__init__)


def test_hyp_elements_node_constructor_args():
    sig = inspect.signature(Elements_Node.__init__)
    params = list(sig.parameters.keys())



def test_hyp_elements_edge_is_not_abstract():
    assert not inspect.isabstract(Elements_Edge)


def test_hyp_elements_edge_constructor_exists():
    assert callable(Elements_Edge.__init__)


def test_hyp_elements_edge_constructor_args():
...
def test_hyp_elements_root_is_not_abstract():
    assert not inspect.isabstract(Elements_Root)


def test_hyp_elements_root_constructor_exists():
    assert callable(Elements_Root.__init__)


def test_hyp_elements_root_constructor_args():
...
def test_hyp_elements_namedelement_is_not_abstract():
    assert not inspect.isabstract(Elements_NamedElement)


def test_hyp_elements_namedelement_constructor_exists():
    assert callable(Elements_NamedElement.__init__)


def test_hyp_elements_namedelement_constructor_args():
...
def test_hyp_elements_identifiedelement_id_setter(instance):
...
def test_hyp_elements_strictelement_sValues_setter(instance):
...
@given(instance=Elements_StrictElement_strategy)
def test_hyp_elements_strictelement_sValue_setter(instance):
...
def test_hyp_elements_element_value_setter(instance):
...
@given(instance=Elements_Element_strategy)
def test_hyp_elements_element_values_setter(instance):
...
def test_hyp_elements_root_name_setter(instance):
...
def test_hyp_elements_namedelement_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
