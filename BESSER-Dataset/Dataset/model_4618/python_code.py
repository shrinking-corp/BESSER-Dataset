...
class Elements_StrictElement(Element):
    ...
    def __init__(self, sValue: int, sValues: int, Elements_StrictElement: set["Elements_Element"] = None, sSingleFromManyRef: set["Elements_StrictElement"] = None, StrictElement56: "Elements_StrictElement" = None, sManyFromSingleRef: "Elements_StrictElement" = None, StrictElement59: "Elements_StrictElement" = None, sManyFromManyRef2: set["Elements_StrictElement"] = None, StrictElement62: "Elements_StrictElement" = None, sManyFromManyRef1: set["Elements_StrictElement"] = None, Elements_StrictElement44: "Elements_Element" = None, Elements_StrictElement47: set["Elements_Element"] = None, Elements_StrictElement50: "Elements_Element" = None, StrictElement: "Elements_StrictElement" = None):
        self.sValue = sValue
