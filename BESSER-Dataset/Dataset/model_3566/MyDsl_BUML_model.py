...
myDsl_SourceFile = Class(name="myDsl_SourceFile")
myDsl_Type = Class(name="myDsl_Type")
myDsl_TypeName = Class(name="myDsl_TypeName")
myDsl_TypeLit = Class(name="myDsl_TypeLit")
myDsl_TypeNameLinha = Class(name="myDsl_TypeNameLinha")
myDsl_TypeLitLinha = Class(name="myDsl_TypeLitLinha")
myDsl_StructType = Class(name="myDsl_StructType")
myDsl_PointerType = Class(name="myDsl_PointerType")
myDsl_FunctionType = Class(name="myDsl_FunctionType")
myDsl_InterfaceType = Class(name="myDsl_InterfaceType")
myDsl_MapType = Class(name="myDsl_MapType")
myDsl_ArrayLength = Class(name="myDsl_ArrayLength")
myDsl_ElementType = Class(name="myDsl_ElementType")
myDsl_Expression = Class(name="myDsl_Expression")
myDsl_FieldDecl = Class(name="myDsl_FieldDecl")
myDsl_IdentifierList = Class(name="myDsl_IdentifierList")
myDsl_EmbeddedField = Class(name="myDsl_EmbeddedField")
myDsl_Tag = Class(name="myDsl_Tag")
myDsl_BaseType = Class(name="myDsl_BaseType")
myDsl_Signature = Class(name="myDsl_Signature")
myDsl_Parameters = Class(name="myDsl_Parameters")
myDsl_ChannelType = Class(name="myDsl_ChannelType")
myDsl_ParameterList = Class(name="myDsl_ParameterList")
myDsl_ParameterDecl = Class(name="myDsl_ParameterDecl")
myDsl_MethodSpec = Class(name="myDsl_MethodSpec")
myDsl_MethodName = Class(name="myDsl_MethodName")
myDsl_InterfaceTypeName = Class(name="myDsl_InterfaceTypeName")
myDsl_KeyType = Class(name="myDsl_KeyType")
myDsl_Result = Class(name="myDsl_Result")
myDsl_Block = Class(name="myDsl_Block")
myDsl_StatementList = Class(name="myDsl_StatementList")
myDsl_Statement = Class(name="myDsl_Statement")
myDsl_Declaration = Class(name="myDsl_Declaration")
myDsl_ConstDecl = Class(name="myDsl_ConstDecl")
myDsl_TypeDecl = Class(name="myDsl_TypeDecl")
myDsl_VarDecl = Class(name="myDsl_VarDecl")
myDsl_TopLevelDecl = Class(name="myDsl_TopLevelDecl")
myDsl_FunctionDecl = Class(name="myDsl_FunctionDecl")
myDsl_MethodDecl = Class(name="myDsl_MethodDecl")
myDsl_ChannelTypeLinha = Class(name="myDsl_ChannelTypeLinha")
myDsl_ExpressionList = Class(name="myDsl_ExpressionList")
myDsl_TypeSpec = Class(name="myDsl_TypeSpec")
myDsl_AliasDecl = Class(name="myDsl_AliasDecl")
myDsl_TypeDef = Class(name="myDsl_TypeDef")
myDsl_VarSpec = Class(name="myDsl_VarSpec")
myDsl_ConstSpec = Class(name="myDsl_ConstSpec")
myDsl_ShortVarDecl = Class(name="myDsl_ShortVarDecl")
myDsl_FunctionName = Class(name="myDsl_FunctionName")
myDsl_FunctionBody = Class(name="myDsl_FunctionBody")
myDsl_Receiver = Class(name="myDsl_Receiver")
myDsl_Operand = Class(name="myDsl_Operand")
myDsl_Literal = Class(name="myDsl_Literal")
myDsl_OperandName = Class(name="myDsl_OperandName")
myDsl_BasicLit = Class(name="myDsl_BasicLit")
myDsl_CompositeLit = Class(name="myDsl_CompositeLit")
myDsl_FunctionLit = Class(name="myDsl_FunctionLit")
myDsl_LiteralType = Class(name="myDsl_LiteralType")
myDsl_LiteralValue = Class(name="myDsl_LiteralValue")
myDsl_LiteralTypeLinha = Class(name="myDsl_LiteralTypeLinha")
myDsl_ElementList = Class(name="myDsl_ElementList")
myDsl_KeyedElement = Class(name="myDsl_KeyedElement")
myDsl_Key = Class(name="myDsl_Key")
myDsl_Element = Class(name="myDsl_Element")
myDsl_FieldName = Class(name="myDsl_FieldName")
myDsl_PrimaryExpr = Class(name="myDsl_PrimaryExpr")
myDsl_PrimaryExprLinha = Class(name="myDsl_PrimaryExprLinha")
myDsl_Conversion = Class(name="myDsl_Conversion")
myDsl_MethodExpr = Class(name="myDsl_MethodExpr")
myDsl_Selector = Class(name="myDsl_Selector")
myDsl_Index = Class(name="myDsl_Index")
myDsl_Slice = Class(name="myDsl_Slice")
myDsl_Arguments = Class(name="myDsl_Arguments")
myDsl_ReceiverType = Class(name="myDsl_ReceiverType")
myDsl_UnaryExpr = Class(name="myDsl_UnaryExpr")
myDsl_TypeAssertion = Class(name="myDsl_TypeAssertion")
myDsl_Expression1 = Class(name="myDsl_Expression1")
myDsl_BINARY_OP = Class(name="myDsl_BINARY_OP")
myDsl_LabeledStmt = Class(name="myDsl_LabeledStmt")
myDsl_SimpleStmt = Class(name="myDsl_SimpleStmt")
myDsl_GoStmt = Class(name="myDsl_GoStmt")
myDsl_ReturnStmt = Class(name="myDsl_ReturnStmt")
myDsl_BreakStmt = Class(name="myDsl_BreakStmt")
myDsl_ContinueStmt = Class(name="myDsl_ContinueStmt")
myDsl_GotoStmt = Class(name="myDsl_GotoStmt")
myDsl_FallthroughStmt = Class(name="myDsl_FallthroughStmt")
myDsl_Expression_Linha = Class(name="myDsl_Expression_Linha")
myDsl_IfStmt = Class(name="myDsl_IfStmt")
myDsl_SwitchStmt = Class(name="myDsl_SwitchStmt")
myDsl_SelectStmt = Class(name="myDsl_SelectStmt")
myDsl_ForStmt = Class(name="myDsl_ForStmt")
myDsl_DeferStmt = Class(name="myDsl_DeferStmt")
myDsl_EmptyStmt = Class(name="myDsl_EmptyStmt")
myDsl_SimpleStmtLinha = Class(name="myDsl_SimpleStmtLinha")
myDsl_assign_op = Class(name="myDsl_assign_op")
myDsl_Label = Class(name="myDsl_Label")
myDsl_IfStmtLinha = Class(name="myDsl_IfStmtLinha")
myDsl_ExprSwitchStmt = Class(name="myDsl_ExprSwitchStmt")
myDsl_TypeSwitchStmt = Class(name="myDsl_TypeSwitchStmt")
myDsl_ExprCaseClause = Class(name="myDsl_ExprCaseClause")
myDsl_ExprSwitchCase = Class(name="myDsl_ExprSwitchCase")
myDsl_TypeSwitchGuard = Class(name="myDsl_TypeSwitchGuard")
myDsl_TypeCaseClause = Class(name="myDsl_TypeCaseClause")
myDsl_TypeSwitchCase = Class(name="myDsl_TypeSwitchCase")
myDsl_TypeList = Class(name="myDsl_TypeList")
myDsl_ForStmtLinha = Class(name="myDsl_ForStmtLinha")
myDsl_Condition = Class(name="myDsl_Condition")
myDsl_PostStmt = Class(name="myDsl_PostStmt")
myDsl_ForStmtLinhaLinha = Class(name="myDsl_ForStmtLinhaLinha")
myDsl_CommClause = Class(name="myDsl_CommClause")
myDsl_CommCase = Class(name="myDsl_CommCase")
myDsl_CommCaseLinha = Class(name="myDsl_CommCaseLinha")
myDsl_RecvExpr = Class(name="myDsl_RecvExpr")
myDsl_PackageClause = Class(name="myDsl_PackageClause")
myDsl_ImportDecl = Class(name="myDsl_ImportDecl")
myDsl_PackageName = Class(name="myDsl_PackageName")
myDsl_ImportSpec = Class(name="myDsl_ImportSpec")
...
myDsl_BasicLit.attributes={myDsl_BasicLit_float_lit, myDsl_BasicLit_int_lit, myDsl_BasicLit_rune_lit, myDsl_BasicLit_string_lit, myDsl_BasicLit_imaginary_lit}
...
myDsl_ReturnStmt_return_: Property = Property(name="return_", type=StringType)
myDsl_ReturnStmt.attributes={myDsl_ReturnStmt_return_}

# myDsl_BreakStmt class attributes and methods
myDsl_BreakStmt_break_: Property = Property(name="break_", type=StringType)
myDsl_BreakStmt.attributes={myDsl_BreakStmt_break_}

# myDsl_ContinueStmt class attributes and methods
myDsl_ContinueStmt_continue_: Property = Property(name="continue_", type=StringType)
myDsl_ContinueStmt.attributes={myDsl_ContinueStmt_continue_}
...
myDsl_IfStmt_if_: Property = Property(name="if_", type=StringType)
myDsl_IfStmt_else_: Property = Property(name="else_", type=StringType)
myDsl_IfStmt.attributes={myDsl_IfStmt_if_, myDsl_IfStmt_else_}
...
myDsl_ForStmt_for_: Property = Property(name="for_", type=StringType)
myDsl_ForStmt.attributes={myDsl_ForStmt_range, myDsl_ForStmt_for_}
...
myDsl_IfStmtLinha_else_: Property = Property(name="else_", type=StringType)
myDsl_IfStmtLinha.attributes={myDsl_IfStmtLinha_else_}
...
myDsl_ExprSwitchCase.attributes={myDsl_ExprSwitchCase_default, myDsl_ExprSwitchCase_case}
...
myDsl_TypeSwitchGuard.attributes={myDsl_TypeSwitchGuard_id, myDsl_TypeSwitchGuard_type}
...
myDsl_TypeSwitchCase.attributes={myDsl_TypeSwitchCase_case, myDsl_TypeSwitchCase_default}
...
myDsl_CommCase.attributes={myDsl_CommCase_default, myDsl_CommCase_case}
...
domain_model = DomainModel(
    name="myDsl",
    types={myDsl_Model, myDsl_SourceFile, myDsl_Type, myDsl_TypeName, myDsl_TypeLit, myDsl_TypeNameLinha, myDsl_TypeLitLinha, myDsl_StructType, myDsl_PointerType, myDsl_FunctionType, myDsl_InterfaceType, myDsl_MapType, myDsl_ArrayLength, myDsl_ElementType, myDsl_Expression, myDsl_FieldDecl, myDsl_IdentifierList, myDsl_EmbeddedField, myDsl_Tag, myDsl_BaseType, myDsl_Signature, myDsl_Parameters, myDsl_ChannelType, myDsl_ParameterList, myDsl_ParameterDecl, myDsl_MethodSpec, myDsl_MethodName, myDsl_InterfaceTypeName, myDsl_KeyType, myDsl_Result, myDsl_Block, myDsl_StatementList, myDsl_Statement, myDsl_Declaration, myDsl_ConstDecl, myDsl_TypeDecl, myDsl_VarDecl, myDsl_TopLevelDecl, myDsl_FunctionDecl, myDsl_MethodDecl, myDsl_ChannelTypeLinha, myDsl_ExpressionList, myDsl_TypeSpec, myDsl_AliasDecl, myDsl_TypeDef, myDsl_VarSpec, myDsl_ConstSpec, myDsl_ShortVarDecl, myDsl_FunctionName, myDsl_FunctionBody, myDsl_Receiver, myDsl_Operand, myDsl_Literal, myDsl_OperandName, myDsl_BasicLit, myDsl_CompositeLit, myDsl_FunctionLit, myDsl_LiteralType, myDsl_LiteralValue, myDsl_LiteralTypeLinha, myDsl_ElementList, myDsl_KeyedElement, myDsl_Key, myDsl_Element, myDsl_FieldName, myDsl_PrimaryExpr, myDsl_PrimaryExprLinha, myDsl_Conversion, myDsl_MethodExpr, myDsl_Selector, myDsl_Index, myDsl_Slice, myDsl_Arguments, myDsl_ReceiverType, myDsl_UnaryExpr, myDsl_TypeAssertion, myDsl_Expression1, myDsl_BINARY_OP, myDsl_LabeledStmt, myDsl_SimpleStmt, myDsl_GoStmt, myDsl_ReturnStmt, myDsl_BreakStmt, myDsl_ContinueStmt, myDsl_GotoStmt, myDsl_FallthroughStmt, myDsl_Expression_Linha, myDsl_IfStmt, myDsl_SwitchStmt, myDsl_SelectStmt, myDsl_ForStmt, myDsl_DeferStmt, myDsl_EmptyStmt, myDsl_SimpleStmtLinha, myDsl_assign_op, myDsl_Label, myDsl_IfStmtLinha, myDsl_ExprSwitchStmt, myDsl_TypeSwitchStmt, myDsl_ExprCaseClause, myDsl_ExprSwitchCase, myDsl_TypeSwitchGuard, myDsl_TypeCaseClause, myDsl_TypeSwitchCase, myDsl_TypeList, myDsl_ForStmtLinha, myDsl_Condition, myDsl_PostStmt, myDsl_ForStmtLinhaLinha, myDsl_CommClause, myDsl_CommCase, myDsl_CommCaseLinha, myDsl_RecvExpr, myDsl_PackageClause, myDsl_ImportDecl, myDsl_PackageName, myDsl_ImportSpec},
    associations={greetings0, typeName1, typeLit2, type5, typeLitLinha7, srtuctType9, pointerType11, functionType13, interfaceType15, mapType17, arrayLength21, elementType23, expression25, type27, fieldDecl30, identifierList32, type34, embeddedField37, tag39, typeName41, baseType44, type46, signature49, parameters51, channelType19, parameters55, type58, parameterList61, parameterDecl63, parameterDecl165, identifierList68, type71, methodSpec74, methodName76, Signature78, interfaceTypeName81, typeName83, keyType86, elementType88, type91, result53, elementType96, statementList99, statements100, constDecl102, typeDecl103, varDecl105, declaration107, functionDecl109, methodDecl111, constSpec1115, channelTypeLinha94, identifierList118, type121, expressionList124, expression126, expression1129, typeSpec132, typeSpec1134, aliasDecl137, typeDef139, type141, type144, varSpec147, varSpec1149, IdentifierList152, constSpec113, expressionList158, identifierList161, expressionList163, functionName166, signature168, functionBody171, block173, receiver176, methodName178, signature181, functionBody184, parameters187, literal190, operandName191, expression193, basicLit196, compositeLit198, type155, literalType202, literalValue204, structType206, mapType209, typeName212, literalTypeLinha215, arrayLength217, elementType220, elementList223, keyedElement225, keyedElement1227, key230, element232, fieldName234, expression236, functionLit200, expression242, literalValue245, signature248, functionBody251, operand254, primaryExprLinha256, conversion258, methodExpr260, selector262, primaryExprLinha265, index267, literalValue239, typeAssertion271, arguments273, expression275, expression278, expression1281, expression2284, type287, expressionList290, type293, receiverType296, methodName298, type301, unaryExpr304, slice269, unaryExpr308, expression_Linha310, BINARY_OP313, expression1315, expression_Linha319, primaryExpr321, type324, expression327, declaration330, labeledStmt333, simpleStmt335, goStmt337, returnStmt339, breakStmt341, continueStmt343, gotoStmt345, expression_Linha306, block349, ifStmt352, switchStmt354, selectStmt356, forStmt358, deferStmt360, emptyStmt362, expression364, simpleStmtLinha367, shortVarDecl369, expression372, expression1375, assign_op378, expressionList380, label383, fallthroughStmt347, expression388, ifStmtLinha391, emptyStmt393, shortVarDecl396, block399, ifStmt403, block1405, simpleStmtLinha408, expression411, block414, ifStmt417, block1420, exprSwitchStmt423, typeSwitchStmt425, statement385, simpleStmt427, exprCaseClause433, exprSwitchCase435, statementList437, expressionList440, simpleStmt443, typeSwitchGuard446, typeCaseClause448, primaryExpr450, typeSwitchCase453, statementList455, typeList458, type460, type1463, expression430, expression466, forStmtLinha469, emptyStmt471, shortVarDecl474, condition477, postStmt479, identifierList481, block484, expression487, forStmtLinhaLinha490, expression1492, condition495, postStmt498, assign_op501, expressionList504, condition507, postStmt510, expression513, expression516, simpleStmt519, expression522, commClause525, commCase527, statementList529, expression532, commCaseLinha535, expression537, expression1540, identifierList543, recvExpr546, expression548, expressionList551, label554, label557, label560, expression563, packageClause566, importDecl568, topLevelDecl570, packageName573, importSpec575, importSpec1577, packageName580},
    generalizations={},
    metadata=None
)
