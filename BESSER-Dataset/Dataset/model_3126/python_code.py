...
class umlMM_Attribute:
    ...
    def __init__(self, name: str, Attribute: "umlMM_Class" = None, attribute: "umlMM_Class" = None, typeOf: "umlMM_Classifier" = None, Attribute18: "umlMM_Classifier" = None):
        self.name = name
...
class umlMM_Class(Classifier):
    ...
    def __init__(self, kind: str, owner: set["umlMM_Attribute"] = None, Class: "umlMM_Class" = None, subclass: "umlMM_Class" = None, Class8: "umlMM_Class" = None, general: set["umlMM_Class"] = None, source: set["umlMM_Association"] = None, destination: set["umlMM_Association"] = None, Class25: "umlMM_Association" = None, Class14: "umlMM_Attribute" = None, Class23: "umlMM_Association" = None):
        self.kind = kind
...
class umlMM_Association:
    ...
    def __init__(self, name: str, Association: "umlMM_Package" = None, Association10: "umlMM_Class" = None, Association12: "umlMM_Class" = None, destinationOf: "umlMM_Class" = None, association: "umlMM_Package" = None, sourceOf: "umlMM_Class" = None):
        self.name = name
