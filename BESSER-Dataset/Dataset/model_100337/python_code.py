...
class resourcePetriNet_InputArc:
    ...
    def __init__(self, weight: int, resourcePetriNet_InputArc11: "resourcePetriNet_Transition" = None, resourcePetriNet_InputArc8: "resourcePetriNet_GenericPlace" = None, resourcePetriNet_InputArc: "resourcePetriNet_PetriNet" = None):
        self.weight = weight
...
class resourcePetriNet_Transition:
    ...
    def __init__(self, name: str, resourcePetriNet_Transition12: "resourcePetriNet_InputArc" = None, resourcePetriNet_Transition15: "resourcePetriNet_OutputArc" = None, resourcePetriNet_Transition: "resourcePetriNet_PetriNet" = None):
        self.name = name
...
class resourcePetriNet_GenericPlace(ABC):
    ...
    def __init__(self, name: str, numberOfTokens: int, resourcePetriNet_GenericPlace18: "resourcePetriNet_OutputArc" = None, resourcePetriNet_GenericPlace9: "resourcePetriNet_InputArc" = None, resourcePetriNet_GenericPlace: "resourcePetriNet_PetriNet" = None):
        self.name = name
...
class resourcePetriNet_PetriNet:
    ...
    def __init__(self, name: str, resourcePetriNet_PetriNet4: set["resourcePetriNet_InputArc"] = None, resourcePetriNet_PetriNet6: set["resourcePetriNet_OutputArc"] = None, resourcePetriNet_PetriNet: set["resourcePetriNet_GenericPlace"] = None, resourcePetriNet_PetriNet2: set["resourcePetriNet_Transition"] = None):
        self.name = name
