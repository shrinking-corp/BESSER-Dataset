...
java_ArrayTypeable = Class(name="java_ArrayTypeable", is_abstract=True)
java_Annotable = Class(name="java_Annotable", is_abstract=True)
Commentable = Class(name="Commentable")
java_AnnotationInstance = Class(name="java_AnnotationInstance")
...
java_Classifier = Class(name="java_Classifier", is_abstract=True)
java_AnnotationParameter = Class(name="java_AnnotationParameter", is_abstract=True)
java_SingleAnnotationParameter = Class(name="java_SingleAnnotationParameter")
AnnotationParameter = Class(name="AnnotationParameter")
java_AnnotationValue = Class(name="java_AnnotationValue", is_abstract=True)
java_AnnotationParameterList = Class(name="java_AnnotationParameterList")
java_AnnotationAttributeSetting = Class(name="java_AnnotationAttributeSetting")
java_InterfaceMethod = Class(name="java_InterfaceMethod")
java_AnnotationAttribute = Class(name="java_AnnotationAttribute")
InterfaceMethod = Class(name="InterfaceMethod")
java_ArrayDimension = Class(name="java_ArrayDimension")
...
java_ArrayInitializationValue = Class(name="java_ArrayInitializationValue", is_abstract=True)
java_ArrayInstantiation = Class(name="java_ArrayInstantiation", is_abstract=True)
Expression = Class(name="Expression")
java_ArrayInstantiationBySize = Class(name="java_ArrayInstantiationBySize")
ArrayInstantiation = Class(name="ArrayInstantiation")
TypedElement = Class(name="TypedElement")
ArrayTypeable = Class(name="ArrayTypeable")
java_ArrayInstantiationByValues = Class(name="java_ArrayInstantiationByValues", is_abstract=True)
java_ArrayInstantiationByValuesUntyped = Class(name="java_ArrayInstantiationByValuesUntyped")
ArrayInstantiationByValues = Class(name="ArrayInstantiationByValues")
java_ArrayInstantiationByValuesTyped = Class(name="java_ArrayInstantiationByValuesTyped")
java_ArraySelector = Class(name="java_ArraySelector")
Type = Class(name="Type")
ReferenceableElement = Class(name="ReferenceableElement")
java_ConcreteClassifier = Class(name="java_ConcreteClassifier", is_abstract=True)
...
java_Implementor = Class(name="java_Implementor", is_abstract=True)
java_TypeReference = Class(name="java_TypeReference", is_abstract=True)
...
java_Enumeration = Class(name="java_Enumeration")
java_EnumConstant = Class(name="java_EnumConstant")
java_AnonymousClass = Class(name="java_AnonymousClass")
java_Commentable = Class(name="java_Commentable", is_abstract=True)
java_LayoutInformation = Class(name="java_LayoutInformation")
java_NamedElement = Class(name="java_NamedElement", is_abstract=True)
java_NamespaceAwareElement = Class(name="java_NamespaceAwareElement", is_abstract=True)
...
java_JavaRoot = Class(name="java_JavaRoot", is_abstract=True)
...
java_EmptyModel = Class(name="java_EmptyModel")
java_ExpressionList = Class(name="java_ExpressionList")
ForLoopInitializer = Class(name="ForLoopInitializer")
java_AssignmentExpression = Class(name="java_AssignmentExpression")
java_AssignmentExpressionChild = Class(name="java_AssignmentExpressionChild", is_abstract=True)
java_AssignmentOperator = Class(name="java_AssignmentOperator", is_abstract=True)
java_RelationExpression = Class(name="java_RelationExpression")
InstanceOfExpressionChild = Class(name="InstanceOfExpressionChild")
java_RelationExpressionChild = Class(name="java_RelationExpressionChild", is_abstract=True)
java_ConditionalExpressionChild = Class(name="java_ConditionalExpressionChild", is_abstract=True)
java_ConditionalOrExpression = Class(name="java_ConditionalOrExpression")
ConditionalExpressionChild = Class(name="ConditionalExpressionChild")
java_ConditionalOrExpressionChild = Class(name="java_ConditionalOrExpressionChild", is_abstract=True)
java_ConditionalAndExpression = Class(name="java_ConditionalAndExpression")
ConditionalOrExpressionChild = Class(name="ConditionalOrExpressionChild")
java_ConditionalAndExpressionChild = Class(name="java_ConditionalAndExpressionChild", is_abstract=True)
java_InclusiveOrExpression = Class(name="java_InclusiveOrExpression")
ConditionalAndExpressionChild = Class(name="ConditionalAndExpressionChild")
java_InclusiveOrExpressionChild = Class(name="java_InclusiveOrExpressionChild", is_abstract=True)
java_ExclusiveOrExpression = Class(name="java_ExclusiveOrExpression")
InclusiveOrExpressionChild = Class(name="InclusiveOrExpressionChild")
java_ExclusiveOrExpressionChild = Class(name="java_ExclusiveOrExpressionChild", is_abstract=True)
java_AndExpression = Class(name="java_AndExpression")
ExclusiveOrExpressionChild = Class(name="ExclusiveOrExpressionChild")
java_AndExpressionChild = Class(name="java_AndExpressionChild", is_abstract=True)
java_EqualityExpression = Class(name="java_EqualityExpression")
AndExpressionChild = Class(name="AndExpressionChild")
java_EqualityOperator = Class(name="java_EqualityOperator", is_abstract=True)
java_EqualityExpressionChild = Class(name="java_EqualityExpressionChild", is_abstract=True)
java_InstanceOfExpression = Class(name="java_InstanceOfExpression")
EqualityExpressionChild = Class(name="EqualityExpressionChild")
java_InstanceOfExpressionChild = Class(name="java_InstanceOfExpressionChild", is_abstract=True)
java_PrefixUnaryModificationExpression = Class(name="java_PrefixUnaryModificationExpression")
UnaryModificationExpression = Class(name="UnaryModificationExpression")
java_SuffixUnaryModificationExpression = Class(name="java_SuffixUnaryModificationExpression")
java_RelationOperator = Class(name="java_RelationOperator", is_abstract=True)
java_ShiftExpression = Class(name="java_ShiftExpression")
RelationExpressionChild = Class(name="RelationExpressionChild")
java_ShiftExpressionChild = Class(name="java_ShiftExpressionChild", is_abstract=True)
java_ShiftOperator = Class(name="java_ShiftOperator", is_abstract=True)
java_AdditiveExpression = Class(name="java_AdditiveExpression")
ShiftExpressionChild = Class(name="ShiftExpressionChild")
java_AdditiveExpressionChild = Class(name="java_AdditiveExpressionChild", is_abstract=True)
java_AdditiveOperator = Class(name="java_AdditiveOperator", is_abstract=True)
java_MultiplicativeExpression = Class(name="java_MultiplicativeExpression")
AdditiveExpressionChild = Class(name="AdditiveExpressionChild")
java_MultiplicativeExpressionChild = Class(name="java_MultiplicativeExpressionChild", is_abstract=True)
java_MultiplicativeOperator = Class(name="java_MultiplicativeOperator", is_abstract=True)
java_UnaryExpression = Class(name="java_UnaryExpression")
MultiplicativeExpressionChild = Class(name="MultiplicativeExpressionChild")
java_UnaryOperator = Class(name="java_UnaryOperator", is_abstract=True)
java_UnaryExpressionChild = Class(name="java_UnaryExpressionChild", is_abstract=True)
java_UnaryModificationExpression = Class(name="java_UnaryModificationExpression", is_abstract=True)
UnaryExpressionChild = Class(name="UnaryExpressionChild")
java_UnaryModificationExpressionChild = Class(name="java_UnaryModificationExpressionChild", is_abstract=True)
java_UnaryModificationOperator = Class(name="java_UnaryModificationOperator", is_abstract=True)
java_UnknownTypeArgument = Class(name="java_UnknownTypeArgument")
java_Import = Class(name="java_Import", is_abstract=True)
...
java_PrimaryExpression = Class(name="java_PrimaryExpression", is_abstract=True)
java_NestedExpression = Class(name="java_NestedExpression")
java_TypeArgument = Class(name="java_TypeArgument", is_abstract=True)
java_TypeArgumentable = Class(name="java_TypeArgumentable", is_abstract=True)
java_CallTypeArgumentable = Class(name="java_CallTypeArgumentable", is_abstract=True)
java_TypeParametrizable = Class(name="java_TypeParametrizable", is_abstract=True)
java_TypeParameter = Class(name="java_TypeParameter")
java_ExtendsTypeArgument = Class(name="java_ExtendsTypeArgument")
TypeArgument = Class(name="TypeArgument")
java_QualifiedTypeArgument = Class(name="java_QualifiedTypeArgument")
java_SuperTypeArgument = Class(name="java_SuperTypeArgument")
java_BooleanLiteral = Class(name="java_BooleanLiteral")
Literal = Class(name="Literal")
java_ImportingElement = Class(name="java_ImportingElement", is_abstract=True)
java_StaticImport = Class(name="java_StaticImport", is_abstract=True)
Import = Class(name="Import")
java_Static = Class(name="java_Static")
java_ClassifierImport = Class(name="java_ClassifierImport")
java_PackageImport = Class(name="java_PackageImport")
java_StaticClassifierImport = Class(name="java_StaticClassifierImport")
StaticImport = Class(name="StaticImport")
java_StaticMemberImport = Class(name="java_StaticMemberImport")
java_ReferenceableElement = Class(name="java_ReferenceableElement", is_abstract=True)
java_Initializable = Class(name="java_Initializable", is_abstract=True)
java_Instantiation = Class(name="java_Instantiation", is_abstract=True)
Argumentable = Class(name="Argumentable")
java_NewConstructorCall = Class(name="java_NewConstructorCall")
Instantiation = Class(name="Instantiation")
CallTypeArgumentable = Class(name="CallTypeArgumentable")
java_ExplicitConstructorCall = Class(name="java_ExplicitConstructorCall")
java_Self = Class(name="java_Self", is_abstract=True)
java_Literal = Class(name="java_Literal", is_abstract=True)
PrimaryExpression = Class(name="PrimaryExpression")
java_CharacterLiteral = Class(name="java_CharacterLiteral")
java_FloatLiteral = Class(name="java_FloatLiteral", is_abstract=True)
java_DecimalFloatLiteral = Class(name="java_DecimalFloatLiteral")
FloatLiteral = Class(name="FloatLiteral")
java_HexFloatLiteral = Class(name="java_HexFloatLiteral")
java_DoubleLiteral = Class(name="java_DoubleLiteral", is_abstract=True)
java_DecimalDoubleLiteral = Class(name="java_DecimalDoubleLiteral")
DoubleLiteral = Class(name="DoubleLiteral")
java_HexDoubleLiteral = Class(name="java_HexDoubleLiteral")
java_IntegerLiteral = Class(name="java_IntegerLiteral", is_abstract=True)
java_DecimalIntegerLiteral = Class(name="java_DecimalIntegerLiteral")
IntegerLiteral = Class(name="IntegerLiteral")
java_HexIntegerLiteral = Class(name="java_HexIntegerLiteral")
java_OctalIntegerLiteral = Class(name="java_OctalIntegerLiteral")
java_LongLiteral = Class(name="java_LongLiteral", is_abstract=True)
java_DecimalLongLiteral = Class(name="java_DecimalLongLiteral")
LongLiteral = Class(name="LongLiteral")
java_HexLongLiteral = Class(name="java_HexLongLiteral")
java_OctalLongLiteral = Class(name="java_OctalLongLiteral")
java_NullLiteral = Class(name="java_NullLiteral")
java_Super = Class(name="java_Super")
Self = Class(name="Self")
java_This = Class(name="java_This")
java_ExceptionThrower = Class(name="java_ExceptionThrower", is_abstract=True)
java_NamespaceClassifierReference = Class(name="java_NamespaceClassifierReference")
java_Member = Class(name="java_Member", is_abstract=True)
java_MemberContainer = Class(name="java_MemberContainer", is_abstract=True)
java_AdditionalField = Class(name="java_AdditionalField")
Initializable = Class(name="Initializable")
java_Constructor = Class(name="java_Constructor")
...
java_EmptyMember = Class(name="java_EmptyMember")
java_Field = Class(name="java_Field")
Variable = Class(name="Variable")
java_Method = Class(name="java_Method", is_abstract=True)
Method_ = Class(name="Method")
java_ClassMethod = Class(name="java_ClassMethod")
java_Modifier = Class(name="java_Modifier", is_abstract=True)
java_AnnotationInstanceOrModifier = Class(name="java_AnnotationInstanceOrModifier", is_abstract=True)
java_AnnotableAndModifiable = Class(name="java_AnnotableAndModifiable", is_abstract=True)
java_AssignmentPlus = Class(name="java_AssignmentPlus")
java_AssignmentRightShift = Class(name="java_AssignmentRightShift")
java_AssignmentUnsignedRightShift = Class(name="java_AssignmentUnsignedRightShift")
java_Equal = Class(name="java_Equal")
EqualityOperator = Class(name="EqualityOperator")
java_Modifiable = Class(name="java_Modifiable", is_abstract=True)
java_Abstract = Class(name="java_Abstract")
Modifier = Class(name="Modifier")
java_Final = Class(name="java_Final")
java_Native = Class(name="java_Native")
java_Protected = Class(name="java_Protected")
java_Public = Class(name="java_Public")
java_Private = Class(name="java_Private")
java_Strictfp = Class(name="java_Strictfp")
java_Synchronized = Class(name="java_Synchronized")
java_Transient = Class(name="java_Transient")
java_Volatile = Class(name="java_Volatile")
java_Operator = Class(name="java_Operator", is_abstract=True)
Operator = Class(name="Operator")
java_Assignment = Class(name="java_Assignment")
AssignmentOperator = Class(name="AssignmentOperator")
java_AssignmentAnd = Class(name="java_AssignmentAnd")
java_AssignmentDivision = Class(name="java_AssignmentDivision")
java_AssignmentExclusiveOr = Class(name="java_AssignmentExclusiveOr")
java_AssignmentMinus = Class(name="java_AssignmentMinus")
java_AssignmentModulo = Class(name="java_AssignmentModulo")
java_AssignmentMultiplication = Class(name="java_AssignmentMultiplication")
java_AssignmentLeftShift = Class(name="java_AssignmentLeftShift")
java_AssignmentOr = Class(name="java_AssignmentOr")
java_ReflectiveClassReference = Class(name="java_ReflectiveClassReference")
java_PrimitiveTypeReference = Class(name="java_PrimitiveTypeReference")
java_PrimitiveType = Class(name="java_PrimitiveType", is_abstract=True)
java_NotEqual = Class(name="java_NotEqual")
java_GreaterThan = Class(name="java_GreaterThan")
RelationOperator = Class(name="RelationOperator")
java_GreaterThanOrEqual = Class(name="java_GreaterThanOrEqual")
java_LessThan = Class(name="java_LessThan")
java_LessThanOrEqual = Class(name="java_LessThanOrEqual")
java_Addition = Class(name="java_Addition")
AdditiveOperator = Class(name="AdditiveOperator")
UnaryOperator = Class(name="UnaryOperator")
java_Subtraction = Class(name="java_Subtraction")
java_Division = Class(name="java_Division")
MultiplicativeOperator = Class(name="MultiplicativeOperator")
java_Multiplication = Class(name="java_Multiplication")
java_Remainder = Class(name="java_Remainder")
java_Complement = Class(name="java_Complement")
java_MinusMinus = Class(name="java_MinusMinus")
UnaryModificationOperator = Class(name="UnaryModificationOperator")
java_Negate = Class(name="java_Negate")
java_PlusPlus = Class(name="java_PlusPlus")
java_LeftShift = Class(name="java_LeftShift")
ShiftOperator = Class(name="ShiftOperator")
java_RightShift = Class(name="java_RightShift")
java_UnsignedRightShift = Class(name="java_UnsignedRightShift")
java_Reference = Class(name="java_Reference", is_abstract=True)
TypeArgumentable = Class(name="TypeArgumentable")
java_Argumentable = Class(name="java_Argumentable", is_abstract=True)
java_ElementReference = Class(name="java_ElementReference", is_abstract=True)
java_IdentifierReference = Class(name="java_IdentifierReference")
ElementReference = Class(name="ElementReference")
java_MethodCall = Class(name="java_MethodCall")
java_Condition = Class(name="java_Condition")
StatementContainer = Class(name="StatementContainer")
java_StringReference = Class(name="java_StringReference")
java_SelfReference = Class(name="java_SelfReference")
java_Parameter = Class(name="java_Parameter", is_abstract=True)
java_Parametrizable = Class(name="java_Parametrizable", is_abstract=True)
java_OrdinaryParameter = Class(name="java_OrdinaryParameter")
Parameter_ = Class(name="Parameter")
java_VariableLengthParameter = Class(name="java_VariableLengthParameter")
java_StatementContainer = Class(name="java_StatementContainer", is_abstract=True)
java_Statement = Class(name="java_Statement", is_abstract=True)
java_StatementListContainer = Class(name="java_StatementListContainer", is_abstract=True)
java_Conditional = Class(name="java_Conditional", is_abstract=True)
java_ForLoopInitializer = Class(name="java_ForLoopInitializer", is_abstract=True)
java_SwitchCase = Class(name="java_SwitchCase", is_abstract=True)
java_Assert = Class(name="java_Assert")
Conditional = Class(name="Conditional")
java_Break = Class(name="java_Break")
Jump = Class(name="Jump")
java_Block = Class(name="java_Block")
Modifiable = Class(name="Modifiable")
java_CatchBlock = Class(name="java_CatchBlock")
java_Throw = Class(name="java_Throw")
java_TryBlock = Class(name="java_TryBlock")
java_Continue = Class(name="java_Continue")
java_DefaultSwitchCase = Class(name="java_DefaultSwitchCase")
SwitchCase = Class(name="SwitchCase")
java_DoWhileLoop = Class(name="java_DoWhileLoop")
...
java_ForLoop = Class(name="java_ForLoop")
java_ForEachLoop = Class(name="java_ForEachLoop")
java_Jump = Class(name="java_Jump", is_abstract=True)
java_JumpLabel = Class(name="java_JumpLabel")
java_LocalVariableStatement = Class(name="java_LocalVariableStatement")
java_LocalVariable = Class(name="java_LocalVariable")
java_NormalSwitchCase = Class(name="java_NormalSwitchCase")
java_Return = Class(name="java_Return")
java_Switch = Class(name="java_Switch")
java_SynchronizedBlock = Class(name="java_SynchronizedBlock")
java_WhileLoop = Class(name="java_WhileLoop")
java_Type = Class(name="java_Type", is_abstract=True)
java_TypedElement = Class(name="java_TypedElement", is_abstract=True)
java_ClassifierReference = Class(name="java_ClassifierReference")
TypeReference = Class(name="TypeReference")
java_Boolean = Class(name="java_Boolean")
PrimitiveType = Class(name="PrimitiveType")
java_Byte = Class(name="java_Byte")
java_Char = Class(name="java_Char")
java_Double = Class(name="java_Double")
java_Float = Class(name="java_Float")
java_Int = Class(name="java_Int")
java_Long = Class(name="java_Long")
java_Short = Class(name="java_Short")
java_Void = Class(name="java_Void")
java_PackageReference = Class(name="java_PackageReference")
java_Variable = Class(name="java_Variable", is_abstract=True)
java_AdditionalLocalVariable = Class(name="java_AdditionalLocalVariable")
...
java_Expression_m_getOneType: Method = Method(name="getOneType", parameters={Parameter(name='java_alternative', type=StringType)}, type=Type)
java_Expression_m_getArrayDimension: Method = Method(name="getArrayDimension", parameters={}, type=StringType)
java_Expression.methods={java_Expression_m_getAlternativeType, java_Expression_m_getArrayDimension, java_Expression_m_getOneType, java_Expression_m_getType}
...
java_ConcreteClassifier_m_getAllMembers: Method = Method(name="getAllMembers", parameters={Parameter(name='java_context', type=StringType)}, type=Member)
...
java_ConcreteClassifier.methods={java_ConcreteClassifier_m_getAllInnerClassifiers, java_ConcreteClassifier_m_getInnerClassifiers, java_ConcreteClassifier_m_getSuperTypeReferences, java_ConcreteClassifier_m_getAllMembers}
...
java_TypeReference_m_getBoundTarget: Method = Method(name="getBoundTarget", parameters={Parameter(name='java_reference', type=StringType)}, type=Type)
java_TypeReference_m_getPureClassifierReference: Method = Method(name="getPureClassifierReference", parameters={}, type=StringType)
java_TypeReference.methods={java_TypeReference_m_getTarget, java_TypeReference_m_getBoundTarget, java_TypeReference_m_getPureClassifierReference}
...
java_Class.methods={java_Class_m_getSuperClass, java_Class_m_unWrapPrimitiveType, java_Class_m_getAllSuperClassifiers}
...
java_Enumeration_m_getContainedConstant: Method = Method(name="getContainedConstant", parameters={Parameter(name='java_name', type=StringType)}, type=StringType)
...
java_AnonymousClass_m_getAllMembers: Method = Method(name="getAllMembers", parameters={Parameter(name='java_context', type=StringType)}, type=Member)
java_AnonymousClass.methods={java_AnonymousClass_m_getAllMembers, java_AnonymousClass_m_getSuperClassifier, java_AnonymousClass_m_getAllSuperClassifiers}
...
java_Commentable_m_getConcreteClassifier: Method = Method(name="getConcreteClassifier", parameters={Parameter(name='java_name', type=StringType)}, type=ConcreteClassifier)
java_Commentable_m_getConcreteClassifierProxy: Method = Method(name="getConcreteClassifierProxy", parameters={Parameter(name='java_name', type=StringType)}, type=ConcreteClassifier)
java_Commentable_m_getConcreteClassifiers: Method = Method(name="getConcreteClassifiers", parameters={Parameter(name='java_classifierQuery', type=StringType), Parameter(name='java_packageName', type=StringType)}, type=ConcreteClassifier)
java_Commentable_m_getConcreteClassifierProxies: Method = Method(name="getConcreteClassifierProxies", parameters={Parameter(name='java_packageName', type=StringType), Parameter(name='java_classifierQuery', type=StringType)}, type=ConcreteClassifier)
java_Commentable_m_getLibClass: Method = Method(name="getLibClass", parameters={Parameter(name='java_name', type=StringType)}, type=StringType)
java_Commentable_m_getLibInterface: Method = Method(name="getLibInterface", parameters={Parameter(name='java_name', type=StringType)}, type=StringType)
...
java_Commentable_m_getParentByEType: Method = Method(name="getParentByEType", parameters={Parameter(name='java_type', type=StringType)}, type=StringType)
java_Commentable_m_getFirstChildByEType: Method = Method(name="getFirstChildByEType", parameters={Parameter(name='java_type', type=StringType)}, type=StringType)
java_Commentable_m_getParentByType: Method = Method(name="getParentByType", parameters={Parameter(name='java_type', type=StringType)})
java_Commentable_m_getFirstChildByType: Method = Method(name="getFirstChildByType", parameters={Parameter(name='java_type', type=StringType)})
java_Commentable_m_getChildrenByEType: Method = Method(name="getChildrenByEType", parameters={Parameter(name='java_type', type=StringType)}, type=StringType)
java_Commentable_m_getChildrenByType: Method = Method(name="getChildrenByType", parameters={Parameter(name='java_type', type=StringType)})
java_Commentable_m_getComments: Method = Method(name="getComments", parameters={}, type=StringType)
java_Commentable_m_addBeforeContainingStatement: Method = Method(name="addBeforeContainingStatement", parameters={Parameter(name='java_statementToAdd', type=StringType)})
java_Commentable_m_addAfterContainingStatement: Method = Method(name="addAfterContainingStatement", parameters={Parameter(name='java_statementToAdd', type=StringType)})
java_Commentable.methods={java_Commentable_m_getChildrenByEType, java_Commentable_m_getContainingAnonymousClass, java_Commentable_m_getAnnotationInterface, java_Commentable_m_getContainingPackageName, java_Commentable_m_getFirstChildByEType, java_Commentable_m_addBeforeContainingStatement, java_Commentable_m_getLibInterface, java_Commentable_m_getContainingConcreteClassifier, java_Commentable_m_getConcreteClassifierProxy, java_Commentable_m_getConcreteClassifiers, java_Commentable_m_getParentByType, java_Commentable_m_getComments, java_Commentable_m_getContainingCompilationUnit, java_Commentable_m_getConcreteClassifier, java_Commentable_m_getStringClass, java_Commentable_m_getClassClass, java_Commentable_m_getParentByEType, java_Commentable_m_addAfterContainingStatement, java_Commentable_m_getFirstChildByType, java_Commentable_m_getChildrenByType, java_Commentable_m_getConcreteClassifierProxies, java_Commentable_m_getObjectClass, java_Commentable_m_getLibClass, java_Commentable_m_getParentConcreteClassifier, java_Commentable_m_getContainingAnnotationInstance}
...
java_NamespaceAwareElement.methods={java_NamespaceAwareElement_m_getNamespacesAsString, java_NamespaceAwareElement_m_getClassifierAtNamespaces}
...
java_CompilationUnit_m_getContainedClassifier: Method = Method(name="getContainedClassifier", parameters={Parameter(name='java_name', type=StringType)}, type=ConcreteClassifier)
...
java_CompilationUnit.methods={java_CompilationUnit_m_getContainedClassifier, java_CompilationUnit_m_getClassifiersInSamePackage}
...
java_Import_m_getImportedClassifier: Method = Method(name="getImportedClassifier", parameters={Parameter(name='java_name', type=StringType)}, type=ConcreteClassifier)
...
java_Import.methods={java_Import_m_getImportedMembers, java_Import_m_getImportedClassifiers, java_Import_m_getImportedClassifier}
...
java_TypeParameter_m_getAllMembers: Method = Method(name="getAllMembers", parameters={Parameter(name='java_context', type=StringType)}, type=Member)
java_TypeParameter_m_getBoundType: Method = Method(name="getBoundType", parameters={Parameter(name='java_reference', type=StringType), Parameter(name='java_typeReference', type=StringType)}, type=Type)
java_TypeParameter.methods={java_TypeParameter_m_getAllSuperClassifiers, java_TypeParameter_m_getBoundType, java_TypeParameter_m_getAllMembers}
...
java_Literal_m_getOneType: Method = Method(name="getOneType", parameters={Parameter(name='java_alternative', type=StringType)}, type=Type)
...
java_MemberContainer_m_getContainedMethod: Method = Method(name="getContainedMethod", parameters={Parameter(name='java_name', type=StringType)}, type=StringType)
java_MemberContainer_m_getContainedClassifier: Method = Method(name="getContainedClassifier", parameters={Parameter(name='java_name', type=StringType)}, type=ConcreteClassifier)
java_MemberContainer_m_getContainedField: Method = Method(name="getContainedField", parameters={Parameter(name='java_name', type=StringType)}, type=StringType)
java_MemberContainer_m_getMethods: Method = Method(name="getMethods", parameters={}, type=StringType)
java_MemberContainer_m_removeMethods: Method = Method(name="removeMethods", parameters={Parameter(name='java_name', type=StringType)})
java_MemberContainer_m_getMembersByName: Method = Method(name="getMembersByName", parameters={Parameter(name='java_name', type=StringType)}, type=Member)
java_MemberContainer_m_createField: Method = Method(name="createField", parameters={Parameter(name='java_qualifiedTypeName', type=StringType), Parameter(name='java_name', type=StringType)}, type=StringType)
java_MemberContainer_m_getFields: Method = Method(name="getFields", parameters={}, type=StringType)
java_MemberContainer.methods={java_MemberContainer_m_removeMethods, java_MemberContainer_m_getContainedMethod, java_MemberContainer_m_getFields, java_MemberContainer_m_getMethods, java_MemberContainer_m_createField, java_MemberContainer_m_getMembersByName, java_MemberContainer_m_getContainedField, java_MemberContainer_m_getContainedClassifier}
...
java_Method_m_isSomeMethodForCall: Method = Method(name="isSomeMethodForCall", parameters={Parameter(name='java_methodCall', type=StringType)}, type=BooleanType)
java_Method_m_isMethodForCall: Method = Method(name="isMethodForCall", parameters={Parameter(name='java_methodCall', type=StringType), Parameter(name='java_needsPerfectMatch', type=StringType)}, type=BooleanType)
java_Method_m_isBetterMethodForCall: Method = Method(name="isBetterMethodForCall", parameters={Parameter(name='java_otherMethod', type=StringType), Parameter(name='java_methodCall', type=StringType)}, type=BooleanType)
java_Method_m_getArrayDimension: Method = Method(name="getArrayDimension", parameters={}, type=StringType)
java_Method.methods={java_Method_m_isBetterMethodForCall, java_Method_m_isMethodForCall, java_Method_m_getArrayDimension, java_Method_m_isSomeMethodForCall}
...
java_AnnotableAndModifiable_m_isHidden: Method = Method(name="isHidden", parameters={Parameter(name='java_context', type=StringType)}, type=BooleanType)
java_AnnotableAndModifiable_m_isStatic: Method = Method(name="isStatic", parameters={}, type=BooleanType)
java_AnnotableAndModifiable_m_removeModifier: Method = Method(name="removeModifier", parameters={Parameter(name='java_modifierType', type=StringType)})
...
java_AnnotableAndModifiable_m_hasModifier: Method = Method(name="hasModifier", parameters={Parameter(name='java_type', type=StringType)}, type=BooleanType)
java_AnnotableAndModifiable_m_isProtected: Method = Method(name="isProtected", parameters={}, type=BooleanType)
java_AnnotableAndModifiable_m_addModifier: Method = Method(name="addModifier", parameters={Parameter(name='java_newModifier', type=StringType)})
java_AnnotableAndModifiable.methods={java_AnnotableAndModifiable_m_addModifier, java_AnnotableAndModifiable_m_makePublic, java_AnnotableAndModifiable_m_isStatic, java_AnnotableAndModifiable_m_removeAllModifiers, java_AnnotableAndModifiable_m_isHidden, java_AnnotableAndModifiable_m_isProtected, java_AnnotableAndModifiable_m_isPublic, java_AnnotableAndModifiable_m_isPrivate, java_AnnotableAndModifiable_m_makePrivate, java_AnnotableAndModifiable_m_makeProtected, java_AnnotableAndModifiable_m_removeModifier, java_AnnotableAndModifiable_m_getModifiers, java_AnnotableAndModifiable_m_hasModifier}
...
java_PrimitiveType_m_getAllMembers: Method = Method(name="getAllMembers", parameters={Parameter(name='java_context', type=StringType)}, type=Member)
java_PrimitiveType_m_wrapPrimitiveType: Method = Method(name="wrapPrimitiveType", parameters={}, type=StringType)
java_PrimitiveType.methods={java_PrimitiveType_m_wrapPrimitiveType, java_PrimitiveType_m_getAllMembers}
...
java_Reference.methods={java_Reference_m_getPrevious, java_Reference_m_getReferencedType}
...
java_StatementListContainer_m_getLocalVariable: Method = Method(name="getLocalVariable", parameters={Parameter(name='java_name', type=StringType)}, type=StringType)
...
java_Type_m_equalsType: Method = Method(name="equalsType", parameters={Parameter(name='java_otherArrayDimension', type=StringType), Parameter(name='java_arrayDimension', type=StringType), Parameter(name='java_otherType', type=StringType)}, type=BooleanType)
java_Type_m_isSuperType: Method = Method(name="isSuperType", parameters={Parameter(name='java_arrayDimension', type=StringType), Parameter(name='java_otherType', type=StringType), Parameter(name='java_otherArrayType', type=StringType)}, type=BooleanType)
java_Type_m_getAllMembers: Method = Method(name="getAllMembers", parameters={Parameter(name='java_context', type=StringType)}, type=Member)
java_Type.methods={java_Type_m_getAllMembers, java_Type_m_equalsType, java_Type_m_isSuperType}
...
java_Variable_m_createMethodCallStatement: Method = Method(name="createMethodCallStatement", parameters={Parameter(name='java_arguments', type=StringType), Parameter(name='java_methodName', type=StringType)}, type=Statement)
java_Variable_m_createMethodCall: Method = Method(name="createMethodCall", parameters={Parameter(name='java_arguments', type=StringType), Parameter(name='java_methodName', type=StringType)}, type=Expression)
java_Variable.methods={java_Variable_m_getArrayDimension, java_Variable_m_createMethodCall, java_Variable_m_createMethodCallStatement}
...
domain_model = DomainModel(
    name="java",
    types={java_Expression, java_ArrayTypeable, java_Annotable, Commentable, java_AnnotationInstance, Reference, AnnotationInstanceOrModifier, NamespaceAwareElement, java_Classifier, java_AnnotationParameter, java_SingleAnnotationParameter, AnnotationParameter, java_AnnotationValue, java_AnnotationParameterList, java_AnnotationAttributeSetting, java_InterfaceMethod, java_AnnotationAttribute, InterfaceMethod, java_ArrayDimension, java_ArrayInitializer, ArrayInitializationValue, AnnotationValue, java_ArrayInitializationValue, java_ArrayInstantiation, Expression, java_ArrayInstantiationBySize, ArrayInstantiation, TypedElement, ArrayTypeable, java_ArrayInstantiationByValues, java_ArrayInstantiationByValuesUntyped, ArrayInstantiationByValues, java_ArrayInstantiationByValuesTyped, java_ArraySelector, Type, ReferenceableElement, java_ConcreteClassifier, Classifier, TypeParametrizable, MemberContainer, Member, Statement, AnnotableAndModifiable, java_Annotation, java_Implementor, java_TypeReference, java_Class, ConcreteClassifier, Implementor, java_Interface, java_Enumeration, java_EnumConstant, java_AnonymousClass, java_Commentable, java_LayoutInformation, java_NamedElement, java_NamespaceAwareElement, java_ConditionalExpression, AssignmentExpressionChild, java_JavaRoot, NamedElement, ImportingElement, java_CompilationUnit, JavaRoot, java_Package, Annotable, java_EmptyModel, java_ExpressionList, ForLoopInitializer, java_AssignmentExpression, java_AssignmentExpressionChild, java_AssignmentOperator, java_RelationExpression, InstanceOfExpressionChild, java_RelationExpressionChild, java_ConditionalExpressionChild, java_ConditionalOrExpression, ConditionalExpressionChild, java_ConditionalOrExpressionChild, java_ConditionalAndExpression, ConditionalOrExpressionChild, java_ConditionalAndExpressionChild, java_InclusiveOrExpression, ConditionalAndExpressionChild, java_InclusiveOrExpressionChild, java_ExclusiveOrExpression, InclusiveOrExpressionChild, java_ExclusiveOrExpressionChild, java_AndExpression, ExclusiveOrExpressionChild, java_AndExpressionChild, java_EqualityExpression, AndExpressionChild, java_EqualityOperator, java_EqualityExpressionChild, java_InstanceOfExpression, EqualityExpressionChild, java_InstanceOfExpressionChild, java_PrefixUnaryModificationExpression, UnaryModificationExpression, java_SuffixUnaryModificationExpression, java_RelationOperator, java_ShiftExpression, RelationExpressionChild, java_ShiftExpressionChild, java_ShiftOperator, java_AdditiveExpression, ShiftExpressionChild, java_AdditiveExpressionChild, java_AdditiveOperator, java_MultiplicativeExpression, AdditiveExpressionChild, java_MultiplicativeExpressionChild, java_MultiplicativeOperator, java_UnaryExpression, MultiplicativeExpressionChild, java_UnaryOperator, java_UnaryExpressionChild, java_UnaryModificationExpression, UnaryExpressionChild, java_UnaryModificationExpressionChild, java_UnaryModificationOperator, java_UnknownTypeArgument, java_Import, java_CastExpression, UnaryModificationExpressionChild, java_PrimaryExpression, java_NestedExpression, java_TypeArgument, java_TypeArgumentable, java_CallTypeArgumentable, java_TypeParametrizable, java_TypeParameter, java_ExtendsTypeArgument, TypeArgument, java_QualifiedTypeArgument, java_SuperTypeArgument, java_BooleanLiteral, Literal, java_ImportingElement, java_StaticImport, Import, java_Static, java_ClassifierImport, java_PackageImport, java_StaticClassifierImport, StaticImport, java_StaticMemberImport, java_ReferenceableElement, java_Initializable, java_Instantiation, Argumentable, java_NewConstructorCall, Instantiation, CallTypeArgumentable, java_ExplicitConstructorCall, java_Self, java_Literal, PrimaryExpression, java_CharacterLiteral, java_FloatLiteral, java_DecimalFloatLiteral, FloatLiteral, java_HexFloatLiteral, java_DoubleLiteral, java_DecimalDoubleLiteral, DoubleLiteral, java_HexDoubleLiteral, java_IntegerLiteral, java_DecimalIntegerLiteral, IntegerLiteral, java_HexIntegerLiteral, java_OctalIntegerLiteral, java_LongLiteral, java_DecimalLongLiteral, LongLiteral, java_HexLongLiteral, java_OctalLongLiteral, java_NullLiteral, java_Super, Self, java_This, java_ExceptionThrower, java_NamespaceClassifierReference, java_Member, java_MemberContainer, java_AdditionalField, Initializable, java_Constructor, StatementListContainer, Parametrizable, ExceptionThrower, java_EmptyMember, java_Field, Variable, java_Method, Method_, java_ClassMethod, java_Modifier, java_AnnotationInstanceOrModifier, java_AnnotableAndModifiable, java_AssignmentPlus, java_AssignmentRightShift, java_AssignmentUnsignedRightShift, java_Equal, EqualityOperator, java_Modifiable, java_Abstract, Modifier, java_Final, java_Native, java_Protected, java_Public, java_Private, java_Strictfp, java_Synchronized, java_Transient, java_Volatile, java_Operator, Operator, java_Assignment, AssignmentOperator, java_AssignmentAnd, java_AssignmentDivision, java_AssignmentExclusiveOr, java_AssignmentMinus, java_AssignmentModulo, java_AssignmentMultiplication, java_AssignmentLeftShift, java_AssignmentOr, java_ReflectiveClassReference, java_PrimitiveTypeReference, java_PrimitiveType, java_NotEqual, java_GreaterThan, RelationOperator, java_GreaterThanOrEqual, java_LessThan, java_LessThanOrEqual, java_Addition, AdditiveOperator, UnaryOperator, java_Subtraction, java_Division, MultiplicativeOperator, java_Multiplication, java_Remainder, java_Complement, java_MinusMinus, UnaryModificationOperator, java_Negate, java_PlusPlus, java_LeftShift, ShiftOperator, java_RightShift, java_UnsignedRightShift, java_Reference, TypeArgumentable, java_Argumentable, java_ElementReference, java_IdentifierReference, ElementReference, java_MethodCall, java_Condition, StatementContainer, java_StringReference, java_SelfReference, java_Parameter, java_Parametrizable, java_OrdinaryParameter, Parameter_, java_VariableLengthParameter, java_StatementContainer, java_Statement, java_StatementListContainer, java_Conditional, java_ForLoopInitializer, java_SwitchCase, java_Assert, Conditional, java_Break, Jump, java_Block, Modifiable, java_CatchBlock, java_Throw, java_TryBlock, java_Continue, java_DefaultSwitchCase, SwitchCase, java_DoWhileLoop, WhileLoop, java_EmptyStatement, java_ExpressionStatement, java_ForLoop, java_ForEachLoop, java_Jump, java_JumpLabel, java_LocalVariableStatement, java_LocalVariable, java_NormalSwitchCase, java_Return, java_Switch, java_SynchronizedBlock, java_WhileLoop, java_Type, java_TypedElement, java_ClassifierReference, TypeReference, java_Boolean, PrimitiveType, java_Byte, java_Char, java_Double, java_Float, java_Int, java_Long, java_Short, java_Void, java_PackageReference, java_Variable, java_AdditionalLocalVariable},
    associations={defaultValue12, annotations0, annotation1, parameter3, value5, settings6, attribute7, value9, arrayDimensionsBefore13, arrayDimensionsAfter14, initialValues17, sizes18, arrayInitializer20, position22, implements24, extends25, defaultExtends27, extends30, defaultExtends32, constants35, layoutInformations36, value45, classifiers37, compilationUnits38, expressions40, child42, assignmentOperator43, children64, child48, expressionIf49, expressionElse52, children55, children56, children57, children58, children59, equalityOperators60, children61, child63, relationOperators65, children67, shiftOperators68, children70, additiveOperators71, children73, multiplicativeOperators74, operators76, child77, child79, operator80, extendTypes94, child82, expression84, typeArguments86, callTypeArguments87, typeParameters89, extendTypes90, superType92, imports97, static98, classifier99, staticMembers101, initialValue102, anonymousClass104, callTarget105, exceptions106, members107, defaultMembers108, additionalFields111, anonymousClass112, annotationsAndModifiers115, modifiers116, primitiveType126, next118, arraySelectors119, arguments122, target124, elseStatement138, self127, parameters129, statement130, statements131, condition133, errorMessage135, parameter137, throwable161, expression140, init142, updates143, next146, collection148, target151, variable152, returnValue153, cases155, variable156, lockProvider159, classifierReferences173, catcheBlocks163, finallyBlock165, condition167, typeReference169, target171, subpackages177, additionalLocalVariables178},
    generalizations={gen_java_ArrayTypeable_Commentable, gen_java_Annotable_Commentable, gen_java_AnnotationInstance_Reference, gen_java_AnnotationInstance_AnnotationInstanceOrModifier, gen_java_AnnotationInstance_NamespaceAwareElement, gen_java_AnnotationParameter_Commentable, gen_java_SingleAnnotationParameter_AnnotationParameter, gen_java_AnnotationParameterList_AnnotationParameter, gen_java_AnnotationAttributeSetting_Commentable, gen_java_AnnotationValue_Commentable, gen_java_AnnotationAttribute_InterfaceMethod, gen_java_ArrayDimension_Commentable, gen_java_ArrayInitializer_ArrayInitializationValue, gen_java_ArrayInitializer_AnnotationValue, gen_java_ArrayInitializationValue_Commentable, gen_java_ArrayInstantiation_Expression, gen_java_ArrayInstantiation_Reference, gen_java_ArrayInstantiationBySize_ArrayInstantiation, gen_java_ArrayInstantiationBySize_TypedElement, gen_java_ArrayInstantiationBySize_ArrayTypeable, gen_java_ArrayInstantiationByValues_ArrayInstantiation, gen_java_ArrayInstantiationByValuesUntyped_ArrayInstantiationByValues, gen_java_ArrayInstantiationByValuesTyped_ArrayInstantiationByValues, gen_java_ArrayInstantiationByValuesTyped_TypedElement, gen_java_ArrayInstantiationByValuesTyped_ArrayTypeable, gen_java_ArraySelector_Commentable, gen_java_Classifier_Type, gen_java_Classifier_ReferenceableElement, gen_java_ConcreteClassifier_Classifier, gen_java_ConcreteClassifier_TypeParametrizable, gen_java_ConcreteClassifier_MemberContainer, gen_java_ConcreteClassifier_Member, gen_java_ConcreteClassifier_Statement, gen_java_ConcreteClassifier_AnnotableAndModifiable, gen_java_Annotation_ConcreteClassifier, gen_java_Implementor_Commentable, gen_java_Class_ConcreteClassifier, gen_java_Class_Implementor, gen_java_Interface_ConcreteClassifier, gen_java_Enumeration_ConcreteClassifier, gen_java_Enumeration_Implementor, gen_java_AnonymousClass_Type, gen_java_AnonymousClass_MemberContainer, gen_java_NamedElement_Commentable, gen_java_NamespaceAwareElement_Commentable, gen_java_AssignmentExpressionChild_Expression, gen_java_ConditionalExpression_AssignmentExpressionChild, gen_java_JavaRoot_NamedElement, gen_java_JavaRoot_NamespaceAwareElement, gen_java_JavaRoot_ImportingElement, gen_java_CompilationUnit_JavaRoot, gen_java_Package_JavaRoot, gen_java_Package_Annotable, gen_java_EmptyModel_JavaRoot, gen_java_ExpressionList_ForLoopInitializer, gen_java_Expression_ArrayInitializationValue, gen_java_Expression_AnnotationValue, gen_java_AssignmentExpression_Expression, gen_java_RelationExpression_InstanceOfExpressionChild, gen_java_ConditionalExpressionChild_AssignmentExpressionChild, gen_java_ConditionalOrExpression_ConditionalExpressionChild, gen_java_ConditionalOrExpressionChild_ConditionalExpressionChild, gen_java_ConditionalAndExpression_ConditionalOrExpressionChild, gen_java_ConditionalAndExpressionChild_ConditionalOrExpressionChild, gen_java_InclusiveOrExpression_ConditionalAndExpressionChild, gen_java_InclusiveOrExpressionChild_ConditionalAndExpressionChild, gen_java_ExclusiveOrExpression_InclusiveOrExpressionChild, gen_java_ExclusiveOrExpressionChild_InclusiveOrExpressionChild, gen_java_AndExpression_ExclusiveOrExpressionChild, gen_java_AndExpressionChild_ExclusiveOrExpressionChild, gen_java_EqualityExpression_AndExpressionChild, gen_java_EqualityExpressionChild_AndExpressionChild, gen_java_InstanceOfExpression_ArrayTypeable, gen_java_InstanceOfExpression_TypedElement, gen_java_InstanceOfExpression_EqualityExpressionChild, gen_java_InstanceOfExpressionChild_EqualityExpressionChild, gen_java_PrefixUnaryModificationExpression_UnaryModificationExpression, gen_java_SuffixUnaryModificationExpression_UnaryModificationExpression, gen_java_UnaryModificationExpressionChild_UnaryExpressionChild, gen_java_RelationExpressionChild_InstanceOfExpressionChild, gen_java_ShiftExpression_RelationExpressionChild, gen_java_ShiftExpressionChild_RelationExpressionChild, gen_java_AdditiveExpression_ShiftExpressionChild, gen_java_AdditiveExpressionChild_ShiftExpressionChild, gen_java_MultiplicativeExpression_AdditiveExpressionChild, gen_java_MultiplicativeExpressionChild_AdditiveExpressionChild, gen_java_UnaryExpression_MultiplicativeExpressionChild, gen_java_UnaryExpressionChild_MultiplicativeExpressionChild, gen_java_UnaryModificationExpression_UnaryExpressionChild, gen_java_UnknownTypeArgument_TypeArgument, gen_java_Import_NamespaceAwareElement, gen_java_CastExpression_TypedElement, gen_java_CastExpression_ArrayTypeable, gen_java_CastExpression_UnaryModificationExpressionChild, gen_java_PrimaryExpression_UnaryModificationExpressionChild, gen_java_NestedExpression_Reference, gen_java_TypeArgument_ArrayTypeable, gen_java_TypeArgumentable_Commentable, gen_java_CallTypeArgumentable_Commentable, gen_java_TypeParametrizable_Commentable, gen_java_ExtendsTypeArgument_TypeArgument, gen_java_QualifiedTypeArgument_TypeArgument, gen_java_QualifiedTypeArgument_TypedElement, gen_java_SuperTypeArgument_TypeArgument, gen_java_TypeParameter_Classifier, gen_java_Self_Commentable, gen_java_BooleanLiteral_Literal, gen_java_ImportingElement_Commentable, gen_java_StaticImport_Import, gen_java_ClassifierImport_Import, gen_java_PackageImport_Import, gen_java_StaticClassifierImport_StaticImport, gen_java_StaticMemberImport_StaticImport, gen_java_Initializable_Commentable, gen_java_Instantiation_Reference, gen_java_Instantiation_Argumentable, gen_java_NewConstructorCall_TypedElement, gen_java_NewConstructorCall_Instantiation, gen_java_NewConstructorCall_CallTypeArgumentable, gen_java_ExplicitConstructorCall_Instantiation, gen_java_Literal_PrimaryExpression, gen_java_CharacterLiteral_Literal, gen_java_FloatLiteral_Literal, gen_java_DecimalFloatLiteral_FloatLiteral, gen_java_HexFloatLiteral_FloatLiteral, gen_java_DoubleLiteral_Literal, gen_java_DecimalDoubleLiteral_DoubleLiteral, gen_java_HexDoubleLiteral_DoubleLiteral, gen_java_IntegerLiteral_Literal, gen_java_DecimalIntegerLiteral_IntegerLiteral, gen_java_HexIntegerLiteral_IntegerLiteral, gen_java_OctalIntegerLiteral_IntegerLiteral, gen_java_LongLiteral_Literal, gen_java_DecimalLongLiteral_LongLiteral, gen_java_HexLongLiteral_LongLiteral, gen_java_OctalLongLiteral_LongLiteral, gen_java_NullLiteral_Literal, gen_java_Super_Self, gen_java_This_Self, gen_java_ExceptionThrower_Commentable, gen_java_Member_NamedElement, gen_java_MemberContainer_Commentable, gen_java_AdditionalField_ReferenceableElement, gen_java_AdditionalField_ArrayTypeable, gen_java_AdditionalField_Initializable, gen_java_Constructor_Member, gen_java_Constructor_StatementListContainer, gen_java_Constructor_Parametrizable, gen_java_Constructor_TypeParametrizable, gen_java_Constructor_ExceptionThrower, gen_java_Constructor_AnnotableAndModifiable, gen_java_EmptyMember_Member, gen_java_Field_Member, gen_java_Field_Initializable, gen_java_Field_Variable, gen_java_Field_ReferenceableElement, gen_java_Field_AnnotableAndModifiable, gen_java_Method_Member, gen_java_Method_TypedElement, gen_java_Method_ArrayTypeable, gen_java_Method_TypeParametrizable, gen_java_Method_Parametrizable, gen_java_Method_ReferenceableElement, gen_java_Method_ExceptionThrower, gen_java_Method_AnnotableAndModifiable, gen_java_InterfaceMethod_Method, gen_java_ClassMethod_Method, gen_java_ClassMethod_StatementListContainer, gen_java_EnumConstant_ReferenceableElement, gen_java_EnumConstant_Argumentable, gen_java_EnumConstant_Annotable, gen_java_Modifier_AnnotationInstanceOrModifier, gen_java_AnnotationInstanceOrModifier_Commentable, gen_java_AnnotableAndModifiable_Commentable, gen_java_AssignmentPlus_AssignmentOperator, gen_java_AssignmentRightShift_AssignmentOperator, gen_java_AssignmentUnsignedRightShift_AssignmentOperator, gen_java_Equal_EqualityOperator, gen_java_Modifiable_Commentable, gen_java_Abstract_Modifier, gen_java_Final_Modifier, gen_java_Native_Modifier, gen_java_Protected_Modifier, gen_java_Public_Modifier, gen_java_Private_Modifier, gen_java_Static_Modifier, gen_java_Strictfp_Modifier, gen_java_Synchronized_Modifier, gen_java_Transient_Modifier, gen_java_Volatile_Modifier, gen_java_Operator_Commentable, gen_java_AdditiveOperator_Operator, gen_java_AssignmentOperator_Operator, gen_java_EqualityOperator_Operator, gen_java_MultiplicativeOperator_Operator, gen_java_RelationOperator_Operator, gen_java_ShiftOperator_Operator, gen_java_UnaryOperator_Operator, gen_java_UnaryModificationOperator_Operator, gen_java_Assignment_AssignmentOperator, gen_java_AssignmentAnd_AssignmentOperator, gen_java_AssignmentDivision_AssignmentOperator, gen_java_AssignmentExclusiveOr_AssignmentOperator, gen_java_AssignmentMinus_AssignmentOperator, gen_java_AssignmentModulo_AssignmentOperator, gen_java_AssignmentMultiplication_AssignmentOperator, gen_java_AssignmentLeftShift_AssignmentOperator, gen_java_AssignmentOr_AssignmentOperator, gen_java_ReflectiveClassReference_Reference, gen_java_PrimitiveTypeReference_Reference, gen_java_NotEqual_EqualityOperator, gen_java_GreaterThan_RelationOperator, gen_java_GreaterThanOrEqual_RelationOperator, gen_java_LessThan_RelationOperator, gen_java_LessThanOrEqual_RelationOperator, gen_java_Addition_AdditiveOperator, gen_java_Addition_UnaryOperator, gen_java_Subtraction_AdditiveOperator, gen_java_Subtraction_UnaryOperator, gen_java_Division_MultiplicativeOperator, gen_java_Multiplication_MultiplicativeOperator, gen_java_Remainder_MultiplicativeOperator, gen_java_Complement_UnaryOperator, gen_java_MinusMinus_UnaryModificationOperator, gen_java_Negate_UnaryOperator, gen_java_PlusPlus_UnaryModificationOperator, gen_java_LeftShift_ShiftOperator, gen_java_RightShift_ShiftOperator, gen_java_UnsignedRightShift_ShiftOperator, gen_java_Reference_PrimaryExpression, gen_java_Reference_TypeArgumentable, gen_java_Argumentable_Commentable, gen_java_ReferenceableElement_NamedElement, gen_java_ElementReference_Reference, gen_java_IdentifierReference_ElementReference, gen_java_MethodCall_ElementReference, gen_java_MethodCall_Argumentable, gen_java_MethodCall_CallTypeArgumentable, gen_java_Condition_Statement, gen_java_Condition_StatementContainer, gen_java_Condition_Conditional, gen_java_StringReference_Reference, gen_java_SelfReference_Reference, gen_java_Parameter_Variable, gen_java_Parameter_AnnotableAndModifiable, gen_java_Parametrizable_Commentable, gen_java_OrdinaryParameter_Parameter, gen_java_VariableLengthParameter_Parameter, gen_java_StatementContainer_Commentable, gen_java_StatementListContainer_Commentable, gen_java_Conditional_Commentable, gen_java_ForLoopInitializer_Commentable, gen_java_Statement_Commentable, gen_java_SwitchCase_StatementListContainer, gen_java_Assert_Statement, gen_java_Assert_Conditional, gen_java_Break_Jump, gen_java_Block_Member, gen_java_Block_Statement, gen_java_Block_StatementListContainer, gen_java_Block_Modifiable, gen_java_CatchBlock_StatementListContainer, gen_java_Throw_Statement, gen_java_Continue_Jump, gen_java_DefaultSwitchCase_SwitchCase, gen_java_DoWhileLoop_WhileLoop, gen_java_EmptyStatement_Statement, gen_java_ExpressionStatement_Statement, gen_java_ForLoop_Statement, gen_java_ForLoop_StatementContainer, gen_java_ForLoop_Conditional, gen_java_ForEachLoop_Statement, gen_java_ForEachLoop_StatementContainer, gen_java_Jump_Statement, gen_java_JumpLabel_Statement, gen_java_JumpLabel_StatementContainer, gen_java_JumpLabel_NamedElement, gen_java_LocalVariableStatement_Statement, gen_java_NormalSwitchCase_SwitchCase, gen_java_NormalSwitchCase_Conditional, gen_java_Return_Statement, gen_java_Switch_Statement, gen_java_SynchronizedBlock_Statement, gen_java_SynchronizedBlock_StatementListContainer, gen_java_PrimitiveType_Type, gen_java_PrimitiveType_TypeReference, gen_java_TryBlock_Statement, gen_java_TryBlock_StatementListContainer, gen_java_WhileLoop_Statement, gen_java_WhileLoop_StatementContainer, gen_java_Type_Commentable, gen_java_TypedElement_Commentable, gen_java_TypeReference_Commentable, gen_java_ClassifierReference_TypeReference, gen_java_ClassifierReference_TypeArgumentable, gen_java_NamespaceClassifierReference_TypeReference, gen_java_NamespaceClassifierReference_NamespaceAwareElement, gen_java_Boolean_PrimitiveType, gen_java_Byte_PrimitiveType, gen_java_Char_PrimitiveType, gen_java_Double_PrimitiveType, gen_java_Float_PrimitiveType, gen_java_Int_PrimitiveType, gen_java_Long_PrimitiveType, gen_java_Short_PrimitiveType, gen_java_Void_PrimitiveType, gen_java_PackageReference_ReferenceableElement, gen_java_Variable_NamedElement, gen_java_Variable_TypedElement, gen_java_Variable_ArrayTypeable, gen_java_Variable_ReferenceableElement, gen_java_Variable_TypeArgumentable, gen_java_LocalVariable_Variable, gen_java_LocalVariable_Initializable, gen_java_LocalVariable_ForLoopInitializer, gen_java_LocalVariable_AnnotableAndModifiable, gen_java_AdditionalLocalVariable_ReferenceableElement, gen_java_AdditionalLocalVariable_ArrayTypeable, gen_java_AdditionalLocalVariable_Initializable},
    metadata=None
)
