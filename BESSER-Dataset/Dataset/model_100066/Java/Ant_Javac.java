...
public class Ant_Javac extends CompileTask {
    ...
    public Ant_Javac(
        String deprecation,        String fork,        String destdir,        String debug,        String srcdir,        String optimize    ) {
        super(
        );
    ...
    public Ant_Javac(
        String deprecation,        String fork,        String destdir,        String debug,        String srcdir,        String optimize        ArrayList<InExcludes> inexcludess    ) {
        this.deprecation = deprecation;
        this.fork = fork;
        this.destdir = destdir;
        this.debug = debug;
