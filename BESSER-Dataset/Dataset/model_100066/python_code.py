...
class Ant_Jar(ArchiveTask):
    ...
    def __init__(self, jarfile: str, basedir: str, encoding: str, manifest: str, compress: str):
...
class Ant_FileSet(Set):
    ...
    def __init__(self, dir: str, Ant_FileSet: set["PatternSet"] = None, Ant_FileSet18: set["Excludes"] = None, Ant_FileSet16: set["Includes"] = None):
        self.dir = dir
...
class Ant_Mapper(Basic):
    ...
    def __init__(self, classname: str, classpath: str, classpathref: str, from_: str, to: str, type: str):
        self.classname = classname
...
class Ant_Project:
    ...
    def __init__(self, name: str, description: str, basedir: str, Ant_Project: "Target" = None, Ant_Project2: "Path" = None, Ant_Project4: set["Property"] = None, Ant_Project6: set["TaskDef"] = None, Ant_Project8: set["Target"] = None):
        self.name = name
        self.description = description
        self.basedir = basedir
