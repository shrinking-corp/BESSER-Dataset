...
class diagram_filter_MappingFilter(Filter):
    ...
    def diagram_filter_MappingFilter(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "DiagramElementMapping450"):
                    opp_val = getattr(item, "DiagramElementMapping450", None)
                    
                    if opp_val == self:
                        setattr(item, "DiagramElementMapping450", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "DiagramElementMapping450"):
                    ...
                    setattr(item, "DiagramElementMapping450", self)
...
class diagram_tool_CreateView(ContainerModelOperation):
    ...
    def diagram_tool_CreateView(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "DiagramElementMapping428"):
                opp_val = getattr(old_value, "DiagramElementMapping428", None)
                if opp_val == self:
                    setattr(old_value, "DiagramElementMapping428", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "DiagramElementMapping428"):
                opp_val = getattr(value, "DiagramElementMapping428", None)
                setattr(value, "DiagramElementMapping428", self)
...
class diagram_tool_Navigation(ContainerModelOperation):
    ...
    def diagram_tool_Navigation(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "DiagramDescription430"):
                opp_val = getattr(old_value, "DiagramDescription430", None)
                if opp_val == self:
                    setattr(old_value, "DiagramDescription430", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "DiagramDescription430"):
                opp_val = getattr(value, "DiagramDescription430", None)
                setattr(value, "DiagramDescription430", self)
...
class diagram_tool_BehaviorTool(AbstractToolDescription):
    ...
    def diagram_tool_BehaviorTool(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tool_InitialOperation426"):
                opp_val = getattr(old_value, "tool_InitialOperation426", None)
                if opp_val == self:
                    setattr(old_value, "tool_InitialOperation426", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tool_InitialOperation426"):
                opp_val = getattr(value, "tool_InitialOperation426", None)
                setattr(value, "tool_InitialOperation426", self)
...
class diagram_tool_ReconnectEdgeDescription(MappingBasedToolDescription):
    ...
    def __init__(self, reconnectionKind: str, diagram_tool_ReconnectEdgeDescription: "tool_SourceEdgeCreationVariable" = None, diagram_tool_ReconnectEdgeDescription405: "tool_TargetEdgeCreationVariable" = None, diagram_tool_ReconnectEdgeDescription408: "tool_SourceEdgeViewCreationVariable" = None, diagram_tool_ReconnectEdgeDescription411: "tool_TargetEdgeViewCreationVariable" = None, diagram_tool_ReconnectEdgeDescription414: "tool_ElementSelectVariable" = None, diagram_tool_ReconnectEdgeDescription416: "tool_InitialOperation" = None, diagram_tool_ReconnectEdgeDescription419: "tool_ElementSelectVariable" = None):
        ...
        self.diagram_tool_ReconnectEdgeDescription419 = diagram_tool_ReconnectEdgeDescription419
    ...
    @property
    def diagram_tool_ReconnectEdgeDescription419(self):
        return self.__diagram_tool_ReconnectEdgeDescription419

    @diagram_tool_ReconnectEdgeDescription419.setter
    def diagram_tool_ReconnectEdgeDescription419(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_diagram_tool_ReconnectEdgeDescription__diagram_tool_ReconnectEdgeDescription419", None)
        self.__diagram_tool_ReconnectEdgeDescription419 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tool_ElementSelectVariable420"):
                opp_val = getattr(old_value, "tool_ElementSelectVariable420", None)
                if opp_val == self:
                    setattr(old_value, "tool_ElementSelectVariable420", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tool_ElementSelectVariable420"):
                opp_val = getattr(value, "tool_ElementSelectVariable420", None)
                setattr(value, "tool_ElementSelectVariable420", self)
    ...
    def diagram_tool_ReconnectEdgeDescription416(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tool_InitialOperation417"):
                opp_val = getattr(old_value, "tool_InitialOperation417", None)
                if opp_val == self:
                    setattr(old_value, "tool_InitialOperation417", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tool_InitialOperation417"):
                opp_val = getattr(value, "tool_InitialOperation417", None)
                setattr(value, "tool_InitialOperation417", self)
    ...
    def diagram_tool_ReconnectEdgeDescription408(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tool_SourceEdgeViewCreationVariable409"):
                opp_val = getattr(old_value, "tool_SourceEdgeViewCreationVariable409", None)
                if opp_val == self:
                    setattr(old_value, "tool_SourceEdgeViewCreationVariable409", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tool_SourceEdgeViewCreationVariable409"):
                opp_val = getattr(value, "tool_SourceEdgeViewCreationVariable409", None)
                setattr(value, "tool_SourceEdgeViewCreationVariable409", self)
    ...
    def diagram_tool_ReconnectEdgeDescription411(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tool_TargetEdgeViewCreationVariable412"):
                opp_val = getattr(old_value, "tool_TargetEdgeViewCreationVariable412", None)
                if opp_val == self:
                    setattr(old_value, "tool_TargetEdgeViewCreationVariable412", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tool_TargetEdgeViewCreationVariable412"):
                opp_val = getattr(value, "tool_TargetEdgeViewCreationVariable412", None)
                setattr(value, "tool_TargetEdgeViewCreationVariable412", self)
    ...
    def diagram_tool_ReconnectEdgeDescription(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tool_SourceEdgeCreationVariable403"):
                opp_val = getattr(old_value, "tool_SourceEdgeCreationVariable403", None)
                if opp_val == self:
                    setattr(old_value, "tool_SourceEdgeCreationVariable403", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tool_SourceEdgeCreationVariable403"):
                opp_val = getattr(value, "tool_SourceEdgeCreationVariable403", None)
                setattr(value, "tool_SourceEdgeCreationVariable403", self)
    ...
    def diagram_tool_ReconnectEdgeDescription405(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tool_TargetEdgeCreationVariable406"):
                opp_val = getattr(old_value, "tool_TargetEdgeCreationVariable406", None)
                if opp_val == self:
                    setattr(old_value, "tool_TargetEdgeCreationVariable406", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tool_TargetEdgeCreationVariable406"):
                opp_val = getattr(value, "tool_TargetEdgeCreationVariable406", None)
                setattr(value, "tool_TargetEdgeCreationVariable406", self)
...
class diagram_tool_DirectEditLabel(MappingBasedToolDescription):
    ...
    def __init__(self, inputLabelExpression: str, diagram_tool_DirectEditLabel: "tool_EditMaskVariables" = None, diagram_tool_DirectEditLabel423: "tool_InitialOperation" = None):
        self.inputLabelExpression = inputLabelExpression
        self.diagram_tool_DirectEditLabel = diagram_tool_DirectEditLabel
        self.diagram_tool_DirectEditLabel423 = diagram_tool_DirectEditLabel423
    ...
    @property
    def diagram_tool_DirectEditLabel423(self):
        return self.__diagram_tool_DirectEditLabel423

    @diagram_tool_DirectEditLabel423.setter
    def diagram_tool_DirectEditLabel423(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_diagram_tool_DirectEditLabel__diagram_tool_DirectEditLabel423", None)
        self.__diagram_tool_DirectEditLabel423 = value
...
class diagram_tool_ContainerDropDescription(MappingBasedToolDescription):
    ...
    def __init__(self, dragSource: str, moveEdges: bool, diagram_tool_ContainerDropDescription: set["DiagramElementMapping"] = None, diagram_tool_ContainerDropDescription438: "tool_DropContainerVariable" = None, diagram_tool_ContainerDropDescription440: "tool_DropContainerVariable" = None, diagram_tool_ContainerDropDescription443: "tool_ElementDropVariable" = None, diagram_tool_ContainerDropDescription445: "tool_ContainerViewVariable" = None, diagram_tool_ContainerDropDescription448: "tool_InitialContainerDropOperation" = None):
        ...
        self.diagram_tool_ContainerDropDescription438 = diagram_tool_ContainerDropDescription438
        self.diagram_tool_ContainerDropDescription440 = diagram_tool_ContainerDropDescription440
        self.diagram_tool_ContainerDropDescription443 = diagram_tool_ContainerDropDescription443
        self.diagram_tool_ContainerDropDescription445 = diagram_tool_ContainerDropDescription445
        self.diagram_tool_ContainerDropDescription448 = diagram_tool_ContainerDropDescription448
    ...
    @property
    def diagram_tool_ContainerDropDescription438(self):
        return self.__diagram_tool_ContainerDropDescription438

    @diagram_tool_ContainerDropDescription438.setter
    def diagram_tool_ContainerDropDescription438(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_diagram_tool_ContainerDropDescription__diagram_tool_ContainerDropDescription438", None)
        self.__diagram_tool_ContainerDropDescription438 = value
    ...
    def diagram_tool_ContainerDropDescription445(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tool_ContainerViewVariable446"):
                opp_val = getattr(old_value, "tool_ContainerViewVariable446", None)
                if opp_val == self:
                    setattr(old_value, "tool_ContainerViewVariable446", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tool_ContainerViewVariable446"):
                opp_val = getattr(value, "tool_ContainerViewVariable446", None)
                setattr(value, "tool_ContainerViewVariable446", self)

    @property
    def diagram_tool_ContainerDropDescription443(self):
        return self.__diagram_tool_ContainerDropDescription443

    @diagram_tool_ContainerDropDescription443.setter
    def diagram_tool_ContainerDropDescription443(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_diagram_tool_ContainerDropDescription__diagram_tool_ContainerDropDescription443", None)
        self.__diagram_tool_ContainerDropDescription443 = value
    ...
    def diagram_tool_ContainerDropDescription(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "DiagramElementMapping436"):
                    opp_val = getattr(item, "DiagramElementMapping436", None)
                    
                    if opp_val == self:
                        setattr(item, "DiagramElementMapping436", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "DiagramElementMapping436"):
                    ...
                    setattr(item, "DiagramElementMapping436", self)
                    

    @property
    def diagram_tool_ContainerDropDescription448(self):
        return self.__diagram_tool_ContainerDropDescription448

    @diagram_tool_ContainerDropDescription448.setter
    def diagram_tool_ContainerDropDescription448(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_diagram_tool_ContainerDropDescription__diagram_tool_ContainerDropDescription448", None)
        self.__diagram_tool_ContainerDropDescription448 = value
    ...
    def diagram_tool_ContainerDropDescription440(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tool_DropContainerVariable441"):
                opp_val = getattr(old_value, "tool_DropContainerVariable441", None)
                if opp_val == self:
                    setattr(old_value, "tool_DropContainerVariable441", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tool_DropContainerVariable441"):
                opp_val = getattr(value, "tool_DropContainerVariable441", None)
                setattr(value, "tool_DropContainerVariable441", self)

    def getContainers(self) :
        # TODO: Implement getContainers method
        pass

    def getBestMapping(self, diagram_targetContainer, diagram_droppedElement) :
...
class diagram_tool_ContainerCreationDescription(MappingBasedToolDescription):
    ...
    def __init__(self, iconPath: str, diagram_tool_ContainerCreationDescription: set["ContainerMapping"] = None, diagram_tool_ContainerCreationDescription369: "tool_NodeCreationVariable" = None, diagram_tool_ContainerCreationDescription372: "tool_ContainerViewVariable" = None, diagram_tool_ContainerCreationDescription375: "tool_InitialNodeCreationOperation" = None, diagram_tool_ContainerCreationDescription378: set["AbstractNodeMapping"] = None):
...
class diagram_tool_NodeCreationDescription(MappingBasedToolDescription):
    ...
    def __init__(self, iconPath: str, diagram_tool_NodeCreationDescription: set["NodeMapping"] = None, diagram_tool_NodeCreationDescription340: "tool_NodeCreationVariable" = None, diagram_tool_NodeCreationDescription342: "tool_ContainerViewVariable" = None, diagram_tool_NodeCreationDescription344: "tool_InitialNodeCreationOperation" = None, diagram_tool_NodeCreationDescription346: set["AbstractNodeMapping"] = None):
        self.iconPath = iconPath
...
class diagram_tool_EdgeCreationDescription(MappingBasedToolDescription):
    ...
    def getBestMapping(self, diagram_createdElements, diagram_target, diagram_source) :
        # TODO: Implement getBestMapping method
        pass
...
class style_BorderedStyleDescription:
    ...
    pass
class diagram_style_ContainerStyleDescription(style_HideLabelCapabilityStyleDescription, style_LabelStyleDescription, style_BorderedStyleDescription, style_TooltipStyleDescription, style_RoundedCornerStyleDescription):
...
class diagram_style_EdgeStyleDescription(StyleDescription):
    ...
    def __init__(self, sourceArrow: str, targetArrow: str, sizeComputationExpression: str, routingStyle: str, foldingStyle: str, endsCentering: str, lineStyle: str, diagram_style_EdgeStyleDescription309: "style_BeginLabelStyleDescription" = None, diagram_style_EdgeStyleDescription311: "style_CenterLabelStyleDescription" = None, diagram_style_EdgeStyleDescription313: "style_EndLabelStyleDescription" = None, diagram_style_EdgeStyleDescription: "ColorDescription" = None, diagram_style_EdgeStyleDescription315: set["DiagramElementMapping"] = None, diagram_style_EdgeStyleDescription318: set["DiagramElementMapping"] = None):
...
class diagram_style_ShapeContainerStyleDescription(style_SizeComputationContainerStyleDescription, style_ContainerStyleDescription):
    ...
    def __init__(self, shape: str, diagram_style_ShapeContainerStyleDescription: "ColorDescription" = None, style_ContainerStyleDescription242: "diagram_description_ConditionalContainerStyleDescription" = None, style_ContainerStyleDescription: "diagram_description_ContainerMapping" = None):
        self.shape = shape
...
class diagram_style_FlatContainerStyleDescription(style_SizeComputationContainerStyleDescription, style_ContainerStyleDescription):
    ...
    def __init__(self, backgroundStyle: str, diagram_style_FlatContainerStyleDescription: "ColorDescription" = None, diagram_style_FlatContainerStyleDescription300: "ColorDescription" = None, diagram_style_FlatContainerStyleDescription303: "style_LabelBorderStyleDescription" = None, style_ContainerStyleDescription242: "diagram_description_ConditionalContainerStyleDescription" = None, style_ContainerStyleDescription: "diagram_description_ContainerMapping" = None):
...
class diagram_style_WorkspaceImageDescription(style_NodeStyleDescription, style_ContainerStyleDescription):
    ...
    def __init__(self, workspacePath: str, style_NodeStyleDescription: "diagram_description_NodeMapping" = None, style_NodeStyleDescription238: "diagram_description_ConditionalNodeStyleDescription" = None, style_ContainerStyleDescription242: "diagram_description_ConditionalContainerStyleDescription" = None, style_ContainerStyleDescription: "diagram_description_ContainerMapping" = None):
...
class diagram_description_NodeMapping(description_AbstractNodeMapping, description_DragAndDropTargetDescription):
    ...
    def getNodesCandidates(self, diagram_container, diagram_containerView, diagram_semanticOrigin) :
...
class diagram_description_ContainerMapping(description_AbstractNodeMapping, description_DragAndDropTargetDescription):
    ...
    def __init__(self, childrenPresentation: str, diagram_description_ContainerMapping212: "style_ContainerStyleDescription" = None, diagram_description_ContainerMapping214: set["ConditionalContainerStyleDescription"] = None, diagram_description_ContainerMapping: set["NodeMapping"] = None, diagram_description_ContainerMapping197: set["NodeMapping"] = None, diagram_description_ContainerMapping200: set["NodeMapping"] = None, diagram_description_ContainerMapping203: set["ContainerMapping"] = None, diagram_description_ContainerMapping206: set["ContainerMapping"] = None, diagram_description_ContainerMapping209: set["ContainerMapping"] = None):
...
class style_StyleDescription:
    ...
    pass
class diagram_style_NodeStyleDescription(style_StyleDescription, style_HideLabelCapabilityStyleDescription, style_LabelStyleDescription, style_BorderedStyleDescription, style_TooltipStyleDescription):

    def __init__(self, forbiddenSides: str, sizeComputationExpression: str, labelPosition: str, resizeKind: str, style_StyleDescription: "diagram_ComputedStyleDescriptionRegistry" = None):
...
class diagram_description_DiagramElementMapping(description_RepresentationElementMapping, description_PasteTargetDescription):
    ...
    def __init__(self, semanticCandidatesExpression: str, createElements: bool, semanticElements: str, synchronizationLock: bool, preconditionExpression: str, diagram_description_DiagramElementMapping184: "tool_DirectEditLabel" = None, mappings: "tool_DoubleClickDescription" = None, diagram_description_DiagramElementMapping: "tool_DeleteElementDescription" = None):
    ...
    def checkPrecondition(self, diagram_container, diagram_modelElement, diagram_containerView) :
...
class ContainerMapping:
    ...
    pass
class diagram_ContainerStyle(BorderedStyle, HideLabelCapabilityStyle, LabelStyle, Style):
...
class diagram_Style:
    ...
    pass
class diagram_NodeStyle(BorderedStyle, HideLabelCapabilityStyle, LabelStyle, Style):
...
class diagram_description_AdditionalLayer(Layer):
    ...
    def __init__(self, activeByDefault: bool, optional: bool, Layer: "diagram_DDiagram" = None, Layer149: "diagram_description_DiagramDescription" = None, Layer144: "diagram_description_DiagramDescription" = None, Layer34: "diagram_DDiagramElement" = None):
...
class diagram_DEdge(EdgeTarget, DDiagramElement):
    ...
    def __init__(self, routingStyle: str, isFold: bool, isMockEdge: bool, size: str, arrangeConstraints: str, beginLabel: str, endLabel: str, diagram_DEdge: "diagram_DDiagram" = None, outgoingEdges: "diagram_EdgeTarget" = None, incomingEdges: "diagram_EdgeTarget" = None, diagram_DEdge94: "IEdgeMapping" = None, diagram_DEdge96: "diagram_Style" = None, diagram_DEdge89: "diagram_EdgeStyle" = None, diagram_DEdge99: set["diagram_EdgeTarget"] = None, DEdge: "diagram_EdgeTarget" = None, DEdge102: "diagram_EdgeTarget" = None):
        self.routingStyle = routingStyle
        self.isFold = isFold
...
class diagram_description_Layer(description_EndUserDocumentedElement, description_IdentifiedElement, description_DocumentedElement):
    ...
    def __init__(self, icon: str, diagram_description_Layer250: set["EdgeMapping"] = None, diagram_description_Layer253: set["EdgeMappingImport"] = None, diagram_description_Layer256: set["ContainerMapping"] = None, diagram_description_Layer: set["NodeMapping"] = None, diagram_description_Layer273: set["EdgeMapping"] = None, diagram_description_Layer276: "Customization" = None, diagram_description_Layer268: set["tool_AbstractToolDescription"] = None, diagram_description_Layer271: "DecorationDescriptionsSet" = None, diagram_description_Layer259: set["DiagramElementMapping"] = None, diagram_description_Layer262: set["tool_AbstractToolDescription"] = None, diagram_description_Layer265: set["tool_ToolSection"] = None):
        self.icon = icon
...
class diagram_description_EdgeMapping(description_DiagramElementMapping, description_DocumentedElement, description_IEdgeMapping):
    ...
    def __init__(self, sourceFinderExpression: str, targetExpression: str, domainClass: str, useDomainElement: bool, targetFinderExpression: str, pathExpression: str, diagram_description_EdgeMapping225: "style_EdgeStyleDescription" = None, diagram_description_EdgeMapping227: set["ConditionalEdgeStyleDescription"] = None, diagram_description_EdgeMapping: set["DiagramElementMapping"] = None, diagram_description_EdgeMapping222: set["DiagramElementMapping"] = None, diagram_description_EdgeMapping229: set["tool_ReconnectEdgeDescription"] = None, diagram_description_EdgeMapping231: set["AbstractNodeMapping"] = None):
    ...
    def getBestStyle(self, diagram_containerVariable, diagram_modelElement, diagram_viewVariable) :
        # TODO: Implement getBestStyle method
        pass
