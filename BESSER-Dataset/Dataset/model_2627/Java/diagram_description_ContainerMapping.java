...
public class diagram_description_ContainerMapping extends description_AbstractNodeMapping, description_DragAndDropTargetDescription {
    ...
    public diagram_description_ContainerMapping(
        String childrenPresentation        ArrayList<ContainerMapping> containermappings,        ArrayList<NodeMapping> nodemappings,        ArrayList<ContainerMapping> containermappings,        ArrayList<ContainerMapping> containermappings,        ArrayList<NodeMapping> nodemappings,        ArrayList<NodeMapping> nodemappings    ) {
        this.childrenPresentation = childrenPresentation;
