...
diagram_DDiagram.methods={diagram_DDiagram_m_getContainersFromMapping, diagram_DDiagram_m_getNodesFromMapping, diagram_DDiagram_m_getEdgesFromMapping}
...
diagram_DEdge.attributes={diagram_DEdge_routingStyle, diagram_DEdge_isFold, diagram_DEdge_endLabel, diagram_DEdge_size, diagram_DEdge_arrangeConstraints, diagram_DEdge_beginLabel, diagram_DEdge_isMockEdge}
...
diagram_AbsoluteBoundsFilter.attributes={diagram_AbsoluteBoundsFilter_x, diagram_AbsoluteBoundsFilter_y, diagram_AbsoluteBoundsFilter_height, diagram_AbsoluteBoundsFilter_width}
...
diagram_EdgeStyle.attributes={diagram_EdgeStyle_centered, diagram_EdgeStyle_lineStyle, diagram_EdgeStyle_targetArrow, diagram_EdgeStyle_foldingStyle, diagram_EdgeStyle_routingStyle, diagram_EdgeStyle_sourceArrow, diagram_EdgeStyle_size, diagram_EdgeStyle_strokeColor}
...
diagram_GaugeSection.attributes={diagram_GaugeSection_min, diagram_GaugeSection_max, diagram_GaugeSection_foregroundColor, diagram_GaugeSection_label, diagram_GaugeSection_value, diagram_GaugeSection_backgroundColor}
...
diagram_Ellipse.attributes={diagram_Ellipse_horizontalDiameter, diagram_Ellipse_verticalDiameter, diagram_Ellipse_color}
...
diagram_Lozenge.attributes={diagram_Lozenge_width, diagram_Lozenge_height, diagram_Lozenge_color}
...
diagram_description_DiagramDescription.attributes={diagram_description_DiagramDescription_enablePopupBars, diagram_description_DiagramDescription_rootExpression, diagram_description_DiagramDescription_preconditionExpression, diagram_description_DiagramDescription_domainClass}
...
diagram_description_DiagramElementMapping_m_checkPrecondition: Method = Method(name="checkPrecondition", parameters={Parameter(name='diagram_modelElement', type=StringType), Parameter(name='diagram_container', type=StringType), Parameter(name='diagram_containerView', type=StringType)}, type=BooleanType)
...
diagram_description_DiagramElementMapping.attributes={diagram_description_DiagramElementMapping_preconditionExpression, diagram_description_DiagramElementMapping_semanticElements, diagram_description_DiagramElementMapping_synchronizationLock, diagram_description_DiagramElementMapping_createElements, diagram_description_DiagramElementMapping_semanticCandidatesExpression}
...
diagram_description_NodeMapping_m_getNodesCandidates: Method = Method(name="getNodesCandidates", parameters={Parameter(name='diagram_container', type=StringType), Parameter(name='diagram_semanticOrigin', type=StringType), Parameter(name='diagram_containerView', type=StringType)}, type=StringType)
diagram_description_NodeMapping_m_createNode: Method = Method(name="createNode", parameters={Parameter(name='diagram_modelElement', type=StringType), Parameter(name='diagram_container', type=StringType), Parameter(name='diagram_viewPoint', type=StringType)}, type=StringType)
diagram_description_NodeMapping.methods={diagram_description_NodeMapping_m_createNode, diagram_description_NodeMapping_m_getNodesCandidates, diagram_description_NodeMapping_m_getNodesCandidates, diagram_description_NodeMapping_m_updateListElement, diagram_description_NodeMapping_m_updateNode}
...
diagram_description_EdgeMapping_m_createEdge: Method = Method(name="createEdge", parameters={Parameter(name='diagram_target', type=StringType), Parameter(name='diagram_semanticTarget', type=StringType), Parameter(name='diagram_source', type=StringType)}, type=StringType)
...
diagram_description_EdgeMapping_m_getBestStyle: Method = Method(name="getBestStyle", parameters={Parameter(name='diagram_containerVariable', type=StringType), Parameter(name='diagram_viewVariable', type=StringType), Parameter(name='diagram_modelElement', type=StringType)}, type=EdgeStyle)
...
diagram_description_EdgeMapping_m_getEdgeTargetCandidates: Method = Method(name="getEdgeTargetCandidates", parameters={Parameter(name='diagram_semanticOrigin', type=StringType), Parameter(name='diagram_containerView', type=StringType), Parameter(name='diagram_container', type=StringType)}, type=StringType)
diagram_description_EdgeMapping.attributes={diagram_description_EdgeMapping_domainClass, diagram_description_EdgeMapping_sourceFinderExpression, diagram_description_EdgeMapping_targetFinderExpression, diagram_description_EdgeMapping_pathExpression, diagram_description_EdgeMapping_useDomainElement, diagram_description_EdgeMapping_targetExpression}
diagram_description_EdgeMapping.methods={diagram_description_EdgeMapping_m_createEdge, diagram_description_EdgeMapping_m_getEdgeTargetCandidates, diagram_description_EdgeMapping_m_getBestStyle, diagram_description_EdgeMapping_m_getEdgeTargetCandidates, diagram_description_EdgeMapping_m_updateEdge, diagram_description_EdgeMapping_m_createEdge, diagram_description_EdgeMapping_m_getEdgeSourceCandidates}
...
diagram_description_ContainerMapping_m_getBestStyle: Method = Method(name="getBestStyle", parameters={Parameter(name='diagram_containerVariable', type=StringType), Parameter(name='diagram_modelElement', type=StringType), Parameter(name='diagram_viewVariable', type=StringType)}, type=ContainerStyle)
...
diagram_description_IEdgeMapping_m_getBestStyle: Method = Method(name="getBestStyle", parameters={Parameter(name='diagram_modelElement', type=StringType), Parameter(name='diagram_viewVariable', type=StringType), Parameter(name='diagram_containerVariable', type=StringType)}, type=EdgeStyle)
...
diagram_style_NodeStyleDescription.attributes={diagram_style_NodeStyleDescription_resizeKind, diagram_style_NodeStyleDescription_forbiddenSides, diagram_style_NodeStyleDescription_sizeComputationExpression, diagram_style_NodeStyleDescription_labelPosition}
...
diagram_style_GaugeSectionDescription.attributes={diagram_style_GaugeSectionDescription_minValueExpression, diagram_style_GaugeSectionDescription_maxValueExpression, diagram_style_GaugeSectionDescription_valueExpression, diagram_style_GaugeSectionDescription_label}
...
diagram_style_EdgeStyleDescription.attributes={diagram_style_EdgeStyleDescription_sizeComputationExpression, diagram_style_EdgeStyleDescription_sourceArrow, diagram_style_EdgeStyleDescription_endsCentering, diagram_style_EdgeStyleDescription_routingStyle, diagram_style_EdgeStyleDescription_foldingStyle, diagram_style_EdgeStyleDescription_targetArrow, diagram_style_EdgeStyleDescription_lineStyle}
...
diagram_tool_EdgeCreationDescription_m_getBestMapping: Method = Method(name="getBestMapping", parameters={Parameter(name='diagram_createdElements', type=StringType), Parameter(name='diagram_target', type=StringType), Parameter(name='diagram_source', type=StringType)}, type=StringType)
...
diagram_tool_ContainerDropDescription_m_getBestMapping: Method = Method(name="getBestMapping", parameters={Parameter(name='diagram_targetContainer', type=StringType), Parameter(name='diagram_droppedElement', type=StringType)}, type=StringType)
...
elementView395: BinaryAssociation = BinaryAssociation(
    name="elementView395",
    ends={
        Property(name="tool_ElementDoubleClickVariable397", type=diagram_tool_DoubleClickDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_DoubleClickDescription396", type=tool_ElementDoubleClickVariable, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
initialOperation398: BinaryAssociation = BinaryAssociation(
    name="initialOperation398",
    ends={
        Property(name="tool_InitialOperation400", type=diagram_tool_DoubleClickDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_DoubleClickDescription399", type=tool_InitialOperation, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
parameters401: BinaryAssociation = BinaryAssociation(
    name="parameters401",
    ends={
...
source402: BinaryAssociation = BinaryAssociation(
    name="source402",
    ends={
        Property(name="tool_SourceEdgeCreationVariable403", type=diagram_tool_ReconnectEdgeDescription, multiplicity=Multiplicity(1, 1)),
...
mappings392: BinaryAssociation = BinaryAssociation(
    name="mappings392",
    ends={
        Property(name="DiagramElementMapping393", type=diagram_tool_DoubleClickDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="doubleClickDescription", type=DiagramElementMapping, multiplicity=Multiplicity(1, 9999))
    }
)
element394: BinaryAssociation = BinaryAssociation(
    name="element394",
    ends={
...
mask421: BinaryAssociation = BinaryAssociation(
    name="mask421",
    ends={
...
initialOperation422: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="tool_InitialOperation424", type=diagram_tool_DirectEditLabel, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_DirectEditLabel423", type=tool_InitialOperation, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
initialOperation425: BinaryAssociation = BinaryAssociation(
    name="initialOperation425",
    ends={
        Property(name="tool_InitialOperation426", type=diagram_tool_BehaviorTool, multiplicity=Multiplicity(1, 1)),
...
target404: BinaryAssociation = BinaryAssociation(
    name="target404",
    ends={
        Property(name="tool_TargetEdgeCreationVariable406", type=diagram_tool_ReconnectEdgeDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ReconnectEdgeDescription405", type=tool_TargetEdgeCreationVariable, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
sourceView407: BinaryAssociation = BinaryAssociation(
    name="sourceView407",
    ends={
        Property(name="tool_SourceEdgeViewCreationVariable409", type=diagram_tool_ReconnectEdgeDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ReconnectEdgeDescription408", type=tool_SourceEdgeViewCreationVariable, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
targetView410: BinaryAssociation = BinaryAssociation(
    name="targetView410",
    ends={
        Property(name="tool_TargetEdgeViewCreationVariable412", type=diagram_tool_ReconnectEdgeDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ReconnectEdgeDescription411", type=tool_TargetEdgeViewCreationVariable, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
element413: BinaryAssociation = BinaryAssociation(
    name="element413",
    ends={
        Property(name="tool_ElementSelectVariable", type=diagram_tool_ReconnectEdgeDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ReconnectEdgeDescription414", type=tool_ElementSelectVariable, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
initialOperation415: BinaryAssociation = BinaryAssociation(
    name="initialOperation415",
    ends={
        Property(name="tool_InitialOperation417", type=diagram_tool_ReconnectEdgeDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ReconnectEdgeDescription416", type=tool_InitialOperation, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
edgeView418: BinaryAssociation = BinaryAssociation(
    name="edgeView418",
    ends={
        Property(name="tool_ElementSelectVariable420", type=diagram_tool_ReconnectEdgeDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ReconnectEdgeDescription419", type=tool_ElementSelectVariable, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
diagramDescription429: BinaryAssociation = BinaryAssociation(
    name="diagramDescription429",
    ends={
        Property(name="DiagramDescription430", type=diagram_tool_Navigation, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_Navigation", type=DiagramDescription, multiplicity=Multiplicity(1, 1))
    }
)
diagramDescription431: BinaryAssociation = BinaryAssociation(
    name="diagramDescription431",
    ends={
        Property(name="DiagramDescription432", type=diagram_tool_DiagramCreationDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_DiagramCreationDescription", type=DiagramDescription, multiplicity=Multiplicity(1, 1))
    }
)
mapping427: BinaryAssociation = BinaryAssociation(
    name="mapping427",
    ends={
        Property(name="DiagramElementMapping428", type=diagram_tool_CreateView, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_CreateView", type=DiagramElementMapping, multiplicity=Multiplicity(1, 1))
    }
)
diagramDescription433: BinaryAssociation = BinaryAssociation(
    name="diagramDescription433",
    ends={
        Property(name="DiagramDescription434", type=diagram_tool_DiagramNavigationDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_DiagramNavigationDescription", type=DiagramDescription, multiplicity=Multiplicity(1, 1))
    }
)
mappings435: BinaryAssociation = BinaryAssociation(
    name="mappings435",
    ends={
        Property(name="DiagramElementMapping436", type=diagram_tool_ContainerDropDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ContainerDropDescription", type=DiagramElementMapping, multiplicity=Multiplicity(0, 9999))
    }
)
oldContainer437: BinaryAssociation = BinaryAssociation(
    name="oldContainer437",
    ends={
        Property(name="tool_DropContainerVariable", type=diagram_tool_ContainerDropDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ContainerDropDescription438", type=tool_DropContainerVariable, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
newContainer439: BinaryAssociation = BinaryAssociation(
    name="newContainer439",
    ends={
        Property(name="tool_DropContainerVariable441", type=diagram_tool_ContainerDropDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ContainerDropDescription440", type=tool_DropContainerVariable, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
element442: BinaryAssociation = BinaryAssociation(
    name="element442",
    ends={
        Property(name="tool_ElementDropVariable", type=diagram_tool_ContainerDropDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ContainerDropDescription443", type=tool_ElementDropVariable, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
newViewContainer444: BinaryAssociation = BinaryAssociation(
    name="newViewContainer444",
    ends={
        Property(name="tool_ContainerViewVariable446", type=diagram_tool_ContainerDropDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ContainerDropDescription445", type=tool_ContainerViewVariable, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
initialOperation447: BinaryAssociation = BinaryAssociation(
    name="initialOperation447",
    ends={
        ...
        Property(name="diagram_tool_ContainerDropDescription448", type=tool_InitialContainerDropOperation, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
ownedConcernDescriptions453: BinaryAssociation = BinaryAssociation(
    name="ownedConcernDescriptions453",
    ends={
        Property(name="concern_ConcernDescription454", type=diagram_concern_ConcernSet, multiplicity=Multiplicity(1, 1)),
...
filters455: BinaryAssociation = BinaryAssociation(
    name="filters455",
    ends={
        Property(name="filter_FilterDescription456", type=diagram_concern_ConcernDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_concern_ConcernDescription", type=filter_FilterDescription, multiplicity=Multiplicity(0, 9999))
    }
)
rules457: BinaryAssociation = BinaryAssociation(
    name="rules457",
    ends={
        Property(name="validation_ValidationRule459", type=diagram_concern_ConcernDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_concern_ConcernDescription458", type=validation_ValidationRule, multiplicity=Multiplicity(0, 9999))
    }
)
behaviors460: BinaryAssociation = BinaryAssociation(
    name="behaviors460",
    ends={
        Property(name="tool_BehaviorTool462", type=diagram_concern_ConcernDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_concern_ConcernDescription461", type=tool_BehaviorTool, multiplicity=Multiplicity(0, 9999))
    }
)
mappings449: BinaryAssociation = BinaryAssociation(
    name="mappings449",
    ends={
        Property(name="DiagramElementMapping450", type=diagram_filter_MappingFilter, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_filter_MappingFilter", type=DiagramElementMapping, multiplicity=Multiplicity(0, 9999))
    }
)
filters451: BinaryAssociation = BinaryAssociation(
    name="filters451",
    ends={
...
ownedVariables452: BinaryAssociation = BinaryAssociation(
    name="ownedVariables452",
    ends={
...
domain_model = DomainModel(
    name="diagram",
    types={diagram_DDiagram, DRepresentation, description_DocumentedElement, DragAndDropTarget, diagram_DDiagramElement, DiagramDescription, diagram_DEdge, diagram_DNode, diagram_DNodeListElement, diagram_DDiagramElementContainer, concern_ConcernDescription, filter_FilterDescription, validation_ValidationRule, diagram_FilterVariableHistory, Layer, diagram_DSemanticDiagram, DDiagram, DSemanticDecorator, DRepresentationElement, diagram_Decoration, DiagramElementMapping, diagram_GraphicalFilter, diagram_HideFilter, GraphicalFilter, diagram_HideLabelFilter, diagram_FoldingPointFilter, diagram_FoldingFilter, diagram_AppliedCompositeFilters, tool_BehaviorTool, filter_CompositeFilterDescription, diagram_AbsoluteBoundsFilter, diagram_AbstractDNode, DDiagramElement, AbstractDNode, EdgeTarget, diagram_NodeStyle, diagram_Style, NodeMapping, diagram_ContainerStyle, ContainerMapping, diagram_DNodeContainer, DDiagramElementContainer, IEdgeMapping, diagram_DNodeList, diagram_EdgeStyle, diagram_EdgeTarget, LabelStyle, Style, BorderedStyle, HideLabelCapabilityStyle, diagram_FlatContainerStyle, ContainerStyle, diagram_ShapeContainerStyle, diagram_Dot, NodeStyle, diagram_GaugeSection, Customizable, diagram_BundledImage, diagram_WorkspaceImage, diagram_Square, diagram_Ellipse, diagram_Lozenge, diagram_BeginLabelStyle, diagram_CenterLabelStyle, diagram_EndLabelStyle, diagram_CustomStyle, diagram_GaugeCompositeStyle, diagram_IndirectlyCollapseFilter, CollapseFilter, BasicLabelStyle, diagram_BorderedStyle, diagram_Note, diagram_VariableValue, diagram_CollapseFilter, description_PasteTargetDescription, EdgeMapping, diagram_BracketEdgeStyle, EdgeStyle, diagram_ComputedStyleDescriptionRegistry, style_StyleDescription, diagram_DragAndDropTarget, diagram_HideLabelCapabilityStyle, diagram_TypedVariableValue, VariableValue, TypedVariable, diagram_EObjectVariableValue, tool_SelectModelElementVariable, diagram_EObject, diagram_description_DiagramDescription, description_DragAndDropTargetDescription, description_RepresentationDescription, Layout, tool_InitialOperation, AdditionalLayer, validation_ValidationSet, concern_ConcernSet, tool_AbstractToolDescription, tool_RepresentationCreationDescription, diagram_description_DiagramImportDescription, description_RepresentationImportDescription, description_DiagramDescription, diagram_description_DiagramExtensionDescription, RepresentationExtensionDescription, diagram_description_DiagramElementMapping, description_RepresentationElementMapping, EdgeMappingImport, tool_ToolSection, tool_DirectEditLabel, tool_DoubleClickDescription, diagram_description_AbstractNodeMapping, description_DiagramElementMapping, tool_DeleteElementDescription, style_NodeStyleDescription, diagram_description_NodeMapping, description_AbstractNodeMapping, style_ContainerStyleDescription, ConditionalContainerStyleDescription, diagram_description_NodeMappingImport, description_NodeMapping, description_AbstractMappingImport, diagram_description_ContainerMappingImport, description_ContainerMapping, diagram_description_EdgeMapping, description_IEdgeMapping, ConditionalNodeStyleDescription, diagram_description_ContainerMapping, style_EdgeStyleDescription, ConditionalEdgeStyleDescription, diagram_description_ConditionalNodeStyleDescription, ConditionalStyleDescription, diagram_description_ConditionalEdgeStyleDescription, diagram_description_ConditionalContainerStyleDescription, diagram_description_Layout, DocumentedElement, diagram_description_OrderedTreeLayout, diagram_description_CompositeLayout, tool_ReconnectEdgeDescription, AbstractNodeMapping, diagram_description_IEdgeMapping, diagram_description_EdgeMappingImport, description_IdentifiedElement, diagram_description_MappingBasedDecoration, DecorationDescription, diagram_description_Layer, description_EndUserDocumentedElement, Customization, diagram_description_AdditionalLayer, diagram_description_DragAndDropTargetDescription, tool_ContainerDropDescription, DecorationDescriptionsSet, diagram_style_CustomStyleDescription, NodeStyleDescription, diagram_style_SquareDescription, diagram_style_LozengeNodeDescription, diagram_style_BorderedStyleDescription, StyleDescription, ColorDescription, diagram_style_NodeStyleDescription, style_BorderedStyleDescription, style_LabelStyleDescription, style_TooltipStyleDescription, style_HideLabelCapabilityStyleDescription, diagram_style_NoteDescription, diagram_style_DotDescription, diagram_style_GaugeCompositeStyleDescription, diagram_style_EllipseNodeDescription, diagram_style_BundledImageDescription, diagram_style_RoundedCornerStyleDescription, diagram_style_ContainerStyleDescription, style_RoundedCornerStyleDescription, diagram_style_FlatContainerStyleDescription, style_SizeComputationContainerStyleDescription, style_GaugeSectionDescription, diagram_style_GaugeSectionDescription, diagram_style_SizeComputationContainerStyleDescription, style_BeginLabelStyleDescription, style_CenterLabelStyleDescription, style_EndLabelStyleDescription, style_LabelBorderStyleDescription, diagram_style_ShapeContainerStyleDescription, diagram_style_WorkspaceImageDescription, diagram_style_EdgeStyleDescription, tool_ToolEntry, tool_PopupMenu, tool_ToolGroupExtension, diagram_tool_ToolGroup, ToolEntry, diagram_tool_ToolGroupExtension, tool_ToolGroup, diagram_style_BeginLabelStyleDescription, BasicLabelStyleDescription, diagram_style_CenterLabelStyleDescription, diagram_style_EndLabelStyleDescription, diagram_style_BracketEdgeStyleDescription, EdgeStyleDescription, diagram_style_HideLabelCapabilityStyleDescription, diagram_tool_ToolSection, diagram_tool_EdgeCreationDescription, tool_SourceEdgeCreationVariable, tool_TargetEdgeCreationVariable, tool_SourceEdgeViewCreationVariable, diagram_tool_NodeCreationDescription, MappingBasedToolDescription, tool_NodeCreationVariable, tool_ContainerViewVariable, tool_InitialNodeCreationOperation, diagram_tool_DeleteElementDescription, tool_ElementDeleteVariable, tool_TargetEdgeViewCreationVariable, tool_InitEdgeCreationOperation, diagram_tool_ContainerCreationDescription, diagram_tool_DeleteHook, tool_DeleteHookParameter, diagram_tool_DeleteHookParameter, diagram_tool_ReconnectEdgeDescription, tool_DeleteHook, diagram_tool_DoubleClickDescription, tool_ElementDoubleClickVariable, diagram_tool_DirectEditLabel, tool_EditMaskVariables, diagram_tool_BehaviorTool, tool_ElementSelectVariable, diagram_tool_RequestDescription, AbstractToolDescription, diagram_tool_CreateEdgeView, CreateView, diagram_tool_Navigation, diagram_tool_DiagramCreationDescription, RepresentationCreationDescription, diagram_tool_DiagramNavigationDescription, RepresentationNavigationDescription, diagram_tool_SourceEdgeCreationVariable, description_AbstractVariable, tool_VariableContainer, diagram_tool_SourceEdgeViewCreationVariable, diagram_tool_TargetEdgeCreationVariable, diagram_tool_TargetEdgeViewCreationVariable, diagram_tool_ElementDoubleClickVariable, diagram_tool_NodeCreationVariable, diagram_tool_CreateView, ContainerModelOperation, diagram_filter_FilterDescription, diagram_filter_Filter, diagram_filter_MappingFilter, Filter, diagram_tool_ContainerDropDescription, tool_DropContainerVariable, tool_ElementDropVariable, tool_InitialContainerDropOperation, diagram_concern_ConcernDescription, diagram_filter_CompositeFilterDescription, FilterDescription, filter_Filter, diagram_filter_VariableFilter, InteractiveVariableDescription, diagram_concern_ConcernSet, ContainerLayout, LabelPosition, ContainerShape, BackgroundStyle, BundledImageShape, EdgeRouting, AlignmentKind, LineStyle, EdgeArrows, ResizeKind, ArrangeConstraint, FoldingStyle, LayoutDirection, CenteringStyle, Side, ReconnectionKind, FilterKind},
    associations={ownedDiagramElements0, diagramElements1, description4, edges6, nodes8, nodeListElements10, containers12, currentConcern14, activatedFilters16, allFilters18, activatedRules21, filterVariableHistory25, activatedLayers27, hiddenElements29, parentLayers32, decorations35, diagramElementMapping37, graphicalFilters39, activateBehaviors23, compositeFilterDescriptions41, ownedBorderedNodes42, ownedStyle44, originalStyle46, actualMapping48, candidatesMapping50, nodes53, containers57, elements59, ownedStyle62, originalStyle64, actualMapping67, candidatesMapping69, ownedDiagramElements72, ownedElements74, ownedStyle76, sourceNode90, targetNode91, actualMapping93, originalStyle95, originalStyle79, actualMapping82, candidatesMapping85, ownedStyle88, path98, beginLabelStyle103, centerLabelStyle105, endLabelStyle107, outgoingEdges100, incomingEdges101, sections109, ownedValues110, filters117, allEdgeMappings119, allNodeMappings121, allContainerMappings124, computedStyleDescriptions112, variableDefinition113, variableDefinition114, modelElement115, layout138, diagramInitialisation140, defaultLayer142, additionalLayers145, allLayers147, allActivatedTools150, nodeMappings153, validationSet127, concerns129, allTools131, defaultConcern133, init136, importedDiagram172, layers174, validationSet176, concerns179, edgeMappings156, edgeMappingImports159, containerMappings161, reusedMappings164, toolSection167, reusedTools169, labelDirectEdit183, doubleClickDescription185, deletionDescription182, style191, borderedNodeMappings186, reusedBorderedNodeMappings188, style211, conditionnalStyles213, importedMapping215, importedMapping217, conditionnalStyles192, subNodeMappings194, allNodeMappings196, reusedNodeMappings199, subContainerMappings202, reusedContainerMappings205, allContainerMappings208, style224, conditionnalStyles226, sourceMapping219, targetMapping221, style237, style239, style241, nodeMapping243, reconnections228, pathNodeMapping230, importedMapping232, conditionnalStyles234, edgeMappings249, edgeMappingImports252, containerMappings255, mappings245, nodeMappings247, allEdgeMappings272, customization275, dropDescriptions277, reusedMappings258, allTools261, toolSections264, reusedTools267, decorationDescriptionsSet270, color279, borderColor278, color285, color287, backgroundColor289, color281, color283, backgroundColor297, sections291, backgroundColor292, foregroundColor294, beginLabelStyleDescription308, centerLabelStyleDescription310, endLabelStyleDescription312, foregroundColor299, labelBorderStyle302, backgroundColor304, strokeColor306, ownedTools320, subSections321, popupMenus324, reusedTools326, groupExtensions329, tools331, group333, centeredSourceMappings314, centeredTargetMappings317, edgeMappings348, sourceVariable350, targetVariable352, sourceViewVariable354, tools334, nodeMappings337, variable339, viewVariable341, initialOperation343, extraMappings345, containerMappings366, variable368, viewVariable371, initialOperation374, extraMappings377, element380, targetViewVariable356, initialOperation358, extraSourceMappings360, extraTargetMappings363, elementView395, initialOperation398, parameters401, source402, elementView381, containerView384, initialOperation387, hook390, mappings392, element394, mask421, initialOperation422, initialOperation425, target404, sourceView407, targetView410, element413, initialOperation415, edgeView418, diagramDescription429, diagramDescription431, mapping427, diagramDescription433, mappings435, oldContainer437, newContainer439, element442, newViewContainer444, initialOperation447, ownedConcernDescriptions453, filters455, rules457, behaviors460, mappings449, filters451, ownedVariables452},
    generalizations={gen_diagram_DDiagram_DRepresentation, gen_diagram_DDiagram_description_DocumentedElement, gen_diagram_DDiagram_DragAndDropTarget, gen_diagram_DSemanticDiagram_DDiagram, gen_diagram_DSemanticDiagram_DSemanticDecorator, gen_diagram_DDiagramElement_DRepresentationElement, gen_diagram_HideFilter_GraphicalFilter, gen_diagram_HideLabelFilter_GraphicalFilter, gen_diagram_FoldingPointFilter_GraphicalFilter, gen_diagram_FoldingFilter_GraphicalFilter, gen_diagram_AppliedCompositeFilters_GraphicalFilter, gen_diagram_AbsoluteBoundsFilter_GraphicalFilter, gen_diagram_AbstractDNode_DDiagramElement, gen_diagram_DNode_AbstractDNode, gen_diagram_DNode_EdgeTarget, gen_diagram_DNode_DragAndDropTarget, gen_diagram_DDiagramElementContainer_AbstractDNode, gen_diagram_DDiagramElementContainer_EdgeTarget, gen_diagram_DDiagramElementContainer_DragAndDropTarget, gen_diagram_DNodeContainer_DDiagramElementContainer, gen_diagram_DNodeListElement_AbstractDNode, gen_diagram_DNodeList_DDiagramElementContainer, gen_diagram_DEdge_DDiagramElement, gen_diagram_DEdge_EdgeTarget, gen_diagram_NodeStyle_LabelStyle, gen_diagram_NodeStyle_Style, gen_diagram_NodeStyle_BorderedStyle, gen_diagram_NodeStyle_HideLabelCapabilityStyle, gen_diagram_ContainerStyle_LabelStyle, gen_diagram_ContainerStyle_Style, gen_diagram_ContainerStyle_BorderedStyle, gen_diagram_ContainerStyle_HideLabelCapabilityStyle, gen_diagram_FlatContainerStyle_ContainerStyle, gen_diagram_ShapeContainerStyle_ContainerStyle, gen_diagram_Dot_NodeStyle, gen_diagram_GaugeSection_Customizable, gen_diagram_BundledImage_NodeStyle, gen_diagram_WorkspaceImage_NodeStyle, gen_diagram_WorkspaceImage_ContainerStyle, gen_diagram_Square_NodeStyle, gen_diagram_Ellipse_NodeStyle, gen_diagram_Lozenge_NodeStyle, gen_diagram_CustomStyle_NodeStyle, gen_diagram_EdgeStyle_Style, gen_diagram_GaugeCompositeStyle_NodeStyle, gen_diagram_IndirectlyCollapseFilter_CollapseFilter, gen_diagram_BeginLabelStyle_BasicLabelStyle, gen_diagram_CenterLabelStyle_BasicLabelStyle, gen_diagram_EndLabelStyle_BasicLabelStyle, gen_diagram_BorderedStyle_Style, gen_diagram_Note_NodeStyle, gen_diagram_CollapseFilter_GraphicalFilter, gen_diagram_description_DiagramDescription_description_PasteTargetDescription, gen_diagram_BracketEdgeStyle_EdgeStyle, gen_diagram_TypedVariableValue_VariableValue, gen_diagram_EObjectVariableValue_VariableValue, gen_diagram_description_DiagramDescription_description_DragAndDropTargetDescription, gen_diagram_description_DiagramDescription_description_RepresentationDescription, gen_diagram_description_DiagramImportDescription_description_RepresentationImportDescription, gen_diagram_description_DiagramImportDescription_description_DiagramDescription, gen_diagram_description_DiagramExtensionDescription_RepresentationExtensionDescription, gen_diagram_description_DiagramElementMapping_description_RepresentationElementMapping, gen_diagram_description_DiagramElementMapping_description_PasteTargetDescription, gen_diagram_description_AbstractNodeMapping_description_DiagramElementMapping, gen_diagram_description_AbstractNodeMapping_description_DocumentedElement, gen_diagram_description_NodeMapping_description_AbstractNodeMapping, gen_diagram_description_NodeMapping_description_DragAndDropTargetDescription, gen_diagram_description_NodeMappingImport_description_NodeMapping, gen_diagram_description_NodeMappingImport_description_AbstractMappingImport, gen_diagram_description_ContainerMappingImport_description_ContainerMapping, gen_diagram_description_ContainerMappingImport_description_AbstractMappingImport, gen_diagram_description_EdgeMapping_description_DiagramElementMapping, gen_diagram_description_EdgeMapping_description_DocumentedElement, gen_diagram_description_EdgeMapping_description_IEdgeMapping, gen_diagram_description_ContainerMapping_description_AbstractNodeMapping, gen_diagram_description_ContainerMapping_description_DragAndDropTargetDescription, gen_diagram_description_ConditionalNodeStyleDescription_ConditionalStyleDescription, gen_diagram_description_ConditionalEdgeStyleDescription_ConditionalStyleDescription, gen_diagram_description_ConditionalContainerStyleDescription_ConditionalStyleDescription, gen_diagram_description_Layout_DocumentedElement, gen_diagram_description_OrderedTreeLayout_Layout, gen_diagram_description_CompositeLayout_Layout, gen_diagram_description_EdgeMappingImport_description_DocumentedElement, gen_diagram_description_EdgeMappingImport_description_IEdgeMapping, gen_diagram_description_EdgeMappingImport_description_IdentifiedElement, gen_diagram_description_MappingBasedDecoration_DecorationDescription, gen_diagram_description_Layer_description_DocumentedElement, gen_diagram_description_Layer_description_EndUserDocumentedElement, gen_diagram_description_Layer_description_IdentifiedElement, gen_diagram_description_AdditionalLayer_Layer, gen_diagram_style_CustomStyleDescription_NodeStyleDescription, gen_diagram_style_SquareDescription_NodeStyleDescription, gen_diagram_style_LozengeNodeDescription_NodeStyleDescription, gen_diagram_style_BorderedStyleDescription_StyleDescription, gen_diagram_style_NodeStyleDescription_style_StyleDescription, gen_diagram_style_NodeStyleDescription_style_BorderedStyleDescription, gen_diagram_style_NodeStyleDescription_style_LabelStyleDescription, gen_diagram_style_NodeStyleDescription_style_TooltipStyleDescription, gen_diagram_style_NodeStyleDescription_style_HideLabelCapabilityStyleDescription, gen_diagram_style_NoteDescription_NodeStyleDescription, gen_diagram_style_DotDescription_NodeStyleDescription, gen_diagram_style_GaugeCompositeStyleDescription_NodeStyleDescription, gen_diagram_style_EllipseNodeDescription_NodeStyleDescription, gen_diagram_style_BundledImageDescription_NodeStyleDescription, gen_diagram_style_RoundedCornerStyleDescription_StyleDescription, gen_diagram_style_ContainerStyleDescription_style_RoundedCornerStyleDescription, gen_diagram_style_ContainerStyleDescription_style_BorderedStyleDescription, gen_diagram_style_ContainerStyleDescription_style_LabelStyleDescription, gen_diagram_style_ContainerStyleDescription_style_TooltipStyleDescription, gen_diagram_style_ContainerStyleDescription_style_HideLabelCapabilityStyleDescription, gen_diagram_style_FlatContainerStyleDescription_style_ContainerStyleDescription, gen_diagram_style_FlatContainerStyleDescription_style_SizeComputationContainerStyleDescription, gen_diagram_style_ShapeContainerStyleDescription_style_ContainerStyleDescription, gen_diagram_style_ShapeContainerStyleDescription_style_SizeComputationContainerStyleDescription, gen_diagram_style_WorkspaceImageDescription_style_NodeStyleDescription, gen_diagram_style_WorkspaceImageDescription_style_ContainerStyleDescription, gen_diagram_style_EdgeStyleDescription_StyleDescription, gen_diagram_tool_ToolGroup_ToolEntry, gen_diagram_style_BeginLabelStyleDescription_BasicLabelStyleDescription, gen_diagram_style_CenterLabelStyleDescription_BasicLabelStyleDescription, gen_diagram_style_EndLabelStyleDescription_BasicLabelStyleDescription, gen_diagram_style_BracketEdgeStyleDescription_EdgeStyleDescription, gen_diagram_tool_ToolSection_description_DocumentedElement, gen_diagram_tool_ToolSection_description_IdentifiedElement, gen_diagram_tool_EdgeCreationDescription_MappingBasedToolDescription, gen_diagram_tool_NodeCreationDescription_MappingBasedToolDescription, gen_diagram_tool_DeleteElementDescription_MappingBasedToolDescription, gen_diagram_tool_ContainerCreationDescription_MappingBasedToolDescription, gen_diagram_tool_ReconnectEdgeDescription_MappingBasedToolDescription, gen_diagram_tool_DoubleClickDescription_MappingBasedToolDescription, gen_diagram_tool_DirectEditLabel_MappingBasedToolDescription, gen_diagram_tool_BehaviorTool_AbstractToolDescription, gen_diagram_tool_RequestDescription_AbstractToolDescription, gen_diagram_tool_CreateEdgeView_CreateView, gen_diagram_tool_Navigation_ContainerModelOperation, gen_diagram_tool_DiagramCreationDescription_RepresentationCreationDescription, gen_diagram_tool_DiagramNavigationDescription_RepresentationNavigationDescription, gen_diagram_tool_SourceEdgeCreationVariable_description_AbstractVariable, gen_diagram_tool_SourceEdgeCreationVariable_tool_VariableContainer, gen_diagram_tool_SourceEdgeViewCreationVariable_description_AbstractVariable, gen_diagram_tool_SourceEdgeViewCreationVariable_tool_VariableContainer, gen_diagram_tool_TargetEdgeCreationVariable_description_AbstractVariable, gen_diagram_tool_TargetEdgeCreationVariable_tool_VariableContainer, gen_diagram_tool_TargetEdgeViewCreationVariable_description_AbstractVariable, gen_diagram_tool_TargetEdgeViewCreationVariable_tool_VariableContainer, gen_diagram_tool_ElementDoubleClickVariable_description_AbstractVariable, gen_diagram_tool_ElementDoubleClickVariable_tool_VariableContainer, gen_diagram_tool_NodeCreationVariable_description_AbstractVariable, gen_diagram_tool_NodeCreationVariable_tool_VariableContainer, gen_diagram_tool_CreateView_ContainerModelOperation, gen_diagram_filter_FilterDescription_description_DocumentedElement, gen_diagram_filter_FilterDescription_description_IdentifiedElement, gen_diagram_filter_MappingFilter_Filter, gen_diagram_tool_ContainerDropDescription_MappingBasedToolDescription, gen_diagram_concern_ConcernDescription_description_DocumentedElement, gen_diagram_concern_ConcernDescription_description_IdentifiedElement, gen_diagram_filter_CompositeFilterDescription_FilterDescription, gen_diagram_filter_VariableFilter_Filter, gen_diagram_concern_ConcernSet_DocumentedElement},
    metadata=None
)
