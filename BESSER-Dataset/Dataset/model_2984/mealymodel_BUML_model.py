...
# Classes
mealymodel_Alphabet = Class(name="mealymodel_Alphabet")
mealymodel_Transition = Class(name="mealymodel_Transition")
mealymodel_MealyMachine = Class(name="mealymodel_MealyMachine")
mealymodel_State = Class(name="mealymodel_State")
...
domain_model = DomainModel(
    name="mealymodel",
    types={mealymodel_Alphabet, mealymodel_Transition, mealymodel_MealyMachine, mealymodel_State},
    associations={initialState0, states1, inputAlphabet4, outputAlphabet6, transitions9, sourceState11, targetState14},
    generalizations={},
    metadata=None
)
