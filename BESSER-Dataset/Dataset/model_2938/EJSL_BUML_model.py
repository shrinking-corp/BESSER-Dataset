...
# Classes
eJSL_EJSLPart = Class(name="eJSL_EJSLPart")
eJSL_Datatype = Class(name="eJSL_Datatype")
eJSL_Parameter = Class(name="eJSL_Parameter")
eJSL_ParameterGroup = Class(name="eJSL_ParameterGroup")
eJSL_Feature = Class(name="eJSL_Feature")
eJSL_CMSCore = Class(name="eJSL_CMSCore")
EJSLPart = Class(name="EJSLPart")
eJSL_coreFeature = Class(name="eJSL_coreFeature")
eJSL_CMSExtension = Class(name="eJSL_CMSExtension")
eJSL_EJSLModel = Class(name="eJSL_EJSLModel")
eJSL_KeyValuePair = Class(name="eJSL_KeyValuePair")
eJSL_PageAction = Class(name="eJSL_PageAction")
eJSL_Extension = Class(name="eJSL_Extension")
eJSL_Entitypackage = Class(name="eJSL_Entitypackage")
eJSL_Entity = Class(name="eJSL_Entity")
eJSL_Page = Class(name="eJSL_Page")
eJSL_Section = Class(name="eJSL_Section")
eJSL_Type = Class(name="eJSL_Type")
eJSL_DatatypeReference = Class(name="eJSL_DatatypeReference")
Type = Class(name="Type")
HTMLTypes = Class(name="HTMLTypes")
eJSL_StandardTypes = Class(name="eJSL_StandardTypes")
eJSL_HTMLTypes = Class(name="eJSL_HTMLTypes")
eJSL_Link = Class(name="eJSL_Link")
eJSL_StaticPage = Class(name="eJSL_StaticPage")
Page = Class(name="Page")
eJSL_Attribute = Class(name="eJSL_Attribute")
eJSL_Reference = Class(name="eJSL_Reference")
eJSL_ComplexHTMLTypes = Class(name="eJSL_ComplexHTMLTypes")
eJSL_ExternalLink = Class(name="eJSL_ExternalLink")
Link = Class(name="Link")
eJSL_InternalLink = Class(name="eJSL_InternalLink")
eJSL_DynamicPage = Class(name="eJSL_DynamicPage")
eJSL_IndexPage = Class(name="eJSL_IndexPage")
DynamicPage = Class(name="DynamicPage")
eJSL_DetailsPage = Class(name="eJSL_DetailsPage")
eJSL_DetailPageField = Class(name="eJSL_DetailPageField")
eJSL_CustomPage = Class(name="eJSL_CustomPage")
eJSL_SimpleHTMLTypes = Class(name="eJSL_SimpleHTMLTypes")
eJSL_FrontendSection = Class(name="eJSL_FrontendSection")
eJSL_Module = Class(name="eJSL_Module")
eJSL_Plugin = Class(name="eJSL_Plugin")
eJSL_Library = Class(name="eJSL_Library")
eJSL_ContextLink = Class(name="eJSL_ContextLink")
InternalLink = Class(name="InternalLink")
eJSL_LinkParameter = Class(name="eJSL_LinkParameter")
eJSL_Manifestation = Class(name="eJSL_Manifestation")
eJSL_Language = Class(name="eJSL_Language")
eJSL_ExtensionPackage = Class(name="eJSL_ExtensionPackage")
Extension = Class(name="Extension")
eJSL_Component = Class(name="eJSL_Component")
eJSL_PageReference = Class(name="eJSL_PageReference")
eJSL_BackendSection = Class(name="eJSL_BackendSection")
Section = Class(name="Section")
eJSL_ComponentReference = Class(name="eJSL_ComponentReference")
eJSL_Position = Class(name="eJSL_Position")
eJSL_CssBlock = Class(name="eJSL_CssBlock")
eJSL_Author = Class(name="eJSL_Author")
eJSL_Class = Class(name="eJSL_Class")
eJSL_Package = Class(name="eJSL_Package")
eJSL_Method = Class(name="eJSL_Method")
eJSL_MethodParameter = Class(name="eJSL_MethodParameter")
eJSL_Template = Class(name="eJSL_Template")
eJSL_PositionParameter = Class(name="eJSL_PositionParameter")
...
eJSL_Parameter.attributes={eJSL_Parameter_descripton, eJSL_Parameter_size, eJSL_Parameter_name, eJSL_Parameter_label, eJSL_Parameter_defaultvalue}
...
eJSL_StandardTypes.attributes={eJSL_StandardTypes_type, eJSL_StandardTypes_notnull, eJSL_StandardTypes_autoincrement, eJSL_StandardTypes_default}
...
eJSL_StaticPage.attributes={eJSL_StaticPage_HTMLBody, eJSL_StaticPage_preserve}
...
eJSL_Attribute.attributes={eJSL_Attribute_isprimary, eJSL_Attribute_name, eJSL_Attribute_id, eJSL_Attribute_isunique, eJSL_Attribute_preserve}
...
eJSL_Reference.attributes={eJSL_Reference_preserve, eJSL_Reference_upper, eJSL_Reference_id, eJSL_Reference_lower}
...
eJSL_CustomPage.attributes={eJSL_CustomPage_pageType, eJSL_CustomPage_preserve}
...
eJSL_LinkParameter.attributes={eJSL_LinkParameter_id, eJSL_LinkParameter_value, eJSL_LinkParameter_name}
...
eJSL_Manifestation.attributes={eJSL_Manifestation_link, eJSL_Manifestation_description, eJSL_Manifestation_license, eJSL_Manifestation_creationdate, eJSL_Manifestation_copyright, eJSL_Manifestation_version}
...
eJSL_Author.attributes={eJSL_Author_authorurl, eJSL_Author_authoremail, eJSL_Author_name}
...
eJSL_PositionParameter.attributes={eJSL_PositionParameter_type, eJSL_PositionParameter_divid, eJSL_PositionParameter_name}
...
domain_model = DomainModel(
    name="eJSL",
    types={eJSL_EJSLPart, eJSL_Datatype, eJSL_Parameter, eJSL_ParameterGroup, eJSL_Feature, eJSL_CMSCore, EJSLPart, eJSL_coreFeature, eJSL_CMSExtension, eJSL_EJSLModel, eJSL_KeyValuePair, eJSL_PageAction, eJSL_Extension, eJSL_Entitypackage, eJSL_Entity, eJSL_Page, eJSL_Section, eJSL_Type, eJSL_DatatypeReference, Type, HTMLTypes, eJSL_StandardTypes, eJSL_HTMLTypes, eJSL_Link, eJSL_StaticPage, Page, eJSL_Attribute, eJSL_Reference, eJSL_ComplexHTMLTypes, eJSL_ExternalLink, Link, eJSL_InternalLink, eJSL_DynamicPage, eJSL_IndexPage, DynamicPage, eJSL_DetailsPage, eJSL_DetailPageField, eJSL_CustomPage, eJSL_SimpleHTMLTypes, eJSL_FrontendSection, eJSL_Module, eJSL_Plugin, eJSL_Library, eJSL_ContextLink, InternalLink, eJSL_LinkParameter, eJSL_Manifestation, eJSL_Language, eJSL_ExtensionPackage, Extension, eJSL_Component, eJSL_PageReference, eJSL_BackendSection, Section, eJSL_ComponentReference, eJSL_Position, eJSL_CssBlock, eJSL_Author, eJSL_Class, eJSL_Package, eJSL_Method, eJSL_MethodParameter, eJSL_Template, eJSL_PositionParameter, PageActionPositionKind, StandardTypeKinds, PluginKinds, PageActionKind, DataAccessKinds, PageKinds, SimpleHTMLTypeKinds, ComplexHTMLTypeKinds, CoreComponent},
    associations={ejslPart0, datatypes1, globalparameters3, parametergroups5, feature7, values22, attributes24, globalparameters27, parameters30, extensions9, entitypackages10, entities12, pages14, sections16, type18, dtype20, parametergroups63, globalparameters66, localparameters69, pageactions72, links74, entitypackages34, entities36, datatypes39, supertype43, attributes45, references47, type49, withattribute52, attribute54, entity57, attributerefereced60, linkedAttribute99, linkedAction102, target105, entities76, tablecolumns78, filters81, editfields84, attribute85, htmltype88, values91, attributes94, entities97, ref129, pageRef132, entities134, localparameters136, linkparameters107, attvalue108, manifest111, languages113, extensions115, globalParamter117, sections119, pageRef122, page124, pagescr127, positions172, cssblocks174, authors176, entities139, classes141, packages143, packages146, classes148, supertype152, references155, entities157, methods160, type162, methodparameters165, type167, localparameters170, keyvaluepairs178, positionparameters181, keyvaluepairs183, keyvaluepairs186},
    generalizations={gen_eJSL_CMSCore_EJSLPart, gen_eJSL_CMSExtension_EJSLPart, gen_eJSL_DatatypeReference_Type, gen_eJSL_DatatypeReference_HTMLTypes, gen_eJSL_StandardTypes_Type, gen_eJSL_StaticPage_Page, gen_eJSL_ComplexHTMLTypes_HTMLTypes, gen_eJSL_ExternalLink_Link, gen_eJSL_InternalLink_Link, gen_eJSL_DynamicPage_Page, gen_eJSL_IndexPage_DynamicPage, gen_eJSL_DetailsPage_DynamicPage, gen_eJSL_CustomPage_Page, gen_eJSL_SimpleHTMLTypes_HTMLTypes, gen_eJSL_FrontendSection_Section, gen_eJSL_Module_Extension, gen_eJSL_Plugin_Extension, gen_eJSL_Library_Extension, gen_eJSL_ContextLink_InternalLink, gen_eJSL_ExtensionPackage_Extension, gen_eJSL_Component_Extension, gen_eJSL_BackendSection_Section, gen_eJSL_Template_Extension},
    metadata=None
)
