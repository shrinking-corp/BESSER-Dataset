...
synccharts_Scope.attributes={synccharts_Scope_interfaceDeclaration, synccharts_Scope_id, synccharts_Scope_label}
...
synccharts_State.attributes={synccharts_State_isInitial, synccharts_State_isFinal, synccharts_State_type}
...
domain_model = DomainModel(
    name="synccharts",
    types={synccharts_Assignment, Effect, synccharts_Variable, synccharts_Emission, synccharts_Action, Annotatable, synccharts_Effect, synccharts_Expression, synccharts_Substitution, synccharts_Scope, synccharts_Signal, synccharts_Region, Scope, synccharts_State, synccharts_Transition, Action, synccharts_TextEffect, TextualCode, synccharts_EObject, synccharts_TextualCode, StateType, TransitionType},
    associations={variable3, expression4, effects0, trigger1, parentState12, parentScope14, signal7, newValue8, states11, outgoingTransitions18, incomingTransitions19, targetState21, regions15, parentRegion16, signals25, variables27, suspensionTrigger30, exitActions33, sourceState23, renamings49, innerActions36, entryActions39, bodyReference42, bodyContents44, bodyText47},
    generalizations={gen_synccharts_Assignment_Effect, gen_synccharts_Emission_Effect, gen_synccharts_Action_Annotatable, gen_synccharts_Region_Scope, gen_synccharts_Transition_Action, gen_synccharts_State_Scope, gen_synccharts_Scope_Annotatable, gen_synccharts_TextEffect_TextualCode, gen_synccharts_TextEffect_Effect},
    metadata=None
)
