...
class PetriNet_PetriElement:
    ...
    def __init__(self, nom: str, PetriNet_PetriElement3: "PetriNet_Arc" = None, PetriNet_PetriElement: "PetriNet_Arc" = None, PetriNet_PetriElement8: "PetriNet_PetriNet" = None):
        self.nom = nom
...
class PetriNet_Arc:
    ...
    def __init__(self, arcType: str, poids: int, PetriNet_Arc2: "PetriNet_PetriElement" = None, PetriNet_Arc: "PetriNet_PetriElement" = None, PetriNet_Arc5: "PetriNet_PetriNet" = None):
