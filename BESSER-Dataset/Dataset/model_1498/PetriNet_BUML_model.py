...
PetriNet_PetriElement = Class(name="PetriNet_PetriElement")
...
domain_model = DomainModel(
    name="PetriNet",
    types={PetriNet_Transition, PetriNet_Place, PetriElement, PetriNet_Arc, PetriNet_PetriElement, PetriNet_PetriNet, ArcType},
    associations={fin1, dbt0, arcs4, petriElements6},
    generalizations={gen_PetriNet_Transition_PetriElement, gen_PetriNet_Place_PetriElement},
    metadata=None
)
