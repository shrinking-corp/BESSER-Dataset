...
# Classes
testcompat103_NamedElement = Class(name="testcompat103_NamedElement", is_abstract=True)
testcompat103_World = Class(name="testcompat103_World", is_abstract=True)
NamedElement = Class(name="NamedElement")
testcompat103_Thing = Class(name="testcompat103_Thing")
testcompat103_Foo = Class(name="testcompat103_Foo")
testcompat103_EClass0 = Class(name="testcompat103_EClass0")
testcompat103_EClass2 = Class(name="testcompat103_EClass2")
testcompat103_RelatedTo = Class(name="testcompat103_RelatedTo")
testcompat103_EClass1 = Class(name="testcompat103_EClass1")
EClass0 = Class(name="EClass0")
testcompat103_EClass3 = Class(name="testcompat103_EClass3")
...
domain_model = DomainModel(
    name="testcompat103",
    types={testcompat103_NamedElement, testcompat103_World, NamedElement, testcompat103_Thing, testcompat103_Foo, testcompat103_EClass0, testcompat103_EClass2, testcompat103_RelatedTo, testcompat103_EClass1, EClass0, testcompat103_EClass3, World},
    associations={fromThing8, toThing9, things0, foos1, ec0s3, ec2s5, relations7, e1s11, subs14},
    generalizations={gen_testcompat103_RelatedTo_NamedElement, gen_testcompat103_World_NamedElement, gen_testcompat103_Thing_NamedElement, gen_testcompat103_Foo_NamedElement, gen_testcompat103_EClass0_NamedElement, gen_testcompat103_EClass1_NamedElement, gen_testcompat103_EClass2_EClass0, gen_testcompat103_EClass3_World},
    metadata=None
)
