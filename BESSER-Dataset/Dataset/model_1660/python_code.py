...
class testcompat103_Thing(NamedElement):
    ...
    def __init__(self, id: int, Thing: "testcompat103_RelatedTo" = None, testcompat103_Thing10: "testcompat103_RelatedTo" = None, testcompat103_Thing: "testcompat103_World" = None, fromThing: set["testcompat103_RelatedTo"] = None):
        self.id = id
        self.Thing = Thing
