...
# Classes
SOS_PremisseList = Class(name="SOS_PremisseList")
SOS_Conclusion = Class(name="SOS_Conclusion")
Variable = Class(name="Variable")
SOS_Condition = Class(name="SOS_Condition", is_abstract=True)
SOS_Semantics = Class(name="SOS_Semantics")
SOS_Rule = Class(name="SOS_Rule")
ADT = Class(name="ADT")
SOS_TypeJudment = Class(name="SOS_TypeJudment")
SOS_Transition = Class(name="SOS_Transition")
Condition = Class(name="Condition")
Term = Class(name="Term")
SOS_adtmm_ADT = Class(name="SOS_adtmm_ADT")
SortDeclaration = Class(name="SortDeclaration")
Operation = Class(name="Operation")
SOS_AlgebraicCondition = Class(name="SOS_AlgebraicCondition")
AbstractEquation = Class(name="AbstractEquation")
SOS_AlgebraicConditionList = Class(name="SOS_AlgebraicConditionList")
SOS_adtmm_Variable = Class(name="SOS_adtmm_Variable")
SOS_adtmm_CondEquation = Class(name="SOS_adtmm_CondEquation")
CondEquation = Class(name="CondEquation")
SOS_adtmm_Sort = Class(name="SOS_adtmm_Sort", is_abstract=True)
SOS_adtmm_Operation = Class(name="SOS_adtmm_Operation")
AbstractOperation = Class(name="AbstractOperation")
Sort = Class(name="Sort")
SOS_adtmm_AbstractEquation = Class(name="SOS_adtmm_AbstractEquation", is_abstract=True)
SOS_adtmm_Equation = Class(name="SOS_adtmm_Equation")
SOS_adtmm_Inequation = Class(name="SOS_adtmm_Inequation")
Equation = Class(name="Equation")
SOS_adtmm_Term = Class(name="SOS_adtmm_Term", is_abstract=True)
SOS_adtmm_VariableRef = Class(name="SOS_adtmm_VariableRef")
SOS_adtmm_CTerm = Class(name="SOS_adtmm_CTerm")
SOS_set_SetTerm = Class(name="SOS_set_SetTerm", is_abstract=True)
SOS_set_ModelSet = Class(name="SOS_set_ModelSet")
SOS_set_SetOperator = Class(name="SOS_set_SetOperator", is_abstract=True)
SOS_set_SetConstructor = Class(name="SOS_set_SetConstructor")
set_SOS_AlgebraicConditionList = Class(name="set_SOS_AlgebraicConditionList")
SOS_adtmm_AbstractSort = Class(name="SOS_adtmm_AbstractSort", is_abstract=True)
SOS_adtmm_AtomicSort = Class(name="SOS_adtmm_AtomicSort")
SOS_adtmm_SortDeclaration = Class(name="SOS_adtmm_SortDeclaration")
SOS_adtmm_AbstractOperation = Class(name="SOS_adtmm_AbstractOperation", is_abstract=True)
SOS_adtmm_AbstractGenericOp = Class(name="SOS_adtmm_AbstractGenericOp", is_abstract=True)
SOS_set_ModelSort = Class(name="SOS_set_ModelSort")
SOS_set_SetMembership = Class(name="SOS_set_SetMembership", is_abstract=True)
SetTerm = Class(name="SetTerm")
SOS_set_Set = Class(name="SOS_set_Set")
SOS_set_ExistsIn = Class(name="SOS_set_ExistsIn")
SetMembership = Class(name="SetMembership")
SOS_set_ForAllIn = Class(name="SOS_set_ForAllIn")
SOS_set_Union = Class(name="SOS_set_Union")
SetOperator = Class(name="SetOperator")
SOS_set_Excluding = Class(name="SOS_set_Excluding")
SOS_set_Intersection = Class(name="SOS_set_Intersection")
SOS_set_ModelRelation = Class(name="SOS_set_ModelRelation")
VariableRef = Class(name="VariableRef")
SOS_set_ModelClassAttribute = Class(name="SOS_set_ModelClassAttribute")
...
domain_model = DomainModel(
    name="SOS",
    types={SOS_PremisseList, SOS_Conclusion, Variable, SOS_Condition, SOS_Semantics, SOS_Rule, ADT, SOS_TypeJudment, SOS_Transition, Condition, Term, SOS_adtmm_ADT, SortDeclaration, Operation, SOS_AlgebraicCondition, AbstractEquation, SOS_AlgebraicConditionList, SOS_adtmm_Variable, SOS_adtmm_CondEquation, CondEquation, SOS_adtmm_Sort, SOS_adtmm_Operation, AbstractOperation, Sort, SOS_adtmm_AbstractEquation, SOS_adtmm_Equation, SOS_adtmm_Inequation, Equation, SOS_adtmm_Term, SOS_adtmm_VariableRef, SOS_adtmm_CTerm, SOS_set_SetTerm, SOS_set_ModelSet, SOS_set_SetOperator, SOS_set_SetConstructor, set_SOS_AlgebraicConditionList, SOS_adtmm_AbstractSort, SOS_adtmm_AtomicSort, SOS_adtmm_SortDeclaration, SOS_adtmm_AbstractOperation, SOS_adtmm_AbstractGenericOp, SOS_set_ModelSort, SOS_set_SetMembership, SetTerm, SOS_set_Set, SOS_set_ExistsIn, SetMembership, SOS_set_ForAllIn, SOS_set_Union, SetOperator, SOS_set_Excluding, SOS_set_Intersection, SOS_set_ModelRelation, VariableRef, SOS_set_ModelClassAttribute},
    associations={assumes3, concludes5, ownedVariables7, has9, rules0, signature1, preState18, posState21, environment24, environment27, next12, has14, label16, has36, next39, ownedSorts41, ownedOperations42, leftHandSide29, rightHandSide32, ownedConditions35, operationSorts52, result53, variableSort56, ownedGenerators44, ownedVariables47, ownedAxioms50, ownedTerms64, op66, iterTerm69, ownedRightTerm72, ownedLeftTerm74, ownedConditions58, ownedEquation60, variable62, rightHandSide81, leftHandSide84, rightHandSide86, suchThat89, member90, declaration77, leftHandSide79, sort99, source93, target94, selector97},
    generalizations={gen_SOS_TypeJudment_Condition, gen_SOS_Transition_Condition, gen_SOS_AlgebraicCondition_Condition, gen_SOS_adtmm_Operation_AbstractOperation, gen_SOS_adtmm_Equation_AbstractEquation, gen_SOS_adtmm_Inequation_AbstractEquation, gen_SOS_adtmm_VariableRef_Term, gen_SOS_adtmm_CTerm_Term, gen_SOS_set_SetTerm_Term, gen_SOS_set_ModelSet_SetTerm, gen_SOS_set_SetOperator_SetTerm, gen_SOS_set_SetConstructor_SetTerm, gen_SOS_adtmm_AtomicSort_Sort, gen_SOS_adtmm_AbstractGenericOp_AbstractOperation, gen_SOS_set_ModelSort_Sort, gen_SOS_set_SetMembership_SetTerm, gen_SOS_set_Set_Sort, gen_SOS_set_ExistsIn_SetMembership, gen_SOS_set_ForAllIn_SetMembership, gen_SOS_set_Union_SetOperator, gen_SOS_set_Excluding_SetOperator, gen_SOS_set_Intersection_SetOperator, gen_SOS_set_ModelRelation_Term, gen_SOS_set_ModelClassAttribute_Term},
    metadata=None
)
