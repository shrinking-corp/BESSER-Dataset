...
# Classes
HSM_HSM_StateMachine = Class(name="HSM_HSM_StateMachine")
HSM_HSM_Transition = Class(name="HSM_HSM_Transition")
HSM_HSM_AbstractState = Class(name="HSM_HSM_AbstractState", is_abstract=True)
HSM_HSM_CompositeState = Class(name="HSM_HSM_CompositeState")
HSM_HSM_InitialState = Class(name="HSM_HSM_InitialState")
HSM_AbstractState = Class(name="HSM_AbstractState")
HSM_HSM_RegularState = Class(name="HSM_HSM_RegularState")
...
domain_model = DomainModel(
    name="HSM",
    types={HSM_HSM_StateMachine, HSM_HSM_Transition, HSM_HSM_AbstractState, HSM_HSM_CompositeState, HSM_HSM_InitialState, HSM_AbstractState, HSM_HSM_RegularState},
    associations={transitions0, states1, stateMachine3, source4, target5, stateMachine8, compositeState10, states12},
    generalizations={gen_HSM_HSM_InitialState_HSM_AbstractState, gen_HSM_HSM_RegularState_HSM_AbstractState, gen_HSM_HSM_CompositeState_HSM_AbstractState},
    metadata=None
)
