...
class HSM_HSM_AbstractState(ABC):
    ...
    def __init__(self, name: str, HSM_AbstractState: "HSM_HSM_StateMachine" = None, HSM_HSM_AbstractState: "HSM_HSM_Transition" = None, HSM_HSM_AbstractState7: "HSM_HSM_Transition" = None, states: "HSM_HSM_StateMachine" = None, states11: "HSM_HSM_CompositeState" = None, HSM_AbstractState13: "HSM_HSM_CompositeState" = None):
        self.name = name
...
class HSM_HSM_Transition:
    ...
    def __init__(self, label: str, HSM_Transition: "HSM_HSM_StateMachine" = None, transitions: "HSM_HSM_StateMachine" = None, HSM_HSM_Transition: "HSM_HSM_AbstractState" = None, HSM_HSM_Transition6: "HSM_HSM_AbstractState" = None):
        self.label = label
...
class HSM_HSM_StateMachine:
    ...
    def __init__(self, name: str, stateMachine: set["HSM_HSM_Transition"] = None, stateMachine2: set["HSM_HSM_AbstractState"] = None, HSM_StateMachine: "HSM_HSM_Transition" = None, HSM_StateMachine9: "HSM_HSM_AbstractState" = None):
        self.name = name
