...
# Classes
flinkie2_Variable = Class(name="flinkie2_Variable")
flinkie2_BooleanEvaluation = Class(name="flinkie2_BooleanEvaluation")
Node = Class(name="Node")
flinkie2_AssignStat = Class(name="flinkie2_AssignStat")
flinkie2_BoolExpr = Class(name="flinkie2_BoolExpr", is_abstract=True)
flinkie2_Question = Class(name="flinkie2_Question")
flinkie2_Option = Class(name="flinkie2_Option")
flinkie2_Message = Class(name="flinkie2_Message")
flinkie2_Node = Class(name="flinkie2_Node", is_abstract=True)
flinkie2_Init = Class(name="flinkie2_Init")
flinkie2_DeclStat = Class(name="flinkie2_DeclStat")
flinkie2_TwoOpInt = Class(name="flinkie2_TwoOpInt")
flinkie2_Number = Class(name="flinkie2_Number")
flinkie2_VariableExpr = Class(name="flinkie2_VariableExpr")
flinkie2_FlowChart = Class(name="flinkie2_FlowChart")
flinkie2_BracExprInt = Class(name="flinkie2_BracExprInt")
flinkie2_OneOpBool = Class(name="flinkie2_OneOpBool")
BoolExpr = Class(name="BoolExpr")
flinkie2_TwoOpBool = Class(name="flinkie2_TwoOpBool")
flinkie2_IntExpr = Class(name="flinkie2_IntExpr", is_abstract=True)
flinkie2_OneOpInt = Class(name="flinkie2_OneOpInt")
IntExpr = Class(name="IntExpr")
flinkie2_BoolVal = Class(name="flinkie2_BoolVal")
flinkie2_BracExprBool = Class(name="flinkie2_BracExprBool")
flinkie2_Comparison = Class(name="flinkie2_Comparison")
...
domain_model = DomainModel(
    name="flinkie2",
    types={flinkie2_Variable, flinkie2_BooleanEvaluation, Node, flinkie2_AssignStat, flinkie2_BoolExpr, flinkie2_Question, flinkie2_Option, flinkie2_Message, flinkie2_Node, flinkie2_Init, flinkie2_DeclStat, flinkie2_TwoOpInt, flinkie2_Number, flinkie2_VariableExpr, flinkie2_FlowChart, flinkie2_BracExprInt, flinkie2_OneOpBool, BoolExpr, flinkie2_TwoOpBool, flinkie2_IntExpr, flinkie2_OneOpInt, IntExpr, flinkie2_BoolVal, flinkie2_BracExprBool, flinkie2_Comparison, EIntOneOp, EIntTwoOp, EBoolVal, EBoolTwoOp, ECompOp, EBoolOneOp},
    associations={node1, variable3, assignstats5, true6, false9, boolexpr12, options14, assignstats15, assignstats18, node20, assignstats23, node26, declstats0, left30, right32, variableexpr35, intexpr37, nodes40, initialisation42, intexpr45, variable47, boolexpr50, left52, right54, intexpr29, right59, left61, boolexpr57},
    generalizations={gen_flinkie2_BooleanEvaluation_Node, gen_flinkie2_Question_Node, gen_flinkie2_Message_Node, gen_flinkie2_TwoOpInt_IntExpr, gen_flinkie2_Number_IntExpr, gen_flinkie2_BracExprInt_IntExpr, gen_flinkie2_VariableExpr_IntExpr, gen_flinkie2_OneOpBool_BoolExpr, gen_flinkie2_TwoOpBool_BoolExpr, gen_flinkie2_OneOpInt_IntExpr, gen_flinkie2_BoolVal_BoolExpr, gen_flinkie2_BracExprBool_BoolExpr, gen_flinkie2_Comparison_BoolExpr},
    metadata=None
)
