...
class lit_petriNets_2_Transition:
    ...
    def __init__(self, name: str, transitions: "lit_petriNets_2_Net" = None, dst11: set["lit_petriNets_2_PTArc"] = None, src14: set["lit_petriNets_2_TPArc"] = None, Transition21: "lit_petriNets_2_PTArc" = None, Transition24: "lit_petriNets_2_TPArc" = None, Transition: "lit_petriNets_2_Net" = None):
        self.name = name
...
class lit_petriNets_2_Place:
    ...
    def __init__(self, name: str, Place19: "lit_petriNets_2_PTArc" = None, Place27: "lit_petriNets_2_TPArc" = None, Place: "lit_petriNets_2_Net" = None, places: "lit_petriNets_2_Net" = None, dst: set["lit_petriNets_2_TPArc"] = None, src: set["lit_petriNets_2_PTArc"] = None):
        self.name = name
    ...
    def Place27(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "in_26"):
                opp_val = getattr(old_value, "in_26", None)
                if opp_val == self:
                    setattr(old_value, "in_26", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "in_26"):
                opp_val = getattr(value, "in_26", None)
                setattr(value, "in_26", self)
