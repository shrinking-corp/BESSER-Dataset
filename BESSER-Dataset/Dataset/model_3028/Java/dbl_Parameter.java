...
public class dbl_Parameter extends AbstractVariable {
    ...
    private dbl_Function dbl_function;
    ...
    public dbl_Function getDbl_function() {
        return dbl_function;
    }

    public void setDbl_function(dbl_Function dbl_function) {
        this.dbl_function = dbl_function;
    }
