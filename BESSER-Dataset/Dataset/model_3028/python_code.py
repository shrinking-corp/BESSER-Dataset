...
class dbl_And(L7Expr, BinaryOperator):
    ...
    pass
class dbl_InstanceOf(BinaryOperator, L5Expr):

    pass
class dbl_Equal(L6Expr, BinaryOperator):

    pass
class dbl_LessEqual(BinaryOperator, L5Expr):
...
class dbl_ExpansionStatement(SimpleStatement):
    ...
    def __init__(self, classContext: bool, functionContext: bool, variableContext: bool, dbl_ExpansionStatement174: set["dbl_Expression"] = None, dbl_ExpansionStatement: "dbl_IdExpr" = None, dbl_ExpansionStatement172: set["dbl_ExpansionPart"] = None):
...
class NamedElement:
    ...
    pass
class dbl_AbstractVariable(TypedElement, NamedElement, AnnotateableElement):
...
class dbl_Pattern(NamedElement):
    ...
    def __init__(self, top: bool, dbl_Pattern193: "dbl_Statement" = None, dbl_Pattern: "dbl_Parameter" = None):
        self.top = top
...
class dbl_Class(Concept, Type, AnnotateableElement, ConstructiveExtensionAtContentExtensionPoint, Construct, NamedElement):

    def __init__(self, active: bool, dbl_Class: "dbl_Module" = None, dbl_Class33: "dbl_SuperClassSpecification" = None, Class: "dbl_Constructor" = None, dbl_Class38: set["dbl_NativeBinding"] = None, dbl_Class40: set["dbl_SuperClassSpecification"] = None, owningClass: set["dbl_Constructor"] = None, dbl_Class44: set["dbl_Variable"] = None, dbl_Class47: set["dbl_Function"] = None, dbl_Class50: "dbl_LocalScope" = None):
        self.active = active
...
class dbl_Module(ConstructiveExtensionAtContentExtensionPoint, Construct, NamedElement):
    ...
    pass
class dbl_StructuralSymbolReference(NamedElement, PlainSymbolReference):
    ...
    @property
    def globalScopedReference(self):
...
class dbl_SyntaxDefinition(ExtensibleElement):
    ...
    pass
class dbl_Extension(ExtensibleElement, Concept):
...
class dbl_Variable(AbstractVariable, SimpleStatement):
    ...
    def __init__(self, control: bool, class_: bool, dbl_Variable: "dbl_Module" = None, dbl_Variable55: "dbl_Expression" = None, dbl_Variable45: "dbl_Class" = None):
...
class dbl_Function(TypedElement, NamedElement, LocalScope):
    ...
    def __init__(self, class_: bool, abstract: bool, detached: bool, dbl_Function: "dbl_Module" = None, dbl_Function31: set["dbl_Parameter"] = None, dbl_Function48: "dbl_Class" = None):
        self.class_ = class_
