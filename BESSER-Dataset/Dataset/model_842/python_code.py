...
class tfsm_EventGuard(Guard):
    ...
    def tfsm_EventGuard(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tfsm_FSMEvent27"):
                opp_val = getattr(old_value, "tfsm_FSMEvent27", None)
                if opp_val == self:
                    setattr(old_value, "tfsm_FSMEvent27", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tfsm_FSMEvent27"):
                opp_val = getattr(value, "tfsm_FSMEvent27", None)
                setattr(value, "tfsm_FSMEvent27", self)
...
class tfsm_FSMClock(NamedElement):
    ...
    def __init__(self, numberOfTicks: str, tfsm_FSMClock35: "tfsm_TimedSystem" = None, tfsm_FSMClock: "tfsm_TFSM" = None, tfsm_FSMClock25: "tfsm_TemporalGuard" = None):
...
class tfsm_Guard(NamedElement):
    ...
    def tfsm_Guard(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tfsm_Transition20"):
                opp_val = getattr(old_value, "tfsm_Transition20", None)
                if opp_val == self:
                    setattr(old_value, "tfsm_Transition20", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tfsm_Transition20"):
                opp_val = getattr(value, "tfsm_Transition20", None)
                setattr(value, "tfsm_Transition20", self)
...
class tfsm_TimedSystem(NamedElement):
    ...
    def __init__(self, tfsm_TimedSystem34: set["tfsm_FSMClock"] = None, tfsm_TimedSystem37: set["tfsm_FSMEvent"] = None, tfsm_TimedSystem: set["tfsm_TFSM"] = None):
    ...
    def initializeModel(self, tfsm_args):
...
class tfsm_Transition(NamedElement):
    ...
    def __init__(self, action: str, Transition: "tfsm_State" = None, Transition14: "tfsm_State" = None, tfsm_Transition: "tfsm_TFSM" = None, outgoingTransitions: "tfsm_State" = None, incomingTransitions: "tfsm_State" = None, tfsm_Transition20: "tfsm_Guard" = None, tfsm_Transition22: set["tfsm_FSMEvent"] = None, tfsm_Transition30: "tfsm_FSMEvent" = None):
        self.action = action
...
class tfsm_FSMEvent(NamedElement):
    ...
    def __init__(self, isTriggered: str, tfsm_FSMEvent: "tfsm_TFSM" = None, tfsm_FSMEvent27: "tfsm_EventGuard" = None, tfsm_FSMEvent23: "tfsm_Transition" = None, tfsm_FSMEvent38: "tfsm_TimedSystem" = None, tfsm_FSMEvent29: set["tfsm_Transition"] = None):
...
class tfsm_State(NamedElement):
    ...
    def __init__(self, ownedStates: "tfsm_TFSM" = None, source: set["tfsm_Transition"] = None, target: set["tfsm_Transition"] = None, State: "tfsm_TFSM" = None, tfsm_State: "tfsm_TFSM" = None, tfsm_State10: "tfsm_TFSM" = None, State16: "tfsm_Transition" = None, State18: "tfsm_Transition" = None):
...
class tfsm_TFSM(NamedElement):
    ...
    def __init__(self, stepNumber: int, lastStateChangeStepNumber: int, TFSM: "tfsm_State" = None, owningFSM: set["tfsm_State"] = None, tfsm_TFSM: "tfsm_State" = None, tfsm_TFSM3: set["tfsm_FSMEvent"] = None, tfsm_TFSM5: "tfsm_FSMClock" = None, tfsm_TFSM7: set["tfsm_Transition"] = None, tfsm_TFSM9: "tfsm_State" = None, tfsm_TFSM32: "tfsm_TimedSystem" = None):
