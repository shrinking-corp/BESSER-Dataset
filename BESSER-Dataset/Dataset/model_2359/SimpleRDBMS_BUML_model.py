...
# Classes
SimpleRDBMS_RdbmsColumn = Class(name="SimpleRDBMS_RdbmsColumn")
RdbmsModelElement = Class(name="RdbmsModelElement")
SimpleRDBMS_RdbmsModelElement = Class(name="SimpleRDBMS_RdbmsModelElement")
SimpleRDBMS_RdbmsSchema = Class(name="SimpleRDBMS_RdbmsSchema")
SimpleRDBMS_RdbmsTable = Class(name="SimpleRDBMS_RdbmsTable")
SimpleRDBMS_RdbmsKey = Class(name="SimpleRDBMS_RdbmsKey")
SimpleRDBMS_RdbmsForeignKey = Class(name="SimpleRDBMS_RdbmsForeignKey")
...
domain_model = DomainModel(
    name="SimpleRDBMS",
    types={SimpleRDBMS_RdbmsColumn, RdbmsModelElement, SimpleRDBMS_RdbmsModelElement, SimpleRDBMS_RdbmsSchema, SimpleRDBMS_RdbmsTable, SimpleRDBMS_RdbmsKey, SimpleRDBMS_RdbmsForeignKey},
    associations={rdbmsOwner5, rdbmsRefersTo7, rdbmsColumn9, rdbmsColumn11, rdbmsRefersToOpposite13, rdbmsOwner15, rdbmsTable18, rdbmsColumn20, rdbmsForeignKey22, rdbmsOwner0, rdbmsKey1, rdbmsForeignKey3, rdbmsKey25, rdbmsSchema28},
    generalizations={gen_SimpleRDBMS_RdbmsColumn_RdbmsModelElement, gen_SimpleRDBMS_RdbmsKey_RdbmsModelElement, gen_SimpleRDBMS_RdbmsSchema_RdbmsModelElement, gen_SimpleRDBMS_RdbmsTable_RdbmsModelElement, gen_SimpleRDBMS_RdbmsForeignKey_RdbmsModelElement},
    metadata=None
)
