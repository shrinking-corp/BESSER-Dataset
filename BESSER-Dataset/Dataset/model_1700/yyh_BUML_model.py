...
# Classes
yyh_Base = Class(name="yyh_Base")
NamedElement = Class(name="NamedElement")
yyh_Boz = Class(name="yyh_Boz")
yyh_Output = Class(name="yyh_Output")
yyh_Baz = Class(name="yyh_Baz", is_abstract=True)
yyh_NamedElement = Class(name="yyh_NamedElement", is_abstract=True)
yyh_Alias = Class(name="yyh_Alias")
yyh_Bar = Class(name="yyh_Bar")
yyh_Rel = Class(name="yyh_Rel")
yyh_Foo = Class(name="yyh_Foo")
yyh_Zing = Class(name="yyh_Zing")
yyh_Bouz = Class(name="yyh_Bouz")
Baz = Class(name="Baz")
yyh_Boul = Class(name="yyh_Boul")
...
domain_model = DomainModel(
    name="yyh",
    types={yyh_Base, NamedElement, yyh_Boz, yyh_Output, yyh_Baz, yyh_NamedElement, yyh_Alias, yyh_Bar, yyh_Rel, yyh_Foo, yyh_Zing, yyh_Bouz, Baz, yyh_Boul},
    associations={relations0, ouputs2, baze4, aliases6, bars7, rels9, fromThing11, toElement12, subRelations15, foos1, src20, trg23, azing26, zings28, output17},
    generalizations={gen_yyh_Base_NamedElement, gen_yyh_Boz_NamedElement, gen_yyh_Baz_NamedElement, gen_yyh_Bouz_Baz, gen_yyh_Boul_Baz, gen_yyh_Zing_NamedElement},
    metadata=None
)
