...
class yyh_Rel:
    ...
    def __init__(self, id: str, yyh_Rel: "yyh_NamedElement" = None, yyh_Rel21: "yyh_NamedElement" = None, yyh_Rel24: "yyh_Boz" = None):
        self.id = id
...
class yyh_Boz(NamedElement):
    ...
    def __init__(self, since: str, Boz: "yyh_Base" = None, relations: "yyh_Base" = None, yyh_Boz: "yyh_NamedElement" = None, yyh_Boz16: "yyh_Boz" = None, yyh_Boz14: set["yyh_Boz"] = None, yyh_Boz25: "yyh_Rel" = None):
        self.since = since
        self.Boz = Boz
...
class yyh_Base(NamedElement):
    ...
    def __init__(self, id: int, fromThing: set["yyh_Boz"] = None, yyh_Base3: set["yyh_Output"] = None, yyh_Base5: set["yyh_Baz"] = None, Base: "yyh_Boz" = None, yyh_Base: set["yyh_Foo"] = None):
        self.id = id
