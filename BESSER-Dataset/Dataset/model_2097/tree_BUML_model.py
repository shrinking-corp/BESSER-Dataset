...
tree_description_TreeItemMapping.attributes={tree_description_TreeItemMapping_domainClass, tree_description_TreeItemMapping_semanticCandidatesExpression, tree_description_TreeItemMapping_preconditionExpression}
...
mapping77: BinaryAssociation = BinaryAssociation(
    name="mapping77",
    ends={
        Property(name="TreeItemMapping78", type=tree_description_TreeItemDeletionTool, multiplicity=Multiplicity(1, 1)),
        Property(name="delete", type=TreeItemMapping, multiplicity=Multiplicity(1, 1))
    }
)
treeDescription79: BinaryAssociation = BinaryAssociation(
    name="treeDescription79",
    ends={
        Property(name="TreeDescription80", type=tree_description_TreeCreationDescription, multiplicity=Multiplicity(1, 1)),
...
treeDescription81: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="TreeDescription82", type=tree_description_TreeNavigationDescription, multiplicity=Multiplicity(1, 1)),
...
dropTools90: BinaryAssociation = BinaryAssociation(
    name="dropTools90",
    ends={
        Property(name="TreeItemContainerDropTool", type=tree_description_TreeItemMappingContainer, multiplicity=Multiplicity(1, 1)),
        Property(name="tree_description_TreeItemMappingContainer91", type=TreeItemContainerDropTool, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
menuItemDescriptions92: BinaryAssociation = BinaryAssociation(
    name="menuItemDescriptions92",
    ends={
...
defaultStyle83: BinaryAssociation = BinaryAssociation(
    name="defaultStyle83",
    ends={
        Property(name="TreeItemStyleDescription84", type=tree_description_StyleUpdater, multiplicity=Multiplicity(1, 1)),
...
conditionalStyles85: BinaryAssociation = BinaryAssociation(
    name="conditionalStyles85",
    ends={
        Property(name="ConditionalTreeItemStyleDescription", type=tree_description_StyleUpdater, multiplicity=Multiplicity(1, 1)),
        Property(name="tree_description_StyleUpdater86", type=ConditionalTreeItemStyleDescription, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
directEdit87: BinaryAssociation = BinaryAssociation(
    name="directEdit87",
    ends={
...
subItemMappings88: BinaryAssociation = BinaryAssociation(
    name="subItemMappings88",
    ends={
        Property(name="TreeItemMapping89", type=tree_description_TreeItemMappingContainer, multiplicity=Multiplicity(1, 1)),
...
domain_model = DomainModel(
    name="tree",
    types={DTreeItemContainer, tree_EObject, TreeDescription, tree_DTreeElement, DRepresentationElement, TreeMapping, tree_DTreeItemContainer, DSemanticDecorator, tree_DTree, DRepresentation, tree_DTreeElementSynchronizer, IdentifiedElement, tree_description_TreeDescription, description_RepresentationDescription, description_TreeItemMappingContainer, TreeItemCreationTool, tree_DTreeItem, DTreeElement, tree_TreeItemStyle, TreeItemMapping, StyleUpdater, TreeItemUpdater, Style, LabelStyle, TreeItemDeletionTool, TreeItemDragTool, TreePopupMenu, tool_RepresentationCreationDescription, tool_RepresentationNavigationDescription, tree_description_TreeItemMapping, description_TreeMapping, description_StyleUpdater, description_TreeItemUpdater, tool_ContainerViewVariable, TreeItemMappingContainer, PrecedingSiblingsVariables, tree_description_TreeItemContainerDropTool, tree_description_TreeItemStyleDescription, style_StyleDescription, style_LabelStyleDescription, ColorDescription, tree_description_ConditionalTreeItemStyleDescription, ConditionalStyleDescription, TreeItemStyleDescription, tree_description_TreeItemTool, AbstractToolDescription, tool_ModelOperation, TreeVariable, tree_description_TreeItemDragTool, tool_MappingBasedToolDescription, description_TreeItemTool, tool_DropContainerVariable, tool_ElementDropVariable, tree_description_TreeItemDeletionTool, tree_description_TreeCreationDescription, RepresentationCreationDescription, tree_description_TreeNavigationDescription, RepresentationNavigationDescription, tree_description_TreeMapping, RepresentationElementMapping, tree_description_TreeItemCreationTool, tree_description_TreeItemEditionTool, TreeItemTool, tool_EditMaskVariables, TreeItemContainerDropTool, tree_description_TreePopupMenu, tool_MenuItemOrRef, tree_description_StyleUpdater, ConditionalTreeItemStyleDescription, tree_description_TreeVariable, description_AbstractVariable, tool_VariableContainer, tree_description_TreeItemUpdater, TreeItemEditionTool, tree_description_PrecedingSiblingsVariables, tree_description_TreeItemMappingContainer, TreeDragSource},
    associations={semanticElements0, description1, treeElementMapping3, createTreeItem13, ownedTreeItems4, ownedStyle5, actualMapping6, container8, styleUpdater9, updater11, reusedTreeItemMappings18, allSubMappings20, specialize23, delete26, create27, dndTools30, popupMenus32, ownedRepresentationCreationDescriptions14, ownedRepresentationNavigationDescriptions16, newViewContainer45, containers47, precedingSiblings49, oldContainer51, newContainer53, backgroundColor34, style35, firstModelOperation36, variables37, oldContainer39, newContainer40, element43, element71, root74, mapping77, treeDescription79, treeDescription81, element56, newViewContainer59, precedingSiblings62, mapping65, mask67, mapping68, dropTools90, menuItemDescriptions92, defaultStyle83, conditionalStyles85, directEdit87, subItemMappings88},
    generalizations={gen_tree_DTree_DTreeItemContainer, gen_tree_DTreeElement_DRepresentationElement, gen_tree_DTreeItemContainer_DSemanticDecorator, gen_tree_DTree_DRepresentation, gen_tree_DTreeElementSynchronizer_IdentifiedElement, gen_tree_description_TreeDescription_description_RepresentationDescription, gen_tree_description_TreeDescription_description_TreeItemMappingContainer, gen_tree_DTreeItem_DTreeItemContainer, gen_tree_DTreeItem_DTreeElement, gen_tree_TreeItemStyle_Style, gen_tree_TreeItemStyle_LabelStyle, gen_tree_description_TreeItemMapping_description_TreeMapping, gen_tree_description_TreeItemMapping_description_StyleUpdater, gen_tree_description_TreeItemMapping_description_TreeItemUpdater, gen_tree_description_TreeItemMapping_description_TreeItemMappingContainer, gen_tree_description_TreeItemContainerDropTool_tool_MappingBasedToolDescription, gen_tree_description_TreeItemContainerDropTool_description_TreeItemTool, gen_tree_description_TreeItemStyleDescription_style_StyleDescription, gen_tree_description_TreeItemStyleDescription_style_LabelStyleDescription, gen_tree_description_ConditionalTreeItemStyleDescription_ConditionalStyleDescription, gen_tree_description_TreeItemTool_AbstractToolDescription, gen_tree_description_TreeItemDragTool_tool_MappingBasedToolDescription, gen_tree_description_TreeItemDragTool_description_TreeItemTool, gen_tree_description_TreeItemDeletionTool_TreeItemTool, gen_tree_description_TreeCreationDescription_RepresentationCreationDescription, gen_tree_description_TreeNavigationDescription_RepresentationNavigationDescription, gen_tree_description_TreeMapping_RepresentationElementMapping, gen_tree_description_TreeItemCreationTool_description_TreeItemTool, gen_tree_description_TreeItemCreationTool_tool_MappingBasedToolDescription, gen_tree_description_TreeItemEditionTool_TreeItemTool, gen_tree_description_TreePopupMenu_AbstractToolDescription, gen_tree_description_TreeVariable_description_AbstractVariable, gen_tree_description_TreeVariable_tool_VariableContainer, gen_tree_description_PrecedingSiblingsVariables_TreeVariable},
    metadata=None
)
