...
def test_hyp_tree_treeitemstyle_backgroundColor_setter(instance):
...
def test_tree_DTreeElementSynchronizer_isa_IdentifiedElement():
    instance = tree_DTreeElementSynchronizer()
