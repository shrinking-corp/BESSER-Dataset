...
class description_AbstractVariable:
    ...
    pass
class tree_description_TreeVariable(description_AbstractVariable, tool_VariableContainer):
...
class tree_description_TreeItemStyleDescription(style_LabelStyleDescription, style_StyleDescription):
    ...
    pass
class tree_description_TreeItemContainerDropTool(description_TreeItemTool, tool_MappingBasedToolDescription):
...
class description_TreeItemMappingContainer:
    ...
    pass
class tree_description_TreeItemMapping(description_StyleUpdater, description_TreeMapping, description_TreeItemUpdater, description_TreeItemMappingContainer):
