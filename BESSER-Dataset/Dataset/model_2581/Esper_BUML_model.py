...
# Classes
esper_Domainmodel = Class(name="esper_Domainmodel")
esper_RuleParts = Class(name="esper_RuleParts")
esper_Event = Class(name="esper_Event")
KindOfEvent = Class(name="KindOfEvent")
esper_Attributes = Class(name="esper_Attributes")
esper_AttributesDefinition = Class(name="esper_AttributesDefinition")
esper_Name = Class(name="esper_Name")
esper_Insert = Class(name="esper_Insert")
esper_Priority = Class(name="esper_Priority")
esper_Select = Class(name="esper_Select")
esper_From = Class(name="esper_From")
esper_GroupBy = Class(name="esper_GroupBy")
esper_Having = Class(name="esper_Having")
esper_SelectAttributesDefinition = Class(name="esper_SelectAttributesDefinition")
esper_KindSelectAttributesDefinition = Class(name="esper_KindSelectAttributesDefinition")
esper_SingleSelectDefinition = Class(name="esper_SingleSelectDefinition")
esper_DefaultMethods = Class(name="esper_DefaultMethods")
esper_SingleDefinition = Class(name="esper_SingleDefinition")
esper_Anything = Class(name="esper_Anything")
esper_Pattern = Class(name="esper_Pattern")
esper_AbstractFollowBy = Class(name="esper_AbstractFollowBy")
esper_FollowBy = Class(name="esper_FollowBy")
esper_FollowByWhere = Class(name="esper_FollowByWhere")
esper_TerminalExpression = Class(name="esper_TerminalExpression")
esper_KindOfEvent = Class(name="esper_KindOfEvent")
esper_Timer = Class(name="esper_Timer")
ExtraParenthesisRule = Class(name="ExtraParenthesisRule")
esper_JoinFollowBy = Class(name="esper_JoinFollowBy")
esper_Win = Class(name="esper_Win")
esper_ExtraParenthesisRule = Class(name="esper_ExtraParenthesisRule")
...
esper_AttributesDefinition.attributes={esper_AttributesDefinition_type, esper_AttributesDefinition_name}
...
esper_KindSelectAttributesDefinition.attributes={esper_KindSelectAttributesDefinition_string, esper_KindSelectAttributesDefinition_int}
