...
# Classes
eol_EolElement = Class(name="eol_EolElement", is_abstract=True)
eol_TextRegion = Class(name="eol_TextRegion")
eol_TextPosition = Class(name="eol_TextPosition")
eol_EolProgram = Class(name="eol_EolProgram")
...
eol_LiteralExpression = Class(name="eol_LiteralExpression", is_abstract=True)
...
eol_ModelExpression = Class(name="eol_ModelExpression")
...
eol_EObject = Class(name="eol_EObject")
...
eol_EPackage = Class(name="eol_EPackage")
...
eol_CollectionInitValue = Class(name="eol_CollectionInitValue", is_abstract=True)
...
eol_KeyValue = Class(name="eol_KeyValue")
...
eol_Annotation = Class(name="eol_Annotation", is_abstract=True)
eol_ExecutableAnnotation = Class(name="eol_ExecutableAnnotation")
Annotation = Class(name="Annotation")
eol_SimpleAnnotation = Class(name="eol_SimpleAnnotation")
eol_SpecialNameExpression = Class(name="eol_SpecialNameExpression")
NameExpression = Class(name="NameExpression")
eol_ModelElementType = Class(name="eol_ModelElementType")
eol_EClassifier = Class(name="eol_EClassifier")
...
eol_ExprList = Class(name="eol_ExprList")
CollectionInitValue = Class(name="CollectionInitValue")
eol_ExpRange = Class(name="eol_ExpRange")
...
eol_NativeExpression = Class(name="eol_NativeExpression")
eol_EType = Class(name="eol_EType")
eol_VoidType = Class(name="eol_VoidType")
eol_PseudoType = Class(name="eol_PseudoType")
eol_SelfType = Class(name="eol_SelfType")
PseudoType = Class(name="PseudoType")
eol_SelfContentType = Class(name="eol_SelfContentType")
eol_OrderedCollectionType = Class(name="eol_OrderedCollectionType")
eol_UniqueCollectionType = Class(name="eol_UniqueCollectionType")
eol_SelfInnermostType = Class(name="eol_SelfInnermostType")
eol_OperationArgType = Class(name="eol_OperationArgType")
eol_LogicalOperatorExpression = Class(name="eol_LogicalOperatorExpression")
BinaryOperatorExpression = Class(name="BinaryOperatorExpression")
eol_ComparisonOperatorExpression = Class(name="eol_ComparisonOperatorExpression")
eol_ArithmeticOperatorExpression = Class(name="eol_ArithmeticOperatorExpression")
...
eol_EolElement.attributes={eol_EolElement_uri, eol_EolElement_line, eol_EolElement_column}
...
domain_model = DomainModel(
    name="eol",
    types={eol_EolElement, eol_TextRegion, eol_TextPosition, eol_EolProgram, EolLibraryModule, eol_Block, eol_Import, EolElement, eol_StringExpression, eol_EolLibraryModule, eol_Statement, eol_Expression, eol_Type, eol_OperatorExpression, Expression, eol_BinaryOperatorExpression, OperatorExpression, eol_AndOperatorExpression, LogicalOperatorExpression, eol_LiteralExpression, eol_BooleanExpression, PrimitiveExpression, eol_DivideOperatorExpression, ArithmeticOperatorExpression, eol_EnumerationLiteralExpression, eol_NameExpression, eol_ModelExpression, eol_EqualsOperatorExpression, ComparisonOperatorExpression, eol_FeatureCallExpression, eol_GreaterThanOperatorExpression, eol_GreaterThanOrEqualToOperatorExpression, eol_ImpliesOperatorExpression, eol_IntegerExpression, eol_LessThanOperatorExpression, eol_LessThanOrEqualToOperatorExpression, eol_MethodCallExpression, FeatureCallExpression, eol_EObject, eol_MinusOperatorExpression, eol_MultiplyOperatorExpression, eol_UnaryOperatorExpression, eol_NegativeOperatorExpression, UnaryOperatorExpression, eol_NotEqualsOperatorExpression, eol_NotOperatorExpression, eol_OrOperatorExpression, eol_PlusOperatorExpression, eol_PropertyCallExpression, eol_VariableDeclarationExpression, eol_XorOperatorExpression, eol_OperationDefinition, eol_AnnotationBlock, eol_FormalParameterExpression, eol_AssignmentStatement, Statement, eol_BreakStatement, eol_BreakAllStatement, eol_ContinueStatement, eol_DeleteStatement, eol_RealExpression, eol_ForStatement, eol_ExpressionOrStatementBlock, eol_IfStatement, eol_ReturnStatement, eol_SwitchStatement, eol_SwitchCaseExpressionStatement, eol_SwitchCaseDefaultStatement, eol_SwitchCaseStatement, eol_WhileStatement, eol_ModelDeclarationStatement, eol_EPackage, eol_ModelDeclarationParameter, eol_FOLMethodCallExpression, eol_ExpressionStatement, SwitchCaseStatement, eol_PrimitiveExpression, LiteralExpression, eol_CollectionExpression, eol_CollectionInitValue, eol_SetExpression, CollectionExpression, eol_BagExpression, eol_SequenceExpression, eol_OrderedSetExpression, eol_MapExpression, eol_KeyValue, eol_AnyType, Type, eol_CollectionType, eol_PrimitiveType, eol_BooleanType, PrimitiveType, eol_IntegerType, eol_RealType, eol_StringType, eol_SetType, UniqueCollectionType, eol_BagType, CollectionType, eol_SequenceType, OrderedCollectionType, eol_OrderedSetType, eol_MapType, eol_Annotation, eol_ExecutableAnnotation, Annotation, eol_SimpleAnnotation, eol_SpecialNameExpression, NameExpression, eol_ModelElementType, eol_EClassifier, eol_NativeType, eol_ThrowStatement, eol_AbortStatement, eol_TransactionStatement, VariableDeclarationExpression, eol_ExprList, CollectionInitValue, eol_ExpRange, eol_NewExpression, eol_SpecialAssignmentStatement, AssignmentStatement, eol_ModelType, eol_NativeExpression, eol_EType, eol_VoidType, eol_PseudoType, eol_SelfType, PseudoType, eol_SelfContentType, eol_OrderedCollectionType, eol_UniqueCollectionType, eol_SelfInnermostType, eol_OperationArgType, eol_LogicalOperatorExpression, BinaryOperatorExpression, eol_ComparisonOperatorExpression, eol_ArithmeticOperatorExpression},
    associations={container1, region2, start4, end6, importedModules10, block11, imported13, importedProgram14, resolvedType16, statements17, lhs19, rhs21, enumeration24, literal25, target30, isArrow32, arguments34, method36, resolvedMethods39, isType41, expr44, property46, extended48, model28, name51, create53, parameters56, contextType59, returnType61, annotationBlock64, body66, name69, parameters72, self74, _result77, dependingOperationDefinitions81, lhs83, rhs85, iterator90, iterated92, body95, condition97, ifBody99, elseBody102, returned105, expression107, cases109, default111, body113, condition115, body117, packages120, name121, alias124, driver127, EReference0133, deleted88, iterator135, condition137, method140, expression143, expression145, parameterList148, contentType149, contents152, keyValues154, parameters130, dynamicTypes155, contentType157, valueType159, keyType161, name164, expression166, values168, key170, value173, ecoreType176, resolvedModelDeclaration177, simpleAnnotations182, executableAnnotations185, name188, value191, thrown194, names196, body198, expressions201, start203, end205, parameters208, expression210, nativeExpression180, models213, nativeExpr215, isType217, ecoreType220, block222, expression225, modelDeclarations228, imports231, operations234, name237},
    generalizations={gen_eol_EolProgram_EolLibraryModule, gen_eol_Import_EolElement, gen_eol_Statement_EolElement, gen_eol_Expression_EolElement, gen_eol_Block_EolElement, gen_eol_OperatorExpression_Expression, gen_eol_BinaryOperatorExpression_OperatorExpression, gen_eol_AndOperatorExpression_LogicalOperatorExpression, gen_eol_LiteralExpression_Expression, gen_eol_BooleanExpression_PrimitiveExpression, gen_eol_DivideOperatorExpression_ArithmeticOperatorExpression, gen_eol_EnumerationLiteralExpression_Expression, gen_eol_EqualsOperatorExpression_ComparisonOperatorExpression, gen_eol_FeatureCallExpression_Expression, gen_eol_GreaterThanOperatorExpression_ComparisonOperatorExpression, gen_eol_GreaterThanOrEqualToOperatorExpression_ComparisonOperatorExpression, gen_eol_ImpliesOperatorExpression_LogicalOperatorExpression, gen_eol_IntegerExpression_PrimitiveExpression, gen_eol_LessThanOperatorExpression_ComparisonOperatorExpression, gen_eol_LessThanOrEqualToOperatorExpression_ComparisonOperatorExpression, gen_eol_MethodCallExpression_FeatureCallExpression, gen_eol_MinusOperatorExpression_ArithmeticOperatorExpression, gen_eol_MultiplyOperatorExpression_ArithmeticOperatorExpression, gen_eol_NameExpression_Expression, gen_eol_UnaryOperatorExpression_OperatorExpression, gen_eol_NegativeOperatorExpression_UnaryOperatorExpression, gen_eol_NotEqualsOperatorExpression_ComparisonOperatorExpression, gen_eol_NotOperatorExpression_UnaryOperatorExpression, gen_eol_OrOperatorExpression_LogicalOperatorExpression, gen_eol_PlusOperatorExpression_ArithmeticOperatorExpression, gen_eol_PropertyCallExpression_FeatureCallExpression, gen_eol_StringExpression_PrimitiveExpression, gen_eol_VariableDeclarationExpression_Expression, gen_eol_XorOperatorExpression_LogicalOperatorExpression, gen_eol_OperationDefinition_EolElement, gen_eol_AssignmentStatement_Statement, gen_eol_BreakStatement_Statement, gen_eol_BreakAllStatement_Statement, gen_eol_ContinueStatement_Statement, gen_eol_DeleteStatement_Statement, gen_eol_RealExpression_PrimitiveExpression, gen_eol_ForStatement_Statement, gen_eol_IfStatement_Statement, gen_eol_ReturnStatement_Statement, gen_eol_SwitchStatement_Statement, gen_eol_SwitchCaseStatement_Statement, gen_eol_WhileStatement_Statement, gen_eol_ModelDeclarationStatement_Statement, gen_eol_FOLMethodCallExpression_FeatureCallExpression, gen_eol_ExpressionStatement_Statement, gen_eol_SwitchCaseDefaultStatement_SwitchCaseStatement, gen_eol_SwitchCaseExpressionStatement_SwitchCaseStatement, gen_eol_PrimitiveExpression_LiteralExpression, gen_eol_CollectionExpression_LiteralExpression, gen_eol_SetExpression_CollectionExpression, gen_eol_BagExpression_CollectionExpression, gen_eol_SequenceExpression_CollectionExpression, gen_eol_OrderedSetExpression_CollectionExpression, gen_eol_MapExpression_LiteralExpression, gen_eol_Type_EolElement, gen_eol_AnyType_Type, gen_eol_CollectionType_Type, gen_eol_PrimitiveType_Type, gen_eol_BooleanType_PrimitiveType, gen_eol_IntegerType_PrimitiveType, gen_eol_RealType_PrimitiveType, gen_eol_StringType_PrimitiveType, gen_eol_SetType_UniqueCollectionType, gen_eol_BagType_CollectionType, gen_eol_SequenceType_OrderedCollectionType, gen_eol_OrderedSetType_OrderedCollectionType, gen_eol_OrderedSetType_UniqueCollectionType, gen_eol_MapType_Type, gen_eol_Annotation_EolElement, gen_eol_ExecutableAnnotation_Annotation, gen_eol_SimpleAnnotation_Annotation, gen_eol_KeyValue_Expression, gen_eol_SpecialNameExpression_NameExpression, gen_eol_ModelElementType_Type, gen_eol_NativeType_Type, gen_eol_ModelExpression_NameExpression, gen_eol_AnnotationBlock_EolElement, gen_eol_ModelDeclarationParameter_Expression, gen_eol_ThrowStatement_Statement, gen_eol_AbortStatement_Statement, gen_eol_TransactionStatement_Statement, gen_eol_FormalParameterExpression_VariableDeclarationExpression, gen_eol_CollectionInitValue_Expression, gen_eol_ExprList_CollectionInitValue, gen_eol_ExpRange_CollectionInitValue, gen_eol_NewExpression_Expression, gen_eol_SpecialAssignmentStatement_AssignmentStatement, gen_eol_ModelType_Type, gen_eol_NativeExpression_LiteralExpression, gen_eol_EType_Type, gen_eol_VoidType_Type, gen_eol_PseudoType_Type, gen_eol_SelfType_PseudoType, gen_eol_SelfContentType_PseudoType, gen_eol_OrderedCollectionType_CollectionType, gen_eol_UniqueCollectionType_CollectionType, gen_eol_SelfInnermostType_PseudoType, gen_eol_OperationArgType_PseudoType, gen_eol_ExpressionOrStatementBlock_EolElement, gen_eol_EolLibraryModule_EolElement, gen_eol_LogicalOperatorExpression_BinaryOperatorExpression, gen_eol_ComparisonOperatorExpression_BinaryOperatorExpression, gen_eol_ArithmeticOperatorExpression_BinaryOperatorExpression},
    metadata=None
)
