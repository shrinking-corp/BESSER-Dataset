...
class mngr_ManagerParameter(NamedElement):
    ...
    @property
    def LitteralUnlimitedNatural(self):
...
class mngr_ManagerTransition(NamedElement):
    ...
    def __init__(self, output: str, transProb: float, transRate: float, Event: str, Condition: str, Action: str, input: str, ManagerTransition13: "mngr_ManagerState" = None, ManagerTransition15: "mngr_ManagerState" = None, ManagerTransition: "mngr_Manager" = None, ownedTransition: "mngr_Manager" = None, outgoingTransition: "mngr_ManagerState" = None, incomingTransition: "mngr_ManagerState" = None):
        self.output = output
...
class mngr_ManagerState(NamedElement):
    ...
    def __init__(self, isStart: bool, isEnd: bool, Prob: float, ownedState: "mngr_Manager" = None, source: set["mngr_ManagerTransition"] = None, target: set["mngr_ManagerTransition"] = None, state: set["mngr_ManagerParameter"] = None, ManagerState: "mngr_Manager" = None, mngr_ManagerState: "mngr_Manager" = None, mngr_ManagerState4: "mngr_Manager" = None, ManagerState25: "mngr_ManagerParameter" = None, ManagerState21: "mngr_ManagerTransition" = None, ManagerState23: "mngr_ManagerTransition" = None):
