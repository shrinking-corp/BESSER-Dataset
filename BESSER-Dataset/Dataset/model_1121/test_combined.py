...
def test_hyp_mngr_opaqueexpression_is_not_abstract():
    assert not inspect.isabstract(mngr_OpaqueExpression)


def test_hyp_mngr_opaqueexpression_constructor_exists():
    assert callable(mngr_OpaqueExpression.__init__)


def test_hyp_mngr_opaqueexpression_constructor_args():
...
def test_hyp_mngr_managertransition_is_not_abstract():
    assert not inspect.isabstract(mngr_ManagerTransition)


def test_hyp_mngr_managertransition_constructor_exists():
    assert callable(mngr_ManagerTransition.__init__)


def test_hyp_mngr_managertransition_constructor_args():
...
def test_hyp_mngr_managedelement_is_not_abstract():
    assert not inspect.isabstract(mngr_ManagedElement)


def test_hyp_mngr_managedelement_constructor_exists():
    assert callable(mngr_ManagedElement.__init__)


def test_hyp_mngr_managedelement_constructor_args():
...
def test_hyp_mngr_managerstate_is_not_abstract():
    assert not inspect.isabstract(mngr_ManagerState)


def test_hyp_mngr_managerstate_constructor_exists():
    assert callable(mngr_ManagerState.__init__)


def test_hyp_mngr_managerstate_constructor_args():
...
def test_hyp_mngr_managerparameter_is_not_abstract():
    assert not inspect.isabstract(mngr_ManagerParameter)


def test_hyp_mngr_managerparameter_constructor_exists():
    assert callable(mngr_ManagerParameter.__init__)


def test_hyp_mngr_managerparameter_constructor_args():
...
def test_hyp_mngr_manager_is_not_abstract():
    assert not inspect.isabstract(mngr_Manager)


def test_hyp_mngr_manager_constructor_exists():
    assert callable(mngr_Manager.__init__)


def test_hyp_mngr_manager_constructor_args():
...
def test_hyp_mngr_managertransition_Event_setter(instance):
...
@given(instance=mngr_ManagerTransition_strategy)
def test_hyp_mngr_managertransition_transRate_setter(instance):
...
@given(instance=mngr_ManagerTransition_strategy)
def test_hyp_mngr_managertransition_input_setter(instance):
...
@given(instance=mngr_ManagerTransition_strategy)
def test_hyp_mngr_managertransition_Condition_setter(instance):
...
@given(instance=mngr_ManagerTransition_strategy)
def test_hyp_mngr_managertransition_Action_setter(instance):
...
@given(instance=mngr_ManagerTransition_strategy)
def test_hyp_mngr_managertransition_output_setter(instance):
...
@given(instance=mngr_ManagerTransition_strategy)
def test_hyp_mngr_managertransition_transProb_setter(instance):
...
def test_hyp_mngr_managedelement_description_setter(instance):
...
def test_hyp_mngr_managerstate_Prob_setter(instance):
...
@given(instance=mngr_ManagerState_strategy)
def test_hyp_mngr_managerstate_isEnd_setter(instance):
...
@given(instance=mngr_ManagerState_strategy)
def test_hyp_mngr_managerstate_isStart_setter(instance):
...
def test_hyp_mngr_managerparameter_LitteralUnlimitedNatural_setter(instance):
...
@given(instance=mngr_ManagerParameter_strategy)
def test_hyp_mngr_managerparameter_LitteralInteger_setter(instance):
...
@given(instance=mngr_ManagerParameter_strategy)
def test_hyp_mngr_managerparameter_LitteralBoolean_setter(instance):
...
@given(instance=mngr_ManagerParameter_strategy)
def test_hyp_mngr_managerparameter_LitteralString_setter(instance):
...
@given(instance=mngr_ManagerParameter_strategy)
def test_hyp_mngr_managerparameter_isInput_setter(instance):
