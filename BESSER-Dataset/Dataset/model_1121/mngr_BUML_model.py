...
# Classes
mngr_Manager = Class(name="mngr_Manager")
NamedElement = Class(name="NamedElement")
mngr_ManagerState = Class(name="mngr_ManagerState")
mngr_ManagerParameter = Class(name="mngr_ManagerParameter")
mngr_ManagedElement = Class(name="mngr_ManagedElement")
mngr_ManagerTransition = Class(name="mngr_ManagerTransition")
mngr_OpaqueExpression = Class(name="mngr_OpaqueExpression")
...
mngr_ManagerParameter.attributes={mngr_ManagerParameter_isInput, mngr_ManagerParameter_LitteralUnlimitedNatural, mngr_ManagerParameter_LitteralBoolean, mngr_ManagerParameter_LitteralInteger, mngr_ManagerParameter_LitteralString}
...
mngr_ManagerTransition.attributes={mngr_ManagerTransition_transProb, mngr_ManagerTransition_Action, mngr_ManagerTransition_output, mngr_ManagerTransition_transRate, mngr_ManagerTransition_input, mngr_ManagerTransition_Event, mngr_ManagerTransition_Condition}
...
domain_model = DomainModel(
    ...
    associations={owningManager11, outgoingTransition12, incomingTransition14, contextParameters16, ownedState0, initialState1, finalState2, contextParameters5, managedElement7, ownedTransition9, state24, opaqueExpressions26, owningManager18, source20, target22, owningManager27, owningManager30},
