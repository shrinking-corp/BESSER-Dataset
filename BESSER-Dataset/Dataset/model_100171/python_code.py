...
class rdbms_referencedColumns:
    ...
    def __init__(self, group: str, rdbms_referencedColumns54: "rdbms_key" = None, rdbms_referencedColumns62: set["rdbms_oID"] = None, rdbms_referencedColumns: "rdbms_DocumentRoot" = None, rdbms_referencedColumns45: "rdbms_foreignKey" = None):
        self.group = group
...
class rdbms_tables:
    ...
    def __init__(self, group: str, rdbms_tables69: "rdbms_schema" = None, rdbms_tables83: set["rdbms_table"] = None, rdbms_tables: "rdbms_DocumentRoot" = None):
        self.group = group
...
class rdbms_table:
    ...
    def __init__(self, kind: str, name: str, oID: str, rdbms_table77: "rdbms_columns" = None, rdbms_table80: "rdbms_key2" = None, rdbms_table84: "rdbms_tables" = None, rdbms_table: "rdbms_DocumentRoot" = None):
        self.kind = kind
        self.name = name
        self.oID = oID
...
class rdbms_schemas:
    ...
    def __init__(self, group: str, rdbms_schemas60: "rdbms_RDBMS" = None, rdbms_schemas74: set["rdbms_schema"] = None, rdbms_schemas: "rdbms_DocumentRoot" = None):
        self.group = group
...
class rdbms_schema:
    ...
    def __init__(self, kind: str, name: str, oID: str, rdbms_schema68: "rdbms_tables" = None, rdbms_schema71: "rdbms_foreignKeys" = None, rdbms_schema75: "rdbms_schemas" = None, rdbms_schema: "rdbms_DocumentRoot" = None):
        self.kind = kind
        self.name = name
        self.oID = oID
...
class rdbms_foreignKeys:
    ...
    def __init__(self, group: str, rdbms_foreignKeys72: "rdbms_schema" = None, rdbms_foreignKeys: "rdbms_DocumentRoot" = None, rdbms_foreignKeys47: set["rdbms_foreignKey"] = None):
        self.group = group
...
class rdbms_foreignKey:
    ...
    def __init__(self, refersTo: str, kind: str, name: str, oID: str, owner: str, rdbms_foreignKey: "rdbms_DocumentRoot" = None, rdbms_foreignKey48: "rdbms_foreignKeys" = None, rdbms_foreignKey44: "rdbms_referencedColumns" = None):
...
class rdbms_oID:
    ...
    def __init__(self, oID: str, rdbms_oID51: "rdbms_hasForeignKeys" = None, rdbms_oID66: "rdbms_referencedKeys" = None, rdbms_oID63: "rdbms_referencedColumns" = None, rdbms_oID: "rdbms_DocumentRoot" = None):
        self.oID = oID
...
class rdbms_key:
    ...
    def __init__(self, oID: str, kind: str, name: str, rdbms_key53: "rdbms_referencedColumns" = None, rdbms_key: "rdbms_DocumentRoot" = None, rdbms_key57: "rdbms_key2" = None):
        self.oID = oID
        self.kind = kind
        self.name = name
...
class rdbms_columns:
    ...
    def __init__(self, group: str, rdbms_columns: set["rdbms_column"] = None, rdbms_columns78: "rdbms_table" = None, rdbms_columns14: "rdbms_DocumentRoot" = None):
        self.group = group
...
class rdbms_DocumentRoot:
    ...
    def __init__(self, mixed: str, rdbms_DocumentRoot: set["rdbms_EStringToStringMapEntry"] = None, rdbms_DocumentRoot7: set["rdbms_EStringToStringMapEntry"] = None, rdbms_DocumentRoot10: set["rdbms_column"] = None, rdbms_DocumentRoot20: set["rdbms_hasForeignKeys"] = None, rdbms_DocumentRoot23: set["rdbms_key"] = None, rdbms_DocumentRoot25: set["rdbms_key2"] = None, rdbms_DocumentRoot27: set["rdbms_oID"] = None, rdbms_DocumentRoot13: set["rdbms_columns"] = None, rdbms_DocumentRoot16: set["rdbms_foreignKey"] = None, rdbms_DocumentRoot18: set["rdbms_foreignKeys"] = None, rdbms_DocumentRoot36: set["rdbms_schema"] = None, rdbms_DocumentRoot38: set["rdbms_schemas"] = None, rdbms_DocumentRoot40: set["rdbms_table"] = None, rdbms_DocumentRoot42: set["rdbms_tables"] = None, rdbms_DocumentRoot29: set["rdbms_RDBMS"] = None, rdbms_DocumentRoot31: set["rdbms_referencedColumns"] = None, rdbms_DocumentRoot33: set["rdbms_referencedKeys"] = None):
        self.mixed = mixed
...
class rdbms_referencedKeys:
    ...
    def __init__(self, group: str, rdbms_referencedKeys: "rdbms_column" = None, rdbms_referencedKeys65: set["rdbms_oID"] = None, rdbms_referencedKeys34: "rdbms_DocumentRoot" = None):
        self.group = group
...
class rdbms_column:
    ...
    def __init__(self, kind: str, name: str, oID: str, type: str, rdbms_column: "rdbms_referencedKeys" = None, rdbms_column2: "rdbms_hasForeignKeys" = None, rdbms_column11: "rdbms_DocumentRoot" = None, rdbms_column4: "rdbms_columns" = None):
        self.kind = kind
        self.name = name
        self.oID = oID
        self.type = type
