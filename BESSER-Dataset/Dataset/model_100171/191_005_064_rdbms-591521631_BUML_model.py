...
rdbms_column.attributes={rdbms_column_type, rdbms_column_oID, rdbms_column_name, rdbms_column_kind}
...
rdbms_key.attributes={rdbms_key_kind, rdbms_key_oID, rdbms_key_name}
...
rdbms_foreignKey.attributes={rdbms_foreignKey_refersTo, rdbms_foreignKey_name, rdbms_foreignKey_oID, rdbms_foreignKey_kind, rdbms_foreignKey_owner}
...
rdbms_schema.attributes={rdbms_schema_name, rdbms_schema_kind, rdbms_schema_oID}
...
domain_model = DomainModel(
    name="rdbms",
    types={rdbms_column, rdbms_referencedKeys, rdbms_hasForeignKeys, rdbms_DocumentRoot, rdbms_EStringToStringMapEntry, rdbms_columns, rdbms_key, rdbms_key2, rdbms_oID, rdbms_foreignKey, rdbms_foreignKeys, rdbms_schema, rdbms_schemas, rdbms_table, rdbms_tables, rdbms_RDBMS, rdbms_referencedColumns},
    associations={referencedKeys0, hasForeignKeys1, xMLNSPrefixMap5, xSISchemaLocation6, column9, column3, hasForeignKeys19, key22, key224, oID26, columns12, foreignKey15, foreignKeys17, schema35, schemas37, table39, tables41, rDBMS28, referencedColumns30, referencedKeys32, foreignKey46, referencedColumns43, key55, schemas58, oID49, referencedColumns52, oID64, tables67, foreignKeys70, oID61, columns76, key279, schema73, table82},
    generalizations={},
    metadata=None
)
