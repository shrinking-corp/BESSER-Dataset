...
# Classes
logoASM_Instruction = Class(name="logoASM_Instruction", is_abstract=True)
logoASM_Primitive = Class(name="logoASM_Primitive", is_abstract=True)
Instruction = Class(name="Instruction")
logoASM_Back = Class(name="logoASM_Back")
Primitive = Class(name="Primitive")
logoASM_Expression = Class(name="logoASM_Expression", is_abstract=True)
logoASM_Forward = Class(name="logoASM_Forward")
logoASM_Left = Class(name="logoASM_Left")
logoASM_Right = Class(name="logoASM_Right")
logoASM_PenDown = Class(name="logoASM_PenDown")
logoASM_PenUp = Class(name="logoASM_PenUp")
logoASM_Clear = Class(name="logoASM_Clear")
logoASM_Constant = Class(name="logoASM_Constant")
logoASM_ProcCall = Class(name="logoASM_ProcCall")
logoASM_ProcDeclaration = Class(name="logoASM_ProcDeclaration")
logoASM_Parameter = Class(name="logoASM_Parameter")
logoASM_Block = Class(name="logoASM_Block")
logoASM_If = Class(name="logoASM_If")
ControlStructure = Class(name="ControlStructure")
logoASM_BinaryExp = Class(name="logoASM_BinaryExp", is_abstract=True)
Expression = Class(name="Expression")
logoASM_Repeat = Class(name="logoASM_Repeat")
logoASM_While = Class(name="logoASM_While")
logoASM_ParameterCall = Class(name="logoASM_ParameterCall")
logoASM_Plus = Class(name="logoASM_Plus")
BinaryExp = Class(name="BinaryExp")
logoASM_Minus = Class(name="logoASM_Minus")
logoASM_Mult = Class(name="logoASM_Mult")
logoASM_Div = Class(name="logoASM_Div")
logoASM_Equals = Class(name="logoASM_Equals")
logoASM_Greater = Class(name="logoASM_Greater")
logoASM_Lower = Class(name="logoASM_Lower")
logoASM_LogoProgram = Class(name="logoASM_LogoProgram")
logoASM_ControlStructure = Class(name="logoASM_ControlStructure")
...
domain_model = DomainModel(
    name="logoASM",
    types={logoASM_Instruction, logoASM_Primitive, Instruction, logoASM_Back, Primitive, logoASM_Expression, logoASM_Forward, logoASM_Left, logoASM_Right, logoASM_PenDown, logoASM_PenUp, logoASM_Clear, logoASM_Constant, logoASM_ProcCall, logoASM_ProcDeclaration, logoASM_Parameter, logoASM_Block, logoASM_If, ControlStructure, logoASM_BinaryExp, Expression, logoASM_Repeat, logoASM_While, logoASM_ParameterCall, logoASM_Plus, BinaryExp, logoASM_Minus, logoASM_Mult, logoASM_Div, logoASM_Equals, logoASM_Greater, logoASM_Lower, logoASM_LogoProgram, logoASM_ControlStructure},
    associations={steps0, steps1, angle3, angle5, rhs9, actualArgs12, declaration14, args16, instructions18, instructions20, thenPart22, elsePart24, lhs7, block29, block31, parameter33, instructions35, condition27},
    generalizations={gen_logoASM_Primitive_Instruction, gen_logoASM_Back_Primitive, gen_logoASM_Forward_Primitive, gen_logoASM_Left_Primitive, gen_logoASM_Right_Primitive, gen_logoASM_PenDown_Primitive, gen_logoASM_PenUp_Primitive, gen_logoASM_Clear_Primitive, gen_logoASM_Expression_Instruction, gen_logoASM_Constant_Expression, gen_logoASM_ProcCall_Expression, gen_logoASM_ProcDeclaration_Instruction, gen_logoASM_Block_Instruction, gen_logoASM_If_ControlStructure, gen_logoASM_BinaryExp_Expression, gen_logoASM_Repeat_ControlStructure, gen_logoASM_While_ControlStructure, gen_logoASM_ParameterCall_Expression, gen_logoASM_Plus_BinaryExp, gen_logoASM_Minus_BinaryExp, gen_logoASM_Mult_BinaryExp, gen_logoASM_Div_BinaryExp, gen_logoASM_Equals_BinaryExp, gen_logoASM_Greater_BinaryExp, gen_logoASM_Lower_BinaryExp, gen_logoASM_ControlStructure_Instruction},
    metadata=None
)
