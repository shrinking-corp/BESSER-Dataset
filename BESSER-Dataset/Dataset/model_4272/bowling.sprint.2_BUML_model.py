...
bowling_Player.attributes={bowling_Player_isProfessional, bowling_Player_height, bowling_Player_dateOfBirth, bowling_Player_name}
...
domain_model = DomainModel(
    name="bowling",
    types={bowling_League, bowling_Tournament, bowling_Matchup, bowling_Game, bowling_Player, bowling_Lane, bowling_Alley, TournamentType},
    associations={players0, matchups1, games2, leagues6, tournaments8, lanes11, matchup3, player4},
    generalizations={},
    metadata=None
)
