...
class GraphWiki_Revision:
    ...
    def __init__(self, user: str, date: str, text_id: int, GraphWiki_Revision20: "GraphWiki_Node" = None, Revision: "GraphWiki_Node" = None, revisions: "GraphWiki_Node" = None, GraphWiki_Revision: "GraphWiki_Wiki" = None):
        self.user = user
        self.date = date
...
class GraphWiki_Edge:
    ...
    def __init__(self, type: str, GraphWiki_Edge23: "GraphWiki_Node" = None, GraphWiki_Edge26: "GraphWiki_Node" = None, GraphWiki_Edge: "GraphWiki_Wiki" = None, GraphWiki_Edge17: "GraphWiki_Graph" = None):
        self.type = type
