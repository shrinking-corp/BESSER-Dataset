...
# Classes
studyplan_CourseGroup = Class(name="studyplan_CourseGroup")
studyplan_Specialization = Class(name="studyplan_Specialization")
studyplan_StudyPlan = Class(name="studyplan_StudyPlan")
studyplan_FieldOfStudy = Class(name="studyplan_FieldOfStudy")
...
studyplan_Course.attributes={studyplan_Course_status, studyplan_Course_credit, studyplan_Course_courseCode, studyplan_Course_courseName}
...
domain_model = DomainModel(
    name="studyplan",
    types={studyplan_CourseGroup, studyplan_Specialization, studyplan_StudyPlan, studyplan_FieldOfStudy, studyplan_Course, studyplan_Semester, SemesterType, CourseStatus},
    associations={courses5, courseGroup8, semesters9, specialization12, courseGroup14, specialization16, semesters19, semester22, course25, program0, courses1, semester3},
    generalizations={},
    metadata=None
)
