...
class studyplan_Semester:
    ...
    def __init__(self, year: int, semesterType: str, studyplan_Semester6: set["studyplan_Course"] = None, studyplan_Semester10: "studyplan_Specialization" = None, studyplan_Semester21: "studyplan_FieldOfStudy" = None, studyplan_Semester24: "studyplan_CourseGroup" = None, studyplan_Semester: "studyplan_StudyPlan" = None):
        self.year = year
...
class studyplan_Course:
    ...
    def __init__(self, courseName: str, courseCode: int, credit: float, status: str, studyplan_Course7: "studyplan_Semester" = None, course: "studyplan_CourseGroup" = None, Course: "studyplan_CourseGroup" = None, studyplan_Course: "studyplan_StudyPlan" = None):
...
class studyplan_FieldOfStudy:
    ...
    def __init__(self, fieldName: str, studyplan_FieldOfStudy17: "studyplan_Specialization" = None, studyplan_FieldOfStudy20: set["studyplan_Semester"] = None, studyplan_FieldOfStudy: "studyplan_StudyPlan" = None):
...
class studyplan_CourseGroup:
    ...
    def __init__(self, group: str, courseStatus: str, CourseGroup: "studyplan_Course" = None, studyplan_CourseGroup: "studyplan_Specialization" = None, studyplan_CourseGroup23: "studyplan_Semester" = None, courseGroup: "studyplan_Course" = None):
        self.group = group
