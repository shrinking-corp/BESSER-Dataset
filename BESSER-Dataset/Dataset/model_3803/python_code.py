...
class ER_ERAttribute:
    ...
    def __init__(self, name: str, isKey: bool, ERAttribute8: "ER_Relship" = None, ERAttribute: "ER_Entity" = None, attrs: "ER_Entity" = None, attrs22: "ER_Relship" = None):
        self.name = name
        self.isKey = isKey
...
class ER_Relship:
    ...
    def __init__(self, name: str, relship: set["ER_ERAttribute"] = None, Relship: "ER_ERSchema" = None, relship10: set["ER_RelshipEnd"] = None, relships: "ER_ERSchema" = None, Relship15: "ER_RelshipEnd" = None, Relship23: "ER_ERAttribute" = None):
        self.name = name
