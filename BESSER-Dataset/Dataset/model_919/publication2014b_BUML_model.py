...
# Classes
publication2014b_PublicationProcess = Class(name="publication2014b_PublicationProcess")
Named = Class(name="Named")
publication2014b_Rule = Class(name="publication2014b_Rule")
publication2014b_Sequence = Class(name="publication2014b_Sequence")
publication2014b_Researcher = Class(name="publication2014b_Researcher")
publication2014b_PublicationPhase = Class(name="publication2014b_PublicationPhase")
publication2014b_Write = Class(name="publication2014b_Write")
publication2014b_Review = Class(name="publication2014b_Review")
publication2014b_Paper = Class(name="publication2014b_Paper")
publication2014b_Paragraph = Class(name="publication2014b_Paragraph")
publication2014b_Progress = Class(name="publication2014b_Progress")
Counted = Class(name="Counted")
publication2014b_ReviewNote = Class(name="publication2014b_ReviewNote")
Labelled = Class(name="Labelled")
publication2014b_PublicationStructure = Class(name="publication2014b_PublicationStructure")
publication2014b_PublicationSystem = Class(name="publication2014b_PublicationSystem")
publication2014b_Named = Class(name="publication2014b_Named", is_abstract=True)
publication2014b_Counted = Class(name="publication2014b_Counted", is_abstract=True)
publication2014b_Labelled = Class(name="publication2014b_Labelled", is_abstract=True)
...
publication2014b_PublicationProcess.attributes={publication2014b_PublicationProcess_minTime, publication2014b_PublicationProcess_maxTime}
...
publication2014b_Rule.attributes={publication2014b_Rule_text, publication2014b_Rule_key}
...
domain_model = DomainModel(
    ...
    types={publication2014b_PublicationProcess, Named, publication2014b_Rule, publication2014b_Sequence, publication2014b_Researcher, publication2014b_PublicationPhase, publication2014b_Write, publication2014b_Review, publication2014b_Paper, publication2014b_Paragraph, publication2014b_Progress, Counted, publication2014b_ReviewNote, Labelled, publication2014b_PublicationStructure, publication2014b_PublicationSystem, publication2014b_Named, publication2014b_Counted, publication2014b_Labelled, SequenceType},
    associations={phases0, publicationRules1, linksToSuccessors3, neededPerson5, rules6, successor9, predecessor12, phaseParticipation15, writes16, reviews17, papers19, paragraphs20, progress21, authors22, reviews24, process26, paper28, paragraph30, reviewNote33, researchers36, papers38, processView41, structuralView43},
    generalizations={gen_publication2014b_PublicationProcess_Named, gen_publication2014b_Paper_Named, gen_publication2014b_Paragraph_Counted, gen_publication2014b_Paragraph_Named, gen_publication2014b_ReviewNote_Named, gen_publication2014b_Progress_Labelled, gen_publication2014b_Write_Labelled, gen_publication2014b_Review_Labelled, gen_publication2014b_PublicationStructure_Named},
    metadata=None
)
