...
class publication2014b_Progress(Labelled):
    ...
    def __init__(self, percent: int, time: int, Progress: "publication2014b_Paper" = None, publication2014b_Progress: "publication2014b_PublicationProcess" = None, progress: "publication2014b_Paper" = None):
...
class publication2014b_PublicationPhase:
    ...
    def __init__(self, name: str, minTime: int, maxTime: int, phaseParticipation: set["publication2014b_Researcher"] = None, publication2014b_PublicationPhase7: set["publication2014b_Rule"] = None, publication2014b_PublicationPhase11: "publication2014b_Sequence" = None, publication2014b_PublicationPhase14: "publication2014b_Sequence" = None, PublicationPhase: "publication2014b_Researcher" = None, publication2014b_PublicationPhase: "publication2014b_PublicationProcess" = None, publication2014b_PublicationPhase4: set["publication2014b_Sequence"] = None):
        self.name = name
...
class publication2014b_Sequence:
    ...
    def __init__(self, sequenceType: str, publication2014b_Sequence10: "publication2014b_PublicationPhase" = None, publication2014b_Sequence13: "publication2014b_PublicationPhase" = None, publication2014b_Sequence: "publication2014b_PublicationPhase" = None):
...
class publication2014b_Rule:
    ...
    def __init__(self, text: str, key: str, publication2014b_Rule8: "publication2014b_PublicationPhase" = None, publication2014b_Rule: "publication2014b_PublicationProcess" = None):
        self.text = text
        self.key = key
...
class publication2014b_PublicationStructure(Named):
    ...
    pass
class publication2014b_Paragraph(Counted, Named):

    def __init__(self, content: str, publication2014b_Paragraph: "publication2014b_Paper" = None, publication2014b_Paragraph25: set["publication2014b_ReviewNote"] = None, publication2014b_Paragraph32: "publication2014b_Write" = None):
