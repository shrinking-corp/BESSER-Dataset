...
public class ale_rCase  {
    ...
    private ale_rSwitch ale_rswitch;
    ...
    public ale_rSwitch getAle_rswitch() {
        return ale_rswitch;
    }

    public void setAle_rswitch(ale_rSwitch ale_rswitch) {
        this.ale_rswitch = ale_rswitch;
    }
    public ale_ExpressionStmt getAle_expressionstmt() {
        return ale_expressionstmt;
    }
