...
class ale_Call(Expression):
    ...
    def __init__(self, name: str, ale_Call96: set["ale_Expression"] = None, ale_Call: "ale_Expression" = None):
        self.name = name
...
class ale_rType:
    ...
    def __init__(self, name: str, ale_rType24: "ale_Attribute" = None, ale_rType28: "ale_VarDecl" = None, ale_rType: "ale_Operation" = None, ale_rType19: "ale_Variable" = None, ale_rType80: "ale_rCase" = None):
        self.name = name
