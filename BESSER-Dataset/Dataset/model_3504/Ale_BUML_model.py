...
# Classes
ale_Import = Class(name="ale_Import")
ale_Service = Class(name="ale_Service")
ale_BehavioredClass = Class(name="ale_BehavioredClass")
ale_Attribute = Class(name="ale_Attribute")
ale_Operation = Class(name="ale_Operation")
ale_ExtendedClass = Class(name="ale_ExtendedClass")
BehavioredClass = Class(name="BehavioredClass")
ale_RuntimeClass = Class(name="ale_RuntimeClass")
ale_Unit = Class(name="ale_Unit")
ale_rOpposite = Class(name="ale_rOpposite")
ale_ExpressionStmt = Class(name="ale_ExpressionStmt")
ale_Statement = Class(name="ale_Statement")
ale_VarDecl = Class(name="ale_VarDecl")
Statement = Class(name="Statement")
ale_Assign = Class(name="ale_Assign")
ale_Expression = Class(name="ale_Expression")
ale_Insert = Class(name="ale_Insert")
ale_Remove = Class(name="ale_Remove")
ale_Tag = Class(name="ale_Tag")
ale_rType = Class(name="ale_rType")
ale_Variable = Class(name="ale_Variable")
ale_Block = Class(name="ale_Block")
ale_If = Class(name="ale_If")
ale_While = Class(name="ale_While")
ale_rSwitch = Class(name="ale_rSwitch")
ale_ForEach = Class(name="ale_ForEach")
ale_Collection = Class(name="ale_Collection")
ale_EObject = Class(name="ale_EObject")
ale_binding = Class(name="ale_binding")
ale_typeLiteral = Class(name="ale_typeLiteral")
ale_rCase = Class(name="ale_rCase")
ale_Feature = Class(name="ale_Feature")
ale_Apply = Class(name="ale_Apply")
ale_Mult = Class(name="ale_Mult")
ale_Add = Class(name="ale_Add")
ale_literal = Class(name="ale_literal")
literal = Class(name="literal")
rType = Class(name="rType")
ale_classifierTypeRule = Class(name="ale_classifierTypeRule")
typeLiteral = Class(name="typeLiteral")
ale_Call = Class(name="ale_Call")
Expression = Class(name="Expression")
ale_Or = Class(name="ale_Or")
ale_Xor = Class(name="ale_Xor")
ale_Implie = Class(name="ale_Implie")
ale_Not = Class(name="ale_Not")
ale_Min = Class(name="ale_Min")
ale_Comp = Class(name="ale_Comp")
ale_And = Class(name="ale_And")
ale_Let = Class(name="ale_Let")
ale_String = Class(name="ale_String")
ale_Int = Class(name="ale_Int")
ale_Real = Class(name="ale_Real")
ale_True = Class(name="ale_True")
ale_False = Class(name="ale_False")
ale_Null = Class(name="ale_Null")
ale_Sequence = Class(name="ale_Sequence")
ale_OrderedSet = Class(name="ale_OrderedSet")
ale_VarRef = Class(name="ale_VarRef")
ale_Lit = Class(name="ale_Lit")
ale_ClassifierSetType = Class(name="ale_ClassifierSetType")
ale_Conditional = Class(name="ale_Conditional")
ale_ClassifierType = Class(name="ale_ClassifierType")
classifierTypeRule = Class(name="classifierTypeRule")
ale_Enum = Class(name="ale_Enum")
ale_StringType = Class(name="ale_StringType")
ale_IntType = Class(name="ale_IntType")
ale_RealType = Class(name="ale_RealType")
ale_BoolType = Class(name="ale_BoolType")
ale_SeqType = Class(name="ale_SeqType")
ale_SetType = Class(name="ale_SetType")
...
ale_Import.attributes={ale_Import_alias, ale_Import_name}
...
lambda_105: BinaryAssociation = BinaryAssociation(
    name="lambda_105",
    ends={
...
else_156: BinaryAssociation = BinaryAssociation(
    name="else_156",
    ends={
...
domain_model = DomainModel(
    name="ale",
    types={ale_Import, ale_Service, ale_BehavioredClass, ale_Attribute, ale_Operation, ale_ExtendedClass, BehavioredClass, ale_RuntimeClass, ale_Unit, ale_rOpposite, ale_ExpressionStmt, ale_Statement, ale_VarDecl, Statement, ale_Assign, ale_Expression, ale_Insert, ale_Remove, ale_Tag, ale_rType, ale_Variable, ale_Block, ale_If, ale_While, ale_rSwitch, ale_ForEach, ale_Collection, ale_EObject, ale_binding, ale_typeLiteral, ale_rCase, ale_Feature, ale_Apply, ale_Mult, ale_Add, ale_literal, literal, rType, ale_classifierTypeRule, typeLiteral, ale_Call, Expression, ale_Or, ale_Xor, ale_Implie, ale_Not, ale_Min, ale_Comp, ale_And, ale_Let, ale_String, ale_Int, ale_Real, ale_True, ale_False, ale_Null, ale_Sequence, ale_OrderedSet, ale_VarRef, ale_Lit, ale_ClassifierSetType, ale_Conditional, ale_ClassifierType, classifierTypeRule, ale_Enum, ale_StringType, ale_IntType, ale_RealType, ale_BoolType, ale_SeqType, ale_SetType},
    associations={imports0, services1, xtendedClasses3, attributes5, operations7, opposite20, type22, exp25, type27, exp29, target32, exp33, target36, exp38, tag9, type11, params13, body15, type17, block47, exp50, statements53, cond55, then57, else_60, nestedIf64, cond66, block68, target41, exp43, collection46, match81, value84, exp87, type89, exp90, paramVal71, cases73, other75, guard78, params95, target98, target100, varType102, lambda_105, params108, left111, right113, target93, left126, right128, left131, right133, left136, right138, left141, right143, exp146, left116, exp148, right118, left121, right123, then153, else_156, bindings159, exp161, params164, literal150, types172, cond151, params166, type168, type170},
    generalizations={gen_ale_ExtendedClass_BehavioredClass, gen_ale_RuntimeClass_BehavioredClass, gen_ale_VarDecl_Statement, gen_ale_Assign_Statement, gen_ale_Insert_Statement, gen_ale_Remove_Statement, gen_ale_If_Statement, gen_ale_While_Statement, gen_ale_ForEach_Statement, gen_ale_ExpressionStmt_Statement, gen_ale_Feature_Expression, gen_ale_Apply_Expression, gen_ale_Mult_Expression, gen_ale_typeLiteral_literal, gen_ale_typeLiteral_rType, gen_ale_classifierTypeRule_typeLiteral, gen_ale_Call_Expression, gen_ale_Or_Expression, gen_ale_Xor_Expression, gen_ale_Implie_Expression, gen_ale_Not_Expression, gen_ale_Add_Expression, gen_ale_Min_Expression, gen_ale_Comp_Expression, gen_ale_And_Expression, gen_ale_Let_Expression, gen_ale_String_literal, gen_ale_Int_literal, gen_ale_Real_literal, gen_ale_True_literal, gen_ale_False_literal, gen_ale_Null_literal, gen_ale_Sequence_literal, gen_ale_OrderedSet_literal, gen_ale_VarRef_Expression, gen_ale_Lit_Expression, gen_ale_ClassifierSetType_typeLiteral, gen_ale_Conditional_Expression, gen_ale_ClassifierType_classifierTypeRule, gen_ale_Enum_literal, gen_ale_StringType_typeLiteral, gen_ale_IntType_typeLiteral, gen_ale_RealType_typeLiteral, gen_ale_BoolType_typeLiteral, gen_ale_SeqType_typeLiteral, gen_ale_SetType_typeLiteral},
    metadata=None
)
