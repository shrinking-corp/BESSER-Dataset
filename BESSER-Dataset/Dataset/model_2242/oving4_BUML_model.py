...
# Classes
oving4_Root = Class(name="oving4_Root")
oving4_Department = Class(name="oving4_Department")
oving4_StudyProgram = Class(name="oving4_StudyProgram")
oving4_Project = Class(name="oving4_Project")
oving4_Course = Class(name="oving4_Course")
oving4_PersonRole = Class(name="oving4_PersonRole")
oving4_Evaluation = Class(name="oving4_Evaluation")
oving4_Person = Class(name="oving4_Person")
oving4_Precondition = Class(name="oving4_Precondition")
oving4_TimeTable = Class(name="oving4_TimeTable")
oving4_CourseWork = Class(name="oving4_CourseWork")
oving4_CourseInstance = Class(name="oving4_CourseInstance")
oving4_TimeTableElement = Class(name="oving4_TimeTableElement")
oving4_EvaluationElement = Class(name="oving4_EvaluationElement")
oving4_Exam = Class(name="oving4_Exam")
oving4_Assignment = Class(name="oving4_Assignment")
...
oving4_Course.attributes={oving4_Course_credits, oving4_Course_code, oving4_Course_content, oving4_Course_examEndDate, oving4_Course_examStartDate, oving4_Course_name}
...
oving4_Evaluation.attributes={oving4_Evaluation_totalPercentageResult, oving4_Evaluation_creditsReceived, oving4_Evaluation_completed, oving4_Evaluation_description}
...
oving4_Person_m_signUpForExam: Method = Method(name="signUpForExam", parameters={Parameter(name='oving4_course', type=StringType)}, type=BooleanType)
oving4_Person_m_cancelExam: Method = Method(name="cancelExam", parameters={Parameter(name='oving4_course', type=StringType)}, type=BooleanType)
oving4_Person_m_takeExam: Method = Method(name="takeExam", parameters={Parameter(name='oving4_course', type=StringType), Parameter(name='oving4_percentageResult', type=StringType)}, type=BooleanType)
oving4_Person.attributes={oving4_Person_first_name, oving4_Person_studyCredits, oving4_Person_last_name, oving4_Person_name}
oving4_Person.methods={oving4_Person_m_signUpForExam, oving4_Person_m_takeExam, oving4_Person_m_cancelExam}
...
oving4_CourseWork.attributes={oving4_CourseWork_isMandatory, oving4_CourseWork_type, oving4_CourseWork_name}
...
oving4_TimeTableElement.attributes={oving4_TimeTableElement_room, oving4_TimeTableElement_durationInMinutes, oving4_TimeTableElement_date}
...
oving4_EvaluationElement.attributes={oving4_EvaluationElement_percentageResult, oving4_EvaluationElement_type, oving4_EvaluationElement_weight, oving4_EvaluationElement_attended}
...
oving4_Exam.attributes={oving4_Exam_startDate, oving4_Exam_previousStartDate, oving4_Exam_previousEndDate, oving4_Exam_endDate}
...
domain_model = DomainModel(
    name="oving4",
    types={oving4_Root, oving4_Department, oving4_StudyProgram, oving4_Project, oving4_Course, oving4_PersonRole, oving4_Evaluation, oving4_Person, oving4_Precondition, oving4_TimeTable, oving4_CourseWork, oving4_CourseInstance, oving4_TimeTableElement, oving4_EvaluationElement, oving4_Exam, oving4_Assignment, StudyProgramType, RoleType, EvaluationType, CourseWorkType},
    associations={ownsDepartment0, ownsStudyProgram3, ownsProject5, ownsCourse7, hasEmployee9, containsCourse10, hasEmployee11, hasRole13, hasEvaluation15, ownsPerson1, studyprogram17, hasPrecondition18, hasTimeTable20, ownedBy21, containsCourseWork23, hasMember24, containsEvaluation26, person29, employedOfStudyProgram30, memberOfCourse32, courseInstance16, employedByDepartment34, containsTimeTableElement36, usedByStudyProgram37, ownedByCourseInstance40, personEvaluated42, containsElement44, courseInstance45, preconditionCourse47, usedByCourseWork50, containsProject54, containsAssignment55, belongsToEvaluationElement56, belongsToEvaluationel57, hasMembers59, belongToEvEl61, containsExam53},
    generalizations={},
    metadata=None
)
