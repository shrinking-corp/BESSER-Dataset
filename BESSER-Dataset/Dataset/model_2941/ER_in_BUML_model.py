...
domain_model = DomainModel(
    name="ER",
    types={ER_Feature, ER_Attribute, Feature, ER_WeakReference, Reference, ER_StrongReference, ER_ERModel, NamedElement, ER_EntityType, ER_NamedElement, ER_Reference},
    associations={features1, entities0, type3},
    generalizations={gen_ER_EntityType_NamedElement, gen_ER_Feature_NamedElement, gen_ER_Attribute_Feature, gen_ER_WeakReference_Reference, gen_ER_ERModel_NamedElement, gen_ER_StrongReference_Reference, gen_ER_Reference_Feature},
    metadata=None
)
