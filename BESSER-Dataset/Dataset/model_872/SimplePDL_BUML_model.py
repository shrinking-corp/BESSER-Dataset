...
domain_model = DomainModel(
    name="simplepdl",
    types={simplepdl_ProcessElement, simplepdl_WorkDefinition, ProcessElement, simplepdl_WorkSequence, simplepdl_Process, simplepdl_Guidance, simplepdl_Ressource, simplepdl_RessourceLink, WorkSequenceType},
    associations={processElements0, linksToPredecessors1, linksToSuccessors2, predecessor4, successor5, element7, workDef9, ressource10},
