...
class ctmc_State(IDBase):
    ...
    def __init__(self, name: str, exitRate: float, from_: set["ctmc_Transition"] = None, state: set["ctmc_Label"] = None, State: "ctmc_Transition" = None, State10: "ctmc_Transition" = None, State12: "ctmc_Label" = None, ctmc_State: "ctmc_CTMC" = None, ctmc_State3: "ctmc_CTMC" = None, to: set["ctmc_Transition"] = None):
        self.name = name
