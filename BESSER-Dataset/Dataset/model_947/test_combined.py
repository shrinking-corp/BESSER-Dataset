...
def test_hyp_graph_edge_relation_setter(instance):
...
@given(instance=Graph_Edge_strategy)
def test_hyp_graph_edge_degree_setter(instance):
...
def test_Graph_Edge_degree_value_roundtrip():
    instance = Graph_Edge(degree=7, relation="sample_text")
    assert instance.degree == 7
    instance.degree = 13
    assert instance.degree == 13


def test_Graph_Edge_relation_value_roundtrip():
    instance = Graph_Edge(degree=7, relation="sample_text")
...
def test_assoc_incoming2_link_reassign_clear():
    ...
    b1 = Graph_Edge(degree=7, relation="sample_text")
    b2 = Graph_Edge(degree=13, relation="sample_text_2")
...
Graph_Edge_strategy = st.builds(Graph_Edge, degree=st.integers(), relation=safe_text)
@given(instance=Graph_Edge_strategy)
