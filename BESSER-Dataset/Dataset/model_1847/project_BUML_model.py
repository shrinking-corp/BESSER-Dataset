...
project_Property = Class(name="project_Property")
project_Account = Class(name="project_Account")
Property_ = Class(name="Property")
AccountAttribute = Class(name="AccountAttribute")
project_AccountAttribute = Class(name="project_AccountAttribute")
project_AccountPrefix = Class(name="project_AccountPrefix")
IncludePropertiesAttribute = Class(name="IncludePropertiesAttribute")
project_Global = Class(name="project_Global")
project_Interval2 = Class(name="project_Interval2")
project_ProjectAttribute = Class(name="project_ProjectAttribute")
project_Task = Class(name="project_Task")
TaskAttribute = Class(name="TaskAttribute")
project_TaskAttribute = Class(name="project_TaskAttribute")
project_Report = Class(name="project_Report")
...
project_AccountReport = Class(name="project_AccountReport")
ReportAttribute = Class(name="ReportAttribute")
project_AccountRoot = Class(name="project_AccountRoot")
project_IcalReportAttribute = Class(name="project_IcalReportAttribute")
project_Export = Class(name="project_Export")
project_ExportAttribute = Class(name="project_ExportAttribute")
project_Resource = Class(name="project_Resource")
ResourceAttribute = Class(name="ResourceAttribute")
project_ResourceAttribute = Class(name="project_ResourceAttribute")
project_ReportAttribute = Class(name="project_ReportAttribute")
project_IcalReport = Class(name="project_IcalReport")
project_Navigator = Class(name="project_Navigator")
project_NavigatorAttribute = Class(name="project_NavigatorAttribute")
project_NewTask = Class(name="project_NewTask")
TimesheetAttribute = Class(name="TimesheetAttribute")
project_NewTaskAttribute = Class(name="project_NewTaskAttribute")
project_NikuReport = Class(name="project_NikuReport")
project_Allocate = Class(name="project_Allocate")
project_AllocateResource = Class(name="project_AllocateResource")
project_AllocateResourceAttribute = Class(name="project_AllocateResourceAttribute")
project_Balance = Class(name="project_Balance")
project_Booking = Class(name="project_Booking")
project_Interval4 = Class(name="project_Interval4")
project_BookingTask = Class(name="project_BookingTask")
project_BookingResource = Class(name="project_BookingResource")
project_NikuReportAttribute = Class(name="project_NikuReportAttribute")
project_Alert = Class(name="project_Alert")
project_Alternative = Class(name="project_Alternative")
AllocateResourceAttribute = Class(name="AllocateResourceAttribute")
project_Author = Class(name="project_Author")
StatusStatusSheetAttribute = Class(name="StatusStatusSheetAttribute")
project_Center = Class(name="project_Center")
project_Charge = Class(name="project_Charge")
project_ChargeSet = Class(name="project_ChargeSet")
project_AccountShare = Class(name="project_AccountShare")
project_Columns = Class(name="project_Columns")
project_Column = Class(name="project_Column")
project_Complete = Class(name="project_Complete")
project_Copyright = Class(name="project_Copyright")
project_Credit = Class(name="project_Credit")
project_Caption = Class(name="project_Caption")
project_CellColor = Class(name="project_CellColor")
ColumnAttribute = Class(name="ColumnAttribute")
project_LogicalExpression = Class(name="project_LogicalExpression")
project_RGB = Class(name="project_RGB")
project_CellText = Class(name="project_CellText")
project_Depends = Class(name="project_Depends")
project_Details = Class(name="project_Details")
StatusTimesheetAttribute = Class(name="StatusTimesheetAttribute")
project_Duration = Class(name="project_Duration")
project_DurationQuantity = Class(name="project_DurationQuantity")
project_Efficiency = Class(name="project_Efficiency")
project_Effort = Class(name="project_Effort")
project_Email = Class(name="project_Email")
project_End = Class(name="project_End")
...
project_Currency = Class(name="project_Currency")
ProjectAttribute = Class(name="ProjectAttribute")
project_CurrencyFormat = Class(name="project_CurrencyFormat")
project_DailyMax = Class(name="project_DailyMax")
LimitsAttribute = Class(name="LimitsAttribute")
project_DailyMin = Class(name="project_DailyMin")
project_DailyWorkingHours = Class(name="project_DailyWorkingHours")
project_Definitions = Class(name="project_Definitions")
ExportAttribute = Class(name="ExportAttribute")
project_ExtendedResourceAttribute = Class(name="project_ExtendedResourceAttribute")
project_ExtendTask = Class(name="project_ExtendTask")
project_ExtendedTaskAttribute = Class(name="project_ExtendedTaskAttribute")
project_Fail = Class(name="project_Fail")
project_Flags = Class(name="project_Flags")
project_EndCredit = Class(name="project_EndCredit")
project_Epilog = Class(name="project_Epilog")
project_Extend = Class(name="project_Extend")
project_ExtendResource = Class(name="project_ExtendResource")
project_GapDuration = Class(name="project_GapDuration")
project_GapLength = Class(name="project_GapLength")
project_HAlign = Class(name="project_HAlign")
project_Header = Class(name="project_Header")
project_Headline = Class(name="project_Headline")
project_HideAccount = Class(name="project_HideAccount")
project_HideJournalEntry = Class(name="project_HideJournalEntry")
project_HideReport = Class(name="project_HideReport")
NavigatorAttribute = Class(name="NavigatorAttribute")
project_FontColor = Class(name="project_FontColor")
project_Footer = Class(name="project_Footer")
project_Formats = Class(name="project_Formats")
project_Function = Class(name="project_Function")
project_Scenario = Class(name="project_Scenario")
project_Include = Class(name="project_Include")
project_IncludeProperties = Class(name="project_IncludeProperties")
project_IncludePropertiesAttribute = Class(name="project_IncludePropertiesAttribute")
project_Interval1 = Class(name="project_Interval1")
project_HideResource = Class(name="project_HideResource")
project_HideTask = Class(name="project_HideTask")
project_Interval3 = Class(name="project_Interval3")
project_JournalEntry = Class(name="project_JournalEntry")
project_Summary = Class(name="project_Summary")
project_JournalAttributes = Class(name="project_JournalAttributes")
project_Limits = Class(name="project_Limits")
project_LimitsAttribute = Class(name="project_LimitsAttribute")
project_ListItem = Class(name="project_ListItem")
project_ListType = Class(name="project_ListType")
project_JournalMode = Class(name="project_JournalMode")
project_Left = Class(name="project_Left")
project_Length = Class(name="project_Length")
project_Managers = Class(name="project_Managers")
project_Mandatory = Class(name="project_Mandatory")
project_MaxEnd = Class(name="project_MaxEnd")
project_Maximum = Class(name="project_Maximum")
project_MaxStart = Class(name="project_MaxStart")
project_LoadUnit = Class(name="project_LoadUnit")
project_Macro = Class(name="project_Macro")
project_MinStart = Class(name="project_MinStart")
project_MonthlyMax = Class(name="project_MonthlyMax")
project_MonthlyMin = Class(name="project_MonthlyMin")
project_Note = Class(name="project_Note")
project_Now = Class(name="project_Now")
project_NumberFormat = Class(name="project_NumberFormat")
project_Milestone = Class(name="project_Milestone")
project_Minimum = Class(name="project_Minimum")
project_MinEnd = Class(name="project_MinEnd")
project_Persistent = Class(name="project_Persistent")
project_Precedes = Class(name="project_Precedes")
project_Period = Class(name="project_Period")
project_ProjectIds = Class(name="project_ProjectIds")
project_Prolog = Class(name="project_Prolog")
project_PurgeReport = Class(name="project_PurgeReport")
project_Priority = Class(name="project_Priority")
project_ProjectId = Class(name="project_ProjectId")
project_PurgeTask = Class(name="project_PurgeTask")
project_PurgeResource = Class(name="project_PurgeResource")
project_ReportPrefix = Class(name="project_ReportPrefix")
project_ResourceAttributes = Class(name="project_ResourceAttributes")
project_ResourcePrefix = Class(name="project_ResourcePrefix")
project_ResourceReport = Class(name="project_ResourceReport")
project_Rate = Class(name="project_Rate")
project_Remaining = Class(name="project_Remaining")
project_Right = Class(name="project_Right")
project_RollupAccount = Class(name="project_RollupAccount")
project_RollupResource = Class(name="project_RollupResource")
project_RollupTask = Class(name="project_RollupTask")
project_Scale = Class(name="project_Scale")
project_ResourceRoot = Class(name="project_ResourceRoot")
project_Responsible = Class(name="project_Responsible")
project_Scenarios = Class(name="project_Scenarios")
project_Scheduled = Class(name="project_Scheduled")
project_Scheduling = Class(name="project_Scheduling")
project_Select = Class(name="project_Select")
project_SelfContained = Class(name="project_SelfContained")
project_Shift = Class(name="project_Shift")
project_Vacation = Class(name="project_Vacation")
project_ScenarioIcal = Class(name="project_ScenarioIcal")
project_Shifts = Class(name="project_Shifts")
ShiftsResource = Class(name="ShiftsResource")
ShiftsTask = Class(name="ShiftsTask")
project_ShiftsLimit = Class(name="project_ShiftsLimit")
project_ShiftsAllocate = Class(name="project_ShiftsAllocate")
project_ShiftsResource = Class(name="project_ShiftsResource")
project_ShiftsTask = Class(name="project_ShiftsTask")
project_ShortTimeFormat = Class(name="project_ShortTimeFormat")
project_WorkingHours = Class(name="project_WorkingHours")
project_ShiftTimesheet = Class(name="project_ShiftTimesheet")
project_Start = Class(name="project_Start")
project_StatusStatusSheet = Class(name="project_StatusStatusSheet")
TaskStatusSheetAttribute = Class(name="TaskStatusSheetAttribute")
project_StatusStatusSheetAttribute = Class(name="project_StatusStatusSheetAttribute")
project_Sort = Class(name="project_Sort")
...
project_Criterion = Class(name="project_Criterion")
project_SortAccounts = Class(name="project_SortAccounts")
project_SortJournalEntries = Class(name="project_SortJournalEntries")
project_SortResources = Class(name="project_SortResources")
project_SortTasks = Class(name="project_SortTasks")
project_StatusTimesheetAttribute = Class(name="project_StatusTimesheetAttribute")
project_StatusSheet = Class(name="project_StatusSheet")
project_StatusSheetAttribute = Class(name="project_StatusSheetAttribute")
project_StatusSheetReport = Class(name="project_StatusSheetReport")
project_StatusTimesheet = Class(name="project_StatusTimesheet")
project_SupplementResource = Class(name="project_SupplementResource")
project_SupplementTask = Class(name="project_SupplementTask")
project_TagFile = Class(name="project_TagFile")
project_StatusSheetReportAttribute = Class(name="project_StatusSheetReportAttribute")
project_SupplementAccount = Class(name="project_SupplementAccount")
project_SupplementReport = Class(name="project_SupplementReport")
project_TaskStatusSheetAttribute = Class(name="project_TaskStatusSheetAttribute")
project_TaskTimesheet = Class(name="project_TaskTimesheet")
project_TaskTimesheetAttribute = Class(name="project_TaskTimesheetAttribute")
project_TaskAttributes = Class(name="project_TaskAttributes")
project_TaskStatusSheet = Class(name="project_TaskStatusSheet")
StatusSheetAttribute = Class(name="StatusSheetAttribute")
project_TimeFormat = Class(name="project_TimeFormat")
project_Timeoff = Class(name="project_Timeoff")
project_Timesheet = Class(name="project_Timesheet")
project_TimesheetAttribute = Class(name="project_TimesheetAttribute")
project_TimesheetReport = Class(name="project_TimesheetReport")
project_TimesheetReportAttribute = Class(name="project_TimesheetReportAttribute")
project_TaskPrefix = Class(name="project_TaskPrefix")
project_TaskReport = Class(name="project_TaskReport")
project_TaskRoot = Class(name="project_TaskRoot")
project_TextReport = Class(name="project_TextReport")
project_TrackingScenario = Class(name="project_TrackingScenario")
project_TreeLevel = Class(name="project_TreeLevel")
project_Warn = Class(name="project_Warn")
project_Timezone = Class(name="project_Timezone")
project_TimingResolution = Class(name="project_TimingResolution")
project_Title = Class(name="project_Title")
project_ToolTip = Class(name="project_ToolTip")
project_Weekdays = Class(name="project_Weekdays")
project_WorkHours = Class(name="project_WorkHours")
project_YearlyWorkingDays = Class(name="project_YearlyWorkingDays")
project_ColumnAttribute = Class(name="project_ColumnAttribute")
project_WeekStarts = Class(name="project_WeekStarts")
project_WeeklyMax = Class(name="project_WeeklyMax")
project_WeeklyMin = Class(name="project_WeeklyMin")
project_Width = Class(name="project_Width")
project_Work = Class(name="project_Work")
WeeklyMin = Class(name="WeeklyMin")
project_LimitAttribute = Class(name="project_LimitAttribute")
GapDuration = Class(name="GapDuration")
GapLength = Class(name="GapLength")
project_Limit = Class(name="project_Limit")
...
project_RealFormat = Class(name="project_RealFormat")
CurrencyFormat = Class(name="CurrencyFormat")
NumberFormat = Class(name="NumberFormat")
project_TaskDependency = Class(name="project_TaskDependency")
...
project_RichText = Class(name="project_RichText")
...
project_Defintions = Class(name="project_Defintions")
Definitions = Class(name="Definitions")
project_XBinaryOperation = Class(name="project_XBinaryOperation")
LogicalExpression = Class(name="LogicalExpression")
project_JvmIdentifiableElement = Class(name="project_JvmIdentifiableElement")
project_LogicalFunctionExpression = Class(name="project_LogicalFunctionExpression")
project_LogicalBooleanLiteral = Class(name="project_LogicalBooleanLiteral")
project_LogicalNumeralLiteral = Class(name="project_LogicalNumeralLiteral")
project_LogicalStringLiteral = Class(name="project_LogicalStringLiteral")
project_LogicalDateLiteral = Class(name="project_LogicalDateLiteral")
project_LogicalAbsoluteIdExression = Class(name="project_LogicalAbsoluteIdExression")
...
project_Account.attributes={project_Account_name, project_Account_id}
...
project_Report.attributes={project_Report_id, project_Report_name}
...
project_Export.attributes={project_Export_id, project_Export_filename}
...
project_Resource.attributes={project_Resource_name, project_Resource_id}
...
project_NewTask.attributes={project_NewTask_id, project_NewTask_text}
...
project_Booking.attributes={project_Booking_sloppy, project_Booking_overtime}
...
project_Charge.attributes={project_Charge_amount, project_Charge_applies}
...
project_Credit.attributes={project_Credit_amount, project_Credit_description, project_Credit_date}
...
project_Extend.attributes={project_Extend_scenariospecific, project_Extend_name, project_Extend_inherit, project_Extend_id}
...
project_Function.attributes={project_Function_level, project_Function_distance, project_Function_date, project_Function_parentId}
...
project_Scenario.attributes={project_Scenario_id, project_Scenario_name, project_Scenario_active}
...
project_JournalEntry.attributes={project_JournalEntry_date, project_JournalEntry_headline}
...
project_JournalAttributes__property: Property = Property(name="_property", type=BooleanType)
...
project_JournalAttributes.attributes={project_JournalAttributes_none, project_JournalAttributes_author, project_JournalAttributes__property, project_JournalAttributes_headline, project_JournalAttributes_all, project_JournalAttributes_timesheet, project_JournalAttributes_propertyid, project_JournalAttributes_summary, project_JournalAttributes_details, project_JournalAttributes_flags, project_JournalAttributes_date}
...
project_ResourceAttributes.attributes={project_ResourceAttributes_vacation, project_ResourceAttributes_workingHours, project_ResourceAttributes_all, project_ResourceAttributes_booking, project_ResourceAttributes_none}
...
project_Shift.attributes={project_Shift_timezone, project_Shift_name, project_Shift_replace, project_Shift_id}
...
project_TagFile.attributes={project_TagFile_id, project_TagFile_filename}
...
project_TaskAttributes.attributes={project_TaskAttributes_minstart, project_TaskAttributes_minend, project_TaskAttributes_all, project_TaskAttributes_booking, project_TaskAttributes_note, project_TaskAttributes_maxstart, project_TaskAttributes_priority, project_TaskAttributes_complete, project_TaskAttributes_none, project_TaskAttributes_responsible, project_TaskAttributes_depends, project_TaskAttributes_flags, project_TaskAttributes_maxend}
...
project_Weekdays.attributes={project_Weekdays_last, project_Weekdays_first}
...
project_WorkHours.attributes={project_WorkHours_stop, project_WorkHours_start}
...
project_Work.attributes={project_Work_value, project_Work_unit}
...
project_LimitAttribute.attributes={project_LimitAttribute_end, project_LimitAttribute_start}
...
project_RealFormat.attributes={project_RealFormat_thousandsSeparator, project_RealFormat_negativeSuffix, project_RealFormat_fractionSeparator, project_RealFormat_fractionDigits, project_RealFormat_negativePrefix}
...
project_Defintions.attributes={project_Defintions_project, project_Defintions_tasks, project_Defintions_projectids, project_Defintions_resources, project_Defintions_flags}
...
domain_model = DomainModel(
    name="project",
    types={project_Project, project_Property, project_Account, Property_, AccountAttribute, project_AccountAttribute, project_AccountPrefix, IncludePropertiesAttribute, project_Global, project_Interval2, project_ProjectAttribute, project_Task, TaskAttribute, project_TaskAttribute, project_Report, AccountReport, ResourceReport, TaskReport, TextReport, project_AccountReport, ReportAttribute, project_AccountRoot, project_IcalReportAttribute, project_Export, project_ExportAttribute, project_Resource, ResourceAttribute, project_ResourceAttribute, project_ReportAttribute, project_IcalReport, project_Navigator, project_NavigatorAttribute, project_NewTask, TimesheetAttribute, project_NewTaskAttribute, project_NikuReport, project_Allocate, project_AllocateResource, project_AllocateResourceAttribute, project_Balance, project_Booking, project_Interval4, project_BookingTask, project_BookingResource, project_NikuReportAttribute, project_Alert, project_Alternative, AllocateResourceAttribute, project_Author, StatusStatusSheetAttribute, project_Center, project_Charge, project_ChargeSet, project_AccountShare, project_Columns, project_Column, project_Complete, project_Copyright, project_Credit, project_Caption, project_CellColor, ColumnAttribute, project_LogicalExpression, project_RGB, project_CellText, project_Depends, project_Details, StatusTimesheetAttribute, project_Duration, project_DurationQuantity, project_Efficiency, project_Effort, project_Email, project_End, IcalReportAttribute, NewTaskAttribute, NikuReportAttribute, StatusSheetReportAttribute, TaskTimesheetAttribute, TimesheetReportAttribute, project_Currency, ProjectAttribute, project_CurrencyFormat, project_DailyMax, LimitsAttribute, project_DailyMin, project_DailyWorkingHours, project_Definitions, ExportAttribute, project_ExtendedResourceAttribute, project_ExtendTask, project_ExtendedTaskAttribute, project_Fail, project_Flags, project_EndCredit, project_Epilog, project_Extend, project_ExtendResource, project_GapDuration, project_GapLength, project_HAlign, project_Header, project_Headline, project_HideAccount, project_HideJournalEntry, project_HideReport, NavigatorAttribute, project_FontColor, project_Footer, project_Formats, project_Function, project_Scenario, project_Include, project_IncludeProperties, project_IncludePropertiesAttribute, project_Interval1, project_HideResource, project_HideTask, project_Interval3, project_JournalEntry, project_Summary, project_JournalAttributes, project_Limits, project_LimitsAttribute, project_ListItem, project_ListType, project_JournalMode, project_Left, project_Length, project_Managers, project_Mandatory, project_MaxEnd, project_Maximum, project_MaxStart, project_LoadUnit, project_Macro, project_MinStart, project_MonthlyMax, project_MonthlyMin, project_Note, project_Now, project_NumberFormat, project_Milestone, project_Minimum, project_MinEnd, project_Persistent, project_Precedes, project_Period, project_ProjectIds, project_Prolog, project_PurgeReport, project_Priority, project_ProjectId, project_PurgeTask, project_PurgeResource, project_ReportPrefix, project_ResourceAttributes, project_ResourcePrefix, project_ResourceReport, project_Rate, project_Remaining, project_Right, project_RollupAccount, project_RollupResource, project_RollupTask, project_Scale, project_ResourceRoot, project_Responsible, project_Scenarios, project_Scheduled, project_Scheduling, project_Select, project_SelfContained, project_Shift, project_Vacation, project_ScenarioIcal, project_Shifts, ShiftsResource, ShiftsTask, project_ShiftsLimit, project_ShiftsAllocate, project_ShiftsResource, project_ShiftsTask, project_ShortTimeFormat, project_WorkingHours, project_ShiftTimesheet, project_Start, project_StatusStatusSheet, TaskStatusSheetAttribute, project_StatusStatusSheetAttribute, project_Sort, SortAccounts, SortJournalEntries, SortResources, SortTasks, project_Criterion, project_SortAccounts, project_SortJournalEntries, project_SortResources, project_SortTasks, project_StatusTimesheetAttribute, project_StatusSheet, project_StatusSheetAttribute, project_StatusSheetReport, project_StatusTimesheet, project_SupplementResource, project_SupplementTask, project_TagFile, project_StatusSheetReportAttribute, project_SupplementAccount, project_SupplementReport, project_TaskStatusSheetAttribute, project_TaskTimesheet, project_TaskTimesheetAttribute, project_TaskAttributes, project_TaskStatusSheet, StatusSheetAttribute, project_TimeFormat, project_Timeoff, project_Timesheet, project_TimesheetAttribute, project_TimesheetReport, project_TimesheetReportAttribute, project_TaskPrefix, project_TaskReport, project_TaskRoot, project_TextReport, project_TrackingScenario, project_TreeLevel, project_Warn, project_Timezone, project_TimingResolution, project_Title, project_ToolTip, project_Weekdays, project_WorkHours, project_YearlyWorkingDays, project_ColumnAttribute, project_WeekStarts, project_WeeklyMax, project_WeeklyMin, project_Width, project_Work, WeeklyMin, project_LimitAttribute, GapDuration, GapLength, project_Limit, DailyMax, DailyMin, Maximum, Minimum, MonthlyMax, MonthlyMin, WeeklyMax, project_RealFormat, CurrencyFormat, NumberFormat, project_TaskDependency, Depends, Precedes, Headline, Left, ListItem, Prolog, Right, Summary, project_RichText, Caption, Center, Details, Epilog, Footer, Header, project_Defintions, Definitions, project_XBinaryOperation, LogicalExpression, project_JvmIdentifiableElement, project_LogicalFunctionExpression, project_LogicalBooleanLiteral, project_LogicalNumeralLiteral, project_LogicalStringLiteral, project_LogicalDateLiteral, project_LogicalAbsoluteIdExression, PurgeReportAttribute, PurgeTaskAttribute, PurgeResourceAttribute, ChargeApplies, Justification, JournalModeValue, JournalEntrySortCriterion, ListTypeValues, CriterionDirection, YesNo, ReportFormat, ScaleResolution, LoadDisplayUnit, SelectArgument, ColumnId, AlertLevel, DependsPolicy, SchedulingPolicy, Weekday, WorkQuantityUnit, TimeUnit},
    associations={project0, properties1, attributes3, interval8, attributes10, attributes12, account4, account6, attributes14, attributes15, attributes16, attributes13, attributes23, attributes24, resources17, resource18, attributes21, cost30, revenue32, interval35, resource36, booking38, attributes25, resources26, resource28, expresssion49, accountShares51, columns52, task41, booking43, expression46, color47, duration53, effort54, extend57, extends59, extend61, expression63, extends56, scenario65, task66, resource69, expression72, expression78, attributes80, expression74, expression76, duration83, duration86, duration81, alert91, author92, details95, summary97, duration88, length99, attributes101, resources102, period104, remaining106, report108, resource110, expression116, expression118, expression120, resource112, resources114, scenarios127, vacation129, scenario123, scenario125, limits137, shift138, limit141, shift144, intervals146, shift131, workingHours133, shift135, criteria149, attributes151, resource152, interval154, attributes157, attributes150, report165, attributes167, resource170, attributes172, task175, attributes177, attributes159, account160, attributes162, task191, attributes193, task195, attributes197, hideResource180, hideTask182, rollupResource185, rollupTask188, resource203, interval205, attributes208, attributes210, task199, task201, expression211, scenario213, intervals215, weekdays220, hours222, account224, attribute227, expression218, duration229, attributes231, task239, gapDuration241, gapLength243, period233, resources236, leftOperand245, feature247, rightOperand249, function252},
    generalizations={gen_project_Account_Property, gen_project_Account_AccountAttribute, gen_project_AccountPrefix_IncludePropertiesAttribute, gen_project_Task_Property, gen_project_Task_TaskAttribute, gen_project_Report_AccountReport, gen_project_Report_ResourceReport, gen_project_Report_TaskReport, gen_project_Report_TextReport, gen_project_AccountReport_Property, gen_project_AccountReport_ReportAttribute, gen_project_AccountRoot_ReportAttribute, gen_project_Export_Property, gen_project_Resource_Property, gen_project_Resource_ResourceAttribute, gen_project_IcalReport_Property, gen_project_Navigator_Property, gen_project_NewTask_TimesheetAttribute, gen_project_NikuReport_Property, gen_project_Allocate_TaskAttribute, gen_project_Balance_Property, gen_project_Balance_ReportAttribute, gen_project_BookingTask_TaskAttribute, gen_project_BookingResource_ResourceAttribute, gen_project_Alternative_AllocateResourceAttribute, gen_project_Author_StatusStatusSheetAttribute, gen_project_Center_ReportAttribute, gen_project_Charge_TaskAttribute, gen_project_ChargeSet_TaskAttribute, gen_project_Columns_ReportAttribute, gen_project_Complete_TaskAttribute, gen_project_Copyright_Property, gen_project_Credit_AccountAttribute, gen_project_Caption_ReportAttribute, gen_project_CellColor_ColumnAttribute, gen_project_CellText_ColumnAttribute, gen_project_Depends_TaskAttribute, gen_project_Details_StatusStatusSheetAttribute, gen_project_Details_StatusTimesheetAttribute, gen_project_Duration_TaskAttribute, gen_project_Efficiency_ResourceAttribute, gen_project_Effort_TaskAttribute, gen_project_Email_ResourceAttribute, gen_project_End_TaskAttribute, gen_project_End_ReportAttribute, gen_project_End_IcalReportAttribute, gen_project_End_ExportAttribute, gen_project_End_NewTaskAttribute, gen_project_End_NikuReportAttribute, gen_project_End_StatusSheetReportAttribute, gen_project_End_TaskTimesheetAttribute, gen_project_End_TimesheetReportAttribute, gen_project_End_ColumnAttribute, gen_project_Currency_ProjectAttribute, gen_project_CurrencyFormat_ProjectAttribute, gen_project_CurrencyFormat_ReportAttribute, gen_project_DailyMax_LimitsAttribute, gen_project_DailyMin_LimitsAttribute, gen_project_DailyWorkingHours_ProjectAttribute, gen_project_Definitions_ExportAttribute, gen_project_ExtendedResourceAttribute_ResourceAttribute, gen_project_ExtendTask_ProjectAttribute, gen_project_ExtendedTaskAttribute_TaskAttribute, gen_project_Fail_TaskAttribute, gen_project_Fail_ResourceAttribute, gen_project_Flags_Property, gen_project_Flags_AccountAttribute, gen_project_Flags_TaskAttribute, gen_project_Flags_ReportAttribute, gen_project_Flags_ResourceAttribute, gen_project_Flags_StatusStatusSheetAttribute, gen_project_Flags_StatusTimesheetAttribute, gen_project_EndCredit_TaskAttribute, gen_project_Epilog_ReportAttribute, gen_project_ExtendResource_ProjectAttribute, gen_project_HAlign_ColumnAttribute, gen_project_Header_ReportAttribute, gen_project_Headline_ReportAttribute, gen_project_Headline_NikuReportAttribute, gen_project_HideAccount_ReportAttribute, gen_project_HideJournalEntry_ReportAttribute, gen_project_HideJournalEntry_IcalReportAttribute, gen_project_FontColor_ColumnAttribute, gen_project_Footer_ReportAttribute, gen_project_Formats_ReportAttribute, gen_project_Formats_NikuReportAttribute, gen_project_Include_ProjectAttribute, gen_project_IncludeProperties_Property, gen_project_HideReport_NavigatorAttribute, gen_project_HideResource_ReportAttribute, gen_project_HideResource_IcalReportAttribute, gen_project_HideResource_ExportAttribute, gen_project_HideResource_NikuReportAttribute, gen_project_HideResource_StatusSheetReportAttribute, gen_project_HideResource_TimesheetReportAttribute, gen_project_HideTask_ReportAttribute, gen_project_HideTask_IcalReportAttribute, gen_project_HideTask_ExportAttribute, gen_project_HideTask_NikuReportAttribute, gen_project_HideTask_StatusSheetReportAttribute, gen_project_JournalEntry_ProjectAttribute, gen_project_JournalEntry_TaskAttribute, gen_project_JournalEntry_ResourceAttribute, gen_project_JournalAttributes_ReportAttribute, gen_project_Limits_Property, gen_project_Limits_TaskAttribute, gen_project_Limits_ResourceAttribute, gen_project_ListItem_ColumnAttribute, gen_project_ListType_ColumnAttribute, gen_project_JournalMode_ReportAttribute, gen_project_Left_ReportAttribute, gen_project_Length_TaskAttribute, gen_project_Macro_Property, gen_project_Managers_ResourceAttribute, gen_project_Mandatory_AllocateResourceAttribute, gen_project_MaxEnd_TaskAttribute, gen_project_Maximum_LimitsAttribute, gen_project_MaxStart_TaskAttribute, gen_project_LoadUnit_ReportAttribute, gen_project_MinStart_TaskAttribute, gen_project_MonthlyMax_LimitsAttribute, gen_project_MonthlyMin_LimitsAttribute, gen_project_Note_TaskAttribute, gen_project_Now_ProjectAttribute, gen_project_NumberFormat_ProjectAttribute, gen_project_NumberFormat_ReportAttribute, gen_project_Milestone_TaskAttribute, gen_project_Minimum_LimitsAttribute, gen_project_MinEnd_TaskAttribute, gen_project_Period_ColumnAttribute, gen_project_Persistent_AllocateResourceAttribute, gen_project_Precedes_TaskAttribute, gen_project_NumberFormat_NikuReportAttribute, gen_project_Period_TaskAttribute, gen_project_Period_ReportAttribute, gen_project_Period_IcalReportAttribute, gen_project_Period_ExportAttribute, gen_project_Period_NikuReportAttribute, gen_project_Period_StatusSheetReportAttribute, gen_project_Period_TimesheetReportAttribute, gen_project_ProjectIds_Property, gen_project_Prolog_ReportAttribute, gen_project_PurgeReport_ReportAttribute, gen_project_Priority_TaskAttribute, gen_project_Priority_NewTaskAttribute, gen_project_Priority_TaskTimesheetAttribute, gen_project_ProjectId_TaskAttribute, gen_project_PurgeTask_TaskAttribute, gen_project_PurgeResource_ResourceAttribute, gen_project_ReportPrefix_IncludePropertiesAttribute, gen_project_ResourceAttributes_ExportAttribute, gen_project_ResourcePrefix_IncludePropertiesAttribute, gen_project_ResourceReport_Property, gen_project_ResourceReport_ReportAttribute, gen_project_Rate_Property, gen_project_Rate_ResourceAttribute, gen_project_Remaining_NewTaskAttribute, gen_project_Remaining_TaskTimesheetAttribute, gen_project_Right_ReportAttribute, gen_project_RollupAccount_ReportAttribute, gen_project_RollupResource_ReportAttribute, gen_project_RollupResource_IcalReportAttribute, gen_project_RollupResource_ExportAttribute, gen_project_RollupTask_ReportAttribute, gen_project_RollupTask_IcalReportAttribute, gen_project_RollupTask_ExportAttribute, gen_project_Scale_ColumnAttribute, gen_project_Scenario_ProjectAttribute, gen_project_ResourceRoot_ReportAttribute, gen_project_Responsible_TaskAttribute, gen_project_Scenarios_ReportAttribute, gen_project_Scenarios_ExportAttribute, gen_project_Scheduled_TaskAttribute, gen_project_Scheduling_TaskAttribute, gen_project_Select_AllocateResourceAttribute, gen_project_SelfContained_ReportAttribute, gen_project_Shift_Property, gen_project_ScenarioIcal_IcalReportAttribute, gen_project_Shifts_ShiftsResource, gen_project_Shifts_ShiftsTask, gen_project_ShiftsAllocate_AllocateResourceAttribute, gen_project_ShiftsResource_ResourceAttribute, gen_project_ShiftsTask_TaskAttribute, gen_project_ShortTimeFormat_ProjectAttribute, gen_project_ShiftTimesheet_TimesheetAttribute, gen_project_SortTasks_ReportAttribute, gen_project_SortTasks_StatusSheetReportAttribute, gen_project_Start_TaskAttribute, gen_project_Start_ReportAttribute, gen_project_Start_IcalReportAttribute, gen_project_Start_ExportAttribute, gen_project_Start_NikuReportAttribute, gen_project_Start_StatusSheetReportAttribute, gen_project_Start_TimesheetReportAttribute, gen_project_Start_ColumnAttribute, gen_project_StatusStatusSheet_TaskStatusSheetAttribute, gen_project_Sort_SortAccounts, gen_project_Sort_SortJournalEntries, gen_project_Sort_SortResources, gen_project_Sort_SortTasks, gen_project_SortAccounts_ReportAttribute, gen_project_SortJournalEntries_ReportAttribute, gen_project_SortResources_ReportAttribute, gen_project_SortResources_StatusSheetReportAttribute, gen_project_StatusSheet_Property, gen_project_StatusSheetReport_Property, gen_project_StatusTimesheet_TaskTimesheetAttribute, gen_project_StatusTimesheet_TimesheetAttribute, gen_project_SupplementResource_Property, gen_project_SupplementResource_ResourceAttribute, gen_project_SupplementTask_Property, gen_project_SupplementTask_TaskAttribute, gen_project_TagFile_Property, gen_project_Summary_StatusStatusSheetAttribute, gen_project_Summary_StatusTimesheetAttribute, gen_project_SupplementAccount_Property, gen_project_SupplementReport_Property, gen_project_TaskTimesheet_TimesheetAttribute, gen_project_TaskAttributes_ExportAttribute, gen_project_TaskStatusSheet_StatusSheetAttribute, gen_project_TaskStatusSheet_TaskStatusSheetAttribute, gen_project_TimeFormat_ProjectAttribute, gen_project_TimeFormat_ReportAttribute, gen_project_Timeoff_NikuReportAttribute, gen_project_Timesheet_Property, gen_project_TimesheetReport_Property, gen_project_TaskPrefix_IncludePropertiesAttribute, gen_project_TaskReport_Property, gen_project_TaskReport_ReportAttribute, gen_project_TaskRoot_ReportAttribute, gen_project_TextReport_Property, gen_project_TextReport_ReportAttribute, gen_project_ToolTip_ColumnAttribute, gen_project_TrackingScenario_ProjectAttribute, gen_project_Vacation_Property, gen_project_Vacation_ResourceAttribute, gen_project_Warn_TaskAttribute, gen_project_Warn_ResourceAttribute, gen_project_Timezone_ProjectAttribute, gen_project_Timezone_ReportAttribute, gen_project_Timezone_ExportAttribute, gen_project_TimingResolution_ProjectAttribute, gen_project_Title_ReportAttribute, gen_project_Title_NikuReportAttribute, gen_project_Title_ColumnAttribute, gen_project_WorkingHours_ProjectAttribute, gen_project_WorkingHours_ResourceAttribute, gen_project_YearlyWorkingDays_ProjectAttribute, gen_project_WeekStarts_ProjectAttribute, gen_project_WeeklyMax_LimitsAttribute, gen_project_WeeklyMin_LimitsAttribute, gen_project_Width_ColumnAttribute, gen_project_Work_NewTaskAttribute, gen_project_Work_TaskTimesheetAttribute, gen_project_Limit_WeeklyMin, gen_project_DurationQuantity_GapDuration, gen_project_DurationQuantity_GapLength, gen_project_Limit_DailyMax, gen_project_Limit_DailyMin, gen_project_Limit_Maximum, gen_project_Limit_Minimum, gen_project_Limit_MonthlyMax, gen_project_Limit_MonthlyMin, gen_project_Limit_WeeklyMax, gen_project_RealFormat_CurrencyFormat, gen_project_RealFormat_NumberFormat, gen_project_TaskDependency_Depends, gen_project_TaskDependency_Precedes, gen_project_RichText_Header, gen_project_RichText_Headline, gen_project_RichText_Left, gen_project_RichText_ListItem, gen_project_RichText_Prolog, gen_project_RichText_Right, gen_project_RichText_Summary, gen_project_RichText_Caption, gen_project_RichText_Center, gen_project_RichText_Details, gen_project_RichText_Epilog, gen_project_RichText_Footer, gen_project_Defintions_Definitions, gen_project_XBinaryOperation_LogicalExpression, gen_project_LogicalFunctionExpression_LogicalExpression, gen_project_LogicalBooleanLiteral_LogicalExpression, gen_project_LogicalNumeralLiteral_LogicalExpression, gen_project_LogicalStringLiteral_LogicalExpression, gen_project_LogicalDateLiteral_LogicalExpression, gen_project_LogicalAbsoluteIdExression_LogicalExpression},
    metadata=None
)
