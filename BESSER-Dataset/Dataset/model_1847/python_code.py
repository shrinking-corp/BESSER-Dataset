...
class Headline:
    ...
    pass
class project_RichText(Caption, Right, Left, Center, Headline, Header, Epilog, Footer, ListItem, Details, Prolog, Summary):
...
class Depends:
    ...
    pass
class project_TaskDependency(Precedes, Depends):
...
class project_RealFormat(CurrencyFormat, NumberFormat):
    ...
    def __init__(self, negativePrefix: str, negativeSuffix: str, thousandsSeparator: str, fractionSeparator: str, fractionDigits: int):
...
class project_LimitAttribute:
    ...
    def __init__(self, start: str, end: str, project_LimitAttribute: "project_Limit" = None, project_LimitAttribute234: "project_Interval1" = None, project_LimitAttribute237: set["project_Resource"] = None):
        self.start = start
        self.end = end
...
class WeeklyMin:
    ...
    pass
class project_Limit(DailyMax, MonthlyMax, WeeklyMin, WeeklyMax, Maximum, MonthlyMin, DailyMin, Minimum):
...
class SortAccounts:
    ...
    pass
class project_Sort(SortJournalEntries, SortTasks, SortAccounts, SortResources):
...
class ShiftsResource:
    ...
    pass
class project_Shifts(ShiftsTask, ShiftsResource):
...
class project_Interval3:
    ...
    def __init__(self, start: str, end: str, project_Interval3148: "project_ShiftsAllocate" = None, project_Interval3: "project_DurationQuantity" = None, project_Interval3217: "project_Vacation" = None):
        self.start = start
        self.end = end
...
class project_Function:
    ...
    def __init__(self, parentId: str, distance: int, level: int, date: str, project_Function: "project_Scenario" = None, project_Function67: "project_Task" = None, project_Function70: "project_Resource" = None, project_Function253: "project_LogicalFunctionExpression" = None):
...
class project_Extend:
    ...
    def __init__(self, id: str, name: str, inherit: bool, scenariospecific: bool, project_Extend58: "project_ExtendedResourceAttribute" = None, project_Extend60: "project_ExtendTask" = None, project_Extend62: "project_ExtendedTaskAttribute" = None, project_Extend: "project_ExtendResource" = None):
        self.id = id
        self.name = name
...
class project_Scenario(ProjectAttribute):
    ...
    def __init__(self, id: str, name: str, active: str, project_Scenario: "project_Function" = None, project_Scenario128: "project_Scenarios" = None, project_Scenario124: "project_Scenario" = None, project_Scenario122: "project_Scenario" = None, project_Scenario126: "project_ScenarioIcal" = None, project_Scenario214: "project_TrackingScenario" = None):
        self.id = id
        self.name = name
        self.active = active
...
class NewTaskAttribute:
    ...
    pass
class project_Work(TaskTimesheetAttribute, NewTaskAttribute):
...
class project_Remaining(TaskTimesheetAttribute, NewTaskAttribute):
...
class project_DurationQuantity(GapDuration, GapLength):
    ...
    def __init__(self, value: float, unit: str, project_DurationQuantity: "project_Duration" = None, project_DurationQuantity55: "project_Effort" = None, project_DurationQuantity85: "project_Interval2" = None, project_DurationQuantity87: "project_Interval3" = None, project_DurationQuantity82: "project_Interval1" = None, project_DurationQuantity90: "project_Interval4" = None, project_DurationQuantity100: "project_Length" = None, project_DurationQuantity107: "project_Remaining" = None, project_DurationQuantity230: "project_Limit" = None):
        self.value = value
        self.unit = unit
...
class ReportAttribute:
    ...
    pass
class project_HideJournalEntry(IcalReportAttribute, ReportAttribute):
...
class project_JournalAttributes(ReportAttribute):
    ...
    def __init__(self, summary: bool, all: bool, none: bool, flags: bool, _property: bool, details: bool, author: bool, headline: bool, date: bool, timesheet: bool, propertyid: bool):
    ...
    @_property.setter
    def _property(self, _property: bool):
...
class project_Scenarios(ExportAttribute, ReportAttribute):
...
class project_TimeFormat(ProjectAttribute, ReportAttribute):
...
class project_Footer(ReportAttribute):
    ...
    pass
class project_SortResources(StatusSheetReportAttribute, ReportAttribute):

    pass
class project_Timezone(ExportAttribute, ProjectAttribute, ReportAttribute):
...
class project_RollupTask(ExportAttribute, IcalReportAttribute, ReportAttribute):

    pass
class project_NumberFormat(ProjectAttribute, NikuReportAttribute, ReportAttribute):

    pass
class project_RollupResource(ExportAttribute, IcalReportAttribute, ReportAttribute):

    pass
class project_Headline(NikuReportAttribute, ReportAttribute):

    pass
class project_SortTasks(StatusSheetReportAttribute, ReportAttribute):
...
class project_SortJournalEntries(ReportAttribute):
    ...
    pass
class project_Formats(NikuReportAttribute, ReportAttribute):
...
class project_HideTask(ExportAttribute, NikuReportAttribute, StatusSheetReportAttribute, ReportAttribute, IcalReportAttribute):

    pass
class project_CurrencyFormat(ProjectAttribute, ReportAttribute):

    pass
class project_HideResource(ExportAttribute, NikuReportAttribute, StatusSheetReportAttribute, ReportAttribute, TimesheetReportAttribute, IcalReportAttribute):
...
class AccountReport:
    ...
    pass
class project_Report(AccountReport, TaskReport, TextReport, ResourceReport):
...
class project_Length(TaskAttribute):
    ...
    pass
class project_Priority(TaskTimesheetAttribute, TaskAttribute, NewTaskAttribute):
...
class project_JournalEntry(ProjectAttribute, TaskAttribute, ResourceAttribute):

    def __init__(self, date: str, headline: str, project_JournalEntry: "project_Alert" = None, project_JournalEntry93: "project_Author" = None, project_JournalEntry96: "project_Details" = None, project_JournalEntry98: "project_Summary" = None):
        self.date = date
        self.headline = headline
...
class Property:
    ...
    pass
class project_AccountReport(Property, ReportAttribute):
...
class project_TagFile(Property):
    ...
    def __init__(self, id: str, filename: str, project_TagFile: "project_HideResource" = None, project_TagFile183: "project_HideTask" = None, project_TagFile186: "project_RollupResource" = None, project_TagFile189: "project_RollupTask" = None):
        self.id = id
        self.filename = filename
...
class project_Limits(Property, TaskAttribute, ResourceAttribute):

    pass
class project_Resource(Property, ResourceAttribute):

    def __init__(self, id: str, name: str, project_Resource27: "project_Alternative" = None, project_Resource29: "project_Author" = None, project_Resource: set["project_ResourceAttribute"] = None, project_Resource20: "project_AllocateResource" = None, project_Resource37: "project_BookingTask" = None, project_Resource153: "project_StatusSheet" = None, project_Resource71: "project_Function" = None, project_Resource103: "project_Managers" = None, project_Resource111: "project_ResourcePrefix" = None, project_Resource113: "project_ResourceRoot" = None, project_Resource115: "project_Responsible" = None, project_Resource171: "project_SupplementResource" = None, project_Resource204: "project_Timesheet" = None, project_Resource238: "project_LimitAttribute" = None):
        self.id = id
        self.name = name
...
class project_TextReport(Property, ReportAttribute):

    pass
class project_Shift(Property):

    def __init__(self, id: str, name: str, replace: str, timezone: str, project_Shift132: "project_Shift" = None, project_Shift130: "project_Shift" = None, project_Shift134: "project_WorkingHours" = None, project_Shift136: "project_ShiftTimesheet" = None, project_Shift: "project_Vacation" = None, project_Shift140: "project_ShiftsLimit" = None, project_Shift145: "project_ShiftsAllocate" = None):
        self.id = id
        self.name = name
...
class project_SupplementTask(Property, TaskAttribute):
...
class project_StatusSheet(Property):
    ...
    pass
class project_ResourceReport(Property, ReportAttribute):
...
class project_Timesheet(Property):
    ...
    pass
class project_TaskReport(Property, ReportAttribute):
...
class project_Task(Property, TaskAttribute):

    def __init__(self, id: str, name: str, project_Task42: "project_BookingResource" = None, project_Task: set["project_TaskAttribute"] = None, project_Task68: "project_Function" = None, project_Task176: "project_SupplementTask" = None, project_Task192: "project_TaskStatusSheet" = None, project_Task196: "project_TaskTimesheet" = None, project_Task200: "project_TaskPrefix" = None, project_Task202: "project_TaskRoot" = None, project_Task240: "project_TaskDependency" = None):
        self.id = id
        self.name = name
...
class project_Account(Property, AccountAttribute):
...
class project_Title(NikuReportAttribute, ColumnAttribute, ReportAttribute):
...
class project_Period(ExportAttribute, NikuReportAttribute, StatusSheetReportAttribute, TaskAttribute, ColumnAttribute, ReportAttribute, TimesheetReportAttribute, IcalReportAttribute):
...
class project_End(ExportAttribute, NikuReportAttribute, TaskTimesheetAttribute, StatusSheetReportAttribute, TaskAttribute, NewTaskAttribute, ColumnAttribute, ReportAttribute, TimesheetReportAttribute, IcalReportAttribute):
...
class project_Start(ExportAttribute, NikuReportAttribute, StatusSheetReportAttribute, TaskAttribute, ColumnAttribute, ReportAttribute, TimesheetReportAttribute, IcalReportAttribute):
...
class project_Details(StatusTimesheetAttribute, StatusStatusSheetAttribute):
    ...
    pass
class project_Flags(TaskAttribute, AccountAttribute, StatusStatusSheetAttribute, StatusTimesheetAttribute, Property, ReportAttribute, ResourceAttribute):
...
class project_Interval4:
    ...
    def __init__(self, start: str, end: str, project_Interval4: "project_Booking" = None, project_Interval4156: "project_StatusSheet" = None, project_Interval489: "project_DurationQuantity" = None, project_Interval4207: "project_Timesheet" = None):
        self.start = start
        self.end = end
...
class project_Booking:
    ...
    def __init__(self, overtime: int, sloppy: int, project_Booking45: "project_BookingResource" = None, project_Booking: "project_Interval4" = None, project_Booking40: "project_BookingTask" = None):
...
class project_Balance(Property, ReportAttribute):
...
class project_ShiftTimesheet(TimesheetAttribute):
    ...
    pass
class project_StatusTimesheet(TimesheetAttribute, TaskTimesheetAttribute):

    def __init__(self, text: str, level: str, project_StatusTimesheet: set["project_StatusTimesheetAttribute"] = None):
        self.text = text
        self.level = level
