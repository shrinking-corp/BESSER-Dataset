...
# GMTPage class attributes and methods
GMTPage_scSession_As_Greenway_Session_SessionClient: Property = Property(name="scSession_As_Greenway_Session_SessionClient", type=StringType)
GMTPage_balance: Property = Property(name="balance", type=FloatType)
GMTPage.attributes={GMTPage_scSession_As_Greenway_Session_SessionClient, GMTPage_balance}
...
ClassC.attributes={ClassC_protectedAttribute, ClassC_packageAttribute, ClassC_privateAttribute, ClassC_publicAttribute}
...
domain_model = DomainModel(
    name="_9e55537a_5eb7_4c3c_a9a0_32213cd4339e",
    types={GMTPage, ClassA, ClassB, ClassC, ClassD, ClassE, ClassF, ClassG, ClassJ, ClassH, ClassK, ClassL, ClassM, ClassN, ClassP, InterfaceO_Interface, ClassQ, ClassR, ClassS, ClassT, ClassU, ClassV},
