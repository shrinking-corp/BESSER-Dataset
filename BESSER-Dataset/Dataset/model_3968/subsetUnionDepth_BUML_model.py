...
# Classes
subsetUnionDepth_Container = Class(name="subsetUnionDepth_Container")
subsetUnionDepth_Element = Class(name="subsetUnionDepth_Element")
subsetUnionDepth_Element_Level1 = Class(name="subsetUnionDepth_Element_Level1")
subsetUnionDepth_Container_Level6 = Class(name="subsetUnionDepth_Container_Level6")
Container_Level5 = Class(name="Container_Level5")
subsetUnionDepth_Element_Level7 = Class(name="subsetUnionDepth_Element_Level7")
Element_Level6 = Class(name="Element_Level6")
subsetUnionDepth_Container_Level7 = Class(name="subsetUnionDepth_Container_Level7")
Container_Level6 = Class(name="Container_Level6")
Element = Class(name="Element")
subsetUnionDepth_Container_Level1 = Class(name="subsetUnionDepth_Container_Level1")
Container = Class(name="Container")
subsetUnionDepth_Element_Level2 = Class(name="subsetUnionDepth_Element_Level2")
Element_Level1 = Class(name="Element_Level1")
subsetUnionDepth_Container_Level2 = Class(name="subsetUnionDepth_Container_Level2")
Container_Level1 = Class(name="Container_Level1")
subsetUnionDepth_Element_Level3 = Class(name="subsetUnionDepth_Element_Level3")
Element_Level2 = Class(name="Element_Level2")
subsetUnionDepth_Container_Level3 = Class(name="subsetUnionDepth_Container_Level3")
Container_Level2 = Class(name="Container_Level2")
subsetUnionDepth_Element_Level4 = Class(name="subsetUnionDepth_Element_Level4")
Element_Level3 = Class(name="Element_Level3")
subsetUnionDepth_Container_Level4 = Class(name="subsetUnionDepth_Container_Level4")
Container_Level3 = Class(name="Container_Level3")
subsetUnionDepth_Container_Level5 = Class(name="subsetUnionDepth_Container_Level5")
Container_Level4 = Class(name="Container_Level4")
subsetUnionDepth_Element_Level5 = Class(name="subsetUnionDepth_Element_Level5")
Element_Level4 = Class(name="Element_Level4")
subsetUnionDepth_Element_Level6 = Class(name="subsetUnionDepth_Element_Level6")
Element_Level5 = Class(name="Element_Level5")
subsetUnionDepth_Container_Level8 = Class(name="subsetUnionDepth_Container_Level8")
Container_Level7 = Class(name="Container_Level7")
subsetUnionDepth_Element_Level8 = Class(name="subsetUnionDepth_Element_Level8")
Element_Level7 = Class(name="Element_Level7")
subsetUnionDepth_Element_Level9 = Class(name="subsetUnionDepth_Element_Level9")
Element_Level8 = Class(name="Element_Level8")
subsetUnionDepth_Container_Level9 = Class(name="subsetUnionDepth_Container_Level9")
Container_Level8 = Class(name="Container_Level8")
subsetUnionDepth_Element_Level10 = Class(name="subsetUnionDepth_Element_Level10")
Element_Level9 = Class(name="Element_Level9")
subsetUnionDepth_Container_Level10 = Class(name="subsetUnionDepth_Container_Level10")
Container_Level9 = Class(name="Container_Level9")
...
domain_model = DomainModel(
    ...
    types={subsetUnionDepth_Container, subsetUnionDepth_Element, subsetUnionDepth_Element_Level1, subsetUnionDepth_Container_Level6, Container_Level5, subsetUnionDepth_Element_Level7, Element_Level6, subsetUnionDepth_Container_Level7, Container_Level6, Element, subsetUnionDepth_Container_Level1, Container, subsetUnionDepth_Element_Level2, Element_Level1, subsetUnionDepth_Container_Level2, Container_Level1, subsetUnionDepth_Element_Level3, Element_Level2, subsetUnionDepth_Container_Level3, Container_Level2, subsetUnionDepth_Element_Level4, Element_Level3, subsetUnionDepth_Container_Level4, Container_Level3, subsetUnionDepth_Container_Level5, Container_Level4, subsetUnionDepth_Element_Level5, Element_Level4, subsetUnionDepth_Element_Level6, Element_Level5, subsetUnionDepth_Container_Level8, Container_Level7, subsetUnionDepth_Element_Level8, Element_Level7, subsetUnionDepth_Element_Level9, Element_Level8, subsetUnionDepth_Container_Level9, Container_Level8, subsetUnionDepth_Element_Level10, Element_Level9, subsetUnionDepth_Container_Level10, Container_Level9},
    associations={unionBag0, subset66, subset77, subset11, subset22, subset33, subset44, subset55, subset88, subset99, subset1010},
    generalizations={gen_subsetUnionDepth_Container_Level6_Container_Level5, gen_subsetUnionDepth_Element_Level7_Element_Level6, gen_subsetUnionDepth_Container_Level7_Container_Level6, gen_subsetUnionDepth_Element_Level1_Element, gen_subsetUnionDepth_Container_Level1_Container, gen_subsetUnionDepth_Element_Level2_Element_Level1, gen_subsetUnionDepth_Container_Level2_Container_Level1, gen_subsetUnionDepth_Element_Level3_Element_Level2, gen_subsetUnionDepth_Container_Level3_Container_Level2, gen_subsetUnionDepth_Element_Level4_Element_Level3, gen_subsetUnionDepth_Container_Level4_Container_Level3, gen_subsetUnionDepth_Container_Level5_Container_Level4, gen_subsetUnionDepth_Element_Level5_Element_Level4, gen_subsetUnionDepth_Element_Level6_Element_Level5, gen_subsetUnionDepth_Container_Level8_Container_Level7, gen_subsetUnionDepth_Element_Level8_Element_Level7, gen_subsetUnionDepth_Element_Level9_Element_Level8, gen_subsetUnionDepth_Container_Level9_Container_Level8, gen_subsetUnionDepth_Element_Level10_Element_Level9, gen_subsetUnionDepth_Container_Level10_Container_Level9},
    metadata=None
)
