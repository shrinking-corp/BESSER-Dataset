...
# Classes
classdiagram_NamedElement = Class(name="classdiagram_NamedElement")
...
domain_model = DomainModel(
    name="classdiagram",
    types={classdiagram_NamedElement, classdiagram_Class, NamedElement, classdiagram_Attribute, classdiagram_Method},
    associations={super1, children3, attributes5, methods6},
    generalizations={gen_classdiagram_Class_NamedElement, gen_classdiagram_Attribute_NamedElement, gen_classdiagram_Method_NamedElement},
    metadata=None
)
