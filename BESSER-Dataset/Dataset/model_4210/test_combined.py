...
def test_hyp_mydsl_model_greetings_setter(instance):
...
def test_myDsl_Model_greetings_value_roundtrip():
    instance = myDsl_Model(greetings="sample_text")
    assert instance.greetings == "sample_text"
    instance.greetings = "sample_text_2"
    assert instance.greetings == "sample_text_2"
...
myDsl_Model_strategy = st.builds(myDsl_Model, greetings=safe_text)
@given(instance=myDsl_Model_strategy)
@settings(max_examples=25)
