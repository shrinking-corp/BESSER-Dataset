...
# Classes
classLayout2Frontend_PageView = Class(name="classLayout2Frontend_PageView")
classLayout2Frontend_ContainerView = Class(name="classLayout2Frontend_ContainerView", is_abstract=True)
classLayout2Frontend_Composition = Class(name="classLayout2Frontend_Composition")
Association = Class(name="Association")
classLayout2Frontend_Association = Class(name="classLayout2Frontend_Association", is_abstract=True)
StructuralFeature = Class(name="StructuralFeature")
classLayout2Frontend_Entity = Class(name="classLayout2Frontend_Entity")
classLayout2Frontend_PropertyType = Class(name="classLayout2Frontend_PropertyType", is_abstract=True)
EntityModelElement = Class(name="EntityModelElement")
classLayout2Frontend_Property = Class(name="classLayout2Frontend_Property")
classLayout2Frontend_StructuralFeature = Class(name="classLayout2Frontend_StructuralFeature", is_abstract=True)
classLayout2Frontend_EntityModelElement = Class(name="classLayout2Frontend_EntityModelElement", is_abstract=True)
classLayout2Frontend_Project = Class(name="classLayout2Frontend_Project")
classLayout2Frontend_EntitiesModel = Class(name="classLayout2Frontend_EntitiesModel")
classLayout2Frontend_SiteView = Class(name="classLayout2Frontend_SiteView")
classLayout2Frontend_AtomicView = Class(name="classLayout2Frontend_AtomicView", is_abstract=True)
ElementView = Class(name="ElementView")
classLayout2Frontend_Autocomplete = Class(name="classLayout2Frontend_Autocomplete")
Selection = Class(name="Selection")
classLayout2Frontend_Dropdownlist = Class(name="classLayout2Frontend_Dropdownlist")
classLayout2Frontend_Image = Class(name="classLayout2Frontend_Image")
Output = Class(name="Output")
classLayout2Frontend_List = Class(name="classLayout2Frontend_List")
classLayout2Frontend_Output = Class(name="classLayout2Frontend_Output", is_abstract=True)
AtomicView = Class(name="AtomicView")
classLayout2Frontend_IterationFilter = Class(name="classLayout2Frontend_IterationFilter")
classLayout2Frontend_Input = Class(name="classLayout2Frontend_Input", is_abstract=True)
classLayout2Frontend_InputText = Class(name="classLayout2Frontend_InputText")
Input = Class(name="Input")
classLayout2Frontend_ElementView = Class(name="classLayout2Frontend_ElementView", is_abstract=True)
classLayout2Frontend_StaticContainer = Class(name="classLayout2Frontend_StaticContainer")
classLayout2Frontend_PrimitiveType = Class(name="classLayout2Frontend_PrimitiveType")
PropertyType = Class(name="PropertyType")
classLayout2Frontend_Literal = Class(name="classLayout2Frontend_Literal")
classLayout2Frontend_Enumeration = Class(name="classLayout2Frontend_Enumeration")
classLayout2Frontend_Reference = Class(name="classLayout2Frontend_Reference")
classLayout2Frontend_CheckList = Class(name="classLayout2Frontend_CheckList")
classLayout2Frontend_RadioButtonGroup = Class(name="classLayout2Frontend_RadioButtonGroup")
classLayout2Frontend_FileUpload = Class(name="classLayout2Frontend_FileUpload")
ContainerView = Class(name="ContainerView")
classLayout2Frontend_TextArea = Class(name="classLayout2Frontend_TextArea")
classLayout2Frontend_Selection = Class(name="classLayout2Frontend_Selection", is_abstract=True)
classLayout2Frontend_IterationContainer = Class(name="classLayout2Frontend_IterationContainer")
classLayout2Frontend_InputForm = Class(name="classLayout2Frontend_InputForm")
...
classLayout2Frontend_EntityModelElement.attributes={classLayout2Frontend_EntityModelElement_name, classLayout2Frontend_EntityModelElement_description, classLayout2Frontend_EntityModelElement_displayName}
...
classLayout2Frontend_SiteView.attributes={classLayout2Frontend_SiteView_name, classLayout2Frontend_SiteView_templateName, classLayout2Frontend_SiteView_displayName, classLayout2Frontend_SiteView_templateColor}
...
classLayout2Frontend_ElementView.attributes={classLayout2Frontend_ElementView_displayName, classLayout2Frontend_ElementView_description, classLayout2Frontend_ElementView_name}
...
classLayout2Frontend_TextArea.attributes={classLayout2Frontend_TextArea_isTitle, classLayout2Frontend_TextArea_value}
...
domain_model = DomainModel(
    ...
    types={classLayout2Frontend_PageView, classLayout2Frontend_ContainerView, classLayout2Frontend_Composition, Association, classLayout2Frontend_Association, StructuralFeature, classLayout2Frontend_Entity, classLayout2Frontend_PropertyType, EntityModelElement, classLayout2Frontend_Property, classLayout2Frontend_StructuralFeature, classLayout2Frontend_EntityModelElement, classLayout2Frontend_Project, classLayout2Frontend_EntitiesModel, classLayout2Frontend_SiteView, classLayout2Frontend_AtomicView, ElementView, classLayout2Frontend_Autocomplete, Selection, classLayout2Frontend_Dropdownlist, classLayout2Frontend_Image, Output, classLayout2Frontend_List, classLayout2Frontend_Output, AtomicView, classLayout2Frontend_IterationFilter, classLayout2Frontend_Input, classLayout2Frontend_InputText, Input, classLayout2Frontend_ElementView, classLayout2Frontend_StaticContainer, classLayout2Frontend_PrimitiveType, PropertyType, classLayout2Frontend_Literal, classLayout2Frontend_Enumeration, classLayout2Frontend_Reference, classLayout2Frontend_CheckList, classLayout2Frontend_RadioButtonGroup, classLayout2Frontend_FileUpload, ContainerView, classLayout2Frontend_TextArea, classLayout2Frontend_Selection, classLayout2Frontend_IterationContainer, classLayout2Frontend_InputForm, LayoutType},
    associations={siteViews1, pageViews3, containerViews5, target7, type8, modelElements9, entitiesmodel0, property17, input19, elementViews20, pageViews22, superclass12, structuralFeatures14, literals16, elements27, entity30, iterationFilters25},
    generalizations={gen_classLayout2Frontend_Composition_Association, gen_classLayout2Frontend_Association_StructuralFeature, gen_classLayout2Frontend_PropertyType_EntityModelElement, gen_classLayout2Frontend_Property_StructuralFeature, gen_classLayout2Frontend_StructuralFeature_EntityModelElement, gen_classLayout2Frontend_AtomicView_ElementView, gen_classLayout2Frontend_Autocomplete_Selection, gen_classLayout2Frontend_Dropdownlist_Selection, gen_classLayout2Frontend_Image_Output, gen_classLayout2Frontend_List_Selection, gen_classLayout2Frontend_Output_AtomicView, gen_classLayout2Frontend_InputText_Input, gen_classLayout2Frontend_Entity_EntityModelElement, gen_classLayout2Frontend_PrimitiveType_PropertyType, gen_classLayout2Frontend_Literal_EntityModelElement, gen_classLayout2Frontend_Enumeration_PropertyType, gen_classLayout2Frontend_Reference_Association, gen_classLayout2Frontend_CheckList_Selection, gen_classLayout2Frontend_RadioButtonGroup_Selection, gen_classLayout2Frontend_ContainerView_ElementView, gen_classLayout2Frontend_FileUpload_Input, gen_classLayout2Frontend_StaticContainer_ContainerView, gen_classLayout2Frontend_TextArea_Output, gen_classLayout2Frontend_Selection_Input, gen_classLayout2Frontend_Input_AtomicView, gen_classLayout2Frontend_IterationContainer_ContainerView, gen_classLayout2Frontend_InputForm_ContainerView},
    metadata=None
)
