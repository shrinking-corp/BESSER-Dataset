...
class classLayout2Frontend_EntitiesModel:
    ...
    def __init__(self, name: str, classLayout2Frontend_EntitiesModel10: set["classLayout2Frontend_EntityModelElement"] = None, classLayout2Frontend_EntitiesModel: "classLayout2Frontend_Project" = None):
        self.name = name
...
class classLayout2Frontend_StructuralFeature(EntityModelElement):
    ...
    def __init__(self, required: bool, classLayout2Frontend_StructuralFeature18: "classLayout2Frontend_AtomicView" = None, classLayout2Frontend_StructuralFeature: "classLayout2Frontend_Entity" = None):
...
class classLayout2Frontend_PageView:
    ...
    def __init__(self, name: str, layoutType: str, classLayout2Frontend_PageView: "classLayout2Frontend_Project" = None, classLayout2Frontend_PageView21: set["classLayout2Frontend_ElementView"] = None, classLayout2Frontend_PageView24: "classLayout2Frontend_SiteView" = None):
        self.name = name
