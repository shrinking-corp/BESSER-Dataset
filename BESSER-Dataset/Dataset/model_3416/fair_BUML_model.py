...
# Classes
fair_Exhibit = Class(name="fair_Exhibit")
fair_Animal = Class(name="fair_Animal")
fair_Lot = Class(name="fair_Lot")
fair_Fair = Class(name="fair_Fair")
fair_YouthClub = Class(name="fair_YouthClub")
fair_Division = Class(name="fair_Division")
fair_Premises = Class(name="fair_Premises")
fair_Person = Class(name="fair_Person")
fair_Department = Class(name="fair_Department")
fair_Class = Class(name="fair_Class")
fair_YoungPerson = Class(name="fair_YoungPerson")
...
fair_Exhibit.attributes={fair_Exhibit_name, fair_Exhibit_number, fair_Exhibit_comments, fair_Exhibit_award, fair_Exhibit_salesOrder, fair_Exhibit_inAuction}
...
fair_Lot.attributes={fair_Lot_name, fair_Lot_comments, fair_Lot_description}
...
fair_Division.attributes={fair_Division_comments, fair_Division_name, fair_Division_description}
...
fair_Person.attributes={fair_Person_name, fair_Person_salesOrder, fair_Person_email, fair_Person_firstName, fair_Person_street, fair_Person_comments, fair_Person_pin, fair_Person_lastName, fair_Person_zipCode, fair_Person_phone, fair_Person_state, fair_Person_exhibitorNumber, fair_Person_city}
...
fair_Department.attributes={fair_Department_name, fair_Department_comments, fair_Department_description}
...
fair_Class.attributes={fair_Class_name, fair_Class_description, fair_Class_comments}
...
class_27: BinaryAssociation = BinaryAssociation(
    name="class_27",
    ends={
...
lots20: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="class_", type=fair_Lot, multiplicity=Multiplicity(1, 9999), is_composite=True)
    }
)
...
domain_model = DomainModel(
    name="fair",
    types={fair_Exhibit, fair_Animal, fair_Lot, fair_Fair, fair_YouthClub, fair_Division, fair_Premises, fair_Person, fair_Department, fair_Class, fair_YoungPerson, Person, Award},
    associations={animal7, exhibitor8, lot11, contacts12, youthClubs0, divisions1, premises3, people5, judges22, department24, exhibits26, class_27, departments15, classes16, superintendents17, division19, lots20, parents29, club31},
