...
class fair_Class:
    ...
    def __init__(self, comments: str, description: str, name: str, fair_Class: set["fair_Person"] = None, classes: "fair_Department" = None, Class28: "fair_Lot" = None, Class: "fair_Department" = None, class_: set["fair_Lot"] = None):
    ...
    def class_(self, value):
        ...
        old_value = getattr(self, f"_fair_Class__class_", None)
...
class fair_Department:
    ...
    def __init__(self, name: str, comments: str, description: str, Department25: "fair_Class" = None, Department: "fair_Division" = None, department: set["fair_Class"] = None, fair_Department: set["fair_Person"] = None, departments: "fair_Division" = None):
        self.name = name
        self.comments = comments
        self.description = description
...
class fair_Person:
    ...
    def __init__(self, firstName: str, lastName: str, phone: str, street: str, city: str, state: str, zipCode: str, name: str, comments: str, pin: str, salesOrder: int, exhibitorNumber: int, email: str, fair_Person10: "fair_Exhibit" = None, fair_Person14: "fair_YouthClub" = None, fair_Person: "fair_Fair" = None, fair_Person23: "fair_Class" = None, fair_Person18: "fair_Department" = None, fair_Person30: "fair_YoungPerson" = None):
...
class fair_Division:
    ...
    def __init__(self, name: str, comments: str, description: str, fair_Division: "fair_Fair" = None, division: set["fair_Department"] = None, Division: "fair_Department" = None):
        self.name = name
        self.comments = comments
        self.description = description
...
class fair_YouthClub:
    ...
    def __init__(self, name: str, comments: str, fair_YouthClub13: set["fair_Person"] = None, fair_YouthClub: "fair_Fair" = None, fair_YouthClub33: "fair_YoungPerson" = None):
        self.name = name
        self.comments = comments
...
class fair_Fair:
    ...
    def __init__(self, comments: str, name: str, fair_Fair: set["fair_YouthClub"] = None, fair_Fair2: set["fair_Division"] = None, fair_Fair4: "fair_Premises" = None, fair_Fair6: set["fair_Person"] = None):
        self.comments = comments
        self.name = name
...
class fair_Lot:
    ...
    def __init__(self, name: str, comments: str, description: str, Lot: "fair_Exhibit" = None, lot: set["fair_Exhibit"] = None, lots: "fair_Class" = None, Lot21: "fair_Class" = None):
        self.name = name
        self.comments = comments
        self.description = description
        self.Lot = Lot
