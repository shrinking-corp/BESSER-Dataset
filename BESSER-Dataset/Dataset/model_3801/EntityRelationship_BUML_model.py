...
# Classes
entityrelationship_Entity_Relationship_Model = Class(name="entityrelationship_Entity_Relationship_Model")
entityrelationship_Elements_with_Attributes = Class(name="entityrelationship_Elements_with_Attributes")
entityrelationship_Entity = Class(name="entityrelationship_Entity")
Elements_with_Attributes = Class(name="Elements_with_Attributes")
entityrelationship_Relationship = Class(name="entityrelationship_Relationship")
entityrelationship_Relationships_Restriction = Class(name="entityrelationship_Relationships_Restriction")
entityrelationship_Connection_Entity2Relationship = Class(name="entityrelationship_Connection_Entity2Relationship")
entityrelationship_Connection_Relationship2Entity = Class(name="entityrelationship_Connection_Relationship2Entity")
entityrelationship_Connection_ConnectionEntityRelationship2Attribute = Class(name="entityrelationship_Connection_ConnectionEntityRelationship2Attribute")
entityrelationship_Connection_Generalization_Entity = Class(name="entityrelationship_Connection_Generalization_Entity")
entityrelationship_Connection_E_R_Restriction = Class(name="entityrelationship_Connection_E_R_Restriction")
entityrelationship_Connection_With_Attribute = Class(name="entityrelationship_Connection_With_Attribute")
entityrelationship_Attribute = Class(name="entityrelationship_Attribute")
entityrelationship_Generalization = Class(name="entityrelationship_Generalization")
entityrelationship_Connection_EntityRelationship = Class(name="entityrelationship_Connection_EntityRelationship", is_abstract=True)
entityrelationship_Attribute_Composite = Class(name="entityrelationship_Attribute_Composite")
Connection_EntityRelationship = Class(name="Connection_EntityRelationship")
...
entityrelationship_Relationship.attributes={entityrelationship_Relationship_name_relationship, entityrelationship_Relationship_cardinality, entityrelationship_Relationship_order, entityrelationship_Relationship_type_relationship}
...
entityrelationship_Connection_EntityRelationship.attributes={entityrelationship_Connection_EntityRelationship_role, entityrelationship_Connection_EntityRelationship_minimum_cardinality, entityrelationship_Connection_EntityRelationship_maximum_cardinality}
...
domain_model = DomainModel(
    ...
    types={entityrelationship_Entity_Relationship_Model, entityrelationship_Elements_with_Attributes, entityrelationship_Entity, Elements_with_Attributes, entityrelationship_Relationship, entityrelationship_Relationships_Restriction, entityrelationship_Connection_Entity2Relationship, entityrelationship_Connection_Relationship2Entity, entityrelationship_Connection_ConnectionEntityRelationship2Attribute, entityrelationship_Connection_Generalization_Entity, entityrelationship_Connection_E_R_Restriction, entityrelationship_Connection_With_Attribute, entityrelationship_Attribute, entityrelationship_Generalization, entityrelationship_Connection_EntityRelationship, entityrelationship_Attribute_Composite, Connection_EntityRelationship, TypeRelationship, TypeRestriction, TypeRestriction2, TypeRestrictionInheritance1, TypeRestrictionInheritance2, TypeEntity, TypeAttribute, TypeIdentifier},
    associations={ERM_Has_E0, inEntityRelationshipModel20, entity_connected_to_entity2relationship21, entity_connected_to_relationship2entity23, subclass_generalizations25, ERM_Has_Rt1, ERM_Has_ConnectionEntity2Relationship3, ERM_Has_ConnectionRelationship2Entity5, ERM_HasConnectionEntityRelationship2Attribute7, ERM_Has_Gen9, ERM_Has_Rt211, ERM_Has_CEA13, ERM_Has_At15, ERM_Has_G16, connected_with_attribute18, attributes49, inAttribute51, source_relationship53, target_relationship56, inEntityRelationshipModel57, connection_source_entity_relationship59, source_restrictions27, target_restrictions28, relationship_connected_to_entity2relationship30, relationship_connected_to_relationship2entity33, attributes_composites35, attributes_identification37, connected39, inAttribute42, inEntityRelationshipModel44, attribute_connected_to_conection_entityrelationship_to_attribute47, Connection_Entity77, inEntityRelationshipModel80, source_entity82, target_relationship84, connection_target_entity_relationship60, inEntityRelationshipModel63, subclasses65, superclass66, inEntityRelationshipModel67, connection_attribute69, element71, inEntityRelationshipModel73, Connection_Generalization75, inEntityRelationshipModel86, source_relationship88, target_entity90, inEntityRelationshipModel92, source_connection94, target_attribute96, inEntityRelationshipModel98},
