...
public class entityrelationship_Connection_ConnectionEntityRelationship2Attribute  {
    ...
    public entityrelationship_Connection_ConnectionEntityRelationship2Attribute(
    ) {
    }
