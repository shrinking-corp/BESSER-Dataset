...
public class entityrelationship_Connection_Entity2Relationship extends Connection_EntityRelationship {
    ...
    private entityrelationship_Relationship entityrelationship_relationship;
    ...
    public entityrelationship_Connection_Entity2Relationship(
    ) {
        super(
        );
    }
    ...
    public entityrelationship_Relationship getEntityrelationship_relationship() {
        return entityrelationship_relationship;
    }

    public void setEntityrelationship_relationship(entityrelationship_Relationship entityrelationship_relationship) {
        this.entityrelationship_relationship = entityrelationship_relationship;
    }
