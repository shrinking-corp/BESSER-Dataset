...
sql_Column.attributes={sql_Column_isNotNull, sql_Column_name, sql_Column_type}
...
domain_model = DomainModel(
    ...
    associations={database0, tables1, facts3, foreignTable8, foreignColumns11, col5, localColumns6},
    generalizations={},
    metadata=None
)
