...
class Donations:
    ...
    def __init__(self, amount: int, cardType: str, cardNumber: int, issuerName: str, expirationDate: int, volunteer13: set["Volunteer"] = None, admin15: set["Admin"] = None, normal_user17: set["Normal_user"] = None, superAdmin11: set["Executive_Director"] = None):
        self.amount = amount
...
class Volunteer:
    ...
    def __init__(self, userID: int, userName: str, password: str, payment12: "Donations" = None, calender_Event0: set["Calender_Event"] = None):
        self.userID = userID
        self.userName = userName
        self.password = password
...
class Admin:
    ...
    def __init__(self, userID: int, userName: str, password: str, donation14: "Donations" = None, mail20: set["Mail"] = None, calender_Event2: set["Calender_Event"] = None):
        self.userID = userID
        self.userName = userName
        self.password = password
...
class Normal_user:
    ...
    def __init__(self, userID: int, userName: str, password: str, donation216: "Donations" = None, calender_Event4: set["Calender_Event"] = None):
        self.userID = userID
        self.userName = userName
        self.password = password
...
class Executive_Director:
    ...
    def __init__(self, userID: int, userName: str, password: str, mail18: set["Mail"] = None, calender_Event6: set["Calender_Event"] = None, payment10: "Donations" = None):
        self.userID = userID
        self.userName = userName
        self.password = password
