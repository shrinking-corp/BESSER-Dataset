...
public class Donations  {
    ...
    public Donations(
        int amount,        int expirationDate,        int cardNumber,        String cardType,        String issuerName    ) {
        this.amount = amount;
    ...
    public Donations(
        int amount,        int expirationDate,        int cardNumber,        String cardType,        String issuerName        ArrayList<Volunteer> volunteers,        ArrayList<Admin> admins,        ArrayList<Executive_Director> executive_directors,        ArrayList<Normal_user> normal_users    ) {
        this.amount = amount;
        this.expirationDate = expirationDate;
        this.cardNumber = cardNumber;
        this.cardType = cardType;
