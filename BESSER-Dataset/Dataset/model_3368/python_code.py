...
class sqliteModel_IndexedColumn:
    ...
    def __init__(self, asc: bool, desc: bool, collationName: str, sqliteModel_IndexedColumn85: "sqliteModel_ColumnDef" = None, sqliteModel_IndexedColumn: "sqliteModel_CreateIndexStatement" = None, sqliteModel_IndexedColumn74: "sqliteModel_UniqueTableConstraint" = None, sqliteModel_IndexedColumn78: "sqliteModel_PrimaryConstraint" = None):
        self.asc = asc
        self.desc = desc
...
class sqliteModel_TableDefinition(DDLStatement):
    ...
    def __init__(self, name: str, sqliteModel_TableDefinition87: "sqliteModel_DeleteStatement" = None, sqliteModel_TableDefinition92: "sqliteModel_InsertStatement" = None, sqliteModel_TableDefinition: "sqliteModel_CreateTriggerStatement" = None, sqliteModel_TableDefinition58: "sqliteModel_AlterTableAddColumnStatement" = None, sqliteModel_TableDefinition63: "sqliteModel_DropTableStatement" = None, sqliteModel_TableDefinition68: "sqliteModel_CreateIndexStatement" = None, sqliteModel_TableDefinition103: "sqliteModel_UpdateStatement" = None, sqliteModel_TableDefinition214: "sqliteModel_SingleSourceTable" = None, sqliteModel_TableDefinition227: "sqliteModel_AlterTableRenameStatement" = None):
        self.name = name
...
class sqliteModel_JoinStatement:
    ...
    def __init__(self, inner: bool, natural: bool, left: bool, outer: bool, cross: bool, sqliteModel_JoinStatement: "sqliteModel_JoinSource" = None, sqliteModel_JoinStatement46: "sqliteModel_SingleSource" = None, sqliteModel_JoinStatement49: "sqliteModel_Expression" = None):
        self.inner = inner
...
class sqliteModel_ColumnSource:
    ...
    def __init__(self, name: str, sqliteModel_ColumnSource: "sqliteModel_SelectList" = None, sqliteModel_ColumnSource61: "sqliteModel_AlterTableAddColumnStatement" = None, sqliteModel_ColumnSource172: "sqliteModel_OldColumn" = None, sqliteModel_ColumnSource176: "sqliteModel_ColumnSourceRef" = None, sqliteModel_ColumnSource170: "sqliteModel_NewColumn" = None, sqliteModel_ColumnSource220: "sqliteModel_CreateTableStatement" = None):
        self.name = name
...
class sqliteModel_ContentUri:
    ...
    def __init__(self, type: str, sqliteModel_ContentUri116: "sqliteModel_ActionStatement" = None, sqliteModel_ContentUri: set["sqliteModel_ContentUriSegment"] = None):
        self.type = type
...
class sqliteModel_DatabaseBlock:
    ...
    def __init__(self, name: str, sqliteModel_DatabaseBlock: "sqliteModel_Model" = None, sqliteModel_DatabaseBlock4: "sqliteModel_InitBlock" = None, sqliteModel_DatabaseBlock6: set["sqliteModel_MigrationBlock"] = None, sqliteModel_DatabaseBlock2: "sqliteModel_ConfigBlock" = None):
        self.name = name
