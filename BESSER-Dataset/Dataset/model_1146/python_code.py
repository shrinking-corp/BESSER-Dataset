...
class hsm_AbstractState(ABC):
    ...
    def __init__(self, name: str, hsm_AbstractState: "hsm_Transition" = None, hsm_AbstractState7: "hsm_Transition" = None, states: "hsm_StateMachine" = None, states11: "hsm_CompositeState" = None, AbstractState13: "hsm_CompositeState" = None, AbstractState: "hsm_StateMachine" = None):
        self.name = name
...
class hsm_Transition:
    ...
    def __init__(self, label: str, hsm_Transition: "hsm_AbstractState" = None, hsm_Transition6: "hsm_AbstractState" = None, Transition: "hsm_StateMachine" = None, transitions: "hsm_StateMachine" = None):
        self.label = label
...
class hsm_StateMachine:
    ...
    def __init__(self, name: str, StateMachine9: "hsm_AbstractState" = None, hsm_StateMachine: "hsm_Root" = None, stateMachine: set["hsm_Transition"] = None, stateMachine2: set["hsm_AbstractState"] = None, StateMachine: "hsm_Transition" = None):
        self.name = name
