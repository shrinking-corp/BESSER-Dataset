...
class publication2014a_Researcher:
    ...
    def __init__(self, name: str, forName: str, position: str, neededPerson: set["publication2014a_PublicationPhase"] = None, publication2014a_Researcher: set["publication2014a_Write"] = None, publication2014a_Researcher18: set["publication2014a_Review"] = None, Researcher: "publication2014a_PublicationPhase" = None, publication2014a_Researcher37: "publication2014a_PublicationStructure" = None, authors: set["publication2014a_Paper"] = None, Researcher23: "publication2014a_Paper" = None):
        self.name = name
...
class publication2014a_PublicationPhase:
    ...
    def __init__(self, name: str, minTime: int, maxTime: int, publication2014a_PublicationPhase: "publication2014a_PublicationProcess" = None, publication2014a_PublicationPhase11: "publication2014a_Sequence" = None, publication2014a_PublicationPhase14: "publication2014a_Sequence" = None, PublicationPhase: "publication2014a_Researcher" = None, publication2014a_PublicationPhase4: set["publication2014a_Sequence"] = None, phaseParticipation: set["publication2014a_Researcher"] = None, publication2014a_PublicationPhase7: set["publication2014a_Rule"] = None):
        self.name = name
...
class publication2014a_ReviewNote(Named):
    ...
    def __init__(self, content: str, publication2014a_ReviewNote: "publication2014a_Paragraph" = None, publication2014a_ReviewNote35: "publication2014a_Review" = None):
...
class publication2014a_PublicationStructure(Named):
    ...
    pass
class publication2014a_Paragraph(Named, Counted):

    def __init__(self, content: str, publication2014a_Paragraph25: set["publication2014a_ReviewNote"] = None, publication2014a_Paragraph32: "publication2014a_Write" = None, publication2014a_Paragraph: "publication2014a_Paper" = None):
        self.content = content
