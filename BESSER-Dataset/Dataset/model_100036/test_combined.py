...
def test_hyp_publication2014a_counted_is_not_abstract():
    assert not inspect.isabstract(publication2014a_Counted)


def test_hyp_publication2014a_counted_constructor_exists():
    assert callable(publication2014a_Counted.__init__)


def test_hyp_publication2014a_counted_constructor_args():
...
def test_hyp_publication2014a_named_is_not_abstract():
    assert not inspect.isabstract(publication2014a_Named)


def test_hyp_publication2014a_named_constructor_exists():
    assert callable(publication2014a_Named.__init__)


def test_hyp_publication2014a_named_constructor_args():
...
def test_hyp_publication2014a_publicationsystem_is_not_abstract():
    assert not inspect.isabstract(publication2014a_PublicationSystem)


def test_hyp_publication2014a_publicationsystem_constructor_exists():
    assert callable(publication2014a_PublicationSystem.__init__)


def test_hyp_publication2014a_publicationsystem_constructor_args():
    sig = inspect.signature(publication2014a_PublicationSystem.__init__)
    params = list(sig.parameters.keys())



def test_hyp_publication2014a_labelled_is_not_abstract():
    assert not inspect.isabstract(publication2014a_Labelled)


def test_hyp_publication2014a_labelled_constructor_exists():
    assert callable(publication2014a_Labelled.__init__)


def test_hyp_publication2014a_labelled_constructor_args():
...
def test_hyp_publication2014a_progress_is_not_abstract():
    assert not inspect.isabstract(publication2014a_Progress)


def test_hyp_publication2014a_progress_constructor_exists():
    assert callable(publication2014a_Progress.__init__)


def test_hyp_publication2014a_progress_constructor_args():
...
def test_hyp_publication2014a_researcher_is_not_abstract():
    assert not inspect.isabstract(publication2014a_Researcher)


def test_hyp_publication2014a_researcher_constructor_exists():
    assert callable(publication2014a_Researcher.__init__)


def test_hyp_publication2014a_researcher_constructor_args():
...
def test_hyp_publication2014a_sequence_is_not_abstract():
    assert not inspect.isabstract(publication2014a_Sequence)


def test_hyp_publication2014a_sequence_constructor_exists():
    assert callable(publication2014a_Sequence.__init__)


def test_hyp_publication2014a_sequence_constructor_args():
...
def test_hyp_publication2014a_rule_is_not_abstract():
    assert not inspect.isabstract(publication2014a_Rule)


def test_hyp_publication2014a_rule_constructor_exists():
    assert callable(publication2014a_Rule.__init__)


def test_hyp_publication2014a_rule_constructor_args():
...
def test_hyp_publication2014a_review_is_not_abstract():
    assert not inspect.isabstract(publication2014a_Review)


def test_hyp_publication2014a_review_constructor_exists():
    assert callable(publication2014a_Review.__init__)


def test_hyp_publication2014a_review_constructor_args():
    sig = inspect.signature(publication2014a_Review.__init__)
    params = list(sig.parameters.keys())



def test_hyp_publication2014a_write_is_not_abstract():
    assert not inspect.isabstract(publication2014a_Write)


def test_hyp_publication2014a_write_constructor_exists():
    assert callable(publication2014a_Write.__init__)


def test_hyp_publication2014a_write_constructor_args():
    sig = inspect.signature(publication2014a_Write.__init__)
    params = list(sig.parameters.keys())



def test_hyp_publication2014a_publicationphase_is_not_abstract():
    assert not inspect.isabstract(publication2014a_PublicationPhase)


def test_hyp_publication2014a_publicationphase_constructor_exists():
    assert callable(publication2014a_PublicationPhase.__init__)


def test_hyp_publication2014a_publicationphase_constructor_args():
...
def test_hyp_publication2014a_paragraph_is_not_abstract():
    assert not inspect.isabstract(publication2014a_Paragraph)


def test_hyp_publication2014a_paragraph_constructor_exists():
    assert callable(publication2014a_Paragraph.__init__)


def test_hyp_publication2014a_paragraph_constructor_args():
...
def test_hyp_publication2014a_paper_is_not_abstract():
    assert not inspect.isabstract(publication2014a_Paper)


def test_hyp_publication2014a_paper_constructor_exists():
    assert callable(publication2014a_Paper.__init__)


def test_hyp_publication2014a_paper_constructor_args():
    sig = inspect.signature(publication2014a_Paper.__init__)
    params = list(sig.parameters.keys())



def test_hyp_publication2014a_publicationstructure_is_not_abstract():
    assert not inspect.isabstract(publication2014a_PublicationStructure)


def test_hyp_publication2014a_publicationstructure_constructor_exists():
    assert callable(publication2014a_PublicationStructure.__init__)


def test_hyp_publication2014a_publicationstructure_constructor_args():
    sig = inspect.signature(publication2014a_PublicationStructure.__init__)
    params = list(sig.parameters.keys())



def test_hyp_publication2014a_reviewnote_is_not_abstract():
    assert not inspect.isabstract(publication2014a_ReviewNote)


def test_hyp_publication2014a_reviewnote_constructor_exists():
    assert callable(publication2014a_ReviewNote.__init__)


def test_hyp_publication2014a_reviewnote_constructor_args():
...
def test_hyp_publication2014a_publicationprocess_is_not_abstract():
    assert not inspect.isabstract(publication2014a_PublicationProcess)


def test_hyp_publication2014a_publicationprocess_constructor_exists():
    assert callable(publication2014a_PublicationProcess.__init__)


def test_hyp_publication2014a_publicationprocess_constructor_args():
...
def test_hyp_publication2014a_counted_id_setter(instance):
...
def test_hyp_publication2014a_named_name_setter(instance):
...
def test_hyp_publication2014a_labelled_lname_setter(instance):
...
def test_hyp_publication2014a_progress_time_setter(instance):
...
@given(instance=publication2014a_Progress_strategy)
def test_hyp_publication2014a_progress_percent_setter(instance):
...
def test_hyp_publication2014a_researcher_position_setter(instance):
...
@given(instance=publication2014a_Researcher_strategy)
def test_hyp_publication2014a_researcher_forName_setter(instance):
...
@given(instance=publication2014a_Researcher_strategy)
def test_hyp_publication2014a_researcher_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_publication2014a_sequence_sequenceType_setter(instance):
...
def test_hyp_publication2014a_rule_key_setter(instance):
...
@given(instance=publication2014a_Rule_strategy)
def test_hyp_publication2014a_rule_text_setter(instance):
...
def test_hyp_publication2014a_publicationphase_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=publication2014a_PublicationPhase_strategy)
def test_hyp_publication2014a_publicationphase_maxTime_setter(instance):
...
@given(instance=publication2014a_PublicationPhase_strategy)
def test_hyp_publication2014a_publicationphase_minTime_setter(instance):
...
def test_hyp_publication2014a_paragraph_content_setter(instance):
...
def test_hyp_publication2014a_reviewnote_content_setter(instance):
    original = instance.content
    instance.content = original
    assert instance.content == original
...
def test_hyp_publication2014a_publicationprocess_minTime_setter(instance):
    original = instance.minTime
    instance.minTime = original
    assert instance.minTime == original
...
@given(instance=publication2014a_PublicationProcess_strategy)
def test_hyp_publication2014a_publicationprocess_maxTime_setter(instance):
    original = instance.maxTime
    instance.maxTime = original
    assert instance.maxTime == original
