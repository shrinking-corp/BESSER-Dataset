...
User_Message: BinaryAssociation = BinaryAssociation(
    name="User_Message",
    ends={
        Property(name="message6", type=Message, multiplicity=Multiplicity(0, 9999)),
...
domain_model = DomainModel(
    name="b7e14f1d_e5c8_4463_a151_238edcad0f7b",
    types={User, Profile, Post, Group, Message, Friend},
    associations={User_Myprofile, User_Post, User_Group, User_Message},
    generalizations={},
    metadata=None
)
