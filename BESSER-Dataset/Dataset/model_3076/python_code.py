...
class OO_Class(Classifier):
    ...
    def __init__(self, isAbstract: str, Class12: "OO_Feature" = None, extends: set["OO_Class"] = None, owner: set["OO_Feature"] = None, Class: "OO_Class" = None, extendedBy: "OO_Class" = None, Class9: "OO_Class" = None):
...
class OO_Feature(NamedElement):
    ...
    def __init__(self, visibility: str, features: "OO_Class" = None, OO_Feature: "OO_Classifier" = None, Feature: "OO_Class" = None):
