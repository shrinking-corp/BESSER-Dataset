...
domain_model = DomainModel(
    name="OO",
    types={OO_Package, OO_AnnotatedElement, OO_Annotation, OO_NamedElement, AnnotatedElement, OO_Model, Package, OO_PackageableElement, NamedElement, OO_Datatype, OO_StructuralFeature, Feature, OO_Operation, PackageableElement, OO_Classifier, OO_ExternalClass, Class_, OO_Class, Classifier, OO_Feature, OO_Parameter, OO_Reference, StructuralFeature, OO_Attribute, VisibilityEnum},
    associations={package0, annotations1, owner11, type13, contents2, uses4, extends6, extendedBy8, features10, parameters14, type16, owner18},
    generalizations={gen_OO_NamedElement_AnnotatedElement, gen_OO_Model_Package, gen_OO_PackageableElement_NamedElement, gen_OO_Datatype_Classifier, gen_OO_Feature_NamedElement, gen_OO_StructuralFeature_Feature, gen_OO_Operation_Feature, gen_OO_Package_PackageableElement, gen_OO_Classifier_PackageableElement, gen_OO_ExternalClass_Class, gen_OO_Class_Classifier, gen_OO_Parameter_NamedElement, gen_OO_Reference_StructuralFeature, gen_OO_Attribute_StructuralFeature},
    metadata=None
)
