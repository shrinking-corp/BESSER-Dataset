...
def test_hyp_abs_mexpand_expr_is_not_abstract():
    assert not inspect.isabstract(abs_MexpAnd_expr)


def test_hyp_abs_mexpand_expr_constructor_exists():
    assert callable(abs_MexpAnd_expr.__init__)


def test_hyp_abs_mexpand_expr_constructor_args():
    sig = inspect.signature(abs_MexpAnd_expr.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_mexpmuldivormod_expr_is_not_abstract():
    assert not inspect.isabstract(abs_MexpMulDivOrMod_expr)


def test_hyp_abs_mexpmuldivormod_expr_constructor_exists():
    assert callable(abs_MexpMulDivOrMod_expr.__init__)


def test_hyp_abs_mexpmuldivormod_expr_constructor_args():
...
def test_hyp_abs_mexpimplies_expr_is_not_abstract():
    assert not inspect.isabstract(abs_MexpImplies_expr)


def test_hyp_abs_mexpimplies_expr_constructor_exists():
    assert callable(abs_MexpImplies_expr.__init__)


def test_hyp_abs_mexpimplies_expr_constructor_args():
...
def test_hyp_abs_mexpprimary_expr_is_not_abstract():
    assert not inspect.isabstract(abs_MexpPrimary_expr)


def test_hyp_abs_mexpprimary_expr_constructor_exists():
    assert callable(abs_MexpPrimary_expr.__init__)


def test_hyp_abs_mexpprimary_expr_constructor_args():
    sig = inspect.signature(abs_MexpPrimary_expr.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_mexpplusorminus_expr_is_not_abstract():
    assert not inspect.isabstract(abs_MexpPlusOrMinus_expr)


def test_hyp_abs_mexpplusorminus_expr_constructor_exists():
    assert callable(abs_MexpPlusOrMinus_expr.__init__)


def test_hyp_abs_mexpplusorminus_expr_constructor_args():
...
def test_hyp_abs_mexpor_exp_is_not_abstract():
    assert not inspect.isabstract(abs_MexpOr_exp)


def test_hyp_abs_mexpor_exp_constructor_exists():
    assert callable(abs_MexpOr_exp.__init__)


def test_hyp_abs_mexpor_exp_constructor_args():
    sig = inspect.signature(abs_MexpOr_exp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_product_expr_is_not_abstract():
    assert not inspect.isabstract(Product_expr)


def test_hyp_product_expr_constructor_exists():
    assert callable(Product_expr.__init__)


def test_hyp_product_expr_constructor_args():
    sig = inspect.signature(Product_expr.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_productminus_exp_is_not_abstract():
    assert not inspect.isabstract(abs_ProductMinus_exp)


def test_hyp_abs_productminus_exp_constructor_exists():
    assert callable(abs_ProductMinus_exp.__init__)


def test_hyp_abs_productminus_exp_constructor_args():
    sig = inspect.signature(abs_ProductMinus_exp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_productand_exp_is_not_abstract():
    assert not inspect.isabstract(abs_ProductAnd_exp)


def test_hyp_abs_productand_exp_constructor_exists():
    assert callable(abs_ProductAnd_exp.__init__)


def test_hyp_abs_productand_exp_constructor_args():
    sig = inspect.signature(abs_ProductAnd_exp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_productor_expr_is_not_abstract():
    assert not inspect.isabstract(abs_ProductOr_expr)


def test_hyp_abs_productor_expr_constructor_exists():
    assert callable(abs_ProductOr_expr.__init__)


def test_hyp_abs_productor_expr_constructor_args():
    sig = inspect.signature(abs_ProductOr_expr.__init__)
    params = list(sig.parameters.keys())



def test_hyp_application_condition_is_not_abstract():
    assert not inspect.isabstract(Application_condition)


def test_hyp_application_condition_constructor_exists():
    assert callable(Application_condition.__init__)


def test_hyp_application_condition_constructor_args():
    sig = inspect.signature(Application_condition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_appand_exp_is_not_abstract():
    assert not inspect.isabstract(abs_AppAnd_exp)


def test_hyp_abs_appand_exp_constructor_exists():
    assert callable(abs_AppAnd_exp.__init__)


def test_hyp_abs_appand_exp_constructor_args():
    sig = inspect.signature(abs_AppAnd_exp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_appor_exp_is_not_abstract():
    assert not inspect.isabstract(abs_AppOr_exp)


def test_hyp_abs_appor_exp_constructor_exists():
    assert callable(abs_AppOr_exp.__init__)


def test_hyp_abs_appor_exp_constructor_args():
    sig = inspect.signature(abs_AppOr_exp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_mexpcomparison_expr_is_not_abstract():
    assert not inspect.isabstract(abs_MexpComparison_expr)


def test_hyp_abs_mexpcomparison_expr_constructor_exists():
    assert callable(abs_MexpComparison_expr.__init__)


def test_hyp_abs_mexpcomparison_expr_constructor_args():
...
def test_hyp_abs_mexpequality_expr_is_not_abstract():
    assert not inspect.isabstract(abs_MexpEquality_expr)


def test_hyp_abs_mexpequality_expr_constructor_exists():
    assert callable(abs_MexpEquality_expr.__init__)


def test_hyp_abs_mexpequality_expr_constructor_args():
...
def test_hyp_abs_andguard_is_not_abstract():
    assert not inspect.isabstract(abs_AndGuard)


def test_hyp_abs_andguard_constructor_exists():
    assert callable(abs_AndGuard.__init__)


def test_hyp_abs_andguard_constructor_args():
...
def test_hyp_abs_mexp_is_not_abstract():
    assert not inspect.isabstract(abs_Mexp)


def test_hyp_abs_mexp_constructor_exists():
    assert callable(abs_Mexp.__init__)


def test_hyp_abs_mexp_constructor_args():
...
def test_hyp_abs_fnode_is_not_abstract():
    assert not inspect.isabstract(abs_Fnode)


def test_hyp_abs_fnode_constructor_exists():
    assert callable(abs_Fnode.__init__)


def test_hyp_abs_fnode_constructor_args():
    sig = inspect.signature(abs_Fnode.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_feature_decl_constraint_is_not_abstract():
    assert not inspect.isabstract(abs_Feature_decl_constraint)


def test_hyp_abs_feature_decl_constraint_constructor_exists():
    assert callable(abs_Feature_decl_constraint.__init__)


def test_hyp_abs_feature_decl_constraint_constructor_args():
    sig = inspect.signature(abs_Feature_decl_constraint.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_feature_decl_attribute_is_not_abstract():
    assert not inspect.isabstract(abs_Feature_decl_attribute)


def test_hyp_abs_feature_decl_attribute_constructor_exists():
    assert callable(abs_Feature_decl_attribute.__init__)


def test_hyp_abs_feature_decl_attribute_constructor_args():
...
def test_hyp_abs_feature_decl_group_is_not_abstract():
    assert not inspect.isabstract(abs_Feature_decl_group)


def test_hyp_abs_feature_decl_group_constructor_exists():
    assert callable(abs_Feature_decl_group.__init__)


def test_hyp_abs_feature_decl_group_constructor_args():
    sig = inspect.signature(abs_Feature_decl_group.__init__)
    params = list(sig.parameters.keys())



def test_hyp_fnode_is_not_abstract():
    assert not inspect.isabstract(Fnode)


def test_hyp_fnode_constructor_exists():
    assert callable(Fnode.__init__)


def test_hyp_fnode_constructor_args():
    sig = inspect.signature(Fnode.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_product_expr_is_not_abstract():
    assert not inspect.isabstract(abs_Product_expr)


def test_hyp_abs_product_expr_constructor_exists():
    assert callable(abs_Product_expr.__init__)


def test_hyp_abs_product_expr_constructor_args():
    sig = inspect.signature(abs_Product_expr.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_product_reconfiguration_is_not_abstract():
    assert not inspect.isabstract(abs_Product_reconfiguration)


def test_hyp_abs_product_reconfiguration_constructor_exists():
    assert callable(abs_Product_reconfiguration.__init__)


def test_hyp_abs_product_reconfiguration_constructor_args():
...
def test_hyp_abs_application_condition_is_not_abstract():
    assert not inspect.isabstract(abs_Application_condition)


def test_hyp_abs_application_condition_constructor_exists():
    assert callable(abs_Application_condition.__init__)


def test_hyp_abs_application_condition_constructor_args():
    sig = inspect.signature(abs_Application_condition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_deltaspec_is_not_abstract():
    assert not inspect.isabstract(abs_Deltaspec)


def test_hyp_abs_deltaspec_constructor_exists():
    assert callable(abs_Deltaspec.__init__)


def test_hyp_abs_deltaspec_constructor_args():
...
def test_hyp_abs_when_condition_is_not_abstract():
    assert not inspect.isabstract(abs_When_condition)


def test_hyp_abs_when_condition_constructor_exists():
    assert callable(abs_When_condition.__init__)


def test_hyp_abs_when_condition_constructor_args():
    sig = inspect.signature(abs_When_condition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_from_condition_is_not_abstract():
    assert not inspect.isabstract(abs_From_condition)


def test_hyp_abs_from_condition_constructor_exists():
    assert callable(abs_From_condition.__init__)


def test_hyp_abs_from_condition_constructor_args():
    sig = inspect.signature(abs_From_condition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_after_condition_is_not_abstract():
    assert not inspect.isabstract(abs_After_condition)


def test_hyp_abs_after_condition_constructor_exists():
    assert callable(abs_After_condition.__init__)


def test_hyp_abs_after_condition_constructor_args():
    sig = inspect.signature(abs_After_condition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_class_modifier_fragment_is_not_abstract():
    assert not inspect.isabstract(abs_Class_modifier_fragment)


def test_hyp_abs_class_modifier_fragment_constructor_exists():
    assert callable(abs_Class_modifier_fragment.__init__)


def test_hyp_abs_class_modifier_fragment_constructor_args():
    sig = inspect.signature(abs_Class_modifier_fragment.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_delta_clause_is_not_abstract():
    assert not inspect.isabstract(abs_Delta_clause)


def test_hyp_abs_delta_clause_constructor_exists():
    assert callable(abs_Delta_clause.__init__)


def test_hyp_abs_delta_clause_constructor_args():
    sig = inspect.signature(abs_Delta_clause.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_feature_is_not_abstract():
    assert not inspect.isabstract(abs_Feature)


def test_hyp_abs_feature_constructor_exists():
    assert callable(abs_Feature.__init__)


def test_hyp_abs_feature_constructor_args():
...
def test_hyp_abs_object_update_assign_stmt_is_not_abstract():
    assert not inspect.isabstract(abs_Object_update_assign_stmt)


def test_hyp_abs_object_update_assign_stmt_constructor_exists():
    assert callable(abs_Object_update_assign_stmt.__init__)


def test_hyp_abs_object_update_assign_stmt_constructor_args():
    sig = inspect.signature(abs_Object_update_assign_stmt.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_update_preamble_declaration_is_not_abstract():
    assert not inspect.isabstract(abs_Update_preamble_declaration)


def test_hyp_abs_update_preamble_declaration_constructor_exists():
    assert callable(abs_Update_preamble_declaration.__init__)


def test_hyp_abs_update_preamble_declaration_constructor_args():
    sig = inspect.signature(abs_Update_preamble_declaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_object_update_is_not_abstract():
    assert not inspect.isabstract(abs_Object_update)


def test_hyp_abs_object_update_constructor_exists():
    assert callable(abs_Object_update.__init__)


def test_hyp_abs_object_update_constructor_args():
    sig = inspect.signature(abs_Object_update.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_interface_modifier_fragment_is_not_abstract():
    assert not inspect.isabstract(abs_Interface_modifier_fragment)


def test_hyp_abs_interface_modifier_fragment_constructor_exists():
    assert callable(abs_Interface_modifier_fragment.__init__)


def test_hyp_abs_interface_modifier_fragment_constructor_args():
    sig = inspect.signature(abs_Interface_modifier_fragment.__init__)
    params = list(sig.parameters.keys())



def test_hyp_module_modifier_is_not_abstract():
    assert not inspect.isabstract(Module_modifier)


def test_hyp_module_modifier_constructor_exists():
    assert callable(Module_modifier.__init__)


def test_hyp_module_modifier_constructor_args():
    sig = inspect.signature(Module_modifier.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_oo_modifier_is_not_abstract():
    assert not inspect.isabstract(abs_OO_modifier)


def test_hyp_abs_oo_modifier_constructor_exists():
    assert callable(abs_OO_modifier.__init__)


def test_hyp_abs_oo_modifier_constructor_args():
    sig = inspect.signature(abs_OO_modifier.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_namespace_modifier_is_not_abstract():
    assert not inspect.isabstract(abs_Namespace_modifier)


def test_hyp_abs_namespace_modifier_constructor_exists():
    assert callable(abs_Namespace_modifier.__init__)


def test_hyp_abs_namespace_modifier_constructor_args():
...
def test_hyp_abs_functional_modifier_is_not_abstract():
    assert not inspect.isabstract(abs_Functional_modifier)


def test_hyp_abs_functional_modifier_constructor_exists():
    assert callable(abs_Functional_modifier.__init__)


def test_hyp_abs_functional_modifier_constructor_args():
    sig = inspect.signature(abs_Functional_modifier.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_module_modifier_is_not_abstract():
    assert not inspect.isabstract(abs_Module_modifier)


def test_hyp_abs_module_modifier_constructor_exists():
    assert callable(abs_Module_modifier.__init__)


def test_hyp_abs_module_modifier_constructor_args():
    sig = inspect.signature(abs_Module_modifier.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_delta_access_is_not_abstract():
    assert not inspect.isabstract(abs_Delta_access)


def test_hyp_abs_delta_access_constructor_exists():
    assert callable(abs_Delta_access.__init__)


def test_hyp_abs_delta_access_constructor_args():
    sig = inspect.signature(abs_Delta_access.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_delta_param_is_not_abstract():
    assert not inspect.isabstract(abs_Delta_param)


def test_hyp_abs_delta_param_constructor_exists():
    assert callable(abs_Delta_param.__init__)


def test_hyp_abs_delta_param_constructor_args():
    sig = inspect.signature(abs_Delta_param.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_trait_oper_is_not_abstract():
    assert not inspect.isabstract(abs_Trait_oper)


def test_hyp_abs_trait_oper_constructor_exists():
    assert callable(abs_Trait_oper.__init__)


def test_hyp_abs_trait_oper_constructor_args():
    sig = inspect.signature(abs_Trait_oper.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_guard_is_not_abstract():
    assert not inspect.isabstract(abs_Guard)


def test_hyp_abs_guard_constructor_exists():
    assert callable(abs_Guard.__init__)


def test_hyp_abs_guard_constructor_args():
    sig = inspect.signature(abs_Guard.__init__)
    params = list(sig.parameters.keys())



def test_hyp_interface_modifier_fragment_is_not_abstract():
    assert not inspect.isabstract(Interface_modifier_fragment)


def test_hyp_interface_modifier_fragment_constructor_exists():
    assert callable(Interface_modifier_fragment.__init__)


def test_hyp_interface_modifier_fragment_constructor_args():
    sig = inspect.signature(Interface_modifier_fragment.__init__)
    params = list(sig.parameters.keys())



def test_hyp_class_modifier_fragment_is_not_abstract():
    assert not inspect.isabstract(Class_modifier_fragment)


def test_hyp_class_modifier_fragment_constructor_exists():
    assert callable(Class_modifier_fragment.__init__)


def test_hyp_class_modifier_fragment_constructor_args():
    sig = inspect.signature(Class_modifier_fragment.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_trait_expr_is_not_abstract():
    assert not inspect.isabstract(abs_Trait_expr)


def test_hyp_abs_trait_expr_constructor_exists():
    assert callable(abs_Trait_expr.__init__)


def test_hyp_abs_trait_expr_constructor_args():
    sig = inspect.signature(abs_Trait_expr.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_interface_name_is_not_abstract():
    assert not inspect.isabstract(abs_Interface_name)


def test_hyp_abs_interface_name_constructor_exists():
    assert callable(abs_Interface_name.__init__)


def test_hyp_abs_interface_name_constructor_args():
...
def test_hyp_abs_methodsig_is_not_abstract():
    assert not inspect.isabstract(abs_Methodsig)


def test_hyp_abs_methodsig_constructor_exists():
    assert callable(abs_Methodsig.__init__)


def test_hyp_abs_methodsig_constructor_args():
...
def test_hyp_abs_exp_is_not_abstract():
    assert not inspect.isabstract(abs_Exp)


def test_hyp_abs_exp_constructor_exists():
    assert callable(abs_Exp.__init__)


def test_hyp_abs_exp_constructor_args():
    sig = inspect.signature(abs_Exp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_method_is_not_abstract():
    assert not inspect.isabstract(abs_Method)


def test_hyp_abs_method_constructor_exists():
    assert callable(abs_Method.__init__)


def test_hyp_abs_method_constructor_args():
...
def test_hyp_abs_trait_usage_is_not_abstract():
    assert not inspect.isabstract(abs_Trait_usage)


def test_hyp_abs_trait_usage_constructor_exists():
    assert callable(abs_Trait_usage.__init__)


def test_hyp_abs_trait_usage_constructor_args():
    sig = inspect.signature(abs_Trait_usage.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_casestmtbranch_is_not_abstract():
    assert not inspect.isabstract(abs_Casestmtbranch)


def test_hyp_abs_casestmtbranch_constructor_exists():
    assert callable(abs_Casestmtbranch.__init__)


def test_hyp_abs_casestmtbranch_constructor_args():
    sig = inspect.signature(abs_Casestmtbranch.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_stmt_is_not_abstract():
    assert not inspect.isabstract(abs_Stmt)


def test_hyp_abs_stmt_constructor_exists():
    assert callable(abs_Stmt.__init__)


def test_hyp_abs_stmt_constructor_args():
...
def test_hyp_case_branch_is_not_abstract():
    assert not inspect.isabstract(Case_branch)


def test_hyp_case_branch_constructor_exists():
    assert callable(Case_branch.__init__)


def test_hyp_case_branch_constructor_args():
    sig = inspect.signature(Case_branch.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_pattern_is_not_abstract():
    assert not inspect.isabstract(abs_Pattern)


def test_hyp_abs_pattern_constructor_exists():
    assert callable(abs_Pattern.__init__)


def test_hyp_abs_pattern_constructor_args():
    sig = inspect.signature(abs_Pattern.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_field_decl_is_not_abstract():
    assert not inspect.isabstract(abs_Field_decl)


def test_hyp_abs_field_decl_constructor_exists():
    assert callable(abs_Field_decl.__init__)


def test_hyp_abs_field_decl_constructor_args():
...
def test_hyp_pure_exp_is_not_abstract():
    assert not inspect.isabstract(Pure_exp)


def test_hyp_pure_exp_constructor_exists():
    assert callable(Pure_exp.__init__)


def test_hyp_pure_exp_constructor_args():
    sig = inspect.signature(Pure_exp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_or_expr_is_not_abstract():
    assert not inspect.isabstract(abs_Or_expr)


def test_hyp_abs_or_expr_constructor_exists():
    assert callable(abs_Or_expr.__init__)


def test_hyp_abs_or_expr_constructor_args():
    sig = inspect.signature(abs_Or_expr.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_and_expr_is_not_abstract():
    assert not inspect.isabstract(abs_And_expr)


def test_hyp_abs_and_expr_constructor_exists():
    assert callable(abs_And_expr.__init__)


def test_hyp_abs_and_expr_constructor_args():
    sig = inspect.signature(abs_And_expr.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_equality_expr_is_not_abstract():
    assert not inspect.isabstract(abs_Equality_expr)


def test_hyp_abs_equality_expr_constructor_exists():
    assert callable(abs_Equality_expr.__init__)


def test_hyp_abs_equality_expr_constructor_args():
    sig = inspect.signature(abs_Equality_expr.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_muldivormod_expr_is_not_abstract():
    assert not inspect.isabstract(abs_MulDivOrMod_expr)


def test_hyp_abs_muldivormod_expr_constructor_exists():
    assert callable(abs_MulDivOrMod_expr.__init__)


def test_hyp_abs_muldivormod_expr_constructor_args():
    sig = inspect.signature(abs_MulDivOrMod_expr.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_plusorminus_expr_is_not_abstract():
    assert not inspect.isabstract(abs_PlusOrMinus_expr)


def test_hyp_abs_plusorminus_expr_constructor_exists():
    assert callable(abs_PlusOrMinus_expr.__init__)


def test_hyp_abs_plusorminus_expr_constructor_args():
    sig = inspect.signature(abs_PlusOrMinus_expr.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_comparison_expr_is_not_abstract():
    assert not inspect.isabstract(abs_Comparison_expr)


def test_hyp_abs_comparison_expr_constructor_exists():
    assert callable(abs_Comparison_expr.__init__)


def test_hyp_abs_comparison_expr_constructor_args():
    sig = inspect.signature(abs_Comparison_expr.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_var_or_field_ref_is_not_abstract():
    assert not inspect.isabstract(abs_Var_or_field_ref)


def test_hyp_abs_var_or_field_ref_constructor_exists():
    assert callable(abs_Var_or_field_ref.__init__)


def test_hyp_abs_var_or_field_ref_constructor_args():
...
def test_hyp_update_preamble_declaration_is_not_abstract():
    assert not inspect.isabstract(Update_preamble_declaration)


def test_hyp_update_preamble_declaration_constructor_exists():
    assert callable(Update_preamble_declaration.__init__)


def test_hyp_update_preamble_declaration_constructor_args():
    sig = inspect.signature(Update_preamble_declaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_type_exp_is_not_abstract():
    assert not inspect.isabstract(abs_Type_exp)


def test_hyp_abs_type_exp_constructor_exists():
    assert callable(abs_Type_exp.__init__)


def test_hyp_abs_type_exp_constructor_args():
...
def test_hyp_delta_param_is_not_abstract():
    assert not inspect.isabstract(Delta_param)


def test_hyp_delta_param_constructor_exists():
    assert callable(Delta_param.__init__)


def test_hyp_delta_param_constructor_args():
    sig = inspect.signature(Delta_param.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_has_condition_is_not_abstract():
    assert not inspect.isabstract(abs_Has_condition)


def test_hyp_abs_has_condition_constructor_exists():
    assert callable(abs_Has_condition.__init__)


def test_hyp_abs_has_condition_constructor_args():
    sig = inspect.signature(abs_Has_condition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_param_decl_is_not_abstract():
    assert not inspect.isabstract(abs_Param_decl)


def test_hyp_abs_param_decl_constructor_exists():
    assert callable(abs_Param_decl.__init__)


def test_hyp_abs_param_decl_constructor_args():
...
def test_hyp_function_param_is_not_abstract():
    assert not inspect.isabstract(Function_param)


def test_hyp_function_param_constructor_exists():
    assert callable(Function_param.__init__)


def test_hyp_function_param_constructor_args():
    sig = inspect.signature(Function_param.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_anon_function_decl_is_not_abstract():
    assert not inspect.isabstract(abs_Anon_function_decl)


def test_hyp_abs_anon_function_decl_constructor_exists():
    assert callable(abs_Anon_function_decl.__init__)


def test_hyp_abs_anon_function_decl_constructor_args():
    sig = inspect.signature(abs_Anon_function_decl.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_function_name_param_decl_is_not_abstract():
    assert not inspect.isabstract(abs_Function_name_param_decl)


def test_hyp_abs_function_name_param_decl_constructor_exists():
    assert callable(abs_Function_name_param_decl.__init__)


def test_hyp_abs_function_name_param_decl_constructor_args():
...
def test_hyp_abs_pure_exp_list_is_not_abstract():
    assert not inspect.isabstract(abs_Pure_exp_list)


def test_hyp_abs_pure_exp_list_constructor_exists():
    assert callable(abs_Pure_exp_list.__init__)


def test_hyp_abs_pure_exp_list_constructor_args():
    sig = inspect.signature(abs_Pure_exp_list.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_function_param_is_not_abstract():
    assert not inspect.isabstract(abs_Function_param)


def test_hyp_abs_function_param_constructor_exists():
    assert callable(abs_Function_param.__init__)


def test_hyp_abs_function_param_constructor_args():
    sig = inspect.signature(abs_Function_param.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_function_list_is_not_abstract():
    assert not inspect.isabstract(abs_Function_list)


def test_hyp_abs_function_list_constructor_exists():
    assert callable(abs_Function_list.__init__)


def test_hyp_abs_function_list_constructor_args():
    sig = inspect.signature(abs_Function_list.__init__)
    params = list(sig.parameters.keys())



def test_hyp_eff_expr_is_not_abstract():
    assert not inspect.isabstract(Eff_expr)


def test_hyp_eff_expr_constructor_exists():
    assert callable(Eff_expr.__init__)


def test_hyp_eff_expr_constructor_args():
    sig = inspect.signature(Eff_expr.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_delta_id_is_not_abstract():
    assert not inspect.isabstract(abs_Delta_id)


def test_hyp_abs_delta_id_constructor_exists():
    assert callable(abs_Delta_id.__init__)


def test_hyp_abs_delta_id_constructor_args():
...
def test_hyp_abs_eff_expr_is_not_abstract():
    assert not inspect.isabstract(abs_Eff_expr)


def test_hyp_abs_eff_expr_constructor_exists():
    assert callable(abs_Eff_expr.__init__)


def test_hyp_abs_eff_expr_constructor_args():
...
def test_hyp_data_constructor_arg_is_not_abstract():
    assert not inspect.isabstract(Data_constructor_arg)


def test_hyp_data_constructor_arg_constructor_exists():
    assert callable(Data_constructor_arg.__init__)


def test_hyp_data_constructor_arg_constructor_args():
    sig = inspect.signature(Data_constructor_arg.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_case_branch_is_not_abstract():
    assert not inspect.isabstract(abs_Case_branch)


def test_hyp_abs_case_branch_constructor_exists():
    assert callable(abs_Case_branch.__init__)


def test_hyp_abs_case_branch_constructor_args():
    sig = inspect.signature(abs_Case_branch.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_main_block_is_not_abstract():
    assert not inspect.isabstract(abs_Main_block)


def test_hyp_abs_main_block_constructor_exists():
    assert callable(abs_Main_block.__init__)


def test_hyp_abs_main_block_constructor_args():
    sig = inspect.signature(abs_Main_block.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_decl_is_not_abstract():
    assert not inspect.isabstract(abs_Decl)


def test_hyp_abs_decl_constructor_exists():
    assert callable(abs_Decl.__init__)


def test_hyp_abs_decl_constructor_args():
...
def test_hyp_abs_fextension_is_not_abstract():
    assert not inspect.isabstract(abs_Fextension)


def test_hyp_abs_fextension_constructor_exists():
    assert callable(abs_Fextension.__init__)


def test_hyp_abs_fextension_constructor_args():
...
def test_hyp_abs_feature_decl_is_not_abstract():
    assert not inspect.isabstract(abs_Feature_decl)


def test_hyp_abs_feature_decl_constructor_exists():
    assert callable(abs_Feature_decl.__init__)


def test_hyp_abs_feature_decl_constructor_args():
...
def test_hyp_abs_annotation_is_not_abstract():
    assert not inspect.isabstract(abs_Annotation)


def test_hyp_abs_annotation_constructor_exists():
    assert callable(abs_Annotation.__init__)


def test_hyp_abs_annotation_constructor_args():
    sig = inspect.signature(abs_Annotation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_annotations_is_not_abstract():
    assert not inspect.isabstract(abs_Annotations)


def test_hyp_abs_annotations_constructor_exists():
    assert callable(abs_Annotations.__init__)


def test_hyp_abs_annotations_constructor_args():
    sig = inspect.signature(abs_Annotations.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_data_constructor_arg_is_not_abstract():
    assert not inspect.isabstract(abs_Data_constructor_arg)


def test_hyp_abs_data_constructor_arg_constructor_exists():
    assert callable(abs_Data_constructor_arg.__init__)


def test_hyp_abs_data_constructor_arg_constructor_args():
    sig = inspect.signature(abs_Data_constructor_arg.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_data_constructor_is_not_abstract():
    assert not inspect.isabstract(abs_Data_constructor)


def test_hyp_abs_data_constructor_constructor_exists():
    assert callable(abs_Data_constructor.__init__)


def test_hyp_abs_data_constructor_constructor_args():
...
def test_hyp_functional_modifier_is_not_abstract():
    assert not inspect.isabstract(Functional_modifier)


def test_hyp_functional_modifier_constructor_exists():
    assert callable(Functional_modifier.__init__)


def test_hyp_functional_modifier_constructor_args():
    sig = inspect.signature(Functional_modifier.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_function_name_decl_is_not_abstract():
    assert not inspect.isabstract(abs_Function_name_decl)


def test_hyp_abs_function_name_decl_constructor_exists():
    assert callable(abs_Function_name_decl.__init__)


def test_hyp_abs_function_name_decl_constructor_args():
...
def test_hyp_abs_pure_exp_is_not_abstract():
    assert not inspect.isabstract(abs_Pure_exp)


def test_hyp_abs_pure_exp_constructor_exists():
    assert callable(abs_Pure_exp.__init__)


def test_hyp_abs_pure_exp_constructor_args():
...
def test_hyp_abs_param_list_is_not_abstract():
    assert not inspect.isabstract(abs_Param_list)


def test_hyp_abs_param_list_constructor_exists():
    assert callable(abs_Param_list.__init__)


def test_hyp_abs_param_list_constructor_args():
    sig = inspect.signature(abs_Param_list.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_function_name_list_is_not_abstract():
    assert not inspect.isabstract(abs_Function_name_list)


def test_hyp_abs_function_name_list_constructor_exists():
    assert callable(abs_Function_name_list.__init__)


def test_hyp_abs_function_name_list_constructor_args():
    sig = inspect.signature(abs_Function_name_list.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_type_use_is_not_abstract():
    assert not inspect.isabstract(abs_Type_use)


def test_hyp_abs_type_use_constructor_exists():
    assert callable(abs_Type_use.__init__)


def test_hyp_abs_type_use_constructor_args():
...
def test_hyp_abs_function_decl_is_not_abstract():
    assert not inspect.isabstract(abs_Function_decl)


def test_hyp_abs_function_decl_constructor_exists():
    assert callable(abs_Function_decl.__init__)


def test_hyp_abs_function_decl_constructor_args():
...
def test_hyp_abs_interface_decl_is_not_abstract():
    assert not inspect.isabstract(abs_Interface_decl)


def test_hyp_abs_interface_decl_constructor_exists():
    assert callable(abs_Interface_decl.__init__)


def test_hyp_abs_interface_decl_constructor_args():
    sig = inspect.signature(abs_Interface_decl.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_exception_decl_is_not_abstract():
    assert not inspect.isabstract(abs_Exception_decl)


def test_hyp_abs_exception_decl_constructor_exists():
    assert callable(abs_Exception_decl.__init__)


def test_hyp_abs_exception_decl_constructor_args():
    sig = inspect.signature(abs_Exception_decl.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_datatype_decl_is_not_abstract():
    assert not inspect.isabstract(abs_DataType_decl)


def test_hyp_abs_datatype_decl_constructor_exists():
    assert callable(abs_DataType_decl.__init__)


def test_hyp_abs_datatype_decl_constructor_args():
...
def test_hyp_abs_trait_decl_is_not_abstract():
    assert not inspect.isabstract(abs_Trait_decl)


def test_hyp_abs_trait_decl_constructor_exists():
    assert callable(abs_Trait_decl.__init__)


def test_hyp_abs_trait_decl_constructor_args():
    sig = inspect.signature(abs_Trait_decl.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_typesyn_decl_is_not_abstract():
    assert not inspect.isabstract(abs_Typesyn_decl)


def test_hyp_abs_typesyn_decl_constructor_exists():
    assert callable(abs_Typesyn_decl.__init__)


def test_hyp_abs_typesyn_decl_constructor_args():
    sig = inspect.signature(abs_Typesyn_decl.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_class_decl_is_not_abstract():
    assert not inspect.isabstract(abs_Class_decl)


def test_hyp_abs_class_decl_constructor_exists():
    assert callable(abs_Class_decl.__init__)


def test_hyp_abs_class_decl_constructor_args():
    sig = inspect.signature(abs_Class_decl.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_par_function_decl_is_not_abstract():
    assert not inspect.isabstract(abs_Par_function_decl)


def test_hyp_abs_par_function_decl_constructor_exists():
    assert callable(abs_Par_function_decl.__init__)


def test_hyp_abs_par_function_decl_constructor_args():
...
def test_hyp_namespace_modifier_is_not_abstract():
    assert not inspect.isabstract(Namespace_modifier)


def test_hyp_namespace_modifier_constructor_exists():
    assert callable(Namespace_modifier.__init__)


def test_hyp_namespace_modifier_constructor_args():
    sig = inspect.signature(Namespace_modifier.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_module_import_is_not_abstract():
    assert not inspect.isabstract(abs_Module_import)


def test_hyp_abs_module_import_constructor_exists():
    assert callable(abs_Module_import.__init__)


def test_hyp_abs_module_import_constructor_args():
...
def test_hyp_abs_module_export_is_not_abstract():
    assert not inspect.isabstract(abs_Module_export)


def test_hyp_abs_module_export_constructor_exists():
    assert callable(abs_Module_export.__init__)


def test_hyp_abs_module_export_constructor_args():
...
def test_hyp_abs_product_decl_is_not_abstract():
    assert not inspect.isabstract(abs_Product_decl)


def test_hyp_abs_product_decl_constructor_exists():
    assert callable(abs_Product_decl.__init__)


def test_hyp_abs_product_decl_constructor_args():
...
def test_hyp_abs_productline_decl_is_not_abstract():
    assert not inspect.isabstract(abs_Productline_decl)


def test_hyp_abs_productline_decl_constructor_exists():
    assert callable(abs_Productline_decl.__init__)


def test_hyp_abs_productline_decl_constructor_args():
...
def test_hyp_abs_update_decl_is_not_abstract():
    assert not inspect.isabstract(abs_Update_decl)


def test_hyp_abs_update_decl_constructor_exists():
    assert callable(abs_Update_decl.__init__)


def test_hyp_abs_update_decl_constructor_args():
...
def test_hyp_abs_delta_decl_is_not_abstract():
    assert not inspect.isabstract(abs_Delta_decl)


def test_hyp_abs_delta_decl_constructor_exists():
    assert callable(abs_Delta_decl.__init__)


def test_hyp_abs_delta_decl_constructor_args():
...
def test_hyp_abs_module_decl_is_not_abstract():
    assert not inspect.isabstract(abs_Module_decl)


def test_hyp_abs_module_decl_constructor_exists():
    assert callable(abs_Module_decl.__init__)


def test_hyp_abs_module_decl_constructor_args():
...
def test_hyp_abs_compilation_unit_is_not_abstract():
    assert not inspect.isabstract(abs_Compilation_Unit)


def test_hyp_abs_compilation_unit_constructor_exists():
    assert callable(abs_Compilation_Unit.__init__)


def test_hyp_abs_compilation_unit_constructor_args():
    sig = inspect.signature(abs_Compilation_Unit.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abs_domainmodel__is_not_abstract():
    assert not inspect.isabstract(abs_DomainModel_)


def test_hyp_abs_domainmodel__constructor_exists():
    assert callable(abs_DomainModel_.__init__)


def test_hyp_abs_domainmodel__constructor_args():
...
def test_hyp_abs_mexpmuldivormod_expr_op_setter(instance):
...
def test_hyp_abs_mexpimplies_expr_op_setter(instance):
    original = instance.op
    instance.op = original
    assert instance.op == original
...
def test_hyp_abs_mexpplusorminus_expr_op_setter(instance):
    original = instance.op
    instance.op = original
    assert instance.op == original
...
def test_hyp_abs_mexpcomparison_expr_op_setter(instance):
    original = instance.op
    instance.op = original
    assert instance.op == original
...
def test_hyp_abs_mexpequality_expr_op_setter(instance):
    original = instance.op
    instance.op = original
    assert instance.op == original
...
def test_hyp_abs_andguard_op_setter(instance):
    original = instance.op
    instance.op = original
    assert instance.op == original
...
def test_hyp_abs_mexp_value_setter(instance):
...
def test_hyp_abs_feature_decl_attribute_boundary_val_setter(instance):
...
@given(instance=abs_Feature_decl_attribute_strategy)
def test_hyp_abs_feature_decl_attribute_uBoundary_int_setter(instance):
...
@given(instance=abs_Feature_decl_attribute_strategy)
def test_hyp_abs_feature_decl_attribute_lBoundary_int_setter(instance):
...
def test_hyp_abs_product_reconfiguration_name_setter(instance):
...
@given(instance=abs_Product_reconfiguration_strategy)
def test_hyp_abs_product_reconfiguration_update_setter(instance):
...
def test_hyp_abs_deltaspec_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=abs_Deltaspec_strategy)
def test_hyp_abs_deltaspec_deltaspec_param_setter(instance):
...
def test_hyp_abs_feature_p_setter(instance):
    original = instance.p
    instance.p = original
...
@given(instance=abs_Feature_strategy)
def test_hyp_abs_feature_attr_assignment_setter(instance):
...
def test_hyp_abs_namespace_modifier_star_setter(instance):
...
def test_hyp_abs_interface_name_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_abs_methodsig_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_abs_method_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_abs_stmt_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_abs_field_decl_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_abs_var_or_field_ref_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_abs_type_exp_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_abs_param_decl_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_abs_function_name_param_decl_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_abs_delta_id_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_abs_eff_expr_l_setter(instance):
    original = instance.l
    instance.l = original
...
def test_hyp_abs_decl_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_abs_fextension_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_abs_feature_decl_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_abs_data_constructor_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_abs_function_name_decl_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_abs_pure_exp_await__setter(instance):
...
@given(instance=abs_Pure_exp_strategy)
def test_hyp_abs_pure_exp_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
@given(instance=abs_Pure_exp_strategy)
def test_hyp_abs_pure_exp_val_setter(instance):
...
@given(instance=abs_Pure_exp_strategy)
def test_hyp_abs_pure_exp_op_setter(instance):
    original = instance.op
    instance.op = original
    assert instance.op == original
...
def test_hyp_abs_type_use_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_abs_function_decl_p_setter(instance):
    original = instance.p
    instance.p = original
    assert instance.p == original
...
def test_hyp_abs_datatype_decl_p_setter(instance):
    original = instance.p
    instance.p = original
    assert instance.p == original
...
def test_hyp_abs_par_function_decl_p_setter(instance):
    original = instance.p
    instance.p = original
    assert instance.p == original
...
def test_hyp_abs_module_import_importedNamespace_setter(instance):
...
@given(instance=abs_Module_import_strategy)
def test_hyp_abs_module_import_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_abs_module_export_importedNamespace_setter(instance):
    original = instance.importedNamespace
    instance.importedNamespace = original
    assert instance.importedNamespace == original
...
@given(instance=abs_Module_export_strategy)
def test_hyp_abs_module_export_anyPackage_setter(instance):
...
def test_hyp_abs_product_decl_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_abs_productline_decl_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_abs_update_decl_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_abs_delta_decl_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_abs_module_decl_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
