...
# Classes
abs_DomainModel = Class(name="abs_DomainModel_")
abs_Compilation_Unit = Class(name="abs_Compilation_Unit")
DomainModel_ = Class(name="DomainModel_")
abs_Module_decl = Class(name="abs_Module_decl")
abs_Delta_decl = Class(name="abs_Delta_decl")
abs_Update_decl = Class(name="abs_Update_decl")
abs_Productline_decl = Class(name="abs_Productline_decl")
abs_Product_decl = Class(name="abs_Product_decl")
Namespace_modifier = Class(name="Namespace_modifier")
abs_Par_function_decl = Class(name="abs_Par_function_decl")
Decl = Class(name="Decl")
abs_Type_use = Class(name="abs_Type_use")
abs_Function_name_list = Class(name="abs_Function_name_list")
abs_Param_list = Class(name="abs_Param_list")
abs_Pure_exp = Class(name="abs_Pure_exp")
abs_Function_name_decl = Class(name="abs_Function_name_decl")
abs_DataType_decl = Class(name="abs_DataType_decl")
Functional_modifier = Class(name="Functional_modifier")
abs_Data_constructor = Class(name="abs_Data_constructor")
abs_Data_constructor_arg = Class(name="abs_Data_constructor_arg")
abs_Annotations = Class(name="abs_Annotations")
abs_Annotation = Class(name="abs_Annotation")
abs_Feature_decl = Class(name="abs_Feature_decl")
abs_Fextension = Class(name="abs_Fextension")
abs_Module_export = Class(name="abs_Module_export")
abs_Module_import = Class(name="abs_Module_import")
abs_Decl = Class(name="abs_Decl")
abs_Main_block = Class(name="abs_Main_block")
abs_Case_branch = Class(name="abs_Case_branch")
Data_constructor_arg = Class(name="Data_constructor_arg")
Annotation = Class(name="Annotation")
Exp = Class(name="Exp")
Eff_expr = Class(name="Eff_expr")
abs_Function_list = Class(name="abs_Function_list")
abs_Function_param = Class(name="abs_Function_param")
abs_Pure_exp_list = Class(name="abs_Pure_exp_list")
abs_Function_name_param_decl = Class(name="abs_Function_name_param_decl")
Function_param = Class(name="Function_param")
abs_Anon_function_decl = Class(name="abs_Anon_function_decl")
abs_Param_decl = Class(name="abs_Param_decl")
Delta_param = Class(name="Delta_param")
abs_Type_exp = Class(name="abs_Type_exp")
Update_preamble_declaration = Class(name="Update_preamble_declaration")
abs_Function_decl = Class(name="abs_Function_decl")
abs_Typesyn_decl = Class(name="abs_Typesyn_decl")
abs_Var_or_field_ref = Class(name="abs_Var_or_field_ref")
Pure_exp = Class(name="Pure_exp")
abs_Field_decl = Class(name="abs_Field_decl")
abs_Pattern = Class(name="abs_Pattern")
Case_branch = Class(name="Case_branch")
abs_Class_decl = Class(name="abs_Class_decl")
abs_Stmt = Class(name="abs_Stmt")
abs_Casestmtbranch = Class(name="abs_Casestmtbranch")
abs_Trait_usage = Class(name="abs_Trait_usage")
abs_Method = Class(name="abs_Method")
abs_Exp = Class(name="abs_Exp")
abs_Exception_decl = Class(name="abs_Exception_decl")
abs_Interface_decl = Class(name="abs_Interface_decl")
abs_Methodsig = Class(name="abs_Methodsig")
abs_Interface_name = Class(name="abs_Interface_name")
Class_modifier_fragment = Class(name="Class_modifier_fragment")
Interface_modifier_fragment = Class(name="Interface_modifier_fragment")
abs_Guard = Class(name="abs_Guard")
abs_Eff_expr = Class(name="abs_Eff_expr")
abs_Delta_id = Class(name="abs_Delta_id")
abs_Trait_expr = Class(name="abs_Trait_expr")
abs_Trait_oper = Class(name="abs_Trait_oper")
abs_Trait_decl = Class(name="abs_Trait_decl")
abs_Delta_param = Class(name="abs_Delta_param")
abs_Delta_access = Class(name="abs_Delta_access")
abs_Module_modifier = Class(name="abs_Module_modifier")
abs_Has_condition = Class(name="abs_Has_condition")
abs_Functional_modifier = Class(name="abs_Functional_modifier")
Module_modifier = Class(name="Module_modifier")
abs_OO_modifier = Class(name="abs_OO_modifier")
abs_Interface_modifier_fragment = Class(name="abs_Interface_modifier_fragment")
abs_Namespace_modifier = Class(name="abs_Namespace_modifier")
abs_Object_update = Class(name="abs_Object_update")
abs_Update_preamble_declaration = Class(name="abs_Update_preamble_declaration")
abs_Object_update_assign_stmt = Class(name="abs_Object_update_assign_stmt")
abs_Feature = Class(name="abs_Feature")
abs_Delta_clause = Class(name="abs_Delta_clause")
abs_Class_modifier_fragment = Class(name="abs_Class_modifier_fragment")
abs_After_condition = Class(name="abs_After_condition")
abs_From_condition = Class(name="abs_From_condition")
abs_When_condition = Class(name="abs_When_condition")
abs_Deltaspec = Class(name="abs_Deltaspec")
abs_Application_condition = Class(name="abs_Application_condition")
abs_Product_reconfiguration = Class(name="abs_Product_reconfiguration")
abs_Product_expr = Class(name="abs_Product_expr")
abs_Or_expr = Class(name="abs_Or_expr")
Fnode = Class(name="Fnode")
abs_Feature_decl_group = Class(name="abs_Feature_decl_group")
abs_Feature_decl_attribute = Class(name="abs_Feature_decl_attribute")
abs_Feature_decl_constraint = Class(name="abs_Feature_decl_constraint")
abs_Fnode = Class(name="abs_Fnode")
abs_Mexp = Class(name="abs_Mexp")
abs_PlusOrMinus_expr = Class(name="abs_PlusOrMinus_expr")
abs_MulDivOrMod_expr = Class(name="abs_MulDivOrMod_expr")
abs_AndGuard = Class(name="abs_AndGuard")
Guard = Class(name="Guard")
abs_And_expr = Class(name="abs_And_expr")
abs_Equality_expr = Class(name="abs_Equality_expr")
abs_Comparison_expr = Class(name="abs_Comparison_expr")
abs_MexpEquality_expr = Class(name="abs_MexpEquality_expr")
abs_MexpComparison_expr = Class(name="abs_MexpComparison_expr")
abs_AppOr_exp = Class(name="abs_AppOr_exp")
Application_condition = Class(name="Application_condition")
abs_AppAnd_exp = Class(name="abs_AppAnd_exp")
abs_ProductOr_expr = Class(name="abs_ProductOr_expr")
Product_expr = Class(name="Product_expr")
abs_ProductAnd_exp = Class(name="abs_ProductAnd_exp")
abs_ProductMinus_exp = Class(name="abs_ProductMinus_exp")
abs_MexpOr_exp = Class(name="abs_MexpOr_exp")
Mexp = Class(name="Mexp")
abs_MexpAnd_expr = Class(name="abs_MexpAnd_expr")
abs_MexpImplies_expr = Class(name="abs_MexpImplies_expr")
abs_MexpPlusOrMinus_expr = Class(name="abs_MexpPlusOrMinus_expr")
abs_MexpMulDivOrMod_expr = Class(name="abs_MexpMulDivOrMod_expr")
abs_MexpPrimary_expr = Class(name="abs_MexpPrimary_expr")
...
abs_Pure_exp_await_: Property = Property(name="await_", type=StringType)
abs_Pure_exp_val: Property = Property(name="val", type=StringType)
abs_Pure_exp.attributes={abs_Pure_exp_await_, abs_Pure_exp_value, abs_Pure_exp_op, abs_Pure_exp_val}
...
abs_Deltaspec.attributes={abs_Deltaspec_name, abs_Deltaspec_deltaspec_param}
...
abs_Feature_decl_attribute.attributes={abs_Feature_decl_attribute_lBoundary_int, abs_Feature_decl_attribute_boundary_val, abs_Feature_decl_attribute_uBoundary_int}
...
if_48: BinaryAssociation = BinaryAssociation(
    name="if_48",
    ends={
...
else_54: BinaryAssociation = BinaryAssociation(
    name="else_54",
    ends={
...
class_285: BinaryAssociation = BinaryAssociation(
    name="class_285",
    ends={
...
# Generalizations
gen_abs_Compilation_Unit_DomainModel = Generalization(general=DomainModel_, specific=abs_Compilation_Unit)
...
domain_model = DomainModel(
    name="abs",
    types={abs_DomainModel, abs_Compilation_Unit, DomainModel_, abs_Module_decl, abs_Delta_decl, abs_Update_decl, abs_Productline_decl, abs_Product_decl, Namespace_modifier, abs_Par_function_decl, Decl, abs_Type_use, abs_Function_name_list, abs_Param_list, abs_Pure_exp, abs_Function_name_decl, abs_DataType_decl, Functional_modifier, abs_Data_constructor, abs_Data_constructor_arg, abs_Annotations, abs_Annotation, abs_Feature_decl, abs_Fextension, abs_Module_export, abs_Module_import, abs_Decl, abs_Main_block, abs_Case_branch, Data_constructor_arg, Annotation, Exp, Eff_expr, abs_Function_list, abs_Function_param, abs_Pure_exp_list, abs_Function_name_param_decl, Function_param, abs_Anon_function_decl, abs_Param_decl, Delta_param, abs_Type_exp, Update_preamble_declaration, abs_Function_decl, abs_Typesyn_decl, abs_Var_or_field_ref, Pure_exp, abs_Field_decl, abs_Pattern, Case_branch, abs_Class_decl, abs_Stmt, abs_Casestmtbranch, abs_Trait_usage, abs_Method, abs_Exp, abs_Exception_decl, abs_Interface_decl, abs_Methodsig, abs_Interface_name, Class_modifier_fragment, Interface_modifier_fragment, abs_Guard, abs_Eff_expr, abs_Delta_id, abs_Trait_expr, abs_Trait_oper, abs_Trait_decl, abs_Delta_param, abs_Delta_access, abs_Module_modifier, abs_Has_condition, abs_Functional_modifier, Module_modifier, abs_OO_modifier, abs_Interface_modifier_fragment, abs_Namespace_modifier, abs_Object_update, abs_Update_preamble_declaration, abs_Object_update_assign_stmt, abs_Feature, abs_Delta_clause, abs_Class_modifier_fragment, abs_After_condition, abs_From_condition, abs_When_condition, abs_Deltaspec, abs_Application_condition, abs_Product_reconfiguration, abs_Product_expr, abs_Or_expr, Fnode, abs_Feature_decl_group, abs_Feature_decl_attribute, abs_Feature_decl_constraint, abs_Fnode, abs_Mexp, abs_PlusOrMinus_expr, abs_MulDivOrMod_expr, abs_AndGuard, Guard, abs_And_expr, abs_Equality_expr, abs_Comparison_expr, abs_MexpEquality_expr, abs_MexpComparison_expr, abs_AppOr_exp, Application_condition, abs_AppAnd_exp, abs_ProductOr_expr, Product_expr, abs_ProductAnd_exp, abs_ProductMinus_exp, abs_MexpOr_exp, Mexp, abs_MexpAnd_expr, abs_MexpImplies_expr, abs_MexpPlusOrMinus_expr, abs_MexpMulDivOrMod_expr, abs_MexpPrimary_expr},
    associations={module0, deltaDecl1, update_decl3, productline_decl5, product_decl7, type_use21, functions22, params24, e26, function_name_decl28, data_constructor30, data_constructor_arg31, annotation33, feature_decl9, fextension11, module_export13, module_import15, decl17, main_block19, partial_function_pure_exp_list42, variadic_exp_list44, if_48, then51, else_54, case57, casebranch59, type_use61, i65, b68, pure_exp34, type_use38, pure_exp79, function_list40, function_param82, params84, pure_exp86, param_decl89, type_exp91, p93, type_use96, paramlist98, pure_exp101, pure_exp71, ref73, pure_exp74, pattern77, type_use112, paramlist115, paramlist118, interface_name120, field_decl123, stmt126, casestmtbranch128, trait_usage130, method132, type_use134, pure_exp137, type_exp140, exp143, var_or_field_ref145, stmt149, pure_exp151, type_use104, type106, interface_name109, methodsig110, trystmt173, casestmtbranch175, ref178, f180, t183, throwPureExp186, diePureExp189, moveCogTo192, c195, pure_exp_list198, list200, ref203, min206, ifstmt155, elsestmt158, condition160, whilestmt164, l166, foreachstmt170, method223, traitMethod225, traitName228, op231, trait_expr234, method236, methodsig239, trait_expr242, trait_exp245, type_use248, max209, guard212, pattern215, stmt218, traitUsage221, p263, delta_access265, module_modifier267, field269, method271, interface274, module_ref277, class_decl280, paramlist251, stmt254, traitExpr257, stmt260, interface299, interface_modifier_fragment302, methodsig304, object_update307, guard309, update_preamble_declaration312, pre314, post316, var_or_field_ref319, exp322, feature325, delta_clause327, feature_decl329, interface_decl282, class_285, inteface288, interfaceName291, removedInterface294, class_modifier_fragment297, deltaspec332, after_condition335, from_condition337, when_condition339, delta_id341, application_condition344, application_condition346, operand350, feature352, left356, feature361, product_reconfiguration364, product_expr366, feature368, productDecl371, left375, right378, mexp390, feature_decl_group392, feature_decl_attribute395, feature_decl_constraint398, left401, right403, right359, delta_id380, feature_decl_group382, feature_decl_attribute384, feature_decl_constraint386, fnode388, left421, right423, left426, right428, left406, right408, left411, right413, left416, right418, left446, right448, left451, right453, left456, left431, right433, left436, right438, left441, right443, right458, left461, right463, left466, right468, a471},
    generalizations={gen_abs_Compilation_Unit_DomainModel, gen_abs_Module_export_Namespace_modifier, gen_abs_Module_import_Namespace_modifier, gen_abs_Par_function_decl_Decl, gen_abs_DataType_decl_Decl, gen_abs_DataType_decl_Functional_modifier, gen_abs_Type_use_Data_constructor_arg, gen_abs_Type_use_Annotation, gen_abs_Pure_exp_Exp, gen_abs_Pure_exp_Eff_expr, gen_abs_Function_name_param_decl_Function_param, gen_abs_Anon_function_decl_Function_param, gen_abs_Param_decl_Delta_param, gen_abs_Type_exp_Update_preamble_declaration, gen_abs_Function_decl_Decl, gen_abs_Function_decl_Functional_modifier, gen_abs_Typesyn_decl_Decl, gen_abs_Typesyn_decl_Functional_modifier, gen_abs_Var_or_field_ref_Pure_exp, gen_abs_Pattern_Case_branch, gen_abs_Class_decl_Decl, gen_abs_Field_decl_Class_modifier_fragment, gen_abs_Exception_decl_Decl, gen_abs_Interface_decl_Decl, gen_abs_Methodsig_Class_modifier_fragment, gen_abs_Methodsig_Interface_modifier_fragment, gen_abs_Eff_expr_Exp, gen_abs_Delta_id_Eff_expr, gen_abs_Trait_expr_Class_modifier_fragment, gen_abs_Has_condition_Delta_param, gen_abs_Functional_modifier_Module_modifier, gen_abs_OO_modifier_Module_modifier, gen_abs_Trait_decl_Decl, gen_abs_Namespace_modifier_Module_modifier, gen_abs_Or_expr_Pure_exp, gen_abs_Feature_decl_Fnode, gen_abs_PlusOrMinus_expr_Pure_exp, gen_abs_MulDivOrMod_expr_Pure_exp, gen_abs_AndGuard_Guard, gen_abs_And_expr_Pure_exp, gen_abs_Equality_expr_Pure_exp, gen_abs_Comparison_expr_Pure_exp, gen_abs_MexpEquality_expr_Mexp, gen_abs_MexpComparison_expr_Mexp, gen_abs_AppOr_exp_Application_condition, gen_abs_AppAnd_exp_Application_condition, gen_abs_ProductOr_expr_Product_expr, gen_abs_ProductAnd_exp_Product_expr, gen_abs_ProductMinus_exp_Product_expr, gen_abs_MexpOr_exp_Mexp, gen_abs_MexpAnd_expr_Mexp, gen_abs_MexpImplies_expr_Mexp, gen_abs_MexpPlusOrMinus_expr_Mexp, gen_abs_MexpMulDivOrMod_expr_Mexp, gen_abs_MexpPrimary_expr_Mexp},
    metadata=None
)
