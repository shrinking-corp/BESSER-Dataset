...
# Classes
dcmddandroid_NamedElement = Class(name="dcmddandroid_NamedElement", is_abstract=True)
dcmddandroid_AbstractClass = Class(name="dcmddandroid_AbstractClass", is_abstract=True)
ModelElement = Class(name="ModelElement")
EVisibility = Class(name="EVisibility")
dcmddandroid_PersistentClass = Class(name="dcmddandroid_PersistentClass")
dcmddandroid_Interface = Class(name="dcmddandroid_Interface")
dcmddandroid_Implements = Class(name="dcmddandroid_Implements")
dcmddandroid_Attribute = Class(name="dcmddandroid_Attribute")
dcmddandroid_Method = Class(name="dcmddandroid_Method")
dcmddandroid_Association = Class(name="dcmddandroid_Association", is_abstract=True)
dcmddandroid_Class = Class(name="dcmddandroid_Class")
AbstractClass = Class(name="AbstractClass")
dcmddandroid_CycleClass = Class(name="dcmddandroid_CycleClass")
dcmddandroid_ClassElement = Class(name="dcmddandroid_ClassElement", is_abstract=True)
NamedElement = Class(name="NamedElement")
ClassElement = Class(name="ClassElement")
dcmddandroid_Parameter = Class(name="dcmddandroid_Parameter")
dcmddandroid_Diagram = Class(name="dcmddandroid_Diagram")
dcmddandroid_ModelElement = Class(name="dcmddandroid_ModelElement", is_abstract=True)
dcmddandroid_Enum = Class(name="dcmddandroid_Enum")
dcmddandroid_EnumValue = Class(name="dcmddandroid_EnumValue")
dcmddandroid_Agregation = Class(name="dcmddandroid_Agregation")
Association = Class(name="Association")
dcmddandroid_Composition = Class(name="dcmddandroid_Composition")
dcmddandroid_EVisibility = Class(name="dcmddandroid_EVisibility")
...
dcmddandroid_Attribute.attributes={dcmddandroid_Attribute_secured, dcmddandroid_Attribute_type, dcmddandroid_Attribute_defaultValue}
...
dcmddandroid_Method.attributes={dcmddandroid_Method_returns, dcmddandroid_Method_isAbstract}
...
dcmddandroid_Association.attributes={dcmddandroid_Association_rolTarget, dcmddandroid_Association_minMultiplicitySource, dcmddandroid_Association_rolSource, dcmddandroid_Association_minMultiplicityTarget, dcmddandroid_Association_maxMultiplicityTarget, dcmddandroid_Association_maxMultiplicitySource}
...
domain_model = DomainModel(
    name="dcmddandroid",
    types={dcmddandroid_NamedElement, dcmddandroid_AbstractClass, ModelElement, EVisibility, dcmddandroid_PersistentClass, dcmddandroid_Interface, dcmddandroid_Implements, dcmddandroid_Attribute, dcmddandroid_Method, dcmddandroid_Association, dcmddandroid_Class, AbstractClass, dcmddandroid_CycleClass, dcmddandroid_ClassElement, NamedElement, ClassElement, dcmddandroid_Parameter, dcmddandroid_Diagram, dcmddandroid_ModelElement, dcmddandroid_Enum, dcmddandroid_EnumValue, dcmddandroid_Agregation, Association, dcmddandroid_Composition, dcmddandroid_EVisibility, Visibility},
    associations={implements0, attributes1, methods2, associationAsSource4, associationAsTarget5, superInterfaces8, methods9, parameters12, source16, modelElements14, values15, target17, implemented19, implements21},
    generalizations={gen_dcmddandroid_AbstractClass_ModelElement, gen_dcmddandroid_AbstractClass_EVisibility, gen_dcmddandroid_PersistentClass_AbstractClass, gen_dcmddandroid_Class_AbstractClass, gen_dcmddandroid_CycleClass_AbstractClass, gen_dcmddandroid_Attribute_ClassElement, gen_dcmddandroid_Interface_ModelElement, gen_dcmddandroid_Interface_EVisibility, gen_dcmddandroid_ClassElement_NamedElement, gen_dcmddandroid_ClassElement_EVisibility, gen_dcmddandroid_Method_ClassElement, gen_dcmddandroid_Association_ModelElement, gen_dcmddandroid_Diagram_NamedElement, gen_dcmddandroid_ModelElement_NamedElement, gen_dcmddandroid_Parameter_NamedElement, gen_dcmddandroid_Enum_ModelElement, gen_dcmddandroid_EnumValue_NamedElement, gen_dcmddandroid_Agregation_Association, gen_dcmddandroid_Composition_Association, gen_dcmddandroid_Implements_ModelElement},
    metadata=None
)
