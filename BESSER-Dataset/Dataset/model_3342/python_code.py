...
class StringElement:
    ...
    pass
class JavaSimplified_Field(NamedElement, CommentedElement, TypedElement, StringElement):
...
class JavaSimplified_Method(NamedElement, CommentedElement, StringElement):

    def __init__(self, exceptions: str, JavaSimplified_Method9: set["JavaSimplified_Parameter"] = None, JavaSimplified_Method11: set["JavaSimplified_Statement"] = None, JavaSimplified_Method: "JavaSimplified_JavaClass" = None, JavaSimplified_Method13: "JavaSimplified_Type" = None):
...
class JavaSimplified_Name(Expression):
    ...
    def __init__(self, identifier: str, JavaSimplified_Name37: "JavaSimplified_MethodInvocation" = None, JavaSimplified_Name: "JavaSimplified_NamedElement" = None, JavaSimplified_Name48: "JavaSimplified_MethodCall" = None, JavaSimplified_Name32: "JavaSimplified_CastExpression" = None):
