...
def test_hyp_javasimplified_field_visibility_setter(instance):
...
def test_JavaSimplified_Field_visibility_value_roundtrip():
    instance = JavaSimplified_Field(visibility="sample_text")
...
def test_JavaSimplified_Field_isa_CommentedElement():
    instance = JavaSimplified_Field(visibility="sample_text")
...
def test_JavaSimplified_Method_isa_CommentedElement():
    instance = JavaSimplified_Method(exceptions="sample_text")
    assert isinstance(instance, CommentedElement)
...
def test_JavaSimplified_Field_isa_NamedElement():
    instance = JavaSimplified_Field(visibility="sample_text")
...
def test_JavaSimplified_Field_isa_StringElement():
    instance = JavaSimplified_Field(visibility="sample_text")
    assert isinstance(instance, StringElement)


def test_JavaSimplified_Method_isa_StringElement():
    instance = JavaSimplified_Method(exceptions="sample_text")
    assert isinstance(instance, StringElement)
...
def test_assoc_className61_link_reassign_clear():
    a = JavaSimplified_Type(type="sample_text")
    b1 = JavaSimplified_ClassInstanceCreation()
    b2 = JavaSimplified_ClassInstanceCreation()
    _safe_set(a, 'JavaSimplified_Type63', b1)
    assert _is_linked(a, 'JavaSimplified_Type63', b1)
    if hasattr(b1, 'JavaSimplified_ClassInstanceCreation62'):
        assert _is_linked(b1, 'JavaSimplified_ClassInstanceCreation62', a)
    _safe_set(a, 'JavaSimplified_Type63', b2)
    assert _is_linked(a, 'JavaSimplified_Type63', b2)
    if hasattr(b1, 'JavaSimplified_ClassInstanceCreation62'):
        assert not _is_linked(b1, 'JavaSimplified_ClassInstanceCreation62', a)
    if hasattr(b2, 'JavaSimplified_ClassInstanceCreation62'):
        assert _is_linked(b2, 'JavaSimplified_ClassInstanceCreation62', a)
    _safe_set(a, 'JavaSimplified_Type63', None)
    assert not _is_linked(a, 'JavaSimplified_Type63', b2)
    if hasattr(b2, 'JavaSimplified_ClassInstanceCreation62'):
        assert not _is_linked(b2, 'JavaSimplified_ClassInstanceCreation62', a)


def test_assoc_comment15_link_reassign_clear():
    a = JavaSimplified_Comment(isJavadoc=True)
    b1 = JavaSimplified_CommentStatement()
    b2 = JavaSimplified_CommentStatement()
    _safe_set(a, 'JavaSimplified_Comment16', b1)
    assert _is_linked(a, 'JavaSimplified_Comment16', b1)
    if hasattr(b1, 'JavaSimplified_CommentStatement'):
        assert _is_linked(b1, 'JavaSimplified_CommentStatement', a)
    _safe_set(a, 'JavaSimplified_Comment16', b2)
    assert _is_linked(a, 'JavaSimplified_Comment16', b2)
    if hasattr(b1, 'JavaSimplified_CommentStatement'):
    ...
    _safe_set(a, 'JavaSimplified_Comment16', None)
    assert not _is_linked(a, 'JavaSimplified_Comment16', b2)
    if hasattr(b2, 'JavaSimplified_CommentStatement'):
...
def test_assoc_expr149_link_reassign_clear():
    ...
    if hasattr(b1, 'JavaSimplified_Expression50'):
        assert _is_linked(b1, 'JavaSimplified_Expression50', a)
    _safe_set(a, 'JavaSimplified_InfixExpression', b2)
    assert _is_linked(a, 'JavaSimplified_InfixExpression', b2)
    if hasattr(b1, 'JavaSimplified_Expression50'):
        assert not _is_linked(b1, 'JavaSimplified_Expression50', a)
    if hasattr(b2, 'JavaSimplified_Expression50'):
        assert _is_linked(b2, 'JavaSimplified_Expression50', a)
    _safe_set(a, 'JavaSimplified_InfixExpression', None)
    assert not _is_linked(a, 'JavaSimplified_InfixExpression', b2)
    if hasattr(b2, 'JavaSimplified_Expression50'):
        assert not _is_linked(b2, 'JavaSimplified_Expression50', a)


def test_assoc_expr154_link_reassign_clear():
    ...
    if hasattr(b1, 'JavaSimplified_Expression55'):
        assert _is_linked(b1, 'JavaSimplified_Expression55', a)
    _safe_set(a, 'JavaSimplified_Assignment', b2)
    assert _is_linked(a, 'JavaSimplified_Assignment', b2)
    if hasattr(b1, 'JavaSimplified_Expression55'):
        assert not _is_linked(b1, 'JavaSimplified_Expression55', a)
    if hasattr(b2, 'JavaSimplified_Expression55'):
        assert _is_linked(b2, 'JavaSimplified_Expression55', a)
    _safe_set(a, 'JavaSimplified_Assignment', None)
    assert not _is_linked(a, 'JavaSimplified_Assignment', b2)
    if hasattr(b2, 'JavaSimplified_Expression55'):
        assert not _is_linked(b2, 'JavaSimplified_Expression55', a)


def test_assoc_expr251_link_reassign_clear():
    a = JavaSimplified_InfixExpression(operator="sample_text")
    b1 = JavaSimplified_Expression()
    b2 = JavaSimplified_Expression()
    _safe_set(a, 'JavaSimplified_InfixExpression52', b1)
    assert _is_linked(a, 'JavaSimplified_InfixExpression52', b1)
    if hasattr(b1, 'JavaSimplified_Expression53'):
        assert _is_linked(b1, 'JavaSimplified_Expression53', a)
    _safe_set(a, 'JavaSimplified_InfixExpression52', b2)
    assert _is_linked(a, 'JavaSimplified_InfixExpression52', b2)
    if hasattr(b1, 'JavaSimplified_Expression53'):
        assert not _is_linked(b1, 'JavaSimplified_Expression53', a)
    if hasattr(b2, 'JavaSimplified_Expression53'):
        assert _is_linked(b2, 'JavaSimplified_Expression53', a)
    _safe_set(a, 'JavaSimplified_InfixExpression52', None)
    assert not _is_linked(a, 'JavaSimplified_InfixExpression52', b2)
    if hasattr(b2, 'JavaSimplified_Expression53'):
        assert not _is_linked(b2, 'JavaSimplified_Expression53', a)


def test_assoc_expr256_link_reassign_clear():
    a = JavaSimplified_Assignment(operator="sample_text")
    b1 = JavaSimplified_Expression()
    b2 = JavaSimplified_Expression()
    _safe_set(a, 'JavaSimplified_Assignment57', b1)
    assert _is_linked(a, 'JavaSimplified_Assignment57', b1)
    if hasattr(b1, 'JavaSimplified_Expression58'):
        assert _is_linked(b1, 'JavaSimplified_Expression58', a)
    _safe_set(a, 'JavaSimplified_Assignment57', b2)
    assert _is_linked(a, 'JavaSimplified_Assignment57', b2)
    if hasattr(b1, 'JavaSimplified_Expression58'):
        assert not _is_linked(b1, 'JavaSimplified_Expression58', a)
    if hasattr(b2, 'JavaSimplified_Expression58'):
        assert _is_linked(b2, 'JavaSimplified_Expression58', a)
    _safe_set(a, 'JavaSimplified_Assignment57', None)
    assert not _is_linked(a, 'JavaSimplified_Assignment57', b2)
    if hasattr(b2, 'JavaSimplified_Expression58'):
        assert not _is_linked(b2, 'JavaSimplified_Expression58', a)


def test_assoc_expr6_link_reassign_clear():
    a = JavaSimplified_Field(visibility="sample_text")
    b1 = JavaSimplified_Expression()
    b2 = JavaSimplified_Expression()
    _safe_set(a, 'JavaSimplified_Field7', b1)
    assert _is_linked(a, 'JavaSimplified_Field7', b1)
    if hasattr(b1, 'JavaSimplified_Expression'):
        assert _is_linked(b1, 'JavaSimplified_Expression', a)
    _safe_set(a, 'JavaSimplified_Field7', b2)
    assert _is_linked(a, 'JavaSimplified_Field7', b2)
    if hasattr(b1, 'JavaSimplified_Expression'):
    ...
    _safe_set(a, 'JavaSimplified_Field7', None)
    assert not _is_linked(a, 'JavaSimplified_Field7', b2)
    if hasattr(b2, 'JavaSimplified_Expression'):
...
def test_assoc_fields3_link_reassign_clear():
    ...
    b1 = JavaSimplified_Field(visibility="sample_text")
    b2 = JavaSimplified_Field(visibility="sample_text_2")
    _safe_set(a, 'JavaSimplified_JavaClass', {b1})
    assert _is_linked(a, 'JavaSimplified_JavaClass', b1)
    if hasattr(b1, 'JavaSimplified_Field'):
        assert _is_linked(b1, 'JavaSimplified_Field', a)
    _safe_set(a, 'JavaSimplified_JavaClass', {b2})
    assert _is_linked(a, 'JavaSimplified_JavaClass', b2)
    if hasattr(b1, 'JavaSimplified_Field'):
        assert not _is_linked(b1, 'JavaSimplified_Field', a)
    if hasattr(b2, 'JavaSimplified_Field'):
        assert _is_linked(b2, 'JavaSimplified_Field', a)
    _safe_set(a, 'JavaSimplified_JavaClass', set())
    assert not _is_linked(a, 'JavaSimplified_JavaClass', b2)
    if hasattr(b2, 'JavaSimplified_Field'):
        assert not _is_linked(b2, 'JavaSimplified_Field', a)


def test_assoc_methodName46_link_reassign_clear():
    a = JavaSimplified_Name(identifier="sample_text")
    b1 = JavaSimplified_MethodCall()
    b2 = JavaSimplified_MethodCall()
    _safe_set(a, 'JavaSimplified_Name48', b1)
    assert _is_linked(a, 'JavaSimplified_Name48', b1)
    if hasattr(b1, 'JavaSimplified_MethodCall47'):
        assert _is_linked(b1, 'JavaSimplified_MethodCall47', a)
    _safe_set(a, 'JavaSimplified_Name48', b2)
    assert _is_linked(a, 'JavaSimplified_Name48', b2)
    if hasattr(b1, 'JavaSimplified_MethodCall47'):
        assert not _is_linked(b1, 'JavaSimplified_MethodCall47', a)
    if hasattr(b2, 'JavaSimplified_MethodCall47'):
        assert _is_linked(b2, 'JavaSimplified_MethodCall47', a)
    _safe_set(a, 'JavaSimplified_Name48', None)
    assert not _is_linked(a, 'JavaSimplified_Name48', b2)
    if hasattr(b2, 'JavaSimplified_MethodCall47'):
        assert not _is_linked(b2, 'JavaSimplified_MethodCall47', a)
...
def test_assoc_methods4_link_reassign_clear():
    ...
    if hasattr(b1, 'JavaSimplified_JavaClass5'):
        assert _is_linked(b1, 'JavaSimplified_JavaClass5', a)
    _safe_set(a, 'JavaSimplified_Method', b2)
    assert _is_linked(a, 'JavaSimplified_Method', b2)
    if hasattr(b1, 'JavaSimplified_JavaClass5'):
        assert not _is_linked(b1, 'JavaSimplified_JavaClass5', a)
    if hasattr(b2, 'JavaSimplified_JavaClass5'):
        assert _is_linked(b2, 'JavaSimplified_JavaClass5', a)
    _safe_set(a, 'JavaSimplified_Method', None)
    assert not _is_linked(a, 'JavaSimplified_Method', b2)
    if hasattr(b2, 'JavaSimplified_JavaClass5'):
        assert not _is_linked(b2, 'JavaSimplified_JavaClass5', a)
...
def test_assoc_object36_link_reassign_clear():
    a = JavaSimplified_Name(identifier="sample_text")
    b1 = JavaSimplified_MethodInvocation()
    b2 = JavaSimplified_MethodInvocation()
    _safe_set(a, 'JavaSimplified_Name37', b1)
    assert _is_linked(a, 'JavaSimplified_Name37', b1)
    if hasattr(b1, 'JavaSimplified_MethodInvocation'):
        assert _is_linked(b1, 'JavaSimplified_MethodInvocation', a)
    _safe_set(a, 'JavaSimplified_Name37', b2)
    assert _is_linked(a, 'JavaSimplified_Name37', b2)
    if hasattr(b1, 'JavaSimplified_MethodInvocation'):
    ...
    _safe_set(a, 'JavaSimplified_Name37', None)
    assert not _is_linked(a, 'JavaSimplified_Name37', b2)
    if hasattr(b2, 'JavaSimplified_MethodInvocation'):
...
def test_assoc_parameters8_link_reassign_clear():
    ...
    _safe_set(a, 'JavaSimplified_Method9', {b1})
    assert _is_linked(a, 'JavaSimplified_Method9', b1)
    if hasattr(b1, 'JavaSimplified_Parameter'):
        assert _is_linked(b1, 'JavaSimplified_Parameter', a)
    _safe_set(a, 'JavaSimplified_Method9', {b2})
    assert _is_linked(a, 'JavaSimplified_Method9', b2)
    if hasattr(b1, 'JavaSimplified_Parameter'):
    ...
    _safe_set(a, 'JavaSimplified_Method9', set())
    assert not _is_linked(a, 'JavaSimplified_Method9', b2)
    if hasattr(b2, 'JavaSimplified_Parameter'):
...
def test_assoc_returnType12_link_reassign_clear():
    ...
    _safe_set(a, 'JavaSimplified_Type14', b1)
    assert _is_linked(a, 'JavaSimplified_Type14', b1)
    if hasattr(b1, 'JavaSimplified_Method13'):
        assert _is_linked(b1, 'JavaSimplified_Method13', a)
    _safe_set(a, 'JavaSimplified_Type14', b2)
    assert _is_linked(a, 'JavaSimplified_Type14', b2)
    if hasattr(b1, 'JavaSimplified_Method13'):
        assert not _is_linked(b1, 'JavaSimplified_Method13', a)
    if hasattr(b2, 'JavaSimplified_Method13'):
        assert _is_linked(b2, 'JavaSimplified_Method13', a)
    _safe_set(a, 'JavaSimplified_Type14', None)
    assert not _is_linked(a, 'JavaSimplified_Type14', b2)
    if hasattr(b2, 'JavaSimplified_Method13'):
        assert not _is_linked(b2, 'JavaSimplified_Method13', a)
...
def test_assoc_statements10_link_reassign_clear():
    ...
    _safe_set(a, 'JavaSimplified_Method11', {b1})
    assert _is_linked(a, 'JavaSimplified_Method11', b1)
    if hasattr(b1, 'JavaSimplified_Statement'):
        assert _is_linked(b1, 'JavaSimplified_Statement', a)
    _safe_set(a, 'JavaSimplified_Method11', {b2})
    assert _is_linked(a, 'JavaSimplified_Method11', b2)
    if hasattr(b1, 'JavaSimplified_Statement'):
    ...
    _safe_set(a, 'JavaSimplified_Method11', set())
    assert not _is_linked(a, 'JavaSimplified_Method11', b2)
    if hasattr(b2, 'JavaSimplified_Statement'):
...
def test_assoc_type33_link_reassign_clear():
    ...
    _safe_set(a, 'JavaSimplified_Type35', b1)
    assert _is_linked(a, 'JavaSimplified_Type35', b1)
    if hasattr(b1, 'JavaSimplified_CastExpression34'):
        assert _is_linked(b1, 'JavaSimplified_CastExpression34', a)
    _safe_set(a, 'JavaSimplified_Type35', b2)
    assert _is_linked(a, 'JavaSimplified_Type35', b2)
    if hasattr(b1, 'JavaSimplified_CastExpression34'):
        assert not _is_linked(b1, 'JavaSimplified_CastExpression34', a)
    if hasattr(b2, 'JavaSimplified_CastExpression34'):
        assert _is_linked(b2, 'JavaSimplified_CastExpression34', a)
    _safe_set(a, 'JavaSimplified_Type35', None)
    assert not _is_linked(a, 'JavaSimplified_Type35', b2)
    if hasattr(b2, 'JavaSimplified_CastExpression34'):
        assert not _is_linked(b2, 'JavaSimplified_CastExpression34', a)
...
def test_assoc_var31_link_reassign_clear():
    ...
    b1 = JavaSimplified_CastExpression()
    b2 = JavaSimplified_CastExpression()
    _safe_set(a, 'JavaSimplified_Name32', b1)
    assert _is_linked(a, 'JavaSimplified_Name32', b1)
    if hasattr(b1, 'JavaSimplified_CastExpression'):
        assert _is_linked(b1, 'JavaSimplified_CastExpression', a)
    _safe_set(a, 'JavaSimplified_Name32', b2)
    assert _is_linked(a, 'JavaSimplified_Name32', b2)
    if hasattr(b1, 'JavaSimplified_CastExpression'):
        assert not _is_linked(b1, 'JavaSimplified_CastExpression', a)
    if hasattr(b2, 'JavaSimplified_CastExpression'):
        assert _is_linked(b2, 'JavaSimplified_CastExpression', a)
    _safe_set(a, 'JavaSimplified_Name32', None)
    assert not _is_linked(a, 'JavaSimplified_Name32', b2)
    if hasattr(b2, 'JavaSimplified_CastExpression'):
        assert not _is_linked(b2, 'JavaSimplified_CastExpression', a)
...
JavaSimplified_Field_strategy = st.builds(JavaSimplified_Field, visibility=safe_text)
@given(instance=JavaSimplified_Field_strategy)
@settings(max_examples=25)
