...
JavaSimplified_JavaClass = Class(name="JavaSimplified_JavaClass", is_abstract=True)
...
domain_model = DomainModel(
    name="JavaSimplified",
    types={JavaSimplified_StringElement, JavaSimplified_Expression, JavaSimplified_Parameter, JavaSimplified_Statement, JavaSimplified_NamedElement, JavaSimplified_Name, JavaSimplified_TypedElement, JavaSimplified_Type, JavaSimplified_Comment, StringElement, JavaSimplified_CommentedElement, JavaSimplified_JavaClass, CommentedElement, NamedElement, JavaSimplified_Field, JavaSimplified_Method, TypedElement, JavaSimplified_InfixExpression, JavaSimplified_CommentStatement, Statement, JavaSimplified_ExpressionStatement, JavaSimplified_IfStatement, JavaSimplified_VariableDeclarationStatement, JavaSimplified_ReturnStatement, Expression, JavaSimplified_CastExpression, JavaSimplified_MethodInvocation, JavaSimplified_MethodCall, JavaSimplified_Assignment, JavaSimplified_Literal, JavaSimplified_ClassInstanceCreation, InfixOperatorType, AssignmentOperatorType, LiteralType, VisibilityType},
    associations={expr6, parameters8, statements10, name0, type1, comment2, fields3, methods4, arguments40, childCall44, methodName46, expr149, returnType12, comment15, expr17, expr19, ifst21, elsest24, expr27, expr29, var31, type33, object36, method38, expr251, expr154, expr256, arguments59, className61},
    generalizations={gen_JavaSimplified_Method_StringElement, gen_JavaSimplified_Method_CommentedElement, gen_JavaSimplified_Method_NamedElement, gen_JavaSimplified_Comment_StringElement, gen_JavaSimplified_JavaClass_CommentedElement, gen_JavaSimplified_JavaClass_NamedElement, gen_JavaSimplified_Field_StringElement, gen_JavaSimplified_Field_CommentedElement, gen_JavaSimplified_Field_NamedElement, gen_JavaSimplified_Field_TypedElement, gen_JavaSimplified_InfixExpression_Expression, gen_JavaSimplified_Parameter_NamedElement, gen_JavaSimplified_Parameter_TypedElement, gen_JavaSimplified_Statement_StringElement, gen_JavaSimplified_CommentStatement_Statement, gen_JavaSimplified_ExpressionStatement_Statement, gen_JavaSimplified_IfStatement_Statement, gen_JavaSimplified_VariableDeclarationStatement_Statement, gen_JavaSimplified_VariableDeclarationStatement_TypedElement, gen_JavaSimplified_VariableDeclarationStatement_NamedElement, gen_JavaSimplified_ReturnStatement_Statement, gen_JavaSimplified_Expression_StringElement, gen_JavaSimplified_Name_Expression, gen_JavaSimplified_CastExpression_Expression, gen_JavaSimplified_MethodInvocation_Expression, gen_JavaSimplified_Assignment_Expression, gen_JavaSimplified_Literal_Expression, gen_JavaSimplified_ClassInstanceCreation_Expression},
    metadata=None
)
