...
Supplier.attributes={Supplier_Supplier_id, Supplier_address, Supplier_contact_no, Supplier_name, Supplier_email}
...
Orders.attributes={Orders_order_date, Orders_price_per_unit, Orders_total_amount, Orders_item_id, Orders_order_id, Orders_Quantity, Orders_recieved_date, Orders_status}
...
Stock.attributes={Stock_exp_date, Stock_quantity, Stock_item_id, Stock_stock_id}
...
Items.attributes={Items_re_order_qty, Items_item_id, Items_item_code, Items_description, Items_unit_of_measure, Items_price_per_unit}
...
Section.attributes={Section_section_id, Section_name, Section_description}
...
Employee.attributes={Employee_address, Employee_attendance_count, Employee_emp_id, Employee_phone, Employee_lname, Employee_email, Employee_DOB, Employee_fname}
...
Attendance.attributes={Attendance_OT_hours, Attendance_out_time, Attendance_in_time, Attendance_work_hours, Attendance_date, Attendance_att_id}
...
Leave.attributes={Leave_to, Leave_date, Leave_leave_id, Leave_from, Leave_leave_type}
...
Order_Sent.attributes={Order_Sent_Item_id, Order_Sent_sentOrder_id, Order_Sent_quantity, Order_Sent_order_status}
...
Bonus.attributes={Bonus_id, Bonus_type, Bonus_amount, Bonus_IDnum}
...
ETF_EPF.attributes={ETF_EPF_type, ETF_EPF_rate, ETF_EPF_no}
...
Daily_production.attributes={Daily_production_section, Daily_production_item_code, Daily_production_date, Daily_production_curr_qty, Daily_production_item_name, Daily_production_future_Qty, Daily_production_pro_number}
...
domain_model = DomainModel(
    name="_07076c04_1464_457c_a5aa_f03b7dd993ad",
