...
# Classes
wsmodel3_Server = Class(name="wsmodel3_Server", is_abstract=True)
wsmodel3_IoTNode = Class(name="wsmodel3_IoTNode")
wsmodel3_AccesPoint = Class(name="wsmodel3_AccesPoint")
wsmodel3_IntegrationPattern = Class(name="wsmodel3_IntegrationPattern")
wsmodel3_MessageBroker = Class(name="wsmodel3_MessageBroker")
wsmodel3_ExternalAPI = Class(name="wsmodel3_ExternalAPI")
wsmodel3_Device = Class(name="wsmodel3_Device", is_abstract=True)
wsmodel3_REST = Class(name="wsmodel3_REST")
wsmodel3_WebServer = Class(name="wsmodel3_WebServer")
wsmodel3_DBServer = Class(name="wsmodel3_DBServer")
wsmodel3_System = Class(name="wsmodel3_System")
wsmodel3_WebService = Class(name="wsmodel3_WebService")
wsmodel3_DeviceData = Class(name="wsmodel3_DeviceData")
wsmodel3_Sensor = Class(name="wsmodel3_Sensor")
Device = Class(name="Device")
wsmodel3_Actuator = Class(name="wsmodel3_Actuator")
wsmodel3_Controller = Class(name="wsmodel3_Controller")
wsmodel3_Port = Class(name="wsmodel3_Port", is_abstract=True)
wsmodel3_Communication = Class(name="wsmodel3_Communication")
Server = Class(name="Server")
wsmodel3_CommunicationData = Class(name="wsmodel3_CommunicationData")
wsmodel3_InputPort = Class(name="wsmodel3_InputPort")
Port = Class(name="Port")
wsmodel3_OutputPort = Class(name="wsmodel3_OutputPort")
Data = Class(name="Data")
wsmodel3_Data = Class(name="wsmodel3_Data", is_abstract=True)
wsmodel3_InputBridge = Class(name="wsmodel3_InputBridge")
Bridge = Class(name="Bridge")
wsmodel3_OutputBridge = Class(name="wsmodel3_OutputBridge")
wsmodel3_InputOrchestrator = Class(name="wsmodel3_InputOrchestrator")
wsmodel3_Orchestrator = Class(name="wsmodel3_Orchestrator")
wsmodel3_Bridge = Class(name="wsmodel3_Bridge", is_abstract=True)
wsmodel3_Break = Class(name="wsmodel3_Break")
wsmodel3_OrchestratorData = Class(name="wsmodel3_OrchestratorData")
wsmodel3_Function = Class(name="wsmodel3_Function")
wsmodel3_OutputOrchestrator = Class(name="wsmodel3_OutputOrchestrator")
...
wsmodel3_AccesPoint_pass_: Property = Property(name="pass_", type=StringType)
wsmodel3_AccesPoint.attributes={wsmodel3_AccesPoint_pass_, wsmodel3_AccesPoint_ssid}
...
wsmodel3_MessageBroker_pass_: Property = Property(name="pass_", type=StringType)
wsmodel3_MessageBroker.attributes={wsmodel3_MessageBroker_port, wsmodel3_MessageBroker_type, wsmodel3_MessageBroker_pass_, wsmodel3_MessageBroker_usser, wsmodel3_MessageBroker_host}
...
wsmodel3_DBServer_pass_: Property = Property(name="pass_", type=StringType)
...
wsmodel3_DBServer.attributes={wsmodel3_DBServer_port, wsmodel3_DBServer_pass_, wsmodel3_DBServer_type, wsmodel3_DBServer_database, wsmodel3_DBServer_usser}
...
wsmodel3_Data.attributes={wsmodel3_Data_Attribute, wsmodel3_Data_id, wsmodel3_Data_Time, wsmodel3_Data_Date, wsmodel3_Data_Location, wsmodel3_Data_Artefact}
...
wsmodel3_Orchestrator.attributes={wsmodel3_Orchestrator_port, wsmodel3_Orchestrator_name}
...
wsmodel3_Bridge.attributes={wsmodel3_Bridge_topic, wsmodel3_Bridge_port, wsmodel3_Bridge_host}
...
break_74: BinaryAssociation = BinaryAssociation(
    name="break_74",
    ends={
...
domain_model = DomainModel(
    name="wsmodel3",
    types={wsmodel3_Server, wsmodel3_IoTNode, wsmodel3_AccesPoint, wsmodel3_IntegrationPattern, wsmodel3_MessageBroker, wsmodel3_ExternalAPI, wsmodel3_Device, wsmodel3_REST, wsmodel3_WebServer, wsmodel3_DBServer, wsmodel3_System, wsmodel3_WebService, wsmodel3_DeviceData, wsmodel3_Sensor, Device, wsmodel3_Actuator, wsmodel3_Controller, wsmodel3_Port, wsmodel3_Communication, Server, wsmodel3_CommunicationData, wsmodel3_InputPort, Port, wsmodel3_OutputPort, Data, wsmodel3_Data, wsmodel3_InputBridge, Bridge, wsmodel3_OutputBridge, wsmodel3_InputOrchestrator, wsmodel3_Orchestrator, wsmodel3_Bridge, wsmodel3_Break, wsmodel3_OrchestratorData, wsmodel3_Function, wsmodel3_OutputOrchestrator, DBType, SensorType, PortType, CommunicationType, ActuatorType, ControllerType, MessageBrokerType},
    associations={server1, iotnode3, accespoint5, integrationpattern7, messagebroker9, externalapi11, device13, rest15, webserver17, dbserver19, device21, webservice0, devicedata24, port26, communication27, communicationdata29, accespoint31, messagebroker34, sensor37, actuator38, rest39, actuator41, inputorchestrator43, sensor44, bridge47, orchestrator50, outputorchestrator60, externalapi62, rest65, inputorchestrator68, outputorchestrator71, break_74, inputorchestrator76, inputbridge79, renponsedata82, rest84, externalapi87, webserver52, inputorchestrator55, function58},
    generalizations={gen_wsmodel3_Sensor_Device, gen_wsmodel3_Actuator_Device, gen_wsmodel3_Controller_Device, gen_wsmodel3_WebServer_Server, gen_wsmodel3_DBServer_Server, gen_wsmodel3_InputPort_Port, gen_wsmodel3_OutputPort_Port, gen_wsmodel3_DeviceData_Data, gen_wsmodel3_CommunicationData_Data, gen_wsmodel3_InputBridge_Bridge, gen_wsmodel3_OutputBridge_Bridge, gen_wsmodel3_OrchestratorData_Data},
    metadata=None
)
