...
class wsmodel3_Orchestrator:
    ...
    def __init__(self, port: str, name: str, wsmodel3_Orchestrator: "wsmodel3_IntegrationPattern" = None, wsmodel3_Orchestrator61: set["wsmodel3_OutputOrchestrator"] = None, wsmodel3_Orchestrator63: set["wsmodel3_ExternalAPI"] = None, wsmodel3_Orchestrator66: set["wsmodel3_REST"] = None, wsmodel3_Orchestrator56: set["wsmodel3_InputOrchestrator"] = None, wsmodel3_Orchestrator59: set["wsmodel3_Function"] = None):
        self.port = port
        self.name = name
...
class wsmodel3_InputOrchestrator:
    ...
    def __init__(self, URI: str, wsmodel3_InputOrchestrator: "wsmodel3_OutputBridge" = None, wsmodel3_InputOrchestrator70: "wsmodel3_Function" = None, wsmodel3_InputOrchestrator78: "wsmodel3_OutputOrchestrator" = None, wsmodel3_InputOrchestrator57: "wsmodel3_Orchestrator" = None):
        self.URI = URI
...
class wsmodel3_Communication:
    ...
    def __init__(self, type: str, name: str, wsmodel3_Communication: "wsmodel3_Controller" = None, wsmodel3_Communication30: set["wsmodel3_CommunicationData"] = None, wsmodel3_Communication32: "wsmodel3_AccesPoint" = None, wsmodel3_Communication35: "wsmodel3_MessageBroker" = None):
        self.type = type
        self.name = name
...
class wsmodel3_Actuator(Device):
    ...
    def __init__(self, type: str, wsmodel3_Actuator: "wsmodel3_OutputPort" = None, wsmodel3_Actuator42: "wsmodel3_InputBridge" = None):
        self.type = type
...
class wsmodel3_System:
    ...
    def __init__(self, name: str, wsmodel3_System2: set["wsmodel3_Server"] = None, wsmodel3_System4: set["wsmodel3_IoTNode"] = None, wsmodel3_System6: set["wsmodel3_AccesPoint"] = None, wsmodel3_System8: set["wsmodel3_IntegrationPattern"] = None, wsmodel3_System10: set["wsmodel3_MessageBroker"] = None, wsmodel3_System12: set["wsmodel3_ExternalAPI"] = None, wsmodel3_System: set["wsmodel3_WebService"] = None):
        self.name = name
...
class wsmodel3_DBServer(Server):
    ...
    def __init__(self, database: str, usser: str, pass_: str, type: str, port: int, wsmodel3_DBServer: "wsmodel3_WebService" = None):
...
class wsmodel3_REST:
    ...
    def __init__(self, URI: str, port: int, wsmodel3_REST: "wsmodel3_WebService" = None, wsmodel3_REST22: "wsmodel3_Device" = None, wsmodel3_REST40: "wsmodel3_Bridge" = None, wsmodel3_REST67: "wsmodel3_Orchestrator" = None, wsmodel3_REST86: "wsmodel3_OutputOrchestrator" = None):
        self.URI = URI
        self.port = port
...
class wsmodel3_Device(ABC):
    ...
    def __init__(self, name: str, wsmodel3_Device: "wsmodel3_IoTNode" = None, wsmodel3_Device23: "wsmodel3_REST" = None, wsmodel3_Device25: set["wsmodel3_DeviceData"] = None):
        self.name = name
...
class wsmodel3_MessageBroker:
    ...
    def __init__(self, type: str, port: int, host: str, usser: str, pass_: str, wsmodel3_MessageBroker: "wsmodel3_System" = None, wsmodel3_MessageBroker36: "wsmodel3_Communication" = None, wsmodel3_MessageBroker48: set["wsmodel3_Bridge"] = None):
        self.type = type
        self.port = port
        self.host = host
        self.usser = usser
...
class wsmodel3_AccesPoint:
    ...
    def __init__(self, ssid: str, pass_: str, wsmodel3_AccesPoint: "wsmodel3_System" = None, wsmodel3_AccesPoint33: "wsmodel3_Communication" = None):
        self.ssid = ssid
        self.pass_ = pass_
