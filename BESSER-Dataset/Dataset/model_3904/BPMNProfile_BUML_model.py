...
BPMNProfile_SequenceFlow_m_SequenceFlowtargetRef: Method = Method(name="SequenceFlowtargetRef", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_SequenceFlow.attributes={BPMNProfile_SequenceFlow_isImmediate}
BPMNProfile_SequenceFlow.methods={BPMNProfile_SequenceFlow_m_SequenceFlowconditionExpression, BPMNProfile_SequenceFlow_m_SequenceFlowsourceRef, BPMNProfile_SequenceFlow_m_SequenceFlowtargetRef}
...
BPMNProfile_InclusiveGateway_m_inclusiveGatewaydefault: Method = Method(name="inclusiveGatewaydefault", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_BPMNAssociation_m_AssociationEnd: Method = Method(name="AssociationEnd", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_LaneSet_m_LaneSetparentLane: Method = Method(name="LaneSetparentLane", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_LaneSet_m_LaneSetflowElementsContainer: Method = Method(name="LaneSetflowElementsContainer", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_LaneSet_m_LaneSet: Method = Method(name="LaneSet", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_LaneSet.methods={BPMNProfile_LaneSet_m_LaneSetparentLane, BPMNProfile_LaneSet_m_LaneSetflowElementsContainer, BPMNProfile_LaneSet_m_LaneSetlanes, BPMNProfile_LaneSet_m_LaneSet}
...
BPMNProfile_Lane_m_LaneflowNodeRefs: Method = Method(name="LaneflowNodeRefs", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_Lane.methods={BPMNProfile_Lane_m_LaneflowNodeRefs, BPMNProfile_Lane_m_LanechildLaneSet, BPMNProfile_Lane_m_LanepartitionElementRef, BPMNProfile_Lane_m_LanelaneSet}
...
BPMNProfile_ComplexGateway_m_complexGatewaydefault: Method = Method(name="complexGatewaydefault", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_ComplexGateway_m_complexGatewayactivationCondition: Method = Method(name="complexGatewayactivationCondition", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_ComplexGateway_m_complexGatewayjoinSpec: Method = Method(name="complexGatewayjoinSpec", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_ExclusiveGateway_m_exclusiveGatewaydefault: Method = Method(name="exclusiveGatewaydefault", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_Definitions.attributes={BPMNProfile_Definitions_targetNamespace, BPMNProfile_Definitions_exporterVersion, BPMNProfile_Definitions_typeLanguage, BPMNProfile_Definitions_expressionLanguage, BPMNProfile_Definitions_exporter}
...
BPMNProfile_BPMNProcess_m_ProcesssupportedInterfaceRefs: Method = Method(name="ProcesssupportedInterfaceRefs", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_BPMNProcess.attributes={BPMNProfile_BPMNProcess_isClosed, BPMNProfile_BPMNProcess_isExecutable, BPMNProfile_BPMNProcess_processType}
BPMNProfile_BPMNProcess.methods={BPMNProfile_BPMNProcess_m_Processproperties, BPMNProfile_BPMNProcess_m_ProcesslaneSets, BPMNProfile_BPMNProcess_m_Processsupports, BPMNProfile_BPMNProcess_m_ProcesssupportedInterfaceRefs, BPMNProfile_BPMNProcess_m_ProcessflowElements}
...
BPMNProfile_BPMNProperty_m_BPMNPropertyapply: Method = Method(name="BPMNPropertyapply", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_ResourceRole_m_ResourceRoleresourceRef: Method = Method(name="ResourceRoleresourceRef", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_ResourceRole_m_ResourceRoleisRequired: Method = Method(name="ResourceRoleisRequired", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_ResourceRole_m_ResourceRoleprocess: Method = Method(name="ResourceRoleprocess", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_ResourceRole.methods={BPMNProfile_ResourceRole_m_ResourceRoleresourceRef, BPMNProfile_ResourceRole_m_ResourceRoleisRequired, BPMNProfile_ResourceRole_m_ResourceRoleprocess, BPMNProfile_ResourceRole_m_ResourceRoleowner, BPMNProfile_ResourceRole_m_ResourceRoleresourceParameterBindings}

# BPMNProfile_CallableElement class attributes and methods
BPMNProfile_CallableElement_m_CallableEelementsupportedInterfaceRefs: Method = Method(name="CallableEelementsupportedInterfaceRefs", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_CallableElement_m_CallableElementresources: Method = Method(name="CallableElementresources", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_BPMNInterface_m_Interfaceoperationmultiplicity: Method = Method(name="Interfaceoperationmultiplicity", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_BPMNInterface_m_InterfaceownedOperation: Method = Method(name="InterfaceownedOperation", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_BPMNInterface.methods={BPMNProfile_BPMNInterface_m_Interfaceoperationmultiplicity, BPMNProfile_BPMNInterface_m_BPMNInterfacecallableElements, BPMNProfile_BPMNInterface_m_BPMNInterfaceoperations, BPMNProfile_BPMNInterface_m_InterfaceownedOperation}
...
BPMNProfile_DataInput_m_DataInputAssociation: Method = Method(name="DataInputAssociation", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_DataInput_m_DataInputnotation: Method = Method(name="DataInputnotation", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_DataInput_m_DataInputitemSubjectRef: Method = Method(name="DataInputitemSubjectRef", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_DataInput.attributes={BPMNProfile_DataInput_isCollection}
BPMNProfile_DataInput.methods={BPMNProfile_DataInput_m_DataInputitemSubjectRef, BPMNProfile_DataInput_m_DataInputAssociation, BPMNProfile_DataInput_m_DataInputnotation}
...
BPMNProfile_DataOutput_m_DataOutputitemSubjectRef: Method = Method(name="DataOutputitemSubjectRef", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_InputSet.methods={BPMNProfile_InputSet_m_InputSetoptionalInputRefs, BPMNProfile_InputSet_m_InputSetdataInputRefs, BPMNProfile_InputSet_m_InputSetwhileExecutingInputRefs}
...
BPMNProfile_OutputSet_m_OutputSetwhileExecutingOutputRefs: Method = Method(name="OutputSetwhileExecutingOutputRefs", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_OutputSet.methods={BPMNProfile_OutputSet_m_OutputSetdataOutputRefs, BPMNProfile_OutputSet_m_OutputSetoptionalOutputRefs, BPMNProfile_OutputSet_m_OutputSetwhileExecutingOutputRefs}
...
BPMNProfile_ItemAwareElement_m_ItemAwareElementdataState: Method = Method(name="ItemAwareElementdataState", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_BPMNOperation_m_BPMNOperationowner: Method = Method(name="BPMNOperationowner", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_BPMNOperation_m_BPMNOperationerrorRefs: Method = Method(name="BPMNOperationerrorRefs", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_BPMNOperation.methods={BPMNProfile_BPMNOperation_m_BPMNOperationowner, BPMNProfile_BPMNOperation_m_BPMNOperationinMessageRef, BPMNProfile_BPMNOperation_m_BPMNOperationerrorRefs, BPMNProfile_BPMNOperation_m_BPMNOperationoutMessageRef}

# BPMNProfile_Operation class attributes and methods

# BPMNProfile_BPMNMessage class attributes and methods
BPMNProfile_BPMNMessage_m_MessageitemRef: Method = Method(name="MessageitemRef", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_ParticipantAssociation_m_ParticipantAssociationinnerParticipantRef: Method = Method(name="ParticipantAssociationinnerParticipantRef", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_MessageFlowAssociation_m_MessageFlowAssociationinnerMessageFlowRef: Method = Method(name="MessageFlowAssociationinnerMessageFlowRef", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_MessageFlow_m_MessageFlowsourceRef: Method = Method(name="MessageFlowsourceRef", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_MessageFlow_m_MessageFlowtargetRef: Method = Method(name="MessageFlowtargetRef", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_Participant_m_Participanttype: Method = Method(name="Participanttype", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_Participant_m_Participantrealizationsupplier: Method = Method(name="Participantrealizationsupplier", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_Participant_m_participantpartnerRoleRef: Method = Method(name="participantpartnerRoleRef", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_Participant_m_ParticipantinterfaceRefs: Method = Method(name="ParticipantinterfaceRefs", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_Participant_m_Participantownership: Method = Method(name="Participantownership", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_Participant.methods={BPMNProfile_Participant_m_Participantrealizationsupplier, BPMNProfile_Participant_m_participantpartnerRoleRef, BPMNProfile_Participant_m_ParticipantmultiplicityMinimum, BPMNProfile_Participant_m_Participantownership, BPMNProfile_Participant_m_ParticipantinterfaceRefs, BPMNProfile_Participant_m_participantpartnerEntityRef, BPMNProfile_Participant_m_ParticipantprocessRef, BPMNProfile_Participant_m_ParticipantmultiplicityMaximum, BPMNProfile_Participant_m_Participanttype}
...
BPMNProfile_PartnerRole_m_PartnerRoleparticipantRef: Method = Method(name="PartnerRoleparticipantRef", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_FormalExpression_m_FormalExpressionevaluatesToTypeRef: Method = Method(name="FormalExpressionevaluatesToTypeRef", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_ResourceParameterBinding_m_ResourceParameterBindingexpression: Method = Method(name="ResourceParameterBindingexpression", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_ResourceParameter_m_ResourceParameterisRequired: Method = Method(name="ResourceParameterisRequired", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_GlobalTask_m_GlobalTasksupportedInterfaceRefs: Method = Method(name="GlobalTasksupportedInterfaceRefs", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_GlobalBusinessRuleTask_m_GlobalBusinessRuleTaskimplementation: Method = Method(name="GlobalBusinessRuleTaskimplementation", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_BPMNActivity_m_BPMNActivityresources: Method = Method(name="BPMNActivityresources", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_BPMNActivity_m_BPMNActivityloopCharacteristics: Method = Method(name="BPMNActivityloopCharacteristics", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_BPMNActivity.methods={BPMNProfile_BPMNActivity_m_BPMNActivityloopCharacteristics, BPMNProfile_BPMNActivity_m_BPMNActivitycontainer, BPMNProfile_BPMNActivity_m_BPMNActivityresources, BPMNProfile_BPMNActivity_m_BPMNActivitydefault, BPMNProfile_BPMNActivity_m_BPMNActivityboundaryEventsRefs, BPMNProfile_BPMNActivity_m_BPMNActivityproperties}
...
BPMNProfile_BoundaryEvent_m_boundaryEventattachedToRef: Method = Method(name="boundaryEventattachedToRef", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_DataInputAssociation_m_dataInputAssociationsource: Method = Method(name="dataInputAssociationsource", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_DataOutputAssociation.methods={BPMNProfile_DataOutputAssociation_m_dataOutputAssociationsource, BPMNProfile_DataOutputAssociation_m_dataOutputAssociationtarget}
...
BPMNProfile_DataAssociation_m_DataAssociationsource: Method = Method(name="DataAssociationsource", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_DataAssociation_m_DataAssociationtransformation: Method = Method(name="DataAssociationtransformation", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_DataAssociation_m_DataAssociationtarget: Method = Method(name="DataAssociationtarget", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_ConditionalEventDefinition_m_conditionalEventDefinitioncondition: Method = Method(name="conditionalEventDefinitioncondition", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_DataObjectReference.methods={BPMNProfile_DataObjectReference_m_DataObjectRefsourcetarget, BPMNProfile_DataObjectReference_m_DataObjectRefdataState}
...
BPMNProfile_UserTask_m_UserTaskimplementation: Method = Method(name="UserTaskimplementation", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_GlobalUserTask.methods={BPMNProfile_GlobalUserTask_m_GlobalUserTaskrenderings, BPMNProfile_GlobalUserTask_m_GlobalUserTaskimplementation}
...
BPMNProfile_CallConversation_m_CallConversationparticipantAssociations: Method = Method(name="CallConversationparticipantAssociations", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_AdHocSubProcess_m_AdHocSubProcesscancelRemainingInstances: Method = Method(name="AdHocSubProcesscancelRemainingInstances", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_ScriptTask_m_ScriptTaskscriptFormat: Method = Method(name="ScriptTaskscriptFormat", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_ScriptTask_m_ScriptTaskscript: Method = Method(name="ScriptTaskscript", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_BusinessRuleTask_m_BusinessRuleTaskimplementation: Method = Method(name="BusinessRuleTaskimplementation", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
BPMNProfile_StandardLoopCharacteristics_m_StandardLoopCharacteristicsloopCondition: Method = Method(name="StandardLoopCharacteristicsloopCondition", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
BPMNProfile_StandardLoopCharacteristics.attributes={BPMNProfile_StandardLoopCharacteristics_testBefore, BPMNProfile_StandardLoopCharacteristics_loopMaximum}
...
BPMNProfile_MultiInstanceLoopCharacteristics_m_MultiinstanceLoopCharacteristicstarget: Method = Method(name="MultiinstanceLoopCharacteristicstarget", parameters={Parameter(name='BPMNProfile_context', type=StringType), Parameter(name='BPMNProfile_diagnostics', type=StringType)}, type=BooleanType)
...
BPMNProfile_ServiceTask_m_ServiceTaskoperationRef: Method = Method(name="ServiceTaskoperationRef", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
BPMNProfile_ServiceTask_m_ServiceTaskinputSet: Method = Method(name="ServiceTaskinputSet", parameters={Parameter(name='BPMNProfile_diagnostics', type=StringType), Parameter(name='BPMNProfile_context', type=StringType)}, type=BooleanType)
...
import_198: BinaryAssociation = BinaryAssociation(
    name="import_198",
    ends={
...
from_503: BinaryAssociation = BinaryAssociation(
    name="from_503",
    ends={
...
domain_model = DomainModel(
    name="BPMNProfile",
    types={NonExclusiveGateway, BPMNProfile_SequenceFlow, BPMNProfile_NonExclusiveGateway, Gateway, BPMNProfile_JoinNode, BPMNProfile_ForkNode, BPMNProfile_Gateway, FlowNode, BPMNProfile_ControlNode, BPMNProfile_ActivityGroup, BPMNProfile_FlowNode, FlowElement, BPMNProfile_ActivityNode, BPMNProfile_FlowElement, BaseElement, BPMNProfile_Auditing, BPMNProfile_Monitoring, BPMNProfile_CategoryValue, BPMNProfile_FlowElementsContainer, BPMNProfile_BaseElement, BPMNProfile_ExtensionAttributeValue, BPMNProfile_Element, BPMNProfile_InclusiveGateway, BPMNProfile_Documentation, BPMNProfile_ExtensionDefinition, BPMNProfile_BPMNAssociation, BPMNProfile_Slot, BPMNProfile_ExtensionAttributeDefinition, BPMNProfile_Property, BPMNProfile_Comment, BPMNProfile_Stereotype, BPMNArtifact, BPMNProfile_Dependency, BPMNProfile_BPMNArtifact, BPMNProfile_Class, BPMNProfile_EnumerationLiteral, BPMNProfile_LaneSet, BPMNProfile_ActivityPartition, BPMNProfile_Lane, BPMNProfile_ControlFlow, BPMNProfile_BPMNExpression, BPMNProfile_OpaqueExpression, BPMNProfile_EventBasedGateway, BPMNProfile_StructuredActivityNode, BPMNProfile_InterruptibleActivityRegion, BPMNProfile_ParallelGateway, BPMNProfile_ComplexGateway, BPMNProfile_ExclusiveGateway, BPMNProfile_DecisionNode, BPMNProfile_MergeNode, BPMNProfile_RootElement, BPMNProfile_PackageableElement, BPMNProfile_Definitions, BPMNProfile_Package, BPMNProfile_Import, BPMNProfile_BPMNRelationship, BPMNProfile_PackageImport, BPMNProfile_Constraint, BPMNProfile_BPMNProcess, CallableElement, FlowElementsContainer, BPMNProfile_BPMNExtension, BPMNProfile_BPMNCollaboration, BPMNProfile_Activity, BPMNProfile_CorrelationSubscription, BPMNProfile_BPMNProperty, BPMNProfile_ResourceRole, BPMNProfile_CallableElement, RootElement, BPMNProfile_Behavior, BPMNProfile_BPMNInterface, BPMNProfile_InputOutputBinding, BPMNProfile_Action, BPMNProfile_DataInput, BPMNProfile_DataOutput, BPMNProfile_InputSet, BPMNProfile_OutputSet, ItemAwareElement, BPMNProfile_InputPin, BPMNProfile_Parameter, BPMNProfile_ActivityParameterNode, BPMNProfile_InputOutputSpecification, BPMNProfile_ItemAwareElement, BPMNProfile_DataState, BPMNProfile_TypedElement, BPMNProfile_ItemDefinition, BPMNProfile_State, BPMNProfile_ParameterSet, BPMNProfile_OutputPin, BPMNProfile_BPMNOperation, BPMNProfile_Operation, BPMNProfile_BPMNMessage, BPMNProfile_Error, ItemDefinition, BPMNProfile_Interface, BPMNProfile_ParticipantAssociation, BPMNProfile_ConversationLink, BPMNProfile_MessageFlowAssociation, BPMNProfile_MessageFlow, BPMNProfile_Collaboration, BPMNProfile_ConversationNode, BPMNProfile_CorrelationKey, BPMNProfile_Participant, InteractionNode, BPMNProfile_InstanceSpecification, BPMNProfile_ParticipantMultiplicity, BPMNProfile_PartnerEntity, BPMNProfile_PartnerRole, BPMNProfile_InteractionNode, BPMNProfile_MultiplicityElement, BPMNProfile_FormalExpression, BPMNProfile_InformationFlow, BPMNProfile_CorrelationProperty, BPMNProfile_CorrelationPropertyRetrievalExpression, BPMNExpression, BPMNProfile_CorrelationPropertyBinding, BPMNProfile_DataStoreNode, BPMNProfile_ResourceAssignmentExpression, BPMNProfile_Resource, BPMNProfile_ResourceParameterBinding, BPMNProfile_ResourceParameter, BPMNProfile_GlobalScriptTask, GlobalTask, BPMNProfile_GlobalTask, BPMNProfile_OpaqueBehavior, BPMNProfile_GlobalBusinessRuleTask, BPMNProfile_CompensateEventDefinition, EventDefinition, BPMNProfile_BPMNActivity, BPMNProfile_CallEvent, BPMNProfile_EventDefinition, BPMNProfile_Event, BPMNProfile_BoundaryEvent, BPMNProfile_DataInputAssociation, BPMNProfile_DataOutputAssociation, BPMNProfile_LoopCharacteristics, CatchEvent, BPMNProfile_CatchEvent, BPMNEvent, BPMNProfile_AcceptEventAction, BPMNProfile_InitialNode, BPMNProfile_BPMNEvent, DataAssociation, BPMNProfile_DataAssociation, BPMNProfile_ObjectFlow, BPMNProfile_Assignment, BPMNProfile_EscalationEventDefinition, BPMNProfile_Escalation, BPMNProfile_TimerEventDefinition, BPMNProfile_ChangeEvent, BPMNProfile_SignalEventDefinition, BPMNProfile_BPMNSignal, BPMNProfile_EndEvent, ThrowEvent, BPMNProfile_FinalNode, BPMNProfile_ThrowEvent, BPMNProfile_CallOperationAction, BPMNProfile_FlowFinalNode, BPMNProfile_MessageEventDefinition, BPMNProfile_StartEvent, BPMNProfile_ConditionalEventDefinition, BPMNProfile_LinkEventDefinition, BPMNProfile_ErrorEventDefinition, BPMNProfile_IntermediateCatchEvent, BPMNProfile_IntermediateThrowEvent, BPMNProfile_SendObjectAction, BPMNProfile_TerminateEventDefinition, BPMNProfile_ImplicitThrowEvent, BPMNProfile_CancelEventDefinition, BPMNProfile_TextAnnotation, BPMNProfile_Category, BPMNProfile_Enumeration, BPMNProfile_Group, BPMNProfile_DataObjectReference, BPMNProfile_DataObject, BPMNProfile_UserTask, Task, BPMNProfile_DataStore, BPMNProfile_OpaqueAction, BPMNProfile_Rendering, BPMNProfile_Task, BPMNActivity, BPMNProfile_DataStoreReference, BPMNProfile_GlobalManualTask, BPMNProfile_ManualTask, BPMNProfile_PotentialOwner, HumanPerformer, BPMNProfile_SubConversation, ConversationNode, BPMNProfile_GlobalConversation, BPMNCollaboration, BPMNProfile_Image, BPMNProfile_HumanPerformer, Performer, BPMNProfile_Performer, ResourceRole, BPMNProfile_GlobalUserTask, BPMNProfile_CollaborationUse, BPMNProfile_Conversation, BPMNProfile_SubProcess, BPMNProfile_CallActivity, BPMNProfile_CallConversation, BPMNProfile_ComplexBehaviorDefinition, BPMNProfile_AdHocSubProcess, SubProcess, BPMNProfile_ScriptTask, BPMNProfile_CallBehaviorAction, BPMNProfile_BusinessRuleTask, BPMNProfile_Transaction, BPMNProfile_StandardLoopCharacteristics, LoopCharacteristics, BPMNProfile_LoopNode, BPMNProfile_ReceiveTask, BPMNProfile_SendTask, BPMNProfile_MultiInstanceLoopCharacteristics, BPMNProfile_ExpansionRegion, BPMNProfile_ServiceTask, AssociationDirection, EventBasedGatewayType, GatewayDirection, RelationshipDirection, ItemKind, ProcessType, AdHocOrdering, MultiInstanceBehavior},
    associations={default0, base_JoinNode1, base_ForkNode2, base_ControlNode4, base_ActivityGroup5, base_ActivityNode7, auditing8, monitoring9, _categoryValueRef11, container12, extensionValues13, base_Element14, documentation16, extensionDefinitions18, outgoing20, incoming21, base_Slot23, valueRef25, extensionAttributeDefinition28, base_Property30, base_Comment32, base_Stereotype34, extensionAttributeDefinitions36, base_Dependency39, targetRef40, sourceRef41, base_Class43, base_Class45, base_EnumerationLiteral48, categorizedFlowElements49, laneSets50, flowElements51, base_ActivityPartition53, lanes54, parentLane55, flowElementsContainer57, base_ActivityPartition59, _partitionElement62, flowNodeRefs65, childLaneSet71, laneSet74, base_ControlFlow76, conditionExpression78, sourceRef80, targetRef83, base_OpaqueExpression86, base_ForkNode88, base_StructuredActivityNode90, base_InterruptibleActivityRegion92, partitionElementRef68, default94, activationCondition96, base_DecisionNode99, base_MergeNode100, default102, base_PackageableElement105, definition106, base_Package107, extensions108, imports110, relationships112, rootElements114, base_Stereotype115, definition118, base_PackageImport121, definitions123, base_Constraint126, targets128, sources131, definition134, auditing137, definitionalCollaborationRef139, base_Activity141, correlationSubscriptions143, monitoring145, supports149, properties151, resources153, base_Behavior154, supportedInterfaceRefs157, ioBinding159, base_Behavior161, base_Action164, dataInputs166, dataOutputs168, inputSets170, outputSets172, base_InputPin174, base_Parameter176, base_ActivityParameterNode178, inputSetRefs180, ioSpecification155, inputSetWithWhileExecuting183, dataState185, base_TypedElement186, itemSubjectRef188, base_State190, base_Class192, structureRef195, inputSetWithOptional181, base_ParameterSet201, optionalInputRefs203, whileExecutingInputRefs204, dataInputRefs206, base_OutputPin208, base_Parameter210, base_ActivityParameterNode213, outputSetRefs216, import_198, base_ParameterSet223, optionalOutputRefs226, whileExecutingOutputRefs229, dataOutputRefs232, outputSetWithOptional217, outputSetWithWhileExecuting220, operations238, callableElements240, base_Operation243, implementationRef245, inMessageRef248, outMessageRef250, errorRef253, base_Interface233, implementationRef235, inputDataRef258, outputDataRef261, operationRef264, base_Dependency267, participantAssociations270, conversationLinks272, messageFlowAssociations273, messageFlows275, itemRef255, base_Collaboration277, conversations279, correlationKeys281, participants283, base_Dependency285, innerParticipantRef288, outerParticipantRef291, base_Property294, processRef297, base_InstanceSpecification324, participantMultiplicity300, partnerEntityRef302, partnerRoleRef303, interfaceRefs305, base_InteractionNode_Element308, outgoingConversationLinks310, incomingConversationLinks313, collaboration316, base_Dependency317, targetRef319, sourceRef320, base_MultiplicityElement322, participantRef325, base_Class326, participantRef328, base_Dependency330, innerMessageFlowRef333, outerMessageFlowRef336, messageRef378, messagePath381, base_InformationFlow339, sourceRef341, targetRef344, messageRef347, base_InformationFlow350, messageFlowRefs353, correlationKeys356, participantRefs359, base_Class362, correlationPropertyRef365, base_Property367, type370, correlationPropertyRetrievalExpression373, base_Dependency375, evaluatesToTypeRef383, base_Class386, correlationKeyRef389, correlationPropertyBinding392, base_Property394, dataPath397, correlationPropertyRef400, base_DataStoreNode403, umlProperty405, base_Property408, resourceAssignmentExpression410, resourceRef412, resourceParameterBindings414, process416, expression417, resourceParameters420, base_Property422, type425, base_Slot428, parameterRef431, expression434, base_OpaqueBehavior437, resources438, activityRef441, base_CallEvent442, base_Event444, loopCharacteristics463, resources465, base_Action445, activityClass448, properties451, default454, boundaryEventRefs457, dataInputAssociations459, dataOutputAssociations461, attachedToRef468, base_AcceptEventAction471, base_InitialNode472, dataOutputAssociation474, eventClass477, _eventDefinitions479, properties482, eventDefinitionRefs485, base_ObjectFlow488, sourceRef489, targetRef492, transformation495, assignment498, to506, base_Dependency500, from_503, base_StructuredActivityNode509, escalationRef512, base_CallEvent513, timeCycle516, timeDate518, timeDuration521, base_ChangeEvent524, signalRef526, base_CallEvent527, base_FinalNode530, base_CallOperationAction531, base_FlowFinalNode532, dataInputAssociation534, messageRef537, operationRef539, base_CallEvent542, base_ChangeEvent545, condition547, _target551, source553, base_CallEvent555, errorRef557, base_CallEvent559, base_SendObjectAction562, base_CallEvent563, base_CallEvent565, base_Comment567, base_Enumeration569, categoryValue570, base_ActivityPartition573, _categoryValueRef575, dataObjectRef578, base_DataStoreNode579, base_DataStoreNode582, base_OpaqueAction595, renderings596, base_Class585, ioSpecification598, itemSubjectRef587, _dataStore590, base_DataStoreNode592, base_OpaqueAction604, conversationNodes606, base_Image600, renderings602, _collaborationUse608, calledCollaborationRef609, participantAssociations612, base_StructuredActivityNode615, hasLaneSets617, condition626, event628, base_ControlFlow630, completionCondition633, base_CallBehaviorAction620, calledElementRef621, base_OpaqueAction624, operationRef642, base_LoopNode645, loopCondition646, base_OpaqueAction635, messageRef637, base_CallOperationAction639, base_CallOperationAction657, operationRef659, loopCardinality662, completionCondition664, base_ExpansionRegion667, messageRef649, base_AcceptEventAction651, operationRef654, noneBehaviorEventRef684, complexBehaviorDefinition687, loopDataInputRef669, loopDataOutputRef672, outputDataItem675, inputDataItem678, oneBehaviorEventRef681},
    generalizations={gen_BPMNProfile_InclusiveGateway_NonExclusiveGateway, gen_BPMNProfile_NonExclusiveGateway_Gateway, gen_BPMNProfile_Gateway_FlowNode, gen_BPMNProfile_FlowNode_FlowElement, gen_BPMNProfile_FlowElement_BaseElement, gen_BPMNProfile_Documentation_BaseElement, gen_BPMNProfile_BPMNAssociation_BPMNArtifact, gen_BPMNProfile_BPMNArtifact_BaseElement, gen_BPMNProfile_Monitoring_BaseElement, gen_BPMNProfile_CategoryValue_BaseElement, gen_BPMNProfile_FlowElementsContainer_BaseElement, gen_BPMNProfile_LaneSet_BaseElement, gen_BPMNProfile_Auditing_BaseElement, gen_BPMNProfile_Lane_BaseElement, gen_BPMNProfile_SequenceFlow_FlowElement, gen_BPMNProfile_BPMNExpression_BaseElement, gen_BPMNProfile_EventBasedGateway_Gateway, gen_BPMNProfile_ParallelGateway_NonExclusiveGateway, gen_BPMNProfile_ComplexGateway_NonExclusiveGateway, gen_BPMNProfile_ExclusiveGateway_Gateway, gen_BPMNProfile_RootElement_BaseElement, gen_BPMNProfile_Definitions_BaseElement, gen_BPMNProfile_BPMNRelationship_BaseElement, gen_BPMNProfile_BPMNProcess_CallableElement, gen_BPMNProfile_BPMNProcess_FlowElementsContainer, gen_BPMNProfile_CallableElement_RootElement, gen_BPMNProfile_InputOutputSpecification_BaseElement, gen_BPMNProfile_DataInput_ItemAwareElement, gen_BPMNProfile_ItemAwareElement_BaseElement, gen_BPMNProfile_DataState_BaseElement, gen_BPMNProfile_ItemDefinition_RootElement, gen_BPMNProfile_DataOutput_ItemAwareElement, gen_BPMNProfile_InputSet_BaseElement, gen_BPMNProfile_BPMNInterface_RootElement, gen_BPMNProfile_OutputSet_BaseElement, gen_BPMNProfile_BPMNOperation_BaseElement, gen_BPMNProfile_BPMNMessage_ItemDefinition, gen_BPMNProfile_Error_ItemDefinition, gen_BPMNProfile_InputOutputBinding_BaseElement, gen_BPMNProfile_BPMNCollaboration_RootElement, gen_BPMNProfile_ParticipantAssociation_BaseElement, gen_BPMNProfile_Participant_BaseElement, gen_BPMNProfile_Participant_InteractionNode, gen_BPMNProfile_ConversationLink_BaseElement, gen_BPMNProfile_ParticipantMultiplicity_BaseElement, gen_BPMNProfile_PartnerEntity_RootElement, gen_BPMNProfile_PartnerRole_RootElement, gen_BPMNProfile_MessageFlowAssociation_BaseElement, gen_BPMNProfile_MessageFlow_BaseElement, gen_BPMNProfile_ConversationNode_BaseElement, gen_BPMNProfile_ConversationNode_InteractionNode, gen_BPMNProfile_CorrelationKey_BaseElement, gen_BPMNProfile_CorrelationProperty_BaseElement, gen_BPMNProfile_CorrelationPropertyRetrievalExpression_BaseElement, gen_BPMNProfile_FormalExpression_BPMNExpression, gen_BPMNProfile_CorrelationSubscription_BaseElement, gen_BPMNProfile_CorrelationPropertyBinding_BaseElement, gen_BPMNProfile_BPMNProperty_ItemAwareElement, gen_BPMNProfile_ResourceRole_BaseElement, gen_BPMNProfile_ResourceAssignmentExpression_BPMNExpression, gen_BPMNProfile_Resource_ItemDefinition, gen_BPMNProfile_ResourceParameter_BaseElement, gen_BPMNProfile_ResourceParameterBinding_BaseElement, gen_BPMNProfile_GlobalScriptTask_GlobalTask, gen_BPMNProfile_GlobalTask_CallableElement, gen_BPMNProfile_GlobalBusinessRuleTask_GlobalTask, gen_BPMNProfile_CompensateEventDefinition_EventDefinition, gen_BPMNProfile_EventDefinition_RootElement, gen_BPMNProfile_BPMNActivity_FlowNode, gen_BPMNProfile_BPMNActivity_InteractionNode, gen_BPMNProfile_BoundaryEvent_CatchEvent, gen_BPMNProfile_CatchEvent_BPMNEvent, gen_BPMNProfile_BPMNEvent_FlowNode, gen_BPMNProfile_BPMNEvent_InteractionNode, gen_BPMNProfile_DataOutputAssociation_DataAssociation, gen_BPMNProfile_DataAssociation_BaseElement, gen_BPMNProfile_Assignment_BaseElement, gen_BPMNProfile_DataInputAssociation_DataAssociation, gen_BPMNProfile_LoopCharacteristics_BaseElement, gen_BPMNProfile_EscalationEventDefinition_EventDefinition, gen_BPMNProfile_Escalation_ItemDefinition, gen_BPMNProfile_TimerEventDefinition_EventDefinition, gen_BPMNProfile_SignalEventDefinition_EventDefinition, gen_BPMNProfile_BPMNSignal_ItemDefinition, gen_BPMNProfile_EndEvent_ThrowEvent, gen_BPMNProfile_ThrowEvent_BPMNEvent, gen_BPMNProfile_MessageEventDefinition_EventDefinition, gen_BPMNProfile_StartEvent_CatchEvent, gen_BPMNProfile_ConditionalEventDefinition_EventDefinition, gen_BPMNProfile_LinkEventDefinition_EventDefinition, gen_BPMNProfile_ErrorEventDefinition_EventDefinition, gen_BPMNProfile_IntermediateCatchEvent_CatchEvent, gen_BPMNProfile_IntermediateThrowEvent_ThrowEvent, gen_BPMNProfile_TerminateEventDefinition_EventDefinition, gen_BPMNProfile_ImplicitThrowEvent_ThrowEvent, gen_BPMNProfile_CancelEventDefinition_EventDefinition, gen_BPMNProfile_TextAnnotation_BPMNArtifact, gen_BPMNProfile_Category_RootElement, gen_BPMNProfile_Group_BPMNArtifact, gen_BPMNProfile_DataObjectReference_FlowElement, gen_BPMNProfile_DataObjectReference_ItemAwareElement, gen_BPMNProfile_DataObject_FlowElement, gen_BPMNProfile_DataObject_ItemAwareElement, gen_BPMNProfile_UserTask_Task, gen_BPMNProfile_DataStore_RootElement, gen_BPMNProfile_Task_BPMNActivity, gen_BPMNProfile_Rendering_BaseElement, gen_BPMNProfile_DataStoreReference_FlowElement, gen_BPMNProfile_DataStoreReference_ItemAwareElement, gen_BPMNProfile_GlobalManualTask_GlobalTask, gen_BPMNProfile_ManualTask_Task, gen_BPMNProfile_PotentialOwner_HumanPerformer, gen_BPMNProfile_SubConversation_ConversationNode, gen_BPMNProfile_GlobalConversation_BPMNCollaboration, gen_BPMNProfile_HumanPerformer_Performer, gen_BPMNProfile_Performer_ResourceRole, gen_BPMNProfile_GlobalUserTask_GlobalTask, gen_BPMNProfile_Conversation_ConversationNode, gen_BPMNProfile_SubProcess_BPMNActivity, gen_BPMNProfile_SubProcess_FlowElementsContainer, gen_BPMNProfile_CallActivity_BPMNActivity, gen_BPMNProfile_CallConversation_ConversationNode, gen_BPMNProfile_ComplexBehaviorDefinition_BaseElement, gen_BPMNProfile_AdHocSubProcess_SubProcess, gen_BPMNProfile_ScriptTask_Task, gen_BPMNProfile_BusinessRuleTask_Task, gen_BPMNProfile_Transaction_SubProcess, gen_BPMNProfile_StandardLoopCharacteristics_LoopCharacteristics, gen_BPMNProfile_ReceiveTask_Task, gen_BPMNProfile_SendTask_Task, gen_BPMNProfile_MultiInstanceLoopCharacteristics_LoopCharacteristics, gen_BPMNProfile_ServiceTask_Task},
    metadata=None
)
