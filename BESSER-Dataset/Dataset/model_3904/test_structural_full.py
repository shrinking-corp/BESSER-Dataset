...
def test_BPMNProfile_ConversationNode_isa_BaseElement():
...
def test_BPMNProfile_BPMNActivity_isa_InteractionNode():
    instance = BPMNProfile_BPMNActivity(completionQuantity="sample_text", isForCompensation="sample_text", startQuantity="sample_text")
    assert isinstance(instance, InteractionNode)


def test_BPMNProfile_BPMNEvent_isa_InteractionNode():
    instance = BPMNProfile_BPMNEvent()
    assert isinstance(instance, InteractionNode)
...
def test_BPMNProfile_Participant_isa_InteractionNode():
    instance = BPMNProfile_Participant()
    assert isinstance(instance, InteractionNode)
...
def test_assoc__collaborationUse608_link_reassign_clear():
...
def test_assoc__dataStore590_link_reassign_clear():
    ...
    _safe_set(a, 'BPMNProfile_DataStore591', b1)
    assert _is_linked(a, 'BPMNProfile_DataStore591', b1)
    if hasattr(b1, 'BPMNProfile_DataStoreReference'):
        assert _is_linked(b1, 'BPMNProfile_DataStoreReference', a)
    _safe_set(a, 'BPMNProfile_DataStore591', b2)
    assert _is_linked(a, 'BPMNProfile_DataStore591', b2)
    if hasattr(b1, 'BPMNProfile_DataStoreReference'):
    ...
    _safe_set(a, 'BPMNProfile_DataStore591', None)
    assert not _is_linked(a, 'BPMNProfile_DataStore591', b2)
    if hasattr(b2, 'BPMNProfile_DataStoreReference'):
...
def test_assoc_activationCondition96_link_reassign_clear():
    a = BPMNProfile_ComplexGateway()
    b1 = BPMNProfile_BPMNExpression()
    b2 = BPMNProfile_BPMNExpression()
    _safe_set(a, 'BPMNProfile_ComplexGateway97', b1)
    assert _is_linked(a, 'BPMNProfile_ComplexGateway97', b1)
    if hasattr(b1, 'BPMNProfile_BPMNExpression98'):
        assert _is_linked(b1, 'BPMNProfile_BPMNExpression98', a)
    _safe_set(a, 'BPMNProfile_ComplexGateway97', b2)
    assert _is_linked(a, 'BPMNProfile_ComplexGateway97', b2)
    if hasattr(b1, 'BPMNProfile_BPMNExpression98'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNExpression98', a)
    if hasattr(b2, 'BPMNProfile_BPMNExpression98'):
        assert _is_linked(b2, 'BPMNProfile_BPMNExpression98', a)
    _safe_set(a, 'BPMNProfile_ComplexGateway97', None)
    assert not _is_linked(a, 'BPMNProfile_ComplexGateway97', b2)
    if hasattr(b2, 'BPMNProfile_BPMNExpression98'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNExpression98', a)


def test_assoc_activityClass448_link_reassign_clear():
    ...
    _safe_set(a, 'BPMNProfile_BPMNActivity449', b1)
    assert _is_linked(a, 'BPMNProfile_BPMNActivity449', b1)
    if hasattr(b1, 'BPMNProfile_Class450'):
        assert _is_linked(b1, 'BPMNProfile_Class450', a)
    _safe_set(a, 'BPMNProfile_BPMNActivity449', b2)
    assert _is_linked(a, 'BPMNProfile_BPMNActivity449', b2)
    if hasattr(b1, 'BPMNProfile_Class450'):
        assert not _is_linked(b1, 'BPMNProfile_Class450', a)
    if hasattr(b2, 'BPMNProfile_Class450'):
        assert _is_linked(b2, 'BPMNProfile_Class450', a)
    _safe_set(a, 'BPMNProfile_BPMNActivity449', None)
    assert not _is_linked(a, 'BPMNProfile_BPMNActivity449', b2)
    if hasattr(b2, 'BPMNProfile_Class450'):
        assert not _is_linked(b2, 'BPMNProfile_Class450', a)


def test_assoc_activityRef441_link_reassign_clear():
...
def test_assoc_assignment498_link_reassign_clear():
    a = BPMNProfile_DataAssociation()
    b1 = BPMNProfile_Assignment()
    b2 = BPMNProfile_Assignment()
    _safe_set(a, 'BPMNProfile_DataAssociation499', {b1})
    assert _is_linked(a, 'BPMNProfile_DataAssociation499', b1)
    if hasattr(b1, 'BPMNProfile_Assignment'):
        assert _is_linked(b1, 'BPMNProfile_Assignment', a)
    _safe_set(a, 'BPMNProfile_DataAssociation499', {b2})
    assert _is_linked(a, 'BPMNProfile_DataAssociation499', b2)
    if hasattr(b1, 'BPMNProfile_Assignment'):
    ...
    _safe_set(a, 'BPMNProfile_DataAssociation499', set())
    assert not _is_linked(a, 'BPMNProfile_DataAssociation499', b2)
    if hasattr(b2, 'BPMNProfile_Assignment'):
        assert not _is_linked(b2, 'BPMNProfile_Assignment', a)


def test_assoc_attachedToRef468_link_reassign_clear():
    a = BPMNProfile_BoundaryEvent(cancelActivity="sample_text")
    b1 = BPMNProfile_BPMNActivity(completionQuantity="sample_text", isForCompensation="sample_text", startQuantity="sample_text")
    b2 = BPMNProfile_BPMNActivity(completionQuantity="sample_text_2", isForCompensation="sample_text_2", startQuantity="sample_text_2")
    _safe_set(a, 'BPMNProfile_BoundaryEvent469', b1)
    assert _is_linked(a, 'BPMNProfile_BoundaryEvent469', b1)
    if hasattr(b1, 'BPMNProfile_BPMNActivity470'):
        assert _is_linked(b1, 'BPMNProfile_BPMNActivity470', a)
    _safe_set(a, 'BPMNProfile_BoundaryEvent469', b2)
    assert _is_linked(a, 'BPMNProfile_BoundaryEvent469', b2)
    if hasattr(b1, 'BPMNProfile_BPMNActivity470'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNActivity470', a)
    if hasattr(b2, 'BPMNProfile_BPMNActivity470'):
        assert _is_linked(b2, 'BPMNProfile_BPMNActivity470', a)
    _safe_set(a, 'BPMNProfile_BoundaryEvent469', None)
    assert not _is_linked(a, 'BPMNProfile_BoundaryEvent469', b2)
    if hasattr(b2, 'BPMNProfile_BPMNActivity470'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNActivity470', a)


def test_assoc_auditing137_link_reassign_clear():
    ...
    if hasattr(b1, 'BPMNProfile_Auditing138'):
        assert _is_linked(b1, 'BPMNProfile_Auditing138', a)
    _safe_set(a, 'BPMNProfile_BPMNProcess', b2)
    assert _is_linked(a, 'BPMNProfile_BPMNProcess', b2)
    if hasattr(b1, 'BPMNProfile_Auditing138'):
        assert not _is_linked(b1, 'BPMNProfile_Auditing138', a)
    if hasattr(b2, 'BPMNProfile_Auditing138'):
        assert _is_linked(b2, 'BPMNProfile_Auditing138', a)
    _safe_set(a, 'BPMNProfile_BPMNProcess', None)
    assert not _is_linked(a, 'BPMNProfile_BPMNProcess', b2)
    if hasattr(b2, 'BPMNProfile_Auditing138'):
        assert not _is_linked(b2, 'BPMNProfile_Auditing138', a)


def test_assoc_base_AcceptEventAction471_link_reassign_clear():
...
def test_assoc_base_AcceptEventAction651_link_reassign_clear():
    a = BPMNProfile_ReceiveTask(implementation="sample_text", instantiate="sample_text")
    b1 = BPMNProfile_AcceptEventAction()
    b2 = BPMNProfile_AcceptEventAction()
    _safe_set(a, 'BPMNProfile_ReceiveTask652', b1)
    assert _is_linked(a, 'BPMNProfile_ReceiveTask652', b1)
    if hasattr(b1, 'BPMNProfile_AcceptEventAction653'):
        assert _is_linked(b1, 'BPMNProfile_AcceptEventAction653', a)
    _safe_set(a, 'BPMNProfile_ReceiveTask652', b2)
    assert _is_linked(a, 'BPMNProfile_ReceiveTask652', b2)
    if hasattr(b1, 'BPMNProfile_AcceptEventAction653'):
        assert not _is_linked(b1, 'BPMNProfile_AcceptEventAction653', a)
    if hasattr(b2, 'BPMNProfile_AcceptEventAction653'):
        assert _is_linked(b2, 'BPMNProfile_AcceptEventAction653', a)
    _safe_set(a, 'BPMNProfile_ReceiveTask652', None)
    assert not _is_linked(a, 'BPMNProfile_ReceiveTask652', b2)
    if hasattr(b2, 'BPMNProfile_AcceptEventAction653'):
        assert not _is_linked(b2, 'BPMNProfile_AcceptEventAction653', a)


def test_assoc_base_Action445_link_reassign_clear():
    a = BPMNProfile_BPMNActivity(completionQuantity="sample_text", isForCompensation="sample_text", startQuantity="sample_text")
    b1 = BPMNProfile_Action()
    b2 = BPMNProfile_Action()
    _safe_set(a, 'BPMNProfile_BPMNActivity446', b1)
    assert _is_linked(a, 'BPMNProfile_BPMNActivity446', b1)
    if hasattr(b1, 'BPMNProfile_Action447'):
        assert _is_linked(b1, 'BPMNProfile_Action447', a)
    _safe_set(a, 'BPMNProfile_BPMNActivity446', b2)
    assert _is_linked(a, 'BPMNProfile_BPMNActivity446', b2)
    if hasattr(b1, 'BPMNProfile_Action447'):
        assert not _is_linked(b1, 'BPMNProfile_Action447', a)
    if hasattr(b2, 'BPMNProfile_Action447'):
        assert _is_linked(b2, 'BPMNProfile_Action447', a)
    _safe_set(a, 'BPMNProfile_BPMNActivity446', None)
    assert not _is_linked(a, 'BPMNProfile_BPMNActivity446', b2)
    if hasattr(b2, 'BPMNProfile_Action447'):
        assert not _is_linked(b2, 'BPMNProfile_Action447', a)


def test_assoc_base_Activity141_link_reassign_clear():
    a = BPMNProfile_BPMNProcess(isClosed="sample_text", isExecutable="sample_text", processType="sample_text")
...
def test_assoc_base_ActivityParameterNode178_link_reassign_clear():
    a = BPMNProfile_DataInput(isCollection="sample_text")
    b1 = BPMNProfile_ActivityParameterNode()
    b2 = BPMNProfile_ActivityParameterNode()
    _safe_set(a, 'BPMNProfile_DataInput179', b1)
    assert _is_linked(a, 'BPMNProfile_DataInput179', b1)
    if hasattr(b1, 'BPMNProfile_ActivityParameterNode'):
        assert _is_linked(b1, 'BPMNProfile_ActivityParameterNode', a)
    _safe_set(a, 'BPMNProfile_DataInput179', b2)
    assert _is_linked(a, 'BPMNProfile_DataInput179', b2)
    if hasattr(b1, 'BPMNProfile_ActivityParameterNode'):
    ...
    _safe_set(a, 'BPMNProfile_DataInput179', None)
    assert not _is_linked(a, 'BPMNProfile_DataInput179', b2)
    if hasattr(b2, 'BPMNProfile_ActivityParameterNode'):
        assert not _is_linked(b2, 'BPMNProfile_ActivityParameterNode', a)


def test_assoc_base_ActivityParameterNode213_link_reassign_clear():
    a = BPMNProfile_DataOutput(isCollection="sample_text")
    b1 = BPMNProfile_ActivityParameterNode()
    b2 = BPMNProfile_ActivityParameterNode()
    _safe_set(a, 'BPMNProfile_DataOutput214', b1)
    assert _is_linked(a, 'BPMNProfile_DataOutput214', b1)
    if hasattr(b1, 'BPMNProfile_ActivityParameterNode215'):
        assert _is_linked(b1, 'BPMNProfile_ActivityParameterNode215', a)
    _safe_set(a, 'BPMNProfile_DataOutput214', b2)
    assert _is_linked(a, 'BPMNProfile_DataOutput214', b2)
    if hasattr(b1, 'BPMNProfile_ActivityParameterNode215'):
        assert not _is_linked(b1, 'BPMNProfile_ActivityParameterNode215', a)
    if hasattr(b2, 'BPMNProfile_ActivityParameterNode215'):
        assert _is_linked(b2, 'BPMNProfile_ActivityParameterNode215', a)
    _safe_set(a, 'BPMNProfile_DataOutput214', None)
    assert not _is_linked(a, 'BPMNProfile_DataOutput214', b2)
    if hasattr(b2, 'BPMNProfile_ActivityParameterNode215'):
        assert not _is_linked(b2, 'BPMNProfile_ActivityParameterNode215', a)
...
def test_assoc_base_Behavior154_link_reassign_clear():
...
def test_assoc_base_CallBehaviorAction620_link_reassign_clear():
...
def test_assoc_base_CallEvent442_link_reassign_clear():
    a = BPMNProfile_CompensateEventDefinition(waitForCompletion="sample_text")
    b1 = BPMNProfile_CallEvent()
    b2 = BPMNProfile_CallEvent()
    _safe_set(a, 'BPMNProfile_CompensateEventDefinition443', b1)
    assert _is_linked(a, 'BPMNProfile_CompensateEventDefinition443', b1)
    if hasattr(b1, 'BPMNProfile_CallEvent'):
        assert _is_linked(b1, 'BPMNProfile_CallEvent', a)
    _safe_set(a, 'BPMNProfile_CompensateEventDefinition443', b2)
    assert _is_linked(a, 'BPMNProfile_CompensateEventDefinition443', b2)
    if hasattr(b1, 'BPMNProfile_CallEvent'):
    ...
    _safe_set(a, 'BPMNProfile_CompensateEventDefinition443', None)
    assert not _is_linked(a, 'BPMNProfile_CompensateEventDefinition443', b2)
    if hasattr(b2, 'BPMNProfile_CallEvent'):
        assert not _is_linked(b2, 'BPMNProfile_CallEvent', a)


def test_assoc_base_CallOperationAction531_link_reassign_clear():
...
def test_assoc_base_CallOperationAction639_link_reassign_clear():
    a = BPMNProfile_SendTask(implementation="sample_text")
    b1 = BPMNProfile_CallOperationAction()
    b2 = BPMNProfile_CallOperationAction()
    _safe_set(a, 'BPMNProfile_SendTask640', b1)
    assert _is_linked(a, 'BPMNProfile_SendTask640', b1)
    if hasattr(b1, 'BPMNProfile_CallOperationAction641'):
        assert _is_linked(b1, 'BPMNProfile_CallOperationAction641', a)
    _safe_set(a, 'BPMNProfile_SendTask640', b2)
    assert _is_linked(a, 'BPMNProfile_SendTask640', b2)
    if hasattr(b1, 'BPMNProfile_CallOperationAction641'):
        assert not _is_linked(b1, 'BPMNProfile_CallOperationAction641', a)
    if hasattr(b2, 'BPMNProfile_CallOperationAction641'):
        assert _is_linked(b2, 'BPMNProfile_CallOperationAction641', a)
    _safe_set(a, 'BPMNProfile_SendTask640', None)
    assert not _is_linked(a, 'BPMNProfile_SendTask640', b2)
    if hasattr(b2, 'BPMNProfile_CallOperationAction641'):
        assert not _is_linked(b2, 'BPMNProfile_CallOperationAction641', a)


def test_assoc_base_CallOperationAction657_link_reassign_clear():
    ...
    if hasattr(b1, 'BPMNProfile_CallOperationAction658'):
        assert _is_linked(b1, 'BPMNProfile_CallOperationAction658', a)
    _safe_set(a, 'BPMNProfile_ServiceTask', b2)
    assert _is_linked(a, 'BPMNProfile_ServiceTask', b2)
    if hasattr(b1, 'BPMNProfile_CallOperationAction658'):
        assert not _is_linked(b1, 'BPMNProfile_CallOperationAction658', a)
    if hasattr(b2, 'BPMNProfile_CallOperationAction658'):
        assert _is_linked(b2, 'BPMNProfile_CallOperationAction658', a)
    _safe_set(a, 'BPMNProfile_ServiceTask', None)
    assert not _is_linked(a, 'BPMNProfile_ServiceTask', b2)
    if hasattr(b2, 'BPMNProfile_CallOperationAction658'):
        assert not _is_linked(b2, 'BPMNProfile_CallOperationAction658', a)


def test_assoc_base_ChangeEvent545_link_reassign_clear():
    ...
    if hasattr(b1, 'BPMNProfile_ChangeEvent546'):
        assert _is_linked(b1, 'BPMNProfile_ChangeEvent546', a)
    _safe_set(a, 'BPMNProfile_ConditionalEventDefinition', b2)
    assert _is_linked(a, 'BPMNProfile_ConditionalEventDefinition', b2)
    if hasattr(b1, 'BPMNProfile_ChangeEvent546'):
        assert not _is_linked(b1, 'BPMNProfile_ChangeEvent546', a)
    if hasattr(b2, 'BPMNProfile_ChangeEvent546'):
        assert _is_linked(b2, 'BPMNProfile_ChangeEvent546', a)
    _safe_set(a, 'BPMNProfile_ConditionalEventDefinition', None)
    assert not _is_linked(a, 'BPMNProfile_ConditionalEventDefinition', b2)
    if hasattr(b2, 'BPMNProfile_ChangeEvent546'):
        assert not _is_linked(b2, 'BPMNProfile_ChangeEvent546', a)


def test_assoc_base_Class192_link_reassign_clear():
    ...
    if hasattr(b1, 'BPMNProfile_Class194'):
        assert _is_linked(b1, 'BPMNProfile_Class194', a)
    _safe_set(a, 'BPMNProfile_ItemDefinition193', b2)
    assert _is_linked(a, 'BPMNProfile_ItemDefinition193', b2)
    if hasattr(b1, 'BPMNProfile_Class194'):
        assert not _is_linked(b1, 'BPMNProfile_Class194', a)
    if hasattr(b2, 'BPMNProfile_Class194'):
        assert _is_linked(b2, 'BPMNProfile_Class194', a)
    _safe_set(a, 'BPMNProfile_ItemDefinition193', None)
    assert not _is_linked(a, 'BPMNProfile_ItemDefinition193', b2)
    if hasattr(b2, 'BPMNProfile_Class194'):
        assert not _is_linked(b2, 'BPMNProfile_Class194', a)


def test_assoc_base_Class326_link_reassign_clear():
    a = BPMNProfile_PartnerRole()
    b1 = BPMNProfile_Class()
    b2 = BPMNProfile_Class()
    _safe_set(a, 'BPMNProfile_PartnerRole', b1)
    assert _is_linked(a, 'BPMNProfile_PartnerRole', b1)
    if hasattr(b1, 'BPMNProfile_Class327'):
        assert _is_linked(b1, 'BPMNProfile_Class327', a)
    _safe_set(a, 'BPMNProfile_PartnerRole', b2)
    assert _is_linked(a, 'BPMNProfile_PartnerRole', b2)
    if hasattr(b1, 'BPMNProfile_Class327'):
        assert not _is_linked(b1, 'BPMNProfile_Class327', a)
    if hasattr(b2, 'BPMNProfile_Class327'):
        assert _is_linked(b2, 'BPMNProfile_Class327', a)
    _safe_set(a, 'BPMNProfile_PartnerRole', None)
    assert not _is_linked(a, 'BPMNProfile_PartnerRole', b2)
    if hasattr(b2, 'BPMNProfile_Class327'):
        assert not _is_linked(b2, 'BPMNProfile_Class327', a)


def test_assoc_base_Class585_link_reassign_clear():
    a = BPMNProfile_DataStore(capacity="sample_text", isUnlimited="sample_text")
    b1 = BPMNProfile_Class()
    b2 = BPMNProfile_Class()
    _safe_set(a, 'BPMNProfile_DataStore', b1)
    assert _is_linked(a, 'BPMNProfile_DataStore', b1)
    if hasattr(b1, 'BPMNProfile_Class586'):
        assert _is_linked(b1, 'BPMNProfile_Class586', a)
    _safe_set(a, 'BPMNProfile_DataStore', b2)
    assert _is_linked(a, 'BPMNProfile_DataStore', b2)
    if hasattr(b1, 'BPMNProfile_Class586'):
        assert not _is_linked(b1, 'BPMNProfile_Class586', a)
    if hasattr(b2, 'BPMNProfile_Class586'):
        assert _is_linked(b2, 'BPMNProfile_Class586', a)
    _safe_set(a, 'BPMNProfile_DataStore', None)
    assert not _is_linked(a, 'BPMNProfile_DataStore', b2)
    if hasattr(b2, 'BPMNProfile_Class586'):
        assert not _is_linked(b2, 'BPMNProfile_Class586', a)


def test_assoc_base_Collaboration277_link_reassign_clear():
    a = BPMNProfile_BPMNCollaboration(isClosed="sample_text")
    b1 = BPMNProfile_Collaboration()
    b2 = BPMNProfile_Collaboration()
    _safe_set(a, 'BPMNProfile_BPMNCollaboration278', b1)
    assert _is_linked(a, 'BPMNProfile_BPMNCollaboration278', b1)
    if hasattr(b1, 'BPMNProfile_Collaboration'):
        assert _is_linked(b1, 'BPMNProfile_Collaboration', a)
    _safe_set(a, 'BPMNProfile_BPMNCollaboration278', b2)
    assert _is_linked(a, 'BPMNProfile_BPMNCollaboration278', b2)
    if hasattr(b1, 'BPMNProfile_Collaboration'):
    ...
    _safe_set(a, 'BPMNProfile_BPMNCollaboration278', None)
    assert not _is_linked(a, 'BPMNProfile_BPMNCollaboration278', b2)
    if hasattr(b2, 'BPMNProfile_Collaboration'):
...
def test_assoc_base_Comment567_link_reassign_clear():
    ...
    if hasattr(b1, 'BPMNProfile_Comment568'):
        assert _is_linked(b1, 'BPMNProfile_Comment568', a)
    _safe_set(a, 'BPMNProfile_TextAnnotation', b2)
    assert _is_linked(a, 'BPMNProfile_TextAnnotation', b2)
    if hasattr(b1, 'BPMNProfile_Comment568'):
        assert not _is_linked(b1, 'BPMNProfile_Comment568', a)
    if hasattr(b2, 'BPMNProfile_Comment568'):
        assert _is_linked(b2, 'BPMNProfile_Comment568', a)
    _safe_set(a, 'BPMNProfile_TextAnnotation', None)
    assert not _is_linked(a, 'BPMNProfile_TextAnnotation', b2)
    if hasattr(b2, 'BPMNProfile_Comment568'):
        assert not _is_linked(b2, 'BPMNProfile_Comment568', a)


def test_assoc_base_Constraint126_link_reassign_clear():
    a = BPMNProfile_BPMNRelationship(direction="sample_text", type="sample_text")
    b1 = BPMNProfile_Constraint()
    b2 = BPMNProfile_Constraint()
    _safe_set(a, 'BPMNProfile_BPMNRelationship127', b1)
    assert _is_linked(a, 'BPMNProfile_BPMNRelationship127', b1)
    if hasattr(b1, 'BPMNProfile_Constraint'):
        assert _is_linked(b1, 'BPMNProfile_Constraint', a)
    _safe_set(a, 'BPMNProfile_BPMNRelationship127', b2)
    assert _is_linked(a, 'BPMNProfile_BPMNRelationship127', b2)
    if hasattr(b1, 'BPMNProfile_Constraint'):
    ...
    _safe_set(a, 'BPMNProfile_BPMNRelationship127', None)
    assert not _is_linked(a, 'BPMNProfile_BPMNRelationship127', b2)
    if hasattr(b2, 'BPMNProfile_Constraint'):
...
def test_assoc_base_DataStoreNode403_link_reassign_clear():
    a = BPMNProfile_BPMNProperty()
    b1 = BPMNProfile_DataStoreNode()
    b2 = BPMNProfile_DataStoreNode()
    _safe_set(a, 'BPMNProfile_BPMNProperty404', b1)
    assert _is_linked(a, 'BPMNProfile_BPMNProperty404', b1)
    if hasattr(b1, 'BPMNProfile_DataStoreNode'):
        assert _is_linked(b1, 'BPMNProfile_DataStoreNode', a)
    _safe_set(a, 'BPMNProfile_BPMNProperty404', b2)
    assert _is_linked(a, 'BPMNProfile_BPMNProperty404', b2)
    if hasattr(b1, 'BPMNProfile_DataStoreNode'):
    ...
    _safe_set(a, 'BPMNProfile_BPMNProperty404', None)
    assert not _is_linked(a, 'BPMNProfile_BPMNProperty404', b2)
    if hasattr(b2, 'BPMNProfile_DataStoreNode'):
        assert not _is_linked(b2, 'BPMNProfile_DataStoreNode', a)


def test_assoc_base_DataStoreNode579_link_reassign_clear():
    a = BPMNProfile_DataObjectReference()
    b1 = BPMNProfile_DataStoreNode()
    b2 = BPMNProfile_DataStoreNode()
    _safe_set(a, 'BPMNProfile_DataObjectReference580', b1)
    assert _is_linked(a, 'BPMNProfile_DataObjectReference580', b1)
    if hasattr(b1, 'BPMNProfile_DataStoreNode581'):
        assert _is_linked(b1, 'BPMNProfile_DataStoreNode581', a)
    _safe_set(a, 'BPMNProfile_DataObjectReference580', b2)
    assert _is_linked(a, 'BPMNProfile_DataObjectReference580', b2)
    if hasattr(b1, 'BPMNProfile_DataStoreNode581'):
        assert not _is_linked(b1, 'BPMNProfile_DataStoreNode581', a)
    if hasattr(b2, 'BPMNProfile_DataStoreNode581'):
        assert _is_linked(b2, 'BPMNProfile_DataStoreNode581', a)
    _safe_set(a, 'BPMNProfile_DataObjectReference580', None)
    assert not _is_linked(a, 'BPMNProfile_DataObjectReference580', b2)
    if hasattr(b2, 'BPMNProfile_DataStoreNode581'):
        assert not _is_linked(b2, 'BPMNProfile_DataStoreNode581', a)


def test_assoc_base_DataStoreNode582_link_reassign_clear():
    a = BPMNProfile_DataObject(isCollection="sample_text")
    b1 = BPMNProfile_DataStoreNode()
    b2 = BPMNProfile_DataStoreNode()
    _safe_set(a, 'BPMNProfile_DataObject583', b1)
    assert _is_linked(a, 'BPMNProfile_DataObject583', b1)
    if hasattr(b1, 'BPMNProfile_DataStoreNode584'):
        assert _is_linked(b1, 'BPMNProfile_DataStoreNode584', a)
    _safe_set(a, 'BPMNProfile_DataObject583', b2)
    assert _is_linked(a, 'BPMNProfile_DataObject583', b2)
    if hasattr(b1, 'BPMNProfile_DataStoreNode584'):
        assert not _is_linked(b1, 'BPMNProfile_DataStoreNode584', a)
    if hasattr(b2, 'BPMNProfile_DataStoreNode584'):
        assert _is_linked(b2, 'BPMNProfile_DataStoreNode584', a)
    _safe_set(a, 'BPMNProfile_DataObject583', None)
    assert not _is_linked(a, 'BPMNProfile_DataObject583', b2)
    if hasattr(b2, 'BPMNProfile_DataStoreNode584'):
        assert not _is_linked(b2, 'BPMNProfile_DataStoreNode584', a)


def test_assoc_base_DecisionNode99_link_reassign_clear():
...
def test_assoc_base_Dependency285_link_reassign_clear():
    ...
    if hasattr(b1, 'BPMNProfile_Dependency287'):
        assert _is_linked(b1, 'BPMNProfile_Dependency287', a)
    _safe_set(a, 'BPMNProfile_ParticipantAssociation286', b2)
    assert _is_linked(a, 'BPMNProfile_ParticipantAssociation286', b2)
    if hasattr(b1, 'BPMNProfile_Dependency287'):
        assert not _is_linked(b1, 'BPMNProfile_Dependency287', a)
    if hasattr(b2, 'BPMNProfile_Dependency287'):
        assert _is_linked(b2, 'BPMNProfile_Dependency287', a)
    _safe_set(a, 'BPMNProfile_ParticipantAssociation286', None)
    assert not _is_linked(a, 'BPMNProfile_ParticipantAssociation286', b2)
    if hasattr(b2, 'BPMNProfile_Dependency287'):
        assert not _is_linked(b2, 'BPMNProfile_Dependency287', a)


def test_assoc_base_Dependency330_link_reassign_clear():
    ...
    if hasattr(b1, 'BPMNProfile_Dependency332'):
        assert _is_linked(b1, 'BPMNProfile_Dependency332', a)
    _safe_set(a, 'BPMNProfile_MessageFlowAssociation331', b2)
    assert _is_linked(a, 'BPMNProfile_MessageFlowAssociation331', b2)
    if hasattr(b1, 'BPMNProfile_Dependency332'):
        assert not _is_linked(b1, 'BPMNProfile_Dependency332', a)
    if hasattr(b2, 'BPMNProfile_Dependency332'):
        assert _is_linked(b2, 'BPMNProfile_Dependency332', a)
    _safe_set(a, 'BPMNProfile_MessageFlowAssociation331', None)
    assert not _is_linked(a, 'BPMNProfile_MessageFlowAssociation331', b2)
    if hasattr(b2, 'BPMNProfile_Dependency332'):
        assert not _is_linked(b2, 'BPMNProfile_Dependency332', a)
...
def test_assoc_base_ExpansionRegion667_link_reassign_clear():
    ...
    _safe_set(a, 'BPMNProfile_MultiInstanceLoopCharacteristics668', b1)
    assert _is_linked(a, 'BPMNProfile_MultiInstanceLoopCharacteristics668', b1)
    if hasattr(b1, 'BPMNProfile_ExpansionRegion'):
        assert _is_linked(b1, 'BPMNProfile_ExpansionRegion', a)
    _safe_set(a, 'BPMNProfile_MultiInstanceLoopCharacteristics668', b2)
    assert _is_linked(a, 'BPMNProfile_MultiInstanceLoopCharacteristics668', b2)
    if hasattr(b1, 'BPMNProfile_ExpansionRegion'):
    ...
    _safe_set(a, 'BPMNProfile_MultiInstanceLoopCharacteristics668', None)
    assert not _is_linked(a, 'BPMNProfile_MultiInstanceLoopCharacteristics668', b2)
    if hasattr(b2, 'BPMNProfile_ExpansionRegion'):
        assert not _is_linked(b2, 'BPMNProfile_ExpansionRegion', a)


def test_assoc_base_FlowFinalNode532_link_reassign_clear():
    a = BPMNProfile_ThrowEvent()
    b1 = BPMNProfile_FlowFinalNode()
    b2 = BPMNProfile_FlowFinalNode()
    _safe_set(a, 'BPMNProfile_ThrowEvent533', b1)
    assert _is_linked(a, 'BPMNProfile_ThrowEvent533', b1)
    if hasattr(b1, 'BPMNProfile_FlowFinalNode'):
        assert _is_linked(b1, 'BPMNProfile_FlowFinalNode', a)
    _safe_set(a, 'BPMNProfile_ThrowEvent533', b2)
    assert _is_linked(a, 'BPMNProfile_ThrowEvent533', b2)
    if hasattr(b1, 'BPMNProfile_FlowFinalNode'):
    ...
    _safe_set(a, 'BPMNProfile_ThrowEvent533', None)
    assert not _is_linked(a, 'BPMNProfile_ThrowEvent533', b2)
    if hasattr(b2, 'BPMNProfile_FlowFinalNode'):
        assert not _is_linked(b2, 'BPMNProfile_FlowFinalNode', a)


def test_assoc_base_ForkNode88_link_reassign_clear():
    ...
    if hasattr(b1, 'BPMNProfile_ForkNode89'):
        assert _is_linked(b1, 'BPMNProfile_ForkNode89', a)
    _safe_set(a, 'BPMNProfile_EventBasedGateway', b2)
    assert _is_linked(a, 'BPMNProfile_EventBasedGateway', b2)
    if hasattr(b1, 'BPMNProfile_ForkNode89'):
        assert not _is_linked(b1, 'BPMNProfile_ForkNode89', a)
    if hasattr(b2, 'BPMNProfile_ForkNode89'):
        assert _is_linked(b2, 'BPMNProfile_ForkNode89', a)
    _safe_set(a, 'BPMNProfile_EventBasedGateway', None)
    assert not _is_linked(a, 'BPMNProfile_EventBasedGateway', b2)
    if hasattr(b2, 'BPMNProfile_ForkNode89'):
        assert not _is_linked(b2, 'BPMNProfile_ForkNode89', a)


def test_assoc_base_InformationFlow339_link_reassign_clear():
    a = BPMNProfile_MessageFlow()
    b1 = BPMNProfile_InformationFlow()
    b2 = BPMNProfile_InformationFlow()
    _safe_set(a, 'BPMNProfile_MessageFlow340', b1)
    assert _is_linked(a, 'BPMNProfile_MessageFlow340', b1)
    if hasattr(b1, 'BPMNProfile_InformationFlow'):
        assert _is_linked(b1, 'BPMNProfile_InformationFlow', a)
    _safe_set(a, 'BPMNProfile_MessageFlow340', b2)
    assert _is_linked(a, 'BPMNProfile_MessageFlow340', b2)
    if hasattr(b1, 'BPMNProfile_InformationFlow'):
    ...
    _safe_set(a, 'BPMNProfile_MessageFlow340', None)
    assert not _is_linked(a, 'BPMNProfile_MessageFlow340', b2)
    if hasattr(b2, 'BPMNProfile_InformationFlow'):
        assert not _is_linked(b2, 'BPMNProfile_InformationFlow', a)


def test_assoc_base_InformationFlow350_link_reassign_clear():
    ...
    if hasattr(b1, 'BPMNProfile_InformationFlow352'):
        assert _is_linked(b1, 'BPMNProfile_InformationFlow352', a)
    _safe_set(a, 'BPMNProfile_ConversationNode351', b2)
    assert _is_linked(a, 'BPMNProfile_ConversationNode351', b2)
    if hasattr(b1, 'BPMNProfile_InformationFlow352'):
        assert not _is_linked(b1, 'BPMNProfile_InformationFlow352', a)
    if hasattr(b2, 'BPMNProfile_InformationFlow352'):
        assert _is_linked(b2, 'BPMNProfile_InformationFlow352', a)
    _safe_set(a, 'BPMNProfile_ConversationNode351', None)
    assert not _is_linked(a, 'BPMNProfile_ConversationNode351', b2)
    if hasattr(b2, 'BPMNProfile_InformationFlow352'):
        assert not _is_linked(b2, 'BPMNProfile_InformationFlow352', a)


def test_assoc_base_InitialNode472_link_reassign_clear():
    a = BPMNProfile_CatchEvent(parallelMultiple="sample_text")
    b1 = BPMNProfile_InitialNode()
    b2 = BPMNProfile_InitialNode()
    _safe_set(a, 'BPMNProfile_CatchEvent473', b1)
    assert _is_linked(a, 'BPMNProfile_CatchEvent473', b1)
    if hasattr(b1, 'BPMNProfile_InitialNode'):
        assert _is_linked(b1, 'BPMNProfile_InitialNode', a)
    _safe_set(a, 'BPMNProfile_CatchEvent473', b2)
    assert _is_linked(a, 'BPMNProfile_CatchEvent473', b2)
    if hasattr(b1, 'BPMNProfile_InitialNode'):
    ...
    _safe_set(a, 'BPMNProfile_CatchEvent473', None)
    assert not _is_linked(a, 'BPMNProfile_CatchEvent473', b2)
    if hasattr(b2, 'BPMNProfile_InitialNode'):
        assert not _is_linked(b2, 'BPMNProfile_InitialNode', a)


def test_assoc_base_InputPin174_link_reassign_clear():
    a = BPMNProfile_DataInput(isCollection="sample_text")
    b1 = BPMNProfile_InputPin()
    b2 = BPMNProfile_InputPin()
    _safe_set(a, 'BPMNProfile_DataInput175', b1)
    assert _is_linked(a, 'BPMNProfile_DataInput175', b1)
    if hasattr(b1, 'BPMNProfile_InputPin'):
        assert _is_linked(b1, 'BPMNProfile_InputPin', a)
    _safe_set(a, 'BPMNProfile_DataInput175', b2)
    assert _is_linked(a, 'BPMNProfile_DataInput175', b2)
    if hasattr(b1, 'BPMNProfile_InputPin'):
    ...
    _safe_set(a, 'BPMNProfile_DataInput175', None)
    assert not _is_linked(a, 'BPMNProfile_DataInput175', b2)
    if hasattr(b2, 'BPMNProfile_InputPin'):
        assert not _is_linked(b2, 'BPMNProfile_InputPin', a)


def test_assoc_base_InstanceSpecification324_link_reassign_clear():
...
def test_assoc_base_Interface233_link_reassign_clear():
    a = BPMNProfile_BPMNInterface()
    b1 = BPMNProfile_Interface()
    b2 = BPMNProfile_Interface()
    _safe_set(a, 'BPMNProfile_BPMNInterface234', b1)
    assert _is_linked(a, 'BPMNProfile_BPMNInterface234', b1)
    if hasattr(b1, 'BPMNProfile_Interface'):
        assert _is_linked(b1, 'BPMNProfile_Interface', a)
    _safe_set(a, 'BPMNProfile_BPMNInterface234', b2)
    assert _is_linked(a, 'BPMNProfile_BPMNInterface234', b2)
    if hasattr(b1, 'BPMNProfile_Interface'):
    ...
    _safe_set(a, 'BPMNProfile_BPMNInterface234', None)
    assert not _is_linked(a, 'BPMNProfile_BPMNInterface234', b2)
    if hasattr(b2, 'BPMNProfile_Interface'):
        assert not _is_linked(b2, 'BPMNProfile_Interface', a)


def test_assoc_base_InterruptibleActivityRegion92_link_reassign_clear():
    a = BPMNProfile_EventBasedGateway(eventGatewayType="sample_text", instantiate="sample_text")
    b1 = BPMNProfile_InterruptibleActivityRegion()
    b2 = BPMNProfile_InterruptibleActivityRegion()
    _safe_set(a, 'BPMNProfile_EventBasedGateway93', b1)
    assert _is_linked(a, 'BPMNProfile_EventBasedGateway93', b1)
    if hasattr(b1, 'BPMNProfile_InterruptibleActivityRegion'):
        assert _is_linked(b1, 'BPMNProfile_InterruptibleActivityRegion', a)
    _safe_set(a, 'BPMNProfile_EventBasedGateway93', b2)
    assert _is_linked(a, 'BPMNProfile_EventBasedGateway93', b2)
    if hasattr(b1, 'BPMNProfile_InterruptibleActivityRegion'):
    ...
    _safe_set(a, 'BPMNProfile_EventBasedGateway93', None)
    assert not _is_linked(a, 'BPMNProfile_EventBasedGateway93', b2)
    if hasattr(b2, 'BPMNProfile_InterruptibleActivityRegion'):
        assert not _is_linked(b2, 'BPMNProfile_InterruptibleActivityRegion', a)


def test_assoc_base_LoopNode645_link_reassign_clear():
...
def test_assoc_base_MergeNode100_link_reassign_clear():
    a = BPMNProfile_ExclusiveGateway()
    b1 = BPMNProfile_MergeNode()
    b2 = BPMNProfile_MergeNode()
    _safe_set(a, 'BPMNProfile_ExclusiveGateway101', b1)
    assert _is_linked(a, 'BPMNProfile_ExclusiveGateway101', b1)
    if hasattr(b1, 'BPMNProfile_MergeNode'):
        assert _is_linked(b1, 'BPMNProfile_MergeNode', a)
    _safe_set(a, 'BPMNProfile_ExclusiveGateway101', b2)
    assert _is_linked(a, 'BPMNProfile_ExclusiveGateway101', b2)
    if hasattr(b1, 'BPMNProfile_MergeNode'):
    ...
    _safe_set(a, 'BPMNProfile_ExclusiveGateway101', None)
    assert not _is_linked(a, 'BPMNProfile_ExclusiveGateway101', b2)
    if hasattr(b2, 'BPMNProfile_MergeNode'):
        assert not _is_linked(b2, 'BPMNProfile_MergeNode', a)


def test_assoc_base_MultiplicityElement322_link_reassign_clear():
    ...
    _safe_set(a, 'BPMNProfile_ParticipantMultiplicity323', b1)
    assert _is_linked(a, 'BPMNProfile_ParticipantMultiplicity323', b1)
    if hasattr(b1, 'BPMNProfile_MultiplicityElement'):
        assert _is_linked(b1, 'BPMNProfile_MultiplicityElement', a)
    _safe_set(a, 'BPMNProfile_ParticipantMultiplicity323', b2)
    assert _is_linked(a, 'BPMNProfile_ParticipantMultiplicity323', b2)
    if hasattr(b1, 'BPMNProfile_MultiplicityElement'):
    ...
    _safe_set(a, 'BPMNProfile_ParticipantMultiplicity323', None)
    assert not _is_linked(a, 'BPMNProfile_ParticipantMultiplicity323', b2)
    if hasattr(b2, 'BPMNProfile_MultiplicityElement'):
        assert not _is_linked(b2, 'BPMNProfile_MultiplicityElement', a)


def test_assoc_base_ObjectFlow488_link_reassign_clear():
    a = BPMNProfile_DataAssociation()
...
def test_assoc_base_OpaqueAction595_link_reassign_clear():
...
def test_assoc_base_OpaqueAction624_link_reassign_clear():
    ...
    if hasattr(b1, 'BPMNProfile_OpaqueAction625'):
        assert _is_linked(b1, 'BPMNProfile_OpaqueAction625', a)
    _safe_set(a, 'BPMNProfile_BusinessRuleTask', b2)
    assert _is_linked(a, 'BPMNProfile_BusinessRuleTask', b2)
    if hasattr(b1, 'BPMNProfile_OpaqueAction625'):
        assert not _is_linked(b1, 'BPMNProfile_OpaqueAction625', a)
    if hasattr(b2, 'BPMNProfile_OpaqueAction625'):
        assert _is_linked(b2, 'BPMNProfile_OpaqueAction625', a)
    _safe_set(a, 'BPMNProfile_BusinessRuleTask', None)
    assert not _is_linked(a, 'BPMNProfile_BusinessRuleTask', b2)
    if hasattr(b2, 'BPMNProfile_OpaqueAction625'):
        assert not _is_linked(b2, 'BPMNProfile_OpaqueAction625', a)


def test_assoc_base_OpaqueAction635_link_reassign_clear():
    ...
    if hasattr(b1, 'BPMNProfile_OpaqueAction636'):
        assert _is_linked(b1, 'BPMNProfile_OpaqueAction636', a)
    _safe_set(a, 'BPMNProfile_ScriptTask', b2)
    assert _is_linked(a, 'BPMNProfile_ScriptTask', b2)
    if hasattr(b1, 'BPMNProfile_OpaqueAction636'):
        assert not _is_linked(b1, 'BPMNProfile_OpaqueAction636', a)
    if hasattr(b2, 'BPMNProfile_OpaqueAction636'):
        assert _is_linked(b2, 'BPMNProfile_OpaqueAction636', a)
    _safe_set(a, 'BPMNProfile_ScriptTask', None)
    assert not _is_linked(a, 'BPMNProfile_ScriptTask', b2)
    if hasattr(b2, 'BPMNProfile_OpaqueAction636'):
        assert not _is_linked(b2, 'BPMNProfile_OpaqueAction636', a)


def test_assoc_base_OpaqueBehavior437_link_reassign_clear():
...
def test_assoc_base_Operation243_link_reassign_clear():
    a = BPMNProfile_BPMNOperation()
    b1 = BPMNProfile_Operation()
    b2 = BPMNProfile_Operation()
    _safe_set(a, 'BPMNProfile_BPMNOperation244', b1)
    assert _is_linked(a, 'BPMNProfile_BPMNOperation244', b1)
    if hasattr(b1, 'BPMNProfile_Operation'):
        assert _is_linked(b1, 'BPMNProfile_Operation', a)
    _safe_set(a, 'BPMNProfile_BPMNOperation244', b2)
    assert _is_linked(a, 'BPMNProfile_BPMNOperation244', b2)
    if hasattr(b1, 'BPMNProfile_Operation'):
    ...
    _safe_set(a, 'BPMNProfile_BPMNOperation244', None)
    assert not _is_linked(a, 'BPMNProfile_BPMNOperation244', b2)
    if hasattr(b2, 'BPMNProfile_Operation'):
        assert not _is_linked(b2, 'BPMNProfile_Operation', a)


def test_assoc_base_OutputPin208_link_reassign_clear():
    a = BPMNProfile_DataOutput(isCollection="sample_text")
    b1 = BPMNProfile_OutputPin()
    b2 = BPMNProfile_OutputPin()
    _safe_set(a, 'BPMNProfile_DataOutput209', b1)
    assert _is_linked(a, 'BPMNProfile_DataOutput209', b1)
    if hasattr(b1, 'BPMNProfile_OutputPin'):
        assert _is_linked(b1, 'BPMNProfile_OutputPin', a)
    _safe_set(a, 'BPMNProfile_DataOutput209', b2)
    assert _is_linked(a, 'BPMNProfile_DataOutput209', b2)
    if hasattr(b1, 'BPMNProfile_OutputPin'):
    ...
    _safe_set(a, 'BPMNProfile_DataOutput209', None)
    assert not _is_linked(a, 'BPMNProfile_DataOutput209', b2)
    if hasattr(b2, 'BPMNProfile_OutputPin'):
        assert not _is_linked(b2, 'BPMNProfile_OutputPin', a)


def test_assoc_base_Package107_link_reassign_clear():
...
def test_assoc_base_PackageImport121_link_reassign_clear():
    ...
    _safe_set(a, 'BPMNProfile_Import122', b1)
    assert _is_linked(a, 'BPMNProfile_Import122', b1)
    if hasattr(b1, 'BPMNProfile_PackageImport'):
        assert _is_linked(b1, 'BPMNProfile_PackageImport', a)
    _safe_set(a, 'BPMNProfile_Import122', b2)
    assert _is_linked(a, 'BPMNProfile_Import122', b2)
    if hasattr(b1, 'BPMNProfile_PackageImport'):
    ...
    _safe_set(a, 'BPMNProfile_Import122', None)
    assert not _is_linked(a, 'BPMNProfile_Import122', b2)
    if hasattr(b2, 'BPMNProfile_PackageImport'):
        assert not _is_linked(b2, 'BPMNProfile_PackageImport', a)


def test_assoc_base_Parameter176_link_reassign_clear():
    a = BPMNProfile_DataInput(isCollection="sample_text")
    b1 = BPMNProfile_Parameter()
    b2 = BPMNProfile_Parameter()
    _safe_set(a, 'BPMNProfile_DataInput177', b1)
    assert _is_linked(a, 'BPMNProfile_DataInput177', b1)
    if hasattr(b1, 'BPMNProfile_Parameter'):
        assert _is_linked(b1, 'BPMNProfile_Parameter', a)
    _safe_set(a, 'BPMNProfile_DataInput177', b2)
    assert _is_linked(a, 'BPMNProfile_DataInput177', b2)
    if hasattr(b1, 'BPMNProfile_Parameter'):
    ...
    _safe_set(a, 'BPMNProfile_DataInput177', None)
    assert not _is_linked(a, 'BPMNProfile_DataInput177', b2)
    if hasattr(b2, 'BPMNProfile_Parameter'):
        assert not _is_linked(b2, 'BPMNProfile_Parameter', a)


def test_assoc_base_Parameter210_link_reassign_clear():
    a = BPMNProfile_DataOutput(isCollection="sample_text")
    b1 = BPMNProfile_Parameter()
    b2 = BPMNProfile_Parameter()
    _safe_set(a, 'BPMNProfile_DataOutput211', b1)
    assert _is_linked(a, 'BPMNProfile_DataOutput211', b1)
    if hasattr(b1, 'BPMNProfile_Parameter212'):
        assert _is_linked(b1, 'BPMNProfile_Parameter212', a)
    _safe_set(a, 'BPMNProfile_DataOutput211', b2)
    assert _is_linked(a, 'BPMNProfile_DataOutput211', b2)
    if hasattr(b1, 'BPMNProfile_Parameter212'):
        assert not _is_linked(b1, 'BPMNProfile_Parameter212', a)
    if hasattr(b2, 'BPMNProfile_Parameter212'):
        assert _is_linked(b2, 'BPMNProfile_Parameter212', a)
    _safe_set(a, 'BPMNProfile_DataOutput211', None)
    assert not _is_linked(a, 'BPMNProfile_DataOutput211', b2)
    if hasattr(b2, 'BPMNProfile_Parameter212'):
        assert not _is_linked(b2, 'BPMNProfile_Parameter212', a)


def test_assoc_base_ParameterSet201_link_reassign_clear():
    a = BPMNProfile_InputSet()
    b1 = BPMNProfile_ParameterSet()
    b2 = BPMNProfile_ParameterSet()
    _safe_set(a, 'BPMNProfile_InputSet202', b1)
    assert _is_linked(a, 'BPMNProfile_InputSet202', b1)
    if hasattr(b1, 'BPMNProfile_ParameterSet'):
        assert _is_linked(b1, 'BPMNProfile_ParameterSet', a)
    _safe_set(a, 'BPMNProfile_InputSet202', b2)
    assert _is_linked(a, 'BPMNProfile_InputSet202', b2)
    if hasattr(b1, 'BPMNProfile_ParameterSet'):
    ...
    _safe_set(a, 'BPMNProfile_InputSet202', None)
    assert not _is_linked(a, 'BPMNProfile_InputSet202', b2)
    if hasattr(b2, 'BPMNProfile_ParameterSet'):
        assert not _is_linked(b2, 'BPMNProfile_ParameterSet', a)


def test_assoc_base_ParameterSet223_link_reassign_clear():
    a = BPMNProfile_OutputSet()
    b1 = BPMNProfile_ParameterSet()
    b2 = BPMNProfile_ParameterSet()
    _safe_set(a, 'BPMNProfile_OutputSet224', b1)
    assert _is_linked(a, 'BPMNProfile_OutputSet224', b1)
    if hasattr(b1, 'BPMNProfile_ParameterSet225'):
        assert _is_linked(b1, 'BPMNProfile_ParameterSet225', a)
    _safe_set(a, 'BPMNProfile_OutputSet224', b2)
    assert _is_linked(a, 'BPMNProfile_OutputSet224', b2)
    if hasattr(b1, 'BPMNProfile_ParameterSet225'):
        assert not _is_linked(b1, 'BPMNProfile_ParameterSet225', a)
    if hasattr(b2, 'BPMNProfile_ParameterSet225'):
        assert _is_linked(b2, 'BPMNProfile_ParameterSet225', a)
    _safe_set(a, 'BPMNProfile_OutputSet224', None)
    assert not _is_linked(a, 'BPMNProfile_OutputSet224', b2)
    if hasattr(b2, 'BPMNProfile_ParameterSet225'):
        assert not _is_linked(b2, 'BPMNProfile_ParameterSet225', a)


def test_assoc_base_Property294_link_reassign_clear():
    a = BPMNProfile_Participant()
    b1 = BPMNProfile_Property()
    b2 = BPMNProfile_Property()
    _safe_set(a, 'BPMNProfile_Participant295', b1)
    assert _is_linked(a, 'BPMNProfile_Participant295', b1)
    if hasattr(b1, 'BPMNProfile_Property296'):
        assert _is_linked(b1, 'BPMNProfile_Property296', a)
    _safe_set(a, 'BPMNProfile_Participant295', b2)
    assert _is_linked(a, 'BPMNProfile_Participant295', b2)
    if hasattr(b1, 'BPMNProfile_Property296'):
        assert not _is_linked(b1, 'BPMNProfile_Property296', a)
    if hasattr(b2, 'BPMNProfile_Property296'):
        assert _is_linked(b2, 'BPMNProfile_Property296', a)
    _safe_set(a, 'BPMNProfile_Participant295', None)
    assert not _is_linked(a, 'BPMNProfile_Participant295', b2)
    if hasattr(b2, 'BPMNProfile_Property296'):
        assert not _is_linked(b2, 'BPMNProfile_Property296', a)
...
def test_assoc_base_Property408_link_reassign_clear():
    a = BPMNProfile_ResourceRole()
    b1 = BPMNProfile_Property()
    b2 = BPMNProfile_Property()
    _safe_set(a, 'BPMNProfile_ResourceRole', b1)
    assert _is_linked(a, 'BPMNProfile_ResourceRole', b1)
    if hasattr(b1, 'BPMNProfile_Property409'):
        assert _is_linked(b1, 'BPMNProfile_Property409', a)
    _safe_set(a, 'BPMNProfile_ResourceRole', b2)
    assert _is_linked(a, 'BPMNProfile_ResourceRole', b2)
    if hasattr(b1, 'BPMNProfile_Property409'):
        assert not _is_linked(b1, 'BPMNProfile_Property409', a)
    if hasattr(b2, 'BPMNProfile_Property409'):
        assert _is_linked(b2, 'BPMNProfile_Property409', a)
    _safe_set(a, 'BPMNProfile_ResourceRole', None)
    assert not _is_linked(a, 'BPMNProfile_ResourceRole', b2)
    if hasattr(b2, 'BPMNProfile_Property409'):
        assert not _is_linked(b2, 'BPMNProfile_Property409', a)


def test_assoc_base_Property422_link_reassign_clear():
    a = BPMNProfile_ResourceParameter(isRequired="sample_text")
    b1 = BPMNProfile_Property()
    b2 = BPMNProfile_Property()
    _safe_set(a, 'BPMNProfile_ResourceParameter423', b1)
    assert _is_linked(a, 'BPMNProfile_ResourceParameter423', b1)
    if hasattr(b1, 'BPMNProfile_Property424'):
        assert _is_linked(b1, 'BPMNProfile_Property424', a)
    _safe_set(a, 'BPMNProfile_ResourceParameter423', b2)
    assert _is_linked(a, 'BPMNProfile_ResourceParameter423', b2)
    if hasattr(b1, 'BPMNProfile_Property424'):
        assert not _is_linked(b1, 'BPMNProfile_Property424', a)
    if hasattr(b2, 'BPMNProfile_Property424'):
        assert _is_linked(b2, 'BPMNProfile_Property424', a)
    _safe_set(a, 'BPMNProfile_ResourceParameter423', None)
    assert not _is_linked(a, 'BPMNProfile_ResourceParameter423', b2)
    if hasattr(b2, 'BPMNProfile_Property424'):
        assert not _is_linked(b2, 'BPMNProfile_Property424', a)


def test_assoc_base_Slot428_link_reassign_clear():
    ...
    if hasattr(b1, 'BPMNProfile_Slot430'):
        assert _is_linked(b1, 'BPMNProfile_Slot430', a)
    _safe_set(a, 'BPMNProfile_ResourceParameterBinding429', b2)
    assert _is_linked(a, 'BPMNProfile_ResourceParameterBinding429', b2)
    if hasattr(b1, 'BPMNProfile_Slot430'):
        assert not _is_linked(b1, 'BPMNProfile_Slot430', a)
    if hasattr(b2, 'BPMNProfile_Slot430'):
        assert _is_linked(b2, 'BPMNProfile_Slot430', a)
    ...
    if hasattr(b2, 'BPMNProfile_Slot430'):
        assert not _is_linked(b2, 'BPMNProfile_Slot430', a)


def test_assoc_base_Stereotype115_link_reassign_clear():
    a = BPMNProfile_BPMNExtension(mustUnderstand="sample_text")
    b1 = BPMNProfile_Stereotype()
    b2 = BPMNProfile_Stereotype()
    _safe_set(a, 'BPMNProfile_BPMNExtension116', b1)
    assert _is_linked(a, 'BPMNProfile_BPMNExtension116', b1)
    if hasattr(b1, 'BPMNProfile_Stereotype117'):
        assert _is_linked(b1, 'BPMNProfile_Stereotype117', a)
    _safe_set(a, 'BPMNProfile_BPMNExtension116', b2)
    assert _is_linked(a, 'BPMNProfile_BPMNExtension116', b2)
    if hasattr(b1, 'BPMNProfile_Stereotype117'):
        assert not _is_linked(b1, 'BPMNProfile_Stereotype117', a)
    if hasattr(b2, 'BPMNProfile_Stereotype117'):
        assert _is_linked(b2, 'BPMNProfile_Stereotype117', a)
    _safe_set(a, 'BPMNProfile_BPMNExtension116', None)
    assert not _is_linked(a, 'BPMNProfile_BPMNExtension116', b2)
    if hasattr(b2, 'BPMNProfile_Stereotype117'):
        assert not _is_linked(b2, 'BPMNProfile_Stereotype117', a)


def test_assoc_base_StructuredActivityNode615_link_reassign_clear():
    ...
    if hasattr(b1, 'BPMNProfile_StructuredActivityNode616'):
        assert _is_linked(b1, 'BPMNProfile_StructuredActivityNode616', a)
    _safe_set(a, 'BPMNProfile_SubProcess', b2)
    assert _is_linked(a, 'BPMNProfile_SubProcess', b2)
    if hasattr(b1, 'BPMNProfile_StructuredActivityNode616'):
        assert not _is_linked(b1, 'BPMNProfile_StructuredActivityNode616', a)
    if hasattr(b2, 'BPMNProfile_StructuredActivityNode616'):
        assert _is_linked(b2, 'BPMNProfile_StructuredActivityNode616', a)
    _safe_set(a, 'BPMNProfile_SubProcess', None)
    assert not _is_linked(a, 'BPMNProfile_SubProcess', b2)
    if hasattr(b2, 'BPMNProfile_StructuredActivityNode616'):
        assert not _is_linked(b2, 'BPMNProfile_StructuredActivityNode616', a)


def test_assoc_base_StructuredActivityNode90_link_reassign_clear():
    a = BPMNProfile_EventBasedGateway(eventGatewayType="sample_text", instantiate="sample_text")
    b1 = BPMNProfile_StructuredActivityNode()
    b2 = BPMNProfile_StructuredActivityNode()
    _safe_set(a, 'BPMNProfile_EventBasedGateway91', b1)
    assert _is_linked(a, 'BPMNProfile_EventBasedGateway91', b1)
    if hasattr(b1, 'BPMNProfile_StructuredActivityNode'):
        assert _is_linked(b1, 'BPMNProfile_StructuredActivityNode', a)
    _safe_set(a, 'BPMNProfile_EventBasedGateway91', b2)
    assert _is_linked(a, 'BPMNProfile_EventBasedGateway91', b2)
    if hasattr(b1, 'BPMNProfile_StructuredActivityNode'):
    ...
    _safe_set(a, 'BPMNProfile_EventBasedGateway91', None)
    assert not _is_linked(a, 'BPMNProfile_EventBasedGateway91', b2)
    if hasattr(b2, 'BPMNProfile_StructuredActivityNode'):
        assert not _is_linked(b2, 'BPMNProfile_StructuredActivityNode', a)


def test_assoc_base_TypedElement186_link_reassign_clear():
    a = BPMNProfile_ItemAwareElement()
    b1 = BPMNProfile_TypedElement()
    b2 = BPMNProfile_TypedElement()
    _safe_set(a, 'BPMNProfile_ItemAwareElement187', b1)
    assert _is_linked(a, 'BPMNProfile_ItemAwareElement187', b1)
    if hasattr(b1, 'BPMNProfile_TypedElement'):
        assert _is_linked(b1, 'BPMNProfile_TypedElement', a)
    _safe_set(a, 'BPMNProfile_ItemAwareElement187', b2)
    assert _is_linked(a, 'BPMNProfile_ItemAwareElement187', b2)
    if hasattr(b1, 'BPMNProfile_TypedElement'):
    ...
    _safe_set(a, 'BPMNProfile_ItemAwareElement187', None)
    assert not _is_linked(a, 'BPMNProfile_ItemAwareElement187', b2)
    if hasattr(b2, 'BPMNProfile_TypedElement'):
        assert not _is_linked(b2, 'BPMNProfile_TypedElement', a)


def test_assoc_boundaryEventRefs457_link_reassign_clear():
    a = BPMNProfile_BoundaryEvent(cancelActivity="sample_text")
    b1 = BPMNProfile_BPMNActivity(completionQuantity="sample_text", isForCompensation="sample_text", startQuantity="sample_text")
    b2 = BPMNProfile_BPMNActivity(completionQuantity="sample_text_2", isForCompensation="sample_text_2", startQuantity="sample_text_2")
    _safe_set(a, 'BPMNProfile_BoundaryEvent', b1)
    assert _is_linked(a, 'BPMNProfile_BoundaryEvent', b1)
    if hasattr(b1, 'BPMNProfile_BPMNActivity458'):
        assert _is_linked(b1, 'BPMNProfile_BPMNActivity458', a)
    _safe_set(a, 'BPMNProfile_BoundaryEvent', b2)
    assert _is_linked(a, 'BPMNProfile_BoundaryEvent', b2)
    if hasattr(b1, 'BPMNProfile_BPMNActivity458'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNActivity458', a)
    if hasattr(b2, 'BPMNProfile_BPMNActivity458'):
        assert _is_linked(b2, 'BPMNProfile_BPMNActivity458', a)
    _safe_set(a, 'BPMNProfile_BoundaryEvent', None)
    assert not _is_linked(a, 'BPMNProfile_BoundaryEvent', b2)
    if hasattr(b2, 'BPMNProfile_BPMNActivity458'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNActivity458', a)


def test_assoc_callableElements240_link_reassign_clear():
    a = BPMNProfile_CallableElement()
    b1 = BPMNProfile_BPMNInterface()
    b2 = BPMNProfile_BPMNInterface()
    _safe_set(a, 'BPMNProfile_CallableElement242', b1)
    assert _is_linked(a, 'BPMNProfile_CallableElement242', b1)
    if hasattr(b1, 'BPMNProfile_BPMNInterface241'):
        assert _is_linked(b1, 'BPMNProfile_BPMNInterface241', a)
    _safe_set(a, 'BPMNProfile_CallableElement242', b2)
    assert _is_linked(a, 'BPMNProfile_CallableElement242', b2)
    if hasattr(b1, 'BPMNProfile_BPMNInterface241'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNInterface241', a)
    if hasattr(b2, 'BPMNProfile_BPMNInterface241'):
        assert _is_linked(b2, 'BPMNProfile_BPMNInterface241', a)
    _safe_set(a, 'BPMNProfile_CallableElement242', None)
    assert not _is_linked(a, 'BPMNProfile_CallableElement242', b2)
    if hasattr(b2, 'BPMNProfile_BPMNInterface241'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNInterface241', a)


def test_assoc_calledCollaborationRef609_link_reassign_clear():
    a = BPMNProfile_CallConversation()
    b1 = BPMNProfile_BPMNCollaboration(isClosed="sample_text")
    b2 = BPMNProfile_BPMNCollaboration(isClosed="sample_text_2")
    _safe_set(a, 'BPMNProfile_CallConversation610', b1)
    assert _is_linked(a, 'BPMNProfile_CallConversation610', b1)
    if hasattr(b1, 'BPMNProfile_BPMNCollaboration611'):
        assert _is_linked(b1, 'BPMNProfile_BPMNCollaboration611', a)
    _safe_set(a, 'BPMNProfile_CallConversation610', b2)
    assert _is_linked(a, 'BPMNProfile_CallConversation610', b2)
    if hasattr(b1, 'BPMNProfile_BPMNCollaboration611'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNCollaboration611', a)
    if hasattr(b2, 'BPMNProfile_BPMNCollaboration611'):
        assert _is_linked(b2, 'BPMNProfile_BPMNCollaboration611', a)
    _safe_set(a, 'BPMNProfile_CallConversation610', None)
    assert not _is_linked(a, 'BPMNProfile_CallConversation610', b2)
    if hasattr(b2, 'BPMNProfile_BPMNCollaboration611'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNCollaboration611', a)


def test_assoc_calledElementRef621_link_reassign_clear():
    a = BPMNProfile_CallableElement()
    b1 = BPMNProfile_CallActivity()
    b2 = BPMNProfile_CallActivity()
    _safe_set(a, 'BPMNProfile_CallableElement623', b1)
    assert _is_linked(a, 'BPMNProfile_CallableElement623', b1)
    if hasattr(b1, 'BPMNProfile_CallActivity622'):
        assert _is_linked(b1, 'BPMNProfile_CallActivity622', a)
    _safe_set(a, 'BPMNProfile_CallableElement623', b2)
    assert _is_linked(a, 'BPMNProfile_CallableElement623', b2)
    if hasattr(b1, 'BPMNProfile_CallActivity622'):
        assert not _is_linked(b1, 'BPMNProfile_CallActivity622', a)
    if hasattr(b2, 'BPMNProfile_CallActivity622'):
        assert _is_linked(b2, 'BPMNProfile_CallActivity622', a)
    _safe_set(a, 'BPMNProfile_CallableElement623', None)
    assert not _is_linked(a, 'BPMNProfile_CallableElement623', b2)
    if hasattr(b2, 'BPMNProfile_CallActivity622'):
        assert not _is_linked(b2, 'BPMNProfile_CallActivity622', a)
...
def test_assoc_collaboration316_link_reassign_clear():
    a = BPMNProfile_BPMNCollaboration(isClosed="sample_text")
...
def test_assoc_completionCondition633_link_reassign_clear():
    ...
    if hasattr(b1, 'BPMNProfile_BPMNExpression634'):
        assert _is_linked(b1, 'BPMNProfile_BPMNExpression634', a)
    _safe_set(a, 'BPMNProfile_AdHocSubProcess', b2)
    assert _is_linked(a, 'BPMNProfile_AdHocSubProcess', b2)
    if hasattr(b1, 'BPMNProfile_BPMNExpression634'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNExpression634', a)
    if hasattr(b2, 'BPMNProfile_BPMNExpression634'):
        assert _is_linked(b2, 'BPMNProfile_BPMNExpression634', a)
    _safe_set(a, 'BPMNProfile_AdHocSubProcess', None)
    assert not _is_linked(a, 'BPMNProfile_AdHocSubProcess', b2)
    if hasattr(b2, 'BPMNProfile_BPMNExpression634'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNExpression634', a)


def test_assoc_completionCondition664_link_reassign_clear():
    a = BPMNProfile_MultiInstanceLoopCharacteristics(behavior="sample_text", isSequential="sample_text")
    b1 = BPMNProfile_BPMNExpression()
    b2 = BPMNProfile_BPMNExpression()
    _safe_set(a, 'BPMNProfile_MultiInstanceLoopCharacteristics665', b1)
    assert _is_linked(a, 'BPMNProfile_MultiInstanceLoopCharacteristics665', b1)
    if hasattr(b1, 'BPMNProfile_BPMNExpression666'):
        assert _is_linked(b1, 'BPMNProfile_BPMNExpression666', a)
    _safe_set(a, 'BPMNProfile_MultiInstanceLoopCharacteristics665', b2)
    assert _is_linked(a, 'BPMNProfile_MultiInstanceLoopCharacteristics665', b2)
    if hasattr(b1, 'BPMNProfile_BPMNExpression666'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNExpression666', a)
    if hasattr(b2, 'BPMNProfile_BPMNExpression666'):
        assert _is_linked(b2, 'BPMNProfile_BPMNExpression666', a)
    _safe_set(a, 'BPMNProfile_MultiInstanceLoopCharacteristics665', None)
    assert not _is_linked(a, 'BPMNProfile_MultiInstanceLoopCharacteristics665', b2)
    if hasattr(b2, 'BPMNProfile_BPMNExpression666'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNExpression666', a)
...
def test_assoc_complexBehaviorDefinition687_link_reassign_clear():
    ...
    _safe_set(a, 'BPMNProfile_MultiInstanceLoopCharacteristics688', {b1})
    assert _is_linked(a, 'BPMNProfile_MultiInstanceLoopCharacteristics688', b1)
    if hasattr(b1, 'BPMNProfile_ComplexBehaviorDefinition689'):
        assert _is_linked(b1, 'BPMNProfile_ComplexBehaviorDefinition689', a)
    _safe_set(a, 'BPMNProfile_MultiInstanceLoopCharacteristics688', {b2})
    assert _is_linked(a, 'BPMNProfile_MultiInstanceLoopCharacteristics688', b2)
    if hasattr(b1, 'BPMNProfile_ComplexBehaviorDefinition689'):
        assert not _is_linked(b1, 'BPMNProfile_ComplexBehaviorDefinition689', a)
    if hasattr(b2, 'BPMNProfile_ComplexBehaviorDefinition689'):
        assert _is_linked(b2, 'BPMNProfile_ComplexBehaviorDefinition689', a)
    _safe_set(a, 'BPMNProfile_MultiInstanceLoopCharacteristics688', set())
    assert not _is_linked(a, 'BPMNProfile_MultiInstanceLoopCharacteristics688', b2)
    if hasattr(b2, 'BPMNProfile_ComplexBehaviorDefinition689'):
        assert not _is_linked(b2, 'BPMNProfile_ComplexBehaviorDefinition689', a)


def test_assoc_condition547_link_reassign_clear():
    a = BPMNProfile_ConditionalEventDefinition()
    b1 = BPMNProfile_BPMNExpression()
    b2 = BPMNProfile_BPMNExpression()
    _safe_set(a, 'BPMNProfile_ConditionalEventDefinition548', b1)
    assert _is_linked(a, 'BPMNProfile_ConditionalEventDefinition548', b1)
    if hasattr(b1, 'BPMNProfile_BPMNExpression549'):
        assert _is_linked(b1, 'BPMNProfile_BPMNExpression549', a)
    _safe_set(a, 'BPMNProfile_ConditionalEventDefinition548', b2)
    assert _is_linked(a, 'BPMNProfile_ConditionalEventDefinition548', b2)
    if hasattr(b1, 'BPMNProfile_BPMNExpression549'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNExpression549', a)
    if hasattr(b2, 'BPMNProfile_BPMNExpression549'):
        assert _is_linked(b2, 'BPMNProfile_BPMNExpression549', a)
    _safe_set(a, 'BPMNProfile_ConditionalEventDefinition548', None)
    assert not _is_linked(a, 'BPMNProfile_ConditionalEventDefinition548', b2)
    if hasattr(b2, 'BPMNProfile_BPMNExpression549'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNExpression549', a)


def test_assoc_condition626_link_reassign_clear():
    a = BPMNProfile_FormalExpression()
    b1 = BPMNProfile_ComplexBehaviorDefinition()
    b2 = BPMNProfile_ComplexBehaviorDefinition()
    _safe_set(a, 'BPMNProfile_FormalExpression627', b1)
    assert _is_linked(a, 'BPMNProfile_FormalExpression627', b1)
    if hasattr(b1, 'BPMNProfile_ComplexBehaviorDefinition'):
        assert _is_linked(b1, 'BPMNProfile_ComplexBehaviorDefinition', a)
    _safe_set(a, 'BPMNProfile_FormalExpression627', b2)
    assert _is_linked(a, 'BPMNProfile_FormalExpression627', b2)
    if hasattr(b1, 'BPMNProfile_ComplexBehaviorDefinition'):
    ...
    _safe_set(a, 'BPMNProfile_FormalExpression627', None)
    assert not _is_linked(a, 'BPMNProfile_FormalExpression627', b2)
    if hasattr(b2, 'BPMNProfile_ComplexBehaviorDefinition'):
...
def test_assoc_conversationLinks272_link_reassign_clear():
    a = BPMNProfile_BPMNCollaboration(isClosed="sample_text")
    b1 = BPMNProfile_ConversationLink()
    b2 = BPMNProfile_ConversationLink()
...
def test_assoc_conversationNodes606_link_reassign_clear():
    ...
    if hasattr(b1, 'BPMNProfile_ConversationNode607'):
        assert _is_linked(b1, 'BPMNProfile_ConversationNode607', a)
    _safe_set(a, 'BPMNProfile_SubConversation', {b2})
    assert _is_linked(a, 'BPMNProfile_SubConversation', b2)
    if hasattr(b1, 'BPMNProfile_ConversationNode607'):
        assert not _is_linked(b1, 'BPMNProfile_ConversationNode607', a)
    if hasattr(b2, 'BPMNProfile_ConversationNode607'):
        assert _is_linked(b2, 'BPMNProfile_ConversationNode607', a)
    _safe_set(a, 'BPMNProfile_SubConversation', set())
    assert not _is_linked(a, 'BPMNProfile_SubConversation', b2)
    if hasattr(b2, 'BPMNProfile_ConversationNode607'):
        assert not _is_linked(b2, 'BPMNProfile_ConversationNode607', a)


def test_assoc_conversations279_link_reassign_clear():
    a = BPMNProfile_ConversationNode()
    b1 = BPMNProfile_BPMNCollaboration(isClosed="sample_text")
    b2 = BPMNProfile_BPMNCollaboration(isClosed="sample_text_2")
    _safe_set(a, 'BPMNProfile_ConversationNode', b1)
    assert _is_linked(a, 'BPMNProfile_ConversationNode', b1)
    if hasattr(b1, 'BPMNProfile_BPMNCollaboration280'):
        assert _is_linked(b1, 'BPMNProfile_BPMNCollaboration280', a)
    _safe_set(a, 'BPMNProfile_ConversationNode', b2)
    assert _is_linked(a, 'BPMNProfile_ConversationNode', b2)
    if hasattr(b1, 'BPMNProfile_BPMNCollaboration280'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNCollaboration280', a)
    if hasattr(b2, 'BPMNProfile_BPMNCollaboration280'):
        assert _is_linked(b2, 'BPMNProfile_BPMNCollaboration280', a)
    _safe_set(a, 'BPMNProfile_ConversationNode', None)
    assert not _is_linked(a, 'BPMNProfile_ConversationNode', b2)
    if hasattr(b2, 'BPMNProfile_BPMNCollaboration280'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNCollaboration280', a)


def test_assoc_correlationKeys281_link_reassign_clear():
    a = BPMNProfile_BPMNCollaboration(isClosed="sample_text")
    b1 = BPMNProfile_CorrelationKey()
    b2 = BPMNProfile_CorrelationKey()
    _safe_set(a, 'BPMNProfile_BPMNCollaboration282', {b1})
    assert _is_linked(a, 'BPMNProfile_BPMNCollaboration282', b1)
    if hasattr(b1, 'BPMNProfile_CorrelationKey'):
        assert _is_linked(b1, 'BPMNProfile_CorrelationKey', a)
    _safe_set(a, 'BPMNProfile_BPMNCollaboration282', {b2})
    assert _is_linked(a, 'BPMNProfile_BPMNCollaboration282', b2)
    if hasattr(b1, 'BPMNProfile_CorrelationKey'):
    ...
    _safe_set(a, 'BPMNProfile_BPMNCollaboration282', set())
    assert not _is_linked(a, 'BPMNProfile_BPMNCollaboration282', b2)
    if hasattr(b2, 'BPMNProfile_CorrelationKey'):
        assert not _is_linked(b2, 'BPMNProfile_CorrelationKey', a)


def test_assoc_correlationKeys356_link_reassign_clear():
    a = BPMNProfile_ConversationNode()
    b1 = BPMNProfile_CorrelationKey()
    b2 = BPMNProfile_CorrelationKey()
    _safe_set(a, 'BPMNProfile_ConversationNode357', {b1})
    assert _is_linked(a, 'BPMNProfile_ConversationNode357', b1)
    if hasattr(b1, 'BPMNProfile_CorrelationKey358'):
        assert _is_linked(b1, 'BPMNProfile_CorrelationKey358', a)
    _safe_set(a, 'BPMNProfile_ConversationNode357', {b2})
    assert _is_linked(a, 'BPMNProfile_ConversationNode357', b2)
    if hasattr(b1, 'BPMNProfile_CorrelationKey358'):
        assert not _is_linked(b1, 'BPMNProfile_CorrelationKey358', a)
    if hasattr(b2, 'BPMNProfile_CorrelationKey358'):
        assert _is_linked(b2, 'BPMNProfile_CorrelationKey358', a)
    _safe_set(a, 'BPMNProfile_ConversationNode357', set())
    assert not _is_linked(a, 'BPMNProfile_ConversationNode357', b2)
    if hasattr(b2, 'BPMNProfile_CorrelationKey358'):
        assert not _is_linked(b2, 'BPMNProfile_CorrelationKey358', a)


def test_assoc_correlationSubscriptions143_link_reassign_clear():
    a = BPMNProfile_BPMNProcess(isClosed="sample_text", isExecutable="sample_text", processType="sample_text")
    b1 = BPMNProfile_CorrelationSubscription()
    b2 = BPMNProfile_CorrelationSubscription()
    _safe_set(a, 'BPMNProfile_BPMNProcess144', {b1})
    assert _is_linked(a, 'BPMNProfile_BPMNProcess144', b1)
    if hasattr(b1, 'BPMNProfile_CorrelationSubscription'):
        assert _is_linked(b1, 'BPMNProfile_CorrelationSubscription', a)
    _safe_set(a, 'BPMNProfile_BPMNProcess144', {b2})
    assert _is_linked(a, 'BPMNProfile_BPMNProcess144', b2)
    if hasattr(b1, 'BPMNProfile_CorrelationSubscription'):
    ...
    _safe_set(a, 'BPMNProfile_BPMNProcess144', set())
    assert not _is_linked(a, 'BPMNProfile_BPMNProcess144', b2)
    if hasattr(b2, 'BPMNProfile_CorrelationSubscription'):
        assert not _is_linked(b2, 'BPMNProfile_CorrelationSubscription', a)


def test_assoc_dataInputAssociation534_link_reassign_clear():
    a = BPMNProfile_ThrowEvent()
    b1 = BPMNProfile_DataInputAssociation()
    b2 = BPMNProfile_DataInputAssociation()
    _safe_set(a, 'BPMNProfile_ThrowEvent535', {b1})
    assert _is_linked(a, 'BPMNProfile_ThrowEvent535', b1)
    if hasattr(b1, 'BPMNProfile_DataInputAssociation536'):
        assert _is_linked(b1, 'BPMNProfile_DataInputAssociation536', a)
    _safe_set(a, 'BPMNProfile_ThrowEvent535', {b2})
    assert _is_linked(a, 'BPMNProfile_ThrowEvent535', b2)
    if hasattr(b1, 'BPMNProfile_DataInputAssociation536'):
        assert not _is_linked(b1, 'BPMNProfile_DataInputAssociation536', a)
    if hasattr(b2, 'BPMNProfile_DataInputAssociation536'):
        assert _is_linked(b2, 'BPMNProfile_DataInputAssociation536', a)
    _safe_set(a, 'BPMNProfile_ThrowEvent535', set())
    assert not _is_linked(a, 'BPMNProfile_ThrowEvent535', b2)
    if hasattr(b2, 'BPMNProfile_DataInputAssociation536'):
        assert not _is_linked(b2, 'BPMNProfile_DataInputAssociation536', a)


def test_assoc_dataInputAssociations459_link_reassign_clear():
...
def test_assoc_dataInputRefs206_link_reassign_clear():
    a = BPMNProfile_InputSet()
    ...
    if hasattr(b1, 'DataInput207'):
        assert _is_linked(b1, 'DataInput207', a)
    _safe_set(a, 'inputSetRefs', {b2})
    assert _is_linked(a, 'inputSetRefs', b2)
    if hasattr(b1, 'DataInput207'):
        assert not _is_linked(b1, 'DataInput207', a)
    if hasattr(b2, 'DataInput207'):
        assert _is_linked(b2, 'DataInput207', a)
    _safe_set(a, 'inputSetRefs', set())
    assert not _is_linked(a, 'inputSetRefs', b2)
    if hasattr(b2, 'DataInput207'):
        assert not _is_linked(b2, 'DataInput207', a)


def test_assoc_dataInputs166_link_reassign_clear():
    a = BPMNProfile_DataInput(isCollection="sample_text")
...
def test_assoc_dataObjectRef578_link_reassign_clear():
    a = BPMNProfile_DataObjectReference()
...
def test_assoc_dataOutputAssociation474_link_reassign_clear():
    ...
    _safe_set(a, 'BPMNProfile_DataOutputAssociation476', b1)
    assert _is_linked(a, 'BPMNProfile_DataOutputAssociation476', b1)
    if hasattr(b1, 'BPMNProfile_CatchEvent475'):
        assert _is_linked(b1, 'BPMNProfile_CatchEvent475', a)
    _safe_set(a, 'BPMNProfile_DataOutputAssociation476', b2)
    assert _is_linked(a, 'BPMNProfile_DataOutputAssociation476', b2)
    if hasattr(b1, 'BPMNProfile_CatchEvent475'):
        assert not _is_linked(b1, 'BPMNProfile_CatchEvent475', a)
    if hasattr(b2, 'BPMNProfile_CatchEvent475'):
        assert _is_linked(b2, 'BPMNProfile_CatchEvent475', a)
    _safe_set(a, 'BPMNProfile_DataOutputAssociation476', None)
    assert not _is_linked(a, 'BPMNProfile_DataOutputAssociation476', b2)
    if hasattr(b2, 'BPMNProfile_CatchEvent475'):
        assert not _is_linked(b2, 'BPMNProfile_CatchEvent475', a)


def test_assoc_dataOutputAssociations461_link_reassign_clear():
    a = BPMNProfile_DataOutputAssociation()
    b1 = BPMNProfile_BPMNActivity(completionQuantity="sample_text", isForCompensation="sample_text", startQuantity="sample_text")
    b2 = BPMNProfile_BPMNActivity(completionQuantity="sample_text_2", isForCompensation="sample_text_2", startQuantity="sample_text_2")
    _safe_set(a, 'BPMNProfile_DataOutputAssociation', b1)
    assert _is_linked(a, 'BPMNProfile_DataOutputAssociation', b1)
    if hasattr(b1, 'BPMNProfile_BPMNActivity462'):
        assert _is_linked(b1, 'BPMNProfile_BPMNActivity462', a)
    _safe_set(a, 'BPMNProfile_DataOutputAssociation', b2)
    assert _is_linked(a, 'BPMNProfile_DataOutputAssociation', b2)
    if hasattr(b1, 'BPMNProfile_BPMNActivity462'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNActivity462', a)
    if hasattr(b2, 'BPMNProfile_BPMNActivity462'):
        assert _is_linked(b2, 'BPMNProfile_BPMNActivity462', a)
    _safe_set(a, 'BPMNProfile_DataOutputAssociation', None)
    assert not _is_linked(a, 'BPMNProfile_DataOutputAssociation', b2)
    if hasattr(b2, 'BPMNProfile_BPMNActivity462'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNActivity462', a)


def test_assoc_dataOutputRefs232_link_reassign_clear():
    a = BPMNProfile_OutputSet()
...
def test_assoc_dataOutputs168_link_reassign_clear():
    a = BPMNProfile_DataOutput(isCollection="sample_text")
    b1 = BPMNProfile_InputOutputSpecification()
    b2 = BPMNProfile_InputOutputSpecification()
    _safe_set(a, 'BPMNProfile_DataOutput', b1)
    assert _is_linked(a, 'BPMNProfile_DataOutput', b1)
    if hasattr(b1, 'BPMNProfile_InputOutputSpecification169'):
        assert _is_linked(b1, 'BPMNProfile_InputOutputSpecification169', a)
    _safe_set(a, 'BPMNProfile_DataOutput', b2)
    assert _is_linked(a, 'BPMNProfile_DataOutput', b2)
    if hasattr(b1, 'BPMNProfile_InputOutputSpecification169'):
        assert not _is_linked(b1, 'BPMNProfile_InputOutputSpecification169', a)
    if hasattr(b2, 'BPMNProfile_InputOutputSpecification169'):
        assert _is_linked(b2, 'BPMNProfile_InputOutputSpecification169', a)
    _safe_set(a, 'BPMNProfile_DataOutput', None)
    assert not _is_linked(a, 'BPMNProfile_DataOutput', b2)
    if hasattr(b2, 'BPMNProfile_InputOutputSpecification169'):
        assert not _is_linked(b2, 'BPMNProfile_InputOutputSpecification169', a)


def test_assoc_dataPath397_link_reassign_clear():
    a = BPMNProfile_FormalExpression()
    b1 = BPMNProfile_CorrelationPropertyBinding()
    b2 = BPMNProfile_CorrelationPropertyBinding()
    _safe_set(a, 'BPMNProfile_FormalExpression399', b1)
    assert _is_linked(a, 'BPMNProfile_FormalExpression399', b1)
    if hasattr(b1, 'BPMNProfile_CorrelationPropertyBinding398'):
        assert _is_linked(b1, 'BPMNProfile_CorrelationPropertyBinding398', a)
    _safe_set(a, 'BPMNProfile_FormalExpression399', b2)
    assert _is_linked(a, 'BPMNProfile_FormalExpression399', b2)
    if hasattr(b1, 'BPMNProfile_CorrelationPropertyBinding398'):
        assert not _is_linked(b1, 'BPMNProfile_CorrelationPropertyBinding398', a)
    if hasattr(b2, 'BPMNProfile_CorrelationPropertyBinding398'):
        assert _is_linked(b2, 'BPMNProfile_CorrelationPropertyBinding398', a)
    _safe_set(a, 'BPMNProfile_FormalExpression399', None)
    assert not _is_linked(a, 'BPMNProfile_FormalExpression399', b2)
    if hasattr(b2, 'BPMNProfile_CorrelationPropertyBinding398'):
        assert not _is_linked(b2, 'BPMNProfile_CorrelationPropertyBinding398', a)


def test_assoc_dataState185_link_reassign_clear():
    a = BPMNProfile_ItemAwareElement()
...
def test_assoc_default102_link_reassign_clear():
    a = BPMNProfile_SequenceFlow(isImmediate="sample_text")
    b1 = BPMNProfile_ExclusiveGateway()
    b2 = BPMNProfile_ExclusiveGateway()
    _safe_set(a, 'BPMNProfile_SequenceFlow104', b1)
    assert _is_linked(a, 'BPMNProfile_SequenceFlow104', b1)
    if hasattr(b1, 'BPMNProfile_ExclusiveGateway103'):
        assert _is_linked(b1, 'BPMNProfile_ExclusiveGateway103', a)
    _safe_set(a, 'BPMNProfile_SequenceFlow104', b2)
    assert _is_linked(a, 'BPMNProfile_SequenceFlow104', b2)
    if hasattr(b1, 'BPMNProfile_ExclusiveGateway103'):
        assert not _is_linked(b1, 'BPMNProfile_ExclusiveGateway103', a)
    if hasattr(b2, 'BPMNProfile_ExclusiveGateway103'):
        assert _is_linked(b2, 'BPMNProfile_ExclusiveGateway103', a)
    _safe_set(a, 'BPMNProfile_SequenceFlow104', None)
    assert not _is_linked(a, 'BPMNProfile_SequenceFlow104', b2)
    if hasattr(b2, 'BPMNProfile_ExclusiveGateway103'):
        assert not _is_linked(b2, 'BPMNProfile_ExclusiveGateway103', a)


def test_assoc_default454_link_reassign_clear():
    a = BPMNProfile_SequenceFlow(isImmediate="sample_text")
    b1 = BPMNProfile_BPMNActivity(completionQuantity="sample_text", isForCompensation="sample_text", startQuantity="sample_text")
    b2 = BPMNProfile_BPMNActivity(completionQuantity="sample_text_2", isForCompensation="sample_text_2", startQuantity="sample_text_2")
    _safe_set(a, 'BPMNProfile_SequenceFlow456', b1)
    assert _is_linked(a, 'BPMNProfile_SequenceFlow456', b1)
    if hasattr(b1, 'BPMNProfile_BPMNActivity455'):
        assert _is_linked(b1, 'BPMNProfile_BPMNActivity455', a)
    _safe_set(a, 'BPMNProfile_SequenceFlow456', b2)
    assert _is_linked(a, 'BPMNProfile_SequenceFlow456', b2)
    if hasattr(b1, 'BPMNProfile_BPMNActivity455'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNActivity455', a)
    if hasattr(b2, 'BPMNProfile_BPMNActivity455'):
        assert _is_linked(b2, 'BPMNProfile_BPMNActivity455', a)
    _safe_set(a, 'BPMNProfile_SequenceFlow456', None)
    assert not _is_linked(a, 'BPMNProfile_SequenceFlow456', b2)
    if hasattr(b2, 'BPMNProfile_BPMNActivity455'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNActivity455', a)


def test_assoc_default94_link_reassign_clear():
    a = BPMNProfile_SequenceFlow(isImmediate="sample_text")
    b1 = BPMNProfile_ComplexGateway()
    b2 = BPMNProfile_ComplexGateway()
    _safe_set(a, 'BPMNProfile_SequenceFlow95', b1)
    assert _is_linked(a, 'BPMNProfile_SequenceFlow95', b1)
    if hasattr(b1, 'BPMNProfile_ComplexGateway'):
        assert _is_linked(b1, 'BPMNProfile_ComplexGateway', a)
    _safe_set(a, 'BPMNProfile_SequenceFlow95', b2)
    assert _is_linked(a, 'BPMNProfile_SequenceFlow95', b2)
    if hasattr(b1, 'BPMNProfile_ComplexGateway'):
    ...
    _safe_set(a, 'BPMNProfile_SequenceFlow95', None)
    assert not _is_linked(a, 'BPMNProfile_SequenceFlow95', b2)
    if hasattr(b2, 'BPMNProfile_ComplexGateway'):
        assert not _is_linked(b2, 'BPMNProfile_ComplexGateway', a)


def test_assoc_definition106_link_reassign_clear():
    a = BPMNProfile_Definitions(exporter="sample_text", exporterVersion="sample_text", expressionLanguage="sample_text", targetNamespace="sample_text", typeLanguage="sample_text")
...
def test_assoc_definition118_link_reassign_clear():
    a = BPMNProfile_BPMNExtension(mustUnderstand="sample_text")
    b1 = BPMNProfile_ExtensionDefinition()
    b2 = BPMNProfile_ExtensionDefinition()
    _safe_set(a, 'BPMNProfile_BPMNExtension119', b1)
    assert _is_linked(a, 'BPMNProfile_BPMNExtension119', b1)
    if hasattr(b1, 'BPMNProfile_ExtensionDefinition120'):
        assert _is_linked(b1, 'BPMNProfile_ExtensionDefinition120', a)
    _safe_set(a, 'BPMNProfile_BPMNExtension119', b2)
    assert _is_linked(a, 'BPMNProfile_BPMNExtension119', b2)
    if hasattr(b1, 'BPMNProfile_ExtensionDefinition120'):
        assert not _is_linked(b1, 'BPMNProfile_ExtensionDefinition120', a)
    if hasattr(b2, 'BPMNProfile_ExtensionDefinition120'):
        assert _is_linked(b2, 'BPMNProfile_ExtensionDefinition120', a)
    _safe_set(a, 'BPMNProfile_BPMNExtension119', None)
    assert not _is_linked(a, 'BPMNProfile_BPMNExtension119', b2)
    if hasattr(b2, 'BPMNProfile_ExtensionDefinition120'):
        assert not _is_linked(b2, 'BPMNProfile_ExtensionDefinition120', a)


def test_assoc_definition134_link_reassign_clear():
    a = BPMNProfile_Definitions(exporter="sample_text", exporterVersion="sample_text", expressionLanguage="sample_text", targetNamespace="sample_text", typeLanguage="sample_text")
    ...
    _safe_set(a, 'BPMNProfile_Definitions136', b1)
    assert _is_linked(a, 'BPMNProfile_Definitions136', b1)
    if hasattr(b1, 'BPMNProfile_BPMNRelationship135'):
        assert _is_linked(b1, 'BPMNProfile_BPMNRelationship135', a)
    _safe_set(a, 'BPMNProfile_Definitions136', b2)
    assert _is_linked(a, 'BPMNProfile_Definitions136', b2)
    if hasattr(b1, 'BPMNProfile_BPMNRelationship135'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNRelationship135', a)
    if hasattr(b2, 'BPMNProfile_BPMNRelationship135'):
        assert _is_linked(b2, 'BPMNProfile_BPMNRelationship135', a)
    _safe_set(a, 'BPMNProfile_Definitions136', None)
    assert not _is_linked(a, 'BPMNProfile_Definitions136', b2)
    if hasattr(b2, 'BPMNProfile_BPMNRelationship135'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNRelationship135', a)


def test_assoc_definitionalCollaborationRef139_link_reassign_clear():
    a = BPMNProfile_BPMNProcess(isClosed="sample_text", isExecutable="sample_text", processType="sample_text")
    b1 = BPMNProfile_BPMNCollaboration(isClosed="sample_text")
    b2 = BPMNProfile_BPMNCollaboration(isClosed="sample_text_2")
...
def test_assoc_definitions123_link_reassign_clear():
    a = BPMNProfile_Import(importType="sample_text", location="sample_text", namespace="sample_text")
    ...
    _safe_set(a, 'BPMNProfile_Import124', b1)
    assert _is_linked(a, 'BPMNProfile_Import124', b1)
    if hasattr(b1, 'BPMNProfile_Definitions125'):
        assert _is_linked(b1, 'BPMNProfile_Definitions125', a)
    _safe_set(a, 'BPMNProfile_Import124', b2)
    assert _is_linked(a, 'BPMNProfile_Import124', b2)
    if hasattr(b1, 'BPMNProfile_Definitions125'):
        assert not _is_linked(b1, 'BPMNProfile_Definitions125', a)
    if hasattr(b2, 'BPMNProfile_Definitions125'):
        assert _is_linked(b2, 'BPMNProfile_Definitions125', a)
    _safe_set(a, 'BPMNProfile_Import124', None)
    assert not _is_linked(a, 'BPMNProfile_Import124', b2)
    if hasattr(b2, 'BPMNProfile_Definitions125'):
        assert not _is_linked(b2, 'BPMNProfile_Definitions125', a)
...
def test_assoc_errorRef253_link_reassign_clear():
    ...
    if hasattr(b1, 'BPMNProfile_BPMNOperation254'):
        assert _is_linked(b1, 'BPMNProfile_BPMNOperation254', a)
    _safe_set(a, 'BPMNProfile_Error', b2)
    assert _is_linked(a, 'BPMNProfile_Error', b2)
    if hasattr(b1, 'BPMNProfile_BPMNOperation254'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNOperation254', a)
    if hasattr(b2, 'BPMNProfile_BPMNOperation254'):
        assert _is_linked(b2, 'BPMNProfile_BPMNOperation254', a)
    _safe_set(a, 'BPMNProfile_Error', None)
    assert not _is_linked(a, 'BPMNProfile_Error', b2)
    if hasattr(b2, 'BPMNProfile_BPMNOperation254'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNOperation254', a)


def test_assoc_errorRef557_link_reassign_clear():
    a = BPMNProfile_Error(errorCode="sample_text")
    b1 = BPMNProfile_ErrorEventDefinition()
    b2 = BPMNProfile_ErrorEventDefinition()
    _safe_set(a, 'BPMNProfile_Error558', b1)
    assert _is_linked(a, 'BPMNProfile_Error558', b1)
    if hasattr(b1, 'BPMNProfile_ErrorEventDefinition'):
        assert _is_linked(b1, 'BPMNProfile_ErrorEventDefinition', a)
    _safe_set(a, 'BPMNProfile_Error558', b2)
    assert _is_linked(a, 'BPMNProfile_Error558', b2)
    if hasattr(b1, 'BPMNProfile_ErrorEventDefinition'):
    ...
    _safe_set(a, 'BPMNProfile_Error558', None)
    assert not _is_linked(a, 'BPMNProfile_Error558', b2)
    if hasattr(b2, 'BPMNProfile_ErrorEventDefinition'):
        assert not _is_linked(b2, 'BPMNProfile_ErrorEventDefinition', a)


def test_assoc_escalationRef512_link_reassign_clear():
...
def test_assoc_evaluatesToTypeRef383_link_reassign_clear():
    a = BPMNProfile_ItemDefinition(isCollection="sample_text", itemKind="sample_text")
    b1 = BPMNProfile_FormalExpression()
    b2 = BPMNProfile_FormalExpression()
    _safe_set(a, 'BPMNProfile_ItemDefinition385', b1)
    assert _is_linked(a, 'BPMNProfile_ItemDefinition385', b1)
    if hasattr(b1, 'BPMNProfile_FormalExpression384'):
        assert _is_linked(b1, 'BPMNProfile_FormalExpression384', a)
    _safe_set(a, 'BPMNProfile_ItemDefinition385', b2)
    assert _is_linked(a, 'BPMNProfile_ItemDefinition385', b2)
    if hasattr(b1, 'BPMNProfile_FormalExpression384'):
        assert not _is_linked(b1, 'BPMNProfile_FormalExpression384', a)
    if hasattr(b2, 'BPMNProfile_FormalExpression384'):
        assert _is_linked(b2, 'BPMNProfile_FormalExpression384', a)
    _safe_set(a, 'BPMNProfile_ItemDefinition385', None)
    assert not _is_linked(a, 'BPMNProfile_ItemDefinition385', b2)
    if hasattr(b2, 'BPMNProfile_FormalExpression384'):
        assert not _is_linked(b2, 'BPMNProfile_FormalExpression384', a)


def test_assoc_expression417_link_reassign_clear():
    a = BPMNProfile_ResourceAssignmentExpression()
    b1 = BPMNProfile_BPMNExpression()
    b2 = BPMNProfile_BPMNExpression()
    _safe_set(a, 'BPMNProfile_ResourceAssignmentExpression418', b1)
    assert _is_linked(a, 'BPMNProfile_ResourceAssignmentExpression418', b1)
    if hasattr(b1, 'BPMNProfile_BPMNExpression419'):
        assert _is_linked(b1, 'BPMNProfile_BPMNExpression419', a)
    _safe_set(a, 'BPMNProfile_ResourceAssignmentExpression418', b2)
    assert _is_linked(a, 'BPMNProfile_ResourceAssignmentExpression418', b2)
    if hasattr(b1, 'BPMNProfile_BPMNExpression419'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNExpression419', a)
    if hasattr(b2, 'BPMNProfile_BPMNExpression419'):
        assert _is_linked(b2, 'BPMNProfile_BPMNExpression419', a)
    _safe_set(a, 'BPMNProfile_ResourceAssignmentExpression418', None)
    assert not _is_linked(a, 'BPMNProfile_ResourceAssignmentExpression418', b2)
    if hasattr(b2, 'BPMNProfile_BPMNExpression419'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNExpression419', a)


def test_assoc_expression434_link_reassign_clear():
    a = BPMNProfile_ResourceParameterBinding()
    b1 = BPMNProfile_BPMNExpression()
    b2 = BPMNProfile_BPMNExpression()
    _safe_set(a, 'BPMNProfile_ResourceParameterBinding435', b1)
    assert _is_linked(a, 'BPMNProfile_ResourceParameterBinding435', b1)
    if hasattr(b1, 'BPMNProfile_BPMNExpression436'):
        assert _is_linked(b1, 'BPMNProfile_BPMNExpression436', a)
    _safe_set(a, 'BPMNProfile_ResourceParameterBinding435', b2)
    assert _is_linked(a, 'BPMNProfile_ResourceParameterBinding435', b2)
    if hasattr(b1, 'BPMNProfile_BPMNExpression436'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNExpression436', a)
    if hasattr(b2, 'BPMNProfile_BPMNExpression436'):
        assert _is_linked(b2, 'BPMNProfile_BPMNExpression436', a)
    _safe_set(a, 'BPMNProfile_ResourceParameterBinding435', None)
    assert not _is_linked(a, 'BPMNProfile_ResourceParameterBinding435', b2)
    if hasattr(b2, 'BPMNProfile_BPMNExpression436'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNExpression436', a)
...
def test_assoc_extensions108_link_reassign_clear():
    a = BPMNProfile_Definitions(exporter="sample_text", exporterVersion="sample_text", expressionLanguage="sample_text", targetNamespace="sample_text", typeLanguage="sample_text")
    b1 = BPMNProfile_BPMNExtension(mustUnderstand="sample_text")
    b2 = BPMNProfile_BPMNExtension(mustUnderstand="sample_text_2")
    _safe_set(a, 'BPMNProfile_Definitions109', {b1})
    assert _is_linked(a, 'BPMNProfile_Definitions109', b1)
    if hasattr(b1, 'BPMNProfile_BPMNExtension'):
        assert _is_linked(b1, 'BPMNProfile_BPMNExtension', a)
    _safe_set(a, 'BPMNProfile_Definitions109', {b2})
    assert _is_linked(a, 'BPMNProfile_Definitions109', b2)
    if hasattr(b1, 'BPMNProfile_BPMNExtension'):
    ...
    _safe_set(a, 'BPMNProfile_Definitions109', set())
    assert not _is_linked(a, 'BPMNProfile_Definitions109', b2)
    if hasattr(b2, 'BPMNProfile_BPMNExtension'):
...
def test_assoc_hasLaneSets617_link_reassign_clear():
    a = BPMNProfile_SubProcess(triggeredByEvent="sample_text")
    b1 = BPMNProfile_LaneSet()
    b2 = BPMNProfile_LaneSet()
    _safe_set(a, 'BPMNProfile_SubProcess618', {b1})
    assert _is_linked(a, 'BPMNProfile_SubProcess618', b1)
    if hasattr(b1, 'BPMNProfile_LaneSet619'):
        assert _is_linked(b1, 'BPMNProfile_LaneSet619', a)
    _safe_set(a, 'BPMNProfile_SubProcess618', {b2})
    assert _is_linked(a, 'BPMNProfile_SubProcess618', b2)
    if hasattr(b1, 'BPMNProfile_LaneSet619'):
        assert not _is_linked(b1, 'BPMNProfile_LaneSet619', a)
    if hasattr(b2, 'BPMNProfile_LaneSet619'):
        assert _is_linked(b2, 'BPMNProfile_LaneSet619', a)
    _safe_set(a, 'BPMNProfile_SubProcess618', set())
    assert not _is_linked(a, 'BPMNProfile_SubProcess618', b2)
    if hasattr(b2, 'BPMNProfile_LaneSet619'):
        assert not _is_linked(b2, 'BPMNProfile_LaneSet619', a)


def test_assoc_implementationRef235_link_reassign_clear():
    a = BPMNProfile_BPMNInterface()
    b1 = BPMNProfile_Element()
    b2 = BPMNProfile_Element()
    _safe_set(a, 'BPMNProfile_BPMNInterface236', b1)
    assert _is_linked(a, 'BPMNProfile_BPMNInterface236', b1)
    if hasattr(b1, 'BPMNProfile_Element237'):
        assert _is_linked(b1, 'BPMNProfile_Element237', a)
    _safe_set(a, 'BPMNProfile_BPMNInterface236', b2)
    assert _is_linked(a, 'BPMNProfile_BPMNInterface236', b2)
    if hasattr(b1, 'BPMNProfile_Element237'):
        assert not _is_linked(b1, 'BPMNProfile_Element237', a)
    if hasattr(b2, 'BPMNProfile_Element237'):
        assert _is_linked(b2, 'BPMNProfile_Element237', a)
    _safe_set(a, 'BPMNProfile_BPMNInterface236', None)
    assert not _is_linked(a, 'BPMNProfile_BPMNInterface236', b2)
    if hasattr(b2, 'BPMNProfile_Element237'):
        assert not _is_linked(b2, 'BPMNProfile_Element237', a)


def test_assoc_implementationRef245_link_reassign_clear():
    a = BPMNProfile_BPMNOperation()
    b1 = BPMNProfile_Element()
    b2 = BPMNProfile_Element()
    _safe_set(a, 'BPMNProfile_BPMNOperation246', b1)
    assert _is_linked(a, 'BPMNProfile_BPMNOperation246', b1)
    if hasattr(b1, 'BPMNProfile_Element247'):
        assert _is_linked(b1, 'BPMNProfile_Element247', a)
    _safe_set(a, 'BPMNProfile_BPMNOperation246', b2)
    assert _is_linked(a, 'BPMNProfile_BPMNOperation246', b2)
    if hasattr(b1, 'BPMNProfile_Element247'):
        assert not _is_linked(b1, 'BPMNProfile_Element247', a)
    if hasattr(b2, 'BPMNProfile_Element247'):
        assert _is_linked(b2, 'BPMNProfile_Element247', a)
    _safe_set(a, 'BPMNProfile_BPMNOperation246', None)
    assert not _is_linked(a, 'BPMNProfile_BPMNOperation246', b2)
    if hasattr(b2, 'BPMNProfile_Element247'):
        assert not _is_linked(b2, 'BPMNProfile_Element247', a)


def test_assoc_import_198_link_reassign_clear():
    a = BPMNProfile_ItemDefinition(isCollection="sample_text", itemKind="sample_text")
    ...
    _safe_set(a, 'BPMNProfile_ItemDefinition199', b1)
    assert _is_linked(a, 'BPMNProfile_ItemDefinition199', b1)
    if hasattr(b1, 'BPMNProfile_Import200'):
        assert _is_linked(b1, 'BPMNProfile_Import200', a)
    _safe_set(a, 'BPMNProfile_ItemDefinition199', b2)
    assert _is_linked(a, 'BPMNProfile_ItemDefinition199', b2)
    if hasattr(b1, 'BPMNProfile_Import200'):
        assert not _is_linked(b1, 'BPMNProfile_Import200', a)
    if hasattr(b2, 'BPMNProfile_Import200'):
        assert _is_linked(b2, 'BPMNProfile_Import200', a)
    _safe_set(a, 'BPMNProfile_ItemDefinition199', None)
    assert not _is_linked(a, 'BPMNProfile_ItemDefinition199', b2)
    if hasattr(b2, 'BPMNProfile_Import200'):
        assert not _is_linked(b2, 'BPMNProfile_Import200', a)


def test_assoc_imports110_link_reassign_clear():
    a = BPMNProfile_Import(importType="sample_text", location="sample_text", namespace="sample_text")
    b1 = BPMNProfile_Definitions(exporter="sample_text", exporterVersion="sample_text", expressionLanguage="sample_text", targetNamespace="sample_text", typeLanguage="sample_text")
    b2 = BPMNProfile_Definitions(exporter="sample_text_2", exporterVersion="sample_text_2", expressionLanguage="sample_text_2", targetNamespace="sample_text_2", typeLanguage="sample_text_2")
    _safe_set(a, 'BPMNProfile_Import', b1)
    assert _is_linked(a, 'BPMNProfile_Import', b1)
    if hasattr(b1, 'BPMNProfile_Definitions111'):
        assert _is_linked(b1, 'BPMNProfile_Definitions111', a)
    _safe_set(a, 'BPMNProfile_Import', b2)
    assert _is_linked(a, 'BPMNProfile_Import', b2)
    if hasattr(b1, 'BPMNProfile_Definitions111'):
        assert not _is_linked(b1, 'BPMNProfile_Definitions111', a)
    if hasattr(b2, 'BPMNProfile_Definitions111'):
        assert _is_linked(b2, 'BPMNProfile_Definitions111', a)
    _safe_set(a, 'BPMNProfile_Import', None)
    assert not _is_linked(a, 'BPMNProfile_Import', b2)
    if hasattr(b2, 'BPMNProfile_Definitions111'):
        assert not _is_linked(b2, 'BPMNProfile_Definitions111', a)


def test_assoc_inMessageRef248_link_reassign_clear():
    a = BPMNProfile_BPMNOperation()
    b1 = BPMNProfile_BPMNMessage()
    b2 = BPMNProfile_BPMNMessage()
    _safe_set(a, 'BPMNProfile_BPMNOperation249', b1)
    assert _is_linked(a, 'BPMNProfile_BPMNOperation249', b1)
    if hasattr(b1, 'BPMNProfile_BPMNMessage'):
        assert _is_linked(b1, 'BPMNProfile_BPMNMessage', a)
    _safe_set(a, 'BPMNProfile_BPMNOperation249', b2)
    assert _is_linked(a, 'BPMNProfile_BPMNOperation249', b2)
    if hasattr(b1, 'BPMNProfile_BPMNMessage'):
    ...
    _safe_set(a, 'BPMNProfile_BPMNOperation249', None)
    assert not _is_linked(a, 'BPMNProfile_BPMNOperation249', b2)
    if hasattr(b2, 'BPMNProfile_BPMNMessage'):
...
def test_assoc_innerMessageFlowRef333_link_reassign_clear():
    a = BPMNProfile_MessageFlowAssociation()
    b1 = BPMNProfile_MessageFlow()
    b2 = BPMNProfile_MessageFlow()
    _safe_set(a, 'BPMNProfile_MessageFlowAssociation334', b1)
    assert _is_linked(a, 'BPMNProfile_MessageFlowAssociation334', b1)
    if hasattr(b1, 'BPMNProfile_MessageFlow335'):
        assert _is_linked(b1, 'BPMNProfile_MessageFlow335', a)
    _safe_set(a, 'BPMNProfile_MessageFlowAssociation334', b2)
    assert _is_linked(a, 'BPMNProfile_MessageFlowAssociation334', b2)
    if hasattr(b1, 'BPMNProfile_MessageFlow335'):
        assert not _is_linked(b1, 'BPMNProfile_MessageFlow335', a)
    if hasattr(b2, 'BPMNProfile_MessageFlow335'):
        assert _is_linked(b2, 'BPMNProfile_MessageFlow335', a)
    _safe_set(a, 'BPMNProfile_MessageFlowAssociation334', None)
    assert not _is_linked(a, 'BPMNProfile_MessageFlowAssociation334', b2)
    if hasattr(b2, 'BPMNProfile_MessageFlow335'):
        assert not _is_linked(b2, 'BPMNProfile_MessageFlow335', a)


def test_assoc_innerParticipantRef288_link_reassign_clear():
    a = BPMNProfile_ParticipantAssociation()
    b1 = BPMNProfile_Participant()
    b2 = BPMNProfile_Participant()
    _safe_set(a, 'BPMNProfile_ParticipantAssociation289', b1)
    assert _is_linked(a, 'BPMNProfile_ParticipantAssociation289', b1)
    if hasattr(b1, 'BPMNProfile_Participant290'):
        assert _is_linked(b1, 'BPMNProfile_Participant290', a)
    _safe_set(a, 'BPMNProfile_ParticipantAssociation289', b2)
    assert _is_linked(a, 'BPMNProfile_ParticipantAssociation289', b2)
    if hasattr(b1, 'BPMNProfile_Participant290'):
        assert not _is_linked(b1, 'BPMNProfile_Participant290', a)
    if hasattr(b2, 'BPMNProfile_Participant290'):
        assert _is_linked(b2, 'BPMNProfile_Participant290', a)
    _safe_set(a, 'BPMNProfile_ParticipantAssociation289', None)
    assert not _is_linked(a, 'BPMNProfile_ParticipantAssociation289', b2)
    if hasattr(b2, 'BPMNProfile_Participant290'):
        assert not _is_linked(b2, 'BPMNProfile_Participant290', a)


def test_assoc_inputDataItem678_link_reassign_clear():
    a = BPMNProfile_MultiInstanceLoopCharacteristics(behavior="sample_text", isSequential="sample_text")
    b1 = BPMNProfile_DataInput(isCollection="sample_text")
    b2 = BPMNProfile_DataInput(isCollection="sample_text_2")
    ...
    if hasattr(b1, 'BPMNProfile_DataInput680'):
        assert _is_linked(b1, 'BPMNProfile_DataInput680', a)
    ...
    if hasattr(b1, 'BPMNProfile_DataInput680'):
        assert not _is_linked(b1, 'BPMNProfile_DataInput680', a)
    if hasattr(b2, 'BPMNProfile_DataInput680'):
        assert _is_linked(b2, 'BPMNProfile_DataInput680', a)
    ...
    if hasattr(b2, 'BPMNProfile_DataInput680'):
        assert not _is_linked(b2, 'BPMNProfile_DataInput680', a)


def test_assoc_inputDataRef258_link_reassign_clear():
    a = BPMNProfile_InputSet()
    b1 = BPMNProfile_InputOutputBinding()
    b2 = BPMNProfile_InputOutputBinding()
    _safe_set(a, 'BPMNProfile_InputSet260', b1)
    assert _is_linked(a, 'BPMNProfile_InputSet260', b1)
    if hasattr(b1, 'BPMNProfile_InputOutputBinding259'):
        assert _is_linked(b1, 'BPMNProfile_InputOutputBinding259', a)
    _safe_set(a, 'BPMNProfile_InputSet260', b2)
    assert _is_linked(a, 'BPMNProfile_InputSet260', b2)
    if hasattr(b1, 'BPMNProfile_InputOutputBinding259'):
    ...
    _safe_set(a, 'BPMNProfile_InputSet260', None)
    assert not _is_linked(a, 'BPMNProfile_InputSet260', b2)
    if hasattr(b2, 'BPMNProfile_InputOutputBinding259'):
        assert not _is_linked(b2, 'BPMNProfile_InputOutputBinding259', a)


def test_assoc_inputSetRefs180_link_reassign_clear():
    a = BPMNProfile_InputSet()
    b1 = BPMNProfile_DataInput(isCollection="sample_text")
    b2 = BPMNProfile_DataInput(isCollection="sample_text_2")
...
def test_assoc_inputSetWithOptional181_link_reassign_clear():
    a = BPMNProfile_InputSet()
    b1 = BPMNProfile_DataInput(isCollection="sample_text")
    b2 = BPMNProfile_DataInput(isCollection="sample_text_2")
    _safe_set(a, 'InputSet182', b1)
    assert _is_linked(a, 'InputSet182', b1)
    if hasattr(b1, 'optionalInputRefs'):
        assert _is_linked(b1, 'optionalInputRefs', a)
    _safe_set(a, 'InputSet182', b2)
    assert _is_linked(a, 'InputSet182', b2)
    if hasattr(b1, 'optionalInputRefs'):
        assert not _is_linked(b1, 'optionalInputRefs', a)
    if hasattr(b2, 'optionalInputRefs'):
        assert _is_linked(b2, 'optionalInputRefs', a)
    _safe_set(a, 'InputSet182', None)
    assert not _is_linked(a, 'InputSet182', b2)
    if hasattr(b2, 'optionalInputRefs'):
        assert not _is_linked(b2, 'optionalInputRefs', a)


def test_assoc_inputSetWithWhileExecuting183_link_reassign_clear():
    a = BPMNProfile_InputSet()
    b1 = BPMNProfile_DataInput(isCollection="sample_text")
    b2 = BPMNProfile_DataInput(isCollection="sample_text_2")
    _safe_set(a, 'InputSet184', b1)
    assert _is_linked(a, 'InputSet184', b1)
    if hasattr(b1, 'whileExecutingInputRefs'):
        assert _is_linked(b1, 'whileExecutingInputRefs', a)
    _safe_set(a, 'InputSet184', b2)
    assert _is_linked(a, 'InputSet184', b2)
    if hasattr(b1, 'whileExecutingInputRefs'):
    ...
    _safe_set(a, 'InputSet184', None)
    assert not _is_linked(a, 'InputSet184', b2)
    if hasattr(b2, 'whileExecutingInputRefs'):
        assert not _is_linked(b2, 'whileExecutingInputRefs', a)


def test_assoc_inputSets170_link_reassign_clear():
    a = BPMNProfile_InputSet()
    b1 = BPMNProfile_InputOutputSpecification()
    b2 = BPMNProfile_InputOutputSpecification()
    _safe_set(a, 'BPMNProfile_InputSet', b1)
    assert _is_linked(a, 'BPMNProfile_InputSet', b1)
    if hasattr(b1, 'BPMNProfile_InputOutputSpecification171'):
        assert _is_linked(b1, 'BPMNProfile_InputOutputSpecification171', a)
    _safe_set(a, 'BPMNProfile_InputSet', b2)
    assert _is_linked(a, 'BPMNProfile_InputSet', b2)
    if hasattr(b1, 'BPMNProfile_InputOutputSpecification171'):
        assert not _is_linked(b1, 'BPMNProfile_InputOutputSpecification171', a)
    if hasattr(b2, 'BPMNProfile_InputOutputSpecification171'):
        assert _is_linked(b2, 'BPMNProfile_InputOutputSpecification171', a)
    _safe_set(a, 'BPMNProfile_InputSet', None)
    assert not _is_linked(a, 'BPMNProfile_InputSet', b2)
    if hasattr(b2, 'BPMNProfile_InputOutputSpecification171'):
        assert not _is_linked(b2, 'BPMNProfile_InputOutputSpecification171', a)


def test_assoc_interfaceRefs305_link_reassign_clear():
    a = BPMNProfile_Participant()
    b1 = BPMNProfile_BPMNInterface()
    b2 = BPMNProfile_BPMNInterface()
    _safe_set(a, 'BPMNProfile_Participant306', {b1})
    assert _is_linked(a, 'BPMNProfile_Participant306', b1)
    if hasattr(b1, 'BPMNProfile_BPMNInterface307'):
        assert _is_linked(b1, 'BPMNProfile_BPMNInterface307', a)
    _safe_set(a, 'BPMNProfile_Participant306', {b2})
    assert _is_linked(a, 'BPMNProfile_Participant306', b2)
    if hasattr(b1, 'BPMNProfile_BPMNInterface307'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNInterface307', a)
    if hasattr(b2, 'BPMNProfile_BPMNInterface307'):
        assert _is_linked(b2, 'BPMNProfile_BPMNInterface307', a)
    _safe_set(a, 'BPMNProfile_Participant306', set())
    assert not _is_linked(a, 'BPMNProfile_Participant306', b2)
    if hasattr(b2, 'BPMNProfile_BPMNInterface307'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNInterface307', a)


def test_assoc_ioBinding159_link_reassign_clear():
    a = BPMNProfile_CallableElement()
    b1 = BPMNProfile_InputOutputBinding()
    b2 = BPMNProfile_InputOutputBinding()
    _safe_set(a, 'BPMNProfile_CallableElement160', {b1})
    assert _is_linked(a, 'BPMNProfile_CallableElement160', b1)
    if hasattr(b1, 'BPMNProfile_InputOutputBinding'):
        assert _is_linked(b1, 'BPMNProfile_InputOutputBinding', a)
    _safe_set(a, 'BPMNProfile_CallableElement160', {b2})
    assert _is_linked(a, 'BPMNProfile_CallableElement160', b2)
    if hasattr(b1, 'BPMNProfile_InputOutputBinding'):
    ...
    _safe_set(a, 'BPMNProfile_CallableElement160', set())
    assert not _is_linked(a, 'BPMNProfile_CallableElement160', b2)
    if hasattr(b2, 'BPMNProfile_InputOutputBinding'):
        assert not _is_linked(b2, 'BPMNProfile_InputOutputBinding', a)


def test_assoc_ioSpecification155_link_reassign_clear():
    a = BPMNProfile_CallableElement()
    b1 = BPMNProfile_InputOutputSpecification()
    b2 = BPMNProfile_InputOutputSpecification()
    _safe_set(a, 'BPMNProfile_CallableElement156', b1)
    assert _is_linked(a, 'BPMNProfile_CallableElement156', b1)
    if hasattr(b1, 'BPMNProfile_InputOutputSpecification'):
        assert _is_linked(b1, 'BPMNProfile_InputOutputSpecification', a)
    _safe_set(a, 'BPMNProfile_CallableElement156', b2)
    assert _is_linked(a, 'BPMNProfile_CallableElement156', b2)
    if hasattr(b1, 'BPMNProfile_InputOutputSpecification'):
    ...
    _safe_set(a, 'BPMNProfile_CallableElement156', None)
    assert not _is_linked(a, 'BPMNProfile_CallableElement156', b2)
    if hasattr(b2, 'BPMNProfile_InputOutputSpecification'):
        assert not _is_linked(b2, 'BPMNProfile_InputOutputSpecification', a)


def test_assoc_itemRef255_link_reassign_clear():
    a = BPMNProfile_ItemDefinition(isCollection="sample_text", itemKind="sample_text")
    b1 = BPMNProfile_BPMNMessage()
    b2 = BPMNProfile_BPMNMessage()
    _safe_set(a, 'BPMNProfile_ItemDefinition257', b1)
    assert _is_linked(a, 'BPMNProfile_ItemDefinition257', b1)
    if hasattr(b1, 'BPMNProfile_BPMNMessage256'):
        assert _is_linked(b1, 'BPMNProfile_BPMNMessage256', a)
    _safe_set(a, 'BPMNProfile_ItemDefinition257', b2)
    assert _is_linked(a, 'BPMNProfile_ItemDefinition257', b2)
    if hasattr(b1, 'BPMNProfile_BPMNMessage256'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNMessage256', a)
    if hasattr(b2, 'BPMNProfile_BPMNMessage256'):
        assert _is_linked(b2, 'BPMNProfile_BPMNMessage256', a)
    _safe_set(a, 'BPMNProfile_ItemDefinition257', None)
    assert not _is_linked(a, 'BPMNProfile_ItemDefinition257', b2)
    if hasattr(b2, 'BPMNProfile_BPMNMessage256'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNMessage256', a)


def test_assoc_itemSubjectRef188_link_reassign_clear():
    a = BPMNProfile_ItemDefinition(isCollection="sample_text", itemKind="sample_text")
    ...
    if hasattr(b1, 'BPMNProfile_ItemAwareElement189'):
        assert _is_linked(b1, 'BPMNProfile_ItemAwareElement189', a)
    _safe_set(a, 'BPMNProfile_ItemDefinition', b2)
    assert _is_linked(a, 'BPMNProfile_ItemDefinition', b2)
    if hasattr(b1, 'BPMNProfile_ItemAwareElement189'):
        assert not _is_linked(b1, 'BPMNProfile_ItemAwareElement189', a)
    if hasattr(b2, 'BPMNProfile_ItemAwareElement189'):
        assert _is_linked(b2, 'BPMNProfile_ItemAwareElement189', a)
    _safe_set(a, 'BPMNProfile_ItemDefinition', None)
    assert not _is_linked(a, 'BPMNProfile_ItemDefinition', b2)
    if hasattr(b2, 'BPMNProfile_ItemAwareElement189'):
        assert not _is_linked(b2, 'BPMNProfile_ItemAwareElement189', a)


def test_assoc_itemSubjectRef587_link_reassign_clear():
    a = BPMNProfile_ItemDefinition(isCollection="sample_text", itemKind="sample_text")
    ...
    _safe_set(a, 'BPMNProfile_ItemDefinition589', b1)
    assert _is_linked(a, 'BPMNProfile_ItemDefinition589', b1)
    if hasattr(b1, 'BPMNProfile_DataStore588'):
        assert _is_linked(b1, 'BPMNProfile_DataStore588', a)
    _safe_set(a, 'BPMNProfile_ItemDefinition589', b2)
    assert _is_linked(a, 'BPMNProfile_ItemDefinition589', b2)
    if hasattr(b1, 'BPMNProfile_DataStore588'):
        assert not _is_linked(b1, 'BPMNProfile_DataStore588', a)
    if hasattr(b2, 'BPMNProfile_DataStore588'):
        assert _is_linked(b2, 'BPMNProfile_DataStore588', a)
    _safe_set(a, 'BPMNProfile_ItemDefinition589', None)
    assert not _is_linked(a, 'BPMNProfile_ItemDefinition589', b2)
    if hasattr(b2, 'BPMNProfile_DataStore588'):
        assert not _is_linked(b2, 'BPMNProfile_DataStore588', a)
...
def test_assoc_loopCardinality662_link_reassign_clear():
    a = BPMNProfile_MultiInstanceLoopCharacteristics(behavior="sample_text", isSequential="sample_text")
    b1 = BPMNProfile_BPMNExpression()
    b2 = BPMNProfile_BPMNExpression()
    ...
    if hasattr(b1, 'BPMNProfile_BPMNExpression663'):
        assert _is_linked(b1, 'BPMNProfile_BPMNExpression663', a)
    ...
    if hasattr(b1, 'BPMNProfile_BPMNExpression663'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNExpression663', a)
    if hasattr(b2, 'BPMNProfile_BPMNExpression663'):
        assert _is_linked(b2, 'BPMNProfile_BPMNExpression663', a)
    ...
    if hasattr(b2, 'BPMNProfile_BPMNExpression663'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNExpression663', a)


def test_assoc_loopCharacteristics463_link_reassign_clear():
    a = BPMNProfile_BPMNActivity(completionQuantity="sample_text", isForCompensation="sample_text", startQuantity="sample_text")
    b1 = BPMNProfile_LoopCharacteristics()
    b2 = BPMNProfile_LoopCharacteristics()
    _safe_set(a, 'BPMNProfile_BPMNActivity464', b1)
    assert _is_linked(a, 'BPMNProfile_BPMNActivity464', b1)
    if hasattr(b1, 'BPMNProfile_LoopCharacteristics'):
        assert _is_linked(b1, 'BPMNProfile_LoopCharacteristics', a)
    _safe_set(a, 'BPMNProfile_BPMNActivity464', b2)
    assert _is_linked(a, 'BPMNProfile_BPMNActivity464', b2)
    if hasattr(b1, 'BPMNProfile_LoopCharacteristics'):
    ...
    _safe_set(a, 'BPMNProfile_BPMNActivity464', None)
    assert not _is_linked(a, 'BPMNProfile_BPMNActivity464', b2)
    if hasattr(b2, 'BPMNProfile_LoopCharacteristics'):
        assert not _is_linked(b2, 'BPMNProfile_LoopCharacteristics', a)


def test_assoc_loopCondition646_link_reassign_clear():
    a = BPMNProfile_StandardLoopCharacteristics(loopMaximum="sample_text", testBefore="sample_text")
    b1 = BPMNProfile_BPMNExpression()
    b2 = BPMNProfile_BPMNExpression()
    _safe_set(a, 'BPMNProfile_StandardLoopCharacteristics647', b1)
    assert _is_linked(a, 'BPMNProfile_StandardLoopCharacteristics647', b1)
    if hasattr(b1, 'BPMNProfile_BPMNExpression648'):
        assert _is_linked(b1, 'BPMNProfile_BPMNExpression648', a)
    _safe_set(a, 'BPMNProfile_StandardLoopCharacteristics647', b2)
    assert _is_linked(a, 'BPMNProfile_StandardLoopCharacteristics647', b2)
    if hasattr(b1, 'BPMNProfile_BPMNExpression648'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNExpression648', a)
    if hasattr(b2, 'BPMNProfile_BPMNExpression648'):
        assert _is_linked(b2, 'BPMNProfile_BPMNExpression648', a)
    _safe_set(a, 'BPMNProfile_StandardLoopCharacteristics647', None)
    assert not _is_linked(a, 'BPMNProfile_StandardLoopCharacteristics647', b2)
    if hasattr(b2, 'BPMNProfile_BPMNExpression648'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNExpression648', a)


def test_assoc_loopDataInputRef669_link_reassign_clear():
    a = BPMNProfile_MultiInstanceLoopCharacteristics(behavior="sample_text", isSequential="sample_text")
    b1 = BPMNProfile_ItemAwareElement()
    b2 = BPMNProfile_ItemAwareElement()
    ...
    if hasattr(b1, 'BPMNProfile_ItemAwareElement671'):
        assert _is_linked(b1, 'BPMNProfile_ItemAwareElement671', a)
    ...
    if hasattr(b1, 'BPMNProfile_ItemAwareElement671'):
        assert not _is_linked(b1, 'BPMNProfile_ItemAwareElement671', a)
    if hasattr(b2, 'BPMNProfile_ItemAwareElement671'):
        assert _is_linked(b2, 'BPMNProfile_ItemAwareElement671', a)
    ...
    if hasattr(b2, 'BPMNProfile_ItemAwareElement671'):
        assert not _is_linked(b2, 'BPMNProfile_ItemAwareElement671', a)


def test_assoc_loopDataOutputRef672_link_reassign_clear():
    a = BPMNProfile_MultiInstanceLoopCharacteristics(behavior="sample_text", isSequential="sample_text")
    b1 = BPMNProfile_ItemAwareElement()
    b2 = BPMNProfile_ItemAwareElement()
    ...
    if hasattr(b1, 'BPMNProfile_ItemAwareElement674'):
        assert _is_linked(b1, 'BPMNProfile_ItemAwareElement674', a)
    ...
    if hasattr(b1, 'BPMNProfile_ItemAwareElement674'):
        assert not _is_linked(b1, 'BPMNProfile_ItemAwareElement674', a)
    if hasattr(b2, 'BPMNProfile_ItemAwareElement674'):
        assert _is_linked(b2, 'BPMNProfile_ItemAwareElement674', a)
    ...
    if hasattr(b2, 'BPMNProfile_ItemAwareElement674'):
        assert not _is_linked(b2, 'BPMNProfile_ItemAwareElement674', a)


def test_assoc_messageFlowAssociations273_link_reassign_clear():
    a = BPMNProfile_MessageFlowAssociation()
    b1 = BPMNProfile_BPMNCollaboration(isClosed="sample_text")
    b2 = BPMNProfile_BPMNCollaboration(isClosed="sample_text_2")
...
def test_assoc_messageFlowRefs353_link_reassign_clear():
    a = BPMNProfile_MessageFlow()
    b1 = BPMNProfile_ConversationNode()
    b2 = BPMNProfile_ConversationNode()
    _safe_set(a, 'BPMNProfile_MessageFlow355', b1)
    assert _is_linked(a, 'BPMNProfile_MessageFlow355', b1)
    if hasattr(b1, 'BPMNProfile_ConversationNode354'):
        assert _is_linked(b1, 'BPMNProfile_ConversationNode354', a)
    _safe_set(a, 'BPMNProfile_MessageFlow355', b2)
    assert _is_linked(a, 'BPMNProfile_MessageFlow355', b2)
    if hasattr(b1, 'BPMNProfile_ConversationNode354'):
    ...
    _safe_set(a, 'BPMNProfile_MessageFlow355', None)
    assert not _is_linked(a, 'BPMNProfile_MessageFlow355', b2)
    if hasattr(b2, 'BPMNProfile_ConversationNode354'):
        assert not _is_linked(b2, 'BPMNProfile_ConversationNode354', a)


def test_assoc_messageFlows275_link_reassign_clear():
    a = BPMNProfile_MessageFlow()
    b1 = BPMNProfile_BPMNCollaboration(isClosed="sample_text")
    b2 = BPMNProfile_BPMNCollaboration(isClosed="sample_text_2")
    _safe_set(a, 'BPMNProfile_MessageFlow', b1)
    assert _is_linked(a, 'BPMNProfile_MessageFlow', b1)
    if hasattr(b1, 'BPMNProfile_BPMNCollaboration276'):
        assert _is_linked(b1, 'BPMNProfile_BPMNCollaboration276', a)
    _safe_set(a, 'BPMNProfile_MessageFlow', b2)
    assert _is_linked(a, 'BPMNProfile_MessageFlow', b2)
    if hasattr(b1, 'BPMNProfile_BPMNCollaboration276'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNCollaboration276', a)
    if hasattr(b2, 'BPMNProfile_BPMNCollaboration276'):
        assert _is_linked(b2, 'BPMNProfile_BPMNCollaboration276', a)
    _safe_set(a, 'BPMNProfile_MessageFlow', None)
    assert not _is_linked(a, 'BPMNProfile_MessageFlow', b2)
    if hasattr(b2, 'BPMNProfile_BPMNCollaboration276'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNCollaboration276', a)


def test_assoc_messagePath381_link_reassign_clear():
    a = BPMNProfile_FormalExpression()
    ...
    if hasattr(b1, 'BPMNProfile_CorrelationPropertyRetrievalExpression382'):
        assert _is_linked(b1, 'BPMNProfile_CorrelationPropertyRetrievalExpression382', a)
    _safe_set(a, 'BPMNProfile_FormalExpression', b2)
    assert _is_linked(a, 'BPMNProfile_FormalExpression', b2)
    if hasattr(b1, 'BPMNProfile_CorrelationPropertyRetrievalExpression382'):
        assert not _is_linked(b1, 'BPMNProfile_CorrelationPropertyRetrievalExpression382', a)
    if hasattr(b2, 'BPMNProfile_CorrelationPropertyRetrievalExpression382'):
        assert _is_linked(b2, 'BPMNProfile_CorrelationPropertyRetrievalExpression382', a)
    _safe_set(a, 'BPMNProfile_FormalExpression', None)
    assert not _is_linked(a, 'BPMNProfile_FormalExpression', b2)
    if hasattr(b2, 'BPMNProfile_CorrelationPropertyRetrievalExpression382'):
        assert not _is_linked(b2, 'BPMNProfile_CorrelationPropertyRetrievalExpression382', a)


def test_assoc_messageRef347_link_reassign_clear():
    a = BPMNProfile_MessageFlow()
    b1 = BPMNProfile_BPMNMessage()
    b2 = BPMNProfile_BPMNMessage()
    _safe_set(a, 'BPMNProfile_MessageFlow348', b1)
    assert _is_linked(a, 'BPMNProfile_MessageFlow348', b1)
    if hasattr(b1, 'BPMNProfile_BPMNMessage349'):
        assert _is_linked(b1, 'BPMNProfile_BPMNMessage349', a)
    _safe_set(a, 'BPMNProfile_MessageFlow348', b2)
    assert _is_linked(a, 'BPMNProfile_MessageFlow348', b2)
    if hasattr(b1, 'BPMNProfile_BPMNMessage349'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNMessage349', a)
    if hasattr(b2, 'BPMNProfile_BPMNMessage349'):
        assert _is_linked(b2, 'BPMNProfile_BPMNMessage349', a)
    _safe_set(a, 'BPMNProfile_MessageFlow348', None)
    assert not _is_linked(a, 'BPMNProfile_MessageFlow348', b2)
    if hasattr(b2, 'BPMNProfile_BPMNMessage349'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNMessage349', a)


def test_assoc_messageRef378_link_reassign_clear():
    a = BPMNProfile_BPMNMessage()
    b1 = BPMNProfile_CorrelationPropertyRetrievalExpression()
    b2 = BPMNProfile_CorrelationPropertyRetrievalExpression()
    _safe_set(a, 'BPMNProfile_BPMNMessage380', b1)
    assert _is_linked(a, 'BPMNProfile_BPMNMessage380', b1)
    if hasattr(b1, 'BPMNProfile_CorrelationPropertyRetrievalExpression379'):
        assert _is_linked(b1, 'BPMNProfile_CorrelationPropertyRetrievalExpression379', a)
    _safe_set(a, 'BPMNProfile_BPMNMessage380', b2)
    assert _is_linked(a, 'BPMNProfile_BPMNMessage380', b2)
    if hasattr(b1, 'BPMNProfile_CorrelationPropertyRetrievalExpression379'):
        assert not _is_linked(b1, 'BPMNProfile_CorrelationPropertyRetrievalExpression379', a)
    if hasattr(b2, 'BPMNProfile_CorrelationPropertyRetrievalExpression379'):
        assert _is_linked(b2, 'BPMNProfile_CorrelationPropertyRetrievalExpression379', a)
    _safe_set(a, 'BPMNProfile_BPMNMessage380', None)
    assert not _is_linked(a, 'BPMNProfile_BPMNMessage380', b2)
    if hasattr(b2, 'BPMNProfile_CorrelationPropertyRetrievalExpression379'):
        assert not _is_linked(b2, 'BPMNProfile_CorrelationPropertyRetrievalExpression379', a)


def test_assoc_messageRef537_link_reassign_clear():
    a = BPMNProfile_BPMNMessage()
    b1 = BPMNProfile_MessageEventDefinition()
    b2 = BPMNProfile_MessageEventDefinition()
    _safe_set(a, 'BPMNProfile_BPMNMessage538', b1)
    assert _is_linked(a, 'BPMNProfile_BPMNMessage538', b1)
    if hasattr(b1, 'BPMNProfile_MessageEventDefinition'):
        assert _is_linked(b1, 'BPMNProfile_MessageEventDefinition', a)
    _safe_set(a, 'BPMNProfile_BPMNMessage538', b2)
    assert _is_linked(a, 'BPMNProfile_BPMNMessage538', b2)
    if hasattr(b1, 'BPMNProfile_MessageEventDefinition'):
    ...
    _safe_set(a, 'BPMNProfile_BPMNMessage538', None)
    assert not _is_linked(a, 'BPMNProfile_BPMNMessage538', b2)
    if hasattr(b2, 'BPMNProfile_MessageEventDefinition'):
        assert not _is_linked(b2, 'BPMNProfile_MessageEventDefinition', a)


def test_assoc_messageRef637_link_reassign_clear():
    a = BPMNProfile_SendTask(implementation="sample_text")
    b1 = BPMNProfile_BPMNMessage()
    b2 = BPMNProfile_BPMNMessage()
    _safe_set(a, 'BPMNProfile_SendTask', b1)
    assert _is_linked(a, 'BPMNProfile_SendTask', b1)
    if hasattr(b1, 'BPMNProfile_BPMNMessage638'):
        assert _is_linked(b1, 'BPMNProfile_BPMNMessage638', a)
    _safe_set(a, 'BPMNProfile_SendTask', b2)
    assert _is_linked(a, 'BPMNProfile_SendTask', b2)
    if hasattr(b1, 'BPMNProfile_BPMNMessage638'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNMessage638', a)
    if hasattr(b2, 'BPMNProfile_BPMNMessage638'):
        assert _is_linked(b2, 'BPMNProfile_BPMNMessage638', a)
    _safe_set(a, 'BPMNProfile_SendTask', None)
    assert not _is_linked(a, 'BPMNProfile_SendTask', b2)
    if hasattr(b2, 'BPMNProfile_BPMNMessage638'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNMessage638', a)


def test_assoc_messageRef649_link_reassign_clear():
    a = BPMNProfile_ReceiveTask(implementation="sample_text", instantiate="sample_text")
    b1 = BPMNProfile_BPMNMessage()
    b2 = BPMNProfile_BPMNMessage()
    _safe_set(a, 'BPMNProfile_ReceiveTask', b1)
    assert _is_linked(a, 'BPMNProfile_ReceiveTask', b1)
    if hasattr(b1, 'BPMNProfile_BPMNMessage650'):
        assert _is_linked(b1, 'BPMNProfile_BPMNMessage650', a)
    _safe_set(a, 'BPMNProfile_ReceiveTask', b2)
    assert _is_linked(a, 'BPMNProfile_ReceiveTask', b2)
    if hasattr(b1, 'BPMNProfile_BPMNMessage650'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNMessage650', a)
    if hasattr(b2, 'BPMNProfile_BPMNMessage650'):
        assert _is_linked(b2, 'BPMNProfile_BPMNMessage650', a)
    _safe_set(a, 'BPMNProfile_ReceiveTask', None)
    assert not _is_linked(a, 'BPMNProfile_ReceiveTask', b2)
    if hasattr(b2, 'BPMNProfile_BPMNMessage650'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNMessage650', a)


def test_assoc_monitoring145_link_reassign_clear():
    a = BPMNProfile_BPMNProcess(isClosed="sample_text", isExecutable="sample_text", processType="sample_text")
    b1 = BPMNProfile_Monitoring()
    b2 = BPMNProfile_Monitoring()
    _safe_set(a, 'BPMNProfile_BPMNProcess146', b1)
    assert _is_linked(a, 'BPMNProfile_BPMNProcess146', b1)
    if hasattr(b1, 'BPMNProfile_Monitoring147'):
        assert _is_linked(b1, 'BPMNProfile_Monitoring147', a)
    _safe_set(a, 'BPMNProfile_BPMNProcess146', b2)
    assert _is_linked(a, 'BPMNProfile_BPMNProcess146', b2)
    if hasattr(b1, 'BPMNProfile_Monitoring147'):
        assert not _is_linked(b1, 'BPMNProfile_Monitoring147', a)
    if hasattr(b2, 'BPMNProfile_Monitoring147'):
        assert _is_linked(b2, 'BPMNProfile_Monitoring147', a)
    _safe_set(a, 'BPMNProfile_BPMNProcess146', None)
    assert not _is_linked(a, 'BPMNProfile_BPMNProcess146', b2)
    if hasattr(b2, 'BPMNProfile_Monitoring147'):
        assert not _is_linked(b2, 'BPMNProfile_Monitoring147', a)


def test_assoc_noneBehaviorEventRef684_link_reassign_clear():
    a = BPMNProfile_MultiInstanceLoopCharacteristics(behavior="sample_text", isSequential="sample_text")
    b1 = BPMNProfile_EventDefinition()
    b2 = BPMNProfile_EventDefinition()
    _safe_set(a, 'BPMNProfile_MultiInstanceLoopCharacteristics685', b1)
    assert _is_linked(a, 'BPMNProfile_MultiInstanceLoopCharacteristics685', b1)
    if hasattr(b1, 'BPMNProfile_EventDefinition686'):
        assert _is_linked(b1, 'BPMNProfile_EventDefinition686', a)
    _safe_set(a, 'BPMNProfile_MultiInstanceLoopCharacteristics685', b2)
    assert _is_linked(a, 'BPMNProfile_MultiInstanceLoopCharacteristics685', b2)
    if hasattr(b1, 'BPMNProfile_EventDefinition686'):
        assert not _is_linked(b1, 'BPMNProfile_EventDefinition686', a)
    if hasattr(b2, 'BPMNProfile_EventDefinition686'):
        assert _is_linked(b2, 'BPMNProfile_EventDefinition686', a)
    _safe_set(a, 'BPMNProfile_MultiInstanceLoopCharacteristics685', None)
    assert not _is_linked(a, 'BPMNProfile_MultiInstanceLoopCharacteristics685', b2)
    if hasattr(b2, 'BPMNProfile_EventDefinition686'):
        assert not _is_linked(b2, 'BPMNProfile_EventDefinition686', a)


def test_assoc_oneBehaviorEventRef681_link_reassign_clear():
    a = BPMNProfile_MultiInstanceLoopCharacteristics(behavior="sample_text", isSequential="sample_text")
    b1 = BPMNProfile_EventDefinition()
    b2 = BPMNProfile_EventDefinition()
    ...
    if hasattr(b1, 'BPMNProfile_EventDefinition683'):
        assert _is_linked(b1, 'BPMNProfile_EventDefinition683', a)
    ...
    if hasattr(b1, 'BPMNProfile_EventDefinition683'):
        assert not _is_linked(b1, 'BPMNProfile_EventDefinition683', a)
    if hasattr(b2, 'BPMNProfile_EventDefinition683'):
        assert _is_linked(b2, 'BPMNProfile_EventDefinition683', a)
    _safe_set(a, 'BPMNProfile_MultiInstanceLoopCharacteristics682', None)
    assert not _is_linked(a, 'BPMNProfile_MultiInstanceLoopCharacteristics682', b2)
    if hasattr(b2, 'BPMNProfile_EventDefinition683'):
        assert not _is_linked(b2, 'BPMNProfile_EventDefinition683', a)


def test_assoc_operationRef264_link_reassign_clear():
    a = BPMNProfile_BPMNOperation()
    b1 = BPMNProfile_InputOutputBinding()
    b2 = BPMNProfile_InputOutputBinding()
    _safe_set(a, 'BPMNProfile_BPMNOperation266', b1)
    assert _is_linked(a, 'BPMNProfile_BPMNOperation266', b1)
    if hasattr(b1, 'BPMNProfile_InputOutputBinding265'):
        assert _is_linked(b1, 'BPMNProfile_InputOutputBinding265', a)
    _safe_set(a, 'BPMNProfile_BPMNOperation266', b2)
    assert _is_linked(a, 'BPMNProfile_BPMNOperation266', b2)
    if hasattr(b1, 'BPMNProfile_InputOutputBinding265'):
        assert not _is_linked(b1, 'BPMNProfile_InputOutputBinding265', a)
    if hasattr(b2, 'BPMNProfile_InputOutputBinding265'):
        assert _is_linked(b2, 'BPMNProfile_InputOutputBinding265', a)
    _safe_set(a, 'BPMNProfile_BPMNOperation266', None)
    assert not _is_linked(a, 'BPMNProfile_BPMNOperation266', b2)
    if hasattr(b2, 'BPMNProfile_InputOutputBinding265'):
        assert not _is_linked(b2, 'BPMNProfile_InputOutputBinding265', a)


def test_assoc_operationRef539_link_reassign_clear():
    a = BPMNProfile_BPMNOperation()
    b1 = BPMNProfile_MessageEventDefinition()
    b2 = BPMNProfile_MessageEventDefinition()
    _safe_set(a, 'BPMNProfile_BPMNOperation541', b1)
    assert _is_linked(a, 'BPMNProfile_BPMNOperation541', b1)
    if hasattr(b1, 'BPMNProfile_MessageEventDefinition540'):
        assert _is_linked(b1, 'BPMNProfile_MessageEventDefinition540', a)
    _safe_set(a, 'BPMNProfile_BPMNOperation541', b2)
    assert _is_linked(a, 'BPMNProfile_BPMNOperation541', b2)
    if hasattr(b1, 'BPMNProfile_MessageEventDefinition540'):
        assert not _is_linked(b1, 'BPMNProfile_MessageEventDefinition540', a)
    if hasattr(b2, 'BPMNProfile_MessageEventDefinition540'):
        assert _is_linked(b2, 'BPMNProfile_MessageEventDefinition540', a)
    _safe_set(a, 'BPMNProfile_BPMNOperation541', None)
    assert not _is_linked(a, 'BPMNProfile_BPMNOperation541', b2)
    if hasattr(b2, 'BPMNProfile_MessageEventDefinition540'):
        assert not _is_linked(b2, 'BPMNProfile_MessageEventDefinition540', a)


def test_assoc_operationRef642_link_reassign_clear():
    a = BPMNProfile_SendTask(implementation="sample_text")
    b1 = BPMNProfile_BPMNOperation()
    b2 = BPMNProfile_BPMNOperation()
    _safe_set(a, 'BPMNProfile_SendTask643', b1)
    assert _is_linked(a, 'BPMNProfile_SendTask643', b1)
    if hasattr(b1, 'BPMNProfile_BPMNOperation644'):
        assert _is_linked(b1, 'BPMNProfile_BPMNOperation644', a)
    _safe_set(a, 'BPMNProfile_SendTask643', b2)
    assert _is_linked(a, 'BPMNProfile_SendTask643', b2)
    if hasattr(b1, 'BPMNProfile_BPMNOperation644'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNOperation644', a)
    if hasattr(b2, 'BPMNProfile_BPMNOperation644'):
        assert _is_linked(b2, 'BPMNProfile_BPMNOperation644', a)
    _safe_set(a, 'BPMNProfile_SendTask643', None)
    assert not _is_linked(a, 'BPMNProfile_SendTask643', b2)
    if hasattr(b2, 'BPMNProfile_BPMNOperation644'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNOperation644', a)


def test_assoc_operationRef654_link_reassign_clear():
    a = BPMNProfile_ReceiveTask(implementation="sample_text", instantiate="sample_text")
    b1 = BPMNProfile_BPMNOperation()
    b2 = BPMNProfile_BPMNOperation()
    _safe_set(a, 'BPMNProfile_ReceiveTask655', b1)
    assert _is_linked(a, 'BPMNProfile_ReceiveTask655', b1)
    if hasattr(b1, 'BPMNProfile_BPMNOperation656'):
        assert _is_linked(b1, 'BPMNProfile_BPMNOperation656', a)
    _safe_set(a, 'BPMNProfile_ReceiveTask655', b2)
    assert _is_linked(a, 'BPMNProfile_ReceiveTask655', b2)
    if hasattr(b1, 'BPMNProfile_BPMNOperation656'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNOperation656', a)
    if hasattr(b2, 'BPMNProfile_BPMNOperation656'):
        assert _is_linked(b2, 'BPMNProfile_BPMNOperation656', a)
    _safe_set(a, 'BPMNProfile_ReceiveTask655', None)
    assert not _is_linked(a, 'BPMNProfile_ReceiveTask655', b2)
    if hasattr(b2, 'BPMNProfile_BPMNOperation656'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNOperation656', a)


def test_assoc_operationRef659_link_reassign_clear():
    a = BPMNProfile_ServiceTask(implementation="sample_text")
    b1 = BPMNProfile_BPMNOperation()
    b2 = BPMNProfile_BPMNOperation()
    _safe_set(a, 'BPMNProfile_ServiceTask660', b1)
    assert _is_linked(a, 'BPMNProfile_ServiceTask660', b1)
    if hasattr(b1, 'BPMNProfile_BPMNOperation661'):
        assert _is_linked(b1, 'BPMNProfile_BPMNOperation661', a)
    _safe_set(a, 'BPMNProfile_ServiceTask660', b2)
    assert _is_linked(a, 'BPMNProfile_ServiceTask660', b2)
    if hasattr(b1, 'BPMNProfile_BPMNOperation661'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNOperation661', a)
    if hasattr(b2, 'BPMNProfile_BPMNOperation661'):
        assert _is_linked(b2, 'BPMNProfile_BPMNOperation661', a)
    _safe_set(a, 'BPMNProfile_ServiceTask660', None)
    assert not _is_linked(a, 'BPMNProfile_ServiceTask660', b2)
    if hasattr(b2, 'BPMNProfile_BPMNOperation661'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNOperation661', a)


def test_assoc_operations238_link_reassign_clear():
    a = BPMNProfile_BPMNOperation()
    b1 = BPMNProfile_BPMNInterface()
    b2 = BPMNProfile_BPMNInterface()
    _safe_set(a, 'BPMNProfile_BPMNOperation', b1)
    assert _is_linked(a, 'BPMNProfile_BPMNOperation', b1)
    if hasattr(b1, 'BPMNProfile_BPMNInterface239'):
        assert _is_linked(b1, 'BPMNProfile_BPMNInterface239', a)
    _safe_set(a, 'BPMNProfile_BPMNOperation', b2)
    assert _is_linked(a, 'BPMNProfile_BPMNOperation', b2)
    if hasattr(b1, 'BPMNProfile_BPMNInterface239'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNInterface239', a)
    if hasattr(b2, 'BPMNProfile_BPMNInterface239'):
        assert _is_linked(b2, 'BPMNProfile_BPMNInterface239', a)
    _safe_set(a, 'BPMNProfile_BPMNOperation', None)
    assert not _is_linked(a, 'BPMNProfile_BPMNOperation', b2)
    if hasattr(b2, 'BPMNProfile_BPMNInterface239'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNInterface239', a)


def test_assoc_optionalInputRefs203_link_reassign_clear():
    a = BPMNProfile_InputSet()
    b1 = BPMNProfile_DataInput(isCollection="sample_text")
    b2 = BPMNProfile_DataInput(isCollection="sample_text_2")
...
def test_assoc_optionalOutputRefs226_link_reassign_clear():
    a = BPMNProfile_OutputSet()
    b1 = BPMNProfile_DataOutput(isCollection="sample_text")
    b2 = BPMNProfile_DataOutput(isCollection="sample_text_2")
    _safe_set(a, 'BPMNProfile_OutputSet227', {b1})
    assert _is_linked(a, 'BPMNProfile_OutputSet227', b1)
    if hasattr(b1, 'BPMNProfile_DataOutput228'):
        assert _is_linked(b1, 'BPMNProfile_DataOutput228', a)
    _safe_set(a, 'BPMNProfile_OutputSet227', {b2})
    assert _is_linked(a, 'BPMNProfile_OutputSet227', b2)
    if hasattr(b1, 'BPMNProfile_DataOutput228'):
        assert not _is_linked(b1, 'BPMNProfile_DataOutput228', a)
    if hasattr(b2, 'BPMNProfile_DataOutput228'):
        assert _is_linked(b2, 'BPMNProfile_DataOutput228', a)
    _safe_set(a, 'BPMNProfile_OutputSet227', set())
    assert not _is_linked(a, 'BPMNProfile_OutputSet227', b2)
    if hasattr(b2, 'BPMNProfile_DataOutput228'):
        assert not _is_linked(b2, 'BPMNProfile_DataOutput228', a)


def test_assoc_outMessageRef250_link_reassign_clear():
    a = BPMNProfile_BPMNOperation()
    b1 = BPMNProfile_BPMNMessage()
    b2 = BPMNProfile_BPMNMessage()
    _safe_set(a, 'BPMNProfile_BPMNOperation251', b1)
    assert _is_linked(a, 'BPMNProfile_BPMNOperation251', b1)
    if hasattr(b1, 'BPMNProfile_BPMNMessage252'):
        assert _is_linked(b1, 'BPMNProfile_BPMNMessage252', a)
    _safe_set(a, 'BPMNProfile_BPMNOperation251', b2)
    assert _is_linked(a, 'BPMNProfile_BPMNOperation251', b2)
    if hasattr(b1, 'BPMNProfile_BPMNMessage252'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNMessage252', a)
    if hasattr(b2, 'BPMNProfile_BPMNMessage252'):
        assert _is_linked(b2, 'BPMNProfile_BPMNMessage252', a)
    _safe_set(a, 'BPMNProfile_BPMNOperation251', None)
    assert not _is_linked(a, 'BPMNProfile_BPMNOperation251', b2)
    if hasattr(b2, 'BPMNProfile_BPMNMessage252'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNMessage252', a)


def test_assoc_outerMessageFlowRef336_link_reassign_clear():
    a = BPMNProfile_MessageFlowAssociation()
    b1 = BPMNProfile_MessageFlow()
    b2 = BPMNProfile_MessageFlow()
    _safe_set(a, 'BPMNProfile_MessageFlowAssociation337', b1)
    assert _is_linked(a, 'BPMNProfile_MessageFlowAssociation337', b1)
    if hasattr(b1, 'BPMNProfile_MessageFlow338'):
        assert _is_linked(b1, 'BPMNProfile_MessageFlow338', a)
    _safe_set(a, 'BPMNProfile_MessageFlowAssociation337', b2)
    assert _is_linked(a, 'BPMNProfile_MessageFlowAssociation337', b2)
    if hasattr(b1, 'BPMNProfile_MessageFlow338'):
        assert not _is_linked(b1, 'BPMNProfile_MessageFlow338', a)
    if hasattr(b2, 'BPMNProfile_MessageFlow338'):
        assert _is_linked(b2, 'BPMNProfile_MessageFlow338', a)
    _safe_set(a, 'BPMNProfile_MessageFlowAssociation337', None)
    assert not _is_linked(a, 'BPMNProfile_MessageFlowAssociation337', b2)
    if hasattr(b2, 'BPMNProfile_MessageFlow338'):
        assert not _is_linked(b2, 'BPMNProfile_MessageFlow338', a)


def test_assoc_outerParticipantRef291_link_reassign_clear():
    a = BPMNProfile_ParticipantAssociation()
    b1 = BPMNProfile_Participant()
    b2 = BPMNProfile_Participant()
    _safe_set(a, 'BPMNProfile_ParticipantAssociation292', b1)
    assert _is_linked(a, 'BPMNProfile_ParticipantAssociation292', b1)
    if hasattr(b1, 'BPMNProfile_Participant293'):
        assert _is_linked(b1, 'BPMNProfile_Participant293', a)
    _safe_set(a, 'BPMNProfile_ParticipantAssociation292', b2)
    assert _is_linked(a, 'BPMNProfile_ParticipantAssociation292', b2)
    if hasattr(b1, 'BPMNProfile_Participant293'):
        assert not _is_linked(b1, 'BPMNProfile_Participant293', a)
    if hasattr(b2, 'BPMNProfile_Participant293'):
        assert _is_linked(b2, 'BPMNProfile_Participant293', a)
    _safe_set(a, 'BPMNProfile_ParticipantAssociation292', None)
    assert not _is_linked(a, 'BPMNProfile_ParticipantAssociation292', b2)
    if hasattr(b2, 'BPMNProfile_Participant293'):
        assert not _is_linked(b2, 'BPMNProfile_Participant293', a)
...
def test_assoc_outputDataItem675_link_reassign_clear():
    a = BPMNProfile_MultiInstanceLoopCharacteristics(behavior="sample_text", isSequential="sample_text")
    b1 = BPMNProfile_DataOutput(isCollection="sample_text")
    b2 = BPMNProfile_DataOutput(isCollection="sample_text_2")
    ...
    if hasattr(b1, 'BPMNProfile_DataOutput677'):
        assert _is_linked(b1, 'BPMNProfile_DataOutput677', a)
    ...
    if hasattr(b1, 'BPMNProfile_DataOutput677'):
        assert not _is_linked(b1, 'BPMNProfile_DataOutput677', a)
    if hasattr(b2, 'BPMNProfile_DataOutput677'):
        assert _is_linked(b2, 'BPMNProfile_DataOutput677', a)
    ...
    if hasattr(b2, 'BPMNProfile_DataOutput677'):
        assert not _is_linked(b2, 'BPMNProfile_DataOutput677', a)


def test_assoc_outputDataRef261_link_reassign_clear():
    a = BPMNProfile_OutputSet()
    b1 = BPMNProfile_InputOutputBinding()
    b2 = BPMNProfile_InputOutputBinding()
    _safe_set(a, 'BPMNProfile_OutputSet263', b1)
    assert _is_linked(a, 'BPMNProfile_OutputSet263', b1)
    if hasattr(b1, 'BPMNProfile_InputOutputBinding262'):
        assert _is_linked(b1, 'BPMNProfile_InputOutputBinding262', a)
    _safe_set(a, 'BPMNProfile_OutputSet263', b2)
    assert _is_linked(a, 'BPMNProfile_OutputSet263', b2)
    if hasattr(b1, 'BPMNProfile_InputOutputBinding262'):
        assert not _is_linked(b1, 'BPMNProfile_InputOutputBinding262', a)
    if hasattr(b2, 'BPMNProfile_InputOutputBinding262'):
        assert _is_linked(b2, 'BPMNProfile_InputOutputBinding262', a)
    _safe_set(a, 'BPMNProfile_OutputSet263', None)
    assert not _is_linked(a, 'BPMNProfile_OutputSet263', b2)
    if hasattr(b2, 'BPMNProfile_InputOutputBinding262'):
        assert not _is_linked(b2, 'BPMNProfile_InputOutputBinding262', a)


def test_assoc_outputSetRefs216_link_reassign_clear():
    a = BPMNProfile_OutputSet()
    b1 = BPMNProfile_DataOutput(isCollection="sample_text")
    b2 = BPMNProfile_DataOutput(isCollection="sample_text_2")
...
def test_assoc_outputSetWithOptional217_link_reassign_clear():
    a = BPMNProfile_OutputSet()
    b1 = BPMNProfile_DataOutput(isCollection="sample_text")
    b2 = BPMNProfile_DataOutput(isCollection="sample_text_2")
    _safe_set(a, 'BPMNProfile_OutputSet219', b1)
    assert _is_linked(a, 'BPMNProfile_OutputSet219', b1)
    if hasattr(b1, 'BPMNProfile_DataOutput218'):
        assert _is_linked(b1, 'BPMNProfile_DataOutput218', a)
    _safe_set(a, 'BPMNProfile_OutputSet219', b2)
    assert _is_linked(a, 'BPMNProfile_OutputSet219', b2)
    if hasattr(b1, 'BPMNProfile_DataOutput218'):
        assert not _is_linked(b1, 'BPMNProfile_DataOutput218', a)
    if hasattr(b2, 'BPMNProfile_DataOutput218'):
        assert _is_linked(b2, 'BPMNProfile_DataOutput218', a)
    _safe_set(a, 'BPMNProfile_OutputSet219', None)
    assert not _is_linked(a, 'BPMNProfile_OutputSet219', b2)
    if hasattr(b2, 'BPMNProfile_DataOutput218'):
        assert not _is_linked(b2, 'BPMNProfile_DataOutput218', a)


def test_assoc_outputSetWithWhileExecuting220_link_reassign_clear():
    a = BPMNProfile_OutputSet()
    b1 = BPMNProfile_DataOutput(isCollection="sample_text")
    b2 = BPMNProfile_DataOutput(isCollection="sample_text_2")
    _safe_set(a, 'BPMNProfile_OutputSet222', b1)
    assert _is_linked(a, 'BPMNProfile_OutputSet222', b1)
    if hasattr(b1, 'BPMNProfile_DataOutput221'):
        assert _is_linked(b1, 'BPMNProfile_DataOutput221', a)
    _safe_set(a, 'BPMNProfile_OutputSet222', b2)
    assert _is_linked(a, 'BPMNProfile_OutputSet222', b2)
    if hasattr(b1, 'BPMNProfile_DataOutput221'):
        assert not _is_linked(b1, 'BPMNProfile_DataOutput221', a)
    if hasattr(b2, 'BPMNProfile_DataOutput221'):
        assert _is_linked(b2, 'BPMNProfile_DataOutput221', a)
    _safe_set(a, 'BPMNProfile_OutputSet222', None)
    assert not _is_linked(a, 'BPMNProfile_OutputSet222', b2)
    if hasattr(b2, 'BPMNProfile_DataOutput221'):
        assert not _is_linked(b2, 'BPMNProfile_DataOutput221', a)


def test_assoc_outputSets172_link_reassign_clear():
    a = BPMNProfile_OutputSet()
    b1 = BPMNProfile_InputOutputSpecification()
    b2 = BPMNProfile_InputOutputSpecification()
    _safe_set(a, 'BPMNProfile_OutputSet', b1)
    assert _is_linked(a, 'BPMNProfile_OutputSet', b1)
    if hasattr(b1, 'BPMNProfile_InputOutputSpecification173'):
        assert _is_linked(b1, 'BPMNProfile_InputOutputSpecification173', a)
    _safe_set(a, 'BPMNProfile_OutputSet', b2)
    assert _is_linked(a, 'BPMNProfile_OutputSet', b2)
    if hasattr(b1, 'BPMNProfile_InputOutputSpecification173'):
        assert not _is_linked(b1, 'BPMNProfile_InputOutputSpecification173', a)
    if hasattr(b2, 'BPMNProfile_InputOutputSpecification173'):
        assert _is_linked(b2, 'BPMNProfile_InputOutputSpecification173', a)
    _safe_set(a, 'BPMNProfile_OutputSet', None)
    assert not _is_linked(a, 'BPMNProfile_OutputSet', b2)
    if hasattr(b2, 'BPMNProfile_InputOutputSpecification173'):
        assert not _is_linked(b2, 'BPMNProfile_InputOutputSpecification173', a)


def test_assoc_parameterRef431_link_reassign_clear():
    a = BPMNProfile_ResourceParameterBinding()
    b1 = BPMNProfile_ResourceParameter(isRequired="sample_text")
    b2 = BPMNProfile_ResourceParameter(isRequired="sample_text_2")
    _safe_set(a, 'BPMNProfile_ResourceParameterBinding432', b1)
    assert _is_linked(a, 'BPMNProfile_ResourceParameterBinding432', b1)
    if hasattr(b1, 'BPMNProfile_ResourceParameter433'):
        assert _is_linked(b1, 'BPMNProfile_ResourceParameter433', a)
    _safe_set(a, 'BPMNProfile_ResourceParameterBinding432', b2)
    assert _is_linked(a, 'BPMNProfile_ResourceParameterBinding432', b2)
    if hasattr(b1, 'BPMNProfile_ResourceParameter433'):
        assert not _is_linked(b1, 'BPMNProfile_ResourceParameter433', a)
    if hasattr(b2, 'BPMNProfile_ResourceParameter433'):
        assert _is_linked(b2, 'BPMNProfile_ResourceParameter433', a)
    _safe_set(a, 'BPMNProfile_ResourceParameterBinding432', None)
    assert not _is_linked(a, 'BPMNProfile_ResourceParameterBinding432', b2)
    if hasattr(b2, 'BPMNProfile_ResourceParameter433'):
        assert not _is_linked(b2, 'BPMNProfile_ResourceParameter433', a)
...
def test_assoc_participantAssociations270_link_reassign_clear():
    a = BPMNProfile_ParticipantAssociation()
    b1 = BPMNProfile_BPMNCollaboration(isClosed="sample_text")
    b2 = BPMNProfile_BPMNCollaboration(isClosed="sample_text_2")
    _safe_set(a, 'BPMNProfile_ParticipantAssociation', b1)
    assert _is_linked(a, 'BPMNProfile_ParticipantAssociation', b1)
    if hasattr(b1, 'BPMNProfile_BPMNCollaboration271'):
        assert _is_linked(b1, 'BPMNProfile_BPMNCollaboration271', a)
    _safe_set(a, 'BPMNProfile_ParticipantAssociation', b2)
    assert _is_linked(a, 'BPMNProfile_ParticipantAssociation', b2)
    if hasattr(b1, 'BPMNProfile_BPMNCollaboration271'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNCollaboration271', a)
    if hasattr(b2, 'BPMNProfile_BPMNCollaboration271'):
        assert _is_linked(b2, 'BPMNProfile_BPMNCollaboration271', a)
    _safe_set(a, 'BPMNProfile_ParticipantAssociation', None)
    assert not _is_linked(a, 'BPMNProfile_ParticipantAssociation', b2)
    if hasattr(b2, 'BPMNProfile_BPMNCollaboration271'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNCollaboration271', a)


def test_assoc_participantAssociations612_link_reassign_clear():
    a = BPMNProfile_ParticipantAssociation()
    b1 = BPMNProfile_CallConversation()
    b2 = BPMNProfile_CallConversation()
    _safe_set(a, 'BPMNProfile_ParticipantAssociation614', b1)
    assert _is_linked(a, 'BPMNProfile_ParticipantAssociation614', b1)
    if hasattr(b1, 'BPMNProfile_CallConversation613'):
        assert _is_linked(b1, 'BPMNProfile_CallConversation613', a)
    _safe_set(a, 'BPMNProfile_ParticipantAssociation614', b2)
    assert _is_linked(a, 'BPMNProfile_ParticipantAssociation614', b2)
    if hasattr(b1, 'BPMNProfile_CallConversation613'):
        assert not _is_linked(b1, 'BPMNProfile_CallConversation613', a)
    if hasattr(b2, 'BPMNProfile_CallConversation613'):
        assert _is_linked(b2, 'BPMNProfile_CallConversation613', a)
    _safe_set(a, 'BPMNProfile_ParticipantAssociation614', None)
    assert not _is_linked(a, 'BPMNProfile_ParticipantAssociation614', b2)
    if hasattr(b2, 'BPMNProfile_CallConversation613'):
        assert not _is_linked(b2, 'BPMNProfile_CallConversation613', a)


def test_assoc_participantMultiplicity300_link_reassign_clear():
    a = BPMNProfile_ParticipantMultiplicity(maximum="sample_text", minimum="sample_text")
    b1 = BPMNProfile_Participant()
    b2 = BPMNProfile_Participant()
    _safe_set(a, 'BPMNProfile_ParticipantMultiplicity', b1)
    assert _is_linked(a, 'BPMNProfile_ParticipantMultiplicity', b1)
    if hasattr(b1, 'BPMNProfile_Participant301'):
        assert _is_linked(b1, 'BPMNProfile_Participant301', a)
    _safe_set(a, 'BPMNProfile_ParticipantMultiplicity', b2)
    assert _is_linked(a, 'BPMNProfile_ParticipantMultiplicity', b2)
    if hasattr(b1, 'BPMNProfile_Participant301'):
        assert not _is_linked(b1, 'BPMNProfile_Participant301', a)
    if hasattr(b2, 'BPMNProfile_Participant301'):
        assert _is_linked(b2, 'BPMNProfile_Participant301', a)
    _safe_set(a, 'BPMNProfile_ParticipantMultiplicity', None)
    assert not _is_linked(a, 'BPMNProfile_ParticipantMultiplicity', b2)
    if hasattr(b2, 'BPMNProfile_Participant301'):
        assert not _is_linked(b2, 'BPMNProfile_Participant301', a)


def test_assoc_participantRef325_link_reassign_clear():
    a = BPMNProfile_PartnerEntity()
    b1 = BPMNProfile_Participant()
    b2 = BPMNProfile_Participant()
...
def test_assoc_participantRef328_link_reassign_clear():
    a = BPMNProfile_PartnerRole()
    b1 = BPMNProfile_Participant()
    b2 = BPMNProfile_Participant()
    _safe_set(a, 'partnerRoleRef', {b1})
    assert _is_linked(a, 'partnerRoleRef', b1)
    if hasattr(b1, 'Participant329'):
        assert _is_linked(b1, 'Participant329', a)
    _safe_set(a, 'partnerRoleRef', {b2})
    assert _is_linked(a, 'partnerRoleRef', b2)
    if hasattr(b1, 'Participant329'):
        assert not _is_linked(b1, 'Participant329', a)
    if hasattr(b2, 'Participant329'):
        assert _is_linked(b2, 'Participant329', a)
    _safe_set(a, 'partnerRoleRef', set())
    assert not _is_linked(a, 'partnerRoleRef', b2)
    if hasattr(b2, 'Participant329'):
        assert not _is_linked(b2, 'Participant329', a)


def test_assoc_participantRefs359_link_reassign_clear():
    a = BPMNProfile_Participant()
    b1 = BPMNProfile_ConversationNode()
    b2 = BPMNProfile_ConversationNode()
    _safe_set(a, 'BPMNProfile_Participant361', b1)
    assert _is_linked(a, 'BPMNProfile_Participant361', b1)
    if hasattr(b1, 'BPMNProfile_ConversationNode360'):
        assert _is_linked(b1, 'BPMNProfile_ConversationNode360', a)
    _safe_set(a, 'BPMNProfile_Participant361', b2)
    assert _is_linked(a, 'BPMNProfile_Participant361', b2)
    if hasattr(b1, 'BPMNProfile_ConversationNode360'):
        assert not _is_linked(b1, 'BPMNProfile_ConversationNode360', a)
    if hasattr(b2, 'BPMNProfile_ConversationNode360'):
        assert _is_linked(b2, 'BPMNProfile_ConversationNode360', a)
    _safe_set(a, 'BPMNProfile_Participant361', None)
    assert not _is_linked(a, 'BPMNProfile_Participant361', b2)
    if hasattr(b2, 'BPMNProfile_ConversationNode360'):
        assert not _is_linked(b2, 'BPMNProfile_ConversationNode360', a)


def test_assoc_participants283_link_reassign_clear():
    a = BPMNProfile_Participant()
    b1 = BPMNProfile_BPMNCollaboration(isClosed="sample_text")
    b2 = BPMNProfile_BPMNCollaboration(isClosed="sample_text_2")
    _safe_set(a, 'BPMNProfile_Participant', b1)
    assert _is_linked(a, 'BPMNProfile_Participant', b1)
    if hasattr(b1, 'BPMNProfile_BPMNCollaboration284'):
        assert _is_linked(b1, 'BPMNProfile_BPMNCollaboration284', a)
    _safe_set(a, 'BPMNProfile_Participant', b2)
    assert _is_linked(a, 'BPMNProfile_Participant', b2)
    if hasattr(b1, 'BPMNProfile_BPMNCollaboration284'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNCollaboration284', a)
    if hasattr(b2, 'BPMNProfile_BPMNCollaboration284'):
        assert _is_linked(b2, 'BPMNProfile_BPMNCollaboration284', a)
    _safe_set(a, 'BPMNProfile_Participant', None)
    assert not _is_linked(a, 'BPMNProfile_Participant', b2)
    if hasattr(b2, 'BPMNProfile_BPMNCollaboration284'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNCollaboration284', a)
...
def test_assoc_partnerEntityRef302_link_reassign_clear():
    a = BPMNProfile_PartnerEntity()
    b1 = BPMNProfile_Participant()
    b2 = BPMNProfile_Participant()
...
def test_assoc_partnerRoleRef303_link_reassign_clear():
    a = BPMNProfile_PartnerRole()
    b1 = BPMNProfile_Participant()
    b2 = BPMNProfile_Participant()
    _safe_set(a, 'PartnerRole', b1)
    assert _is_linked(a, 'PartnerRole', b1)
    if hasattr(b1, 'participantRef304'):
        assert _is_linked(b1, 'participantRef304', a)
    _safe_set(a, 'PartnerRole', b2)
    assert _is_linked(a, 'PartnerRole', b2)
    if hasattr(b1, 'participantRef304'):
        assert not _is_linked(b1, 'participantRef304', a)
    if hasattr(b2, 'participantRef304'):
        assert _is_linked(b2, 'participantRef304', a)
    _safe_set(a, 'PartnerRole', None)
    assert not _is_linked(a, 'PartnerRole', b2)
    if hasattr(b2, 'participantRef304'):
        assert not _is_linked(b2, 'participantRef304', a)


def test_assoc_process416_link_reassign_clear():
    a = BPMNProfile_ResourceRole()
...
def test_assoc_processRef297_link_reassign_clear():
    a = BPMNProfile_Participant()
    b1 = BPMNProfile_BPMNProcess(isClosed="sample_text", isExecutable="sample_text", processType="sample_text")
    b2 = BPMNProfile_BPMNProcess(isClosed="sample_text_2", isExecutable="sample_text_2", processType="sample_text_2")
    _safe_set(a, 'BPMNProfile_Participant298', b1)
    assert _is_linked(a, 'BPMNProfile_Participant298', b1)
    if hasattr(b1, 'BPMNProfile_BPMNProcess299'):
        assert _is_linked(b1, 'BPMNProfile_BPMNProcess299', a)
    _safe_set(a, 'BPMNProfile_Participant298', b2)
    assert _is_linked(a, 'BPMNProfile_Participant298', b2)
    if hasattr(b1, 'BPMNProfile_BPMNProcess299'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNProcess299', a)
    if hasattr(b2, 'BPMNProfile_BPMNProcess299'):
        assert _is_linked(b2, 'BPMNProfile_BPMNProcess299', a)
    _safe_set(a, 'BPMNProfile_Participant298', None)
    assert not _is_linked(a, 'BPMNProfile_Participant298', b2)
    if hasattr(b2, 'BPMNProfile_BPMNProcess299'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNProcess299', a)


def test_assoc_properties151_link_reassign_clear():
    a = BPMNProfile_BPMNProperty()
    b1 = BPMNProfile_BPMNProcess(isClosed="sample_text", isExecutable="sample_text", processType="sample_text")
    b2 = BPMNProfile_BPMNProcess(isClosed="sample_text_2", isExecutable="sample_text_2", processType="sample_text_2")
    _safe_set(a, 'BPMNProfile_BPMNProperty', b1)
    assert _is_linked(a, 'BPMNProfile_BPMNProperty', b1)
    if hasattr(b1, 'BPMNProfile_BPMNProcess152'):
        assert _is_linked(b1, 'BPMNProfile_BPMNProcess152', a)
    _safe_set(a, 'BPMNProfile_BPMNProperty', b2)
    assert _is_linked(a, 'BPMNProfile_BPMNProperty', b2)
    if hasattr(b1, 'BPMNProfile_BPMNProcess152'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNProcess152', a)
    if hasattr(b2, 'BPMNProfile_BPMNProcess152'):
        assert _is_linked(b2, 'BPMNProfile_BPMNProcess152', a)
    _safe_set(a, 'BPMNProfile_BPMNProperty', None)
    assert not _is_linked(a, 'BPMNProfile_BPMNProperty', b2)
    if hasattr(b2, 'BPMNProfile_BPMNProcess152'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNProcess152', a)


def test_assoc_properties451_link_reassign_clear():
    a = BPMNProfile_BPMNProperty()
    b1 = BPMNProfile_BPMNActivity(completionQuantity="sample_text", isForCompensation="sample_text", startQuantity="sample_text")
    b2 = BPMNProfile_BPMNActivity(completionQuantity="sample_text_2", isForCompensation="sample_text_2", startQuantity="sample_text_2")
    _safe_set(a, 'BPMNProfile_BPMNProperty453', b1)
    assert _is_linked(a, 'BPMNProfile_BPMNProperty453', b1)
    if hasattr(b1, 'BPMNProfile_BPMNActivity452'):
        assert _is_linked(b1, 'BPMNProfile_BPMNActivity452', a)
    _safe_set(a, 'BPMNProfile_BPMNProperty453', b2)
    assert _is_linked(a, 'BPMNProfile_BPMNProperty453', b2)
    if hasattr(b1, 'BPMNProfile_BPMNActivity452'):
    ...
    _safe_set(a, 'BPMNProfile_BPMNProperty453', None)
    assert not _is_linked(a, 'BPMNProfile_BPMNProperty453', b2)
    if hasattr(b2, 'BPMNProfile_BPMNActivity452'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNActivity452', a)


def test_assoc_properties482_link_reassign_clear():
    a = BPMNProfile_BPMNProperty()
    b1 = BPMNProfile_BPMNEvent()
    b2 = BPMNProfile_BPMNEvent()
    _safe_set(a, 'BPMNProfile_BPMNProperty484', b1)
    assert _is_linked(a, 'BPMNProfile_BPMNProperty484', b1)
    if hasattr(b1, 'BPMNProfile_BPMNEvent483'):
        assert _is_linked(b1, 'BPMNProfile_BPMNEvent483', a)
    _safe_set(a, 'BPMNProfile_BPMNProperty484', b2)
    assert _is_linked(a, 'BPMNProfile_BPMNProperty484', b2)
    if hasattr(b1, 'BPMNProfile_BPMNEvent483'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNEvent483', a)
    if hasattr(b2, 'BPMNProfile_BPMNEvent483'):
        assert _is_linked(b2, 'BPMNProfile_BPMNEvent483', a)
    _safe_set(a, 'BPMNProfile_BPMNProperty484', None)
    assert not _is_linked(a, 'BPMNProfile_BPMNProperty484', b2)
    if hasattr(b2, 'BPMNProfile_BPMNEvent483'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNEvent483', a)


def test_assoc_relationships112_link_reassign_clear():
    a = BPMNProfile_Definitions(exporter="sample_text", exporterVersion="sample_text", expressionLanguage="sample_text", targetNamespace="sample_text", typeLanguage="sample_text")
    b1 = BPMNProfile_BPMNRelationship(direction="sample_text", type="sample_text")
    b2 = BPMNProfile_BPMNRelationship(direction="sample_text_2", type="sample_text_2")
    _safe_set(a, 'BPMNProfile_Definitions113', {b1})
    assert _is_linked(a, 'BPMNProfile_Definitions113', b1)
    if hasattr(b1, 'BPMNProfile_BPMNRelationship'):
        assert _is_linked(b1, 'BPMNProfile_BPMNRelationship', a)
    _safe_set(a, 'BPMNProfile_Definitions113', {b2})
    assert _is_linked(a, 'BPMNProfile_Definitions113', b2)
    if hasattr(b1, 'BPMNProfile_BPMNRelationship'):
    ...
    _safe_set(a, 'BPMNProfile_Definitions113', set())
    assert not _is_linked(a, 'BPMNProfile_Definitions113', b2)
    if hasattr(b2, 'BPMNProfile_BPMNRelationship'):
...
def test_assoc_renderings596_link_reassign_clear():
    ...
    _safe_set(a, 'BPMNProfile_UserTask597', {b1})
    assert _is_linked(a, 'BPMNProfile_UserTask597', b1)
    if hasattr(b1, 'BPMNProfile_Rendering'):
        assert _is_linked(b1, 'BPMNProfile_Rendering', a)
    _safe_set(a, 'BPMNProfile_UserTask597', {b2})
    assert _is_linked(a, 'BPMNProfile_UserTask597', b2)
    if hasattr(b1, 'BPMNProfile_Rendering'):
    ...
    _safe_set(a, 'BPMNProfile_UserTask597', set())
    assert not _is_linked(a, 'BPMNProfile_UserTask597', b2)
    if hasattr(b2, 'BPMNProfile_Rendering'):
        assert not _is_linked(b2, 'BPMNProfile_Rendering', a)


def test_assoc_renderings602_link_reassign_clear():
    ...
    if hasattr(b1, 'BPMNProfile_Rendering603'):
        assert _is_linked(b1, 'BPMNProfile_Rendering603', a)
    _safe_set(a, 'BPMNProfile_GlobalUserTask', {b2})
    assert _is_linked(a, 'BPMNProfile_GlobalUserTask', b2)
    if hasattr(b1, 'BPMNProfile_Rendering603'):
        assert not _is_linked(b1, 'BPMNProfile_Rendering603', a)
    if hasattr(b2, 'BPMNProfile_Rendering603'):
        assert _is_linked(b2, 'BPMNProfile_Rendering603', a)
    _safe_set(a, 'BPMNProfile_GlobalUserTask', set())
    assert not _is_linked(a, 'BPMNProfile_GlobalUserTask', b2)
    if hasattr(b2, 'BPMNProfile_Rendering603'):
        assert not _is_linked(b2, 'BPMNProfile_Rendering603', a)


def test_assoc_resourceAssignmentExpression410_link_reassign_clear():
    a = BPMNProfile_ResourceRole()
    b1 = BPMNProfile_ResourceAssignmentExpression()
    b2 = BPMNProfile_ResourceAssignmentExpression()
    _safe_set(a, 'BPMNProfile_ResourceRole411', b1)
    assert _is_linked(a, 'BPMNProfile_ResourceRole411', b1)
    if hasattr(b1, 'BPMNProfile_ResourceAssignmentExpression'):
        assert _is_linked(b1, 'BPMNProfile_ResourceAssignmentExpression', a)
    _safe_set(a, 'BPMNProfile_ResourceRole411', b2)
    assert _is_linked(a, 'BPMNProfile_ResourceRole411', b2)
    if hasattr(b1, 'BPMNProfile_ResourceAssignmentExpression'):
    ...
    _safe_set(a, 'BPMNProfile_ResourceRole411', None)
    assert not _is_linked(a, 'BPMNProfile_ResourceRole411', b2)
    if hasattr(b2, 'BPMNProfile_ResourceAssignmentExpression'):
        assert not _is_linked(b2, 'BPMNProfile_ResourceAssignmentExpression', a)


def test_assoc_resourceParameterBindings414_link_reassign_clear():
    a = BPMNProfile_ResourceRole()
    b1 = BPMNProfile_ResourceParameterBinding()
    b2 = BPMNProfile_ResourceParameterBinding()
    _safe_set(a, 'BPMNProfile_ResourceRole415', {b1})
    assert _is_linked(a, 'BPMNProfile_ResourceRole415', b1)
    if hasattr(b1, 'BPMNProfile_ResourceParameterBinding'):
        assert _is_linked(b1, 'BPMNProfile_ResourceParameterBinding', a)
    _safe_set(a, 'BPMNProfile_ResourceRole415', {b2})
    assert _is_linked(a, 'BPMNProfile_ResourceRole415', b2)
    if hasattr(b1, 'BPMNProfile_ResourceParameterBinding'):
    ...
    _safe_set(a, 'BPMNProfile_ResourceRole415', set())
    assert not _is_linked(a, 'BPMNProfile_ResourceRole415', b2)
    if hasattr(b2, 'BPMNProfile_ResourceParameterBinding'):
        assert not _is_linked(b2, 'BPMNProfile_ResourceParameterBinding', a)


def test_assoc_resourceParameters420_link_reassign_clear():
    a = BPMNProfile_ResourceParameter(isRequired="sample_text")
    ...
    if hasattr(b1, 'BPMNProfile_Resource421'):
        assert _is_linked(b1, 'BPMNProfile_Resource421', a)
    _safe_set(a, 'BPMNProfile_ResourceParameter', b2)
    assert _is_linked(a, 'BPMNProfile_ResourceParameter', b2)
    if hasattr(b1, 'BPMNProfile_Resource421'):
        assert not _is_linked(b1, 'BPMNProfile_Resource421', a)
    if hasattr(b2, 'BPMNProfile_Resource421'):
        assert _is_linked(b2, 'BPMNProfile_Resource421', a)
    _safe_set(a, 'BPMNProfile_ResourceParameter', None)
    assert not _is_linked(a, 'BPMNProfile_ResourceParameter', b2)
    if hasattr(b2, 'BPMNProfile_Resource421'):
        assert not _is_linked(b2, 'BPMNProfile_Resource421', a)


def test_assoc_resourceRef412_link_reassign_clear():
    a = BPMNProfile_ResourceRole()
    b1 = BPMNProfile_Resource()
    b2 = BPMNProfile_Resource()
    _safe_set(a, 'BPMNProfile_ResourceRole413', b1)
    assert _is_linked(a, 'BPMNProfile_ResourceRole413', b1)
    if hasattr(b1, 'BPMNProfile_Resource'):
        assert _is_linked(b1, 'BPMNProfile_Resource', a)
    _safe_set(a, 'BPMNProfile_ResourceRole413', b2)
    assert _is_linked(a, 'BPMNProfile_ResourceRole413', b2)
    if hasattr(b1, 'BPMNProfile_Resource'):
    ...
    _safe_set(a, 'BPMNProfile_ResourceRole413', None)
    assert not _is_linked(a, 'BPMNProfile_ResourceRole413', b2)
    if hasattr(b2, 'BPMNProfile_Resource'):
        assert not _is_linked(b2, 'BPMNProfile_Resource', a)


def test_assoc_resources153_link_reassign_clear():
    a = BPMNProfile_ResourceRole()
    b1 = BPMNProfile_BPMNProcess(isClosed="sample_text", isExecutable="sample_text", processType="sample_text")
    b2 = BPMNProfile_BPMNProcess(isClosed="sample_text_2", isExecutable="sample_text_2", processType="sample_text_2")
...
def test_assoc_resources438_link_reassign_clear():
    a = BPMNProfile_ResourceRole()
    b1 = BPMNProfile_GlobalTask()
    b2 = BPMNProfile_GlobalTask()
    _safe_set(a, 'BPMNProfile_ResourceRole440', b1)
    assert _is_linked(a, 'BPMNProfile_ResourceRole440', b1)
    if hasattr(b1, 'BPMNProfile_GlobalTask439'):
        assert _is_linked(b1, 'BPMNProfile_GlobalTask439', a)
    _safe_set(a, 'BPMNProfile_ResourceRole440', b2)
    assert _is_linked(a, 'BPMNProfile_ResourceRole440', b2)
    if hasattr(b1, 'BPMNProfile_GlobalTask439'):
        assert not _is_linked(b1, 'BPMNProfile_GlobalTask439', a)
    if hasattr(b2, 'BPMNProfile_GlobalTask439'):
        assert _is_linked(b2, 'BPMNProfile_GlobalTask439', a)
    _safe_set(a, 'BPMNProfile_ResourceRole440', None)
    assert not _is_linked(a, 'BPMNProfile_ResourceRole440', b2)
    if hasattr(b2, 'BPMNProfile_GlobalTask439'):
        assert not _is_linked(b2, 'BPMNProfile_GlobalTask439', a)


def test_assoc_resources465_link_reassign_clear():
    a = BPMNProfile_ResourceRole()
    b1 = BPMNProfile_BPMNActivity(completionQuantity="sample_text", isForCompensation="sample_text", startQuantity="sample_text")
    b2 = BPMNProfile_BPMNActivity(completionQuantity="sample_text_2", isForCompensation="sample_text_2", startQuantity="sample_text_2")
    _safe_set(a, 'BPMNProfile_ResourceRole467', b1)
    assert _is_linked(a, 'BPMNProfile_ResourceRole467', b1)
    if hasattr(b1, 'BPMNProfile_BPMNActivity466'):
        assert _is_linked(b1, 'BPMNProfile_BPMNActivity466', a)
    _safe_set(a, 'BPMNProfile_ResourceRole467', b2)
    assert _is_linked(a, 'BPMNProfile_ResourceRole467', b2)
    if hasattr(b1, 'BPMNProfile_BPMNActivity466'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNActivity466', a)
    if hasattr(b2, 'BPMNProfile_BPMNActivity466'):
        assert _is_linked(b2, 'BPMNProfile_BPMNActivity466', a)
    _safe_set(a, 'BPMNProfile_ResourceRole467', None)
    assert not _is_linked(a, 'BPMNProfile_ResourceRole467', b2)
    if hasattr(b2, 'BPMNProfile_BPMNActivity466'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNActivity466', a)


def test_assoc_rootElements114_link_reassign_clear():
    a = BPMNProfile_Definitions(exporter="sample_text", exporterVersion="sample_text", expressionLanguage="sample_text", targetNamespace="sample_text", typeLanguage="sample_text")
    b1 = BPMNProfile_RootElement()
    b2 = BPMNProfile_RootElement()
...
def test_assoc_signalRef526_link_reassign_clear():
...
def test_assoc_sourceRef341_link_reassign_clear():
    a = BPMNProfile_MessageFlow()
    ...
    if hasattr(b1, 'BPMNProfile_InteractionNode343'):
        assert _is_linked(b1, 'BPMNProfile_InteractionNode343', a)
    _safe_set(a, 'BPMNProfile_MessageFlow342', b2)
    assert _is_linked(a, 'BPMNProfile_MessageFlow342', b2)
    if hasattr(b1, 'BPMNProfile_InteractionNode343'):
        assert not _is_linked(b1, 'BPMNProfile_InteractionNode343', a)
    if hasattr(b2, 'BPMNProfile_InteractionNode343'):
        assert _is_linked(b2, 'BPMNProfile_InteractionNode343', a)
    _safe_set(a, 'BPMNProfile_MessageFlow342', None)
    assert not _is_linked(a, 'BPMNProfile_MessageFlow342', b2)
    if hasattr(b2, 'BPMNProfile_InteractionNode343'):
        assert not _is_linked(b2, 'BPMNProfile_InteractionNode343', a)
...
def test_assoc_sourceRef489_link_reassign_clear():
    a = BPMNProfile_ItemAwareElement()
    b1 = BPMNProfile_DataAssociation()
    b2 = BPMNProfile_DataAssociation()
    _safe_set(a, 'BPMNProfile_ItemAwareElement491', b1)
    assert _is_linked(a, 'BPMNProfile_ItemAwareElement491', b1)
    if hasattr(b1, 'BPMNProfile_DataAssociation490'):
        assert _is_linked(b1, 'BPMNProfile_DataAssociation490', a)
    _safe_set(a, 'BPMNProfile_ItemAwareElement491', b2)
    assert _is_linked(a, 'BPMNProfile_ItemAwareElement491', b2)
    if hasattr(b1, 'BPMNProfile_DataAssociation490'):
    ...
    _safe_set(a, 'BPMNProfile_ItemAwareElement491', None)
    assert not _is_linked(a, 'BPMNProfile_ItemAwareElement491', b2)
    if hasattr(b2, 'BPMNProfile_DataAssociation490'):
        assert not _is_linked(b2, 'BPMNProfile_DataAssociation490', a)


def test_assoc_sourceRef80_link_reassign_clear():
    a = BPMNProfile_SequenceFlow(isImmediate="sample_text")
    b1 = BPMNProfile_FlowNode()
    b2 = BPMNProfile_FlowNode()
    _safe_set(a, 'BPMNProfile_SequenceFlow81', b1)
    assert _is_linked(a, 'BPMNProfile_SequenceFlow81', b1)
    if hasattr(b1, 'BPMNProfile_FlowNode82'):
        assert _is_linked(b1, 'BPMNProfile_FlowNode82', a)
    _safe_set(a, 'BPMNProfile_SequenceFlow81', b2)
    assert _is_linked(a, 'BPMNProfile_SequenceFlow81', b2)
    if hasattr(b1, 'BPMNProfile_FlowNode82'):
        assert not _is_linked(b1, 'BPMNProfile_FlowNode82', a)
    if hasattr(b2, 'BPMNProfile_FlowNode82'):
        assert _is_linked(b2, 'BPMNProfile_FlowNode82', a)
    _safe_set(a, 'BPMNProfile_SequenceFlow81', None)
    assert not _is_linked(a, 'BPMNProfile_SequenceFlow81', b2)
    if hasattr(b2, 'BPMNProfile_FlowNode82'):
        assert not _is_linked(b2, 'BPMNProfile_FlowNode82', a)


def test_assoc_sources131_link_reassign_clear():
    a = BPMNProfile_BPMNRelationship(direction="sample_text", type="sample_text")
    b1 = BPMNProfile_Element()
    b2 = BPMNProfile_Element()
    _safe_set(a, 'BPMNProfile_BPMNRelationship132', {b1})
    assert _is_linked(a, 'BPMNProfile_BPMNRelationship132', b1)
    if hasattr(b1, 'BPMNProfile_Element133'):
        assert _is_linked(b1, 'BPMNProfile_Element133', a)
    _safe_set(a, 'BPMNProfile_BPMNRelationship132', {b2})
    assert _is_linked(a, 'BPMNProfile_BPMNRelationship132', b2)
    if hasattr(b1, 'BPMNProfile_Element133'):
        assert not _is_linked(b1, 'BPMNProfile_Element133', a)
    if hasattr(b2, 'BPMNProfile_Element133'):
        assert _is_linked(b2, 'BPMNProfile_Element133', a)
    _safe_set(a, 'BPMNProfile_BPMNRelationship132', set())
    assert not _is_linked(a, 'BPMNProfile_BPMNRelationship132', b2)
    if hasattr(b2, 'BPMNProfile_Element133'):
        assert not _is_linked(b2, 'BPMNProfile_Element133', a)


def test_assoc_structureRef195_link_reassign_clear():
    a = BPMNProfile_ItemDefinition(isCollection="sample_text", itemKind="sample_text")
    b1 = BPMNProfile_Element()
    b2 = BPMNProfile_Element()
    _safe_set(a, 'BPMNProfile_ItemDefinition196', b1)
    assert _is_linked(a, 'BPMNProfile_ItemDefinition196', b1)
    if hasattr(b1, 'BPMNProfile_Element197'):
        assert _is_linked(b1, 'BPMNProfile_Element197', a)
    _safe_set(a, 'BPMNProfile_ItemDefinition196', b2)
    assert _is_linked(a, 'BPMNProfile_ItemDefinition196', b2)
    if hasattr(b1, 'BPMNProfile_Element197'):
        assert not _is_linked(b1, 'BPMNProfile_Element197', a)
    if hasattr(b2, 'BPMNProfile_Element197'):
        assert _is_linked(b2, 'BPMNProfile_Element197', a)
    _safe_set(a, 'BPMNProfile_ItemDefinition196', None)
    assert not _is_linked(a, 'BPMNProfile_ItemDefinition196', b2)
    if hasattr(b2, 'BPMNProfile_Element197'):
        assert not _is_linked(b2, 'BPMNProfile_Element197', a)


def test_assoc_supportedInterfaceRefs157_link_reassign_clear():
    a = BPMNProfile_CallableElement()
    b1 = BPMNProfile_BPMNInterface()
    b2 = BPMNProfile_BPMNInterface()
    _safe_set(a, 'BPMNProfile_CallableElement158', {b1})
    assert _is_linked(a, 'BPMNProfile_CallableElement158', b1)
    if hasattr(b1, 'BPMNProfile_BPMNInterface'):
        assert _is_linked(b1, 'BPMNProfile_BPMNInterface', a)
    _safe_set(a, 'BPMNProfile_CallableElement158', {b2})
    assert _is_linked(a, 'BPMNProfile_CallableElement158', b2)
    if hasattr(b1, 'BPMNProfile_BPMNInterface'):
    ...
    _safe_set(a, 'BPMNProfile_CallableElement158', set())
    assert not _is_linked(a, 'BPMNProfile_CallableElement158', b2)
    if hasattr(b2, 'BPMNProfile_BPMNInterface'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNInterface', a)


def test_assoc_supports149_link_reassign_clear():
    a = BPMNProfile_BPMNProcess(isClosed="sample_text", isExecutable="sample_text", processType="sample_text")
    b1 = BPMNProfile_BPMNProcess(isClosed="sample_text", isExecutable="sample_text", processType="sample_text")
    b2 = BPMNProfile_BPMNProcess(isClosed="sample_text_2", isExecutable="sample_text_2", processType="sample_text_2")
    _safe_set(a, 'BPMNProfile_BPMNProcess148', b1)
    assert _is_linked(a, 'BPMNProfile_BPMNProcess148', b1)
    if hasattr(b1, 'BPMNProfile_BPMNProcess150'):
        assert _is_linked(b1, 'BPMNProfile_BPMNProcess150', a)
    _safe_set(a, 'BPMNProfile_BPMNProcess148', b2)
    assert _is_linked(a, 'BPMNProfile_BPMNProcess148', b2)
    if hasattr(b1, 'BPMNProfile_BPMNProcess150'):
        assert not _is_linked(b1, 'BPMNProfile_BPMNProcess150', a)
    if hasattr(b2, 'BPMNProfile_BPMNProcess150'):
        assert _is_linked(b2, 'BPMNProfile_BPMNProcess150', a)
    _safe_set(a, 'BPMNProfile_BPMNProcess148', None)
    assert not _is_linked(a, 'BPMNProfile_BPMNProcess148', b2)
    if hasattr(b2, 'BPMNProfile_BPMNProcess150'):
        assert not _is_linked(b2, 'BPMNProfile_BPMNProcess150', a)


def test_assoc_targetRef344_link_reassign_clear():
    a = BPMNProfile_MessageFlow()
    b1 = BPMNProfile_InteractionNode()
    b2 = BPMNProfile_InteractionNode()
    _safe_set(a, 'BPMNProfile_MessageFlow345', b1)
    assert _is_linked(a, 'BPMNProfile_MessageFlow345', b1)
    if hasattr(b1, 'BPMNProfile_InteractionNode346'):
        assert _is_linked(b1, 'BPMNProfile_InteractionNode346', a)
    _safe_set(a, 'BPMNProfile_MessageFlow345', b2)
    assert _is_linked(a, 'BPMNProfile_MessageFlow345', b2)
    if hasattr(b1, 'BPMNProfile_InteractionNode346'):
        assert not _is_linked(b1, 'BPMNProfile_InteractionNode346', a)
    if hasattr(b2, 'BPMNProfile_InteractionNode346'):
        assert _is_linked(b2, 'BPMNProfile_InteractionNode346', a)
    _safe_set(a, 'BPMNProfile_MessageFlow345', None)
    assert not _is_linked(a, 'BPMNProfile_MessageFlow345', b2)
    if hasattr(b2, 'BPMNProfile_InteractionNode346'):
        assert not _is_linked(b2, 'BPMNProfile_InteractionNode346', a)
...
def test_assoc_targetRef492_link_reassign_clear():
    a = BPMNProfile_ItemAwareElement()
    b1 = BPMNProfile_DataAssociation()
    b2 = BPMNProfile_DataAssociation()
    _safe_set(a, 'BPMNProfile_ItemAwareElement494', b1)
    assert _is_linked(a, 'BPMNProfile_ItemAwareElement494', b1)
    if hasattr(b1, 'BPMNProfile_DataAssociation493'):
        assert _is_linked(b1, 'BPMNProfile_DataAssociation493', a)
    _safe_set(a, 'BPMNProfile_ItemAwareElement494', b2)
    assert _is_linked(a, 'BPMNProfile_ItemAwareElement494', b2)
    if hasattr(b1, 'BPMNProfile_DataAssociation493'):
        assert not _is_linked(b1, 'BPMNProfile_DataAssociation493', a)
    if hasattr(b2, 'BPMNProfile_DataAssociation493'):
        assert _is_linked(b2, 'BPMNProfile_DataAssociation493', a)
    _safe_set(a, 'BPMNProfile_ItemAwareElement494', None)
    assert not _is_linked(a, 'BPMNProfile_ItemAwareElement494', b2)
    if hasattr(b2, 'BPMNProfile_DataAssociation493'):
        assert not _is_linked(b2, 'BPMNProfile_DataAssociation493', a)


def test_assoc_targetRef83_link_reassign_clear():
    a = BPMNProfile_SequenceFlow(isImmediate="sample_text")
    b1 = BPMNProfile_FlowNode()
    b2 = BPMNProfile_FlowNode()
    _safe_set(a, 'BPMNProfile_SequenceFlow84', b1)
    assert _is_linked(a, 'BPMNProfile_SequenceFlow84', b1)
    if hasattr(b1, 'BPMNProfile_FlowNode85'):
        assert _is_linked(b1, 'BPMNProfile_FlowNode85', a)
    _safe_set(a, 'BPMNProfile_SequenceFlow84', b2)
    assert _is_linked(a, 'BPMNProfile_SequenceFlow84', b2)
    if hasattr(b1, 'BPMNProfile_FlowNode85'):
        assert not _is_linked(b1, 'BPMNProfile_FlowNode85', a)
    if hasattr(b2, 'BPMNProfile_FlowNode85'):
        assert _is_linked(b2, 'BPMNProfile_FlowNode85', a)
    _safe_set(a, 'BPMNProfile_SequenceFlow84', None)
    assert not _is_linked(a, 'BPMNProfile_SequenceFlow84', b2)
    if hasattr(b2, 'BPMNProfile_FlowNode85'):
        assert not _is_linked(b2, 'BPMNProfile_FlowNode85', a)


def test_assoc_targets128_link_reassign_clear():
    a = BPMNProfile_BPMNRelationship(direction="sample_text", type="sample_text")
    b1 = BPMNProfile_Element()
    b2 = BPMNProfile_Element()
    _safe_set(a, 'BPMNProfile_BPMNRelationship129', {b1})
    assert _is_linked(a, 'BPMNProfile_BPMNRelationship129', b1)
    if hasattr(b1, 'BPMNProfile_Element130'):
        assert _is_linked(b1, 'BPMNProfile_Element130', a)
    _safe_set(a, 'BPMNProfile_BPMNRelationship129', {b2})
    assert _is_linked(a, 'BPMNProfile_BPMNRelationship129', b2)
    if hasattr(b1, 'BPMNProfile_Element130'):
        assert not _is_linked(b1, 'BPMNProfile_Element130', a)
    if hasattr(b2, 'BPMNProfile_Element130'):
        assert _is_linked(b2, 'BPMNProfile_Element130', a)
    _safe_set(a, 'BPMNProfile_BPMNRelationship129', set())
    assert not _is_linked(a, 'BPMNProfile_BPMNRelationship129', b2)
    if hasattr(b2, 'BPMNProfile_Element130'):
        assert not _is_linked(b2, 'BPMNProfile_Element130', a)


def test_assoc_transformation495_link_reassign_clear():
    a = BPMNProfile_FormalExpression()
    b1 = BPMNProfile_DataAssociation()
    b2 = BPMNProfile_DataAssociation()
    _safe_set(a, 'BPMNProfile_FormalExpression497', b1)
    assert _is_linked(a, 'BPMNProfile_FormalExpression497', b1)
    if hasattr(b1, 'BPMNProfile_DataAssociation496'):
        assert _is_linked(b1, 'BPMNProfile_DataAssociation496', a)
    _safe_set(a, 'BPMNProfile_FormalExpression497', b2)
    assert _is_linked(a, 'BPMNProfile_FormalExpression497', b2)
    if hasattr(b1, 'BPMNProfile_DataAssociation496'):
        assert not _is_linked(b1, 'BPMNProfile_DataAssociation496', a)
    if hasattr(b2, 'BPMNProfile_DataAssociation496'):
        assert _is_linked(b2, 'BPMNProfile_DataAssociation496', a)
    _safe_set(a, 'BPMNProfile_FormalExpression497', None)
    assert not _is_linked(a, 'BPMNProfile_FormalExpression497', b2)
    if hasattr(b2, 'BPMNProfile_DataAssociation496'):
        assert not _is_linked(b2, 'BPMNProfile_DataAssociation496', a)


def test_assoc_type370_link_reassign_clear():
    a = BPMNProfile_ItemDefinition(isCollection="sample_text", itemKind="sample_text")
    b1 = BPMNProfile_CorrelationProperty()
    b2 = BPMNProfile_CorrelationProperty()
    _safe_set(a, 'BPMNProfile_ItemDefinition372', b1)
    assert _is_linked(a, 'BPMNProfile_ItemDefinition372', b1)
    if hasattr(b1, 'BPMNProfile_CorrelationProperty371'):
        assert _is_linked(b1, 'BPMNProfile_CorrelationProperty371', a)
    _safe_set(a, 'BPMNProfile_ItemDefinition372', b2)
    assert _is_linked(a, 'BPMNProfile_ItemDefinition372', b2)
    if hasattr(b1, 'BPMNProfile_CorrelationProperty371'):
        assert not _is_linked(b1, 'BPMNProfile_CorrelationProperty371', a)
    if hasattr(b2, 'BPMNProfile_CorrelationProperty371'):
        assert _is_linked(b2, 'BPMNProfile_CorrelationProperty371', a)
    _safe_set(a, 'BPMNProfile_ItemDefinition372', None)
    assert not _is_linked(a, 'BPMNProfile_ItemDefinition372', b2)
    if hasattr(b2, 'BPMNProfile_CorrelationProperty371'):
        assert not _is_linked(b2, 'BPMNProfile_CorrelationProperty371', a)


def test_assoc_type425_link_reassign_clear():
    a = BPMNProfile_ResourceParameter(isRequired="sample_text")
    ...
    _safe_set(a, 'BPMNProfile_ResourceParameter426', b1)
    assert _is_linked(a, 'BPMNProfile_ResourceParameter426', b1)
    if hasattr(b1, 'BPMNProfile_ItemDefinition427'):
        assert _is_linked(b1, 'BPMNProfile_ItemDefinition427', a)
    _safe_set(a, 'BPMNProfile_ResourceParameter426', b2)
    assert _is_linked(a, 'BPMNProfile_ResourceParameter426', b2)
    if hasattr(b1, 'BPMNProfile_ItemDefinition427'):
        assert not _is_linked(b1, 'BPMNProfile_ItemDefinition427', a)
    if hasattr(b2, 'BPMNProfile_ItemDefinition427'):
        assert _is_linked(b2, 'BPMNProfile_ItemDefinition427', a)
    _safe_set(a, 'BPMNProfile_ResourceParameter426', None)
    assert not _is_linked(a, 'BPMNProfile_ResourceParameter426', b2)
    if hasattr(b2, 'BPMNProfile_ItemDefinition427'):
        assert not _is_linked(b2, 'BPMNProfile_ItemDefinition427', a)


def test_assoc_umlProperty405_link_reassign_clear():
    a = BPMNProfile_BPMNProperty()
    b1 = BPMNProfile_Property()
    b2 = BPMNProfile_Property()
    _safe_set(a, 'BPMNProfile_BPMNProperty406', b1)
    assert _is_linked(a, 'BPMNProfile_BPMNProperty406', b1)
    if hasattr(b1, 'BPMNProfile_Property407'):
        assert _is_linked(b1, 'BPMNProfile_Property407', a)
    _safe_set(a, 'BPMNProfile_BPMNProperty406', b2)
    assert _is_linked(a, 'BPMNProfile_BPMNProperty406', b2)
    if hasattr(b1, 'BPMNProfile_Property407'):
        assert not _is_linked(b1, 'BPMNProfile_Property407', a)
    if hasattr(b2, 'BPMNProfile_Property407'):
        assert _is_linked(b2, 'BPMNProfile_Property407', a)
    _safe_set(a, 'BPMNProfile_BPMNProperty406', None)
    assert not _is_linked(a, 'BPMNProfile_BPMNProperty406', b2)
    if hasattr(b2, 'BPMNProfile_Property407'):
        assert not _is_linked(b2, 'BPMNProfile_Property407', a)


def test_assoc_whileExecutingInputRefs204_link_reassign_clear():
    a = BPMNProfile_InputSet()
    b1 = BPMNProfile_DataInput(isCollection="sample_text")
    b2 = BPMNProfile_DataInput(isCollection="sample_text_2")
    _safe_set(a, 'inputSetWithWhileExecuting', {b1})
    assert _is_linked(a, 'inputSetWithWhileExecuting', b1)
    if hasattr(b1, 'DataInput205'):
        assert _is_linked(b1, 'DataInput205', a)
    _safe_set(a, 'inputSetWithWhileExecuting', {b2})
    assert _is_linked(a, 'inputSetWithWhileExecuting', b2)
    if hasattr(b1, 'DataInput205'):
        assert not _is_linked(b1, 'DataInput205', a)
    if hasattr(b2, 'DataInput205'):
        assert _is_linked(b2, 'DataInput205', a)
    _safe_set(a, 'inputSetWithWhileExecuting', set())
    assert not _is_linked(a, 'inputSetWithWhileExecuting', b2)
    if hasattr(b2, 'DataInput205'):
        assert not _is_linked(b2, 'DataInput205', a)


def test_assoc_whileExecutingOutputRefs229_link_reassign_clear():
    a = BPMNProfile_OutputSet()
    b1 = BPMNProfile_DataOutput(isCollection="sample_text")
    b2 = BPMNProfile_DataOutput(isCollection="sample_text_2")
    _safe_set(a, 'BPMNProfile_OutputSet230', {b1})
    assert _is_linked(a, 'BPMNProfile_OutputSet230', b1)
    if hasattr(b1, 'BPMNProfile_DataOutput231'):
        assert _is_linked(b1, 'BPMNProfile_DataOutput231', a)
    _safe_set(a, 'BPMNProfile_OutputSet230', {b2})
    assert _is_linked(a, 'BPMNProfile_OutputSet230', b2)
    if hasattr(b1, 'BPMNProfile_DataOutput231'):
        assert not _is_linked(b1, 'BPMNProfile_DataOutput231', a)
    if hasattr(b2, 'BPMNProfile_DataOutput231'):
        assert _is_linked(b2, 'BPMNProfile_DataOutput231', a)
    _safe_set(a, 'BPMNProfile_OutputSet230', set())
    assert not _is_linked(a, 'BPMNProfile_OutputSet230', b2)
    if hasattr(b2, 'BPMNProfile_DataOutput231'):
        assert not _is_linked(b2, 'BPMNProfile_DataOutput231', a)
