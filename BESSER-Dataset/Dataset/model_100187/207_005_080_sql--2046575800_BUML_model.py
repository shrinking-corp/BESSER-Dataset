...
# Classes
sql_common_SQLScript = Class(name="sql_common_SQLScript")
Statement = Class(name="Statement")
sql_Dummy = Class(name="sql_Dummy")
sql_common_Statement = Class(name="sql_common_Statement", is_abstract=True)
sql_common_SchemaQualifiedName = Class(name="sql_common_SchemaQualifiedName")
sql_common_DirectSQLStatement = Class(name="sql_common_DirectSQLStatement", is_abstract=True)
sql_common_Separator = Class(name="sql_common_Separator", is_abstract=True)
sql_common_Comment = Class(name="sql_common_Comment", is_abstract=True)
Separator = Class(name="Separator")
sql_common_SimpleComment = Class(name="sql_common_SimpleComment")
Comment = Class(name="Comment")
sql_common_BracketedComment = Class(name="sql_common_BracketedComment")
sql_literal_NationalCharacterStringLiteral = Class(name="sql_literal_NationalCharacterStringLiteral")
GeneralLiteral = Class(name="GeneralLiteral")
sql_literal_Literal = Class(name="sql_literal_Literal", is_abstract=True)
sql_literal_GeneralLiteral = Class(name="sql_literal_GeneralLiteral", is_abstract=True)
Literal = Class(name="Literal")
sql_literal_CharacterStringLiteral = Class(name="sql_literal_CharacterStringLiteral")
...
sql_literal_ExactNumericLiteral = Class(name="sql_literal_ExactNumericLiteral")
NumericLiteral = Class(name="NumericLiteral")
sql_literal_ApproximateNumericLiteral = Class(name="sql_literal_ApproximateNumericLiteral")
sql_literal_DatetimeLiteral = Class(name="sql_literal_DatetimeLiteral", is_abstract=True)
sql_literal_BooleanLiteral = Class(name="sql_literal_BooleanLiteral")
sql_literal_DateLiteral = Class(name="sql_literal_DateLiteral")
DatetimeLiteral = Class(name="DatetimeLiteral")
sql_literal_TimeLiteral = Class(name="sql_literal_TimeLiteral")
sql_literal_TimestampLiteral = Class(name="sql_literal_TimestampLiteral")
sql_datatype_NationalCharacterStringType = Class(name="sql_datatype_NationalCharacterStringType")
sql_literal_NumericLiteral = Class(name="sql_literal_NumericLiteral", is_abstract=True)
sql_datatype_DataType = Class(name="sql_datatype_DataType", is_abstract=True)
sql_datatype_PredefinedType = Class(name="sql_datatype_PredefinedType", is_abstract=True)
DataType = Class(name="DataType")
sql_datatype_CharacterStringType = Class(name="sql_datatype_CharacterStringType")
PredefinedType = Class(name="PredefinedType")
sql_datatype_BooleanType = Class(name="sql_datatype_BooleanType")
sql_datatype_DatetimeType = Class(name="sql_datatype_DatetimeType", is_abstract=True)
sql_datatype_BinaryLargeObjectStringType = Class(name="sql_datatype_BinaryLargeObjectStringType")
LargeObjectLength = Class(name="LargeObjectLength")
sql_datatype_NumericType = Class(name="sql_datatype_NumericType", is_abstract=True)
sql_datatype_ExactNumericType = Class(name="sql_datatype_ExactNumericType")
NumericType = Class(name="NumericType")
sql_datatype_ApproximateNumericType = Class(name="sql_datatype_ApproximateNumericType")
sql_datatype_LargeObjectLength = Class(name="sql_datatype_LargeObjectLength")
sql_function_DatetimeValueFunction = Class(name="sql_function_DatetimeValueFunction")
sql_datatype_DateType = Class(name="sql_datatype_DateType")
DatetimeType = Class(name="DatetimeType")
sql_datatype_TimeType = Class(name="sql_datatype_TimeType")
sql_datatype_TimestampType = Class(name="sql_datatype_TimestampType")
sql_schema_TableDefinition = Class(name="sql_schema_TableDefinition")
schema_SQLSchemaDefinitionStatement = Class(name="schema_SQLSchemaDefinitionStatement")
EObject = Class(name="EObject")
sql_expression_ImplicitlyTypedValueSpecification = Class(name="sql_expression_ImplicitlyTypedValueSpecification", is_abstract=True)
sql_expression_NullSpecification = Class(name="sql_expression_NullSpecification")
ImplicitlyTypedValueSpecification = Class(name="ImplicitlyTypedValueSpecification")
sql_schema_TableElement = Class(name="sql_schema_TableElement", is_abstract=True)
TableElementList = Class(name="TableElementList")
TableContentsSource = Class(name="TableContentsSource")
sql_schema_TableElementList = Class(name="sql_schema_TableElementList")
TableElement = Class(name="TableElement")
ColumnConstraint = Class(name="ColumnConstraint")
sql_schema_Column = Class(name="sql_schema_Column")
DefaultOption = Class(name="DefaultOption")
sql_schema_ColumnConstraint = Class(name="sql_schema_ColumnConstraint", is_abstract=True)
sql_schema_TableConstraint = Class(name="sql_schema_TableConstraint", is_abstract=True)
schema_TableElement = Class(name="schema_TableElement")
sql_schema_TableContentsSource = Class(name="sql_schema_TableContentsSource", is_abstract=True)
TableDefinition = Class(name="TableDefinition")
sql_schema_DefaultOption = Class(name="sql_schema_DefaultOption", is_abstract=True)
Column = Class(name="Column")
sql_schema_SQLSchemaDefinitionStatement = Class(name="sql_schema_SQLSchemaDefinitionStatement", is_abstract=True)
SQLSchemaStatement = Class(name="SQLSchemaStatement")
sql_schema_LiteralDefaultOption = Class(name="sql_schema_LiteralDefaultOption")
sql_schema_NotNullColumnConstraint = Class(name="sql_schema_NotNullColumnConstraint")
sql_schema_UniqueColumnConstraint = Class(name="sql_schema_UniqueColumnConstraint")
schema_UniqueConstraint = Class(name="schema_UniqueConstraint")
schema_ColumnConstraint = Class(name="schema_ColumnConstraint")
sql_schema_ReferentialColumnConstraint = Class(name="sql_schema_ReferentialColumnConstraint")
schema_ReferentialConstraint = Class(name="schema_ReferentialConstraint")
sql_schema_SQLSchemaStatement = Class(name="sql_schema_SQLSchemaStatement", is_abstract=True)
DirectSQLStatement = Class(name="DirectSQLStatement")
schema_TableColumnsConstraint = Class(name="schema_TableColumnsConstraint")
sql_schema_ReferentialTableConstraint = Class(name="sql_schema_ReferentialTableConstraint")
sql_schema_DatetimeValueFunctionDefaultOption = Class(name="sql_schema_DatetimeValueFunctionDefaultOption")
DatetimeValueFunction = Class(name="DatetimeValueFunction")
sql_schema_ImplicitlyTypedValueSpecificationDefaultOption = Class(name="sql_schema_ImplicitlyTypedValueSpecificationDefaultOption")
sql_schema_UniqueTableConstraint = Class(name="sql_schema_UniqueTableConstraint")
sql_schema_TableColumnsConstraint = Class(name="sql_schema_TableColumnsConstraint", is_abstract=True)
TableConstraint = Class(name="TableConstraint")
sql_schema_UniqueConstraint = Class(name="sql_schema_UniqueConstraint", is_abstract=True)
sql_schema_ReferentialConstraint = Class(name="sql_schema_ReferentialConstraint", is_abstract=True)
TableReference = Class(name="TableReference")
sql_schema_TableReference = Class(name="sql_schema_TableReference")
...
sql_common_SchemaQualifiedName.attributes={sql_common_SchemaQualifiedName_catalogName, sql_common_SchemaQualifiedName_schemaName, sql_common_SchemaQualifiedName_name}
...
sql_datatype_NationalCharacterStringType.attributes={sql_datatype_NationalCharacterStringType_kind, sql_datatype_NationalCharacterStringType_length}
...
sql_datatype_ExactNumericType.attributes={sql_datatype_ExactNumericType_kind, sql_datatype_ExactNumericType_precision, sql_datatype_ExactNumericType_scale}
...
sql_datatype_LargeObjectLength.attributes={sql_datatype_LargeObjectLength_value, sql_datatype_LargeObjectLength_units, sql_datatype_LargeObjectLength_multiplier}
...
sql_datatype_TimeType.attributes={sql_datatype_TimeType_precision, sql_datatype_TimeType_withTimeZone}
...
sql_datatype_TimestampType.attributes={sql_datatype_TimestampType_precision, sql_datatype_TimestampType_withTimeZone}
...
sql_schema_TableDefinition.attributes={sql_schema_TableDefinition_label, sql_schema_TableDefinition_scope}
...
sql_schema_TableReference.attributes={sql_schema_TableReference_schemaName, sql_schema_TableReference_catalogName}
...
owner16: BinaryAssociation = BinaryAssociation(
    name="owner16",
    ends={
        Property(name="TableElementList", type=sql_schema_TableElement, multiplicity=Multiplicity(1, 1)),
        Property(name="elements", type=TableElementList, multiplicity=Multiplicity(1, 1))
    }
)
...
contentsSource13: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="TableContentsSource", type=sql_schema_TableDefinition, multiplicity=Multiplicity(1, 1)),
        Property(name="owner", type=TableContentsSource, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
elements14: BinaryAssociation = BinaryAssociation(
    name="elements14",
    ends={
        Property(name="TableElement", type=sql_schema_TableElementList, multiplicity=Multiplicity(1, 1)),
        Property(name="owner15", type=TableElement, multiplicity=Multiplicity(1, 9999), is_composite=True)
    }
)
constraint20: BinaryAssociation = BinaryAssociation(
    name="constraint20",
    ends={
        Property(name="ColumnConstraint", type=sql_schema_Column, multiplicity=Multiplicity(1, 1)),
        Property(name="owner21", type=ColumnConstraint, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
collationName22: BinaryAssociation = BinaryAssociation(
    name="collationName22",
    ends={
        Property(name="SchemaQualifiedName24", type=sql_schema_Column, multiplicity=Multiplicity(1, 1)),
        Property(name="sql_schema_Column23", type=SchemaQualifiedName, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
...
defaultOption18: BinaryAssociation = BinaryAssociation(
    name="defaultOption18",
    ends={
        Property(name="DefaultOption", type=sql_schema_Column, multiplicity=Multiplicity(1, 1)),
        Property(name="owner19", type=DefaultOption, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
owner29: BinaryAssociation = BinaryAssociation(
    name="owner29",
    ends={
        Property(name="Column30", type=sql_schema_ColumnConstraint, multiplicity=Multiplicity(1, 1)),
        Property(name="constraint", type=Column, multiplicity=Multiplicity(1, 1))
    }
)
schemaQualifiedName25: BinaryAssociation = BinaryAssociation(
    name="schemaQualifiedName25",
    ends={
        Property(name="SchemaQualifiedName26", type=sql_schema_TableConstraint, multiplicity=Multiplicity(1, 1)),
...
owner27: BinaryAssociation = BinaryAssociation(
    name="owner27",
    ends={
        Property(name="TableDefinition", type=sql_schema_TableContentsSource, multiplicity=Multiplicity(1, 1)),
        Property(name="contentsSource", type=TableDefinition, multiplicity=Multiplicity(1, 1))
    }
)
owner28: BinaryAssociation = BinaryAssociation(
    name="owner28",
    ends={
        Property(name="Column", type=sql_schema_DefaultOption, multiplicity=Multiplicity(1, 1)),
        Property(name="defaultOption", type=Column, multiplicity=Multiplicity(1, 1))
    }
)
schemaQualifiedName31: BinaryAssociation = BinaryAssociation(
    name="schemaQualifiedName31",
    ends={
        Property(name="SchemaQualifiedName32", type=sql_schema_ColumnConstraint, multiplicity=Multiplicity(1, 1)),
        Property(name="sql_schema_ColumnConstraint", type=SchemaQualifiedName, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
literal33: BinaryAssociation = BinaryAssociation(
    name="literal33",
    ends={
...
target40: BinaryAssociation = BinaryAssociation(
    name="target40",
    ends={
        Property(name="TableDefinition41", type=sql_schema_TableReference, multiplicity=Multiplicity(1, 1)),
        Property(name="sql_schema_TableReference", type=TableDefinition, multiplicity=Multiplicity(1, 1))
    }
)
referencedColumns36: BinaryAssociation = BinaryAssociation(
    name="referencedColumns36",
    ends={
        Property(name="Column37", type=sql_schema_ReferentialConstraint, multiplicity=Multiplicity(1, 1)),
        Property(name="sql_schema_ReferentialConstraint", type=Column, multiplicity=Multiplicity(0, 9999))
    }
)
referencedTable38: BinaryAssociation = BinaryAssociation(
    name="referencedTable38",
    ends={
        Property(name="TableReference", type=sql_schema_ReferentialConstraint, multiplicity=Multiplicity(1, 1)),
        Property(name="sql_schema_ReferentialConstraint39", type=TableReference, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
columns42: BinaryAssociation = BinaryAssociation(
    name="columns42",
    ends={
        Property(name="Column43", type=sql_schema_TableColumnsConstraint, multiplicity=Multiplicity(1, 1)),
...
domain_model = DomainModel(
    name="sql",
    types={sql_common_SQLScript, Statement, sql_Dummy, sql_common_Statement, sql_common_SchemaQualifiedName, sql_common_DirectSQLStatement, sql_common_Separator, sql_common_Comment, Separator, sql_common_SimpleComment, Comment, sql_common_BracketedComment, sql_literal_NationalCharacterStringLiteral, GeneralLiteral, sql_literal_Literal, sql_literal_GeneralLiteral, Literal, sql_literal_CharacterStringLiteral, NationalCharacterStringLiteral, SchemaQualifiedName, sql_literal_ExactNumericLiteral, NumericLiteral, sql_literal_ApproximateNumericLiteral, sql_literal_DatetimeLiteral, sql_literal_BooleanLiteral, sql_literal_DateLiteral, DatetimeLiteral, sql_literal_TimeLiteral, sql_literal_TimestampLiteral, sql_datatype_NationalCharacterStringType, sql_literal_NumericLiteral, sql_datatype_DataType, sql_datatype_PredefinedType, DataType, sql_datatype_CharacterStringType, PredefinedType, sql_datatype_BooleanType, sql_datatype_DatetimeType, sql_datatype_BinaryLargeObjectStringType, LargeObjectLength, sql_datatype_NumericType, sql_datatype_ExactNumericType, NumericType, sql_datatype_ApproximateNumericType, sql_datatype_LargeObjectLength, sql_function_DatetimeValueFunction, sql_datatype_DateType, DatetimeType, sql_datatype_TimeType, sql_datatype_TimestampType, sql_schema_TableDefinition, schema_SQLSchemaDefinitionStatement, EObject, sql_expression_ImplicitlyTypedValueSpecification, sql_expression_NullSpecification, ImplicitlyTypedValueSpecification, sql_schema_TableElement, TableElementList, TableContentsSource, sql_schema_TableElementList, TableElement, ColumnConstraint, sql_schema_Column, DefaultOption, sql_schema_ColumnConstraint, sql_schema_TableConstraint, schema_TableElement, sql_schema_TableContentsSource, TableDefinition, sql_schema_DefaultOption, Column, sql_schema_SQLSchemaDefinitionStatement, SQLSchemaStatement, sql_schema_LiteralDefaultOption, sql_schema_NotNullColumnConstraint, sql_schema_UniqueColumnConstraint, schema_UniqueConstraint, schema_ColumnConstraint, sql_schema_ReferentialColumnConstraint, schema_ReferentialConstraint, sql_schema_SQLSchemaStatement, DirectSQLStatement, schema_TableColumnsConstraint, sql_schema_ReferentialTableConstraint, sql_schema_DatetimeValueFunctionDefaultOption, DatetimeValueFunction, sql_schema_ImplicitlyTypedValueSpecificationDefaultOption, sql_schema_UniqueTableConstraint, sql_schema_TableColumnsConstraint, TableConstraint, sql_schema_UniqueConstraint, sql_schema_ReferentialConstraint, TableReference, sql_schema_TableReference, CharacterStringTypeKind, ApproximateNumericTypeKind, NationalCharacterStringTypeKind, BinaryLargeObjectStringTypeKind, ExactNumericTypeKind, Multiplier, CharLengthUnits, DatetimeValueFunctionKind, TableScope, UniqueSpecificationKind},
    associations={statements0, separators2, characterSetName1, collationName5, characterSetName3, collationName8, length10, owner16, schemaQualifiedName11, contentsSource13, elements14, constraint20, collationName22, dataType17, defaultOption18, owner29, schemaQualifiedName25, owner27, owner28, schemaQualifiedName31, literal33, function34, specification35, target40, referencedColumns36, referencedTable38, columns42},
    generalizations={gen_sql_common_DirectSQLStatement_Statement, gen_sql_common_Separator_Statement, gen_sql_common_Comment_Separator, gen_sql_common_SimpleComment_Comment, gen_sql_common_BracketedComment_Comment, gen_sql_literal_NationalCharacterStringLiteral_GeneralLiteral, gen_sql_literal_GeneralLiteral_Literal, gen_sql_literal_CharacterStringLiteral_NationalCharacterStringLiteral, gen_sql_literal_ExactNumericLiteral_NumericLiteral, gen_sql_literal_ApproximateNumericLiteral_NumericLiteral, gen_sql_literal_DatetimeLiteral_GeneralLiteral, gen_sql_literal_BooleanLiteral_GeneralLiteral, gen_sql_literal_DateLiteral_DatetimeLiteral, gen_sql_literal_TimeLiteral_DatetimeLiteral, gen_sql_literal_TimestampLiteral_DatetimeLiteral, gen_sql_datatype_NationalCharacterStringType_PredefinedType, gen_sql_literal_NumericLiteral_Literal, gen_sql_datatype_PredefinedType_DataType, gen_sql_datatype_CharacterStringType_PredefinedType, gen_sql_datatype_BooleanType_PredefinedType, gen_sql_datatype_DatetimeType_PredefinedType, gen_sql_datatype_BinaryLargeObjectStringType_PredefinedType, gen_sql_datatype_NumericType_PredefinedType, gen_sql_datatype_ExactNumericType_NumericType, gen_sql_datatype_ApproximateNumericType_NumericType, gen_sql_datatype_DateType_DatetimeType, gen_sql_datatype_TimeType_DatetimeType, gen_sql_datatype_TimestampType_DatetimeType, gen_sql_schema_TableDefinition_schema_SQLSchemaDefinitionStatement, gen_sql_schema_TableDefinition_EObject, gen_sql_expression_NullSpecification_ImplicitlyTypedValueSpecification, gen_sql_schema_TableElementList_TableContentsSource, gen_sql_schema_Column_TableElement, gen_sql_schema_ColumnConstraint_EObject, gen_sql_schema_TableConstraint_schema_TableElement, gen_sql_schema_TableConstraint_EObject, gen_sql_schema_SQLSchemaDefinitionStatement_SQLSchemaStatement, gen_sql_schema_LiteralDefaultOption_DefaultOption, gen_sql_schema_NotNullColumnConstraint_ColumnConstraint, gen_sql_schema_UniqueColumnConstraint_schema_UniqueConstraint, gen_sql_schema_UniqueColumnConstraint_schema_ColumnConstraint, gen_sql_schema_ReferentialColumnConstraint_schema_ReferentialConstraint, gen_sql_schema_ReferentialColumnConstraint_schema_ColumnConstraint, gen_sql_schema_SQLSchemaStatement_DirectSQLStatement, gen_sql_schema_UniqueTableConstraint_schema_TableColumnsConstraint, gen_sql_schema_ReferentialTableConstraint_schema_ReferentialConstraint, gen_sql_schema_ReferentialTableConstraint_schema_TableColumnsConstraint, gen_sql_schema_DatetimeValueFunctionDefaultOption_DefaultOption, gen_sql_schema_ImplicitlyTypedValueSpecificationDefaultOption_DefaultOption, gen_sql_schema_UniqueTableConstraint_schema_UniqueConstraint, gen_sql_schema_TableColumnsConstraint_TableConstraint},
    metadata=None
)
