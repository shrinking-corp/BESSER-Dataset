...
class sm4_Transition:
    ...
    def __init__(self, event: str, Transition: "sm4_State" = None, Transition7: "sm4_State" = None, outgoing: "sm4_State" = None, incoming: "sm4_State" = None, sm4_Transition: "sm4_StateMachine" = None):
        self.event = event
...
class sm4_State:
    ...
    def __init__(self, name: str, states: "sm4_StateMachine" = None, src: set["sm4_Transition"] = None, tgt: set["sm4_Transition"] = None, State9: "sm4_Transition" = None, State11: "sm4_Transition" = None, sm4_State: "sm4_StateMachine" = None, State: "sm4_StateMachine" = None):
        self.name = name
        self.states = states
