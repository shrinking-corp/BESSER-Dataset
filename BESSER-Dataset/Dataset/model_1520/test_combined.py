...
def test_hyp_sm4_transition_is_not_abstract():
    assert not inspect.isabstract(sm4_Transition)


def test_hyp_sm4_transition_constructor_exists():
    assert callable(sm4_Transition.__init__)


def test_hyp_sm4_transition_constructor_args():
...
def test_hyp_sm4_state_is_not_abstract():
    assert not inspect.isabstract(sm4_State)


def test_hyp_sm4_state_constructor_exists():
    assert callable(sm4_State.__init__)


def test_hyp_sm4_state_constructor_args():
...
def test_hyp_sm4_statemachine_is_not_abstract():
    assert not inspect.isabstract(sm4_StateMachine)


def test_hyp_sm4_statemachine_constructor_exists():
    assert callable(sm4_StateMachine.__init__)


def test_hyp_sm4_statemachine_constructor_args():
...
def test_hyp_sm4_transition_event_setter(instance):
...
def test_hyp_sm4_state_name_setter(instance):
