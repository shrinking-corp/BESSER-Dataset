...
public class extlibrary_Library extends Addressable {
    ...
    public extlibrary_Library(
        String name,        String people        ArrayList<extlibrary_Book> extlibrary_books,        ArrayList<extlibrary_Borrower> extlibrary_borrowers,        ArrayList<extlibrary_Writer> extlibrary_writers,        ArrayList<extlibrary_Employee> extlibrary_employees    ) {
        this.name = name;
        this.people = people;
