...
def test_university_Student_id_value_roundtrip():
    instance = university_Student(id="sample_text")
...
def test_assoc_courses1_link_reassign_clear():
    a = university_Student(id="sample_text")
...
def test_assoc_students2_link_reassign_clear():
    a = university_University(name="sample_text")
    b1 = university_Student(id="sample_text")
    b2 = university_Student(id="sample_text_2")
...
university_Student_strategy = st.builds(university_Student, id=safe_text)
