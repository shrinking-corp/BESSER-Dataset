...
class university_Student:
    ...
    def __init__(self, id: str, Student: "university_Course" = None, students: set["university_Course"] = None, university_Student: "university_University" = None):
        self.id = id
...
class university_Course:
    ...
    def __init__(self, name: str, courses: set["university_Student"] = None, Course: "university_Student" = None, university_Course: "university_University" = None):
        self.name = name
