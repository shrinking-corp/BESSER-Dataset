...
class services_ServiceUser(Base):
    ...
    def __init__(self, description: str, name: str, services_ServiceUser56: "services_Expression" = None, services_ServiceUser53: "services_ServiceProfile" = None, services_ServiceUser: "services_Service" = None, services_ServiceUser44: "services_ServiceForecastUsers" = None):
...
class services_ServiceMonitor(Base):
    ...
    def __init__(self, revision: str, name: str, services_ServiceMonitor46: "services_DateTimeRange" = None, services_ServiceMonitor49: set["services_ResourceMonitor"] = None, services_ServiceMonitor: "services_Service" = None):
...
class services_ServiceForecast(Base):
    ...
    def __init__(self, name: str, revision: str, services_ServiceForecast38: set["services_ResourceForecast"] = None, services_ServiceForecast: "services_Service" = None, services_ServiceForecast34: "services_DateTimeRange" = None, services_ServiceForecast36: set["services_ServiceForecastUsers"] = None):
        self.name = name
        self.revision = revision
...
class services_RFSService(Service):
    ...
    def __init__(self, functionalCategory: str, services_RFSService13: set["services_Tolerance"] = None, services_RFSService: set["services_Node"] = None):
