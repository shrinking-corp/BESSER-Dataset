...
Payment.attributes={Payment_ex_date, Payment_card_no, Payment_pay_mode, Payment_pay_amount, Payment_pay_id}
...
Request.attributes={Request_request_type, Request_requser_id, Request_request_id, Request_request_details}
...
Advertiesment.attributes={Advertiesment_advertiser_id, Advertiesment_advertiesment_id, Advertiesment_start_date, Advertiesment_end_date}
...
domain_model = DomainModel(
    name="_2ce97a9d_df35_4dd9_839a_69b91ccbe5a9",
    ...
    associations={Property_Seller, User_Request, Property_Buyer, Reg_User_Requirement, Property_Management, Payment_Reg_User, Payment_Property, User_Administrator, Advertiser_Advertiesment},
    generalizations={},
    metadata=None
)
