...
public class tfsm_plaink3_TimedSystem extends NamedElement {
    ...
    public tfsm_plaink3_TimedSystem(
        ArrayList<tfsm_plaink3_FSMEvent> tfsm_plaink3_fsmevents,        ArrayList<tfsm_plaink3_TFSM> tfsm_plaink3_tfsms,        ArrayList<tfsm_plaink3_FSMClock> tfsm_plaink3_fsmclocks    ) {
