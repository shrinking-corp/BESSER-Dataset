...
class tfsm_plaink3_NamedElement:
...
class tfsm_plaink3_TimedSystem(NamedElement):
    ...
    def __init__(self, tfsm_plaink3_TimedSystem34: set["tfsm_plaink3_FSMClock"] = None, tfsm_plaink3_TimedSystem37: set["tfsm_plaink3_FSMEvent"] = None, tfsm_plaink3_TimedSystem: set["tfsm_plaink3_TFSM"] = None):
...
class tfsm_plaink3_State(NamedElement):
    ...
    def __init__(self, tfsm_plaink3_State: "tfsm_plaink3_TFSM" = None, State: "tfsm_plaink3_TFSM" = None, ownedStates: "tfsm_plaink3_TFSM" = None, source: set["tfsm_plaink3_Transition"] = None, target: set["tfsm_plaink3_Transition"] = None, tfsm_plaink3_State10: "tfsm_plaink3_TFSM" = None, State16: "tfsm_plaink3_Transition" = None, State18: "tfsm_plaink3_Transition" = None):
...
class tfsm_plaink3_TFSM(NamedElement):
    ...
    def __init__(self, stepNumber: int, lastStateChangeStepNumber: int, tfsm_plaink3_TFSM: "tfsm_plaink3_State" = None, tfsm_plaink3_TFSM3: set["tfsm_plaink3_FSMEvent"] = None, tfsm_plaink3_TFSM5: "tfsm_plaink3_FSMClock" = None, owningFSM: set["tfsm_plaink3_State"] = None, TFSM: "tfsm_plaink3_State" = None, tfsm_plaink3_TFSM7: set["tfsm_plaink3_Transition"] = None, tfsm_plaink3_TFSM9: "tfsm_plaink3_State" = None, tfsm_plaink3_TFSM32: "tfsm_plaink3_TimedSystem" = None):
...
class tfsm_plaink3_Transition(NamedElement):
    ...
    def __init__(self, action: str, Transition: "tfsm_plaink3_State" = None, Transition14: "tfsm_plaink3_State" = None, tfsm_plaink3_Transition: "tfsm_plaink3_TFSM" = None, tfsm_plaink3_Transition22: set["tfsm_plaink3_FSMEvent"] = None, outgoingTransitions: "tfsm_plaink3_State" = None, incomingTransitions: "tfsm_plaink3_State" = None, tfsm_plaink3_Transition20: "tfsm_plaink3_Guard" = None, tfsm_plaink3_Transition30: "tfsm_plaink3_FSMEvent" = None):
        self.action = action
...
class tfsm_plaink3_FSMEvent(NamedElement):
    ...
    def __init__(self, isTriggered: str, tfsm_plaink3_FSMEvent: "tfsm_plaink3_TFSM" = None, tfsm_plaink3_FSMEvent23: "tfsm_plaink3_Transition" = None, tfsm_plaink3_FSMEvent29: set["tfsm_plaink3_Transition"] = None, tfsm_plaink3_FSMEvent27: "tfsm_plaink3_EventGuard" = None, tfsm_plaink3_FSMEvent38: "tfsm_plaink3_TimedSystem" = None):
