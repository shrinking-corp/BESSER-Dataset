...
def test_hyp_extlibrary_periodical_has_title():
...
def test_hyp_extlibrary_videocassette_has_minutesLength():
    assert hasattr(extlibrary_VideoCassette, "minutesLength")
    descriptor = None
    for klass in extlibrary_VideoCassette.__mro__:
...
def test_hyp_extlibrary_bookontape_has_minutesLength():
    assert hasattr(extlibrary_BookOnTape, "minutesLength")
    descriptor = None
    for klass in extlibrary_BookOnTape.__mro__:
        if "minutesLength" in klass.__dict__:
            descriptor = klass.__dict__["minutesLength"]
...
@given(instance=extlibrary_VideoCassette_strategy)
def test_hyp_extlibrary_videocassette_minutesLength_setter(instance):
    original = instance.minutesLength
    instance.minutesLength = original
    assert instance.minutesLength == original
...
@given(instance=extlibrary_BookOnTape_strategy)
def test_hyp_extlibrary_bookontape_minutesLength_setter(instance):
    original = instance.minutesLength
    instance.minutesLength = original
    assert instance.minutesLength == original
