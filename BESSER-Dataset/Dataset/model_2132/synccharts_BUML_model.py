...
synccharts_Action.attributes={synccharts_Action_isImmediate, synccharts_Action_delay, synccharts_Action_label}
...
synccharts_Substitution.attributes={synccharts_Substitution_actual, synccharts_Substitution_formal}
...
synccharts_Scope.attributes={synccharts_Scope_id, synccharts_Scope_label, synccharts_Scope_interfaceDeclaration}
...
synccharts_Transition.attributes={synccharts_Transition_isHistory, synccharts_Transition_priority, synccharts_Transition_type}
...
domain_model = DomainModel(
    name="synccharts",
    types={synccharts_Action, Annotatable, synccharts_Effect, synccharts_Expression, synccharts_Assignment, Effect, synccharts_Variable, synccharts_Emission, synccharts_Signal, synccharts_Region, Scope, synccharts_State, synccharts_Substitution, synccharts_Scope, synccharts_Transition, Action, synccharts_EObject, synccharts_TextualCode, synccharts_TextEffect, TextualCode, StateType, TransitionType},
    associations={parentScope14, regions15, effects0, trigger1, variable3, expression4, signal7, newValue8, states11, parentState12, targetState21, parentRegion16, outgoingTransitions18, incomingTransitions19, variables27, suspensionTrigger30, exitActions33, sourceState23, signals25, innerActions36, entryActions39, bodyReference42, bodyContents44, bodyText47, renamings49},
