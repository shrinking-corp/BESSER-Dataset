...
public class synccharts_Scope extends Annotatable {
    ...
    public synccharts_Scope(
        String interfaceDeclaration,        String id,        String label    ) {
        super(
        );
    ...
    public synccharts_Scope(
        String interfaceDeclaration,        String id,        String label        ArrayList<synccharts_Action> synccharts_actions,        ArrayList<synccharts_Action> synccharts_actions,        ArrayList<synccharts_Action> synccharts_actions    ) {
        this.interfaceDeclaration = interfaceDeclaration;
        this.id = id;
        this.label = label;
