...
# Classes
CD_NamedElt = Class(name="CD_NamedElt", is_abstract=True)
CD_Classifier = Class(name="CD_Classifier", is_abstract=True)
NamedElt = Class(name="NamedElt")
CD_DataType = Class(name="CD_DataType")
Classifier = Class(name="Classifier")
CD_Class = Class(name="CD_Class")
CD_Attribute = Class(name="CD_Attribute")
CD_Package = Class(name="CD_Package")
...
domain_model = DomainModel(
    ...
    generalizations={gen_CD_Classifier_NamedElt, gen_CD_DataType_Classifier, gen_CD_Class_Classifier, gen_CD_Attribute_NamedElt, gen_CD_Package_Classifier},
    metadata=None
)
