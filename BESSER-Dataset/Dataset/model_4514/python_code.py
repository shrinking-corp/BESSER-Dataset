...
class HouseMountable:
    ...
    pass
class majordomo_LightSensor(RoomMountable, HouseMountable, FloatSensor):
...
class majordomo_PreparedStatement:
    ...
    def __init__(self, name: str, preparedStatements: "majordomo_Program" = None, majordomo_PreparedStatement41: "majordomo_Statement" = None, majordomo_PreparedStatement: "majordomo_StatementReference" = None, PreparedStatement: "majordomo_Program" = None):
        self.name = name
...
class majordomo_RainSensor(HouseMountable, BooleanSensor):
    ...
    pass
class majordomo_TemperatureSensor(FloatSensor, RoomMountable, HouseMountable):
...
class majordomo_FloatActor(Actor):
    ...
    def setValue(self, majordomo_value):
