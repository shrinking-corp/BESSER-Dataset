...
class be_jebouquine_entities_Commentaire:
    ...
    def __init__(self, idClient: int, idCommentaire: int, dateCommentaire: date, textCommentaire: str, idLivre: int, client23: "be_jebouquine_entities_Client" = None, livre29: "be_jebouquine_entities_Livre" = None):
        self.idClient = idClient
