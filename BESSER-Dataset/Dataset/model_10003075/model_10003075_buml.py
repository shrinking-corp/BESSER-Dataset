...
User.attributes={User_UserID, User_Firstname, User_Linkedin_link, User_TitleID, User_Settings, User_About, User_Lastname, User_Email, User_Active, User_Roles___, User_Dateofbirth, User_Hiredate, User_Username, User_Password, User_Phone, User_Position, User_Facebook_link, User_DepartmentID, User_Google_plus_link}
...
Project.attributes={Project_Title, Project_Author, Project_Description, Project_Activities___, Project_Assignee, Project_PorjectID, Project_ProjectManager, Project_Attachments___, Project_Comments___, Project_PriorityID, Project_Team___, Project_Subscriptions___, Project_Created, Project_StatusID, Project_Deadline}
...
Activity.attributes={Activity_ActivitySubType, Activity_Seen, Activity_Project, Activity_ActivityID, Activity_ActivityType, Activity_PrevValue, Activity_NewValue, Activity_User}
...
Comment.attributes={Comment_Content, Comment_Created, Comment_CommentID, Comment_User, Comment_Project}
...
Attachment.attributes={Attachment_Name, Attachment_User, Attachment_Path, Attachment_Size, Attachment_Extension, Attachment_Created, Attachment_Project, Attachment_AttachmentID}
...
domain_model = DomainModel(
    name="fbabdf1b_c3e8_4bcd_9ce4_6fb056e8eff7",
