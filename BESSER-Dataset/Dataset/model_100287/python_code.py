...
class petrinet_Arc:
    ...
    def __init__(self, kind: str, weight: int, Arc5: "petrinet_Node" = None, Arc: "petrinet_PetriNet" = None, Arc7: "petrinet_Node" = None, incomings: "petrinet_Node" = None, outgoings: "petrinet_Node" = None, arcs: "petrinet_PetriNet" = None):
        self.kind = kind
        self.weight = weight
        self.Arc5 = Arc5
        self.Arc = Arc
...
class petrinet_Node(ABC):
    ...
    def __init__(self, name: str, Node: "petrinet_PetriNet" = None, source: set["petrinet_Arc"] = None, nodes: "petrinet_PetriNet" = None, target: set["petrinet_Arc"] = None, Node9: "petrinet_Arc" = None, Node11: "petrinet_Arc" = None):
        self.name = name
        self.Node = Node
