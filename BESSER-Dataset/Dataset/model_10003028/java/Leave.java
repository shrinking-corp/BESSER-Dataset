...
public class Leave  {
    ...
    public Leave(
        String Leave_Title,        LocalDate Leave_ApplyDate,        int leave_id,        int Emp_Id,        String Leave_Status,        String Leave_detail,        LocalDate Leave_EndDate,        int Leave_NoOfDays,        LocalDate Leave_StartDate    ) {
