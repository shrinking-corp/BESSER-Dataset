...
# Classes
Sample_Book = Class(name="Sample_Book")
Sample_Person = Class(name="Sample_Person")
Sample_EString = Class(name="Sample_EString")
Sample_Library = Class(name="Sample_Library")
...
Sample_Book.attributes={Sample_Book_category, Sample_Book_name}
...
domain_model = DomainModel(
    name="Sample",
    types={Sample_Book, Sample_Person, Sample_EString, Sample_Library, Category},
