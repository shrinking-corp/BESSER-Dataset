...
class behavior_BehaviorMixEntry:
    ...
    def __init__(self, behaviorModelName: str, relativeFrequency: float, behavior_BehaviorMixEntry: "behavior_BehaviorMix" = None, behavior_BehaviorMixEntry17: "behavior_BehaviorModelRelative" = None):
...
class behavior_UseCase:
    ...
    def __init__(self, id: str, name: str, behavior_UseCase: "behavior_UseCaseRepository" = None, behavior_UseCase5: "behavior_AbstractUseCaseExecution" = None):
        self.id = id
        self.name = name
