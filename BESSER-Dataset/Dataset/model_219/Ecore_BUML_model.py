...
ecore_EClass.methods={ecore_EClass_m_getEStructuralFeature, ecore_EClass_m_isSuperTypeOf, ecore_EClass_m_getFeatureCount, ecore_EClass_m_getEStructuralFeature, ecore_EClass_m_getFeatureID}
...
ecore_EStructuralFeature.attributes={ecore_EStructuralFeature_defaultValue, ecore_EStructuralFeature_derived, ecore_EStructuralFeature_volatile, ecore_EStructuralFeature_transient, ecore_EStructuralFeature_unsettable, ecore_EStructuralFeature_changeable, ecore_EStructuralFeature_defaultValueLiteral}
...
ecore_ETypedElement.attributes={ecore_ETypedElement_required, ecore_ETypedElement_lowerBound, ecore_ETypedElement_unique, ecore_ETypedElement_many, ecore_ETypedElement_ordered, ecore_ETypedElement_upperBound}
...
domain_model = DomainModel(
    name="ecore",
    types={EStructuralFeature, ecore_EAttribute, ecore_EReference, ecore_EDataType, ecore_EAnnotation, EModelElement, ecore_EModelElement, ecore_EObject, ecore_EClass, EClassifier, ecore_EOperation, ecore_EStructuralFeature, ecore_EGenericType, ecore_EClassifier, ENamedElement, ecore_EPackage, ecore_ETypeParameter, ecore_EEnum, EDataType, ecore_EEnumLiteral, ecore_EFactory, EObject, ecore_ENamedElement, ETypedElement, ecore_EParameter, ecore_ETypedElement},
    associations={eAllAttributes9, eAllReferences12, eAttributeType0, eModelElement1, contents2, references3, eSuperTypes7, eOperations8, eReferences14, eAttributes17, eAllContainments20, eAllOperations23, eAllStructuralFeatures25, eAllSuperTypes28, eIDAttribute30, eStructuralFeatures33, eGenericSuperTypes35, eAllGenericSuperTypes37, eIDAttributeForTest40, eAllAttributesForTest43, ePackage46, eTypeParameters47, eLiterals48, eEnum49, eContainingClass53, eTypeParameters54, ePackage50, eAnnotations52, eOpposite76, eParameters57, eExceptions58, eGenericExceptions61, eFactoryInstance64, eClassifiers65, eSubpackages68, eSuperPackage71, eOperation73, eReferenceType78, eKeys81, eContainingClass84, eType86, eGenericType88, eUpperBound92, eTypeArguments95, eRawType97, eLowerBound101, eTypeParameter103, eClassifier106, eBounds109},
