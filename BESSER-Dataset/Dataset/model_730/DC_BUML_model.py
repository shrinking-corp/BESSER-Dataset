...
dc_Dimension_m_nonNegativeDimension: Method = Method(name="nonNegativeDimension", parameters={Parameter(name='dc_diagnostics', type=StringType), Parameter(name='dc_context', type=StringType)}, type=BooleanType)
...
dc_Bounds_m_nonNegativeSize: Method = Method(name="nonNegativeSize", parameters={Parameter(name='dc_diagnostics', type=StringType), Parameter(name='dc_context', type=StringType)}, type=BooleanType)
dc_Bounds.attributes={dc_Bounds_y, dc_Bounds_x, dc_Bounds_width, dc_Bounds_height}
