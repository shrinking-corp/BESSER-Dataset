...
class Login:
    ...
    def shoppingCart2(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Login__shoppingCart2", None)
    ...
    def customer4(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Login__customer4", None)
...
class ShoppingCart:
    ...
    def __init__(self, creationDate: date, webUser3: "Login" = None, account9: "Account" = None, items10: "LineItem" = None):
...
class Customer:
    ...
    def __init__(self, address: str, phone: str, email: str, webUser5: "Login" = None, account6: "Account" = None):
