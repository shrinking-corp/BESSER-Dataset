...
Login_state: Property = Property(name="state", type=UserState)
Login.attributes={Login_login, Login_state, Login_password}
...
Order.attributes={Order_shipTo, Order_ordered, Order_number, Order_shipped, Order_status, Order_total}
...
WebUser_ShoppingCart: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="webUser3", type=Login, multiplicity=Multiplicity(1, 1))
    }
)
WebUser_Customer: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="webUser5", type=Login, multiplicity=Multiplicity(1, 1))
    }
)
...
domain_model = DomainModel(
    name="_34ca70c8_4ef2_4cd7_9722_94ff4e776bfb",
    types={Customer, Payment, ShoppingCart, Account, Login, Order, LineItem, Product, UserState, OrderStatus},
