...
# Classes
metaModelSM_StateMachine = Class(name="metaModelSM_StateMachine")
metaModelSM_Region = Class(name="metaModelSM_Region")
metaModelSM_State = Class(name="metaModelSM_State")
metaModelSM_Triggers = Class(name="metaModelSM_Triggers")
metaModelSM_InitialState = Class(name="metaModelSM_InitialState")
State = Class(name="State")
metaModelSM_FinalState = Class(name="metaModelSM_FinalState")
metaModelSM_Transition = Class(name="metaModelSM_Transition")
metaModelSM_NewEClass1 = Class(name="metaModelSM_NewEClass1")
metaModelSM_NewEClass2 = Class(name="metaModelSM_NewEClass2")
metaModelSM_Guard = Class(name="metaModelSM_Guard")
metaModelSM_Signal = Class(name="metaModelSM_Signal")
...
domain_model = DomainModel(
    name="metaModelSM",
    types={metaModelSM_StateMachine, metaModelSM_Region, metaModelSM_State, metaModelSM_Triggers, metaModelSM_InitialState, State, metaModelSM_FinalState, metaModelSM_Transition, metaModelSM_NewEClass1, metaModelSM_NewEClass2, metaModelSM_Guard, metaModelSM_Signal},
    associations={region1, source2, region3, transition6, triggered8, neweclass20, defines11, target13, signal16},
