...
public class Liga  {
    ...
    public Liga(
        String Num_equipos,        String Cod_liga,        String Nombre,        String Inferior,        String Superior,        String Cod_Clasificacion    ) {
    ...
    public Liga(
        String Num_equipos,        String Cod_liga,        String Nombre,        String Inferior,        String Superior,        String Cod_Clasificacion        ArrayList<Partido> partidos    ) {
        this.Num_equipos = Num_equipos;
        this.Cod_liga = Cod_liga;
        this.Nombre = Nombre;
        this.Inferior = Inferior;
