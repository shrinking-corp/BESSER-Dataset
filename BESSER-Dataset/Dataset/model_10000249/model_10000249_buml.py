...
admin_modify_list_of_students: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="modify_list_of_students28", type=modify_list_of_students_external, multiplicity=Multiplicity(0, 1)),
...
FACULTY_STUDENT: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="sTUDENT30", type=STUDENT, multiplicity=Multiplicity(1, 9999)),
...
FACULTY_ADMIN: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="fACULTY33", type=FACULTY, multiplicity=Multiplicity(1, 9999))
    }
)
STUDENT_ADMIN: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="sTUDENT35", type=STUDENT, multiplicity=Multiplicity(1, 9999))
    }
)

# Domain Model
domain_model = DomainModel(
    name="_1f577bd7_0678_44ad_a9d1_2693c1d30787",
    types={student_Actor, faculty_Actor, _Component, admin_Actor, FACULTY, STUDENT, ADMIN, take_attendance_call_external, generate_class_wise_attendance_report_external, post_attendance_external, answer_attendance_call_external, view_subject_wise_attendance_external, view_cumiliative_attendance_external, login_external, logout_external, send_attendance_sms_external, modify_list_of_students_external},
    associations={faculty_give_attendance, faculty_generate_class_wise_attendance_report, faculty_post_attendance, student_answer_attendance_call, student_view_subject_wise_attendance, student_view_cumiliative_attendance, student_login, student_logout, faculty_login, faculty_logout, admin_login, admin_logout, faculty_send_attendance_sms, faculty_view_cumiliative_attendance, admin_modify_list_of_students, FACULTY_STUDENT, FACULTY_ADMIN, STUDENT_ADMIN},
    generalizations={},
    metadata=None
)
