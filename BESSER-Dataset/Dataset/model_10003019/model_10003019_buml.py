...
Account.attributes={Account_billingAddress, Account_closed, Account_open, Account_isClosed}
...
Order.attributes={Order_shipTo, Order_status, Order_number, Order_total, Order_ordered, Order_shipped}
...
domain_model = DomainModel(
    name="f604ab74_18cd_433e_93ea_02a7da6f1a87",
    types={Customer, Payment, ShoppingCart, Account, WebUser, Order, LineItem, Product, UserState, OrderStatus},
    associations={Product_LineItem, Order_LineItem, Account_Order, Payment_Order, Account_Payment, WebUser_ShoppingCart, WebUser_Customer, Customer_Account, Account_ShoppingCart, ShoppingCart_LineItem},
    generalizations={},
    metadata=None
)
