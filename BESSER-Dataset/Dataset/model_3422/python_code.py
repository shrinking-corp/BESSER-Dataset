...
class location_Location:
    ...
    def __init__(self, description: str, phoneNumber: str, street: str, city: str, state: str, postalCode: str, country: str, longitude: float, latitude: float, altitude: float, altitudeMode: str, comments: str, name: str, location_Location: set["location_Area"] = None):
    ...
    def containsPoint(self, location_point) :
    ...
    def locate(self, location_point) :
