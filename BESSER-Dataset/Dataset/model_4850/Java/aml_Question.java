...
public class aml_Question  {
    ...
    public aml_Question(
        String group,        String amplification,        String description,        String id,        String label    ) {
        this.group = group;
    ...
    public aml_Question(
        String group,        String amplification,        String description,        String id,        String label        ArrayList<aml_DiscoveryMethod> aml_discoverymethods,        ArrayList<aml_Annotation> aml_annotations,        ArrayList<aml_EObject> aml_eobjects,        ArrayList<aml_AggregationRule> aml_aggregationrules,        ArrayList<aml_Choice> aml_choices    ) {
        this.group = group;
        this.amplification = amplification;
        this.description = description;
        this.id = id;
