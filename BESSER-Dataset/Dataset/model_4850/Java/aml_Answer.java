...
public class aml_Answer  {
    ...
    public aml_Answer(
        String questionId,        String group,        String rationale        ArrayList<aml_Witness> aml_witnesss,        ArrayList<aml_Annotation> aml_annotations,        ArrayList<aml_AggregationRule> aml_aggregationrules,        ArrayList<aml_Belief> aml_beliefs,        ArrayList<aml_DiscoveryMethod> aml_discoverymethods    ) {
        this.questionId = questionId;
        this.group = group;
        this.rationale = rationale;
