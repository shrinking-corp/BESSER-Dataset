...
aml_DiscoveryMethod.attributes={aml_DiscoveryMethod_importType, aml_DiscoveryMethod_description, aml_DiscoveryMethod_type, aml_DiscoveryMethod_id, aml_DiscoveryMethod_autoTrigger, aml_DiscoveryMethod_label, aml_DiscoveryMethod_url}
...
aml_Collection.attributes={aml_Collection_label1, aml_Collection_id, aml_Collection_label, aml_Collection_group, aml_Collection_objectType}
...
aml_Person.attributes={aml_Person_description, aml_Person_department, aml_Person_id, aml_Person_middleName, aml_Person_firstName, aml_Person_organization, aml_Person_nickName, aml_Person_email, aml_Person_lastName}
...
aml_Memo.attributes={aml_Memo_id, aml_Memo_subject, aml_Memo_type, aml_Memo_body}
...
aml_Witness.attributes={aml_Witness_idRef, aml_Witness_description, aml_Witness_timestamp}
...
aml_MetaData.attributes={aml_MetaData_subject, aml_MetaData_title, aml_MetaData_securityMarking, aml_MetaData_description, aml_MetaData_date, aml_MetaData_group}
...
aml_CreatingTool.attributes={aml_CreatingTool_label, aml_CreatingTool_version, aml_CreatingTool_toolType}
...
aml_Evidence.attributes={aml_Evidence_ordinal, aml_Evidence_id, aml_Evidence_label}
...
aml_Choice.attributes={aml_Choice_symbol, aml_Choice_description, aml_Choice_ordinal, aml_Choice_label}
...
aml_CollectionItem.attributes={aml_CollectionItem_objectType, aml_CollectionItem_ordinal, aml_CollectionItem_idRef}
...
aml_Question.attributes={aml_Question_group, aml_Question_id, aml_Question_label, aml_Question_amplification, aml_Question_description}
...
aml_NationState.attributes={aml_NationState_event, aml_NationState_perspective, aml_NationState_group, aml_NationState_region, aml_NationState_actor}
...
aml_DocumentRoot.attributes={aml_DocumentRoot_id, aml_DocumentRoot_symbol, aml_DocumentRoot_url, aml_DocumentRoot_middleName, aml_DocumentRoot_label, aml_DocumentRoot_lastName, aml_DocumentRoot_rationale, aml_DocumentRoot_mixed, aml_DocumentRoot_date, aml_DocumentRoot_organization, aml_DocumentRoot_securityMarking, aml_DocumentRoot_description, aml_DocumentRoot_label1, aml_DocumentRoot_description1, aml_DocumentRoot_title, aml_DocumentRoot_firstName, aml_DocumentRoot_nickName, aml_DocumentRoot_region, aml_DocumentRoot_body, aml_DocumentRoot_actor, aml_DocumentRoot_event, aml_DocumentRoot_perspective, aml_DocumentRoot_subject, aml_DocumentRoot_department, aml_DocumentRoot_idRef, aml_DocumentRoot_email}
...
aml_EvidenceExhibit.attributes={aml_EvidenceExhibit_questionId, aml_EvidenceExhibit_value, aml_EvidenceExhibit_idRef}
...
aml_Reader.attributes={aml_Reader_description, aml_Reader_idRef, aml_Reader_objectType}
...
aml_Relevance.attributes={aml_Relevance_description, aml_Relevance_symbol, aml_Relevance_ordinal, aml_Relevance_label}
...
aml_Reliability.attributes={aml_Reliability_label, aml_Reliability_ordinal, aml_Reliability_description, aml_Reliability_symbol}
...
aml_Value.attributes={aml_Value_type, aml_Value_group, aml_Value_unit, aml_Value_mixed}
...
domain_model = DomainModel(
    name="aml",
    types={aml_Template, aml_Argument, aml_Exhibit, aml_AggregationRule, aml_EObject, aml_Parameter, aml_AmlDocument, aml_DiscoveryMethod, aml_Annotation, aml_Collection, aml_Person, aml_Memo, aml_Belief, aml_Witness, aml_Flag, aml_Answer, aml_MetaData, aml_CreatingTool, aml_Evidence, aml_ArgumentTemplate, aml_Choice, aml_CollectionItem, aml_Question, aml_Creator, aml_Coverage, aml_NationState, aml_Dependent, aml_DocumentRoot, aml_EStringToStringMapEntry, aml_End, aml_Interval, aml_EvidenceExhibit, aml_List, aml_Publisher, aml_Period, aml_QuestionRelationships, aml_Reader, aml_Relevance, aml_Reliability, aml_Start, aml_Value, ObjectType, ObjectType1, ObjectType2, ObjectType3, Type},
    associations={template3, argument4, exhibit6, method0, parameter1, discoveryMethod14, memo16, collection8, person10, memo12, belief20, witness21, annotation23, flag18, metaData34, creatingTool36, annotation38, aggregationRule26, evidence29, discoveryMethod31, argumentTemplate41, answer43, question55, argumentTemplate57, collectionItem60, metaData46, creatingTool49, annotation52, nationState62, argumentTemplate63, annotation66, amlDocument76, annotation79, answer82, archive85, argument88, xMLNSPrefixMap69, xSISchemaLocation70, aggregationRule73, collection99, collectionItem102, contributor105, coverage108, creatingTool111, argumentTemplate91, belief94, choice97, discoveryMethod118, end121, creator114, dependent116, format134, identifier137, image140, interval143, evidence123, evidenceExhibit126, exhibit128, flag131, metaData153, method156, nationState159, language145, list148, memo150, relation179, person167, parameter162, publisher170, period165, question172, questionRelationships175, reader177, relevance182, reliability184, rights186, source189, start192, template194, type197, value200, witness202, reliability211, witness214, annotation217, evidenceExhibit205, relevance208, archive220, metaData223, annotation226, li232, creator235, witness229, creator241, reader244, reader238, type253, format256, identifier259, publisher247, contributor250, rights274, image277, source262, language265, relation268, coverage271, period280, value283, start286, end289, type295, choice298, dependent292, questionRelationships301, aggregationRule304, discoveryMethod307, annotation310, metaData313, creatingTool316, annotation319, question322, interval325, list328},
    generalizations={},
    metadata=None
)
