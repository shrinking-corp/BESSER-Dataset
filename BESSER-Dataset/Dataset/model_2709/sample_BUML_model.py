...
# Classes
strictSample_A = Class(name="strictSample_A")
strictSample_B = Class(name="strictSample_B")
strictSample_C = Class(name="strictSample_C")
strictSample_D = Class(name="strictSample_D")
