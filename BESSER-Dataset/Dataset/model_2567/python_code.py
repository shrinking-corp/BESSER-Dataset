...
class dsl_State:
    ...
    def __init__(self, name: str, dsl_State: "dsl_StateMachine" = None, dsl_State5: "dsl_StateMachine" = None, dsl_State7: set["dsl_Transition"] = None, dsl_State13: "dsl_Transition" = None):
        self.name = name
