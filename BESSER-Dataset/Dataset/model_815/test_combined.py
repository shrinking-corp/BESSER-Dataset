...
def test_assoc_containingFSM13_link_reassign_clear():
...
def test_assoc_containingFSM8_link_reassign_clear():
...
def test_assoc_states0_link_reassign_clear():
    ...
    if hasattr(b1, 'containingFSM'):
        assert _is_linked(b1, 'containingFSM', a)
    _safe_set(a, 'State', b2)
    assert _is_linked(a, 'State', b2)
    if hasattr(b1, 'containingFSM'):
        assert not _is_linked(b1, 'containingFSM', a)
    if hasattr(b2, 'containingFSM'):
        assert _is_linked(b2, 'containingFSM', a)
    _safe_set(a, 'State', None)
    assert not _is_linked(a, 'State', b2)
    if hasattr(b2, 'containingFSM'):
        assert not _is_linked(b2, 'containingFSM', a)
...
def test_assoc_transitions1_link_reassign_clear():
    ...
    if hasattr(b1, 'containingFSM2'):
        assert _is_linked(b1, 'containingFSM2', a)
    _safe_set(a, 'Transition', b2)
    assert _is_linked(a, 'Transition', b2)
    if hasattr(b1, 'containingFSM2'):
        assert not _is_linked(b1, 'containingFSM2', a)
    if hasattr(b2, 'containingFSM2'):
        assert _is_linked(b2, 'containingFSM2', a)
    _safe_set(a, 'Transition', None)
    assert not _is_linked(a, 'Transition', b2)
    if hasattr(b2, 'containingFSM2'):
        assert not _is_linked(b2, 'containingFSM2', a)
