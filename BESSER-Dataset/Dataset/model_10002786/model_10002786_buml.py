...
Library_Management_System_Patron.attributes={Library_Management_System_Patron_OtherResources, Library_Management_System_Patron_Magazines, Library_Management_System_Patron_Books, Library_Management_System_Patron_Status, Library_Management_System_Patron_SpecialStatus}
...
domain_model = DomainModel(
    name="dae64ee7_734d_43de_aefb_815d587d67c0",
    ...
    associations={Librarian_1_year_check_out, Librarian_Check_in___Return, Librarian_Check_out, Librarian_Requested, Librarian_Reserve, Librarian_Reference, Librarian_Reshelving_books, Librarian_Ordering_new_resources, Librarian_Assist_patrons_in_research, Librarian_Connect_to_holding_of_other_libraries, Librarian_Books, Patron_Student, Patron_Faculty, Patron_Librarian, Student_Check_in___Return, Student_Check_out, Student_Requested, Student_Reserve, Student_Reference, Faculty_Check_in___Return, Faculty_Check_out, Faculty_Requested, Faculty_Reserve, Faculty_Reference, Librarian_Issue_fines, Librarian_Manage_Magazines},
    generalizations={},
    metadata=None
)
