...
class stateMachine_State:
    ...
    def __init__(self, name: str, stateMachine_State: "stateMachine_StateMachine" = None, stateMachine_State6: set["stateMachine_Transition"] = None, stateMachine_State12: "stateMachine_Transition" = None):
        self.name = name
...
class stateMachine_Event:
    ...
    def __init__(self, name: str, stateMachine_Event: "stateMachine_StateMachine" = None, stateMachine_Event9: "stateMachine_Transition" = None, stateMachine_Event14: "stateMachine_Condition" = None):
        self.name = name
