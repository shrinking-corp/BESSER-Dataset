...
# Classes
SecCon_Element = Class(name="SecCon_Element", is_abstract=True)
SecCon_Comment = Class(name="SecCon_Comment")
SecCon_TypedElement = Class(name="SecCon_TypedElement", is_abstract=True)
NamedElement = Class(name="NamedElement")
SecCon_Type = Class(name="SecCon_Type", is_abstract=True)
SecCon_MultiplicityElement = Class(name="SecCon_MultiplicityElement", is_abstract=True)
Element = Class(name="Element")
SecCon_NamedElement = Class(name="SecCon_NamedElement", is_abstract=True)
SecCon_Operation = Class(name="SecCon_Operation")
SecCon_Parameter = Class(name="SecCon_Parameter")
SecCon_Package = Class(name="SecCon_Package")
SecCon_Class = Class(name="SecCon_Class")
Type = Class(name="Type")
SecCon_Attribute = Class(name="SecCon_Attribute")
TypedElement = Class(name="TypedElement")
MultiplicityElement = Class(name="MultiplicityElement")
SecCon_Enumeration = Class(name="SecCon_Enumeration")
SecCon_EnumerationLiteral = Class(name="SecCon_EnumerationLiteral")
SecCon_Actor = Class(name="SecCon_Actor")
SecCon_UseCase = Class(name="SecCon_UseCase", is_abstract=True)
SecCon_DataType = Class(name="SecCon_DataType", is_abstract=True)
SecCon_PrimitiveType = Class(name="SecCon_PrimitiveType")
DataType = Class(name="DataType")
SecCon_UseCaseScenario = Class(name="SecCon_UseCaseScenario")
SecCon_ThreatUseCase = Class(name="SecCon_ThreatUseCase")
UseCase = Class(name="UseCase")
SecCon_AttackUseCase = Class(name="SecCon_AttackUseCase")
SecCon_VulnerabilityUseCase = Class(name="SecCon_VulnerabilityUseCase")
SecCon_CountermeasureUseCase = Class(name="SecCon_CountermeasureUseCase")
SecCon_RecoverUseCase = Class(name="SecCon_RecoverUseCase")
SecCon_PrevenctionUseCase = Class(name="SecCon_PrevenctionUseCase")
SecCon_DetectionUseCase = Class(name="SecCon_DetectionUseCase")
SecCon_Include = Class(name="SecCon_Include")
SecCon_Extend = Class(name="SecCon_Extend")
SecCon_StateMachineScenario = Class(name="SecCon_StateMachineScenario")
SecCon_StateVertex = Class(name="SecCon_StateVertex", is_abstract=True)
SecCon_Event = Class(name="SecCon_Event", is_abstract=True)
SecCon_Transition = Class(name="SecCon_Transition")
SecCon_State = Class(name="SecCon_State", is_abstract=True)
StateVertex = Class(name="StateVertex")
SecCon_StateOperation = Class(name="SecCon_StateOperation")
SecCon_InitialState = Class(name="SecCon_InitialState")
SecCon_CountermeasureEvent = Class(name="SecCon_CountermeasureEvent")
Event = Class(name="Event")
SecCon_ThreatEvent = Class(name="SecCon_ThreatEvent")
SecCon_AttackEvent = Class(name="SecCon_AttackEvent")
SecCon_Project = Class(name="SecCon_Project")
SecCon_ContextScenario = Class(name="SecCon_ContextScenario")
SecCon_Rule = Class(name="SecCon_Rule")
SecCon_ContextInformation = Class(name="SecCon_ContextInformation")
SecCon_Condition = Class(name="SecCon_Condition")
SecCon_Action = Class(name="SecCon_Action")
SecCon_FinalState = Class(name="SecCon_FinalState")
SecCon_ThreatenedState = Class(name="SecCon_ThreatenedState")
State = Class(name="State")
SecCon_AttackedState = Class(name="SecCon_AttackedState")
SecCon_VulnerableState = Class(name="SecCon_VulnerableState")
SecCon_ProtectedState = Class(name="SecCon_ProtectedState")
...
SecCon_MultiplicityElement.attributes={SecCon_MultiplicityElement_lower, SecCon_MultiplicityElement_isUnique, SecCon_MultiplicityElement_upper, SecCon_MultiplicityElement_isOrdered}
...
SecCon_Attribute.attributes={SecCon_Attribute_isID, SecCon_Attribute_isReadOnly, SecCon_Attribute_isDerived, SecCon_Attribute_isComposite, SecCon_Attribute_default}
...
SecCon_UseCase.attributes={SecCon_UseCase_description, SecCon_UseCase_preCondition}
...
SecCon_UseCaseScenario.attributes={SecCon_UseCaseScenario_author, SecCon_UseCaseScenario_version}
...
SecCon_StateMachineScenario.attributes={SecCon_StateMachineScenario_author, SecCon_StateMachineScenario_version}
...
domain_model = DomainModel(
    name="SecCon",
    types={SecCon_Element, SecCon_Comment, SecCon_TypedElement, NamedElement, SecCon_Type, SecCon_MultiplicityElement, Element, SecCon_NamedElement, SecCon_Operation, SecCon_Parameter, SecCon_Package, SecCon_Class, Type, SecCon_Attribute, TypedElement, MultiplicityElement, SecCon_Enumeration, SecCon_EnumerationLiteral, SecCon_Actor, SecCon_UseCase, SecCon_DataType, SecCon_PrimitiveType, DataType, SecCon_UseCaseScenario, SecCon_ThreatUseCase, UseCase, SecCon_AttackUseCase, SecCon_VulnerabilityUseCase, SecCon_CountermeasureUseCase, SecCon_RecoverUseCase, SecCon_PrevenctionUseCase, SecCon_DetectionUseCase, SecCon_Include, SecCon_Extend, SecCon_StateMachineScenario, SecCon_StateVertex, SecCon_Event, SecCon_Transition, SecCon_State, StateVertex, SecCon_StateOperation, SecCon_InitialState, SecCon_CountermeasureEvent, Event, SecCon_ThreatEvent, SecCon_AttackEvent, SecCon_Project, SecCon_ContextScenario, SecCon_Rule, SecCon_ContextInformation, SecCon_Condition, SecCon_Action, SecCon_FinalState, SecCon_ThreatenedState, State, SecCon_AttackedState, SecCon_VulnerableState, SecCon_ProtectedState, ParameterDirectionKind, PseudostateKind, Operator, TypeOfCondition, TypeOfContext},
    associations={ownedElement0, type1, opposite6, raisedException7, ownedParameter9, package11, ownedOperation13, superclass16, annotatedElement2, ownedLiteral21, enumeration22, ownedType23, nestedPackage27, nestingPackage29, actor31, ownedAttribute18, extend35, extends36, scenario39, addition41, base42, scenario44, extension46, base48, includes32, include33, ownedActor61, ownedState64, ownedEvent65, ownedTransition67, outgoing69, incoming72, ownedStateOperation75, deferrableEvent76, scenario50, ownedUseCase52, ownedExtend55, ownedInclude58, ownedPackages82, ownedUseCaseScenario84, ownedStateMachineScenario87, ownedContextScenario90, contains92, isFormed94, hasCondition96, hasAction98, trigger79, hasContextInformation100},
    generalizations={gen_SecCon_TypedElement_NamedElement, gen_SecCon_MultiplicityElement_Element, gen_SecCon_NamedElement_Element, gen_SecCon_Operation_TypedElement, gen_SecCon_Operation_MultiplicityElement, gen_SecCon_Parameter_TypedElement, gen_SecCon_Parameter_MultiplicityElement, gen_SecCon_Type_NamedElement, gen_SecCon_Class_Type, gen_SecCon_Attribute_TypedElement, gen_SecCon_Attribute_MultiplicityElement, gen_SecCon_Enumeration_DataType, gen_SecCon_EnumerationLiteral_NamedElement, gen_SecCon_Package_NamedElement, gen_SecCon_Actor_NamedElement, gen_SecCon_UseCase_NamedElement, gen_SecCon_DataType_Type, gen_SecCon_PrimitiveType_DataType, gen_SecCon_ThreatUseCase_UseCase, gen_SecCon_AttackUseCase_UseCase, gen_SecCon_VulnerabilityUseCase_UseCase, gen_SecCon_CountermeasureUseCase_UseCase, gen_SecCon_RecoverUseCase_UseCase, gen_SecCon_PrevenctionUseCase_UseCase, gen_SecCon_DetectionUseCase_UseCase, gen_SecCon_StateMachineScenario_NamedElement, gen_SecCon_StateVertex_NamedElement, gen_SecCon_State_StateVertex, gen_SecCon_UseCaseScenario_NamedElement, gen_SecCon_Event_NamedElement, gen_SecCon_InitialState_StateVertex, gen_SecCon_CountermeasureEvent_Event, gen_SecCon_ThreatEvent_Event, gen_SecCon_AttackEvent_Event, gen_SecCon_Project_NamedElement, gen_SecCon_StateOperation_NamedElement, gen_SecCon_FinalState_StateVertex, gen_SecCon_ThreatenedState_State, gen_SecCon_AttackedState_State, gen_SecCon_VulnerableState_State, gen_SecCon_ProtectedState_State, gen_SecCon_Transition_NamedElement},
    metadata=None
)
