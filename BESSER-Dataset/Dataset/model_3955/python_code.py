...
class SecCon_Extend:
    ...
    def __init__(self, name: str, condition: str, Extend: "SecCon_UseCase" = None, Extend38: "SecCon_UseCase" = None, SecCon_Extend: "SecCon_UseCaseScenario" = None, SecCon_Extend57: "SecCon_UseCaseScenario" = None, extend: "SecCon_UseCase" = None, extends: "SecCon_UseCase" = None):
        self.name = name
        self.condition = condition
        self.Extend = Extend
...
class SecCon_Include:
    ...
    def __init__(self, name: str, includes: "SecCon_UseCase" = None, include: "SecCon_UseCase" = None, SecCon_Include60: "SecCon_UseCaseScenario" = None, SecCon_Include: "SecCon_UseCaseScenario" = None, Include: "SecCon_UseCase" = None, Include34: "SecCon_UseCase" = None):
        self.name = name
...
class SecCon_Attribute(MultiplicityElement, TypedElement):
    ...
    def __init__(self, isDerived: bool, isID: bool, isReadOnly: bool, default: str, isComposite: bool, SecCon_Attribute: "SecCon_Attribute" = None, SecCon_Attribute5: "SecCon_Attribute" = None, SecCon_Attribute20: "SecCon_Class" = None):
...
class SecCon_UseCase(NamedElement):
    ...
    def __init__(self, description: str, preCondition: str, SecCon_UseCase: set["SecCon_Actor"] = None, extension: set["SecCon_Extend"] = None, base37: set["SecCon_Extend"] = None, SecCon_UseCase40: "SecCon_UseCaseScenario" = None, UseCase: "SecCon_Include" = None, UseCase43: "SecCon_Include" = None, SecCon_UseCase54: "SecCon_UseCaseScenario" = None, UseCase47: "SecCon_Extend" = None, UseCase49: "SecCon_Extend" = None, addition: set["SecCon_Include"] = None, base: "SecCon_Include" = None):
...
class SecCon_StateMachineScenario(NamedElement):
    ...
    def __init__(self, author: str, version: str, SecCon_StateMachineScenario89: "SecCon_Project" = None, SecCon_StateMachineScenario: set["SecCon_StateVertex"] = None, SecCon_StateMachineScenario66: set["SecCon_Event"] = None, SecCon_StateMachineScenario68: set["SecCon_Transition"] = None):
        self.author = author
...
class SecCon_UseCaseScenario(NamedElement):
    ...
    def __init__(self, author: str, version: str, SecCon_UseCaseScenario: "SecCon_UseCase" = None, SecCon_UseCaseScenario51: "SecCon_Extend" = None, SecCon_UseCaseScenario53: set["SecCon_UseCase"] = None, SecCon_UseCaseScenario56: set["SecCon_Extend"] = None, SecCon_UseCaseScenario59: set["SecCon_Include"] = None, SecCon_UseCaseScenario86: "SecCon_Project" = None, SecCon_UseCaseScenario45: "SecCon_Include" = None, SecCon_UseCaseScenario62: set["SecCon_Actor"] = None):
        self.author = author
        self.version = version
...
class SecCon_Comment:
    ...
    def __init__(self, body: str, SecCon_Comment: "SecCon_Element" = None, SecCon_Comment3: set["SecCon_Element"] = None):
        self.body = body
