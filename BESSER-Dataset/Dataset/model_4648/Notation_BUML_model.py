...
domain_model = DomainModel(
    name="notation",
    types={notation_View, NotationElement, notation_Node, notation_EObject, notation_Edge, notation_NotationElement, notation_Diagram, notation_LayoutConstraint, notation_Location, LayoutConstraint, View, notation_Bounds, notation_MindMapNode, Location, notation_Note, Node},
    associations={persistentChildren0, diagrammableElement1, sourceEdges3, source8, target9, persistentEdges11, targetEdges4, layoutConstraint6},
    generalizations={gen_notation_View_NotationElement, gen_notation_Edge_View, gen_notation_Diagram_View, gen_notation_Location_NotationElement, gen_notation_Location_LayoutConstraint, gen_notation_Node_View, gen_notation_MindMapNode_Node, gen_notation_Bounds_Location, gen_notation_Note_Node},
    metadata=None
)
