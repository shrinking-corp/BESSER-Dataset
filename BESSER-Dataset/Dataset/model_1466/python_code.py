...
class graph_DocumentRoot:
    ...
    def __init__(self, mixed: str, graph_DocumentRoot: set["graph_EStringToStringMapEntry"] = None, graph_DocumentRoot8: set["graph_EStringToStringMapEntry"] = None, graph_DocumentRoot11: set["graph_Cause"] = None, graph_DocumentRoot14: set["graph_Dependency"] = None, graph_DocumentRoot17: set["graph_EnvironmentGraph"] = None, graph_DocumentRoot19: set["graph_Node"] = None):
        self.mixed = mixed
...
class graph_Cause:
    ...
    def __init__(self, name: str, type: str, version: str, graph_Cause12: "graph_DocumentRoot" = None, graph_Cause: "graph_Dependency" = None):
        self.name = name
        self.type = type
...
class graph_Node:
    ...
    def __init__(self, nodeName: str, unitName: str, unitVersion: str, containerName: str, id: str, graph_Node29: "graph_EnvironmentGraph" = None, graph_Node31: set["graph_Dependency"] = None, graph_Node34: set["graph_Dependency"] = None, graph_Node: "graph_Dependency" = None, graph_Node5: "graph_Dependency" = None, graph_Node20: "graph_DocumentRoot" = None, graph_Node23: "graph_EnvironmentGraph" = None):
...
class graph_Dependency:
    ...
    def __init__(self, id: str, locality: str, graph_Dependency26: "graph_EnvironmentGraph" = None, graph_Dependency32: "graph_Node" = None, graph_Dependency35: "graph_Node" = None, graph_Dependency: set["graph_Cause"] = None, graph_Dependency2: "graph_Node" = None, graph_Dependency4: "graph_Node" = None, graph_Dependency15: "graph_DocumentRoot" = None):
        self.id = id
