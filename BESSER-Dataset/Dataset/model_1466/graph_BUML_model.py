...
# Classes
graph_Dependency = Class(name="graph_Dependency")
graph_Node = Class(name="graph_Node")
graph_Cause = Class(name="graph_Cause")
graph_EnvironmentGraph = Class(name="graph_EnvironmentGraph")
graph_DocumentRoot = Class(name="graph_DocumentRoot")
graph_EStringToStringMapEntry = Class(name="graph_EStringToStringMapEntry")
...
graph_Node.attributes={graph_Node_unitVersion, graph_Node_nodeName, graph_Node_unitName, graph_Node_id, graph_Node_containerName}
...
graph_Cause.attributes={graph_Cause_type, graph_Cause_name, graph_Cause_version}
...
domain_model = DomainModel(
    name="graph",
    types={graph_Dependency, graph_Node, graph_Cause, graph_EnvironmentGraph, graph_DocumentRoot, graph_EStringToStringMapEntry},
    associations={cause0, destination1, source3, dependency13, environmentGraph16, node18, node21, xMLNSPrefixMap6, xSISchemaLocation7, cause10, dependencies24, origins27, dependencies30, isRequiredBy33},
    generalizations={},
    metadata=None
)
