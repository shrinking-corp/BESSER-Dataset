...
# Classes
family_course = Class(name="family_course")
family_Family = Class(name="family_Family")
family_person = Class(name="family_person")
family_university = Class(name="family_university")
...
family_person.attributes={family_person_name, family_person_CPR, family_person_age}
...
domain_model = DomainModel(
    name="family",
    types={family_course, family_Family, family_person, family_university},
    associations={courses10, students12, members16, Members17, spouse1, parent3, children6, enrollment8},
    generalizations={},
    metadata=None
)
