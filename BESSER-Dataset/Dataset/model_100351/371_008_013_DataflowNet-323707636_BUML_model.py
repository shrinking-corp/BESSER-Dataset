...
domain_model = DomainModel(
    name="dataflownet",
    types={dataflownet_NamedElement, dataflownet_Node, NamedElement, dataflownet_DataflowNet, dataflownet_StateMachine, Node, dataflownet_StateMachineState, dataflownet_FiringRule, dataflownet_Channel, dataflownet_Process, dataflownet_StateMachineTransition, dataflownet_Type, dataflownet_Token, dataflownet_DataflowSystem, Comparation, Protocol},
    associations={parent0, nodes1, initialState2, firingRules3, outputChannels5, inputChannels6, nodes9, ownChannels11, process14, outputTransitions16, inputTransitions17, parent19, fromState21, toState23, inputs25, outputs27, type30, channel32, tokens35, type37, types40, nets42, channels45, processes48},
    generalizations={gen_dataflownet_Node_NamedElement, gen_dataflownet_StateMachine_Node, gen_dataflownet_DataflowNet_Node, gen_dataflownet_StateMachineState_NamedElement, gen_dataflownet_StateMachineTransition_NamedElement, gen_dataflownet_Channel_NamedElement, gen_dataflownet_FiringRule_NamedElement, gen_dataflownet_DataflowSystem_NamedElement, gen_dataflownet_Process_NamedElement},
    metadata=None
)
