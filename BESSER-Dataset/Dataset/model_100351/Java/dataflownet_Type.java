...
public class dataflownet_Type  {
    ...
    private dataflownet_Channel dataflownet_channel;
    ...
    public dataflownet_Type(
    ) {
    }



    public dataflownet_Channel getDataflownet_channel() {
        return dataflownet_channel;
    }

    public void setDataflownet_channel(dataflownet_Channel dataflownet_channel) {
        this.dataflownet_channel = dataflownet_channel;
    }
