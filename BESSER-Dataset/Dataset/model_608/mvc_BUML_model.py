...
# Classes
mvc_MvcApplication = Class(name="mvc_MvcApplication")
mvc_View = Class(name="mvc_View")
mvc_Model = Class(name="mvc_Model")
mvc_Controller = Class(name="mvc_Controller")
mvc_Position = Class(name="mvc_Position")
mvc_Attribute = Class(name="mvc_Attribute")
mvc_Method = Class(name="mvc_Method")
mvc_GraphicComponent = Class(name="mvc_GraphicComponent")
View = Class(name="View")
mvc_MapComponent = Class(name="mvc_MapComponent")
mvc_SocialComponent = Class(name="mvc_SocialComponent")
mvc_ReturnParameter = Class(name="mvc_ReturnParameter")
mvc_Client = Class(name="mvc_Client")
Model = Class(name="Model")
mvc_DataBase = Class(name="mvc_DataBase")
...
mvc_MvcApplication.attributes={mvc_MvcApplication_email, mvc_MvcApplication_picture, mvc_MvcApplication_name, mvc_MvcApplication_pagelink, mvc_MvcApplication_description}
...
mvc_Position.attributes={mvc_Position_name, mvc_Position_wide, mvc_Position_align_left, mvc_Position_long, mvc_Position_above}
...
mvc_MapComponent.attributes={mvc_MapComponent_latitude, mvc_MapComponent_longitude, mvc_MapComponent_marker}
...
domain_model = DomainModel(
    name="mvc",
    types={mvc_MvcApplication, mvc_View, mvc_Model, mvc_Controller, mvc_Position, mvc_Attribute, mvc_Method, mvc_GraphicComponent, View, mvc_MapComponent, mvc_SocialComponent, mvc_ReturnParameter, mvc_Client, Model, mvc_DataBase},
    associations={views0, models1, controllers3, model5, view6, controller8, controller9, position11, datoA18, datoB20, attrib13, method14, attribute16},
    generalizations={gen_mvc_GraphicComponent_View, gen_mvc_MapComponent_View, gen_mvc_SocialComponent_View, gen_mvc_Client_Model, gen_mvc_DataBase_Model},
    metadata=None
)
