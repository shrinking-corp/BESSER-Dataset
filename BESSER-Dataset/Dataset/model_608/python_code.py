...
class mvc_Attribute:
    ...
    def __init__(self, nameattribute: str, typeattribute: str, mvc_Attribute19: "mvc_GraphicComponent" = None, mvc_Attribute22: "mvc_GraphicComponent" = None, mvc_Attribute: "mvc_Method" = None, mvc_Attribute17: "mvc_DataBase" = None):
...
class mvc_Controller:
    ...
    def __init__(self, name: str, mvc_Controller: "mvc_MvcApplication" = None, controller: "mvc_Model" = None, controller7: "mvc_View" = None, Controller: "mvc_Model" = None, Controller10: "mvc_View" = None):
        self.name = name
...
class mvc_View:
    ...
    def __init__(self, name: str, type: str, mvc_View: "mvc_MvcApplication" = None, View: "mvc_Controller" = None, view: "mvc_Controller" = None, mvc_View12: "mvc_Position" = None):
        self.name = name
        self.type = type
