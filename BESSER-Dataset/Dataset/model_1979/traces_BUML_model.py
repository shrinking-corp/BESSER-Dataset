...
# Classes
traces_TraceRecord = Class(name="traces_TraceRecord")
traces_Trace = Class(name="traces_Trace")
traces_Model = Class(name="traces_Model")
traces_TraceElement = Class(name="traces_TraceElement")
traces_EObject = Class(name="traces_EObject")
...
traces_Trace.attributes={traces_Trace_timestamp, traces_Trace_ruleInfo, traces_Trace_ruleName}
...
traces_TraceElement.attributes={traces_TraceElement_value, traces_TraceElement_traceType, traces_TraceElement_typeName}
...
domain_model = DomainModel(
    name="traces",
    types={traces_TraceRecord, traces_Trace, traces_Model, traces_TraceElement, traces_EObject, ParameterType},
