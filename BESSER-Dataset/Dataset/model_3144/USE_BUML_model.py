...
USE_Role.attributes={USE_Role_lowerBound, USE_Role_name, USE_Role_upperBound, USE_Role_ordered}
...
domain_model = DomainModel(
    name="USE",
    types={USE_Parameter, USE_Class, USE_EnumerationType, Type, USE_CollectionType, USE_Attribute, USE_Operation, USE_SimpleType, USE_OCLExpression, USE_ReferenceType, USE_Model, USE_Enumeration, USE_Association, USE_Type, USE_Literal, USE_Role, AssocKind, SimpleTypes, CollectionTypes},
    associations={parameters16, implementation18, type21, preCondition24, postCondition27, type30, enum33, superClasses1, attributes2, baseType35, operations4, invariants6, classes8, enumerations10, associations12, type14, literals39, role41, className43, class_37},
