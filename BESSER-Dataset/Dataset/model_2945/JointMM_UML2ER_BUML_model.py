...
# Classes
jointPackage_UML2ER_JointMM = Class(name="jointPackage_UML2ER_JointMM")
SrcPackage = Class(name="SrcPackage")
TrgStrongReference = Class(name="TrgStrongReference")
jointPackage_UML2ER_SrcPackage = Class(name="jointPackage_UML2ER_SrcPackage")
SrcNamedElement = Class(name="SrcNamedElement")
SrcClass = Class(name="SrcClass")
jointPackage_UML2ER_SrcClass = Class(name="jointPackage_UML2ER_SrcClass")
SrcProperty = Class(name="SrcProperty")
jointPackage_UML2ER_SrcProperty = Class(name="jointPackage_UML2ER_SrcProperty")
jointPackage_UML2ER_TrgERModel = Class(name="jointPackage_UML2ER_TrgERModel")
TrgElement = Class(name="TrgElement")
TrgEntityType = Class(name="TrgEntityType")
jointPackage_UML2ER_TrgWeakReference = Class(name="jointPackage_UML2ER_TrgWeakReference")
TrgReference = Class(name="TrgReference")
jointPackage_UML2ER_TrgStrongReference = Class(name="jointPackage_UML2ER_TrgStrongReference")
jointPackage_UML2ER_TrgEntityType = Class(name="jointPackage_UML2ER_TrgEntityType")
TrgFeature = Class(name="TrgFeature")
jointPackage_UML2ER_TrgFeature = Class(name="jointPackage_UML2ER_TrgFeature", is_abstract=True)
jointPackage_UML2ER_TrgAttribute = Class(name="jointPackage_UML2ER_TrgAttribute")
jointPackage_UML2ER_TrgElement = Class(name="jointPackage_UML2ER_TrgElement", is_abstract=True)
jointPackage_UML2ER_TrgReference = Class(name="jointPackage_UML2ER_TrgReference", is_abstract=True)
jointPackage_UML2ER_SrcNamedElement = Class(name="jointPackage_UML2ER_SrcNamedElement", is_abstract=True)
...
domain_model = DomainModel(
    ...
    types={jointPackage_UML2ER_JointMM, SrcPackage, TrgStrongReference, jointPackage_UML2ER_SrcPackage, SrcNamedElement, SrcClass, jointPackage_UML2ER_SrcClass, SrcProperty, jointPackage_UML2ER_SrcProperty, jointPackage_UML2ER_TrgERModel, TrgElement, TrgEntityType, jointPackage_UML2ER_TrgWeakReference, TrgReference, jointPackage_UML2ER_TrgStrongReference, jointPackage_UML2ER_TrgEntityType, TrgFeature, jointPackage_UML2ER_TrgFeature, jointPackage_UML2ER_TrgAttribute, jointPackage_UML2ER_TrgElement, jointPackage_UML2ER_TrgReference, jointPackage_UML2ER_SrcNamedElement},
