...
def test_hyp_jointpackage_uml2er_srcnamedelement_is_not_abstract():
    assert not inspect.isabstract(jointPackage_UML2ER_SrcNamedElement)


def test_hyp_jointpackage_uml2er_srcnamedelement_constructor_exists():
    assert callable(jointPackage_UML2ER_SrcNamedElement.__init__)


def test_hyp_jointpackage_uml2er_srcnamedelement_constructor_args():
...
def test_hyp_jointpackage_uml2er_trgelement_is_not_abstract():
    assert not inspect.isabstract(jointPackage_UML2ER_TrgElement)


def test_hyp_jointpackage_uml2er_trgelement_constructor_exists():
    assert callable(jointPackage_UML2ER_TrgElement.__init__)


def test_hyp_jointpackage_uml2er_trgelement_constructor_args():
...
def test_hyp_trgfeature_is_not_abstract():
    assert not inspect.isabstract(TrgFeature)


def test_hyp_trgfeature_constructor_exists():
    assert callable(TrgFeature.__init__)


def test_hyp_trgfeature_constructor_args():
    sig = inspect.signature(TrgFeature.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jointpackage_uml2er_trgattribute_is_not_abstract():
    assert not inspect.isabstract(jointPackage_UML2ER_TrgAttribute)


def test_hyp_jointpackage_uml2er_trgattribute_constructor_exists():
    assert callable(jointPackage_UML2ER_TrgAttribute.__init__)


def test_hyp_jointpackage_uml2er_trgattribute_constructor_args():
...
def test_hyp_jointpackage_uml2er_trgreference_is_not_abstract():
    assert not inspect.isabstract(jointPackage_UML2ER_TrgReference)


def test_hyp_jointpackage_uml2er_trgreference_constructor_exists():
    assert callable(jointPackage_UML2ER_TrgReference.__init__)


def test_hyp_jointpackage_uml2er_trgreference_constructor_args():
    sig = inspect.signature(jointPackage_UML2ER_TrgReference.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trgreference_is_not_abstract():
    assert not inspect.isabstract(TrgReference)


def test_hyp_trgreference_constructor_exists():
    assert callable(TrgReference.__init__)


def test_hyp_trgreference_constructor_args():
    sig = inspect.signature(TrgReference.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jointpackage_uml2er_trgstrongreference_is_not_abstract():
    assert not inspect.isabstract(jointPackage_UML2ER_TrgStrongReference)


def test_hyp_jointpackage_uml2er_trgstrongreference_constructor_exists():
    assert callable(jointPackage_UML2ER_TrgStrongReference.__init__)


def test_hyp_jointpackage_uml2er_trgstrongreference_constructor_args():
    sig = inspect.signature(jointPackage_UML2ER_TrgStrongReference.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jointpackage_uml2er_trgweakreference_is_not_abstract():
    assert not inspect.isabstract(jointPackage_UML2ER_TrgWeakReference)


def test_hyp_jointpackage_uml2er_trgweakreference_constructor_exists():
    assert callable(jointPackage_UML2ER_TrgWeakReference.__init__)


def test_hyp_jointpackage_uml2er_trgweakreference_constructor_args():
    sig = inspect.signature(jointPackage_UML2ER_TrgWeakReference.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trgentitytype_is_not_abstract():
    assert not inspect.isabstract(TrgEntityType)


def test_hyp_trgentitytype_constructor_exists():
    assert callable(TrgEntityType.__init__)


def test_hyp_trgentitytype_constructor_args():
...
def test_hyp_jointpackage_uml2er_trgfeature_is_not_abstract():
    assert not inspect.isabstract(jointPackage_UML2ER_TrgFeature)


def test_hyp_jointpackage_uml2er_trgfeature_constructor_exists():
    assert callable(jointPackage_UML2ER_TrgFeature.__init__)


def test_hyp_jointpackage_uml2er_trgfeature_constructor_args():
    sig = inspect.signature(jointPackage_UML2ER_TrgFeature.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jointpackage_uml2er_trgentitytype_is_not_abstract():
    assert not inspect.isabstract(jointPackage_UML2ER_TrgEntityType)


def test_hyp_jointpackage_uml2er_trgentitytype_constructor_exists():
    assert callable(jointPackage_UML2ER_TrgEntityType.__init__)


def test_hyp_jointpackage_uml2er_trgentitytype_constructor_args():
    sig = inspect.signature(jointPackage_UML2ER_TrgEntityType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jointpackage_uml2er_trgermodel_is_not_abstract():
    assert not inspect.isabstract(jointPackage_UML2ER_TrgERModel)


def test_hyp_jointpackage_uml2er_trgermodel_constructor_exists():
    assert callable(jointPackage_UML2ER_TrgERModel.__init__)


def test_hyp_jointpackage_uml2er_trgermodel_constructor_args():
    sig = inspect.signature(jointPackage_UML2ER_TrgERModel.__init__)
    params = list(sig.parameters.keys())



def test_hyp_srcproperty_is_not_abstract():
    assert not inspect.isabstract(SrcProperty)


def test_hyp_srcproperty_constructor_exists():
    assert callable(SrcProperty.__init__)


def test_hyp_srcproperty_constructor_args():
    sig = inspect.signature(SrcProperty.__init__)
    params = list(sig.parameters.keys())



def test_hyp_srcclass_is_not_abstract():
    assert not inspect.isabstract(SrcClass)


def test_hyp_srcclass_constructor_exists():
    assert callable(SrcClass.__init__)


def test_hyp_srcclass_constructor_args():
...
def test_hyp_jointpackage_uml2er_srcproperty_is_not_abstract():
    assert not inspect.isabstract(jointPackage_UML2ER_SrcProperty)


def test_hyp_jointpackage_uml2er_srcproperty_constructor_exists():
    assert callable(jointPackage_UML2ER_SrcProperty.__init__)


def test_hyp_jointpackage_uml2er_srcproperty_constructor_args():
...
def test_hyp_jointpackage_uml2er_srcclass_is_not_abstract():
    assert not inspect.isabstract(jointPackage_UML2ER_SrcClass)


def test_hyp_jointpackage_uml2er_srcclass_constructor_exists():
    assert callable(jointPackage_UML2ER_SrcClass.__init__)


def test_hyp_jointpackage_uml2er_srcclass_constructor_args():
    sig = inspect.signature(jointPackage_UML2ER_SrcClass.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jointpackage_uml2er_srcpackage_is_not_abstract():
    assert not inspect.isabstract(jointPackage_UML2ER_SrcPackage)


def test_hyp_jointpackage_uml2er_srcpackage_constructor_exists():
    assert callable(jointPackage_UML2ER_SrcPackage.__init__)


def test_hyp_jointpackage_uml2er_srcpackage_constructor_args():
    sig = inspect.signature(jointPackage_UML2ER_SrcPackage.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trgstrongreference_is_not_abstract():
    assert not inspect.isabstract(TrgStrongReference)


def test_hyp_trgstrongreference_constructor_exists():
    assert callable(TrgStrongReference.__init__)


def test_hyp_trgstrongreference_constructor_args():
    sig = inspect.signature(TrgStrongReference.__init__)
    params = list(sig.parameters.keys())



def test_hyp_srcpackage_is_not_abstract():
    assert not inspect.isabstract(SrcPackage)


def test_hyp_srcpackage_constructor_exists():
    assert callable(SrcPackage.__init__)


def test_hyp_srcpackage_constructor_args():
    sig = inspect.signature(SrcPackage.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jointpackage_uml2er_jointmm_is_not_abstract():
    assert not inspect.isabstract(jointPackage_UML2ER_JointMM)


def test_hyp_jointpackage_uml2er_jointmm_constructor_exists():
    assert callable(jointPackage_UML2ER_JointMM.__init__)


def test_hyp_jointpackage_uml2er_jointmm_constructor_args():
...
def test_hyp_jointpackage_uml2er_srcnamedelement_name_setter(instance):
...
def test_hyp_jointpackage_uml2er_trgelement_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_jointpackage_uml2er_trgattribute_type_setter(instance):
...
def test_hyp_jointpackage_uml2er_srcproperty_isContainment_setter(instance):
...
@given(instance=jointPackage_UML2ER_SrcProperty_strategy)
def test_hyp_jointpackage_uml2er_srcproperty_primitiveType_setter(instance):
