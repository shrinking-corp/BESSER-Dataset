...
class SQL2003_V2_StructuralComponent(ABC):
    ...
    def __init__(self, name: str, StructuralComponent98: "SQL2003_V2_Domain" = None, SQL2003_V2_StructuralComponent: "SQL2003_V2_DataType" = None, components: set["SQL2003_V2_View"] = None, columns54: set["SQL2003_V2_Restriction"] = None, SQL2003_V2_StructuralComponent56: set["SQL2003_V2_Feature"] = None, defines: "SQL2003_V2_Domain" = None, StructuralComponent: "SQL2003_V2_Restriction" = None, SQL2003_V2_StructuralComponent80: "SQL2003_V2_Trigger" = None, StructuralComponent94: "SQL2003_V2_View" = None):
        self.name = name
...
class SQL2003_V2_Domain:
    ...
    def __init__(self, name: str, expression: str, default: str, has_domain: set["SQL2003_V2_StructuralComponent"] = None, Domain: "SQL2003_V2_Schema" = None, Domain59: "SQL2003_V2_StructuralComponent" = None, domains: "SQL2003_V2_Schema" = None):
        self.name = name
...
class SQL2003_V2_ReferentialConstraint(TableConstraint):
    ...
    def __init__(self, delete_action: str, update_action: str, match: str, SQL2003_V2_ReferentialConstraint: "SQL2003_V2_UniqueConstraint" = None):
...
class SQL2003_V2_Schema:
    ...
    def __init__(self, name: str, Schema9: "SQL2003_V2_DataType" = None, Schema: "SQL2003_V2_BehaviouralComponent" = None, schema: set["SQL2003_V2_BehaviouralComponent"] = None, schema44: set["SQL2003_V2_DataType"] = None, schema46: set["SQL2003_V2_Table"] = None, schema49: set["SQL2003_V2_Domain"] = None, Schema70: "SQL2003_V2_Table" = None, Schema96: "SQL2003_V2_Domain" = None):
        self.name = name
...
class SQL2003_V2_BehaviouralComponent(ABC):
    ...
    def __init__(self, name: str, body: str, behaviouralComponents: "SQL2003_V2_Schema" = None, BehaviouralComponent: "SQL2003_V2_ParameterWithMode" = None, behaviouralComponent: set["SQL2003_V2_ParameterWithMode"] = None, BehaviouralComponent42: "SQL2003_V2_Schema" = None):
        self.name = name
        self.body = body
...
class SQL2003_V2_Table(ABC):
    ...
    def __init__(self, name: str, Table: "SQL2003_V2_Column" = None, Table47: "SQL2003_V2_Schema" = None, Table38: "SQL2003_V2_Restriction" = None, table: set["SQL2003_V2_Column"] = None, tables73: set["SQL2003_V2_View"] = None, table76: set["SQL2003_V2_Restriction"] = None, tables: "SQL2003_V2_Schema" = None, Table91: "SQL2003_V2_View" = None):
        self.name = name
        self.Table = Table
...
class SQL2003_V2_ParameterWithMode(Parameter):
    ...
    def __init__(self, mode: str, parametersWithMode: "SQL2003_V2_BehaviouralComponent" = None, ParameterWithMode: "SQL2003_V2_BehaviouralComponent" = None):
        self.mode = mode
...
class SQL2003_V2_StructuredType(UserDefinedType):
    ...
    def __init__(self, is_final: bool, is_instantiable: bool, StructuredType: "SQL2003_V2_Attribute" = None, StructuredType18: "SQL2003_V2_Method" = None, StructuredType83: "SQL2003_V2_TypedTable" = None, SQL2003_V2_StructuredType: "SQL2003_V2_ReferenceType" = None, SQL2003_V2_StructuredType62: "SQL2003_V2_StructuredType" = None, SQL2003_V2_StructuredType60: "SQL2003_V2_StructuredType" = None, structured: set["SQL2003_V2_Attribute"] = None, structured65: set["SQL2003_V2_Method"] = None, structured68: set["SQL2003_V2_TypedTable"] = None):
