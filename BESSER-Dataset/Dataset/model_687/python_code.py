...
class JTLMM_emof_Tag(Element):
    ...
    def __init__(self, value: str, name: str, tag: set["Element"] = None, Element: "JTLMM_emof_Tag" = None, Element230: "JTLMM_imperativeocl_LogExp" = None):
        self.value = value
        self.name = name
...
class JTLMM_JTL_Relation(NamedElement):
    ...
    def __init__(self, isTopLevel: bool, relation: "Transformation" = None, relation30: set["Domain"] = None, whereOwner: "Pattern" = None, whenOwner: "Pattern" = None, JTLMM_JTL_Relation: set["Variable"] = None, NamedElement: "JTLMM_emof_Comment" = None):
...
class JTLMM_emof_Property(emof_MultiplicityElement, emof_TypedElement):
    ...
    def __init__(self, isDerived: bool, isComposite: bool, isId: bool, default: str, isReadOnly: bool, ownedAttribute: "Class" = None, JTLMM_emof_Property: "Property" = None):
...
class JTLMM_emof_NamedElement(Element):
    ...
    def __init__(self, name: str, Element: "JTLMM_emof_Tag" = None, Element230: "JTLMM_imperativeocl_LogExp" = None):
        self.name = name
...
class JTLMM_emof_Class(Type):
    ...
    def __init__(self, isAbstract: bool, Class: set["Property"] = None, class_: set["Operation"] = None, JTLMM_emof_Class: set["Class"] = None, Type92: "JTLMM_essentialocl_TypeExp" = None, Type242: "JTLMM_imperativeocl_AnonymousTupleType" = None, Type219: "JTLMM_imperativeocl_DictionaryType" = None, Type197: "JTLMM_imperativeocl_TryExp" = None, Type202: "JTLMM_imperativeocl_RaiseExp" = None, Type206: "JTLMM_imperativeocl_Typedef" = None, Type131: "JTLMM_essentialocl_CollectionType" = None, Type: "JTLMM_emof_Operation" = None, Type13: "JTLMM_emof_Package" = None):
...
class JTLMM_imperativeocl_TemplateParameterType(Type):
    ...
    def __init__(self, specification: str, Type92: "JTLMM_essentialocl_TypeExp" = None, Type242: "JTLMM_imperativeocl_AnonymousTupleType" = None, Type219: "JTLMM_imperativeocl_DictionaryType" = None, Type197: "JTLMM_imperativeocl_TryExp" = None, Type202: "JTLMM_imperativeocl_RaiseExp" = None, Type206: "JTLMM_imperativeocl_Typedef" = None, Type131: "JTLMM_essentialocl_CollectionType" = None, Type: "JTLMM_emof_Operation" = None, Type13: "JTLMM_emof_Package" = None):
