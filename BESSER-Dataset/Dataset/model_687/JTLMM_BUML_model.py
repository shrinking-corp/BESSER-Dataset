...
JTLMM_emof_MultiplicityElement.attributes={JTLMM_emof_MultiplicityElement_isOrdered, JTLMM_emof_MultiplicityElement_isUnique, JTLMM_emof_MultiplicityElement_upper, JTLMM_emof_MultiplicityElement_lower}
...
JTLMM_emof_Property.attributes={JTLMM_emof_Property_isId, JTLMM_emof_Property_isReadOnly, JTLMM_emof_Property_isDerived, JTLMM_emof_Property_isComposite, JTLMM_emof_Property_default}
...
JTLMM_imperativeocl_LogExp.attributes={JTLMM_imperativeocl_LogExp_level, JTLMM_imperativeocl_LogExp_text}
...
referredOperation100: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="Relation102", type=JTLMM_essentialocl_OperationCallExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_essentialocl_OperationCallExp101", type=Relation, multiplicity=Multiplicity(0, 1))
    }
)
...
domain_model = DomainModel(
    name="JTLMM",
    types={JTLMM_emof_Class, Type, Property_, Operation, Class_, JTLMM_emof_Enumeration, DataType, EnumerationLiteral, JTLMM_emof_NamedElement, JTLMM_emof_Extent, JTLMM_emof_Object, JTLMM_emof_Operation, emof_MultiplicityElement, emof_TypedElement, Parameter_, JTLMM_emof_MultiplicityElement, JTLMM_emof_Package, NamedElement, Package, JTLMM_emof_Type, JTLMM_emof_Parameter, JTLMM_emof_DataType, JTLMM_emof_Element, Object, Tag, Comment, JTLMM_emof_Tag, Element, JTLMM_emof_TypedElement, JTLMM_emof_PrimitiveType, JTLMM_emof_URIExtent, Extent, JTLMM_emof_Comment, JTLMM_JTL_Transformation, emof_Class, emof_Package, Model, Relation, JTLMM_emof_EnumerationLiteral, Enumeration_, JTLMM_emof_Property, JTLMM_JTL_Model, JTLMM_JTL_Pattern, Predicate, TemplateExp, JTLMM_JTL_Predicate, OclExpression, JTLMM_essentialocl_BooleanLiteralExp, PrimitiveLiteralExp, JTLMM_JTL_Relation, Transformation, Domain, Pattern, Variable, JTLMM_JTL_Domain, JTLMM_essentialocl_LetExp, JTLMM_essentialocl_Variable, LetExp, ComputeExp, JTLMM_essentialocl_PropertyCallExp, FeaturePropertyCall, JTLMM_essentialocl_VariableExp, JTLMM_essentialocl_CallExp, JTLMM_essentialocl_OclExpression, TypedElement, TryExp, JTLMM_essentialocl_UnlimitedNaturalExp, NumericLiteralExp, JTLMM_essentialocl_IfExp, JTLMM_essentialocl_TypeExp, JTLMM_essentialocl_LoopExp, essentialocl_CallExp, essentialocl_OclExpression, JTLMM_essentialocl_IteratorExp, LoopExp, JTLMM_essentialocl_StringLiteralExp, JTLMM_essentialocl_IntegerLiteralExp, JTLMM_essentialocl_OperationCallExp, JTLMM_essentialocl_CollectionRange, JTLMM_essentialocl_TupleLiteralExp, TupleLiteralPart, JTLMM_essentialocl_NullLiteralExp, JTLMM_essentialocl_ExpressionInOcl, OpaqueExpression, JTLMM_essentialocl_OpaqueExpression, JTLMM_essentialocl_InvalidLiteralExp, JTLMM_essentialocl_FeaturePropertyCall, CallExp, JTLMM_essentialocl_TupleLiteralPart, TupleLiteralExp, JTLMM_essentialocl_BagType, CollectionType, JTLMM_essentialocl_RealLiteralExp, JTLMM_essentialocl_LiteralExp, JTLMM_essentialocl_IterateExp, JTLMM_essentialocl_PrimitiveLiteralExp, LiteralExp, JTLMM_essentialocl_NumericLiteralExp, JTLMM_essentialocl_CollectionLiteralExp, CollectionLiteralPart, JTLMM_essentialocl_CollectionLiteralPart, CollectionLiteralExp, JTLMM_essentialocl_CollectionItem, JTLMM_template_ObjectTemplateExp, PropertyTemplateItem, AssignExp, JTLMM_template_CollectionTemplateExp, JTLMM_template_PropertyTemplateItem, ObjectTemplateExp, JTLMM_imperativeocl_ImperativeIterateExp, ImperativeLoopExp, JTLMM_essentialocl_CollectionType, JTLMM_essentialocl_EnumLiteralExp, JTLMM_essentialocl_InvalidType, JTLMM_essentialocl_OrderedSetType, JTLMM_essentialocl_SequenceType, JTLMM_essentialocl_SetType, JTLMM_essentialocl_TupleType, emof_DataType, JTLMM_essentialocl_VoidType, JTLMM_essentialocl_AnyType, emof_Type, JTLMM_template_TemplateExp, JTLMM_imperativeocl_BlockExp, JTLMM_imperativeocl_BreakExp, JTLMM_imperativeocl_TryExp, JTLMM_imperativeocl_SwitchExp, imperativeocl_ImperativeExpression, AltExp, JTLMM_imperativeocl_AssignExp, ImperativeExpression, JTLMM_imperativeocl_VariableInitExp, JTLMM_imperativeocl_WhileExp, JTLMM_imperativeocl_ComputeExp, JTLMM_imperativeocl_AltExp, JTLMM_imperativeocl_UnlinkExp, JTLMM_imperativeocl_ReturnExp, JTLMM_imperativeocl_RaiseExp, JTLMM_imperativeocl_ContinueExp, JTLMM_imperativeocl_ForExp, JTLMM_imperativeocl_TupleExp, JTLMM_imperativeocl_Typedef, JTLMM_imperativeocl_InstantiationExp, JTLMM_imperativeocl_DictionaryType, JTLMM_imperativeocl_DictLiteralExp, DictLiteralPart, JTLMM_imperativeocl_DictLiteralPart, JTLMM_imperativeocl_AnonymousTupleLiteralPart, JTLMM_imperativeocl_ListType, JTLMM_imperativeocl_TemplateParameterType, JTLMM_imperativeocl_LogExp, JTLMM_imperativeocl_AssertExp, LogExp, JTLMM_imperativeocl_ImperativeLoopExp, essentialocl_LoopExp, JTLMM_imperativeocl_CollectorExp, JTLMM_imperativeocl_ImperativeExpression, JTLMM_imperativeocl_UnpackExp, JTLMM_imperativeocl_AnonymousTupleType, JTLMM_imperativeocl_AnonymousTupleLiteralExp, AnonymousTupleLiteralPart, CollectionKind, SeverityKind},
    associations={ownedAttribute0, ownedOperation1, superClass2, ownedLiteral7, class_8, ownedParameter10, raisedException11, ownedType12, nestedPackage14, package15, tag4, ownedComment5, element6, annotatedElement24, modelParameter25, relation26, operation17, enumeration19, Class20, opposite22, pattern37, model39, rootVariable42, transformation45, dependsOn47, whereOwner49, whenOwner51, predicate53, bindsTo54, templateExpression56, domain58, pattern61, conditionExpression63, transformation28, domain29, where31, when32, variable34, relation35, thenExpression69, elseExpression72, in_75, variable77, initExpression79, LetExp81, bindParameter83, computeOwner86, referredProperty87, referredVariable89, source64, tryBodyOwner66, condition67, referredType91, body93, iterator95, argument98, referredOperation100, item108, first110, last112, part115, bodyExpression116, context118, resultVariable121, parameterVariable124, TupleLiteralExp127, result103, part105, CollectionLiteralExp106, bindsTo134, where136, part139, inside140, part141, referredCollectionType143, match145, objContainer148, value150, referredProperty152, elementType130, referredEnumLiteral132, body165, value192, target155, alternativePart167, elsePart168, value157, referredVariable171, left159, condition173, defaultValue162, body175, returnedElement178, body180, condition182, body184, target187, item189, key221, value223, tryBody194, exception196, exceptBody198, exception201, element203, base205, condition207, instantiatedClass210, extent212, argument215, keyType218, part220, part243, value244, condition226, element228, log231, assertion232, condition235, target237, variable239, elementType241},
    generalizations={gen_JTLMM_emof_Class_Type, gen_JTLMM_emof_Enumeration_DataType, gen_JTLMM_emof_NamedElement_Element, gen_JTLMM_emof_Extent_Object, gen_JTLMM_emof_Operation_emof_MultiplicityElement, gen_JTLMM_emof_Operation_emof_TypedElement, gen_JTLMM_emof_Package_NamedElement, gen_JTLMM_emof_Type_NamedElement, gen_JTLMM_emof_DataType_Type, gen_JTLMM_emof_Element_Object, gen_JTLMM_emof_Tag_Element, gen_JTLMM_emof_TypedElement_NamedElement, gen_JTLMM_emof_PrimitiveType_DataType, gen_JTLMM_emof_URIExtent_Extent, gen_JTLMM_emof_Comment_Element, gen_JTLMM_JTL_Transformation_emof_Class, gen_JTLMM_JTL_Transformation_emof_Package, gen_JTLMM_emof_Parameter_emof_MultiplicityElement, gen_JTLMM_emof_Parameter_emof_TypedElement, gen_JTLMM_emof_EnumerationLiteral_NamedElement, gen_JTLMM_emof_Property_emof_MultiplicityElement, gen_JTLMM_emof_Property_emof_TypedElement, gen_JTLMM_JTL_Model_NamedElement, gen_JTLMM_JTL_Pattern_Element, gen_JTLMM_JTL_Predicate_Element, gen_JTLMM_essentialocl_BooleanLiteralExp_PrimitiveLiteralExp, gen_JTLMM_JTL_Relation_NamedElement, gen_JTLMM_JTL_Domain_NamedElement, gen_JTLMM_essentialocl_LetExp_OclExpression, gen_JTLMM_essentialocl_Variable_TypedElement, gen_JTLMM_essentialocl_PropertyCallExp_FeaturePropertyCall, gen_JTLMM_essentialocl_VariableExp_OclExpression, gen_JTLMM_essentialocl_CallExp_OclExpression, gen_JTLMM_essentialocl_OclExpression_TypedElement, gen_JTLMM_essentialocl_UnlimitedNaturalExp_NumericLiteralExp, gen_JTLMM_essentialocl_IfExp_OclExpression, gen_JTLMM_essentialocl_TypeExp_OclExpression, gen_JTLMM_essentialocl_LoopExp_essentialocl_CallExp, gen_JTLMM_essentialocl_LoopExp_essentialocl_OclExpression, gen_JTLMM_essentialocl_IteratorExp_LoopExp, gen_JTLMM_essentialocl_StringLiteralExp_PrimitiveLiteralExp, gen_JTLMM_essentialocl_IntegerLiteralExp_NumericLiteralExp, gen_JTLMM_essentialocl_OperationCallExp_FeaturePropertyCall, gen_JTLMM_essentialocl_CollectionRange_CollectionLiteralPart, gen_JTLMM_essentialocl_TupleLiteralExp_LiteralExp, gen_JTLMM_essentialocl_NullLiteralExp_LiteralExp, gen_JTLMM_essentialocl_ExpressionInOcl_OpaqueExpression, gen_JTLMM_essentialocl_InvalidLiteralExp_LiteralExp, gen_JTLMM_essentialocl_FeaturePropertyCall_CallExp, gen_JTLMM_essentialocl_TupleLiteralPart_TypedElement, gen_JTLMM_essentialocl_BagType_CollectionType, gen_JTLMM_essentialocl_RealLiteralExp_NumericLiteralExp, gen_JTLMM_essentialocl_LiteralExp_OclExpression, gen_JTLMM_essentialocl_IterateExp_LoopExp, gen_JTLMM_essentialocl_PrimitiveLiteralExp_LiteralExp, gen_JTLMM_essentialocl_NumericLiteralExp_PrimitiveLiteralExp, gen_JTLMM_essentialocl_CollectionLiteralExp_LiteralExp, gen_JTLMM_essentialocl_CollectionLiteralPart_TypedElement, gen_JTLMM_essentialocl_CollectionItem_CollectionLiteralPart, gen_JTLMM_template_ObjectTemplateExp_TemplateExp, gen_JTLMM_template_CollectionTemplateExp_TemplateExp, gen_JTLMM_template_PropertyTemplateItem_Element, gen_JTLMM_imperativeocl_ImperativeIterateExp_ImperativeLoopExp, gen_JTLMM_essentialocl_CollectionType_DataType, gen_JTLMM_essentialocl_EnumLiteralExp_LiteralExp, gen_JTLMM_essentialocl_InvalidType_Type, gen_JTLMM_essentialocl_OrderedSetType_CollectionType, gen_JTLMM_essentialocl_SequenceType_CollectionType, gen_JTLMM_essentialocl_SetType_CollectionType, gen_JTLMM_essentialocl_TupleType_emof_Class, gen_JTLMM_essentialocl_TupleType_emof_DataType, gen_JTLMM_essentialocl_VoidType_Type, gen_JTLMM_essentialocl_AnyType_emof_Class, gen_JTLMM_essentialocl_AnyType_emof_Type, gen_JTLMM_template_TemplateExp_LiteralExp, gen_JTLMM_imperativeocl_BlockExp_ImperativeExpression, gen_JTLMM_imperativeocl_BreakExp_ImperativeExpression, gen_JTLMM_imperativeocl_TryExp_ImperativeExpression, gen_JTLMM_imperativeocl_SwitchExp_essentialocl_CallExp, gen_JTLMM_imperativeocl_SwitchExp_imperativeocl_ImperativeExpression, gen_JTLMM_imperativeocl_AssignExp_ImperativeExpression, gen_JTLMM_imperativeocl_VariableInitExp_ImperativeExpression, gen_JTLMM_imperativeocl_WhileExp_ImperativeExpression, gen_JTLMM_imperativeocl_ComputeExp_ImperativeExpression, gen_JTLMM_imperativeocl_AltExp_ImperativeExpression, gen_JTLMM_imperativeocl_UnlinkExp_ImperativeExpression, gen_JTLMM_imperativeocl_ReturnExp_ImperativeExpression, gen_JTLMM_imperativeocl_DictLiteralPart_Element, gen_JTLMM_imperativeocl_RaiseExp_ImperativeExpression, gen_JTLMM_imperativeocl_ContinueExp_ImperativeExpression, gen_JTLMM_imperativeocl_ForExp_ImperativeLoopExp, gen_JTLMM_imperativeocl_TupleExp_ImperativeExpression, gen_JTLMM_imperativeocl_Typedef_Class, gen_JTLMM_imperativeocl_InstantiationExp_ImperativeExpression, gen_JTLMM_imperativeocl_DictionaryType_CollectionType, gen_JTLMM_imperativeocl_DictLiteralExp_LiteralExp, gen_JTLMM_imperativeocl_AnonymousTupleLiteralPart_Element, gen_JTLMM_imperativeocl_ListType_CollectionType, gen_JTLMM_imperativeocl_TemplateParameterType_Type, gen_JTLMM_imperativeocl_LogExp_ImperativeExpression, gen_JTLMM_imperativeocl_AssertExp_ImperativeExpression, gen_JTLMM_imperativeocl_ImperativeLoopExp_essentialocl_LoopExp, gen_JTLMM_imperativeocl_ImperativeLoopExp_imperativeocl_ImperativeExpression, gen_JTLMM_imperativeocl_CollectorExp_ImperativeLoopExp, gen_JTLMM_imperativeocl_ImperativeExpression_OclExpression, gen_JTLMM_imperativeocl_UnpackExp_ImperativeExpression, gen_JTLMM_imperativeocl_AnonymousTupleType_Class, gen_JTLMM_imperativeocl_AnonymousTupleLiteralExp_LiteralExp},
    metadata=None
)
