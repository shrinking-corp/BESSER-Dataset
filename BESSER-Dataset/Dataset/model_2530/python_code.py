...
class HibernateTest_Bz398057B:
    ...
    def __init__(self, value: float, dbId: str, listOfB: "HibernateTest_Bz398057A" = None, Bz398057B: "HibernateTest_Bz398057A" = None):
        self.value = value
        self.dbId = dbId
...
class HibernateTest_Bz398057A:
    ...
    def __init__(self, dbId: str, Bz398057A: "HibernateTest_Bz398057B" = None, refToClassA: set["HibernateTest_Bz398057B"] = None):
        self.dbId = dbId
