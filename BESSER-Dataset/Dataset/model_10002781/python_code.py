...
class account_Account:
    ...
    def __init__(self, type: account_AccountType, balance: float, accountNo: str, customer0: "mypackage_Customer" = None, transactions2: set["transaction_Transaction"] = None):
        self.type = type
