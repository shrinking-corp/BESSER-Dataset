...
# Classes
effbd101_Function = Class(name="effbd101_Function")
effbd101_And = Class(name="effbd101_And")
Sequence = Class(name="Sequence")
effbd101_Or = Class(name="effbd101_Or")
SequenceNode = Class(name="SequenceNode")
ProcessNode = Class(name="ProcessNode")
effbd101_Sequence = Class(name="effbd101_Sequence", is_abstract=True)
effbd101_Flow = Class(name="effbd101_Flow")
effbd101_OutputPort = Class(name="effbd101_OutputPort")
effbd101_InputPort = Class(name="effbd101_InputPort")
effbd101_Description = Class(name="effbd101_Description")
effbd101_SequenceNode = Class(name="effbd101_SequenceNode", is_abstract=True)
effbd101_Start = Class(name="effbd101_Start")
effbd101_Final = Class(name="effbd101_Final")
effbd101_Loop = Class(name="effbd101_Loop")
Port = Class(name="Port")
effbd101_Port = Class(name="effbd101_Port", is_abstract=True)
effbd101_Item = Class(name="effbd101_Item")
effbd101_ProcessNode = Class(name="effbd101_ProcessNode", is_abstract=True)
...
domain_model = DomainModel(
    name="effbd101",
    types={effbd101_Function, effbd101_And, Sequence, effbd101_Or, SequenceNode, ProcessNode, effbd101_Sequence, effbd101_Flow, effbd101_OutputPort, effbd101_InputPort, effbd101_Description, effbd101_SequenceNode, effbd101_Start, effbd101_Final, effbd101_Loop, Port, effbd101_Port, effbd101_Item, effbd101_ProcessNode},
    ...
    generalizations={gen_effbd101_Sequence_SequenceNode, gen_effbd101_And_Sequence, gen_effbd101_Or_Sequence, gen_effbd101_Function_SequenceNode, gen_effbd101_Function_ProcessNode, gen_effbd101_Start_Sequence, gen_effbd101_Final_Sequence, gen_effbd101_Loop_Sequence, gen_effbd101_InputPort_Port, gen_effbd101_Flow_ProcessNode, gen_effbd101_OutputPort_Port},
    metadata=None
)
