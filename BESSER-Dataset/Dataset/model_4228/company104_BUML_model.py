...
# Classes
company104_Company = Class(name="company104_Company")
company104_Agency = Class(name="company104_Agency")
company104_Goal = Class(name="company104_Goal")
company104_Department = Class(name="company104_Department")
Function = Class(name="Function")
company104_Room = Class(name="company104_Room")
company104_NamedElement = Class(name="company104_NamedElement", is_abstract=True)
company104_Flow = Class(name="company104_Flow")
NamedElement = Class(name="NamedElement")
company104_Function = Class(name="company104_Function", is_abstract=True)
company104_Employee = Class(name="company104_Employee")
company104_HierarchyLink = Class(name="company104_HierarchyLink")
company104_Workstation = Class(name="company104_Workstation")
Interval = Class(name="Interval")
company104_ObjectiveReach = Class(name="company104_ObjectiveReach")
company104_Objective = Class(name="company104_Objective")
company104_Interval = Class(name="company104_Interval", is_abstract=True)
...
company104_Agency.attributes={company104_Agency_Accronym, company104_Agency_Status}
...
company104_Employee.attributes={company104_Employee_fullName, company104_Employee_address, company104_Employee_socialSecurityNumber}
...
company104_Objective.attributes={company104_Objective_value, company104_Objective_nature, company104_Objective_type}
...
company104_Interval.attributes={company104_Interval_dateFrom, company104_Interval_dateTo}
...
domain_model = DomainModel(
    name="company104",
    types={company104_Company, company104_Agency, company104_Goal, company104_Department, Function, company104_Room, company104_NamedElement, company104_Flow, NamedElement, company104_Function, company104_Employee, company104_HierarchyLink, company104_Workstation, Interval, company104_ObjectiveReach, company104_Objective, company104_Interval, Hierarchy, RoleType, ObjectiveType, ObjectiveNature},
    associations={goals1, rooms3, fromFunction4, toFunction5, hierarchies8, responsibleOf9, inChargeOf12, fromEmployee13, toEmployee16, agencies0, parent20, workstations22, owners24, reacheds33, objectives25, departments27, employees30, trgObjective35, srcAgency38, flows41},
    generalizations={gen_company104_Department_Function, gen_company104_Flow_NamedElement, gen_company104_Workstation_NamedElement, gen_company104_Goal_Interval, gen_company104_Room_Function, gen_company104_Agency_Function, gen_company104_Function_NamedElement},
    metadata=None
)
