...
# Classes
MetamodelInheritance2_ChildA = Class(name="MetamodelInheritance2_ChildA")
BaseContaineeA = Class(name="BaseContaineeA")
MetamodelInheritance2_ChildB = Class(name="MetamodelInheritance2_ChildB")
MetamodelInheritance2_ChildContaineeD = Class(name="MetamodelInheritance2_ChildContaineeD")
MetamodelInheritance2_BaseContaineeC = Class(name="MetamodelInheritance2_BaseContaineeC")
...
domain_model = DomainModel(
    ...
    associations={b0, childD1, c3, a5, d8},
