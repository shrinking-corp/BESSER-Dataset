...
def test_MetamodelInheritance2_ChildA_isa_BaseContaineeA():
    instance = MetamodelInheritance2_ChildA()
    assert isinstance(instance, BaseContaineeA)


def test_MetamodelInheritance2_ChildB_isa_BaseContaineeB():
    instance = MetamodelInheritance2_ChildB()
...
BaseContaineeA_strategy = st.builds(BaseContaineeA)
...
BaseContaineeB_strategy = st.builds(BaseContaineeB)
...
MetamodelInheritance2_BaseContaineeC_strategy = st.builds(MetamodelInheritance2_BaseContaineeC)
...
MetamodelInheritance2_ChildA_strategy = st.builds(MetamodelInheritance2_ChildA)
...
MetamodelInheritance2_ChildB_strategy = st.builds(MetamodelInheritance2_ChildB)
...
MetamodelInheritance2_ChildContaineeD_strategy = st.builds(MetamodelInheritance2_ChildContaineeD)
