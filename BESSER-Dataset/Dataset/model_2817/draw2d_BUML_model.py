...
# Classes
draw2d_Color = Class(name="draw2d_Color")
draw2d_Font = Class(name="draw2d_Font")
draw2d_Border = Class(name="draw2d_Border", is_abstract=True)
draw2d_Label = Class(name="draw2d_Label")
Figure = Class(name="Figure")
draw2d_Draw2DCanvas = Class(name="draw2d_Draw2DCanvas")
Canvas = Class(name="Canvas")
draw2d_Figure = Class(name="draw2d_Figure")
draw2d_RectangleFigure = Class(name="draw2d_RectangleFigure")
Shape = Class(name="Shape")
draw2d_RoundedRectangle = Class(name="draw2d_RoundedRectangle")
draw2d_Ellipse = Class(name="draw2d_Ellipse")
draw2d_Triangle = Class(name="draw2d_Triangle")
draw2d_PointListShape = Class(name="draw2d_PointListShape", is_abstract=True)
draw2d_Polyline = Class(name="draw2d_Polyline")
PointListShape = Class(name="PointListShape")
draw2d_Polygon = Class(name="draw2d_Polygon")
Polyline = Class(name="Polyline")
draw2d_Shape = Class(name="draw2d_Shape", is_abstract=True)
draw2d_FrameBorder = Class(name="draw2d_FrameBorder")
LabeledBorder = Class(name="LabeledBorder")
draw2d_ColoredLabeledBorder = Class(name="draw2d_ColoredLabeledBorder", is_abstract=True)
draw2d_GroupBoxBorder = Class(name="draw2d_GroupBoxBorder")
ColoredLabeledBorder = Class(name="ColoredLabeledBorder")
draw2d_TitleBarBorder = Class(name="draw2d_TitleBarBorder")
draw2d_FlowBorder = Class(name="draw2d_FlowBorder")
draw2d_PolylineShape = Class(name="draw2d_PolylineShape")
draw2d_PolygonShape = Class(name="draw2d_PolygonShape")
draw2d_ImageFigure = Class(name="draw2d_ImageFigure")
draw2d_ConnectionAnchor = Class(name="draw2d_ConnectionAnchor", is_abstract=True)
draw2d_XYAnchor = Class(name="draw2d_XYAnchor")
ConnectionAnchor = Class(name="ConnectionAnchor")
draw2d_BlockFlow = Class(name="draw2d_BlockFlow")
draw2d_LabeledBorder = Class(name="draw2d_LabeledBorder", is_abstract=True)
...
draw2d_Label.attributes={draw2d_Label_iconAlignment, draw2d_Label_icon, draw2d_Label_iconTextGap, draw2d_Label_textPlacement, draw2d_Label_text, draw2d_Label_textAlignment}
...
draw2d_Figure.attributes={draw2d_Figure_preferredSize, draw2d_Figure_bounds, draw2d_Figure_visible, draw2d_Figure_minimumSize, draw2d_Figure_focusTraversable, draw2d_Figure_enabled, draw2d_Figure_maximumSize, draw2d_Figure_opaque}
...
draw2d_Triangle.attributes={draw2d_Triangle_orientation, draw2d_Triangle_direction}
...
draw2d_Shape.attributes={draw2d_Shape_lineCap, draw2d_Shape_lineDash, draw2d_Shape_antialias, draw2d_Shape_lineStyle, draw2d_Shape_fill, draw2d_Shape_outline, draw2d_Shape_alpha, draw2d_Shape_lineWidthFloat, draw2d_Shape_lineMiterLimit, draw2d_Shape_lineDashOffset, draw2d_Shape_lineJoin, draw2d_Shape_outlineXOR, draw2d_Shape_fillXOR}
...
draw2d_FlowBorder.attributes={draw2d_FlowBorder_rightMargin, draw2d_FlowBorder_leftMargin, draw2d_FlowBorder_bottomMargin, draw2d_FlowBorder_topMargin}
...
domain_model = DomainModel(
    name="draw2d",
    types={draw2d_Color, draw2d_Font, draw2d_Border, draw2d_Label, Figure, draw2d_Draw2DCanvas, Canvas, draw2d_Figure, draw2d_RectangleFigure, Shape, draw2d_RoundedRectangle, draw2d_Ellipse, draw2d_Triangle, draw2d_PointListShape, draw2d_Polyline, PointListShape, draw2d_Polygon, Polyline, draw2d_Shape, draw2d_FrameBorder, LabeledBorder, draw2d_ColoredLabeledBorder, draw2d_GroupBoxBorder, ColoredLabeledBorder, draw2d_TitleBarBorder, draw2d_FlowBorder, draw2d_PolylineShape, draw2d_PolygonShape, draw2d_ImageFigure, draw2d_ConnectionAnchor, draw2d_XYAnchor, ConnectionAnchor, draw2d_BlockFlow, draw2d_LabeledBorder, Border, Alignment, Orientation, Direction},
    associations={children2, parent4, toolTip7, backgroundColor9, foregroundColor11, font14, border16, contents0, textColor22, owner18, font20},
    generalizations={gen_draw2d_Label_Figure, gen_draw2d_Draw2DCanvas_Canvas, gen_draw2d_RectangleFigure_Shape, gen_draw2d_RoundedRectangle_Shape, gen_draw2d_Ellipse_Shape, gen_draw2d_Triangle_Shape, gen_draw2d_PointListShape_Shape, gen_draw2d_Polyline_PointListShape, gen_draw2d_Shape_Figure, gen_draw2d_FrameBorder_LabeledBorder, gen_draw2d_ColoredLabeledBorder_LabeledBorder, gen_draw2d_GroupBoxBorder_ColoredLabeledBorder, gen_draw2d_TitleBarBorder_ColoredLabeledBorder, gen_draw2d_FlowBorder_Border, gen_draw2d_Polygon_Polyline, gen_draw2d_PolylineShape_PointListShape, gen_draw2d_PolygonShape_PointListShape, gen_draw2d_ImageFigure_Figure, gen_draw2d_XYAnchor_ConnectionAnchor, gen_draw2d_BlockFlow_Figure, gen_draw2d_LabeledBorder_Border},
    metadata=None
)
