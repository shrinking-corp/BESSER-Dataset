...
class draw2d_FlowBorder(Border):
    ...
    def __init__(self, leftMargin: int, rightMargin: int, topMargin: int, bottomMargin: int):
...
class draw2d_Figure:
    ...
    def __init__(self, enabled: bool, visible: bool, opaque: bool, focusTraversable: bool, bounds: str, minimumSize: str, preferredSize: str, maximumSize: str, Figure: "draw2d_Figure" = None, parent: set["draw2d_Figure"] = None, Figure5: "draw2d_Figure" = None, children: "draw2d_Figure" = None, draw2d_Figure8: "draw2d_Figure" = None, draw2d_Figure6: "draw2d_Figure" = None, draw2d_Figure10: "draw2d_Color" = None, draw2d_Figure12: "draw2d_Color" = None, draw2d_Figure15: "draw2d_Font" = None, draw2d_Figure17: "draw2d_Border" = None, draw2d_Figure: "draw2d_Draw2DCanvas" = None, draw2d_Figure19: "draw2d_ConnectionAnchor" = None):
...
class draw2d_Shape(Figure):
    ...
    def __init__(self, lineDash: float, lineDashOffset: float, lineMiterLimit: float, fill: bool, fillXOR: bool, outline: bool, outlineXOR: bool, alpha: str, antialias: str, lineWidthFloat: float, lineStyle: str, lineCap: str, lineJoin: str):
