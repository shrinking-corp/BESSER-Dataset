...
Salary.attributes={Salary_Sly_Increment, Salary_Sly_Decrement, Salary_Emp_Id, Salary_Sly_Netgross, Salary_Sly_Basic, Salary_OverTime}
...
Leave.attributes={Leave_Leave_detail, Leave_Leave_ApplyDate, Leave_Leave_NoOfDays, Leave_Leave_EndDate, Leave_Leave_Status, Leave_Emp_Id, Leave_Leave_Title, Leave_Leave_StartDate, Leave_leave_id}
...
Attendance.attributes={Attendance_Attend_date, Attendance_Leaving_Time, Attendance_AttendTime, Attendance_Emp_id}
...
Employee.attributes={Employee_Emp_Name, Employee_Emp_NIC, Employee_Emp_DOB, Employee_Emp_Position, Employee_Emp_Email, Employee_Emp_Salary, Employee_Emp_Id, Employee_Emp_Department, Employee_Emp_Date_Of_Joint, Employee_Emp_ContactNo, Employee_Emp_Address}
...
domain_model = DomainModel(
    name="_4ca0ccec_9e6e_4a2a_9c30_5a95d29defc7",
    types={Salary, Authenticate_staff, Leave, Attendance, Login, Employee_Management_System_Component, Authentication_UseCase, Salary_Management_UseCase, Administrator_Actor, Employee_Actor, Employee, Login_external, Logout_external},
