...
public class Leave  {
    ...
    public Leave(
        LocalDate Leave_StartDate,        int leave_id,        LocalDate Leave_ApplyDate,        LocalDate Leave_EndDate,        int Emp_Id,        String Leave_Status,        int Leave_NoOfDays,        String Leave_detail,        String Leave_Title    ) {
