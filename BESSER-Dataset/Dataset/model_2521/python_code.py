...
class codemodel_expressions_BinExp(Expression):
    ...
    def __init__(self, operator: str, codemodel_expressions_BinExp: "Expression" = None, codemodel_expressions_BinExp7: "Expression" = None, Expression13: "codemodel_statements_AsgnStmt" = None, Expression: "codemodel_expressions_BinExp" = None, Expression10: "codemodel_statements_AsgnStmt" = None, Expression8: "codemodel_expressions_BinExp" = None):
