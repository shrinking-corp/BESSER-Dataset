...
domain_model = DomainModel(
    name="codemodel",
    types={codemodel_D, codemodel_E, codemodel_expressions_Expression, codemodel_expressions_VarExp, Expression, expressions_codemodel_Variable, codemodel_expressions_BinExp, codemodel_CMElement, codemodel_CodeModel, CMElement, codemodel_Variable, Statement, codemodel_statements_Statement, codemodel_statements_AsgnStmt, codemodel_statements_CompStmt},
    associations={refE3, variable4, left5, right6, vars0, stmts1, leftExp9, rightExp11, statements14},
    generalizations={gen_codemodel_D_CMElement, gen_codemodel_E_CMElement, gen_codemodel_expressions_Expression_CMElement, gen_codemodel_expressions_VarExp_Expression, gen_codemodel_expressions_BinExp_Expression, gen_codemodel_CodeModel_CMElement, gen_codemodel_Variable_CMElement, gen_codemodel_statements_Statement_CMElement, gen_codemodel_statements_AsgnStmt_Statement, gen_codemodel_statements_CompStmt_Statement},
    metadata=None
)
