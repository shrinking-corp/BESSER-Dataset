...
fsmSample_Action_m_run: Method = Method(name="run", parameters={Parameter(name='fsmSample_sync', type=StringType)}, type=StringType)
...
domain_model = DomainModel(
    ...
    associations={ownedState0, initialState1, action16, finalState2, currentState5, owningFSM8, outgoingTransition9, incomingTransition10, source12, target14},
    generalizations={},
    metadata=None
)
