...
class fsmSample_Transition:
    ...
    def __init__(self, output: str, input: str, fsmSample_Transition: "fsmSample_Action" = None, Transition: "fsmSample_State" = None, Transition11: "fsmSample_State" = None, outgoingTransition: "fsmSample_State" = None, incomingTransition: "fsmSample_State" = None):
        self.output = output
        self.input = input
