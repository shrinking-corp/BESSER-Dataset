...
mypackage_Assignment = Class(name="mypackage_Assignment")
mypackage_Book = Class(name="mypackage_Book")
mypackage_Exceptions = Class(name="mypackage_Exceptions")
...
mypackage_Perosn_Pass: Property = Property(name="Pass", type=StringType)
mypackage_Perosn.attributes={mypackage_Perosn_fName, mypackage_Perosn_UserName, mypackage_Perosn_id, mypackage_Perosn_lname, mypackage_Perosn_age, mypackage_Perosn_Pass}
...
mypackage_Student.attributes={mypackage_Student_studentFileName, mypackage_Student_grade, mypackage_Student_level}
...
mypackage_Tutor_WorkingHours: Property = Property(name="WorkingHours", type=StringType)
mypackage_Tutor.attributes={mypackage_Tutor_WorkingHours, mypackage_Tutor_TutorFileName}
...
mypackage_Course.attributes={mypackage_Course_CId, mypackage_Course_CourseFileName, mypackage_Course_CreditHours, mypackage_Course_CName}
...
mypackage_Exam.attributes={mypackage_Exam_ExamsFileName, mypackage_Exam_MaxGrade, mypackage_Exam_EName, mypackage_Exam_EId}

# mypackage_FileManager class attributes and methods

# mypackage_Assignment class attributes and methods
mypackage_Assignment_number: Property = Property(name="number", type=IntegerType)
mypackage_Assignment_StrartDate: Property = Property(name="StrartDate", type=StringType)
mypackage_Assignment_Deadline: Property = Property(name="Deadline", type=StringType)
mypackage_Assignment.attributes={mypackage_Assignment_number, mypackage_Assignment_StrartDate, mypackage_Assignment_Deadline}

# mypackage_Book class attributes and methods
mypackage_Book_BName: Property = Property(name="BName", type=StringType)
mypackage_Book_BId: Property = Property(name="BId", type=StringType)
mypackage_Book_Price: Property = Property(name="Price", type=StringType)
mypackage_Book.attributes={mypackage_Book_BName, mypackage_Book_BId, mypackage_Book_Price}

# mypackage_Exceptions class attributes and methods
...
Course_Assignment: BinaryAssociation = BinaryAssociation(
    name="Course_Assignment",
    ends={
        Property(name="assignment8", type=mypackage_Assignment, multiplicity=Multiplicity(0, 1)),
        Property(name="course9", type=mypackage_Course, multiplicity=Multiplicity(0, 1))
    }
)
Tutor_Assignment: BinaryAssociation = BinaryAssociation(
    name="Tutor_Assignment",
    ends={
        Property(name="assignment10", type=mypackage_Assignment, multiplicity=Multiplicity(0, 1)),
        Property(name="tutor11", type=mypackage_Tutor, multiplicity=Multiplicity(0, 1))
    }
)
Student_Assignment: BinaryAssociation = BinaryAssociation(
    name="Student_Assignment",
    ends={
        Property(name="assignment12", type=mypackage_Assignment, multiplicity=Multiplicity(0, 1)),
        Property(name="student13", type=mypackage_Student, multiplicity=Multiplicity(0, 1))
    }
)
Course_Book: BinaryAssociation = BinaryAssociation(
    name="Course_Book",
    ends={
        Property(name="book14", type=mypackage_Book, multiplicity=Multiplicity(0, 1)),
        Property(name="course15", type=mypackage_Course, multiplicity=Multiplicity(0, 1))
    }
)
Book_FileManager: BinaryAssociation = BinaryAssociation(
    name="Book_FileManager",
    ends={
        Property(name="fileManager16", type=mypackage_FileManager, multiplicity=Multiplicity(0, 1)),
        Property(name="book17", type=mypackage_Book, multiplicity=Multiplicity(0, 1))
    }
)

# Domain Model
domain_model = DomainModel(
    name="_n_Kd4NaYEeehRMl7r1_c5g",
    types={mypackage_Perosn, mypackage_Staff, mypackage_Student, mypackage_studentAffairsEmp, mypackage_Tutor, mypackage_Admin, mypackage_Course, mypackage_Exam, mypackage_FileManager, mypackage_Assignment, mypackage_Book, mypackage_Exceptions, Class_},
    associations={Course_Exam, FileManager_Perosn, FileManager_Course, FileManager_Exam, Course_Assignment, Tutor_Assignment, Student_Assignment, Course_Book, Book_FileManager},
    generalizations={},
    metadata=None
)
