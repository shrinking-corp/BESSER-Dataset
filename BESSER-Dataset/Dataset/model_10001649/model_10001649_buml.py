...
C_attC2: Property = Property(name="attC2", type=IntegerType)
...
B_C2: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="b5", type=B1, multiplicity=Multiplicity(0, 9999))
    }
)
...
domain_model = DomainModel(
    name="_LfgSsM6_EeeMV96X50GAvA",
    types={A, B, C, R, Y, A1, Z, B1, C1, C2, C3},
    associations={B_C, B_C2, A_B2, R_A, A_B},
    generalizations={},
    metadata=None
)
