...
def test_traceability_cps2deplyomenttrace_is_not_abstract():
    assert not inspect.isabstract(traceability_CPS2DeplyomentTrace)


def test_traceability_cps2deplyomenttrace_constructor_exists():
    assert callable(traceability_CPS2DeplyomentTrace.__init__)


def test_traceability_cps2deplyomenttrace_constructor_args():
    sig = inspect.signature(traceability_CPS2DeplyomentTrace.__init__)
    params = list(sig.parameters.keys())
...
traceability_CPS2DeplyomentTrace_strategy = st.builds(
    traceability_CPS2DeplyomentTrace,
)
