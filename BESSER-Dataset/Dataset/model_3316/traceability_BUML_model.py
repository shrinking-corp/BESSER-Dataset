...
# Classes
traceability_Deployment = Class(name="traceability_Deployment")
traceability_CPS2DeplyomentTrace = Class(name="traceability_CPS2DeplyomentTrace")
traceability_CPSToDeployment = Class(name="traceability_CPSToDeployment")
traceability_CyberPhysicalSystem = Class(name="traceability_CyberPhysicalSystem")
traceability_Identifiable = Class(name="traceability_Identifiable")
traceability_DeploymentElement = Class(name="traceability_DeploymentElement")
...
domain_model = DomainModel(
    name="traceability",
    types={traceability_Deployment, traceability_CPS2DeplyomentTrace, traceability_CPSToDeployment, traceability_CyberPhysicalSystem, traceability_Identifiable, traceability_DeploymentElement},
