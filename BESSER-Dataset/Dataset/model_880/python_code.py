...
class simplepdl_WorkDefinition(ProcessElement):
    ...
    def __init__(self, name: str, workdefinition: set["simplepdl_Allocation"] = None, WorkDefinition15: "simplepdl_Allocation" = None, WorkDefinition: "simplepdl_WorkSequence" = None, WorkDefinition7: "simplepdl_WorkSequence" = None, successor: set["simplepdl_WorkSequence"] = None, predecessor: set["simplepdl_WorkSequence"] = None):
        self.name = name
