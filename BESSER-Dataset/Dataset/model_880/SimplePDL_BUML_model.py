...
domain_model = DomainModel(
    name="simplepdl",
    types={simplepdl_Guidance, simplepdl_Ressource, simplepdl_Process, simplepdl_ProcessElement, simplepdl_WorkDefinition, ProcessElement, simplepdl_WorkSequence, simplepdl_Allocation, WorkSequenceType},
    associations={predecessor5, successor6, process8, elements11, processElement0, linksToPredecessors1, linksToSuccessors2, allocation4, ressource13, workdefinition14},
    generalizations={gen_simplepdl_WorkSequence_ProcessElement, gen_simplepdl_Guidance_ProcessElement, gen_simplepdl_Ressource_ProcessElement, gen_simplepdl_WorkDefinition_ProcessElement},
    metadata=None
)
