...
Employee.attributes={Employee_employeeName, Employee_jobLevel, Employee_employeeId, Employee_password, Employee_leavesTaken, Employee_managerId, Employee_noOfLeaves}
...
LeaveApplication.attributes={LeaveApplication_reason, LeaveApplication_fromDate, LeaveApplication_status, LeaveApplication_applicationId, LeaveApplication_employeeId, LeaveApplication_approverComments, LeaveApplication_toDate}
...
Application_GenerateSummary: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="generateSummary24", type=_UseCase, multiplicity=Multiplicity(0, 1)),
...
domain_model = DomainModel(
    name="_0c75b8dd_63d3_46f1_8df3_53a97860f9ce",
    types={Login_UseCase, Query_Leave_Balance_UseCase, Query_Leave_History_UseCase, Apply_Leave_UseCase, Leave_Request_Status_UseCase, Withdraw_Application_UseCase, Approver_Jobs_UseCase, Approve_RejectRequests_UseCase, Cancel_Leaves_UseCase, Admin_Actor, CreateUser_UseCase, Update_Calendar_UseCase, Application_Actor, SendNotification_UseCase, Credit_Leaves_UseCase, AutoApproval_UseCase, _UseCase, Employee, Query, EligibilityQuery, LeaveBalanceQuery, LeaveHistoryQuery, LeaveApplication, Request, ApplyLeaveRequest, WithdrawLeaveRequest, CancelLeaveRequest, LeaveStatusQuery, ApproveOrRejectStatus, LoginAction, CreateUserAction, UpdateCalendar, ApplicationUtils, Employee_Actor, Change_Password_UseCase, Query_Eligibility_UseCase, LeaveStatus},
