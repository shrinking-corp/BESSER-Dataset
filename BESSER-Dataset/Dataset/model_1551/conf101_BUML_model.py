...
# Classes
conf101_Laboratory = Class(name="conf101_Laboratory")
conf101_Conference = Class(name="conf101_Conference")
conf101_RevisionProcess = Class(name="conf101_RevisionProcess")
conf101_Session = Class(name="conf101_Session")
conf101_Location = Class(name="conf101_Location")
conf101_ProgramComitee = Class(name="conf101_ProgramComitee")
conf101_SteeringComitee = Class(name="conf101_SteeringComitee")
conf101_Contribution = Class(name="conf101_Contribution")
conf101_System = Class(name="conf101_System")
NamedElement = Class(name="NamedElement")
conf101_Admin = Class(name="conf101_Admin")
Person = Class(name="Person")
conf101_Evaluation = Class(name="conf101_Evaluation")
conf101_Chapter = Class(name="conf101_Chapter")
conf101_RevisionNote = Class(name="conf101_RevisionNote")
conf101_Person = Class(name="conf101_Person")
conf101_Researcher = Class(name="conf101_Researcher")
conf101_Publication = Class(name="conf101_Publication")
conf101_NamedElement = Class(name="conf101_NamedElement")
...
domain_model = DomainModel(
    name="conf101",
    types={conf101_Laboratory, conf101_Conference, conf101_RevisionProcess, conf101_Session, conf101_Location, conf101_ProgramComitee, conf101_SteeringComitee, conf101_Contribution, conf101_System, NamedElement, conf101_Admin, Person, conf101_Evaluation, conf101_Chapter, conf101_RevisionNote, conf101_Person, conf101_Researcher, conf101_Publication, conf101_NamedElement},
    associations={admin0, laboratories1, conferences3, revisionProcess5, location7, progcomit8, steercomit10, contributions12, locations14, sessions17, evaluations24, writes26, reviews28, publications30, chapters33, revisonNotes36, researchers20, publications22, pcPerson41, publication44, evPubli47, scPerson39},
    generalizations={gen_conf101_Session_NamedElement, gen_conf101_Location_NamedElement, gen_conf101_Admin_NamedElement, gen_conf101_Conference_NamedElement, gen_conf101_Laboratory_NamedElement, gen_conf101_System_NamedElement, gen_conf101_Researcher_Person, gen_conf101_Publication_NamedElement, gen_conf101_Person_NamedElement, gen_conf101_Chapter_NamedElement, gen_conf101_ProgramComitee_NamedElement, gen_conf101_Contribution_NamedElement, gen_conf101_Evaluation_NamedElement, gen_conf101_SteeringComitee_NamedElement},
    metadata=None
)
