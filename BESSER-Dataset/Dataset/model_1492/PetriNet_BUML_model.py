...
domain_model = DomainModel(
    name="PetriNet",
    types={PetriNet_LocatedElement, PetriNet_Place, Element, PetriNet_Transition, PetriNet_NamedElement, LocatedElement, PetriNet_PetriNet, NamedElement, PetriNet_Element},
    associations={elements0, net1, incomingArc2, outgoingArc3, incomingArc5, outgoingArc7},
    generalizations={gen_PetriNet_Element_NamedElement, gen_PetriNet_Place_Element, gen_PetriNet_Transition_Element, gen_PetriNet_NamedElement_LocatedElement, gen_PetriNet_PetriNet_NamedElement},
    metadata=None
)
