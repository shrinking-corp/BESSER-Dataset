...
class iTrace_Block:
    ...
    def __init__(self, startColumn: int, endColumn: int, blockNumber: int, startLine: int, endLine: int, Block17: "iTrace_Code" = None, Block: "iTrace_M2TLink" = None, blocks: "iTrace_Code" = None, targetBlocks: "iTrace_M2TLink" = None):
...
class iTrace_TraceLinkElement(ABC):
    ...
    def __init__(self, ref: str, type: str, elements: "iTrace_Model" = None, iTrace_TraceLinkElement: "iTrace_EObject" = None, TraceLinkElement: "iTrace_Model" = None):
        self.ref = ref
        self.type = type
