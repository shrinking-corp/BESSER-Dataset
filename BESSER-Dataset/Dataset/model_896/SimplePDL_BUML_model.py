...
simplepdl_Resources = Class(name="simplepdl_Resources")
...
simplepdl_RequeteDeRessource = Class(name="simplepdl_RequeteDeRessource")
simplepdl_GuidanceLink = Class(name="simplepdl_GuidanceLink")
...
simplepdl_Resources.attributes={simplepdl_Resources_name, simplepdl_Resources_quantite}
...
domain_model = DomainModel(
    name="simplepdl",
    types={simplepdl_Guidance, simplepdl_Resources, simplepdl_Process, simplepdl_ProcessElement, simplepdl_WorkDefinition, ProcessElement, simplepdl_WorkSequence, simplepdl_RequeteDeRessource, simplepdl_GuidanceLink, WorkSequenceType},
    associations={predecessor5, successor6, elements8, processElements0, linksToPredecessors1, linksToSuccessors2, linktoresource4, linktoresource10, resources12, workdefinition13, guidance16, workdefinition18},
    generalizations={gen_simplepdl_Guidance_ProcessElement, gen_simplepdl_Resources_ProcessElement, gen_simplepdl_WorkDefinition_ProcessElement, gen_simplepdl_WorkSequence_ProcessElement, gen_simplepdl_RequeteDeRessource_ProcessElement, gen_simplepdl_GuidanceLink_ProcessElement},
    metadata=None
)
