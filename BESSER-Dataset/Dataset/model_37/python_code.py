...
class petrinet_Arc:
    ...
    def __init__(self, weight: int, petrinet_Arc: "petrinet_PetriNet" = None, petrinet_Arc4: "petrinet_Node" = None, petrinet_Arc7: "petrinet_Node" = None):
        self.weight = weight
...
class petrinet_Node(ABC):
    ...
    def __init__(self, name: str, petrinet_Node5: "petrinet_Arc" = None, petrinet_Node8: "petrinet_Arc" = None, petrinet_Node: "petrinet_PetriNet" = None):
        self.name = name
