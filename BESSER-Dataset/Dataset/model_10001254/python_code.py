...
class Conta_Conta:
    ...
    def __init__(self, contanum: str, type: Conta_AccountType, balance: float, customer0: "Cliente" = None, transactions2: set["transaction_Transaction"] = None):
    ...
    @property
    def contanum(self):
        return self.__contanum
    @contanum.setter
    def contanum(self, contanum: str):
        self.__contanum = contanum

    @property
    def type(self):
        return self.__type
    @type.setter
    def type(self, type: Conta_AccountType):
        self.__type = type
    ...
    def customer0(self, value):
        ...
        old_value = getattr(self, f"_Conta_Conta__customer0", None)
    ...
    def transactions2(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Conta_Conta__transactions2", None)
...
class Conta_CertificatesOfDepositAccount:
...
class transaction_TransferTransaction:
    ...
    def __init__(self, targetAccount: Conta_Conta, sourceAccount: Conta_Conta):
    ...
    def sourceAccount(self, sourceAccount: Conta_Conta):
    ...
    def targetAccount(self, targetAccount: Conta_Conta):
...
class transaction_Transaction:
    ...
    def __init__(self, id: int, type: transaction_TransactionType, transactionTime: date, amount: float, account3: "Conta_Conta" = None):
        self.id = id
        self.type = type
...
class Login:
    ...
    def __init__(self, username: str, securityAnswer: str, password: str, securityQuestion: str, lastLoginTime: date, customer5: "Cliente" = None):
...
class Cliente:
    ...
    def __init__(self, name: str, dateOfBirth: date, address: str, phoneNumber: str, emailAddress: str, a1: set["Conta_Conta"] = None, login4: "Login" = None):
        self.name = name
    ...
    def login4(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Cliente__login4", None)
        self.__login4 = value
    ...
    def a1(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Cliente__a1", None)
