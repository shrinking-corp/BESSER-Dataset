...
public class ram_StateMachine  {
    ...
    private List<ram_Substitution> ram_substitutions;
    ...
    public ram_StateMachine(
        ...
        this.ram_substitutions = new ArrayList<>();
        this.ram_transitions = new ArrayList<>();
        this.ram_checkstates = new ArrayList<>();
    }

    public ram_StateMachine(
        ArrayList<ram_Substitution> ram_substitutions,        ArrayList<ram_Transition> ram_transitions,        ArrayList<ram_CheckState> ram_checkstates    ) {
        this.ram_substitutions = ram_substitutions;
        this.ram_transitions = ram_transitions;
        this.ram_checkstates = ram_checkstates;
    }


    public List<ram_Substitution> getRam_substitutions() {
        return ram_substitutions;
    }

    public void addRam_substitution(Ram_substitution ram_substitution) {
        this.ram_substitutions.add(ram_substitution);
    }
