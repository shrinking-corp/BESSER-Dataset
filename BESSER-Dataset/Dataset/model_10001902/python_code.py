...
class ShoppinCart:
    ...
    def __init__(self, creationDate: date, webuser8: "WebUser" = None, account17: "Account" = None, items18: set["LineItem"] = None, shoppinCart20: "ShoppinCart" = None, shoppinCart21: "ShoppinCart" = None):
        self.creationDate = creationDate
        self.webuser8 = webuser8
        self.account17 = account17
        self.items18 = items18 if items18 is not None else set()
        self.shoppinCart20 = shoppinCart20
        self.shoppinCart21 = shoppinCart21
    ...
    @property
    def shoppinCart20(self):
        return self.__shoppinCart20
    @shoppinCart20.setter
    def shoppinCart20(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_ShoppinCart__shoppinCart20", None)
        self.__shoppinCart20 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "shoppinCart21"):
                opp_val = getattr(old_value, "shoppinCart21", None)
                if opp_val == self:
                    setattr(old_value, "shoppinCart21", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "shoppinCart21"):
                opp_val = getattr(value, "shoppinCart21", None)
                setattr(value, "shoppinCart21", self)
    ...
    @property
    def shoppinCart21(self):
        return self.__shoppinCart21
    @shoppinCart21.setter
    def shoppinCart21(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_ShoppinCart__shoppinCart21", None)
        self.__shoppinCart21 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "shoppinCart20"):
                opp_val = getattr(old_value, "shoppinCart20", None)
                if opp_val == self:
                    setattr(old_value, "shoppinCart20", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "shoppinCart20"):
                opp_val = getattr(value, "shoppinCart20", None)
                setattr(value, "shoppinCart20", self)
...
class LineItem:
    ...
    def __init__(self, quantity: int, price: float, product13: "Product" = None, lineitem15: set["Order"] = None, sc19: "ShoppinCart" = None):
...
class Order:
    ...
    def __init__(self, number: int, ordered: date, shipped: bool, shipTo: str, total: float, status: OrderStatus, order3: set["Payment"] = None, account5: "Account" = None, items14: set["LineItem"] = None):
        self.number = number
...
class WebUser:
    ...
    def __init__(self, login: str, password: str, state: UserState, customer6: "Customer" = None, shoppincart9: "ShoppinCart" = None):
        self.login = login
...
class Account:
    ...
    def __init__(self, billingAddress: str, open: date, closed: date, isClosed: bool, payment0: set["Payment"] = None, order4: set["Order"] = None, customer11: "Customer" = None, cart16: "ShoppinCart" = None):
