...
Account.attributes={Account_billingAddress, Account_isClosed, Account_closed, Account_open}
...
Order.attributes={Order_status, Order_shipTo, Order_number, Order_shipped, Order_ordered, Order_total}
...
ShoppinCart_ShoppinCart: BinaryAssociation = BinaryAssociation(
    name="ShoppinCart_ShoppinCart",
    ends={
        Property(name="shoppinCart20", type=ShoppinCart, multiplicity=Multiplicity(0, 1)),
        Property(name="shoppinCart21", type=ShoppinCart, multiplicity=Multiplicity(0, 1))
    }
)

# Domain Model
domain_model = DomainModel(
    name="_cEb9oHDfEeqhRdvvYtDJdw",
    types={Account, WebUser, Order, LineItem, Product, Customer, Payment, ShoppinCart, UserState, OrderStatus},
    associations={Account_Payment, Payment_Order, Account_Order, WebUser_Customer, ShoppinCart_WebUser, Customer_Account, Product_LineItem, Order_LineItem, Account_ShoppinCart, ShoppinCart_LineItem, ShoppinCart_ShoppinCart},
    generalizations={},
    metadata=None
)
