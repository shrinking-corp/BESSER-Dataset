...
# Classes
jsflibraryregistry_JSFLibraryRegistry = Class(name="jsflibraryregistry_JSFLibraryRegistry")
jsflibraryregistry_ArchiveFile = Class(name="jsflibraryregistry_ArchiveFile")
JSFLibrary = Class(name="JSFLibrary")
jsflibraryregistry_JSFLibrary = Class(name="jsflibraryregistry_JSFLibrary")
jsflibraryregistry_PluginProvidedJSFLibrary = Class(name="jsflibraryregistry_PluginProvidedJSFLibrary")
...
jsflibraryregistry_JSFLibraryRegistry_m_getJSFLibraryByID: Method = Method(name="getJSFLibraryByID", parameters={Parameter(name='jsflibraryregistry_ID', type=StringType)}, type=StringType)
jsflibraryregistry_JSFLibraryRegistry_m_getJSFLibrariesByName: Method = Method(name="getJSFLibrariesByName", parameters={Parameter(name='jsflibraryregistry_name', type=StringType)}, type=StringType)
...
jsflibraryregistry_JSFLibraryRegistry_m_addJSFLibrary: Method = Method(name="addJSFLibrary", parameters={Parameter(name='jsflibraryregistry_library', type=StringType)}, type=BooleanType)
jsflibraryregistry_JSFLibraryRegistry_m_removeJSFLibrary: Method = Method(name="removeJSFLibrary", parameters={Parameter(name='jsflibraryregistry_library', type=StringType)}, type=BooleanType)
...
jsflibraryregistry_JSFLibraryRegistry_m_setDefaultImplementation: Method = Method(name="setDefaultImplementation", parameters={Parameter(name='jsflibraryregistry_implementation', type=StringType)})
jsflibraryregistry_JSFLibraryRegistry.attributes={jsflibraryregistry_JSFLibraryRegistry_DefaultImplementationID}
jsflibraryregistry_JSFLibraryRegistry.methods={jsflibraryregistry_JSFLibraryRegistry_m_getNonImplJSFLibraries, jsflibraryregistry_JSFLibraryRegistry_m_addJSFLibrary, jsflibraryregistry_JSFLibraryRegistry_m_getImplJSFLibraries, jsflibraryregistry_JSFLibraryRegistry_m_setDefaultImplementation, jsflibraryregistry_JSFLibraryRegistry_m_removeJSFLibrary, jsflibraryregistry_JSFLibraryRegistry_m_getJSFLibrariesByName, jsflibraryregistry_JSFLibraryRegistry_m_getDefaultImplementation, jsflibraryregistry_JSFLibraryRegistry_m_getJSFLibraryByID, jsflibraryregistry_JSFLibraryRegistry_m_getAllJSFLibraries}
...
jsflibraryregistry_ArchiveFile_m_equals: Method = Method(name="equals", parameters={Parameter(name='jsflibraryregistry_object', type=StringType)}, type=BooleanType)
jsflibraryregistry_ArchiveFile_m_hashCode: Method = Method(name="hashCode", parameters={}, type=IntegerType)
jsflibraryregistry_ArchiveFile_m_copyTo: Method = Method(name="copyTo", parameters={Parameter(name='jsflibraryregistry_baseDestLocation', type=StringType)}, type=BooleanType)
...
jsflibraryregistry_ArchiveFile.attributes={jsflibraryregistry_ArchiveFile_RelativeToWorkspace, jsflibraryregistry_ArchiveFile_SourceLocation, jsflibraryregistry_ArchiveFile_RelativeDestLocation}
jsflibraryregistry_ArchiveFile.methods={jsflibraryregistry_ArchiveFile_m_hashCode, jsflibraryregistry_ArchiveFile_m_getName, jsflibraryregistry_ArchiveFile_m_equals, jsflibraryregistry_ArchiveFile_m_getPath, jsflibraryregistry_ArchiveFile_m_exists, jsflibraryregistry_ArchiveFile_m_copyTo, jsflibraryregistry_ArchiveFile_m_getResolvedSourceLocation}
...
jsflibraryregistry_JSFLibrary_m_containsArchiveFile: Method = Method(name="containsArchiveFile", parameters={Parameter(name='jsflibraryregistry_fullPath', type=StringType)}, type=BooleanType)
jsflibraryregistry_JSFLibrary_m_getWorkingCopy: Method = Method(name="getWorkingCopy", parameters={}, type=StringType)
jsflibraryregistry_JSFLibrary_m_updateValues: Method = Method(name="updateValues", parameters={Parameter(name='jsflibraryregistry_otherLibrary', type=StringType)})
jsflibraryregistry_JSFLibrary_m_copyTo: Method = Method(name="copyTo", parameters={Parameter(name='jsflibraryregistry_baseDestLocation', type=StringType)}, type=BooleanType)
jsflibraryregistry_JSFLibrary_m_getLabel: Method = Method(name="getLabel", parameters={}, type=StringType)
jsflibraryregistry_JSFLibrary.attributes={jsflibraryregistry_JSFLibrary_Name, jsflibraryregistry_JSFLibrary_Implementation, jsflibraryregistry_JSFLibrary_Deployed, jsflibraryregistry_JSFLibrary_ID, jsflibraryregistry_JSFLibrary_JSFVersion}
jsflibraryregistry_JSFLibrary.methods={jsflibraryregistry_JSFLibrary_m_containsArchiveFile, jsflibraryregistry_JSFLibrary_m_updateValues, jsflibraryregistry_JSFLibrary_m_getWorkingCopy, jsflibraryregistry_JSFLibrary_m_getLabel, jsflibraryregistry_JSFLibrary_m_copyTo}
...
domain_model = DomainModel(
    ...
    types={jsflibraryregistry_JSFLibraryRegistry, jsflibraryregistry_ArchiveFile, JSFLibrary, jsflibraryregistry_JSFLibrary, jsflibraryregistry_PluginProvidedJSFLibrary, JSFVersion},
    associations={ArchiveFiles3, JSFLibraries0, PluginProvidedJSFLibraries1, JSFLibrary4},
