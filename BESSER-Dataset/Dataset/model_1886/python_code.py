...
class jsflibraryregistry_JSFLibrary:
    ...
    def __init__(self, JSFVersion: str, Deployed: bool, Implementation: bool, ID: str, Name: str, JSFLibrary: set["jsflibraryregistry_ArchiveFile"] = None, jsflibraryregistry_JSFLibrary: "jsflibraryregistry_JSFLibraryRegistry" = None, JSFLibrary5: "jsflibraryregistry_ArchiveFile" = None):
