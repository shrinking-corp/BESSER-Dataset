...
def test_installableunitreference_is_not_abstract():
    assert not inspect.isabstract(InstallableUnitReference)


def test_installableunitreference_constructor_exists():
    assert callable(InstallableUnitReference.__init__)


def test_installableunitreference_constructor_args():
...
def test_aggregator_installableunitreference_is_not_abstract():
    assert not inspect.isabstract(aggregator_InstallableUnitReference)


def test_aggregator_installableunitreference_constructor_exists():
    assert callable(aggregator_InstallableUnitReference.__init__)


def test_aggregator_installableunitreference_constructor_args():
...
@given(instance=aggregator_InstallableUnitReference_strategy)
@settings(max_examples=30)
def test_aggregator_installableunitreference_ismappedrepositorybroken_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
...
@given(instance=aggregator_InstallableUnitReference_strategy)
@settings(max_examples=30)
def test_aggregator_installableunitreference_isbranchenabled_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
        instance.isBranchEnabled()
