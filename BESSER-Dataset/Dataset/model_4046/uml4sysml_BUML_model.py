...
# Classes
uml_UML_NamedElement = Class(name="uml_UML_NamedElement")
uml_UML_RedefinableElement = Class(name="uml_UML_RedefinableElement")
UML_NamedElement = Class(name="UML_NamedElement")
uml_UML_Feature = Class(name="uml_UML_Feature")
UML_RedefinableElement = Class(name="UML_RedefinableElement")
uml_UML_Namespace = Class(name="uml_UML_Namespace")
uml_UML_Constraint = Class(name="uml_UML_Constraint")
uml_UML_Operation = Class(name="uml_UML_Operation")
uml_UML_Property = Class(name="uml_UML_Property")
uml_UML_InterfaceRealization = Class(name="uml_UML_InterfaceRealization")
uml_UML_BehavioredClassifier = Class(name="uml_UML_BehavioredClassifier")
uml_UML_Behavior = Class(name="uml_UML_Behavior")
UML_BehavioralFeature = Class(name="UML_BehavioralFeature")
uml_UML_Class = Class(name="uml_UML_Class")
UML_BehavioredClassifier = Class(name="UML_BehavioredClassifier")
UML_StructuralFeature = Class(name="UML_StructuralFeature")
UML_ConnectableElement = Class(name="UML_ConnectableElement")
uml_UML_Package = Class(name="uml_UML_Package")
UML_Namespace = Class(name="UML_Namespace")
uml_UML_PackageableElement = Class(name="uml_UML_PackageableElement")
uml_UML_BehavioralFeature = Class(name="uml_UML_BehavioralFeature")
UML_Feature = Class(name="UML_Feature")
uml_UML_StructuralFeature = Class(name="uml_UML_StructuralFeature")
UML_TypedElement = Class(name="UML_TypedElement")
uml_UML_Type = Class(name="uml_UML_Type")
UML_PackageableElement = Class(name="UML_PackageableElement")
uml_UML_TypedElement = Class(name="uml_UML_TypedElement")
uml_UML_Classifier = Class(name="uml_UML_Classifier")
UML_Type = Class(name="UML_Type")
uml_UML_Interface = Class(name="uml_UML_Interface")
UML_Classifier = Class(name="UML_Classifier")
uml_UML_ValueSpecification = Class(name="uml_UML_ValueSpecification")
uml_UML_OpaqueExpression = Class(name="uml_UML_OpaqueExpression")
UML_ValueSpecification = Class(name="UML_ValueSpecification")
uml_UML_Port = Class(name="uml_UML_Port")
UML_Property = Class(name="UML_Property")
UML_Class = Class(name="UML_Class")
uml_UML_Activity = Class(name="uml_UML_Activity")
UML_Behavior = Class(name="UML_Behavior")
uml_UML_ActivityEdge = Class(name="uml_UML_ActivityEdge")
uml_UML_ActivityNode = Class(name="uml_UML_ActivityNode")
uml_UML_ConnectableElement = Class(name="uml_UML_ConnectableElement")
uml_UML_Connector = Class(name="uml_UML_Connector")
uml_UML_ConnectorEnd = Class(name="uml_UML_ConnectorEnd")
uml_UML_CallOperationAction = Class(name="uml_UML_CallOperationAction")
UML_Action = Class(name="UML_Action")
uml_UML_Action = Class(name="uml_UML_Action")
UML_ActivityNode = Class(name="UML_ActivityNode")
...
domain_model = DomainModel(
    name="uml",
    types={uml_UML_NamedElement, uml_UML_RedefinableElement, UML_NamedElement, uml_UML_Feature, UML_RedefinableElement, uml_UML_Namespace, uml_UML_Constraint, uml_UML_Operation, uml_UML_Property, uml_UML_InterfaceRealization, uml_UML_BehavioredClassifier, uml_UML_Behavior, UML_BehavioralFeature, uml_UML_Class, UML_BehavioredClassifier, UML_StructuralFeature, UML_ConnectableElement, uml_UML_Package, UML_Namespace, uml_UML_PackageableElement, uml_UML_BehavioralFeature, UML_Feature, uml_UML_StructuralFeature, UML_TypedElement, uml_UML_Type, UML_PackageableElement, uml_UML_TypedElement, uml_UML_Classifier, UML_Type, uml_UML_Interface, UML_Classifier, uml_UML_ValueSpecification, uml_UML_OpaqueExpression, UML_ValueSpecification, uml_UML_Port, UML_Property, UML_Class, uml_UML_Activity, UML_Behavior, uml_UML_ActivityEdge, uml_UML_ActivityNode, uml_UML_ConnectableElement, uml_UML_Connector, uml_UML_ConnectorEnd, uml_UML_CallOperationAction, UML_Action, uml_UML_Action, UML_ActivityNode},
    associations={ownedOperation4, ownedAttribute5, contract7, interfaceRealization9, ownedBehavior11, ownedOperation13, nestedClassifier15, ownedAttribute18, ownedRule0, packagedElements1, type2, feature3, outgoing30, source33, target36, specification39, role41, edge21, node22, connectorEnd24, operation25, incoming28},
    generalizations={gen_uml_UML_RedefinableElement_UML_NamedElement, gen_uml_UML_Feature_UML_RedefinableElement, gen_uml_UML_Namespace_UML_NamedElement, gen_uml_UML_BehavioredClassifier_UML_Classifier, gen_uml_UML_Operation_UML_BehavioralFeature, gen_uml_UML_Class_UML_BehavioredClassifier, gen_uml_UML_Property_UML_StructuralFeature, gen_uml_UML_Property_UML_ConnectableElement, gen_uml_UML_Package_UML_Namespace, gen_uml_UML_PackageableElement_UML_NamedElement, gen_uml_UML_BehavioralFeature_UML_Namespace, gen_uml_UML_BehavioralFeature_UML_Feature, gen_uml_UML_StructuralFeature_UML_Feature, gen_uml_UML_StructuralFeature_UML_TypedElement, gen_uml_UML_Type_UML_PackageableElement, gen_uml_UML_TypedElement_UML_NamedElement, gen_uml_UML_Classifier_UML_Namespace, gen_uml_UML_Classifier_UML_Type, gen_uml_UML_Interface_UML_Classifier, gen_uml_UML_OpaqueExpression_UML_ValueSpecification, gen_uml_UML_Constraint_UML_PackageableElement, gen_uml_UML_Port_UML_Property, gen_uml_UML_Behavior_UML_Class, gen_uml_UML_Activity_UML_Behavior, gen_uml_UML_ConnectableElement_UML_TypedElement, gen_uml_UML_Connector_UML_Feature, gen_uml_UML_CallOperationAction_UML_Action, gen_uml_UML_Action_UML_ActivityNode},
    metadata=None
)
