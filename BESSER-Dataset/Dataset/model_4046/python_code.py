...
class uml_UML_ActivityNode:
    ...
    def __init__(self, name: str, uml_UML_ActivityNode38: "uml_UML_ActivityEdge" = None, uml_UML_ActivityNode: "uml_UML_Activity" = None, uml_UML_ActivityNode29: "uml_UML_ActivityNode" = None, uml_UML_ActivityNode31: set["uml_UML_ActivityEdge"] = None, uml_UML_ActivityNode35: "uml_UML_ActivityEdge" = None, uml_UML_ActivityNode27: set["uml_UML_ActivityNode"] = None):
        self.name = name
...
class uml_UML_Connector(UML_Feature):
    ...
    pass
class uml_UML_StructuralFeature(UML_Feature, UML_TypedElement):
...
class uml_UML_Classifier(UML_Namespace, UML_Type):
    ...
    pass
class uml_UML_BehavioralFeature(UML_Feature, UML_Namespace):
...
class uml_UML_InterfaceRealization:
    ...
    pass
class uml_UML_Property(UML_StructuralFeature, UML_ConnectableElement):
