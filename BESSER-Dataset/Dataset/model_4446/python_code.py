...
class iot_RequiredPort:
    ...
    def __init__(self, name: str, UUID: str, method: str, args: str, iot_RequiredPort20: "iot_ProvidedPort" = None, iot_RequiredPort: "iot_Iteration" = None, iot_RequiredPort11: "iot_Sequence" = None, iot_RequiredPort13: "iot_Component" = None):
        self.name = name
        self.UUID = UUID
        self.method = method
        self.args = args
...
class iot_ProvidedPort:
    ...
    def __init__(self, UUID: str, name: str, iot_ProvidedPort: "iot_Item" = None, iot_ProvidedPort18: "iot_Controller" = None, iot_ProvidedPort21: "iot_RequiredPort" = None, iot_ProvidedPort16: "iot_Component" = None):
        self.UUID = UUID
        self.name = name
    ...
    def invoke(self, iot_method, iot_args) :
        # TODO: Implement invoke method
        pass
...
class iot_Actuator(Hardware):
    ...
    def switchOnOff(self, iot_onOff) :
