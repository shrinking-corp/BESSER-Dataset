...
# Classes
iot_Software = Class(name="iot_Software")
Component = Class(name="Component")
iot_Item = Class(name="iot_Item", is_abstract=True)
iot_Hardware = Class(name="iot_Hardware", is_abstract=True)
iot_Branching = Class(name="iot_Branching")
Controller = Class(name="Controller")
iot_CounterLoop = Class(name="iot_CounterLoop")
Iteration = Class(name="Iteration")
iot_IfPort = Class(name="iot_IfPort")
RequiredPort = Class(name="RequiredPort")
iot_Actuator = Class(name="iot_Actuator")
Hardware = Class(name="Hardware")
iot_IterativeLoop = Class(name="iot_IterativeLoop")
iot_ConditionPort = Class(name="iot_ConditionPort")
iot_ProvidedPort = Class(name="iot_ProvidedPort")
iot_ThenPort = Class(name="iot_ThenPort")
iot_ElsePort = Class(name="iot_ElsePort")
iot_Iteration = Class(name="iot_Iteration", is_abstract=True)
iot_RequiredPort = Class(name="iot_RequiredPort")
iot_Sensor = Class(name="iot_Sensor")
iot_Sequence = Class(name="iot_Sequence")
iot_Component = Class(name="iot_Component", is_abstract=True)
Item = Class(name="Item")
iot_Controller = Class(name="iot_Controller", is_abstract=True)
iot_Snippet = Class(name="iot_Snippet")
...
iot_Item.attributes={iot_Item_UUID, iot_Item_name, iot_Item_newThread}
...
iot_Hardware.attributes={iot_Hardware_type, iot_Hardware_pinNumber, iot_Hardware_timeInterval, iot_Hardware_mode}
...
iot_Actuator_m_switchOnOff: Method = Method(name="switchOnOff", parameters={Parameter(name='iot_onOff', type=StringType)}, type=StringType)
iot_Actuator.attributes={iot_Actuator_toggle}
iot_Actuator.methods={iot_Actuator_m_toggle, iot_Actuator_m_switchOnOff, iot_Actuator_m_getStatus}
...
iot_IterativeLoop.attributes={iot_IterativeLoop_var, iot_IterativeLoop_operator}
...
iot_ProvidedPort_m_invoke: Method = Method(name="invoke", parameters={Parameter(name='iot_method', type=StringType)}, type=StringType)
iot_ProvidedPort_m_invoke: Method = Method(name="invoke", parameters={Parameter(name='iot_args', type=StringType), Parameter(name='iot_method', type=StringType)}, type=StringType)
...
iot_RequiredPort_m_invoke: Method = Method(name="invoke", parameters={Parameter(name='iot_method', type=StringType)}, type=StringType)
iot_RequiredPort.attributes={iot_RequiredPort_args, iot_RequiredPort_method, iot_RequiredPort_name, iot_RequiredPort_UUID}
...
domain_model = DomainModel(
    name="iot",
    types={iot_Software, Component, iot_Item, iot_Hardware, iot_Branching, Controller, iot_CounterLoop, Iteration, iot_IfPort, RequiredPort, iot_Actuator, Hardware, iot_IterativeLoop, iot_ConditionPort, iot_ProvidedPort, iot_ThenPort, iot_ElsePort, iot_Iteration, iot_RequiredPort, iot_Sensor, iot_Sequence, iot_Component, Item, iot_Controller, iot_Snippet, Operator},
    associations={item0, referto2, ifport4, condition1, providedport17, use19, thenport5, elseport7, requiredport9, requiredport10, requiredport12, providedport14},
    generalizations={gen_iot_Software_Component, gen_iot_Hardware_Component, gen_iot_Branching_Controller, gen_iot_CounterLoop_Iteration, gen_iot_IfPort_RequiredPort, gen_iot_Actuator_Hardware, gen_iot_IterativeLoop_Iteration, gen_iot_Iteration_Controller, gen_iot_Sensor_Hardware, gen_iot_Sequence_Controller, gen_iot_Component_Item, gen_iot_Controller_Item, gen_iot_Snippet_Component, gen_iot_ConditionPort_RequiredPort, gen_iot_ThenPort_RequiredPort, gen_iot_ElsePort_RequiredPort},
    metadata=None
)
