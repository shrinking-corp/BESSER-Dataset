...
di_BPMNShape.attributes={di_BPMNShape_isMarkerVisible, di_BPMNShape_isMessageVisible, di_BPMNShape_isHorizontal, di_BPMNShape_participantBandKind, di_BPMNShape_isExpanded}
...
domain_model = DomainModel(
    name="di",
    types={di_DocumentRoot, di_EStringToStringMapEntry, di_BPMNEdge, di_BPMNLabel, di_BPMNLabelStyle, di_BPMNPlane, di_BPMNShape, Diagram, di_BPMNDiagram, di_BaseElement, di_DiagramElement, Label, Style, di_Font, LabeledEdge, Plane, LabeledShape, MessageVisibleKind, ParticipantBandKind},
    associations={xMLNSPrefixMap0, xSISchemaLocation1, bPMNEdge6, bPMNLabel8, bPMNLabelStyle10, bPMNPlane12, bPMNShape14, plane16, bPMNDiagram4, label22, bpmnElement25, sourceElement27, targetElement29, labelStyle32, labelStyle19, bpmnElement37, label40, bpmnElement43, choreographyActivityShape47, font35},
