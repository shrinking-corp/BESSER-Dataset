...
class contentfwk_WorkPackage(StrategicElement):
    ...
    def __init__(self, workPackageCategory: str, capabilityDelivered: str, isDeliveredBy: set["contentfwk_Capability"] = None, WorkPackage: "contentfwk_Capability" = None):
...
class contentfwk_LogicalTechnologyComponent(TechnologyComponent, Element):
    ...
    def __init__(self, categoryTRM: str, contentfwk_LogicalTechnologyComponent: "contentfwk_TechnologyArchitecture" = None, LogicalTechnologyComponent215: "contentfwk_PhysicalTechnologyComponent" = None, LogicalTechnologyComponent: "contentfwk_PlatformService" = None, LogicalTechnologyComponent339: "contentfwk_LogicalTechnologyComponent" = None, isRequiredByLogicalTechnologyComponents: set["contentfwk_LogicalTechnologyComponent"] = None, isImplementedOnLogicalTechnologyComponents: set["contentfwk_Service"] = None, isSuppliedByLogicalTechnologyComponents: set["contentfwk_PlatformService"] = None, extendsLogicalTechnologyComponents: set["contentfwk_PhysicalTechnologyComponent"] = None, contentfwk_LogicalTechnologyComponent341: set["contentfwk_PhysicalTechnologyComponent"] = None, LogicalTechnologyComponent345: "contentfwk_LogicalTechnologyComponent" = None, isDependentOnLogicalTechnologyComponents: set["contentfwk_LogicalTechnologyComponent"] = None, LogicalTechnologyComponent348: "contentfwk_LogicalTechnologyComponent" = None, decomposesLogicalTechnologyComponent: set["contentfwk_LogicalTechnologyComponent"] = None, LogicalTechnologyComponent336: "contentfwk_LogicalTechnologyComponent" = None, isDecomposedByLogicalTechnologyComponents: "contentfwk_LogicalTechnologyComponent" = None, LogicalTechnologyComponent365: "contentfwk_Service" = None):
...
class contentfwk_Actor(Element):
    ...
    def __init__(self, FTEs: str, actorGoal: str, actorTasks: str, isSuppliedByActors: set["contentfwk_DataEntity"] = None, isConsumedByActors: set["contentfwk_DataEntity"] = None, contentfwk_Actor: "contentfwk_BusinessArchitecture" = None, containsActors: "contentfwk_OrganizationUnit" = None, Actor: "contentfwk_OrganizationUnit" = None, isPerformedByActors: set["contentfwk_Function"] = None, Actor104: "contentfwk_Actor" = None, isDecomposedByActors: "contentfwk_Actor" = None, Actor107: "contentfwk_Actor" = None, decomposesActor: set["contentfwk_Actor"] = None, Actor109: "contentfwk_Role" = None, supportsActors: set["contentfwk_Function"] = None, isAssumedByActors: set["contentfwk_Role"] = None, involvesActors: set["contentfwk_Process"] = None, isProvidedToActors: set["contentfwk_Service"] = None, isResolvedByActors: set["contentfwk_Event"] = None, isGeneratedByActors: set["contentfwk_Event"] = None, containsActors98: "contentfwk_Location" = None, Actor190: "contentfwk_Process" = None, Actor119: "contentfwk_DataEntity" = None, Actor121: "contentfwk_DataEntity" = None, Actor152: "contentfwk_Function" = None, Actor164: "contentfwk_Function" = None, Actor260: "contentfwk_Event" = None, Actor263: "contentfwk_Event" = None, Actor272: "contentfwk_Location" = None, Actor353: "contentfwk_Service" = None):
        self.FTEs = FTEs
...
class contentfwk_OrganizationUnit(Element):
    ...
    def __init__(self, headcount: str, isProducedByOrganizationUnits: set["contentfwk_Product"] = None, containsOrganizationUnits: "contentfwk_Location" = None, OrganizationUnit78: "contentfwk_OrganizationUnit" = None, isDecomposedByOrganizationUnits: "contentfwk_OrganizationUnit" = None, OrganizationUnit81: "contentfwk_OrganizationUnit" = None, decomposesOrganizationUnit: set["contentfwk_OrganizationUnit"] = None, contentfwk_OrganizationUnit: "contentfwk_BusinessArchitecture" = None, OrganizationUnit: "contentfwk_Driver" = None, motivatesOrganizationUnits: set["contentfwk_Driver"] = None, OrganizationUnit86: "contentfwk_Actor" = None, isOwnedAndGovernedByOrganizationUnits: set["contentfwk_Service"] = None, belongsToOrganizationUnit: set["contentfwk_Actor"] = None, isOwnedByOrganizationUnit: set["contentfwk_Function"] = None, involvesOrganizationUnits: set["contentfwk_Process"] = None, OrganizationUnit154: "contentfwk_Function" = None, OrganizationUnit181: "contentfwk_Process" = None, OrganizationUnit230: "contentfwk_Product" = None, OrganizationUnit275: "contentfwk_Location" = None, OrganizationUnit369: "contentfwk_Service" = None):
...
class contentfwk_Contract(Element):
    ...
    def __init__(self, internationalizationCharacteristics: str, interoperabilityCharacteristics: str, scalabilityCharacteristics: str, portabilityCharacteristics: str, extensibilityCharacteristics: str, capacityCharacteristics: str, throughput: str, throughputPeriod: str, growth: str, growthPeriod: str, peakProfileShortTerm: str, peakProfileLongTerm: str, responseCharacteristics: str, reliabilityCharacteristics: str, qualityOfInformationRequired: str, contractControlRequirements: str, resultControlRequirements: str, recoverabilityCharacteristics: str, locatabilityCharacteristics: str, behaviorCharacteristics: str, serviceNameCaller: str, serviceNameCalled: str, serviceQualityCharacteristics: str, availabilityQualityCharacteristics: str, servicesTimes: str, manageabilityCharacteristics: str, serviceabilityCharacteristics: str, performanceCharacteristics: str, securityCharacteristics: str, privacyCharacteristics: str, integrityCharacteristics: str, credibilityCharacteristics: str, localizationCharacteristics: str, contentfwk_Contract: "contentfwk_BusinessArchitecture" = None, Contract: "contentfwk_ServiceQuality" = None, isGovernedAndMeasuredByContracts: set["contentfwk_Service"] = None, appliesToContracts: set["contentfwk_ServiceQuality"] = None, Contract361: "contentfwk_Service" = None):
        self.internationalizationCharacteristics = internationalizationCharacteristics
        self.interoperabilityCharacteristics = interoperabilityCharacteristics
        self.scalabilityCharacteristics = scalabilityCharacteristics
        self.portabilityCharacteristics = portabilityCharacteristics
...
class contentfwk_Process(Standard, Element):
    ...
    def __init__(self, processCritiality: str, isAutomated: bool, processVolumetrics: str, contentfwk_Process: "contentfwk_BusinessArchitecture" = None, Process: "contentfwk_OrganizationUnit" = None, Process91: "contentfwk_Actor" = None, isRealizedByProcesses: set["contentfwk_Function"] = None, participatesInProcesses189: set["contentfwk_Actor"] = None, ensuresCorrectOperationOfProcesses: set["contentfwk_Control"] = None, isResolvedByProcesses: set["contentfwk_Event"] = None, isGeneratedByProcesses: set["contentfwk_Event"] = None, Process158: "contentfwk_Function" = None, Process160: "contentfwk_Function" = None, supportsProcesses: set["contentfwk_Function"] = None, participatesInProcesses: set["contentfwk_OrganizationUnit"] = None, isRealizedByProcesses183: set["contentfwk_Service"] = None, Process255: "contentfwk_Event" = None, Process257: "contentfwk_Event" = None, isProducedByProcesses: set["contentfwk_Product"] = None, Process200: "contentfwk_Process" = None, isDecomposedByProcesses: "contentfwk_Process" = None, Process203: "contentfwk_Process" = None, followsProcesses: set["contentfwk_Process"] = None, Process206: "contentfwk_Process" = None, precedesProcesses: set["contentfwk_Process"] = None, Process209: "contentfwk_Process" = None, decomposesProcess: set["contentfwk_Process"] = None, supportsProcesses186: set["contentfwk_Service"] = None, Process233: "contentfwk_Product" = None, Process265: "contentfwk_Control" = None, Process373: "contentfwk_Service" = None, Process375: "contentfwk_Service" = None):
