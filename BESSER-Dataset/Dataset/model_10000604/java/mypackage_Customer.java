...
public class mypackage_Customer  {
    ...
    public mypackage_Customer(
        String phoneNumber,        String address,        String emailAddress,        LocalDate dateOfBirth,        String name    ) {
    ...
    public mypackage_Customer(
        String phoneNumber,        String address,        String emailAddress,        LocalDate dateOfBirth,        String name        ArrayList<account_Account> account_accounts    ) {
        this.phoneNumber = phoneNumber;
        this.address = address;
        this.emailAddress = emailAddress;
        this.dateOfBirth = dateOfBirth;
