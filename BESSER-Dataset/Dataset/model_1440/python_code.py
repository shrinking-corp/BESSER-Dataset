...
class RepresentationGraph_NodeElement(GraphicElement):
    ...
    def __init__(self, label: str, RepresentationGraph_NodeElement7: "RepresentationGraph_NodeElement" = None, RepresentationGraph_NodeElement5: set["RepresentationGraph_NodeElement"] = None, RepresentationGraph_NodeElement9: "RepresentationGraph_ContainerElement" = None, RepresentationGraph_NodeElement: "RepresentationGraph_EdgeElement" = None, RepresentationGraph_NodeElement4: "RepresentationGraph_EdgeElement" = None):
        self.label = label
