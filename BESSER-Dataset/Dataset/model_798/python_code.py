...
class fsmSample_Transition:
    ...
    def __init__(self, input: str, output: str, Transition11: "fsmSample_State" = None, outgoingTransition: "fsmSample_State" = None, incomingTransition: "fsmSample_State" = None, fsmSample_Transition: "fsmSample_Action" = None, Transition: "fsmSample_State" = None):
        self.input = input
        self.output = output
