...
class tfsm_Transition:
    ...
    def __init__(self, event: str, Transition: "tfsm_State" = None, Transition17: "tfsm_State" = None, tfsm_Transition19: set["tfsm_ClockReset"] = None, tfsm_Transition21: "tfsm_ClockConstraintOperation" = None, outgoingtransitions: "tfsm_State" = None, incommingtransitions: "tfsm_State" = None, tfsm_Transition: "tfsm_FSM" = None):
        self.event = event
...
class tfsm_State:
    ...
    def __init__(self, name: str, tfsm_State13: "tfsm_FSM" = None, from_: set["tfsm_Transition"] = None, to: set["tfsm_Transition"] = None, State: "tfsm_Transition" = None, State25: "tfsm_Transition" = None, tfsm_State: "tfsm_FSM" = None, tfsm_State9: "tfsm_FSM" = None, tfsm_State11: "tfsm_ClockConstraintOperation" = None):
        self.name = name
    ...
    def from_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_tfsm_State__from_", None)
...
class tfsm_Clock:
    ...
    def __init__(self, name: str, tick: int, tfsm_Clock: "tfsm_FSM" = None, tfsm_Clock27: "tfsm_ClockConstraint" = None, tfsm_Clock30: "tfsm_ClockReset" = None):
        self.name = name
        self.tick = tick
...
class tfsm_FSM:
    ...
    def __init__(self, name: str, tfsm_FSM14: "tfsm_State" = None, tfsm_FSM: set["tfsm_Clock"] = None, tfsm_FSM2: set["tfsm_State"] = None, tfsm_FSM4: set["tfsm_Transition"] = None, tfsm_FSM6: "tfsm_InitialState" = None, tfsm_FSM8: "tfsm_State" = None):
        self.name = name
