...
outgoingtransitions15: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_", type=tfsm_Transition, multiplicity=Multiplicity(0, 9999))
    }
)
...
domain_model = DomainModel(
    name="tfsm",
    types={tfsm_ClockReset, tfsm_FSM, tfsm_Clock, tfsm_State, tfsm_Transition, tfsm_InitialState, tfsm_ClockConstraintOperation, tfsm_FinalState, State, tfsm_ClockConstraint, ClockConstraintOperation, tfsm_LowerClockConstraint, ClockConstraint, tfsm_LowerEqualClockConstraint, tfsm_UpperClockConstraint, tfsm_UpperEqualClockConstraint, tfsm_AndClockConstraint, BinaryClockConstraint, tfsm_OrClockConstraint, tfsm_BinaryClockConstraint},
    associations={fsm12, outgoingtransitions15, incommingtransitions16, clockresets18, transitionguard20, from_23, to24, clocks0, states1, transitions3, initialstate5, currentState7, stateguard10, right33, clock26, clock28, left31},
    generalizations={gen_tfsm_FinalState_State, gen_tfsm_InitialState_State, gen_tfsm_ClockConstraint_ClockConstraintOperation, gen_tfsm_LowerClockConstraint_ClockConstraint, gen_tfsm_LowerEqualClockConstraint_ClockConstraint, gen_tfsm_UpperClockConstraint_ClockConstraint, gen_tfsm_UpperEqualClockConstraint_ClockConstraint, gen_tfsm_AndClockConstraint_BinaryClockConstraint, gen_tfsm_OrClockConstraint_BinaryClockConstraint, gen_tfsm_BinaryClockConstraint_ClockConstraintOperation},
    metadata=None
)
