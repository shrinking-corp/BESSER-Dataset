...
# Classes
fragdial101_AbstractComponent = Class(name="fragdial101_AbstractComponent", is_abstract=True)
fragdial101_Attributes = Class(name="fragdial101_Attributes")
fragdial101_Output = Class(name="fragdial101_Output")
fragdial101_Controller = Class(name="fragdial101_Controller")
fragdial101_Required = Class(name="fragdial101_Required")
fragdial101_Provided = Class(name="fragdial101_Provided")
fragdial101_Interface = Class(name="fragdial101_Interface", is_abstract=True)
fragdial101_Binding = Class(name="fragdial101_Binding")
fragdial101_Content = Class(name="fragdial101_Content")
fragdial101_Include = Class(name="fragdial101_Include")
fragdial101_Ldflag = Class(name="fragdial101_Ldflag")
fragdial101_Attribute = Class(name="fragdial101_Attribute")
Interface = Class(name="Interface")
fragdial101_Component = Class(name="fragdial101_Component")
...
fragdial101_Interface.attributes={fragdial101_Interface_cardinality, fragdial101_Interface_contingency, fragdial101_Interface_signature, fragdial101_Interface_startProperty, fragdial101_Interface_name}

# fragdial101_Binding class attributes and methods

# fragdial101_Content class attributes and methods
fragdial101_Content_class_: Property = Property(name="class_", type=StringType)
fragdial101_Content_language: Property = Property(name="language", type=StringType)
fragdial101_Content.attributes={fragdial101_Content_class_, fragdial101_Content_language}
...
fragdial101_Attribute.attributes={fragdial101_Attribute_value, fragdial101_Attribute_name}
...
domain_model = DomainModel(
    name="fragdial101",
    types={fragdial101_AbstractComponent, fragdial101_Attributes, fragdial101_Output, fragdial101_Controller, fragdial101_Required, fragdial101_Provided, fragdial101_Interface, fragdial101_Binding, fragdial101_Content, fragdial101_Include, fragdial101_Ldflag, fragdial101_Attribute, Interface, fragdial101_Component, AbstractComponent},
    associations={content0, attributes1, output3, controller5, requiredInterfaces7, providedInterfaces9, bindings11, from_12, to15, contentParent18, includes21, ldflags23, attributes25, subComponents28},
