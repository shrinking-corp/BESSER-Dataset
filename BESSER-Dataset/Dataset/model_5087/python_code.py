...
class fragdial101_Content:
    ...
    def __init__(self, class_: str, language: str, fragdial101_Content19: "fragdial101_AbstractComponent" = None, fragdial101_Content22: set["fragdial101_Include"] = None, fragdial101_Content24: set["fragdial101_Ldflag"] = None, fragdial101_Content: "fragdial101_AbstractComponent" = None):
        self.class_ = class_
...
class fragdial101_Attributes:
    ...
    def __init__(self, signature: str, fragdial101_Attributes26: set["fragdial101_Attribute"] = None, fragdial101_Attributes: "fragdial101_AbstractComponent" = None):
        self.signature = signature
...
class fragdial101_AbstractComponent(ABC):
    ...
    def __init__(self, name: str, fragdial101_AbstractComponent6: "fragdial101_Controller" = None, fragdial101_AbstractComponent8: set["fragdial101_Required"] = None, fragdial101_AbstractComponent10: set["fragdial101_Provided"] = None, fragdial101_AbstractComponent20: "fragdial101_Content" = None, fragdial101_AbstractComponent: "fragdial101_Content" = None, fragdial101_AbstractComponent2: "fragdial101_Attributes" = None, fragdial101_AbstractComponent4: "fragdial101_Output" = None):
        self.name = name
