...
# Classes
test_A = Class(name="test_A")
test_B = Class(name="test_B")
test_C = Class(name="test_C")
test_D = Class(name="test_D")
test_EClassToEStringMap = Class(name="test_EClassToEStringMap")
test_EClassToAMap = Class(name="test_EClassToAMap")
test_EClass = Class(name="test_EClass")
...
test_D.attributes={test_D_x, test_D_yList}
...
domain_model = DomainModel(
    ...
    associations={b0, c1, cList3, d6, eClassToString8, eClassToA10, key12, key14, value17},
    generalizations={},
    metadata=None
)
