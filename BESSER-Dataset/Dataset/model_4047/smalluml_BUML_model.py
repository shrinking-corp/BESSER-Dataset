...
smalluml_SuperType = Class(name="smalluml_SuperType", is_abstract=True)
...
class_1: BinaryAssociation = BinaryAssociation(
    name="class_1",
    ends={
...
domain_model = DomainModel(
    ...
    associations={returnType5, type0, class_1, role2, parameters4, type8, attribute11, operation14, super18, elements20, association22},
