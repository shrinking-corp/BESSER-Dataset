...
class smalluml_Operation(NamedElement):
    ...
    def __init__(self, isAbstract: bool, smalluml_Operation6: "smalluml_SuperType" = None, smalluml_Operation: set["smalluml_Parameter"] = None, smalluml_Operation16: "smalluml_Class" = None):
        self.isAbstract = isAbstract
