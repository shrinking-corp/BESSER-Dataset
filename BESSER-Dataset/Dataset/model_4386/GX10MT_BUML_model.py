...
gx10_Equal.methods={gx10_Equal_m_evaluate, gx10_Equal_m_getCurrentValue}
...
gx10_Plus.methods={gx10_Plus_m_getCurrentValue, gx10_Plus_m_evaluate}
...
domain_model = DomainModel(
    name="gx10",
    types={gx10_Block, gx10_MethodCall, gx10_Referentiable, Statement, gx10_Statement, gx10_ControlStructure, gx10_BoolExpression, gx10_Program, gx10_Method, BoolExpression, gx10_False, gx10_Not, gx10_And, gx10_IntConst, IntExpression, gx10_IntBinaryOperation, gx10_IntExpression, Expression, gx10_MethodCallParameter, gx10_If, ControlStructure, gx10_While, gx10_True, gx10_BoolVar, gx10_IntVar, gx10_IntVarAccess, gx10_BoolVarAccess, gx10_Equal, gx10_Async, gx10_Expression, gx10_Finish, gx10_Print, gx10_Plus, IntBinaryOperation, gx10_Time},
    associations={inProgram2, methodBlock3, calledBy5, methodParameters6, blockStatements8, inBlock9, methods0, startMethod1, notExpression19, leftAndExpression21, rightAndExpression23, controlStructureCondition10, inMethodCallParameter11, thenBlock12, elseBlock14, whileBlock17, toPrint37, boolVarExpr38, boolVarName40, intVarExpr43, intVarName45, intVarRef48, boolVarRef50, leftBinaryExpression26, rightBinaryExpression27, asyncBlock30, methodToCall31, methodCallParameters33, finishStatement35, methodCallParameterExpr57, inMethodCall58, leftEqual52, rightEqual54},
    generalizations={gen_gx10_Block_Statement, gen_gx10_ControlStructure_Statement, gen_gx10_True_BoolExpression, gen_gx10_False_BoolExpression, gen_gx10_Not_BoolExpression, gen_gx10_And_BoolExpression, gen_gx10_IntConst_IntExpression, gen_gx10_IntBinaryOperation_IntExpression, gen_gx10_IntExpression_Expression, gen_gx10_BoolExpression_Expression, gen_gx10_If_ControlStructure, gen_gx10_While_ControlStructure, gen_gx10_BoolVar_Expression, gen_gx10_IntVar_Statement, gen_gx10_IntVarAccess_IntExpression, gen_gx10_BoolVarAccess_BoolExpression, gen_gx10_Equal_BoolExpression, gen_gx10_Async_Statement, gen_gx10_MethodCall_Expression, gen_gx10_Expression_Statement, gen_gx10_Finish_Statement, gen_gx10_Print_Statement, gen_gx10_Plus_IntBinaryOperation, gen_gx10_Time_IntBinaryOperation},
    metadata=None
)
