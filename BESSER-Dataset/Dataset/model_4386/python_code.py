...
class gx10_MethodCallParameter:
    ...
    def __init__(self, name: str, MethodCallParameter: "gx10_IntExpression" = None, MethodCallParameter34: "gx10_MethodCall" = None, inMethodCallParameter: "gx10_IntExpression" = None, methodCallParameters: "gx10_MethodCall" = None):
        self.name = name
...
class gx10_IntExpression(Expression):
    ...
    def __init__(self, gx10_IntExpression56: "gx10_Equal" = None, methodCallParameterExpr: "gx10_MethodCallParameter" = None, gx10_IntExpression44: "gx10_IntVar" = None, gx10_IntExpression: "gx10_IntBinaryOperation" = None, gx10_IntExpression29: "gx10_IntBinaryOperation" = None, IntExpression: "gx10_MethodCallParameter" = None, gx10_IntExpression53: "gx10_Equal" = None):
...
class gx10_IntVarAccess(IntExpression):
    ...
    def gx10_IntVarAccess(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "gx10_Referentiable49"):
                opp_val = getattr(old_value, "gx10_Referentiable49", None)
                if opp_val == self:
                    setattr(old_value, "gx10_Referentiable49", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "gx10_Referentiable49"):
                opp_val = getattr(value, "gx10_Referentiable49", None)
                setattr(value, "gx10_Referentiable49", self)
...
class gx10_Not(BoolExpression):
    ...
    def gx10_Not(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "gx10_BoolExpression20"):
                opp_val = getattr(old_value, "gx10_BoolExpression20", None)
                if opp_val == self:
                    setattr(old_value, "gx10_BoolExpression20", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "gx10_BoolExpression20"):
                opp_val = getattr(value, "gx10_BoolExpression20", None)
                setattr(value, "gx10_BoolExpression20", self)
...
class gx10_BoolVarAccess(BoolExpression):
    ...
    def gx10_BoolVarAccess(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "gx10_Referentiable51"):
                opp_val = getattr(old_value, "gx10_Referentiable51", None)
                if opp_val == self:
                    setattr(old_value, "gx10_Referentiable51", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "gx10_Referentiable51"):
                opp_val = getattr(value, "gx10_Referentiable51", None)
                setattr(value, "gx10_Referentiable51", self)
...
class gx10_Equal(BoolExpression):
    ...
    def __init__(self, gx10_Equal55: "gx10_IntExpression" = None, gx10_Equal: "gx10_IntExpression" = None):
...
class gx10_Method:
    ...
    def __init__(self, name: str, methods: "gx10_Program" = None, gx10_Method4: "gx10_Block" = None, methodToCall: set["gx10_MethodCall"] = None, gx10_Method7: set["gx10_Referentiable"] = None, Method: "gx10_Program" = None, gx10_Method: "gx10_Program" = None, Method32: "gx10_MethodCall" = None):
        self.name = name
...
class gx10_BoolExpression(Expression):
    ...
    def __init__(self, gx10_BoolExpression20: "gx10_Not" = None, gx10_BoolExpression22: "gx10_And" = None, gx10_BoolExpression25: "gx10_And" = None, gx10_BoolExpression: "gx10_ControlStructure" = None, gx10_BoolExpression39: "gx10_BoolVar" = None):
...
class gx10_Referentiable:
    ...
    def __init__(self, name: int, gx10_Referentiable: "gx10_Method" = None, gx10_Referentiable42: "gx10_BoolVar" = None, gx10_Referentiable47: "gx10_IntVar" = None, gx10_Referentiable49: "gx10_IntVarAccess" = None, gx10_Referentiable51: "gx10_BoolVarAccess" = None):
        self.name = name
...
class gx10_MethodCall(Expression):
    ...
    def __init__(self, MethodCall: "gx10_Method" = None, calledBy: "gx10_Method" = None, inMethodCall: set["gx10_MethodCallParameter"] = None, MethodCall59: "gx10_MethodCallParameter" = None):
...
class gx10_Block(Statement):
    ...
    def __init__(self, context: int, gx10_Block: "gx10_Method" = None, inBlock: set["gx10_Statement"] = None, Block: "gx10_Statement" = None, gx10_Block13: "gx10_If" = None, gx10_Block16: "gx10_If" = None, gx10_Block18: "gx10_While" = None):
