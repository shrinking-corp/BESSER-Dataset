...
def test_hyp_gx10_time_evaluate_changes_state(instance):
...
@settings(max_examples=30)
def test_hyp_gx10_plus_evaluate_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
        instance.evaluate()
...
def test_hyp_gx10_block_context_setter(instance):
