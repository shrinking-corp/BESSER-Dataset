...
def test_hyp_uml_14_aufzaehlungswert_is_not_abstract():
    assert not inspect.isabstract(UML_14_Aufzaehlungswert)


def test_hyp_uml_14_aufzaehlungswert_constructor_exists():
    assert callable(UML_14_Aufzaehlungswert.__init__)


def test_hyp_uml_14_aufzaehlungswert_constructor_args():
...
def test_hyp_uml_14_benanntes_is_not_abstract():
    assert not inspect.isabstract(UML_14_Benanntes)


def test_hyp_uml_14_benanntes_constructor_exists():
    assert callable(UML_14_Benanntes.__init__)


def test_hyp_uml_14_benanntes_constructor_args():
...
def test_hyp_uml_14_root_is_not_abstract():
    assert not inspect.isabstract(UML_14_root)


def test_hyp_uml_14_root_constructor_exists():
    assert callable(UML_14_root.__init__)


def test_hyp_uml_14_root_constructor_args():
    sig = inspect.signature(UML_14_root.__init__)
    params = list(sig.parameters.keys())



def test_hyp_uml_14_kommentar_is_not_abstract():
    assert not inspect.isabstract(UML_14_Kommentar)


def test_hyp_uml_14_kommentar_constructor_exists():
    assert callable(UML_14_Kommentar.__init__)


def test_hyp_uml_14_kommentar_constructor_args():
...
def test_hyp_uml_14_vererbung_is_not_abstract():
    assert not inspect.isabstract(UML_14_Vererbung)


def test_hyp_uml_14_vererbung_constructor_exists():
    assert callable(UML_14_Vererbung.__init__)


def test_hyp_uml_14_vererbung_constructor_args():
...
def test_hyp_uml_14_instanzanzahl_is_not_abstract():
    assert not inspect.isabstract(UML_14_InstanzAnzahl)


def test_hyp_uml_14_instanzanzahl_constructor_exists():
    assert callable(UML_14_InstanzAnzahl.__init__)


def test_hyp_uml_14_instanzanzahl_constructor_args():
...
def test_hyp_uml_14_einschraenkung_is_not_abstract():
    assert not inspect.isabstract(UML_14_Einschraenkung)


def test_hyp_uml_14_einschraenkung_constructor_exists():
    assert callable(UML_14_Einschraenkung.__init__)


def test_hyp_uml_14_einschraenkung_constructor_args():
...
def test_hyp_benanntes_is_not_abstract():
    assert not inspect.isabstract(Benanntes)


def test_hyp_benanntes_constructor_exists():
    assert callable(Benanntes.__init__)


def test_hyp_benanntes_constructor_args():
    sig = inspect.signature(Benanntes.__init__)
    params = list(sig.parameters.keys())



def test_hyp_uml_14_konzept_is_not_abstract():
    assert not inspect.isabstract(UML_14_Konzept)


def test_hyp_uml_14_konzept_constructor_exists():
    assert callable(UML_14_Konzept.__init__)


def test_hyp_uml_14_konzept_constructor_args():
...
def test_hyp_uml_14_einfach_is_not_abstract():
    assert not inspect.isabstract(UML_14_Einfach)


def test_hyp_uml_14_einfach_constructor_exists():
    assert callable(UML_14_Einfach.__init__)


def test_hyp_uml_14_einfach_constructor_args():
    sig = inspect.signature(UML_14_Einfach.__init__)
    params = list(sig.parameters.keys())



def test_hyp_uml_14_verbindung_is_not_abstract():
    assert not inspect.isabstract(UML_14_Verbindung)


def test_hyp_uml_14_verbindung_constructor_exists():
    assert callable(UML_14_Verbindung.__init__)


def test_hyp_uml_14_verbindung_constructor_args():
    sig = inspect.signature(UML_14_Verbindung.__init__)
    params = list(sig.parameters.keys())



def test_hyp_uml_14_eigenschaft_is_not_abstract():
    assert not inspect.isabstract(UML_14_Eigenschaft)


def test_hyp_uml_14_eigenschaft_constructor_exists():
    assert callable(UML_14_Eigenschaft.__init__)


def test_hyp_uml_14_eigenschaft_constructor_args():
...
def test_hyp_uml_14_schachtel_is_not_abstract():
    assert not inspect.isabstract(UML_14_Schachtel)


def test_hyp_uml_14_schachtel_constructor_exists():
    assert callable(UML_14_Schachtel.__init__)


def test_hyp_uml_14_schachtel_constructor_args():
    sig = inspect.signature(UML_14_Schachtel.__init__)
    params = list(sig.parameters.keys())



def test_hyp_uml_14_aufzaehlung_is_not_abstract():
    assert not inspect.isabstract(UML_14_Aufzaehlung)


def test_hyp_uml_14_aufzaehlung_constructor_exists():
    assert callable(UML_14_Aufzaehlung.__init__)


def test_hyp_uml_14_aufzaehlung_constructor_args():
    sig = inspect.signature(UML_14_Aufzaehlung.__init__)
    params = list(sig.parameters.keys())



def test_hyp_uml_14_verhalten_is_not_abstract():
    assert not inspect.isabstract(UML_14_Verhalten)


def test_hyp_uml_14_verhalten_constructor_exists():
    assert callable(UML_14_Verhalten.__init__)


def test_hyp_uml_14_verhalten_constructor_args():
...
def test_hyp_uml_14_verbindungsende_is_not_abstract():
    assert not inspect.isabstract(UML_14_Verbindungsende)


def test_hyp_uml_14_verbindungsende_constructor_exists():
    assert callable(UML_14_Verbindungsende.__init__)


def test_hyp_uml_14_verbindungsende_constructor_args():
...
def test_hyp_uml_14_methodenwert_is_not_abstract():
    assert not inspect.isabstract(UML_14_MethodenWert)


def test_hyp_uml_14_methodenwert_constructor_exists():
    assert callable(UML_14_MethodenWert.__init__)


def test_hyp_uml_14_methodenwert_constructor_args():
...
def test_hyp_uml_14_aufzaehlungswert_wert_setter(instance):
...
def test_hyp_uml_14_benanntes_beschreibung_setter(instance):
...
def test_hyp_uml_14_kommentar_inhalt_setter(instance):
...
def test_hyp_uml_14_vererbung_unterscheidung_setter(instance):
...
def test_hyp_uml_14_instanzanzahl_obergrenze_setter(instance):
...
@given(instance=UML_14_InstanzAnzahl_strategy)
def test_hyp_uml_14_instanzanzahl_untergrenze_setter(instance):
...
def test_hyp_uml_14_einschraenkung_beschreibung_setter(instance):
    original = instance.beschreibung
    instance.beschreibung = original
    assert instance.beschreibung == original
...
def test_hyp_uml_14_konzept_istAktiev_setter(instance):
...
def test_hyp_uml_14_eigenschaft_sichtbarkeit_setter(instance):
...
@given(instance=UML_14_Eigenschaft_strategy)
def test_hyp_uml_14_eigenschaft_initialWert_setter(instance):
...
def test_hyp_uml_14_verhalten_inhlat_setter(instance):
...
@given(instance=UML_14_Verhalten_strategy)
def test_hyp_uml_14_verhalten_sichtbarkeit_setter(instance):
    original = instance.sichtbarkeit
    instance.sichtbarkeit = original
    assert instance.sichtbarkeit == original
...
def test_hyp_uml_14_verbindungsende_istNavigierbar_setter(instance):
...
@given(instance=UML_14_Verbindungsende_strategy)
def test_hyp_uml_14_verbindungsende_sichtbarkeit_setter(instance):
    original = instance.sichtbarkeit
    instance.sichtbarkeit = original
    assert instance.sichtbarkeit == original
...
def test_hyp_uml_14_methodenwert_art_setter(instance):
...
@given(instance=UML_14_MethodenWert_strategy)
def test_hyp_uml_14_methodenwert_standartWert_setter(instance):
