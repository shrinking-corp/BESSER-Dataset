...
epo2_Item.attributes={epo2_Item_USPrice, epo2_Item_comment, epo2_Item_quantity, epo2_Item_partNum, epo2_Item_shipDate, epo2_Item_productName}
...
domain_model = DomainModel(
    name="epo2",
    types={epo2_USAddress, Address, epo2_Item, epo2_PurchaseOrder, epo2_Customer, epo2_Supplier, epo2_Address, epo2_GlobalAddress, GlobalLocation, epo2_GlobalLocation, OrderStatus},
    associations={items1, order0, customer6, previousOrder8, billTo2, shipTo3, shippedOrders17, orders20, customers10, orders11, pendingOrders14},
