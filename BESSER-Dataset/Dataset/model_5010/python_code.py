...
class epo2_Supplier:
    ...
    def __init__(self, name: str, epo2_Supplier18: set["epo2_PurchaseOrder"] = None, epo2_Supplier: set["epo2_Customer"] = None, epo2_Supplier12: set["epo2_PurchaseOrder"] = None, epo2_Supplier15: set["epo2_PurchaseOrder"] = None):
        self.name = name
...
class epo2_PurchaseOrder:
    ...
    def __init__(self, comment: str, orderDate: str, status: str, totalAmount: int, epo2_PurchaseOrder: "epo2_Address" = None, epo2_PurchaseOrder4: "epo2_Address" = None, epo2_PurchaseOrder19: "epo2_Supplier" = None, PurchaseOrder21: "epo2_Customer" = None, epo2_PurchaseOrder13: "epo2_Supplier" = None, epo2_PurchaseOrder16: "epo2_Supplier" = None, order: set["epo2_Item"] = None, PurchaseOrder: "epo2_Item" = None, orders: "epo2_Customer" = None, epo2_PurchaseOrder9: "epo2_PurchaseOrder" = None, epo2_PurchaseOrder7: "epo2_PurchaseOrder" = None):
...
class epo2_Item:
    ...
    def __init__(self, USPrice: int, comment: str, shipDate: str, partNum: str, productName: str, quantity: int, Item: "epo2_PurchaseOrder" = None, items: "epo2_PurchaseOrder" = None):
