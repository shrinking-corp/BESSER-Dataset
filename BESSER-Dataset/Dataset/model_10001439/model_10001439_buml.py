...
domain_model = DomainModel(
    name="_6cNK0N_3EemZHaiox11UDg",
    types={ShoppingCartExample_ShoppingCart, ShoppingCartExample_Order, ShoppingCartExample_LineItem, ShoppingCartExample_Account, ShoppingCartExample_Customer, StoringStrategy, Interface_Interface, StoringStrategy_Interface, Class1, SoftwareType, Actor_Actor, Custumor_Actor, Customer_Actor, Subject_Actor, Observer, ObserverA, ObserverB, Stratrgy_Interface, Strategy_Interface, StrategyA, Obs_Actor, Observer1, Observer_Actor, Subject, Strategy, PaymentStrategy_Interface, CheckOrCard, Check, Card},
