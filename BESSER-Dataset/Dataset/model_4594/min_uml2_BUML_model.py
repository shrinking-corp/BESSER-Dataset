...
# Classes
minuml2_ActivityGroup = Class(name="minuml2_ActivityGroup", is_abstract=True)
...
minuml2_ValueSpecification = Class(name="minuml2_ValueSpecification")
...
minuml2_ActivityNode = Class(name="minuml2_ActivityNode")
...
domain_model = DomainModel(
    name="minuml2",
    types={minuml2_ActivityGroup, minuml2_ActivityPartition, ActivityGroup, minuml2_OpaqueAction, ActivityNode, minuml2_ForkNode, minuml2_JoinNode, minuml2_DecisionNode, minuml2_ActivityFinalNode, minuml2_ValueSpecification, minuml2_ControlFlow, ActivityEdge, minuml2_ObjectFlow, minuml2_OpaqueExpression, ValueSpecification, minuml2_Activity, minuml2_ActivityNode, minuml2_ActivityEdge},
    associations={groups3, source5, target8, guard11, nodes0, edges1},
