...
class fsm_State(NamedElement):
    ...
    def __init__(self, initialTime: int, finalTime: int, State: "fsm_StateMachine" = None, source: set["fsm_Transition"] = None, target: set["fsm_Transition"] = None, states: "fsm_StateMachine" = None, State9: "fsm_Transition" = None, State11: "fsm_Transition" = None):
