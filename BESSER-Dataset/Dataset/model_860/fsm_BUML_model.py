...
fsm_Transition.attributes={fsm_Transition_initialTime, fsm_Transition_finalTime, fsm_Transition_time}
...
domain_model = DomainModel(
    name="fsm",
    types={fsm_StateMachine, NamedElement, fsm_State, fsm_Transition, fsm_FinalState, State, fsm_InitialState, fsm_Trigger, fsm_TimedTransition, Transition, fsm_Pseudostate, fsm_Fork, Pseudostate, fsm_NamedElement, fsm_Join},
    associations={states0, transitions1, outgoing3, incoming5, stateMachine7, target8, source10, trigger12, stateMachine13},
    generalizations={gen_fsm_StateMachine_NamedElement, gen_fsm_State_NamedElement, gen_fsm_FinalState_State, gen_fsm_InitialState_State, gen_fsm_Transition_NamedElement, gen_fsm_TimedTransition_Transition, gen_fsm_Pseudostate_State, gen_fsm_Join_Pseudostate, gen_fsm_Fork_Pseudostate},
    metadata=None
)
