...
# Classes
ast_ASTNode = Class(name="ast_ASTNode")
ast_MarkerAnnotation = Class(name="ast_MarkerAnnotation")
Annotation = Class(name="Annotation")
ast_Name = Class(name="ast_Name")
ast_Annotation = Class(name="ast_Annotation")
Expression = Class(name="Expression")
ast_Expression = Class(name="ast_Expression")
ast_NormalAnnotation = Class(name="ast_NormalAnnotation")
ast_MemberValuePair = Class(name="ast_MemberValuePair")
ast_SingleMemberAnnotation = Class(name="ast_SingleMemberAnnotation")
ast_IDocElement = Class(name="ast_IDocElement")
ast_MemberRef = Class(name="ast_MemberRef")
IDocElement = Class(name="IDocElement")
ast_SimpleName = Class(name="ast_SimpleName")
ast_MethodRef = Class(name="ast_MethodRef")
ast_MethodRefParameter = Class(name="ast_MethodRefParameter")
ast_IExtendedModifier = Class(name="ast_IExtendedModifier")
ast_Modifier = Class(name="ast_Modifier")
ASTNode = Class(name="ASTNode")
IExtendedModifier = Class(name="IExtendedModifier")
ast_ArrayCreation = Class(name="ast_ArrayCreation")
ast_ArrayType = Class(name="ast_ArrayType")
ast_ArrayInitializer = Class(name="ast_ArrayInitializer")
Type = Class(name="Type")
ast_Type = Class(name="ast_Type")
ast_Dimension = Class(name="ast_Dimension")
ast_AssertStatement = Class(name="ast_AssertStatement")
Statement = Class(name="Statement")
ast_Statement = Class(name="ast_Statement")
ast_Assignment = Class(name="ast_Assignment")
ast_TagElement = Class(name="ast_TagElement")
ast_TextElement = Class(name="ast_TextElement")
ast_AnonymousClassDeclaration = Class(name="ast_AnonymousClassDeclaration")
ast_BodyDeclaration = Class(name="ast_BodyDeclaration")
ast_ArrayAccess = Class(name="ast_ArrayAccess")
ast_CastExpression = Class(name="ast_CastExpression")
ast_CatchClause = Class(name="ast_CatchClause")
ast_SingleVariableDeclaration = Class(name="ast_SingleVariableDeclaration")
ast_CharacterLiteral = Class(name="ast_CharacterLiteral")
ast_ClassInstanceCreation = Class(name="ast_ClassInstanceCreation")
ast_CompilationUnit = Class(name="ast_CompilationUnit")
ast_PackageDeclaration = Class(name="ast_PackageDeclaration")
ast_ImportDeclaration = Class(name="ast_ImportDeclaration")
ast_Block = Class(name="ast_Block")
ast_BooleanLiteral = Class(name="ast_BooleanLiteral")
ast_BreakStatement = Class(name="ast_BreakStatement")
ast_AbstractTypeDeclaration = Class(name="ast_AbstractTypeDeclaration")
ast_ConditionalExpression = Class(name="ast_ConditionalExpression")
ast_ConstructorInvocation = Class(name="ast_ConstructorInvocation")
ast_ContinueStatement = Class(name="ast_ContinueStatement")
ast_DoStatement = Class(name="ast_DoStatement")
...
ast_InfixExpression = Class(name="ast_InfixExpression")
ast_FieldAccess = Class(name="ast_FieldAccess")
ast_FieldDeclaration = Class(name="ast_FieldDeclaration")
BodyDeclaration = Class(name="BodyDeclaration")
ast_Javadoc = Class(name="ast_Javadoc")
ast_VariableDeclarationFragment = Class(name="ast_VariableDeclarationFragment")
ast_MethodDeclaration = Class(name="ast_MethodDeclaration")
ast_TypeParameter = Class(name="ast_TypeParameter")
ast_MethodInvocation = Class(name="ast_MethodInvocation")
ast_Initializer = Class(name="ast_Initializer")
Comment = Class(name="Comment")
ast_Comment = Class(name="ast_Comment")
ast_LabeledStatement = Class(name="ast_LabeledStatement")
ast_PostfixExpression = Class(name="ast_PostfixExpression")
ast_PrefixExpression = Class(name="ast_PrefixExpression")
ast_PrimitiveType = Class(name="ast_PrimitiveType")
AnnotatableType = Class(name="AnnotatableType")
ast_AnnotatableType = Class(name="ast_AnnotatableType")
ast_QualifiedName = Class(name="ast_QualifiedName")
Name = Class(name="Name")
ast_ReturnStatement = Class(name="ast_ReturnStatement")
ast_SimpleType = Class(name="ast_SimpleType")
ast_NullLiteral = Class(name="ast_NullLiteral")
ast_NumberLiteral = Class(name="ast_NumberLiteral")
ast_ParenthesizedExpression = Class(name="ast_ParenthesizedExpression")
ast_VariableDeclaration = Class(name="ast_VariableDeclaration")
ast_StringLiteral = Class(name="ast_StringLiteral")
ast_SuperConstructorInvocation = Class(name="ast_SuperConstructorInvocation")
ast_SuperFieldAccess = Class(name="ast_SuperFieldAccess")
ast_SuperMethodInvocation = Class(name="ast_SuperMethodInvocation")
ast_SwitchCase = Class(name="ast_SwitchCase")
VariableDeclaration = Class(name="VariableDeclaration")
ast_SynchronizedStatement = Class(name="ast_SynchronizedStatement")
ast_ThisExpression = Class(name="ast_ThisExpression")
ast_ThrowStatement = Class(name="ast_ThrowStatement")
ast_TryStatement = Class(name="ast_TryStatement")
ast_VariableDeclarationExpression = Class(name="ast_VariableDeclarationExpression")
ast_TypeDeclaration = Class(name="ast_TypeDeclaration")
AbstractTypeDeclaration = Class(name="AbstractTypeDeclaration")
ast_SwitchStatement = Class(name="ast_SwitchStatement")
ast_TypeDeclarationStatement = Class(name="ast_TypeDeclarationStatement")
ast_TypeLiteral = Class(name="ast_TypeLiteral")
ast_VariableDeclarationStatement = Class(name="ast_VariableDeclarationStatement")
ast_EnhancedForStatement = Class(name="ast_EnhancedForStatement")
ast_EnumDeclaration = Class(name="ast_EnumDeclaration")
ast_EnumConstantDeclaration = Class(name="ast_EnumConstantDeclaration")
ast_WhileStatement = Class(name="ast_WhileStatement")
ast_InstanceofExpression = Class(name="ast_InstanceofExpression")
ast_LineComment = Class(name="ast_LineComment")
ast_BlockComment = Class(name="ast_BlockComment")
ast_ParameterizedType = Class(name="ast_ParameterizedType")
ast_QualifiedType = Class(name="ast_QualifiedType")
ast_WildcardType = Class(name="ast_WildcardType")
ast_AnnotationTypeDeclaration = Class(name="ast_AnnotationTypeDeclaration")
ast_UnionType = Class(name="ast_UnionType")
ast_LambdaExpression = Class(name="ast_LambdaExpression")
ast_IntersectionType = Class(name="ast_IntersectionType")
ast_NameQualifiedType = Class(name="ast_NameQualifiedType")
ast_CreationReference = Class(name="ast_CreationReference")
MethodReference = Class(name="MethodReference")
ast_AnnotationTypeMemberDeclaration = Class(name="ast_AnnotationTypeMemberDeclaration")
ast_TypeMethodReference = Class(name="ast_TypeMethodReference")
ast_MethodReference = Class(name="ast_MethodReference")
ast_ExpressionMethodReference = Class(name="ast_ExpressionMethodReference")
ast_SuperMethodReference = Class(name="ast_SuperMethodReference")
...
finally_297: BinaryAssociation = BinaryAssociation(
    name="finally_297",
    ends={
...
domain_model = DomainModel(
    name="ast",
    types={ast_ASTNode, ast_MarkerAnnotation, Annotation, ast_Name, ast_Annotation, Expression, ast_Expression, ast_NormalAnnotation, ast_MemberValuePair, ast_SingleMemberAnnotation, ast_IDocElement, ast_MemberRef, IDocElement, ast_SimpleName, ast_MethodRef, ast_MethodRefParameter, ast_IExtendedModifier, ast_Modifier, ASTNode, IExtendedModifier, ast_ArrayCreation, ast_ArrayType, ast_ArrayInitializer, Type, ast_Type, ast_Dimension, ast_AssertStatement, Statement, ast_Statement, ast_Assignment, ast_TagElement, ast_TextElement, ast_AnonymousClassDeclaration, ast_BodyDeclaration, ast_ArrayAccess, ast_CastExpression, ast_CatchClause, ast_SingleVariableDeclaration, ast_CharacterLiteral, ast_ClassInstanceCreation, ast_CompilationUnit, ast_PackageDeclaration, ast_ImportDeclaration, ast_Block, ast_BooleanLiteral, ast_BreakStatement, ast_AbstractTypeDeclaration, ast_ConditionalExpression, ast_ConstructorInvocation, ast_ContinueStatement, ast_DoStatement, ast_EmptyStatement, ast_ExpressionStatement, ast_ForStatement, ast_IfStatement, ast_InfixExpression, ast_FieldAccess, ast_FieldDeclaration, BodyDeclaration, ast_Javadoc, ast_VariableDeclarationFragment, ast_MethodDeclaration, ast_TypeParameter, ast_MethodInvocation, ast_Initializer, Comment, ast_Comment, ast_LabeledStatement, ast_PostfixExpression, ast_PrefixExpression, ast_PrimitiveType, AnnotatableType, ast_AnnotatableType, ast_QualifiedName, Name, ast_ReturnStatement, ast_SimpleType, ast_NullLiteral, ast_NumberLiteral, ast_ParenthesizedExpression, ast_VariableDeclaration, ast_StringLiteral, ast_SuperConstructorInvocation, ast_SuperFieldAccess, ast_SuperMethodInvocation, ast_SwitchCase, VariableDeclaration, ast_SynchronizedStatement, ast_ThisExpression, ast_ThrowStatement, ast_TryStatement, ast_VariableDeclarationExpression, ast_TypeDeclaration, AbstractTypeDeclaration, ast_SwitchStatement, ast_TypeDeclarationStatement, ast_TypeLiteral, ast_VariableDeclarationStatement, ast_EnhancedForStatement, ast_EnumDeclaration, ast_EnumConstantDeclaration, ast_WhileStatement, ast_InstanceofExpression, ast_LineComment, ast_BlockComment, ast_ParameterizedType, ast_QualifiedType, ast_WildcardType, ast_AnnotationTypeDeclaration, ast_UnionType, ast_LambdaExpression, ast_IntersectionType, ast_NameQualifiedType, ast_CreationReference, MethodReference, ast_AnnotationTypeMemberDeclaration, ast_TypeMethodReference, ast_MethodReference, ast_ExpressionMethodReference, ast_SuperMethodReference},
    associations={typeName0, typeName1, values3, typeName5, value7, qualifier9, name11, qualifier13, name15, parameters18, array22, index24, type27, dimensions28, initializer31, expressions33, elementType36, dimensions38, expression40, message42, fragments20, bodyDeclarations21, label51, type53, expression55, exception58, body59, expression62, typeArguments64, type67, arguments70, anonymousClassDeclaration73, package76, imports77, leftHandSide45, rightHandSide47, statements50, types79, expression81, thenExpression83, elseExpression86, typeArguments89, arguments91, label94, body96, expression98, initializers116, expression118, updaters121, body124, expression127, thenStatement129, elseStatement132, name135, leftOperand138, rightOperand140, expression101, expression103, name105, javadoc108, modifiers109, type111, fragments114, body159, javadoc162, modifiers164, typeParameters167, returnType2169, name172, receiverType175, receiverQualifier178, parameters181, extraDimensions2184, thrownExceptionTypes187, body190, expression193, typeArguments195, extendedOperands143, javadoc146, modifiers148, body151, tags154, label157, expression212, operand214, operand216, annotations218, qualifier220, name222, expression225, name198, arguments201, javadoc204, annotations207, name209, expression250, typeArguments252, arguments255, qualifier258, name260, qualifier263, typeArguments265, name268, arguments271, annotations227, name229, modifiers232, type235, varargsAnnotations238, name241, extraDimensions2244, initializer247, expression281, body283, qualifier286, expression288, resources290, body291, catchClauses294, finally_297, javadoc300, expression274, expression276, statements278, declaration320, type322, modifiers324, type327, fragments330, name333, extraDimensions2336, initializer339, modifiers342, modifiers302, name305, typeParameters308, superclassType311, superInterfaceTypes314, name363, bodyDeclarations317, parameter366, expression368, body371, javadoc374, modifiers376, name379, superInterfaceTypes382, enumConstants385, bodyDeclarations387, javadoc390, type344, fragments347, expression350, body352, leftOperand355, rightOperand357, type360, type414, typeArguments416, qualifier419, annotations421, name424, annotations427, bound429, name432, value435, javadoc438, modifiers393, name396, arguments399, anonymousClassDeclaration402, modifiers405, name408, typeBounds411, types463, annotations465, parameters468, body469, types471, qualifier473, annotations475, name478, type481, modifiers440, name443, bodyDeclarations446, javadoc449, modifiers451, type454, name457, default460, typeArguments496, name499, type502, typeArguments504, name507, typeArguments483, expression486, typeArguments488, name491, qualifier494},
    generalizations={gen_ast_MarkerAnnotation_Annotation, gen_ast_Annotation_Expression, gen_ast_Annotation_IExtendedModifier, gen_ast_Expression_ASTNode, gen_ast_NormalAnnotation_Annotation, gen_ast_SingleMemberAnnotation_Annotation, gen_ast_MemberRef_ASTNode, gen_ast_MemberRef_IDocElement, gen_ast_MethodRef_ASTNode, gen_ast_MethodRef_IDocElement, gen_ast_Modifier_ASTNode, gen_ast_Modifier_IExtendedModifier, gen_ast_ArrayAccess_Expression, gen_ast_ArrayCreation_Expression, gen_ast_ArrayInitializer_Expression, gen_ast_ArrayType_Type, gen_ast_Type_ASTNode, gen_ast_AssertStatement_Statement, gen_ast_Statement_ASTNode, gen_ast_Name_Expression, gen_ast_Assignment_Expression, gen_ast_Name_IDocElement, gen_ast_TagElement_ASTNode, gen_ast_TagElement_IDocElement, gen_ast_TextElement_ASTNode, gen_ast_TextElement_IDocElement, gen_ast_AnonymousClassDeclaration_ASTNode, gen_ast_CastExpression_Expression, gen_ast_CatchClause_ASTNode, gen_ast_CharacterLiteral_Expression, gen_ast_ClassInstanceCreation_Expression, gen_ast_CompilationUnit_ASTNode, gen_ast_Block_Statement, gen_ast_BooleanLiteral_Expression, gen_ast_BreakStatement_Statement, gen_ast_ConditionalExpression_Expression, gen_ast_ConstructorInvocation_Statement, gen_ast_ContinueStatement_Statement, gen_ast_DoStatement_Statement, gen_ast_EmptyStatement_Statement, gen_ast_ExpressionStatement_Statement, gen_ast_BodyDeclaration_ASTNode, gen_ast_ForStatement_Statement, gen_ast_IfStatement_Statement, gen_ast_ImportDeclaration_ASTNode, gen_ast_InfixExpression_Expression, gen_ast_FieldAccess_Expression, gen_ast_FieldDeclaration_BodyDeclaration, gen_ast_MethodDeclaration_BodyDeclaration, gen_ast_MethodInvocation_Expression, gen_ast_Initializer_BodyDeclaration, gen_ast_Javadoc_Comment, gen_ast_Comment_ASTNode, gen_ast_LabeledStatement_Statement, gen_ast_PostfixExpression_Expression, gen_ast_PrefixExpression_Expression, gen_ast_PrimitiveType_AnnotatableType, gen_ast_AnnotatableType_Type, gen_ast_QualifiedName_Name, gen_ast_ReturnStatement_Statement, gen_ast_SimpleName_Name, gen_ast_SimpleType_AnnotatableType, gen_ast_NullLiteral_Expression, gen_ast_NumberLiteral_Expression, gen_ast_PackageDeclaration_ASTNode, gen_ast_ParenthesizedExpression_Expression, gen_ast_VariableDeclaration_ASTNode, gen_ast_StringLiteral_Expression, gen_ast_SuperConstructorInvocation_Statement, gen_ast_SuperFieldAccess_Expression, gen_ast_SuperMethodInvocation_Expression, gen_ast_SingleVariableDeclaration_VariableDeclaration, gen_ast_SynchronizedStatement_Statement, gen_ast_ThisExpression_Expression, gen_ast_ThrowStatement_Statement, gen_ast_TryStatement_Statement, gen_ast_TypeDeclaration_AbstractTypeDeclaration, gen_ast_SwitchCase_Statement, gen_ast_SwitchStatement_Statement, gen_ast_AbstractTypeDeclaration_BodyDeclaration, gen_ast_TypeDeclarationStatement_Statement, gen_ast_TypeLiteral_Expression, gen_ast_VariableDeclarationExpression_Expression, gen_ast_VariableDeclarationFragment_VariableDeclaration, gen_ast_VariableDeclarationStatement_Statement, gen_ast_EnhancedForStatement_Statement, gen_ast_EnumDeclaration_AbstractTypeDeclaration, gen_ast_EnumConstantDeclaration_BodyDeclaration, gen_ast_WhileStatement_Statement, gen_ast_InstanceofExpression_Expression, gen_ast_LineComment_Comment, gen_ast_BlockComment_Comment, gen_ast_MethodRefParameter_ASTNode, gen_ast_ParameterizedType_Type, gen_ast_QualifiedType_AnnotatableType, gen_ast_WildcardType_AnnotatableType, gen_ast_MemberValuePair_ASTNode, gen_ast_AnnotationTypeDeclaration_AbstractTypeDeclaration, gen_ast_TypeParameter_ASTNode, gen_ast_UnionType_Type, gen_ast_Dimension_ASTNode, gen_ast_LambdaExpression_Expression, gen_ast_IntersectionType_Type, gen_ast_NameQualifiedType_AnnotatableType, gen_ast_CreationReference_MethodReference, gen_ast_AnnotationTypeMemberDeclaration_BodyDeclaration, gen_ast_TypeMethodReference_MethodReference, gen_ast_MethodReference_Expression, gen_ast_ExpressionMethodReference_MethodReference, gen_ast_SuperMethodReference_MethodReference},
    metadata=None
)
