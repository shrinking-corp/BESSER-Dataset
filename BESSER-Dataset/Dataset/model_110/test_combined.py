...
def test_hyp_ast_astnode_is_not_abstract():
    assert not inspect.isabstract(ast_ASTNode)


def test_hyp_ast_astnode_constructor_exists():
    assert callable(ast_ASTNode.__init__)


def test_hyp_ast_astnode_constructor_args():
    sig = inspect.signature(ast_ASTNode.__init__)
    params = list(sig.parameters.keys())



def test_hyp_methodreference_is_not_abstract():
    assert not inspect.isabstract(MethodReference)


def test_hyp_methodreference_constructor_exists():
    assert callable(MethodReference.__init__)


def test_hyp_methodreference_constructor_args():
    sig = inspect.signature(MethodReference.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_expressionmethodreference_is_not_abstract():
    assert not inspect.isabstract(ast_ExpressionMethodReference)


def test_hyp_ast_expressionmethodreference_constructor_exists():
    assert callable(ast_ExpressionMethodReference.__init__)


def test_hyp_ast_expressionmethodreference_constructor_args():
    sig = inspect.signature(ast_ExpressionMethodReference.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_supermethodreference_is_not_abstract():
    assert not inspect.isabstract(ast_SuperMethodReference)


def test_hyp_ast_supermethodreference_constructor_exists():
    assert callable(ast_SuperMethodReference.__init__)


def test_hyp_ast_supermethodreference_constructor_args():
    sig = inspect.signature(ast_SuperMethodReference.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_typemethodreference_is_not_abstract():
    assert not inspect.isabstract(ast_TypeMethodReference)


def test_hyp_ast_typemethodreference_constructor_exists():
    assert callable(ast_TypeMethodReference.__init__)


def test_hyp_ast_typemethodreference_constructor_args():
    sig = inspect.signature(ast_TypeMethodReference.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_creationreference_is_not_abstract():
    assert not inspect.isabstract(ast_CreationReference)


def test_hyp_ast_creationreference_constructor_exists():
    assert callable(ast_CreationReference.__init__)


def test_hyp_ast_creationreference_constructor_args():
...
def test_hyp_ast_enumdeclaration_is_not_abstract():
    assert not inspect.isabstract(ast_EnumDeclaration)


def test_hyp_ast_enumdeclaration_constructor_exists():
    assert callable(ast_EnumDeclaration.__init__)


def test_hyp_ast_enumdeclaration_constructor_args():
    sig = inspect.signature(ast_EnumDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_annotationtypedeclaration_is_not_abstract():
    assert not inspect.isabstract(ast_AnnotationTypeDeclaration)


def test_hyp_ast_annotationtypedeclaration_constructor_exists():
    assert callable(ast_AnnotationTypeDeclaration.__init__)


def test_hyp_ast_annotationtypedeclaration_constructor_args():
    sig = inspect.signature(ast_AnnotationTypeDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_typedeclaration_is_not_abstract():
    assert not inspect.isabstract(ast_TypeDeclaration)


def test_hyp_ast_typedeclaration_constructor_exists():
    assert callable(ast_TypeDeclaration.__init__)


def test_hyp_ast_typedeclaration_constructor_args():
...
def test_hyp_ast_qualifiedname_is_not_abstract():
    assert not inspect.isabstract(ast_QualifiedName)


def test_hyp_ast_qualifiedname_constructor_exists():
    assert callable(ast_QualifiedName.__init__)


def test_hyp_ast_qualifiedname_constructor_args():
    sig = inspect.signature(ast_QualifiedName.__init__)
    params = list(sig.parameters.keys())



def test_hyp_annotatabletype_is_not_abstract():
    assert not inspect.isabstract(AnnotatableType)


def test_hyp_annotatabletype_constructor_exists():
    assert callable(AnnotatableType.__init__)


def test_hyp_annotatabletype_constructor_args():
    sig = inspect.signature(AnnotatableType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_namequalifiedtype_is_not_abstract():
    assert not inspect.isabstract(ast_NameQualifiedType)


def test_hyp_ast_namequalifiedtype_constructor_exists():
    assert callable(ast_NameQualifiedType.__init__)


def test_hyp_ast_namequalifiedtype_constructor_args():
    sig = inspect.signature(ast_NameQualifiedType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_simpletype_is_not_abstract():
    assert not inspect.isabstract(ast_SimpleType)


def test_hyp_ast_simpletype_constructor_exists():
    assert callable(ast_SimpleType.__init__)


def test_hyp_ast_simpletype_constructor_args():
...
def test_hyp_ast_qualifiedtype_is_not_abstract():
    assert not inspect.isabstract(ast_QualifiedType)


def test_hyp_ast_qualifiedtype_constructor_exists():
    assert callable(ast_QualifiedType.__init__)


def test_hyp_ast_qualifiedtype_constructor_args():
...
def test_hyp_ast_blockcomment_is_not_abstract():
    assert not inspect.isabstract(ast_BlockComment)


def test_hyp_ast_blockcomment_constructor_exists():
    assert callable(ast_BlockComment.__init__)


def test_hyp_ast_blockcomment_constructor_args():
    sig = inspect.signature(ast_BlockComment.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_linecomment_is_not_abstract():
    assert not inspect.isabstract(ast_LineComment)


def test_hyp_ast_linecomment_constructor_exists():
    assert callable(ast_LineComment.__init__)


def test_hyp_ast_linecomment_constructor_args():
    sig = inspect.signature(ast_LineComment.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_variabledeclarationfragment_is_not_abstract():
    assert not inspect.isabstract(ast_VariableDeclarationFragment)


def test_hyp_ast_variabledeclarationfragment_constructor_exists():
    assert callable(ast_VariableDeclarationFragment.__init__)


def test_hyp_ast_variabledeclarationfragment_constructor_args():
    sig = inspect.signature(ast_VariableDeclarationFragment.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_javadoc_is_not_abstract():
    assert not inspect.isabstract(ast_Javadoc)


def test_hyp_ast_javadoc_constructor_exists():
    assert callable(ast_Javadoc.__init__)


def test_hyp_ast_javadoc_constructor_args():
...
def test_hyp_ast_annotationtypememberdeclaration_is_not_abstract():
    assert not inspect.isabstract(ast_AnnotationTypeMemberDeclaration)


def test_hyp_ast_annotationtypememberdeclaration_constructor_exists():
    assert callable(ast_AnnotationTypeMemberDeclaration.__init__)


def test_hyp_ast_annotationtypememberdeclaration_constructor_args():
    sig = inspect.signature(ast_AnnotationTypeMemberDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_initializer_is_not_abstract():
    assert not inspect.isabstract(ast_Initializer)


def test_hyp_ast_initializer_constructor_exists():
    assert callable(ast_Initializer.__init__)


def test_hyp_ast_initializer_constructor_args():
    sig = inspect.signature(ast_Initializer.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_enumconstantdeclaration_is_not_abstract():
    assert not inspect.isabstract(ast_EnumConstantDeclaration)


def test_hyp_ast_enumconstantdeclaration_constructor_exists():
    assert callable(ast_EnumConstantDeclaration.__init__)


def test_hyp_ast_enumconstantdeclaration_constructor_args():
    sig = inspect.signature(ast_EnumConstantDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_methoddeclaration_is_not_abstract():
    assert not inspect.isabstract(ast_MethodDeclaration)


def test_hyp_ast_methoddeclaration_constructor_exists():
    assert callable(ast_MethodDeclaration.__init__)


def test_hyp_ast_methoddeclaration_constructor_args():
...
def test_hyp_ast_fielddeclaration_is_not_abstract():
    assert not inspect.isabstract(ast_FieldDeclaration)


def test_hyp_ast_fielddeclaration_constructor_exists():
    assert callable(ast_FieldDeclaration.__init__)


def test_hyp_ast_fielddeclaration_constructor_args():
    sig = inspect.signature(ast_FieldDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_abstracttypedeclaration_is_not_abstract():
    assert not inspect.isabstract(ast_AbstractTypeDeclaration)


def test_hyp_ast_abstracttypedeclaration_constructor_exists():
    assert callable(ast_AbstractTypeDeclaration.__init__)


def test_hyp_ast_abstracttypedeclaration_constructor_args():
    sig = inspect.signature(ast_AbstractTypeDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_singlevariabledeclaration_is_not_abstract():
    assert not inspect.isabstract(ast_SingleVariableDeclaration)


def test_hyp_ast_singlevariabledeclaration_constructor_exists():
    assert callable(ast_SingleVariableDeclaration.__init__)


def test_hyp_ast_singlevariabledeclaration_constructor_args():
...
def test_hyp_ast_constructorinvocation_is_not_abstract():
    assert not inspect.isabstract(ast_ConstructorInvocation)


def test_hyp_ast_constructorinvocation_constructor_exists():
    assert callable(ast_ConstructorInvocation.__init__)


def test_hyp_ast_constructorinvocation_constructor_args():
    sig = inspect.signature(ast_ConstructorInvocation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_typedeclarationstatement_is_not_abstract():
    assert not inspect.isabstract(ast_TypeDeclarationStatement)


def test_hyp_ast_typedeclarationstatement_constructor_exists():
    assert callable(ast_TypeDeclarationStatement.__init__)


def test_hyp_ast_typedeclarationstatement_constructor_args():
...
def test_hyp_ast_variabledeclarationstatement_is_not_abstract():
    assert not inspect.isabstract(ast_VariableDeclarationStatement)


def test_hyp_ast_variabledeclarationstatement_constructor_exists():
    assert callable(ast_VariableDeclarationStatement.__init__)


def test_hyp_ast_variabledeclarationstatement_constructor_args():
...
def test_hyp_ast_superconstructorinvocation_is_not_abstract():
    assert not inspect.isabstract(ast_SuperConstructorInvocation)


def test_hyp_ast_superconstructorinvocation_constructor_exists():
    assert callable(ast_SuperConstructorInvocation.__init__)


def test_hyp_ast_superconstructorinvocation_constructor_args():
    sig = inspect.signature(ast_SuperConstructorInvocation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_enhancedforstatement_is_not_abstract():
    assert not inspect.isabstract(ast_EnhancedForStatement)


def test_hyp_ast_enhancedforstatement_constructor_exists():
    assert callable(ast_EnhancedForStatement.__init__)


def test_hyp_ast_enhancedforstatement_constructor_args():
    sig = inspect.signature(ast_EnhancedForStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_block_is_not_abstract():
    assert not inspect.isabstract(ast_Block)


def test_hyp_ast_block_constructor_exists():
    assert callable(ast_Block.__init__)


def test_hyp_ast_block_constructor_args():
    sig = inspect.signature(ast_Block.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_dostatement_is_not_abstract():
    assert not inspect.isabstract(ast_DoStatement)


def test_hyp_ast_dostatement_constructor_exists():
    assert callable(ast_DoStatement.__init__)


def test_hyp_ast_dostatement_constructor_args():
...
def test_hyp_ast_uniontype_is_not_abstract():
    assert not inspect.isabstract(ast_UnionType)


def test_hyp_ast_uniontype_constructor_exists():
    assert callable(ast_UnionType.__init__)


def test_hyp_ast_uniontype_constructor_args():
    sig = inspect.signature(ast_UnionType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_parameterizedtype_is_not_abstract():
    assert not inspect.isabstract(ast_ParameterizedType)


def test_hyp_ast_parameterizedtype_constructor_exists():
    assert callable(ast_ParameterizedType.__init__)


def test_hyp_ast_parameterizedtype_constructor_args():
    sig = inspect.signature(ast_ParameterizedType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_annotatabletype_is_not_abstract():
    assert not inspect.isabstract(ast_AnnotatableType)


def test_hyp_ast_annotatabletype_constructor_exists():
    assert callable(ast_AnnotatableType.__init__)


def test_hyp_ast_annotatabletype_constructor_args():
    sig = inspect.signature(ast_AnnotatableType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_intersectiontype_is_not_abstract():
    assert not inspect.isabstract(ast_IntersectionType)


def test_hyp_ast_intersectiontype_constructor_exists():
    assert callable(ast_IntersectionType.__init__)


def test_hyp_ast_intersectiontype_constructor_args():
    sig = inspect.signature(ast_IntersectionType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_arraytype_is_not_abstract():
    assert not inspect.isabstract(ast_ArrayType)


def test_hyp_ast_arraytype_constructor_exists():
    assert callable(ast_ArrayType.__init__)


def test_hyp_ast_arraytype_constructor_args():
    sig = inspect.signature(ast_ArrayType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_iextendedmodifier_is_not_abstract():
    assert not inspect.isabstract(IExtendedModifier)


def test_hyp_iextendedmodifier_constructor_exists():
    assert callable(IExtendedModifier.__init__)


def test_hyp_iextendedmodifier_constructor_args():
...
def test_hyp_ast_catchclause_is_not_abstract():
    assert not inspect.isabstract(ast_CatchClause)


def test_hyp_ast_catchclause_constructor_exists():
    assert callable(ast_CatchClause.__init__)


def test_hyp_ast_catchclause_constructor_args():
    sig = inspect.signature(ast_CatchClause.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_bodydeclaration_is_not_abstract():
    assert not inspect.isabstract(ast_BodyDeclaration)


def test_hyp_ast_bodydeclaration_constructor_exists():
    assert callable(ast_BodyDeclaration.__init__)


def test_hyp_ast_bodydeclaration_constructor_args():
    sig = inspect.signature(ast_BodyDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_typeparameter_is_not_abstract():
    assert not inspect.isabstract(ast_TypeParameter)


def test_hyp_ast_typeparameter_constructor_exists():
    assert callable(ast_TypeParameter.__init__)


def test_hyp_ast_typeparameter_constructor_args():
    sig = inspect.signature(ast_TypeParameter.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_type_is_not_abstract():
    assert not inspect.isabstract(ast_Type)


def test_hyp_ast_type_constructor_exists():
    assert callable(ast_Type.__init__)


def test_hyp_ast_type_constructor_args():
    sig = inspect.signature(ast_Type.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_comment_is_not_abstract():
    assert not inspect.isabstract(ast_Comment)


def test_hyp_ast_comment_constructor_exists():
    assert callable(ast_Comment.__init__)


def test_hyp_ast_comment_constructor_args():
    sig = inspect.signature(ast_Comment.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_packagedeclaration_is_not_abstract():
    assert not inspect.isabstract(ast_PackageDeclaration)


def test_hyp_ast_packagedeclaration_constructor_exists():
    assert callable(ast_PackageDeclaration.__init__)


def test_hyp_ast_packagedeclaration_constructor_args():
    sig = inspect.signature(ast_PackageDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_anonymousclassdeclaration_is_not_abstract():
    assert not inspect.isabstract(ast_AnonymousClassDeclaration)


def test_hyp_ast_anonymousclassdeclaration_constructor_exists():
    assert callable(ast_AnonymousClassDeclaration.__init__)


def test_hyp_ast_anonymousclassdeclaration_constructor_args():
...
def test_hyp_ast_importdeclaration_is_not_abstract():
    assert not inspect.isabstract(ast_ImportDeclaration)


def test_hyp_ast_importdeclaration_constructor_exists():
    assert callable(ast_ImportDeclaration.__init__)


def test_hyp_ast_importdeclaration_constructor_args():
...
def test_hyp_ast_compilationunit_is_not_abstract():
    assert not inspect.isabstract(ast_CompilationUnit)


def test_hyp_ast_compilationunit_constructor_exists():
    assert callable(ast_CompilationUnit.__init__)


def test_hyp_ast_compilationunit_constructor_args():
    sig = inspect.signature(ast_CompilationUnit.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_dimension_is_not_abstract():
    assert not inspect.isabstract(ast_Dimension)


def test_hyp_ast_dimension_constructor_exists():
    assert callable(ast_Dimension.__init__)


def test_hyp_ast_dimension_constructor_args():
...
def test_hyp_ast_iextendedmodifier_is_not_abstract():
    assert not inspect.isabstract(ast_IExtendedModifier)


def test_hyp_ast_iextendedmodifier_constructor_exists():
    assert callable(ast_IExtendedModifier.__init__)


def test_hyp_ast_iextendedmodifier_constructor_args():
    sig = inspect.signature(ast_IExtendedModifier.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_methodrefparameter_is_not_abstract():
    assert not inspect.isabstract(ast_MethodRefParameter)


def test_hyp_ast_methodrefparameter_constructor_exists():
    assert callable(ast_MethodRefParameter.__init__)


def test_hyp_ast_methodrefparameter_constructor_args():
...
def test_hyp_ast_simplename_is_not_abstract():
    assert not inspect.isabstract(ast_SimpleName)


def test_hyp_ast_simplename_constructor_exists():
    assert callable(ast_SimpleName.__init__)


def test_hyp_ast_simplename_constructor_args():
...
def test_hyp_idocelement_is_not_abstract():
    assert not inspect.isabstract(IDocElement)


def test_hyp_idocelement_constructor_exists():
    assert callable(IDocElement.__init__)


def test_hyp_idocelement_constructor_args():
    sig = inspect.signature(IDocElement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_methodref_is_not_abstract():
    assert not inspect.isabstract(ast_MethodRef)


def test_hyp_ast_methodref_constructor_exists():
    assert callable(ast_MethodRef.__init__)


def test_hyp_ast_methodref_constructor_args():
    sig = inspect.signature(ast_MethodRef.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_tagelement_is_not_abstract():
    assert not inspect.isabstract(ast_TagElement)


def test_hyp_ast_tagelement_constructor_exists():
    assert callable(ast_TagElement.__init__)


def test_hyp_ast_tagelement_constructor_args():
...
def test_hyp_ast_textelement_is_not_abstract():
    assert not inspect.isabstract(ast_TextElement)


def test_hyp_ast_textelement_constructor_exists():
    assert callable(ast_TextElement.__init__)


def test_hyp_ast_textelement_constructor_args():
...
def test_hyp_ast_memberref_is_not_abstract():
    assert not inspect.isabstract(ast_MemberRef)


def test_hyp_ast_memberref_constructor_exists():
    assert callable(ast_MemberRef.__init__)


def test_hyp_ast_memberref_constructor_args():
    sig = inspect.signature(ast_MemberRef.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_idocelement_is_not_abstract():
    assert not inspect.isabstract(ast_IDocElement)


def test_hyp_ast_idocelement_constructor_exists():
    assert callable(ast_IDocElement.__init__)


def test_hyp_ast_idocelement_constructor_args():
    sig = inspect.signature(ast_IDocElement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_membervaluepair_is_not_abstract():
    assert not inspect.isabstract(ast_MemberValuePair)


def test_hyp_ast_membervaluepair_constructor_exists():
    assert callable(ast_MemberValuePair.__init__)


def test_hyp_ast_membervaluepair_constructor_args():
...
def test_hyp_ast_classinstancecreation_is_not_abstract():
    assert not inspect.isabstract(ast_ClassInstanceCreation)


def test_hyp_ast_classinstancecreation_constructor_exists():
    assert callable(ast_ClassInstanceCreation.__init__)


def test_hyp_ast_classinstancecreation_constructor_args():
    sig = inspect.signature(ast_ClassInstanceCreation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_lambdaexpression_is_not_abstract():
    assert not inspect.isabstract(ast_LambdaExpression)


def test_hyp_ast_lambdaexpression_constructor_exists():
    assert callable(ast_LambdaExpression.__init__)


def test_hyp_ast_lambdaexpression_constructor_args():
...
def test_hyp_ast_methodreference_is_not_abstract():
    assert not inspect.isabstract(ast_MethodReference)


def test_hyp_ast_methodreference_constructor_exists():
    assert callable(ast_MethodReference.__init__)


def test_hyp_ast_methodreference_constructor_args():
...
def test_hyp_ast_supermethodinvocation_is_not_abstract():
    assert not inspect.isabstract(ast_SuperMethodInvocation)


def test_hyp_ast_supermethodinvocation_constructor_exists():
    assert callable(ast_SuperMethodInvocation.__init__)


def test_hyp_ast_supermethodinvocation_constructor_args():
    sig = inspect.signature(ast_SuperMethodInvocation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_infixexpression_is_not_abstract():
    assert not inspect.isabstract(ast_InfixExpression)


def test_hyp_ast_infixexpression_constructor_exists():
    assert callable(ast_InfixExpression.__init__)


def test_hyp_ast_infixexpression_constructor_args():
...
def test_hyp_ast_superfieldaccess_is_not_abstract():
    assert not inspect.isabstract(ast_SuperFieldAccess)


def test_hyp_ast_superfieldaccess_constructor_exists():
    assert callable(ast_SuperFieldAccess.__init__)


def test_hyp_ast_superfieldaccess_constructor_args():
...
def test_hyp_ast_prefixexpression_is_not_abstract():
    assert not inspect.isabstract(ast_PrefixExpression)


def test_hyp_ast_prefixexpression_constructor_exists():
    assert callable(ast_PrefixExpression.__init__)


def test_hyp_ast_prefixexpression_constructor_args():
...
def test_hyp_ast_conditionalexpression_is_not_abstract():
    assert not inspect.isabstract(ast_ConditionalExpression)


def test_hyp_ast_conditionalexpression_constructor_exists():
    assert callable(ast_ConditionalExpression.__init__)


def test_hyp_ast_conditionalexpression_constructor_args():
    sig = inspect.signature(ast_ConditionalExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_arrayaccess_is_not_abstract():
    assert not inspect.isabstract(ast_ArrayAccess)


def test_hyp_ast_arrayaccess_constructor_exists():
    assert callable(ast_ArrayAccess.__init__)


def test_hyp_ast_arrayaccess_constructor_args():
...
def test_hyp_ast_fieldaccess_is_not_abstract():
    assert not inspect.isabstract(ast_FieldAccess)


def test_hyp_ast_fieldaccess_constructor_exists():
    assert callable(ast_FieldAccess.__init__)


def test_hyp_ast_fieldaccess_constructor_args():
    sig = inspect.signature(ast_FieldAccess.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_nullliteral_is_not_abstract():
    assert not inspect.isabstract(ast_NullLiteral)


def test_hyp_ast_nullliteral_constructor_exists():
    assert callable(ast_NullLiteral.__init__)


def test_hyp_ast_nullliteral_constructor_args():
    sig = inspect.signature(ast_NullLiteral.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_instanceofexpression_is_not_abstract():
    assert not inspect.isabstract(ast_InstanceofExpression)


def test_hyp_ast_instanceofexpression_constructor_exists():
    assert callable(ast_InstanceofExpression.__init__)


def test_hyp_ast_instanceofexpression_constructor_args():
    sig = inspect.signature(ast_InstanceofExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_arrayinitializer_is_not_abstract():
    assert not inspect.isabstract(ast_ArrayInitializer)


def test_hyp_ast_arrayinitializer_constructor_exists():
    assert callable(ast_ArrayInitializer.__init__)


def test_hyp_ast_arrayinitializer_constructor_args():
...
def test_hyp_ast_methodinvocation_is_not_abstract():
    assert not inspect.isabstract(ast_MethodInvocation)


def test_hyp_ast_methodinvocation_constructor_exists():
    assert callable(ast_MethodInvocation.__init__)


def test_hyp_ast_methodinvocation_constructor_args():
    sig = inspect.signature(ast_MethodInvocation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_variabledeclarationexpression_is_not_abstract():
    assert not inspect.isabstract(ast_VariableDeclarationExpression)


def test_hyp_ast_variabledeclarationexpression_constructor_exists():
    assert callable(ast_VariableDeclarationExpression.__init__)


def test_hyp_ast_variabledeclarationexpression_constructor_args():
    sig = inspect.signature(ast_VariableDeclarationExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_arraycreation_is_not_abstract():
    assert not inspect.isabstract(ast_ArrayCreation)


def test_hyp_ast_arraycreation_constructor_exists():
    assert callable(ast_ArrayCreation.__init__)


def test_hyp_ast_arraycreation_constructor_args():
    sig = inspect.signature(ast_ArrayCreation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_typeliteral_is_not_abstract():
    assert not inspect.isabstract(ast_TypeLiteral)


def test_hyp_ast_typeliteral_constructor_exists():
    assert callable(ast_TypeLiteral.__init__)


def test_hyp_ast_typeliteral_constructor_args():
    sig = inspect.signature(ast_TypeLiteral.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_thisexpression_is_not_abstract():
    assert not inspect.isabstract(ast_ThisExpression)


def test_hyp_ast_thisexpression_constructor_exists():
    assert callable(ast_ThisExpression.__init__)


def test_hyp_ast_thisexpression_constructor_args():
    sig = inspect.signature(ast_ThisExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_castexpression_is_not_abstract():
    assert not inspect.isabstract(ast_CastExpression)


def test_hyp_ast_castexpression_constructor_exists():
    assert callable(ast_CastExpression.__init__)


def test_hyp_ast_castexpression_constructor_args():
    sig = inspect.signature(ast_CastExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_numberliteral_is_not_abstract():
    assert not inspect.isabstract(ast_NumberLiteral)


def test_hyp_ast_numberliteral_constructor_exists():
    assert callable(ast_NumberLiteral.__init__)


def test_hyp_ast_numberliteral_constructor_args():
...
def test_hyp_ast_annotation_is_not_abstract():
    assert not inspect.isabstract(ast_Annotation)


def test_hyp_ast_annotation_constructor_exists():
    assert callable(ast_Annotation.__init__)


def test_hyp_ast_annotation_constructor_args():
    sig = inspect.signature(ast_Annotation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_name_is_not_abstract():
    assert not inspect.isabstract(ast_Name)


def test_hyp_ast_name_constructor_exists():
    assert callable(ast_Name.__init__)


def test_hyp_ast_name_constructor_args():
...
def test_hyp_ast_normalannotation_is_not_abstract():
    assert not inspect.isabstract(ast_NormalAnnotation)


def test_hyp_ast_normalannotation_constructor_exists():
    assert callable(ast_NormalAnnotation.__init__)


def test_hyp_ast_normalannotation_constructor_args():
    sig = inspect.signature(ast_NormalAnnotation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_singlememberannotation_is_not_abstract():
    assert not inspect.isabstract(ast_SingleMemberAnnotation)


def test_hyp_ast_singlememberannotation_constructor_exists():
    assert callable(ast_SingleMemberAnnotation.__init__)


def test_hyp_ast_singlememberannotation_constructor_args():
    sig = inspect.signature(ast_SingleMemberAnnotation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ast_markerannotation_is_not_abstract():
    assert not inspect.isabstract(ast_MarkerAnnotation)


def test_hyp_ast_markerannotation_constructor_exists():
    assert callable(ast_MarkerAnnotation.__init__)


def test_hyp_ast_markerannotation_constructor_args():
...
def test_hyp_ast_typedeclaration_interface_setter(instance):
...
def test_hyp_ast_wildcardtype_upperBound_setter(instance):
...
def test_hyp_ast_primitivetype_primitiveTypeCode_setter(instance):
...
def test_hyp_ast_methoddeclaration_constructor_setter(instance):
...
def test_hyp_ast_singlevariabledeclaration_varargs_setter(instance):
...
def test_hyp_ast_importdeclaration_onDemand_setter(instance):
...
@given(instance=ast_ImportDeclaration_strategy)
def test_hyp_ast_importdeclaration_static_setter(instance):
...
def test_hyp_ast_modifier_keyword_setter(instance):
...
def test_hyp_ast_methodrefparameter_varargs_setter(instance):
    original = instance.varargs
    instance.varargs = original
    assert instance.varargs == original
...
def test_hyp_ast_simplename_identifier_setter(instance):
...
def test_hyp_ast_tagelement_tagName_setter(instance):
...
def test_hyp_ast_textelement_text_setter(instance):
...
def test_hyp_ast_lambdaexpression_parentheses_setter(instance):
...
def test_hyp_ast_infixexpression_operator_setter(instance):
    original = instance.operator
    instance.operator = original
    assert instance.operator == original
...
def test_hyp_ast_stringliteral_escapedValue_setter(instance):
...
def test_hyp_ast_characterliteral_escapedValue_setter(instance):
    original = instance.escapedValue
    instance.escapedValue = original
    assert instance.escapedValue == original
...
def test_hyp_ast_assignment_operator_setter(instance):
    original = instance.operator
    instance.operator = original
    assert instance.operator == original
...
def test_hyp_ast_prefixexpression_operator_setter(instance):
    original = instance.operator
    instance.operator = original
    assert instance.operator == original
...
def test_hyp_ast_booleanliteral_booleanValue_setter(instance):
...
def test_hyp_ast_numberliteral_token_setter(instance):
