...
class myFirstEditorCustom_Transition:
    ...
    def __init__(self, name: str, myFirstEditorCustom_Transition: "myFirstEditorCustom_StateMachine" = None, Transition: "myFirstEditorCustom_State" = None, Transition5: "myFirstEditorCustom_State" = None, out: "myFirstEditorCustom_State" = None, in_: "myFirstEditorCustom_State" = None):
        self.name = name
    ...
    def in_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_myFirstEditorCustom_Transition__in_", None)
        self.__in_ = value
