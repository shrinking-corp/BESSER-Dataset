...
# Classes
myFirstEditorCustom_StateMachine = Class(name="myFirstEditorCustom_StateMachine")
myFirstEditorCustom_State = Class(name="myFirstEditorCustom_State")
myFirstEditorCustom_Transition = Class(name="myFirstEditorCustom_Transition")
myFirstEditorCustom_StartState = Class(name="myFirstEditorCustom_StartState")
State = Class(name="State")
myFirstEditorCustom_EndState = Class(name="myFirstEditorCustom_EndState")
...
source7: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="in_", type=myFirstEditorCustom_State, multiplicity=Multiplicity(0, 1))
    }
)
...
domain_model = DomainModel(
    ...
    types={myFirstEditorCustom_StateMachine, myFirstEditorCustom_State, myFirstEditorCustom_Transition, myFirstEditorCustom_StartState, State, myFirstEditorCustom_EndState},
    associations={state0, transition1, out3, in_4, target6, source7},
