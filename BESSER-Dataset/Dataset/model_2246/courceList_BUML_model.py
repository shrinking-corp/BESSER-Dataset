...
# Classes
courceList_Department = Class(name="courceList_Department")
courceList_StudyGeneralization = Class(name="courceList_StudyGeneralization")
courceList_Cource = Class(name="courceList_Cource")
courceList_Professor = Class(name="courceList_Professor")
courceList_Exam = Class(name="courceList_Exam")
courceList_EvaluationForm = Class(name="courceList_EvaluationForm")
courceList_Work = Class(name="courceList_Work")
courceList_StudyCourceRelation = Class(name="courceList_StudyCourceRelation")
courceList_CourceSpecification = Class(name="courceList_CourceSpecification")
courceList_Student = Class(name="courceList_Student")
courceList_StudyProgram = Class(name="courceList_StudyProgram")
courceList_Specialisation = Class(name="courceList_Specialisation")
...
courceList_StudyGeneralization.attributes={courceList_StudyGeneralization_name, courceList_StudyGeneralization_nrOfYears, courceList_StudyGeneralization_campus, courceList_StudyGeneralization_abbreviation, courceList_StudyGeneralization_educationLevel}
...
courceList_Exam.attributes={courceList_Exam_weight, courceList_Exam_lenght, courceList_Exam_date, courceList_Exam_form}
...
courceList_StudyCourceRelation.attributes={courceList_StudyCourceRelation_year, courceList_StudyCourceRelation_status}
...
courceList_CourceSpecification.attributes={courceList_CourceSpecification_language, courceList_CourceSpecification_semester, courceList_CourceSpecification_version, courceList_CourceSpecification_name, courceList_CourceSpecification_specificationYear, courceList_CourceSpecification_credits}
...
courceList_Specialisation.attributes={courceList_Specialisation_startSemester, courceList_Specialisation_name}
...
domain_model = DomainModel(
    name="courceList",
    types={courceList_Department, courceList_StudyGeneralization, courceList_Cource, courceList_Professor, courceList_Exam, courceList_EvaluationForm, courceList_Work, courceList_StudyCourceRelation, courceList_CourceSpecification, courceList_Student, courceList_StudyProgram, courceList_Specialisation, Semester, WorkForm, EducationLevel, Campus, EvaluationType},
    associations={studyProgram0, course1, professor3, evaluationForm14, exam15, work16, cource18, evaluationForm21, cource23, department5, corseSpecifications6, studyProgram7, cource8, generalization9, student12, cource39, coordinator41, evaluationForm43, specialisation24, department27, cource29, studyProgram30, furtherSpecialisation34, hostSpecialisation37, studyProgram46, department48},
    generalizations={},
    metadata=None
)
