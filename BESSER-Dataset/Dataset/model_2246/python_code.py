...
class courceList_CourceSpecification:
    ...
    def __init__(self, specificationYear: int, semester: str, language: str, version: str, credits: float, name: str, CourceSpecification20: "courceList_EvaluationForm" = None, courceList_CourceSpecification: "courceList_StudyCourceRelation" = None, CourceSpecification: "courceList_Cource" = None, corseSpecifications: "courceList_Cource" = None, courceList_CourceSpecification42: "courceList_Professor" = None, cource44: "courceList_EvaluationForm" = None):
...
class courceList_StudyCourceRelation:
    ...
    def __init__(self, status: str, year: int, courceList_StudyCourceRelation: "courceList_CourceSpecification" = None, cource25: "courceList_Specialisation" = None, StudyCourceRelation: "courceList_Specialisation" = None):
        self.status = status
        self.year = year
...
class courceList_EvaluationForm:
    ...
    def __init__(self, evaluationType: str, EvaluationForm: "courceList_Exam" = None, evaluationForm: "courceList_Exam" = None, evaluationForm17: "courceList_Work" = None, evaluationForm19: "courceList_CourceSpecification" = None, EvaluationForm22: "courceList_Work" = None, EvaluationForm45: "courceList_CourceSpecification" = None):
...
class courceList_Exam:
    ...
    def __init__(self, weight: int, form: str, lenght: int, date: date, exam: "courceList_EvaluationForm" = None, Exam: "courceList_EvaluationForm" = None):
        self.weight = weight
        self.form = form
        self.lenght = lenght
        self.date = date
...
class courceList_Professor:
    ...
    def __init__(self, name: str, title: str, Professor: "courceList_Department" = None, courceList_Professor: "courceList_CourceSpecification" = None, professor: "courceList_Department" = None):
        self.name = name
        self.title = title
...
class courceList_Cource:
    ...
    def __init__(self, code: str, name: str, location: str, Cource: "courceList_Department" = None, course: "courceList_Department" = None, cource: set["courceList_CourceSpecification"] = None, Cource40: "courceList_CourceSpecification" = None):
        self.code = code
        self.name = name
...
class courceList_StudyGeneralization:
    ...
    def __init__(self, campus: str, abbreviation: str, name: str, educationLevel: str, nrOfYears: int, StudyGeneralization: "courceList_Department" = None, StudyGeneralization11: "courceList_StudyProgram" = None, generalization: set["courceList_StudyProgram"] = None, studyProgram49: "courceList_Department" = None):
        self.campus = campus
