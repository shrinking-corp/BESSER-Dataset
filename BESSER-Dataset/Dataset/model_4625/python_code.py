...
class model_SymbolReference(Primitive):
    ...
    def __init__(self, onCreateProperties: str, uri: str, zoom: str, model_SymbolReference: set["model_StringToStringMap"] = None):
...
class model_Figure(Primitive):
    ...
    def __init__(self, foregroundColor: str, backgroundColor: str, onClick: str, onDoubleClick: str, visible: bool, border: str, opaque: str, toolTip: str, onMouseIn: str, onMouseOut: str, onMouseMove: str, onMouseHover: str, onMouseDrag: str, model_Figure: "model_Dimension" = None, model_Figure24: "model_Cursor" = None):
...
class model_Position:
    ...
    def __init__(self, x: float, y: float, model_Position: "model_XYChild" = None, model_Position41: "model_Polygon" = None, model_Position20: "model_Line" = None):
        self.x = x
        self.y = y
...
class model_Symbol:
    ...
    def __init__(self, backgroundColor: str, onInit: str, onDispose: str, onUpdate: str, scriptModules: str, backgroundImage: str, model_Symbol4: "model_Cursor" = None, model_Symbol: "model_Primitive" = None, model_Symbol2: set["model_StringToStringMap"] = None, model_Symbol6: "model_Dimension" = None, model_Symbol8: set["model_Connection"] = None, model_Symbol10: set["model_TimeTrigger"] = None):
        self.backgroundColor = backgroundColor
        self.onInit = onInit
...
class model_Dimension:
    ...
    def __init__(self, width: float, height: float, model_Dimension: "model_Symbol" = None, model_Dimension43: "model_RoundedRectangle" = None, model_Dimension16: "model_XYChild" = None, model_Dimension22: "model_Figure" = None):
        self.width = width
        self.height = height
