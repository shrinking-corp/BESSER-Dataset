...
# Classes
model_Cursor = Class(name="model_Cursor", is_abstract=True)
model_Dimension = Class(name="model_Dimension")
model_Symbol = Class(name="model_Symbol")
model_Primitive = Class(name="model_Primitive", is_abstract=True)
model_StringToStringMap = Class(name="model_StringToStringMap")
model_XYChild = Class(name="model_XYChild")
Child = Class(name="Child")
model_Position = Class(name="model_Position")
model_Connection = Class(name="model_Connection")
model_TimeTrigger = Class(name="model_TimeTrigger")
model_Container = Class(name="model_Container", is_abstract=True)
Primitive = Class(name="Primitive")
model_Shape = Class(name="model_Shape", is_abstract=True)
Figure = Class(name="Figure")
model_Rectangle = Class(name="model_Rectangle")
Shape = Class(name="Shape")
model_Text = Class(name="model_Text")
model_Child = Class(name="model_Child")
model_XYContainer = Class(name="model_XYContainer")
Container = Class(name="Container")
model_Line = Class(name="model_Line")
model_Figure = Class(name="model_Figure", is_abstract=True)
model_SymbolReference = Class(name="model_SymbolReference")
model_SystemCursor = Class(name="model_SystemCursor")
Cursor = Class(name="Cursor")
model_GridContainer = Class(name="model_GridContainer")
model_GridChild = Class(name="model_GridChild")
model_BorderContainer = Class(name="model_BorderContainer")
model_BorderChild = Class(name="model_BorderChild")
model_FigureContainer = Class(name="model_FigureContainer")
model_Image = Class(name="model_Image")
model_Ellipse = Class(name="model_Ellipse")
model_Arc = Class(name="model_Arc")
model_StackContainer = Class(name="model_StackContainer")
model_Polygon = Class(name="model_Polygon")
model_RoundedRectangle = Class(name="model_RoundedRectangle")
...
model_Symbol.attributes={model_Symbol_onInit, model_Symbol_onDispose, model_Symbol_backgroundColor, model_Symbol_scriptModules, model_Symbol_onUpdate, model_Symbol_backgroundImage}
...
model_TimeTrigger.attributes={model_TimeTrigger_onTrigger, model_TimeTrigger_period}
...
model_Shape.attributes={model_Shape_alpha, model_Shape_antialias, model_Shape_outline, model_Shape_fill, model_Shape_lineWidth}
...
model_Text.attributes={model_Text_iconAlignment, model_Text_textAlignment, model_Text_alpha, model_Text_text, model_Text_fontItalic, model_Text_labelAlignment, model_Text_fontSize, model_Text_fontName, model_Text_fontBold, model_Text_textPlacement}
...
model_Figure.attributes={model_Figure_onMouseHover, model_Figure_foregroundColor, model_Figure_visible, model_Figure_toolTip, model_Figure_border, model_Figure_onMouseOut, model_Figure_onMouseMove, model_Figure_opaque, model_Figure_backgroundColor, model_Figure_onMouseDrag, model_Figure_onClick, model_Figure_onDoubleClick, model_Figure_onMouseIn}
...
model_SymbolReference.attributes={model_SymbolReference_onCreateProperties, model_SymbolReference_zoom, model_SymbolReference_uri}
...
model_GridContainer.attributes={model_GridContainer_marginWidth, model_GridContainer_horizontalSpacing, model_GridContainer_equalWidth, model_GridContainer_verticalSpacing, model_GridContainer_columns, model_GridContainer_marginHeight}
...
model_GridChild.attributes={model_GridChild_heightHint, model_GridChild_spanCols, model_GridChild_horizontalAlignment, model_GridChild_spanRows, model_GridChild_widthHint, model_GridChild_verticalAlignment, model_GridChild_grabHorizontalSpace, model_GridChild_grabVerticalSpace}
...
domain_model = DomainModel(
    name="model",
    types={model_Cursor, model_Dimension, model_Symbol, model_Primitive, model_StringToStringMap, model_XYChild, Child, model_Position, model_Connection, model_TimeTrigger, model_Container, Primitive, model_Shape, Figure, model_Rectangle, Shape, model_Text, model_Child, model_XYContainer, Container, model_Line, model_Figure, model_SymbolReference, model_SystemCursor, Cursor, model_GridContainer, model_GridChild, model_BorderContainer, model_BorderChild, model_FigureContainer, model_Image, model_Ellipse, model_Arc, model_StackContainer, model_Polygon, model_RoundedRectangle, Alignment, Orientation, SystemCursorType, GridAlignment},
    associations={cursors3, root0, properties1, position13, designSize5, connections7, timeTriggers9, element11, properties26, dimension14, children17, points19, size21, cursor23, children28, children29, content30, start32, end35, children38, points40, corner42},
    generalizations={gen_model_XYChild_Child, gen_model_Container_Primitive, gen_model_Shape_Figure, gen_model_Rectangle_Shape, gen_model_Text_Figure, gen_model_XYContainer_Container, gen_model_Line_Shape, gen_model_Figure_Primitive, gen_model_SymbolReference_Primitive, gen_model_GridChild_Child, gen_model_SystemCursor_Cursor, gen_model_GridContainer_Container, gen_model_BorderContainer_Container, gen_model_BorderChild_Child, gen_model_FigureContainer_Figure, gen_model_Image_Figure, gen_model_Ellipse_Shape, gen_model_Arc_Shape, gen_model_StackContainer_Container, gen_model_Polygon_Shape, gen_model_RoundedRectangle_Shape},
    metadata=None
)
