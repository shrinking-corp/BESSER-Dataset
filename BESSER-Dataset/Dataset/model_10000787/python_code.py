...
class Admin:
    ...
    def __init__(self, name: int, address: str, customer27: set["Product"] = None):
        self.name = name
    ...
    def customer27(self, value):
        ...
        old_value = getattr(self, f"_Admin__customer27", None)
        self.__customer27 = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "update_create26"):
                    opp_val = getattr(item, "update_create26", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "update_create26"):
                    ...
                    if opp_val is None:
                        setattr(item, "update_create26", set([self]))
...
class Shipment:
    ...
    def __init__(self, name: str, warehouse29: set["Warehouse"] = None):
        self.name = name
...
class Warehouse:
    ...
    def __init__(self, name: str, location: str, shipment28: set["Shipment"] = None, product31: set["Product"] = None):
        self.name = name
...
class Product:
    ...
    def __init__(self, name: str, id: int, type: str, oRDER25: set["Order"] = None, update_create26: set["Admin"] = None, warehouse30: set["Warehouse"] = None):
        self.name = name
        self.id = id
        self.type = type
        self.oRDER25 = oRDER25 if oRDER25 is not None else set()
        self.update_create26 = update_create26 if update_create26 is not None else set()
    ...
    @property
    def update_create26(self):
        return self.__update_create26
    @update_create26.setter
    def update_create26(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Product__update_create26", None)
        self.__update_create26 = value if value is not None else set()
