...
Customer.attributes={Customer_mailid, Customer_id, Customer_name, Customer_address, Customer_phoneno}
...
Warehouse_name: Property = Property(name="name", type=StringType)
Warehouse_location: Property = Property(name="location", type=StringType)
Warehouse.attributes={Warehouse_name, Warehouse_location}
...
Shipment_name: Property = Property(name="name", type=StringType)
Shipment.attributes={Shipment_name}

# Admin class attributes and methods
Admin_name: Property = Property(name="name", type=IntegerType)
Admin_address: Property = Property(name="address", type=StringType)
Admin.attributes={Admin_address, Admin_name}
...
Customer_Customercare: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="update_create26", type=Admin, multiplicity=Multiplicity(1, 9999)),
        Property(name="customer27", type=Product, multiplicity=Multiplicity(1, 9999))
    }
)
