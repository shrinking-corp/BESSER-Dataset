...
domain_model = DomainModel(
    name="bb4abd72_1114_49ee_bb68_fe1ada5f02bf",
    types={logout_external, student_Actor, faculty_Actor, _Component, parent_Actor, admin_Actor, FACULTY, STUDENT, PARENT, ADMIN, take_attendance_call_external, generate_class_wise_attendance_report_external, post_attendance_external, answer_attendance_call_external, view_subject_wise_attendance_external, view_cumiliative_attendance_external, login_external, send_attendance_sms_external, recieve_attendance_sms_external, modify_list_of_students_external},
    associations={student_login, student_logout, faculty_login, faculty_give_attendance, faculty_generate_class_wise_attendance_report, faculty_post_attendance, student_answer_attendance_call, student_view_subject_wise_attendance, student_view_cumiliative_attendance, faculty_logout, admin_login, admin_logout, parent_view_subject_wise_attendance, faculty_send_attendance_sms, parent_recieve_attendance_sms, faculty_view_cumiliative_attendance, parent_view_cumiliative_attendance, parent_login, parent_logout, admin_modify_list_of_students, FACULTY_STUDENT, FACULTY_ADMIN, STUDENT_ADMIN, PARENT_ADMIN},
    generalizations={},
    metadata=None
)
