...
DDL_CreateCommentColumn.attributes={DDL_CreateCommentColumn_columnComment, DDL_CreateCommentColumn_tableName, DDL_CreateCommentColumn_columnName}
...
DDL_CreateFk.attributes={DDL_CreateFk_columnName, DDL_CreateFk_columnReference, DDL_CreateFk_nameFk}
...
DDL_CreateCk.attributes={DDL_CreateCk_columnName, DDL_CreateCk_valuesCk, DDL_CreateCk_nameCk}
...
domain_model = DomainModel(
    name="DDL",
    types={DDL_CreateCommentTable, DDL_CreateCommentColumn, DDL_DDLDefinition, DDL_Statement, DDL_DataDefinition, Statement, DDL_CreatePk, DDL_CreateFk, DDL_CreateTable, DDL_CreateCk, DDL_CreateColumn, DDL_CreateDatabase, DataDefinition},
    associations={columnsFk5, checks8, statements10, references0, columns1, columnsPk3},
    generalizations={gen_DDL_CreateCommentTable_DataDefinition, gen_DDL_CreateCommentColumn_DataDefinition, gen_DDL_DataDefinition_Statement, gen_DDL_CreateDatabase_DataDefinition, gen_DDL_CreateTable_DataDefinition},
    metadata=None
)
