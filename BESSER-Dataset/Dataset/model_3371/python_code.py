...
class DDL_CreateTable(DataDefinition):
    ...
    def __init__(self, tableName: str, commentTable: str, DDL_CreateTable6: set["DDL_CreateFk"] = None, DDL_CreateTable9: set["DDL_CreateCk"] = None, DDL_CreateTable: "DDL_CreateFk" = None, DDL_CreateTable2: set["DDL_CreateColumn"] = None, DDL_CreateTable4: "DDL_CreatePk" = None):
        self.tableName = tableName
...
class DDL_CreateFk:
    ...
    def __init__(self, nameFk: str, columnName: str, columnReference: str, DDL_CreateFk7: "DDL_CreateTable" = None, DDL_CreateFk: "DDL_CreateTable" = None):
        self.nameFk = nameFk
        self.columnName = columnName
