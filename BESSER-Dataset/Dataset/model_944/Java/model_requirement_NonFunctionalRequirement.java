...
public class model_requirement_NonFunctionalRequirement extends Criterion {
    ...
    public model_requirement_NonFunctionalRequirement(
        ArrayList<requirement_UserTask> requirement_usertasks,        ArrayList<requirement_Scenario> requirement_scenarios,        ArrayList<requirement_SystemFunction> requirement_systemfunctions,        ArrayList<requirement_UseCase> requirement_usecases    ) {
