...
class project_CommitterShip:
    ...
    def __init__(self, start: date, end: date, committers: "project_Project" = None, committerships: "project_Person" = None, CommitterShip16: "project_Person" = None, CommitterShip: "project_Project" = None):
        self.start = start
        self.end = end
...
class project_Person:
    ...
    def __init__(self, lastname: str, firstname: str, email: str, image: str, project_Person11: "project_Project" = None, Person: "project_CommitterShip" = None, person: set["project_CommitterShip"] = None, project_Person: "project_Foundation" = None):
...
class project_Project:
    ...
    def __init__(self, start: date, end: date, longname: str, devmail: str, homepage: str, shortname: str, Project8: "project_Project" = None, subprojects: "project_Project" = None, project_Project10: set["project_Person"] = None, Project13: "project_CommitterShip" = None, project_Project: "project_Foundation" = None, Project: "project_Project" = None, parent: set["project_Project"] = None, project: set["project_CommitterShip"] = None):
        self.start = start
        self.end = end
