...
# Classes
project_Foundation = Class(name="project_Foundation")
project_Project = Class(name="project_Project")
project_Person = Class(name="project_Person")
project_CommitterShip = Class(name="project_CommitterShip")
...
project_Project.attributes={project_Project_homepage, project_Project_start, project_Project_shortname, project_Project_longname, project_Project_devmail, project_Project_end}
...
project_Person.attributes={project_Person_image, project_Person_firstname, project_Person_email, project_Person_lastname}
...
project_CommitterShip.attributes={project_CommitterShip_end, project_CommitterShip_start}
...
domain_model = DomainModel(
    name="project",
    types={project_Foundation, project_Project, project_Person, project_CommitterShip},
    associations={parent7, projectleads9, project12, person14, committerships15, projects0, persons1, subprojects4, committers5},
    generalizations={},
    metadata=None
)
