...
# Classes
file_File = Class(name="file_File", is_abstract=True)
file_FileLocal = Class(name="file_FileLocal")
ByteFile = Class(name="ByteFile")
file_FileRemote = Class(name="file_FileRemote")
file_FileInMemory = Class(name="file_FileInMemory")
File = Class(name="File")
file_FileReaderWriter = Class(name="file_FileReaderWriter", is_abstract=True)
FileHandler = Class(name="FileHandler")
file_FileHandler = Class(name="file_FileHandler", is_abstract=True)
FileOwner = Class(name="FileOwner")
file_FileOwner = Class(name="file_FileOwner", is_abstract=True)
file_Files = Class(name="file_Files")
file_ByteFile = Class(name="file_ByteFile", is_abstract=True)
file_FileOutput = Class(name="file_FileOutput", is_abstract=True)
...
file_FileReaderWriter_m_getReadFeedback: Method = Method(name="getReadFeedback", parameters={Parameter(name='file_file', type=StringType)}, type=StringType)
file_FileReaderWriter_m_getWriteFeedback: Method = Method(name="getWriteFeedback", parameters={Parameter(name='file_file', type=StringType)}, type=StringType)
...
file_FileReaderWriter_m_readFile: Method = Method(name="readFile", parameters={Parameter(name='file_file', type=StringType)})
file_FileReaderWriter_m_writeFile: Method = Method(name="writeFile", parameters={Parameter(name='file_file', type=StringType)})
file_FileReaderWriter.attributes={file_FileReaderWriter_Open, file_FileReaderWriter_WriteFeedback, file_FileReaderWriter_ReadFeedback, file_FileReaderWriter_CloseFeedback}
file_FileReaderWriter.methods={file_FileReaderWriter_m_getWriteFeedback, file_FileReaderWriter_m_getReadFeedback, file_FileReaderWriter_m_close, file_FileReaderWriter_m_readFile, file_FileReaderWriter_m_writeFile, file_FileReaderWriter_m_writeFile, file_FileReaderWriter_m_readFile}
...
domain_model = DomainModel(
    name="file",
    types={file_File, file_FileLocal, ByteFile, file_FileRemote, file_FileInMemory, File, file_FileReaderWriter, FileHandler, file_FileHandler, FileOwner, file_FileOwner, file_Files, file_ByteFile, file_FileOutput, FileEncoding},
    associations={SelectedFile0, HandledFile1, Files4, OutputFile6},
