...
class petrinet_Node(ABC):
    ...
    def __init__(self, name: str, Node11: "petrinet_Arc" = None, Node13: "petrinet_Arc" = None, Node: "petrinet_Petrinet" = None, nodes: "petrinet_Petrinet" = None, target: set["petrinet_Arc"] = None, source: set["petrinet_Arc"] = None):
        self.name = name
        self.Node11 = Node11
        self.Node13 = Node13
        self.Node = Node
...
class petrinet_Petrinet:
    ...
    def __init__(self, name: str, Petrinet15: "petrinet_Arc" = None, petrinet: set["petrinet_Node"] = None, petrinet2: set["petrinet_Arc"] = None, Petrinet: "petrinet_Node" = None):
        self.name = name
