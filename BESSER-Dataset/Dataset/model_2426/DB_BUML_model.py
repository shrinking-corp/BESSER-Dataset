...
DB_Column.attributes={DB_Column_notNull, DB_Column_type}
...
domain_model = DomainModel(
    name="DB",
    types={DB_NamedElement, DB_Database, DB_DatabaseElement, NamedElement, DB_Table, DatabaseElement, DB_Column, DB_ForeignKey, DataType},
