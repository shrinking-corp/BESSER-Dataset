...
class states_Statemachine:
    ...
    def __init__(self, initial: bool, value: int, name: str, states_Statemachine: "states_Module" = None, states_Statemachine2: set["states_Event"] = None, states_Statemachine4: set["states_State"] = None, states_Statemachine8: "states_CompoundState" = None):
        self.initial = initial
        self.value = value
        self.name = name
