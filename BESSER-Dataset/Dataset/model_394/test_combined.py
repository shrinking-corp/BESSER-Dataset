...
def test_assoc_inheritedMember1_link_reassign_clear():
    ...
    b1 = UML2_Classifier()
    b2 = UML2_Classifier()
    _safe_set(a, 'UML2_NamedElement2', b1)
    assert _is_linked(a, 'UML2_NamedElement2', b1)
    if hasattr(b1, 'UML2_Classifier'):
        assert _is_linked(b1, 'UML2_Classifier', a)
    _safe_set(a, 'UML2_NamedElement2', b2)
    assert _is_linked(a, 'UML2_NamedElement2', b2)
    if hasattr(b1, 'UML2_Classifier'):
        assert not _is_linked(b1, 'UML2_Classifier', a)
    if hasattr(b2, 'UML2_Classifier'):
        assert _is_linked(b2, 'UML2_Classifier', a)
    _safe_set(a, 'UML2_NamedElement2', None)
    assert not _is_linked(a, 'UML2_NamedElement2', b2)
    if hasattr(b2, 'UML2_Classifier'):
