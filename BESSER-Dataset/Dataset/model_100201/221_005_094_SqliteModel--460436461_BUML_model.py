...
CompoundOperator: Enumeration = Enumeration(
    ...
    literals={
			...
			EnumerationLiteral(name="except_")
    }
)
...
# Classes
sqliteModel_ConfigBlock = Class(name="sqliteModel_ConfigBlock")
sqliteModel_InitBlock = Class(name="sqliteModel_InitBlock")
sqliteModel_MigrationBlock = Class(name="sqliteModel_MigrationBlock")
sqliteModel_Model = Class(name="sqliteModel_Model")
sqliteModel_DatabaseBlock = Class(name="sqliteModel_DatabaseBlock")
sqliteModel_DDLStatement = Class(name="sqliteModel_DDLStatement")
sqliteModel_ConfigurationStatement = Class(name="sqliteModel_ConfigurationStatement")
sqliteModel_FunctionArg = Class(name="sqliteModel_FunctionArg")
sqliteModel_ContentUri = Class(name="sqliteModel_ContentUri")
sqliteModel_ContentUriSegment = Class(name="sqliteModel_ContentUriSegment")
sqliteModel_SelectStatement = Class(name="sqliteModel_SelectStatement")
DMLStatement = Class(name="DMLStatement")
sqliteModel_Expression = Class(name="sqliteModel_Expression")
sqliteModel_Case = Class(name="sqliteModel_Case")
sqliteModel_OrderingTerm = Class(name="sqliteModel_OrderingTerm")
sqliteModel_SelectList = Class(name="sqliteModel_SelectList")
sqliteModel_SelectCoreExpression = Class(name="sqliteModel_SelectCoreExpression")
sqliteModel_OrderingTermList = Class(name="sqliteModel_OrderingTermList")
sqliteModel_ColumnSource = Class(name="sqliteModel_ColumnSource")
sqliteModel_WhereExpressions = Class(name="sqliteModel_WhereExpressions")
sqliteModel_GroupByExpressions = Class(name="sqliteModel_GroupByExpressions")
sqliteModel_HavingExpressions = Class(name="sqliteModel_HavingExpressions")
sqliteModel_JoinSource = Class(name="sqliteModel_JoinSource")
sqliteModel_SingleSource = Class(name="sqliteModel_SingleSource")
sqliteModel_JoinStatement = Class(name="sqliteModel_JoinStatement")
sqliteModel_SelectSource = Class(name="sqliteModel_SelectSource")
SingleSource = Class(name="SingleSource")
sqliteModel_SingleSourceJoin = Class(name="sqliteModel_SingleSourceJoin")
sqliteModel_TableDefinition = Class(name="sqliteModel_TableDefinition")
DDLStatement = Class(name="DDLStatement")
sqliteModel_LiteralValue = Class(name="sqliteModel_LiteralValue")
sqliteModel_DMLStatement = Class(name="sqliteModel_DMLStatement")
sqliteModel_AlterTableAddColumnStatement = Class(name="sqliteModel_AlterTableAddColumnStatement")
sqliteModel_CreateTriggerStatement = Class(name="sqliteModel_CreateTriggerStatement")
sqliteModel_DropViewStatement = Class(name="sqliteModel_DropViewStatement")
sqliteModel_CreateViewStatement = Class(name="sqliteModel_CreateViewStatement")
sqliteModel_DropTableStatement = Class(name="sqliteModel_DropTableStatement")
sqliteModel_DropTriggerStatement = Class(name="sqliteModel_DropTriggerStatement")
sqliteModel_ColumnConstraint = Class(name="sqliteModel_ColumnConstraint")
sqliteModel_TableConstraint = Class(name="sqliteModel_TableConstraint")
sqliteModel_UniqueTableConstraint = Class(name="sqliteModel_UniqueTableConstraint")
TableConstraint = Class(name="TableConstraint")
sqliteModel_CreateIndexStatement = Class(name="sqliteModel_CreateIndexStatement")
sqliteModel_IndexedColumn = Class(name="sqliteModel_IndexedColumn")
sqliteModel_DropIndexStatement = Class(name="sqliteModel_DropIndexStatement")
sqliteModel_ColumnDef = Class(name="sqliteModel_ColumnDef")
sqliteModel_ConflictClause = Class(name="sqliteModel_ConflictClause")
sqliteModel_PrimaryConstraint = Class(name="sqliteModel_PrimaryConstraint")
sqliteModel_CheckTableConstraint = Class(name="sqliteModel_CheckTableConstraint")
sqliteModel_DeleteStatement = Class(name="sqliteModel_DeleteStatement")
sqliteModel_DefaultValue = Class(name="sqliteModel_DefaultValue")
sqliteModel_InsertStatement = Class(name="sqliteModel_InsertStatement")
sqliteModel_ActionStatement = Class(name="sqliteModel_ActionStatement")
ConfigurationStatement = Class(name="ConfigurationStatement")
sqliteModel_UpdateStatement = Class(name="sqliteModel_UpdateStatement")
sqliteModel_UpdateColumnExpression = Class(name="sqliteModel_UpdateColumnExpression")
sqliteModel_ExprConcat = Class(name="sqliteModel_ExprConcat")
sqliteModel_Function = Class(name="sqliteModel_Function")
Expression = Class(name="Expression")
sqliteModel_ContentUriParamSegment = Class(name="sqliteModel_ContentUriParamSegment")
ContentUriSegment = Class(name="ContentUriSegment")
sqliteModel_ExprMult = Class(name="sqliteModel_ExprMult")
sqliteModel_ExprAdd = Class(name="sqliteModel_ExprAdd")
sqliteModel_ExprRelate = Class(name="sqliteModel_ExprRelate")
sqliteModel_ExprBit = Class(name="sqliteModel_ExprBit")
sqliteModel_ExprEqual = Class(name="sqliteModel_ExprEqual")
sqliteModel_ExprAnd = Class(name="sqliteModel_ExprAnd")
sqliteModel_ExprOr = Class(name="sqliteModel_ExprOr")
sqliteModel_NullCheckExpression = Class(name="sqliteModel_NullCheckExpression")
sqliteModel_IsNull = Class(name="sqliteModel_IsNull")
sqliteModel_NotNull = Class(name="sqliteModel_NotNull")
sqliteModel_NewColumn = Class(name="sqliteModel_NewColumn")
sqliteModel_OldColumn = Class(name="sqliteModel_OldColumn")
sqliteModel_ColumnSourceRef = Class(name="sqliteModel_ColumnSourceRef")
sqliteModel_CaseExpression = Class(name="sqliteModel_CaseExpression")
sqliteModel_Literal = Class(name="sqliteModel_Literal")
sqliteModel_NestedExpression = Class(name="sqliteModel_NestedExpression")
sqliteModel_SelectStatementExpression = Class(name="sqliteModel_SelectStatementExpression")
sqliteModel_SelectCore = Class(name="sqliteModel_SelectCore")
SelectCoreExpression = Class(name="SelectCoreExpression")
sqliteModel_SelectExpression = Class(name="sqliteModel_SelectExpression")
sqliteModel_CastExpression = Class(name="sqliteModel_CastExpression")
sqliteModel_FunctionArgument = Class(name="sqliteModel_FunctionArgument")
sqliteModel_SingleSourceTable = Class(name="sqliteModel_SingleSourceTable")
SelectSource = Class(name="SelectSource")
sqliteModel_SingleSourceSelectStatement = Class(name="sqliteModel_SingleSourceSelectStatement")
ColumnSource = Class(name="ColumnSource")
sqliteModel_NumericLiteral = Class(name="sqliteModel_NumericLiteral")
LiteralValue = Class(name="LiteralValue")
sqliteModel_StringLiteral = Class(name="sqliteModel_StringLiteral")
sqliteModel_NullLiteral = Class(name="sqliteModel_NullLiteral")
sqliteModel_CurrentTimeLiteral = Class(name="sqliteModel_CurrentTimeLiteral")
sqliteModel_ResultColumn = Class(name="sqliteModel_ResultColumn")
sqliteModel_CurrentTimeStampLiteral = Class(name="sqliteModel_CurrentTimeStampLiteral")
sqliteModel_CreateTableStatement = Class(name="sqliteModel_CreateTableStatement")
TableDefinition = Class(name="TableDefinition")
sqliteModel_CurrentDateLiteral = Class(name="sqliteModel_CurrentDateLiteral")
sqliteModel_PrimaryKeyColumnConstraint = Class(name="sqliteModel_PrimaryKeyColumnConstraint")
ColumnConstraint = Class(name="ColumnConstraint")
sqliteModel_NotNullConstraint = Class(name="sqliteModel_NotNullConstraint")
sqliteModel_AlterTableRenameStatement = Class(name="sqliteModel_AlterTableRenameStatement")
sqliteModel_UniqueConstraint = Class(name="sqliteModel_UniqueConstraint")
sqliteModel_DefaultConstraint = Class(name="sqliteModel_DefaultConstraint")
sqliteModel_CheckConstraint = Class(name="sqliteModel_CheckConstraint")
sqliteModel_LiteralDefaultValue = Class(name="sqliteModel_LiteralDefaultValue")
DefaultValue = Class(name="DefaultValue")
sqliteModel_ExpressionDefaultValue = Class(name="sqliteModel_ExpressionDefaultValue")
...
sqliteModel_JoinStatement.attributes={sqliteModel_JoinStatement_left, sqliteModel_JoinStatement_cross, sqliteModel_JoinStatement_natural, sqliteModel_JoinStatement_outer, sqliteModel_JoinStatement_inner}
...
sqliteModel_CreateTriggerStatement.attributes={sqliteModel_CreateTriggerStatement_forEachRow, sqliteModel_CreateTriggerStatement_updateColumnNames, sqliteModel_CreateTriggerStatement_name, sqliteModel_CreateTriggerStatement_eventType, sqliteModel_CreateTriggerStatement_when, sqliteModel_CreateTriggerStatement_temporary}
...
sqliteModel_IndexedColumn.attributes={sqliteModel_IndexedColumn_collationName, sqliteModel_IndexedColumn_desc, sqliteModel_IndexedColumn_asc}
...
sqliteModel_SelectStatementExpression_not_: Property = Property(name="not_", type=BooleanType)
sqliteModel_SelectStatementExpression_exists: Property = Property(name="exists", type=BooleanType)
sqliteModel_SelectStatementExpression.attributes={sqliteModel_SelectStatementExpression_not_, sqliteModel_SelectStatementExpression_exists}
...
sqliteModel_SelectExpression.attributes={sqliteModel_SelectExpression_allColumns, sqliteModel_SelectExpression_all, sqliteModel_SelectExpression_distinct}
...
sqliteModel_PrimaryKeyColumnConstraint.attributes={sqliteModel_PrimaryKeyColumnConstraint_autoincrement, sqliteModel_PrimaryKeyColumnConstraint_desc, sqliteModel_PrimaryKeyColumnConstraint_asc}
...
domain_model = DomainModel(
    name="sqliteModel",
    types={sqliteModel_ConfigBlock, sqliteModel_InitBlock, sqliteModel_MigrationBlock, sqliteModel_Model, sqliteModel_DatabaseBlock, sqliteModel_DDLStatement, sqliteModel_ConfigurationStatement, sqliteModel_FunctionArg, sqliteModel_ContentUri, sqliteModel_ContentUriSegment, sqliteModel_SelectStatement, DMLStatement, sqliteModel_Expression, sqliteModel_Case, sqliteModel_OrderingTerm, sqliteModel_SelectList, sqliteModel_SelectCoreExpression, sqliteModel_OrderingTermList, sqliteModel_ColumnSource, sqliteModel_WhereExpressions, sqliteModel_GroupByExpressions, sqliteModel_HavingExpressions, sqliteModel_JoinSource, sqliteModel_SingleSource, sqliteModel_JoinStatement, sqliteModel_SelectSource, SingleSource, sqliteModel_SingleSourceJoin, sqliteModel_TableDefinition, DDLStatement, sqliteModel_LiteralValue, sqliteModel_DMLStatement, sqliteModel_AlterTableAddColumnStatement, sqliteModel_CreateTriggerStatement, sqliteModel_DropViewStatement, sqliteModel_CreateViewStatement, sqliteModel_DropTableStatement, sqliteModel_DropTriggerStatement, sqliteModel_ColumnConstraint, sqliteModel_TableConstraint, sqliteModel_UniqueTableConstraint, TableConstraint, sqliteModel_CreateIndexStatement, sqliteModel_IndexedColumn, sqliteModel_DropIndexStatement, sqliteModel_ColumnDef, sqliteModel_ConflictClause, sqliteModel_PrimaryConstraint, sqliteModel_CheckTableConstraint, sqliteModel_DeleteStatement, sqliteModel_DefaultValue, sqliteModel_InsertStatement, sqliteModel_ActionStatement, ConfigurationStatement, sqliteModel_UpdateStatement, sqliteModel_UpdateColumnExpression, sqliteModel_ExprConcat, sqliteModel_Function, Expression, sqliteModel_ContentUriParamSegment, ContentUriSegment, sqliteModel_ExprMult, sqliteModel_ExprAdd, sqliteModel_ExprRelate, sqliteModel_ExprBit, sqliteModel_ExprEqual, sqliteModel_ExprAnd, sqliteModel_ExprOr, sqliteModel_NullCheckExpression, sqliteModel_IsNull, sqliteModel_NotNull, sqliteModel_NewColumn, sqliteModel_OldColumn, sqliteModel_ColumnSourceRef, sqliteModel_CaseExpression, sqliteModel_Literal, sqliteModel_NestedExpression, sqliteModel_SelectStatementExpression, sqliteModel_SelectCore, SelectCoreExpression, sqliteModel_SelectExpression, sqliteModel_CastExpression, sqliteModel_FunctionArgument, sqliteModel_SingleSourceTable, SelectSource, sqliteModel_SingleSourceSelectStatement, ColumnSource, sqliteModel_NumericLiteral, LiteralValue, sqliteModel_StringLiteral, sqliteModel_NullLiteral, sqliteModel_CurrentTimeLiteral, sqliteModel_ResultColumn, sqliteModel_CurrentTimeStampLiteral, sqliteModel_CreateTableStatement, TableDefinition, sqliteModel_CurrentDateLiteral, sqliteModel_PrimaryKeyColumnConstraint, ColumnConstraint, sqliteModel_NotNullConstraint, sqliteModel_AlterTableRenameStatement, sqliteModel_UniqueConstraint, sqliteModel_DefaultConstraint, sqliteModel_CheckConstraint, sqliteModel_LiteralDefaultValue, DefaultValue, sqliteModel_ExpressionDefaultValue, CompoundOperator, SqliteDataType, ColumnType, ConflictResolution},
    associations={database0, config1, init3, migrations5, statements9, statements7, segments11, statements12, thenExpression16, whenExpression15, orderingTerms28, core19, orderby20, limit22, limitOffset25, resultColumns30, expression31, groupByExpressions33, expression35, expression37, source40, joinStatements41, joinSource43, singleSource45, expression48, statements55, table51, whenExpression52, table57, columnDef59, table62, trigger64, view66, table67, columns69, index71, expression82, columnReference84, columns73, conflictClause75, columns77, conflictClause79, expressions96, selectStatement99, table86, expression88, table91, columnNames93, expression112, table102, updateColumnExpressions104, whereExpression106, columnName109, left124, uri115, args117, statements118, arguments121, left134, right126, left129, right131, left144, right136, left139, right141, left154, right146, left149, right151, left164, right166, right156, left159, right161, source173, column174, column169, column171, caseExpression182, literalValue177, expression178, select180, arg192, left194, cases184, elseExpression187, right196, expression190, source201, where204, groupBy207, having210, tableReference213, selectList199, expression217, selectStatement215, columnDefs219, constraints221, table226, constraints228, selectStatement223, conflictClause232, defaultValue234, conflictClause230, expression235, literal237, expression239},
    generalizations={gen_sqliteModel_SelectStatement_DMLStatement, gen_sqliteModel_SelectSource_SingleSource, gen_sqliteModel_SingleSourceJoin_SingleSource, gen_sqliteModel_TableDefinition_DDLStatement, gen_sqliteModel_AlterTableAddColumnStatement_DDLStatement, gen_sqliteModel_CreateTriggerStatement_DDLStatement, gen_sqliteModel_DropViewStatement_DDLStatement, gen_sqliteModel_DropTableStatement_DDLStatement, gen_sqliteModel_DropTriggerStatement_DDLStatement, gen_sqliteModel_UniqueTableConstraint_TableConstraint, gen_sqliteModel_CreateIndexStatement_DDLStatement, gen_sqliteModel_DropIndexStatement_DDLStatement, gen_sqliteModel_PrimaryConstraint_TableConstraint, gen_sqliteModel_CheckTableConstraint_TableConstraint, gen_sqliteModel_DeleteStatement_DMLStatement, gen_sqliteModel_InsertStatement_DMLStatement, gen_sqliteModel_ActionStatement_ConfigurationStatement, gen_sqliteModel_UpdateStatement_DMLStatement, gen_sqliteModel_ExprConcat_Expression, gen_sqliteModel_Function_ConfigurationStatement, gen_sqliteModel_Function_Expression, gen_sqliteModel_ContentUriParamSegment_ContentUriSegment, gen_sqliteModel_ExprAdd_Expression, gen_sqliteModel_ExprMult_Expression, gen_sqliteModel_ExprRelate_Expression, gen_sqliteModel_ExprBit_Expression, gen_sqliteModel_ExprEqual_Expression, gen_sqliteModel_ExprAnd_Expression, gen_sqliteModel_ExprOr_Expression, gen_sqliteModel_NullCheckExpression_Expression, gen_sqliteModel_IsNull_Expression, gen_sqliteModel_NotNull_Expression, gen_sqliteModel_NewColumn_Expression, gen_sqliteModel_OldColumn_Expression, gen_sqliteModel_ColumnSourceRef_Expression, gen_sqliteModel_CaseExpression_Expression, gen_sqliteModel_Literal_Expression, gen_sqliteModel_NestedExpression_Expression, gen_sqliteModel_SelectStatementExpression_Expression, gen_sqliteModel_SelectCore_SelectCoreExpression, gen_sqliteModel_SelectExpression_SelectCoreExpression, gen_sqliteModel_CastExpression_Expression, gen_sqliteModel_FunctionArgument_Expression, gen_sqliteModel_SingleSourceTable_SelectSource, gen_sqliteModel_SingleSourceSelectStatement_SelectSource, gen_sqliteModel_ResultColumn_ColumnSource, gen_sqliteModel_NumericLiteral_LiteralValue, gen_sqliteModel_StringLiteral_LiteralValue, gen_sqliteModel_NullLiteral_LiteralValue, gen_sqliteModel_CurrentTimeLiteral_LiteralValue, gen_sqliteModel_CurrentTimeStampLiteral_LiteralValue, gen_sqliteModel_CreateTableStatement_TableDefinition, gen_sqliteModel_CreateViewStatement_TableDefinition, gen_sqliteModel_CurrentDateLiteral_LiteralValue, gen_sqliteModel_ColumnDef_ColumnSource, gen_sqliteModel_PrimaryKeyColumnConstraint_ColumnConstraint, gen_sqliteModel_NotNullConstraint_ColumnConstraint, gen_sqliteModel_AlterTableRenameStatement_TableDefinition, gen_sqliteModel_UniqueConstraint_ColumnConstraint, gen_sqliteModel_DefaultConstraint_ColumnConstraint, gen_sqliteModel_CheckConstraint_ColumnConstraint, gen_sqliteModel_LiteralDefaultValue_DefaultValue, gen_sqliteModel_ExpressionDefaultValue_DefaultValue},
    metadata=None
)
