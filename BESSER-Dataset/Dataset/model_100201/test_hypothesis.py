...
def test_sqlitemodel_checkconstraint_is_not_abstract():
    assert not inspect.isabstract(sqliteModel_CheckConstraint)


def test_sqlitemodel_checkconstraint_constructor_exists():
    assert callable(sqliteModel_CheckConstraint.__init__)


def test_sqlitemodel_checkconstraint_constructor_args():
