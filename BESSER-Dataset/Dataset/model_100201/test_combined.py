...
def test_hyp_sqlitemodel_checkconstraint_is_not_abstract():
    assert not inspect.isabstract(sqliteModel_CheckConstraint)


def test_hyp_sqlitemodel_checkconstraint_constructor_exists():
    assert callable(sqliteModel_CheckConstraint.__init__)


def test_hyp_sqlitemodel_checkconstraint_constructor_args():
    sig = inspect.signature(sqliteModel_CheckConstraint.__init__)
    params = list(sig.parameters.keys())
...
sqliteModel_CheckConstraint_strategy = st.builds(
    sqliteModel_CheckConstraint,
)
