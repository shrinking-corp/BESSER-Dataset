...
class model_ETypes:
    ...
    def __init__(self, eByteArray: str, eChar: str, eDate: date, eFloat: float, eLong: str, eShort: str, uris: str, eString: str, eStrings: str, eBoolean: bool, eBooleans: str, eInt: int, eInts: int, doubleValue: str, eDouble: float, eDoubles: str, eByte: str):
