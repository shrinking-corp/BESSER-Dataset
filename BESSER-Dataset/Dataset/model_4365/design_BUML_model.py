...
# Classes
design_Aggregation = Class(name="design_Aggregation")
design_Realization = Class(name="design_Realization")
design_Class = Class(name="design_Class")
Classifier = Class(name="Classifier")
design_Attribute = Class(name="design_Attribute")
design_Operation = Class(name="design_Operation")
design_Design = Class(name="design_Design")
design_Classifier = Class(name="design_Classifier", is_abstract=True)
design_Relation = Class(name="design_Relation", is_abstract=True)
design_Association = Class(name="design_Association")
Relation = Class(name="Relation")
design_Generalization = Class(name="design_Generalization")
design_Dependency = Class(name="design_Dependency")
design_Composition = Class(name="design_Composition")
design_Interface = Class(name="design_Interface")
...
design_Operation.attributes={design_Operation_name, design_Operation_returnType}
...
domain_model = DomainModel(
    name="design",
    types={design_Aggregation, design_Realization, design_Class, Classifier, design_Attribute, design_Operation, design_Design, design_Classifier, design_Relation, design_Association, Relation, design_Generalization, design_Dependency, design_Composition, design_Interface, Languages, Types, AccessModifiers},
    associations={target6, elements0, relations1, source3, attributes9, operations11},
    generalizations={gen_design_Aggregation_Relation, gen_design_Realization_Relation, gen_design_Class_Classifier, gen_design_Association_Relation, gen_design_Generalization_Relation, gen_design_Dependency_Relation, gen_design_Composition_Relation, gen_design_Interface_Classifier},
    metadata=None
)
