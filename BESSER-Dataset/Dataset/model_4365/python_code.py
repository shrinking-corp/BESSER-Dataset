...
class design_Classifier(ABC):
    ...
    def __init__(self, accessModifier: str, name: str, design_Classifier8: "design_Relation" = None, design_Classifier: "design_Design" = None, design_Classifier5: "design_Relation" = None, design_Classifier10: set["design_Attribute"] = None, design_Classifier12: set["design_Operation"] = None):
