...
diagram_DDiagram.attributes={diagram_DDiagram_headerHeight, diagram_DDiagram_synchronized, diagram_DDiagram_isInLayoutingMode}
...
diagram_DEdge.attributes={diagram_DEdge_isMockEdge, diagram_DEdge_beginLabel, diagram_DEdge_arrangeConstraints, diagram_DEdge_size, diagram_DEdge_endLabel, diagram_DEdge_isFold, diagram_DEdge_routingStyle}
...
diagram_DNode.attributes={diagram_DNode_width, diagram_DNode_labelPosition, diagram_DNode_resizeKind, diagram_DNode_height}
...
diagram_AbsoluteBoundsFilter.attributes={diagram_AbsoluteBoundsFilter_y, diagram_AbsoluteBoundsFilter_x, diagram_AbsoluteBoundsFilter_height, diagram_AbsoluteBoundsFilter_width}
...
diagram_NodeStyle.attributes={diagram_NodeStyle_labelPosition, diagram_NodeStyle_labelDirection}
...
diagram_EdgeStyle.attributes={diagram_EdgeStyle_centered, diagram_EdgeStyle_lineStyle, diagram_EdgeStyle_foldingStyle, diagram_EdgeStyle_routingStyle, diagram_EdgeStyle_sourceArrow, diagram_EdgeStyle_strokeColor, diagram_EdgeStyle_targetArrow, diagram_EdgeStyle_size}
...
diagram_FlatContainerStyle.attributes={diagram_FlatContainerStyle_foregroundColor, diagram_FlatContainerStyle_backgroundColor, diagram_FlatContainerStyle_backgroundStyle}
...
diagram_GaugeSection.attributes={diagram_GaugeSection_value, diagram_GaugeSection_min, diagram_GaugeSection_foregroundColor, diagram_GaugeSection_max, diagram_GaugeSection_backgroundColor, diagram_GaugeSection_label}
...
diagram_BundledImage.attributes={diagram_BundledImage_color, diagram_BundledImage_providedShapeID, diagram_BundledImage_shape}
...
diagram_description_DiagramElementMapping_m_checkPrecondition: Method = Method(name="checkPrecondition", parameters={Parameter(name='diagram_container', type=StringType), Parameter(name='diagram_modelElement', type=StringType), Parameter(name='diagram_containerView', type=StringType)}, type=BooleanType)
...
diagram_description_AbstractNodeMapping.methods={diagram_description_AbstractNodeMapping_m_clearDNodesDone, diagram_description_AbstractNodeMapping_m_getAllBorderedNodeMappings, diagram_description_AbstractNodeMapping_m_findDNodeFromEObject, diagram_description_AbstractNodeMapping_m_addDoneNode}
...
diagram_description_NodeMapping_m_createNode: Method = Method(name="createNode", parameters={Parameter(name='diagram_viewPoint', type=StringType), Parameter(name='diagram_modelElement', type=StringType), Parameter(name='diagram_container', type=StringType)}, type=StringType)
...
diagram_description_NodeMapping.methods={diagram_description_NodeMapping_m_createNode, diagram_description_NodeMapping_m_updateListElement, diagram_description_NodeMapping_m_getNodesCandidates, diagram_description_NodeMapping_m_getNodesCandidates, diagram_description_NodeMapping_m_updateNode}
...
diagram_description_ContainerMapping_m_getBestStyle: Method = Method(name="getBestStyle", parameters={Parameter(name='diagram_modelElement', type=StringType), Parameter(name='diagram_viewVariable', type=StringType), Parameter(name='diagram_containerVariable', type=StringType)}, type=ContainerStyle)
...
diagram_description_EdgeMapping_m_createEdge: Method = Method(name="createEdge", parameters={Parameter(name='diagram_target', type=StringType), Parameter(name='diagram_source', type=StringType), Parameter(name='diagram_semanticTarget', type=StringType)}, type=StringType)
diagram_description_EdgeMapping_m_createEdge: Method = Method(name="createEdge", parameters={Parameter(name='diagram_target', type=StringType), Parameter(name='diagram_semanticTarget', type=StringType), Parameter(name='diagram_container', type=StringType), Parameter(name='diagram_source', type=StringType)}, type=StringType)
...
diagram_description_EdgeMapping_m_getEdgeTargetCandidates: Method = Method(name="getEdgeTargetCandidates", parameters={Parameter(name='diagram_containerView', type=StringType), Parameter(name='diagram_container', type=StringType), Parameter(name='diagram_semanticOrigin', type=StringType)}, type=StringType)
diagram_description_EdgeMapping.attributes={diagram_description_EdgeMapping_sourceFinderExpression, diagram_description_EdgeMapping_useDomainElement, diagram_description_EdgeMapping_targetFinderExpression, diagram_description_EdgeMapping_targetExpression, diagram_description_EdgeMapping_pathExpression, diagram_description_EdgeMapping_domainClass}
diagram_description_EdgeMapping.methods={diagram_description_EdgeMapping_m_getEdgeSourceCandidates, diagram_description_EdgeMapping_m_getEdgeTargetCandidates, diagram_description_EdgeMapping_m_getBestStyle, diagram_description_EdgeMapping_m_getEdgeTargetCandidates, diagram_description_EdgeMapping_m_updateEdge, diagram_description_EdgeMapping_m_createEdge, diagram_description_EdgeMapping_m_createEdge}
...
diagram_description_IEdgeMapping_m_getBestStyle: Method = Method(name="getBestStyle", parameters={Parameter(name='diagram_viewVariable', type=StringType), Parameter(name='diagram_modelElement', type=StringType), Parameter(name='diagram_containerVariable', type=StringType)}, type=EdgeStyle)
...
diagram_style_NodeStyleDescription.attributes={diagram_style_NodeStyleDescription_forbiddenSides, diagram_style_NodeStyleDescription_labelDirection, diagram_style_NodeStyleDescription_sizeComputationExpression, diagram_style_NodeStyleDescription_resizeKind, diagram_style_NodeStyleDescription_labelPosition}
...
diagram_style_BundledImageDescription.attributes={diagram_style_BundledImageDescription_shape, diagram_style_BundledImageDescription_providedShapeID}
...
diagram_style_GaugeSectionDescription.attributes={diagram_style_GaugeSectionDescription_maxValueExpression, diagram_style_GaugeSectionDescription_valueExpression, diagram_style_GaugeSectionDescription_label, diagram_style_GaugeSectionDescription_minValueExpression}
...
diagram_style_EdgeStyleDescription.attributes={diagram_style_EdgeStyleDescription_sourceArrow, diagram_style_EdgeStyleDescription_endsCentering, diagram_style_EdgeStyleDescription_sizeComputationExpression, diagram_style_EdgeStyleDescription_routingStyle, diagram_style_EdgeStyleDescription_foldingStyle, diagram_style_EdgeStyleDescription_targetArrow, diagram_style_EdgeStyleDescription_lineStyle}
...
diagram_tool_EdgeCreationDescription_m_getBestMapping: Method = Method(name="getBestMapping", parameters={Parameter(name='diagram_createdElements', type=StringType), Parameter(name='diagram_source', type=StringType), Parameter(name='diagram_target', type=StringType)}, type=StringType)
...
domain_model = DomainModel(
    name="diagram",
    types={diagram_DDiagram, DRepresentation, description_DocumentedElement, DragAndDropTarget, diagram_DDiagramElement, DiagramDescription, diagram_DEdge, diagram_DNode, diagram_DNodeListElement, diagram_DDiagramElementContainer, concern_ConcernDescription, validation_ValidationRule, tool_BehaviorTool, diagram_FilterVariableHistory, Layer, diagram_DSemanticDiagram, DDiagram, DSemanticDecorator, DRepresentationElement, diagram_Decoration, DiagramElementMapping, filter_FilterDescription, diagram_HideFilter, GraphicalFilter, diagram_HideLabelFilter, diagram_FoldingPointFilter, diagram_FoldingFilter, diagram_AppliedCompositeFilters, filter_CompositeFilterDescription, diagram_AbsoluteBoundsFilter, diagram_AbstractDNode, DDiagramElement, AbstractDNode, EdgeTarget, diagram_NodeStyle, diagram_Style, NodeMapping, diagram_GraphicalFilter, diagram_ContainerStyle, ContainerMapping, diagram_DNodeContainer, DDiagramElementContainer, diagram_EdgeStyle, diagram_EdgeTarget, IEdgeMapping, diagram_DNodeList, LabelStyle, Style, BorderedStyle, HideLabelCapabilityStyle, diagram_Dot, NodeStyle, diagram_FlatContainerStyle, ContainerStyle, diagram_ShapeContainerStyle, diagram_GaugeSection, Customizable, diagram_Ellipse, diagram_Lozenge, diagram_BundledImage, diagram_WorkspaceImage, diagram_CustomStyle, diagram_Square, diagram_BeginLabelStyle, diagram_CenterLabelStyle, diagram_EndLabelStyle, diagram_BorderedStyle, diagram_Note, diagram_VariableValue, diagram_CollapseFilter, diagram_IndirectlyCollapseFilter, CollapseFilter, BasicLabelStyle, diagram_GaugeCompositeStyle, diagram_BracketEdgeStyle, EdgeStyle, diagram_ComputedStyleDescriptionRegistry, style_StyleDescription, diagram_DragAndDropTarget, diagram_HideLabelCapabilityStyle, diagram_TypedVariableValue, VariableValue, TypedVariable, diagram_EObjectVariableValue, tool_SelectModelElementVariable, diagram_EObject, diagram_description_DiagramDescription, description_DragAndDropTargetDescription, description_RepresentationDescription, description_PasteTargetDescription, EdgeMapping, validation_ValidationSet, concern_ConcernSet, tool_AbstractToolDescription, tool_RepresentationCreationDescription, Layout, tool_InitialOperation, AdditionalLayer, EdgeMappingImport, tool_ToolSection, diagram_description_DiagramImportDescription, description_RepresentationImportDescription, description_DiagramDescription, diagram_description_DiagramExtensionDescription, RepresentationExtensionDescription, diagram_description_DiagramElementMapping, description_RepresentationElementMapping, tool_DeleteElementDescription, tool_DirectEditLabel, tool_DoubleClickDescription, diagram_description_AbstractNodeMapping, description_DiagramElementMapping, diagram_description_NodeMapping, description_AbstractNodeMapping, diagram_description_ContainerMapping, style_ContainerStyleDescription, ConditionalContainerStyleDescription, diagram_description_NodeMappingImport, description_NodeMapping, description_AbstractMappingImport, style_NodeStyleDescription, diagram_description_EdgeMapping, description_IEdgeMapping, ConditionalNodeStyleDescription, diagram_description_ContainerMappingImport, description_ContainerMapping, ConditionalEdgeStyleDescription, tool_ReconnectEdgeDescription, AbstractNodeMapping, diagram_description_IEdgeMapping, diagram_description_EdgeMappingImport, description_IdentifiedElement, diagram_description_ConditionalNodeStyleDescription, ConditionalStyleDescription, diagram_description_ConditionalEdgeStyleDescription, style_EdgeStyleDescription, diagram_description_Layout, DocumentedElement, diagram_description_OrderedTreeLayout, diagram_description_CompositeLayout, diagram_description_MappingBasedDecoration, DecorationDescription, diagram_description_Layer, description_EndUserDocumentedElement, diagram_description_ConditionalContainerStyleDescription, DecorationDescriptionsSet, Customization, diagram_description_AdditionalLayer, diagram_description_DragAndDropTargetDescription, tool_ContainerDropDescription, diagram_style_BorderedStyleDescription, StyleDescription, ColorDescription, diagram_style_NodeStyleDescription, style_BorderedStyleDescription, style_LabelStyleDescription, style_TooltipStyleDescription, style_HideLabelCapabilityStyleDescription, diagram_style_CustomStyleDescription, NodeStyleDescription, diagram_style_SquareDescription, diagram_style_LozengeNodeDescription, diagram_style_EllipseNodeDescription, diagram_style_BundledImageDescription, diagram_style_NoteDescription, diagram_style_DotDescription, diagram_style_GaugeCompositeStyleDescription, style_GaugeSectionDescription, diagram_style_GaugeSectionDescription, diagram_style_RoundedCornerStyleDescription, diagram_style_ContainerStyleDescription, style_RoundedCornerStyleDescription, diagram_style_FlatContainerStyleDescription, style_SizeComputationContainerStyleDescription, style_LabelBorderStyleDescription, diagram_style_SizeComputationContainerStyleDescription, diagram_style_WorkspaceImageDescription, diagram_style_EdgeStyleDescription, style_CenterLabelStyleDescription, style_EndLabelStyleDescription, diagram_style_ShapeContainerStyleDescription, diagram_style_BeginLabelStyleDescription, BasicLabelStyleDescription, diagram_style_CenterLabelStyleDescription, diagram_style_EndLabelStyleDescription, diagram_style_BracketEdgeStyleDescription, EdgeStyleDescription, diagram_style_HideLabelCapabilityStyleDescription, diagram_tool_ToolSection, tool_ToolEntry, style_BeginLabelStyleDescription, tool_ToolGroupExtension, diagram_tool_ToolGroup, ToolEntry, diagram_tool_ToolGroupExtension, tool_ToolGroup, diagram_tool_NodeCreationDescription, MappingBasedToolDescription, tool_NodeCreationVariable, tool_ContainerViewVariable, tool_InitialNodeCreationOperation, diagram_tool_EdgeCreationDescription, tool_PopupMenu, tool_SourceEdgeCreationVariable, tool_TargetEdgeCreationVariable, tool_SourceEdgeViewCreationVariable, tool_TargetEdgeViewCreationVariable, tool_InitEdgeCreationOperation, diagram_tool_ContainerCreationDescription, diagram_tool_DeleteElementDescription, tool_ElementDeleteVariable, tool_DeleteHook, diagram_tool_DoubleClickDescription, tool_ElementDoubleClickVariable, tool_DeleteHookParameter, diagram_tool_DeleteHookParameter, diagram_tool_ReconnectEdgeDescription, tool_ElementSelectVariable, diagram_tool_DirectEditLabel, diagram_tool_DeleteHook, tool_EditMaskVariables, diagram_tool_BehaviorTool, diagram_tool_SourceEdgeCreationVariable, description_AbstractVariable, tool_VariableContainer, diagram_tool_SourceEdgeViewCreationVariable, diagram_tool_TargetEdgeCreationVariable, diagram_tool_TargetEdgeViewCreationVariable, diagram_tool_ElementDoubleClickVariable, diagram_tool_NodeCreationVariable, diagram_tool_CreateView, ContainerModelOperation, diagram_tool_RequestDescription, AbstractToolDescription, diagram_tool_CreateEdgeView, CreateView, diagram_tool_Navigation, diagram_tool_DiagramCreationDescription, RepresentationCreationDescription, tool_DropContainerVariable, tool_ElementDropVariable, tool_InitialContainerDropOperation, diagram_filter_FilterDescription, diagram_tool_DiagramNavigationDescription, RepresentationNavigationDescription, diagram_tool_ContainerDropDescription, diagram_filter_CompositeFilterDescription, FilterDescription, filter_Filter, diagram_filter_VariableFilter, InteractiveVariableDescription, diagram_concern_ConcernSet, diagram_concern_ConcernDescription, diagram_filter_Filter, diagram_filter_MappingFilter, Filter, ContainerLayout, LabelPosition, ContainerShape, BackgroundStyle, BundledImageShape, LineStyle, EdgeArrows, AlignmentKind, ResizeKind, ArrangeConstraint, EdgeRouting, LabelDirection, ContainerLabelDirection, LayoutDirection, FoldingStyle, CenteringStyle, Side, ReconnectionKind, FilterKind},
    associations={ownedDiagramElements0, diagramElements1, description4, edges6, nodes8, nodeListElements10, containers12, currentConcern14, allFilters18, activatedRules21, activateBehaviors23, filterVariableHistory25, activatedLayers27, hiddenElements29, parentLayers32, decorations35, diagramElementMapping37, activatedFilters16, compositeFilterDescriptions41, ownedBorderedNodes42, ownedStyle44, originalStyle46, actualMapping48, candidatesMapping50, graphicalFilters39, nodes53, containers57, elements59, ownedStyle62, originalStyle64, actualMapping67, candidatesMapping69, ownedDiagramElements72, ownedElements74, ownedStyle76, originalStyle79, actualMapping82, candidatesMapping85, ownedStyle88, sourceNode90, targetNode91, actualMapping93, originalStyle95, path98, outgoingEdges100, incomingEdges101, beginLabelStyle103, centerLabelStyle105, endLabelStyle107, sections109, ownedValues110, computedStyleDescriptions112, variableDefinition113, variableDefinition114, modelElement115, filters117, allEdgeMappings119, validationSet127, concerns129, allTools131, defaultConcern133, init136, layout138, diagramInitialisation140, defaultLayer142, additionalLayers145, allLayers147, allActivatedTools150, allNodeMappings121, allContainerMappings124, edgeMappingImports159, containerMappings161, reusedMappings164, toolSection167, reusedTools169, importedDiagram172, layers174, validationSet176, concerns179, nodeMappings153, edgeMappings156, deletionDescription182, labelDirectEdit183, doubleClickDescription185, borderedNodeMappings186, reusedBorderedNodeMappings188, conditionnalStyles192, subNodeMappings194, allNodeMappings196, reusedNodeMappings199, subContainerMappings202, reusedContainerMappings205, allContainerMappings208, style211, conditionnalStyles213, importedMapping217, style191, sourceMapping219, targetMapping221, importedMapping215, conditionnalStyles226, reconnections228, pathNodeMapping230, importedMapping232, conditionnalStyles234, style237, style224, nodeMapping243, mappings245, nodeMappings247, edgeMappings249, edgeMappingImports252, containerMappings255, reusedMappings258, style239, style241, reusedTools267, decorationDescriptionsSet270, allEdgeMappings272, customization275, dropDescriptions277, borderColor278, allTools261, toolSections264, color279, color281, color283, color287, backgroundColor289, sections291, backgroundColor292, foregroundColor294, color285, backgroundColor297, foregroundColor299, labelBorderStyle302, backgroundColor304, strokeColor306, beginLabelStyleDescription308, centerLabelStyleDescription310, endLabelStyleDescription312, centeredSourceMappings314, centeredTargetMappings317, ownedTools320, subSections321, reusedTools326, groupExtensions329, tools331, group333, tools334, nodeMappings337, variable339, viewVariable341, initialOperation343, extraMappings345, popupMenus324, edgeMappings348, sourceVariable350, targetVariable352, sourceViewVariable354, targetViewVariable356, initialOperation358, extraSourceMappings360, extraTargetMappings363, containerMappings366, viewVariable371, initialOperation374, extraMappings377, element380, elementView381, containerView384, initialOperation387, hook390, mappings392, element394, elementView395, initialOperation398, variable368, parameters401, source402, target404, sourceView407, targetView410, element413, initialOperation415, mask421, initialOperation422, initialOperation425, mapping427, edgeView418, diagramDescription429, diagramDescription431, mappings435, oldContainer437, newContainer439, element442, newViewContainer444, initialOperation447, diagramDescription433, mappings449, filters451, ownedVariables452, ownedConcernDescriptions453, filters455, rules457, behaviors460},
    generalizations={gen_diagram_DDiagram_DRepresentation, gen_diagram_DDiagram_description_DocumentedElement, gen_diagram_DDiagram_DragAndDropTarget, gen_diagram_DSemanticDiagram_DDiagram, gen_diagram_DSemanticDiagram_DSemanticDecorator, gen_diagram_DDiagramElement_DRepresentationElement, gen_diagram_HideFilter_GraphicalFilter, gen_diagram_HideLabelFilter_GraphicalFilter, gen_diagram_FoldingPointFilter_GraphicalFilter, gen_diagram_FoldingFilter_GraphicalFilter, gen_diagram_AppliedCompositeFilters_GraphicalFilter, gen_diagram_AbsoluteBoundsFilter_GraphicalFilter, gen_diagram_AbstractDNode_DDiagramElement, gen_diagram_DNode_AbstractDNode, gen_diagram_DNode_EdgeTarget, gen_diagram_DNode_DragAndDropTarget, gen_diagram_DDiagramElementContainer_DragAndDropTarget, gen_diagram_DNodeContainer_DDiagramElementContainer, gen_diagram_DDiagramElementContainer_AbstractDNode, gen_diagram_DDiagramElementContainer_EdgeTarget, gen_diagram_DNodeListElement_AbstractDNode, gen_diagram_DEdge_DDiagramElement, gen_diagram_DEdge_EdgeTarget, gen_diagram_DNodeList_DDiagramElementContainer, gen_diagram_NodeStyle_LabelStyle, gen_diagram_NodeStyle_Style, gen_diagram_NodeStyle_BorderedStyle, gen_diagram_NodeStyle_HideLabelCapabilityStyle, gen_diagram_Dot_NodeStyle, gen_diagram_ContainerStyle_LabelStyle, gen_diagram_ContainerStyle_Style, gen_diagram_ContainerStyle_BorderedStyle, gen_diagram_ContainerStyle_HideLabelCapabilityStyle, gen_diagram_FlatContainerStyle_ContainerStyle, gen_diagram_ShapeContainerStyle_ContainerStyle, gen_diagram_GaugeSection_Customizable, gen_diagram_Ellipse_NodeStyle, gen_diagram_Lozenge_NodeStyle, gen_diagram_BundledImage_NodeStyle, gen_diagram_WorkspaceImage_NodeStyle, gen_diagram_WorkspaceImage_ContainerStyle, gen_diagram_CustomStyle_NodeStyle, gen_diagram_Square_NodeStyle, gen_diagram_EdgeStyle_Style, gen_diagram_BorderedStyle_Style, gen_diagram_Note_NodeStyle, gen_diagram_CollapseFilter_GraphicalFilter, gen_diagram_IndirectlyCollapseFilter_CollapseFilter, gen_diagram_BeginLabelStyle_BasicLabelStyle, gen_diagram_CenterLabelStyle_BasicLabelStyle, gen_diagram_GaugeCompositeStyle_NodeStyle, gen_diagram_BracketEdgeStyle_EdgeStyle, gen_diagram_TypedVariableValue_VariableValue, gen_diagram_EObjectVariableValue_VariableValue, gen_diagram_description_DiagramDescription_description_DragAndDropTargetDescription, gen_diagram_description_DiagramDescription_description_RepresentationDescription, gen_diagram_description_DiagramDescription_description_PasteTargetDescription, gen_diagram_EndLabelStyle_BasicLabelStyle, gen_diagram_description_DiagramImportDescription_description_RepresentationImportDescription, gen_diagram_description_DiagramImportDescription_description_DiagramDescription, gen_diagram_description_DiagramExtensionDescription_RepresentationExtensionDescription, gen_diagram_description_DiagramElementMapping_description_RepresentationElementMapping, gen_diagram_description_DiagramElementMapping_description_PasteTargetDescription, gen_diagram_description_AbstractNodeMapping_description_DiagramElementMapping, gen_diagram_description_AbstractNodeMapping_description_DocumentedElement, gen_diagram_description_NodeMapping_description_AbstractNodeMapping, gen_diagram_description_NodeMapping_description_DragAndDropTargetDescription, gen_diagram_description_ContainerMapping_description_AbstractNodeMapping, gen_diagram_description_ContainerMapping_description_DragAndDropTargetDescription, gen_diagram_description_NodeMappingImport_description_NodeMapping, gen_diagram_description_NodeMappingImport_description_AbstractMappingImport, gen_diagram_description_EdgeMapping_description_DiagramElementMapping, gen_diagram_description_EdgeMapping_description_DocumentedElement, gen_diagram_description_EdgeMapping_description_IEdgeMapping, gen_diagram_description_ContainerMappingImport_description_ContainerMapping, gen_diagram_description_ContainerMappingImport_description_AbstractMappingImport, gen_diagram_description_EdgeMappingImport_description_DocumentedElement, gen_diagram_description_EdgeMappingImport_description_IEdgeMapping, gen_diagram_description_EdgeMappingImport_description_IdentifiedElement, gen_diagram_description_ConditionalNodeStyleDescription_ConditionalStyleDescription, gen_diagram_description_ConditionalEdgeStyleDescription_ConditionalStyleDescription, gen_diagram_description_Layout_DocumentedElement, gen_diagram_description_OrderedTreeLayout_Layout, gen_diagram_description_CompositeLayout_Layout, gen_diagram_description_MappingBasedDecoration_DecorationDescription, gen_diagram_description_Layer_description_DocumentedElement, gen_diagram_description_Layer_description_EndUserDocumentedElement, gen_diagram_description_Layer_description_IdentifiedElement, gen_diagram_description_ConditionalContainerStyleDescription_ConditionalStyleDescription, gen_diagram_description_AdditionalLayer_Layer, gen_diagram_style_BorderedStyleDescription_StyleDescription, gen_diagram_style_NodeStyleDescription_style_StyleDescription, gen_diagram_style_NodeStyleDescription_style_BorderedStyleDescription, gen_diagram_style_NodeStyleDescription_style_LabelStyleDescription, gen_diagram_style_NodeStyleDescription_style_TooltipStyleDescription, gen_diagram_style_NodeStyleDescription_style_HideLabelCapabilityStyleDescription, gen_diagram_style_CustomStyleDescription_NodeStyleDescription, gen_diagram_style_SquareDescription_NodeStyleDescription, gen_diagram_style_LozengeNodeDescription_NodeStyleDescription, gen_diagram_style_EllipseNodeDescription_NodeStyleDescription, gen_diagram_style_BundledImageDescription_NodeStyleDescription, gen_diagram_style_NoteDescription_NodeStyleDescription, gen_diagram_style_DotDescription_NodeStyleDescription, gen_diagram_style_GaugeCompositeStyleDescription_NodeStyleDescription, gen_diagram_style_RoundedCornerStyleDescription_StyleDescription, gen_diagram_style_ContainerStyleDescription_style_RoundedCornerStyleDescription, gen_diagram_style_ContainerStyleDescription_style_BorderedStyleDescription, gen_diagram_style_ContainerStyleDescription_style_LabelStyleDescription, gen_diagram_style_ContainerStyleDescription_style_TooltipStyleDescription, gen_diagram_style_ContainerStyleDescription_style_HideLabelCapabilityStyleDescription, gen_diagram_style_FlatContainerStyleDescription_style_ContainerStyleDescription, gen_diagram_style_FlatContainerStyleDescription_style_SizeComputationContainerStyleDescription, gen_diagram_style_WorkspaceImageDescription_style_NodeStyleDescription, gen_diagram_style_WorkspaceImageDescription_style_ContainerStyleDescription, gen_diagram_style_EdgeStyleDescription_StyleDescription, gen_diagram_style_ShapeContainerStyleDescription_style_ContainerStyleDescription, gen_diagram_style_ShapeContainerStyleDescription_style_SizeComputationContainerStyleDescription, gen_diagram_style_BeginLabelStyleDescription_BasicLabelStyleDescription, gen_diagram_style_CenterLabelStyleDescription_BasicLabelStyleDescription, gen_diagram_style_EndLabelStyleDescription_BasicLabelStyleDescription, gen_diagram_style_BracketEdgeStyleDescription_EdgeStyleDescription, gen_diagram_tool_ToolSection_description_DocumentedElement, gen_diagram_tool_ToolSection_description_IdentifiedElement, gen_diagram_tool_ToolGroup_ToolEntry, gen_diagram_tool_NodeCreationDescription_MappingBasedToolDescription, gen_diagram_tool_EdgeCreationDescription_MappingBasedToolDescription, gen_diagram_tool_ContainerCreationDescription_MappingBasedToolDescription, gen_diagram_tool_DeleteElementDescription_MappingBasedToolDescription, gen_diagram_tool_DoubleClickDescription_MappingBasedToolDescription, gen_diagram_tool_ReconnectEdgeDescription_MappingBasedToolDescription, gen_diagram_tool_DirectEditLabel_MappingBasedToolDescription, gen_diagram_tool_BehaviorTool_AbstractToolDescription, gen_diagram_tool_SourceEdgeCreationVariable_description_AbstractVariable, gen_diagram_tool_SourceEdgeCreationVariable_tool_VariableContainer, gen_diagram_tool_SourceEdgeViewCreationVariable_description_AbstractVariable, gen_diagram_tool_SourceEdgeViewCreationVariable_tool_VariableContainer, gen_diagram_tool_TargetEdgeCreationVariable_description_AbstractVariable, gen_diagram_tool_TargetEdgeCreationVariable_tool_VariableContainer, gen_diagram_tool_TargetEdgeViewCreationVariable_description_AbstractVariable, gen_diagram_tool_TargetEdgeViewCreationVariable_tool_VariableContainer, gen_diagram_tool_ElementDoubleClickVariable_description_AbstractVariable, gen_diagram_tool_ElementDoubleClickVariable_tool_VariableContainer, gen_diagram_tool_NodeCreationVariable_description_AbstractVariable, gen_diagram_tool_NodeCreationVariable_tool_VariableContainer, gen_diagram_tool_CreateView_ContainerModelOperation, gen_diagram_tool_RequestDescription_AbstractToolDescription, gen_diagram_tool_CreateEdgeView_CreateView, gen_diagram_tool_Navigation_ContainerModelOperation, gen_diagram_tool_DiagramCreationDescription_RepresentationCreationDescription, gen_diagram_filter_FilterDescription_description_DocumentedElement, gen_diagram_filter_FilterDescription_description_IdentifiedElement, gen_diagram_tool_DiagramNavigationDescription_RepresentationNavigationDescription, gen_diagram_tool_ContainerDropDescription_MappingBasedToolDescription, gen_diagram_filter_CompositeFilterDescription_FilterDescription, gen_diagram_filter_VariableFilter_Filter, gen_diagram_concern_ConcernSet_DocumentedElement, gen_diagram_concern_ConcernDescription_description_DocumentedElement, gen_diagram_concern_ConcernDescription_description_IdentifiedElement, gen_diagram_filter_MappingFilter_Filter},
    metadata=None
)
