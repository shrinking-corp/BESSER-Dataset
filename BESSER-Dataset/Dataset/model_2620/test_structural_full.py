...
def test_diagram_ContainerStyle_containerLabelDirection_value_roundtrip():
    instance = diagram_ContainerStyle(containerLabelDirection="sample_text")
    assert instance.containerLabelDirection == "sample_text"
    instance.containerLabelDirection = "sample_text_2"
    assert instance.containerLabelDirection == "sample_text_2"
...
def test_diagram_NodeStyle_labelDirection_value_roundtrip():
    instance = diagram_NodeStyle(labelDirection="sample_text", labelPosition="sample_text")
    assert instance.labelDirection == "sample_text"
    instance.labelDirection = "sample_text_2"
    assert instance.labelDirection == "sample_text_2"
...
def test_diagram_style_ContainerStyleDescription_containerLabelDirection_value_roundtrip():
    instance = diagram_style_ContainerStyleDescription(containerLabelDirection="sample_text", roundedCorner=True)
    assert instance.containerLabelDirection == "sample_text"
    instance.containerLabelDirection = "sample_text_2"
    assert instance.containerLabelDirection == "sample_text_2"
...
def test_diagram_style_NodeStyleDescription_forbiddenSides_value_roundtrip():
    instance = diagram_style_NodeStyleDescription(forbiddenSides="sample_text", labelDirection="sample_text", labelPosition="sample_text", resizeKind="sample_text", sizeComputationExpression="sample_text")
...
def test_diagram_style_NodeStyleDescription_labelDirection_value_roundtrip():
    instance = diagram_style_NodeStyleDescription(forbiddenSides="sample_text", labelDirection="sample_text", labelPosition="sample_text", resizeKind="sample_text", sizeComputationExpression="sample_text")
    assert instance.labelDirection == "sample_text"
    instance.labelDirection = "sample_text_2"
    assert instance.labelDirection == "sample_text_2"
...
def test_assoc_ownedStyle44_link_reassign_clear():
    a = diagram_NodeStyle(labelDirection="sample_text", labelPosition="sample_text")
...
def test_assoc_ownedStyle62_link_reassign_clear():
    a = diagram_DDiagramElementContainer(height="sample_text", width="sample_text")
    b1 = diagram_ContainerStyle(containerLabelDirection="sample_text")
    b2 = diagram_ContainerStyle(containerLabelDirection="sample_text_2")
...
diagram_ContainerStyle_strategy = st.builds(diagram_ContainerStyle, containerLabelDirection=safe_text)
...
diagram_NodeStyle_strategy = st.builds(diagram_NodeStyle, labelDirection=safe_text, labelPosition=safe_text)
...
diagram_style_ContainerStyleDescription_strategy = st.builds(diagram_style_ContainerStyleDescription, containerLabelDirection=safe_text, roundedCorner=st.booleans())
...
diagram_style_NodeStyleDescription_strategy = st.builds(diagram_style_NodeStyleDescription, forbiddenSides=safe_text, labelDirection=safe_text, labelPosition=safe_text, resizeKind=safe_text, sizeComputationExpression=safe_text)
