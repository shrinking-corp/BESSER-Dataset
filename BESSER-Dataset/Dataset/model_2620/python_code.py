...
class style_BorderedStyleDescription:
    ...
    pass
class diagram_style_ContainerStyleDescription(style_LabelStyleDescription, style_BorderedStyleDescription, style_HideLabelCapabilityStyleDescription, style_TooltipStyleDescription, style_RoundedCornerStyleDescription):
    ...
    @property
    def containerLabelDirection(self):
...
class diagram_tool_ReconnectEdgeDescription(MappingBasedToolDescription):
    ...
    def __init__(self, reconnectionKind: str, diagram_tool_ReconnectEdgeDescription408: "tool_SourceEdgeViewCreationVariable" = None, diagram_tool_ReconnectEdgeDescription411: "tool_TargetEdgeViewCreationVariable" = None, diagram_tool_ReconnectEdgeDescription414: "tool_ElementSelectVariable" = None, diagram_tool_ReconnectEdgeDescription416: "tool_InitialOperation" = None, diagram_tool_ReconnectEdgeDescription419: "tool_ElementSelectVariable" = None, diagram_tool_ReconnectEdgeDescription: "tool_SourceEdgeCreationVariable" = None, diagram_tool_ReconnectEdgeDescription405: "tool_TargetEdgeCreationVariable" = None):
...
class diagram_tool_ContainerCreationDescription(MappingBasedToolDescription):
    ...
    def __init__(self, iconPath: str, diagram_tool_ContainerCreationDescription: set["ContainerMapping"] = None, diagram_tool_ContainerCreationDescription372: "tool_ContainerViewVariable" = None, diagram_tool_ContainerCreationDescription375: "tool_InitialNodeCreationOperation" = None, diagram_tool_ContainerCreationDescription378: set["AbstractNodeMapping"] = None, diagram_tool_ContainerCreationDescription369: "tool_NodeCreationVariable" = None):
        self.iconPath = iconPath
...
class diagram_style_WorkspaceImageDescription(style_NodeStyleDescription, style_ContainerStyleDescription):
    ...
    def __init__(self, workspacePath: str, style_ContainerStyleDescription242: "diagram_description_ConditionalContainerStyleDescription" = None, style_ContainerStyleDescription: "diagram_description_ContainerMapping" = None, style_NodeStyleDescription238: "diagram_description_ConditionalNodeStyleDescription" = None, style_NodeStyleDescription: "diagram_description_NodeMapping" = None):
...
class diagram_description_DiagramElementMapping(description_PasteTargetDescription, description_RepresentationElementMapping):
    ...
    def checkPrecondition(self, diagram_containerView, diagram_modelElement, diagram_container) :
...
class diagram_description_NodeMapping(description_DragAndDropTargetDescription, description_AbstractNodeMapping):
    ...
    def __init__(self, diagram_description_NodeMapping193: set["ConditionalNodeStyleDescription"] = None, diagram_description_NodeMapping: "style_NodeStyleDescription" = None):
    ...
    def createNode(self, diagram_viewPoint, diagram_modelElement, diagram_container) :
...
class diagram_description_DiagramDescription(description_DragAndDropTargetDescription, description_PasteTargetDescription, description_RepresentationDescription):
    ...
    def __init__(self, domainClass: str, preconditionExpression: str, rootExpression: str, enablePopupBars: bool, diagram_description_DiagramDescription: set["filter_FilterDescription"] = None, diagram_description_DiagramDescription120: set["EdgeMapping"] = None, diagram_description_DiagramDescription128: "validation_ValidationSet" = None, diagram_description_DiagramDescription130: "concern_ConcernSet" = None, diagram_description_DiagramDescription132: set["tool_AbstractToolDescription"] = None, diagram_description_DiagramDescription134: "concern_ConcernDescription" = None, diagram_description_DiagramDescription137: "tool_RepresentationCreationDescription" = None, diagram_description_DiagramDescription139: "Layout" = None, diagram_description_DiagramDescription141: "tool_InitialOperation" = None, diagram_description_DiagramDescription143: "Layer" = None, diagram_description_DiagramDescription146: set["AdditionalLayer"] = None, diagram_description_DiagramDescription168: "tool_ToolSection" = None, diagram_description_DiagramDescription170: set["tool_AbstractToolDescription"] = None, diagram_description_DiagramDescription154: set["NodeMapping"] = None, diagram_description_DiagramDescription157: set["EdgeMapping"] = None, diagram_description_DiagramDescription148: set["Layer"] = None, diagram_description_DiagramDescription151: set["tool_AbstractToolDescription"] = None, diagram_description_DiagramDescription122: set["NodeMapping"] = None, diagram_description_DiagramDescription125: set["ContainerMapping"] = None, diagram_description_DiagramDescription160: set["EdgeMappingImport"] = None, diagram_description_DiagramDescription162: set["ContainerMapping"] = None, diagram_description_DiagramDescription165: set["DiagramElementMapping"] = None):
        self.domainClass = domainClass
        self.preconditionExpression = preconditionExpression
...
class style_StyleDescription:
    ...
    pass
class diagram_style_NodeStyleDescription(style_LabelStyleDescription, style_BorderedStyleDescription, style_HideLabelCapabilityStyleDescription, style_TooltipStyleDescription, style_StyleDescription):

    def __init__(self, sizeComputationExpression: str, resizeKind: str, forbiddenSides: str, labelDirection: str, labelPosition: str, style_StyleDescription: "diagram_ComputedStyleDescriptionRegistry" = None):
        self.sizeComputationExpression = sizeComputationExpression
...
class diagram_GaugeSection(Customizable):
    ...
    def __init__(self, value: str, label: str, backgroundColor: str, foregroundColor: str, min: str, max: str, diagram_GaugeSection: "diagram_GaugeCompositeStyle" = None):
        self.value = value
        self.label = label
...
class diagram_EdgeStyle(Style):
    ...
    def __init__(self, sourceArrow: str, targetArrow: str, foldingStyle: str, size: str, routingStyle: str, centered: str, strokeColor: str, lineStyle: str, diagram_EdgeStyle: "diagram_DEdge" = None, diagram_EdgeStyle104: "diagram_BeginLabelStyle" = None, diagram_EdgeStyle106: "diagram_CenterLabelStyle" = None, diagram_EdgeStyle108: "diagram_EndLabelStyle" = None):
        self.sourceArrow = sourceArrow
        self.targetArrow = targetArrow
        self.foldingStyle = foldingStyle
        self.size = size
...
class diagram_Style:
    ...
    pass
class diagram_NodeStyle(HideLabelCapabilityStyle, BorderedStyle, LabelStyle, Style):
...
class diagram_description_AdditionalLayer(Layer):
    ...
    def __init__(self, activeByDefault: bool, optional: bool, Layer: "diagram_DDiagram" = None, Layer34: "diagram_DDiagramElement" = None, Layer144: "diagram_description_DiagramDescription" = None, Layer149: "diagram_description_DiagramDescription" = None):
...
class diagram_description_Layer(description_DocumentedElement, description_IdentifiedElement, description_EndUserDocumentedElement):
    ...
    def __init__(self, icon: str, diagram_description_Layer253: set["EdgeMappingImport"] = None, diagram_description_Layer256: set["ContainerMapping"] = None, diagram_description_Layer259: set["DiagramElementMapping"] = None, diagram_description_Layer268: set["tool_AbstractToolDescription"] = None, diagram_description_Layer271: "DecorationDescriptionsSet" = None, diagram_description_Layer273: set["EdgeMapping"] = None, diagram_description_Layer276: "Customization" = None, diagram_description_Layer262: set["tool_AbstractToolDescription"] = None, diagram_description_Layer265: set["tool_ToolSection"] = None, diagram_description_Layer: set["NodeMapping"] = None, diagram_description_Layer250: set["EdgeMapping"] = None):
        self.icon = icon
...
class diagram_description_EdgeMapping(description_DiagramElementMapping, description_IEdgeMapping, description_DocumentedElement):
    ...
    def createEdge(self, diagram_semanticTarget, diagram_source, diagram_container, diagram_target) :
        # TODO: Implement createEdge method
        pass

    def getEdgeTargetCandidates(self, diagram_container, diagram_semanticOrigin, diagram_containerView) :
...
class diagram_tool_ToolSection(description_DocumentedElement, description_IdentifiedElement):
    ...
    def __init__(self, icon: str, diagram_tool_ToolSection: set["tool_ToolEntry"] = None, diagram_tool_ToolSection322: set["tool_ToolSection"] = None, diagram_tool_ToolSection327: set["tool_ToolEntry"] = None, diagram_tool_ToolSection330: set["tool_ToolGroupExtension"] = None, diagram_tool_ToolSection325: set["tool_PopupMenu"] = None):
        self.icon = icon
...
class diagram_DDiagram(DRepresentation, description_DocumentedElement, DragAndDropTarget):
    ...
    def __init__(self, synchronized: bool, isInLayoutingMode: bool, headerHeight: int, diagram_DDiagram: set["diagram_DDiagramElement"] = None, diagram_DDiagram2: set["diagram_DDiagramElement"] = None, diagram_DDiagram5: "DiagramDescription" = None, diagram_DDiagram7: set["diagram_DEdge"] = None, diagram_DDiagram9: set["diagram_DNode"] = None, diagram_DDiagram11: set["diagram_DNodeListElement"] = None, diagram_DDiagram13: set["diagram_DDiagramElementContainer"] = None, diagram_DDiagram15: "concern_ConcernDescription" = None, diagram_DDiagram19: set["filter_FilterDescription"] = None, diagram_DDiagram22: set["validation_ValidationRule"] = None, diagram_DDiagram24: set["tool_BehaviorTool"] = None, diagram_DDiagram26: "diagram_FilterVariableHistory" = None, diagram_DDiagram28: set["Layer"] = None, diagram_DDiagram30: set["diagram_DDiagramElement"] = None, diagram_DDiagram17: set["filter_FilterDescription"] = None):
