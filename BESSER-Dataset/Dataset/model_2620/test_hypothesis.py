...
def test_diagram_style_containerstyledescription_has_containerLabelDirection():
    assert hasattr(diagram_style_ContainerStyleDescription, "containerLabelDirection")
    descriptor = None
...
def test_diagram_style_nodestyledescription_has_labelDirection():
    assert hasattr(diagram_style_NodeStyleDescription, "labelDirection")
    descriptor = None
...
def test_diagram_containerstyle_has_containerLabelDirection():
    assert hasattr(diagram_ContainerStyle, "containerLabelDirection")
    descriptor = None
    for klass in diagram_ContainerStyle.__mro__:
        if "containerLabelDirection" in klass.__dict__:
            descriptor = klass.__dict__["containerLabelDirection"]
            break
    assert isinstance(descriptor, property)
...
def test_diagram_nodestyle_has_labelDirection():
    assert hasattr(diagram_NodeStyle, "labelDirection")
    descriptor = None
    for klass in diagram_NodeStyle.__mro__:
        if "labelDirection" in klass.__dict__:
            descriptor = klass.__dict__["labelDirection"]
...
@given(instance=diagram_style_ContainerStyleDescription_strategy)
def test_diagram_style_containerstyledescription_containerLabelDirection_setter(instance):
...
@given(instance=diagram_style_NodeStyleDescription_strategy)
def test_diagram_style_nodestyledescription_labelDirection_setter(instance):
...
@given(instance=diagram_ContainerStyle_strategy)
def test_diagram_containerstyle_containerLabelDirection_setter(instance):
    original = instance.containerLabelDirection
    instance.containerLabelDirection = original
    assert instance.containerLabelDirection == original
...
@given(instance=diagram_NodeStyle_strategy)
def test_diagram_nodestyle_labelDirection_setter(instance):
    original = instance.labelDirection
    instance.labelDirection = original
    assert instance.labelDirection == original
