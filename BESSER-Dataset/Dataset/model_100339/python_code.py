...
class ardurobotml_MoveForwardAction(Action):
    ...
    def __init__(self, speed: int, duration: int, startTick: int):
        self.speed = speed
        self.duration = duration
        self.startTick = startTick
...
class ardurobotml_MoveForwardAndTurningLeftAction(Action):
    ...
    def __init__(self, speed: int, duration: int, startTick: int, diff: int):
        self.speed = speed
        self.duration = duration
        self.startTick = startTick
        self.diff = diff
...
class ardurobotml_State(RegionContainer):
    ...
    def __init__(self, State: "ardurobotml_TFSM" = None, ardurobotml_State: "ardurobotml_TFSM" = None, ardurobotml_State17: "ardurobotml_TFSM" = None, State26: "ardurobotml_Transition" = None, source: set["ardurobotml_Transition"] = None, target: set["ardurobotml_Transition"] = None, ardurobotml_State23: set["ardurobotml_Action"] = None, ownedStates: "ardurobotml_TFSM" = None, State28: "ardurobotml_Transition" = None, ardurobotml_State43: "ardurobotml_Region" = None):
        self.State = State
...
class ardurobotml_TFSM(RegionContainer):
    ...
    def __init__(self, ardurobotml_TFSM: "ardurobotml_TimedSystem" = None, owningFSM: set["ardurobotml_State"] = None, ardurobotml_TFSM6: "ardurobotml_State" = None, ardurobotml_TFSM8: set["ardurobotml_FSMEvent"] = None, ardurobotml_TFSM11: "ardurobotml_FSMClock" = None, ardurobotml_TFSM14: set["ardurobotml_Transition"] = None, ardurobotml_TFSM16: "ardurobotml_State" = None, TFSM: "ardurobotml_State" = None):
...
class ardurobotml_Transition(NamedElement):
    ...
    def __init__(self, ardurobotml_Transition: "ardurobotml_TFSM" = None, outgoingTransitions: "ardurobotml_State" = None, Transition: "ardurobotml_State" = None, Transition21: "ardurobotml_State" = None, incomingTransitions: "ardurobotml_State" = None, ardurobotml_Transition30: "ardurobotml_Guard" = None, ardurobotml_Transition32: set["ardurobotml_FSMEvent"] = None, ardurobotml_Transition40: "ardurobotml_FSMEvent" = None):
