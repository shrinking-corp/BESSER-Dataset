...
# Classes
ardurobotml_TimedSystem = Class(name="ardurobotml_TimedSystem")
NamedElement = Class(name="NamedElement")
ardurobotml_TFSM = Class(name="ardurobotml_TFSM")
ardurobotml_FSMClock = Class(name="ardurobotml_FSMClock")
ardurobotml_FSMEvent = Class(name="ardurobotml_FSMEvent")
RegionContainer = Class(name="RegionContainer")
ardurobotml_State = Class(name="ardurobotml_State")
ardurobotml_Transition = Class(name="ardurobotml_Transition")
ardurobotml_Action = Class(name="ardurobotml_Action", is_abstract=True)
ardurobotml_Guard = Class(name="ardurobotml_Guard", is_abstract=True)
ardurobotml_NamedElement = Class(name="ardurobotml_NamedElement")
ardurobotml_TemporalGuard = Class(name="ardurobotml_TemporalGuard")
Guard = Class(name="Guard")
ardurobotml_EventGuard = Class(name="ardurobotml_EventGuard")
ardurobotml_EvaluateGuard = Class(name="ardurobotml_EvaluateGuard")
ardurobotml_Condition = Class(name="ardurobotml_Condition", is_abstract=True)
ardurobotml_Region = Class(name="ardurobotml_Region")
ardurobotml_RegionContainer = Class(name="ardurobotml_RegionContainer", is_abstract=True)
ardurobotml_AllActionFinishedCondition = Class(name="ardurobotml_AllActionFinishedCondition")
Condition = Class(name="Condition")
ardurobotml_SystemPropertyCondition = Class(name="ardurobotml_SystemPropertyCondition")
ardurobotml_CollisionSensorCondition = Class(name="ardurobotml_CollisionSensorCondition")
ardurobotml_ActionSequence = Class(name="ardurobotml_ActionSequence")
Action = Class(name="Action")
ardurobotml_StopAction = Class(name="ardurobotml_StopAction")
ardurobotml_MoveForwardAction = Class(name="ardurobotml_MoveForwardAction")
ardurobotml_MoveBackardAction = Class(name="ardurobotml_MoveBackardAction")
ardurobotml_MoveForwardAndTurningRightAction = Class(name="ardurobotml_MoveForwardAndTurningRightAction")
ardurobotml_MoveForwardAndTurningLeftAction = Class(name="ardurobotml_MoveForwardAndTurningLeftAction")
ardurobotml_MoveBackardAndTurningRightAction = Class(name="ardurobotml_MoveBackardAndTurningRightAction")
ardurobotml_AcceleratetAction = Class(name="ardurobotml_AcceleratetAction")
ardurobotml_MoveBackardAndTurningLeftAction = Class(name="ardurobotml_MoveBackardAndTurningLeftAction")
ardurobotml_TurningLeftAction = Class(name="ardurobotml_TurningLeftAction")
ardurobotml_TurningRightAction = Class(name="ardurobotml_TurningRightAction")
ardurobotml_DeceleratetAction = Class(name="ardurobotml_DeceleratetAction")
ardurobotml_SCANCollisionAction = Class(name="ardurobotml_SCANCollisionAction")
ardurobotml_EmergencyStopAction = Class(name="ardurobotml_EmergencyStopAction")
...
ardurobotml_Action.methods={ardurobotml_Action_m_begin, ardurobotml_Action_m_end}
...
ardurobotml_MoveForwardAction.attributes={ardurobotml_MoveForwardAction_startTick, ardurobotml_MoveForwardAction_duration, ardurobotml_MoveForwardAction_speed}
...
ardurobotml_MoveBackardAction.attributes={ardurobotml_MoveBackardAction_duration, ardurobotml_MoveBackardAction_startTick, ardurobotml_MoveBackardAction_speed}
...
ardurobotml_MoveForwardAndTurningRightAction.attributes={ardurobotml_MoveForwardAndTurningRightAction_startTick, ardurobotml_MoveForwardAndTurningRightAction_speed, ardurobotml_MoveForwardAndTurningRightAction_duration, ardurobotml_MoveForwardAndTurningRightAction_diff}
...
ardurobotml_MoveForwardAndTurningLeftAction.attributes={ardurobotml_MoveForwardAndTurningLeftAction_speed, ardurobotml_MoveForwardAndTurningLeftAction_diff, ardurobotml_MoveForwardAndTurningLeftAction_startTick, ardurobotml_MoveForwardAndTurningLeftAction_duration}
...
ardurobotml_MoveBackardAndTurningRightAction.attributes={ardurobotml_MoveBackardAndTurningRightAction_duration, ardurobotml_MoveBackardAndTurningRightAction_diff, ardurobotml_MoveBackardAndTurningRightAction_speed, ardurobotml_MoveBackardAndTurningRightAction_startTick}
...
ardurobotml_AcceleratetAction.attributes={ardurobotml_AcceleratetAction_startTick, ardurobotml_AcceleratetAction_ratio}
...
ardurobotml_MoveBackardAndTurningLeftAction.attributes={ardurobotml_MoveBackardAndTurningLeftAction_duration, ardurobotml_MoveBackardAndTurningLeftAction_diff, ardurobotml_MoveBackardAndTurningLeftAction_speed, ardurobotml_MoveBackardAndTurningLeftAction_startTick}
...
ardurobotml_TurningLeftAction.attributes={ardurobotml_TurningLeftAction_startTick, ardurobotml_TurningLeftAction_duration, ardurobotml_TurningLeftAction_speed}
...
ardurobotml_TurningRightAction.attributes={ardurobotml_TurningRightAction_duration, ardurobotml_TurningRightAction_speed, ardurobotml_TurningRightAction_startTick}
...
domain_model = DomainModel(
    name="ardurobotml",
    types={ardurobotml_TimedSystem, NamedElement, ardurobotml_TFSM, ardurobotml_FSMClock, ardurobotml_FSMEvent, RegionContainer, ardurobotml_State, ardurobotml_Transition, ardurobotml_Action, ardurobotml_Guard, ardurobotml_NamedElement, ardurobotml_TemporalGuard, Guard, ardurobotml_EventGuard, ardurobotml_EvaluateGuard, ardurobotml_Condition, ardurobotml_Region, ardurobotml_RegionContainer, ardurobotml_AllActionFinishedCondition, Condition, ardurobotml_SystemPropertyCondition, ardurobotml_CollisionSensorCondition, ardurobotml_ActionSequence, Action, ardurobotml_StopAction, ardurobotml_MoveForwardAction, ardurobotml_MoveBackardAction, ardurobotml_MoveForwardAndTurningRightAction, ardurobotml_MoveForwardAndTurningLeftAction, ardurobotml_MoveBackardAndTurningRightAction, ardurobotml_AcceleratetAction, ardurobotml_MoveBackardAndTurningLeftAction, ardurobotml_TurningLeftAction, ardurobotml_TurningRightAction, ardurobotml_DeceleratetAction, ardurobotml_SCANCollisionAction, ardurobotml_EmergencyStopAction},
    associations={globalClocks1, tfsms0, ownedStates18, globalEvents3, initialState5, localEvents7, localClock10, ownedTransitions13, currentState15, source25, outgoingTransitions19, incomingTransitions20, actions22, owningFSM24, triggeringEvent36, target27, ownedGuard29, generatedEvents31, onClock34, ownedRegions44, sollicitingTransitions38, condition41, ownedStates42, actions46},
    generalizations={gen_ardurobotml_TimedSystem_NamedElement, gen_ardurobotml_TFSM_RegionContainer, gen_ardurobotml_State_RegionContainer, gen_ardurobotml_Transition_NamedElement, gen_ardurobotml_Guard_NamedElement, gen_ardurobotml_TemporalGuard_Guard, gen_ardurobotml_EventGuard_Guard, gen_ardurobotml_FSMEvent_NamedElement, gen_ardurobotml_FSMClock_NamedElement, gen_ardurobotml_EvaluateGuard_Guard, gen_ardurobotml_RegionContainer_NamedElement, gen_ardurobotml_Action_NamedElement, gen_ardurobotml_AllActionFinishedCondition_Condition, gen_ardurobotml_SystemPropertyCondition_Condition, gen_ardurobotml_CollisionSensorCondition_Condition, gen_ardurobotml_ActionSequence_Action, gen_ardurobotml_StopAction_Action, gen_ardurobotml_MoveForwardAction_Action, gen_ardurobotml_MoveBackardAction_Action, gen_ardurobotml_MoveForwardAndTurningRightAction_Action, gen_ardurobotml_MoveForwardAndTurningLeftAction_Action, gen_ardurobotml_MoveBackardAndTurningRightAction_Action, gen_ardurobotml_AcceleratetAction_Action, gen_ardurobotml_MoveBackardAndTurningLeftAction_Action, gen_ardurobotml_TurningLeftAction_Action, gen_ardurobotml_TurningRightAction_Action, gen_ardurobotml_DeceleratetAction_Action, gen_ardurobotml_SCANCollisionAction_Action, gen_ardurobotml_EmergencyStopAction_Action},
    metadata=None
)
