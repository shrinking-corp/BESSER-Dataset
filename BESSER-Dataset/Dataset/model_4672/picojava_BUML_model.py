...
# Classes
picojava_Program = Class(name="picojava_Program")
picojava_UnknownDecl = Class(name="picojava_UnknownDecl")
picojava_PrimitiveDecl = Class(name="picojava_PrimitiveDecl")
picojava_Block = Class(name="picojava_Block")
picojava_TypeDecl = Class(name="picojava_TypeDecl", is_abstract=True)
picojava_Stmt = Class(name="picojava_Stmt", is_abstract=True)
BlockStmt = Class(name="BlockStmt")
picojava_BlockStmt = Class(name="picojava_BlockStmt", is_abstract=True)
picojava_Decl = Class(name="picojava_Decl", is_abstract=True)
Decl = Class(name="Decl")
picojava_ClassDecl = Class(name="picojava_ClassDecl")
TypeDecl = Class(name="TypeDecl")
picojava_Access = Class(name="picojava_Access", is_abstract=True)
picojava_VarDecl = Class(name="picojava_VarDecl")
picojava_AssignStmt = Class(name="picojava_AssignStmt")
Stmt = Class(name="Stmt")
picojava_IdUse = Class(name="picojava_IdUse", is_abstract=True)
picojava_Exp = Class(name="picojava_Exp", is_abstract=True)
picojava_WhileStmt = Class(name="picojava_WhileStmt")
Access = Class(name="Access")
Exp = Class(name="Exp")
picojava_Use = Class(name="picojava_Use")
IdUse = Class(name="IdUse")
picojava_Dot = Class(name="picojava_Dot")
picojava_TypeUse = Class(name="picojava_TypeUse")
picojava_VariableUse = Class(name="picojava_VariableUse")
picojava_BooleanLiteral = Class(name="picojava_BooleanLiteral")

# picojava_Program class attributes and methods
picojava_Program_m_localLookup: Method = Method(name="localLookup", parameters={Parameter(name='picojava_name', type=StringType)}, type=StringType)
...
picojava_Block_m_lookup: Method = Method(name="lookup", parameters={Parameter(name='picojava_name', type=StringType)}, type=StringType)
picojava_Block_m_localLookup: Method = Method(name="localLookup", parameters={Parameter(name='picojava_name', type=StringType)}, type=StringType)
...
picojava_TypeDecl_m_remoteLookup: Method = Method(name="remoteLookup", parameters={Parameter(name='picojava_name', type=StringType)}, type=Decl)
picojava_TypeDecl_m_isSuperTypeOfClassDecl: Method = Method(name="isSuperTypeOfClassDecl", parameters={Parameter(name='picojava_typeDecl', type=StringType)}, type=BooleanType)
picojava_TypeDecl_m_lookup: Method = Method(name="lookup", parameters={Parameter(name='picojava_name', type=StringType)}, type=Decl)
picojava_TypeDecl_m_isSubtypeOf: Method = Method(name="isSubtypeOf", parameters={Parameter(name='picojava_typeDecl', type=StringType)}, type=BooleanType)
picojava_TypeDecl_m_isSuperTypeOf: Method = Method(name="isSuperTypeOf", parameters={Parameter(name='picojava_typeDecl', type=StringType)}, type=BooleanType)
picojava_TypeDecl.attributes={picojava_TypeDecl_isQualified}
picojava_TypeDecl.methods={picojava_TypeDecl_m_lookup, picojava_TypeDecl_m_isSuperTypeOf, picojava_TypeDecl_m_remoteLookup, picojava_TypeDecl_m_isSubtypeOf, picojava_TypeDecl_m_isSuperTypeOfClassDecl}
...
picojava_BlockStmt_m_declarationOf: Method = Method(name="declarationOf", parameters={Parameter(name='picojava_name', type=StringType)}, type=StringType)
...
picojava_Decl.attributes={picojava_Decl_Name, picojava_Decl_isUnknown}
...
picojava_IdUse_m_lookup: Method = Method(name="lookup", parameters={Parameter(name='picojava_name', type=StringType)}, type=Decl)
...
domain_model = DomainModel(
    name="picojava",
    types={picojava_Program, picojava_UnknownDecl, picojava_PrimitiveDecl, picojava_Block, picojava_TypeDecl, picojava_Stmt, BlockStmt, picojava_BlockStmt, picojava_Decl, Decl, picojava_ClassDecl, TypeDecl, picojava_Access, picojava_VarDecl, picojava_AssignStmt, Stmt, picojava_IdUse, picojava_Exp, picojava_WhileStmt, Access, Exp, picojava_Use, IdUse, picojava_Dot, picojava_TypeUse, picojava_VariableUse, picojava_BooleanLiteral},
    associations={unknownDecl3, booleanType5, Block0, PredefinedType1, BlockStmt7, unknownDecl9, type11, booleanType14, unknownDecl19, qualifier17, TypeAccess29, SuperclassId22, Body23, superClass27, type42, Variable31, Value33, Condition35, Body37, booleanType39, decl45, ObjectReference51, IdUse53, qualifier48, booleanType56},
    generalizations={gen_picojava_Stmt_BlockStmt, gen_picojava_Decl_BlockStmt, gen_picojava_TypeDecl_Decl, gen_picojava_ClassDecl_TypeDecl, gen_picojava_VarDecl_Decl, gen_picojava_AssignStmt_Stmt, gen_picojava_WhileStmt_Stmt, gen_picojava_IdUse_Access, gen_picojava_Access_Exp, gen_picojava_Use_IdUse, gen_picojava_Dot_Access, gen_picojava_TypeUse_IdUse, gen_picojava_VariableUse_IdUse, gen_picojava_BooleanLiteral_Exp, gen_picojava_PrimitiveDecl_TypeDecl, gen_picojava_UnknownDecl_TypeDecl},
    metadata=None
)
