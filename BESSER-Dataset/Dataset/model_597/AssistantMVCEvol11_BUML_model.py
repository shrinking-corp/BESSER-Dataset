...
# Classes
AssistantMVC_Controller = Class(name="AssistantMVC_Controller")
AssistantMVC_View = Class(name="AssistantMVC_View")
...
AssistantMVC_ArrowShape = Class(name="AssistantMVC_ArrowShape")
AssistantMVC_Subgraph = Class(name="AssistantMVC_Subgraph")
AssistantMVC_Exam = Class(name="AssistantMVC_Exam")
AssistantMVC_ExamItem = Class(name="AssistantMVC_ExamItem")
...
AssistantMVC_ArrowShape.attributes={AssistantMVC_ArrowShape_value, AssistantMVC_ArrowShape_question}
...
domain_model = DomainModel(
    name="AssistantMVC",
    types={AssistantMVC_Controller, AssistantMVC_View, AssistantMVC_Open, ExamItem, AssistantMVC_MultipleChoice, AssistantMVC_Observer, Observer, AssistantMVC_ExamController, Controller, AssistantMVC_ExamItemController, AssistantMVC_MultipleChoiceController, ExamItemController, AssistantMVC_OpenController, AssistantMVC_ExamView, View, AssistantMVC_ExamItemView, AssistantMVC_OpenView, ExamView, AssistantMVC_MultipleChoiceView, ExamItemView, AssistantMVC_ArrowShape, AssistantMVC_Subgraph, AssistantMVC_Exam, AssistantMVC_ExamItem},
    associations={controllers1, views3, controller5, examItems0},
