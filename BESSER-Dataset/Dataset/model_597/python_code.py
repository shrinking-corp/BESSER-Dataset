...
class AssistantMVC_Exam:
    ...
    def __init__(self, question: str, AssistantMVC_Exam2: set["AssistantMVC_Controller"] = None, AssistantMVC_Exam4: set["AssistantMVC_View"] = None, AssistantMVC_Exam: set["AssistantMVC_ExamItem"] = None):
