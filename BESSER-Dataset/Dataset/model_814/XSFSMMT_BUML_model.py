...
fsm_FSMSystem_m_initialize: Method = Method(name="initialize", parameters={Parameter(name='fsm_args', type=StringType)})
...
fsm_Buffer.methods={fsm_Buffer_m_initialize, fsm_Buffer_m_dequeue, fsm_Buffer_m_enqueue}
...
domain_model = DomainModel(
    ...
    associations={ownedStates0, initialState1, ownedTransitions2, currentState4, source11, target13, ownedStateMachines15, ownedBuffer17, owningFSM7, outgoingTransitions8, incomingTransitions9, inputs19, outputs22},
    generalizations={gen_fsm_StateMachine_NamedElement, gen_fsm_FSMSystem_NamedElement, gen_fsm_Buffer_NamedElement, gen_fsm_State_NamedElement, gen_fsm_Transition_NamedElement},
    metadata=None
)
