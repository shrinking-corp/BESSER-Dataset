...
class smm_SmmElement(ABC):
    ...
    def __init__(self, name: str, shortDescription: str, description: str, SmmElement: "smm_SmmRelationship" = None, SmmElement179: "smm_SmmRelationship" = None, smm_SmmElement: set["smm_Attribute"] = None, smm_SmmElement168: set["smm_Annotation"] = None, to: set["smm_SmmRelationship"] = None, from_: set["smm_SmmRelationship"] = None):
        self.name = name
    ...
    def from_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_smm_SmmElement__from_", None)
...
class smm_RankingInterval(Interval):
    ...
    def __init__(self, value: float, interval: "smm_RankingMeasure" = None, RankingInterval: "smm_RankingMeasure" = None):
        self.value = value
...
class smm_DimensionalMeasure(Measure):
    ...
    def __init__(self, formula: str, smm_DimensionalMeasure27: set["smm_BaseNMeasureRelationship"] = None, smm_DimensionalMeasure30: set["smm_Base2MeasureRelationship"] = None, smm_DimensionalMeasure: set["smm_Base1MeasureRelationship"] = None, smm_DimensionalMeasure33: set["smm_RankingMeasureRelationship"] = None, smm_DimensionalMeasure35: set["smm_RescaledMeasureRelationship"] = None, smm_DimensionalMeasure37: set["smm_GradeMeasureRelationship"] = None, smm_DimensionalMeasure39: "smm_UnitOfMeasure" = None):
...
class smm_Measure(AbstractMeasureElement):
    ...
    def __init__(self, visible: str, source: str, measureLabelFormat: str, measurementLabelFormat: str, scale: str, customScale: str, smm_Measure: set["smm_RefinementMeasureRelationship"] = None, smm_Measure65: set["smm_RefinementMeasureRelationship"] = None, smm_Measure68: set["smm_MeasureRelationship"] = None, Measure: "smm_MeasureCategory" = None, smm_Measure70: set["smm_MeasureRelationship"] = None, smm_Measure73: set["smm_EquivalentMeasureRelationship"] = None, smm_Measure76: set["smm_EquivalentMeasureRelationship"] = None, smm_Measure79: "smm_Operation" = None, categoryMeasure: set["smm_MeasureCategory"] = None, smm_Measure83: "smm_Scope" = None, smm_Measure85: "smm_Characteristic" = None, smm_Measure88: set["smm_MeasureRelationship"] = None, smm_Measure138: "smm_ObservedMeasure" = None):
...
class smm_RescaledMeasure(DimensionalMeasure):
    ...
    def __init__(self, offset: float, multiplier: float, operationFirst: str, RescaledMeasure: "smm_ScaledBaseMeasureRelationship" = None, smm_RescaledMeasure: set["smm_RescaledMeasureRelationship"] = None, rescaledMeasure: "smm_ScaledBaseMeasureRelationship" = None, smm_RescaledMeasure147: "smm_Operation" = None):
        self.offset = offset
...
class smm_MeasureRelationship(SmmRelationship):
    ...
    def __init__(self, influence: str, smm_MeasureRelationship: "smm_Measure" = None, smm_MeasureRelationship102: "smm_Operation" = None, smm_MeasureRelationship71: "smm_Measure" = None, smm_MeasureRelationship89: "smm_Measure" = None):
...
class smm_Operation(AbstractMeasureElement):
    ...
    def __init__(self, body: str, language: str, smm_Operation: "smm_BinaryMeasure" = None, smm_Operation13: "smm_BinaryMeasurement" = None, smm_Operation19: "smm_CollectiveMeasure" = None, smm_Operation23: "smm_CollectiveMeasurement" = None, smm_Operation103: "smm_MeasureRelationship" = None, smm_Operation55: "smm_DirectMeasure" = None, smm_Operation57: "smm_EquivalentMeasureRelationship" = None, smm_Operation80: "smm_Measure" = None, smm_Operation62: "smm_GradeMeasurement" = None, smm_Operation148: "smm_RescaledMeasure" = None, smm_Operation153: "smm_RescaledMeasurement" = None, smm_Operation156: "smm_Scope" = None, smm_Operation159: "smm_Scope" = None, smm_Operation186: "smm_RankingMeasurement" = None):
        self.body = body
...
class smm_Measurement(SmmElement):
    ...
    def __init__(self, breakValue: str, error: str, smm_Measurement108: set["smm_EquivalentMeasurementRelationship"] = None, smm_Measurement111: set["smm_MeasurementRelationship"] = None, smm_Measurement114: set["smm_MeasurementRelationship"] = None, smm_Measurement117: set["smm_RefinementMeasurementRelationship"] = None, smm_Measurement119: set["smm_RefinementMeasurementRelationship"] = None, smm_Measurement: set["smm_MeasurementRelationship"] = None, smm_Measurement106: set["smm_EquivalentMeasurementRelationship"] = None, Measurement: "smm_ObservedMeasure" = None, measurements: "smm_ObservedMeasure" = None, smm_Measurement124: "smm_EObject" = None):
