...
simplerdbms_Primary_Key = Class(name="simplerdbms_Primary_Key")
Key = Class(name="Key")
...
domain_model = DomainModel(
    name="simplerdbms",
    types={simplerdbms_Column, RModelElement, simplerdbms_Table, simplerdbms_ForeignKey, simplerdbms_Key, simplerdbms_Primary_Key, Key, simplerdbms_RModelElement, simplerdbms_Schema},
    associations={owner0, foreignKeys1, keys3, refersTo5, columns6, owner7, k_owner10, columns12, pk_owner15, columns19, schema21, keys22, foreignKeys24, primary_key27, tables17},
    generalizations={gen_simplerdbms_Column_RModelElement, gen_simplerdbms_ForeignKey_RModelElement, gen_simplerdbms_Key_RModelElement, gen_simplerdbms_Primary_Key_Key, gen_simplerdbms_Schema_RModelElement, gen_simplerdbms_Table_RModelElement},
    metadata=None
)
