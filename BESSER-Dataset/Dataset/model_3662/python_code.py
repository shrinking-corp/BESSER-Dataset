...
class employee_Address:
    ...
    def __init__(self, id: str, city: str, country: str, province: str, postalCode: str, street: str, employee_Address: "employee_Employee" = None):
        self.id = id
        self.city = city
...
class employee_EmploymentPeriod:
    ...
    def __init__(self, id: str, startDate: date, endDate: date, employee_EmploymentPeriod: "employee_Employee" = None):
        self.id = id
...
class employee_PhoneNumber:
    ...
    def __init__(self, number: str, type: str, areaCode: str, employee_PhoneNumber: "employee_Employee" = None, employee_PhoneNumber25: "employee_Employee" = None):
        self.number = number
        self.type = type
...
class employee_Project(ABC):
    ...
    def __init__(self, name: str, description: str, employee_Project: "employee_Organization" = None, employee_Project6: "employee_Employee" = None, employee_Project28: "employee_Employee" = None):
        self.name = name
...
class employee_Employee:
    ...
    def __init__(self, id: str, firstName: str, lastName: str, gender: str, salary: float, responsibilities: str, employee_Employee: "employee_Organization" = None, employee_Employee7: "employee_Project" = None, employee_Employee9: "employee_PhoneNumber" = None, employee_Employee11: "employee_EmploymentPeriod" = None, employee_Employee13: "employee_Address" = None, employee_Employee15: "employee_JobTitle" = None, employee_Employee19: "employee_Employee" = None, employee_Employee17: "employee_Employee" = None, employee_Employee22: "employee_Employee" = None, employee_Employee20: set["employee_Employee"] = None, employee_Employee27: set["employee_Project"] = None, employee_Employee30: set["employee_EmailAddress"] = None, employee_Employee24: set["employee_PhoneNumber"] = None):
        self.id = id
