...
# Classes
employee_Organization = Class(name="employee_Organization")
...
employee_Employee.attributes={employee_Employee_gender, employee_Employee_lastName, employee_Employee_id, employee_Employee_salary, employee_Employee_responsibilities, employee_Employee_firstName}
...
employee_EmploymentPeriod.attributes={employee_EmploymentPeriod_startDate, employee_EmploymentPeriod_id, employee_EmploymentPeriod_endDate}
...
employee_Address.attributes={employee_Address_postalCode, employee_Address_city, employee_Address_id, employee_Address_street, employee_Address_province, employee_Address_country}
...
employee_EmailAddress.attributes={employee_EmailAddress_id, employee_EmailAddress_name, employee_EmailAddress_address}
...
domain_model = DomainModel(
    name="employee",
    types={employee_Organization, employee_Employee, employee_Project, employee_JobTitle, employee_PhoneNumber, employee_EmploymentPeriod, employee_Address, employee_SmallProject, Project, employee_LargeProject, employee_EmailAddress, Gender},
    associations={employees0, projects1, jobs3, teamLeader5, owner8, period10, address12, jobTitle14, manager18, managedEmployees21, projects26, emailAddresses29, phoneNumbers23},
