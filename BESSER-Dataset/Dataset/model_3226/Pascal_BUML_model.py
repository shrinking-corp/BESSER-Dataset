...
# Classes
pascal_Model = Class(name="pascal_Model")
...
pascal_DeclarationPart = Class(name="pascal_DeclarationPart")
...
pascal_procedure_declaration = Class(name="pascal_procedure_declaration")
pascal_function_declaration = Class(name="pascal_function_declaration")
...
pascal_procedure_and_function_declaration_part = Class(name="pascal_procedure_and_function_declaration_part")
...
conformant_array_schema = Class(name="conformant_array_schema")
...
statement_part = Class(name="statement_part")
pascal_statement = Class(name="pascal_statement")
pascal_EObject = Class(name="pascal_EObject")
...
simple_statement = Class(name="simple_statement")
...
structured_statement = Class(name="structured_statement")
...
repetitive_statement = Class(name="repetitive_statement")
...
pascal_ExpressionList = Class(name="pascal_ExpressionList")
pascal_ElementList = Class(name="pascal_ElementList")
...
program_heading = Class(name="program_heading")
statement = Class(name="statement")
goto_statement = Class(name="goto_statement")
pascal_field_list = Class(name="pascal_field_list")
constant_definition = Class(name="constant_definition")
...
pascal_function_heading.attributes={pascal_function_heading_id2, pascal_function_heading_id1}
...
pascal_bound_specification.attributes={pascal_bound_specification_id1, pascal_bound_specification_id2, pascal_bound_specification_id3}
...
pascal_assignment_statement.attributes={pascal_assignment_statement_variable, pascal_assignment_statement_identifier}
...
pascal_procedure_statement.attributes={pascal_procedure_statement_actualParameterList, pascal_procedure_statement_name}
...
pascal_factor.attributes={pascal_factor_string, pascal_factor_id, pascal_factor_nil}
...
domain_model = DomainModel(
    name="pascal",
    types={pascal_Model, pascal_program, pascal_program_heading, pascal_block, pascal_DeclarationPart, pascal_statement_part, pascal_label_declaration_part, pascal_constant_definition_part, pascal_type_definition_part, pascal_variable_declaration_part, pascal_type_definition, pascal_variable_declaration, pascal_identifier_list, pascal_type, pascal_procedure_declaration, pascal_function_declaration, pascal_formal_parameter_list, pascal_procedure_heading, pascal_function_heading, pascal_procedure_and_function_declaration_part, pascal_label, pascal_constant_definition, pascal_parameter_type, pascal_conformant_array_schema, pascal_packed_conformant_array_schema, conformant_array_schema, pascal_bound_specification, pascal_unpacked_conformant_array_Schema, pascal_statement_sequence, statement_part, pascal_statement, pascal_EObject, pascal_simple_statement, pascal_assignment_statement, simple_statement, pascal_formal_parameter_section, pascal_value_parameter_section, pascal_variable_parameter_section, structured_statement, pascal_repetitive_statement, pascal_while_statement, repetitive_statement, pascal_repeat_statement, pascal_for_statement, pascal_conditional_statement, pascal_if_statement, pascal_case_statement, pascal_expression, pascal_procedure_statement, pascal_goto_statement, pascal_structured_statement, pascal_compound_statement, pascal_constant, pascal_with_statement, pascal_variable, pascal_simple_expression, pascal_term, pascal_factor, pascal_FunctionDesignator, pascal_number, pascal_Set, pascal_Variable1, pascal_case_limb, pascal_case_label_list, type_definition, pascal_simple_type, pascal_structured_type, pascal_pointer_type, pascal_subrange_type, pascal_enumerated_type, pascal_unpacked_structured_type, pascal_array_type, pascal_record_type, pascal_set_type, pascal_file_type, pascal_ExpressionList, pascal_ElementList, pascal_fixed_part, pascal_variant_part, pascal_record_section, pascal_tag_field, pascal_variant, program_heading, statement, goto_statement, pascal_field_list, constant_definition},
    associations={programs0, program1, block3, declarationPart5, statementPart7, labelDeclarationPart9, constantDefinitionPart11, typeDefinitionPart13, typeDefinitions23, variableDeclarations25, identifierList27, type29, procedureDeclarations31, functionDeclarations33, formalParameterList35, block37, formalParameterList40, type43, block46, FormalParameterList49, FormalParameterList51, variableDeclarationPart15, procedureAndFunctionDeclarationPart17, labels19, constantDefinitions21, functionHeading62, identifierList65, parameterType68, identifierList70, parameterType73, conformantArraySchema76, boundSpecification78, boundSpecifications79, conformantArraySchema81, statements84, statement85, FormalParameterSections53, valueParameterSection55, variableParamenterSection57, procedureHeading59, statementSequence88, expression90, statement92, statementSequence95, expression97, expression1100, expression2102, statement105, ifStatement108, caseStatement109, expression111, ifStatement114, elseStatement117, expression87, constants130, variables132, statement133, simpleExpressions136, terms138, factors140, functionDesignator142, variable144, number147, set149, expression151, factor155, variable1157, expression120, caseLimbs123, caseLabelList125, statement127, simpleType169, structuredType171, pointerType173, subrangeType175, enumeratedType177, identifierList179, constant182, constant2185, unpackedStructuredType188, arrayType190, recordType192, setType194, fileType196, simpleTypes198, expressionList159, variable1162, elementList164, expressions166, type209, fixedPart212, variantPart214, recordSections216, identifierList218, type221, tagfield224, variants226, caseLabelList228, fieldList231, expressions234, type201, fieldlist204, type206, number237},
    generalizations={gen_pascal_packed_conformant_array_schema_conformant_array_schema, gen_pascal_unpacked_conformant_array_Schema_conformant_array_schema, gen_pascal_statement_sequence_statement_part, gen_pascal_assignment_statement_simple_statement, gen_pascal_compound_statement_structured_statement, gen_pascal_repetitive_statement_structured_statement, gen_pascal_while_statement_repetitive_statement, gen_pascal_repeat_statement_repetitive_statement, gen_pascal_for_statement_repetitive_statement, gen_pascal_conditional_statement_structured_statement, gen_pascal_procedure_statement_simple_statement, gen_pascal_goto_statement_simple_statement, gen_pascal_with_statement_structured_statement, gen_pascal_type_type_definition, gen_pascal_identifier_list_program_heading, gen_pascal_label_statement, gen_pascal_label_goto_statement, gen_pascal_constant_constant_definition},
    metadata=None
)
