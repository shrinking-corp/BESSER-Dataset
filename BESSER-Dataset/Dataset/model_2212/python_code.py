...
class StudyProgramme_CourseGroup:
    ...
    def __init__(self, status: str, StudyProgramme_CourseGroup17: set["StudyProgramme_Course"] = None, StudyProgramme_CourseGroup: "StudyProgramme_Semester" = None):
        self.status = status
...
class StudyProgramme_Course:
    ...
    def __init__(self, name: str, code: str, credits: float, level: str, StudyProgramme_Course9: "StudyProgramme_Specialization" = None, StudyProgramme_Course18: "StudyProgramme_CourseGroup" = None, StudyProgramme_Course23: "StudyProgramme_Department" = None, StudyProgramme_Course: "StudyProgramme_Semester" = None):
        self.name = name
        self.code = code
...
class StudyProgramme_Semester:
    ...
    def __init__(self, totalCredits: float, season: str, creditConstraint: str, number: int, StudyProgramme_Semester: "StudyProgramme_Programme" = None, StudyProgramme_Semester12: "StudyProgramme_Specialization" = None, StudyProgramme_Semester4: set["StudyProgramme_Course"] = None, StudyProgramme_Semester6: set["StudyProgramme_CourseGroup"] = None):
