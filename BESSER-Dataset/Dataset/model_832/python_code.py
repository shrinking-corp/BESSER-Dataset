...
class tfsmextended_State(NamedElement):
    ...
    def __init__(self, State18: "tfsmextended_Transition" = None, tfsmextended_State10: "tfsmextended_TFSM" = None, ownedStates: "tfsmextended_TFSM" = None, source: set["tfsmextended_Transition"] = None, target: set["tfsmextended_Transition"] = None, State16: "tfsmextended_Transition" = None, State: "tfsmextended_TFSM" = None, tfsmextended_State: "tfsmextended_TFSM" = None):
...
class tfsmextended_Transition(NamedElement):
    ...
    def __init__(self, action: str, incomingTransitions: "tfsmextended_State" = None, tfsmextended_Transition20: "tfsmextended_Guard" = None, tfsmextended_Transition22: set["tfsmextended_FSMEvent"] = None, tfsmextended_Transition30: "tfsmextended_FSMEvent" = None, tfsmextended_Transition: "tfsmextended_TFSM" = None, Transition: "tfsmextended_State" = None, Transition14: "tfsmextended_State" = None, outgoingTransitions: "tfsmextended_State" = None):
        self.action = action
...
class tfsmextended_FSMEvent(NamedElement):
    ...
    def __init__(self, isTriggered: str, tfsmextended_FSMEvent23: "tfsmextended_Transition" = None, tfsmextended_FSMEvent27: "tfsmextended_EventGuard" = None, tfsmextended_FSMEvent29: set["tfsmextended_Transition"] = None, tfsmextended_FSMEvent38: "tfsmextended_TimedSystem" = None, tfsmextended_FSMEvent: "tfsmextended_TFSM" = None):
...
class tfsmextended_FSMClock(NamedElement):
    ...
    def __init__(self, numberOfTicks: str, tfsmextended_FSMClock25: "tfsmextended_TemporalGuard" = None, tfsmextended_FSMClock35: "tfsmextended_TimedSystem" = None, tfsmextended_FSMClock: "tfsmextended_TFSM" = None):
...
class tfsmextended_TFSM(NamedElement):
    ...
    def __init__(self, tfsmextended_TFSM7: set["tfsmextended_Transition"] = None, tfsmextended_TFSM9: "tfsmextended_State" = None, TFSM: "tfsmextended_State" = None, tfsmextended_TFSM32: "tfsmextended_TimedSystem" = None, owningFSM: set["tfsmextended_State"] = None, tfsmextended_TFSM: "tfsmextended_State" = None, tfsmextended_TFSM3: set["tfsmextended_FSMEvent"] = None, tfsmextended_TFSM5: "tfsmextended_FSMClock" = None):
