...
gastm_SourceFileReference = Class(name="gastm_SourceFileReference")
...
gastm_MinorSyntaxObject = Class(name="gastm_MinorSyntaxObject", is_abstract=True)
...
gastm_MemberObject = Class(name="gastm_MemberObject")
...
gastm_TypeDeclaration = Class(name="gastm_TypeDeclaration")
...
gastm_AggregateTypeDeclaration = Class(name="gastm_AggregateTypeDeclaration")
TypeDeclaration = Class(name="TypeDeclaration")
gastm_EnumTypeDeclaration = Class(name="gastm_EnumTypeDeclaration")
...
gastm_EnumTypeDefinition = Class(name="gastm_EnumTypeDefinition")
gastm_EnumType = Class(name="gastm_EnumType")
gastm_NumberType = Class(name="gastm_NumberType", is_abstract=True)
PrimitiveType = Class(name="PrimitiveType")
gastm_Void = Class(name="gastm_Void")
gastm_Boolean = Class(name="gastm_Boolean")
gastm_IntegralType = Class(name="gastm_IntegralType", is_abstract=True)
...
gastm_RealType = Class(name="gastm_RealType", is_abstract=True)
...
gastm_Real = Class(name="gastm_Real")
...
gastm_IntegerLiteral = Class(name="gastm_IntegerLiteral")
...
gastm_EnumLiteral = Class(name="gastm_EnumLiteral")
gastm_UnaryPlus = Class(name="gastm_UnaryPlus")
gastm_CollectionExpression = Class(name="gastm_CollectionExpression")
...
gastm_UnaryMinus = Class(name="gastm_UnaryMinus")
...
gastm_ActualParameterExpression = Class(name="gastm_ActualParameterExpression", is_abstract=True)
...
gastm_SourceLocation.attributes={gastm_SourceLocation_endLine, gastm_SourceLocation_startPosition, gastm_SourceLocation_endPosition, gastm_SourceLocation_startLine}
...
domain_model = DomainModel(
    name="gastm",
    types={gastm_CompilationUnit, SourceFile, gastm_DefinitionObject, gastm_GASTMObject, gastm_GASTMSourceObject, GASTMObject, gastm_GASTMSemanticObject, gastm_GASTMSyntaxObject, gastm_SourceLocation, gastm_PreprocessorElement, gastm_AnnotationExpression, gastm_SourceFile, GASTMSourceObject, gastm_Name, gastm_SwitchCase, gastm_ProgramScope, gastm_SourceFileReference, gastm_Project, GASTMSemanticObject, gastm_GlobalScope, gastm_Scope, Scope, gastm_FunctionScope, gastm_AggregateScope, gastm_BlockScope, GASTMSyntaxObject, gastm_Type, gastm_Expression, gastm_TypeReference, gastm_Statement, gastm_MinorSyntaxObject, gastm_Dimension, MinorSyntaxObject, gastm_TypeDefinition, gastm_NameSpaceDefinition, gastm_CatchBlock, gastm_NameSpaceType, gastm_UnaryOperator, gastm_BinaryOperator, gastm_StorageSpecification, gastm_VirtualSpecification, gastm_AccessKind, gastm_ActualParameter, gastm_FunctionMemberAttributes, gastm_DerivesFrom, gastm_NamedTypeReference, gastm_MemberObject, gastm_DeclarationOrDefinition, DefinitionObject, gastm_EntryDefinition, gastm_DataDefinition, gastm_EnumLiteralDefinition, gastm_LabelDefinition, gastm_LabelType, gastm_TypeDeclaration, gastm_Definition, DeclarationOrDefinition, gastm_Declaration, gastm_FunctionDefinition, Definition, gastm_FormalParameterDefinition, gastm_AggregateTypeDeclaration, TypeDeclaration, gastm_EnumTypeDeclaration, gastm_IncludeUnit, PreprocessorElement, gastm_MacroCall, gastm_MacroDefinition, gastm_FunctionDeclaration, Declaration, gastm_FormalParameterDeclaration, gastm_VariableDeclaration, gastm_External, StorageSpecification, gastm_FunctionPersistent, gastm_FileLocal, gastm_PerClassMember, gastm_NoDef, gastm_Virtual, VirtualSpecification, gastm_VariableDefinition, DataDefinition, gastm_BitFieldDefinition, gastm_NamedTypeDefinition, TypeDefinition, gastm_NamedType, gastm_AggregateTypeDefinition, gastm_AggregateType, gastm_EnumTypeDefinition, gastm_EnumType, gastm_NumberType, PrimitiveType, gastm_Void, gastm_Boolean, gastm_IntegralType, NumberType, gastm_Comment, gastm_FunctionType, Type, gastm_FormalParameterType, gastm_DataType, gastm_PrimitiveType, DataType, gastm_ConstructedType, gastm_ExceptionType, FormalParameterType, gastm_ByReferenceFormalParameterType, gastm_Public, AccessKind, gastm_Protected, gastm_Private, gastm_UnnamedTypeReference, TypeReference, gastm_RealType, gastm_Byte, gastm_Character, gastm_ShortInteger, IntegralType, gastm_Integer, IntegerLiteral, gastm_LongInteger, gastm_Real, RealType, gastm_Double, gastm_LongDouble, gastm_CollectionType, ConstructedType, gastm_PointerType, gastm_ReferenceType, gastm_RangeType, gastm_ArrayType, gastm_StructureType, AggregateType, gastm_UnionType, gastm_ClassType, gastm_AnnotationType, gastm_ByValueFormalParameterType, gastm_SwitchStatement, gastm_ExpressionStatement, Statement, gastm_JumpStatement, gastm_BreakStatement, gastm_LabelAccess, gastm_ContinueStatement, gastm_LabeledStatement, gastm_BlockStatement, gastm_EmptyStatement, gastm_IfStatement, gastm_DefaultBlock, gastm_WhileStatement, LoopStatement, gastm_DoWhileStatement, gastm_ReturnStatement, gastm_LoopStatement, gastm_TryStatement, gastm_DeclarationOrDefinitionStatement, gastm_ThrowStatement, gastm_DeleteStatement, gastm_TerminateStatement, gastm_CaseBlock, SwitchCase, gastm_Literal, Expression, gastm_ForStatement, gastm_ForCheckBeforeStatement, ForStatement, gastm_ForCheckAfterStatement, gastm_TypesCatchBlock, CatchBlock, gastm_VariableCatchBlock, gastm_CastExpression, gastm_AggregateExpression, gastm_UnaryExpression, gastm_BinaryExpression, gastm_ConditionalExpression, gastm_RangeExpression, gastm_ArrayAccess, gastm_FunctionCallExpression, gastm_NewExpression, gastm_NameReference, gastm_IntegerLiteral, Literal, gastm_CharLiteral, gastm_RealLiteral, gastm_StringLiteral, gastm_BooleanLiteral, gastm_BitLiteral, gastm_EnumLiteral, gastm_UnaryPlus, gastm_CollectionExpression, gastm_IdentifierReference, NameReference, gastm_QualifiedIdentifierReference, gastm_TypeQualifiedIdentifierReference, gastm_QualifiedOverPointer, QualifiedIdentifierReference, gastm_QualifiedOverData, gastm_BitAnd, gastm_BitOr, gastm_BitXor, gastm_BitLeftShift, UnaryOperator, gastm_UnaryMinus, gastm_Not, gastm_BitNot, gastm_AddressOf, gastm_Deref, gastm_Increment, gastm_Decrement, gastm_PostIncrement, gastm_PostDecrement, gastm_Add, BinaryOperator, gastm_Subtract, gastm_Multiply, gastm_Divide, gastm_Modulus, gastm_Exponent, gastm_And, gastm_Or, gastm_Equal, gastm_NotEqual, gastm_Greater, gastm_NotGreater, gastm_Less, gastm_NotLess, gastm_BitRightShift, gastm_Assign, gastm_OperatorAssign, gastm_ActualParameterExpression, ActualParameter, gastm_MissingActualParameter, gastm_ByValueActualParameterExpression, ActualParameterExpression, gastm_ByReferenceActualParameterExpression},
    associations={inSourceFile5, fragments7, locationInfo0, preProcessorElements1, annotations3, highBound27, opensScope8, locationInfo10, ofSourceFile12, files15, outerScope17, definitionObject19, childScope22, expressionType24, lowBound25, typeName46, nameSpace47, body30, body49, nameSpaceType52, body31, virtualSpecifier33, virtualSpecifier34, accessKind36, className38, member40, storageSpecifiers42, accessKind43, formalParameters85, body87, initialValue90, labelName54, labelType56, typeRef58, identifierName60, definitionType62, defRef65, identifierName67, declarationType70, returnType73, formalParameters75, body77, functionMemberAttributes80, opensScope83, file103, refersTo105, value92, formalParameters94, functionMemberAttributes95, bitFieldSize98, definitionType100, aggregateType101, definitionType102, body123, returnType106, parameterTypes108, enumLiterals110, baseType113, members115, opensScope118, type120, ranks125, thenBody155, derivesFrom127, elseBody158, type129, switchExpression161, typeName131, type134, expression137, target139, target141, target142, label144, statement146, subStatements149, opensScope151, condition153, caseExpressions187, cases163, returnValue166, condition168, body170, guardedStatement173, catchBlocks175, finalStatement178, declOrDefn181, exception183, operand185, exceptionVariable196, initBody189, iterationBody191, exceptions194, condition216, onTrueOperand218, castType198, expression200, subExpressions203, operator205, operand206, operator209, leftOperand210, rightOperand213, fromExpression224, onFalseOperand221, labelDefinition246, arrayName249, subscripts251, toExpression226, calledFunction229, actualParams231, newType233, actualParams235, name238, refersTo240, labelName243, annotationType254, memberValues257, expressionList260, qualifiers262, member264, aggregateType266, member268, operator271, value273},
    generalizations={gen_gastm_CompilationUnit_SourceFile, gen_gastm_GASTMSourceObject_GASTMObject, gen_gastm_GASTMSemanticObject_GASTMObject, gen_gastm_GASTMSyntaxObject_GASTMObject, gen_gastm_SourceFile_GASTMSourceObject, gen_gastm_SourceLocation_GASTMSourceObject, gen_gastm_Name_MinorSyntaxObject, gen_gastm_SwitchCase_MinorSyntaxObject, gen_gastm_SourceFileReference_SourceFile, gen_gastm_Project_GASTMSemanticObject, gen_gastm_Scope_GASTMSemanticObject, gen_gastm_ProgramScope_Scope, gen_gastm_FunctionScope_Scope, gen_gastm_AggregateScope_Scope, gen_gastm_BlockScope_Scope, gen_gastm_GlobalScope_Scope, gen_gastm_PreprocessorElement_GASTMSyntaxObject, gen_gastm_DefinitionObject_GASTMSyntaxObject, gen_gastm_Type_GASTMSyntaxObject, gen_gastm_Expression_GASTMSyntaxObject, gen_gastm_Statement_GASTMSyntaxObject, gen_gastm_MinorSyntaxObject_GASTMSyntaxObject, gen_gastm_Dimension_MinorSyntaxObject, gen_gastm_TypeDefinition_DefinitionObject, gen_gastm_NameSpaceDefinition_DefinitionObject, gen_gastm_CatchBlock_MinorSyntaxObject, gen_gastm_UnaryOperator_MinorSyntaxObject, gen_gastm_BinaryOperator_MinorSyntaxObject, gen_gastm_StorageSpecification_MinorSyntaxObject, gen_gastm_VirtualSpecification_MinorSyntaxObject, gen_gastm_AccessKind_MinorSyntaxObject, gen_gastm_ActualParameter_MinorSyntaxObject, gen_gastm_FunctionMemberAttributes_MinorSyntaxObject, gen_gastm_DerivesFrom_MinorSyntaxObject, gen_gastm_MemberObject_MinorSyntaxObject, gen_gastm_DeclarationOrDefinition_DefinitionObject, gen_gastm_EntryDefinition_Definition, gen_gastm_DataDefinition_Definition, gen_gastm_EnumLiteralDefinition_Definition, gen_gastm_LabelDefinition_DefinitionObject, gen_gastm_TypeDeclaration_DefinitionObject, gen_gastm_Definition_DeclarationOrDefinition, gen_gastm_Declaration_DeclarationOrDefinition, gen_gastm_FunctionDefinition_Definition, gen_gastm_AggregateTypeDeclaration_TypeDeclaration, gen_gastm_EnumTypeDeclaration_TypeDeclaration, gen_gastm_IncludeUnit_PreprocessorElement, gen_gastm_MacroCall_PreprocessorElement, gen_gastm_MacroDefinition_PreprocessorElement, gen_gastm_FunctionDeclaration_Declaration, gen_gastm_VariableDeclaration_Declaration, gen_gastm_FormalParameterDeclaration_Declaration, gen_gastm_External_StorageSpecification, gen_gastm_FunctionPersistent_StorageSpecification, gen_gastm_FileLocal_StorageSpecification, gen_gastm_PerClassMember_StorageSpecification, gen_gastm_NoDef_StorageSpecification, gen_gastm_Virtual_VirtualSpecification, gen_gastm_VariableDefinition_DataDefinition, gen_gastm_FormalParameterDefinition_DataDefinition, gen_gastm_BitFieldDefinition_DataDefinition, gen_gastm_NamedTypeDefinition_TypeDefinition, gen_gastm_AggregateTypeDefinition_TypeDefinition, gen_gastm_EnumTypeDefinition_TypeDefinition, gen_gastm_NamedType_DataType, gen_gastm_NumberType_PrimitiveType, gen_gastm_Void_PrimitiveType, gen_gastm_Boolean_PrimitiveType, gen_gastm_IntegralType_NumberType, gen_gastm_Comment_PreprocessorElement, gen_gastm_FunctionType_Type, gen_gastm_DataType_Type, gen_gastm_LabelType_Type, gen_gastm_NameSpaceType_Type, gen_gastm_TypeReference_Type, gen_gastm_PrimitiveType_DataType, gen_gastm_EnumType_DataType, gen_gastm_ConstructedType_DataType, gen_gastm_AggregateType_DataType, gen_gastm_ExceptionType_DataType, gen_gastm_FormalParameterType_DataType, gen_gastm_ByValueFormalParameterType_FormalParameterType, gen_gastm_ByReferenceFormalParameterType_FormalParameterType, gen_gastm_Public_AccessKind, gen_gastm_Protected_AccessKind, gen_gastm_Private_AccessKind, gen_gastm_UnnamedTypeReference_TypeReference, gen_gastm_RealType_NumberType, gen_gastm_Byte_NumberType, gen_gastm_Character_NumberType, gen_gastm_ShortInteger_IntegralType, gen_gastm_Integer_IntegerLiteral, gen_gastm_LongInteger_IntegralType, gen_gastm_Real_RealType, gen_gastm_Double_RealType, gen_gastm_LongDouble_RealType, gen_gastm_CollectionType_ConstructedType, gen_gastm_PointerType_ConstructedType, gen_gastm_ReferenceType_ConstructedType, gen_gastm_RangeType_ConstructedType, gen_gastm_ArrayType_ConstructedType, gen_gastm_StructureType_AggregateType, gen_gastm_UnionType_AggregateType, gen_gastm_ClassType_AggregateType, gen_gastm_AnnotationType_AggregateType, gen_gastm_SwitchStatement_Statement, gen_gastm_NamedTypeReference_TypeReference, gen_gastm_ExpressionStatement_Statement, gen_gastm_JumpStatement_Statement, gen_gastm_BreakStatement_Statement, gen_gastm_ContinueStatement_Statement, gen_gastm_LabeledStatement_Statement, gen_gastm_BlockStatement_Statement, gen_gastm_EmptyStatement_Statement, gen_gastm_IfStatement_Statement, gen_gastm_CaseBlock_SwitchCase, gen_gastm_DefaultBlock_SwitchCase, gen_gastm_WhileStatement_LoopStatement, gen_gastm_DoWhileStatement_LoopStatement, gen_gastm_ReturnStatement_Statement, gen_gastm_LoopStatement_Statement, gen_gastm_TryStatement_Statement, gen_gastm_DeclarationOrDefinitionStatement_Statement, gen_gastm_ThrowStatement_Statement, gen_gastm_DeleteStatement_Statement, gen_gastm_TerminateStatement_Statement, gen_gastm_Literal_Expression, gen_gastm_ForStatement_LoopStatement, gen_gastm_ForCheckBeforeStatement_ForStatement, gen_gastm_ForCheckAfterStatement_ForStatement, gen_gastm_TypesCatchBlock_CatchBlock, gen_gastm_VariableCatchBlock_CatchBlock, gen_gastm_CastExpression_Expression, gen_gastm_AggregateExpression_Expression, gen_gastm_UnaryExpression_Expression, gen_gastm_BinaryExpression_Expression, gen_gastm_ConditionalExpression_Expression, gen_gastm_RangeExpression_Expression, gen_gastm_ArrayAccess_Expression, gen_gastm_AnnotationExpression_Expression, gen_gastm_FunctionCallExpression_Expression, gen_gastm_NewExpression_Expression, gen_gastm_NameReference_Expression, gen_gastm_LabelAccess_Expression, gen_gastm_IntegerLiteral_Literal, gen_gastm_CharLiteral_Literal, gen_gastm_RealLiteral_Literal, gen_gastm_StringLiteral_Literal, gen_gastm_BooleanLiteral_Literal, gen_gastm_BitLiteral_Literal, gen_gastm_EnumLiteral_Literal, gen_gastm_CollectionExpression_Expression, gen_gastm_IdentifierReference_NameReference, gen_gastm_QualifiedIdentifierReference_NameReference, gen_gastm_TypeQualifiedIdentifierReference_NameReference, gen_gastm_QualifiedOverPointer_QualifiedIdentifierReference, gen_gastm_QualifiedOverData_QualifiedIdentifierReference, gen_gastm_BitAnd_BinaryOperator, gen_gastm_BitOr_BinaryOperator, gen_gastm_BitXor_BinaryOperator, gen_gastm_BitLeftShift_BinaryOperator, gen_gastm_UnaryPlus_UnaryOperator, gen_gastm_UnaryMinus_UnaryOperator, gen_gastm_Not_UnaryOperator, gen_gastm_BitNot_UnaryOperator, gen_gastm_AddressOf_UnaryOperator, gen_gastm_Deref_UnaryOperator, gen_gastm_Increment_UnaryOperator, gen_gastm_Decrement_UnaryOperator, gen_gastm_PostIncrement_UnaryOperator, gen_gastm_PostDecrement_UnaryOperator, gen_gastm_Add_BinaryOperator, gen_gastm_Subtract_BinaryOperator, gen_gastm_Multiply_BinaryOperator, gen_gastm_Divide_BinaryOperator, gen_gastm_Modulus_BinaryOperator, gen_gastm_Exponent_BinaryOperator, gen_gastm_And_BinaryOperator, gen_gastm_Or_BinaryOperator, gen_gastm_Equal_BinaryOperator, gen_gastm_NotEqual_BinaryOperator, gen_gastm_Greater_BinaryOperator, gen_gastm_NotGreater_BinaryOperator, gen_gastm_Less_BinaryOperator, gen_gastm_NotLess_BinaryOperator, gen_gastm_BitRightShift_BinaryOperator, gen_gastm_Assign_BinaryOperator, gen_gastm_OperatorAssign_BinaryOperator, gen_gastm_ActualParameterExpression_ActualParameter, gen_gastm_MissingActualParameter_ActualParameter, gen_gastm_ByValueActualParameterExpression_ActualParameterExpression, gen_gastm_ByReferenceActualParameterExpression_ActualParameterExpression},
    metadata=None
)
