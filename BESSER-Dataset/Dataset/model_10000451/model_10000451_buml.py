...
AsteroidSpawner = Class(name="AsteroidSpawner")
...
# AsteroidSpawner class attributes and methods
AsteroidSpawner_publicAttribute: Property = Property(name="publicAttribute", type=FloatType)
AsteroidSpawner_privateAttribute: Property = Property(name="privateAttribute", type=IntegerType)
AsteroidSpawner_asteroids: Property = Property(name="asteroids", type=StringType)
AsteroidSpawner_packageAttribute: Property = Property(name="packageAttribute", type=StringType)
AsteroidSpawner.attributes={AsteroidSpawner_packageAttribute, AsteroidSpawner_asteroids, AsteroidSpawner_privateAttribute, AsteroidSpawner_publicAttribute}
...
ClassC.attributes={ClassC_privateAttribute, ClassC_protectedAttribute, ClassC_publicAttribute, ClassC_packageAttribute}
...
domain_model = DomainModel(
    name="_382a1b7b_81b6_432f_b904_56c13dced5a3",
    types={BankAccount, AsteroidSpawner, ClassB, ClassC, ClassD, ClassE, ClassF, ClassG, ClassJ, ClassH, ClassK, ClassL, ClassM, ClassN, ClassP, InterfaceO_Interface, ClassQ, ClassR, ClassS, ClassT, ClassU, ClassV},
