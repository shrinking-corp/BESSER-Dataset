...
def test_hyp_asteroidspawner_is_not_abstract():
    assert not inspect.isabstract(AsteroidSpawner)


def test_hyp_asteroidspawner_constructor_exists():
    assert callable(AsteroidSpawner.__init__)


def test_hyp_asteroidspawner_constructor_args():
...
def test_hyp_asteroidspawner_privateAttribute_setter(instance):
    original = instance.privateAttribute
    instance.privateAttribute = original
    assert instance.privateAttribute == original
...
@given(instance=AsteroidSpawner_strategy)
def test_hyp_asteroidspawner_asteroids_setter(instance):
    original = instance.asteroids
...
@given(instance=AsteroidSpawner_strategy)
def test_hyp_asteroidspawner_publicAttribute_setter(instance):
    original = instance.publicAttribute
    instance.publicAttribute = original
    assert instance.publicAttribute == original
...
@given(instance=AsteroidSpawner_strategy)
def test_hyp_asteroidspawner_packageAttribute_setter(instance):
    original = instance.packageAttribute
    instance.packageAttribute = original
    assert instance.packageAttribute == original
...
def test_AsteroidSpawner_asteroids_value_roundtrip():
    instance = AsteroidSpawner(asteroids="sample_text", packageAttribute="sample_text", privateAttribute=7, publicAttribute=3.14)
    assert instance.asteroids == "sample_text"
    instance.asteroids = "sample_text_2"
    assert instance.asteroids == "sample_text_2"


def test_AsteroidSpawner_packageAttribute_value_roundtrip():
    instance = AsteroidSpawner(asteroids="sample_text", packageAttribute="sample_text", privateAttribute=7, publicAttribute=3.14)
...
def test_AsteroidSpawner_privateAttribute_value_roundtrip():
    instance = AsteroidSpawner(asteroids="sample_text", packageAttribute="sample_text", privateAttribute=7, publicAttribute=3.14)
...
def test_AsteroidSpawner_publicAttribute_value_roundtrip():
    instance = AsteroidSpawner(asteroids="sample_text", packageAttribute="sample_text", privateAttribute=7, publicAttribute=3.14)
...
AsteroidSpawner_strategy = st.builds(AsteroidSpawner, asteroids=safe_text, packageAttribute=safe_text, privateAttribute=st.integers(), publicAttribute=st.floats(allow_nan=False, allow_infinity=False))
@given(instance=AsteroidSpawner_strategy)
