...
class model6_PropertiesMapEntry:
    ...
    def __init__(self, key: str, model6_PropertiesMapEntry28: "model6_PropertiesMap" = None, model6_PropertiesMapEntry30: "model6_PropertiesMapEntryValue" = None, model6_PropertiesMapEntry: "model6_PropertiesMap" = None):
        self.key = key
...
class model6_PropertiesMap:
    ...
    def __init__(self, label: str, model6_PropertiesMap27: set["model6_PropertiesMapEntry"] = None, model6_PropertiesMap: set["model6_PropertiesMapEntry"] = None):
        self.label = label
