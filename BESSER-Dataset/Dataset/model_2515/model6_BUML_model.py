...
model6_G.methods={model6_G_m_isListModified, model6_G_m_isReferenceModified, model6_G_m_isAttributeModified}
...
domain_model = DomainModel(
    name="model6",
    types={model6_Root, model6_BaseObject, model6_ReferenceObject, BaseObject, model6_PropertiesMapEntryValue, model6_ContainmentObject, model6_A, model6_D, model6_B, model6_UnorderedList, model6_C, model6_EObject, model6_PropertiesMap, model6_E, model6_PropertiesMapEntry, model6_F, model6_G, model6_MyEnumList, model6_MyEnumListUnsettable, MyEnum},
    associations={listA0, listB1, listC4, listD7, transientMap26, referenceOptional10, value29, referenceList12, ownedDs31, containmentOptional15, ownedBs32, containmentList17, ownedC34, contained21, referenced23, data36, persistentMap25, ownedAs38, ownedEs40, reference42, list44},
