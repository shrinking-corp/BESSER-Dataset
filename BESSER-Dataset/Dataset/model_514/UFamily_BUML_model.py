...
domain_model = DomainModel(
    name="Families",
    types={aMember, aFamily, Families_Member, uncertainty_aMember, Families_Family, uncertainty_ModelElement, uncertainty_aFamily, uncertainty_Families_Family, uFamily, Families_uncertainty_aFamily, Families_uncertainty_uMember, uncertainty_Families_Member, uMember, Families_uncertainty_aMember, Families_uncertainty_uFamilyRegistry, Families_FamilyRegistry, uncertainty_aFamilyRegistry, Families_uncertainty_ModelElement, ModelElement, Families_uncertainty_UData, Families_uncertainty_uFamily, uncertainty_UData, uncertainty_Families_FamilyRegistry, uFamilyRegistry, Families_uncertainty_aFamilyRegistry, OperatorType},
    associations={sons0, daughters1, mother4, father7, links10, uleft20, uright21, upoint24, uleft26, uright27, upoint30, relatives12, families14, include16, exclude17, uleft32, uright33, upoint36},
    generalizations={gen_Families_Member_uncertainty_ModelElement, gen_Families_Member_uncertainty_aMember, gen_Families_Family_uncertainty_ModelElement, gen_Families_Family_uncertainty_aFamily, gen_Families_uncertainty_uMember_uncertainty_aMember, gen_Families_uncertainty_uMember_uncertainty_UData, gen_Families_uncertainty_uFamilyRegistry_uncertainty_aFamilyRegistry, gen_Families_uncertainty_uFamilyRegistry_uncertainty_UData, gen_Families_FamilyRegistry_uncertainty_ModelElement, gen_Families_FamilyRegistry_uncertainty_aFamilyRegistry, gen_Families_uncertainty_uFamily_uncertainty_aFamily, gen_Families_uncertainty_uFamily_uncertainty_UData},
    metadata=None
)
