...
class types_Field:
    ...
    def __init__(self, name: str, types_Field5: "types_Type" = None, types_Field8: "types_Key" = None, types_Field: "types_Branch" = None, types_Field25: "types_Union" = None, types_Field12: "types_Struct" = None):
        self.name = name
