...
# Classes
v125case5_D = Class(name="v125case5_D")
T = Class(name="T")
v125case5_N = Class(name="v125case5_N")
Named = Class(name="Named")
v125case5_T = Class(name="v125case5_T")
v125case5_A = Class(name="v125case5_A")
v125case5_B = Class(name="v125case5_B")
v125case5_Named = Class(name="v125case5_Named")
v125case5_E = Class(name="v125case5_E")
D = Class(name="D")
...
as_1: BinaryAssociation = BinaryAssociation(
    name="as_1",
    ends={
...
domain_model = DomainModel(
    name="v125case5",
    types={v125case5_D, T, v125case5_N, Named, v125case5_T, v125case5_A, v125case5_B, v125case5_Named, v125case5_E, D},
    associations={ts0, as_1, bs3, d5, ds7},
    generalizations={gen_v125case5_B_Named, gen_v125case5_D_T, gen_v125case5_N_Named, gen_v125case5_T_Named, gen_v125case5_A_Named, gen_v125case5_E_Named, gen_v125case5_E_D},
    metadata=None
)
