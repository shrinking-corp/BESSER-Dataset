...
applauseDsl_ContentProviderImplementation = Class(name="applauseDsl_ContentProviderImplementation")
applauseDsl_FetchingContentProviderImplementation = Class(name="applauseDsl_FetchingContentProviderImplementation")
ContentProviderImplementation = Class(name="ContentProviderImplementation")
applauseDsl_CustomContentProviderImplementation = Class(name="applauseDsl_CustomContentProviderImplementation")
applauseDsl_ProjectClass = Class(name="applauseDsl_ProjectClass")
...
applauseDsl_Section = Class(name="applauseDsl_Section")
applauseDsl_CustomView = Class(name="applauseDsl_CustomView")
applauseDsl_ViewContentElement = Class(name="applauseDsl_ViewContentElement")
applauseDsl_CollectionIterator = Class(name="applauseDsl_CollectionIterator")
ViewContentElement = Class(name="ViewContentElement")
applauseDsl_Cell = Class(name="applauseDsl_Cell")
applauseDsl_ViewAction = Class(name="applauseDsl_ViewAction")
applauseDsl_TabView = Class(name="applauseDsl_TabView")
View = Class(name="View")
applauseDsl_Tab = Class(name="applauseDsl_Tab")
...
applauseDsl_ComplexProviderConstruction = Class(name="applauseDsl_ComplexProviderConstruction")
ProviderConstruction = Class(name="ProviderConstruction")
applauseDsl_SimpleProviderConstruction = Class(name="applauseDsl_SimpleProviderConstruction")
applauseDsl_Selector = Class(name="applauseDsl_Selector")
...
applauseDsl_Cell.attributes={applauseDsl_Cell_accessory, applauseDsl_Cell_type}
...
domain_model = DomainModel(
    name="applauseDsl",
    types={applauseDsl_Model, applauseDsl_Application, applauseDsl_ModelElement, applauseDsl_PropertyPathPart, applauseDsl_TypeDescription, applauseDsl_Type, applauseDsl_Parameter, PropertyPathPart, applauseDsl_ProviderConstruction, applauseDsl_ObjectReference, Expression, ScalarExpression, CollectionExpression, applauseDsl_Expression, applauseDsl_ScalarExpression, applauseDsl_CollectionExpression, applauseDsl_StringLiteral, applauseDsl_StringFunction, applauseDsl_CollectionLiteral, applauseDsl_Entity, applauseDsl_Property, applauseDsl_ContentProvider, applauseDsl_ContentProviderImplementation, applauseDsl_FetchingContentProviderImplementation, ContentProviderImplementation, applauseDsl_CustomContentProviderImplementation, applauseDsl_ProjectClass, applauseDsl_View, applauseDsl_CollectionFunction, applauseDsl_ViewCall, ModelElement, applauseDsl_SimpleType, Type, applauseDsl_Section, applauseDsl_CustomView, applauseDsl_ViewContentElement, applauseDsl_CollectionIterator, ViewContentElement, applauseDsl_Cell, applauseDsl_ViewAction, applauseDsl_TabView, View, applauseDsl_Tab, applauseDsl_TableView, applauseDsl_StringConcat, StringFunction, applauseDsl_StringReplace, applauseDsl_StringUrlConform, applauseDsl_StringSplit, CollectionFunction, applauseDsl_ComplexProviderConstruction, ProviderConstruction, applauseDsl_SimpleProviderConstruction, applauseDsl_Selector, ViewAction, applauseDsl_ExternalOpen, SerializationFormat, CellType, CellAccessory, TableViewStyle},
    associations={application0, elements1, type3, description4, value6, object8, tail10, extends19, properties20, description22, parameter25, type27, implementation30, url32, selection34, providerClass37, content38, items12, background13, startView16, variables50, title52, titleImage55, sections58, iterator60, title61, cells64, text66, details69, image72, action75, tabs40, title41, icon44, view47, provider84, values87, value89, match91, replacement94, value97, value99, delimiter101, provider104, argument106, expression108, collection77, url79, view81},
    generalizations={gen_applauseDsl_Parameter_PropertyPathPart, gen_applauseDsl_ObjectReference_Expression, gen_applauseDsl_ObjectReference_ScalarExpression, gen_applauseDsl_ObjectReference_CollectionExpression, gen_applauseDsl_StringLiteral_Expression, gen_applauseDsl_StringLiteral_ScalarExpression, gen_applauseDsl_StringFunction_Expression, gen_applauseDsl_StringFunction_ScalarExpression, gen_applauseDsl_CollectionLiteral_Expression, gen_applauseDsl_CollectionLiteral_CollectionExpression, gen_applauseDsl_Entity_Type, gen_applauseDsl_Property_PropertyPathPart, gen_applauseDsl_ContentProvider_ModelElement, gen_applauseDsl_FetchingContentProviderImplementation_ContentProviderImplementation, gen_applauseDsl_CustomContentProviderImplementation_ContentProviderImplementation, gen_applauseDsl_View_ModelElement, gen_applauseDsl_CollectionFunction_Expression, gen_applauseDsl_CollectionFunction_CollectionExpression, gen_applauseDsl_Type_ModelElement, gen_applauseDsl_SimpleType_Type, gen_applauseDsl_CustomView_View, gen_applauseDsl_Section_ViewContentElement, gen_applauseDsl_Cell_ViewContentElement, gen_applauseDsl_CollectionIterator_PropertyPathPart, gen_applauseDsl_TabView_View, gen_applauseDsl_TableView_View, gen_applauseDsl_StringConcat_StringFunction, gen_applauseDsl_StringReplace_StringFunction, gen_applauseDsl_StringUrlConform_StringFunction, gen_applauseDsl_StringSplit_CollectionFunction, gen_applauseDsl_ComplexProviderConstruction_ProviderConstruction, gen_applauseDsl_SimpleProviderConstruction_ProviderConstruction, gen_applauseDsl_Selector_ViewAction, gen_applauseDsl_ExternalOpen_ViewAction, gen_applauseDsl_ViewCall_ViewAction},
    metadata=None
)
