...
# Classes
myDsl_Member = Class(name="myDsl_Member")
myDsl_Entity = Class(name="myDsl_Entity")
Member = Class(name="Member")
myDsl_IsServer = Class(name="myDsl_IsServer")
myDsl_Attribute = Class(name="myDsl_Attribute")
myDsl_ValueType = Class(name="myDsl_ValueType")
myDsl_ElementType = Class(name="myDsl_ElementType")
myDsl_EntityType = Class(name="myDsl_EntityType")
myDsl_Model = Class(name="myDsl_Model")
myDsl_Or = Class(name="myDsl_Or")
Expression = Class(name="Expression")
myDsl_And = Class(name="myDsl_And")
myDsl_Equality = Class(name="myDsl_Equality")
myDsl_Comparison = Class(name="myDsl_Comparison")
ElementType = Class(name="ElementType")
myDsl_BasicType = Class(name="myDsl_BasicType")
myDsl_ArrayType = Class(name="myDsl_ArrayType")
myDsl_ArrayElement = Class(name="myDsl_ArrayElement")
myDsl_Verb = Class(name="myDsl_Verb")
myDsl_Rule = Class(name="myDsl_Rule")
...
myDsl_BoolType = Class(name="myDsl_BoolType")
myDsl_Plus = Class(name="myDsl_Plus")
myDsl_Minus = Class(name="myDsl_Minus")
myDsl_MulOrDiv = Class(name="myDsl_MulOrDiv")
myDsl_Not = Class(name="myDsl_Not")
myDsl_IntConstant = Class(name="myDsl_IntConstant")
myDsl_StringConstant = Class(name="myDsl_StringConstant")
myDsl_BoolConstant = Class(name="myDsl_BoolConstant")
myDsl_VariableConstant = Class(name="myDsl_VariableConstant")
...
myDsl_Verb.attributes={myDsl_Verb_qa, myDsl_Verb_verb}
...
is_1: BinaryAssociation = BinaryAssociation(
    name="is_1",
    ends={
...
domain_model = DomainModel(
    name="myDsl",
    types={myDsl_Member, myDsl_Entity, Member, myDsl_IsServer, myDsl_Attribute, myDsl_ValueType, myDsl_ElementType, myDsl_EntityType, myDsl_Model, myDsl_Or, Expression, myDsl_And, myDsl_Equality, myDsl_Comparison, ElementType, myDsl_BasicType, myDsl_ArrayType, myDsl_ArrayElement, myDsl_Verb, myDsl_Rule, myDsl_Condition, myDsl_Expression, myDsl_IntType, BasicType, myDsl_StringType, myDsl_BoolType, myDsl_Plus, myDsl_Minus, myDsl_MulOrDiv, myDsl_Not, myDsl_IntConstant, myDsl_StringConstant, myDsl_BoolConstant, myDsl_VariableConstant},
    associations={members0, is_1, attributes2, value4, elementType6, left21, right23, left26, right28, left31, right33, left36, entity8, arrayElements10, value11, rules13, condition14, url16, expression19, value58, right38, left41, right43, left46, right48, left51, right53, expression56},
    generalizations={gen_myDsl_Entity_Member, gen_myDsl_Or_Expression, gen_myDsl_And_Expression, gen_myDsl_Equality_Expression, gen_myDsl_Comparison_Expression, gen_myDsl_EntityType_ElementType, gen_myDsl_BasicType_ElementType, gen_myDsl_ArrayType_ElementType, gen_myDsl_Verb_Member, gen_myDsl_IntType_BasicType, gen_myDsl_StringType_BasicType, gen_myDsl_BoolType_BasicType, gen_myDsl_Plus_Expression, gen_myDsl_Minus_Expression, gen_myDsl_MulOrDiv_Expression, gen_myDsl_Not_Expression, gen_myDsl_IntConstant_Expression, gen_myDsl_StringConstant_Expression, gen_myDsl_BoolConstant_Expression, gen_myDsl_VariableConstant_Expression},
    metadata=None
)
