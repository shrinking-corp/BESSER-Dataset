...
Doctor.attributes={Doctor_phno, Doctor_address, Doctor_docid, Doctor_specialization, Doctor_name, Doctor_department}
...
Patient.attributes={Patient_name, Patient_telno, Patient_id, Patient_sex, Patient_address, Patient_roomno, Patient_age}
...
domain_model = DomainModel(
    name="_7312d779_2e44_4ae6_9ae0_656db3a02a76",
    types={Room, Receptionist, Person, Bill, Staff, Nurse, Doctor, Department, Patient},
