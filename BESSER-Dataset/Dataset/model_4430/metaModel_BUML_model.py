...
# Classes
metamodel_Sensor = Class(name="metamodel_Sensor", is_abstract=True)
metamodel_Actuator = Class(name="metamodel_Actuator", is_abstract=True)
metamodel_Action = Class(name="metamodel_Action", is_abstract=True)
metamodel_DifferentialWheel = Class(name="metamodel_DifferentialWheel")
Actuator = Class(name="Actuator")
metamodel_Robot = Class(name="metamodel_Robot")
metamodel_Behaviour = Class(name="metamodel_Behaviour")
metamodel_ActionWheel = Class(name="metamodel_ActionWheel", is_abstract=True)
Action = Class(name="Action")
metamodel_TurnLeft = Class(name="metamodel_TurnLeft")
ActionWheel = Class(name="ActionWheel")
metamodel_Forward = Class(name="metamodel_Forward")
metamodel_Stopping = Class(name="metamodel_Stopping")
metamodel_Backward = Class(name="metamodel_Backward")
metamodel_TurnRight = Class(name="metamodel_TurnRight")
metamodel_DistanceSensor = Class(name="metamodel_DistanceSensor")
Sensor = Class(name="Sensor")
metamodel_LightSensor = Class(name="metamodel_LightSensor")
metamodel_Group = Class(name="metamodel_Group")
metamodel_Type = Class(name="metamodel_Type", is_abstract=True)
metamodel_BoolVal = Class(name="metamodel_BoolVal")
Type = Class(name="Type")
metamodel_FloatVal = Class(name="metamodel_FloatVal")
metamodel_IntVal = Class(name="metamodel_IntVal")
metamodel_StateMachine = Class(name="metamodel_StateMachine")
metamodel_State = Class(name="metamodel_State")
metamodel_Transition = Class(name="metamodel_Transition")
metamodel_Value = Class(name="metamodel_Value")
metamodel_Condition = Class(name="metamodel_Condition", is_abstract=True)
metamodel_UnaryOperator = Class(name="metamodel_UnaryOperator", is_abstract=True)
Operator = Class(name="Operator")
metamodel_BinaryOperator = Class(name="metamodel_BinaryOperator", is_abstract=True)
metamodel_Operator = Class(name="metamodel_Operator", is_abstract=True)
metamodel_BinaryCond = Class(name="metamodel_BinaryCond", is_abstract=True)
Condition = Class(name="Condition")
metamodel_Or = Class(name="metamodel_Or")
BinaryCond = Class(name="BinaryCond")
metamodel_And = Class(name="metamodel_And")
metamodel_UnaryCond = Class(name="metamodel_UnaryCond", is_abstract=True)
metamodel_LessOrEqual = Class(name="metamodel_LessOrEqual")
metamodel_MoreOrEqual = Class(name="metamodel_MoreOrEqual")
metamodel_Add = Class(name="metamodel_Add")
metamodel_Sub = Class(name="metamodel_Sub")
metamodel_Negative = Class(name="metamodel_Negative")
UnaryOperator = Class(name="UnaryOperator")
metamodel_Positive = Class(name="metamodel_Positive")
metamodel_Negation = Class(name="metamodel_Negation")
UnaryCond = Class(name="UnaryCond")
metamodel_Equal = Class(name="metamodel_Equal")
BinaryOperator = Class(name="BinaryOperator")
metamodel_Less = Class(name="metamodel_Less")
metamodel_More = Class(name="metamodel_More")
metamodel_Different = Class(name="metamodel_Different")
...
metamodel_Sensor.attributes={metamodel_Sensor_sensorName, metamodel_Sensor_name}
...
metamodel_DifferentialWheel.attributes={metamodel_DifferentialWheel_isLeft, metamodel_DifferentialWheel_speed}
...
metamodel_State.attributes={metamodel_State_isInitial, metamodel_State_uid, metamodel_State_name}
...
domain_model = DomainModel(
    name="metamodel",
    types={metamodel_Sensor, metamodel_Actuator, metamodel_Action, metamodel_DifferentialWheel, Actuator, metamodel_Robot, metamodel_Behaviour, metamodel_ActionWheel, Action, metamodel_TurnLeft, ActionWheel, metamodel_Forward, metamodel_Stopping, metamodel_Backward, metamodel_TurnRight, metamodel_DistanceSensor, Sensor, metamodel_LightSensor, metamodel_Group, metamodel_Type, metamodel_BoolVal, Type, metamodel_FloatVal, metamodel_IntVal, metamodel_StateMachine, metamodel_State, metamodel_Transition, metamodel_Value, metamodel_Condition, metamodel_UnaryOperator, Operator, metamodel_BinaryOperator, metamodel_Operator, metamodel_BinaryCond, Condition, metamodel_Or, BinaryCond, metamodel_And, metamodel_UnaryCond, metamodel_LessOrEqual, metamodel_MoreOrEqual, metamodel_Add, metamodel_Sub, metamodel_Negative, UnaryOperator, metamodel_Positive, metamodel_Negation, UnaryCond, metamodel_Equal, BinaryOperator, metamodel_Less, metamodel_More, metamodel_Different},
    associations={behaviours0, sensors1, actuators3, actions5, wheels7, group8, value12, stateMachine14, states16, constants18, transitions21, value10, onLeaveAction29, dstId32, cond35, valeur37, operandLeft39, OperandRight40, operandRight43, operandLeft45, child48, workingAction23, onEnterAction26},
    generalizations={gen_metamodel_DifferentialWheel_Actuator, gen_metamodel_ActionWheel_Action, gen_metamodel_TurnLeft_ActionWheel, gen_metamodel_Forward_ActionWheel, gen_metamodel_Stopping_ActionWheel, gen_metamodel_Backward_ActionWheel, gen_metamodel_TurnRight_ActionWheel, gen_metamodel_DistanceSensor_Sensor, gen_metamodel_LightSensor_Sensor, gen_metamodel_Group_Actuator, gen_metamodel_BoolVal_Type, gen_metamodel_FloatVal_Type, gen_metamodel_IntVal_Type, gen_metamodel_UnaryOperator_Operator, gen_metamodel_BinaryOperator_Operator, gen_metamodel_BinaryCond_Condition, gen_metamodel_Or_BinaryCond, gen_metamodel_And_BinaryCond, gen_metamodel_UnaryCond_Condition, gen_metamodel_LessOrEqual_BinaryOperator, gen_metamodel_MoreOrEqual_BinaryOperator, gen_metamodel_Add_BinaryOperator, gen_metamodel_Sub_BinaryOperator, gen_metamodel_Negative_UnaryOperator, gen_metamodel_Positive_UnaryOperator, gen_metamodel_Operator_Condition, gen_metamodel_Negation_UnaryCond, gen_metamodel_Equal_BinaryOperator, gen_metamodel_Less_BinaryOperator, gen_metamodel_More_BinaryOperator, gen_metamodel_Different_BinaryOperator},
    metadata=None
)
