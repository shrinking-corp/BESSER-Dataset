...
class metamodel_Value:
    ...
    def __init__(self, name: str, metamodel_Value13: "metamodel_Type" = None, metamodel_Value20: "metamodel_StateMachine" = None, metamodel_Value: "metamodel_Sensor" = None, metamodel_Value38: "metamodel_UnaryOperator" = None):
        self.name = name
...
class metamodel_State:
    ...
    def __init__(self, uid: int, name: str, isInitial: bool, metamodel_State: "metamodel_StateMachine" = None, metamodel_State22: set["metamodel_Transition"] = None, metamodel_State30: "metamodel_Action" = None, metamodel_State34: "metamodel_Transition" = None, metamodel_State27: "metamodel_Action" = None, metamodel_State24: "metamodel_Action" = None):
        self.uid = uid
        self.name = name
...
class metamodel_Sensor(ABC):
    ...
    def __init__(self, sensorName: str, name: str, metamodel_Sensor: "metamodel_Robot" = None, metamodel_Sensor11: "metamodel_Value" = None):
