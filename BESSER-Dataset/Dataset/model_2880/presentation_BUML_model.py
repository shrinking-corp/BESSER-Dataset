...
# Classes
presentation_literal_TextLiteral = Class(name="presentation_literal_TextLiteral")
presentation_scenario_ScenarioFile = Class(name="presentation_scenario_ScenarioFile", is_abstract=True)
presentation_scenario_Header = Class(name="presentation_scenario_Header")
ScenarioFile = Class(name="ScenarioFile")
HeaderParameter = Class(name="HeaderParameter")
presentation_scenario_SDL = Class(name="presentation_scenario_SDL")
ScenarioObject = Class(name="ScenarioObject")
presentation_scenario_PCL = Class(name="presentation_scenario_PCL")
statements_Statement = Class(name="statements_Statement")
presentation_scenario_Scenario = Class(name="presentation_scenario_Scenario")
NamedElement = Class(name="NamedElement")
Header = Class(name="Header")
SDL = Class(name="SDL")
PCL = Class(name="PCL")
presentation_parameter_Parameter = Class(name="presentation_parameter_Parameter", is_abstract=True)
presentation_parameter_HeaderParameter = Class(name="presentation_parameter_HeaderParameter", is_abstract=True)
Parameter_ = Class(name="Parameter")
presentation_literal_Literal = Class(name="presentation_literal_Literal", is_abstract=True)
presentation_literal_NumericLiteral = Class(name="presentation_literal_NumericLiteral", is_abstract=True)
Literal = Class(name="Literal")
presentation_literal_NumberLiteral = Class(name="presentation_literal_NumberLiteral")
NumericLiteral = Class(name="NumericLiteral")
presentation_literal_GeneralLiteral = Class(name="presentation_literal_GeneralLiteral", is_abstract=True)
presentation_literal_BooleanLiteral = Class(name="presentation_literal_BooleanLiteral")
GeneralLiteral = Class(name="GeneralLiteral")
presentation_literal_NameLiteral = Class(name="presentation_literal_NameLiteral")
TextLiteral = Class(name="TextLiteral")
presentation_literal_FilenameLiteral = Class(name="presentation_literal_FilenameLiteral")
presentation_parameter_TargetButtonParameter = Class(name="presentation_parameter_TargetButtonParameter")
presentation_parameter_CodeParameter = Class(name="presentation_parameter_CodeParameter")
presentation_parameter_PictureParameter = Class(name="presentation_parameter_PictureParameter", is_abstract=True)
presentation_parameter_BackgroundColorParameter = Class(name="presentation_parameter_BackgroundColorParameter")
PictureParameter = Class(name="PictureParameter")
presentation_parameter_TextParameter = Class(name="presentation_parameter_TextParameter", is_abstract=True)
presentation_parameter_CaptionParameter = Class(name="presentation_parameter_CaptionParameter")
TextParameter = Class(name="TextParameter")
presentation_parameter_BitmapParameter = Class(name="presentation_parameter_BitmapParameter", is_abstract=True)
presentation_parameter_FilenameParameter = Class(name="presentation_parameter_FilenameParameter")
BitmapParameter = Class(name="BitmapParameter")
presentation_parameter_StimulusEventParameter = Class(name="presentation_parameter_StimulusEventParameter", is_abstract=True)
presentation_parameter_ActiveButtonsParameter = Class(name="presentation_parameter_ActiveButtonsParameter")
NumberLiteral = Class(name="NumberLiteral")
presentation_parameter_ButtonCodesParameter = Class(name="presentation_parameter_ButtonCodesParameter")
presentation_parameter_ScenarioNameParameter = Class(name="presentation_parameter_ScenarioNameParameter")
NameLiteral = Class(name="NameLiteral")
presentation_parameter_TimeParameter = Class(name="presentation_parameter_TimeParameter")
StimulusEventParameter = Class(name="StimulusEventParameter")
presentation_stimulus_StimulusList = Class(name="presentation_stimulus_StimulusList")
StimulusEvent = Class(name="StimulusEvent")
presentation_stimulus_Trial = Class(name="presentation_stimulus_Trial")
StimulusList = Class(name="StimulusList")
TrialParameter = Class(name="TrialParameter")
presentation_stimulus_ScenarioObject = Class(name="presentation_stimulus_ScenarioObject", is_abstract=True)
presentation_picture_Picture = Class(name="presentation_picture_Picture")
Stimulus = Class(name="Stimulus")
picture_PicturePart = Class(name="picture_PicturePart")
presentation_picture_PictureStimulusEvent = Class(name="presentation_picture_PictureStimulusEvent")
picture_Picture = Class(name="picture_Picture")
presentation_picture_PicturePart = Class(name="presentation_picture_PicturePart", is_abstract=True)
presentation_picture_Bitmap = Class(name="presentation_picture_Bitmap")
Graphic2D = Class(name="Graphic2D")
FilenameParameter = Class(name="FilenameParameter")
presentation_picture_Text = Class(name="presentation_picture_Text")
FilenameLiteral = Class(name="FilenameLiteral")
CaptionParameter = Class(name="CaptionParameter")
presentation_parameter_TrialParameter = Class(name="presentation_parameter_TrialParameter", is_abstract=True)
presentation_general_CoordinateDefinition = Class(name="presentation_general_CoordinateDefinition")
presentation_general_NamedElement = Class(name="presentation_general_NamedElement", is_abstract=True)
presentation_stimulus_Stimulus = Class(name="presentation_stimulus_Stimulus", is_abstract=True)
presentation_stimulus_StimulusEvent = Class(name="presentation_stimulus_StimulusEvent", is_abstract=True)
presentation_picture_TextStimulus = Class(name="presentation_picture_TextStimulus")
picture_Text = Class(name="picture_Text")
presentation_sound_Sound = Class(name="presentation_sound_Sound")
presentation_types_Type = Class(name="presentation_types_Type", is_abstract=True)
presentation_types_BasicType = Class(name="presentation_types_BasicType", is_abstract=True)
Type = Class(name="Type")
presentation_types_Bool = Class(name="presentation_types_Bool")
BasicType = Class(name="BasicType")
presentation_types_Int = Class(name="presentation_types_Int")
presentation_types_Double = Class(name="presentation_types_Double")
presentation_types_String = Class(name="presentation_types_String")
presentation_expressions_BooleanExpression = Class(name="presentation_expressions_BooleanExpression", is_abstract=True)
Expression = Class(name="Expression")
presentation_expressions_OrExpression = Class(name="presentation_expressions_OrExpression")
BooleanExpression = Class(name="BooleanExpression")
expressions_BooleanExpression = Class(name="expressions_BooleanExpression")
presentation_expressions_AndExpression = Class(name="presentation_expressions_AndExpression")
presentation_expressions_NotExpression = Class(name="presentation_expressions_NotExpression")
presentation_expressions_AtomExpression = Class(name="presentation_expressions_AtomExpression", is_abstract=True)
presentation_expressions_BoolExpression = Class(name="presentation_expressions_BoolExpression")
AtomExpression = Class(name="AtomExpression")
BooleanLiteral = Class(name="BooleanLiteral")
presentation_picture_Box = Class(name="presentation_picture_Box")
presentation_picture_Graphic2D = Class(name="presentation_picture_Graphic2D", is_abstract=True)
presentation_picture_Stimulus2D = Class(name="presentation_picture_Stimulus2D", is_abstract=True)
PicturePart = Class(name="PicturePart")
CoordinateDefinition = Class(name="CoordinateDefinition")
presentation_picture_BitmapStimulus = Class(name="presentation_picture_BitmapStimulus")
Stimulus2D = Class(name="Stimulus2D")
picture_Bitmap = Class(name="picture_Bitmap")
presentation_picture_BoxStimulus = Class(name="presentation_picture_BoxStimulus")
picture_Box = Class(name="picture_Box")
presentation_operators_RelationOperator = Class(name="presentation_operators_RelationOperator", is_abstract=True)
presentation_operators_EqualityOperator = Class(name="presentation_operators_EqualityOperator", is_abstract=True)
presentation_operators_MultiplicativeOperator = Class(name="presentation_operators_MultiplicativeOperator", is_abstract=True)
presentation_operators_UnaryOperator = Class(name="presentation_operators_UnaryOperator", is_abstract=True)
presentation_operators_AdditiveOperator = Class(name="presentation_operators_AdditiveOperator", is_abstract=True)
presentation_operators_Assignment = Class(name="presentation_operators_Assignment")
AssignmentOperator = Class(name="AssignmentOperator")
presentation_operators_Greater = Class(name="presentation_operators_Greater")
RelationOperator = Class(name="RelationOperator")
presentation_operators_Less = Class(name="presentation_operators_Less")
presentation_operators_GreaterOrEqual = Class(name="presentation_operators_GreaterOrEqual")
presentation_operators_LessOrEqual = Class(name="presentation_operators_LessOrEqual")
presentation_operators_Equal = Class(name="presentation_operators_Equal")
EqualityOperator = Class(name="EqualityOperator")
presentation_operators_NotEqual = Class(name="presentation_operators_NotEqual")
presentation_statements_Statement = Class(name="presentation_statements_Statement", is_abstract=True)
presentation_statements_StatementList = Class(name="presentation_statements_StatementList")
presentation_statements_Inclusion = Class(name="presentation_statements_Inclusion")
Statement = Class(name="Statement")
presentation_statements_Assignment = Class(name="presentation_statements_Assignment")
presentation_statements_Loop = Class(name="presentation_statements_Loop")
statements_StatementList = Class(name="statements_StatementList")
presentation_statements_VariableDeclaration = Class(name="presentation_statements_VariableDeclaration")
...
presentation_expressions_EqualsExpression = Class(name="presentation_expressions_EqualsExpression")
expressions_Expression = Class(name="expressions_Expression")
presentation_expressions_Expression = Class(name="presentation_expressions_Expression", is_abstract=True)
VariableInitializer = Class(name="VariableInitializer")
presentation_expressions_StatementExpression = Class(name="presentation_expressions_StatementExpression", is_abstract=True)
presentation_expressions_AssignmentExpression = Class(name="presentation_expressions_AssignmentExpression")
expressions_StatementExpression = Class(name="expressions_StatementExpression")
operators_AssignmentOperator = Class(name="operators_AssignmentOperator")
presentation_expressions_PrimaryExpression = Class(name="presentation_expressions_PrimaryExpression", is_abstract=True)
presentation_operators_Operator = Class(name="presentation_operators_Operator", is_abstract=True)
presentation_operators_AssignmentOperator = Class(name="presentation_operators_AssignmentOperator", is_abstract=True)
Operator = Class(name="Operator")
statements_VariableDeclarator = Class(name="statements_VariableDeclarator")
presentation_statements_DeclarationStatement = Class(name="presentation_statements_DeclarationStatement")
statements_VariableDeclaration = Class(name="statements_VariableDeclaration")
presentation_statements_ForInitializer = Class(name="presentation_statements_ForInitializer", is_abstract=True)
presentation_statements_ResourceAcquisition = Class(name="presentation_statements_ResourceAcquisition", is_abstract=True)
presentation_statements_VariableDeclarator = Class(name="presentation_statements_VariableDeclarator")
common_VariableInitializer = Class(name="common_VariableInitializer")
presentation_common_VariableInitializer = Class(name="presentation_common_VariableInitializer", is_abstract=True)
presentation_common_NamedElement = Class(name="presentation_common_NamedElement", is_abstract=True)
presentation_common_Identifier = Class(name="presentation_common_Identifier")
presentation_program_Block = Class(name="presentation_program_Block")
...
presentation_general_CoordinateDefinition.attributes={presentation_general_CoordinateDefinition_type, presentation_general_CoordinateDefinition_coordinate, presentation_general_CoordinateDefinition_right_bottom}
...
domain_model = DomainModel(
    name="presentation",
    types={presentation_literal_TextLiteral, presentation_scenario_ScenarioFile, presentation_scenario_Header, ScenarioFile, HeaderParameter, presentation_scenario_SDL, ScenarioObject, presentation_scenario_PCL, statements_Statement, presentation_scenario_Scenario, NamedElement, Header, SDL, PCL, presentation_parameter_Parameter, presentation_parameter_HeaderParameter, Parameter_, presentation_literal_Literal, presentation_literal_NumericLiteral, Literal, presentation_literal_NumberLiteral, NumericLiteral, presentation_literal_GeneralLiteral, presentation_literal_BooleanLiteral, GeneralLiteral, presentation_literal_NameLiteral, TextLiteral, presentation_literal_FilenameLiteral, presentation_parameter_TargetButtonParameter, presentation_parameter_CodeParameter, presentation_parameter_PictureParameter, presentation_parameter_BackgroundColorParameter, PictureParameter, presentation_parameter_TextParameter, presentation_parameter_CaptionParameter, TextParameter, presentation_parameter_BitmapParameter, presentation_parameter_FilenameParameter, BitmapParameter, presentation_parameter_StimulusEventParameter, presentation_parameter_ActiveButtonsParameter, NumberLiteral, presentation_parameter_ButtonCodesParameter, presentation_parameter_ScenarioNameParameter, NameLiteral, presentation_parameter_TimeParameter, StimulusEventParameter, presentation_stimulus_StimulusList, StimulusEvent, presentation_stimulus_Trial, StimulusList, TrialParameter, presentation_stimulus_ScenarioObject, presentation_picture_Picture, Stimulus, picture_PicturePart, presentation_picture_PictureStimulusEvent, picture_Picture, presentation_picture_PicturePart, presentation_picture_Bitmap, Graphic2D, FilenameParameter, presentation_picture_Text, FilenameLiteral, CaptionParameter, presentation_parameter_TrialParameter, presentation_general_CoordinateDefinition, presentation_general_NamedElement, presentation_stimulus_Stimulus, presentation_stimulus_StimulusEvent, presentation_picture_TextStimulus, picture_Text, presentation_sound_Sound, presentation_types_Type, presentation_types_BasicType, Type, presentation_types_Bool, BasicType, presentation_types_Int, presentation_types_Double, presentation_types_String, presentation_expressions_BooleanExpression, Expression, presentation_expressions_OrExpression, BooleanExpression, expressions_BooleanExpression, presentation_expressions_AndExpression, presentation_expressions_NotExpression, presentation_expressions_AtomExpression, presentation_expressions_BoolExpression, AtomExpression, BooleanLiteral, presentation_picture_Box, presentation_picture_Graphic2D, presentation_picture_Stimulus2D, PicturePart, CoordinateDefinition, presentation_picture_BitmapStimulus, Stimulus2D, picture_Bitmap, presentation_picture_BoxStimulus, picture_Box, presentation_operators_RelationOperator, presentation_operators_EqualityOperator, presentation_operators_MultiplicativeOperator, presentation_operators_UnaryOperator, presentation_operators_AdditiveOperator, presentation_operators_Assignment, AssignmentOperator, presentation_operators_Greater, RelationOperator, presentation_operators_Less, presentation_operators_GreaterOrEqual, presentation_operators_LessOrEqual, presentation_operators_Equal, EqualityOperator, presentation_operators_NotEqual, presentation_statements_Statement, presentation_statements_StatementList, presentation_statements_Inclusion, Statement, presentation_statements_Assignment, presentation_statements_Loop, statements_StatementList, presentation_statements_VariableDeclaration, statements_ForInitializer, statements_ResourceAcquisition, types_Type, presentation_expressions_EqualsExpression, expressions_Expression, presentation_expressions_Expression, VariableInitializer, presentation_expressions_StatementExpression, presentation_expressions_AssignmentExpression, expressions_StatementExpression, operators_AssignmentOperator, presentation_expressions_PrimaryExpression, presentation_operators_Operator, presentation_operators_AssignmentOperator, Operator, statements_VariableDeclarator, presentation_statements_DeclarationStatement, statements_VariableDeclaration, presentation_statements_ForInitializer, presentation_statements_ResourceAcquisition, presentation_statements_VariableDeclarator, common_VariableInitializer, presentation_common_VariableInitializer, presentation_common_NamedElement, presentation_common_Identifier, presentation_program_Block, CoordinateType},
    associations={parameter0, scenario_object1, statement2, header3, sdl4, pcl6, number_literal12, number_literal14, text_literal16, number_literal17, text_literal19, number_literal8, number_literal9, name_literal11, stimulus_event23, stimulus_list24, trial_parameter25, picture_part27, picture_parameter28, picture30, filename_parameter31, caption32, filename_literal21, text_parameter33, stimulus_event_parameter22, text41, argument42, argument43, argument45, value47, x_definition35, y_definition36, bitmap39, box40, statement53, expression55, init57, body58, condition61, type64, arguments48, assignmentOperator49, expression50, variableDeclarator65, variableDeclaration67, variableInitializer68, statement69},
    generalizations={gen_presentation_literal_TextLiteral_GeneralLiteral, gen_presentation_scenario_Header_ScenarioFile, gen_presentation_scenario_SDL_ScenarioFile, gen_presentation_scenario_PCL_ScenarioFile, gen_presentation_scenario_Scenario_NamedElement, gen_presentation_parameter_HeaderParameter_Parameter, gen_presentation_literal_NumericLiteral_Literal, gen_presentation_literal_NumberLiteral_NumericLiteral, gen_presentation_literal_GeneralLiteral_Literal, gen_presentation_literal_BooleanLiteral_GeneralLiteral, gen_presentation_literal_NameLiteral_TextLiteral, gen_presentation_literal_FilenameLiteral_TextLiteral, gen_presentation_parameter_TargetButtonParameter_StimulusEventParameter, gen_presentation_parameter_CodeParameter_StimulusEventParameter, gen_presentation_parameter_PictureParameter_Parameter, gen_presentation_parameter_BackgroundColorParameter_PictureParameter, gen_presentation_parameter_TextParameter_Parameter, gen_presentation_parameter_CaptionParameter_TextParameter, gen_presentation_parameter_FilenameParameter_BitmapParameter, gen_presentation_parameter_StimulusEventParameter_Parameter, gen_presentation_parameter_ActiveButtonsParameter_HeaderParameter, gen_presentation_parameter_ButtonCodesParameter_HeaderParameter, gen_presentation_parameter_ScenarioNameParameter_HeaderParameter, gen_presentation_parameter_TimeParameter_StimulusEventParameter, gen_presentation_stimulus_Trial_ScenarioObject, gen_presentation_stimulus_ScenarioObject_NamedElement, gen_presentation_picture_Picture_Stimulus, gen_presentation_picture_PictureStimulusEvent_StimulusEvent, gen_presentation_picture_PicturePart_ScenarioObject, gen_presentation_picture_Bitmap_Graphic2D, gen_presentation_picture_Text_Graphic2D, gen_presentation_parameter_TrialParameter_Parameter, gen_presentation_stimulus_Stimulus_ScenarioObject, gen_presentation_stimulus_StimulusEvent_ScenarioObject, gen_presentation_picture_TextStimulus_Stimulus2D, gen_presentation_sound_Sound_Stimulus, gen_presentation_types_BasicType_Type, gen_presentation_types_Bool_BasicType, gen_presentation_types_Int_BasicType, gen_presentation_types_Double_BasicType, gen_presentation_types_String_BasicType, gen_presentation_expressions_BooleanExpression_Expression, gen_presentation_expressions_OrExpression_BooleanExpression, gen_presentation_expressions_AndExpression_BooleanExpression, gen_presentation_expressions_NotExpression_BooleanExpression, gen_presentation_expressions_AtomExpression_BooleanExpression, gen_presentation_expressions_BoolExpression_AtomExpression, gen_presentation_picture_Box_Graphic2D, gen_presentation_picture_Graphic2D_ScenarioObject, gen_presentation_picture_Stimulus2D_PicturePart, gen_presentation_picture_BitmapStimulus_Stimulus2D, gen_presentation_picture_BoxStimulus_Stimulus2D, gen_presentation_operators_RelationOperator_Operator, gen_presentation_operators_EqualityOperator_Operator, gen_presentation_operators_MultiplicativeOperator_Operator, gen_presentation_operators_UnaryOperator_Operator, gen_presentation_operators_AdditiveOperator_Operator, gen_presentation_operators_Assignment_AssignmentOperator, gen_presentation_operators_Greater_RelationOperator, gen_presentation_operators_Less_RelationOperator, gen_presentation_operators_GreaterOrEqual_RelationOperator, gen_presentation_operators_LessOrEqual_RelationOperator, gen_presentation_operators_Equal_EqualityOperator, gen_presentation_operators_NotEqual_EqualityOperator, gen_presentation_statements_Inclusion_Statement, gen_presentation_statements_Assignment_Statement, gen_presentation_statements_Loop_Statement, gen_presentation_statements_VariableDeclaration_statements_ForInitializer, gen_presentation_statements_VariableDeclaration_statements_ResourceAcquisition, gen_presentation_expressions_EqualsExpression_AtomExpression, gen_presentation_expressions_Expression_VariableInitializer, gen_presentation_expressions_AssignmentExpression_expressions_Expression, gen_presentation_expressions_AssignmentExpression_expressions_StatementExpression, gen_presentation_operators_AssignmentOperator_Operator, gen_presentation_statements_DeclarationStatement_Statement, gen_presentation_statements_VariableDeclarator_NamedElement, gen_presentation_common_Identifier_NamedElement},
    metadata=None
)
