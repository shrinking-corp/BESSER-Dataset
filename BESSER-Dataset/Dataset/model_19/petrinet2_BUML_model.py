...
# Classes
petrinet2_Node = Class(name="petrinet2_Node", is_abstract=True)
Element = Class(name="Element")
petrinet2_Place = Class(name="petrinet2_Place")
Node = Class(name="Node")
petrinet2_Transition = Class(name="petrinet2_Transition")
petrinet2_Petrinet = Class(name="petrinet2_Petrinet")
petrinet2_Element = Class(name="petrinet2_Element", is_abstract=True)
petrinet2_Arc = Class(name="petrinet2_Arc")
