...
class umlMM__Association:
    ...
    def __init__(self, name: str, Association11: "umlMM__Class" = None, Association13: "umlMM__Class" = None, Association: "umlMM__Package" = None, association: "umlMM__Package" = None, sourceOf: "umlMM__Class" = None, destinationOf: "umlMM__Class" = None):
        self.name = name
...
class umlMM__Classifier(ABC):
    ...
    def __init__(self, name: str, Classifier: "umlMM__Package" = None, Classifier17: "umlMM__Attribute" = None, type: set["umlMM__Attribute"] = None, classifier: "umlMM__Package" = None):
        self.name = name
