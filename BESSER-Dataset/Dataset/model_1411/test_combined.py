...
def test_trialStatemachine_State_name_value_roundtrip():
    instance = trialStatemachine_State(name="sample_text")
    assert instance.name == "sample_text"
    instance.name = "sample_text_2"
    assert instance.name == "sample_text_2"
...
def test_assoc_action15_link_reassign_clear():
    ...
    _safe_set(a, 'trialStatemachine_LabeledTransition16', b1)
    assert _is_linked(a, 'trialStatemachine_LabeledTransition16', b1)
    if hasattr(b1, 'trialStatemachine_Action17'):
        assert _is_linked(b1, 'trialStatemachine_Action17', a)
    _safe_set(a, 'trialStatemachine_LabeledTransition16', b2)
    assert _is_linked(a, 'trialStatemachine_LabeledTransition16', b2)
    if hasattr(b1, 'trialStatemachine_Action17'):
        assert not _is_linked(b1, 'trialStatemachine_Action17', a)
    if hasattr(b2, 'trialStatemachine_Action17'):
        assert _is_linked(b2, 'trialStatemachine_Action17', a)
    _safe_set(a, 'trialStatemachine_LabeledTransition16', None)
    assert not _is_linked(a, 'trialStatemachine_LabeledTransition16', b2)
    if hasattr(b2, 'trialStatemachine_Action17'):
        assert not _is_linked(b2, 'trialStatemachine_Action17', a)
...
def test_assoc_defaultHistory3_link_reassign_clear():
    a = trialStatemachine_State(name="sample_text")
    b1 = trialStatemachine_Region(history="sample_text")
    b2 = trialStatemachine_Region(history="sample_text_2")
    _safe_set(a, 'trialStatemachine_State5', b1)
    assert _is_linked(a, 'trialStatemachine_State5', b1)
    if hasattr(b1, 'trialStatemachine_Region4'):
        assert _is_linked(b1, 'trialStatemachine_Region4', a)
    _safe_set(a, 'trialStatemachine_State5', b2)
    assert _is_linked(a, 'trialStatemachine_State5', b2)
    if hasattr(b1, 'trialStatemachine_Region4'):
        assert not _is_linked(b1, 'trialStatemachine_Region4', a)
    if hasattr(b2, 'trialStatemachine_Region4'):
        assert _is_linked(b2, 'trialStatemachine_Region4', a)
    _safe_set(a, 'trialStatemachine_State5', None)
    assert not _is_linked(a, 'trialStatemachine_State5', b2)
    if hasattr(b2, 'trialStatemachine_Region4'):
        assert not _is_linked(b2, 'trialStatemachine_Region4', a)
...
def test_assoc_region1_link_reassign_clear():
    a = trialStatemachine_Region(history="sample_text")
    b1 = trialStatemachine_ComplexState()
    b2 = trialStatemachine_ComplexState()
    _safe_set(a, 'trialStatemachine_Region', b1)
    assert _is_linked(a, 'trialStatemachine_Region', b1)
    if hasattr(b1, 'trialStatemachine_ComplexState'):
        assert _is_linked(b1, 'trialStatemachine_ComplexState', a)
    _safe_set(a, 'trialStatemachine_Region', b2)
    assert _is_linked(a, 'trialStatemachine_Region', b2)
    if hasattr(b1, 'trialStatemachine_ComplexState'):
    ...
    _safe_set(a, 'trialStatemachine_Region', None)
    assert not _is_linked(a, 'trialStatemachine_Region', b2)
    if hasattr(b2, 'trialStatemachine_ComplexState'):
...
def test_assoc_target12_link_reassign_clear():
    ...
    if hasattr(b1, 'trialStatemachine_LabeledTransition13'):
        assert _is_linked(b1, 'trialStatemachine_LabeledTransition13', a)
    _safe_set(a, 'trialStatemachine_State14', b2)
    assert _is_linked(a, 'trialStatemachine_State14', b2)
    if hasattr(b1, 'trialStatemachine_LabeledTransition13'):
        assert not _is_linked(b1, 'trialStatemachine_LabeledTransition13', a)
    if hasattr(b2, 'trialStatemachine_LabeledTransition13'):
        assert _is_linked(b2, 'trialStatemachine_LabeledTransition13', a)
    _safe_set(a, 'trialStatemachine_State14', None)
    assert not _is_linked(a, 'trialStatemachine_State14', b2)
    if hasattr(b2, 'trialStatemachine_LabeledTransition13'):
        assert not _is_linked(b2, 'trialStatemachine_LabeledTransition13', a)
...
trialStatemachine_State_strategy = st.builds(trialStatemachine_State, name=safe_text)
@given(instance=trialStatemachine_State_strategy)
@settings(max_examples=25)
