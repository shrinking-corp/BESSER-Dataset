...
class trialStatemachine_Action:
    ...
    def __init__(self, name: str, trialStatemachine_Action17: "trialStatemachine_LabeledTransition" = None, trialStatemachine_Action: "trialStatemachine_Statemachine" = None):
        self.name = name
