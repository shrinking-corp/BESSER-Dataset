...
mathInterpreter_Mult = Class(name="mathInterpreter_Mult")
mathInterpreter_Div = Class(name="mathInterpreter_Div")
...
domain_model = DomainModel(
    ...
    types={mathInterpreter_MathExp, mathInterpreter_Exp, mathInterpreter_Plus, Exp, mathInterpreter_Minus, mathInterpreter_Mult, mathInterpreter_Div},
    associations={exp0, exp2, left5, right8},
    generalizations={gen_mathInterpreter_Plus_Exp, gen_mathInterpreter_Minus_Exp, gen_mathInterpreter_Mult_Exp, gen_mathInterpreter_Div_Exp},
    metadata=None
)
