...
FrontOfHouse = Class(name="FrontOfHouse")
...
Booking.attributes={Booking_email_id, Booking_customer_name, Booking_date, Booking_endTime, Booking_startTime, Booking_reservedTables, Booking_contact_no, Booking_booking_id}
...
Staff.attributes={Staff_staffId, Staff_name, Staff_type}
...
# FrontOfHouse class attributes and methods
...
Staff_StaffUI: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="interacts1", type=ReservationManagementSystem, multiplicity=Multiplicity(0, 9999))
    }
)
Staff_ReservationManagementSystem: BinaryAssociation = BinaryAssociation(
    name="Staff_ReservationManagementSystem",
    ends={
        Property(name="reservationManagementSystem2", type=StaffUI, multiplicity=Multiplicity(1, 1)),
...
domain_model = DomainModel(
    name="ca4580cd_8fdd_45e8_9748_3a7772c0b634",
    types={ReservationManagementSystem, Booking, Table, Report, Staff, Waiter, StaffUI, CustomerUI, FrontOfHouse, Manager},
