...
# Classes
xal_Address = Class(name="xal_Address")
xal_AddressDetails = Class(name="xal_AddressDetails")
xal_PostalServiceElements = Class(name="xal_PostalServiceElements")
xal_Country = Class(name="xal_Country")
xal_AdministrativeArea = Class(name="xal_AdministrativeArea")
xal_Locality = Class(name="xal_Locality")
xal_Thoroughfare = Class(name="xal_Thoroughfare")
xal_AddressLines = Class(name="xal_AddressLines")
xal_AddressIdentifier = Class(name="xal_AddressIdentifier")
xal_AddressLatitudeDirection = Class(name="xal_AddressLatitudeDirection")
xal_AddressLatitude = Class(name="xal_AddressLatitude")
xal_AddressLongitude = Class(name="xal_AddressLongitude")
xal_AddressLine = Class(name="xal_AddressLine")
xal_AdministrativeAreaName = Class(name="xal_AdministrativeAreaName")
xal_SubAdministrativeArea = Class(name="xal_SubAdministrativeArea")
xal_AddressLongitudeDirection = Class(name="xal_AddressLongitudeDirection")
xal_PostOffice = Class(name="xal_PostOffice")
xal_PostalCode = Class(name="xal_PostalCode")
xal_BuildingName = Class(name="xal_BuildingName")
xal_Barcode = Class(name="xal_Barcode")
xal_CountryNameCode = Class(name="xal_CountryNameCode")
xal_CountryName = Class(name="xal_CountryName")
xal_Department = Class(name="xal_Department")
xal_DepartmentName = Class(name="xal_DepartmentName")
xal_MailStop = Class(name="xal_MailStop")
xal_DependentLocality = Class(name="xal_DependentLocality")
xal_DependentLocalityName = Class(name="xal_DependentLocalityName")
xal_DependentLocalityNumber = Class(name="xal_DependentLocalityNumber")
xal_PostBox = Class(name="xal_PostBox")
xal_Premise = Class(name="xal_Premise")
xal_LargeMailUser = Class(name="xal_LargeMailUser")
xal_PostalRoute = Class(name="xal_PostalRoute")
xal_ThoroughfareLeadingType = Class(name="xal_ThoroughfareLeadingType")
xal_ThoroughfareName = Class(name="xal_ThoroughfareName")
xal_ThoroughfareTrailingType = Class(name="xal_ThoroughfareTrailingType")
xal_ThoroughfarePostDirection = Class(name="xal_ThoroughfarePostDirection")
xal_DependentThoroughfare = Class(name="xal_DependentThoroughfare")
xal_ThoroughfarePreDirection = Class(name="xal_ThoroughfarePreDirection")
xal_EStringToStringMapEntry = Class(name="xal_EStringToStringMapEntry")
xal_DocumentRoot = Class(name="xal_DocumentRoot")
xal_ThoroughfareNumber = Class(name="xal_ThoroughfareNumber")
xal_ThoroughfareNumberPrefix = Class(name="xal_ThoroughfareNumberPrefix")
xal_ThoroughfareNumberSuffix = Class(name="xal_ThoroughfareNumberSuffix")
xal_PremiseNumber = Class(name="xal_PremiseNumber")
xal_PremiseNumberPrefix = Class(name="xal_PremiseNumberPrefix")
xal_PremiseNumberSuffix = Class(name="xal_PremiseNumberSuffix")
xal_Firm = Class(name="xal_Firm")
xal_FirmName = Class(name="xal_FirmName")
xal_Xal = Class(name="xal_Xal")
xal_EndorsementLineCode = Class(name="xal_EndorsementLineCode")
xal_KeyLineCode = Class(name="xal_KeyLineCode")
xal_LargeMailUserName = Class(name="xal_LargeMailUserName")
xal_LargeMailUserIdentifier = Class(name="xal_LargeMailUserIdentifier")
xal_LocalityName = Class(name="xal_LocalityName")
xal_MailStopName = Class(name="xal_MailStopName")
xal_MailStopNumber = Class(name="xal_MailStopNumber")
xal_PostTown = Class(name="xal_PostTown")
xal_PostalCodeNumber = Class(name="xal_PostalCodeNumber")
xal_PostalCodeNumberExtension = Class(name="xal_PostalCodeNumberExtension")
xal_PostalRouteName = Class(name="xal_PostalRouteName")
xal_PostalRouteNumber = Class(name="xal_PostalRouteNumber")
xal_SortingCode = Class(name="xal_SortingCode")
xal_PostBoxNumber = Class(name="xal_PostBoxNumber")
xal_SupplementaryPostalServiceData = Class(name="xal_SupplementaryPostalServiceData")
xal_PostBoxNumberPrefix = Class(name="xal_PostBoxNumberPrefix")
xal_PostBoxNumberSuffix = Class(name="xal_PostBoxNumberSuffix")
xal_PostBoxNumberExtension = Class(name="xal_PostBoxNumberExtension")
xal_PostOfficeName = Class(name="xal_PostOfficeName")
xal_PostOfficeNumber = Class(name="xal_PostOfficeNumber")
xal_PostTownName = Class(name="xal_PostTownName")
xal_PostTownSuffix = Class(name="xal_PostTownSuffix")
xal_PremiseLocation = Class(name="xal_PremiseLocation")
xal_PremiseNumberRange = Class(name="xal_PremiseNumberRange")
xal_PremiseName = Class(name="xal_PremiseName")
xal_SubPremise = Class(name="xal_SubPremise")
xal_PremiseNumberRangeFrom = Class(name="xal_PremiseNumberRangeFrom")
xal_PremiseNumberRangeTo = Class(name="xal_PremiseNumberRangeTo")
xal_SubAdministrativeAreaName = Class(name="xal_SubAdministrativeAreaName")
xal_SubPremiseName = Class(name="xal_SubPremiseName")
xal_SubPremiseLocation = Class(name="xal_SubPremiseLocation")
xal_SubPremiseNumberSuffix = Class(name="xal_SubPremiseNumberSuffix")
xal_SubPremiseNumber = Class(name="xal_SubPremiseNumber")
xal_SubPremiseNumberPrefix = Class(name="xal_SubPremiseNumberPrefix")
xal_ThoroughfareNumberRange = Class(name="xal_ThoroughfareNumberRange")
xal_ThoroughfareNumberFrom = Class(name="xal_ThoroughfareNumberFrom")
xal_ThoroughfareNumberTo = Class(name="xal_ThoroughfareNumberTo")
...
xal_Address.attributes={xal_Address_anyAttribute, xal_Address_mixed, xal_Address_type, xal_Address_code}
...
xal_AddressDetails.attributes={xal_AddressDetails_any, xal_AddressDetails_anyAttribute, xal_AddressDetails_code, xal_AddressDetails_addressDetailsKey, xal_AddressDetails_currentStatus, xal_AddressDetails_validFromDate, xal_AddressDetails_addressType, xal_AddressDetails_validToDate, xal_AddressDetails_usage}
...
xal_PostalServiceElements.attributes={xal_PostalServiceElements_type, xal_PostalServiceElements_anyAttribute, xal_PostalServiceElements_any}
...
xal_AdministrativeArea.attributes={xal_AdministrativeArea_indicator, xal_AdministrativeArea_any, xal_AdministrativeArea_anyAttribute, xal_AdministrativeArea_type, xal_AdministrativeArea_usageType}
...
xal_Locality.attributes={xal_Locality_indicator, xal_Locality_type, xal_Locality_usageType, xal_Locality_anyAttribute, xal_Locality_any}
...
xal_Thoroughfare.attributes={xal_Thoroughfare_dependentThoroughfaresType, xal_Thoroughfare_type, xal_Thoroughfare_dependentThoroughfaresConnector, xal_Thoroughfare_any, xal_Thoroughfare_dependentThoroughfares, xal_Thoroughfare_anyAttribute, xal_Thoroughfare_dependentThoroughfaresIndicator, xal_Thoroughfare_group}
...
xal_AddressLines.attributes={xal_AddressLines_anyAttribute, xal_AddressLines_any}
...
xal_AddressIdentifier.attributes={xal_AddressIdentifier_identifierType, xal_AddressIdentifier_anyAttribute, xal_AddressIdentifier_mixed, xal_AddressIdentifier_code, xal_AddressIdentifier_type}
...
xal_AddressLatitudeDirection.attributes={xal_AddressLatitudeDirection_type, xal_AddressLatitudeDirection_anyAttribute, xal_AddressLatitudeDirection_code, xal_AddressLatitudeDirection_mixed}
...
xal_AddressLatitude.attributes={xal_AddressLatitude_type, xal_AddressLatitude_anyAttribute, xal_AddressLatitude_mixed, xal_AddressLatitude_code}
...
xal_AddressLongitude.attributes={xal_AddressLongitude_type, xal_AddressLongitude_code, xal_AddressLongitude_mixed, xal_AddressLongitude_anyAttribute}
...
xal_AddressLine.attributes={xal_AddressLine_anyAttribute, xal_AddressLine_code, xal_AddressLine_type, xal_AddressLine_mixed}
...
xal_AdministrativeAreaName.attributes={xal_AdministrativeAreaName_anyAttribute, xal_AdministrativeAreaName_code, xal_AdministrativeAreaName_type, xal_AdministrativeAreaName_mixed}
...
xal_SubAdministrativeArea.attributes={xal_SubAdministrativeArea_any, xal_SubAdministrativeArea_type, xal_SubAdministrativeArea_anyAttribute, xal_SubAdministrativeArea_indicator, xal_SubAdministrativeArea_usageType}
...
xal_AddressLongitudeDirection.attributes={xal_AddressLongitudeDirection_mixed, xal_AddressLongitudeDirection_code, xal_AddressLongitudeDirection_anyAttribute, xal_AddressLongitudeDirection_type}
...
xal_PostOffice.attributes={xal_PostOffice_any, xal_PostOffice_indicator, xal_PostOffice_type, xal_PostOffice_anyAttribute}
...
xal_BuildingName.attributes={xal_BuildingName_anyAttribute, xal_BuildingName_type, xal_BuildingName_code, xal_BuildingName_typeOccurrence, xal_BuildingName_mixed}
...
xal_Barcode.attributes={xal_Barcode_code, xal_Barcode_mixed, xal_Barcode_anyAttribute, xal_Barcode_type}
...
xal_CountryNameCode.attributes={xal_CountryNameCode_scheme, xal_CountryNameCode_mixed, xal_CountryNameCode_code, xal_CountryNameCode_anyAttribute}
...
xal_CountryName.attributes={xal_CountryName_anyAttribute, xal_CountryName_code, xal_CountryName_mixed, xal_CountryName_type}
...
xal_Department.attributes={xal_Department_type, xal_Department_anyAttribute, xal_Department_any}
...
xal_DepartmentName.attributes={xal_DepartmentName_anyAttribute, xal_DepartmentName_type, xal_DepartmentName_code, xal_DepartmentName_mixed}
...
xal_MailStop.attributes={xal_MailStop_type, xal_MailStop_anyAttribute, xal_MailStop_any}
...
xal_DependentLocality.attributes={xal_DependentLocality_connector, xal_DependentLocality_indicator, xal_DependentLocality_anyAttribute, xal_DependentLocality_usageType, xal_DependentLocality_type, xal_DependentLocality_any}
...
xal_DependentLocalityName.attributes={xal_DependentLocalityName_anyAttribute, xal_DependentLocalityName_code, xal_DependentLocalityName_mixed, xal_DependentLocalityName_type}
...
xal_DependentLocalityNumber.attributes={xal_DependentLocalityNumber_mixed, xal_DependentLocalityNumber_nameNumberOccurrence, xal_DependentLocalityNumber_code, xal_DependentLocalityNumber_anyAttribute}
...
xal_PostBox.attributes={xal_PostBox_type, xal_PostBox_anyAttribute, xal_PostBox_any, xal_PostBox_indicator}
...
xal_Premise.attributes={xal_Premise_premiseDependencyType, xal_Premise_premiseThoroughfareConnector, xal_Premise_type, xal_Premise_premiseDependency, xal_Premise_any, xal_Premise_anyAttribute}
...
xal_PostalRoute.attributes={xal_PostalRoute_anyAttribute, xal_PostalRoute_any, xal_PostalRoute_type}
...
xal_ThoroughfareLeadingType.attributes={xal_ThoroughfareLeadingType_type, xal_ThoroughfareLeadingType_mixed, xal_ThoroughfareLeadingType_anyAttribute, xal_ThoroughfareLeadingType_code}
...
xal_ThoroughfareName.attributes={xal_ThoroughfareName_type, xal_ThoroughfareName_mixed, xal_ThoroughfareName_code, xal_ThoroughfareName_anyAttribute}
...
xal_ThoroughfareTrailingType.attributes={xal_ThoroughfareTrailingType_anyAttribute, xal_ThoroughfareTrailingType_code, xal_ThoroughfareTrailingType_type, xal_ThoroughfareTrailingType_mixed}
...
xal_ThoroughfarePostDirection.attributes={xal_ThoroughfarePostDirection_mixed, xal_ThoroughfarePostDirection_type, xal_ThoroughfarePostDirection_code, xal_ThoroughfarePostDirection_anyAttribute}
...
xal_DependentThoroughfare.attributes={xal_DependentThoroughfare_anyAttribute, xal_DependentThoroughfare_any, xal_DependentThoroughfare_type}
...
xal_ThoroughfarePreDirection.attributes={xal_ThoroughfarePreDirection_mixed, xal_ThoroughfarePreDirection_code, xal_ThoroughfarePreDirection_type, xal_ThoroughfarePreDirection_anyAttribute}
...
xal_ThoroughfareNumber.attributes={xal_ThoroughfareNumber_code, xal_ThoroughfareNumber_mixed, xal_ThoroughfareNumber_indicatorOccurrence, xal_ThoroughfareNumber_anyAttribute, xal_ThoroughfareNumber_type, xal_ThoroughfareNumber_numberOccurrence, xal_ThoroughfareNumber_numberType, xal_ThoroughfareNumber_indicator}
...
xal_ThoroughfareNumberPrefix.attributes={xal_ThoroughfareNumberPrefix_anyAttribute, xal_ThoroughfareNumberPrefix_numberPrefixSeparator, xal_ThoroughfareNumberPrefix_type, xal_ThoroughfareNumberPrefix_mixed, xal_ThoroughfareNumberPrefix_code}
...
xal_ThoroughfareNumberSuffix.attributes={xal_ThoroughfareNumberSuffix_type, xal_ThoroughfareNumberSuffix_mixed, xal_ThoroughfareNumberSuffix_code, xal_ThoroughfareNumberSuffix_anyAttribute, xal_ThoroughfareNumberSuffix_numberSuffixSeparator}
...
xal_PremiseNumber.attributes={xal_PremiseNumber_indicatorOccurrence, xal_PremiseNumber_numberType, xal_PremiseNumber_anyAttribute, xal_PremiseNumber_indicator, xal_PremiseNumber_mixed, xal_PremiseNumber_code, xal_PremiseNumber_type, xal_PremiseNumber_numberTypeOccurrence}
...
xal_PremiseNumberPrefix.attributes={xal_PremiseNumberPrefix_value, xal_PremiseNumberPrefix_numberPrefixSeparator, xal_PremiseNumberPrefix_anyAttribute, xal_PremiseNumberPrefix_code, xal_PremiseNumberPrefix_type}
...
xal_PremiseNumberSuffix.attributes={xal_PremiseNumberSuffix_type, xal_PremiseNumberSuffix_mixed, xal_PremiseNumberSuffix_code, xal_PremiseNumberSuffix_anyAttribute, xal_PremiseNumberSuffix_numberSuffixSeparator}
...
xal_Firm.attributes={xal_Firm_type, xal_Firm_any, xal_Firm_anyAttribute}
...
xal_FirmName.attributes={xal_FirmName_type, xal_FirmName_code, xal_FirmName_mixed, xal_FirmName_anyAttribute}
...
xal_Xal.attributes={xal_Xal_any, xal_Xal_anyAttribute, xal_Xal_version}
...
xal_EndorsementLineCode.attributes={xal_EndorsementLineCode_type, xal_EndorsementLineCode_anyAttribute, xal_EndorsementLineCode_mixed, xal_EndorsementLineCode_code}
...
xal_KeyLineCode.attributes={xal_KeyLineCode_mixed, xal_KeyLineCode_code, xal_KeyLineCode_anyAttribute, xal_KeyLineCode_type}
...
xal_LargeMailUserName.attributes={xal_LargeMailUserName_mixed, xal_LargeMailUserName_anyAttribute, xal_LargeMailUserName_type, xal_LargeMailUserName_code}
...
xal_LargeMailUserIdentifier.attributes={xal_LargeMailUserIdentifier_code, xal_LargeMailUserIdentifier_anyAttribute, xal_LargeMailUserIdentifier_mixed, xal_LargeMailUserIdentifier_indicator, xal_LargeMailUserIdentifier_type}
...
xal_LocalityName.attributes={xal_LocalityName_code, xal_LocalityName_anyAttribute, xal_LocalityName_mixed, xal_LocalityName_type}
...
xal_MailStopNumber.attributes={xal_MailStopNumber_code, xal_MailStopNumber_mixed, xal_MailStopNumber_anyAttribute, xal_MailStopNumber_nameNumberSeparator}
...
xal_PostalCodeNumber.attributes={xal_PostalCodeNumber_code, xal_PostalCodeNumber_type, xal_PostalCodeNumber_mixed, xal_PostalCodeNumber_anyAttribute}
...
xal_PostalCodeNumberExtension.attributes={xal_PostalCodeNumberExtension_numberExtensionSeparator, xal_PostalCodeNumberExtension_mixed, xal_PostalCodeNumberExtension_anyAttribute, xal_PostalCodeNumberExtension_type, xal_PostalCodeNumberExtension_code}
...
xal_PostalRouteName.attributes={xal_PostalRouteName_type, xal_PostalRouteName_code, xal_PostalRouteName_anyAttribute, xal_PostalRouteName_mixed}
...
xal_PostalRouteNumber.attributes={xal_PostalRouteNumber_code, xal_PostalRouteNumber_mixed, xal_PostalRouteNumber_anyAttribute}
...
xal_PostBoxNumber.attributes={xal_PostBoxNumber_mixed, xal_PostBoxNumber_anyAttribute, xal_PostBoxNumber_code}
...
xal_SupplementaryPostalServiceData.attributes={xal_SupplementaryPostalServiceData_mixed, xal_SupplementaryPostalServiceData_code, xal_SupplementaryPostalServiceData_anyAttribute, xal_SupplementaryPostalServiceData_type}
...
xal_PostBoxNumberPrefix.attributes={xal_PostBoxNumberPrefix_anyAttribute, xal_PostBoxNumberPrefix_numberPrefixSeparator, xal_PostBoxNumberPrefix_mixed, xal_PostBoxNumberPrefix_code}
...
xal_PostBoxNumberSuffix.attributes={xal_PostBoxNumberSuffix_numberSuffixSeparator, xal_PostBoxNumberSuffix_anyAttribute, xal_PostBoxNumberSuffix_code, xal_PostBoxNumberSuffix_mixed}
...
xal_PostBoxNumberExtension.attributes={xal_PostBoxNumberExtension_anyAttribute, xal_PostBoxNumberExtension_numberExtensionSeparator, xal_PostBoxNumberExtension_mixed}
...
xal_PostOfficeName.attributes={xal_PostOfficeName_anyAttribute, xal_PostOfficeName_type, xal_PostOfficeName_code, xal_PostOfficeName_mixed}
...
xal_PostOfficeNumber.attributes={xal_PostOfficeNumber_indicator, xal_PostOfficeNumber_indicatorOccurrence, xal_PostOfficeNumber_code, xal_PostOfficeNumber_mixed, xal_PostOfficeNumber_anyAttribute}
...
xal_PostTownName.attributes={xal_PostTownName_anyAttribute, xal_PostTownName_code, xal_PostTownName_mixed, xal_PostTownName_type}
...
xal_PostTownSuffix.attributes={xal_PostTownSuffix_mixed, xal_PostTownSuffix_anyAttribute, xal_PostTownSuffix_code}
...
xal_PremiseLocation.attributes={xal_PremiseLocation_mixed, xal_PremiseLocation_anyAttribute, xal_PremiseLocation_code}
...
xal_PremiseNumberRange.attributes={xal_PremiseNumberRange_indicatorOccurence, xal_PremiseNumberRange_type, xal_PremiseNumberRange_numberRangeOccurence, xal_PremiseNumberRange_indicator, xal_PremiseNumberRange_separator, xal_PremiseNumberRange_rangeType}
...
xal_PremiseName.attributes={xal_PremiseName_typeOccurrence, xal_PremiseName_type, xal_PremiseName_code, xal_PremiseName_anyAttribute, xal_PremiseName_mixed}
...
xal_SubPremise.attributes={xal_SubPremise_type, xal_SubPremise_anyAttribute, xal_SubPremise_any}
...
xal_SubAdministrativeAreaName.attributes={xal_SubAdministrativeAreaName_mixed, xal_SubAdministrativeAreaName_code, xal_SubAdministrativeAreaName_type, xal_SubAdministrativeAreaName_anyAttribute}
...
xal_SubPremiseName.attributes={xal_SubPremiseName_anyAttribute, xal_SubPremiseName_typeOccurrence, xal_SubPremiseName_code, xal_SubPremiseName_mixed, xal_SubPremiseName_type}
...
xal_SubPremiseLocation.attributes={xal_SubPremiseLocation_code, xal_SubPremiseLocation_mixed}
...
xal_SubPremiseNumberSuffix.attributes={xal_SubPremiseNumberSuffix_numberSuffixSeparator, xal_SubPremiseNumberSuffix_mixed, xal_SubPremiseNumberSuffix_code, xal_SubPremiseNumberSuffix_type, xal_SubPremiseNumberSuffix_anyAttribute}
...
xal_SubPremiseNumber.attributes={xal_SubPremiseNumber_anyAttribute, xal_SubPremiseNumber_premiseNumberSeparator, xal_SubPremiseNumber_code, xal_SubPremiseNumber_indicatorOccurrence, xal_SubPremiseNumber_type, xal_SubPremiseNumber_mixed, xal_SubPremiseNumber_numberTypeOccurrence, xal_SubPremiseNumber_indicator}
...
xal_SubPremiseNumberPrefix.attributes={xal_SubPremiseNumberPrefix_anyAttribute, xal_SubPremiseNumberPrefix_code, xal_SubPremiseNumberPrefix_mixed, xal_SubPremiseNumberPrefix_type, xal_SubPremiseNumberPrefix_numberPrefixSeparator}
...
xal_ThoroughfareNumberRange.attributes={xal_ThoroughfareNumberRange_code, xal_ThoroughfareNumberRange_numberRangeOccurrence, xal_ThoroughfareNumberRange_indicatorOccurrence, xal_ThoroughfareNumberRange_anyAttribute, xal_ThoroughfareNumberRange_type, xal_ThoroughfareNumberRange_rangeType, xal_ThoroughfareNumberRange_separator, xal_ThoroughfareNumberRange_indicator}
...
xal_ThoroughfareNumberFrom.attributes={xal_ThoroughfareNumberFrom_code, xal_ThoroughfareNumberFrom_anyAttribute, xal_ThoroughfareNumberFrom_mixed}
...
xal_ThoroughfareNumberTo.attributes={xal_ThoroughfareNumberTo_code, xal_ThoroughfareNumberTo_anyAttribute, xal_ThoroughfareNumberTo_mixed}
...
domain_model = DomainModel(
    name="xal",
    types={xal_Address, xal_AddressDetails, xal_PostalServiceElements, xal_Country, xal_AdministrativeArea, xal_Locality, xal_Thoroughfare, xal_AddressLines, xal_AddressIdentifier, xal_AddressLatitudeDirection, xal_AddressLatitude, xal_AddressLongitude, xal_AddressLine, xal_AdministrativeAreaName, xal_SubAdministrativeArea, xal_AddressLongitudeDirection, xal_PostOffice, xal_PostalCode, xal_BuildingName, xal_Barcode, xal_CountryNameCode, xal_CountryName, xal_Department, xal_DepartmentName, xal_MailStop, xal_DependentLocality, xal_DependentLocalityName, xal_DependentLocalityNumber, xal_PostBox, xal_Premise, xal_LargeMailUser, xal_PostalRoute, xal_ThoroughfareLeadingType, xal_ThoroughfareName, xal_ThoroughfareTrailingType, xal_ThoroughfarePostDirection, xal_DependentThoroughfare, xal_ThoroughfarePreDirection, xal_EStringToStringMapEntry, xal_DocumentRoot, xal_ThoroughfareNumber, xal_ThoroughfareNumberPrefix, xal_ThoroughfareNumberSuffix, xal_PremiseNumber, xal_PremiseNumberPrefix, xal_PremiseNumberSuffix, xal_Firm, xal_FirmName, xal_Xal, xal_EndorsementLineCode, xal_KeyLineCode, xal_LargeMailUserName, xal_LargeMailUserIdentifier, xal_LocalityName, xal_MailStopName, xal_MailStopNumber, xal_PostTown, xal_PostalCodeNumber, xal_PostalCodeNumberExtension, xal_PostalRouteName, xal_PostalRouteNumber, xal_SortingCode, xal_PostBoxNumber, xal_SupplementaryPostalServiceData, xal_PostBoxNumberPrefix, xal_PostBoxNumberSuffix, xal_PostBoxNumberExtension, xal_PostOfficeName, xal_PostOfficeNumber, xal_PostTownName, xal_PostTownSuffix, xal_PremiseLocation, xal_PremiseNumberRange, xal_PremiseName, xal_SubPremise, xal_PremiseNumberRangeFrom, xal_PremiseNumberRangeTo, xal_SubAdministrativeAreaName, xal_SubPremiseName, xal_SubPremiseLocation, xal_SubPremiseNumberSuffix, xal_SubPremiseNumber, xal_SubPremiseNumberPrefix, xal_ThoroughfareNumberRange, xal_ThoroughfareNumberFrom, xal_ThoroughfareNumberTo, DependentThoroughfaresType, IndicatorOccurence, IndicatorOccurrence4, IndicatorOccurrence, IndicatorOccurrence1, IndicatorOccurrence2, IndicatorOccurrence3, NameNumberOccurrence, NumberTypeOccurrence, NumberTypeOccurrence1, NumberTypeType, NumberTypeType1, NumberOccurrence, NumberRangeOccurence, NumberRangeOccurrence, RangeTypeType, TypeOccurrence, TypeOccurrence1, TypeOccurrence2},
    associations={postalServiceElements0, country5, administrativeArea7, locality9, thoroughfare11, address1, addressLines3, addressLine13, addressLine15, administrativeAreaName18, subAdministrativeArea20, locality22, postOffice25, postalCode27, administrativeArea36, locality39, thoroughfare42, addressLine29, countryNameCode32, countryName34, addressLine45, departmentName47, mailStop49, postalCode51, addressLine54, dependentLocalityName56, dependentLocalityNumber58, postBox60, thoroughfare69, premise72, dependentLocality75, postalCode77, largeMailUser62, postOffice64, postalRoute67, thoroughfareLeadingType84, thoroughfareName86, thoroughfareTrailingType88, thoroughfarePostDirection90, addressLine80, thoroughfarePreDirection82, xMLNSPrefixMap92, xSISchemaLocation93, addressDetails96, addressLine99, administrativeArea102, postalCode114, postBox117, postOffice120, premise123, countryName105, department108, locality111, thoroughfare132, thoroughfareNumber135, thoroughfareNumberPrefix137, thoroughfareNumberSuffix139, premiseNumber126, premiseNumberPrefix128, premiseNumberSuffix130, addressLine143, firmName145, department147, xAL141, mailStop150, postalCode153, largeMailUserName159, largeMailUserIdentifier161, buildingName163, department165, addressLine156, postBox168, thoroughfare171, postalCode174, addressLine177, localityName180, postBox182, largeMailUser185, postOffice188, dependentLocality200, postalCode203, postalRoute191, thoroughfare194, premise197, addressLine206, mailStopName209, mailStopNumber211, postTown220, addressLine213, postalCodeNumber216, postalCodeNumberExtension218, addressLine222, postalRouteName225, postalRouteNumber227, postBox229, keyLineCode236, barcode238, sortingCode240, addressLatitude242, addressLatitudeDirection244, addressIdentifier232, endorsementLineCode234, addressLine252, postBoxNumber255, addressLongitude246, addressLongitudeDirection248, supplementaryPostalServiceData250, firm263, postalCode266, postBoxNumberPrefix257, postBoxNumberSuffix259, postBoxNumberExtension261, addressLine269, postOfficeName272, postalCode282, postOfficeNumber274, postalRoute276, postBox279, addressLine285, postTownName288, postTownSuffix290, premiseLocation297, premiseNumber299, premiseNumberRange302, premiseNumberPrefix304, premiseNumberSuffix307, addressLine292, premiseName295, mailStop318, postalCode321, premise325, buildingName310, subPremise313, firm315, premiseNumberRangeFrom327, premiseNumberRangeTo329, premiseNumber337, premiseNumberSuffix340, addressLine343, premiseNumberPrefix346, addressLine331, premiseNumberPrefix334, premiseNumber349, premiseNumberSuffix352, locality360, postOffice363, postalCode366, addressLine355, subAdministrativeAreaName358, addressLine369, subPremiseName372, subPremiseLocation374, subPremiseNumberSuffix380, buildingName382, firm385, mailStop388, postalCode391, subPremiseNumber376, subPremiseNumberPrefix378, subPremise395, addressLine397, thoroughfareTrailingType420, thoroughfareNumberPrefix405, thoroughfareNumberSuffix408, thoroughfarePreDirection411, thoroughfareLeadingType414, thoroughfareNumber400, thoroughfareName417, thoroughfareNumberRange403, postalCode438, thoroughfarePostDirection423, dependentThoroughfare426, dependentLocality429, premise432, firm435, addressLine441, thoroughfareNumberPrefix443, thoroughfareNumber446, thoroughfareNumberSuffix449, thoroughfareNumberTo458, addressLine452, thoroughfareNumberFrom455, addressLine460, thoroughfareNumberPrefix463, thoroughfareNumber466, thoroughfareNumberSuffix469, addressDetails472},
    generalizations={},
    metadata=None
)
