...
public class xal_ThoroughfareNumberSuffix  {
    ...
    public xal_ThoroughfareNumberSuffix(
        String numberSuffixSeparator,        String anyAttribute,        String mixed,        String code,        String type    ) {
