...
class xal_PostBoxNumberSuffix:
    ...
    def __init__(self, numberSuffixSeparator: str, anyAttribute: str, mixed: str, code: str, xal_PostBoxNumberSuffix: "xal_PostBox" = None):
    ...
    @property
    def numberSuffixSeparator(self):
...
class xal_PostBoxNumberPrefix:
    ...
    def __init__(self, mixed: str, code: str, numberPrefixSeparator: str, anyAttribute: str, xal_PostBoxNumberPrefix: "xal_PostBox" = None):
        ...
        pass
    @property
    def numberPrefixSeparator(self):
...
class xal_SupplementaryPostalServiceData:
    ...
    def __init__(self, type: str, anyAttribute: str, mixed: str, code: str, xal_SupplementaryPostalServiceData: "xal_PostalServiceElements" = None):
        self.type = type
        self.anyAttribute = anyAttribute
        self.mixed = mixed
        self.code = code
...
class xal_PostalRouteNumber:
    ...
    def __init__(self, mixed: str, code: str, anyAttribute: str, xal_PostalRouteNumber: "xal_PostalRoute" = None):
        self.mixed = mixed
        self.code = code
        self.anyAttribute = anyAttribute
...
class xal_PostalCodeNumberExtension:
    ...
    def __init__(self, numberExtensionSeparator: str, type: str, anyAttribute: str, mixed: str, code: str, xal_PostalCodeNumberExtension: "xal_PostalCode" = None):
    ...
    @property
    def numberExtensionSeparator(self):
...
class xal_PostalCodeNumber:
    ...
    def __init__(self, mixed: str, code: str, type: str, anyAttribute: str, xal_PostalCodeNumber: "xal_PostalCode" = None):
        self.mixed = mixed
        self.code = code
        self.type = type
        self.anyAttribute = anyAttribute
...
class xal_PostTown:
    ...
    def __init__(self, type: str, anyAttribute: str, xal_PostTown286: set["xal_AddressLine"] = None, xal_PostTown289: set["xal_PostTownName"] = None, xal_PostTown291: "xal_PostTownSuffix" = None, xal_PostTown: "xal_PostalCode" = None):
        self.type = type
        self.anyAttribute = anyAttribute
...
class xal_MailStopName:
    ...
    def __init__(self, anyAttribute: str, mixed: str, code: str, type: str, xal_MailStopName: "xal_MailStop" = None):
        self.anyAttribute = anyAttribute
        self.mixed = mixed
        self.code = code
        self.type = type
...
class xal_LargeMailUserIdentifier:
    ...
    def __init__(self, mixed: str, code: str, indicator: str, type: str, anyAttribute: str, xal_LargeMailUserIdentifier: "xal_LargeMailUser" = None):
        self.mixed = mixed
        self.code = code
...
class xal_Xal:
    ...
    def __init__(self, any: str, version: str, anyAttribute: str, xal_Xal: "xal_DocumentRoot" = None, xal_Xal473: set["xal_AddressDetails"] = None):
        self.any = any
...
class xal_Firm:
    ...
    def __init__(self, anyAttribute: str, any: str, type: str, xal_Firm: set["xal_AddressLine"] = None, xal_Firm146: set["xal_FirmName"] = None, xal_Firm148: set["xal_Department"] = None, xal_Firm151: "xal_MailStop" = None, xal_Firm154: "xal_PostalCode" = None, xal_Firm265: "xal_PostBox" = None, xal_Firm317: "xal_Premise" = None, xal_Firm387: "xal_SubPremise" = None, xal_Firm437: "xal_Thoroughfare" = None):
        self.anyAttribute = anyAttribute
        self.any = any
        self.type = type
...
class xal_PremiseNumberSuffix:
    ...
    def __init__(self, code: str, numberSuffixSeparator: str, type: str, anyAttribute: str, mixed: str, xal_PremiseNumberSuffix: "xal_DocumentRoot" = None, xal_PremiseNumberSuffix309: "xal_Premise" = None, xal_PremiseNumberSuffix342: "xal_PremiseNumberRangeFrom" = None, xal_PremiseNumberSuffix354: "xal_PremiseNumberRangeTo" = None):
        self.code = code
        self.numberSuffixSeparator = numberSuffixSeparator
        self.type = type
        self.anyAttribute = anyAttribute
...
class xal_PremiseNumberPrefix:
    ...
    def __init__(self, value: str, code: str, numberPrefixSeparator: str, type: str, anyAttribute: str, xal_PremiseNumberPrefix: "xal_DocumentRoot" = None, xal_PremiseNumberPrefix306: "xal_Premise" = None, xal_PremiseNumberPrefix348: "xal_PremiseNumberRangeTo" = None, xal_PremiseNumberPrefix336: "xal_PremiseNumberRangeFrom" = None):
        self.value = value
        self.code = code
        self.numberPrefixSeparator = numberPrefixSeparator
        self.type = type
...
class xal_PremiseNumber:
    ...
    def __init__(self, indicator: str, indicatorOccurrence: str, numberType: str, numberTypeOccurrence: str, type: str, anyAttribute: str, mixed: str, code: str, xal_PremiseNumber: "xal_DocumentRoot" = None, xal_PremiseNumber301: "xal_Premise" = None, xal_PremiseNumber339: "xal_PremiseNumberRangeFrom" = None, xal_PremiseNumber351: "xal_PremiseNumberRangeTo" = None):
        self.indicator = indicator
...
class xal_ThoroughfareNumberPrefix:
    ...
    def __init__(self, mixed: str, code: str, numberPrefixSeparator: str, type: str, anyAttribute: str, xal_ThoroughfareNumberPrefix: "xal_DocumentRoot" = None, xal_ThoroughfareNumberPrefix407: "xal_Thoroughfare" = None, xal_ThoroughfareNumberPrefix445: "xal_ThoroughfareNumberFrom" = None, xal_ThoroughfareNumberPrefix465: "xal_ThoroughfareNumberTo" = None):
        self.mixed = mixed
        self.code = code
        self.numberPrefixSeparator = numberPrefixSeparator
        self.type = type
...
class xal_ThoroughfareNumber:
    ...
    def __init__(self, numberOccurrence: str, numberType: str, mixed: str, code: str, indicator: str, indicatorOccurrence: str, type: str, anyAttribute: str, xal_ThoroughfareNumber: "xal_DocumentRoot" = None, xal_ThoroughfareNumber402: "xal_Thoroughfare" = None, xal_ThoroughfareNumber448: "xal_ThoroughfareNumberFrom" = None, xal_ThoroughfareNumber468: "xal_ThoroughfareNumberTo" = None):
...
class xal_ThoroughfareTrailingType:
    ...
    def __init__(self, anyAttribute: str, mixed: str, code: str, type: str, xal_ThoroughfareTrailingType: "xal_DependentThoroughfare" = None, xal_ThoroughfareTrailingType422: "xal_Thoroughfare" = None):
        self.anyAttribute = anyAttribute
        self.mixed = mixed
        self.code = code
        self.type = type
...
class xal_ThoroughfareLeadingType:
    ...
    def __init__(self, mixed: str, code: str, type: str, anyAttribute: str, xal_ThoroughfareLeadingType: "xal_DependentThoroughfare" = None, xal_ThoroughfareLeadingType416: "xal_Thoroughfare" = None):
        self.mixed = mixed
        self.code = code
        self.type = type
        self.anyAttribute = anyAttribute
...
class xal_PostalRoute:
    ...
    def __init__(self, anyAttribute: str, any: str, type: str, xal_PostalRoute: "xal_DependentLocality" = None, xal_PostalRoute193: "xal_Locality" = None, xal_PostalRoute278: "xal_PostOffice" = None, xal_PostalRoute223: set["xal_AddressLine"] = None, xal_PostalRoute226: set["xal_PostalRouteName"] = None, xal_PostalRoute228: "xal_PostalRouteNumber" = None, xal_PostalRoute230: "xal_PostBox" = None):
        self.anyAttribute = anyAttribute
        self.any = any
        self.type = type
...
class xal_LargeMailUser:
    ...
    def __init__(self, type: str, anyAttribute: str, any: str, xal_LargeMailUser: "xal_DependentLocality" = None, xal_LargeMailUser157: set["xal_AddressLine"] = None, xal_LargeMailUser169: "xal_PostBox" = None, xal_LargeMailUser172: "xal_Thoroughfare" = None, xal_LargeMailUser175: "xal_PostalCode" = None, xal_LargeMailUser187: "xal_Locality" = None, xal_LargeMailUser160: set["xal_LargeMailUserName"] = None, xal_LargeMailUser162: "xal_LargeMailUserIdentifier" = None, xal_LargeMailUser164: set["xal_BuildingName"] = None, xal_LargeMailUser166: "xal_Department" = None):
        self.type = type
        self.anyAttribute = anyAttribute
        self.any = any
...
class xal_Premise:
    ...
    def __init__(self, any: str, premiseDependency: str, premiseDependencyType: str, premiseThoroughfareConnector: str, type: str, anyAttribute: str, xal_Premise125: "xal_DocumentRoot" = None, xal_Premise: "xal_DependentLocality" = None, xal_Premise298: "xal_PremiseLocation" = None, xal_Premise300: set["xal_PremiseNumber"] = None, xal_Premise303: "xal_PremiseNumberRange" = None, xal_Premise305: set["xal_PremiseNumberPrefix"] = None, xal_Premise308: set["xal_PremiseNumberSuffix"] = None, xal_Premise293: set["xal_AddressLine"] = None, xal_Premise199: "xal_Locality" = None, xal_Premise296: set["xal_PremiseName"] = None, xal_Premise319: "xal_MailStop" = None, xal_Premise322: "xal_PostalCode" = None, xal_Premise326: "xal_Premise" = None, xal_Premise324: "xal_Premise" = None, xal_Premise311: set["xal_BuildingName"] = None, xal_Premise314: set["xal_SubPremise"] = None, xal_Premise316: "xal_Firm" = None, xal_Premise434: "xal_Thoroughfare" = None):
        self.any = any
        ...
        pass
    @property
    def premiseThoroughfareConnector(self):
    ...
    @property
    def premiseDependencyType(self):
...
class xal_PostBox:
    ...
    def __init__(self, any: str, indicator: str, type: str, anyAttribute: str, xal_PostBox119: "xal_DocumentRoot" = None, xal_PostBox: "xal_DependentLocality" = None, xal_PostBox170: "xal_LargeMailUser" = None, xal_PostBox184: "xal_Locality" = None, xal_PostBox281: "xal_PostOffice" = None, xal_PostBox231: "xal_PostalRoute" = None, xal_PostBox253: set["xal_AddressLine"] = None, xal_PostBox256: "xal_PostBoxNumber" = None, xal_PostBox264: "xal_Firm" = None, xal_PostBox267: "xal_PostalCode" = None, xal_PostBox258: "xal_PostBoxNumberPrefix" = None, xal_PostBox260: "xal_PostBoxNumberSuffix" = None, xal_PostBox262: "xal_PostBoxNumberExtension" = None):
        self.any = any
        self.indicator = indicator
        self.type = type
        self.anyAttribute = anyAttribute
...
class xal_DependentLocalityName:
    ...
    def __init__(self, mixed: str, code: str, type: str, anyAttribute: str, xal_DependentLocalityName: "xal_DependentLocality" = None):
        self.mixed = mixed
        self.code = code
        self.type = type
        self.anyAttribute = anyAttribute
...
class xal_DependentLocality:
    ...
    def __init__(self, any: str, anyAttribute: str, connector: str, indicator: str, type: str, usageType: str, xal_DependentLocality63: "xal_LargeMailUser" = None, xal_DependentLocality65: "xal_PostOffice" = None, xal_DependentLocality68: "xal_PostalRoute" = None, xal_DependentLocality: set["xal_AddressLine"] = None, xal_DependentLocality57: set["xal_DependentLocalityName"] = None, xal_DependentLocality59: "xal_DependentLocalityNumber" = None, xal_DependentLocality61: "xal_PostBox" = None, xal_DependentLocality70: "xal_Thoroughfare" = None, xal_DependentLocality73: "xal_Premise" = None, xal_DependentLocality76: "xal_DependentLocality" = None, xal_DependentLocality74: "xal_DependentLocality" = None, xal_DependentLocality78: "xal_PostalCode" = None, xal_DependentLocality202: "xal_Locality" = None, xal_DependentLocality431: "xal_Thoroughfare" = None):
        self.any = any
        self.anyAttribute = anyAttribute
...
class xal_MailStop:
    ...
    def __init__(self, any: str, type: str, anyAttribute: str, xal_MailStop: "xal_Department" = None, xal_MailStop152: "xal_Firm" = None, xal_MailStop207: set["xal_AddressLine"] = None, xal_MailStop210: "xal_MailStopName" = None, xal_MailStop212: "xal_MailStopNumber" = None, xal_MailStop390: "xal_SubPremise" = None, xal_MailStop320: "xal_Premise" = None):
        self.any = any
        self.type = type
        self.anyAttribute = anyAttribute
...
class xal_DepartmentName:
    ...
    def __init__(self, anyAttribute: str, mixed: str, code: str, type: str, xal_DepartmentName: "xal_Department" = None):
        self.anyAttribute = anyAttribute
        self.mixed = mixed
        self.code = code
        self.type = type
...
class xal_Department:
    ...
    def __init__(self, any: str, type: str, anyAttribute: str, xal_Department110: "xal_DocumentRoot" = None, xal_Department: set["xal_AddressLine"] = None, xal_Department48: set["xal_DepartmentName"] = None, xal_Department50: "xal_MailStop" = None, xal_Department52: "xal_PostalCode" = None, xal_Department149: "xal_Firm" = None, xal_Department167: "xal_LargeMailUser" = None):
        self.any = any
        self.type = type
        self.anyAttribute = anyAttribute
...
class xal_CountryName:
    ...
    def __init__(self, mixed: str, code: str, type: str, anyAttribute: str, xal_CountryName107: "xal_DocumentRoot" = None, xal_CountryName: "xal_Country" = None):
        self.mixed = mixed
        self.code = code
        self.type = type
        self.anyAttribute = anyAttribute
...
class xal_Barcode:
    ...
    def __init__(self, anyAttribute: str, mixed: str, code: str, type: str, xal_Barcode: "xal_PostalServiceElements" = None):
        self.anyAttribute = anyAttribute
        self.mixed = mixed
        self.code = code
        self.type = type
...
class xal_PostalCode:
    ...
    def __init__(self, any: str, type: str, anyAttribute: str, xal_PostalCode116: "xal_DocumentRoot" = None, xal_PostalCode: "xal_AdministrativeArea" = None, xal_PostalCode53: "xal_Department" = None, xal_PostalCode79: "xal_DependentLocality" = None, xal_PostalCode176: "xal_LargeMailUser" = None, xal_PostalCode205: "xal_Locality" = None, xal_PostalCode155: "xal_Firm" = None, xal_PostalCode284: "xal_PostOffice" = None, xal_PostalCode221: "xal_PostTown" = None, xal_PostalCode214: set["xal_AddressLine"] = None, xal_PostalCode217: set["xal_PostalCodeNumber"] = None, xal_PostalCode219: set["xal_PostalCodeNumberExtension"] = None, xal_PostalCode268: "xal_PostBox" = None, xal_PostalCode393: "xal_SubPremise" = None, xal_PostalCode323: "xal_Premise" = None, xal_PostalCode368: "xal_SubAdministrativeArea" = None, xal_PostalCode440: "xal_Thoroughfare" = None):
        self.any = any
        self.type = type
        self.anyAttribute = anyAttribute
...
class xal_PostOffice:
    ...
    def __init__(self, any: str, indicator: str, type: str, anyAttribute: str, xal_PostOffice66: "xal_DependentLocality" = None, xal_PostOffice122: "xal_DocumentRoot" = None, xal_PostOffice: "xal_AdministrativeArea" = None, xal_PostOffice190: "xal_Locality" = None, xal_PostOffice273: set["xal_PostOfficeName"] = None, xal_PostOffice283: "xal_PostalCode" = None, xal_PostOffice275: "xal_PostOfficeNumber" = None, xal_PostOffice277: "xal_PostalRoute" = None, xal_PostOffice280: "xal_PostBox" = None, xal_PostOffice270: set["xal_AddressLine"] = None, xal_PostOffice365: "xal_SubAdministrativeArea" = None):
        self.any = any
        self.indicator = indicator
        self.type = type
        self.anyAttribute = anyAttribute
...
class xal_AddressLongitudeDirection:
    ...
    def __init__(self, type: str, anyAttribute: str, mixed: str, code: str, xal_AddressLongitudeDirection: "xal_PostalServiceElements" = None):
        self.type = type
        self.anyAttribute = anyAttribute
        self.mixed = mixed
        self.code = code
...
class xal_SubAdministrativeArea:
    ...
    def __init__(self, any: str, indicator: str, type: str, usageType: str, anyAttribute: str, xal_SubAdministrativeArea: "xal_AdministrativeArea" = None, xal_SubAdministrativeArea361: "xal_Locality" = None, xal_SubAdministrativeArea364: "xal_PostOffice" = None, xal_SubAdministrativeArea367: "xal_PostalCode" = None, xal_SubAdministrativeArea356: set["xal_AddressLine"] = None, xal_SubAdministrativeArea359: set["xal_SubAdministrativeAreaName"] = None):
        self.any = any
        self.indicator = indicator
        self.type = type
        self.usageType = usageType
...
class xal_AddressLine:
    ...
    def __init__(self, mixed: str, code: str, type: str, anyAttribute: str, xal_AddressLine81: "xal_DependentThoroughfare" = None, xal_AddressLine101: "xal_DocumentRoot" = None, xal_AddressLine: "xal_AddressLines" = None, xal_AddressLine17: "xal_AdministrativeArea" = None, xal_AddressLine31: "xal_Country" = None, xal_AddressLine46: "xal_Department" = None, xal_AddressLine55: "xal_DependentLocality" = None, xal_AddressLine158: "xal_LargeMailUser" = None, xal_AddressLine179: "xal_Locality" = None, xal_AddressLine144: "xal_Firm" = None, xal_AddressLine287: "xal_PostTown" = None, xal_AddressLine294: "xal_Premise" = None, xal_AddressLine208: "xal_MailStop" = None, xal_AddressLine215: "xal_PostalCode" = None, xal_AddressLine224: "xal_PostalRoute" = None, xal_AddressLine254: "xal_PostBox" = None, xal_AddressLine271: "xal_PostOffice" = None, xal_AddressLine399: "xal_Thoroughfare" = None, xal_AddressLine345: "xal_PremiseNumberRangeTo" = None, xal_AddressLine333: "xal_PremiseNumberRangeFrom" = None, xal_AddressLine357: "xal_SubAdministrativeArea" = None, xal_AddressLine371: "xal_SubPremise" = None, xal_AddressLine442: "xal_ThoroughfareNumberFrom" = None, xal_AddressLine454: "xal_ThoroughfareNumberRange" = None, xal_AddressLine462: "xal_ThoroughfareNumberTo" = None):
        self.mixed = mixed
        self.code = code
        self.type = type
        self.anyAttribute = anyAttribute
...
class xal_AddressLatitude:
    ...
    def __init__(self, type: str, anyAttribute: str, mixed: str, code: str, xal_AddressLatitude: "xal_PostalServiceElements" = None):
        self.type = type
        self.anyAttribute = anyAttribute
        self.mixed = mixed
        self.code = code
...
class xal_AddressIdentifier:
    ...
    def __init__(self, mixed: str, code: str, identifierType: str, type: str, anyAttribute: str, xal_AddressIdentifier: "xal_PostalServiceElements" = None):
        self.mixed = mixed
        self.code = code
...
class xal_AddressLines:
    ...
    def __init__(self, any: str, anyAttribute: str, xal_AddressLines: "xal_AddressDetails" = None, xal_AddressLines14: set["xal_AddressLine"] = None):
        self.any = any
        self.anyAttribute = anyAttribute
...
class xal_Thoroughfare:
    ...
    def __init__(self, group: str, any: str, dependentThoroughfares: str, dependentThoroughfaresConnector: str, dependentThoroughfaresIndicator: str, dependentThoroughfaresType: str, type: str, anyAttribute: str, xal_Thoroughfare: "xal_AddressDetails" = None, xal_Thoroughfare44: "xal_Country" = None, xal_Thoroughfare71: "xal_DependentLocality" = None, xal_Thoroughfare173: "xal_LargeMailUser" = None, xal_Thoroughfare196: "xal_Locality" = None, xal_Thoroughfare134: "xal_DocumentRoot" = None, xal_Thoroughfare398: set["xal_AddressLine"] = None, xal_Thoroughfare421: "xal_ThoroughfareTrailingType" = None, xal_Thoroughfare406: set["xal_ThoroughfareNumberPrefix"] = None, xal_Thoroughfare409: set["xal_ThoroughfareNumberSuffix"] = None, xal_Thoroughfare412: "xal_ThoroughfarePreDirection" = None, xal_Thoroughfare415: "xal_ThoroughfareLeadingType" = None, xal_Thoroughfare401: set["xal_ThoroughfareNumber"] = None, xal_Thoroughfare418: set["xal_ThoroughfareName"] = None, xal_Thoroughfare404: set["xal_ThoroughfareNumberRange"] = None, xal_Thoroughfare439: "xal_PostalCode" = None, xal_Thoroughfare424: "xal_ThoroughfarePostDirection" = None, xal_Thoroughfare427: "xal_DependentThoroughfare" = None, xal_Thoroughfare430: "xal_DependentLocality" = None, xal_Thoroughfare433: "xal_Premise" = None, xal_Thoroughfare436: "xal_Firm" = None):
        self.group = group
        self.any = any
        ...
        pass
    @property
    def dependentThoroughfaresConnector(self):
    ...
    @property
    def dependentThoroughfaresType(self):
    ...
    @property
    def dependentThoroughfares(self):
    ...
    @property
    def dependentThoroughfaresIndicator(self):
...
class xal_Locality:
    ...
    def __init__(self, any: str, indicator: str, type: str, usageType: str, anyAttribute: str, xal_Locality113: "xal_DocumentRoot" = None, xal_Locality: "xal_AddressDetails" = None, xal_Locality24: "xal_AdministrativeArea" = None, xal_Locality41: "xal_Country" = None, xal_Locality178: set["xal_AddressLine"] = None, xal_Locality181: set["xal_LocalityName"] = None, xal_Locality183: "xal_PostBox" = None, xal_Locality186: "xal_LargeMailUser" = None, xal_Locality189: "xal_PostOffice" = None, xal_Locality201: "xal_DependentLocality" = None, xal_Locality204: "xal_PostalCode" = None, xal_Locality192: "xal_PostalRoute" = None, xal_Locality195: "xal_Thoroughfare" = None, xal_Locality198: "xal_Premise" = None, xal_Locality362: "xal_SubAdministrativeArea" = None):
        self.any = any
        self.indicator = indicator
        self.type = type
        self.usageType = usageType
...
class xal_AdministrativeArea:
    ...
    def __init__(self, any: str, indicator: str, type: str, usageType: str, anyAttribute: str, xal_AdministrativeArea104: "xal_DocumentRoot" = None, xal_AdministrativeArea: "xal_AddressDetails" = None, xal_AdministrativeArea16: set["xal_AddressLine"] = None, xal_AdministrativeArea19: set["xal_AdministrativeAreaName"] = None, xal_AdministrativeArea21: "xal_SubAdministrativeArea" = None, xal_AdministrativeArea23: "xal_Locality" = None, xal_AdministrativeArea26: "xal_PostOffice" = None, xal_AdministrativeArea28: "xal_PostalCode" = None, xal_AdministrativeArea38: "xal_Country" = None):
        self.any = any
        self.indicator = indicator
        self.type = type
        self.usageType = usageType
...
class xal_Country:
    ...
    def __init__(self, any: str, anyAttribute: str, xal_Country: "xal_AddressDetails" = None, xal_Country37: "xal_AdministrativeArea" = None, xal_Country40: "xal_Locality" = None, xal_Country43: "xal_Thoroughfare" = None, xal_Country30: set["xal_AddressLine"] = None, xal_Country33: set["xal_CountryNameCode"] = None, xal_Country35: set["xal_CountryName"] = None):
        self.any = any
        self.anyAttribute = anyAttribute
...
class xal_AddressDetails:
    ...
    def __init__(self, any: str, addressDetailsKey: str, validFromDate: str, validToDate: str, anyAttribute: str, addressType: str, code: str, currentStatus: str, usage: str, xal_AddressDetails98: "xal_DocumentRoot" = None, xal_AddressDetails: "xal_PostalServiceElements" = None, xal_AddressDetails6: "xal_Country" = None, xal_AddressDetails8: "xal_AdministrativeArea" = None, xal_AddressDetails10: "xal_Locality" = None, xal_AddressDetails12: "xal_Thoroughfare" = None, xal_AddressDetails2: "xal_Address" = None, xal_AddressDetails4: "xal_AddressLines" = None, xal_AddressDetails474: "xal_Xal" = None):
        self.any = any
...
class xal_ThoroughfareNumberFrom:
    ...
    def __init__(self, code: str, anyAttribute: str, mixed: str, xal_ThoroughfareNumberFrom: set["xal_AddressLine"] = None, xal_ThoroughfareNumberFrom444: set["xal_ThoroughfareNumberPrefix"] = None, xal_ThoroughfareNumberFrom447: set["xal_ThoroughfareNumber"] = None, xal_ThoroughfareNumberFrom450: set["xal_ThoroughfareNumberSuffix"] = None, xal_ThoroughfareNumberFrom457: "xal_ThoroughfareNumberRange" = None):
        self.code = code
        self.anyAttribute = anyAttribute
        self.mixed = mixed
...
class xal_ThoroughfareNumberRange:
    ...
    @property
    def numberRangeOccurrence(self):
...
class xal_SubPremiseNumber:
    ...
    def __init__(self, numberTypeOccurrence: str, premiseNumberSeparator: str, type: str, anyAttribute: str, mixed: str, code: str, indicator: str, indicatorOccurrence: str, xal_SubPremiseNumber: "xal_SubPremise" = None):
        self.numberTypeOccurrence = numberTypeOccurrence
    ...
    @property
    def premiseNumberSeparator(self):
...
class xal_SubPremiseLocation:
    ...
    def __init__(self, mixed: str, code: str, xal_SubPremiseLocation: "xal_SubPremise" = None):
        self.mixed = mixed
        self.code = code
...
class xal_SubPremiseName:
    ...
    def __init__(self, mixed: str, code: str, type: str, typeOccurrence: str, anyAttribute: str, xal_SubPremiseName: "xal_SubPremise" = None):
        self.mixed = mixed
        self.code = code
        self.type = type
        self.typeOccurrence = typeOccurrence
...
class xal_SubAdministrativeAreaName:
    ...
    def __init__(self, code: str, type: str, anyAttribute: str, mixed: str, xal_SubAdministrativeAreaName: "xal_SubAdministrativeArea" = None):
        self.code = code
        self.type = type
        self.anyAttribute = anyAttribute
        self.mixed = mixed
...
class xal_SubPremise:
    ...
    def __init__(self, any: str, type: str, anyAttribute: str, xal_SubPremise389: "xal_MailStop" = None, xal_SubPremise392: "xal_PostalCode" = None, xal_SubPremise377: set["xal_SubPremiseNumber"] = None, xal_SubPremise379: set["xal_SubPremiseNumberPrefix"] = None, xal_SubPremise396: "xal_SubPremise" = None, xal_SubPremise394: "xal_SubPremise" = None, xal_SubPremise: "xal_Premise" = None, xal_SubPremise370: set["xal_AddressLine"] = None, xal_SubPremise373: set["xal_SubPremiseName"] = None, xal_SubPremise375: "xal_SubPremiseLocation" = None, xal_SubPremise381: set["xal_SubPremiseNumberSuffix"] = None, xal_SubPremise383: set["xal_BuildingName"] = None, xal_SubPremise386: "xal_Firm" = None):
        self.any = any
        self.type = type
        self.anyAttribute = anyAttribute
...
class xal_PremiseName:
    ...
    def __init__(self, mixed: str, code: str, type: str, typeOccurrence: str, anyAttribute: str, xal_PremiseName: "xal_Premise" = None):
        self.mixed = mixed
        self.code = code
        self.type = type
        self.typeOccurrence = typeOccurrence
...
class xal_PremiseNumberRange:
    ...
    def __init__(self, indicator: str, indicatorOccurence: str, numberRangeOccurence: str, rangeType: str, separator: str, type: str, xal_PremiseNumberRange: "xal_Premise" = None, xal_PremiseNumberRange328: "xal_PremiseNumberRangeFrom" = None, xal_PremiseNumberRange330: "xal_PremiseNumberRangeTo" = None):
        self.indicator = indicator
...
class xal_PostOfficeNumber:
    ...
    def __init__(self, indicator: str, indicatorOccurrence: str, anyAttribute: str, mixed: str, code: str, xal_PostOfficeNumber: "xal_PostOffice" = None):
        self.indicator = indicator
        self.indicatorOccurrence = indicatorOccurrence
        self.anyAttribute = anyAttribute
        self.mixed = mixed
...
class xal_PostBoxNumberExtension:
    ...
    def __init__(self, numberExtensionSeparator: str, anyAttribute: str, mixed: str, xal_PostBoxNumberExtension: "xal_PostBox" = None):
        self.numberExtensionSeparator = numberExtensionSeparator
        self.anyAttribute = anyAttribute
        self.mixed = mixed
