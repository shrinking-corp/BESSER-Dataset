...
class iritpdl_ResourceConf:
    ...
    def __init__(self, name: str, ResourceConf: "iritpdl_WorkDefinition" = None, ResourceConf21: "iritpdl_Resource" = None, resourceConf: "iritpdl_WorkDefinition" = None, resourceConf25: set["iritpdl_Resource"] = None):
        self.name = name
...
class iritpdl_WorkDefinition(ProcessElement):
    ...
    def __init__(self, name: str, minTime: int, maxTime: int, successor: set["iritpdl_WorkSequence"] = None, predecessor: set["iritpdl_WorkSequence"] = None, workDefinition: set["iritpdl_ResourceConf"] = None, parent: set["iritpdl_ProcessElement"] = None, WorkDefinition23: "iritpdl_ResourceConf" = None, WorkDefinition: "iritpdl_WorkSequence" = None, WorkDefinition12: "iritpdl_WorkSequence" = None, WorkDefinition17: "iritpdl_ProcessElement" = None):
        self.name = name
