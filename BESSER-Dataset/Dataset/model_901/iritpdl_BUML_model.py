...
# Classes
iritpdl_Process = Class(name="iritpdl_Process")
iritpdl_ProcessElement = Class(name="iritpdl_ProcessElement")
iritpdl_Guidance = Class(name="iritpdl_Guidance")
iritpdl_ResourceType = Class(name="iritpdl_ResourceType")
iritpdl_WorkDefinition = Class(name="iritpdl_WorkDefinition")
ProcessElement = Class(name="ProcessElement")
iritpdl_WorkSequence = Class(name="iritpdl_WorkSequence")
iritpdl_ResourceConf = Class(name="iritpdl_ResourceConf")
iritpdl_Resource = Class(name="iritpdl_Resource")
...
iritpdl_Process.attributes={iritpdl_Process_maxTime, iritpdl_Process_minTime, iritpdl_Process_name}
...
iritpdl_WorkDefinition.attributes={iritpdl_WorkDefinition_minTime, iritpdl_WorkDefinition_name, iritpdl_WorkDefinition_maxTime}
...
domain_model = DomainModel(
    name="iritpdl",
    types={iritpdl_Process, iritpdl_ProcessElement, iritpdl_Guidance, iritpdl_ResourceType, iritpdl_WorkDefinition, ProcessElement, iritpdl_WorkSequence, iritpdl_ResourceConf, iritpdl_Resource, WorkSequenceType},
    associations={processElements0, guidanceGFX1, resources3, linksToPredecessors5, linksToSuccessors6, resourceConf8, children9, type18, resourceConf20, workDefinition22, neededResources24, predecessor10, successor11, guides13, parent16},
