...
@given(instance=school_Year_strategy)
def test_hyp_school_year_weightOfRegularCourses_setter(instance):
...
def test_hyp_school_school_numberOfTeachers_setter(instance):
...
@given(instance=school_School_strategy)
def test_hyp_school_school_currentYear_setter(instance):
