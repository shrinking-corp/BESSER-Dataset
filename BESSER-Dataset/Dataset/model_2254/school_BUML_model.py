...
school_SchoolClass = Class(name="school_SchoolClass")
school_Year = Class(name="school_Year")
school_SpecialisationCourse = Class(name="school_SpecialisationCourse")
...
school_Course.attributes={school_Course_weight, school_Course_subject}
...
school_School.attributes={school_School_numberOfTeachers, school_School_name, school_School_currentYear, school_School_address}
...
domain_model = DomainModel(
    name="school",
    types={school_Student, school_Course, school_School, school_Teacher, school_SchoolClass, school_Year, school_SpecialisationCourse, Course},
    associations={teachers6, courses9, teachersWithMostCourses11, lastYear12, year14, students16, school0, teacher1, schoolClass3, years5, school31, schoolClasses33, courses17, homeroomTeacher20, homeroomCourses22, schoolClass23, school25, courses27, homeroomedClass29},
