...
class school_Year:
    ...
    def __init__(self, startingDate: int, weightOfRegularCourses: int, school_Year: "school_School" = None, Year15: "school_SchoolClass" = None, Year: "school_School" = None, years: "school_School" = None, year: set["school_SchoolClass"] = None):
        ...
        pass
    @property
    def weightOfRegularCourses(self):
...
class school_SchoolClass:
    ...
    def __init__(self, code: str, schoolClasses: "school_Year" = None, schoolClass: set["school_Student"] = None, SchoolClass: "school_Course" = None, SchoolClass34: "school_Year" = None, schoolClass18: set["school_Course"] = None, homeroomedClass: "school_Teacher" = None, school_SchoolClass: set["school_Course"] = None, SchoolClass24: "school_Student" = None, SchoolClass30: "school_Teacher" = None):
        self.code = code
...
class school_Teacher:
    ...
    def __init__(self, name: str, school_Teacher: "school_School" = None, Teacher: "school_Course" = None, Teacher8: "school_School" = None, Teacher21: "school_SchoolClass" = None, teachers: "school_School" = None, teacher: set["school_Course"] = None, homeroomTeacher: "school_SchoolClass" = None):
        self.name = name
...
class school_School:
    ...
    def __init__(self, numberOfTeachers: int, currentYear: int, name: str, address: str, school_School: set["school_Teacher"] = None, school_School13: "school_Year" = None, School: "school_Course" = None, school: set["school_Year"] = None, School32: "school_Year" = None, school7: set["school_Teacher"] = None, school10: set["school_Course"] = None, School26: "school_Teacher" = None):
...
class school_Course:
    ...
    def __init__(self, subject: str, weight: int, courses: "school_School" = None, courses2: "school_Teacher" = None, courses4: "school_SchoolClass" = None, Course19: "school_SchoolClass" = None, Course: "school_School" = None, school_Course: "school_SchoolClass" = None, Course28: "school_Teacher" = None):
