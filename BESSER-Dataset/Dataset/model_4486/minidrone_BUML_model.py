...
# Classes
minidrone_MiniDroneProgram = Class(name="minidrone_MiniDroneProgram")
minidrone_Instruction = Class(name="minidrone_Instruction", is_abstract=True)
minidrone_Go = Class(name="minidrone_Go")
Instruction = Class(name="Instruction")
minidrone_Turn = Class(name="minidrone_Turn")
minidrone_Jump = Class(name="minidrone_Jump")
