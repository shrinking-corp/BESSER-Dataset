...
# Classes
TestPackage_TestInterface = Class(name="TestPackage_TestInterface", is_abstract=True)
TestPackage_TestClass = Class(name="TestPackage_TestClass")
SuperClass = Class(name="SuperClass")
UberClass = Class(name="UberClass")
TestPackage_SuperClass = Class(name="TestPackage_SuperClass", is_abstract=True)
TestPackage_UberClass = Class(name="TestPackage_UberClass", is_abstract=True)
TestPackage_SubPackage_SubTestClass = Class(name="TestPackage_SubPackage_SubTestClass")
TestPackage_SubPackage_SubTestInterface = Class(name="TestPackage_SubPackage_SubTestInterface", is_abstract=True)
...
TestPackage_TestClass.attributes={TestPackage_TestClass_testAttr4, TestPackage_TestClass_testAttr3, TestPackage_TestClass_testAttr5, TestPackage_TestClass_testAttr6, TestPackage_TestClass_testAttr8, TestPackage_TestClass_testIntAttr, TestPackage_TestClass_testAttr2, TestPackage_TestClass_testAttr, TestPackage_TestClass_testBooleanAttr, TestPackage_TestClass_testStringAttr, TestPackage_TestClass_testAttr1, TestPackage_TestClass_testAttr7, TestPackage_TestClass_testRealAttr, TestPackage_TestClass_testUnlimitedNaturalAttr}
...
TestPackage_SubPackage_SubTestClass.attributes={TestPackage_SubPackage_SubTestClass_testRealAttr, TestPackage_SubPackage_SubTestClass_testBooleanAttr, TestPackage_SubPackage_SubTestClass_testAttr, TestPackage_SubPackage_SubTestClass_testIntAttr, TestPackage_SubPackage_SubTestClass_testStringAttr}
...
domain_model = DomainModel(
    name="TestPackage",
    types={TestPackage_TestInterface, TestPackage_TestClass, SuperClass, UberClass, TestPackage_SuperClass, TestPackage_UberClass, TestPackage_SubPackage_SubTestClass, TestPackage_SubPackage_SubTestInterface, TestEnum, SubTestEnum},
    associations={},
    generalizations={gen_TestPackage_TestInterface_SuperClass, gen_TestPackage_TestClass_SuperClass, gen_TestPackage_TestClass_UberClass},
    metadata=None
)
