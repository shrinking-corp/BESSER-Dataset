...
class TestPackage_TestClass(SuperClass, UberClass):
    ...
    def __init__(self, testAttr2: int, testAttr3: int, testAttr4: int, testAttr5: int, testUnlimitedNaturalAttr: str, testAttr6: int, testAttr7: int, testAttr8: int, testAttr: date, testStringAttr: str, testRealAttr: str, testBooleanAttr: bool, testIntAttr: int, testAttr1: int):
