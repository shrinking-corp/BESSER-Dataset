...
public class diva_VariabilityModel extends DiVAModelElement {
    ...
    public diva_VariabilityModel(
        ArrayList<diva_Constraint> diva_constraints,        ArrayList<diva_Dimension> diva_dimensions,        ArrayList<diva_Property> diva_propertys,        ArrayList<diva_Rule> diva_rules,        ArrayList<diva_Variable> diva_variables    ) {
