...
class OCLinEmig_Attribute(OclFeature):
    ...
    def __init__(self, name: str, Attribute70: "OCLinEmig_OclType" = None, Attribute: "OCLinEmig_OclExpression" = None, owningAttribute: "OCLinEmig_OclExpression" = None, attribute: "OCLinEmig_OclType" = None):
        self.name = name
...
class OCLinEmig_Operation(OclFeature):
    ...
    def __init__(self, name: str, Operation66: "OCLinEmig_OclType" = None, Operation59: "OCLinEmig_Parameter" = None, Operation: "OCLinEmig_OclExpression" = None, operation: set["OCLinEmig_Parameter"] = None, operation106: "OCLinEmig_OclType" = None, owningOperation: "OCLinEmig_OclExpression" = None):
        self.name = name
...
class OCLinEmig_TupleTypeAttribute(LocatedElement):
    ...
    def __init__(self, name: str, attributes: "OCLinEmig_TupleType" = None, TupleTypeAttribute: "OCLinEmig_OclType" = None, TupleTypeAttribute80: "OCLinEmig_TupleType" = None, tupleTypeAttribute: "OCLinEmig_OclType" = None):
        self.name = name
...
class OCLinEmig_VariableDeclaration(LocatedElement):
    ...
    def __init__(self, id: str, varName: str, VariableDeclaration: "OCLinEmig_OclExpression" = None, variableDeclaration: "OCLinEmig_OclType" = None, initializedVariable: "OCLinEmig_OclExpression" = None, variable: "OCLinEmig_LetExp" = None, result: "OCLinEmig_IterateExp" = None, referredVariable: set["OCLinEmig_VariableExp"] = None, VariableDeclaration17: "OCLinEmig_VariableExp" = None, VariableDeclaration36: "OCLinEmig_IterateExp" = None, VariableDeclaration38: "OCLinEmig_LetExp" = None, VariableDeclaration78: "OCLinEmig_OclType" = None):
        self.id = id
...
class OCLinEmig_OclType(OclExpression):
    ...
    def __init__(self, name: str, OclType: "OCLinEmig_OclExpression" = None, context_: "OCLinEmig_OclContextDefinition" = None, type: "OCLinEmig_OclExpression" = None, returnType: "OCLinEmig_Operation" = None, valueType: "OCLinEmig_MapType" = None, type69: "OCLinEmig_Attribute" = None, OclType49: "OCLinEmig_VariableDeclaration" = None, OclType61: "OCLinEmig_CollectionType" = None, keyType: "OCLinEmig_MapType" = None, elementType: "OCLinEmig_CollectionType" = None, type75: "OCLinEmig_TupleTypeAttribute" = None, type77: "OCLinEmig_VariableDeclaration" = None, OclType82: "OCLinEmig_TupleTypeAttribute" = None, OclType107: "OCLinEmig_Operation" = None, OclType87: "OCLinEmig_MapType" = None, OclType89: "OCLinEmig_MapType" = None, OclType97: "OCLinEmig_OclContextDefinition" = None, OclType103: "OCLinEmig_Attribute" = None):
        self.name = name
