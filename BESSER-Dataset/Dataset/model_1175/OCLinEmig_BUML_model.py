...
# Classes
OCLinEmig_OclType = Class(name="OCLinEmig_OclType")
OCLinEmig_IfExp = Class(name="OCLinEmig_IfExp")
OCLinEmig_PropertyCallExp = Class(name="OCLinEmig_PropertyCallExp", is_abstract=True)
OCLinEmig_CollectionExp = Class(name="OCLinEmig_CollectionExp", is_abstract=True)
OCLinEmig_OclExpression = Class(name="OCLinEmig_OclExpression", is_abstract=True)
LocatedElement = Class(name="LocatedElement")
OCLinEmig_BooleanExp = Class(name="OCLinEmig_BooleanExp")
OCLinEmig_NumericExp = Class(name="OCLinEmig_NumericExp", is_abstract=True)
OCLinEmig_RealExp = Class(name="OCLinEmig_RealExp")
NumericExp = Class(name="NumericExp")
OCLinEmig_IntegerExp = Class(name="OCLinEmig_IntegerExp")
OCLinEmig_LetExp = Class(name="OCLinEmig_LetExp")
OCLinEmig_LoopExp = Class(name="OCLinEmig_LoopExp", is_abstract=True)
OCLinEmig_OperationCallExp = Class(name="OCLinEmig_OperationCallExp")
OCLinEmig_VariableDeclaration = Class(name="OCLinEmig_VariableDeclaration")
OCLinEmig_Operation = Class(name="OCLinEmig_Operation")
OCLinEmig_Attribute = Class(name="OCLinEmig_Attribute")
OCLinEmig_VariableExp = Class(name="OCLinEmig_VariableExp")
OclExpression = Class(name="OclExpression")
OCLinEmig_SuperExp = Class(name="OCLinEmig_SuperExp")
OCLinEmig_PrimitiveExp = Class(name="OCLinEmig_PrimitiveExp", is_abstract=True)
OCLinEmig_StringExp = Class(name="OCLinEmig_StringExp")
PrimitiveExp = Class(name="PrimitiveExp")
OCLinEmig_OclUndefinedExp = Class(name="OCLinEmig_OclUndefinedExp")
OCLinEmig_NavigationOrAttributeCallExp = Class(name="OCLinEmig_NavigationOrAttributeCallExp")
PropertyCallExp = Class(name="PropertyCallExp")
OCLinEmig_BagExp = Class(name="OCLinEmig_BagExp")
CollectionExp = Class(name="CollectionExp")
OCLinEmig_OrderedSetExp = Class(name="OCLinEmig_OrderedSetExp")
OCLinEmig_SequenceExp = Class(name="OCLinEmig_SequenceExp")
OCLinEmig_SetExp = Class(name="OCLinEmig_SetExp")
OCLinEmig_TupleExp = Class(name="OCLinEmig_TupleExp")
OCLinEmig_TuplePart = Class(name="OCLinEmig_TuplePart")
VariableDeclaration = Class(name="VariableDeclaration")
OCLinEmig_MapExp = Class(name="OCLinEmig_MapExp")
OCLinEmig_MapElement = Class(name="OCLinEmig_MapElement")
OCLinEmig_EnumLiteralExp = Class(name="OCLinEmig_EnumLiteralExp")
OCLinEmig_OperatorCallExp = Class(name="OCLinEmig_OperatorCallExp")
OperationCallExp = Class(name="OperationCallExp")
OCLinEmig_CollectionOperationCallExp = Class(name="OCLinEmig_CollectionOperationCallExp")
OCLinEmig_Iterator = Class(name="OCLinEmig_Iterator")
OCLinEmig_IterateExp = Class(name="OCLinEmig_IterateExp")
LoopExp = Class(name="LoopExp")
OCLinEmig_IteratorExp = Class(name="OCLinEmig_IteratorExp")
OCLinEmig_OclContextDefinition = Class(name="OCLinEmig_OclContextDefinition")
OCLinEmig_MapType = Class(name="OCLinEmig_MapType")
OCLinEmig_Parameter = Class(name="OCLinEmig_Parameter")
OCLinEmig_CollectionType = Class(name="OCLinEmig_CollectionType")
OclType = Class(name="OclType")
OCLinEmig_OclModelElement = Class(name="OCLinEmig_OclModelElement")
OCLinEmig_OclModel = Class(name="OCLinEmig_OclModel")
OCLinEmig_TupleTypeAttribute = Class(name="OCLinEmig_TupleTypeAttribute")
OCLinEmig_Primitive = Class(name="OCLinEmig_Primitive", is_abstract=True)
OCLinEmig_StringType = Class(name="OCLinEmig_StringType")
Primitive = Class(name="Primitive")
OCLinEmig_BooleanType = Class(name="OCLinEmig_BooleanType")
OCLinEmig_NumericType = Class(name="OCLinEmig_NumericType", is_abstract=True)
OCLinEmig_IntegerType = Class(name="OCLinEmig_IntegerType")
NumericType = Class(name="NumericType")
OCLinEmig_RealType = Class(name="OCLinEmig_RealType")
OCLinEmig_BagType = Class(name="OCLinEmig_BagType")
CollectionType = Class(name="CollectionType")
OCLinEmig_OrderedSetType = Class(name="OCLinEmig_OrderedSetType")
OCLinEmig_SequenceType = Class(name="OCLinEmig_SequenceType")
OCLinEmig_SetType = Class(name="OCLinEmig_SetType")
OCLinEmig_OclAnyType = Class(name="OCLinEmig_OclAnyType")
OCLinEmig_TupleType = Class(name="OCLinEmig_TupleType")
OCLinEmig_OclFeatureDefinition = Class(name="OCLinEmig_OclFeatureDefinition")
OCLinEmig_OclFeature = Class(name="OCLinEmig_OclFeature", is_abstract=True)
OclFeature = Class(name="OclFeature")
OCLinEmig_LocatedElement = Class(name="OCLinEmig_LocatedElement", is_abstract=True)
OCLinEmig_Module = Class(name="OCLinEmig_Module")
...
OCLinEmig_VariableDeclaration.attributes={OCLinEmig_VariableDeclaration_varName, OCLinEmig_VariableDeclaration_id}
...
OCLinEmig_LocatedElement.attributes={OCLinEmig_LocatedElement_location, OCLinEmig_LocatedElement_commentsBefore, OCLinEmig_LocatedElement_commentsAfter}
...
domain_model = DomainModel(
    name="OCLinEmig",
    types={OCLinEmig_OclType, OCLinEmig_IfExp, OCLinEmig_PropertyCallExp, OCLinEmig_CollectionExp, OCLinEmig_OclExpression, LocatedElement, OCLinEmig_BooleanExp, OCLinEmig_NumericExp, OCLinEmig_RealExp, NumericExp, OCLinEmig_IntegerExp, OCLinEmig_LetExp, OCLinEmig_LoopExp, OCLinEmig_OperationCallExp, OCLinEmig_VariableDeclaration, OCLinEmig_Operation, OCLinEmig_Attribute, OCLinEmig_VariableExp, OclExpression, OCLinEmig_SuperExp, OCLinEmig_PrimitiveExp, OCLinEmig_StringExp, PrimitiveExp, OCLinEmig_OclUndefinedExp, OCLinEmig_NavigationOrAttributeCallExp, PropertyCallExp, OCLinEmig_BagExp, CollectionExp, OCLinEmig_OrderedSetExp, OCLinEmig_SequenceExp, OCLinEmig_SetExp, OCLinEmig_TupleExp, OCLinEmig_TuplePart, VariableDeclaration, OCLinEmig_MapExp, OCLinEmig_MapElement, OCLinEmig_EnumLiteralExp, OCLinEmig_OperatorCallExp, OperationCallExp, OCLinEmig_CollectionOperationCallExp, OCLinEmig_Iterator, OCLinEmig_IterateExp, LoopExp, OCLinEmig_IteratorExp, OCLinEmig_OclContextDefinition, OCLinEmig_MapType, OCLinEmig_Parameter, OCLinEmig_CollectionType, OclType, OCLinEmig_OclModelElement, OCLinEmig_OclModel, OCLinEmig_TupleTypeAttribute, OCLinEmig_Primitive, OCLinEmig_StringType, Primitive, OCLinEmig_BooleanType, OCLinEmig_NumericType, OCLinEmig_IntegerType, NumericType, OCLinEmig_RealType, OCLinEmig_BagType, CollectionType, OCLinEmig_OrderedSetType, OCLinEmig_SequenceType, OCLinEmig_SetType, OCLinEmig_OclAnyType, OCLinEmig_TupleType, OCLinEmig_OclFeatureDefinition, OCLinEmig_OclFeature, OclFeature, OCLinEmig_LocatedElement, OCLinEmig_Module},
    associations={type0, ifExp31, appliedProperty2, collection3, letExp4, loopExp5, parentOperation6, initializedVariable7, ifExp28, owningOperation10, ifExp112, owningAttribute14, referredVariable16, source28, elements18, tuplePart19, tuple20, elements21, map22, key24, value25, thenExpression42, condition44, elseExpression46, arguments30, body32, iterators34, result35, variable37, in_39, definitions62, oclExpression63, operation65, mapType267, attribute68, type48, initExpression50, letExp52, baseExp54, variableExp55, loopExpr56, operation58, elementType60, tupleType83, model84, mapType71, collectionTypes73, tupleTypeAttribute74, variableDeclaration76, attributes79, type81, parameters104, returnType105, body108, valueType86, keyType88, feature90, context_91, definition94, context_96, definition98, initExpression100, type102, metamodel111, elements113, model116, oclFeatures118},
    generalizations={gen_OCLinEmig_OclExpression_LocatedElement, gen_OCLinEmig_BooleanExp_PrimitiveExp, gen_OCLinEmig_NumericExp_PrimitiveExp, gen_OCLinEmig_RealExp_NumericExp, gen_OCLinEmig_IntegerExp_NumericExp, gen_OCLinEmig_CollectionExp_OclExpression, gen_OCLinEmig_VariableExp_OclExpression, gen_OCLinEmig_SuperExp_OclExpression, gen_OCLinEmig_PrimitiveExp_OclExpression, gen_OCLinEmig_StringExp_PrimitiveExp, gen_OCLinEmig_OclUndefinedExp_OclExpression, gen_OCLinEmig_PropertyCallExp_OclExpression, gen_OCLinEmig_NavigationOrAttributeCallExp_PropertyCallExp, gen_OCLinEmig_OperationCallExp_PropertyCallExp, gen_OCLinEmig_BagExp_CollectionExp, gen_OCLinEmig_OrderedSetExp_CollectionExp, gen_OCLinEmig_SequenceExp_CollectionExp, gen_OCLinEmig_SetExp_CollectionExp, gen_OCLinEmig_TupleExp_OclExpression, gen_OCLinEmig_TuplePart_VariableDeclaration, gen_OCLinEmig_MapExp_OclExpression, gen_OCLinEmig_MapElement_LocatedElement, gen_OCLinEmig_EnumLiteralExp_OclExpression, gen_OCLinEmig_IfExp_OclExpression, gen_OCLinEmig_VariableDeclaration_LocatedElement, gen_OCLinEmig_OperatorCallExp_OperationCallExp, gen_OCLinEmig_CollectionOperationCallExp_OperationCallExp, gen_OCLinEmig_LoopExp_PropertyCallExp, gen_OCLinEmig_IterateExp_LoopExp, gen_OCLinEmig_IteratorExp_LoopExp, gen_OCLinEmig_LetExp_OclExpression, gen_OCLinEmig_Iterator_VariableDeclaration, gen_OCLinEmig_Parameter_VariableDeclaration, gen_OCLinEmig_CollectionType_OclType, gen_OCLinEmig_OclType_OclExpression, gen_OCLinEmig_OclModelElement_OclType, gen_OCLinEmig_MapType_OclType, gen_OCLinEmig_Primitive_OclType, gen_OCLinEmig_StringType_Primitive, gen_OCLinEmig_BooleanType_Primitive, gen_OCLinEmig_NumericType_Primitive, gen_OCLinEmig_IntegerType_NumericType, gen_OCLinEmig_RealType_NumericType, gen_OCLinEmig_BagType_CollectionType, gen_OCLinEmig_OrderedSetType_CollectionType, gen_OCLinEmig_SequenceType_CollectionType, gen_OCLinEmig_SetType_CollectionType, gen_OCLinEmig_OclAnyType_OclType, gen_OCLinEmig_TupleType_OclType, gen_OCLinEmig_TupleTypeAttribute_LocatedElement, gen_OCLinEmig_Operation_OclFeature, gen_OCLinEmig_OclFeatureDefinition_LocatedElement, gen_OCLinEmig_OclContextDefinition_LocatedElement, gen_OCLinEmig_OclFeature_LocatedElement, gen_OCLinEmig_Attribute_OclFeature, gen_OCLinEmig_OclModel_LocatedElement},
    metadata=None
)
