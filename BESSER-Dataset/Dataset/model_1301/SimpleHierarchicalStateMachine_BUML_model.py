...
domain_model = DomainModel(
    ...
    types={State, SimpleHierarchicalStateMachine_State, SimpleHierarchicalStateMachine_CompositeState, SimpleHierarchicalStateMachine_Transition, SimpleHierarchicalStateMachine_StateMachine, SimpleHierarchicalStateMachine_InitialState, SimpleHierarchicalStateMachine_FinalState},
    associations={source3, ownedSubState6, owningCompositeState0, target1, ownedState9, ownedTransition11},
    generalizations={gen_SimpleHierarchicalStateMachine_CompositeState_State, gen_SimpleHierarchicalStateMachine_InitialState_State, gen_SimpleHierarchicalStateMachine_FinalState_State},
    metadata=None
)
