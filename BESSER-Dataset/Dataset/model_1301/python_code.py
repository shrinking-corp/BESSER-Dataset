...
class SimpleHierarchicalStateMachine_Transition:
    ...
    def __init__(self, trigger: str, effect: str, SimpleHierarchicalStateMachine_Transition4: "SimpleHierarchicalStateMachine_State" = None, SimpleHierarchicalStateMachine_Transition: "SimpleHierarchicalStateMachine_State" = None, SimpleHierarchicalStateMachine_Transition13: "SimpleHierarchicalStateMachine_StateMachine" = None):
...
class SimpleHierarchicalStateMachine_State:
    ...
    def __init__(self, name: str, SimpleHierarchicalStateMachine_State5: "SimpleHierarchicalStateMachine_Transition" = None, SimpleHierarchicalStateMachine_State8: "SimpleHierarchicalStateMachine_CompositeState" = None, SimpleHierarchicalStateMachine_State: "SimpleHierarchicalStateMachine_CompositeState" = None, SimpleHierarchicalStateMachine_State2: "SimpleHierarchicalStateMachine_Transition" = None, SimpleHierarchicalStateMachine_State10: "SimpleHierarchicalStateMachine_StateMachine" = None):
        self.name = name
