...
class ryz_Header:
    ...
    def __init__(self, labelText: str, name: str, ryz_Header: "ryz_Table" = None):
...
class ryz_HelperForSendingRequest(ABC):
    ...
    def __init__(self, requestType: str, httpMethod: str, text: str, helperforsendingrequest56: set["ryz_PresentationElement"] = None, HelperForSendingRequest: "ryz_UseCase" = None, helperforsendingrequest: set["ryz_UseCase"] = None, HelperForSendingRequest83: "ryz_PresentationElement" = None, ryz_HelperForSendingRequest88: "ryz_FormElementToPropertyKeyRelation" = None, ryz_HelperForSendingRequest: "ryz_AbstractView" = None, ryz_HelperForSendingRequest35: "ryz_ViewToControllerRelation" = None):
...
class ryz_Property(NamedElement):
    ...
    def __init__(self, type: str, isRequired: bool, ryz_Property52: "ryz_ControllerToModelRelation" = None, ryz_Property69: "ryz_ViewToModelRelation" = None, ryz_Property: "ryz_Model" = None, ryz_Property44: "ryz_ViewToControllerRelation" = None, ryz_Property99: "ryz_PresentationFormElementToPropertyKey" = None):
        self.type = type
        self.isRequired = isRequired
...
class ryz_ActionMethod(NamedElement):
    ...
    def __init__(self, httpMethod: str, returns: str, ryz_ActionMethod46: "ryz_ControllerToModelRelation" = None, ryz_ActionMethod31: set["ryz_Parameter"] = None, ryz_ActionMethod58: "ryz_ControllerToViewRelation" = None, ActionMethod: "ryz_UseCase" = None, ryz_ActionMethod: "ryz_Controller" = None, actionmethod: set["ryz_UseCase"] = None, ryz_ActionMethod38: "ryz_ViewToControllerRelation" = None):
        self.httpMethod = httpMethod
