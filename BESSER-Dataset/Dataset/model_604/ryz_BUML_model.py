...
# Classes
ryz_Project = Class(name="ryz_Project")
NamedElement = Class(name="NamedElement")
ryz_Package = Class(name="ryz_Package", is_abstract=True)
ryz_ComponentPackage = Class(name="ryz_ComponentPackage", is_abstract=True)
Package = Class(name="Package")
ryz_MvcPackage = Class(name="ryz_MvcPackage")
ryz_MainComponent = Class(name="ryz_MainComponent", is_abstract=True)
ryz_MainComponentRelation = Class(name="ryz_MainComponentRelation", is_abstract=True)
ryz_NamedElement = Class(name="ryz_NamedElement", is_abstract=True)
ryz_ModelPackage = Class(name="ryz_ModelPackage")
ComponentPackage = Class(name="ComponentPackage")
ryz_Model = Class(name="ryz_Model")
ryz_ModelAssociation = Class(name="ryz_ModelAssociation")
ryz_ViewPackage = Class(name="ryz_ViewPackage")
ryz_AbstractView = Class(name="ryz_AbstractView", is_abstract=True)
ryz_ControllerPackage = Class(name="ryz_ControllerPackage")
ryz_Controller = Class(name="ryz_Controller")
ryz_Property = Class(name="ryz_Property")
ryz_TableKey = Class(name="ryz_TableKey")
ryz_Partial = Class(name="ryz_Partial")
ryz_HelperForSendingRequest = Class(name="ryz_HelperForSendingRequest", is_abstract=True)
ryz_PresentationElement = Class(name="ryz_PresentationElement", is_abstract=True)
ryz_ActionMethod = Class(name="ryz_ActionMethod")
AbstractView = Class(name="AbstractView")
ryz_Parameter = Class(name="ryz_Parameter")
MainComponent = Class(name="MainComponent")
ryz_UseCase = Class(name="ryz_UseCase")
ryz_Layout = Class(name="ryz_Layout")
ryz_View = Class(name="ryz_View")
ryz_ViewToControllerRelation = Class(name="ryz_ViewToControllerRelation")
MainComponentRelation = Class(name="MainComponentRelation")
ryz_ControllerToModelRelation = Class(name="ryz_ControllerToModelRelation")
ryz_ActionLink = Class(name="ryz_ActionLink")
HelperForSendingRequest = Class(name="HelperForSendingRequest")
ryz_Form = Class(name="ryz_Form")
ryz_ControllerToViewRelation = Class(name="ryz_ControllerToViewRelation")
ryz_ViewToModelRelation = Class(name="ryz_ViewToModelRelation")
ryz_UseCaseActorPackage = Class(name="ryz_UseCaseActorPackage")
ryz_Actor = Class(name="ryz_Actor")
ryz_UseCasePackage = Class(name="ryz_UseCasePackage")
ryz_PresentationForm = Class(name="ryz_PresentationForm")
PresentationElement = Class(name="PresentationElement")
ryz_PresentationFormElement = Class(name="ryz_PresentationFormElement", is_abstract=True)
ryz_MultipleChoice = Class(name="ryz_MultipleChoice")
PresentationFormElement = Class(name="PresentationFormElement")
ryz_Choice = Class(name="ryz_Choice")
ryz_Button = Class(name="ryz_Button")
ryz_Input = Class(name="ryz_Input")
ryz_Link = Class(name="ryz_Link")
ryz_Table = Class(name="ryz_Table")
ryz_FormElementToPropertyKeyRelation = Class(name="ryz_FormElementToPropertyKeyRelation")
ryz_PresentationFormElementToPropertyKey = Class(name="ryz_PresentationFormElementToPropertyKey")
ryz_Header = Class(name="ryz_Header")
...
ryz_ModelAssociation.attributes={ryz_ModelAssociation_principalRoleName, ryz_ModelAssociation_cardinality, ryz_ModelAssociation_dependentRoleName, ryz_ModelAssociation_isRequired}
...
ryz_Property.attributes={ryz_Property_isRequired, ryz_Property_type}
...
ryz_TableKey.attributes={ryz_TableKey_type, ryz_TableKey_isPrimaryKey, ryz_TableKey_isForeignKey, ryz_TableKey_isRequired}
...
ryz_Parameter.attributes={ryz_Parameter_isList, ryz_Parameter_type, ryz_Parameter_isNullable}
...
ryz_Choice.attributes={ryz_Choice_text, ryz_Choice_selected, ryz_Choice_value}
...
ryz_Input.attributes={ryz_Input_inputDataType, ryz_Input_isReadOnly, ryz_Input_isHidden}
...
domain_model = DomainModel(
    name="ryz",
    types={ryz_Project, NamedElement, ryz_Package, ryz_ComponentPackage, Package, ryz_MvcPackage, ryz_MainComponent, ryz_MainComponentRelation, ryz_NamedElement, ryz_ModelPackage, ComponentPackage, ryz_Model, ryz_ModelAssociation, ryz_ViewPackage, ryz_AbstractView, ryz_ControllerPackage, ryz_Controller, ryz_Property, ryz_TableKey, ryz_Partial, ryz_HelperForSendingRequest, ryz_PresentationElement, ryz_ActionMethod, AbstractView, ryz_Parameter, MainComponent, ryz_UseCase, ryz_Layout, ryz_View, ryz_ViewToControllerRelation, MainComponentRelation, ryz_ControllerToModelRelation, ryz_ActionLink, HelperForSendingRequest, ryz_Form, ryz_ControllerToViewRelation, ryz_ViewToModelRelation, ryz_UseCaseActorPackage, ryz_Actor, ryz_UseCasePackage, ryz_PresentationForm, PresentationElement, ryz_PresentationFormElement, ryz_MultipleChoice, PresentationFormElement, ryz_Choice, ryz_Button, ryz_Input, ryz_Link, ryz_Table, ryz_FormElementToPropertyKeyRelation, ryz_PresentationFormElementToPropertyKey, ryz_Header, ModelPropertyType, Cardinality, ActionMethodParameterType, RequestType, HttpMethod, ModelCardinality, ModelOperation, ActionMethodReturnType, MultipleChoiceType, ButtonType, InputDataType},
    associations={packages0, maincomponents1, maincomponentrelations2, models4, modelassociations5, views7, controllers8, properties9, inherits12, tablekeys14, renders16, htmlelements18, presentationelement20, actionmethods22, principal24, dependent27, usecase32, layout33, helperforsendingrequest34, actionmethod36, model39, properties42, actionmethod45, model47, modelproperties50, parameters30, presentationelement55, actionmethod57, returns59, abstractview62, model64, properties67, actors70, usecasepackages71, usecase73, actor75, helperforsendingrequest76, usecase53, usecases80, helperforsendingrequest82, presentationformelement84, choice85, actionmethod78, helperforsendingrequest87, model89, presentationformelementtoproperty92, presentationformelement94, property97, tablekey100, header86},
    generalizations={gen_ryz_Project_NamedElement, gen_ryz_Package_NamedElement, gen_ryz_ComponentPackage_Package, gen_ryz_MvcPackage_Package, gen_ryz_ModelPackage_ComponentPackage, gen_ryz_ViewPackage_ComponentPackage, gen_ryz_ControllerPackage_ComponentPackage, gen_ryz_AbstractView_MainComponent, gen_ryz_Controller_MainComponent, gen_ryz_MainComponent_NamedElement, gen_ryz_Property_NamedElement, gen_ryz_ModelAssociation_NamedElement, gen_ryz_Partial_AbstractView, gen_ryz_ActionMethod_NamedElement, gen_ryz_Model_MainComponent, gen_ryz_Layout_AbstractView, gen_ryz_View_AbstractView, gen_ryz_Parameter_NamedElement, gen_ryz_MainComponentRelation_NamedElement, gen_ryz_ViewToControllerRelation_MainComponentRelation, gen_ryz_ControllerToModelRelation_MainComponentRelation, gen_ryz_ActionLink_HelperForSendingRequest, gen_ryz_Form_HelperForSendingRequest, gen_ryz_ControllerToViewRelation_MainComponentRelation, gen_ryz_TableKey_NamedElement, gen_ryz_ViewToModelRelation_MainComponentRelation, gen_ryz_UseCaseActorPackage_Package, gen_ryz_Actor_NamedElement, gen_ryz_UseCase_NamedElement, gen_ryz_UseCasePackage_NamedElement, gen_ryz_PresentationElement_NamedElement, gen_ryz_PresentationForm_PresentationElement, gen_ryz_MultipleChoice_PresentationFormElement, gen_ryz_Button_PresentationFormElement, gen_ryz_Input_PresentationFormElement, gen_ryz_Link_PresentationElement, gen_ryz_Table_PresentationElement, gen_ryz_FormElementToPropertyKeyRelation_MainComponentRelation},
    metadata=None
)
