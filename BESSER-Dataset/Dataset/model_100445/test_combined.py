...
def test_hyp_statemodel_entity_is_not_abstract():
    assert not inspect.isabstract(statemodel_Entity)


def test_hyp_statemodel_entity_constructor_exists():
    assert callable(statemodel_Entity.__init__)


def test_hyp_statemodel_entity_constructor_args():
...
def test_hyp_statemodel_annotation_is_not_abstract():
    assert not inspect.isabstract(statemodel_Annotation)


def test_hyp_statemodel_annotation_constructor_exists():
    assert callable(statemodel_Annotation.__init__)


def test_hyp_statemodel_annotation_constructor_args():
