...
domain_model = DomainModel(
    name="statemodel",
    types={statemodel_Model, statemodel_Import, statemodel_Element, statemodel_Annotation, statemodel_Statemachine, Element, statemodel_Entity, statemodel_State, Activity, statemodel_Activity, statemodel_TransitionBlock, statemodel_Transition, StateType},
    associations={imports0, elements1, annotation3, entity5, state6, element8, transition10, state11},
