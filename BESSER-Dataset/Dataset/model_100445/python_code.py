...
class Element:
    ...
    pass
class statemodel_State(Activity, Element):

    def __init__(self, type: str, name: str, statemodel_State9: set["statemodel_Activity"] = None, statemodel_State13: "statemodel_Transition" = None, statemodel_State: "statemodel_Statemachine" = None):
        self.type = type
        self.name = name
