...
class feature_Attribute:
    ...
    def __init__(self, name: str, value: str, deselectedDomainValues: str, Attribute: "feature_Feature" = None, attributes: "feature_Feature" = None, feature_Attribute: "feature_Domain" = None, feature_Attribute21: "feature_AttributeReference" = None):
        self.name = name
        self.value = value
    ...
    @property
    def deselectedDomainValues(self):
...
class feature_Feature(Identifiable):
    ...
    def __init__(self, name: str, configurationState: str, feature: set["feature_Attribute"] = None, feature_Feature7: set["feature_Group"] = None, feature_Feature: "feature_FeatureModel" = None, feature_Feature10: "feature_Group" = None, Feature: "feature_Attribute" = None, feature_Feature24: "feature_AttributeReference" = None, feature_Feature26: "feature_FeatureConstraint" = None, feature_Feature29: "feature_FeatureConstraint" = None):
        self.name = name
