...
public class feature_Attribute  {
    ...
    private String name;
    private String deselectedDomainValues;
    ...
    public feature_Attribute(
        String value,        String name,        String deselectedDomainValues    ) {
        this.value = value;
        this.name = name;
        this.deselectedDomainValues = deselectedDomainValues;
    }
    ...
    public String getDeselecteddomainvalues() {
        return deselectedDomainValues;
    }

    public void setDeselecteddomainvalues(String deselectedDomainValues) {
        this.deselectedDomainValues = deselectedDomainValues;
    }
