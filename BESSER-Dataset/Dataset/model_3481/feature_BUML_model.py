...
feature_Constraint = Class(name="feature_Constraint", is_abstract=True)
feature_AttributeConstraint = Class(name="feature_AttributeConstraint")
...
feature_DomainValue = Class(name="feature_DomainValue")
feature_NumericalDomain = Class(name="feature_NumericalDomain")
feature_Interval = Class(name="feature_Interval")
feature_Identifiable = Class(name="feature_Identifiable", is_abstract=True)
feature_AttributeValue = Class(name="feature_AttributeValue")
feature_FeatureConstraint = Class(name="feature_FeatureConstraint", is_abstract=True)
feature_Imply = Class(name="feature_Imply")
FeatureConstraint = Class(name="FeatureConstraint")
feature_Exclude = Class(name="feature_Exclude")
...
feature_Attribute.attributes={feature_Attribute_name, feature_Attribute_deselectedDomainValues, feature_Attribute_value}
...
feature_Feature.attributes={feature_Feature_configurationState, feature_Feature_name}
...
feature_AttributeValue.attributes={feature_AttributeValue_name, feature_AttributeValue_int}
...
domain_model = DomainModel(
    name="feature",
    types={Identifiable, feature_Attribute, feature_Group, feature_FeatureModel, feature_Feature, feature_Domain, feature_Constraint, feature_AttributeConstraint, Constraint, feature_AttributeOperand, feature_AttributeReference, AttributeOperand, feature_DiscreteDomain, Domain, feature_DomainValue, feature_NumericalDomain, feature_Interval, feature_Identifiable, feature_AttributeValue, feature_FeatureConstraint, feature_Imply, FeatureConstraint, feature_Exclude, FeatureState, Relop},
    associations={attributes5, groups6, root0, domains1, constraints3, leftOperand16, rightOperand17, childFeatures8, feature11, domain12, values14, intervals15, attribute20, feature22, leftOperand25, rightOperand27},
    generalizations={gen_feature_Feature_Identifiable, gen_feature_Group_Identifiable, gen_feature_AttributeConstraint_Constraint, gen_feature_AttributeReference_AttributeOperand, gen_feature_DiscreteDomain_Domain, gen_feature_NumericalDomain_Domain, gen_feature_Domain_Identifiable, gen_feature_Constraint_Identifiable, gen_feature_AttributeValue_AttributeOperand, gen_feature_FeatureConstraint_Constraint, gen_feature_Imply_FeatureConstraint, gen_feature_Exclude_FeatureConstraint},
    metadata=None
)
