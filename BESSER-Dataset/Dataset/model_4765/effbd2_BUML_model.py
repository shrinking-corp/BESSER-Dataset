...
# Classes
effbd2_Function = Class(name="effbd2_Function")
FunctionSpecification = Class(name="FunctionSpecification")
effbd2_DataFlowEdge = Class(name="effbd2_DataFlowEdge")
effbd2_EffbdNode = Class(name="effbd2_EffbdNode", is_abstract=True)
effbd2_ControlFlowEdge = Class(name="effbd2_ControlFlowEdge")
effbd2_Transformed = Class(name="effbd2_Transformed", is_abstract=True)
EffbdNode = Class(name="EffbdNode")
EffbdElement = Class(name="EffbdElement")
effbd2_SequenceNode = Class(name="effbd2_SequenceNode", is_abstract=True)
Transformer = Class(name="Transformer")
effbd2_FunctionSpecification = Class(name="effbd2_FunctionSpecification", is_abstract=True)
effbd2_Input = Class(name="effbd2_Input")
effbd2_Control = Class(name="effbd2_Control")
effbd2_Resource = Class(name="effbd2_Resource")
effbd2_Out = Class(name="effbd2_Out")
effbd2_FunctionDefinition = Class(name="effbd2_FunctionDefinition")
effbd2_EffbdElement = Class(name="effbd2_EffbdElement", is_abstract=True)
effbd2_Fork = Class(name="effbd2_Fork")
SequenceNode = Class(name="SequenceNode")
effbd2_Decision = Class(name="effbd2_Decision")
effbd2_ItemContent = Class(name="effbd2_ItemContent")
effbd2_ContinuousFlowItem = Class(name="effbd2_ContinuousFlowItem")
Transformed = Class(name="Transformed")
effbd2_DataFlowOutputEdge = Class(name="effbd2_DataFlowOutputEdge")
effbd2_TriggerItem = Class(name="effbd2_TriggerItem")
effbd2_In = Class(name="effbd2_In", is_abstract=True)
DataPort = Class(name="DataPort")
effbd2_DataPort = Class(name="effbd2_DataPort", is_abstract=True)
In = Class(name="In")
effbd2_Transformer = Class(name="effbd2_Transformer", is_abstract=True)
effbd2_DataFlowInputEdge = Class(name="effbd2_DataFlowInputEdge")
DataFlowEdge = Class(name="DataFlowEdge")
effbd2_LoopEnd = Class(name="effbd2_LoopEnd")
effbd2_IterationEnd = Class(name="effbd2_IterationEnd")
effbd2_IterationStart = Class(name="effbd2_IterationStart")
effbd2_LoopExit = Class(name="effbd2_LoopExit")
effbd2_Join = Class(name="effbd2_Join")
effbd2_Merge = Class(name="effbd2_Merge")
effbd2_Start = Class(name="effbd2_Start")
effbd2_Final = Class(name="effbd2_Final")
effbd2_LoopStart = Class(name="effbd2_LoopStart")
...
effbd2_FunctionSpecification.attributes={effbd2_FunctionSpecification_maxDuration, effbd2_FunctionSpecification_domain, effbd2_FunctionSpecification_minDuration}
...
domain_model = DomainModel(
    name="effbd2",
    types={effbd2_Function, FunctionSpecification, effbd2_DataFlowEdge, effbd2_EffbdNode, effbd2_ControlFlowEdge, effbd2_Transformed, EffbdNode, EffbdElement, effbd2_SequenceNode, Transformer, effbd2_FunctionSpecification, effbd2_Input, effbd2_Control, effbd2_Resource, effbd2_Out, effbd2_FunctionDefinition, effbd2_EffbdElement, effbd2_Fork, SequenceNode, effbd2_Decision, effbd2_ItemContent, effbd2_ContinuousFlowItem, Transformed, effbd2_DataFlowOutputEdge, effbd2_TriggerItem, effbd2_In, DataPort, effbd2_DataPort, In, effbd2_Transformer, effbd2_DataFlowInputEdge, DataFlowEdge, effbd2_LoopEnd, effbd2_IterationEnd, effbd2_IterationStart, effbd2_LoopExit, effbd2_Join, effbd2_Merge, effbd2_Start, effbd2_Final, effbd2_LoopStart, FunctionDomain},
    associations={decompositions6, dataEdges0, effbdNodes1, controlEdges3, inputPorts8, controlPorts9, resourcePorts11, outputPort13, definitions15, inputFrom23, content17, inputTo25, outputFrom27, ouputTo29, from_18, to20},
    generalizations={gen_effbd2_Function_FunctionSpecification, gen_effbd2_Transformed_EffbdNode, gen_effbd2_DataFlowEdge_EffbdElement, gen_effbd2_EffbdNode_EffbdElement, gen_effbd2_SequenceNode_Transformer, gen_effbd2_FunctionSpecification_Transformer, gen_effbd2_Fork_SequenceNode, gen_effbd2_Decision_SequenceNode, gen_effbd2_ContinuousFlowItem_Transformed, gen_effbd2_DataFlowOutputEdge_DataFlowEdge, gen_effbd2_TriggerItem_Transformed, gen_effbd2_In_DataPort, gen_effbd2_Out_DataPort, gen_effbd2_Resource_In, gen_effbd2_Control_In, gen_effbd2_Input_In, gen_effbd2_ControlFlowEdge_EffbdElement, gen_effbd2_Transformer_EffbdNode, gen_effbd2_DataFlowInputEdge_DataFlowEdge, gen_effbd2_LoopEnd_SequenceNode, gen_effbd2_IterationEnd_SequenceNode, gen_effbd2_IterationStart_SequenceNode, gen_effbd2_LoopExit_SequenceNode, gen_effbd2_Join_SequenceNode, gen_effbd2_Merge_SequenceNode, gen_effbd2_Start_SequenceNode, gen_effbd2_Final_SequenceNode, gen_effbd2_LoopStart_SequenceNode},
    metadata=None
)
