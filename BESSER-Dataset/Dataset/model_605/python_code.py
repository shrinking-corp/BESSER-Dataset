...
class SMVC_Entity:
    ...
    def __init__(self, name: str, SMVC_Entity17: "SMVC_DataAccessObject" = None, SMVC_Entity: "SMVC_SMVCApplication" = None, SMVC_Entity19: set["SMVC_Attribute"] = None, SMVC_Entity22: "SMVC_Attribute" = None, SMVC_Entity30: "SMVC_EntityComponent" = None):
        self.name = name
...
class SMVC_DataAccessObject:
    ...
    def __init__(self, name: str, showDirectInstancesOnly: bool, SMVC_DataAccessObject16: "SMVC_Entity" = None, SMVC_DataAccessObject: "SMVC_SMVCApplication" = None, SMVC_DataAccessObject14: "SMVC_EntityController" = None):
        self.name = name
        ...
        pass
    @property
    def showDirectInstancesOnly(self):
...
class SMVC_SMVCApplication:
    ...
    def __init__(self, name: str, SMVC_SMVCApplication: "SMVC_Controller" = None, SMVC_SMVCApplication2: set["SMVC_Controller"] = None, SMVC_SMVCApplication5: set["SMVC_DataAccessObject"] = None, SMVC_SMVCApplication7: set["SMVC_Entity"] = None):
        self.name = name
