...
# Classes
SmartHouse_House = Class(name="SmartHouse_House")
SmartHouse_Person = Class(name="SmartHouse_Person")
SmartHouse_WaterHeater = Class(name="SmartHouse_WaterHeater")
SmartHouse_EV = Class(name="SmartHouse_EV")
SmartHouse_Gate = Class(name="SmartHouse_Gate")
SmartHouse_Security = Class(name="SmartHouse_Security")
SmartHouse_Room = Class(name="SmartHouse_Room")
SmartHouse_Window = Class(name="SmartHouse_Window")
SmartHouse_Heating = Class(name="SmartHouse_Heating")
SmartHouse_Cooker = Class(name="SmartHouse_Cooker")
SmartHouse_WashingMachine = Class(name="SmartHouse_WashingMachine")
SmartHouse_CoffeeMaker = Class(name="SmartHouse_CoffeeMaker")
SmartHouse_Light = Class(name="SmartHouse_Light")
SmartHouse_AirConditioner = Class(name="SmartHouse_AirConditioner")
SmartHouse_Sensor = Class(name="SmartHouse_Sensor")
SmartHouse_Projector = Class(name="SmartHouse_Projector")
...
SmartHouse_House.attributes={SmartHouse_House_eprice, SmartHouse_House_outtemp, SmartHouse_House_time, SmartHouse_House_name}
...
SmartHouse_WaterHeater.attributes={SmartHouse_WaterHeater_on, SmartHouse_WaterHeater_boost, SmartHouse_WaterHeater_temp}
...
SmartHouse_EV.attributes={SmartHouse_EV_level, SmartHouse_EV_name, SmartHouse_EV_charging, SmartHouse_EV_pluged}
...
SmartHouse_Room.attributes={SmartHouse_Room_air, SmartHouse_Room_temp, SmartHouse_Room_bright, SmartHouse_Room_name}
...
SmartHouse_Window.attributes={SmartHouse_Window_name, SmartHouse_Window_curtainOn, SmartHouse_Window_opened}
...
SmartHouse_WashingMachine.attributes={SmartHouse_WashingMachine_loaded, SmartHouse_WashingMachine_on}
...
SmartHouse_CoffeeMaker.attributes={SmartHouse_CoffeeMaker_warming, SmartHouse_CoffeeMaker_on, SmartHouse_CoffeeMaker_loaded}
...
SmartHouse_Sensor.attributes={SmartHouse_Sensor_battery, SmartHouse_Sensor_brightness, SmartHouse_Sensor_temp, SmartHouse_Sensor_air, SmartHouse_Sensor_circle}
...
SmartHouse_Projector.attributes={SmartHouse_Projector_volume, SmartHouse_Projector_brightness, SmartHouse_Projector_on}
...
domain_model = DomainModel(
    name="SmartHouse",
    types={SmartHouse_House, SmartHouse_Person, SmartHouse_WaterHeater, SmartHouse_EV, SmartHouse_Gate, SmartHouse_Security, SmartHouse_Room, SmartHouse_Window, SmartHouse_Heating, SmartHouse_Cooker, SmartHouse_WashingMachine, SmartHouse_CoffeeMaker, SmartHouse_Light, SmartHouse_AirConditioner, SmartHouse_Sensor, SmartHouse_Projector},
    associations={room0, member1, wh2, ev4, gate6, sec8, house10, house11, house15, house17, window19, heating20, house13, projector31, cooker33, wm35, cm37, room39, light22, ac24, occupied26, sensor29, room41, room43, room45},
    generalizations={},
    metadata=None
)
