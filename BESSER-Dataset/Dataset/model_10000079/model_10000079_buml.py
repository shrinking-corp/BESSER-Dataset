...
transaction_Transaction.attributes={transaction_Transaction_type, transaction_Transaction_id, transaction_Transaction_amount, transaction_Transaction_transactionTime}
...
mypackage_Login.attributes={mypackage_Login_password, mypackage_Login_username, mypackage_Login_securityQuestion, mypackage_Login_lastLoginTime, mypackage_Login_securityAnswer}
...
mypackage_Customer.attributes={mypackage_Customer_name, mypackage_Customer_address, mypackage_Customer_dateOfBirth, mypackage_Customer_phoneNumber, mypackage_Customer_emailAddress}
...
domain_model = DomainModel(
    name="_0b834b23_f5f9_4abe_8ca1_8beb5aa0826e",
    types={transaction_Transaction, transaction_DepositTransaction, transaction_WithdrawTransaction, transaction_TransferTransaction, account_SavingsAccount, account_CheckingAccount, account_Account, mypackage_Login, mypackage_Customer, transaction_TransactionType, account_AccountType},
