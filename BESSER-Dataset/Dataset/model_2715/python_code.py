...
class Kasu3_ClassB:
    ...
    def __init__(self, Name: str, Kasu3_ClassB: "Kasu3_ClassA" = None, Kasu3_ClassB2: "Kasu3_ClassA" = None):
        self.Name = Name
...
class Kasu3_ClassA:
    ...
    def __init__(self, Name: str, Kasu3_ClassA: set["Kasu3_ClassB"] = None, Kasu3_ClassA3: "Kasu3_ClassB" = None):
        self.Name = Name
