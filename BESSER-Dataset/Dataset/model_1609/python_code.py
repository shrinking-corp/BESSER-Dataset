...
class pnmlcoremodel_Font:
    ...
    def __init__(self, style: str, weight: str, align: str, decoration: str, family: str, rotation: str, size: str, Font: "pnmlcoremodel_AnnotationGraphics" = None, font: "pnmlcoremodel_AnnotationGraphics" = None):
        self.style = style
        self.weight = weight
        self.align = align
...
class pnmlcoremodel_Fill:
    ...
    def __init__(self, color: str, gradientcolor: str, gradientrotation: str, image: str, Fill: "pnmlcoremodel_NodeGraphics" = None, fill: "pnmlcoremodel_NodeGraphics" = None, fill60: "pnmlcoremodel_AnnotationGraphics" = None, Fill50: "pnmlcoremodel_AnnotationGraphics" = None):
        self.color = color
...
class pnmlcoremodel_Line:
    ...
    def __init__(self, color: str, shape: str, width: str, style: str, Line53: "pnmlcoremodel_AnnotationGraphics" = None, Line74: "pnmlcoremodel_ArcGraphics" = None, line: "pnmlcoremodel_NodeGraphics" = None, line65: "pnmlcoremodel_ArcGraphics" = None, line68: "pnmlcoremodel_AnnotationGraphics" = None, Line: "pnmlcoremodel_NodeGraphics" = None):
        self.color = color
        self.shape = shape
        self.width = width
        self.style = style
...
class pnmlcoremodel_PnObject(ABC):
    ...
    def __init__(self, id: str, PnObject21: "pnmlcoremodel_Name" = None, PnObject: "pnmlcoremodel_Page" = None, containerNamePnObject: "pnmlcoremodel_Name" = None, containerPnObject: set["pnmlcoremodel_ToolInfo"] = None, PnObject26: "pnmlcoremodel_ToolInfo" = None, objects: "pnmlcoremodel_Page" = None):
        self.id = id
...
class pnmlcoremodel_Name(Annotation):
    ...
    def __init__(self, text: str, Name: "pnmlcoremodel_PetriNet" = None, name: "pnmlcoremodel_PetriNet" = None, name20: "pnmlcoremodel_PnObject" = None, Name12: "pnmlcoremodel_PnObject" = None):
        self.text = text
        self.Name = Name
        self.name = name
        self.name20 = name20
...
class pnmlcoremodel_PetriNet:
    ...
    def __init__(self, id: str, type: str, nets: "pnmlcoremodel_PetriNetDoc" = None, PetriNet: "pnmlcoremodel_PetriNetDoc" = None, containerPetriNet: set["pnmlcoremodel_Page"] = None, containerNamePetriNet: "pnmlcoremodel_Name" = None, containerPetriNet4: set["pnmlcoremodel_ToolInfo"] = None, PetriNet18: "pnmlcoremodel_Name" = None, PetriNet8: "pnmlcoremodel_Page" = None, PetriNet23: "pnmlcoremodel_ToolInfo" = None):
        self.id = id
        self.type = type
        self.nets = nets
