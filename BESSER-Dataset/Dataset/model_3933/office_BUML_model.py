...
# Classes
office_OfficeModel = Class(name="office_OfficeModel")
NamedElement = Class(name="NamedElement")
office_OfficeElement = Class(name="office_OfficeElement", is_abstract=True)
office_Employee = Class(name="office_Employee")
OfficeElement = Class(name="OfficeElement")
office_Office = Class(name="office_Office")
office_NamedElement = Class(name="office_NamedElement", is_abstract=True)
