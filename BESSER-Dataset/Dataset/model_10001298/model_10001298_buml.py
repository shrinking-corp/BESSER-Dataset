...
HouseHolds.attributes={HouseHolds_DishWasher, HouseHolds_TimeID, HouseHolds_Alarm, HouseHolds_WashingMachine, HouseHolds_Coffee}
...
domain_model = DomainModel(
    name="_9f510af6_1690_4d09_b973_5069cf83647a",
    types={System, Sensor, Motion_Sensor, PressureSensor, Home_Security_System, Alert, Door, Camera, Speakers, MicroPhone, Light, Start_Of_Day, End_Of_Day, TV, HomeTheatre, HouseHolds, Entertainment},
    associations={TV_Entertainment, Speakers_Entertainment, HomeTheatre_Entertainment, Sensor_Door, Door_Camera, HomeTheatre_TV, HomeTheatre_Speakers, HouseHolds_Start_Of_Day, HouseHolds_End_Of_Day, MicroPhone_System, Home_Security_System_Alert, Sensor_System, System_HouseHolds, HomeTheatre_System, Home_Security_System_System},
    generalizations={},
    metadata=None
)
