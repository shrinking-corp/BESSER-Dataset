...
errormanypov_B = Class(name="errormanypov_B")
errormanypov_E = Class(name="errormanypov_E")
errormanypov_J = Class(name="errormanypov_J")
errormanypov_A = Class(name="errormanypov_A")
errormanypov_M = Class(name="errormanypov_M")
errormanypov_C = Class(name="errormanypov_C")
errormanypov_Named = Class(name="errormanypov_Named")
errormanypov_F = Class(name="errormanypov_F")
errormanypov_JK = Class(name="errormanypov_JK")
errormanypov_K = Class(name="errormanypov_K")
...
domain_model = DomainModel(
    name="errormanypov",
    types={Named, errormanypov_B, errormanypov_E, errormanypov_J, errormanypov_A, errormanypov_M, errormanypov_C, errormanypov_Named, errormanypov_F, errormanypov_JK, errormanypov_K},
    associations={bs0, es1, js3, ms11, cs12, ks15, cs5, fs7, jks9},
    generalizations={gen_errormanypov_A_Named, gen_errormanypov_B_Named, gen_errormanypov_JK_Named, gen_errormanypov_M_Named, gen_errormanypov_C_Named, gen_errormanypov_E_Named, gen_errormanypov_F_Named, gen_errormanypov_J_Named, gen_errormanypov_K_Named},
    metadata=None
)
