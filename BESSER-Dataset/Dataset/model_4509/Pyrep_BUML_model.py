...
# Classes
pyrep_Model = Class(name="pyrep_Model")
pyrep_Entity = Class(name="pyrep_Entity")
pyrep_Environment = Class(name="pyrep_Environment")
Entity = Class(name="Entity")
pyrep_IP = Class(name="pyrep_IP")
pyrep_Robot = Class(name="pyrep_Robot")
pyrep_AbstractDataMove = Class(name="pyrep_AbstractDataMove")
pyrep_AbstractMove = Class(name="pyrep_AbstractMove")
AbstractDataMove = Class(name="AbstractDataMove")
pyrep_DataMove = Class(name="pyrep_DataMove")
pyrep_AbstractCrossMove = Class(name="pyrep_AbstractCrossMove")
pyrep_MoveCollection = Class(name="pyrep_MoveCollection")
pyrep_Wheel = Class(name="pyrep_Wheel")
pyrep_Move = Class(name="pyrep_Move")
DataMove = Class(name="DataMove")
pyrep_Turn = Class(name="pyrep_Turn")
pyrep_Sensor = Class(name="pyrep_Sensor")
pyrep_TypeSensor = Class(name="pyrep_TypeSensor")
...
pyrep_IP.attributes={pyrep_IP_ip, pyrep_IP_name}
...
pyrep_DataMove.attributes={pyrep_DataMove_name, pyrep_DataMove_type, pyrep_DataMove_velocity}
...
domain_model = DomainModel(
    name="pyrep",
    types={pyrep_Model, pyrep_Entity, pyrep_Environment, Entity, pyrep_IP, pyrep_Robot, pyrep_AbstractDataMove, pyrep_AbstractMove, AbstractDataMove, pyrep_DataMove, pyrep_AbstractCrossMove, pyrep_MoveCollection, pyrep_Wheel, pyrep_Move, DataMove, pyrep_Turn, pyrep_Sensor, pyrep_TypeSensor},
    associations={environment0, ip1, robot8, moves11, typeM13, typeM14, robots2, moves4, wheels6, type16},
    generalizations={gen_pyrep_Environment_Entity, gen_pyrep_AbstractMove_AbstractDataMove, gen_pyrep_AbstractCrossMove_AbstractDataMove, gen_pyrep_DataMove_Entity, gen_pyrep_Robot_Entity, gen_pyrep_IP_Entity, gen_pyrep_Wheel_Entity, gen_pyrep_MoveCollection_Entity, gen_pyrep_Move_DataMove, gen_pyrep_Turn_DataMove, gen_pyrep_Sensor_Entity, gen_pyrep_TypeSensor_Entity},
    metadata=None
)
