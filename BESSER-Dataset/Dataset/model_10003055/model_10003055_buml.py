...
ComponentenLijst = Class(name="ComponentenLijst")
...
ClassA.attributes={ClassA_protectedAttribute, ClassA_publicAttribute, ClassA_privateAttribute, ClassA_packageAttribute}
...
# ComponentenLijst class attributes and methods
ComponentenLijst_componentenlijst: Property = Property(name="componentenlijst", type=StringType)
ComponentenLijst.attributes={ComponentenLijst_componentenlijst}

# Component class attributes and methods
Component_model: Property = Property(name="model", type=StringType)
Component_type: Property = Property(name="type", type=StringType)
Component_prijs: Property = Property(name="prijs", type=FloatType)
Component_beschikbaarheidspercentage: Property = Property(name="beschikbaarheidspercentage", type=FloatType)
Component.attributes={Component_beschikbaarheidspercentage, Component_model, Component_type, Component_prijs}
...
domain_model = DomainModel(
    name="f966575f_5639_435f_a68e_514930f77ac2",
    types={BankAccount, ClassA, ClassB, ClassC, ClassD, ClassE, ClassF, ClassG, ClassJ, ClassH, ClassK, ClassL, ClassM, ClassN, ClassP, InterfaceO_Interface, ClassQ, ClassR, ClassS, ClassT, ClassU, ClassV, ComponentenLijst, Component},
