...
def test_hyp_componentenlijst_is_not_abstract():
    assert not inspect.isabstract(ComponentenLijst)


def test_hyp_componentenlijst_constructor_exists():
    assert callable(ComponentenLijst.__init__)


def test_hyp_componentenlijst_constructor_args():
...
@given(instance=Component_strategy)
def test_hyp_component_model_setter(instance):
...
@given(instance=Component_strategy)
def test_hyp_component_prijs_setter(instance):
...
@given(instance=Component_strategy)
def test_hyp_component_beschikbaarheidspercentage_setter(instance):
...
def test_hyp_componentenlijst_componentenlijst_setter(instance):
