...
domain_model = DomainModel(
    name="_6pZu0OsnEemtRYNXkUdu3A",
    types={Student, Employee_Interface, Teacher, HOD, Department, Course, Authentication, Access_Information, Attendance, Subject, Admin, Class_},
