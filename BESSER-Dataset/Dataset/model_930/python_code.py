...
class uma_DiagramLink(DiagramElement):
    ...
    def __init__(self, zoom: str, uma_DiagramLink: "uma_Point" = None, link: "uma_GraphElement" = None, diagramLink: "uma_Diagram" = None, DiagramLink: "uma_GraphElement" = None, DiagramLink109: "uma_Diagram" = None):
        self.zoom = zoom
...
class uma_Point:
    ...
    def __init__(self, x: str, y: str, uma_Point89: "uma_DiagramLink" = None, uma_Point: "uma_GraphElement" = None, uma_Point105: "uma_GraphEdge" = None, uma_Point107: "uma_Diagram" = None, uma_Point118: "uma_Polyline" = None, uma_Point120: "uma_Ellipse" = None):
        self.x = x
        self.y = y
...
class uma_Section(VariabilityElement):
    ...
    def __init__(self, sectionName: str, sectionDescription: str, uma_Section21: "uma_Section" = None, uma_Section19: set["uma_Section"] = None, uma_Section24: "uma_Section" = None, uma_Section22: "uma_Section" = None, uma_Section: "uma_ContentDescription" = None, uma_Section203: "uma_TaskDescriptor" = None):
...
class uma_DiagramElement(MethodElement):
    ...
    def __init__(self, isVisible: str, contained: "uma_GraphElement" = None, referenced: set["uma_Reference"] = None, uma_DiagramElement: set["uma_Property"] = None, DiagramElement: "uma_GraphElement" = None, DiagramElement101: "uma_Reference" = None):
...
class uma_MethodPackage(Package, MethodElement):
    ...
    def __init__(self, global_: str, uma_MethodPackage: "uma_MethodPackage" = None, uma_MethodPackage71: set["uma_MethodPackage"] = None, uma_MethodPackage75: "uma_MethodPackage" = None, uma_MethodPackage73: set["uma_MethodPackage"] = None, uma_MethodPackage304: "uma_MethodPlugin" = None, uma_MethodPackage317: "uma_MethodConfiguration" = None):
...
class uma_MethodPlugin(Package, MethodUnit):
    ...
    def __init__(self, userChangeable: str, uma_MethodPlugin: set["uma_MethodPackage"] = None, uma_MethodPlugin307: "uma_MethodPlugin" = None, uma_MethodPlugin305: set["uma_MethodPlugin"] = None, uma_MethodPlugin314: "uma_MethodConfiguration" = None, uma_MethodPlugin336: "uma_MethodLibrary" = None):
...
class uma_WorkProductDescriptor(Descriptor):
    ...
    def __init__(self, activityEntryState: str, activityExitState: str, uma_WorkProductDescriptor: "uma_RoleDescriptor" = None, uma_WorkProductDescriptor300: "uma_ProcessComponentInterface" = None, uma_WorkProductDescriptor163: "uma_RoleDescriptor" = None, uma_WorkProductDescriptor168: "uma_WorkProduct" = None, WorkProductDescriptor: "uma_WorkProductDescriptor" = None, impacts: set["uma_WorkProductDescriptor"] = None, WorkProductDescriptor174: "uma_WorkProductDescriptor" = None, impactedBy: set["uma_WorkProductDescriptor"] = None, uma_WorkProductDescriptor177: "uma_WorkProductDescriptor" = None, uma_WorkProductDescriptor175: set["uma_WorkProductDescriptor"] = None, uma_WorkProductDescriptor188: "uma_TaskDescriptor" = None, uma_WorkProductDescriptor191: "uma_TaskDescriptor" = None, uma_WorkProductDescriptor194: "uma_TaskDescriptor" = None, uma_WorkProductDescriptor197: "uma_TaskDescriptor" = None):
...
class uma_Activity(VariabilityElement, WorkDefinition, WorkBreakdownElement):
    ...
    def __init__(self, isEnactable: str, uma_Activity124: set["uma_SupportingMaterial"] = None, uma_Activity127: set["uma_Checklist"] = None, uma_Activity130: set["uma_Concept"] = None, uma_Activity133: set["uma_Example"] = None, uma_Activity136: set["uma_Guideline"] = None, uma_Activity139: set["uma_ReusableAsset"] = None, superActivities: set["uma_BreakdownElement"] = None, uma_Activity: set["uma_Roadmap"] = None, uma_Activity213: "uma_Practice" = None, uma_Activity254: "uma_Discipline" = None, Activity: "uma_BreakdownElement" = None):
