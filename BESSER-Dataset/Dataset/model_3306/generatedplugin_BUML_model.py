...
# Classes
generatedplugin_DublinCore = Class(name="generatedplugin_DublinCore")
generatedplugin_Plugin = Class(name="generatedplugin_Plugin")
generatedplugin_Extension = Class(name="generatedplugin_Extension")
generatedplugin_StemCategory = Class(name="generatedplugin_StemCategory")
...
generatedplugin_DublinCore.attributes={generatedplugin_DublinCore_bibliographicCitation, generatedplugin_DublinCore_contributor, generatedplugin_DublinCore_spatial, generatedplugin_DublinCore_requires, generatedplugin_DublinCore_creator, generatedplugin_DublinCore_identifier, generatedplugin_DublinCore_subject, generatedplugin_DublinCore_created, generatedplugin_DublinCore_license, generatedplugin_DublinCore_categoryId, generatedplugin_DublinCore_title, generatedplugin_DublinCore_publisher, generatedplugin_DublinCore_relation, generatedplugin_DublinCore_rights, generatedplugin_DublinCore_language, generatedplugin_DublinCore_description, generatedplugin_DublinCore_format, generatedplugin_DublinCore_date, generatedplugin_DublinCore_coverage, generatedplugin_DublinCore_type, generatedplugin_DublinCore_source, generatedplugin_DublinCore_valid}
...
generatedplugin_StemCategory.attributes={generatedplugin_StemCategory_id, generatedplugin_StemCategory_parentId, generatedplugin_StemCategory_name}
...
domain_model = DomainModel(
    ...
    types={generatedplugin_DublinCore, generatedplugin_Plugin, generatedplugin_Extension, generatedplugin_StemCategory},
    associations={dublinCores1, extensionelement3, categories0},
    generalizations={},
    metadata=None
)
