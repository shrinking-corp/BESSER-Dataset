...
class generatedplugin_Extension:
    ...
    def __init__(self, point: str, generatedplugin_Extension4: "generatedplugin_Plugin" = None, generatedplugin_Extension: set["generatedplugin_StemCategory"] = None, generatedplugin_Extension2: set["generatedplugin_DublinCore"] = None):
        self.point = point
...
class generatedplugin_DublinCore:
    ...
    def __init__(self, categoryId: str, bibliographicCitation: str, identifier: str, language: str, license: str, publisher: str, relation: str, requires: str, rights: str, source: str, spatial: str, contributor: str, coverage: str, created: str, creator: str, date: str, description: str, format: str, subject: str, title: str, type: str, valid: str, generatedplugin_DublinCore: "generatedplugin_Extension" = None):
