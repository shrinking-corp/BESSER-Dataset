...
# Classes
chartDsl_Company = Class(name="chartDsl_Company")
chartDsl_Employee = Class(name="chartDsl_Employee")
chartDsl_Project = Class(name="chartDsl_Project")
chartDsl_Task = Class(name="chartDsl_Task")
...
chartDsl_Project.attributes={chartDsl_Project_projectType, chartDsl_Project_name}
