...
# Classes
mytry_Library = Class(name="mytry_Library")
mytry_Book = Class(name="mytry_Book")
mytry_Author = Class(name="mytry_Author")
...
domain_model = DomainModel(
    name="mytry",
    types={mytry_Library, mytry_Book, mytry_Author},
    associations={books0, authors1, authors3, books4},
    generalizations={},
    metadata=None
)
