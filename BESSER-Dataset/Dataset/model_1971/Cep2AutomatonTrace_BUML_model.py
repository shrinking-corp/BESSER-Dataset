...
trace_TimedZoneTrace = Class(name="trace_TimedZoneTrace")
trace_EventPattern = Class(name="trace_EventPattern")
trace_Automaton = Class(name="trace_Automaton")
trace_TimedZone = Class(name="trace_TimedZone")
