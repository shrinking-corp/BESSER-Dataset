...
class Registration:
    ...
    def __init__(self, name: str, LastName: str, DOB: str, UserName: str, Password: str, Address: str, Phone: int, Email: str, admin11: "Admin" = None, person19: "Person" = None):
        self.name = name
...
class Person:
    ...
    def __init__(self, Name: str, LastName: str, DOB: str, Address: str, Phone: int, Email: str, product12: "Product" = None, registration18: "Registration" = None):
        self.Name = Name
        self.LastName = LastName
        self.DOB = DOB
        self.Address = Address
