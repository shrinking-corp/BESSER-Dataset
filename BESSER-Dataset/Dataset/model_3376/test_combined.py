...
@given(instance=DML_DDL_Fk_strategy)
def test_hyp_dml_ddl_fk_type_setter(instance):
...
def test_DML_DDL_Fk_columnName_value_roundtrip():
    instance = DML_DDL_Fk(columnName="sample_text", columnReference="sample_text", nameFk="sample_text", status="sample_text", type="sample_text")
    assert instance.columnName == "sample_text"
    instance.columnName = "sample_text_2"
    assert instance.columnName == "sample_text_2"
...
def test_DML_DDL_Fk_type_value_roundtrip():
    instance = DML_DDL_Fk(columnName="sample_text", columnReference="sample_text", nameFk="sample_text", status="sample_text", type="sample_text")
...
def test_assoc_columnsFk14_link_reassign_clear():
    a = DML_DDL_Table(commentTable="sample_text", tableName="sample_text")
    b1 = DML_DDL_Fk(columnName="sample_text", columnReference="sample_text", nameFk="sample_text", status="sample_text", type="sample_text")
    b2 = DML_DDL_Fk(columnName="sample_text_2", columnReference="sample_text_2", nameFk="sample_text_2", status="sample_text_2", type="sample_text_2")
...
DML_DDL_Fk_strategy = st.builds(DML_DDL_Fk, columnName=safe_text, columnReference=safe_text, nameFk=safe_text, status=safe_text, type=safe_text)
@given(instance=DML_DDL_Fk_strategy)
@settings(max_examples=25)
