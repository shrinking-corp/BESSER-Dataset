...
def test_user_business_has_description():
...
def test_user_business_has_logo():
...
def test_user_business_has_gallery():
...
def test_user_business_has_mapRef():
...
def test_user_business_has_providers():
...
def test_user_business_has_subCategories():
...
@given(instance=user_Business_strategy)
def test_user_business_description_setter(instance):
    original = instance.description
    instance.description = original
    assert instance.description == original
...
@given(instance=user_Business_strategy)
def test_user_business_logo_setter(instance):
...
@given(instance=user_Business_strategy)
def test_user_business_gallery_setter(instance):
...
@given(instance=user_Business_strategy)
def test_user_business_mapRef_setter(instance):
...
@given(instance=user_Business_strategy)
def test_user_business_providers_setter(instance):
...
@given(instance=user_Business_strategy)
def test_user_business_subCategories_setter(instance):
