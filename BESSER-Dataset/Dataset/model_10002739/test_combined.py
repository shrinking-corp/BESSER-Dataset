...
def test_hyp_system_category_is_not_abstract():
    assert not inspect.isabstract(system_Category)


def test_hyp_system_category_constructor_exists():
    assert callable(system_Category.__init__)


def test_hyp_system_category_constructor_args():
...
def test_hyp_system_category_has_id():
...
def test_hyp_system_category_has_icon():
...
def test_hyp_system_category_has_name():
...
def test_hyp_system_category_has_parent():
...
def test_hyp_system_category_has_section():
...
def test_hyp_marketing_review_is_not_abstract():
    assert not inspect.isabstract(marketing_Review)


def test_hyp_marketing_review_constructor_exists():
    assert callable(marketing_Review.__init__)


def test_hyp_marketing_review_constructor_args():
...
def test_hyp_marketing_review_has_description():
...
def test_hyp_marketing_review_has_product():
...
def test_hyp_marketing_review_has_user():
...
def test_hyp_marketing_review_has_id():
...
def test_hyp_marketing_review_has_rating():
...
def test_hyp_marketing_product_is_not_abstract():
    assert not inspect.isabstract(marketing_Product)


def test_hyp_marketing_product_constructor_exists():
    assert callable(marketing_Product.__init__)


def test_hyp_marketing_product_constructor_args():
...
def test_hyp_marketing_product_has_expires():
...
def test_hyp_marketing_product_has_ccategory():
...
def test_hyp_marketing_product_has_name():
...
def test_hyp_marketing_product_has_created():
...
def test_hyp_marketing_product_has_id():
...
def test_hyp_marketing_product_has_reviews():
...
def test_hyp_marketing_product_has_price():
...
def test_hyp_marketing_product_has_busId():
...
def test_hyp_marketing_product_has_active():
...
def test_hyp_user_tags_is_not_abstract():
    assert not inspect.isabstract(user_Tags)


def test_hyp_user_tags_constructor_exists():
    assert callable(user_Tags.__init__)


def test_hyp_user_tags_constructor_args():
...
def test_hyp_user_business_is_not_abstract():
    assert not inspect.isabstract(user_Business)


def test_hyp_user_business_constructor_exists():
    assert callable(user_Business.__init__)


def test_hyp_user_business_constructor_args():
    ...
    assert "gallery" in params, "Missing parameter 'gallery'"
    assert "name" in params, "Missing parameter 'name'"
    assert "id" in params, "Missing parameter 'id'"
    assert "products" in params, "Missing parameter 'products'"
    assert "mapRef" in params, "Missing parameter 'mapRef'"
    assert "staffUsers" in params, "Missing parameter 'staffUsers'"
    assert "providers" in params, "Missing parameter 'providers'"
    assert "subCategories" in params, "Missing parameter 'subCategories'"
    assert "email" in params, "Missing parameter 'email'"

def test_hyp_user_business_has_avgRatings():
...
def test_hyp_user_business_has_description():
    assert hasattr(user_Business, "description")
    descriptor = None
    for klass in user_Business.__mro__:
        if "description" in klass.__dict__:
            descriptor = klass.__dict__["description"]
...
def test_hyp_user_business_has_logo():
    assert hasattr(user_Business, "logo")
    descriptor = None
    for klass in user_Business.__mro__:
...
def test_hyp_user_business_has_adminUser():
...
def test_hyp_user_business_has_website():
...
def test_hyp_user_business_has_phone():
...
def test_hyp_user_business_has_address():
...
def test_hyp_user_business_has_category():
...
def test_hyp_user_business_has_tags():
...
def test_hyp_user_business_has_gallery():
    assert hasattr(user_Business, "gallery")
    descriptor = None
    for klass in user_Business.__mro__:
        if "gallery" in klass.__dict__:
            descriptor = klass.__dict__["gallery"]
            break
    assert isinstance(descriptor, property)

def test_hyp_user_business_has_name():
...
def test_hyp_user_business_has_id():
...
def test_hyp_user_business_has_products():
...
def test_hyp_user_business_has_mapRef():
    assert hasattr(user_Business, "mapRef")
    descriptor = None
    for klass in user_Business.__mro__:
        if "mapRef" in klass.__dict__:
            descriptor = klass.__dict__["mapRef"]
            break
    assert isinstance(descriptor, property)

def test_hyp_user_business_has_staffUsers():
...
def test_hyp_user_business_has_providers():
    assert hasattr(user_Business, "providers")
    descriptor = None
    for klass in user_Business.__mro__:
        if "providers" in klass.__dict__:
            descriptor = klass.__dict__["providers"]
            break
    assert isinstance(descriptor, property)

def test_hyp_user_business_has_subCategories():
    assert hasattr(user_Business, "subCategories")
    descriptor = None
    for klass in user_Business.__mro__:
        if "subCategories" in klass.__dict__:
            descriptor = klass.__dict__["subCategories"]
            break
    assert isinstance(descriptor, property)

def test_hyp_user_business_has_email():
...
def test_hyp_user_provider_is_not_abstract():
    assert not inspect.isabstract(user_Provider)


def test_hyp_user_provider_constructor_exists():
    assert callable(user_Provider.__init__)


def test_hyp_user_provider_constructor_args():
...
def test_hyp_user_address_is_not_abstract():
    assert not inspect.isabstract(user_Address)


def test_hyp_user_address_constructor_exists():
    assert callable(user_Address.__init__)


def test_hyp_user_address_constructor_args():
...
def test_hyp_user_address_has_postcode():
...
def test_hyp_user_address_has_state():
...
def test_hyp_user_address_has_street():
...
def test_hyp_user_address_has_suburb():
...
def test_hyp_user_address_has_country():
...
def test_hyp_user_user_is_not_abstract():
    assert not inspect.isabstract(user_User)


def test_hyp_user_user_constructor_exists():
    assert callable(user_User.__init__)


def test_hyp_user_user_constructor_args():
...
def test_hyp_user_user_has_displayName():
...
def test_hyp_user_user_has_interests():
...
def test_hyp_user_user_has_address():
...
def test_hyp_user_user_has_wishlist():
...
def test_hyp_user_user_has_photoURL():
...
def test_hyp_user_user_has_email():
...
def test_hyp_user_user_has_phone():
...
def test_hyp_user_user_has_reviews():
...
def test_hyp_user_user_has_business():
...
def test_hyp_user_user_has_fiirstName():
...
def test_hyp_user_user_has_provider():
...
def test_hyp_user_user_has_purchaseHistory():
...
def test_hyp_user_user_has_lastName():
...
def test_hyp_datatypes_value_is_not_abstract():
    assert not inspect.isabstract(datatypes_Value)


def test_hyp_datatypes_value_constructor_exists():
    assert callable(datatypes_Value.__init__)


def test_hyp_datatypes_value_constructor_args():
...
def test_hyp_datatypes_array_is_not_abstract():
    assert not inspect.isabstract(datatypes_Array)


def test_hyp_datatypes_array_constructor_exists():
    assert callable(datatypes_Array.__init__)


def test_hyp_datatypes_array_constructor_args():
    sig = inspect.signature(datatypes_Array.__init__)
    params = list(sig.parameters.keys())
    assert "data" in params, "Missing parameter 'data'"

def test_hyp_datatypes_array_has_data():
...
def test_hyp_datatypes_bool_is_not_abstract():
    assert not inspect.isabstract(datatypes_Bool)


def test_hyp_datatypes_bool_constructor_exists():
    assert callable(datatypes_Bool.__init__)


def test_hyp_datatypes_bool_constructor_args():
...
def test_hyp_datatypes_string_is_not_abstract():
    assert not inspect.isabstract(datatypes_String)


def test_hyp_datatypes_string_constructor_exists():
    assert callable(datatypes_String.__init__)


def test_hyp_datatypes_string_constructor_args():
    sig = inspect.signature(datatypes_String.__init__)
    params = list(sig.parameters.keys())
    assert "data" in params, "Missing parameter 'data'"

def test_hyp_datatypes_string_has_data():
...
def test_hyp_datatypes_number_is_not_abstract():
    assert not inspect.isabstract(datatypes_Number)


def test_hyp_datatypes_number_constructor_exists():
    assert callable(datatypes_Number.__init__)


def test_hyp_datatypes_number_constructor_args():
...
def test_hyp_datatypes_json_is_not_abstract():
    assert not inspect.isabstract(datatypes_Json)


def test_hyp_datatypes_json_constructor_exists():
    assert callable(datatypes_Json.__init__)


def test_hyp_datatypes_json_constructor_args():
    sig = inspect.signature(datatypes_Json.__init__)
    params = list(sig.parameters.keys())
    assert "values" in params, "Missing parameter 'values'"

def test_hyp_datatypes_json_has_values():
...
def test_hyp_datatypes_documents_is_not_abstract():
    assert not inspect.isabstract(datatypes_Documents)


def test_hyp_datatypes_documents_constructor_exists():
    assert callable(datatypes_Documents.__init__)


def test_hyp_datatypes_documents_constructor_args():
...
def test_hyp_datatypes_documents_has_tab_counter():
...
def test_hyp_datatypes_documents_has_data():
...
def test_hyp_datatypes_documents_has_file_name():
...
def test_hyp_datatypes_documents_has_file():
...
def test_hyp_system_category_instantiation(instance):
    assert isinstance(instance, system_Category)



@given(instance=system_Category_strategy)
def test_hyp_system_category_id_setter(instance):
...
@given(instance=system_Category_strategy)
def test_hyp_system_category_icon_setter(instance):
...
@given(instance=system_Category_strategy)
def test_hyp_system_category_name_setter(instance):
...
@given(instance=system_Category_strategy)
def test_hyp_system_category_parent_setter(instance):
...
@given(instance=system_Category_strategy)
def test_hyp_system_category_section_setter(instance):
...
@settings(max_examples=50)
def test_hyp_marketing_review_instantiation(instance):
    assert isinstance(instance, marketing_Review)



@given(instance=marketing_Review_strategy)
def test_hyp_marketing_review_description_setter(instance):
...
@given(instance=marketing_Review_strategy)
def test_hyp_marketing_review_product_setter(instance):
...
@given(instance=marketing_Review_strategy)
def test_hyp_marketing_review_user_setter(instance):
...
@given(instance=marketing_Review_strategy)
def test_hyp_marketing_review_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
@given(instance=marketing_Review_strategy)
def test_hyp_marketing_review_rating_setter(instance):
...
@settings(max_examples=50)
def test_hyp_marketing_product_instantiation(instance):
    assert isinstance(instance, marketing_Product)



@given(instance=marketing_Product_strategy)
def test_hyp_marketing_product_expires_setter(instance):
...
@given(instance=marketing_Product_strategy)
def test_hyp_marketing_product_ccategory_setter(instance):
...
@given(instance=marketing_Product_strategy)
def test_hyp_marketing_product_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=marketing_Product_strategy)
def test_hyp_marketing_product_created_setter(instance):
...
@given(instance=marketing_Product_strategy)
def test_hyp_marketing_product_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
@given(instance=marketing_Product_strategy)
def test_hyp_marketing_product_reviews_setter(instance):
...
@given(instance=marketing_Product_strategy)
def test_hyp_marketing_product_price_setter(instance):
...
@given(instance=marketing_Product_strategy)
def test_hyp_marketing_product_busId_setter(instance):
...
@given(instance=marketing_Product_strategy)
def test_hyp_marketing_product_active_setter(instance):
...
def test_hyp_user_tags_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=user_Tags_strategy)
def test_hyp_user_tags_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
@settings(max_examples=50)
def test_hyp_user_business_instantiation(instance):
    assert isinstance(instance, user_Business)



@given(instance=user_Business_strategy)
def test_hyp_user_business_avgRatings_setter(instance):
...
@given(instance=user_Business_strategy)
def test_hyp_user_business_description_setter(instance):
    original = instance.description
    instance.description = original
    assert instance.description == original
...
@given(instance=user_Business_strategy)
def test_hyp_user_business_logo_setter(instance):
...
@given(instance=user_Business_strategy)
def test_hyp_user_business_adminUser_setter(instance):
...
@given(instance=user_Business_strategy)
def test_hyp_user_business_website_setter(instance):
...
@given(instance=user_Business_strategy)
def test_hyp_user_business_phone_setter(instance):
...
@given(instance=user_Business_strategy)
def test_hyp_user_business_address_setter(instance):
...
@given(instance=user_Business_strategy)
def test_hyp_user_business_category_setter(instance):
...
@given(instance=user_Business_strategy)
def test_hyp_user_business_tags_setter(instance):
...
@given(instance=user_Business_strategy)
def test_hyp_user_business_gallery_setter(instance):
    original = instance.gallery
    instance.gallery = original
    assert instance.gallery == original



@given(instance=user_Business_strategy)
def test_hyp_user_business_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=user_Business_strategy)
def test_hyp_user_business_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
@given(instance=user_Business_strategy)
def test_hyp_user_business_products_setter(instance):
...
@given(instance=user_Business_strategy)
def test_hyp_user_business_mapRef_setter(instance):
    original = instance.mapRef
    instance.mapRef = original
    assert instance.mapRef == original



@given(instance=user_Business_strategy)
def test_hyp_user_business_staffUsers_setter(instance):
...
@given(instance=user_Business_strategy)
def test_hyp_user_business_providers_setter(instance):
    original = instance.providers
    instance.providers = original
    assert instance.providers == original



@given(instance=user_Business_strategy)
def test_hyp_user_business_subCategories_setter(instance):
    original = instance.subCategories
    instance.subCategories = original
    assert instance.subCategories == original



@given(instance=user_Business_strategy)
def test_hyp_user_business_email_setter(instance):
...
def test_hyp_user_provider_uid_setter(instance):
...
@given(instance=user_Provider_strategy)
def test_hyp_user_provider_providerId_setter(instance):
...
@given(instance=user_Provider_strategy)
def test_hyp_user_provider_email_setter(instance):
    original = instance.email
    instance.email = original
    assert instance.email == original
...
@given(instance=user_Provider_strategy)
def test_hyp_user_provider_displayName_setter(instance):
...
@given(instance=user_Provider_strategy)
def test_hyp_user_provider_photoURL_setter(instance):
...
@settings(max_examples=50)
def test_hyp_user_address_instantiation(instance):
    assert isinstance(instance, user_Address)



@given(instance=user_Address_strategy)
def test_hyp_user_address_postcode_setter(instance):
...
@given(instance=user_Address_strategy)
def test_hyp_user_address_state_setter(instance):
...
@given(instance=user_Address_strategy)
def test_hyp_user_address_street_setter(instance):
...
@given(instance=user_Address_strategy)
def test_hyp_user_address_suburb_setter(instance):
...
@given(instance=user_Address_strategy)
def test_hyp_user_address_country_setter(instance):
...
@settings(max_examples=50)
def test_hyp_user_user_instantiation(instance):
    assert isinstance(instance, user_User)



@given(instance=user_User_strategy)
def test_hyp_user_user_displayName_setter(instance):
    original = instance.displayName
    instance.displayName = original
    assert instance.displayName == original
...
@given(instance=user_User_strategy)
def test_hyp_user_user_interests_setter(instance):
...
@given(instance=user_User_strategy)
def test_hyp_user_user_wishlist_setter(instance):
...
@given(instance=user_User_strategy)
def test_hyp_user_user_photoURL_setter(instance):
    original = instance.photoURL
    instance.photoURL = original
    assert instance.photoURL == original
...
@given(instance=user_User_strategy)
def test_hyp_user_user_phone_setter(instance):
    original = instance.phone
    instance.phone = original
    assert instance.phone == original
...
@given(instance=user_User_strategy)
def test_hyp_user_user_reviews_setter(instance):
    original = instance.reviews
    instance.reviews = original
    assert instance.reviews == original
...
@given(instance=user_User_strategy)
def test_hyp_user_user_business_setter(instance):
...
@given(instance=user_User_strategy)
def test_hyp_user_user_fiirstName_setter(instance):
...
@given(instance=user_User_strategy)
def test_hyp_user_user_provider_setter(instance):
...
@given(instance=user_User_strategy)
def test_hyp_user_user_purchaseHistory_setter(instance):
...
@given(instance=user_User_strategy)
def test_hyp_user_user_lastName_setter(instance):
...
def test_hyp_datatypes_value_attribute_setter(instance):
...
@settings(max_examples=50)
def test_hyp_datatypes_array_instantiation(instance):
    assert isinstance(instance, datatypes_Array)



@given(instance=datatypes_Array_strategy)
def test_hyp_datatypes_array_data_setter(instance):
...
def test_hyp_datatypes_bool_data_setter(instance):
    original = instance.data
    instance.data = original
    assert instance.data == original
...
@settings(max_examples=50)
def test_hyp_datatypes_string_instantiation(instance):
    assert isinstance(instance, datatypes_String)



@given(instance=datatypes_String_strategy)
def test_hyp_datatypes_string_data_setter(instance):
    original = instance.data
    instance.data = original
    assert instance.data == original
...
def test_hyp_datatypes_number_data_setter(instance):
    original = instance.data
    instance.data = original
    assert instance.data == original
...
@settings(max_examples=50)
def test_hyp_datatypes_json_instantiation(instance):
    assert isinstance(instance, datatypes_Json)



@given(instance=datatypes_Json_strategy)
def test_hyp_datatypes_json_values_setter(instance):
...
@settings(max_examples=50)
def test_hyp_datatypes_documents_instantiation(instance):
    assert isinstance(instance, datatypes_Documents)



@given(instance=datatypes_Documents_strategy)
def test_hyp_datatypes_documents_tab_counter_setter(instance):
...
@given(instance=datatypes_Documents_strategy)
def test_hyp_datatypes_documents_data_setter(instance):
    original = instance.data
    instance.data = original
    assert instance.data == original
...
@given(instance=datatypes_Documents_strategy)
def test_hyp_datatypes_documents_file_name_setter(instance):
...
@given(instance=datatypes_Documents_strategy)
def test_hyp_datatypes_documents_file_setter(instance):
