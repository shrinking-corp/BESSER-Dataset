...
# Classes
rdpl_ForeignKey = Class(name="rdpl_ForeignKey")
rdpl_Schema = Class(name="rdpl_Schema")
rdpl_Table = Class(name="rdpl_Table")
rdpl_Type = Class(name="rdpl_Type")
rdpl_Column = Class(name="rdpl_Column")
rdpl_Record = Class(name="rdpl_Record")
rdpl_RecordElement = Class(name="rdpl_RecordElement")
...
rdpl_Column.attributes={rdpl_Column_name, rdpl_Column_stype, rdpl_Column_ctype}
...
domain_model = DomainModel(
    name="rdpl",
    types={rdpl_ForeignKey, rdpl_Schema, rdpl_Table, rdpl_Type, rdpl_Column, rdpl_Record, rdpl_RecordElement, BasicType},
    associations={content8, foreignKeys10, references12, tables0, types1, columns3, keyColumns5, columns15, elements18, type20, type23},
    generalizations={},
    metadata=None
)
