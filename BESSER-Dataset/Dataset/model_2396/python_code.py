...
class rdpl_RecordElement:
    ...
    def __init__(self, value: str, rdpl_RecordElement: "rdpl_Record" = None, rdpl_RecordElement21: "rdpl_Column" = None):
        self.value = value
...
class rdpl_Table:
    ...
    def __init__(self, name: str, rdpl_Table9: set["rdpl_Record"] = None, rdpl_Table11: set["rdpl_ForeignKey"] = None, rdpl_Table14: "rdpl_ForeignKey" = None, rdpl_Table: "rdpl_Schema" = None, rdpl_Table4: set["rdpl_Column"] = None, rdpl_Table6: set["rdpl_Column"] = None):
        self.name = name
