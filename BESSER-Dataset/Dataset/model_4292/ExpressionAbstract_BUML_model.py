...
# Classes
expression_IncludingExpression = Class(name="expression_IncludingExpression")
...
expression_StringExpression = Class(name="expression_StringExpression")
SubExpression2 = Class(name="SubExpression2")
expression_BooleanExpression = Class(name="expression_BooleanExpression")
expression_NegativeIntExpression = Class(name="expression_NegativeIntExpression")
expression_SubExpression = Class(name="expression_SubExpression", is_abstract=True)
Expression = Class(name="Expression")
expression_SubExpression2 = Class(name="expression_SubExpression2")
...
expression_NegativeIntExpression.attributes={expression_NegativeIntExpression_value, expression_NegativeIntExpression_isNegative}
...
domain_model = DomainModel(
    name="expression",
    types={expression_IncludingExpression, SubExpression, expression_Expression, expression_ExpressionList, expression_StringExpression, SubExpression2, expression_BooleanExpression, expression_NegativeIntExpression, expression_SubExpression, Expression, expression_SubExpression2},
    associations={argument0, source1, elements4},
    generalizations={gen_expression_IncludingExpression_SubExpression, gen_expression_StringExpression_SubExpression2, gen_expression_BooleanExpression_SubExpression, gen_expression_NegativeIntExpression_SubExpression2, gen_expression_SubExpression_Expression, gen_expression_SubExpression2_Expression},
    metadata=None
)
