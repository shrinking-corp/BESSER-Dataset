...
public class java_Package extends NamedElement {
    ...
    private List<java_PackageAccess> java_packageaccesss;
    ...
    public java_Package(
        ...
        this.java_packageaccesss = new ArrayList<>();
        this.java_abstracttypedeclarations = new ArrayList<>();
        this.java_packages = new ArrayList<>();
    }

    public java_Package(
        ArrayList<java_PackageAccess> java_packageaccesss,        ArrayList<java_AbstractTypeDeclaration> java_abstracttypedeclarations,        ArrayList<java_Package> java_packages    ) {
        this.java_packageaccesss = java_packageaccesss;
    ...
    public List<java_PackageAccess> getJava_packageaccesss() {
        return java_packageaccesss;
    }

    public void addJava_packageaccess(Java_packageaccess java_packageaccess) {
        this.java_packageaccesss.add(java_packageaccess);
    }
