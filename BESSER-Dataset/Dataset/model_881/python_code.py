...
class simplepdl_Allocation:
    ...
    def __init__(self, count: int, Allocation: "simplepdl_WorkDefinition" = None, Allocation11: "simplepdl_Ressource" = None, allocations: "simplepdl_WorkDefinition" = None, allocations15: "simplepdl_Ressource" = None):
        self.count = count
...
class simplepdl_WorkDefinition(ProcessElement):
    ...
    def __init__(self, name: str, successor: set["simplepdl_WorkSequence"] = None, predecessor: set["simplepdl_WorkSequence"] = None, workDefinition: set["simplepdl_Allocation"] = None, WorkDefinition: "simplepdl_WorkSequence" = None, WorkDefinition7: "simplepdl_WorkSequence" = None, WorkDefinition13: "simplepdl_Allocation" = None):
        self.name = name
