...
class test_Person:
    ...
    def __init__(self, lastname: str, firstame: str, Grade: str, test_Person6: "test_University" = None, test_Person: "test_Person" = None, test_Person0: "test_Person" = None, test_Person4: "test_Person" = None, test_Person2: set["test_Person"] = None):
