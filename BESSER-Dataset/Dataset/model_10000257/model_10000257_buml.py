...
Menu.attributes={Menu_specialCourse, Menu_desert, Menu_starter, Menu_mainCourse}
...
Drinks.attributes={Drinks_wine, Drinks_cocktail, Drinks_beer, Drinks_softDrink, Drinks_spirits}
...
domain_model = DomainModel(
    name="_2022e893_a0e0_47fe_a825_c07feed1a31a",
    types={Grant_discount_UseCase, Input_payment_details_UseCase, Change_Order_UseCase, View_statistics_UseCase, Diner_Actor, Waiter_Actor, Kitchen_Staff_Actor, Bar_Staff_Actor, Management_Actor, _Component, Order_food_UseCase1, Pay_for_food_UseCase1, Bill, Payment, Table, Order, Menu, Drinks, Discount, Input_Order_UseCase, Order_food_UseCase, Alerted_to_Prepare_food_UseCase, Alerted_to_Serve_drinks_UseCase, Alerted_to_Serve_Food_UseCase, Print_bill_UseCase, Alerted_to_Prepare_drinks_UseCase, Pay_for_food_UseCase, Input_Order_external, Alerted_to_Serve_drinks_external, Alerted_to_Serve_Food_external, Print_bill_external, Input_payment_details_external, Alerted_to_Prepare_food_external, Alerted_to_Prepare_drinks_external, Grant_discount_external, View_statistics_external},
