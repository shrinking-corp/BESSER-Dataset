...
Machine_Card: BinaryAssociation = BinaryAssociation(
    name="Machine_Card",
    ends={
        Property(name="machine18", type=_unnamed, multiplicity=Multiplicity(0, 9999)),
...
Machine_Memory: BinaryAssociation = BinaryAssociation(
    name="Machine_Memory",
    ends={
        Property(name="machine0", type=_unnamed, multiplicity=Multiplicity(0, 9999)),
...
Processor_Memory: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="processor2", type=car, multiplicity=Multiplicity(0, 9999)),
...
Machine_Processor: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="machine6", type=_unnamed, multiplicity=Multiplicity(0, 9999)),
        Property(name="processor7", type=car, multiplicity=Multiplicity(0, 9999))
    }
)
Processor_Program: BinaryAssociation = BinaryAssociation(
    name="Processor_Program",
    ends={
        Property(name="processor8", type=car, multiplicity=Multiplicity(0, 9999)),
...
domain_model = DomainModel(
    name="db5279bf_426e_4739_a05e_5bd9990f72ab",
    types={CPU, car, AcceleratorCard, Cache, RAM, _unnamed, Program, Instruction, Memory_Interface, DeviceCard, Card, Sound, GenericSound, Vendor1Adapter, Vendor2Adapter, Vendor1Sound, Vendor2Sound, ExtensionBoard, FastCard},
    associations={Cache_RAM, ExtensionBoard_Card, Vendor1Adapter_Vendor1Sound, Vendor2Adapter_Vendor2Sound, Machine_Card, AcceleratorCard_CPU, Machine_Memory, Processor_Memory, Program_Instruction, Machine_Processor, Processor_Program},
    generalizations={},
    metadata=None
)
