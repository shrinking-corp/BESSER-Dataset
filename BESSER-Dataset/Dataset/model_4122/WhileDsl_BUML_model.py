...
# Classes
whileDsl_Model = Class(name="whileDsl_Model")
whileDsl_Function = Class(name="whileDsl_Function")
whileDsl_Definition = Class(name="whileDsl_Definition")
whileDsl_WhileCommand = Class(name="whileDsl_WhileCommand")
Command = Class(name="Command")
whileDsl_Expr = Class(name="whileDsl_Expr")
whileDsl_ForCommand = Class(name="whileDsl_ForCommand")
whileDsl_IfCommand = Class(name="whileDsl_IfCommand")
whileDsl_ForeachCommand = Class(name="whileDsl_ForeachCommand")
whileDsl_VarsCommand = Class(name="whileDsl_VarsCommand")
whileDsl_Vars = Class(name="whileDsl_Vars")
whileDsl_Exprs = Class(name="whileDsl_Exprs")
whileDsl_Input = Class(name="whileDsl_Input")
whileDsl_Commands = Class(name="whileDsl_Commands")
whileDsl_Output = Class(name="whileDsl_Output")
whileDsl_Command = Class(name="whileDsl_Command")
whileDsl_ExprAnd = Class(name="whileDsl_ExprAnd")
whileDsl_ExprOr = Class(name="whileDsl_ExprOr")
whileDsl_ExprNot = Class(name="whileDsl_ExprNot")
whileDsl_ExprEq = Class(name="whileDsl_ExprEq")
whileDsl_NopCommand = Class(name="whileDsl_NopCommand")
whileDsl_ExprSimple = Class(name="whileDsl_ExprSimple")
whileDsl_EObject = Class(name="whileDsl_EObject")
whileDsl_ExprSimpleWithLExpr = Class(name="whileDsl_ExprSimpleWithLExpr")
whileDsl_LExpr = Class(name="whileDsl_LExpr")
whileDsl_ExprSimpleWithExpr = Class(name="whileDsl_ExprSimpleWithExpr")
whileDsl_ExprSimpleWithSymbolLExpr = Class(name="whileDsl_ExprSimpleWithSymbolLExpr")
...
domain_model = DomainModel(
    name="whileDsl",
    types={whileDsl_Model, whileDsl_Function, whileDsl_Definition, whileDsl_WhileCommand, Command, whileDsl_Expr, whileDsl_ForCommand, whileDsl_IfCommand, whileDsl_ForeachCommand, whileDsl_VarsCommand, whileDsl_Vars, whileDsl_Exprs, whileDsl_Input, whileDsl_Commands, whileDsl_Output, whileDsl_Command, whileDsl_ExprAnd, whileDsl_ExprOr, whileDsl_ExprNot, whileDsl_ExprEq, whileDsl_NopCommand, whileDsl_ExprSimple, whileDsl_EObject, whileDsl_ExprSimpleWithLExpr, whileDsl_LExpr, whileDsl_ExprSimpleWithExpr, whileDsl_ExprSimpleWithSymbolLExpr},
    associations={program0, commands9, cond11, body12, cond15, body17, cond20, thenBody22, elseBody25, expList28, body30, variables33, values34, functionDefinition1, intput3, body5, output7, expressions42, expressions45, expression48, expressionsOr51, expressionsNot52, expressionEq54, exprLSimple56, exprRSimple59, expr62, expression36, lexpr37, expr38, lexpr40},
    generalizations={gen_whileDsl_WhileCommand_Command, gen_whileDsl_ForCommand_Command, gen_whileDsl_IfCommand_Command, gen_whileDsl_ForeachCommand_Command, gen_whileDsl_VarsCommand_Command, gen_whileDsl_NopCommand_Command},
    metadata=None
)
