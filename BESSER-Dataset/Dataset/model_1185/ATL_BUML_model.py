...
atl_n_ocl_ATL_Rule = Class(name="atl_n_ocl_ATL_Rule", is_abstract=True)
...
atl_n_ocl_ATL_MatchedRule = Class(name="atl_n_ocl_ATL_MatchedRule")
Rule = Class(name="Rule")
InPattern = Class(name="InPattern")
MatchedRule = Class(name="MatchedRule")
atl_n_ocl_ATL_LazyMatchedRule = Class(name="atl_n_ocl_ATL_LazyMatchedRule")
atl_n_ocl_ATL_CalledRule = Class(name="atl_n_ocl_ATL_CalledRule")
Parameter_ = Class(name="Parameter")
atl_n_ocl_ATL_Query = Class(name="atl_n_ocl_ATL_Query")
OclExpression = Class(name="OclExpression")
Helper = Class(name="Helper")
atl_n_ocl_ATL_Module = Class(name="atl_n_ocl_ATL_Module")
OclModel = Class(name="OclModel")
ModuleElement = Class(name="ModuleElement")
atl_n_ocl_ATL_ModuleElement = Class(name="atl_n_ocl_ATL_ModuleElement", is_abstract=True)
atl_n_ocl_ATL_Helper = Class(name="atl_n_ocl_ATL_Helper")
Binding = Class(name="Binding")
atl_n_ocl_ATL_SimpleOutPatternElement = Class(name="atl_n_ocl_ATL_SimpleOutPatternElement")
atl_n_ocl_ATL_ForEachOutPatternElement = Class(name="atl_n_ocl_ATL_ForEachOutPatternElement")
Iterator = Class(name="Iterator")
atl_n_ocl_ATL_Binding = Class(name="atl_n_ocl_ATL_Binding")
atl_n_ocl_ATL_RuleVariableDeclaration = Class(name="atl_n_ocl_ATL_RuleVariableDeclaration")
atl_n_ocl_ATL_ActionBlock = Class(name="atl_n_ocl_ATL_ActionBlock")
Statement = Class(name="Statement")
atl_n_ocl_ATL_Statement = Class(name="atl_n_ocl_ATL_Statement", is_abstract=True)
atl_n_ocl_ATL_ExpressionStat = Class(name="atl_n_ocl_ATL_ExpressionStat")
atl_n_ocl_ATL_InPattern = Class(name="atl_n_ocl_ATL_InPattern")
InPatternElement = Class(name="InPatternElement")
atl_n_ocl_ATL_OutPattern = Class(name="atl_n_ocl_ATL_OutPattern")
DropPattern = Class(name="DropPattern")
OutPatternElement = Class(name="OutPatternElement")
atl_n_ocl_ATL_DropPattern = Class(name="atl_n_ocl_ATL_DropPattern")
atl_n_ocl_ATL_PatternElement = Class(name="atl_n_ocl_ATL_PatternElement", is_abstract=True)
VariableDeclaration = Class(name="VariableDeclaration")
atl_n_ocl_ATL_InPatternElement = Class(name="atl_n_ocl_ATL_InPatternElement", is_abstract=True)
PatternElement = Class(name="PatternElement")
atl_n_ocl_ATL_SimpleInPatternElement = Class(name="atl_n_ocl_ATL_SimpleInPatternElement")
atl_n_ocl_ATL_OutPatternElement = Class(name="atl_n_ocl_ATL_OutPatternElement", is_abstract=True)
atl_n_ocl_OCL_OclExpression = Class(name="atl_n_ocl_OCL_OclExpression", is_abstract=True)
OclType = Class(name="OclType")
atl_n_ocl_OCL_VariableExp = Class(name="atl_n_ocl_OCL_VariableExp")
atl_n_ocl_OCL_SuperExp = Class(name="atl_n_ocl_OCL_SuperExp")
atl_n_ocl_OCL_PrimitiveExp = Class(name="atl_n_ocl_OCL_PrimitiveExp", is_abstract=True)
atl_n_ocl_OCL_StringExp = Class(name="atl_n_ocl_OCL_StringExp")
PrimitiveExp = Class(name="PrimitiveExp")
atl_n_ocl_OCL_BooleanExp = Class(name="atl_n_ocl_OCL_BooleanExp")
atl_n_ocl_OCL_NumericExp = Class(name="atl_n_ocl_OCL_NumericExp", is_abstract=True)
atl_n_ocl_OCL_RealExp = Class(name="atl_n_ocl_OCL_RealExp")
NumericExp = Class(name="NumericExp")
atl_n_ocl_OCL_IntegerExp = Class(name="atl_n_ocl_OCL_IntegerExp")
atl_n_ocl_OCL_CollectionExp = Class(name="atl_n_ocl_OCL_CollectionExp", is_abstract=True)
atl_n_ocl_ATL_BindingStat = Class(name="atl_n_ocl_ATL_BindingStat")
atl_n_ocl_ATL_IfStat = Class(name="atl_n_ocl_ATL_IfStat")
atl_n_ocl_ATL_ForStat = Class(name="atl_n_ocl_ATL_ForStat")
atl_n_ocl_OCL_EnumLiteralExp = Class(name="atl_n_ocl_OCL_EnumLiteralExp")
atl_n_ocl_OCL_OclUndefinedExp = Class(name="atl_n_ocl_OCL_OclUndefinedExp")
atl_n_ocl_OCL_PropertyCallExp = Class(name="atl_n_ocl_OCL_PropertyCallExp", is_abstract=True)
atl_n_ocl_OCL_NavigationOrAttributeCallExp = Class(name="atl_n_ocl_OCL_NavigationOrAttributeCallExp")
PropertyCallExp = Class(name="PropertyCallExp")
atl_n_ocl_OCL_OperationCallExp = Class(name="atl_n_ocl_OCL_OperationCallExp")
atl_n_ocl_OCL_OperatorCallExp = Class(name="atl_n_ocl_OCL_OperatorCallExp")
OperationCallExp = Class(name="OperationCallExp")
atl_n_ocl_OCL_CollectionOperationCallExp = Class(name="atl_n_ocl_OCL_CollectionOperationCallExp")
atl_n_ocl_OCL_LoopExp = Class(name="atl_n_ocl_OCL_LoopExp", is_abstract=True)
atl_n_ocl_OCL_BagExp = Class(name="atl_n_ocl_OCL_BagExp")
CollectionExp = Class(name="CollectionExp")
atl_n_ocl_OCL_OrderedSetExp = Class(name="atl_n_ocl_OCL_OrderedSetExp")
atl_n_ocl_OCL_SequenceExp = Class(name="atl_n_ocl_OCL_SequenceExp")
atl_n_ocl_OCL_SetExp = Class(name="atl_n_ocl_OCL_SetExp")
atl_n_ocl_OCL_TupleExp = Class(name="atl_n_ocl_OCL_TupleExp")
TuplePart = Class(name="TuplePart")
atl_n_ocl_OCL_TuplePart = Class(name="atl_n_ocl_OCL_TuplePart")
TupleExp = Class(name="TupleExp")
atl_n_ocl_OCL_MapExp = Class(name="atl_n_ocl_OCL_MapExp")
MapElement = Class(name="MapElement")
atl_n_ocl_OCL_MapElement = Class(name="atl_n_ocl_OCL_MapElement")
atl_n_ocl_OCL_VariableDeclaration = Class(name="atl_n_ocl_OCL_VariableDeclaration")
atl_n_ocl_OCL_Iterator = Class(name="atl_n_ocl_OCL_Iterator")
atl_n_ocl_OCL_Parameter = Class(name="atl_n_ocl_OCL_Parameter")
atl_n_ocl_OCL_CollectionType = Class(name="atl_n_ocl_OCL_CollectionType")
atl_n_ocl_OCL_OclType = Class(name="atl_n_ocl_OCL_OclType")
atl_n_ocl_OCL_Primitive = Class(name="atl_n_ocl_OCL_Primitive", is_abstract=True)
atl_n_ocl_OCL_StringType = Class(name="atl_n_ocl_OCL_StringType")
atl_n_ocl_OCL_IterateExp = Class(name="atl_n_ocl_OCL_IterateExp")
LoopExp = Class(name="LoopExp")
atl_n_ocl_OCL_IteratorExp = Class(name="atl_n_ocl_OCL_IteratorExp")
atl_n_ocl_OCL_LetExp = Class(name="atl_n_ocl_OCL_LetExp")
atl_n_ocl_OCL_IfExp = Class(name="atl_n_ocl_OCL_IfExp")
atl_n_ocl_OCL_OclFeatureDefinition = Class(name="atl_n_ocl_OCL_OclFeatureDefinition")
OclFeature = Class(name="OclFeature")
OclContextDefinition = Class(name="OclContextDefinition")
atl_n_ocl_OCL_OclContextDefinition = Class(name="atl_n_ocl_OCL_OclContextDefinition")
atl_n_ocl_OCL_OclFeature = Class(name="atl_n_ocl_OCL_OclFeature", is_abstract=True)
atl_n_ocl_OCL_Attribute = Class(name="atl_n_ocl_OCL_Attribute")
atl_n_ocl_OCL_Operation = Class(name="atl_n_ocl_OCL_Operation")
Primitive = Class(name="Primitive")
atl_n_ocl_OCL_BooleanType = Class(name="atl_n_ocl_OCL_BooleanType")
atl_n_ocl_OCL_NumericType = Class(name="atl_n_ocl_OCL_NumericType", is_abstract=True)
atl_n_ocl_OCL_IntegerType = Class(name="atl_n_ocl_OCL_IntegerType")
NumericType = Class(name="NumericType")
atl_n_ocl_OCL_RealType = Class(name="atl_n_ocl_OCL_RealType")
atl_n_ocl_OCL_BagType = Class(name="atl_n_ocl_OCL_BagType")
CollectionType = Class(name="CollectionType")
atl_n_ocl_OCL_OrderedSetType = Class(name="atl_n_ocl_OCL_OrderedSetType")
atl_n_ocl_OCL_SequenceType = Class(name="atl_n_ocl_OCL_SequenceType")
atl_n_ocl_OCL_SetType = Class(name="atl_n_ocl_OCL_SetType")
atl_n_ocl_OCL_OclAnyType = Class(name="atl_n_ocl_OCL_OclAnyType")
atl_n_ocl_OCL_TupleType = Class(name="atl_n_ocl_OCL_TupleType")
TupleTypeAttribute = Class(name="TupleTypeAttribute")
atl_n_ocl_OCL_TupleTypeAttribute = Class(name="atl_n_ocl_OCL_TupleTypeAttribute")
atl_n_ocl_OCL_OclModelElement = Class(name="atl_n_ocl_OCL_OclModelElement")
atl_n_ocl_OCL_MapType = Class(name="atl_n_ocl_OCL_MapType")
atl_n_ocl_OCL_OclModel = Class(name="atl_n_ocl_OCL_OclModel")
...
atl_n_ocl_ATL_MatchedRule.attributes={atl_n_ocl_ATL_MatchedRule_isAbstract, atl_n_ocl_ATL_MatchedRule_isRefining, atl_n_ocl_ATL_MatchedRule_isNoDefault}
...
atl_n_ocl_ATL_CalledRule.attributes={atl_n_ocl_ATL_CalledRule_isEntrypoint, atl_n_ocl_ATL_CalledRule_isEndpoint}
...
atl_n_ocl_OCL_VariableDeclaration.attributes={atl_n_ocl_OCL_VariableDeclaration_varName, atl_n_ocl_OCL_VariableDeclaration_id}
...
domain_model = DomainModel(
    name="atl_n_ocl",
    types={OclFeatureDefinition, atl_n_ocl_ATL_Rule, OutPattern, ActionBlock, RuleVariableDeclaration, atl_n_ocl_ATL_MatchedRule, Rule, InPattern, MatchedRule, atl_n_ocl_ATL_LazyMatchedRule, atl_n_ocl_ATL_CalledRule, Parameter_, atl_n_ocl_ATL_Query, OclExpression, Helper, atl_n_ocl_ATL_Module, OclModel, ModuleElement, atl_n_ocl_ATL_ModuleElement, atl_n_ocl_ATL_Helper, Binding, atl_n_ocl_ATL_SimpleOutPatternElement, atl_n_ocl_ATL_ForEachOutPatternElement, Iterator, atl_n_ocl_ATL_Binding, atl_n_ocl_ATL_RuleVariableDeclaration, atl_n_ocl_ATL_ActionBlock, Statement, atl_n_ocl_ATL_Statement, atl_n_ocl_ATL_ExpressionStat, atl_n_ocl_ATL_InPattern, InPatternElement, atl_n_ocl_ATL_OutPattern, DropPattern, OutPatternElement, atl_n_ocl_ATL_DropPattern, atl_n_ocl_ATL_PatternElement, VariableDeclaration, atl_n_ocl_ATL_InPatternElement, PatternElement, atl_n_ocl_ATL_SimpleInPatternElement, atl_n_ocl_ATL_OutPatternElement, atl_n_ocl_OCL_OclExpression, OclType, atl_n_ocl_OCL_VariableExp, atl_n_ocl_OCL_SuperExp, atl_n_ocl_OCL_PrimitiveExp, atl_n_ocl_OCL_StringExp, PrimitiveExp, atl_n_ocl_OCL_BooleanExp, atl_n_ocl_OCL_NumericExp, atl_n_ocl_OCL_RealExp, NumericExp, atl_n_ocl_OCL_IntegerExp, atl_n_ocl_OCL_CollectionExp, atl_n_ocl_ATL_BindingStat, atl_n_ocl_ATL_IfStat, atl_n_ocl_ATL_ForStat, atl_n_ocl_OCL_EnumLiteralExp, atl_n_ocl_OCL_OclUndefinedExp, atl_n_ocl_OCL_PropertyCallExp, atl_n_ocl_OCL_NavigationOrAttributeCallExp, PropertyCallExp, atl_n_ocl_OCL_OperationCallExp, atl_n_ocl_OCL_OperatorCallExp, OperationCallExp, atl_n_ocl_OCL_CollectionOperationCallExp, atl_n_ocl_OCL_LoopExp, atl_n_ocl_OCL_BagExp, CollectionExp, atl_n_ocl_OCL_OrderedSetExp, atl_n_ocl_OCL_SequenceExp, atl_n_ocl_OCL_SetExp, atl_n_ocl_OCL_TupleExp, TuplePart, atl_n_ocl_OCL_TuplePart, TupleExp, atl_n_ocl_OCL_MapExp, MapElement, atl_n_ocl_OCL_MapElement, atl_n_ocl_OCL_VariableDeclaration, atl_n_ocl_OCL_Iterator, atl_n_ocl_OCL_Parameter, atl_n_ocl_OCL_CollectionType, atl_n_ocl_OCL_OclType, atl_n_ocl_OCL_Primitive, atl_n_ocl_OCL_StringType, atl_n_ocl_OCL_IterateExp, LoopExp, atl_n_ocl_OCL_IteratorExp, atl_n_ocl_OCL_LetExp, atl_n_ocl_OCL_IfExp, atl_n_ocl_OCL_OclFeatureDefinition, OclFeature, OclContextDefinition, atl_n_ocl_OCL_OclContextDefinition, atl_n_ocl_OCL_OclFeature, atl_n_ocl_OCL_Attribute, atl_n_ocl_OCL_Operation, Primitive, atl_n_ocl_OCL_BooleanType, atl_n_ocl_OCL_NumericType, atl_n_ocl_OCL_IntegerType, NumericType, atl_n_ocl_OCL_RealType, atl_n_ocl_OCL_BagType, CollectionType, atl_n_ocl_OCL_OrderedSetType, atl_n_ocl_OCL_SequenceType, atl_n_ocl_OCL_SetType, atl_n_ocl_OCL_OclAnyType, atl_n_ocl_OCL_TupleType, TupleTypeAttribute, atl_n_ocl_OCL_TupleTypeAttribute, atl_n_ocl_OCL_OclModelElement, atl_n_ocl_OCL_MapType, atl_n_ocl_OCL_OclModel, OclModelElement},
    associations={definition9, outPattern10, actionBlock11, variables13, inPattern15, children16, parameters18, body0, helpers1, inModels3, outModels4, elements7, bindings32, model34, reverseBindings37, collection39, iterator41, value43, statements45, elements19, filter20, dropPattern23, elements24, outPattern26, models28, sourceElement30, statements66, type69, referredVariable70, expression46, source48, value50, condition53, thenStatements55, elseStatements58, iterator61, collection63, source81, arguments83, body85, iterators87, elements71, tuplePart73, tuple74, elements75, key76, value78, condition99, elseExpression102, type105, initExpression107, elementType110, result90, variable92, in_94, thenExpression97, keyType117, feature120, context_121, context_123, initExpression125, type127, parameters130, attributes112, type113, valueType115, returnType132, body135, metamodel138, elements140, model142},
    generalizations={gen_atl_n_ocl_ATL_Rule_ModuleElement, gen_atl_n_ocl_ATL_MatchedRule_Rule, gen_atl_n_ocl_ATL_LazyMatchedRule_MatchedRule, gen_atl_n_ocl_ATL_CalledRule_Rule, gen_atl_n_ocl_ATL_Helper_ModuleElement, gen_atl_n_ocl_ATL_SimpleOutPatternElement_OutPatternElement, gen_atl_n_ocl_ATL_ForEachOutPatternElement_OutPatternElement, gen_atl_n_ocl_ATL_RuleVariableDeclaration_VariableDeclaration, gen_atl_n_ocl_ATL_ExpressionStat_Statement, gen_atl_n_ocl_ATL_PatternElement_VariableDeclaration, gen_atl_n_ocl_ATL_InPatternElement_PatternElement, gen_atl_n_ocl_ATL_SimpleInPatternElement_InPatternElement, gen_atl_n_ocl_ATL_OutPatternElement_PatternElement, gen_atl_n_ocl_OCL_VariableExp_OclExpression, gen_atl_n_ocl_OCL_SuperExp_OclExpression, gen_atl_n_ocl_OCL_PrimitiveExp_OclExpression, gen_atl_n_ocl_OCL_StringExp_PrimitiveExp, gen_atl_n_ocl_OCL_BooleanExp_PrimitiveExp, gen_atl_n_ocl_OCL_NumericExp_PrimitiveExp, gen_atl_n_ocl_OCL_RealExp_NumericExp, gen_atl_n_ocl_OCL_IntegerExp_NumericExp, gen_atl_n_ocl_OCL_CollectionExp_OclExpression, gen_atl_n_ocl_ATL_BindingStat_Statement, gen_atl_n_ocl_ATL_IfStat_Statement, gen_atl_n_ocl_ATL_ForStat_Statement, gen_atl_n_ocl_OCL_EnumLiteralExp_OclExpression, gen_atl_n_ocl_OCL_OclUndefinedExp_OclExpression, gen_atl_n_ocl_OCL_PropertyCallExp_OclExpression, gen_atl_n_ocl_OCL_NavigationOrAttributeCallExp_PropertyCallExp, gen_atl_n_ocl_OCL_OperationCallExp_PropertyCallExp, gen_atl_n_ocl_OCL_OperatorCallExp_OperationCallExp, gen_atl_n_ocl_OCL_CollectionOperationCallExp_OperationCallExp, gen_atl_n_ocl_OCL_LoopExp_PropertyCallExp, gen_atl_n_ocl_OCL_BagExp_CollectionExp, gen_atl_n_ocl_OCL_OrderedSetExp_CollectionExp, gen_atl_n_ocl_OCL_SequenceExp_CollectionExp, gen_atl_n_ocl_OCL_SetExp_CollectionExp, gen_atl_n_ocl_OCL_TupleExp_OclExpression, gen_atl_n_ocl_OCL_TuplePart_VariableDeclaration, gen_atl_n_ocl_OCL_MapExp_OclExpression, gen_atl_n_ocl_OCL_Iterator_VariableDeclaration, gen_atl_n_ocl_OCL_Parameter_VariableDeclaration, gen_atl_n_ocl_OCL_CollectionType_OclType, gen_atl_n_ocl_OCL_OclType_OclExpression, gen_atl_n_ocl_OCL_Primitive_OclType, gen_atl_n_ocl_OCL_IterateExp_LoopExp, gen_atl_n_ocl_OCL_IteratorExp_LoopExp, gen_atl_n_ocl_OCL_LetExp_OclExpression, gen_atl_n_ocl_OCL_IfExp_OclExpression, gen_atl_n_ocl_OCL_Attribute_OclFeature, gen_atl_n_ocl_OCL_Operation_OclFeature, gen_atl_n_ocl_OCL_StringType_Primitive, gen_atl_n_ocl_OCL_BooleanType_Primitive, gen_atl_n_ocl_OCL_NumericType_Primitive, gen_atl_n_ocl_OCL_IntegerType_NumericType, gen_atl_n_ocl_OCL_RealType_NumericType, gen_atl_n_ocl_OCL_BagType_CollectionType, gen_atl_n_ocl_OCL_OrderedSetType_CollectionType, gen_atl_n_ocl_OCL_SequenceType_CollectionType, gen_atl_n_ocl_OCL_SetType_CollectionType, gen_atl_n_ocl_OCL_OclAnyType_OclType, gen_atl_n_ocl_OCL_TupleType_OclType, gen_atl_n_ocl_OCL_OclModelElement_OclType, gen_atl_n_ocl_OCL_MapType_OclType},
    metadata=None
)
