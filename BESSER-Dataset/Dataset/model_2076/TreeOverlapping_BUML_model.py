...
# Classes
OverlappingTree_Child = Class(name="OverlappingTree_Child")
OverlappingTree_Tree = Class(name="OverlappingTree_Tree")
OverlappingTree_NodeKind = Class(name="OverlappingTree_NodeKind")
...
domain_model = DomainModel(
    ...
    types={OverlappingTree_Child, OverlappingTree_Tree, OverlappingTree_NodeKind},
