...
class feature_Attribute:
    ...
    def __init__(self, name: str, type: str, value: str, attributes: "feature_Feature" = None, Attribute: "feature_Feature" = None):
        self.name = name
        self.type = type
        self.value = value
...
class feature_FeatureModel:
    ...
    def getFeatureRecursive(self, feature_base) :
...
class feature_Feature(FeatureTreeNode):
    ...
    def __init__(self, name: str, feature_Feature: "feature_FeatureModel" = None, constrainedFeatures: set["feature_Constraint"] = None, Feature: "feature_Group" = None, Feature20: "feature_Group" = None, Feature22: "feature_Constraint" = None, Feature24: "feature_Attribute" = None, Feature26: "feature_Annotation" = None, feature: set["feature_Attribute"] = None, parentFeature: set["feature_Group"] = None, childFeatures: "feature_Group" = None, feature16: set["feature_Annotation"] = None):
        self.name = name
