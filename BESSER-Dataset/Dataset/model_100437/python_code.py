...
class statemachine_Transition(Named):
    ...
    def __init__(self, preserveTimers: bool, statemachine_Transition9: "statemachine_Value" = None, statemachine_Transition12: set["statemachine_Value"] = None, statemachine_Transition: "statemachine_GAbstractState" = None, statemachine_Transition4: "statemachine_GAbstractState" = None, statemachine_Transition7: "statemachine_Value" = None, statemachine_Transition18: "statemachine_GCompositeState" = None):
...
class statemachine_GState(GAbstractState, Named):
