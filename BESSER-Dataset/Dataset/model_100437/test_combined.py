...
def test_hyp_statemachine_constantvalue_is_not_abstract():
    assert not inspect.isabstract(statemachine_ConstantValue)


def test_hyp_statemachine_constantvalue_constructor_exists():
    assert callable(statemachine_ConstantValue.__init__)


def test_hyp_statemachine_constantvalue_constructor_args():
...
def test_hyp_statemachine_getparameter_is_not_abstract():
    assert not inspect.isabstract(statemachine_GetParameter)


def test_hyp_statemachine_getparameter_constructor_exists():
    assert callable(statemachine_GetParameter.__init__)


def test_hyp_statemachine_getparameter_constructor_args():
...
def test_hyp_statemachine_longvalue_is_not_abstract():
    assert not inspect.isabstract(statemachine_LongValue)


def test_hyp_statemachine_longvalue_constructor_exists():
    assert callable(statemachine_LongValue.__init__)


def test_hyp_statemachine_longvalue_constructor_args():
    sig = inspect.signature(statemachine_LongValue.__init__)
    params = list(sig.parameters.keys())



def test_hyp_constantvalue_is_not_abstract():
    assert not inspect.isabstract(ConstantValue)


def test_hyp_constantvalue_constructor_exists():
    assert callable(ConstantValue.__init__)


def test_hyp_constantvalue_constructor_args():
    sig = inspect.signature(ConstantValue.__init__)
    params = list(sig.parameters.keys())



def test_hyp_statemachine_numbervalue_is_not_abstract():
    assert not inspect.isabstract(statemachine_NumberValue)


def test_hyp_statemachine_numbervalue_constructor_exists():
    assert callable(statemachine_NumberValue.__init__)


def test_hyp_statemachine_numbervalue_constructor_args():
    sig = inspect.signature(statemachine_NumberValue.__init__)
    params = list(sig.parameters.keys())



def test_hyp_statemachine_booleanvalue_is_not_abstract():
    assert not inspect.isabstract(statemachine_BooleanValue)


def test_hyp_statemachine_booleanvalue_constructor_exists():
    assert callable(statemachine_BooleanValue.__init__)


def test_hyp_statemachine_booleanvalue_constructor_args():
    sig = inspect.signature(statemachine_BooleanValue.__init__)
    params = list(sig.parameters.keys())



def test_hyp_statemachine_stringvalue_is_not_abstract():
    assert not inspect.isabstract(statemachine_StringValue)


def test_hyp_statemachine_stringvalue_constructor_exists():
    assert callable(statemachine_StringValue.__init__)


def test_hyp_statemachine_stringvalue_constructor_args():
    sig = inspect.signature(statemachine_StringValue.__init__)
    params = list(sig.parameters.keys())



def test_hyp_gcompositestate_is_not_abstract():
    assert not inspect.isabstract(GCompositeState)


def test_hyp_gcompositestate_constructor_exists():
    assert callable(GCompositeState.__init__)


def test_hyp_gcompositestate_constructor_args():
    sig = inspect.signature(GCompositeState.__init__)
    params = list(sig.parameters.keys())



def test_hyp_statemachine_gstatemachine_is_not_abstract():
    assert not inspect.isabstract(statemachine_GStatemachine)


def test_hyp_statemachine_gstatemachine_constructor_exists():
    assert callable(statemachine_GStatemachine.__init__)


def test_hyp_statemachine_gstatemachine_constructor_args():
...
def test_hyp_gabstractaction_is_not_abstract():
    assert not inspect.isabstract(GAbstractAction)


def test_hyp_gabstractaction_constructor_exists():
    assert callable(GAbstractAction.__init__)


def test_hyp_gabstractaction_constructor_args():
    sig = inspect.signature(GAbstractAction.__init__)
    params = list(sig.parameters.keys())



def test_hyp_statemachine_callaction_is_not_abstract():
    assert not inspect.isabstract(statemachine_CallAction)


def test_hyp_statemachine_callaction_constructor_exists():
    assert callable(statemachine_CallAction.__init__)


def test_hyp_statemachine_callaction_constructor_args():
...
def test_hyp_gabstractstate_is_not_abstract():
    assert not inspect.isabstract(GAbstractState)


def test_hyp_gabstractstate_constructor_exists():
    assert callable(GAbstractState.__init__)


def test_hyp_gabstractstate_constructor_args():
    sig = inspect.signature(GAbstractState.__init__)
    params = list(sig.parameters.keys())



def test_hyp_statemachine_gstartstate_is_not_abstract():
    assert not inspect.isabstract(statemachine_GStartState)


def test_hyp_statemachine_gstartstate_constructor_exists():
    assert callable(statemachine_GStartState.__init__)


def test_hyp_statemachine_gstartstate_constructor_args():
    sig = inspect.signature(statemachine_GStartState.__init__)
    params = list(sig.parameters.keys())



def test_hyp_statemachine_gstopstate_is_not_abstract():
    assert not inspect.isabstract(statemachine_GStopState)


def test_hyp_statemachine_gstopstate_constructor_exists():
    assert callable(statemachine_GStopState.__init__)


def test_hyp_statemachine_gstopstate_constructor_args():
...
def test_hyp_statemachine_parameter_is_not_abstract():
    assert not inspect.isabstract(statemachine_Parameter)


def test_hyp_statemachine_parameter_constructor_exists():
    assert callable(statemachine_Parameter.__init__)


def test_hyp_statemachine_parameter_constructor_args():
...
def test_hyp_statemachine_gstate_is_not_abstract():
    assert not inspect.isabstract(statemachine_GState)


def test_hyp_statemachine_gstate_constructor_exists():
    assert callable(statemachine_GState.__init__)


def test_hyp_statemachine_gstate_constructor_args():
    sig = inspect.signature(statemachine_GState.__init__)
    params = list(sig.parameters.keys())



def test_hyp_gstate_is_not_abstract():
    assert not inspect.isabstract(GState)


def test_hyp_gstate_constructor_exists():
    assert callable(GState.__init__)


def test_hyp_gstate_constructor_args():
    sig = inspect.signature(GState.__init__)
    params = list(sig.parameters.keys())



def test_hyp_statemachine_gcompositestate_is_not_abstract():
    assert not inspect.isabstract(statemachine_GCompositeState)


def test_hyp_statemachine_gcompositestate_constructor_exists():
    assert callable(statemachine_GCompositeState.__init__)


def test_hyp_statemachine_gcompositestate_constructor_args():
...
def test_hyp_statemachine_gabstractaction_is_not_abstract():
    assert not inspect.isabstract(statemachine_GAbstractAction)


def test_hyp_statemachine_gabstractaction_constructor_exists():
    assert callable(statemachine_GAbstractAction.__init__)


def test_hyp_statemachine_gabstractaction_constructor_args():
...
def test_hyp_statemachine_gabstractstate_is_not_abstract():
    assert not inspect.isabstract(statemachine_GAbstractState)


def test_hyp_statemachine_gabstractstate_constructor_exists():
    assert callable(statemachine_GAbstractState.__init__)


def test_hyp_statemachine_gabstractstate_constructor_args():
...
def test_hyp_statemachine_constantvalue_value_setter(instance):
...
def test_hyp_statemachine_gstatemachine_package_setter(instance):
...
def test_hyp_statemachine_call_actionId_setter(instance):
...
def test_hyp_statemachine_transition_preserveTimers_setter(instance):
...
@given(instance=statemachine_Named_strategy)
def test_hyp_statemachine_named_comment_setter(instance):
...
def test_hyp_statemachine_gabstractaction_kind_setter(instance):
