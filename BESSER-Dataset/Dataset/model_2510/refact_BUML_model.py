...
refact_D = Class(name="refact_D")
refact_C = Class(name="refact_C")
refact_A = Class(name="refact_A")
refact_B = Class(name="refact_B")
refact_E = Class(name="refact_E")
refact_Named = Class(name="refact_Named")
...
domain_model = DomainModel(
    name="refact",
    types={Named, refact_D, refact_C, refact_A, refact_B, refact_E, refact_Named},
    associations={ds3, es5, cs8, c_input10, c_outputs13, Bs0, es1, e16},
    generalizations={gen_refact_B_Named, gen_refact_C_Named, gen_refact_D_Named, gen_refact_E_Named},
    metadata=None
)
