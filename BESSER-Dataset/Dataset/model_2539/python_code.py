...
class compartments_ChildOfB_E:
    ...
    def __init__(self, name: str, compartments_ChildOfB_E10: "compartments_ChildOfA_C" = None, compartments_ChildOfB_E: "compartments_TopNodeB" = None):
        self.name = name
...
class compartments_ChildOfB_F:
    ...
    def __init__(self, name: str, compartments_ChildOfB_F: "compartments_TopNodeB" = None, compartments_ChildOfB_F15: "compartments_ChildOfA_D" = None):
        self.name = name
...
class compartments_TopNodeB(TopNode):
    ...
    def __init__(self, name: str, compartments_TopNodeB6: set["compartments_ChildOfB_G"] = None, compartments_TopNodeB8: set["compartments_ChildOfB_F"] = None, compartments_TopNodeB: set["compartments_ChildOfB_E"] = None):
        self.name = name
