...
class Bill:
    ...
    def __init__(self, billno: str, patientname: str, amount: float, pat9: "Patient" = None, receptionist13: "Staff" = None):
        self.billno = billno
...
class Hospital:
    ...
    def __init__(self, name: str, address: str, phone: int, person14: "Person" = None, person16: set["Person"] = None, department19: set["Department"] = None, person24: set["Person"] = None):
        self.name = name
...
class Person(ABC):
    ...
    def __init__(self, Name: str, Title: str, Gender: str, birthDate: date, address: str, phone: int, hospital15: "Hospital" = None, Person_Hospital2_117: set["Hospital"] = None, hospital25: set["Hospital"] = None):
        self.Name = Name
        self.Title = Title
        self.Gender = Gender
    ...
    def hospital15(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Person__hospital15", None)
    ...
    def Person_Hospital2_117(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Person__Person_Hospital2_117", None)
    ...
    def hospital25(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Person__hospital25", None)
...
class Staff:
    ...
    def __init__(self, joined: date, education: str, p11: "Patient" = None, sbill12: set["Bill"] = None, department20: "Department" = None):
        self.joined = joined
...
class Room:
    ...
    def __init__(self, roomno: int, location: str, staff6: set["Staff1"] = None, patient5: set["Patient"] = None):
        self.roomno = roomno
...
class Patient:
    ...
    def __init__(self, accepted: date, sickness: str, telno: int, address: str, age: int, sex: str, roomno: int, bill8: "Bill" = None, receptionist10: "Staff" = None, doctors1: set["Doctor"] = None, room4: "Room" = None, operations_staff23: set["Operations_staff"] = None):
