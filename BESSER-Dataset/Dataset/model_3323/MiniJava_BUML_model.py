...
miniJava_ClassDecl = Class(name="miniJava_ClassDecl")
miniJava_MainMethod = Class(name="miniJava_MainMethod")
miniJava_VarDeclaration = Class(name="miniJava_VarDeclaration")
miniJava_Method = Class(name="miniJava_Method")
miniJava_Statement = Class(name="miniJava_Statement")
miniJava_Type = Class(name="miniJava_Type")
miniJava_Variable = Class(name="miniJava_Variable")
miniJava_Expr = Class(name="miniJava_Expr")
miniJava_NumberValue = Class(name="miniJava_NumberValue")
miniJava_MethodCall = Class(name="miniJava_MethodCall")
miniJava_Expression = Class(name="miniJava_Expression")
Expr = Class(name="Expr")
miniJava_Addition = Class(name="miniJava_Addition")
miniJava_Multiplication = Class(name="miniJava_Multiplication")
miniJava_Point = Class(name="miniJava_Point")
miniJava_SquareBrackets = Class(name="miniJava_SquareBrackets")
...
domain_model = DomainModel(
    name="miniJava",
    types={miniJava_Program, miniJava_ClassDecl, miniJava_MainMethod, miniJava_VarDeclaration, miniJava_Method, miniJava_Statement, miniJava_Type, miniJava_Variable, miniJava_Expr, miniJava_NumberValue, miniJava_MethodCall, miniJava_Expression, Expr, miniJava_Addition, miniJava_Multiplication, miniJava_Point, miniJava_SquareBrackets},
    associations={firstExpression36, variable39, secondExpression42, classDeclarations0, mainMethod1, extendedClass4, varDeclarations6, methodDeclarations8, statement10, classDecl12, variable14, variableType16, methodType19, formalVarDeclarations22, localVarDeclarations25, statements28, returnExpression31, statements34, right46, expression49, type51, variable54, number57, methodCall59, left62, method64, parameters67},
    generalizations={gen_miniJava_Expression_Expr, gen_miniJava_Addition_Expr, gen_miniJava_Multiplication_Expr, gen_miniJava_Point_Expr, gen_miniJava_SquareBrackets_Expr},
    metadata=None
)
