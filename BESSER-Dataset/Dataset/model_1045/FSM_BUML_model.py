...
# Classes
FSM_FAbstractState = Class(name="FSM_FAbstractState", is_abstract=True)
FSM_FStateMachine = Class(name="FSM_FStateMachine")
FSM_FTransition = Class(name="FSM_FTransition")
FSM_FInitialState = Class(name="FSM_FInitialState")
FAbstractState = Class(name="FAbstractState")
FSM_FRegularState = Class(name="FSM_FRegularState")
...
domain_model = DomainModel(
    name="FSM",
    types={FSM_FAbstractState, FSM_FStateMachine, FSM_FTransition, FSM_FInitialState, FAbstractState, FSM_FRegularState},
