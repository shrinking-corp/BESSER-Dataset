...
# Classes
martinfowlerdsl_State = Class(name="martinfowlerdsl_State")
martinfowlerdsl_StateMachine = Class(name="martinfowlerdsl_StateMachine")
martinfowlerdsl_AbstractEvent = Class(name="martinfowlerdsl_AbstractEvent", is_abstract=True)
martinfowlerdsl_Command = Class(name="martinfowlerdsl_Command")
martinfowlerdsl_Transition = Class(name="martinfowlerdsl_Transition")
AbstractEvent = Class(name="AbstractEvent")
martinfowlerdsl_Event = Class(name="martinfowlerdsl_Event")
...
domain_model = DomainModel(
    ...
    types={martinfowlerdsl_State, martinfowlerdsl_StateMachine, martinfowlerdsl_AbstractEvent, martinfowlerdsl_Command, martinfowlerdsl_Transition, AbstractEvent, martinfowlerdsl_Event},
