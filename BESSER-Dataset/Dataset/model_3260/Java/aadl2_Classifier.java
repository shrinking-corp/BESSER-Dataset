...
public class aadl2_Classifier extends Namespace, Type {
    ...
    private aadl2_ClassifierValue aadl2_classifiervalue;
    ...
    public aadl2_Classifier(
        String noAnnexes,        String noProperties,        String noPrototypes    ) {
        super(
        );
    ...
    public aadl2_Classifier(
        String noAnnexes,        String noProperties,        String noPrototypes        ArrayList<aadl2_NamedElement> aadl2_namedelements,        ArrayList<aadl2_PrototypeBinding> aadl2_prototypebindings,        ArrayList<aadl2_ClassifierFeature> aadl2_classifierfeatures    ) {
        this.noAnnexes = noAnnexes;
        this.noProperties = noProperties;
        this.noPrototypes = noPrototypes;
    ...
    public aadl2_ClassifierValue getAadl2_classifiervalue() {
        return aadl2_classifiervalue;
    }

    public void setAadl2_classifiervalue(aadl2_ClassifierValue aadl2_classifiervalue) {
        this.aadl2_classifiervalue = aadl2_classifiervalue;
    }
