...
public class aadl2_PackageSection extends Namespace {
    ...
    public aadl2_PackageSection(
        String aliases,        String noProperties,        String declarations,        String imports,        String noAnnexes    ) {
        super(
        );
    ...
    public aadl2_PackageSection(
        String aliases,        String noProperties,        String declarations,        String imports,        String noAnnexes        ArrayList<aadl2_VirtualProcessorImplementation> aadl2_virtualprocessorimplementations,        ArrayList<aadl2_SystemImplementation> aadl2_systemimplementations,        ArrayList<aadl2_VirtualBusImplementation> aadl2_virtualbusimplementations,        ArrayList<aadl2_ThreadGroupImplementation> aadl2_threadgroupimplementations,        ArrayList<aadl2_ComponentTypeRename> aadl2_componenttyperenames,        ArrayList<aadl2_SubprogramImplementation> aadl2_subprogramimplementations,        ArrayList<aadl2_DataImplementation> aadl2_dataimplementations,        ArrayList<aadl2_BusImplementation> aadl2_busimplementations,        ArrayList<aadl2_DataType> aadl2_datatypes,        ArrayList<aadl2_AnnexLibrary> aadl2_annexlibrarys,        ArrayList<aadl2_MemoryType> aadl2_memorytypes,        ArrayList<aadl2_ThreadGroupType> aadl2_threadgrouptypes,        ArrayList<aadl2_MemoryImplementation> aadl2_memoryimplementations,        ArrayList<aadl2_FeatureGroupTypeRename> aadl2_featuregrouptyperenames,        ArrayList<aadl2_BusType> aadl2_bustypes,        ArrayList<aadl2_ProcessorImplementation> aadl2_processorimplementations,        ArrayList<aadl2_VirtualBusType> aadl2_virtualbustypes,        ArrayList<aadl2_Classifier> aadl2_classifiers,        ArrayList<aadl2_ProcessImplementation> aadl2_processimplementations,        ArrayList<aadl2_VirtualProcessorType> aadl2_virtualprocessortypes,        ArrayList<aadl2_ThreadImplementation> aadl2_threadimplementations,        ArrayList<aadl2_ProcessType> aadl2_processtypes,        ArrayList<aadl2_ThreadType> aadl2_threadtypes,        ArrayList<aadl2_DeviceImplementation> aadl2_deviceimplementations,        ArrayList<aadl2_ProcessorType> aadl2_processortypes,        ArrayList<aadl2_PackageRename> aadl2_packagerenames,        ArrayList<aadl2_SubprogramType> aadl2_subprogramtypes,        ArrayList<aadl2_DeviceType> aadl2_devicetypes,        ArrayList<aadl2_AadlPackage> aadl2_aadlpackages,        ArrayList<aadl2_SubprogramGroupImplementation> aadl2_subprogramgroupimplementations,        ArrayList<aadl2_SubprogramGroupType> aadl2_subprogramgrouptypes,        ArrayList<aadl2_SystemType> aadl2_systemtypes    ) {
        this.aliases = aliases;
        this.noProperties = noProperties;
        this.declarations = declarations;
        this.imports = imports;
