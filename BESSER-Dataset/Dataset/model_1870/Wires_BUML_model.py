...
# Classes
Wires_Transformation = Class(name="Wires_Transformation", is_abstract=True)
TypedElement = Class(name="TypedElement")
Wires_InputActualParameter = Class(name="Wires_InputActualParameter")
Wires_OutputActualParameter = Class(name="Wires_OutputActualParameter")
Wires_DecisionNode = Class(name="Wires_DecisionNode")
Wires_Query = Class(name="Wires_Query")
Transformation = Class(name="Transformation")
Wires_AtomicModelTransformation = Class(name="Wires_AtomicModelTransformation")
Wires_TypedElement = Class(name="Wires_TypedElement", is_abstract=True)
ConnectableElement = Class(name="ConnectableElement")
Wires_Type = Class(name="Wires_Type", is_abstract=True)
Type = Class(name="Type")
Wires_ActualParameter = Class(name="Wires_ActualParameter", is_abstract=True)
WiresElement = Class(name="WiresElement")
Wires_DataFlow = Class(name="Wires_DataFlow")
Wires_ConnectableElement = Class(name="Wires_ConnectableElement", is_abstract=True)
Wires_TransformationType = Class(name="Wires_TransformationType", is_abstract=True)
Wires_OutputFormalParameter = Class(name="Wires_OutputFormalParameter")
Wires_LibraryRef = Class(name="Wires_LibraryRef")
Wires_InputFormalParameter = Class(name="Wires_InputFormalParameter")
Wires_FormalParameter = Class(name="Wires_FormalParameter", is_abstract=True)
Wires_QueryType = Class(name="Wires_QueryType")
TransformationType = Class(name="TransformationType")
Wires_ModelType = Class(name="Wires_ModelType")
DataType = Class(name="DataType")
Wires_DataType = Class(name="Wires_DataType", is_abstract=True)
Wires_BasicData = Class(name="Wires_BasicData")
Wires_CompositeTransformationType = Class(name="Wires_CompositeTransformationType")
WiresSpecification = Class(name="WiresSpecification")
Wires_CompositeTransformation = Class(name="Wires_CompositeTransformation")
Wires_BasicDataType = Class(name="Wires_BasicDataType")
Wires_WiresSpecification = Class(name="Wires_WiresSpecification")
Wires_WiresElement = Class(name="Wires_WiresElement", is_abstract=True)
Wires_Library = Class(name="Wires_Library")
FormalParameter = Class(name="FormalParameter")
ActualParameter = Class(name="ActualParameter")
Wires_AtomicModelTransfomationType = Class(name="Wires_AtomicModelTransfomationType")
Wires_IdentityTransformation = Class(name="Wires_IdentityTransformation")
AtomicModelTransformation = Class(name="AtomicModelTransformation")
Wires_GenericTransformation = Class(name="Wires_GenericTransformation")
Wires_TypeParameter = Class(name="Wires_TypeParameter")
Wires_GenericQuery = Class(name="Wires_GenericQuery")
Query = Class(name="Query")
Wires_Model = Class(name="Wires_Model")
...
Wires_Library.attributes={Wires_Library_path, Wires_Library_name}
...
domain_model = DomainModel(
    name="Wires",
    types={Wires_Transformation, TypedElement, Wires_InputActualParameter, Wires_OutputActualParameter, Wires_DecisionNode, Wires_Query, Transformation, Wires_AtomicModelTransformation, Wires_TypedElement, ConnectableElement, Wires_Type, Type, Wires_ActualParameter, WiresElement, Wires_DataFlow, Wires_ConnectableElement, Wires_TransformationType, Wires_OutputFormalParameter, Wires_LibraryRef, Wires_InputFormalParameter, Wires_FormalParameter, Wires_QueryType, TransformationType, Wires_ModelType, DataType, Wires_DataType, Wires_BasicData, Wires_CompositeTransformationType, WiresSpecification, Wires_CompositeTransformation, Wires_BasicDataType, Wires_WiresSpecification, Wires_WiresElement, Wires_Library, FormalParameter, ActualParameter, Wires_AtomicModelTransfomationType, Wires_IdentityTransformation, AtomicModelTransformation, Wires_GenericTransformation, Wires_TypeParameter, Wires_GenericQuery, Query, Wires_Model},
    associations={inParams0, outParams1, controlNode3, type5, trueBranch6, falseBranch9, inParams12, target15, src16, outParams18, libraries19, inParams21, typeEl23, incoming24, outgoing25, els27, library28, libraries30, typeParam33, typeParam34},
    generalizations={gen_Wires_Transformation_TypedElement, gen_Wires_Query_Transformation, gen_Wires_AtomicModelTransformation_Transformation, gen_Wires_TypedElement_ConnectableElement, gen_Wires_Type_ConnectableElement, gen_Wires_DataType_Type, gen_Wires_ActualParameter_TypedElement, gen_Wires_DecisionNode_WiresElement, gen_Wires_DataFlow_WiresElement, gen_Wires_TransformationType_Type, gen_Wires_FormalParameter_Type, gen_Wires_QueryType_TransformationType, gen_Wires_ConnectableElement_WiresElement, gen_Wires_ModelType_DataType, gen_Wires_BasicData_TypedElement, gen_Wires_CompositeTransformationType_TransformationType, gen_Wires_CompositeTransformationType_WiresSpecification, gen_Wires_CompositeTransformation_Transformation, gen_Wires_BasicDataType_DataType, gen_Wires_Library_WiresElement, gen_Wires_InputFormalParameter_FormalParameter, gen_Wires_OutputFormalParameter_FormalParameter, gen_Wires_InputActualParameter_ActualParameter, gen_Wires_OutputActualParameter_ActualParameter, gen_Wires_AtomicModelTransfomationType_TransformationType, gen_Wires_IdentityTransformation_AtomicModelTransformation, gen_Wires_GenericTransformation_AtomicModelTransformation, gen_Wires_TypeParameter_ActualParameter, gen_Wires_GenericQuery_Query, gen_Wires_Model_TypedElement},
    metadata=None
)
