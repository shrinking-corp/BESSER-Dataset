...
def test_hyp_wires_genericquery_is_not_abstract():
    assert not inspect.isabstract(Wires_GenericQuery)


def test_hyp_wires_genericquery_constructor_exists():
    assert callable(Wires_GenericQuery.__init__)


def test_hyp_wires_genericquery_constructor_args():
    sig = inspect.signature(Wires_GenericQuery.__init__)
    params = list(sig.parameters.keys())



def test_hyp_atomicmodeltransformation_is_not_abstract():
    assert not inspect.isabstract(AtomicModelTransformation)


def test_hyp_atomicmodeltransformation_constructor_exists():
    assert callable(AtomicModelTransformation.__init__)


def test_hyp_atomicmodeltransformation_constructor_args():
    sig = inspect.signature(AtomicModelTransformation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_wires_generictransformation_is_not_abstract():
    assert not inspect.isabstract(Wires_GenericTransformation)


def test_hyp_wires_generictransformation_constructor_exists():
    assert callable(Wires_GenericTransformation.__init__)


def test_hyp_wires_generictransformation_constructor_args():
    sig = inspect.signature(Wires_GenericTransformation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_wires_identitytransformation_is_not_abstract():
    assert not inspect.isabstract(Wires_IdentityTransformation)


def test_hyp_wires_identitytransformation_constructor_exists():
    assert callable(Wires_IdentityTransformation.__init__)


def test_hyp_wires_identitytransformation_constructor_args():
...
def test_hyp_wires_typeparameter_is_not_abstract():
    assert not inspect.isabstract(Wires_TypeParameter)


def test_hyp_wires_typeparameter_constructor_exists():
    assert callable(Wires_TypeParameter.__init__)


def test_hyp_wires_typeparameter_constructor_args():
...
def test_hyp_wires_wireselement_is_not_abstract():
    assert not inspect.isabstract(Wires_WiresElement)


def test_hyp_wires_wireselement_constructor_exists():
    assert callable(Wires_WiresElement.__init__)


def test_hyp_wires_wireselement_constructor_args():
    sig = inspect.signature(Wires_WiresElement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_wires_wiresspecification_is_not_abstract():
    assert not inspect.isabstract(Wires_WiresSpecification)


def test_hyp_wires_wiresspecification_constructor_exists():
    assert callable(Wires_WiresSpecification.__init__)


def test_hyp_wires_wiresspecification_constructor_args():
    sig = inspect.signature(Wires_WiresSpecification.__init__)
    params = list(sig.parameters.keys())



def test_hyp_wiresspecification_is_not_abstract():
    assert not inspect.isabstract(WiresSpecification)


def test_hyp_wiresspecification_constructor_exists():
    assert callable(WiresSpecification.__init__)


def test_hyp_wiresspecification_constructor_args():
...
def test_hyp_wires_basicdatatype_is_not_abstract():
    assert not inspect.isabstract(Wires_BasicDataType)


def test_hyp_wires_basicdatatype_constructor_exists():
    assert callable(Wires_BasicDataType.__init__)


def test_hyp_wires_basicdatatype_constructor_args():
    sig = inspect.signature(Wires_BasicDataType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_wires_modeltype_is_not_abstract():
    assert not inspect.isabstract(Wires_ModelType)


def test_hyp_wires_modeltype_constructor_exists():
    assert callable(Wires_ModelType.__init__)


def test_hyp_wires_modeltype_constructor_args():
...
def test_hyp_transformationtype_is_not_abstract():
    assert not inspect.isabstract(TransformationType)


def test_hyp_transformationtype_constructor_exists():
    assert callable(TransformationType.__init__)


def test_hyp_transformationtype_constructor_args():
    sig = inspect.signature(TransformationType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_wires_atomicmodeltransfomationtype_is_not_abstract():
    assert not inspect.isabstract(Wires_AtomicModelTransfomationType)


def test_hyp_wires_atomicmodeltransfomationtype_constructor_exists():
    assert callable(Wires_AtomicModelTransfomationType.__init__)


def test_hyp_wires_atomicmodeltransfomationtype_constructor_args():
    sig = inspect.signature(Wires_AtomicModelTransfomationType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_wires_compositetransformationtype_is_not_abstract():
    assert not inspect.isabstract(Wires_CompositeTransformationType)


def test_hyp_wires_compositetransformationtype_constructor_exists():
    assert callable(Wires_CompositeTransformationType.__init__)


def test_hyp_wires_compositetransformationtype_constructor_args():
    sig = inspect.signature(Wires_CompositeTransformationType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_wires_querytype_is_not_abstract():
    assert not inspect.isabstract(Wires_QueryType)


def test_hyp_wires_querytype_constructor_exists():
    assert callable(Wires_QueryType.__init__)


def test_hyp_wires_querytype_constructor_args():
    sig = inspect.signature(Wires_QueryType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_wires_inputformalparameter_is_not_abstract():
    assert not inspect.isabstract(Wires_InputFormalParameter)


def test_hyp_wires_inputformalparameter_constructor_exists():
    assert callable(Wires_InputFormalParameter.__init__)


def test_hyp_wires_inputformalparameter_constructor_args():
    sig = inspect.signature(Wires_InputFormalParameter.__init__)
    params = list(sig.parameters.keys())



def test_hyp_wires_libraryref_is_not_abstract():
    assert not inspect.isabstract(Wires_LibraryRef)


def test_hyp_wires_libraryref_constructor_exists():
    assert callable(Wires_LibraryRef.__init__)


def test_hyp_wires_libraryref_constructor_args():
...
def test_hyp_wires_outputformalparameter_is_not_abstract():
    assert not inspect.isabstract(Wires_OutputFormalParameter)


def test_hyp_wires_outputformalparameter_constructor_exists():
    assert callable(Wires_OutputFormalParameter.__init__)


def test_hyp_wires_outputformalparameter_constructor_args():
    sig = inspect.signature(Wires_OutputFormalParameter.__init__)
    params = list(sig.parameters.keys())



def test_hyp_wireselement_is_not_abstract():
    assert not inspect.isabstract(WiresElement)


def test_hyp_wireselement_constructor_exists():
    assert callable(WiresElement.__init__)


def test_hyp_wireselement_constructor_args():
    sig = inspect.signature(WiresElement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_wires_connectableelement_is_not_abstract():
    assert not inspect.isabstract(Wires_ConnectableElement)


def test_hyp_wires_connectableelement_constructor_exists():
    assert callable(Wires_ConnectableElement.__init__)


def test_hyp_wires_connectableelement_constructor_args():
...
def test_hyp_wires_library_is_not_abstract():
    assert not inspect.isabstract(Wires_Library)


def test_hyp_wires_library_constructor_exists():
    assert callable(Wires_Library.__init__)


def test_hyp_wires_library_constructor_args():
...
def test_hyp_wires_dataflow_is_not_abstract():
    assert not inspect.isabstract(Wires_DataFlow)


def test_hyp_wires_dataflow_constructor_exists():
    assert callable(Wires_DataFlow.__init__)


def test_hyp_wires_dataflow_constructor_args():
...
def test_hyp_wires_transformationtype_is_not_abstract():
    assert not inspect.isabstract(Wires_TransformationType)


def test_hyp_wires_transformationtype_constructor_exists():
    assert callable(Wires_TransformationType.__init__)


def test_hyp_wires_transformationtype_constructor_args():
    sig = inspect.signature(Wires_TransformationType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_wires_formalparameter_is_not_abstract():
    assert not inspect.isabstract(Wires_FormalParameter)


def test_hyp_wires_formalparameter_constructor_exists():
    assert callable(Wires_FormalParameter.__init__)


def test_hyp_wires_formalparameter_constructor_args():
...
def test_hyp_wires_datatype_is_not_abstract():
    assert not inspect.isabstract(Wires_DataType)


def test_hyp_wires_datatype_constructor_exists():
    assert callable(Wires_DataType.__init__)


def test_hyp_wires_datatype_constructor_args():
...
def test_hyp_wires_type_is_not_abstract():
    assert not inspect.isabstract(Wires_Type)


def test_hyp_wires_type_constructor_exists():
    assert callable(Wires_Type.__init__)


def test_hyp_wires_type_constructor_args():
...
def test_hyp_wires_typedelement_is_not_abstract():
    assert not inspect.isabstract(Wires_TypedElement)


def test_hyp_wires_typedelement_constructor_exists():
    assert callable(Wires_TypedElement.__init__)


def test_hyp_wires_typedelement_constructor_args():
...
def test_hyp_wires_atomicmodeltransformation_is_not_abstract():
    assert not inspect.isabstract(Wires_AtomicModelTransformation)


def test_hyp_wires_atomicmodeltransformation_constructor_exists():
    assert callable(Wires_AtomicModelTransformation.__init__)


def test_hyp_wires_atomicmodeltransformation_constructor_args():
    sig = inspect.signature(Wires_AtomicModelTransformation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_wires_compositetransformation_is_not_abstract():
    assert not inspect.isabstract(Wires_CompositeTransformation)


def test_hyp_wires_compositetransformation_constructor_exists():
    assert callable(Wires_CompositeTransformation.__init__)


def test_hyp_wires_compositetransformation_constructor_args():
    sig = inspect.signature(Wires_CompositeTransformation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_wires_query_is_not_abstract():
    assert not inspect.isabstract(Wires_Query)


def test_hyp_wires_query_constructor_exists():
    assert callable(Wires_Query.__init__)


def test_hyp_wires_query_constructor_args():
    sig = inspect.signature(Wires_Query.__init__)
    params = list(sig.parameters.keys())



def test_hyp_wires_decisionnode_is_not_abstract():
    assert not inspect.isabstract(Wires_DecisionNode)


def test_hyp_wires_decisionnode_constructor_exists():
    assert callable(Wires_DecisionNode.__init__)


def test_hyp_wires_decisionnode_constructor_args():
...
def test_hyp_wires_outputactualparameter_is_not_abstract():
    assert not inspect.isabstract(Wires_OutputActualParameter)


def test_hyp_wires_outputactualparameter_constructor_exists():
    assert callable(Wires_OutputActualParameter.__init__)


def test_hyp_wires_outputactualparameter_constructor_args():
    sig = inspect.signature(Wires_OutputActualParameter.__init__)
    params = list(sig.parameters.keys())



def test_hyp_wires_inputactualparameter_is_not_abstract():
    assert not inspect.isabstract(Wires_InputActualParameter)


def test_hyp_wires_inputactualparameter_constructor_exists():
    assert callable(Wires_InputActualParameter.__init__)


def test_hyp_wires_inputactualparameter_constructor_args():
...
def test_hyp_wires_actualparameter_is_not_abstract():
    assert not inspect.isabstract(Wires_ActualParameter)


def test_hyp_wires_actualparameter_constructor_exists():
    assert callable(Wires_ActualParameter.__init__)


def test_hyp_wires_actualparameter_constructor_args():
    sig = inspect.signature(Wires_ActualParameter.__init__)
    params = list(sig.parameters.keys())



def test_hyp_wires_basicdata_is_not_abstract():
    assert not inspect.isabstract(Wires_BasicData)


def test_hyp_wires_basicdata_constructor_exists():
    assert callable(Wires_BasicData.__init__)


def test_hyp_wires_basicdata_constructor_args():
...
def test_hyp_wires_model_is_not_abstract():
    assert not inspect.isabstract(Wires_Model)


def test_hyp_wires_model_constructor_exists():
    assert callable(Wires_Model.__init__)


def test_hyp_wires_model_constructor_args():
...
def test_hyp_wires_transformation_is_not_abstract():
    assert not inspect.isabstract(Wires_Transformation)


def test_hyp_wires_transformation_constructor_exists():
    assert callable(Wires_Transformation.__init__)


def test_hyp_wires_transformation_constructor_args():
...
def test_hyp_wires_modeltype_uri_setter(instance):
...
def test_hyp_wires_libraryref_name_setter(instance):
...
def test_hyp_wires_connectableelement_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_wires_library_path_setter(instance):
...
@given(instance=Wires_Library_strategy)
def test_hyp_wires_library_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_wires_formalparameter_typeName_setter(instance):
...
def test_hyp_wires_type_path_setter(instance):
    original = instance.path
    instance.path = original
    assert instance.path == original
...
def test_hyp_wires_decisionnode_expression_setter(instance):
...
def test_hyp_wires_basicdata_path_setter(instance):
    original = instance.path
    instance.path = original
    assert instance.path == original
...
def test_hyp_wires_model_path_setter(instance):
    original = instance.path
    instance.path = original
    assert instance.path == original
