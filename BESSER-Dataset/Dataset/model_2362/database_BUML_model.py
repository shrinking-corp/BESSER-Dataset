...
database_Index.attributes={database_Index_qualifier, database_Index_cardinality, database_Index_indexType, database_Index_unique}
...
database_Sequence.attributes={database_Sequence_minValue, database_Sequence_increment, database_Sequence_start, database_Sequence_maxValue}
...
database_Column.attributes={database_Column_defaultValue, database_Column_unique, database_Column_nullable, database_Column_inPrimaryKey, database_Column_inForeignKey, database_Column_autoincrement}
database_Column.methods={database_Column_m_addToPrimaryKey, database_Column_m_removeFromUniqueIndex, database_Column_m_removeFromPrimaryKey, database_Column_m_addToUniqueIndex}
...
domain_model = DomainModel(
    name="database",
    types={database_NamedElement, DatabaseElement, database_DataBase, TableContainer, database_Index, database_IndexElement, database_PrimaryKey, database_ForeignKey, database_ForeignKeyElement, database_Type, database_Sequence, TypesLibraryUser, database_Schema, database_UserDefinedTypesLibrary, database_AbstractTable, NamedElement, database_Column, database_TableContainer, database_Constraint, database_Table, database_View, AbstractTable, database_DatabaseElement},
    associations={indexes5, indexElements6, primaryKey7, foreignKeys8, foreignKeyElements10, type11, sequence13, owner15, schemas0, defines1, columns3, owner4, primaryKey20, foreignKeys23, constraints25, indexes27, columns29, owner31, elements34, elements17, owner19, tables49, sequences52, owner36, target38, fkColumn40, pkColumn42, column45, owner47},
    generalizations={gen_database_NamedElement_DatabaseElement, gen_database_DataBase_TableContainer, gen_database_DataBase_TypesLibraryUser, gen_database_AbstractTable_NamedElement, gen_database_Column_NamedElement, gen_database_PrimaryKey_NamedElement, gen_database_ForeignKey_NamedElement, gen_database_Index_NamedElement, gen_database_View_AbstractTable, gen_database_Table_AbstractTable, gen_database_Schema_TableContainer, gen_database_Sequence_NamedElement, gen_database_TableContainer_NamedElement, gen_database_ForeignKeyElement_DatabaseElement, gen_database_IndexElement_DatabaseElement, gen_database_Constraint_NamedElement},
    metadata=None
)
