...
class database_Column(NamedElement):
    ...
    def __init__(self, defaultValue: str, nullable: bool, autoincrement: bool, inPrimaryKey: bool, inForeignKey: bool, unique: bool, database_Column: set["database_Index"] = None, column: set["database_IndexElement"] = None, columns: "database_PrimaryKey" = None, database_Column9: set["database_ForeignKey"] = None, fkColumn: set["database_ForeignKeyElement"] = None, Column41: "database_ForeignKeyElement" = None, database_Column44: "database_ForeignKeyElement" = None, Column46: "database_IndexElement" = None, database_Column12: "database_Type" = None, database_Column14: "database_Sequence" = None, columns16: "database_AbstractTable" = None, Column: "database_AbstractTable" = None, Column30: "database_PrimaryKey" = None):
...
class database_ForeignKey(NamedElement):
    ...
    def __init__(self, database_ForeignKey: "database_Column" = None, foreignKeys: "database_Table" = None, database_ForeignKey39: "database_Table" = None, ForeignKey: "database_Table" = None, database_ForeignKey35: set["database_ForeignKeyElement"] = None):
...
class database_Index(NamedElement):
    ...
    def __init__(self, qualifier: str, unique: bool, cardinality: int, indexType: str, database_Index: "database_Column" = None, Index: "database_Table" = None, database_Index18: set["database_IndexElement"] = None, indexes: "database_Table" = None):
...
class database_IndexElement(DatabaseElement):
    ...
    def __init__(self, asc: bool, IndexElement: "database_Column" = None, indexElements: "database_Column" = None, database_IndexElement: "database_Index" = None):
        self.asc = asc
