...
dst25: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="in_26", type=lit_petriNets_Place, multiplicity=Multiplicity(1, 1))
    }
)
...
domain_model = DomainModel(
    name="lit_petriNets",
    types={lit_petriNets_TPArc, lit_petriNets_PTArc, lit_petriNets_Net, lit_petriNets_Place, lit_petriNets_Transition, lit_petriNets_Arc, Arc},
    associations={arcs3, net5, in_6, out7, places0, transitions1, src18, dst20, src22, dst25, net8, in_10, out13, net16},
    generalizations={gen_lit_petriNets_TPArc_Arc, gen_lit_petriNets_PTArc_Arc},
    metadata=None
)
