...
class QualityMetrics_AggregatedIntegerMetric(Metric):
    ...
    def __init__(self, Median: int, Average: float, StandardDeviation: float, Minimum: int, Maximum: int, QualityMetrics_AggregatedIntegerMetric: "QualityMetrics_Metrics" = None):
        self.Median = Median
        self.Average = Average
        self.StandardDeviation = StandardDeviation
        self.Minimum = Minimum
