...
# Classes
QualityMetrics_Metrics = Class(name="QualityMetrics_Metrics")
QualityMetrics_SimpleMetric = Class(name="QualityMetrics_SimpleMetric")
QualityMetrics_AggregatedIntegerMetric = Class(name="QualityMetrics_AggregatedIntegerMetric")
QualityMetrics_AggregatedRealMetric = Class(name="QualityMetrics_AggregatedRealMetric")
QualityMetrics_Metric = Class(name="QualityMetrics_Metric", is_abstract=True)
...
QualityMetrics_AggregatedIntegerMetric.attributes={QualityMetrics_AggregatedIntegerMetric_Median, QualityMetrics_AggregatedIntegerMetric_StandardDeviation, QualityMetrics_AggregatedIntegerMetric_Minimum, QualityMetrics_AggregatedIntegerMetric_Average, QualityMetrics_AggregatedIntegerMetric_Maximum}
...
QualityMetrics_AggregatedRealMetric.attributes={QualityMetrics_AggregatedRealMetric_Maximum, QualityMetrics_AggregatedRealMetric_Average, QualityMetrics_AggregatedRealMetric_Median, QualityMetrics_AggregatedRealMetric_StandardDeviation, QualityMetrics_AggregatedRealMetric_Minimum}
...
domain_model = DomainModel(
    name="QualityMetrics",
    types={QualityMetrics_Metrics, QualityMetrics_SimpleMetric, QualityMetrics_AggregatedIntegerMetric, QualityMetrics_AggregatedRealMetric, QualityMetrics_Metric, Metric},
    associations={SimpleMetrics0, AggregatedIntegerMetrics1, AggregatedRealMetrics3},
    generalizations={gen_QualityMetrics_AggregatedRealMetric_Metric, gen_QualityMetrics_SimpleMetric_Metric, gen_QualityMetrics_AggregatedIntegerMetric_Metric},
    metadata=None
)
