...
# Classes
mongoQuery_Selector = Class(name="mongoQuery_Selector")
mongoQuery_Query = Class(name="mongoQuery_Query")
mongoQuery_Selection = Class(name="mongoQuery_Selection")
mongoQuery_FieldSelection = Class(name="mongoQuery_FieldSelection")
mongoQuery_QueryObject = Class(name="mongoQuery_QueryObject")
Query = Class(name="Query")
mongoQuery_JsonDate = Class(name="mongoQuery_JsonDate")
mongoQuery_Array = Class(name="mongoQuery_Array")
...
mongoQuery_Query.attributes={mongoQuery_Query_integerValue, mongoQuery_Query_key, mongoQuery_Query_numberValue, mongoQuery_Query_stringValue}
...
mongoQuery_FieldSelection.attributes={mongoQuery_FieldSelection_enabled, mongoQuery_FieldSelection_key}
...
mongoQuery_JsonDate.attributes={mongoQuery_JsonDate_day, mongoQuery_JsonDate_month, mongoQuery_JsonDate_milliseconds, mongoQuery_JsonDate_dateString, mongoQuery_JsonDate_second, mongoQuery_JsonDate_minute, mongoQuery_JsonDate_hour, mongoQuery_JsonDate_millisecond, mongoQuery_JsonDate_year}
...
domain_model = DomainModel(
    name="mongoQuery",
    types={mongoQuery_Selector, mongoQuery_Query, mongoQuery_Selection, mongoQuery_FieldSelection, mongoQuery_QueryObject, Query, mongoQuery_JsonDate, mongoQuery_Array},
    associations={query0, selection1, fields3, value6, members18, dateValue8, arrayValue10, objectValue13, values15},
