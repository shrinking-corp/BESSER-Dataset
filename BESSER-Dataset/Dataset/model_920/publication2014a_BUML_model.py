...
# Classes
publication2014a_PublicationPhase = Class(name="publication2014a_PublicationPhase")
publication2014a_Rule = Class(name="publication2014a_Rule")
publication2014a_PublicationProcess = Class(name="publication2014a_PublicationProcess")
Named = Class(name="Named")
publication2014a_Sequence = Class(name="publication2014a_Sequence")
publication2014a_Researcher = Class(name="publication2014a_Researcher")
publication2014a_PublicationStructure = Class(name="publication2014a_PublicationStructure")
publication2014a_Write = Class(name="publication2014a_Write")
publication2014a_Review = Class(name="publication2014a_Review")
publication2014a_Paper = Class(name="publication2014a_Paper")
publication2014a_Paragraph = Class(name="publication2014a_Paragraph")
publication2014a_Progress = Class(name="publication2014a_Progress")
Counted = Class(name="Counted")
publication2014a_ReviewNote = Class(name="publication2014a_ReviewNote")
Labelled = Class(name="Labelled")
publication2014a_PublicationSystem = Class(name="publication2014a_PublicationSystem")
publication2014a_Named = Class(name="publication2014a_Named", is_abstract=True)
publication2014a_Counted = Class(name="publication2014a_Counted", is_abstract=True)
publication2014a_Labelled = Class(name="publication2014a_Labelled", is_abstract=True)
...
publication2014a_PublicationPhase.attributes={publication2014a_PublicationPhase_name, publication2014a_PublicationPhase_minTime, publication2014a_PublicationPhase_maxTime}
...
publication2014a_Rule.attributes={publication2014a_Rule_key, publication2014a_Rule_text}
...
publication2014a_PublicationProcess.attributes={publication2014a_PublicationProcess_minTime, publication2014a_PublicationProcess_maxTime}
...
publication2014a_Researcher.attributes={publication2014a_Researcher_name, publication2014a_Researcher_position, publication2014a_Researcher_forName}
...
publication2014a_Progress.attributes={publication2014a_Progress_time, publication2014a_Progress_percent}
...
domain_model = DomainModel(
    ...
    types={publication2014a_PublicationPhase, publication2014a_Rule, publication2014a_PublicationProcess, Named, publication2014a_Sequence, publication2014a_Researcher, publication2014a_PublicationStructure, publication2014a_Write, publication2014a_Review, publication2014a_Paper, publication2014a_Paragraph, publication2014a_Progress, Counted, publication2014a_ReviewNote, Labelled, publication2014a_PublicationSystem, publication2014a_Named, publication2014a_Counted, publication2014a_Labelled, SequenceType},
    associations={phases0, publicationRules1, predecessor12, linksToSuccessors3, neededPerson5, rules6, successor9, process26, paper28, paragraph30, reviewNote33, phaseParticipation15, writes16, reviews17, papers19, paragraphs20, progress21, authors22, reviews24, researchers36, papers38, processView41, structuralView43},
    generalizations={gen_publication2014a_PublicationProcess_Named, gen_publication2014a_Write_Labelled, gen_publication2014a_Review_Labelled, gen_publication2014a_PublicationStructure_Named, gen_publication2014a_Paper_Named, gen_publication2014a_Paragraph_Counted, gen_publication2014a_Paragraph_Named, gen_publication2014a_ReviewNote_Named, gen_publication2014a_Progress_Labelled},
    metadata=None
)
