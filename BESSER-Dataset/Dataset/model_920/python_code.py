...
class publication2014a_Progress(Labelled):
    ...
    def __init__(self, percent: int, time: int, publication2014a_Progress: "publication2014a_PublicationProcess" = None, progress: "publication2014a_Paper" = None, Progress: "publication2014a_Paper" = None):
...
class publication2014a_Researcher:
    ...
    def __init__(self, name: str, forName: str, position: str, neededPerson: set["publication2014a_PublicationPhase"] = None, publication2014a_Researcher: set["publication2014a_Write"] = None, publication2014a_Researcher18: set["publication2014a_Review"] = None, Researcher: "publication2014a_PublicationPhase" = None, authors: set["publication2014a_Paper"] = None, Researcher23: "publication2014a_Paper" = None, publication2014a_Researcher37: "publication2014a_PublicationStructure" = None):
        self.name = name
...
class publication2014a_Sequence:
    ...
    def __init__(self, sequenceType: str, publication2014a_Sequence10: "publication2014a_PublicationPhase" = None, publication2014a_Sequence13: "publication2014a_PublicationPhase" = None, publication2014a_Sequence: "publication2014a_PublicationPhase" = None):
...
class publication2014a_PublicationProcess(Named):
    ...
    def __init__(self, minTime: int, maxTime: int, publication2014a_PublicationProcess27: "publication2014a_Progress" = None, publication2014a_PublicationProcess: set["publication2014a_PublicationPhase"] = None, publication2014a_PublicationProcess2: set["publication2014a_Rule"] = None, publication2014a_PublicationProcess42: "publication2014a_PublicationSystem" = None):
...
class publication2014a_Rule:
    ...
    def __init__(self, text: str, key: str, publication2014a_Rule8: "publication2014a_PublicationPhase" = None, publication2014a_Rule: "publication2014a_PublicationProcess" = None):
        self.text = text
        self.key = key
...
class publication2014a_PublicationPhase:
    ...
    def __init__(self, name: str, minTime: int, maxTime: int, publication2014a_PublicationPhase7: set["publication2014a_Rule"] = None, publication2014a_PublicationPhase11: "publication2014a_Sequence" = None, PublicationPhase: "publication2014a_Researcher" = None, publication2014a_PublicationPhase: "publication2014a_PublicationProcess" = None, publication2014a_PublicationPhase14: "publication2014a_Sequence" = None, publication2014a_PublicationPhase4: set["publication2014a_Sequence"] = None, phaseParticipation: set["publication2014a_Researcher"] = None):
        self.name = name
        self.minTime = minTime
        self.maxTime = maxTime
