...
class RefOntoUML_OpaqueExpression(ValueSpecification):
    ...
    def one_return_result_parameter(self, RefOntoUML_diagnostics, RefOntoUML_context) :
    ...
    def only_return_result_parameters(self, RefOntoUML_diagnostics, RefOntoUML_context) :
...
class RefOntoUML_Property(StructuralFeature):
    ...
    def __init__(self, isDerived: str, isDerivedUnion: str, default: str, aggregation: str, isComposite: str, memberEnd: "RefOntoUML_Association" = None, Property125: "RefOntoUML_Class" = None, Property127: "RefOntoUML_DataType" = None, Property: "RefOntoUML_Association" = None, Property60: "RefOntoUML_Association" = None, RefOntoUML_Property: "RefOntoUML_Association" = None, RefOntoUML_Property78: "RefOntoUML_Classifier" = None, ownedAttribute: "RefOntoUML_Class" = None, ownedAttribute103: "RefOntoUML_DataType" = None, RefOntoUML_Property106: "RefOntoUML_Property" = None, RefOntoUML_Property104: set["RefOntoUML_Property"] = None, ownedEnd: "RefOntoUML_Association" = None, RefOntoUML_Property109: "RefOntoUML_ValueSpecification" = None, RefOntoUML_Property113: "RefOntoUML_Property" = None, RefOntoUML_Property111: "RefOntoUML_Property" = None, RefOntoUML_Property116: "RefOntoUML_Property" = None, RefOntoUML_Property114: set["RefOntoUML_Property"] = None):
    ...
    def derived_union_is_derived(self, RefOntoUML_diagnostics, RefOntoUML_context) :
    ...
    def subsetting_context_conforms(self, RefOntoUML_diagnostics, RefOntoUML_context) :
        # TODO: Implement subsetting_context_conforms method
        pass

    def subsetting_rules(self, RefOntoUML_diagnostics, RefOntoUML_context) :
    ...
    def binding_to_attribute(self, RefOntoUML_diagnostics, RefOntoUML_context) :
    ...
    def subsetted_property_names(self, RefOntoUML_diagnostics, RefOntoUML_context) :
        # TODO: Implement subsetted_property_names method
        pass

    def multiplicity_of_composite(self, RefOntoUML_diagnostics, RefOntoUML_context) :
...
class RefOntoUML_Class(Classifier):
    ...
    def __init__(self, isActive: str, RefOntoUML_Class: set["RefOntoUML_Classifier"] = None, RefOntoUML_Class123: "RefOntoUML_Class" = None, RefOntoUML_Class121: set["RefOntoUML_Class"] = None, class_: set["RefOntoUML_Property"] = None, Class: "RefOntoUML_Property" = None):
    ...
    def createOwnedOperation(self, RefOntoUML_returnType, RefOntoUML_parameterTypes, RefOntoUML_parameterNames, RefOntoUML_name):
    ...
    def passive_class(self, RefOntoUML_diagnostics, RefOntoUML_context) :
        # TODO: Implement passive_class method
        pass

class RefOntoUML_DataType(Classifier):

    def __init__(self, datatype: set["RefOntoUML_Property"] = None, DataType: "RefOntoUML_Property" = None):
    ...
    def createOwnedOperation(self, RefOntoUML_name, RefOntoUML_parameterTypes, RefOntoUML_returnType, RefOntoUML_parameterNames):
        # TODO: Implement createOwnedOperation method
        pass
...
class RefOntoUML_Association(Classifier, Relationship):
    ...
    def specialized_end_number(self, RefOntoUML_diagnostics, RefOntoUML_context) :
    ...
    def binary_associations(self, RefOntoUML_diagnostics, RefOntoUML_context) :
...
class RefOntoUML_PackageImport(DirectedRelationship):
    ...
    def __init__(self, visibility: str, RefOntoUML_PackageImport: "RefOntoUML_Package" = None, packageImport: "RefOntoUML_Namespace" = None, PackageImport: "RefOntoUML_Namespace" = None):
    ...
    def public_or_private(self, RefOntoUML_context, RefOntoUML_diagnostics) :
        # TODO: Implement public_or_private method
        pass

class RefOntoUML_ElementImport(DirectedRelationship):

    def __init__(self, visibility: str, alias: str, RefOntoUML_ElementImport: "RefOntoUML_PackageableElement" = None, elementImport: "RefOntoUML_Namespace" = None, ElementImport: "RefOntoUML_Namespace" = None):
        self.visibility = visibility
        self.alias = alias
...
class RefOntoUML_Namespace(NamedElement):
    ...
    def __init__(self, RefOntoUML_Namespace37: set["RefOntoUML_PackageableElement"] = None, namespace: set["RefOntoUML_NamedElement"] = None, Namespace44: "RefOntoUML_ElementImport" = None, Namespace48: "RefOntoUML_PackageImport" = None, Namespace54: "RefOntoUML_Constraintx" = None, Namespace: "RefOntoUML_NamedElement" = None, importingNamespace: set["RefOntoUML_ElementImport"] = None, importingNamespace32: set["RefOntoUML_PackageImport"] = None, context: set["RefOntoUML_Constraintx"] = None, RefOntoUML_Namespace: set["RefOntoUML_NamedElement"] = None):
    ...
    def createElementImport(self, RefOntoUML_visibility, RefOntoUML_element) :
    ...
    def members_distinguishable(self, RefOntoUML_context, RefOntoUML_diagnostics) :
    ...
    def createPackageImport(self, RefOntoUML_visibility, RefOntoUML_package_) :
...
class RefOntoUML_RedefinableElement(NamedElement):
    ...
    def redefinition_consistent(self, RefOntoUML_diagnostics, RefOntoUML_context) :
    ...
    def redefinition_context_valid(self, RefOntoUML_diagnostics, RefOntoUML_context) :
...
class RefOntoUML_ValueSpecification(PackageableElement, TypedElement):
    ...
    def __init__(self, RefOntoUML_ValueSpecification: "RefOntoUML_Constraintx" = None, RefOntoUML_ValueSpecification134: "RefOntoUML_Expression" = None, RefOntoUML_ValueSpecification97: "RefOntoUML_MultiplicityElement" = None, RefOntoUML_ValueSpecification100: "RefOntoUML_MultiplicityElement" = None, RefOntoUML_ValueSpecification110: "RefOntoUML_Property" = None, RefOntoUML_ValueSpecification146: "RefOntoUML_InstanceSpecification" = None, RefOntoUML_ValueSpecification150: "RefOntoUML_Slot" = None):
...
class RefOntoUML_InstanceSpecification(PackageableElement):
    ...
    def __init__(self, RefOntoUML_InstanceSpecification145: "RefOntoUML_ValueSpecification" = None, RefOntoUML_InstanceSpecification: set["RefOntoUML_Classifier"] = None, owningInstance: set["RefOntoUML_Slot"] = None, InstanceSpecification: "RefOntoUML_Slot" = None, RefOntoUML_InstanceSpecification153: "RefOntoUML_InstanceValue" = None):
    ...
    def structural_feature(self, RefOntoUML_context, RefOntoUML_diagnostics) :
    ...
    def deployment_artifact(self, RefOntoUML_diagnostics, RefOntoUML_context) :
...
class RefOntoUML_Constraintx(PackageableElement):
    ...
    def __init__(self, RefOntoUML_Constraintx: set["RefOntoUML_Element"] = None, RefOntoUML_Constraintx52: "RefOntoUML_ValueSpecification" = None, ownedRule: "RefOntoUML_Namespace" = None, Constraintx: "RefOntoUML_Namespace" = None):
    ...
    def no_side_effects(self, RefOntoUML_context, RefOntoUML_diagnostics) :
        # TODO: Implement no_side_effects method
        pass

    def boolean_value(self, RefOntoUML_context, RefOntoUML_diagnostics) :
    ...
    def not_apply_to_self(self, RefOntoUML_diagnostics, RefOntoUML_context) :
...
class RefOntoUML_Type(PackageableElement):
    ...
    def __init__(self, RefOntoUML_Type: "RefOntoUML_TypedElement" = None, Type: "RefOntoUML_Package" = None, ownedType: "RefOntoUML_Package" = None, RefOntoUML_Type62: "RefOntoUML_Association" = None):
    ...
    def createAssociation(self, RefOntoUML_end2IsNavigable, RefOntoUML_end1IsNavigable, RefOntoUML_end2Lower, RefOntoUML_end2Aggregation, RefOntoUML_end1Name, RefOntoUML_end1Upper, RefOntoUML_end2Upper, RefOntoUML_end1Type, RefOntoUML_end1Lower, RefOntoUML_end1Aggregation, RefOntoUML_end2Name) :
...
class RefOntoUML_Classifier(Namespace, RedefinableElement, Type):
    ...
    def __init__(self, isAbstract: str, RefOntoUML_Classifier120: "RefOntoUML_Class" = None, specific: set["RefOntoUML_Generalization"] = None, powertype: set["RefOntoUML_GeneralizationSet"] = None, featuringClassifier: set["RefOntoUML_Feature"] = None, RefOntoUML_Classifier: set["RefOntoUML_NamedElement"] = None, RefOntoUML_Classifier72: "RefOntoUML_Classifier" = None, RefOntoUML_Classifier70: set["RefOntoUML_Classifier"] = None, RefOntoUML_Classifier75: "RefOntoUML_Classifier" = None, RefOntoUML_Classifier73: set["RefOntoUML_Classifier"] = None, RefOntoUML_Classifier77: set["RefOntoUML_Property"] = None, RefOntoUML_Classifier83: "RefOntoUML_RedefinableElement" = None, RefOntoUML_Classifier85: "RefOntoUML_Generalization" = None, Classifier: "RefOntoUML_Generalization" = None, Classifier91: "RefOntoUML_GeneralizationSet" = None, Classifier95: "RefOntoUML_Feature" = None, RefOntoUML_Classifier142: "RefOntoUML_InstanceSpecification" = None):
    ...
    def no_cycles_in_generalization(self, RefOntoUML_context, RefOntoUML_diagnostics) :
...
class RefOntoUML_Package(Namespace, PackageableElement):
    ...
    def __init__(self, RefOntoUML_Package46: "RefOntoUML_PackageImport" = None, package: set["RefOntoUML_Type"] = None, receivingPackage: set["RefOntoUML_PackageMerge"] = None, RefOntoUML_Package: set["RefOntoUML_PackageableElement"] = None, Package: "RefOntoUML_Package" = None, nestingPackage: set["RefOntoUML_Package"] = None, Package16: "RefOntoUML_Package" = None, nestedPackage: "RefOntoUML_Package" = None, Package138: "RefOntoUML_PackageMerge" = None, RefOntoUML_Package136: "RefOntoUML_PackageMerge" = None, Package57: "RefOntoUML_Type" = None):
    ...
    def createOwnedClass(self, RefOntoUML_name, RefOntoUML_isAbstract) :
    ...
    def getAppliedProfile(self, RefOntoUML_qualifiedName, RefOntoUML_recurse):
...
class RefOntoUML_Element(EModelElement):
    ...
    def __init__(self, RefOntoUML_Element50: "RefOntoUML_Constraintx" = None, RefOntoUML_Element: "RefOntoUML_Comment" = None, Element: "RefOntoUML_Element" = None, owner: set["RefOntoUML_Element"] = None, Element5: "RefOntoUML_Element" = None, ownedElement: "RefOntoUML_Element" = None, RefOntoUML_Element7: set["RefOntoUML_Comment"] = None, RefOntoUML_Element24: "RefOntoUML_DirectedRelationship" = None, RefOntoUML_Element27: "RefOntoUML_DirectedRelationship" = None, RefOntoUML_Element29: "RefOntoUML_Relationship" = None):
    ...
    def not_own_self(self, RefOntoUML_diagnostics, RefOntoUML_context) :
...
class RefOntoUML_MultiplicityElement(Element):
    ...
    def value_specification_constant(self, RefOntoUML_diagnostics, RefOntoUML_context) :
    ...
    def value_specification_no_side_effects(self, RefOntoUML_diagnostics, RefOntoUML_context) :
    ...
    def upper_ge_lower(self, RefOntoUML_diagnostics, RefOntoUML_context) :
    ...
    def lower_ge_0(self, RefOntoUML_context, RefOntoUML_diagnostics) :
        # TODO: Implement lower_ge_0 method
        pass

class RefOntoUML_NamedElement(Element):

    def __init__(self, name: str, visibility: str, qualifiedName: str, NamedElement40: "RefOntoUML_Namespace" = None, client: set["RefOntoUML_Dependency"] = None, ownedMember: "RefOntoUML_Namespace" = None, RefOntoUML_NamedElement: "RefOntoUML_StringExpression" = None, RefOntoUML_NamedElement21: "RefOntoUML_Dependency" = None, NamedElement: "RefOntoUML_Dependency" = None, RefOntoUML_NamedElement35: "RefOntoUML_Namespace" = None, RefOntoUML_NamedElement69: "RefOntoUML_Classifier" = None):
        self.name = name
        self.visibility = visibility
    ...
    def has_no_qualified_name(self, RefOntoUML_context, RefOntoUML_diagnostics) :
        # TODO: Implement has_no_qualified_name method
        pass

    def isDistinguishableFrom(self, RefOntoUML_n, RefOntoUML_ns) :
        # TODO: Implement isDistinguishableFrom method
        pass

    def has_qualified_name(self, RefOntoUML_diagnostics, RefOntoUML_context) :
