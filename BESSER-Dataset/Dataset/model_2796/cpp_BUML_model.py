...
# Classes
Metamodelo_Cpp_CppType = Class(name="Metamodelo_Cpp_CppType", is_abstract=True)
Metamodelo_Cpp_CppClassFile = Class(name="Metamodelo_Cpp_CppClassFile")
CppNamedElement = Class(name="CppNamedElement")
Metamodelo_Cpp_CppPackage = Class(name="Metamodelo_Cpp_CppPackage")
Metamodelo_Cpp_CppPathReference = Class(name="Metamodelo_Cpp_CppPathReference", is_abstract=True)
CppModelElement = Class(name="CppModelElement")
CppPathReferentiable = Class(name="CppPathReferentiable")
Metamodelo_Cpp_CppModel = Class(name="Metamodelo_Cpp_CppModel")
Metamodelo_Cpp_CppClass = Class(name="Metamodelo_Cpp_CppClass")
Metamodelo_Cpp_CppPathReferentiable = Class(name="Metamodelo_Cpp_CppPathReferentiable", is_abstract=True)
Metamodelo_Cpp_CppClassifier = Class(name="Metamodelo_Cpp_CppClassifier", is_abstract=True)
CppFieldContainer = Class(name="CppFieldContainer")
Metamodelo_Cpp_CppMemberFunction = Class(name="Metamodelo_Cpp_CppMemberFunction", is_abstract=True)
Metamodelo_Cpp_CppVariable = Class(name="Metamodelo_Cpp_CppVariable")
Metamodelo_Cpp_CppEnum = Class(name="Metamodelo_Cpp_CppEnum")
Metamodelo_Cpp_CppEnumConstructor = Class(name="Metamodelo_Cpp_CppEnumConstructor")
Metamodelo_Cpp_CppExpression = Class(name="Metamodelo_Cpp_CppExpression", is_abstract=True)
Metamodelo_Cpp_CppComment = Class(name="Metamodelo_Cpp_CppComment")
Metamodelo_Cpp_CppModelElement = Class(name="Metamodelo_Cpp_CppModelElement", is_abstract=True)
Metamodelo_Cpp_CppNamedElement = Class(name="Metamodelo_Cpp_CppNamedElement", is_abstract=True)
Metamodelo_Cpp_CppImportDeclaration = Class(name="Metamodelo_Cpp_CppImportDeclaration")
Metamodelo_Cpp_CppTypeAccess = Class(name="Metamodelo_Cpp_CppTypeAccess")
Metamodelo_Cpp_CppTypeParameter = Class(name="Metamodelo_Cpp_CppTypeParameter")
CppType = Class(name="CppType")
Metamodelo_Cpp_CppPrimitiveType = Class(name="Metamodelo_Cpp_CppPrimitiveType", is_abstract=True)
Metamodelo_Cpp_CppBooleanType = Class(name="Metamodelo_Cpp_CppBooleanType")
CppPrimitiveType = Class(name="CppPrimitiveType")
Metamodelo_Cpp_CppVoidType = Class(name="Metamodelo_Cpp_CppVoidType")
Metamodelo_Cpp_CppCharType = Class(name="Metamodelo_Cpp_CppCharType")
Metamodelo_Cpp_CppShortType = Class(name="Metamodelo_Cpp_CppShortType")
Metamodelo_Cpp_CppIntType = Class(name="Metamodelo_Cpp_CppIntType")
Metamodelo_Cpp_CppLongType = Class(name="Metamodelo_Cpp_CppLongType")
Metamodelo_Cpp_CppFloatType = Class(name="Metamodelo_Cpp_CppFloatType")
Metamodelo_Cpp_CppDoubleType = Class(name="Metamodelo_Cpp_CppDoubleType")
Metamodelo_Cpp_CppSignedType = Class(name="Metamodelo_Cpp_CppSignedType")
Metamodelo_Cpp_CppUnsignedType = Class(name="Metamodelo_Cpp_CppUnsignedType")
CppClassifier = Class(name="CppClassifier")
Metamodelo_Cpp_CppTypedElement = Class(name="Metamodelo_Cpp_CppTypedElement", is_abstract=True)
CppFunction = Class(name="CppFunction")
Metamodelo_Cpp_CppConstructor = Class(name="Metamodelo_Cpp_CppConstructor")
CppMemberFunction = Class(name="CppMemberFunction")
Metamodelo_Cpp_CppDestructor = Class(name="Metamodelo_Cpp_CppDestructor")
Metamodelo_Cpp_CppMethod = Class(name="Metamodelo_Cpp_CppMethod")
Metamodelo_Cpp_CppAbstractMethodInvocation = Class(name="Metamodelo_Cpp_CppAbstractMethodInvocation", is_abstract=True)
Metamodelo_Cpp_CppMethodInvocation = Class(name="Metamodelo_Cpp_CppMethodInvocation")
...
Metamodelo_Cpp_CppArrayInitializer = Class(name="Metamodelo_Cpp_CppArrayInitializer")
CppExpression = Class(name="CppExpression")
Metamodelo_Cpp_CppFunction = Class(name="Metamodelo_Cpp_CppFunction", is_abstract=True)
Metamodelo_Cpp_CppSingleVariableDeclaration = Class(name="Metamodelo_Cpp_CppSingleVariableDeclaration")
Metamodelo_Cpp_CppBlock = Class(name="Metamodelo_Cpp_CppBlock")
Metamodelo_Cpp_CppSwitchExpression = Class(name="Metamodelo_Cpp_CppSwitchExpression")
Metamodelo_Cpp_CppCase = Class(name="Metamodelo_Cpp_CppCase")
Metamodelo_Cpp_CppWhileStatement = Class(name="Metamodelo_Cpp_CppWhileStatement")
CppIterationStatement = Class(name="CppIterationStatement")
Metamodelo_Cpp_CppDoWhileStatement = Class(name="Metamodelo_Cpp_CppDoWhileStatement")
Metamodelo_Cpp_CppForStatement = Class(name="Metamodelo_Cpp_CppForStatement")
Metamodelo_Cpp_CppBreakStatement = Class(name="Metamodelo_Cpp_CppBreakStatement")
CppJumpStatement = Class(name="CppJumpStatement")
Metamodelo_Cpp_CppReturnStatement = Class(name="Metamodelo_Cpp_CppReturnStatement")
Metamodelo_Cpp_CppSuperMethodInvocation = Class(name="Metamodelo_Cpp_CppSuperMethodInvocation")
Metamodelo_Cpp_CppSuperConstructorInvocation = Class(name="Metamodelo_Cpp_CppSuperConstructorInvocation")
CppMethodInvocation = Class(name="CppMethodInvocation")
Metamodelo_Cpp_CppLabeledStatement = Class(name="Metamodelo_Cpp_CppLabeledStatement")
Metamodelo_Cpp_CppSelectionStatement = Class(name="Metamodelo_Cpp_CppSelectionStatement", is_abstract=True)
Metamodelo_Cpp_CppIterationStatement = Class(name="Metamodelo_Cpp_CppIterationStatement", is_abstract=True)
Metamodelo_Cpp_CppJumpStatement = Class(name="Metamodelo_Cpp_CppJumpStatement", is_abstract=True)
Metamodelo_Cpp_CppIfStatement = Class(name="Metamodelo_Cpp_CppIfStatement")
CppSelectionStatement = Class(name="CppSelectionStatement")
Metamodelo_Cpp_CppIfElseStatement = Class(name="Metamodelo_Cpp_CppIfElseStatement")
Metamodelo_Cpp_CppDeclarationExpression = Class(name="Metamodelo_Cpp_CppDeclarationExpression")
Metamodelo_Cpp_CppVariableDeclarationGroup = Class(name="Metamodelo_Cpp_CppVariableDeclarationGroup")
Metamodelo_Cpp_CppBinaryExpression = Class(name="Metamodelo_Cpp_CppBinaryExpression", is_abstract=True)
Metamodelo_Cpp_CppInfixExpression = Class(name="Metamodelo_Cpp_CppInfixExpression")
Metamodelo_Cpp_CppUnaryExpression = Class(name="Metamodelo_Cpp_CppUnaryExpression", is_abstract=True)
Metamodelo_Cpp_CppPostfixExpression = Class(name="Metamodelo_Cpp_CppPostfixExpression")
CppUnaryExpression = Class(name="CppUnaryExpression")
Metamodelo_Cpp_CppPrefixExpression = Class(name="Metamodelo_Cpp_CppPrefixExpression")
Metamodelo_Cpp_CppParenthizedExpression = Class(name="Metamodelo_Cpp_CppParenthizedExpression")
Metamodelo_Cpp_CppCastExpression = Class(name="Metamodelo_Cpp_CppCastExpression")
Metamodelo_Cpp_CppGotoStatement = Class(name="Metamodelo_Cpp_CppGotoStatement")
Metamodelo_Cpp_CppContinueStatement = Class(name="Metamodelo_Cpp_CppContinueStatement")
Metamodelo_Cpp_CppAssignamentStatement = Class(name="Metamodelo_Cpp_CppAssignamentStatement")
CppBinaryExpression = Class(name="CppBinaryExpression")
Metamodelo_Cpp_CppNullLiteral = Class(name="Metamodelo_Cpp_CppNullLiteral")
Metamodelo_Cpp_CppBooleanLiteral = Class(name="Metamodelo_Cpp_CppBooleanLiteral")
Metamodelo_Cpp_CppCharacterLiteral = Class(name="Metamodelo_Cpp_CppCharacterLiteral")
Metamodelo_Cpp_CppNumberLiteral = Class(name="Metamodelo_Cpp_CppNumberLiteral")
Metamodelo_Cpp_CppStringLiteral = Class(name="Metamodelo_Cpp_CppStringLiteral")
Metamodelo_Cpp_CppRegexLiteral = Class(name="Metamodelo_Cpp_CppRegexLiteral")
Metamodelo_Cpp_CppTryExpression = Class(name="Metamodelo_Cpp_CppTryExpression")
Metamodelo_Cpp_CppCatchClause = Class(name="Metamodelo_Cpp_CppCatchClause")
Metamodelo_Cpp_CppThrowExpression = Class(name="Metamodelo_Cpp_CppThrowExpression")
Metamodelo_Cpp_CppConstantExpression = Class(name="Metamodelo_Cpp_CppConstantExpression")
Metamodelo_Cpp_CppArrayAccess = Class(name="Metamodelo_Cpp_CppArrayAccess")
Metamodelo_Cpp_CppField = Class(name="Metamodelo_Cpp_CppField", is_abstract=True)
Metamodelo_Cpp_CppFieldContainer = Class(name="Metamodelo_Cpp_CppFieldContainer")
Metamodelo_Cpp_CppVariableDeclarationFragment = Class(name="Metamodelo_Cpp_CppVariableDeclarationFragment")
Metamodelo_Cpp_CppThisExpression = Class(name="Metamodelo_Cpp_CppThisExpression")
Metamodelo_Cpp_CppFieldAccess = Class(name="Metamodelo_Cpp_CppFieldAccess")
Metamodelo_Cpp_CppVariableAccess = Class(name="Metamodelo_Cpp_CppVariableAccess")
Metamodelo_Cpp_CppVariableDeclaration = Class(name="Metamodelo_Cpp_CppVariableDeclaration", is_abstract=True)
...
Metamodelo_Cpp_CppModel.attributes={Metamodelo_Cpp_CppModel_name, Metamodelo_Cpp_CppModel_targetFolder, Metamodelo_Cpp_CppModel_sourceFolder}
...
Metamodelo_Cpp_CppClass.attributes={Metamodelo_Cpp_CppClass_isAbstract, Metamodelo_Cpp_CppClass_classkey, Metamodelo_Cpp_CppClass_isGeneric, Metamodelo_Cpp_CppClass_isFinal}
...
Metamodelo_Cpp_CppVariable.attributes={Metamodelo_Cpp_CppVariable_storage, Metamodelo_Cpp_CppVariable_isConst}
...
Metamodelo_Cpp_CppComment.attributes={Metamodelo_Cpp_CppComment_content, Metamodelo_Cpp_CppComment_multiLine, Metamodelo_Cpp_CppComment_singleLine}
...
Metamodelo_Cpp_CppMethod.attributes={Metamodelo_Cpp_CppMethod_isFinal, Metamodelo_Cpp_CppMethod_isVirtual, Metamodelo_Cpp_CppMethod_isConst, Metamodelo_Cpp_CppMethod_isPureVirtual}
...
Metamodelo_Cpp_CppFunction.attributes={Metamodelo_Cpp_CppFunction_isInline, Metamodelo_Cpp_CppFunction_isVarArg, Metamodelo_Cpp_CppFunction_linkage}
...
Metamodelo_Cpp_CppRegexLiteral.attributes={Metamodelo_Cpp_CppRegexLiteral_options, Metamodelo_Cpp_CppRegexLiteral_pattern}
...
domain_model = DomainModel(
    name="Metamodelo_Cpp",
    types={Metamodelo_Cpp_CppType, Metamodelo_Cpp_CppClassFile, CppNamedElement, Metamodelo_Cpp_CppPackage, Metamodelo_Cpp_CppPathReference, CppModelElement, CppPathReferentiable, Metamodelo_Cpp_CppModel, Metamodelo_Cpp_CppClass, Metamodelo_Cpp_CppPathReferentiable, Metamodelo_Cpp_CppClassifier, CppFieldContainer, Metamodelo_Cpp_CppMemberFunction, Metamodelo_Cpp_CppVariable, Metamodelo_Cpp_CppEnum, Metamodelo_Cpp_CppEnumConstructor, Metamodelo_Cpp_CppExpression, Metamodelo_Cpp_CppComment, Metamodelo_Cpp_CppModelElement, Metamodelo_Cpp_CppNamedElement, Metamodelo_Cpp_CppImportDeclaration, Metamodelo_Cpp_CppTypeAccess, Metamodelo_Cpp_CppTypeParameter, CppType, Metamodelo_Cpp_CppPrimitiveType, Metamodelo_Cpp_CppBooleanType, CppPrimitiveType, Metamodelo_Cpp_CppVoidType, Metamodelo_Cpp_CppCharType, Metamodelo_Cpp_CppShortType, Metamodelo_Cpp_CppIntType, Metamodelo_Cpp_CppLongType, Metamodelo_Cpp_CppFloatType, Metamodelo_Cpp_CppDoubleType, Metamodelo_Cpp_CppSignedType, Metamodelo_Cpp_CppUnsignedType, CppClassifier, Metamodelo_Cpp_CppTypedElement, CppFunction, Metamodelo_Cpp_CppConstructor, CppMemberFunction, Metamodelo_Cpp_CppDestructor, Metamodelo_Cpp_CppMethod, Metamodelo_Cpp_CppAbstractMethodInvocation, Metamodelo_Cpp_CppMethodInvocation, CppAbstractMethodInvocation, CppVariableDeclaration, CppField, CppTypedElement, Metamodelo_Cpp_CppArrayInitializer, CppExpression, Metamodelo_Cpp_CppFunction, Metamodelo_Cpp_CppSingleVariableDeclaration, Metamodelo_Cpp_CppBlock, Metamodelo_Cpp_CppSwitchExpression, Metamodelo_Cpp_CppCase, Metamodelo_Cpp_CppWhileStatement, CppIterationStatement, Metamodelo_Cpp_CppDoWhileStatement, Metamodelo_Cpp_CppForStatement, Metamodelo_Cpp_CppBreakStatement, CppJumpStatement, Metamodelo_Cpp_CppReturnStatement, Metamodelo_Cpp_CppSuperMethodInvocation, Metamodelo_Cpp_CppSuperConstructorInvocation, CppMethodInvocation, Metamodelo_Cpp_CppLabeledStatement, Metamodelo_Cpp_CppSelectionStatement, Metamodelo_Cpp_CppIterationStatement, Metamodelo_Cpp_CppJumpStatement, Metamodelo_Cpp_CppIfStatement, CppSelectionStatement, Metamodelo_Cpp_CppIfElseStatement, Metamodelo_Cpp_CppDeclarationExpression, Metamodelo_Cpp_CppVariableDeclarationGroup, Metamodelo_Cpp_CppBinaryExpression, Metamodelo_Cpp_CppInfixExpression, Metamodelo_Cpp_CppUnaryExpression, Metamodelo_Cpp_CppPostfixExpression, CppUnaryExpression, Metamodelo_Cpp_CppPrefixExpression, Metamodelo_Cpp_CppParenthizedExpression, Metamodelo_Cpp_CppCastExpression, Metamodelo_Cpp_CppGotoStatement, Metamodelo_Cpp_CppContinueStatement, Metamodelo_Cpp_CppAssignamentStatement, CppBinaryExpression, Metamodelo_Cpp_CppNullLiteral, Metamodelo_Cpp_CppBooleanLiteral, Metamodelo_Cpp_CppCharacterLiteral, Metamodelo_Cpp_CppNumberLiteral, Metamodelo_Cpp_CppStringLiteral, Metamodelo_Cpp_CppRegexLiteral, Metamodelo_Cpp_CppTryExpression, Metamodelo_Cpp_CppCatchClause, Metamodelo_Cpp_CppThrowExpression, Metamodelo_Cpp_CppConstantExpression, Metamodelo_Cpp_CppArrayAccess, Metamodelo_Cpp_CppField, Metamodelo_Cpp_CppFieldContainer, Metamodelo_Cpp_CppVariableDeclarationFragment, Metamodelo_Cpp_CppThisExpression, Metamodelo_Cpp_CppFieldAccess, Metamodelo_Cpp_CppVariableAccess, Metamodelo_Cpp_CppVariableDeclaration, CppVarType, CppAccessSpecifier, CppUnaryOperator, CppAssignmentOperator, CppPostfixOperator, CppClassKey, CppLinkageSpecifier, CppStorageType, CppQualifierType, CppOperator},
    associations={orphanTypes3, modules5, parentReference7, referencedIn8, referencedTerminal9, childrenReferences10, childrenPackages13, containedTypes14, mainClass0, elements1, bounds25, cppOperations27, cppDestructor28, cppConstructor31, cppAttributes34, literals36, expression37, elements17, imports20, usagesInTypeAccess22, typeParameters23, superClass40, pathImport42, type45, statements52, method55, arguments57, expression60, expressions47, ownedParameters49, functionBody50, elseStatement72, expression74, cases76, default78, value81, expression84, initializer87, updater89, condition62, statement64, theBody67, condition69, groups95, leftOperand96, rightOperand98, expression101, expression103, type105, returnExpression92, label94, cppFields116, theBody117, catchClause119, exception121, theBody122, expression125, expression107, index110, array112, fieldContainer115, usageInVariableAccess136, initializer137, dimensions139, catchClause142, container143, fragments144, variablesContainer145, field127, expression128, variable131, access132, parameterMapping134},
    generalizations={gen_Metamodelo_Cpp_CppPathReferentiable_CppNamedElement, gen_Metamodelo_Cpp_CppPathReference_CppModelElement, gen_Metamodelo_Cpp_CppPackage_CppPathReferentiable, gen_Metamodelo_Cpp_CppTypeParameter_CppType, gen_Metamodelo_Cpp_CppClassifier_CppType, gen_Metamodelo_Cpp_CppClassifier_CppFieldContainer, gen_Metamodelo_Cpp_CppEnum_CppType, gen_Metamodelo_Cpp_CppEnumConstructor_CppNamedElement, gen_Metamodelo_Cpp_CppComment_CppModelElement, gen_Metamodelo_Cpp_CppNamedElement_CppModelElement, gen_Metamodelo_Cpp_CppClassFile_CppPathReferentiable, gen_Metamodelo_Cpp_CppType_CppPathReferentiable, gen_Metamodelo_Cpp_CppPrimitiveType_CppType, gen_Metamodelo_Cpp_CppVoidType_CppPrimitiveType, gen_Metamodelo_Cpp_CppCharType_CppPrimitiveType, gen_Metamodelo_Cpp_CppShortType_CppPrimitiveType, gen_Metamodelo_Cpp_CppIntType_CppPrimitiveType, gen_Metamodelo_Cpp_CppLongType_CppPrimitiveType, gen_Metamodelo_Cpp_CppFloatType_CppPrimitiveType, gen_Metamodelo_Cpp_CppDoubleType_CppPrimitiveType, gen_Metamodelo_Cpp_CppSignedType_CppPrimitiveType, gen_Metamodelo_Cpp_CppUnsignedType_CppPrimitiveType, gen_Metamodelo_Cpp_CppClass_CppClassifier, gen_Metamodelo_Cpp_CppImportDeclaration_CppModelElement, gen_Metamodelo_Cpp_CppTypedElement_CppModelElement, gen_Metamodelo_Cpp_CppExpression_CppModelElement, gen_Metamodelo_Cpp_CppBooleanType_CppPrimitiveType, gen_Metamodelo_Cpp_CppMemberFunction_CppFunction, gen_Metamodelo_Cpp_CppMemberFunction_CppField, gen_Metamodelo_Cpp_CppConstructor_CppMemberFunction, gen_Metamodelo_Cpp_CppDestructor_CppMemberFunction, gen_Metamodelo_Cpp_CppMethod_CppMemberFunction, gen_Metamodelo_Cpp_CppMethod_CppTypedElement, gen_Metamodelo_Cpp_CppAbstractMethodInvocation_CppExpression, gen_Metamodelo_Cpp_CppMethodInvocation_CppAbstractMethodInvocation, gen_Metamodelo_Cpp_CppVariable_CppVariableDeclaration, gen_Metamodelo_Cpp_CppVariable_CppField, gen_Metamodelo_Cpp_CppVariable_CppTypedElement, gen_Metamodelo_Cpp_CppVariable_CppType, gen_Metamodelo_Cpp_CppArrayInitializer_CppExpression, gen_Metamodelo_Cpp_CppFunction_CppModelElement, gen_Metamodelo_Cpp_CppFunction_CppType, gen_Metamodelo_Cpp_CppBlock_CppExpression, gen_Metamodelo_Cpp_CppSwitchExpression_CppExpression, gen_Metamodelo_Cpp_CppCase_CppExpression, gen_Metamodelo_Cpp_CppWhileStatement_CppIterationStatement, gen_Metamodelo_Cpp_CppDoWhileStatement_CppIterationStatement, gen_Metamodelo_Cpp_CppForStatement_CppIterationStatement, gen_Metamodelo_Cpp_CppBreakStatement_CppJumpStatement, gen_Metamodelo_Cpp_CppReturnStatement_CppJumpStatement, gen_Metamodelo_Cpp_CppSuperMethodInvocation_CppAbstractMethodInvocation, gen_Metamodelo_Cpp_CppSuperConstructorInvocation_CppMethodInvocation, gen_Metamodelo_Cpp_CppLabeledStatement_CppExpression, gen_Metamodelo_Cpp_CppLabeledStatement_CppNamedElement, gen_Metamodelo_Cpp_CppSelectionStatement_CppExpression, gen_Metamodelo_Cpp_CppIterationStatement_CppExpression, gen_Metamodelo_Cpp_CppJumpStatement_CppExpression, gen_Metamodelo_Cpp_CppIfStatement_CppSelectionStatement, gen_Metamodelo_Cpp_CppIfElseStatement_CppSelectionStatement, gen_Metamodelo_Cpp_CppDeclarationExpression_CppExpression, gen_Metamodelo_Cpp_CppBinaryExpression_CppExpression, gen_Metamodelo_Cpp_CppInfixExpression_CppBinaryExpression, gen_Metamodelo_Cpp_CppUnaryExpression_CppExpression, gen_Metamodelo_Cpp_CppPostfixExpression_CppUnaryExpression, gen_Metamodelo_Cpp_CppPrefixExpression_CppUnaryExpression, gen_Metamodelo_Cpp_CppParenthizedExpression_CppExpression, gen_Metamodelo_Cpp_CppCastExpression_CppExpression, gen_Metamodelo_Cpp_CppGotoStatement_CppJumpStatement, gen_Metamodelo_Cpp_CppContinueStatement_CppJumpStatement, gen_Metamodelo_Cpp_CppAssignamentStatement_CppBinaryExpression, gen_Metamodelo_Cpp_CppNullLiteral_CppExpression, gen_Metamodelo_Cpp_CppBooleanLiteral_CppExpression, gen_Metamodelo_Cpp_CppCharacterLiteral_CppExpression, gen_Metamodelo_Cpp_CppNumberLiteral_CppExpression, gen_Metamodelo_Cpp_CppStringLiteral_CppExpression, gen_Metamodelo_Cpp_CppRegexLiteral_CppExpression, gen_Metamodelo_Cpp_CppTryExpression_CppExpression, gen_Metamodelo_Cpp_CppCatchClause_CppExpression, gen_Metamodelo_Cpp_CppThrowExpression_CppExpression, gen_Metamodelo_Cpp_CppConstantExpression_CppExpression, gen_Metamodelo_Cpp_CppConstantExpression_CppNamedElement, gen_Metamodelo_Cpp_CppArrayAccess_CppExpression, gen_Metamodelo_Cpp_CppField_CppNamedElement, gen_Metamodelo_Cpp_CppFieldContainer_CppModelElement, gen_Metamodelo_Cpp_CppSingleVariableDeclaration_CppVariableDeclaration, gen_Metamodelo_Cpp_CppSingleVariableDeclaration_CppTypedElement, gen_Metamodelo_Cpp_CppVariableDeclarationGroup_CppTypedElement, gen_Metamodelo_Cpp_CppVariableDeclarationFragment_CppVariableDeclaration, gen_Metamodelo_Cpp_CppThisExpression_CppExpression, gen_Metamodelo_Cpp_CppFieldAccess_CppExpression, gen_Metamodelo_Cpp_CppVariableAccess_CppExpression, gen_Metamodelo_Cpp_CppTypeAccess_CppExpression, gen_Metamodelo_Cpp_CppVariableDeclaration_CppNamedElement},
    metadata=None
)
