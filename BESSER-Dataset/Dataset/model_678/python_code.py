...
class emof_Property(TypedElement, MultiplicityElement):
    ...
    def __init__(self, isReadOnly: str, isDerived: str, isComposite: str, isId: str, default: str, ownedAttribute: "emof_Class" = None, emof_Property: "emof_Property" = None, emof_Property21: "emof_Property" = None, Property: "emof_Class" = None):
...
class emof_Class(Type):
    ...
    def __init__(self, isAbstract: str, Class20: "emof_Property" = None, class_: set["emof_Property"] = None, class_2: set["emof_Operation"] = None, emof_Class: "emof_Class" = None, emof_Class3: set["emof_Class"] = None, Class: "emof_Operation" = None):
