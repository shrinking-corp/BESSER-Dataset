...
domain_model = DomainModel(
    name="emof",
    types={emof_Class, Type, emof_Property, emof_Operation, emof_Parameter, emof_Type, emof_MultiplicityElement, emof_Package, NamedElement, emof_DataType, emof_Element, Object, emof_Tag, emof_Comment, Element, emof_Enumeration, DataType, emof_EnumerationLiteral, emof_NamedElement, emof_Extent, emof_Object, MultiplicityElement, TypedElement, emof_TypedElement, emof_PrimitiveType, emof_URIExtent, Extent},
    associations={ownedAttribute0, ownedOperation1, superClass4, class_9, ownedParameter10, raisedException11, ownedType12, nestedPackage14, package15, operation16, tag5, ownedComment6, element7, ownedLiteral8, enumeration18, class_19, opposite22, type23, annotatedElement25},
    generalizations={gen_emof_Class_Type, gen_emof_Package_NamedElement, gen_emof_Type_NamedElement, gen_emof_Parameter_MultiplicityElement, gen_emof_Parameter_TypedElement, gen_emof_DataType_Type, gen_emof_Element_Object, gen_emof_Tag_Element, gen_emof_Enumeration_DataType, gen_emof_NamedElement_Element, gen_emof_Extent_Object, gen_emof_Operation_MultiplicityElement, gen_emof_Operation_TypedElement, gen_emof_EnumerationLiteral_NamedElement, gen_emof_Property_MultiplicityElement, gen_emof_Property_TypedElement, gen_emof_TypedElement_NamedElement, gen_emof_PrimitiveType_DataType, gen_emof_URIExtent_Extent, gen_emof_Comment_Element},
    metadata=None
)
