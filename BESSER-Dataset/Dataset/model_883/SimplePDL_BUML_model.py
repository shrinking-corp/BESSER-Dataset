...
simplepdl_RessourceSequence = Class(name="simplepdl_RessourceSequence")
...
domain_model = DomainModel(
    name="simplepdl",
    types={simplepdl_Process, simplepdl_ProcessElement, simplepdl_WorkDefinition, ProcessElement, simplepdl_WorkSequence, simplepdl_RessourceSequence, simplepdl_Guidance, simplepdl_Ressource, WorkSequenceType},
    associations={processElements0, process1, linksToPredecessors4, linksToSuccessors5, ressourcesequence7, predecessor8, successor9, element11, ressource13, workdefinition14},
    generalizations={gen_simplepdl_WorkDefinition_ProcessElement, gen_simplepdl_WorkSequence_ProcessElement, gen_simplepdl_Guidance_ProcessElement, gen_simplepdl_Ressource_ProcessElement, gen_simplepdl_RessourceSequence_ProcessElement},
    metadata=None
)
