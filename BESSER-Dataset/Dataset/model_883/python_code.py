...
class simplepdl_WorkDefinition(ProcessElement):
    ...
    def __init__(self, name: str, successor: set["simplepdl_WorkSequence"] = None, predecessor: set["simplepdl_WorkSequence"] = None, workdefinition: set["simplepdl_RessourceSequence"] = None, WorkDefinition: "simplepdl_WorkSequence" = None, WorkDefinition10: "simplepdl_WorkSequence" = None, WorkDefinition15: "simplepdl_RessourceSequence" = None):
        self.name = name
