...
# Classes
features_Model = Class(name="features_Model")
...
features_Feature.attributes={features_Feature_abstract, features_Feature_name, features_Feature_short}
...
domain_model = DomainModel(
    ...
    associations={features0, isA2, isOfType5, contains8, uses11},
    generalizations={},
    metadata=None
)
