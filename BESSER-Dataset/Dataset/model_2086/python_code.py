...
class cvlmodel_ResolutionModel:
    ...
    def getVSpecResolutionsForVSpec(self, cvlmodel_vspec) :
...
class cvlmodel_VSpecResolution(ABC):
    ...
    def __init__(self, name: str, cvlmodel_VSpecResolution26: "cvlmodel_ResolutionModel" = None, cvlmodel_VSpecResolution: "cvlmodel_VSpec" = None):
        self.name = name
    ...
    def isPossitivelyResolved(self) :
...
class cvlmodel_StringToMOFRefMap:
    ...
    def __init__(self, key: str, cvlmodel_StringToMOFRefMap: "cvlmodel_VariationPoint" = None, cvlmodel_StringToMOFRefMap19: "cvlmodel_MOFRef" = None):
        self.key = key
...
class cvlmodel_VariationPoint(ABC):
    ...
    def __init__(self, modelTransformationURL: str, modelTransformationSourceURL: str, name: str, negativeVariability: str, cvlmodel_VariationPoint34: "cvlmodel_CVLModel" = None, cvlmodel_VariationPoint: "cvlmodel_VSpec" = None, cvlmodel_VariationPoint17: set["cvlmodel_StringToMOFRefMap"] = None):
        ...
        pass
    @property
    def modelTransformationSourceURL(self):
    ...
    @property
    def modelTransformationURL(self):
...
class cvlmodel_Multiplicity:
    ...
    def __init__(self, min: str, max: str, cvlmodel_Multiplicity: "cvlmodel_VSpec" = None, cvlmodel_Multiplicity11: "cvlmodel_VClassifier" = None, cvlmodel_Multiplicity8: set["cvlmodel_VSpec"] = None):
        self.min = min
        self.max = max
...
class cvlmodel_VSpec(ABC):
    ...
    def __init__(self, name: str, mandatory: str, cvlmodel_VSpec: "cvlmodel_Multiplicity" = None, cvlmodel_VSpec3: "cvlmodel_VSpec" = None, cvlmodel_VSpec1: "cvlmodel_VSpec" = None, cvlmodel_VSpec6: "cvlmodel_VSpec" = None, cvlmodel_VSpec4: set["cvlmodel_VSpec"] = None, cvlmodel_VSpec9: "cvlmodel_Multiplicity" = None, cvlmodel_VSpec13: "cvlmodel_VSpecResolution" = None, cvlmodel_VSpec15: "cvlmodel_VariationPoint" = None, cvlmodel_VSpec21: "cvlmodel_VSpecTree" = None, cvlmodel_VSpec24: "cvlmodel_VSpecTree" = None):
        self.name = name
