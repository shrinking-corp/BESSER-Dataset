...
# Classes
cvlmodel_VSpec = Class(name="cvlmodel_VSpec", is_abstract=True)
cvlmodel_Multiplicity = Class(name="cvlmodel_Multiplicity")
cvlmodel_Choice = Class(name="cvlmodel_Choice")
VSpec = Class(name="VSpec")
cvlmodel_Variable = Class(name="cvlmodel_Variable")
cvlmodel_VClassifier = Class(name="cvlmodel_VClassifier")
cvlmodel_ChoiceResolution = Class(name="cvlmodel_ChoiceResolution")
VSpecResolution = Class(name="VSpecResolution")
cvlmodel_VariableResolution = Class(name="cvlmodel_VariableResolution")
cvlmodel_VClassifierResolution = Class(name="cvlmodel_VClassifierResolution")
cvlmodel_VariationPoint = Class(name="cvlmodel_VariationPoint", is_abstract=True)
cvlmodel_StringToMOFRefMap = Class(name="cvlmodel_StringToMOFRefMap")
cvlmodel_MOFRef = Class(name="cvlmodel_MOFRef")
cvlmodel_ObjectExistence = Class(name="cvlmodel_ObjectExistence")
VariationPoint = Class(name="VariationPoint")
cvlmodel_VSpecTree = Class(name="cvlmodel_VSpecTree")
cvlmodel_VSpecResolution = Class(name="cvlmodel_VSpecResolution", is_abstract=True)
cvlmodel_CVLModel = Class(name="cvlmodel_CVLModel")
cvlmodel_ResolutionModel = Class(name="cvlmodel_ResolutionModel")
...
cvlmodel_VSpec.methods={cvlmodel_VSpec_m_isCloneable, cvlmodel_VSpec_m_isRoot, cvlmodel_VSpec_m_isClon}
...
cvlmodel_VariationPoint.attributes={cvlmodel_VariationPoint_modelTransformationURL, cvlmodel_VariationPoint_modelTransformationSourceURL, cvlmodel_VariationPoint_negativeVariability, cvlmodel_VariationPoint_name}
...
cvlmodel_ResolutionModel_m_getVSpecResolutionsForVSpec: Method = Method(name="getVSpecResolutionsForVSpec", parameters={Parameter(name='cvlmodel_vspec', type=StringType)}, type=StringType)
...
domain_model = DomainModel(
    name="cvlmodel",
    types={cvlmodel_VSpec, cvlmodel_Multiplicity, cvlmodel_Choice, VSpec, cvlmodel_Variable, cvlmodel_VClassifier, cvlmodel_ChoiceResolution, VSpecResolution, cvlmodel_VariableResolution, cvlmodel_VClassifierResolution, cvlmodel_VariationPoint, cvlmodel_StringToMOFRefMap, cvlmodel_MOFRef, cvlmodel_ObjectExistence, VariationPoint, cvlmodel_VSpecTree, cvlmodel_VSpecResolution, cvlmodel_CVLModel, cvlmodel_ResolutionModel, PrimitiveTypeEnum},
    associations={groupMultiplicity0, parent2, children5, children7, resolvedVSpec12, binding14, references16, value18, vspecs20, root22, instanceMultiplicity10, vspecTree30, variationPoints32, resolutions25, resolvedVSpec27},
    generalizations={gen_cvlmodel_Choice_VSpec, gen_cvlmodel_Variable_VSpec, gen_cvlmodel_VClassifier_VSpec, gen_cvlmodel_ChoiceResolution_VSpecResolution, gen_cvlmodel_VariableResolution_VSpecResolution, gen_cvlmodel_VClassifierResolution_VSpecResolution, gen_cvlmodel_ObjectExistence_VariationPoint},
    metadata=None
)
