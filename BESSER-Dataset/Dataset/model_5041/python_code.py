...
class bank_Transaction(ABC):
    ...
    def __init__(self, amount: str, date: date, comment: str, id: str, credits: "bank_Statement" = None, bank_Transaction: "bank_TransactionInitiator" = None, debits: "bank_Statement" = None):
        self.amount = amount
        self.date = date
...
class bank_PointOfSale:
    ...
    def __init__(self, id: str, bank_PointOfSale22: "bank_PostalAddress" = None, bank_PointOfSale30: "bank_DeviceTransaction" = None, bank_PointOfSale: "bank_Merchant" = None):
        self.id = id
...
class bank_Statement:
    ...
    def __init__(self, openingBalance: str, openingDate: date, closingBalance: str, closingDate: date, bank_Statement: "bank_Account" = None, Statement17: "bank_Transaction" = None, Statement: "bank_Transaction" = None):
