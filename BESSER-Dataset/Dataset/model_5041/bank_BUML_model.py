...
# Classes
bank_Party = Class(name="bank_Party", is_abstract=True)
bank_ContactMethod = Class(name="bank_ContactMethod", is_abstract=True)
bank_EMail = Class(name="bank_EMail")
ContactMethod = Class(name="ContactMethod")
bank_Phone = Class(name="bank_Phone")
bank_PostalAddress = Class(name="bank_PostalAddress")
bank_Merchant = Class(name="bank_Merchant")
bank_Product = Class(name="bank_Product")
bank_Account = Class(name="bank_Account", is_abstract=True)
bank_Customer = Class(name="bank_Customer")
bank_Banker = Class(name="bank_Banker")
bank_WebAddress = Class(name="bank_WebAddress")
bank_Bank = Class(name="bank_Bank")
Party = Class(name="Party")
bank_Statement = Class(name="bank_Statement")
bank_CustomerAccount = Class(name="bank_CustomerAccount")
bank_OnlineSession = Class(name="bank_OnlineSession")
bank_TransactionInitiator = Class(name="bank_TransactionInitiator", is_abstract=True)
bank_PointOfSale = Class(name="bank_PointOfSale")
bank_Transaction = Class(name="bank_Transaction", is_abstract=True)
bank_Card = Class(name="bank_Card")
bank_DeviceTransaction = Class(name="bank_DeviceTransaction")
bank_Device = Class(name="bank_Device", is_abstract=True)
TransactionInitiator = Class(name="TransactionInitiator")
bank_Token = Class(name="bank_Token")
bank_MobilePhone = Class(name="bank_MobilePhone")
Device = Class(name="Device")
bank_InternalAccount = Class(name="bank_InternalAccount")
bank_BankerTransaction = Class(name="bank_BankerTransaction")
bank_TokenTransaction = Class(name="bank_TokenTransaction")
Account = Class(name="Account")
bank_OnlineTransaction = Class(name="bank_OnlineTransaction")
...
bank_ContactMethod.attributes={bank_ContactMethod_description, bank_ContactMethod_name}
...
bank_Phone.attributes={bank_Phone_extension, bank_Phone_phoneNumber, bank_Phone_countryCode, bank_Phone_areaCode}
...
bank_PostalAddress.attributes={bank_PostalAddress_city, bank_PostalAddress_postalCode, bank_PostalAddress_line1, bank_PostalAddress_country, bank_PostalAddress_line2, bank_PostalAddress_stateProvince}
...
bank_Account.attributes={bank_Account_balance, bank_Account_number, bank_Account_description, bank_Account_periodStart}
...
bank_Statement.attributes={bank_Statement_closingDate, bank_Statement_closingBalance, bank_Statement_openingDate, bank_Statement_openingBalance}
...
bank_OnlineSession.attributes={bank_OnlineSession_end, bank_OnlineSession_internetAddress, bank_OnlineSession_start}
...
bank_Transaction.attributes={bank_Transaction_comment, bank_Transaction_date, bank_Transaction_amount, bank_Transaction_id}
...
bank_Card.attributes={bank_Card_deactivated, bank_Card_virtual, bank_Card_id, bank_Card_expires, bank_Card_activated, bank_Card_issued}
...
domain_model = DomainModel(
    name="bank",
    types={bank_Party, bank_ContactMethod, bank_EMail, ContactMethod, bank_Phone, bank_PostalAddress, bank_Merchant, bank_Product, bank_Account, bank_Customer, bank_Banker, bank_WebAddress, bank_Bank, Party, bank_Statement, bank_CustomerAccount, bank_OnlineSession, bank_TransactionInitiator, bank_PointOfSale, bank_Transaction, bank_Card, bank_DeviceTransaction, bank_Device, TransactionInitiator, bank_Token, bank_MobilePhone, Device, bank_InternalAccount, bank_BankerTransaction, bank_TokenTransaction, Account, bank_OnlineTransaction},
    associations={contactMethods0, merchants1, products2, accounts4, customers6, bankers8, statements13, accounts10, onlineSessions11, credit16, initiator18, pointsOfSale19, debit15, lockedTo24, replaces27, location21, tokens23, product33, owners36, merchant37, pointOfSale29, devices31},
    generalizations={gen_bank_EMail_ContactMethod, gen_bank_Phone_ContactMethod, gen_bank_PostalAddress_ContactMethod, gen_bank_Customer_Party, gen_bank_WebAddress_ContactMethod, gen_bank_Bank_Party, gen_bank_Merchant_Party, gen_bank_Card_Device, gen_bank_Device_TransactionInitiator, gen_bank_MobilePhone_Device, gen_bank_InternalAccount_Account, gen_bank_Banker_Party, gen_bank_Banker_TransactionInitiator, gen_bank_Token_TransactionInitiator, gen_bank_OnlineSession_TransactionInitiator, gen_bank_CustomerAccount_Account},
    metadata=None
)
