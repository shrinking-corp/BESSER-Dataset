...
nosql_Index = Class(name="nosql_Index")
nosql_ColumnFamily = Class(name="nosql_ColumnFamily")
nosql_Options = Class(name="nosql_Options")
nosql_PK = Class(name="nosql_PK")
nosql_Column = Class(name="nosql_Column")
nosql_Row = Class(name="nosql_Row")
ColumnFamily = Class(name="ColumnFamily")
nosql_Cell = Class(name="nosql_Cell")
...
nosql_Index.attributes={nosql_Index_reference, nosql_Index_name}
...
nosql_Column.attributes={nosql_Column_datatype, nosql_Column_size, nosql_Column_name}
...
domain_model = DomainModel(
    name="nosql",
    types={nosql_KeySpace, nosql_Index, nosql_ColumnFamily, nosql_Options, nosql_PK, nosql_Column, nosql_Row, ColumnFamily, nosql_Cell, Type},
    associations={idexes0, columnFamily26, families1, EReference03, options5, hasPK8, applyTo10, columns12, options15, PK18, rows21, keyspace23, columns29, cells32, additionalColumns34, column37},
