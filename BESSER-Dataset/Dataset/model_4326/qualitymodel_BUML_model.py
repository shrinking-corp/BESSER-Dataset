...
# Classes
qualitymodel_Metric = Class(name="qualitymodel_Metric")
qualitymodel_LeafAttribute = Class(name="qualitymodel_LeafAttribute")
qualitymodel_Attribute = Class(name="qualitymodel_Attribute", is_abstract=True)
qualitymodel_CompositeAttribute = Class(name="qualitymodel_CompositeAttribute")
Attribute = Class(name="Attribute")
qualitymodel_HistoricalData = Class(name="qualitymodel_HistoricalData")
qualitymodel_Preference = Class(name="qualitymodel_Preference")
qualitymodel_ConfigurationProfile = Class(name="qualitymodel_ConfigurationProfile")
...
qualitymodel_Metric.attributes={qualitymodel_Metric_data, qualitymodel_Metric_descriptionName, qualitymodel_Metric_probeName, qualitymodel_Metric_resourceName}
...
qualitymodel_LeafAttribute_m_calculateSum: Method = Method(name="calculateSum", parameters={Parameter(name='qualitymodel_profile', type=StringType)}, type=FloatType)
qualitymodel_LeafAttribute_m_calculateAverage: Method = Method(name="calculateAverage", parameters={Parameter(name='qualitymodel_profile', type=StringType)}, type=FloatType)
qualitymodel_LeafAttribute_m_calculateMinimum: Method = Method(name="calculateMinimum", parameters={Parameter(name='qualitymodel_profile', type=StringType)}, type=FloatType)
qualitymodel_LeafAttribute_m_calculateMaximum: Method = Method(name="calculateMaximum", parameters={Parameter(name='qualitymodel_profile', type=StringType)}, type=FloatType)
qualitymodel_LeafAttribute.attributes={qualitymodel_LeafAttribute_operator, qualitymodel_LeafAttribute_normalizationKind, qualitymodel_LeafAttribute_numSamples, qualitymodel_LeafAttribute_normalizationMin, qualitymodel_LeafAttribute_normalizationMax}
qualitymodel_LeafAttribute.methods={qualitymodel_LeafAttribute_m_calculateAverage, qualitymodel_LeafAttribute_m_calculateMinimum, qualitymodel_LeafAttribute_m_calculateSum, qualitymodel_LeafAttribute_m_calculateMaximum}
...
qualitymodel_Attribute_m_calculate: Method = Method(name="calculate", parameters={Parameter(name='qualitymodel_profile', type=StringType)}, type=StringType)
...
qualitymodel_CompositeAttribute_m_calculateNeutrality: Method = Method(name="calculateNeutrality", parameters={Parameter(name='qualitymodel_profile', type=StringType)}, type=FloatType)
qualitymodel_CompositeAttribute_m_calculateSimultaneity: Method = Method(name="calculateSimultaneity", parameters={Parameter(name='qualitymodel_profile', type=StringType)}, type=FloatType)
qualitymodel_CompositeAttribute_m_calculateReplaceability: Method = Method(name="calculateReplaceability", parameters={Parameter(name='qualitymodel_profile', type=StringType)}, type=FloatType)
qualitymodel_CompositeAttribute.attributes={qualitymodel_CompositeAttribute_operator}
qualitymodel_CompositeAttribute.methods={qualitymodel_CompositeAttribute_m_calculateNeutrality, qualitymodel_CompositeAttribute_m_calculateReplaceability, qualitymodel_CompositeAttribute_m_calculateSimultaneity}
...
qualitymodel_HistoricalData.attributes={qualitymodel_HistoricalData_value, qualitymodel_HistoricalData_instant}
...
domain_model = DomainModel(
    name="qualitymodel",
    types={qualitymodel_Metric, qualitymodel_LeafAttribute, qualitymodel_Attribute, qualitymodel_CompositeAttribute, Attribute, qualitymodel_HistoricalData, qualitymodel_Preference, qualitymodel_ConfigurationProfile, MetricAggregationOperator, AttributeAggregationOperator, MetricNormalizationKind},
