...
class company_Product:
    ...
    def __init__(self, name: str, vat: str, description: str, price: float, company_Product: "company_Category" = None, product: set["company_OrderDetail"] = None, Product: "company_OrderDetail" = None):
        self.name = name
        self.vat = vat
...
class company_OrderDetail:
    ...
    def __init__(self, price: float, OrderDetail: "company_Order" = None, orderDetails: "company_Order" = None, OrderDetail23: "company_Product" = None, orderDetails14: "company_Product" = None):
        self.price = price
...
class company_PurchaseOrder(Order):
    ...
    def __init__(self, date: date, company_PurchaseOrder: "company_Company" = None, PurchaseOrder: "company_Supplier" = None, purchaseOrders: "company_Supplier" = None):
        self.date = date
...
class company_Supplier(Addressable):
    ...
    def __init__(self, preferred: bool, company_Supplier: "company_Company" = None, supplier: set["company_PurchaseOrder"] = None, Supplier: "company_PurchaseOrder" = None):
