...
company_Product.attributes={company_Product_vat, company_Product_name, company_Product_description, company_Product_price}
...
domain_model = DomainModel(
    name="company",
    types={company_Addressable, company_Company, Addressable, company_Category, company_Supplier, company_Customer, company_PurchaseOrder, company_SalesOrder, company_Order, company_OrderDetail, company_Product, Order, VAT},
    associations={categories0, suppliers1, customers3, purchaseOrders5, salesOrders7, purchaseOrders9, salesOrders10, orderDetails11, order12, supplier15, customer16, categories18, products20, orderDetails22, product13},
