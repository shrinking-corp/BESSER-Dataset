...
prolog_Numeral = Class(name="prolog_Numeral")
Term = Class(name="Term")
prolog_Variable = Class(name="prolog_Variable")
Tail = Class(name="Tail")
prolog_String = Class(name="prolog_String")
prolog_List = Class(name="prolog_List")
prolog_PrologProgram = Class(name="prolog_PrologProgram")
prolog_Clause = Class(name="prolog_Clause")
prolog_Predicate = Class(name="prolog_Predicate")
prolog_Conjunction = Class(name="prolog_Conjunction")
prolog_Multiplicative = Class(name="prolog_Multiplicative")
prolog_Tail = Class(name="prolog_Tail", is_abstract=True)
Part = Class(name="Part")
prolog_VariableReference = Class(name="prolog_VariableReference")
prolog_AnonymousVariable = Class(name="prolog_AnonymousVariable")
prolog_Assignment = Class(name="prolog_Assignment")
prolog_Part = Class(name="prolog_Part", is_abstract=True)
prolog_Additive = Class(name="prolog_Additive")
prolog_Power = Class(name="prolog_Power")
prolog_Negation = Class(name="prolog_Negation")
prolog_BracketExpression = Class(name="prolog_BracketExpression")
...
domain_model = DomainModel(
    name="prolog",
    types={prolog_Term, prolog_Numeral, Term, prolog_Variable, Tail, prolog_String, prolog_List, prolog_PrologProgram, prolog_Clause, prolog_Predicate, prolog_Conjunction, prolog_Multiplicative, prolog_Tail, Part, prolog_VariableReference, prolog_AnonymousVariable, prolog_Assignment, prolog_Part, prolog_Additive, prolog_Power, prolog_Negation, prolog_BracketExpression, ADDITIVE_OPERATOR, MULTIPLICATIVE_OPERATOR},
    associations={clauses0, predicate1, conjunction3, left24, right26, headTerms5, tail6, terms8, variable11, variable12, term14, parts17, left19, right21, base29, exponent31, body34, body36},
    generalizations={gen_prolog_Numeral_Term, gen_prolog_Variable_Term, gen_prolog_Variable_Tail, gen_prolog_String_Term, gen_prolog_Multiplicative_Term, gen_prolog_List_Term, gen_prolog_List_Tail, gen_prolog_Predicate_Part, gen_prolog_Predicate_Term, gen_prolog_VariableReference_Term, gen_prolog_AnonymousVariable_Term, gen_prolog_Assignment_Part, gen_prolog_Additive_Term, gen_prolog_Power_Term, gen_prolog_Negation_Term, gen_prolog_BracketExpression_Term},
    metadata=None
)
