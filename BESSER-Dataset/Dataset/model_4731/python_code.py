...
class prolog_Power(Term):
    ...
    pass
class prolog_Variable(Term, Tail):
...
class prolog_Predicate(Term, Part):
    ...
    def __init__(self, name: str, prolog_Predicate9: set["prolog_Term"] = None, prolog_Predicate: "prolog_Clause" = None):
        self.name = name
