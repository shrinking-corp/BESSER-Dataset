...
class Literal:
    ...
    pass
class vcml_NumericLiteral(NumberListEntry, Literal):
...
class Condition:
    ...
    pass
class vcml_PFunction(SimpleStatement, FunctionOrTable, Condition):
...
class vcml_BinaryCondition(Condition):
    ...
    def __init__(self, operator: str, vcml_BinaryCondition: "vcml_Condition" = None, vcml_BinaryCondition277: "vcml_Condition" = None):
        self.operator = operator
...
class vcml_Table(ConstraintRestriction, SimpleStatement, FunctionOrTable, Condition):
...
class vcml_Function(ConstraintRestriction, SimpleStatement, FunctionOrTable, Condition):
...
class vcml_ShortVarDefinition:
    ...
    def __init__(self, name: str, vcml_ShortVarDefinition156: "vcml_Characteristic" = None, vcml_ShortVarDefinition175: "vcml_ShortVarReference" = None, vcml_ShortVarDefinition: "vcml_ConstraintObject" = None):
        self.name = name
...
class vcml_ConstraintObject:
    ...
    def __init__(self, name: str, vcml_ConstraintObject: "vcml_ConstraintSource" = None, vcml_ConstraintObject159: "vcml_PartOfCondition" = None, vcml_ConstraintObject162: "vcml_PartOfCondition" = None, vcml_ConstraintObject164: "vcml_SubpartOfCondition" = None, vcml_ConstraintObject167: "vcml_SubpartOfCondition" = None, vcml_ConstraintObject170: "vcml_ObjectCharacteristicReference" = None, vcml_ConstraintObject146: set["vcml_ShortVarDefinition"] = None):
        self.name = name
...
class vcml_VariantFunctionArgument:
    ...
    def __init__(self, in_: bool, vcml_VariantFunctionArgument: "vcml_VariantFunction" = None, vcml_VariantFunctionArgument119: "vcml_Characteristic" = None):
        self.in_ = in_
...
class vcml_DateCharacteristicValue:
    ...
    def __init__(self, from_: str, to: str, default: bool, vcml_DateCharacteristicValue: "vcml_DateType" = None, vcml_DateCharacteristicValue47: "vcml_CharacteristicOrValueDependencies" = None, vcml_DateCharacteristicValue44: "vcml_Documentation" = None):
        self.from_ = from_
        self.to = to
...
class vcml_CharacteristicValue:
    ...
    def __init__(self, name: str, default: bool, vcml_CharacteristicValue33: "vcml_CharacteristicOrValueDependencies" = None, vcml_CharacteristicValue: "vcml_SymbolicType" = None, vcml_CharacteristicValue27: "vcml_Description" = None, vcml_CharacteristicValue30: "vcml_Documentation" = None):
        self.name = name
        self.default = default
...
class vcml_NumericCharacteristicValue:
    ...
    def __init__(self, default: bool, vcml_NumericCharacteristicValue: "vcml_NumericType" = None, vcml_NumericCharacteristicValue36: "vcml_NumberListEntry" = None, vcml_NumericCharacteristicValue38: "vcml_Documentation" = None, vcml_NumericCharacteristicValue41: "vcml_CharacteristicOrValueDependencies" = None):
        self.default = default
...
class vcml_Characteristic(VCObject):
    ...
    def __init__(self, field: str, status: str, group: str, additionalValues: bool, required: bool, restrictable: bool, noDisplay: bool, notReadyForInput: bool, multiValue: bool, displayAllowedValues: bool, table: str, vcml_Characteristic: "vcml_Documentation" = None, vcml_Characteristic20: "vcml_CharacteristicType" = None, vcml_Characteristic22: "vcml_CharacteristicOrValueDependencies" = None, vcml_Characteristic53: "vcml_Class" = None, vcml_Characteristic101: "vcml_CharacteristicGroup" = None, vcml_Characteristic114: "vcml_ValueAssignment" = None, vcml_Characteristic120: "vcml_VariantFunctionArgument" = None, vcml_Characteristic124: "vcml_VariantTableArgument" = None, vcml_Characteristic157: "vcml_ShortVarDefinition" = None, vcml_Characteristic173: "vcml_ObjectCharacteristicReference" = None, vcml_Characteristic180: "vcml_Assignment" = None, vcml_Characteristic223: "vcml_CharacteristicReference_P" = None, vcml_Characteristic187: "vcml_Function" = None, vcml_Characteristic195: "vcml_PFunction" = None, vcml_Characteristic203: "vcml_Table" = None, vcml_Characteristic208: "vcml_SetOrDelDefault" = None, vcml_Characteristic213: "vcml_IsInvisible" = None, vcml_Characteristic215: "vcml_SetPricingFactor" = None, vcml_Characteristic229: "vcml_SumParts" = None):
        self.field = field
        self.status = status
        self.group = group
...
class vcml_ConfigurationProfile(VCObject):
    ...
    def __init__(self, status: str, bomapplication: str, fixing: str, vcml_ConfigurationProfile: "vcml_InterfaceDesign" = None, vcml_ConfigurationProfile59: set["vcml_DependencyNet"] = None, vcml_ConfigurationProfile61: set["vcml_ConfigurationProfileEntry"] = None, configurationprofiles: "vcml_Material" = None, ConfigurationProfile: "vcml_Material" = None):
        self.status = status
...
class vcml_SelectionCondition(Dependency, VCObject):
...
class vcml_Precondition(Dependency, VCObject):
...
class vcml_Procedure(Dependency, VCObject):
...
class vcml_Constraint(VCObject, Dependency):
    ...
    def __init__(self, status: str, group: str, vcml_Constraint87: "vcml_Documentation" = None, vcml_Constraint: "vcml_DependencyNet" = None, vcml_Constraint90: "vcml_ConstraintSource" = None):
        self.status = status
        self.group = group
...
class vcml_DateType(CharacteristicType):
    ...
    def __init__(self, intervalValuesAllowed: bool, vcml_DateType: set["vcml_DateCharacteristicValue"] = None):
        ...
        pass
    @property
    def intervalValuesAllowed(self):
...
class vcml_NumericType(CharacteristicType):
    ...
    @property
    def negativeValuesAllowed(self):
