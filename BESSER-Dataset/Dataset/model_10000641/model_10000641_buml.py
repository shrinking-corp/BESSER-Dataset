...
Restaurant.attributes={Restaurant_Menu, Restaurant_Address, Restaurant_Name, Restaurant_PostCode}
...
Customer.attributes={Customer_Cellphone, Customer_FullName, Customer_CreditCard, Customer_PostCode, Customer_Address}
...
domain_model = DomainModel(
    name="_4f1fbbf0_8f30_46a9_9a84_891ee2e288ad",
    types={Restaurant, MenuItem, FoodPackage, FoodItem, Food, Order, Customer, RestaurantController, OrderController},
    associations={MenuItem_FoodPackage, FoodItem_Food, FoodPackage_Food, Restaurant_MenuItem, Order_MenuItem, Order_Restaurant, Order_Customer, RestaurantManager_Restaurant, OrderController_Order, MenuItem_FoodItem},
    generalizations={},
    metadata=None
)
