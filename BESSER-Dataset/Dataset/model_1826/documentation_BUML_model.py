...
domain_model = DomainModel(
    name="Documentation",
    types={Documentation_Book, Documentation_Section, Documentation_TextualValue, ParagraphValue, Documentation_ItemizedListValue, Documentation_ItemizedListValueItem, Paragraph, Documentation_EmphasisValue, Documentation_XRefValue, Documentation_InformalTableValue, Documentation_InformalTableValueGroup, Documentation_InformalTableValueHead, Documentation_InformalTableValueBody, Documentation_InformalTableValueRow, Documentation_Paragraph, Documentation_ParagraphValue, Documentation_InformalTableValueEntry},
    associations={content0, items8, linkend9, tgroup11, thead12, tbody14, rows16, values1, section3, para5, rows18, entry21},
