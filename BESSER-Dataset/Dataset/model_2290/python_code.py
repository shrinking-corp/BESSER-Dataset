...
class lobj_Publisher:
    ...
    def __init__(self, id: str, publishername: str, lobj_Publisher190: "lobj_PublishInfo" = None, lobj_Publisher: "lobj_Address" = None):
        self.id = id
...
class lobj_PublishInfo:
    ...
    def __init__(self, edition: str, pubdate: date, pubsnumber: str, releaseinfo: str, id: str, lobj_PublishInfo: "lobj_LuMeta" = None, lobj_PublishInfo189: "lobj_Publisher" = None, lobj_PublishInfo209: "lobj_ModuleMeta" = None):
...
class lobj_Precognition:
    ...
    def __init__(self, id: str, precog: str, lobj_Precognition: "lobj_DidacMeta" = None, lobj_Precognition197: set["lobj_InternalRef"] = None):
        self.id = id
        self.precog = precog
...
class lobj_Person:
    ...
    def __init__(self, honorific: str, firstname: str, surname: str, contrib: str, personblurb: str, id: str, lobj_Person: "lobj_Author" = None, lobj_Person184: set["lobj_Affiliation"] = None):
...
class lobj_Author:
    ...
    def __init__(self, email: str, id: str, credittype: str, lobj_Author: "lobj_Person" = None, lobj_Author137: "lobj_Address" = None, lobj_Author172: "lobj_LuMeta" = None, lobj_Author215: "lobj_Source" = None, lobj_Author206: "lobj_ModuleMeta" = None):
        self.email = email
        self.id = id
...
class lobj_Blocktype:
    ...
    def __init__(self, name: str, description: str, creationDate: date, styleRef: str, id: str, lobj_Blocktype: "lobj_BlockMeta" = None, blocktypes: set["lobj_Domain"] = None, Blocktype: "lobj_Domain" = None):
        self.name = name
        self.description = description
        self.creationDate = creationDate
...
class lobj_Address:
    ...
    def __init__(self, state: str, country: str, phone: str, fax: str, email: str, otheraddr: str, id: str, street: str, postcode: str, city: str, lobj_Address: "lobj_Affiliation" = None, lobj_Address138: "lobj_Author" = None, lobj_Address187: "lobj_Publisher" = None):
        self.state = state
...
class lobj_Edition:
    ...
    def __init__(self, id: str, editionNr: str, editedBy: str, version: str, lastVersionNumber: str, status: str, editionCreationDate: date, lobj_Edition: "lobj_AccessControl" = None):
        self.id = id
...
class lobj_Userauthorization:
    ...
    def __init__(self, id: str, lobj_Userauthorization: "lobj_AccessControl" = None, lobj_Userauthorization182: "lobj_AuthorizationTypes" = None, lobj_Userauthorization179: "lobj_User" = None):
        self.id = id
...
class lobj_User:
    ...
    def __init__(self, matriculationnr: str, scn: str, icqnumber: str, icqpassword: str, entryasxml: str, languagenr: str, notificationprofileasxml: str, dossierasxml: str, photo: str, onlinestatus: str, onlinedate: date, datafilter: str, loginname: str, password: str, firstname: str, lastname: str, inchatsince: date, contchatdate: date, chatroomnr: str, fromext: str, lastlogindate: date, id: str, currlogindate: date, lastcoursematerialnr: str, lastcoursematerialviewnr: str, authenticateldap: str, photochanged: str, lobj_User: "lobj_AccessControl" = None, lobj_User124: "lobj_AccessControl" = None, lobj_User127: "lobj_AccessControl" = None, lobj_User155: "lobj_CourseMeta" = None, lobj_User180: "lobj_Userauthorization" = None, lobj_User217: set["lobj_AuthorizationTypes"] = None):
    ...
    @property
    def notificationprofileasxml(self):
    ...
    @property
    def lastcoursematerialviewnr(self):
...
class lobj_ResrcFiletype:
    ...
    def __init__(self, id: str, filetypeExtension: str, filetypeDesc: str, image: bool, applet: bool, filetypeImageSmall: str, filetypeImageBif: str, lobj_ResrcFiletype119: "lobj_BlockAudiofile" = None, lobj_ResrcFiletype: "lobj_ResrcFile" = None):
        self.id = id
...
class lobj_SimpleDidacMeta:
    ...
    def __init__(self, id: str, title: str, description: str, keywords: str, lobj_SimpleDidacMeta143: "lobj_BlockMeta" = None, lobj_SimpleDidacMeta160: "lobj_Language" = None, lobj_SimpleDidacMeta: "lobj_Theme" = None):
        self.id = id
        self.title = title
        self.description = description
...
class lobj_Coursetype:
    ...
    def __init__(self, title: str, description: str, id: str, lobj_Coursetype: "lobj_Course" = None, lobj_Coursetype194: "lobj_Language" = None):
        self.title = title
        self.description = description
        self.id = id
...
class lobj_PresentationBlock:
    ...
    def __init__(self, lod: int, rendering: str, id: str, lobj_PresentationBlock: "lobj_CorrBlock" = None, lobj_PresentationBlock97: "lobj_Block" = None):
        self.lod = lod
...
class lobj_CorrBlock:
    ...
    def __init__(self, id: str, lobj_CorrBlock39: "lobj_Item" = None, lobj_CorrBlock: set["lobj_PresentationBlock"] = None, lobj_CorrBlock27: set["lobj_TitleMeta"] = None):
        self.id = id
...
class lobj_AccessControl:
    ...
    def __init__(self, lastModified: date, status: str, lastStatusChange: date, globalAccess: bool, id: str, lobj_AccessControl: "lobj_Block" = None, lobj_AccessControl21: "lobj_BlockFolder" = None, lobj_AccessControl121: "lobj_User" = None, lobj_AccessControl123: "lobj_User" = None, lobj_AccessControl126: "lobj_User" = None, lobj_AccessControl129: "lobj_Sharednotes" = None, lobj_AccessControl131: set["lobj_Userauthorization"] = None, lobj_AccessControl133: set["lobj_Edition"] = None, lobj_AccessControl49: "lobj_LearningUnit" = None, lobj_AccessControl63: "lobj_LuFolder" = None, lobj_AccessControl92: "lobj_ResrcFolder" = None, lobj_AccessControl73: "lobj_Module" = None, lobj_AccessControl84: "lobj_ModuleFolder" = None, lobj_AccessControl108: "lobj_ResrcFile" = None):
...
class lobj_ExternalMetadata:
    ...
    def __init__(self, ref: str, file: str, id: str, lobj_ExternalMetadata46: "lobj_LearningUnit" = None, lobj_ExternalMetadata33: "lobj_Course" = None, lobj_ExternalMetadata68: "lobj_Module" = None, lobj_ExternalMetadata: "lobj_Block" = None):
        self.ref = ref
        self.file = file
        self.id = id
...
class lobj_Course(LearningObject):
    ...
    def __init__(self, outlineAsXml: str, lobj_Course: "lobj_Category" = None, lobj_Course30: "lobj_CourseMeta" = None, lobj_Course32: set["lobj_ExternalMetadata"] = None, lobj_Course35: "lobj_Coursetype" = None, lobj_Course37: set["lobj_Module"] = None):
...
class lobj_FolderMeta(LearningObject):
    ...
    def __init__(self, title: str, description: str, creationDate: date, lobj_FolderMeta: "lobj_BlockFolder" = None, lobj_FolderMeta54: "lobj_LuFolder" = None, lobj_FolderMeta75: "lobj_ModuleFolder" = None, lobj_FolderMeta86: "lobj_ResrcFolder" = None):
        self.title = title
        self.description = description
        self.creationDate = creationDate
...
class lobj_LuMeta(LearningObject):
    ...
    def __init__(self, creationDate: date, lobj_LuMeta: "lobj_LearningUnit" = None, lobj_LuMeta166: set["lobj_DidacMeta"] = None, lobj_LuMeta169: "lobj_Domain" = None, lobj_LuMeta171: set["lobj_Author"] = None, lobj_LuMeta174: "lobj_PublishInfo" = None, lobj_LuMeta176: "lobj_Language" = None):
        self.creationDate = creationDate
...
class lobj_ResrcFolder(LearningObject):
    ...
    def __init__(self, deleteScheduled: bool, lobj_ResrcFolder87: set["lobj_ResrcFolder"] = None, lobj_ResrcFolder89: "lobj_ResrcFolder" = None, lobj_ResrcFolder91: "lobj_AccessControl" = None, lobj_ResrcFolder94: set["lobj_ResrcFile"] = None, lobj_ResrcFolder: "lobj_FolderMeta" = None):
...
class lobj_ModuleMeta(LearningObject):
    ...
    def __init__(self, creationDate: date, lobj_ModuleMeta: "lobj_Module" = None, lobj_ModuleMeta208: "lobj_PublishInfo" = None, lobj_ModuleMeta211: "lobj_Language" = None, lobj_ModuleMeta202: set["lobj_DidacMeta"] = None, lobj_ModuleMeta205: set["lobj_Author"] = None):
        self.creationDate = creationDate
...
class lobj_Module(LearningObject):
    ...
    def __init__(self, moduleFile: str, treeAsXml: str, lobj_Module: "lobj_Course" = None, lobj_Module65: "lobj_ModuleMeta" = None, lobj_Module67: set["lobj_ExternalMetadata"] = None, lobj_Module70: "lobj_Node" = None, lobj_Module72: "lobj_AccessControl" = None, lobj_Module81: "lobj_ModuleFolder" = None):
...
class lobj_CourseMeta(LearningObject):
    ...
    def __init__(self, hours: int, lvanr: str, columnfilterasxml: str, fromext: str, creationDate: date, lobj_CourseMeta: "lobj_Course" = None, lobj_CourseMeta152: set["lobj_DidacMeta"] = None, lobj_CourseMeta154: "lobj_User" = None, lobj_CourseMeta157: "lobj_Language" = None):
        self.hours = hours
        self.lvanr = lvanr
...
class lobj_BlockAudiofile(LearningObject):
    ...
    def __init__(self, file: str, originalextension: str, filesize: int, resrcHref: str, lobj_BlockAudiofile: "lobj_HypertextContent" = None, lobj_BlockAudiofile118: "lobj_ResrcFiletype" = None):
        self.file = file
...
class lobj_ResrcFile(LearningObject):
    ...
    def __init__(self, file: str, file_tn: str, originalextension: str, filesize: int, resrcHref: str, ResrcFile: "lobj_HypertextContent" = None, resrcFile: set["lobj_HypertextContent"] = None, lobj_ResrcFile: "lobj_ResrcFolder" = None, lobj_ResrcFile116: "lobj_ResrcMeta" = None, lobj_ResrcFile107: "lobj_AccessControl" = None, lobj_ResrcFile110: "lobj_ResrcFiletype" = None, lobj_ResrcFile112: "lobj_Source" = None):
        self.file = file
...
class lobj_LearningObject(ABC):
    ...
    def __init__(self, id: str, timestamp: date, synchronized: bool):
        self.id = id
...
class lobj_AbstractContent(LearningObject):
    ...
    def __init__(self, heading: str, lobj_AbstractContent8: "lobj_Source" = None, lobj_AbstractContent: "lobj_Language" = None):
...
class lobj_HypertextContent(AbstractContent):
    ...
    def __init__(self, content: str, lobj_HypertextContent10: "lobj_BlockAudiofile" = None, hypertextContent: set["lobj_ResrcFile"] = None, lobj_HypertextContent: "lobj_HypertextBlock" = None, HypertextContent: "lobj_ResrcFile" = None):
        self.content = content
