...
# Classes
lobj_HypertextBlock = Class(name="lobj_HypertextBlock")
Block = Class(name="Block")
lobj_HypertextContent = Class(name="lobj_HypertextContent")
lobj_AbstractContent = Class(name="lobj_AbstractContent", is_abstract=True)
lobj_Language = Class(name="lobj_Language")
lobj_LearningObject = Class(name="lobj_LearningObject", is_abstract=True)
lobj_Block = Class(name="lobj_Block", is_abstract=True)
LearningObject = Class(name="LearningObject")
lobj_BlockMeta = Class(name="lobj_BlockMeta")
lobj_ExternalMetadata = Class(name="lobj_ExternalMetadata")
lobj_AccessControl = Class(name="lobj_AccessControl")
lobj_Category = Class(name="lobj_Category")
lobj_TitleMeta = Class(name="lobj_TitleMeta")
lobj_Course = Class(name="lobj_Course")
lobj_CorrBlock = Class(name="lobj_CorrBlock")
lobj_Source = Class(name="lobj_Source")
AbstractContent = Class(name="AbstractContent")
lobj_BlockAudiofile = Class(name="lobj_BlockAudiofile")
lobj_ResrcFile = Class(name="lobj_ResrcFile")
lobj_BlockFolder = Class(name="lobj_BlockFolder")
lobj_FolderMeta = Class(name="lobj_FolderMeta")
lobj_LearningUnit = Class(name="lobj_LearningUnit")
lobj_LuMeta = Class(name="lobj_LuMeta")
lobj_PresentationBlock = Class(name="lobj_PresentationBlock")
lobj_CourseMeta = Class(name="lobj_CourseMeta")
lobj_Coursetype = Class(name="lobj_Coursetype")
lobj_Module = Class(name="lobj_Module")
lobj_Item = Class(name="lobj_Item")
lobj_ModuleMeta = Class(name="lobj_ModuleMeta")
lobj_Node = Class(name="lobj_Node", is_abstract=True)
lobj_LuFolder = Class(name="lobj_LuFolder")
lobj_Theme = Class(name="lobj_Theme")
lobj_SimpleDidacMeta = Class(name="lobj_SimpleDidacMeta")
lobj_ModuleFolder = Class(name="lobj_ModuleFolder")
lobj_ResrcFolder = Class(name="lobj_ResrcFolder")
lobj_LuNode = Class(name="lobj_LuNode")
lobj_ThemeNode = Class(name="lobj_ThemeNode")
Node = Class(name="Node")
lobj_ResrcMeta = Class(name="lobj_ResrcMeta")
lobj_ResrcFiletype = Class(name="lobj_ResrcFiletype")
lobj_User = Class(name="lobj_User")
lobj_Sharednotes = Class(name="lobj_Sharednotes")
lobj_Affiliation = Class(name="lobj_Affiliation")
lobj_Userauthorization = Class(name="lobj_Userauthorization")
lobj_Edition = Class(name="lobj_Edition")
lobj_Address = Class(name="lobj_Address")
lobj_Blocktype = Class(name="lobj_Blocktype")
lobj_Author = Class(name="lobj_Author")
lobj_Person = Class(name="lobj_Person")
lobj_DidacMeta = Class(name="lobj_DidacMeta")
lobj_Domain = Class(name="lobj_Domain")
SimpleDidacMeta = Class(name="SimpleDidacMeta")
lobj_Precognition = Class(name="lobj_Precognition")
lobj_AuthorizationTypes = Class(name="lobj_AuthorizationTypes")
lobj_Note = Class(name="lobj_Note")
lobj_PublishInfo = Class(name="lobj_PublishInfo")
lobj_Publisher = Class(name="lobj_Publisher")
lobj_InternalRef = Class(name="lobj_InternalRef")
...
lobj_Language.attributes={lobj_Language_code, lobj_Language_language}
...
lobj_LearningObject.attributes={lobj_LearningObject_synchronized, lobj_LearningObject_id, lobj_LearningObject_timestamp}
...
lobj_BlockMeta.attributes={lobj_BlockMeta_creationDate, lobj_BlockMeta_rendering, lobj_BlockMeta_lastModified, lobj_BlockMeta_lod}
...
lobj_AccessControl.attributes={lobj_AccessControl_id, lobj_AccessControl_status, lobj_AccessControl_lastModified, lobj_AccessControl_globalAccess, lobj_AccessControl_lastStatusChange}
...
lobj_TitleMeta.attributes={lobj_TitleMeta_id, lobj_TitleMeta_title}
...
lobj_Source.attributes={lobj_Source_pp, lobj_Source_id, lobj_Source_title, lobj_Source_publishedBy, lobj_Source_publishedIn, lobj_Source_publishDate, lobj_Source_subtitle}
...
lobj_BlockAudiofile.attributes={lobj_BlockAudiofile_resrcHref, lobj_BlockAudiofile_file, lobj_BlockAudiofile_originalextension, lobj_BlockAudiofile_filesize}
...
lobj_ResrcFile.attributes={lobj_ResrcFile_originalextension, lobj_ResrcFile_resrcHref, lobj_ResrcFile_file, lobj_ResrcFile_filesize, lobj_ResrcFile_file_tn}
...
lobj_CourseMeta.attributes={lobj_CourseMeta_lvanr, lobj_CourseMeta_creationDate, lobj_CourseMeta_hours, lobj_CourseMeta_fromext, lobj_CourseMeta_columnfilterasxml}
...
lobj_Coursetype.attributes={lobj_Coursetype_description, lobj_Coursetype_id, lobj_Coursetype_title}
...
lobj_SimpleDidacMeta.attributes={lobj_SimpleDidacMeta_description, lobj_SimpleDidacMeta_id, lobj_SimpleDidacMeta_keywords, lobj_SimpleDidacMeta_title}
...
lobj_ResrcMeta.attributes={lobj_ResrcMeta_height, lobj_ResrcMeta_creationDate, lobj_ResrcMeta_filename, lobj_ResrcMeta_title, lobj_ResrcMeta_description, lobj_ResrcMeta_keywords, lobj_ResrcMeta_parameters, lobj_ResrcMeta_width, lobj_ResrcMeta_lastModified}
...
lobj_ResrcFiletype.attributes={lobj_ResrcFiletype_id, lobj_ResrcFiletype_filetypeDesc, lobj_ResrcFiletype_image, lobj_ResrcFiletype_filetypeImageBif, lobj_ResrcFiletype_applet, lobj_ResrcFiletype_filetypeImageSmall, lobj_ResrcFiletype_filetypeExtension}
...
lobj_User.attributes={lobj_User_notificationprofileasxml, lobj_User_matriculationnr, lobj_User_scn, lobj_User_photo, lobj_User_icqpassword, lobj_User_contchatdate, lobj_User_inchatsince, lobj_User_onlinedate, lobj_User_languagenr, lobj_User_currlogindate, lobj_User_datafilter, lobj_User_firstname, lobj_User_lastlogindate, lobj_User_dossierasxml, lobj_User_lastcoursematerialviewnr, lobj_User_authenticateldap, lobj_User_fromext, lobj_User_lastname, lobj_User_photochanged, lobj_User_id, lobj_User_chatroomnr, lobj_User_loginname, lobj_User_onlinestatus, lobj_User_password, lobj_User_lastcoursematerialnr, lobj_User_entryasxml, lobj_User_icqnumber}
...
lobj_Affiliation.attributes={lobj_Affiliation_jobtitle, lobj_Affiliation_orgdiv, lobj_Affiliation_id, lobj_Affiliation_shortaffil, lobj_Affiliation_orgname}
...
lobj_Edition.attributes={lobj_Edition_editionCreationDate, lobj_Edition_version, lobj_Edition_status, lobj_Edition_editedBy, lobj_Edition_lastVersionNumber, lobj_Edition_editionNr, lobj_Edition_id}
...
lobj_Address.attributes={lobj_Address_city, lobj_Address_postcode, lobj_Address_country, lobj_Address_email, lobj_Address_otheraddr, lobj_Address_street, lobj_Address_fax, lobj_Address_state, lobj_Address_id, lobj_Address_phone}
...
lobj_Blocktype.attributes={lobj_Blocktype_name, lobj_Blocktype_id, lobj_Blocktype_styleRef, lobj_Blocktype_description, lobj_Blocktype_creationDate}
...
lobj_Author.attributes={lobj_Author_credittype, lobj_Author_id, lobj_Author_email}
...
lobj_Person.attributes={lobj_Person_personblurb, lobj_Person_surname, lobj_Person_id, lobj_Person_contrib, lobj_Person_firstname, lobj_Person_honorific}
...
lobj_Domain.attributes={lobj_Domain_creationDate, lobj_Domain_id, lobj_Domain_description, lobj_Domain_name, lobj_Domain_serverURL}
...
lobj_Precognition.attributes={lobj_Precognition_precog, lobj_Precognition_id}
...
lobj_AuthorizationTypes.attributes={lobj_AuthorizationTypes_readOnly, lobj_AuthorizationTypes_id, lobj_AuthorizationTypes_authType, lobj_AuthorizationTypes_authTypeDesc}
...
lobj_Note.attributes={lobj_Note_id, lobj_Note_date, lobj_Note_noteAuthor, lobj_Note_content}
...
lobj_PublishInfo.attributes={lobj_PublishInfo_releaseinfo, lobj_PublishInfo_pubsnumber, lobj_PublishInfo_edition, lobj_PublishInfo_id, lobj_PublishInfo_pubdate}
...
lobj_InternalRef.attributes={lobj_InternalRef_ref, lobj_InternalRef_id, lobj_InternalRef_file, lobj_InternalRef_reftype}
...
domain_model = DomainModel(
    name="lobj",
    types={lobj_HypertextBlock, Block, lobj_HypertextContent, lobj_AbstractContent, lobj_Language, lobj_LearningObject, lobj_Block, LearningObject, lobj_BlockMeta, lobj_ExternalMetadata, lobj_AccessControl, lobj_Category, lobj_TitleMeta, lobj_Course, lobj_CorrBlock, lobj_Source, AbstractContent, lobj_BlockAudiofile, lobj_ResrcFile, lobj_BlockFolder, lobj_FolderMeta, lobj_LearningUnit, lobj_LuMeta, lobj_PresentationBlock, lobj_CourseMeta, lobj_Coursetype, lobj_Module, lobj_Item, lobj_ModuleMeta, lobj_Node, lobj_LuFolder, lobj_Theme, lobj_SimpleDidacMeta, lobj_ModuleFolder, lobj_ResrcFolder, lobj_LuNode, lobj_ThemeNode, Node, lobj_ResrcMeta, lobj_ResrcFiletype, lobj_User, lobj_Sharednotes, lobj_Affiliation, lobj_Userauthorization, lobj_Edition, lobj_Address, lobj_Blocktype, lobj_Author, lobj_Person, lobj_DidacMeta, lobj_Domain, SimpleDidacMeta, lobj_Precognition, lobj_AuthorizationTypes, lobj_Note, lobj_PublishInfo, lobj_Publisher, lobj_InternalRef},
    associations={hypertextContent5, language6, blockMeta0, externalMetadata1, accessControl3, accessControl19, titleMeta22, course23, source7, blockAudiofile9, resrcFile11, folderMeta12, blockFolder14, block16, corrBlock38, childitems41, luMeta43, externalMetadata44, presentationBlock25, titleMeta26, courseMeta29, externalMetadata31, coursetype34, module36, moduleMeta64, externalMetadata66, rootNode69, accessControl47, item50, folderMeta53, luFolder56, learningUnit58, accessControl61, resrcFolder88, accessControl90, resrcFile93, simpleDidacMeta95, accessControl71, folderMeta74, moduleFolder77, module79, accessControl82, folderMeta85, childnodes101, learningUnit104, block96, theme99, resrcMeta115, accesscontrol106, resrcFiletype109, source111, hypertextContent114, owner120, lastModifiedBy122, lastStatusChangeBy125, sharednotes128, resrcFiletype117, authorizes130, editionHistory132, blocktype139, simpleDidacMeta141, address134, person135, address136, didacMeta151, lecturer153, defLang144, domains147, language148, precognition162, blocktypes164, defLang156, language159, authType181, didacMeta165, domain168, authors170, publishInfo173, defLang175, user178, publisher188, affiliations183, address186, language193, notes191, internalRefs196, language198, publishInfo207, defLang210, author213, didacMeta201, authors204, authorizations216},
    generalizations={gen_lobj_HypertextBlock_Block, gen_lobj_AbstractContent_LearningObject, gen_lobj_Block_LearningObject, gen_lobj_Category_LearningObject, gen_lobj_HypertextContent_AbstractContent, gen_lobj_BlockFolder_LearningObject, gen_lobj_LearningUnit_LearningObject, gen_lobj_Course_LearningObject, gen_lobj_Module_LearningObject, gen_lobj_LuFolder_LearningObject, gen_lobj_Theme_LearningObject, gen_lobj_ModuleFolder_LearningObject, gen_lobj_ResrcFolder_LearningObject, gen_lobj_LuNode_Node, gen_lobj_ResrcFile_LearningObject, gen_lobj_ThemeNode_Node, gen_lobj_BlockAudiofile_LearningObject, gen_lobj_BlockMeta_LearningObject, gen_lobj_CourseMeta_LearningObject, gen_lobj_DidacMeta_SimpleDidacMeta, gen_lobj_FolderMeta_LearningObject, gen_lobj_LuMeta_LearningObject, gen_lobj_ResrcMeta_LearningObject, gen_lobj_ModuleMeta_LearningObject},
    metadata=None
)
