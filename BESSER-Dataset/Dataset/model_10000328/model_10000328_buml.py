...
domain_model = DomainModel(
    name="_2939d9e3_05ad_40b1_9473_fcda718079e1",
    ...
    associations={Monopoly_Tarjeta, Monopoly_Tarjeta2, Monopoly_Dados, Servicio_TituloServicio, Ferrocarril_TituloFerrocarril, Monopoly_Jugador, Monopoly_Jugador2, Propiedad_TituloPropiedad, Jugador_Titulo, Jugador_TSalirCarcel, Monopoly_Casilla},
    generalizations={},
    metadata=None
)
