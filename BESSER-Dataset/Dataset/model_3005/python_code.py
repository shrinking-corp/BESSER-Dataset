...
class miniJava_TypeDeclaration(NamedElement):
    ...
    def __init__(self, accessLevel: str, miniJava_TypeDeclaration43: "miniJava_ClassRef" = None, miniJava_TypeDeclaration: "miniJava_Program" = None, miniJava_TypeDeclaration4: set["miniJava_Interface"] = None, miniJava_TypeDeclaration6: set["miniJava_Member"] = None):
