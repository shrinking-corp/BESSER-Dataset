...
# Classes
libraryModel_Library = Class(name="libraryModel_Library")
libraryModel_Writer = Class(name="libraryModel_Writer")
libraryModel_Book = Class(name="libraryModel_Book")
...
libraryModel_Book.attributes={libraryModel_Book_category, libraryModel_Book_title, libraryModel_Book_pages}
