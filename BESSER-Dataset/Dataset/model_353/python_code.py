...
class libraryModel_Book:
    ...
    def __init__(self, pages: int, category: str, title: str, libraryModel_Book: "libraryModel_Library" = None, Book: "libraryModel_Writer" = None, books: "libraryModel_Writer" = None):
        self.pages = pages
