...
class stateChart_Transient:
    ...
    def __init__(self, priority: int, name: str, trigger: str, guard: str, effect: str, stateChart_Transient: "stateChart_Region" = None, stateChart_Transient4: "stateChart_Vertex" = None, stateChart_Transient7: "stateChart_Vertex" = None):
...
class stateChart_Region:
    ...
    def __init__(self, name: str, note: str, stateChart_Region10: "stateChart_StateMachine" = None, stateChart_Region: set["stateChart_Transient"] = None, stateChart_Region2: set["stateChart_Vertex"] = None, stateChart_Region12: "stateChart_CompositeState" = None):
        self.name = name
        self.note = note
...
class stateChart_State(Vertex):
    ...
    def __init__(self, entry: str, exit: str, action: str):
        self.entry = entry
        self.exit = exit
        self.action = action
...
class stateChart_Vertex(ABC):
    ...
    def __init__(self, note: str, name: str, isActive: bool, stateChart_Vertex: "stateChart_Region" = None, stateChart_Vertex5: "stateChart_Transient" = None, stateChart_Vertex8: "stateChart_Transient" = None):
        self.note = note
        self.name = name
