...
stateChart_Vertex = Class(name="stateChart_Vertex", is_abstract=True)
stateChart_PseudoState = Class(name="stateChart_PseudoState")
Vertex = Class(name="Vertex")
stateChart_State = Class(name="stateChart_State", is_abstract=True)
stateChart_SimpleState = Class(name="stateChart_SimpleState")
State = Class(name="State")
stateChart_FinalState = Class(name="stateChart_FinalState")
stateChart_Region = Class(name="stateChart_Region")
stateChart_Transient = Class(name="stateChart_Transient")
...
stateChart_State.attributes={stateChart_State_entry, stateChart_State_action, stateChart_State_exit}
...
stateChart_Region.attributes={stateChart_Region_name, stateChart_Region_note}
...
stateChart_Transient.attributes={stateChart_Transient_guard, stateChart_Transient_name, stateChart_Transient_priority, stateChart_Transient_effect, stateChart_Transient_trigger}
...
domain_model = DomainModel(
    name="stateChart",
    types={stateChart_StateMachine, stateChart_Vertex, stateChart_PseudoState, Vertex, stateChart_State, stateChart_SimpleState, State, stateChart_FinalState, stateChart_Region, stateChart_Transient, stateChart_CompositeState, PseudoStateType},
    associations={mainRegion9, transient0, vertex1, source3, target6, element11},
    generalizations={gen_stateChart_PseudoState_Vertex, gen_stateChart_State_Vertex, gen_stateChart_SimpleState_State, gen_stateChart_FinalState_State, gen_stateChart_CompositeState_State},
    metadata=None
)
