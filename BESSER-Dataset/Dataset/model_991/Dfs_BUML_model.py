...
# Classes
dfs_Node = Class(name="dfs_Node")
dfs_Edge = Class(name="dfs_Edge")
dfs_DFSGraph = Class(name="dfs_DFSGraph")
dfs_EdgeProcessor = Class(name="dfs_EdgeProcessor", is_abstract=True)
dfs_EObject = Class(name="dfs_EObject")
dfs_DepthFirstSearch = Class(name="dfs_DepthFirstSearch")
...
dfs_EdgeProcessor_m_processNode: Method = Method(name="processNode", parameters={Parameter(name='dfs_node', type=StringType)}, type=StringType)
dfs_EdgeProcessor_m_processEdge: Method = Method(name="processEdge", parameters={Parameter(name='dfs_edge', type=StringType)}, type=StringType)
...
dfs_DepthFirstSearch_m_processEdge: Method = Method(name="processEdge", parameters={Parameter(name='dfs_edge', type=StringType)}, type=StringType)
dfs_DepthFirstSearch_m_processNode: Method = Method(name="processNode", parameters={Parameter(name='dfs_node', type=StringType)}, type=StringType)
dfs_DepthFirstSearch.attributes={dfs_DepthFirstSearch_postTraversalCounter, dfs_DepthFirstSearch_preTraversalCounter}
dfs_DepthFirstSearch.methods={dfs_DepthFirstSearch_m_incrementPostTraversalCounter, dfs_DepthFirstSearch_m_processEdge, dfs_DepthFirstSearch_m_incrementPreTraversalCounter, dfs_DepthFirstSearch_m_processNode}
...
domain_model = DomainModel(
    name="dfs",
    types={dfs_Node, dfs_Edge, dfs_DFSGraph, dfs_EdgeProcessor, dfs_EObject, dfs_DepthFirstSearch, EdgeProcessor, EdgeType},
    associations={delegate1, incoming2, graph3, origin4, outgoing5, graph7, source9, origin10, target12, edges14, nodes16},
