...
domain_model = DomainModel(
    name="Families",
    types={Families_Family, uncertainty_ModelElement, uncertainty_aFamily, aMember, Families_uncertainty_uFamily, uncertainty_UData, uncertainty_Families_Family, uFamily, Families_uncertainty_aFamily, Families_uncertainty_uMember, uncertainty_Families_Member, Families_Member, uncertainty_aMember, aFamily, Families_FamilyRegistry, uncertainty_aFamilyRegistry, Families_uncertainty_ModelElement, ModelElement, Families_uncertainty_UData, uMember, Families_uncertainty_aMember, Families_uncertainty_uFamilyRegistry, uncertainty_Families_FamilyRegistry, uFamilyRegistry, Families_uncertainty_aFamilyRegistry, OperatorType},
    associations={uleft14, uright15, upoint18, children0, mother1, father4, guardian7, families8, include10, exclude11, uleft20, uright21, upoint24, uleft26, uright27, upoint30},
    generalizations={gen_Families_Family_uncertainty_ModelElement, gen_Families_Family_uncertainty_aFamily, gen_Families_uncertainty_uFamily_uncertainty_aFamily, gen_Families_uncertainty_uFamily_uncertainty_UData, gen_Families_uncertainty_uMember_uncertainty_aMember, gen_Families_uncertainty_uMember_uncertainty_UData, gen_Families_Member_uncertainty_ModelElement, gen_Families_Member_uncertainty_aMember, gen_Families_FamilyRegistry_uncertainty_ModelElement, gen_Families_FamilyRegistry_uncertainty_aFamilyRegistry, gen_Families_uncertainty_uFamilyRegistry_uncertainty_aFamilyRegistry, gen_Families_uncertainty_uFamilyRegistry_uncertainty_UData},
    metadata=None
)
