...
class Families_Family(uncertainty_aFamily, uncertainty_ModelElement):
    ...
    def __init__(self, lastName: str, address: str, Families_Family: set["aMember"] = None, Families_Family2: "aMember" = None, Families_Family5: "aMember" = None):
...
class Families_uncertainty_UData(ABC):
    ...
    def __init__(self, utype: str, name: str):
        self.utype = utype
        self.name = name
