...
class Customer:
    ...
    def __init__(self, login: str, password: str, isBan: bool, firstname: str, lastname: str, emailAddress: str, id: int, cart1: "ShoppingCart" = None, account3: "Account" = None):
        self.login = login
...
class Item:
    ...
    def __init__(self, quantity: int, price: float, id: int, product13: "Product" = None, shoppingcart10: "ShoppingCart" = None):
