...
# Classes
faultTree_FaultTree = Class(name="faultTree_FaultTree")
faultTree_Gate = Class(name="faultTree_Gate")
faultTree_Event = Class(name="faultTree_Event", is_abstract=True)
faultTree_IntermediateEvent = Class(name="faultTree_IntermediateEvent")
faultTree_PrimaryEvent = Class(name="faultTree_PrimaryEvent")
faultTree_ConditioningEvent = Class(name="faultTree_ConditioningEvent")
faultTree_TransferOut = Class(name="faultTree_TransferOut")
faultTree_TransferIn = Class(name="faultTree_TransferIn")
Event = Class(name="Event")
Transfer = Class(name="Transfer")
faultTree_Transfer = Class(name="faultTree_Transfer", is_abstract=True)
...
faultTree_Gate.attributes={faultTree_Gate_type, faultTree_Gate_name, faultTree_Gate_probability}
...
faultTree_Event.attributes={faultTree_Event_name, faultTree_Event_description}
...
faultTree_PrimaryEvent.attributes={faultTree_PrimaryEvent_type, faultTree_PrimaryEvent_probability}
...
domain_model = DomainModel(
    name="faultTree",
    types={faultTree_FaultTree, faultTree_Gate, faultTree_Event, faultTree_IntermediateEvent, faultTree_PrimaryEvent, faultTree_ConditioningEvent, faultTree_TransferOut, faultTree_TransferIn, Event, Transfer, faultTree_Transfer, GateType, PrimaryEventType},
    associations={gates0, events1, intermediateEvents2, primaryEvents4, conditioningEvents6, transferOut8, transferIns10, topEvent12, inputs15, output16, faultTree17, topGates18, bottomGate23, topEvent26, bottomEvent29, transferIn31, transferOut33, event36, faultTree38, faultTree20, event40, faultTree42},
    generalizations={gen_faultTree_IntermediateEvent_Event, gen_faultTree_PrimaryEvent_Event, gen_faultTree_ConditioningEvent_Event, gen_faultTree_TransferIn_Transfer, gen_faultTree_TransferOut_Transfer},
    metadata=None
)
