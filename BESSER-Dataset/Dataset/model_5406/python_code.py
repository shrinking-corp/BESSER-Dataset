...
class faultTree_Event(ABC):
    ...
    def __init__(self, name: str, description: str, faultTree_Event: "faultTree_FaultTree" = None, Event: "faultTree_Gate" = None, inputs: set["faultTree_Gate"] = None, faultTree_Event21: "faultTree_FaultTree" = None):
        self.name = name
...
class faultTree_Gate:
    ...
    def __init__(self, name: str, type: str, probability: float, Gate: "faultTree_FaultTree" = None, topGates: set["faultTree_Event"] = None, bottomGate: "faultTree_IntermediateEvent" = None, gates: "faultTree_FaultTree" = None, Gate19: "faultTree_Event" = None, Gate24: "faultTree_IntermediateEvent" = None):
        self.name = name
        self.type = type
        self.probability = probability
        self.Gate = Gate
...
class faultTree_FaultTree:
    ...
    def __init__(self, name: str, faultTree_FaultTree3: set["faultTree_IntermediateEvent"] = None, faultTree_FaultTree5: set["faultTree_PrimaryEvent"] = None, faultTree_FaultTree7: set["faultTree_ConditioningEvent"] = None, faultTree: set["faultTree_Gate"] = None, faultTree_FaultTree: set["faultTree_Event"] = None, faultTree9: "faultTree_TransferOut" = None, faultTree11: set["faultTree_TransferIn"] = None, faultTree_FaultTree13: "faultTree_IntermediateEvent" = None, FaultTree: "faultTree_Gate" = None, FaultTree39: "faultTree_TransferIn" = None, faultTree_FaultTree22: "faultTree_Event" = None, FaultTree44: "faultTree_TransferOut" = None):
        self.name = name
