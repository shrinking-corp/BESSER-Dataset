...
# Classes
company106_Company = Class(name="company106_Company")
company106_Room = Class(name="company106_Room")
company106_NamedElement = Class(name="company106_NamedElement", is_abstract=True)
company106_Flow = Class(name="company106_Flow")
NamedElement = Class(name="NamedElement")
company106_Function = Class(name="company106_Function", is_abstract=True)
company106_Employee = Class(name="company106_Employee")
company106_HierarchyLink = Class(name="company106_HierarchyLink")
company106_Workstation = Class(name="company106_Workstation")
company106_Agency = Class(name="company106_Agency")
company106_Goal = Class(name="company106_Goal")
company106_Department = Class(name="company106_Department")
Function = Class(name="Function")
Interval = Class(name="Interval")
company106_Objective = Class(name="company106_Objective")
company106_ObjectiveReach = Class(name="company106_ObjectiveReach")
company106_Action = Class(name="company106_Action")
company106_Interval = Class(name="company106_Interval", is_abstract=True)
...
company106_Employee.attributes={company106_Employee_socialSecurityNumber, company106_Employee_fullName, company106_Employee_address}
...
company106_Interval.attributes={company106_Interval_dateFrom, company106_Interval_dateTo}
...
domain_model = DomainModel(
    name="company106",
    types={company106_Company, company106_Room, company106_NamedElement, company106_Flow, NamedElement, company106_Function, company106_Employee, company106_HierarchyLink, company106_Workstation, company106_Agency, company106_Goal, company106_Department, Function, Interval, company106_Objective, company106_ObjectiveReach, company106_Action, company106_Interval, Hierarchy, RoleType, ObjectiveType, ObjectiveNature},
    associations={rooms3, fromFunction4, toFunction5, hierarchies8, responsibleOf9, inChargeOf12, fromEmployee13, toEmployee16, agencies0, goals1, owners24, objectives25, departments27, employees30, reacheds33, parent20, workstations22, trgObjective35, srcAgency38, actions41, flows43, flow46},
    generalizations={gen_company106_Flow_NamedElement, gen_company106_Room_Function, gen_company106_Department_Function, gen_company106_Goal_Interval, gen_company106_Agency_Function, gen_company106_Workstation_NamedElement, gen_company106_Function_NamedElement, gen_company106_Action_NamedElement},
    metadata=None
)
