...
# Classes
cool_Program = Class(name="cool_Program")
cool_Class_ = Class(name="cool_Class_")
cool_IdentifierRefExpression = Class(name="cool_IdentifierRefExpression")
cool_IdentifiableElement = Class(name="cool_IdentifiableElement")
cool_Literal = Class(name="cool_Literal")
cool_NumberLiteral = Class(name="cool_NumberLiteral")
Literal = Class(name="Literal")
cool_StringLiteral = Class(name="cool_StringLiteral")
cool_BooleanLiteral = Class(name="cool_BooleanLiteral")
cool_ParenExpression = Class(name="cool_ParenExpression")
Type = Class(name="Type")
IdentifiableElement = Class(name="IdentifiableElement")
cool_Type = Class(name="cool_Type")
cool_Feature_ = Class(name="cool_Feature_")
cool_Attr = Class(name="cool_Attr")
Feature_ = Class(name="Feature_")
cool_Expression = Class(name="cool_Expression")
cool_Method = Class(name="cool_Method")
cool_Formal = Class(name="cool_Formal")
cool_PrimaryExpression = Class(name="cool_PrimaryExpression")
Expression = Class(name="Expression")
cool_SelfTypeLiteral = Class(name="cool_SelfTypeLiteral")
PrimaryExpression = Class(name="PrimaryExpression")
cool_ConditionalExpression = Class(name="cool_ConditionalExpression")
cool_LoopExpression = Class(name="cool_LoopExpression")
cool_AssignmentExpression = Class(name="cool_AssignmentExpression")
cool_NegationExpression = Class(name="cool_NegationExpression")
cool_IntegerCompositeExpression = Class(name="cool_IntegerCompositeExpression")
cool_NewExpression = Class(name="cool_NewExpression")
cool_DispatchExpression = Class(name="cool_DispatchExpression")
cool_CompareExpression = Class(name="cool_CompareExpression")
cool_BlockExpression = Class(name="cool_BlockExpression")
cool_IsvoidExpression = Class(name="cool_IsvoidExpression")
cool_LetExpression = Class(name="cool_LetExpression")
cool_LetDeclaration = Class(name="cool_LetDeclaration")
cool_CaseExpression = Class(name="cool_CaseExpression")
cool_Case = Class(name="cool_Case")
cool_AdditionExpression = Class(name="cool_AdditionExpression")
cool_Minus = Class(name="cool_Minus")
cool_MultiplicationExpression = Class(name="cool_MultiplicationExpression")
cool_Div = Class(name="cool_Div")
...
domain_model = DomainModel(
    name="cool",
    types={cool_Program, cool_Class_, cool_IdentifierRefExpression, cool_IdentifiableElement, cool_Literal, cool_NumberLiteral, Literal, cool_StringLiteral, cool_BooleanLiteral, cool_ParenExpression, Type, IdentifiableElement, cool_Type, cool_Feature_, cool_Attr, Feature_, cool_Expression, cool_Method, cool_Formal, cool_PrimaryExpression, Expression, cool_SelfTypeLiteral, PrimaryExpression, cool_ConditionalExpression, cool_LoopExpression, cool_AssignmentExpression, cool_NegationExpression, cool_IntegerCompositeExpression, cool_NewExpression, cool_DispatchExpression, cool_CompareExpression, cool_BlockExpression, cool_IsvoidExpression, cool_LetExpression, cool_LetDeclaration, cool_CaseExpression, cool_Case, cool_AdditionExpression, cool_Minus, cool_MultiplicationExpression, cool_Div},
    associations={classes0, id19, parent1, features3, type_decl5, init7, formals9, return_type10, expr13, type_decl16, type_name40, pred43, then_exp45, else_exp48, pred51, expr20, expr22, expr24, expr26, type_name28, ref30, actual32, chain36, left38, type_decl74, expr77, left80, right82, body53, body56, expr58, declaration60, body61, type_decl64, init67, expr70, case72, left85, right87, op90, right92, left95, right97, op100, right102},
    generalizations={gen_cool_IdentifierRefExpression_PrimaryExpression, gen_cool_Literal_PrimaryExpression, gen_cool_NumberLiteral_Literal, gen_cool_StringLiteral_Literal, gen_cool_BooleanLiteral_Literal, gen_cool_ParenExpression_PrimaryExpression, gen_cool_Class__Type, gen_cool_Class__IdentifiableElement, gen_cool_Feature__IdentifiableElement, gen_cool_Attr_Feature_, gen_cool_Method_Feature_, gen_cool_Formal_IdentifiableElement, gen_cool_PrimaryExpression_Expression, gen_cool_SelfTypeLiteral_PrimaryExpression, gen_cool_ConditionalExpression_PrimaryExpression, gen_cool_LoopExpression_PrimaryExpression, gen_cool_AssignmentExpression_PrimaryExpression, gen_cool_NegationExpression_PrimaryExpression, gen_cool_IntegerCompositeExpression_PrimaryExpression, gen_cool_NewExpression_PrimaryExpression, gen_cool_DispatchExpression_PrimaryExpression, gen_cool_CompareExpression_Expression, gen_cool_BlockExpression_PrimaryExpression, gen_cool_IsvoidExpression_PrimaryExpression, gen_cool_LetExpression_PrimaryExpression, gen_cool_LetDeclaration_IdentifiableElement, gen_cool_CaseExpression_PrimaryExpression, gen_cool_Case_IdentifiableElement, gen_cool_AdditionExpression_Expression, gen_cool_Minus_Expression, gen_cool_MultiplicationExpression_Expression, gen_cool_Div_Expression},
    metadata=None
)
