...
def test_hyp_cool_isvoidexpression_is_not_abstract():
    assert not inspect.isabstract(cool_IsvoidExpression)


def test_hyp_cool_isvoidexpression_constructor_exists():
    assert callable(cool_IsvoidExpression.__init__)


def test_hyp_cool_isvoidexpression_constructor_args():
    sig = inspect.signature(cool_IsvoidExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cool_negationexpression_is_not_abstract():
    assert not inspect.isabstract(cool_NegationExpression)


def test_hyp_cool_negationexpression_constructor_exists():
    assert callable(cool_NegationExpression.__init__)


def test_hyp_cool_negationexpression_constructor_args():
    sig = inspect.signature(cool_NegationExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cool_assignmentexpression_is_not_abstract():
    assert not inspect.isabstract(cool_AssignmentExpression)


def test_hyp_cool_assignmentexpression_constructor_exists():
    assert callable(cool_AssignmentExpression.__init__)


def test_hyp_cool_assignmentexpression_constructor_args():
...
def test_hyp_cool_conditionalexpression_is_not_abstract():
    assert not inspect.isabstract(cool_ConditionalExpression)


def test_hyp_cool_conditionalexpression_constructor_exists():
    assert callable(cool_ConditionalExpression.__init__)


def test_hyp_cool_conditionalexpression_constructor_args():
    sig = inspect.signature(cool_ConditionalExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cool_caseexpression_is_not_abstract():
    assert not inspect.isabstract(cool_CaseExpression)


def test_hyp_cool_caseexpression_constructor_exists():
    assert callable(cool_CaseExpression.__init__)


def test_hyp_cool_caseexpression_constructor_args():
    sig = inspect.signature(cool_CaseExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cool_loopexpression_is_not_abstract():
    assert not inspect.isabstract(cool_LoopExpression)


def test_hyp_cool_loopexpression_constructor_exists():
    assert callable(cool_LoopExpression.__init__)


def test_hyp_cool_loopexpression_constructor_args():
    sig = inspect.signature(cool_LoopExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cool_integercompositeexpression_is_not_abstract():
    assert not inspect.isabstract(cool_IntegerCompositeExpression)


def test_hyp_cool_integercompositeexpression_constructor_exists():
    assert callable(cool_IntegerCompositeExpression.__init__)


def test_hyp_cool_integercompositeexpression_constructor_args():
    sig = inspect.signature(cool_IntegerCompositeExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cool_newexpression_is_not_abstract():
    assert not inspect.isabstract(cool_NewExpression)


def test_hyp_cool_newexpression_constructor_exists():
    assert callable(cool_NewExpression.__init__)


def test_hyp_cool_newexpression_constructor_args():
    sig = inspect.signature(cool_NewExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cool_dispatchexpression_is_not_abstract():
    assert not inspect.isabstract(cool_DispatchExpression)


def test_hyp_cool_dispatchexpression_constructor_exists():
    assert callable(cool_DispatchExpression.__init__)


def test_hyp_cool_dispatchexpression_constructor_args():
    sig = inspect.signature(cool_DispatchExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cool_blockexpression_is_not_abstract():
    assert not inspect.isabstract(cool_BlockExpression)


def test_hyp_cool_blockexpression_constructor_exists():
    assert callable(cool_BlockExpression.__init__)


def test_hyp_cool_blockexpression_constructor_args():
    sig = inspect.signature(cool_BlockExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cool_letexpression_is_not_abstract():
    assert not inspect.isabstract(cool_LetExpression)


def test_hyp_cool_letexpression_constructor_exists():
    assert callable(cool_LetExpression.__init__)


def test_hyp_cool_letexpression_constructor_args():
    sig = inspect.signature(cool_LetExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cool_selftypeliteral_is_not_abstract():
    assert not inspect.isabstract(cool_SelfTypeLiteral)


def test_hyp_cool_selftypeliteral_constructor_exists():
    assert callable(cool_SelfTypeLiteral.__init__)


def test_hyp_cool_selftypeliteral_constructor_args():
...
def test_hyp_cool_minus_is_not_abstract():
    assert not inspect.isabstract(cool_Minus)


def test_hyp_cool_minus_constructor_exists():
    assert callable(cool_Minus.__init__)


def test_hyp_cool_minus_constructor_args():
    sig = inspect.signature(cool_Minus.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cool_multiplicationexpression_is_not_abstract():
    assert not inspect.isabstract(cool_MultiplicationExpression)


def test_hyp_cool_multiplicationexpression_constructor_exists():
    assert callable(cool_MultiplicationExpression.__init__)


def test_hyp_cool_multiplicationexpression_constructor_args():
    sig = inspect.signature(cool_MultiplicationExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cool_additionexpression_is_not_abstract():
    assert not inspect.isabstract(cool_AdditionExpression)


def test_hyp_cool_additionexpression_constructor_exists():
    assert callable(cool_AdditionExpression.__init__)


def test_hyp_cool_additionexpression_constructor_args():
    sig = inspect.signature(cool_AdditionExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cool_div_is_not_abstract():
    assert not inspect.isabstract(cool_Div)


def test_hyp_cool_div_constructor_exists():
    assert callable(cool_Div.__init__)


def test_hyp_cool_div_constructor_args():
    sig = inspect.signature(cool_Div.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cool_compareexpression_is_not_abstract():
    assert not inspect.isabstract(cool_CompareExpression)


def test_hyp_cool_compareexpression_constructor_exists():
    assert callable(cool_CompareExpression.__init__)


def test_hyp_cool_compareexpression_constructor_args():
...
def test_hyp_cool_primaryexpression_is_not_abstract():
    assert not inspect.isabstract(cool_PrimaryExpression)


def test_hyp_cool_primaryexpression_constructor_exists():
    assert callable(cool_PrimaryExpression.__init__)


def test_hyp_cool_primaryexpression_constructor_args():
    sig = inspect.signature(cool_PrimaryExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cool_expression_is_not_abstract():
    assert not inspect.isabstract(cool_Expression)


def test_hyp_cool_expression_constructor_exists():
    assert callable(cool_Expression.__init__)


def test_hyp_cool_expression_constructor_args():
    sig = inspect.signature(cool_Expression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_feature__is_not_abstract():
    assert not inspect.isabstract(Feature_)


def test_hyp_feature__constructor_exists():
    assert callable(Feature_.__init__)


def test_hyp_feature__constructor_args():
    sig = inspect.signature(Feature_.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cool_method_is_not_abstract():
    assert not inspect.isabstract(cool_Method)


def test_hyp_cool_method_constructor_exists():
    assert callable(cool_Method.__init__)


def test_hyp_cool_method_constructor_args():
    sig = inspect.signature(cool_Method.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cool_attr_is_not_abstract():
    assert not inspect.isabstract(cool_Attr)


def test_hyp_cool_attr_constructor_exists():
    assert callable(cool_Attr.__init__)


def test_hyp_cool_attr_constructor_args():
    sig = inspect.signature(cool_Attr.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cool_type_is_not_abstract():
    assert not inspect.isabstract(cool_Type)


def test_hyp_cool_type_constructor_exists():
    assert callable(cool_Type.__init__)


def test_hyp_cool_type_constructor_args():
...
def test_hyp_cool_case_is_not_abstract():
    assert not inspect.isabstract(cool_Case)


def test_hyp_cool_case_constructor_exists():
    assert callable(cool_Case.__init__)


def test_hyp_cool_case_constructor_args():
    sig = inspect.signature(cool_Case.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cool_feature__is_not_abstract():
    assert not inspect.isabstract(cool_Feature_)


def test_hyp_cool_feature__constructor_exists():
    assert callable(cool_Feature_.__init__)


def test_hyp_cool_feature__constructor_args():
    sig = inspect.signature(cool_Feature_.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cool_letdeclaration_is_not_abstract():
    assert not inspect.isabstract(cool_LetDeclaration)


def test_hyp_cool_letdeclaration_constructor_exists():
    assert callable(cool_LetDeclaration.__init__)


def test_hyp_cool_letdeclaration_constructor_args():
    sig = inspect.signature(cool_LetDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cool_formal_is_not_abstract():
    assert not inspect.isabstract(cool_Formal)


def test_hyp_cool_formal_constructor_exists():
    assert callable(cool_Formal.__init__)


def test_hyp_cool_formal_constructor_args():
...
def test_hyp_cool_parenexpression_is_not_abstract():
    assert not inspect.isabstract(cool_ParenExpression)


def test_hyp_cool_parenexpression_constructor_exists():
    assert callable(cool_ParenExpression.__init__)


def test_hyp_cool_parenexpression_constructor_args():
...
def test_hyp_cool_stringliteral_is_not_abstract():
    assert not inspect.isabstract(cool_StringLiteral)


def test_hyp_cool_stringliteral_constructor_exists():
    assert callable(cool_StringLiteral.__init__)


def test_hyp_cool_stringliteral_constructor_args():
...
def test_hyp_cool_booleanliteral_is_not_abstract():
    assert not inspect.isabstract(cool_BooleanLiteral)


def test_hyp_cool_booleanliteral_constructor_exists():
    assert callable(cool_BooleanLiteral.__init__)


def test_hyp_cool_booleanliteral_constructor_args():
...
def test_hyp_cool_numberliteral_is_not_abstract():
    assert not inspect.isabstract(cool_NumberLiteral)


def test_hyp_cool_numberliteral_constructor_exists():
    assert callable(cool_NumberLiteral.__init__)


def test_hyp_cool_numberliteral_constructor_args():
...
def test_hyp_cool_literal_is_not_abstract():
    assert not inspect.isabstract(cool_Literal)


def test_hyp_cool_literal_constructor_exists():
    assert callable(cool_Literal.__init__)


def test_hyp_cool_literal_constructor_args():
    sig = inspect.signature(cool_Literal.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cool_identifiableelement_is_not_abstract():
    assert not inspect.isabstract(cool_IdentifiableElement)


def test_hyp_cool_identifiableelement_constructor_exists():
    assert callable(cool_IdentifiableElement.__init__)


def test_hyp_cool_identifiableelement_constructor_args():
...
def test_hyp_cool_identifierrefexpression_is_not_abstract():
    assert not inspect.isabstract(cool_IdentifierRefExpression)


def test_hyp_cool_identifierrefexpression_constructor_exists():
    assert callable(cool_IdentifierRefExpression.__init__)


def test_hyp_cool_identifierrefexpression_constructor_args():
    sig = inspect.signature(cool_IdentifierRefExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cool_class__is_not_abstract():
    assert not inspect.isabstract(cool_Class_)


def test_hyp_cool_class__constructor_exists():
    assert callable(cool_Class_.__init__)


def test_hyp_cool_class__constructor_args():
    sig = inspect.signature(cool_Class_.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cool_program_is_not_abstract():
    assert not inspect.isabstract(cool_Program)


def test_hyp_cool_program_constructor_exists():
    assert callable(cool_Program.__init__)


def test_hyp_cool_program_constructor_args():
...
def test_hyp_cool_assignmentexpression_name_setter(instance):
...
def test_hyp_cool_compareexpression_op_setter(instance):
...
def test_hyp_cool_stringliteral_value_setter(instance):
...
def test_hyp_cool_booleanliteral_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_cool_numberliteral_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_cool_identifiableelement_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
