...
library_Shelf = Class(name="library_Shelf")
...
domain_model = DomainModel(
    name="library",
    types={library_Library, library_Author, library_Book, library_Employee, library_Shelf},
    associations={shelves3, authors5, employees7, books10, books0, author1, shelves2},
    generalizations={},
    metadata=None
)
