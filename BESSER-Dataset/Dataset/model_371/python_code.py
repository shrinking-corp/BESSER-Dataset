...
class library_Shelf:
    ...
    def __init__(self, name: str, library_Shelf4: "library_Library" = None, library_Shelf11: set["library_Book"] = None, library_Shelf: "library_Employee" = None):
        self.name = name
...
class library_Book:
    ...
    def __init__(self, title: str, library_Book: "library_Shelf" = None, Book: "library_Author" = None, books: "library_Author" = None):
        self.title = title
...
class library_Author:
    ...
    def __init__(self, name: str, library_Author: "library_Library" = None, author: set["library_Book"] = None, Author: "library_Book" = None):
        self.name = name
