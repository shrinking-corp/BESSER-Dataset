...
model_FiniteStateMachine.methods={model_FiniteStateMachine_m_onEnter, model_FiniteStateMachine_m_main, model_FiniteStateMachine_m_on, model_FiniteStateMachine_m_enterInitialState}
...
domain_model = DomainModel(
    name="model",
    types={model_FiniteStateMachine, model_AbstractState, model_Transition, model_State, AbstractState},
    associations={parent0, outgoings1, initial2, states3, current4, source7, target9},
