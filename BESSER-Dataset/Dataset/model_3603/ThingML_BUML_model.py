...
# Classes
thingML_ThingMLModel = Class(name="thingML_ThingMLModel")
thingML_Expression = Class(name="thingML_Expression", is_abstract=True)
AnnotatedElement = Class(name="AnnotatedElement")
thingML_PrimitiveType = Class(name="thingML_PrimitiveType")
Type = Class(name="Type")
thingML_ObjectType = Class(name="thingML_ObjectType")
thingML_Enumeration = Class(name="thingML_Enumeration")
thingML_Import = Class(name="thingML_Import")
thingML_Type = Class(name="thingML_Type", is_abstract=True)
thingML_Protocol = Class(name="thingML_Protocol")
thingML_Configuration = Class(name="thingML_Configuration")
thingML_PlatformAnnotation = Class(name="thingML_PlatformAnnotation")
thingML_AnnotatedElement = Class(name="thingML_AnnotatedElement", is_abstract=True)
thingML_TypeRef = Class(name="thingML_TypeRef")
thingML_Parameter = Class(name="thingML_Parameter")
thingML_EnumerationLiteral = Class(name="thingML_EnumerationLiteral")
thingML_Thing = Class(name="thingML_Thing")
thingML_Message = Class(name="thingML_Message")
thingML_Port = Class(name="thingML_Port", is_abstract=True)
thingML_Property = Class(name="thingML_Property")
thingML_Function = Class(name="thingML_Function")
thingML_PropertyAssign = Class(name="thingML_PropertyAssign")
thingML_CompositeState = Class(name="thingML_CompositeState")
thingML_Stream = Class(name="thingML_Stream")
thingML_RequiredPort = Class(name="thingML_RequiredPort")
Port = Class(name="Port")
thingML_ProvidedPort = Class(name="thingML_ProvidedPort")
thingML_InternalPort = Class(name="thingML_InternalPort")
thingML_ActionBlock = Class(name="thingML_ActionBlock")
ReferencedElmt = Class(name="ReferencedElmt")
Variable = Class(name="Variable")
thingML_SimpleSource = Class(name="thingML_SimpleSource")
thingML_ReceiveMessage = Class(name="thingML_ReceiveMessage")
thingML_Filter = Class(name="thingML_Filter")
ViewSource = Class(name="ViewSource")
thingML_LengthWindow = Class(name="thingML_LengthWindow")
thingML_Source = Class(name="thingML_Source", is_abstract=True)
thingML_LocalVariable = Class(name="thingML_LocalVariable")
thingML_SendAction = Class(name="thingML_SendAction")
thingML_ViewSource = Class(name="thingML_ViewSource", is_abstract=True)
thingML_ReferencedElmt = Class(name="thingML_ReferencedElmt", is_abstract=True)
thingML_ElmtProperty = Class(name="thingML_ElmtProperty", is_abstract=True)
thingML_JoinSources = Class(name="thingML_JoinSources")
Source = Class(name="Source")
thingML_MergeSources = Class(name="thingML_MergeSources")
thingML_ParallelRegion = Class(name="thingML_ParallelRegion")
thingML_FinalState = Class(name="thingML_FinalState")
thingML_Session = Class(name="thingML_Session")
thingML_TimeWindow = Class(name="thingML_TimeWindow")
thingML_MessageParameter = Class(name="thingML_MessageParameter")
thingML_SimpleParamRef = Class(name="thingML_SimpleParamRef")
ElmtProperty = Class(name="ElmtProperty")
thingML_ArrayParamRef = Class(name="thingML_ArrayParamRef")
thingML_LengthArray = Class(name="thingML_LengthArray")
thingML_Region = Class(name="thingML_Region")
Region = Class(name="Region")
State = Class(name="State")
thingML_State = Class(name="thingML_State")
Event = Class(name="Event")
thingML_Variable = Class(name="thingML_Variable", is_abstract=True)
Action = Class(name="Action")
thingML_Action = Class(name="thingML_Action", is_abstract=True)
thingML_InternalTransition = Class(name="thingML_InternalTransition")
thingML_Transition = Class(name="thingML_Transition")
thingML_Handler = Class(name="thingML_Handler", is_abstract=True)
thingML_Event = Class(name="thingML_Event", is_abstract=True)
Handler = Class(name="Handler")
thingML_VariableAssignment = Class(name="thingML_VariableAssignment")
thingML_Increment = Class(name="thingML_Increment")
thingML_Decrement = Class(name="thingML_Decrement")
thingML_ExternStatement = Class(name="thingML_ExternStatement")
thingML_StartSession = Class(name="thingML_StartSession")
thingML_FunctionCallStatement = Class(name="thingML_FunctionCallStatement")
thingML_ExternExpression = Class(name="thingML_ExternExpression")
Expression = Class(name="Expression")
thingML_LoopAction = Class(name="thingML_LoopAction")
thingML_ConditionalAction = Class(name="thingML_ConditionalAction")
thingML_ReturnAction = Class(name="thingML_ReturnAction")
thingML_PrintAction = Class(name="thingML_PrintAction")
thingML_ErrorAction = Class(name="thingML_ErrorAction")
thingML_Instance = Class(name="thingML_Instance")
thingML_AbstractConnector = Class(name="thingML_AbstractConnector", is_abstract=True)
thingML_ConfigPropertyAssign = Class(name="thingML_ConfigPropertyAssign")
thingML_InstanceRef = Class(name="thingML_InstanceRef")
thingML_EnumLiteralRef = Class(name="thingML_EnumLiteralRef")
thingML_IntegerLiteral = Class(name="thingML_IntegerLiteral")
thingML_BooleanLiteral = Class(name="thingML_BooleanLiteral")
thingML_StringLiteral = Class(name="thingML_StringLiteral")
thingML_DoubleLiteral = Class(name="thingML_DoubleLiteral")
thingML_PropertyReference = Class(name="thingML_PropertyReference")
thingML_Reference = Class(name="thingML_Reference")
thingML_FunctionCallExpression = Class(name="thingML_FunctionCallExpression")
thingML_OrExpression = Class(name="thingML_OrExpression")
thingML_AndExpression = Class(name="thingML_AndExpression")
thingML_EqualsExpression = Class(name="thingML_EqualsExpression")
thingML_Connector = Class(name="thingML_Connector")
AbstractConnector = Class(name="AbstractConnector")
thingML_ExternalConnector = Class(name="thingML_ExternalConnector")
thingML_LowerOrEqualExpression = Class(name="thingML_LowerOrEqualExpression")
thingML_PlusExpression = Class(name="thingML_PlusExpression")
thingML_MinusExpression = Class(name="thingML_MinusExpression")
thingML_NotEqualsExpression = Class(name="thingML_NotEqualsExpression")
thingML_GreaterExpression = Class(name="thingML_GreaterExpression")
thingML_LowerExpression = Class(name="thingML_LowerExpression")
thingML_GreaterOrEqualExpression = Class(name="thingML_GreaterOrEqualExpression")
thingML_NotExpression = Class(name="thingML_NotExpression")
thingML_UnaryMinus = Class(name="thingML_UnaryMinus")
thingML_ArrayIndex = Class(name="thingML_ArrayIndex")
thingML_TimesExpression = Class(name="thingML_TimesExpression")
thingML_DivExpression = Class(name="thingML_DivExpression")
thingML_ModExpression = Class(name="thingML_ModExpression")
...
thingML_Property.attributes={thingML_Property_changeable, thingML_Property_name}
...
thingML_ParallelRegion.attributes={thingML_ParallelRegion_name, thingML_ParallelRegion_history}
...
domain_model = DomainModel(
    name="thingML",
    types={thingML_ThingMLModel, thingML_Expression, AnnotatedElement, thingML_PrimitiveType, Type, thingML_ObjectType, thingML_Enumeration, thingML_Import, thingML_Type, thingML_Protocol, thingML_Configuration, thingML_PlatformAnnotation, thingML_AnnotatedElement, thingML_TypeRef, thingML_Parameter, thingML_EnumerationLiteral, thingML_Thing, thingML_Message, thingML_Port, thingML_Property, thingML_Function, thingML_PropertyAssign, thingML_CompositeState, thingML_Stream, thingML_RequiredPort, Port, thingML_ProvidedPort, thingML_InternalPort, thingML_ActionBlock, ReferencedElmt, Variable, thingML_SimpleSource, thingML_ReceiveMessage, thingML_Filter, ViewSource, thingML_LengthWindow, thingML_Source, thingML_LocalVariable, thingML_SendAction, thingML_ViewSource, thingML_ReferencedElmt, thingML_ElmtProperty, thingML_JoinSources, Source, thingML_MergeSources, thingML_ParallelRegion, thingML_FinalState, thingML_Session, thingML_TimeWindow, thingML_MessageParameter, thingML_SimpleParamRef, ElmtProperty, thingML_ArrayParamRef, thingML_LengthArray, thingML_Region, Region, State, thingML_State, Event, thingML_Variable, Action, thingML_Action, thingML_InternalTransition, thingML_Transition, thingML_Handler, thingML_Event, Handler, thingML_VariableAssignment, thingML_Increment, thingML_Decrement, thingML_ExternStatement, thingML_StartSession, thingML_FunctionCallStatement, thingML_ExternExpression, Expression, thingML_LoopAction, thingML_ConditionalAction, thingML_ReturnAction, thingML_PrintAction, thingML_ErrorAction, thingML_Instance, thingML_AbstractConnector, thingML_ConfigPropertyAssign, thingML_InstanceRef, thingML_EnumLiteralRef, thingML_IntegerLiteral, thingML_BooleanLiteral, thingML_StringLiteral, thingML_DoubleLiteral, thingML_PropertyReference, thingML_Reference, thingML_FunctionCallExpression, thingML_OrExpression, thingML_AndExpression, thingML_EqualsExpression, thingML_Connector, AbstractConnector, thingML_ExternalConnector, thingML_LowerOrEqualExpression, thingML_PlusExpression, thingML_MinusExpression, thingML_NotEqualsExpression, thingML_GreaterExpression, thingML_LowerExpression, thingML_GreaterOrEqualExpression, thingML_NotExpression, thingML_UnaryMinus, thingML_ArrayIndex, thingML_TimesExpression, thingML_DivExpression, thingML_ModExpression},
    associations={cardinality10, imports0, types1, protocols3, configs5, annotations7, type8, property32, index35, init38, parameters41, literals12, annotations13, includes17, messages18, ports20, properties22, functions24, assign26, behaviour28, streams30, sends60, receives63, typeRef43, body46, typeRef48, init51, parameters54, typeRef57, sources82, resultMessage84, operators87, message90, operators91, guard94, size96, input66, selection68, output70, sources72, resultMessage74, rules77, operators80, region117, initial119, substate121, region124, initial127, step98, duration101, step103, msgRef106, parameterRef108, parameterRef110, initial112, substate114, target152, port155, message158, substate130, properties133, entry136, exit138, internal141, outgoing143, event145, guard146, action149, message175, parameters178, property181, index182, expression185, var188, actions161, segments164, typeRef166, init169, port172, session211, function213, parameters215, segments218, var190, condition192, action194, condition197, action199, elseAction202, exp205, msg207, msg209, instances235, connectors237, propassigns239, type241, instance244, enum220, literal222, property225, reference227, parameter228, function230, parameters232, instance275, lhs278, rhs280, lhs283, rhs285, property246, index249, init252, annotations255, cli258, required260, srv262, provided265, inst267, port269, protocol272, rhs310, lhs313, rhs315, lhs318, rhs320, lhs288, rhs290, lhs293, rhs295, lhs298, rhs300, lhs303, rhs305, lhs308, rhs340, term343, term345, array347, index349, lhs323, rhs325, lhs328, rhs330, lhs333, rhs335, lhs338},
    generalizations={gen_thingML_Type_AnnotatedElement, gen_thingML_PrimitiveType_Type, gen_thingML_ObjectType_Type, gen_thingML_Enumeration_Type, gen_thingML_PropertyAssign_AnnotatedElement, gen_thingML_Protocol_AnnotatedElement, gen_thingML_Function_AnnotatedElement, gen_thingML_Thing_Type, gen_thingML_Port_AnnotatedElement, gen_thingML_RequiredPort_Port, gen_thingML_ProvidedPort_Port, gen_thingML_InternalPort_Port, gen_thingML_Stream_AnnotatedElement, gen_thingML_Property_AnnotatedElement, gen_thingML_Property_ReferencedElmt, gen_thingML_Property_Variable, gen_thingML_Message_AnnotatedElement, gen_thingML_Message_ReferencedElmt, gen_thingML_Parameter_AnnotatedElement, gen_thingML_Parameter_ReferencedElmt, gen_thingML_Parameter_Variable, gen_thingML_SimpleSource_Source, gen_thingML_SimpleSource_ReferencedElmt, gen_thingML_Filter_ViewSource, gen_thingML_LengthWindow_ViewSource, gen_thingML_JoinSources_Source, gen_thingML_JoinSources_ReferencedElmt, gen_thingML_MergeSources_Source, gen_thingML_MergeSources_ReferencedElmt, gen_thingML_FinalState_AnnotatedElement, gen_thingML_FinalState_State, gen_thingML_Session_AnnotatedElement, gen_thingML_Session_Region, gen_thingML_Session_State, gen_thingML_ParallelRegion_AnnotatedElement, gen_thingML_ParallelRegion_Region, gen_thingML_TimeWindow_ViewSource, gen_thingML_MessageParameter_ReferencedElmt, gen_thingML_SimpleParamRef_ElmtProperty, gen_thingML_ArrayParamRef_ElmtProperty, gen_thingML_LengthArray_ElmtProperty, gen_thingML_CompositeState_AnnotatedElement, gen_thingML_CompositeState_Region, gen_thingML_CompositeState_State, gen_thingML_InternalTransition_Handler, gen_thingML_ReceiveMessage_ReferencedElmt, gen_thingML_ReceiveMessage_Event, gen_thingML_ActionBlock_Action, gen_thingML_State_AnnotatedElement, gen_thingML_Handler_AnnotatedElement, gen_thingML_Transition_Handler, gen_thingML_VariableAssignment_Action, gen_thingML_Increment_Action, gen_thingML_Decrement_Action, gen_thingML_ExternStatement_Action, gen_thingML_LocalVariable_AnnotatedElement, gen_thingML_LocalVariable_ReferencedElmt, gen_thingML_LocalVariable_Action, gen_thingML_LocalVariable_Variable, gen_thingML_SendAction_Action, gen_thingML_StartSession_Action, gen_thingML_FunctionCallStatement_Action, gen_thingML_ExternExpression_Expression, gen_thingML_LoopAction_Action, gen_thingML_ConditionalAction_Action, gen_thingML_ReturnAction_Action, gen_thingML_PrintAction_Action, gen_thingML_ErrorAction_Action, gen_thingML_Instance_AnnotatedElement, gen_thingML_EnumLiteralRef_Expression, gen_thingML_IntegerLiteral_Expression, gen_thingML_BooleanLiteral_Expression, gen_thingML_StringLiteral_Expression, gen_thingML_DoubleLiteral_Expression, gen_thingML_PropertyReference_Expression, gen_thingML_Reference_Expression, gen_thingML_FunctionCallExpression_Expression, gen_thingML_Configuration_AnnotatedElement, gen_thingML_OrExpression_Expression, gen_thingML_AndExpression_Expression, gen_thingML_EqualsExpression_Expression, gen_thingML_AbstractConnector_AnnotatedElement, gen_thingML_Connector_AbstractConnector, gen_thingML_ExternalConnector_AbstractConnector, gen_thingML_LowerOrEqualExpression_Expression, gen_thingML_PlusExpression_Expression, gen_thingML_MinusExpression_Expression, gen_thingML_NotEqualsExpression_Expression, gen_thingML_GreaterExpression_Expression, gen_thingML_LowerExpression_Expression, gen_thingML_GreaterOrEqualExpression_Expression, gen_thingML_NotExpression_Expression, gen_thingML_UnaryMinus_Expression, gen_thingML_ArrayIndex_Expression, gen_thingML_TimesExpression_Expression, gen_thingML_DivExpression_Expression, gen_thingML_ModExpression_Expression},
    metadata=None
)
