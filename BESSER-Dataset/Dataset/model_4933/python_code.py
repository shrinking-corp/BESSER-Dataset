...
class form_PageElement(ABC):
    ...
    def __init__(self, elementId: str, elements: "form_Page" = None, PageElement: "form_Page" = None, form_PageElement: "form_VisibilityCondition" = None):
...
class form_Page:
    ...
    def __init__(self, title: str, Page19: "form_PageElement" = None, form_Page: "form_Form" = None, form_Page3: "form_Form" = None, form_Page6: "form_Page" = None, form_Page4: set["form_Page"] = None, form_Page9: "form_Page" = None, form_Page7: set["form_Page"] = None, Page: "form_Page" = None, previousPage: "form_Page" = None, page: set["form_PageElement"] = None, Page15: "form_Page" = None, nextPage: "form_Page" = None, page17: set["form_VisibilityCondition"] = None, Page24: "form_VisibilityCondition" = None):
        self.title = title
        self.Page19 = Page19
...
class form_SelectionItem:
    ...
    def __init__(self, label: str, selected: bool, SelectionItem: "form_SelectionField" = None, form_SelectionItem: "form_SelectionCondition" = None, items: "form_SelectionField" = None):
        self.label = label
