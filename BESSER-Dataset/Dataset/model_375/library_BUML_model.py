...
library_SpecialistBookWriter = Class(name="library_SpecialistBookWriter")
library_Writer = Class(name="library_Writer")
library_Library = Class(name="library_Library")
library_GuideSpecialistBookWriter = Class(name="library_GuideSpecialistBookWriter")
SpecialistBookWriter = Class(name="SpecialistBookWriter")
library_GuideBookWriter = Class(name="library_GuideBookWriter")
...
domain_model = DomainModel(
    name="library",
    types={library_Book, library_SpecialistBookWriter, library_Writer, library_Library, library_GuideSpecialistBookWriter, SpecialistBookWriter, library_GuideBookWriter, Writer},
    associations={author0, books1},
    generalizations={gen_library_SpecialistBookWriter_Writer, gen_library_GuideSpecialistBookWriter_SpecialistBookWriter, gen_library_GuideBookWriter_Writer},
    metadata=None
)
