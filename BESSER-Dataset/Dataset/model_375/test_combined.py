...
def test_hyp_specialistbookwriter_is_not_abstract():
    assert not inspect.isabstract(SpecialistBookWriter)


def test_hyp_specialistbookwriter_constructor_exists():
    assert callable(SpecialistBookWriter.__init__)


def test_hyp_specialistbookwriter_constructor_args():
    sig = inspect.signature(SpecialistBookWriter.__init__)
    params = list(sig.parameters.keys())



def test_hyp_library_guidespecialistbookwriter_is_not_abstract():
    assert not inspect.isabstract(library_GuideSpecialistBookWriter)


def test_hyp_library_guidespecialistbookwriter_constructor_exists():
    assert callable(library_GuideSpecialistBookWriter.__init__)


def test_hyp_library_guidespecialistbookwriter_constructor_args():
...
def test_hyp_library_guidespecialistbookwriter_amazing_setter(instance):
