...
# Classes
syswb101_Workbench = Class(name="syswb101_Workbench")
Named = Class(name="Named")
syswb101_Thing = Class(name="syswb101_Thing")
syswb101_Thoughts = Class(name="syswb101_Thoughts")
syswb101_System = Class(name="syswb101_System")
syswb101_Named = Class(name="syswb101_Named", is_abstract=True)
syswb101_FunctionProperty = Class(name="syswb101_FunctionProperty")
syswb101_PatternCatalog = Class(name="syswb101_PatternCatalog")
NamedElement = Class(name="NamedElement")
syswb101_RelatedTo = Class(name="syswb101_RelatedTo")
syswb101_NamedElement = Class(name="syswb101_NamedElement", is_abstract=True)
syswb101_Component = Class(name="syswb101_Component")
syswb101_Function = Class(name="syswb101_Function")
...
domain_model = DomainModel(
    name="syswb101",
    types={syswb101_Workbench, Named, syswb101_Thing, syswb101_Thoughts, syswb101_System, syswb101_Named, syswb101_FunctionProperty, syswb101_PatternCatalog, NamedElement, syswb101_RelatedTo, syswb101_NamedElement, syswb101_Component, syswb101_Function},
    associations={things0, thoughts1, systemView3, fromThing10, toThing11, relatedTo13, parent17, functionProperties5, catalog7, relations9, decompositions27, property29, associations33, allocatedTo35, functionalArchitecture38, physicalArchitecture41, decompositions20, associations22, performs24, patterns44},
    generalizations={gen_syswb101_Workbench_Named, gen_syswb101_Thoughts_NamedElement, gen_syswb101_FunctionProperty_Named, gen_syswb101_Thing_NamedElement, gen_syswb101_RelatedTo_NamedElement, gen_syswb101_System_Named, gen_syswb101_Component_Named, gen_syswb101_Function_Named},
    metadata=None
)
