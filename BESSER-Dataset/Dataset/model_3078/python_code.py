...
class esm_IEsmState(ABC):
    ...
    def __init__(self, kind: str, esm_IEsmState: "esm_IEsmStateModel" = None, esm_IEsmState5: "esm_DState" = None, esm_IEsmState7: "esm_DRichText" = None):
        self.kind = kind
...
class DModel:
    ...
    pass
class esm_EsmEntityStateModel(DModel, IStaticReferenceTarget, INavigableMemberContainer, IEsmStateModel, IDiagramRoot):
