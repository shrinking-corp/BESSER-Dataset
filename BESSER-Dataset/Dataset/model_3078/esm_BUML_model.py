...
# Classes
esm_EsmEntityStateModel = Class(name="esm_EsmEntityStateModel")
DModel = Class(name="DModel")
esm_IEsmStateModel = Class(name="esm_IEsmStateModel", is_abstract=True)
IEsmLayout = Class(name="IEsmLayout")
esm_IEsmState = Class(name="esm_IEsmState", is_abstract=True)
esm_EsmTransition = Class(name="esm_EsmTransition")
esm_DState = Class(name="esm_DState")
esm_DRichText = Class(name="esm_DRichText")
esm_EsmState = Class(name="esm_EsmState")
IEsmState = Class(name="IEsmState")
esm_EsmDerivedState = Class(name="esm_EsmDerivedState")
EsmState = Class(name="EsmState")
esm_DExpression = Class(name="esm_DExpression")
esm_EsmCompositeState = Class(name="esm_EsmCompositeState")
esm_EsmConcurrentState = Class(name="esm_EsmConcurrentState")
esm_EsmSubStateModel = Class(name="esm_EsmSubStateModel")
...
esm_DEntityType = Class(name="esm_DEntityType")
esm_IEsmLayout = Class(name="esm_IEsmLayout", is_abstract=True)
esm_DStateEvent = Class(name="esm_DStateEvent")
...
domain_model = DomainModel(
    name="esm",
    types={esm_EsmEntityStateModel, DModel, esm_IEsmStateModel, IEsmLayout, esm_IEsmState, esm_EsmTransition, esm_DState, esm_DRichText, esm_EsmState, IEsmState, esm_EsmDerivedState, EsmState, esm_DExpression, esm_EsmCompositeState, esm_EsmConcurrentState, esm_EsmSubStateModel, IEsmStateModel, INavigableMemberContainer, IStaticReferenceTarget, IDiagramRoot, esm_DEntityType, esm_IEsmLayout, esm_DStateEvent, EsmLayoutDirection, EsmStateKind},
    associations={states1, transitions2, state4, description6, expression8, subStates9, forType0, from_10, to13, event16, guard18},
    generalizations={gen_esm_IEsmStateModel_IEsmLayout, gen_esm_EsmState_IEsmState, gen_esm_EsmDerivedState_EsmState, gen_esm_EsmCompositeState_IEsmState, gen_esm_EsmCompositeState_IEsmStateModel, gen_esm_EsmConcurrentState_IEsmState, gen_esm_EsmSubStateModel_IEsmStateModel, gen_esm_EsmEntityStateModel_DModel, gen_esm_EsmEntityStateModel_IEsmStateModel, gen_esm_EsmEntityStateModel_INavigableMemberContainer, gen_esm_EsmEntityStateModel_IStaticReferenceTarget, gen_esm_EsmEntityStateModel_IDiagramRoot, gen_esm_EsmTransition_IEsmLayout},
    metadata=None
)
