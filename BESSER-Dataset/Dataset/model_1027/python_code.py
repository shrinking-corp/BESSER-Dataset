...
class mydsl_Transition:
    ...
    def __init__(self, name: str, mydsl_Transition4: "mydsl_State" = None, mydsl_Transition7: "mydsl_State" = None, mydsl_Transition: "mydsl_FSM" = None):
        self.name = name
...
class mydsl_State:
    ...
    def __init__(self, name: str, mydsl_State5: "mydsl_Transition" = None, mydsl_State8: "mydsl_Transition" = None, mydsl_State: "mydsl_FSM" = None):
        self.name = name
...
class mydsl_FSM:
    ...
    def __init__(self, name: str, mydsl_FSM: set["mydsl_State"] = None, mydsl_FSM2: set["mydsl_Transition"] = None):
        self.name = name
