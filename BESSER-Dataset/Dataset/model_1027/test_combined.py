...
def test_hyp_mydsl_intitialstate_is_not_abstract():
    assert not inspect.isabstract(mydsl_IntitialState)


def test_hyp_mydsl_intitialstate_constructor_exists():
    assert callable(mydsl_IntitialState.__init__)


def test_hyp_mydsl_intitialstate_constructor_args():
...
def test_hyp_mydsl_finalstate_is_not_abstract():
    assert not inspect.isabstract(mydsl_FinalState)


def test_hyp_mydsl_finalstate_constructor_exists():
    assert callable(mydsl_FinalState.__init__)


def test_hyp_mydsl_finalstate_constructor_args():
