...
# Classes
PSM_ArtifactElement = Class(name="PSM_ArtifactElement")
PSM_RootPSM = Class(name="PSM_RootPSM")
PSM_DistributedApplicationProject = Class(name="PSM_DistributedApplicationProject")
PSM_DockerContainerDefinition = Class(name="PSM_DockerContainerDefinition")
PSM_ApplicationProject = Class(name="PSM_ApplicationProject")
PSM_DockerContainerLink = Class(name="PSM_DockerContainerLink")
PSM_DockerContainerPort = Class(name="PSM_DockerContainerPort")
PSM_MicroserviceProject = Class(name="PSM_MicroserviceProject")
PSM_DependencyLibrary = Class(name="PSM_DependencyLibrary")
PSM_JavaSpringWebApplicationProject = Class(name="PSM_JavaSpringWebApplicationProject")
MicroserviceProject = Class(name="MicroserviceProject")
PSM_ConfigurationProperty = Class(name="PSM_ConfigurationProperty")
PSM_SpringWebApplicationLayer = Class(name="PSM_SpringWebApplicationLayer")
PSM_JavaSpringWebFluxApplicationProject = Class(name="PSM_JavaSpringWebFluxApplicationProject")
JavaSpringWebApplicationProject = Class(name="JavaSpringWebApplicationProject")
PSM_JavaSpringMVCApplicationProject = Class(name="PSM_JavaSpringMVCApplicationProject")
ArtifactElement = Class(name="ArtifactElement")
PSM_SpringControllerLayer = Class(name="PSM_SpringControllerLayer")
PSM_SpringServiceLayer = Class(name="PSM_SpringServiceLayer")
PSM_SpringConfigurationLayer = Class(name="PSM_SpringConfigurationLayer")
PSM_SpringFeignClientLayer = Class(name="PSM_SpringFeignClientLayer")
PSM_SpringComponentLayer = Class(name="PSM_SpringComponentLayer")
PSM_SpringRepositoryLayer = Class(name="PSM_SpringRepositoryLayer")
PSM_SpringDomainLayer = Class(name="PSM_SpringDomainLayer")
PSM_SpringModelPojoLayer = Class(name="PSM_SpringModelPojoLayer")
PSM_JavaElement = Class(name="PSM_JavaElement")
PSM_JavaAnnotation = Class(name="PSM_JavaAnnotation")
PSM_JavaAnnotationParameter = Class(name="PSM_JavaAnnotationParameter")
PSM_JavaDataType = Class(name="PSM_JavaDataType")
JavaElement = Class(name="JavaElement")
JavaDataType = Class(name="JavaDataType")
PSM_JavaMethod = Class(name="PSM_JavaMethod")
PSM_JavaDataField = Class(name="PSM_JavaDataField")
PSM_JavaUserDefinedType = Class(name="PSM_JavaUserDefinedType")
PSM_SpringBootApplicationLayer = Class(name="PSM_SpringBootApplicationLayer")
SpringWebApplicationLayer = Class(name="SpringWebApplicationLayer")
PSM_JavaMethodParameter = Class(name="PSM_JavaMethodParameter")
JavaDataField = Class(name="JavaDataField")
PSM_JavaClassType = Class(name="PSM_JavaClassType")
JavaUserDefinedType = Class(name="JavaUserDefinedType")
PSM_JavaInterfaceType = Class(name="PSM_JavaInterfaceType")
...
PSM_ArtifactElement.attributes={PSM_ArtifactElement_ArtifactFileName, PSM_ArtifactElement_ParentProjectName, PSM_ArtifactElement_GeneratingLinesOfCode}
...
PSM_DistributedApplicationProject.attributes={PSM_DistributedApplicationProject_ProjectPackageURL, PSM_DistributedApplicationProject_ApplicationName}
...
PSM_DockerContainerDefinition.attributes={PSM_DockerContainerDefinition_GeneratesLogs, PSM_DockerContainerDefinition_ContainerName, PSM_DockerContainerDefinition_BuildField, PSM_DockerContainerDefinition_ImageField}
...
PSM_ConfigurationProperty.attributes={PSM_ConfigurationProperty_ConfigurationProfile, PSM_ConfigurationProperty_FullyQualifiedPropertyName, PSM_ConfigurationProperty_PropertyValue}
...
PSM_JavaElement.attributes={PSM_JavaElement_ElementProfile, PSM_JavaElement_ElementIdentifier}
...
PSM_JavaDataType.attributes={PSM_JavaDataType_IsPrimitive, PSM_JavaDataType_PackageName, PSM_JavaDataType_JsonSchema}
...
domain_model = DomainModel(
    name="PSM",
    types={PSM_ArtifactElement, PSM_RootPSM, PSM_DistributedApplicationProject, PSM_DockerContainerDefinition, PSM_ApplicationProject, PSM_DockerContainerLink, PSM_DockerContainerPort, PSM_MicroserviceProject, PSM_DependencyLibrary, PSM_JavaSpringWebApplicationProject, MicroserviceProject, PSM_ConfigurationProperty, PSM_SpringWebApplicationLayer, PSM_JavaSpringWebFluxApplicationProject, JavaSpringWebApplicationProject, PSM_JavaSpringMVCApplicationProject, ArtifactElement, PSM_SpringControllerLayer, PSM_SpringServiceLayer, PSM_SpringConfigurationLayer, PSM_SpringFeignClientLayer, PSM_SpringComponentLayer, PSM_SpringRepositoryLayer, PSM_SpringDomainLayer, PSM_SpringModelPojoLayer, PSM_JavaElement, PSM_JavaAnnotation, PSM_JavaAnnotationParameter, PSM_JavaDataType, JavaElement, JavaDataType, PSM_JavaMethod, PSM_JavaDataField, PSM_JavaUserDefinedType, PSM_SpringBootApplicationLayer, SpringWebApplicationLayer, PSM_JavaMethodParameter, JavaDataField, PSM_JavaClassType, JavaUserDefinedType, PSM_JavaInterfaceType},
    associations={application0, containers1, links5, ports7, modules9, libraries11, properties13, layers14, application_project3, annotations18, parameters19, methods21, extends24, imports27, defines30, elements16, parent35, parameters38, returns40, invokes43, type45, fields32, implements34},
    generalizations={gen_PSM_DockerContainerLink_ArtifactElement, gen_PSM_DockerContainerPort_ArtifactElement, gen_PSM_ApplicationProject_ArtifactElement, gen_PSM_MicroserviceProject_ArtifactElement, gen_PSM_DependencyLibrary_ArtifactElement, gen_PSM_JavaSpringWebApplicationProject_MicroserviceProject, gen_PSM_JavaSpringWebFluxApplicationProject_JavaSpringWebApplicationProject, gen_PSM_JavaSpringMVCApplicationProject_JavaSpringWebApplicationProject, gen_PSM_ConfigurationProperty_ArtifactElement, gen_PSM_DockerContainerDefinition_ArtifactElement, gen_PSM_SpringControllerLayer_SpringWebApplicationLayer, gen_PSM_SpringServiceLayer_SpringWebApplicationLayer, gen_PSM_SpringConfigurationLayer_SpringWebApplicationLayer, gen_PSM_SpringFeignClientLayer_SpringWebApplicationLayer, gen_PSM_SpringComponentLayer_SpringWebApplicationLayer, gen_PSM_SpringRepositoryLayer_SpringWebApplicationLayer, gen_PSM_SpringDomainLayer_SpringWebApplicationLayer, gen_PSM_SpringModelPojoLayer_SpringWebApplicationLayer, gen_PSM_JavaElement_ArtifactElement, gen_PSM_JavaAnnotation_ArtifactElement, gen_PSM_JavaAnnotationParameter_ArtifactElement, gen_PSM_JavaDataType_JavaElement, gen_PSM_JavaUserDefinedType_JavaDataType, gen_PSM_SpringWebApplicationLayer_ArtifactElement, gen_PSM_SpringBootApplicationLayer_SpringWebApplicationLayer, gen_PSM_JavaMethod_JavaElement, gen_PSM_JavaDataField_JavaElement, gen_PSM_JavaMethodParameter_JavaDataField, gen_PSM_JavaClassType_JavaUserDefinedType, gen_PSM_JavaInterfaceType_JavaUserDefinedType},
    metadata=None
)
