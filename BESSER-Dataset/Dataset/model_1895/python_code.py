...
class PSM_JavaDataField(JavaElement):
    ...
    def __init__(self, FieldValue: str, PSM_JavaDataField46: "PSM_JavaDataType" = None, PSM_JavaDataField: "PSM_JavaUserDefinedType" = None):
...
class PSM_JavaAnnotation(ArtifactElement):
    ...
    def __init__(self, AnnotationName: str, PSM_JavaAnnotation: "PSM_JavaElement" = None, PSM_JavaAnnotation20: set["PSM_JavaAnnotationParameter"] = None):
...
class PSM_SpringWebApplicationLayer(ArtifactElement):
    ...
    def __init__(self, LayerName: str, PSM_SpringWebApplicationLayer: "PSM_JavaSpringWebApplicationProject" = None, PSM_SpringWebApplicationLayer17: set["PSM_JavaUserDefinedType"] = None):
...
class PSM_ConfigurationProperty(ArtifactElement):
    ...
    @property
    def FullyQualifiedPropertyName(self):
...
class PSM_DependencyLibrary(ArtifactElement):
    ...
    def __init__(self, LibraryGroupName: str, LibraryName: str, LibraryScope: str, PSM_DependencyLibrary: "PSM_MicroserviceProject" = None):
...
class PSM_DockerContainerDefinition(ArtifactElement):
    ...
    def __init__(self, ContainerName: str, GeneratesLogs: bool, ImageField: str, BuildField: str, PSM_DockerContainerDefinition: "PSM_DistributedApplicationProject" = None, PSM_DockerContainerDefinition6: set["PSM_DockerContainerLink"] = None, PSM_DockerContainerDefinition8: set["PSM_DockerContainerPort"] = None):
...
class PSM_ArtifactElement:
    ...
    @property
    def GeneratingLinesOfCode(self):
