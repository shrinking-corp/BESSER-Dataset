...
# Classes
types_SingleTypes = Class(name="types_SingleTypes")
types_ManyTypes = Class(name="types_ManyTypes")
...
types_SingleTypes.attributes={types_SingleTypes_integerObject, types_SingleTypes_stringArray, types_SingleTypes_bigDecimal, types_SingleTypes_date, types_SingleTypes_long, types_SingleTypes_float, types_SingleTypes_longArray, types_SingleTypes_clazz, types_SingleTypes_byteObject, types_SingleTypes_integer, types_SingleTypes_string, types_SingleTypes_enum, types_SingleTypes_bigInteger, types_SingleTypes_byteArray, types_SingleTypes_byte, types_SingleTypes_double, types_SingleTypes_longObject, types_SingleTypes_doubleObject, types_SingleTypes_nextEnum, types_SingleTypes_floatObject, types_SingleTypes_char, types_SingleTypes_charObject}
...
types_ManyTypes.attributes={types_ManyTypes_doubleObject, types_ManyTypes_date, types_ManyTypes_integerObject, types_ManyTypes_byteObject, types_ManyTypes_stringArray, types_ManyTypes_charObject, types_ManyTypes_floatObject, types_ManyTypes_string, types_ManyTypes_longArray, types_ManyTypes_bigDecimal, types_ManyTypes_byteArray, types_ManyTypes_bigInteger, types_ManyTypes_clazz, types_ManyTypes_enum, types_ManyTypes_long}
