...
class DefVariable:
    ...
    pass
class modelDsl_DefSimpleVariable(DefAttribute, DefVariable, DefIdAttribute):
...
class Link:
    ...
    pass
class modelDsl_SimpleLink(Element, Link):
...
class Entity:
    ...
    pass
class modelDsl_AssociativeEntity(Link, Entity):
