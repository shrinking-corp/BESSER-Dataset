...
Card.attributes={Card_fullCardNumber, Card_NINE, Card_faceUp, Card_DIAMONDS_SUIT, Card_ACE, Card_TEN, Card_image, Card_cardColor, Card_SIX, Card_FOUR, Card_TWO, Card_cardHighLighted, Card_EIGHT, Card_QUEEN, Card_highlighted, Card_cardNumber, Card_SEVEN, Card_int_deckNumber, Card_JACK, Card_cardSuit, Card_location, Card_FIVE, Card_HEARTS_SUIT, Card_CLUBS_SUIT, Card_INVALID_SUIT, Card_THREE, Card_INVALID_NUMBER, Card_cardBack, Card_cardImageString, Card_SPADES_SUIT, Card_KING}
...
ChangeAppearance.attributes={ChangeAppearance_FRS_BACKGROUND, ChangeAppearance_NUM_DECKS, ChangeAppearance_decks, ChangeAppearance_exited, ChangeAppearance_NUM_BACKGROUNDS, ChangeAppearance_FRS_DECK, ChangeAppearance_backGroundLabel, ChangeAppearance_ok, ChangeAppearance_deckNumber, ChangeAppearance_backgroundNumber, ChangeAppearance_backgrounds, ChangeAppearance_cardBackLabel}
...
ChangeOptions.attributes={ChangeOptions_sounds, ChangeOptions_difficulty, ChangeOptions_easy, ChangeOptions_winAnimationCheck, ChangeOptions_drawOne, ChangeOptions_winSoundCheck, ChangeOptions_drawCount, ChangeOptions_timerCheck, ChangeOptions_drawThree, ChangeOptions_ok, ChangeOptions_exited, ChangeOptions_timer, ChangeOptions_animation, ChangeOptions_hard, ChangeOptions_medium}
...
DealDeck.attributes={DealDeck_EASY_THROUGH_LIMIT, DealDeck_DRAW_ONE_THROUGH_LIMIT, DealDeck_DRAW_THREE_THROUGH_LIMIT, DealDeck_MEDIUM_THROUGH_LIMIT, DealDeck_redealable, DealDeck_drawCount, DealDeck_numTimesThroughDeck, DealDeck_deckThroughLimit, DealDeck_difficulty, DealDeck_HARD_THROUGH_LIMIT, DealDeck_discardPile}
...
Deck.attributes={Deck_deck, Deck_deckNumber}
...
FireworksDisplay.attributes={FireworksDisplay_y, FireworksDisplay_SET_DELAY, FireworksDisplay_numSets, FireworksDisplay_time, FireworksDisplay_random, FireworksDisplay_x, FireworksDisplay_colors, FireworksDisplay_xx, FireworksDisplay_NUM_FIREWORKS, FireworksDisplay_FIREWORKS_SIZE, FireworksDisplay_yy, FireworksDisplay_startValue, FireworksDisplay_FIREWORKS_TIME, FireworksDisplay_num}
...
FourRowSolitaire.attributes={FourRowSolitaire_exit, FourRowSolitaire_about, FourRowSolitaire_menubar, FourRowSolitaire_newGame, FourRowSolitaire_helpMenu, FourRowSolitaire_statistics, FourRowSolitaire_options, FourRowSolitaire_game, FourRowSolitaire_checkUpdate, FourRowSolitaire_appearance, FourRowSolitaire_help, FourRowSolitaire_hint, FourRowSolitaire_undo, FourRowSolitaire_version}
...
SolitaireBoard.attributes={SolitaireBoard_DO_NOTHING, SolitaireBoard_deck, SolitaireBoard_deckNumber, SolitaireBoard_columns, SolitaireBoard_numCards, SolitaireBoard_destinationList, SolitaireBoard_drawCount, SolitaireBoard_discardPile, SolitaireBoard_timerToRunNextGame, SolitaireBoard_winAnimationStatus, SolitaireBoard_RESET_STATS, SolitaireBoard_mainPanel, SolitaireBoard_cells, SolitaireBoard_timerCount, SolitaireBoard_GAME_SAVED, SolitaireBoard_acePiles, SolitaireBoard_timerLabel, SolitaireBoard_timerToRun, SolitaireBoard_statusBar, SolitaireBoard_backgroundNumber, SolitaireBoard_sourceList, SolitaireBoard_GAME_WON, SolitaireBoard_timer, SolitaireBoard_numCardsInDiscardView, SolitaireBoard_GAME_LOST, SolitaireBoard_wl, SolitaireBoard_dealDeck, SolitaireBoard_newDifficulty, SolitaireBoard_newDrawCount, SolitaireBoard_ml}
...
MyMouseListener.attributes={MyMouseListener_hasSelected, MyMouseListener_destination, MyMouseListener_temp, MyMouseListener_clickedCard, MyMouseListener_tempCard, MyMouseListener_rightClicked, MyMouseListener_source, MyMouseListener_singleCardSelected}
...
SolitaireLayout.attributes={SolitaireLayout_HEARTS_ACE_PILE, SolitaireLayout_CELL_THREE, SolitaireLayout_cellOne, SolitaireLayout_cellFour, SolitaireLayout_CLUBS_ACE_PILE, SolitaireLayout_DECK, SolitaireLayout_COLUMN_FOUR, SolitaireLayout_CELL_TWO, SolitaireLayout_cellTwo, SolitaireLayout_aceClubs, SolitaireLayout_COLUMN_THREE, SolitaireLayout_ColThree, SolitaireLayout_DISCARD_PILE, SolitaireLayout_COLUMN_ONE, SolitaireLayout_aceHearts, SolitaireLayout_acespades, SolitaireLayout_colOne, SolitaireLayout_COLUMN_TWO, SolitaireLayout_discardPile, SolitaireLayout_deck, SolitaireLayout_DIAMONDS_ACE_PILE, SolitaireLayout_ColFour, SolitaireLayout_SPADES_ACE_PILE, SolitaireLayout_cellThree, SolitaireLayout_aceDiamonds, SolitaireLayout_ColTwo, SolitaireLayout_CELL_ONE, SolitaireLayout_CELL_FOUR}
...
domain_model = DomainModel(
    name="_621bbbc5_f81d_437f_b493_e9355c7a71eb",
