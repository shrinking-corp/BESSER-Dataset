...
class SolitaireLayout:
    ...
    def __init__(self, COLUMN_ONE: str, COLUMN_TWO: str, COLUMN_THREE: str, COLUMN_FOUR: str, SPADES_ACE_PILE: str, CLUBS_ACE_PILE: str, DIAMONDS_ACE_PILE: str, HEARTS_ACE_PILE: str, DISCARD_PILE: str, DECK: str, CELL_ONE: str, CELL_TWO: str, CELL_THREE: str, CELL_FOUR: str, colOne: str, ColTwo: str, ColThree: str, ColFour: str, acespades: str, aceClubs: str, aceDiamonds: str, aceHearts: str, discardPile: str, deck: str, cellOne: str, cellTwo: str, cellThree: str, cellFour: str):
...
class SolitaireBoard:
    ...
    def __init__(self, timerLabel: str, timerCount: str, timerToRunNextGame: str, timerToRun: bool, winAnimationStatus: str, newDifficulty: str, sourceList: str, destinationList: str, numCards: str, numCardsInDiscardView: str, GAME_WON: str, GAME_LOST: str, RESET_STATS: str, DO_NOTHING: str, GAME_SAVED: str, drawCount: str, newDrawCount: str, backgroundNumber: str, deckNumber: str, deck: Deck, columns: str, discardPile: str, dealDeck: DealDeck, acePiles: str, cells: str, mainPanel: str, ml: str, wl: str, timer: str, statusBar: str):
...
class FourRowSolitaire:
    ...
    def __init__(self, hint: str, statistics: str, options: str, appearance: str, version: str, menubar: str, game: str, helpMenu: str, newGame: str, undo: str, exit: str, help: str, about: str, checkUpdate: str):
        self.hint = hint
...
class FireworksDisplay:
    ...
    def __init__(self, NUM_FIREWORKS: str, FIREWORKS_SIZE: str, SET_DELAY: str, FIREWORKS_TIME: str, x: str, y: str, colors: str, xx: str, yy: str, num: str, numSets: str, startValue: str, time: str, random: str):
...
class ChangeOptions:
    ...
    def __init__(self, hard: str, ok: str, exited: bool, drawCount: str, drawOne: str, drawThree: str, timerCheck: str, timer: str, winAnimationCheck: str, animation: str, winSoundCheck: str, sounds: str, difficulty: str, easy: str, medium: str):
        self.hard = hard
        self.ok = ok
        self.exited = exited
        self.drawCount = drawCount
...
class ChangeAppearance:
    ...
    def __init__(self, NUM_DECKS: str, NUM_BACKGROUNDS: str, FRS_DECK: str, FRS_BACKGROUND: str, decks: str, backgrounds: str, ok: str, deckNumber: str, backgroundNumber: str, exited: bool, cardBackLabel: str, backGroundLabel: str):
...
class Card:
    ...
    def __init__(self, SPADES_SUIT: str, CLUBS_SUIT: str, HEARTS_SUIT: str, DIAMONDS_SUIT: str, INVALID_SUIT: str, ACE: str, TWO: str, THREE: str, FOUR: str, FIVE: str, SIX: str, SEVEN: str, EIGHT: str, cardColor: str, int_deckNumber: str, image: str, cardBack: str, cardImageString: str, cardHighLighted: str, faceUp: bool, highlighted: bool, location: str, NINE: str, TEN: str, JACK: str, QUEEN: str, KING: str, INVALID_NUMBER: str, cardSuit: str, cardNumber: str, fullCardNumber: str):
