...
class HALL_Messages_NamedMessageState(MessageState):
    ...
    def __init__(self, name: str, messageState: "MessageHandler" = None, MessageState99: "HALL_Messages_MessageTransition" = None, MessageState: "HALL_Messages_MessageTransition" = None):
        self.name = name
...
class HALL_TaskObject(Component):
    ...
    def __init__(self, completionTime: int, numberofgoalscompleted: int, goalInv: set["HALL_Goal"] = None, taskObject: "HALL_UserProfile" = None, TaskObject43: "HALL_TaskObject" = None, componentSetInv42: set["HALL_TaskObject"] = None, TaskObject47: "HALL_TaskObject" = None, componentSet46: "HALL_TaskObject" = None, TaskObject49: "HALL_Goal" = None, TaskObject: "HALL_UserProfile" = None):
...
class HALL_Data:
    ...
    def __init__(self, name: str, type: str, initValue: str, currentValue: str, data: "MessageDefinition" = None, data55: "HALL_Component" = None, Data: "HALL_Component" = None):
        self.name = name
        self.type = type
...
class HALL_Component(ABC):
    ...
    def __init__(self, name: str, Component: "HALL_Data" = None, dataInvComponent: set["HALL_Data"] = None, FSMInv: "FSM" = None, messageHandlerSetInv: set["MessageHandler"] = None):
        self.name = name
...
class HALL_UserProfile(Component):
    ...
    def __init__(self, numberofcompletedtasks: int, UserProfile39: "HALL_TaskObject" = None, UserProfile20: "HALL_Model" = None, visualObjectInv: set["HALL_VisualObject"] = None, UserProfile: "HALL_VisualObject" = None, taskObjectInv: set["HALL_TaskObject"] = None, userProfile: "HALL_Model" = None, UserProfile32: "HALL_UserProfile" = None, componentSetInv31: set["HALL_UserProfile"] = None, UserProfile36: "HALL_UserProfile" = None, componentSet35: "HALL_UserProfile" = None):
...
class HALL_FSMActions_Let(ActionExpressionElement):
    ...
    def __init__(self, namevar: str, HALL_FSMActions_Let: "FSMActions_ActionExpressionElement" = None, HALL_FSMActions_Let278: "FSMActions_ActionExpressionElement" = None):
