...
domain_model = DomainModel(
    name="fsm",
    types={AbstractState, fsm_Program, fsm_StateMachine, NamedElement, fsm_Region, fsm_AbstractState, fsm_Transition, fsm_State, Statement, fsm_NamedElement, fsm_Trigger, fsm_Statement, fsm_Constraint, fsm_Pseudostate, fsm_InitialState, Pseudostate, fsm_Fork, fsm_Join, fsm_ShallowHistory, fsm_Junction, fsm_Conditional, fsm_FinalState, State},
    associations={incoming5, outgoing6, ownerRegion8, doActivity9, regions0, subvertex1, transitions2, ownerState4, statements28, entry10, exit13, ownedRegions16, trigger18, target20, source22, effect24, guard26},
    generalizations={gen_fsm_State_AbstractState, gen_fsm_StateMachine_NamedElement, gen_fsm_Region_NamedElement, gen_fsm_AbstractState_NamedElement, gen_fsm_Program_Statement, gen_fsm_Transition_NamedElement, gen_fsm_Pseudostate_AbstractState, gen_fsm_InitialState_Pseudostate, gen_fsm_Fork_Pseudostate, gen_fsm_Join_Pseudostate, gen_fsm_ShallowHistory_Pseudostate, gen_fsm_Junction_Pseudostate, gen_fsm_Conditional_Pseudostate, gen_fsm_FinalState_State},
    metadata=None
)
