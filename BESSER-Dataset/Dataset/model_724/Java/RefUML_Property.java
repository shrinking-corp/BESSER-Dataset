...
public class RefUML_Property extends StructuralFeature {
    ...
    public RefUML_Property(
        String isDerived,        String aggregation,        String default,        String isComposite,        String isDerivedUnion    ) {
        super(
        );
    ...
    public RefUML_Property(
        String isDerived,        String aggregation,        String default,        String isComposite,        String isDerivedUnion        ArrayList<RefUML_Property> refuml_propertys,        ArrayList<RefUML_Property> refuml_propertys    ) {
        this.isDerived = isDerived;
        this.aggregation = aggregation;
        this.default = default;
        this.isComposite = isComposite;
