...
# Classes
uml_attribute = Class(name="uml_attribute")
uml_ownerClassifier = Class(name="uml_ownerClassifier")
uml_association = Class(name="uml_association")
uml_classifiersAndAssociations = Class(name="uml_classifiersAndAssociations")
uml_attributes = Class(name="uml_attributes")
uml_class_ = Class(name="uml_class_")
uml_generalClass = Class(name="uml_generalClass")
uml_primitiveDataType = Class(name="uml_primitiveDataType")
uml_DocumentRoot = Class(name="uml_DocumentRoot")
uml_EStringToStringMapEntry = Class(name="uml_EStringToStringMapEntry")
uml_package_ = Class(name="uml_package_")
uml_packages = Class(name="uml_packages")
uml_UML = Class(name="uml_UML")
...
uml_attribute.attributes={uml_attribute_name, uml_attribute_kind, uml_attribute_oID}
...
uml_association.attributes={uml_association_name, uml_association_kind, uml_association_destination, uml_association_source, uml_association_oID}
...
uml_class_.attributes={uml_class__oID, uml_class__name, uml_class__kind}
...
uml_package_.attributes={uml_package__oID, uml_package__kind, uml_package__name}
...
class_7: BinaryAssociation = BinaryAssociation(
    name="class_7",
    ends={
...
domain_model = DomainModel(
    name="uml",
    types={uml_attribute, uml_ownerClassifier, uml_association, uml_classifiersAndAssociations, uml_attributes, uml_class_, uml_generalClass, uml_primitiveDataType, uml_DocumentRoot, uml_EStringToStringMapEntry, uml_package_, uml_packages, uml_UML},
    associations={ownerClassifier0, attribute1, generalClass3, attributes4, attribute20, attributes23, class_7, primitiveDataType9, association11, xMLNSPrefixMap13, xSISchemaLocation14, association17, uML45, class_47, class_26, classifiersAndAssociations29, generalClass32, ownerClassifier35, package38, packages40, primitiveDataType42, class_50, primitiveDataType53, classifiersAndAssociations56, package59, packages62},
    generalizations={},
    metadata=None
)
