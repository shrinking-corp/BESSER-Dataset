...
class uml_package_:
    ...
    def __init__(self, kind: str, name: str, oID: str, uml_package_: "uml_DocumentRoot" = None, uml_package_57: "uml_classifiersAndAssociations" = None, uml_package_61: "uml_packages" = None):
        self.kind = kind
        self.name = name
        self.oID = oID
...
class uml_DocumentRoot:
    ...
    def __init__(self, mixed: str, uml_DocumentRoot46: set["uml_UML"] = None, uml_DocumentRoot21: set["uml_attribute"] = None, uml_DocumentRoot24: set["uml_attributes"] = None, uml_DocumentRoot: set["uml_EStringToStringMapEntry"] = None, uml_DocumentRoot15: set["uml_EStringToStringMapEntry"] = None, uml_DocumentRoot18: set["uml_association"] = None, uml_DocumentRoot27: set["uml_class_"] = None, uml_DocumentRoot30: set["uml_classifiersAndAssociations"] = None, uml_DocumentRoot33: set["uml_generalClass"] = None, uml_DocumentRoot36: set["uml_ownerClassifier"] = None, uml_DocumentRoot39: set["uml_package_"] = None, uml_DocumentRoot41: set["uml_packages"] = None, uml_DocumentRoot43: set["uml_primitiveDataType"] = None):
        self.mixed = mixed
...
class uml_class_:
    ...
    def __init__(self, name: str, oID: str, kind: str, uml_class_49: "uml_generalClass" = None, uml_class_28: "uml_DocumentRoot" = None, uml_class_: "uml_generalClass" = None, uml_class_5: "uml_attributes" = None, uml_class_8: "uml_classifiersAndAssociations" = None, uml_class_52: "uml_ownerClassifier" = None):
        self.name = name
        self.oID = oID
        self.kind = kind
...
class uml_classifiersAndAssociations:
    ...
    def __init__(self, group: str, uml_classifiersAndAssociations: set["uml_class_"] = None, uml_classifiersAndAssociations10: set["uml_primitiveDataType"] = None, uml_classifiersAndAssociations12: set["uml_association"] = None, uml_classifiersAndAssociations31: "uml_DocumentRoot" = None, uml_classifiersAndAssociations58: "uml_package_" = None):
        self.group = group
