...
# Classes
rootPackage_A = Class(name="rootPackage_A")
AbstractA = Class(name="AbstractA")
rootPackage_C = Class(name="rootPackage_C")
rootPackage_B = Class(name="rootPackage_B")
rootPackage_AbstractA = Class(name="rootPackage_AbstractA", is_abstract=True)
rootPackage_aSubPackage_D = Class(name="rootPackage_aSubPackage_D")
rootPackage_aSubSubPackage_E = Class(name="rootPackage_aSubSubPackage_E")
aSubSubPackage_F = Class(name="aSubSubPackage_F")
rootPackage_aSubSubPackage_F = Class(name="rootPackage_aSubSubPackage_F")
...
rootPackage_B.attributes={rootPackage_B_stuff, rootPackage_B_bint}
...
domain_model = DomainModel(
    name="rootPackage",
    types={rootPackage_A, AbstractA, rootPackage_C, rootPackage_B, rootPackage_AbstractA, rootPackage_aSubPackage_D, rootPackage_aSubSubPackage_E, aSubSubPackage_F, rootPackage_aSubSubPackage_F},
