...
class docbook_Sect1Type:
    ...
    def __init__(self, mixed: str, title: str, para: str, docbook_Sect1Type15: "docbook_DocumentRoot" = None, docbook_Sect1Type: "docbook_ChapterType" = None):
        self.mixed = mixed
        self.title = title
        self.para = para
...
class docbook_ChapterType:
    ...
    def __init__(self, mixed: str, title: str, para: str, docbook_ChapterType: "docbook_BookType" = None, docbook_ChapterType12: "docbook_DocumentRoot" = None, docbook_ChapterType2: set["docbook_Sect1Type"] = None):
        self.mixed = mixed
        self.title = title
        self.para = para
