...
docbook_Sect1Type = Class(name="docbook_Sect1Type")
...
docbook_BookType.attributes={docbook_BookType_info, docbook_BookType_title}
...
docbook_ChapterType.attributes={docbook_ChapterType_title, docbook_ChapterType_para, docbook_ChapterType_mixed}
...
docbook_DocumentRoot.attributes={docbook_DocumentRoot_mixed, docbook_DocumentRoot_title, docbook_DocumentRoot_info, docbook_DocumentRoot_para}
...
docbook_Sect1Type.attributes={docbook_Sect1Type_para, docbook_Sect1Type_mixed, docbook_Sect1Type_title}
...
domain_model = DomainModel(
    name="docbook",
    types={docbook_BookType, docbook_ChapterType, docbook_DocumentRoot, docbook_EStringToStringMapEntry, docbook_Sect1Type},
    associations={chapter0, xMLNSPrefixMap3, xSISchemaLocation4, book7, chapter10, sect113, sect11},
    generalizations={},
    metadata=None
)
