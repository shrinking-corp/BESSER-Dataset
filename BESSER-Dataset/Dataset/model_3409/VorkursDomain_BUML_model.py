...
# Classes
VorkursModel_Notebook = Class(name="VorkursModel_Notebook")
VorkursModel_Qualification = Class(name="VorkursModel_Qualification")
VorkursModel_Address = Class(name="VorkursModel_Address")
VorkursModel_RegistrationSystem = Class(name="VorkursModel_RegistrationSystem")
VorkursModel_Student = Class(name="VorkursModel_Student")
VorkursModel_TeachingAssistant = Class(name="VorkursModel_TeachingAssistant")
VorkursModel_Person = Class(name="VorkursModel_Person", is_abstract=True)
VorkursModel_Contact = Class(name="VorkursModel_Contact")
Person = Class(name="Person")
VorkursModel_Room = Class(name="VorkursModel_Room")
...
VorkursModel_Qualification.attributes={VorkursModel_Qualification_programminLanguage, VorkursModel_Qualification_hasProgrammingExperience, VorkursModel_Qualification_Language, VorkursModel_Qualification_hasPCExperience}
...
VorkursModel_Address.attributes={VorkursModel_Address_zip, VorkursModel_Address_city, VorkursModel_Address_state, VorkursModel_Address_street}
...
VorkursModel_Person.attributes={VorkursModel_Person_subject, VorkursModel_Person_gender, VorkursModel_Person_lastname, VorkursModel_Person_firstname}
...
VorkursModel_Room.attributes={VorkursModel_Room_seats, VorkursModel_Room_roomNr, VorkursModel_Room_sockets, VorkursModel_Room_hasComputers}
...
domain_model = DomainModel(
    name="VorkursModel",
    types={VorkursModel_Notebook, VorkursModel_Qualification, VorkursModel_Address, VorkursModel_RegistrationSystem, VorkursModel_Student, VorkursModel_TeachingAssistant, VorkursModel_Person, VorkursModel_Contact, Person, VorkursModel_Room, Nationality, ProgrammingLanguage, OperatingSystem, Subject, Gender},
    associations={notebook4, qualification6, students0, teachingAssistants1, contactinfo3, address8, room10},
