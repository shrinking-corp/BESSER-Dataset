...
class VorkursModel_Person(ABC):
    ...
    def __init__(self, gender: str, subject: str, firstname: str, lastname: str, VorkursModel_Person5: "VorkursModel_Notebook" = None, VorkursModel_Person7: "VorkursModel_Qualification" = None, VorkursModel_Person: "VorkursModel_Contact" = None):
        self.gender = gender
