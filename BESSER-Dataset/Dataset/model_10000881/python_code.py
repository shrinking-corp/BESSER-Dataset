...
class GameView:
    ...
    def __init__(self, splitButton: JButton, doubleButton: JButton, showStrategy: bool, bet: JLabel, dealButton: JButton, hitButton: JButton, standButton: JButton, playerView11: set["PlayerView"] = None, blackjack7: "BlackjackGame" = None):
