...
def test_hyp_move_a_card_one_space_external_is_not_abstract():
    assert not inspect.isabstract(Move_a_Card_one_Space_external)


def test_hyp_move_a_card_one_space_external_constructor_exists():
    assert callable(Move_a_Card_one_Space_external.__init__)


def test_hyp_move_a_card_one_space_external_constructor_args():
    sig = inspect.signature(Move_a_Card_one_Space_external.__init__)
    params = list(sig.parameters.keys())



def test_hyp_shuffle_deck_external_is_not_abstract():
    assert not inspect.isabstract(Shuffle_Deck_external)


def test_hyp_shuffle_deck_external_constructor_exists():
    assert callable(Shuffle_Deck_external.__init__)


def test_hyp_shuffle_deck_external_constructor_args():
    sig = inspect.signature(Shuffle_Deck_external.__init__)
    params = list(sig.parameters.keys())



def test_hyp_deal_a_card_external_is_not_abstract():
    assert not inspect.isabstract(Deal_A_Card_external)


def test_hyp_deal_a_card_external_constructor_exists():
    assert callable(Deal_A_Card_external.__init__)


def test_hyp_deal_a_card_external_constructor_args():
...
def test_hyp_cardtable_is_not_abstract():
    assert not inspect.isabstract(CardTable)


def test_hyp_cardtable_constructor_exists():
    assert callable(CardTable.__init__)


def test_hyp_cardtable_constructor_args():
...
def test_hyp_cardtable_has_cards():
...
def test_hyp_cardtable_has_done():
...
def test_hyp_cardtable_has_stage():
...
def test_hyp_board_has_boardGui():
...
def test_hyp_card_has_cardNames():
...
def test_hyp_display_rulebook_usecase_is_not_abstract():
    assert not inspect.isabstract(Display_Rulebook_UseCase)


def test_hyp_display_rulebook_usecase_constructor_exists():
    assert callable(Display_Rulebook_UseCase.__init__)


def test_hyp_display_rulebook_usecase_constructor_args():
    sig = inspect.signature(Display_Rulebook_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_display_leaderboard_usecase_is_not_abstract():
    assert not inspect.isabstract(Display_leaderboard_UseCase)


def test_hyp_display_leaderboard_usecase_constructor_exists():
    assert callable(Display_leaderboard_UseCase.__init__)


def test_hyp_display_leaderboard_usecase_constructor_args():
    sig = inspect.signature(Display_leaderboard_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_amalgamate_middle_cards_usecase_is_not_abstract():
    assert not inspect.isabstract(Amalgamate_Middle_Cards_UseCase)


def test_hyp_amalgamate_middle_cards_usecase_constructor_exists():
    assert callable(Amalgamate_Middle_Cards_UseCase.__init__)


def test_hyp_amalgamate_middle_cards_usecase_constructor_args():
    sig = inspect.signature(Amalgamate_Middle_Cards_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_print_cards_text_form__usecase_is_not_abstract():
    assert not inspect.isabstract(Print_Cards_text_form__UseCase)


def test_hyp_print_cards_text_form__usecase_constructor_exists():
    assert callable(Print_Cards_text_form__UseCase.__init__)


def test_hyp_print_cards_text_form__usecase_constructor_args():
    sig = inspect.signature(Print_Cards_text_form__UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_automatic_play_usecase_is_not_abstract():
    assert not inspect.isabstract(Automatic_play_UseCase)


def test_hyp_automatic_play_usecase_constructor_exists():
    assert callable(Automatic_play_UseCase.__init__)


def test_hyp_automatic_play_usecase_constructor_args():
    sig = inspect.signature(Automatic_play_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_move_a_card_two_spaces_usecase_is_not_abstract():
    assert not inspect.isabstract(Move_a_Card_two_Spaces_UseCase)


def test_hyp_move_a_card_two_spaces_usecase_constructor_exists():
    assert callable(Move_a_Card_two_Spaces_UseCase.__init__)


def test_hyp_move_a_card_two_spaces_usecase_constructor_args():
    sig = inspect.signature(Move_a_Card_two_Spaces_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_game_component_is_not_abstract():
    assert not inspect.isabstract(Game_Component)


def test_hyp_game_component_constructor_exists():
    assert callable(Game_Component.__init__)


def test_hyp_game_component_constructor_args():
...
def test_hyp_cardsuits_exists():
    # Check that the Enumeration exists
    assert CardSuits is not None

def test_hyp_cardsuits_has_all_literals():
...
@given(instance=Deck_strategy)
def test_hyp_deck_card_setter(instance):
...
@given(instance=Deck_strategy)
def test_hyp_deck_deck____setter(instance):
...
@settings(max_examples=50)
def test_hyp_cardtable_instantiation(instance):
    assert isinstance(instance, CardTable)



@given(instance=CardTable_strategy)
def test_hyp_cardtable_cards_setter(instance):
...
@given(instance=CardTable_strategy)
def test_hyp_cardtable_done_setter(instance):
...
@given(instance=CardTable_strategy)
def test_hyp_cardtable_stage_setter(instance):
...
@given(instance=Board_strategy)
def test_hyp_board_scores_setter(instance):
...
@given(instance=Board_strategy)
def test_hyp_board_boardGui_setter(instance):
...
@given(instance=Card_strategy)
def test_hyp_card_cardNames_setter(instance):
...
@given(instance=Game_strategy)
def test_hyp_game_board_setter(instance):
    original = instance.board
    instance.board = original
    assert instance.board == original
...
@given(instance=Game_strategy)
def test_hyp_game_scan_setter(instance):
