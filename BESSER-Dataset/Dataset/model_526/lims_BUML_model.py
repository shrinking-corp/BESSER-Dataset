...
domain_model = DomainModel(
    name="Lims",
    types={Lims_Sample, Lims_Family, Lims_Individual, Lims_Laboratory, Lims_Sequencer, Lims_Run, Lims_Sequenced, Gender},
    associations={Father8, Mother10, samples12, individuals0, laboratory1, families2, sequencers3, family5, runs13, laboratory14, sequenced16, sequencer17, individual19, run21, sample23},
    generalizations={},
    metadata=None
)
