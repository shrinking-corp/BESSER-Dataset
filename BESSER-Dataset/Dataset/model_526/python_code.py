...
class Lims_Run:
    ...
    def __init__(self, name: str, date: date, Run: "Lims_Sequencer" = None, run: set["Lims_Sequenced"] = None, runs: "Lims_Sequencer" = None, Run22: "Lims_Sequenced" = None):
        self.name = name
        self.date = date
        self.Run = Run
...
class Lims_Individual:
    ...
    def __init__(self, name: str, gender: str, Lims_Individual: "Lims_Individual" = None, Lims_Individual7: "Lims_Individual" = None, Lims_Individual11: "Lims_Individual" = None, Lims_Individual9: "Lims_Individual" = None, individual: set["Lims_Sample"] = None, Individual: "Lims_Family" = None, individuals: "Lims_Family" = None, Individual20: "Lims_Sample" = None):
        self.name = name
        self.gender = gender
...
class Lims_Family:
    ...
    def __init__(self, name: str, family: set["Lims_Individual"] = None, families: "Lims_Laboratory" = None, Family: "Lims_Laboratory" = None, Family6: "Lims_Individual" = None):
        self.name = name
