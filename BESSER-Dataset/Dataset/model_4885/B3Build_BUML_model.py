...
build_IBuilder = Class(name="build_IBuilder", is_abstract=True)
build_BuildUnit = Class(name="build_BuildUnit")
VersionedCapability = Class(name="VersionedCapability")
build_FragmentHost = Class(name="build_FragmentHost")
IFunction = Class(name="IFunction")
build_BExpression = Class(name="build_BExpression")
build_BuilderInput = Class(name="build_BuilderInput")
build_RequiredCapability = Class(name="build_RequiredCapability")
build_IType = Class(name="build_IType")
build_BConcern = Class(name="build_BConcern")
build_BPropertySet = Class(name="build_BPropertySet")
build_Synchronization = Class(name="build_Synchronization")
build_Repository = Class(name="build_Repository")
build_ContainerConfiguration = Class(name="build_ContainerConfiguration")
build_FirstFoundUnitProvider = Class(name="build_FirstFoundUnitProvider")
build_IBuildUnitContainer = Class(name="build_IBuildUnitContainer", is_abstract=True)
build_PathGroup = Class(name="build_PathGroup")
build_UnitParameterDeclaration = Class(name="build_UnitParameterDeclaration")
build_VersionedCapability = Class(name="build_VersionedCapability")
Capability = Class(name="Capability")
build_ConditionalPathVector = Class(name="build_ConditionalPathVector")
build_PathVector = Class(name="build_PathVector")
build_BuilderInputDecorator = Class(name="build_BuilderInputDecorator", is_abstract=True)
BuilderInput = Class(name="BuilderInput")
build_BuilderCall = Class(name="build_BuilderCall", is_abstract=True)
build_BParameterList = Class(name="build_BParameterList")
build_Capability = Class(name="build_Capability")
INamedValue = Class(name="INamedValue")
build_BestFoundUnitProvider = Class(name="build_BestFoundUnitProvider")
build_BuildConcernContext = Class(name="build_BuildConcernContext")
BConcernContext = Class(name="BConcernContext")
build_RequiresPredicate = Class(name="build_RequiresPredicate")
build_BuilderQuery = Class(name="build_BuilderQuery")
build_UnitProvider = Class(name="build_UnitProvider", is_abstract=True)
BExpression = Class(name="BExpression")
build_RepositoryUnitProvider = Class(name="build_RepositoryUnitProvider")
UnitProvider = Class(name="UnitProvider")
build_RepoOption = Class(name="build_RepoOption")
build_IBuildUnitRepository = Class(name="build_IBuildUnitRepository", is_abstract=True)
build_CompoundUnitProvider = Class(name="build_CompoundUnitProvider", is_abstract=True)
CompoundUnitProvider = Class(name="CompoundUnitProvider")
build_NameSpacePredicate = Class(name="build_NameSpacePredicate")
build_UnitNamePredicate = Class(name="build_UnitNamePredicate")
CapabilityPredicate = Class(name="CapabilityPredicate")
build_BuilderNamePredicate = Class(name="build_BuilderNamePredicate")
build_InputPredicate = Class(name="build_InputPredicate")
build_CapabilityPredicate = Class(name="build_CapabilityPredicate")
build_BNamePredicate = Class(name="build_BNamePredicate")
build_ImplementsPredicate = Class(name="build_ImplementsPredicate")
build_ProvidesPredicate = Class(name="build_ProvidesPredicate")
build_BParameterPredicate = Class(name="build_BParameterPredicate")
build_UnitConcernContext = Class(name="build_UnitConcernContext")
BuildConcernContext = Class(name="BuildConcernContext")
build_BuilderConcernContext = Class(name="build_BuilderConcernContext")
build_OutputPredicate = Class(name="build_OutputPredicate")
build_IProvidedCapabilityContainer = Class(name="build_IProvidedCapabilityContainer", is_abstract=True)
build_Builder = Class(name="build_Builder")
B3Function = Class(name="B3Function")
IBuilder = Class(name="IBuilder")
build_SourcePredicate = Class(name="build_SourcePredicate")
build_PathGroupPredicate = Class(name="build_PathGroupPredicate")
build_AliasedRequiredCapability = Class(name="build_AliasedRequiredCapability")
RequiredCapability = Class(name="RequiredCapability")
build_IRequiredCapabilityContainer = Class(name="build_IRequiredCapabilityContainer", is_abstract=True)
build_BeeHive = Class(name="build_BeeHive")
build_ResolutionInfo = Class(name="build_ResolutionInfo")
build_BuilderJava = Class(name="build_BuilderJava")
BJavaFunction = Class(name="BJavaFunction")
build_BuilderWrapper = Class(name="build_BuilderWrapper")
BFunctionWrapper = Class(name="BFunctionWrapper")
build_BeeModel = Class(name="build_BeeModel")
BChainedExpression = Class(name="BChainedExpression")
IBuildUnitContainer = Class(name="IBuildUnitContainer")
build_IFunction = Class(name="build_IFunction")
build_BuildResultContext = Class(name="build_BuildResultContext")
BInnerContext = Class(name="BInnerContext")
PathGroupPredicate = Class(name="PathGroupPredicate")
build_BuildUnitRepository = Class(name="build_BuildUnitRepository", is_abstract=True)
build_EffectiveFacade = Class(name="build_EffectiveFacade")
IEffectiveFacade = Class(name="IEffectiveFacade")
build_EffectiveUnitFacade = Class(name="build_EffectiveUnitFacade")
EffectiveFacade = Class(name="EffectiveFacade")
build_EffectiveCapabilityFacade = Class(name="build_EffectiveCapabilityFacade")
build_EffectiveRequirementFacade = Class(name="build_EffectiveRequirementFacade")
build_BuilderCallFacade = Class(name="build_BuilderCallFacade")
build_BuildSet = Class(name="build_BuildSet")
ITypedValueContainer = Class(name="ITypedValueContainer")
build_BSwitchExpression = Class(name="build_BSwitchExpression")
build_Branch = Class(name="build_Branch")
IBuildUnitRepository = Class(name="IBuildUnitRepository")
build_CompoundBuildUnitRepository = Class(name="build_CompoundBuildUnitRepository", is_abstract=True)
BuildUnitRepository = Class(name="BuildUnitRepository")
build_CompoundFirstFoundRepository = Class(name="build_CompoundFirstFoundRepository")
CompoundBuildUnitRepository = Class(name="CompoundBuildUnitRepository")
build_ExecutionStackRepository = Class(name="build_ExecutionStackRepository")
build_BeeModelRepository = Class(name="build_BeeModelRepository")
build_UnitResolutionInfo = Class(name="build_UnitResolutionInfo")
ResolutionInfo = Class(name="ResolutionInfo")
build_BExecutionContext = Class(name="build_BExecutionContext")
build_SwitchUnitProvider = Class(name="build_SwitchUnitProvider")
build_DelegatingUnitProvider = Class(name="build_DelegatingUnitProvider")
build_BuildCallOnSelectedRequirements = Class(name="build_BuildCallOnSelectedRequirements")
BuildCallMultiple = Class(name="BuildCallMultiple")
build_BuilderInputNameDecorator = Class(name="build_BuilderInputNameDecorator")
BuilderInputDecorator = Class(name="BuilderInputDecorator")
build_BuilderInputContextDecorator = Class(name="build_BuilderInputContextDecorator")
build_BWithExpression = Class(name="build_BWithExpression")
build_UnitRepositoryDescription = Class(name="build_UnitRepositoryDescription")
BParameterDeclaration = Class(name="BParameterDeclaration")
build_BuilderInputCondition = Class(name="build_BuilderInputCondition")
build_BuildCallMultiple = Class(name="build_BuildCallMultiple")
BuilderCall = Class(name="BuilderCall")
build_BuildCallSingle = Class(name="build_BuildCallSingle", is_abstract=True)
build_BuildCallOnDeclaredRequirement = Class(name="build_BuildCallOnDeclaredRequirement")
BuildCallSingle = Class(name="BuildCallSingle")
build_BuildCallOnReferencedRequirement = Class(name="build_BuildCallOnReferencedRequirement")
build_BuilderInputGroup = Class(name="build_BuilderInputGroup")
build_IEffectiveFacade = Class(name="build_IEffectiveFacade", is_abstract=True)
build_EffectiveBuilderCallFacade = Class(name="build_EffectiveBuilderCallFacade")
...
build_BuildUnit_m_getEffectiveFacade: Method = Method(name="getEffectiveFacade", parameters={Parameter(name='build_ctx', type=StringType)}, type=StringType)
build_BuildUnit_m_getUnitProvider: Method = Method(name="getUnitProvider", parameters={}, type=StringType)
build_BuildUnit.attributes={build_BuildUnit_outputLocation, build_BuildUnit_sourceLocation, build_BuildUnit_platformFilter, build_BuildUnit_executionMode, build_BuildUnit_documentation}
...
build_RequiredCapability.attributes={build_RequiredCapability_max, build_RequiredCapability_greedy, build_RequiredCapability_versionRange, build_RequiredCapability_min}
...
build_Repository.attributes={build_Repository_name, build_Repository_documentation, build_Repository_handlerType}
...
build_ContainerConfiguration.attributes={build_ContainerConfiguration_documentation, build_ContainerConfiguration_name}
...
build_UnitParameterDeclaration_m_hasCorrectState: Method = Method(name="hasCorrectState", parameters={Parameter(name='build_chain', type=StringType), Parameter(name='build_map', type=StringType)}, type=BooleanType)
...
build_PathVector_m_resolve: Method = Method(name="resolve", parameters={Parameter(name='build_baseUri', type=StringType)}, type=StringType)
...
build_Capability_m_satisfies: Method = Method(name="satisfies", parameters={Parameter(name='build_requirement', type=StringType)}, type=BooleanType)
...
build_RequiresPredicate_m_matches: Method = Method(name="matches", parameters={Parameter(name='build_candidate', type=StringType)}, type=BooleanType)
...
build_UnitProvider_m_resolve: Method = Method(name="resolve", parameters={Parameter(name='build_requiredCapability', type=StringType), Parameter(name='build_ctx', type=StringType)}, type=StringType)
build_UnitProvider_m_resolve: Method = Method(name="resolve", parameters={Parameter(name='build_effectiveRequirement', type=StringType)}, type=StringType)
...
build_CapabilityPredicate_m_matches: Method = Method(name="matches", parameters={Parameter(name='build_candidate', type=StringType)}, type=BooleanType)
build_CapabilityPredicate_m_matches: Method = Method(name="matches", parameters={Parameter(name='build_candidate', type=StringType)}, type=BooleanType)
build_CapabilityPredicate_m_matches: Method = Method(name="matches", parameters={Parameter(name='build_candidate', type=StringType)}, type=BooleanType)
...
build_ProvidesPredicate_m_matches: Method = Method(name="matches", parameters={Parameter(name='build_candidate', type=StringType)}, type=BooleanType)
build_ProvidesPredicate_m_matches: Method = Method(name="matches", parameters={Parameter(name='build_candidate', type=StringType)}, type=BooleanType)
build_ProvidesPredicate_m_removeMatching: Method = Method(name="removeMatching", parameters={Parameter(name='build_input', type=StringType)}, type=BooleanType)
build_ProvidesPredicate.methods={build_ProvidesPredicate_m_removeMatching, build_ProvidesPredicate_m_matches, build_ProvidesPredicate_m_matches}
...
build_UnitConcernContext.attributes={build_UnitConcernContext_sourceLocation, build_UnitConcernContext_outputLocation}
...
build_BuilderConcernContext.attributes={build_BuilderConcernContext_removePreCondition, build_BuilderConcernContext_outputAnnotationsRemovals, build_BuilderConcernContext_removePostCondition, build_BuilderConcernContext_removePostInputCondition, build_BuilderConcernContext_matchParameters, build_BuilderConcernContext_sourceAnnotationsRemovals, build_BuilderConcernContext_varArgs}
...
build_PathGroupPredicate_m_removeMatching: Method = Method(name="removeMatching", parameters={Parameter(name='build_input', type=StringType)}, type=BooleanType)
...
build_BeeHive_m_getResolvedCapabilityContainer: Method = Method(name="getResolvedCapabilityContainer", parameters={Parameter(name='build_requiredCapability', type=StringType)}, type=IProvidedCapabilityContainer)
...
build_BuilderWrapper.attributes={build_BuilderWrapper_defaultPropertiesAdvised, build_BuilderWrapper_providesAdvised, build_BuilderWrapper_outputAdvised, build_BuilderWrapper_unitTypeAdvised, build_BuilderWrapper_sourceAdvised, build_BuilderWrapper_inputAdvised}
...
build_BuildUnitRepository_m_resolve: Method = Method(name="resolve", parameters={Parameter(name='build_requiredCapability', type=StringType), Parameter(name='build_options', type=StringType), Parameter(name='build_ctx', type=StringType)}, type=StringType)
build_BuildUnitRepository_m_initialize: Method = Method(name="initialize", parameters={Parameter(name='build_ctx', type=StringType), Parameter(name='build_repository', type=StringType), Parameter(name='build_options', type=StringType)})
build_BuildUnitRepository.methods={build_BuildUnitRepository_m_initialize, build_BuildUnitRepository_m_resolve}
...
build_BuildSet_m_merge: Method = Method(name="merge", parameters={Parameter(name='build_buildResult', type=StringType)}, type=StringType)
build_BuildSet.attributes={build_BuildSet_valueMap, build_BuildSet_pathIterator}
...
build_Branch_m_hasValidState: Method = Method(name="hasValidState", parameters={Parameter(name='build_map', type=StringType), Parameter(name='build_chain', type=StringType)}, type=BooleanType)
build_Branch.attributes={build_Branch_branchPointType, build_Branch_replace, build_Branch_mergeStrategy, build_Branch_checkout, build_Branch_acceptDirty, build_Branch_name, build_Branch_update, build_Branch_documentation}
build_Branch.methods={build_Branch_m_getEffectiveMergeStrategy, build_Branch_m_getEffectiveReplace, build_Branch_m_getEffectiveUpdate, build_Branch_m_hasValidState, build_Branch_m_getEffectiveAcceptDirty, build_Branch_m_getEffectiveCheckout}
...
domain_model = DomainModel(
    name="build",
    types={BFunctionContainer, IRequiredCapabilityContainer, IProvidedCapabilityContainer, IVarName, build_IBuilder, build_BuildUnit, VersionedCapability, build_FragmentHost, IFunction, build_BExpression, build_BuilderInput, build_RequiredCapability, build_IType, build_BConcern, build_BPropertySet, build_Synchronization, build_Repository, build_ContainerConfiguration, build_FirstFoundUnitProvider, build_IBuildUnitContainer, build_PathGroup, build_UnitParameterDeclaration, build_VersionedCapability, Capability, build_ConditionalPathVector, build_PathVector, build_BuilderInputDecorator, BuilderInput, build_BuilderCall, build_BParameterList, build_Capability, INamedValue, build_BestFoundUnitProvider, build_BuildConcernContext, BConcernContext, build_RequiresPredicate, build_BuilderQuery, build_UnitProvider, BExpression, build_RepositoryUnitProvider, UnitProvider, build_RepoOption, build_IBuildUnitRepository, build_CompoundUnitProvider, CompoundUnitProvider, build_NameSpacePredicate, build_UnitNamePredicate, CapabilityPredicate, build_BuilderNamePredicate, build_InputPredicate, build_CapabilityPredicate, build_BNamePredicate, build_ImplementsPredicate, build_ProvidesPredicate, build_BParameterPredicate, build_UnitConcernContext, BuildConcernContext, build_BuilderConcernContext, build_OutputPredicate, build_IProvidedCapabilityContainer, build_Builder, B3Function, IBuilder, build_SourcePredicate, build_PathGroupPredicate, build_AliasedRequiredCapability, RequiredCapability, build_IRequiredCapabilityContainer, build_BeeHive, build_ResolutionInfo, build_BuilderJava, BJavaFunction, build_BuilderWrapper, BFunctionWrapper, build_BeeModel, BChainedExpression, IBuildUnitContainer, build_IFunction, build_BuildResultContext, BInnerContext, PathGroupPredicate, build_BuildUnitRepository, build_EffectiveFacade, IEffectiveFacade, build_EffectiveUnitFacade, EffectiveFacade, build_EffectiveCapabilityFacade, build_EffectiveRequirementFacade, build_BuilderCallFacade, build_BuildSet, ITypedValueContainer, build_BSwitchExpression, build_Branch, IBuildUnitRepository, build_CompoundBuildUnitRepository, BuildUnitRepository, build_CompoundFirstFoundRepository, CompoundBuildUnitRepository, build_ExecutionStackRepository, build_BeeModelRepository, build_UnitResolutionInfo, ResolutionInfo, build_BExecutionContext, build_SwitchUnitProvider, build_DelegatingUnitProvider, build_BuildCallOnSelectedRequirements, BuildCallMultiple, build_BuilderInputNameDecorator, BuilderInputDecorator, build_BuilderInputContextDecorator, build_BWithExpression, build_UnitRepositoryDescription, BParameterDeclaration, build_BuilderInputCondition, build_BuildCallMultiple, BuilderCall, build_BuildCallSingle, build_BuildCallOnDeclaredRequirement, BuildCallSingle, build_BuildCallOnReferencedRequirement, build_BuilderInputGroup, build_IEffectiveFacade, build_EffectiveBuilderCallFacade, BuilderCallFacade, BranchPointType, MergeConflictStrategy, TriState},
    associations={builders0, fragmentHosts22, postcondExpr24, precondExpr26, input29, metaRequiredCapabilities1, implements3, concerns5, defaultProperties7, synchronizations9, repositories11, containers13, propertySets15, providers18, parent20, output31, defaultProperties33, postinputcondExpr36, explicitUnitType39, source41, annotations44, pathVectors47, condExpr52, condExpr54, builderInput49, parameters51, agentType68, contextBlock71, defaultPropertiesAdditions74, pathVectors57, builderQueries59, repository61, options63, buildUnitRepository65, providers67, capabilityPredicate84, namePredicate86, capabilityPredicate88, builderPredicate90, capabilityPredicate76, namePredicate77, nameSpacePredicate79, type82, funcExpr120, parameters123, precondExpr125, postcondExpr128, builderContexts93, query94, requiresRemovals97, providesRemovals100, requiredPredicatesRemovals103, query106, inputAdditions109, inputRemovals112, outputAdditions115, outputRemovals118, requiredPredicates155, providedCapabilities158, builderQueries160, unitQuery163, postinputcondExpr131, providesRemovals134, outputAnnotationAdditions137, sourceRemovals140, sourceAdditions142, sourceAnnotationAdditions145, pathVector148, pathPattern150, requiredCapabilities153, beeModels185, parent188, imports166, functions168, concerns170, propertySets173, repositories176, providers179, defaultProperties182, pathVectors213, unit190, providedCapabilities192, requiredCapabilities194, metaRequiredCapabilities196, unitRequiredCapabilities199, requirement202, providedCapability205, builderReference208, requiredCapability210, repoSwitch223, branches224, options226, buildUnitRepository229, repositories215, beeModels217, unit219, context221, delegate244, address232, include235, exclude238, branchPoint241, requiredPredicate251, expr246, repository249, hostRequirements267, withExpr253, condExpr254, requiredCapability256, requiredCapabilityDeclaration258, requiredCapabilityReference260, context262, buildUnits264},
    generalizations={gen_build_BuildUnit_BFunctionContainer, gen_build_BuildUnit_IRequiredCapabilityContainer, gen_build_BuildUnit_IProvidedCapabilityContainer, gen_build_BuildUnit_IVarName, gen_build_BuildUnit_VersionedCapability, gen_build_IBuilder_IProvidedCapabilityContainer, gen_build_IBuilder_IFunction, gen_build_VersionedCapability_Capability, gen_build_RequiredCapability_Capability, gen_build_BuilderInputDecorator_BuilderInput, gen_build_BuilderCall_BuilderInput, gen_build_Capability_INamedValue, gen_build_BestFoundUnitProvider_CompoundUnitProvider, gen_build_BuildConcernContext_BConcernContext, gen_build_BuildConcernContext_IProvidedCapabilityContainer, gen_build_RequiresPredicate_BExpression, gen_build_UnitProvider_BExpression, gen_build_RepositoryUnitProvider_UnitProvider, gen_build_CompoundUnitProvider_UnitProvider, gen_build_FirstFoundUnitProvider_CompoundUnitProvider, gen_build_UnitNamePredicate_CapabilityPredicate, gen_build_BuilderNamePredicate_BExpression, gen_build_InputPredicate_BExpression, gen_build_CapabilityPredicate_BExpression, gen_build_ImplementsPredicate_BExpression, gen_build_ProvidesPredicate_BExpression, gen_build_UnitConcernContext_BuildConcernContext, gen_build_UnitConcernContext_IRequiredCapabilityContainer, gen_build_BuilderConcernContext_BuildConcernContext, gen_build_Builder_B3Function, gen_build_Builder_IBuilder, gen_build_PathGroupPredicate_BExpression, gen_build_AliasedRequiredCapability_RequiredCapability, gen_build_BuilderJava_BJavaFunction, gen_build_BuilderJava_IBuilder, gen_build_BuilderWrapper_BFunctionWrapper, gen_build_BuilderWrapper_IBuilder, gen_build_BeeModel_BChainedExpression, gen_build_BeeModel_IBuildUnitContainer, gen_build_BuildResultContext_BInnerContext, gen_build_OutputPredicate_PathGroupPredicate, gen_build_SourcePredicate_PathGroupPredicate, gen_build_EffectiveFacade_IEffectiveFacade, gen_build_EffectiveUnitFacade_EffectiveFacade, gen_build_EffectiveRequirementFacade_EffectiveFacade, gen_build_EffectiveCapabilityFacade_EffectiveFacade, gen_build_BuildSet_ITypedValueContainer, gen_build_SwitchUnitProvider_UnitProvider, gen_build_Repository_BExpression, gen_build_BuildUnitRepository_IBuildUnitRepository, gen_build_CompoundBuildUnitRepository_BuildUnitRepository, gen_build_CompoundFirstFoundRepository_CompoundBuildUnitRepository, gen_build_ExecutionStackRepository_BuildUnitRepository, gen_build_BeeModelRepository_BuildUnitRepository, gen_build_UnitResolutionInfo_ResolutionInfo, gen_build_DelegatingUnitProvider_UnitProvider, gen_build_BuildCallOnSelectedRequirements_BuildCallMultiple, gen_build_BuilderInputNameDecorator_BuilderInputDecorator, gen_build_BuilderInputNameDecorator_INamedValue, gen_build_BuilderInputContextDecorator_BuilderInputDecorator, gen_build_UnitRepositoryDescription_BuildUnitRepository, gen_build_UnitParameterDeclaration_BParameterDeclaration, gen_build_BuilderInputCondition_BuilderInputDecorator, gen_build_BuildCallMultiple_BuilderCall, gen_build_BuildCallSingle_BuilderCall, gen_build_BuildCallOnDeclaredRequirement_BuildCallSingle, gen_build_BuildCallOnReferencedRequirement_BuildCallSingle, gen_build_BuilderInputGroup_BuilderInputDecorator, gen_build_EffectiveBuilderCallFacade_BuilderCallFacade, gen_build_EffectiveBuilderCallFacade_IEffectiveFacade},
    metadata=None
)
