...
class build_Branch:
    ...
    def __init__(self, name: str, documentation: str, branchPointType: str, mergeStrategy: str, checkout: str, acceptDirty: str, update: str, replace: str, build_Branch: "build_Repository" = None, build_Branch236: set["build_BNamePredicate"] = None, build_Branch239: set["build_BNamePredicate"] = None, build_Branch242: "build_BExpression" = None):
        self.name = name
...
class build_BuildUnitRepository(IBuildUnitRepository):
    ...
    def __init__(self):
        ...
        pass
    def initialize(self, build_repository, build_ctx, build_options):
        # TODO: Implement initialize method
        pass

    def resolve(self, build_options, build_requiredCapability, build_ctx) :
...
class build_BeeModel(BChainedExpression, IBuildUnitContainer):
    ...
    def __init__(self, build_BeeModel186: "build_BeeHive" = None, build_BeeModel: set["build_IType"] = None, build_BeeModel169: set["build_IFunction"] = None, build_BeeModel171: set["build_BConcern"] = None, build_BeeModel174: set["build_BPropertySet"] = None, build_BeeModel177: set["build_Repository"] = None, build_BeeModel180: set["build_FirstFoundUnitProvider"] = None, build_BeeModel183: "build_BPropertySet" = None, build_BeeModel218: "build_BeeModelRepository" = None):
...
class build_BuilderJava(BJavaFunction, IBuilder):
...
class build_BuilderConcernContext(BuildConcernContext):
    ...
    def __init__(self, varArgs: bool, matchParameters: bool, removePreCondition: bool, removePostCondition: bool, removePostInputCondition: bool, outputAnnotationsRemovals: str, sourceAnnotationsRemovals: str, build_BuilderConcernContext126: "build_BExpression" = None, build_BuilderConcernContext129: "build_BExpression" = None, build_BuilderConcernContext: "build_UnitConcernContext" = None, build_BuilderConcernContext121: "build_BExpression" = None, build_BuilderConcernContext124: set["build_BParameterPredicate"] = None, build_BuilderConcernContext107: "build_BExpression" = None, build_BuilderConcernContext110: set["build_BuilderInput"] = None, build_BuilderConcernContext113: set["build_InputPredicate"] = None, build_BuilderConcernContext116: set["build_ConditionalPathVector"] = None, build_BuilderConcernContext119: set["build_OutputPredicate"] = None, build_BuilderConcernContext132: "build_BExpression" = None, build_BuilderConcernContext135: set["build_ProvidesPredicate"] = None, build_BuilderConcernContext138: "build_BPropertySet" = None, build_BuilderConcernContext141: set["build_SourcePredicate"] = None, build_BuilderConcernContext143: set["build_ConditionalPathVector"] = None, build_BuilderConcernContext146: "build_BPropertySet" = None):
...
class build_CapabilityPredicate(BExpression):
    ...
    def __init__(self, versionRange: str, build_CapabilityPredicate85: "build_ProvidesPredicate" = None, build_CapabilityPredicate89: "build_InputPredicate" = None, build_CapabilityPredicate: "build_RequiresPredicate" = None, build_CapabilityPredicate78: "build_BNamePredicate" = None, build_CapabilityPredicate80: "build_BNamePredicate" = None, build_CapabilityPredicate105: "build_UnitConcernContext" = None, build_CapabilityPredicate157: "build_IRequiredCapabilityContainer" = None, build_CapabilityPredicate252: "build_BuildCallOnSelectedRequirements" = None):
...
class build_UnitParameterDeclaration(BParameterDeclaration):
    ...
    def hasCorrectState(self, build_chain, build_map) :
...
class IProvidedCapabilityContainer:
    ...
    pass
class build_IBuilder(IFunction, IProvidedCapabilityContainer):

    def __init__(self, unitType: str, build_IBuilder: "build_BuildUnit" = None, build_IBuilder25: "build_BExpression" = None, build_IBuilder27: "build_BExpression" = None, build_IBuilder30: "build_BuilderInput" = None, build_IBuilder32: "build_PathGroup" = None, build_IBuilder34: "build_BPropertySet" = None, build_IBuilder37: "build_BExpression" = None, build_IBuilder40: "build_UnitParameterDeclaration" = None, build_IBuilder42: "build_PathGroup" = None):
...
class BFunctionContainer:
    ...
    pass
class build_BuildUnit(VersionedCapability, BFunctionContainer, IRequiredCapabilityContainer, IVarName, IProvidedCapabilityContainer):

    def __init__(self, documentation: str, platformFilter: str, executionMode: str, sourceLocation: str, outputLocation: str, build_BuildUnit: set["build_IBuilder"] = None, build_BuildUnit23: set["build_FragmentHost"] = None, build_BuildUnit2: set["build_RequiredCapability"] = None, build_BuildUnit4: set["build_IType"] = None, build_BuildUnit6: set["build_BConcern"] = None, build_BuildUnit8: "build_BPropertySet" = None, build_BuildUnit10: set["build_Synchronization"] = None, build_BuildUnit12: set["build_Repository"] = None, build_BuildUnit14: set["build_ContainerConfiguration"] = None, build_BuildUnit16: set["build_BPropertySet"] = None, build_BuildUnit19: set["build_FirstFoundUnitProvider"] = None, build_BuildUnit21: "build_IBuildUnitContainer" = None, build_BuildUnit191: "build_EffectiveUnitFacade" = None, build_BuildUnit220: "build_UnitResolutionInfo" = None, build_BuildUnit266: "build_IBuildUnitContainer" = None):
        self.documentation = documentation
