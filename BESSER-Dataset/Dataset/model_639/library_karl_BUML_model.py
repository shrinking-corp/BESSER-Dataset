...
domain_model = DomainModel(
    name="library",
    types={library_Borrowable, library_Customer, library_Author, library_Book, library_CD, Borrowable, library_Magazine, library_Library},
    associations={borrowables0, customers1, authors2, borrowed4, library6, writtenBooks7, library8, authors11},
