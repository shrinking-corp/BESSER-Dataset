...
class sgraph_CompositeElement(ABC):
    ...
    pass
class sgraph_Transition(DocumentedElement, SpecificationElement, Reaction):
...
class CompositeElement:
    ...
    pass
class sgraph_State(RegularState, SpecificationElement, ReactiveElement, ScopedElement, DocumentedElement, CompositeElement):
...
class sgraph_Statechart(SpecificationElement, NamedElement, ReactiveElement, ScopedElement, DocumentedElement, CompositeElement):
