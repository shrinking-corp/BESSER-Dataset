...
class sgraph_FinalState(Vertex):
    ...
    pass
class sgraph_State(ScopedElement, Vertex, ReactiveElement, ExpressionElement):

    def __init__(self, leaf: bool, orthogonal: bool, submachine: bool, simple: bool, composite: bool, sgraph_State: set["sgraph_Region"] = None, sgraph_State28: "sgraph_Statechart" = None):
        self.leaf = leaf
...
class sgraph_Pseudostate(Vertex):
    ...
    pass
class sgraph_Transition(ExpressionElement, Reaction):
...
class NamedElement:
    ...
    pass
class sgraph_Statechart(NamedElement, ScopedElement, ExpressionElement, ReactiveElement):
