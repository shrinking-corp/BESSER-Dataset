...
from python_code import (
    tDT4250_asssignment1_2_Department,
...
def test_hyp_tdt4250_asssignment1_2_department_is_not_abstract():
    assert not inspect.isabstract(tDT4250_asssignment1_2_Department)


def test_hyp_tdt4250_asssignment1_2_department_constructor_exists():
    assert callable(tDT4250_asssignment1_2_Department.__init__)


def test_hyp_tdt4250_asssignment1_2_department_constructor_args():
    sig = inspect.signature(tDT4250_asssignment1_2_Department.__init__)
...
tDT4250_asssignment1_2_Department_strategy = st.builds(
    tDT4250_asssignment1_2_Department,
    Name=
        safe_text
)
...
@given(instance=tDT4250_asssignment1_2_Department_strategy)
def test_hyp_tdt4250_asssignment1_2_department_Name_setter(instance):
...
def test_tDT4250_asssignment1_2_Department_Name_value_roundtrip():
    instance = tDT4250_asssignment1_2_Department(Name="sample_text")
    assert instance.Name == "sample_text"
    instance.Name = "sample_text_2"
    assert instance.Name == "sample_text_2"
...
def test_assoc_course18_link_reassign_clear():
    a = tDT4250_asssignment1_2_Department(Name="sample_text")
    b1 = tDT4250_asssignment1_2_Course(Code="sample_text", Credits=3.14, ExamDate="sample_text", Name="sample_text", StartDate="sample_text")
    b2 = tDT4250_asssignment1_2_Course(Code="sample_text_2", Credits=9.99, ExamDate="sample_text_2", Name="sample_text_2", StartDate="sample_text_2")
    _safe_set(a, 'tDT4250_asssignment1_2_Department', {b1})
    assert _is_linked(a, 'tDT4250_asssignment1_2_Department', b1)
    if hasattr(b1, 'tDT4250_asssignment1_2_Course19'):
        assert _is_linked(b1, 'tDT4250_asssignment1_2_Course19', a)
    _safe_set(a, 'tDT4250_asssignment1_2_Department', {b2})
    assert _is_linked(a, 'tDT4250_asssignment1_2_Department', b2)
    if hasattr(b1, 'tDT4250_asssignment1_2_Course19'):
        assert not _is_linked(b1, 'tDT4250_asssignment1_2_Course19', a)
    if hasattr(b2, 'tDT4250_asssignment1_2_Course19'):
        assert _is_linked(b2, 'tDT4250_asssignment1_2_Course19', a)
    _safe_set(a, 'tDT4250_asssignment1_2_Department', set())
    assert not _is_linked(a, 'tDT4250_asssignment1_2_Department', b2)
    if hasattr(b2, 'tDT4250_asssignment1_2_Course19'):
        assert not _is_linked(b2, 'tDT4250_asssignment1_2_Course19', a)


def test_assoc_program20_link_reassign_clear():
    a = tDT4250_asssignment1_2_Program(Credits="sample_text", Name="sample_text")
    b1 = tDT4250_asssignment1_2_Department(Name="sample_text")
    b2 = tDT4250_asssignment1_2_Department(Name="sample_text_2")
    _safe_set(a, 'tDT4250_asssignment1_2_Program22', b1)
    assert _is_linked(a, 'tDT4250_asssignment1_2_Program22', b1)
    if hasattr(b1, 'tDT4250_asssignment1_2_Department21'):
        assert _is_linked(b1, 'tDT4250_asssignment1_2_Department21', a)
    _safe_set(a, 'tDT4250_asssignment1_2_Program22', b2)
    assert _is_linked(a, 'tDT4250_asssignment1_2_Program22', b2)
    if hasattr(b1, 'tDT4250_asssignment1_2_Department21'):
        assert not _is_linked(b1, 'tDT4250_asssignment1_2_Department21', a)
    if hasattr(b2, 'tDT4250_asssignment1_2_Department21'):
        assert _is_linked(b2, 'tDT4250_asssignment1_2_Department21', a)
    _safe_set(a, 'tDT4250_asssignment1_2_Program22', None)
    assert not _is_linked(a, 'tDT4250_asssignment1_2_Program22', b2)
    if hasattr(b2, 'tDT4250_asssignment1_2_Department21'):
        assert not _is_linked(b2, 'tDT4250_asssignment1_2_Department21', a)
...
tDT4250_asssignment1_2_Department_strategy = st.builds(tDT4250_asssignment1_2_Department, Name=safe_text)
@given(instance=tDT4250_asssignment1_2_Department_strategy)
@settings(max_examples=25)
def test_tDT4250_asssignment1_2_Department_instantiation(instance):
    assert isinstance(instance, tDT4250_asssignment1_2_Department)
