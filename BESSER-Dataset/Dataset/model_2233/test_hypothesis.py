...
def test_tdt4250_asssignment1_2_department_is_not_abstract():
    assert not inspect.isabstract(tDT4250_asssignment1_2_Department)


def test_tdt4250_asssignment1_2_department_constructor_exists():
    assert callable(tDT4250_asssignment1_2_Department.__init__)


def test_tdt4250_asssignment1_2_department_constructor_args():
    sig = inspect.signature(tDT4250_asssignment1_2_Department.__init__)
    params = list(sig.parameters.keys())
    assert "Name" in params, "Missing parameter 'Name'"

def test_tdt4250_asssignment1_2_department_has_Name():
    assert hasattr(tDT4250_asssignment1_2_Department, "Name")
    descriptor = None
    for klass in tDT4250_asssignment1_2_Department.__mro__:
...
@given(instance=tDT4250_asssignment1_2_Department_strategy)
def test_tdt4250_asssignment1_2_department_Name_setter(instance):
