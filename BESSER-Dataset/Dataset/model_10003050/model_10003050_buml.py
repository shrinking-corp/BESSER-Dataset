...
Employee.attributes={Employee_Emp_ContactNo, Employee_Emp_DOB, Employee_Emp_Name, Employee_Emp_Salary, Employee_Emp_Department, Employee_Emp_Address, Employee_Emp_NIC, Employee_Emp_Email, Employee_Emp_Date_Of_Joint, Employee_Emp_Id, Employee_Emp_Position}
...
Salary.attributes={Salary_Sly_Decrement, Salary_Sly_Netgross, Salary_OverTime, Salary_Sly_Increment, Salary_Sly_Basic, Salary_Emp_Id}
...
Leave.attributes={Leave_Leave_NoOfDays, Leave_leave_id, Leave_Leave_StartDate, Leave_Leave_EndDate, Leave_Leave_Status, Leave_Leave_detail, Leave_Emp_Id, Leave_Leave_ApplyDate, Leave_Leave_Title}
...
domain_model = DomainModel(
    name="f90b795e_5369_4591_80ab_0e6bbfd4d5c0",
    ...
    associations={Employee_Attendance, Employee_Salary, Employee_Login, Employee_Logout, Employee_Leave},
    generalizations={},
    metadata=None
)
