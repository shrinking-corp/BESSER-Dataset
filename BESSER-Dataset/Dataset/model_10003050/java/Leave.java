...
public class Leave  {
    ...
    public Leave(
        LocalDate Leave_EndDate,        LocalDate Leave_ApplyDate,        int Leave_NoOfDays,        LocalDate Leave_StartDate,        int leave_id,        String Leave_Title,        String Leave_Status,        int Emp_Id,        String Leave_detail    ) {
