...
def test_assoc_arraysHeap172_link_reassign_clear():
...
def test_assoc_instance211_link_reassign_clear():
    a = miniJava_ArrayInstance(size=7)
    b1 = miniJava_ArrayRefValue()
    b2 = miniJava_ArrayRefValue()
    _safe_set(a, 'miniJava_ArrayInstance212', b1)
    assert _is_linked(a, 'miniJava_ArrayInstance212', b1)
    if hasattr(b1, 'miniJava_ArrayRefValue'):
        assert _is_linked(b1, 'miniJava_ArrayRefValue', a)
    _safe_set(a, 'miniJava_ArrayInstance212', b2)
    assert _is_linked(a, 'miniJava_ArrayInstance212', b2)
    if hasattr(b1, 'miniJava_ArrayRefValue'):
    ...
    _safe_set(a, 'miniJava_ArrayInstance212', None)
    assert not _is_linked(a, 'miniJava_ArrayInstance212', b2)
    if hasattr(b2, 'miniJava_ArrayRefValue'):
...
def test_assoc_outputStream170_link_reassign_clear():
    ...
    if hasattr(b1, 'miniJava_State171'):
        assert _is_linked(b1, 'miniJava_State171', a)
    _safe_set(a, 'miniJava_OutputStream', b2)
    assert _is_linked(a, 'miniJava_OutputStream', b2)
    if hasattr(b1, 'miniJava_State171'):
        assert not _is_linked(b1, 'miniJava_State171', a)
    if hasattr(b2, 'miniJava_State171'):
        assert _is_linked(b2, 'miniJava_State171', a)
    _safe_set(a, 'miniJava_OutputStream', None)
    assert not _is_linked(a, 'miniJava_OutputStream', b2)
    if hasattr(b2, 'miniJava_State171'):
        assert not _is_linked(b2, 'miniJava_State171', a)
...
def test_assoc_type203_link_reassign_clear():
    a = miniJava_Clazz(isabstract=True)
    b1 = miniJava_ObjectInstance()
    b2 = miniJava_ObjectInstance()
    _safe_set(a, 'miniJava_Clazz205', b1)
    assert _is_linked(a, 'miniJava_Clazz205', b1)
    if hasattr(b1, 'miniJava_ObjectInstance204'):
        assert _is_linked(b1, 'miniJava_ObjectInstance204', a)
    _safe_set(a, 'miniJava_Clazz205', b2)
    assert _is_linked(a, 'miniJava_Clazz205', b2)
    if hasattr(b1, 'miniJava_ObjectInstance204'):
        assert not _is_linked(b1, 'miniJava_ObjectInstance204', a)
    if hasattr(b2, 'miniJava_ObjectInstance204'):
        assert _is_linked(b2, 'miniJava_ObjectInstance204', a)
    _safe_set(a, 'miniJava_Clazz205', None)
    assert not _is_linked(a, 'miniJava_Clazz205', b2)
    if hasattr(b2, 'miniJava_ObjectInstance204'):
        assert not _is_linked(b2, 'miniJava_ObjectInstance204', a)


def test_assoc_value206_link_reassign_clear():
    a = miniJava_ArrayInstance(size=7)
    b1 = miniJava_Value()
    b2 = miniJava_Value()
    _safe_set(a, 'miniJava_ArrayInstance207', {b1})
    assert _is_linked(a, 'miniJava_ArrayInstance207', b1)
    if hasattr(b1, 'miniJava_Value208'):
        assert _is_linked(b1, 'miniJava_Value208', a)
    _safe_set(a, 'miniJava_ArrayInstance207', {b2})
    assert _is_linked(a, 'miniJava_ArrayInstance207', b2)
    if hasattr(b1, 'miniJava_Value208'):
        assert not _is_linked(b1, 'miniJava_Value208', a)
    if hasattr(b2, 'miniJava_Value208'):
        assert _is_linked(b2, 'miniJava_Value208', a)
    _safe_set(a, 'miniJava_ArrayInstance207', set())
    assert not _is_linked(a, 'miniJava_ArrayInstance207', b2)
    if hasattr(b2, 'miniJava_Value208'):
        assert not _is_linked(b2, 'miniJava_Value208', a)
