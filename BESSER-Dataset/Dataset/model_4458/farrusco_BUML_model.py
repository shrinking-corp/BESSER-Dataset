...
farrusco_Filho = Class(name="farrusco_Filho")
farrusco_Irmao = Class(name="farrusco_Irmao")
Node = Class(name="Node")
farrusco_Prioridade = Class(name="farrusco_Prioridade")
Behavior = Class(name="Behavior")
farrusco_Paralelo = Class(name="farrusco_Paralelo")
farrusco_Sequencial = Class(name="farrusco_Sequencial")
farrusco_Behavior = Class(name="farrusco_Behavior")
farrusco_Bumpers = Class(name="farrusco_Bumpers")
farrusco_Espera = Class(name="farrusco_Espera")
farrusco_Actuate = Class(name="farrusco_Actuate", is_abstract=True)
farrusco_Motor = Class(name="farrusco_Motor")
Actuate = Class(name="Actuate")
farrusco_AlterarEstado = Class(name="farrusco_AlterarEstado")
...
farrusco_Distancia = Class(name="farrusco_Distancia")
Condition = Class(name="Condition")
farrusco_Servo = Class(name="farrusco_Servo")
...
farrusco_AlterarEstado.attributes={farrusco_AlterarEstado_Alterar_Falha, farrusco_AlterarEstado_Alterar_Sucesso, farrusco_AlterarEstado_Nome, farrusco_AlterarEstado_Alterar_Decorrer}
...
farrusco_Servo.attributes={farrusco_Servo_Posicao_Minima, farrusco_Servo_Posicao_Maxima, farrusco_Servo_Nome, farrusco_Servo_Passo_a_Passo}
...
domain_model = DomainModel(
    name="farrusco",
    types={farrusco_Robot, farrusco_Node, farrusco_Filho, farrusco_Irmao, Node, farrusco_Prioridade, Behavior, farrusco_Paralelo, farrusco_Sequencial, farrusco_Behavior, farrusco_Bumpers, farrusco_Espera, farrusco_Actuate, farrusco_Motor, Actuate, farrusco_AlterarEstado, farrusco_Action, farrusco_Condition, Action, farrusco_Distancia, Condition, farrusco_Servo, farrusco_LED, EstadoDaLuz, EstadoSucesso, EstadoFalha, EstadoDecorrer, EscolhaBumper, TipoDistancia},
    associations={nodes0, child1, next3, target13, source5, target7, source10},
    generalizations={gen_farrusco_Behavior_Node, gen_farrusco_Prioridade_Behavior, gen_farrusco_Paralelo_Behavior, gen_farrusco_Sequencial_Behavior, gen_farrusco_Bumpers_Condition, gen_farrusco_Espera_Condition, gen_farrusco_Actuate_Action, gen_farrusco_Motor_Actuate, gen_farrusco_AlterarEstado_Behavior, gen_farrusco_Action_Node, gen_farrusco_Condition_Action, gen_farrusco_Distancia_Condition, gen_farrusco_Servo_Actuate, gen_farrusco_LED_Actuate},
    metadata=None
)
