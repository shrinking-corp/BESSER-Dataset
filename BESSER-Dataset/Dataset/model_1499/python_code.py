...
class PetriNet_ReseauPetri:
    ...
    def __init__(self, name: str, PetriNet_ReseauPetri: set["PetriNet_PetriElement"] = None, PetriNet_ReseauPetri7: set["PetriNet_Arc"] = None):
        self.name = name
...
class PetriNet_PetriElement:
    ...
    def __init__(self, name: str, PetriNet_PetriElement: "PetriNet_Arc" = None, PetriNet_PetriElement3: "PetriNet_Arc" = None, PetriNet_PetriElement5: "PetriNet_ReseauPetri" = None):
        self.name = name
...
class PetriNet_Arc:
    ...
    def __init__(self, poids: str, type: str, PetriNet_Arc: "PetriNet_PetriElement" = None, PetriNet_Arc2: "PetriNet_PetriElement" = None, PetriNet_Arc8: "PetriNet_ReseauPetri" = None):
        self.poids = poids
        self.type = type
