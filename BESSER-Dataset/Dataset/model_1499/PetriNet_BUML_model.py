...
PetriNet_Place.attributes={PetriNet_Place_borne, PetriNet_Place_nbJeton}
...
domain_model = DomainModel(
    name="PetriNet",
    types={PetriNet_Place, PetriElement, PetriNet_Transition, PetriNet_Arc, PetriNet_PetriElement, PetriNet_ReseauPetri, ArcType},
    associations={debut0, fin1, elements4, arcs6},
