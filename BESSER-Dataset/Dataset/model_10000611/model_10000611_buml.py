...
Department.attributes={Department_teachers__, Department_students__, Department_course, Department_hod}
...
domain_model = DomainModel(
    name="_4a632af0_429d_4833_af7c_0af84016517e",
    types={Student, Employee_Interface, Teacher, HOD, Department, Course, Authentication, Access_Information, Attendance, Subject, Admin, Interface_Interface},
    associations={Access_Information_Department, Department_Course, Course_Subject, Department_Student, Department_Employee, Student_Access_Information, Employee_Access_Information, Admin_Student, Admin_Employee, Access_Information_Attendance},
    generalizations={},
    metadata=None
)
