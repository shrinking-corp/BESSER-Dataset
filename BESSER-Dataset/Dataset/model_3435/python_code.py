...
class school_School:
    ...
    def __init__(self, name: str, school_School3: set["school_Classroom"] = None, school_School: "school_Diagram" = None):
        self.name = name
...
class school_Student:
    ...
    def __init__(self, name: str, school_Student7: "school_Student" = None, school_Student5: set["school_Student"] = None, school_Student: "school_Classroom" = None):
        self.name = name
