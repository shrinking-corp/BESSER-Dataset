...
class mm_rdb_TypeChangeToColumn(Operation):
    ...
    def __init__(self, newType: str, mm_rdb_TypeChangeToColumn69: "TableColumn" = None, mm_rdb_TypeChangeToColumn: "Table" = None, Operation: "mm_rdb_ModelRoot" = None):
    ...
    def typeChangeToColumn(self, mm_changedTable, mm_changedTypeColumn, mm_newType) :
...
class mm_rdb_CreateTable(Operation):
    ...
    def createTable(self, mm_tableColumns, mm_primaryKey, mm_tableName, mm_generateID, mm_tableConstraints) :
...
class mm_rdb_AddColumn(Operation):
    ...
    def addColumn(self, mm_newColumnName, mm_columnConstrains, mm_changedTable) :
...
class mm_rdb_Table(rdb_DbObject, rdb_Relation):
    ...
    def __init__(self, owningTable: set["TableConstraint"] = None, tables: "Schema" = None, mm_rdb_Table: "PrimaryKey" = None, _owningTable: set["TableColumn"] = None):
