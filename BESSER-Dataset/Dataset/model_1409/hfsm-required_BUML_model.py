...
# Classes
hfsmReq_State = Class(name="hfsmReq_State")
AbstractState = Class(name="AbstractState")
hfsmReq_Region = Class(name="hfsmReq_Region")
NamedElement = Class(name="NamedElement")
hfsmReq_AbstractState = Class(name="hfsmReq_AbstractState")
hfsmReq_Transition = Class(name="hfsmReq_Transition")
hfsmReq_NamedElement = Class(name="hfsmReq_NamedElement")
...
domain_model = DomainModel(
    name="hfsmReq",
    types={hfsmReq_State, AbstractState, hfsmReq_Region, NamedElement, hfsmReq_AbstractState, hfsmReq_Transition, hfsmReq_NamedElement},
    associations={ownedRegions0, ownerState1, subvertex4, incoming6, ownerRegion11, target14, source17, outgoing8},
