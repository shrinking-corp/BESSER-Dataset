...
def test_hyp_hfsmreq_namedelement_is_not_abstract():
    assert not inspect.isabstract(hfsmReq_NamedElement)


def test_hyp_hfsmreq_namedelement_constructor_exists():
    assert callable(hfsmReq_NamedElement.__init__)


def test_hyp_hfsmreq_namedelement_constructor_args():
...
def test_hyp_hfsmreq_abstractstate_is_not_abstract():
    assert not inspect.isabstract(hfsmReq_AbstractState)


def test_hyp_hfsmreq_abstractstate_constructor_exists():
    assert callable(hfsmReq_AbstractState.__init__)


def test_hyp_hfsmreq_abstractstate_constructor_args():
    sig = inspect.signature(hfsmReq_AbstractState.__init__)
    params = list(sig.parameters.keys())



def test_hyp_hfsmreq_transition_is_not_abstract():
    assert not inspect.isabstract(hfsmReq_Transition)


def test_hyp_hfsmreq_transition_constructor_exists():
    assert callable(hfsmReq_Transition.__init__)


def test_hyp_hfsmreq_transition_constructor_args():
    sig = inspect.signature(hfsmReq_Transition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_hfsmreq_region_is_not_abstract():
    assert not inspect.isabstract(hfsmReq_Region)


def test_hyp_hfsmreq_region_constructor_exists():
    assert callable(hfsmReq_Region.__init__)


def test_hyp_hfsmreq_region_constructor_args():
...
def test_hyp_hfsmreq_state_is_not_abstract():
    assert not inspect.isabstract(hfsmReq_State)


def test_hyp_hfsmreq_state_constructor_exists():
    assert callable(hfsmReq_State.__init__)


def test_hyp_hfsmreq_state_constructor_args():
...
def test_hyp_hfsmreq_namedelement_name_setter(instance):
