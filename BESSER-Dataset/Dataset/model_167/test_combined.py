...
def test_hyp_lit_petrinets_net_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_lit_petriNets_Net_name_value_roundtrip():
    instance = lit_petriNets_Net(name="sample_text")
...
def test_assoc_net3_link_reassign_clear():
    ...
    b1 = lit_petriNets_Net(name="sample_text")
    b2 = lit_petriNets_Net(name="sample_text_2")
...
lit_petriNets_Net_strategy = st.builds(lit_petriNets_Net, name=safe_text)
@given(instance=lit_petriNets_Net_strategy)
