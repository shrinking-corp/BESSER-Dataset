...
# Classes
logo_Instruction = Class(name="logo_Instruction")
logo_Backward = Class(name="logo_Backward")
Instruction = Class(name="Instruction")
logo_Expression = Class(name="logo_Expression")
...
logo_PenDown = Class(name="logo_PenDown")
logo_PenUp = Class(name="logo_PenUp")
logo_Clear = Class(name="logo_Clear")
logo_Constant = Class(name="logo_Constant")
Expression = Class(name="Expression")
logo_ProcCall = Class(name="logo_ProcCall")
logo_ProcDeclaration = Class(name="logo_ProcDeclaration")
logo_Parameter = Class(name="logo_Parameter")
logo_Greater = Class(name="logo_Greater")
logo_Lower = Class(name="logo_Lower")
logo_Repeat = Class(name="logo_Repeat")
logo_While = Class(name="logo_While")
logo_ParameterCall = Class(name="logo_ParameterCall")
logo_Equals = Class(name="logo_Equals")
logo_Plus = Class(name="logo_Plus")
logo_Minus = Class(name="logo_Minus")
logo_Mult = Class(name="logo_Mult")
logo_Div = Class(name="logo_Div")
...
domain_model = DomainModel(
    name="logo",
    types={logo_Instruction, logo_Backward, Instruction, logo_Expression, logo_Forward, logo_Left, logo_LogoProgram, logo_Block, logo_If, logo_Right, logo_PenDown, logo_PenUp, logo_Clear, logo_Constant, Expression, logo_ProcCall, logo_ProcDeclaration, logo_Parameter, logo_Greater, logo_Lower, logo_Repeat, logo_While, logo_ParameterCall, logo_Equals, logo_Plus, logo_Minus, logo_Mult, logo_Div},
    associations={instructions0, steps1, steps2, instructions14, instructions17, condition19, thenPart21, angle4, angle6, declaration8, actualArgs9, args12, rhs41, lhs44, rhs46, lhs49, rhs51, elsePart24, condition27, block29, condition32, block34, parameter37, lhs39, rhs71, lhs54, rhs56, lhs59, rhs61, lhs64, rhs66, lhs69},
    generalizations={gen_logo_Backward_Instruction, gen_logo_Forward_Instruction, gen_logo_Left_Instruction, gen_logo_Block_Instruction, gen_logo_If_Instruction, gen_logo_Right_Instruction, gen_logo_PenDown_Instruction, gen_logo_PenUp_Instruction, gen_logo_Clear_Instruction, gen_logo_Constant_Expression, gen_logo_ProcCall_Instruction, gen_logo_ProcDeclaration_Instruction, gen_logo_Greater_Expression, gen_logo_Lower_Expression, gen_logo_Repeat_Instruction, gen_logo_While_Instruction, gen_logo_ParameterCall_Instruction, gen_logo_ParameterCall_Expression, gen_logo_Equals_Expression, gen_logo_Plus_Expression, gen_logo_Minus_Expression, gen_logo_Mult_Expression, gen_logo_Div_Expression},
    metadata=None
)
