...
class logo_Parameter:
    ...
    def __init__(self, name: str, logo_Parameter: "logo_ProcDeclaration" = None, logo_Parameter38: "logo_ParameterCall" = None):
        self.name = name
...
class logo_Left(Instruction):
    ...
    pass
class logo_ParameterCall(Expression, Instruction):
...
class logo_ProcDeclaration(Instruction):
    ...
    def __init__(self, name: str, logo_ProcDeclaration15: set["logo_Instruction"] = None, logo_ProcDeclaration: "logo_ProcCall" = None, logo_ProcDeclaration13: set["logo_Parameter"] = None):
        self.name = name
