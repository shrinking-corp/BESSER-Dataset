...
class Etunit_ErrorType:
    ...
    def __init__(self, expected: str, actual: str, mixed: str, Etunit_ErrorType: "Etunit_TestcaseType" = None):
...
class Etunit_Testsuite:
    ...
    def __init__(self, errors: str, time: str, timestamp: str, failures: str, name: str, skipped: str, tests: str, Etunit_Testsuite: "Etunit_DocumentRoot" = None, Etunit_Testsuite12: set["Etunit_TestcaseType"] = None):
        self.errors = errors
        self.time = time
...
class Etunit_DocumentRoot:
    ...
    def __init__(self, mixed: str, Etunit_DocumentRoot2: set["Etunit_EStringToStringMapEntry"] = None, Etunit_DocumentRoot5: set["Etunit_Testsuite"] = None, Etunit_DocumentRoot7: set["Etunit_TestsuitesType"] = None, Etunit_DocumentRoot: set["Etunit_EStringToStringMapEntry"] = None):
        self.mixed = mixed
