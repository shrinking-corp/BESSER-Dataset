...
def test_hyp_tool_groupmenu_is_not_abstract():
    assert not inspect.isabstract(tool_GroupMenu)


def test_hyp_tool_groupmenu_constructor_exists():
    assert callable(tool_GroupMenu.__init__)


def test_hyp_tool_groupmenu_constructor_args():
...
def test_hyp_diagram_description_enumlayoutvalue_is_not_abstract():
    assert not inspect.isabstract(diagram_description_EnumLayoutValue)


def test_hyp_diagram_description_enumlayoutvalue_constructor_exists():
    assert callable(diagram_description_EnumLayoutValue.__init__)


def test_hyp_diagram_description_enumlayoutvalue_constructor_args():
...
def test_hyp_enumlayoutvalue_is_not_abstract():
    assert not inspect.isabstract(EnumLayoutValue)


def test_hyp_enumlayoutvalue_constructor_exists():
    assert callable(EnumLayoutValue.__init__)


def test_hyp_enumlayoutvalue_constructor_args():
    sig = inspect.signature(EnumLayoutValue.__init__)
    params = list(sig.parameters.keys())



def test_hyp_enumoption_is_not_abstract():
    assert not inspect.isabstract(EnumOption)


def test_hyp_enumoption_constructor_exists():
    assert callable(EnumOption.__init__)


def test_hyp_enumoption_constructor_args():
    sig = inspect.signature(EnumOption.__init__)
    params = list(sig.parameters.keys())



def test_hyp_diagram_description_enumsetlayoutoption_is_not_abstract():
    assert not inspect.isabstract(diagram_description_EnumSetLayoutOption)


def test_hyp_diagram_description_enumsetlayoutoption_constructor_exists():
    assert callable(diagram_description_EnumSetLayoutOption.__init__)


def test_hyp_diagram_description_enumsetlayoutoption_constructor_args():
    sig = inspect.signature(diagram_description_EnumSetLayoutOption.__init__)
    params = list(sig.parameters.keys())



def test_hyp_diagram_description_enumlayoutoption_is_not_abstract():
    assert not inspect.isabstract(diagram_description_EnumLayoutOption)


def test_hyp_diagram_description_enumlayoutoption_constructor_exists():
    assert callable(diagram_description_EnumLayoutOption.__init__)


def test_hyp_diagram_description_enumlayoutoption_constructor_args():
...
def test_hyp_layoutoption_is_not_abstract():
    assert not inspect.isabstract(LayoutOption)


def test_hyp_layoutoption_constructor_exists():
    assert callable(LayoutOption.__init__)


def test_hyp_layoutoption_constructor_args():
    sig = inspect.signature(LayoutOption.__init__)
    params = list(sig.parameters.keys())



def test_hyp_diagram_description_integerlayoutoption_is_not_abstract():
    assert not inspect.isabstract(diagram_description_IntegerLayoutOption)


def test_hyp_diagram_description_integerlayoutoption_constructor_exists():
    assert callable(diagram_description_IntegerLayoutOption.__init__)


def test_hyp_diagram_description_integerlayoutoption_constructor_args():
...
def test_hyp_diagram_description_doublelayoutoption_is_not_abstract():
    assert not inspect.isabstract(diagram_description_DoubleLayoutOption)


def test_hyp_diagram_description_doublelayoutoption_constructor_exists():
    assert callable(diagram_description_DoubleLayoutOption.__init__)


def test_hyp_diagram_description_doublelayoutoption_constructor_args():
...
def test_hyp_diagram_description_stringlayoutoption_is_not_abstract():
    assert not inspect.isabstract(diagram_description_StringLayoutOption)


def test_hyp_diagram_description_stringlayoutoption_constructor_exists():
    assert callable(diagram_description_StringLayoutOption.__init__)


def test_hyp_diagram_description_stringlayoutoption_constructor_args():
...
def test_hyp_diagram_description_enumoption_is_not_abstract():
    assert not inspect.isabstract(diagram_description_EnumOption)


def test_hyp_diagram_description_enumoption_constructor_exists():
    assert callable(diagram_description_EnumOption.__init__)


def test_hyp_diagram_description_enumoption_constructor_args():
...
def test_hyp_diagram_description_booleanlayoutoption_is_not_abstract():
    assert not inspect.isabstract(diagram_description_BooleanLayoutOption)


def test_hyp_diagram_description_booleanlayoutoption_constructor_exists():
    assert callable(diagram_description_BooleanLayoutOption.__init__)


def test_hyp_diagram_description_booleanlayoutoption_constructor_args():
...
def test_hyp_diagram_description_layoutoption_is_not_abstract():
    assert not inspect.isabstract(diagram_description_LayoutOption)


def test_hyp_diagram_description_layoutoption_constructor_exists():
    assert callable(diagram_description_LayoutOption.__init__)


def test_hyp_diagram_description_layoutoption_constructor_args():
...
def test_hyp_diagram_description_customlayoutconfiguration_is_not_abstract():
    assert not inspect.isabstract(diagram_description_CustomLayoutConfiguration)


def test_hyp_diagram_description_customlayoutconfiguration_constructor_exists():
    assert callable(diagram_description_CustomLayoutConfiguration.__init__)


def test_hyp_diagram_description_customlayoutconfiguration_constructor_args():
...
def test_hyp_layoutoptiontarget_exists():
    # Check that the Enumeration exists
    assert LayoutOptionTarget is not None

def test_hyp_layoutoptiontarget_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_diagram_description_enumlayoutvalue_description_setter(instance):
...
@given(instance=diagram_description_EnumLayoutValue_strategy)
def test_hyp_diagram_description_enumlayoutvalue_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_diagram_description_integerlayoutoption_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_diagram_description_doublelayoutoption_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_diagram_description_stringlayoutoption_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_diagram_description_booleanlayoutoption_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_diagram_description_layoutoption_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
@given(instance=diagram_description_LayoutOption_strategy)
def test_hyp_diagram_description_layoutoption_description_setter(instance):
    original = instance.description
    instance.description = original
    assert instance.description == original
...
@given(instance=diagram_description_LayoutOption_strategy)
def test_hyp_diagram_description_layoutoption_targets_setter(instance):
...
@given(instance=diagram_description_LayoutOption_strategy)
def test_hyp_diagram_description_layoutoption_label_setter(instance):
    original = instance.label
    instance.label = original
    assert instance.label == original
...
@given(instance=diagram_DDiagram_strategy)
def test_hyp_diagram_ddiagram_isInShowingMode_setter(instance):
...
def test_hyp_diagram_description_customlayoutconfiguration_description_setter(instance):
    original = instance.description
    instance.description = original
    assert instance.description == original
...
@given(instance=diagram_description_CustomLayoutConfiguration_strategy)
def test_hyp_diagram_description_customlayoutconfiguration_label_setter(instance):
    original = instance.label
    instance.label = original
    assert instance.label == original
...
@given(instance=diagram_description_CustomLayoutConfiguration_strategy)
def test_hyp_diagram_description_customlayoutconfiguration_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
