...
def test_tool_groupmenu_is_not_abstract():
    assert not inspect.isabstract(tool_GroupMenu)


def test_tool_groupmenu_constructor_exists():
    assert callable(tool_GroupMenu.__init__)


def test_tool_groupmenu_constructor_args():
    sig = inspect.signature(tool_GroupMenu.__init__)
    params = list(sig.parameters.keys())
...
def test_diagram_description_enumlayoutvalue_is_not_abstract():
    assert not inspect.isabstract(diagram_description_EnumLayoutValue)


def test_diagram_description_enumlayoutvalue_constructor_exists():
    assert callable(diagram_description_EnumLayoutValue.__init__)


def test_diagram_description_enumlayoutvalue_constructor_args():
    sig = inspect.signature(diagram_description_EnumLayoutValue.__init__)
    params = list(sig.parameters.keys())
    assert "description" in params, "Missing parameter 'description'"
    assert "name" in params, "Missing parameter 'name'"

def test_diagram_description_enumlayoutvalue_has_description():
    assert hasattr(diagram_description_EnumLayoutValue, "description")
    descriptor = None
    for klass in diagram_description_EnumLayoutValue.__mro__:
        if "description" in klass.__dict__:
            descriptor = klass.__dict__["description"]
            break
    assert isinstance(descriptor, property)

def test_diagram_description_enumlayoutvalue_has_name():
    assert hasattr(diagram_description_EnumLayoutValue, "name")
    descriptor = None
    for klass in diagram_description_EnumLayoutValue.__mro__:
        if "name" in klass.__dict__:
            descriptor = klass.__dict__["name"]
...
def test_enumlayoutvalue_is_not_abstract():
    assert not inspect.isabstract(EnumLayoutValue)


def test_enumlayoutvalue_constructor_exists():
    assert callable(EnumLayoutValue.__init__)


def test_enumlayoutvalue_constructor_args():
    sig = inspect.signature(EnumLayoutValue.__init__)
    params = list(sig.parameters.keys())



def test_enumoption_is_not_abstract():
    assert not inspect.isabstract(EnumOption)


def test_enumoption_constructor_exists():
    assert callable(EnumOption.__init__)


def test_enumoption_constructor_args():
    sig = inspect.signature(EnumOption.__init__)
    params = list(sig.parameters.keys())



def test_diagram_description_enumsetlayoutoption_is_not_abstract():
    assert not inspect.isabstract(diagram_description_EnumSetLayoutOption)


def test_diagram_description_enumsetlayoutoption_constructor_exists():
    assert callable(diagram_description_EnumSetLayoutOption.__init__)


def test_diagram_description_enumsetlayoutoption_constructor_args():
    sig = inspect.signature(diagram_description_EnumSetLayoutOption.__init__)
    params = list(sig.parameters.keys())



def test_diagram_description_enumlayoutoption_is_not_abstract():
    assert not inspect.isabstract(diagram_description_EnumLayoutOption)


def test_diagram_description_enumlayoutoption_constructor_exists():
    assert callable(diagram_description_EnumLayoutOption.__init__)


def test_diagram_description_enumlayoutoption_constructor_args():
    sig = inspect.signature(diagram_description_EnumLayoutOption.__init__)
    params = list(sig.parameters.keys())
...
def test_layoutoption_is_not_abstract():
    assert not inspect.isabstract(LayoutOption)


def test_layoutoption_constructor_exists():
    assert callable(LayoutOption.__init__)


def test_layoutoption_constructor_args():
    sig = inspect.signature(LayoutOption.__init__)
    params = list(sig.parameters.keys())



def test_diagram_description_integerlayoutoption_is_not_abstract():
    assert not inspect.isabstract(diagram_description_IntegerLayoutOption)


def test_diagram_description_integerlayoutoption_constructor_exists():
    assert callable(diagram_description_IntegerLayoutOption.__init__)


def test_diagram_description_integerlayoutoption_constructor_args():
    sig = inspect.signature(diagram_description_IntegerLayoutOption.__init__)
    params = list(sig.parameters.keys())
    assert "value" in params, "Missing parameter 'value'"

def test_diagram_description_integerlayoutoption_has_value():
    assert hasattr(diagram_description_IntegerLayoutOption, "value")
    descriptor = None
    for klass in diagram_description_IntegerLayoutOption.__mro__:
        if "value" in klass.__dict__:
            descriptor = klass.__dict__["value"]
            break
    assert isinstance(descriptor, property)
...
def test_diagram_description_doublelayoutoption_is_not_abstract():
    assert not inspect.isabstract(diagram_description_DoubleLayoutOption)


def test_diagram_description_doublelayoutoption_constructor_exists():
    assert callable(diagram_description_DoubleLayoutOption.__init__)


def test_diagram_description_doublelayoutoption_constructor_args():
    sig = inspect.signature(diagram_description_DoubleLayoutOption.__init__)
    params = list(sig.parameters.keys())
    assert "value" in params, "Missing parameter 'value'"

def test_diagram_description_doublelayoutoption_has_value():
    assert hasattr(diagram_description_DoubleLayoutOption, "value")
    descriptor = None
    for klass in diagram_description_DoubleLayoutOption.__mro__:
        if "value" in klass.__dict__:
            descriptor = klass.__dict__["value"]
            break
    assert isinstance(descriptor, property)
...
def test_diagram_description_stringlayoutoption_is_not_abstract():
    assert not inspect.isabstract(diagram_description_StringLayoutOption)


def test_diagram_description_stringlayoutoption_constructor_exists():
    assert callable(diagram_description_StringLayoutOption.__init__)


def test_diagram_description_stringlayoutoption_constructor_args():
    sig = inspect.signature(diagram_description_StringLayoutOption.__init__)
    params = list(sig.parameters.keys())
    assert "value" in params, "Missing parameter 'value'"

def test_diagram_description_stringlayoutoption_has_value():
    assert hasattr(diagram_description_StringLayoutOption, "value")
    descriptor = None
    for klass in diagram_description_StringLayoutOption.__mro__:
        if "value" in klass.__dict__:
            descriptor = klass.__dict__["value"]
            break
    assert isinstance(descriptor, property)
...
def test_diagram_description_enumoption_is_not_abstract():
    assert not inspect.isabstract(diagram_description_EnumOption)


def test_diagram_description_enumoption_constructor_exists():
    assert callable(diagram_description_EnumOption.__init__)


def test_diagram_description_enumoption_constructor_args():
    sig = inspect.signature(diagram_description_EnumOption.__init__)
    params = list(sig.parameters.keys())
...
def test_diagram_description_booleanlayoutoption_is_not_abstract():
    assert not inspect.isabstract(diagram_description_BooleanLayoutOption)


def test_diagram_description_booleanlayoutoption_constructor_exists():
    assert callable(diagram_description_BooleanLayoutOption.__init__)


def test_diagram_description_booleanlayoutoption_constructor_args():
    sig = inspect.signature(diagram_description_BooleanLayoutOption.__init__)
    params = list(sig.parameters.keys())
    assert "value" in params, "Missing parameter 'value'"

def test_diagram_description_booleanlayoutoption_has_value():
    assert hasattr(diagram_description_BooleanLayoutOption, "value")
    descriptor = None
    for klass in diagram_description_BooleanLayoutOption.__mro__:
        if "value" in klass.__dict__:
            descriptor = klass.__dict__["value"]
            break
    assert isinstance(descriptor, property)
...
def test_diagram_description_layoutoption_is_not_abstract():
    assert not inspect.isabstract(diagram_description_LayoutOption)


def test_diagram_description_layoutoption_constructor_exists():
    assert callable(diagram_description_LayoutOption.__init__)


def test_diagram_description_layoutoption_constructor_args():
    sig = inspect.signature(diagram_description_LayoutOption.__init__)
    params = list(sig.parameters.keys())
    assert "id" in params, "Missing parameter 'id'"
    assert "description" in params, "Missing parameter 'description'"
...
def test_diagram_description_layoutoption_has_id():
    assert hasattr(diagram_description_LayoutOption, "id")
    descriptor = None
    for klass in diagram_description_LayoutOption.__mro__:
        if "id" in klass.__dict__:
            descriptor = klass.__dict__["id"]
            break
    assert isinstance(descriptor, property)

def test_diagram_description_layoutoption_has_description():
    assert hasattr(diagram_description_LayoutOption, "description")
    descriptor = None
    for klass in diagram_description_LayoutOption.__mro__:
        if "description" in klass.__dict__:
            descriptor = klass.__dict__["description"]
...
def test_diagram_description_layoutoption_has_targets():
    assert hasattr(diagram_description_LayoutOption, "targets")
    descriptor = None
    for klass in diagram_description_LayoutOption.__mro__:
...
def test_diagram_description_layoutoption_has_label():
    assert hasattr(diagram_description_LayoutOption, "label")
    descriptor = None
    for klass in diagram_description_LayoutOption.__mro__:
        if "label" in klass.__dict__:
            descriptor = klass.__dict__["label"]
...
def test_diagram_ddiagram_constructor_args():
    ...
    assert "isInShowingMode" in params, "Missing parameter 'isInShowingMode'"
...
def test_diagram_ddiagram_has_isInShowingMode():
    assert hasattr(diagram_DDiagram, "isInShowingMode")
    descriptor = None
    for klass in diagram_DDiagram.__mro__:
        if "isInShowingMode" in klass.__dict__:
            descriptor = klass.__dict__["isInShowingMode"]
            break
    assert isinstance(descriptor, property)
...
def test_diagram_description_customlayoutconfiguration_is_not_abstract():
    assert not inspect.isabstract(diagram_description_CustomLayoutConfiguration)


def test_diagram_description_customlayoutconfiguration_constructor_exists():
    assert callable(diagram_description_CustomLayoutConfiguration.__init__)


def test_diagram_description_customlayoutconfiguration_constructor_args():
    sig = inspect.signature(diagram_description_CustomLayoutConfiguration.__init__)
    params = list(sig.parameters.keys())
    assert "description" in params, "Missing parameter 'description'"
    assert "label" in params, "Missing parameter 'label'"
    assert "id" in params, "Missing parameter 'id'"

def test_diagram_description_customlayoutconfiguration_has_description():
    assert hasattr(diagram_description_CustomLayoutConfiguration, "description")
    descriptor = None
    for klass in diagram_description_CustomLayoutConfiguration.__mro__:
        if "description" in klass.__dict__:
            descriptor = klass.__dict__["description"]
            break
    assert isinstance(descriptor, property)

def test_diagram_description_customlayoutconfiguration_has_label():
    assert hasattr(diagram_description_CustomLayoutConfiguration, "label")
    descriptor = None
    for klass in diagram_description_CustomLayoutConfiguration.__mro__:
        if "label" in klass.__dict__:
            descriptor = klass.__dict__["label"]
...
def test_diagram_description_customlayoutconfiguration_has_id():
    assert hasattr(diagram_description_CustomLayoutConfiguration, "id")
    descriptor = None
    for klass in diagram_description_CustomLayoutConfiguration.__mro__:
        if "id" in klass.__dict__:
            descriptor = klass.__dict__["id"]
...
def test_diagram_style_nodestyledescription_has_forbiddenSides():
    assert hasattr(diagram_style_NodeStyleDescription, "forbiddenSides")
    descriptor = None
    for klass in diagram_style_NodeStyleDescription.__mro__:
...
def test_layoutoptiontarget_exists():
    # Check that the Enumeration exists
    assert LayoutOptionTarget is not None

def test_layoutoptiontarget_has_all_literals():
    # Collect the names of literals in this Enumeration
    enum_literals = [lit.name for lit in LayoutOptionTarget]
    expected_literals = [
        "NODE",
        "EDGE",
        "PARENT",
    ...
    # Check that all expected literals exist
    for lit_name in expected_literals:
        assert lit_name in enum_literals, f"Literal '' missing in LayoutOptionTarget"
...
tool_GroupMenu_strategy = st.builds(
    tool_GroupMenu,
)
...
diagram_description_EnumLayoutValue_strategy = st.builds(
    diagram_description_EnumLayoutValue,
    description=
        safe_text,
    name=
...
EnumLayoutValue_strategy = st.builds(
    EnumLayoutValue,
)
EnumOption_strategy = st.builds(
    EnumOption,
)
diagram_description_EnumSetLayoutOption_strategy = st.builds(
    diagram_description_EnumSetLayoutOption,
)
diagram_description_EnumLayoutOption_strategy = st.builds(
    diagram_description_EnumLayoutOption,
)
description_EndUserDocumentedElement_strategy = st.builds(
    description_EndUserDocumentedElement,
)
LayoutOption_strategy = st.builds(
    LayoutOption,
)
diagram_description_IntegerLayoutOption_strategy = st.builds(
    diagram_description_IntegerLayoutOption,
    value=
        st.integers()
)
diagram_description_DoubleLayoutOption_strategy = st.builds(
    diagram_description_DoubleLayoutOption,
    value=
        st.floats(min_value=0, max_value=1000,allow_nan=False, allow_infinity=False)
)
diagram_description_StringLayoutOption_strategy = st.builds(
    diagram_description_StringLayoutOption,
    value=
        safe_text
)
diagram_description_EnumOption_strategy = st.builds(
    diagram_description_EnumOption,
)
...
diagram_description_BooleanLayoutOption_strategy = st.builds(
    diagram_description_BooleanLayoutOption,
    value=
        st.booleans()
)
diagram_description_LayoutOption_strategy = st.builds(
    diagram_description_LayoutOption,
    id=
        safe_text,
    description=
...
diagram_description_CustomLayoutConfiguration_strategy = st.builds(
    diagram_description_CustomLayoutConfiguration,
    description=
        safe_text,
    label=
...
@given(instance=diagram_description_EnumLayoutValue_strategy)
def test_diagram_description_enumlayoutvalue_description_setter(instance):
...
@given(instance=diagram_description_EnumLayoutValue_strategy)
def test_diagram_description_enumlayoutvalue_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=diagram_description_IntegerLayoutOption_strategy)
def test_diagram_description_integerlayoutoption_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
@given(instance=diagram_description_DoubleLayoutOption_strategy)
def test_diagram_description_doublelayoutoption_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
@given(instance=diagram_description_StringLayoutOption_strategy)
def test_diagram_description_stringlayoutoption_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
@given(instance=diagram_description_BooleanLayoutOption_strategy)
def test_diagram_description_booleanlayoutoption_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
@given(instance=diagram_description_LayoutOption_strategy)
def test_diagram_description_layoutoption_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
@given(instance=diagram_description_LayoutOption_strategy)
def test_diagram_description_layoutoption_description_setter(instance):
    original = instance.description
    instance.description = original
    assert instance.description == original
...
@given(instance=diagram_description_LayoutOption_strategy)
def test_diagram_description_layoutoption_targets_setter(instance):
...
@given(instance=diagram_description_LayoutOption_strategy)
def test_diagram_description_layoutoption_label_setter(instance):
    original = instance.label
    instance.label = original
    assert instance.label == original
...
@given(instance=diagram_DDiagram_strategy)
def test_diagram_ddiagram_isInShowingMode_setter(instance):
    original = instance.isInShowingMode
    instance.isInShowingMode = original
    assert instance.isInShowingMode == original
...
@given(instance=diagram_description_CustomLayoutConfiguration_strategy)
def test_diagram_description_customlayoutconfiguration_description_setter(instance):
    original = instance.description
    instance.description = original
    assert instance.description == original
...
@given(instance=diagram_description_CustomLayoutConfiguration_strategy)
def test_diagram_description_customlayoutconfiguration_label_setter(instance):
    original = instance.label
    instance.label = original
    assert instance.label == original
...
@given(instance=diagram_description_CustomLayoutConfiguration_strategy)
def test_diagram_description_customlayoutconfiguration_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
@given(instance=diagram_style_NodeStyleDescription_strategy)
def test_diagram_style_nodestyledescription_forbiddenSides_setter(instance):
