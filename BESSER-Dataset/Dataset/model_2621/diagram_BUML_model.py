...
diagram_description_LayoutOption = Class(name="diagram_description_LayoutOption", is_abstract=True)
diagram_description_BooleanLayoutOption = Class(name="diagram_description_BooleanLayoutOption")
...
diagram_description_CustomLayoutConfiguration = Class(name="diagram_description_CustomLayoutConfiguration")
...
diagram_description_StringLayoutOption = Class(name="diagram_description_StringLayoutOption")
diagram_description_IntegerLayoutOption = Class(name="diagram_description_IntegerLayoutOption")
diagram_description_DoubleLayoutOption = Class(name="diagram_description_DoubleLayoutOption")
diagram_description_EnumLayoutOption = Class(name="diagram_description_EnumLayoutOption")
EnumOption = Class(name="EnumOption")
EnumLayoutValue = Class(name="EnumLayoutValue")
diagram_description_EnumSetLayoutOption = Class(name="diagram_description_EnumSetLayoutOption")
diagram_description_EnumOption = Class(name="diagram_description_EnumOption", is_abstract=True)
diagram_description_EnumLayoutValue = Class(name="diagram_description_EnumLayoutValue")
...
tool_GroupMenu = Class(name="tool_GroupMenu")
...
diagram_DDiagram.attributes={diagram_DDiagram_isInLayoutingMode, diagram_DDiagram_headerHeight, diagram_DDiagram_isInShowingMode, diagram_DDiagram_synchronized}
...
diagram_DEdge.attributes={diagram_DEdge_endLabel, diagram_DEdge_size, diagram_DEdge_isMockEdge, diagram_DEdge_isFold, diagram_DEdge_arrangeConstraints, diagram_DEdge_routingStyle, diagram_DEdge_beginLabel}
...
diagram_EdgeStyle.attributes={diagram_EdgeStyle_size, diagram_EdgeStyle_strokeColor, diagram_EdgeStyle_sourceArrow, diagram_EdgeStyle_targetArrow, diagram_EdgeStyle_centered, diagram_EdgeStyle_foldingStyle, diagram_EdgeStyle_routingStyle, diagram_EdgeStyle_lineStyle}
...
diagram_GaugeSection.attributes={diagram_GaugeSection_label, diagram_GaugeSection_value, diagram_GaugeSection_min, diagram_GaugeSection_max, diagram_GaugeSection_foregroundColor, diagram_GaugeSection_backgroundColor}
...
diagram_BorderedStyle.attributes={diagram_BorderedStyle_borderLineStyle, diagram_BorderedStyle_borderColor, diagram_BorderedStyle_borderSize, diagram_BorderedStyle_borderSizeComputationExpression}
...
diagram_description_LayoutOption.attributes={diagram_description_LayoutOption_id, diagram_description_LayoutOption_targets, diagram_description_LayoutOption_label, diagram_description_LayoutOption_description}
...
diagram_description_CustomLayoutConfiguration.attributes={diagram_description_CustomLayoutConfiguration_label, diagram_description_CustomLayoutConfiguration_description, diagram_description_CustomLayoutConfiguration_id}
...
diagram_description_EnumLayoutValue.attributes={diagram_description_EnumLayoutValue_name, diagram_description_EnumLayoutValue_description}
...
diagram_style_NodeStyleDescription.attributes={diagram_style_NodeStyleDescription_labelPosition, diagram_style_NodeStyleDescription_sizeComputationExpression, diagram_style_NodeStyleDescription_resizeKind, diagram_style_NodeStyleDescription_forbiddenSides}
...
diagram_style_EdgeStyleDescription.attributes={diagram_style_EdgeStyleDescription_routingStyle, diagram_style_EdgeStyleDescription_targetArrow, diagram_style_EdgeStyleDescription_sourceArrow, diagram_style_EdgeStyleDescription_sizeComputationExpression, diagram_style_EdgeStyleDescription_endsCentering, diagram_style_EdgeStyleDescription_foldingStyle, diagram_style_EdgeStyleDescription_lineStyle}
...
source398: BinaryAssociation = BinaryAssociation(
    name="source398",
    ends={
        Property(name="tool_SourceEdgeCreationVariable399", type=diagram_tool_ReconnectEdgeDescription, multiplicity=Multiplicity(1, 1)),
...
target400: BinaryAssociation = BinaryAssociation(
    name="target400",
    ends={
        Property(name="tool_TargetEdgeCreationVariable402", type=diagram_tool_ReconnectEdgeDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ReconnectEdgeDescription401", type=tool_TargetEdgeCreationVariable, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
sourceView403: BinaryAssociation = BinaryAssociation(
    name="sourceView403",
    ends={
        Property(name="tool_SourceEdgeViewCreationVariable405", type=diagram_tool_ReconnectEdgeDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ReconnectEdgeDescription404", type=tool_SourceEdgeViewCreationVariable, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
targetView406: BinaryAssociation = BinaryAssociation(
    name="targetView406",
    ends={
        Property(name="tool_TargetEdgeViewCreationVariable408", type=diagram_tool_ReconnectEdgeDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ReconnectEdgeDescription407", type=tool_TargetEdgeViewCreationVariable, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
element409: BinaryAssociation = BinaryAssociation(
    name="element409",
    ends={
        Property(name="tool_ElementSelectVariable", type=diagram_tool_ReconnectEdgeDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ReconnectEdgeDescription410", type=tool_ElementSelectVariable, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
initialOperation411: BinaryAssociation = BinaryAssociation(
    name="initialOperation411",
    ends={
        Property(name="tool_InitialOperation413", type=diagram_tool_ReconnectEdgeDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ReconnectEdgeDescription412", type=tool_InitialOperation, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
edgeView414: BinaryAssociation = BinaryAssociation(
    name="edgeView414",
    ends={
        Property(name="tool_ElementSelectVariable416", type=diagram_tool_ReconnectEdgeDescription, multiplicity=Multiplicity(1, 1)),
...
mappings388: BinaryAssociation = BinaryAssociation(
    name="mappings388",
    ends={
        Property(name="DiagramElementMapping389", type=diagram_tool_DoubleClickDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="doubleClickDescription", type=DiagramElementMapping, multiplicity=Multiplicity(1, 9999))
    }
)
element390: BinaryAssociation = BinaryAssociation(
    name="element390",
    ends={
...
elementView391: BinaryAssociation = BinaryAssociation(
    name="elementView391",
    ends={
        Property(name="tool_ElementDoubleClickVariable393", type=diagram_tool_DoubleClickDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_DoubleClickDescription392", type=tool_ElementDoubleClickVariable, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
initialOperation394: BinaryAssociation = BinaryAssociation(
    name="initialOperation394",
    ends={
        Property(name="tool_InitialOperation396", type=diagram_tool_DoubleClickDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_DoubleClickDescription395", type=tool_InitialOperation, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
parameters397: BinaryAssociation = BinaryAssociation(
    name="parameters397",
    ends={
...
initialOperation421: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="tool_InitialOperation422", type=diagram_tool_BehaviorTool, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_BehaviorTool", type=tool_InitialOperation, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
mapping423: BinaryAssociation = BinaryAssociation(
    name="mapping423",
    ends={
        Property(name="DiagramElementMapping424", type=diagram_tool_CreateView, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_CreateView", type=DiagramElementMapping, multiplicity=Multiplicity(1, 1))
    }
)
mask417: BinaryAssociation = BinaryAssociation(
    name="mask417",
    ends={
...
initialOperation418: BinaryAssociation = BinaryAssociation(
    name="initialOperation418",
    ends={
        Property(name="tool_InitialOperation420", type=diagram_tool_DirectEditLabel, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_DirectEditLabel419", type=tool_InitialOperation, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
mappings431: BinaryAssociation = BinaryAssociation(
    name="mappings431",
    ends={
        Property(name="DiagramElementMapping432", type=diagram_tool_ContainerDropDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ContainerDropDescription", type=DiagramElementMapping, multiplicity=Multiplicity(0, 9999))
    }
)
oldContainer433: BinaryAssociation = BinaryAssociation(
    name="oldContainer433",
    ends={
        Property(name="tool_DropContainerVariable", type=diagram_tool_ContainerDropDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ContainerDropDescription434", type=tool_DropContainerVariable, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
newContainer435: BinaryAssociation = BinaryAssociation(
    name="newContainer435",
    ends={
        Property(name="tool_DropContainerVariable437", type=diagram_tool_ContainerDropDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ContainerDropDescription436", type=tool_DropContainerVariable, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
element438: BinaryAssociation = BinaryAssociation(
    name="element438",
    ends={
        Property(name="tool_ElementDropVariable", type=diagram_tool_ContainerDropDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ContainerDropDescription439", type=tool_ElementDropVariable, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
newViewContainer440: BinaryAssociation = BinaryAssociation(
    name="newViewContainer440",
    ends={
        Property(name="tool_ContainerViewVariable442", type=diagram_tool_ContainerDropDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ContainerDropDescription441", type=tool_ContainerViewVariable, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
initialOperation443: BinaryAssociation = BinaryAssociation(
    name="initialOperation443",
    ends={
        ...
        Property(name="diagram_tool_ContainerDropDescription444", type=tool_InitialContainerDropOperation, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
diagramDescription425: BinaryAssociation = BinaryAssociation(
    name="diagramDescription425",
    ends={
        Property(name="DiagramDescription426", type=diagram_tool_Navigation, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_Navigation", type=DiagramDescription, multiplicity=Multiplicity(1, 1))
    }
)
diagramDescription427: BinaryAssociation = BinaryAssociation(
    name="diagramDescription427",
    ends={
        Property(name="DiagramDescription428", type=diagram_tool_DiagramCreationDescription, multiplicity=Multiplicity(1, 1)),
...
diagramDescription429: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="DiagramDescription430", type=diagram_tool_DiagramNavigationDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_DiagramNavigationDescription", type=DiagramDescription, multiplicity=Multiplicity(1, 1))
    }
)
filters447: BinaryAssociation = BinaryAssociation(
    name="filters447",
    ends={
...
ownedVariables448: BinaryAssociation = BinaryAssociation(
    name="ownedVariables448",
    ends={
...
ownedConcernDescriptions449: BinaryAssociation = BinaryAssociation(
    name="ownedConcernDescriptions449",
    ends={
        Property(name="concern_ConcernDescription450", type=diagram_concern_ConcernSet, multiplicity=Multiplicity(1, 1)),
...
mappings445: BinaryAssociation = BinaryAssociation(
    name="mappings445",
    ends={
        Property(name="DiagramElementMapping446", type=diagram_filter_MappingFilter, multiplicity=Multiplicity(1, 1)),
...
filters451: BinaryAssociation = BinaryAssociation(
    name="filters451",
    ends={
        Property(name="filter_FilterDescription452", type=diagram_concern_ConcernDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_concern_ConcernDescription", type=filter_FilterDescription, multiplicity=Multiplicity(0, 9999))
    }
)
rules453: BinaryAssociation = BinaryAssociation(
    name="rules453",
    ends={
        Property(name="validation_ValidationRule455", type=diagram_concern_ConcernDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_concern_ConcernDescription454", type=validation_ValidationRule, multiplicity=Multiplicity(0, 9999))
    }
)
behaviors456: BinaryAssociation = BinaryAssociation(
    name="behaviors456",
    ends={
        Property(name="tool_BehaviorTool458", type=diagram_concern_ConcernDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_concern_ConcernDescription457", type=tool_BehaviorTool, multiplicity=Multiplicity(0, 9999))
    }
)
...
domain_model = DomainModel(
    name="diagram",
    types={AdditionalLayer, validation_ValidationRule, diagram_DDiagram, DRepresentation, DragAndDropTarget, diagram_DDiagramElement, DiagramDescription, diagram_DEdge, diagram_DNode, diagram_DNodeListElement, diagram_DDiagramElementContainer, concern_ConcernDescription, filter_FilterDescription, DDiagram, DSemanticDecorator, DRepresentationElement, tool_BehaviorTool, diagram_FilterVariableHistory, Layer, AbstractDNode, EdgeTarget, diagram_DSemanticDiagram, diagram_Decoration, DiagramElementMapping, diagram_GraphicalFilter, IdentifiedElement, diagram_HideFilter, GraphicalFilter, diagram_HideLabelFilter, diagram_FoldingPointFilter, diagram_FoldingFilter, diagram_AppliedCompositeFilters, filter_CompositeFilterDescription, diagram_AbsoluteBoundsFilter, diagram_AbstractDNode, DDiagramElement, diagram_ContainerStyle, diagram_NodeStyle, diagram_Style, NodeMapping, diagram_EdgeStyle, ContainerMapping, diagram_DNodeContainer, DDiagramElementContainer, diagram_DNodeList, diagram_GaugeSection, Customizable, diagram_EdgeTarget, IEdgeMapping, LabelStyle, Style, BorderedStyle, HideLabelCapabilityStyle, diagram_Dot, NodeStyle, diagram_Ellipse, diagram_FlatContainerStyle, ContainerStyle, diagram_ShapeContainerStyle, diagram_Square, diagram_Lozenge, diagram_BundledImage, diagram_WorkspaceImage, diagram_CustomStyle, diagram_BeginLabelStyle, diagram_CenterLabelStyle, diagram_EndLabelStyle, diagram_GaugeCompositeStyle, diagram_BracketEdgeStyle, EdgeStyle, diagram_ComputedStyleDescriptionRegistry, style_StyleDescription, diagram_DragAndDropTarget, diagram_BorderedStyle, diagram_Note, diagram_VariableValue, diagram_CollapseFilter, diagram_IndirectlyCollapseFilter, CollapseFilter, BasicLabelStyle, diagram_HideLabelCapabilityStyle, diagram_TypedVariableValue, VariableValue, TypedVariable, diagram_EObjectVariableValue, tool_SelectModelElementVariable, diagram_EObject, diagram_description_DiagramDescription, description_DragAndDropTargetDescription, description_RepresentationDescription, description_PasteTargetDescription, EdgeMapping, validation_ValidationSet, concern_ConcernSet, tool_AbstractToolDescription, ColorDescription, tool_RepresentationCreationDescription, Layout, tool_InitialOperation, EdgeMappingImport, tool_ToolSection, tool_DoubleClickDescription, diagram_description_DiagramImportDescription, description_RepresentationImportDescription, description_DiagramDescription, diagram_description_DiagramExtensionDescription, RepresentationExtensionDescription, diagram_description_DiagramElementMapping, description_RepresentationElementMapping, tool_DeleteElementDescription, tool_DirectEditLabel, diagram_description_ContainerMappingImport, description_ContainerMapping, diagram_description_AbstractNodeMapping, description_DiagramElementMapping, description_DocumentedElement, diagram_description_NodeMapping, description_AbstractNodeMapping, style_NodeStyleDescription, ConditionalNodeStyleDescription, diagram_description_ContainerMapping, style_ContainerStyleDescription, ConditionalContainerStyleDescription, diagram_description_NodeMappingImport, description_NodeMapping, description_AbstractMappingImport, AbstractNodeMapping, diagram_description_IEdgeMapping, diagram_description_EdgeMapping, description_IEdgeMapping, style_EdgeStyleDescription, ConditionalEdgeStyleDescription, tool_ReconnectEdgeDescription, diagram_description_LayoutOption, diagram_description_BooleanLayoutOption, diagram_description_EdgeMappingImport, description_IdentifiedElement, diagram_description_ConditionalNodeStyleDescription, ConditionalStyleDescription, diagram_description_ConditionalEdgeStyleDescription, diagram_description_ConditionalContainerStyleDescription, diagram_description_Layout, DocumentedElement, diagram_description_OrderedTreeLayout, diagram_description_CompositeLayout, diagram_description_CustomLayoutConfiguration, LayoutOption, diagram_description_Layer, description_EndUserDocumentedElement, diagram_description_StringLayoutOption, diagram_description_IntegerLayoutOption, diagram_description_DoubleLayoutOption, diagram_description_EnumLayoutOption, EnumOption, EnumLayoutValue, diagram_description_EnumSetLayoutOption, diagram_description_EnumOption, diagram_description_EnumLayoutValue, diagram_description_MappingBasedDecoration, DecorationDescription, diagram_style_BorderedStyleDescription, StyleDescription, diagram_style_NodeStyleDescription, style_BorderedStyleDescription, style_LabelStyleDescription, style_TooltipStyleDescription, style_HideLabelCapabilityStyleDescription, DecorationDescriptionsSet, Customization, diagram_description_AdditionalLayer, diagram_description_DragAndDropTargetDescription, tool_ContainerDropDescription, diagram_style_EllipseNodeDescription, diagram_style_BundledImageDescription, diagram_style_NoteDescription, diagram_style_CustomStyleDescription, NodeStyleDescription, diagram_style_SquareDescription, diagram_style_LozengeNodeDescription, diagram_style_SizeComputationContainerStyleDescription, diagram_style_RoundedCornerStyleDescription, diagram_style_DotDescription, diagram_style_GaugeCompositeStyleDescription, style_GaugeSectionDescription, diagram_style_GaugeSectionDescription, style_LabelBorderStyleDescription, diagram_style_ShapeContainerStyleDescription, diagram_style_WorkspaceImageDescription, diagram_style_ContainerStyleDescription, style_RoundedCornerStyleDescription, diagram_style_FlatContainerStyleDescription, style_SizeComputationContainerStyleDescription, style_BeginLabelStyleDescription, style_CenterLabelStyleDescription, style_EndLabelStyleDescription, diagram_style_BeginLabelStyleDescription, BasicLabelStyleDescription, diagram_style_CenterLabelStyleDescription, diagram_style_EdgeStyleDescription, tool_PopupMenu, tool_ToolGroupExtension, tool_GroupMenu, diagram_tool_ToolGroup, ToolEntry, diagram_tool_ToolGroupExtension, tool_ToolGroup, diagram_tool_NodeCreationDescription, MappingBasedToolDescription, diagram_style_EndLabelStyleDescription, diagram_style_BracketEdgeStyleDescription, EdgeStyleDescription, diagram_style_HideLabelCapabilityStyleDescription, diagram_tool_ToolSection, tool_ToolEntry, tool_SourceEdgeCreationVariable, tool_TargetEdgeCreationVariable, tool_SourceEdgeViewCreationVariable, tool_TargetEdgeViewCreationVariable, tool_InitEdgeCreationOperation, tool_NodeCreationVariable, tool_ContainerViewVariable, tool_InitialNodeCreationOperation, diagram_tool_EdgeCreationDescription, diagram_tool_DeleteElementDescription, tool_ElementDeleteVariable, tool_DeleteHook, diagram_tool_DoubleClickDescription, diagram_tool_ContainerCreationDescription, tool_ElementSelectVariable, tool_ElementDoubleClickVariable, diagram_tool_DeleteHook, tool_DeleteHookParameter, diagram_tool_DeleteHookParameter, diagram_tool_ReconnectEdgeDescription, diagram_tool_SourceEdgeCreationVariable, description_AbstractVariable, tool_VariableContainer, diagram_tool_SourceEdgeViewCreationVariable, diagram_tool_TargetEdgeCreationVariable, diagram_tool_TargetEdgeViewCreationVariable, diagram_tool_ElementDoubleClickVariable, diagram_tool_NodeCreationVariable, diagram_tool_CreateView, ContainerModelOperation, diagram_tool_CreateEdgeView, CreateView, diagram_tool_RequestDescription, AbstractToolDescription, diagram_tool_DirectEditLabel, tool_EditMaskVariables, diagram_tool_BehaviorTool, diagram_tool_ContainerDropDescription, tool_DropContainerVariable, tool_ElementDropVariable, tool_InitialContainerDropOperation, diagram_tool_Navigation, diagram_tool_DiagramCreationDescription, RepresentationCreationDescription, diagram_tool_DiagramNavigationDescription, RepresentationNavigationDescription, diagram_filter_CompositeFilterDescription, FilterDescription, filter_Filter, diagram_filter_VariableFilter, InteractiveVariableDescription, diagram_concern_ConcernSet, diagram_concern_ConcernDescription, diagram_filter_FilterDescription, diagram_filter_Filter, diagram_filter_MappingFilter, Filter, ContainerLayout, LabelPosition, ContainerShape, BackgroundStyle, BundledImageShape, AlignmentKind, LineStyle, EdgeArrows, EdgeRouting, ResizeKind, ArrangeConstraint, FoldingStyle, LayoutDirection, CenteringStyle, LayoutOptionTarget, Side, ReconnectionKind, FilterKind},
    associations={activatedTransientLayers18, allFilters20, activatedRules23, ownedDiagramElements0, diagramElements1, description4, edges6, nodes8, nodeListElements10, containers12, currentConcern14, activatedFilters16, activateBehaviors25, filterVariableHistory27, activatedLayers29, hiddenElements31, parentLayers34, decorations37, transientDecorations39, diagramElementMapping42, graphicalFilters44, compositeFilterDescriptions46, ownedBorderedNodes47, ownedStyle67, ownedStyle49, originalStyle51, actualMapping53, candidatesMapping55, nodes58, containers62, elements64, ownedStyle93, originalStyle69, actualMapping72, candidatesMapping74, ownedDiagramElements77, ownedElements79, ownedStyle81, originalStyle84, actualMapping87, candidatesMapping90, sourceNode95, targetNode96, actualMapping98, originalStyle100, path103, outgoingEdges105, incomingEdges106, sections114, beginLabelStyle108, centerLabelStyle110, endLabelStyle112, computedStyleDescriptions117, ownedValues115, defaultConcern132, variableDefinition118, variableDefinition119, modelElement120, filters122, allEdgeMappings124, validationSet126, concerns128, allTools130, reusedTools163, backgroundColor166, init135, layout137, diagramInitialisation139, defaultLayer141, additionalLayers144, nodeMappings147, edgeMappings150, edgeMappingImports153, containerMappings155, reusedMappings158, toolSection161, doubleClickDescription181, importedDiagram168, layers170, validationSet172, concerns175, deletionDescription178, labelDirectEdit179, importedMapping205, borderedNodeMappings182, reusedBorderedNodeMappings184, style187, conditionnalStyles188, subNodeMappings190, reusedNodeMappings192, subContainerMappings195, reusedContainerMappings198, style201, conditionnalStyles203, pathNodeMapping220, importedMapping207, sourceMapping209, targetMapping211, style214, conditionnalStyles216, reconnections218, layoutOptions235, importedMapping222, conditionnalStyles224, style227, style229, style231, nodeMapping233, mappings241, nodeMappings243, edgeMappings245, edgeMappingImports248, containerMappings251, reusedMappings254, value236, values237, choices239, borderColor271, allTools257, toolSections260, reusedTools263, decorationDescriptionsSet266, customization268, dropDescriptions270, color275, color277, color279, color281, color273, backgroundColor286, foregroundColor288, backgroundColor283, sections285, backgroundColor291, foregroundColor293, labelBorderStyle296, backgroundColor298, beginLabelStyleDescription302, centerLabelStyleDescription304, endLabelStyleDescription306, centeredSourceMappings308, centeredTargetMappings311, strokeColor300, popupMenus318, reusedTools320, groupExtensions323, groups325, tools327, group329, tools330, nodeMappings333, ownedTools314, subSections315, sourceVariable346, targetVariable348, sourceViewVariable350, targetViewVariable352, initialOperation354, extraSourceMappings356, variable335, viewVariable337, initialOperation339, extraMappings341, edgeMappings344, extraMappings373, element376, elementView377, containerView380, initialOperation383, hook386, extraTargetMappings359, containerMappings362, variable364, viewVariable367, initialOperation370, source398, target400, sourceView403, targetView406, element409, initialOperation411, edgeView414, mappings388, element390, elementView391, initialOperation394, parameters397, initialOperation421, mapping423, mask417, initialOperation418, mappings431, oldContainer433, newContainer435, element438, newViewContainer440, initialOperation443, diagramDescription425, diagramDescription427, diagramDescription429, filters447, ownedVariables448, ownedConcernDescriptions449, mappings445, filters451, rules453, behaviors456},
    generalizations={gen_diagram_DDiagram_DRepresentation, gen_diagram_DDiagram_DragAndDropTarget, gen_diagram_DSemanticDiagram_DDiagram, gen_diagram_DSemanticDiagram_DSemanticDecorator, gen_diagram_DDiagramElement_DRepresentationElement, gen_diagram_DNode_AbstractDNode, gen_diagram_DNode_EdgeTarget, gen_diagram_DNode_DragAndDropTarget, gen_diagram_GraphicalFilter_IdentifiedElement, gen_diagram_HideFilter_GraphicalFilter, gen_diagram_HideLabelFilter_GraphicalFilter, gen_diagram_FoldingPointFilter_GraphicalFilter, gen_diagram_FoldingFilter_GraphicalFilter, gen_diagram_AppliedCompositeFilters_GraphicalFilter, gen_diagram_AbsoluteBoundsFilter_GraphicalFilter, gen_diagram_AbstractDNode_DDiagramElement, gen_diagram_DDiagramElementContainer_AbstractDNode, gen_diagram_DDiagramElementContainer_EdgeTarget, gen_diagram_DDiagramElementContainer_DragAndDropTarget, gen_diagram_DEdge_DDiagramElement, gen_diagram_DEdge_EdgeTarget, gen_diagram_DNodeContainer_DDiagramElementContainer, gen_diagram_DNodeList_DDiagramElementContainer, gen_diagram_DNodeListElement_AbstractDNode, gen_diagram_GaugeSection_Customizable, gen_diagram_NodeStyle_LabelStyle, gen_diagram_NodeStyle_Style, gen_diagram_NodeStyle_BorderedStyle, gen_diagram_NodeStyle_HideLabelCapabilityStyle, gen_diagram_Dot_NodeStyle, gen_diagram_Ellipse_NodeStyle, gen_diagram_ContainerStyle_LabelStyle, gen_diagram_ContainerStyle_Style, gen_diagram_ContainerStyle_BorderedStyle, gen_diagram_ContainerStyle_HideLabelCapabilityStyle, gen_diagram_FlatContainerStyle_ContainerStyle, gen_diagram_ShapeContainerStyle_ContainerStyle, gen_diagram_Square_NodeStyle, gen_diagram_Lozenge_NodeStyle, gen_diagram_BundledImage_NodeStyle, gen_diagram_WorkspaceImage_NodeStyle, gen_diagram_WorkspaceImage_ContainerStyle, gen_diagram_CustomStyle_NodeStyle, gen_diagram_EdgeTarget_IdentifiedElement, gen_diagram_EdgeStyle_Style, gen_diagram_GaugeCompositeStyle_NodeStyle, gen_diagram_BracketEdgeStyle_EdgeStyle, gen_diagram_ComputedStyleDescriptionRegistry_IdentifiedElement, gen_diagram_DragAndDropTarget_IdentifiedElement, gen_diagram_BorderedStyle_Style, gen_diagram_Note_NodeStyle, gen_diagram_FilterVariableHistory_IdentifiedElement, gen_diagram_CollapseFilter_GraphicalFilter, gen_diagram_IndirectlyCollapseFilter_CollapseFilter, gen_diagram_BeginLabelStyle_BasicLabelStyle, gen_diagram_CenterLabelStyle_BasicLabelStyle, gen_diagram_EndLabelStyle_BasicLabelStyle, gen_diagram_VariableValue_IdentifiedElement, gen_diagram_TypedVariableValue_VariableValue, gen_diagram_EObjectVariableValue_VariableValue, gen_diagram_description_DiagramDescription_description_DragAndDropTargetDescription, gen_diagram_description_DiagramDescription_description_RepresentationDescription, gen_diagram_description_DiagramDescription_description_PasteTargetDescription, gen_diagram_description_DiagramImportDescription_description_RepresentationImportDescription, gen_diagram_description_DiagramImportDescription_description_DiagramDescription, gen_diagram_description_DiagramExtensionDescription_RepresentationExtensionDescription, gen_diagram_description_DiagramElementMapping_description_RepresentationElementMapping, gen_diagram_description_DiagramElementMapping_description_PasteTargetDescription, gen_diagram_description_ContainerMappingImport_description_ContainerMapping, gen_diagram_description_ContainerMappingImport_description_AbstractMappingImport, gen_diagram_description_AbstractNodeMapping_description_DiagramElementMapping, gen_diagram_description_AbstractNodeMapping_description_DocumentedElement, gen_diagram_description_NodeMapping_description_AbstractNodeMapping, gen_diagram_description_NodeMapping_description_DragAndDropTargetDescription, gen_diagram_description_ContainerMapping_description_AbstractNodeMapping, gen_diagram_description_ContainerMapping_description_DragAndDropTargetDescription, gen_diagram_description_NodeMappingImport_description_NodeMapping, gen_diagram_description_NodeMappingImport_description_AbstractMappingImport, gen_diagram_description_EdgeMapping_description_DiagramElementMapping, gen_diagram_description_EdgeMapping_description_DocumentedElement, gen_diagram_description_EdgeMapping_description_IEdgeMapping, gen_diagram_description_BooleanLayoutOption_LayoutOption, gen_diagram_description_EdgeMappingImport_description_DocumentedElement, gen_diagram_description_EdgeMappingImport_description_IEdgeMapping, gen_diagram_description_EdgeMappingImport_description_IdentifiedElement, gen_diagram_description_ConditionalNodeStyleDescription_ConditionalStyleDescription, gen_diagram_description_ConditionalEdgeStyleDescription_ConditionalStyleDescription, gen_diagram_description_ConditionalContainerStyleDescription_ConditionalStyleDescription, gen_diagram_description_Layout_DocumentedElement, gen_diagram_description_OrderedTreeLayout_Layout, gen_diagram_description_CompositeLayout_Layout, gen_diagram_description_CustomLayoutConfiguration_Layout, gen_diagram_description_Layer_description_DocumentedElement, gen_diagram_description_Layer_description_EndUserDocumentedElement, gen_diagram_description_Layer_description_IdentifiedElement, gen_diagram_description_StringLayoutOption_LayoutOption, gen_diagram_description_IntegerLayoutOption_LayoutOption, gen_diagram_description_DoubleLayoutOption_LayoutOption, gen_diagram_description_EnumLayoutOption_EnumOption, gen_diagram_description_EnumSetLayoutOption_EnumOption, gen_diagram_description_EnumOption_LayoutOption, gen_diagram_description_MappingBasedDecoration_DecorationDescription, gen_diagram_style_BorderedStyleDescription_StyleDescription, gen_diagram_style_NodeStyleDescription_style_StyleDescription, gen_diagram_style_NodeStyleDescription_style_BorderedStyleDescription, gen_diagram_style_NodeStyleDescription_style_LabelStyleDescription, gen_diagram_style_NodeStyleDescription_style_TooltipStyleDescription, gen_diagram_style_NodeStyleDescription_style_HideLabelCapabilityStyleDescription, gen_diagram_description_AdditionalLayer_Layer, gen_diagram_style_EllipseNodeDescription_NodeStyleDescription, gen_diagram_style_BundledImageDescription_NodeStyleDescription, gen_diagram_style_NoteDescription_NodeStyleDescription, gen_diagram_style_CustomStyleDescription_NodeStyleDescription, gen_diagram_style_SquareDescription_NodeStyleDescription, gen_diagram_style_LozengeNodeDescription_NodeStyleDescription, gen_diagram_style_RoundedCornerStyleDescription_StyleDescription, gen_diagram_style_DotDescription_NodeStyleDescription, gen_diagram_style_GaugeCompositeStyleDescription_NodeStyleDescription, gen_diagram_style_ShapeContainerStyleDescription_style_ContainerStyleDescription, gen_diagram_style_ShapeContainerStyleDescription_style_SizeComputationContainerStyleDescription, gen_diagram_style_WorkspaceImageDescription_style_NodeStyleDescription, gen_diagram_style_WorkspaceImageDescription_style_ContainerStyleDescription, gen_diagram_style_ContainerStyleDescription_style_RoundedCornerStyleDescription, gen_diagram_style_ContainerStyleDescription_style_BorderedStyleDescription, gen_diagram_style_ContainerStyleDescription_style_LabelStyleDescription, gen_diagram_style_ContainerStyleDescription_style_TooltipStyleDescription, gen_diagram_style_ContainerStyleDescription_style_HideLabelCapabilityStyleDescription, gen_diagram_style_FlatContainerStyleDescription_style_ContainerStyleDescription, gen_diagram_style_FlatContainerStyleDescription_style_SizeComputationContainerStyleDescription, gen_diagram_style_BeginLabelStyleDescription_BasicLabelStyleDescription, gen_diagram_style_CenterLabelStyleDescription_BasicLabelStyleDescription, gen_diagram_style_EdgeStyleDescription_StyleDescription, gen_diagram_tool_ToolGroup_ToolEntry, gen_diagram_tool_NodeCreationDescription_MappingBasedToolDescription, gen_diagram_style_EndLabelStyleDescription_BasicLabelStyleDescription, gen_diagram_style_BracketEdgeStyleDescription_EdgeStyleDescription, gen_diagram_tool_ToolSection_description_DocumentedElement, gen_diagram_tool_ToolSection_description_IdentifiedElement, gen_diagram_tool_EdgeCreationDescription_MappingBasedToolDescription, gen_diagram_tool_DeleteElementDescription_MappingBasedToolDescription, gen_diagram_tool_DoubleClickDescription_MappingBasedToolDescription, gen_diagram_tool_ContainerCreationDescription_MappingBasedToolDescription, gen_diagram_tool_ReconnectEdgeDescription_MappingBasedToolDescription, gen_diagram_tool_SourceEdgeCreationVariable_description_AbstractVariable, gen_diagram_tool_SourceEdgeCreationVariable_tool_VariableContainer, gen_diagram_tool_SourceEdgeViewCreationVariable_description_AbstractVariable, gen_diagram_tool_SourceEdgeViewCreationVariable_tool_VariableContainer, gen_diagram_tool_TargetEdgeCreationVariable_description_AbstractVariable, gen_diagram_tool_TargetEdgeCreationVariable_tool_VariableContainer, gen_diagram_tool_TargetEdgeViewCreationVariable_description_AbstractVariable, gen_diagram_tool_TargetEdgeViewCreationVariable_tool_VariableContainer, gen_diagram_tool_ElementDoubleClickVariable_description_AbstractVariable, gen_diagram_tool_ElementDoubleClickVariable_tool_VariableContainer, gen_diagram_tool_NodeCreationVariable_description_AbstractVariable, gen_diagram_tool_NodeCreationVariable_tool_VariableContainer, gen_diagram_tool_CreateView_ContainerModelOperation, gen_diagram_tool_CreateEdgeView_CreateView, gen_diagram_tool_RequestDescription_AbstractToolDescription, gen_diagram_tool_DirectEditLabel_MappingBasedToolDescription, gen_diagram_tool_BehaviorTool_AbstractToolDescription, gen_diagram_tool_ContainerDropDescription_MappingBasedToolDescription, gen_diagram_tool_Navigation_ContainerModelOperation, gen_diagram_tool_DiagramCreationDescription_RepresentationCreationDescription, gen_diagram_tool_DiagramNavigationDescription_RepresentationNavigationDescription, gen_diagram_filter_CompositeFilterDescription_FilterDescription, gen_diagram_filter_VariableFilter_Filter, gen_diagram_concern_ConcernSet_DocumentedElement, gen_diagram_concern_ConcernDescription_description_DocumentedElement, gen_diagram_filter_FilterDescription_description_DocumentedElement, gen_diagram_filter_FilterDescription_description_IdentifiedElement, gen_diagram_filter_MappingFilter_Filter, gen_diagram_concern_ConcernDescription_description_IdentifiedElement},
    metadata=None
)
