    ...
    def diagram_filter_MappingFilter(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "DiagramElementMapping446"):
                    opp_val = getattr(item, "DiagramElementMapping446", None)
                    
                    if opp_val == self:
                        setattr(item, "DiagramElementMapping446", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "DiagramElementMapping446"):
                    ...
                    setattr(item, "DiagramElementMapping446", self)
...
class diagram_tool_BehaviorTool(AbstractToolDescription):
    ...
    def diagram_tool_BehaviorTool(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tool_InitialOperation422"):
                opp_val = getattr(old_value, "tool_InitialOperation422", None)
                if opp_val == self:
                    setattr(old_value, "tool_InitialOperation422", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tool_InitialOperation422"):
                opp_val = getattr(value, "tool_InitialOperation422", None)
                setattr(value, "tool_InitialOperation422", self)
...
class diagram_tool_Navigation(ContainerModelOperation):
    ...
    def diagram_tool_Navigation(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "DiagramDescription426"):
                opp_val = getattr(old_value, "DiagramDescription426", None)
                if opp_val == self:
                    setattr(old_value, "DiagramDescription426", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "DiagramDescription426"):
                opp_val = getattr(value, "DiagramDescription426", None)
                setattr(value, "DiagramDescription426", self)
...
class diagram_tool_CreateView(ContainerModelOperation):
    ...
    def diagram_tool_CreateView(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "DiagramElementMapping424"):
                opp_val = getattr(old_value, "DiagramElementMapping424", None)
                if opp_val == self:
                    setattr(old_value, "DiagramElementMapping424", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "DiagramElementMapping424"):
                opp_val = getattr(value, "DiagramElementMapping424", None)
                setattr(value, "DiagramElementMapping424", self)
...
class diagram_tool_ReconnectEdgeDescription(MappingBasedToolDescription):
    ...
    def __init__(self, reconnectionKind: str, diagram_tool_ReconnectEdgeDescription: "tool_SourceEdgeCreationVariable" = None, diagram_tool_ReconnectEdgeDescription401: "tool_TargetEdgeCreationVariable" = None, diagram_tool_ReconnectEdgeDescription404: "tool_SourceEdgeViewCreationVariable" = None, diagram_tool_ReconnectEdgeDescription407: "tool_TargetEdgeViewCreationVariable" = None, diagram_tool_ReconnectEdgeDescription410: "tool_ElementSelectVariable" = None, diagram_tool_ReconnectEdgeDescription412: "tool_InitialOperation" = None, diagram_tool_ReconnectEdgeDescription415: "tool_ElementSelectVariable" = None):
        self.reconnectionKind = reconnectionKind
        self.diagram_tool_ReconnectEdgeDescription = diagram_tool_ReconnectEdgeDescription
        self.diagram_tool_ReconnectEdgeDescription401 = diagram_tool_ReconnectEdgeDescription401
        self.diagram_tool_ReconnectEdgeDescription404 = diagram_tool_ReconnectEdgeDescription404
        self.diagram_tool_ReconnectEdgeDescription407 = diagram_tool_ReconnectEdgeDescription407
        self.diagram_tool_ReconnectEdgeDescription410 = diagram_tool_ReconnectEdgeDescription410
    ...
    def diagram_tool_ReconnectEdgeDescription412(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tool_InitialOperation413"):
                opp_val = getattr(old_value, "tool_InitialOperation413", None)
                if opp_val == self:
                    setattr(old_value, "tool_InitialOperation413", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tool_InitialOperation413"):
                opp_val = getattr(value, "tool_InitialOperation413", None)
                setattr(value, "tool_InitialOperation413", self)

    @property
    def diagram_tool_ReconnectEdgeDescription404(self):
        return self.__diagram_tool_ReconnectEdgeDescription404

    @diagram_tool_ReconnectEdgeDescription404.setter
    def diagram_tool_ReconnectEdgeDescription404(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_diagram_tool_ReconnectEdgeDescription__diagram_tool_ReconnectEdgeDescription404", None)
        self.__diagram_tool_ReconnectEdgeDescription404 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tool_SourceEdgeViewCreationVariable405"):
                opp_val = getattr(old_value, "tool_SourceEdgeViewCreationVariable405", None)
                if opp_val == self:
                    setattr(old_value, "tool_SourceEdgeViewCreationVariable405", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tool_SourceEdgeViewCreationVariable405"):
                opp_val = getattr(value, "tool_SourceEdgeViewCreationVariable405", None)
                setattr(value, "tool_SourceEdgeViewCreationVariable405", self)

    @property
    def diagram_tool_ReconnectEdgeDescription401(self):
        return self.__diagram_tool_ReconnectEdgeDescription401

    @diagram_tool_ReconnectEdgeDescription401.setter
    def diagram_tool_ReconnectEdgeDescription401(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_diagram_tool_ReconnectEdgeDescription__diagram_tool_ReconnectEdgeDescription401", None)
        self.__diagram_tool_ReconnectEdgeDescription401 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tool_TargetEdgeCreationVariable402"):
                opp_val = getattr(old_value, "tool_TargetEdgeCreationVariable402", None)
                if opp_val == self:
                    setattr(old_value, "tool_TargetEdgeCreationVariable402", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tool_TargetEdgeCreationVariable402"):
                opp_val = getattr(value, "tool_TargetEdgeCreationVariable402", None)
                setattr(value, "tool_TargetEdgeCreationVariable402", self)
    ...
    def diagram_tool_ReconnectEdgeDescription415(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tool_ElementSelectVariable416"):
                opp_val = getattr(old_value, "tool_ElementSelectVariable416", None)
                if opp_val == self:
                    setattr(old_value, "tool_ElementSelectVariable416", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tool_ElementSelectVariable416"):
                opp_val = getattr(value, "tool_ElementSelectVariable416", None)
                setattr(value, "tool_ElementSelectVariable416", self)

    @property
    def diagram_tool_ReconnectEdgeDescription407(self):
        return self.__diagram_tool_ReconnectEdgeDescription407

    @diagram_tool_ReconnectEdgeDescription407.setter
    def diagram_tool_ReconnectEdgeDescription407(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_diagram_tool_ReconnectEdgeDescription__diagram_tool_ReconnectEdgeDescription407", None)
        self.__diagram_tool_ReconnectEdgeDescription407 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tool_TargetEdgeViewCreationVariable408"):
                opp_val = getattr(old_value, "tool_TargetEdgeViewCreationVariable408", None)
                if opp_val == self:
                    setattr(old_value, "tool_TargetEdgeViewCreationVariable408", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tool_TargetEdgeViewCreationVariable408"):
                opp_val = getattr(value, "tool_TargetEdgeViewCreationVariable408", None)
                setattr(value, "tool_TargetEdgeViewCreationVariable408", self)

    @property
    def diagram_tool_ReconnectEdgeDescription410(self):
        return self.__diagram_tool_ReconnectEdgeDescription410

    @diagram_tool_ReconnectEdgeDescription410.setter
    def diagram_tool_ReconnectEdgeDescription410(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_diagram_tool_ReconnectEdgeDescription__diagram_tool_ReconnectEdgeDescription410", None)
        self.__diagram_tool_ReconnectEdgeDescription410 = value
    ...
    def diagram_tool_ReconnectEdgeDescription(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tool_SourceEdgeCreationVariable399"):
                opp_val = getattr(old_value, "tool_SourceEdgeCreationVariable399", None)
                if opp_val == self:
                    setattr(old_value, "tool_SourceEdgeCreationVariable399", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tool_SourceEdgeCreationVariable399"):
                opp_val = getattr(value, "tool_SourceEdgeCreationVariable399", None)
                setattr(value, "tool_SourceEdgeCreationVariable399", self)
...
class diagram_tool_ContainerCreationDescription(MappingBasedToolDescription):
    ...
    def __init__(self, iconPath: str, diagram_tool_ContainerCreationDescription374: set["AbstractNodeMapping"] = None, diagram_tool_ContainerCreationDescription: set["ContainerMapping"] = None, diagram_tool_ContainerCreationDescription365: "tool_NodeCreationVariable" = None, diagram_tool_ContainerCreationDescription368: "tool_ContainerViewVariable" = None, diagram_tool_ContainerCreationDescription371: "tool_InitialNodeCreationOperation" = None):
...
class diagram_tool_ContainerDropDescription(MappingBasedToolDescription):
    ...
    def __init__(self, dragSource: str, moveEdges: bool, diagram_tool_ContainerDropDescription: set["DiagramElementMapping"] = None, diagram_tool_ContainerDropDescription434: "tool_DropContainerVariable" = None, diagram_tool_ContainerDropDescription436: "tool_DropContainerVariable" = None, diagram_tool_ContainerDropDescription439: "tool_ElementDropVariable" = None, diagram_tool_ContainerDropDescription441: "tool_ContainerViewVariable" = None, diagram_tool_ContainerDropDescription444: "tool_InitialContainerDropOperation" = None):
        ...
        self.diagram_tool_ContainerDropDescription434 = diagram_tool_ContainerDropDescription434
        self.diagram_tool_ContainerDropDescription436 = diagram_tool_ContainerDropDescription436
    ...
    @property
    def diagram_tool_ContainerDropDescription436(self):
        return self.__diagram_tool_ContainerDropDescription436

    @diagram_tool_ContainerDropDescription436.setter
    def diagram_tool_ContainerDropDescription436(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_diagram_tool_ContainerDropDescription__diagram_tool_ContainerDropDescription436", None)
        self.__diagram_tool_ContainerDropDescription436 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tool_DropContainerVariable437"):
                opp_val = getattr(old_value, "tool_DropContainerVariable437", None)
                if opp_val == self:
                    setattr(old_value, "tool_DropContainerVariable437", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tool_DropContainerVariable437"):
                opp_val = getattr(value, "tool_DropContainerVariable437", None)
                setattr(value, "tool_DropContainerVariable437", self)

    @property
    def diagram_tool_ContainerDropDescription434(self):
        return self.__diagram_tool_ContainerDropDescription434

    @diagram_tool_ContainerDropDescription434.setter
    def diagram_tool_ContainerDropDescription434(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_diagram_tool_ContainerDropDescription__diagram_tool_ContainerDropDescription434", None)
        self.__diagram_tool_ContainerDropDescription434 = value
    ...
    def diagram_tool_ContainerDropDescription(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "DiagramElementMapping432"):
                    opp_val = getattr(item, "DiagramElementMapping432", None)
                    
                    if opp_val == self:
                        setattr(item, "DiagramElementMapping432", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "DiagramElementMapping432"):
                    ...
                    setattr(item, "DiagramElementMapping432", self)
    ...
    def diagram_tool_ContainerDropDescription441(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tool_ContainerViewVariable442"):
                opp_val = getattr(old_value, "tool_ContainerViewVariable442", None)
                if opp_val == self:
                    setattr(old_value, "tool_ContainerViewVariable442", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tool_ContainerViewVariable442"):
                opp_val = getattr(value, "tool_ContainerViewVariable442", None)
                setattr(value, "tool_ContainerViewVariable442", self)
...
class diagram_tool_DirectEditLabel(MappingBasedToolDescription):
    ...
    def __init__(self, inputLabelExpression: str, diagram_tool_DirectEditLabel: "tool_EditMaskVariables" = None, diagram_tool_DirectEditLabel419: "tool_InitialOperation" = None):
        self.inputLabelExpression = inputLabelExpression
        self.diagram_tool_DirectEditLabel = diagram_tool_DirectEditLabel
        self.diagram_tool_DirectEditLabel419 = diagram_tool_DirectEditLabel419
    ...
    @property
    def diagram_tool_DirectEditLabel419(self):
        return self.__diagram_tool_DirectEditLabel419

    @diagram_tool_DirectEditLabel419.setter
    def diagram_tool_DirectEditLabel419(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_diagram_tool_DirectEditLabel__diagram_tool_DirectEditLabel419", None)
        self.__diagram_tool_DirectEditLabel419 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tool_InitialOperation420"):
                opp_val = getattr(old_value, "tool_InitialOperation420", None)
                if opp_val == self:
                    setattr(old_value, "tool_InitialOperation420", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tool_InitialOperation420"):
                opp_val = getattr(value, "tool_InitialOperation420", None)
                setattr(value, "tool_InitialOperation420", self)
...
class diagram_style_GaugeSectionDescription:
    ...
    def __init__(self, maxValueExpression: str, valueExpression: str, label: str, minValueExpression: str, diagram_style_GaugeSectionDescription: "ColorDescription" = None, diagram_style_GaugeSectionDescription289: "ColorDescription" = None):
...
class style_BorderedStyleDescription:
    ...
    pass
class diagram_style_ContainerStyleDescription(style_BorderedStyleDescription, style_LabelStyleDescription, style_RoundedCornerStyleDescription, style_TooltipStyleDescription, style_HideLabelCapabilityStyleDescription):
...
class diagram_style_EdgeStyleDescription(StyleDescription):
    ...
    def __init__(self, routingStyle: str, foldingStyle: str, endsCentering: str, lineStyle: str, sourceArrow: str, targetArrow: str, sizeComputationExpression: str, diagram_style_EdgeStyleDescription305: "style_CenterLabelStyleDescription" = None, diagram_style_EdgeStyleDescription307: "style_EndLabelStyleDescription" = None, diagram_style_EdgeStyleDescription309: set["DiagramElementMapping"] = None, diagram_style_EdgeStyleDescription312: set["DiagramElementMapping"] = None, diagram_style_EdgeStyleDescription303: "style_BeginLabelStyleDescription" = None, diagram_style_EdgeStyleDescription: "ColorDescription" = None):
...
class diagram_description_StringLayoutOption(LayoutOption):
    ...
    def __init__(self, value: str, LayoutOption: "diagram_description_CustomLayoutConfiguration" = None):
        self.value = value
...
class diagram_description_IntegerLayoutOption(LayoutOption):
    ...
    def __init__(self, value: int, LayoutOption: "diagram_description_CustomLayoutConfiguration" = None):
        self.value = value
...
class diagram_description_DoubleLayoutOption(LayoutOption):
    ...
    def __init__(self, value: float, LayoutOption: "diagram_description_CustomLayoutConfiguration" = None):
        self.value = value
...
class diagram_description_DiagramDescription(description_DragAndDropTargetDescription, description_PasteTargetDescription, description_RepresentationDescription):
    ...
    def __init__(self, domainClass: str, preconditionExpression: str, enablePopupBars: bool, rootExpression: str, diagram_description_DiagramDescription133: "concern_ConcernDescription" = None, diagram_description_DiagramDescription: set["filter_FilterDescription"] = None, diagram_description_DiagramDescription125: set["EdgeMapping"] = None, diagram_description_DiagramDescription127: "validation_ValidationSet" = None, diagram_description_DiagramDescription129: "concern_ConcernSet" = None, diagram_description_DiagramDescription131: set["tool_AbstractToolDescription"] = None, diagram_description_DiagramDescription164: set["tool_AbstractToolDescription"] = None, diagram_description_DiagramDescription167: "ColorDescription" = None, diagram_description_DiagramDescription136: "tool_RepresentationCreationDescription" = None, diagram_description_DiagramDescription138: "Layout" = None, diagram_description_DiagramDescription140: "tool_InitialOperation" = None, diagram_description_DiagramDescription142: "Layer" = None, diagram_description_DiagramDescription145: set["AdditionalLayer"] = None, diagram_description_DiagramDescription148: set["NodeMapping"] = None, diagram_description_DiagramDescription151: set["EdgeMapping"] = None, diagram_description_DiagramDescription154: set["EdgeMappingImport"] = None, diagram_description_DiagramDescription156: set["ContainerMapping"] = None, diagram_description_DiagramDescription159: set["DiagramElementMapping"] = None, diagram_description_DiagramDescription162: "tool_ToolSection" = None):
        self.domainClass = domainClass
...
class style_StyleDescription:
    ...
    pass
class diagram_style_NodeStyleDescription(style_BorderedStyleDescription, style_LabelStyleDescription, style_StyleDescription, style_TooltipStyleDescription, style_HideLabelCapabilityStyleDescription):
...
class diagram_Dot(NodeStyle):
    ...
    def __init__(self, backgroundColor: str, strokeSizeComputationExpression: str):
        self.backgroundColor = backgroundColor
        self.strokeSizeComputationExpression = strokeSizeComputationExpression
...
class diagram_EdgeStyle(Style):
    ...
    def __init__(self, sourceArrow: str, targetArrow: str, foldingStyle: str, size: str, lineStyle: str, routingStyle: str, centered: str, strokeColor: str, diagram_EdgeStyle: "diagram_DEdge" = None, diagram_EdgeStyle109: "diagram_BeginLabelStyle" = None, diagram_EdgeStyle111: "diagram_CenterLabelStyle" = None, diagram_EdgeStyle113: "diagram_EndLabelStyle" = None):
        self.sourceArrow = sourceArrow
        self.targetArrow = targetArrow
        self.foldingStyle = foldingStyle
        self.size = size
...
class diagram_Style:
    ...
    pass
class diagram_NodeStyle(BorderedStyle, LabelStyle, HideLabelCapabilityStyle, Style):

    def __init__(self, labelPosition: str, diagram_NodeStyle83: "diagram_DNodeListElement" = None, diagram_NodeStyle: "diagram_DNode" = None):
        self.labelPosition = labelPosition
...
class diagram_ContainerStyle(BorderedStyle, LabelStyle, HideLabelCapabilityStyle, Style):
...
class diagram_description_AdditionalLayer(Layer):
    ...
    def __init__(self, activeByDefault: bool, optional: bool, Layer36: "diagram_DDiagramElement" = None, Layer: "diagram_DDiagram" = None, Layer143: "diagram_description_DiagramDescription" = None):
...
class diagram_DEdge(EdgeTarget, DDiagramElement):
    ...
    def __init__(self, size: str, routingStyle: str, isFold: bool, isMockEdge: bool, arrangeConstraints: str, beginLabel: str, endLabel: str, outgoingEdges: "diagram_EdgeTarget" = None, diagram_DEdge: "diagram_DDiagram" = None, diagram_DEdge94: "diagram_EdgeStyle" = None, incomingEdges: "diagram_EdgeTarget" = None, diagram_DEdge99: "IEdgeMapping" = None, diagram_DEdge101: "diagram_Style" = None, diagram_DEdge104: set["diagram_EdgeTarget"] = None, DEdge: "diagram_EdgeTarget" = None, DEdge107: "diagram_EdgeTarget" = None):
        self.size = size
        self.routingStyle = routingStyle
        self.isFold = isFold
...
class DragAndDropTarget:
    ...
    pass
class diagram_DNode(DragAndDropTarget, AbstractDNode, EdgeTarget):
...
class diagram_DDiagram(DRepresentation, DragAndDropTarget):
    ...
    def __init__(self, synchronized: bool, isInLayoutingMode: bool, isInShowingMode: bool, headerHeight: int, diagram_DDiagram19: set["AdditionalLayer"] = None, diagram_DDiagram21: set["filter_FilterDescription"] = None, diagram_DDiagram24: set["validation_ValidationRule"] = None, diagram_DDiagram: set["diagram_DDiagramElement"] = None, diagram_DDiagram2: set["diagram_DDiagramElement"] = None, diagram_DDiagram5: "DiagramDescription" = None, diagram_DDiagram7: set["diagram_DEdge"] = None, diagram_DDiagram9: set["diagram_DNode"] = None, diagram_DDiagram11: set["diagram_DNodeListElement"] = None, diagram_DDiagram13: set["diagram_DDiagramElementContainer"] = None, diagram_DDiagram15: "concern_ConcernDescription" = None, diagram_DDiagram17: set["filter_FilterDescription"] = None, diagram_DDiagram26: set["tool_BehaviorTool"] = None, diagram_DDiagram28: "diagram_FilterVariableHistory" = None, diagram_DDiagram30: set["Layer"] = None, diagram_DDiagram32: set["diagram_DDiagramElement"] = None):
...
class diagram_description_CustomLayoutConfiguration(Layout):
    ...
    def __init__(self, id: str, label: str, description: str, diagram_description_CustomLayoutConfiguration: set["LayoutOption"] = None, Layout: "diagram_description_DiagramDescription" = None):
        self.id = id
        self.label = label
        self.description = description
...
class diagram_description_BooleanLayoutOption(LayoutOption):
    ...
    def __init__(self, value: bool, LayoutOption: "diagram_description_CustomLayoutConfiguration" = None):
        self.value = value
...
class diagram_style_ShapeContainerStyleDescription(style_ContainerStyleDescription, style_SizeComputationContainerStyleDescription):
    ...
    def __init__(self, shape: str, diagram_style_ShapeContainerStyleDescription: "ColorDescription" = None, style_ContainerStyleDescription: "diagram_description_ContainerMapping" = None, style_ContainerStyleDescription232: "diagram_description_ConditionalContainerStyleDescription" = None):
        self.shape = shape
...
class diagram_style_WorkspaceImageDescription(style_ContainerStyleDescription, style_NodeStyleDescription):
    ...
    def __init__(self, workspacePath: str, style_NodeStyleDescription: "diagram_description_NodeMapping" = None, style_NodeStyleDescription228: "diagram_description_ConditionalNodeStyleDescription" = None, style_ContainerStyleDescription: "diagram_description_ContainerMapping" = None, style_ContainerStyleDescription232: "diagram_description_ConditionalContainerStyleDescription" = None):
        self.workspacePath = workspacePath
...
class diagram_tool_ToolSection(description_IdentifiedElement, description_DocumentedElement):
    ...
    def __init__(self, icon: str, diagram_tool_ToolSection319: set["tool_PopupMenu"] = None, diagram_tool_ToolSection321: set["tool_ToolEntry"] = None, diagram_tool_ToolSection324: set["tool_ToolGroupExtension"] = None, diagram_tool_ToolSection326: set["tool_GroupMenu"] = None, diagram_tool_ToolSection: set["tool_ToolEntry"] = None, diagram_tool_ToolSection316: set["tool_ToolSection"] = None):
        self.icon = icon
...
class diagram_description_DiagramElementMapping(description_RepresentationElementMapping, description_PasteTargetDescription):
    ...
    def __init__(self, synchronizationLock: bool, preconditionExpression: str, semanticCandidatesExpression: str, createElements: bool, semanticElements: str, mappings: "tool_DoubleClickDescription" = None, diagram_description_DiagramElementMapping: "tool_DeleteElementDescription" = None, diagram_description_DiagramElementMapping180: "tool_DirectEditLabel" = None):
