...
domain_model = DomainModel(
    name="bibtex",
    types={bibtex_Author, Person, bibtex_Editor, bibtex_StringValue, bibtex_YearValue, bibtex_IntValue, bibtex_Page, IntValue, bibtex_Field, bibtex_AuthorField, Field, bibtex_EditorField, bibtex_Person, bibtex_MonthField, bibtex_OrganizationField, bibtex_NoteField, bibtex_PublisherField, bibtex_PartField, bibtex_EidField, bibtex_UrlField, bibtex_Keyword, bibtex_KeywordField, bibtex_AbstractField, bibtex_ReviewField, bibtex_TitleField, StringValue, bibtex_BookTitleField, bibtex_NumberField, bibtex_YearField, YearValue, bibtex_BibtexKeyField, bibtex_JournalField, bibtex_VolumeField, bibtex_PageField, bibtex_SeriesField, bibtex_AddressField, bibtex_Entry, bibtex_InProceedingsEntry, Entry, bibtex_Bibliography, bibtex_ArticleEntry},
    associations={authors0, keywords6, editors1, fromPage2, toPage3, title19, bookTitle21, year23, editor25, pages28, volume31, number33, series35, address37, bibtexKey7, abstract8, url10, keyword12, review15, author17, volume60, number63, month66, note69, part72, eid74, entries76, month39, organization41, note43, publisher45, author47, title49, year52, journal55, pages57},
    generalizations={gen_bibtex_Author_Person, gen_bibtex_Editor_Person, gen_bibtex_Page_IntValue, gen_bibtex_AuthorField_Field, gen_bibtex_AddressField_Field, gen_bibtex_AddressField_StringValue, gen_bibtex_MonthField_Field, gen_bibtex_MonthField_StringValue, gen_bibtex_OrganizationField_Field, gen_bibtex_OrganizationField_StringValue, gen_bibtex_NoteField_Field, gen_bibtex_NoteField_StringValue, gen_bibtex_PublisherField_Field, gen_bibtex_PublisherField_StringValue, gen_bibtex_PartField_IntValue, gen_bibtex_PartField_Field, gen_bibtex_EidField_Field, gen_bibtex_EidField_StringValue, gen_bibtex_UrlField_StringValue, gen_bibtex_UrlField_Field, gen_bibtex_Keyword_StringValue, gen_bibtex_KeywordField_Field, gen_bibtex_AbstractField_StringValue, gen_bibtex_AbstractField_Field, gen_bibtex_ReviewField_StringValue, gen_bibtex_EditorField_Field, gen_bibtex_TitleField_Field, gen_bibtex_TitleField_StringValue, gen_bibtex_BookTitleField_Field, gen_bibtex_BookTitleField_StringValue, gen_bibtex_NumberField_IntValue, gen_bibtex_NumberField_Field, gen_bibtex_YearField_Field, gen_bibtex_YearField_YearValue, gen_bibtex_BibtexKeyField_Field, gen_bibtex_BibtexKeyField_StringValue, gen_bibtex_JournalField_Field, gen_bibtex_JournalField_StringValue, gen_bibtex_VolumeField_Field, gen_bibtex_VolumeField_IntValue, gen_bibtex_PageField_Field, gen_bibtex_SeriesField_StringValue, gen_bibtex_SeriesField_Field, gen_bibtex_ReviewField_Field, gen_bibtex_InProceedingsEntry_Entry, gen_bibtex_ArticleEntry_Entry},
    metadata=None
)
