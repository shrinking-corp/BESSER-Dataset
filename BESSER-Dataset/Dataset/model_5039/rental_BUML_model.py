...
rental_Address.attributes={rental_Address_streetName, rental_Address_city, rental_Address_zipCode, rental_Address_number, rental_Address_streetType}
...
rental_RentalAgency_m_book: Method = Method(name="book", parameters={Parameter(name='rental_from_', type=StringType), Parameter(name='rental_rentedObject', type=StringType), Parameter(name='rental_customer', type=StringType), Parameter(name='rental_to', type=StringType)}, type=StringType)
rental_RentalAgency_m_addCustomer: Method = Method(name="addCustomer", parameters={Parameter(name='rental_customer', type=StringType)})
rental_RentalAgency_m_addObject: Method = Method(name="addObject", parameters={Parameter(name='rental_object', type=StringType)})
rental_RentalAgency.attributes={rental_RentalAgency_name}
rental_RentalAgency.methods={rental_RentalAgency_m_book, rental_RentalAgency_m_addCustomer, rental_RentalAgency_m_addObject}
...
rental_RentalObject.attributes={rental_RentalObject_ID, rental_RentalObject_name, rental_RentalObject_picture}
rental_RentalObject.methods={rental_RentalObject_m_isAvailable, rental_RentalObject_m_rent}
...
rental_Rental.methods={rental_Rental_m_nbDaysRented, rental_Rental_m_end, rental_Rental_m_nbDaysBooked, rental_Rental_m_start}
...
domain_model = DomainModel(
    name="rental",
    types={rental_Address, rental_License, rental_RentalAgency, rental_Customer, rental_RentalObject, rental_Rental, StreetType},
    associations={address0, licenses1, parentAgency2, parentAgency10, owner12, address3, objectsToRent5, customers6, rentals8, customer14, rentedObject17, parentAgency19},
    generalizations={},
    metadata=None
)
