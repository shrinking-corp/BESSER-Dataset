...
class rental_RentalObject:
    ...
    def __init__(self, name: str, picture: str, ID: str, objectsToRent: "rental_RentalAgency" = None, RentalObject: "rental_RentalAgency" = None, rental_RentalObject: "rental_Rental" = None):
        self.name = name
...
class rental_Customer:
    ...
    def __init__(self, firstName: str, lastName: str, rental_Customer: "rental_Address" = None, owner: set["rental_License"] = None, customers: "rental_RentalAgency" = None, Customer13: "rental_License" = None, Customer: "rental_RentalAgency" = None, rental_Customer16: "rental_Rental" = None):
...
class rental_RentalAgency:
    ...
    def __init__(self, name: str, RentalAgency: "rental_Customer" = None, RentalAgency11: "rental_RentalObject" = None, rental_RentalAgency: "rental_Address" = None, parentAgency: set["rental_RentalObject"] = None, parentAgency7: set["rental_Customer"] = None, rental_RentalAgency9: set["rental_Rental"] = None, rental_RentalAgency21: "rental_Rental" = None):
        self.name = name
    ...
    def book(self, rental_rentedObject, rental_to, rental_from_, rental_customer) :
