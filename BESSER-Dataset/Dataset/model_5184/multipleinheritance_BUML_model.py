...
# Classes
MultipleInheritance_Model = Class(name="MultipleInheritance_Model")
MultipleInheritance_Object = Class(name="MultipleInheritance_Object", is_abstract=True)
MultipleInheritance_A = Class(name="MultipleInheritance_A")
Object = Class(name="Object")
MultipleInheritance_D = Class(name="MultipleInheritance_D")
MultipleInheritance_B = Class(name="MultipleInheritance_B")
MultipleInheritance_C = Class(name="MultipleInheritance_C")
A = Class(name="A")
B = Class(name="B")
...
domain_model = DomainModel(
    ...
    associations={objects0, fieldOfB2, fieldOfA1},
