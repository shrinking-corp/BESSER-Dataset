...
stateChart_Model.attributes={stateChart_Model_metadata, stateChart_Model_name, stateChart_Model_description}
...
stateChart_Node.attributes={stateChart_Node_actions, stateChart_Node_label, stateChart_Node_metadata, stateChart_Node_type, stateChart_Node_activity, stateChart_Node_name}
...
domain_model = DomainModel(
    name="stateChart",
    types={stateChart_Variable, stateChart_Transition, stateChart_Model, stateChart_Node},
