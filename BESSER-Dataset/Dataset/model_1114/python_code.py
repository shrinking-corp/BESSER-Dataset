...
class stateChart_Node:
    ...
    def __init__(self, activity: str, actions: str, metadata: str, name: str, label: str, type: str, stateChart_Node21: "stateChart_Transition" = None, stateChart_Node: set["stateChart_Variable"] = None, stateChart_Node24: "stateChart_Transition" = None, Node: "stateChart_Node" = None, Father: set["stateChart_Node"] = None, Node5: "stateChart_Node" = None, Children: "stateChart_Node" = None, stateChart_Node7: set["stateChart_Transition"] = None, stateChart_Node9: "stateChart_Transition" = None, stateChart_Node12: "stateChart_Model" = None):
...
class stateChart_Model:
    ...
    def __init__(self, name: str, description: str, metadata: str, stateChart_Model17: set["stateChart_Transition"] = None, stateChart_Model: set["stateChart_Node"] = None, stateChart_Model14: set["stateChart_Variable"] = None):
        self.name = name
...
class stateChart_Transition:
    ...
    def __init__(self, TE: str, name: str, metadata: str, stateChart_Transition18: "stateChart_Model" = None, stateChart_Transition20: "stateChart_Node" = None, stateChart_Transition23: "stateChart_Node" = None, stateChart_Transition: "stateChart_Node" = None, stateChart_Transition10: "stateChart_Node" = None):
        self.TE = TE
        self.name = name
        self.metadata = metadata
