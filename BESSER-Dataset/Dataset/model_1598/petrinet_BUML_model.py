...
domain_model = DomainModel(
    ...
    generalizations={gen_Petrinet_Place_Node, gen_Petrinet_Node_Element, gen_Petrinet_Arc_Element, gen_Petrinet_OutputArc_Arc, gen_Petrinet_InputArc_Arc, gen_Petrinet_Transition_Node},
    metadata=None
)
