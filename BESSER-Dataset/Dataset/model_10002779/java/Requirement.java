...
public class Requirement  {
    ...
    public Requirement(
        String requirement_location,        String requirement_type,        String user_id,        String req_description    ) {
    ...
    public Requirement(
        String requirement_location,        String requirement_type,        String user_id,        String req_description        ArrayList<Reg_User> reg_users    ) {
        this.requirement_location = requirement_location;
        this.requirement_type = requirement_type;
        this.user_id = user_id;
        this.req_description = req_description;
