...
class trace_TraceLink:
    ...
    def __init__(self, targetValue: str, sourceValue: str, name: str, similarity: int, requiredSimilarity: int, rationale: str, similarityMethod: int, trace_TraceLink: "trace_Trace" = None, trace_TraceLink7: "trace_EObject" = None, trace_TraceLink10: "trace_EObject" = None):
    ...
    def sameAs(self, trace_tracelink) :
