...
trace_TraceLink_m_sameAs: Method = Method(name="sameAs", parameters={Parameter(name='trace_tracelink', type=StringType)}, type=BooleanType)
trace_TraceLink.attributes={trace_TraceLink_targetValue, trace_TraceLink_sourceValue, trace_TraceLink_rationale, trace_TraceLink_similarityMethod, trace_TraceLink_requiredSimilarity, trace_TraceLink_similarity, trace_TraceLink_name}
