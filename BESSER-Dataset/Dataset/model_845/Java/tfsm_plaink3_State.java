...
public class tfsm_plaink3_State extends NamedElement {
    ...
    public tfsm_plaink3_State(
        ArrayList<tfsm_plaink3_Transition> tfsm_plaink3_transitions,        ArrayList<tfsm_plaink3_Transition> tfsm_plaink3_transitions    ) {
