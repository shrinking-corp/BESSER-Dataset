...
tfsm_plaink3_State.methods={tfsm_plaink3_State_m_onEnter, tfsm_plaink3_State_m_visit, tfsm_plaink3_State_m_onLeave}
...
tfsm_plaink3_TimedSystem_m_initializeModel: Method = Method(name="initializeModel", parameters={Parameter(name='tfsm_plaink3_args', type=StringType)})
tfsm_plaink3_TimedSystem_m_visit: Method = Method(name="visit", parameters={})
tfsm_plaink3_TimedSystem.methods={tfsm_plaink3_TimedSystem_m_initializeModel, tfsm_plaink3_TimedSystem_m_main, tfsm_plaink3_TimedSystem_m_visit}
...
domain_model = DomainModel(
    name="tfsm_plaink3",
    types={tfsm_plaink3_TFSM, NamedElement, tfsm_plaink3_State, tfsm_plaink3_Guard, tfsm_plaink3_FSMEvent, tfsm_plaink3_FSMClock, tfsm_plaink3_Transition, tfsm_plaink3_TimedSystem, tfsm_plaink3_NamedElement, tfsm_plaink3_TemporalGuard, Guard, tfsm_plaink3_EventGuard, tfsm_plaink3_EvaluateGuard},
    associations={ownedStates0, source15, target17, ownedGuard19, generatedEvents21, initialState1, localEvents2, localClock4, ownedTransitions6, currentState8, owningFSM11, outgoingTransitions12, incomingTransitions13, tfsms31, globalClocks33, globalEvents36, onClock24, triggeringEvent26, sollicitingTransitions28},
    generalizations={gen_tfsm_plaink3_TFSM_NamedElement, gen_tfsm_plaink3_State_NamedElement, gen_tfsm_plaink3_Transition_NamedElement, gen_tfsm_plaink3_TimedSystem_NamedElement, gen_tfsm_plaink3_Guard_NamedElement, gen_tfsm_plaink3_TemporalGuard_Guard, gen_tfsm_plaink3_EventGuard_Guard, gen_tfsm_plaink3_FSMEvent_NamedElement, gen_tfsm_plaink3_FSMClock_NamedElement, gen_tfsm_plaink3_EvaluateGuard_Guard},
    metadata=None
)
