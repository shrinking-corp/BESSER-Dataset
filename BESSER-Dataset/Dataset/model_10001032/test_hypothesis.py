...
def test_check_attendance_external_is_not_abstract():
    assert not inspect.isabstract(check_attendance_external)


def test_check_attendance_external_constructor_exists():
    assert callable(check_attendance_external.__init__)


def test_check_attendance_external_constructor_args():
    sig = inspect.signature(check_attendance_external.__init__)
    params = list(sig.parameters.keys())



def test_add_student_external_is_not_abstract():
    assert not inspect.isabstract(add_student_external)


def test_add_student_external_constructor_exists():
    assert callable(add_student_external.__init__)


def test_add_student_external_constructor_args():
    sig = inspect.signature(add_student_external.__init__)
    params = list(sig.parameters.keys())



def test_view_student_external_is_not_abstract():
    assert not inspect.isabstract(view_student_external)


def test_view_student_external_constructor_exists():
    assert callable(view_student_external.__init__)


def test_view_student_external_constructor_args():
    sig = inspect.signature(view_student_external.__init__)
    params = list(sig.parameters.keys())



def test_student_login_external_is_not_abstract():
    assert not inspect.isabstract(student_login_external)


def test_student_login_external_constructor_exists():
    assert callable(student_login_external.__init__)


def test_student_login_external_constructor_args():
