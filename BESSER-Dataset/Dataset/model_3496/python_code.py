...
class servicefeaturemodel_ServiceFeature(ABC):
    ...
    def __init__(self, name: str, description: str, minAmount: int, maxAmount: int, mapsToGSMElement: bool, associatedGSMElement: str, id: str, featureType: str, required: bool, servicefeaturemodel_ServiceFeature21: "servicefeaturemodel_Requires" = None, servicefeaturemodel_ServiceFeature24: "servicefeaturemodel_Excludes" = None, servicefeaturemodel_ServiceFeature27: "servicefeaturemodel_ServiceFeatureDiagram" = None, servicefeaturemodel_ServiceFeature46: "servicefeaturemodel_FeatureToAttributeModifyRelationship" = None, servicefeaturemodel_ServiceFeature: set["servicefeaturemodel_Attribute"] = None, servicefeaturemodel_ServiceFeature7: "servicefeaturemodel_Variant" = None, servicefeaturemodel_ServiceFeature9: set["servicefeaturemodel_Requires"] = None, servicefeaturemodel_ServiceFeature11: set["servicefeaturemodel_Excludes"] = None, servicefeaturemodel_ServiceFeature14: "servicefeaturemodel_ServiceFeature" = None, servicefeaturemodel_ServiceFeature12: set["servicefeaturemodel_ServiceFeature"] = None, servicefeaturemodel_ServiceFeature29: "servicefeaturemodel_Configuration" = None):
        self.name = name
        self.description = description
...
class servicefeaturemodel_ServiceFeatureDiagram:
    ...
    def __init__(self, name: str, description: str, id: str, servicefeaturemodel_ServiceFeatureDiagram26: set["servicefeaturemodel_ServiceFeature"] = None, servicefeaturemodel_ServiceFeatureDiagram: "servicefeaturemodel_Service" = None):
        self.name = name
        self.description = description
        self.id = id
...
class servicefeaturemodel_Attribute:
    ...
    def __init__(self, instantiationValue: str, id: str, servicefeaturemodel_Attribute16: "servicefeaturemodel_AttributeType" = None, servicefeaturemodel_Attribute18: set["servicefeaturemodel_ModifyRelationship"] = None, servicefeaturemodel_Attribute44: "servicefeaturemodel_AttributeToAttributeModifyRelationship" = None, servicefeaturemodel_Attribute: "servicefeaturemodel_ServiceFeature" = None, servicefeaturemodel_Attribute34: "servicefeaturemodel_Configuration" = None):
