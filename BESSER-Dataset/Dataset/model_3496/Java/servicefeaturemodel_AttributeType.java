...
public class servicefeaturemodel_AttributeType  {
    ...
    public servicefeaturemodel_AttributeType(
        String aggregationRule,        int customAttributeTypePriority,        String scaleOrder,        boolean toBeEvaluated,        String name,        String domain,        String description,        String requirement    ) {
