...
# Classes
servicefeaturemodel_Attribute = Class(name="servicefeaturemodel_Attribute")
servicefeaturemodel_Variant = Class(name="servicefeaturemodel_Variant", is_abstract=True)
servicefeaturemodel_Requires = Class(name="servicefeaturemodel_Requires")
servicefeaturemodel_Excludes = Class(name="servicefeaturemodel_Excludes")
servicefeaturemodel_OptionalServiceFeature = Class(name="servicefeaturemodel_OptionalServiceFeature")
ServiceFeature = Class(name="ServiceFeature")
servicefeaturemodel_Service = Class(name="servicefeaturemodel_Service")
servicefeaturemodel_ServiceFeatureDiagram = Class(name="servicefeaturemodel_ServiceFeatureDiagram")
servicefeaturemodel_PossibleConfigurations = Class(name="servicefeaturemodel_PossibleConfigurations")
servicefeaturemodel_AttributeTypes = Class(name="servicefeaturemodel_AttributeTypes")
servicefeaturemodel_ServiceFeature = Class(name="servicefeaturemodel_ServiceFeature", is_abstract=True)
servicefeaturemodel_Configuration = Class(name="servicefeaturemodel_Configuration")
servicefeaturemodel_Preference = Class(name="servicefeaturemodel_Preference")
servicefeaturemodel_MandatoryServiceFeature = Class(name="servicefeaturemodel_MandatoryServiceFeature")
servicefeaturemodel_AttributeType = Class(name="servicefeaturemodel_AttributeType")
servicefeaturemodel_ModifyRelationship = Class(name="servicefeaturemodel_ModifyRelationship", is_abstract=True)
servicefeaturemodel_OR = Class(name="servicefeaturemodel_OR")
Variant = Class(name="Variant")
servicefeaturemodel_XOR = Class(name="servicefeaturemodel_XOR")
servicefeaturemodel_AttributeToAttributeModifyRelationship = Class(name="servicefeaturemodel_AttributeToAttributeModifyRelationship")
ModifyRelationship = Class(name="ModifyRelationship")
servicefeaturemodel_FeatureToAttributeModifyRelationship = Class(name="servicefeaturemodel_FeatureToAttributeModifyRelationship")
...
servicefeaturemodel_Service.attributes={servicefeaturemodel_Service_id, servicefeaturemodel_Service_name, servicefeaturemodel_Service_description}
...
servicefeaturemodel_ServiceFeatureDiagram_m_validate: Method = Method(name="validate", parameters={Parameter(name='servicefeaturemodel_context', type=StringType), Parameter(name='servicefeaturemodel_diagnostic', type=StringType)}, type=BooleanType)
...
servicefeaturemodel_ServiceFeature_m_validate: Method = Method(name="validate", parameters={Parameter(name='servicefeaturemodel_diagnostic', type=StringType), Parameter(name='servicefeaturemodel_context', type=StringType)}, type=BooleanType)
servicefeaturemodel_ServiceFeature.attributes={servicefeaturemodel_ServiceFeature_required, servicefeaturemodel_ServiceFeature_minAmount, servicefeaturemodel_ServiceFeature_description, servicefeaturemodel_ServiceFeature_name, servicefeaturemodel_ServiceFeature_maxAmount, servicefeaturemodel_ServiceFeature_associatedGSMElement, servicefeaturemodel_ServiceFeature_featureType, servicefeaturemodel_ServiceFeature_id, servicefeaturemodel_ServiceFeature_mapsToGSMElement}
...
servicefeaturemodel_Configuration_m_validate: Method = Method(name="validate", parameters={Parameter(name='servicefeaturemodel_context', type=StringType), Parameter(name='servicefeaturemodel_diagnostic', type=StringType)}, type=BooleanType)
...
servicefeaturemodel_Preference.attributes={servicefeaturemodel_Preference_value, servicefeaturemodel_Preference_description, servicefeaturemodel_Preference_creationDate, servicefeaturemodel_Preference_stakeholderGroup}
...
servicefeaturemodel_AttributeType.attributes={servicefeaturemodel_AttributeType_name, servicefeaturemodel_AttributeType_customAttributeTypePriority, servicefeaturemodel_AttributeType_aggregationRule, servicefeaturemodel_AttributeType_requirement, servicefeaturemodel_AttributeType_description, servicefeaturemodel_AttributeType_toBeEvaluated, servicefeaturemodel_AttributeType_domain, servicefeaturemodel_AttributeType_scaleOrder}
...
servicefeaturemodel_ModifyRelationship.attributes={servicefeaturemodel_ModifyRelationship_function, servicefeaturemodel_ModifyRelationship_orderNumber, servicefeaturemodel_ModifyRelationship_name, servicefeaturemodel_ModifyRelationship_targetParameterName}
...
domain_model = DomainModel(
    ...
    types={servicefeaturemodel_Attribute, servicefeaturemodel_Variant, servicefeaturemodel_Requires, servicefeaturemodel_Excludes, servicefeaturemodel_OptionalServiceFeature, ServiceFeature, servicefeaturemodel_Service, servicefeaturemodel_ServiceFeatureDiagram, servicefeaturemodel_PossibleConfigurations, servicefeaturemodel_AttributeTypes, servicefeaturemodel_ServiceFeature, servicefeaturemodel_Configuration, servicefeaturemodel_Preference, servicefeaturemodel_MandatoryServiceFeature, servicefeaturemodel_AttributeType, servicefeaturemodel_ModifyRelationship, servicefeaturemodel_OR, Variant, servicefeaturemodel_XOR, servicefeaturemodel_AttributeToAttributeModifyRelationship, ModifyRelationship, servicefeaturemodel_FeatureToAttributeModifyRelationship, FeatureTypes, AttributeDomain, AggregationRules, ScaleOrders},
    associations={describedBy5, containsVariant6, containsRequires8, containsExcludes10, decomposesInto13, representedBy0, enables1, has3, groups28, evaluatedBy30, describedBy32, contains35, ofAttributeType15, containsModifyRelationship17, requiresServiceFeature19, excludesServiceFeature22, containsFeatures25, triggeredByAttribute43, triggeredByServiceFeature45, contains37, contains40},
    generalizations={gen_servicefeaturemodel_OptionalServiceFeature_ServiceFeature, gen_servicefeaturemodel_MandatoryServiceFeature_ServiceFeature, gen_servicefeaturemodel_OR_Variant, gen_servicefeaturemodel_XOR_Variant, gen_servicefeaturemodel_AttributeToAttributeModifyRelationship_ModifyRelationship, gen_servicefeaturemodel_FeatureToAttributeModifyRelationship_ModifyRelationship},
    metadata=None
)
