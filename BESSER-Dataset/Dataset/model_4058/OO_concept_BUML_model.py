...
# Classes
simple_OO_concept_Package = Class(name="simple_OO_concept_Package")
NamedElement = Class(name="NamedElement")
simple_OO_concept_Class = Class(name="simple_OO_concept_Class")
simple_OO_concept_Dependency = Class(name="simple_OO_concept_Dependency")
simple_OO_concept_Attribute = Class(name="simple_OO_concept_Attribute")
simple_OO_concept_Operation = Class(name="simple_OO_concept_Operation")
simple_OO_concept_NamedElement = Class(name="simple_OO_concept_NamedElement", is_abstract=True)
simple_OO_concept_Feature = Class(name="simple_OO_concept_Feature", is_abstract=True)
Feature = Class(name="Feature")
simple_OO_concept_Parameter = Class(name="simple_OO_concept_Parameter")
simple_OO_concept_Behavior = Class(name="simple_OO_concept_Behavior")
...
domain_model = DomainModel(
    ...
    types={simple_OO_concept_Package, NamedElement, simple_OO_concept_Class, simple_OO_concept_Dependency, simple_OO_concept_Attribute, simple_OO_concept_Operation, simple_OO_concept_NamedElement, simple_OO_concept_Feature, Feature, simple_OO_concept_Parameter, simple_OO_concept_Behavior, Class_},
    associations={classes0, dependencies1, supplier3, client5, attributes8, operations10, parents13, atttype15, parameters18, method20, partype22},
    generalizations={gen_simple_OO_concept_Package_NamedElement, gen_simple_OO_concept_Class_NamedElement, gen_simple_OO_concept_Attribute_NamedElement, gen_simple_OO_concept_Attribute_Feature, gen_simple_OO_concept_Operation_NamedElement, gen_simple_OO_concept_Operation_Feature, gen_simple_OO_concept_Behavior_Class},
    metadata=None
)
