...
class simple_OO_concept_NamedElement(ABC):
    ...
    def __init__(self, name: str, simple_OO_concept_NamedElement7: "simple_OO_concept_Dependency" = None, simple_OO_concept_NamedElement: "simple_OO_concept_Dependency" = None):
        self.name = name
...
class simple_OO_concept_Class(NamedElement):
    ...
    def __init__(self, isAbstract: bool, simple_OO_concept_Class: "simple_OO_concept_Package" = None, simple_OO_concept_Class9: set["simple_OO_concept_Attribute"] = None, simple_OO_concept_Class11: set["simple_OO_concept_Operation"] = None, simple_OO_concept_Class14: "simple_OO_concept_Class" = None, simple_OO_concept_Class12: set["simple_OO_concept_Class"] = None, simple_OO_concept_Class17: "simple_OO_concept_Attribute" = None, simple_OO_concept_Class24: "simple_OO_concept_Parameter" = None):
...
class simple_OO_concept_Attribute(NamedElement, Feature):

    pass
class simple_OO_concept_Operation(NamedElement, Feature):
