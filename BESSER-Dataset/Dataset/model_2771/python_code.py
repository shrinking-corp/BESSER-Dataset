...
class ecoreJavascriptTest_C2:
    ...
    def __init__(self, value: int, name: str, c2s: "ecoreJavascriptTest_C1" = None, C2: "ecoreJavascriptTest_C1" = None):
        self.value = value
        self.name = name
        self.c2s = c2s
        self.C2 = C2
...
class ecoreJavascriptTest_C1:
    ...
    def __init__(self, name: str, C1: "ecoreJavascriptTest_C2" = None, c1: set["ecoreJavascriptTest_C2"] = None, ecoreJavascriptTest_C1: "ecoreJavascriptTest_C1" = None, ecoreJavascriptTest_C11: set["ecoreJavascriptTest_C1"] = None):
        self.name = name
        self.C1 = C1
