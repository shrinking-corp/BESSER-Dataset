...
# Classes
ecoreJavascriptTest_C3 = Class(name="ecoreJavascriptTest_C3")
C2 = Class(name="C2")
ecoreJavascriptTest_C1 = Class(name="ecoreJavascriptTest_C1")
ecoreJavascriptTest_C2 = Class(name="ecoreJavascriptTest_C2")
...
domain_model = DomainModel(
    ...
    types={ecoreJavascriptTest_C3, C2, ecoreJavascriptTest_C1, ecoreJavascriptTest_C2},
    associations={c13, c2s0, c1s2},
