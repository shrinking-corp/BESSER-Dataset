...
domain_model = DomainModel(
    name="petrinet",
    types={petrinet_PetriNet, petrinet_Arc, petrinet_Transition, Node, petrinet_Place, petrinet_Token, petrinet_Node},
    associations={arcs1, net3, source6, target9, net12, incoming15, outgoing18, tokens21, nodes0},
