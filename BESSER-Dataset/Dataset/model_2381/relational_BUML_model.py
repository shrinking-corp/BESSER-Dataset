...
# Classes
relational_Comment = Class(name="relational_Comment", is_abstract=True)
relational_ENamedElement = Class(name="relational_ENamedElement", is_abstract=True)
relational_SQLObject = Class(name="relational_SQLObject", is_abstract=True)
ENamedElement = Class(name="ENamedElement")
relational_DataType = Class(name="relational_DataType")
SQLObject = Class(name="SQLObject")
relational_TypedElement = Class(name="relational_TypedElement", is_abstract=True)
relational_Schema = Class(name="relational_Schema")
relational_Table = Class(name="relational_Table", is_abstract=True)
relational_Trigger = Class(name="relational_Trigger")
relational_Assertion = Class(name="relational_Assertion")
relational_UserDefinedType = Class(name="relational_UserDefinedType")
TableConstraint = Class(name="TableConstraint")
relational_Column = Class(name="relational_Column")
TypedElement = Class(name="TypedElement")
relational_ReferenceConstraint = Class(name="relational_ReferenceConstraint", is_abstract=True)
relational_ForeignKey = Class(name="relational_ForeignKey")
relational_BaseTable = Class(name="relational_BaseTable")
Table = Class(name="Table")
relational_TableConstraint = Class(name="relational_TableConstraint", is_abstract=True)
relational_Constraint = Class(name="relational_Constraint", is_abstract=True)
...
relational_CheckConstraint = Class(name="relational_CheckConstraint")
DataType = Class(name="DataType")
relational_Domain = Class(name="relational_Domain")
DistinctUserDefinedType = Class(name="DistinctUserDefinedType")
relational_DistinctUserDefinedType = Class(name="relational_DistinctUserDefinedType")
...
relational_Trigger.attributes={relational_Trigger_updateType, relational_Trigger_insertType, relational_Trigger_actionTime, relational_Trigger_oldTable, relational_Trigger_actionGranularity, relational_Trigger_condition, relational_Trigger_newTable, relational_Trigger_statementSQL, relational_Trigger_deleteType, relational_Trigger_oldRow, relational_Trigger_newRow}
...
relational_Column.attributes={relational_Column_defaultValue, relational_Column_nullable, relational_Column_srid, relational_Column_length}
...
relational_ForeignKey.attributes={relational_ForeignKey_onDelete, relational_ForeignKey_onUpdate}
...
relational_Domain.attributes={relational_Domain_nullable, relational_Domain_defaultValue}
...
domain_model = DomainModel(
    name="relational",
    types={relational_Comment, relational_ENamedElement, relational_SQLObject, ENamedElement, relational_DataType, SQLObject, relational_TypedElement, relational_Schema, relational_Table, relational_Trigger, relational_Assertion, relational_UserDefinedType, TableConstraint, relational_Column, TypedElement, relational_ReferenceConstraint, relational_ForeignKey, relational_BaseTable, Table, relational_TableConstraint, relational_Constraint, Constraint, ReferenceConstraint, relational_UniqueConstraint, relational_PrimaryKey, UniqueConstraint, relational_CheckConstraint, DataType, relational_Domain, DistinctUserDefinedType, relational_DistinctUserDefinedType, UserDefinedType, ActionTimeType, ReferentialActionType, ActionGranularityType},
    associations={comments0, sqlobject1, typedElement2, dataType3, tables4, triggers5, assertions7, userDefinedTypes9, schema11, table12, triggerTables15, baseTable32, members33, schema17, triggers19, triggersConstrainted21, columns23, table25, referenceConstraint27, foreignKey28, referencingForeignKeys29, constraints31, constraint47, referencedType48, referencedTable35, uniqueConstraint37, referencedMembers38, foreignKey41, schema43, schema45},
    generalizations={gen_relational_SQLObject_ENamedElement, gen_relational_DataType_SQLObject, gen_relational_TypedElement_SQLObject, gen_relational_Schema_SQLObject, gen_relational_Trigger_SQLObject, gen_relational_ReferenceConstraint_TableConstraint, gen_relational_Table_SQLObject, gen_relational_Column_TypedElement, gen_relational_BaseTable_Table, gen_relational_Constraint_SQLObject, gen_relational_TableConstraint_Constraint, gen_relational_ForeignKey_ReferenceConstraint, gen_relational_UniqueConstraint_ReferenceConstraint, gen_relational_PrimaryKey_UniqueConstraint, gen_relational_CheckConstraint_TableConstraint, gen_relational_Assertion_Constraint, gen_relational_UserDefinedType_DataType, gen_relational_Domain_DistinctUserDefinedType, gen_relational_DistinctUserDefinedType_UserDefinedType},
    metadata=None
)
