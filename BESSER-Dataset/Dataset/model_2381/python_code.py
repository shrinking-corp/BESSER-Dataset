...
class relational_Assertion(Constraint):
    ...
    def __init__(self, searchCondition: str, assertions: "relational_Schema" = None, Assertion: "relational_Schema" = None):
        self.searchCondition = searchCondition
...
class relational_Trigger(SQLObject):
    ...
    def __init__(self, statementSQL: str, oldRow: str, newRow: str, oldTable: str, newTable: str, actionGranularity: str, updateType: bool, insertType: bool, deleteType: bool, actionTime: str, condition: str, Trigger22: "relational_Table" = None, Trigger: "relational_Schema" = None, triggers: "relational_Schema" = None, triggers13: "relational_Table" = None, triggersConstrainted: set["relational_Table"] = None, Trigger20: "relational_Table" = None):
