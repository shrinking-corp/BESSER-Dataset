...
# Classes
javasimplified_Method = Class(name="javasimplified_Method")
NamedElement = Class(name="NamedElement")
javasimplified_Class = Class(name="javasimplified_Class")
javasimplified_Parameter = Class(name="javasimplified_Parameter")
javasimplified_Type = Class(name="javasimplified_Type")
javasimplified_Modifier = Class(name="javasimplified_Modifier")
javasimplified_Statement = Class(name="javasimplified_Statement", is_abstract=True)
javasimplified_Variable = Class(name="javasimplified_Variable")
Statement = Class(name="Statement")
javasimplified_Comment = Class(name="javasimplified_Comment")
Type = Class(name="Type")
javasimplified_ImportDeclaration = Class(name="javasimplified_ImportDeclaration")
javasimplified_NamedElement = Class(name="javasimplified_NamedElement", is_abstract=True)
javasimplified_Interface = Class(name="javasimplified_Interface")
javasimplified_Package = Class(name="javasimplified_Package")
javasimplified_Model = Class(name="javasimplified_Model")
javasimplified_PrimitiveType = Class(name="javasimplified_PrimitiveType")
javasimplified_ForStatement = Class(name="javasimplified_ForStatement")
javasimplified_Expression = Class(name="javasimplified_Expression", is_abstract=True)
javasimplified_IfStatement = Class(name="javasimplified_IfStatement")
javasimplified_WhileStatement = Class(name="javasimplified_WhileStatement")
javasimplified_CatchStatment = Class(name="javasimplified_CatchStatment")
javasimplified_ThrowStatement = Class(name="javasimplified_ThrowStatement")
javasimplified_ReturnStatement = Class(name="javasimplified_ReturnStatement")
javasimplified_Assignment = Class(name="javasimplified_Assignment")
Expression = Class(name="Expression")
javasimplified_BooleanLiteral = Class(name="javasimplified_BooleanLiteral")
javasimplified_ExpressionStatement = Class(name="javasimplified_ExpressionStatement")
javasimplified_Block = Class(name="javasimplified_Block")
javasimplified_CastExpression = Class(name="javasimplified_CastExpression")
javasimplified_ThisExpression = Class(name="javasimplified_ThisExpression")
javasimplified_VariableAccess = Class(name="javasimplified_VariableAccess")
javasimplified_TryStatement = Class(name="javasimplified_TryStatement")
javasimplified_StringLiteral = Class(name="javasimplified_StringLiteral")
javasimplified_NumberLiteral = Class(name="javasimplified_NumberLiteral")
javasimplified_NullLiteral = Class(name="javasimplified_NullLiteral")
javasimplified_ClassInstanceCreation = Class(name="javasimplified_ClassInstanceCreation")
javasimplified_InstanceOfExpression = Class(name="javasimplified_InstanceOfExpression")
javasimplified_ArrayAccess = Class(name="javasimplified_ArrayAccess")
javasimplified_ArrayCreation = Class(name="javasimplified_ArrayCreation")
...
javasimplified_Modifier.attributes={javasimplified_Modifier_isStatic, javasimplified_Modifier_isFinal, javasimplified_Modifier_isVolatile, javasimplified_Modifier_visibility, javasimplified_Modifier_isSynchronized}
...
class_18: BinaryAssociation = BinaryAssociation(
    name="class_18",
    ends={
...
variables20: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="class_", type=javasimplified_Variable, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
comments21: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="class_22", type=javasimplified_Comment, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
else_60: BinaryAssociation = BinaryAssociation(
    name="else_60",
    ends={
...
domain_model = DomainModel(
    name="javasimplified",
    types={javasimplified_Method, NamedElement, javasimplified_Class, javasimplified_Parameter, javasimplified_Type, javasimplified_Modifier, javasimplified_Statement, javasimplified_Variable, Statement, javasimplified_Comment, Type, javasimplified_ImportDeclaration, javasimplified_NamedElement, javasimplified_Interface, javasimplified_Package, javasimplified_Model, javasimplified_PrimitiveType, javasimplified_ForStatement, javasimplified_Expression, javasimplified_IfStatement, javasimplified_WhileStatement, javasimplified_CatchStatment, javasimplified_ThrowStatement, javasimplified_ReturnStatement, javasimplified_Assignment, Expression, javasimplified_BooleanLiteral, javasimplified_ExpressionStatement, javasimplified_Block, javasimplified_CastExpression, javasimplified_ThisExpression, javasimplified_VariableAccess, javasimplified_TryStatement, javasimplified_StringLiteral, javasimplified_NumberLiteral, javasimplified_NullLiteral, javasimplified_ClassInstanceCreation, javasimplified_InstanceOfExpression, javasimplified_ArrayAccess, javasimplified_ArrayCreation, VisibilityKind},
    associations={class_0, params1, returnType3, modifier5, statements7, type9, class_11, modifier12, type15, class_18, variables20, comments21, superClass24, methods26, imports29, implements34, ownedElems36, package39, packs41, importedElement43, body45, expression47, updaters49, initializers52, expression55, body57, else_60, body63, modifier31, body68, catchClauses70, expression72, expression74, leftHandSide76, rightHandSide78, expression81, body83, exception86, statements89, expression91, type93, type96, variable98, expression65, expression103, type105, leftOperand108, rightOperand110, array113, index115, dimensions118, type120, initializars123, expression100},
    generalizations={gen_javasimplified_Method_NamedElement, gen_javasimplified_Variable_Statement, gen_javasimplified_Parameter_NamedElement, gen_javasimplified_Class_Type, gen_javasimplified_Package_NamedElement, gen_javasimplified_Model_NamedElement, gen_javasimplified_Type_NamedElement, gen_javasimplified_PrimitiveType_Type, gen_javasimplified_Interface_Type, gen_javasimplified_ForStatement_Statement, gen_javasimplified_IfStatement_Statement, gen_javasimplified_WhileStatement_Statement, gen_javasimplified_TryStatement_Statement, gen_javasimplified_ThrowStatement_Statement, gen_javasimplified_ReturnStatement_Statement, gen_javasimplified_Assignment_Expression, gen_javasimplified_BooleanLiteral_Expression, gen_javasimplified_ExpressionStatement_Statement, gen_javasimplified_CatchStatment_Statement, gen_javasimplified_Block_Statement, gen_javasimplified_CastExpression_Expression, gen_javasimplified_ThisExpression_Expression, gen_javasimplified_VariableAccess_Expression, gen_javasimplified_StringLiteral_Expression, gen_javasimplified_NumberLiteral_Expression, gen_javasimplified_NullLiteral_Expression, gen_javasimplified_ClassInstanceCreation_Expression, gen_javasimplified_InstanceOfExpression_Expression, gen_javasimplified_ArrayAccess_Expression, gen_javasimplified_ArrayCreation_Expression},
    metadata=None
)
