...
def test_assoc_assignee28_link_reassign_clear():
    ...
    if hasattr(b1, 'activitydiagram_IntegerVariable29'):
        assert _is_linked(b1, 'activitydiagram_IntegerVariable29', a)
    ...
    if hasattr(b1, 'activitydiagram_IntegerVariable29'):
        assert not _is_linked(b1, 'activitydiagram_IntegerVariable29', a)
    if hasattr(b2, 'activitydiagram_IntegerVariable29'):
        assert _is_linked(b2, 'activitydiagram_IntegerVariable29', a)
    ...
    if hasattr(b2, 'activitydiagram_IntegerVariable29'):
        assert not _is_linked(b2, 'activitydiagram_IntegerVariable29', a)
...
def test_assoc_assignee30_link_reassign_clear():
    ...
    if hasattr(b1, 'activitydiagram_BooleanVariable31'):
        assert _is_linked(b1, 'activitydiagram_BooleanVariable31', a)
    ...
    if hasattr(b1, 'activitydiagram_BooleanVariable31'):
        assert not _is_linked(b1, 'activitydiagram_BooleanVariable31', a)
    if hasattr(b2, 'activitydiagram_BooleanVariable31'):
        assert _is_linked(b2, 'activitydiagram_BooleanVariable31', a)
    ...
    if hasattr(b2, 'activitydiagram_BooleanVariable31'):
        assert not _is_linked(b2, 'activitydiagram_BooleanVariable31', a)
...
def test_assoc_currentValue19_link_reassign_clear():
    ...
    if hasattr(b1, 'activitydiagram_Value21'):
        assert _is_linked(b1, 'activitydiagram_Value21', a)
    _safe_set(a, 'activitydiagram_Variable20', b2)
    assert _is_linked(a, 'activitydiagram_Variable20', b2)
    if hasattr(b1, 'activitydiagram_Value21'):
        assert not _is_linked(b1, 'activitydiagram_Value21', a)
    if hasattr(b2, 'activitydiagram_Value21'):
        assert _is_linked(b2, 'activitydiagram_Value21', a)
    _safe_set(a, 'activitydiagram_Variable20', None)
    assert not _is_linked(a, 'activitydiagram_Variable20', b2)
    if hasattr(b2, 'activitydiagram_Value21'):
        assert not _is_linked(b2, 'activitydiagram_Value21', a)
...
def test_assoc_initialValue17_link_reassign_clear():
    ...
    b1 = activitydiagram_Value()
    b2 = activitydiagram_Value()
    _safe_set(a, 'activitydiagram_Variable18', b1)
    assert _is_linked(a, 'activitydiagram_Variable18', b1)
    if hasattr(b1, 'activitydiagram_Value'):
        assert _is_linked(b1, 'activitydiagram_Value', a)
    _safe_set(a, 'activitydiagram_Variable18', b2)
    assert _is_linked(a, 'activitydiagram_Variable18', b2)
    if hasattr(b1, 'activitydiagram_Value'):
    ...
    _safe_set(a, 'activitydiagram_Variable18', None)
    assert not _is_linked(a, 'activitydiagram_Variable18', b2)
    if hasattr(b2, 'activitydiagram_Value'):
...
def test_assoc_operand134_link_reassign_clear():
    ...
    if hasattr(b1, 'activitydiagram_BooleanVariable35'):
        assert _is_linked(b1, 'activitydiagram_BooleanVariable35', a)
    _safe_set(a, 'activitydiagram_BooleanBinaryExpression', b2)
    assert _is_linked(a, 'activitydiagram_BooleanBinaryExpression', b2)
    if hasattr(b1, 'activitydiagram_BooleanVariable35'):
        assert not _is_linked(b1, 'activitydiagram_BooleanVariable35', a)
    if hasattr(b2, 'activitydiagram_BooleanVariable35'):
        assert _is_linked(b2, 'activitydiagram_BooleanVariable35', a)
    ...
    if hasattr(b2, 'activitydiagram_BooleanVariable35'):
        assert not _is_linked(b2, 'activitydiagram_BooleanVariable35', a)
...
def test_assoc_operand236_link_reassign_clear():
    ...
    b1 = activitydiagram_BooleanVariable()
    b2 = activitydiagram_BooleanVariable()
    _safe_set(a, 'activitydiagram_BooleanBinaryExpression37', b1)
    assert _is_linked(a, 'activitydiagram_BooleanBinaryExpression37', b1)
    if hasattr(b1, 'activitydiagram_BooleanVariable38'):
        assert _is_linked(b1, 'activitydiagram_BooleanVariable38', a)
    _safe_set(a, 'activitydiagram_BooleanBinaryExpression37', b2)
    assert _is_linked(a, 'activitydiagram_BooleanBinaryExpression37', b2)
    if hasattr(b1, 'activitydiagram_BooleanVariable38'):
    ...
    _safe_set(a, 'activitydiagram_BooleanBinaryExpression37', None)
    assert not _is_linked(a, 'activitydiagram_BooleanBinaryExpression37', b2)
    if hasattr(b2, 'activitydiagram_BooleanVariable38'):
...
def test_assoc_variable41_link_reassign_clear():
    ...
    _safe_set(a, 'activitydiagram_Variable43', b1)
    assert _is_linked(a, 'activitydiagram_Variable43', b1)
    if hasattr(b1, 'activitydiagram_InputValue42'):
        assert _is_linked(b1, 'activitydiagram_InputValue42', a)
    _safe_set(a, 'activitydiagram_Variable43', b2)
    assert _is_linked(a, 'activitydiagram_Variable43', b2)
    if hasattr(b1, 'activitydiagram_InputValue42'):
        assert not _is_linked(b1, 'activitydiagram_InputValue42', a)
    if hasattr(b2, 'activitydiagram_InputValue42'):
        assert _is_linked(b2, 'activitydiagram_InputValue42', a)
    _safe_set(a, 'activitydiagram_Variable43', None)
    assert not _is_linked(a, 'activitydiagram_Variable43', b2)
    if hasattr(b2, 'activitydiagram_InputValue42'):
        assert not _is_linked(b2, 'activitydiagram_InputValue42', a)
