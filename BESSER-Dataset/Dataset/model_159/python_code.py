...
class petrinet_Transition:
    ...
    def __init__(self, name: str, trg10: set["petrinet_PTArc"] = None, petrinet_Transition: "petrinet_Petrinet" = None, src13: set["petrinet_TPArc"] = None, Transition: "petrinet_PTArc" = None, Transition19: "petrinet_TPArc" = None):
        self.name = name
...
class petrinet_Place:
    ...
    def __init__(self, name: str, trg: set["petrinet_TPArc"] = None, petrinet_Place: "petrinet_Petrinet" = None, petrinet_Place6: set["petrinet_Token"] = None, src: set["petrinet_PTArc"] = None, Place: "petrinet_PTArc" = None, Place22: "petrinet_TPArc" = None):
        self.name = name
    ...
    def Place22(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "in_21"):
                opp_val = getattr(old_value, "in_21", None)
                if isinstance(opp_val, set):
                    opp_val.discard(self)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "in_21"):
                opp_val = getattr(value, "in_21", None)
                if opp_val is None:
                    setattr(value, "in_21", set([self]))
                elif isinstance(opp_val, set):
                    opp_val.add(self)
