...
def test_hyp_channelpriorityitem_is_not_abstract():
    assert not inspect.isabstract(ChannelPriorityItem)


def test_hyp_channelpriorityitem_constructor_exists():
    assert callable(ChannelPriorityItem.__init__)


def test_hyp_channelpriorityitem_constructor_args():
    sig = inspect.signature(ChannelPriorityItem.__init__)
    params = list(sig.parameters.keys())



def test_hyp_uppaal_global_defaultchannelpriority_is_not_abstract():
    assert not inspect.isabstract(uppaal_global_DefaultChannelPriority)


def test_hyp_uppaal_global_defaultchannelpriority_constructor_exists():
    assert callable(uppaal_global_DefaultChannelPriority.__init__)


def test_hyp_uppaal_global_defaultchannelpriority_constructor_args():
    sig = inspect.signature(uppaal_global_DefaultChannelPriority.__init__)
    params = list(sig.parameters.keys())



def test_hyp_uppaal_global_channellist_is_not_abstract():
    assert not inspect.isabstract(uppaal_global_ChannelList)


def test_hyp_uppaal_global_channellist_constructor_exists():
    assert callable(uppaal_global_ChannelList.__init__)


def test_hyp_uppaal_global_channellist_constructor_args():
    sig = inspect.signature(uppaal_global_ChannelList.__init__)
    params = list(sig.parameters.keys())



def test_hyp_uppaal_global_channelpriorityitem_is_not_abstract():
    assert not inspect.isabstract(uppaal_global_ChannelPriorityItem)


def test_hyp_uppaal_global_channelpriorityitem_constructor_exists():
    assert callable(uppaal_global_ChannelPriorityItem.__init__)


def test_hyp_uppaal_global_channelpriorityitem_constructor_args():
    sig = inspect.signature(uppaal_global_ChannelPriorityItem.__init__)
    params = list(sig.parameters.keys())



def test_hyp_global_channelpriorityitem_is_not_abstract():
    assert not inspect.isabstract(global_ChannelPriorityItem)


def test_hyp_global_channelpriorityitem_constructor_exists():
    assert callable(global_ChannelPriorityItem.__init__)


def test_hyp_global_channelpriorityitem_constructor_args():
    sig = inspect.signature(global_ChannelPriorityItem.__init__)
    params = list(sig.parameters.keys())



def test_hyp_uppaal_global_channelpriority_is_not_abstract():
    assert not inspect.isabstract(uppaal_global_ChannelPriority)


def test_hyp_uppaal_global_channelpriority_constructor_exists():
    assert callable(uppaal_global_ChannelPriority.__init__)


def test_hyp_uppaal_global_channelpriority_constructor_args():
...
def test_hyp_uppaal_declarations_variablecontainer_is_not_abstract():
    assert not inspect.isabstract(uppaal_declarations_VariableContainer)


def test_hyp_uppaal_declarations_variablecontainer_constructor_exists():
    assert callable(uppaal_declarations_VariableContainer.__init__)


def test_hyp_uppaal_declarations_variablecontainer_constructor_args():
    sig = inspect.signature(uppaal_declarations_VariableContainer.__init__)
    params = list(sig.parameters.keys())



def test_hyp_uppaal_declarations_index_is_not_abstract():
    assert not inspect.isabstract(uppaal_declarations_Index)


def test_hyp_uppaal_declarations_index_constructor_exists():
    assert callable(uppaal_declarations_Index.__init__)


def test_hyp_uppaal_declarations_index_constructor_args():
...
def test_hyp_variablecontainer_is_not_abstract():
    assert not inspect.isabstract(VariableContainer)


def test_hyp_variablecontainer_constructor_exists():
    assert callable(VariableContainer.__init__)


def test_hyp_variablecontainer_constructor_args():
...
def test_hyp_uppaal_declarations_clockvariabledeclaration_is_not_abstract():
    assert not inspect.isabstract(uppaal_declarations_ClockVariableDeclaration)


def test_hyp_uppaal_declarations_clockvariabledeclaration_constructor_exists():
    assert callable(uppaal_declarations_ClockVariableDeclaration.__init__)


def test_hyp_uppaal_declarations_clockvariabledeclaration_constructor_args():
    sig = inspect.signature(uppaal_declarations_ClockVariableDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_uppaal_declarations_datavariabledeclaration_is_not_abstract():
    assert not inspect.isabstract(uppaal_declarations_DataVariableDeclaration)


def test_hyp_uppaal_declarations_datavariabledeclaration_constructor_exists():
    assert callable(uppaal_declarations_DataVariableDeclaration.__init__)


def test_hyp_uppaal_declarations_datavariabledeclaration_constructor_args():
...
def test_hyp_uppaal_declarations_channelvariabledeclaration_is_not_abstract():
    assert not inspect.isabstract(uppaal_declarations_ChannelVariableDeclaration)


def test_hyp_uppaal_declarations_channelvariabledeclaration_constructor_exists():
    assert callable(uppaal_declarations_ChannelVariableDeclaration.__init__)


def test_hyp_uppaal_declarations_channelvariabledeclaration_constructor_args():
...
def test_hyp_declarations_variablecontainer_is_not_abstract():
    assert not inspect.isabstract(declarations_VariableContainer)


def test_hyp_declarations_variablecontainer_constructor_exists():
    assert callable(declarations_VariableContainer.__init__)


def test_hyp_declarations_variablecontainer_constructor_args():
...
def test_hyp_uppaal_declarations_variabledeclaration_is_not_abstract():
    assert not inspect.isabstract(uppaal_declarations_VariableDeclaration)


def test_hyp_uppaal_declarations_variabledeclaration_constructor_exists():
    assert callable(uppaal_declarations_VariableDeclaration.__init__)


def test_hyp_uppaal_declarations_variabledeclaration_constructor_args():
...
def test_hyp_global_channelpriority_is_not_abstract():
    assert not inspect.isabstract(global_ChannelPriority)


def test_hyp_global_channelpriority_constructor_exists():
    assert callable(global_ChannelPriority.__init__)


def test_hyp_global_channelpriority_constructor_args():
...
def test_hyp_uppaal_declarations_functiondeclaration_is_not_abstract():
    assert not inspect.isabstract(uppaal_declarations_FunctionDeclaration)


def test_hyp_uppaal_declarations_functiondeclaration_constructor_exists():
    assert callable(uppaal_declarations_FunctionDeclaration.__init__)


def test_hyp_uppaal_declarations_functiondeclaration_constructor_args():
...
def test_hyp_datavariabledeclaration_is_not_abstract():
    assert not inspect.isabstract(DataVariableDeclaration)


def test_hyp_datavariabledeclaration_constructor_exists():
    assert callable(DataVariableDeclaration.__init__)


def test_hyp_datavariabledeclaration_constructor_args():
...
def test_hyp_uppaal_types_typedefinition_is_not_abstract():
    assert not inspect.isabstract(uppaal_types_TypeDefinition)


def test_hyp_uppaal_types_typedefinition_constructor_exists():
    assert callable(uppaal_types_TypeDefinition.__init__)


def test_hyp_uppaal_types_typedefinition_constructor_args():
...
def test_hyp_uppaal_types_typespecification_is_not_abstract():
    assert not inspect.isabstract(uppaal_types_TypeSpecification)


def test_hyp_uppaal_types_typespecification_constructor_exists():
    assert callable(uppaal_types_TypeSpecification.__init__)


def test_hyp_uppaal_types_typespecification_constructor_args():
    sig = inspect.signature(uppaal_types_TypeSpecification.__init__)
    params = list(sig.parameters.keys())



def test_hyp_uppaal_types_typereference_is_not_abstract():
    assert not inspect.isabstract(uppaal_types_TypeReference)


def test_hyp_uppaal_types_typereference_constructor_exists():
    assert callable(uppaal_types_TypeReference.__init__)


def test_hyp_uppaal_types_typereference_constructor_args():
...
def test_hyp_typespecification_is_not_abstract():
    assert not inspect.isabstract(TypeSpecification)


def test_hyp_typespecification_constructor_exists():
    assert callable(TypeSpecification.__init__)


def test_hyp_typespecification_constructor_args():
...
def test_hyp_uppaal_declarations_valueindex_is_not_abstract():
    assert not inspect.isabstract(uppaal_declarations_ValueIndex)


def test_hyp_uppaal_declarations_valueindex_constructor_exists():
    assert callable(uppaal_declarations_ValueIndex.__init__)


def test_hyp_uppaal_declarations_valueindex_constructor_args():
    sig = inspect.signature(uppaal_declarations_ValueIndex.__init__)
    params = list(sig.parameters.keys())



def test_hyp_uppaal_declarations_typeindex_is_not_abstract():
    assert not inspect.isabstract(uppaal_declarations_TypeIndex)


def test_hyp_uppaal_declarations_typeindex_constructor_exists():
    assert callable(uppaal_declarations_TypeIndex.__init__)


def test_hyp_uppaal_declarations_typeindex_constructor_args():
...
def test_hyp_incrementdecrementposition_exists():
    # Check that the Enumeration exists
    assert IncrementDecrementPosition is not None

def test_hyp_incrementdecrementposition_has_all_literals():
    # Collect the names of literals in this Enumeration
...
@given(instance=uppaal_visuals_ColoredElement_strategy)
def test_hyp_uppaal_visuals_coloredelement_color_setter(instance):
...
def test_hyp_uppaal_declarations_datavariabledeclaration_prefix_setter(instance):
...
def test_hyp_uppaal_declarations_channelvariabledeclaration_urgent_setter(instance):
...
@given(instance=uppaal_declarations_ChannelVariableDeclaration_strategy)
def test_hyp_uppaal_declarations_channelvariabledeclaration_broadcast_setter(instance):
...
@given(instance=uppaal_expressions_IncrementDecrementExpression_strategy)
def test_hyp_uppaal_expressions_incrementdecrementexpression_position_setter(instance):
...
def test_hyp_uppaal_types_typedefinition_baseType_setter(instance):
...
def test_assoc_channelExpression114_link_reassign_clear():
    ...
    if hasattr(b1, 'IdentifierExpression115'):
        assert _is_linked(b1, 'IdentifierExpression115', a)
    _safe_set(a, 'uppaal_templates_Synchronization', b2)
    assert _is_linked(a, 'uppaal_templates_Synchronization', b2)
    if hasattr(b1, 'IdentifierExpression115'):
        assert not _is_linked(b1, 'IdentifierExpression115', a)
    if hasattr(b2, 'IdentifierExpression115'):
        assert _is_linked(b2, 'IdentifierExpression115', a)
    _safe_set(a, 'uppaal_templates_Synchronization', None)
    assert not _is_linked(a, 'uppaal_templates_Synchronization', b2)
    if hasattr(b2, 'IdentifierExpression115'):
        assert not _is_linked(b2, 'IdentifierExpression115', a)
...
def test_assoc_expression188_link_reassign_clear():
    ...
    if hasattr(b1, 'Expression189'):
        assert _is_linked(b1, 'Expression189', a)
    ...
    if hasattr(b1, 'Expression189'):
        assert not _is_linked(b1, 'Expression189', a)
    if hasattr(b2, 'Expression189'):
        assert _is_linked(b2, 'Expression189', a)
    ...
    if hasattr(b2, 'Expression189'):
        assert not _is_linked(b2, 'Expression189', a)
...
def test_assoc_expression190_link_reassign_clear():
    ...
    if hasattr(b1, 'Expression191'):
        assert _is_linked(b1, 'Expression191', a)
    ...
    if hasattr(b1, 'Expression191'):
        assert not _is_linked(b1, 'Expression191', a)
    if hasattr(b2, 'Expression191'):
        assert _is_linked(b2, 'Expression191', a)
    ...
    if hasattr(b2, 'Expression191'):
        assert not _is_linked(b2, 'Expression191', a)
...
def test_assoc_invariant95_link_reassign_clear():
    ...
    if hasattr(b1, 'Expression96'):
        assert _is_linked(b1, 'Expression96', a)
    _safe_set(a, 'uppaal_templates_Location', b2)
    assert _is_linked(a, 'uppaal_templates_Location', b2)
    if hasattr(b1, 'Expression96'):
        assert not _is_linked(b1, 'Expression96', a)
    if hasattr(b2, 'Expression96'):
        assert _is_linked(b2, 'Expression96', a)
    _safe_set(a, 'uppaal_templates_Location', None)
    assert not _is_linked(a, 'uppaal_templates_Location', b2)
    if hasattr(b2, 'Expression96'):
        assert not _is_linked(b2, 'Expression96', a)


def test_assoc_parentTemplate93_link_reassign_clear():
    a = uppaal_templates_Location(locationTimeKind="sample_text")
    b1 = Template()
    b2 = Template()
    _safe_set(a, 'location', b1)
    assert _is_linked(a, 'location', b1)
    if hasattr(b1, 'Template94'):
        assert _is_linked(b1, 'Template94', a)
    _safe_set(a, 'location', b2)
    assert _is_linked(a, 'location', b2)
    if hasattr(b1, 'Template94'):
        assert not _is_linked(b1, 'Template94', a)
    if hasattr(b2, 'Template94'):
        assert _is_linked(b2, 'Template94', a)
    _safe_set(a, 'location', None)
    assert not _is_linked(a, 'location', b2)
    if hasattr(b2, 'Template94'):
        assert not _is_linked(b2, 'Template94', a)


def test_assoc_typeSpecification20_link_reassign_clear():
    a = uppaal_types_Type(baseType="sample_text")
    b1 = TypeSpecification()
    b2 = TypeSpecification()
    _safe_set(a, 'uppaal_types_Type21', b1)
    assert _is_linked(a, 'uppaal_types_Type21', b1)
    if hasattr(b1, 'TypeSpecification'):
        assert _is_linked(b1, 'TypeSpecification', a)
    _safe_set(a, 'uppaal_types_Type21', b2)
    assert _is_linked(a, 'uppaal_types_Type21', b2)
    if hasattr(b1, 'TypeSpecification'):
        assert not _is_linked(b1, 'TypeSpecification', a)
    if hasattr(b2, 'TypeSpecification'):
        assert _is_linked(b2, 'TypeSpecification', a)
    _safe_set(a, 'uppaal_types_Type21', None)
    assert not _is_linked(a, 'uppaal_types_Type21', b2)
    if hasattr(b2, 'TypeSpecification'):
        assert not _is_linked(b2, 'TypeSpecification', a)


def test_assoc_typeSpecification24_link_reassign_clear():
    a = uppaal_types_TypeDefinition(baseType="sample_text")
    b1 = TypeSpecification()
    b2 = TypeSpecification()
    _safe_set(a, 'uppaal_types_TypeDefinition', b1)
    assert _is_linked(a, 'uppaal_types_TypeDefinition', b1)
    if hasattr(b1, 'TypeSpecification25'):
        assert _is_linked(b1, 'TypeSpecification25', a)
    _safe_set(a, 'uppaal_types_TypeDefinition', b2)
    assert _is_linked(a, 'uppaal_types_TypeDefinition', b2)
    if hasattr(b1, 'TypeSpecification25'):
        assert not _is_linked(b1, 'TypeSpecification25', a)
    if hasattr(b2, 'TypeSpecification25'):
        assert _is_linked(b2, 'TypeSpecification25', a)
    _safe_set(a, 'uppaal_types_TypeDefinition', None)
    assert not _is_linked(a, 'uppaal_types_TypeDefinition', b2)
    if hasattr(b2, 'TypeSpecification25'):
        assert not _is_linked(b2, 'TypeSpecification25', a)


def test_assoc_variableDeclaration67_link_reassign_clear():
