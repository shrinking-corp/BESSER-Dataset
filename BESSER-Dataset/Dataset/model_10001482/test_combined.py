...
def test_hyp_benannteeinrichtung_is_not_abstract():
    assert not inspect.isabstract(BenannteEinrichtung)


def test_hyp_benannteeinrichtung_constructor_exists():
    assert callable(BenannteEinrichtung.__init__)


def test_hyp_benannteeinrichtung_constructor_args():
...
def test_hyp_kabine_is_not_abstract():
    assert not inspect.isabstract(Kabine)


def test_hyp_kabine_constructor_exists():
    assert callable(Kabine.__init__)


def test_hyp_kabine_constructor_args():
...
def test_hyp_antrieb_is_not_abstract():
    assert not inspect.isabstract(Antrieb)


def test_hyp_antrieb_constructor_exists():
    assert callable(Antrieb.__init__)


def test_hyp_antrieb_constructor_args():
...
def test_hyp_turboliftschacht_is_not_abstract():
    assert not inspect.isabstract(TurboliftSchacht)


def test_hyp_turboliftschacht_constructor_exists():
    assert callable(TurboliftSchacht.__init__)


def test_hyp_turboliftschacht_constructor_args():
...
def test_hyp_steuerung_is_not_abstract():
    assert not inspect.isabstract(Steuerung)


def test_hyp_steuerung_constructor_exists():
    assert callable(Steuerung.__init__)


def test_hyp_steuerung_constructor_args():
    sig = inspect.signature(Steuerung.__init__)
    params = list(sig.parameters.keys())



def test_hyp_turboliftsystem_is_not_abstract():
    assert not inspect.isabstract(TurboliftSystem)


def test_hyp_turboliftsystem_constructor_exists():
    assert callable(TurboliftSystem.__init__)


def test_hyp_turboliftsystem_constructor_args():
...
def test_hyp_benannteeinrichtung_name_setter(instance):
...
def test_hyp_deck_sektion_setter(instance):
...
@given(instance=Deck_strategy)
def test_hyp_deck_fahrtWunsch_setter(instance):
...
def test_hyp_kabine_tuerZustand_setter(instance):
...
def test_hyp_antrieb_aNTRIEBSART_setter(instance):
...
def test_hyp_turboliftschacht_vertikal_setter(instance):
...
def test_hyp_turboliftsystem_alarmStufe_setter(instance):
