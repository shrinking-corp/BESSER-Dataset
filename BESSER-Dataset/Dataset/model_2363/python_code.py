...
class database_Index(NamedElement):
    ...
    def __init__(self, cardinality: int, indexType: str, qualifier: str, unique: bool, database_Index: "database_Column" = None, indexes: "database_Table" = None, database_Index17: set["database_IndexElement"] = None, Index: "database_Table" = None):
...
class database_Column(NamedElement):
    ...
    def __init__(self, nullable: bool, defaultValue: str, autoincrement: bool, inPrimaryKey: bool, inForeignKey: bool, unique: bool, database_Column: set["database_Index"] = None, column: set["database_IndexElement"] = None, columns: "database_PrimaryKey" = None, database_Column8: set["database_ForeignKey"] = None, fkColumn: set["database_ForeignKeyElement"] = None, database_Column11: "database_Type" = None, columns13: "database_Sequence" = None, columns15: "database_Table" = None, Column46: "database_ForeignKeyElement" = None, database_Column49: "database_ForeignKeyElement" = None, Column51: "database_IndexElement" = None, Column: "database_Table" = None, Column35: "database_PrimaryKey" = None, Column55: "database_Sequence" = None):
