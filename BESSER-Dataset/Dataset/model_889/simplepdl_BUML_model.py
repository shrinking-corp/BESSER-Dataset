...
domain_model = DomainModel(
    name="simplepdl",
    types={simplepdl_WorkSequence, simplepdl_Process, simplepdl_ProcessElement, simplepdl_WorkDefinition, ProcessElement, simplepdl_Guidance, WorkSequenceType},
    associations={linksToPredecessors1, linksToSuccessors2, predecessor4, successor5, processElements0, element7},
