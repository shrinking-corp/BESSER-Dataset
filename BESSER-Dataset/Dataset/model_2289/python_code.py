...
class gradingsystem_Task(ABC):
    ...
    def __init__(self, name: str, gradingsystem_Task12: "gradingsystem_Grading" = None, gradingsystem_Task: "gradingsystem_MinRequirement" = None, gradingsystem_Task5: "gradingsystem_TaskGroup" = None):
        self.name = name
...
class gradingsystem_Grading:
    ...
    def __init__(self, semester: str, gradingsystem_Grading11: set["gradingsystem_Task"] = None, gradingsystem_Grading14: "gradingsystem_GradingScheme" = None, gradingsystem_Grading: "gradingsystem_Course" = None):
