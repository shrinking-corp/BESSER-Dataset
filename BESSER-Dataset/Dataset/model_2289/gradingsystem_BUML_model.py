...
# Classes
gradingsystem_GradingSystem = Class(name="gradingsystem_GradingSystem")
gradingsystem_Course = Class(name="gradingsystem_Course")
gradingsystem_Grading = Class(name="gradingsystem_Grading")
gradingsystem_Task = Class(name="gradingsystem_Task", is_abstract=True)
gradingsystem_MinRequirement = Class(name="gradingsystem_MinRequirement")
gradingsystem_ConcreteTask = Class(name="gradingsystem_ConcreteTask")
Task = Class(name="Task")
gradingsystem_TaskGroup = Class(name="gradingsystem_TaskGroup")
gradingsystem_GradingScheme = Class(name="gradingsystem_GradingScheme")
gradingsystem_Grade = Class(name="gradingsystem_Grade")
...
domain_model = DomainModel(
    name="gradingsystem",
    types={gradingsystem_GradingSystem, gradingsystem_Course, gradingsystem_Grading, gradingsystem_Task, gradingsystem_MinRequirement, gradingsystem_ConcreteTask, Task, gradingsystem_TaskGroup, gradingsystem_GradingScheme, gradingsystem_Grade, MinRequirementsType},
    associations={tasks10, gradingScheme13, courses0, gradings1, minRequirement3, contains4, grades6, minRequirementNotFulfilledGrade7},
