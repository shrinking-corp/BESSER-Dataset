...
def test_hyp_gbind_dsl_virtualtupleexp_is_not_abstract():
    assert not inspect.isabstract(gbind_dsl_VirtualTupleExp)


def test_hyp_gbind_dsl_virtualtupleexp_constructor_exists():
    assert callable(gbind_dsl_VirtualTupleExp.__init__)


def test_hyp_gbind_dsl_virtualtupleexp_constructor_args():
...
@given(instance=gbind_dsl_BindingModel_strategy)
def test_hyp_gbind_dsl_bindingmodel_targetBinding_setter(instance):
...
def test_hyp_gbind_dsl_virtualtupleexp_typeName_setter(instance):
...
@given(instance=gbind_dsl_MetamodelDeclaration_strategy)
def test_hyp_gbind_dsl_metamodeldeclaration_resource_setter(instance):
