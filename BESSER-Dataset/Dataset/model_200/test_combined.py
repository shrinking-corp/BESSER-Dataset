...
def test_hyp_ecore_visitable_is_not_abstract():
    assert not inspect.isabstract(ecore_Visitable)


def test_hyp_ecore_visitable_constructor_exists():
    assert callable(ecore_Visitable.__init__)


def test_hyp_ecore_visitable_constructor_args():
    sig = inspect.signature(ecore_Visitable.__init__)
...
ecore_Visitable_strategy = st.builds(
    ecore_Visitable,
)
...
ecore_Visitable_strategy = st.builds(ecore_Visitable)
@given(instance=ecore_Visitable_strategy)
@settings(max_examples=25)
def test_ecore_Visitable_instantiation(instance):
    assert isinstance(instance, ecore_Visitable)
