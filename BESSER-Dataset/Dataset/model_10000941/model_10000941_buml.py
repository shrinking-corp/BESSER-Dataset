...
Employee.attributes={Employee_Emp_DOB, Employee_Emp_NIC, Employee_Emp_Name, Employee_Emp_Department, Employee_Emp_ContactNo, Employee_Emp_Date_Of_Joint, Employee_Emp_Position, Employee_Emp_Email, Employee_Emp_Salary, Employee_Emp_Id, Employee_Emp_Address}
...
Salary.attributes={Salary_Sly_Netgross, Salary_Sly_Basic, Salary_OverTime, Salary_Sly_Decrement, Salary_Emp_Id, Salary_Sly_Increment}
...
Authenticate_staff.attributes={Authenticate_staff_Authendication_Mood, Authenticate_staff_Password, Authenticate_staff_UserName}
...
Leave.attributes={Leave_leave_id, Leave_Leave_detail, Leave_Leave_ApplyDate, Leave_Leave_EndDate, Leave_Emp_Id, Leave_Leave_Title, Leave_Leave_StartDate, Leave_Leave_NoOfDays, Leave_Leave_Status}
...
domain_model = DomainModel(
    name="_72803a22_e3fd_492b_8260_2997d060cc05",
    types={Employee, Salary, Authenticate_staff, Leave, Attendance, Login, Employee_Management_System_Component, Authentication_UseCase, Salary_Management_UseCase, Administrator_Actor, Employee_Actor, Logout_external, Login_external},
    associations={Employee_Leave, Employee_Attendance, Employee_Salary, Employee_Logout, Employee_Login},
    generalizations={},
    metadata=None
)
