...
public class Leave  {
    ...
    public Leave(
        int leave_id,        int Emp_Id,        String Leave_Title,        String Leave_detail,        String Leave_Status,        LocalDate Leave_StartDate,        LocalDate Leave_EndDate,        int Leave_NoOfDays,        LocalDate Leave_ApplyDate    ) {
