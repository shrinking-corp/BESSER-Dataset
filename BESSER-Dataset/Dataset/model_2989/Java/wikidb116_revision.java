...
public class wikidb116_revision  {
    ...
    public wikidb116_revision(
        String rev_id,        int rev_deleted,        String rev_timestamp,        String rev_page,        String rev_parent_id,        String rev_user_text,        int rev_minor_edit,        String rev_len,        String rev_comment,        String rev_user,        String rev_text_id    ) {
        this.rev_id = rev_id;
