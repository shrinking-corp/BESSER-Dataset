...
public class wikidb116_recentchanges  {
    ...
    public wikidb116_recentchanges(
        int rc_minor,        String rc_this_oldid,        String rc_namespace,        String rc_cur_id,        int rc_bot,        int rc_type,        String rc_log_action,        String rc_params,        int rc_new,        String rc_moved_to_title,        int rc_moved_to_ns,        String rc_user,        String rc_id,        String rc_cur_time,        String rc_title,        String rc_user_text,        String rc_comment,        int rc_patrolled,        String rc_timestamp,        String rc_ip,        String rc_logid,        int rc_deleted,        String rc_log_type,        String rc_new_len,        String rc_old_len,        String rc_last_oldid    ) {
