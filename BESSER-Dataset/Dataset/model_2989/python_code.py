...
class wikidb116_oldimage:
    ...
    def __init__(self, oi_height: str, oi_bits: str, oi_metadata: str, oi_user: str, oi_media_type: str, oi_deleted: int, oi_major_mime: str, oi_width: str, oi_sha1: str, oi_description: str, oi_size: str, oi_name: str, oi_timestamp: str, oi_minor_mime: str, oi_user_text: str, oi_archive_name: str):
...
class wikidb116_querycachetwo:
    ...
    def __init__(self, qcc_namespacetwo: str, qcc_value: str, qcc_titletwo: str, qcc_namespace: str, qcc_title: str, qcc_type: str):
...
class wikidb116_ipblocks:
    ...
    def __init__(self, ipb_anon_only: int, ipb_block_email: int, ipb_by_text: str, ipb_enable_autoblock: int, ipb_id: str, ipb_reason: str, ipb_timestamp: str, ipb_range_end: str, ipb_allow_usertalk: int, ipb_range_start: str, ipb_expiry: str, ipb_deleted: int, ipb_user: str, ipb_by: str, ipb_address: str, ipb_auto: int, ipb_create_account: int):
...
class wikidb116_externallinks:
    ...
    def __init__(self, el_from: str, el_to: str, el_index: str):
...
class wikidb116_filearchive:
    ...
    def __init__(self, fa_media_type: str, fa_name: str, fa_user: str, fa_timestamp: str, fa_deleted_user: str, fa_minor_mime: str, fa_storage_group: str, fa_storage_key: str, fa_bits: str, fa_id: str, fa_size: str, fa_user_text: str, fa_major_mime: str, fa_deleted_timestamp: str, fa_width: str, fa_height: str, fa_deleted: int, fa_metadata: str, fa_description: str, fa_deleted_reason: str, fa_archive_name: str):
