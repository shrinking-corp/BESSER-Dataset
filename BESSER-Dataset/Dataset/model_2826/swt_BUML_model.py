...
# Classes
swt_Widget = Class(name="swt_Widget", is_abstract=True)
swt_Layout = Class(name="swt_Layout", is_abstract=True)
swt_Color = Class(name="swt_Color", is_abstract=True)
swt_Font = Class(name="swt_Font")
swt_AbstractComposite = Class(name="swt_AbstractComposite", is_abstract=True)
Control = Class(name="Control")
swt_Composite = Class(name="swt_Composite")
swt_Group = Class(name="swt_Group")
Composite = Class(name="Composite")
swt_Canvas = Class(name="swt_Canvas")
swt_Decorations = Class(name="swt_Decorations", is_abstract=True)
Canvas = Class(name="Canvas")
swt_MenuBar = Class(name="swt_MenuBar")
swt_Shell = Class(name="swt_Shell")
Decorations = Class(name="Decorations")
swt_LayoutData = Class(name="swt_LayoutData", is_abstract=True)
swt_Control = Class(name="swt_Control", is_abstract=True)
Widget = Class(name="Widget")
swt_Button = Class(name="swt_Button")
swt_AbstractMenu = Class(name="swt_AbstractMenu", is_abstract=True)
swt_MenuItem = Class(name="swt_MenuItem")
swt_Menu = Class(name="swt_Menu")
AbstractMenu = Class(name="AbstractMenu")
swt_Labeled = Class(name="swt_Labeled", is_abstract=True)
swt_Item = Class(name="swt_Item", is_abstract=True)
Labeled = Class(name="Labeled")
Item = Class(name="Item")
swt_ToolBar = Class(name="swt_ToolBar")
swt_ToolItem = Class(name="swt_ToolItem")
swt_CoolItem = Class(name="swt_CoolItem")
swt_PasswordText = Class(name="swt_PasswordText")
Text = Class(name="Text")
swt_SearchText = Class(name="swt_SearchText")
swt_IntervalControl = Class(name="swt_IntervalControl", is_abstract=True)
swt_IntervalSelector = Class(name="swt_IntervalSelector", is_abstract=True)
IntervalControl = Class(name="IntervalControl")
swt_Slider = Class(name="swt_Slider")
IntervalSelector = Class(name="IntervalSelector")
swt_Spinner = Class(name="swt_Spinner")
swt_CoolBar = Class(name="swt_CoolBar")
swt_ProgressBar = Class(name="swt_ProgressBar")
swt_Label = Class(name="swt_Label")
swt_Separator = Class(name="swt_Separator")
swt_Text = Class(name="swt_Text")
swt_Combo = Class(name="swt_Combo")
swt_TabFolder = Class(name="swt_TabFolder")
swt_TabItem = Class(name="swt_TabItem")
swt_SystemColor = Class(name="swt_SystemColor")
Color = Class(name="Color")
swt_RGBColor = Class(name="swt_RGBColor")
swt_DateTime = Class(name="swt_DateTime")
swt_Browser = Class(name="swt_Browser")
swt_AbstractList = Class(name="swt_AbstractList", is_abstract=True)
swt_List = Class(name="swt_List")
AbstractList = Class(name="AbstractList")
swt_RowData = Class(name="swt_RowData")
LayoutData = Class(name="LayoutData")
swt_GridLayout = Class(name="swt_GridLayout")
swt_FillLayout = Class(name="swt_FillLayout")
swt_RowLayout = Class(name="swt_RowLayout")
swt_FormData = Class(name="swt_FormData")
swt_FormAttachment = Class(name="swt_FormAttachment")
swt_GridData = Class(name="swt_GridData")
swt_FormLayout = Class(name="swt_FormLayout")
swt_LineAttributes = Class(name="swt_LineAttributes")
swt_TreeColumn = Class(name="swt_TreeColumn")
swt_Tree = Class(name="swt_Tree")
swt_TreeViewer = Class(name="swt_TreeViewer")
swt_Viewer = Class(name="swt_Viewer", is_abstract=True)
...
swt_Font.attributes={swt_Font_name, swt_Font_height, swt_Font_style}
...
swt_Decorations.attributes={swt_Decorations_maximized, swt_Decorations_minimized}
...
swt_Shell.attributes={swt_Shell_fullScreen, swt_Shell_trimStyle, swt_Shell_alpha, swt_Shell_modalStyle}
...
swt_Control.attributes={swt_Control_textOrientationStyle, swt_Control_enabled, swt_Control_toolTipText, swt_Control_borderStyle, swt_Control_visible, swt_Control_size, swt_Control_touchEnabled}
...
swt_Button.attributes={swt_Button_selection, swt_Button_arrowStyle, swt_Button_buttonStyle}
...
swt_AbstractMenu.attributes={swt_AbstractMenu_enabled, swt_AbstractMenu_textOrientationStyle, swt_AbstractMenu_visible}
...
swt_MenuItem.attributes={swt_MenuItem_menuItemStyle, swt_MenuItem_accelerator, swt_MenuItem_enabled, swt_MenuItem_selection, swt_MenuItem_ID}
...
swt_ToolItem.attributes={swt_ToolItem_enabled, swt_ToolItem_hotImage, swt_ToolItem_selection, swt_ToolItem_toolTipText}
...
swt_IntervalControl.attributes={swt_IntervalControl_minimum, swt_IntervalControl_maximum, swt_IntervalControl_selection}
...
swt_IntervalSelector.attributes={swt_IntervalSelector_pageIncrement, swt_IntervalSelector_increment, swt_IntervalSelector_orientationStyle}
...
swt_Text.attributes={swt_Text_message, swt_Text_text, swt_Text_editable, swt_Text_tabs, swt_Text_multiplicityStyle, swt_Text_selection, swt_Text_topIndex, swt_Text_textLimit, swt_Text_echoChar}
...
swt_DateTime.attributes={swt_DateTime_minutes, swt_DateTime_hours, swt_DateTime_day, swt_DateTime_seconds, swt_DateTime_year, swt_DateTime_month}
...
swt_Browser.attributes={swt_Browser_text, swt_Browser_javascriptEnabled, swt_Browser_url}
...
swt_AbstractList.attributes={swt_AbstractList_items, swt_AbstractList_selectionIndex}
...
swt_RowData.attributes={swt_RowData_height, swt_RowData_width, swt_RowData_exclude}
...
swt_GridLayout.attributes={swt_GridLayout_marginHeight, swt_GridLayout_verticalSpacing, swt_GridLayout_numColumns, swt_GridLayout_marginBottom, swt_GridLayout_makeColumnsEqualWidth, swt_GridLayout_marginWidth, swt_GridLayout_horizontalSpacing, swt_GridLayout_marginRight, swt_GridLayout_marginLeft, swt_GridLayout_marginTop}
...
swt_FillLayout.attributes={swt_FillLayout_marginHeight, swt_FillLayout_marginWidth, swt_FillLayout_spacing, swt_FillLayout_orientationStyle}
...
swt_RowLayout.attributes={swt_RowLayout_marginWidth, swt_RowLayout_marginTop, swt_RowLayout_fill, swt_RowLayout_justify, swt_RowLayout_spacing, swt_RowLayout_center, swt_RowLayout_marginRight, swt_RowLayout_orientationStyle, swt_RowLayout_marginHeight, swt_RowLayout_marginBottom, swt_RowLayout_marginLeft, swt_RowLayout_pack, swt_RowLayout_wrap}
...
swt_FormData.attributes={swt_FormData_width, swt_FormData_height}
...
swt_FormAttachment.attributes={swt_FormAttachment_alignment, swt_FormAttachment_denominator, swt_FormAttachment_offset, swt_FormAttachment_numerator}
...
swt_GridData.attributes={swt_GridData_grabExcessVerticalSpace, swt_GridData_verticalSpan, swt_GridData_minimumHeight, swt_GridData_horizontalIndent, swt_GridData_exclude, swt_GridData_horizontalAlignment, swt_GridData_heightHint, swt_GridData_widthHint, swt_GridData_verticalAlignment, swt_GridData_verticalIndent, swt_GridData_horizontalSpan, swt_GridData_minimumWidth, swt_GridData_grabExcessHorizontalSpace}
...
swt_FormLayout.attributes={swt_FormLayout_marginHeight, swt_FormLayout_marginTop, swt_FormLayout_spacing, swt_FormLayout_marginLeft, swt_FormLayout_marginWidth, swt_FormLayout_marginRight, swt_FormLayout_marginBottom}
...
swt_LineAttributes.attributes={swt_LineAttributes_miterLimit, swt_LineAttributes_cap, swt_LineAttributes_join, swt_LineAttributes_width, swt_LineAttributes_dashOffset, swt_LineAttributes_style, swt_LineAttributes_dash}
...
swt_TreeColumn.attributes={swt_TreeColumn_displayText, swt_TreeColumn_toolTipText}
...
domain_model = DomainModel(
    name="swt",
    types={swt_Widget, swt_Layout, swt_Color, swt_Font, swt_AbstractComposite, Control, swt_Composite, swt_Group, Composite, swt_Canvas, swt_Decorations, Canvas, swt_MenuBar, swt_Shell, Decorations, swt_LayoutData, swt_Control, Widget, swt_Button, swt_AbstractMenu, swt_MenuItem, swt_Menu, AbstractMenu, swt_Labeled, swt_Item, Labeled, Item, swt_ToolBar, swt_ToolItem, swt_CoolItem, swt_PasswordText, Text, swt_SearchText, swt_IntervalControl, swt_IntervalSelector, IntervalControl, swt_Slider, IntervalSelector, swt_Spinner, swt_CoolBar, swt_ProgressBar, swt_Label, swt_Separator, swt_Text, swt_Combo, swt_TabFolder, swt_TabItem, swt_SystemColor, Color, swt_RGBColor, swt_DateTime, swt_Browser, swt_AbstractList, swt_List, AbstractList, swt_RowData, LayoutData, swt_GridLayout, swt_FillLayout, swt_RowLayout, swt_FormData, swt_FormAttachment, swt_GridData, swt_FormLayout, swt_LineAttributes, swt_TreeColumn, swt_Tree, swt_TreeViewer, swt_Viewer, SystemColors, ProgressState, FontStyle, FormAttachmentAlignment, VerticalAlignmentStyle, MultiplicityStyle, ComboStyle, MenuStyle, MenuItemStyle, ModalStyle, TrimStyle, BorderStyle, ButtonStyle, ArrowStyle, TextOrientationStyle, OrientationStyle, HorizontalAlignmentStyle, SortDirection, LineStyle, CapStyle, JoinStyle},
    ...
    generalizations={gen_swt_AbstractComposite_Control, gen_swt_Group_Composite, gen_swt_Canvas_Composite, gen_swt_Decorations_Canvas, gen_swt_Control_Widget, gen_swt_AbstractMenu_Widget, gen_swt_Menu_AbstractMenu, gen_swt_MenuBar_AbstractMenu, gen_swt_Item_Widget, gen_swt_Item_Labeled, gen_swt_MenuItem_Item, gen_swt_ToolBar_Control, gen_swt_ToolItem_Item, gen_swt_Shell_Decorations, gen_swt_CoolItem_Item, gen_swt_PasswordText_Text, gen_swt_SearchText_Text, gen_swt_IntervalControl_Control, gen_swt_IntervalSelector_IntervalControl, gen_swt_Slider_IntervalSelector, gen_swt_Spinner_IntervalSelector, gen_swt_ProgressBar_IntervalControl, gen_swt_Label_Control, gen_swt_Label_Labeled, gen_swt_Separator_Control, gen_swt_Button_Control, gen_swt_Button_Labeled, gen_swt_Text_Control, gen_swt_Combo_AbstractList, gen_swt_TabFolder_Control, gen_swt_TabItem_Item, gen_swt_SystemColor_Color, gen_swt_RGBColor_Color, gen_swt_DateTime_Control, gen_swt_Browser_Control, gen_swt_AbstractList_Control, gen_swt_List_AbstractList, gen_swt_RowData_LayoutData, gen_swt_FormData_LayoutData, gen_swt_GridData_LayoutData, gen_swt_TreeColumn_Item, gen_swt_Tree_Control},
    metadata=None
)
