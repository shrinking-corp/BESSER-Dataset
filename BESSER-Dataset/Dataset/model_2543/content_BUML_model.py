...
# Classes
content_C = Class(name="content_C")
content_D = Class(name="content_D")
content_F = Class(name="content_F")
content_E = Class(name="content_E")
content_A = Class(name="content_A")
W = Class(name="W")
content_B = Class(name="content_B")
content_H = Class(name="content_H")
content_I = Class(name="content_I")
content_Q = Class(name="content_Q")
content_R = Class(name="content_R")
content_G = Class(name="content_G")
content_P = Class(name="content_P")
content_J = Class(name="content_J")
content_W = Class(name="content_W")
content_M = Class(name="content_M")
content_N = Class(name="content_N")
...
content_J.attributes={content_J_linkName, content_J_cardinality}
...
is_21: BinaryAssociation = BinaryAssociation(
    name="is_21",
    ends={
...
as_38: BinaryAssociation = BinaryAssociation(
    name="as_38",
    ends={
...
domain_model = DomainModel(
    name="content",
    types={content_C, content_D, content_F, content_E, content_A, W, content_B, content_H, content_I, content_Q, content_R, content_G, content_P, content_J, content_W, content_M, content_N},
    associations={cs1, ds3, fs5, es7, nested10, bs0, hs19, is_21, qs23, eh25, q28, gs12, r31, ps33, e14, js17, qs42, p45, h35, as_38, ns40},
    generalizations={gen_content_B_W, gen_content_C_W, gen_content_A_W, gen_content_H_W, gen_content_I_W, gen_content_D_W, gen_content_J_W, gen_content_E_W, gen_content_F_W, gen_content_G_W, gen_content_Q_W, gen_content_R_W, gen_content_M_W, gen_content_N_W, gen_content_P_W},
    metadata=None
)
