...
public class b_AssertionExpr  {
    ...
    private b_Assertions b_assertions;


    public b_AssertionExpr(
    ) {
    }
    ...
    public b_Assertions getB_assertions() {
        return b_assertions;
    }

    public void setB_assertions(b_Assertions b_assertions) {
        this.b_assertions = b_assertions;
    }
