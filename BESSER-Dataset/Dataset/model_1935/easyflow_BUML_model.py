...
# Classes
easyflow_Workflow = Class(name="easyflow_Workflow")
easyflow_EasyFlowConfiguration = Class(name="easyflow_EasyFlowConfiguration")
easyflow_EasyFlowMetadata = Class(name="easyflow_EasyFlowMetadata")
easyflow_EasyFlowImplementationTemplate = Class(name="easyflow_EasyFlowImplementationTemplate")
easyflow_DataProcessingType = Class(name="easyflow_DataProcessingType")
easyflow_DataProcessingTypeToTask = Class(name="easyflow_DataProcessingTypeToTask")
easyflow_TaskToDataProcessingType = Class(name="easyflow_TaskToDataProcessingType")
easyflow_DataFormatToTaskList = Class(name="easyflow_DataFormatToTaskList")
easyflow_Task = Class(name="easyflow_Task")
easyflow_EasyFlowTemplate = Class(name="easyflow_EasyFlowTemplate")
easyflow_StringToToolMap = Class(name="easyflow_StringToToolMap")
easyflow_StringToTaskMap = Class(name="easyflow_StringToTaskMap")
easyflow_StringToGroupingCriterionMap = Class(name="easyflow_StringToGroupingCriterionMap")
easyflow_StringToTraversalCriterionMap = Class(name="easyflow_StringToTraversalCriterionMap")
easyflow_StringToGroupMap = Class(name="easyflow_StringToGroupMap")
easyflow_CommandArgument = Class(name="easyflow_CommandArgument")
easyflow_IWorkflowUtil = Class(name="easyflow_IWorkflowUtil", is_abstract=True)
easyflow_Interpreter = Class(name="easyflow_Interpreter")
easyflow_Argument = Class(name="easyflow_Argument")
easyflow_GroupingCriterion = Class(name="easyflow_GroupingCriterion")
easyflow_Tool = Class(name="easyflow_Tool")
easyflow_Group = Class(name="easyflow_Group")
GroupingCriterion = Class(name="GroupingCriterion")
easyflow_StringToSampleMap = Class(name="easyflow_StringToSampleMap")
easyflow_StringToReadgroupMap = Class(name="easyflow_StringToReadgroupMap")
easyflow_StringToLibraryMap = Class(name="easyflow_StringToLibraryMap")
easyflow_StringToRecordMap = Class(name="easyflow_StringToRecordMap")
easyflow_Sample = Class(name="easyflow_Sample")
easyflow_Readgroup = Class(name="easyflow_Readgroup")
easyflow_Record = Class(name="easyflow_Record")
easyflow_EasyFlowMetadataReader = Class(name="easyflow_EasyFlowMetadataReader")
EasyFlowMetadata = Class(name="EasyFlowMetadata")
easyflow_Library = Class(name="easyflow_Library")
easyflow_ITraversal = Class(name="easyflow_ITraversal", is_abstract=True)
easyflow_Traversal = Class(name="easyflow_Traversal")
ITraversal = Class(name="ITraversal")
easyflow_StringToChunkMap = Class(name="easyflow_StringToChunkMap")
easyflow_GenericTraversalCriterion = Class(name="easyflow_GenericTraversalCriterion")
Traversal = Class(name="Traversal")
easyflow_ReadEnd = Class(name="easyflow_ReadEnd")
easyflow_Contig = Class(name="easyflow_Contig")
easyflow_Locus = Class(name="easyflow_Locus")
easyflow_SplittingEvent = Class(name="easyflow_SplittingEvent")
easyflow_Job = Class(name="easyflow_Job")
easyflow_GroupingEvent = Class(name="easyflow_GroupingEvent")
easyflow_Chunk = Class(name="easyflow_Chunk")
...
easyflow_Workflow_m_processMetadata: Method = Method(name="processMetadata", parameters={Parameter(name='easyflow_metadata', type=StringType), Parameter(name='easyflow_task', type=StringType)})
easyflow_Workflow_m_processMetadataSet: Method = Method(name="processMetadataSet", parameters={Parameter(name='easyflow_task', type=StringType)})
...
easyflow_Workflow_m_iterateByGroup: Method = Method(name="iterateByGroup", parameters={Parameter(name='easyflow_dataCriterion', type=StringType), Parameter(name='easyflow_group', type=StringType), Parameter(name='easyflow_dag', type=StringType), Parameter(name='easyflow_task', type=StringType)}, type=StringType)
easyflow_Workflow_m_resolveStaticDependencies: Method = Method(name="resolveStaticDependencies", parameters={})
easyflow_Workflow_m_getNextSplittingEvent: Method = Method(name="getNextSplittingEvent", parameters={Parameter(name='easyflow_processedTasks', type=StringType)})
easyflow_Workflow_m_getTasksFromLastTaskClass: Method = Method(name="getTasksFromLastTaskClass", parameters={Parameter(name='easyflow_dataFormatIn', type=StringType), Parameter(name='easyflow_strategy', type=StringType), Parameter(name='easyflow_dataFormatOut', type=StringType)}, type=StringType)
easyflow_Workflow_m_getTasksFromLastTaskClassMap: Method = Method(name="getTasksFromLastTaskClassMap", parameters={Parameter(name='easyflow_dataProcessingTypeIn', type=StringType), Parameter(name='easyflow_strategy', type=StringType)})
easyflow_Workflow_m_updateLastTaskClass: Method = Method(name="updateLastTaskClass", parameters={Parameter(name='easyflow_dataFormatIn', type=StringType), Parameter(name='easyflow_task', type=StringType), Parameter(name='easyflow_dataFormatOut', type=StringType)})
easyflow_Workflow_m_updateLastTaskClassMap: Method = Method(name="updateLastTaskClassMap", parameters={Parameter(name='easyflow_task', type=StringType), Parameter(name='easyflow_dataProcessingType', type=StringType)})
...
easyflow_Workflow.attributes={easyflow_Workflow_jobDag, easyflow_Workflow_dag, easyflow_Workflow_graph, easyflow_Workflow_name}
easyflow_Workflow.methods={easyflow_Workflow_m_getTasksFromLastTaskClassMap, easyflow_Workflow_m_printLastTaskClassMap, easyflow_Workflow_m_getTasksFromLastTaskClass, easyflow_Workflow_m_createTaskDag, easyflow_Workflow_m_iterateByGroup, easyflow_Workflow_m_checkDag, easyflow_Workflow_m_resolveStaticDependencies, easyflow_Workflow_m_updateLastTaskClassMap, easyflow_Workflow_m_createJobDag, easyflow_Workflow_m_writeMakeflow, easyflow_Workflow_m_printLastTaskMap, easyflow_Workflow_m_writeAWSCloudFormation, easyflow_Workflow_m_processMetadata, easyflow_Workflow_m_updateLastTaskClass, easyflow_Workflow_m_processMetadataSet, easyflow_Workflow_m_getNextSplittingEvent}
...
easyflow_EasyFlowConfiguration.attributes={easyflow_EasyFlowConfiguration_configMap, easyflow_EasyFlowConfiguration_fileName}
...
easyflow_EasyFlowMetadata.attributes={easyflow_EasyFlowMetadata_refData, easyflow_EasyFlowMetadata_contrast, easyflow_EasyFlowMetadata_name}
...
easyflow_EasyFlowImplementationTemplate_m_readParameterConfig: Method = Method(name="readParameterConfig", parameters={Parameter(name='easyflow_toolName', type=StringType)})
easyflow_EasyFlowImplementationTemplate_m_initJsonRootNode: Method = Method(name="initJsonRootNode", parameters={})
easyflow_EasyFlowImplementationTemplate_m_templateFileParser: Method = Method(name="templateFileParser", parameters={Parameter(name='easyflow_dag', type=StringType)})
easyflow_EasyFlowImplementationTemplate.attributes={easyflow_EasyFlowImplementationTemplate_fileName, easyflow_EasyFlowImplementationTemplate_parameterConfigFileName, easyflow_EasyFlowImplementationTemplate_globalOptions, easyflow_EasyFlowImplementationTemplate_parameterConfigMap, easyflow_EasyFlowImplementationTemplate_jsonRootNode}
easyflow_EasyFlowImplementationTemplate.methods={easyflow_EasyFlowImplementationTemplate_m_templateFileParser, easyflow_EasyFlowImplementationTemplate_m_initJsonRootNode, easyflow_EasyFlowImplementationTemplate_m_readParameterConfig}
...
easyflow_DataProcessingType_m_isConvertableTo: Method = Method(name="isConvertableTo", parameters={Parameter(name='easyflow_dataProcessingTypeOut', type=StringType)}, type=BooleanType)
easyflow_DataProcessingType.attributes={easyflow_DataProcessingType_dataFormatIn, easyflow_DataProcessingType_dataFormatOut}
...
easyflow_Task_m_readTask: Method = Method(name="readTask", parameters={Parameter(name='easyflow_wtplLine', type=StringType)})
easyflow_Task_m_evaluateJexlExp: Method = Method(name="evaluateJexlExp", parameters={Parameter(name='easyflow_map', type=StringType)}, type=BooleanType)
...
easyflow_Task_m_fitsToGroupingCriterionOf: Method = Method(name="fitsToGroupingCriterionOf", parameters={Parameter(name='easyflow_task', type=StringType)}, type=BooleanType)
easyflow_Task_m_isConvertableTo: Method = Method(name="isConvertableTo", parameters={Parameter(name='easyflow_dataFormat', type=StringType)}, type=BooleanType)
easyflow_Task_m_isMarkedToSkip: Method = Method(name="isMarkedToSkip", parameters={}, type=BooleanType)
easyflow_Task_m_getParentForTask: Method = Method(name="getParentForTask", parameters={Parameter(name='easyflow_dag', type=StringType)}, type=StringType)
easyflow_Task_m_getSampleUniqueString: Method = Method(name="getSampleUniqueString", parameters={}, type=StringType)
easyflow_Task_m_getParentForTask: Method = Method(name="getParentForTask", parameters={Parameter(name='easyflow_graph', type=StringType)}, type=StringType)
easyflow_Task.attributes={easyflow_Task_dataFormatOut, easyflow_Task_splitCriterion, easyflow_Task_mergeCriterion, easyflow_Task_depricated, easyflow_Task_dataFormatIn, easyflow_Task_cardinalityOut, easyflow_Task_skipGroupingCriterion, easyflow_Task_isMultipleInstancesOfDataCriterion, easyflow_Task_name, easyflow_Task_util, easyflow_Task_dataCriterion, easyflow_Task_traversalCriterion, easyflow_Task_contrast, easyflow_Task_cardinalityIn, easyflow_Task_static, easyflow_Task_jexlString}
easyflow_Task.methods={easyflow_Task_m_fitsToGroupingCriterionOf, easyflow_Task_m_isMarkedToSkip, easyflow_Task_m_copy, easyflow_Task_m_getParentForTask, easyflow_Task_m_getUniqueString, easyflow_Task_m_evaluateJexlExp, easyflow_Task_m_readTask, easyflow_Task_m_getSampleUniqueString, easyflow_Task_m_isConvertableTo, easyflow_Task_m_getParentForTask}
...
easyflow_CommandArgument_m_setGlobalCmdProperties: Method = Method(name="setGlobalCmdProperties", parameters={Parameter(name='easyflow_parameterConfigMap', type=StringType)})
easyflow_CommandArgument_m_setCmdProperties: Method = Method(name="setCmdProperties", parameters={Parameter(name='easyflow_parameterConfigMap', type=StringType)})
easyflow_CommandArgument_m_printArgument: Method = Method(name="printArgument", parameters={Parameter(name='easyflow_fileName', type=StringType)}, type=StringType)
easyflow_CommandArgument_m_printStaticArg: Method = Method(name="printStaticArg", parameters={}, type=StringType)
easyflow_CommandArgument_m_printGenericArg: Method = Method(name="printGenericArg", parameters={Parameter(name='easyflow_generica', type=StringType)}, type=StringType)
easyflow_CommandArgument.attributes={easyflow_CommandArgument_named, easyflow_CommandArgument_arg, easyflow_CommandArgument_sep, easyflow_CommandArgument_name, easyflow_CommandArgument_required}
...
easyflow_IWorkflowUtil_m_addTaskListToDAG: Method = Method(name="addTaskListToDAG", parameters={Parameter(name='easyflow_dag', type=StringType), Parameter(name='easyflow_curTask', type=StringType), Parameter(name='easyflow_lastTasks', type=StringType)})
easyflow_IWorkflowUtil_m_getTaskByName: Method = Method(name="getTaskByName", parameters={Parameter(name='easyflow_tasks', type=StringType), Parameter(name='easyflow_taskNames', type=StringType)})
easyflow_IWorkflowUtil_m_getGroupingCriterion: Method = Method(name="getGroupingCriterion", parameters={Parameter(name='easyflow_dataCriterion', type=StringType), Parameter(name='easyflow_key', type=StringType), Parameter(name='easyflow_group', type=StringType)}, type=StringType)
easyflow_IWorkflowUtil_m_getKeysForGroupingCriterion: Method = Method(name="getKeysForGroupingCriterion", parameters={Parameter(name='easyflow_group', type=StringType), Parameter(name='easyflow_dataCriterion', type=StringType)})
easyflow_IWorkflowUtil_m_writeDagToDot: Method = Method(name="writeDagToDot", parameters={Parameter(name='easyflow_dag', type=StringType), Parameter(name='easyflow_fileName', type=StringType)})
easyflow_IWorkflowUtil_m_addTaskListToGraph: Method = Method(name="addTaskListToGraph", parameters={Parameter(name='easyflow_lastTasks', type=StringType), Parameter(name='easyflow_curTask', type=StringType), Parameter(name='easyflow_graph', type=StringType)})
easyflow_IWorkflowUtil_m_convertDagToGraph: Method = Method(name="convertDagToGraph", parameters={Parameter(name='easyflow_graph', type=StringType), Parameter(name='easyflow_dag', type=StringType)}, type=StringType)
easyflow_IWorkflowUtil_m_convertGraphToDag: Method = Method(name="convertGraphToDag", parameters={Parameter(name='easyflow_graph', type=StringType)}, type=StringType)
easyflow_IWorkflowUtil.methods={easyflow_IWorkflowUtil_m_writeDagToDot, easyflow_IWorkflowUtil_m_addTaskListToGraph, easyflow_IWorkflowUtil_m_addTaskListToDAG, easyflow_IWorkflowUtil_m_convertDagToGraph, easyflow_IWorkflowUtil_m_getGroupingCriterion, easyflow_IWorkflowUtil_m_getAllTasks, easyflow_IWorkflowUtil_m_convertGraphToDag, easyflow_IWorkflowUtil_m_getTaskByName, easyflow_IWorkflowUtil_m_getKeysForGroupingCriterion}
...
easyflow_Interpreter.attributes={easyflow_Interpreter_subCmd, easyflow_Interpreter_name, easyflow_Interpreter_options, easyflow_Interpreter_exe}
...
easyflow_Argument.attributes={easyflow_Argument_name, easyflow_Argument_arg, easyflow_Argument_sep}
...
easyflow_GroupingCriterion_m_getMap: Method = Method(name="getMap", parameters={Parameter(name='easyflow_groupCritMap', type=StringType)})
easyflow_GroupingCriterion_m_getKeysForGroupingCriterion: Method = Method(name="getKeysForGroupingCriterion", parameters={Parameter(name='easyflow_dataCriterion', type=StringType), Parameter(name='easyflow_group', type=StringType)})
easyflow_GroupingCriterion_m_getGroupingCriterion: Method = Method(name="getGroupingCriterion", parameters={Parameter(name='easyflow_key', type=StringType), Parameter(name='easyflow_dataCriterion', type=StringType), Parameter(name='easyflow_group', type=StringType)}, type=StringType)
easyflow_GroupingCriterion_m_getLibraryString: Method = Method(name="getLibraryString", parameters={Parameter(name='easyflow_groupingCriterion', type=StringType)})
easyflow_GroupingCriterion_m_getUniqueStringForParent: Method = Method(name="getUniqueStringForParent", parameters={Parameter(name='easyflow_parentGroupingCriterion', type=StringType)})
easyflow_GroupingCriterion_m_equalsParent: Method = Method(name="equalsParent", parameters={Parameter(name='easyflow_map', type=StringType)}, type=BooleanType)
easyflow_GroupingCriterion_m_getGroupString: Method = Method(name="getGroupString", parameters={Parameter(name='easyflow_groupingCriterion', type=StringType)})
easyflow_GroupingCriterion_m_getSampleString: Method = Method(name="getSampleString", parameters={Parameter(name='easyflow_groupingCriterion', type=StringType)})
easyflow_GroupingCriterion_m_getRecordString: Method = Method(name="getRecordString", parameters={Parameter(name='easyflow_groupingCriterion', type=StringType)})
easyflow_GroupingCriterion_m_getReadgroupString: Method = Method(name="getReadgroupString", parameters={Parameter(name='easyflow_groupingCriterion', type=StringType)})
easyflow_GroupingCriterion.attributes={easyflow_GroupingCriterion_id}
easyflow_GroupingCriterion.methods={easyflow_GroupingCriterion_m_getReadgroupString, easyflow_GroupingCriterion_m_equalsParent, easyflow_GroupingCriterion_m_getGroupingCriterion, easyflow_GroupingCriterion_m_getRecordString, easyflow_GroupingCriterion_m_getKeysForGroupingCriterion, easyflow_GroupingCriterion_m_getSampleString, easyflow_GroupingCriterion_m_getUniqueStringForParent, easyflow_GroupingCriterion_m_getGroupString, easyflow_GroupingCriterion_m_getLibraryString, easyflow_GroupingCriterion_m_getMap}
...
easyflow_Tool_m_applyGlobalOptions: Method = Method(name="applyGlobalOptions", parameters={Parameter(name='easyflow_globalOptions', type=StringType)})
easyflow_Tool_m_createJob: Method = Method(name="createJob", parameters={Parameter(name='easyflow_groupingId', type=StringType)}, type=StringType)
easyflow_Tool.attributes={easyflow_Tool_refData, easyflow_Tool_subCmdPrefix, easyflow_Tool_toolName, easyflow_Tool_category, easyflow_Tool_subCmd, easyflow_Tool_source, easyflow_Tool_pattern, easyflow_Tool_type}
easyflow_Tool.methods={easyflow_Tool_m_createJob, easyflow_Tool_m_applyGlobalOptions}
...
easyflow_Readgroup.attributes={easyflow_Readgroup_name, easyflow_Readgroup_platform, easyflow_Readgroup_description, easyflow_Readgroup_platformUnit}
...
easyflow_ITraversal_m_readTemplate: Method = Method(name="readTemplate", parameters={Parameter(name='easyflow_fileName', type=StringType)})
easyflow_ITraversal_m_readChunks: Method = Method(name="readChunks", parameters={Parameter(name='easyflow_fileName', type=StringType)})
easyflow_ITraversal_m_readChunks: Method = Method(name="readChunks", parameters={})
easyflow_ITraversal.methods={easyflow_ITraversal_m_readChunks, easyflow_ITraversal_m_readTemplate, easyflow_ITraversal_m_readChunks, easyflow_ITraversal_m_getChunksAsString}
...
easyflow_SplittingEvent_m_applyTraversalCriterion: Method = Method(name="applyTraversalCriterion", parameters={Parameter(name='easyflow_metadata', type=StringType)})
easyflow_SplittingEvent_m_getTraversalImplementation: Method = Method(name="getTraversalImplementation", parameters={Parameter(name='easyflow_metadata', type=StringType)}, type=ITraversal)
easyflow_SplittingEvent_m_removePath: Method = Method(name="removePath", parameters={})
easyflow_SplittingEvent_m_insertPathToDag: Method = Method(name="insertPathToDag", parameters={Parameter(name='easyflow_chunks', type=StringType)})
easyflow_SplittingEvent.attributes={easyflow_SplittingEvent_traversalCriterion, easyflow_SplittingEvent_traversalChunks, easyflow_SplittingEvent_traversalImplDir, easyflow_SplittingEvent_dag, easyflow_SplittingEvent_processedTask}
easyflow_SplittingEvent.methods={easyflow_SplittingEvent_m_getTraversalImplementation, easyflow_SplittingEvent_m_insertPathToDag, easyflow_SplittingEvent_m_applyTraversalCriterion, easyflow_SplittingEvent_m_removePath}
...
easyflow_Job.attributes={easyflow_Job_inputArgs, easyflow_Job_outputArgs, easyflow_Job_dependencies, easyflow_Job_staticArgs, easyflow_Job_source, easyflow_Job_targetPlatform, easyflow_Job_targetPlatformOptions, easyflow_Job_interpreterOption, easyflow_Job_genericArgs, easyflow_Job_targets, easyflow_Job_name, easyflow_Job_exe, easyflow_Job_subCmd}
...
easyflow_GroupingEvent_m_applyGroupingCriterion: Method = Method(name="applyGroupingCriterion", parameters={Parameter(name='easyflow_metadata', type=StringType)}, type=StringType)
easyflow_GroupingEvent.attributes={easyflow_GroupingEvent_dagIn, easyflow_GroupingEvent_dagOut}
...
domain_model = DomainModel(
    name="easyflow",
    types={easyflow_Workflow, easyflow_EasyFlowConfiguration, easyflow_EasyFlowMetadata, easyflow_EasyFlowImplementationTemplate, easyflow_DataProcessingType, easyflow_DataProcessingTypeToTask, easyflow_TaskToDataProcessingType, easyflow_DataFormatToTaskList, easyflow_Task, easyflow_EasyFlowTemplate, easyflow_StringToToolMap, easyflow_StringToTaskMap, easyflow_StringToGroupingCriterionMap, easyflow_StringToTraversalCriterionMap, easyflow_StringToGroupMap, easyflow_CommandArgument, easyflow_IWorkflowUtil, easyflow_Interpreter, easyflow_Argument, easyflow_GroupingCriterion, easyflow_Tool, easyflow_Group, GroupingCriterion, easyflow_StringToSampleMap, easyflow_StringToReadgroupMap, easyflow_StringToLibraryMap, easyflow_StringToRecordMap, easyflow_Sample, easyflow_Readgroup, easyflow_Record, easyflow_EasyFlowMetadataReader, EasyFlowMetadata, easyflow_Library, easyflow_ITraversal, easyflow_Traversal, ITraversal, easyflow_StringToChunkMap, easyflow_GenericTraversalCriterion, Traversal, easyflow_ReadEnd, easyflow_Contig, easyflow_Locus, easyflow_SplittingEvent, easyflow_Job, easyflow_GroupingEvent, easyflow_Chunk, DataFormat, DataCriterion, TraversalCriterion},
    associations={Configuration1, metadata3, ImplementationTemplate5, DataProcessingType7, LastTaskClassMap9, taskMap11, lastTaskMap13, WorkflowTemplate0, tool15, parentTasks16, groupingCriterionMap18, chunks20, sortOrder22, key25, workflow28, groups31, key33, value36, argIn39, argOut40, staticArg43, genericArg46, interpreter49, task51, metadata54, samples56, readgroups57, libraries59, records61, libraries63, records65, readgroups68, readgroups81, sample84, readgroup86, library89, value92, value95, value98, value101, value104, value107, samples71, libraries73, samples76, records78, splittingTask118, chunks120, value110, value113, metadata116, mergingChildTask126, value129, key132, value135, value138, parentTask121, splittingTask123},
    generalizations={gen_easyflow_Group_GroupingCriterion, gen_easyflow_Sample_GroupingCriterion, gen_easyflow_Readgroup_GroupingCriterion, gen_easyflow_Record_GroupingCriterion, gen_easyflow_EasyFlowMetadataReader_EasyFlowMetadata, gen_easyflow_Library_GroupingCriterion, gen_easyflow_Traversal_ITraversal, gen_easyflow_GenericTraversalCriterion_Traversal, gen_easyflow_ReadEnd_Traversal, gen_easyflow_Contig_Traversal, gen_easyflow_Locus_Traversal},
    metadata=None
)
