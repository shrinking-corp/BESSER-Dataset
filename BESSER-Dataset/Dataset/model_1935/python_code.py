...
class easyflow_Job:
    ...
    def __init__(self, interpreterOption: str, dependencies: str, targets: str, inputArgs: str, outputArgs: str, genericArgs: str, staticArgs: str, targetPlatform: str, targetPlatformOptions: str, subCmd: str, source: str, name: str, exe: str, easyflow_Job: "easyflow_EasyFlowMetadata" = None):
...
class easyflow_SplittingEvent:
    ...
    def __init__(self, dag: str, processedTask: str, traversalImplDir: str, traversalCriterion: str, traversalChunks: str, easyflow_SplittingEvent127: "easyflow_Task" = None, easyflow_SplittingEvent: "easyflow_Task" = None, easyflow_SplittingEvent124: "easyflow_Task" = None):
        self.dag = dag
...
class easyflow_StringToLibraryMap:
    ...
    def __init__(self, key: str, easyflow_StringToLibraryMap: "easyflow_Group" = None, easyflow_StringToLibraryMap64: "easyflow_Sample" = None, easyflow_StringToLibraryMap102: "easyflow_Library" = None, easyflow_StringToLibraryMap75: "easyflow_Readgroup" = None):
        self.key = key
...
class easyflow_StringToSampleMap:
    ...
    def __init__(self, key: str, easyflow_StringToSampleMap: "easyflow_Group" = None, easyflow_StringToSampleMap96: "easyflow_Sample" = None, easyflow_StringToSampleMap77: "easyflow_Library" = None, easyflow_StringToSampleMap72: "easyflow_Readgroup" = None):
        self.key = key
...
class easyflow_Readgroup(GroupingCriterion):
    ...
    def __init__(self, name: str, platform: str, platformUnit: str, description: str, easyflow_Readgroup88: "easyflow_Record" = None, easyflow_Readgroup100: "easyflow_StringToReadgroupMap" = None, easyflow_Readgroup74: set["easyflow_StringToLibraryMap"] = None, easyflow_Readgroup: set["easyflow_StringToSampleMap"] = None):
        self.name = name
...
class easyflow_GroupingCriterion:
    ...
    def getGroupingCriterion(self, easyflow_group, easyflow_key, easyflow_dataCriterion) :
...
class easyflow_IWorkflowUtil(ABC):
    ...
    def addTaskListToGraph(self, easyflow_graph, easyflow_lastTasks, easyflow_curTask):
        # TODO: Implement addTaskListToGraph method
        pass

    def addTaskListToDAG(self, easyflow_lastTasks, easyflow_curTask, easyflow_dag):
    ...
    def getGroupingCriterion(self, easyflow_group, easyflow_dataCriterion, easyflow_key) :
        # TODO: Implement getGroupingCriterion method
        pass

    def writeDagToDot(self, easyflow_fileName, easyflow_dag):
...
class easyflow_Task:
    ...
    def __init__(self, dataCriterion: str, isMultipleInstancesOfDataCriterion: str, mergeCriterion: str, traversalCriterion: str, splitCriterion: str, contrast: bool, static: bool, util: bool, jexlString: str, skipGroupingCriterion: str, depricated: bool, name: str, dataFormatIn: str, dataFormatOut: str, cardinalityIn: str, cardinalityOut: str, easyflow_Task: set["easyflow_StringToToolMap"] = None, easyflow_Task17: set["easyflow_StringToTaskMap"] = None, easyflow_Task19: set["easyflow_StringToGroupingCriterionMap"] = None, easyflow_Task21: set["easyflow_StringToTraversalCriterionMap"] = None, easyflow_Task23: set["easyflow_StringToTraversalCriterionMap"] = None, easyflow_Task26: "easyflow_TaskToDataProcessingType" = None, easyflow_Task38: "easyflow_DataProcessingTypeToTask" = None, easyflow_Task53: "easyflow_Tool" = None, easyflow_Task119: "easyflow_ITraversal" = None, easyflow_Task128: "easyflow_SplittingEvent" = None, easyflow_Task134: "easyflow_TaskToDataProcessingType" = None, easyflow_Task137: "easyflow_DataFormatToTaskList" = None, easyflow_Task122: "easyflow_SplittingEvent" = None, easyflow_Task125: "easyflow_SplittingEvent" = None, easyflow_Task109: "easyflow_StringToTaskMap" = None):
...
class easyflow_Workflow:
    ...
    def __init__(self, jobDag: str, graph: str, name: str, dag: str, easyflow_Workflow2: "easyflow_EasyFlowConfiguration" = None, easyflow_Workflow4: set["easyflow_EasyFlowMetadata"] = None, easyflow_Workflow6: "easyflow_EasyFlowImplementationTemplate" = None, easyflow_Workflow8: "easyflow_DataProcessingType" = None, easyflow_Workflow10: set["easyflow_DataProcessingTypeToTask"] = None, easyflow_Workflow12: set["easyflow_TaskToDataProcessingType"] = None, easyflow_Workflow14: set["easyflow_DataFormatToTaskList"] = None, easyflow_Workflow: "easyflow_EasyFlowTemplate" = None, easyflow_Workflow30: "easyflow_EasyFlowTemplate" = None):
        self.jobDag = jobDag
        self.graph = graph
        self.name = name
        self.dag = dag
    ...
    def iterateByGroup(self, easyflow_group, easyflow_dag, easyflow_dataCriterion, easyflow_task) :
    ...
    def processMetadata(self, easyflow_metadata, easyflow_task):
        # TODO: Implement processMetadata method
        pass

    def updateLastTaskClassMap(self, easyflow_dataProcessingType, easyflow_task):
    ...
    def getTasksFromLastTaskClassMap(self, easyflow_strategy, easyflow_dataProcessingTypeIn):
    ...
    def getTasksFromLastTaskClass(self, easyflow_dataFormatIn, easyflow_strategy, easyflow_dataFormatOut) :
    ...
    def updateLastTaskClass(self, easyflow_task, easyflow_dataFormatIn, easyflow_dataFormatOut):
