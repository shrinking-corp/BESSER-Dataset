...
class NHSM_Transition:
    ...
    def __init__(self, cost: int, trigger: str, effect: str, ownedTransition: "NHSM_StateMachine" = None, Transition: "NHSM_StateMachine" = None, NHSM_Transition: "NHSM_State" = None, NHSM_Transition3: "NHSM_State" = None):
        self.cost = cost
...
class NHSM_State:
    ...
    def __init__(self, name: str, memRequirement: int, State: "NHSM_StateMachine" = None, ownedState: "NHSM_StateMachine" = None, NHSM_State: "NHSM_Transition" = None, NHSM_State4: "NHSM_Transition" = None):
        self.name = name
