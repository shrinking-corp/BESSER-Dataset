...
domain_model = DomainModel(
    name="simpleRdbms",
    types={simpleRdbms_Schema, RModelElement, simpleRdbms_Table, simpleRdbms_RModelElement, simpleRdbms_Column, simpleRdbms_Key, simpleRdbms_ForeignKey},
    associations={tables0, column15, owner17, column20, schema1, column2, key3, foreignKey5, owner7, key9, foreignKey12, refersTo22, owner23},
