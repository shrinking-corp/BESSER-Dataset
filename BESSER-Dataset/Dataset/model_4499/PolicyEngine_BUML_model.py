...
# Classes
PolicyEngine_CalendarSystem = Class(name="PolicyEngine_CalendarSystem")
PolicyEngine_MeetingScheduleSystem = Class(name="PolicyEngine_MeetingScheduleSystem")
PolicyEngine_Floor = Class(name="PolicyEngine_Floor")
PolicyEngine_Timer = Class(name="PolicyEngine_Timer")
PolicyEngine_Model = Class(name="PolicyEngine_Model")
PolicyEngine_Room = Class(name="PolicyEngine_Room")
PolicyEngine_Policy = Class(name="PolicyEngine_Policy")
PolicyEngine_Building = Class(name="PolicyEngine_Building")
NamedElement = Class(name="NamedElement")
PolicyEngine_CTS = Class(name="PolicyEngine_CTS")
PolicyEngine_AccessControl = Class(name="PolicyEngine_AccessControl")
PolicyEngine_HumidifierActuator = Class(name="PolicyEngine_HumidifierActuator")
PolicyEngine_LightSensor = Class(name="PolicyEngine_LightSensor")
PolicyEngine_State = Class(name="PolicyEngine_State")
PolicyEngine_Schedule = Class(name="PolicyEngine_Schedule")
PolicyEngine_LightSwitchActuator = Class(name="PolicyEngine_LightSwitchActuator")
Actuator = Class(name="Actuator")
PolicyEngine_Sensor = Class(name="PolicyEngine_Sensor", is_abstract=True)
HasIntegerValue = Class(name="HasIntegerValue")
PolicyEngine_Actuator = Class(name="PolicyEngine_Actuator", is_abstract=True)
PolicyEngine_SensorComponent = Class(name="PolicyEngine_SensorComponent")
HasSensors = Class(name="HasSensors")
PolicyEngine_MotionSensor = Class(name="PolicyEngine_MotionSensor")
Sensor = Class(name="Sensor")
PolicyEngine_TemperatureSensor = Class(name="PolicyEngine_TemperatureSensor")
PolicyEngine_PressureSensor = Class(name="PolicyEngine_PressureSensor")
PolicyEngine_TouchSensor = Class(name="PolicyEngine_TouchSensor")
PolicyEngine_WindowActuator = Class(name="PolicyEngine_WindowActuator")
PolicyEngine_DoorActuator = Class(name="PolicyEngine_DoorActuator")
PolicyEngine_NamedElement = Class(name="PolicyEngine_NamedElement", is_abstract=True)
PolicyEngine_RadiatorActuator = Class(name="PolicyEngine_RadiatorActuator")
PolicyEngine_SmokeSensor = Class(name="PolicyEngine_SmokeSensor")
PolicyEngine_HasSensors = Class(name="PolicyEngine_HasSensors")
PolicyEngine_HasActuators = Class(name="PolicyEngine_HasActuators")
PolicyEngine_CO2Sensor = Class(name="PolicyEngine_CO2Sensor")
HasActuators = Class(name="HasActuators")
PolicyEngine_If = Class(name="PolicyEngine_If")
PolicyEngine_InfraredLightSensor = Class(name="PolicyEngine_InfraredLightSensor")
PolicyEngine_HumiditySensor = Class(name="PolicyEngine_HumiditySensor")
PolicyEngine_AudioAlarmActuator = Class(name="PolicyEngine_AudioAlarmActuator")
PolicyEngine_HasIntegerValue = Class(name="PolicyEngine_HasIntegerValue")
PolicyEngine_ActuatorComponent = Class(name="PolicyEngine_ActuatorComponent")
PolicyEngine_Expression = Class(name="PolicyEngine_Expression", is_abstract=True)
PolicyEngine_Time = Class(name="PolicyEngine_Time")
PolicyEngine_BinaryOps = Class(name="PolicyEngine_BinaryOps")
PolicyEngine_UnaryOp = Class(name="PolicyEngine_UnaryOp")
PolicyEngine_Id = Class(name="PolicyEngine_Id")
PolicyEngine_TimeExpression = Class(name="PolicyEngine_TimeExpression")
Expression = Class(name="Expression")
PolicyEngine_ResetExpression = Class(name="PolicyEngine_ResetExpression")
PolicyEngine_RoomUsage = Class(name="PolicyEngine_RoomUsage")
PolicyEngine_RoomActuators = Class(name="PolicyEngine_RoomActuators")
PolicyEngine_Constant = Class(name="PolicyEngine_Constant")
...
from_85: BinaryAssociation = BinaryAssociation(
    name="from_85",
    ends={
...
else_99: BinaryAssociation = BinaryAssociation(
    name="else_99",
    ends={
...
domain_model = DomainModel(
    name="PolicyEngine",
    types={PolicyEngine_CalendarSystem, PolicyEngine_MeetingScheduleSystem, PolicyEngine_Floor, PolicyEngine_Timer, PolicyEngine_Model, PolicyEngine_Room, PolicyEngine_Policy, PolicyEngine_Building, NamedElement, PolicyEngine_CTS, PolicyEngine_AccessControl, PolicyEngine_HumidifierActuator, PolicyEngine_LightSensor, PolicyEngine_State, PolicyEngine_Schedule, PolicyEngine_LightSwitchActuator, Actuator, PolicyEngine_Sensor, HasIntegerValue, PolicyEngine_Actuator, PolicyEngine_SensorComponent, HasSensors, PolicyEngine_MotionSensor, Sensor, PolicyEngine_TemperatureSensor, PolicyEngine_PressureSensor, PolicyEngine_TouchSensor, PolicyEngine_WindowActuator, PolicyEngine_DoorActuator, PolicyEngine_NamedElement, PolicyEngine_RadiatorActuator, PolicyEngine_SmokeSensor, PolicyEngine_HasSensors, PolicyEngine_HasActuators, PolicyEngine_CO2Sensor, HasActuators, PolicyEngine_If, PolicyEngine_InfraredLightSensor, PolicyEngine_HumiditySensor, PolicyEngine_AudioAlarmActuator, PolicyEngine_HasIntegerValue, PolicyEngine_ActuatorComponent, PolicyEngine_Expression, PolicyEngine_Time, PolicyEngine_BinaryOps, PolicyEngine_UnaryOp, PolicyEngine_Id, PolicyEngine_TimeExpression, Expression, PolicyEngine_ResetExpression, PolicyEngine_RoomUsage, PolicyEngine_RoomActuators, PolicyEngine_Constant, Weekdays, CompOps},
    associations={calendarSystem3, meetingScheduleSystem5, floors7, timers9, buildings11, predefinedRooms13, policyDefinition15, ctsSystem0, accessControl1, temperatureSensors24, ctsActuators26, accessControlSensors28, stateDefinition17, timers19, schedules22, accessControlDoorLockActuator31, sensors34, actuators36, rooms54, timers57, usesActuators60, usesSensors63, specifiedBy66, declareSensor38, declareActuator40, extends43, timers45, policies48, during51, from_85, to87, cond90, then93, controlledBy68, defineState71, during74, usesRooms77, defineLocalState80, exprStates83, sen106, act108, defineState111, lexpr114, rexpr116, expr119, elseif97, else_99, time102, reset104, definedRoomActuator121, definedActuator123},
    generalizations={gen_PolicyEngine_Model_NamedElement, gen_PolicyEngine_Building_NamedElement, gen_PolicyEngine_WindowActuator_Actuator, gen_PolicyEngine_HumidifierActuator_Actuator, gen_PolicyEngine_LightSensor_Sensor, gen_PolicyEngine_LightSwitchActuator_Actuator, gen_PolicyEngine_Sensor_HasIntegerValue, gen_PolicyEngine_Actuator_HasIntegerValue, gen_PolicyEngine_SensorComponent_HasSensors, gen_PolicyEngine_SensorComponent_NamedElement, gen_PolicyEngine_MotionSensor_Sensor, gen_PolicyEngine_TemperatureSensor_Sensor, gen_PolicyEngine_PressureSensor_Sensor, gen_PolicyEngine_TouchSensor_Sensor, gen_PolicyEngine_DoorActuator_Actuator, gen_PolicyEngine_RadiatorActuator_Actuator, gen_PolicyEngine_SmokeSensor_Sensor, gen_PolicyEngine_CO2Sensor_Sensor, gen_PolicyEngine_Floor_NamedElement, gen_PolicyEngine_ActuatorComponent_HasActuators, gen_PolicyEngine_ActuatorComponent_NamedElement, gen_PolicyEngine_Policy_NamedElement, gen_PolicyEngine_InfraredLightSensor_Sensor, gen_PolicyEngine_HumiditySensor_Sensor, gen_PolicyEngine_AudioAlarmActuator_Actuator, gen_PolicyEngine_Room_NamedElement, gen_PolicyEngine_State_NamedElement, gen_PolicyEngine_Timer_NamedElement, gen_PolicyEngine_Schedule_NamedElement, gen_PolicyEngine_BinaryOps_Expression, gen_PolicyEngine_UnaryOp_Expression, gen_PolicyEngine_TimeExpression_Expression, gen_PolicyEngine_ResetExpression_Expression, gen_PolicyEngine_RoomUsage_Expression, gen_PolicyEngine_Id_Expression, gen_PolicyEngine_Id_NamedElement, gen_PolicyEngine_RoomActuators_Expression, gen_PolicyEngine_Constant_Expression},
    metadata=None
)
