...
def test_hyp_petrinet_movement_is_not_abstract():
    assert not inspect.isabstract(PetriNet_Movement)


def test_hyp_petrinet_movement_constructor_exists():
    assert callable(PetriNet_Movement.__init__)


def test_hyp_petrinet_movement_constructor_args():
...
def test_hyp_petrinet_marking_is_not_abstract():
    assert not inspect.isabstract(PetriNet_Marking)


def test_hyp_petrinet_marking_constructor_exists():
    assert callable(PetriNet_Marking.__init__)


def test_hyp_petrinet_marking_constructor_args():
...
def test_hyp_petrinet_execution_is_not_abstract():
    assert not inspect.isabstract(PetriNet_Execution)


def test_hyp_petrinet_execution_constructor_exists():
    assert callable(PetriNet_Execution.__init__)


def test_hyp_petrinet_execution_constructor_args():
