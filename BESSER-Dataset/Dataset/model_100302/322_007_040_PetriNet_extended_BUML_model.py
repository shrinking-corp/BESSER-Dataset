...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={PetriNet_Element, PetriNet, PetriNet_Place, PetriNet_LocatedElement, PetriNet_NamedElement, LocatedElement, PetriNet_PetriNet, NamedElement, Element, Arc, Execution, PetriNet_Execution, Marking, TransitionToPlace, PlaceToTransition, PetriNet_Transition, PetriNet_Arc, PetriNet_PlaceToTransition, Place, Transition, PetriNet_TransitionToPlace, Movement, PetriNet_Token, PetriNet_Marking, Token, PetriNet_Movement},
    associations={execs3, net5, elements0, arcs1, to21, net24, incomingArc6, outgoingArc7, incomingArc8, outgoingArc11, net14, from_16, to17, from_18, markings26, movements27, placedAt29, marking31, exec33, tokens35, exec36, fire38, source40, target43},
