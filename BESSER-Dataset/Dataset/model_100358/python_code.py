...
class fmpl_Transition:
    ...
    def __init__(self, name: str, fmpl_Transition: "fmpl_Automata" = None, fmpl_Transition17: "fmpl_Exec" = None, fmpl_Transition11: "fmpl_State" = None, fmpl_Transition14: "fmpl_State" = None):
        self.name = name
...
class fmpl_State:
    ...
    def __init__(self, name: str, fmpl_State: "fmpl_Automata" = None, fmpl_State9: "fmpl_Automata" = None, fmpl_State12: "fmpl_Transition" = None, fmpl_State15: "fmpl_Transition" = None):
        self.name = name
...
class fmpl_Automata:
    ...
    def __init__(self, name: str, fmpl_Automata: "fmpl_Policy" = None, fmpl_Automata4: set["fmpl_State"] = None, fmpl_Automata6: set["fmpl_Transition"] = None, fmpl_Automata8: "fmpl_State" = None, fmpl_Automata24: "fmpl_Init" = None):
        self.name = name
...
class fmpl_Policy:
    ...
    def __init__(self, name: str, parserURI: str, fmpl_Policy: set["fmpl_Automata"] = None, fmpl_Policy2: set["fmpl_Expression"] = None):
        self.name = name
