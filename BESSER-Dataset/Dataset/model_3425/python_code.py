...
class ecvi_ResultValue:
    ...
    def __init__(self, resultInteger: str, resultString: str, resultFloat: str, resultName: str, ecvi_ResultValue: "ecvi_Test" = None):
...
class ecvi_GroupLot:
    ...
    def __init__(self, age: str, breed: str, description: str, quantity: str, sex: str, sexDetail: str, species: str, unit: str, ecvi_GroupLot: "ecvi_Ecvi" = None):
        self.age = age
        self.breed = breed
...
class ecvi_Premises:
    ...
    def __init__(self, premName: str, premId: str, ecvi_Premises25: "ecvi_Ecvi" = None, ecvi_Premises: "ecvi_Ecvi" = None, ecvi_Premises48: "ecvi_Address" = None, ecvi_Premises51: set["ecvi_ProgramStatus"] = None, ecvi_Premises53: set["ecvi_Person"] = None):
...
class ecvi_Veterinarian:
    ...
    def __init__(self, licenseIssueState: str, licenseNumber: str, nationalAccreditationNumber: str, ecvi_Veterinarian: "ecvi_Ecvi" = None, ecvi_Veterinarian58: "ecvi_Person" = None, ecvi_Veterinarian61: "ecvi_Address" = None):
    ...
    @property
    def nationalAccreditationNumber(self):
...
class ecvi_Ecvi:
    ...
    def __init__(self, issueDate: str, shipmentDate: str, speciesCode: str, group: str, group1: str, cviNumber: str, entryPermitNumber: str, expirationDate: str, ecvi_Ecvi24: "ecvi_Premises" = None, ecvi_Ecvi27: "ecvi_Contact" = None, ecvi_Ecvi30: "ecvi_Contact" = None, ecvi_Ecvi33: "ecvi_Accessions" = None, ecvi_Ecvi: "ecvi_DocumentRoot" = None, ecvi_Ecvi18: "ecvi_Veterinarian" = None, ecvi_Ecvi20: "ecvi_MovementPurposes" = None, ecvi_Ecvi22: "ecvi_Premises" = None, ecvi_Ecvi36: set["ecvi_Animal"] = None, ecvi_Ecvi39: set["ecvi_GroupLot"] = None, ecvi_Ecvi41: set["ecvi_Attachement"] = None):
...
class ecvi_Animal:
    ...
    def __init__(self, age: str, breed: str, inspectionDate: str, sex: str, sexDetail: str, ecvi_Animal: set["ecvi_AnimalTag"] = None, ecvi_Animal6: set["ecvi_Test"] = None, ecvi_Animal37: "ecvi_Ecvi" = None):
        self.age = age
        self.breed = breed
...
class ecvi_Attachement:
    ...
    def __init__(self, payload: str, comment: str, docType: str, filename: str, mimeType: str, ecvi_Attachement: "ecvi_Ecvi" = None):
...
class ecvi_Address:
    ...
    def __init__(self, line2: str, town: str, county: str, state: str, zIP: str, country: str, line1: str, ecvi_Address: "ecvi_GeoPoint" = None, ecvi_Address8: "ecvi_Contact" = None, ecvi_Address44: "ecvi_Laboratory" = None, ecvi_Address49: "ecvi_Premises" = None, ecvi_Address62: "ecvi_Veterinarian" = None):
        self.line2 = line2
        self.town = town
        self.county = county
        self.state = state
