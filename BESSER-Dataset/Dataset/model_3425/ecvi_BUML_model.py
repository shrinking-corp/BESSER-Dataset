...
# Classes
ecvi_Accession = Class(name="ecvi_Accession")
ecvi_Laboratory = Class(name="ecvi_Laboratory")
ecvi_GeoPoint = Class(name="ecvi_GeoPoint")
ecvi_Accessions = Class(name="ecvi_Accessions")
ecvi_Address = Class(name="ecvi_Address")
ecvi_Attachement = Class(name="ecvi_Attachement")
ecvi_Animal = Class(name="ecvi_Animal")
ecvi_AnimalTag = Class(name="ecvi_AnimalTag")
ecvi_Test = Class(name="ecvi_Test")
ecvi_Person = Class(name="ecvi_Person")
ecvi_Contact = Class(name="ecvi_Contact")
ecvi_DocumentRoot = Class(name="ecvi_DocumentRoot")
ecvi_EStringToStringMapEntry = Class(name="ecvi_EStringToStringMapEntry")
ecvi_Ecvi = Class(name="ecvi_Ecvi")
ecvi_Veterinarian = Class(name="ecvi_Veterinarian")
ecvi_MovementPurposes = Class(name="ecvi_MovementPurposes")
ecvi_Premises = Class(name="ecvi_Premises")
ecvi_GroupLot = Class(name="ecvi_GroupLot")
ecvi_PhoneNum = Class(name="ecvi_PhoneNum")
ecvi_ProgramStatus = Class(name="ecvi_ProgramStatus")
ecvi_ResultValue = Class(name="ecvi_ResultValue")
...
ecvi_Address.attributes={ecvi_Address_line1, ecvi_Address_state, ecvi_Address_country, ecvi_Address_line2, ecvi_Address_zIP, ecvi_Address_town, ecvi_Address_county}
...
ecvi_Attachement.attributes={ecvi_Attachement_payload, ecvi_Attachement_mimeType, ecvi_Attachement_docType, ecvi_Attachement_filename, ecvi_Attachement_comment}
...
ecvi_Animal.attributes={ecvi_Animal_breed, ecvi_Animal_inspectionDate, ecvi_Animal_sex, ecvi_Animal_sexDetail, ecvi_Animal_age}
...
ecvi_AnimalTag.attributes={ecvi_AnimalTag_number, ecvi_AnimalTag_brandImage, ecvi_AnimalTag_type}
...
ecvi_Ecvi.attributes={ecvi_Ecvi_shipmentDate, ecvi_Ecvi_speciesCode, ecvi_Ecvi_expirationDate, ecvi_Ecvi_issueDate, ecvi_Ecvi_entryPermitNumber, ecvi_Ecvi_group, ecvi_Ecvi_cviNumber, ecvi_Ecvi_group1}
...
ecvi_Veterinarian.attributes={ecvi_Veterinarian_licenseIssueState, ecvi_Veterinarian_licenseNumber, ecvi_Veterinarian_nationalAccreditationNumber}
...
ecvi_GroupLot.attributes={ecvi_GroupLot_breed, ecvi_GroupLot_sexDetail, ecvi_GroupLot_age, ecvi_GroupLot_unit, ecvi_GroupLot_species, ecvi_GroupLot_sex, ecvi_GroupLot_description, ecvi_GroupLot_quantity}
...
ecvi_PhoneNum.attributes={ecvi_PhoneNum_number, ecvi_PhoneNum_comment, ecvi_PhoneNum_type}
...
ecvi_ProgramStatus.attributes={ecvi_ProgramStatus_name, ecvi_ProgramStatus_valueOther, ecvi_ProgramStatus_value}
...
ecvi_ResultValue.attributes={ecvi_ResultValue_resultName, ecvi_ResultValue_resultFloat, ecvi_ResultValue_resultString, ecvi_ResultValue_resultInteger}
...
domain_model = DomainModel(
    name="ecvi",
    types={ecvi_Accession, ecvi_Laboratory, ecvi_GeoPoint, ecvi_Accessions, ecvi_Address, ecvi_Attachement, ecvi_Animal, ecvi_AnimalTag, ecvi_Test, ecvi_Person, ecvi_Contact, ecvi_DocumentRoot, ecvi_EStringToStringMapEntry, ecvi_Ecvi, ecvi_Veterinarian, ecvi_MovementPurposes, ecvi_Premises, ecvi_GroupLot, ecvi_PhoneNum, ecvi_ProgramStatus, ecvi_ResultValue, DocType, ISO3166Country, PhoneDevice, MovementPurpose, ProgramStatusName, ProgramStatusValue, ResultName, TagType, Sex, SpeciesCode, UsState},
    associations={laboratory0, geoPoint3, accession1, animalTag4, test5, person9, address7, destination23, consignor26, consignee29, accessions32, xMLNSPrefixMap11, xSISchemaLocation12, eCVI15, veterinarian17, movementPurposes19, origin21, animal35, groupLot38, attachment40, address42, phone45, address47, programStatus50, person52, result55, person57, address60},
    generalizations={},
    metadata=None
)
