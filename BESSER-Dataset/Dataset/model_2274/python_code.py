...
class university_University:
    ...
    def __init__(self, name: str, university_University: set["university_Professor"] = None, university_University4: set["university_Course"] = None, university_University6: set["university_Student"] = None):
        self.name = name
...
class university_Course:
    ...
    def __init__(self, name: str, courses: "university_Professor" = None, Course: "university_Professor" = None, university_Course: "university_University" = None):
        self.name = name
