...
class fsm_State:
    ...
    def __init__(self, name: str, fsm_State3: "fsm_Transition" = None, fsm_State5: "fsm_FSM" = None, fsm_State: "fsm_Transition" = None):
        self.name = name
...
class fsm_Transition:
    ...
    def __init__(self, name: str, trigger: str, fsm_Transition2: "fsm_State" = None, fsm_Transition8: "fsm_FSM" = None, fsm_Transition: "fsm_State" = None):
        self.name = name
