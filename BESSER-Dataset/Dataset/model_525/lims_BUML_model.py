...
# Classes
Lims_Sequencer = Class(name="Lims_Sequencer")
Lims_Sample = Class(name="Lims_Sample")
Lims_Run = Class(name="Lims_Run")
Lims_Family = Class(name="Lims_Family")
Lims_Individual = Class(name="Lims_Individual")
Lims_Laboratory = Class(name="Lims_Laboratory")
Lims_Sequenced = Class(name="Lims_Sequenced")
...
Lims_Run.attributes={Lims_Run_name, Lims_Run_date}
...
domain_model = DomainModel(
    name="Lims",
    types={Lims_Sequencer, Lims_Sample, Lims_Run, Lims_Family, Lims_Individual, Lims_Laboratory, Lims_Sequenced, Gender},
    associations={sequencers3, family5, Father8, Mother10, samples12, runs13, laboratory14, individuals0, laboratory1, families2, sequenced16, sequencer17, individual19, run21, sample23},
    generalizations={},
    metadata=None
)
