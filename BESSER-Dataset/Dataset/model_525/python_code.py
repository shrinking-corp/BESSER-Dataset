...
class Lims_Individual:
    ...
    def __init__(self, gender: str, name: str, individuals: "Lims_Family" = None, Lims_Individual: "Lims_Individual" = None, Lims_Individual7: "Lims_Individual" = None, Lims_Individual11: "Lims_Individual" = None, Lims_Individual9: "Lims_Individual" = None, individual: set["Lims_Sample"] = None, Individual: "Lims_Family" = None, Individual20: "Lims_Sample" = None):
        self.gender = gender
        self.name = name
...
class Lims_Family:
    ...
    def __init__(self, name: str, Family6: "Lims_Individual" = None, family: set["Lims_Individual"] = None, families: "Lims_Laboratory" = None, Family: "Lims_Laboratory" = None):
        self.name = name
