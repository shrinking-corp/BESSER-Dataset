...
MyClass11_MyClass12: BinaryAssociation = BinaryAssociation(
    name="MyClass11_MyClass12",
    ends={
        Property(name="myClass1212", type=MyClass12, multiplicity=Multiplicity(0, 1)),
        Property(name="myClass1113", type=MyClass11, multiplicity=Multiplicity(0, 1))
    }
)
image_Document: BinaryAssociation = BinaryAssociation(
    name="image_Document",
    ends={
        Property(name="document14", type=Document, multiplicity=Multiplicity(0, 1)),
        Property(name="image15", type=image, multiplicity=Multiplicity(0, 9999))
    }
)

# Domain Model
domain_model = DomainModel(
    name="e357f27a_93f7_4f1e_8335_80c6327ecc9a",
    types={MyClass, MyClass2, MyClass3, MyClass4, MyClass5, MyClass6, MyClass7, MyClass8, MyClass9, MyClass10, MyClass11, MyClass12, image, Document},
    associations={association2, association3, association4, association5, association6, association7, MyClass11_MyClass12, image_Document},
    generalizations={},
    metadata=None
)
