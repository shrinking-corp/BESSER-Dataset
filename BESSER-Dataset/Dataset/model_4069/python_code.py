...
class simpleuml_UMLClass(Classifier):
    ...
    def __init__(self, kind: str, simpleuml_UMLClass: "simpleuml_UMLClass" = None, simpleuml_UMLClass0: set["simpleuml_UMLClass"] = None, owner: set["simpleuml_Attribute"] = None, simpleuml_UMLClass4: "simpleuml_Association" = None, simpleuml_UMLClass7: "simpleuml_Association" = None, UMLClass: "simpleuml_Attribute" = None):
        self.kind = kind
