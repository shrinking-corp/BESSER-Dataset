...
domain_model = DomainModel(
    name="simpleuml",
    types={simpleuml_UMLClass, Classifier, simpleuml_Attribute, simpleuml_ModelElement, simpleuml_Association, ModelElement, simpleuml_Classifier, simpleuml_PrimitiveDataType, simpleuml_UMLPackage, Ignore},
    associations={parents1, attribute2, source3, target5, type8, owner9, contents10},
    generalizations={gen_simpleuml_UMLClass_Classifier, gen_simpleuml_Association_ModelElement, gen_simpleuml_Classifier_ModelElement, gen_simpleuml_Attribute_ModelElement, gen_simpleuml_PrimitiveDataType_Classifier},
    metadata=None
)
