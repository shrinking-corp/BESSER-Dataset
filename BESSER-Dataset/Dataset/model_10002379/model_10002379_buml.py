...
Product.attributes={Product_description, Product_id, Product_name}
...
Order.attributes={Order_shippingAddress, Order_finalTotal, Order_status, Order_id}
...
Customer.attributes={Customer_login, Customer_lastname, Customer_isBan, Customer_id, Customer_emailAddress, Customer_password, Customer_firstname}
...
domain_model = DomainModel(
    name="ad2515e4_a1db_49f2_b088_155874cb86d8",
    types={ShoppingCart, Item, Product, Account, Payment, Order, Customer, OrderStatus},
    associations={association7, association8, association2, association3, association4, association5, association6},
    generalizations={},
    metadata=None
)
