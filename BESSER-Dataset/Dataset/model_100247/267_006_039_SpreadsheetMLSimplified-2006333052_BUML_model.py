...
SpreadsheetMLSimplified_DateTimeType.attributes={SpreadsheetMLSimplified_DateTimeType_second, SpreadsheetMLSimplified_DateTimeType_day, SpreadsheetMLSimplified_DateTimeType_minute, SpreadsheetMLSimplified_DateTimeType_hour, SpreadsheetMLSimplified_DateTimeType_month, SpreadsheetMLSimplified_DateTimeType_year}
...
SpreadsheetMLSimplified_Cell.attributes={SpreadsheetMLSimplified_Cell_hRef, SpreadsheetMLSimplified_Cell_mergeDown, SpreadsheetMLSimplified_Cell_mergeAcross, SpreadsheetMLSimplified_Cell_formula, SpreadsheetMLSimplified_Cell_arrayRange}
...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={SpreadsheetMLSimplified_DateTimeType, SpreadsheetMLSimplified_ValueType, SpreadsheetMLSimplified_StringValue, ValueType, SpreadsheetMLSimplified_NumberValue, SpreadsheetMLSimplified_DateTimeTypeValue, DateTimeType, SpreadsheetMLSimplified_BooleanValue, Data, SpreadsheetMLSimplified_ErrorValue, SpreadsheetMLSimplified_Workbook, Worksheet, SpreadsheetMLSimplified_Worksheet, Workbook, Table, SpreadsheetMLSimplified_Table, Column, Row, SpreadsheetMLSimplified_TableElement, SpreadsheetMLSimplified_ColOrRowElement, TableElement, SpreadsheetMLSimplified_Column, ColOrRowElement, SpreadsheetMLSimplified_Row, Cell, SpreadsheetMLSimplified_Cell, SpreadsheetMLSimplified_Data},
    associations={value1, vt_data0, wb_worksheets2, ws_workbook3, ws_table4, t_worksheet5, t_cols7, t_rows8, c_table9, r_cells13, c_row14, c_data16, r_table11, d_cell18, value20},
