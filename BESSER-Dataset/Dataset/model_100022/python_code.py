...
class BibText_Author(BibTextEntry):
    ...
    def __init__(self, name: str, author: set["BibText_Article"] = None):
        self.name = name
...
class BibText_BibTextEntry(LocatedElement):
    ...
    def __init__(self, key: str, BibText_BibTextEntry: "BibText_BibTextFile" = None, BibText_BibTextEntry2: set["BibText_Attribute"] = None, Author: "BibText_Article" = None):
        self.key = key
    ...
    def Author(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_BibText_BibTextEntry__Author", None)
        self.__Author = value
