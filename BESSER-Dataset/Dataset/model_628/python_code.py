...
class model_Book:
    ...
    def __init__(self, title: str, pages: int, Book: "model_Writer" = None, books: "model_Writer" = None, model_Book: "model_Library" = None):
        self.title = title
        self.pages = pages
        self.Book = Book
        self.books = books
    ...
    def validate(self, model_context, model_diagnostic) :
        # TODO: Implement validate method
        pass

class model_Writer:

    def __init__(self, firstName: str, lastName: str, EMail: str, BirthDate: date, Pseudonym: bool, initials: str, title: str, writers: set["model_Book"] = None, writers6: "model_Library" = None, Writer8: "model_Book" = None, Writer: "model_Library" = None):
        self.firstName = firstName
        self.lastName = lastName
        self.EMail = EMail
...
class model_Librarian:
    ...
    def validate(self, model_diagnostic, model_context) :
        # TODO: Implement validate method
        pass

class model_Library:

    def __init__(self, name: str, phoneNumber: str, model_Library3: "model_Librarian" = None, Library: "model_Writer" = None, library: set["model_Writer"] = None, model_Library: set["model_Book"] = None):
        self.name = name
