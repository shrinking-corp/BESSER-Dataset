...
# Classes
model_Library = Class(name="model_Library")
model_Librarian = Class(name="model_Librarian")
model_Computer = Class(name="model_Computer")
model_Mainboard = Class(name="model_Mainboard")
model_Writer = Class(name="model_Writer")
model_Book = Class(name="model_Book")
model_Container = Class(name="model_Container")
model_Content = Class(name="model_Content")
model_TableWithMultiplicity = Class(name="model_TableWithMultiplicity")
model_TableContent = Class(name="model_TableContent", is_abstract=True)
model_TableContentWithoutValidation = Class(name="model_TableContentWithoutValidation")
TableContent = Class(name="TableContent")
model_TableContentWithValidation = Class(name="model_TableContentWithValidation")
model_TableWithoutMultiplicity = Class(name="model_TableWithoutMultiplicity")
model_TableWithUnique = Class(name="model_TableWithUnique")
model_TableContentWithInnerChild2 = Class(name="model_TableContentWithInnerChild2")
model_TableContentWithInnerChild = Class(name="model_TableContentWithInnerChild")
model_TableWithoutMultiplicityConcrete = Class(name="model_TableWithoutMultiplicityConcrete")
model_Referencer = Class(name="model_Referencer")
model_PowerBlock = Class(name="model_PowerBlock")
model_Person = Class(name="model_Person")
model_CrossReferenceContainer = Class(name="model_CrossReferenceContainer")
model_CrossReferenceContent = Class(name="model_CrossReferenceContent")
...
model_Library_m_validate: Method = Method(name="validate", parameters={Parameter(name='model_diagnostic', type=StringType), Parameter(name='model_context', type=StringType)}, type=BooleanType)
...
model_Librarian_m_validate: Method = Method(name="validate", parameters={Parameter(name='model_context', type=StringType), Parameter(name='model_diagnostic', type=StringType)}, type=BooleanType)
...
model_Computer.attributes={model_Computer_colors, model_Computer_name}
...
model_Writer_m_validate: Method = Method(name="validate", parameters={Parameter(name='model_context', type=StringType), Parameter(name='model_diagnostic', type=StringType)}, type=BooleanType)
model_Writer.attributes={model_Writer_initials, model_Writer_firstName, model_Writer_BirthDate, model_Writer_EMail, model_Writer_lastName, model_Writer_Pseudonym, model_Writer_title}
...
model_Book_m_validate: Method = Method(name="validate", parameters={Parameter(name='model_diagnostic', type=StringType), Parameter(name='model_context', type=StringType)}, type=BooleanType)
...
model_Person.attributes={model_Person_gender, model_Person_firstName, model_Person_custom, model_Person_age, model_Person_lastName}
...
domain_model = DomainModel(
    name="model",
    types={model_Library, model_Librarian, model_Computer, model_Mainboard, model_Writer, model_Book, model_Container, model_Content, model_TableWithMultiplicity, model_TableContent, model_TableContentWithoutValidation, TableContent, model_TableContentWithValidation, model_TableWithoutMultiplicity, model_TableWithUnique, model_TableContentWithInnerChild2, model_TableContentWithInnerChild, model_TableWithoutMultiplicityConcrete, model_Referencer, model_PowerBlock, model_Person, model_CrossReferenceContainer, model_CrossReferenceContent, Gender, Color},
    associations={librarian2, books4, library5, writers7, mainboard9, writers0, books1, contents12, content13, content14, content16, innerChild18, innerChild20, content22, powerBlock10, singleContent27, parent29, singleParent30, referencedContent24, contents26},
