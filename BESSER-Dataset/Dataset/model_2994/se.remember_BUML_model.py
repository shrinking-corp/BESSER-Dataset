...
# Classes
remember_Folder = Class(name="remember_Folder")
remember_KeyManager = Class(name="remember_KeyManager")
Node = Class(name="Node")
remember_Task = Class(name="remember_Task")
remember_Customers = Class(name="remember_Customers")
remember_TimeSpent = Class(name="remember_TimeSpent")
remember_Node = Class(name="remember_Node", is_abstract=True)
remember_Customer = Class(name="remember_Customer")
remember_Project = Class(name="remember_Project")
remember_KeyIdPair = Class(name="remember_KeyIdPair")
remember_InvoiceSpecification = Class(name="remember_InvoiceSpecification")
remember_Year = Class(name="remember_Year")
remember_Years = Class(name="remember_Years")
...
remember_Task.attributes={remember_Task_status, remember_Task_done, remember_Task_priority, remember_Task_text, remember_Task_taskId, remember_Task_budget}
...
remember_TimeSpent.attributes={remember_TimeSpent_comment, remember_TimeSpent_timeSpentId, remember_TimeSpent_date, remember_TimeSpent_minutes, remember_TimeSpent_invoiced}
...
remember_Node.attributes={remember_Node_sequence, remember_Node_nodeId, remember_Node_description, remember_Node_name, remember_Node_parentNodeId, remember_Node_parentNodeType, remember_Node_dateModified, remember_Node_nodeType, remember_Node_markedForDeletion, remember_Node_dateCreated}
...
remember_Customer.attributes={remember_Customer_customerId, remember_Customer_name}
...
remember_KeyIdPair.attributes={remember_KeyIdPair_key, remember_KeyIdPair_id}
...
domain_model = DomainModel(
    name="remember",
    types={remember_Folder, remember_KeyManager, Node, remember_Task, remember_Customers, remember_TimeSpent, remember_Node, remember_Customer, remember_Project, remember_KeyIdPair, remember_InvoiceSpecification, remember_Year, remember_Years},
    associations={Tasks0, folders2, parent5, workspace7, parent8, timeSpent10, customer11, project12, timeSpent34, keyIdPairs14, projects15, nodes17, customer19, nodes21, customers23, project25, task26, invoiceSpecification28, invoiceSpecifications30, years32, year36, year37},
    generalizations={gen_remember_Folder_Node, gen_remember_Task_Node},
    metadata=None
)
