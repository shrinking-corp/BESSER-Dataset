...
class remember_Year:
    ...
    def __init__(self, year1: int, year: set["remember_InvoiceSpecification"] = None, year33: "remember_Years" = None, Year: "remember_InvoiceSpecification" = None, Year38: "remember_Years" = None):
        self.year1 = year1
...
class remember_InvoiceSpecification:
    ...
    def __init__(self, month: int, invoiceSpecification: set["remember_TimeSpent"] = None, InvoiceSpecification: "remember_TimeSpent" = None, InvoiceSpecification31: "remember_Year" = None, invoiceSpecifications: "remember_Year" = None):
        self.month = month
...
class remember_Project:
    ...
    def __init__(self, projectId: str, projectNumber: str, description: str, Project: "remember_Node" = None, Project16: "remember_Customer" = None, projects: "remember_Customer" = None, project: set["remember_Node"] = None, remember_Project: "remember_TimeSpent" = None):
...
class remember_Customer:
    ...
    def __init__(self, customerId: str, name: str, Customer: "remember_Node" = None, customer: set["remember_Project"] = None, customer18: set["remember_Node"] = None, Customer20: "remember_Project" = None, remember_Customer: "remember_Customers" = None):
...
class remember_TimeSpent:
    ...
    def __init__(self, timeSpentId: str, date: date, minutes: int, comment: str, invoiced: bool, TimeSpent: "remember_Task" = None, TimeSpent35: "remember_InvoiceSpecification" = None, remember_TimeSpent: "remember_Project" = None, timeSpent: "remember_Task" = None, timeSpent29: "remember_InvoiceSpecification" = None):
