...
ID = Class(name="ID")
pnmlcoremodel_PetriNetType = Class(name="pnmlcoremodel_PetriNetType", is_abstract=True)
pnmlcoremodel_Name = Class(name="pnmlcoremodel_Name")
pnmlcoremodel_Page = Class(name="pnmlcoremodel_Page")
pnmlcoremodel_ToolInfo = Class(name="pnmlcoremodel_ToolInfo", is_abstract=True)
...
pnmlcoremodel_AnyType = Class(name="pnmlcoremodel_AnyType")
Node = Class(name="Node")
pnmlcoremodel_Object = Class(name="pnmlcoremodel_Object", is_abstract=True)
pnmlcoremodel_PageLabelProxy = Class(name="pnmlcoremodel_PageLabelProxy")
pnmlcoremodel_LabelProxy = Class(name="pnmlcoremodel_LabelProxy")
...
pnmlcoremodel_Coordinate = Class(name="pnmlcoremodel_Coordinate")
...
pnmlcoremodel_EmptyType = Class(name="pnmlcoremodel_EmptyType")
PetriNetType = Class(name="PetriNetType")
pnmlcoremodel_ToolInfoText = Class(name="pnmlcoremodel_ToolInfoText")
ToolInfo = Class(name="ToolInfo")
pnmlcoremodel_ID = Class(name="pnmlcoremodel_ID", is_abstract=True)
...
pnmlcoremodel_Line.attributes={pnmlcoremodel_Line_color, pnmlcoremodel_Line_style, pnmlcoremodel_Line_width, pnmlcoremodel_Line_shape}
...
pnmlcoremodel_Fill.attributes={pnmlcoremodel_Fill_color, pnmlcoremodel_Fill_image, pnmlcoremodel_Fill_gradientrotation, pnmlcoremodel_Fill_gradientColor}
...
pnmlcoremodel_Font.attributes={pnmlcoremodel_Font_style, pnmlcoremodel_Font_family, pnmlcoremodel_Font_rotation, pnmlcoremodel_Font_weight, pnmlcoremodel_Font_align, pnmlcoremodel_Font_decoration, pnmlcoremodel_Font_size}
...
in_34: BinaryAssociation = BinaryAssociation(
    name="in_34",
    ends={
...
target37: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="in_", type=pnmlcoremodel_Node, multiplicity=Multiplicity(1, 1))
    }
)
...
domain_model = DomainModel(
    name="pnmlcoremodel",
    types={pnmlcoremodel_PetriNetDoc, pnmlcoremodel_PetriNet, ID, pnmlcoremodel_PetriNetType, pnmlcoremodel_Name, pnmlcoremodel_Page, pnmlcoremodel_ToolInfo, pnmlcoremodel_Label, pnmlcoremodel_Node, Object, pnmlcoremodel_Arc, pnmlcoremodel_PlaceNode, pnmlcoremodel_TransitionNode, pnmlcoremodel_AnyType, Node, pnmlcoremodel_Object, pnmlcoremodel_PageLabelProxy, pnmlcoremodel_LabelProxy, pnmlcoremodel_Graphics, pnmlcoremodel_ArcGraphics, Graphics, pnmlcoremodel_Line, pnmlcoremodel_Coordinate, pnmlcoremodel_NodeGraphics, pnmlcoremodel_Fill, pnmlcoremodel_AnnotationGraphics, pnmlcoremodel_Place, PlaceNode, pnmlcoremodel_RefPlace, pnmlcoremodel_RefTransition, TransitionNode, pnmlcoremodel_Transition, Label, pnmlcoremodel_EmptyType, PetriNetType, pnmlcoremodel_ToolInfoText, ToolInfo, pnmlcoremodel_ID, pnmlcoremodel_Font, pnmlcoremodel_Attribute, LineShape},
    associations={net0, type1, name3, page5, toolspecific7, label28, object30, out33, in_34, source36, target37, unknown9, object11, pageLabelProxy13, labelproxy15, name17, toolspecific20, graphics23, unknown25, line50, position51, position53, dimension55, line58, fill61, fill63, line65, offset68, ref39, ref40, toolspecific41, graphics44, unknown47, font71, label73},
    generalizations={gen_pnmlcoremodel_PetriNet_ID, gen_pnmlcoremodel_Node_Object, gen_pnmlcoremodel_Arc_Object, gen_pnmlcoremodel_PlaceNode_Node, gen_pnmlcoremodel_Page_Node, gen_pnmlcoremodel_Object_ID, gen_pnmlcoremodel_ArcGraphics_Graphics, gen_pnmlcoremodel_NodeGraphics_Graphics, gen_pnmlcoremodel_AnnotationGraphics_Graphics, gen_pnmlcoremodel_TransitionNode_Node, gen_pnmlcoremodel_Place_PlaceNode, gen_pnmlcoremodel_RefPlace_PlaceNode, gen_pnmlcoremodel_RefTransition_TransitionNode, gen_pnmlcoremodel_Transition_TransitionNode, gen_pnmlcoremodel_Name_Label, gen_pnmlcoremodel_EmptyType_PetriNetType, gen_pnmlcoremodel_ToolInfoText_ToolInfo, gen_pnmlcoremodel_Attribute_Label},
    metadata=None
)
