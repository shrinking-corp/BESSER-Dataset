...
class Product:
    ...
    def __init__(self, name: str, description: str, Add_to_cart24: "ShoppingCart" = None, visitor31: "Visitor" = None, administrator35: "Administrator" = None, account22: "Account" = None, item7: set["LineItem"] = None, vendors39: "Shop_Owner" = None, Shop_Owner_Product_145: "Shop_Owner" = None):
        self.name = name
...
class LineItem:
    ...
    def __init__(self, quantity: int, price: float, shopping_cart3: "ShoppingCart" = None, order15: "Order" = None, product6: "Product" = None):
...
class Order:
    ...
    def __init__(self, number: int, ordered: date, shipped: bool, shipTo: str, total: float, status: str, shoppingCart27: "ShoppingCart" = None, items14: set["LineItem"] = None, accnt17: "Account" = None, payment21: "Payment" = None):
        self.number = number
...
class Account:
    ...
    def __init__(self, billingAddress: str, open: date, closed: date, isClosed: bool, product23: set["Product"] = None, payment29: "Payment" = None, cart4: "ShoppingCart" = None, customer13: "Customer" = None, order16: set["Order"] = None, payment18: set["Payment"] = None, Giving_feedback40: "ShoppingCart" = None):
...
class ShoppingCart:
    ...
    def __init__(self, creationDate: date, product25: set["Product"] = None, order26: "Order" = None, items2: set["LineItem"] = None, account5: "Account" = None, webUser9: "Visitor" = None, Account_ShoppingCart2_141: "Account" = None):
...
class Payment:
    ...
    def __init__(self, paidDate: date, total: float, details: str, account28: "Account" = None, account19: "Account" = None, order20: "Order" = None):
...
class Customer:
    ...
    def __init__(self, IDCust: int, Last_name: str, Name: str, Password: str, Email: str, Administrator_Customer_133: "Administrator" = None, has12: "Account" = None, webUser11: "Visitor" = None, Ask_question43: "Customer_Support" = None):
        self.IDCust = IDCust
        self.Last_name = Last_name
        self.Name = Name
        self.Password = Password
