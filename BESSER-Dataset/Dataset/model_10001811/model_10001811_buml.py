...
Customer.attributes={Customer_Name, Customer_IDCust, Customer_Last_name, Customer_Email, Customer_Password}
...
Order.attributes={Order_ordered, Order_shipped, Order_number, Order_total, Order_status, Order_shipTo}
...
Administrator.attributes={Administrator_Name, Administrator_Last_name, Administrator_Email, Administrator_IDAdm, Administrator_Password}
...
Shop_Owner.attributes={Shop_Owner_Email, Shop_Owner_Name, Shop_Owner_IDSowner, Shop_Owner_Password, Shop_Owner_Last_name}
...
domain_model = DomainModel(
    ...
    associations={Customer_Account, Order_LineItem, Account_Order, Account_Payment, Payment_Order, Product_Account, Product_ShoppingCart, ShoppingCart_Order, Payment_Account, Visitor_Product, Administrator_Customer, Administrator_Product, Vendors_Administrator, association2, ShoppingCart_LineItem, Account_ShoppingCart, LineItem_Product, WebUser_ShoppingCart, WebUser_Customer, Vendors_Product, Account_ShoppingCart2, Customer_Support_Customer, Shop_Owner_Product},
    generalizations={},
    metadata=None
)
