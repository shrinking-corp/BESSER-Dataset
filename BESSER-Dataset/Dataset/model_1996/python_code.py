...
class trace_ReferenceMapping:
    ...
    def __init__(self, type: str, trace_ReferenceMapping16: "trace_EReference" = None, trace_ReferenceMapping18: "trace_EStructuralFeature" = None, trace_ReferenceMapping: "trace_Trace" = None):
        self.type = type
