...
def test_assoc_anotherGreeting1_link_reassign_clear():
    ...
    if hasattr(b1, 'myDsl_Greeting0'):
        assert _is_linked(b1, 'myDsl_Greeting0', a)
    _safe_set(a, 'myDsl_Greeting', b2)
    assert _is_linked(a, 'myDsl_Greeting', b2)
    if hasattr(b1, 'myDsl_Greeting0'):
        assert not _is_linked(b1, 'myDsl_Greeting0', a)
    if hasattr(b2, 'myDsl_Greeting0'):
        assert _is_linked(b2, 'myDsl_Greeting0', a)
    _safe_set(a, 'myDsl_Greeting', None)
    assert not _is_linked(a, 'myDsl_Greeting', b2)
    if hasattr(b2, 'myDsl_Greeting0'):
        assert not _is_linked(b2, 'myDsl_Greeting0', a)
