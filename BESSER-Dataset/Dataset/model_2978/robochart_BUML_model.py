...
# Classes
robochart_Interface = Class(name="robochart_Interface")
robochart_RoboticPlatformDef = Class(name="robochart_RoboticPlatformDef")
robochart_TypeDecl = Class(name="robochart_TypeDecl", is_abstract=True)
robochart_StateMachineDef = Class(name="robochart_StateMachineDef")
robochart_ControllerDef = Class(name="robochart_ControllerDef")
robochart_RCModule = Class(name="robochart_RCModule")
robochart_OperationDef = Class(name="robochart_OperationDef")
robochart_Function = Class(name="robochart_Function")
robochart_BasicPackage = Class(name="robochart_BasicPackage")
robochart_Import = Class(name="robochart_Import")
robochart_RCPackage = Class(name="robochart_RCPackage")
BasicPackage = Class(name="BasicPackage")
robochart_PrimitiveType = Class(name="robochart_PrimitiveType")
TypeDecl = Class(name="TypeDecl")
robochart_RecordType = Class(name="robochart_RecordType")
robochart_Field = Class(name="robochart_Field")
Member = Class(name="Member")
NamedExpression = Class(name="NamedExpression")
robochart_TypedNamedElement = Class(name="robochart_TypedNamedElement", is_abstract=True)
robochart_Type = Class(name="robochart_Type", is_abstract=True)
robochart_Member = Class(name="robochart_Member", is_abstract=True)
TypedNamedElement = Class(name="TypedNamedElement")
robochart_Enumeration = Class(name="robochart_Enumeration")
robochart_Literal = Class(name="robochart_Literal")
robochart_NamedElement = Class(name="robochart_NamedElement", is_abstract=True)
NamedElement = Class(name="NamedElement")
robochart_FunctionType = Class(name="robochart_FunctionType")
RelationType = Class(name="RelationType")
robochart_SetType = Class(name="robochart_SetType")
robochart_SeqType = Class(name="robochart_SeqType")
SetType = Class(name="SetType")
robochart_TypeRef = Class(name="robochart_TypeRef")
robochart_AnyType = Class(name="robochart_AnyType")
robochart_VariableList = Class(name="robochart_VariableList")
robochart_Variable = Class(name="robochart_Variable")
robochart_Expression = Class(name="robochart_Expression", is_abstract=True)
robochart_Event = Class(name="robochart_Event")
robochart_NameType = Class(name="robochart_NameType")
robochart_ProductType = Class(name="robochart_ProductType")
Type = Class(name="Type")
robochart_RelationType = Class(name="robochart_RelationType")
robochart_Operation = Class(name="robochart_Operation", is_abstract=True)
...
robochart_Reference = Class(name="robochart_Reference", is_abstract=True)
robochart_OperationRef = Class(name="robochart_OperationRef")
Reference = Class(name="Reference")
BasicContext = Class(name="BasicContext")
robochart_BasicContext = Class(name="robochart_BasicContext", is_abstract=True)
robochart_Parameter = Class(name="robochart_Parameter")
Variable = Class(name="Variable")
robochart_OperationSig = Class(name="robochart_OperationSig")
robochart_RoboticPlatformRef = Class(name="robochart_RoboticPlatformRef")
robochart_StateMachine = Class(name="robochart_StateMachine", is_abstract=True)
StateMachine = Class(name="StateMachine")
robochart_StateMachineRef = Class(name="robochart_StateMachineRef")
robochart_StateMachineBody = Class(name="robochart_StateMachineBody")
NodeContainer = Class(name="NodeContainer")
robochart_NodeContainer = Class(name="robochart_NodeContainer", is_abstract=True)
robochart_Node = Class(name="robochart_Node", is_abstract=True)
robochart_Transition = Class(name="robochart_Transition")
robochart_Junction = Class(name="robochart_Junction")
Node = Class(name="Node")
robochart_Initial = Class(name="robochart_Initial")
Junction = Class(name="Junction")
robochart_State = Class(name="robochart_State")
robochart_Action = Class(name="robochart_Action", is_abstract=True)
robochart_Clock = Class(name="robochart_Clock")
robochart_RoboticPlatform = Class(name="robochart_RoboticPlatform", is_abstract=True)
Context = Class(name="Context")
RoboticPlatform = Class(name="RoboticPlatform")
robochart_Context = Class(name="robochart_Context", is_abstract=True)
robochart_ClockReset = Class(name="robochart_ClockReset")
robochart_EntryAction = Class(name="robochart_EntryAction")
Action = Class(name="Action")
robochart_DuringAction = Class(name="robochart_DuringAction")
robochart_Final = Class(name="robochart_Final")
State = Class(name="State")
robochart_ProbabilisticJunction = Class(name="robochart_ProbabilisticJunction")
robochart_Trigger = Class(name="robochart_Trigger")
robochart_Statement = Class(name="robochart_Statement", is_abstract=True)
robochart_ControllerRef = Class(name="robochart_ControllerRef")
robochart_TimedStatement = Class(name="robochart_TimedStatement")
Statement = Class(name="Statement")
robochart_Wait = Class(name="robochart_Wait")
robochart_ExitAction = Class(name="robochart_ExitAction")
robochart_Controller = Class(name="robochart_Controller", is_abstract=True)
Controller = Class(name="Controller")
robochart_Connection = Class(name="robochart_Connection")
robochart_ConnectionNode = Class(name="robochart_ConnectionNode", is_abstract=True)
robochart_SeqStatement = Class(name="robochart_SeqStatement")
robochart_ParStmt = Class(name="robochart_ParStmt")
robochart_Call = Class(name="robochart_Call")
robochart_ResultExp = Class(name="robochart_ResultExp")
Expression = Class(name="Expression")
robochart_ArrayExp = Class(name="robochart_ArrayExp")
robochart_Skip = Class(name="robochart_Skip")
robochart_IfStmt = Class(name="robochart_IfStmt")
robochart_Assignment = Class(name="robochart_Assignment")
robochart_Assignable = Class(name="robochart_Assignable", is_abstract=True)
robochart_SendEvent = Class(name="robochart_SendEvent")
robochart_Forall = Class(name="robochart_Forall")
QuantifierExpression = Class(name="QuantifierExpression")
robochart_Exists = Class(name="robochart_Exists")
robochart_LambdaExp = Class(name="robochart_LambdaExp")
robochart_DefiniteDescription = Class(name="robochart_DefiniteDescription")
LambdaExp = Class(name="LambdaExp")
robochart_IfExpression = Class(name="robochart_IfExpression")
robochart_Declaration = Class(name="robochart_Declaration")
robochart_ClockExp = Class(name="robochart_ClockExp")
robochart_StateClockExp = Class(name="robochart_StateClockExp")
robochart_BinaryExpression = Class(name="robochart_BinaryExpression", is_abstract=True)
robochart_Iff = Class(name="robochart_Iff")
BinaryExpression = Class(name="BinaryExpression")
robochart_Implies = Class(name="robochart_Implies")
robochart_Or = Class(name="robochart_Or")
robochart_QuantifierExpression = Class(name="robochart_QuantifierExpression", is_abstract=True)
robochart_TypeExp = Class(name="robochart_TypeExp")
robochart_Equals = Class(name="robochart_Equals")
robochart_Different = Class(name="robochart_Different")
robochart_GreaterThan = Class(name="robochart_GreaterThan")
robochart_GreaterOrEqual = Class(name="robochart_GreaterOrEqual")
robochart_LessThan = Class(name="robochart_LessThan")
robochart_LessOrEqual = Class(name="robochart_LessOrEqual")
robochart_Plus = Class(name="robochart_Plus")
robochart_Minus = Class(name="robochart_Minus")
robochart_Modulus = Class(name="robochart_Modulus")
robochart_Mult = Class(name="robochart_Mult")
robochart_Div = Class(name="robochart_Div")
robochart_Cat = Class(name="robochart_Cat")
robochart_Neg = Class(name="robochart_Neg")
robochart_Selection = Class(name="robochart_Selection")
robochart_LetExpression = Class(name="robochart_LetExpression")
robochart_And = Class(name="robochart_And")
robochart_Not = Class(name="robochart_Not")
robochart_ToExp = Class(name="robochart_ToExp")
robochart_InExp = Class(name="robochart_InExp")
robochart_FromExp = Class(name="robochart_FromExp")
robochart_IdExp = Class(name="robochart_IdExp")
robochart_AsExp = Class(name="robochart_AsExp")
robochart_IsExp = Class(name="robochart_IsExp")
robochart_EnumExp = Class(name="robochart_EnumExp")
robochart_ParExp = Class(name="robochart_ParExp")
robochart_SeqExp = Class(name="robochart_SeqExp")
robochart_IntegerExp = Class(name="robochart_IntegerExp")
robochart_FloatExp = Class(name="robochart_FloatExp")
robochart_StringExp = Class(name="robochart_StringExp")
robochart_BooleanExp = Class(name="robochart_BooleanExp")
robochart_VarExp = Class(name="robochart_VarExp")
robochart_RefExp = Class(name="robochart_RefExp")
robochart_NamedExpression = Class(name="robochart_NamedExpression", is_abstract=True)
robochart_SetComp = Class(name="robochart_SetComp")
robochart_SetRange = Class(name="robochart_SetRange")
robochart_SetExp = Class(name="robochart_SetExp")
robochart_CallExp = Class(name="robochart_CallExp")
robochart_ElseExp = Class(name="robochart_ElseExp")
robochart_VarSelection = Class(name="robochart_VarSelection")
Assignable = Class(name="Assignable")
robochart_ArrayAssignable = Class(name="robochart_ArrayAssignable")
robochart_TupleExp = Class(name="robochart_TupleExp")
robochart_RangeExp = Class(name="robochart_RangeExp")
robochart_MatrixType = Class(name="robochart_MatrixType")
robochart_VarRef = Class(name="robochart_VarRef")
robochart_WaitingCondition = Class(name="robochart_WaitingCondition")
robochart_WaitingConditionRef = Class(name="robochart_WaitingConditionRef")
robochart_VectorType = Class(name="robochart_VectorType")
...
robochart_Connection_async_: Property = Property(name="async_", type=BooleanType)
robochart_Connection_bidirec: Property = Property(name="bidirec", type=BooleanType)
robochart_Connection.attributes={robochart_Connection_bidirec, robochart_Connection_async_}
...
robochart_MatrixType.attributes={robochart_MatrixType_rows, robochart_MatrixType_columns}
...
from_135: BinaryAssociation = BinaryAssociation(
    name="from_135",
    ends={
...
else_169: BinaryAssociation = BinaryAssociation(
    name="else_169",
    ends={
...
domain_model = DomainModel(
    name="robochart",
    types={robochart_Interface, robochart_RoboticPlatformDef, robochart_TypeDecl, robochart_StateMachineDef, robochart_ControllerDef, robochart_RCModule, robochart_OperationDef, robochart_Function, robochart_BasicPackage, robochart_Import, robochart_RCPackage, BasicPackage, robochart_PrimitiveType, TypeDecl, robochart_RecordType, robochart_Field, Member, NamedExpression, robochart_TypedNamedElement, robochart_Type, robochart_Member, TypedNamedElement, robochart_Enumeration, robochart_Literal, robochart_NamedElement, NamedElement, robochart_FunctionType, RelationType, robochart_SetType, robochart_SeqType, SetType, robochart_TypeRef, robochart_AnyType, robochart_VariableList, robochart_Variable, robochart_Expression, robochart_Event, robochart_NameType, robochart_ProductType, Type, robochart_RelationType, robochart_Operation, ConnectionNode, Operation, OperationSig, StateMachineBody, robochart_Reference, robochart_OperationRef, Reference, BasicContext, robochart_BasicContext, robochart_Parameter, Variable, robochart_OperationSig, robochart_RoboticPlatformRef, robochart_StateMachine, StateMachine, robochart_StateMachineRef, robochart_StateMachineBody, NodeContainer, robochart_NodeContainer, robochart_Node, robochart_Transition, robochart_Junction, Node, robochart_Initial, Junction, robochart_State, robochart_Action, robochart_Clock, robochart_RoboticPlatform, Context, RoboticPlatform, robochart_Context, robochart_ClockReset, robochart_EntryAction, Action, robochart_DuringAction, robochart_Final, State, robochart_ProbabilisticJunction, robochart_Trigger, robochart_Statement, robochart_ControllerRef, robochart_TimedStatement, Statement, robochart_Wait, robochart_ExitAction, robochart_Controller, Controller, robochart_Connection, robochart_ConnectionNode, robochart_SeqStatement, robochart_ParStmt, robochart_Call, robochart_ResultExp, Expression, robochart_ArrayExp, robochart_Skip, robochart_IfStmt, robochart_Assignment, robochart_Assignable, robochart_SendEvent, robochart_Forall, QuantifierExpression, robochart_Exists, robochart_LambdaExp, robochart_DefiniteDescription, LambdaExp, robochart_IfExpression, robochart_Declaration, robochart_ClockExp, robochart_StateClockExp, robochart_BinaryExpression, robochart_Iff, BinaryExpression, robochart_Implies, robochart_Or, robochart_QuantifierExpression, robochart_TypeExp, robochart_Equals, robochart_Different, robochart_GreaterThan, robochart_GreaterOrEqual, robochart_LessThan, robochart_LessOrEqual, robochart_Plus, robochart_Minus, robochart_Modulus, robochart_Mult, robochart_Div, robochart_Cat, robochart_Neg, robochart_Selection, robochart_LetExpression, robochart_And, robochart_Not, robochart_ToExp, robochart_InExp, robochart_FromExp, robochart_IdExp, robochart_AsExp, robochart_IsExp, robochart_EnumExp, robochart_ParExp, robochart_SeqExp, robochart_IntegerExp, robochart_FloatExp, robochart_StringExp, robochart_BooleanExp, robochart_VarExp, robochart_RefExp, robochart_NamedExpression, robochart_SetComp, robochart_SetRange, robochart_SetExp, robochart_CallExp, robochart_ElseExp, robochart_VarSelection, Assignable, robochart_ArrayAssignable, robochart_TupleExp, robochart_RangeExp, robochart_MatrixType, robochart_VarRef, robochart_WaitingCondition, robochart_WaitingConditionRef, robochart_VectorType, VariableModifier, TriggerType},
    associations={interfaces1, robots2, types4, machines6, controllers8, modules10, operations12, functions14, imports0, fields16, type17, literals18, domain31, ref33, vars35, initial36, types19, type22, types24, domain26, range28, parameters48, preconditions50, postconditions53, ref56, variableList58, operations60, type38, parameters40, preconditions42, postconditions45, ref76, ref78, nodes80, transitions81, actions83, events63, clocks66, pInterfaces68, rInterfaces70, interfaces73, probability103, event106, _from109, _predicate112, parameter115, value118, time121, reset124, action126, source84, target87, start90, trigger93, end95, condition98, action101, efrom140, eto143, ref146, connections148, nodes151, start154, stmt156, end159, machines129, lOperations131, connections133, from_135, to137, statements178, stmt180, operation182, args184, clock187, value190, parameters192, duration162, expression164, then166, else_169, left172, right173, trigger176, suchthat206, predicate209, variables212, suchthat214, expression217, condition220, ifexp222, elseexp225, clock195, state197, left199, right201, variables204, member237, set239, type242, exp244, value228, declarations230, expression232, exp235, exp253, type255, exp258, type260, type263, literal265, exp268, receiver246, member248, value250, ref252, variables274, predicate276, expression279, start282, values270, values272, lrange289, rrange291, function294, args296, receiver299, member301, value304, end284, values287, base320, parameters306, name309, expression311, transitions313, ref316, base318},
    generalizations={gen_robochart_RCPackage_BasicPackage, gen_robochart_PrimitiveType_TypeDecl, gen_robochart_RecordType_TypeDecl, gen_robochart_Field_Member, gen_robochart_Field_NamedExpression, gen_robochart_TypedNamedElement_NamedElement, gen_robochart_Member_TypedNamedElement, gen_robochart_Enumeration_TypeDecl, gen_robochart_Literal_TypeDecl, gen_robochart_Literal_NamedExpression, gen_robochart_TypeDecl_NamedElement, gen_robochart_FunctionType_RelationType, gen_robochart_SetType_Type, gen_robochart_SeqType_SetType, gen_robochart_TypeRef_Type, gen_robochart_AnyType_Type, gen_robochart_Variable_TypedNamedElement, gen_robochart_Variable_NamedExpression, gen_robochart_Variable_Member, gen_robochart_Event_NamedElement, gen_robochart_NameType_TypeDecl, gen_robochart_ProductType_Type, gen_robochart_RelationType_Type, gen_robochart_Operation_NamedElement, gen_robochart_Operation_ConnectionNode, gen_robochart_OperationDef_Operation, gen_robochart_OperationDef_OperationSig, gen_robochart_OperationDef_StateMachineBody, gen_robochart_OperationRef_Operation, gen_robochart_OperationRef_Reference, gen_robochart_Interface_NamedElement, gen_robochart_Interface_BasicContext, gen_robochart_Function_TypedNamedElement, gen_robochart_Function_NamedExpression, gen_robochart_Parameter_Variable, gen_robochart_OperationSig_NamedElement, gen_robochart_RoboticPlatformRef_RoboticPlatform, gen_robochart_RoboticPlatformRef_Reference, gen_robochart_StateMachine_NamedElement, gen_robochart_StateMachine_ConnectionNode, gen_robochart_StateMachineDef_StateMachineBody, gen_robochart_StateMachineDef_StateMachine, gen_robochart_StateMachineRef_StateMachine, gen_robochart_StateMachineRef_Reference, gen_robochart_StateMachineBody_Context, gen_robochart_StateMachineBody_NodeContainer, gen_robochart_Clock_NamedElement, gen_robochart_Node_NamedElement, gen_robochart_Junction_Node, gen_robochart_Initial_Junction, gen_robochart_State_Node, gen_robochart_State_NodeContainer, gen_robochart_RoboticPlatform_NamedElement, gen_robochart_RoboticPlatform_ConnectionNode, gen_robochart_RoboticPlatformDef_Context, gen_robochart_RoboticPlatformDef_RoboticPlatform, gen_robochart_Context_BasicContext, gen_robochart_EntryAction_Action, gen_robochart_DuringAction_Action, gen_robochart_Final_State, gen_robochart_ProbabilisticJunction_Junction, gen_robochart_Transition_NamedElement, gen_robochart_ControllerRef_Controller, gen_robochart_RCModule_NamedElement, gen_robochart_TimedStatement_Statement, gen_robochart_ExitAction_Action, gen_robochart_Controller_NamedElement, gen_robochart_Controller_ConnectionNode, gen_robochart_ControllerDef_Context, gen_robochart_ControllerDef_Controller, gen_robochart_SeqStatement_Statement, gen_robochart_ParStmt_Statement, gen_robochart_Call_Statement, gen_robochart_ClockReset_Statement, gen_robochart_ResultExp_Expression, gen_robochart_ArrayExp_Expression, gen_robochart_Wait_Statement, gen_robochart_Skip_Statement, gen_robochart_IfStmt_Statement, gen_robochart_Assignment_Statement, gen_robochart_SendEvent_Statement, gen_robochart_Forall_QuantifierExpression, gen_robochart_Exists_QuantifierExpression, gen_robochart_LambdaExp_Expression, gen_robochart_DefiniteDescription_LambdaExp, gen_robochart_IfExpression_Expression, gen_robochart_Declaration_NamedElement, gen_robochart_Declaration_NamedExpression, gen_robochart_ClockExp_Expression, gen_robochart_StateClockExp_Expression, gen_robochart_BinaryExpression_Expression, gen_robochart_Iff_BinaryExpression, gen_robochart_Implies_BinaryExpression, gen_robochart_Or_BinaryExpression, gen_robochart_QuantifierExpression_Expression, gen_robochart_InExp_Expression, gen_robochart_TypeExp_Expression, gen_robochart_Equals_BinaryExpression, gen_robochart_Different_BinaryExpression, gen_robochart_GreaterThan_BinaryExpression, gen_robochart_GreaterOrEqual_BinaryExpression, gen_robochart_LessThan_BinaryExpression, gen_robochart_LessOrEqual_BinaryExpression, gen_robochart_Plus_BinaryExpression, gen_robochart_Minus_BinaryExpression, gen_robochart_Modulus_BinaryExpression, gen_robochart_Mult_BinaryExpression, gen_robochart_Div_BinaryExpression, gen_robochart_Cat_BinaryExpression, gen_robochart_Neg_Expression, gen_robochart_LetExpression_Expression, gen_robochart_And_BinaryExpression, gen_robochart_Not_Expression, gen_robochart_ToExp_Expression, gen_robochart_FromExp_Expression, gen_robochart_IdExp_Expression, gen_robochart_AsExp_Expression, gen_robochart_IsExp_Expression, gen_robochart_EnumExp_Expression, gen_robochart_ParExp_Expression, gen_robochart_SeqExp_Expression, gen_robochart_Selection_Expression, gen_robochart_IntegerExp_Expression, gen_robochart_FloatExp_Expression, gen_robochart_StringExp_Expression, gen_robochart_BooleanExp_Expression, gen_robochart_VarExp_Expression, gen_robochart_RefExp_Expression, gen_robochart_SetComp_Expression, gen_robochart_SetRange_Expression, gen_robochart_SetExp_Expression, gen_robochart_CallExp_Expression, gen_robochart_ElseExp_Expression, gen_robochart_VarSelection_Assignable, gen_robochart_ArrayAssignable_Assignable, gen_robochart_TupleExp_Expression, gen_robochart_RangeExp_Expression, gen_robochart_MatrixType_Type, gen_robochart_VarRef_Assignable, gen_robochart_WaitingCondition_NamedElement, gen_robochart_WaitingConditionRef_Expression, gen_robochart_VectorType_Type},
    metadata=None
)
