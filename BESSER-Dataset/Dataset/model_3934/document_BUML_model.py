...
# Classes
document_Chapter = Class(name="document_Chapter")
document_Section = Class(name="document_Section")
document_Table = Class(name="document_Table")
document_Entry = Class(name="document_Entry", is_abstract=True)
document_FullEntry = Class(name="document_FullEntry")
Entry = Class(name="Entry")
document_BasicEntry = Class(name="document_BasicEntry")
