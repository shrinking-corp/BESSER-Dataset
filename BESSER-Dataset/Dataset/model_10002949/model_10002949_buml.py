...
Cleaning_Management.attributes={Cleaning_Management_powderized_wash, Cleaning_Management_brushing, Cleaning_Management_water}
...
Delivering_Management.attributes={Delivering_Management_client_name, Delivering_Management_deliver_boy_id, Delivering_Management_client_key}
...
domain_model = DomainModel(
    name="ed7d4d44_403c_4a6e_911c_df844f9bb237",
    types={User, Cleaning_Management, Money_Dispenser, Reciept____Balance_UseCase, Cleaning_Management_UseCase, Powderized_Cleaning_UseCase, Water_Wash_UseCase, Brushing_UseCase, Delivery_Management_UseCase, Delivery_Boy_Id_UseCase, Client_Id___Name_UseCase, Primary_Info, Payment, Delivering_Management, Administrator, Cleaner, Delivery_Boy, Client_Actor, Payment_Actor, Cleaner_Actor, Deliver_Actor, Payment_UseCase, Info_UseCase, Type_of_wash_UseCase, Type_of_car_UseCase, Type_of_Payment_UseCase},
    associations={Primary_Info_Payment, Payment_Cleaning_Management, Cleaning_Management_Delivering_Management, User_Primary_Info, User_Payment, User_Cleaning_Management, User_Delivering_Management, Cleaning_Management_Cleaner, Info_Payment, Payment_Payment, Info_Cleaning_Management, Cleaning_Management_Cleaner2, Deliver_Delivery_Boy_Id, Cleaning_Management_Delivery_Management, Delivery_Management_Deliver, Client_Delivery_Management, Payment_Money_Dispenser, Delivering_Management_Delivery_Boy, Client_Info},
    generalizations={},
    metadata=None
)
