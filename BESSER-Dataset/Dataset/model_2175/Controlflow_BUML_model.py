...
# Classes
controlflow_Node = Class(name="controlflow_Node", is_abstract=True)
controlflow_Graph = Class(name="controlflow_Graph")
controlflow_Command = Class(name="controlflow_Command")
Node = Class(name="Node")
controlflow_Branch = Class(name="controlflow_Branch")
