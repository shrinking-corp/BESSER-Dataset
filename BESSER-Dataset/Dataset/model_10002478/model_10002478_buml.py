...
qwsd = Class(name="qwsd")
SR_AppBean = Class(name="SR_AppBean")
...
# qwsd class attributes and methods

# SR_AppBean class attributes and methods
SR_AppBean_time: Property = Property(name="time", type=BooleanType)
SR_AppBean.attributes={SR_AppBean_time}
...
domain_model = DomainModel(
    name="b81f198a_e10e_441d_9127_5eff508f80f5",
    types={Search_books_external, Library_Management_Component, Member_Actor, Librarian_Actor, qwsd, SR_AppBean, Inquiry_for_membership_external, Request_book_external, Request_book_return_external, Issue_member_card_external, Issue_book_external, Return_book_external, Update_member_profile_external},
    associations={Member_Request_book_return, Member_Search_books, Member_Inquiry_for_membership, Member_Request_book, Librarian_Issue_member_card, Librarian_Issue_book, Librarian_Return_book, Librarian_Update_member_profile},
    generalizations={},
    metadata=None
)
