...
Doctor.attributes={Doctor_address, Doctor_specialization, Doctor_phno, Doctor_docid, Doctor_name, Doctor_department}
...
Nurse.attributes={Nurse_doctorid, Nurse_id, Nurse_name}
...
Patient.attributes={Patient_telno, Patient_accepted, Patient_sex, Patient_age, Patient_sickness, Patient_roomno, Patient_address}
...
Person.attributes={Person_Title, Person_Name, Person_phone, Person_Gender, Person_birthDate, Person_address}
