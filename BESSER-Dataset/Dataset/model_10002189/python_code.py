...
class Hospital:
    ...
    def __init__(self, name: str, address: str, phone: int, person16: set["Person"] = None, department19: set["Department"] = None, person24: set["Person"] = None, person14: "Person" = None):
        self.name = name
...
class Person(ABC):
    ...
    def __init__(self, Name: str, Title: str, Gender: str, birthDate: date, address: str, phone: int, Person_Hospital2_117: set["Hospital"] = None, hospital25: set["Hospital"] = None, hospital15: "Hospital" = None):
        self.Name = Name
        self.Title = Title
        self.Gender = Gender
...
class Staff:
    ...
    def __init__(self, joined: date, education: str, department20: "Department" = None, p11: "Patient" = None, sbill12: set["Bill"] = None):
        self.joined = joined
