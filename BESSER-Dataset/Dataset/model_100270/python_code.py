...
class ptnet_Font:
    ...
    def __init__(self, decoration: str, family: str, rotation: str, size: str, style: str, weight: str, align: str, Font: "ptnet_AnnotationGraphics" = None, font: "ptnet_AnnotationGraphics" = None):
...
class ptnet_Line:
    ...
    def __init__(self, color: str, shape: str, width: str, style: str, Line55: "ptnet_AnnotationGraphics" = None, Line: "ptnet_NodeGraphics" = None, Line76: "ptnet_ArcGraphics" = None, line: "ptnet_NodeGraphics" = None, line67: "ptnet_ArcGraphics" = None, line70: "ptnet_AnnotationGraphics" = None):
        self.color = color
        self.shape = shape
        self.width = width
        self.style = style
...
class ptnet_Fill:
    ...
    def __init__(self, color: str, gradientcolor: str, gradientrotation: str, image: str, Fill52: "ptnet_AnnotationGraphics" = None, Fill: "ptnet_NodeGraphics" = None, fill62: "ptnet_AnnotationGraphics" = None, fill: "ptnet_NodeGraphics" = None):
        self.color = color
...
class ptnet_PnObject(ABC):
    ...
    def __init__(self, id: str, PnObject: "ptnet_Page" = None, containerNamePnObject: "ptnet_Name" = None, containerPnObject: set["ptnet_ToolInfo"] = None, PnObject28: "ptnet_ToolInfo" = None, objects: "ptnet_Page" = None, PnObject23: "ptnet_Name" = None):
        self.id = id
...
class ptnet_PetriNet:
    ...
    def __init__(self, id: str, type: str, PetriNet: "ptnet_PetriNetDoc" = None, containerPetriNet: set["ptnet_Page"] = None, containerNamePetriNet: "ptnet_Name" = None, PetriNet10: "ptnet_Page" = None, containerPetriNet6: set["ptnet_ToolInfo"] = None, nets: "ptnet_PetriNetDoc" = None, PetriNet25: "ptnet_ToolInfo" = None, PetriNet20: "ptnet_Name" = None):
        self.id = id
        self.type = type
...
class ptnet_ToolInfo:
    ...
    def __init__(self, tool: str, version: str, formattedXMLBuffer: str, toolInfoGrammarURI: str, ToolInfo16: "ptnet_PnObject" = None, ToolInfo: "ptnet_PetriNet" = None, toolspecifics: "ptnet_PetriNet" = None, toolspecifics27: "ptnet_PnObject" = None, toolspecifics30: "ptnet_Label" = None, containerToolInfo: "ptnet_AnyObject" = None, ToolInfo33: "ptnet_Label" = None, ToolInfo107: "ptnet_AnyObject" = None):
        self.tool = tool
