...
class metrics_MetricRetentionRule:
    ...
    def __init__(self, intervalHint: str, period: str, name: str, metrics_MetricRetentionRule: "metrics_Expression" = None, metrics_MetricRetentionRule26: "metrics_MetricRetentionRules" = None):
        self.intervalHint = intervalHint
        self.period = period
        self.name = name
...
class metrics_MappingRDBMS(Mapping):
    ...
    def __init__(self, databaseType: str, dateFormat: str, password: str, query: str, timeFormat: str, user: str, dateTimeFormat: str):
