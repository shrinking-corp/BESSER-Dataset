...
metrics_IdentifierDataKind.attributes={metrics_IdentifierDataKind_objectProperty, metrics_IdentifierDataKind_pattern, metrics_IdentifierDataKind_objectKind}
...
metrics_MappingRDBMS.attributes={metrics_MappingRDBMS_dateFormat, metrics_MappingRDBMS_dateTimeFormat, metrics_MappingRDBMS_timeFormat, metrics_MappingRDBMS_password, metrics_MappingRDBMS_user, metrics_MappingRDBMS_databaseType, metrics_MappingRDBMS_query}
...
metrics_MappingStatistic.attributes={metrics_MappingStatistic_totalRecords, metrics_MappingStatistic_intervalEstimate, metrics_MappingStatistic_message}
...
metrics_Metric.attributes={metrics_Metric_measurementKind, metrics_Metric_measurementPoint, metrics_Metric_name, metrics_Metric_description}
...
metrics_ValueDataKind.attributes={metrics_ValueDataKind_kindHint, metrics_ValueDataKind_format, metrics_ValueDataKind_valueKind}
...
domain_model = DomainModel(
    name="metrics",
    types={metrics_DataKind, metrics_IdentifierDataKind, DataKind, metrics_Mapping, Base, metrics_MappingColumn, metrics_MappingCSV, Mapping, metrics_MappingRDBMS, metrics_MappingRecord, metrics_MappingStatistic, metrics_DateTimeRange, metrics_MappingXLS, metrics_Metric, metrics_Expression, metrics_MetricSource, metrics_Unit, metrics_MetricRetentionRule, metrics_MetricRetentionRules, metrics_MetricValueRange, metrics_Value, metrics_ValueDataKind, DatabaseTypeType, KindHintType, MetricRetentionPeriod, ObjectKindType, ValueKindType},
    associations={headerMappingColumns0, dataMappingColumns1, dataType4, failedRecords6, mappingDuration7, periodEstimate9, subStatistics13, metrics16, expressionRef17, metricSourceRef19, unitRef21, retentionExpression23, metricRetentionRules25, metricMapping27, statistics30, metricRef34, metricValues33},
