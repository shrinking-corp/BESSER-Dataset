...
class viewpoint_validation_ValidationSet(DocumentedElement):
    ...
    def __init__(self, name: str, viewpoint_validation_ValidationSet241: set["validation_ValidationRule"] = None, viewpoint_validation_ValidationSet: set["validation_ValidationRule"] = None, viewpoint_validation_ValidationSet238: set["validation_ValidationRule"] = None):
        self.name = name
...
class tool_MenuItemDescriptionWithIcon:
    ...
    pass
class viewpoint_tool_ExternalJavaActionCall(tool_ContainerModelOperation, tool_MenuItemDescriptionWithIcon, tool_GroupMenuItem):

    pass
class viewpoint_tool_ExternalJavaAction(tool_ContainerModelOperation, tool_MenuItemDescriptionWithIcon, tool_GroupMenuItem):

    def __init__(self, id: str, viewpoint_tool_ExternalJavaAction: set["tool_ExternalJavaActionParameter"] = None, tool_GroupMenuItem: "viewpoint_tool_GroupMenu" = None):
        self.id = id
...
class viewpoint_tool_OperationAction(tool_MenuItemDescriptionWithIcon, tool_GroupMenuItem):
...
class viewpoint_tool_PasteDescription(MappingBasedToolDescription):
    ...
    def __init__(self, viewpoint_tool_PasteDescription: "tool_DropContainerVariable" = None, viewpoint_tool_PasteDescription155: "tool_ContainerViewVariable" = None, viewpoint_tool_PasteDescription157: "tool_ElementViewVariable" = None, viewpoint_tool_PasteDescription160: "tool_ElementVariable" = None, viewpoint_tool_PasteDescription163: "tool_InitialOperation" = None):
...
class viewpoint_tool_PaneBasedSelectionWizardDescription(AbstractToolDescription):
    ...
    def __init__(self, preSelectedCandidatesExpression: str, iconPath: str, windowTitle: str, windowImagePath: str, message: str, choiceOfValuesMessage: str, candidatesExpression: str, tree: bool, rootExpression: str, childrenExpression: str, selectedValuesMessage: str, viewpoint_tool_PaneBasedSelectionWizardDescription: "tool_ElementSelectVariable" = None, viewpoint_tool_PaneBasedSelectionWizardDescription177: "tool_ContainerViewVariable" = None, viewpoint_tool_PaneBasedSelectionWizardDescription180: "tool_SelectContainerVariable" = None, viewpoint_tool_PaneBasedSelectionWizardDescription183: "tool_InitialOperation" = None):
...
class viewpoint_tool_RepresentationNavigationDescription(AbstractToolDescription):
    ...
    def __init__(self, browseExpression: str, navigationNameExpression: str, viewpoint_tool_RepresentationNavigationDescription198: "tool_ContainerViewVariable" = None, viewpoint_tool_RepresentationNavigationDescription201: "tool_ElementSelectVariable" = None, viewpoint_tool_RepresentationNavigationDescription204: "tool_NameVariable" = None, viewpoint_tool_RepresentationNavigationDescription: "RepresentationDescription" = None):
        self.browseExpression = browseExpression
...
class description_InteractiveVariableDescription:
    ...
    pass
class viewpoint_tool_SelectModelElementVariable(description_SubVariable, description_InteractiveVariableDescription, description_SelectionDescription):
...
class viewpoint_description_EReferenceCustomization(EStructuralFeatureCustomization):
    ...
    def __init__(self, referenceName: str, viewpoint_description_EReferenceCustomization: "description_viewpoint_EObject" = None, EStructuralFeatureCustomization123: "viewpoint_description_VSMElementCustomizationReuse" = None, EStructuralFeatureCustomization: "viewpoint_description_VSMElementCustomization" = None):
        self.referenceName = referenceName
...
class viewpoint_description_EAttributeCustomization(EStructuralFeatureCustomization):
    ...
    def __init__(self, attributeName: str, value: str, EStructuralFeatureCustomization123: "viewpoint_description_VSMElementCustomizationReuse" = None, EStructuralFeatureCustomization: "viewpoint_description_VSMElementCustomization" = None):
...
class viewpoint_description_DecorationDescription(ABC):
    ...
    def __init__(self, imageExpression: str, tooltipExpression: str, name: str, position: str, distributionDirection: str, preconditionExpression: str):
    ...
    @property
    def distributionDirection(self):
...
class viewpoint_description_ConditionalStyleDescription(ABC):
    ...
    def checkPredicate(self, viewpoint_containerVariable, viewpoint_modelElement, viewpoint_viewVariable) :
...
class viewpoint_BasicLabelStyle(Customizable):
    ...
    def __init__(self, showIcon: bool, iconPath: str, labelColor: str, labelSize: int, labelFormat: str):
        self.showIcon = showIcon
        self.iconPath = iconPath
...
class viewpoint_description_SemanticBasedDecoration(DecorationDescription):
    ...
    def __init__(self, domainClass: str, DecorationDescription119: "viewpoint_description_DecorationDescriptionsSet" = None, DecorationDescription: "viewpoint_Decoration" = None):
        self.domainClass = domainClass
...
class viewpoint_UIState:
    ...
    @property
    def subDiagramDecorationDescriptors(self):
...
class viewpoint_tool_ToolEntry(description_IdentifiedElement, description_DocumentedElement):
    ...
    pass
class viewpoint_description_Viewpoint(description_EndUserDocumentedElement, description_Component, description_IdentifiedElement, description_DocumentedElement):

    def __init__(self, icon: str, modelFileExtension: str, conflicts: str, reuses: str, customizes: str, viewpoint_description_Viewpoint93: set["RepresentationExtensionDescription"] = None, viewpoint_description_Viewpoint95: set["JavaExtension"] = None, viewpoint_description_Viewpoint97: set["MetamodelExtensionSetting"] = None, viewpoint_description_Viewpoint99: set["FeatureExtensionDescription"] = None, viewpoint_description_Viewpoint: "validation_ValidationSet" = None, viewpoint_description_Viewpoint90: set["RepresentationDescription"] = None, viewpoint_description_Viewpoint102: set["RepresentationTemplate"] = None):
        self.icon = icon
...
class viewpoint_description_RepresentationElementMapping(IdentifiedElement):
    ...
    pass
class viewpoint_DRepresentationDescriptor(IdentifiedElement, description_DModelElement, description_DocumentedElement):

    def __init__(self, repPath: str, changeId: str, name: str, viewpoint_DRepresentationDescriptor19: "viewpoint_EObject" = None, viewpoint_DRepresentationDescriptor22: "viewpoint_DRepresentation" = None, viewpoint_DRepresentationDescriptor: "RepresentationDescription" = None, viewpoint_DRepresentationDescriptor39: "viewpoint_DView" = None):
...
class viewpoint_DRepresentation(DRefreshable, IdentifiedElement, description_DModelElement):

    def __init__(self, name: str, documentation: str, viewpoint_DRepresentation: "viewpoint_DRepresentationDescriptor" = None, viewpoint_DRepresentation24: set["viewpoint_DRepresentationElement"] = None, viewpoint_DRepresentation26: set["viewpoint_DRepresentationElement"] = None, viewpoint_DRepresentation29: set["AnnotationEntry"] = None, viewpoint_DRepresentation31: "viewpoint_UIState" = None):
        self.name = name
        self.documentation = documentation
...
class viewpoint_DRepresentationElement(IdentifiedElement, DSemanticDecorator, DMappingBased, DRefreshable, DStylizable):
...
class viewpoint_Style(DRefreshable, IdentifiedElement, Customizable):
...
class viewpoint_DAnalysis(IdentifiedElement):
    ...
    def __init__(self, version: str, semanticResources: str, viewpoint_DAnalysis12: set["viewpoint_DFeatureExtension"] = None, viewpoint_DAnalysis5: set["DAnnotationEntry"] = None, viewpoint_DAnalysis7: set["viewpoint_DView"] = None, viewpoint_DAnalysis9: set["viewpoint_DView"] = None, viewpoint_DAnalysis: "viewpoint_DAnalysis" = None, viewpoint_DAnalysis0: set["viewpoint_DAnalysis"] = None, viewpoint_DAnalysis3: set["viewpoint_EObject"] = None, viewpoint_DAnalysis56: "viewpoint_DAnalysisSessionEObject" = None):
        self.version = version
...
class viewpoint_DFeatureExtension(IdentifiedElement):
    ...
    pass
class viewpoint_DView(DRefreshable, IdentifiedElement):
