...
viewpoint_IdentifiedElement = Class(name="viewpoint_IdentifiedElement", is_abstract=True)
...
viewpoint_DRepresentationDescriptor = Class(name="viewpoint_DRepresentationDescriptor")
...
viewpoint_UIState = Class(name="viewpoint_UIState")
...
viewpoint_ToolSectionInstance = Class(name="viewpoint_ToolSectionInstance")
viewpoint_ToolInstance = Class(name="viewpoint_ToolInstance")
tool_ToolEntry = Class(name="tool_ToolEntry")
viewpoint_ToolGroupInstance = Class(name="viewpoint_ToolGroupInstance")
...
viewpoint_description_Extension = Class(name="viewpoint_description_Extension", is_abstract=True)
...
viewpoint_description_GenericDecorationDescription = Class(name="viewpoint_description_GenericDecorationDescription")
...
viewpoint_description_TypedVariable = Class(name="viewpoint_description_TypedVariable")
description_InteractiveVariableDescription = Class(name="description_InteractiveVariableDescription")
description_SubVariable = Class(name="description_SubVariable")
description_viewpoint_EDataType = Class(name="description_viewpoint_EDataType")
...
viewpoint_description_AbstractVariable = Class(name="viewpoint_description_AbstractVariable", is_abstract=True)
viewpoint_description_SubVariable = Class(name="viewpoint_description_SubVariable", is_abstract=True)
AbstractVariable = Class(name="AbstractVariable")
viewpoint_description_InteractiveVariableDescription = Class(name="viewpoint_description_InteractiveVariableDescription", is_abstract=True)
...
tool_MenuItemDescriptionWithIcon = Class(name="tool_MenuItemDescriptionWithIcon")
tool_GroupMenuItem = Class(name="tool_GroupMenuItem")
...
viewpoint_tool_GroupMenu = Class(name="viewpoint_tool_GroupMenu")
MenuItemDescription = Class(name="MenuItemDescription")
tool_PopupMenu = Class(name="tool_PopupMenu")
viewpoint_tool_GroupMenuItem = Class(name="viewpoint_tool_GroupMenuItem", is_abstract=True)
viewpoint_tool_Let = Class(name="viewpoint_tool_Let")
...
viewpoint_tool_MenuItemDescriptionWithIcon = Class(name="viewpoint_tool_MenuItemDescriptionWithIcon", is_abstract=True)
...
viewpoint_DRepresentationDescriptor.attributes={viewpoint_DRepresentationDescriptor_changeId, viewpoint_DRepresentationDescriptor_name, viewpoint_DRepresentationDescriptor_repPath}
...
viewpoint_DAnalysisSessionEObject.attributes={viewpoint_DAnalysisSessionEObject_resources, viewpoint_DAnalysisSessionEObject_open, viewpoint_DAnalysisSessionEObject_controlledResources, viewpoint_DAnalysisSessionEObject_synchronizationStatus}
...
viewpoint_BasicLabelStyle.attributes={viewpoint_BasicLabelStyle_showIcon, viewpoint_BasicLabelStyle_labelSize, viewpoint_BasicLabelStyle_labelColor, viewpoint_BasicLabelStyle_labelFormat, viewpoint_BasicLabelStyle_iconPath}
...
viewpoint_ToolInstance.attributes={viewpoint_ToolInstance_enabled, viewpoint_ToolInstance_visible, viewpoint_ToolInstance_filtered, viewpoint_ToolInstance_id}
...
viewpoint_description_Viewpoint.attributes={viewpoint_description_Viewpoint_conflicts, viewpoint_description_Viewpoint_reuses, viewpoint_description_Viewpoint_customizes, viewpoint_description_Viewpoint_icon, viewpoint_description_Viewpoint_modelFileExtension}
...
viewpoint_description_RepresentationExtensionDescription.attributes={viewpoint_description_RepresentationExtensionDescription_representationName, viewpoint_description_RepresentationExtensionDescription_name, viewpoint_description_RepresentationExtensionDescription_viewpointURI}
...
viewpoint_description_DecorationDescription.attributes={viewpoint_description_DecorationDescription_tooltipExpression, viewpoint_description_DecorationDescription_name, viewpoint_description_DecorationDescription_distributionDirection, viewpoint_description_DecorationDescription_imageExpression, viewpoint_description_DecorationDescription_position, viewpoint_description_DecorationDescription_preconditionExpression}
...
viewpoint_description_SelectionDescription.attributes={viewpoint_description_SelectionDescription_tree, viewpoint_description_SelectionDescription_rootExpression, viewpoint_description_SelectionDescription_multiple, viewpoint_description_SelectionDescription_candidatesExpression, viewpoint_description_SelectionDescription_message, viewpoint_description_SelectionDescription_childrenExpression}
...
viewpoint_description_ComputedColor.attributes={viewpoint_description_ComputedColor_green, viewpoint_description_ComputedColor_blue, viewpoint_description_ComputedColor_red}
...
viewpoint_style_BasicLabelStyleDescription.attributes={viewpoint_style_BasicLabelStyleDescription_labelExpression, viewpoint_style_BasicLabelStyleDescription_iconPath, viewpoint_style_BasicLabelStyleDescription_labelSize, viewpoint_style_BasicLabelStyleDescription_showIcon, viewpoint_style_BasicLabelStyleDescription_labelFormat}
...
viewpoint_tool_AbstractToolDescription.attributes={viewpoint_tool_AbstractToolDescription_precondition, viewpoint_tool_AbstractToolDescription_inverseSelectionOrder, viewpoint_tool_AbstractToolDescription_forceRefresh, viewpoint_tool_AbstractToolDescription_elementsToSelect}
...
viewpoint_tool_PaneBasedSelectionWizardDescription.attributes={viewpoint_tool_PaneBasedSelectionWizardDescription_windowTitle, viewpoint_tool_PaneBasedSelectionWizardDescription_selectedValuesMessage, viewpoint_tool_PaneBasedSelectionWizardDescription_candidatesExpression, viewpoint_tool_PaneBasedSelectionWizardDescription_message, viewpoint_tool_PaneBasedSelectionWizardDescription_choiceOfValuesMessage, viewpoint_tool_PaneBasedSelectionWizardDescription_iconPath, viewpoint_tool_PaneBasedSelectionWizardDescription_windowImagePath, viewpoint_tool_PaneBasedSelectionWizardDescription_tree, viewpoint_tool_PaneBasedSelectionWizardDescription_rootExpression, viewpoint_tool_PaneBasedSelectionWizardDescription_preSelectedCandidatesExpression, viewpoint_tool_PaneBasedSelectionWizardDescription_childrenExpression}
...
viewpoint_tool_CreateInstance.attributes={viewpoint_tool_CreateInstance_typeName, viewpoint_tool_CreateInstance_variableName, viewpoint_tool_CreateInstance_referenceName}
...
domain_model = DomainModel(
    name="viewpoint",
    types={viewpoint_DView, viewpoint_DFeatureExtension, viewpoint_IdentifiedElement, viewpoint_DAnalysis, IdentifiedElement, viewpoint_EObject, DAnnotationEntry, viewpoint_DRepresentation, DRefreshable, FeatureExtensionDescription, viewpoint_DRepresentationElement, viewpoint_DStylizable, viewpoint_DRefreshable, viewpoint_DMappingBased, viewpoint_DSemanticDecorator, viewpoint_DRepresentationDescriptor, description_DModelElement, description_DocumentedElement, RepresentationDescription, viewpoint_MetaModelExtension, AnnotationEntry, viewpoint_UIState, DMappingBased, DStylizable, DSemanticDecorator, style_StyleDescription, Viewpoint, viewpoint_DAnalysisSessionEObject, viewpoint_Decoration, DecorationDescription, viewpoint_DAnalysisCustomData, viewpoint_LabelStyle, BasicLabelStyle, viewpoint_Style, Customizable, viewpoint_Customizable, viewpoint_SessionManagerEObject, viewpoint_DResource, viewpoint_DFile, DResource, viewpoint_DResourceContainer, viewpoint_DProject, DResourceContainer, viewpoint_DFolder, viewpoint_DModel, DFile, viewpoint_BasicLabelStyle, viewpoint_description_Group, viewpoint_ToolSectionInstance, viewpoint_ToolInstance, tool_ToolEntry, viewpoint_ToolGroupInstance, ToolInstance, JavaExtension, MetamodelExtensionSetting, RepresentationTemplate, SytemColorsPalette, UserColorsPalette, Extension, viewpoint_description_Extension, viewpoint_description_Component, viewpoint_description_Viewpoint, description_Component, description_EndUserDocumentedElement, description_IdentifiedElement, validation_ValidationSet, RepresentationExtensionDescription, viewpoint_description_MetamodelExtensionSetting, description_viewpoint_EObject, viewpoint_description_JavaExtension, viewpoint_description_FeatureExtensionDescription, viewpoint_description_RepresentationDescription, description_viewpoint_EPackage, viewpoint_description_RepresentationTemplate, viewpoint_description_RepresentationImportDescription, viewpoint_description_RepresentationExtensionDescription, viewpoint_description_DAnnotation, description_viewpoint_EStringToStringMapEntry, viewpoint_description_ConditionalStyleDescription, viewpoint_description_RepresentationElementMapping, tool_RepresentationCreationDescription, tool_RepresentationNavigationDescription, viewpoint_description_AbstractMappingImport, viewpoint_description_DocumentedElement, viewpoint_description_DModelElement, DAnnotation, viewpoint_description_PasteTargetDescription, tool_PasteDescription, viewpoint_description_DecorationDescriptionsSet, viewpoint_description_DecorationDescription, viewpoint_description_Customization, IVSMElementCustomization, viewpoint_description_IVSMElementCustomization, viewpoint_description_VSMElementCustomization, viewpoint_description_SemanticBasedDecoration, viewpoint_description_GenericDecorationDescription, viewpoint_description_SelectionDescription, EStructuralFeatureCustomization, viewpoint_description_VSMElementCustomizationReuse, viewpoint_description_EStructuralFeatureCustomization, viewpoint_description_EAttributeCustomization, viewpoint_description_EReferenceCustomization, viewpoint_description_ColorStep, viewpoint_description_FixedColor, ColorDescription, viewpoint_description_UserFixedColor, description_FixedColor, viewpoint_description_ColorDescription, viewpoint_description_UserColor, viewpoint_description_SystemColor, FixedColor, viewpoint_description_InterpolatedColor, description_ColorDescription, description_UserColor, ColorStep, viewpoint_description_Environment, viewpoint_description_UserColorsPalette, UserColor, viewpoint_description_AnnotationEntry, viewpoint_description_EndUserDocumentedElement, viewpoint_description_IdentifiedElement, viewpoint_description_ComputedColor, style_LabelBorderStyles, viewpoint_description_SytemColorsPalette, SystemColor, viewpoint_description_TypedVariable, description_InteractiveVariableDescription, description_SubVariable, description_viewpoint_EDataType, viewpoint_style_StyleDescription, viewpoint_style_BasicLabelStyleDescription, viewpoint_description_DAnnotationEntry, viewpoint_style_LabelStyleDescription, BasicLabelStyleDescription, viewpoint_description_AbstractVariable, viewpoint_description_SubVariable, AbstractVariable, viewpoint_description_InteractiveVariableDescription, viewpoint_style_LabelBorderStyleDescription, viewpoint_style_TooltipStyleDescription, viewpoint_tool_ToolEntry, viewpoint_tool_AbstractToolDescription, ToolEntry, tool_ToolFilterDescription, viewpoint_style_LabelBorderStyles, style_LabelBorderStyleDescription, viewpoint_tool_MappingBasedToolDescription, AbstractToolDescription, viewpoint_tool_ToolDescription, MappingBasedToolDescription, tool_ElementVariable, tool_ElementViewVariable, tool_InitialOperation, viewpoint_tool_PasteDescription, tool_DropContainerVariable, tool_ContainerViewVariable, viewpoint_tool_SelectionWizardDescription, tool_AbstractToolDescription, description_SelectionDescription, tool_ElementSelectVariable, tool_SelectContainerVariable, viewpoint_tool_PaneBasedSelectionWizardDescription, viewpoint_tool_RepresentationCreationDescription, tool_NameVariable, viewpoint_tool_RepresentationNavigationDescription, viewpoint_tool_PopupMenu, viewpoint_tool_VariableContainer, SubVariable, viewpoint_tool_AcceleoVariable, tool_VariableContainer, viewpoint_tool_MenuItemOrRef, viewpoint_tool_MenuItemDescription, tool_MenuItemOrRef, viewpoint_tool_MenuItemDescriptionReference, MenuItemOrRef, tool_MenuItemDescription, viewpoint_tool_OperationAction, tool_MenuItemDescriptionWithIcon, tool_GroupMenuItem, viewpoint_tool_ExternalJavaAction, tool_ContainerModelOperation, tool_ExternalJavaActionParameter, viewpoint_tool_ExternalJavaActionCall, tool_ExternalJavaAction, viewpoint_tool_ModelOperation, viewpoint_tool_InitialNodeCreationOperation, viewpoint_tool_InitialOperation, viewpoint_tool_InitEdgeCreationOperation, viewpoint_tool_InitialContainerDropOperation, viewpoint_tool_DialogVariable, viewpoint_tool_ElementDropVariable, description_AbstractVariable, viewpoint_tool_ElementSelectVariable, viewpoint_tool_ElementVariable, viewpoint_tool_ElementViewVariable, viewpoint_tool_ElementDeleteVariable, viewpoint_tool_DropContainerVariable, viewpoint_tool_SelectContainerVariable, viewpoint_tool_ContainerViewVariable, viewpoint_tool_SelectModelElementVariable, viewpoint_tool_EditMaskVariables, viewpoint_tool_ContainerModelOperation, ModelOperation, tool_ModelOperation, tool_viewpoint_EObject, viewpoint_tool_Unset, viewpoint_tool_MoveElement, viewpoint_tool_CreateInstance, ContainerModelOperation, viewpoint_tool_ChangeContext, viewpoint_tool_SetValue, viewpoint_tool_SetObject, viewpoint_tool_DeleteView, viewpoint_tool_NameVariable, viewpoint_tool_ExternalJavaActionParameter, viewpoint_tool_RemoveElement, viewpoint_tool_For, viewpoint_tool_If, viewpoint_tool_SwitchChild, viewpoint_tool_Default, viewpoint_tool_Switch, tool_Case, tool_Default, viewpoint_tool_ToolFilterDescription, tool_FeatureChangeListener, viewpoint_tool_FeatureChangeListener, viewpoint_tool_Case, SwitchChild, viewpoint_tool_GroupMenu, MenuItemDescription, tool_PopupMenu, viewpoint_tool_GroupMenuItem, viewpoint_tool_Let, viewpoint_validation_ValidationRule, validation_RuleAudit, validation_ValidationFix, viewpoint_tool_MenuItemDescriptionWithIcon, viewpoint_validation_ValidationSet, DocumentedElement, validation_ValidationRule, viewpoint_validation_ValidationFix, viewpoint_audit_InformationSection, viewpoint_audit_TemplateInformationSection, InformationSection, viewpoint_validation_SemanticValidationRule, ValidationRule, viewpoint_validation_ViewValidationRule, RepresentationElementMapping, viewpoint_validation_RuleAudit, LabelAlignment, FontFormat, SyncStatus, Position, DecorationDistributionDirection, SystemColors, DragSource, ERROR_LEVEL},
    associations={eAnnotations4, ownedViews6, selectedViews8, ownedFeatureExtensions11, referencedAnalysis1, models2, target18, representation21, description13, target15, description17, viewpoint35, ownedRepresentationDescriptors37, ownedExtensions40, models42, ownedRepresentationElements23, representationElements25, ownedAnnotationEntries28, uiState30, semanticElements32, description51, extensionGroup45, description48, data49, activatedViewpoints52, analyses54, ownedSessions57, members59, tools71, section74, subSections78, ownedViewpoints80, elementsToSelect60, toolSections63, toolEntry65, tools66, group68, ownedRepresentationExtensions92, ownedJavaExtensions94, ownedMMExtensions96, ownedFeatureExtensions98, systemColorsPalette82, userColorsPalettes84, extensions86, validationSet88, ownedRepresentations89, metamodel106, extensionGroup108, ownedTemplates101, metamodel103, ownedRepresentations104, details113, references114, detailDescriptions109, navigationDescriptions110, eAnnotations112, pasteDescriptions117, decorationDescriptions118, vsmElementCustomizations120, featureCustomizations121, reuse122, appliedOn124, appliedOn127, value129, associatedColor132, colorSteps131, systemColors133, entries141, data142, defaultTools135, labelBorderStyles138, entries140, valueType144, labelColor145, filters147, labelBorderStyleDescriptions146, element148, container169, initialOperation171, elementView149, initialOperation151, container153, containerView154, copiedView156, copiedElement159, initialOperation162, element165, containerView166, element174, containerView176, container179, initialOperation182, containerViewVariable197, containerVariable200, representationNameVariable203, representationDescription185, initialOperation187, containerViewVariable190, representationNameVariable193, representationDescription195, menuItemDescription214, subVariables216, item206, view207, initialOperation209, parameters212, action213, firstModelOperations218, firstModelOperations220, firstModelOperations222, subModelOperations217, object226, firstModelOperations224, subModelOperations228, cases230, default231, listeners227, popupMenus233, itemDescriptions234, allRules240, audits243, fixes244, ownedRules236, reusedRules237, initialOperation247, targets246},
    generalizations={gen_viewpoint_DFeatureExtension_IdentifiedElement, gen_viewpoint_DAnalysis_IdentifiedElement, gen_viewpoint_DRepresentation_IdentifiedElement, gen_viewpoint_DRepresentation_description_DModelElement, gen_viewpoint_DRepresentation_DRefreshable, gen_viewpoint_DSemanticDecorator_IdentifiedElement, gen_viewpoint_DRepresentationDescriptor_IdentifiedElement, gen_viewpoint_DRepresentationDescriptor_description_DModelElement, gen_viewpoint_DRepresentationDescriptor_description_DocumentedElement, gen_viewpoint_DRepresentationElement_IdentifiedElement, gen_viewpoint_DRepresentationElement_DMappingBased, gen_viewpoint_DRepresentationElement_DStylizable, gen_viewpoint_DRepresentationElement_DRefreshable, gen_viewpoint_DRepresentationElement_DSemanticDecorator, gen_viewpoint_DView_IdentifiedElement, gen_viewpoint_DView_DRefreshable, gen_viewpoint_MetaModelExtension_IdentifiedElement, gen_viewpoint_Decoration_IdentifiedElement, gen_viewpoint_DAnalysisCustomData_IdentifiedElement, gen_viewpoint_LabelStyle_BasicLabelStyle, gen_viewpoint_Style_IdentifiedElement, gen_viewpoint_Style_DRefreshable, gen_viewpoint_Style_Customizable, gen_viewpoint_Customizable_IdentifiedElement, gen_viewpoint_DFile_IdentifiedElement, gen_viewpoint_DFile_DResource, gen_viewpoint_DResourceContainer_IdentifiedElement, gen_viewpoint_DResourceContainer_DResource, gen_viewpoint_DProject_DResourceContainer, gen_viewpoint_DFolder_DResourceContainer, gen_viewpoint_DModel_DFile, gen_viewpoint_BasicLabelStyle_Customizable, gen_viewpoint_description_Group_description_DModelElement, gen_viewpoint_description_Group_description_DocumentedElement, gen_viewpoint_ToolGroupInstance_ToolInstance, gen_viewpoint_ToolSectionInstance_ToolInstance, gen_viewpoint_description_Viewpoint_description_DocumentedElement, gen_viewpoint_description_Viewpoint_description_Component, gen_viewpoint_description_Viewpoint_description_EndUserDocumentedElement, gen_viewpoint_description_Viewpoint_description_IdentifiedElement, gen_viewpoint_description_RepresentationDescription_description_DocumentedElement, gen_viewpoint_description_RepresentationDescription_description_EndUserDocumentedElement, gen_viewpoint_description_RepresentationDescription_description_IdentifiedElement, gen_viewpoint_description_RepresentationImportDescription_RepresentationDescription, gen_viewpoint_description_DAnnotation_IdentifiedElement, gen_viewpoint_description_RepresentationElementMapping_IdentifiedElement, gen_viewpoint_description_VSMElementCustomization_IVSMElementCustomization, gen_viewpoint_description_SemanticBasedDecoration_DecorationDescription, gen_viewpoint_description_GenericDecorationDescription_DecorationDescription, gen_viewpoint_description_VSMElementCustomizationReuse_IVSMElementCustomization, gen_viewpoint_description_EAttributeCustomization_EStructuralFeatureCustomization, gen_viewpoint_description_EReferenceCustomization_EStructuralFeatureCustomization, gen_viewpoint_description_FixedColor_ColorDescription, gen_viewpoint_description_UserFixedColor_description_FixedColor, gen_viewpoint_description_UserFixedColor_description_UserColor, gen_viewpoint_description_SystemColor_FixedColor, gen_viewpoint_description_InterpolatedColor_description_ColorDescription, gen_viewpoint_description_InterpolatedColor_description_UserColor, gen_viewpoint_description_AnnotationEntry_IdentifiedElement, gen_viewpoint_description_ComputedColor_description_UserColor, gen_viewpoint_description_ComputedColor_description_ColorDescription, gen_viewpoint_description_TypedVariable_description_InteractiveVariableDescription, gen_viewpoint_description_TypedVariable_description_SubVariable, gen_viewpoint_description_DAnnotationEntry_IdentifiedElement, gen_viewpoint_style_LabelStyleDescription_BasicLabelStyleDescription, gen_viewpoint_description_SubVariable_AbstractVariable, gen_viewpoint_tool_ToolEntry_description_DocumentedElement, gen_viewpoint_tool_ToolEntry_description_IdentifiedElement, gen_viewpoint_tool_AbstractToolDescription_ToolEntry, gen_viewpoint_tool_MappingBasedToolDescription_AbstractToolDescription, gen_viewpoint_tool_ToolDescription_MappingBasedToolDescription, gen_viewpoint_tool_PasteDescription_MappingBasedToolDescription, gen_viewpoint_tool_SelectionWizardDescription_tool_AbstractToolDescription, gen_viewpoint_tool_SelectionWizardDescription_description_SelectionDescription, gen_viewpoint_tool_PaneBasedSelectionWizardDescription_AbstractToolDescription, gen_viewpoint_tool_RepresentationCreationDescription_AbstractToolDescription, gen_viewpoint_tool_RepresentationNavigationDescription_AbstractToolDescription, gen_viewpoint_tool_PopupMenu_tool_AbstractToolDescription, gen_viewpoint_tool_PopupMenu_tool_GroupMenuItem, gen_viewpoint_tool_AcceleoVariable_tool_VariableContainer, gen_viewpoint_tool_MenuItemDescription_tool_AbstractToolDescription, gen_viewpoint_tool_MenuItemDescription_tool_MenuItemOrRef, gen_viewpoint_tool_MenuItemDescriptionReference_MenuItemOrRef, gen_viewpoint_tool_OperationAction_tool_MenuItemDescriptionWithIcon, gen_viewpoint_tool_OperationAction_tool_GroupMenuItem, gen_viewpoint_tool_ExternalJavaAction_tool_MenuItemDescriptionWithIcon, gen_viewpoint_tool_ExternalJavaAction_tool_ContainerModelOperation, gen_viewpoint_tool_ExternalJavaAction_tool_GroupMenuItem, gen_viewpoint_tool_ExternalJavaActionCall_tool_MenuItemDescriptionWithIcon, gen_viewpoint_tool_ExternalJavaActionCall_tool_ContainerModelOperation, gen_viewpoint_tool_ExternalJavaActionCall_tool_GroupMenuItem, gen_viewpoint_tool_AcceleoVariable_description_SubVariable, gen_viewpoint_tool_DialogVariable_AbstractVariable, gen_viewpoint_tool_ElementDropVariable_description_AbstractVariable, gen_viewpoint_tool_ElementDropVariable_tool_VariableContainer, gen_viewpoint_tool_ElementSelectVariable_AbstractVariable, gen_viewpoint_tool_ElementVariable_description_AbstractVariable, gen_viewpoint_tool_ElementVariable_tool_VariableContainer, gen_viewpoint_tool_ElementViewVariable_description_AbstractVariable, gen_viewpoint_tool_ElementViewVariable_tool_VariableContainer, gen_viewpoint_tool_ElementDeleteVariable_description_AbstractVariable, gen_viewpoint_tool_ElementDeleteVariable_tool_VariableContainer, gen_viewpoint_tool_DropContainerVariable_description_AbstractVariable, gen_viewpoint_tool_DropContainerVariable_tool_VariableContainer, gen_viewpoint_tool_SelectContainerVariable_description_AbstractVariable, gen_viewpoint_tool_SelectContainerVariable_tool_VariableContainer, gen_viewpoint_tool_ContainerViewVariable_description_AbstractVariable, gen_viewpoint_tool_ContainerViewVariable_tool_VariableContainer, gen_viewpoint_tool_SelectModelElementVariable_description_SubVariable, gen_viewpoint_tool_SelectModelElementVariable_description_SelectionDescription, gen_viewpoint_tool_SelectModelElementVariable_description_InteractiveVariableDescription, gen_viewpoint_tool_ContainerModelOperation_ModelOperation, gen_viewpoint_tool_Unset_ContainerModelOperation, gen_viewpoint_tool_MoveElement_ContainerModelOperation, gen_viewpoint_tool_CreateInstance_ContainerModelOperation, gen_viewpoint_tool_ChangeContext_ContainerModelOperation, gen_viewpoint_tool_SetValue_ContainerModelOperation, gen_viewpoint_tool_SetObject_ContainerModelOperation, gen_viewpoint_tool_DeleteView_ContainerModelOperation, gen_viewpoint_tool_NameVariable_AbstractVariable, gen_viewpoint_tool_RemoveElement_ContainerModelOperation, gen_viewpoint_tool_For_ContainerModelOperation, gen_viewpoint_tool_If_ContainerModelOperation, gen_viewpoint_tool_Default_SwitchChild, gen_viewpoint_tool_Switch_ModelOperation, gen_viewpoint_tool_Case_SwitchChild, gen_viewpoint_tool_GroupMenu_MenuItemDescription, gen_viewpoint_tool_GroupMenuItem_AbstractToolDescription, gen_viewpoint_tool_Let_ContainerModelOperation, gen_viewpoint_validation_ValidationRule_IdentifiedElement, gen_viewpoint_tool_MenuItemDescriptionWithIcon_MenuItemDescription, gen_viewpoint_validation_ValidationSet_DocumentedElement, gen_viewpoint_audit_TemplateInformationSection_InformationSection, gen_viewpoint_validation_SemanticValidationRule_ValidationRule, gen_viewpoint_validation_ViewValidationRule_ValidationRule},
    metadata=None
)
