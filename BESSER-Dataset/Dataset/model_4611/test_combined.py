...
def test_hyp_toolinstance_is_not_abstract():
    assert not inspect.isabstract(ToolInstance)


def test_hyp_toolinstance_constructor_exists():
    assert callable(ToolInstance.__init__)


def test_hyp_toolinstance_constructor_args():
    sig = inspect.signature(ToolInstance.__init__)
    params = list(sig.parameters.keys())



def test_hyp_viewpoint_toolgroupinstance_is_not_abstract():
    assert not inspect.isabstract(viewpoint_ToolGroupInstance)


def test_hyp_viewpoint_toolgroupinstance_constructor_exists():
    assert callable(viewpoint_ToolGroupInstance.__init__)


def test_hyp_viewpoint_toolgroupinstance_constructor_args():
...
def test_hyp_viewpoint_toolinstance_is_not_abstract():
    assert not inspect.isabstract(viewpoint_ToolInstance)


def test_hyp_viewpoint_toolinstance_constructor_exists():
    assert callable(viewpoint_ToolInstance.__init__)


def test_hyp_viewpoint_toolinstance_constructor_args():
...
def test_hyp_viewpoint_toolsectioninstance_is_not_abstract():
    assert not inspect.isabstract(viewpoint_ToolSectionInstance)


def test_hyp_viewpoint_toolsectioninstance_constructor_exists():
    assert callable(viewpoint_ToolSectionInstance.__init__)


def test_hyp_viewpoint_toolsectioninstance_constructor_args():
...
def test_hyp_viewpoint_identifiedelement_is_not_abstract():
    assert not inspect.isabstract(viewpoint_IdentifiedElement)


def test_hyp_viewpoint_identifiedelement_constructor_exists():
    assert callable(viewpoint_IdentifiedElement.__init__)


def test_hyp_viewpoint_identifiedelement_constructor_args():
...
def test_hyp_viewpoint_tool_menuitemdescriptionwithicon_is_not_abstract():
    assert not inspect.isabstract(viewpoint_tool_MenuItemDescriptionWithIcon)


def test_hyp_viewpoint_tool_menuitemdescriptionwithicon_constructor_exists():
    assert callable(viewpoint_tool_MenuItemDescriptionWithIcon.__init__)


def test_hyp_viewpoint_tool_menuitemdescriptionwithicon_constructor_args():
...
def test_hyp_viewpoint_tool_groupmenu_is_not_abstract():
    assert not inspect.isabstract(viewpoint_tool_GroupMenu)


def test_hyp_viewpoint_tool_groupmenu_constructor_exists():
    assert callable(viewpoint_tool_GroupMenu.__init__)


def test_hyp_viewpoint_tool_groupmenu_constructor_args():
...
def test_hyp_tool_groupmenuitem_is_not_abstract():
    assert not inspect.isabstract(tool_GroupMenuItem)


def test_hyp_tool_groupmenuitem_constructor_exists():
    assert callable(tool_GroupMenuItem.__init__)


def test_hyp_tool_groupmenuitem_constructor_args():
    sig = inspect.signature(tool_GroupMenuItem.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tool_menuitemdescriptionwithicon_is_not_abstract():
    assert not inspect.isabstract(tool_MenuItemDescriptionWithIcon)


def test_hyp_tool_menuitemdescriptionwithicon_constructor_exists():
    assert callable(tool_MenuItemDescriptionWithIcon.__init__)


def test_hyp_tool_menuitemdescriptionwithicon_constructor_args():
...
def test_hyp_viewpoint_tool_groupmenuitem_is_not_abstract():
    assert not inspect.isabstract(viewpoint_tool_GroupMenuItem)


def test_hyp_viewpoint_tool_groupmenuitem_constructor_exists():
    assert callable(viewpoint_tool_GroupMenuItem.__init__)


def test_hyp_viewpoint_tool_groupmenuitem_constructor_args():
...
def test_hyp_viewpoint_toolinstance_enabled_setter(instance):
...
@given(instance=viewpoint_ToolInstance_strategy)
def test_hyp_viewpoint_toolinstance_visible_setter(instance):
...
@given(instance=viewpoint_ToolInstance_strategy)
def test_hyp_viewpoint_toolinstance_id_setter(instance):
...
@given(instance=viewpoint_ToolInstance_strategy)
def test_hyp_viewpoint_toolinstance_filtered_setter(instance):
...
def test_hyp_viewpoint_uistate_subDiagramDecorationDescriptors_setter(instance):
...
def test_hyp_viewpoint_drepresentation_documentation_setter(instance):
...
def test_hyp_viewpoint_drepresentationdescriptor_changeId_setter(instance):
...
@given(instance=viewpoint_DRepresentationDescriptor_strategy)
def test_hyp_viewpoint_drepresentationdescriptor_repPath_setter(instance):
...
def test_hyp_viewpoint_identifiedelement_uid_setter(instance):
...
def test_hyp_viewpoint_tool_menuitemdescriptionwithicon_icon_setter(instance):
...
def test_hyp_viewpoint_tool_groupmenu_locationURI_setter(instance):
