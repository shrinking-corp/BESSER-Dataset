...
library3_BookType.attributes={library3_BookType_author, library3_BookType_isbn, library3_BookType_name, library3_BookType_pages, library3_BookType_title}
...
domain_model = DomainModel(
    ...
    associations={xMLNSPrefixMap1, xSISchemaLocation2, bookInfo0, book7, customer10, library5},
    generalizations={},
    metadata=None
)
