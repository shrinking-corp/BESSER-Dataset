...
class library3_BookType:
    ...
    def __init__(self, name: str, title: str, isbn: str, author: str, pages: str, library3_BookType: "library3_BookInfoType" = None, library3_BookType9: "library3_LibraryType" = None):
        self.name = name
        self.title = title
        self.isbn = isbn
        self.author = author
