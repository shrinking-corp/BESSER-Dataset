...
public class Department  {
    ...
    public Department(
        None course,        None hod,        None teachers__,        None students__    ) {
        this.course = course;
        this.hod = hod;
    ...
    public Department(
        None course,        None hod,        None teachers__,        None students__        ArrayList<Student> students,        ArrayList<Employee_Interface> employee_interfaces    ) {
        this.course = course;
        this.hod = hod;
        this.teachers__ = teachers__;
        this.students__ = students__;
