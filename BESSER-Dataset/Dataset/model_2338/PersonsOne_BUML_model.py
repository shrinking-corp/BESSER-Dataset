...
# Classes
PersonsOne_Student = Class(name="PersonsOne_Student")
Person = Class(name="Person")
PersonsOne_Group = Class(name="PersonsOne_Group")
PersonsOne_Person = Class(name="PersonsOne_Person")
...
domain_model = DomainModel(
    name="PersonsOne",
    types={PersonsOne_Student, Person, PersonsOne_Group, PersonsOne_Person},
