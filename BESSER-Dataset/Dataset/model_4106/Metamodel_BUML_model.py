...
# Classes
Concept_Segment = Class(name="Concept_Segment")
Trackelement = Class(name="Trackelement")
Concept_Trackelement = Class(name="Concept_Trackelement")
Thing = Class(name="Thing")
Concept_Sensor = Class(name="Concept_Sensor")
Concept_Switch = Class(name="Concept_Switch")
Concept_SwitchPosition = Class(name="Concept_SwitchPosition")
Concept_Route = Class(name="Concept_Route")
Concept_Signal = Class(name="Concept_Signal")
Concept_IndividualContainer = Class(name="Concept_IndividualContainer")
Concept_Thing = Class(name="Concept_Thing")
...
domain_model = DomainModel(
    name="Concept",
    types={Concept_Segment, Trackelement, Concept_Trackelement, Thing, Concept_Sensor, Concept_Switch, Concept_SwitchPosition, Concept_Route, Concept_Signal, Concept_IndividualContainer, Concept_Thing, SwitchStateKind, SignalStateKind},
    associations={TrackElement_sensor0, TrackElement_connectsTo2, Switch_switchPosition3, Route_entry4, Route_switchPosition5, Route_exit7, Route_routeDefinition10, SwitchPosition_switch12, contains15, SwitchPosition_route13, Sensor_trackElement14},
    generalizations={gen_Concept_Segment_Trackelement, gen_Concept_Trackelement_Thing, gen_Concept_Switch_Trackelement, gen_Concept_Route_Thing, gen_Concept_Signal_Thing, gen_Concept_SwitchPosition_Thing, gen_Concept_Sensor_Thing},
    metadata=None
)
