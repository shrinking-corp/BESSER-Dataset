...
class Concept_SwitchPosition(Thing):
    ...
    def __init__(self, SwitchPosition_switchState: str, SwitchPosition: "Concept_Switch" = None, SwitchPosition6: "Concept_Route" = None, Switch_switchPosition: "Concept_Switch" = None, Route_switchPosition: "Concept_Route" = None):
...
class Concept_Switch(Trackelement):
    ...
    def __init__(self, Switch_actualState: str, SwitchPosition_switch: set["Concept_SwitchPosition"] = None, Switch: "Concept_SwitchPosition" = None):
