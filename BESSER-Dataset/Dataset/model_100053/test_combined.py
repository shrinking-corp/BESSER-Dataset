...
def test_hyp_research_team_typecollaboration_is_not_abstract():
    assert not inspect.isabstract(research_team_TypeCollaboration)


def test_hyp_research_team_typecollaboration_constructor_exists():
    assert callable(research_team_TypeCollaboration.__init__)


def test_hyp_research_team_typecollaboration_constructor_args():
...
def test_hyp_research_team_partner_is_not_abstract():
    assert not inspect.isabstract(research_team_Partner)


def test_hyp_research_team_partner_constructor_exists():
    assert callable(research_team_Partner.__init__)


def test_hyp_research_team_partner_constructor_args():
...
def test_hyp_research_team_callforpaper_is_not_abstract():
    assert not inspect.isabstract(research_team_CallForPaper)


def test_hyp_research_team_callforpaper_constructor_exists():
    assert callable(research_team_CallForPaper.__init__)


def test_hyp_research_team_callforpaper_constructor_args():
...
def test_hyp_research_team_section_is_not_abstract():
    assert not inspect.isabstract(research_team_Section)


def test_hyp_research_team_section_constructor_exists():
    assert callable(research_team_Section.__init__)


def test_hyp_research_team_section_constructor_args():
...
def test_hyp_research_team_inproceedings_is_not_abstract():
    assert not inspect.isabstract(research_team_InProceedings)


def test_hyp_research_team_inproceedings_constructor_exists():
    assert callable(research_team_InProceedings.__init__)


def test_hyp_research_team_inproceedings_constructor_args():
    sig = inspect.signature(research_team_InProceedings.__init__)
    params = list(sig.parameters.keys())



def test_hyp_research_team_phdthesis_is_not_abstract():
    assert not inspect.isabstract(research_team_PhDThesis)


def test_hyp_research_team_phdthesis_constructor_exists():
    assert callable(research_team_PhDThesis.__init__)


def test_hyp_research_team_phdthesis_constructor_args():
    sig = inspect.signature(research_team_PhDThesis.__init__)
    params = list(sig.parameters.keys())



def test_hyp_research_team_misc_is_not_abstract():
    assert not inspect.isabstract(research_team_Misc)


def test_hyp_research_team_misc_constructor_exists():
    assert callable(research_team_Misc.__init__)


def test_hyp_research_team_misc_constructor_args():
    sig = inspect.signature(research_team_Misc.__init__)
    params = list(sig.parameters.keys())



def test_hyp_research_team_masterthesis_is_not_abstract():
    assert not inspect.isabstract(research_team_MasterThesis)


def test_hyp_research_team_masterthesis_constructor_exists():
    assert callable(research_team_MasterThesis.__init__)


def test_hyp_research_team_masterthesis_constructor_args():
    sig = inspect.signature(research_team_MasterThesis.__init__)
    params = list(sig.parameters.keys())



def test_hyp_research_team_article_is_not_abstract():
    assert not inspect.isabstract(research_team_Article)


def test_hyp_research_team_article_constructor_exists():
    assert callable(research_team_Article.__init__)


def test_hyp_research_team_article_constructor_args():
    sig = inspect.signature(research_team_Article.__init__)
    params = list(sig.parameters.keys())



def test_hyp_research_team_paper_is_not_abstract():
    assert not inspect.isabstract(research_team_Paper)


def test_hyp_research_team_paper_constructor_exists():
    assert callable(research_team_Paper.__init__)


def test_hyp_research_team_paper_constructor_args():
...
def test_hyp_research_team_seminar_is_not_abstract():
    assert not inspect.isabstract(research_team_Seminar)


def test_hyp_research_team_seminar_constructor_exists():
    assert callable(research_team_Seminar.__init__)


def test_hyp_research_team_seminar_constructor_args():
...
def test_hyp_research_team_software_is_not_abstract():
    assert not inspect.isabstract(research_team_Software)


def test_hyp_research_team_software_constructor_exists():
    assert callable(research_team_Software.__init__)


def test_hyp_research_team_software_constructor_args():
...
def test_hyp_research_team_publication_is_not_abstract():
    assert not inspect.isabstract(research_team_Publication)


def test_hyp_research_team_publication_constructor_exists():
    assert callable(research_team_Publication.__init__)


def test_hyp_research_team_publication_constructor_args():
    sig = inspect.signature(research_team_Publication.__init__)
    params = list(sig.parameters.keys())



def test_hyp_research_team_collaboration_is_not_abstract():
    assert not inspect.isabstract(research_team_Collaboration)


def test_hyp_research_team_collaboration_constructor_exists():
    assert callable(research_team_Collaboration.__init__)


def test_hyp_research_team_collaboration_constructor_args():
...
def test_hyp_research_team_openposition_is_not_abstract():
    assert not inspect.isabstract(research_team_OpenPosition)


def test_hyp_research_team_openposition_constructor_exists():
    assert callable(research_team_OpenPosition.__init__)


def test_hyp_research_team_openposition_constructor_args():
...
def test_hyp_research_team_person_is_not_abstract():
    assert not inspect.isabstract(research_team_Person)


def test_hyp_research_team_person_constructor_exists():
    assert callable(research_team_Person.__init__)


def test_hyp_research_team_person_constructor_args():
...
def test_hyp_research_team_activityreport_is_not_abstract():
    assert not inspect.isabstract(research_team_ActivityReport)


def test_hyp_research_team_activityreport_constructor_exists():
    assert callable(research_team_ActivityReport.__init__)


def test_hyp_research_team_activityreport_constructor_args():
    sig = inspect.signature(research_team_ActivityReport.__init__)
    params = list(sig.parameters.keys())



def test_hyp_research_team_team_is_not_abstract():
    assert not inspect.isabstract(research_team_Team)


def test_hyp_research_team_team_constructor_exists():
    assert callable(research_team_Team.__init__)


def test_hyp_research_team_team_constructor_args():
...
def test_hyp_research_team_typecollaboration_name_setter(instance):
...
def test_hyp_research_team_partner_category_setter(instance):
...
@given(instance=research_team_Partner_strategy)
def test_hyp_research_team_partner_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=research_team_Partner_strategy)
def test_hyp_research_team_partner_country_setter(instance):
...
def test_hyp_research_team_callforpaper_title_setter(instance):
...
@given(instance=research_team_CallForPaper_strategy)
def test_hyp_research_team_callforpaper_category_setter(instance):
    original = instance.category
    instance.category = original
    assert instance.category == original
...
@given(instance=research_team_CallForPaper_strategy)
def test_hyp_research_team_callforpaper_deadline_setter(instance):
...
@given(instance=research_team_CallForPaper_strategy)
def test_hyp_research_team_callforpaper_url_setter(instance):
...
def test_hyp_research_team_section_text_setter(instance):
...
def test_hyp_research_team_paper_state_setter(instance):
...
@given(instance=research_team_Paper_strategy)
def test_hyp_research_team_paper_url4pdf_setter(instance):
...
@given(instance=research_team_Paper_strategy)
def test_hyp_research_team_paper_title_setter(instance):
    original = instance.title
    instance.title = original
    assert instance.title == original
...
def test_hyp_research_team_seminar_dateUntil_setter(instance):
...
@given(instance=research_team_Seminar_strategy)
def test_hyp_research_team_seminar_title_setter(instance):
    original = instance.title
    instance.title = original
    assert instance.title == original
...
@given(instance=research_team_Seminar_strategy)
def test_hyp_research_team_seminar_dateFrom_setter(instance):
...
@given(instance=research_team_Seminar_strategy)
def test_hyp_research_team_seminar_url4slides_setter(instance):
...
@given(instance=research_team_Seminar_strategy)
def test_hyp_research_team_seminar_place_setter(instance):
...
@given(instance=research_team_Seminar_strategy)
def test_hyp_research_team_seminar_abstract_setter(instance):
...
def test_hyp_research_team_software_description_setter(instance):
...
@given(instance=research_team_Software_strategy)
def test_hyp_research_team_software_title_setter(instance):
    original = instance.title
    instance.title = original
    assert instance.title == original
...
@given(instance=research_team_Software_strategy)
def test_hyp_research_team_software_website_setter(instance):
...
def test_hyp_research_team_collaboration_status_setter(instance):
...
@given(instance=research_team_Collaboration_strategy)
def test_hyp_research_team_collaboration_from__setter(instance):
...
@given(instance=research_team_Collaboration_strategy)
def test_hyp_research_team_collaboration_title_setter(instance):
    original = instance.title
    instance.title = original
    assert instance.title == original
...
@given(instance=research_team_Collaboration_strategy)
def test_hyp_research_team_collaboration_until_setter(instance):
...
@given(instance=research_team_Collaboration_strategy)
def test_hyp_research_team_collaboration_website_setter(instance):
    original = instance.website
    instance.website = original
    assert instance.website == original
...
def test_hyp_research_team_openposition_duration_setter(instance):
...
@given(instance=research_team_OpenPosition_strategy)
def test_hyp_research_team_openposition_status_setter(instance):
    original = instance.status
    instance.status = original
    assert instance.status == original
...
@given(instance=research_team_OpenPosition_strategy)
def test_hyp_research_team_openposition_mission_setter(instance):
...
def test_hyp_research_team_person_mail_setter(instance):
...
@given(instance=research_team_Person_strategy)
def test_hyp_research_team_person_firstname_setter(instance):
...
@given(instance=research_team_Person_strategy)
def test_hyp_research_team_person_phone_setter(instance):
...
@given(instance=research_team_Person_strategy)
def test_hyp_research_team_person_affiliation_setter(instance):
...
@given(instance=research_team_Person_strategy)
def test_hyp_research_team_person_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_research_team_team_urlPage_setter(instance):
...
@given(instance=research_team_Team_strategy)
def test_hyp_research_team_team_status_setter(instance):
    original = instance.status
    instance.status = original
    assert instance.status == original
...
@given(instance=research_team_Team_strategy)
def test_hyp_research_team_team_meaning_setter(instance):
...
@given(instance=research_team_Team_strategy)
def test_hyp_research_team_team_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
