...
def test_hyp_rel2rel_world_is_not_abstract():
    assert not inspect.isabstract(rel2rel_World)


def test_hyp_rel2rel_world_constructor_exists():
    assert callable(rel2rel_World.__init__)


def test_hyp_rel2rel_world_constructor_args():
...
def test_hyp_rel2rel_namedelement_is_not_abstract():
    assert not inspect.isabstract(rel2rel_NamedElement)


def test_hyp_rel2rel_namedelement_constructor_exists():
    assert callable(rel2rel_NamedElement.__init__)


def test_hyp_rel2rel_namedelement_constructor_args():
...
def test_hyp_rel2rel_relatedto_is_not_abstract():
    assert not inspect.isabstract(rel2rel_RelatedTo)


def test_hyp_rel2rel_relatedto_constructor_exists():
    assert callable(rel2rel_RelatedTo.__init__)


def test_hyp_rel2rel_relatedto_constructor_args():
...
def test_hyp_rel2rel_thing_is_not_abstract():
    assert not inspect.isabstract(rel2rel_Thing)


def test_hyp_rel2rel_thing_constructor_exists():
    assert callable(rel2rel_Thing.__init__)


def test_hyp_rel2rel_thing_constructor_args():
...
def test_hyp_rel2rel_namedelement_name_setter(instance):
...
def test_hyp_rel2rel_relatedto_since_setter(instance):
...
def test_hyp_rel2rel_thing_id_setter(instance):
