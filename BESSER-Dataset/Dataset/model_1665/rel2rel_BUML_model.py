...
# Classes
rel2rel_Thing = Class(name="rel2rel_Thing")
NamedElement = Class(name="NamedElement")
rel2rel_RelatedTo = Class(name="rel2rel_RelatedTo")
rel2rel_NamedElement = Class(name="rel2rel_NamedElement", is_abstract=True)
Thing = Class(name="Thing")
rel2rel_World = Class(name="rel2rel_World")
...
domain_model = DomainModel(
    name="rel2rel",
    types={rel2rel_Thing, NamedElement, rel2rel_RelatedTo, rel2rel_NamedElement, Thing, rel2rel_World},
