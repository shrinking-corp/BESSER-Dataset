...
Operating_System.attributes={Operating_System_PROC_BASE_REGISTER, Operating_System_memory, Operating_System_INSTRUCTION_REGISTER, Operating_System_PAGE_SIZE, Operating_System_PROC_DATA_POINTER, Operating_System_dispatcher, Operating_System_device, Operating_System_PROC_LIMIT_REGISTER, Operating_System_PROCESS_ID_REGISTER, Operating_System_taskManager, Operating_System_QUANTUM, Operating_System_clock, Operating_System_scheduler, Operating_System_prompt, Operating_System_NUMBER_OF_REGISTERS, Operating_System_MEMORY_SIZE, Operating_System_cpu, Operating_System_PROC_BASE_POINTER, Operating_System_hardDrive}
...
Scheduler.attributes={Scheduler_newQueue, Scheduler_ioQueue, Scheduler_identifier, Scheduler_readyQueue}
...
Prompt.attributes={Prompt_MAX_COMMAND_LENGTH, Prompt_commandLine, Prompt_OUTPUT_WIDTH, Prompt_output, Prompt_OUTPUT_HEIGHT, Prompt_FONT_SIZE, Prompt_queuePosition, Prompt_frameFont, Prompt_frame}
...
Page.attributes={Page_attribute, Page_owner, Page_free}
...
Process.attributes={Process_memoryUseage, Process_registers, Process_name, Process_processState}
...
ProcessData.attributes={ProcessData_memory, ProcessData_instructions, ProcessData_name, ProcessData_startTime}
...
ProgramFileData.attributes={ProgramFileData_instructions, ProgramFileData_name, ProgramFileData_memory}
...
Request.attributes={Request_processID, Request_endAddress, Request_startAddress}
...
JobFileData.attributes={JobFileData_startTimes, JobFileData_programs}
...
ProcessTableModel.attributes={ProcessTableModel_columnNames, ProcessTableModel_numberProcesses, ProcessTableModel_processList}
...
Task_Manager.attributes={Task_Manager_scrollPane, Task_Manager_amountofUsedMemory, Task_Manager_contactTable, Task_Manager_amountofFreeMemory, Task_Manager_numberOfProcesses}
...
domain_model = DomainModel(
    name="b232482d_3d04_41b8_8ec6_b13539c0c20b",
    types={Operating_System, Clock, CPU, Dispatcher, Memory, Scheduler, IO_Device, Hard_Drive, Prompt, Class_, Interrupter_Interface, Page, Object, Process, ProcessData, ProgramFileData, JFrame, JTextField, Font, JTextArea, JTable, JScrollPane, JLabel, Request, JobFileData, ArrayList_ProgramFileData_, Instruction_Out, Instruction_Calculate, Instruction_IO, Instruction_Exit, Instruction_Instruction_Interface, Instruction_Yield, Instruction_DecrementPointer, Instruction_CloseBracket, Instruction_DecrementValue, Instruction_IncrementPointer, Instruction_IncrementValue, Instruction_OpenBracket, Instruction_Print, Main, ProcessTableModel, AbstractTableModel, Task_Manager, ArrayList_Interrupter_, ProcessState, Memory__, Page__, ArrayList_Instruction_, ArrayList_Integer_, ArrayList_ProcessData_},
    associations={Yield_Operating_System, IO_Operating_System, IO_Process, Exit_Operating_System, Exit_Process, Calculate_Operating_System, Out_Operating_System, ProcessTableModel_Operating_System, ProcessTableModel_Process, Operating_System_Prompt, Operating_System_Task_Manager, Task_Manager_Process, Operating_System_Main, Operating_System_Clock, Operating_System_CPU, Operating_System_Dispatcher, Operating_System_Memory, Operating_System_Scheduler, Instruction_ProcessData, Operating_System_IO_Device, Operating_System_Hard_Drive, Page_Process, ProgramFileData_Instruction, JobFileData_ProgramFileData, Hard_Drive_Request, Memory_Page},
    generalizations={},
    metadata=None
)
