...
domainmodel_PackageDec = Class(name="domainmodel_PackageDec")
...
domain_model = DomainModel(
    name="domainmodel",
    types={domainmodel_Domainmodel, domainmodel_AbstractElement, domainmodel_PackageDec, AbstractElement, domainmodel_Import, domainmodel_Type, domainmodel_DataType, Type, domainmodel_Entity, domainmodel_Feature},
    associations={elements0, element1, superType4, features5, type7},
    generalizations={gen_domainmodel_PackageDec_AbstractElement, gen_domainmodel_Import_AbstractElement, gen_domainmodel_Type_AbstractElement, gen_domainmodel_DataType_Type, gen_domainmodel_Entity_Type},
    metadata=None
)
