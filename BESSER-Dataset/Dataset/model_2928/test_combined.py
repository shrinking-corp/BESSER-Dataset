...
def test_hyp_domainmodel_packagedec_is_not_abstract():
    assert not inspect.isabstract(domainmodel_PackageDec)


def test_hyp_domainmodel_packagedec_constructor_exists():
    assert callable(domainmodel_PackageDec.__init__)


def test_hyp_domainmodel_packagedec_constructor_args():
...
def test_hyp_domainmodel_packagedec_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_domainmodel_PackageDec_name_value_roundtrip():
    instance = domainmodel_PackageDec(name="sample_text")
    assert instance.name == "sample_text"
    instance.name = "sample_text_2"
    assert instance.name == "sample_text_2"
...
def test_domainmodel_PackageDec_isa_AbstractElement():
    instance = domainmodel_PackageDec(name="sample_text")
    assert isinstance(instance, AbstractElement)
...
def test_assoc_element1_link_reassign_clear():
    a = domainmodel_PackageDec(name="sample_text")
    b1 = domainmodel_AbstractElement()
    b2 = domainmodel_AbstractElement()
    _safe_set(a, 'domainmodel_PackageDec', {b1})
    assert _is_linked(a, 'domainmodel_PackageDec', b1)
    if hasattr(b1, 'domainmodel_AbstractElement2'):
        assert _is_linked(b1, 'domainmodel_AbstractElement2', a)
    _safe_set(a, 'domainmodel_PackageDec', {b2})
    assert _is_linked(a, 'domainmodel_PackageDec', b2)
    if hasattr(b1, 'domainmodel_AbstractElement2'):
    ...
    _safe_set(a, 'domainmodel_PackageDec', set())
    assert not _is_linked(a, 'domainmodel_PackageDec', b2)
    if hasattr(b2, 'domainmodel_AbstractElement2'):
...
domainmodel_PackageDec_strategy = st.builds(domainmodel_PackageDec, name=safe_text)
@given(instance=domainmodel_PackageDec_strategy)
@settings(max_examples=25)
