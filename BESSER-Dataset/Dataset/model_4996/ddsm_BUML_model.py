...
ddsm_StormSupervisor = Class(name="ddsm_StormSupervisor")
...
ddsm_Kafka = Class(name="ddsm_Kafka")
ddsm_Cluster = Class(name="ddsm_Cluster")
ddsm_ClientNode = Class(name="ddsm_ClientNode")
ddsm_YarnResourceManager = Class(name="ddsm_YarnResourceManager")
ddsm_YarnNodeManager = Class(name="ddsm_YarnNodeManager")
ddsm_StormNimbus = Class(name="ddsm_StormNimbus")
ddsm_Zookeeper = Class(name="ddsm_Zookeeper")
ddsm_HDFSNameNode = Class(name="ddsm_HDFSNameNode")
ddsm_HDFSDataNode = Class(name="ddsm_HDFSDataNode")
ddsm_ChefResource = Class(name="ddsm_ChefResource")
...
ddsm_Resource.attributes={ddsm_Resource_configureCommand, ddsm_Resource_installCommand, ddsm_Resource_downloadCommand, ddsm_Resource_resourceId, ddsm_Resource_startCommand, ddsm_Resource_stopCommand, ddsm_Resource_createCommand}
...
ddsm_StormSupervisor.attributes={ddsm_StormSupervisor_workerStartTimeout, ddsm_StormSupervisor_memoryCapacity, ddsm_StormSupervisor_cpuCapacity, ddsm_StormSupervisor_heartbeatFrequency}
...
ddsm_ExternalComponent.attributes={ddsm_ExternalComponent_password, ddsm_ExternalComponent_location, ddsm_ExternalComponent_region, ddsm_ExternalComponent_serviceType, ddsm_ExternalComponent_login}
...
ddsm_Provider.attributes={ddsm_Provider_type, ddsm_Provider_credentialsPath}
...
ddsm_VM.attributes={ddsm_VM_securityGroup, ddsm_VM_is64os, ddsm_VM_imageId, ddsm_VM_minCores, ddsm_VM_publicAddress, ddsm_VM_publicPorts, ddsm_VM_maxRam, ddsm_VM_minRam, ddsm_VM_privateKey, ddsm_VM_maxStorage, ddsm_VM_minStorage, ddsm_VM_instances, ddsm_VM_genericSize, ddsm_VM_os, ddsm_VM_sshKey, ddsm_VM_providerSpecificTypeName, ddsm_VM_maxCores}
...
ddsm_ClientNode.attributes={ddsm_ClientNode_artifactUrl, ddsm_ClientNode_type, ddsm_ClientNode_mainClass}
...
ddsm_StormNimbus.attributes={ddsm_StormNimbus_retryInterval, ddsm_StormNimbus_supervisorTimeout, ddsm_StormNimbus_monitorFrequency, ddsm_StormNimbus_taskTimeout, ddsm_StormNimbus_queueSize, ddsm_StormNimbus_retryTimes}
...
domain_model = DomainModel(
    name="ddsm",
    types={ddsm_Component, CloudElement, ddsm_ProvidedPort, ddsm_ProvidedExecutionPlatform, ddsm_CloudElement, ddsm_Resource, ddsm_Property, ExecutionPlatform, ddsm_Relationship, ddsm_ExecutionBinding, ddsm_InternalComponent, Component, ddsm_RequiredPort, ddsm_RequiredExecutionPlatform, ddsm_ExecutionPlatform, ddsm_Port, Port, ddsm_DDSM, ddsm_StormSupervisor, InternalComponent, ddsm_ExternalComponent, ddsm_Provider, ddsm_VM, ExternalComponent, ddsm_Kafka, ddsm_Cluster, ddsm_ClientNode, ddsm_YarnResourceManager, ddsm_YarnNodeManager, ddsm_StormNimbus, ddsm_Zookeeper, ddsm_HDFSNameNode, ddsm_HDFSDataNode, ddsm_ChefResource, Resource, ddsm_StormCluster, Cluster, VMSize, ProviderType},
    associations={providedport3, providedexecutionplatform4, resource0, property1, owner12, owner15, providedport18, requiredport20, requiredexecutionplatform23, requiredport6, internalcomponent8, requiredexecutionplatform10, cloudelement29, properties31, resources34, providedexecutionplatform25, provider28, hasVm37},
    generalizations={gen_ddsm_Component_CloudElement, gen_ddsm_RequiredExecutionPlatform_ExecutionPlatform, gen_ddsm_ProvidedExecutionPlatform_ExecutionPlatform, gen_ddsm_Relationship_CloudElement, gen_ddsm_ExecutionBinding_CloudElement, gen_ddsm_InternalComponent_Component, gen_ddsm_ExecutionPlatform_CloudElement, gen_ddsm_Port_CloudElement, gen_ddsm_RequiredPort_Port, gen_ddsm_ProvidedPort_Port, gen_ddsm_StormSupervisor_InternalComponent, gen_ddsm_ExternalComponent_Component, gen_ddsm_Provider_CloudElement, gen_ddsm_VM_ExternalComponent, gen_ddsm_Kafka_InternalComponent, gen_ddsm_Cluster_ExternalComponent, gen_ddsm_ClientNode_InternalComponent, gen_ddsm_YarnResourceManager_InternalComponent, gen_ddsm_YarnNodeManager_InternalComponent, gen_ddsm_StormNimbus_InternalComponent, gen_ddsm_Zookeeper_InternalComponent, gen_ddsm_HDFSNameNode_InternalComponent, gen_ddsm_HDFSDataNode_InternalComponent, gen_ddsm_ChefResource_Resource, gen_ddsm_StormCluster_Cluster},
    metadata=None
)
