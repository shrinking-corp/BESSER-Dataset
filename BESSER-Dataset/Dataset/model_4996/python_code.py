...
class ddsm_VM(ExternalComponent):
    ...
    def __init__(self, providerSpecificTypeName: str, securityGroup: str, sshKey: str, publicAddress: str, instances: str, genericSize: str, publicPorts: str, is64os: str, imageId: str, maxCores: str, maxRam: str, maxStorage: str, minCores: str, minRam: str, minStorage: str, os: str, privateKey: str, ddsm_VM: "ddsm_Cluster" = None):
...
class ddsm_RequiredPort(Port):
    ...
    def __init__(self, isMandatory: bool, ddsm_RequiredPort22: "ddsm_Relationship" = None, ddsm_RequiredPort: "ddsm_InternalComponent" = None):
...
class ddsm_RequiredExecutionPlatform(ExecutionPlatform):
    ...
    def __init__(self, isMandatory: bool, ddsm_RequiredExecutionPlatform24: "ddsm_ExecutionBinding" = None, ddsm_RequiredExecutionPlatform: "ddsm_InternalComponent" = None):
        self.isMandatory = isMandatory
...
class ddsm_Property:
    ...
    def __init__(self, value: str, propertyId: str, ddsm_Property: "ddsm_CloudElement" = None, ddsm_Property33: "ddsm_DDSM" = None):
        self.value = value
...
class ddsm_Resource:
    ...
    def __init__(self, resourceId: str, downloadCommand: str, createCommand: str, configureCommand: str, installCommand: str, startCommand: str, stopCommand: str, ddsm_Resource: "ddsm_CloudElement" = None, ddsm_Resource36: "ddsm_DDSM" = None):
