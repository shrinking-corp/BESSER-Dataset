...
Activity.attributes={Activity_ActivityID, Activity_NewValue, Activity_Seen, Activity_PrevValue, Activity_User, Activity_ActivityType, Activity_ActivitySubType, Activity_Project}
...
Comment.attributes={Comment_CommentID, Comment_Content, Comment_Project, Comment_Created, Comment_User}
...
Attachment.attributes={Attachment_AttachmentID, Attachment_Extension, Attachment_User, Attachment_Created, Attachment_Project, Attachment_Size, Attachment_Path, Attachment_Name}
...
Role.attributes={Role_Name, Role_descripcion, Role_nombre}
...
ChatService.attributes={ChatService_attribute3, ChatService_attribute2, ChatService_attribute, ChatService_salasCollection, ChatService_itemsCollection, ChatService_usuario}
...
RoomService.attributes={RoomService_idiomas, RoomService_itemsCollection, RoomService_roomsCollection, RoomService_niveles}
...
SpeechRecognitionService.attributes={SpeechRecognitionService_grabando, SpeechRecognitionService__attr, SpeechRecognitionService_speechRecognition}
...
AuthenticationService.attributes={AuthenticationService_user, AuthenticationService_authState, AuthenticationService_attribute2, AuthenticationService_attribute, AuthenticationService_attribute3, AuthenticationService_attribute4, AuthenticationService_role}
...
domain_model = DomainModel(
    name="_20f8f7d4_955e_4c39_a26d_ec41f3c19c26",
