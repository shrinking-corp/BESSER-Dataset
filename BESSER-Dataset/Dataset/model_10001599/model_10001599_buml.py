...
domain_model = DomainModel(
    name="_IQ0YMLw_EeedTfUoC_GfaA",
    types={MyInterface_Interface, MyClass, MyClass2, MyClass3, MyClass4, MyClass5, MyClass6, MyClass7, MyClass8, MyClass9, MyClass10, MyClass11, MyClass12, MyClass13, MyClass14, MyClass15, MyClass16, MyClass17, MyClass18},
    associations={},
    generalizations={},
    metadata=None
)
