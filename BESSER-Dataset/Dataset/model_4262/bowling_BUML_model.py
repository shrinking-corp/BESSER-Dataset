...
bowling_SpecialPlayer = Class(name="bowling_SpecialPlayer")
...
bowling_Player.attributes={bowling_Player_height, bowling_Player_name, bowling_Player_dateOfBirth, bowling_Player_isProfessional}
...
domain_model = DomainModel(
    name="bowling",
    types={bowling_League, bowling_Tournament, bowling_Matchup, bowling_Game, bowling_SpecialPlayer, Player, bowling_Player, TournamentType},
