...
def test_hyp_assessment_notes_is_not_abstract():
    assert not inspect.isabstract(assessment_Notes)


def test_hyp_assessment_notes_constructor_exists():
    assert callable(assessment_Notes.__init__)


def test_hyp_assessment_notes_constructor_args():
...
def test_hyp_assessment_graph_is_not_abstract():
    assert not inspect.isabstract(assessment_Graph)


def test_hyp_assessment_graph_constructor_exists():
    assert callable(assessment_Graph.__init__)


def test_hyp_assessment_graph_constructor_args():
    sig = inspect.signature(assessment_Graph.__init__)
    params = list(sig.parameters.keys())



def test_hyp_assessment_url_is_not_abstract():
    assert not inspect.isabstract(assessment_Url)


def test_hyp_assessment_url_constructor_exists():
    assert callable(assessment_Url.__init__)


def test_hyp_assessment_url_constructor_args():
...
def test_hyp_contents_is_not_abstract():
    assert not inspect.isabstract(Contents)


def test_hyp_contents_constructor_exists():
    assert callable(Contents.__init__)


def test_hyp_contents_constructor_args():
    sig = inspect.signature(Contents.__init__)
    params = list(sig.parameters.keys())



def test_hyp_assessment_contents_is_not_abstract():
    assert not inspect.isabstract(assessment_Contents)


def test_hyp_assessment_contents_constructor_exists():
    assert callable(assessment_Contents.__init__)


def test_hyp_assessment_contents_constructor_args():
...
def test_hyp_assessment_label_is_not_abstract():
    assert not inspect.isabstract(assessment_Label)


def test_hyp_assessment_label_constructor_exists():
    assert callable(assessment_Label.__init__)


def test_hyp_assessment_label_constructor_args():
...
def test_hyp_assessment_view_is_not_abstract():
    assert not inspect.isabstract(assessment_View)


def test_hyp_assessment_view_constructor_exists():
    assert callable(assessment_View.__init__)


def test_hyp_assessment_view_constructor_args():
    sig = inspect.signature(assessment_View.__init__)
    params = list(sig.parameters.keys())



def test_hyp_assessment_controller_is_not_abstract():
    assert not inspect.isabstract(assessment_Controller)


def test_hyp_assessment_controller_constructor_exists():
    assert callable(assessment_Controller.__init__)


def test_hyp_assessment_controller_constructor_args():
    sig = inspect.signature(assessment_Controller.__init__)
    params = list(sig.parameters.keys())



def test_hyp_assessment_model_is_not_abstract():
    assert not inspect.isabstract(assessment_Model)


def test_hyp_assessment_model_constructor_exists():
    assert callable(assessment_Model.__init__)


def test_hyp_assessment_model_constructor_args():
    sig = inspect.signature(assessment_Model.__init__)
    params = list(sig.parameters.keys())



def test_hyp_assessment_sink_is_not_abstract():
    assert not inspect.isabstract(assessment_Sink)


def test_hyp_assessment_sink_constructor_exists():
    assert callable(assessment_Sink.__init__)


def test_hyp_assessment_sink_constructor_args():
...
def test_hyp_assessment_resources_is_not_abstract():
    assert not inspect.isabstract(assessment_Resources)


def test_hyp_assessment_resources_constructor_exists():
    assert callable(assessment_Resources.__init__)


def test_hyp_assessment_resources_constructor_args():
    sig = inspect.signature(assessment_Resources.__init__)
    params = list(sig.parameters.keys())



def test_hyp_assessment_sinks_is_not_abstract():
    assert not inspect.isabstract(assessment_Sinks)


def test_hyp_assessment_sinks_constructor_exists():
    assert callable(assessment_Sinks.__init__)


def test_hyp_assessment_sinks_constructor_args():
    sig = inspect.signature(assessment_Sinks.__init__)
    params = list(sig.parameters.keys())



def test_hyp_assessment_entitlement_is_not_abstract():
    assert not inspect.isabstract(assessment_Entitlement)


def test_hyp_assessment_entitlement_constructor_exists():
    assert callable(assessment_Entitlement.__init__)


def test_hyp_assessment_entitlement_constructor_args():
    sig = inspect.signature(assessment_Entitlement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_assessment_account_is_not_abstract():
    assert not inspect.isabstract(assessment_Account)


def test_hyp_assessment_account_constructor_exists():
    assert callable(assessment_Account.__init__)


def test_hyp_assessment_account_constructor_args():
...
def test_hyp_assessment_applications_is_not_abstract():
    assert not inspect.isabstract(assessment_Applications)


def test_hyp_assessment_applications_constructor_exists():
    assert callable(assessment_Applications.__init__)


def test_hyp_assessment_applications_constructor_args():
    sig = inspect.signature(assessment_Applications.__init__)
    params = list(sig.parameters.keys())



def test_hyp_assessment_graphnode_is_not_abstract():
    assert not inspect.isabstract(assessment_GraphNode)


def test_hyp_assessment_graphnode_constructor_exists():
    assert callable(assessment_GraphNode.__init__)


def test_hyp_assessment_graphnode_constructor_args():
    sig = inspect.signature(assessment_GraphNode.__init__)
    params = list(sig.parameters.keys())



def test_hyp_notes_is_not_abstract():
    assert not inspect.isabstract(Notes)


def test_hyp_notes_constructor_exists():
    assert callable(Notes.__init__)


def test_hyp_notes_constructor_args():
...
def test_hyp_assessment_finding_is_not_abstract():
    assert not inspect.isabstract(assessment_Finding)


def test_hyp_assessment_finding_constructor_exists():
    assert callable(assessment_Finding.__init__)


def test_hyp_assessment_finding_constructor_args():
...
def test_hyp_assessment_assessment_is_not_abstract():
    assert not inspect.isabstract(assessment_Assessment)


def test_hyp_assessment_assessment_constructor_exists():
    assert callable(assessment_Assessment.__init__)


def test_hyp_assessment_assessment_constructor_args():
    sig = inspect.signature(assessment_Assessment.__init__)
    params = list(sig.parameters.keys())



def test_hyp_assessment_resource_is_not_abstract():
    assert not inspect.isabstract(assessment_Resource)


def test_hyp_assessment_resource_constructor_exists():
    assert callable(assessment_Resource.__init__)


def test_hyp_assessment_resource_constructor_args():
    sig = inspect.signature(assessment_Resource.__init__)
    params = list(sig.parameters.keys())



def test_hyp_assessment_task_is_not_abstract():
    assert not inspect.isabstract(assessment_Task)


def test_hyp_assessment_task_constructor_exists():
    assert callable(assessment_Task.__init__)


def test_hyp_assessment_task_constructor_args():
...
def test_hyp_assessment_node_is_not_abstract():
    assert not inspect.isabstract(assessment_Node)


def test_hyp_assessment_node_constructor_exists():
    assert callable(assessment_Node.__init__)


def test_hyp_assessment_node_constructor_args():
...
def test_hyp_assessment_snippet_is_not_abstract():
    assert not inspect.isabstract(assessment_Snippet)


def test_hyp_assessment_snippet_constructor_exists():
    assert callable(assessment_Snippet.__init__)


def test_hyp_assessment_snippet_constructor_args():
...
def test_hyp_assessment_generic_is_not_abstract():
    assert not inspect.isabstract(assessment_Generic)


def test_hyp_assessment_generic_constructor_exists():
    assert callable(assessment_Generic.__init__)


def test_hyp_assessment_generic_constructor_args():
    sig = inspect.signature(assessment_Generic.__init__)
    params = list(sig.parameters.keys())



def test_hyp_assessment_control_is_not_abstract():
    assert not inspect.isabstract(assessment_Control)


def test_hyp_assessment_control_constructor_exists():
    assert callable(assessment_Control.__init__)


def test_hyp_assessment_control_constructor_args():
    sig = inspect.signature(assessment_Control.__init__)
    params = list(sig.parameters.keys())



def test_hyp_assessment_http_is_not_abstract():
    assert not inspect.isabstract(assessment_Http)


def test_hyp_assessment_http_constructor_exists():
    assert callable(assessment_Http.__init__)


def test_hyp_assessment_http_constructor_args():
...
def test_hyp_assessment_views_is_not_abstract():
    assert not inspect.isabstract(assessment_Views)


def test_hyp_assessment_views_constructor_exists():
    assert callable(assessment_Views.__init__)


def test_hyp_assessment_views_constructor_args():
    sig = inspect.signature(assessment_Views.__init__)
    params = list(sig.parameters.keys())



def test_hyp_assessment_scm_is_not_abstract():
    assert not inspect.isabstract(assessment_Scm)


def test_hyp_assessment_scm_constructor_exists():
    assert callable(assessment_Scm.__init__)


def test_hyp_assessment_scm_constructor_args():
...
def test_hyp_assessment_models_is_not_abstract():
    assert not inspect.isabstract(assessment_Models)


def test_hyp_assessment_models_constructor_exists():
    assert callable(assessment_Models.__init__)


def test_hyp_assessment_models_constructor_args():
    sig = inspect.signature(assessment_Models.__init__)
    params = list(sig.parameters.keys())



def test_hyp_assessment_controllers_is_not_abstract():
    assert not inspect.isabstract(assessment_Controllers)


def test_hyp_assessment_controllers_constructor_exists():
    assert callable(assessment_Controllers.__init__)


def test_hyp_assessment_controllers_constructor_args():
    sig = inspect.signature(assessment_Controllers.__init__)
    params = list(sig.parameters.keys())



def test_hyp_assessment_entitlements_is_not_abstract():
    assert not inspect.isabstract(assessment_Entitlements)


def test_hyp_assessment_entitlements_constructor_exists():
    assert callable(assessment_Entitlements.__init__)


def test_hyp_assessment_entitlements_constructor_args():
    sig = inspect.signature(assessment_Entitlements.__init__)
    params = list(sig.parameters.keys())



def test_hyp_assessment_accounts_is_not_abstract():
    assert not inspect.isabstract(assessment_Accounts)


def test_hyp_assessment_accounts_constructor_exists():
    assert callable(assessment_Accounts.__init__)


def test_hyp_assessment_accounts_constructor_args():
    sig = inspect.signature(assessment_Accounts.__init__)
    params = list(sig.parameters.keys())



def test_hyp_assessment_application_is_not_abstract():
    assert not inspect.isabstract(assessment_Application)


def test_hyp_assessment_application_constructor_exists():
    assert callable(assessment_Application.__init__)


def test_hyp_assessment_application_constructor_args():
...
def test_hyp_assessment_tasks_is_not_abstract():
    assert not inspect.isabstract(assessment_Tasks)


def test_hyp_assessment_tasks_constructor_exists():
    assert callable(assessment_Tasks.__init__)


def test_hyp_assessment_tasks_constructor_args():
    sig = inspect.signature(assessment_Tasks.__init__)
    params = list(sig.parameters.keys())



def test_hyp_assessment_findings_is_not_abstract():
    assert not inspect.isabstract(assessment_Findings)


def test_hyp_assessment_findings_constructor_exists():
    assert callable(assessment_Findings.__init__)


def test_hyp_assessment_findings_constructor_args():
...
def test_hyp_taskstatus_exists():
    # Check that the Enumeration exists
    assert TaskStatus is not None

def test_hyp_taskstatus_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_urlpattern_exists():
    # Check that the Enumeration exists
    assert UrlPattern is not None

def test_hyp_urlpattern_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_assessment_notes_notes_setter(instance):
...
def test_hyp_assessment_url_patternType_setter(instance):
...
@given(instance=assessment_Url_strategy)
def test_hyp_assessment_url_pattern_setter(instance):
...
def test_hyp_assessment_contents_contents_setter(instance):
...
def test_hyp_assessment_label_label_setter(instance):
...
def test_hyp_assessment_sink_cwes_setter(instance):
...
def test_hyp_assessment_account_password_setter(instance):
...
@given(instance=assessment_Account_strategy)
def test_hyp_assessment_account_email_setter(instance):
...
def test_hyp_assessment_finding_references_setter(instance):
...
@given(instance=assessment_Finding_strategy)
def test_hyp_assessment_finding_remediation_setter(instance):
...
@given(instance=assessment_Finding_strategy)
def test_hyp_assessment_finding_reproducer_setter(instance):
...
def test_hyp_assessment_task_status_setter(instance):
...
def test_hyp_assessment_snippet_lineEnd_setter(instance):
...
@given(instance=assessment_Snippet_strategy)
def test_hyp_assessment_snippet_columnStart_setter(instance):
...
@given(instance=assessment_Snippet_strategy)
def test_hyp_assessment_snippet_columnEnd_setter(instance):
...
@given(instance=assessment_Snippet_strategy)
def test_hyp_assessment_snippet_lineStart_setter(instance):
...
def test_hyp_assessment_http_response_setter(instance):
...
@given(instance=assessment_Http_strategy)
def test_hyp_assessment_http_request_setter(instance):
...
def test_hyp_assessment_scm_repository_setter(instance):
...
@given(instance=assessment_Scm_strategy)
def test_hyp_assessment_scm_branchTag_setter(instance):
...
def test_hyp_assessment_application_externalURL_setter(instance):
...
@given(instance=assessment_Application_strategy)
def test_hyp_assessment_application_internalURL_setter(instance):
