...
reqLanguage_State.attributes={reqLanguage_State_state, reqLanguage_State_name}
...
reqLanguage_Function.attributes={reqLanguage_Function_function, reqLanguage_Function_name, reqLanguage_Function_type}
...
domain_model = DomainModel(
    name="reqLanguage",
    types={reqLanguage_Model, reqLanguage_Requirement, reqLanguage_ReqID, reqLanguage_Prefix, reqLanguage_EObject, reqLanguage_PrefixRightOperand, reqLanguage_PrefixState, reqLanguage_PrefixCondition, reqLanguage_Operator, reqLanguage_Value, reqLanguage_PrefixEvent, reqLanguage_ParamEvent, reqLanguage_ActorEvent, reqLanguage_Parameter, reqLanguage_StateEvent, reqLanguage_System, reqLanguage_State, reqLanguage_ParameterState, reqLanguage_TimingConstraint, reqLanguage_MainFunction, reqLanguage_Action, reqLanguage_MainComposition, reqLanguage_MainStateTransition, reqLanguage_MainAttributes, reqLanguage_MainFunctions, reqLanguage_Function, reqLanguage_Transition, reqLanguage_OutTransition, reqLanguage_NoTransition, reqLanguage_Actor, reqLanguage_Attribute, reqLanguage_User, reqLanguage_Time},
    associations={requirements0, reqID1, prefix3, mainRequirement5, leftOperand7, prefixList10, prefixRightOperand12, stateExpression15, parameter17, operator19, value21, event_expression25, parameter27, value29, actor32, entity34, system36, state37, time23, parameter_value41, system44, function46, system48, subsystemList50, system53, transition55, function58, system61, parameter39, system65, functionList67, source_state69, target_state71, source_state74, state76, attributeList63, parameter78, value81, subject84, time87},
    generalizations={},
    metadata=None
)
