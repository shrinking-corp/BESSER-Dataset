...
# Classes
helloWeb_RecordedFlight = Class(name="helloWeb_RecordedFlight")
helloWeb_Program = Class(name="helloWeb_Program")
helloWeb_Main = Class(name="helloWeb_Main")
helloWeb_SuperCommand = Class(name="helloWeb_SuperCommand")
helloWeb_UserFunction = Class(name="helloWeb_UserFunction")
helloWeb_Command = Class(name="helloWeb_Command")
helloWeb_FeatureMatch = Class(name="helloWeb_FeatureMatch")
SuperCommand = Class(name="SuperCommand")
helloWeb_Snapshot = Class(name="helloWeb_Snapshot")
Command = Class(name="Command")
helloWeb_Up = Class(name="helloWeb_Up")
helloWeb_Down = Class(name="helloWeb_Down")
helloWeb_Left = Class(name="helloWeb_Left")
helloWeb_Right = Class(name="helloWeb_Right")
helloWeb_Forward = Class(name="helloWeb_Forward")
helloWeb_Backward = Class(name="helloWeb_Backward")
helloWeb_RotateL = Class(name="helloWeb_RotateL")
helloWeb_RotateR = Class(name="helloWeb_RotateR")
helloWeb_Wait = Class(name="helloWeb_Wait")
helloWeb_FunctionName = Class(name="helloWeb_FunctionName")
...
domain_model = DomainModel(
    name="helloWeb",
    types={helloWeb_RecordedFlight, helloWeb_Program, helloWeb_Main, helloWeb_SuperCommand, helloWeb_UserFunction, helloWeb_Command, helloWeb_FeatureMatch, SuperCommand, helloWeb_Snapshot, Command, helloWeb_Up, helloWeb_Down, helloWeb_Left, helloWeb_Right, helloWeb_Forward, helloWeb_Backward, helloWeb_RotateL, helloWeb_RotateR, helloWeb_Wait, helloWeb_FunctionName},
    associations={main0, commands1, func3},
