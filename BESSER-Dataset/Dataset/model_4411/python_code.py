...
class arduino_IntegerVariable(IntegerExpression, Variable):
...
class arduino_BooleanModuleGet(BooleanExpression, ModuleGet):
    ...
    pass
class arduino_BooleanVariable(BooleanExpression, Variable):
...
class arduino_Sketch(Instruction, NamedElement):
    ...
    pass
class arduino_Variable(Expression, NamedElement):

    pass
class arduino_Module(NamedElement):

    def __init__(self, kind: str, image: str, level: bool, library: str, arduino_Module: "arduino_Hardware" = None, arduino_Module17: "arduino_Project" = None, arduino_Module41: "arduino_Connector" = None, arduino_Module43: "arduino_ModuleGet" = None, arduino_Module34: "arduino_ModuleInstruction" = None):
        self.kind = kind
        self.image = image
        self.level = level
...
class arduino_Instruction(NamedElement):
    ...
    def __init__(self, arduino_Instruction26: "arduino_Instruction" = None, arduino_Instruction24: "arduino_Instruction" = None, arduino_Instruction29: "arduino_Instruction" = None, arduino_Instruction27: "arduino_Instruction" = None, arduino_Instruction: "arduino_Sketch" = None, arduino_Instruction32: "arduino_Instruction" = None, arduino_Instruction30: "arduino_Instruction" = None, arduino_Instruction36: "arduino_Control" = None):
...
class arduino_Platform(NamedElement):
    ...
    def __init__(self, image: str, arduino_Platform: "arduino_Hardware" = None, arduino_Platform6: set["arduino_DigitalPin"] = None, arduino_Platform8: set["arduino_AnalogPin"] = None, arduino_Platform20: "arduino_Project" = None):
        self.image = image
