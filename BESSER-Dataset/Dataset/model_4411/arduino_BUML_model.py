...
arduino_VariableRef = Class(name="arduino_VariableRef")
arduino_Synchro = Class(name="arduino_Synchro")
...
arduino_InstantaneousInstruction = Class(name="arduino_InstantaneousInstruction", is_abstract=True)
...
arduino_Module.attributes={arduino_Module_level, arduino_Module_image, arduino_Module_library, arduino_Module_kind}
...
domain_model = DomainModel(
    name="arduino",
    types={arduino_Hardware, NamedElement, arduino_Platform, arduino_Module, arduino_Connector, arduino_DigitalPin, arduino_AnalogPin, arduino_Project, Pin, arduino_Pin, arduino_Sketch, Instruction, arduino_Instruction, arduino_Sensor, Module, arduino_Actuator, arduino_NamedElement, arduino_Repeat, Control, arduino_ModuleGet, Expression, arduino_While, arduino_Expression, arduino_ModuleAssignment, ModuleInstruction, Assignment, arduino_ModuleInstruction, arduino_Control, arduino_Utilities, arduino_Delay, Utilities, arduino_BinaryBooleanExpression, BooleanExpression, arduino_Constant, arduino_If, arduino_IntegerConstant, Constant, arduino_BooleanConstant, arduino_BooleanExpression, arduino_IntegerExpression, arduino_Assignment, arduino_BinaryExpression, arduino_Variable, arduino_VariableAssignment, arduino_BinaryIntegerExpression, BinaryExpression, IntegerExpression, arduino_UnaryExpression, arduino_UnaryBooleanExpression, UnaryExpression, arduino_UnaryIntegerExpression, arduino_VariableDeclaration, arduino_VariableRef, arduino_Synchro, InstantaneousInstruction, arduino_IntegerVariable, Variable, arduino_BooleanVariable, arduino_BooleanModuleGet, ModuleGet, arduino_IntegerModuleGet, arduino_InstantaneousInstruction, ModuleKind, Time, Library, BinaryIntegerOperatorKind, UnaryBooleanOperatorKind, BinaryBooleanOperatorKind, UnaryIntegerOperatorKind},
    associations={platforms0, modules1, connectors3, digitalPins5, analogPins7, hardware13, modules15, platform18, sketchs21, previous25, next28, hardware9, instructions11, pin37, module39, module42, condition44, dependency31, module33, instructions35, condition51, left45, right47, variable50, operand55, variable57, variable59, operand53, synchro62, synchroeOpposite64},
    generalizations={gen_arduino_Hardware_NamedElement, gen_arduino_Platform_NamedElement, gen_arduino_Instruction_NamedElement, gen_arduino_Module_NamedElement, gen_arduino_DigitalPin_Pin, gen_arduino_AnalogPin_Pin, gen_arduino_Sketch_NamedElement, gen_arduino_Sketch_Instruction, gen_arduino_Sensor_Module, gen_arduino_Actuator_Module, gen_arduino_Repeat_Control, gen_arduino_ModuleGet_Expression, gen_arduino_While_Control, gen_arduino_ModuleAssignment_ModuleInstruction, gen_arduino_ModuleAssignment_Assignment, gen_arduino_ModuleInstruction_Instruction, gen_arduino_Control_Instruction, gen_arduino_Utilities_Instruction, gen_arduino_Delay_Utilities, gen_arduino_BinaryBooleanExpression_BinaryExpression, gen_arduino_BinaryBooleanExpression_BooleanExpression, gen_arduino_Constant_Expression, gen_arduino_If_Control, gen_arduino_IntegerConstant_Constant, gen_arduino_IntegerConstant_IntegerExpression, gen_arduino_BooleanConstant_Constant, gen_arduino_BooleanConstant_BooleanExpression, gen_arduino_BooleanExpression_Expression, gen_arduino_IntegerExpression_Expression, gen_arduino_Assignment_Instruction, gen_arduino_BinaryExpression_Expression, gen_arduino_Variable_Expression, gen_arduino_Variable_NamedElement, gen_arduino_VariableAssignment_Instruction, gen_arduino_VariableAssignment_Assignment, gen_arduino_BinaryIntegerExpression_BinaryExpression, gen_arduino_BinaryIntegerExpression_IntegerExpression, gen_arduino_UnaryExpression_Expression, gen_arduino_UnaryBooleanExpression_UnaryExpression, gen_arduino_UnaryBooleanExpression_BooleanExpression, gen_arduino_UnaryIntegerExpression_UnaryExpression, gen_arduino_UnaryIntegerExpression_IntegerExpression, gen_arduino_VariableDeclaration_Instruction, gen_arduino_VariableRef_Expression, gen_arduino_Synchro_InstantaneousInstruction, gen_arduino_IntegerVariable_Variable, gen_arduino_IntegerVariable_IntegerExpression, gen_arduino_BooleanVariable_Variable, gen_arduino_BooleanVariable_BooleanExpression, gen_arduino_BooleanModuleGet_ModuleGet, gen_arduino_BooleanModuleGet_BooleanExpression, gen_arduino_IntegerModuleGet_ModuleGet, gen_arduino_IntegerModuleGet_IntegerExpression, gen_arduino_InstantaneousInstruction_Instruction},
    metadata=None
)
