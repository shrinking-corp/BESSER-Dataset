...
class aggregator_p2view_Category(IUPresentation):
    ...
    def __init__(self, aggregator_p2view_Category101: "Products" = None, aggregator_p2view_Category104: "Bundles" = None, aggregator_p2view_Category107: "Fragments" = None, aggregator_p2view_Category110: "IUDetails" = None, aggregator_p2view_Category: "Categories" = None, aggregator_p2view_Category98: "Features" = None):
...
class aggregator_p2view_MetadataRepositoryStructuredView:
    ...
    def __init__(self, name: str, loaded: bool, aggregator_p2view_MetadataRepositoryStructuredView71: "Properties" = None, aggregator_p2view_MetadataRepositoryStructuredView73: "MetadataRepository" = None, aggregator_p2view_MetadataRepositoryStructuredView: "InstallableUnits" = None):
        self.name = name
        self.loaded = loaded
...
class aggregator_p2_IQueryable(ABC):
    ...
    def __init__(self):
        ...
        pass
    def query(self, aggregator_progress, aggregator_collector, aggregator_query) :
...
class aggregator_p2_IMetadataRepository(p2_IRepository, p2_IQueryable):
    ...
    def addReference(self, aggregator_type, aggregator_nickname, aggregator_location, aggregator_options):
...
class aggregator_Aggregator(DescriptionProvider, InfosProvider, StatusProvider):
    ...
    def __init__(self, label: str, buildRoot: str, packedStrategy: str, sendmail: bool, type: str, mavenResult: bool, aggregator_Aggregator7: set["aggregator_CustomCategory"] = None, aggregator_Aggregator9: set["aggregator_MetadataRepositoryReference"] = None, aggregator_Aggregator11: set["aggregator_MavenMapping"] = None, aggregator_Aggregator: set["aggregator_Configuration"] = None, aggregator_Aggregator2: set["aggregator_Contribution"] = None, aggregator_Aggregator4: "aggregator_Contact" = None, aggregator: set["aggregator_Contact"] = None, Aggregator: "aggregator_Contact" = None):
        self.label = label
