...
public class aadl2_ComponentImplementation extends ComponentClassifier {
    ...
    public aadl2_ComponentImplementation(
        String noCalls,        String noSubcomponents,        String noConnections    ) {
        super(
        );
    ...
    public aadl2_ComponentImplementation(
        String noCalls,        String noSubcomponents,        String noConnections        ArrayList<aadl2_Subcomponent> aadl2_subcomponents,        ArrayList<aadl2_FlowImplementation> aadl2_flowimplementations,        ArrayList<aadl2_ProcessorFeature> aadl2_processorfeatures,        ArrayList<aadl2_InternalFeature> aadl2_internalfeatures,        ArrayList<aadl2_SubprogramProxy> aadl2_subprogramproxys,        ArrayList<aadl2_Connection> aadl2_connections    ) {
        this.noCalls = noCalls;
        this.noSubcomponents = noSubcomponents;
        this.noConnections = noConnections;
