...
public class aadl2_ProcessorType extends ProcessorClassifier, ComponentType {
    ...
    public aadl2_ProcessorType(
        ArrayList<aadl2_SubprogramGroupAccess> aadl2_subprogramgroupaccesss,        ArrayList<aadl2_SubprogramAccess> aadl2_subprogramaccesss,        ArrayList<aadl2_EventPort> aadl2_eventports,        ArrayList<aadl2_BusAccess> aadl2_busaccesss,        ArrayList<aadl2_DataPort> aadl2_dataports,        ArrayList<aadl2_EventDataPort> aadl2_eventdataports    ) {
