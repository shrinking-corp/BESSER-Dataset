...
class AbstractSubcomponentType:
    ...
    pass
class aadl2_AbstractPrototype(VirtualProcessorSubcomponentType, ProcessSubcomponentType, ThreadGroupSubcomponentType, ThreadSubcomponentType, VirtualBusSubcomponentType, MemorySubcomponentType, AbstractSubcomponentType, ProcessorSubcomponentType, DataSubcomponentType, BusSubcomponentType, SubprogramSubcomponentType, SubprogramGroupSubcomponentType, DeviceSubcomponentType, SystemSubcomponentType, ComponentPrototype):
...
class aadl2_SubprogramSubcomponent(Subcomponent, AccessConnectionEnd, Subprogram):
    ...
    pass
class aadl2_DataSubcomponent(Data, PortConnectionEnd, Subcomponent, AccessConnectionEnd, ParameterConnectionEnd):
...
class FlowElement:
    ...
    pass
class aadl2_DataAccess(FlowElement, Data, Access, PortConnectionEnd, ParameterConnectionEnd):
...
class aadl2_FeaturePrototype(Prototype):
    ...
    def __init__(self, direction: str, aadl2_FeaturePrototype252: "aadl2_ComponentClassifier" = None, aadl2_FeaturePrototype: "aadl2_AbstractFeature" = None, aadl2_FeaturePrototype385: "aadl2_FeaturePrototypeReference" = None):
        self.direction = direction
...
class aadl2_ComponentPrototypeActual(ArrayableElement):
    ...
    def __init__(self, category: str, aadl2_ComponentPrototypeActual361: set["aadl2_PrototypeBinding"] = None, aadl2_ComponentPrototypeActual364: "aadl2_SubcomponentType" = None, aadl2_ComponentPrototypeActual: "aadl2_ComponentPrototypeBinding" = None):
        self.category = category
...
class aadl2_ProcessSubcomponentType(Process, SubcomponentType):
    ...
    pass
class aadl2_SubprogramSubcomponentType(SubcomponentType, FeatureClassifier, Subprogram):
...
class aadl2_ComponentType(ComponentClassifier):
    ...
    def __init__(self, noFeatures: str, aadl2_ComponentType: "aadl2_ComponentImplementation" = None, aadl2_ComponentType154: "aadl2_TypeExtension" = None, aadl2_ComponentType156: set["aadl2_FeatureGroup"] = None, aadl2_ComponentType158: set["aadl2_AbstractFeature"] = None, aadl2_ComponentType147: set["aadl2_Feature"] = None, aadl2_ComponentType150: "aadl2_ComponentType" = None, aadl2_ComponentType148: "aadl2_ComponentType" = None, aadl2_ComponentType152: set["aadl2_FlowSpecification"] = None, aadl2_ComponentType189: "aadl2_TypeExtension" = None, aadl2_ComponentType310: "aadl2_Realization" = None, aadl2_ComponentType355: "aadl2_ComponentTypeRename" = None):
...
class aadl2_ComponentImplementation(ComponentClassifier):
    ...
    def __init__(self, noSubcomponents: str, noConnections: str, noCalls: str, aadl2_ComponentImplementation90: "aadl2_ComponentType" = None, aadl2_ComponentImplementation92: set["aadl2_Subcomponent"] = None, aadl2_ComponentImplementation95: "aadl2_ComponentImplementation" = None, aadl2_ComponentImplementation93: "aadl2_ComponentImplementation" = None, aadl2_ComponentImplementation97: set["aadl2_FlowImplementation"] = None, aadl2_ComponentImplementation: "aadl2_ComponentImplementationReference" = None, aadl2_ComponentImplementation113: set["aadl2_PortConnection"] = None, aadl2_ComponentImplementation115: set["aadl2_FeatureConnection"] = None, aadl2_ComponentImplementation117: set["aadl2_FeatureGroupConnection"] = None, aadl2_ComponentImplementation119: set["aadl2_ProcessorFeature"] = None, aadl2_ComponentImplementation99: set["aadl2_Connection"] = None, aadl2_ComponentImplementation101: "aadl2_ImplementationExtension" = None, aadl2_ComponentImplementation103: "aadl2_Realization" = None, aadl2_ComponentImplementation105: set["aadl2_EndToEndFlow"] = None, aadl2_ComponentImplementation107: set["aadl2_AbstractSubcomponent"] = None, aadl2_ComponentImplementation109: set["aadl2_AccessConnection"] = None, aadl2_ComponentImplementation111: set["aadl2_ParameterConnection"] = None, aadl2_ComponentImplementation121: set["aadl2_InternalFeature"] = None, aadl2_ComponentImplementation123: set["aadl2_EventSource"] = None, aadl2_ComponentImplementation125: set["aadl2_EventDataSource"] = None, aadl2_ComponentImplementation127: set["aadl2_PortProxy"] = None, aadl2_ComponentImplementation129: set["aadl2_SubprogramProxy"] = None, aadl2_ComponentImplementation307: "aadl2_ImplementationExtension" = None):
...
class aadl2_ThreadGroupClassifier(ComponentClassifier, ThreadGroupSubcomponentType):
    ...
    pass
class aadl2_AbstractClassifier(VirtualProcessorSubcomponentType, ProcessSubcomponentType, SubprogramSubcomponentType, ThreadGroupSubcomponentType, ThreadSubcomponentType, VirtualBusSubcomponentType, MemorySubcomponentType, ComponentClassifier, AbstractSubcomponentType, DataSubcomponentType, ProcessorSubcomponentType, BusSubcomponentType, DeviceSubcomponentType, SubprogramGroupSubcomponentType, SystemSubcomponentType):
...
class aadl2_ContainmentPathElement(Element):
    ...
    def __init__(self, annexName: str, aadl2_ContainmentPathElement73: set["aadl2_ArrayRange"] = None, aadl2_ContainmentPathElement75: "aadl2_NamedElement" = None, aadl2_ContainmentPathElement: "aadl2_ContainedNamedElement" = None):
        self.annexName = annexName
...
class aadl2_Prototype(CalledSubprogram, StructuralFeature):
    ...
    def __init__(self, aadl2_Prototype61: "aadl2_Prototype" = None, aadl2_Prototype59: "aadl2_Prototype" = None, aadl2_Prototype69: "aadl2_PrototypeBinding" = None, aadl2_Prototype: "aadl2_Classifier" = None):
...
class aadl2_ProcessorFeature(ModalElement, StructuralFeature):
    ...
    pass
class aadl2_Subcomponent(FlowElement, ModalElement, StructuralFeature, Context, ArrayableElement):
...
class aadl2_Feature(FeatureConnectionEnd, ArrayableElement, StructuralFeature):
    ...
    pass
class aadl2_InternalFeature(ModalElement, StructuralFeature, TriggerPort, FeatureConnectionEnd, PortConnectionEnd):
