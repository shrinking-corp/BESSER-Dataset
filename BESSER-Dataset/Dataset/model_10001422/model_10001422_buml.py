...
Department.attributes={Department_hod, Department_course, Department_teachers__, Department_students__}
...
Admin_Student: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="admin13", type=Administrator, multiplicity=Multiplicity(0, 1))
    }
)
Admin_Employee: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="admin15", type=Administrator, multiplicity=Multiplicity(0, 1))
    }
)
...
domain_model = DomainModel(
    name="_5fJZMBKaEeqDmNBP3mfLQg",
    types={Student, Employee_Interface, Teacher, HOD, Department, Course, Authentication, Access_Information, Attendance, Subject, Administrator},
