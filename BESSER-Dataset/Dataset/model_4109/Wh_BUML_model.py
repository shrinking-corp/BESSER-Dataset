...
wh_Vars = Class(name="wh_Vars")
wh_Exprs = Class(name="wh_Exprs")
wh_Command = Class(name="wh_Command")
wh_EObject = Class(name="wh_EObject")
wh_Foreach = Class(name="wh_Foreach")
...
wh_Cons = Class(name="wh_Cons")
wh_ListExpr = Class(name="wh_ListExpr")
...
wh_ExprSimple.attributes={wh_ExprSimple_strSymb, wh_ExprSimple_str}
...
wh_ExprNot_not_: Property = Property(name="not_", type=StringType)
wh_ExprNot.attributes={wh_ExprNot_not_}
...
domain_model = DomainModel(
    name="wh",
    types={wh_Input, wh_Commands, wh_Output, wh_Wh, wh_Program, wh_Definition, wh_Nop, wh_Affect, wh_Vars, wh_Exprs, wh_Command, wh_EObject, wh_Foreach, wh_Expr, wh_For, wh_While, wh_If, wh_ExprEq, wh_ExprSimple, wh_Cons, wh_ListExpr, wh_ExprAnd, wh_ExprOr, wh_ExprNot},
    associations={input3, command5, output7, elements0, definition1, vars38, exp39, commands9, cmd11, expr113, expr214, cmds17, expr20, cmds22, expr25, cmds27, expr30, cmdsTrue32, cmdsFalse35, expr71, exprSimp173, exprSimp276, exprs41, expr44, cons47, listExpr48, exprHd50, exprTl53, list56, exprs59, exprOr162, exprOrX63, exprNot166, exprNotX68, expr79},
    generalizations={},
    metadata=None
)
