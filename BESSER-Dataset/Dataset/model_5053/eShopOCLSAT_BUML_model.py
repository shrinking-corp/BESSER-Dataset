...
# Classes
eShop_SaleLine = Class(name="eShop_SaleLine")
eShop_Customer = Class(name="eShop_Customer")
eShop_Portal = Class(name="eShop_Portal")
eShop_Sale = Class(name="eShop_Sale")
eShop_GoldCustomer = Class(name="eShop_GoldCustomer")
Customer = Class(name="Customer")
eShop_Product = Class(name="eShop_Product")
...
eShop_Customer_m_newCustomer: Method = Method(name="newCustomer", parameters={Parameter(name='eShop_p', type=StringType), Parameter(name='eShop_name', type=StringType)}, type=StringType)
...
eShop_Portal_m_removeGoldCategory: Method = Method(name="removeGoldCategory", parameters={Parameter(name='eShop_c', type=StringType)})
...
eShop_Sale_m_addSaleLine: Method = Method(name="addSaleLine", parameters={Parameter(name='eShop_p', type=StringType), Parameter(name='eShop_quantity', type=StringType)}, type=StringType)
eShop_Sale.attributes={eShop_Sale_id, eShop_Sale_amount, eShop_Sale_paid}
...
domain_model = DomainModel(
    name="eShop",
    types={eShop_SaleLine, eShop_Customer, eShop_Portal, eShop_Sale, eShop_GoldCustomer, Customer, eShop_Product},
    associations={customers2, purchaser3, portal0, sale1, lines5, sale7, product9, salesLines10},
