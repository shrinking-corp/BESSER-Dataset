...
class eShop_Sale:
    ...
    def addSaleLine(self, eShop_quantity, eShop_p) :
...
class eShop_Portal:
    ...
    def removeGoldCategory(self, eShop_c):
        # TODO: Implement removeGoldCategory method
        pass

class eShop_Customer:

    def __init__(self, name: int, Customer: "eShop_Portal" = None, Customer4: "eShop_Sale" = None, customers: "eShop_Portal" = None, purchaser: set["eShop_Sale"] = None):
        self.name = name
    ...
    def newCustomer(self, eShop_name, eShop_p) :
