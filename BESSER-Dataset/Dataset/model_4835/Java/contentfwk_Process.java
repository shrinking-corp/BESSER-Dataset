...
public class contentfwk_Process extends Standard, Element {
    ...
    public contentfwk_Process(
        String processVolumetrics,        boolean isAutomated,        String processCritiality        ArrayList<contentfwk_Function> contentfwk_functions,        ArrayList<contentfwk_Process> contentfwk_processs,        ArrayList<contentfwk_Process> contentfwk_processs,        ArrayList<contentfwk_Process> contentfwk_processs,        ArrayList<contentfwk_Function> contentfwk_functions    ) {
        this.processVolumetrics = processVolumetrics;
        this.isAutomated = isAutomated;
        this.processCritiality = processCritiality;
