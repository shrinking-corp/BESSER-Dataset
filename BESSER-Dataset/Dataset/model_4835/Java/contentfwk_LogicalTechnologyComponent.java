...
public class contentfwk_LogicalTechnologyComponent extends Element, TechnologyComponent {
    ...
    public contentfwk_LogicalTechnologyComponent(
        String categoryTRM        ArrayList<contentfwk_LogicalTechnologyComponent> contentfwk_logicaltechnologycomponents,        ArrayList<contentfwk_PhysicalTechnologyComponent> contentfwk_physicaltechnologycomponents,        ArrayList<contentfwk_PlatformService> contentfwk_platformservices,        ArrayList<contentfwk_PhysicalTechnologyComponent> contentfwk_physicaltechnologycomponents    ) {
        this.categoryTRM = categoryTRM;
