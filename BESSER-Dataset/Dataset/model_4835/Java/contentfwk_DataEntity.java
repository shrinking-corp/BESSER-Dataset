...
public class contentfwk_DataEntity extends Element {
    ...
    public contentfwk_DataEntity(
        String retentionClassification,        String privacyClassification,        String dataEntityCategory        ArrayList<contentfwk_DataEntity> contentfwk_dataentitys,        ArrayList<contentfwk_Actor> contentfwk_actors,        ArrayList<contentfwk_Actor> contentfwk_actors    ) {
        this.retentionClassification = retentionClassification;
        this.privacyClassification = privacyClassification;
        this.dataEntityCategory = dataEntityCategory;
