...
public class contentfwk_BusinessArchitecture extends Architecture {
    ...
    public contentfwk_BusinessArchitecture(
        ArrayList<contentfwk_Contract> contentfwk_contracts,        ArrayList<contentfwk_Event> contentfwk_events,        ArrayList<contentfwk_Control> contentfwk_controls,        ArrayList<contentfwk_Function> contentfwk_functions,        ArrayList<contentfwk_BusinessService> contentfwk_businessservices,        ArrayList<contentfwk_Location> contentfwk_locations,        ArrayList<contentfwk_ServiceQuality> contentfwk_servicequalitys,        ArrayList<contentfwk_Measure> contentfwk_measures,        ArrayList<contentfwk_Process> contentfwk_processs,        ArrayList<contentfwk_Product> contentfwk_products    ) {
