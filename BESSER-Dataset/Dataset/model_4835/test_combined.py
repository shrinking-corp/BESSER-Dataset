...
def test_hyp_contentfwk_element_forceid_changes_state(instance):
...
def test_hyp_contentfwk_architecture_ID_setter(instance):
    original = instance.ID
    instance.ID = original
    assert instance.ID == original
...
@given(instance=contentfwk_Architecture_strategy)
@settings(max_examples=30)
def test_hyp_contentfwk_architecture_forceid_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
        instance.forceID(
...
def test_hyp_contentfwk_enterprisearchitecture_ID_setter(instance):
    original = instance.ID
    instance.ID = original
    assert instance.ID == original
...
@given(instance=contentfwk_EnterpriseArchitecture_strategy)
@settings(max_examples=30)
def test_hyp_contentfwk_enterprisearchitecture_forceid_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
        instance.forceID(
