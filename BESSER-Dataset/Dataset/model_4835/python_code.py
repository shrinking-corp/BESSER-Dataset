...
class contentfwk_Standard(ABC):
    ...
    def __init__(self, standardClass: str, standardCreationDate: date, lastStandardReviewDate: date, nextStandardReviewDate: date, retireDate: date):
        ...
        pass
    @property
    def lastStandardReviewDate(self):
    ...
    @property
    def nextStandardReviewDate(self):
...
class contentfwk_Principle(StrategicElement):
    ...
    def __init__(self, priority: str, statementOfPrinciple: str, rationale: str, implication: str, metric: str, principleCategory: str):
...
class contentfwk_Element:
    ...
    def __init__(self, ID: str, category: str, name: str, description: str, sourceDescr: str, ownerDescr: str, Element: "contentfwk_Element" = None, isDelegatedBy: set["contentfwk_Element"] = None, Element270: "contentfwk_Element" = None, delegates: set["contentfwk_Element"] = None):
        self.ID = ID
    ...
    def forceID(self, contentfwk_newID):
...
class contentfwk_PhysicalApplicationComponent(Element, ApplicationComponent):
    ...
    @property
    def availabilityCharacteristics(self):
...
class contentfwk_PlatformService(Element):
    ...
    def __init__(self, standardClass: str, categoryTRM: str, contentfwk_PlatformService: "contentfwk_TechnologyArchitecture" = None, suppliesPlatformServices: set["contentfwk_LogicalTechnologyComponent"] = None, PlatformService: "contentfwk_LogicalTechnologyComponent" = None):
        self.standardClass = standardClass
        self.categoryTRM = categoryTRM
...
class contentfwk_DataEntity(Element):
    ...
    def __init__(self, dataEntityCategory: str, privacyClassification: str, retentionClassification: str, DataEntity: "contentfwk_Actor" = None, DataEntity84: "contentfwk_Actor" = None, operatesOnDataEntities: set["contentfwk_LogicalApplicationComponent"] = None, contentfwk_DataEntity: "contentfwk_DataArchitecture" = None, contentfwk_DataEntity135: set["contentfwk_DataEntity"] = None, DataEntity141: "contentfwk_LogicalApplicationComponent" = None, suppliesDataEntities: set["contentfwk_Actor"] = None, consumesDataEntities: set["contentfwk_Actor"] = None, consumesDataEntities123: set["contentfwk_Service"] = None, providesDataEntities: set["contentfwk_Service"] = None, encapsulatesDataEntities: "contentfwk_LogicalDataComponent" = None, contentfwk_DataEntity131: "contentfwk_DataEntity" = None, contentfwk_DataEntity129: "contentfwk_DataEntity" = None, contentfwk_DataEntity134: "contentfwk_DataEntity" = None, contentfwk_DataEntity132: set["contentfwk_DataEntity"] = None, contentfwk_DataEntity137: "contentfwk_DataEntity" = None, DataEntity291: "contentfwk_LogicalDataComponent" = None, DataEntity359: "contentfwk_Service" = None, DataEntity357: "contentfwk_Service" = None):
...
class contentfwk_Actor(Element):
    ...
    def __init__(self, actorGoal: str, actorTasks: str, FTEs: str, contentfwk_Actor: "contentfwk_BusinessArchitecture" = None, isSuppliedByActors: set["contentfwk_DataEntity"] = None, isConsumedByActors: set["contentfwk_DataEntity"] = None, Actor: "contentfwk_OrganizationUnit" = None, isPerformedByActors: set["contentfwk_Function"] = None, Actor104: "contentfwk_Actor" = None, isDecomposedByActors: "contentfwk_Actor" = None, Actor107: "contentfwk_Actor" = None, decomposesActor: set["contentfwk_Actor"] = None, Actor109: "contentfwk_Role" = None, containsActors: "contentfwk_OrganizationUnit" = None, supportsActors: set["contentfwk_Function"] = None, isAssumedByActors: set["contentfwk_Role"] = None, involvesActors: set["contentfwk_Process"] = None, isProvidedToActors: set["contentfwk_Service"] = None, isResolvedByActors: set["contentfwk_Event"] = None, isGeneratedByActors: set["contentfwk_Event"] = None, containsActors98: "contentfwk_Location" = None, Actor119: "contentfwk_DataEntity" = None, Actor121: "contentfwk_DataEntity" = None, Actor164: "contentfwk_Function" = None, Actor152: "contentfwk_Function" = None, Actor190: "contentfwk_Process" = None, Actor260: "contentfwk_Event" = None, Actor263: "contentfwk_Event" = None, Actor272: "contentfwk_Location" = None, Actor353: "contentfwk_Service" = None):
...
class contentfwk_OrganizationUnit(Element):
    ...
    def __init__(self, headcount: str, contentfwk_OrganizationUnit: "contentfwk_BusinessArchitecture" = None, OrganizationUnit: "contentfwk_Driver" = None, involvesOrganizationUnits: set["contentfwk_Process"] = None, motivatesOrganizationUnits: set["contentfwk_Driver"] = None, isProducedByOrganizationUnits: set["contentfwk_Product"] = None, containsOrganizationUnits: "contentfwk_Location" = None, OrganizationUnit78: "contentfwk_OrganizationUnit" = None, isDecomposedByOrganizationUnits: "contentfwk_OrganizationUnit" = None, OrganizationUnit81: "contentfwk_OrganizationUnit" = None, decomposesOrganizationUnit: set["contentfwk_OrganizationUnit"] = None, isOwnedAndGovernedByOrganizationUnits: set["contentfwk_Service"] = None, belongsToOrganizationUnit: set["contentfwk_Actor"] = None, isOwnedByOrganizationUnit: set["contentfwk_Function"] = None, OrganizationUnit86: "contentfwk_Actor" = None, OrganizationUnit154: "contentfwk_Function" = None, OrganizationUnit181: "contentfwk_Process" = None, OrganizationUnit230: "contentfwk_Product" = None, OrganizationUnit275: "contentfwk_Location" = None, OrganizationUnit369: "contentfwk_Service" = None):
...
class contentfwk_Process(Standard, Element):
    ...
    def __init__(self, processCritiality: str, isAutomated: bool, processVolumetrics: str, contentfwk_Process: "contentfwk_BusinessArchitecture" = None, Process: "contentfwk_OrganizationUnit" = None, Process91: "contentfwk_Actor" = None, Process158: "contentfwk_Function" = None, Process160: "contentfwk_Function" = None, isRealizedByProcesses183: set["contentfwk_Service"] = None, supportsProcesses186: set["contentfwk_Service"] = None, participatesInProcesses189: set["contentfwk_Actor"] = None, ensuresCorrectOperationOfProcesses: set["contentfwk_Control"] = None, isResolvedByProcesses: set["contentfwk_Event"] = None, isGeneratedByProcesses: set["contentfwk_Event"] = None, isProducedByProcesses: set["contentfwk_Product"] = None, participatesInProcesses: set["contentfwk_OrganizationUnit"] = None, Process200: "contentfwk_Process" = None, isDecomposedByProcesses: "contentfwk_Process" = None, Process203: "contentfwk_Process" = None, followsProcesses: set["contentfwk_Process"] = None, Process206: "contentfwk_Process" = None, precedesProcesses: set["contentfwk_Process"] = None, Process209: "contentfwk_Process" = None, decomposesProcess: set["contentfwk_Process"] = None, Process233: "contentfwk_Product" = None, Process255: "contentfwk_Event" = None, Process257: "contentfwk_Event" = None, isRealizedByProcesses: set["contentfwk_Function"] = None, supportsProcesses: set["contentfwk_Function"] = None, Process265: "contentfwk_Control" = None, Process375: "contentfwk_Service" = None, Process373: "contentfwk_Service" = None):
