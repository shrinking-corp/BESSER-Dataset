...
class model_Attribute:
    ...
    def __init__(self, minOccurs: int, maxOccurs: int, model_Attribute: "model_BasicObject" = None, model_Attribute47: "model_BasicRelationship" = None, model_Attribute50: "model_BasicObject" = None):
...
class model_Template:
    ...
    def __init__(self, path: str, Template: "model_Metamodel" = None, template: set["model_BasicObject"] = None, templates: "model_Metamodel" = None, model_Template: "model_DiagramModel" = None, Template40: "model_BasicObject" = None):
        self.path = path
...
class model_SketchModelActor(DiagramModelObject, Documentable, Properties):
    ...
    pass
class model_DiagramModelZentaObject(DiagramModelObject, DiagramModelContainer):
    ...
    def addZentaElementToModel(self, model_parent):
...
class model_DiagramModelImage(DiagramModelObject, DiagramModelImageProvider, BorderObject):
    ...
    pass
class model_DiagramModelGroup(Properties, Documentable, DiagramModelObject, DiagramModelContainer):

    pass
class model_SketchModelSticky(TextContent, DiagramModelContainer, Properties, DiagramModelObject):
...
class DiagramModelComponent:
    ...
    pass
class model_DiagramModelConnection(FontAttribute, DiagramModelComponent, Documentable, Properties):

    def __init__(self, text: str, lineDecoration: str, type: int, model_DiagramModelConnection15: "model_DiagramModelObject" = None, model_DiagramModelConnection: "model_DiagramModelObject" = None, model_DiagramModelConnection17: "model_DiagramModelObject" = None, model_DiagramModelConnection20: "model_DiagramModelObject" = None, model_DiagramModelConnection23: set["model_DiagramModelBendpoint"] = None):
        self.text = text
...
class model_DiagramModelObject(FontAttribute, DiagramModelComponent):
    ...
    def __init__(self, fillColor: str, elementShape: str, model_DiagramModelObject: "model_DiagramModelContainer" = None, model_DiagramModelObject14: set["model_DiagramModelConnection"] = None, model_DiagramModelObject10: "model_Bounds" = None, model_DiagramModelObject12: set["model_DiagramModelConnection"] = None, model_DiagramModelObject18: "model_DiagramModelConnection" = None, model_DiagramModelObject21: "model_DiagramModelConnection" = None):
    ...
    def setBounds(self, model_x, model_width, model_height, model_y):
...
class model_DiagramModelContainer(DiagramModelComponent):
    ...
    pass
class model_DiagramModel(ZentaModelElement, Documentable, Properties, DiagramModelContainer):

    def __init__(self, connectionRouterType: int, model_DiagramModel: "model_DiagramModelComponent" = None, model_DiagramModel8: "model_DiagramModelReference" = None, model_DiagramModel30: "model_Template" = None):
...
class Nameable:
    ...
    pass
class model_ZentaElement(ZentaModelElement, Properties, Cloneable, Nameable, Identifier, Documentable):
...
class model_ZentaModel(Folder, ZentaModelElement, Properties, FolderContainer, Nameable, Identifier, Documentable):
...
class model_ZentaModelElement(Adapter):
    ...
    pass
class model_Folder(ZentaModelElement, Properties, FolderContainer, Nameable, Identifier, Documentable):
