...
model_ZentaModelElement = Class(name="model_ZentaModelElement", is_abstract=True)
Adapter = Class(name="Adapter")
model_ZentaModel = Class(name="model_ZentaModel")
...
model_ZentaDiagramModel = Class(name="model_ZentaDiagramModel")
DiagramModel = Class(name="DiagramModel")
model_DiagramModelZentaObject = Class(name="model_DiagramModelZentaObject")
model_ZentaElement = Class(name="model_ZentaElement", is_abstract=True)
...
model_DiagramModelZentaConnection = Class(name="model_DiagramModelZentaConnection")
DiagramModelConnection = Class(name="DiagramModelConnection")
model_Metamodel = Class(name="model_Metamodel")
model_Template = Class(name="model_Template")
model_BasicRelationship = Class(name="model_BasicRelationship")
model_BasicObject = Class(name="model_BasicObject")
model_SketchModel = Class(name="model_SketchModel")
model_SketchModelSticky = Class(name="model_SketchModelSticky")
model_Attribute = Class(name="model_Attribute")
...
model_ZentaModel_m_getDefaultFolderForElement: Method = Method(name="getDefaultFolderForElement", parameters={Parameter(name='model_element', type=StringType)}, type=Folder)
...
model_ZentaModel.methods={model_ZentaModel_m_getDefaultFolderForElement, model_ZentaModel_m_getDefaultDiagramModel, model_ZentaModel_m_getDiagramModels}
...
model_Property.attributes={model_Property_key, model_Property_value, model_Property_generated}
...
model_DiagramModelZentaObject_m_addZentaElementToModel: Method = Method(name="addZentaElementToModel", parameters={Parameter(name='model_parent', type=StringType)})
...
model_DiagramModelZentaObject.methods={model_DiagramModelZentaObject_m_addZentaElementToModel, model_DiagramModelZentaObject_m_removeZentaElementFromModel}
...
model_FontAttribute.attributes={model_FontAttribute_textAlignment, model_FontAttribute_fontColor, model_FontAttribute_textPosition, model_FontAttribute_font}
...
model_DiagramModelZentaConnection_m_addRelationshipToModel: Method = Method(name="addRelationshipToModel", parameters={Parameter(name='model_parent', type=StringType)})
...
model_DiagramModelZentaConnection.methods={model_DiagramModelZentaConnection_m_addRelationshipToModel, model_DiagramModelZentaConnection_m_removeRelationshipFromModel}
...
model_Attribute.attributes={model_Attribute_maxOccurs, model_Attribute_minOccurs}
...
domain_model = DomainModel(
    name="model",
    types={model_Adapter, model_TextContent, model_Documentable, model_Cloneable, model_FolderContainer, model_Folder, model_ZentaModelElement, Adapter, model_ZentaModel, model_Identifier, Nameable, model_Property, model_Properties, model_Nameable, model_OrJunction, model_DiagramModelComponent, Cloneable, model_DiagramModel, model_DiagramModelContainer, DiagramModelComponent, model_DiagramModelObject, model_DiagramModelReference, DiagramModelObject, ZentaModelElement, FolderContainer, Identifier, Documentable, Properties, model_JunctionElement, ZentaElement, model_InterfaceElement, model_Junction, JunctionElement, model_AndJunction, model_DiagramModelGroup, DiagramModelContainer, model_DiagramModelNote, TextContent, model_DiagramModelImage, FontAttribute, model_Bounds, model_DiagramModelConnection, model_DiagramModelBendpoint, BorderObject, DiagramModelImageProvider, model_Lockable, model_ZentaDiagramModel, DiagramModel, model_DiagramModelZentaObject, model_ZentaElement, model_FontAttribute, model_BorderObject, model_DiagramModelImageProvider, model_SketchModelActor, Folder, model_DiagramModelZentaConnection, DiagramModelConnection, model_Metamodel, model_Template, model_BasicRelationship, model_BasicObject, model_SketchModel, model_SketchModelSticky, model_Attribute, BasicObject},
    associations={folders1, zentaModel2, properties0, diagramModel5, children6, referencedModel7, elements3, targetConnections13, bounds9, sourceConnections11, source16, target19, bendpoints22, zentaElement24, templates26, relationship25, classes27, metamodel28, diagram29, diagObjects31, attributes32, ancestor34, children37, template39, source41, target42, diagConnections45, relation46, connectedObject49},
    generalizations={gen_model_ZentaModelElement_Adapter, gen_model_Identifier_Nameable, gen_model_OrJunction_JunctionElement, gen_model_DiagramModelComponent_Identifier, gen_model_DiagramModelComponent_Cloneable, gen_model_DiagramModelComponent_Adapter, gen_model_DiagramModelComponent_Nameable, gen_model_DiagramModelContainer_DiagramModelComponent, gen_model_DiagramModelReference_DiagramModelObject, gen_model_Folder_ZentaModelElement, gen_model_Folder_FolderContainer, gen_model_Folder_Nameable, gen_model_Folder_Identifier, gen_model_Folder_Documentable, gen_model_Folder_Properties, gen_model_JunctionElement_ZentaElement, gen_model_InterfaceElement_ZentaElement, gen_model_Junction_JunctionElement, gen_model_AndJunction_JunctionElement, gen_model_DiagramModelGroup_DiagramModelObject, gen_model_DiagramModelGroup_DiagramModelContainer, gen_model_DiagramModelGroup_Documentable, gen_model_DiagramModelGroup_Properties, gen_model_DiagramModelNote_DiagramModelObject, gen_model_DiagramModelNote_TextContent, gen_model_DiagramModelImage_DiagramModelObject, gen_model_DiagramModelObject_DiagramModelComponent, gen_model_DiagramModelObject_FontAttribute, gen_model_DiagramModelBendpoint_Cloneable, gen_model_DiagramModelImage_BorderObject, gen_model_DiagramModelImage_DiagramModelImageProvider, gen_model_DiagramModelConnection_DiagramModelComponent, gen_model_DiagramModelConnection_FontAttribute, gen_model_DiagramModelConnection_Properties, gen_model_DiagramModelConnection_Documentable, gen_model_ZentaDiagramModel_DiagramModel, gen_model_DiagramModelZentaObject_DiagramModelObject, gen_model_DiagramModelZentaObject_DiagramModelContainer, gen_model_ZentaElement_Nameable, gen_model_ZentaElement_Documentable, gen_model_ZentaElement_Properties, gen_model_SketchModelActor_DiagramModelObject, gen_model_SketchModelActor_Documentable, gen_model_SketchModelActor_Properties, gen_model_DiagramModel_ZentaModelElement, gen_model_DiagramModel_DiagramModelContainer, gen_model_DiagramModel_Documentable, gen_model_DiagramModel_Properties, gen_model_ZentaModel_FolderContainer, gen_model_ZentaModel_Nameable, gen_model_ZentaModel_Identifier, gen_model_ZentaModel_ZentaModelElement, gen_model_ZentaModel_Properties, gen_model_ZentaModel_Documentable, gen_model_ZentaModel_Folder, gen_model_DiagramModelZentaConnection_DiagramModelConnection, gen_model_SketchModel_DiagramModel, gen_model_SketchModelSticky_DiagramModelObject, gen_model_SketchModelSticky_DiagramModelContainer, gen_model_SketchModelSticky_TextContent, gen_model_SketchModelSticky_Properties, gen_model_ZentaElement_ZentaModelElement, gen_model_ZentaElement_Identifier, gen_model_ZentaElement_Cloneable, gen_model_BasicObject_ZentaElement, gen_model_BasicRelationship_BasicObject},
    metadata=None
)
