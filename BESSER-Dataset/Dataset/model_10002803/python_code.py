...
class Order:
    ...
    def __init__(self, number: int, ordered: date, shipped: str, shipTo: str, total: float, status: OrderStatus, payment19: "Payment" = None, items14: set["LineItem"] = None, account17: "Account" = None):
        self.number = number
