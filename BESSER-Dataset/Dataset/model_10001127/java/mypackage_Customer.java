...
public class mypackage_Customer  {
    ...
    public mypackage_Customer(
        String address,        LocalDate dateOfBirth,        String phoneNumber,        String name,        String emailAddress    ) {
    ...
    public mypackage_Customer(
        String address,        LocalDate dateOfBirth,        String phoneNumber,        String name,        String emailAddress        ArrayList<account_Account> account_accounts    ) {
        this.address = address;
        this.dateOfBirth = dateOfBirth;
        this.phoneNumber = phoneNumber;
        this.name = name;
