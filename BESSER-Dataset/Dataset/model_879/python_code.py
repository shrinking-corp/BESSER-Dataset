...
class simplepdl_WorkSequence(ProcessElement):
    ...
    def __init__(self, name: str, linkType: str, WorkSequence10: "simplepdl_Activities" = None, linksToSuccessors: "simplepdl_Activities" = None, linksToPredecessors: "simplepdl_Activities" = None, WorkSequence: "simplepdl_Activities" = None):
        self.name = name
...
class simplepdl_Activities(ProcessElement):
    ...
    def __init__(self, name: str, min_time: int, max_time: int, Activities14: "simplepdl_SubWorkDefinition" = None, predecessor: set["simplepdl_WorkSequence"] = None, parent: set["simplepdl_SubWorkDefinition"] = None, Activities: "simplepdl_WorkSequence" = None, Activities7: "simplepdl_WorkSequence" = None, successor: set["simplepdl_WorkSequence"] = None):
        self.name = name
...
class simplepdl_Resource:
    ...
    def __init__(self, name: str, marking: int, simplepdl_Resource17: "simplepdl_ParameterWD" = None, simplepdl_Resource: "simplepdl_Process" = None):
        self.name = name
