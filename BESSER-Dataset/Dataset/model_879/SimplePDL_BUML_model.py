...
simplepdl_Activities = Class(name="simplepdl_Activities", is_abstract=True)
simplepdl_ParameterSWD = Class(name="simplepdl_ParameterSWD")
simplepdl_Parameter = Class(name="simplepdl_Parameter", is_abstract=True)
Parameter_ = Class(name="Parameter")
simplepdl_SubWorkDefinition = Class(name="simplepdl_SubWorkDefinition")
simplepdl_WorkDefinition = Class(name="simplepdl_WorkDefinition")
Activities = Class(name="Activities")
simplepdl_ParameterWD = Class(name="simplepdl_ParameterWD")
...
simplepdl_Resource.attributes={simplepdl_Resource_marking, simplepdl_Resource_name}
...
simplepdl_Activities.attributes={simplepdl_Activities_name, simplepdl_Activities_max_time, simplepdl_Activities_min_time}
...
simplepdl_Parameter.attributes={simplepdl_Parameter_name, simplepdl_Parameter_nbNeeds}
...
domain_model = DomainModel(
    name="simplepdl",
    types={simplepdl_Process, simplepdl_ProcessElement, simplepdl_Resource, simplepdl_Guidance, ProcessElement, simplepdl_WorkSequence, simplepdl_Activities, simplepdl_ParameterSWD, simplepdl_Parameter, Parameter_, simplepdl_SubWorkDefinition, simplepdl_WorkDefinition, Activities, simplepdl_ParameterWD, WorkSequenceType},
    associations={processElements0, resources1, element3, predecessor5, successor6, linksToPredecessors8, parent13, needsSWD15, resource16, workDefinition18, internResource19, subWorkDefinition21, linksToSuccessors9, children11, needsWD12},
    generalizations={gen_simplepdl_Guidance_ProcessElement, gen_simplepdl_WorkSequence_ProcessElement, gen_simplepdl_Activities_ProcessElement, gen_simplepdl_Parameter_ProcessElement, gen_simplepdl_ParameterWD_Parameter, gen_simplepdl_ParameterSWD_Parameter, gen_simplepdl_WorkDefinition_Activities, gen_simplepdl_SubWorkDefinition_Activities},
    metadata=None
)
