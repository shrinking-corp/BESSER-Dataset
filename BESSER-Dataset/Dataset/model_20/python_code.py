...
class petriNetz_Transition:
    ...
    def __init__(self, name: str, petriNetz_Transition12: set["petriNetz_PTArc"] = None, petriNetz_Transition15: set["petriNetz_TPArc"] = None, petriNetz_Transition22: "petriNetz_PTArc" = None, petriNetz_Transition28: "petriNetz_TPArc" = None, petriNetz_Transition: "petriNetz_Petrinet" = None):
        self.name = name
...
class petriNetz_Place:
    ...
    def __init__(self, name: str, petriNetz_Place10: set["petriNetz_TPArc"] = None, petriNetz_Place19: "petriNetz_PTArc" = None, petriNetz_Place25: "petriNetz_TPArc" = None, petriNetz_Place: "petriNetz_Petrinet" = None, petriNetz_Place6: set["petriNetz_Token"] = None, petriNetz_Place8: set["petriNetz_PTArc"] = None):
        self.name = name
...
class petriNetz_Petrinet:
    ...
    def __init__(self, name: str, petriNetz_Petrinet: set["petriNetz_Place"] = None, petriNetz_Petrinet2: set["petriNetz_Transition"] = None, petriNetz_Petrinet4: set["petriNetz_Arc"] = None):
        self.name = name
