...
# Classes
petriNetz_Petrinet = Class(name="petriNetz_Petrinet")
petriNetz_TPArc = Class(name="petriNetz_TPArc")
Arc = Class(name="Arc")
petriNetz_Place = Class(name="petriNetz_Place")
petriNetz_Transition = Class(name="petriNetz_Transition")
petriNetz_Arc = Class(name="petriNetz_Arc")
petriNetz_Token = Class(name="petriNetz_Token")
petriNetz_PTArc = Class(name="petriNetz_PTArc")
...
domain_model = DomainModel(
    name="petriNetz",
    types={petriNetz_Petrinet, petriNetz_TPArc, Arc, petriNetz_Place, petriNetz_Transition, petriNetz_Arc, petriNetz_Token, petriNetz_PTArc},
    associations={in_9, in_11, out14, src17, trg20, trg23, src26, places0, transitions1, arcs3, tokens5, out7},
