...
# Classes
astm_GASTMObject = Class(name="astm_GASTMObject")
Visitable = Class(name="Visitable")
astm_GASTMSourceObject = Class(name="astm_GASTMSourceObject", is_abstract=True)
astm_GASTMSemanticObject = Class(name="astm_GASTMSemanticObject", is_abstract=True)
astm_OtherSyntaxObject = Class(name="astm_OtherSyntaxObject", is_abstract=True)
astm_StorageSpecification = Class(name="astm_StorageSpecification", is_abstract=True)
astm_DataType = Class(name="astm_DataType", is_abstract=True)
astm_AccessKind = Class(name="astm_AccessKind")
astm_UnaryOperator = Class(name="astm_UnaryOperator", is_abstract=True)
astm_BinaryOperator = Class(name="astm_BinaryOperator", is_abstract=True)
astm_ActualParameter = Class(name="astm_ActualParameter", is_abstract=True)
astm_SourceFile = Class(name="astm_SourceFile")
GASTMSourceObject = Class(name="GASTMSourceObject")
astm_SourceLocation = Class(name="astm_SourceLocation")
astm_CompilationUnit = Class(name="astm_CompilationUnit")
astm_GlobalScope = Class(name="astm_GlobalScope")
astm_Scope = Class(name="astm_Scope")
astm_DefinitionObject = Class(name="astm_DefinitionObject", is_abstract=True)
astm_GASTMSyntaxObject = Class(name="astm_GASTMSyntaxObject", is_abstract=True)
GASTMObject = Class(name="GASTMObject")
astm_PreprocessorElement = Class(name="astm_PreprocessorElement", is_abstract=True)
astm_AnnotationExpression = Class(name="astm_AnnotationExpression")
OtherSyntaxObject = Class(name="OtherSyntaxObject")
astm_ProgramScope = Class(name="astm_ProgramScope")
astm_Name = Class(name="astm_Name")
astm_DeclarationOrDefinition = Class(name="astm_DeclarationOrDefinition", is_abstract=True)
DefinitionObject = Class(name="DefinitionObject")
astm_Definition = Class(name="astm_Definition", is_abstract=True)
DeclarationOrDefinition = Class(name="DeclarationOrDefinition")
astm_Project = Class(name="astm_Project")
GASTMSemanticObject = Class(name="GASTMSemanticObject")
astm_Declaration = Class(name="astm_Declaration", is_abstract=True)
astm_FunctionDeclaration = Class(name="astm_FunctionDeclaration")
Declaration = Class(name="Declaration")
astm_FormalParameterDeclaration = Class(name="astm_FormalParameterDeclaration")
astm_FunctionMemberAttributes = Class(name="astm_FunctionMemberAttributes")
astm_VariableDeclaration = Class(name="astm_VariableDeclaration")
astm_FunctionDefinition = Class(name="astm_FunctionDefinition")
Definition = Class(name="Definition")
astm_FormalParameterDefinition = Class(name="astm_FormalParameterDefinition")
astm_Statement = Class(name="astm_Statement", is_abstract=True)
astm_FunctionScope = Class(name="astm_FunctionScope")
astm_VirtualSpecification = Class(name="astm_VirtualSpecification", is_abstract=True)
astm_EntryDefinition = Class(name="astm_EntryDefinition")
astm_TypeReference = Class(name="astm_TypeReference", is_abstract=True)
astm_DataDefinition = Class(name="astm_DataDefinition", is_abstract=True)
astm_Expression = Class(name="astm_Expression", is_abstract=True)
astm_BitFieldDefinition = Class(name="astm_BitFieldDefinition")
DataDefinition = Class(name="DataDefinition")
astm_EnumLiteralDefinition = Class(name="astm_EnumLiteralDefinition")
astm_TypeDefinition = Class(name="astm_TypeDefinition")
astm_NamedTypeDefinition = Class(name="astm_NamedTypeDefinition")
TypeDefinition = Class(name="TypeDefinition")
astm_NamedType = Class(name="astm_NamedType")
astm_AggregateTypeDefinition = Class(name="astm_AggregateTypeDefinition")
astm_AggregateType = Class(name="astm_AggregateType", is_abstract=True)
astm_NameSpaceDefinition = Class(name="astm_NameSpaceDefinition")
astm_NameSpaceType = Class(name="astm_NameSpaceType")
astm_LabelDefinition = Class(name="astm_LabelDefinition")
astm_LabelType = Class(name="astm_LabelType")
astm_IncludeUnit = Class(name="astm_IncludeUnit")
PreprocessorElement = Class(name="PreprocessorElement")
astm_MacroCall = Class(name="astm_MacroCall")
astm_Comment = Class(name="astm_Comment")
astm_Type = Class(name="astm_Type", is_abstract=True)
GASTMSyntaxObject = Class(name="GASTMSyntaxObject")
astm_PrimitiveType = Class(name="astm_PrimitiveType", is_abstract=True)
DataType = Class(name="DataType")
astm_EnumType = Class(name="astm_EnumType")
astm_ConstructedType = Class(name="astm_ConstructedType", is_abstract=True)
astm_AggregateScope = Class(name="astm_AggregateScope")
astm_ArrayType = Class(name="astm_ArrayType")
ConstructedType = Class(name="ConstructedType")
astm_Dimension = Class(name="astm_Dimension")
astm_FunctionType = Class(name="astm_FunctionType")
Type = Class(name="Type")
astm_FormalParameterType = Class(name="astm_FormalParameterType", is_abstract=True)
astm_MacroDefinition = Class(name="astm_MacroDefinition")
astm_ClassType = Class(name="astm_ClassType")
AggregateType = Class(name="AggregateType")
astm_DerivesFrom = Class(name="astm_DerivesFrom")
astm_UnnamedTypeReference = Class(name="astm_UnnamedTypeReference")
TypeReference = Class(name="TypeReference")
astm_NamedTypeReference = Class(name="astm_NamedTypeReference")
astm_DeleteStatement = Class(name="astm_DeleteStatement")
Statement = Class(name="Statement")
astm_DeclarationOrDefinitionStatement = Class(name="astm_DeclarationOrDefinitionStatement")
astm_ExpressionStatement = Class(name="astm_ExpressionStatement")
astm_JumpStatement = Class(name="astm_JumpStatement")
astm_BreakStatement = Class(name="astm_BreakStatement")
astm_ContinueStatement = Class(name="astm_ContinueStatement")
astm_LabeledStatement = Class(name="astm_LabeledStatement")
astm_BlockStatement = Class(name="astm_BlockStatement")
astm_BlockScope = Class(name="astm_BlockScope")
astm_EmptyStatement = Class(name="astm_EmptyStatement")
astm_IfStatement = Class(name="astm_IfStatement")
astm_SwitchStatement = Class(name="astm_SwitchStatement")
astm_SwitchCase = Class(name="astm_SwitchCase")
astm_CaseBlock = Class(name="astm_CaseBlock")
SwitchCase = Class(name="SwitchCase")
astm_ReturnStatement = Class(name="astm_ReturnStatement")
astm_LabelAccess = Class(name="astm_LabelAccess")
astm_ForStatement = Class(name="astm_ForStatement", is_abstract=True)
LoopStatement = Class(name="LoopStatement")
astm_TryStatement = Class(name="astm_TryStatement")
astm_CatchBlock = Class(name="astm_CatchBlock")
astm_TypesCatchBlock = Class(name="astm_TypesCatchBlock")
CatchBlock = Class(name="CatchBlock")
astm_VariableCatchBlock = Class(name="astm_VariableCatchBlock")
astm_ThrowStatement = Class(name="astm_ThrowStatement")
astm_NameReference = Class(name="astm_NameReference", is_abstract=True)
Expression = Class(name="Expression")
astm_LoopStatement = Class(name="astm_LoopStatement")
astm_ArrayAccess = Class(name="astm_ArrayAccess")
astm_QualifiedIdentifierReference = Class(name="astm_QualifiedIdentifierReference", is_abstract=True)
NameReference = Class(name="NameReference")
astm_IdentifierReference = Class(name="astm_IdentifierReference")
astm_TypeQualifiedIdentifierReference = Class(name="astm_TypeQualifiedIdentifierReference")
astm_Literal = Class(name="astm_Literal")
astm_CastExpression = Class(name="astm_CastExpression")
astm_UnaryExpression = Class(name="astm_UnaryExpression")
astm_BinaryExpression = Class(name="astm_BinaryExpression")
astm_OperatorAssign = Class(name="astm_OperatorAssign")
BinaryOperator = Class(name="BinaryOperator")
astm_ConditionalExpression = Class(name="astm_ConditionalExpression")
astm_RangeExpression = Class(name="astm_RangeExpression")
astm_FunctionCallExpression = Class(name="astm_FunctionCallExpression")
astm_ActualParameterExpression = Class(name="astm_ActualParameterExpression")
ActualParameter = Class(name="ActualParameter")
astm_NewExpression = Class(name="astm_NewExpression")
Scope = Class(name="Scope")
astm_VariableDefinition = Class(name="astm_VariableDefinition")
astm_FunctionMemberAttribute = Class(name="astm_FunctionMemberAttribute")
astm_External = Class(name="astm_External")
StorageSpecification = Class(name="StorageSpecification")
astm_FunctionPersistent = Class(name="astm_FunctionPersistent")
astm_FileLocal = Class(name="astm_FileLocal")
astm_PerClassMember = Class(name="astm_PerClassMember")
astm_NoDef = Class(name="astm_NoDef")
astm_Virtual = Class(name="astm_Virtual")
VirtualSpecification = Class(name="VirtualSpecification")
astm_PureVirtual = Class(name="astm_PureVirtual")
astm_NonVirtual = Class(name="astm_NonVirtual")
astm_ExceptionType = Class(name="astm_ExceptionType")
astm_Void = Class(name="astm_Void")
PrimitiveType = Class(name="PrimitiveType")
astm_Byte = Class(name="astm_Byte")
astm_ShortInteger = Class(name="astm_ShortInteger")
astm_Protected = Class(name="astm_Protected")
astm_Double = Class(name="astm_Double")
astm_Integer = Class(name="astm_Integer")
astm_LongDouble = Class(name="astm_LongDouble")
astm_Character = Class(name="astm_Character")
astm_String = Class(name="astm_String")
astm_Boolean = Class(name="astm_Boolean")
astm_WideCharacter = Class(name="astm_WideCharacter")
astm_CollectionType = Class(name="astm_CollectionType")
astm_PointerType = Class(name="astm_PointerType")
astm_ReferenceType = Class(name="astm_ReferenceType")
astm_RangeType = Class(name="astm_RangeType")
astm_StructureType = Class(name="astm_StructureType")
astm_UnionType = Class(name="astm_UnionType")
astm_AnnotationType = Class(name="astm_AnnotationType")
astm_ByValueFormalParameterType = Class(name="astm_ByValueFormalParameterType")
FormalParameterType = Class(name="FormalParameterType")
astm_ByReferenceFormalParameterType = Class(name="astm_ByReferenceFormalParameterType")
astm_Public = Class(name="astm_Public")
AccessKind = Class(name="AccessKind")
astm_LongInteger = Class(name="astm_LongInteger")
astm_Float = Class(name="astm_Float")
astm_NotGreater = Class(name="astm_NotGreater")
astm_Less = Class(name="astm_Less")
astm_Private = Class(name="astm_Private")
astm_TerminateStatement = Class(name="astm_TerminateStatement")
astm_DefaultBlock = Class(name="astm_DefaultBlock")
astm_WhileStatement = Class(name="astm_WhileStatement")
astm_DoWhileStatement = Class(name="astm_DoWhileStatement")
astm_ForCheckBeforeStatement = Class(name="astm_ForCheckBeforeStatement")
ForStatement = Class(name="ForStatement")
astm_ForCheckAfterStatement = Class(name="astm_ForCheckAfterStatement")
astm_AggregateExpression = Class(name="astm_AggregateExpression")
astm_QualifiedOverPointer = Class(name="astm_QualifiedOverPointer")
QualifiedIdentifierReference = Class(name="QualifiedIdentifierReference")
astm_QualifiedOverData = Class(name="astm_QualifiedOverData")
astm_IntegerlLiteral = Class(name="astm_IntegerlLiteral")
Literal = Class(name="Literal")
astm_StringLiteral = Class(name="astm_StringLiteral")
astm_CharLiteral = Class(name="astm_CharLiteral")
astm_RealLiteral = Class(name="astm_RealLiteral")
astm_BooleanLiteral = Class(name="astm_BooleanLiteral")
astm_BitLiteral = Class(name="astm_BitLiteral")
astm_UnaryPlus = Class(name="astm_UnaryPlus")
UnaryOperator = Class(name="UnaryOperator")
astm_Negate = Class(name="astm_Negate")
astm_Not = Class(name="astm_Not")
astm_BitNot = Class(name="astm_BitNot")
astm_AddressOf = Class(name="astm_AddressOf")
astm_Deref = Class(name="astm_Deref")
astm_Increment = Class(name="astm_Increment")
astm_Decrement = Class(name="astm_Decrement")
astm_PostIncrement = Class(name="astm_PostIncrement")
astm_PostDecrement = Class(name="astm_PostDecrement")
astm_Add = Class(name="astm_Add")
astm_Subtract = Class(name="astm_Subtract")
astm_Multiply = Class(name="astm_Multiply")
astm_Divide = Class(name="astm_Divide")
astm_Modulus = Class(name="astm_Modulus")
astm_Exponent = Class(name="astm_Exponent")
astm_And = Class(name="astm_And")
astm_Or = Class(name="astm_Or")
astm_Equal = Class(name="astm_Equal")
astm_NotEqual = Class(name="astm_NotEqual")
astm_Greater = Class(name="astm_Greater")
astm_NotLess = Class(name="astm_NotLess")
astm_BitAnd = Class(name="astm_BitAnd")
astm_BitOr = Class(name="astm_BitOr")
astm_BitXor = Class(name="astm_BitXor")
astm_BitLeftShift = Class(name="astm_BitLeftShift")
astm_BitRightShift = Class(name="astm_BitRightShift")
astm_Assign = Class(name="astm_Assign")
astm_MissingActualParameter = Class(name="astm_MissingActualParameter")
astm_ByValueActualParameterExpression = Class(name="astm_ByValueActualParameterExpression")
ActualParameterExpression = Class(name="ActualParameterExpression")
astm_ByReferenceActualParameterExpression = Class(name="astm_ByReferenceActualParameterExpression")
astm_SpecificTriggerDefinition = Class(name="astm_SpecificTriggerDefinition")
astm_SpecificLessEqual = Class(name="astm_SpecificLessEqual")
astm_SpecificGreaterEqual = Class(name="astm_SpecificGreaterEqual")
astm_SpecificIn = Class(name="astm_SpecificIn")
astm_SpecificLike = Class(name="astm_SpecificLike")
astm_SpecificConcatString = Class(name="astm_SpecificConcatString")
astm_SpecificSelectStatement = Class(name="astm_SpecificSelectStatement")
astm_RDBDatabaseDefinition = Class(name="astm_RDBDatabaseDefinition")
astm_RDBTableSpaceReference = Class(name="astm_RDBTableSpaceReference")
astm_RDBUserDefinition = Class(name="astm_RDBUserDefinition")
astm_RDBTableSpaceDefinition = Class(name="astm_RDBTableSpaceDefinition")
astm_RDBTableDefinition = Class(name="astm_RDBTableDefinition")
astm_RDBColumnReference = Class(name="astm_RDBColumnReference")
astm_RDBColumnDefinition = Class(name="astm_RDBColumnDefinition")
astm_RDBConstraint = Class(name="astm_RDBConstraint")
astm_RDBIndex = Class(name="astm_RDBIndex")
astm_RDBTrigger = Class(name="astm_RDBTrigger")
astm_RDBColumnType = Class(name="astm_RDBColumnType", is_abstract=True)
astm_RDBViewDefinition = Class(name="astm_RDBViewDefinition")
astm_RDBCursorDefinition = Class(name="astm_RDBCursorDefinition")
astm_RDBIndexColumn = Class(name="astm_RDBIndexColumn")
astm_RDBCheckConstraint = Class(name="astm_RDBCheckConstraint")
RDBConstraint = Class(name="RDBConstraint")
astm_RDBRefIntegrity = Class(name="astm_RDBRefIntegrity")
astm_RDBTableReference = Class(name="astm_RDBTableReference")
astm_RDBUniqueKey = Class(name="astm_RDBUniqueKey")
astm_RDBConnectStatement = Class(name="astm_RDBConnectStatement")
astm_RDBSelectStatement = Class(name="astm_RDBSelectStatement")
astm_RDBSelectExpression = Class(name="astm_RDBSelectExpression")
astm_RDBHostVariableReference = Class(name="astm_RDBHostVariableReference")
astm_RDBInsertStatement = Class(name="astm_RDBInsertStatement")
astm_RDBModifyStatement = Class(name="astm_RDBModifyStatement", is_abstract=True)
astm_RDBUpdateStatement = Class(name="astm_RDBUpdateStatement")
RDBModifyStatement = Class(name="RDBModifyStatement")
astm_RDBCursorStatement = Class(name="astm_RDBCursorStatement", is_abstract=True)
astm_RDBOpenCursorStatement = Class(name="astm_RDBOpenCursorStatement")
RDBCursorStatement = Class(name="RDBCursorStatement")
astm_RDBFetchCursorStatement = Class(name="astm_RDBFetchCursorStatement")
astm_RDBString = Class(name="astm_RDBString")
astm_RDBRaw = Class(name="astm_RDBRaw")
IdentifierReference = Class(name="IdentifierReference")
astm_RDBTableAlias = Class(name="astm_RDBTableAlias")
astm_RDBDataBaseType = Class(name="astm_RDBDataBaseType")
astm_RDBUserType = Class(name="astm_RDBUserType")
astm_RDBTableSpaceType = Class(name="astm_RDBTableSpaceType")
astm_RDBTableType = Class(name="astm_RDBTableType")
astm_RDBViewType = Class(name="astm_RDBViewType")
astm_RDBCursorType = Class(name="astm_RDBCursorType")
astm_RDBInteger = Class(name="astm_RDBInteger")
RDBColumnType = Class(name="RDBColumnType")
astm_RDBInt = Class(name="astm_RDBInt")
astm_RDBReal = Class(name="astm_RDBReal")
astm_RDBFloat = Class(name="astm_RDBFloat")
astm_RDBDecimal = Class(name="astm_RDBDecimal")
astm_RDBNumber = Class(name="astm_RDBNumber")
astm_RDBLong = Class(name="astm_RDBLong")
astm_RDBChar = Class(name="astm_RDBChar")
astm_RDBVarchar = Class(name="astm_RDBVarchar")
astm_RDBDate = Class(name="astm_RDBDate")
astm_RDBTimestamp = Class(name="astm_RDBTimestamp")
astm_RDBRowid = Class(name="astm_RDBRowid")
astm_RDBBoolean = Class(name="astm_RDBBoolean")
astm_RDBBlob = Class(name="astm_RDBBlob")
astm_RDBClob = Class(name="astm_RDBClob")
astm_RDBNClob = Class(name="astm_RDBNClob")
astm_RDBBFile = Class(name="astm_RDBBFile")
astm_RDBDeleteStatement = Class(name="astm_RDBDeleteStatement")
astm_RDBCloseCursorStatement = Class(name="astm_RDBCloseCursorStatement")
astm_RDBHostVariableExpression = Class(name="astm_RDBHostVariableExpression")
astm_Visitable = Class(name="astm_Visitable", is_abstract=True)
...
astm_SourceLocation.attributes={astm_SourceLocation_startLine, astm_SourceLocation_endColumn, astm_SourceLocation_endLine, astm_SourceLocation_startColumn}
...
astm_FunctionMemberAttributes.attributes={astm_FunctionMemberAttributes_isFriend, astm_FunctionMemberAttributes_isThisConst, astm_FunctionMemberAttributes_isInline}
...
domain_model = DomainModel(
    name="astm",
    types={astm_GASTMObject, Visitable, astm_GASTMSourceObject, astm_GASTMSemanticObject, astm_OtherSyntaxObject, astm_StorageSpecification, astm_DataType, astm_AccessKind, astm_UnaryOperator, astm_BinaryOperator, astm_ActualParameter, astm_SourceFile, GASTMSourceObject, astm_SourceLocation, astm_CompilationUnit, astm_GlobalScope, astm_Scope, astm_DefinitionObject, astm_GASTMSyntaxObject, GASTMObject, astm_PreprocessorElement, astm_AnnotationExpression, OtherSyntaxObject, astm_ProgramScope, astm_Name, astm_DeclarationOrDefinition, DefinitionObject, astm_Definition, DeclarationOrDefinition, astm_Project, GASTMSemanticObject, astm_Declaration, astm_FunctionDeclaration, Declaration, astm_FormalParameterDeclaration, astm_FunctionMemberAttributes, astm_VariableDeclaration, astm_FunctionDefinition, Definition, astm_FormalParameterDefinition, astm_Statement, astm_FunctionScope, astm_VirtualSpecification, astm_EntryDefinition, astm_TypeReference, astm_DataDefinition, astm_Expression, astm_BitFieldDefinition, DataDefinition, astm_EnumLiteralDefinition, astm_TypeDefinition, astm_NamedTypeDefinition, TypeDefinition, astm_NamedType, astm_AggregateTypeDefinition, astm_AggregateType, astm_NameSpaceDefinition, astm_NameSpaceType, astm_LabelDefinition, astm_LabelType, astm_IncludeUnit, PreprocessorElement, astm_MacroCall, astm_Comment, astm_Type, GASTMSyntaxObject, astm_PrimitiveType, DataType, astm_EnumType, astm_ConstructedType, astm_AggregateScope, astm_ArrayType, ConstructedType, astm_Dimension, astm_FunctionType, Type, astm_FormalParameterType, astm_MacroDefinition, astm_ClassType, AggregateType, astm_DerivesFrom, astm_UnnamedTypeReference, TypeReference, astm_NamedTypeReference, astm_DeleteStatement, Statement, astm_DeclarationOrDefinitionStatement, astm_ExpressionStatement, astm_JumpStatement, astm_BreakStatement, astm_ContinueStatement, astm_LabeledStatement, astm_BlockStatement, astm_BlockScope, astm_EmptyStatement, astm_IfStatement, astm_SwitchStatement, astm_SwitchCase, astm_CaseBlock, SwitchCase, astm_ReturnStatement, astm_LabelAccess, astm_ForStatement, LoopStatement, astm_TryStatement, astm_CatchBlock, astm_TypesCatchBlock, CatchBlock, astm_VariableCatchBlock, astm_ThrowStatement, astm_NameReference, Expression, astm_LoopStatement, astm_ArrayAccess, astm_QualifiedIdentifierReference, NameReference, astm_IdentifierReference, astm_TypeQualifiedIdentifierReference, astm_Literal, astm_CastExpression, astm_UnaryExpression, astm_BinaryExpression, astm_OperatorAssign, BinaryOperator, astm_ConditionalExpression, astm_RangeExpression, astm_FunctionCallExpression, astm_ActualParameterExpression, ActualParameter, astm_NewExpression, Scope, astm_VariableDefinition, astm_FunctionMemberAttribute, astm_External, StorageSpecification, astm_FunctionPersistent, astm_FileLocal, astm_PerClassMember, astm_NoDef, astm_Virtual, VirtualSpecification, astm_PureVirtual, astm_NonVirtual, astm_ExceptionType, astm_Void, PrimitiveType, astm_Byte, astm_ShortInteger, astm_Protected, astm_Double, astm_Integer, astm_LongDouble, astm_Character, astm_String, astm_Boolean, astm_WideCharacter, astm_CollectionType, astm_PointerType, astm_ReferenceType, astm_RangeType, astm_StructureType, astm_UnionType, astm_AnnotationType, astm_ByValueFormalParameterType, FormalParameterType, astm_ByReferenceFormalParameterType, astm_Public, AccessKind, astm_LongInteger, astm_Float, astm_NotGreater, astm_Less, astm_Private, astm_TerminateStatement, astm_DefaultBlock, astm_WhileStatement, astm_DoWhileStatement, astm_ForCheckBeforeStatement, ForStatement, astm_ForCheckAfterStatement, astm_AggregateExpression, astm_QualifiedOverPointer, QualifiedIdentifierReference, astm_QualifiedOverData, astm_IntegerlLiteral, Literal, astm_StringLiteral, astm_CharLiteral, astm_RealLiteral, astm_BooleanLiteral, astm_BitLiteral, astm_UnaryPlus, UnaryOperator, astm_Negate, astm_Not, astm_BitNot, astm_AddressOf, astm_Deref, astm_Increment, astm_Decrement, astm_PostIncrement, astm_PostDecrement, astm_Add, astm_Subtract, astm_Multiply, astm_Divide, astm_Modulus, astm_Exponent, astm_And, astm_Or, astm_Equal, astm_NotEqual, astm_Greater, astm_NotLess, astm_BitAnd, astm_BitOr, astm_BitXor, astm_BitLeftShift, astm_BitRightShift, astm_Assign, astm_MissingActualParameter, astm_ByValueActualParameterExpression, ActualParameterExpression, astm_ByReferenceActualParameterExpression, astm_SpecificTriggerDefinition, astm_SpecificLessEqual, astm_SpecificGreaterEqual, astm_SpecificIn, astm_SpecificLike, astm_SpecificConcatString, astm_SpecificSelectStatement, astm_RDBDatabaseDefinition, astm_RDBTableSpaceReference, astm_RDBUserDefinition, astm_RDBTableSpaceDefinition, astm_RDBTableDefinition, astm_RDBColumnReference, astm_RDBColumnDefinition, astm_RDBConstraint, astm_RDBIndex, astm_RDBTrigger, astm_RDBColumnType, astm_RDBViewDefinition, astm_RDBCursorDefinition, astm_RDBIndexColumn, astm_RDBCheckConstraint, RDBConstraint, astm_RDBRefIntegrity, astm_RDBTableReference, astm_RDBUniqueKey, astm_RDBConnectStatement, astm_RDBSelectStatement, astm_RDBSelectExpression, astm_RDBHostVariableReference, astm_RDBInsertStatement, astm_RDBModifyStatement, astm_RDBUpdateStatement, RDBModifyStatement, astm_RDBCursorStatement, astm_RDBOpenCursorStatement, RDBCursorStatement, astm_RDBFetchCursorStatement, astm_RDBString, astm_RDBRaw, IdentifierReference, astm_RDBTableAlias, astm_RDBDataBaseType, astm_RDBUserType, astm_RDBTableSpaceType, astm_RDBTableType, astm_RDBViewType, astm_RDBCursorType, astm_RDBInteger, RDBColumnType, astm_RDBInt, astm_RDBReal, astm_RDBFloat, astm_RDBDecimal, astm_RDBNumber, astm_RDBLong, astm_RDBChar, astm_RDBVarchar, astm_RDBDate, astm_RDBTimestamp, astm_RDBRowid, astm_RDBBoolean, astm_RDBBlob, astm_RDBClob, astm_RDBNClob, astm_RDBBFile, astm_RDBDeleteStatement, astm_RDBCloseCursorStatement, astm_RDBHostVariableExpression, astm_Visitable},
    associations={inSourceFile0, files1, outerScope2, definitionObject4, childScope6, locationInfo8, preProcessorElements10, annotations12, fragments14, opensScope17, storageSpecifiers19, accessKind20, identifierName23, defRef26, identifierName28, declarationType31, formalParameters34, functionMemberAttributes35, returnType37, formalParameters39, body41, functionMemberAttributes43, opensScope46, virtualSpecifier48, formalParameters50, definitionType24, initialValue55, bitFieldSize56, value58, name60, definitionType62, aggregateType63, nameSpace64, body66, nameSpaceType69, labelName71, labelType73, file75, body52, enumLiterals78, baseType80, members82, opensScope85, ranks87, lowBound88, highBound91, returnType94, refersTo77, type98, body101, derivesFrom103, accessKind104, className107, type110, name112, type114, operand117, declOrDefn119, expression121, target123, parameterTypes96, target126, label128, statement130, subStatements133, opensScope135, condition137, thenBody139, elseBody142, switchExpression145, cases147, body149, caseExpressions152, target125, condition156, body158, initBody161, iterationBody163, guardedStatement166, catchBlocks168, finalStatement170, body173, exceptions176, exceptionVariable178, exception180, expressionType182, name185, returnValue154, arrayName190, subscripts192, qualifiers195, member197, aggregateType199, member201, castType204, expression206, operator209, operand211, operator214, leftOperand216, rightOperand219, operator222, refersTo187, condition224, memberValues257, onTrueOperand226, onFalseOperand229, fromExpression232, toExpression234, calledFunction237, actualParams239, value241, newType243, actualParams245, name248, definition251, annotationType254, Constraint270, body260, TableSpace262, Owns263, Table265, PrimKey267, Column268, Column300, Index272, Trigger274, name276, type279, DefinedBy281, SelectExpression283, IndexColumn285, Column288, body290, ForeignKey293, ParentKey295, ParentTable298, ConnectString302, SelectExpression304, IntoVariable305, IntoTable307, Columns309, Values312, Table315, Where317, Values320, Cursor322, Values324, Into326, BaseVariable328, Indicator331, Table334, Column337, Where340, Alias343, Table346},
    generalizations={gen_astm_GASTMObject_Visitable, gen_astm_GASTMSourceObject_Visitable, gen_astm_GASTMSemanticObject_Visitable, gen_astm_OtherSyntaxObject_Visitable, gen_astm_StorageSpecification_Visitable, gen_astm_DataType_Visitable, gen_astm_AccessKind_Visitable, gen_astm_UnaryOperator_Visitable, gen_astm_BinaryOperator_Visitable, gen_astm_ActualParameter_Visitable, gen_astm_SourceFile_GASTMSourceObject, gen_astm_SourceLocation_GASTMSourceObject, gen_astm_Scope_GASTMSemanticObject, gen_astm_GASTMSyntaxObject_GASTMObject, gen_astm_CompilationUnit_OtherSyntaxObject, gen_astm_Name_OtherSyntaxObject, gen_astm_DeclarationOrDefinition_DefinitionObject, gen_astm_Definition_DeclarationOrDefinition, gen_astm_Project_GASTMSemanticObject, gen_astm_Declaration_DeclarationOrDefinition, gen_astm_FunctionDeclaration_Declaration, gen_astm_VariableDeclaration_Declaration, gen_astm_FunctionDefinition_Definition, gen_astm_FunctionMemberAttributes_Visitable, gen_astm_EntryDefinition_Definition, gen_astm_DataDefinition_Definition, gen_astm_BitFieldDefinition_DataDefinition, gen_astm_EnumLiteralDefinition_Definition, gen_astm_TypeDefinition_DefinitionObject, gen_astm_NamedTypeDefinition_TypeDefinition, gen_astm_AggregateTypeDefinition_TypeDefinition, gen_astm_NameSpaceDefinition_DefinitionObject, gen_astm_LabelDefinition_DefinitionObject, gen_astm_IncludeUnit_PreprocessorElement, gen_astm_MacroCall_PreprocessorElement, gen_astm_MacroDefinition_PreprocessorElement, gen_astm_Comment_PreprocessorElement, gen_astm_Type_GASTMSyntaxObject, gen_astm_PrimitiveType_DataType, gen_astm_EnumType_DataType, gen_astm_ConstructedType_DataType, gen_astm_AggregateType_DataType, gen_astm_ArrayType_ConstructedType, gen_astm_Dimension_OtherSyntaxObject, gen_astm_FunctionType_Type, gen_astm_NamedType_DataType, gen_astm_ClassType_AggregateType, gen_astm_DerivesFrom_OtherSyntaxObject, gen_astm_UnnamedTypeReference_TypeReference, gen_astm_NamedTypeReference_TypeReference, gen_astm_DeleteStatement_Statement, gen_astm_DeclarationOrDefinitionStatement_Statement, gen_astm_ExpressionStatement_Statement, gen_astm_JumpStatement_Statement, gen_astm_BreakStatement_Statement, gen_astm_FormalParameterType_DataType, gen_astm_ContinueStatement_Statement, gen_astm_LabeledStatement_Statement, gen_astm_BlockStatement_Statement, gen_astm_EmptyStatement_Statement, gen_astm_IfStatement_Statement, gen_astm_SwitchStatement_Statement, gen_astm_SwitchCase_OtherSyntaxObject, gen_astm_CaseBlock_SwitchCase, gen_astm_ReturnStatement_Statement, gen_astm_ForStatement_LoopStatement, gen_astm_TryStatement_Statement, gen_astm_CatchBlock_OtherSyntaxObject, gen_astm_TypesCatchBlock_CatchBlock, gen_astm_VariableCatchBlock_CatchBlock, gen_astm_ThrowStatement_Statement, gen_astm_Expression_GASTMSyntaxObject, gen_astm_NameReference_Expression, gen_astm_LoopStatement_Statement, gen_astm_ArrayAccess_Expression, gen_astm_QualifiedIdentifierReference_NameReference, gen_astm_TypeQualifiedIdentifierReference_NameReference, gen_astm_Literal_Expression, gen_astm_CastExpression_Expression, gen_astm_UnaryExpression_Expression, gen_astm_BinaryExpression_Expression, gen_astm_OperatorAssign_BinaryOperator, gen_astm_ConditionalExpression_Expression, gen_astm_RangeExpression_Expression, gen_astm_FunctionCallExpression_Expression, gen_astm_ActualParameterExpression_ActualParameter, gen_astm_NewExpression_Expression, gen_astm_LabelAccess_Expression, gen_astm_AnnotationExpression_Expression, gen_astm_GlobalScope_Scope, gen_astm_PreprocessorElement_GASTMSyntaxObject, gen_astm_DefinitionObject_GASTMSyntaxObject, gen_astm_ProgramScope_Scope, gen_astm_TypeReference_Type, gen_astm_Statement_GASTMSyntaxObject, gen_astm_FunctionScope_Scope, gen_astm_NameSpaceType_Type, gen_astm_LabelType_Type, gen_astm_AggregateScope_Scope, gen_astm_BlockScope_Scope, gen_astm_IdentifierReference_NameReference, gen_astm_FormalParameterDefinition_DataDefinition, gen_astm_VirtualSpecification_OtherSyntaxObject, gen_astm_FormalParameterDeclaration_Declaration, gen_astm_VariableDefinition_DataDefinition, gen_astm_FunctionMemberAttribute_OtherSyntaxObject, gen_astm_External_StorageSpecification, gen_astm_FunctionPersistent_StorageSpecification, gen_astm_FileLocal_StorageSpecification, gen_astm_PerClassMember_StorageSpecification, gen_astm_NoDef_StorageSpecification, gen_astm_Virtual_VirtualSpecification, gen_astm_PureVirtual_VirtualSpecification, gen_astm_NonVirtual_VirtualSpecification, gen_astm_ExceptionType_DataType, gen_astm_Void_PrimitiveType, gen_astm_Byte_PrimitiveType, gen_astm_ShortInteger_PrimitiveType, gen_astm_Protected_AccessKind, gen_astm_Double_PrimitiveType, gen_astm_Integer_PrimitiveType, gen_astm_LongDouble_PrimitiveType, gen_astm_Character_PrimitiveType, gen_astm_String_PrimitiveType, gen_astm_Boolean_PrimitiveType, gen_astm_WideCharacter_PrimitiveType, gen_astm_CollectionType_ConstructedType, gen_astm_PointerType_ConstructedType, gen_astm_ReferenceType_ConstructedType, gen_astm_RangeType_ConstructedType, gen_astm_StructureType_AggregateType, gen_astm_UnionType_AggregateType, gen_astm_AnnotationType_AggregateType, gen_astm_ByValueFormalParameterType_FormalParameterType, gen_astm_ByReferenceFormalParameterType_FormalParameterType, gen_astm_Public_AccessKind, gen_astm_LongInteger_PrimitiveType, gen_astm_Float_PrimitiveType, gen_astm_NotGreater_BinaryOperator, gen_astm_Private_AccessKind, gen_astm_TerminateStatement_Statement, gen_astm_DefaultBlock_SwitchCase, gen_astm_WhileStatement_LoopStatement, gen_astm_DoWhileStatement_LoopStatement, gen_astm_ForCheckBeforeStatement_ForStatement, gen_astm_ForCheckAfterStatement_ForStatement, gen_astm_AggregateExpression_Expression, gen_astm_QualifiedOverPointer_QualifiedIdentifierReference, gen_astm_QualifiedOverData_QualifiedIdentifierReference, gen_astm_IntegerlLiteral_Literal, gen_astm_StringLiteral_Literal, gen_astm_CharLiteral_Literal, gen_astm_RealLiteral_Literal, gen_astm_BooleanLiteral_Literal, gen_astm_BitLiteral_Literal, gen_astm_UnaryPlus_UnaryOperator, gen_astm_Negate_UnaryOperator, gen_astm_Not_UnaryOperator, gen_astm_BitNot_UnaryOperator, gen_astm_AddressOf_UnaryOperator, gen_astm_Deref_UnaryOperator, gen_astm_Increment_UnaryOperator, gen_astm_Decrement_UnaryOperator, gen_astm_PostIncrement_UnaryOperator, gen_astm_PostDecrement_UnaryOperator, gen_astm_Add_BinaryOperator, gen_astm_Subtract_BinaryOperator, gen_astm_Multiply_BinaryOperator, gen_astm_Divide_BinaryOperator, gen_astm_Modulus_BinaryOperator, gen_astm_Exponent_BinaryOperator, gen_astm_And_BinaryOperator, gen_astm_Or_BinaryOperator, gen_astm_Equal_BinaryOperator, gen_astm_NotEqual_BinaryOperator, gen_astm_Greater_BinaryOperator, gen_astm_Less_BinaryOperator, gen_astm_NotLess_BinaryOperator, gen_astm_BitAnd_BinaryOperator, gen_astm_BitOr_BinaryOperator, gen_astm_BitXor_BinaryOperator, gen_astm_BitLeftShift_BinaryOperator, gen_astm_BitRightShift_BinaryOperator, gen_astm_Assign_BinaryOperator, gen_astm_MissingActualParameter_ActualParameter, gen_astm_ByValueActualParameterExpression_ActualParameterExpression, gen_astm_ByReferenceActualParameterExpression_ActualParameterExpression, gen_astm_SpecificTriggerDefinition_Definition, gen_astm_SpecificLessEqual_BinaryOperator, gen_astm_SpecificGreaterEqual_BinaryOperator, gen_astm_SpecificIn_BinaryOperator, gen_astm_SpecificLike_BinaryOperator, gen_astm_SpecificConcatString_BinaryOperator, gen_astm_SpecificSelectStatement_Statement, gen_astm_RDBDatabaseDefinition_Definition, gen_astm_RDBTableSpaceReference_Visitable, gen_astm_RDBUserDefinition_Definition, gen_astm_RDBTableSpaceDefinition_Definition, gen_astm_RDBTableDefinition_Definition, gen_astm_RDBColumnDefinition_Definition, gen_astm_RDBViewDefinition_Definition, gen_astm_RDBCursorDefinition_Definition, gen_astm_RDBIndex_OtherSyntaxObject, gen_astm_RDBIndexColumn_OtherSyntaxObject, gen_astm_RDBTrigger_OtherSyntaxObject, gen_astm_RDBTrigger_Definition, gen_astm_RDBConstraint_OtherSyntaxObject, gen_astm_RDBCheckConstraint_RDBConstraint, gen_astm_RDBRefIntegrity_RDBConstraint, gen_astm_RDBUniqueKey_RDBConstraint, gen_astm_RDBConnectStatement_Statement, gen_astm_RDBSelectStatement_Statement, gen_astm_RDBInsertStatement_Statement, gen_astm_RDBModifyStatement_Statement, gen_astm_RDBUpdateStatement_RDBModifyStatement, gen_astm_RDBCursorStatement_Statement, gen_astm_RDBOpenCursorStatement_RDBCursorStatement, gen_astm_RDBFetchCursorStatement_RDBCursorStatement, gen_astm_RDBString_RDBColumnType, gen_astm_RDBHostVariableReference_Visitable, gen_astm_RDBSelectExpression_Expression, gen_astm_RDBTableReference_IdentifierReference, gen_astm_RDBTableAlias_IdentifierReference, gen_astm_RDBColumnReference_IdentifierReference, gen_astm_RDBDataBaseType_DataType, gen_astm_RDBUserType_DataType, gen_astm_RDBTableSpaceType_DataType, gen_astm_RDBTableType_DataType, gen_astm_RDBViewType_DataType, gen_astm_RDBCursorType_DataType, gen_astm_RDBColumnType_DataType, gen_astm_RDBInteger_RDBColumnType, gen_astm_RDBInt_RDBColumnType, gen_astm_RDBReal_RDBColumnType, gen_astm_RDBFloat_RDBColumnType, gen_astm_RDBDecimal_RDBColumnType, gen_astm_RDBNumber_RDBColumnType, gen_astm_RDBLong_RDBColumnType, gen_astm_RDBChar_RDBColumnType, gen_astm_RDBVarchar_RDBColumnType, gen_astm_RDBRaw_RDBColumnType, gen_astm_RDBDate_RDBColumnType, gen_astm_RDBTimestamp_RDBColumnType, gen_astm_RDBRowid_RDBColumnType, gen_astm_RDBBoolean_RDBColumnType, gen_astm_RDBBlob_RDBColumnType, gen_astm_RDBClob_RDBColumnType, gen_astm_RDBNClob_RDBColumnType, gen_astm_RDBBFile_RDBColumnType, gen_astm_RDBDeleteStatement_RDBModifyStatement, gen_astm_RDBCloseCursorStatement_RDBCursorStatement, gen_astm_RDBHostVariableExpression_Expression},
    metadata=None
)
