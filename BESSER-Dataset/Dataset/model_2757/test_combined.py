...
def test_hyp_test_compo_is_not_abstract():
    assert not inspect.isabstract(test_Compo)


def test_hyp_test_compo_constructor_exists():
    assert callable(test_Compo.__init__)


def test_hyp_test_compo_constructor_args():
...
def test_hyp_test_a_listen_setter(instance):
...
def test_hyp_test_b_name_setter(instance):
