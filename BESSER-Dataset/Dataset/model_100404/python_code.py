...
class RegularState:
    ...
    pass
class sgraph_State(RegularState, ScopedElement, ReactiveElement, ExpressionElement):

    def __init__(self, orthogonal: bool, substatechartId: str, submachine: bool, simple: bool, leaf: bool, composite: bool, sgraph_State: set["sgraph_Region"] = None, sgraph_State28: "sgraph_Statechart" = None):
...
class sgraph_Declaration(NamedElement):
    ...
    pass
class sgraph_Statechart(ScopedElement, ReactiveElement, NamedElement, ExpressionElement):
