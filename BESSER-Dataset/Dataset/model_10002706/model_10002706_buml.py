...
domain_model = DomainModel(
    name="d08d7f80_55ba_48a9_8798_f9a2139a7fbc",
    ...
    associations={Login_Add_Student, Login_Add_Instructor, Login_Add_Course, Login_Add_Evalutaions_Assignments_Exams, Login_Generate_Report, Login_Register_drop_course, Login_View_Grades, Submit_Exam_Assignment_Login, Admin_Login, Admin_Logout, Instructor_Logout, Student_Logout, Instructor_Login, Login_Student, School_Admin_Course, Student_Course, Exam_Question, Question_Answer, Course_Exam},
    generalizations={},
    metadata=None
)
