...
public class xhtml_Block  {
    ...
    public xhtml_Block(
        String group        ArrayList<xhtml_AddressType> xhtml_addresstypes,        ArrayList<xhtml_DelType> xhtml_deltypes,        ArrayList<xhtml_H2Type> xhtml_h2types,        ArrayList<xhtml_H4Type> xhtml_h4types,        ArrayList<xhtml_H6Type> xhtml_h6types,        ArrayList<xhtml_PType> xhtml_ptypes,        ArrayList<xhtml_H1Type> xhtml_h1types,        ArrayList<xhtml_H5Type> xhtml_h5types,        ArrayList<xhtml_InsType> xhtml_instypes,        ArrayList<xhtml_H3Type> xhtml_h3types    ) {
        this.group = group;
