...
# Classes
spem_ExtensibleElement = Class(name="spem_ExtensibleElement", is_abstract=True)
spem_Kind = Class(name="spem_Kind")
ExtensibleElement = Class(name="ExtensibleElement")
spem_WorkDefinitionPerformer = Class(name="spem_WorkDefinitionPerformer", is_abstract=True)
spem_WorkDefinition = Class(name="spem_WorkDefinition", is_abstract=True)
spem_BreakdownElement = Class(name="spem_BreakdownElement", is_abstract=True)
ProcessElement = Class(name="ProcessElement")
spem_PlanningData = Class(name="spem_PlanningData")
spem_WorkBreakdownElement = Class(name="spem_WorkBreakdownElement", is_abstract=True)
BreakdownElement = Class(name="BreakdownElement")
spem_WorkSequence = Class(name="spem_WorkSequence")
spem_WorkDefinitionParameter = Class(name="spem_WorkDefinitionParameter")
spem_ProcessParameter = Class(name="spem_ProcessParameter")
spem_MethodConfiguration = Class(name="spem_MethodConfiguration")
spem_ProcessPerformer = Class(name="spem_ProcessPerformer")
WorkDefinitionPerformer = Class(name="WorkDefinitionPerformer")
spem_RoleUse = Class(name="spem_RoleUse")
spem_TaskUse = Class(name="spem_TaskUse")
MethodContentUse = Class(name="MethodContentUse")
spem_RoleDefinition = Class(name="spem_RoleDefinition")
spem_Qualification = Class(name="spem_Qualification")
spem_ProcessResponsibilityAssignment = Class(name="spem_ProcessResponsibilityAssignment")
spem_WorkProductUse = Class(name="spem_WorkProductUse")
spem_Activity = Class(name="spem_Activity")
...
spem_Milestone = Class(name="spem_Milestone")
spem_ProcessElement = Class(name="spem_ProcessElement", is_abstract=True)
DescribableElement = Class(name="DescribableElement")
ProcessPackageableElement = Class(name="ProcessPackageableElement")
spem_ProcessKind = Class(name="spem_ProcessKind", is_abstract=True)
spem_DescribableElement = Class(name="spem_DescribableElement", is_abstract=True)
spem_Guidance = Class(name="spem_Guidance")
spem_Metric = Class(name="spem_Metric")
spem_Category = Class(name="spem_Category")
MethodContentElement = Class(name="MethodContentElement")
spem_WorkProductDefinition = Class(name="spem_WorkProductDefinition")
spem_WorkProductUseRelationship = Class(name="spem_WorkProductUseRelationship")
spem_MethodContentElement = Class(name="spem_MethodContentElement", is_abstract=True)
MethodContentPackageableElement = Class(name="MethodContentPackageableElement")
spem_MethodContentKind = Class(name="spem_MethodContentKind", is_abstract=True)
spem_ToolDefinition = Class(name="spem_ToolDefinition")
spem_TaskDefinition = Class(name="spem_TaskDefinition")
spem_Default_TaskDefinitionParameter = Class(name="spem_Default_TaskDefinitionParameter")
spem_Step = Class(name="spem_Step")
spem_WorkProductDefinitionRelationship = Class(name="spem_WorkProductDefinitionRelationship")
spem_Default_ResponsibilityAssignment = Class(name="spem_Default_ResponsibilityAssignment")
spem_MethodContentPackageableElement = Class(name="spem_MethodContentPackageableElement", is_abstract=True)
spem_ProcessPackageableElement = Class(name="spem_ProcessPackageableElement", is_abstract=True)
spem_MethodContentPackage = Class(name="spem_MethodContentPackage")
MethodPluginPackageableElement = Class(name="MethodPluginPackageableElement")
spem_ProcessPackage = Class(name="spem_ProcessPackage")
Kind = Class(name="Kind")
spem_Default_TaskDefinitionPerformer = Class(name="spem_Default_TaskDefinitionPerformer")
spem_CompositeRole = Class(name="spem_CompositeRole")
RoleUse = Class(name="RoleUse")
spem_TeamProfile = Class(name="spem_TeamProfile")
spem_VariabilityElement = Class(name="spem_VariabilityElement", is_abstract=True)
spem_ProcessComponent = Class(name="spem_ProcessComponent")
ProcessPackage = Class(name="ProcessPackage")
spem_WorkProductPort = Class(name="spem_WorkProductPort")
spem_ProcessComponentUse = Class(name="spem_ProcessComponentUse")
spem_MethodContentUse = Class(name="spem_MethodContentUse", is_abstract=True)
spem_MethodPlugin = Class(name="spem_MethodPlugin")
spem_MethodLibrary = Class(name="spem_MethodLibrary")
spem_WorkProductPortConnector = Class(name="spem_WorkProductPortConnector")
spem_MethodLibraryPackageableElement = Class(name="spem_MethodLibraryPackageableElement", is_abstract=True)
spem_MethodPluginPackageableElement = Class(name="spem_MethodPluginPackageableElement", is_abstract=True)
MethodLibraryPackageableElement = Class(name="MethodLibraryPackageableElement")
spem_uma_Artifact = Class(name="spem_uma_Artifact")
WorkProductUse = Class(name="WorkProductUse")
Artifact = Class(name="Artifact")
spem_uma_Discipline = Class(name="spem_uma_Discipline")
spem_uma_CapabilityPattern = Class(name="spem_uma_CapabilityPattern")
Process = Class(name="Process")
uma_spem_TaskDefinition = Class(name="uma_spem_TaskDefinition")
spem_uma_Checklist = Class(name="spem_uma_Checklist")
Guidance = Class(name="Guidance")
spem_uma_Concept = Class(name="spem_uma_Concept")
spem_uma_CategoryPackage = Class(name="spem_uma_CategoryPackage")
MethodContentPackage = Class(name="MethodContentPackage")
spem_uma_CustomCategory = Class(name="spem_uma_CustomCategory")
spem_uma_DisciplineGrouping = Class(name="spem_uma_DisciplineGrouping")
Category = Class(name="Category")
spem_uma_Deliverable = Class(name="spem_uma_Deliverable")
spem_uma_Root = Class(name="spem_uma_Root")
uma_spem_MethodConfiguration = Class(name="uma_spem_MethodConfiguration")
uma_spem_WorkProductUse = Class(name="uma_spem_WorkProductUse")
uma_spem_MethodLibrary = Class(name="uma_spem_MethodLibrary")
uma_spem_MethodPlugin = Class(name="uma_spem_MethodPlugin")
spem_uma_Process = Class(name="spem_uma_Process")
Activity = Class(name="Activity")
CapabilityPattern = Class(name="CapabilityPattern")
uma_spem_WorkProductPortConnector = Class(name="uma_spem_WorkProductPortConnector")
spem_uma_DeliveryProcess = Class(name="spem_uma_DeliveryProcess")
SupportingMaterial = Class(name="SupportingMaterial")
spem_uma_ProcessPlanningTemplate = Class(name="spem_uma_ProcessPlanningTemplate")
spem_uma_Report = Class(name="spem_uma_Report")
spem_uma_ReusableAsset = Class(name="spem_uma_ReusableAsset")
spem_uma_Roadmap = Class(name="spem_uma_Roadmap")
spem_uma_Template = Class(name="spem_uma_Template")
spem_uma_TermDefinition = Class(name="spem_uma_TermDefinition")
spem_uma_ToolMentor = Class(name="spem_uma_ToolMentor")
spem_uma_Whitepaper = Class(name="spem_uma_Whitepaper")
Concept = Class(name="Concept")
spem_uma_Guideline = Class(name="spem_uma_Guideline")
spem_uma_SupportingMaterial = Class(name="spem_uma_SupportingMaterial")
spem_uma_Domain = Class(name="spem_uma_Domain")
spem_uma_RoleDefinitionPackage = Class(name="spem_uma_RoleDefinitionPackage")
uma_spem_WorkProductDefinition = Class(name="uma_spem_WorkProductDefinition")
spem_uma_TaskDefinitionPackage = Class(name="spem_uma_TaskDefinitionPackage")
spem_uma_EstimatingConsideration = Class(name="spem_uma_EstimatingConsideration")
spem_uma_Example = Class(name="spem_uma_Example")
spem_uma_Iteration = Class(name="spem_uma_Iteration")
spem_uma_Outcome = Class(name="spem_uma_Outcome")
spem_uma_Phase = Class(name="spem_uma_Phase")
spem_uma_Practice = Class(name="spem_uma_Practice")
Practice = Class(name="Practice")
uma_spem_Activity = Class(name="uma_spem_Activity")
uma_spem_MethodContentElement = Class(name="uma_spem_MethodContentElement")
spem_activity_Node = Class(name="spem_activity_Node", is_abstract=True)
Edge = Class(name="Edge")
spem_activity_Edge = Class(name="spem_activity_Edge")
activity_spem_BreakdownElement = Class(name="activity_spem_BreakdownElement")
spem_activity_StartNode = Class(name="spem_activity_StartNode")
Node = Class(name="Node")
spem_activity_EndNode = Class(name="spem_activity_EndNode")
spem_activity_ForkNode = Class(name="spem_activity_ForkNode")
spem_activity_JoinNode = Class(name="spem_activity_JoinNode")
spem_activity_DecisionNode = Class(name="spem_activity_DecisionNode")
spem_uma_WorkProductDefinitionPackage = Class(name="spem_uma_WorkProductDefinitionPackage")
spem_uma_GuidancePackage = Class(name="spem_uma_GuidancePackage")
spem_uma_DisciplinePackage = Class(name="spem_uma_DisciplinePackage")
spem_uma_DomainPackage = Class(name="spem_uma_DomainPackage")
spem_uma_WorkProductKindPackage = Class(name="spem_uma_WorkProductKindPackage")
spem_uma_RoleSetPackage = Class(name="spem_uma_RoleSetPackage")
spem_uma_ToolDefinitionPackage = Class(name="spem_uma_ToolDefinitionPackage")
spem_uma_ConfigurationPackage = Class(name="spem_uma_ConfigurationPackage")
spem_uma_CapabilityPatternPackage = Class(name="spem_uma_CapabilityPatternPackage")
spem_uma_DeliveryProcessPackage = Class(name="spem_uma_DeliveryProcessPackage")
spem_uma_RoleSet = Class(name="spem_uma_RoleSet")
uma_spem_RoleDefinition = Class(name="uma_spem_RoleDefinition")
spem_uma_QualificationPackage = Class(name="spem_uma_QualificationPackage")
spem_uma_ProcessComponentPackage = Class(name="spem_uma_ProcessComponentPackage")
spem_uma_WorkProductKind = Class(name="spem_uma_WorkProductKind")
...
spem_BreakdownElement.attributes={spem_BreakdownElement_isOptional, spem_BreakdownElement_isPlanned, spem_BreakdownElement_hasMultipleOccurrences}
...
spem_PlanningData.attributes={spem_PlanningData_finishDate, spem_PlanningData_rank, spem_PlanningData_duration, spem_PlanningData_startDate}
...
spem_WorkBreakdownElement.attributes={spem_WorkBreakdownElement_isOngoing, spem_WorkBreakdownElement_isRepeatable, spem_WorkBreakdownElement_isEventDriven}
...
spem_DescribableElement.attributes={spem_DescribableElement_briefDescription, spem_DescribableElement_changeDate, spem_DescribableElement_changeDescription, spem_DescribableElement_author, spem_DescribableElement_purpose, spem_DescribableElement_copyright, spem_DescribableElement_presentationName, spem_DescribableElement_mainDescription, spem_DescribableElement_version}
...
spem_uma_DeliveryProcess.attributes={spem_uma_DeliveryProcess_riskLevel, spem_uma_DeliveryProcess_typeOfContract, spem_uma_DeliveryProcess_projectMemberExpertise, spem_uma_DeliveryProcess_estimatingTechnique, spem_uma_DeliveryProcess_scale, spem_uma_DeliveryProcess_projectCharacteristics}
...
spem_uma_Practice.attributes={spem_uma_Practice_background, spem_uma_Practice_levelOfAdoption, spem_uma_Practice_application, spem_uma_Practice_problem, spem_uma_Practice_additionalInfo, spem_uma_Practice_goal}
...
domain_model = DomainModel(
    name="spem",
    types={spem_ExtensibleElement, spem_Kind, ExtensibleElement, spem_WorkDefinitionPerformer, spem_WorkDefinition, spem_BreakdownElement, ProcessElement, spem_PlanningData, spem_WorkBreakdownElement, BreakdownElement, spem_WorkSequence, spem_WorkDefinitionParameter, spem_ProcessParameter, spem_MethodConfiguration, spem_ProcessPerformer, WorkDefinitionPerformer, spem_RoleUse, spem_TaskUse, MethodContentUse, spem_RoleDefinition, spem_Qualification, spem_ProcessResponsibilityAssignment, spem_WorkProductUse, spem_Activity, WorkDefinition, WorkBreakdownElement, VariabilityElement, WorkDefinitionParameter, spem_Milestone, spem_ProcessElement, DescribableElement, ProcessPackageableElement, spem_ProcessKind, spem_DescribableElement, spem_Guidance, spem_Metric, spem_Category, MethodContentElement, spem_WorkProductDefinition, spem_WorkProductUseRelationship, spem_MethodContentElement, MethodContentPackageableElement, spem_MethodContentKind, spem_ToolDefinition, spem_TaskDefinition, spem_Default_TaskDefinitionParameter, spem_Step, spem_WorkProductDefinitionRelationship, spem_Default_ResponsibilityAssignment, spem_MethodContentPackageableElement, spem_ProcessPackageableElement, spem_MethodContentPackage, MethodPluginPackageableElement, spem_ProcessPackage, Kind, spem_Default_TaskDefinitionPerformer, spem_CompositeRole, RoleUse, spem_TeamProfile, spem_VariabilityElement, spem_ProcessComponent, ProcessPackage, spem_WorkProductPort, spem_ProcessComponentUse, spem_MethodContentUse, spem_MethodPlugin, spem_MethodLibrary, spem_WorkProductPortConnector, spem_MethodLibraryPackageableElement, spem_MethodPluginPackageableElement, MethodLibraryPackageableElement, spem_uma_Artifact, WorkProductUse, Artifact, spem_uma_Discipline, spem_uma_CapabilityPattern, Process, uma_spem_TaskDefinition, spem_uma_Checklist, Guidance, spem_uma_Concept, spem_uma_CategoryPackage, MethodContentPackage, spem_uma_CustomCategory, spem_uma_DisciplineGrouping, Category, spem_uma_Deliverable, spem_uma_Root, uma_spem_MethodConfiguration, uma_spem_WorkProductUse, uma_spem_MethodLibrary, uma_spem_MethodPlugin, spem_uma_Process, Activity, CapabilityPattern, uma_spem_WorkProductPortConnector, spem_uma_DeliveryProcess, SupportingMaterial, spem_uma_ProcessPlanningTemplate, spem_uma_Report, spem_uma_ReusableAsset, spem_uma_Roadmap, spem_uma_Template, spem_uma_TermDefinition, spem_uma_ToolMentor, spem_uma_Whitepaper, Concept, spem_uma_Guideline, spem_uma_SupportingMaterial, spem_uma_Domain, spem_uma_RoleDefinitionPackage, uma_spem_WorkProductDefinition, spem_uma_TaskDefinitionPackage, spem_uma_EstimatingConsideration, spem_uma_Example, spem_uma_Iteration, spem_uma_Outcome, spem_uma_Phase, spem_uma_Practice, Practice, uma_spem_Activity, uma_spem_MethodContentElement, spem_activity_Node, Edge, spem_activity_Edge, activity_spem_BreakdownElement, spem_activity_StartNode, Node, spem_activity_EndNode, spem_activity_ForkNode, spem_activity_JoinNode, spem_activity_DecisionNode, spem_uma_WorkProductDefinitionPackage, spem_uma_GuidancePackage, spem_uma_DisciplinePackage, spem_uma_DomainPackage, spem_uma_WorkProductKindPackage, spem_uma_RoleSetPackage, spem_uma_ToolDefinitionPackage, spem_uma_ConfigurationPackage, spem_uma_CapabilityPatternPackage, spem_uma_DeliveryProcessPackage, spem_uma_RoleSet, uma_spem_RoleDefinition, spem_uma_QualificationPackage, spem_uma_ProcessComponentPackage, spem_uma_WorkProductKind, ParameterDirectionKind, WorkSequenceKind, ActivityUseKind, OptionalityKind, ExpertiseLevel, ContractKind, RiskLevel, VariabilityType, EstimatingTechnique, WorkProductRelationshipKind},
    associations={kind0, linkedWorkDefinition1, planningData4, linkToPredecessor5, linkToSuccessor6, predecessor8, successor9, ownedParameter2, usedActivity12, nestedBreakdownElement13, suppressedBreakdownElement16, ownedProcessParameter19, defaultContext21, validContext23, linkedRoleUse26, linkedActivity27, linkedTaskUse30, role32, appliedQualification34, linkedRoleUse36, linkedWorkProductUse38, target44, parameterType47, requiredResult50, processKind52, guidance53, metric54, category56, subCategory58, workProduct40, source42, methodContentKind60, managedWorkProduct61, ownedTaskDefinitionParameter63, step64, requiredQualification66, usedTool69, predecessor73, successor76, providedQualification79, source82, categorizedElement59, linkedRoleDefinition89, linkedRoleDefinition92, linkedWorkProductDefinition94, parameterType97, ownedMethodContentMember100, reusedPackage102, ownedProcessMember104, target84, linkedTaskDefinition87, task105, usedQualification108, selectedStep111, ownedProcessParameter114, aggregatedRole117, subTeam120, superTeam122, teamRole124, variabilityBasedOnElement127, process128, ownedPort130, processComponent132, usedPort134, methodPluginSelection140, processPackageSelection142, contentPackageSelection145, substractedCategory148, defaultView151, processView154, ownedMethodContentPackage157, ownedProcessPackage160, basePlugin164, ownedMethodPlugin166, predefinedConfiguration168, configurationPackage171, portType174, baseConfiguration138, containedArtifact179, relatedTask188, relatedWorflow189, methodConfiguration191, deliveredProduct180, methodLibrary192, MethodPlugin194, includedPattern181, includedConnector182, communicationMaterial184, educationalMaterial185, connectedPort177, baseProcess202, relatedProduct196, subPractice197, referencedActivity198, contentReference200, incomingEdge207, outgoingEdge208, source211, target212, ownedConfiguration204, role206},
    generalizations={gen_spem_Kind_ExtensibleElement, gen_spem_BreakdownElement_ProcessElement, gen_spem_WorkBreakdownElement_BreakdownElement, gen_spem_WorkSequence_BreakdownElement, gen_spem_ProcessPerformer_WorkDefinitionPerformer, gen_spem_ProcessPerformer_BreakdownElement, gen_spem_RoleUse_MethodContentUse, gen_spem_ProcessResponsibilityAssignment_BreakdownElement, gen_spem_WorkProductUse_MethodContentUse, gen_spem_Activity_WorkDefinition, gen_spem_Activity_WorkBreakdownElement, gen_spem_Activity_VariabilityElement, gen_spem_ProcessParameter_WorkDefinitionParameter, gen_spem_ProcessParameter_BreakdownElement, gen_spem_Milestone_WorkBreakdownElement, gen_spem_ProcessElement_DescribableElement, gen_spem_ProcessElement_ProcessPackageableElement, gen_spem_DescribableElement_ExtensibleElement, gen_spem_Category_MethodContentElement, gen_spem_WorkProductUseRelationship_BreakdownElement, gen_spem_MethodContentElement_DescribableElement, gen_spem_MethodContentElement_MethodContentPackageableElement, gen_spem_MethodContentElement_VariabilityElement, gen_spem_ToolDefinition_MethodContentElement, gen_spem_TaskDefinition_WorkDefinition, gen_spem_TaskDefinition_MethodContentElement, gen_spem_Step_WorkDefinition, gen_spem_Step_DescribableElement, gen_spem_Step_VariabilityElement, gen_spem_WorkProductDefinition_MethodContentElement, gen_spem_RoleDefinition_MethodContentElement, gen_spem_WorkProductDefinitionRelationship_MethodContentElement, gen_spem_Guidance_MethodContentElement, gen_spem_Metric_DescribableElement, gen_spem_Default_ResponsibilityAssignment_MethodContentElement, gen_spem_Default_TaskDefinitionParameter_WorkDefinitionParameter, gen_spem_Qualification_MethodContentElement, gen_spem_MethodContentPackage_MethodContentPackageableElement, gen_spem_MethodContentPackage_MethodPluginPackageableElement, gen_spem_ProcessPackage_ProcessPackageableElement, gen_spem_ProcessPackage_MethodPluginPackageableElement, gen_spem_MethodContentKind_MethodContentElement, gen_spem_MethodContentKind_Kind, gen_spem_ProcessKind_ProcessElement, gen_spem_ProcessKind_Kind, gen_spem_Default_TaskDefinitionPerformer_MethodContentElement, gen_spem_TaskUse_MethodContentUse, gen_spem_TaskUse_WorkBreakdownElement, gen_spem_CompositeRole_RoleUse, gen_spem_TeamProfile_BreakdownElement, gen_spem_ProcessComponent_ProcessPackage, gen_spem_ProcessComponentUse_MethodContentUse, gen_spem_PlanningData_ProcessElement, gen_spem_MethodContentUse_BreakdownElement, gen_spem_MethodPlugin_MethodLibraryPackageableElement, gen_spem_WorkProductPort_ProcessElement, gen_spem_WorkProductPortConnector_ProcessElement, gen_spem_MethodConfiguration_MethodLibraryPackageableElement, gen_spem_uma_Artifact_WorkProductUse, gen_spem_uma_Discipline_Category, gen_spem_uma_CapabilityPattern_Process, gen_spem_uma_Checklist_Guidance, gen_spem_uma_Concept_Guidance, gen_spem_uma_CategoryPackage_MethodContentPackage, gen_spem_uma_CustomCategory_Category, gen_spem_uma_DisciplineGrouping_Category, gen_spem_uma_Deliverable_WorkProductUse, gen_spem_uma_Process_Activity, gen_spem_uma_DeliveryProcess_Process, gen_spem_uma_ProcessPlanningTemplate_Process, gen_spem_uma_Report_Guidance, gen_spem_uma_ReusableAsset_Guidance, gen_spem_uma_Roadmap_Guidance, gen_spem_uma_Template_Guidance, gen_spem_uma_TermDefinition_Guidance, gen_spem_uma_ToolMentor_Guidance, gen_spem_uma_Whitepaper_Concept, gen_spem_uma_Guideline_Guidance, gen_spem_uma_SupportingMaterial_Guidance, gen_spem_uma_Domain_Category, gen_spem_uma_RoleDefinitionPackage_MethodContentPackage, gen_spem_uma_TaskDefinitionPackage_MethodContentPackage, gen_spem_uma_EstimatingConsideration_Guidance, gen_spem_uma_Example_Guidance, gen_spem_uma_Iteration_Activity, gen_spem_uma_Outcome_WorkProductUse, gen_spem_uma_Phase_Activity, gen_spem_uma_Practice_Guidance, gen_spem_activity_Node_BreakdownElement, gen_spem_activity_Edge_BreakdownElement, gen_spem_activity_StartNode_Node, gen_spem_activity_EndNode_Node, gen_spem_activity_ForkNode_Node, gen_spem_activity_JoinNode_Node, gen_spem_activity_DecisionNode_Node, gen_spem_uma_WorkProductDefinitionPackage_MethodContentPackage, gen_spem_uma_GuidancePackage_MethodContentPackage, gen_spem_uma_DisciplinePackage_MethodContentPackage, gen_spem_uma_DomainPackage_MethodContentPackage, gen_spem_uma_WorkProductKindPackage_MethodContentPackage, gen_spem_uma_RoleSetPackage_MethodContentPackage, gen_spem_uma_ToolDefinitionPackage_MethodContentPackage, gen_spem_uma_ConfigurationPackage_MethodContentPackage, gen_spem_uma_CapabilityPatternPackage_ProcessPackage, gen_spem_uma_DeliveryProcessPackage_ProcessPackage, gen_spem_uma_RoleSet_MethodContentElement, gen_spem_uma_QualificationPackage_MethodContentPackage, gen_spem_uma_ProcessComponentPackage_ProcessPackage, gen_spem_uma_WorkProductKind_Kind, gen_spem_uma_WorkProductKind_MethodContentElement},
    metadata=None
)
