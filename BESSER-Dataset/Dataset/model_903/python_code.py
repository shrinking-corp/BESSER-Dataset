...
class spem_uma_Practice(Guidance):
    ...
    def __init__(self, levelOfAdoption: str, problem: str, additionalInfo: str, application: str, background: str, goal: str, spem_uma_Practice: set["Practice"] = None, spem_uma_Practice199: set["uma_spem_Activity"] = None, spem_uma_Practice201: set["uma_spem_MethodContentElement"] = None):
...
class spem_uma_DeliveryProcess(Process):
    ...
    def __init__(self, scale: str, projectCharacteristics: str, riskLevel: str, estimatingTechnique: str, projectMemberExpertise: str, typeOfContract: str, spem_uma_DeliveryProcess: set["SupportingMaterial"] = None, spem_uma_DeliveryProcess186: set["SupportingMaterial"] = None, Process: "spem_uma_Discipline" = None, Process203: "spem_uma_ProcessPlanningTemplate" = None):
        self.scale = scale
...
class spem_Activity(WorkBreakdownElement, WorkDefinition, VariabilityElement):
    ...
    def __init__(self, useKind: str, isEnactable: bool, spem_Activity17: set["spem_BreakdownElement"] = None, spem_Activity20: set["spem_ProcessParameter"] = None, spem_Activity22: "spem_MethodConfiguration" = None, spem_Activity24: set["spem_MethodConfiguration"] = None, spem_Activity29: "spem_ProcessPerformer" = None, spem_Activity: "spem_Activity" = None, spem_Activity11: "spem_Activity" = None, spem_Activity14: set["spem_BreakdownElement"] = None, spem_Activity129: "spem_ProcessComponent" = None):
...
class spem_WorkProductUseRelationship(BreakdownElement):
    ...
    def __init__(self, relationshipKind: str, spem_WorkProductUseRelationship45: set["spem_WorkProductUse"] = None, spem_WorkProductUseRelationship: "spem_WorkProductUse" = None):
...
class spem_WorkProductPort(ProcessElement):
    ...
    def __init__(self, isOptional: bool, portKind: str, spem_WorkProductPort136: "spem_ProcessComponentUse" = None, spem_WorkProductPort175: "spem_WorkProductDefinition" = None, spem_WorkProductPort: "spem_ProcessComponent" = None, spem_WorkProductPort178: "spem_WorkProductPortConnector" = None):
...
class spem_BreakdownElement(ProcessElement):
    ...
    def __init__(self, hasMultipleOccurrences: bool, isOptional: bool, isPlanned: bool, spem_BreakdownElement18: "spem_Activity" = None, spem_BreakdownElement: "spem_PlanningData" = None, spem_BreakdownElement15: "spem_Activity" = None):
