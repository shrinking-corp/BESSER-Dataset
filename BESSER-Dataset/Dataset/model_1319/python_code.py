...
class stateMachineDsl_DoubleExp(Expression):
    ...
    def __init__(self, number: int, decimal: int, negative: str):
        self.number = number
...
class stateMachineDsl_VarType:
    ...
    def __init__(self, vt: str, stateMachineDsl_VarType59: "stateMachineDsl_Parameter" = None, stateMachineDsl_VarType70: "stateMachineDsl_Function" = None, stateMachineDsl_VarType: "stateMachineDsl_Variable" = None, stateMachineDsl_VarType73: "stateMachineDsl_ParameterFunction" = None):
        self.vt = vt
...
class stateMachineDsl_VarParName:
    ...
    def __init__(self, name: str, stateMachineDsl_VarParName80: "stateMachineDsl_SetAction" = None, stateMachineDsl_VarParName85: "stateMachineDsl_ChangeAction" = None, stateMachineDsl_VarParName62: "stateMachineDsl_Parameter" = None, stateMachineDsl_VarParName: "stateMachineDsl_Variable" = None, stateMachineDsl_VarParName137: "stateMachineDsl_VarRef" = None):
        self.name = name
...
class stateMachineDsl_StateMachine:
    ...
    def __init__(self, name: str, stateMachineDsl_StateMachine2: set["stateMachineDsl_State"] = None, stateMachineDsl_StateMachine4: "stateMachineDsl_State" = None, stateMachineDsl_StateMachine: set["stateMachineDsl_Declaration"] = None):
        self.name = name
...
class stateMachineDsl_Procedure:
    ...
    def __init__(self, name: str, stateMachineDsl_Procedure92: "stateMachineDsl_ProcedureUse" = None, stateMachineDsl_Procedure: "stateMachineDsl_Declaration" = None, stateMachineDsl_Procedure50: set["stateMachineDsl_Parameter"] = None, stateMachineDsl_Procedure52: "stateMachineDsl_Condition" = None, stateMachineDsl_Procedure55: set["stateMachineDsl_Member"] = None):
        self.name = name
