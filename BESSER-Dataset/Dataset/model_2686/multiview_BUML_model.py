...
# Classes
multiview_A = Class(name="multiview_A")
Named = Class(name="Named")
multiview_E = Class(name="multiview_E")
multiview_C = Class(name="multiview_C")
multiview_Named = Class(name="multiview_Named")
multiview_F = Class(name="multiview_F")
multiview_B = Class(name="multiview_B")
...
domain_model = DomainModel(
    name="multiview",
    types={multiview_A, Named, multiview_E, multiview_C, multiview_Named, multiview_F, multiview_B},
    associations={es1, cs3, fs5, bs0},
    generalizations={gen_multiview_A_Named, gen_multiview_B_Named, gen_multiview_C_Named, gen_multiview_E_Named, gen_multiview_F_Named},
    metadata=None
)
