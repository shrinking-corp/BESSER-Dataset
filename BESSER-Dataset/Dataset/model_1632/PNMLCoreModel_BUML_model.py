...
pnmlcoremodel_ToolInfo.attributes={pnmlcoremodel_ToolInfo_version, pnmlcoremodel_ToolInfo_tool}
...
pnmlcoremodel_Font.attributes={pnmlcoremodel_Font_style, pnmlcoremodel_Font_decoration, pnmlcoremodel_Font_weight, pnmlcoremodel_Font_rotation, pnmlcoremodel_Font_size, pnmlcoremodel_Font_family, pnmlcoremodel_Font_align}
...
domain_model = DomainModel(
    name="pnmlcoremodel",
    types={pnmlcoremodel_PetriNetDoc, pnmlcoremodel_PetriNet, ID, pnmlcoremodel_Name, pnmlcoremodel_Page, pnmlcoremodel_ToolInfo, pnmlcoremodel_AnyType, Node, pnmlcoremodel_Object, pnmlcoremodel_PageLabelProxy, pnmlcoremodel_LabelProxy, pnmlcoremodel_Graphics, pnmlcoremodel_PetriNetType, pnmlcoremodel_Node, Object, pnmlcoremodel_Arc, pnmlcoremodel_PlaceNode, pnmlcoremodel_TransitionNode, pnmlcoremodel_Place, PlaceNode, pnmlcoremodel_RefPlace, pnmlcoremodel_RefTransition, TransitionNode, pnmlcoremodel_Transition, Label, pnmlcoremodel_Label, pnmlcoremodel_ArcGraphics, Graphics, pnmlcoremodel_Line, pnmlcoremodel_Coordinate, pnmlcoremodel_NodeGraphics, pnmlcoremodel_Fill, pnmlcoremodel_AnnotationGraphics, pnmlcoremodel_Font, pnmlcoremodel_EmptyType, PetriNetType, pnmlcoremodel_ToolInfoText, ToolInfo, pnmlcoremodel_ID, pnmlcoremodel_Attribute, LineShape},
    associations={net0, name3, page5, toolspecific7, unknown9, object11, pageLabelProxy13, labelproxy15, name17, toolspecific20, graphics23, unknown25, type1, label28, object30, out33, in_34, source36, target37, ref39, ref40, toolspecific41, graphics44, unknown47, line50, position51, position53, dimension55, line58, fill61, fill63, line65, offset68, font71, label73},
    generalizations={gen_pnmlcoremodel_PetriNet_ID, gen_pnmlcoremodel_Page_Node, gen_pnmlcoremodel_Object_ID, gen_pnmlcoremodel_Node_Object, gen_pnmlcoremodel_Arc_Object, gen_pnmlcoremodel_PlaceNode_Node, gen_pnmlcoremodel_TransitionNode_Node, gen_pnmlcoremodel_Place_PlaceNode, gen_pnmlcoremodel_RefPlace_PlaceNode, gen_pnmlcoremodel_RefTransition_TransitionNode, gen_pnmlcoremodel_Transition_TransitionNode, gen_pnmlcoremodel_Name_Label, gen_pnmlcoremodel_ArcGraphics_Graphics, gen_pnmlcoremodel_NodeGraphics_Graphics, gen_pnmlcoremodel_AnnotationGraphics_Graphics, gen_pnmlcoremodel_EmptyType_PetriNetType, gen_pnmlcoremodel_ToolInfoText_ToolInfo, gen_pnmlcoremodel_Attribute_Label},
    metadata=None
)
