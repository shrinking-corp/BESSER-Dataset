...
class pnmlcoremodel_Fill:
    ...
    def __init__(self, color: str, gradientColor: str, gradientrotation: str, image: str, pnmlcoremodel_Fill: "pnmlcoremodel_NodeGraphics" = None, pnmlcoremodel_Fill64: "pnmlcoremodel_AnnotationGraphics" = None):
        self.color = color
...
class pnmlcoremodel_Coordinate:
    ...
    def __init__(self, x: float, y: float, pnmlcoremodel_Coordinate: "pnmlcoremodel_ArcGraphics" = None, pnmlcoremodel_Coordinate54: "pnmlcoremodel_NodeGraphics" = None, pnmlcoremodel_Coordinate57: "pnmlcoremodel_NodeGraphics" = None, pnmlcoremodel_Coordinate70: "pnmlcoremodel_AnnotationGraphics" = None):
        self.x = x
        self.y = y
...
class pnmlcoremodel_Line:
    ...
    def __init__(self, shape: str, color: str, width: float, style: str, pnmlcoremodel_Line: "pnmlcoremodel_ArcGraphics" = None, pnmlcoremodel_Line60: "pnmlcoremodel_NodeGraphics" = None, pnmlcoremodel_Line67: "pnmlcoremodel_AnnotationGraphics" = None):
        self.shape = shape
        self.color = color
        self.width = width
        self.style = style
...
class pnmlcoremodel_LabelProxy:
    ...
    def __init__(self, text: str, pnmlcoremodel_LabelProxy: "pnmlcoremodel_Page" = None, pnmlcoremodel_LabelProxy29: "pnmlcoremodel_Label" = None, pnmlcoremodel_LabelProxy31: "pnmlcoremodel_Object" = None):
        self.text = text
