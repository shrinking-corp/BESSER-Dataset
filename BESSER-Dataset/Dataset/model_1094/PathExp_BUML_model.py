...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={PathExp, PathExp_Element, PathExp_PathExp, Element, State, Transition, PathExp_State, PathExp_Transition},
    associations={outgoing4, owner6, states0, transitions1, incoming2, source7, target9},
