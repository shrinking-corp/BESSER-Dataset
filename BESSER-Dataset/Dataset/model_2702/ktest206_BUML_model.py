...
# Classes
ktest206_B = Class(name="ktest206_B", is_abstract=True)
N = Class(name="N")
ktest206_C = Class(name="ktest206_C")
ktest206_A = Class(name="ktest206_A", is_abstract=True)
B = Class(name="B")
ktest206_D = Class(name="ktest206_D")
ktest206_X = Class(name="ktest206_X")
Y = Class(name="Y")
ktest206_V = Class(name="ktest206_V")
ktest206_W = Class(name="ktest206_W")
ktest206_Y = Class(name="ktest206_Y", is_abstract=True)
A = Class(name="A")
ktest206_E = Class(name="ktest206_E")
ktest206_N = Class(name="ktest206_N")
...
domain_model = DomainModel(
    name="ktest206",
    types={ktest206_B, N, ktest206_C, ktest206_A, B, ktest206_D, ktest206_X, Y, ktest206_V, ktest206_W, ktest206_Y, A, ktest206_E, ktest206_N},
    associations={cs0, ds1, vs4, ws2, es3},
    generalizations={gen_ktest206_B_N, gen_ktest206_A_B, gen_ktest206_X_Y, gen_ktest206_V_Y, gen_ktest206_Y_A, gen_ktest206_E_N, gen_ktest206_W_N},
    metadata=None
)
