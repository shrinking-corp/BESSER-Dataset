...
class kmLogo_ASM_ProcDeclaration(Instruction):
    ...
    def __init__(self, name: str, kmLogo_ASM_ProcDeclaration18: set["Instruction"] = None, kmLogo_ASM_ProcDeclaration: set["Parameter"] = None, declaration: set["ProcCall"] = None, Instruction: "kmLogo_ASM_ProcDeclaration" = None, Instruction20: "kmLogo_ASM_Block" = None, Instruction34: "kmLogo_ASM_LogoProgram" = None):
        self.name = name
...
class kmLogo_ASM_Constant(Expression):
    ...
    def __init__(self, integerValue: str, Expression13: "kmLogo_ASM_ProcCall" = None, Expression11: "kmLogo_ASM_BinaryExp" = None, Expression6: "kmLogo_ASM_Right" = None, Expression4: "kmLogo_ASM_Left" = None, Expression2: "kmLogo_ASM_Forward" = None, Expression8: "kmLogo_ASM_BinaryExp" = None, Expression26: "kmLogo_ASM_ControlStructure" = None, Expression: "kmLogo_ASM_Back" = None):
