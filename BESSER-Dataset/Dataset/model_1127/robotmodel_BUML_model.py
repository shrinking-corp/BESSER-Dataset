...
# Classes
robotmodel_System = Class(name="robotmodel_System")
robotmodel_Component = Class(name="robotmodel_Component")
robotmodel_Connector = Class(name="robotmodel_Connector")
robotmodel_Port = Class(name="robotmodel_Port")
robotmodel_Property_List = Class(name="robotmodel_Property_List")
robotmodel_State = Class(name="robotmodel_State")
robotmodel_Event = Class(name="robotmodel_Event")
robotmodel_Transition = Class(name="robotmodel_Transition")
robotmodel_Action = Class(name="robotmodel_Action")
robotmodel_Role = Class(name="robotmodel_Role")
robotmodel_Property = Class(name="robotmodel_Property")
...
robotmodel_System.attributes={robotmodel_System_depends, robotmodel_System_author, robotmodel_System_name, robotmodel_System_description, robotmodel_System_author_email}
...
robotmodel_Component.attributes={robotmodel_Component_depends, robotmodel_Component_name, robotmodel_Component_type, robotmodel_Component_atype, robotmodel_Component_frequency}
...
robotmodel_Connector.attributes={robotmodel_Connector_name, robotmodel_Connector_type, robotmodel_Connector_atype}
...
robotmodel_Property.attributes={robotmodel_Property_value, robotmodel_Property_type, robotmodel_Property_name}
...
domain_model = DomainModel(
    name="robotmodel",
    types={robotmodel_System, robotmodel_Component, robotmodel_Connector, robotmodel_Port, robotmodel_Property_List, robotmodel_State, robotmodel_Event, robotmodel_Transition, robotmodel_Action, robotmodel_Role, robotmodel_Property, Is_Style},
    associations={component0, connector1, port3, property_list5, component8, state10, event12, transition14, action16, property_list18, role21, role23, property26, substate29, action31, transition34, entryaction37, exitaction40, event43, action46, guard49, source52, target55, transition58},
    generalizations={},
    metadata=None
)
