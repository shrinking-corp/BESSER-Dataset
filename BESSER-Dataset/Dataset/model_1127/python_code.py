...
class robotmodel_Action:
    ...
    def __init__(self, name: str, robotmodel_Action: "robotmodel_Component" = None, robotmodel_Action33: "robotmodel_State" = None, robotmodel_Action39: "robotmodel_State" = None, robotmodel_Action42: "robotmodel_State" = None, robotmodel_Action48: "robotmodel_Transition" = None, robotmodel_Action51: "robotmodel_Transition" = None):
        self.name = name
...
class robotmodel_Transition:
    ...
    def __init__(self, name: str, robotmodel_Transition60: "robotmodel_Event" = None, robotmodel_Transition: "robotmodel_Component" = None, robotmodel_Transition36: "robotmodel_State" = None, robotmodel_Transition47: "robotmodel_Action" = None, robotmodel_Transition50: "robotmodel_Action" = None, robotmodel_Transition53: "robotmodel_State" = None, robotmodel_Transition56: "robotmodel_State" = None):
        self.name = name
...
class robotmodel_Event:
    ...
    def __init__(self, name: str, robotmodel_Event59: "robotmodel_Transition" = None, robotmodel_Event: "robotmodel_Component" = None, robotmodel_Event45: "robotmodel_State" = None):
        self.name = name
...
class robotmodel_State:
    ...
    def __init__(self, name: str, robotmodel_State: "robotmodel_Component" = None, robotmodel_State30: "robotmodel_State" = None, robotmodel_State28: set["robotmodel_State"] = None, robotmodel_State32: set["robotmodel_Action"] = None, robotmodel_State35: set["robotmodel_Transition"] = None, robotmodel_State38: "robotmodel_Action" = None, robotmodel_State41: "robotmodel_Action" = None, robotmodel_State44: set["robotmodel_Event"] = None, robotmodel_State54: "robotmodel_Transition" = None, robotmodel_State57: "robotmodel_Transition" = None):
        self.name = name
...
class robotmodel_Property_List:
    ...
    def __init__(self, name: str, robotmodel_Property_List: "robotmodel_Component" = None, robotmodel_Property_List20: "robotmodel_Connector" = None, robotmodel_Property_List27: set["robotmodel_Property"] = None):
        self.name = name
...
class robotmodel_Connector:
    ...
    def __init__(self, name: str, atype: str, type: str, robotmodel_Connector: "robotmodel_System" = None, robotmodel_Connector19: set["robotmodel_Property_List"] = None, robotmodel_Connector22: set["robotmodel_Role"] = None):
        self.name = name
        self.atype = atype
        self.type = type
...
class robotmodel_Component:
    ...
    def __init__(self, name: str, atype: str, type: str, depends: str, frequency: float, robotmodel_Component: "robotmodel_System" = None, robotmodel_Component4: set["robotmodel_Port"] = None, robotmodel_Component6: set["robotmodel_Property_List"] = None, robotmodel_Component9: "robotmodel_Component" = None, robotmodel_Component7: set["robotmodel_Component"] = None, robotmodel_Component11: set["robotmodel_State"] = None, robotmodel_Component13: set["robotmodel_Event"] = None, robotmodel_Component15: set["robotmodel_Transition"] = None, robotmodel_Component17: set["robotmodel_Action"] = None):
        self.name = name
        self.atype = atype
        self.type = type
