...
class library_Book:
    ...
    def __init__(self, bookURN: str, bookURL: str, collection: str, title: str, author: str, lastHref: str, lastLocation: str, lastOpened: str, library_Book: "library_Library" = None, library_Book2: set["library_Bookmark"] = None, library_Book4: set["library_Metadata"] = None):
