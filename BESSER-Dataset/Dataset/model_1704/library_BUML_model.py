...
library_TextAnnotation = Class(name="library_TextAnnotation")
Bookmark = Class(name="Bookmark")
library_Bookmark = Class(name="library_Bookmark")
library_Metadata = Class(name="library_Metadata")
...
library_Book.attributes={library_Book_bookURN, library_Book_lastOpened, library_Book_lastHref, library_Book_lastLocation, library_Book_collection, library_Book_title, library_Book_bookURL, library_Book_author}
...
library_Bookmark.attributes={library_Bookmark_href, library_Bookmark_location, library_Bookmark_id, library_Bookmark_timestamp, library_Bookmark_text, library_Bookmark_page}
...
library_Metadata.attributes={library_Metadata_value, library_Metadata_key}
...
domain_model = DomainModel(
    name="library",
    types={library_Library, library_Book, library_TextAnnotation, Bookmark, library_Bookmark, library_Metadata, AnnotationColor},
    associations={books0, bookmarks1, metadata3},
