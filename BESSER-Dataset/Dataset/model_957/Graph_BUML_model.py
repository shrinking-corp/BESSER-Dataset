...
# Classes
graph_EdgeType = Class(name="graph_EdgeType")
graph_Element = Class(name="graph_Element", is_abstract=True)
graph_Graph = Class(name="graph_Graph")
graph_ElementType = Class(name="graph_ElementType", is_abstract=True)
graph_Node = Class(name="graph_Node")
Element = Class(name="Element")
graph_Edge = Class(name="graph_Edge")
graph_NodeType = Class(name="graph_NodeType")
...
domain_model = DomainModel(
    name="graph",
    types={graph_EdgeType, graph_Element, graph_Graph, graph_ElementType, graph_Node, Element, graph_Edge, graph_NodeType, ElementType},
    associations={type7, graph8, incoming0, outgoing1, type3, target4, source5, graph9, element11, elementType12},
