...
example_AbstractPlayer_strategy = st.builds(example_AbstractPlayer)
...
example_InterfacePlayer_strategy = st.builds(example_InterfacePlayer)
...
example_Player_strategy = st.builds(example_Player)
