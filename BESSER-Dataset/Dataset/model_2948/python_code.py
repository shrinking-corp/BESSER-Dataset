...
class Page:
    ...
    pass
class swml_LinkJoinNode(Node, Page):
...
class swml_Attribute:
    ...
    def __init__(self, name: str, type: str, swml_Attribute: "swml_EntityType" = None, swml_Attribute6: "swml_EntityType" = None, swml_Attribute12: "swml_Enumeration" = None):
        self.name = name
        self.type = type
...
class swml_EntityType:
    ...
    def __init__(self, name: str, isAbstract: bool, swml_EntityType: set["swml_Attribute"] = None, swml_EntityType5: "swml_Attribute" = None, entityType: set["swml_Relationship"] = None, swml_EntityType10: "swml_EntityType" = None, swml_EntityType8: "swml_EntityType" = None, swml_EntityType20: "swml_DynamicPage" = None, EntityType: "swml_Relationship" = None, swml_EntityType26: "swml_Relationship" = None, swml_EntityType34: "swml_ContentModel" = None):
        self.name = name
