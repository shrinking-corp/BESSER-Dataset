...
public class necsis14_classdiagram_ClassDiagram  {
    ...
    private List<necsis14_classdiagram__QTable> necsis14_classdiagram__qtables;
    ...
    public necsis14_classdiagram_ClassDiagram(
        ...
        this.necsis14_classdiagram__qtables = new ArrayList<>();
        this.necsis14_classdiagram_associations = new ArrayList<>();
    }

    public necsis14_classdiagram_ClassDiagram(
        ArrayList<necsis14_classdiagram_Class> necsis14_classdiagram_classs,        ArrayList<necsis14_classdiagram__QTable> necsis14_classdiagram__qtables,        ArrayList<necsis14_classdiagram_Association> necsis14_classdiagram_associations    ) {
        this.necsis14_classdiagram_classs = necsis14_classdiagram_classs;
        this.necsis14_classdiagram__qtables = necsis14_classdiagram__qtables;
    ...
    public List<necsis14_classdiagram__QTable> getNecsis14_classdiagram__qtables() {
        return necsis14_classdiagram__qtables;
    }

    public void addNecsis14_classdiagram__qtable(Necsis14_classdiagram__qtable necsis14_classdiagram__qtable) {
        this.necsis14_classdiagram__qtables.add(necsis14_classdiagram__qtable);
    }
