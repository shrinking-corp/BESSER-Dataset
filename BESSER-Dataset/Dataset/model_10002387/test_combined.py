...
@given(instance=BankAccount_strategy)
def test_hyp_bankaccount_attribute_setter(instance):
...
def test_BankAccount_attribute_value_roundtrip():
    instance = BankAccount(attribute="sample_text", balance=3.14, ownerName="sample_text")
...
BankAccount_strategy = st.builds(BankAccount, attribute=safe_text, balance=st.floats(allow_nan=False, allow_infinity=False), ownerName=safe_text)
@given(instance=BankAccount_strategy)
