...
BankAccount_attribute: Property = Property(name="attribute", type=StringType)
BankAccount.attributes={BankAccount_balance, BankAccount_attribute, BankAccount_ownerName}
...
domain_model = DomainModel(
    name="ae3d46a4_dd21_4e0b_878c_53fcf9b52a54",
