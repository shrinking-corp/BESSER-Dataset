...
class uma_WorkProductDescriptor(Descriptor):
    ...
    def __init__(self, responsibleRole: str, workProduct: str, group2: str, externalInputTo: str, impactedBy: str, impacts: str, mandatoryInputTo: str, optionalInputTo: str, outputFrom: str, deliverableParts: str, activityEntryState: str, activityExitState: str, uma_WorkProductDescriptor: "uma_ProcessComponentInterface" = None):
...
class uma_Process(Activity):
    ...
    def __init__(self, defaultContext: str, includesPattern: str, validContext: str, diagramURI: str, uma_Process: "uma_ProcessComponent" = None):
...
class uma_DocumentRoot:
    ...
    def __init__(self, mixed: str, uma_DocumentRoot20: set["uma_MethodPlugin"] = None, uma_DocumentRoot: set["uma_EStringToStringMapEntry"] = None, uma_DocumentRoot13: set["uma_EStringToStringMapEntry"] = None, uma_DocumentRoot16: set["uma_MethodConfiguration"] = None, uma_DocumentRoot18: set["uma_MethodLibrary"] = None):
        self.mixed = mixed
...
class uma_Descriptor(BreakdownElement):
    ...
    def __init__(self, isSynchronizedWithSource: str):
        ...
        pass
    @property
    def isSynchronizedWithSource(self):
...
class uma_DeliveryProcessDescription(ProcessDescription):
    ...
    @property
    def projectCharacteristics(self):
    ...
    @property
    def projectMemberExpertise(self):
...
class uma_TaskDescriptor(WorkBreakdownElement):
    ...
    def __init__(self, assistedBy: str, task: str, group3: str, performedPrimarilyBy: str, additionallyPerformedBy: str, externalInput: str, mandatoryInput: str, optionalInput: str, output: str, isSynchronizedWithSource: str, uma_TaskDescriptor: "uma_ProcessComponentInterface" = None, uma_TaskDescriptor51: set["uma_Section"] = None):
    ...
    @property
    def additionallyPerformedBy(self):
...
class uma_Activity(WorkBreakdownElement):
    ...
    def __init__(self, postcondition: str, roadmap: str, precondition: str, group3: str, isEnactable: str, variabilityBasedOnElement: str, variabilityType: str, uma_Activity: set["uma_BreakdownElement"] = None):
    ...
    @property
    def variabilityBasedOnElement(self):
...
class uma_ContentElement(DescribableElement):
    ...
    def __init__(self, reusableAsset: str, group1: str, checklist: str, concept: str, example: str, guideline: str, supportingMaterial: str, whitepaper: str, variabilityBasedOnElement: str, variabilityType: str, uma_ContentElement: "uma_ContentPackage" = None):
...
class uma_MethodPlugin(MethodUnit):
    ...
    def __init__(self, referencedMethodPlugin: str, supporting: str, userChangeable: str, uma_MethodPlugin: "uma_DocumentRoot" = None, uma_MethodPlugin28: "uma_MethodLibrary" = None, uma_MethodPlugin35: set["uma_MethodPackage"] = None):
        ...
        pass
    @property
    def referencedMethodPlugin(self):
...
class uma_MethodConfiguration(MethodUnit):
    ...
    def __init__(self, defaultView: str, baseConfiguration: str, methodPluginSelection: str, methodPackageSelection: str, processView: str, subtractedCategory: str, addedCategory: str, uma_MethodConfiguration: "uma_DocumentRoot" = None, uma_MethodConfiguration31: "uma_MethodLibrary" = None):
        ...
        pass
    @property
    def methodPluginSelection(self):
    ...
    @property
    def methodPackageSelection(self):
...
class uma_WorkProduct(ContentElement):
    ...
    @property
    def estimationConsiderations(self):
...
class uma_Task(ContentElement):
    ...
    def __init__(self, estimate: str, precondition: str, postcondition: str, performedBy: str, group2: str, mandatoryInput: str, output: str, additionallyPerformedBy: str, optionalInput: str, estimationConsiderations: str, toolMentor: str):
        self.estimate = estimate
        self.precondition = precondition
        self.postcondition = postcondition
...
class uma_Kind(ContentElement):
    ...
    def __init__(self, applicableMetaClassInfo: str):
        ...
        pass
    @property
    def applicableMetaClassInfo(self):
...
class uma_Section(MethodElement):
    ...
    def __init__(self, sectionName: str, predecessor: str, description: str, variabilityBasedOnElement: str, variabilityType: str, uma_Section: "uma_ContentDescription" = None, uma_Section49: "uma_Section" = None, uma_Section47: "uma_Section" = None, uma_Section52: "uma_TaskDescriptor" = None):
...
class uma_MethodPackage(MethodElement):
    ...
    def __init__(self, group1: str, reusedPackage: str, global_: str, uma_MethodPackage: "uma_MethodPackage" = None, uma_MethodPackage32: set["uma_MethodPackage"] = None, uma_MethodPackage36: "uma_MethodPlugin" = None):
        self.group1 = group1
    ...
    @global_.setter
    def global_(self, global_: str):
        self.__global_ = global_


    @property
    def reusedPackage(self):
...
class uma_Practice(Guidance):
    ...
    def __init__(self, activityReference: str, group2: str, contentReference: str, uma_Practice: "uma_Practice" = None, uma_Practice37: set["uma_Practice"] = None):
...
class uma_DeliveryProcess(Process):
    ...
    def __init__(self, group4: str, communicationsMaterial: str, educationMaterial: str):
        ...
        pass
    @property
    def communicationsMaterial(self):
...
class uma_BreakdownElement(ProcessElement):
    ...
    def __init__(self, planningData: str, presentedAfter: str, presentedBefore: str, prefix: str, superActivity: str, group1: str, checklist: str, concept: str, example: str, guideline: str, reusableAsset: str, supportingMaterial: str, whitepaper: str, hasMultipleOccurrences: str, isOptional: str, isPlanned: str, uma_BreakdownElement: "uma_Activity" = None):
    ...
    @property
    def hasMultipleOccurrences(self):
...
class uma_ArtifactDescription(WorkProductDescription):
    ...
    @property
    def representationOptions(self):
...
class uma_MethodElement(PackageableElement):
    ...
    def __init__(self, suppressed: str, group: str, briefDescription: str, id: str, orderingGuide: str, presentationName: str, uma_MethodElement: set["uma_Constraint"] = None, uma_MethodElement25: set["uma_MethodElementProperty"] = None):
