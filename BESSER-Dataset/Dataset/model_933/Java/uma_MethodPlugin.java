...
public class uma_MethodPlugin extends MethodUnit {
    ...
    public uma_MethodPlugin(
        String referencedMethodPlugin,        String userChangeable,        String supporting    ) {
        super(
        );
    ...
    public uma_MethodPlugin(
        String referencedMethodPlugin,        String userChangeable,        String supporting        ArrayList<uma_MethodPackage> uma_methodpackages    ) {
        this.referencedMethodPlugin = referencedMethodPlugin;
        this.userChangeable = userChangeable;
        this.supporting = supporting;
