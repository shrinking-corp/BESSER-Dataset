...
library_Writer = Class(name="library_Writer", is_abstract=True)
...
domain_model = DomainModel(
    name="library",
    types={library_Book, library_Writer, library_Library, library_GuideBookWriter, Writer, library_SpecialistBookWriter},
