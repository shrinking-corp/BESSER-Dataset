...
# Classes
xtextTest_Model = Class(name="xtextTest_Model")
xtextTest_XtextTest = Class(name="xtextTest_XtextTest")
xtextTest_EmfTest = Class(name="xtextTest_EmfTest")
xtextTest_Input = Class(name="xtextTest_Input")
xtextTest_Tokens = Class(name="xtextTest_Tokens")
xtextTest_Element = Class(name="xtextTest_Element")
xtextTest_Generator = Class(name="xtextTest_Generator")
xtextTest_Before = Class(name="xtextTest_Before")
xtextTest_After = Class(name="xtextTest_After")
xtextTest_Import = Class(name="xtextTest_Import")
xtextTest_CodeCall = Class(name="xtextTest_CodeCall")
xtextTest_MyTokens = Class(name="xtextTest_MyTokens")
xtextTest_Inner = Class(name="xtextTest_Inner")
xtextTest_ReplacePatterns = Class(name="xtextTest_ReplacePatterns")
...
xtextTest_XtextTest.attributes={xtextTest_XtextTest_lang, xtextTest_XtextTest_boolean, xtextTest_XtextTest_timeOut, xtextTest_XtextTest_package, xtextTest_XtextTest_imports}
...
xtextTest_EmfTest.attributes={xtextTest_EmfTest_mydefault, xtextTest_EmfTest_package, xtextTest_EmfTest_file, xtextTest_EmfTest_timeOut}
...
xtextTest_Element.attributes={xtextTest_Element_name, xtextTest_Element_importing}
...
xtextTest_Generator.attributes={xtextTest_Generator_isSameAsInputFile, xtextTest_Generator_expected, xtextTest_Generator_patternFile, xtextTest_Generator_exception, xtextTest_Generator_output}
...
xtextTest_CodeCall.attributes={xtextTest_CodeCall_myclass, xtextTest_CodeCall_params, xtextTest_CodeCall_method}
...
xtextTest_MyTokens.attributes={xtextTest_MyTokens_count, xtextTest_MyTokens_token, xtextTest_MyTokens_string}
...
xtextTest_Inner.attributes={xtextTest_Inner_isEmpty, xtextTest_Inner_assignAsBool, xtextTest_Inner_value, xtextTest_Inner_isNotNull, xtextTest_Inner_isNull, xtextTest_Inner_parameter, xtextTest_Inner_assignAsData}
...
domain_model = DomainModel(
    name="xtextTest",
    types={xtextTest_Model, xtextTest_XtextTest, xtextTest_EmfTest, xtextTest_Input, xtextTest_Tokens, xtextTest_Element, xtextTest_Generator, xtextTest_Before, xtextTest_After, xtextTest_Import, xtextTest_CodeCall, xtextTest_MyTokens, xtextTest_Inner, xtextTest_ReplacePatterns},
    associations={xtextTest0, emfTest1, input3, tokens5, root7, output9, before11, after13, myimport15, codeCall17, optionCall19, paramCall22, root25, before28, after31, tokens34, inner36, assign38, assignList41, replacePatterns44, codeCall46, codeCall49},
    generalizations={},
    metadata=None
)
