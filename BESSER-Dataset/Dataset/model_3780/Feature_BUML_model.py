...
feature_Value = Class(name="feature_Value")
feature_SimpleOntologyTerm = Class(name="feature_SimpleOntologyTerm")
feature_EvidenceCode = Class(name="feature_EvidenceCode")
feature_FeatureSet = Class(name="feature_FeatureSet")
feature_SimpleFeature = Class(name="feature_SimpleFeature")
SimpleIdentifier = Class(name="SimpleIdentifier")
feature_AnnotatedSimpleFeature = Class(name="feature_AnnotatedSimpleFeature")
SimpleFeature = Class(name="SimpleFeature")
feature_SimpleIdentifier = Class(name="feature_SimpleIdentifier")
...
domain_model = DomainModel(
    name="feature",
    types={feature_Feature, feature_Value, feature_SimpleOntologyTerm, feature_EvidenceCode, feature_FeatureSet, feature_SimpleFeature, SimpleIdentifier, feature_AnnotatedSimpleFeature, SimpleFeature, feature_SimpleIdentifier},
    associations={annotations0, values1, unit2, supportingEvidence4, features6, type7},
    generalizations={gen_feature_Feature_SimpleFeature, gen_feature_FeatureSet_SimpleFeature, gen_feature_SimpleFeature_SimpleIdentifier, gen_feature_AnnotatedSimpleFeature_SimpleFeature},
    metadata=None
)
