...
def test_hyp_edatatypecolumn_book_is_not_abstract():
    assert not inspect.isabstract(edatatypeColumn_Book)


def test_hyp_edatatypecolumn_book_constructor_exists():
    assert callable(edatatypeColumn_Book.__init__)


def test_hyp_edatatypecolumn_book_constructor_args():
...
def test_hyp_edatatypecolumn_book_author_setter(instance):
...
@given(instance=edatatypeColumn_Book_strategy)
def test_hyp_edatatypecolumn_book_weight_setter(instance):
...
@given(instance=edatatypeColumn_Book_strategy)
def test_hyp_edatatypecolumn_book_title_setter(instance):
...
@given(instance=edatatypeColumn_Book_strategy)
def test_hyp_edatatypecolumn_book_pages_setter(instance):
