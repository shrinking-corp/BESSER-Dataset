...
# Classes
A = Class(name="A")
abcd_NamedElt = Class(name="abcd_NamedElt", is_abstract=True)
abcd_Model = Class(name="abcd_Model")
NamedElt = Class(name="NamedElt")
abcd_A = Class(name="abcd_A", is_abstract=True)
abcd_Other = Class(name="abcd_Other")
abcd_B = Class(name="abcd_B")
abcd_C = Class(name="abcd_C")
abcd_D = Class(name="abcd_D", is_abstract=True)
abcd_C1 = Class(name="abcd_C1")
C = Class(name="C")
abcd_C2 = Class(name="abcd_C2")
abcd_D1 = Class(name="abcd_D1")
D = Class(name="D")
abcd_D2 = Class(name="abcd_D2")
abcd_D3 = Class(name="abcd_D3")
abcd_D3_B = Class(name="abcd_D3_B")
D3 = Class(name="D3")
B = Class(name="B")
abcd_D3_B_C = Class(name="abcd_D3_B_C")
D3_B = Class(name="D3_B")
...
domain_model = DomainModel(
    name="abcd",
    types={A, abcd_NamedElt, abcd_Model, NamedElt, abcd_A, abcd_Other, abcd_B, abcd_C, abcd_D, abcd_C1, C, abcd_C2, abcd_D1, D, abcd_D2, abcd_D3, abcd_D3_B, D3, B, abcd_D3_B_C, D3_B, StyleKind},
    associations={children13, elements0, others1, optionalA3, optionalB6, optionalC8, optionalD10},
    generalizations={gen_abcd_A_NamedElt, gen_abcd_B_A, gen_abcd_C_A, gen_abcd_Model_NamedElt, gen_abcd_C1_C, gen_abcd_C2_C, gen_abcd_D_A, gen_abcd_D1_D, gen_abcd_D2_D, gen_abcd_D3_D, gen_abcd_D3_B_D3, gen_abcd_D3_B_B, gen_abcd_D3_B_C_D3_B, gen_abcd_D3_B_C_C, gen_abcd_Other_NamedElt},
    metadata=None
)
