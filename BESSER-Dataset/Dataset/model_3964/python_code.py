...
class archDSL_UncertainConnector:
    ...
    def __init__(self, name: str, archDSL_UncertainConnector: "archDSL_Model" = None, archDSL_UncertainConnector25: set["archDSL_UncertainBehavior"] = None, archDSL_UncertainConnector22: "archDSL_Interface" = None):
        self.name = name
...
class archDSL_UncertainInterface:
    ...
    def __init__(self, name: str, archDSL_UncertainInterface10: "archDSL_Interface" = None, archDSL_UncertainInterface13: set["archDSL_AltMethod"] = None, archDSL_UncertainInterface15: set["archDSL_OptMethod"] = None, archDSL_UncertainInterface: "archDSL_Model" = None):
        self.name = name
...
class archDSL_Interface:
    ...
    def __init__(self, name: str, archDSL_Interface11: "archDSL_UncertainInterface" = None, archDSL_Interface17: set["archDSL_Method"] = None, archDSL_Interface28: "archDSL_Behavior" = None, archDSL_Interface: "archDSL_Model" = None, archDSL_Interface34: "archDSL_Behavior" = None, archDSL_Interface40: "archDSL_UncertainBehavior" = None, archDSL_Interface23: "archDSL_UncertainConnector" = None):
        self.name = name
