...
# Classes
archDSL_Model = Class(name="archDSL_Model")
archDSL_Interface = Class(name="archDSL_Interface")
archDSL_UncertainInterface = Class(name="archDSL_UncertainInterface")
archDSL_Behavior = Class(name="archDSL_Behavior")
archDSL_UncertainConnector = Class(name="archDSL_UncertainConnector")
archDSL_Connector = Class(name="archDSL_Connector")
archDSL_AltMethod = Class(name="archDSL_AltMethod")
archDSL_OptMethod = Class(name="archDSL_OptMethod")
archDSL_Method = Class(name="archDSL_Method")
SuperMethod = Class(name="SuperMethod")
archDSL_SuperMethod = Class(name="archDSL_SuperMethod")
archDSL_SuperCall = Class(name="archDSL_SuperCall")
archDSL_CertainCall = Class(name="archDSL_CertainCall")
SuperCall = Class(name="SuperCall")
archDSL_OptCall = Class(name="archDSL_OptCall")
archDSL_AltCall = Class(name="archDSL_AltCall")
archDSL_Param = Class(name="archDSL_Param")
archDSL_UncertainBehavior = Class(name="archDSL_UncertainBehavior")
...
archDSL_AltMethod.attributes={archDSL_AltMethod_a_name, archDSL_AltMethod_type}
...
archDSL_Param.attributes={archDSL_Param_name, archDSL_Param_type}
...
domain_model = DomainModel(
    name="archDSL",
    types={archDSL_Model, archDSL_Interface, archDSL_UncertainInterface, archDSL_Behavior, archDSL_UncertainConnector, archDSL_Connector, archDSL_AltMethod, archDSL_OptMethod, archDSL_Method, SuperMethod, archDSL_SuperMethod, archDSL_SuperCall, archDSL_CertainCall, SuperCall, archDSL_OptCall, archDSL_AltCall, archDSL_Param, archDSL_UncertainBehavior},
    associations={interfaces0, u_interfaces1, behaviors3, u_connectors5, connectors7, superInterface9, altmethods12, optmethods14, methods16, u_behaviors24, interface26, call29, end32, param35, call36, end38, a_name41, name43, behaviors18, superInterface21},
    generalizations={gen_archDSL_Method_SuperMethod, gen_archDSL_AltMethod_SuperMethod, gen_archDSL_CertainCall_SuperCall, gen_archDSL_OptCall_SuperCall, gen_archDSL_AltCall_SuperCall, gen_archDSL_OptMethod_SuperMethod},
    metadata=None
)
