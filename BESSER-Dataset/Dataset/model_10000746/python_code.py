...
class Persona:
    ...
    def __init__(self, Cod_persona: str, Nombre: str, Apellido: str, NombreCorto: str, FechaNacimiento: str, Nacionalidad: str, entrenador20: set["Entrenador"] = None, arbitro16: set["Arbitro"] = None, jugador18: set["Jugador"] = None):
...
class Partido:
    ...
    def __init__(self, GolVisita: str, Ganador: str, Cod_liga: str, Cod_partido: str, Fecha: str, Hora: str, Local: str, Visita: str, GolLocal: str, estadio4: "Estadio" = None, liga25: "Liga" = None, equipo6: "Equipo" = None, equipo9: "Equipo" = None, evento13: set["Evento"] = None):
...
class Arbitro:
    ...
    def __init__(self, Partidos: str, Cod_Arbitro: str, Cod_persona: str, persona17: "Persona" = None):
...
class Jugador:
    ...
    def __init__(self, Cod_jugador: str, Dorsal: str, Posicion: str, Altura: str, Peso: str, Titulos: str, Cod_equipo: str, Cod_persona: str, equipo2: "Equipo" = None, lesion22: set["Lesion"] = None, evento10: set["Evento"] = None, persona19: "Persona" = None):
        self.Cod_jugador = Cod_jugador
        self.Dorsal = Dorsal
        self.Posicion = Posicion
        self.Altura = Altura
