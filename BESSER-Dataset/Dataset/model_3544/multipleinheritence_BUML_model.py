...
# Classes
multipleinheritence_NewEClass2 = Class(name="multipleinheritence_NewEClass2")
multipleinheritence_NewEClass3 = Class(name="multipleinheritence_NewEClass3")
NewEClass4 = Class(name="NewEClass4")
NewEClass5 = Class(name="NewEClass5")
multipleinheritence_NewEClass4 = Class(name="multipleinheritence_NewEClass4")
multipleinheritence_NewEClass5 = Class(name="multipleinheritence_NewEClass5")
multipleinheritence_NewEClass1 = Class(name="multipleinheritence_NewEClass1")
...
domain_model = DomainModel(
    ...
    types={multipleinheritence_NewEClass2, multipleinheritence_NewEClass3, NewEClass4, NewEClass5, multipleinheritence_NewEClass4, multipleinheritence_NewEClass5, multipleinheritence_NewEClass1, NewEClass2, NewEClass3},
    associations={},
    generalizations={gen_multipleinheritence_NewEClass3_NewEClass4, gen_multipleinheritence_NewEClass3_NewEClass5, gen_multipleinheritence_NewEClass1_NewEClass2, gen_multipleinheritence_NewEClass1_NewEClass3},
    metadata=None
)
