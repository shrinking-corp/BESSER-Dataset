...
class SpecificationElement:
    ...
    pass
class sgraph_State(SpecificationElement, DocumentedElement, RegularState, CompositeElement, ReactiveElement, ScopedElement):
...
class NamedElement:
    ...
    pass
class sgraph_Statechart(NamedElement, SpecificationElement, DocumentedElement, CompositeElement, ReactiveElement, ScopedElement, DomainElement):
