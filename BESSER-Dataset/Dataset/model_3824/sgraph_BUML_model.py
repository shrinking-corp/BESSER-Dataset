...
sgraph_State.attributes={sgraph_State_composite, sgraph_State_leaf, sgraph_State_simple, sgraph_State_orthogonal}
...
domain_model = DomainModel(
    name="sgraph",
    types={sgraph_Exit, sgraph_ReactiveElement, sgraph_Reaction, sgraph_Pseudostate, Vertex, sgraph_Vertex, NamedElement, sgraph_Region, sgraph_Transition, sgraph_CompositeElement, SpecificationElement, Reaction, DocumentedElement, sgraph_FinalState, RegularState, sgraph_Choice, Pseudostate, sgraph_Statechart, ReactiveElement, ScopedElement, CompositeElement, DomainElement, sgraph_Entry, sgraph_ImportDeclaration, Declaration, sgraph_Trigger, sgraph_Effect, sgraph_ReactionProperty, sgraph_SpecificationElement, sgraph_Scope, sgraph_Declaration, sgraph_Event, sgraph_Property, sgraph_ScopedElement, sgraph_Synchronization, sgraph_State, sgraph_RegularState, EntryKind, ChoiceKind},
    associations={parentRegion0, incomingTransitions1, outgoingTransitions2, vertices4, composite5, target6, source8, regions27, localReactions10, trigger11, effect13, properties15, declarations17, events18, variables20, reactions22, scopes25, declaration29},
    generalizations={gen_sgraph_Exit_Pseudostate, gen_sgraph_Pseudostate_Vertex, gen_sgraph_Vertex_NamedElement, gen_sgraph_Region_NamedElement, gen_sgraph_Transition_SpecificationElement, gen_sgraph_Transition_Reaction, gen_sgraph_Transition_DocumentedElement, gen_sgraph_FinalState_RegularState, gen_sgraph_Choice_Pseudostate, gen_sgraph_Statechart_SpecificationElement, gen_sgraph_Statechart_ReactiveElement, gen_sgraph_Statechart_ScopedElement, gen_sgraph_Statechart_CompositeElement, gen_sgraph_Statechart_NamedElement, gen_sgraph_Statechart_DocumentedElement, gen_sgraph_Statechart_DomainElement, gen_sgraph_Entry_Pseudostate, gen_sgraph_RegularState_Vertex, gen_sgraph_ImportDeclaration_Declaration, gen_sgraph_Synchronization_Pseudostate, gen_sgraph_State_SpecificationElement, gen_sgraph_State_ReactiveElement, gen_sgraph_State_ScopedElement, gen_sgraph_State_RegularState, gen_sgraph_State_CompositeElement, gen_sgraph_State_DocumentedElement},
    metadata=None
)
