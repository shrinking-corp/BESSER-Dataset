...
# Classes
uitf_TestCase = Class(name="uitf_TestCase")
uitf_UISUT = Class(name="uitf_UISUT")
uitf_Statement = Class(name="uitf_Statement")
uitf_TestSuite = Class(name="uitf_TestSuite")
uitf_Variable = Class(name="uitf_Variable")
Variable = Class(name="Variable")
uitf_UIControl = Class(name="uitf_UIControl")
uitf_UIControlVariable = Class(name="uitf_UIControlVariable")
uitf_AssertInState = Class(name="uitf_AssertInState")
Statement = Class(name="Statement")
uitf_TriggeredTransition = Class(name="uitf_TriggeredTransition")
...
uitf_UISUT_m_onUITrigger: Method = Method(name="onUITrigger", parameters={Parameter(name='uitf_trigger', type=StringType)})
uitf_UISUT_m_onManipulateUIControl: Method = Method(name="onManipulateUIControl", parameters={Parameter(name='uitf_manipulationKind', type=StringType), Parameter(name='uitf_controlPath', type=StringType)})
uitf_UISUT_m_onManipulateUIControlData: Method = Method(name="onManipulateUIControlData", parameters={Parameter(name='uitf_controlPropertyKey', type=StringType), Parameter(name='uitf_controlPropertyVal', type=StringType), Parameter(name='uitf_controlPath', type=StringType)})
uitf_UISUT_m_assertInState: Method = Method(name="assertInState", parameters={})
uitf_UISUT.attributes={uitf_UISUT_objectURI}
uitf_UISUT.methods={uitf_UISUT_m_onManipulateUIControl, uitf_UISUT_m_onUITrigger, uitf_UISUT_m_onManipulateUIControlData, uitf_UISUT_m_assertInState}
...
uitf_TestSuite.methods={uitf_TestSuite_m_start, uitf_TestSuite_m_stop}

# uitf_Variable class attributes and methods
uitf_Variable_id: Property = Property(name="id", type=StringType)
uitf_Variable_m_setValue: Method = Method(name="setValue", parameters={Parameter(name='uitf_val', type=StringType)})
...
uitf_Variable.methods={uitf_Variable_m_assertValue, uitf_Variable_m_setValue, uitf_Variable_m_getValue}
...
uitf_TriggeredTransition.attributes={uitf_TriggeredTransition_transitionId, uitf_TriggeredTransition_scriptStr}
...
domain_model = DomainModel(
    name="uitf",
    types={uitf_TestCase, uitf_UISUT, uitf_Statement, uitf_TestSuite, uitf_Variable, Variable, uitf_UIControl, uitf_UIControlVariable, uitf_AssertInState, Statement, uitf_TriggeredTransition, UserInstructionEnum},
    associations={itsUISUT0, itsStatement1, itsTestCase3, itsVariable5, itsUICtrl7, itsVariable9, itsVariable12},
    generalizations={gen_uitf_UISUT_Variable, gen_uitf_UIControlVariable_Variable, gen_uitf_AssertInState_Statement, gen_uitf_TriggeredTransition_Statement},
    metadata=None
)
