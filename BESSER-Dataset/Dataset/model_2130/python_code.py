...
class uitf_UIControl:
    ...
    def __init__(self, id: str, uitf_UIControl: "uitf_UISUT" = None, uitf_UIControl13: "uitf_Variable" = None):
        self.id = id
...
class uitf_Variable:
    ...
    def __init__(self, id: str, uitf_Variable: "uitf_UISUT" = None, uitf_Variable11: "uitf_Statement" = None, uitf_Variable14: "uitf_UIControl" = None):
        self.id = id
...
class uitf_UISUT(Variable):
    ...
    def onUITrigger(self, uitf_trigger):
        # TODO: Implement onUITrigger method
        pass

    def onManipulateUIControlData(self, uitf_controlPropertyVal, uitf_controlPropertyKey, uitf_controlPath):
        # TODO: Implement onManipulateUIControlData method
        pass

    def onManipulateUIControl(self, uitf_controlPath, uitf_manipulationKind):
