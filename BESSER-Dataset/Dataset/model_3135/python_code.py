...
class classdiagram_Attribute:
    ...
    def __init__(self, name: str, classdiagram_Attribute: "classdiagram_ClassDiagram" = None, classdiagram_Attribute5: "classdiagram_Class" = None):
        self.name = name
...
class classdiagram_Class:
    ...
    def __init__(self, name: str, classdiagram_Class: "classdiagram_ClassDiagram" = None, classdiagram_Class4: set["classdiagram_Attribute"] = None):
        self.name = name
