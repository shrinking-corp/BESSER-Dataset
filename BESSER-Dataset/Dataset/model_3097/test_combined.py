...
def test_hyp_simpleclass_schema_is_not_abstract():
    assert not inspect.isabstract(SimpleClass_Schema)


def test_hyp_simpleclass_schema_constructor_exists():
    assert callable(SimpleClass_Schema.__init__)


def test_hyp_simpleclass_schema_constructor_args():
    sig = inspect.signature(SimpleClass_Schema.__init__)
    params = list(sig.parameters.keys())
...
def test_hyp_entity_exists():
    # Check that the Enumeration exists
    assert Entity is not None

def test_hyp_entity_has_all_literals():
...
def test_hyp_vocabulary_exists():
    # Check that the Enumeration exists
    assert Vocabulary is not None

def test_hyp_vocabulary_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_ea_exists():
    # Check that the Enumeration exists
    assert EA is not None

def test_hyp_ea_has_all_literals():
    # Collect the names of literals in this Enumeration
...
SimpleClass_Schema_strategy = st.builds(
    SimpleClass_Schema,
)
...
def test_SimpleClass_Schema_isa_Classifier():
    instance = SimpleClass_Schema()
    assert isinstance(instance, Classifier)
...
SimpleClass_Schema_strategy = st.builds(SimpleClass_Schema)
@given(instance=SimpleClass_Schema_strategy)
@settings(max_examples=25)
def test_SimpleClass_Schema_instantiation(instance):
    assert isinstance(instance, SimpleClass_Schema)
