...
SimpleClass_Schema = Class(name="SimpleClass_Schema")
...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={SimpleClass_Association, SimpleClass_Attribute, SimpleClass_Classifier, SimpleClass_Class, Classifier, Class_, Attribute, SimpleClass_PrimitiveDataType, SimpleClass_Schema, Association, PrimitiveDataType, EA, Vocabulary, Entity},
    associations={src3, dest5, type8, parent0, attrs1, clases9, relaciones11, datos13},
