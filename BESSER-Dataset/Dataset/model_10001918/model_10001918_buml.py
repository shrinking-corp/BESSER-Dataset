...
domain_model = DomainModel(
    name="_dFc_UF7OEeqK2M3E1LfZ7Q",
    types={ShoppingCartExample_ShoppingCart, ShoppingCartExample_Order, ShoppingCartExample_LineItem, ShoppingCartExample_Account, ShoppingCartExample_Customer, Class_, Location, Packet, Neighbor, Transportation, Sistema_Actor, Base_de_datos_Actor, Cliente_Actor, Sistema2, Operario_Actor, Risk_Person_Actor, Client_Interface},
