...
fsm_Constraint_m_eval: Method = Method(name="eval", parameters={Parameter(name='fsm_context', type=StringType)}, type=BooleanType)
...
domain_model = DomainModel(
    name="fsm",
    types={fsm_State, AbstractState, fsm_Trigger, fsm_StateMachine, NamedElement, fsm_Region, fsm_AbstractState, fsm_Transition, fsm_Constraint, fsm_Pseudostate, fsm_InitialState, Pseudostate, fsm_FinalState, State, fsm_NamedElement},
    associations={incoming4, outgoing5, ownerRegion7, trigger9, target11, source13, regions0, subvertex1, transitions2, ownerStateMachine3, guard15},
    generalizations={gen_fsm_AbstractState_NamedElement, gen_fsm_State_AbstractState, gen_fsm_Transition_NamedElement, gen_fsm_StateMachine_NamedElement, gen_fsm_Region_NamedElement, gen_fsm_Pseudostate_AbstractState, gen_fsm_InitialState_Pseudostate, gen_fsm_FinalState_State},
    metadata=None
)
