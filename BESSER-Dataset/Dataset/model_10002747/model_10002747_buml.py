...
ClassA.attributes={ClassA_protectedAttribute, ClassA_packageAttribute, ClassA_privateAttribute, ClassA_publicAttribute}
...
# ____ class attributes and methods
...
ClassD_ClassE: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="classD1", type=____, multiplicity=Multiplicity(0, 1))
    }
)
...
domain_model = DomainModel(
    name="d5c8ccfc_97e4_484d_89c2_47c5ad373ec7",
    types={BankAccount, ClassA, ClassC, ____, ClassE, ClassF, ClassG, ClassJ, ClassH, ClassK, ClassL, ClassM, ClassN, ClassP, InterfaceO_Interface, ClassQ, ClassR, ClassS, ClassT, ClassU, ClassV},
