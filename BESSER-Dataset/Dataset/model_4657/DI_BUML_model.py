...
domain_model = DomainModel(
    name="di",
    types={di_EObject, di_Style, di_Node, DiagramElement, di_Edge, di_Point, di_DiagramElement, di_Diagram, di_Plane, di_Shape, Node, di_Bounds, di_LabeledEdge, Edge, di_Label, di_LabeledShape, Shape},
    associations={modelElement6, style7, ownedStyle9, rootElement11, source13, target15, waypoint18, owningDiagram0, owningElement2, ownedElement4, planeElement27, bounds20, ownedLabel21, bounds22, ownedLabel25},
    generalizations={gen_di_Node_DiagramElement, gen_di_Edge_DiagramElement, gen_di_Plane_Node, gen_di_Shape_Node, gen_di_LabeledEdge_Edge, gen_di_Label_Node, gen_di_LabeledShape_Shape},
    metadata=None
)
