...
# Classes
web_service_Service = Class(name="web_service_Service")
web_service_Endpoint = Class(name="web_service_Endpoint")
web_service_MessageFormatter = Class(name="web_service_MessageFormatter")
web_service_GenericDataRecogniser = Class(name="web_service_GenericDataRecogniser")
DataRecogniser = Class(name="DataRecogniser")
web_service_FunctionProvider = Class(name="web_service_FunctionProvider")
web_service_DataRecogniser = Class(name="web_service_DataRecogniser")
web_service_GenericMessageFormatter = Class(name="web_service_GenericMessageFormatter")
MessageFormatter = Class(name="MessageFormatter")
web_service_GenericFunctionProvider = Class(name="web_service_GenericFunctionProvider")
...
domain_model = DomainModel(
    name="web_service",
    types={web_service_Service, web_service_Endpoint, web_service_MessageFormatter, web_service_GenericDataRecogniser, DataRecogniser, web_service_FunctionProvider, web_service_DataRecogniser, web_service_GenericMessageFormatter, MessageFormatter, web_service_GenericFunctionProvider, FunctionProvider},
    associations={endpoint0, formatters1, functions3, recognisers5},
    generalizations={gen_web_service_GenericDataRecogniser_DataRecogniser, gen_web_service_GenericMessageFormatter_MessageFormatter, gen_web_service_GenericFunctionProvider_FunctionProvider},
    metadata=None
)
