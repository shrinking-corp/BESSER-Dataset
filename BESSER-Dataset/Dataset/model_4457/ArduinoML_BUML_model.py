...
arduinoml_Board = Class(name="arduinoml_Board")
...
arduinoml_Off = Class(name="arduinoml_Off")
Action = Class(name="Action")
arduinoml_On = Class(name="arduinoml_On")
arduinoml_Wait = Class(name="arduinoml_Wait")
arduinoml_Trigger = Class(name="arduinoml_Trigger")
...
domain_model = DomainModel(
    name="arduinoml",
    types={arduinoml_Brick, NamedElement, arduinoml_Action, arduinoml_Board, arduinoml_State, arduinoml_Sensor, Brick, arduinoml_Actuator, arduinoml_Transition, arduinoml_Off, Action, arduinoml_On, arduinoml_Wait, arduinoml_Trigger, arduinoml_NamedElement, DigitalValue},
    associations={alternatives1, bricks4, actions6, initial0, target9, eventCode8, actuators14, trigger11, source13, sensors16},
    generalizations={gen_arduinoml_State_NamedElement, gen_arduinoml_Sensor_Brick, gen_arduinoml_Actuator_Brick, gen_arduinoml_Transition_NamedElement, gen_arduinoml_Brick_NamedElement, gen_arduinoml_Off_Action, gen_arduinoml_On_Action, gen_arduinoml_Wait_Action},
    metadata=None
)
