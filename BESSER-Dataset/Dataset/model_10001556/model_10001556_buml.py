...
Chef.attributes={Chef_PersonalInformation, Chef_ID, Chef_Contact, Chef_Name, Chef_Domain, Chef_Address}
...
Waiter.attributes={Waiter_Contact, Waiter_Personal_Information, Waiter_Address, Waiter_ID, Waiter_Name}
...
Customer.attributes={Customer_date, Customer_Dishes_Ordered, Customer_Reservation, Customer_Contact_Number, Customer_reservedTables, Customer_Name}
...
Manager.attributes={Manager_ID, Manager_Name, Manager_Contact, Manager_Personalnformation, Manager_Address}
...
domain_model = DomainModel(
    name="_FT_wQPTuEemTHo7LQdQL6Q",
    types={Chef, Waiter, Customer, Class_, Manager},
