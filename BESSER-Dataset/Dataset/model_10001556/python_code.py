...
class Manager:
    ...
    def __init__(self, Name: str, Address: str, ID: int, Contact: int, Personalnformation: str, customer7: "Customer" = None, waiter1: "Waiter" = None):
        self.Name = Name
...
class Waiter:
    ...
    def __init__(self, Name: str, ID: str, Address: str, Contact: int, Personal_Information: str, chef2: "Chef" = None, customer4: "Customer" = None, manager0: "Manager" = None):
        self.Name = Name
        self.ID = ID
        self.Address = Address
        self.Contact = Contact
