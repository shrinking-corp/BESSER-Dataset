...
def test_arterial_access_site_is_not_abstract():
    assert not inspect.isabstract(Arterial_Access_Site)


def test_arterial_access_site_constructor_exists():
    assert callable(Arterial_Access_Site.__init__)


def test_arterial_access_site_constructor_args():
...
def test_arterial_access_site_has_AAA_Arterial_Access_Site():
    assert hasattr(Arterial_Access_Site, "AAA_Arterial_Access_Site")
    descriptor = None
    for klass in Arterial_Access_Site.__mro__:
        if "AAA_Arterial_Access_Site" in klass.__dict__:
            descriptor = klass.__dict__["AAA_Arterial_Access_Site"]
            break
    assert isinstance(descriptor, property)

def test_arterial_access_site_has_CathPCI_Arterial_Access_Site():
    assert hasattr(Arterial_Access_Site, "CathPCI_Arterial_Access_Site")
    descriptor = None
    for klass in Arterial_Access_Site.__mro__:
        if "CathPCI_Arterial_Access_Site" in klass.__dict__:
            descriptor = klass.__dict__["CathPCI_Arterial_Access_Site"]
            break
    assert isinstance(descriptor, property)

def test_arterial_access_site_has_Carotid_Intervention_Arterial_Access_Site():
    assert hasattr(Arterial_Access_Site, "Carotid_Intervention_Arterial_Access_Site")
    descriptor = None
    for klass in Arterial_Access_Site.__mro__:
        if "Carotid_Intervention_Arterial_Access_Site" in klass.__dict__:
            descriptor = klass.__dict__["Carotid_Intervention_Arterial_Access_Site"]
            break
    assert isinstance(descriptor, property)

def test_arterial_access_site_has_Renal_Arterial_Access_Site():
    assert hasattr(Arterial_Access_Site, "Renal_Arterial_Access_Site")
    descriptor = None
    for klass in Arterial_Access_Site.__mro__:
        if "Renal_Arterial_Access_Site" in klass.__dict__:
            descriptor = klass.__dict__["Renal_Arterial_Access_Site"]
            break
    assert isinstance(descriptor, property)

def test_arterial_access_site_has_Lower_Extremity_Arterial_Access_Site():
    assert hasattr(Arterial_Access_Site, "Lower_Extremity_Arterial_Access_Site")
    descriptor = None
    for klass in Arterial_Access_Site.__mro__:
        if "Lower_Extremity_Arterial_Access_Site" in klass.__dict__:
            descriptor = klass.__dict__["Lower_Extremity_Arterial_Access_Site"]
            break
    assert isinstance(descriptor, property)
...
@given(instance=Arterial_Access_Site_strategy)
def test_arterial_access_site_AAA_Arterial_Access_Site_setter(instance):
...
@given(instance=Arterial_Access_Site_strategy)
def test_arterial_access_site_CathPCI_Arterial_Access_Site_setter(instance):
...
@given(instance=Arterial_Access_Site_strategy)
def test_arterial_access_site_Carotid_Intervention_Arterial_Access_Site_setter(instance):
...
@given(instance=Arterial_Access_Site_strategy)
def test_arterial_access_site_Renal_Arterial_Access_Site_setter(instance):
...
@given(instance=Arterial_Access_Site_strategy)
def test_arterial_access_site_Lower_Extremity_Arterial_Access_Site_setter(instance):
