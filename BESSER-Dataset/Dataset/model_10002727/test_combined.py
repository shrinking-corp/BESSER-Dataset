...
def test_hyp_arterial_access_site_is_not_abstract():
    assert not inspect.isabstract(Arterial_Access_Site)


def test_hyp_arterial_access_site_constructor_exists():
    assert callable(Arterial_Access_Site.__init__)


def test_hyp_arterial_access_site_constructor_args():
    sig = inspect.signature(Arterial_Access_Site.__init__)
    params = list(sig.parameters.keys())
    assert "AAA_Arterial_Access_Site" in params, "Missing parameter 'AAA_Arterial_Access_Site'"
    assert "CathPCI_Arterial_Access_Site" in params, "Missing parameter 'CathPCI_Arterial_Access_Site'"
    assert "Carotid_Intervention_Arterial_Access_Site" in params, "Missing parameter 'Carotid_Intervention_Arterial_Access_Site'"
    assert "Renal_Arterial_Access_Site" in params, "Missing parameter 'Renal_Arterial_Access_Site'"
    assert "Lower_Extremity_Arterial_Access_Site" in params, "Missing parameter 'Lower_Extremity_Arterial_Access_Site'"
...
Arterial_Access_Site_strategy = st.builds(
    Arterial_Access_Site,
    AAA_Arterial_Access_Site=
        safe_text,
    CathPCI_Arterial_Access_Site=
        safe_text,
    Carotid_Intervention_Arterial_Access_Site=
        safe_text,
    Renal_Arterial_Access_Site=
        safe_text,
    Lower_Extremity_Arterial_Access_Site=
        safe_text
)
...
@given(instance=Arterial_Access_Site_strategy)
def test_hyp_arterial_access_site_AAA_Arterial_Access_Site_setter(instance):
    original = instance.AAA_Arterial_Access_Site
    instance.AAA_Arterial_Access_Site = original
    assert instance.AAA_Arterial_Access_Site == original



@given(instance=Arterial_Access_Site_strategy)
def test_hyp_arterial_access_site_CathPCI_Arterial_Access_Site_setter(instance):
    original = instance.CathPCI_Arterial_Access_Site
    instance.CathPCI_Arterial_Access_Site = original
    assert instance.CathPCI_Arterial_Access_Site == original



@given(instance=Arterial_Access_Site_strategy)
def test_hyp_arterial_access_site_Carotid_Intervention_Arterial_Access_Site_setter(instance):
    original = instance.Carotid_Intervention_Arterial_Access_Site
    instance.Carotid_Intervention_Arterial_Access_Site = original
    assert instance.Carotid_Intervention_Arterial_Access_Site == original



@given(instance=Arterial_Access_Site_strategy)
def test_hyp_arterial_access_site_Renal_Arterial_Access_Site_setter(instance):
    original = instance.Renal_Arterial_Access_Site
    instance.Renal_Arterial_Access_Site = original
    assert instance.Renal_Arterial_Access_Site == original



@given(instance=Arterial_Access_Site_strategy)
def test_hyp_arterial_access_site_Lower_Extremity_Arterial_Access_Site_setter(instance):
    original = instance.Lower_Extremity_Arterial_Access_Site
    instance.Lower_Extremity_Arterial_Access_Site = original
    assert instance.Lower_Extremity_Arterial_Access_Site == original
...
def test_Arterial_Access_Site_AAA_Arterial_Access_Site_value_roundtrip():
    instance = Arterial_Access_Site(AAA_Arterial_Access_Site="sample_text", Carotid_Intervention_Arterial_Access_Site="sample_text", CathPCI_Arterial_Access_Site="sample_text", Lower_Extremity_Arterial_Access_Site="sample_text", Renal_Arterial_Access_Site="sample_text")
    assert instance.AAA_Arterial_Access_Site == "sample_text"
    instance.AAA_Arterial_Access_Site = "sample_text_2"
    assert instance.AAA_Arterial_Access_Site == "sample_text_2"


def test_Arterial_Access_Site_Carotid_Intervention_Arterial_Access_Site_value_roundtrip():
    instance = Arterial_Access_Site(AAA_Arterial_Access_Site="sample_text", Carotid_Intervention_Arterial_Access_Site="sample_text", CathPCI_Arterial_Access_Site="sample_text", Lower_Extremity_Arterial_Access_Site="sample_text", Renal_Arterial_Access_Site="sample_text")
    assert instance.Carotid_Intervention_Arterial_Access_Site == "sample_text"
    instance.Carotid_Intervention_Arterial_Access_Site = "sample_text_2"
    assert instance.Carotid_Intervention_Arterial_Access_Site == "sample_text_2"


def test_Arterial_Access_Site_CathPCI_Arterial_Access_Site_value_roundtrip():
    instance = Arterial_Access_Site(AAA_Arterial_Access_Site="sample_text", Carotid_Intervention_Arterial_Access_Site="sample_text", CathPCI_Arterial_Access_Site="sample_text", Lower_Extremity_Arterial_Access_Site="sample_text", Renal_Arterial_Access_Site="sample_text")
    assert instance.CathPCI_Arterial_Access_Site == "sample_text"
    instance.CathPCI_Arterial_Access_Site = "sample_text_2"
    assert instance.CathPCI_Arterial_Access_Site == "sample_text_2"


def test_Arterial_Access_Site_Lower_Extremity_Arterial_Access_Site_value_roundtrip():
    instance = Arterial_Access_Site(AAA_Arterial_Access_Site="sample_text", Carotid_Intervention_Arterial_Access_Site="sample_text", CathPCI_Arterial_Access_Site="sample_text", Lower_Extremity_Arterial_Access_Site="sample_text", Renal_Arterial_Access_Site="sample_text")
    assert instance.Lower_Extremity_Arterial_Access_Site == "sample_text"
    instance.Lower_Extremity_Arterial_Access_Site = "sample_text_2"
    assert instance.Lower_Extremity_Arterial_Access_Site == "sample_text_2"


def test_Arterial_Access_Site_Renal_Arterial_Access_Site_value_roundtrip():
    instance = Arterial_Access_Site(AAA_Arterial_Access_Site="sample_text", Carotid_Intervention_Arterial_Access_Site="sample_text", CathPCI_Arterial_Access_Site="sample_text", Lower_Extremity_Arterial_Access_Site="sample_text", Renal_Arterial_Access_Site="sample_text")
    assert instance.Renal_Arterial_Access_Site == "sample_text"
    instance.Renal_Arterial_Access_Site = "sample_text_2"
    assert instance.Renal_Arterial_Access_Site == "sample_text_2"
...
Arterial_Access_Site_strategy = st.builds(Arterial_Access_Site, AAA_Arterial_Access_Site=safe_text, Carotid_Intervention_Arterial_Access_Site=safe_text, CathPCI_Arterial_Access_Site=safe_text, Lower_Extremity_Arterial_Access_Site=safe_text, Renal_Arterial_Access_Site=safe_text)
@given(instance=Arterial_Access_Site_strategy)
@settings(max_examples=25)
def test_Arterial_Access_Site_instantiation(instance):
    assert isinstance(instance, Arterial_Access_Site)
