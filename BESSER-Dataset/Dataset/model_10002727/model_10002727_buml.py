...
Arterial_Access_Site = Class(name="Arterial_Access_Site")
...
# Arterial_Access_Site class attributes and methods
Arterial_Access_Site_CathPCI_Arterial_Access_Site: Property = Property(name="CathPCI_Arterial_Access_Site", type=StringType)
Arterial_Access_Site_AAA_Arterial_Access_Site: Property = Property(name="AAA_Arterial_Access_Site", type=StringType)
Arterial_Access_Site_Lower_Extremity_Arterial_Access_Site: Property = Property(name="Lower_Extremity_Arterial_Access_Site", type=StringType)
Arterial_Access_Site_Renal_Arterial_Access_Site: Property = Property(name="Renal_Arterial_Access_Site", type=StringType)
Arterial_Access_Site_Carotid_Intervention_Arterial_Access_Site: Property = Property(name="Carotid_Intervention_Arterial_Access_Site", type=StringType)
Arterial_Access_Site.attributes={Arterial_Access_Site_AAA_Arterial_Access_Site, Arterial_Access_Site_Renal_Arterial_Access_Site, Arterial_Access_Site_Lower_Extremity_Arterial_Access_Site, Arterial_Access_Site_CathPCI_Arterial_Access_Site, Arterial_Access_Site_Carotid_Intervention_Arterial_Access_Site}
...
domain_model = DomainModel(
    name="d24e945b_e567_479e_b800_a8237bc450ba",
    types={CPU, Processor, AcceleratorCard, Cache, RAM, Machine, Program, Instruction, Memory_Interface, DeviceCard, Card, Sound, GenericSound, Vendor1Adapter, Vendor2Adapter, Vendor1Sound, Vendor2Sound, ExtensionBoard, FastCard, Arterial_Access_Site},
