...
domain_model = DomainModel(
    name="state",
    types={state_Trigger, state_State, Vertex, NamedElement, state_Region, state_Vertex, state_StateMachine, state_Transition, state_Behaviour, state_NamedElement, State, state_OpaqueExpression, state_Event, state_Constraint, state_FinalState, state_StateModel, state_PseudoState, TransitionKind, PseudoStateKind},
    associations={region0, defferableTrigger1, subVertex14, stateMachine16, transition18, doActivity3, entry5, exit8, state11, incoming24, source26, target27, region20, outgoing23, specification37, event39, trigger29, guard32, effect34, packagedElment41},
    generalizations={gen_state_State_Vertex, gen_state_State_NamedElement, gen_state_Region_NamedElement, gen_state_Transition_NamedElement, gen_state_StateMachine_NamedElement, gen_state_Vertex_NamedElement, gen_state_FinalState_State, gen_state_Trigger_NamedElement, gen_state_PseudoState_Vertex},
    metadata=None
)
