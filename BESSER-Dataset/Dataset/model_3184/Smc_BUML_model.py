...
# Classes
smc_BlockSMC = Class(name="smc_BlockSMC")
smc_MainSMC = Class(name="smc_MainSMC")
smc_Command = Class(name="smc_Command")
smc_Smc = Class(name="smc_Smc")
smc_VariableDecl = Class(name="smc_VariableDecl")
smc_AbstractAssignment = Class(name="smc_AbstractAssignment")
smc_VariableAssignment = Class(name="smc_VariableAssignment")
smc_ParamDecl = Class(name="smc_ParamDecl")
Command = Class(name="Command")
smc_InvocationVoid = Class(name="smc_InvocationVoid")
smc_Invocation = Class(name="smc_Invocation")
smc_Print = Class(name="smc_Print")
smc_Expression = Class(name="smc_Expression")
smc_While = Class(name="smc_While")
smc_IfThenElse = Class(name="smc_IfThenElse")
smc_Functions = Class(name="smc_Functions")
smc_Computation = Class(name="smc_Computation")
Functions = Class(name="Functions")
smc_Multiplication = Class(name="smc_Multiplication")
Computation = Class(name="Computation")
smc_Median = Class(name="smc_Median")
smc_WeightedAvg = Class(name="smc_WeightedAvg")
smc_Download = Class(name="smc_Download")
AbstractAssignment = Class(name="AbstractAssignment")
smc_Database = Class(name="smc_Database")
Download = Class(name="Download")
smc_Client = Class(name="smc_Client")
smc_Tuple = Class(name="smc_Tuple")
Expression = Class(name="Expression")
smc_List = Class(name="smc_List")
smc_Dict = Class(name="smc_Dict")
smc_Search = Class(name="smc_Search")
smc_BloomFilter = Class(name="smc_BloomFilter")
smc_CheckTable = Class(name="smc_CheckTable")
smc_AddValues = Class(name="smc_AddValues")
smc_Average = Class(name="smc_Average")
smc_Count = Class(name="smc_Count")
smc_AccessControl = Class(name="smc_AccessControl")
smc_BellLapadula = Class(name="smc_BellLapadula")
AccessControl = Class(name="AccessControl")
smc_Covered = Class(name="smc_Covered")
smc_Equality = Class(name="smc_Equality")
smc_Comparison = Class(name="smc_Comparison")
smc_CreateTable = Class(name="smc_CreateTable")
smc_Return = Class(name="smc_Return")
smc_Block = Class(name="smc_Block")
smc_Or = Class(name="smc_Or")
smc_And = Class(name="smc_And")
smc_StringLiteral = Class(name="smc_StringLiteral")
smc_DateLiteral = Class(name="smc_DateLiteral")
smc_TimeLiteral = Class(name="smc_TimeLiteral")
smc_VariableRef = Class(name="smc_VariableRef")
smc_PlusOrMinus = Class(name="smc_PlusOrMinus")
smc_MulOrDiv = Class(name="smc_MulOrDiv")
smc_Not = Class(name="smc_Not")
smc_IntLiteral = Class(name="smc_IntLiteral")
smc_DoubleLiteral = Class(name="smc_DoubleLiteral")
smc_BooleanLiteral = Class(name="smc_BooleanLiteral")
...
smc_VariableDecl.attributes={smc_VariableDecl_length, smc_VariableDecl_type, smc_VariableDecl_name, smc_VariableDecl_visibility, smc_VariableDecl_array}
...
smc_ParamDecl.attributes={smc_ParamDecl_parName, smc_ParamDecl_btype, smc_ParamDecl_name, smc_ParamDecl_stype}
...
domain_model = DomainModel(
    name="smc",
    types={smc_BlockSMC, smc_MainSMC, smc_Command, smc_Smc, smc_VariableDecl, smc_AbstractAssignment, smc_VariableAssignment, smc_ParamDecl, Command, smc_InvocationVoid, smc_Invocation, smc_Print, smc_Expression, smc_While, smc_IfThenElse, smc_Functions, smc_Computation, Functions, smc_Multiplication, Computation, smc_Median, smc_WeightedAvg, smc_Download, AbstractAssignment, smc_Database, Download, smc_Client, smc_Tuple, Expression, smc_List, smc_Dict, smc_Search, smc_BloomFilter, smc_CheckTable, smc_AddValues, smc_Average, smc_Count, smc_AccessControl, smc_BellLapadula, AccessControl, smc_Covered, smc_Equality, smc_Comparison, smc_CreateTable, smc_Return, smc_Block, smc_Or, smc_And, smc_StringLiteral, smc_DateLiteral, smc_TimeLiteral, smc_VariableRef, smc_PlusOrMinus, smc_MulOrDiv, smc_Not, smc_IntLiteral, smc_DoubleLiteral, smc_BooleanLiteral, BlockType, SecType, BasicType},
    associations={blocks0, main1, commands3, elseBranch17, option20, var21, call5, value6, condition7, body9, condition12, thenBrach14, value37, blockName40, funcName43, x45, y47, array50, option23, tbl26, arg128, arg230, args33, key35, covered70, tblname73, keyword75, pre78, post80, tblname83, weights52, elems54, array57, array59, c_lvls61, v_lvl63, cur66, match68, left101, right103, left106, right108, left111, right113, tblname85, args87, tblname90, params92, commands94, left96, right98, variable128, left116, right118, left121, right123, expression126},
    generalizations={gen_smc_VariableDecl_Command, gen_smc_VariableAssignment_Command, gen_smc_ParamDecl_Command, gen_smc_InvocationVoid_Command, gen_smc_Print_Command, gen_smc_While_Command, gen_smc_IfThenElse_Command, gen_smc_Invocation_Expression, gen_smc_Computation_Functions, gen_smc_Multiplication_Computation, gen_smc_Median_Computation, gen_smc_WeightedAvg_Computation, gen_smc_Download_AbstractAssignment, gen_smc_Database_Download, gen_smc_Client_Download, gen_smc_Expression_AbstractAssignment, gen_smc_Tuple_Expression, gen_smc_List_Expression, gen_smc_Dict_Expression, gen_smc_Search_Functions, gen_smc_BloomFilter_Functions, gen_smc_CheckTable_Functions, gen_smc_AddValues_Functions, gen_smc_Average_Computation, gen_smc_Count_Computation, gen_smc_AccessControl_Functions, gen_smc_BellLapadula_AccessControl, gen_smc_Covered_AccessControl, gen_smc_Equality_Expression, gen_smc_Comparison_Expression, gen_smc_CreateTable_Functions, gen_smc_Return_Command, gen_smc_Block_Command, gen_smc_Or_Expression, gen_smc_And_Expression, gen_smc_BooleanLiteral_Expression, gen_smc_StringLiteral_Expression, gen_smc_DateLiteral_Expression, gen_smc_TimeLiteral_Expression, gen_smc_VariableRef_Expression, gen_smc_PlusOrMinus_Expression, gen_smc_MulOrDiv_Expression, gen_smc_Not_Expression, gen_smc_IntLiteral_Expression, gen_smc_DoubleLiteral_Expression},
    metadata=None
)
