...
def test_hyp_keypresseventargs__is_not_abstract():
    assert not inspect.isabstract(KeyPressEventArgs_)


def test_hyp_keypresseventargs__constructor_exists():
    assert callable(KeyPressEventArgs_.__init__)


def test_hyp_keypresseventargs__constructor_args():
...
def test_hyp_font_2_is_not_abstract():
    assert not inspect.isabstract(Font_2)


def test_hyp_font_2_constructor_exists():
    assert callable(Font_2.__init__)


def test_hyp_font_2_constructor_args():
    sig = inspect.signature(Font_2.__init__)
    params = list(sig.parameters.keys())



def test_hyp_font__is_not_abstract():
    assert not inspect.isabstract(Font_)


def test_hyp_font__constructor_exists():
    assert callable(Font_.__init__)


def test_hyp_font__constructor_args():
    sig = inspect.signature(Font_.__init__)
    params = list(sig.parameters.keys())



def test_hyp_threadexceptioneventargs__is_not_abstract():
    assert not inspect.isabstract(ThreadExceptionEventArgs_)


def test_hyp_threadexceptioneventargs__constructor_exists():
    assert callable(ThreadExceptionEventArgs_.__init__)


def test_hyp_threadexceptioneventargs__constructor_args():
    sig = inspect.signature(ThreadExceptionEventArgs_.__init__)
    params = list(sig.parameters.keys())



def test_hyp_object__is_not_abstract():
    assert not inspect.isabstract(Object_)


def test_hyp_object__constructor_exists():
    assert callable(Object_.__init__)


def test_hyp_object__constructor_args():
...
def test_hyp_pl_form__is_not_abstract():
    assert not inspect.isabstract(PL_Form_)


def test_hyp_pl_form__constructor_exists():
    assert callable(PL_Form_.__init__)


def test_hyp_pl_form__constructor_args():
    sig = inspect.signature(PL_Form_.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pl_groesse__is_not_abstract():
    assert not inspect.isabstract(PL_Groesse_)


def test_hyp_pl_groesse__constructor_exists():
    assert callable(PL_Groesse_.__init__)


def test_hyp_pl_groesse__constructor_args():
    sig = inspect.signature(PL_Groesse_.__init__)
    params = list(sig.parameters.keys())



def test_hyp_list_teigrezept____is_not_abstract():
    assert not inspect.isabstract(List_TeigRezept___)


def test_hyp_list_teigrezept____constructor_exists():
    assert callable(List_TeigRezept___.__init__)


def test_hyp_list_teigrezept____constructor_args():
    sig = inspect.signature(List_TeigRezept___.__init__)
    params = list(sig.parameters.keys())



def test_hyp_array_zutat____is_not_abstract():
    assert not inspect.isabstract(Array_Zutat___)


def test_hyp_array_zutat____constructor_exists():
    assert callable(Array_Zutat___.__init__)


def test_hyp_array_zutat____constructor_args():
    sig = inspect.signature(Array_Zutat___.__init__)
    params = list(sig.parameters.keys())



def test_hyp_list_dekorrezept____is_not_abstract():
    assert not inspect.isabstract(List_DekorRezept___)


def test_hyp_list_dekorrezept____constructor_exists():
    assert callable(List_DekorRezept___.__init__)


def test_hyp_list_dekorrezept____constructor_args():
    sig = inspect.signature(List_DekorRezept___.__init__)
    params = list(sig.parameters.keys())



def test_hyp_list_plaetzchenform____is_not_abstract():
    assert not inspect.isabstract(List_PlaetzchenForm___)


def test_hyp_list_plaetzchenform____constructor_exists():
    assert callable(List_PlaetzchenForm___.__init__)


def test_hyp_list_plaetzchenform____constructor_args():
    sig = inspect.signature(List_PlaetzchenForm___.__init__)
    params = list(sig.parameters.keys())



def test_hyp_list_zutat____is_not_abstract():
    assert not inspect.isabstract(List_Zutat___)


def test_hyp_list_zutat____constructor_exists():
    assert callable(List_Zutat___.__init__)


def test_hyp_list_zutat____constructor_args():
    sig = inspect.signature(List_Zutat___.__init__)
    params = list(sig.parameters.keys())



def test_hyp_gussrezept_is_not_abstract():
    assert not inspect.isabstract(GussRezept)


def test_hyp_gussrezept_constructor_exists():
    assert callable(GussRezept.__init__)


def test_hyp_gussrezept_constructor_args():
...
def test_hyp_gussrezept_has_basis():
...
def test_hyp_gussrezept_has_zutat():
...
def test_hyp_gussrezept_has_basismenge():
...
def test_hyp_rezept_is_not_abstract():
    assert not inspect.isabstract(Rezept)


def test_hyp_rezept_constructor_exists():
    assert callable(Rezept.__init__)


def test_hyp_rezept_constructor_args():
...
def test_hyp_rezept_has_rezeptname():
...
def test_hyp_rezept_has_basismenge():
...
def test_hyp_rezept_has_attribute2():
...
def test_hyp_rezept_has_attribute():
...
def test_hyp_dekorrezept_is_not_abstract():
    assert not inspect.isabstract(DekorRezept)


def test_hyp_dekorrezept_constructor_exists():
    assert callable(DekorRezept.__init__)


def test_hyp_dekorrezept_constructor_args():
...
def test_hyp_dekorrezept_has_basismenge():
...
def test_hyp_dekorrezept_has_zutaten():
...
def test_hyp_dekorrezept_has_basis():
...
def test_hyp_dekorrezept_has_dekor():
...
def test_hyp_guirezept_is_not_abstract():
    assert not inspect.isabstract(GUIRezept)


def test_hyp_guirezept_constructor_exists():
    assert callable(GUIRezept.__init__)


def test_hyp_guirezept_constructor_args():
...
def test_hyp_combobox_is_not_abstract():
    assert not inspect.isabstract(ComboBox)


def test_hyp_combobox_constructor_exists():
    assert callable(ComboBox.__init__)


def test_hyp_combobox_constructor_args():
    sig = inspect.signature(ComboBox.__init__)
    params = list(sig.parameters.keys())



def test_hyp_plaetzchen__is_not_abstract():
    assert not inspect.isabstract(Plaetzchen_)


def test_hyp_plaetzchen__constructor_exists():
    assert callable(Plaetzchen_.__init__)


def test_hyp_plaetzchen__constructor_args():
...
def test_hyp_plaetzchen_has_menge():
...
def test_hyp_plaetzchen_has_deko():
...
def test_hyp_plaetzchen_has_rezeptTeig():
...
def test_hyp_plaetzchen_has_form():
...
def test_hyp_plaetzchen_has_guss():
...
def test_hyp_plaetzchen_has_rezeptDeko():
...
def test_hyp_plaetzchen_has_teig():
...
def test_hyp_plaetzchen_has_rezeptGuss():
...
def test_hyp_teigrezept__is_not_abstract():
    assert not inspect.isabstract(TeigRezept_)


def test_hyp_teigrezept__constructor_exists():
    assert callable(TeigRezept_.__init__)


def test_hyp_teigrezept__constructor_args():
    sig = inspect.signature(TeigRezept_.__init__)
    params = list(sig.parameters.keys())



def test_hyp_teigrezept_is_not_abstract():
    assert not inspect.isabstract(TeigRezept)


def test_hyp_teigrezept_constructor_exists():
    assert callable(TeigRezept.__init__)


def test_hyp_teigrezept_constructor_args():
...
def test_hyp_teigrezept_has_basismenge():
...
def test_hyp_teigrezept_has_basis():
...
def test_hyp_teigrezept_has_zutaten():
...
def test_hyp_teigrezept_has_backzeit():
...
def test_hyp_teigrezept_has_backtemp():
...
def test_hyp_konfigdatei__is_not_abstract():
    assert not inspect.isabstract(KonfigDatei_)


def test_hyp_konfigdatei__constructor_exists():
    assert callable(KonfigDatei_.__init__)


def test_hyp_konfigdatei__constructor_args():
    sig = inspect.signature(KonfigDatei_.__init__)
    params = list(sig.parameters.keys())



def test_hyp_konfigdatei_is_not_abstract():
    assert not inspect.isabstract(KonfigDatei)


def test_hyp_konfigdatei_constructor_exists():
    assert callable(KonfigDatei.__init__)


def test_hyp_konfigdatei_constructor_args():
...
def test_hyp_konfigdatei_has_menge1():
...
def test_hyp_konfigdatei_has_attribute():
...
def test_hyp_konfigdatei_has_menge():
...
def test_hyp_konfigdatei_has_backtemp():
...
def test_hyp_konfigdatei_has_plaetzchen():
...
def test_hyp_konfigdatei_has_attribute2():
...
def test_hyp_konfigdatei_has_backzeit():
...
def test_hyp_konfigdatei_has_name():
...
def test_hyp_guikeksform_is_not_abstract():
    assert not inspect.isabstract(GUIKeksform)


def test_hyp_guikeksform_constructor_exists():
    assert callable(GUIKeksform.__init__)


def test_hyp_guikeksform_constructor_args():
...
def test_hyp_guikeksform_has_breite():
...
def test_hyp_guikeksform_has_laenge():
...
def test_hyp_guikeksform_has_name():
...
def test_hyp_guikeksform_has_pl__f():
...
def test_hyp_gui_has_plaetzchenname():
...
def test_hyp_gui_has_stueckzahl():
...
def test_hyp_gui_has_dekorList():
...
def test_hyp_gui_has_zutatenList():
...
def test_hyp_gui_has_teigsorte():
...
def test_hyp_gui_has_plaetzchen():
...
def test_hyp_gui_has_dateiname():
...
def test_hyp_gui_has_attribute():
...
def test_hyp_gui_has_plformList():
...
def test_hyp_groesse_has_breite():
...
def test_hyp_groesse_has_name1():
...
def test_hyp_groesse_has_laenge():
...
def test_hyp_plaetzchenform_has_faktor():
...
def test_hyp_plaetzchenform_has_pl_groesse():
...
def test_hyp_plaetzchenform_has_pl_form():
...
def test_hyp_zutat_has_einheit():
...
def test_hyp_pl_form_exists():
    # Check that the Enumeration exists
    assert PL_Form is not None

def test_hyp_pl_form_has_all_literals():
...
def test_hyp_pl_groesse_exists():
    # Check that the Enumeration exists
    assert PL_Groesse is not None

def test_hyp_pl_groesse_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_gussrezept_instantiation(instance):
    assert isinstance(instance, GussRezept)



@given(instance=GussRezept_strategy)
def test_hyp_gussrezept_basis_setter(instance):
...
@given(instance=GussRezept_strategy)
def test_hyp_gussrezept_zutat_setter(instance):
...
@given(instance=GussRezept_strategy)
def test_hyp_gussrezept_basismenge_setter(instance):
...
@settings(max_examples=50)
def test_hyp_rezept_instantiation(instance):
    assert isinstance(instance, Rezept)



@given(instance=Rezept_strategy)
def test_hyp_rezept_rezeptname_setter(instance):
...
@given(instance=Rezept_strategy)
def test_hyp_rezept_basismenge_setter(instance):
    original = instance.basismenge
    instance.basismenge = original
    assert instance.basismenge == original
...
@given(instance=Rezept_strategy)
def test_hyp_rezept_attribute2_setter(instance):
...
@given(instance=Rezept_strategy)
def test_hyp_rezept_basis_setter(instance):
    original = instance.basis
    instance.basis = original
    assert instance.basis == original
...
@given(instance=Rezept_strategy)
def test_hyp_rezept_attribute_setter(instance):
...
@settings(max_examples=50)
def test_hyp_dekorrezept_instantiation(instance):
    assert isinstance(instance, DekorRezept)



@given(instance=DekorRezept_strategy)
def test_hyp_dekorrezept_basismenge_setter(instance):
    original = instance.basismenge
    instance.basismenge = original
    assert instance.basismenge == original
...
@given(instance=DekorRezept_strategy)
def test_hyp_dekorrezept_zutaten_setter(instance):
...
@given(instance=DekorRezept_strategy)
def test_hyp_dekorrezept_basis_setter(instance):
    original = instance.basis
    instance.basis = original
    assert instance.basis == original
...
@given(instance=DekorRezept_strategy)
def test_hyp_dekorrezept_dekor_setter(instance):
...
def test_hyp_guirezept_name_setter(instance):
...
@given(instance=Plaetzchen_strategy)
def test_hyp_plaetzchen_menge_setter(instance):
...
@given(instance=Plaetzchen_strategy)
def test_hyp_plaetzchen_deko_setter(instance):
...
@given(instance=Plaetzchen_strategy)
def test_hyp_plaetzchen_rezeptTeig_setter(instance):
...
@given(instance=Plaetzchen_strategy)
def test_hyp_plaetzchen_guss_setter(instance):
...
@given(instance=Plaetzchen_strategy)
def test_hyp_plaetzchen_rezeptDeko_setter(instance):
...
@given(instance=Plaetzchen_strategy)
def test_hyp_plaetzchen_rezeptGuss_setter(instance):
...
@settings(max_examples=50)
def test_hyp_teigrezept_instantiation(instance):
    assert isinstance(instance, TeigRezept)



@given(instance=TeigRezept_strategy)
def test_hyp_teigrezept_basismenge_setter(instance):
    original = instance.basismenge
    instance.basismenge = original
    assert instance.basismenge == original
...
@given(instance=TeigRezept_strategy)
def test_hyp_teigrezept_basis_setter(instance):
    original = instance.basis
    instance.basis = original
    assert instance.basis == original
...
@given(instance=TeigRezept_strategy)
def test_hyp_teigrezept_zutaten_setter(instance):
    original = instance.zutaten
    instance.zutaten = original
    assert instance.zutaten == original
...
@given(instance=TeigRezept_strategy)
def test_hyp_teigrezept_backzeit_setter(instance):
...
@given(instance=TeigRezept_strategy)
def test_hyp_teigrezept_backtemp_setter(instance):
...
@settings(max_examples=50)
def test_hyp_konfigdatei_instantiation(instance):
    assert isinstance(instance, KonfigDatei)



@given(instance=KonfigDatei_strategy)
def test_hyp_konfigdatei_menge1_setter(instance):
...
@given(instance=KonfigDatei_strategy)
def test_hyp_konfigdatei_attribute_setter(instance):
    original = instance.attribute
    instance.attribute = original
    assert instance.attribute == original
...
@given(instance=KonfigDatei_strategy)
def test_hyp_konfigdatei_menge_setter(instance):
    original = instance.menge
    instance.menge = original
    assert instance.menge == original
...
@given(instance=KonfigDatei_strategy)
def test_hyp_konfigdatei_backtemp_setter(instance):
    original = instance.backtemp
    instance.backtemp = original
    assert instance.backtemp == original
...
@given(instance=KonfigDatei_strategy)
def test_hyp_konfigdatei_plaetzchen_setter(instance):
...
@given(instance=KonfigDatei_strategy)
def test_hyp_konfigdatei_attribute2_setter(instance):
    original = instance.attribute2
    instance.attribute2 = original
    assert instance.attribute2 == original
...
@given(instance=KonfigDatei_strategy)
def test_hyp_konfigdatei_backzeit_setter(instance):
    original = instance.backzeit
    instance.backzeit = original
    assert instance.backzeit == original
...
@given(instance=KonfigDatei_strategy)
def test_hyp_konfigdatei_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@settings(max_examples=50)
def test_hyp_guikeksform_instantiation(instance):
    assert isinstance(instance, GUIKeksform)



@given(instance=GUIKeksform_strategy)
def test_hyp_guikeksform_breite_setter(instance):
...
@given(instance=GUIKeksform_strategy)
def test_hyp_guikeksform_laenge_setter(instance):
...
@given(instance=GUIKeksform_strategy)
def test_hyp_guikeksform_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=GUIKeksform_strategy)
def test_hyp_guikeksform_pl__f_setter(instance):
...
@settings(max_examples=50)
def test_hyp_gui_instantiation(instance):
    assert isinstance(instance, GUI)



@given(instance=GUI_strategy)
def test_hyp_gui_groesse_setter(instance):
...
@given(instance=GUI_strategy)
def test_hyp_gui_guss_setter(instance):
    original = instance.guss
    instance.guss = original
    assert instance.guss == original
...
@given(instance=GUI_strategy)
def test_hyp_gui_plaetzchenname_setter(instance):
...
@given(instance=GUI_strategy)
def test_hyp_gui_gussList_setter(instance):
...
@given(instance=GUI_strategy)
def test_hyp_gui_stueckzahl_setter(instance):
...
@given(instance=GUI_strategy)
def test_hyp_gui_dekorList_setter(instance):
...
@given(instance=GUI_strategy)
def test_hyp_gui_zutatenList_setter(instance):
...
@given(instance=GUI_strategy)
def test_hyp_gui_deko_setter(instance):
    original = instance.deko
    instance.deko = original
    assert instance.deko == original
...
@given(instance=GUI_strategy)
def test_hyp_gui_teigsorte_setter(instance):
...
@given(instance=GUI_strategy)
def test_hyp_gui_teigList_setter(instance):
...
@given(instance=GUI_strategy)
def test_hyp_gui_plaetzchen_setter(instance):
    original = instance.plaetzchen
    instance.plaetzchen = original
    assert instance.plaetzchen == original
...
@given(instance=GUI_strategy)
def test_hyp_gui_dateiname_setter(instance):
...
@given(instance=GUI_strategy)
def test_hyp_gui_datei_setter(instance):
...
@given(instance=GUI_strategy)
def test_hyp_gui_attribute_setter(instance):
    original = instance.attribute
    instance.attribute = original
    assert instance.attribute == original
...
@given(instance=GUI_strategy)
def test_hyp_gui_form_setter(instance):
    original = instance.form
    instance.form = original
    assert instance.form == original
...
@given(instance=GUI_strategy)
def test_hyp_gui_plformList_setter(instance):
...
@settings(max_examples=50)
def test_hyp_groesse_instantiation(instance):
...
@given(instance=PlaetzchenForm_strategy)
def test_hyp_plaetzchenform_faktor_setter(instance):
...
@given(instance=PlaetzchenForm_strategy)
def test_hyp_plaetzchenform_pl_groesse_setter(instance):
...
@given(instance=PlaetzchenForm_strategy)
def test_hyp_plaetzchenform_pl_form_setter(instance):
...
@settings(max_examples=50)
def test_hyp_zutat_instantiation(instance):
