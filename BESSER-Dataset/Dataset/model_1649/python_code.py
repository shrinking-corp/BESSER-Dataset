...
class simpleworld_RelatedTo(NamedElement):
    ...
    def __init__(self, since: str, relations: "simpleworld_Thing" = None, RelatedTo: "simpleworld_Thing" = None, simpleworld_RelatedTo: "simpleworld_Thing" = None):
        self.since = since
...
class simpleworld_Thing(NamedElement):
    ...
    def __init__(self, id: int, Thing: "simpleworld_RelatedTo" = None, simpleworld_Thing: "simpleworld_World" = None, fromThing: set["simpleworld_RelatedTo"] = None, simpleworld_Thing4: "simpleworld_RelatedTo" = None):
        self.id = id
        self.Thing = Thing
