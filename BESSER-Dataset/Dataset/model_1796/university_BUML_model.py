...
# Classes
university_University = Class(name="university_University")
NamedElement = Class(name="NamedElement")
university_Department = Class(name="university_Department")
university_StaffMember = Class(name="university_StaffMember")
university_Student = Class(name="university_Student")
university_Module = Class(name="university_Module")
university_Vehicle = Class(name="university_Vehicle")
university_Computer = Class(name="university_Computer")
university_Book = Class(name="university_Book")
university_Library = Class(name="university_Library")
university_NamedElement = Class(name="university_NamedElement", is_abstract=True)
university_PrimitiveType = Class(name="university_PrimitiveType")
...
university_Book.attributes={university_Book_ISBN, university_Book_authorNames}
...
university_PrimitiveType.attributes={university_PrimitiveType_n, university_PrimitiveType_p, university_PrimitiveType_l, university_PrimitiveType_k, university_PrimitiveType_c, university_PrimitiveType_bigIntList, university_PrimitiveType_e, university_PrimitiveType_b, university_PrimitiveType_m, university_PrimitiveType_f, university_PrimitiveType_g, university_PrimitiveType_d, university_PrimitiveType_i, university_PrimitiveType_h, university_PrimitiveType_o, university_PrimitiveType_a, university_PrimitiveType_j}
...
domain_model = DomainModel(
    name="university",
    types={university_University, NamedElement, university_Department, university_StaffMember, university_Student, university_Module, university_Vehicle, university_Computer, university_Book, university_Library, university_NamedElement, university_PrimitiveType, StaffMemberType},
    associations={chancelor3, enrolledModules5, registeredVehicle6, mainComputer7, books9, libraryVans11, departments0, libraries1, taughtModules14, registeredVehicles16, staff19, students22, moduleLecturers25, enrolledStudents26},
    generalizations={gen_university_University_NamedElement, gen_university_Student_NamedElement, gen_university_Library_NamedElement, gen_university_Computer_NamedElement, gen_university_Book_NamedElement, gen_university_Department_NamedElement, gen_university_Module_NamedElement, gen_university_StaffMember_NamedElement},
    metadata=None
)
