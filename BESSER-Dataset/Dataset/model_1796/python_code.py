...
class university_PrimitiveType:
    ...
    def __init__(self, a: str, b: int, f: float, g: str, h: str, i: float, j: str, k: str, l: str, m: str, n: str, o: str, p: str, c: str, bigIntList: str, d: bool, e: str):
        self.a = a
        self.b = b
        self.f = f
        self.g = g
...
class university_Vehicle:
    ...
    def __init__(self, registrationNumber: str, university_Vehicle: "university_Student" = None, university_Vehicle13: "university_Library" = None, university_Vehicle18: "university_StaffMember" = None):
