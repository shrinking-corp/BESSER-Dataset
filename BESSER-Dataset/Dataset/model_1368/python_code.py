...
class HSM_AbstractState(ABC):
    ...
    def __init__(self, name: str, AbstractState: "HSM_StateMachine" = None, AbstractState13: "HSM_CompositeState" = None, HSM_AbstractState: "HSM_Transition" = None, HSM_AbstractState7: "HSM_Transition" = None, states: "HSM_StateMachine" = None, states11: "HSM_CompositeState" = None):
        self.name = name
