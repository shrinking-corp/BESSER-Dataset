...
HSM_AbstractState = Class(name="HSM_AbstractState", is_abstract=True)
HSM_RegularState = Class(name="HSM_RegularState")
...
domain_model = DomainModel(
    name="HSM",
    types={HSM_StateMachine, HSM_Transition, HSM_AbstractState, HSM_RegularState, HSM_CompositeState, HSM_InitialState, AbstractState},
    associations={transitions0, states1, states12, stateMachine3, source4, target5, stateMachine8, compositeState10},
    generalizations={gen_HSM_RegularState_AbstractState, gen_HSM_CompositeState_AbstractState, gen_HSM_InitialState_AbstractState},
    metadata=None
)
