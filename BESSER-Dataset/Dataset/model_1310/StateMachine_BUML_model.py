...
stateMachine_Properties.attributes={stateMachine_Properties_scscfUser, stateMachine_Properties_mediaHost, stateMachine_Properties_recordPath, stateMachine_Properties_scscfPort, stateMachine_Properties_applicationServerProtocol, stateMachine_Properties_scscfHost, stateMachine_Properties_mediaToAddr, stateMachine_Properties_setupConference, stateMachine_Properties_mediaProtocol, stateMachine_Properties_mediaURI, stateMachine_Properties_scscfProtocol, stateMachine_Properties_mediaFromAddr, stateMachine_Properties_applicationServerPort, stateMachine_Properties_mediaPort, stateMachine_Properties_applicationAddress, stateMachine_Properties_applicationServerHost}
...
stateMachine_SMS.attributes={stateMachine_SMS_text, stateMachine_SMS_to, stateMachine_SMS_from_}
...
stateMachine_Call.attributes={stateMachine_Call_to, stateMachine_Call_from_}
...
domain_model = DomainModel(
    name="stateMachine",
    types={stateMachine_StateMachine, stateMachine_State, stateMachine_Properties, stateMachine_Transition, stateMachine_InitialState, State, stateMachine_FinalState, stateMachine_CompositeState, stateMachine_Action, stateMachine_IvrAction, Action, stateMachine_Play, IvrAction, stateMachine_Terminate, stateMachine_SendSms, stateMachine_SMS, stateMachine_SetTimer, stateMachine_IVREvent, Transition, stateMachine_Bye, IVREvent, stateMachine_Call, stateMachine_PickUp, stateMachine_Played, stateMachine_Terminated, stateMachine_Init, stateMachine_Cancel, stateMachine_CollectTimeout, stateMachine_Managed, stateMachine_NoneEvent, stateMachine_SMSReceived, stateMachine_Timer, stateMachine_Collected, stateMachine_Branch, stateMachine_Key, Branch, stateMachine_Otherwise, stateMachine_Recorderd},
    associations={states0, properties1, outs3, children5, parent7, sm9, sms11, action12, src13, defaultTar15, sms18, branches20, out21, action24},
    generalizations={gen_stateMachine_InitialState_State, gen_stateMachine_FinalState_State, gen_stateMachine_CompositeState_State, gen_stateMachine_IvrAction_Action, gen_stateMachine_Play_IvrAction, gen_stateMachine_Terminate_IvrAction, gen_stateMachine_SendSms_Action, gen_stateMachine_SetTimer_Action, gen_stateMachine_IVREvent_Transition, gen_stateMachine_Bye_IVREvent, gen_stateMachine_Call_IVREvent, gen_stateMachine_PickUp_IVREvent, gen_stateMachine_Terminated_IVREvent, gen_stateMachine_Init_IVREvent, gen_stateMachine_Cancel_IVREvent, gen_stateMachine_CollectTimeout_IVREvent, gen_stateMachine_Managed_IVREvent, gen_stateMachine_NoneEvent_Transition, gen_stateMachine_SMSReceived_Transition, gen_stateMachine_Timer_Transition, gen_stateMachine_Collected_IVREvent, gen_stateMachine_Key_Branch, gen_stateMachine_Otherwise_Branch, gen_stateMachine_Played_IVREvent, gen_stateMachine_Recorderd_IVREvent},
    metadata=None
)
