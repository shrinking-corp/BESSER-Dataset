...
class stateMachine_Properties:
    ...
    def __init__(self, applicationAddress: str, mediaFromAddr: str, mediaToAddr: str, mediaURI: str, recordPath: str, scscfUser: str, scscfHost: str, scscfPort: int, scscfProtocol: str, applicationServerPort: int, mediaHost: str, mediaPort: int, mediaProtocol: str, setupConference: bool, applicationServerProtocol: str, applicationServerHost: str, stateMachine_Properties: "stateMachine_StateMachine" = None):
