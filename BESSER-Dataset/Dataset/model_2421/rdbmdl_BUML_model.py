...
# Classes
rdbmdl_NamedColumnSet = Class(name="rdbmdl_NamedColumnSet", is_abstract=True)
SchemaElement = Class(name="SchemaElement")
rdbmdl_NamedElement = Class(name="rdbmdl_NamedElement", is_abstract=True)
Element = Class(name="Element")
rdbmdl_Model = Class(name="rdbmdl_Model")
NamedElement = Class(name="NamedElement")
rdbmdl_Schema = Class(name="rdbmdl_Schema")
rdbmdl_Element = Class(name="rdbmdl_Element")
Column = Class(name="Column")
Domain = Class(name="Domain")
PrimitiveDataType = Class(name="PrimitiveDataType")
rdbmdl_constraints_Constraint = Class(name="rdbmdl_constraints_Constraint", is_abstract=True)
rdbmdl_SchemaElement = Class(name="rdbmdl_SchemaElement", is_abstract=True)
rdbmdl_Table = Class(name="rdbmdl_Table")
NamedColumnSet = Class(name="NamedColumnSet")
rdbmdl_TableColumn = Class(name="rdbmdl_TableColumn")
...
rdbmdl_Column = Class(name="rdbmdl_Column", is_abstract=True)
rdbmdl_datatypes_PrimitiveDataType = Class(name="rdbmdl_datatypes_PrimitiveDataType")
DataType = Class(name="DataType")
rdbmdl_constraints_CheckConstraint = Class(name="rdbmdl_constraints_CheckConstraint")
Constraint = Class(name="Constraint")
rdbmdl_constraints_ColumnRefConstraint = Class(name="rdbmdl_constraints_ColumnRefConstraint", is_abstract=True)
constraints_rdbmdl_TableColumn = Class(name="constraints_rdbmdl_TableColumn")
rdbmdl_constraints_UniqueConstraint = Class(name="rdbmdl_constraints_UniqueConstraint")
ColumnRefConstraint = Class(name="ColumnRefConstraint")
rdbmdl_constraints_PrimaryKey = Class(name="rdbmdl_constraints_PrimaryKey")
rdbmdl_constraints_ForeignKey = Class(name="rdbmdl_constraints_ForeignKey")
rdbmdl_constraints_Index = Class(name="rdbmdl_constraints_Index")
IndexedColumn = Class(name="IndexedColumn")
rdbmdl_constraints_IndexedColumn = Class(name="rdbmdl_constraints_IndexedColumn")
rdbmdl_datatypes_Domain = Class(name="rdbmdl_datatypes_Domain")
datatypes_PrimitiveDataType = Class(name="datatypes_PrimitiveDataType")
rdbmdl_datatypes_DataType = Class(name="rdbmdl_datatypes_DataType", is_abstract=True)
ViewAlias = Class(name="ViewAlias")
rdbmdl_view_ViewAlias = Class(name="rdbmdl_view_ViewAlias")
view_rdbmdl_NamedColumnSet = Class(name="view_rdbmdl_NamedColumnSet")
rdbmdl_view_ViewColumn = Class(name="rdbmdl_view_ViewColumn", is_abstract=True)
rdbmdl_view_View = Class(name="rdbmdl_view_View")
ViewColumn = Class(name="ViewColumn")
rdbmdl_view_ViewExpressionColumn = Class(name="rdbmdl_view_ViewExpressionColumn")
rdbmdl_view_ReferencedViewColumn = Class(name="rdbmdl_view_ReferencedViewColumn")
view_rdbmdl_Column = Class(name="view_rdbmdl_Column")
...
rdbmdl_NamedElement.attributes={rdbmdl_NamedElement_uid, rdbmdl_NamedElement_name}
...
rdbmdl_TableColumn.attributes={rdbmdl_TableColumn_isForeignKey, rdbmdl_TableColumn_isPrimaryKey}
...
rdbmdl_datatypes_DataType.attributes={rdbmdl_datatypes_DataType_check, rdbmdl_datatypes_DataType_size, rdbmdl_datatypes_DataType_default, rdbmdl_datatypes_DataType_nullable, rdbmdl_datatypes_DataType_var, rdbmdl_datatypes_DataType_decimalDigits}
...
domain_model = DomainModel(
    name="rdbmdl",
    types={rdbmdl_NamedColumnSet, SchemaElement, rdbmdl_NamedElement, Element, rdbmdl_Model, NamedElement, rdbmdl_Schema, rdbmdl_Element, Column, Domain, PrimitiveDataType, rdbmdl_constraints_Constraint, rdbmdl_SchemaElement, rdbmdl_Table, NamedColumnSet, rdbmdl_TableColumn, PrimaryKey, UniqueConstraint, ForeignKey, Index, CheckConstraint, rdbmdl_Column, rdbmdl_datatypes_PrimitiveDataType, DataType, rdbmdl_constraints_CheckConstraint, Constraint, rdbmdl_constraints_ColumnRefConstraint, constraints_rdbmdl_TableColumn, rdbmdl_constraints_UniqueConstraint, ColumnRefConstraint, rdbmdl_constraints_PrimaryKey, rdbmdl_constraints_ForeignKey, rdbmdl_constraints_Index, IndexedColumn, rdbmdl_constraints_IndexedColumn, rdbmdl_datatypes_Domain, datatypes_PrimitiveDataType, rdbmdl_datatypes_DataType, ViewAlias, rdbmdl_view_ViewAlias, view_rdbmdl_NamedColumnSet, rdbmdl_view_ViewColumn, rdbmdl_view_View, ViewColumn, rdbmdl_view_ViewExpressionColumn, rdbmdl_view_ReferencedViewColumn, view_rdbmdl_Column, PrimitiveTypeCodes},
    associations={schemas2, parent1, domain16, type18, elements3, columns5, primaryKey6, uniqueConstraints8, foreignKeys10, indices12, checks14, includedColumns20, referredUC21, indexedColumns23, refColumn24, parentDomain26, columns28, referencedTablesAndViews29, referencedTableOrView31, refColumn32},
    generalizations={gen_rdbmdl_NamedColumnSet_SchemaElement, gen_rdbmdl_NamedElement_Element, gen_rdbmdl_Model_NamedElement, gen_rdbmdl_TableColumn_Column, gen_rdbmdl_constraints_Constraint_NamedElement, gen_rdbmdl_Schema_NamedElement, gen_rdbmdl_SchemaElement_NamedElement, gen_rdbmdl_Table_NamedColumnSet, gen_rdbmdl_Column_NamedElement, gen_rdbmdl_datatypes_PrimitiveDataType_DataType, gen_rdbmdl_constraints_CheckConstraint_Constraint, gen_rdbmdl_constraints_ColumnRefConstraint_Constraint, gen_rdbmdl_constraints_UniqueConstraint_ColumnRefConstraint, gen_rdbmdl_constraints_PrimaryKey_UniqueConstraint, gen_rdbmdl_constraints_ForeignKey_ColumnRefConstraint, gen_rdbmdl_constraints_Index_Constraint, gen_rdbmdl_constraints_IndexedColumn_NamedElement, gen_rdbmdl_datatypes_Domain_SchemaElement, gen_rdbmdl_datatypes_Domain_datatypes_PrimitiveDataType, gen_rdbmdl_datatypes_DataType_NamedElement, gen_rdbmdl_view_ViewAlias_NamedElement, gen_rdbmdl_view_ViewColumn_Column, gen_rdbmdl_view_View_NamedColumnSet, gen_rdbmdl_view_ViewExpressionColumn_ViewColumn, gen_rdbmdl_view_ReferencedViewColumn_ViewColumn},
    metadata=None
)
