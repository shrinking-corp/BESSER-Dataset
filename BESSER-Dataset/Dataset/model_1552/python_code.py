...
class reviews_RequirementEntry:
    ...
    def __init__(self, status: str, reviews_RequirementEntry79: "reviews_ReviewRequirementsMap" = None, reviews_RequirementEntry: "reviews_User" = None):
        self.status = status
...
class reviews_ApprovalValueMap:
    ...
    def __init__(self, value: str, reviews_ApprovalValueMap: "reviews_ReviewerEntry" = None, reviews_ApprovalValueMap70: "reviews_ApprovalType" = None):
        self.value = value
...
class reviews_LineLocation(Location):
    ...
    def __init__(self, rangeMax: int, rangeMin: int, reviews_LineLocation: set["reviews_LineRange"] = None):
...
class reviews_FileVersion(ReviewItem):
    ...
    def __init__(self, path: str, description: str, content: str, fileRevision: str, binaryContent: str, reviews_FileVersion: "reviews_FileItem" = None, reviews_FileVersion51: "reviews_FileItem" = None, reviews_FileVersion60: "reviews_FileItem" = None):
        self.path = path
...
class reviews_ApprovalType:
    ...
    def __init__(self, key: str, name: str, reviews_ApprovalType76: "reviews_ReviewRequirementsMap" = None, reviews_ApprovalType71: "reviews_ApprovalValueMap" = None, reviews_ApprovalType: "reviews_Repository" = None):
        self.key = key
        self.name = name
...
class reviews_User:
    ...
    def __init__(self, id: str, email: str, displayName: str, reviews_User33: "reviews_ReviewItem" = None, reviews_User36: "reviews_ReviewItem" = None, reviews_User64: "reviews_UserApprovalsMap" = None, reviews_User73: "reviews_RequirementEntry" = None, reviews_User22: "reviews_Comment" = None, reviews_User: "reviews_Change" = None, reviews_User43: "reviews_Repository" = None, reviews_User47: "reviews_Repository" = None):
        self.id = id
        self.email = email
...
class reviews_ReviewItemSet(ReviewItem, Dated):
    ...
    def __init__(self, revision: str, inNeedOfRetrieval: bool, ReviewItemSet53: "reviews_FileItem" = None, set: set["reviews_FileItem"] = None, sets: "reviews_Review" = None, reviews_ReviewItemSet: set["reviews_Commit"] = None, ReviewItemSet: "reviews_Review" = None):
...
class reviews_Change(Dated):
    ...
    def __init__(self, id: str, key: str, subject: str, message: str, state: str, reviews_Change15: "reviews_Review" = None, reviews_Change: "reviews_User" = None, reviews_Change12: "reviews_Review" = None):
        self.id = id
        self.key = key
        self.subject = subject
...
class reviews_CommentContainer(ABC):
    ...
    def createComment(self, reviews_commentText, reviews_initalLocation) :
