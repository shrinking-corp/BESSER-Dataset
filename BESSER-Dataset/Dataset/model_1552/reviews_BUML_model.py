...
# Classes
reviews_CommentContainer = Class(name="reviews_CommentContainer", is_abstract=True)
reviews_Comment = Class(name="reviews_Comment")
reviews_Change = Class(name="reviews_Change")
Dated = Class(name="Dated")
reviews_UserApprovalsMap = Class(name="reviews_UserApprovalsMap")
reviews_ReviewRequirementsMap = Class(name="reviews_ReviewRequirementsMap")
Indexed = Class(name="Indexed")
reviews_Location = Class(name="reviews_Location", is_abstract=True)
reviews_User = Class(name="reviews_User")
reviews_Review = Class(name="reviews_Review")
CommentContainer = Class(name="CommentContainer")
Change = Class(name="Change")
reviews_ReviewItemSet = Class(name="reviews_ReviewItemSet")
reviews_Repository = Class(name="reviews_Repository")
reviews_ApprovalType = Class(name="reviews_ApprovalType")
reviews_FileItem = Class(name="reviews_FileItem")
ReviewItem = Class(name="ReviewItem")
reviews_FileVersion = Class(name="reviews_FileVersion")
reviews_ReviewItem = Class(name="reviews_ReviewItem", is_abstract=True)
reviews_Indexed = Class(name="reviews_Indexed", is_abstract=True)
reviews_Dated = Class(name="reviews_Dated", is_abstract=True)
reviews_ReviewerEntry = Class(name="reviews_ReviewerEntry")
reviews_Commit = Class(name="reviews_Commit")
reviews_LineLocation = Class(name="reviews_LineLocation")
Location = Class(name="Location")
reviews_LineRange = Class(name="reviews_LineRange")
reviews_ApprovalValueMap = Class(name="reviews_ApprovalValueMap")
reviews_RequirementEntry = Class(name="reviews_RequirementEntry")

# reviews_CommentContainer class attributes and methods
reviews_CommentContainer_m_createComment: Method = Method(name="createComment", parameters={Parameter(name='reviews_commentText', type=StringType), Parameter(name='reviews_initalLocation', type=StringType)}, type=StringType)
...
reviews_Comment.attributes={reviews_Comment_mine, reviews_Comment_description, reviews_Comment_id, reviews_Comment_title, reviews_Comment_draft}
...
reviews_Change.attributes={reviews_Change_message, reviews_Change_state, reviews_Change_key, reviews_Change_id, reviews_Change_subject}
...
reviews_User.attributes={reviews_User_displayName, reviews_User_id, reviews_User_email}
...
reviews_Repository.attributes={reviews_Repository_taskConnectorKind, reviews_Repository_taskRepository, reviews_Repository_description, reviews_Repository_taskRepositoryUrl}
...
reviews_FileVersion.attributes={reviews_FileVersion_path, reviews_FileVersion_content, reviews_FileVersion_binaryContent, reviews_FileVersion_fileRevision, reviews_FileVersion_description}
...
reviews_Commit.attributes={reviews_Commit_subject, reviews_Commit_id}
...
domain_model = DomainModel(
    name="reviews",
    types={reviews_CommentContainer, reviews_Comment, reviews_Change, Dated, reviews_UserApprovalsMap, reviews_ReviewRequirementsMap, Indexed, reviews_Location, reviews_User, reviews_Review, CommentContainer, Change, reviews_ReviewItemSet, reviews_Repository, reviews_ApprovalType, reviews_FileItem, ReviewItem, reviews_FileVersion, reviews_ReviewItem, reviews_Indexed, reviews_Dated, reviews_ReviewerEntry, reviews_Commit, reviews_LineLocation, Location, reviews_LineRange, reviews_ApprovalValueMap, reviews_RequirementEntry, ReviewStatus, RequirementStatus},
    associations={allComments0, comments1, allDrafts2, drafts5, children13, reviewerApprovals16, requirements18, author20, replies24, locations26, review28, item31, owner8, sets9, repository10, parents11, approvalTypes40, account41, reviews44, users45, base48, target49, set52, items54, addedBy32, committedBy34, review37, file59, key62, value65, parentReview55, parentCommits57, ranges58, key74, value77, approvals67, key69, by72},
    generalizations={gen_reviews_Change_Dated, gen_reviews_Comment_Indexed, gen_reviews_Comment_Dated, gen_reviews_Review_CommentContainer, gen_reviews_Review_Change, gen_reviews_FileItem_ReviewItem, gen_reviews_ReviewItemSet_ReviewItem, gen_reviews_ReviewItemSet_Dated, gen_reviews_ReviewItem_CommentContainer, gen_reviews_Location_Indexed, gen_reviews_FileVersion_ReviewItem, gen_reviews_LineLocation_Location},
    metadata=None
)
