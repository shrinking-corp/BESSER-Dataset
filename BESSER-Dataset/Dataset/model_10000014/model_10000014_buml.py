...
Employee.attributes={Employee_Emp_Salary, Employee_Emp_Name, Employee_Emp_Department, Employee_Emp_ContactNo, Employee_Emp_Position, Employee_Emp_Email, Employee_Emp_Address, Employee_Emp_NIC, Employee_Emp_Id, Employee_Emp_DOB, Employee_Emp_Date_Of_Joint}
...
Salary.attributes={Salary_Sly_Basic, Salary_Sly_Netgross, Salary_Sly_Decrement, Salary_OverTime, Salary_Sly_Increment, Salary_Emp_Id}
...
Leave.attributes={Leave_Emp_Id, Leave_Leave_Title, Leave_Leave_detail, Leave_leave_id, Leave_Leave_Status, Leave_Leave_EndDate, Leave_Leave_NoOfDays, Leave_Leave_StartDate, Leave_Leave_ApplyDate}
...
domain_model = DomainModel(
    name="_028d758f_d6e9_4580_b0c5_83f928ac0a53",
