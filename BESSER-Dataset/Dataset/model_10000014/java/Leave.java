...
public class Leave  {
    ...
    public Leave(
        String Leave_detail,        LocalDate Leave_ApplyDate,        int Leave_NoOfDays,        LocalDate Leave_StartDate,        LocalDate Leave_EndDate,        int Emp_Id,        int leave_id,        String Leave_Status,        String Leave_Title    ) {
