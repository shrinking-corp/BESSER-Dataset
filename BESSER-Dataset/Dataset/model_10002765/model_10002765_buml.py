...
User.attributes={User_DepartmentID, User_Email, User_Hiredate, User_Password, User_Settings, User_Roles___, User_Linkedin_link, User_UserID, User_Lastname, User_Google_plus_link, User_Firstname, User_Dateofbirth, User_Username, User_Facebook_link, User_Phone, User_Active, User_TitleID, User_About, User_Position}
...
Project.attributes={Project_Team___, Project_Attachments___, Project_Assignee, Project_Description, Project_StatusID, Project_Comments___, Project_Deadline, Project_ProjectManager, Project_Author, Project_Title, Project_PorjectID, Project_Subscriptions___, Project_Created, Project_Activities___, Project_PriorityID}
...
Activity.attributes={Activity_User, Activity_NewValue, Activity_Project, Activity_ActivitySubType, Activity_ActivityType, Activity_ActivityID, Activity_Seen, Activity_PrevValue}
...
Comment.attributes={Comment_User, Comment_Created, Comment_Project, Comment_Content, Comment_CommentID}
...
Attachment.attributes={Attachment_Path, Attachment_Name, Attachment_Project, Attachment_Size, Attachment_User, Attachment_Created, Attachment_Extension, Attachment_AttachmentID}
...
Role.attributes={Role_RoleID, Role_Name, Role_Description}
...
domain_model = DomainModel(
    name="d7571304_3723_43b1_a7a0_ed1a794685d1",
    types={User, Project, Activity, Comment, Attachment, Role, String},
    associations={User_Comment, User_Project, User_Project2, User_Project3, User_Activity, Project_Activity, Project_Comment, User_Attachment, Project_Attachment, User_Role, Project_User},
    generalizations={},
    metadata=None
)
