...
errors_Error = Class(name="errors_Error", is_abstract=True)
...
domain_model = DomainModel(
    name="errors",
    types={errors_Errores, errors_Error, errors_ForeignError, Error, errors_Table, errors_Column, errors_Fk},
    associations={errores0, tableCont1, tableRef2, fkColumns5, fk7},
