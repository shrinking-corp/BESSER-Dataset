...
class reviews_User:
    ...
    def __init__(self, id: str, email: str, displayName: str, reviews_User22: "reviews_Comment" = None, reviews_User33: "reviews_ReviewItem" = None, reviews_User: "reviews_Change" = None, reviews_User43: "reviews_Repository" = None, reviews_User47: "reviews_Repository" = None, reviews_User36: "reviews_ReviewItem" = None, reviews_User63: "reviews_UserApprovalsMap" = None, reviews_User72: "reviews_RequirementEntry" = None):
        self.id = id
        self.email = email
...
class reviews_ReviewItem(CommentContainer):
    ...
    def __init__(self, name: str, id: str, reference: str, reviews_ReviewItem: "reviews_User" = None, reviews_ReviewItem38: "reviews_Review" = None, reviews_ReviewItem35: "reviews_User" = None):
        self.name = name
        self.id = id
...
class reviews_Change(Dated):
    ...
    def __init__(self, id: str, key: str, subject: str, state: str, message: str, reviews_Change12: "reviews_Review" = None, reviews_Change15: "reviews_Review" = None, reviews_Change: "reviews_User" = None):
        self.id = id
        self.key = key
