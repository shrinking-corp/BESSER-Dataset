...
class tfsm_Transition(NamedElement):
    ...
    def __init__(self, action: str, tfsm_Transition: "tfsm_TFSM" = None, Transition: "tfsm_State" = None, Transition14: "tfsm_State" = None, tfsm_Transition30: "tfsm_FSMEvent" = None, outgoingTransitions: "tfsm_State" = None, incomingTransitions: "tfsm_State" = None, tfsm_Transition20: "tfsm_Guard" = None, tfsm_Transition22: set["tfsm_FSMEvent"] = None):
        self.action = action
...
class tfsm_FSMEvent(NamedElement):
    ...
    def __init__(self, tfsm_FSMEvent: "tfsm_TFSM" = None, tfsm_FSMEvent27: "tfsm_EventGuard" = None, tfsm_FSMEvent29: set["tfsm_Transition"] = None, tfsm_FSMEvent38: "tfsm_TimedSystem" = None, tfsm_FSMEvent23: "tfsm_Transition" = None):
