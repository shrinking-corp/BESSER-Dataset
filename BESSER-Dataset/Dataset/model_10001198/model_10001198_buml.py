...
association2: BinaryAssociation = BinaryAssociation(
    name="association2",
    ends={
        Property(name="end10", type=MyClass, multiplicity=Multiplicity(0, 9999)),
        Property(name="end21", type=MyClass2, multiplicity=Multiplicity(0, 9999))
    }
)
...
domain_model = DomainModel(
    name="_915752ec_a8f2_4359_af10_49213a85e98d",
