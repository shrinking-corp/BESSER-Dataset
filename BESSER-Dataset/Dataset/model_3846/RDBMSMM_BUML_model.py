...
# Classes
RDBMSMM_FKey = Class(name="RDBMSMM_FKey")
RDBMSMM_Table = Class(name="RDBMSMM_Table")
RDBMSMM_Column = Class(name="RDBMSMM_Column")
RDBMSMM_RDBMSModel = Class(name="RDBMSMM_RDBMSModel")
...
domain_model = DomainModel(
    name="RDBMSMM",
    types={RDBMSMM_FKey, RDBMSMM_Table, RDBMSMM_Column, RDBMSMM_RDBMSModel},
    associations={pkey1, fkeys4, references6, cols9, cols0, table12},
    generalizations={},
    metadata=None
)
