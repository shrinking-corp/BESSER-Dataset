...
class RDBMSMM_Column:
    ...
    def __init__(self, name: str, type: str, RDBMSMM_Column3: "RDBMSMM_Table" = None, RDBMSMM_Column11: "RDBMSMM_FKey" = None, RDBMSMM_Column: "RDBMSMM_Table" = None):
        self.name = name
        self.type = type
...
class RDBMSMM_Table:
    ...
    def __init__(self, name: str, RDBMSMM_Table2: set["RDBMSMM_Column"] = None, RDBMSMM_Table5: set["RDBMSMM_FKey"] = None, RDBMSMM_Table8: "RDBMSMM_FKey" = None, RDBMSMM_Table: set["RDBMSMM_Column"] = None, RDBMSMM_Table13: "RDBMSMM_RDBMSModel" = None):
        self.name = name
