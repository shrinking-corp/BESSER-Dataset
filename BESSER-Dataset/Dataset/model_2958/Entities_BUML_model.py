...
domain_model = DomainModel(
    name="entities",
    types={entities_Model, entities_Entity, entities_Attribute, entities_AttributeType, entities_EntityType, ElementType, entities_BasicType, entities_ElementType},
    associations={entities0, superType2, attributes4, entity10, type6, elementType8},
