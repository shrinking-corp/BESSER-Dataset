...
class database_Column:
    ...
    def __init__(self, Name: str, Type: str, IsPrimaryKey: bool, database_Column: "database_ForeignKey" = None, database_Column14: "database_ForeignKey" = None, Column: "database_Table" = None, TableColumn: "database_Table" = None):
        self.Name = Name
        self.Type = Type
...
class database_Table:
    ...
    def __init__(self, Name: str, database_Table: "database_ForeignKey" = None, database_Table9: "database_ForeignKey" = None, Table: "database_Database" = None, DbTable: "database_Database" = None, ColumnTable: set["database_Column"] = None, Table5: "database_Column" = None):
        self.Name = Name
...
class database_ForeignKey:
    ...
    def __init__(self, Name: str, database_ForeignKey: "database_Table" = None, database_ForeignKey8: "database_Table" = None, database_ForeignKey11: set["database_Column"] = None, database_ForeignKey13: set["database_Column"] = None, DbFK: "database_Database" = None, ForeignKey: "database_Database" = None):
        self.Name = Name
