...
# Classes
CarRental_Person = Class(name="CarRental_Person")
CarRental_Rental = Class(name="CarRental_Rental")
CarRental_Employee = Class(name="CarRental_Employee")
CarRental_Branch = Class(name="CarRental_Branch")
CarRental_Car = Class(name="CarRental_Car")
CarRental_CarGroup = Class(name="CarRental_CarGroup")
CarRental_Customer = Class(name="CarRental_Customer")
Person = Class(name="Person")
CarRental_ServiceDepot = Class(name="CarRental_ServiceDepot")
CarRental_Check = Class(name="CarRental_Check")
...
CarRental_Person_m_updateAge: Method = Method(name="updateAge", parameters={Parameter(name='CarRental_newAge', type=StringType)})
CarRental_Person.attributes={CarRental_Person_isMarried, CarRental_Person_age, CarRental_Person_lastname, CarRental_Person_firstname}
CarRental_Person.methods={CarRental_Person_m_email, CarRental_Person_m_updateAge}
...
CarRental_Rental.attributes={CarRental_Rental_untilDate, CarRental_Rental_framDate}

# CarRental_Employee class attributes and methods
CarRental_Employee_salary: Property = Property(name="salary", type=FloatType)
CarRental_Employee_m_raiseSalary: Method = Method(name="raiseSalary", parameters={Parameter(name='CarRental_amount', type=StringType)}, type=FloatType)
...
domain_model = DomainModel(
    name="CarRental",
    types={CarRental_Person, CarRental_Rental, CarRental_Employee, CarRental_Branch, CarRental_Car, CarRental_CarGroup, CarRental_Customer, Person, CarRental_ServiceDepot, CarRental_Check, CarGroupKind},
    associations={rental0, managedBranch1, employer2, manager5, employee8, car11, carGroup12, rental14, car17, customer19, car28, rental31, higher35, lower38, branch40, carGroup42, rental45, branch21, carGroup23, branch26},
    generalizations={gen_CarRental_Employee_Person, gen_CarRental_Customer_Person},
    metadata=None
)
