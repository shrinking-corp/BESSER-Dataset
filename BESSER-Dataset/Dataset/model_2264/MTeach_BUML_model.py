...
# Classes
mteach_Professor = Class(name="mteach_Professor")
mteach_Course = Class(name="mteach_Course")
mteach_Topic = Class(name="mteach_Topic")
...
mteach_Professor.attributes={mteach_Professor_firstName, mteach_Professor_lastName}
...
mteach_Course.attributes={mteach_Course_name, mteach_Course_coefficient, mteach_Course_time}
...
domain_model = DomainModel(
    ...
    associations={course3, teachedCourses0, topics1, professor2},
    generalizations={},
    metadata=None
)
