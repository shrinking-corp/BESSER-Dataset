...
# Classes
dynamicFaultTree_Event = Class(name="dynamicFaultTree_Event")
dynamicFaultTree_DFT = Class(name="dynamicFaultTree_DFT")
dynamicFaultTree_TopLevelEvent = Class(name="dynamicFaultTree_TopLevelEvent")
dynamicFaultTree_Dependency = Class(name="dynamicFaultTree_Dependency", is_abstract=True)
dynamicFaultTree_Element = Class(name="dynamicFaultTree_Element", is_abstract=True)
Element = Class(name="Element")
dynamicFaultTree_Gate = Class(name="dynamicFaultTree_Gate", is_abstract=True)
dynamicFaultTree_Sequence = Class(name="dynamicFaultTree_Sequence")
Dependency = Class(name="Dependency")
dynamicFaultTree_FunctionalDependency = Class(name="dynamicFaultTree_FunctionalDependency")
dynamicFaultTree_AND = Class(name="dynamicFaultTree_AND")
Gate = Class(name="Gate")
dynamicFaultTree_PAND = Class(name="dynamicFaultTree_PAND")
dynamicFaultTree_OR = Class(name="dynamicFaultTree_OR")
dynamicFaultTree_POR = Class(name="dynamicFaultTree_POR")
dynamicFaultTree_XOR = Class(name="dynamicFaultTree_XOR")
dynamicFaultTree_Spare = Class(name="dynamicFaultTree_Spare")
...
dynamicFaultTree_Element.attributes={dynamicFaultTree_Element_elementID, dynamicFaultTree_Element_name, dynamicFaultTree_Element_probability, dynamicFaultTree_Element_sequencePosition}
...
domain_model = DomainModel(
    ...
    types={dynamicFaultTree_Event, dynamicFaultTree_DFT, dynamicFaultTree_TopLevelEvent, dynamicFaultTree_Dependency, dynamicFaultTree_Element, Element, dynamicFaultTree_Gate, dynamicFaultTree_Sequence, Dependency, dynamicFaultTree_FunctionalDependency, dynamicFaultTree_AND, Gate, dynamicFaultTree_PAND, dynamicFaultTree_OR, dynamicFaultTree_POR, dynamicFaultTree_XOR, dynamicFaultTree_Spare},
    associations={toplevelevent4, childGate6, parentGate9, childEvent11, parentGate13, dependency15, events16, topLevelEvent0, dependencies1, gate3, spares18},
    generalizations={gen_dynamicFaultTree_Gate_Element, gen_dynamicFaultTree_Event_Element, gen_dynamicFaultTree_Dependency_Element, gen_dynamicFaultTree_TopLevelEvent_Element, gen_dynamicFaultTree_Sequence_Dependency, gen_dynamicFaultTree_FunctionalDependency_Dependency, gen_dynamicFaultTree_AND_Gate, gen_dynamicFaultTree_PAND_Gate, gen_dynamicFaultTree_OR_Gate, gen_dynamicFaultTree_POR_Gate, gen_dynamicFaultTree_XOR_Gate, gen_dynamicFaultTree_Spare_Gate},
    metadata=None
)
