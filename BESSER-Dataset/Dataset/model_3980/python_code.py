...
class dtmc_Transition(NamedEntity):
    ...
    def __init__(self, probability: str, Transition: "dtmc_Node" = None, transitions: "dtmc_Module" = None, Transition19: "dtmc_Module" = None, Transition4: "dtmc_Node" = None, outTransitions: "dtmc_Node" = None, inTransitions: "dtmc_Node" = None):
...
class dtmc_Node(NamedEntity):
    ...
    def __init__(self, isStart: bool, isEnd: bool, isFail: bool, nodes: "dtmc_Module" = None, _from: set["dtmc_Transition"] = None, Node16: "dtmc_Module" = None, _to: set["dtmc_Transition"] = None, Node: "dtmc_Transition" = None, Node7: "dtmc_Transition" = None):
