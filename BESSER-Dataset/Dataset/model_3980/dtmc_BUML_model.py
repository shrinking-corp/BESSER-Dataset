...
dtmc_Module = Class(name="dtmc_Module")
dtmc_Node = Class(name="dtmc_Node")
dtmc_Transition = Class(name="dtmc_Transition", is_abstract=True)
dtmc_SynchronizedTransition = Class(name="dtmc_SynchronizedTransition")
Transition = Class(name="Transition")
dtmc_NamedEntity = Class(name="dtmc_NamedEntity", is_abstract=True)
dtmc_CallTransition = Class(name="dtmc_CallTransition")
dtmc_InvokedTransition = Class(name="dtmc_InvokedTransition")
dtmc_StandardTransition = Class(name="dtmc_StandardTransition")
...
dtmc_NamedEntity.attributes={dtmc_NamedEntity_name, dtmc_NamedEntity_description}
...
domain_model = DomainModel(
    name="dtmc",
    types={dtmc_Dtmc, NamedEntity, dtmc_Module, dtmc_Node, dtmc_Transition, dtmc_SynchronizedTransition, Transition, dtmc_NamedEntity, dtmc_CallTransition, dtmc_InvokedTransition, dtmc_StandardTransition},
    associations={modules0, module1, outTransitions2, module8, syncWith11, synchedWith13, nodes15, transitions17, invokedTransition20, callTransition21, inTransitions3, _from5, _to6},
    generalizations={gen_dtmc_Dtmc_NamedEntity, gen_dtmc_Node_NamedEntity, gen_dtmc_SynchronizedTransition_Transition, gen_dtmc_Module_NamedEntity, gen_dtmc_CallTransition_Transition, gen_dtmc_InvokedTransition_Transition, gen_dtmc_StandardTransition_Transition, gen_dtmc_Transition_NamedEntity},
    metadata=None
)
