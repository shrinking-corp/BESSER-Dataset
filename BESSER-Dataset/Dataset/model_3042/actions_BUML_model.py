...
# Classes
actions_AtomicAction = Class(name="actions_AtomicAction")
Action = Class(name="Action")
AtomicProcess = Class(name="AtomicProcess")
actions_AtomicActionResult = Class(name="actions_AtomicActionResult")
actions_CompositeAction = Class(name="actions_CompositeAction")
CompositeProcess = Class(name="CompositeProcess")
actions_ActionResult = Class(name="actions_ActionResult")
actions_Condition = Class(name="actions_Condition")
actions_Expression = Class(name="actions_Expression")
ActionResult = Class(name="ActionResult")
actions_Distribution = Class(name="actions_Distribution")
actions_Action = Class(name="actions_Action", is_abstract=True)
Process = Class(name="Process")
actions_Role = Class(name="actions_Role")
actions_ActionsCollection = Class(name="actions_ActionsCollection")
actions_Participant = Class(name="actions_Participant")
actions_Parameter = Class(name="actions_Parameter")
...
actions_ActionResult.attributes={actions_ActionResult_version, actions_ActionResult_id}
...
actions_Distribution.attributes={actions_Distribution_version, actions_Distribution_datapoint, actions_Distribution_id, actions_Distribution_density}
...
domain_model = DomainModel(
    name="actions",
    types={actions_AtomicAction, Action, AtomicProcess, actions_AtomicActionResult, actions_CompositeAction, CompositeProcess, actions_ActionResult, actions_Condition, actions_Expression, ActionResult, actions_Distribution, actions_Action, Process, actions_Role, actions_ActionsCollection, actions_Participant, actions_Parameter},
    associations={performedByRole0, hasAtomicActionResult1, inCondition2, hasAddEffect3, hasDeleteEffect5, hasCostDistribution8, parameters20, hasDurationDistribution10, hasQualityDistribution13, actions16, participants18},
    generalizations={gen_actions_AtomicAction_Action, gen_actions_AtomicAction_AtomicProcess, gen_actions_CompositeAction_Action, gen_actions_CompositeAction_CompositeProcess, gen_actions_AtomicActionResult_ActionResult, gen_actions_Action_Process},
    metadata=None
)
