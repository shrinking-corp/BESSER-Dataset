...
class actions_ActionsCollection:
    ...
    def __init__(self, id: int, version: int, ns: str, actions_ActionsCollection21: set["actions_Parameter"] = None, actions_ActionsCollection: set["actions_Action"] = None, actions_ActionsCollection19: set["actions_Participant"] = None):
        self.id = id
...
class CompositeProcess:
    ...
    pass
class actions_CompositeAction(Action, CompositeProcess):
