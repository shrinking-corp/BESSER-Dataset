...
# Classes
filetree_FileTree = Class(name="filetree_FileTree")
Container = Class(name="Container")
filetree_PathToTreeElementMap = Class(name="filetree_PathToTreeElementMap")
filetree_FileTreeElement = Class(name="filetree_FileTreeElement", is_abstract=True)
filetree_Container = Class(name="filetree_Container")
filetree_AccessRight = Class(name="filetree_AccessRight")
filetree_Directory = Class(name="filetree_Directory")
filetree_H2HFile = Class(name="filetree_H2HFile")
FileTreeElement = Class(name="FileTreeElement")
filetree_User = Class(name="filetree_User")
...
filetree_FileTreeElement.attributes={filetree_FileTreeElement_file, filetree_FileTreeElement_name, filetree_FileTreeElement_path}
...
filetree_AccessRight.attributes={filetree_AccessRight_userId, filetree_AccessRight_writePermission, filetree_AccessRight_readPermission}
...
filetree_User.attributes={filetree_User_rootDir, filetree_User_userId, filetree_User_password, filetree_User_pin}
...
domain_model = DomainModel(
    name="filetree",
    types={filetree_FileTree, Container, filetree_PathToTreeElementMap, filetree_FileTreeElement, filetree_Container, filetree_AccessRight, filetree_Directory, filetree_H2HFile, FileTreeElement, filetree_User},
    associations={elements0, parent1, accessRights2, children3, fileTree4, value6},
