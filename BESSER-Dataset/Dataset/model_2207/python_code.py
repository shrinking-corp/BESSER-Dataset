...
class filetree_FileTreeElement(ABC):
    ...
    def __init__(self, path: str, name: str, file: str, children: "filetree_Container" = None, filetree_FileTreeElement: set["filetree_AccessRight"] = None, FileTreeElement: "filetree_Container" = None, filetree_FileTreeElement8: "filetree_PathToTreeElementMap" = None):
        self.path = path
        self.name = name
        self.file = file
