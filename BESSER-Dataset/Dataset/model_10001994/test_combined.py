...
def test_hyp_jobexecutionstatusproxy_actor_is_not_abstract():
    assert not inspect.isabstract(JobExecutionStatusProxy_Actor)


def test_hyp_jobexecutionstatusproxy_actor_constructor_exists():
    assert callable(JobExecutionStatusProxy_Actor.__init__)


def test_hyp_jobexecutionstatusproxy_actor_constructor_args():
    sig = inspect.signature(JobExecutionStatusProxy_Actor.__init__)
    params = list(sig.parameters.keys())
...
JobExecutionStatusProxy_Actor_strategy = st.builds(
    JobExecutionStatusProxy_Actor,
)
