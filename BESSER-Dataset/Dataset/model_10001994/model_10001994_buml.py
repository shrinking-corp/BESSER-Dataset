...
JobExecutionStatusProxy_Actor = Class(name="JobExecutionStatusProxy_Actor")
...
Risk_Person_Actor = Class(name="Risk_Person_Actor")
Client_Interface = Class(name="Client_Interface")
...
# JobExecutionStatusProxy_Actor class attributes and methods
...
# Risk_Person_Actor class attributes and methods

# Client_Interface class attributes and methods
...
domain_model = DomainModel(
    name="_iPGWcGH0EeqK2M3E1LfZ7Q",
    types={ShoppingCartExample_ShoppingCart, ShoppingCartExample_Order, ShoppingCartExample_LineItem, ShoppingCartExample_Account, JobExecutionStatusProxy_Actor, Class2, Class3, ShoppingCartExample_Customer, Class_, Location, Packet, Neighbor, Transportation, Sistema_Actor, Base_de_datos_Actor, Cliente_Actor, Sistema2, Operario_Actor, Risk_Person_Actor, Client_Interface, User},
