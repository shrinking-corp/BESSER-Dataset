...
class HSVTree_HSVNode:
    ...
    def __init__(self, hsv: str, name: str, HSVNode4: "HSVTree_HSVNode" = None, parent: set["HSVTree_HSVNode"] = None, HSVNode: "HSVTree_HSVNode" = None, children: "HSVTree_HSVNode" = None):
        self.hsv = hsv
        self.name = name
