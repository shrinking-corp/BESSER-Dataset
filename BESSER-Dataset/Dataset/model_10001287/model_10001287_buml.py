...
Customer.attributes={Customer_address, Customer_type, Customer_name}
...
ActiveRecord.attributes={ActiveRecord_connection, ActiveRecord_id}
...
Car.attributes={Car_stock, Car_name, Car_cost, Car_manufacturer}
...
Sale.attributes={Sale_date, Sale_car, Sale_billable, Sale_customer}
...
RepairPart.attributes={RepairPart_cost, RepairPart_name, RepairPart_stock}
...
domain_model = DomainModel(
    name="_9e4feb90_73a2_4058_a24d_3680cc26ff1d",
    types={Customer_Actor, Enquire_for_Cars_UseCase, Purchase_Car_UseCase, Send_for_Repair_UseCase, Dealer_Actor, Maintenance_Team_Actor, Repair_Part_Purchase_UseCase, Check_for_Parts_UseCase, Check_Car_Stock_UseCase, Compute_Billables_UseCase, Order_Cars_UseCase, Manufacturer_Actor, Customer, ActiveRecord, ConnectionInterface_Interface, Car, Sale, RepairPart, Repair, CustomerType},
