...
domain_model = DomainModel(
    name="simpleClass",
    types={NamedElement, simpleClass_Class, simpleClass_Association, simpleClass_Attribute, simpleClass_NamedElement, simpleClass_ClassModel, simpleClass_Package},
    associations={subPackages2, classes4, associations6, attributes8, packages0, super11, source13, target16},
