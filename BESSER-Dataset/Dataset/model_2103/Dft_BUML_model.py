...
# Classes
dft_GalileoDft = Class(name="dft_GalileoDft")
dft_GalileoFaultTreeNode = Class(name="dft_GalileoFaultTreeNode")
dft_GalileoNodeType = Class(name="dft_GalileoNodeType")
dft_Named = Class(name="dft_Named")
GalileoNodeType = Class(name="GalileoNodeType")
dft_Observer = Class(name="dft_Observer")
dft_Parametrized = Class(name="dft_Parametrized")
...
dft_GalileoFaultTreeNode_lambda_: Property = Property(name="lambda_", type=StringType)
...
dft_GalileoFaultTreeNode.attributes={dft_GalileoFaultTreeNode_repair, dft_GalileoFaultTreeNode_dorm, dft_GalileoFaultTreeNode_name, dft_GalileoFaultTreeNode_lambda_}
...
dft_Parametrized.attributes={dft_Parametrized_typeName, dft_Parametrized_parameter}
...
domain_model = DomainModel(
    name="dft",
    types={dft_GalileoDft, dft_GalileoFaultTreeNode, dft_GalileoNodeType, dft_Named, GalileoNodeType, dft_Observer, dft_Parametrized},
    associations={root0, gates1, basicEvents4, type7, children10, observables12},
