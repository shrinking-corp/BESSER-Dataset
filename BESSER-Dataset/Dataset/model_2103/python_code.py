...
class dft_GalileoFaultTreeNode:
    ...
    def __init__(self, name: str, lambda_: str, dorm: str, repair: str, dft_GalileoFaultTreeNode8: "dft_GalileoNodeType" = None, dft_GalileoFaultTreeNode11: "dft_GalileoFaultTreeNode" = None, dft_GalileoFaultTreeNode9: set["dft_GalileoFaultTreeNode"] = None, dft_GalileoFaultTreeNode13: "dft_Observer" = None, dft_GalileoFaultTreeNode: "dft_GalileoDft" = None, dft_GalileoFaultTreeNode3: "dft_GalileoDft" = None, dft_GalileoFaultTreeNode6: "dft_GalileoDft" = None):
        self.name = name
