...
# Classes
hairDressersRegSys_Appointment = Class(name="hairDressersRegSys_Appointment")
hairDressersRegSys_Invoice = Class(name="hairDressersRegSys_Invoice")
hairDressersRegSys_Service = Class(name="hairDressersRegSys_Service")
hairDressersRegSys_Haircuts = Class(name="hairDressersRegSys_Haircuts")
hairDressersRegSys_Other = Class(name="hairDressersRegSys_Other")
Person = Class(name="Person")
hairDressersRegSys_Products = Class(name="hairDressersRegSys_Products")
hairDressersRegSys_Discounts = Class(name="hairDressersRegSys_Discounts")
hairDressersRegSys_Payment = Class(name="hairDressersRegSys_Payment")
hairDressersRegSys_Customer = Class(name="hairDressersRegSys_Customer")
hairDressersRegSys_Styling = Class(name="hairDressersRegSys_Styling")
Service = Class(name="Service")
hairDressersRegSys_ServiceEmployee = Class(name="hairDressersRegSys_ServiceEmployee")
hairDressersRegSys_Person = Class(name="hairDressersRegSys_Person")
...
hairDressersRegSys_Appointment.attributes={hairDressersRegSys_Appointment_EndTime, hairDressersRegSys_Appointment_StartTime, hairDressersRegSys_Appointment_Date}
hairDressersRegSys_Appointment.methods={hairDressersRegSys_Appointment_m_ViewSchedule, hairDressersRegSys_Appointment_m_AddAppointment}
...
hairDressersRegSys_Invoice.methods={hairDressersRegSys_Invoice_m_GetDiscount, hairDressersRegSys_Invoice_m_CalculateTotal}
...
hairDressersRegSys_Service.attributes={hairDressersRegSys_Service_Description, hairDressersRegSys_Service_Time, hairDressersRegSys_Service_CostPerHour, hairDressersRegSys_Service_Name}
...
hairDressersRegSys_Haircuts.attributes={hairDressersRegSys_Haircuts_IsWash, hairDressersRegSys_Haircuts_IsShave, hairDressersRegSys_Haircuts_IsCut}
...
hairDressersRegSys_Products.attributes={hairDressersRegSys_Products_Price, hairDressersRegSys_Products_Name, hairDressersRegSys_Products_Description}
...
hairDressersRegSys_Discounts.attributes={hairDressersRegSys_Discounts_Description, hairDressersRegSys_Discounts_Percentage, hairDressersRegSys_Discounts_Name}
...
hairDressersRegSys_Payment.attributes={hairDressersRegSys_Payment_AmountPaid, hairDressersRegSys_Payment_Date, hairDressersRegSys_Payment_PaymentMethod}
...
hairDressersRegSys_Customer.methods={hairDressersRegSys_Customer_m_AddNewCustomer, hairDressersRegSys_Customer_m_PlaceAppointment}
...
hairDressersRegSys_ServiceEmployee.methods={hairDressersRegSys_ServiceEmployee_m_AddNewEmployee, hairDressersRegSys_ServiceEmployee_m_ViewAppointments, hairDressersRegSys_ServiceEmployee_m_RemoveAppointment, hairDressersRegSys_ServiceEmployee_m_MakeAppointment, hairDressersRegSys_ServiceEmployee_m_ViewAllAvailableEmployees}
...
hairDressersRegSys_Person.attributes={hairDressersRegSys_Person_DateOfBirth, hairDressersRegSys_Person_LastName, hairDressersRegSys_Person_Address, hairDressersRegSys_Person_FirstName}
...
domain_model = DomainModel(
    ...
    types={hairDressersRegSys_Appointment, hairDressersRegSys_Invoice, hairDressersRegSys_Service, hairDressersRegSys_Haircuts, hairDressersRegSys_Other, Person, hairDressersRegSys_Products, hairDressersRegSys_Discounts, hairDressersRegSys_Payment, hairDressersRegSys_Customer, hairDressersRegSys_Styling, Service, hairDressersRegSys_ServiceEmployee, hairDressersRegSys_Person},
    associations={appointment0, invoice1, invoice3, products4, discounts5, payment7, customer9, invoice10, appointment13, discounts15, appointment17, invoice19},
    generalizations={gen_hairDressersRegSys_Haircuts_Service, gen_hairDressersRegSys_Other_Service, gen_hairDressersRegSys_Customer_Person, gen_hairDressersRegSys_Styling_Service, gen_hairDressersRegSys_ServiceEmployee_Person},
    metadata=None
)
