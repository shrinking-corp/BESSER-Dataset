...
class BasicCompartment:
    ...
    pass
class notation_ListCompartment(BasicCompartment, SortingStyle, TitleStyle, FilteringStyle):
...
class RoundedCornersStyle:
    ...
    pass
class notation_ShapeStyle(DescriptionStyle, LineStyle, FontStyle, FillStyle, RoundedCornersStyle):
...
class notation_Diagram(View):
    ...
    def __init__(self, name: str, measurementUnit: str, notation_Diagram: "notation_View" = None, notation_Diagram57: "notation_DiagramLinkStyle" = None, notation_Diagram59: "notation_MultiDiagramLinkStyle" = None, notation_Diagram27: set["notation_Edge"] = None, notation_Diagram30: set["notation_Edge"] = None):
        self.name = name
