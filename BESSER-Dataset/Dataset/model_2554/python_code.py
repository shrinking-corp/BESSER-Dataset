...
class testmodel_Node:
    ...
    def __init__(self, nodename: str, testmodel_Node4: set["testmodel_Val"] = None, Node: "testmodel_Node" = None, childNodes: "testmodel_Node" = None, Node10: "testmodel_Node" = None, parentNode: set["testmodel_Node"] = None, testmodel_Node: "testmodel_cont" = None):
