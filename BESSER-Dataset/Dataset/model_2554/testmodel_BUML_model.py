...
# Classes
testmodel_cont = Class(name="testmodel_cont")
testmodel_Node = Class(name="testmodel_Node")
testmodel_Val = Class(name="testmodel_Val")
...
domain_model = DomainModel(
    ...
    associations={containsNode0, containsVal1, hasVals3, parentNode7, childNodes9},
    generalizations={},
    metadata=None
)
