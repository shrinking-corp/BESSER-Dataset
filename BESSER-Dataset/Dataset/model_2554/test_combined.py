...
def test_hyp_testmodel_val_is_not_abstract():
    assert not inspect.isabstract(testmodel_Val)


def test_hyp_testmodel_val_constructor_exists():
    assert callable(testmodel_Val.__init__)


def test_hyp_testmodel_val_constructor_args():
...
def test_hyp_testmodel_cont_is_not_abstract():
    assert not inspect.isabstract(testmodel_cont)


def test_hyp_testmodel_cont_constructor_exists():
    assert callable(testmodel_cont.__init__)


def test_hyp_testmodel_cont_constructor_args():
...
def test_hyp_testmodel_val_valname_setter(instance):
...
@given(instance=testmodel_Val_strategy)
def test_hyp_testmodel_val_intlist_setter(instance):
...
@given(instance=testmodel_Val_strategy)
def test_hyp_testmodel_val_intvl_setter(instance):
...
def test_hyp_testmodel_node_nodename_setter(instance):
