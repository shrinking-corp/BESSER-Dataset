...
class ir_ocl_UnsupportedExp(OclExpression):
    ...
    def __init__(self, reason: str, description: str, OclExpression: "ir_ocl_OclInvariant" = None, OclExpression60: "ir_ocl_CallExp" = None, OclExpression78: "ir_ocl_IfExp" = None, OclExpression62: "ir_ocl_AbstractOperationCallExp" = None, OclExpression68: "ir_ocl_LoopExp" = None, OclExpression98: "ir_ocl_TuplePart" = None, OclExpression55: "ir_ocl_OclDerivedProperty" = None, OclExpression89: "ir_ocl_LetExp" = None, OclExpression81: "ir_ocl_IfExp" = None, OclExpression57: "ir_ocl_OclOperation" = None, OclExpression86: "ir_ocl_LetExp" = None, OclExpression103: "ir_ocl_CollectionLiteralExp" = None, OclExpression75: "ir_ocl_IfExp" = None, OclExpression91: "ir_ocl_OperatorCallExp" = None, OclExpression73: "ir_ocl_IterateExp" = None):
        self.reason = reason
...
class ocl_WithContextVariable:
    ...
    pass
class ir_ocl_OclOperation(ocl_WithContextVariable, Operation):

    pass
class ir_ocl_OclDerivedProperty(ocl_WithContextVariable, DerivedProperty):
...
class ir_EFTupleType(EFType):
    ...
    def __init__(self, id: str, ir_EFTupleType: "ir_Specification" = None, ir_EFTupleType20: "ir_TupleFieldRef" = None, ir_EFTupleType42: set["ir_TupleTypeElement"] = None):
        self.id = id
