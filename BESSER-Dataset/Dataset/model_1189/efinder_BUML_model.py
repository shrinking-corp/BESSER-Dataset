...
# Classes
ir_Operation = Class(name="ir_Operation", is_abstract=True)
ir_EFPrimitiveType = Class(name="ir_EFPrimitiveType")
ir_EFTupleType = Class(name="ir_EFTupleType")
ir_TypedElement = Class(name="ir_TypedElement", is_abstract=True)
ir_TypeRef = Class(name="ir_TypeRef", is_abstract=True)
ir_AbstractFunction = Class(name="ir_AbstractFunction", is_abstract=True)
TypedElement = Class(name="TypedElement")
ir_EFType = Class(name="ir_EFType", is_abstract=True)
ir_Specification = Class(name="ir_Specification")
AbstractFunction = Class(name="AbstractFunction")
ir_EFMetamodel = Class(name="ir_EFMetamodel")
ir_Parameter = Class(name="ir_Parameter")
ir_Constraint = Class(name="ir_Constraint", is_abstract=True)
ir_FeatureRef = Class(name="ir_FeatureRef", is_abstract=True)
ir_OperationFeatureRef = Class(name="ir_OperationFeatureRef", is_abstract=True)
FeatureRef = Class(name="FeatureRef")
ir_EFClass = Class(name="ir_EFClass")
ir_BuiltinOperationRef = Class(name="ir_BuiltinOperationRef")
OperationFeatureRef = Class(name="OperationFeatureRef")
ir_DefinedOperationRef = Class(name="ir_DefinedOperationRef")
ir_DerivedProperty = Class(name="ir_DerivedProperty", is_abstract=True)
ir_PropertyFeatureRef = Class(name="ir_PropertyFeatureRef", is_abstract=True)
ir_TupleFieldRef = Class(name="ir_TupleFieldRef")
PropertyFeatureRef = Class(name="PropertyFeatureRef")
ir_DerivedPropertyRef = Class(name="ir_DerivedPropertyRef")
ir_BuiltinPropertyRef = Class(name="ir_BuiltinPropertyRef")
ir_MetamodelFeatureRef = Class(name="ir_MetamodelFeatureRef")
ir_EStructuralFeature = Class(name="ir_EStructuralFeature")
ir_VariableDeclaration = Class(name="ir_VariableDeclaration")
VariableDeclaration = Class(name="VariableDeclaration")
ir_EFPackage = Class(name="ir_EFPackage")
ir_EPackage = Class(name="ir_EPackage")
ir_EFEnum = Class(name="ir_EFEnum")
EFType = Class(name="EFType")
ir_EClass = Class(name="ir_EClass")
ir_EEnum = Class(name="ir_EEnum")
ir_EFEnumLiteral = Class(name="ir_EFEnumLiteral")
ir_TupleTypeElement = Class(name="ir_TupleTypeElement")
ir_MetaTypeRef = Class(name="ir_MetaTypeRef")
TypeRef = Class(name="TypeRef")
ir_InvalidTypeRef = Class(name="ir_InvalidTypeRef")
ir_CollectionTypeRef = Class(name="ir_CollectionTypeRef", is_abstract=True)
ir_SetTypeRef = Class(name="ir_SetTypeRef")
CollectionTypeRef = Class(name="CollectionTypeRef")
ir_SequenceTypeRef = Class(name="ir_SequenceTypeRef")
ir_BagTypeRef = Class(name="ir_BagTypeRef")
ir_OrderedSetTypeRef = Class(name="ir_OrderedSetTypeRef")
ir_ocl_WithContextVariable = Class(name="ir_ocl_WithContextVariable", is_abstract=True)
ocl_ir_VariableDeclaration = Class(name="ocl_ir_VariableDeclaration")
ir_ocl_OclInvariant = Class(name="ir_ocl_OclInvariant")
Constraint = Class(name="Constraint")
ocl_WithContextVariable = Class(name="ocl_WithContextVariable")
ocl_ir_EFClass = Class(name="ocl_ir_EFClass")
OclExpression = Class(name="OclExpression")
ir_ocl_OclDerivedProperty = Class(name="ir_ocl_OclDerivedProperty")
DerivedProperty = Class(name="DerivedProperty")
ir_ocl_OclOperation = Class(name="ir_ocl_OclOperation")
Operation = Class(name="Operation")
ir_ocl_OclExpression = Class(name="ir_ocl_OclExpression", is_abstract=True)
ocl_ir_TypeRef = Class(name="ocl_ir_TypeRef")
ir_ocl_ModelElement = Class(name="ir_ocl_ModelElement")
ir_ocl_CallExp = Class(name="ir_ocl_CallExp", is_abstract=True)
ir_ocl_AbstractOperationCallExp = Class(name="ir_ocl_AbstractOperationCallExp", is_abstract=True)
CallExp = Class(name="CallExp")
ir_ocl_OperationCallExp = Class(name="ir_ocl_OperationCallExp")
AbstractOperationCallExp = Class(name="AbstractOperationCallExp")
ocl_ir_OperationFeatureRef = Class(name="ocl_ir_OperationFeatureRef")
ir_ocl_PropertyCallExp = Class(name="ir_ocl_PropertyCallExp")
ocl_ir_PropertyFeatureRef = Class(name="ocl_ir_PropertyFeatureRef")
ir_ocl_CollectionCallExp = Class(name="ir_ocl_CollectionCallExp")
ir_ocl_LoopExp = Class(name="ir_ocl_LoopExp", is_abstract=True)
Iterator = Class(name="Iterator")
ir_ocl_IteratorExp = Class(name="ir_ocl_IteratorExp")
LoopExp = Class(name="LoopExp")
ir_ocl_IterateExp = Class(name="ir_ocl_IterateExp")
ir_ocl_Iterator = Class(name="ir_ocl_Iterator")
ir_ocl_IfExp = Class(name="ir_ocl_IfExp")
ir_ocl_LetExp = Class(name="ir_ocl_LetExp")
ir_ocl_OperatorCallExp = Class(name="ir_ocl_OperatorCallExp")
ir_ocl_VarExp = Class(name="ir_ocl_VarExp")
ir_ocl_LiteralExp = Class(name="ir_ocl_LiteralExp", is_abstract=True)
ir_ocl_BooleanLiteralExp = Class(name="ir_ocl_BooleanLiteralExp")
LiteralExp = Class(name="LiteralExp")
ir_ocl_StringLiteralExp = Class(name="ir_ocl_StringLiteralExp")
ir_ocl_IntegerLiteralExp = Class(name="ir_ocl_IntegerLiteralExp")
ir_ocl_RealLiteralExp = Class(name="ir_ocl_RealLiteralExp")
ir_ocl_OclUndefined = Class(name="ir_ocl_OclUndefined")
ir_ocl_OclInvalid = Class(name="ir_ocl_OclInvalid")
ir_ocl_TupleLiteralExp = Class(name="ir_ocl_TupleLiteralExp")
ocl_ir_EFTupleType = Class(name="ocl_ir_EFTupleType")
TuplePart = Class(name="TuplePart")
ir_ocl_TuplePart = Class(name="ir_ocl_TuplePart")
ir_ocl_EnumLiteralExp = Class(name="ir_ocl_EnumLiteralExp")
ocl_ir_MetaTypeRef = Class(name="ocl_ir_MetaTypeRef")
ocl_ir_EFEnumLiteral = Class(name="ocl_ir_EFEnumLiteral")
ir_ocl_CollectionLiteralExp = Class(name="ir_ocl_CollectionLiteralExp", is_abstract=True)
ir_ocl_SetLiteralExp = Class(name="ir_ocl_SetLiteralExp")
CollectionLiteralExp = Class(name="CollectionLiteralExp")
ir_ocl_OrderedSetLiteralExp = Class(name="ir_ocl_OrderedSetLiteralExp")
ir_ocl_SequenceLiteralExp = Class(name="ir_ocl_SequenceLiteralExp")
ir_ocl_BagLiteralExp = Class(name="ir_ocl_BagLiteralExp")
ir_ocl_UnsupportedExp = Class(name="ir_ocl_UnsupportedExp")
ir_ocl_OclAnyLibElement = Class(name="ir_ocl_OclAnyLibElement")
...
in_87: BinaryAssociation = BinaryAssociation(
    name="in_87",
    ends={
...
domain_model = DomainModel(
    name="ir",
    types={ir_Operation, ir_EFPrimitiveType, ir_EFTupleType, ir_TypedElement, ir_TypeRef, ir_AbstractFunction, TypedElement, ir_EFType, ir_Specification, AbstractFunction, ir_EFMetamodel, ir_Parameter, ir_Constraint, ir_FeatureRef, ir_OperationFeatureRef, FeatureRef, ir_EFClass, ir_BuiltinOperationRef, OperationFeatureRef, ir_DefinedOperationRef, ir_DerivedProperty, ir_PropertyFeatureRef, ir_TupleFieldRef, PropertyFeatureRef, ir_DerivedPropertyRef, ir_BuiltinPropertyRef, ir_MetamodelFeatureRef, ir_EStructuralFeature, ir_VariableDeclaration, VariableDeclaration, ir_EFPackage, ir_EPackage, ir_EFEnum, EFType, ir_EClass, ir_EEnum, ir_EFEnumLiteral, ir_TupleTypeElement, ir_MetaTypeRef, TypeRef, ir_InvalidTypeRef, ir_CollectionTypeRef, ir_SetTypeRef, CollectionTypeRef, ir_SequenceTypeRef, ir_BagTypeRef, ir_OrderedSetTypeRef, ir_ocl_WithContextVariable, ocl_ir_VariableDeclaration, ir_ocl_OclInvariant, Constraint, ocl_WithContextVariable, ocl_ir_EFClass, OclExpression, ir_ocl_OclDerivedProperty, DerivedProperty, ir_ocl_OclOperation, Operation, ir_ocl_OclExpression, ocl_ir_TypeRef, ir_ocl_ModelElement, ir_ocl_CallExp, ir_ocl_AbstractOperationCallExp, CallExp, ir_ocl_OperationCallExp, AbstractOperationCallExp, ocl_ir_OperationFeatureRef, ir_ocl_PropertyCallExp, ocl_ir_PropertyFeatureRef, ir_ocl_CollectionCallExp, ir_ocl_LoopExp, Iterator, ir_ocl_IteratorExp, LoopExp, ir_ocl_IterateExp, ir_ocl_Iterator, ir_ocl_IfExp, ir_ocl_LetExp, ir_ocl_OperatorCallExp, ir_ocl_VarExp, ir_ocl_LiteralExp, ir_ocl_BooleanLiteralExp, LiteralExp, ir_ocl_StringLiteralExp, ir_ocl_IntegerLiteralExp, ir_ocl_RealLiteralExp, ir_ocl_OclUndefined, ir_ocl_OclInvalid, ir_ocl_TupleLiteralExp, ocl_ir_EFTupleType, TuplePart, ir_ocl_TuplePart, ir_ocl_EnumLiteralExp, ocl_ir_MetaTypeRef, ocl_ir_EFEnumLiteral, ir_ocl_CollectionLiteralExp, ir_ocl_SetLiteralExp, CollectionLiteralExp, ir_ocl_OrderedSetLiteralExp, ir_ocl_SequenceLiteralExp, ir_ocl_BagLiteralExp, ir_ocl_UnsupportedExp, ir_ocl_OclAnyLibElement, OperatorKind},
    associations={operations7, primitiveTypes9, tupleTypes11, type13, context14, metamodels0, parameters15, constaints1, temporary3, properties5, type19, property21, feature23, type24, roots26, pkg28, classes30, operation17, enumerations33, klass35, enum_37, literals39, elements41, type46, containedType48, contextVariable50, klass51, expression52, body54, body56, type58, source59, arguments61, type43, feature63, feature64, iterators65, body66, result69, init71, condition74, then76, else_79, variable82, init84, in_87, argument90, variable92, tupleType94, parts95, value97, enum_99, literal100, parts102},
    generalizations={gen_ir_AbstractFunction_TypedElement, gen_ir_DerivedProperty_AbstractFunction, gen_ir_Operation_AbstractFunction, gen_ir_OperationFeatureRef_FeatureRef, gen_ir_BuiltinOperationRef_OperationFeatureRef, gen_ir_DefinedOperationRef_OperationFeatureRef, gen_ir_PropertyFeatureRef_FeatureRef, gen_ir_TupleFieldRef_PropertyFeatureRef, gen_ir_DerivedPropertyRef_PropertyFeatureRef, gen_ir_BuiltinPropertyRef_PropertyFeatureRef, gen_ir_MetamodelFeatureRef_PropertyFeatureRef, gen_ir_Parameter_VariableDeclaration, gen_ir_EFClass_EFType, gen_ir_EFPrimitiveType_EFType, gen_ir_EFEnum_EFType, gen_ir_EFTupleType_EFType, gen_ir_MetaTypeRef_TypeRef, gen_ir_InvalidTypeRef_TypeRef, gen_ir_CollectionTypeRef_TypeRef, gen_ir_SetTypeRef_CollectionTypeRef, gen_ir_SequenceTypeRef_CollectionTypeRef, gen_ir_BagTypeRef_CollectionTypeRef, gen_ir_OrderedSetTypeRef_CollectionTypeRef, gen_ir_ocl_OclInvariant_Constraint, gen_ir_ocl_OclInvariant_ocl_WithContextVariable, gen_ir_ocl_OclDerivedProperty_DerivedProperty, gen_ir_ocl_OclDerivedProperty_ocl_WithContextVariable, gen_ir_ocl_OclOperation_Operation, gen_ir_ocl_OclOperation_ocl_WithContextVariable, gen_ir_ocl_ModelElement_OclExpression, gen_ir_ocl_CallExp_OclExpression, gen_ir_ocl_AbstractOperationCallExp_CallExp, gen_ir_ocl_OperationCallExp_AbstractOperationCallExp, gen_ir_ocl_PropertyCallExp_CallExp, gen_ir_ocl_CollectionCallExp_AbstractOperationCallExp, gen_ir_ocl_LoopExp_CallExp, gen_ir_ocl_IteratorExp_LoopExp, gen_ir_ocl_IterateExp_LoopExp, gen_ir_ocl_Iterator_VariableDeclaration, gen_ir_ocl_IfExp_OclExpression, gen_ir_ocl_LetExp_OclExpression, gen_ir_ocl_OperatorCallExp_CallExp, gen_ir_ocl_VarExp_OclExpression, gen_ir_ocl_LiteralExp_OclExpression, gen_ir_ocl_BooleanLiteralExp_LiteralExp, gen_ir_ocl_StringLiteralExp_LiteralExp, gen_ir_ocl_IntegerLiteralExp_LiteralExp, gen_ir_ocl_RealLiteralExp_LiteralExp, gen_ir_ocl_OclUndefined_LiteralExp, gen_ir_ocl_OclInvalid_LiteralExp, gen_ir_ocl_TupleLiteralExp_LiteralExp, gen_ir_ocl_EnumLiteralExp_LiteralExp, gen_ir_ocl_CollectionLiteralExp_LiteralExp, gen_ir_ocl_SetLiteralExp_CollectionLiteralExp, gen_ir_ocl_OrderedSetLiteralExp_CollectionLiteralExp, gen_ir_ocl_SequenceLiteralExp_CollectionLiteralExp, gen_ir_ocl_BagLiteralExp_CollectionLiteralExp, gen_ir_ocl_UnsupportedExp_OclExpression},
    metadata=None
)
