...
# Classes
PetriNets_PetriNet = Class(name="PetriNets_PetriNet")
PetriNets_Place = Class(name="PetriNets_Place")
PetriNets_Token = Class(name="PetriNets_Token")
PetriNets_ArcPT = Class(name="PetriNets_ArcPT")
Arc = Class(name="Arc")
PetriNets_ArcTP = Class(name="PetriNets_ArcTP")
...
PetriNets_Transition.methods={PetriNets_Transition_m_inputs, PetriNets_Transition_m_outputs}
...
domain_model = DomainModel(
    name="PetriNets",
    types={PetriNets_PetriNet, PetriNets_Place, PetriNets_Token, PetriNets_ArcPT, Arc, PetriNets_ArcTP, PetriNets_Transition, PetriNets_Arc},
    associations={places0, ctokens5, from_6, to8, from_10, trans1, arcs3, net4, inh23, read26, reset29, to12, net15, ins17, outs20},
