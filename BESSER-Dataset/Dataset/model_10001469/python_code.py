...
class CC:
    ...
    def __init__(self, attC1: int, attC2: bool, b9: "BB" = None):
        self.attC1 = attC1
        self.attC2 = attC2
        self.b9 = b9
    ...
    def b9(self, value):
        ...
        old_value = getattr(self, f"_CC__b9", None)
        self.__b9 = value
...
class BB:
    ...
    def __init__(self, attB: int, a7: "AA" = None, c8: set["CC"] = None):
        self.attB = attB
        self.a7 = a7
    ...
    def c8(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_BB__c8", None)
    ...
    def a7(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_BB__a7", None)
        self.__a7 = value
...
class AA:
    ...
    def __init__(self, attA: str, r5: "R" = None, b6: set["BB"] = None):
        self.attA = attA
        self.r5 = r5
    ...
    def b6(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_AA__b6", None)
    ...
    def r5(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_AA__r5", None)
        self.__r5 = value
