...
class test_Transition(NamedElement):
    ...
    def __init__(self, test_Transition: "test_StateMachine" = None, test_Transition4: "test_State" = None, test_Transition7: "test_State" = None):
...
class test_State(NamedElement):
    ...
    def __init__(self, kind: str, test_State: "test_StateMachine" = None, test_State5: "test_Transition" = None, test_State8: "test_Transition" = None):
        self.kind = kind
