...
# Classes
test_StateMachine = Class(name="test_StateMachine")
NamedElement = Class(name="NamedElement")
test_Transition = Class(name="test_Transition")
test_State = Class(name="test_State")
...
domain_model = DomainModel(
    ...
    associations={transitions0, states1, source3, target6},
    generalizations={gen_test_StateMachine_NamedElement, gen_test_Transition_NamedElement, gen_test_State_NamedElement},
    metadata=None
)
