...
# Classes
syswb106_Workbench = Class(name="syswb106_Workbench")
syswb106_Thing = Class(name="syswb106_Thing")
syswb106_Thoughts = Class(name="syswb106_Thoughts")
syswb106_System = Class(name="syswb106_System")
syswb106_FunctionProperty = Class(name="syswb106_FunctionProperty")
syswb106_PatternCatalog = Class(name="syswb106_PatternCatalog")
syswb106_RelatedTo = Class(name="syswb106_RelatedTo")
syswb106_Function = Class(name="syswb106_Function")
syswb106_Component = Class(name="syswb106_Component")
...
domain_model = DomainModel(
    name="syswb106",
    types={syswb106_Workbench, syswb106_Thing, syswb106_Thoughts, syswb106_System, syswb106_FunctionProperty, syswb106_PatternCatalog, syswb106_RelatedTo, syswb106_Function, syswb106_Component},
    associations={things0, thoughts1, systemView3, functionProperties5, catalog7, decompositions20, associations22, performs24, decompositions27, property29, associations33, allocatedTo35, relations9, fromThing10, toThing11, relatedTo13, parent17, functionalArchitecture38, physicalArchitecture41, patterns44},
    generalizations={},
    metadata=None
)
