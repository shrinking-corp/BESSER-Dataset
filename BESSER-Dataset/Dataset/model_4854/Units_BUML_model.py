...
domain_model = DomainModel(
    name="units",
    types={units_BaseUnit, units_UnitRepository, units_UnitMultiplication, Unit, units_UnitPower, units_UnitCarryingElement, units_Unit, units_UnitLiteral},
    associations={units1, units2, unit0, unit4, baseUnit6},
