...
class contacts_Address:
    ...
    def __init__(self, street: str, city: str, state: str, country: str, zipCode: str, contacts_Address: "contacts_Contact" = None, contacts_Address8: "contacts_Contact" = None):
        self.street = street
        self.city = city
        self.state = state
        self.country = country
...
class contacts_Contact:
    ...
    def __init__(self, firstName: str, middleName: str, lastName: str, title: str, company: str, jobTitle: str, email: str, webPage: str, note: str, image: str, contacts_Contact: "contacts_Address" = None, contacts_Contact2: "contacts_PhoneNumber" = None, contacts_Contact4: "contacts_PhoneNumber" = None, contacts_Contact7: "contacts_Address" = None, contacts_Contact10: "contacts_AddressBook" = None):
