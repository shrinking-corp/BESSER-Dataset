...
# Classes
contacts_Contact = Class(name="contacts_Contact")
contacts_Address = Class(name="contacts_Address")
contacts_PhoneNumber = Class(name="contacts_PhoneNumber")
contacts_AddressBook = Class(name="contacts_AddressBook")
contacts_UoD = Class(name="contacts_UoD")
...
contacts_Contact.attributes={contacts_Contact_firstName, contacts_Contact_lastName, contacts_Contact_title, contacts_Contact_middleName, contacts_Contact_company, contacts_Contact_image, contacts_Contact_jobTitle, contacts_Contact_webPage, contacts_Contact_email, contacts_Contact_note}
...
contacts_Address.attributes={contacts_Address_street, contacts_Address_state, contacts_Address_country, contacts_Address_zipCode, contacts_Address_city}
...
domain_model = DomainModel(
    name="contacts",
    types={contacts_Contact, contacts_Address, contacts_PhoneNumber, contacts_AddressBook, contacts_UoD},
    associations={workAddress0, phone1, mobile3, homeAddress6, contacts9, allAddressBooks11},
    generalizations={},
    metadata=None
)
