...
# Classes
ref3_D = Class(name="ref3_D")
T = Class(name="T")
ref3_N = Class(name="ref3_N")
Named = Class(name="Named")
ref3_T = Class(name="ref3_T")
ref3_A = Class(name="ref3_A")
ref3_B = Class(name="ref3_B")
ref3_Named = Class(name="ref3_Named")
ref3_E = Class(name="ref3_E")
D = Class(name="D")
...
domain_model = DomainModel(
    name="ref3",
    types={ref3_D, T, ref3_N, Named, ref3_T, ref3_A, ref3_B, ref3_Named, ref3_E, D},
    associations={ts0, as_1, bs3, ds5, ds7, ds10},
    generalizations={gen_ref3_D_T, gen_ref3_N_Named, gen_ref3_T_Named, gen_ref3_A_Named, gen_ref3_B_Named, gen_ref3_E_Named, gen_ref3_E_D},
    metadata=None
)
