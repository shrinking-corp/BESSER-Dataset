...
class accounting_Accounting(Serializable):
    ...
    def __init__(self, name: str, accounting_Accounting6: "accounting_BalanceAccount" = None, accounting_Accounting8: "accounting_Report" = None, accounting_Accounting10: set["accounting_JournalGroup"] = None, accounting_Accounting: set["accounting_AccountGroup"] = None, accounting_Accounting4: set["accounting_Vat"] = None):
        self.name = name
...
class accounting_JournalGroup:
    ...
    def __init__(self, name: str, accounting_JournalGroup: "accounting_Accounting" = None, accounting_JournalGroup16: set["accounting_JournalStatement"] = None, accounting_JournalGroup14: "accounting_JournalGroup" = None, accounting_JournalGroup12: set["accounting_JournalGroup"] = None):
        self.name = name
