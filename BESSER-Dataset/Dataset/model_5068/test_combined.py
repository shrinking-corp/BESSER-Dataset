...
def test_hyp_accounting_serializable_is_not_abstract():
    assert not inspect.isabstract(accounting_Serializable)


def test_hyp_accounting_serializable_constructor_exists():
    assert callable(accounting_Serializable.__init__)


def test_hyp_accounting_serializable_constructor_args():
    sig = inspect.signature(accounting_Serializable.__init__)
    params = list(sig.parameters.keys())
...
accounting_Serializable_strategy = st.builds(
    accounting_Serializable,
)
