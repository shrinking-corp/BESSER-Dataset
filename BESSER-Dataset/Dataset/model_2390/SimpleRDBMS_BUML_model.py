...
# Classes
simpleRDBMS_RDBMSModel = Class(name="simpleRDBMS_RDBMSModel")
simpleRDBMS_NamedElement = Class(name="simpleRDBMS_NamedElement", is_abstract=True)
...
domain_model = DomainModel(
    name="simpleRDBMS",
    types={simpleRDBMS_RDBMSModel, simpleRDBMS_NamedElement, simpleRDBMS_Schema, NamedElement, simpleRDBMS_Table, simpleRDBMS_Column, simpleRDBMS_ForeignKey, simpleRDBMS_Key},
    associations={column7, referTo10, tables0, columns1, foreignKeys3, key5, schemas13, column15},
    generalizations={gen_simpleRDBMS_Schema_NamedElement, gen_simpleRDBMS_Table_NamedElement, gen_simpleRDBMS_Column_NamedElement, gen_simpleRDBMS_ForeignKey_NamedElement, gen_simpleRDBMS_Key_NamedElement},
    metadata=None
)
