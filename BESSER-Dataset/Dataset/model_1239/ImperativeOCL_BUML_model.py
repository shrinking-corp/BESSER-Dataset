...
domain_model = DomainModel(
    name="ImperativeOCL",
    types={LogExp, ImperativeOCL_AltExp, ImperativeExpression, OclExpression, ImperativeOCL_AssertExp, ImperativeOCL_AssignExp, ImperativeOCL_BlockExp, ImperativeOCL_BreakExp, ImperativeOCL_CatchExp, ImperativeOCL_ImperativeLoopExp, LoopExp, Variable, Type, ImperativeOCL_ComputeExp, ImperativeOCL_ContinueExp, ImperativeOCL_DictLiteralExp, LiteralExp, DictLiteralPart, ImperativeOCL_DictLiteralPart, Element, DictLiteralExp, ImperativeOCL_DictionaryType, CollectionType, ImperativeOCL_ForExp, ImperativeLoopExp, ImperativeOCL_ImperativeExpression, ImperativeOCL_ImperativeIterateExp, ImperativeOCL_InstantiationExp, Class_, Operation, ImperativeOCL_ListLiteralExp, ImperativeOCL_ListType, ImperativeOCL_LogExp, OperationCallExp, ImperativeOCL_RaiseExp, ImperativeOCL_ReturnExp, ImperativeOCL_SwitchExp, AltExp, ImperativeOCL_TryExp, CatchExp, ImperativeOCL_Typedef, ImperativeOCL_UnlinkExp, ImperativeOCL_VariableInitExp, ImperativeOCL_WhileExp, SeverityKind},
    associations={assertion4, log6, body0, condition1, exception20, defaultValue8, left10, value13, body16, body18, exceptionVariable22, body24, returnedElement26, part29, key30, value32, partOwner35, keyType37, target39, condition41, argument43, extent45, instantiatedClass48, initializationOperation50, element52, condition54, argument56, exception58, value61, alternativePart63, elsePart64, exceptClause67, tryBody68, base71, condition73, item76, target78, referredVariable81, body83, condition85},
    generalizations={gen_ImperativeOCL_AltExp_ImperativeExpression, gen_ImperativeOCL_AssertExp_ImperativeExpression, gen_ImperativeOCL_AssignExp_ImperativeExpression, gen_ImperativeOCL_BlockExp_ImperativeExpression, gen_ImperativeOCL_BreakExp_ImperativeExpression, gen_ImperativeOCL_CatchExp_ImperativeExpression, gen_ImperativeOCL_ImperativeLoopExp_LoopExp, gen_ImperativeOCL_ImperativeLoopExp_ImperativeExpression, gen_ImperativeOCL_ComputeExp_ImperativeExpression, gen_ImperativeOCL_ContinueExp_ImperativeExpression, gen_ImperativeOCL_DictLiteralExp_LiteralExp, gen_ImperativeOCL_DictLiteralPart_Element, gen_ImperativeOCL_DictionaryType_CollectionType, gen_ImperativeOCL_ForExp_ImperativeLoopExp, gen_ImperativeOCL_ImperativeExpression_OclExpression, gen_ImperativeOCL_ImperativeIterateExp_ImperativeLoopExp, gen_ImperativeOCL_InstantiationExp_ImperativeExpression, gen_ImperativeOCL_ListLiteralExp_LiteralExp, gen_ImperativeOCL_ListType_CollectionType, gen_ImperativeOCL_LogExp_OperationCallExp, gen_ImperativeOCL_LogExp_ImperativeExpression, gen_ImperativeOCL_RaiseExp_ImperativeExpression, gen_ImperativeOCL_ReturnExp_ImperativeExpression, gen_ImperativeOCL_SwitchExp_ImperativeExpression, gen_ImperativeOCL_TryExp_ImperativeExpression, gen_ImperativeOCL_Typedef_Class, gen_ImperativeOCL_UnlinkExp_ImperativeExpression, gen_ImperativeOCL_VariableInitExp_ImperativeExpression, gen_ImperativeOCL_WhileExp_ImperativeExpression},
    metadata=None
)
