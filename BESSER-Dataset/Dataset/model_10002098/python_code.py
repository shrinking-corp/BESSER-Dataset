...
class Fitur_Menghubungi_admin_melalui_media_sosial_yang_ditentukan_UseCase:
...
class Mengedit_Data_Pemeriksaan_Kesehatan_Pra_Nikah_UseCase:

    pass


class Menghapus_Data_Pemeriksaan_Kesehatan_Pra_Nikah_UseCase:

    pass


class Menambah_Data_Pemeriksaan_Kesehatan_Pra_Nikah_UseCase:
...
class Siapa_Yang_Melakukan_UseCase:
...
class Dampak_Jika_Tidak_Dilakukan_UseCase:

    pass


class Jenis_Pemeriksaan_UseCase:

    pass


class Manfaat_Pemeriksaan_UseCase:
...
class Kapan_Harus_Melakukan_UseCase:

    pass


class Dimana_Melakukannya_UseCase:

    pass


class Fitur_Data_Informasi_Pemeriksaan_Kesehatan_Pra_Nikah_UseCase:
...
class Fitur_Pemilihan_Informasi_Berdasarkan_Jenisnya_UseCase:
...
class Website_Informasi_Kesehatan_Pra_Nikah_UseCase:
