...
Website_Informasi_Kesehatan_Pra_Nikah_UseCase = Class(name="Website_Informasi_Kesehatan_Pra_Nikah_UseCase")
...
Fitur_Pemilihan_Informasi_Berdasarkan_Jenisnya_UseCase = Class(name="Fitur_Pemilihan_Informasi_Berdasarkan_Jenisnya_UseCase")
...
Fitur_Data_Informasi_Pemeriksaan_Kesehatan_Pra_Nikah_UseCase = Class(name="Fitur_Data_Informasi_Pemeriksaan_Kesehatan_Pra_Nikah_UseCase")
Dimana_Melakukannya_UseCase = Class(name="Dimana_Melakukannya_UseCase")
Kapan_Harus_Melakukan_UseCase = Class(name="Kapan_Harus_Melakukan_UseCase")
Jenis_Tumbuhan_Herbalnya_UseCase = Class(name="Jenis_Tumbuhan_Herbalnya_UseCase")
Manfaat_Pemeriksaan_UseCase = Class(name="Manfaat_Pemeriksaan_UseCase")
Jenis_Pemeriksaan_UseCase = Class(name="Jenis_Pemeriksaan_UseCase")
Dampak_Jika_Tidak_Dilakukan_UseCase = Class(name="Dampak_Jika_Tidak_Dilakukan_UseCase")
Kelas_Ordo_Tumbuhan_Herbal_UseCase = Class(name="Kelas_Ordo_Tumbuhan_Herbal_UseCase")
Gambar_Tumbuhan_Herbalnya_UseCase = Class(name="Gambar_Tumbuhan_Herbalnya_UseCase")
Siapa_Yang_Melakukan_UseCase = Class(name="Siapa_Yang_Melakukan_UseCase")
...
Menambah_Data_Pemeriksaan_Kesehatan_Pra_Nikah_UseCase = Class(name="Menambah_Data_Pemeriksaan_Kesehatan_Pra_Nikah_UseCase")
Menghapus_Data_Pemeriksaan_Kesehatan_Pra_Nikah_UseCase = Class(name="Menghapus_Data_Pemeriksaan_Kesehatan_Pra_Nikah_UseCase")
Mengedit_Data_Pemeriksaan_Kesehatan_Pra_Nikah_UseCase = Class(name="Mengedit_Data_Pemeriksaan_Kesehatan_Pra_Nikah_UseCase")
...
Fitur_Menghubungi_admin_melalui_media_sosial_yang_ditentukan_UseCase = Class(name="Fitur_Menghubungi_admin_melalui_media_sosial_yang_ditentukan_UseCase")
...
Pengelola_Website.attributes={Pengelola_Website_attribute2, Pengelola_Website_attribute4, Pengelola_Website_attribute3, Pengelola_Website_attribute}
...
Nama_Tumbuh_Tumbuhan_Herbal.attributes={Nama_Tumbuh_Tumbuhan_Herbal_attribute4, Nama_Tumbuh_Tumbuhan_Herbal_attribute6, Nama_Tumbuh_Tumbuhan_Herbal_attribute5, Nama_Tumbuh_Tumbuhan_Herbal_attribute9, Nama_Tumbuh_Tumbuhan_Herbal_attribute3, Nama_Tumbuh_Tumbuhan_Herbal_attribute2, Nama_Tumbuh_Tumbuhan_Herbal_attribute, Nama_Tumbuh_Tumbuhan_Herbal_attribute7, Nama_Tumbuh_Tumbuhan_Herbal_attribute8}

# Admin_Website_Actor class attributes and methods

# Website_Informasi_Kesehatan_Pra_Nikah_UseCase class attributes and methods

# Halaman_Utama_Website_UseCase class attributes and methods

# Fitur_Fitur_Pada_Website_UseCase class attributes and methods

# Fitur_Pemilihan_Informasi_Berdasarkan_Jenisnya_UseCase class attributes and methods
...
# Fitur_Data_Informasi_Pemeriksaan_Kesehatan_Pra_Nikah_UseCase class attributes and methods

# Dimana_Melakukannya_UseCase class attributes and methods

# Kapan_Harus_Melakukan_UseCase class attributes and methods

# Jenis_Tumbuhan_Herbalnya_UseCase class attributes and methods

# Manfaat_Pemeriksaan_UseCase class attributes and methods

# Jenis_Pemeriksaan_UseCase class attributes and methods

# Dampak_Jika_Tidak_Dilakukan_UseCase class attributes and methods

# Kelas_Ordo_Tumbuhan_Herbal_UseCase class attributes and methods

# Gambar_Tumbuhan_Herbalnya_UseCase class attributes and methods

# Siapa_Yang_Melakukan_UseCase class attributes and methods

# Dosisnya_UseCase1 class attributes and methods

# Mengedit_Profil_Dan_Data_Website_UseCase class attributes and methods

# Menambah_Data_Pemeriksaan_Kesehatan_Pra_Nikah_UseCase class attributes and methods

# Menghapus_Data_Pemeriksaan_Kesehatan_Pra_Nikah_UseCase class attributes and methods

# Mengedit_Data_Pemeriksaan_Kesehatan_Pra_Nikah_UseCase class attributes and methods
...
# Fitur_Menghubungi_admin_melalui_media_sosial_yang_ditentukan_UseCase class attributes and methods
...
Mengedit_Profil_Dan_Data_Website_Website_Informasi_Tumbuhan_Herbal: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="website_Informasi_Tumbuhan_Herbal19", type=Website_Informasi_Kesehatan_Pra_Nikah_UseCase, multiplicity=Multiplicity(0, 1))
    }
)
Website_Informasi_Tumbuhan_Herbal_Halaman_Utama_Website: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="website_Informasi_Tumbuhan_Herbal20", type=Website_Informasi_Kesehatan_Pra_Nikah_UseCase, multiplicity=Multiplicity(0, 1)),
...
Menambah_Data_Tumbuh_Tumbuhan_Herbal_Fitur_Data_Informasi_Tumbuh_Tumbuhan_Herbal: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="menambah_Data_Tumbuh_Tumbuhan_Herbal24", type=Menambah_Data_Pemeriksaan_Kesehatan_Pra_Nikah_UseCase, multiplicity=Multiplicity(0, 1)),
        Property(name="fitur_Data_Informasi_Tumbuh_Tumbuhan_Herbal25", type=Fitur_Data_Informasi_Pemeriksaan_Kesehatan_Pra_Nikah_UseCase, multiplicity=Multiplicity(0, 1))
    }
)
Mengedit_Data_Tumbuh_Tumbuhan_Herbal_Fitur_Data_Informasi_Tumbuh_Tumbuhan_Herbal: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="mengedit_Data_Tumbuh_Tumbuhan_Herbal26", type=Mengedit_Data_Pemeriksaan_Kesehatan_Pra_Nikah_UseCase, multiplicity=Multiplicity(0, 1)),
        Property(name="fitur_Data_Informasi_Tumbuh_Tumbuhan_Herbal27", type=Fitur_Data_Informasi_Pemeriksaan_Kesehatan_Pra_Nikah_UseCase, multiplicity=Multiplicity(0, 1))
    }
)
Menghapus_Data_Tumbuh_Tumbuhan_Herbal_Fitur_Data_Informasi_Tumbuh_Tumbuhan_Herbal: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="menghapus_Data_Tumbuh_Tumbuhan_Herbal28", type=Menghapus_Data_Pemeriksaan_Kesehatan_Pra_Nikah_UseCase, multiplicity=Multiplicity(0, 1)),
        Property(name="fitur_Data_Informasi_Tumbuh_Tumbuhan_Herbal29", type=Fitur_Data_Informasi_Pemeriksaan_Kesehatan_Pra_Nikah_UseCase, multiplicity=Multiplicity(0, 1))
    }
)
...
Admin_Website_Situs_Browsing: BinaryAssociation = BinaryAssociation(
    name="Admin_Website_Situs_Browsing",
    ends={
        Property(name="admin_Website34", type=Admin_Website_Actor, multiplicity=Multiplicity(0, 1)),
        Property(name="situs_Browsing35", type=Situs_Browsing_UseCase, multiplicity=Multiplicity(0, 1))
    }
)
Situs_Browsing_Website_Informasi_Kesehatan_Pra_Nikah: BinaryAssociation = BinaryAssociation(
    name="Situs_Browsing_Website_Informasi_Kesehatan_Pra_Nikah",
    ends={
        Property(name="situs_Browsing36", type=Situs_Browsing_UseCase, multiplicity=Multiplicity(0, 1)),
        Property(name="website_Informasi_Kesehatan_Pra_Nikah37", type=Website_Informasi_Kesehatan_Pra_Nikah_UseCase, multiplicity=Multiplicity(0, 1))
    }
)

# Domain Model
domain_model = DomainModel(
    name="_oFWyIIMEEeqWAK1R3DAmBw",
    types={Admin_Actor, Kelola_data_website_UseCase, Menambah_membuat_data_website_UseCase, Menghapus_data_website_UseCase, Mengedit_data_website_UseCase, Browsing_Situs_UseCase, Menu_Halaman_Utama_WebsiteTumbuhan_Herbal_UseCase, Nama_Tumbuh_Tumbuhan_Herbal_UseCase, Nama_latinnya_UseCase, Jenis_tumbuhan_herbal_UseCase, Asal_daerah_tumbuhan_herbal_UseCase, Kelas_Ordo_tumbuhan_herbal_UseCase, Khasiatnya_apa_UseCase, Dosisnya_UseCase, Cara_pengolahannya_UseCase, Gambar_tumbuhan_herbalnya_UseCase, Obat__Produk_jadi__UseCase, Fitur_Pencarian_berdsarkan_penyakit_UseCase, Forum_diskusi_UseCase, User__Pengunjung__Actor, Login_Website, Browsing_Website, Pengelola_Website, Menu_Halaman_Website, Nama_Tumbuh_Tumbuhan_Herbal, Admin_Website_Actor, Website_Informasi_Kesehatan_Pra_Nikah_UseCase, Halaman_Utama_Website_UseCase, Fitur_Fitur_Pada_Website_UseCase, Fitur_Pemilihan_Informasi_Berdasarkan_Jenisnya_UseCase, Fitur_Kolom_Diskusi_UseCase, Fitur_Sosial_Media_Sharing_UseCase, Fitur_Pencarian_Tumbuhan_Herbal_UseCase, Fitur_Galeri_Foto_Tumbuhan_Herbal_UseCase, Fitur_Data_Informasi_Pemeriksaan_Kesehatan_Pra_Nikah_UseCase, Dimana_Melakukannya_UseCase, Kapan_Harus_Melakukan_UseCase, Jenis_Tumbuhan_Herbalnya_UseCase, Manfaat_Pemeriksaan_UseCase, Jenis_Pemeriksaan_UseCase, Dampak_Jika_Tidak_Dilakukan_UseCase, Kelas_Ordo_Tumbuhan_Herbal_UseCase, Gambar_Tumbuhan_Herbalnya_UseCase, Siapa_Yang_Melakukan_UseCase, Dosisnya_UseCase1, Mengedit_Profil_Dan_Data_Website_UseCase, Menambah_Data_Pemeriksaan_Kesehatan_Pra_Nikah_UseCase, Menghapus_Data_Pemeriksaan_Kesehatan_Pra_Nikah_UseCase, Mengedit_Data_Pemeriksaan_Kesehatan_Pra_Nikah_UseCase, Fitur_Website_Yang_Dapat_Diakses_Dan_Edit_Oleh_admin_UseCase, User__Pengunjung__Actor1, Fitur_Website_Yang_Dapat_Diakses_Oleh_Pengunjung_UseCase, Situs_Browsing_UseCase, Fitur_Menghubungi_admin_melalui_media_sosial_yang_ditentukan_UseCase},
    associations={Admin_Forum_diskusi, Admin_Website_Mengedit_Profil_Dan_Data_Website, Admin_Website_Fitur_Website_Yang_Dapat_Diakses_Dan_Edit_Oleh_admin, Fitur_Website_Yang_Dapat_Diakses_Dan_Edit_Oleh_admin_Fitur_Fitur_Pada_Website, Mengedit_Profil_Dan_Data_Website_Website_Informasi_Tumbuhan_Herbal, Website_Informasi_Tumbuhan_Herbal_Halaman_Utama_Website, Halaman_Utama_Website_Fitur_Fitur_Pada_Website, Admin_Kelola_data_website, Admin_Menambah_membuat_data_website, Admin_Mengedit_data_website, Admin_Menghapus_data_website, User__Pengunjung__Browsing_Situs, Menambah_Data_Tumbuh_Tumbuhan_Herbal_Fitur_Data_Informasi_Tumbuh_Tumbuhan_Herbal, Mengedit_Data_Tumbuh_Tumbuhan_Herbal_Fitur_Data_Informasi_Tumbuh_Tumbuhan_Herbal, Menghapus_Data_Tumbuh_Tumbuhan_Herbal_Fitur_Data_Informasi_Tumbuh_Tumbuhan_Herbal, Fitur_Website_Yang_Dapat_Diakses_Oleh_Pengunjung_Fitur_Fitur_Pada_Website, User__Pengunjung__Situs_Browsing, Admin_Website_Situs_Browsing, Situs_Browsing_Website_Informasi_Kesehatan_Pra_Nikah},
    generalizations={},
    metadata=None
)
