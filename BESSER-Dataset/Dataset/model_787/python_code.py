...
class fsm_State:
    ...
    def __init__(self, name: str, fsm_State: "fsm_FSM" = None, fsm_State4: "fsm_FSM" = None, State: "fsm_FSM" = None, ownedState: "fsm_FSM" = None, source: set["fsm_Transition"] = None, target: set["fsm_Transition"] = None, State10: "fsm_Transition" = None, State12: "fsm_Transition" = None):
        self.name = name
