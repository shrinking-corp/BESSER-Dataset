...
public class jpdl32_DocumentRoot  {
    ...
    public jpdl32_DocumentRoot(
        String text,        String to,        String subject,        String recipients,        String template,        String description,        String mixed    ) {
        this.text = text;
        this.to = to;
    ...
    public jpdl32_DocumentRoot(
        String text,        String to,        String subject,        String recipients,        String template,        String description,        String mixed        ArrayList<jpdl32_EventType> jpdl32_eventtypes,        ArrayList<jpdl32_AssignmentType> jpdl32_assignmenttypes,        ArrayList<jpdl32_CancelTimerType> jpdl32_canceltimertypes,        ArrayList<jpdl32_CreateTimerType> jpdl32_createtimertypes,        ArrayList<jpdl32_TransitionType> jpdl32_transitiontypes,        ArrayList<jpdl32_DecisionType> jpdl32_decisiontypes,        ArrayList<jpdl32_Delegation> jpdl32_delegations,        ArrayList<jpdl32_ExceptionHandlerType> jpdl32_exceptionhandlertypes,        ArrayList<jpdl32_ScriptType> jpdl32_scripttypes    ) {
        this.text = text;
        this.to = to;
        this.subject = subject;
        this.recipients = recipients;
