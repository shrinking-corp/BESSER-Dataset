...
public class jpdl32_ProcessDefinitionType  {
    ...
    public jpdl32_ProcessDefinitionType(
        String description,        String name,        String group        ArrayList<jpdl32_EndStateType> jpdl32_endstatetypes,        ArrayList<jpdl32_JoinType> jpdl32_jointypes,        ArrayList<jpdl32_MailType> jpdl32_mailtypes,        ArrayList<jpdl32_MailNodeType> jpdl32_mailnodetypes,        ArrayList<jpdl32_NodeType> jpdl32_nodetypes,        ArrayList<jpdl32_ExceptionHandlerType> jpdl32_exceptionhandlertypes,        ArrayList<jpdl32_CancelTimerType> jpdl32_canceltimertypes,        ArrayList<jpdl32_EventType> jpdl32_eventtypes,        ArrayList<jpdl32_ScriptType> jpdl32_scripttypes,        ArrayList<jpdl32_CreateTimerType> jpdl32_createtimertypes,        ArrayList<jpdl32_DecisionType> jpdl32_decisiontypes,        ArrayList<jpdl32_ForkType> jpdl32_forktypes    ) {
        this.description = description;
        this.name = name;
        this.group = group;
