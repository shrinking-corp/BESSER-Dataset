...
cardinality6_A_strategy = st.builds(cardinality6_A)
...
cardinality6_B_strategy = st.builds(cardinality6_B)
...
cardinality6_Root_strategy = st.builds(cardinality6_Root)
