...
def test_hyp_classt_attribute_setter(instance):
...
def test_ClassT_attribute_value_roundtrip():
    instance = ClassT(attribute=True)
...
ClassT_strategy = st.builds(ClassT, attribute=st.booleans())
@given(instance=ClassT_strategy)
@settings(max_examples=25)
