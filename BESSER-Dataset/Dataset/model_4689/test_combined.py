...
def test_hyp_simpleal_assign_is_not_abstract():
    assert not inspect.isabstract(simpleal_Assign)


def test_hyp_simpleal_assign_constructor_exists():
    assert callable(simpleal_Assign.__init__)


def test_hyp_simpleal_assign_constructor_args():
...
def test_hyp_simpleal_print_is_not_abstract():
    assert not inspect.isabstract(simpleal_Print)


def test_hyp_simpleal_print_constructor_exists():
    assert callable(simpleal_Print.__init__)


def test_hyp_simpleal_print_constructor_args():
...
def test_hyp_simpleal_arithminus_is_not_abstract():
    assert not inspect.isabstract(simpleal_ArithMinus)


def test_hyp_simpleal_arithminus_constructor_exists():
    assert callable(simpleal_ArithMinus.__init__)


def test_hyp_simpleal_arithminus_constructor_args():
    sig = inspect.signature(simpleal_ArithMinus.__init__)
    params = list(sig.parameters.keys())



def test_hyp_simpleal_arithplus_is_not_abstract():
    assert not inspect.isabstract(simpleal_ArithPlus)


def test_hyp_simpleal_arithplus_constructor_exists():
    assert callable(simpleal_ArithPlus.__init__)


def test_hyp_simpleal_arithplus_constructor_args():
...
def test_hyp_simpleal_arithop_is_not_abstract():
    assert not inspect.isabstract(simpleal_ArithOp)


def test_hyp_simpleal_arithop_constructor_exists():
    assert callable(simpleal_ArithOp.__init__)


def test_hyp_simpleal_arithop_constructor_args():
    sig = inspect.signature(simpleal_ArithOp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_simpleal_arithlit_is_not_abstract():
    assert not inspect.isabstract(simpleal_ArithLit)


def test_hyp_simpleal_arithlit_constructor_exists():
    assert callable(simpleal_ArithLit.__init__)


def test_hyp_simpleal_arithlit_constructor_args():
...
def test_hyp_simpleal_varref_is_not_abstract():
    assert not inspect.isabstract(simpleal_VarRef)


def test_hyp_simpleal_varref_constructor_exists():
    assert callable(simpleal_VarRef.__init__)


def test_hyp_simpleal_varref_constructor_args():
...
def test_hyp_simpleal_arith_is_not_abstract():
    assert not inspect.isabstract(simpleal_Arith)


def test_hyp_simpleal_arith_constructor_exists():
    assert callable(simpleal_Arith.__init__)


def test_hyp_simpleal_arith_constructor_args():
    sig = inspect.signature(simpleal_Arith.__init__)
    params = list(sig.parameters.keys())



def test_hyp_simpleal_stmt_is_not_abstract():
    assert not inspect.isabstract(simpleal_Stmt)


def test_hyp_simpleal_stmt_constructor_exists():
    assert callable(simpleal_Stmt.__init__)


def test_hyp_simpleal_stmt_constructor_args():
    sig = inspect.signature(simpleal_Stmt.__init__)
    params = list(sig.parameters.keys())



def test_hyp_simpleal_block_is_not_abstract():
    assert not inspect.isabstract(simpleal_Block)


def test_hyp_simpleal_block_constructor_exists():
    assert callable(simpleal_Block.__init__)


def test_hyp_simpleal_block_constructor_args():
...
def test_hyp_simpleal_assign_name_setter(instance):
...
def test_hyp_simpleal_print_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_simpleal_arithlit_val_setter(instance):
...
def test_hyp_simpleal_varref_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
