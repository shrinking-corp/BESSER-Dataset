...
# Classes
relationaldatabase_RelationalDatabase = Class(name="relationaldatabase_RelationalDatabase")
...
domain_model = DomainModel(
    ...
    types={relationaldatabase_RelationalDatabase, relationaldatabase_Table, relationaldatabase_NamedElement, NamedElement, relationaldatabase_Column, relationaldatabase_ForeignKey},
    associations={foreignKeysAsColumn9, foreignKeysAsForeignColumn11, tableColumn13, foreignColumn15, tables0, columns1, primaryKey2, foreignKeys4, table6, tableAsPrimaryKey7, table17},
    generalizations={gen_relationaldatabase_ForeignKey_NamedElement, gen_relationaldatabase_Table_NamedElement, gen_relationaldatabase_Column_NamedElement},
    metadata=None
)
