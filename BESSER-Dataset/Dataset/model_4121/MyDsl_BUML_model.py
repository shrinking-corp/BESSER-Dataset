...
myDsl_Function = Class(name="myDsl_Function")
myDsl_Definiton = Class(name="myDsl_Definiton")
myDsl_Input = Class(name="myDsl_Input")
myDsl_Commands = Class(name="myDsl_Commands")
myDsl_Output = Class(name="myDsl_Output")
myDsl_Command = Class(name="myDsl_Command")
...
myDsl_ExprTerm = Class(name="myDsl_ExprTerm")
myDsl_Or = Class(name="myDsl_Or")
myDsl_Not = Class(name="myDsl_Not")
myDsl_Eq = Class(name="myDsl_Eq")
...
myDsl_Input.attributes={myDsl_Input_v, myDsl_Input_v2}
...
myDsl_Output.attributes={myDsl_Output_v2, myDsl_Output_v}
...
myDsl_Vars.attributes={myDsl_Vars_v1, myDsl_Vars_v2}
...
domain_model = DomainModel(
    name="myDsl",
    types={myDsl_Model, myDsl_Function, myDsl_Definiton, myDsl_Input, myDsl_Commands, myDsl_Output, myDsl_Command, myDsl_Vars, myDsl_Exprs, myDsl_Expr, myDsl_ExprSimple, myDsl_And, myDsl_ExprTerm, myDsl_Or, myDsl_Not, myDsl_Eq, myDsl_EObject, myDsl_Lexpr},
    associations={model0, def_1, inputVars3, commandList5, outputVars7, c9, exp11, expL12, varL15, expL17, exp20, c123, exp126, exp229, c232, exprSimple35, expEt37, expTerminale39, expOu41, expOu243, expNon46, expNon248, expEq51, exprEq153, exprEq255, exp58, lexpr61, expr63, exp66},
    generalizations={},
    metadata=None
)
