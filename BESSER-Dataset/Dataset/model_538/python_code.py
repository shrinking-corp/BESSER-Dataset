...
class SimpleFamilies_FamilyMember:
    ...
    def __init__(self, name: str, SimpleFamilies_FamilyMember8: "SimpleFamilies_Family" = None, SimpleFamilies_FamilyMember11: "SimpleFamilies_Family" = None, SimpleFamilies_FamilyMember: "SimpleFamilies_Family" = None, SimpleFamilies_FamilyMember5: "SimpleFamilies_Family" = None):
        self.name = name
...
class SimpleFamilies_Family:
    ...
    def __init__(self, name: str, SimpleFamilies_Family7: set["SimpleFamilies_FamilyMember"] = None, SimpleFamilies_Family10: set["SimpleFamilies_FamilyMember"] = None, SimpleFamilies_Family: "SimpleFamilies_FamilyRegister" = None, SimpleFamilies_Family2: "SimpleFamilies_FamilyMember" = None, SimpleFamilies_Family4: "SimpleFamilies_FamilyMember" = None):
        self.name = name
