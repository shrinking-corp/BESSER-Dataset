...
# Classes
redblacktree2_Node = Class(name="redblacktree2_Node")
redblacktree2_Tree = Class(name="redblacktree2_Tree")
...
domain_model = DomainModel(
    name="redblacktree2",
    types={redblacktree2_Node, redblacktree2_Tree, Color, Type},
    associations={nodes0, root1, left5, right8},
    generalizations={},
    metadata=None
)
