...
pivot_Property_m_CompatibleDefaultExpression: Method = Method(name="CompatibleDefaultExpression", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_Property.attributes={pivot_Property_isUnsettable, pivot_Property_isVolatile, pivot_Property_isDerived, pivot_Property_implicit, pivot_Property_isID, pivot_Property_isResolveProxies, pivot_Property_default, pivot_Property_isReadOnly, pivot_Property_isTransient, pivot_Property_isComposite}
...
pivot_Operation_m_CompatibleReturn: Method = Method(name="CompatibleReturn", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_Operation_m_UniquePreconditionName: Method = Method(name="UniquePreconditionName", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_Class.attributes={pivot_Class_isInterface, pivot_Class_isActive, pivot_Class_isAbstract}
...
pivot_CollectionItem_m_TypeIsItemType: Method = Method(name="TypeIsItemType", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_CollectionLiteralExp_m_SetKindIsSet: Method = Method(name="SetKindIsSet", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_CollectionLiteralExp.attributes={pivot_CollectionLiteralExp_kind}
pivot_CollectionLiteralExp.methods={pivot_CollectionLiteralExp_m_CollectionKindIsConcrete, pivot_CollectionLiteralExp_m_BagKindIsBag, pivot_CollectionLiteralExp_m_SequenceKindIsSequence, pivot_CollectionLiteralExp_m_OrderedSetKindIsOrderedSet, pivot_CollectionLiteralExp_m_SetKindIsSet}
...
pivot_Type_m_UniqueInvariantName: Method = Method(name="UniqueInvariantName", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_State.attributes={pivot_State_isSimple, pivot_State_isOrthogonal, pivot_State_isComposite, pivot_State_isSubmachineState}
...
pivot_Variable_m_CompatibleInitialiserType: Method = Method(name="CompatibleInitialiserType", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_EnumLiteralExp_m_TypeIsEnumerationType: Method = Method(name="TypeIsEnumerationType", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_IterateExp_m_OneInitializer: Method = Method(name="OneInitializer", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_IterateExp_m_TypeIsResultType: Method = Method(name="TypeIsResultType", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_IteratorExp_m_AnyBodyTypeIsBoolean: Method = Method(name="AnyBodyTypeIsBoolean", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_IteratorExp_m_ClosureHasOneIterator: Method = Method(name="ClosureHasOneIterator", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_IteratorExp_m_ClosureSourceElementTypeIsBodyElementType: Method = Method(name="ClosureSourceElementTypeIsBodyElementType", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_IteratorExp_m_CollectElementTypeIsSourceElementType: Method = Method(name="CollectElementTypeIsSourceElementType", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_IteratorExp_m_CollectNestedHasOneIterator: Method = Method(name="CollectNestedHasOneIterator", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_IteratorExp_m_AnyHasOneIterator: Method = Method(name="AnyHasOneIterator", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_IteratorExp_m_ClosureBodyTypeIsConformanttoIteratorType: Method = Method(name="ClosureBodyTypeIsConformanttoIteratorType", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_IteratorExp_m_ForAllBodyTypeIsBoolean: Method = Method(name="ForAllBodyTypeIsBoolean", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_IteratorExp_m_ForAllTypeIsBoolean: Method = Method(name="ForAllTypeIsBoolean", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_IteratorExp_m_IsUniqueHasOneIterator: Method = Method(name="IsUniqueHasOneIterator", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_IteratorExp_m_IsUniqueTypeIsBoolean: Method = Method(name="IsUniqueTypeIsBoolean", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_IteratorExp_m_IteratorTypeIsSourceElementType: Method = Method(name="IteratorTypeIsSourceElementType", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_IteratorExp_m_OneTypeIsBoolean: Method = Method(name="OneTypeIsBoolean", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_IteratorExp_m_CollectTypeIsUnordered: Method = Method(name="CollectTypeIsUnordered", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_IteratorExp_m_ExistsBodyTypeIsBoolean: Method = Method(name="ExistsBodyTypeIsBoolean", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_IteratorExp_m_ExistsTypeIsBoolean: Method = Method(name="ExistsTypeIsBoolean", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_IteratorExp_m_SortedByIsOrderedIfSourceIsOrdered: Method = Method(name="SortedByIsOrderedIfSourceIsOrdered", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_IteratorExp_m_SortedByIteratorTypeIsComparable: Method = Method(name="SortedByIteratorTypeIsComparable", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_IteratorExp.methods={pivot_IteratorExp_m_ExistsBodyTypeIsBoolean, pivot_IteratorExp_m_AnyBodyTypeIsBoolean, pivot_IteratorExp_m_ClosureBodyTypeIsConformanttoIteratorType, pivot_IteratorExp_m_ClosureHasOneIterator, pivot_IteratorExp_m_CollectNestedHasOneIterator, pivot_IteratorExp_m_ClosureSourceElementTypeIsBodyElementType, pivot_IteratorExp_m_RejectOrSelectTypeIsSourceType, pivot_IteratorExp_m_CollectHasOneIterator, pivot_IteratorExp_m_AnyTypeIsSourceElementType, pivot_IteratorExp_m_ForAllTypeIsBoolean, pivot_IteratorExp_m_IsUniqueTypeIsBoolean, pivot_IteratorExp_m_SortedByElementTypeIsSourceElementType, pivot_IteratorExp_m_SortedByIteratorTypeIsComparable, pivot_IteratorExp_m_CollectNestedTypeIsBodyType, pivot_IteratorExp_m_OneHasOneIterator, pivot_IteratorExp_m_CollectNestedTypeIsBag, pivot_IteratorExp_m_ClosureTypeIsUniqueCollection, pivot_IteratorExp_m_SortedByIsOrderedIfSourceIsOrdered, pivot_IteratorExp_m_ClosureElementTypeIsSourceElementType, pivot_IteratorExp_m_CollectTypeIsUnordered, pivot_IteratorExp_m_ForAllBodyTypeIsBoolean, pivot_IteratorExp_m_CollectElementTypeIsSourceElementType, pivot_IteratorExp_m_OneBodyTypeIsBoolean, pivot_IteratorExp_m_SortedByHasOneIterator, pivot_IteratorExp_m_ExistsTypeIsBoolean, pivot_IteratorExp_m_RejectOrSelectHasOneIterator, pivot_IteratorExp_m_IsUniqueHasOneIterator, pivot_IteratorExp_m_OneTypeIsBoolean, pivot_IteratorExp_m_RejectOrSelectTypeIsBoolean, pivot_IteratorExp_m_AnyHasOneIterator, pivot_IteratorExp_m_IteratorTypeIsSourceElementType}
...
pivot_IntegerLiteralExp_m_TypeIsInteger: Method = Method(name="TypeIsInteger", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_LetExp_m_TypeIsInType: Method = Method(name="TypeIsInType", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_OperationCallExp_m_ArgumentTypeIsConformant: Method = Method(name="ArgumentTypeIsConformant", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_PropertyCallExp_m_CompatibleResultType: Method = Method(name="CompatibleResultType", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_PropertyCallExp_m_NonStaticSourceTypeIsConformant: Method = Method(name="NonStaticSourceTypeIsConformant", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_PropertyCallExp.methods={pivot_PropertyCallExp_m_getSpecializedReferredPropertyOwningType, pivot_PropertyCallExp_m_CompatibleResultType, pivot_PropertyCallExp_m_getSpecializedReferredPropertyType, pivot_PropertyCallExp_m_NonStaticSourceTypeIsConformant}
...
pivot_ValueSpecification.methods={pivot_ValueSpecification_m_isComputable, pivot_ValueSpecification_m_stringValue, pivot_ValueSpecification_m_integerValue, pivot_ValueSpecification_m_isNull, pivot_ValueSpecification_m_booleanValue, pivot_ValueSpecification_m_unlimitedValue}
...
domain_model = DomainModel(
    name="pivot",
    types={pivot_Detail, pivot_Annotation, NamedElement, pivot_Element, pivot_AnyType, Class_, pivot_AssociationClass, pivot_Property, pivot_AssociationClassCallExp, NavigationCallExp, pivot_BagType, CollectionType, pivot_Behavior, pivot_Transition, pivot_BooleanLiteralExp, PrimitiveLiteralExp, pivot_CallExp, OCLExpression, pivot_OCLExpression, pivot_CallOperationAction, pivot_Operation, pivot_Class, Type, Namespace, pivot_Comment, Element, pivot_CollectionItem, CollectionLiteralPart, pivot_CollectionLiteralExp, LiteralExp, pivot_CollectionLiteralPart, TypedElement, pivot_CollectionRange, pivot_CollectionType, DataType, pivot_Type, pivot_ConnectionPointReference, Vertex, pivot_Pseudostate, pivot_State, pivot_Constraint, pivot_DynamicType, DynamicElement, pivot_Namespace, pivot_OpaqueExpression, pivot_ConstructorExp, pivot_ConstructorPart, pivot_DataType, pivot_DynamicElement, pivot_DynamicProperty, pivot_Variable, Visitable, pivot_Feature, TypedMultiplicityElement, pivot_FeatureCallExp, CallExp, pivot_FinalState, State, pivot_ElementExtension, pivot_IfExp, pivot_Stereotype, pivot_EnumLiteralExp, pivot_EnumerationLiteral, pivot_Enumeration, pivot_ExpressionInOCL, OpaqueExpression, pivot_InvalidLiteralExp, pivot_InvalidType, pivot_IterateExp, LoopExp, ReferringElement, pivot_Iteration, Operation, pivot_Parameter, pivot_IteratorExp, pivot_Import, pivot_IntegerLiteralExp, NumericLiteralExp, pivot_LambdaType, pivot_LetExp, pivot_MessageExp, pivot_SendSignalAction, pivot_MessageType, pivot_Signal, pivot_Metaclass, pivot_Library, Package, pivot_Precedence, pivot_LiteralExp, pivot_LoopExp, pivot_NullLiteralExp, pivot_NumericLiteralExp, ValueSpecification, Feature, TemplateableElement, ParameterableElement, pivot_MorePivotable, pivot_Nameable, pivot_NamedElement, Nameable, pivot_NavigationCallExp, FeatureCallExp, pivot_OperationCallExp, pivot_OperationTemplateParameter, TemplateParameter, pivot_OppositePropertyCallExp, pivot_OrderedSetType, pivot_ProfileApplication, pivot_PackageableElement, VariableDeclaration, pivot_ParameterableElement, pivot_TemplateParameter, pivot_Pivotable, pivot_Package, pivot_PrimitiveLiteralExp, pivot_PrimitiveType, pivot_Profile, pivot_PropertyCallExp, pivot_StateMachine, pivot_RealLiteralExp, pivot_ReferringElement, pivot_Region, pivot_Root, pivot_SelfType, pivot_SequenceType, pivot_SetType, pivot_Trigger, pivot_Vertex, pivot_StateExp, Behavior, pivot_TypeExtension, pivot_StringLiteralExp, pivot_TemplateBinding, pivot_TemplateableElement, pivot_TemplateParameterSubstitution, pivot_TemplateSignature, pivot_TemplateParameterType, pivot_TypeExp, pivot_TupleLiteralExp, pivot_TupleLiteralPart, pivot_TupleType, pivot_TypedElement, pivot_TypedMultiplicityElement, pivot_TypeTemplateParameter, pivot_UnspecifiedValueExp, pivot_ValueSpecification, pivot_VariableDeclaration, pivot_VariableExp, pivot_UnlimitedNaturalLiteralExp, pivot_UnspecifiedType, pivot_Visitable, pivot_Visitor, pivot_VoidType, AssociativityKind, CollectionKind, PseudostateKind, TransitionKind},
    associations={ownedContent0, ownedDetail1, nestedType12, reference3, unownedAttribute6, referredAssociationClass7, transition8, source9, operation10, ownedBehavior13, item15, part17, first18, last20, elementType23, annotatedElement24, entry26, exit27, state30, ownedProperty56, constrainedElement31, context33, owningState35, redefinedConstraint38, specification40, transition42, part44, initExpression45, referredProperty48, behavioralType50, metaType52, referredProperty54, contextVariable72, parameterVariable74, resultVariable77, extension58, ownedAnnotation60, ownedComment62, condition80, base65, elseExpression82, stereotype66, thenExpression85, referredEnumLiteral67, ownedLiteral68, enumeration69, bodyExpression70, result90, ownedAccumulator92, ownedIterator93, importedNamespace88, contextType96, parameterType98, resultType101, in_104, body110, iterator112, referredIteration115, argument118, calledOperation120, sentSignal123, target125, referredOperation128, referredSignal130, instanceType132, variable106, ownedPrecedence109, navigationSource137, qualifier139, expressionInOCL142, postcondition153, ownedRule134, precedence156, precondition159, raisedException162, redefinedOperation166, argument168, referredOperation170, referredProperty173, bodyExpression145, class_148, ownedParameter151, owningType152, ownedType182, profileApplication184, operation185, owningTemplateParameter186, templateParameter187, importedPackage176, nestedPackage178, nestingPackage180, associationClass194, class_195, defaultExpression198, keys202, application189, appliedProfile191, applyingPackage192, referredProperty218, state220, stateMachine222, opposite205, owningType207, redefinedProperty210, referredProperty213, subsettedProperty216, transition231, imports234, nestedPackage236, signal239, connection242, connectionPoint243, deferrableTrigger245, doActivity247, extendedRegion225, state226, stateMachine228, subvertex230, redefinedState256, region258, stateInvariant260, submachine261, referredState263, connectionPoint265, extendedStateMachine269, region271, submachineState273, entry249, exit252, extensionOfs275, boundElement276, parameterSubstitution277, signature279, signature287, actual289, formal291, ownedActual294, templateBinding297, ownedParameter298, template300, default280, ownedDefault281, ownedParameteredElement284, parameteredElement285, unspecializedElement307, container308, effect310, guard312, source315, target317, trigger319, state322, ownedTemplateSignature302, templateBinding304, extendedBys330, ownedAttribute332, ownedInvariant334, ownedOperation337, package340, superClass343, referredType345, transition324, part326, initExpression327, type352, stereotype347, type348, upperBound356, constrainingType350, initExpression359, representedParameter362, lowerBound354, outgoing370, referredVariable365, container366, incoming368},
    generalizations={gen_pivot_Annotation_NamedElement, gen_pivot_AnyType_Class, gen_pivot_AssociationClass_Class, gen_pivot_AssociationClassCallExp_NavigationCallExp, gen_pivot_BagType_CollectionType, gen_pivot_Behavior_Class, gen_pivot_BooleanLiteralExp_PrimitiveLiteralExp, gen_pivot_CallExp_OCLExpression, gen_pivot_CallOperationAction_NamedElement, gen_pivot_Class_Type, gen_pivot_Class_Namespace, gen_pivot_Comment_Element, gen_pivot_CollectionItem_CollectionLiteralPart, gen_pivot_CollectionLiteralExp_LiteralExp, gen_pivot_CollectionLiteralPart_TypedElement, gen_pivot_CollectionRange_CollectionLiteralPart, gen_pivot_CollectionType_DataType, gen_pivot_ConnectionPointReference_Vertex, gen_pivot_Constraint_NamedElement, gen_pivot_DynamicType_Type, gen_pivot_DynamicType_DynamicElement, gen_pivot_ConstructorExp_OCLExpression, gen_pivot_ConstructorPart_TypedElement, gen_pivot_DataType_Class, gen_pivot_Detail_NamedElement, gen_pivot_DynamicElement_Element, gen_pivot_DynamicProperty_Element, gen_pivot_Element_Visitable, gen_pivot_Feature_TypedMultiplicityElement, gen_pivot_FeatureCallExp_CallExp, gen_pivot_FinalState_State, gen_pivot_IfExp_OCLExpression, gen_pivot_ElementExtension_Type, gen_pivot_EnumLiteralExp_LiteralExp, gen_pivot_Enumeration_DataType, gen_pivot_EnumerationLiteral_NamedElement, gen_pivot_ExpressionInOCL_OpaqueExpression, gen_pivot_InvalidLiteralExp_LiteralExp, gen_pivot_InvalidType_Class, gen_pivot_IterateExp_LoopExp, gen_pivot_IterateExp_ReferringElement, gen_pivot_Iteration_Operation, gen_pivot_IteratorExp_LoopExp, gen_pivot_IteratorExp_ReferringElement, gen_pivot_Import_NamedElement, gen_pivot_IntegerLiteralExp_NumericLiteralExp, gen_pivot_LambdaType_DataType, gen_pivot_LetExp_OCLExpression, gen_pivot_MessageExp_OCLExpression, gen_pivot_MessageType_Type, gen_pivot_Metaclass_Class, gen_pivot_Library_Package, gen_pivot_LiteralExp_OCLExpression, gen_pivot_LoopExp_CallExp, gen_pivot_NullLiteralExp_PrimitiveLiteralExp, gen_pivot_NumericLiteralExp_PrimitiveLiteralExp, gen_pivot_OCLExpression_TypedElement, gen_pivot_OpaqueExpression_ValueSpecification, gen_pivot_Operation_Feature, gen_pivot_Operation_Namespace, gen_pivot_Operation_TemplateableElement, gen_pivot_Operation_ParameterableElement, gen_pivot_NamedElement_Element, gen_pivot_NamedElement_Nameable, gen_pivot_Namespace_NamedElement, gen_pivot_NavigationCallExp_FeatureCallExp, gen_pivot_OperationCallExp_FeatureCallExp, gen_pivot_OperationCallExp_ReferringElement, gen_pivot_OperationTemplateParameter_TemplateParameter, gen_pivot_OppositePropertyCallExp_NavigationCallExp, gen_pivot_OrderedSetType_CollectionType, gen_pivot_PackageableElement_ParameterableElement, gen_pivot_Parameter_TypedMultiplicityElement, gen_pivot_Parameter_VariableDeclaration, gen_pivot_ParameterableElement_Element, gen_pivot_Precedence_NamedElement, gen_pivot_Package_Namespace, gen_pivot_Package_TemplateableElement, gen_pivot_Property_Feature, gen_pivot_Property_ParameterableElement, gen_pivot_PrimitiveLiteralExp_LiteralExp, gen_pivot_PrimitiveType_DataType, gen_pivot_Profile_Package, gen_pivot_ProfileApplication_Element, gen_pivot_PropertyCallExp_NavigationCallExp, gen_pivot_PropertyCallExp_ReferringElement, gen_pivot_Pseudostate_Vertex, gen_pivot_RealLiteralExp_NumericLiteralExp, gen_pivot_Region_Namespace, gen_pivot_Root_Namespace, gen_pivot_SelfType_Class, gen_pivot_SendSignalAction_NamedElement, gen_pivot_SequenceType_CollectionType, gen_pivot_SetType_CollectionType, gen_pivot_Signal_NamedElement, gen_pivot_State_Vertex, gen_pivot_State_Namespace, gen_pivot_StateExp_OCLExpression, gen_pivot_StateMachine_Behavior, gen_pivot_StringLiteralExp_PrimitiveLiteralExp, gen_pivot_TemplateBinding_Element, gen_pivot_Stereotype_Class, gen_pivot_TemplateParameterSubstitution_Element, gen_pivot_TemplateParameterType_Type, gen_pivot_TemplateSignature_Element, gen_pivot_TemplateParameter_Element, gen_pivot_Transition_Namespace, gen_pivot_Trigger_NamedElement, gen_pivot_TemplateableElement_Element, gen_pivot_TypeExp_OCLExpression, gen_pivot_TypeExp_ReferringElement, gen_pivot_TypeExtension_Element, gen_pivot_TupleLiteralExp_LiteralExp, gen_pivot_TupleLiteralPart_VariableDeclaration, gen_pivot_TupleType_DataType, gen_pivot_Type_NamedElement, gen_pivot_Type_TemplateableElement, gen_pivot_Type_ParameterableElement, gen_pivot_TypedElement_NamedElement, gen_pivot_TypeTemplateParameter_TemplateParameter, gen_pivot_UnspecifiedValueExp_OCLExpression, gen_pivot_ValueSpecification_TypedElement, gen_pivot_ValueSpecification_ParameterableElement, gen_pivot_Variable_VariableDeclaration, gen_pivot_TypedMultiplicityElement_TypedElement, gen_pivot_VariableDeclaration_TypedElement, gen_pivot_VariableExp_OCLExpression, gen_pivot_VariableExp_ReferringElement, gen_pivot_UnlimitedNaturalLiteralExp_NumericLiteralExp, gen_pivot_UnspecifiedType_Class, gen_pivot_VoidType_Class, gen_pivot_Vertex_NamedElement},
    metadata=None
)
