...
class pivot_Comment(Element):
    ...
    def __init__(self, body: str, pivot_Comment64: "pivot_Element" = None, pivot_Comment: set["pivot_Element"] = None):
        self.body = body
...
class pivot_State(Vertex, Namespace):
    ...
    def __init__(self, isSubmachineState: str, isComposite: str, isOrthogonal: str, isSimple: str, State: "pivot_ConnectionPointReference" = None, State36: "pivot_Constraint" = None, State221: "pivot_Pseudostate" = None, state: set["pivot_ConnectionPointReference"] = None, state244: set["pivot_Pseudostate"] = None, state246: set["pivot_Trigger"] = None, pivot_State: "pivot_Behavior" = None, State227: "pivot_Region" = None, pivot_State257: "pivot_State" = None, pivot_State255: "pivot_State" = None, state259: set["pivot_Region"] = None, owningState: "pivot_Constraint" = None, submachineState: "pivot_StateMachine" = None, pivot_State264: "pivot_StateExp" = None, State323: "pivot_Trigger" = None, State274: "pivot_StateMachine" = None, pivot_State250: "pivot_Behavior" = None, pivot_State253: "pivot_Behavior" = None):
...
class pivot_Class(Type, Namespace):
    ...
    def __init__(self, isInterface: str, isAbstract: str, isActive: str, pivot_Class: "pivot_Class" = None, pivot_Class11: set["pivot_Class"] = None, pivot_Class14: set["pivot_Behavior"] = None, pivot_Class150: "pivot_Operation" = None, pivot_Class197: "pivot_Property" = None):
...
class pivot_Constraint(NamedElement):
    ...
    def __init__(self, isCallable: str, pivot_Constraint41: "pivot_OpaqueExpression" = None, guard: "pivot_Transition" = None, pivot_Constraint: set["pivot_Element"] = None, pivot_Constraint34: "pivot_Namespace" = None, stateInvariant: "pivot_State" = None, pivot_Constraint39: "pivot_Constraint" = None, pivot_Constraint37: set["pivot_Constraint"] = None, pivot_Constraint155: "pivot_Operation" = None, pivot_Constraint136: "pivot_Namespace" = None, pivot_Constraint161: "pivot_Operation" = None, Constraint: "pivot_State" = None, Constraint314: "pivot_Transition" = None, pivot_Constraint336: "pivot_Type" = None):
    ...
    def UniqueName(self, pivot_context, pivot_diagnostics) :
...
class pivot_TemplateableElement(Element):
    ...
    def __init__(self, TemplateableElement301: "pivot_TemplateSignature" = None, pivot_TemplateableElement: "pivot_TemplateableElement" = None, pivot_TemplateableElement306: "pivot_TemplateableElement" = None, TemplateableElement: "pivot_TemplateBinding" = None, template: "pivot_TemplateSignature" = None, boundElement: set["pivot_TemplateBinding"] = None):
...
class pivot_TypeExtension(Element):
    ...
    def __init__(self, isRequired: str, TypeExtension: "pivot_Stereotype" = None, extensionOfs: "pivot_Stereotype" = None, extendedBys: "pivot_Type" = None, TypeExtension331: "pivot_Type" = None):
        self.isRequired = isRequired
...
class pivot_ParameterableElement(Element):
    ...
    def __init__(self, ownedParameteredElement: "pivot_TemplateParameter" = None, parameteredElement: "pivot_TemplateParameter" = None, pivot_ParameterableElement290: "pivot_TemplateParameterSubstitution" = None, pivot_ParameterableElement296: "pivot_TemplateParameterSubstitution" = None, pivot_ParameterableElement: "pivot_TemplateParameter" = None, pivot_ParameterableElement283: "pivot_TemplateParameter" = None, ParameterableElement: "pivot_TemplateParameter" = None, ParameterableElement286: "pivot_TemplateParameter" = None):
...
class pivot_ProfileApplication(Element):
    ...
    def __init__(self, isStrict: str, ProfileApplication: "pivot_Package" = None, ProfileApplication190: "pivot_Profile" = None, application: "pivot_Profile" = None, profileApplication: "pivot_Package" = None):
...
class pivot_Package(TemplateableElement, Namespace):
    ...
    def __init__(self, nsURI: str, nsPrefix: str, package: set["pivot_Type"] = None, applyingPackage: set["pivot_ProfileApplication"] = None, pivot_Package238: "pivot_Root" = None, pivot_Package: "pivot_Package" = None, pivot_Package175: set["pivot_Package"] = None, Package: "pivot_Package" = None, nestingPackage: set["pivot_Package"] = None, Package181: "pivot_Package" = None, nestedPackage: "pivot_Package" = None, Package193: "pivot_ProfileApplication" = None, Package341: "pivot_Type" = None):
        self.nsURI = nsURI
...
class pivot_Type(TemplateableElement, ParameterableElement, NamedElement):
    ...
    def __init__(self, instanceClassName: str, pivot_Type51: "pivot_DataType" = None, pivot_Type53: "pivot_DynamicElement" = None, pivot_Type: "pivot_CollectionType" = None, pivot_Type133: "pivot_Metaclass" = None, pivot_Type164: "pivot_Operation" = None, Type: "pivot_Operation" = None, Type183: "pivot_Package" = None, pivot_Type97: "pivot_LambdaType" = None, pivot_Type100: "pivot_LambdaType" = None, pivot_Type103: "pivot_LambdaType" = None, Type208: "pivot_Property" = None, pivot_Type353: "pivot_TypedElement" = None, Type349: "pivot_TypeExtension" = None, pivot_Type358: "pivot_UnspecifiedType" = None, pivot_Type351: "pivot_TypeTemplateParameter" = None, pivot_Type355: "pivot_UnspecifiedType" = None, type: set["pivot_TypeExtension"] = None, owningType: set["pivot_Property"] = None, pivot_Type335: set["pivot_Constraint"] = None, owningType338: set["pivot_Operation"] = None, ownedType: "pivot_Package" = None, pivot_Type344: "pivot_Type" = None, pivot_Type342: set["pivot_Type"] = None, pivot_Type346: "pivot_TypeExp" = None):
...
class pivot_Operation(TemplateableElement, Namespace, ParameterableElement, Feature):
    ...
    def UniquePostconditionName(self, pivot_context, pivot_diagnostics) :
    ...
    def CompatibleReturn(self, pivot_context, pivot_diagnostics) :
...
class pivot_MessageExp(OCLExpression):
    ...
    def TargetIsNotACollection(self, pivot_context, pivot_diagnostics) :
...
class pivot_IntegerLiteralExp(NumericLiteralExp):
    ...
    def TypeIsInteger(self, pivot_context, pivot_diagnostics) :
...
class pivot_OperationCallExp(ReferringElement, FeatureCallExp):
    ...
    def ArgumentCount(self, pivot_diagnostics, pivot_context) :
...
class pivot_IteratorExp(ReferringElement, LoopExp):
    ...
    def OneBodyTypeIsBoolean(self, pivot_context, pivot_diagnostics) :
    ...
    def SortedByHasOneIterator(self, pivot_context, pivot_diagnostics) :
    ...
    def CollectNestedTypeIsBodyType(self, pivot_context, pivot_diagnostics) :
    ...
    def SortedByIteratorTypeIsComparable(self, pivot_diagnostics, pivot_context) :
        # TODO: Implement SortedByIteratorTypeIsComparable method
        pass

    def IteratorTypeIsSourceElementType(self, pivot_context, pivot_diagnostics) :
    ...
    def CollectElementTypeIsSourceElementType(self, pivot_diagnostics, pivot_context) :
    ...
    def CollectNestedTypeIsBag(self, pivot_diagnostics, pivot_context) :
...
class pivot_IterateExp(ReferringElement, LoopExp):
    ...
    def OneInitializer(self, pivot_diagnostics, pivot_context) :
...
class pivot_IfExp(OCLExpression):
    ...
    def __init__(self, pivot_IfExp: "pivot_OCLExpression" = None, pivot_IfExp83: "pivot_OCLExpression" = None, pivot_IfExp86: "pivot_OCLExpression" = None):
...
class pivot_LoopExp(CallExp):
    ...
    def SourceIsCollection(self, pivot_context, pivot_diagnostics) :
...
class pivot_Element(Visitable):
    ...
    def __init__(self, pivot_Element: "pivot_Annotation" = None, pivot_Element5: "pivot_Annotation" = None, base: set["pivot_ElementExtension"] = None, pivot_Element61: "pivot_Element" = None, pivot_Element59: set["pivot_Element"] = None, pivot_Element63: set["pivot_Comment"] = None, Element: "pivot_ElementExtension" = None, pivot_Element25: "pivot_Comment" = None, pivot_Element32: "pivot_Constraint" = None):
