...
public class pivot_TemplateParameterSubstitution extends Element {
    ...
    private pivot_ParameterableElement pivot_parameterableelement;
    ...
    public pivot_TemplateParameterSubstitution(
    ) {
        super(
        );
    }
    ...
    public pivot_ParameterableElement getPivot_parameterableelement() {
        return pivot_parameterableelement;
    }

    public void setPivot_parameterableelement(pivot_ParameterableElement pivot_parameterableelement) {
        this.pivot_parameterableelement = pivot_parameterableelement;
    }
