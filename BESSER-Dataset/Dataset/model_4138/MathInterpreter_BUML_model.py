...
mathInterpreter_MathExp = Class(name="mathInterpreter_MathExp")
mathInterpreter_Expression = Class(name="mathInterpreter_Expression")
mathInterpreter_Exp = Class(name="mathInterpreter_Exp")
...
domain_model = DomainModel(
    ...
    types={mathInterpreter_Num, mathInterpreter_MathExp, mathInterpreter_Expression, mathInterpreter_Exp, Expression, mathInterpreter_Plus, mathInterpreter_Minus, mathInterpreter_Multiply, mathInterpreter_Divide},
    associations={exp0, exp2, left4, operator6, right9},
    generalizations={gen_mathInterpreter_Num_Expression, gen_mathInterpreter_Exp_Expression, gen_mathInterpreter_Plus_Expression, gen_mathInterpreter_Minus_Expression, gen_mathInterpreter_Multiply_Expression, gen_mathInterpreter_Divide_Expression},
    metadata=None
)
