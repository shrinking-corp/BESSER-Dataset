...
simplepdl_WorkDefinition.attributes={simplepdl_WorkDefinition_min_time, simplepdl_WorkDefinition_max_time, simplepdl_WorkDefinition_name}
...
domain_model = DomainModel(
    name="simplepdl",
    types={simplepdl_ProcessElement, simplepdl_WorkDefinition, ProcessElement, simplepdl_WorkSequence, simplepdl_RessourceInstance, simplepdl_Process, simplepdl_Guidance, simplepdl_RessourceDefinition, WorkSequenceType},
    associations={processElements0, linksToPredecessors1, linksToSuccessors2, linksToRessources4, predecessor5, successor6, element8, type10, activity11},
