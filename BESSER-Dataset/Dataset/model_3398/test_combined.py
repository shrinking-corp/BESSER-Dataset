...
def test_hyp_statemachine_place_is_not_abstract():
    assert not inspect.isabstract(StateMachine_Place)


def test_hyp_statemachine_place_constructor_exists():
    assert callable(StateMachine_Place.__init__)


def test_hyp_statemachine_place_constructor_args():
...
def test_hyp_statemachine_pntransition_is_not_abstract():
    assert not inspect.isabstract(StateMachine_PNTransition)


def test_hyp_statemachine_pntransition_constructor_exists():
    assert callable(StateMachine_PNTransition.__init__)


def test_hyp_statemachine_pntransition_constructor_args():
    sig = inspect.signature(StateMachine_PNTransition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_statemachine_arc_is_not_abstract():
    assert not inspect.isabstract(StateMachine_Arc)


def test_hyp_statemachine_arc_constructor_exists():
    assert callable(StateMachine_Arc.__init__)


def test_hyp_statemachine_arc_constructor_args():
...
def test_hyp_statemachine_place_tokens_setter(instance):
...
@given(instance=StateMachine_Place_strategy)
def test_hyp_statemachine_place_name_setter(instance):
...
def test_hyp_statemachine_arc_toPlace_setter(instance):
...
@given(instance=StateMachine_Arc_strategy)
def test_hyp_statemachine_arc_weight_setter(instance):
