...
# Classes
StateMachine_Arc = Class(name="StateMachine_Arc")
StateMachine_PNTransition = Class(name="StateMachine_PNTransition")
StateMachine_Place = Class(name="StateMachine_Place")
...
StateMachine_Arc.attributes={StateMachine_Arc_weight, StateMachine_Arc_toPlace}
