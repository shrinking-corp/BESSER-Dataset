...
domain_model = DomainModel(
    name="database",
    types={database_DataBaseElement, database_Table, database_Column, database_ForeignKey, database_Schema, DataBaseElement, RailsData},
    associations={tables0, columns1, primaryKey3, foreignKeys6, column8, reference11},
    generalizations={gen_database_Table_DataBaseElement, gen_database_Column_DataBaseElement, gen_database_Schema_DataBaseElement},
    metadata=None
)
