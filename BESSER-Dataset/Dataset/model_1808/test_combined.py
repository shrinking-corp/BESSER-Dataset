...
def test_hyp_hierarchy_book_is_not_abstract():
    assert not inspect.isabstract(hierarchy_Book)


def test_hyp_hierarchy_book_constructor_exists():
    assert callable(hierarchy_Book.__init__)


def test_hyp_hierarchy_book_constructor_args():
...
def test_hyp_hierarchy_nonfiction_is_not_abstract():
    assert not inspect.isabstract(hierarchy_NonFiction)


def test_hyp_hierarchy_nonfiction_constructor_exists():
    assert callable(hierarchy_NonFiction.__init__)


def test_hyp_hierarchy_nonfiction_constructor_args():
...
def test_hyp_hierarchy_fiction_is_not_abstract():
    assert not inspect.isabstract(hierarchy_Fiction)


def test_hyp_hierarchy_fiction_constructor_exists():
    assert callable(hierarchy_Fiction.__init__)


def test_hyp_hierarchy_fiction_constructor_args():
...
def test_hyp_hierarchy_hierlibrary_is_not_abstract():
    assert not inspect.isabstract(hierarchy_HierLibrary)


def test_hyp_hierarchy_hierlibrary_constructor_exists():
    assert callable(hierarchy_HierLibrary.__init__)


def test_hyp_hierarchy_hierlibrary_constructor_args():
...
def test_hyp_hierarchy_book_genre_setter(instance):
...
@given(instance=hierarchy_Book_strategy)
def test_hyp_hierarchy_book_Name_setter(instance):
...
def test_hyp_hierarchy_nonfiction_Name_setter(instance):
    original = instance.Name
    instance.Name = original
    assert instance.Name == original
...
def test_hyp_hierarchy_fiction_Name_setter(instance):
    original = instance.Name
    instance.Name = original
    assert instance.Name == original
...
def test_hyp_hierarchy_hierlibrary_Name_setter(instance):
    original = instance.Name
    instance.Name = original
    assert instance.Name == original
