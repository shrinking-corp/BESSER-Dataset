...
# Classes
hierarchy_HierLibrary = Class(name="hierarchy_HierLibrary")
hierarchy_Fiction = Class(name="hierarchy_Fiction")
hierarchy_NonFiction = Class(name="hierarchy_NonFiction")
hierarchy_Book = Class(name="hierarchy_Book")
...
hierarchy_Book.attributes={hierarchy_Book_Name, hierarchy_Book_genre}
...
domain_model = DomainModel(
    ...
    associations={fiction0, nonfiction1, members3, members5},
    generalizations={},
    metadata=None
)
