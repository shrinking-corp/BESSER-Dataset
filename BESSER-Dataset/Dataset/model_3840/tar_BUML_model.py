...
# Classes
target_Table = Class(name="target_Table")
target_FKey = Class(name="target_FKey")
target_Column = Class(name="target_Column")
target_Database = Class(name="target_Database")
...
domain_model = DomainModel(
    ...
    associations={fkeys0, pkey1, cols3, fcols6, references9, table12},
    generalizations={},
    metadata=None
)
