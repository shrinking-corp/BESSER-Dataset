...
Order.attributes={Order_number, Order_shipped, Order_total, Order_status, Order_ordered, Order_shipTo}
...
domain_model = DomainModel(
    name="_7e089161_277f_44c5_9105_34c09610f088",
    types={Customer, Payment, ShoppingCart, Account, WebUser, Order, LineItem, Product, UserState, OrderStatus},
    associations={WebUser_ShoppingCart, WebUser_Customer, Customer_Account, Account_ShoppingCart, ShoppingCart_LineItem, Product_LineItem, Order_LineItem, Account_Order, Account_Payment, Payment_Order},
    generalizations={},
    metadata=None
)
