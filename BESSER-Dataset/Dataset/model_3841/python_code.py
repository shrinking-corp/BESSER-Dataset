...
class target_Column:
    ...
    def __init__(self, type: str, name: str, target_Column5: "target_Table" = None, target_Column8: "target_FKey" = None, target_Column: "target_Table" = None):
        self.type = type
        self.name = name
...
class target_Table:
    ...
    def __init__(self, name: str, target_Table4: set["target_Column"] = None, target_Table13: "target_Database" = None, target_Table11: "target_FKey" = None, target_Table: set["target_FKey"] = None, target_Table2: "target_Column" = None):
        self.name = name
