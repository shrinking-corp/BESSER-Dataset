...
def test_webapp_routerbinding_has_requestURL():
    assert hasattr(webapp_RouterBinding, "requestURL")
    descriptor = None
...
def test_webapp_routerbinding_has_requestCookies():
    assert hasattr(webapp_RouterBinding, "requestCookies")
    descriptor = None
    for klass in webapp_RouterBinding.__mro__:
...
def test_webapp_style_is_not_abstract():
    assert not inspect.isabstract(webapp_Style)


def test_webapp_style_constructor_exists():
    assert callable(webapp_Style.__init__)


def test_webapp_style_constructor_args():
    sig = inspect.signature(webapp_Style.__init__)
    params = list(sig.parameters.keys())
    assert "src" in params, "Missing parameter 'src'"
    assert "href" in params, "Missing parameter 'href'"

def test_webapp_style_has_src():
    assert hasattr(webapp_Style, "src")
    descriptor = None
    for klass in webapp_Style.__mro__:
        if "src" in klass.__dict__:
            descriptor = klass.__dict__["src"]
            break
    assert isinstance(descriptor, property)

def test_webapp_style_has_href():
    assert hasattr(webapp_Style, "href")
    descriptor = None
    for klass in webapp_Style.__mro__:
...
@given(instance=webapp_RouterBinding_strategy)
def test_webapp_routerbinding_requestURL_setter(instance):
...
@given(instance=webapp_RouterBinding_strategy)
def test_webapp_routerbinding_requestCookies_setter(instance):
...
@given(instance=webapp_Style_strategy)
def test_webapp_style_src_setter(instance):
...
@given(instance=webapp_Style_strategy)
def test_webapp_style_href_setter(instance):
