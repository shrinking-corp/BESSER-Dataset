...
class webapp_Attribute(NamedElement):
    ...
    def __init__(self, baseType: str, customType: str, webapp_Attribute: "webapp_Model" = None, webapp_Attribute26: "webapp_View" = None, webapp_Attribute37: "webapp_Controller" = None):
...
class webapp_Template(NamedElement):
    ...
    def __init__(self, structure: str, webapp_Template23: "webapp_View" = None, webapp_Template: "webapp_WebApp" = None, webapp_Template30: "webapp_Style" = None):
