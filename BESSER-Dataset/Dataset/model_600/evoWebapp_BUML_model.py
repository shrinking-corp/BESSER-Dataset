...
webapp_Controller = Class(name="webapp_Controller", is_abstract=True)
webapp_Template = Class(name="webapp_Template")
webapp_View = Class(name="webapp_View")
webapp_Style = Class(name="webapp_Style")
Data = Class(name="Data")
webapp_Attribute = Class(name="webapp_Attribute")
webapp_Data = Class(name="webapp_Data")
...
webapp_PageController = Class(name="webapp_PageController")
Controller = Class(name="Controller")
webapp_ServiceController = Class(name="webapp_ServiceController")
webapp_RouterBinding = Class(name="webapp_RouterBinding")
...
webapp_Style.attributes={webapp_Style_href, webapp_Style_src}
...
domain_model = DomainModel(
    name="webapp",
    types={webapp_NamedElement, webapp_Controller, webapp_Template, webapp_View, webapp_Style, Data, webapp_Attribute, webapp_Data, webapp_WebApp, NamedElement, webapp_Collection, webapp_Router, webapp_Model, webapp_PageController, Controller, webapp_ServiceController, webapp_RouterBinding, DataType},
    associations={models3, controllers5, templates7, views9, styles11, attributes13, model15, subviews19, template21, data24, collections0, router1, parameters35, page38, bindings27, style29, controller32},
    generalizations={gen_webapp_Model_Data, gen_webapp_Collection_Data, gen_webapp_Data_NamedElement, gen_webapp_View_NamedElement, gen_webapp_WebApp_NamedElement, gen_webapp_PageController_Controller, gen_webapp_ServiceController_Controller, gen_webapp_Style_NamedElement, gen_webapp_Attribute_NamedElement, gen_webapp_Template_NamedElement, gen_webapp_Controller_NamedElement},
    metadata=None
)
