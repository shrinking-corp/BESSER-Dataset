...
class PetriNet_Arc:
    ...
    def __init__(self, weight: int, kind: str, Arc: "PetriNet_PetriNet" = None, incomings: "PetriNet_Node" = None, outgoings: "PetriNet_Node" = None, arcs: "PetriNet_PetriNet" = None, Arc5: "PetriNet_Node" = None, Arc7: "PetriNet_Node" = None):
        self.weight = weight
        self.kind = kind
        self.Arc = Arc
...
class PetriNet_Node(ABC):
    ...
    def __init__(self, name: str, Node: "PetriNet_PetriNet" = None, Node9: "PetriNet_Arc" = None, Node11: "PetriNet_Arc" = None, nodes: "PetriNet_PetriNet" = None, source: set["PetriNet_Arc"] = None, target: set["PetriNet_Arc"] = None):
        self.name = name
        self.Node = Node
        self.Node9 = Node9
        self.Node11 = Node11
...
class PetriNet_PetriNet:
    ...
    def __init__(self, name: str, net: set["PetriNet_Node"] = None, net2: set["PetriNet_Arc"] = None, PetriNet13: "PetriNet_Arc" = None, PetriNet: "PetriNet_Node" = None):
        self.name = name
