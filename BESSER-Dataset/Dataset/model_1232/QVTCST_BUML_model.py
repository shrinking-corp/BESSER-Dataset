...
# Classes
qvt_cst_ErrorNode = Class(name="qvt_cst_ErrorNode")
qvt_cst_IdentifiedCS = Class(name="qvt_cst_IdentifiedCS")
cst_CSTNode = Class(name="cst_CSTNode")
cst_IHasName = Class(name="cst_IHasName")
IdentifierCS = Class(name="IdentifierCS")
cst_qvt_EObject = Class(name="cst_qvt_EObject")
qvt_cst_IdentifierCS = Class(name="qvt_cst_IdentifierCS")
qvt_cst_IHasName = Class(name="qvt_cst_IHasName", is_abstract=True)
