...
class graphEditor_Message(GraphElement):
    ...
    def __init__(self, count: int, type: str, graphEditor_Message6: "graphEditor_Node" = None, graphEditor_Message9: "graphEditor_Node" = None, graphEditor_Message: "graphEditor_Graph" = None):
        self.count = count
        self.type = type
...
class graphEditor_Node(GraphElement):
    ...
    def __init__(self, name: str, graphEditor_Node7: "graphEditor_Message" = None, graphEditor_Node10: "graphEditor_Message" = None, graphEditor_Node13: "graphEditor_Edge" = None, graphEditor_Node16: "graphEditor_Edge" = None, graphEditor_Node: "graphEditor_Graph" = None):
        self.name = name
...
class graphEditor_Graph:
    ...
    def getGraphElement(self, graphEditor_id) :
        # TODO: Implement getGraphElement method
        pass

    def getConnectingVariablenodes(self, graphEditor_node) :
