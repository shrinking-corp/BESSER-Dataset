...
# Classes
taskDSL_Action = Class(name="taskDSL_Action")
taskDSL_Detector = Class(name="taskDSL_Detector")
taskDSL_DSL = Class(name="taskDSL_DSL")
taskDSL_Mission = Class(name="taskDSL_Mission")
taskDSL_Task = Class(name="taskDSL_Task")
taskDSL_Avoid = Class(name="taskDSL_Avoid")
taskDSL_DriveUntil = Class(name="taskDSL_DriveUntil")
Action = Class(name="Action")
taskDSL_Investigate = Class(name="taskDSL_Investigate")
taskDSL_Speak = Class(name="taskDSL_Speak")
taskDSL_FollowLine = Class(name="taskDSL_FollowLine")
taskDSL_DriveAction = Class(name="taskDSL_DriveAction")
taskDSL_MoveBack = Class(name="taskDSL_MoveBack")
DriveAction = Class(name="DriveAction")
taskDSL_TurnLeft = Class(name="taskDSL_TurnLeft")
taskDSL_TurnRight = Class(name="taskDSL_TurnRight")
...
taskDSL_DriveUntil.attributes={taskDSL_DriveUntil_color, taskDSL_DriveUntil_speed, taskDSL_DriveUntil_object}
...
domain_model = DomainModel(
    name="taskDSL",
    types={taskDSL_Action, taskDSL_Detector, taskDSL_DSL, taskDSL_Mission, taskDSL_Task, taskDSL_Avoid, taskDSL_DriveUntil, Action, taskDSL_Investigate, taskDSL_Speak, taskDSL_FollowLine, taskDSL_DriveAction, taskDSL_MoveBack, DriveAction, taskDSL_TurnLeft, taskDSL_TurnRight, Object, Speed, Color},
    associations={tasks3, action6, detector8, missions0, tasks1, avoiders10, driveActions12},
