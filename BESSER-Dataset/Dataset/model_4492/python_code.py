...
class taskDSL_Task:
    ...
    def __init__(self, name: str, taskDSL_Task5: "taskDSL_Mission" = None, taskDSL_Task7: "taskDSL_Action" = None, taskDSL_Task9: "taskDSL_Detector" = None, taskDSL_Task: "taskDSL_DSL" = None):
        self.name = name
