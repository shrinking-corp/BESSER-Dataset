...
# Classes
xDrone_Program = Class(name="xDrone_Program")
xDrone_Main = Class(name="xDrone_Main")
xDrone_Drone = Class(name="xDrone_Drone")
xDrone_Walls = Class(name="xDrone_Walls")
xDrone_Object = Class(name="xDrone_Object")
xDrone_Command = Class(name="xDrone_Command")
SuperCommand = Class(name="SuperCommand")
xDrone_GoTo = Class(name="xDrone_GoTo")
Command = Class(name="Command")
xDrone_Up = Class(name="xDrone_Up")
xDrone_Down = Class(name="xDrone_Down")
xDrone_Left = Class(name="xDrone_Left")
xDrone_Right = Class(name="xDrone_Right")
xDrone_Forward = Class(name="xDrone_Forward")
xDrone_Backward = Class(name="xDrone_Backward")
xDrone_Fly = Class(name="xDrone_Fly")
xDrone_Environment = Class(name="xDrone_Environment")
xDrone_SuperCommand = Class(name="xDrone_SuperCommand")
xDrone_Origin = Class(name="xDrone_Origin")
xDrone_Size = Class(name="xDrone_Size")
xDrone_Color = Class(name="xDrone_Color")
xDrone_Vector = Class(name="xDrone_Vector")
xDrone_FrontWall = Class(name="xDrone_FrontWall")
xDrone_RightWall = Class(name="xDrone_RightWall")
xDrone_BackWall = Class(name="xDrone_BackWall")
xDrone_RotateL = Class(name="xDrone_RotateL")
xDrone_RotateR = Class(name="xDrone_RotateR")
xDrone_Wait = Class(name="xDrone_Wait")
xDrone_Position = Class(name="xDrone_Position")
xDrone_LeftWall = Class(name="xDrone_LeftWall")
xDrone_UpWall = Class(name="xDrone_UpWall")
...
xDrone_Fly.attributes={xDrone_Fly_land, xDrone_Fly_takeoff}
...
xDrone_Vector.attributes={xDrone_Vector_z, xDrone_Vector_y, xDrone_Vector_x}
...
domain_model = DomainModel(
    name="xDrone",
    types={xDrone_Program, xDrone_Main, xDrone_Drone, xDrone_Walls, xDrone_Object, xDrone_Command, SuperCommand, xDrone_GoTo, Command, xDrone_Up, xDrone_Down, xDrone_Left, xDrone_Right, xDrone_Forward, xDrone_Backward, xDrone_Fly, xDrone_Environment, xDrone_SuperCommand, xDrone_Origin, xDrone_Size, xDrone_Color, xDrone_Vector, xDrone_FrontWall, xDrone_RightWall, xDrone_BackWall, xDrone_RotateL, xDrone_RotateR, xDrone_Wait, xDrone_Position, xDrone_LeftWall, xDrone_UpWall},
    associations={main0, drone7, walls9, objects11, fly1, environment3, commands5, origin15, size17, color19, vector21, vector23, vector26, front29, right31, position13, back33, left35, up37},
