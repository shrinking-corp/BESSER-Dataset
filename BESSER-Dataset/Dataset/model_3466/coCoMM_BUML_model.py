...
coCoMM_Feature.attributes={coCoMM_Feature_abstract, coCoMM_Feature_mandatory, coCoMM_Feature_name, coCoMM_Feature_id}
...
coCoMM_Project.attributes={coCoMM_Project_date, coCoMM_Project_name, coCoMM_Project_target}
...
domain_model = DomainModel(
    name="coCoMM",
    types={coCoMM_FeatureModel, coCoMM_Feature, coCoMM_CrossTreeConstraint, coCoMM_TreeConstraint, coCoMM_FeatureAttribute, coCoMM_AttributeTypeElement, coCoMM_FeatureAttributeElement, coCoMM_CTConstraintExpression, coCoMM_CoCo, coCoMM_CrossModelConstraint, coCoMM_SolutionConstraint, coCoMM_Project, coCoMM_Stakeholder, coCoMM_CMConstraintExpression, coCoMM_AttributeType, coCoMM_SelectionStateSC, SolutionConstraint, coCoMM_HardLimitSC, coCoMM_HardLimitDRExpression, coCoMM_OptimizationSC, coCoMM_Config, coCoMM_FiniteDomainSC, coCoMM_FiniteDomainSCValue, TreeConstraintType, DataType, CTConstraintType, CMConstraintType, SCType, SelectionStateSCType, OptimizationSCFunct, ConfigType, HardLimitSCOp, ConfigScenarioType},
    associations={root0, ctConstraints1, treeConstraints3, featureModel5, featureAttributes8, children10, elements15, featureAttributes17, attrType20, elements23, expressions25, featureModels27, cmConstraints29, solutionConstraints31, attributeTypes33, project36, stakeholders38, independentAttrType14, featureModel42, feature44, expressions47, attrType48, attrType51, expressions40, solutionConstraints53, configs56, stakeholder58, features61, features64, expressions68, features70, expressions74, featureAttributes76, feature78, values81},
