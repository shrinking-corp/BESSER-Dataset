...
class c_B:
    ...
    def __init__(self, c: float, y: bool, cc: "c_C" = None, c_B3: set["c_A"] = None, c_B7: "c_B" = None, c_B5: "c_B" = None, B: "c_C" = None, c_B: "c_A" = None):
        self.c = c
        self.y = y
        self.cc = cc
...
class c_A:
    ...
    def __init__(self, x: str, a: str, b: str, c_A4: "c_B" = None, c_A: set["c_B"] = None):
        self.x = x
        self.a = a
        self.b = b
        self.c_A4 = c_A4
