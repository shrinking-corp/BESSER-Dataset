...
class Class_Class(Classifier):
    ...
    def __init__(self, isAbstract: bool, Class: "Class_Attribute" = None, Class_Class: "Class_Class" = None, Class_Class0: set["Class_Class"] = None, owner: set["Class_Attribute"] = None):
...
class Class_Attribute(NamedElt):
    ...
    def __init__(self, multiValued: bool, Class_Attribute: "Class_Classifier" = None, attr: "Class_Class" = None, Attribute: "Class_Class" = None):
