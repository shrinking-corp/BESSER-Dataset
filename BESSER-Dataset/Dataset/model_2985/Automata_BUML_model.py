...
automata_Final = Class(name="automata_Final")
automata_Automata = Class(name="automata_Automata")
automata_Current = Class(name="automata_Current")
automata_Initial = Class(name="automata_Initial")
...
automata_Transition.attributes={automata_Transition_name, automata_Transition_token}
...
domain_model = DomainModel(
    name="automata",
    types={automata_State, automata_Transition, automata_Final, automata_Automata, automata_Current, automata_Initial},
    associations={initial1, states3, transitions5, finals7, source9, target12, current0, state15, state18, state21},
    generalizations={},
    metadata=None
)
