...
# Classes
NQC_GlobalVariable = Class(name="NQC_GlobalVariable")
NQC_Statement = Class(name="NQC_Statement", is_abstract=True)
NQC_LocalVariable = Class(name="NQC_LocalVariable")
NQC_Program = Class(name="NQC_Program")
NQC_Parameter = Class(name="NQC_Parameter")
NQC_Task = Class(name="NQC_Task")
NQC_Function = Class(name="NQC_Function")
NQC_Subroutine = Class(name="NQC_Subroutine")
NQC_Variable = Class(name="NQC_Variable", is_abstract=True)
NQC_ConstantExpression = Class(name="NQC_ConstantExpression", is_abstract=True)
NQC_IntegerConstant = Class(name="NQC_IntegerConstant")
NQC_Label = Class(name="NQC_Label")
NQC_AssignmentStatement = Class(name="NQC_AssignmentStatement")
Statement = Class(name="Statement")
Variable = Class(name="Variable")
NQC_BreakStatement = Class(name="NQC_BreakStatement")
NQC_ContinueStatement = Class(name="NQC_ContinueStatement")
NQC_ControlStructure = Class(name="NQC_ControlStructure", is_abstract=True)
NQC_EmptyStatement = Class(name="NQC_EmptyStatement")
NQC_ReturnStatement = Class(name="NQC_ReturnStatement")
NQC_StartStatement = Class(name="NQC_StartStatement")
NQC_StopStatement = Class(name="NQC_StopStatement")
NQC_DoWhileStatement = Class(name="NQC_DoWhileStatement")
ControlStructure = Class(name="ControlStructure")
NQC_ForStatement = Class(name="NQC_ForStatement")
NQC_VariableExpression = Class(name="NQC_VariableExpression")
NQC_Expression = Class(name="NQC_Expression", is_abstract=True)
NQC_BlockStatement = Class(name="NQC_BlockStatement")
NQC_RepeatStatement = Class(name="NQC_RepeatStatement")
NQC_SwitchStatement = Class(name="NQC_SwitchStatement")
NQC_Case = Class(name="NQC_Case")
NQC_UntilStatement = Class(name="NQC_UntilStatement")
NQC_WhileStatement = Class(name="NQC_WhileStatement")
NQC_GoToStatement = Class(name="NQC_GoToStatement")
NQC_IfStatement = Class(name="NQC_IfStatement")
NQC_BooleanConstant = Class(name="NQC_BooleanConstant")
ConstantExpression = Class(name="ConstantExpression")
NQC_CompoundExpression = Class(name="NQC_CompoundExpression", is_abstract=True)
NQC_BinaryExpression = Class(name="NQC_BinaryExpression")
CompoundExpression = Class(name="CompoundExpression")
NQC_CallStatement = Class(name="NQC_CallStatement", is_abstract=True)
NQC_FunctionCall = Class(name="NQC_FunctionCall")
CallStatement = Class(name="CallStatement")
NQC_SubroutineCall = Class(name="NQC_SubroutineCall")
NQC_ValueExpression = Class(name="NQC_ValueExpression", is_abstract=True)
Expression = Class(name="Expression")
ValueExpression = Class(name="ValueExpression")
NQC_ArrayExpression = Class(name="NQC_ArrayExpression")
...
domain_model = DomainModel(
    name="NQC",
    types={NQC_GlobalVariable, NQC_Statement, NQC_LocalVariable, NQC_Program, NQC_Parameter, NQC_Task, NQC_Function, NQC_Subroutine, NQC_Variable, NQC_ConstantExpression, NQC_IntegerConstant, NQC_Label, NQC_AssignmentStatement, Statement, Variable, NQC_BreakStatement, NQC_ContinueStatement, NQC_ControlStructure, NQC_EmptyStatement, NQC_ReturnStatement, NQC_StartStatement, NQC_StopStatement, NQC_DoWhileStatement, ControlStructure, NQC_ForStatement, NQC_VariableExpression, NQC_Expression, NQC_BlockStatement, NQC_RepeatStatement, NQC_SwitchStatement, NQC_Case, NQC_UntilStatement, NQC_WhileStatement, NQC_GoToStatement, NQC_IfStatement, NQC_BooleanConstant, ConstantExpression, NQC_CompoundExpression, NQC_BinaryExpression, CompoundExpression, NQC_CallStatement, NQC_FunctionCall, CallStatement, NQC_SubroutineCall, NQC_ValueExpression, Expression, ValueExpression, NQC_ArrayExpression, VariableExpression, TypeEnum, BinaryOperatorEnum, AssignmentStatementEnum},
    associations={GlobalVariables5, Statements7, LocalVariables9, Statements11, LocalVariables14, Parameters17, Tasks0, Functions1, Subroutines3, InitialValue25, ArrayMaxSize26, Label28, Statements19, LocalVariables22, Statements35, Task38, Task40, Body42, Condition44, Initialization47, Condition49, Update52, Variable30, Expression31, LocalVariables33, Alternative62, Condition65, Body67, Condition70, Cases72, Condition74, Body76, Condition79, Body81, Label84, JumpLabel55, Condition57, Consequence59, index93, Operand195, Operand297, Callee100, Parameters102, Statements87, Variable90, Callee105},
    generalizations={gen_NQC_LocalVariable_Variable, gen_NQC_GlobalVariable_Variable, gen_NQC_AssignmentStatement_Statement, gen_NQC_Parameter_Variable, gen_NQC_BreakStatement_Statement, gen_NQC_ContinueStatement_Statement, gen_NQC_ControlStructure_Statement, gen_NQC_EmptyStatement_Statement, gen_NQC_Expression_Statement, gen_NQC_ReturnStatement_Statement, gen_NQC_StartStatement_Statement, gen_NQC_StopStatement_Statement, gen_NQC_DoWhileStatement_ControlStructure, gen_NQC_ForStatement_ControlStructure, gen_NQC_BlockStatement_Statement, gen_NQC_RepeatStatement_ControlStructure, gen_NQC_SwitchStatement_ControlStructure, gen_NQC_UntilStatement_ControlStructure, gen_NQC_WhileStatement_ControlStructure, gen_NQC_GoToStatement_ControlStructure, gen_NQC_IfStatement_ControlStructure, gen_NQC_ConstantExpression_ValueExpression, gen_NQC_BooleanConstant_ConstantExpression, gen_NQC_IntegerConstant_ConstantExpression, gen_NQC_CompoundExpression_Expression, gen_NQC_BinaryExpression_CompoundExpression, gen_NQC_CallStatement_Statement, gen_NQC_FunctionCall_CallStatement, gen_NQC_SubroutineCall_CallStatement, gen_NQC_ValueExpression_Expression, gen_NQC_VariableExpression_ValueExpression, gen_NQC_ArrayExpression_VariableExpression},
    metadata=None
)
