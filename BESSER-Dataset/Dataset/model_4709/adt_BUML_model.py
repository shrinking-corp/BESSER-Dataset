...
# Classes
adt_ASort = Class(name="adt_ASort", is_abstract=True)
adt_ADT = Class(name="adt_ADT")
adt_Signature = Class(name="adt_Signature")
adt_VariableDeclaration = Class(name="adt_VariableDeclaration")
adt_Equation = Class(name="adt_Equation")
adt_SubSort = Class(name="adt_SubSort")
ASort = Class(name="ASort")
adt_Sort = Class(name="adt_Sort")
adt_Operation = Class(name="adt_Operation")
adt_ATerm = Class(name="adt_ATerm", is_abstract=True)
adt_Term = Class(name="adt_Term")
ATerm = Class(name="ATerm")
adt_Variable = Class(name="adt_Variable")

# adt_ASort class attributes and methods
adt_ASort_name: Property = Property(name="name", type=StringType)
adt_ASort_m_isSubSortOf: Method = Method(name="isSubSortOf", parameters={Parameter(name='adt_sort', type=StringType)}, type=BooleanType)
...
domain_model = DomainModel(
    name="adt",
    types={adt_ASort, adt_ADT, adt_Signature, adt_VariableDeclaration, adt_Equation, adt_SubSort, ASort, adt_Sort, adt_Operation, adt_ATerm, adt_Term, ATerm, adt_Variable},
    associations={signature0, variables1, equations3, superSort5, allOperations6, sorts8, operations11, generators14, declaration36, leftHandTerm38, sort17, returnType20, formalParameters23, adt26, sort28, operationSymbol31, subterms33, rightHandTerm41},
