...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={PNML_PNMLDocument, URI, NetElement, PNML_NetElement, IdedElement, PNMLDocument, NetContent, PNML_LocatedElement, PNML_IdedElement, LocatedElement, PNML_URI, LabeledElement, PNML_Name, PNML_NetContentElement, PNML_Arc, NetContentElement, Name, PNML_NetContent, PNML_LabeledElement, Label, PNML_Label, PNML_Place, PNML_Transition},
    associations={xmlns0, nets1, type2, document4, contents5, labeledElement13, net14, netContent16, source19, name6, net8, name10, labels12, target20},
    generalizations={gen_PNML_PNMLDocument_LocatedElement, gen_PNML_NetElement_IdedElement, gen_PNML_IdedElement_LocatedElement, gen_PNML_URI_LocatedElement, gen_PNML_Name_LabeledElement, gen_PNML_NetContentElement_NetContent, gen_PNML_NetContentElement_IdedElement, gen_PNML_Arc_NetContent, gen_PNML_Arc_IdedElement, gen_PNML_NetContent_LocatedElement, gen_PNML_LabeledElement_LocatedElement, gen_PNML_Label_LocatedElement, gen_PNML_Place_NetContentElement, gen_PNML_Transition_NetContentElement},
    metadata=None
)
