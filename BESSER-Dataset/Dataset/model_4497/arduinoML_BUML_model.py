...
domain_model = DomainModel(
    name="arduinoML",
    types={arduinoML_NamedElement, arduinoML_App, NamedElement, arduinoML_Brick, arduinoML_State, arduinoML_Action, arduinoML_Transition, Brick, arduinoML_Actuator, arduinoML_Sensor, Signal},
    associations={bricks0, states1, initial3, actions6, transition8, actuator9, next11, sensor13, state15},
    generalizations={gen_arduinoML_App_NamedElement, gen_arduinoML_Brick_NamedElement, gen_arduinoML_State_NamedElement, gen_arduinoML_Sensor_Brick, gen_arduinoML_Actuator_Brick},
    metadata=None
)
