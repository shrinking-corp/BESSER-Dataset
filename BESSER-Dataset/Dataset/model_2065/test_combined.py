...
def test_assoc_operand233_link_reassign_clear():
    ...
    b1 = activitydiagram_BooleanVariable()
    b2 = activitydiagram_BooleanVariable()
    _safe_set(a, 'activitydiagram_BooleanBinaryExpression34', b1)
    assert _is_linked(a, 'activitydiagram_BooleanBinaryExpression34', b1)
    if hasattr(b1, 'activitydiagram_BooleanVariable35'):
        assert _is_linked(b1, 'activitydiagram_BooleanVariable35', a)
    _safe_set(a, 'activitydiagram_BooleanBinaryExpression34', b2)
    assert _is_linked(a, 'activitydiagram_BooleanBinaryExpression34', b2)
    if hasattr(b1, 'activitydiagram_BooleanVariable35'):
    ...
    _safe_set(a, 'activitydiagram_BooleanBinaryExpression34', None)
    assert not _is_linked(a, 'activitydiagram_BooleanBinaryExpression34', b2)
    if hasattr(b2, 'activitydiagram_BooleanVariable35'):
