...
# Classes
architecture_AnalysedElement = Class(name="architecture_AnalysedElement", is_abstract=True)
architecture_Relationship = Class(name="architecture_Relationship", is_abstract=True)
architecture_Type = Class(name="architecture_Type")
AnalysedElement = Class(name="AnalysedElement")
architecture_ArchitectureFile = Class(name="architecture_ArchitectureFile")
architecture_InheritanceDependency = Class(name="architecture_InheritanceDependency")
Dependency = Class(name="Dependency")
architecture_ReferenceDependency = Class(name="architecture_ReferenceDependency")
architecture_Dependency = Class(name="architecture_Dependency", is_abstract=True)
Relationship = Class(name="Relationship")
architecture_Library = Class(name="architecture_Library")
architecture_RuntimeDependency = Class(name="architecture_RuntimeDependency")
architecture_InjectionDependency = Class(name="architecture_InjectionDependency")
RuntimeDependency = Class(name="RuntimeDependency")
architecture_FieldReferenceDependency = Class(name="architecture_FieldReferenceDependency")
ReferenceDependency = Class(name="ReferenceDependency")
architecture_ImportReferenceDependency = Class(name="architecture_ImportReferenceDependency")
architecture_Project = Class(name="architecture_Project")
architecture_Method = Class(name="architecture_Method")
architecture_ReturnTypeRelationship = Class(name="architecture_ReturnTypeRelationship")
architecture_ParameterRelationship = Class(name="architecture_ParameterRelationship")
architecture_CallRelationship = Class(name="architecture_CallRelationship")
architecture_Field = Class(name="architecture_Field")
architecture_DeclaredType = Class(name="architecture_DeclaredType")
architecture_extension_Pattern = Class(name="architecture_extension_Pattern", is_abstract=True)
architecture_extension_Role = Class(name="architecture_extension_Role", is_abstract=True)
architecture_extension_RelationshipConstraint = Class(name="architecture_extension_RelationshipConstraint", is_abstract=True)
architecture_extension_ExtensionRelationship = Class(name="architecture_extension_ExtensionRelationship")
architecture_extension_RoleRelationship = Class(name="architecture_extension_RoleRelationship")
architecture_extension_PatternRelationship = Class(name="architecture_extension_PatternRelationship")
architecture_extension_Bop = Class(name="architecture_extension_Bop")
...
architecture_AnalysedElement.attributes={architecture_AnalysedElement_properties, architecture_AnalysedElement_idAnalyzedElement, architecture_AnalysedElement_name}
...
architecture_Type.attributes={architecture_Type_source, architecture_Type_binary, architecture_Type_qualifiedName}
...
architecture_extension_RelationshipConstraint_m_check: Method = Method(name="check", parameters={Parameter(name='architecture_relationship', type=StringType)}, type=BooleanType)
...
architecture_extension_PatternRelationship.methods={architecture_extension_PatternRelationship_m_getSource, architecture_extension_PatternRelationship_m_checkConstraint, architecture_extension_PatternRelationship_m_getTarget}
