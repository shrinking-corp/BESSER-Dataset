...
class architecture_extension_RelationshipConstraint(ABC):
    ...
    def __init__(self):
        ...
        pass
    def check(self, architecture_relationship) :
...
class architecture_AnalysedElement(ABC):
    ...
    def __init__(self, name: str, idAnalyzedElement: int, properties: int, source: set["architecture_Relationship"] = None, target: set["architecture_Relationship"] = None, AnalysedElement7: "architecture_AnalysedElement" = None, containedElements: "architecture_AnalysedElement" = None, AnalysedElement9: "architecture_Relationship" = None, AnalysedElement11: "architecture_Relationship" = None, architecture_AnalysedElement: "architecture_InjectionDependency" = None, AnalysedElement: "architecture_AnalysedElement" = None, parent: set["architecture_AnalysedElement"] = None):
        self.name = name
