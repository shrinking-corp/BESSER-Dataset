...
public class Leave  {
    ...
    public Leave(
        String Leave_detail,        LocalDate Leave_ApplyDate,        LocalDate Leave_StartDate,        LocalDate Leave_EndDate,        int leave_id,        int Leave_NoOfDays,        String Leave_Status,        int Emp_Id,        String Leave_Title    ) {
