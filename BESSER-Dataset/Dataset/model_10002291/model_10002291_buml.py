...
Employee.attributes={Employee_Emp_Address, Employee_Emp_Department, Employee_Emp_Position, Employee_Emp_Id, Employee_Emp_Email, Employee_Emp_NIC, Employee_Emp_Date_Of_Joint, Employee_Emp_ContactNo, Employee_Emp_Name, Employee_Emp_DOB, Employee_Emp_Salary}
...
Salary.attributes={Salary_Sly_Basic, Salary_Sly_Decrement, Salary_Sly_Increment, Salary_OverTime, Salary_Emp_Id, Salary_Sly_Netgross}
...
Leave.attributes={Leave_Leave_Status, Leave_Leave_EndDate, Leave_Leave_StartDate, Leave_Leave_detail, Leave_Leave_ApplyDate, Leave_leave_id, Leave_Leave_NoOfDays, Leave_Leave_Title, Leave_Emp_Id}
...
domain_model = DomainModel(
    name="a43d1eb9_933c_4176_8703_2111ed145ebb",
    types={Login, Employee_Management_System_Component, Authentication_UseCase, Salary_Management_UseCase, Administrator_Actor, Employee_Actor, Employee, Salary, Authenticate_staff, Leave, Attendance, Login_external, Logout_external},
