...
state_Constraint = Class(name="state_Constraint")
Vertex = Class(name="Vertex")
NamedElement = Class(name="NamedElement")
state_Region = Class(name="state_Region")
state_Trigger = Class(name="state_Trigger")
state_Behaviour = Class(name="state_Behaviour")
state_Vertex = Class(name="state_Vertex", is_abstract=True)
state_StateMachine = Class(name="state_StateMachine")
state_Transition = Class(name="state_Transition")
state_NamedElement = Class(name="state_NamedElement", is_abstract=True)
state_FinalState = Class(name="state_FinalState")
State = Class(name="State")
state_OpaqueExpression = Class(name="state_OpaqueExpression")
state_Event = Class(name="state_Event")
state_StateModel = Class(name="state_StateModel")
state_PseudoState = Class(name="state_PseudoState")
...
state_NamedElement.attributes={state_NamedElement_name, state_NamedElement_id}
...
domain_model = DomainModel(
    name="state",
    types={state_State, state_Constraint, Vertex, NamedElement, state_Region, state_Trigger, state_Behaviour, state_Vertex, state_StateMachine, state_Transition, state_NamedElement, state_FinalState, State, state_OpaqueExpression, state_Event, state_StateModel, state_PseudoState, PseudoStateKind, TransitionKind},
    associations={source26, target27, trigger29, guard32, region0, defferableTrigger1, doActivity3, entry5, exit8, state11, subVertex14, stateMachine16, transition18, region20, outgoing23, incoming24, effect34, specification37, event39, packagedElment41},
    generalizations={gen_state_State_Vertex, gen_state_State_NamedElement, gen_state_Region_NamedElement, gen_state_StateMachine_NamedElement, gen_state_Vertex_NamedElement, gen_state_Transition_NamedElement, gen_state_FinalState_State, gen_state_Trigger_NamedElement, gen_state_PseudoState_Vertex},
    metadata=None
)
