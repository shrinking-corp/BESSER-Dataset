...
def test_UML2_Property_aggregation_value_roundtrip():
    instance = UML2_Property(aggregation="sample_text", isComposite=True)
...
UML2_Property_strategy = st.builds(UML2_Property, aggregation=safe_text, isComposite=st.booleans())
@given(instance=UML2_Property_strategy)
@settings(max_examples=25)
