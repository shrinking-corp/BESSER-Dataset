...
Services_UseCase = Class(name="Services_UseCase")
Home_UseCase = Class(name="Home_UseCase")
...
Booking_UseCase = Class(name="Booking_UseCase")
Booking_Form_UseCase = Class(name="Booking_Form_UseCase")
Details_in_Database_UseCase = Class(name="Details_in_Database_UseCase")
Email__UseCase = Class(name="Email__UseCase")
Address_UseCase = Class(name="Address_UseCase")
Date_UseCase = Class(name="Date_UseCase")
Team_UseCase = Class(name="Team_UseCase")
About_us_UseCase = Class(name="About_us_UseCase")
Packeges_UseCase = Class(name="Packeges_UseCase")
Name_UseCase = Class(name="Name_UseCase")
Time_UseCase = Class(name="Time_UseCase")
Phone_Number_UseCase = Class(name="Phone_Number_UseCase")
Owner_Actor = Class(name="Owner_Actor")
...
Delivering_Management.attributes={Delivering_Management_client_name, Delivering_Management_client_key, Delivering_Management_deliver_boy_id}
...
# Services_UseCase class attributes and methods

# Home_UseCase class attributes and methods

# Type_of_Payment_UseCase class attributes and methods

# Reciept____Balance_UseCase class attributes and methods

# Booking_UseCase class attributes and methods

# Booking_Form_UseCase class attributes and methods

# Details_in_Database_UseCase class attributes and methods

# Email__UseCase class attributes and methods

# Address_UseCase class attributes and methods

# Date_UseCase class attributes and methods

# Team_UseCase class attributes and methods

# About_us_UseCase class attributes and methods

# Packeges_UseCase class attributes and methods

# Name_UseCase class attributes and methods

# Time_UseCase class attributes and methods

# Phone_Number_UseCase class attributes and methods

# Owner_Actor class attributes and methods
...
Info_Cleaning_Management: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="cleaning_Management22", type=Booking_UseCase, multiplicity=Multiplicity(0, 1)),
...
Deliver_Delivery_Boy_Id: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="delivery_Boy_Id24", type=Date_UseCase, multiplicity=Multiplicity(0, 1)),
        Property(name="deliver25", type=Deliver_Actor, multiplicity=Multiplicity(0, 1))
    }
)
Cleaning_Management_Delivery_Management: BinaryAssociation = BinaryAssociation(
    name="Cleaning_Management_Delivery_Management",
    ends={
        Property(name="delivery_Management26", type=Address_UseCase, multiplicity=Multiplicity(0, 1)),
        Property(name="cleaning_Management27", type=Booking_UseCase, multiplicity=Multiplicity(0, 1))
    }
)
Delivery_Management_Deliver: BinaryAssociation = BinaryAssociation(
    name="Delivery_Management_Deliver",
    ends={
        Property(name="deliver28", type=Deliver_Actor, multiplicity=Multiplicity(0, 1)),
        Property(name="delivery_Management29", type=Address_UseCase, multiplicity=Multiplicity(0, 1))
    }
)
Booking_Details_in_Database: BinaryAssociation = BinaryAssociation(
    name="Booking_Details_in_Database",
    ends={
        Property(name="details_in_Database30", type=Details_in_Database_UseCase, multiplicity=Multiplicity(0, 1)),
        Property(name="booking31", type=Booking_UseCase, multiplicity=Multiplicity(0, 1))
    }
)
Details_in_Database_Owner: BinaryAssociation = BinaryAssociation(
    name="Details_in_Database_Owner",
    ends={
        Property(name="owner32", type=Owner_Actor, multiplicity=Multiplicity(0, 1)),
        Property(name="details_in_Database33", type=Details_in_Database_UseCase, multiplicity=Multiplicity(0, 1))
    }
)

# Domain Model
domain_model = DomainModel(
    name="_41482629_ebfa_436a_9e31_b6a1606868ad",
    types={User, Cleaning_Management, Money_Dispenser, Primary_Info, Payment, Delivering_Management, Administrator, Cleaner, Delivery_Boy, Client_Actor, Cleaner_Actor, Deliver_Actor, Payment_UseCase, Info_UseCase, Services_UseCase, Home_UseCase, Type_of_Payment_UseCase, Reciept____Balance_UseCase, Booking_UseCase, Booking_Form_UseCase, Details_in_Database_UseCase, Email__UseCase, Address_UseCase, Date_UseCase, Team_UseCase, About_us_UseCase, Packeges_UseCase, Name_UseCase, Time_UseCase, Phone_Number_UseCase, Owner_Actor},
    associations={Primary_Info_Payment, Payment_Cleaning_Management, Cleaning_Management_Delivering_Management, User_Primary_Info, User_Payment, User_Cleaning_Management, User_Delivering_Management, Cleaning_Management_Cleaner, Payment_Money_Dispenser, Delivering_Management_Delivery_Boy, Client_Info, Info_Cleaning_Management, Deliver_Delivery_Boy_Id, Cleaning_Management_Delivery_Management, Delivery_Management_Deliver, Booking_Details_in_Database, Details_in_Database_Owner},
    generalizations={},
    metadata=None
)
