...
Customer.attributes={Customer_id, Customer_name, Customer_mailid, Customer_address, Customer_phoneno}
...
Transaction.attributes={Transaction_cashondelivery, Transaction_debitcard, Transaction_creditcard}
...
domain_model = DomainModel(
    name="_96550129_b9d3_4e19_9ded_199f523f908f",
    ...
    associations={CUSTOMER_SUPPORT_AND_FEEDBACK, SELECTS_THE_MODE_OF_PAYMENT_ADMINISTRATOR, PAYS_THE_BILL_ADMINISTRATOR, DELIVERS_THE_PRODUCT_ADMINISTRATOR, MAINTAINS_THE_PRODUCTS_SERVICES_ADMINISTRATOR, SUPPORT_AND_FEEDBACK_ADMINISTRATOR, ORDER_PRODUCT, Customer_Customercare, Warehouse_Shipment, Product_Warehouse, CREATES_THE_WEBSITE_WEB_DEVELOPER, CUSTOMER_VISITS_THE_WEBSITE, CUSTOMER_SELECTS_THE_ITEMS_SERVICE, CUSTOMER_ADDS_ITEMS_SERVICE_TO_CART, CUSTOMER_SELECTS_THE_MODE_OF_PAYMENT, CUSTOMER_PAYS_THE_BILL},
    generalizations={},
    metadata=None
)
