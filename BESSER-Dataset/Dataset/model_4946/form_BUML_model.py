...
# Classes
form_WidgetDependency = Class(name="form_WidgetDependency")
form_Widget = Class(name="form_Widget", is_abstract=True)
form_Validator = Class(name="form_Validator")
form_Expression = Class(name="form_Expression")
form_Validable = Class(name="form_Validable")
form_Column = Class(name="form_Column")
form_Line = Class(name="form_Line")
form_Operation = Class(name="form_Operation")
form_Form = Class(name="form_Form")
ConnectableElement = Class(name="ConnectableElement")
Validable = Class(name="Validable")
form_EStringToStringMapEntry = Class(name="form_EStringToStringMapEntry")
form_WidgetLayoutInfo = Class(name="form_WidgetLayoutInfo")
form_ItemContainer = Class(name="form_ItemContainer", is_abstract=True)
form_Duplicable = Class(name="form_Duplicable", is_abstract=True)
Element = Class(name="Element")
CSSCustomizable = Class(name="CSSCustomizable")
form_ViewForm = Class(name="form_ViewForm")
Form = Class(name="Form")
form_CSSCustomizable = Class(name="form_CSSCustomizable", is_abstract=True)
form_Group = Class(name="form_Group")
Widget = Class(name="Widget")
Duplicable = Class(name="Duplicable")
form_GroupIterator = Class(name="form_GroupIterator")
form_FormField = Class(name="form_FormField", is_abstract=True)
form_MultipleValuatedFormField = Class(name="form_MultipleValuatedFormField", is_abstract=True)
FormField = Class(name="FormField")
form_RadioFormField = Class(name="form_RadioFormField")
form_SelectFormField = Class(name="form_SelectFormField")
form_TextFormField = Class(name="form_TextFormField")
form_TextAreaFormField = Class(name="form_TextAreaFormField")
form_RichTextAreaFormField = Class(name="form_RichTextAreaFormField")
form_FormButton = Class(name="form_FormButton")
form_SubmitFormButton = Class(name="form_SubmitFormButton")
FormButton = Class(name="FormButton")
form_PreviousFormButton = Class(name="form_PreviousFormButton")
form_NextFormButton = Class(name="form_NextFormButton")
form_Info = Class(name="form_Info")
form_TextInfo = Class(name="form_TextInfo")
Info = Class(name="Info")
form_MessageInfo = Class(name="form_MessageInfo")
form_SingleValuatedFormField = Class(name="form_SingleValuatedFormField", is_abstract=True)
form_CheckBoxMultipleFormField = Class(name="form_CheckBoxMultipleFormField")
MultipleValuatedFormField = Class(name="MultipleValuatedFormField")
ItemContainer = Class(name="ItemContainer")
form_ComboFormField = Class(name="form_ComboFormField")
form_DateFormField = Class(name="form_DateFormField")
SingleValuatedFormField = Class(name="SingleValuatedFormField")
form_ListFormField = Class(name="form_ListFormField")
form_PasswordFormField = Class(name="form_PasswordFormField")
form_ImageWidget = Class(name="form_ImageWidget")
form_HiddenWidget = Class(name="form_HiddenWidget")
form_DurationFormField = Class(name="form_DurationFormField")
form_AbstractTable = Class(name="form_AbstractTable", is_abstract=True)
form_CheckBoxSingleFormField = Class(name="form_CheckBoxSingleFormField")
form_FileWidget = Class(name="form_FileWidget")
form_Document = Class(name="form_Document")
form_DynamicTable = Class(name="form_DynamicTable")
form_IFrameWidget = Class(name="form_IFrameWidget")
form_MandatoryFieldsCustomization = Class(name="form_MandatoryFieldsCustomization", is_abstract=True)
form_TableExpression = Class(name="form_TableExpression")
form_Table = Class(name="form_Table")
AbstractTable = Class(name="AbstractTable")
form_HtmlWidget = Class(name="form_HtmlWidget")
form_SuggestBox = Class(name="form_SuggestBox")
...
form_Widget.attributes={form_Widget_displayDependentWidgetOnlyOnEventTriggered, form_Widget_realHtmlAttributes, form_Widget_injectWidgetCondition, form_Widget_version, form_Widget_labelPosition, form_Widget_readOnly, form_Widget_returnTypeModifier, form_Widget_allowHTMLForDisplayLabel, form_Widget_showDisplayLabel, form_Widget_mandatory}
...
form_Validator.attributes={form_Validator_belowField, form_Validator_name, form_Validator_htmlClass, form_Validator_validatorClass}
...
form_Validable.attributes={form_Validable_below, form_Validable_useDefaultValidator}
...
form_Form.attributes={form_Form_showPageLabel, form_Form_nLine, form_Form_version, form_Form_allowHTMLInPageLabel, form_Form_nColumn}
...
form_WidgetLayoutInfo.attributes={form_WidgetLayoutInfo_verticalSpan, form_WidgetLayoutInfo_horizontalSpan, form_WidgetLayoutInfo_column, form_WidgetLayoutInfo_line}
...
form_Duplicable.attributes={form_Duplicable_limitNumberOfDuplication, form_Duplicable_limitMinNumberOfDuplication, form_Duplicable_duplicate}
...
form_DateFormField.attributes={form_DateFormField_displayFormat, form_DateFormField_initialFormat}
...
form_DurationFormField.attributes={form_DurationFormField_min, form_DurationFormField_day, form_DurationFormField_sec, form_DurationFormField_hour}
...
form_AbstractTable.attributes={form_AbstractTable_initializedUsingCells, form_AbstractTable_LastRowIsHeader, form_AbstractTable_firstRowIsHeader, form_AbstractTable_rightColumnIsHeader, form_AbstractTable_useHorizontalHeader, form_AbstractTable_leftColumnIsHeader, form_AbstractTable_useVerticalHeader}
...
form_FileWidget.attributes={form_FileWidget_downloadOnly, form_FileWidget_intialResourceList, form_FileWidget_usePreview, form_FileWidget_inputType, form_FileWidget_downloadType, form_FileWidget_initialResourcePath, form_FileWidget_updateDocument, form_FileWidget_outputDocumentName}
...
form_DynamicTable.attributes={form_DynamicTable_limitMinNumberOfRow, form_DynamicTable_allowAddRemoveRow, form_DynamicTable_limitMaxNumberOfColumn, form_DynamicTable_limitMaxNumberOfRow, form_DynamicTable_limitMinNumberOfColumn, form_DynamicTable_allowAddRemoveColumn}
...
form_Table.attributes={form_Table_usePagination, form_Table_allowSelection, form_Table_selectionModeIsMultiple}
...
form_SuggestBox.attributes={form_SuggestBox_delay, form_SuggestBox_asynchronous, form_SuggestBox_useMaxItems, form_SuggestBox_maxItems}
...
domain_model = DomainModel(
    name="form",
    types={form_WidgetDependency, form_Widget, form_Validator, form_Expression, form_Validable, form_Column, form_Line, form_Operation, form_Form, ConnectableElement, Validable, form_EStringToStringMapEntry, form_WidgetLayoutInfo, form_ItemContainer, form_Duplicable, Element, CSSCustomizable, form_ViewForm, Form, form_CSSCustomizable, form_Group, Widget, Duplicable, form_GroupIterator, form_FormField, form_MultipleValuatedFormField, FormField, form_RadioFormField, form_SelectFormField, form_TextFormField, form_TextAreaFormField, form_RichTextAreaFormField, form_FormButton, form_SubmitFormButton, FormButton, form_PreviousFormButton, form_NextFormButton, form_Info, form_TextInfo, Info, form_MessageInfo, form_SingleValuatedFormField, form_CheckBoxMultipleFormField, MultipleValuatedFormField, ItemContainer, form_ComboFormField, form_DateFormField, SingleValuatedFormField, form_ListFormField, form_PasswordFormField, form_ImageWidget, form_HiddenWidget, form_DurationFormField, form_AbstractTable, form_CheckBoxSingleFormField, form_FileWidget, form_Document, form_DynamicTable, form_IFrameWidget, form_MandatoryFieldsCustomization, form_TableExpression, form_Table, AbstractTable, form_HtmlWidget, form_SuggestBox, EventDependencyType, LabelPosition, FileWidgetDownloadType, FileWidgetInputType},
    associations={widget0, parameter1, displayName2, columns8, lines10, widgets12, pageLabel15, actions18, validators5, stringAttributes7, maxNumberOfDuplication20, minNumberOfDuplication22, displayLabelForAdd25, widgetLayoutInfo39, dependOn41, parentOf44, displayDependentWidgetOnlyAfterFirstEventTriggeredAndCondition47, displayAfterEventDependsOnConditionScript50, tooltipForAdd28, displayLabelForRemove31, tooltipForRemove34, htmlAttributes37, action71, widgets74, columns76, lines79, iterator82, exampleMessage84, defaultExpression86, inputExpression53, afterEventExpression56, tooltip59, helpMessage62, displayLabel65, injectWidgetScript68, actions91, defaultExpressionAfterEvent88, document97, imgPath99, horizontalHeaderExpression102, verticalHeaderExpression104, document93, outputDocumentListExpression94, selectedValues114, minNumberOfColumn117, minNumberOfRow119, maxNumberOfColumn122, maxNumberOfRow125, mandatorySymbol128, mandatoryLabel130, tableExpression107, maxRowForPagination109, columnForInitialSelectionIndex111},
    generalizations={gen_form_Form_ConnectableElement, gen_form_Form_Validable, gen_form_Widget_Element, gen_form_Widget_CSSCustomizable, gen_form_ViewForm_Form, gen_form_Group_Widget, gen_form_Group_Duplicable, gen_form_FormField_Widget, gen_form_FormField_Validable, gen_form_FormField_Duplicable, gen_form_MultipleValuatedFormField_FormField, gen_form_RadioFormField_MultipleValuatedFormField, gen_form_RadioFormField_ItemContainer, gen_form_SelectFormField_MultipleValuatedFormField, gen_form_TextFormField_SingleValuatedFormField, gen_form_TextAreaFormField_SingleValuatedFormField, gen_form_RichTextAreaFormField_SingleValuatedFormField, gen_form_FormButton_Widget, gen_form_SubmitFormButton_FormButton, gen_form_SubmitFormButton_ConnectableElement, gen_form_PreviousFormButton_FormButton, gen_form_NextFormButton_FormButton, gen_form_Info_Widget, gen_form_TextInfo_Info, gen_form_TextInfo_Duplicable, gen_form_MessageInfo_Info, gen_form_SingleValuatedFormField_FormField, gen_form_CheckBoxMultipleFormField_MultipleValuatedFormField, gen_form_CheckBoxMultipleFormField_ItemContainer, gen_form_ComboFormField_MultipleValuatedFormField, gen_form_DateFormField_SingleValuatedFormField, gen_form_ListFormField_MultipleValuatedFormField, gen_form_PasswordFormField_SingleValuatedFormField, gen_form_ImageWidget_Widget, gen_form_ImageWidget_Duplicable, gen_form_HiddenWidget_SingleValuatedFormField, gen_form_HiddenWidget_Duplicable, gen_form_DurationFormField_SingleValuatedFormField, gen_form_DurationFormField_ItemContainer, gen_form_AbstractTable_Widget, gen_form_AbstractTable_Duplicable, gen_form_CheckBoxSingleFormField_SingleValuatedFormField, gen_form_FileWidget_SingleValuatedFormField, gen_form_FileWidget_Duplicable, gen_form_DynamicTable_AbstractTable, gen_form_DynamicTable_SingleValuatedFormField, gen_form_IFrameWidget_Info, gen_form_MandatoryFieldsCustomization_CSSCustomizable, gen_form_Table_AbstractTable, gen_form_Table_MultipleValuatedFormField, gen_form_GroupIterator_Element, gen_form_HtmlWidget_Info, gen_form_SuggestBox_MultipleValuatedFormField},
    metadata=None
)
