...
# Classes
publication101_Skill = Class(name="publication101_Skill")
publication101_Position = Class(name="publication101_Position")
publication101_Collaboration = Class(name="publication101_Collaboration")
publication101_PublicationProcess = Class(name="publication101_PublicationProcess")
Named = Class(name="Named")
publication101_Phase = Class(name="publication101_Phase")
publication101_Researcher = Class(name="publication101_Researcher")
publication101_Write = Class(name="publication101_Write")
publication101_Review = Class(name="publication101_Review")
publication101_Paper = Class(name="publication101_Paper")
publication101_Paragraph = Class(name="publication101_Paragraph")
publication101_Progress = Class(name="publication101_Progress")
publication101_PaperKeyword = Class(name="publication101_PaperKeyword")
Counted = Class(name="Counted")
publication101_ReviewNote = Class(name="publication101_ReviewNote")
Labelled = Class(name="Labelled")
publication101_PublicationStructure = Class(name="publication101_PublicationStructure")
publication101_KnowledgeManager = Class(name="publication101_KnowledgeManager")
publication101_PublicationSystem = Class(name="publication101_PublicationSystem")
publication101_Named = Class(name="publication101_Named", is_abstract=True)
publication101_Counted = Class(name="publication101_Counted", is_abstract=True)
publication101_Labelled = Class(name="publication101_Labelled", is_abstract=True)
publication101_Keyword = Class(name="publication101_Keyword")
...
publication101_PublicationProcess.attributes={publication101_PublicationProcess_minTime, publication101_PublicationProcess_maxTime}
...
publication101_Researcher.attributes={publication101_Researcher_name, publication101_Researcher_forName}
...
domain_model = DomainModel(
    name="publication101",
    types={publication101_Skill, publication101_Position, publication101_Collaboration, publication101_PublicationProcess, Named, publication101_Phase, publication101_Researcher, publication101_Write, publication101_Review, publication101_Paper, publication101_Paragraph, publication101_Progress, publication101_PaperKeyword, Counted, publication101_ReviewNote, Labelled, publication101_PublicationStructure, publication101_KnowledgeManager, publication101_PublicationSystem, publication101_Named, publication101_Counted, publication101_Labelled, publication101_Keyword},
    associations={skills5, res_position7, collaborations9, phases0, writes1, reviews2, res_papers4, paragraph25, reviewNote28, paragraphs11, progress12, authors13, keywords14, citedBy17, reviews19, process21, paper23, parent47, researchers31, papers33, knowledgeMan36, processView38, structuralView40, positions43, kpapers49, allkeywords51, keyword54, col_paper57},
    generalizations={gen_publication101_Paper_Named, gen_publication101_PublicationProcess_Named, gen_publication101_Review_Labelled, gen_publication101_Paragraph_Counted, gen_publication101_Paragraph_Named, gen_publication101_ReviewNote_Named, gen_publication101_Progress_Labelled, gen_publication101_Write_Labelled, gen_publication101_Position_Named, gen_publication101_PublicationStructure_Named, gen_publication101_PublicationSystem_Named, gen_publication101_Keyword_Named, gen_publication101_KnowledgeManager_Named},
    metadata=None
)
