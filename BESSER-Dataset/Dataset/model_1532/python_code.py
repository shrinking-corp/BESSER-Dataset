...
class publication101_Review(Labelled):
    ...
    def __init__(self, date: date, publication101_Review29: "publication101_ReviewNote" = None, publication101_Review: "publication101_Researcher" = None):
        self.date = date
...
class publication101_Write(Labelled):
    ...
    def __init__(self, timeSpent: int, publication101_Write26: "publication101_Paragraph" = None, publication101_Write: "publication101_Researcher" = None):
...
class publication101_Researcher:
    ...
    def __init__(self, name: str, forName: str, authors: set["publication101_Paper"] = None, Researcher: "publication101_Paper" = None, publication101_Researcher32: "publication101_PublicationStructure" = None, publication101_Researcher6: set["publication101_Skill"] = None, publication101_Researcher8: "publication101_Position" = None, publication101_Researcher10: set["publication101_Collaboration"] = None, publication101_Researcher: set["publication101_Write"] = None, publication101_Researcher3: set["publication101_Review"] = None):
        self.name = name
...
class publication101_ReviewNote(Named):
    ...
    def __init__(self, content: str, publication101_ReviewNote30: "publication101_Review" = None, publication101_ReviewNote: "publication101_Paragraph" = None):
...
class publication101_Keyword(Named):
    ...
    def __init__(self, description: str, publication101_Keyword: set["publication101_Paper"] = None, publication101_Keyword53: "publication101_KnowledgeManager" = None, publication101_Keyword56: "publication101_PaperKeyword" = None):
...
class publication101_KnowledgeManager(Named):
    ...
    pass
class publication101_Paragraph(Counted, Named):

    def __init__(self, content: str, publication101_Paragraph27: "publication101_Write" = None, publication101_Paragraph: "publication101_Paper" = None, publication101_Paragraph20: set["publication101_ReviewNote"] = None):
        self.content = content
...
class publication101_PublicationProcess(Named):
    ...
    def __init__(self, minTime: int, maxTime: int, publication101_PublicationProcess22: "publication101_Progress" = None, publication101_PublicationProcess39: "publication101_PublicationSystem" = None, publication101_PublicationProcess: set["publication101_Phase"] = None):
...
class publication101_Collaboration:
    ...
    def __init__(self, ratio: int, publication101_Collaboration58: "publication101_Paper" = None, publication101_Collaboration: "publication101_Researcher" = None):
        self.ratio = ratio
...
class publication101_Position(Named):
    ...
    def __init__(self, description: str, publication101_Position48: "publication101_Position" = None, publication101_Position46: "publication101_Position" = None, publication101_Position45: "publication101_PublicationSystem" = None, publication101_Position: "publication101_Researcher" = None):
        self.description = description
