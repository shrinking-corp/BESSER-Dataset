...
statemachine_FSM = Class(name="statemachine_FSM")
...
domain_model = DomainModel(
    name="statemachine",
    types={statemachine_Initial, State, statemachine_Final, statemachine_FSM, statemachine_State, statemachine_Transition},
    associations={nested7, src9, tar12, states0, transitions1, current3},
