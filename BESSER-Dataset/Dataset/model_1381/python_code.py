...
class statemachine_State:
    ...
    def __init__(self, time: str, statemachine_State6: set["statemachine_State"] = None, statemachine_State8: "statemachine_State" = None, statemachine_State11: "statemachine_Transition" = None, statemachine_State14: "statemachine_Transition" = None, statemachine_State: "statemachine_FSM" = None, statemachine_State5: "statemachine_FSM" = None):
        self.time = time
