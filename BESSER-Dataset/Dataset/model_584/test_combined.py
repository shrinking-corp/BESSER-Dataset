...
def test_hyp_assistantmvc_newopenview_is_not_abstract():
    assert not inspect.isabstract(AssistantMVC_NewOpenView)


def test_hyp_assistantmvc_newopenview_constructor_exists():
    assert callable(AssistantMVC_NewOpenView.__init__)


def test_hyp_assistantmvc_newopenview_constructor_args():
    sig = inspect.signature(AssistantMVC_NewOpenView.__init__)
    params = list(sig.parameters.keys())
...
AssistantMVC_NewOpenView_strategy = st.builds(
    AssistantMVC_NewOpenView,
    style=
        safe_text
)
...
@given(instance=AssistantMVC_NewOpenView_strategy)
def test_hyp_assistantmvc_newopenview_style_setter(instance):
...
def test_AssistantMVC_NewOpenView_style_value_roundtrip():
    instance = AssistantMVC_NewOpenView(style="sample_text")
...
def test_AssistantMVC_NewOpenView_isa_ExamItemView():
    instance = AssistantMVC_NewOpenView(style="sample_text")
    assert isinstance(instance, ExamItemView)
...
AssistantMVC_NewOpenView_strategy = st.builds(AssistantMVC_NewOpenView, style=safe_text)
@given(instance=AssistantMVC_NewOpenView_strategy)
@settings(max_examples=25)
def test_AssistantMVC_NewOpenView_instantiation(instance):
    assert isinstance(instance, AssistantMVC_NewOpenView)
