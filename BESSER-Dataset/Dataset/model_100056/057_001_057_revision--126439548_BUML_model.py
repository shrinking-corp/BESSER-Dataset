...
# Classes
revision_PublicationProcess = Class(name="revision_PublicationProcess")
Named = Class(name="Named")
revision_Researcher = Class(name="revision_Researcher")
revision_PlaceHolderPP = Class(name="revision_PlaceHolderPP")
revision_PublicationPhase = Class(name="revision_PublicationPhase")
revision_Rule = Class(name="revision_Rule")
revision_Sequence = Class(name="revision_Sequence")
revision_PlaceHolderRs = Class(name="revision_PlaceHolderRs")
revision_Paragraph = Class(name="revision_Paragraph")
revision_Progress = Class(name="revision_Progress")
Counted = Class(name="Counted")
revision_PlaceHolderRule = Class(name="revision_PlaceHolderRule")
revision_Write = Class(name="revision_Write")
revision_Review = Class(name="revision_Review")
revision_Paper = Class(name="revision_Paper")
revision_PublicationStructure = Class(name="revision_PublicationStructure")
revision_PublicationSystem = Class(name="revision_PublicationSystem")
revision_ReviewNote = Class(name="revision_ReviewNote")
revision_PlaceHolderRn = Class(name="revision_PlaceHolderRn")
Labelled = Class(name="Labelled")
revision_Named = Class(name="revision_Named", is_abstract=True)
revision_Counted = Class(name="revision_Counted", is_abstract=True)
revision_Labelled = Class(name="revision_Labelled", is_abstract=True)
PlaceHolder = Class(name="PlaceHolder")
revision_PlaceHolder = Class(name="revision_PlaceHolder", is_abstract=True)
...
revision_PublicationProcess.attributes={revision_PublicationProcess_maxTime, revision_PublicationProcess_minTime}
...
revision_Researcher.attributes={revision_Researcher_name, revision_Researcher_forName, revision_Researcher_position}
...
revision_PublicationPhase.attributes={revision_PublicationPhase_maxTime, revision_PublicationPhase_name, revision_PublicationPhase_minTime}
...
revision_Rule.attributes={revision_Rule_text, revision_Rule_key}
...
domain_model = DomainModel(
    name="revision",
    types={revision_PublicationProcess, Named, revision_Researcher, revision_PlaceHolderPP, revision_PublicationPhase, revision_Rule, revision_Sequence, revision_PlaceHolderRs, revision_Paragraph, revision_Progress, Counted, revision_PlaceHolderRule, revision_Write, revision_Review, revision_Paper, revision_PublicationStructure, revision_PublicationSystem, revision_ReviewNote, revision_PlaceHolderRn, Labelled, revision_Named, revision_Counted, revision_Labelled, PlaceHolder, revision_PlaceHolder, SequenceType},
    associations={neededPerson5, rules6, placeholder9, successor11, predecessor14, phases0, publicationRules1, linksToSuccessors3, papers23, placeholder24, paragraphs26, progress27, authors28, placeholder17, phaseParticipation19, writes20, reviews21, reviewNote41, researchers44, papers46, processView49, reviews30, placeholder32, process34, paper36, paragraph38, structuralView51},
    generalizations={gen_revision_PublicationProcess_Named, gen_revision_Paper_Named, gen_revision_Paragraph_Counted, gen_revision_Paragraph_Named, gen_revision_Review_Labelled, gen_revision_PublicationStructure_Named, gen_revision_ReviewNote_Named, gen_revision_Progress_Labelled, gen_revision_Write_Labelled, gen_revision_PlaceHolderRs_PlaceHolder, gen_revision_PlaceHolderRule_PlaceHolder, gen_revision_PlaceHolderRn_PlaceHolder, gen_revision_PlaceHolderPP_PlaceHolder},
    metadata=None
)
