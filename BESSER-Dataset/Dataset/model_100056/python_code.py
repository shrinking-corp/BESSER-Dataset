...
class revision_Sequence:
    ...
    def __init__(self, sequenceType: str, revision_Sequence12: "revision_PublicationPhase" = None, revision_Sequence15: "revision_PublicationPhase" = None, revision_Sequence: "revision_PublicationPhase" = None):
...
class revision_Rule:
    ...
    def __init__(self, text: str, key: str, revision_Rule8: "revision_PublicationPhase" = None, revision_Rule: "revision_PublicationProcess" = None, revision_Rule18: "revision_PlaceHolderRule" = None):
        self.text = text
        self.key = key
...
class revision_PublicationPhase:
    ...
    def __init__(self, maxTime: int, name: str, minTime: int, phaseParticipation: set["revision_Researcher"] = None, revision_PublicationPhase7: set["revision_Rule"] = None, revision_PublicationPhase10: "revision_PlaceHolderPP" = None, revision_PublicationPhase13: "revision_Sequence" = None, revision_PublicationPhase16: "revision_Sequence" = None, revision_PublicationPhase: "revision_PublicationProcess" = None, revision_PublicationPhase4: set["revision_Sequence"] = None, PublicationPhase: "revision_Researcher" = None):
...
class revision_Researcher:
    ...
    def __init__(self, position: str, name: str, forName: str, Researcher: "revision_PublicationPhase" = None, authors: set["revision_Paper"] = None, revision_Researcher25: "revision_PlaceHolderRs" = None, Researcher29: "revision_Paper" = None, neededPerson: set["revision_PublicationPhase"] = None, revision_Researcher: set["revision_Write"] = None, revision_Researcher22: set["revision_Review"] = None, revision_Researcher45: "revision_PublicationStructure" = None):
...
class revision_ReviewNote(Named):
    ...
    def __init__(self, content: str, revision_ReviewNote43: "revision_Review" = None, revision_ReviewNote: "revision_Paragraph" = None, revision_ReviewNote33: "revision_PlaceHolderRn" = None):
...
class revision_Paragraph(Named, Counted):

    def __init__(self, content: str, revision_Paragraph: "revision_Paper" = None, revision_Paragraph31: set["revision_ReviewNote"] = None, revision_Paragraph40: "revision_Write" = None):
        self.content = content
...
class revision_PublicationProcess(Named):
    ...
    def __init__(self, minTime: int, maxTime: int, revision_PublicationProcess: set["revision_PublicationPhase"] = None, revision_PublicationProcess2: set["revision_Rule"] = None, revision_PublicationProcess50: "revision_PublicationSystem" = None, revision_PublicationProcess35: "revision_Progress" = None):
        self.minTime = minTime
        self.maxTime = maxTime
