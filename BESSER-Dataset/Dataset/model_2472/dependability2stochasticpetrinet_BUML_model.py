...
# Classes
dependability2stochasticpetrinet_Dependability2StochasticPetriNetTrace = Class(name="dependability2stochasticpetrinet_Dependability2StochasticPetriNetTrace")
dependability2stochasticpetrinet_Place = Class(name="dependability2stochasticpetrinet_Place")
dependability2stochasticpetrinet_Transition = Class(name="dependability2stochasticpetrinet_Transition")
dependability2stochasticpetrinet_RailwayContainer2PetriNet = Class(name="dependability2stochasticpetrinet_RailwayContainer2PetriNet")
TraceLink = Class(name="TraceLink")
dependability2stochasticpetrinet_PetriNet = Class(name="dependability2stochasticpetrinet_PetriNet")
dependability2stochasticpetrinet_PetriNetModuleTraceLink = Class(name="dependability2stochasticpetrinet_PetriNetModuleTraceLink", is_abstract=True)
dependability2stochasticpetrinet_Node = Class(name="dependability2stochasticpetrinet_Node")
dependability2stochasticpetrinet_Arc = Class(name="dependability2stochasticpetrinet_Arc")
dependability2stochasticpetrinet_RequiredElement2Connection = Class(name="dependability2stochasticpetrinet_RequiredElement2Connection")
dependability2stochasticpetrinet_RailwayContainer = Class(name="dependability2stochasticpetrinet_RailwayContainer")
dependability2stochasticpetrinet_DependabilityModel = Class(name="dependability2stochasticpetrinet_DependabilityModel")
dependability2stochasticpetrinet_TraceLink = Class(name="dependability2stochasticpetrinet_TraceLink", is_abstract=True)
dependability2stochasticpetrinet_ErrorModel2PetriNetModule = Class(name="dependability2stochasticpetrinet_ErrorModel2PetriNetModule")
PetriNetModuleTraceLink = Class(name="PetriNetModuleTraceLink")
dependability2stochasticpetrinet_ErrorModel = Class(name="dependability2stochasticpetrinet_ErrorModel")
...
domain_model = DomainModel(
    ...
    types={dependability2stochasticpetrinet_Dependability2StochasticPetriNetTrace, dependability2stochasticpetrinet_Place, dependability2stochasticpetrinet_Transition, dependability2stochasticpetrinet_RailwayContainer2PetriNet, TraceLink, dependability2stochasticpetrinet_PetriNet, dependability2stochasticpetrinet_PetriNetModuleTraceLink, dependability2stochasticpetrinet_Node, dependability2stochasticpetrinet_Arc, dependability2stochasticpetrinet_RequiredElement2Connection, dependability2stochasticpetrinet_RailwayContainer, dependability2stochasticpetrinet_DependabilityModel, dependability2stochasticpetrinet_TraceLink, dependability2stochasticpetrinet_ErrorModel2PetriNetModule, PetriNetModuleTraceLink, dependability2stochasticpetrinet_ErrorModel},
    associations={up6, down8, repair11, railwayContainer13, petriNet15, nodes17, arcs18, source20, target22, railwayContainer0, dependabilityModel1, traceLinks3, errorModel5},
    generalizations={gen_dependability2stochasticpetrinet_RailwayContainer2PetriNet_TraceLink, gen_dependability2stochasticpetrinet_PetriNetModuleTraceLink_TraceLink, gen_dependability2stochasticpetrinet_RequiredElement2Connection_PetriNetModuleTraceLink, gen_dependability2stochasticpetrinet_ErrorModel2PetriNetModule_PetriNetModuleTraceLink},
    metadata=None
)
