...
class imdb_db:
    ...
    def __init__(self, bestOf2014: str, imdb_db: set["imdb_Person"] = None, imdb_db10: set["imdb_Person"] = None, imdb_db21: set["imdb_User"] = None, imdb_db13: set["imdb_Person"] = None, imdb_db16: set["imdb_Movie"] = None, imdb_db19: set["imdb_StaffList"] = None):
...
class imdb_StaffList:
    ...
    def __init__(self, coverPhoto: str, name: str, elements: str, elementType: str, createdDate: date, imdb_StaffList23: "imdb_User" = None, imdb_StaffList: "imdb_db" = None):
...
class imdb_Movie:
    ...
    def __init__(self, title: str, releaseDate: date, runtime: int, poster: str, rating: float, userReviews: int, criticReviews: int, userRatings: int, synopsis: str, metaScore: int, metacriticReviews: int, genres: str, age: int, imdb_Movie17: "imdb_db" = None, imdb_Movie: "imdb_Person" = None, imdb_Movie2: set["imdb_Person"] = None, imdb_Movie5: set["imdb_Person"] = None):
        self.title = title
