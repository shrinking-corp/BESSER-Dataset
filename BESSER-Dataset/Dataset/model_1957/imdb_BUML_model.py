...
# Classes
imdb_Movie = Class(name="imdb_Movie")
imdb_Person = Class(name="imdb_Person")
imdb_StaffList = Class(name="imdb_StaffList")
imdb_User = Class(name="imdb_User")
imdb_db = Class(name="imdb_db")
...
imdb_Movie.attributes={imdb_Movie_metacriticReviews, imdb_Movie_releaseDate, imdb_Movie_poster, imdb_Movie_runtime, imdb_Movie_title, imdb_Movie_synopsis, imdb_Movie_genres, imdb_Movie_rating, imdb_Movie_userRatings, imdb_Movie_userReviews, imdb_Movie_metaScore, imdb_Movie_age, imdb_Movie_criticReviews}
...
imdb_StaffList.attributes={imdb_StaffList_elements, imdb_StaffList_name, imdb_StaffList_coverPhoto, imdb_StaffList_elementType, imdb_StaffList_createdDate}
...
imdb_User.attributes={imdb_User_watchlist, imdb_User_username}
...
domain_model = DomainModel(
    name="imdb",
    types={imdb_Movie, imdb_Person, imdb_StaffList, imdb_User, imdb_db, Genre, StaffListType},
    associations={allActors12, allMovies15, allStaffLists18, director0, writers1, actors4, allDirectors7, allWriters9, allUsers20, user22},
    generalizations={},
    metadata=None
)
