...
class Book_Chapter:
    ...
    def __init__(self, title: str, nbPages: int, author: str, Book_Chapter4: "Book_Book" = None, Book_Chapter: "Book_Book" = None):
        self.title = title
...
class Book_Book:
    ...
    def __init__(self, title: str, Book_Book5: "Book_Chapter" = None, Book_Book: "Book_Books" = None, Book_Book2: set["Book_Chapter"] = None):
        self.title = title
