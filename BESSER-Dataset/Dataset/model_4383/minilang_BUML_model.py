...
# Classes
minilang_GreaterOrEqual = Class(name="minilang_GreaterOrEqual")
minilang_Less = Class(name="minilang_Less")
minilang_IntExpression = Class(name="minilang_IntExpression")
minilang_Integer = Class(name="minilang_Integer")
IntExpression = Class(name="IntExpression")
minilang_Boolean = Class(name="minilang_Boolean")
BooleanExpression = Class(name="BooleanExpression")
minilang_IntOperation = Class(name="minilang_IntOperation")
minilang_Equal = Class(name="minilang_Equal")
IntComparison = Class(name="IntComparison")
minilang_Greater = Class(name="minilang_Greater")
minilang_If = Class(name="minilang_If")
minilang_LessOrEqual = Class(name="minilang_LessOrEqual")
minilang_Not = Class(name="minilang_Not")
minilang_BooleanExpression = Class(name="minilang_BooleanExpression")
minilang_Or = Class(name="minilang_Or")
BooleanOperation = Class(name="BooleanOperation")
minilang_And = Class(name="minilang_And")
minilang_Plus = Class(name="minilang_Plus")
IntOperation = Class(name="IntOperation")
minilang_Minus = Class(name="minilang_Minus")
minilang_Multiply = Class(name="minilang_Multiply")
minilang_Divide = Class(name="minilang_Divide")
minilang_IntComparison = Class(name="minilang_IntComparison", is_abstract=True)
minilang_BooleanOperation = Class(name="minilang_BooleanOperation")
minilang_BooleanVariableRef = Class(name="minilang_BooleanVariableRef")
VariableRef = Class(name="VariableRef")
minilang_IntVariableRef = Class(name="minilang_IntVariableRef")
minilang_VariableRef = Class(name="minilang_VariableRef")
minilang_Statement = Class(name="minilang_Statement")
minilang_BooleanAssignment = Class(name="minilang_BooleanAssignment")
Statement = Class(name="Statement")
minilang_IntAssignment = Class(name="minilang_IntAssignment")
minilang_PrintVar = Class(name="minilang_PrintVar")
minilang_PrintStr = Class(name="minilang_PrintStr")
minilang_Block = Class(name="minilang_Block")
minilang_While = Class(name="minilang_While")
...
else_29: BinaryAssociation = BinaryAssociation(
    name="else_29",
    ends={
...
domain_model = DomainModel(
    name="minilang",
    types={minilang_GreaterOrEqual, minilang_Less, minilang_IntExpression, minilang_Integer, IntExpression, minilang_Boolean, BooleanExpression, minilang_IntOperation, minilang_Equal, IntComparison, minilang_Greater, minilang_If, minilang_LessOrEqual, minilang_Not, minilang_BooleanExpression, minilang_Or, BooleanOperation, minilang_And, minilang_Plus, IntOperation, minilang_Minus, minilang_Multiply, minilang_Divide, minilang_IntComparison, minilang_BooleanOperation, minilang_BooleanVariableRef, VariableRef, minilang_IntVariableRef, minilang_VariableRef, minilang_Statement, minilang_BooleanAssignment, Statement, minilang_IntAssignment, minilang_PrintVar, minilang_PrintStr, minilang_Block, minilang_While},
    associations={right0, left1, statement23, expression4, right5, left7, left10, right12, variable15, value16, variable19, value20, condition24, then26, else_29, condition32, body34},
    generalizations={gen_minilang_GreaterOrEqual_IntComparison, gen_minilang_Less_IntComparison, gen_minilang_Integer_IntExpression, gen_minilang_Boolean_BooleanExpression, gen_minilang_IntOperation_IntExpression, gen_minilang_Equal_IntComparison, gen_minilang_Greater_IntComparison, gen_minilang_LessOrEqual_IntComparison, gen_minilang_Not_BooleanExpression, gen_minilang_Or_BooleanOperation, gen_minilang_And_BooleanOperation, gen_minilang_Plus_IntOperation, gen_minilang_Minus_IntOperation, gen_minilang_Multiply_IntOperation, gen_minilang_Divide_IntOperation, gen_minilang_IntComparison_BooleanExpression, gen_minilang_BooleanOperation_BooleanExpression, gen_minilang_BooleanVariableRef_VariableRef, gen_minilang_BooleanVariableRef_BooleanExpression, gen_minilang_IntVariableRef_VariableRef, gen_minilang_IntVariableRef_IntExpression, gen_minilang_BooleanAssignment_Statement, gen_minilang_IntAssignment_Statement, gen_minilang_PrintVar_Statement, gen_minilang_PrintStr_Statement},
    metadata=None
)
