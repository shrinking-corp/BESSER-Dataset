...
# Classes
restapp_model_User = Class(name="restapp_model_User")
Employee = Class(name="Employee")
restapp_model_Product = Class(name="restapp_model_Product")
Category = Class(name="Category")
restapp_model_Category = Class(name="restapp_model_Category")
restapp_model_Price = Class(name="restapp_model_Price")
restapp_model_Employee = Class(name="restapp_model_Employee")
User = Class(name="User")
restapp_model_Provider = Class(name="restapp_model_Provider")
restapp_model_ProductsPurchase = Class(name="restapp_model_ProductsPurchase")
Purchase = Class(name="Purchase")
restapp_model_PhysicalCard = Class(name="restapp_model_PhysicalCard")
restapp_model_Card = Class(name="restapp_model_Card")
PhysicalCard = Class(name="PhysicalCard")
restapp_model_ProductsCard = Class(name="restapp_model_ProductsCard")
Product = Class(name="Product")
restapp_model_Purchase = Class(name="restapp_model_Purchase")
...
restapp_model_User.attributes={restapp_model_User_user, restapp_model_User_id, restapp_model_User_password, restapp_model_User_status}
...
restapp_model_Category.attributes={restapp_model_Category_description, restapp_model_Category_status, restapp_model_Category_id, restapp_model_Category_name}
...
restapp_model_Price.attributes={restapp_model_Price_id, restapp_model_Price_date, restapp_model_Price_value}
...
restapp_model_Employee.attributes={restapp_model_Employee_name, restapp_model_Employee_phone, restapp_model_Employee_id, restapp_model_Employee_contracted, restapp_model_Employee_working, restapp_model_Employee_rg, restapp_model_Employee_zipcode, restapp_model_Employee_status, restapp_model_Employee_mobile, restapp_model_Employee_address, restapp_model_Employee_salary, restapp_model_Employee_cpf, restapp_model_Employee_comission, restapp_model_Employee_fired}
...
restapp_model_Provider.attributes={restapp_model_Provider_CNPJ, restapp_model_Provider_contact, restapp_model_Provider_Address, restapp_model_Provider_phone, restapp_model_Provider_name, restapp_model_Provider_id}
...
restapp_model_ProductsPurchase.attributes={restapp_model_ProductsPurchase_quantity, restapp_model_ProductsPurchase_unityDiscount, restapp_model_ProductsPurchase_unityValue, restapp_model_ProductsPurchase_unityValueWithDiscount}
...
restapp_model_Card.attributes={restapp_model_Card_totalValue, restapp_model_Card_payedValue, restapp_model_Card_change, restapp_model_Card_totalValueWithDiscount, restapp_model_Card_sellDate, restapp_model_Card_id, restapp_model_Card_discount}
...
restapp_model_ProductsCard.attributes={restapp_model_ProductsCard_date, restapp_model_ProductsCard_id}
...
restapp_model_Purchase.attributes={restapp_model_Purchase_discount, restapp_model_Purchase_id, restapp_model_Purchase_totalWithDiscount, restapp_model_Purchase_totalValue, restapp_model_Purchase_date}
...
domain_model = DomainModel(
    name="restapp",
    types={restapp_model_User, Employee, restapp_model_Product, Category, restapp_model_Category, restapp_model_Price, restapp_model_Employee, User, restapp_model_Provider, restapp_model_ProductsPurchase, Purchase, restapp_model_PhysicalCard, restapp_model_Card, PhysicalCard, restapp_model_ProductsCard, Product, restapp_model_Purchase, Provider, Card},
    associations={newEReference10, newEReference11, newEReference24, newEReference16, newEReference27, newEReference110, newEReference2, newEReference13, newEReference111, newEReference213, newEReference315},
    generalizations={},
    metadata=None
)
