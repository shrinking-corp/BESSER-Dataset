...
public class Requirement  {
    ...
    public Requirement(
        String requirement_location,        String req_description,        String user_id,        String requirement_type    ) {
    ...
    public Requirement(
        String requirement_location,        String req_description,        String user_id,        String requirement_type        ArrayList<Reg_User> reg_users    ) {
        this.requirement_location = requirement_location;
        this.req_description = req_description;
        this.user_id = user_id;
        this.requirement_type = requirement_type;
