...
class Payment:
    ...
    def __init__(self, pay_id: int, pay_mode: str, ex_date: str, pay_amount: str, card_no: str, reg_User14: set["Reg_User"] = None, property16: set["Property"] = None):
        self.pay_id = pay_id
...
class Property:
    ...
    def __init__(self, property_id: str, property_type: str, address: str, location: str, owner4: "Seller" = None, user8: "Buyer" = None, management12: set["Management"] = None, payment17: "Payment" = None):
        self.property_id = property_id
