...
domain_model = DomainModel(
    name="XPath",
    types={XPath_LocatedElement, XPath_NamedElement, LocatedElement, XPath_Expression, XPath_VariableExp, Expression, NamedElement, XPath_LiteralExp, XPath_IntegerExp, LiteralExp, XPath_StringExp, XPath_OperatorCallExp},
    associations={right1, left0},
    generalizations={gen_XPath_NamedElement_LocatedElement, gen_XPath_Expression_LocatedElement, gen_XPath_VariableExp_Expression, gen_XPath_VariableExp_NamedElement, gen_XPath_LiteralExp_Expression, gen_XPath_IntegerExp_LiteralExp, gen_XPath_StringExp_LiteralExp, gen_XPath_OperatorCallExp_NamedElement, gen_XPath_OperatorCallExp_LocatedElement},
    metadata=None
)
