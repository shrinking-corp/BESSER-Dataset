...
# Classes
coursePages_Person = Class(name="coursePages_Person")
coursePages_EvaluationObject = Class(name="coursePages_EvaluationObject")
coursePages_Evaluations = Class(name="coursePages_Evaluations")
coursePages_Student = Class(name="coursePages_Student")
Person = Class(name="Person")
coursePages_StudyPrograms = Class(name="coursePages_StudyPrograms")
coursePages_Course = Class(name="coursePages_Course")
coursePages_Employee = Class(name="coursePages_Employee")
coursePages_Department = Class(name="coursePages_Department")
coursePages_CourseWorkObject = Class(name="coursePages_CourseWorkObject")
coursePages_CourseWork = Class(name="coursePages_CourseWork")
coursePages_CourseInstance = Class(name="coursePages_CourseInstance")
coursePages_CourseWorker = Class(name="coursePages_CourseWorker")
coursePages_Precondition = Class(name="coursePages_Precondition")
coursePages_Reduction = Class(name="coursePages_Reduction")
...
coursePages_Person.attributes={coursePages_Person_email, coursePages_Person_surName, coursePages_Person_phoneNummber, coursePages_Person_firstName}
...
coursePages_EvaluationObject.attributes={coursePages_EvaluationObject_credits, coursePages_EvaluationObject_term, coursePages_EvaluationObject_date, coursePages_EvaluationObject_evaluationsForm}
...
coursePages_Department.attributes={coursePages_Department_phoneNummber, coursePages_Department_email, coursePages_Department_departmentName}
...
coursePages_CourseWorkObject.attributes={coursePages_CourseWorkObject_start, coursePages_CourseWorkObject_room, coursePages_CourseWorkObject_day, coursePages_CourseWorkObject_end, coursePages_CourseWorkObject_courseWorkType}
...
coursePages_CourseInstance.attributes={coursePages_CourseInstance_term, coursePages_CourseInstance_courseYear}
...
domain_model = DomainModel(
    name="coursePages",
    types={coursePages_Person, coursePages_EvaluationObject, coursePages_Evaluations, coursePages_Student, Person, coursePages_StudyPrograms, coursePages_Course, coursePages_Employee, coursePages_Department, coursePages_CourseWorkObject, coursePages_CourseWork, coursePages_CourseInstance, coursePages_CourseWorker, coursePages_Precondition, coursePages_Reduction, personRoleType, TermType, CourseWorkType, EvaluationType, PrecondistionType},
    associations={student10, course12, evaluationobject14, studyprograms0, course1, department2, employee3, studyprograms4, course6, belongsToDepartment8, employee32, course34, courseworkobject15, courseinstance16, studyprograms18, courseworker20, precondition22, reduction24, coursework26, evaluations29, course37},
    generalizations={gen_coursePages_Student_Person, gen_coursePages_Employee_Person},
    metadata=None
)
