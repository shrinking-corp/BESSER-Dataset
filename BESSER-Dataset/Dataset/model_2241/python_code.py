...
class coursePages_Reduction:
    ...
    def __init__(self, creditReduction: float, coursePages_Reduction: "coursePages_Course" = None, coursePages_Reduction38: "coursePages_Course" = None):
...
class coursePages_Precondition:
    ...
    def __init__(self, preconditionStatus: str, coursePages_Precondition35: "coursePages_Course" = None, coursePages_Precondition: "coursePages_Course" = None):
...
class coursePages_CourseWorker:
    ...
    def __init__(self, courseRole: str, coursePages_CourseWorker33: "coursePages_Employee" = None, coursePages_CourseWorker: "coursePages_Course" = None):
...
class coursePages_CourseInstance:
    ...
    def __init__(self, term: str, courseYear: str, coursePages_CourseInstance: "coursePages_Course" = None, coursePages_CourseInstance27: "coursePages_CourseWork" = None, coursePages_CourseInstance30: "coursePages_Evaluations" = None):
        self.term = term
...
class coursePages_Course:
    ...
    def __init__(self, courseCode: str, courseName: str, courseCredits: float, courseContent: str, Course: "coursePages_StudyPrograms" = None, coursePages_Course: "coursePages_Student" = None, coursePages_Course7: "coursePages_Department" = None, coursePages_Course36: "coursePages_Precondition" = None, coursePages_Course17: set["coursePages_CourseInstance"] = None, course: set["coursePages_StudyPrograms"] = None, coursePages_Course21: set["coursePages_CourseWorker"] = None, coursePages_Course23: set["coursePages_Precondition"] = None, coursePages_Course25: set["coursePages_Reduction"] = None, coursePages_Course39: "coursePages_Reduction" = None):
...
class coursePages_StudyPrograms:
    ...
    def __init__(self, studyProgramCode: str, studyProgramName: str, studyprograms11: set["coursePages_Student"] = None, studyprograms13: set["coursePages_Course"] = None, StudyPrograms: "coursePages_Student" = None, StudyPrograms5: "coursePages_Department" = None, studyprograms: "coursePages_Department" = None, StudyPrograms19: "coursePages_Course" = None):
...
class coursePages_Student(Person):
    ...
    def __init__(self, studentID: str, Student: "coursePages_StudyPrograms" = None, student: "coursePages_StudyPrograms" = None, coursePages_Student: set["coursePages_Course"] = None):
