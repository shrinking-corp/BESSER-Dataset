...
class rdbms_referencedColumns:
    ...
    def __init__(self, group: str, rdbms_referencedColumns45: "rdbms_foreignKey" = None, rdbms_referencedColumns: "rdbms_DocumentRoot" = None, rdbms_referencedColumns54: "rdbms_key" = None, rdbms_referencedColumns62: set["rdbms_oID"] = None):
        self.group = group
...
class rdbms_table:
    ...
    def __init__(self, oID: str, kind: str, name: str, rdbms_table: "rdbms_DocumentRoot" = None, rdbms_table77: "rdbms_columns" = None, rdbms_table80: "rdbms_key2" = None, rdbms_table84: "rdbms_tables" = None):
        self.oID = oID
        self.kind = kind
        self.name = name
...
class rdbms_schema:
    ...
    def __init__(self, kind: str, name: str, oID: str, rdbms_schema: "rdbms_DocumentRoot" = None, rdbms_schema68: "rdbms_tables" = None, rdbms_schema71: "rdbms_foreignKeys" = None, rdbms_schema75: "rdbms_schemas" = None):
        self.kind = kind
        self.name = name
        self.oID = oID
...
class rdbms_key:
    ...
    def __init__(self, kind: str, oID: str, name: str, rdbms_key: "rdbms_DocumentRoot" = None, rdbms_key53: "rdbms_referencedColumns" = None, rdbms_key57: "rdbms_key2" = None):
        self.kind = kind
        self.oID = oID
        self.name = name
...
class rdbms_foreignKey:
    ...
    def __init__(self, kind: str, name: str, refersTo: str, oID: str, owner: str, rdbms_foreignKey: "rdbms_DocumentRoot" = None, rdbms_foreignKey44: "rdbms_referencedColumns" = None, rdbms_foreignKey48: "rdbms_foreignKeys" = None):
        self.kind = kind
        self.name = name
...
class rdbms_DocumentRoot:
    ...
    def __init__(self, mixed: str, rdbms_DocumentRoot16: set["rdbms_foreignKey"] = None, rdbms_DocumentRoot: set["rdbms_EStringToStringMapEntry"] = None, rdbms_DocumentRoot20: set["rdbms_hasForeignKeys"] = None, rdbms_DocumentRoot7: set["rdbms_EStringToStringMapEntry"] = None, rdbms_DocumentRoot10: set["rdbms_column"] = None, rdbms_DocumentRoot13: set["rdbms_columns"] = None, rdbms_DocumentRoot23: set["rdbms_key"] = None, rdbms_DocumentRoot25: set["rdbms_key2"] = None, rdbms_DocumentRoot27: set["rdbms_oID"] = None, rdbms_DocumentRoot29: set["rdbms_RDBMS"] = None, rdbms_DocumentRoot18: set["rdbms_foreignKeys"] = None, rdbms_DocumentRoot33: set["rdbms_referencedKeys"] = None, rdbms_DocumentRoot36: set["rdbms_schema"] = None, rdbms_DocumentRoot38: set["rdbms_schemas"] = None, rdbms_DocumentRoot40: set["rdbms_table"] = None, rdbms_DocumentRoot42: set["rdbms_tables"] = None, rdbms_DocumentRoot31: set["rdbms_referencedColumns"] = None):
        self.mixed = mixed
...
class rdbms_hasForeignKeys:
    ...
    def __init__(self, group: str, rdbms_hasForeignKeys21: "rdbms_DocumentRoot" = None, rdbms_hasForeignKeys: "rdbms_column" = None, rdbms_hasForeignKeys50: set["rdbms_oID"] = None):
        self.group = group
...
class rdbms_column:
    ...
    def __init__(self, oID: str, type: str, kind: str, name: str, rdbms_column: "rdbms_referencedKeys" = None, rdbms_column2: "rdbms_hasForeignKeys" = None, rdbms_column4: "rdbms_columns" = None, rdbms_column11: "rdbms_DocumentRoot" = None):
        self.oID = oID
        self.type = type
        self.kind = kind
        self.name = name
