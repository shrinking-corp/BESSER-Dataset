...
rdbms_referencedKeys = Class(name="rdbms_referencedKeys")
rdbms_hasForeignKeys = Class(name="rdbms_hasForeignKeys")
rdbms_columns = Class(name="rdbms_columns")
rdbms_DocumentRoot = Class(name="rdbms_DocumentRoot")
rdbms_foreignKey = Class(name="rdbms_foreignKey")
rdbms_EStringToStringMapEntry = Class(name="rdbms_EStringToStringMapEntry")
rdbms_key = Class(name="rdbms_key")
rdbms_key2 = Class(name="rdbms_key2")
rdbms_oID = Class(name="rdbms_oID")
rdbms_RDBMS = Class(name="rdbms_RDBMS")
rdbms_foreignKeys = Class(name="rdbms_foreignKeys")
rdbms_schema = Class(name="rdbms_schema")
rdbms_schemas = Class(name="rdbms_schemas")
rdbms_table = Class(name="rdbms_table")
rdbms_tables = Class(name="rdbms_tables")
rdbms_referencedColumns = Class(name="rdbms_referencedColumns")
...
rdbms_column.attributes={rdbms_column_kind, rdbms_column_type, rdbms_column_name, rdbms_column_oID}
...
rdbms_foreignKey.attributes={rdbms_foreignKey_owner, rdbms_foreignKey_oID, rdbms_foreignKey_kind, rdbms_foreignKey_refersTo, rdbms_foreignKey_name}
...
rdbms_key.attributes={rdbms_key_name, rdbms_key_oID, rdbms_key_kind}
...
rdbms_schema.attributes={rdbms_schema_oID, rdbms_schema_name, rdbms_schema_kind}
...
rdbms_table.attributes={rdbms_table_oID, rdbms_table_kind, rdbms_table_name}
...
domain_model = DomainModel(
    name="rdbms",
    types={rdbms_column, rdbms_referencedKeys, rdbms_hasForeignKeys, rdbms_columns, rdbms_DocumentRoot, rdbms_foreignKey, rdbms_EStringToStringMapEntry, rdbms_key, rdbms_key2, rdbms_oID, rdbms_RDBMS, rdbms_foreignKeys, rdbms_schema, rdbms_schemas, rdbms_table, rdbms_tables, rdbms_referencedColumns},
    associations={referencedKeys0, hasForeignKeys1, column3, xSISchemaLocation6, column9, columns12, foreignKey15, xMLNSPrefixMap5, hasForeignKeys19, key22, key224, oID26, rDBMS28, foreignKeys17, referencedKeys32, schema35, schemas37, table39, tables41, referencedColumns43, referencedColumns30, foreignKey46, oID49, referencedColumns52, key55, schemas58, oID61, tables67, foreignKeys70, schema73, columns76, key279, oID64, table82},
    generalizations={},
    metadata=None
)
