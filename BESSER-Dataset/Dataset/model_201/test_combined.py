...
def test_hyp_ecore_hello_is_not_abstract():
    assert not inspect.isabstract(ecore_hello)


def test_hyp_ecore_hello_constructor_exists():
    assert callable(ecore_hello.__init__)


def test_hyp_ecore_hello_constructor_args():
    sig = inspect.signature(ecore_hello.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecore_prueba_is_not_abstract():
    assert not inspect.isabstract(ecore_prueba)


def test_hyp_ecore_prueba_constructor_exists():
    assert callable(ecore_prueba.__init__)


def test_hyp_ecore_prueba_constructor_args():
    sig = inspect.signature(ecore_prueba.__init__)
    params = list(sig.parameters.keys())
    assert "long" in params, "Missing parameter 'long'"
    assert "char" in params, "Missing parameter 'char'"
    assert "enum2" in params, "Missing parameter 'enum2'"
    assert "collect2" in params, "Missing parameter 'collect2'"
...
def test_hyp_pruebaenum_exists():
    # Check that the Enumeration exists
    assert pruebaEnum is not None

def test_hyp_pruebaenum_has_all_literals():
    # Collect the names of literals in this Enumeration
    enum_literals = [lit.name for lit in pruebaEnum]
    expected_literals = [
        "item2",
        "item1",
    ]
    ...
    for lit_name in expected_literals:
        assert lit_name in enum_literals, f"Literal '' missing in pruebaEnum"
...
ecore_hello_strategy = st.builds(
    ecore_hello,
)
ecore_prueba_strategy = st.builds(
    ecore_prueba,
    long=
        safe_text,
    char=
...
@given(instance=ecore_prueba_strategy)
def test_hyp_ecore_prueba_long_setter(instance):
...
@given(instance=ecore_prueba_strategy)
def test_hyp_ecore_prueba_char_setter(instance):
...
@given(instance=ecore_prueba_strategy)
def test_hyp_ecore_prueba_enum2_setter(instance):
    original = instance.enum2
    instance.enum2 = original
    assert instance.enum2 == original



@given(instance=ecore_prueba_strategy)
def test_hyp_ecore_prueba_collect2_setter(instance):
    original = instance.collect2
    instance.collect2 = original
    assert instance.collect2 == original



@given(instance=ecore_prueba_strategy)
def test_hyp_ecore_prueba_p_setter(instance):
    original = instance.p
    instance.p = original
...
@given(instance=ecore_prueba_strategy)
def test_hyp_ecore_prueba_Float_setter(instance):
...
@given(instance=ecore_prueba_strategy)
def test_hyp_ecore_prueba_collection_setter(instance):
...
@given(instance=ecore_prueba_strategy)
def test_hyp_ecore_prueba_enum_setter(instance):
...
def test_ecore_prueba_Float_value_roundtrip():
    instance = ecore_prueba(Float=3.14, char="sample_text", collect2=7, collection=7, enum="sample_text", enum2="sample_text", long="sample_text", p=3.14)
    assert instance.Float == 3.14
    instance.Float = 9.99
    assert instance.Float == 9.99


def test_ecore_prueba_char_value_roundtrip():
    instance = ecore_prueba(Float=3.14, char="sample_text", collect2=7, collection=7, enum="sample_text", enum2="sample_text", long="sample_text", p=3.14)
...
def test_ecore_prueba_collect2_value_roundtrip():
    instance = ecore_prueba(Float=3.14, char="sample_text", collect2=7, collection=7, enum="sample_text", enum2="sample_text", long="sample_text", p=3.14)
    assert instance.collect2 == 7
    instance.collect2 = 13
    assert instance.collect2 == 13


def test_ecore_prueba_collection_value_roundtrip():
    instance = ecore_prueba(Float=3.14, char="sample_text", collect2=7, collection=7, enum="sample_text", enum2="sample_text", long="sample_text", p=3.14)
    assert instance.collection == 7
    instance.collection = 13
    assert instance.collection == 13


def test_ecore_prueba_enum_value_roundtrip():
    instance = ecore_prueba(Float=3.14, char="sample_text", collect2=7, collection=7, enum="sample_text", enum2="sample_text", long="sample_text", p=3.14)
...
def test_ecore_prueba_enum2_value_roundtrip():
    instance = ecore_prueba(Float=3.14, char="sample_text", collect2=7, collection=7, enum="sample_text", enum2="sample_text", long="sample_text", p=3.14)
    assert instance.enum2 == "sample_text"
    instance.enum2 = "sample_text_2"
    assert instance.enum2 == "sample_text_2"


def test_ecore_prueba_long_value_roundtrip():
    instance = ecore_prueba(Float=3.14, char="sample_text", collect2=7, collection=7, enum="sample_text", enum2="sample_text", long="sample_text", p=3.14)
...
def test_ecore_prueba_p_value_roundtrip():
    instance = ecore_prueba(Float=3.14, char="sample_text", collect2=7, collection=7, enum="sample_text", enum2="sample_text", long="sample_text", p=3.14)
    assert instance.p == 3.14
    instance.p = 9.99
    assert instance.p == 9.99
...
def test_assoc_eExceptions54_link_reassign_clear():
    ...
    b1 = ecore_EOperation()
    b2 = ecore_EOperation()
    _safe_set(a, 'ecore_EClassifier56', b1)
    assert _is_linked(a, 'ecore_EClassifier56', b1)
    if hasattr(b1, 'ecore_EOperation55'):
        assert _is_linked(b1, 'ecore_EOperation55', a)
    _safe_set(a, 'ecore_EClassifier56', b2)
    assert _is_linked(a, 'ecore_EClassifier56', b2)
    if hasattr(b1, 'ecore_EOperation55'):
        assert not _is_linked(b1, 'ecore_EOperation55', a)
    if hasattr(b2, 'ecore_EOperation55'):
        assert _is_linked(b2, 'ecore_EOperation55', a)
    _safe_set(a, 'ecore_EClassifier56', None)
    assert not _is_linked(a, 'ecore_EClassifier56', b2)
    if hasattr(b2, 'ecore_EOperation55'):
        assert not _is_linked(b2, 'ecore_EOperation55', a)
...
def test_assoc_ref1108_link_reassign_clear():
    a = ecore_prueba(Float=3.14, char="sample_text", collect2=7, collection=7, enum="sample_text", enum2="sample_text", long="sample_text", p=3.14)
    b1 = ecore_hello()
    b2 = ecore_hello()
    _safe_set(a, 'ref2', {b1})
    assert _is_linked(a, 'ref2', b1)
    if hasattr(b1, 'hello'):
        assert _is_linked(b1, 'hello', a)
    _safe_set(a, 'ref2', {b2})
    assert _is_linked(a, 'ref2', b2)
    if hasattr(b1, 'hello'):
        assert not _is_linked(b1, 'hello', a)
    if hasattr(b2, 'hello'):
        assert _is_linked(b2, 'hello', a)
    _safe_set(a, 'ref2', set())
    assert not _is_linked(a, 'ref2', b2)
    if hasattr(b2, 'hello'):
        assert not _is_linked(b2, 'hello', a)


def test_assoc_ref2109_link_reassign_clear():
    a = ecore_prueba(Float=3.14, char="sample_text", collect2=7, collection=7, enum="sample_text", enum2="sample_text", long="sample_text", p=3.14)
    b1 = ecore_hello()
    b2 = ecore_hello()
    _safe_set(a, 'prueba', b1)
    assert _is_linked(a, 'prueba', b1)
    if hasattr(b1, 'ref1'):
        assert _is_linked(b1, 'ref1', a)
    _safe_set(a, 'prueba', b2)
    assert _is_linked(a, 'prueba', b2)
    if hasattr(b1, 'ref1'):
        assert not _is_linked(b1, 'ref1', a)
    if hasattr(b2, 'ref1'):
        assert _is_linked(b2, 'ref1', a)
    _safe_set(a, 'prueba', None)
    assert not _is_linked(a, 'prueba', b2)
    if hasattr(b2, 'ref1'):
        assert not _is_linked(b2, 'ref1', a)
...
ecore_hello_strategy = st.builds(ecore_hello)
@given(instance=ecore_hello_strategy)
@settings(max_examples=25)
def test_ecore_hello_instantiation(instance):
    assert isinstance(instance, ecore_hello)


ecore_prueba_strategy = st.builds(ecore_prueba, Float=st.floats(allow_nan=False, allow_infinity=False), char=safe_text, collect2=st.integers(), collection=st.integers(), enum=safe_text, enum2=safe_text, long=safe_text, p=st.floats(allow_nan=False, allow_infinity=False))
@given(instance=ecore_prueba_strategy)
@settings(max_examples=25)
def test_ecore_prueba_instantiation(instance):
    assert isinstance(instance, ecore_prueba)
