...
types_Integer = Class(name="types_Integer")
types_Real = Class(name="types_Real")
...
types_RangeConstraint_m_assignableTo: Method = Method(name="assignableTo", parameters={Parameter(name='types_constraint', type=StringType)}, type=BooleanType)
...
domain_model = DomainModel(
    name="types",
    types={NamedElement, types_PackageMember, types_Type, PackageMember, types_TypeConstraint, types_Feature, TypedElement, types_Package, types_Enumerator, types_PrimitiveType, Type, ParameterizedType, types_ComplexType, types_Operation, Feature, types_Parameter, types_Property, types_TypedElement, types_Event, types_EnumerationType, PrimitiveType, types_String, types_Void, types_TypeParameter, types_ParameterizedType, types_RangeConstraint, TypeConstraint, types_Integer, types_Real, types_Boolean},
    associations={member0, constraints1, enumerator10, baseType12, features13, superTypes15, owningType2, parameters3, owningOperation4, type5, typeArguments7, owningEnumeration16, bound17, parameter19},
    generalizations={gen_types_Package_NamedElement, gen_types_Type_PackageMember, gen_types_Feature_TypedElement, gen_types_Feature_NamedElement, gen_types_PrimitiveType_Type, gen_types_ComplexType_ParameterizedType, gen_types_Enumerator_NamedElement, gen_types_Operation_Feature, gen_types_Property_Feature, gen_types_Parameter_TypedElement, gen_types_Parameter_NamedElement, gen_types_Event_Feature, gen_types_EnumerationType_PrimitiveType, gen_types_String_PrimitiveType, gen_types_Void_PrimitiveType, gen_types_TypeParameter_Type, gen_types_ParameterizedType_Type, gen_types_PackageMember_NamedElement, gen_types_RangeConstraint_TypeConstraint, gen_types_Integer_PrimitiveType, gen_types_Real_PrimitiveType, gen_types_Boolean_PrimitiveType},
    metadata=None
)
