...
class cellsheet_Row(HasId, HasA1):

    def __init__(self, rowIndex: int, rows: "cellsheet_Sheet" = None, row: set["cellsheet_Cell"] = None, Row15: "cellsheet_Cell" = None, Row: "cellsheet_Sheet" = None):
    ...
    def getA1RowIndex(self) :
        # TODO: Implement getA1RowIndex method
        pass

class cellsheet_Cell(HasId, HasA1):
...
class cellsheet_Sheet(HasId, HasA1):

    def __init__(self, sheetName: str, sheetIndex: int, Sheet: "cellsheet_Book" = None, sheets: "cellsheet_Book" = None, Sheet12: "cellsheet_Row" = None, sheet: set["cellsheet_Row"] = None):
...
class cellsheet_Book(HasId, HasA1):
