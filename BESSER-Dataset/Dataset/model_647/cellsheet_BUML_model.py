...
# Classes
cellsheet_EStringToTokenEntry = Class(name="cellsheet_EStringToTokenEntry")
cellsheet_Token = Class(name="cellsheet_Token")
cellsheet_HasA1 = Class(name="cellsheet_HasA1", is_abstract=True)
cellsheet_HasId = Class(name="cellsheet_HasId", is_abstract=True)
cellsheet_Workspace = Class(name="cellsheet_Workspace")
cellsheet_Book = Class(name="cellsheet_Book")
HasId = Class(name="HasId")
HasA1 = Class(name="HasA1")
cellsheet_CellFormat = Class(name="cellsheet_CellFormat")
cellsheet_Sheet = Class(name="cellsheet_Sheet")
cellsheet_Row = Class(name="cellsheet_Row")
cellsheet_Cell = Class(name="cellsheet_Cell", is_abstract=True)
cellsheet_Ast = Class(name="cellsheet_Ast", is_abstract=True)
cellsheet_BlankCell = Class(name="cellsheet_BlankCell")
Cell = Class(name="Cell")
cellsheet_TextCell = Class(name="cellsheet_TextCell")
cellsheet_NumericCell = Class(name="cellsheet_NumericCell")
cellsheet_BooleanCell = Class(name="cellsheet_BooleanCell")
cellsheet_DateCell = Class(name="cellsheet_DateCell")
cellsheet_FormulaCell = Class(name="cellsheet_FormulaCell")
cellsheet_AstEval = Class(name="cellsheet_AstEval")
cellsheet_Operand = Class(name="cellsheet_Operand", is_abstract=True)
Ast = Class(name="Ast")
cellsheet_Operation = Class(name="cellsheet_Operation", is_abstract=True)
cellsheet_PrefixOperator = Class(name="cellsheet_PrefixOperator", is_abstract=True)
cellsheet_InfixOperator = Class(name="cellsheet_InfixOperator", is_abstract=True)
cellsheet_PostfixOperator = Class(name="cellsheet_PostfixOperator", is_abstract=True)
cellsheet_Unknown = Class(name="cellsheet_Unknown")
cellsheet_Noop = Class(name="cellsheet_Noop")
cellsheet_Text = Class(name="cellsheet_Text")
Operand = Class(name="Operand")
cellsheet_Number = Class(name="cellsheet_Number")
cellsheet_Logical = Class(name="cellsheet_Logical")
cellsheet_Error = Class(name="cellsheet_Error")
cellsheet_Ref = Class(name="cellsheet_Ref")
cellsheet_Range = Class(name="cellsheet_Range")
cellsheet_RelativeRef = Class(name="cellsheet_RelativeRef")
Ref = Class(name="Ref")
cellsheet_RelativeRange = Class(name="cellsheet_RelativeRange")
cellsheet_Function = Class(name="cellsheet_Function")
Operation = Class(name="Operation")
cellsheet_Plus = Class(name="cellsheet_Plus")
PrefixOperator = Class(name="PrefixOperator")
cellsheet_Negation = Class(name="cellsheet_Negation")
cellsheet_Percent = Class(name="cellsheet_Percent")
PostfixOperator = Class(name="PostfixOperator")
cellsheet_Exponentiation = Class(name="cellsheet_Exponentiation")
InfixOperator = Class(name="InfixOperator")
cellsheet_Multiplication = Class(name="cellsheet_Multiplication")
cellsheet_Division = Class(name="cellsheet_Division")
cellsheet_Addition = Class(name="cellsheet_Addition")
cellsheet_Subtraction = Class(name="cellsheet_Subtraction")
cellsheet_Concatenation = Class(name="cellsheet_Concatenation")
cellsheet_EQ = Class(name="cellsheet_EQ")
cellsheet_LT = Class(name="cellsheet_LT")
cellsheet_GT = Class(name="cellsheet_GT")
cellsheet_LTE = Class(name="cellsheet_LTE")
cellsheet_GTE = Class(name="cellsheet_GTE")
cellsheet_NEQ = Class(name="cellsheet_NEQ")
cellsheet_Intersection = Class(name="cellsheet_Intersection")
cellsheet_Union = Class(name="cellsheet_Union")
...
cellsheet_Sheet.attributes={cellsheet_Sheet_sheetIndex, cellsheet_Sheet_sheetName}
...
cellsheet_Row.methods={cellsheet_Row_m_getBook, cellsheet_Row_m_getA1RowIndex}
...
cellsheet_Cell.methods={cellsheet_Cell_m_getA1ColIndex, cellsheet_Cell_m_getSheet, cellsheet_Cell_m_getA1RowIndex, cellsheet_Cell_m_getRowIndex, cellsheet_Cell_m_getBook}
...
cellsheet_AstEval.attributes={cellsheet_AstEval_isError, cellsheet_AstEval_numberValue, cellsheet_AstEval_text}
