...
class featureModel_Group:
    ...
    def __init__(self, inclusive: bool, featureModel_Group8: set["featureModel_GroupedFeature"] = None, featureModel_Group: "featureModel_Feature" = None):
...
class featureModel_Feature(ABC):
    ...
    def __init__(self, name: str, type: str, featureModel_Feature6: "featureModel_Model" = None, featureModel_Feature17: "featureModel_Identifier" = None, featureModel_Feature: set["featureModel_Group"] = None, featureModel_Feature2: set["featureModel_SolitaryFeature"] = None, featureModel_Feature4: set["featureModel_Expression"] = None):
        self.name = name
        self.type = type
