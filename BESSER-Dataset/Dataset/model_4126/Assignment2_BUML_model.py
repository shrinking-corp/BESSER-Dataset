...
# Classes
assignment2_Primary = Class(name="assignment2_Primary")
ExpMultDiv = Class(name="ExpMultDiv")
assignment2_Parenthesis = Class(name="assignment2_Parenthesis")
Primary = Class(name="Primary")
assignment2_Number = Class(name="assignment2_Number")
assignment2_Exp = Class(name="assignment2_Exp")
assignment2_Plus = Class(name="assignment2_Plus")
ExpPM = Class(name="ExpPM")
assignment2_Minus = Class(name="assignment2_Minus")
assignment2_Mult = Class(name="assignment2_Mult")
ExpMD = Class(name="ExpMD")
assignment2_Div = Class(name="assignment2_Div")
assignment2_Model = Class(name="assignment2_Model")
assignment2_MathExp = Class(name="assignment2_MathExp")
assignment2_ExpMinusPlus = Class(name="assignment2_ExpMinusPlus")
assignment2_ExpMultDiv = Class(name="assignment2_ExpMultDiv")
ExpMinusPlus = Class(name="ExpMinusPlus")
assignment2_EObject = Class(name="assignment2_EObject")
assignment2_ExpPM = Class(name="assignment2_ExpPM")
assignment2_ExpMD = Class(name="assignment2_ExpMD")
...
domain_model = DomainModel(
    name="assignment2",
    types={assignment2_Primary, ExpMultDiv, assignment2_Parenthesis, Primary, assignment2_Number, assignment2_Exp, assignment2_Plus, ExpPM, assignment2_Minus, assignment2_Mult, ExpMD, assignment2_Div, assignment2_Model, assignment2_MathExp, assignment2_ExpMinusPlus, assignment2_ExpMultDiv, ExpMinusPlus, assignment2_EObject, assignment2_ExpPM, assignment2_ExpMD},
    associations={exp10, math0, exp1, left4, operator6, right8},
    generalizations={gen_assignment2_Primary_ExpMultDiv, gen_assignment2_Parenthesis_Primary, gen_assignment2_Number_Primary, gen_assignment2_Exp_ExpMultDiv, gen_assignment2_Plus_ExpPM, gen_assignment2_Minus_ExpPM, gen_assignment2_Mult_ExpMD, gen_assignment2_Div_ExpMD, gen_assignment2_ExpMultDiv_ExpMinusPlus},
    metadata=None
)
