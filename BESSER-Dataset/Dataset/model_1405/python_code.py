...
class HSM_StateMachine:
    ...
    def __init__(self, name: str, StateMachine: "HSM_State" = None, machine: set["HSM_State"] = None, HSM_StateMachine: set["HSM_Transition"] = None, HSM_StateMachine12: "HSM_Transition" = None):
        self.name = name
