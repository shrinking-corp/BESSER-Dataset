...
rental_RentalAgency_m_book: Method = Method(name="book", parameters={Parameter(name='rental_customer', type=StringType), Parameter(name='rental_from_', type=StringType), Parameter(name='rental_rentedObject', type=StringType), Parameter(name='rental_to', type=StringType)}, type=StringType)
...
rental_RentalAgency.methods={rental_RentalAgency_m_addObject, rental_RentalAgency_m_book, rental_RentalAgency_m_addCustomer}
...
rental_Rental.methods={rental_Rental_m_end, rental_Rental_m_nbDaysRented, rental_Rental_m_start, rental_Rental_m_nbDaysBooked}
...
rental_Address.attributes={rental_Address_streetType, rental_Address_zipCode, rental_Address_city, rental_Address_number, rental_Address_streetName}
...
domain_model = DomainModel(
    name="rental",
    types={rental_RentalAgency, rental_RentalObject, rental_Rental, rental_Customer, rental_Address, rental_License, StreetType},
    associations={licenses1, parentAgency2, address3, objectsToRent5, customers6, address0, owner12, customer14, rentedObject17, parentAgency19, rentals8, parentAgency10},
    generalizations={},
    metadata=None
)
