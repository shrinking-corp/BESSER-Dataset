...
public class rental_Customer  {
    ...
    private rental_Rental rental_rental;
    ...
    public rental_Rental getRental_rental() {
        return rental_rental;
    }

    public void setRental_rental(rental_Rental rental_rental) {
        this.rental_rental = rental_rental;
    }
    public rental_RentalAgency getRental_rentalagency() {
        return rental_rentalagency;
    }
