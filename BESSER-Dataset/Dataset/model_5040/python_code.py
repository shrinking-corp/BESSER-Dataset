...
class rental_License:
    ...
    def __init__(self, number: int, validityDate: date, licenses: "rental_Customer" = None, License: "rental_Customer" = None):
        self.number = number
...
class rental_Customer:
    ...
    def __init__(self, firstName: str, lastName: str, Customer: "rental_RentalAgency" = None, rental_Customer: "rental_Address" = None, Customer13: "rental_License" = None, rental_Customer16: "rental_Rental" = None, owner: set["rental_License"] = None, customers: "rental_RentalAgency" = None):
...
class rental_Rental:
    ...
    def __init__(self, startDate: date, endDate: date, rental_Rental15: "rental_Customer" = None, rental_Rental18: "rental_RentalObject" = None, rental_Rental20: "rental_RentalAgency" = None, rental_Rental: "rental_RentalAgency" = None):
...
class rental_RentalObject:
    ...
    def __init__(self, ID: str, name: str, picture: str, RentalObject: "rental_RentalAgency" = None, rental_RentalObject: "rental_Rental" = None, objectsToRent: "rental_RentalAgency" = None):
        self.ID = ID
        self.name = name
...
class rental_RentalAgency:
    ...
    def __init__(self, name: str, parentAgency: set["rental_RentalObject"] = None, parentAgency7: set["rental_Customer"] = None, rental_RentalAgency21: "rental_Rental" = None, rental_RentalAgency9: set["rental_Rental"] = None, RentalAgency11: "rental_RentalObject" = None, RentalAgency: "rental_Customer" = None, rental_RentalAgency: "rental_Address" = None):
        self.name = name
    ...
    def book(self, rental_rentedObject, rental_customer, rental_to, rental_from_) :
        # TODO: Implement book method
        pass

    def addObject(self, rental_object):
        # TODO: Implement addObject method
        pass

    def addCustomer(self, rental_customer):
