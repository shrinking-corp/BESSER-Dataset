...
public class contentfwk_DataEntity extends Element {
    ...
    public contentfwk_DataEntity(
        String dataEntityCategory,        String privacyClassification,        String retentionClassification        ArrayList<contentfwk_Actor> contentfwk_actors,        ArrayList<contentfwk_Actor> contentfwk_actors,        ArrayList<contentfwk_DataEntity> contentfwk_dataentitys    ) {
        this.dataEntityCategory = dataEntityCategory;
        this.privacyClassification = privacyClassification;
        this.retentionClassification = retentionClassification;
