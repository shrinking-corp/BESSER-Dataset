...
public class contentfwk_Service extends Standard {
    ...
    public contentfwk_Service(
        ArrayList<contentfwk_OrganizationUnit> contentfwk_organizationunits,        ArrayList<contentfwk_ServiceQuality> contentfwk_servicequalitys,        ArrayList<contentfwk_DataEntity> contentfwk_dataentitys,        ArrayList<contentfwk_Service> contentfwk_services,        ArrayList<contentfwk_Actor> contentfwk_actors,        ArrayList<contentfwk_Process> contentfwk_processs,        ArrayList<contentfwk_DataEntity> contentfwk_dataentitys,        ArrayList<contentfwk_Event> contentfwk_events,        ArrayList<contentfwk_Contract> contentfwk_contracts,        ArrayList<contentfwk_Measure> contentfwk_measures,        ArrayList<contentfwk_Process> contentfwk_processs,        ArrayList<contentfwk_Service> contentfwk_services,        ArrayList<contentfwk_Function> contentfwk_functions    ) {
