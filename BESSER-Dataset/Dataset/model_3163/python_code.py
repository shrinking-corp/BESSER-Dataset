...
class transformation_VariableDefinition:
    ...
    def __init__(self, name: str, transformation_VariableDefinition78: "transformation_Lambda" = None, transformation_VariableDefinition87: "transformation_VariableUse" = None, transformation_VariableDefinition: "transformation_VariableInitialization" = None):
        self.name = name
