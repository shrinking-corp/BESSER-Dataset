...
PetriNet_NonReferencedClass = Class(name="PetriNet_NonReferencedClass")
...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={PetriNet_TransToPlaceArc, PetriNet_Element, PetriNet_PetriNet, Element, Place, Transition, Arc, PetriNet_Place, TransToPlaceArc, PlaceToTransArc, PetriNet, PetriNet_Transition, PetriNet_Arc, PetriNet_PlaceToTransArc, PetriNet_NonReferencedClass},
    ...
    generalizations={gen_PetriNet_TransToPlaceArc_Arc, gen_PetriNet_PetriNet_Element, gen_PetriNet_Place_Element, gen_PetriNet_Transition_Element, gen_PetriNet_PlaceToTransArc_Arc},
    metadata=None
)
