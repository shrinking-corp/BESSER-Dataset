...
class household_Member:
    ...
    def __init__(self, name: str, household_Member: "household_Family" = None, household_Member3: "household_Family" = None, household_Member6: "household_Family" = None, household_Member9: "household_Family" = None):
        self.name = name
...
class household_Family:
    ...
    def __init__(self, name: str, household_Family: "household_Member" = None, household_Family2: set["household_Member"] = None, household_Family5: set["household_Member"] = None, household_Family8: "household_Member" = None):
        self.name = name
