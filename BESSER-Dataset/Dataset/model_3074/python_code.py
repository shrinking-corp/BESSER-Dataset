...
class oml_Class(Classifier):
    ...
    def __init__(self, isAbstract: str, Class7: "oml_Class" = None, extends: set["oml_Class"] = None, owner: set["oml_Feature"] = None, Class10: "oml_Feature" = None, Class: "oml_Class" = None, extendedBy: "oml_Class" = None):
