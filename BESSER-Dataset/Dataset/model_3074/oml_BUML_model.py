...
# Classes
oml_Model = Class(name="oml_Model")
Package = Class(name="Package")
oml_PackageableElement = Class(name="oml_PackageableElement", is_abstract=True)
NamedElement = Class(name="NamedElement")
oml_Package = Class(name="oml_Package")
PackageableElement = Class(name="PackageableElement")
oml_Classifier = Class(name="oml_Classifier", is_abstract=True)
oml_ExternalClass = Class(name="oml_ExternalClass")
Class_ = Class(name="Class")
oml_Class = Class(name="oml_Class")
Classifier = Class(name="Classifier")
oml_Feature = Class(name="oml_Feature", is_abstract=True)
oml_Datatype = Class(name="oml_Datatype")
oml_StructuralFeature = Class(name="oml_StructuralFeature", is_abstract=True)
Feature = Class(name="Feature")
oml_Operation = Class(name="oml_Operation")
oml_Parameter = Class(name="oml_Parameter")
oml_AnnotatedElement = Class(name="oml_AnnotatedElement", is_abstract=True)
oml_Annotation = Class(name="oml_Annotation")
oml_NamedElement = Class(name="oml_NamedElement", is_abstract=True)
AnnotatedElement = Class(name="AnnotatedElement")
oml_Reference = Class(name="oml_Reference")
StructuralFeature = Class(name="StructuralFeature")
oml_Attribute = Class(name="oml_Attribute")
...
domain_model = DomainModel(
    name="oml",
    types={oml_Model, Package, oml_PackageableElement, NamedElement, oml_Package, PackageableElement, oml_Classifier, oml_ExternalClass, Class_, oml_Class, Classifier, oml_Feature, oml_Datatype, oml_StructuralFeature, Feature, oml_Operation, oml_Parameter, oml_AnnotatedElement, oml_Annotation, oml_NamedElement, AnnotatedElement, oml_Reference, StructuralFeature, oml_Attribute, VisibilityEnum},
    associations={package0, contents2, extends4, extendedBy6, features8, owner9, type11, parameters12, annotations1, type14, owner16},
    generalizations={gen_oml_Model_Package, gen_oml_PackageableElement_NamedElement, gen_oml_Package_PackageableElement, gen_oml_Classifier_PackageableElement, gen_oml_ExternalClass_Class, gen_oml_Class_Classifier, gen_oml_Datatype_Classifier, gen_oml_Feature_NamedElement, gen_oml_StructuralFeature_Feature, gen_oml_Operation_Feature, gen_oml_Parameter_NamedElement, gen_oml_NamedElement_AnnotatedElement, gen_oml_Reference_StructuralFeature, gen_oml_Attribute_StructuralFeature},
    metadata=None
)
