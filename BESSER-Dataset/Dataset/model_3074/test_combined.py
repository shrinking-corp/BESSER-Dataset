...
def test_hyp_oml_attribute_is_not_abstract():
    assert not inspect.isabstract(oml_Attribute)


def test_hyp_oml_attribute_constructor_exists():
    assert callable(oml_Attribute.__init__)


def test_hyp_oml_attribute_constructor_args():
    sig = inspect.signature(oml_Attribute.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oml_reference_is_not_abstract():
    assert not inspect.isabstract(oml_Reference)


def test_hyp_oml_reference_constructor_exists():
    assert callable(oml_Reference.__init__)


def test_hyp_oml_reference_constructor_args():
...
def test_hyp_oml_namedelement_is_not_abstract():
    assert not inspect.isabstract(oml_NamedElement)


def test_hyp_oml_namedelement_constructor_exists():
    assert callable(oml_NamedElement.__init__)


def test_hyp_oml_namedelement_constructor_args():
...
def test_hyp_oml_annotation_is_not_abstract():
    assert not inspect.isabstract(oml_Annotation)


def test_hyp_oml_annotation_constructor_exists():
    assert callable(oml_Annotation.__init__)


def test_hyp_oml_annotation_constructor_args():
...
def test_hyp_oml_annotatedelement_is_not_abstract():
    assert not inspect.isabstract(oml_AnnotatedElement)


def test_hyp_oml_annotatedelement_constructor_exists():
    assert callable(oml_AnnotatedElement.__init__)


def test_hyp_oml_annotatedelement_constructor_args():
...
def test_hyp_oml_operation_is_not_abstract():
    assert not inspect.isabstract(oml_Operation)


def test_hyp_oml_operation_constructor_exists():
    assert callable(oml_Operation.__init__)


def test_hyp_oml_operation_constructor_args():
    sig = inspect.signature(oml_Operation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oml_structuralfeature_is_not_abstract():
    assert not inspect.isabstract(oml_StructuralFeature)


def test_hyp_oml_structuralfeature_constructor_exists():
    assert callable(oml_StructuralFeature.__init__)


def test_hyp_oml_structuralfeature_constructor_args():
...
def test_hyp_oml_datatype_is_not_abstract():
    assert not inspect.isabstract(oml_Datatype)


def test_hyp_oml_datatype_constructor_exists():
    assert callable(oml_Datatype.__init__)


def test_hyp_oml_datatype_constructor_args():
    sig = inspect.signature(oml_Datatype.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oml_class_is_not_abstract():
    assert not inspect.isabstract(oml_Class)


def test_hyp_oml_class_constructor_exists():
    assert callable(oml_Class.__init__)


def test_hyp_oml_class_constructor_args():
...
def test_hyp_oml_externalclass_is_not_abstract():
    assert not inspect.isabstract(oml_ExternalClass)


def test_hyp_oml_externalclass_constructor_exists():
    assert callable(oml_ExternalClass.__init__)


def test_hyp_oml_externalclass_constructor_args():
...
def test_hyp_oml_classifier_is_not_abstract():
    assert not inspect.isabstract(oml_Classifier)


def test_hyp_oml_classifier_constructor_exists():
    assert callable(oml_Classifier.__init__)


def test_hyp_oml_classifier_constructor_args():
    sig = inspect.signature(oml_Classifier.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oml_package_is_not_abstract():
    assert not inspect.isabstract(oml_Package)


def test_hyp_oml_package_constructor_exists():
    assert callable(oml_Package.__init__)


def test_hyp_oml_package_constructor_args():
...
def test_hyp_oml_parameter_is_not_abstract():
    assert not inspect.isabstract(oml_Parameter)


def test_hyp_oml_parameter_constructor_exists():
    assert callable(oml_Parameter.__init__)


def test_hyp_oml_parameter_constructor_args():
    sig = inspect.signature(oml_Parameter.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oml_feature_is_not_abstract():
    assert not inspect.isabstract(oml_Feature)


def test_hyp_oml_feature_constructor_exists():
    assert callable(oml_Feature.__init__)


def test_hyp_oml_feature_constructor_args():
...
def test_hyp_oml_packageableelement_is_not_abstract():
    assert not inspect.isabstract(oml_PackageableElement)


def test_hyp_oml_packageableelement_constructor_exists():
    assert callable(oml_PackageableElement.__init__)


def test_hyp_oml_packageableelement_constructor_args():
...
def test_hyp_oml_model_is_not_abstract():
    assert not inspect.isabstract(oml_Model)


def test_hyp_oml_model_constructor_exists():
    assert callable(oml_Model.__init__)


def test_hyp_oml_model_constructor_args():
...
def test_hyp_oml_namedelement_name_setter(instance):
...
def test_hyp_oml_annotation_key_setter(instance):
...
@given(instance=oml_Annotation_strategy)
def test_hyp_oml_annotation_value_setter(instance):
...
def test_hyp_oml_structuralfeature_isMany_setter(instance):
...
def test_hyp_oml_class_isAbstract_setter(instance):
...
def test_hyp_oml_feature_visibility_setter(instance):
