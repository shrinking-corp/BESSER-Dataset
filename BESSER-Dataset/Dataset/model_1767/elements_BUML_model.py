...
elements_EObject = Class(name="elements_EObject")
...
elements_Book.attributes={elements_Book_title, elements_Book_pages, elements_Book_category, elements_Book_uuid}
