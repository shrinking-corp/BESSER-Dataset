...
class simplepdl_RessourceConfig(ProcessElement):
    ...
    def __init__(self, name: str, linksToRessources: "simplepdl_WorkDefinition" = None, config: set["simplepdl_RessourceInstance"] = None, RessourceConfig: "simplepdl_WorkDefinition" = None, RessourceConfig12: "simplepdl_RessourceInstance" = None):
        self.name = name
...
class simplepdl_RessourceInstance(ProcessElement):
    ...
    def __init__(self, instances: int, RessourceInstance: "simplepdl_RessourceConfig" = None, simplepdl_RessourceInstance: "simplepdl_RessourceDefinition" = None, ressources: "simplepdl_RessourceConfig" = None):
...
class simplepdl_WorkDefinition(ProcessElement):
    ...
    def __init__(self, min_time: int, max_time: int, name: str, WorkDefinition14: "simplepdl_RessourceConfig" = None, successor: set["simplepdl_WorkSequence"] = None, predecessor: set["simplepdl_WorkSequence"] = None, activity: set["simplepdl_RessourceConfig"] = None, WorkDefinition: "simplepdl_WorkSequence" = None, WorkDefinition7: "simplepdl_WorkSequence" = None):
