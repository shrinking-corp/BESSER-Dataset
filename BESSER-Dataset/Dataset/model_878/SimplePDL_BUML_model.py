...
simplepdl_RessourceConfig = Class(name="simplepdl_RessourceConfig")
simplepdl_Guidance = Class(name="simplepdl_Guidance")
simplepdl_RessourceDefinition = Class(name="simplepdl_RessourceDefinition")
simplepdl_RessourceInstance = Class(name="simplepdl_RessourceInstance")
...
simplepdl_Process.attributes={simplepdl_Process_name, simplepdl_Process_max_time, simplepdl_Process_min_time}
...
domain_model = DomainModel(
    name="simplepdl",
    types={simplepdl_Process, simplepdl_ProcessElement, simplepdl_WorkDefinition, ProcessElement, simplepdl_WorkSequence, simplepdl_RessourceConfig, simplepdl_Guidance, simplepdl_RessourceDefinition, simplepdl_RessourceInstance, WorkSequenceType},
    associations={processElements0, activity13, ressources15, linksToPredecessors1, linksToSuccessors2, linksToRessources4, predecessor5, successor6, element8, type10, config11},
    generalizations={gen_simplepdl_WorkDefinition_ProcessElement, gen_simplepdl_RessourceConfig_ProcessElement, gen_simplepdl_WorkSequence_ProcessElement, gen_simplepdl_Guidance_ProcessElement, gen_simplepdl_RessourceDefinition_ProcessElement, gen_simplepdl_RessourceInstance_ProcessElement},
    metadata=None
)
