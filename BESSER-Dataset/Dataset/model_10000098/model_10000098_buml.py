...
faculty_give_attendance: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="faculty1", type=Teacher_Actor, multiplicity=Multiplicity(0, 1))
    }
)
faculty_generate_class_wise_attendance_report: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="faculty3", type=Teacher_Actor, multiplicity=Multiplicity(0, 1))
    }
)
faculty_post_attendance: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="faculty5", type=Teacher_Actor, multiplicity=Multiplicity(0, 1))
    }
)
...
faculty_login: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="faculty17", type=Teacher_Actor, multiplicity=Multiplicity(0, 1))
    }
)
faculty_logout: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="faculty19", type=Teacher_Actor, multiplicity=Multiplicity(0, 1))
    }
)
...
faculty_view_cumiliative_attendance: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="faculty27", type=Teacher_Actor, multiplicity=Multiplicity(0, 1))
    }
)
...
parent_logout: BinaryAssociation = BinaryAssociation(
    name="parent_logout",
    ends={
        Property(name="logout32", type=logout_external, multiplicity=Multiplicity(0, 1)),
...
admin_modify_list_of_students: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="modify_list_of_students34", type=modify_list_of_students_external, multiplicity=Multiplicity(0, 1)),
...
FACULTY_STUDENT: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="sTUDENT36", type=STUDENT, multiplicity=Multiplicity(1, 9999)),
...
STUDENT_ADMIN: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="sTUDENT41", type=STUDENT, multiplicity=Multiplicity(1, 9999))
    }
)
PARENT_ADMIN: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="pARENT43", type=PARENT, multiplicity=Multiplicity(1, 9999))
    }
)

# Domain Model
domain_model = DomainModel(
    name="_0d5cfdcd_ad51_4b6e_bf64_e3f2593eba7e",
    types={student_Actor, Teacher_Actor, _Component, parent_Actor, admin_Actor, FACULTY, STUDENT, PARENT, ADMIN, take_attendance_call_external, generate_class_wise_attendance_report_external, post_attendance_external, answer_attendance_call_external, view_subject_wise_attendance_external, view_cumiliative_attendance_external, login_external, logout_external, modify_list_of_students_external},
    associations={faculty_give_attendance, faculty_generate_class_wise_attendance_report, faculty_post_attendance, student_answer_attendance_call, student_view_subject_wise_attendance, student_view_cumiliative_attendance, student_login, student_logout, faculty_login, faculty_logout, admin_login, admin_logout, parent_view_subject_wise_attendance, faculty_view_cumiliative_attendance, parent_view_cumiliative_attendance, parent_login, parent_logout, admin_modify_list_of_students, FACULTY_STUDENT, FACULTY_ADMIN, STUDENT_ADMIN, PARENT_ADMIN},
    generalizations={},
    metadata=None
)
