...
def test_assoc_FACULTY_ADMIN_link_reassign_clear():
    ...
    if hasattr(b1, 'fACULTY39'):
        assert _is_linked(b1, 'fACULTY39', a)
    _safe_set(a, 'aDMIN38', b2)
    assert _is_linked(a, 'aDMIN38', b2)
    if hasattr(b1, 'fACULTY39'):
        assert not _is_linked(b1, 'fACULTY39', a)
    if hasattr(b2, 'fACULTY39'):
        assert _is_linked(b2, 'fACULTY39', a)
    _safe_set(a, 'aDMIN38', None)
    assert not _is_linked(a, 'aDMIN38', b2)
    if hasattr(b2, 'fACULTY39'):
        assert not _is_linked(b2, 'fACULTY39', a)
...
def test_assoc_FACULTY_STUDENT_link_reassign_clear():
    ...
    _safe_set(a, 'fACULTY37', {b1})
    assert _is_linked(a, 'fACULTY37', b1)
    if hasattr(b1, 'sTUDENT36'):
        assert _is_linked(b1, 'sTUDENT36', a)
    _safe_set(a, 'fACULTY37', {b2})
    assert _is_linked(a, 'fACULTY37', b2)
    if hasattr(b1, 'sTUDENT36'):
        assert not _is_linked(b1, 'sTUDENT36', a)
    if hasattr(b2, 'sTUDENT36'):
        assert _is_linked(b2, 'sTUDENT36', a)
    _safe_set(a, 'fACULTY37', set())
    assert not _is_linked(a, 'fACULTY37', b2)
    if hasattr(b2, 'sTUDENT36'):
        assert not _is_linked(b2, 'sTUDENT36', a)
...
def test_assoc_PARENT_ADMIN_link_reassign_clear():
    ...
    if hasattr(b1, 'pARENT43'):
        assert _is_linked(b1, 'pARENT43', a)
    _safe_set(a, 'aDMIN42', b2)
    assert _is_linked(a, 'aDMIN42', b2)
    if hasattr(b1, 'pARENT43'):
        assert not _is_linked(b1, 'pARENT43', a)
    if hasattr(b2, 'pARENT43'):
        assert _is_linked(b2, 'pARENT43', a)
    _safe_set(a, 'aDMIN42', None)
    assert not _is_linked(a, 'aDMIN42', b2)
    if hasattr(b2, 'pARENT43'):
        assert not _is_linked(b2, 'pARENT43', a)
...
def test_assoc_STUDENT_ADMIN_link_reassign_clear():
    ...
    if hasattr(b1, 'sTUDENT41'):
        assert _is_linked(b1, 'sTUDENT41', a)
    _safe_set(a, 'aDMIN40', b2)
    assert _is_linked(a, 'aDMIN40', b2)
    if hasattr(b1, 'sTUDENT41'):
        assert not _is_linked(b1, 'sTUDENT41', a)
    if hasattr(b2, 'sTUDENT41'):
        assert _is_linked(b2, 'sTUDENT41', a)
    _safe_set(a, 'aDMIN40', None)
    assert not _is_linked(a, 'aDMIN40', b2)
    if hasattr(b2, 'sTUDENT41'):
        assert not _is_linked(b2, 'sTUDENT41', a)
