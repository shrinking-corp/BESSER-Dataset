...
# Classes
shape_ShapeContainer = Class(name="shape_ShapeContainer")
shape_ShapeContainerElement = Class(name="shape_ShapeContainerElement")
shape_ConnectionDefinition = Class(name="shape_ConnectionDefinition")
ShapeContainerElement = Class(name="ShapeContainerElement")
shape_ShapestyleLayout = Class(name="shape_ShapestyleLayout")
shape_PlacingDefinition = Class(name="shape_PlacingDefinition")
shape_ShapeDefinition = Class(name="shape_ShapeDefinition")
shape_ShapeLayout = Class(name="shape_ShapeLayout")
shape_Shape = Class(name="shape_Shape")
shape_Description = Class(name="shape_Description")
shape_Anchor = Class(name="shape_Anchor")
shape_ShapeConnection = Class(name="shape_ShapeConnection")
shape_AnchorType = Class(name="shape_AnchorType")
shape_AnchorPredefinied = Class(name="shape_AnchorPredefinied")
AnchorType = Class(name="AnchorType")
shape_TextBody = Class(name="shape_TextBody")
shape_AnchorManual = Class(name="shape_AnchorManual")
shape_AnchorPosition = Class(name="shape_AnchorPosition")
shape_AnchorPositionPos = Class(name="shape_AnchorPositionPos")
shape_AnchorRelativePosition = Class(name="shape_AnchorRelativePosition")
AnchorPositionPos = Class(name="AnchorPositionPos")
shape_AnchorFixPointPosition = Class(name="shape_AnchorFixPointPosition")
shape_CDLine = Class(name="shape_CDLine")
ShapeConnection = Class(name="ShapeConnection")
shape_LineLayout = Class(name="shape_LineLayout")
shape_CDPolyline = Class(name="shape_CDPolyline")
shape_PolyLineLayout = Class(name="shape_PolyLineLayout")
shape_CDRectangle = Class(name="shape_CDRectangle")
shape_RectangleEllipseLayout = Class(name="shape_RectangleEllipseLayout")
shape_CDRoundedRectangle = Class(name="shape_CDRoundedRectangle")
shape_RoundedRectangleLayout = Class(name="shape_RoundedRectangleLayout")
shape_CDPolygon = Class(name="shape_CDPolygon")
shape_CDEllipse = Class(name="shape_CDEllipse")
shape_CDText = Class(name="shape_CDText")
shape_TextLayout = Class(name="shape_TextLayout")
shape_Line = Class(name="shape_Line")
Shape = Class(name="Shape")
shape_Polyline = Class(name="shape_Polyline")
shape_Rectangle = Class(name="shape_Rectangle")
shape_CompartmentInfo = Class(name="shape_CompartmentInfo")
shape_RoundedRectangle = Class(name="shape_RoundedRectangle")
shape_Polygon = Class(name="shape_Polygon")
shape_Ellipse = Class(name="shape_Ellipse")
shape_Text = Class(name="shape_Text")
shape_Compartment = Class(name="shape_Compartment")
shape_CompartmentShape = Class(name="shape_CompartmentShape")
shape_CompartmentRectangle = Class(name="shape_CompartmentRectangle")
CompartmentShape = Class(name="CompartmentShape")
shape_CompartmentRoundedRectangle = Class(name="shape_CompartmentRoundedRectangle")
shape_CompartmentPolygon = Class(name="shape_CompartmentPolygon")
shape_CompartmentEllipse = Class(name="shape_CompartmentEllipse")
shape_CommonLayout = Class(name="shape_CommonLayout")
shape_Point = Class(name="shape_Point")
...
shape_PlacingDefinition.attributes={shape_PlacingDefinition_distance, shape_PlacingDefinition_offset, shape_PlacingDefinition_angle}
...
shape_ShapeLayout.attributes={shape_ShapeLayout_maxwidth, shape_ShapeLayout_minheight, shape_ShapeLayout_stretchV, shape_ShapeLayout_stretchH, shape_ShapeLayout_proportional, shape_ShapeLayout_minwidth, shape_ShapeLayout_maxheight}
...
shape_Description.attributes={shape_Description_hAlign, shape_Description_vAlign, shape_Description_style}
...
shape_RoundedRectangleLayout.attributes={shape_RoundedRectangleLayout_curveWidth, shape_RoundedRectangleLayout_curveHeight}
...
shape_TextLayout.attributes={shape_TextLayout_vAlign, shape_TextLayout_hAlign}
...
shape_CompartmentInfo.attributes={shape_CompartmentInfo_stretchH, shape_CompartmentInfo_invisible, shape_CompartmentInfo_compartmentLayout, shape_CompartmentInfo_stretchV, shape_CompartmentInfo_margin, shape_CompartmentInfo_spacing}
...
shape_CommonLayout.attributes={shape_CommonLayout_width, shape_CommonLayout_ycor, shape_CommonLayout_heigth, shape_CommonLayout_xcor}
...
shape_Point.attributes={shape_Point_xcor, shape_Point_curveBefore, shape_Point_ycor, shape_Point_curveAfter}
...
domain_model = DomainModel(
    name="shape",
    types={shape_ShapeContainer, shape_ShapeContainerElement, shape_ConnectionDefinition, ShapeContainerElement, shape_ShapestyleLayout, shape_PlacingDefinition, shape_ShapeDefinition, shape_ShapeLayout, shape_Shape, shape_Description, shape_Anchor, shape_ShapeConnection, shape_AnchorType, shape_AnchorPredefinied, AnchorType, shape_TextBody, shape_AnchorManual, shape_AnchorPosition, shape_AnchorPositionPos, shape_AnchorRelativePosition, AnchorPositionPos, shape_AnchorFixPointPosition, shape_CDLine, ShapeConnection, shape_LineLayout, shape_CDPolyline, shape_PolyLineLayout, shape_CDRectangle, shape_RectangleEllipseLayout, shape_CDRoundedRectangle, shape_RoundedRectangleLayout, shape_CDPolygon, shape_CDEllipse, shape_CDText, shape_TextLayout, shape_Line, Shape, shape_Polyline, shape_Rectangle, shape_CompartmentInfo, shape_RoundedRectangle, shape_Polygon, shape_Ellipse, shape_Text, shape_Compartment, shape_CompartmentShape, shape_CompartmentRectangle, CompartmentShape, shape_CompartmentRoundedRectangle, shape_CompartmentPolygon, shape_CompartmentEllipse, shape_CommonLayout, shape_Point, CompartmentLayout, HAlign, VAlign, ConnectionStyle, AnchorPredefiniedEnum, TextType},
    associations={shapeContainerElement0, layout1, placing2, shapeLayout4, shape5, description7, anchor9, shapeCon11, type13, position15, pos16, layout18, layout19, layout20, layout21, layout22, layout24, layout26, body27, layout29, layout31, compartmentInfo33, layout34, shape37, layout40, shape42, layout45, shape47, compartmentInfo50, layout52, layout58, body60, id63, shape66, layout67, id70, layout73, id75, layout78, id80, body83, shape55, common86, layout88, point91, layout93, point96, layout99, common102, layout105, common108, layout111},
    generalizations={gen_shape_ConnectionDefinition_ShapeContainerElement, gen_shape_ShapeDefinition_ShapeContainerElement, gen_shape_AnchorPredefinied_AnchorType, gen_shape_AnchorManual_AnchorType, gen_shape_AnchorRelativePosition_AnchorPositionPos, gen_shape_AnchorFixPointPosition_AnchorPositionPos, gen_shape_CDLine_ShapeConnection, gen_shape_CDPolyline_ShapeConnection, gen_shape_CDRectangle_ShapeConnection, gen_shape_CDRoundedRectangle_ShapeConnection, gen_shape_CDPolygon_ShapeConnection, gen_shape_CDEllipse_ShapeConnection, gen_shape_CDText_ShapeConnection, gen_shape_Line_Shape, gen_shape_Polyline_Shape, gen_shape_Rectangle_Shape, gen_shape_RoundedRectangle_Shape, gen_shape_Polygon_Shape, gen_shape_Ellipse_Shape, gen_shape_Text_Shape, gen_shape_CompartmentRectangle_CompartmentShape, gen_shape_CompartmentEllipse_CompartmentShape},
    metadata=None
)
