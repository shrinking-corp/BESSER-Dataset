...
# Classes
trip_Car = Class(name="trip_Car")
Vehicle = Class(name="Vehicle")
trip_Trip = Class(name="trip_Trip")
NamedElement = Class(name="NamedElement")
trip_Vehicle = Class(name="trip_Vehicle", is_abstract=True)
trip_Person = Class(name="trip_Person")
trip_TripModel = Class(name="trip_TripModel")
trip_NamedElement = Class(name="trip_NamedElement", is_abstract=True)
trip_Van = Class(name="trip_Van")
...
domain_model = DomainModel(
    name="trip",
    types={trip_Car, Vehicle, trip_Trip, NamedElement, trip_Vehicle, trip_Person, trip_TripModel, trip_NamedElement, trip_Van},
    associations={driver2, trips4, vehicle0, passengers1, elements5},
    generalizations={gen_trip_Vehicle_NamedElement, gen_trip_Person_NamedElement, gen_trip_Car_Vehicle, gen_trip_Trip_NamedElement, gen_trip_TripModel_NamedElement, gen_trip_Van_Vehicle},
    metadata=None
)
