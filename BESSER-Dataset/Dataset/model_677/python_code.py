...
class emof_Class(Type):
    ...
    def __init__(self, isAbstract: str, class_: set["emof_Property"] = None, class_2: set["emof_Operation"] = None, emof_Class: "emof_Class" = None, emof_Class3: set["emof_Class"] = None, Class: "emof_Operation" = None, Class20: "emof_Property" = None):
