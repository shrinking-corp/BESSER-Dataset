...
class qvtoperational_cst_ResolveExpCS(CallExpCS):
    ...
    def __init__(self, isDeferred: bool, one: bool, isInverse: bool, qvtoperational_cst_ResolveExpCS: "VariableCS" = None, qvtoperational_cst_ResolveExpCS158: "OCLExpressionCS" = None):
...
class qvtoperational_cst_ModuleUsageCS(CSTNode):
    ...
    def __init__(self, importKind: str, qvtoperational_cst_ModuleUsageCS: "ModuleKindCS" = None, qvtoperational_cst_ModuleUsageCS199: set["ModuleRefCS"] = None, CSTNode: "qvtoperational_cst_UnitCS" = None):
...
class qvtoperational_cst_MappingQueryCS(MappingMethodCS):
    ...
    def __init__(self, isSimpleDefinition: bool, qvtoperational_cst_MappingQueryCS: set["OCLExpressionCS"] = None, MappingMethodCS: "qvtoperational_cst_MappingModuleCS" = None):
