...
# Classes
studyprogramme_Course = Class(name="studyprogramme_Course")
studyprogramme_Programme = Class(name="studyprogramme_Programme")
SemesterContainer = Class(name="SemesterContainer")
studyprogramme_Specialization = Class(name="studyprogramme_Specialization")
studyprogramme_CourseSlot = Class(name="studyprogramme_CourseSlot")
studyprogramme_SemesterContainer = Class(name="studyprogramme_SemesterContainer")
studyprogramme_ElectiveCourseList = Class(name="studyprogramme_ElectiveCourseList")
studyprogramme_ElectiveCourseSlot = Class(name="studyprogramme_ElectiveCourseSlot")
studyprogramme_University = Class(name="studyprogramme_University")
CourseSlot = Class(name="CourseSlot")
studyprogramme_CompulsoryCourseSlot = Class(name="studyprogramme_CompulsoryCourseSlot")
studyprogramme_Semester = Class(name="studyprogramme_Semester")
...
studyprogramme_Course.attributes={studyprogramme_Course_displayedName, studyprogramme_Course_level, studyprogramme_Course_credits, studyprogramme_Course_courseCode, studyprogramme_Course_name}
...
studyprogramme_Programme.attributes={studyprogramme_Programme_name, studyprogramme_Programme_programmeCode, studyprogramme_Programme_numberOfYears, studyprogramme_Programme_programmeType}
...
studyprogramme_Specialization.attributes={studyprogramme_Specialization_name, studyprogramme_Specialization_selectionSemester}
...
domain_model = DomainModel(
    name="studyprogramme",
    types={studyprogramme_Course, studyprogramme_Programme, SemesterContainer, studyprogramme_Specialization, studyprogramme_CourseSlot, studyprogramme_SemesterContainer, studyprogramme_ElectiveCourseList, studyprogramme_ElectiveCourseSlot, studyprogramme_University, CourseSlot, studyprogramme_CompulsoryCourseSlot, studyprogramme_Semester, ProgrammeCode, ProgrammeType},
    associations={specializations0, programme1, subSpecialisations3, slots8, course9, semesters11, availableCourses13, electiveCourseSlot15, programmes16, courses17, Semesters20, specialisations23, electiveCourseList25, assignedCourse26, parrentSpecialisation6},
