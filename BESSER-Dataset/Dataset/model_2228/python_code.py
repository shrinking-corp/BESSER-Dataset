...
class studyprogramme_Semester:
    ...
    def __init__(self, semesterNumber: int, studyprogramme_Semester: set["studyprogramme_CourseSlot"] = None, studyprogramme_Semester12: "studyprogramme_SemesterContainer" = None, studyprogramme_Semester22: "studyprogramme_University" = None):
...
class studyprogramme_University:
    ...
    def __init__(self, name: str, studyprogramme_University: set["studyprogramme_Programme"] = None, studyprogramme_University18: set["studyprogramme_Course"] = None, studyprogramme_University21: set["studyprogramme_Semester"] = None, studyprogramme_University24: set["studyprogramme_Specialization"] = None):
        self.name = name
...
class studyprogramme_Specialization(SemesterContainer):
    ...
    def __init__(self, name: str, selectionSemester: int, Specialization: "studyprogramme_Programme" = None, specializations: "studyprogramme_Programme" = None, Specialization4: "studyprogramme_Specialization" = None, parrentSpecialisation: set["studyprogramme_Specialization"] = None, studyprogramme_Specialization: "studyprogramme_University" = None, Specialization7: "studyprogramme_Specialization" = None, subSpecialisations: "studyprogramme_Specialization" = None):
        self.name = name
...
class studyprogramme_Programme(SemesterContainer):
    ...
    def __init__(self, name: str, programmeCode: str, numberOfYears: int, programmeType: str, programme: set["studyprogramme_Specialization"] = None, Programme: "studyprogramme_Specialization" = None, studyprogramme_Programme: "studyprogramme_University" = None):
        self.name = name
...
class studyprogramme_Course:
    ...
    def __init__(self, name: str, courseCode: str, credits: float, level: int, displayedName: str, studyprogramme_Course: "studyprogramme_CourseSlot" = None, studyprogramme_Course14: "studyprogramme_ElectiveCourseList" = None, studyprogramme_Course19: "studyprogramme_University" = None, studyprogramme_Course27: "studyprogramme_ElectiveCourseSlot" = None):
        self.name = name
