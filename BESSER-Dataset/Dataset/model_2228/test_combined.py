...
def test_hyp_studyprogramme_compulsorycourseslot_is_not_abstract():
    assert not inspect.isabstract(studyprogramme_CompulsoryCourseSlot)


def test_hyp_studyprogramme_compulsorycourseslot_constructor_exists():
    assert callable(studyprogramme_CompulsoryCourseSlot.__init__)


def test_hyp_studyprogramme_compulsorycourseslot_constructor_args():
    sig = inspect.signature(studyprogramme_CompulsoryCourseSlot.__init__)
    params = list(sig.parameters.keys())



def test_hyp_studyprogramme_university_is_not_abstract():
    assert not inspect.isabstract(studyprogramme_University)


def test_hyp_studyprogramme_university_constructor_exists():
    assert callable(studyprogramme_University.__init__)


def test_hyp_studyprogramme_university_constructor_args():
...
def test_hyp_studyprogramme_electivecourseslot_is_not_abstract():
    assert not inspect.isabstract(studyprogramme_ElectiveCourseSlot)


def test_hyp_studyprogramme_electivecourseslot_constructor_exists():
    assert callable(studyprogramme_ElectiveCourseSlot.__init__)


def test_hyp_studyprogramme_electivecourseslot_constructor_args():
    sig = inspect.signature(studyprogramme_ElectiveCourseSlot.__init__)
    params = list(sig.parameters.keys())



def test_hyp_studyprogramme_electivecourselist_is_not_abstract():
    assert not inspect.isabstract(studyprogramme_ElectiveCourseList)


def test_hyp_studyprogramme_electivecourselist_constructor_exists():
    assert callable(studyprogramme_ElectiveCourseList.__init__)


def test_hyp_studyprogramme_electivecourselist_constructor_args():
...
def test_hyp_studyprogramme_semestercontainer_is_not_abstract():
    assert not inspect.isabstract(studyprogramme_SemesterContainer)


def test_hyp_studyprogramme_semestercontainer_constructor_exists():
    assert callable(studyprogramme_SemesterContainer.__init__)


def test_hyp_studyprogramme_semestercontainer_constructor_args():
    sig = inspect.signature(studyprogramme_SemesterContainer.__init__)
    params = list(sig.parameters.keys())



def test_hyp_studyprogramme_courseslot_is_not_abstract():
    assert not inspect.isabstract(studyprogramme_CourseSlot)


def test_hyp_studyprogramme_courseslot_constructor_exists():
    assert callable(studyprogramme_CourseSlot.__init__)


def test_hyp_studyprogramme_courseslot_constructor_args():
    sig = inspect.signature(studyprogramme_CourseSlot.__init__)
    params = list(sig.parameters.keys())



def test_hyp_semestercontainer_is_not_abstract():
    assert not inspect.isabstract(SemesterContainer)


def test_hyp_semestercontainer_constructor_exists():
    assert callable(SemesterContainer.__init__)


def test_hyp_semestercontainer_constructor_args():
...
def test_hyp_studyprogramme_semester_semesterNumber_setter(instance):
...
def test_hyp_studyprogramme_university_name_setter(instance):
...
def test_hyp_studyprogramme_electivecourselist_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_studyprogramme_specialization_selectionSemester_setter(instance):
...
@given(instance=studyprogramme_Programme_strategy)
def test_hyp_studyprogramme_programme_numberOfYears_setter(instance):
...
@given(instance=studyprogramme_Programme_strategy)
def test_hyp_studyprogramme_programme_programmeType_setter(instance):
...
@given(instance=studyprogramme_Programme_strategy)
def test_hyp_studyprogramme_programme_programmeCode_setter(instance):
...
@given(instance=studyprogramme_Course_strategy)
def test_hyp_studyprogramme_course_displayedName_setter(instance):
...
@given(instance=studyprogramme_Course_strategy)
def test_hyp_studyprogramme_course_courseCode_setter(instance):
