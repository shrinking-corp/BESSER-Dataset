...
# Classes
StateMachine_StateVertex = Class(name="StateMachine_StateVertex", is_abstract=True)
...
StateMachine_SimpleState = Class(name="StateMachine_SimpleState")
...
domain_model = DomainModel(
    name="StateMachine",
    types={StateMachine_StateVertex, StateMachine_Transition, StateMachine_Event, StateMachine_InitialState, StateMachine_StateMachine, StateVertex, StateMachine_SimpleState, StateMachine_FinalState},
