...
apromore_Node.attributes={apromore_Node_configurable, apromore_Node_ident, apromore_Node_name}
...
domain_model = DomainModel(
    name="apromore",
    types={apromore_Edge, apromore_Work, Node, apromore_Event, Work, apromore_Message, Event, apromore_Time, apromore_Task, apromore_Routing, apromore_Split, Routing, apromore_CanonicalProcess, apromore_Net, apromore_Node, apromore_ORSplit, Split, apromore_XORSplit, apromore_ANDSplit, apromore_State, apromore_Join, apromore_ORJoin, Join, apromore_XORJoin, apromore_ANDJoin},
    associations={edges6, source8, target11, subnet14, nets0, root1, nodes4},
