...
class XHTML_Em(Attrs, Phrase):
    ...
    pass
class XHTML_Ins(Miscinline, Attrs):

    pass
class XHTML_Ul(Attrs, Lists):

    pass
class XHTML_Pre(Attrs, Blocktext):
...
class XHTML_Dfn(Attrs, Phrase):
    ...
    pass
class XHTML_Address(Attrs, Blocktext):
...
class XHTML_Span(Attrs, Specialpre):
    ...
    pass
class XHTML_Blockquote(Attrs, Blocktext):

    pass
class EMPTY:

    pass
class XHTML_Hr(Attrs, Blocktext, EMPTY):
...
class HeadMisc:
    ...
    pass
class XHTML_Link(Attrs, EMPTY, HeadMisc):

    pass
class XHTML_Meta(EMPTY, HeadMisc):
...
class PCDATA:
    ...
    pass
class XHTML_Script(Miscinline, PCDATA, HeadMisc):

    def __init__(self, defer: str, xml_space: str, XHTML_Script: "ID" = None, XHTML_Script169: "Charset" = None, XHTML_Script172: "ContentType" = None, XHTML_Script175: "URI" = None, PCDATA55: "XHTML_Flow" = None, PCDATA: "XHTML_Inline" = None, PCDATA501: "XHTML_FieldsetElement" = None, PCDATA61: "XHTML_ButtonContent" = None, PCDATA59: "XHTML_PreContent" = None, PCDATA57: "XHTML_AContent" = None, PCDATA308: "XHTML_ObjectElement" = None, HeadMisc94: "XHTML_BaseTitleHeadElement" = None, HeadMisc106: "XHTML_TitleBaseHeadElement" = None, HeadMisc: "XHTML_Head" = None, HeadMisc99: "XHTML_BaseHeadElement" = None, HeadMisc88: "XHTML_TitleHeadElement" = None):
        self.defer = defer
        self.xml_space = xml_space
...
class Flow:
    ...
    pass
class XHTML_Inline(ObjectElement, Flow, FieldsetElement):

    pass
class Block:

    pass
class XHTML_block(MapElementContent, FieldsetElement, ObjectElement, FormContent, Flow, Block):
...
class Misc:
    ...
    pass
class XHTML_Noscript(Attrs, Misc):
...
class ButtonContent:
    ...
    pass
class XHTML_Misc(MapElementContent, FieldsetElement, ButtonContent, ObjectElement, Flow, FormContent, Block):
...
class PreContent:
    ...
    pass
class XHTML_Miscinline(Misc, Inline, AContent, PreContent):

    pass
class XHTML_Inlineforms(PreContent, AContent, inline):

    pass
class XHTML_Phrase(ButtonContent, inline, AContent, PreContent):

    pass
class XHTML_Fontstyle(AContent, inline, ButtonContent, PreContent):

    pass
class XHTML_A(Attrs, PreContent, Focus, inline):
...
class CoreAttrs:
    ...
    pass
class XHTML_Br(Specialpre, EMPTY, CoreAttrs):

    pass
class XHTML_Bdo(Events, Specialpre, CoreAttrs):
...
class XHTML_Attrs(Events, I18n, CoreAttrs):
...
class XHTML_Tfoot(Attrs, Cellhalign, Cellvalign):
    ...
    pass
class XHTML_Th(Attrs, Cellvalign, Cellhalign, TrElement):

    def __init__(self, scope: str, XHTML_Th579: "IDREFS" = None, XHTML_Th581: "Number" = None, XHTML_Th: set["Flow"] = None, XHTML_Th573: "Text" = None, XHTML_Th576: "CDATA" = None, XHTML_Th584: "Number" = None, TrElement: "XHTML_Tr" = None):
        self.scope = scope
...
class XHTML_Tbody(Attrs, Cellhalign, Cellvalign):
    ...
    pass
class XHTML_Td(Attrs, Cellhalign, TrElement, Cellvalign):

    def __init__(self, scope: str, XHTML_Td: set["Flow"] = None, XHTML_Td595: "IDREFS" = None, XHTML_Td589: "Text" = None, XHTML_Td598: "Number" = None, XHTML_Td592: "CDATA" = None, XHTML_Td601: "Number" = None, TrElement: "XHTML_Tr" = None):
        self.scope = scope
...
class XHTML_Colgroup(Attrs, Cellvalign, Cellhalign):

    pass
class XHTML_Col(Attrs, Cellvalign, EMPTY, Cellhalign):

    pass
class XHTML_Thead(Attrs, Cellvalign, Cellhalign):
...
class XHTML_Table(Attrs, block, ButtonContent):
    ...
    def __init__(self, frame: str, rules: str, XHTML_Table524: "Thead" = None, XHTML_Table526: "Tfoot" = None, XHTML_Table528: "TableElement" = None, XHTML_Table530: "Text" = None, XHTML_Table533: "Length" = None, XHTML_Table538: "Length" = None, XHTML_Table541: "Length" = None, XHTML_Table536: "Pixels" = None, XHTML_Table: set["Caption"] = None, XHTML_Table522: "ColElement" = None, ButtonContent: "XHTML_Button" = None):
        self.frame = frame
        self.rules = rules
...
class XHTML_Legend(Attrs, FieldsetElement):
...
class SelectElement:
    ...
    pass
class XHTML_Option(Attrs, PCDATA, SelectElement):

    def __init__(self, selected: str, disabled: str, XHTML_Option: "Text" = None, XHTML_Option484: "CDATA" = None, SelectElement: "XHTML_Select" = None, PCDATA55: "XHTML_Flow" = None, PCDATA: "XHTML_Inline" = None, PCDATA501: "XHTML_FieldsetElement" = None, PCDATA61: "XHTML_ButtonContent" = None, PCDATA59: "XHTML_PreContent" = None, PCDATA57: "XHTML_AContent" = None, PCDATA308: "XHTML_ObjectElement" = None):
...
class XHTML_Optgroup(Attrs, SelectElement):
...
class Inlineforms:
    ...
    pass
class XHTML_Button(Attrs, Inlineforms, Focus):

    def __init__(self, type: str, disabled: str, XHTML_Button: set["ButtonContent"] = None, XHTML_Button513: "CDATA" = None, XHTML_Button510: "CDATA" = None):
        self.type = type
        self.disabled = disabled
...
class XHTML_Select(Attrs, Inlineforms):
    ...
    def __init__(self, multiple: str, disabled: str, XHTML_Select: set["SelectElement"] = None, XHTML_Select463: "Number" = None, XHTML_Select466: "Number" = None, XHTML_Select469: "ScriptExpression" = None, XHTML_Select472: "ScriptExpression" = None, XHTML_Select475: "ScriptExpression" = None, XHTML_Select460: "CDATA" = None):
...
class XHTML_Textarea(Attrs, Inlineforms, PCDATA, Focus):

    def __init__(self, disabled: str, readonly: str, XHTML_Textarea489: "Number" = None, XHTML_Textarea492: "Number" = None, XHTML_Textarea495: "ScriptExpression" = None, XHTML_Textarea498: "ScriptExpression" = None, XHTML_Textarea: "CDATA" = None, PCDATA55: "XHTML_Flow" = None, PCDATA: "XHTML_Inline" = None, PCDATA501: "XHTML_FieldsetElement" = None, PCDATA61: "XHTML_ButtonContent" = None, PCDATA59: "XHTML_PreContent" = None, PCDATA57: "XHTML_AContent" = None, PCDATA308: "XHTML_ObjectElement" = None):
        self.disabled = disabled
...
class XHTML_Input(Attrs, Inlineforms, Focus, EMPTY):

    def __init__(self, type: str, checked: str, disabled: str, readonly: str, XHTML_Input: "CDATA" = None, XHTML_Input432: "CDATA" = None, XHTML_Input435: "CDATA" = None, XHTML_Input438: "Number" = None, XHTML_Input441: "URI" = None, XHTML_Input444: "CDATA" = None, XHTML_Input447: "URI" = None, XHTML_Input450: "ScriptExpression" = None, XHTML_Input453: "ScriptExpression" = None, XHTML_Input456: "ContentTypes" = None):
        self.type = type
...
class ContentTypes:
    ...
    pass
class XHTML_Form(MapElementContent, FieldsetElement, ObjectElement, Block, Attrs):

    def __init__(self, method: str, XHTML_Form400: "URI" = None, XHTML_Form403: "ContentType" = None, XHTML_Form406: "ScriptExpression" = None, XHTML_Form409: "ScriptExpression" = None, XHTML_Form412: "ContentTypes" = None, XHTML_Form414: "Charsets" = None, XHTML_Form: set["FormContent"] = None, Block179: "XHTML_Body" = None, Block216: "XHTML_Blockquote" = None, Block: "XHTML_Noscript" = None, ObjectElement: "XHTML_Object" = None, FieldsetElement: "XHTML_Fieldset" = None):
        self.method = method
...
class MapContent:
    ...
    pass
class XHTML_Map(Events, I18n, Specialpre):
...
class MapElement:
    ...
    pass
class XHTML_Area(Attrs, EMPTY, Focus, MapElement):
...
class XHTML_MapContent:
    ...
    pass
class XHTML_Img(Attrs, Special, EMPTY):
...
class XHTML_Param(ObjectElement, EMPTY):
    ...
    def __init__(self, valuetype: str, XHTML_Param: "ID" = None, XHTML_Param351: "CDATA" = None, XHTML_Param354: "ContentType" = None, XHTML_Param348: "CDATA" = None, ObjectElement: "XHTML_Object" = None):
...
class UriList:
    ...
    pass
class XHTML_Object(Attrs, Special, HeadMisc):

    def __init__(self, declare: str, XHTML_Object: set["ObjectElement"] = None, XHTML_Object311: "URI" = None, XHTML_Object314: "URI" = None, XHTML_Object317: "URI" = None, XHTML_Object320: "ContentType" = None, XHTML_Object323: "ContentType" = None, XHTML_Object326: "UriList" = None, XHTML_Object328: "Text" = None, XHTML_Object331: "Length" = None, XHTML_Object334: "Length" = None, XHTML_Object337: "URI" = None, XHTML_Object340: "NMTOKEN" = None, XHTML_Object343: "Number" = None, HeadMisc94: "XHTML_BaseTitleHeadElement" = None, HeadMisc106: "XHTML_TitleBaseHeadElement" = None, HeadMisc: "XHTML_Head" = None, HeadMisc99: "XHTML_BaseHeadElement" = None, HeadMisc88: "XHTML_TitleHeadElement" = None):
