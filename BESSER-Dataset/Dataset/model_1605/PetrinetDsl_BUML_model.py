...
domain_model = DomainModel(
    name="petrinetDsl",
    types={petrinetDsl_PetriNet, petrinetDsl_Resource, petrinetDsl_Place, petrinetDsl_Transaction, petrinetDsl_Storage, petrinetDsl_AssureStatement, petrinetDsl_TakeStatement, petrinetDsl_PutStatement},
    associations={resourceRef22, placeRef25, resourceRef28, placeRef31, resources0, places1, transactions3, storages5, resourceRef7, assureStatements10, takeStatements12, putStatements14, resourceRef16, placeRef19},
    generalizations={},
    metadata=None
)
