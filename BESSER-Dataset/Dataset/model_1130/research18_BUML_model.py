...
# Classes
research18_PublicationProcess = Class(name="research18_PublicationProcess")
Named = Class(name="Named")
research18_Phase = Class(name="research18_Phase")
research18_Researcher = Class(name="research18_Researcher")
research18_Review = Class(name="research18_Review")
research18_Paper = Class(name="research18_Paper")
research18_Skill = Class(name="research18_Skill")
research18_Position = Class(name="research18_Position")
research18_Collaboration = Class(name="research18_Collaboration")
research18_Paragraph = Class(name="research18_Paragraph")
research18_Write = Class(name="research18_Write")
Counted = Class(name="Counted")
research18_ReviewNote = Class(name="research18_ReviewNote")
Labelled = Class(name="Labelled")
research18_Progress = Class(name="research18_Progress")
research18_PaperKeyword = Class(name="research18_PaperKeyword")
research18_State = Class(name="research18_State")
research18_PublicationStructure = Class(name="research18_PublicationStructure")
research18_KnowledgeManager = Class(name="research18_KnowledgeManager")
research18_Named = Class(name="research18_Named", is_abstract=True)
research18_Counted = Class(name="research18_Counted", is_abstract=True)
research18_Labelled = Class(name="research18_Labelled", is_abstract=True)
research18_PublicationSystem = Class(name="research18_PublicationSystem")
research18_PublicationStatus = Class(name="research18_PublicationStatus")
research18_StateMachineVariable = Class(name="research18_StateMachineVariable")
research18_Keyword = Class(name="research18_Keyword")
research18_Action = Class(name="research18_Action")
research18_StateMachineObject = Class(name="research18_StateMachineObject", is_abstract=True)
research18_Transition = Class(name="research18_Transition")
...
research18_PublicationProcess.attributes={research18_PublicationProcess_minTime, research18_PublicationProcess_maxTime}
...
research18_State.attributes={research18_State_kind, research18_State_id, research18_State_name}
...
domain_model = DomainModel(
    name="research18",
    types={research18_PublicationProcess, Named, research18_Phase, research18_Researcher, research18_Review, research18_Paper, research18_Skill, research18_Position, research18_Collaboration, research18_Paragraph, research18_Write, Counted, research18_ReviewNote, Labelled, research18_Progress, research18_PaperKeyword, research18_State, research18_PublicationStructure, research18_KnowledgeManager, research18_Named, research18_Counted, research18_Labelled, research18_PublicationSystem, research18_PublicationStatus, research18_StateMachineVariable, research18_Keyword, research18_Action, research18_StateMachineObject, research18_Transition, StateMachineObject, StateType},
    associations={phases0, reviews2, res_papers4, skills5, res_position7, collaborations9, writes1, reviews21, process23, paragraphs11, progress12, authors13, keywords14, citedBy17, state19, reviewNote30, researchers33, papers35, knowledgeMan38, paper25, paragraph27, parent51, processView40, structuralView42, positions45, behaviorView48, allkeywords55, keyword58, col_paper61, machineVariables64, kpapers53, t_actions69, source70, target73, pubStates66, s_actions79, transitions76, next83},
    generalizations={gen_research18_PublicationProcess_Named, gen_research18_Paper_Named, gen_research18_Paragraph_Counted, gen_research18_Paragraph_Named, gen_research18_ReviewNote_Named, gen_research18_Progress_Labelled, gen_research18_PublicationStructure_Named, gen_research18_Write_Labelled, gen_research18_Review_Labelled, gen_research18_Position_Named, gen_research18_PublicationSystem_Named, gen_research18_Keyword_Named, gen_research18_KnowledgeManager_Named, gen_research18_State_StateMachineObject, gen_research18_Transition_StateMachineObject},
    metadata=None
)
