...
class arduino_Project:
    ...
    def __init__(self, Project: "arduino_Board" = None, project: set["arduino_Board"] = None, project10: set["arduino_Sketch"] = None, Project4: "arduino_Sketch" = None):
...
class arduino_Block:
    ...
    def __init__(self, arduino_Block13: "arduino_Control" = None, arduino_Block26: "arduino_If" = None, arduino_Block35: set["arduino_Instruction"] = None, arduino_Block: "arduino_Sketch" = None):
