...
class metrics_Metric(Base):
    ...
    def __init__(self, description: str, measurementKind: str, measurementPoint: str, name: str, metrics_Metric32: "metrics_ValueDataKind" = None, metrics_Metric: "metrics_Metric" = None, metrics_Metric12: set["metrics_Metric"] = None, metrics_Metric15: "metrics_Expression" = None, metrics_Metric17: "metrics_MetricSource" = None, metrics_Metric19: "metrics_Unit" = None):
...
class metrics_MappingStatistic(Base):
    ...
    def __init__(self, intervalEstimate: str, message: str, totalRecords: str, metrics_MappingStatistic29: "metrics_MetricSource" = None, metrics_MappingStatistic: set["metrics_MappingRecord"] = None, metrics_MappingStatistic8: "metrics_DateTimeRange" = None, metrics_MappingStatistic10: "metrics_DateTimeRange" = None):
...
class metrics_MetricSource(Base):
    ...
    def __init__(self, filterPattern: str, metricLocation: str, name: str, metrics_MetricSource28: set["metrics_MappingStatistic"] = None, metrics_MetricSource: "metrics_Metric" = None, metrics_MetricSource25: "metrics_Mapping" = None):
        self.filterPattern = filterPattern
...
class metrics_Mapping(Base):
    ...
    def __init__(self, firstDataRow: str, headerRow: str, intervalHint: str, metrics_Mapping: set["metrics_MappingColumn"] = None, metrics_Mapping2: set["metrics_MappingColumn"] = None, metrics_Mapping26: "metrics_MetricSource" = None):
...
class metrics_IdentifierDataKind(DataKind):
    ...
    def __init__(self, pattern: str, objectKind: str, objectProperty: str):
