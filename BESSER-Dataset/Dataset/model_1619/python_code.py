...
class ptnet_PnObject(ABC):
    ...
    def __init__(self, id: str, PnObject23: "ptnet_Name" = None, PnObject28: "ptnet_ToolInfo" = None, containerPnObject: set["ptnet_ToolInfo"] = None, objects: "ptnet_Page" = None, PnObject: "ptnet_Page" = None, containerNamePnObject: "ptnet_Name" = None):
        self.id = id
...
class ptnet_ToolInfo:
    ...
    def __init__(self, tool: str, version: str, formattedXMLBuffer: str, toolInfoGrammarURI: str, toolspecifics: "ptnet_PetriNet" = None, toolspecifics27: "ptnet_PnObject" = None, toolspecifics30: "ptnet_Label" = None, containerToolInfo: "ptnet_AnyObject" = None, ToolInfo16: "ptnet_PnObject" = None, ToolInfo33: "ptnet_Label" = None, ToolInfo: "ptnet_PetriNet" = None, ToolInfo107: "ptnet_AnyObject" = None):
        self.tool = tool
...
class ptnet_PetriNet:
    ...
    def __init__(self, id: str, type: str, containerNamePetriNet: "ptnet_Name" = None, PetriNet25: "ptnet_ToolInfo" = None, PetriNet20: "ptnet_Name" = None, PetriNet: "ptnet_PetriNetDoc" = None, containerPetriNet6: set["ptnet_ToolInfo"] = None, nets: "ptnet_PetriNetDoc" = None, PetriNet10: "ptnet_Page" = None, containerPetriNet: set["ptnet_Page"] = None):
        self.id = id
        self.type = type
...
class ptnet_Name(Annotation):
    ...
    def __init__(self, text: str, name22: "ptnet_PnObject" = None, name: "ptnet_PetriNet" = None, Name14: "ptnet_PnObject" = None, Name: "ptnet_PetriNet" = None):
        self.text = text
        self.name22 = name22
        self.name = name
        self.Name14 = Name14
