...
class bowling_Fan:
    ...
    def __init__(self, name: str, dateOfBirth: date, hasSeasonTicket: bool, eMails: str, gender: str, moneySpentOnTickets: float, numberOfTournamentsVisited: int, bowling_Fan: "bowling_Player" = None, bowling_Fan32: set["bowling_Merchandise"] = None, bowling_Fan34: "bowling_Merchandise" = None, bowling_Fan37: set["bowling_Tournament"] = None):
        self.name = name
    ...
    @property
    def numberOfTournamentsVisited(self):
...
class bowling_Referee:
    ...
    def __init__(self, dateOfBirth: str, bowling_Referee20: "bowling_RefereeToGamesMap" = None, bowling_Referee: "bowling_League" = None):
        self.dateOfBirth = dateOfBirth
...
class bowling_Game:
    ...
    def __init__(self, frames: int, Game: "bowling_Matchup" = None, bowling_Game23: "bowling_RefereeToGamesMap" = None, games: "bowling_Matchup" = None, bowling_Game: "bowling_Player" = None):
        self.frames = frames
        self.Game = Game
...
class bowling_Tournament:
    ...
    def __init__(self, type: str, priceMoney: float, receivesTrophy: bool, matchDays: date, bowling_Tournament: set["bowling_Matchup"] = None, bowling_Tournament3: set["bowling_PlayerToPointsMap"] = None, bowling_Tournament5: set["bowling_Player"] = None, bowling_Tournament8: set["bowling_RefereeToGamesMap"] = None, bowling_Tournament28: "bowling_Area" = None, bowling_Tournament38: "bowling_Fan" = None):
        self.type = type
...
class bowling_Player:
    ...
    def __init__(self, name: str, dateOfBirth: date, height: float, isProfessional: bool, eMails: str, numberOfVictories: int, playedTournamentTypes: str, winLossRatio: str, gender: str, bowling_Player: "bowling_League" = None, bowling_Player6: "bowling_Tournament" = None, bowling_Player30: "bowling_Fan" = None, bowling_Player12: "bowling_Game" = None, bowling_Player15: "bowling_PlayerToPointsMap" = None):
        self.name = name
        self.dateOfBirth = dateOfBirth
        self.height = height
    ...
    @property
    def playedTournamentTypes(self):
    ...
    def validate(self, bowling_chain, bowling_context) :
