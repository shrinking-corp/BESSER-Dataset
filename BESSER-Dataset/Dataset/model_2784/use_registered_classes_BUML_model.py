...
# Classes
use_registered_classes_A = Class(name="use_registered_classes_A")
use_registered_classes_B = Class(name="use_registered_classes_B")
use_registered_classes_C = Class(name="use_registered_classes_C")
...
use_registered_classes_A.attributes={use_registered_classes_A_z, use_registered_classes_A_y, use_registered_classes_A_x}
