...
class arduinoml_State:
    ...
    def __init__(self, name: str, arduinoml_State9: set["arduinoml_Transition"] = None, arduinoml_State: "arduinoml_Board" = None, arduinoml_State3: "arduinoml_Board" = None, arduinoml_State7: set["arduinoml_Action"] = None, arduinoml_State13: "arduinoml_Transition" = None, arduinoml_State16: "arduinoml_Transition" = None):
        self.name = name
