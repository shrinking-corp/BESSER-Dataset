...
arduinoml_ActuatorState = Class(name="arduinoml_ActuatorState")
...
domain_model = DomainModel(
    ...
    associations={eventCode8, initial0, possibles1, bricks4, actions6, state10, source11, target14, target17, triggers19},
