...
public class RefOntoUML_Classifier extends Namespace, RedefinableElement, Type {
    ...
    public RefOntoUML_Classifier(
        String isAbstract        ArrayList<RefOntoUML_Classifier> refontouml_classifiers,        ArrayList<RefOntoUML_NamedElement> refontouml_namedelements,        ArrayList<RefOntoUML_Classifier> refontouml_classifiers    ) {
        this.isAbstract = isAbstract;
