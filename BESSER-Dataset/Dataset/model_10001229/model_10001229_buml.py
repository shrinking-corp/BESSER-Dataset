...
Customer.attributes={Customer_dateOfBirth, Customer_phoneNumber, Customer_address, Customer_name, Customer_emailAddress}
...
Login.attributes={Login_lastLoginTime, Login_securityAnswer, Login_username, Login_securityQuestion, Login_password}
...
domain_model = DomainModel(
    name="_95feec8a_4d41_4c6a_be7a_ee7beefb23bc",
    types={Customer, Login, transaction_Transaction, transaction_DepositTransaction, transaction_WithdrawTransaction, transaction_TransferTransaction, account_SavingsAccount, account_CertificatesOfDepositAccount, account_CheckingAccount, account_Account, MyClass, transaction_TransactionType, account_AccountType},
