...
public class Docbook_TermType  {
    ...
    public Docbook_TermType(
        String mixed        ArrayList<Docbook_OptionType> docbook_optiontypes,        ArrayList<Docbook_EnvarType> docbook_envartypes,        ArrayList<Docbook_EmphasisType> docbook_emphasistypes,        ArrayList<Docbook_FileNameType> docbook_filenametypes    ) {
        this.mixed = mixed;
