...
# Classes
Docbook_AbstractType = Class(name="Docbook_AbstractType")
Docbook_ParaType = Class(name="Docbook_ParaType")
Docbook_AddressType = Class(name="Docbook_AddressType")
Docbook_ArgType = Class(name="Docbook_ArgType")
Docbook_OptionType = Class(name="Docbook_OptionType")
Docbook_ReplaceableType = Class(name="Docbook_ReplaceableType")
Docbook_AuthorinitialsType = Class(name="Docbook_AuthorinitialsType")
Docbook_AuthorType = Class(name="Docbook_AuthorType")
Docbook_PersonnameType = Class(name="Docbook_PersonnameType")
Docbook_OtheraddrType = Class(name="Docbook_OtheraddrType")
Docbook_TitleType = Class(name="Docbook_TitleType")
Docbook_BookType = Class(name="Docbook_BookType")
Docbook_InfoType = Class(name="Docbook_InfoType")
Docbook_PrefaceType = Class(name="Docbook_PrefaceType")
Docbook_ChapterType = Class(name="Docbook_ChapterType")
Docbook_ReferenceType = Class(name="Docbook_ReferenceType")
Docbook_NoteType = Class(name="Docbook_NoteType")
Docbook_SectionType = Class(name="Docbook_SectionType")
Docbook_ColspecType = Class(name="Docbook_ColspecType")
Docbook_CmdsynopsisType = Class(name="Docbook_CmdsynopsisType")
Docbook_CommandType = Class(name="Docbook_CommandType")
Docbook_DocumentRoot = Class(name="Docbook_DocumentRoot")
Docbook_EStringToStringMapEntry = Class(name="Docbook_EStringToStringMapEntry")
Docbook_ConfgroupType = Class(name="Docbook_ConfgroupType")
Docbook_CopyrightType = Class(name="Docbook_CopyrightType")
Docbook_DateType = Class(name="Docbook_DateType")
Docbook_EmphasisType = Class(name="Docbook_EmphasisType")
Docbook_EntryType = Class(name="Docbook_EntryType")
Docbook_FigureType = Class(name="Docbook_FigureType")
Docbook_InformaltableType = Class(name="Docbook_InformaltableType")
Docbook_ItemizedlistType = Class(name="Docbook_ItemizedlistType")
Docbook_FootnoteType = Class(name="Docbook_FootnoteType")
Docbook_ImagedataType = Class(name="Docbook_ImagedataType")
Docbook_ImageobjectType = Class(name="Docbook_ImageobjectType")
Docbook_ImportantType = Class(name="Docbook_ImportantType")
Docbook_LiteralType = Class(name="Docbook_LiteralType")
Docbook_KeywordsetType = Class(name="Docbook_KeywordsetType")
Docbook_LinkType = Class(name="Docbook_LinkType")
Docbook_ListitemType = Class(name="Docbook_ListitemType")
Docbook_MediaobjectType = Class(name="Docbook_MediaobjectType")
Docbook_OrderedlistType = Class(name="Docbook_OrderedlistType")
Docbook_PublisherType = Class(name="Docbook_PublisherType")
Docbook_PhraseType = Class(name="Docbook_PhraseType")
Docbook_RowType = Class(name="Docbook_RowType")
Docbook_ProgramlistingType = Class(name="Docbook_ProgramlistingType")
Docbook_TableType = Class(name="Docbook_TableType")
Docbook_TbodyType = Class(name="Docbook_TbodyType")
Docbook_TipType = Class(name="Docbook_TipType")
Docbook_UlinkType = Class(name="Docbook_UlinkType")
Docbook_TgroupType = Class(name="Docbook_TgroupType")
Docbook_TheadType = Class(name="Docbook_TheadType")
Docbook_ExampleType = Class(name="Docbook_ExampleType")
Docbook_EnvarType = Class(name="Docbook_EnvarType")
Docbook_FirstnameType = Class(name="Docbook_FirstnameType")
Docbook_FuncdefType = Class(name="Docbook_FuncdefType")
Docbook_FunctionType = Class(name="Docbook_FunctionType")
Docbook_FileNameType = Class(name="Docbook_FileNameType")
Docbook_FuncsynopsisType = Class(name="Docbook_FuncsynopsisType")
Docbook_FuncprototypeType = Class(name="Docbook_FuncprototypeType")
Docbook_ParamdefType = Class(name="Docbook_ParamdefType")
Docbook_SubtitleType = Class(name="Docbook_SubtitleType")
Docbook_LegalNoticeType = Class(name="Docbook_LegalNoticeType")
Docbook_RevhistoryType = Class(name="Docbook_RevhistoryType")
Docbook_ParameterType = Class(name="Docbook_ParameterType")
ItemizedlistType = Class(name="ItemizedlistType")
Docbook_VariableListType = Class(name="Docbook_VariableListType")
Docbook_SurnameType = Class(name="Docbook_SurnameType")
Docbook_RefEntryType = Class(name="Docbook_RefEntryType")
Docbook_RefMetaType = Class(name="Docbook_RefMetaType")
Docbook_RefNameDivType = Class(name="Docbook_RefNameDivType")
Docbook_RefSynopsisDivType = Class(name="Docbook_RefSynopsisDivType")
Docbook_RefSect1Type = Class(name="Docbook_RefSect1Type")
Docbook_RefEntryTitleType = Class(name="Docbook_RefEntryTitleType")
Docbook_SegmentedListType = Class(name="Docbook_SegmentedListType")
Docbook_RevisionType = Class(name="Docbook_RevisionType")
Docbook_RevnumberType = Class(name="Docbook_RevnumberType")
Docbook_RevdescriptionType = Class(name="Docbook_RevdescriptionType")
Docbook_SegListItemType = Class(name="Docbook_SegListItemType")
Docbook_SegType = Class(name="Docbook_SegType")
Docbook_TermType = Class(name="Docbook_TermType")
Docbook_VarListEntryType = Class(name="Docbook_VarListEntryType")
...
Docbook_ParaType.attributes={Docbook_ParaType_role, Docbook_ParaType_mixed, Docbook_ParaType_group, Docbook_ParaType_id}
...
Docbook_AddressType.attributes={Docbook_AddressType_email, Docbook_AddressType_format, Docbook_AddressType_state}
...
Docbook_ArgType.attributes={Docbook_ArgType_mixed, Docbook_ArgType_rep, Docbook_ArgType_choice}
...
Docbook_BookType.attributes={Docbook_BookType_version, Docbook_BookType_label, Docbook_BookType_lang}
...
Docbook_InfoType.attributes={Docbook_InfoType_pubdate, Docbook_InfoType_date, Docbook_InfoType_productname, Docbook_InfoType_group, Docbook_InfoType_bibliomisc, Docbook_InfoType_releaseinfo}
...
Docbook_NoteType.attributes={Docbook_NoteType_mixed, Docbook_NoteType_group}
...
Docbook_SectionType.attributes={Docbook_SectionType_annotations, Docbook_SectionType_group, Docbook_SectionType_warning, Docbook_SectionType_caution}
...
Docbook_ColspecType.attributes={Docbook_ColspecType_colwidth, Docbook_ColspecType_colname}
...
Docbook_DocumentRoot.attributes={Docbook_DocumentRoot_publishername, Docbook_DocumentRoot_conftitle, Docbook_DocumentRoot_bibliomisc, Docbook_DocumentRoot_confnum, Docbook_DocumentRoot_subtitle, Docbook_DocumentRoot_superscript, Docbook_DocumentRoot_date, Docbook_DocumentRoot_keyword, Docbook_DocumentRoot_caution, Docbook_DocumentRoot_confsponsor, Docbook_DocumentRoot_firstname, Docbook_DocumentRoot_state, Docbook_DocumentRoot_warning, Docbook_DocumentRoot_pubdate, Docbook_DocumentRoot_mixed}
...
Docbook_ConfgroupType.attributes={Docbook_ConfgroupType_confsponsor, Docbook_ConfgroupType_conftitle, Docbook_ConfgroupType_confnum}
...
Docbook_CopyrightType.attributes={Docbook_CopyrightType_holder, Docbook_CopyrightType_year, Docbook_CopyrightType_group}
...
Docbook_EntryType.attributes={Docbook_EntryType_nameend, Docbook_EntryType_namest, Docbook_EntryType_mixed, Docbook_EntryType_valign, Docbook_EntryType_morerows, Docbook_EntryType_align}
...
Docbook_FigureType.attributes={Docbook_FigureType_id, Docbook_FigureType_float}
...
Docbook_ImagedataType.attributes={Docbook_ImagedataType_fileref, Docbook_ImagedataType_align, Docbook_ImagedataType_scale, Docbook_ImagedataType_width, Docbook_ImagedataType_depth}
...
Docbook_ImportantType.attributes={Docbook_ImportantType_mixed, Docbook_ImportantType_group}
...
Docbook_LinkType.attributes={Docbook_LinkType_mixed, Docbook_LinkType_value, Docbook_LinkType_linkend}
...
Docbook_OrderedlistType.attributes={Docbook_OrderedlistType_inheritnum, Docbook_OrderedlistType_continuation}
...
Docbook_ProgramlistingType.attributes={Docbook_ProgramlistingType_group, Docbook_ProgramlistingType_language, Docbook_ProgramlistingType_mixed, Docbook_ProgramlistingType_linenumbering, Docbook_ProgramlistingType_format, Docbook_ProgramlistingType_superscript}
...
Docbook_TgroupType.attributes={Docbook_TgroupType_rowseq, Docbook_TgroupType_align, Docbook_TgroupType_cols, Docbook_TgroupType_colseq}
...
Docbook_SubtitleType.attributes={Docbook_SubtitleType_group, Docbook_SubtitleType_mixed}
...
Docbook_RefNameDivType.attributes={Docbook_RefNameDivType_refpurpose, Docbook_RefNameDivType_refclass, Docbook_RefNameDivType_refname}
...
Docbook_SegType.attributes={Docbook_SegType_errortext, Docbook_SegType_group, Docbook_SegType_errorcode, Docbook_SegType_mixed}
...
domain_model = DomainModel(
    name="Docbook",
    types={Docbook_AbstractType, Docbook_ParaType, Docbook_AddressType, Docbook_ArgType, Docbook_OptionType, Docbook_ReplaceableType, Docbook_AuthorinitialsType, Docbook_AuthorType, Docbook_PersonnameType, Docbook_OtheraddrType, Docbook_TitleType, Docbook_BookType, Docbook_InfoType, Docbook_PrefaceType, Docbook_ChapterType, Docbook_ReferenceType, Docbook_NoteType, Docbook_SectionType, Docbook_ColspecType, Docbook_CmdsynopsisType, Docbook_CommandType, Docbook_DocumentRoot, Docbook_EStringToStringMapEntry, Docbook_ConfgroupType, Docbook_CopyrightType, Docbook_DateType, Docbook_EmphasisType, Docbook_EntryType, Docbook_FigureType, Docbook_InformaltableType, Docbook_ItemizedlistType, Docbook_FootnoteType, Docbook_ImagedataType, Docbook_ImageobjectType, Docbook_ImportantType, Docbook_LiteralType, Docbook_KeywordsetType, Docbook_LinkType, Docbook_ListitemType, Docbook_MediaobjectType, Docbook_OrderedlistType, Docbook_PublisherType, Docbook_PhraseType, Docbook_RowType, Docbook_ProgramlistingType, Docbook_TableType, Docbook_TbodyType, Docbook_TipType, Docbook_UlinkType, Docbook_TgroupType, Docbook_TheadType, Docbook_ExampleType, Docbook_EnvarType, Docbook_FirstnameType, Docbook_FuncdefType, Docbook_FunctionType, Docbook_FileNameType, Docbook_FuncsynopsisType, Docbook_FuncprototypeType, Docbook_ParamdefType, Docbook_SubtitleType, Docbook_LegalNoticeType, Docbook_RevhistoryType, Docbook_ParameterType, ItemizedlistType, Docbook_VariableListType, Docbook_SurnameType, Docbook_RefEntryType, Docbook_RefMetaType, Docbook_RefNameDivType, Docbook_RefSynopsisDivType, Docbook_RefSect1Type, Docbook_RefEntryTitleType, Docbook_SegmentedListType, Docbook_RevisionType, Docbook_RevnumberType, Docbook_RevdescriptionType, Docbook_SegListItemType, Docbook_SegType, Docbook_TermType, Docbook_VarListEntryType},
    associations={para0, address6, option2, replaceable3, personname5, otheraddr1, title16, para18, info9, preface10, chapter12, reference14, arg26, note21, section23, command25, xMLNSPrefixMap29, info45, chapter48, xSISchemaLocation30, abstract33, address36, author39, book42, emphasis55, entry57, figure59, colspec51, confgroup53, informaltable69, itemizedlist71, footnote61, imagedata63, imageobject65, important67, literal79, keywordset73, link75, listitem77, para91, mediaobject81, note83, orderedlist86, otheraddr88, publisher101, phrase94, preface96, row103, programlisting99, table108, tbody110, section105, tip116, title118, ulink121, tgroup112, thead114, programlisting126, mediaobject129, para132, emphasis124, replaceable135, title137, programlisting139, title142, mediaobject145, replaceable148, para150, function153, funcprototype158, funcdef154, paramdef156, emphasis163, ulink166, tgroup169, author172, imagedata160, keywordset180, abstract183, publisher186, confgroup189, title175, subtitle178, legalnotice196, listitem198, revhistory192, copyright194, para207, orderedlist210, para213, title201, revhistory204, imageobject219, literal222, ulink225, itemizedlist216, ulink231, parameter234, replaceable228, emphasis236, literal239, ulink242, footnote245, link248, variablelist254, firstname256, surname258, title260, itemizedlist251, emphasis272, phrase275, para263, important266, tip269, info281, refmeta283, refnamediv285, refsynopsisdiv287, refsect1289, address278, refentry297, refentrytitle300, info291, title294, para305, variablelist308, segmentedlist311, title302, para319, revision321, revnumber323, date325, cmdsynopsis313, funcsynopsis316, ulink332, entry335, itemizedlist338, authorinitials327, revdescription329, mediaobject341, note344, para347, programlisting350, title356, figure359, informaltable362, orderedlist365, section354, tip371, funcsynopsis374, example377, cmdsynopsis380, table368, seglistitem384, seg383, phrase390, title393, tgroup396, emphasis387, option401, filename404, envar407, row410, colspec413, thead416, emphasis399, row422, ulink425, tbody419, phrase431, emphasis434, varlistentry437, emphasis428, term439, listitem442},
