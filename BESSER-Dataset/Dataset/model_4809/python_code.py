...
class model_PrimaryObject:
    ...
    def __init__(self, name: str, idAttribute: str, unsettableAttribute: str, unsettableAttributeWithNonNullDefault: str, featureMapReferenceCollection: str, featureMapAttributeType1: str, featureMapAttributeType2: str, featureMapAttributeCollection: str, model_PrimaryObject36: set["model_TargetObject"] = None, model_PrimaryObject: "model_TargetObject" = None, model_PrimaryObject10: "model_PrimaryObject" = None, model_PrimaryObject8: "model_PrimaryObject" = None, model_PrimaryObject12: "model_TargetObject" = None, model_PrimaryObject15: set["model_TargetObject"] = None, model_PrimaryObject18: "model_TargetObject" = None, model_PrimaryObject21: set["model_TargetObject"] = None, model_PrimaryObject24: "model_TargetObject" = None, model_PrimaryObject27: set["model_TargetObject"] = None, model_PrimaryObject30: "model_TargetObject" = None, model_PrimaryObject33: set["model_TargetObject"] = None):
        self.name = name
    ...
    @property
    def unsettableAttributeWithNonNullDefault(self):
...
class model_ETypes:
    ...
    def __init__(self, eString: str, eStrings: str, eBoolean: bool, eBooleans: str, eInt: int, eInts: int, doubleValue: str, eDouble: float, eDoubles: str, eBigDecimal: str, eBigInteger: str, eByte: str, eByteArray: str, eChar: str, eDate: date, eFloat: float, eLong: str, eShort: str, uris: str):
