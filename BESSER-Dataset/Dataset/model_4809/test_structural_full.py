...
def test_model_ETypes_doubleValue_value_roundtrip():
    instance = model_ETypes(doubleValue="sample_text", eBigDecimal="sample_text", eBigInteger="sample_text", eBoolean=True, eBooleans="sample_text", eByte="sample_text", eByteArray="sample_text", eChar="sample_text", eDate=date(2024, 1, 1), eDouble=3.14, eDoubles="sample_text", eFloat=3.14, eInt=7, eInts=7, eLong="sample_text", eShort="sample_text", eString="sample_text", eStrings="sample_text", uris="sample_text")
