...
# Classes
faultTree_FTElement = Class(name="faultTree_FTElement", is_abstract=True)
faultTree_Connector = Class(name="faultTree_Connector")
FTElement = Class(name="FTElement")
faultTree_FaultTree = Class(name="faultTree_FaultTree")
faultTree_Event = Class(name="faultTree_Event")
faultTree_ProbabalisticEvent = Class(name="faultTree_ProbabalisticEvent", is_abstract=True)
Event = Class(name="Event")
faultTree_IntermediateEvent = Class(name="faultTree_IntermediateEvent")
faultTree_Gate = Class(name="faultTree_Gate", is_abstract=True)
faultTree_AND_Gate = Class(name="faultTree_AND_Gate")
Gate = Class(name="Gate")
faultTree_OR_Gate = Class(name="faultTree_OR_Gate")
faultTree_BasicEvent = Class(name="faultTree_BasicEvent")
ProbabalisticEvent = Class(name="ProbabalisticEvent")
faultTree_UndevelopedEvent = Class(name="faultTree_UndevelopedEvent")
faultTree_ExternalEvent = Class(name="faultTree_ExternalEvent")
...
faultTree_Event.attributes={faultTree_Event_description, faultTree_Event_title}
...
domain_model = DomainModel(
    name="faultTree",
    types={faultTree_FTElement, faultTree_Connector, FTElement, faultTree_FaultTree, faultTree_Event, faultTree_ProbabalisticEvent, Event, faultTree_IntermediateEvent, faultTree_Gate, faultTree_AND_Gate, Gate, faultTree_OR_Gate, faultTree_BasicEvent, ProbabalisticEvent, faultTree_UndevelopedEvent, faultTree_ExternalEvent},
    associations={source0, target1},
    generalizations={gen_faultTree_Connector_FTElement, gen_faultTree_FaultTree_FTElement, gen_faultTree_Event_FTElement, gen_faultTree_ProbabalisticEvent_Event, gen_faultTree_IntermediateEvent_Event, gen_faultTree_Gate_FTElement, gen_faultTree_AND_Gate_Gate, gen_faultTree_OR_Gate_Gate, gen_faultTree_BasicEvent_ProbabalisticEvent, gen_faultTree_UndevelopedEvent_ProbabalisticEvent, gen_faultTree_ExternalEvent_ProbabalisticEvent},
    metadata=None
)
