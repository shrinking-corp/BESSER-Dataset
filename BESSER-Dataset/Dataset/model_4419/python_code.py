...
class arduino_Task:
    ...
    def __init__(self, name: str, external: bool, arduino_Task: "arduino_Sketch" = None, arduino_Task21: "arduino_LoopItem" = None, arduino_Task48: "arduino_InAcquireOperation" = None, arduino_Task54: "arduino_DemandRequest" = None, arduino_Task58: "arduino_ForwardDispatch" = None, arduino_Task46: "arduino_OutOperation" = None, arduino_Task62: "arduino_AskInvitation" = None):
        self.name = name
...
class arduino_Poll:
    ...
    def __init__(self, type: str, l: int, h: int, arduino_Poll: "arduino_Sketch" = None, arduino_Poll30: "arduino_Sensor" = None, arduino_Poll33: "arduino_Handler" = None):
        self.type = type
        self.l = l
        self.h = h
...
class arduino_Sketch:
    ...
    def __init__(self, name: str, hardware: str, defineSystem: bool, arduino_Sketch12: "arduino_SystemDefinition" = None, arduino_Sketch4: set["arduino_Interrupt"] = None, arduino_Sketch6: set["arduino_Poll"] = None, arduino_Sketch8: set["arduino_Task"] = None, arduino_Sketch: set["arduino_AbstractDevice"] = None, arduino_Sketch2: set["arduino_Handler"] = None, arduino_Sketch10: set["arduino_LoopItem"] = None):
        self.name = name
