...
arduino_AbstractDevice.attributes={arduino_AbstractDevice_pin, arduino_AbstractDevice_name}
...
arduino_Interrupt.attributes={arduino_Interrupt_interruptKind, arduino_Interrupt_name, arduino_Interrupt_eventKind}
...
arduino_Poll.attributes={arduino_Poll_type, arduino_Poll_h, arduino_Poll_l}
...
arduino_CommunicationParams.attributes={arduino_CommunicationParams_dns, arduino_CommunicationParams_gateway, arduino_CommunicationParams_subnet, arduino_CommunicationParams_ip, arduino_CommunicationParams_type, arduino_CommunicationParams_mac, arduino_CommunicationParams_baudrate}
...
arduino_PortConnectionData.attributes={arduino_PortConnectionData_host, arduino_PortConnectionData_port}
...
domain_model = DomainModel(
    name="arduino",
    types={arduino_AbstractDevice, arduino_Handler, arduino_Sketch, arduino_SystemDefinition, arduino_Interrupt, arduino_Poll, arduino_Task, arduino_LoopItem, arduino_CommunicationParams, arduino_Message, arduino_HighLevelOperation, arduino_Precondition, arduino_Sensor, arduino_Precondition1, arduino_PortProtocol, arduino_PortTCP, PortProtocol, arduino_PortConnectionData, arduino_SensorValuePrecondition, arduino_Actuator, AbstractDevice, arduino_IODevice, arduino_EObject, arduino_EmptyPrecondition, arduino_InAcquireOperation, InOperation, arduino_SupportSpecification, arduino_DemandRequest, OutOperation, arduino_ForwardDispatch, arduino_OutOnlyMessage, Message, arduino_OutInMessage, arduino_Dispatch, OutOnlyMessage, arduino_Request, OutInMessage, arduino_Invitation, arduino_OutOperation, HighLevelOperation, arduino_InOperation, arduino_Serial, SupportSpecification, arduino_TCP, arduino_SupportData, arduino_ExplicitSupportData, SupportData, arduino_AskInvitation, arduino_GrantRequest, InAcquireOperation, arduino_ServeDispatch, arduino_AcceptInvitation, arduino_IP},
    associations={devices0, handlers1, loop9, systemDefinition11, interrupts3, pollings5, tasks7, operation17, mydata13, messages15, sensor29, task19, precondition22, sensor24, handler26, info35, pre136, handler32, sensor43, pre39, pre41, receiver47, support49, demand51, receiver52, forward55, receiver56, sender45, info69, ask59, receiver60, grant63, serve65, accept67},
    generalizations={gen_arduino_PortTCP_PortProtocol, gen_arduino_Actuator_AbstractDevice, gen_arduino_Sensor_AbstractDevice, gen_arduino_IODevice_AbstractDevice, gen_arduino_InAcquireOperation_InOperation, gen_arduino_DemandRequest_OutOperation, gen_arduino_ForwardDispatch_OutOperation, gen_arduino_OutOnlyMessage_Message, gen_arduino_OutInMessage_Message, gen_arduino_Dispatch_OutOnlyMessage, gen_arduino_Request_OutInMessage, gen_arduino_Invitation_OutInMessage, gen_arduino_OutOperation_HighLevelOperation, gen_arduino_InOperation_HighLevelOperation, gen_arduino_Serial_SupportSpecification, gen_arduino_TCP_SupportSpecification, gen_arduino_ExplicitSupportData_SupportData, gen_arduino_AskInvitation_OutOperation, gen_arduino_GrantRequest_InAcquireOperation, gen_arduino_ServeDispatch_InAcquireOperation, gen_arduino_AcceptInvitation_InAcquireOperation},
    metadata=None
)
