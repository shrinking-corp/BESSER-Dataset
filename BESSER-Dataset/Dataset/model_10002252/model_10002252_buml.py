...
# F1 class attributes and methods
F1_ownerName: Property = Property(name="ownerName", type=StringType)
F1_balance: Property = Property(name="balance", type=FloatType)
F1.attributes={F1_ownerName, F1_balance}
...
domain_model = DomainModel(
    name="_zZaKAIB3EeqjCeBtMxTJVQ",
    types={F1, ClassA, ClassB, ClassC, ClassD, ClassE, ClassF, ClassG, ClassJ, ClassH, ClassK, ClassL, ClassM, ClassN, ClassP, InterfaceO_Interface, ClassQ, ClassR, ClassS, ClassT, ClassU, ClassV},
