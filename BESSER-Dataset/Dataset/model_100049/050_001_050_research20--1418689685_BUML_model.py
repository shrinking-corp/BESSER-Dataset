...
# Classes
research20_PublicationProcess = Class(name="research20_PublicationProcess")
Named = Class(name="Named")
research20_Phase = Class(name="research20_Phase")
research20_Researcher = Class(name="research20_Researcher")
research20_Paper = Class(name="research20_Paper")
research20_Skill = Class(name="research20_Skill")
research20_Position = Class(name="research20_Position")
research20_Collaboration = Class(name="research20_Collaboration")
research20_Paragraph = Class(name="research20_Paragraph")
research20_Progress = Class(name="research20_Progress")
research20_PaperKeyword = Class(name="research20_PaperKeyword")
research20_State = Class(name="research20_State")
Counted = Class(name="Counted")
research20_Write = Class(name="research20_Write")
research20_ReviewNote = Class(name="research20_ReviewNote")
research20_Review = Class(name="research20_Review")
research20_KnowledgeManager = Class(name="research20_KnowledgeManager")
Labelled = Class(name="Labelled")
research20_PublicationStructure = Class(name="research20_PublicationStructure")
research20_PublicationStatus = Class(name="research20_PublicationStatus")
research20_PublicationSystem = Class(name="research20_PublicationSystem")
research20_Named = Class(name="research20_Named", is_abstract=True)
research20_Counted = Class(name="research20_Counted", is_abstract=True)
research20_Labelled = Class(name="research20_Labelled", is_abstract=True)
research20_Keyword = Class(name="research20_Keyword")
research20_Action = Class(name="research20_Action")
research20_StateMachineVariable = Class(name="research20_StateMachineVariable")
research20_StateMachineObject = Class(name="research20_StateMachineObject", is_abstract=True)
research20_Transition = Class(name="research20_Transition")
...
research20_PublicationProcess.attributes={research20_PublicationProcess_maxTime, research20_PublicationProcess_minTime}
...
research20_Researcher.attributes={research20_Researcher_forName, research20_Researcher_name}
...
research20_State.attributes={research20_State_name, research20_State_kind, research20_State_id}
...
research20_Transition.attributes={research20_Transition_guardExpression, research20_Transition_guardLabel}
...
domain_model = DomainModel(
    name="research20",
    types={research20_PublicationProcess, Named, research20_Phase, research20_Researcher, research20_Paper, research20_Skill, research20_Position, research20_Collaboration, research20_Paragraph, research20_Progress, research20_PaperKeyword, research20_State, Counted, research20_Write, research20_ReviewNote, research20_Review, research20_KnowledgeManager, Labelled, research20_PublicationStructure, research20_PublicationStatus, research20_PublicationSystem, research20_Named, research20_Counted, research20_Labelled, research20_Keyword, research20_Action, research20_StateMachineVariable, research20_StateMachineObject, research20_Transition, StateMachineObject, StateType},
    associations={phases0, res_papers4, skills5, res_position7, collaborations9, paragraphs11, progress12, authors13, keywords14, citedBy17, state19, writes1, reviews21, reviews2, knowledgeMan38, process23, paper25, paragraph27, reviewNote30, researchers33, papers35, kpapers53, behaviorView40, processView42, structuralView44, positions47, parent51, t_actions69, allkeywords55, keyword58, col_paper61, machineVariables64, pubStates66, source70, target73, transitions76, s_actions79, next83},
    generalizations={gen_research20_PublicationProcess_Named, gen_research20_Paper_Named, gen_research20_Paragraph_Counted, gen_research20_Paragraph_Named, gen_research20_ReviewNote_Named, gen_research20_Progress_Labelled, gen_research20_Write_Labelled, gen_research20_Review_Labelled, gen_research20_PublicationStructure_Named, gen_research20_PublicationSystem_Named, gen_research20_Position_Named, gen_research20_Keyword_Named, gen_research20_KnowledgeManager_Named, gen_research20_Transition_StateMachineObject, gen_research20_State_StateMachineObject},
    metadata=None
)
