...
Order.attributes={Order_shipTo, Order_total, Order_ordered, Order_status, Order_number, Order_shipped}
...
domain_model = DomainModel(
    name="a302ff5d_b2ea_4b14_bf8e_501cae618e04",
    types={Customer, Payment, ShoppingCart, Account, WebUser, Order, LineItem, Product, UserState, OrderStatus},
    associations={WebUser_ShoppingCart, WebUser_Customer, Customer_Account, Account_ShoppingCart, ShoppingCart_LineItem, Product_LineItem, Account_Payment, Order_LineItem, Account_Order, Payment_Order},
    generalizations={},
    metadata=None
)
