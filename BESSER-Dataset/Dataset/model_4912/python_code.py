...
class services_ServiceFlow(Base):
    ...
    def __init__(self, name: str, services_ServiceFlow38: "services_ServiceFlowRelationship" = None, services_ServiceFlow: set["services_ServiceFlowRelationship"] = None):
        self.name = name
...
class services_ServiceFlowRelationship(Base):
    ...
    def __init__(self, direction: str, services_ServiceFlowRelationship35: "services_ReferenceRelationship" = None, services_ServiceFlowRelationship37: "services_ServiceFlow" = None, services_ServiceFlowRelationship: "services_ServiceFlow" = None, services_ServiceFlowRelationship42: "services_Message" = None, services_ServiceFlowRelationship40: "services_Protocol" = None):
...
class services_ServiceForecast(Base):
    ...
    def __init__(self, name: str, revision: str, services_ServiceForecast: "services_Service" = None, services_ServiceForecast44: "services_DateTimeRange" = None, services_ServiceForecast46: set["services_ServiceForecastUsers"] = None, services_ServiceForecast48: set["services_ResourceForecast"] = None):
        self.name = name
