...
services_DerivedResource = Class(name="services_DerivedResource")
...
services_DistributionEntry = Class(name="services_DistributionEntry")
services_Lifecycle = Class(name="services_Lifecycle")
...
services_ReferenceRelationship = Class(name="services_ReferenceRelationship")
services_Expression = Class(name="services_Expression")
services_ServiceFlow = Class(name="services_ServiceFlow")
services_ServiceFlowRelationship = Class(name="services_ServiceFlowRelationship")
...
services_Protocol = Class(name="services_Protocol")
services_Message = Class(name="services_Message")
...
services_Service.attributes={services_Service_serviceCategory, services_Service_serviceDescription, services_Service_serviceClass, services_Service_serviceName}
...
domain_model = DomainModel(
    name="services",
    types={services_CIID, Base, services_DerivedResource, BaseResource, services_Value, services_CFSService, Service, services_NetXResource, services_RFSService, services_DistributionEntry, services_Lifecycle, services_ServiceForecast, services_Node, services_Tolerance, services_Service, services_ServiceMonitor, services_ServiceUser, services_ServiceDistribution, services_ReferenceRelationship, services_Expression, services_ServiceFlow, services_ServiceFlowRelationship, services_DateTimeRange, services_ServiceForecastUsers, services_ResourceForecast, services_Protocol, services_Message, services_ResourceMonitor, services_ServiceProfile, ResourceOriginType, ServiceClassType, ServiceFlowDirection},
    associations={resourceRef7, distribution8, values0, forecastValues1, trendedValues4, cIID14, lifecycle15, services18, serviceForecasts20, nodes11, toleranceRefs12, serviceMonitors22, serviceUserRefs24, serviceDistribution26, referenceRelationship34, serviceFlow36, distributionEntries28, expressionRefs31, serviceFlowRelationships33, period43, serviceForecastUsers45, resourceForecasts47, protocol39, message41, period55, resourceMonitors58, userValues49, serviceUserRef52, profileResources60, serviceProfile62, expressionRef65},
    generalizations={gen_services_CIID_Base, gen_services_DerivedResource_BaseResource, gen_services_CFSService_Service, gen_services_RFSService_Service, gen_services_DistributionEntry_Base, gen_services_Service_Base, gen_services_ServiceDistribution_Base, gen_services_ServiceFlowRelationship_Base, gen_services_ServiceFlow_Base, gen_services_ServiceForecast_Base, gen_services_ServiceProfile_Base, gen_services_ServiceForecastUsers_Base, gen_services_ServiceMonitor_Base, gen_services_ServiceUser_Base},
    metadata=None
)
