...
domain_model = DomainModel(
    name="source",
    types={source_Z, source_Y1, Y, source_Y2, source_PathNameCS, source_SRoot, source_SElement, source_EObject, source_X, SElement, source_Y, source_PathElementCS},
    associations={ownsZ1, toX2, toY3, refers5, ownedX6, ownsY0, ast7, path8},
    generalizations={gen_source_Y_SElement, gen_source_Y1_Y, gen_source_Y2_Y, gen_source_Z_SElement, gen_source_SRoot_SElement, gen_source_X_SElement, gen_source_PathNameCS_SElement, gen_source_PathElementCS_SElement},
    metadata=None
)
