...
class source_Y(SElement):
    ...
    def __init__(self, name: str, toY: "source_Z" = None, Y4: "source_Z" = None, Y: "source_X" = None, ownsY: "source_X" = None):
        self.name = name
        self.toY = toY
        self.Y4 = Y4
        self.Y = Y
...
class source_X(SElement):
    ...
    def __init__(self, isA1: bool, isA2: bool, name: str, X: "source_Y" = None, source_X: "source_SRoot" = None, toX: set["source_Y"] = None):
        self.isA1 = isA1
        self.isA2 = isA2
        self.name = name
        self.X = X
