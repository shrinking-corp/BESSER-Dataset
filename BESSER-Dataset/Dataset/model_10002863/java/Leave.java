...
public class Leave  {
    ...
    public Leave(
        LocalDate Leave_ApplyDate,        int leave_id,        String Leave_Status,        String Leave_detail,        LocalDate Leave_EndDate,        String Leave_Title,        int Leave_NoOfDays,        LocalDate Leave_StartDate,        int Emp_Id    ) {
