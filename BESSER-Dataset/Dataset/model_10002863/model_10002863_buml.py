...
Employee.attributes={Employee_Emp_Address, Employee_Emp_Email, Employee_Emp_Department, Employee_Emp_Salary, Employee_Emp_Position, Employee_Emp_Name, Employee_Emp_ContactNo, Employee_Emp_Date_Of_Joint, Employee_Emp_Id, Employee_Emp_DOB, Employee_Emp_NIC}
...
Salary.attributes={Salary_Sly_Netgross, Salary_OverTime, Salary_Sly_Increment, Salary_Sly_Decrement, Salary_Emp_Id, Salary_Sly_Basic}
...
Leave.attributes={Leave_Emp_Id, Leave_Leave_StartDate, Leave_Leave_Status, Leave_Leave_NoOfDays, Leave_Leave_EndDate, Leave_leave_id, Leave_Leave_detail, Leave_Leave_ApplyDate, Leave_Leave_Title}
...
Attendance.attributes={Attendance_AttendTime, Attendance_Leaving_Time, Attendance_Emp_id, Attendance_Attend_date}
...
domain_model = DomainModel(
    name="e40fce67_28d3_41ef_ab21_0b92f310c297",
    types={Employee, Salary, Authenticate_staff, Leave, Attendance, Login, Employee_Management_System_Component, Authentication_UseCase, Salary_Management_UseCase, Login_external, Logout_external, Administrator_Actor, Employee_Actor},
    associations={Employee_Login, Employee_Logout, Employee_Leave, Employee_Attendance, Employee_Salary},
    generalizations={},
    metadata=None
)
