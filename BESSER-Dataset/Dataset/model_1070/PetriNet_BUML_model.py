...
domain_model = DomainModel(
    name="PetriNet",
    types={PetriNet_LocatedElement, PetriNet_NamedElement, LocatedElement, PetriNet_PetriNet, NamedElement, PetriNet_Element, PetriNet_Arc, PetriNet_Place, Element, PetriNet_TransitionToPlace, PetriNet_Transition, Arc, PetriNet_PlaceToTransition},
    associations={elements0, arcs1, net3, incomingArc6, outgoingArc9, net12, from_14, to15, from_16, to19, incomingArc4, outgoingArc5},
