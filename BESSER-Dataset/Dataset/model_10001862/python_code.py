...
class Board:
    ...
    def __init__(self, cardArea: str, playAagain: str):
        self.cardArea = cardArea
        self.playAagain = playAagain
        
        pass
    @property
    def playAagain(self):
        return self.__playAagain
    @playAagain.setter
    def playAagain(self, playAagain: str):
        self.__playAagain = playAagain

    @property
    def cardArea(self):
        return self.__cardArea
    @cardArea.setter
    def cardArea(self, cardArea: str):
        self.__cardArea = cardArea
