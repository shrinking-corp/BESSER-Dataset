...
# Classes
brmodel_Model = Class(name="brmodel_Model")
brmodel_Rule = Class(name="brmodel_Rule")
brmodel_SlicedVariable = Class(name="brmodel_SlicedVariable")
brmodel_RulePart = Class(name="brmodel_RulePart")
brmodel_RelatedMethod = Class(name="brmodel_RelatedMethod")
brmodel_Statement = Class(name="brmodel_Statement")
brmodel_ReachableMethod = Class(name="brmodel_ReachableMethod")
brmodel_ReachableVariable = Class(name="brmodel_ReachableVariable")
Method_ = Class(name="Method")
Trace = Class(name="Trace")
brmodel_EObject = Class(name="brmodel_EObject")
brmodel_Method = Class(name="brmodel_Method", is_abstract=True)
Variable = Class(name="Variable")
brmodel_RelatedVariable = Class(name="brmodel_RelatedVariable")
brmodel_Variable = Class(name="brmodel_Variable", is_abstract=True)
brmodel_Trace = Class(name="brmodel_Trace")
...
brmodel_Method_class_: Property = Property(name="class_", type=StringType)
brmodel_Method_name: Property = Property(name="name", type=StringType)
brmodel_Method.attributes={brmodel_Method_name, brmodel_Method_class_}
...
domain_model = DomainModel(
    name="brmodel",
    types={brmodel_Model, brmodel_Rule, brmodel_SlicedVariable, brmodel_RulePart, brmodel_RelatedMethod, brmodel_Statement, brmodel_ReachableMethod, brmodel_ReachableVariable, Method_, Trace, brmodel_EObject, brmodel_Method, Variable, brmodel_RelatedVariable, brmodel_Variable, brmodel_Trace},
    associations={rules0, slicedVariable1, ruleParts3, relatedMethod5, relatedStatements7, action9, reachableMethods12, relatedVariables14, linkToCode16},
