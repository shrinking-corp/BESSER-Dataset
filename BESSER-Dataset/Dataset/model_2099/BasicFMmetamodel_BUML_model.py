...
# Classes
BasicFMmetamodel_FeatureModel = Class(name="BasicFMmetamodel_FeatureModel")
BasicFMmetamodel_Feature = Class(name="BasicFMmetamodel_Feature")
BasicFMmetamodel_CrossTreeConstraint = Class(name="BasicFMmetamodel_CrossTreeConstraint", is_abstract=True)
BasicFMmetamodel_Alternative = Class(name="BasicFMmetamodel_Alternative")
Feature = Class(name="Feature")
BasicFMmetamodel_OrGroup = Class(name="BasicFMmetamodel_OrGroup")
...
BasicFMmetamodel_FeatureModel_m_getFeature: Method = Method(name="getFeature", parameters={Parameter(name='BasicFMmetamodel_id', type=StringType)}, type=StringType)
...
BasicFMmetamodel_Feature.attributes={BasicFMmetamodel_Feature_name, BasicFMmetamodel_Feature_id, BasicFMmetamodel_Feature_selected, BasicFMmetamodel_Feature_mandatory}
