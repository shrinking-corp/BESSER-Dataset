...
def test_CoachBusWithEDataType_Employee_baseSalary_value_roundtrip():
    instance = CoachBusWithEDataType_Employee(baseSalary=3.14)
...
CoachBusWithEDataType_Employee_strategy = st.builds(CoachBusWithEDataType_Employee, baseSalary=st.floats(allow_nan=False, allow_infinity=False))
@given(instance=CoachBusWithEDataType_Employee_strategy)
