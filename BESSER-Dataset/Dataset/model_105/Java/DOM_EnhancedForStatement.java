...
public class DOM_EnhancedForStatement extends Statement {
    ...
    private DOM_SingleVariableDeclaration dom_singlevariabledeclaration;
    ...
    public DOM_SingleVariableDeclaration getDom_singlevariabledeclaration() {
        return dom_singlevariabledeclaration;
    }

    public void setDom_singlevariabledeclaration(DOM_SingleVariableDeclaration dom_singlevariabledeclaration) {
        this.dom_singlevariabledeclaration = dom_singlevariabledeclaration;
    }
