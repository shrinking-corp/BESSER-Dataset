...
model_DatabaseVersions.methods={model_DatabaseVersions_m_getLastVersion, model_DatabaseVersions_m_getFirstVersion, model_DatabaseVersions_m_createVersion}
...
model_common_TableMapping_m_put: Method = Method(name="put", parameters={Parameter(name='model_current', type=StringType), Parameter(name='model_previous', type=StringType)})
model_common_TableMapping_m_entries: Method = Method(name="entries", parameters={})
model_common_TableMapping.methods={model_common_TableMapping_m_put, model_common_TableMapping_m_getAllCurrent, model_common_TableMapping_m_entries, model_common_TableMapping_m_getPrevious, model_common_TableMapping_m_getAllPrevious, model_common_TableMapping_m_getCurrent}
...
model_common_ColumnMapping.methods={model_common_ColumnMapping_m_getCurrent, model_common_ColumnMapping_m_getAllCurrent, model_common_ColumnMapping_m_put, model_common_ColumnMapping_m_entries, model_common_ColumnMapping_m_getPrevious, model_common_ColumnMapping_m_getAllPrevious}
...
domain_model = DomainModel(
    name="model",
    types={model_DatabaseVersions, model_DatabaseVersion, model_Database, TableMapping, ColumnMapping, NameProvider, Table, View, Trigger, Index, model_common_NameProvider, model_common_MappingEntry, model_common_StringToTableMappingEntryMap, model_common_StringToColumnMappingEntryMap, model_common_TableMapping, StringToTableMappingEntryMap, model_common_ColumnMapping, StringToColumnMappingEntryMap, model_table_Table, table_model_Database, Column, model_column_Column, ColumnConstraint, model_column_IndexedColumn, model_column_ColumnConstraint, TableConstraint, model_table_TableConstraint, model_table_PrimaryKeyTableConstraint, IndexedColumn, model_table_UniqueTableConstraint, model_table_CheckTableConstraint, Expression, model_table_ForeignKeyTableConstraint, model_column_DefaultRealValueColumnConstraint, model_view_View, view_model_Database, model_index_Index, index_model_Database, model_trigger_Trigger, trigger_model_Database, model_expression_Expression, model_column_PrimaryKeyColumnConstraint, model_column_NotNullColumnConstraint, model_column_UniqueColumnConstraint, model_column_CheckColumnConstraint, model_column_DefaultValueColumnConstraint, model_column_DefaultExpressionValueColumnConstraint, model_column_DefaultStringValueColumnConstraint, model_column_DefaultIntegerValueColumnConstraint, DataType},
    associations={versions0, database1, previousVersion4, nextVersion6, tableMapping8, columnMapping10, tables12, views13, triggers15, indexes17, prev2entryMap19, curr2entryMap20, prev2entryMap23, curr2entryMap24, database27, columns28, columns37, foreignTable39, foreignColumns42, table45, constraints47, column48, constraints29, table31, columns33, columns34, expression36, database55, database57, database59, column50, expression53},
    generalizations={gen_model_Database_NameProvider, gen_model_table_Table_NameProvider, gen_model_column_Column_NameProvider, gen_model_table_PrimaryKeyTableConstraint_TableConstraint, gen_model_table_UniqueTableConstraint_TableConstraint, gen_model_table_CheckTableConstraint_TableConstraint, gen_model_table_ForeignKeyTableConstraint_TableConstraint, gen_model_view_View_NameProvider, gen_model_trigger_Trigger_NameProvider, gen_model_column_PrimaryKeyColumnConstraint_ColumnConstraint, gen_model_column_NotNullColumnConstraint_ColumnConstraint, gen_model_column_UniqueColumnConstraint_ColumnConstraint, gen_model_column_CheckColumnConstraint_ColumnConstraint, gen_model_column_DefaultValueColumnConstraint_ColumnConstraint},
    metadata=None
)
