...
RFID_Reader = Class(name="RFID_Reader", is_abstract=True)
...
Doctor.attributes={Doctor_address, Doctor_docid, Doctor_phno, Doctor_department, Doctor_name, Doctor_specialization}
...
Nurse.attributes={Nurse_id, Nurse_doctorid, Nurse_name}
...
Patient.attributes={Patient_telno, Patient_roomno, Patient_sickness, Patient_accepted, Patient_address, Patient_sex, Patient_age}
...
Staff.attributes={Staff_joined, Staff_education}

# RFID_Reader class attributes and methods
RFID_Reader_RFID: Property = Property(name="RFID", type=IntegerType)
RFID_Reader_CRC_code: Property = Property(name="CRC_code", type=StringType)
RFID_Reader_Gender: Property = Property(name="Gender", type=StringType)
RFID_Reader_birthDate: Property = Property(name="birthDate", type=DateType)
RFID_Reader_address: Property = Property(name="address", type=StringType)
RFID_Reader_phone: Property = Property(name="phone", type=IntegerType)
RFID_Reader.attributes={RFID_Reader_phone, RFID_Reader_RFID, RFID_Reader_birthDate, RFID_Reader_address, RFID_Reader_Gender, RFID_Reader_CRC_code}
...
Hospital.attributes={Hospital_phone, Hospital_address, Hospital_name}
...
Person_Hospital: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="person14", type=RFID_Reader, multiplicity=Multiplicity(0, 1)),
...
Person_Hospital2: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="person16", type=RFID_Reader, multiplicity=Multiplicity(0, 9999)),
...
Person_Hospital3: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="person24", type=RFID_Reader, multiplicity=Multiplicity(0, 9999)),
...
domain_model = DomainModel(
    name="_2XbA8H7PEeqjCeBtMxTJVQ",
    types={Doctor, Nurse, Patient, Room, Staff, RFID_Reader, Hospital, Bill, Staff1, Nurse1, Department, Operations_staff, Administrative_staff, Technical_staff},
