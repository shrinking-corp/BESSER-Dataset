...
class core_ClassUse(ImplicitlyAnnotableElement, TypeExpression):
    ...
    def __init__(self, className: str, strictType: bool, core_ClassUse72: "core_TypedWithClass" = None, core_ClassUse: "core_RepresentModel" = None):
...
class core_ModelReference(Expression, ClassUse):
...
class core_PropertyWrite(Expression):
    ...
    def __init__(self, _property: str, core_PropertyWrite: "core_Variable" = None, core_PropertyWrite26: "core_Expression" = None):
...
class core_UseDeclaration(RepresentModel):
    ...
    def __init__(self, module: str, as_: str, core_UseDeclaration: "core_TransformationDefinition" = None, core_UseDeclaration54: "core_ResolveLink" = None):
        self.module = module
        self.as_ = as_
