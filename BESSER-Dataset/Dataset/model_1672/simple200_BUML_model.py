...
# Classes
simple200_Thing = Class(name="simple200_Thing", is_abstract=True)
NamedElement = Class(name="NamedElement")
simple200_RelatedTo = Class(name="simple200_RelatedTo")
simple200_NamedElement = Class(name="simple200_NamedElement", is_abstract=True)
simple200_Variable = Class(name="simple200_Variable")
Thing = Class(name="Thing")
simple200_Transition = Class(name="simple200_Transition")
simple200_State = Class(name="simple200_State")
...
simple200_State.attributes={simple200_State_label, simple200_State_activity, simple200_State_type}
...
domain_model = DomainModel(
    ...
    associations={fromThing1, toThing2, relations0, source3, target4, substates6, parentstate9, variables11, transitions13},
    generalizations={gen_simple200_Thing_NamedElement, gen_simple200_RelatedTo_NamedElement, gen_simple200_Variable_Thing, gen_simple200_Transition_NamedElement, gen_simple200_State_NamedElement},
    metadata=None
)
