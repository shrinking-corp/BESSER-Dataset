...
# Classes
yyd_Blias = Class(name="yyd_Blias")
yyd_Thing = Class(name="yyd_Thing")
yyd_RelatedTo = Class(name="yyd_RelatedTo")
yyd_Foo = Class(name="yyd_Foo", is_abstract=True)
yyd_Alias = Class(name="yyd_Alias")
Foo = Class(name="Foo")
...
domain_model = DomainModel(
    name="yyd",
    types={yyd_Blias, yyd_Thing, yyd_RelatedTo, yyd_Foo, yyd_Alias, Foo},
    associations={relations0, fromThing1, foos2},
    generalizations={gen_yyd_Blias_Foo, gen_yyd_Alias_Foo},
    metadata=None
)
