...
# Classes
petrinet_metamodel_Rectangle = Class(name="petrinet_metamodel_Rectangle")
Arc = Class(name="Arc")
petrinet_metamodel_Element = Class(name="petrinet_metamodel_Element", is_abstract=True)
petrinet_metamodel_PetriNet = Class(name="petrinet_metamodel_PetriNet")
Element = Class(name="Element")
petrinet_metamodel_Place = Class(name="petrinet_metamodel_Place")
petrinet_metamodel_Transition = Class(name="petrinet_metamodel_Transition")
petrinet_metamodel_Arc = Class(name="petrinet_metamodel_Arc", is_abstract=True)
petrinet_metamodel_TransToPlaceArc = Class(name="petrinet_metamodel_TransToPlaceArc")
petrinet_metamodel_PlaceToTransArc = Class(name="petrinet_metamodel_PlaceToTransArc")
...
petrinet_metamodel_Element.attributes={petrinet_metamodel_Element_comments, petrinet_metamodel_Element_name}
...
petrinet_metamodel_Place.attributes={petrinet_metamodel_Place_radius, petrinet_metamodel_Place_fill_colour, petrinet_metamodel_Place_coordinates}
...
domain_model = DomainModel(
    ...
    types={petrinet_metamodel_Rectangle, Arc, petrinet_metamodel_Element, petrinet_metamodel_PetriNet, Element, petrinet_metamodel_Place, petrinet_metamodel_Transition, petrinet_metamodel_Arc, petrinet_metamodel_TransToPlaceArc, petrinet_metamodel_PlaceToTransArc},
    associations={petrinet6, petrinet7, incoming9, outgoing12, rectangle15, source16, target18, source20, places0, transitions1, arcs3, incoming4, outgoing5, target23, belongs_to26},
    generalizations={gen_petrinet_metamodel_Transition_Element, gen_petrinet_metamodel_PlaceToTransArc_Arc, gen_petrinet_metamodel_TransToPlaceArc_Arc, gen_petrinet_metamodel_PetriNet_Element, gen_petrinet_metamodel_Place_Element},
    metadata=None
)
