...
# Classes
nested102_World = Class(name="nested102_World")
nested102_Thing = Class(name="nested102_Thing")
NamedElement = Class(name="NamedElement")
nested102_RelatedTo = Class(name="nested102_RelatedTo")
nested102_EClass0 = Class(name="nested102_EClass0")
nested102_EClass1 = Class(name="nested102_EClass1")
nested102_EClass2 = Class(name="nested102_EClass2")
nested102_NamedElement = Class(name="nested102_NamedElement", is_abstract=True)
nested102_EClass4 = Class(name="nested102_EClass4")
nested102_EClass5 = Class(name="nested102_EClass5")
EClass6 = Class(name="EClass6")
nested102_EClass6 = Class(name="nested102_EClass6", is_abstract=True)
EClass7 = Class(name="EClass7")
EClass8 = Class(name="EClass8")
nested102_EClass7 = Class(name="nested102_EClass7", is_abstract=True)
Thing = Class(name="Thing")
nested102_EClass8 = Class(name="nested102_EClass8", is_abstract=True)
nested102_EClass3 = Class(name="nested102_EClass3")
...
domain_model = DomainModel(
    name="nested102",
    types={nested102_World, nested102_Thing, NamedElement, nested102_RelatedTo, nested102_EClass0, nested102_EClass1, nested102_EClass2, nested102_NamedElement, nested102_EClass4, nested102_EClass5, EClass6, nested102_EClass6, EClass7, EClass8, nested102_EClass7, Thing, nested102_EClass8, nested102_EClass3},
    associations={things0, relations1, EReference02, fromThing4, toThing5, ecl17, ecl29, ecl413, ecl515, ecl311},
