...
umlTransition_EffectRule.attributes={umlTransition_EffectRule_kind, umlTransition_EffectRule_behaviorName}
...
domain_model = DomainModel(
    name="umlTransition",
    types={umlTransition_TransitionRule, umlTransition_RelativeTimeEventRule, TimeEventRule, umlTransition_AbsoluteTimeEventRule, umlTransition_ChangeEventRule, umlTransition_EventRule, umlTransition_GuardRule, umlTransition_EffectRule, umlTransition_CallOrSignalEventRule, EventRule, umlTransition_NamedElement, umlTransition_AnyReceiveEventRule, umlTransition_TimeEventRule, BehaviorKind},
    associations={triggers0, guard1, effect3, operationOrSignal5},
    generalizations={gen_umlTransition_RelativeTimeEventRule_TimeEventRule, gen_umlTransition_AbsoluteTimeEventRule_TimeEventRule, gen_umlTransition_ChangeEventRule_EventRule, gen_umlTransition_CallOrSignalEventRule_EventRule, gen_umlTransition_AnyReceiveEventRule_EventRule, gen_umlTransition_TimeEventRule_EventRule},
    metadata=None
)
