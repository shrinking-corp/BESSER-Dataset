...
class ptnet_Line:
    ...
    def __init__(self, style: str, color: str, shape: str, width: str, Line55: "ptnet_AnnotationGraphics" = None, Line: "ptnet_NodeGraphics" = None, line: "ptnet_NodeGraphics" = None, line67: "ptnet_ArcGraphics" = None, line70: "ptnet_AnnotationGraphics" = None, Line76: "ptnet_ArcGraphics" = None):
        self.style = style
        self.color = color
        self.shape = shape
        self.width = width
...
class ptnet_Fill:
    ...
    def __init__(self, color: str, gradientcolor: str, gradientrotation: str, image: str, Fill52: "ptnet_AnnotationGraphics" = None, Fill: "ptnet_NodeGraphics" = None, fill: "ptnet_NodeGraphics" = None, fill62: "ptnet_AnnotationGraphics" = None):
        self.color = color
...
class ptnet_PnObject(ABC):
    ...
    def __init__(self, id: str, PnObject23: "ptnet_Name" = None, PnObject: "ptnet_Page" = None, containerNamePnObject: "ptnet_Name" = None, containerPnObject: set["ptnet_ToolInfo"] = None, PnObject28: "ptnet_ToolInfo" = None, objects: "ptnet_Page" = None):
        self.id = id
...
class ptnet_Name(Annotation):
    ...
    def __init__(self, text: str, name: "ptnet_PetriNet" = None, name22: "ptnet_PnObject" = None, Name: "ptnet_PetriNet" = None, Name14: "ptnet_PnObject" = None):
        self.text = text
        self.name = name
        self.name22 = name22
        self.Name = Name
...
class ptnet_PetriNet:
    ...
    def __init__(self, id: str, type: str, PetriNet20: "ptnet_Name" = None, containerPetriNet: set["ptnet_Page"] = None, containerNamePetriNet: "ptnet_Name" = None, containerPetriNet6: set["ptnet_ToolInfo"] = None, nets: "ptnet_PetriNetDoc" = None, PetriNet10: "ptnet_Page" = None, PetriNet25: "ptnet_ToolInfo" = None, PetriNet: "ptnet_PetriNetDoc" = None):
        self.id = id
        self.type = type
