...
ptnet_Font.attributes={ptnet_Font_decoration, ptnet_Font_rotation, ptnet_Font_family, ptnet_Font_style, ptnet_Font_align, ptnet_Font_size, ptnet_Font_weight}
...
domain_model = DomainModel(
    name="ptnet",
    types={ptnet_Arc, ptnet_PetriNetDoc, ptnet_PetriNet, ptnet_Page, ptnet_PTMarking, Annotation, ptnet_Place, ptnet_PTArcAnnotation, ptnet_Name, ptnet_ToolInfo, PnObject, ptnet_PnObject, ptnet_NodeGraphics, ptnet_Font, ptnet_Label, ptnet_AnyObject, Graphics, ptnet_Position, ptnet_Dimension, ptnet_Fill, ptnet_Line, ptnet_Node, ptnet_Graphics, ptnet_Coordinate, Coordinate, ptnet_ArcGraphics, ptnet_Offset, ptnet_AnnotationGraphics, ptnet_Annotation, ptnet_PlaceNode, Node, ptnet_RefPlace, ptnet_TransitionNode, ptnet_RefTransition, PlaceNode, TransitionNode, ptnet_Transition, ptnet_Attribute, Label, PNType, LineShape, CSS2Color, Gradient, CSS2FontFamily, CSS2FontSize, CSS2FontStyle, CSS2FontWeight, FontAlign, FontDecoration, LineStyle},
    associations={containerArc1, nets2, containerPlace0, containerPage17, containerNamePetriNet19, containerNamePnObject21, pages3, name4, toolspecifics5, containerPetriNetDoc7, objects8, containerPetriNet9, nodegraphics11, name13, toolspecifics15, containerDNodeGraphics47, offset49, fill50, line53, containerPetriNet24, containerPnObject26, containerLabel29, toolInfoModel31, toolspecifics32, position34, dimension35, fill36, line37, containerNode39, containerPage40, containerArcGraphics43, containerPNodeGraphics44, containerAnnotationGraphics46, containerNodeGraphics64, containerArcGraphics66, containerAnnotationGraphics69, positions72, line74, font56, containerAnnotation58, containerNodeGraphics59, containerAnnotationGraphics61, containerArc77, source79, target81, arcgraphics83, inscription85, InArcs87, OutArcs89, nodegraphics91, containerAnnotationGraphics93, referencingPlaces95, referencingTransitions96, initialMarking98, ref99, ref100, annotationgraphics101, containerToolInfo103},
    generalizations={gen_ptnet_PTArcAnnotation_Annotation, gen_ptnet_PTMarking_Annotation, gen_ptnet_Name_Annotation, gen_ptnet_Page_PnObject, gen_ptnet_Dimension_Coordinate, gen_ptnet_AnnotationGraphics_Graphics, gen_ptnet_NodeGraphics_Graphics, gen_ptnet_Position_Coordinate, gen_ptnet_Offset_Coordinate, gen_ptnet_ArcGraphics_Graphics, gen_ptnet_Arc_PnObject, gen_ptnet_Node_PnObject, gen_ptnet_PlaceNode_Node, gen_ptnet_TransitionNode_Node, gen_ptnet_Place_PlaceNode, gen_ptnet_RefTransition_TransitionNode, gen_ptnet_Transition_TransitionNode, gen_ptnet_RefPlace_PlaceNode, gen_ptnet_Attribute_Label, gen_ptnet_Annotation_Label},
    metadata=None
)
