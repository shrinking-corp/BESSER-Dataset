...
domain_model = DomainModel(
    name="Example",
    types={Example_Family, Example_Parent, Example_Son, Example_Daughter, Example_Pet, Example_Dog, Pet, Example_Cat, Example_RaceDog, Dog, Example_HuntingDog, Example_Member, Member},
    associations={parents0, sons1, daughters3, pets5, family9, family6, family7},
