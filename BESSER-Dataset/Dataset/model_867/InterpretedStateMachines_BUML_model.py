...
statemachines_State.attributes={statemachines_State_isEntryCompleted, statemachines_State_isExitCompleted, statemachines_State_isDoActivityCompleted}
...
domain_model = DomainModel(
    name="statemachines",
    types={statemachines_CustomSystem, statemachines_StateMachine, statemachines_Signal, statemachines_Operation, NamedElement, statemachines_Attribute, statemachines_EventType, statemachines_SignalEventType, EventType, statemachines_CallEventType, statemachines_BooleanAttribute, Attribute, statemachines_IntegerAttribute, statemachines_StringAttribute, statemachines_BooleanConstraint, statemachines_IntegerConstraint, statemachines_StringConstraint, statemachines_NamedElement, statemachines_Region, statemachines_Vertex, statemachines_Transition, statemachines_State, statemachines_Constraint, statemachines_Behavior, statemachines_Trigger, statemachines_FinalState, State, statemachines_Pseudostate, Vertex, statemachines_SignalEventOccurrence, statemachines_OperationBehavior, Behavior, statemachines_AttributeValue, statemachines_BooleanAttributeValue, AttributeValue, statemachines_IntegerAttributeValue, statemachines_StringAttributeValue, statemachines_EventOccurrence, statemachines_CompletionEventOccurrence, EventOccurrence, statemachines_CallEventOccurrence, PseudostateKind, TransitionKind},
    associations={statemachine0, signals1, operations3, attributes5, inParameters7, outParameters10, return_13, signal16, operation18, regions20, vertice21, transitions22, stateMachine24, state25, currentVertex27, container28, outgoingTransitions30, incomingTransitions32, state34, regions36, entry38, doActivity39, exit42, deferrableTriggers45, connectionPoint47, source49, target51, triggers53, container55, effect57, eventType60, emittedSignals62, attributeValues64, attribute65, attribute66, attribute67, state68, signal70, attributeValues73, outParameterValues81, returnValue84, operation76, inParameterValues78},
    generalizations={gen_statemachines_Signal_NamedElement, gen_statemachines_Operation_NamedElement, gen_statemachines_SignalEventType_EventType, gen_statemachines_CallEventType_EventType, gen_statemachines_Attribute_NamedElement, gen_statemachines_BooleanAttribute_Attribute, gen_statemachines_IntegerAttribute_Attribute, gen_statemachines_StringAttribute_Attribute, gen_statemachines_StateMachine_NamedElement, gen_statemachines_Region_NamedElement, gen_statemachines_Vertex_NamedElement, gen_statemachines_State_Vertex, gen_statemachines_FinalState_State, gen_statemachines_Transition_NamedElement, gen_statemachines_Pseudostate_Vertex, gen_statemachines_Behavior_NamedElement, gen_statemachines_OperationBehavior_Behavior, gen_statemachines_BooleanAttributeValue_AttributeValue, gen_statemachines_IntegerAttributeValue_AttributeValue, gen_statemachines_StringAttributeValue_AttributeValue, gen_statemachines_SignalEventOccurrence_EventOccurrence, gen_statemachines_CallEventOccurrence_EventOccurrence, gen_statemachines_Trigger_NamedElement},
    metadata=None
)
