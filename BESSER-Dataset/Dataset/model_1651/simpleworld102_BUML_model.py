...
# Classes
simpleworld102_Person = Class(name="simpleworld102_Person")
simpleworld102_Named = Class(name="simpleworld102_Named", is_abstract=True)
simpleworld102_Relations = Class(name="simpleworld102_Relations")
simpleworld102_Element = Class(name="simpleworld102_Element")
simpleworld102_Thing = Class(name="simpleworld102_Thing")
Named = Class(name="Named")
simpleworld102_Part = Class(name="simpleworld102_Part")
simpleworld102_World = Class(name="simpleworld102_World")
...
simpleworld102_Person.attributes={simpleworld102_Person_name, simpleworld102_Person_foreName}
...
domain_model = DomainModel(
    name="simpleworld102",
    types={simpleworld102_Person, simpleworld102_Named, simpleworld102_Relations, simpleworld102_Element, simpleworld102_Thing, Named, simpleworld102_Part, simpleworld102_World},
    associations={relations0, elements1, thing3, things5, components6, persons8, parent10, parts12, persons15, things17},
    generalizations={gen_simpleworld102_Thing_Named, gen_simpleworld102_Part_Named, gen_simpleworld102_World_Named},
    metadata=None
)
