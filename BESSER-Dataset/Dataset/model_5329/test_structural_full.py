...
Root_NewEClass1_strategy = st.builds(Root_NewEClass1)
...
Root_NewEClass2_strategy = st.builds(Root_NewEClass2)
...
Root_NewEClass3_strategy = st.builds(Root_NewEClass3)
