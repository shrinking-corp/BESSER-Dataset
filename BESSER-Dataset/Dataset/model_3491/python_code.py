...
class featureDiagram_Attribute(FeatureElement):
    ...
    def __init__(self, name: str, value: str, type: str, attributes: "featureDiagram_Feature" = None, Attribute: "featureDiagram_Feature" = None):
        self.name = name
        self.value = value
        self.type = type
...
class featureDiagram_Feature(FeatureElement):
    ...
    def __init__(self, name: str, selected: bool, featureDiagram_Feature15: "featureDiagram_ConstraintEdge" = None, featureDiagram_Feature19: "featureDiagram_ConstraintEdge" = None, Feature26: "featureDiagram_Attribute" = None, Feature: "featureDiagram_FeatureDiagram" = None, featureDiagram_Feature: "featureDiagram_FeatureDiagram" = None, Feature21: "featureDiagram_Operator" = None, Feature23: "featureDiagram_Operator" = None, features: "featureDiagram_FeatureDiagram" = None, owningFeature: set["featureDiagram_Operator"] = None, owningFeature7: set["featureDiagram_Attribute"] = None, features9: set["featureDiagram_Operator"] = None, featureDiagram_Feature12: set["featureDiagram_EObject"] = None):
        self.name = name
...
class featureDiagram_Operator(FeatureElement):
    ...
    def __init__(self, name: str, operator: "featureDiagram_Feature" = None, owningOperator: set["featureDiagram_Feature"] = None, Operator: "featureDiagram_Feature" = None, Operator10: "featureDiagram_Feature" = None):
        self.name = name
