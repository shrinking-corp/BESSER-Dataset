...
Property_.attributes={Property__address, Property__property_type, Property__property_id, Property__location}
...
Reg_User.attributes={Reg_User_username, Reg_User_password, Reg_User_Address}
...
Payment.attributes={Payment_pay_id, Payment_card_no, Payment_ex_date, Payment_pay_mode, Payment_pay_amount}
...
Requirement.attributes={Requirement_req_description, Requirement_user_id, Requirement_requirement_type, Requirement_requirement_location}
...
Advertiesment.attributes={Advertiesment_start_date, Advertiesment_advertiser_id, Advertiesment_advertiesment_id, Advertiesment_end_date}
...
domain_model = DomainModel(
    name="_3699e4d7_07f5_4ebf_a071_498723778f99",
    ...
    associations={Payment_Reg_User, Payment_Property, User_Administrator, Advertiser_Advertiesment, Property_Seller, User_Request, Property_Buyer, Reg_User_Requirement, Property_Management},
    generalizations={},
    metadata=None
)
