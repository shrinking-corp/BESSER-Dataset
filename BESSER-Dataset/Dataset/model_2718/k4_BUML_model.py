...
# Classes
k4_M = Class(name="k4_M")
k4_X = Class(name="k4_X")
k4_C = Class(name="k4_C", is_abstract=True)
k4_P = Class(name="k4_P")
k4_Z = Class(name="k4_Z")
k4_Y = Class(name="k4_Y")
k4_W = Class(name="k4_W")
k4_A = Class(name="k4_A")
B = Class(name="B")
k4_B = Class(name="k4_B")
C = Class(name="C")
k4_I = Class(name="k4_I")
G = Class(name="G")
k4_G = Class(name="k4_G", is_abstract=True)
k4_L1 = Class(name="k4_L1")
k4_N = Class(name="k4_N")
M = Class(name="M")
k4_J = Class(name="k4_J")
A = Class(name="A")
N = Class(name="N")
k4_K = Class(name="k4_K")
k4_Q = Class(name="k4_Q")
P = Class(name="P")
k4_L2 = Class(name="k4_L2")
k4_L4 = Class(name="k4_L4")
J = Class(name="J")
k4_L3 = Class(name="k4_L3")
L1 = Class(name="L1")
...
k4_Z.attributes={k4_Z_z1, k4_Z_z2, k4_Z_z3}
...
domain_model = DomainModel(
    name="k4",
    types={k4_M, k4_X, k4_C, k4_P, k4_Z, k4_Y, k4_W, k4_A, B, k4_B, C, k4_I, G, k4_G, k4_L1, k4_N, M, k4_J, A, N, k4_K, k4_Q, P, k4_L2, k4_L4, J, k4_L3, L1},
    associations={xcs0, ps1, zs3, ys5, w7, is_9, mcs10, ml112, a14, ks16, js18, l2s20, l3i33, l1c21, l1m24, l2q27, l2k30, l4z35},
    generalizations={gen_k4_M_G, gen_k4_A_B, gen_k4_B_C, gen_k4_C_G, gen_k4_N_M, gen_k4_J_A, gen_k4_P_N, gen_k4_Q_P, gen_k4_I_G, gen_k4_L4_L1, gen_k4_K_J, gen_k4_L3_L1},
    metadata=None
)
