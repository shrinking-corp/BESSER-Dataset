...
class gastm_Literal(Expression):
    ...
    def __init__(self, value: str, Expression148: "gastm_ForStatement" = None, Expression292: "sastm_RDBModifyStatement" = None, Expression179: "gastm_QualifiedIdentifierReference" = None, Expression240: "gastm_AnnotationExpression" = None, Expression133: "gastm_SwitchStatement" = None, Expression: "gastm_DataDefinition" = None, Expression151: "gastm_ForStatement" = None, Expression304: "sastm_RDBHostVariableReference" = None, Expression143: "gastm_LoopStatement" = None, Expression141: "gastm_ReturnStatement" = None, Expression219: "gastm_RangeExpression" = None, Expression165: "gastm_ThrowStatement" = None, Expression52: "gastm_BitFieldDefinition" = None, Expression112: "gastm_JumpStatement" = None, Expression177: "gastm_ArrayAccess" = None, Expression298: "sastm_RDBOpenCursorStatement" = None, Expression287: "sastm_RDBInsertStatement" = None, Expression216: "gastm_RangeExpression" = None, Expression316: "sastm_RDBColumnReference" = None, Expression201: "gastm_BinaryExpression" = None, Expression294: "sastm_RDBUpdateStatement" = None, Expression204: "gastm_BinaryExpression" = None, Expression208: "gastm_ConditionalExpression" = None, Expression214: "gastm_ConditionalExpression" = None, Expression191: "gastm_CastExpression" = None, Expression85: "gastm_Dimension" = None, Expression125: "gastm_IfStatement" = None, Expression312: "sastm_RDBSelectExpression" = None, Expression301: "sastm_RDBHostVariableReference" = None, Expression110: "gastm_ExpressionStatement" = None, Expression211: "gastm_ConditionalExpression" = None, Expression82: "gastm_Dimension" = None, Expression54: "gastm_EnumLiteralDefinition" = None, Expression221: "gastm_FunctionCallExpression" = None, Expression196: "gastm_UnaryExpression" = None, Expression225: "gastm_ActualParameterExpression" = None, Expression174: "gastm_ArrayAccess" = None, Expression139: "gastm_CaseBlock" = None, Expression106: "gastm_DeleteStatement" = None, Expression296: "sastm_RDBCursorStatement" = None):
        self.value = value
...
class gastm_DataDefinition(Definition):
    ...
    def __init__(self, isMutable: bool, gastm_DataDefinition: "Expression" = None, Definition: "gastm_Declaration" = None):
...
class sastm_RDBColumnDefinition(Definition):
    ...
    def __init__(self, NotNull: bool, Definition: "gastm_Declaration" = None):
...
class sastm_RDBIndexColumn(OtherSyntaxObject):
    ...
    def __init__(self, AscendingOrDescending: str, sastm_RDBIndexColumn: "IncludeUnit" = None, OtherSyntaxObject193: "gastm_UnaryExpression" = None, OtherSyntaxObject198: "gastm_BinaryExpression" = None, OtherSyntaxObject95: "gastm_DerivesFrom" = None, OtherSyntaxObject19: "gastm_DeclarationOrDefinition" = None, OtherSyntaxObject230: "gastm_NewExpression" = None, OtherSyntaxObject206: "gastm_OperatorAssign" = None, OtherSyntaxObject: "gastm_DeclarationOrDefinition" = None):
...
class gastm_DerivesFrom(OtherSyntaxObject):
    ...
    def __init__(self, isVirtual: bool, gastm_DerivesFrom: "OtherSyntaxObject" = None, gastm_DerivesFrom97: "NamedType" = None, OtherSyntaxObject193: "gastm_UnaryExpression" = None, OtherSyntaxObject198: "gastm_BinaryExpression" = None, OtherSyntaxObject95: "gastm_DerivesFrom" = None, OtherSyntaxObject19: "gastm_DeclarationOrDefinition" = None, OtherSyntaxObject230: "gastm_NewExpression" = None, OtherSyntaxObject206: "gastm_OperatorAssign" = None, OtherSyntaxObject: "gastm_DeclarationOrDefinition" = None):
...
class gastm_Name(OtherSyntaxObject):
    ...
    def __init__(self, nameString: str, OtherSyntaxObject193: "gastm_UnaryExpression" = None, OtherSyntaxObject198: "gastm_BinaryExpression" = None, OtherSyntaxObject95: "gastm_DerivesFrom" = None, OtherSyntaxObject19: "gastm_DeclarationOrDefinition" = None, OtherSyntaxObject230: "gastm_NewExpression" = None, OtherSyntaxObject206: "gastm_OperatorAssign" = None, OtherSyntaxObject: "gastm_DeclarationOrDefinition" = None):
...
class sastm_RDBIndex(OtherSyntaxObject):
    ...
    def __init__(self, NotNull: bool, IsUnique: bool, sastm_RDBIndex: set["Name"] = None, OtherSyntaxObject193: "gastm_UnaryExpression" = None, OtherSyntaxObject198: "gastm_BinaryExpression" = None, OtherSyntaxObject95: "gastm_DerivesFrom" = None, OtherSyntaxObject19: "gastm_DeclarationOrDefinition" = None, OtherSyntaxObject230: "gastm_NewExpression" = None, OtherSyntaxObject206: "gastm_OperatorAssign" = None, OtherSyntaxObject: "gastm_DeclarationOrDefinition" = None):
        self.NotNull = NotNull
...
class gastm_CompilationUnit(OtherSyntaxObject):
    ...
    def __init__(self, language: str, gastm_CompilationUnit: set["DefinitionObject"] = None, gastm_CompilationUnit15: "ProgramScope" = None, OtherSyntaxObject193: "gastm_UnaryExpression" = None, OtherSyntaxObject198: "gastm_BinaryExpression" = None, OtherSyntaxObject95: "gastm_DerivesFrom" = None, OtherSyntaxObject19: "gastm_DeclarationOrDefinition" = None, OtherSyntaxObject230: "gastm_NewExpression" = None, OtherSyntaxObject206: "gastm_OperatorAssign" = None, OtherSyntaxObject: "gastm_DeclarationOrDefinition" = None):
...
class gastm_MacroDefinition(PreprocessorElement):
    ...
    def __init__(self, macroName: str, body: str, PreprocessorElement: "gastm_GASTMSyntaxObject" = None):
...
class gastm_Comment(PreprocessorElement):
    ...
    def __init__(self, text: str, PreprocessorElement: "gastm_GASTMSyntaxObject" = None):
        self.text = text
...
class gastm_DeclarationOrDefinition(DefinitionObject):
    ...
    def __init__(self, isRegister: bool, linkageSpecifier: str, gastm_DeclarationOrDefinition: "OtherSyntaxObject" = None, gastm_DeclarationOrDefinition18: "OtherSyntaxObject" = None, DefinitionObject108: "gastm_DeclarationOrDefinitionStatement" = None, DefinitionObject77: "gastm_AggregateType" = None, DefinitionObject172: "gastm_NameReference" = None, DefinitionObject: "gastm_Scope" = None, DefinitionObject63: "gastm_NameSpaceDefinition" = None, DefinitionObject13: "gastm_CompilationUnit" = None):
