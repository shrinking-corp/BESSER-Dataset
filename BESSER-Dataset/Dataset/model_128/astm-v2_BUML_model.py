...
gastm_Scope = Class(name="gastm_Scope")
DefinitionObject = Class(name="DefinitionObject")
Scope = Class(name="Scope")
gastm_GASTMSyntaxObject = Class(name="gastm_GASTMSyntaxObject", is_abstract=True)
...
gastm_CompilationUnit = Class(name="gastm_CompilationUnit")
OtherSyntaxObject = Class(name="OtherSyntaxObject")
ProgramScope = Class(name="ProgramScope")
gastm_Name = Class(name="gastm_Name")
gastm_GASTMObject = Class(name="gastm_GASTMObject")
gastm_GASTMSourceObject = Class(name="gastm_GASTMSourceObject", is_abstract=True)
gastm_GASTMSemanticObject = Class(name="gastm_GASTMSemanticObject", is_abstract=True)
gastm_OtherSyntaxObject = Class(name="gastm_OtherSyntaxObject", is_abstract=True)
gastm_StorageSpecification = Class(name="gastm_StorageSpecification", is_abstract=True)
gastm_DataType = Class(name="gastm_DataType", is_abstract=True)
gastm_AccessKind = Class(name="gastm_AccessKind")
gastm_UnaryOperator = Class(name="gastm_UnaryOperator", is_abstract=True)
gastm_BinaryOperator = Class(name="gastm_BinaryOperator", is_abstract=True)
gastm_ActualParameter = Class(name="gastm_ActualParameter", is_abstract=True)
gastm_SourceFile = Class(name="gastm_SourceFile")
GASTMSourceObject = Class(name="GASTMSourceObject")
gastm_SourceLocation = Class(name="gastm_SourceLocation")
SourceFile = Class(name="SourceFile")
gastm_Project = Class(name="gastm_Project")
GASTMSemanticObject = Class(name="GASTMSemanticObject")
CompilationUnit = Class(name="CompilationUnit")
gastm_VariableDeclaration = Class(name="gastm_VariableDeclaration")
gastm_FunctionDefinition = Class(name="gastm_FunctionDefinition")
FormalParameterDefinition = Class(name="FormalParameterDefinition")
Statement = Class(name="Statement")
FunctionScope = Class(name="FunctionScope")
gastm_FunctionMemberAttributes = Class(name="gastm_FunctionMemberAttributes")
VirtualSpecification = Class(name="VirtualSpecification")
gastm_EntryDefinition = Class(name="gastm_EntryDefinition")
gastm_DeclarationOrDefinition = Class(name="gastm_DeclarationOrDefinition", is_abstract=True)
gastm_Definition = Class(name="gastm_Definition", is_abstract=True)
DeclarationOrDefinition = Class(name="DeclarationOrDefinition")
Name = Class(name="Name")
TypeReference = Class(name="TypeReference")
gastm_Declaration = Class(name="gastm_Declaration", is_abstract=True)
Definition = Class(name="Definition")
gastm_FunctionDeclaration = Class(name="gastm_FunctionDeclaration")
...
gastm_LabelDefinition = Class(name="gastm_LabelDefinition")
LabelType = Class(name="LabelType")
gastm_IncludeUnit = Class(name="gastm_IncludeUnit")
gastm_MacroCall = Class(name="gastm_MacroCall")
MacroDefinition = Class(name="MacroDefinition")
gastm_MacroDefinition = Class(name="gastm_MacroDefinition")
gastm_Comment = Class(name="gastm_Comment")
gastm_Type = Class(name="gastm_Type", is_abstract=True)
GASTMSyntaxObject = Class(name="GASTMSyntaxObject")
gastm_DataDefinition = Class(name="gastm_DataDefinition", is_abstract=True)
Expression = Class(name="Expression")
gastm_BitFieldDefinition = Class(name="gastm_BitFieldDefinition")
DataDefinition = Class(name="DataDefinition")
gastm_EnumLiteralDefinition = Class(name="gastm_EnumLiteralDefinition")
gastm_TypeDefinition = Class(name="gastm_TypeDefinition")
gastm_NamedTypeDefinition = Class(name="gastm_NamedTypeDefinition")
TypeDefinition = Class(name="TypeDefinition")
NamedType = Class(name="NamedType")
gastm_AggregateTypeDefinition = Class(name="gastm_AggregateTypeDefinition")
AggregateType = Class(name="AggregateType")
gastm_NameSpaceDefinition = Class(name="gastm_NameSpaceDefinition")
Type = Class(name="Type")
FormalParameterType = Class(name="FormalParameterType")
gastm_FormalParameterType = Class(name="gastm_FormalParameterType", is_abstract=True)
gastm_NamedType = Class(name="gastm_NamedType")
gastm_ClassType = Class(name="gastm_ClassType")
DerivesFrom = Class(name="DerivesFrom")
gastm_DerivesFrom = Class(name="gastm_DerivesFrom")
gastm_UnnamedTypeReference = Class(name="gastm_UnnamedTypeReference")
gastm_PrimitiveType = Class(name="gastm_PrimitiveType", is_abstract=True)
DataType = Class(name="DataType")
gastm_EnumType = Class(name="gastm_EnumType")
EnumLiteralDefinition = Class(name="EnumLiteralDefinition")
gastm_ConstructedType = Class(name="gastm_ConstructedType", is_abstract=True)
gastm_AggregateType = Class(name="gastm_AggregateType", is_abstract=True)
AggregateScope = Class(name="AggregateScope")
gastm_ArrayType = Class(name="gastm_ArrayType")
ConstructedType = Class(name="ConstructedType")
Dimension = Class(name="Dimension")
gastm_Dimension = Class(name="gastm_Dimension")
gastm_FunctionType = Class(name="gastm_FunctionType")
gastm_DeclarationOrDefinitionStatement = Class(name="gastm_DeclarationOrDefinitionStatement")
gastm_ExpressionStatement = Class(name="gastm_ExpressionStatement")
gastm_JumpStatement = Class(name="gastm_JumpStatement")
gastm_BreakStatement = Class(name="gastm_BreakStatement")
LabelAccess = Class(name="LabelAccess")
gastm_ContinueStatement = Class(name="gastm_ContinueStatement")
gastm_NamedTypeReference = Class(name="gastm_NamedTypeReference")
SwitchCase = Class(name="SwitchCase")
gastm_DeleteStatement = Class(name="gastm_DeleteStatement")
gastm_SwitchCase = Class(name="gastm_SwitchCase")
gastm_CaseBlock = Class(name="gastm_CaseBlock")
gastm_ReturnStatement = Class(name="gastm_ReturnStatement")
gastm_LoopStatement = Class(name="gastm_LoopStatement")
gastm_LabeledStatement = Class(name="gastm_LabeledStatement")
LabelDefinition = Class(name="LabelDefinition")
gastm_BlockStatement = Class(name="gastm_BlockStatement")
BlockScope = Class(name="BlockScope")
gastm_EmptyStatement = Class(name="gastm_EmptyStatement")
gastm_IfStatement = Class(name="gastm_IfStatement")
gastm_SwitchStatement = Class(name="gastm_SwitchStatement")
gastm_VariableCatchBlock = Class(name="gastm_VariableCatchBlock")
gastm_ThrowStatement = Class(name="gastm_ThrowStatement")
gastm_Expression = Class(name="gastm_Expression", is_abstract=True)
gastm_NameReference = Class(name="gastm_NameReference", is_abstract=True)
gastm_ForStatement = Class(name="gastm_ForStatement", is_abstract=True)
LoopStatement = Class(name="LoopStatement")
gastm_TryStatement = Class(name="gastm_TryStatement")
CatchBlock = Class(name="CatchBlock")
gastm_CatchBlock = Class(name="gastm_CatchBlock")
gastm_TypesCatchBlock = Class(name="gastm_TypesCatchBlock")
gastm_UnaryExpression = Class(name="gastm_UnaryExpression")
gastm_BinaryExpression = Class(name="gastm_BinaryExpression")
gastm_ArrayAccess = Class(name="gastm_ArrayAccess")
gastm_QualifiedIdentifierReference = Class(name="gastm_QualifiedIdentifierReference", is_abstract=True)
NameReference = Class(name="NameReference")
IdentifierReference = Class(name="IdentifierReference")
gastm_TypeQualifiedIdentifierReference = Class(name="gastm_TypeQualifiedIdentifierReference")
gastm_Literal = Class(name="gastm_Literal")
gastm_CastExpression = Class(name="gastm_CastExpression")
gastm_FunctionCallExpression = Class(name="gastm_FunctionCallExpression")
ActualParameter = Class(name="ActualParameter")
gastm_ActualParameterExpression = Class(name="gastm_ActualParameterExpression")
gastm_OperatorAssign = Class(name="gastm_OperatorAssign")
BinaryOperator = Class(name="BinaryOperator")
gastm_ConditionalExpression = Class(name="gastm_ConditionalExpression")
gastm_RangeExpression = Class(name="gastm_RangeExpression")
gastm_GlobalScope = Class(name="gastm_GlobalScope")
gastm_PreprocessorElement = Class(name="gastm_PreprocessorElement", is_abstract=True)
gastm_DefinitionObject = Class(name="gastm_DefinitionObject", is_abstract=True)
gastm_ProgramScope = Class(name="gastm_ProgramScope")
gastm_TypeReference = Class(name="gastm_TypeReference", is_abstract=True)
gastm_Statement = Class(name="gastm_Statement", is_abstract=True)
gastm_FunctionScope = Class(name="gastm_FunctionScope")
gastm_NameSpaceType = Class(name="gastm_NameSpaceType")
gastm_LabelType = Class(name="gastm_LabelType")
gastm_AggregateScope = Class(name="gastm_AggregateScope")
gastm_BlockScope = Class(name="gastm_BlockScope")
gastm_IdentifierReference = Class(name="gastm_IdentifierReference")
gastm_FormalParameterDefinition = Class(name="gastm_FormalParameterDefinition")
gastm_VirtualSpecification = Class(name="gastm_VirtualSpecification", is_abstract=True)
gastm_NewExpression = Class(name="gastm_NewExpression")
gastm_LabelAccess = Class(name="gastm_LabelAccess")
gastm_AnnotationExpression = Class(name="gastm_AnnotationExpression")
gastm_PointerType = Class(name="gastm_PointerType")
gastm_ReferenceType = Class(name="gastm_ReferenceType")
gastm_RangeType = Class(name="gastm_RangeType")
gastm_StructureType = Class(name="gastm_StructureType")
gastm_UnionType = Class(name="gastm_UnionType")
gastm_AnnotationType = Class(name="gastm_AnnotationType")
gastm_ByValueFormalParameterType = Class(name="gastm_ByValueFormalParameterType")
gastm_ByReferenceFormalParameterType = Class(name="gastm_ByReferenceFormalParameterType")
gastm_Public = Class(name="gastm_Public")
AccessKind = Class(name="AccessKind")
gastm_Protected = Class(name="gastm_Protected")
gastm_Private = Class(name="gastm_Private")
gastm_TerminateStatement = Class(name="gastm_TerminateStatement")
gastm_DefaultBlock = Class(name="gastm_DefaultBlock")
gastm_WhileStatement = Class(name="gastm_WhileStatement")
gastm_DoWhileStatement = Class(name="gastm_DoWhileStatement")
gastm_ForCheckBeforeStatement = Class(name="gastm_ForCheckBeforeStatement")
ForStatement = Class(name="ForStatement")
gastm_FormalParameterDeclaration = Class(name="gastm_FormalParameterDeclaration")
gastm_VariableDefinition = Class(name="gastm_VariableDefinition")
gastm_FunctionMemberAttribute = Class(name="gastm_FunctionMemberAttribute")
gastm_External = Class(name="gastm_External")
StorageSpecification = Class(name="StorageSpecification")
gastm_FunctionPersistent = Class(name="gastm_FunctionPersistent")
gastm_FileLocal = Class(name="gastm_FileLocal")
gastm_PerClassMember = Class(name="gastm_PerClassMember")
gastm_NoDef = Class(name="gastm_NoDef")
gastm_Virtual = Class(name="gastm_Virtual")
gastm_PureVirtual = Class(name="gastm_PureVirtual")
gastm_NonVirtual = Class(name="gastm_NonVirtual")
gastm_ExceptionType = Class(name="gastm_ExceptionType")
gastm_Void = Class(name="gastm_Void")
PrimitiveType = Class(name="PrimitiveType")
gastm_Byte = Class(name="gastm_Byte")
gastm_ShortInteger = Class(name="gastm_ShortInteger")
gastm_Integer = Class(name="gastm_Integer")
gastm_LongInteger = Class(name="gastm_LongInteger")
gastm_Float = Class(name="gastm_Float")
gastm_Double = Class(name="gastm_Double")
gastm_LongDouble = Class(name="gastm_LongDouble")
gastm_Character = Class(name="gastm_Character")
gastm_String = Class(name="gastm_String")
gastm_Boolean = Class(name="gastm_Boolean")
gastm_WideCharacter = Class(name="gastm_WideCharacter")
gastm_CollectionType = Class(name="gastm_CollectionType")
gastm_PostIncrement = Class(name="gastm_PostIncrement")
gastm_PostDecrement = Class(name="gastm_PostDecrement")
gastm_Add = Class(name="gastm_Add")
gastm_Subtract = Class(name="gastm_Subtract")
gastm_Multiply = Class(name="gastm_Multiply")
gastm_Divide = Class(name="gastm_Divide")
gastm_Modulus = Class(name="gastm_Modulus")
gastm_Exponent = Class(name="gastm_Exponent")
gastm_And = Class(name="gastm_And")
gastm_Or = Class(name="gastm_Or")
gastm_Equal = Class(name="gastm_Equal")
gastm_NotEqual = Class(name="gastm_NotEqual")
gastm_Greater = Class(name="gastm_Greater")
gastm_ForCheckAfterStatement = Class(name="gastm_ForCheckAfterStatement")
gastm_AggregateExpression = Class(name="gastm_AggregateExpression")
gastm_QualifiedOverPointer = Class(name="gastm_QualifiedOverPointer")
QualifiedIdentifierReference = Class(name="QualifiedIdentifierReference")
gastm_QualifiedOverData = Class(name="gastm_QualifiedOverData")
gastm_IntegerlLiteral = Class(name="gastm_IntegerlLiteral")
Literal = Class(name="Literal")
gastm_StringLiteral = Class(name="gastm_StringLiteral")
gastm_CharLiteral = Class(name="gastm_CharLiteral")
gastm_RealLiteral = Class(name="gastm_RealLiteral")
gastm_BooleanLiteral = Class(name="gastm_BooleanLiteral")
gastm_BitLiteral = Class(name="gastm_BitLiteral")
gastm_UnaryPlus = Class(name="gastm_UnaryPlus")
UnaryOperator = Class(name="UnaryOperator")
gastm_Negate = Class(name="gastm_Negate")
gastm_Not = Class(name="gastm_Not")
gastm_BitNot = Class(name="gastm_BitNot")
gastm_AddressOf = Class(name="gastm_AddressOf")
gastm_Deref = Class(name="gastm_Deref")
gastm_Increment = Class(name="gastm_Increment")
gastm_Decrement = Class(name="gastm_Decrement")
gastm_SpecificLessEqual = Class(name="gastm_SpecificLessEqual")
gastm_SpecificGreaterEqual = Class(name="gastm_SpecificGreaterEqual")
gastm_SpecificIn = Class(name="gastm_SpecificIn")
gastm_SpecificLike = Class(name="gastm_SpecificLike")
gastm_SpecificConcatString = Class(name="gastm_SpecificConcatString")
gastm_SpecificSelectStatement = Class(name="gastm_SpecificSelectStatement")
sastm_RDBDatabaseDefinition = Class(name="sastm_RDBDatabaseDefinition")
RDBTableSpaceReference = Class(name="RDBTableSpaceReference")
sastm_RDBTableSpaceReference = Class(name="sastm_RDBTableSpaceReference")
sastm_RDBUserDefinition = Class(name="sastm_RDBUserDefinition")
NameSpaceDefinition = Class(name="NameSpaceDefinition")
sastm_RDBTableSpaceDefinition = Class(name="sastm_RDBTableSpaceDefinition")
gastm_NotGreater = Class(name="gastm_NotGreater")
sastm_RDBTableDefinition = Class(name="sastm_RDBTableDefinition")
gastm_Less = Class(name="gastm_Less")
IncludeUnit = Class(name="IncludeUnit")
gastm_NotLess = Class(name="gastm_NotLess")
gastm_BitAnd = Class(name="gastm_BitAnd")
gastm_BitOr = Class(name="gastm_BitOr")
gastm_BitXor = Class(name="gastm_BitXor")
gastm_BitLeftShift = Class(name="gastm_BitLeftShift")
gastm_BitRightShift = Class(name="gastm_BitRightShift")
gastm_Assign = Class(name="gastm_Assign")
gastm_MissingActualParameter = Class(name="gastm_MissingActualParameter")
gastm_ByValueActualParameterExpression = Class(name="gastm_ByValueActualParameterExpression")
ActualParameterExpression = Class(name="ActualParameterExpression")
gastm_ByReferenceActualParameterExpression = Class(name="gastm_ByReferenceActualParameterExpression")
gastm_SpecificTriggerDefinition = Class(name="gastm_SpecificTriggerDefinition")
sastm_RDBTrigger = Class(name="sastm_RDBTrigger")
sastm_RDBConstraint = Class(name="sastm_RDBConstraint")
sastm_RDBCheckConstraint = Class(name="sastm_RDBCheckConstraint")
RDBConstraint = Class(name="RDBConstraint")
sastm_RDBRefIntegrity = Class(name="sastm_RDBRefIntegrity")
sastm_RDBUniqueKey = Class(name="sastm_RDBUniqueKey")
sastm_RDBConnectStatement = Class(name="sastm_RDBConnectStatement")
NamedTypeDefinition = Class(name="NamedTypeDefinition")
sastm_RDBSelectStatement = Class(name="sastm_RDBSelectStatement")
Project = Class(name="Project")
sastm_RDBColumnDefinition = Class(name="sastm_RDBColumnDefinition")
sastm_RDBViewDefinition = Class(name="sastm_RDBViewDefinition")
AggregateTypeDefinition = Class(name="AggregateTypeDefinition")
sastm_RDBCursorDefinition = Class(name="sastm_RDBCursorDefinition")
sastm_RDBIndex = Class(name="sastm_RDBIndex")
sastm_RDBIndexColumn = Class(name="sastm_RDBIndexColumn")
sastm_RDBUpdateStatement = Class(name="sastm_RDBUpdateStatement")
RDBModifyStatement = Class(name="RDBModifyStatement")
sastm_RDBCursorStatement = Class(name="sastm_RDBCursorStatement", is_abstract=True)
sastm_RDBOpenCursorStatement = Class(name="sastm_RDBOpenCursorStatement")
RDBCursorStatement = Class(name="RDBCursorStatement")
sastm_RDBFetchCursorStatement = Class(name="sastm_RDBFetchCursorStatement")
RDBHostVariableReference = Class(name="RDBHostVariableReference")
sastm_RDBHostVariableReference = Class(name="sastm_RDBHostVariableReference")
sastm_RDBInsertStatement = Class(name="sastm_RDBInsertStatement")
sastm_RDBModifyStatement = Class(name="sastm_RDBModifyStatement", is_abstract=True)
sastm_RDBDataBaseType = Class(name="sastm_RDBDataBaseType")
sastm_RDBUserType = Class(name="sastm_RDBUserType")
sastm_RDBTableSpaceType = Class(name="sastm_RDBTableSpaceType")
sastm_RDBTableType = Class(name="sastm_RDBTableType")
sastm_RDBViewType = Class(name="sastm_RDBViewType")
sastm_RDBCursorType = Class(name="sastm_RDBCursorType")
sastm_RDBInteger = Class(name="sastm_RDBInteger")
sastm_RDBInt = Class(name="sastm_RDBInt")
sastm_RDBReal = Class(name="sastm_RDBReal")
sastm_RDBFloat = Class(name="sastm_RDBFloat")
sastm_RDBDecimal = Class(name="sastm_RDBDecimal")
sastm_RDBNumber = Class(name="sastm_RDBNumber")
sastm_RDBLong = Class(name="sastm_RDBLong")
sastm_RDBChar = Class(name="sastm_RDBChar")
sastm_RDBVarchar = Class(name="sastm_RDBVarchar")
sastm_RDBString = Class(name="sastm_RDBString")
sastm_RDBRaw = Class(name="sastm_RDBRaw")
sastm_RDBDate = Class(name="sastm_RDBDate")
sastm_RDBTimestamp = Class(name="sastm_RDBTimestamp")
sastm_RDBRowid = Class(name="sastm_RDBRowid")
sastm_RDBBoolean = Class(name="sastm_RDBBoolean")
sastm_RDBBlob = Class(name="sastm_RDBBlob")
sastm_RDBSelectExpression = Class(name="sastm_RDBSelectExpression")
sastm_RDBTableReference = Class(name="sastm_RDBTableReference")
sastm_RDBTableAlias = Class(name="sastm_RDBTableAlias")
sastm_RDBColumnReference = Class(name="sastm_RDBColumnReference")
sastm_RDBClob = Class(name="sastm_RDBClob")
sastm_RDBNClob = Class(name="sastm_RDBNClob")
sastm_RDBBFile = Class(name="sastm_RDBBFile")
sastm_RDBDeleteStatement = Class(name="sastm_RDBDeleteStatement")
sastm_RDBCloseCursorStatement = Class(name="sastm_RDBCloseCursorStatement")
sastm_RDBHostVariableExpression = Class(name="sastm_RDBHostVariableExpression")
...
gastm_SourceLocation.attributes={gastm_SourceLocation_startLine, gastm_SourceLocation_endLine, gastm_SourceLocation_startColumn, gastm_SourceLocation_endColumn}
...
gastm_FunctionMemberAttributes.attributes={gastm_FunctionMemberAttributes_isInline, gastm_FunctionMemberAttributes_isFriend, gastm_FunctionMemberAttributes_isThisConst}
...
sastm_RDBCheckConstraint.attributes={sastm_RDBCheckConstraint_RDBConstraintText, sastm_RDBCheckConstraint_RDBConstraintType}
...
domain_model = DomainModel(
    name="sastm",
    types={GlobalScope, gastm_Scope, DefinitionObject, Scope, gastm_GASTMSyntaxObject, GASTMObject, SourceLocation, PreprocessorElement, AnnotationExpression, gastm_CompilationUnit, OtherSyntaxObject, ProgramScope, gastm_Name, gastm_GASTMObject, gastm_GASTMSourceObject, gastm_GASTMSemanticObject, gastm_OtherSyntaxObject, gastm_StorageSpecification, gastm_DataType, gastm_AccessKind, gastm_UnaryOperator, gastm_BinaryOperator, gastm_ActualParameter, gastm_SourceFile, GASTMSourceObject, gastm_SourceLocation, SourceFile, gastm_Project, GASTMSemanticObject, CompilationUnit, gastm_VariableDeclaration, gastm_FunctionDefinition, FormalParameterDefinition, Statement, FunctionScope, gastm_FunctionMemberAttributes, VirtualSpecification, gastm_EntryDefinition, gastm_DeclarationOrDefinition, gastm_Definition, DeclarationOrDefinition, Name, TypeReference, gastm_Declaration, Definition, gastm_FunctionDeclaration, Declaration, FormalParameterDeclaration, FunctionMemberAttributes, NameSpaceType, gastm_LabelDefinition, LabelType, gastm_IncludeUnit, gastm_MacroCall, MacroDefinition, gastm_MacroDefinition, gastm_Comment, gastm_Type, GASTMSyntaxObject, gastm_DataDefinition, Expression, gastm_BitFieldDefinition, DataDefinition, gastm_EnumLiteralDefinition, gastm_TypeDefinition, gastm_NamedTypeDefinition, TypeDefinition, NamedType, gastm_AggregateTypeDefinition, AggregateType, gastm_NameSpaceDefinition, Type, FormalParameterType, gastm_FormalParameterType, gastm_NamedType, gastm_ClassType, DerivesFrom, gastm_DerivesFrom, gastm_UnnamedTypeReference, gastm_PrimitiveType, DataType, gastm_EnumType, EnumLiteralDefinition, gastm_ConstructedType, gastm_AggregateType, AggregateScope, gastm_ArrayType, ConstructedType, Dimension, gastm_Dimension, gastm_FunctionType, gastm_DeclarationOrDefinitionStatement, gastm_ExpressionStatement, gastm_JumpStatement, gastm_BreakStatement, LabelAccess, gastm_ContinueStatement, gastm_NamedTypeReference, SwitchCase, gastm_DeleteStatement, gastm_SwitchCase, gastm_CaseBlock, gastm_ReturnStatement, gastm_LoopStatement, gastm_LabeledStatement, LabelDefinition, gastm_BlockStatement, BlockScope, gastm_EmptyStatement, gastm_IfStatement, gastm_SwitchStatement, gastm_VariableCatchBlock, gastm_ThrowStatement, gastm_Expression, gastm_NameReference, gastm_ForStatement, LoopStatement, gastm_TryStatement, CatchBlock, gastm_CatchBlock, gastm_TypesCatchBlock, gastm_UnaryExpression, gastm_BinaryExpression, gastm_ArrayAccess, gastm_QualifiedIdentifierReference, NameReference, IdentifierReference, gastm_TypeQualifiedIdentifierReference, gastm_Literal, gastm_CastExpression, gastm_FunctionCallExpression, ActualParameter, gastm_ActualParameterExpression, gastm_OperatorAssign, BinaryOperator, gastm_ConditionalExpression, gastm_RangeExpression, gastm_GlobalScope, gastm_PreprocessorElement, gastm_DefinitionObject, gastm_ProgramScope, gastm_TypeReference, gastm_Statement, gastm_FunctionScope, gastm_NameSpaceType, gastm_LabelType, gastm_AggregateScope, gastm_BlockScope, gastm_IdentifierReference, gastm_FormalParameterDefinition, gastm_VirtualSpecification, gastm_NewExpression, gastm_LabelAccess, gastm_AnnotationExpression, gastm_PointerType, gastm_ReferenceType, gastm_RangeType, gastm_StructureType, gastm_UnionType, gastm_AnnotationType, gastm_ByValueFormalParameterType, gastm_ByReferenceFormalParameterType, gastm_Public, AccessKind, gastm_Protected, gastm_Private, gastm_TerminateStatement, gastm_DefaultBlock, gastm_WhileStatement, gastm_DoWhileStatement, gastm_ForCheckBeforeStatement, ForStatement, gastm_FormalParameterDeclaration, gastm_VariableDefinition, gastm_FunctionMemberAttribute, gastm_External, StorageSpecification, gastm_FunctionPersistent, gastm_FileLocal, gastm_PerClassMember, gastm_NoDef, gastm_Virtual, gastm_PureVirtual, gastm_NonVirtual, gastm_ExceptionType, gastm_Void, PrimitiveType, gastm_Byte, gastm_ShortInteger, gastm_Integer, gastm_LongInteger, gastm_Float, gastm_Double, gastm_LongDouble, gastm_Character, gastm_String, gastm_Boolean, gastm_WideCharacter, gastm_CollectionType, gastm_PostIncrement, gastm_PostDecrement, gastm_Add, gastm_Subtract, gastm_Multiply, gastm_Divide, gastm_Modulus, gastm_Exponent, gastm_And, gastm_Or, gastm_Equal, gastm_NotEqual, gastm_Greater, gastm_ForCheckAfterStatement, gastm_AggregateExpression, gastm_QualifiedOverPointer, QualifiedIdentifierReference, gastm_QualifiedOverData, gastm_IntegerlLiteral, Literal, gastm_StringLiteral, gastm_CharLiteral, gastm_RealLiteral, gastm_BooleanLiteral, gastm_BitLiteral, gastm_UnaryPlus, UnaryOperator, gastm_Negate, gastm_Not, gastm_BitNot, gastm_AddressOf, gastm_Deref, gastm_Increment, gastm_Decrement, gastm_SpecificLessEqual, gastm_SpecificGreaterEqual, gastm_SpecificIn, gastm_SpecificLike, gastm_SpecificConcatString, gastm_SpecificSelectStatement, sastm_RDBDatabaseDefinition, RDBTableSpaceReference, sastm_RDBTableSpaceReference, sastm_RDBUserDefinition, NameSpaceDefinition, sastm_RDBTableSpaceDefinition, gastm_NotGreater, sastm_RDBTableDefinition, gastm_Less, IncludeUnit, gastm_NotLess, gastm_BitAnd, gastm_BitOr, gastm_BitXor, gastm_BitLeftShift, gastm_BitRightShift, gastm_Assign, gastm_MissingActualParameter, gastm_ByValueActualParameterExpression, ActualParameterExpression, gastm_ByReferenceActualParameterExpression, gastm_SpecificTriggerDefinition, sastm_RDBTrigger, sastm_RDBConstraint, sastm_RDBCheckConstraint, RDBConstraint, sastm_RDBRefIntegrity, sastm_RDBUniqueKey, sastm_RDBConnectStatement, NamedTypeDefinition, sastm_RDBSelectStatement, Project, sastm_RDBColumnDefinition, sastm_RDBViewDefinition, AggregateTypeDefinition, sastm_RDBCursorDefinition, sastm_RDBIndex, sastm_RDBIndexColumn, sastm_RDBUpdateStatement, RDBModifyStatement, sastm_RDBCursorStatement, sastm_RDBOpenCursorStatement, RDBCursorStatement, sastm_RDBFetchCursorStatement, RDBHostVariableReference, sastm_RDBHostVariableReference, sastm_RDBInsertStatement, sastm_RDBModifyStatement, sastm_RDBDataBaseType, sastm_RDBUserType, sastm_RDBTableSpaceType, sastm_RDBTableType, sastm_RDBViewType, sastm_RDBCursorType, sastm_RDBInteger, sastm_RDBInt, sastm_RDBReal, sastm_RDBFloat, sastm_RDBDecimal, sastm_RDBNumber, sastm_RDBLong, sastm_RDBChar, sastm_RDBVarchar, sastm_RDBString, sastm_RDBRaw, sastm_RDBDate, sastm_RDBTimestamp, sastm_RDBRowid, sastm_RDBBoolean, sastm_RDBBlob, sastm_RDBSelectExpression, sastm_RDBTableReference, sastm_RDBTableAlias, sastm_RDBColumnReference, sastm_RDBClob, sastm_RDBNClob, sastm_RDBBFile, sastm_RDBDeleteStatement, sastm_RDBCloseCursorStatement, sastm_RDBHostVariableExpression},
    associations={outerScope2, definitionObject4, childScope5, locationInfo7, preProcessorElements8, annotations10, fragments12, opensScope14, inSourceFile0, files1, functionMemberAttributes31, returnType33, formalParameters35, body37, functionMemberAttributes39, opensScope42, virtualSpecifier44, formalParameters45, body47, storageSpecifiers16, accessKind17, identifierName20, definitionType21, defRef23, identifierName24, declarationType27, formalParameters30, nameSpaceType64, labelName66, labelType68, file70, refersTo72, initialValue50, bitFieldSize51, value53, name55, definitionType57, aggregateType58, nameSpace59, body61, returnType86, parameterTypes88, type90, body92, derivesFrom93, accessKind94, className96, type99, enumLiterals73, baseType74, members76, opensScope78, ranks80, lowBound81, highBound83, declOrDefn107, expression109, target111, target113, name101, type103, cases134, operand105, body136, caseExpressions138, returnValue140, condition142, target114, label116, statement117, subStatements120, opensScope122, condition124, thenBody126, elseBody129, switchExpression132, exceptionVariable163, exception164, expressionType166, name168, body144, initBody147, iterationBody149, guardedStatement152, catchBlocks154, finalStatement156, body159, exceptions161, expression189, operator192, operand194, operator197, refersTo170, arrayName173, subscripts175, qualifiers178, member180, aggregateType182, member184, castType187, fromExpression215, toExpression217, calledFunction220, actualParams222, leftOperand199, rightOperand202, operator205, condition207, onTrueOperand209, onFalseOperand212, value224, newType226, actualParams228, name231, definition233, annotationType236, memberValues238, TableSpace243, Owns244, Table245, PrimKey247, body241, Column262, ForeignKey264, ParentKey266, ParentTable269, Column272, ConnectString274, Column248, Constraint250, Index252, Trigger255, DefinedBy257, SelectExpression258, IndexColumn260, Values293, Cursor295, Values297, Into299, BaseVariable300, SelectExpression275, IntoVariable277, IntoTable280, Columns282, Values285, Table288, Where290, Indicator302, Table305, Column307, Where310, Alias313, Table315},
    generalizations={gen_gastm_Scope_GASTMSemanticObject, gen_gastm_GASTMSyntaxObject_GASTMObject, gen_gastm_CompilationUnit_OtherSyntaxObject, gen_gastm_Name_OtherSyntaxObject, gen_gastm_SourceFile_GASTMSourceObject, gen_gastm_SourceLocation_GASTMSourceObject, gen_gastm_Project_GASTMSemanticObject, gen_gastm_VariableDeclaration_Declaration, gen_gastm_FunctionDefinition_Definition, gen_gastm_EntryDefinition_Definition, gen_gastm_DeclarationOrDefinition_DefinitionObject, gen_gastm_Definition_DeclarationOrDefinition, gen_gastm_Declaration_DeclarationOrDefinition, gen_gastm_FunctionDeclaration_Declaration, gen_gastm_LabelDefinition_DefinitionObject, gen_gastm_IncludeUnit_PreprocessorElement, gen_gastm_MacroCall_PreprocessorElement, gen_gastm_MacroDefinition_PreprocessorElement, gen_gastm_Comment_PreprocessorElement, gen_gastm_Type_GASTMSyntaxObject, gen_gastm_DataDefinition_Definition, gen_gastm_BitFieldDefinition_DataDefinition, gen_gastm_EnumLiteralDefinition_Definition, gen_gastm_TypeDefinition_DefinitionObject, gen_gastm_NamedTypeDefinition_TypeDefinition, gen_gastm_AggregateTypeDefinition_TypeDefinition, gen_gastm_NameSpaceDefinition_DefinitionObject, gen_gastm_FunctionType_Type, gen_gastm_FormalParameterType_DataType, gen_gastm_NamedType_DataType, gen_gastm_ClassType_AggregateType, gen_gastm_DerivesFrom_OtherSyntaxObject, gen_gastm_UnnamedTypeReference_TypeReference, gen_gastm_PrimitiveType_DataType, gen_gastm_EnumType_DataType, gen_gastm_ConstructedType_DataType, gen_gastm_AggregateType_DataType, gen_gastm_ArrayType_ConstructedType, gen_gastm_Dimension_OtherSyntaxObject, gen_gastm_DeclarationOrDefinitionStatement_Statement, gen_gastm_ExpressionStatement_Statement, gen_gastm_JumpStatement_Statement, gen_gastm_BreakStatement_Statement, gen_gastm_ContinueStatement_Statement, gen_gastm_NamedTypeReference_TypeReference, gen_gastm_DeleteStatement_Statement, gen_gastm_SwitchCase_OtherSyntaxObject, gen_gastm_CaseBlock_SwitchCase, gen_gastm_ReturnStatement_Statement, gen_gastm_LoopStatement_Statement, gen_gastm_LabeledStatement_Statement, gen_gastm_BlockStatement_Statement, gen_gastm_EmptyStatement_Statement, gen_gastm_IfStatement_Statement, gen_gastm_SwitchStatement_Statement, gen_gastm_VariableCatchBlock_CatchBlock, gen_gastm_ThrowStatement_Statement, gen_gastm_Expression_GASTMSyntaxObject, gen_gastm_NameReference_Expression, gen_gastm_ForStatement_LoopStatement, gen_gastm_TryStatement_Statement, gen_gastm_CatchBlock_OtherSyntaxObject, gen_gastm_TypesCatchBlock_CatchBlock, gen_gastm_UnaryExpression_Expression, gen_gastm_BinaryExpression_Expression, gen_gastm_ArrayAccess_Expression, gen_gastm_QualifiedIdentifierReference_NameReference, gen_gastm_TypeQualifiedIdentifierReference_NameReference, gen_gastm_Literal_Expression, gen_gastm_CastExpression_Expression, gen_gastm_FunctionCallExpression_Expression, gen_gastm_ActualParameterExpression_ActualParameter, gen_gastm_OperatorAssign_BinaryOperator, gen_gastm_ConditionalExpression_Expression, gen_gastm_RangeExpression_Expression, gen_gastm_GlobalScope_Scope, gen_gastm_PreprocessorElement_GASTMSyntaxObject, gen_gastm_DefinitionObject_GASTMSyntaxObject, gen_gastm_ProgramScope_Scope, gen_gastm_TypeReference_Type, gen_gastm_Statement_GASTMSyntaxObject, gen_gastm_FunctionScope_Scope, gen_gastm_NameSpaceType_Type, gen_gastm_LabelType_Type, gen_gastm_AggregateScope_Scope, gen_gastm_BlockScope_Scope, gen_gastm_IdentifierReference_NameReference, gen_gastm_FormalParameterDefinition_DataDefinition, gen_gastm_VirtualSpecification_OtherSyntaxObject, gen_gastm_NewExpression_Expression, gen_gastm_LabelAccess_Expression, gen_gastm_AnnotationExpression_Expression, gen_gastm_PointerType_ConstructedType, gen_gastm_ReferenceType_ConstructedType, gen_gastm_RangeType_ConstructedType, gen_gastm_StructureType_AggregateType, gen_gastm_UnionType_AggregateType, gen_gastm_AnnotationType_AggregateType, gen_gastm_ByValueFormalParameterType_FormalParameterType, gen_gastm_ByReferenceFormalParameterType_FormalParameterType, gen_gastm_Public_AccessKind, gen_gastm_Protected_AccessKind, gen_gastm_Private_AccessKind, gen_gastm_TerminateStatement_Statement, gen_gastm_DefaultBlock_SwitchCase, gen_gastm_WhileStatement_LoopStatement, gen_gastm_DoWhileStatement_LoopStatement, gen_gastm_FormalParameterDeclaration_Declaration, gen_gastm_VariableDefinition_DataDefinition, gen_gastm_FunctionMemberAttribute_OtherSyntaxObject, gen_gastm_External_StorageSpecification, gen_gastm_FunctionPersistent_StorageSpecification, gen_gastm_FileLocal_StorageSpecification, gen_gastm_PerClassMember_StorageSpecification, gen_gastm_NoDef_StorageSpecification, gen_gastm_Virtual_VirtualSpecification, gen_gastm_PureVirtual_VirtualSpecification, gen_gastm_NonVirtual_VirtualSpecification, gen_gastm_ExceptionType_DataType, gen_gastm_Void_PrimitiveType, gen_gastm_Byte_PrimitiveType, gen_gastm_ShortInteger_PrimitiveType, gen_gastm_Integer_PrimitiveType, gen_gastm_LongInteger_PrimitiveType, gen_gastm_Float_PrimitiveType, gen_gastm_Double_PrimitiveType, gen_gastm_LongDouble_PrimitiveType, gen_gastm_Character_PrimitiveType, gen_gastm_String_PrimitiveType, gen_gastm_Boolean_PrimitiveType, gen_gastm_WideCharacter_PrimitiveType, gen_gastm_CollectionType_ConstructedType, gen_gastm_PostIncrement_UnaryOperator, gen_gastm_PostDecrement_UnaryOperator, gen_gastm_Add_BinaryOperator, gen_gastm_Subtract_BinaryOperator, gen_gastm_Multiply_BinaryOperator, gen_gastm_Divide_BinaryOperator, gen_gastm_Modulus_BinaryOperator, gen_gastm_Exponent_BinaryOperator, gen_gastm_And_BinaryOperator, gen_gastm_Or_BinaryOperator, gen_gastm_Equal_BinaryOperator, gen_gastm_NotEqual_BinaryOperator, gen_gastm_Greater_BinaryOperator, gen_gastm_ForCheckBeforeStatement_ForStatement, gen_gastm_ForCheckAfterStatement_ForStatement, gen_gastm_AggregateExpression_Expression, gen_gastm_QualifiedOverPointer_QualifiedIdentifierReference, gen_gastm_QualifiedOverData_QualifiedIdentifierReference, gen_gastm_IntegerlLiteral_Literal, gen_gastm_StringLiteral_Literal, gen_gastm_CharLiteral_Literal, gen_gastm_RealLiteral_Literal, gen_gastm_BooleanLiteral_Literal, gen_gastm_BitLiteral_Literal, gen_gastm_UnaryPlus_UnaryOperator, gen_gastm_Negate_UnaryOperator, gen_gastm_Not_UnaryOperator, gen_gastm_BitNot_UnaryOperator, gen_gastm_AddressOf_UnaryOperator, gen_gastm_Deref_UnaryOperator, gen_gastm_Increment_UnaryOperator, gen_gastm_Decrement_UnaryOperator, gen_gastm_SpecificLessEqual_BinaryOperator, gen_gastm_SpecificGreaterEqual_BinaryOperator, gen_gastm_SpecificIn_BinaryOperator, gen_gastm_SpecificLike_BinaryOperator, gen_gastm_SpecificConcatString_BinaryOperator, gen_gastm_SpecificSelectStatement_Statement, gen_sastm_RDBDatabaseDefinition_Definition, gen_sastm_RDBUserDefinition_Definition, gen_sastm_RDBTableSpaceDefinition_Definition, gen_gastm_NotGreater_BinaryOperator, gen_sastm_RDBTableDefinition_Definition, gen_gastm_Less_BinaryOperator, gen_gastm_NotLess_BinaryOperator, gen_gastm_BitAnd_BinaryOperator, gen_gastm_BitOr_BinaryOperator, gen_gastm_BitXor_BinaryOperator, gen_gastm_BitLeftShift_BinaryOperator, gen_gastm_BitRightShift_BinaryOperator, gen_gastm_Assign_BinaryOperator, gen_gastm_MissingActualParameter_ActualParameter, gen_gastm_ByValueActualParameterExpression_ActualParameterExpression, gen_gastm_ByReferenceActualParameterExpression_ActualParameterExpression, gen_gastm_SpecificTriggerDefinition_Definition, gen_sastm_RDBTrigger_OtherSyntaxObject, gen_sastm_RDBConstraint_OtherSyntaxObject, gen_sastm_RDBCheckConstraint_RDBConstraint, gen_sastm_RDBRefIntegrity_RDBConstraint, gen_sastm_RDBUniqueKey_RDBConstraint, gen_sastm_RDBConnectStatement_Statement, gen_sastm_RDBSelectStatement_Statement, gen_sastm_RDBColumnDefinition_Definition, gen_sastm_RDBViewDefinition_Definition, gen_sastm_RDBCursorDefinition_Definition, gen_sastm_RDBIndex_OtherSyntaxObject, gen_sastm_RDBIndexColumn_OtherSyntaxObject, gen_sastm_RDBUpdateStatement_RDBModifyStatement, gen_sastm_RDBCursorStatement_Statement, gen_sastm_RDBOpenCursorStatement_RDBCursorStatement, gen_sastm_RDBFetchCursorStatement_RDBCursorStatement, gen_sastm_RDBInsertStatement_Statement, gen_sastm_RDBModifyStatement_Statement, gen_sastm_RDBDataBaseType_DataType, gen_sastm_RDBUserType_DataType, gen_sastm_RDBTableSpaceType_DataType, gen_sastm_RDBTableType_DataType, gen_sastm_RDBViewType_DataType, gen_sastm_RDBCursorType_DataType, gen_sastm_RDBInteger_DataType, gen_sastm_RDBInt_DataType, gen_sastm_RDBReal_DataType, gen_sastm_RDBFloat_DataType, gen_sastm_RDBDecimal_DataType, gen_sastm_RDBNumber_DataType, gen_sastm_RDBLong_DataType, gen_sastm_RDBChar_DataType, gen_sastm_RDBVarchar_DataType, gen_sastm_RDBString_DataType, gen_sastm_RDBRaw_DataType, gen_sastm_RDBDate_DataType, gen_sastm_RDBTimestamp_DataType, gen_sastm_RDBRowid_DataType, gen_sastm_RDBBoolean_DataType, gen_sastm_RDBBlob_DataType, gen_sastm_RDBSelectExpression_Expression, gen_sastm_RDBTableReference_IdentifierReference, gen_sastm_RDBTableAlias_IdentifierReference, gen_sastm_RDBColumnReference_IdentifierReference, gen_sastm_RDBClob_DataType, gen_sastm_RDBNClob_DataType, gen_sastm_RDBBFile_DataType, gen_sastm_RDBDeleteStatement_RDBModifyStatement, gen_sastm_RDBCloseCursorStatement_RDBCursorStatement, gen_sastm_RDBHostVariableExpression_Expression},
    metadata=None
)
