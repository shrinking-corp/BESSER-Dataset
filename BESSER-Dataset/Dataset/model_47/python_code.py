...
class petrinet_PetriNet:
    ...
    def __init__(self, name: str, petrinet_PetriNet: "petrinet_System" = None, petrinet_PetriNet4: set["petrinet_Element"] = None, petrinet_PetriNet7: "petrinet_PetriNetRelationship" = None, petrinet_PetriNet10: "petrinet_PetriNetRelationship" = None):
        self.name = name
