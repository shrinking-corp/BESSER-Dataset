...
class Company_Project(ABC):
    ...
    def __init__(self, name: str, Company_Project7: "Company_Organisation" = None, Company_Project13: "Company_Category" = None, Company_Project: "Company_Person" = None):
        self.name = name
...
class Company_Person:
    ...
    def __init__(self, firstname: str, lastname: str, position: str, Company_Person2: "Company_ServiceLine" = None, Company_Person4: "Company_Organisation" = None, Company_Person: set["Company_Project"] = None):
...
class Company_Organisation:
    ...
    def __init__(self, name: str, Company_Organisation: set["Company_Person"] = None, Company_Organisation6: set["Company_Project"] = None, Company_Organisation9: "Company_Address" = None, Company_Organisation11: set["Company_Division"] = None, Company_Organisation17: "Company_CompanyModel" = None):
        self.name = name
