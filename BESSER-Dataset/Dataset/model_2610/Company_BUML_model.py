...
Company_Organisation = Class(name="Company_Organisation")
...
Company_Person = Class(name="Company_Person")
...
Company_Person.attributes={Company_Person_firstname, Company_Person_lastname, Company_Person_position}
...
domain_model = DomainModel(
    name="Company",
    types={Company_ServiceLine, Company_Organisation, Company_Address, Company_Division, Company_Category, Company_European, Project, Company_National, Company_Person, Company_Project, Company_Unit, Division, Company_Topic, Company_CompanyModel, type},
    associations={employed1, persons3, projects5, address8, lines10, related12, assignedTo0, division26, topics14, category15, company16, categories18, topics21, address23},
