...
class cbpmni_ProcessInst:
    ...
    def __init__(self, cbpmni_ProcessInst2: set["cbpmni_FlowNodeInst"] = None, cbpmni_ProcessInst4: set["cbpmni_FlowNodeInst"] = None, cbpmni_ProcessInst: "cbpmni_ProcessModel" = None):
