...
# Classes
cbpmni_ProcessInst = Class(name="cbpmni_ProcessInst")
cbpmni_ProcessModel = Class(name="cbpmni_ProcessModel")
cbpmni_FlowNodeInst = Class(name="cbpmni_FlowNodeInst", is_abstract=True)
cbpmni_FlowNode = Class(name="cbpmni_FlowNode")
cbpmni_ActivityInst = Class(name="cbpmni_ActivityInst")
FlowNodeInst = Class(name="FlowNodeInst")
cbpmni_ConstraintInst = Class(name="cbpmni_ConstraintInst")
cbpmni_EObject = Class(name="cbpmni_EObject")
cbpmni_EventInst = Class(name="cbpmni_EventInst")
cbpmni_SplitInst = Class(name="cbpmni_SplitInst")
cbpmni_Branch = Class(name="cbpmni_Branch")
cbpmni_OCLConstraint = Class(name="cbpmni_OCLConstraint")
cbpmni_BranchInst = Class(name="cbpmni_BranchInst")
...
domain_model = DomainModel(
    name="cbpmni",
    types={cbpmni_ProcessInst, cbpmni_ProcessModel, cbpmni_FlowNodeInst, cbpmni_FlowNode, cbpmni_ActivityInst, FlowNodeInst, cbpmni_ConstraintInst, cbpmni_EObject, cbpmni_EventInst, cbpmni_SplitInst, cbpmni_Branch, cbpmni_OCLConstraint, cbpmni_BranchInst, FlowNodeStatusType},
    associations={processDef0, tokens1, flowNodes3, nodeDef6, next9, preconditions11, postconditions12, inputs15, outputs17, branchDef21, extension23, constraintDef26, branches20},
    generalizations={gen_cbpmni_ActivityInst_FlowNodeInst, gen_cbpmni_EventInst_FlowNodeInst, gen_cbpmni_SplitInst_FlowNodeInst},
    metadata=None
)
