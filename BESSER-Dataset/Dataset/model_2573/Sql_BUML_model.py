...
sql_ScalarOperand.attributes={sql_ScalarOperand_sostr, sql_ScalarOperand_sodbl, sql_ScalarOperand_soint, sql_ScalarOperand_sodt, sql_ScalarOperand_sodate, sql_ScalarOperand_sotime}
...
domain_model = DomainModel(
    name="sql",
    types={sql_SelectQuery, sql_FetchFirst, sql_IntegerValue, sql_Offset, sql_Limit, sql_SelectSubSet, sql_Model, sql_OrColumn, sql_Select, SelectQuery, sql_OrOrderByColumn, PivotForClause, sql_ColumnOrAlias, OrColumn, sql_Operands, sql_DbObjectName, sql_DbObjectNameAll, sql_ColumnFull, sql_FromTable, OrTable, sql_TableOrAlias, sql_OrTable, sql_OrExpr, sql_OrGroupByColumn, sql_PivotFunctions, sql_PivotForClause, sql_PivotInClause, sql_PivotFunction, sql_UnpivotInClauseArgs, sql_PivotColumns, sql_UnpivotInClause, sql_UnpivotInClauseArg, UnpivotInClauseArgs, sql_Pivots, sql_FromTableJoin, sql_TableFull, sql_SubQueryOperand, sql_PivotTable, sql_UnpivotTable, OrGroupByColumn, sql_OpFunction, sql_FullExpression, OrExpr, sql_ExprGroup, sql_XExpr, sql_InOper, sql_ExistsOper, sql_Between, sql_Like, sql_Comparison, PivotColumns, sql_PivotCol, PivotFunction, Pivots, ColumnFull, PivotCol, TableFull, sql_OrderByColumnFull, OrOrderByColumn, sql_GroupByColumnFull, sql_Prms, sql_JRParameter, Prms, sql_OperandListGroup, sql_LikeOperand, sql_OpFunctionCast, sql_POperand, sql_ColumnOperand, sql_FunctionExtract, sql_SQLCaseOperand, sql_ExpOperand, sql_ScalarOperand, sql_OpFunctionArg, sql_OperandList, OpFunctionArgAgregate, sql_Operand, sql_WindowingClauseOperandFollowing, sql_AnalyticExprArg, sql_OrderByClauseArgs, sql_OrderByClauseArg, OrderByClauseArgs, sql_AnalyticExprArgs, QueryPartitionClause, AnalyticExprArgs, sql_OpFunctionArgOperand, OpFunctionArg, sql_OpFunctionArgAgregate, sql_FunctionAnalytical, sql_AnalyticClause, sql_QueryPartitionClause, sql_OrderByClause, sql_WindowingClause, sql_WindowingClauseBetween, WindowingClause, sql_WindowingClauseOperandPreceding, sql_SQLCaseWhens, sql_SqlCaseWhen, SQLCaseWhens, OperandList, sql_UnipivotInClause, UnpivotInClause, sql_uicargs, sql_pvcs, sql_pcols, sql_tbls, sql_OpList, sql_Plus, Operands, sql_Minus, sql_Star, sql_Div, sql_Concat, sql_OBCArgs, sql_AExpArgs, sql_OpFList, sql_Col, sql_WhenList, EXTRACT_VALUES, XFunction},
    associations={query0, fetchFirst1, l22, op5, query4, havingEntry16, orderByEntry19, lim21, offset24, fetchFirst26, entries29, ce31, colAlias33, dbAllCols35, entries37, table39, cols8, tbl10, whereExpression12, groupByEntry14, pfun60, pfor62, pin64, sq66, args69, pcols71, pfor73, inop76, pcols78, cfuls80, fjoin41, onTable43, joinExpr46, tfull49, sq51, pivot53, unpivot55, tblAlias57, colGrBy89, gbFunction92, entries94, efrag97, expgroup99, exp102, xexp104, in_106, exists108, op1110, between113, like115, comp117, entries83, colOrder85, entries87, prm125, entries127, op2129, expr119, col122, op2141, op3144, subquery147, opList150, subquery152, opList155, op2132, fop2134, fcast137, fparam139, right165, column168, xop171, subq173, fcast176, fext179, func181, sqlcase184, param186, eparam189, scalar191, args193, opGroup158, op1160, left163, wcoF209, exp211, expr213, args216, col218, args220, ce222, colAlias225, op228, op229, fan195, operand197, anClause200, abc202, obc204, winc206, wcoP208, expr238, when241, expr243, texp245, eexp248, cfull232, sel235, args253, entries255, entries257, entries258, entries260, entries262, entries264, entries266, entries268, entries251, entries270},
    generalizations={gen_sql_Select_SelectQuery, gen_sql_OrColumn_PivotForClause, gen_sql_ColumnOrAlias_OrColumn, gen_sql_ColumnFull_PivotForClause, gen_sql_FromTable_OrTable, gen_sql_UnpivotInClauseArg_UnpivotInClauseArgs, gen_sql_GroupByColumnFull_OrGroupByColumn, gen_sql_FullExpression_OrExpr, gen_sql_Pivots_PivotColumns, gen_sql_PivotCol_PivotFunction, gen_sql_PivotCol_PivotColumns, gen_sql_PivotCol_Pivots, gen_sql_DbObjectName_ColumnFull, gen_sql_DbObjectName_PivotCol, gen_sql_DbObjectName_TableFull, gen_sql_OrderByColumnFull_OrOrderByColumn, gen_sql_JRParameter_Prms, gen_sql_Operands_OpFunctionArgAgregate, gen_sql_WindowingClauseOperandPreceding_WindowingClause, gen_sql_OrderByClauseArg_OrderByClauseArgs, gen_sql_AnalyticExprArgs_QueryPartitionClause, gen_sql_AnalyticExprArg_AnalyticExprArgs, gen_sql_OpFunctionArgOperand_OpFunctionArg, gen_sql_WindowingClauseBetween_WindowingClause, gen_sql_SqlCaseWhen_SQLCaseWhens, gen_sql_ScalarOperand_OperandList, gen_sql_UnipivotInClause_UnpivotInClause, gen_sql_uicargs_UnpivotInClauseArgs, gen_sql_pvcs_Pivots, gen_sql_pcols_PivotCol, gen_sql_tbls_TableFull, gen_sql_OpList_OperandList, gen_sql_Plus_Operands, gen_sql_Minus_Operands, gen_sql_Star_Operands, gen_sql_Div_Operands, gen_sql_Concat_Operands, gen_sql_OBCArgs_OrderByClauseArgs, gen_sql_AExpArgs_AnalyticExprArgs, gen_sql_OpFList_OpFunctionArg, gen_sql_Col_ColumnFull, gen_sql_WhenList_SQLCaseWhens},
    metadata=None
)
