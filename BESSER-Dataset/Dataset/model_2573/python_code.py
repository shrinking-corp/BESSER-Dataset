...
class sql_LikeOperand:
    ...
    def __init__(self, op2: str, sql_LikeOperand: "sql_Like" = None, sql_LikeOperand135: "sql_OpFunction" = None, sql_LikeOperand138: "sql_OpFunctionCast" = None, sql_LikeOperand140: "sql_POperand" = None):
        self.op2 = op2
...
class sql_OrderByColumnFull(OrOrderByColumn):
    ...
    def __init__(self, colOrderInt: int, direction: str, sql_OrderByColumnFull: "sql_OrOrderByColumn" = None, sql_OrderByColumnFull86: "sql_ColumnFull" = None):
...
class sql_Comparison:
    ...
    def __init__(self, operator: str, subOperator: str, sql_Comparison130: "sql_Operands" = None, sql_Comparison: "sql_FullExpression" = None):
...
class sql_Like:
    ...
    def __init__(self, opLike: str, sql_Like133: "sql_LikeOperand" = None, sql_Like: "sql_FullExpression" = None):
        self.opLike = opLike
...
class sql_Between:
    ...
    def __init__(self, opBetween: str, sql_Between142: "sql_Operands" = None, sql_Between145: "sql_Operands" = None, sql_Between: "sql_FullExpression" = None):
...
class sql_ExistsOper:
    ...
    def __init__(self, op: str, sql_ExistsOper153: "sql_SubQueryOperand" = None, sql_ExistsOper156: "sql_OperandListGroup" = None, sql_ExistsOper: "sql_FullExpression" = None):
        self.op = op
...
class sql_FullExpression(OrExpr):
    ...
    def __init__(self, c: str, notPrm: str, isnull: str, sql_FullExpression: "sql_OrExpr" = None, sql_FullExpression98: "sql_FullExpression" = None, sql_FullExpression96: "sql_FullExpression" = None, sql_FullExpression100: "sql_ExprGroup" = None, sql_FullExpression103: "sql_FullExpression" = None, sql_FullExpression101: "sql_FullExpression" = None, sql_FullExpression105: "sql_XExpr" = None, sql_FullExpression107: "sql_InOper" = None, sql_FullExpression109: "sql_ExistsOper" = None, sql_FullExpression111: "sql_Operands" = None, sql_FullExpression114: "sql_Between" = None, sql_FullExpression116: "sql_Like" = None, sql_FullExpression118: "sql_Comparison" = None):
        self.c = c
        self.notPrm = notPrm
        self.isnull = isnull
...
class sql_TableOrAlias:
    ...
    def __init__(self, alias: str, sql_TableOrAlias: "sql_FromTable" = None, sql_TableOrAlias45: "sql_FromTableJoin" = None, sql_TableOrAlias50: "sql_TableFull" = None, sql_TableOrAlias52: "sql_SubQueryOperand" = None, sql_TableOrAlias54: "sql_PivotTable" = None, sql_TableOrAlias56: "sql_UnpivotTable" = None, sql_TableOrAlias58: "sql_DbObjectName" = None):
        self.alias = alias
...
class sql_DbObjectName(PivotCol, ColumnFull, TableFull):
    ...
    def __init__(self, dbname: str, sql_DbObjectName: "sql_ColumnOrAlias" = None, sql_DbObjectName59: "sql_TableOrAlias" = None, sql_DbObjectName227: "sql_AnalyticExprArg" = None, sql_DbObjectName259: "sql_pcols" = None, sql_DbObjectName261: "sql_tbls" = None, sql_DbObjectName252: "sql_Col" = None):
        self.dbname = dbname
...
class sql_Select(SelectQuery):
    ...
    def __init__(self, select: str, sql_Select17: "sql_OrExpr" = None, sql_Select20: "sql_OrOrderByColumn" = None, sql_Select22: "sql_Limit" = None, sql_Select25: "sql_Offset" = None, sql_Select27: "sql_FetchFirst" = None, sql_Select9: "sql_OrColumn" = None, sql_Select11: "sql_OrTable" = None, sql_Select13: "sql_OrExpr" = None, sql_Select15: "sql_OrGroupByColumn" = None, sql_Select6: set["sql_SelectSubSet"] = None, sql_Select: "sql_SelectSubSet" = None):
        self.select = select
...
class sql_SelectSubSet:
    ...
    def __init__(self, op: str, all: str, sql_SelectSubSet7: "sql_Select" = None, sql_SelectSubSet: "sql_Select" = None):
        self.op = op
        self.all = all
...
class sql_Limit:
    ...
    def __init__(self, l1: int, sql_Limit23: "sql_Select" = None, sql_Limit: "sql_IntegerValue" = None):
        self.l1 = l1
...
class sql_IntegerValue:
    ...
    def __init__(self, integer: int, sql_IntegerValue: "sql_FetchFirst" = None, sql_IntegerValue3: "sql_Limit" = None):
...
class sql_FetchFirst:
    ...
    def __init__(self, row: str, sql_FetchFirst28: "sql_Select" = None, sql_FetchFirst: "sql_IntegerValue" = None):
        self.row = row
