...
class remes_Variable:
    ...
    def __init__(self, name: str, value: str, type: str, vectorSize: int, global_: bool, readable: bool, writable: bool, Variable: "remes_Mode" = None, variables: "remes_Mode" = None):
        self.name = name
        self.value = value
        self.type = type
...
class remes_Mode(ABC):
    ...
    def __init__(self, name: str, initialization: str, scope: set["remes_Variable"] = None, remes_Mode: "remes_RemesDiagram" = None, Mode: "remes_Variable" = None):
        self.name = name
...
class ToConditionalConnectorEdge:
    ...
    pass
class remes_EntryConditionalTopInitEdge(InitEdge, ToConditionalConnectorEdge, FromCompositeModeInitEdge):
...
class Edge:
    ...
    pass
class remes_EntryConditionalTopEdge(ToConditionalConnectorEdge, Edge, FromCompositeModeEdge):

    pass
class remes_ExitConditionalSubEdge(ToConditionalConnectorEdge, Edge, FromSubModeEdge):
...
class remes_ExitConditionalTopEdge(FromConditionalConnectorEdge, ToCompositeModeEdge, Edge):
    ...
    pass
class remes_EntryConditionalSubEdge(ToSubModeEdge, FromConditionalConnectorEdge, Edge):
...
class remes_ConditionalConnector:
    ...
    def __init__(self, name: str, ConditionalConnector35: "remes_ToConditionalConnectorEdge" = None, ConditionalConnector: "remes_CompositeMode" = None, connectTo8: set["remes_ToConditionalConnectorEdge"] = None, connectFrom10: set["remes_FromConditionalConnectorEdge"] = None, conditionalConnectors: "remes_CompositeMode" = None, ConditionalConnector17: "remes_FromConditionalConnectorEdge" = None):
        self.name = name
...
class remes_SubMode(Mode):
    ...
    def __init__(self, invariant: str, isUrgent: bool, connectTo24: set["remes_ToSubModeEdge"] = None, connectFrom26: set["remes_FromSubModeEdge"] = None, subModes: "remes_CompositeMode" = None, scope30: set["remes_Resource"] = None, SubMode38: "remes_ToSubModeEdge" = None, SubMode20: "remes_FromSubModeEdge" = None, SubMode41: "remes_Resource" = None, SubMode: "remes_CompositeMode" = None):
