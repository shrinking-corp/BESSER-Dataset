...
remes_ToCompositeModeEdge = Class(name="remes_ToCompositeModeEdge", is_abstract=True)
remes_FromCompositeModeInitEdge = Class(name="remes_FromCompositeModeInitEdge", is_abstract=True)
remes_FromCompositeModeEdge = Class(name="remes_FromCompositeModeEdge", is_abstract=True)
remes_ConditionalConnector = Class(name="remes_ConditionalConnector")
remes_ToConditionalConnectorEdge = Class(name="remes_ToConditionalConnectorEdge", is_abstract=True)
remes_FromConditionalConnectorEdge = Class(name="remes_FromConditionalConnectorEdge", is_abstract=True)
remes_Edge = Class(name="remes_Edge", is_abstract=True)
remes_EntryConditionalSubEdge = Class(name="remes_EntryConditionalSubEdge")
...
remes_EntryConditionalTopEdge = Class(name="remes_EntryConditionalTopEdge")
FromCompositeModeEdge = Class(name="FromCompositeModeEdge")
ToConditionalConnectorEdge = Class(name="ToConditionalConnectorEdge")
remes_EntryConditionalTopInitEdge = Class(name="remes_EntryConditionalTopInitEdge")
FromCompositeModeInitEdge = Class(name="FromCompositeModeInitEdge")
InitEdge = Class(name="InitEdge")
remes_EntryEdge = Class(name="remes_EntryEdge")
remes_EntryInitEdge = Class(name="remes_EntryInitEdge")
remes_ExitConditionalSubEdge = Class(name="remes_ExitConditionalSubEdge")
FromSubModeEdge = Class(name="FromSubModeEdge")
remes_ExitConditionalTopEdge = Class(name="remes_ExitConditionalTopEdge")
ToCompositeModeEdge = Class(name="ToCompositeModeEdge")
remes_ExitEdge = Class(name="remes_ExitEdge")
remes_FromSubModeEdge = Class(name="remes_FromSubModeEdge", is_abstract=True)
remes_SubMode = Class(name="remes_SubMode")
remes_InitEdge = Class(name="remes_InitEdge", is_abstract=True)
remes_InternalEdge = Class(name="remes_InternalEdge")
...
remes_ToSubModeEdge = Class(name="remes_ToSubModeEdge", is_abstract=True)
...
remes_Mode.attributes={remes_Mode_name, remes_Mode_initialization}
...
remes_Variable.attributes={remes_Variable_value, remes_Variable_readable, remes_Variable_type, remes_Variable_global_, remes_Variable_vectorSize, remes_Variable_writable, remes_Variable_name}
