...
class execTraces_Variable:
    ...
    def __init__(self, name: str, execTraces_Variable18: "execTraces_Literal" = None, execTraces_Variable: "execTraces_Node" = None):
        self.name = name
...
class execTraces_Edge:
    ...
    def __init__(self, trigger: str, actions: str, status: str, guard: str, execTraces_Edge16: "execTraces_Node" = None, execTraces_Edge: "execTraces_ExecTraces" = None, execTraces_Edge4: "execTraces_Node" = None, execTraces_Edge7: "execTraces_Node" = None, execTraces_Edge13: "execTraces_Node" = None):
...
class execTraces_Node:
    ...
    def __init__(self, name: str, id: int, level: int, status: str, constraints: str, execTraces_Node15: set["execTraces_Edge"] = None, execTraces_Node: "execTraces_ExecTraces" = None, execTraces_Node5: "execTraces_Edge" = None, execTraces_Node8: "execTraces_Edge" = None, execTraces_Node10: set["execTraces_Variable"] = None, execTraces_Node12: set["execTraces_Edge"] = None):
        self.name = name
        self.id = id
        self.level = level
        self.status = status
