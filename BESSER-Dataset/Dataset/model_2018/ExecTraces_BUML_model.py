...
# Classes
execTraces_ExecTraces = Class(name="execTraces_ExecTraces")
execTraces_Node = Class(name="execTraces_Node")
execTraces_Edge = Class(name="execTraces_Edge")
execTraces_Variable = Class(name="execTraces_Variable")
execTraces_Literal = Class(name="execTraces_Literal")
execTraces_RealLiteral = Class(name="execTraces_RealLiteral")
Literal = Class(name="Literal")
execTraces_IntLiteral = Class(name="execTraces_IntLiteral")
execTraces_BoolLiteral = Class(name="execTraces_BoolLiteral")
...
execTraces_Node.attributes={execTraces_Node_status, execTraces_Node_name, execTraces_Node_constraints, execTraces_Node_level, execTraces_Node_id}
...
execTraces_Edge.attributes={execTraces_Edge_actions, execTraces_Edge_guard, execTraces_Edge_trigger, execTraces_Edge_status}
...
domain_model = DomainModel(
    name="execTraces",
    types={execTraces_ExecTraces, execTraces_Node, execTraces_Edge, execTraces_Variable, execTraces_Literal, execTraces_RealLiteral, Literal, execTraces_IntLiteral, execTraces_BoolLiteral, StateStatus, TransStatus},
    associations={Node0, Edge1, source3, destination6, VarData9, outgoingEdges11, incomingEdges14, value17},
