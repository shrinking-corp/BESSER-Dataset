...
domain_model = DomainModel(
    name="simpleRdbms",
    types={simpleRdbms_Schema, RModelElement, simpleRdbms_Table, simpleRdbms_Column, simpleRdbms_Key, simpleRdbms_ForeignKey, simpleRdbms_RModelElement},
    associations={schema1, column2, key3, foreignKey5, owner7, key9, tables0, owner17, column20, refersTo22, owner23, foreignKey12, column15},
    generalizations={gen_simpleRdbms_Schema_RModelElement, gen_simpleRdbms_Column_RModelElement, gen_simpleRdbms_Table_RModelElement, gen_simpleRdbms_ForeignKey_RModelElement, gen_simpleRdbms_Key_RModelElement},
    metadata=None
)
