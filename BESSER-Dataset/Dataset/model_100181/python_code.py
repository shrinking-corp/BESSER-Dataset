...
class simpleRdbms_Column(RModelElement):
    ...
    def __init__(self, type: str, Column: "simpleRdbms_Table" = None, column: "simpleRdbms_Table" = None, column10: set["simpleRdbms_Key"] = None, Column21: "simpleRdbms_ForeignKey" = None, column13: set["simpleRdbms_ForeignKey"] = None, Column16: "simpleRdbms_Key" = None):
        self.type = type
        self.Column = Column
        self.column = column
