...
class modelDsl_RangeValue(Value):
    ...
    def __init__(self, from_: int, fromInf: bool, to: int, toInf: bool):
        self.from_ = from_
...
class modelDsl_AnnotationProperty:
    ...
    def __init__(self, name: str, type: str, multi: bool, modelDsl_AnnotationProperty: "modelDsl_Annotation" = None, modelDsl_AnnotationProperty57: "modelDsl_Annotation" = None, modelDsl_AnnotationProperty72: "modelDsl_AnnotationHiddenProperty" = None, modelDsl_AnnotationProperty59: "modelDsl_GroupType" = None):
        self.name = name
        self.type = type
        self.multi = multi
...
class modelDsl_Property(Field):
    ...
    def __init__(self, optional: bool, modelDsl_Property39: "modelDsl_Type" = None, modelDsl_Property: "modelDsl_EntityElements" = None):
...
class modelDsl_Reference(Field):
    ...
    def __init__(self, optional: bool, modelDsl_Reference42: "modelDsl_Entity" = None, modelDsl_Reference46: "modelDsl_ReferenceList" = None, modelDsl_Reference: "modelDsl_EntityElements" = None):
        self.optional = optional
...
class modelDsl_DataTypeField:
    ...
    def __init__(self, format: str, modelDsl_DataTypeField: "modelDsl_DataType" = None, modelDsl_DataTypeField11: "modelDsl_PatternType" = None, modelDsl_DataTypeField13: "modelDsl_DataType" = None):
        self.format = format
