...
modelDsl_Type = Class(name="modelDsl_Type")
Element = Class(name="Element")
modelDsl_AnnotationGroup = Class(name="modelDsl_AnnotationGroup")
modelDsl_Package = Class(name="modelDsl_Package")
modelDsl_DataType = Class(name="modelDsl_DataType")
Type = Class(name="Type")
modelDsl_DataTypeField = Class(name="modelDsl_DataTypeField")
modelDsl_PatternType = Class(name="modelDsl_PatternType")
modelDsl_Entity = Class(name="modelDsl_Entity")
modelDsl_Parent = Class(name="modelDsl_Parent")
modelDsl_EntityElements = Class(name="modelDsl_EntityElements")
modelDsl_Model = Class(name="modelDsl_Model")
modelDsl_Import = Class(name="modelDsl_Import")
modelDsl_Element = Class(name="modelDsl_Element")
modelDsl_Field = Class(name="modelDsl_Field")
Container = Class(name="Container")
Field = Class(name="Field")
modelDsl_Annotation = Class(name="modelDsl_Annotation")
modelDsl_AnnoTypes = Class(name="modelDsl_AnnoTypes")
modelDsl_AnnotationInstance = Class(name="modelDsl_AnnotationInstance")
modelDsl_AnnotationProperty = Class(name="modelDsl_AnnotationProperty")
modelDsl_EntityGroup = Class(name="modelDsl_EntityGroup")
modelDsl_Child = Class(name="modelDsl_Child")
modelDsl_Property = Class(name="modelDsl_Property")
modelDsl_Reference = Class(name="modelDsl_Reference")
modelDsl_ReferenceList = Class(name="modelDsl_ReferenceList")
modelDsl_Container = Class(name="modelDsl_Container")
modelDsl_Annotated = Class(name="modelDsl_Annotated")
AnnoTypes = Class(name="AnnoTypes")
modelDsl_PackageType = Class(name="modelDsl_PackageType")
modelDsl_DataTypeType = Class(name="modelDsl_DataTypeType")
modelDsl_AnnotationType = Class(name="modelDsl_AnnotationType")
modelDsl_EntityType = Class(name="modelDsl_EntityType")
modelDsl_PropertyType = Class(name="modelDsl_PropertyType")
modelDsl_ReferenceType = Class(name="modelDsl_ReferenceType")
modelDsl_ReferenceListType = Class(name="modelDsl_ReferenceListType")
modelDsl_ParentType = Class(name="modelDsl_ParentType")
modelDsl_ChildType = Class(name="modelDsl_ChildType")
modelDsl_StringValue = Class(name="modelDsl_StringValue")
Value = Class(name="Value")
modelDsl_IntegerValue = Class(name="modelDsl_IntegerValue")
modelDsl_DoubleValue = Class(name="modelDsl_DoubleValue")
modelDsl_RangeValue = Class(name="modelDsl_RangeValue")
modelDsl_GroupType = Class(name="modelDsl_GroupType")
AnnotationValue = Class(name="AnnotationValue")
modelDsl_AnnotationValue = Class(name="modelDsl_AnnotationValue")
modelDsl_AnnotationHiddenProperty = Class(name="modelDsl_AnnotationHiddenProperty")
modelDsl_FormatRangeValue = Class(name="modelDsl_FormatRangeValue")
modelDsl_Value = Class(name="modelDsl_Value")
...
modelDsl_PatternType.attributes={modelDsl_PatternType_REGEX, modelDsl_PatternType_NUMBER, modelDsl_PatternType_DATE}
...
modelDsl_RangeValue_from_: Property = Property(name="from_", type=IntegerType)
...
modelDsl_RangeValue.attributes={modelDsl_RangeValue_from_, modelDsl_RangeValue_to, modelDsl_RangeValue_fromInf, modelDsl_RangeValue_toInf}
...
modelDsl_FormatRangeValue_from_: Property = Property(name="from_", type=StringType)
modelDsl_FormatRangeValue_to: Property = Property(name="to", type=StringType)
modelDsl_FormatRangeValue.attributes={modelDsl_FormatRangeValue_from_, modelDsl_FormatRangeValue_to}
...
domain_model = DomainModel(
    name="modelDsl",
    types={Annotated, modelDsl_Type, Element, modelDsl_AnnotationGroup, modelDsl_Package, modelDsl_DataType, Type, modelDsl_DataTypeField, modelDsl_PatternType, modelDsl_Entity, modelDsl_Parent, modelDsl_EntityElements, modelDsl_Model, modelDsl_Import, modelDsl_Element, modelDsl_Field, Container, Field, modelDsl_Annotation, modelDsl_AnnoTypes, modelDsl_AnnotationInstance, modelDsl_AnnotationProperty, modelDsl_EntityGroup, modelDsl_Child, modelDsl_Property, modelDsl_Reference, modelDsl_ReferenceList, modelDsl_Container, modelDsl_Annotated, AnnoTypes, modelDsl_PackageType, modelDsl_DataTypeType, modelDsl_AnnotationType, modelDsl_EntityType, modelDsl_PropertyType, modelDsl_ReferenceType, modelDsl_ReferenceListType, modelDsl_ParentType, modelDsl_ChildType, modelDsl_StringValue, Value, modelDsl_IntegerValue, modelDsl_DoubleValue, modelDsl_RangeValue, modelDsl_GroupType, AnnotationValue, modelDsl_AnnotationValue, modelDsl_AnnotationHiddenProperty, modelDsl_FormatRangeValue, modelDsl_Value, ValueType},
    associations={annotations3, annotations4, elements6, formatedFields9, pattern10, type12, parent15, elements16, imports0, elements1, annotations36, type38, entity41, reference44, entity47, types50, instances51, mandatories53, optionals55, groups18, elements20, childs23, properties25, references27, referenceLists29, type31, annotations33, property70, values73, group58, instances60, annotation63, values66, properties68},
    generalizations={gen_modelDsl_Element_Annotated, gen_modelDsl_Type_Element, gen_modelDsl_Package_Element, gen_modelDsl_DataType_Type, gen_modelDsl_Entity_Type, gen_modelDsl_Field_Annotated, gen_modelDsl_Parent_Container, gen_modelDsl_Child_Container, gen_modelDsl_Property_Field, gen_modelDsl_Reference_Field, gen_modelDsl_ReferenceList_Field, gen_modelDsl_Annotation_Element, gen_modelDsl_Container_Annotated, gen_modelDsl_GroupType_AnnoTypes, gen_modelDsl_PackageType_AnnoTypes, gen_modelDsl_DataTypeType_AnnoTypes, gen_modelDsl_AnnotationType_AnnoTypes, gen_modelDsl_EntityType_AnnoTypes, gen_modelDsl_PropertyType_AnnoTypes, gen_modelDsl_ReferenceType_AnnoTypes, gen_modelDsl_ReferenceListType_AnnoTypes, gen_modelDsl_ParentType_AnnoTypes, gen_modelDsl_ChildType_AnnoTypes, gen_modelDsl_StringValue_Value, gen_modelDsl_IntegerValue_Value, gen_modelDsl_DoubleValue_Value, gen_modelDsl_RangeValue_Value, gen_modelDsl_AnnotationGroup_AnnotationValue, gen_modelDsl_AnnotationInstance_Annotated, gen_modelDsl_FormatRangeValue_Value, gen_modelDsl_Value_AnnotationValue},
    metadata=None
)
