...
class gpfl_State:
    ...
    def __init__(self, name: str, gpfl_State17: set["gpfl_Transition"] = None, gpfl_State20: "gpfl_Transition" = None, gpfl_State: "gpfl_AutomataDef" = None, gpfl_State15: "gpfl_AutomataDef" = None):
        self.name = name
...
class gpfl_InterruptStmt(GExpression):
    ...
    def __init__(self, timeout: int, gpfl_InterruptStmt: "gpfl_GExpression" = None, gpfl_InterruptStmt34: set["gpfl_GExpression"] = None):
