...
# Classes
gpfl_Program = Class(name="gpfl_Program")
gpfl_AutomataDef = Class(name="gpfl_AutomataDef")
gpfl_GExpression = Class(name="gpfl_GExpression")
gpfl_Field = Class(name="gpfl_Field")
gpfl_Transition = Class(name="gpfl_Transition")
gpfl_CondStmt = Class(name="gpfl_CondStmt")
GExpression = Class(name="GExpression")
gpfl_IterStmt = Class(name="gpfl_IterStmt")
gpfl_InterruptStmt = Class(name="gpfl_InterruptStmt")
gpfl_NopCmd = Class(name="gpfl_NopCmd")
gpfl_AcceptCmd = Class(name="gpfl_AcceptCmd")
gpfl_DropCmd = Class(name="gpfl_DropCmd")
gpfl_SendCmd = Class(name="gpfl_SendCmd")
gpfl_State = Class(name="gpfl_State")
gpfl_SetCmd = Class(name="gpfl_SetCmd")
gpfl_AutomatonCmd = Class(name="gpfl_AutomatonCmd")
gpfl_StpCmd = Class(name="gpfl_StpCmd")
gpfl_CmdAnd = Class(name="gpfl_CmdAnd")
gpfl_CmdEq = Class(name="gpfl_CmdEq")
gpfl_CmdNEq = Class(name="gpfl_CmdNEq")
gpfl_AlarmCmd = Class(name="gpfl_AlarmCmd")
gpfl_CmdLECompare = Class(name="gpfl_CmdLECompare")
gpfl_CmdGCompare = Class(name="gpfl_CmdGCompare")
gpfl_CmdLCompare = Class(name="gpfl_CmdLCompare")
gpfl_CmdAdd = Class(name="gpfl_CmdAdd")
gpfl_CmdSub = Class(name="gpfl_CmdSub")
gpfl_CmdGECompare = Class(name="gpfl_CmdGECompare")
gpfl_GBoolTrue = Class(name="gpfl_GBoolTrue")
gpfl_GBoolFalse = Class(name="gpfl_GBoolFalse")
gpfl_StringLit = Class(name="gpfl_StringLit")
gpfl_Variable = Class(name="gpfl_Variable")
gpfl_PortLit = Class(name="gpfl_PortLit")
gpfl_InPort = Class(name="gpfl_InPort")
gpfl_OutPort = Class(name="gpfl_OutPort")
gpfl_IntLitCmd = Class(name="gpfl_IntLitCmd")
...
domain_model = DomainModel(
    name="gpfl",
    types={gpfl_Program, gpfl_AutomataDef, gpfl_GExpression, gpfl_Field, gpfl_Transition, gpfl_CondStmt, GExpression, gpfl_IterStmt, gpfl_InterruptStmt, gpfl_NopCmd, gpfl_AcceptCmd, gpfl_DropCmd, gpfl_SendCmd, gpfl_State, gpfl_SetCmd, gpfl_AutomatonCmd, gpfl_StpCmd, gpfl_CmdAnd, gpfl_CmdEq, gpfl_CmdNEq, gpfl_AlarmCmd, gpfl_CmdLECompare, gpfl_CmdGCompare, gpfl_CmdLCompare, gpfl_CmdAdd, gpfl_CmdSub, gpfl_CmdGECompare, gpfl_GBoolTrue, gpfl_GBoolFalse, gpfl_StringLit, gpfl_Variable, gpfl_PortLit, gpfl_InPort, gpfl_OutPort, gpfl_IntLitCmd},
    associations={automatas0, initStmts1, stmts3, expression7, value9, transitions16, target18, exp21, stmts23, exp26, stmts28, periodic31, stmts33, init11, states13, exp43, automaton45, automaton47, event49, errors52, left55, right57, left60, right62, port36, fields38, exp41, left70, right72, left75, right77, left80, right82, left85, right87, left90, right92, left95, left65, right67, right97},
    generalizations={gen_gpfl_CondStmt_GExpression, gen_gpfl_IterStmt_GExpression, gen_gpfl_InterruptStmt_GExpression, gen_gpfl_NopCmd_GExpression, gen_gpfl_AcceptCmd_GExpression, gen_gpfl_DropCmd_GExpression, gen_gpfl_SendCmd_GExpression, gen_gpfl_SetCmd_GExpression, gen_gpfl_AutomatonCmd_GExpression, gen_gpfl_StpCmd_GExpression, gen_gpfl_CmdAnd_GExpression, gen_gpfl_CmdEq_GExpression, gen_gpfl_CmdNEq_GExpression, gen_gpfl_AlarmCmd_GExpression, gen_gpfl_CmdLECompare_GExpression, gen_gpfl_CmdGCompare_GExpression, gen_gpfl_CmdLCompare_GExpression, gen_gpfl_CmdAdd_GExpression, gen_gpfl_CmdSub_GExpression, gen_gpfl_CmdGECompare_GExpression, gen_gpfl_GBoolTrue_GExpression, gen_gpfl_GBoolFalse_GExpression, gen_gpfl_StringLit_GExpression, gen_gpfl_Variable_GExpression, gen_gpfl_PortLit_GExpression, gen_gpfl_InPort_GExpression, gen_gpfl_OutPort_GExpression, gen_gpfl_IntLitCmd_GExpression},
    metadata=None
)
