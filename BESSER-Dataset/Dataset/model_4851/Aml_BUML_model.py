...
# Classes
aml_SpeedFeature = Class(name="aml_SpeedFeature")
aml_FormFeature = Class(name="aml_FormFeature")
aml_Aml = Class(name="aml_Aml")
aml_AbstractElements = Class(name="aml_AbstractElements")
aml_MinMax = Class(name="aml_MinMax")
AbstractElements = Class(name="AbstractElements")
aml_TargetGroupFeature = Class(name="aml_TargetGroupFeature")
aml_ProductPUIDFeature = Class(name="aml_ProductPUIDFeature")
aml_MaxFeature = Class(name="aml_MaxFeature")
aml_Drive = Class(name="aml_Drive")
SuperEntity = Class(name="SuperEntity")
aml_TypeFeature = Class(name="aml_TypeFeature")
aml_SizeFeature = Class(name="aml_SizeFeature")
aml_Cable = Class(name="aml_Cable")
aml_ColorFeature = Class(name="aml_ColorFeature")
aml_NetWorkFeature = Class(name="aml_NetWorkFeature")
aml_LengthFeature = Class(name="aml_LengthFeature")
aml_PriceRule = Class(name="aml_PriceRule")
aml_Feature = Class(name="aml_Feature")
aml_Entity = Class(name="aml_Entity")
aml_SuperEntity = Class(name="aml_SuperEntity")
...
aml_SpeedFeature.attributes={aml_SpeedFeature_value, aml_SpeedFeature_name}
...
aml_TargetGroupFeature.attributes={aml_TargetGroupFeature_name, aml_TargetGroupFeature_value}
...
aml_MaxFeature.attributes={aml_MaxFeature_value, aml_MaxFeature_name}
...
aml_TypeFeature.attributes={aml_TypeFeature_name, aml_TypeFeature_value}
...
aml_ColorFeature.attributes={aml_ColorFeature_value, aml_ColorFeature_name}
...
domain_model = DomainModel(
    name="aml",
    types={aml_SpeedFeature, aml_FormFeature, aml_Aml, aml_AbstractElements, aml_MinMax, AbstractElements, aml_TargetGroupFeature, aml_ProductPUIDFeature, aml_MaxFeature, aml_Drive, SuperEntity, aml_TypeFeature, aml_SizeFeature, aml_Cable, aml_ColorFeature, aml_NetWorkFeature, aml_LengthFeature, aml_PriceRule, aml_Feature, aml_Entity, aml_SuperEntity, Color},
    associations={speedFeature9, formFeature11, elements0, targetGroupFeature1, productPuidsFeature2, maxFeature4, typeFeature6, sizeFeature7, colorFeature13, networkFeature14, lengthFeature16, superType18, features20, superType22, features23},
    generalizations={gen_aml_MinMax_AbstractElements, gen_aml_Drive_SuperEntity, gen_aml_Cable_SuperEntity, gen_aml_PriceRule_AbstractElements, gen_aml_Entity_AbstractElements, gen_aml_SuperEntity_AbstractElements},
    metadata=None
)
