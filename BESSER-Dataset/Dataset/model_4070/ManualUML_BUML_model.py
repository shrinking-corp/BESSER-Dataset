...
domain_model = DomainModel(
    name="uml",
    types={uml_Attribute, UMLModelElement, uml_Classifier, uml_Association, PackageElement, Classifier, uml_Package, uml_PackageElement, uml_PrimitiveDataType, uml_UMLModelElement, uml_Class},
    associations={owner1, source2, destination4, general6, forward8, attributes9, reverse10, generalOpposite14, typeOpposite16, elements18, namespace19, type0},
    generalizations={gen_uml_Attribute_UMLModelElement, gen_uml_Association_PackageElement, gen_uml_Class_Classifier, gen_uml_Classifier_PackageElement, gen_uml_Package_UMLModelElement, gen_uml_PackageElement_UMLModelElement, gen_uml_PrimitiveDataType_Classifier},
    metadata=None
)
