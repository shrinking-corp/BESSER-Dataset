...
# Classes
simTL4J_annotations_Annotable = Class(name="simTL4J_annotations_Annotable", is_abstract=True)
Commentable = Class(name="Commentable")
AnnotationInstance = Class(name="AnnotationInstance")
simTL4J_annotations_AnnotationParameterList = Class(name="simTL4J_annotations_AnnotationParameterList")
AnnotationAttributeSetting = Class(name="AnnotationAttributeSetting")
simTL4J_annotations_AnnotationAttributeSetting = Class(name="simTL4J_annotations_AnnotationAttributeSetting")
InterfaceMethod = Class(name="InterfaceMethod")
simTL4J_annotations_AnnotationValue = Class(name="simTL4J_annotations_AnnotationValue", is_abstract=True)
simTL4J_annotations_AnnotationAttribute = Class(name="simTL4J_annotations_AnnotationAttribute")
Expression = Class(name="Expression")
simTL4J_arrays_ArrayTypeable = Class(name="simTL4J_arrays_ArrayTypeable", is_abstract=True)
ArrayDimension = Class(name="ArrayDimension")
simTL4J_annotations_AnnotationInstance = Class(name="simTL4J_annotations_AnnotationInstance")
references_Reference = Class(name="references_Reference")
modifiers_AnnotationInstanceOrModifier = Class(name="modifiers_AnnotationInstanceOrModifier")
commons_NamespaceAwareElement = Class(name="commons_NamespaceAwareElement")
Classifier = Class(name="Classifier")
AnnotationParameter = Class(name="AnnotationParameter")
simTL4J_annotations_AnnotationParameter = Class(name="simTL4J_annotations_AnnotationParameter", is_abstract=True)
simTL4J_annotations_SingleAnnotationParameter = Class(name="simTL4J_annotations_SingleAnnotationParameter")
AnnotationValue = Class(name="AnnotationValue")
simTL4J_arrays_ArrayInstantiationByValues = Class(name="simTL4J_arrays_ArrayInstantiationByValues")
ArrayInitializer = Class(name="ArrayInitializer")
simTL4J_arrays_ArraySelector = Class(name="simTL4J_arrays_ArraySelector")
simTL4J_classifiers_Classifier = Class(name="simTL4J_classifiers_Classifier", is_abstract=True)
types_Type = Class(name="types_Type")
references_ReferenceableElement = Class(name="references_ReferenceableElement")
simTL4J_classifiers_ConcreteClassifier = Class(name="simTL4J_classifiers_ConcreteClassifier", is_abstract=True)
classifiers_Classifier = Class(name="classifiers_Classifier")
generics_TypeParametrizable = Class(name="generics_TypeParametrizable")
members_MemberContainer = Class(name="members_MemberContainer")
members_Member = Class(name="members_Member")
statements_Statement = Class(name="statements_Statement")
modifiers_AnnotableAndModifiable = Class(name="modifiers_AnnotableAndModifiable")
simTL4J_arrays_ArrayDimension = Class(name="simTL4J_arrays_ArrayDimension")
simTL4J_arrays_ArrayInitializer = Class(name="simTL4J_arrays_ArrayInitializer")
arrays_ArrayInitializationValue = Class(name="arrays_ArrayInitializationValue")
annotations_AnnotationValue = Class(name="annotations_AnnotationValue")
ArrayInitializationValue = Class(name="ArrayInitializationValue")
simTL4J_arrays_ArrayInitializationValue = Class(name="simTL4J_arrays_ArrayInitializationValue", is_abstract=True)
simTL4J_arrays_ArrayInstantiationBySize = Class(name="simTL4J_arrays_ArrayInstantiationBySize")
expressions_Expression = Class(name="expressions_Expression")
types_TypedElement = Class(name="types_TypedElement")
arrays_ArrayTypeable = Class(name="arrays_ArrayTypeable")
classifiers_Implementor = Class(name="classifiers_Implementor")
simTL4J_classifiers_Interface = Class(name="simTL4J_classifiers_Interface")
ConcreteClassifier = Class(name="ConcreteClassifier")
simTL4J_classifiers_Enumeration = Class(name="simTL4J_classifiers_Enumeration")
simTL4J_classifiers_Implementor = Class(name="simTL4J_classifiers_Implementor", is_abstract=True)
TypeReference = Class(name="TypeReference")
simTL4J_classifiers_Class = Class(name="simTL4J_classifiers_Class")
classifiers_ConcreteClassifier = Class(name="classifiers_ConcreteClassifier")
simTL4J_commons_Commentable = Class(name="simTL4J_commons_Commentable", is_abstract=True)
EnumConstant = Class(name="EnumConstant")
simTL4J_classifiers_Annotation = Class(name="simTL4J_classifiers_Annotation")
simTL4J_classifiers_AnonymousClass = Class(name="simTL4J_classifiers_AnonymousClass")
simTL4J_commons_NamedElement = Class(name="simTL4J_commons_NamedElement", is_abstract=True)
TPlaceholder = Class(name="TPlaceholder")
simTL4J_commons_NamespaceAwareElement = Class(name="simTL4J_commons_NamespaceAwareElement", is_abstract=True)
simTL4J_containers_JavaRoot = Class(name="simTL4J_containers_JavaRoot", is_abstract=True)
commons_NamedElement = Class(name="commons_NamedElement")
imports_ImportingElement = Class(name="imports_ImportingElement")
simTL4J_containers_Package = Class(name="simTL4J_containers_Package")
containers_JavaRoot = Class(name="containers_JavaRoot")
annotations_Annotable = Class(name="annotations_Annotable")
CompilationUnit = Class(name="CompilationUnit")
Package = Class(name="Package")
simTL4J_containers_EmptyModel = Class(name="simTL4J_containers_EmptyModel")
simTL4J_expressions_ExpressionList = Class(name="simTL4J_expressions_ExpressionList")
ForLoopInitializer = Class(name="ForLoopInitializer")
simTL4J_expressions_Expression = Class(name="simTL4J_expressions_Expression", is_abstract=True)
simTL4J_containers_CompilationUnit = Class(name="simTL4J_containers_CompilationUnit")
JavaRoot = Class(name="JavaRoot")
simTL4J_expressions_AssignmentExpressionChild = Class(name="simTL4J_expressions_AssignmentExpressionChild", is_abstract=True)
simTL4J_expressions_ConditionalExpression = Class(name="simTL4J_expressions_ConditionalExpression")
ConditionalExpressionChild = Class(name="ConditionalExpressionChild")
simTL4J_expressions_ConditionalExpressionChild = Class(name="simTL4J_expressions_ConditionalExpressionChild", is_abstract=True)
simTL4J_expressions_ConditionalOrExpression = Class(name="simTL4J_expressions_ConditionalOrExpression")
ConditionalOrExpressionChild = Class(name="ConditionalOrExpressionChild")
simTL4J_expressions_ConditionalOrExpressionChild = Class(name="simTL4J_expressions_ConditionalOrExpressionChild", is_abstract=True)
simTL4J_expressions_ConditionalAndExpression = Class(name="simTL4J_expressions_ConditionalAndExpression")
ConditionalAndExpressionChild = Class(name="ConditionalAndExpressionChild")
simTL4J_expressions_AssignmentExpression = Class(name="simTL4J_expressions_AssignmentExpression")
AssignmentExpressionChild = Class(name="AssignmentExpressionChild")
AssignmentOperator = Class(name="AssignmentOperator")
simTL4J_expressions_AndExpression = Class(name="simTL4J_expressions_AndExpression")
AndExpressionChild = Class(name="AndExpressionChild")
simTL4J_expressions_AndExpressionChild = Class(name="simTL4J_expressions_AndExpressionChild", is_abstract=True)
simTL4J_expressions_EqualityExpression = Class(name="simTL4J_expressions_EqualityExpression")
EqualityOperator = Class(name="EqualityOperator")
EqualityExpressionChild = Class(name="EqualityExpressionChild")
simTL4J_expressions_EqualityExpressionChild = Class(name="simTL4J_expressions_EqualityExpressionChild", is_abstract=True)
simTL4J_expressions_InstanceOfExpression = Class(name="simTL4J_expressions_InstanceOfExpression")
expressions_EqualityExpressionChild = Class(name="expressions_EqualityExpressionChild")
InstanceOfExpressionChild = Class(name="InstanceOfExpressionChild")
simTL4J_expressions_InstanceOfExpressionChild = Class(name="simTL4J_expressions_InstanceOfExpressionChild", is_abstract=True)
simTL4J_expressions_RelationExpression = Class(name="simTL4J_expressions_RelationExpression")
RelationExpressionChild = Class(name="RelationExpressionChild")
RelationOperator = Class(name="RelationOperator")
simTL4J_expressions_ConditionalAndExpressionChild = Class(name="simTL4J_expressions_ConditionalAndExpressionChild", is_abstract=True)
simTL4J_expressions_InclusiveOrExpression = Class(name="simTL4J_expressions_InclusiveOrExpression")
InclusiveOrExpressionChild = Class(name="InclusiveOrExpressionChild")
simTL4J_expressions_InclusiveOrExpressionChild = Class(name="simTL4J_expressions_InclusiveOrExpressionChild", is_abstract=True)
simTL4J_expressions_ExclusiveOrExpression = Class(name="simTL4J_expressions_ExclusiveOrExpression")
ExclusiveOrExpressionChild = Class(name="ExclusiveOrExpressionChild")
simTL4J_expressions_ExclusiveOrExpressionChild = Class(name="simTL4J_expressions_ExclusiveOrExpressionChild", is_abstract=True)
simTL4J_expressions_AdditiveExpressionChild = Class(name="simTL4J_expressions_AdditiveExpressionChild", is_abstract=True)
simTL4J_expressions_MultiplicativeExpression = Class(name="simTL4J_expressions_MultiplicativeExpression")
...
simTL4J_expressions_MultiplicativeExpressionChild = Class(name="simTL4J_expressions_MultiplicativeExpressionChild", is_abstract=True)
simTL4J_expressions_UnaryExpression = Class(name="simTL4J_expressions_UnaryExpression")
UnaryOperator = Class(name="UnaryOperator")
UnaryExpressionChild = Class(name="UnaryExpressionChild")
simTL4J_expressions_UnaryExpressionChild = Class(name="simTL4J_expressions_UnaryExpressionChild", is_abstract=True)
simTL4J_expressions_UnaryModificationExpression = Class(name="simTL4J_expressions_UnaryModificationExpression", is_abstract=True)
...
simTL4J_expressions_PrefixUnaryModificationExpression = Class(name="simTL4J_expressions_PrefixUnaryModificationExpression")
UnaryModificationExpression = Class(name="UnaryModificationExpression")
simTL4J_expressions_SuffixUnaryModificationExpression = Class(name="simTL4J_expressions_SuffixUnaryModificationExpression")
simTL4J_expressions_RelationExpressionChild = Class(name="simTL4J_expressions_RelationExpressionChild", is_abstract=True)
simTL4J_expressions_ShiftExpression = Class(name="simTL4J_expressions_ShiftExpression")
ShiftExpressionChild = Class(name="ShiftExpressionChild")
ShiftOperator = Class(name="ShiftOperator")
simTL4J_expressions_ShiftExpressionChild = Class(name="simTL4J_expressions_ShiftExpressionChild", is_abstract=True)
simTL4J_expressions_AdditiveExpression = Class(name="simTL4J_expressions_AdditiveExpression")
AdditiveExpressionChild = Class(name="AdditiveExpressionChild")
AdditiveOperator = Class(name="AdditiveOperator")
simTL4J_generics_TypeArgumentable = Class(name="simTL4J_generics_TypeArgumentable", is_abstract=True)
TypeArgument = Class(name="TypeArgument")
simTL4J_generics_CallTypeArgumentable = Class(name="simTL4J_generics_CallTypeArgumentable", is_abstract=True)
simTL4J_generics_TypeParametrizable = Class(name="simTL4J_generics_TypeParametrizable", is_abstract=True)
TypeParameter = Class(name="TypeParameter")
simTL4J_generics_ExtendsTypeArgument = Class(name="simTL4J_generics_ExtendsTypeArgument")
simTL4J_generics_QualifiedTypeArgument = Class(name="simTL4J_generics_QualifiedTypeArgument")
generics_TypeArgument = Class(name="generics_TypeArgument")
simTL4J_generics_SuperTypeArgument = Class(name="simTL4J_generics_SuperTypeArgument")
simTL4J_generics_TypeParameter = Class(name="simTL4J_generics_TypeParameter")
simTL4J_expressions_UnaryModificationExpressionChild = Class(name="simTL4J_expressions_UnaryModificationExpressionChild", is_abstract=True)
simTL4J_expressions_CastExpression = Class(name="simTL4J_expressions_CastExpression")
expressions_UnaryModificationExpressionChild = Class(name="expressions_UnaryModificationExpressionChild")
simTL4J_expressions_PrimaryExpression = Class(name="simTL4J_expressions_PrimaryExpression", is_abstract=True)
simTL4J_expressions_NestedExpression = Class(name="simTL4J_expressions_NestedExpression")
Reference = Class(name="Reference")
simTL4J_generics_TypeArgument = Class(name="simTL4J_generics_TypeArgument", is_abstract=True)
ArrayTypeable = Class(name="ArrayTypeable")
simTL4J_imports_Import = Class(name="simTL4J_imports_Import", is_abstract=True)
NamespaceAwareElement = Class(name="NamespaceAwareElement")
simTL4J_imports_ImportingElement = Class(name="simTL4J_imports_ImportingElement", is_abstract=True)
Import = Class(name="Import")
simTL4J_imports_StaticImport = Class(name="simTL4J_imports_StaticImport", is_abstract=True)
Static = Class(name="Static")
simTL4J_imports_ClassifierImport = Class(name="simTL4J_imports_ClassifierImport")
simTL4J_imports_PackageImport = Class(name="simTL4J_imports_PackageImport")
simTL4J_generics_UnknownTypeArgument = Class(name="simTL4J_generics_UnknownTypeArgument")
generics_TypeArgumentable = Class(name="generics_TypeArgumentable")
simTL4J_instantiations_NewConstructorCall = Class(name="simTL4J_instantiations_NewConstructorCall")
instantiations_Instantiation = Class(name="instantiations_Instantiation")
generics_CallTypeArgumentable = Class(name="generics_CallTypeArgumentable")
AnonymousClass = Class(name="AnonymousClass")
simTL4J_instantiations_ExplicitConstructorCall = Class(name="simTL4J_instantiations_ExplicitConstructorCall")
Instantiation = Class(name="Instantiation")
Self = Class(name="Self")
simTL4J_literals_Literal = Class(name="simTL4J_literals_Literal", is_abstract=True)
PrimaryExpression = Class(name="PrimaryExpression")
simTL4J_literals_Self = Class(name="simTL4J_literals_Self", is_abstract=True)
simTL4J_literals_BooleanLiteral = Class(name="simTL4J_literals_BooleanLiteral")
Literal = Class(name="Literal")
simTL4J_literals_CharacterLiteral = Class(name="simTL4J_literals_CharacterLiteral")
simTL4J_literals_FloatLiteral = Class(name="simTL4J_literals_FloatLiteral", is_abstract=True)
simTL4J_literals_DecimalFloatLiteral = Class(name="simTL4J_literals_DecimalFloatLiteral")
FloatLiteral = Class(name="FloatLiteral")
simTL4J_imports_StaticClassifierImport = Class(name="simTL4J_imports_StaticClassifierImport")
StaticImport = Class(name="StaticImport")
simTL4J_imports_StaticMemberImport = Class(name="simTL4J_imports_StaticMemberImport")
ReferenceableElement = Class(name="ReferenceableElement")
simTL4J_instantiations_Initializable = Class(name="simTL4J_instantiations_Initializable", is_abstract=True)
simTL4J_instantiations_Instantiation = Class(name="simTL4J_instantiations_Instantiation", is_abstract=True)
references_Argumentable = Class(name="references_Argumentable")
simTL4J_literals_OctalIntegerLiteral = Class(name="simTL4J_literals_OctalIntegerLiteral")
simTL4J_literals_LongLiteral = Class(name="simTL4J_literals_LongLiteral", is_abstract=True)
simTL4J_literals_DecimalLongLiteral = Class(name="simTL4J_literals_DecimalLongLiteral")
LongLiteral = Class(name="LongLiteral")
simTL4J_literals_HexLongLiteral = Class(name="simTL4J_literals_HexLongLiteral")
simTL4J_literals_OctalLongLiteral = Class(name="simTL4J_literals_OctalLongLiteral")
simTL4J_literals_NullLiteral = Class(name="simTL4J_literals_NullLiteral")
simTL4J_literals_Super = Class(name="simTL4J_literals_Super")
simTL4J_literals_This = Class(name="simTL4J_literals_This")
simTL4J_members_ExceptionThrower = Class(name="simTL4J_members_ExceptionThrower", is_abstract=True)
NamespaceClassifierReference = Class(name="NamespaceClassifierReference")
simTL4J_members_Member = Class(name="simTL4J_members_Member", is_abstract=True)
NamedElement = Class(name="NamedElement")
simTL4J_members_MemberContainer = Class(name="simTL4J_members_MemberContainer", is_abstract=True)
simTL4J_literals_HexFloatLiteral = Class(name="simTL4J_literals_HexFloatLiteral")
simTL4J_literals_DoubleLiteral = Class(name="simTL4J_literals_DoubleLiteral", is_abstract=True)
simTL4J_literals_DecimalDoubleLiteral = Class(name="simTL4J_literals_DecimalDoubleLiteral")
DoubleLiteral = Class(name="DoubleLiteral")
simTL4J_literals_HexDoubleLiteral = Class(name="simTL4J_literals_HexDoubleLiteral")
simTL4J_literals_IntegerLiteral = Class(name="simTL4J_literals_IntegerLiteral", is_abstract=True)
simTL4J_literals_DecimalIntegerLiteral = Class(name="simTL4J_literals_DecimalIntegerLiteral")
IntegerLiteral = Class(name="IntegerLiteral")
simTL4J_literals_HexIntegerLiteral = Class(name="simTL4J_literals_HexIntegerLiteral")
instantiations_Initializable = Class(name="instantiations_Initializable")
simTL4J_members_Constructor = Class(name="simTL4J_members_Constructor")
statements_StatementListContainer = Class(name="statements_StatementListContainer")
parameters_Parametrizable = Class(name="parameters_Parametrizable")
members_ExceptionThrower = Class(name="members_ExceptionThrower")
simTL4J_members_EmptyMember = Class(name="simTL4J_members_EmptyMember")
simTL4J_members_Field = Class(name="simTL4J_members_Field")
variables_Variable = Class(name="variables_Variable")
AdditionalField = Class(name="AdditionalField")
simTL4J_members_Method = Class(name="simTL4J_members_Method", is_abstract=True)
Member = Class(name="Member")
simTL4J_members_AdditionalField = Class(name="simTL4J_members_AdditionalField")
simTL4J_members_InterfaceMethod = Class(name="simTL4J_members_InterfaceMethod")
Method_ = Class(name="Method")
simTL4J_members_ClassMethod = Class(name="simTL4J_members_ClassMethod")
members_Method = Class(name="members_Method")
simTL4J_members_EnumConstant = Class(name="simTL4J_members_EnumConstant")
simTL4J_modifiers_Modifier = Class(name="simTL4J_modifiers_Modifier", is_abstract=True)
AnnotationInstanceOrModifier = Class(name="AnnotationInstanceOrModifier")
simTL4J_modifiers_AnnotationInstanceOrModifier = Class(name="simTL4J_modifiers_AnnotationInstanceOrModifier", is_abstract=True)
simTL4J_modifiers_AnnotableAndModifiable = Class(name="simTL4J_modifiers_AnnotableAndModifiable", is_abstract=True)
simTL4J_modifiers_Public = Class(name="simTL4J_modifiers_Public")
simTL4J_modifiers_Private = Class(name="simTL4J_modifiers_Private")
simTL4J_modifiers_Static = Class(name="simTL4J_modifiers_Static")
simTL4J_modifiers_Strictfp = Class(name="simTL4J_modifiers_Strictfp")
simTL4J_modifiers_Synchronized = Class(name="simTL4J_modifiers_Synchronized")
simTL4J_modifiers_Transient = Class(name="simTL4J_modifiers_Transient")
simTL4J_modifiers_Volatile = Class(name="simTL4J_modifiers_Volatile")
simTL4J_operators_Operator = Class(name="simTL4J_operators_Operator", is_abstract=True)
simTL4J_operators_AdditiveOperator = Class(name="simTL4J_operators_AdditiveOperator", is_abstract=True)
Operator = Class(name="Operator")
simTL4J_operators_AssignmentOperator = Class(name="simTL4J_operators_AssignmentOperator", is_abstract=True)
simTL4J_operators_EqualityOperator = Class(name="simTL4J_operators_EqualityOperator", is_abstract=True)
simTL4J_operators_MultiplicativeOperator = Class(name="simTL4J_operators_MultiplicativeOperator", is_abstract=True)
simTL4J_operators_RelationOperator = Class(name="simTL4J_operators_RelationOperator", is_abstract=True)
simTL4J_operators_ShiftOperator = Class(name="simTL4J_operators_ShiftOperator", is_abstract=True)
simTL4J_operators_UnaryOperator = Class(name="simTL4J_operators_UnaryOperator", is_abstract=True)
simTL4J_modifiers_Modifiable = Class(name="simTL4J_modifiers_Modifiable", is_abstract=True)
Modifier = Class(name="Modifier")
simTL4J_modifiers_Abstract = Class(name="simTL4J_modifiers_Abstract")
simTL4J_modifiers_Final = Class(name="simTL4J_modifiers_Final")
simTL4J_modifiers_Native = Class(name="simTL4J_modifiers_Native")
simTL4J_modifiers_Protected = Class(name="simTL4J_modifiers_Protected")
simTL4J_operators_UnaryModificationOperator = Class(name="simTL4J_operators_UnaryModificationOperator", is_abstract=True)
simTL4J_operators_Assignment = Class(name="simTL4J_operators_Assignment")
simTL4J_operators_AssignmentAnd = Class(name="simTL4J_operators_AssignmentAnd")
simTL4J_operators_AssignmentDivision = Class(name="simTL4J_operators_AssignmentDivision")
simTL4J_operators_AssignmentExclusiveOr = Class(name="simTL4J_operators_AssignmentExclusiveOr")
simTL4J_operators_AssignmentMinus = Class(name="simTL4J_operators_AssignmentMinus")
simTL4J_operators_AssignmentModulo = Class(name="simTL4J_operators_AssignmentModulo")
simTL4J_operators_AssignmentMultiplication = Class(name="simTL4J_operators_AssignmentMultiplication")
simTL4J_operators_AssignmentLeftShift = Class(name="simTL4J_operators_AssignmentLeftShift")
simTL4J_operators_AssignmentOr = Class(name="simTL4J_operators_AssignmentOr")
simTL4J_operators_AssignmentPlus = Class(name="simTL4J_operators_AssignmentPlus")
simTL4J_operators_AssignmentRightShift = Class(name="simTL4J_operators_AssignmentRightShift")
simTL4J_operators_AssignmentUnsignedRightShift = Class(name="simTL4J_operators_AssignmentUnsignedRightShift")
simTL4J_operators_Equal = Class(name="simTL4J_operators_Equal")
simTL4J_operators_NotEqual = Class(name="simTL4J_operators_NotEqual")
simTL4J_operators_GreaterThan = Class(name="simTL4J_operators_GreaterThan")
simTL4J_operators_GreaterThanOrEqual = Class(name="simTL4J_operators_GreaterThanOrEqual")
simTL4J_operators_RightShift = Class(name="simTL4J_operators_RightShift")
simTL4J_operators_UnsignedRightShift = Class(name="simTL4J_operators_UnsignedRightShift")
simTL4J_parameters_Parameter = Class(name="simTL4J_parameters_Parameter", is_abstract=True)
simTL4J_parameters_Parametrizable = Class(name="simTL4J_parameters_Parametrizable", is_abstract=True)
Parameter_ = Class(name="Parameter")
simTL4J_parameters_OrdinaryParameter = Class(name="simTL4J_parameters_OrdinaryParameter")
simTL4J_parameters_VariableLengthParameter = Class(name="simTL4J_parameters_VariableLengthParameter")
simTL4J_references_Reference = Class(name="simTL4J_references_Reference", is_abstract=True)
expressions_PrimaryExpression = Class(name="expressions_PrimaryExpression")
ArraySelector = Class(name="ArraySelector")
simTL4J_operators_LessThan = Class(name="simTL4J_operators_LessThan")
simTL4J_operators_LessThanOrEqual = Class(name="simTL4J_operators_LessThanOrEqual")
simTL4J_operators_Addition = Class(name="simTL4J_operators_Addition")
...
simTL4J_operators_Subtraction = Class(name="simTL4J_operators_Subtraction")
simTL4J_operators_Division = Class(name="simTL4J_operators_Division")
simTL4J_operators_Multiplication = Class(name="simTL4J_operators_Multiplication")
simTL4J_operators_Remainder = Class(name="simTL4J_operators_Remainder")
simTL4J_operators_Complement = Class(name="simTL4J_operators_Complement")
simTL4J_operators_MinusMinus = Class(name="simTL4J_operators_MinusMinus")
simTL4J_operators_Negate = Class(name="simTL4J_operators_Negate")
simTL4J_operators_PlusPlus = Class(name="simTL4J_operators_PlusPlus")
simTL4J_operators_LeftShift = Class(name="simTL4J_operators_LeftShift")
simTL4J_references_ReflectiveClassReference = Class(name="simTL4J_references_ReflectiveClassReference")
simTL4J_references_PrimitiveTypeReference = Class(name="simTL4J_references_PrimitiveTypeReference")
PrimitiveType = Class(name="PrimitiveType")
simTL4J_references_StringReference = Class(name="simTL4J_references_StringReference")
simTL4J_references_SelfReference = Class(name="simTL4J_references_SelfReference")
simTL4J_statements_StatementContainer = Class(name="simTL4J_statements_StatementContainer", is_abstract=True)
Statement = Class(name="Statement")
simTL4J_statements_StatementListContainer = Class(name="simTL4J_statements_StatementListContainer", is_abstract=True)
simTL4J_statements_Conditional = Class(name="simTL4J_statements_Conditional", is_abstract=True)
simTL4J_references_Argumentable = Class(name="simTL4J_references_Argumentable", is_abstract=True)
simTL4J_references_ReferenceableElement = Class(name="simTL4J_references_ReferenceableElement", is_abstract=True)
simTL4J_references_ElementReference = Class(name="simTL4J_references_ElementReference", is_abstract=True)
simTL4J_references_IdentifierReference = Class(name="simTL4J_references_IdentifierReference")
ElementReference = Class(name="ElementReference")
simTL4J_references_MethodCall = Class(name="simTL4J_references_MethodCall")
references_ElementReference = Class(name="references_ElementReference")
simTL4J_statements_Condition = Class(name="simTL4J_statements_Condition")
statements_StatementContainer = Class(name="statements_StatementContainer")
simTL4J_statements_Continue = Class(name="simTL4J_statements_Continue")
simTL4J_statements_DefaultSwitchCase = Class(name="simTL4J_statements_DefaultSwitchCase")
SwitchCase = Class(name="SwitchCase")
simTL4J_statements_DoWhileLoop = Class(name="simTL4J_statements_DoWhileLoop")
WhileLoop = Class(name="WhileLoop")
simTL4J_statements_EmptyStatement = Class(name="simTL4J_statements_EmptyStatement")
simTL4J_statements_ExpressionStatement = Class(name="simTL4J_statements_ExpressionStatement")
simTL4J_statements_ForLoop = Class(name="simTL4J_statements_ForLoop")
simTL4J_statements_ForEachLoop = Class(name="simTL4J_statements_ForEachLoop")
simTL4J_statements_ForLoopInitializer = Class(name="simTL4J_statements_ForLoopInitializer", is_abstract=True)
simTL4J_statements_Statement = Class(name="simTL4J_statements_Statement", is_abstract=True)
simTL4J_statements_SwitchCase = Class(name="simTL4J_statements_SwitchCase", is_abstract=True)
StatementListContainer = Class(name="StatementListContainer")
simTL4J_statements_Assert = Class(name="simTL4J_statements_Assert")
statements_Conditional = Class(name="statements_Conditional")
simTL4J_statements_Break = Class(name="simTL4J_statements_Break")
Jump = Class(name="Jump")
simTL4J_statements_Block = Class(name="simTL4J_statements_Block")
modifiers_Modifiable = Class(name="modifiers_Modifiable")
simTL4J_statements_CatchBlock = Class(name="simTL4J_statements_CatchBlock")
OrdinaryParameter = Class(name="OrdinaryParameter")
simTL4J_statements_Jump = Class(name="simTL4J_statements_Jump", is_abstract=True)
JumpLabel = Class(name="JumpLabel")
simTL4J_statements_JumpLabel = Class(name="simTL4J_statements_JumpLabel")
simTL4J_statements_LocalVariableStatement = Class(name="simTL4J_statements_LocalVariableStatement")
LocalVariable = Class(name="LocalVariable")
CatchBlock = Class(name="CatchBlock")
Block = Class(name="Block")
simTL4J_statements_WhileLoop = Class(name="simTL4J_statements_WhileLoop")
simTL4J_statements_NormalSwitchCase = Class(name="simTL4J_statements_NormalSwitchCase")
statements_SwitchCase = Class(name="statements_SwitchCase")
simTL4J_statements_Return = Class(name="simTL4J_statements_Return")
simTL4J_statements_Switch = Class(name="simTL4J_statements_Switch")
simTL4J_statements_SynchronizedBlock = Class(name="simTL4J_statements_SynchronizedBlock")
simTL4J_statements_Throw = Class(name="simTL4J_statements_Throw")
simTL4J_types_NamespaceClassifierReference = Class(name="simTL4J_types_NamespaceClassifierReference")
simTL4J_statements_TryBlock = Class(name="simTL4J_statements_TryBlock")
ClassifierReference = Class(name="ClassifierReference")
simTL4J_types_Type = Class(name="simTL4J_types_Type", is_abstract=True)
simTL4J_types_TypedElement = Class(name="simTL4J_types_TypedElement", is_abstract=True)
simTL4J_types_TypeReference = Class(name="simTL4J_types_TypeReference", is_abstract=True)
simTL4J_types_ClassifierReference = Class(name="simTL4J_types_ClassifierReference")
types_TypeReference = Class(name="types_TypeReference")
simTL4J_simTL_TIf = Class(name="simTL4J_simTL_TIf", is_abstract=True)
TAbstractMethodStatement = Class(name="TAbstractMethodStatement")
simTL4J_simTL_TFor = Class(name="simTL4J_simTL_TFor", is_abstract=True)
simTL4J_types_PrimitiveType = Class(name="simTL4J_types_PrimitiveType", is_abstract=True)
simTL4J_types_Boolean = Class(name="simTL4J_types_Boolean")
simTL4J_types_Byte = Class(name="simTL4J_types_Byte")
simTL4J_types_Char = Class(name="simTL4J_types_Char")
simTL4J_types_Double = Class(name="simTL4J_types_Double")
simTL4J_types_Float = Class(name="simTL4J_types_Float")
simTL4J_types_Int = Class(name="simTL4J_types_Int")
simTL4J_types_Long = Class(name="simTL4J_types_Long")
simTL4J_types_Short = Class(name="simTL4J_types_Short")
simTL4J_types_Void = Class(name="simTL4J_types_Void")
simTL4J_variables_Variable = Class(name="simTL4J_variables_Variable", is_abstract=True)
simTL4J_variables_LocalVariable = Class(name="simTL4J_variables_LocalVariable")
statements_ForLoopInitializer = Class(name="statements_ForLoopInitializer")
AdditionalLocalVariable = Class(name="AdditionalLocalVariable")
simTL4J_variables_AdditionalLocalVariable = Class(name="simTL4J_variables_AdditionalLocalVariable")
simTL4J_simTL_TMethodCall = Class(name="simTL4J_simTL_TMethodCall")
simTL4J_simTL_TAbstractMethodStatement = Class(name="simTL4J_simTL_TAbstractMethodStatement")
simTL4J_simTL_TFor_MemberContainer = Class(name="simTL4J_simTL_TFor_MemberContainer")
simTL_TFor = Class(name="simTL_TFor")
TForVariable = Class(name="TForVariable")
simTL4J_simTL_TForVariable = Class(name="simTL4J_simTL_TForVariable")
simTL4J_simTL_Template = Class(name="simTL4J_simTL_Template")
TemplateHeader = Class(name="TemplateHeader")
simTL4J_simTL_TemplateHeader = Class(name="simTL4J_simTL_TemplateHeader")
TModelImport = Class(name="TModelImport")
simTL4J_simTL_TModelImport = Class(name="simTL4J_simTL_TModelImport")
simTL4J_simTL_TFor_StatementListContainer = Class(name="simTL4J_simTL_TFor_StatementListContainer")
simTL4J_simTL_TIf_MemberContainer = Class(name="simTL4J_simTL_TIf_MemberContainer")
simTL_TIf = Class(name="simTL_TIf")
simTL4J_simTL_TIf_StatementListContainer = Class(name="simTL4J_simTL_TIf_StatementListContainer")
simTL4J_simTL_TPlaceholder = Class(name="simTL4J_simTL_TPlaceholder")
simTL4J_simTL_TPlaceholder_PrimaryExpression = Class(name="simTL4J_simTL_TPlaceholder_PrimaryExpression")
simTL_TPlaceholder = Class(name="simTL_TPlaceholder")
simTL4J_simTL_TUnaryOperator = Class(name="simTL4J_simTL_TUnaryOperator", is_abstract=True)
simTL4J_simTL_TUnaryOperatorNOT = Class(name="simTL4J_simTL_TUnaryOperatorNOT")
TUnaryOperator = Class(name="TUnaryOperator")
simTL4J_simTL_TMethodStatementImpl = Class(name="simTL4J_simTL_TMethodStatementImpl")
...
simTL4J_classifiers_ConcreteClassifier_m_getAllMembers: Method = Method(name="getAllMembers", parameters={Parameter(name='simTL4J_context', type=StringType)}, type=StringType)
simTL4J_classifiers_ConcreteClassifier.attributes={simTL4J_classifiers_ConcreteClassifier_fullName}
simTL4J_classifiers_ConcreteClassifier.methods={simTL4J_classifiers_ConcreteClassifier_m_getAllInnerClassifiers, simTL4J_classifiers_ConcreteClassifier_m_getSuperTypeReferences, simTL4J_classifiers_ConcreteClassifier_m_getAllMembers, simTL4J_classifiers_ConcreteClassifier_m_getInnerClassifiers}
...
simTL4J_commons_Commentable_m_getConcreteClassifier: Method = Method(name="getConcreteClassifier", parameters={Parameter(name='simTL4J_name', type=StringType)}, type=StringType)
simTL4J_commons_Commentable_m_getConcreteClassifiers: Method = Method(name="getConcreteClassifiers", parameters={Parameter(name='simTL4J_packageName', type=StringType), Parameter(name='simTL4J_classifierQuery', type=StringType)}, type=StringType)
simTL4J_commons_Commentable_m_getLibClass: Method = Method(name="getLibClass", parameters={Parameter(name='simTL4J_name', type=StringType)}, type=StringType)
simTL4J_commons_Commentable_m_getLibInterface: Method = Method(name="getLibInterface", parameters={Parameter(name='simTL4J_name', type=StringType)}, type=StringType)
...
simTL4J_commons_Commentable.methods={simTL4J_commons_Commentable_m_getConcreteClassifiers, simTL4J_commons_Commentable_m_getLibInterface, simTL4J_commons_Commentable_m_getContainingAnnotationInstance, simTL4J_commons_Commentable_m_getContainingCompilationUnit, simTL4J_commons_Commentable_m_getLibClass, simTL4J_commons_Commentable_m_getContainingAnonymousClass, simTL4J_commons_Commentable_m_getConcreteClassifier, simTL4J_commons_Commentable_m_getObjectClass, simTL4J_commons_Commentable_m_getContainingPackageName, simTL4J_commons_Commentable_m_getClassClass, simTL4J_commons_Commentable_m_getParentConcreteClassifier, simTL4J_commons_Commentable_m_getAnnotationInterface, simTL4J_commons_Commentable_m_getStringClass, simTL4J_commons_Commentable_m_getContainingConcreteClassifier}
...
simTL4J_classifiers_AnonymousClass_m_getAllMembers: Method = Method(name="getAllMembers", parameters={Parameter(name='simTL4J_context', type=StringType)}, type=StringType)
simTL4J_classifiers_AnonymousClass.methods={simTL4J_classifiers_AnonymousClass_m_getSuperClassifier, simTL4J_classifiers_AnonymousClass_m_getAllMembers, simTL4J_classifiers_AnonymousClass_m_getAllSuperClassifiers}
...
simTL4J_commons_NamespaceAwareElement.methods={simTL4J_commons_NamespaceAwareElement_m_getClassifierAtNamespaces, simTL4J_commons_NamespaceAwareElement_m_getNamespacesAsString}
...
simTL4J_expressions_Expression_m_getOneType: Method = Method(name="getOneType", parameters={Parameter(name='simTL4J_alternative', type=StringType)}, type=StringType)
simTL4J_expressions_Expression_m_getArrayDimension: Method = Method(name="getArrayDimension", parameters={}, type=StringType)
simTL4J_expressions_Expression.methods={simTL4J_expressions_Expression_m_getOneType, simTL4J_expressions_Expression_m_getAlternativeType, simTL4J_expressions_Expression_m_getArrayDimension, simTL4J_expressions_Expression_m_getType}

# simTL4J_containers_CompilationUnit class attributes and methods
simTL4J_containers_CompilationUnit_m_getContainedClassifier: Method = Method(name="getContainedClassifier", parameters={Parameter(name='simTL4J_name', type=StringType)}, type=StringType)
...
simTL4J_containers_CompilationUnit.methods={simTL4J_containers_CompilationUnit_m_getContainedClassifier, simTL4J_containers_CompilationUnit_m_getClassifiersInSamePackage}
...
simTL4J_generics_TypeParameter_m_getAllMembers: Method = Method(name="getAllMembers", parameters={Parameter(name='simTL4J_context', type=StringType)}, type=StringType)
simTL4J_generics_TypeParameter_m_getBoundType: Method = Method(name="getBoundType", parameters={Parameter(name='simTL4J_typeReference', type=StringType), Parameter(name='simTL4J_reference', type=StringType)}, type=StringType)
...
simTL4J_imports_Import_m_getImportedClassifier: Method = Method(name="getImportedClassifier", parameters={Parameter(name='simTL4J_name', type=StringType)}, type=StringType)
...
simTL4J_imports_Import.methods={simTL4J_imports_Import_m_getImportedClassifiers, simTL4J_imports_Import_m_getImportedMembers, simTL4J_imports_Import_m_getImportedClassifier}
...
simTL4J_literals_Literal_m_getOneType: Method = Method(name="getOneType", parameters={Parameter(name='simTL4J_alternative', type=StringType)}, type=StringType)
...
simTL4J_members_MemberContainer_m_getContainedClassifier: Method = Method(name="getContainedClassifier", parameters={Parameter(name='simTL4J_name', type=StringType)}, type=StringType)
simTL4J_members_MemberContainer_m_getContainedField: Method = Method(name="getContainedField", parameters={Parameter(name='simTL4J_name', type=StringType)}, type=StringType)
simTL4J_members_MemberContainer_m_getContainedMethod: Method = Method(name="getContainedMethod", parameters={Parameter(name='simTL4J_name', type=StringType)}, type=StringType)
simTL4J_members_MemberContainer.methods={simTL4J_members_MemberContainer_m_getContainedClassifier, simTL4J_members_MemberContainer_m_getContainedMethod, simTL4J_members_MemberContainer_m_getContainedField}
...
simTL4J_members_Method_m_isMethodForCall: Method = Method(name="isMethodForCall", parameters={Parameter(name='simTL4J_methodCall', type=StringType), Parameter(name='simTL4J_needsPerfectMatch', type=StringType)}, type=BooleanType)
simTL4J_members_Method_m_isBetterMethodForCall: Method = Method(name="isBetterMethodForCall", parameters={Parameter(name='simTL4J_methodCall', type=StringType), Parameter(name='simTL4J_otherMethod', type=StringType)}, type=BooleanType)
simTL4J_members_Method_m_getArrayDimension: Method = Method(name="getArrayDimension", parameters={}, type=StringType)
simTL4J_members_Method_m_isSomeMethodForCall: Method = Method(name="isSomeMethodForCall", parameters={Parameter(name='simTL4J_methodCall', type=StringType)}, type=BooleanType)
simTL4J_members_Method.methods={simTL4J_members_Method_m_isSomeMethodForCall, simTL4J_members_Method_m_isBetterMethodForCall, simTL4J_members_Method_m_isMethodForCall, simTL4J_members_Method_m_getArrayDimension}
...
simTL4J_modifiers_AnnotableAndModifiable_m_isHidden: Method = Method(name="isHidden", parameters={Parameter(name='simTL4J_context', type=StringType)}, type=BooleanType)
...
simTL4J_types_Type_m_equalsType: Method = Method(name="equalsType", parameters={Parameter(name='simTL4J_otherArrayDimension', type=StringType), Parameter(name='simTL4J_otherType', type=StringType), Parameter(name='simTL4J_arrayDimension', type=StringType)}, type=BooleanType)
simTL4J_types_Type_m_isSuperType: Method = Method(name="isSuperType", parameters={Parameter(name='simTL4J_otherArrayType', type=StringType), Parameter(name='simTL4J_otherType', type=StringType), Parameter(name='simTL4J_arrayDimension', type=StringType)}, type=BooleanType)
simTL4J_types_Type_m_getAllMembers: Method = Method(name="getAllMembers", parameters={Parameter(name='simTL4J_context', type=StringType)}, type=StringType)
...
simTL4J_types_TypeReference_m_getBoundTarget: Method = Method(name="getBoundTarget", parameters={Parameter(name='simTL4J_reference', type=StringType)}, type=StringType)
...
simTL4J_types_TypeReference.methods={simTL4J_types_TypeReference_m_getBoundTarget, simTL4J_types_TypeReference_m_getTarget, simTL4J_types_TypeReference_m_getPureClassifierReference}
...
simTL4J_types_PrimitiveType_m_getAllMembers: Method = Method(name="getAllMembers", parameters={Parameter(name='simTL4J_context', type=StringType)}, type=StringType)
...
simTL4J_simTL_TMethodCall.attributes={simTL4J_simTL_TMethodCall_methodName, simTL4J_simTL_TMethodCall_params}
...
class_173: BinaryAssociation = BinaryAssociation(
    name="class_173",
    ends={
...
domain_model = DomainModel(
    name="simTL4J",
    types={simTL4J_annotations_Annotable, Commentable, AnnotationInstance, simTL4J_annotations_AnnotationParameterList, AnnotationAttributeSetting, simTL4J_annotations_AnnotationAttributeSetting, InterfaceMethod, simTL4J_annotations_AnnotationValue, simTL4J_annotations_AnnotationAttribute, Expression, simTL4J_arrays_ArrayTypeable, ArrayDimension, simTL4J_annotations_AnnotationInstance, references_Reference, modifiers_AnnotationInstanceOrModifier, commons_NamespaceAwareElement, Classifier, AnnotationParameter, simTL4J_annotations_AnnotationParameter, simTL4J_annotations_SingleAnnotationParameter, AnnotationValue, simTL4J_arrays_ArrayInstantiationByValues, ArrayInitializer, simTL4J_arrays_ArraySelector, simTL4J_classifiers_Classifier, types_Type, references_ReferenceableElement, simTL4J_classifiers_ConcreteClassifier, classifiers_Classifier, generics_TypeParametrizable, members_MemberContainer, members_Member, statements_Statement, modifiers_AnnotableAndModifiable, simTL4J_arrays_ArrayDimension, simTL4J_arrays_ArrayInitializer, arrays_ArrayInitializationValue, annotations_AnnotationValue, ArrayInitializationValue, simTL4J_arrays_ArrayInitializationValue, simTL4J_arrays_ArrayInstantiationBySize, expressions_Expression, types_TypedElement, arrays_ArrayTypeable, classifiers_Implementor, simTL4J_classifiers_Interface, ConcreteClassifier, simTL4J_classifiers_Enumeration, simTL4J_classifiers_Implementor, TypeReference, simTL4J_classifiers_Class, classifiers_ConcreteClassifier, simTL4J_commons_Commentable, EnumConstant, simTL4J_classifiers_Annotation, simTL4J_classifiers_AnonymousClass, simTL4J_commons_NamedElement, TPlaceholder, simTL4J_commons_NamespaceAwareElement, simTL4J_containers_JavaRoot, commons_NamedElement, imports_ImportingElement, simTL4J_containers_Package, containers_JavaRoot, annotations_Annotable, CompilationUnit, Package, simTL4J_containers_EmptyModel, simTL4J_expressions_ExpressionList, ForLoopInitializer, simTL4J_expressions_Expression, simTL4J_containers_CompilationUnit, JavaRoot, simTL4J_expressions_AssignmentExpressionChild, simTL4J_expressions_ConditionalExpression, ConditionalExpressionChild, simTL4J_expressions_ConditionalExpressionChild, simTL4J_expressions_ConditionalOrExpression, ConditionalOrExpressionChild, simTL4J_expressions_ConditionalOrExpressionChild, simTL4J_expressions_ConditionalAndExpression, ConditionalAndExpressionChild, simTL4J_expressions_AssignmentExpression, AssignmentExpressionChild, AssignmentOperator, simTL4J_expressions_AndExpression, AndExpressionChild, simTL4J_expressions_AndExpressionChild, simTL4J_expressions_EqualityExpression, EqualityOperator, EqualityExpressionChild, simTL4J_expressions_EqualityExpressionChild, simTL4J_expressions_InstanceOfExpression, expressions_EqualityExpressionChild, InstanceOfExpressionChild, simTL4J_expressions_InstanceOfExpressionChild, simTL4J_expressions_RelationExpression, RelationExpressionChild, RelationOperator, simTL4J_expressions_ConditionalAndExpressionChild, simTL4J_expressions_InclusiveOrExpression, InclusiveOrExpressionChild, simTL4J_expressions_InclusiveOrExpressionChild, simTL4J_expressions_ExclusiveOrExpression, ExclusiveOrExpressionChild, simTL4J_expressions_ExclusiveOrExpressionChild, simTL4J_expressions_AdditiveExpressionChild, simTL4J_expressions_MultiplicativeExpression, MultiplicativeExpressionChild, MultiplicativeOperator, simTL4J_expressions_MultiplicativeExpressionChild, simTL4J_expressions_UnaryExpression, UnaryOperator, UnaryExpressionChild, simTL4J_expressions_UnaryExpressionChild, simTL4J_expressions_UnaryModificationExpression, UnaryModificationExpressionChild, UnaryModificationOperator, simTL4J_expressions_PrefixUnaryModificationExpression, UnaryModificationExpression, simTL4J_expressions_SuffixUnaryModificationExpression, simTL4J_expressions_RelationExpressionChild, simTL4J_expressions_ShiftExpression, ShiftExpressionChild, ShiftOperator, simTL4J_expressions_ShiftExpressionChild, simTL4J_expressions_AdditiveExpression, AdditiveExpressionChild, AdditiveOperator, simTL4J_generics_TypeArgumentable, TypeArgument, simTL4J_generics_CallTypeArgumentable, simTL4J_generics_TypeParametrizable, TypeParameter, simTL4J_generics_ExtendsTypeArgument, simTL4J_generics_QualifiedTypeArgument, generics_TypeArgument, simTL4J_generics_SuperTypeArgument, simTL4J_generics_TypeParameter, simTL4J_expressions_UnaryModificationExpressionChild, simTL4J_expressions_CastExpression, expressions_UnaryModificationExpressionChild, simTL4J_expressions_PrimaryExpression, simTL4J_expressions_NestedExpression, Reference, simTL4J_generics_TypeArgument, ArrayTypeable, simTL4J_imports_Import, NamespaceAwareElement, simTL4J_imports_ImportingElement, Import, simTL4J_imports_StaticImport, Static, simTL4J_imports_ClassifierImport, simTL4J_imports_PackageImport, simTL4J_generics_UnknownTypeArgument, generics_TypeArgumentable, simTL4J_instantiations_NewConstructorCall, instantiations_Instantiation, generics_CallTypeArgumentable, AnonymousClass, simTL4J_instantiations_ExplicitConstructorCall, Instantiation, Self, simTL4J_literals_Literal, PrimaryExpression, simTL4J_literals_Self, simTL4J_literals_BooleanLiteral, Literal, simTL4J_literals_CharacterLiteral, simTL4J_literals_FloatLiteral, simTL4J_literals_DecimalFloatLiteral, FloatLiteral, simTL4J_imports_StaticClassifierImport, StaticImport, simTL4J_imports_StaticMemberImport, ReferenceableElement, simTL4J_instantiations_Initializable, simTL4J_instantiations_Instantiation, references_Argumentable, simTL4J_literals_OctalIntegerLiteral, simTL4J_literals_LongLiteral, simTL4J_literals_DecimalLongLiteral, LongLiteral, simTL4J_literals_HexLongLiteral, simTL4J_literals_OctalLongLiteral, simTL4J_literals_NullLiteral, simTL4J_literals_Super, simTL4J_literals_This, simTL4J_members_ExceptionThrower, NamespaceClassifierReference, simTL4J_members_Member, NamedElement, simTL4J_members_MemberContainer, simTL4J_literals_HexFloatLiteral, simTL4J_literals_DoubleLiteral, simTL4J_literals_DecimalDoubleLiteral, DoubleLiteral, simTL4J_literals_HexDoubleLiteral, simTL4J_literals_IntegerLiteral, simTL4J_literals_DecimalIntegerLiteral, IntegerLiteral, simTL4J_literals_HexIntegerLiteral, instantiations_Initializable, simTL4J_members_Constructor, statements_StatementListContainer, parameters_Parametrizable, members_ExceptionThrower, simTL4J_members_EmptyMember, simTL4J_members_Field, variables_Variable, AdditionalField, simTL4J_members_Method, Member, simTL4J_members_AdditionalField, simTL4J_members_InterfaceMethod, Method_, simTL4J_members_ClassMethod, members_Method, simTL4J_members_EnumConstant, simTL4J_modifiers_Modifier, AnnotationInstanceOrModifier, simTL4J_modifiers_AnnotationInstanceOrModifier, simTL4J_modifiers_AnnotableAndModifiable, simTL4J_modifiers_Public, simTL4J_modifiers_Private, simTL4J_modifiers_Static, simTL4J_modifiers_Strictfp, simTL4J_modifiers_Synchronized, simTL4J_modifiers_Transient, simTL4J_modifiers_Volatile, simTL4J_operators_Operator, simTL4J_operators_AdditiveOperator, Operator, simTL4J_operators_AssignmentOperator, simTL4J_operators_EqualityOperator, simTL4J_operators_MultiplicativeOperator, simTL4J_operators_RelationOperator, simTL4J_operators_ShiftOperator, simTL4J_operators_UnaryOperator, simTL4J_modifiers_Modifiable, Modifier, simTL4J_modifiers_Abstract, simTL4J_modifiers_Final, simTL4J_modifiers_Native, simTL4J_modifiers_Protected, simTL4J_operators_UnaryModificationOperator, simTL4J_operators_Assignment, simTL4J_operators_AssignmentAnd, simTL4J_operators_AssignmentDivision, simTL4J_operators_AssignmentExclusiveOr, simTL4J_operators_AssignmentMinus, simTL4J_operators_AssignmentModulo, simTL4J_operators_AssignmentMultiplication, simTL4J_operators_AssignmentLeftShift, simTL4J_operators_AssignmentOr, simTL4J_operators_AssignmentPlus, simTL4J_operators_AssignmentRightShift, simTL4J_operators_AssignmentUnsignedRightShift, simTL4J_operators_Equal, simTL4J_operators_NotEqual, simTL4J_operators_GreaterThan, simTL4J_operators_GreaterThanOrEqual, simTL4J_operators_RightShift, simTL4J_operators_UnsignedRightShift, simTL4J_parameters_Parameter, simTL4J_parameters_Parametrizable, Parameter_, simTL4J_parameters_OrdinaryParameter, simTL4J_parameters_VariableLengthParameter, simTL4J_references_Reference, expressions_PrimaryExpression, ArraySelector, simTL4J_operators_LessThan, simTL4J_operators_LessThanOrEqual, simTL4J_operators_Addition, operators_AdditiveOperator, operators_UnaryOperator, simTL4J_operators_Subtraction, simTL4J_operators_Division, simTL4J_operators_Multiplication, simTL4J_operators_Remainder, simTL4J_operators_Complement, simTL4J_operators_MinusMinus, simTL4J_operators_Negate, simTL4J_operators_PlusPlus, simTL4J_operators_LeftShift, simTL4J_references_ReflectiveClassReference, simTL4J_references_PrimitiveTypeReference, PrimitiveType, simTL4J_references_StringReference, simTL4J_references_SelfReference, simTL4J_statements_StatementContainer, Statement, simTL4J_statements_StatementListContainer, simTL4J_statements_Conditional, simTL4J_references_Argumentable, simTL4J_references_ReferenceableElement, simTL4J_references_ElementReference, simTL4J_references_IdentifierReference, ElementReference, simTL4J_references_MethodCall, references_ElementReference, simTL4J_statements_Condition, statements_StatementContainer, simTL4J_statements_Continue, simTL4J_statements_DefaultSwitchCase, SwitchCase, simTL4J_statements_DoWhileLoop, WhileLoop, simTL4J_statements_EmptyStatement, simTL4J_statements_ExpressionStatement, simTL4J_statements_ForLoop, simTL4J_statements_ForEachLoop, simTL4J_statements_ForLoopInitializer, simTL4J_statements_Statement, simTL4J_statements_SwitchCase, StatementListContainer, simTL4J_statements_Assert, statements_Conditional, simTL4J_statements_Break, Jump, simTL4J_statements_Block, modifiers_Modifiable, simTL4J_statements_CatchBlock, OrdinaryParameter, simTL4J_statements_Jump, JumpLabel, simTL4J_statements_JumpLabel, simTL4J_statements_LocalVariableStatement, LocalVariable, CatchBlock, Block, simTL4J_statements_WhileLoop, simTL4J_statements_NormalSwitchCase, statements_SwitchCase, simTL4J_statements_Return, simTL4J_statements_Switch, simTL4J_statements_SynchronizedBlock, simTL4J_statements_Throw, simTL4J_types_NamespaceClassifierReference, simTL4J_statements_TryBlock, ClassifierReference, simTL4J_types_Type, simTL4J_types_TypedElement, simTL4J_types_TypeReference, simTL4J_types_ClassifierReference, types_TypeReference, simTL4J_simTL_TIf, TAbstractMethodStatement, simTL4J_simTL_TFor, simTL4J_types_PrimitiveType, simTL4J_types_Boolean, simTL4J_types_Byte, simTL4J_types_Char, simTL4J_types_Double, simTL4J_types_Float, simTL4J_types_Int, simTL4J_types_Long, simTL4J_types_Short, simTL4J_types_Void, simTL4J_variables_Variable, simTL4J_variables_LocalVariable, statements_ForLoopInitializer, AdditionalLocalVariable, simTL4J_variables_AdditionalLocalVariable, simTL4J_simTL_TMethodCall, simTL4J_simTL_TAbstractMethodStatement, simTL4J_simTL_TFor_MemberContainer, simTL_TFor, TForVariable, simTL4J_simTL_TForVariable, simTL4J_simTL_Template, TemplateHeader, simTL4J_simTL_TemplateHeader, TModelImport, simTL4J_simTL_TModelImport, simTL4J_simTL_TFor_StatementListContainer, simTL4J_simTL_TIf_MemberContainer, simTL_TIf, simTL4J_simTL_TIf_StatementListContainer, simTL4J_simTL_TPlaceholder, simTL4J_simTL_TPlaceholder_PrimaryExpression, simTL_TPlaceholder, simTL4J_simTL_TUnaryOperator, simTL4J_simTL_TUnaryOperatorNOT, TUnaryOperator, simTL4J_simTL_TMethodStatementImpl, TMethodCall},
    associations={value4, settings5, attribute6, value7, defaultValue10, annotations0, annotation1, parameter2, sizes16, arrayInitializer18, position19, arrayDimensionsBefore11, arrayDimensionsAfter12, initialValues15, extends22, defaultExtends24, extends27, defaultExtends29, implements21, constants32, name_PH33, compilationUnits35, subpackages36, expressions38, classifiers34, value43, child46, expressionIf47, expressionElse50, children53, child40, assignmentOperator41, children57, equalityOperators58, children59, child61, children62, relationOperators63, children54, children55, children56, children71, multiplicativeOperators72, operators74, child75, child77, operator78, children65, shiftOperators66, children68, additiveOperators69, typeArguments84, callTypeArguments85, typeParameters87, extendTypes88, superType90, child80, expression82, imports94, static95, classifier96, extendTypes92, anonymousClass101, callTarget102, staticMembers98, initialValue99, exceptions103, additionalFields108, members104, defaultMembers105, anonymousClass109, annotationsAndModifiers111, modifiers112, parameters113, next114, arraySelectors115, primitiveType121, self122, statement124, statements125, condition127, arguments117, target119, elseStatement132, expression134, init136, updates137, next140, errorMessage129, parameter131, collection142, target145, catcheBlocks157, finallyBlock158, variable146, returnValue147, cases149, variable150, lockProvider153, target164, throwable155, classifierReferences166, condition160, typeReference162, condition168, additionalLocalVariables167, count169, setToBeIterated170, templateHeader172, class_173, modelImports175, methodStatement176, methodStatement178, callee180},
    generalizations={gen_simTL4J_annotations_Annotable_Commentable, gen_simTL4J_annotations_AnnotationParameterList_AnnotationParameter, gen_simTL4J_annotations_AnnotationAttributeSetting_Commentable, gen_simTL4J_annotations_AnnotationValue_Commentable, gen_simTL4J_annotations_AnnotationAttribute_InterfaceMethod, gen_simTL4J_arrays_ArrayTypeable_Commentable, gen_simTL4J_annotations_AnnotationInstance_references_Reference, gen_simTL4J_annotations_AnnotationInstance_modifiers_AnnotationInstanceOrModifier, gen_simTL4J_annotations_AnnotationInstance_commons_NamespaceAwareElement, gen_simTL4J_annotations_AnnotationParameter_Commentable, gen_simTL4J_annotations_SingleAnnotationParameter_AnnotationParameter, gen_simTL4J_arrays_ArrayInstantiationByValues_expressions_Expression, gen_simTL4J_arrays_ArrayInstantiationByValues_types_TypedElement, gen_simTL4J_arrays_ArrayInstantiationByValues_arrays_ArrayTypeable, gen_simTL4J_arrays_ArrayInstantiationByValues_references_Reference, gen_simTL4J_arrays_ArraySelector_Commentable, gen_simTL4J_classifiers_Classifier_types_Type, gen_simTL4J_classifiers_Classifier_references_ReferenceableElement, gen_simTL4J_classifiers_ConcreteClassifier_classifiers_Classifier, gen_simTL4J_classifiers_ConcreteClassifier_generics_TypeParametrizable, gen_simTL4J_classifiers_ConcreteClassifier_members_MemberContainer, gen_simTL4J_classifiers_ConcreteClassifier_members_Member, gen_simTL4J_classifiers_ConcreteClassifier_statements_Statement, gen_simTL4J_classifiers_ConcreteClassifier_modifiers_AnnotableAndModifiable, gen_simTL4J_arrays_ArrayDimension_Commentable, gen_simTL4J_arrays_ArrayInitializer_arrays_ArrayInitializationValue, gen_simTL4J_arrays_ArrayInitializer_annotations_AnnotationValue, gen_simTL4J_arrays_ArrayInitializationValue_Commentable, gen_simTL4J_arrays_ArrayInstantiationBySize_expressions_Expression, gen_simTL4J_arrays_ArrayInstantiationBySize_types_TypedElement, gen_simTL4J_arrays_ArrayInstantiationBySize_arrays_ArrayTypeable, gen_simTL4J_arrays_ArrayInstantiationBySize_references_Reference, gen_simTL4J_classifiers_Class_classifiers_ConcreteClassifier, gen_simTL4J_classifiers_Class_classifiers_Implementor, gen_simTL4J_classifiers_Interface_ConcreteClassifier, gen_simTL4J_classifiers_Enumeration_classifiers_ConcreteClassifier, gen_simTL4J_classifiers_Enumeration_classifiers_Implementor, gen_simTL4J_classifiers_Implementor_Commentable, gen_simTL4J_classifiers_Annotation_ConcreteClassifier, gen_simTL4J_classifiers_AnonymousClass_types_Type, gen_simTL4J_classifiers_AnonymousClass_members_MemberContainer, gen_simTL4J_commons_NamedElement_Commentable, gen_simTL4J_commons_NamespaceAwareElement_Commentable, gen_simTL4J_containers_JavaRoot_commons_NamedElement, gen_simTL4J_containers_JavaRoot_commons_NamespaceAwareElement, gen_simTL4J_containers_JavaRoot_imports_ImportingElement, gen_simTL4J_containers_Package_containers_JavaRoot, gen_simTL4J_containers_Package_annotations_Annotable, gen_simTL4J_containers_Package_references_ReferenceableElement, gen_simTL4J_containers_EmptyModel_JavaRoot, gen_simTL4J_expressions_ExpressionList_ForLoopInitializer, gen_simTL4J_expressions_Expression_arrays_ArrayInitializationValue, gen_simTL4J_expressions_Expression_annotations_AnnotationValue, gen_simTL4J_containers_CompilationUnit_JavaRoot, gen_simTL4J_expressions_AssignmentExpressionChild_Expression, gen_simTL4J_expressions_ConditionalExpression_AssignmentExpressionChild, gen_simTL4J_expressions_ConditionalExpressionChild_AssignmentExpressionChild, gen_simTL4J_expressions_ConditionalOrExpression_ConditionalExpressionChild, gen_simTL4J_expressions_ConditionalOrExpressionChild_ConditionalExpressionChild, gen_simTL4J_expressions_ConditionalAndExpression_ConditionalOrExpressionChild, gen_simTL4J_expressions_AssignmentExpression_Expression, gen_simTL4J_expressions_AndExpression_ExclusiveOrExpressionChild, gen_simTL4J_expressions_AndExpressionChild_ExclusiveOrExpressionChild, gen_simTL4J_expressions_EqualityExpression_AndExpressionChild, gen_simTL4J_expressions_EqualityExpressionChild_AndExpressionChild, gen_simTL4J_expressions_InstanceOfExpression_arrays_ArrayTypeable, gen_simTL4J_expressions_InstanceOfExpression_types_TypedElement, gen_simTL4J_expressions_InstanceOfExpression_expressions_EqualityExpressionChild, gen_simTL4J_expressions_InstanceOfExpressionChild_EqualityExpressionChild, gen_simTL4J_expressions_RelationExpression_InstanceOfExpressionChild, gen_simTL4J_expressions_ConditionalAndExpressionChild_ConditionalOrExpressionChild, gen_simTL4J_expressions_InclusiveOrExpression_ConditionalAndExpressionChild, gen_simTL4J_expressions_InclusiveOrExpressionChild_ConditionalAndExpressionChild, gen_simTL4J_expressions_ExclusiveOrExpression_InclusiveOrExpressionChild, gen_simTL4J_expressions_ExclusiveOrExpressionChild_InclusiveOrExpressionChild, gen_simTL4J_expressions_AdditiveExpressionChild_ShiftExpressionChild, gen_simTL4J_expressions_MultiplicativeExpression_AdditiveExpressionChild, gen_simTL4J_expressions_MultiplicativeExpressionChild_AdditiveExpressionChild, gen_simTL4J_expressions_UnaryExpression_MultiplicativeExpressionChild, gen_simTL4J_expressions_UnaryExpressionChild_MultiplicativeExpressionChild, gen_simTL4J_expressions_UnaryModificationExpression_UnaryExpressionChild, gen_simTL4J_expressions_PrefixUnaryModificationExpression_UnaryModificationExpression, gen_simTL4J_expressions_RelationExpressionChild_InstanceOfExpressionChild, gen_simTL4J_expressions_ShiftExpression_RelationExpressionChild, gen_simTL4J_expressions_ShiftExpressionChild_RelationExpressionChild, gen_simTL4J_expressions_AdditiveExpression_ShiftExpressionChild, gen_simTL4J_generics_TypeArgumentable_Commentable, gen_simTL4J_generics_CallTypeArgumentable_Commentable, gen_simTL4J_generics_TypeParametrizable_Commentable, gen_simTL4J_generics_ExtendsTypeArgument_TypeArgument, gen_simTL4J_generics_QualifiedTypeArgument_generics_TypeArgument, gen_simTL4J_generics_QualifiedTypeArgument_types_TypedElement, gen_simTL4J_generics_SuperTypeArgument_TypeArgument, gen_simTL4J_generics_TypeParameter_Classifier, gen_simTL4J_expressions_SuffixUnaryModificationExpression_UnaryModificationExpression, gen_simTL4J_expressions_UnaryModificationExpressionChild_UnaryExpressionChild, gen_simTL4J_expressions_CastExpression_types_TypedElement, gen_simTL4J_expressions_CastExpression_arrays_ArrayTypeable, gen_simTL4J_expressions_CastExpression_expressions_UnaryModificationExpressionChild, gen_simTL4J_expressions_PrimaryExpression_UnaryModificationExpressionChild, gen_simTL4J_expressions_NestedExpression_Reference, gen_simTL4J_generics_TypeArgument_ArrayTypeable, gen_simTL4J_imports_Import_NamespaceAwareElement, gen_simTL4J_imports_ImportingElement_Commentable, gen_simTL4J_imports_StaticImport_Import, gen_simTL4J_imports_ClassifierImport_Import, gen_simTL4J_generics_UnknownTypeArgument_TypeArgument, gen_simTL4J_instantiations_Instantiation_references_Argumentable, gen_simTL4J_instantiations_Instantiation_generics_TypeArgumentable, gen_simTL4J_instantiations_NewConstructorCall_instantiations_Instantiation, gen_simTL4J_instantiations_NewConstructorCall_generics_CallTypeArgumentable, gen_simTL4J_instantiations_ExplicitConstructorCall_Instantiation, gen_simTL4J_literals_Literal_PrimaryExpression, gen_simTL4J_literals_Self_Commentable, gen_simTL4J_literals_BooleanLiteral_Literal, gen_simTL4J_literals_CharacterLiteral_Literal, gen_simTL4J_literals_FloatLiteral_Literal, gen_simTL4J_imports_PackageImport_Import, gen_simTL4J_imports_StaticClassifierImport_StaticImport, gen_simTL4J_imports_StaticMemberImport_StaticImport, gen_simTL4J_instantiations_Initializable_Commentable, gen_simTL4J_instantiations_Instantiation_types_TypedElement, gen_simTL4J_instantiations_Instantiation_references_Reference, gen_simTL4J_literals_OctalIntegerLiteral_IntegerLiteral, gen_simTL4J_literals_LongLiteral_Literal, gen_simTL4J_literals_DecimalLongLiteral_LongLiteral, gen_simTL4J_literals_HexLongLiteral_LongLiteral, gen_simTL4J_literals_OctalLongLiteral_LongLiteral, gen_simTL4J_literals_NullLiteral_Literal, gen_simTL4J_literals_Super_Self, gen_simTL4J_literals_This_Self, gen_simTL4J_members_ExceptionThrower_Commentable, gen_simTL4J_members_Member_NamedElement, gen_simTL4J_members_MemberContainer_Commentable, gen_simTL4J_literals_DecimalFloatLiteral_FloatLiteral, gen_simTL4J_literals_HexFloatLiteral_FloatLiteral, gen_simTL4J_literals_DoubleLiteral_Literal, gen_simTL4J_literals_DecimalDoubleLiteral_DoubleLiteral, gen_simTL4J_literals_HexDoubleLiteral_DoubleLiteral, gen_simTL4J_literals_IntegerLiteral_Literal, gen_simTL4J_literals_DecimalIntegerLiteral_IntegerLiteral, gen_simTL4J_literals_HexIntegerLiteral_IntegerLiteral, gen_simTL4J_members_AdditionalField_references_ReferenceableElement, gen_simTL4J_members_AdditionalField_arrays_ArrayTypeable, gen_simTL4J_members_AdditionalField_instantiations_Initializable, gen_simTL4J_members_Constructor_members_Member, gen_simTL4J_members_Constructor_statements_StatementListContainer, gen_simTL4J_members_Constructor_parameters_Parametrizable, gen_simTL4J_members_Constructor_generics_TypeParametrizable, gen_simTL4J_members_Constructor_members_ExceptionThrower, gen_simTL4J_members_Constructor_modifiers_AnnotableAndModifiable, gen_simTL4J_members_EmptyMember_Member, gen_simTL4J_members_Field_members_Member, gen_simTL4J_members_Field_instantiations_Initializable, gen_simTL4J_members_Field_variables_Variable, gen_simTL4J_members_Field_references_ReferenceableElement, gen_simTL4J_members_Field_modifiers_AnnotableAndModifiable, gen_simTL4J_members_Method_members_Member, gen_simTL4J_members_Method_types_TypedElement, gen_simTL4J_members_Method_arrays_ArrayTypeable, gen_simTL4J_members_Method_generics_TypeParametrizable, gen_simTL4J_members_Method_parameters_Parametrizable, gen_simTL4J_members_Method_references_ReferenceableElement, gen_simTL4J_members_Method_members_ExceptionThrower, gen_simTL4J_members_Method_modifiers_AnnotableAndModifiable, gen_simTL4J_members_InterfaceMethod_Method, gen_simTL4J_members_ClassMethod_members_Method, gen_simTL4J_members_ClassMethod_statements_StatementListContainer, gen_simTL4J_members_EnumConstant_references_ReferenceableElement, gen_simTL4J_members_EnumConstant_references_Argumentable, gen_simTL4J_members_EnumConstant_annotations_Annotable, gen_simTL4J_modifiers_Modifier_AnnotationInstanceOrModifier, gen_simTL4J_modifiers_AnnotationInstanceOrModifier_Commentable, gen_simTL4J_modifiers_AnnotableAndModifiable_Commentable, gen_simTL4J_modifiers_Protected_Modifier, gen_simTL4J_modifiers_Public_Modifier, gen_simTL4J_modifiers_Private_Modifier, gen_simTL4J_modifiers_Static_Modifier, gen_simTL4J_modifiers_Strictfp_Modifier, gen_simTL4J_modifiers_Synchronized_Modifier, gen_simTL4J_modifiers_Transient_Modifier, gen_simTL4J_modifiers_Volatile_Modifier, gen_simTL4J_operators_Operator_Commentable, gen_simTL4J_operators_AdditiveOperator_Operator, gen_simTL4J_operators_AssignmentOperator_Operator, gen_simTL4J_operators_EqualityOperator_Operator, gen_simTL4J_operators_MultiplicativeOperator_Operator, gen_simTL4J_operators_RelationOperator_Operator, gen_simTL4J_operators_ShiftOperator_Operator, gen_simTL4J_operators_UnaryOperator_Operator, gen_simTL4J_modifiers_Modifiable_Commentable, gen_simTL4J_modifiers_Abstract_Modifier, gen_simTL4J_modifiers_Final_Modifier, gen_simTL4J_modifiers_Native_Modifier, gen_simTL4J_operators_UnaryModificationOperator_Operator, gen_simTL4J_operators_Assignment_AssignmentOperator, gen_simTL4J_operators_AssignmentAnd_AssignmentOperator, gen_simTL4J_operators_AssignmentDivision_AssignmentOperator, gen_simTL4J_operators_AssignmentExclusiveOr_AssignmentOperator, gen_simTL4J_operators_AssignmentMinus_AssignmentOperator, gen_simTL4J_operators_AssignmentModulo_AssignmentOperator, gen_simTL4J_operators_AssignmentMultiplication_AssignmentOperator, gen_simTL4J_operators_AssignmentLeftShift_AssignmentOperator, gen_simTL4J_operators_AssignmentOr_AssignmentOperator, gen_simTL4J_operators_AssignmentPlus_AssignmentOperator, gen_simTL4J_operators_AssignmentRightShift_AssignmentOperator, gen_simTL4J_operators_AssignmentUnsignedRightShift_AssignmentOperator, gen_simTL4J_operators_Equal_EqualityOperator, gen_simTL4J_operators_NotEqual_EqualityOperator, gen_simTL4J_operators_GreaterThan_RelationOperator, gen_simTL4J_operators_GreaterThanOrEqual_RelationOperator, gen_simTL4J_operators_RightShift_ShiftOperator, gen_simTL4J_operators_UnsignedRightShift_ShiftOperator, gen_simTL4J_parameters_Parameter_variables_Variable, gen_simTL4J_parameters_Parameter_modifiers_AnnotableAndModifiable, gen_simTL4J_parameters_Parametrizable_Commentable, gen_simTL4J_parameters_OrdinaryParameter_Parameter, gen_simTL4J_parameters_VariableLengthParameter_Parameter, gen_simTL4J_references_Reference_expressions_PrimaryExpression, gen_simTL4J_references_Reference_generics_TypeArgumentable, gen_simTL4J_operators_LessThan_RelationOperator, gen_simTL4J_operators_LessThanOrEqual_RelationOperator, gen_simTL4J_operators_Addition_operators_AdditiveOperator, gen_simTL4J_operators_Addition_operators_UnaryOperator, gen_simTL4J_operators_Subtraction_operators_AdditiveOperator, gen_simTL4J_operators_Subtraction_operators_UnaryOperator, gen_simTL4J_operators_Division_MultiplicativeOperator, gen_simTL4J_operators_Multiplication_MultiplicativeOperator, gen_simTL4J_operators_Remainder_MultiplicativeOperator, gen_simTL4J_operators_Complement_UnaryOperator, gen_simTL4J_operators_MinusMinus_UnaryModificationOperator, gen_simTL4J_operators_Negate_UnaryOperator, gen_simTL4J_operators_PlusPlus_UnaryModificationOperator, gen_simTL4J_operators_LeftShift_ShiftOperator, gen_simTL4J_references_ReflectiveClassReference_Reference, gen_simTL4J_references_PrimitiveTypeReference_Reference, gen_simTL4J_references_StringReference_Reference, gen_simTL4J_references_SelfReference_Reference, gen_simTL4J_statements_StatementContainer_Commentable, gen_simTL4J_statements_StatementListContainer_Commentable, gen_simTL4J_statements_Conditional_Commentable, gen_simTL4J_references_Argumentable_Commentable, gen_simTL4J_references_ReferenceableElement_NamedElement, gen_simTL4J_references_ElementReference_Reference, gen_simTL4J_references_IdentifierReference_ElementReference, gen_simTL4J_references_MethodCall_references_ElementReference, gen_simTL4J_references_MethodCall_references_Argumentable, gen_simTL4J_references_MethodCall_generics_CallTypeArgumentable, gen_simTL4J_statements_Condition_statements_Statement, gen_simTL4J_statements_Condition_statements_StatementContainer, gen_simTL4J_statements_Condition_statements_Conditional, gen_simTL4J_statements_Continue_Jump, gen_simTL4J_statements_DefaultSwitchCase_SwitchCase, gen_simTL4J_statements_DoWhileLoop_WhileLoop, gen_simTL4J_statements_EmptyStatement_Statement, gen_simTL4J_statements_ExpressionStatement_Statement, gen_simTL4J_statements_ForLoop_statements_Statement, gen_simTL4J_statements_ForLoop_statements_StatementContainer, gen_simTL4J_statements_ForLoop_statements_Conditional, gen_simTL4J_statements_ForEachLoop_statements_Statement, gen_simTL4J_statements_ForEachLoop_statements_StatementContainer, gen_simTL4J_statements_ForLoopInitializer_Commentable, gen_simTL4J_statements_Statement_Commentable, gen_simTL4J_statements_SwitchCase_StatementListContainer, gen_simTL4J_statements_Assert_statements_Statement, gen_simTL4J_statements_Assert_statements_Conditional, gen_simTL4J_statements_Break_Jump, gen_simTL4J_statements_Block_members_Member, gen_simTL4J_statements_Block_statements_Statement, gen_simTL4J_statements_Block_statements_StatementListContainer, gen_simTL4J_statements_Block_modifiers_Modifiable, gen_simTL4J_statements_CatchBlock_StatementListContainer, gen_simTL4J_statements_Jump_Statement, gen_simTL4J_statements_JumpLabel_statements_Statement, gen_simTL4J_statements_JumpLabel_statements_StatementContainer, gen_simTL4J_statements_JumpLabel_commons_NamedElement, gen_simTL4J_statements_LocalVariableStatement_Statement, gen_simTL4J_statements_TryBlock_statements_Statement, gen_simTL4J_statements_TryBlock_statements_StatementListContainer, gen_simTL4J_statements_WhileLoop_statements_Statement, gen_simTL4J_statements_WhileLoop_statements_StatementContainer, gen_simTL4J_statements_NormalSwitchCase_statements_SwitchCase, gen_simTL4J_statements_NormalSwitchCase_statements_Conditional, gen_simTL4J_statements_Return_Statement, gen_simTL4J_statements_Switch_Statement, gen_simTL4J_statements_SynchronizedBlock_statements_Statement, gen_simTL4J_statements_SynchronizedBlock_statements_StatementListContainer, gen_simTL4J_statements_Throw_Statement, gen_simTL4J_types_NamespaceClassifierReference_types_TypeReference, gen_simTL4J_types_NamespaceClassifierReference_commons_NamespaceAwareElement, gen_simTL4J_types_Type_Commentable, gen_simTL4J_types_TypedElement_Commentable, gen_simTL4J_types_TypeReference_Commentable, gen_simTL4J_types_ClassifierReference_types_TypeReference, gen_simTL4J_types_ClassifierReference_generics_TypeArgumentable, gen_simTL4J_types_PrimitiveType_types_Type, gen_simTL4J_types_PrimitiveType_types_TypeReference, gen_simTL4J_types_Boolean_PrimitiveType, gen_simTL4J_types_Byte_PrimitiveType, gen_simTL4J_types_Char_PrimitiveType, gen_simTL4J_types_Double_PrimitiveType, gen_simTL4J_types_Float_PrimitiveType, gen_simTL4J_types_Int_PrimitiveType, gen_simTL4J_types_Long_PrimitiveType, gen_simTL4J_types_Short_PrimitiveType, gen_simTL4J_types_Void_PrimitiveType, gen_simTL4J_variables_Variable_commons_NamedElement, gen_simTL4J_variables_Variable_types_TypedElement, gen_simTL4J_variables_Variable_arrays_ArrayTypeable, gen_simTL4J_variables_Variable_references_ReferenceableElement, gen_simTL4J_variables_Variable_generics_TypeArgumentable, gen_simTL4J_variables_LocalVariable_variables_Variable, gen_simTL4J_variables_LocalVariable_instantiations_Initializable, gen_simTL4J_variables_LocalVariable_statements_ForLoopInitializer, gen_simTL4J_variables_LocalVariable_modifiers_AnnotableAndModifiable, gen_simTL4J_variables_AdditionalLocalVariable_references_ReferenceableElement, gen_simTL4J_variables_AdditionalLocalVariable_arrays_ArrayTypeable, gen_simTL4J_variables_AdditionalLocalVariable_instantiations_Initializable, gen_simTL4J_simTL_TFor_MemberContainer_simTL_TFor, gen_simTL4J_simTL_TFor_MemberContainer_members_MemberContainer, gen_simTL4J_simTL_TFor_MemberContainer_members_Member, gen_simTL4J_simTL_TFor_StatementListContainer_simTL_TFor, gen_simTL4J_simTL_TFor_StatementListContainer_statements_StatementListContainer, gen_simTL4J_simTL_TFor_StatementListContainer_statements_Statement, gen_simTL4J_simTL_TIf_MemberContainer_simTL_TIf, gen_simTL4J_simTL_TIf_MemberContainer_members_MemberContainer, gen_simTL4J_simTL_TIf_MemberContainer_members_Member, gen_simTL4J_simTL_TIf_StatementListContainer_simTL_TIf, gen_simTL4J_simTL_TIf_StatementListContainer_statements_StatementListContainer, gen_simTL4J_simTL_TIf_StatementListContainer_statements_Statement, gen_simTL4J_simTL_TPlaceholder_PrimaryExpression_simTL_TPlaceholder, gen_simTL4J_simTL_TPlaceholder_PrimaryExpression_expressions_PrimaryExpression, gen_simTL4J_simTL_TUnaryOperator_TAbstractMethodStatement, gen_simTL4J_simTL_TUnaryOperatorNOT_TUnaryOperator, gen_simTL4J_simTL_TMethodStatementImpl_TAbstractMethodStatement},
    metadata=None
)
