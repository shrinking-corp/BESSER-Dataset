...
class petrinet_Node(ABC):
    ...
    def __init__(self, name: str, Node5: "petrinet_Arc" = None, Node7: "petrinet_Arc" = None, source: set["petrinet_Arc"] = None, target: set["petrinet_Arc"] = None, nodes: "petrinet_Petrinet" = None, Node: "petrinet_Petrinet" = None):
        self.name = name
        self.Node5 = Node5
        self.Node7 = Node7
...
class petrinet_Petrinet:
    ...
    def __init__(self, name: str, petrinet: set["petrinet_Arc"] = None, Petrinet: "petrinet_Arc" = None, Petrinet14: "petrinet_Node" = None, petrinet2: set["petrinet_Node"] = None):
        self.name = name
