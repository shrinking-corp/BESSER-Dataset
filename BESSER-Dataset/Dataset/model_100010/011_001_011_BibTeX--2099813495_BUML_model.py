...
# Classes
bibTeX_BibtexEntryTypes = Class(name="bibTeX_BibtexEntryTypes")
...
bibTeX_UnknownField = Class(name="bibTeX_UnknownField")
...
bibTeX_PagesField = Class(name="bibTeX_PagesField")
bibTeX_Book = Class(name="bibTeX_Book")
bibTeX_EObject = Class(name="bibTeX_EObject")
bibTeX_IsbnField = Class(name="bibTeX_IsbnField")
bibTeX_UnknownType = Class(name="bibTeX_UnknownType")
bibTeX_AddressField = Class(name="bibTeX_AddressField")
bibTeX_EditionField = Class(name="bibTeX_EditionField")
AuthorField = Class(name="AuthorField")
bibTeX_Fullname = Class(name="bibTeX_Fullname")
bibTeX_UnknownValue = Class(name="bibTeX_UnknownValue")
...
bibTeX_Fullname.attributes={bibTeX_Fullname_lastname, bibTeX_Fullname_firstname}
...
domain_model = DomainModel(
    name="bibTeX",
    types={bibTeX_BibtexEntryTypes, bibTeX_Model, bibTeX_NoteField, bibTeX_CiteKey, bibTeX_TitleField, bibTeX_YearField, bibTeX_MonthField, bibTeX_AuthorField, bibTeX_UnknownField, bibTeX_Article, BibtexEntryTypes, bibTeX_NumberField, bibTeX_JournalField, bibTeX_VolumeField, bibTeX_PublisherField, bibTeX_SeriesField, bibTeX_PagesField, bibTeX_Book, bibTeX_EObject, bibTeX_IsbnField, bibTeX_UnknownType, bibTeX_AddressField, bibTeX_EditionField, AuthorField, bibTeX_Fullname, bibTeX_UnknownValue, bibTeX_Authors, bibTeX_EditorField},
    associations={BibtexEntries0, key1, title3, year5, month7, note9, unknowns11, number18, author13, journal14, volume16, author_editor22, publisher23, volume_number25, series28, pages20, isbn34, address30, edition32, names40, type36, value38},
    generalizations={gen_bibTeX_Article_BibtexEntryTypes, gen_bibTeX_Book_BibtexEntryTypes, gen_bibTeX_Authors_AuthorField},
    metadata=None
)
