...
class adaptiveSystem_Condition(Node):
    ...
    def __init__(self, token: int, marked: bool, maximal: bool, minimal: bool, adaptiveSystem_Condition: "adaptiveSystem_PreNet" = None, adaptiveSystem_Condition14: "adaptiveSystem_AdaptiveProcess" = None, postConditions: set["adaptiveSystem_Event"] = None, preConditions: set["adaptiveSystem_Event"] = None, source: set["adaptiveSystem_ArcToEvent"] = None, Condition: "adaptiveSystem_Event" = None, Condition22: "adaptiveSystem_Event" = None, Condition30: "adaptiveSystem_ArcToEvent" = None, Condition38: "adaptiveSystem_ArcToCondition" = None, destination: set["adaptiveSystem_ArcToCondition"] = None):
        self.token = token
        self.marked = marked
