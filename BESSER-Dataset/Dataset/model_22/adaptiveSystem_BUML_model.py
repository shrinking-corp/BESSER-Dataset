...
adaptiveSystem_Oclet.attributes={adaptiveSystem_Oclet_quantor, adaptiveSystem_Oclet_wellFormed, adaptiveSystem_Oclet_orientation, adaptiveSystem_Oclet_name}
...
adaptiveSystem_Node.attributes={adaptiveSystem_Node_disabledByAntiOclet, adaptiveSystem_Node_disabledByConflict, adaptiveSystem_Node_name, adaptiveSystem_Node_temp, adaptiveSystem_Node_abstract}
...
adaptiveSystem_Condition.attributes={adaptiveSystem_Condition_token, adaptiveSystem_Condition_minimal, adaptiveSystem_Condition_marked, adaptiveSystem_Condition_maximal}
...
domain_model = DomainModel(
    name="adaptiveSystem",
    types={adaptiveSystem_AdaptiveSystem, adaptiveSystem_Oclet, adaptiveSystem_AdaptiveProcess, adaptiveSystem_OccurrenceNet, adaptiveSystem_Node, adaptiveSystem_Arc, OccurrenceNet, adaptiveSystem_Condition, Node, adaptiveSystem_Event, adaptiveSystem_PreNet, adaptiveSystem_DoNet, adaptiveSystem_ArcToEvent, Arc, adaptiveSystem_ArcToCondition, Orientation, Quantor, Temp},
    associations={oclets0, adaptiveProcess1, nodes7, arcs8, markedConditions10, markedConditions12, preEvents15, postEvents16, preNet3, doNet5, outgoing19, preConditions20, postConditions21, incoming23, outgoing26, source29, destination31, source33, destination36, incoming18},
