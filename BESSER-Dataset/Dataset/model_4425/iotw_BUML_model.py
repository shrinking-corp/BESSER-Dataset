...
# Classes
iotw_Control = Class(name="iotw_Control", is_abstract=True)
iotw_IOControl = Class(name="iotw_IOControl", is_abstract=True)
Control = Class(name="Control")
iotw_DataExplorer = Class(name="iotw_DataExplorer")
iotw_Mainboard = Class(name="iotw_Mainboard", is_abstract=True)
iotw_ConnectivityControl = Class(name="iotw_ConnectivityControl", is_abstract=True)
iotw_StateControl = Class(name="iotw_StateControl", is_abstract=True)
iotw_Connection = Class(name="iotw_Connection")
iotw_DataControl = Class(name="iotw_DataControl", is_abstract=True)
iotw_StateSchema = Class(name="iotw_StateSchema")
iotw_ArduinoUNOR3 = Class(name="iotw_ArduinoUNOR3")
Mainboard = Class(name="Mainboard")
iotw_InputControl = Class(name="iotw_InputControl", is_abstract=True)
IOControl = Class(name="IOControl")
iotw_OutputControl = Class(name="iotw_OutputControl", is_abstract=True)
...
iotw_I2CLCD2004 = Class(name="iotw_I2CLCD2004")
...
iotw_Control.attributes={iotw_Control_id, iotw_Control_name}
...
iotw_IOControl_m_modifyPin: Method = Method(name="modifyPin", parameters={Parameter(name='iotw_pin', type=StringType)})
iotw_IOControl.attributes={iotw_IOControl_constraints}
iotw_IOControl.methods={iotw_IOControl_m_getPins, iotw_IOControl_m_getPinConnecteds, iotw_IOControl_m_modifyPin}
...
iotw_Mainboard_m_addControl: Method = Method(name="addControl", parameters={Parameter(name='iotw_control', type=StringType)})
iotw_Mainboard_m_removeControl: Method = Method(name="removeControl", parameters={Parameter(name='iotw_control', type=StringType)})
iotw_Mainboard_m_addConnectivity: Method = Method(name="addConnectivity", parameters={Parameter(name='iotw_control', type=StringType)})
iotw_Mainboard_m_removeConnectivity: Method = Method(name="removeConnectivity", parameters={Parameter(name='iotw_control', type=StringType)})
...
iotw_Mainboard.methods={iotw_Mainboard_m_getPinConnecteds, iotw_Mainboard_m_addConnectivity, iotw_Mainboard_m_addControl, iotw_Mainboard_m_removeConnectivity, iotw_Mainboard_m_modifyPin, iotw_Mainboard_m_findPin, iotw_Mainboard_m_removeControl, iotw_Mainboard_m_getPins}
...
iotw_ConnectivityControl_m_modifyPin: Method = Method(name="modifyPin", parameters={Parameter(name='iotw_pin', type=StringType)})
iotw_ConnectivityControl.attributes={iotw_ConnectivityControl_constraints}
iotw_ConnectivityControl.methods={iotw_ConnectivityControl_m_getPins, iotw_ConnectivityControl_m_modifyPin, iotw_ConnectivityControl_m_getPinConnecteds}
...
iotw_Connection.attributes={iotw_Connection_bendpoints, iotw_Connection_kind, iotw_Connection_label, iotw_Connection_routerKind}
...
iotw_DataControl.attributes={iotw_DataControl_location, iotw_DataControl_type, iotw_DataControl_constraints}
...
iotw_ArduinoUNOR3.attributes={iotw_ArduinoUNOR3_pin6, iotw_ArduinoUNOR3_pinA0, iotw_ArduinoUNOR3_pin2, iotw_ArduinoUNOR3_pin12, iotw_ArduinoUNOR3_pinA1, iotw_ArduinoUNOR3_pin7, iotw_ArduinoUNOR3_pin0, iotw_ArduinoUNOR3_pin13, iotw_ArduinoUNOR3_pinA3, iotw_ArduinoUNOR3_pin4, iotw_ArduinoUNOR3_pinA2, iotw_ArduinoUNOR3_pin11, iotw_ArduinoUNOR3_pin9, iotw_ArduinoUNOR3_pin8, iotw_ArduinoUNOR3_pin5, iotw_ArduinoUNOR3_pin1, iotw_ArduinoUNOR3_pin3, iotw_ArduinoUNOR3_pin10, iotw_ArduinoUNOR3_pinA4, iotw_ArduinoUNOR3_pinA5}
...
iotw_Keypad4x4.attributes={iotw_Keypad4x4_nameButton9, iotw_Keypad4x4_nameButtonB, iotw_Keypad4x4_nameButtonD, iotw_Keypad4x4_nameButtonC, iotw_Keypad4x4_pin6, iotw_Keypad4x4_nameButton0, iotw_Keypad4x4_nameButton4, iotw_Keypad4x4_pin7, iotw_Keypad4x4_nameButton5, iotw_Keypad4x4_nameButtonA, iotw_Keypad4x4_pin5, iotw_Keypad4x4_pin2, iotw_Keypad4x4_nameButtonAsterisk, iotw_Keypad4x4_nameButton8, iotw_Keypad4x4_rows, iotw_Keypad4x4_nameButton3, iotw_Keypad4x4_nameButton2, iotw_Keypad4x4_cols, iotw_Keypad4x4_pin3, iotw_Keypad4x4_keys, iotw_Keypad4x4_nameButtonHash, iotw_Keypad4x4_nameButton6, iotw_Keypad4x4_pin1, iotw_Keypad4x4_pin4, iotw_Keypad4x4_nameButton7, iotw_Keypad4x4_nameButton1, iotw_Keypad4x4_pin8}
...
iotw_Buzzer.attributes={iotw_Buzzer_pin2, iotw_Buzzer_pin1}
...
iotw_I2CLCD2004.attributes={iotw_I2CLCD2004_pinSDA, iotw_I2CLCD2004_pinVcc, iotw_I2CLCD2004_pinSCL, iotw_I2CLCD2004_pinGND}
...
iotw_BluetoothHC06.attributes={iotw_BluetoothHC06_pinVCC, iotw_BluetoothHC06_pinTXD, iotw_BluetoothHC06_pinGND, iotw_BluetoothHC06_pinRXD}
...
iotw_WifiESP8266.attributes={iotw_WifiESP8266_pinGND, iotw_WifiESP8266_Host, iotw_WifiESP8266_SSID, iotw_WifiESP8266_pinVcc, iotw_WifiESP8266_pinCHPD, iotw_WifiESP8266_Port, iotw_WifiESP8266_Password, iotw_WifiESP8266_pinTX, iotw_WifiESP8266_pinRX}
...
domain_model = DomainModel(
    name="iotw",
    types={iotw_Control, iotw_IOControl, Control, iotw_DataExplorer, iotw_Mainboard, iotw_ConnectivityControl, iotw_StateControl, iotw_Connection, iotw_DataControl, iotw_StateSchema, iotw_ArduinoUNOR3, Mainboard, iotw_InputControl, IOControl, iotw_OutputControl, iotw_Keypad4x4, InputControl, iotw_Button, iotw_Buzzer, iotw_StateFrame, StateControl, iotw_Decision, iotw_LED, OutputControl, iotw_I2CLCD2004, iotw_BluetoothHC06, ConnectivityControl, iotw_WifiESP8266, iotw_StartPoint, iotw_EndPoint, ConnectionKind, RouterKind, TypeData},
    associations={dataExplorer7, datas8, mainboard0, mainboard1, incomings3, outgoings4, controls9, connectivities10, controls12, connnections14, source15, target17, stateSchema20},
    generalizations={gen_iotw_IOControl_Control, gen_iotw_ConnectivityControl_Control, gen_iotw_StateControl_Control, gen_iotw_DataControl_Control, gen_iotw_ArduinoUNOR3_Mainboard, gen_iotw_InputControl_IOControl, gen_iotw_OutputControl_IOControl, gen_iotw_Keypad4x4_InputControl, gen_iotw_Button_InputControl, gen_iotw_Buzzer_OutputControl, gen_iotw_StateFrame_StateControl, gen_iotw_Decision_StateControl, gen_iotw_LED_OutputControl, gen_iotw_I2CLCD2004_OutputControl, gen_iotw_BluetoothHC06_ConnectivityControl, gen_iotw_WifiESP8266_ConnectivityControl, gen_iotw_StartPoint_StateControl, gen_iotw_EndPoint_StateControl},
    metadata=None
)
