...
# Classes
RobotWork_Instruction = Class(name="RobotWork_Instruction", is_abstract=True)
RobotWork_Action = Class(name="RobotWork_Action", is_abstract=True)
Instruction = Class(name="Instruction")
RobotWork_Chrography = Class(name="RobotWork_Chrography")
RobotWork_Grab = Class(name="RobotWork_Grab")
Action = Class(name="Action")
RobotWork_Release = Class(name="RobotWork_Release")
RobotWork_Rotate = Class(name="RobotWork_Rotate")
RobotWork_GoForward = Class(name="RobotWork_GoForward")
...
RobotWork_Rotate.attributes={RobotWork_Rotate_degrees, RobotWork_Rotate_random}
