...
# Classes
sample_Value = Class(name="sample_Value")
sample_PrimaryObject = Class(name="sample_PrimaryObject")
sample_TargetObject = Class(name="sample_TargetObject")
sample_ETypes = Class(name="sample_ETypes")
sample_TypeMap = Class(name="sample_TypeMap")
sample_TypeMapReference = Class(name="sample_TypeMapReference")
sample_StringMap = Class(name="sample_StringMap")
sample_DataTypeMap = Class(name="sample_DataTypeMap")
sample_Type = Class(name="sample_Type")
sample_Tree = Class(name="sample_Tree")
sample_PhysicalNode = Class(name="sample_PhysicalNode")
Node = Class(name="Node")
sample_RemoteNode = Class(name="sample_RemoteNode")
PhysicalNode = Class(name="PhysicalNode")
sample_LocalNode = Class(name="sample_LocalNode")
sample_VirtualNode = Class(name="sample_VirtualNode")
sample_Node = Class(name="sample_Node", is_abstract=True)
sample_Comment = Class(name="sample_Comment")
...
sample_PrimaryObject.attributes={sample_PrimaryObject_featureMapAttributeType1, sample_PrimaryObject_featureMapAttributeCollection, sample_PrimaryObject_unsettableAttribute, sample_PrimaryObject_kind, sample_PrimaryObject_unsettableAttributeWithDefault, sample_PrimaryObject_featureMapReferenceCollection, sample_PrimaryObject_name, sample_PrimaryObject_id, sample_PrimaryObject_featureMapAttributeType2}
...
sample_TargetObject.attributes={sample_TargetObject_singleAttribute, sample_TargetObject_name, sample_TargetObject_manyAttributes}
...
sample_DataTypeMap.attributes={sample_DataTypeMap_value, sample_DataTypeMap_key}
...
domain_model = DomainModel(
    name="sample",
    types={sample_Value, sample_PrimaryObject, sample_TargetObject, sample_ETypes, sample_TypeMap, sample_TypeMapReference, sample_StringMap, sample_DataTypeMap, sample_Type, sample_Tree, sample_PhysicalNode, Node, sample_RemoteNode, PhysicalNode, sample_LocalNode, sample_VirtualNode, sample_Node, sample_Comment, SomeKind},
    associations={key7, value9, key11, value13, values0, valuesWithReferences1, stringValues3, dataTypeValues5, singleReference36, manyReferences39, unsettableReference15, singleReference18, manyReferences21, singleContainmentReference24, manyContainmentReferences27, featureMapReferenceType130, featureMapReferenceType233, nodes42, parent44, children46, manyReference48, children50, childrenProxies54, parent57, parentProxy61, tree63, manyContainmentReference65},
