...
class sample_Tree:
    ...
    def __init__(self, name: str, tree: set["sample_Node"] = None, Tree: "sample_Tree" = None, children: "sample_Tree" = None, Tree47: "sample_Tree" = None, parent: set["sample_Tree"] = None, sample_Tree: set["sample_Comment"] = None, Tree64: "sample_Node" = None):
        self.name = name
...
class sample_StringMap:
    ...
    def __init__(self, key: str, value: str, sample_StringMap: "sample_ETypes" = None):
        self.key = key
        self.value = value
...
class sample_PrimaryObject:
    ...
    def __init__(self, id: str, name: str, kind: str, featureMapAttributeCollection: str, featureMapAttributeType1: str, featureMapAttributeType2: str, unsettableAttribute: str, unsettableAttributeWithDefault: str, featureMapReferenceCollection: str, sample_PrimaryObject: "sample_TypeMapReference" = None, sample_PrimaryObject38: "sample_TargetObject" = None, sample_PrimaryObject41: "sample_TargetObject" = None, sample_PrimaryObject16: "sample_TargetObject" = None, sample_PrimaryObject19: "sample_TargetObject" = None, sample_PrimaryObject22: set["sample_TargetObject"] = None, sample_PrimaryObject25: "sample_TargetObject" = None, sample_PrimaryObject28: set["sample_TargetObject"] = None, sample_PrimaryObject31: set["sample_TargetObject"] = None, sample_PrimaryObject34: set["sample_TargetObject"] = None):
        self.id = id
        self.name = name
        self.kind = kind
    ...
    @property
    def featureMapAttributeType2(self):
    ...
    @property
    def featureMapReferenceCollection(self):
    ...
    @property
    def unsettableAttributeWithDefault(self):
    ...
    @property
    def featureMapAttributeType1(self):
    ...
    @property
    def featureMapAttributeCollection(self):
...
class sample_Node(ABC):
    ...
    def __init__(self, label: str, Node: "sample_Tree" = None, Node52: "sample_Node" = None, parent51: set["sample_Node"] = None, Node55: "sample_Node" = None, parentProxy: set["sample_Node"] = None, Node59: "sample_Node" = None, children58: "sample_Node" = None, Node62: "sample_Node" = None, childrenProxies: "sample_Node" = None, nodes: "sample_Tree" = None, sample_Node: set["sample_Comment"] = None):
        self.label = label
        self.Node = Node
        self.Node52 = Node52
