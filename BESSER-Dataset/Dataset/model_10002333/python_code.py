...
class Order:
    ...
    def __init__(self, total: float, status: OrderStatus, number: int, ordered: date, shipped: bool, shipTo: str, items14: set["LineItem"] = None, account17: "Account" = None, payment19: "Payment" = None):
        self.total = total
        self.status = status
        self.number = number
...
class Customer:
    ...
    def __init__(self, phone: str, email: str, address: str, webUser5: "WebUser" = None, account6: "Account" = None):
        self.phone = phone
        self.email = email
