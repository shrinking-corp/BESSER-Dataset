...
# Classes
jkind_Constant = Class(name="jkind_Constant")
jkind_Function = Class(name="jkind_Function")
jkind_Node = Class(name="jkind_Node")
jkind_EnumValue = Class(name="jkind_EnumValue")
IdRef = Class(name="IdRef")
jkind_Type = Class(name="jkind_Type")
jkind_Field = Class(name="jkind_Field")
jkind_Expr = Class(name="jkind_Expr")
Callable = Class(name="Callable")
jkind_VariableGroup = Class(name="jkind_VariableGroup")
jkind_Equation = Class(name="jkind_Equation")
jkind_Assertion = Class(name="jkind_Assertion")
jkind_Property = Class(name="jkind_Property")
jkind_Ivc = Class(name="jkind_Ivc")
jkind_File = Class(name="jkind_File")
jkind_TypeDef = Class(name="jkind_TypeDef")
jkind_Variable = Class(name="jkind_Variable")
jkind_CallExpr = Class(name="jkind_CallExpr")
Expr = Class(name="Expr")
jkind_Callable = Class(name="jkind_Callable")
jkind_IdRef = Class(name="jkind_IdRef")
jkind_RealizabilityInputs = Class(name="jkind_RealizabilityInputs")
jkind_RecordType = Class(name="jkind_RecordType")
jkind_EnumType = Class(name="jkind_EnumType")
jkind_ArrayType = Class(name="jkind_ArrayType")
Type = Class(name="Type")
jkind_IntType = Class(name="jkind_IntType")
jkind_BoolType = Class(name="jkind_BoolType")
jkind_RealType = Class(name="jkind_RealType")
jkind_SubrangeType = Class(name="jkind_SubrangeType")
jkind_UserType = Class(name="jkind_UserType")
jkind_BinaryExpr = Class(name="jkind_BinaryExpr")
jkind_UnaryExpr = Class(name="jkind_UnaryExpr")
jkind_AbbreviationType = Class(name="jkind_AbbreviationType")
TypeDef = Class(name="TypeDef")
jkind_RecordAccessExpr = Class(name="jkind_RecordAccessExpr")
jkind_RecordUpdateExpr = Class(name="jkind_RecordUpdateExpr")
jkind_ArrayAccessExpr = Class(name="jkind_ArrayAccessExpr")
jkind_ArrayUpdateExpr = Class(name="jkind_ArrayUpdateExpr")
jkind_IdExpr = Class(name="jkind_IdExpr")
jkind_IntExpr = Class(name="jkind_IntExpr")
jkind_RealExpr = Class(name="jkind_RealExpr")
jkind_BoolExpr = Class(name="jkind_BoolExpr")
jkind_CastExpr = Class(name="jkind_CastExpr")
jkind_CondactExpr = Class(name="jkind_CondactExpr")
jkind_ArrayExpr = Class(name="jkind_ArrayExpr")
jkind_RecordExpr = Class(name="jkind_RecordExpr")
jkind_TupleExpr = Class(name="jkind_TupleExpr")
jkind_IfThenElseExpr = Class(name="jkind_IfThenElseExpr")
...
def_65: BinaryAssociation = BinaryAssociation(
    name="def_65",
    ends={
...
else_103: BinaryAssociation = BinaryAssociation(
    name="else_103",
    ends={
...
domain_model = DomainModel(
    name="jkind",
    types={jkind_Constant, jkind_Function, jkind_Node, jkind_EnumValue, IdRef, jkind_Type, jkind_Field, jkind_Expr, Callable, jkind_VariableGroup, jkind_Equation, jkind_Assertion, jkind_Property, jkind_Ivc, jkind_File, jkind_TypeDef, jkind_Variable, jkind_CallExpr, Expr, jkind_Callable, jkind_IdRef, jkind_RealizabilityInputs, jkind_RecordType, jkind_EnumType, jkind_ArrayType, Type, jkind_IntType, jkind_BoolType, jkind_RealType, jkind_SubrangeType, jkind_UserType, jkind_BinaryExpr, jkind_UnaryExpr, jkind_AbbreviationType, TypeDef, jkind_RecordAccessExpr, jkind_RecordUpdateExpr, jkind_ArrayAccessExpr, jkind_ArrayUpdateExpr, jkind_IdExpr, jkind_IntExpr, jkind_RealExpr, jkind_BoolExpr, jkind_CastExpr, jkind_CondactExpr, jkind_ArrayExpr, jkind_RecordExpr, jkind_TupleExpr, jkind_IfThenElseExpr},
    associations={typedefs0, constants1, functions3, nodes5, type7, expr9, locals11, equations13, assertions15, properties17, ivc19, variables23, type25, lhs28, rhs31, ref34, ids37, ids40, expr43, callable46, args47, inputs50, outputs53, realizabilityInputs21, fields58, types59, values62, base63, def_65, left67, right69, type56, record74, field76, record79, field81, value84, array87, index89, access92, value94, id97, expr72, then100, else_103, expr106, clock108, call110, args113, exprs116, type118, fields120, exprs123, exprs126, cond98},
    generalizations={gen_jkind_EnumValue_IdRef, gen_jkind_Constant_IdRef, gen_jkind_Function_Callable, gen_jkind_Node_Callable, gen_jkind_Variable_IdRef, gen_jkind_CallExpr_Expr, gen_jkind_RecordType_TypeDef, gen_jkind_EnumType_TypeDef, gen_jkind_ArrayType_Type, gen_jkind_IntType_Type, gen_jkind_BoolType_Type, gen_jkind_RealType_Type, gen_jkind_SubrangeType_Type, gen_jkind_UserType_Type, gen_jkind_BinaryExpr_Expr, gen_jkind_AbbreviationType_TypeDef, gen_jkind_RecordAccessExpr_Expr, gen_jkind_RecordUpdateExpr_Expr, gen_jkind_ArrayAccessExpr_Expr, gen_jkind_ArrayUpdateExpr_Expr, gen_jkind_IdExpr_Expr, gen_jkind_IntExpr_Expr, gen_jkind_RealExpr_Expr, gen_jkind_BoolExpr_Expr, gen_jkind_UnaryExpr_Expr, gen_jkind_CastExpr_Expr, gen_jkind_CondactExpr_Expr, gen_jkind_ArrayExpr_Expr, gen_jkind_RecordExpr_Expr, gen_jkind_TupleExpr_Expr, gen_jkind_IfThenElseExpr_Expr},
    metadata=None
)
