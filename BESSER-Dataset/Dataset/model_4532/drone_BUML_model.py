...
# Classes
drone_Mission = Class(name="drone_Mission")
NamedElement = Class(name="NamedElement")
drone_Task = Class(name="drone_Task")
drone_TaskDescriptor = Class(name="drone_TaskDescriptor")
drone_AreaObject = Class(name="drone_AreaObject")
drone_Property = Class(name="drone_Property")
drone_Position = Class(name="drone_Position")
drone_Coordinate = Class(name="drone_Coordinate")
drone_Size = Class(name="drone_Size")
drone_PropertyValue = Class(name="drone_PropertyValue", is_abstract=True)
drone_PropertyKey = Class(name="drone_PropertyKey")
drone_Robot = Class(name="drone_Robot")
drone_Battery = Class(name="drone_Battery")
drone_Equipment = Class(name="drone_Equipment")
drone_MeasureValue = Class(name="drone_MeasureValue")
drone_Capability = Class(name="drone_Capability")
drone_CapabilityProperties = Class(name="drone_CapabilityProperties")
drone_StringValue = Class(name="drone_StringValue")
PropertyValue = Class(name="PropertyValue")
drone_NamedElement = Class(name="drone_NamedElement", is_abstract=True)
drone_MeasureDimension = Class(name="drone_MeasureDimension")
drone_MeasureConversion = Class(name="drone_MeasureConversion")
drone_RobotMissionContainer = Class(name="drone_RobotMissionContainer")
drone_PropertyKeyContainer = Class(name="drone_PropertyKeyContainer")
drone_EObject = Class(name="drone_EObject")
...
drone_Coordinate.attributes={drone_Coordinate_altitude, drone_Coordinate_longitude, drone_Coordinate_latitude}
...
domain_model = DomainModel(
    name="drone",
    types={drone_Mission, NamedElement, drone_Task, drone_TaskDescriptor, drone_AreaObject, drone_Property, drone_Position, drone_Coordinate, drone_Size, drone_PropertyValue, drone_PropertyKey, drone_Robot, drone_Battery, drone_Equipment, drone_MeasureValue, drone_Capability, drone_CapabilityProperties, drone_StringValue, PropertyValue, drone_NamedElement, drone_MeasureDimension, drone_MeasureConversion, drone_RobotMissionContainer, drone_PropertyKeyContainer, drone_EObject},
    associations={tasks0, mission1, descriptor2, targets3, properties4, task6, coordinates8, properties9, positions12, size15, properties17, value20, key22, position24, size26, batteries29, equipments31, tasks33, properties35, communicationRange38, weight40, mission43, capabilities45, capabilityProperties47, width49, height52, length55, capacity58, voltage61, rechargeTime64, properties67, properties70, facilitate73, dimension76, dimension78, conversions80, missions83, robots85, measureDimensions88, areaObjects91, capabilities94, propertyKeyContainer97, temporalElements99, keys101, properties104, capability107},
    generalizations={gen_drone_Mission_NamedElement, gen_drone_Task_NamedElement, gen_drone_AreaObject_NamedElement, gen_drone_Robot_NamedElement, gen_drone_StringValue_PropertyValue, gen_drone_Equipment_NamedElement, gen_drone_MeasureValue_PropertyValue, gen_drone_MeasureDimension_NamedElement, gen_drone_PropertyKeyContainer_NamedElement, gen_drone_PropertyKey_NamedElement, gen_drone_Capability_NamedElement},
    metadata=None
)
