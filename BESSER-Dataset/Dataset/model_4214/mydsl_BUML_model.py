...
# Classes
mydsl_MyAbstractElement = Class(name="mydsl_MyAbstractElement", is_abstract=True)
mydsl_MyElement = Class(name="mydsl_MyElement")
MyAbstractElement = Class(name="MyAbstractElement")
mydsl_MyReference = Class(name="mydsl_MyReference")
mydsl_MyModel = Class(name="mydsl_MyModel")
...
domain_model = DomainModel(
    name="mydsl",
    types={mydsl_MyAbstractElement, mydsl_MyElement, MyAbstractElement, mydsl_MyReference, mydsl_MyModel},
