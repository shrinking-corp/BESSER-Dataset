...
class lts_Transition:
    ...
    def __init__(self, label: str, Transition: "lts_State" = None, lts_Transition: "lts_LTS" = None, incoming: "lts_State" = None, Transition12: "lts_State" = None, outgoing: "lts_State" = None):
        self.label = label
...
class lts_LTS:
    ...
    def __init__(self, name: str, lts_LTS: set["lts_Transition"] = None, lts_LTS2: "lts_InitialState" = None, lts_LTS4: set["lts_IntermediateState"] = None, lts_LTS6: "lts_FinalState" = None):
        self.name = name
...
class lts_State:
    ...
    def __init__(self, Id: str, target: set["lts_Transition"] = None, State: "lts_Transition" = None, source: set["lts_Transition"] = None, State9: "lts_Transition" = None):
        self.Id = Id
