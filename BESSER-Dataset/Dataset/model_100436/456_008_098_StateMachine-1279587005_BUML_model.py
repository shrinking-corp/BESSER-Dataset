...
# Classes
stateMachine_Properties = Class(name="stateMachine_Properties")
stateMachine_StateMachine = Class(name="stateMachine_StateMachine")
stateMachine_State = Class(name="stateMachine_State")
stateMachine_Transition = Class(name="stateMachine_Transition", is_abstract=True)
stateMachine_IvrAction = Class(name="stateMachine_IvrAction", is_abstract=True)
Action = Class(name="Action")
stateMachine_HangUp = Class(name="stateMachine_HangUp")
IvrAction = Class(name="IvrAction")
stateMachine_NewCall = Class(name="stateMachine_NewCall")
...
stateMachine_CompositeState = Class(name="stateMachine_CompositeState")
stateMachine_Action = Class(name="stateMachine_Action", is_abstract=True)
stateMachine_SMS = Class(name="stateMachine_SMS")
stateMachine_Play = Class(name="stateMachine_Play")
stateMachine_PlayCollect = Class(name="stateMachine_PlayCollect")
Play = Class(name="Play")
stateMachine_PlayRecord = Class(name="stateMachine_PlayRecord")
stateMachine_RemoveRecord = Class(name="stateMachine_RemoveRecord")
stateMachine_Terminate = Class(name="stateMachine_Terminate")
stateMachine_SendSms = Class(name="stateMachine_SendSms")
stateMachine_Bye = Class(name="stateMachine_Bye")
IVREvent = Class(name="IVREvent")
stateMachine_Call = Class(name="stateMachine_Call")
stateMachine_SetTimer = Class(name="stateMachine_SetTimer")
stateMachine_IVREvent = Class(name="stateMachine_IVREvent", is_abstract=True)
Transition = Class(name="Transition")
stateMachine_NoneEvent = Class(name="stateMachine_NoneEvent")
stateMachine_SMSReceived = Class(name="stateMachine_SMSReceived")
stateMachine_PickUp = Class(name="stateMachine_PickUp")
stateMachine_Played = Class(name="stateMachine_Played")
stateMachine_Recorderd = Class(name="stateMachine_Recorderd")
stateMachine_Terminated = Class(name="stateMachine_Terminated")
stateMachine_Init = Class(name="stateMachine_Init")
stateMachine_Cancel = Class(name="stateMachine_Cancel")
stateMachine_CollectTimeout = Class(name="stateMachine_CollectTimeout")
stateMachine_Managed = Class(name="stateMachine_Managed")
stateMachine_Key = Class(name="stateMachine_Key")
Branch = Class(name="Branch")
stateMachine_Otherwise = Class(name="stateMachine_Otherwise")
stateMachine_Timer = Class(name="stateMachine_Timer")
stateMachine_Collected = Class(name="stateMachine_Collected")
stateMachine_Branch = Class(name="stateMachine_Branch", is_abstract=True)
...
stateMachine_Properties.attributes={stateMachine_Properties_setupConference, stateMachine_Properties_mediaPort, stateMachine_Properties_mediaURI, stateMachine_Properties_scscfHost, stateMachine_Properties_applicationServerPort, stateMachine_Properties_scscfPort, stateMachine_Properties_mediaToAddr, stateMachine_Properties_applicationAddress, stateMachine_Properties_applicationServerHost, stateMachine_Properties_scscfProtocol, stateMachine_Properties_recordPath, stateMachine_Properties_mediaProtocol, stateMachine_Properties_mediaHost, stateMachine_Properties_scscfUser, stateMachine_Properties_applicationServerProtocol, stateMachine_Properties_mediaFromAddr}
...
# stateMachine_HangUp class attributes and methods

# IvrAction class attributes and methods

# stateMachine_NewCall class attributes and methods
stateMachine_NewCall_from_: Property = Property(name="from_", type=StringType)
stateMachine_NewCall_to: Property = Property(name="to", type=StringType)
stateMachine_NewCall.attributes={stateMachine_NewCall_from_, stateMachine_NewCall_to}
...
stateMachine_SMS_from_: Property = Property(name="from_", type=StringType)
...
stateMachine_SMS.attributes={stateMachine_SMS_to, stateMachine_SMS_from_, stateMachine_SMS_text}
...
# stateMachine_PlayCollect class attributes and methods

# Play class attributes and methods

# stateMachine_PlayRecord class attributes and methods

# stateMachine_RemoveRecord class attributes and methods
stateMachine_RemoveRecord_recordId: Property = Property(name="recordId", type=StringType)
stateMachine_RemoveRecord.attributes={stateMachine_RemoveRecord_recordId}
...
stateMachine_Call_from_: Property = Property(name="from_", type=StringType)
stateMachine_Call_to: Property = Property(name="to", type=StringType)
stateMachine_Call.attributes={stateMachine_Call_from_, stateMachine_Call_to}
...
stateMachine_Managed.attributes={stateMachine_Managed_success, stateMachine_Managed_code}
...
gen_stateMachine_HangUp_IvrAction = Generalization(general=IvrAction, specific=stateMachine_HangUp)
gen_stateMachine_NewCall_IvrAction = Generalization(general=IvrAction, specific=stateMachine_NewCall)
...
gen_stateMachine_PlayCollect_Play = Generalization(general=Play, specific=stateMachine_PlayCollect)
gen_stateMachine_PlayRecord_Play = Generalization(general=Play, specific=stateMachine_PlayRecord)
gen_stateMachine_RemoveRecord_IvrAction = Generalization(general=IvrAction, specific=stateMachine_RemoveRecord)
...
domain_model = DomainModel(
    name="stateMachine",
    types={stateMachine_Properties, stateMachine_StateMachine, stateMachine_State, stateMachine_Transition, stateMachine_IvrAction, Action, stateMachine_HangUp, IvrAction, stateMachine_NewCall, stateMachine_InitialState, State, stateMachine_FinalState, stateMachine_CompositeState, stateMachine_Action, stateMachine_SMS, stateMachine_Play, stateMachine_PlayCollect, Play, stateMachine_PlayRecord, stateMachine_RemoveRecord, stateMachine_Terminate, stateMachine_SendSms, stateMachine_Bye, IVREvent, stateMachine_Call, stateMachine_SetTimer, stateMachine_IVREvent, Transition, stateMachine_NoneEvent, stateMachine_SMSReceived, stateMachine_PickUp, stateMachine_Played, stateMachine_Recorderd, stateMachine_Terminated, stateMachine_Init, stateMachine_Cancel, stateMachine_CollectTimeout, stateMachine_Managed, stateMachine_Key, Branch, stateMachine_Otherwise, stateMachine_Timer, stateMachine_Collected, stateMachine_Branch},
    associations={properties1, states0, outs3, children5, parent7, sm9, sms11, action12, src13, defaultTar15, sms18, branches20, out21, action24},
    generalizations={gen_stateMachine_IvrAction_Action, gen_stateMachine_HangUp_IvrAction, gen_stateMachine_NewCall_IvrAction, gen_stateMachine_InitialState_State, gen_stateMachine_FinalState_State, gen_stateMachine_CompositeState_State, gen_stateMachine_Play_IvrAction, gen_stateMachine_PlayCollect_Play, gen_stateMachine_PlayRecord_Play, gen_stateMachine_RemoveRecord_IvrAction, gen_stateMachine_Terminate_IvrAction, gen_stateMachine_IVREvent_Transition, gen_stateMachine_SendSms_Action, gen_stateMachine_Bye_IVREvent, gen_stateMachine_Call_IVREvent, gen_stateMachine_SetTimer_Action, gen_stateMachine_NoneEvent_Transition, gen_stateMachine_SMSReceived_Transition, gen_stateMachine_PickUp_IVREvent, gen_stateMachine_Played_IVREvent, gen_stateMachine_Recorderd_IVREvent, gen_stateMachine_Terminated_IVREvent, gen_stateMachine_Init_IVREvent, gen_stateMachine_Cancel_IVREvent, gen_stateMachine_CollectTimeout_IVREvent, gen_stateMachine_Managed_IVREvent, gen_stateMachine_Key_Branch, gen_stateMachine_Otherwise_Branch, gen_stateMachine_Timer_Transition, gen_stateMachine_Collected_IVREvent},
    metadata=None
)
