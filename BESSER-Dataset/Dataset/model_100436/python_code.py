...
class Play:
    ...
    pass
class stateMachine_PlayRecord(Play):

    pass
class stateMachine_PlayCollect(Play):

    pass
class stateMachine_SMS:

    def __init__(self, from_: str, to: str, text: str, stateMachine_SMS: "stateMachine_SendSms" = None, stateMachine_SMS19: "stateMachine_SMSReceived" = None):
        self.from_ = from_
        self.to = to
        self.text = text
...
class stateMachine_RemoveRecord(IvrAction):
...
class stateMachine_Terminate(IvrAction):
    ...
    pass
class stateMachine_NewCall(IvrAction):
...
class stateMachine_HangUp(IvrAction):
...
class stateMachine_State:
    ...
    def __init__(self, nombre: str, stateMachine_State: "stateMachine_StateMachine" = None, src: set["stateMachine_Transition"] = None, State: "stateMachine_State" = None, parent: set["stateMachine_State"] = None, State8: "stateMachine_State" = None, children: "stateMachine_State" = None, State14: "stateMachine_Transition" = None, stateMachine_State17: "stateMachine_Transition" = None, stateMachine_State23: "stateMachine_Branch" = None):
        self.nombre = nombre
...
class stateMachine_StateMachine:
    ...
    def __init__(self, nombre: str, stateMachine_StateMachine2: "stateMachine_Properties" = None, stateMachine_StateMachine: set["stateMachine_State"] = None, stateMachine_StateMachine10: "stateMachine_CompositeState" = None):
        self.nombre = nombre
...
class stateMachine_Properties:
    ...
    def __init__(self, applicationAddress: str, mediaFromAddr: str, mediaToAddr: str, mediaURI: str, recordPath: str, scscfUser: str, scscfHost: str, scscfPort: int, scscfProtocol: str, applicationServerProtocol: str, applicationServerHost: str, applicationServerPort: int, mediaHost: str, mediaPort: int, mediaProtocol: str, setupConference: bool, stateMachine_Properties: "stateMachine_StateMachine" = None):
    ...
    @property
    def applicationServerPort(self):
    ...
    @property
    def applicationServerProtocol(self):
    ...
    @property
    def applicationServerHost(self):
