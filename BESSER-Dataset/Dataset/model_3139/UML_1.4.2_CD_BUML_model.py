...
# Classes
UML_14_ModelElement = Class(name="UML_14_ModelElement", is_abstract=True)
UML_14_GeneralizableElement = Class(name="UML_14_GeneralizableElement", is_abstract=True)
UML_14_Generalization = Class(name="UML_14_Generalization")
UML_14_Parameter = Class(name="UML_14_Parameter", is_abstract=True)
UML_14_BehavioralFeature = Class(name="UML_14_BehavioralFeature", is_abstract=True)
Element = Class(name="Element")
UML_14_Constraint = Class(name="UML_14_Constraint", is_abstract=True)
UML_14_Comment = Class(name="UML_14_Comment")
UML_14_Dependency = Class(name="UML_14_Dependency")
UML_14_Feature = Class(name="UML_14_Feature", is_abstract=True)
ModelElement = Class(name="ModelElement")
UML_14_Classifier = Class(name="UML_14_Classifier", is_abstract=True)
UML_14_NameSpace = Class(name="UML_14_NameSpace", is_abstract=True)
Feature = Class(name="Feature")
UML_14_Multiplicity = Class(name="UML_14_Multiplicity")
UML_14_MultiplicityRange = Class(name="UML_14_MultiplicityRange")
NameSpace = Class(name="NameSpace")
GeneralizableElement = Class(name="GeneralizableElement")
UML_14_StructuralFeature = Class(name="UML_14_StructuralFeature", is_abstract=True)
UML_14_AssociationEnd = Class(name="UML_14_AssociationEnd")
UML_14_Association = Class(name="UML_14_Association")
UML_14_Operation = Class(name="UML_14_Operation")
BehavioralFeature = Class(name="BehavioralFeature")
UML_14_Method = Class(name="UML_14_Method")
UML_14_Attribute = Class(name="UML_14_Attribute")
StructuralFeature = Class(name="StructuralFeature")
UML_14_Relationship = Class(name="UML_14_Relationship", is_abstract=True)
Relationship = Class(name="Relationship")
UML_14_DataType = Class(name="UML_14_DataType")
UML_14_Primitive = Class(name="UML_14_Primitive")
DataType = Class(name="DataType")
UML_14_Enumeration = Class(name="UML_14_Enumeration")
UML_14_Class = Class(name="UML_14_Class")
Classifier = Class(name="Classifier")
UML_14_EnumerationLiteral = Class(name="UML_14_EnumerationLiteral")
UML_14_AssociationClass = Class(name="UML_14_AssociationClass")
Class_ = Class(name="Class")
Association = Class(name="Association")
UML_14_Element = Class(name="UML_14_Element", is_abstract=True)
UML_14_ElementOwnership = Class(name="UML_14_ElementOwnership")
UML_14_Binding = Class(name="UML_14_Binding")
Dependency = Class(name="Dependency")
UML_14_Abstraction = Class(name="UML_14_Abstraction")
UML_14_Usage = Class(name="UML_14_Usage")
UML_14_Permission = Class(name="UML_14_Permission")
UML_14_Interface = Class(name="UML_14_Interface")
...
UML_14_GeneralizableElement.attributes={UML_14_GeneralizableElement_isRoot, UML_14_GeneralizableElement_isAbstract, UML_14_GeneralizableElement_isLeaf}
...
UML_14_Feature.attributes={UML_14_Feature_visibility, UML_14_Feature_ownerScope}
...
UML_14_StructuralFeature.attributes={UML_14_StructuralFeature_targetScope, UML_14_StructuralFeature_changeability, UML_14_StructuralFeature_ordering}
...
UML_14_AssociationEnd.attributes={UML_14_AssociationEnd_visibility, UML_14_AssociationEnd_isNavigable, UML_14_AssociationEnd_aggregation, UML_14_AssociationEnd_targetScope, UML_14_AssociationEnd_changeability}
...
UML_14_Operation.attributes={UML_14_Operation_isAbstract, UML_14_Operation_isLeaf, UML_14_Operation_isRoot, UML_14_Operation_specification}
...
domain_model = DomainModel(
    name="UML_14",
    types={UML_14_ModelElement, UML_14_GeneralizableElement, UML_14_Generalization, UML_14_Parameter, UML_14_BehavioralFeature, Element, UML_14_Constraint, UML_14_Comment, UML_14_Dependency, UML_14_Feature, ModelElement, UML_14_Classifier, UML_14_NameSpace, Feature, UML_14_Multiplicity, UML_14_MultiplicityRange, NameSpace, GeneralizableElement, UML_14_StructuralFeature, UML_14_AssociationEnd, UML_14_Association, UML_14_Operation, BehavioralFeature, UML_14_Method, UML_14_Attribute, StructuralFeature, UML_14_Relationship, Relationship, UML_14_DataType, UML_14_Primitive, DataType, UML_14_Enumeration, UML_14_Class, Classifier, UML_14_EnumerationLiteral, UML_14_AssociationClass, Class_, Association, UML_14_Element, UML_14_ElementOwnership, UML_14_Binding, Dependency, UML_14_Abstraction, UML_14_Usage, UML_14_Permission, UML_14_Interface, VisibilityKind, OrderingKind, AggregationKind, ChangeableKind, ScopeKind, ParameterDirectionKind},
    associations={generalization6, specialization7, type9, feature11, constraint0, comments1, supplierDependency2, clientDependency3, owner5, type22, multiplicity24, parameter25, range28, constrainedElement12, feature13, typedParameter14, typedFeature15, powertypeRange17, association19, specifiedEnd20, parent34, powertype36, connection38, association40, participant41, specification44, multiplicity46, multiplicity29, operation30, associationEnd31, child33, qualifier48, literal53, enumeration54, supplier49, annotatedElement55, client51},
    generalizations={gen_UML_14_GeneralizableElement_ModelElement, gen_UML_14_Parameter_ModelElement, gen_UML_14_Constraint_ModelElement, gen_UML_14_ModelElement_Element, gen_UML_14_Feature_ModelElement, gen_UML_14_NameSpace_ModelElement, gen_UML_14_StructuralFeature_Feature, gen_UML_14_BehavioralFeature_Feature, gen_UML_14_Classifier_NameSpace, gen_UML_14_Classifier_GeneralizableElement, gen_UML_14_Association_Relationship, gen_UML_14_Association_GeneralizableElement, gen_UML_14_AssociationEnd_ModelElement, gen_UML_14_Operation_BehavioralFeature, gen_UML_14_Method_BehavioralFeature, gen_UML_14_Attribute_StructuralFeature, gen_UML_14_Relationship_ModelElement, gen_UML_14_Generalization_Relationship, gen_UML_14_DataType_Classifier, gen_UML_14_Primitive_DataType, gen_UML_14_Enumeration_DataType, gen_UML_14_Class_Classifier, gen_UML_14_AssociationClass_Class, gen_UML_14_AssociationClass_Association, gen_UML_14_EnumerationLiteral_ModelElement, gen_UML_14_Dependency_Relationship, gen_UML_14_Binding_Dependency, gen_UML_14_Abstraction_Dependency, gen_UML_14_Usage_Dependency, gen_UML_14_Permission_Dependency, gen_UML_14_Interface_Classifier},
    metadata=None
)
