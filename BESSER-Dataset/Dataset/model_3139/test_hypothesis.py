...
def test_uml_14_structuralfeature_has_changeability():
    assert hasattr(UML_14_StructuralFeature, "changeability")
    descriptor = None
    for klass in UML_14_StructuralFeature.__mro__:
        if "changeability" in klass.__dict__:
            descriptor = klass.__dict__["changeability"]
            break
    assert isinstance(descriptor, property)

def test_uml_14_structuralfeature_has_targetScope():
    assert hasattr(UML_14_StructuralFeature, "targetScope")
    descriptor = None
    for klass in UML_14_StructuralFeature.__mro__:
...
def test_uml_14_structuralfeature_has_ordering():
    assert hasattr(UML_14_StructuralFeature, "ordering")
    descriptor = None
    for klass in UML_14_StructuralFeature.__mro__:
...
def test_uml_14_feature_has_visibility():
    assert hasattr(UML_14_Feature, "visibility")
    descriptor = None
    for klass in UML_14_Feature.__mro__:
        if "visibility" in klass.__dict__:
            descriptor = klass.__dict__["visibility"]
            break
    assert isinstance(descriptor, property)

def test_uml_14_feature_has_ownerScope():
    assert hasattr(UML_14_Feature, "ownerScope")
    descriptor = None
    for klass in UML_14_Feature.__mro__:
...
def test_uml_14_generalizableelement_has_isLeaf():
    assert hasattr(UML_14_GeneralizableElement, "isLeaf")
    descriptor = None
...
def test_uml_14_generalizableelement_has_isRoot():
    assert hasattr(UML_14_GeneralizableElement, "isRoot")
    descriptor = None
    for klass in UML_14_GeneralizableElement.__mro__:
        if "isRoot" in klass.__dict__:
            descriptor = klass.__dict__["isRoot"]
...
@given(instance=UML_14_StructuralFeature_strategy)
def test_uml_14_structuralfeature_changeability_setter(instance):
...
@given(instance=UML_14_StructuralFeature_strategy)
def test_uml_14_structuralfeature_targetScope_setter(instance):
...
@given(instance=UML_14_StructuralFeature_strategy)
def test_uml_14_structuralfeature_ordering_setter(instance):
...
@given(instance=UML_14_Feature_strategy)
def test_uml_14_feature_visibility_setter(instance):
    original = instance.visibility
    instance.visibility = original
    assert instance.visibility == original
...
@given(instance=UML_14_Feature_strategy)
def test_uml_14_feature_ownerScope_setter(instance):
...
@given(instance=UML_14_GeneralizableElement_strategy)
def test_uml_14_generalizableelement_isLeaf_setter(instance):
    original = instance.isLeaf
    instance.isLeaf = original
    assert instance.isLeaf == original
...
@given(instance=UML_14_GeneralizableElement_strategy)
def test_uml_14_generalizableelement_isRoot_setter(instance):
    original = instance.isRoot
    instance.isRoot = original
    assert instance.isRoot == original
