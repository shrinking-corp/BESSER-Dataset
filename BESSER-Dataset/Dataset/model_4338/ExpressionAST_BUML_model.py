...
# Classes
ast_Model = Class(name="ast_Model")
ast_Variable = Class(name="ast_Variable")
Operand = Class(name="Operand")
ast_Number = Class(name="ast_Number")
ast_Expression = Class(name="ast_Expression", is_abstract=True)
ast_Operator = Class(name="ast_Operator")
Expression = Class(name="Expression")
ast_Operand = Class(name="ast_Operand", is_abstract=True)
...
domain_model = DomainModel(
    name="ast",
    types={ast_Model, ast_Variable, Operand, ast_Number, ast_Expression, ast_Operator, Expression, ast_Operand, ArithmeticOperator},
    associations={expr0, model1, leftInverse2, rightInverse3, left5, right7},
    generalizations={gen_ast_Variable_Operand, gen_ast_Number_Operand, gen_ast_Operator_Expression, gen_ast_Operand_Expression},
    metadata=None
)
