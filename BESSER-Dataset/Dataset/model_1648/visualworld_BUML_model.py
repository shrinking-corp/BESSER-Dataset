...
# Classes
visualworld_World = Class(name="visualworld_World")
visualworld_Thing = Class(name="visualworld_Thing")
NamedElement = Class(name="NamedElement")
visualworld_RelatedTo = Class(name="visualworld_RelatedTo")
visualworld_NamedElement = Class(name="visualworld_NamedElement", is_abstract=True)
...
domain_model = DomainModel(
    name="visualworld",
    types={visualworld_World, visualworld_Thing, NamedElement, visualworld_RelatedTo, visualworld_NamedElement},
