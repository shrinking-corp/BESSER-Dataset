...
def test_hyp_visualworld_namedelement_is_not_abstract():
    assert not inspect.isabstract(visualworld_NamedElement)


def test_hyp_visualworld_namedelement_constructor_exists():
    assert callable(visualworld_NamedElement.__init__)


def test_hyp_visualworld_namedelement_constructor_args():
...
def test_hyp_visualworld_relatedto_is_not_abstract():
    assert not inspect.isabstract(visualworld_RelatedTo)


def test_hyp_visualworld_relatedto_constructor_exists():
    assert callable(visualworld_RelatedTo.__init__)


def test_hyp_visualworld_relatedto_constructor_args():
...
def test_hyp_visualworld_thing_is_not_abstract():
    assert not inspect.isabstract(visualworld_Thing)


def test_hyp_visualworld_thing_constructor_exists():
    assert callable(visualworld_Thing.__init__)


def test_hyp_visualworld_thing_constructor_args():
...
def test_hyp_visualworld_world_is_not_abstract():
    assert not inspect.isabstract(visualworld_World)


def test_hyp_visualworld_world_constructor_exists():
    assert callable(visualworld_World.__init__)


def test_hyp_visualworld_world_constructor_args():
...
def test_hyp_visualworld_namedelement_name_setter(instance):
...
def test_hyp_visualworld_relatedto_since_setter(instance):
...
def test_hyp_visualworld_thing_id_setter(instance):
