...
class visualworld_RelatedTo(NamedElement):
    ...
    def __init__(self, since: str, RelatedTo: "visualworld_Thing" = None, relations: "visualworld_Thing" = None, visualworld_RelatedTo: "visualworld_Thing" = None):
        self.since = since
...
class visualworld_Thing(NamedElement):
    ...
    def __init__(self, id: int, visualworld_Thing: "visualworld_World" = None, fromThing: set["visualworld_RelatedTo"] = None, Thing: "visualworld_RelatedTo" = None, visualworld_Thing4: "visualworld_RelatedTo" = None):
        self.id = id
