...
class hlcorestructure_PnObject(ABC):
    ...
    def __init__(self, id: str, containerNamePnObject: "hlcorestructure_Name" = None, PnObject: "hlcorestructure_Page" = None, containerPnObject: set["hlcorestructure_ToolInfo"] = None, objects: "hlcorestructure_Page" = None, PnObject24: "hlcorestructure_Name" = None, PnObject29: "hlcorestructure_ToolInfo" = None):
        self.id = id
...
class hlcorestructure_PetriNet:
    ...
    def __init__(self, id: str, type: str, PetriNet9: "hlcorestructure_Page" = None, PetriNet: "hlcorestructure_PetriNetDoc" = None, containerPetriNet: set["hlcorestructure_Page"] = None, containerNamePetriNet: "hlcorestructure_Name" = None, containerPetriNet4: set["hlcorestructure_ToolInfo"] = None, nets: "hlcorestructure_PetriNetDoc" = None, PetriNet122: "hlcorestructure_Declaration" = None, containerDeclarationPetriNet: set["hlcorestructure_Declaration"] = None, PetriNet21: "hlcorestructure_Name" = None, PetriNet26: "hlcorestructure_ToolInfo" = None):
        self.id = id
        self.type = type
