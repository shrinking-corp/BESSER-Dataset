...
class junitresult_Testrun(AbstractAggregatedTest):
    ...
    def __init__(self, started: int, ignored: int, project: str):
...
class junitresult_Testcase:
    ...
    def __init__(self, name: str, classname: str, time: float, system_out: str, system_err: str, status: str, assertions: str, junitresult_Testcase: "junitresult_Testsuite" = None, junitresult_Testcase4: "junitresult_Skipped" = None, junitresult_Testcase6: set["junitresult_Failure"] = None, junitresult_Testcase8: set["junitresult_Error"] = None):
        self.name = name
