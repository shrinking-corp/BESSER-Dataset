...
junitresult_Testcase.attributes={junitresult_Testcase_status, junitresult_Testcase_assertions, junitresult_Testcase_system_err, junitresult_Testcase_system_out, junitresult_Testcase_classname, junitresult_Testcase_time, junitresult_Testcase_name}
...
junitresult_Testsuite.attributes={junitresult_Testsuite_package, junitresult_Testsuite_time, junitresult_Testsuite_id, junitresult_Testsuite_system_err, junitresult_Testsuite_system_out, junitresult_Testsuite_hostname, junitresult_Testsuite_timestamp, junitresult_Testsuite_skipped, junitresult_Testsuite_disabled}
...
junitresult_AbstractAggregatedTest.attributes={junitresult_AbstractAggregatedTest_errors, junitresult_AbstractAggregatedTest_tests, junitresult_AbstractAggregatedTest_name, junitresult_AbstractAggregatedTest_failures}
...
domain_model = DomainModel(
    name="junitresult",
    types={junitresult_Testcase, junitresult_Skipped, junitresult_Failure, junitresult_Error, junitresult_Testsuite, AbstractAggregatedTest, junitresult_Property, junitresult_AbstractAggregatedTest, JunitResult, junitresult_Testsuites, junitresult_JunitResult, NegativeResult, junitresult_NegativeResult, junitresult_Testrun},
    associations={properties0, testcases1, skipped3, failures5, errors7, testsuites9},
    generalizations={gen_junitresult_Testsuite_AbstractAggregatedTest, gen_junitresult_AbstractAggregatedTest_JunitResult, gen_junitresult_Testsuites_AbstractAggregatedTest, gen_junitresult_Skipped_NegativeResult, gen_junitresult_Error_NegativeResult, gen_junitresult_Failure_NegativeResult, gen_junitresult_Testrun_AbstractAggregatedTest},
    metadata=None
)
