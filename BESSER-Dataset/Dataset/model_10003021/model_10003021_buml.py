...
Account.attributes={Account_closed, Account_open, Account_isClosed, Account_billingAddress}
...
WebUser.attributes={WebUser_password, WebUser_login, WebUser_state}
...
Order.attributes={Order_total, Order_status, Order_number, Order_shipTo, Order_shipped, Order_ordered}
...
domain_model = DomainModel(
    name="f60ea665_be9c_4b7d_b0b9_2d6738066ad5",
    types={Account, WebUser, Order, LineItem, Product, Web_customer_Actor, Registered_customer_Actor, New_customer_Actor, View_items_UseCase, Purchase_UseCase, Checkout_UseCase, Client_register_UseCase, Customer, Payment, ShoppingCart, UserState, OrderStatus},
