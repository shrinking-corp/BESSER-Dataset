...
class SrcAuthoredEntry:
    ...
    pass
class jointPackage_SrcThesisEntry(SrcDatedEntry, SrcTitledEntry, SrcAuthoredEntry):
...
class jointPackage_SrcArticle(SrcDatedEntry, SrcTitledEntry, SrcAuthoredEntry):
...
class jointPackage_SrcBook(SrcDatedEntry, SrcTitledEntry, SrcAuthoredEntry):
...
class SrcProceedings:
    ...
    pass
class jointPackage_SrcInProceedings(SrcBookTitledEntry, SrcAuthoredEntry, SrcProceedings):
...
class jointPackage_SrcTechReport(SrcDatedEntry, SrcTitledEntry, SrcAuthoredEntry):
