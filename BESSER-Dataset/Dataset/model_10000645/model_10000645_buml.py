...
SuperAdmin.attributes={SuperAdmin_password, SuperAdmin_userID, SuperAdmin_userName}
...
Normal_user.attributes={Normal_user_userName, Normal_user_password, Normal_user_userID}
...
Volunteer.attributes={Volunteer_userName, Volunteer_password, Volunteer_userID}
...
Calender_Event.attributes={Calender_Event_description, Calender_Event_time, Calender_Event_eventType, Calender_Event_nomarlUser, Calender_Event_category, Calender_Event_volunteer, Calender_Event_date, Calender_Event_admin, Calender_Event_participantAmount}
...
Login.attributes={Login_loggedoutTime, Login_userID, Login_loggedinTime}
...
Attendance.attributes={Attendance_checkOutTime, Attendance_attendanceID, Attendance_checkInTime}
...
Payment.attributes={Payment_expiryDate, Payment_amount, Payment_cardNumber, Payment_cardType, Payment_issuerName}
...
Mail.attributes={Mail_emailID, Mail_subject, Mail_sendBy, Mail_sendTo}
...
domain_model = DomainModel(
    name="_4fa2ae5f_252d_45e4_8341_a794d109b4d8",
    types={Profile, SuperAdmin, void, Normal_user, Admin, Volunteer, Calender_Event, Login, Attendance, Logout, Payment, Mail},
    associations={SuperAdmin_Calender_Event, Profile_Attendance, SuperAdmin_Payment, Volunteer_Payment, Admin_Payment, Normal_user_Payment, SuperAdmin_Mail, Admin_Mail, Volunteer_Calender_Event, Admin_Calender_Event, Normal_user_Calender_Event},
    generalizations={},
    metadata=None
)
