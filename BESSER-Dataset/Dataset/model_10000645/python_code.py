...
class Calender_Event:
    ...
    def __init__(self, category: str, date: str, time: str, description: str, eventType: str, participantAmount: str, volunteer: Volunteer, nomarlUser: Normal_user, admin: Admin, Add_Edit_View5: "Normal_user" = None, Add_Edit_Vew7: set["SuperAdmin"] = None, Add_Edit_View1: set["Volunteer"] = None, Add_Edit_View3: set["Admin"] = None):
