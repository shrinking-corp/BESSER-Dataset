...
Order.attributes={Order_shipped, Order_total, Order_status, Order_number, Order_ordered, Order_shipTo}
...
domain_model = DomainModel(
    name="_6f62a7b9_94e0_4685_a60a_cd008b752fa9",
    types={Payment, ShoppingCart, Account, Customer, WebUser, Order, LineItem, Product, UserState, OrderStatus},
