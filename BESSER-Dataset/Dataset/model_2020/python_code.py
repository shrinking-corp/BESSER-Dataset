...
class umlTrace_Values_ActionActivation_firing_Value:
    ...
    def __init__(self, firing: str, actionActivation_firing_Values: set["State"] = None, firingTrace: "BasicActions_TracedActionActivation" = None):
        self.firing = firing
    ...
    def actionActivation_firing_Values(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "State455"):
                    opp_val = getattr(item, "State455", None)
                    
                    if opp_val == self:
                        setattr(item, "State455", None)
    ...
    def firingTrace(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "TracedActionActivation"):
                opp_val = getattr(old_value, "TracedActionActivation", None)
                if opp_val == self:
                    setattr(old_value, "TracedActionActivation", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "TracedActionActivation"):
                opp_val = getattr(value, "TracedActionActivation", None)
                setattr(value, "TracedActionActivation", self)
...
class uml_TracedBehavior:
    ...
    pass
class umlTrace_uml_TracedInteraction(uml_TracedBehavior, uml_TracedInteractionFragment):
...
class uml_TracedStructuralFeature:
    ...
    pass
class umlTrace_uml_TracedProperty(uml_TracedConnectableElement, uml_TracedStructuralFeature, uml_TracedDeploymentTarget):
...
class uml_TracedParameterableElement:
    ...
    pass
class umlTrace_uml_TracedOperation(uml_TracedBehavioralFeature, uml_TracedParameterableElement, uml_TracedTemplateableElement):
...
class uml_TracedDeployedArtifact:
    ...
    pass
class umlTrace_uml_TracedInstanceSpecification(uml_TracedPackageableElement, uml_TracedDeploymentTarget, uml_TracedDeployedArtifact):
...
class uml_TracedMultiplicityElement:
    ...
    pass
class umlTrace_uml_TracedStructuralFeature(uml_TracedMultiplicityElement, uml_TracedTypedElement, uml_TracedFeature):
...
class uml_TracedOccurrenceSpecification:
    ...
    pass
class umlTrace_uml_TracedMessageOccurrenceSpecification(uml_TracedMessageEnd, uml_TracedOccurrenceSpecification):
...
class umlTrace_uml_TracedAssociationClass(uml_TracedClass, uml_TracedAssociation):
    ...
    pass
class umlTrace_uml_TracedNode(uml_TracedClass, uml_TracedDeploymentTarget):
