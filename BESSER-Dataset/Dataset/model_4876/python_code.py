...
class application_ConfigurableElement(ABC):
    ...
    def getPropertyValueElseDefault(self, application_defaultValue, application_key) :
...
class application_OAuthClientConfig:
    ...
    def __init__(self, clientSecret: str, code: str, grantType: str, refreshToken: str, accessToken: str, accessTokenCreationDate: date, accessTokenExpirationDate: date, forbiddenMetaTags: str, allowedMetaTags: str, oAuthScopeLevel: str, type: str, redirectionURL: str, name: str, description: str, clientID: str, application_OAuthClientConfig31: "application_OAuthClientScope" = None, application_OAuthClientConfig: "application_OAuthConfig" = None):
...
class application_Mashup(Source):
    ...
    def __init__(self, workingDirectory: str, cacheAttachments: str, cacheDataSet: str, backupDataSet: str, backupIntervall: str, cacheDelay: str, sourceIdentCounter: str, Mashup: "application_Source" = None, application_Mashup11: "application_MashupContainer" = None, application_Mashup16: "application_MashupContainer" = None, application_Mashup19: "application_MashupContainer" = None, Mashup24: "application_Interface" = None, Mashup33: "application_MashupAdmin" = None, application_Mashup: set["application_MappingRule"] = None, mashup: set["application_Source"] = None, mashup7: set["application_Interface"] = None, configurableMashups: set["application_MashupAdmin"] = None):
...
class application_Source(ConfigurableElement):
    ...
    def __init__(self, bundleId: str, state: str, activeState: str, logLevel: str, removeDataOnStop: str, updateRound: str, application_Source2: "application_DataSet" = None, sources: "application_Mashup" = None, Source: "application_Mashup" = None, application_Source: "application_Persistency" = None):
...
class application_MashupAdmin:
    ...
    def __init__(self, provider: str, id: str, name: str, localIdent: str, isConfigurationAdmin: str, profileImage: str, email: str, application_MashupAdmin: "application_MashupContainer" = None, mashupAdmins: set["application_Mashup"] = None, MashupAdmin: "application_Mashup" = None):
...
class application_Interface(ConfigurableElement):
    ...
    def __init__(self, urlSuffix: str, frontEndCaching: str, application_Interface: "application_MashupContainer" = None, interface: "application_Security" = None, interfaces: "application_Mashup" = None, Interface26: "application_Security" = None, Interface: "application_Mashup" = None):
