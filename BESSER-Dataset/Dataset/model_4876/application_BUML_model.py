...
application_MashupAdmin.attributes={application_MashupAdmin_localIdent, application_MashupAdmin_provider, application_MashupAdmin_profileImage, application_MashupAdmin_id, application_MashupAdmin_isConfigurationAdmin, application_MashupAdmin_name, application_MashupAdmin_email}
...
application_Source.attributes={application_Source_removeDataOnStop, application_Source_logLevel, application_Source_bundleId, application_Source_activeState, application_Source_state, application_Source_updateRound}
application_Source.methods={application_Source_m_pause, application_Source_m_stop, application_Source_m_getLogLevelIntValue, application_Source_m_start}
...
application_Mashup.attributes={application_Mashup_workingDirectory, application_Mashup_backupIntervall, application_Mashup_cacheAttachments, application_Mashup_cacheDelay, application_Mashup_cacheDataSet, application_Mashup_backupDataSet, application_Mashup_sourceIdentCounter}
...
application_MashupContainer.methods={application_MashupContainer_m_getConfigurationAdmins, application_MashupContainer_m_getNewIdentNumber, application_MashupContainer_m_getSourceConfigurationWithIdent, application_MashupContainer_m_setNewIdentFor, application_MashupContainer_m_getMashupWithIdent}
...
application_Property.attributes={application_Property_hidden, application_Property_Key, application_Property_required, application_Property_propertyType, application_Property_possibleValues, application_Property_helpText, application_Property_Value, application_Property_changeable}
application_Property.methods={application_Property_m_getMaxValue, application_Property_m_getMinValue, application_Property_m_isValueRange, application_Property_m_isValueList, application_Property_m_getListOfValues}
...
application_FEEDInterface.attributes={application_FEEDInterface_language, application_FEEDInterface_allowTypeFiltering, application_FEEDInterface_allowMetaTagFiltering, application_FEEDInterface_allowTagFiltering, application_FEEDInterface_allowPersonFiltering, application_FEEDInterface_feedTitle, application_FEEDInterface_allowOrganisationFiltering, application_FEEDInterface_allowCategoryFiltering, application_FEEDInterface_feedType}
...
application_OAuthClientScope.attributes={application_OAuthClientScope_allowPersons, application_OAuthClientScope_negativePerson, application_OAuthClientScope_positiveCategory, application_OAuthClientScope_negativeCategory, application_OAuthClientScope_negativeOrganisation, application_OAuthClientScope_positiveOrganisation, application_OAuthClientScope_negativeMetaTag, application_OAuthClientScope_positivePerson, application_OAuthClientScope_maximumAge, application_OAuthClientScope_positiveMetaTag, application_OAuthClientScope_negativeTag, application_OAuthClientScope_allowOrganisations, application_OAuthClientScope_identSpecification, application_OAuthClientScope_allowContents, application_OAuthClientScope_positiveTag}
...
application_OAuthClientConfig.attributes={application_OAuthClientConfig_accessTokenCreationDate, application_OAuthClientConfig_type, application_OAuthClientConfig_clientID, application_OAuthClientConfig_clientSecret, application_OAuthClientConfig_accessToken, application_OAuthClientConfig_forbiddenMetaTags, application_OAuthClientConfig_name, application_OAuthClientConfig_code, application_OAuthClientConfig_redirectionURL, application_OAuthClientConfig_grantType, application_OAuthClientConfig_accessTokenExpirationDate, application_OAuthClientConfig_allowedMetaTags, application_OAuthClientConfig_oAuthScopeLevel, application_OAuthClientConfig_description, application_OAuthClientConfig_refreshToken}
...
application_ConfigurableElement.attributes={application_ConfigurableElement_configurationImage, application_ConfigurableElement_changeable, application_ConfigurableElement_description, application_ConfigurableElement_ident, application_ConfigurableElement_hidden, application_ConfigurableElement_name}
application_ConfigurableElement.methods={application_ConfigurableElement_m_addProperty, application_ConfigurableElement_m_isPropertyTrueElseDefault, application_ConfigurableElement_m_removeProperty, application_ConfigurableElement_m_getProperty, application_ConfigurableElement_m_getPropertyValueElseDefault, application_ConfigurableElement_m_addProperty, application_ConfigurableElement_m_getPropertyValue, application_ConfigurableElement_m_isPropertyTrue}
...
domain_model = DomainModel(
    name="application",
    types={application_Interface, application_MashupAdmin, application_Source, ConfigurableElement, application_Persistency, application_DataSet, application_Mashup, Source, application_MappingRule, application_MashupContainer, application_Configuration, application_Property, application_XMLFile, Persistency, application_Database, application_OCLRestrictedProperty, Property_, application_RESTInterface, Interface, application_FEEDInterface, application_Security, application_OAuthClientScope, application_OAuthConfig, Security, application_OAuthClientConfig, application_OAuthAdmin, application_ApplicationKeyConfig, application_ConfigurableElement, SourceState, SourceActiveStates, PropertyTypes},
    associations={mappingRules4, sources5, interfaces6, mashupAdmins8, persistency0, dataSet1, mashup3, properties9, mashups10, allMashupAdmins12, defaultMashups14, sourceConfigurations17, interfaceConfigurations20, security22, mashup23, clientScope30, interface25, clients27, admins28, configurableMashups32, configuration34},
