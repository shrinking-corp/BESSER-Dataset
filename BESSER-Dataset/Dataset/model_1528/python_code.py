...
class minifsm_Transition:
    ...
    def __init__(self, event: str, out: "minifsm_State" = None, in_: "minifsm_State" = None, minifsm_Transition: "minifsm_Machine" = None, Transition: "minifsm_State" = None, Transition5: "minifsm_State" = None):
        self.event = event
        self.out = out
        self.in_ = in_
...
class minifsm_State:
    ...
    def __init__(self, name: str, State: "minifsm_Transition" = None, State8: "minifsm_Transition" = None, minifsm_State: "minifsm_Machine" = None, src: set["minifsm_Transition"] = None, tgt: set["minifsm_Transition"] = None):
        self.name = name
        self.State = State
        self.State8 = State8
