...
# Classes
minifsm_Machine = Class(name="minifsm_Machine")
minifsm_FinalState = Class(name="minifsm_FinalState")
...
tgt7: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="in_", type=minifsm_State, multiplicity=Multiplicity(0, 1))
    }
)
...
domain_model = DomainModel(
    name="minifsm",
    types={minifsm_Machine, minifsm_FinalState, State, minifsm_State, minifsm_Transition},
    associations={src6, tgt7, states0, transitions1, out3, in_4},
