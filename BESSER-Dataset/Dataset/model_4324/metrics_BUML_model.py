...
# Classes
metrics_LinkMeasurement = Class(name="metrics_LinkMeasurement")
metrics_Measurement = Class(name="metrics_Measurement", is_abstract=True)
metrics_ValueMeasurement = Class(name="metrics_ValueMeasurement")
Measurement = Class(name="Measurement")
ModelElement = Class(name="ModelElement")
metrics_ComplexMeasurement = Class(name="metrics_ComplexMeasurement")
metrics_Observation = Class(name="metrics_Observation")
...
metrics_Measurement.attributes={metrics_Measurement_error, metrics_Measurement_tag, metrics_Measurement_name}
...
domain_model = DomainModel(
    name="metrics",
    types={metrics_LinkMeasurement, metrics_Measurement, metrics_ValueMeasurement, Measurement, ModelElement, metrics_ComplexMeasurement, metrics_Observation},
    associations={elements0, measurements1, measurements2},
    generalizations={gen_metrics_LinkMeasurement_Measurement, gen_metrics_ValueMeasurement_Measurement, gen_metrics_ComplexMeasurement_Measurement},
    metadata=None
)
