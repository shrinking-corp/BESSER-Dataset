...
ClassDiagram_Package = Class(name="ClassDiagram_Package")
...
ClassDiagram_System = Class(name="ClassDiagram_System")
...
ownedElement0: BinaryAssociation = BinaryAssociation(
    name="ownedElement0",
    ends={
        Property(name="Classifier", type=ClassDiagram_Package, multiplicity=Multiplicity(1, 1)),
        Property(name="owner", type=Classifier, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
owner1: BinaryAssociation = BinaryAssociation(
    name="owner1",
    ends={
        Property(name="Package", type=ClassDiagram_Classifier, multiplicity=Multiplicity(1, 1)),
        Property(name="ownedElement", type=Package, multiplicity=Multiplicity(1, 1))
    }
)
...
attr3: BinaryAssociation = BinaryAssociation(
    name="attr3",
    ends={
        Property(name="Attribute", type=ClassDiagram_Class, multiplicity=Multiplicity(1, 1)),
        Property(name="owner4", type=Attribute, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
type5: BinaryAssociation = BinaryAssociation(
    name="type5",
    ends={
        Property(name="Classifier6", type=ClassDiagram_Attribute, multiplicity=Multiplicity(1, 1)),
...
owner7: BinaryAssociation = BinaryAssociation(
    name="owner7",
    ends={
        Property(name="Class8", type=ClassDiagram_Attribute, multiplicity=Multiplicity(1, 1)),
        Property(name="attr", type=Class_, multiplicity=Multiplicity(1, 1))
    }
)
packages9: BinaryAssociation = BinaryAssociation(
    name="packages9",
    ends={
        Property(name="Package10", type=ClassDiagram_System, multiplicity=Multiplicity(1, 1)),
...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={ClassDiagram_NamedElement, ClassDiagram_Package, NamedElement, Classifier, ClassDiagram_Classifier, Package, ClassDiagram_DataType, ClassDiagram_Class, Class_, Attribute, ClassDiagram_Attribute, ClassDiagram_System},
    associations={ownedElement0, owner1, super2, attr3, type5, owner7, packages9},
    generalizations={gen_ClassDiagram_Package_NamedElement, gen_ClassDiagram_Classifier_NamedElement, gen_ClassDiagram_DataType_Classifier, gen_ClassDiagram_Class_Classifier, gen_ClassDiagram_Attribute_NamedElement, gen_ClassDiagram_System_NamedElement},
    metadata=None
)
