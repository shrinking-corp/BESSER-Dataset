...
def test_hyp_globalaspect_is_not_abstract():
    assert not inspect.isabstract(GlobalAspect)


def test_hyp_globalaspect_constructor_exists():
    assert callable(GlobalAspect.__init__)


def test_hyp_globalaspect_constructor_args():
    sig = inspect.signature(GlobalAspect.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_documenttypecontainer_is_not_abstract():
    assert not inspect.isabstract(workflow_DocumentTypeContainer)


def test_hyp_workflow_documenttypecontainer_constructor_exists():
    assert callable(workflow_DocumentTypeContainer.__init__)


def test_hyp_workflow_documenttypecontainer_constructor_args():
...
def test_hyp_workflow_organisation_is_not_abstract():
    assert not inspect.isabstract(workflow_Organisation)


def test_hyp_workflow_organisation_constructor_exists():
    assert callable(workflow_Organisation.__init__)


def test_hyp_workflow_organisation_constructor_args():
...
def test_hyp_runtimeglobalaspect_is_not_abstract():
    assert not inspect.isabstract(RuntimeGlobalAspect)


def test_hyp_runtimeglobalaspect_constructor_exists():
    assert callable(RuntimeGlobalAspect.__init__)


def test_hyp_runtimeglobalaspect_constructor_args():
    sig = inspect.signature(RuntimeGlobalAspect.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_documentcontainer_is_not_abstract():
    assert not inspect.isabstract(workflow_DocumentContainer)


def test_hyp_workflow_documentcontainer_constructor_exists():
    assert callable(workflow_DocumentContainer.__init__)


def test_hyp_workflow_documentcontainer_constructor_args():
...
def test_hyp_workflow_agentcontainer_is_not_abstract():
    assert not inspect.isabstract(workflow_AgentContainer)


def test_hyp_workflow_agentcontainer_constructor_exists():
    assert callable(workflow_AgentContainer.__init__)


def test_hyp_workflow_agentcontainer_constructor_args():
...
def test_hyp_workflow_enumliteral_is_not_abstract():
    assert not inspect.isabstract(workflow_EnumLiteral)


def test_hyp_workflow_enumliteral_constructor_exists():
    assert callable(workflow_EnumLiteral.__init__)


def test_hyp_workflow_enumliteral_constructor_args():
...
def test_hyp_documentcondition_is_not_abstract():
    assert not inspect.isabstract(DocumentCondition)


def test_hyp_documentcondition_constructor_exists():
    assert callable(DocumentCondition.__init__)


def test_hyp_documentcondition_constructor_args():
    sig = inspect.signature(DocumentCondition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_defaultdocumentcondition_is_not_abstract():
    assert not inspect.isabstract(workflow_DefaultDocumentCondition)


def test_hyp_workflow_defaultdocumentcondition_constructor_exists():
    assert callable(workflow_DefaultDocumentCondition.__init__)


def test_hyp_workflow_defaultdocumentcondition_constructor_args():
...
def test_hyp_workflow_equaltooperator_is_not_abstract():
    assert not inspect.isabstract(workflow_EqualToOperator)


def test_hyp_workflow_equaltooperator_constructor_exists():
    assert callable(workflow_EqualToOperator.__init__)


def test_hyp_workflow_equaltooperator_constructor_args():
    sig = inspect.signature(workflow_EqualToOperator.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_unequaltooperator_is_not_abstract():
    assert not inspect.isabstract(workflow_UnequalToOperator)


def test_hyp_workflow_unequaltooperator_constructor_exists():
    assert callable(workflow_UnequalToOperator.__init__)


def test_hyp_workflow_unequaltooperator_constructor_args():
    sig = inspect.signature(workflow_UnequalToOperator.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_greaterthanoperator_is_not_abstract():
    assert not inspect.isabstract(workflow_GreaterThanOperator)


def test_hyp_workflow_greaterthanoperator_constructor_exists():
    assert callable(workflow_GreaterThanOperator.__init__)


def test_hyp_workflow_greaterthanoperator_constructor_args():
    sig = inspect.signature(workflow_GreaterThanOperator.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_lessthanoperator_is_not_abstract():
    assert not inspect.isabstract(workflow_LessThanOperator)


def test_hyp_workflow_lessthanoperator_constructor_exists():
    assert callable(workflow_LessThanOperator.__init__)


def test_hyp_workflow_lessthanoperator_constructor_args():
    sig = inspect.signature(workflow_LessThanOperator.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_dotoperator_is_not_abstract():
    assert not inspect.isabstract(workflow_DotOperator)


def test_hyp_workflow_dotoperator_constructor_exists():
    assert callable(workflow_DotOperator.__init__)


def test_hyp_workflow_dotoperator_constructor_args():
...
def test_hyp_workflow_constantatom_is_not_abstract():
    assert not inspect.isabstract(workflow_ConstantAtom)


def test_hyp_workflow_constantatom_constructor_exists():
    assert callable(workflow_ConstantAtom.__init__)


def test_hyp_workflow_constantatom_constructor_args():
...
def test_hyp_workflow_enumliteralatom_is_not_abstract():
    assert not inspect.isabstract(workflow_EnumLiteralAtom)


def test_hyp_workflow_enumliteralatom_constructor_exists():
    assert callable(workflow_EnumLiteralAtom.__init__)


def test_hyp_workflow_enumliteralatom_constructor_args():
    sig = inspect.signature(workflow_EnumLiteralAtom.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_fieldatom_is_not_abstract():
    assert not inspect.isabstract(workflow_FieldAtom)


def test_hyp_workflow_fieldatom_constructor_exists():
    assert callable(workflow_FieldAtom.__init__)


def test_hyp_workflow_fieldatom_constructor_args():
    sig = inspect.signature(workflow_FieldAtom.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_enumfieldatom_is_not_abstract():
    assert not inspect.isabstract(workflow_EnumFieldAtom)


def test_hyp_workflow_enumfieldatom_constructor_exists():
    assert callable(workflow_EnumFieldAtom.__init__)


def test_hyp_workflow_enumfieldatom_constructor_args():
    sig = inspect.signature(workflow_EnumFieldAtom.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_documentdescratom_is_not_abstract():
    assert not inspect.isabstract(workflow_DocumentDescrAtom)


def test_hyp_workflow_documentdescratom_constructor_exists():
    assert callable(workflow_DocumentDescrAtom.__init__)


def test_hyp_workflow_documentdescratom_constructor_args():
...
def test_hyp_workflow_operator_is_not_abstract():
    assert not inspect.isabstract(workflow_Operator)


def test_hyp_workflow_operator_constructor_exists():
    assert callable(workflow_Operator.__init__)


def test_hyp_workflow_operator_constructor_args():
    sig = inspect.signature(workflow_Operator.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_atom_is_not_abstract():
    assert not inspect.isabstract(workflow_Atom)


def test_hyp_workflow_atom_constructor_exists():
    assert callable(workflow_Atom.__init__)


def test_hyp_workflow_atom_constructor_args():
    sig = inspect.signature(workflow_Atom.__init__)
    params = list(sig.parameters.keys())



def test_hyp_documentdescriptor_is_not_abstract():
    assert not inspect.isabstract(DocumentDescriptor)


def test_hyp_documentdescriptor_constructor_exists():
    assert callable(DocumentDescriptor.__init__)


def test_hyp_documentdescriptor_constructor_args():
    sig = inspect.signature(DocumentDescriptor.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_defaultdocumentdescriptor_is_not_abstract():
    assert not inspect.isabstract(workflow_DefaultDocumentDescriptor)


def test_hyp_workflow_defaultdocumentdescriptor_constructor_exists():
    assert callable(workflow_DefaultDocumentDescriptor.__init__)


def test_hyp_workflow_defaultdocumentdescriptor_constructor_args():
    sig = inspect.signature(workflow_DefaultDocumentDescriptor.__init__)
    params = list(sig.parameters.keys())



def test_hyp_runtimemodelaspect_is_not_abstract():
    assert not inspect.isabstract(RuntimeModelAspect)


def test_hyp_runtimemodelaspect_constructor_exists():
    assert callable(RuntimeModelAspect.__init__)


def test_hyp_runtimemodelaspect_constructor_args():
    sig = inspect.signature(RuntimeModelAspect.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_informationruntimeaspect_is_not_abstract():
    assert not inspect.isabstract(workflow_InformationRuntimeAspect)


def test_hyp_workflow_informationruntimeaspect_constructor_exists():
    assert callable(workflow_InformationRuntimeAspect.__init__)


def test_hyp_workflow_informationruntimeaspect_constructor_args():
    sig = inspect.signature(workflow_InformationRuntimeAspect.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_enumfieldvalue_is_not_abstract():
    assert not inspect.isabstract(workflow_EnumFieldValue)


def test_hyp_workflow_enumfieldvalue_constructor_exists():
    assert callable(workflow_EnumFieldValue.__init__)


def test_hyp_workflow_enumfieldvalue_constructor_args():
    sig = inspect.signature(workflow_EnumFieldValue.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_fieldvalue_is_not_abstract():
    assert not inspect.isabstract(workflow_FieldValue)


def test_hyp_workflow_fieldvalue_constructor_exists():
    assert callable(workflow_FieldValue.__init__)


def test_hyp_workflow_fieldvalue_constructor_args():
...
def test_hyp_workflow_defaultdocument_is_not_abstract():
    assert not inspect.isabstract(workflow_DefaultDocument)


def test_hyp_workflow_defaultdocument_constructor_exists():
    assert callable(workflow_DefaultDocument.__init__)


def test_hyp_workflow_defaultdocument_constructor_args():
...
def test_hyp_workflow_enumfield_is_not_abstract():
    assert not inspect.isabstract(workflow_EnumField)


def test_hyp_workflow_enumfield_constructor_exists():
    assert callable(workflow_EnumField.__init__)


def test_hyp_workflow_enumfield_constructor_args():
...
def test_hyp_workflow_field_is_not_abstract():
    assert not inspect.isabstract(workflow_Field)


def test_hyp_workflow_field_constructor_exists():
    assert callable(workflow_Field.__init__)


def test_hyp_workflow_field_constructor_args():
...
def test_hyp_documenttype_is_not_abstract():
    assert not inspect.isabstract(DocumentType)


def test_hyp_documenttype_constructor_exists():
    assert callable(DocumentType.__init__)


def test_hyp_documenttype_constructor_args():
    sig = inspect.signature(DocumentType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_defaultdocumenttype_is_not_abstract():
    assert not inspect.isabstract(workflow_DefaultDocumentType)


def test_hyp_workflow_defaultdocumenttype_constructor_exists():
    assert callable(workflow_DefaultDocumentType.__init__)


def test_hyp_workflow_defaultdocumenttype_constructor_args():
...
def test_hyp_workflow_runtimeglobalaspect_is_not_abstract():
    assert not inspect.isabstract(workflow_RuntimeGlobalAspect)


def test_hyp_workflow_runtimeglobalaspect_constructor_exists():
    assert callable(workflow_RuntimeGlobalAspect.__init__)


def test_hyp_workflow_runtimeglobalaspect_constructor_args():
    sig = inspect.signature(workflow_RuntimeGlobalAspect.__init__)
    params = list(sig.parameters.keys())



def test_hyp_modelaspect_is_not_abstract():
    assert not inspect.isabstract(ModelAspect)


def test_hyp_modelaspect_constructor_exists():
    assert callable(ModelAspect.__init__)


def test_hyp_modelaspect_constructor_args():
    sig = inspect.signature(ModelAspect.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_informationaspect_is_not_abstract():
    assert not inspect.isabstract(workflow_InformationAspect)


def test_hyp_workflow_informationaspect_constructor_exists():
    assert callable(workflow_InformationAspect.__init__)


def test_hyp_workflow_informationaspect_constructor_args():
    sig = inspect.signature(workflow_InformationAspect.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_controlaspect_is_not_abstract():
    assert not inspect.isabstract(workflow_ControlAspect)


def test_hyp_workflow_controlaspect_constructor_exists():
    assert callable(workflow_ControlAspect.__init__)


def test_hyp_workflow_controlaspect_constructor_args():
    sig = inspect.signature(workflow_ControlAspect.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_organisationaspect_is_not_abstract():
    assert not inspect.isabstract(workflow_OrganisationAspect)


def test_hyp_workflow_organisationaspect_constructor_exists():
    assert callable(workflow_OrganisationAspect.__init__)


def test_hyp_workflow_organisationaspect_constructor_args():
    sig = inspect.signature(workflow_OrganisationAspect.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_modelaspect_is_not_abstract():
    assert not inspect.isabstract(workflow_ModelAspect)


def test_hyp_workflow_modelaspect_constructor_exists():
    assert callable(workflow_ModelAspect.__init__)


def test_hyp_workflow_modelaspect_constructor_args():
    sig = inspect.signature(workflow_ModelAspect.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_runtimemodelaspect_is_not_abstract():
    assert not inspect.isabstract(workflow_RuntimeModelAspect)


def test_hyp_workflow_runtimemodelaspect_constructor_exists():
    assert callable(workflow_RuntimeModelAspect.__init__)


def test_hyp_workflow_runtimemodelaspect_constructor_args():
    sig = inspect.signature(workflow_RuntimeModelAspect.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_taskaspect_is_not_abstract():
    assert not inspect.isabstract(workflow_TaskAspect)


def test_hyp_workflow_taskaspect_constructor_exists():
    assert callable(workflow_TaskAspect.__init__)


def test_hyp_workflow_taskaspect_constructor_args():
    sig = inspect.signature(workflow_TaskAspect.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_processaspect_is_not_abstract():
    assert not inspect.isabstract(workflow_ProcessAspect)


def test_hyp_workflow_processaspect_constructor_exists():
    assert callable(workflow_ProcessAspect.__init__)


def test_hyp_workflow_processaspect_constructor_args():
...
def test_hyp_workflow_marking_is_not_abstract():
    assert not inspect.isabstract(workflow_Marking)


def test_hyp_workflow_marking_constructor_exists():
    assert callable(workflow_Marking.__init__)


def test_hyp_workflow_marking_constructor_args():
    sig = inspect.signature(workflow_Marking.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_string2documentmap_is_not_abstract():
    assert not inspect.isabstract(workflow_String2DocumentMap)


def test_hyp_workflow_string2documentmap_constructor_exists():
    assert callable(workflow_String2DocumentMap.__init__)


def test_hyp_workflow_string2documentmap_constructor_args():
...
def test_hyp_workflow_document_is_not_abstract():
    assert not inspect.isabstract(workflow_Document)


def test_hyp_workflow_document_constructor_exists():
    assert callable(workflow_Document.__init__)


def test_hyp_workflow_document_constructor_args():
...
def test_hyp_workflow_documenttype_is_not_abstract():
    assert not inspect.isabstract(workflow_DocumentType)


def test_hyp_workflow_documenttype_constructor_exists():
    assert callable(workflow_DocumentType.__init__)


def test_hyp_workflow_documenttype_constructor_args():
...
def test_hyp_workflow_documentcondition_is_not_abstract():
    assert not inspect.isabstract(workflow_DocumentCondition)


def test_hyp_workflow_documentcondition_constructor_exists():
    assert callable(workflow_DocumentCondition.__init__)


def test_hyp_workflow_documentcondition_constructor_args():
...
def test_hyp_workflow_documentdescriptor_is_not_abstract():
    assert not inspect.isabstract(workflow_DocumentDescriptor)


def test_hyp_workflow_documentdescriptor_constructor_exists():
    assert callable(workflow_DocumentDescriptor.__init__)


def test_hyp_workflow_documentdescriptor_constructor_args():
...
def test_hyp_workflow_processdocument_is_not_abstract():
    assert not inspect.isabstract(workflow_ProcessDocument)


def test_hyp_workflow_processdocument_constructor_exists():
    assert callable(workflow_ProcessDocument.__init__)


def test_hyp_workflow_processdocument_constructor_args():
...
def test_hyp_workflow_globalaspect_is_not_abstract():
    assert not inspect.isabstract(workflow_GlobalAspect)


def test_hyp_workflow_globalaspect_constructor_exists():
    assert callable(workflow_GlobalAspect.__init__)


def test_hyp_workflow_globalaspect_constructor_args():
    sig = inspect.signature(workflow_GlobalAspect.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_coremodel_is_not_abstract():
    assert not inspect.isabstract(workflow_CoreModel)


def test_hyp_workflow_coremodel_constructor_exists():
    assert callable(workflow_CoreModel.__init__)


def test_hyp_workflow_coremodel_constructor_args():
...
def test_hyp_workflow_workflowengine_is_not_abstract():
    assert not inspect.isabstract(workflow_WorkflowEngine)


def test_hyp_workflow_workflowengine_constructor_exists():
    assert callable(workflow_WorkflowEngine.__init__)


def test_hyp_workflow_workflowengine_constructor_args():
    sig = inspect.signature(workflow_WorkflowEngine.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_modelregistry_is_not_abstract():
    assert not inspect.isabstract(workflow_ModelRegistry)


def test_hyp_workflow_modelregistry_constructor_exists():
    assert callable(workflow_ModelRegistry.__init__)


def test_hyp_workflow_modelregistry_constructor_args():
    sig = inspect.signature(workflow_ModelRegistry.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_token_is_not_abstract():
    assert not inspect.isabstract(workflow_Token)


def test_hyp_workflow_token_constructor_exists():
    assert callable(workflow_Token.__init__)


def test_hyp_workflow_token_constructor_args():
    sig = inspect.signature(workflow_Token.__init__)
    params = list(sig.parameters.keys())



def test_hyp_taskc_is_not_abstract():
    assert not inspect.isabstract(TaskC)


def test_hyp_taskc_constructor_exists():
    assert callable(TaskC.__init__)


def test_hyp_taskc_constructor_args():
    sig = inspect.signature(TaskC.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_transition_is_not_abstract():
    assert not inspect.isabstract(workflow_Transition)


def test_hyp_workflow_transition_constructor_exists():
    assert callable(workflow_Transition.__init__)


def test_hyp_workflow_transition_constructor_args():
    sig = inspect.signature(workflow_Transition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_place_is_not_abstract():
    assert not inspect.isabstract(workflow_Place)


def test_hyp_workflow_place_constructor_exists():
    assert callable(workflow_Place.__init__)


def test_hyp_workflow_place_constructor_args():
...
def test_hyp_workflow_arc_is_not_abstract():
    assert not inspect.isabstract(workflow_Arc)


def test_hyp_workflow_arc_constructor_exists():
    assert callable(workflow_Arc.__init__)


def test_hyp_workflow_arc_constructor_args():
...
def test_hyp_workflow_petrinet_is_not_abstract():
    assert not inspect.isabstract(workflow_PetriNet)


def test_hyp_workflow_petrinet_constructor_exists():
    assert callable(workflow_PetriNet.__init__)


def test_hyp_workflow_petrinet_constructor_args():
    sig = inspect.signature(workflow_PetriNet.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_state_is_not_abstract():
    assert not inspect.isabstract(workflow_State)


def test_hyp_workflow_state_constructor_exists():
    assert callable(workflow_State.__init__)


def test_hyp_workflow_state_constructor_args():
    sig = inspect.signature(workflow_State.__init__)
    params = list(sig.parameters.keys())



def test_hyp_caseaspect_is_not_abstract():
    assert not inspect.isabstract(CaseAspect)


def test_hyp_caseaspect_constructor_exists():
    assert callable(CaseAspect.__init__)


def test_hyp_caseaspect_constructor_args():
    sig = inspect.signature(CaseAspect.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_casei_is_not_abstract():
    assert not inspect.isabstract(workflow_CaseI)


def test_hyp_workflow_casei_constructor_exists():
    assert callable(workflow_CaseI.__init__)


def test_hyp_workflow_casei_constructor_args():
    sig = inspect.signature(workflow_CaseI.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_caseo_is_not_abstract():
    assert not inspect.isabstract(workflow_CaseO)


def test_hyp_workflow_caseo_constructor_exists():
    assert callable(workflow_CaseO.__init__)


def test_hyp_workflow_caseo_constructor_args():
    sig = inspect.signature(workflow_CaseO.__init__)
    params = list(sig.parameters.keys())



def test_hyp_processaspect_is_not_abstract():
    assert not inspect.isabstract(ProcessAspect)


def test_hyp_processaspect_constructor_exists():
    assert callable(ProcessAspect.__init__)


def test_hyp_processaspect_constructor_args():
    sig = inspect.signature(ProcessAspect.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_information_is_not_abstract():
    assert not inspect.isabstract(workflow_Information)


def test_hyp_workflow_information_constructor_exists():
    assert callable(workflow_Information.__init__)


def test_hyp_workflow_information_constructor_args():
    sig = inspect.signature(workflow_Information.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_processo_is_not_abstract():
    assert not inspect.isabstract(workflow_ProcessO)


def test_hyp_workflow_processo_constructor_exists():
    assert callable(workflow_ProcessO.__init__)


def test_hyp_workflow_processo_constructor_args():
    sig = inspect.signature(workflow_ProcessO.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_control_is_not_abstract():
    assert not inspect.isabstract(workflow_Control)


def test_hyp_workflow_control_constructor_exists():
    assert callable(workflow_Control.__init__)


def test_hyp_workflow_control_constructor_args():
    sig = inspect.signature(workflow_Control.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_casec_is_not_abstract():
    assert not inspect.isabstract(workflow_CaseC)


def test_hyp_workflow_casec_constructor_exists():
    assert callable(workflow_CaseC.__init__)


def test_hyp_workflow_casec_constructor_args():
    sig = inspect.signature(workflow_CaseC.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_runtimeinformation_is_not_abstract():
    assert not inspect.isabstract(workflow_RuntimeInformation)


def test_hyp_workflow_runtimeinformation_constructor_exists():
    assert callable(workflow_RuntimeInformation.__init__)


def test_hyp_workflow_runtimeinformation_constructor_args():
...
def test_hyp_workflow_activityaspect_is_not_abstract():
    assert not inspect.isabstract(workflow_ActivityAspect)


def test_hyp_workflow_activityaspect_constructor_exists():
    assert callable(workflow_ActivityAspect.__init__)


def test_hyp_workflow_activityaspect_constructor_args():
    sig = inspect.signature(workflow_ActivityAspect.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_runtimecoremodel_is_not_abstract():
    assert not inspect.isabstract(workflow_RuntimeCoreModel)


def test_hyp_workflow_runtimecoremodel_constructor_exists():
    assert callable(workflow_RuntimeCoreModel.__init__)


def test_hyp_workflow_runtimecoremodel_constructor_args():
    sig = inspect.signature(workflow_RuntimeCoreModel.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_process_is_not_abstract():
    assert not inspect.isabstract(workflow_Process)


def test_hyp_workflow_process_constructor_exists():
    assert callable(workflow_Process.__init__)


def test_hyp_workflow_process_constructor_args():
...
def test_hyp_workflow_activity_is_not_abstract():
    assert not inspect.isabstract(workflow_Activity)


def test_hyp_workflow_activity_constructor_exists():
    assert callable(workflow_Activity.__init__)


def test_hyp_workflow_activity_constructor_args():
...
def test_hyp_workflow_caseaspect_is_not_abstract():
    assert not inspect.isabstract(workflow_CaseAspect)


def test_hyp_workflow_caseaspect_constructor_exists():
    assert callable(workflow_CaseAspect.__init__)


def test_hyp_workflow_caseaspect_constructor_args():
    sig = inspect.signature(workflow_CaseAspect.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_case_is_not_abstract():
    assert not inspect.isabstract(workflow_Case)


def test_hyp_workflow_case_constructor_exists():
    assert callable(workflow_Case.__init__)


def test_hyp_workflow_case_constructor_args():
...
def test_hyp_workflow_agent_is_not_abstract():
    assert not inspect.isabstract(workflow_Agent)


def test_hyp_workflow_agent_constructor_exists():
    assert callable(workflow_Agent.__init__)


def test_hyp_workflow_agent_constructor_args():
...
def test_hyp_activityaspect_is_not_abstract():
    assert not inspect.isabstract(ActivityAspect)


def test_hyp_activityaspect_constructor_exists():
    assert callable(ActivityAspect.__init__)


def test_hyp_activityaspect_constructor_args():
    sig = inspect.signature(ActivityAspect.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_activityi_is_not_abstract():
    assert not inspect.isabstract(workflow_ActivityI)


def test_hyp_workflow_activityi_constructor_exists():
    assert callable(workflow_ActivityI.__init__)


def test_hyp_workflow_activityi_constructor_args():
    sig = inspect.signature(workflow_ActivityI.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_activityc_is_not_abstract():
    assert not inspect.isabstract(workflow_ActivityC)


def test_hyp_workflow_activityc_constructor_exists():
    assert callable(workflow_ActivityC.__init__)


def test_hyp_workflow_activityc_constructor_args():
    sig = inspect.signature(workflow_ActivityC.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_activityo_is_not_abstract():
    assert not inspect.isabstract(workflow_ActivityO)


def test_hyp_workflow_activityo_constructor_exists():
    assert callable(workflow_ActivityO.__init__)


def test_hyp_workflow_activityo_constructor_args():
    sig = inspect.signature(workflow_ActivityO.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_role_is_not_abstract():
    assert not inspect.isabstract(workflow_Role)


def test_hyp_workflow_role_constructor_exists():
    assert callable(workflow_Role.__init__)


def test_hyp_workflow_role_constructor_args():
...
def test_hyp_taskaspect_is_not_abstract():
    assert not inspect.isabstract(TaskAspect)


def test_hyp_taskaspect_constructor_exists():
    assert callable(TaskAspect.__init__)


def test_hyp_taskaspect_constructor_args():
    sig = inspect.signature(TaskAspect.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_taskc_is_not_abstract():
    assert not inspect.isabstract(workflow_TaskC)


def test_hyp_workflow_taskc_constructor_exists():
    assert callable(workflow_TaskC.__init__)


def test_hyp_workflow_taskc_constructor_args():
...
def test_hyp_workflow_taski_is_not_abstract():
    assert not inspect.isabstract(workflow_TaskI)


def test_hyp_workflow_taski_constructor_exists():
    assert callable(workflow_TaskI.__init__)


def test_hyp_workflow_taski_constructor_args():
    sig = inspect.signature(workflow_TaskI.__init__)
    params = list(sig.parameters.keys())



def test_hyp_workflow_tasko_is_not_abstract():
    assert not inspect.isabstract(workflow_TaskO)


def test_hyp_workflow_tasko_constructor_exists():
    assert callable(workflow_TaskO.__init__)


def test_hyp_workflow_tasko_constructor_args():
...
def test_hyp_workflow_documenttypecontainer_name_setter(instance):
...
def test_hyp_workflow_organisation_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_workflow_documentcontainer_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_workflow_agentcontainer_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_workflow_enumliteral_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_workflow_constantatom_value_setter(instance):
...
def test_hyp_workflow_fieldvalue_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_workflow_defaultdocument_placeholder_setter(instance):
...
def test_hyp_workflow_enumfield_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_workflow_field_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_workflow_string2documentmap_key_setter(instance):
...
def test_hyp_workflow_document_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=workflow_Document_strategy)
def test_hyp_workflow_document_id_setter(instance):
...
def test_hyp_workflow_documenttype_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_workflow_documentcondition_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_workflow_documentdescriptor_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_workflow_processdocument_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_workflow_coremodel_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_workflow_place_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_workflow_arc_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_workflow_runtimeinformation_caseIdCount_setter(instance):
...
def test_hyp_workflow_task_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_workflow_process_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_workflow_activity_finished_setter(instance):
...
@given(instance=workflow_Activity_strategy)
def test_hyp_workflow_activity_started_setter(instance):
...
def test_hyp_workflow_case_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
@given(instance=workflow_Case_strategy)
def test_hyp_workflow_case_client_setter(instance):
...
@given(instance=workflow_Case_strategy)
def test_hyp_workflow_case_finished_setter(instance):
    original = instance.finished
    instance.finished = original
    assert instance.finished == original
...
@given(instance=workflow_Case_strategy)
def test_hyp_workflow_case_started_setter(instance):
    original = instance.started
    instance.started = original
    assert instance.started == original
...
def test_hyp_workflow_agent_username_setter(instance):
...
@given(instance=workflow_Agent_strategy)
def test_hyp_workflow_agent_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=workflow_Agent_strategy)
def test_hyp_workflow_agent_password_setter(instance):
...
def test_hyp_workflow_role_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_workflow_taskc_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_workflow_tasko_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
