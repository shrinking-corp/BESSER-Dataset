...
# Classes
workflow_TaskO = Class(name="workflow_TaskO")
TaskAspect = Class(name="TaskAspect")
workflow_Role = Class(name="workflow_Role")
workflow_ActivityO = Class(name="workflow_ActivityO")
ActivityAspect = Class(name="ActivityAspect")
workflow_Agent = Class(name="workflow_Agent")
workflow_Case = Class(name="workflow_Case")
workflow_CaseAspect = Class(name="workflow_CaseAspect", is_abstract=True)
workflow_Activity = Class(name="workflow_Activity")
workflow_Process = Class(name="workflow_Process")
workflow_RuntimeCoreModel = Class(name="workflow_RuntimeCoreModel")
workflow_ActivityAspect = Class(name="workflow_ActivityAspect", is_abstract=True)
workflow_Task = Class(name="workflow_Task")
workflow_RuntimeInformation = Class(name="workflow_RuntimeInformation")
workflow_TaskC = Class(name="workflow_TaskC", is_abstract=True)
workflow_ActivityC = Class(name="workflow_ActivityC")
workflow_CaseC = Class(name="workflow_CaseC")
workflow_Control = Class(name="workflow_Control", is_abstract=True)
ProcessAspect = Class(name="ProcessAspect")
CaseAspect = Class(name="CaseAspect")
workflow_State = Class(name="workflow_State", is_abstract=True)
workflow_PetriNet = Class(name="workflow_PetriNet")
Control = Class(name="Control")
workflow_Arc = Class(name="workflow_Arc")
workflow_Place = Class(name="workflow_Place")
workflow_Transition = Class(name="workflow_Transition")
TaskC = Class(name="TaskC")
workflow_Token = Class(name="workflow_Token")
workflow_ModelRegistry = Class(name="workflow_ModelRegistry")
workflow_WorkflowEngine = Class(name="workflow_WorkflowEngine")
workflow_CoreModel = Class(name="workflow_CoreModel")
workflow_GlobalAspect = Class(name="workflow_GlobalAspect", is_abstract=True)
workflow_Information = Class(name="workflow_Information")
workflow_ProcessDocument = Class(name="workflow_ProcessDocument")
workflow_TaskI = Class(name="workflow_TaskI")
workflow_DocumentDescriptor = Class(name="workflow_DocumentDescriptor", is_abstract=True)
workflow_DocumentCondition = Class(name="workflow_DocumentCondition", is_abstract=True)
workflow_DocumentType = Class(name="workflow_DocumentType", is_abstract=True)
workflow_ActivityI = Class(name="workflow_ActivityI")
workflow_Document = Class(name="workflow_Document", is_abstract=True)
workflow_CaseI = Class(name="workflow_CaseI")
workflow_String2DocumentMap = Class(name="workflow_String2DocumentMap")
workflow_Marking = Class(name="workflow_Marking")
State = Class(name="State")
workflow_ProcessAspect = Class(name="workflow_ProcessAspect", is_abstract=True)
workflow_TaskAspect = Class(name="workflow_TaskAspect", is_abstract=True)
workflow_RuntimeModelAspect = Class(name="workflow_RuntimeModelAspect", is_abstract=True)
workflow_ModelAspect = Class(name="workflow_ModelAspect", is_abstract=True)
workflow_OrganisationAspect = Class(name="workflow_OrganisationAspect")
ModelAspect = Class(name="ModelAspect")
workflow_ControlAspect = Class(name="workflow_ControlAspect")
workflow_RuntimeGlobalAspect = Class(name="workflow_RuntimeGlobalAspect", is_abstract=True)
workflow_ProcessO = Class(name="workflow_ProcessO")
workflow_Expression = Class(name="workflow_Expression")
workflow_DefaultDocumentType = Class(name="workflow_DefaultDocumentType")
DocumentType = Class(name="DocumentType")
workflow_Field = Class(name="workflow_Field")
workflow_EnumField = Class(name="workflow_EnumField")
workflow_DefaultDocument = Class(name="workflow_DefaultDocument")
Document = Class(name="Document")
workflow_FieldValue = Class(name="workflow_FieldValue")
workflow_EnumFieldValue = Class(name="workflow_EnumFieldValue")
workflow_InformationAspect = Class(name="workflow_InformationAspect")
workflow_CaseO = Class(name="workflow_CaseO")
workflow_InformationRuntimeAspect = Class(name="workflow_InformationRuntimeAspect")
RuntimeModelAspect = Class(name="RuntimeModelAspect")
workflow_DefaultDocumentDescriptor = Class(name="workflow_DefaultDocumentDescriptor")
DocumentDescriptor = Class(name="DocumentDescriptor")
workflow_Atom = Class(name="workflow_Atom")
Expression = Class(name="Expression")
workflow_Operator = Class(name="workflow_Operator")
workflow_DocumentDescrAtom = Class(name="workflow_DocumentDescrAtom")
Atom = Class(name="Atom")
workflow_FieldAtom = Class(name="workflow_FieldAtom")
workflow_ConstantAtom = Class(name="workflow_ConstantAtom")
workflow_DotOperator = Class(name="workflow_DotOperator")
Operator = Class(name="Operator")
workflow_EqualToOperator = Class(name="workflow_EqualToOperator")
workflow_DefaultDocumentCondition = Class(name="workflow_DefaultDocumentCondition")
DocumentCondition = Class(name="DocumentCondition")
workflow_EnumLiteral = Class(name="workflow_EnumLiteral")
workflow_LessThanOperator = Class(name="workflow_LessThanOperator")
workflow_GreaterThanOperator = Class(name="workflow_GreaterThanOperator")
workflow_EnumFieldAtom = Class(name="workflow_EnumFieldAtom")
workflow_UnequalToOperator = Class(name="workflow_UnequalToOperator")
workflow_AgentContainer = Class(name="workflow_AgentContainer")
RuntimeGlobalAspect = Class(name="RuntimeGlobalAspect")
workflow_Organisation = Class(name="workflow_Organisation")
GlobalAspect = Class(name="GlobalAspect")
workflow_DocumentTypeContainer = Class(name="workflow_DocumentTypeContainer")
workflow_DocumentContainer = Class(name="workflow_DocumentContainer")
workflow_EnumLiteralAtom = Class(name="workflow_EnumLiteralAtom")
...
workflow_Case.attributes={workflow_Case_finished, workflow_Case_started, workflow_Case_client, workflow_Case_id}
...
in_35: BinaryAssociation = BinaryAssociation(
    name="in_35",
    ends={
...
targetPlace38: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="in_", type=workflow_Place, multiplicity=Multiplicity(1, 1))
    }
)
...
targetTransition42: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="in_43", type=workflow_Transition, multiplicity=Multiplicity(1, 1))
    }
)
in_45: BinaryAssociation = BinaryAssociation(
    name="in_45",
    ends={
...
in_62: BinaryAssociation = BinaryAssociation(
    name="in_62",
    ends={
...
in_76: BinaryAssociation = BinaryAssociation(
    name="in_76",
    ends={
...
domain_model = DomainModel(
    name="workflow",
    types={workflow_TaskO, TaskAspect, workflow_Role, workflow_ActivityO, ActivityAspect, workflow_Agent, workflow_Case, workflow_CaseAspect, workflow_Activity, workflow_Process, workflow_RuntimeCoreModel, workflow_ActivityAspect, workflow_Task, workflow_RuntimeInformation, workflow_TaskC, workflow_ActivityC, workflow_CaseC, workflow_Control, ProcessAspect, CaseAspect, workflow_State, workflow_PetriNet, Control, workflow_Arc, workflow_Place, workflow_Transition, TaskC, workflow_Token, workflow_ModelRegistry, workflow_WorkflowEngine, workflow_CoreModel, workflow_GlobalAspect, workflow_Information, workflow_ProcessDocument, workflow_TaskI, workflow_DocumentDescriptor, workflow_DocumentCondition, workflow_DocumentType, workflow_ActivityI, workflow_Document, workflow_CaseI, workflow_String2DocumentMap, workflow_Marking, State, workflow_ProcessAspect, workflow_TaskAspect, workflow_RuntimeModelAspect, workflow_ModelAspect, workflow_OrganisationAspect, ModelAspect, workflow_ControlAspect, workflow_RuntimeGlobalAspect, workflow_ProcessO, workflow_Expression, workflow_DefaultDocumentType, DocumentType, workflow_Field, workflow_EnumField, workflow_DefaultDocument, Document, workflow_FieldValue, workflow_EnumFieldValue, workflow_InformationAspect, workflow_CaseO, workflow_InformationRuntimeAspect, RuntimeModelAspect, workflow_DefaultDocumentDescriptor, DocumentDescriptor, workflow_Atom, Expression, workflow_Operator, workflow_DocumentDescrAtom, Atom, workflow_FieldAtom, workflow_ConstantAtom, workflow_DotOperator, Operator, workflow_EqualToOperator, workflow_DefaultDocumentCondition, DocumentCondition, workflow_EnumLiteral, workflow_LessThanOperator, workflow_GreaterThanOperator, workflow_EnumFieldAtom, workflow_UnequalToOperator, workflow_AgentContainer, RuntimeGlobalAspect, workflow_Organisation, GlobalAspect, workflow_DocumentTypeContainer, workflow_DocumentContainer, workflow_EnumLiteralAtom},
    associations={requiredRoles0, followsUpOn2, assignedTo4, aspects5, activities6, process7, runtimeCoreModel9, aspects10, task12, EReference014, active18, mayTakeRoles19, case22, state23, arcs25, places26, start28, finish31, out34, in_35, sourcePlace37, targetPlace38, sourceTransition40, targetTransition42, in_45, takenRoles16, tokens49, petrinet50, place53, engine56, coreModels57, globalAspects59, processDocuments61, in_62, out63, start66, finish68, documentType71, processDocument73, in_76, out77, DocumentType80, caseDocuments83, out47, process84, tasks85, core87, core88, process90, core92, task94, core97, aspects99, process101, modelRegistry103, tasks104, aspects109, aspects111, aspects113, cases114, coreModel116, modelRegistry119, runtimeCoreModels121, runtimeGlobalAspects123, involved125, fields127, enumFields128, fieldValues130, enumFieldValues131, field133, coreModel107, documentType138, value141, operands144, descriptor145, field147, expression149, enumLiterals151, defaultValue153, enumField156, enumValue159, enumField162, involved136, agents166, roles168, modelRegistry170, engine172, documentTypes174, documents176, enumLiteral164},
    generalizations={gen_workflow_TaskO_TaskAspect, gen_workflow_ActivityO_ActivityAspect, gen_workflow_TaskC_TaskAspect, gen_workflow_ActivityC_ActivityAspect, gen_workflow_Control_ProcessAspect, gen_workflow_CaseC_CaseAspect, gen_workflow_PetriNet_Control, gen_workflow_Transition_TaskC, gen_workflow_Marking_State, gen_workflow_Information_ProcessAspect, gen_workflow_TaskI_TaskAspect, gen_workflow_ActivityI_ActivityAspect, gen_workflow_CaseI_CaseAspect, gen_workflow_OrganisationAspect_ModelAspect, gen_workflow_ControlAspect_ModelAspect, gen_workflow_ProcessO_ProcessAspect, gen_workflow_DefaultDocumentType_DocumentType, gen_workflow_DefaultDocument_Document, gen_workflow_InformationAspect_ModelAspect, gen_workflow_CaseO_CaseAspect, gen_workflow_InformationRuntimeAspect_RuntimeModelAspect, gen_workflow_DefaultDocumentDescriptor_DocumentDescriptor, gen_workflow_Atom_Expression, gen_workflow_Operator_Expression, gen_workflow_DocumentDescrAtom_Atom, gen_workflow_FieldAtom_Atom, gen_workflow_ConstantAtom_Atom, gen_workflow_DotOperator_Operator, gen_workflow_EqualToOperator_Operator, gen_workflow_DefaultDocumentCondition_DocumentCondition, gen_workflow_LessThanOperator_Operator, gen_workflow_GreaterThanOperator_Operator, gen_workflow_EnumFieldAtom_Atom, gen_workflow_UnequalToOperator_Operator, gen_workflow_AgentContainer_RuntimeGlobalAspect, gen_workflow_Organisation_GlobalAspect, gen_workflow_DocumentTypeContainer_GlobalAspect, gen_workflow_DocumentContainer_RuntimeGlobalAspect, gen_workflow_EnumLiteralAtom_Atom},
    metadata=None
)
