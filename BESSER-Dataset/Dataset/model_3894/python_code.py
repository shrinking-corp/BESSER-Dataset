...
class workflow_EnumLiteral:
    ...
    def __init__(self, name: str, workflow_EnumLiteral: "workflow_EnumField" = None, workflow_EnumLiteral155: "workflow_EnumField" = None, workflow_EnumLiteral161: "workflow_EnumFieldValue" = None, workflow_EnumLiteral165: "workflow_EnumLiteralAtom" = None):
        self.name = name
...
class workflow_EnumField:
    ...
    def __init__(self, name: str, workflow_EnumField: "workflow_DefaultDocumentType" = None, workflow_EnumField152: set["workflow_EnumLiteral"] = None, workflow_EnumField154: "workflow_EnumLiteral" = None, workflow_EnumField158: "workflow_EnumFieldValue" = None, workflow_EnumField163: "workflow_EnumFieldAtom" = None):
        self.name = name
...
class workflow_Field:
    ...
    def __init__(self, name: str, workflow_Field148: "workflow_FieldAtom" = None, workflow_Field: "workflow_DefaultDocumentType" = None, workflow_Field135: "workflow_FieldValue" = None):
        self.name = name
...
class workflow_DocumentDescriptor(ABC):
    ...
    def __init__(self, name: str, workflow_DocumentDescriptor146: "workflow_DocumentDescrAtom" = None, workflow_DocumentDescriptor: "workflow_TaskI" = None, workflow_DocumentDescriptor65: "workflow_TaskI" = None, workflow_DocumentDescriptor72: "workflow_DocumentType" = None, workflow_DocumentDescriptor74: "workflow_ProcessDocument" = None):
        self.name = name
...
class workflow_Place:
    ...
    def __init__(self, name: str, targetPlace: set["workflow_Arc"] = None, workflow_Place: "workflow_PetriNet" = None, workflow_Place30: "workflow_PetriNet" = None, workflow_Place33: "workflow_PetriNet" = None, Place: "workflow_Arc" = None, Place39: "workflow_Arc" = None, workflow_Place55: "workflow_Token" = None, sourcePlace: set["workflow_Arc"] = None):
        self.name = name
...
class workflow_Arc:
    ...
    def __init__(self, name: str, workflow_Arc: "workflow_PetriNet" = None, Arc: "workflow_Transition" = None, Arc36: "workflow_Transition" = None, out: "workflow_Place" = None, in_: "workflow_Place" = None, out41: "workflow_Transition" = None, in_43: "workflow_Transition" = None, Arc46: "workflow_Place" = None, Arc48: "workflow_Place" = None):
        self.name = name
    ...
    @in_43.setter
    def in_43(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_workflow_Arc__in_43", None)
        self.__in_43 = value
    ...
    def in_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_workflow_Arc__in_", None)
        self.__in_ = value
...
class workflow_Task:
    ...
    def __init__(self, name: str, workflow_Task: "workflow_Activity" = None, Task: "workflow_TaskAspect" = None, workflow_Task106: "workflow_Process" = None, core112: set["workflow_TaskAspect"] = None):
        self.name = name
...
class workflow_Process:
    ...
    def __init__(self, name: str, workflow_Process: "workflow_Case" = None, Process: "workflow_ProcessAspect" = None, Process102: "workflow_CoreModel" = None, workflow_Process105: set["workflow_Task"] = None, core110: set["workflow_ProcessAspect"] = None, process: "workflow_CoreModel" = None):
        self.name = name
...
class workflow_Agent:
    ...
    def __init__(self, username: str, password: str, name: str, workflow_Agent: set["workflow_Role"] = None, Agent: "workflow_ActivityO" = None, assignedTo: set["workflow_ActivityO"] = None, workflow_Agent20: set["workflow_Role"] = None, workflow_Agent137: "workflow_CaseO" = None, workflow_Agent167: "workflow_AgentContainer" = None):
