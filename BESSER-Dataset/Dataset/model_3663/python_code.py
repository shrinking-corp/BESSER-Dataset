...
class iOI_Department:
    ...
    def __init__(self, name: str, iOI_Department10: set["iOI_Employee"] = None, iOI_Department14: "iOI_Department" = None, iOI_Department12: "iOI_Department" = None, iOI_Department: "iOI_Company" = None, iOI_Department8: "iOI_Manager" = None):
        self.name = name
