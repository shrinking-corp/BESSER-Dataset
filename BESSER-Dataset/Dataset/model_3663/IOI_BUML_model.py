...
domain_model = DomainModel(
    name="iOI",
    types={iOI_Model, iOI_Company, iOI_Employee, iOI_Position, Employee, iOI_Department, iOI_Manager},
    associations={companies0, works_on1, employees9, sub_department13, positions2, departments5, manager7},
