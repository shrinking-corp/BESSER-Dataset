...
class uml2CD_Property(NamedElement):
    ...
    def __init__(self, isDerived: str, aggregation: str, lower: str, upper: str, uml2CD_Property40: "uml2CD_Association" = None, uml2CD_Property43: "uml2CD_Association" = None, uml2CD_Property: "uml2CD_Class" = None):
