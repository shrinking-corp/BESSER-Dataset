...
# Classes
arithmetic_Import = Class(name="arithmetic_Import")
arithmetic_Statement = Class(name="arithmetic_Statement")
arithmetic_Definition = Class(name="arithmetic_Definition")
Statement = Class(name="Statement")
AbstractDefinition = Class(name="AbstractDefinition")
arithmetic_Module = Class(name="arithmetic_Module")
arithmetic_Div = Class(name="arithmetic_Div")
arithmetic_NumberLiteral = Class(name="arithmetic_NumberLiteral")
arithmetic_FunctionCall = Class(name="arithmetic_FunctionCall")
arithmetic_DeclaredParameter = Class(name="arithmetic_DeclaredParameter")
arithmetic_Expression = Class(name="arithmetic_Expression")
arithmetic_AbstractDefinition = Class(name="arithmetic_AbstractDefinition")
arithmetic_Evaluation = Class(name="arithmetic_Evaluation")
arithmetic_SumExpression = Class(name="arithmetic_SumExpression")
Expression = Class(name="Expression")
arithmetic_Plus = Class(name="arithmetic_Plus")
arithmetic_Minus = Class(name="arithmetic_Minus")
arithmetic_Multi = Class(name="arithmetic_Multi")
...
domain_model = DomainModel(
    name="arithmetic",
    types={arithmetic_Import, arithmetic_Statement, arithmetic_Definition, Statement, AbstractDefinition, arithmetic_Module, arithmetic_Div, arithmetic_NumberLiteral, arithmetic_FunctionCall, arithmetic_DeclaredParameter, arithmetic_Expression, arithmetic_AbstractDefinition, arithmetic_Evaluation, arithmetic_SumExpression, Expression, arithmetic_Plus, arithmetic_Minus, arithmetic_Multi},
    associations={imports0, statements1, module3, right28, left31, right33, func36, args6, expr7, expression9, indexVariable11, expr13, left16, right18, left21, right23, left26},
    generalizations={gen_arithmetic_Definition_Statement, gen_arithmetic_Definition_AbstractDefinition, gen_arithmetic_Div_Expression, gen_arithmetic_NumberLiteral_Expression, gen_arithmetic_FunctionCall_Expression, gen_arithmetic_DeclaredParameter_AbstractDefinition, gen_arithmetic_Evaluation_Statement, gen_arithmetic_SumExpression_Expression, gen_arithmetic_Plus_Expression, gen_arithmetic_Minus_Expression, gen_arithmetic_Multi_Expression},
    metadata=None
)
