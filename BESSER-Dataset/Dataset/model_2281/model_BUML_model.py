...
# Classes
model_Student = Class(name="model_Student")
model_Course = Class(name="model_Course")
model_Delivery = Class(name="model_Delivery")
model_Exercise = Class(name="model_Exercise")
model_Response = Class(name="model_Response")
...
model_Course.attributes={model_Course_ID, model_Course_name}
...
model_Delivery.attributes={model_Delivery_ID, model_Delivery_group_number, model_Delivery_answer, model_Delivery_submission_date}
...
model_Exercise.attributes={model_Exercise_ID, model_Exercise_deadline_date}
...
model_Response.attributes={model_Response_ID, model_Response_ok, model_Response_comment}
...
domain_model = DomainModel(
    name="model",
    types={model_Student, model_Course, model_Delivery, model_Exercise, model_Response, model_root},
    associations={containsStudent0, containsCourse1, containsDelivery3, attends5, submits8, hasSubmitted11, assignedTo13, contains16, evaluates19},
    generalizations={},
    metadata=None
)
