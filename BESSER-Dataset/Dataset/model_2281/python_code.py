...
class model_Exercise:
    ...
    def __init__(self, ID: int, deadline_date: date, model_Exercise: set["model_Delivery"] = None, model_Exercise14: set["model_Student"] = None, model_Exercise18: "model_Course" = None):
        self.ID = ID
...
class model_Course:
    ...
    def __init__(self, ID: int, name: str, model_Course: "model_root" = None, model_Course7: "model_Student" = None, model_Course17: set["model_Exercise"] = None):
        self.ID = ID
        self.name = name
