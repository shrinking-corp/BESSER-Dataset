...
class WebUser:
    ...
    def __init__(self, Enter_to_Travel_Website: str, state: UserState, shoppingCart2: "ShoppingCart" = None, customer4: "Customer" = None):
        self.Enter_to_Travel_Website = Enter_to_Travel_Website
        self.state = state
    ...
    @property
    def Enter_to_Travel_Website(self):
        return self.__Enter_to_Travel_Website
    @Enter_to_Travel_Website.setter
    def Enter_to_Travel_Website(self, Enter_to_Travel_Website: str):
        self.__Enter_to_Travel_Website = Enter_to_Travel_Website
