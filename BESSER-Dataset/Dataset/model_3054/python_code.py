...
class hibernate_Entity(NamedElement):
    ...
    def __init__(self, annotations: str, hibernate_Entity: "hibernate_Package" = None, hibernate_Entity4: set["hibernate_Feature"] = None, hibernate_Entity7: "hibernate_Entity" = None, hibernate_Entity5: "hibernate_Entity" = None, hibernate_Entity9: "hibernate_Reference" = None):
...
class hibernate_Feature(NamedElement):
    ...
    def __init__(self, annotations: str, many: bool, hibernate_Feature: "hibernate_Entity" = None):
        self.annotations = annotations
        self.many = many
