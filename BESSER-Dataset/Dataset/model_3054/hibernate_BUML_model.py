...
# Classes
hibernate_Reference = Class(name="hibernate_Reference")
Feature = Class(name="Feature")
hibernate_Module = Class(name="hibernate_Module")
NamedElement = Class(name="NamedElement")
hibernate_Package = Class(name="hibernate_Package")
hibernate_Entity = Class(name="hibernate_Entity")
hibernate_NamedElement = Class(name="hibernate_NamedElement", is_abstract=True)
hibernate_Feature = Class(name="hibernate_Feature", is_abstract=True)
hibernate_DataType = Class(name="hibernate_DataType")
...
domain_model = DomainModel(
    name="hibernate",
    types={hibernate_Reference, Feature, hibernate_Module, NamedElement, hibernate_Package, hibernate_Entity, hibernate_NamedElement, hibernate_Feature, hibernate_DataType, DataTypes, EntityAnnotation, FetureAnnotation},
    associations={packages0, entities1, features3, superEntity6, reference8},
    generalizations={gen_hibernate_Reference_Feature, gen_hibernate_Module_NamedElement, gen_hibernate_Package_NamedElement, gen_hibernate_Entity_NamedElement, gen_hibernate_Feature_NamedElement, gen_hibernate_DataType_Feature},
    metadata=None
)
