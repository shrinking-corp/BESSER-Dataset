...
class cfgraph_ControlFlowEdge:
    ...
    def __init__(self, backward: bool, cfgraph_ControlFlowEdge: "cfgraph_StartVertex" = None, ControlFlowEdge: "cfgraph_BodyVertex" = None, incomingEdges: "cfgraph_BodyVertex" = None, cfgraph_ControlFlowEdge6: "cfgraph_StatementVertex" = None, cfgraph_ControlFlowEdge10: "cfgraph_BranchingVertex" = None):
