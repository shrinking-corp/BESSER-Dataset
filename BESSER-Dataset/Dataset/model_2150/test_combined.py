...
def test_hyp_statementvertex_is_not_abstract():
    assert not inspect.isabstract(StatementVertex)


def test_hyp_statementvertex_constructor_exists():
    assert callable(StatementVertex.__init__)


def test_hyp_statementvertex_constructor_args():
    sig = inspect.signature(StatementVertex.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cfgraph_callvertex_is_not_abstract():
    assert not inspect.isabstract(cfgraph_CallVertex)


def test_hyp_cfgraph_callvertex_constructor_exists():
    assert callable(cfgraph_CallVertex.__init__)


def test_hyp_cfgraph_callvertex_constructor_args():
    sig = inspect.signature(cfgraph_CallVertex.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cfgraph_simplestatementvertex_is_not_abstract():
    assert not inspect.isabstract(cfgraph_SimpleStatementVertex)


def test_hyp_cfgraph_simplestatementvertex_constructor_exists():
    assert callable(cfgraph_SimpleStatementVertex.__init__)


def test_hyp_cfgraph_simplestatementvertex_constructor_args():
    sig = inspect.signature(cfgraph_SimpleStatementVertex.__init__)
    params = list(sig.parameters.keys())



def test_hyp_controlflowvertex_is_not_abstract():
    assert not inspect.isabstract(ControlFlowVertex)


def test_hyp_controlflowvertex_constructor_exists():
    assert callable(ControlFlowVertex.__init__)


def test_hyp_controlflowvertex_constructor_args():
    sig = inspect.signature(ControlFlowVertex.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cfgraph_controlflowvertex_is_not_abstract():
    assert not inspect.isabstract(cfgraph_ControlFlowVertex)


def test_hyp_cfgraph_controlflowvertex_constructor_exists():
    assert callable(cfgraph_ControlFlowVertex.__init__)


def test_hyp_cfgraph_controlflowvertex_constructor_args():
    sig = inspect.signature(cfgraph_ControlFlowVertex.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cfgraph_bodyvertex_is_not_abstract():
    assert not inspect.isabstract(cfgraph_BodyVertex)


def test_hyp_cfgraph_bodyvertex_constructor_exists():
    assert callable(cfgraph_BodyVertex.__init__)


def test_hyp_cfgraph_bodyvertex_constructor_args():
    sig = inspect.signature(cfgraph_BodyVertex.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cfgraph_controlflowedge_is_not_abstract():
    assert not inspect.isabstract(cfgraph_ControlFlowEdge)


def test_hyp_cfgraph_controlflowedge_constructor_exists():
    assert callable(cfgraph_ControlFlowEdge.__init__)


def test_hyp_cfgraph_controlflowedge_constructor_args():
...
def test_hyp_cfgraph_startvertex_is_not_abstract():
    assert not inspect.isabstract(cfgraph_StartVertex)


def test_hyp_cfgraph_startvertex_constructor_exists():
    assert callable(cfgraph_StartVertex.__init__)


def test_hyp_cfgraph_startvertex_constructor_args():
    sig = inspect.signature(cfgraph_StartVertex.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cfgraph_controlflowgraph_is_not_abstract():
    assert not inspect.isabstract(cfgraph_ControlFlowGraph)


def test_hyp_cfgraph_controlflowgraph_constructor_exists():
    assert callable(cfgraph_ControlFlowGraph.__init__)


def test_hyp_cfgraph_controlflowgraph_constructor_args():
    sig = inspect.signature(cfgraph_ControlFlowGraph.__init__)
    params = list(sig.parameters.keys())



def test_hyp_bodyvertex_is_not_abstract():
    assert not inspect.isabstract(BodyVertex)


def test_hyp_bodyvertex_constructor_exists():
    assert callable(BodyVertex.__init__)


def test_hyp_bodyvertex_constructor_args():
    sig = inspect.signature(BodyVertex.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cfgraph_branchingvertex_is_not_abstract():
    assert not inspect.isabstract(cfgraph_BranchingVertex)


def test_hyp_cfgraph_branchingvertex_constructor_exists():
    assert callable(cfgraph_BranchingVertex.__init__)


def test_hyp_cfgraph_branchingvertex_constructor_args():
    sig = inspect.signature(cfgraph_BranchingVertex.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cfgraph_statementvertex_is_not_abstract():
    assert not inspect.isabstract(cfgraph_StatementVertex)


def test_hyp_cfgraph_statementvertex_constructor_exists():
    assert callable(cfgraph_StatementVertex.__init__)


def test_hyp_cfgraph_statementvertex_constructor_args():
    sig = inspect.signature(cfgraph_StatementVertex.__init__)
    params = list(sig.parameters.keys())



def test_hyp_cfgraph_endvertex_is_not_abstract():
    assert not inspect.isabstract(cfgraph_EndVertex)


def test_hyp_cfgraph_endvertex_constructor_exists():
    assert callable(cfgraph_EndVertex.__init__)


def test_hyp_cfgraph_endvertex_constructor_args():
...
def test_hyp_cfgraph_controlflowedge_backward_setter(instance):
