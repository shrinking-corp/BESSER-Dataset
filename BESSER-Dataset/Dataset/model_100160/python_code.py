...
class nosql_Column:
    ...
    def __init__(self, name: str, nosql_Column12: "nosql_DynamicColumnFamily" = None, nosql_Column: "nosql_ColumnFamily" = None, nosql_Column8: "nosql_ColumnFamily" = None, nosql_Column10: "nosql_Type" = None):
        self.name = name
...
class nosql_ColumnFamily(ABC):
    ...
    def __init__(self, name: str, nosql_ColumnFamily: "nosql_KeySpace" = None, nosql_ColumnFamily2: "nosql_KeySpace" = None, nosql_ColumnFamily5: set["nosql_Column"] = None, nosql_ColumnFamily7: set["nosql_Column"] = None):
        self.name = name
