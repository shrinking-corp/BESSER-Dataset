...
# Relationships
partitionKey11: BinaryAssociation = BinaryAssociation(
    name="partitionKey11",
    ends={
...
domain_model = DomainModel(
    name="nosql",
    types={nosql_KeySpace, nosql_DynamicColumnFamily, ColumnFamily, nosql_ColumnFamily, nosql_Column, nosql_Type, nosql_StaticColumnFamily, nosql_PrimitiveType, Type, nosql_DataStructureType, nosql_MapType, DataStructureType, nosql_CollectionType, ReplicaPlacementStrategies, PrimitiveTypeType, CollectionTypeType},
    associations={partitionKey11, columnFamilies0, keyspace1, columns4, primaryKey6, type9},
    generalizations={gen_nosql_DynamicColumnFamily_ColumnFamily, gen_nosql_StaticColumnFamily_ColumnFamily, gen_nosql_PrimitiveType_Type, gen_nosql_DataStructureType_Type, gen_nosql_MapType_DataStructureType, gen_nosql_CollectionType_DataStructureType},
    metadata=None
)
