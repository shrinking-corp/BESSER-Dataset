...
Menu.attributes={Menu_starter, Menu_mainCourse, Menu_specialCourse, Menu_desert}
...
Drinks.attributes={Drinks_cocktail, Drinks_wine, Drinks_beer, Drinks_spirits, Drinks_softDrink}
...
Waiter_Input_payment_details: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="input_payment_details22", type=Input_payment_details_external, multiplicity=Multiplicity(0, 1)),
...
Kitchen_Staff_Alerted_to_Prepare_food: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="alerted_to_Prepare_food24", type=Alerted_to_Prepare_food_external, multiplicity=Multiplicity(0, 1)),
        Property(name="kitchen_Staff25", type=Kitchen_Staff_Actor, multiplicity=Multiplicity(0, 1))
    }
)
Bar_Staff_Alerted_to_Prepare_drinks: BinaryAssociation = BinaryAssociation(
    name="Bar_Staff_Alerted_to_Prepare_drinks",
    ends={
        Property(name="alerted_to_Prepare_drinks26", type=Alerted_to_Prepare_drinks_external, multiplicity=Multiplicity(0, 1)),
        Property(name="bar_Staff27", type=Bar_Staff_Actor, multiplicity=Multiplicity(0, 1))
    }
)
Management_Grant_discount: BinaryAssociation = BinaryAssociation(
    name="Management_Grant_discount",
    ends={
        Property(name="grant_discount28", type=Grant_discount_external, multiplicity=Multiplicity(0, 1)),
        Property(name="management29", type=Management_Actor, multiplicity=Multiplicity(0, 1))
    }
)
Management_View_statistics: BinaryAssociation = BinaryAssociation(
    name="Management_View_statistics",
    ends={
        Property(name="view_statistics30", type=View_statistics_external, multiplicity=Multiplicity(0, 1)),
...
Waiter_Input_Order2: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="input_Order32", type=Input_Order_external, multiplicity=Multiplicity(0, 1)),
        Property(name="waiter33", type=Waiter_Actor, multiplicity=Multiplicity(0, 1))
    }
)
...
Bill_Order: BinaryAssociation = BinaryAssociation(
    name="Bill_Order",
    ends={
        Property(name="Bill_Order_02", type=Order, multiplicity=Multiplicity(0, 9999)),
        Property(name="Bill_Order_13", type=Bill, multiplicity=Multiplicity(1, 1))
    }
)
Order_Menu: BinaryAssociation = BinaryAssociation(
    name="Order_Menu",
    ends={
        Property(name="Order_Menu_04", type=Menu, multiplicity=Multiplicity(0, 9999)),
        Property(name="Order_Menu_15", type=Order, multiplicity=Multiplicity(0, 1))
    }
)
Order_Drinks: BinaryAssociation = BinaryAssociation(
    name="Order_Drinks",
    ends={
        Property(name="Order_Drinks_06", type=Drinks, multiplicity=Multiplicity(0, 9999)),
        Property(name="Order_Drinks_17", type=Order, multiplicity=Multiplicity(0, 1))
    }
)
Bill_Discount: BinaryAssociation = BinaryAssociation(
    name="Bill_Discount",
    ends={
        Property(name="discount8", type=Discount, multiplicity=Multiplicity(0, 9999)),
        Property(name="bill9", type=Bill, multiplicity=Multiplicity(0, 1))
    }
)
Diner_Order_food: BinaryAssociation = BinaryAssociation(
    name="Diner_Order_food",
    ends={
        Property(name="order_food10", type=Order_food_UseCase1, multiplicity=Multiplicity(0, 1)),
        Property(name="diner11", type=Diner_Actor, multiplicity=Multiplicity(0, 1))
    }
)
Diner_Pay_for_food: BinaryAssociation = BinaryAssociation(
    name="Diner_Pay_for_food",
    ends={
        Property(name="pay_for_food12", type=Pay_for_food_UseCase1, multiplicity=Multiplicity(0, 1)),
...
Waiter_Input_Order: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="input_Order14", type=Input_Order_external, multiplicity=Multiplicity(0, 1)),
        Property(name="waiter15", type=Waiter_Actor, multiplicity=Multiplicity(0, 1))
    }
)
Waiter_Alerted_to_Serve_drinks: BinaryAssociation = BinaryAssociation(
    name="Waiter_Alerted_to_Serve_drinks",
    ends={
        Property(name="alerted_to_Serve_drinks16", type=Alerted_to_Serve_drinks_external, multiplicity=Multiplicity(0, 1)),
...
Waiter_Alerted_to_Serve_Food: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="alerted_to_Serve_Food18", type=Alerted_to_Serve_Food_external, multiplicity=Multiplicity(0, 1)),
...
Waiter_Print_bill: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="print_bill20", type=Print_bill_external, multiplicity=Multiplicity(0, 1)),
...
domain_model = DomainModel(
    name="fcbf20e8_06c8_4a8d_9c22_65908d0c9517",
    types={Bill, Payment, Order, Menu, Drinks, Discount, Input_Order_UseCase, Order_food_UseCase, Alerted_to_Prepare_food_UseCase, Alerted_to_Serve_drinks_UseCase, Alerted_to_Serve_Food_UseCase, Print_bill_UseCase, Alerted_to_Prepare_drinks_UseCase, Pay_for_food_UseCase, Grant_discount_UseCase, Input_payment_details_UseCase, Change_Order_UseCase, View_statistics_UseCase, Diner_Actor, Waiter_Actor, Kitchen_Staff_Actor, Bar_Staff_Actor, Management_Actor, _Component, Order_food_UseCase1, Pay_for_food_UseCase1, Input_payment_details_external, Alerted_to_Prepare_food_external, Alerted_to_Prepare_drinks_external, Grant_discount_external, View_statistics_external, Input_Order_external, Alerted_to_Serve_drinks_external, Alerted_to_Serve_Food_external, Print_bill_external},
    associations={Waiter_Input_payment_details, Kitchen_Staff_Alerted_to_Prepare_food, Bar_Staff_Alerted_to_Prepare_drinks, Management_Grant_discount, Management_View_statistics, Waiter_Input_Order2, Bill_Payment, Bill_Order, Order_Menu, Order_Drinks, Bill_Discount, Diner_Order_food, Diner_Pay_for_food, Waiter_Input_Order, Waiter_Alerted_to_Serve_drinks, Waiter_Alerted_to_Serve_Food, Waiter_Print_bill},
    generalizations={},
    metadata=None
)
