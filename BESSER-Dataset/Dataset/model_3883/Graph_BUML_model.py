...
# Classes
graph_Node = Class(name="graph_Node", is_abstract=True)
graph_Center = Class(name="graph_Center")
Node = Class(name="Node")
graph_Boundary = Class(name="graph_Boundary")
graph_G = Class(name="graph_G")
