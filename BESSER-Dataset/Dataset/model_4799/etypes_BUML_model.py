...
# Classes
primitives_Bag = Class(name="primitives_Bag")
primitives_Primitive = Class(name="primitives_Primitive")
...
primitives_Primitive.attributes={primitives_Primitive_double, primitives_Primitive_javaObj, primitives_Primitive_int, primitives_Primitive_string, primitives_Primitive_characterObj, primitives_Primitive_javaClass, primitives_Primitive_byteArray, primitives_Primitive_date, primitives_Primitive_doubleObj, primitives_Primitive_shortObj, primitives_Primitive_boolean, primitives_Primitive_longObj, primitives_Primitive_floatObj, primitives_Primitive_byteObj, primitives_Primitive_bigdecimal, primitives_Primitive_byte, primitives_Primitive_long, primitives_Primitive_char, primitives_Primitive_bigint, primitives_Primitive_integerObj, primitives_Primitive_float, primitives_Primitive_short, primitives_Primitive_booleanObj}
...
domain_model = DomainModel(
    name="primitives",
    types={primitives_Bag, primitives_Primitive},
