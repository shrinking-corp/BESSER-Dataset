...
class primitives_Primitive:
    ...
    def __init__(self, booleanObj: str, byte: str, byteArray: str, byteObj: str, char: str, characterObj: str, date: date, double: float, doubleObj: str, float: float, floatObj: str, int: int, integerObj: str, javaClass: str, javaObj: str, long: str, longObj: str, short: str, shortObj: str, string: str, bigdecimal: str, bigint: str, boolean: bool, primitives_Primitive: "primitives_Bag" = None):
