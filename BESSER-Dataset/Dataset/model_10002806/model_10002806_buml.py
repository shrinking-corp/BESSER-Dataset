...
domain_model = DomainModel(
    name="dd94ac78_0c2f_4796_b0ad_2e7da2d889ed",
    ...
    associations={Employee_Access_Information, Admin_Student, Admin_Employee, Department_Course, Course_Subject, Department_Student, Department_Employee, Student_Access_Information, Access_Information_Attendance, Access_Information_Department},
    generalizations={},
    metadata=None
)
