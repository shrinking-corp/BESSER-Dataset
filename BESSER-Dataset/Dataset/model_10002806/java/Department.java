...
public class Department  {
    ...
    public Department(
        None students__,        None course,        None hod,        None teachers__    ) {
    ...
    public Department(
        None students__,        None course,        None hod,        None teachers__        ArrayList<Employee_Interface> employee_interfaces,        ArrayList<Student> students    ) {
        this.students__ = students__;
        this.course = course;
        this.hod = hod;
        this.teachers__ = teachers__;
