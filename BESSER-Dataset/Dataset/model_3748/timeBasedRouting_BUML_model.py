...
# Classes
timeBasedRouting_TimeBasedRouting = Class(name="timeBasedRouting_TimeBasedRouting")
ActionStep = Class(name="ActionStep")
timeBasedRouting_OccursModel = Class(name="timeBasedRouting_OccursModel")
timeBasedRouting_DailyOccursModel = Class(name="timeBasedRouting_DailyOccursModel")
OccursModel = Class(name="OccursModel")
timeBasedRouting_WeeklyOccursModel = Class(name="timeBasedRouting_WeeklyOccursModel")
DynamicValue = Class(name="DynamicValue")
timeBasedRouting_TimeItem = Class(name="timeBasedRouting_TimeItem")
CaseItem = Class(name="CaseItem")
timeBasedRouting_MonthlyOccursModel = Class(name="timeBasedRouting_MonthlyOccursModel")
timeBasedRouting_TimeRange = Class(name="timeBasedRouting_TimeRange")
...
timeBasedRouting_OccursModel_m_isMatch: Method = Method(name="isMatch", parameters={Parameter(name='timeBasedRouting_date', type=StringType)}, type=BooleanType)
...
timeBasedRouting_WeeklyOccursModel.attributes={timeBasedRouting_WeeklyOccursModel_days, timeBasedRouting_WeeklyOccursModel_skipWeeks, timeBasedRouting_WeeklyOccursModel_startDate}
...
timeBasedRouting_MonthlyOccursModel.attributes={timeBasedRouting_MonthlyOccursModel_day, timeBasedRouting_MonthlyOccursModel_startDate, timeBasedRouting_MonthlyOccursModel_skipMonths, timeBasedRouting_MonthlyOccursModel_dayIndex, timeBasedRouting_MonthlyOccursModel_byIndex, timeBasedRouting_MonthlyOccursModel_dayOccurence}
...
timeBasedRouting_TimeRange_m_isMatch: Method = Method(name="isMatch", parameters={Parameter(name='timeBasedRouting_date', type=StringType)}, type=BooleanType)
timeBasedRouting_TimeRange.attributes={timeBasedRouting_TimeRange_name, timeBasedRouting_TimeRange_endRange, timeBasedRouting_TimeRange_startRange}
...
domain_model = DomainModel(
    ...
    types={timeBasedRouting_TimeBasedRouting, ActionStep, timeBasedRouting_OccursModel, timeBasedRouting_DailyOccursModel, OccursModel, timeBasedRouting_WeeklyOccursModel, DynamicValue, timeBasedRouting_TimeItem, CaseItem, timeBasedRouting_MonthlyOccursModel, timeBasedRouting_TimeRange, OccursMode, Day, DayOccurrence},
    associations={value0, times1, occursModel3},
    generalizations={gen_timeBasedRouting_TimeBasedRouting_ActionStep, gen_timeBasedRouting_DailyOccursModel_OccursModel, gen_timeBasedRouting_WeeklyOccursModel_OccursModel, gen_timeBasedRouting_TimeItem_CaseItem, gen_timeBasedRouting_MonthlyOccursModel_OccursModel},
    metadata=None
)
