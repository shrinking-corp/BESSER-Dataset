...
class timeBasedRouting_TimeRange:
    ...
    def __init__(self, name: str, startRange: date, endRange: date, timeBasedRouting_TimeRange: "timeBasedRouting_OccursModel" = None):
        self.name = name
    ...
    def isMatch(self, timeBasedRouting_date) :
