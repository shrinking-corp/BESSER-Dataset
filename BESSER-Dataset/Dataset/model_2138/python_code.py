...
class flowchart_Transition:
    ...
    def __init__(self, label: str, Transition: "flowchart_Node" = None, flowchart_Transition: "flowchart_Flowchart" = None, Transition5: "flowchart_Node" = None, outgoing: "flowchart_Node" = None, incoming: "flowchart_Node" = None):
        self.label = label
...
class flowchart_Node:
    ...
    def __init__(self, name: str, target: set["flowchart_Transition"] = None, flowchart_Node: "flowchart_Flowchart" = None, source: set["flowchart_Transition"] = None, flowchart_Node7: "flowchart_Action" = None, flowchart_Node9: "flowchart_Decision" = None, Node: "flowchart_Transition" = None, Node12: "flowchart_Transition" = None):
        self.name = name
