...
# Classes
flowchart_Flowchart = Class(name="flowchart_Flowchart")
flowchart_Node = Class(name="flowchart_Node")
flowchart_Transition = Class(name="flowchart_Transition")
flowchart_Action = Class(name="flowchart_Action")
flowchart_Decision = Class(name="flowchart_Decision")
...
flowchart_Decision.attributes={flowchart_Decision_isDecision, flowchart_Decision_condition}
...
domain_model = DomainModel(
    name="flowchart",
    types={flowchart_Flowchart, flowchart_Node, flowchart_Transition, flowchart_Action, flowchart_Decision},
    associations={incoming3, nodes0, transitions1, outgoing4, actionNode6, decisionNode8, source10, target11},
    generalizations={},
    metadata=None
)
