...
class sqlCrudGenerator_Table:
    ...
    def __init__(self, name: str, sqlCrudGenerator_Table: "sqlCrudGenerator_Schema" = None, sqlCrudGenerator_Table2: set["sqlCrudGenerator_Column"] = None, sqlCrudGenerator_Table4: "sqlCrudGenerator_PrimaryKey" = None, sqlCrudGenerator_Table6: set["sqlCrudGenerator_ForeignKey"] = None, sqlCrudGenerator_Table17: "sqlCrudGenerator_ForeignKey" = None):
        self.name = name
