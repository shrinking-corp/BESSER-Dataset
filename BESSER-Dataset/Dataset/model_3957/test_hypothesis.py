...
def test_km3_locatedelement_has_commentsBefore():
    assert hasattr(KM3_LocatedElement, "commentsBefore")
    descriptor = None
...
def test_km3_locatedelement_has_commentsAfter():
    assert hasattr(KM3_LocatedElement, "commentsAfter")
    descriptor = None
    for klass in KM3_LocatedElement.__mro__:
...
@given(instance=KM3_LocatedElement_strategy)
def test_km3_locatedelement_commentsBefore_setter(instance):
...
@given(instance=KM3_LocatedElement_strategy)
def test_km3_locatedelement_commentsAfter_setter(instance):
