...
class KM3_Class(Classifier):
    ...
    def __init__(self, isAbstract: bool, KM3_Class: "KM3_Class" = None, KM3_Class3: set["KM3_Class"] = None, owner: set["KM3_StructuralFeature"] = None, owner7: set["KM3_Operation"] = None, Class: "KM3_StructuralFeature" = None, Class19: "KM3_Operation" = None):
...
class KM3_TypedElement(ModelElement):
    ...
    def __init__(self, isOrdered: bool, isUnique: bool, lower: int, upper: int, KM3_TypedElement: "KM3_Classifier" = None):
