...
KM3_LocatedElement.attributes={KM3_LocatedElement_commentsBefore, KM3_LocatedElement_location, KM3_LocatedElement_commentsAfter}
...
KM3_TypedElement.attributes={KM3_TypedElement_lower, KM3_TypedElement_isUnique, KM3_TypedElement_isOrdered, KM3_TypedElement_upper}
...
domain_model = DomainModel(
    name="KM3",
    types={KM3_LocatedElement, KM3_ModelElement, LocatedElement, KM3_Package, KM3_Classifier, ModelElement, KM3_DataType, Classifier, KM3_Enumeration, KM3_EnumLiteral, KM3_Class, KM3_StructuralFeature, KM3_Operation, KM3_TypedElement, TypedElement, KM3_Attribute, StructuralFeature, KM3_Reference, KM3_Parameter, KM3_Metamodel},
    associations={package0, literals1, enum2, supertypes4, structuralFeatures5, operations6, type8, owner9, subsetOf11, derivedFrom14, opposite17, owner18, parameters20, owner22, contents24, metamodel27, contents28},
    generalizations={gen_KM3_ModelElement_LocatedElement, gen_KM3_Classifier_ModelElement, gen_KM3_DataType_Classifier, gen_KM3_Enumeration_Classifier, gen_KM3_EnumLiteral_ModelElement, gen_KM3_Class_Classifier, gen_KM3_TypedElement_ModelElement, gen_KM3_StructuralFeature_TypedElement, gen_KM3_Attribute_StructuralFeature, gen_KM3_Reference_StructuralFeature, gen_KM3_Operation_TypedElement, gen_KM3_Parameter_TypedElement, gen_KM3_Package_ModelElement, gen_KM3_Metamodel_LocatedElement},
    metadata=None
)
