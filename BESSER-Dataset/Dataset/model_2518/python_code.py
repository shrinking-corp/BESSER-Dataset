...
class model6_BaseObject:
    ...
    def __init__(self, attributeOptional: str, attributeRequired: str, attributeList: str, model6_BaseObject11: "model6_ReferenceObject" = None, model6_BaseObject14: "model6_ReferenceObject" = None, model6_BaseObject16: "model6_ContainmentObject" = None, model6_BaseObject19: "model6_ContainmentObject" = None, model6_BaseObject: "model6_Root" = None, model6_BaseObject3: "model6_Root" = None, model6_BaseObject6: "model6_Root" = None, model6_BaseObject9: "model6_Root" = None, model6_BaseObject43: "model6_G" = None, model6_BaseObject46: "model6_G" = None):
...
class model6_UnsettableAttributes:
    ...
    def __init__(self, attrLong: str, attrLongObject: str, attrShort: str, attrShortObject: str, attrString: str, attrBigDecimal: str, attrBigInteger: str, attrBoolean: bool, attrBooleanObject: str, attrByte: str, attrByteArray: str, attrByteObject: str, attrChar: str, attrCharacterObject: str, attrDate: date, attrDouble: float, attrDoubleObject: str, attrFloat: float, attrFloatObject: str, attrInt: int, attrIntegerObject: str, attrJavaClass: str, attrJavaObject: str):
