...
# Classes
model6_ReferenceObject = Class(name="model6_ReferenceObject")
BaseObject = Class(name="BaseObject")
model6_ContainmentObject = Class(name="model6_ContainmentObject")
model6_UnorderedList = Class(name="model6_UnorderedList")
model6_PropertiesMap = Class(name="model6_PropertiesMap")
model6_PropertiesMapEntry = Class(name="model6_PropertiesMapEntry")
model6_Root = Class(name="model6_Root")
model6_BaseObject = Class(name="model6_BaseObject")
model6_MyEnumList = Class(name="model6_MyEnumList")
model6_MyEnumListUnsettable = Class(name="model6_MyEnumListUnsettable")
model6_Holder = Class(name="model6_Holder")
Holdable = Class(name="Holdable")
model6_Holdable = Class(name="model6_Holdable", is_abstract=True)
model6_Thing = Class(name="model6_Thing")
model6_PropertiesMapEntryValue = Class(name="model6_PropertiesMapEntryValue")
model6_A = Class(name="model6_A")
model6_D = Class(name="model6_D")
model6_B = Class(name="model6_B")
model6_C = Class(name="model6_C")
model6_EObject = Class(name="model6_EObject")
model6_E = Class(name="model6_E")
model6_F = Class(name="model6_F")
model6_G = Class(name="model6_G")
model6_CanReferenceLegacy = Class(name="model6_CanReferenceLegacy")
model6_HasNillableAttribute = Class(name="model6_HasNillableAttribute")
model6_EmptyStringDefault = Class(name="model6_EmptyStringDefault")
model6_EmptyStringDefaultUnsettable = Class(name="model6_EmptyStringDefaultUnsettable")
model6_UnsettableAttributes = Class(name="model6_UnsettableAttributes")
...
model6_BaseObject.attributes={model6_BaseObject_attributeOptional, model6_BaseObject_attributeList, model6_BaseObject_attributeRequired}
...
model6_G.methods={model6_G_m_isAttributeModified, model6_G_m_isListModified, model6_G_m_isReferenceModified}
...
model6_UnsettableAttributes.attributes={model6_UnsettableAttributes_attrString, model6_UnsettableAttributes_attrDouble, model6_UnsettableAttributes_attrByteArray, model6_UnsettableAttributes_attrDate, model6_UnsettableAttributes_attrLongObject, model6_UnsettableAttributes_attrJavaClass, model6_UnsettableAttributes_attrBooleanObject, model6_UnsettableAttributes_attrFloatObject, model6_UnsettableAttributes_attrShort, model6_UnsettableAttributes_attrCharacterObject, model6_UnsettableAttributes_attrLong, model6_UnsettableAttributes_attrIntegerObject, model6_UnsettableAttributes_attrInt, model6_UnsettableAttributes_attrBigDecimal, model6_UnsettableAttributes_attrFloat, model6_UnsettableAttributes_attrBoolean, model6_UnsettableAttributes_attrDoubleObject, model6_UnsettableAttributes_attrByteObject, model6_UnsettableAttributes_attrByte, model6_UnsettableAttributes_attrShortObject, model6_UnsettableAttributes_attrJavaObject, model6_UnsettableAttributes_attrChar, model6_UnsettableAttributes_attrBigInteger}
...
domain_model = DomainModel(
    name="model6",
    types={model6_ReferenceObject, BaseObject, model6_ContainmentObject, model6_UnorderedList, model6_PropertiesMap, model6_PropertiesMapEntry, model6_Root, model6_BaseObject, model6_MyEnumList, model6_MyEnumListUnsettable, model6_Holder, Holdable, model6_Holdable, model6_Thing, model6_PropertiesMapEntryValue, model6_A, model6_D, model6_B, model6_C, model6_EObject, model6_E, model6_F, model6_G, model6_CanReferenceLegacy, model6_HasNillableAttribute, model6_EmptyStringDefault, model6_EmptyStringDefaultUnsettable, model6_UnsettableAttributes, MyEnum},
    associations={referenceOptional10, referenceList12, containmentOptional15, containmentList17, contained21, referenced23, persistentMap25, transientMap26, listA0, listB1, listC4, listD7, reference42, list44, held47, owned48, value29, ownedDs31, ownedBs32, ownedC34, data36, ownedAs38, ownedEs40, singleContainment51, multipleContainment53, singleReference56, multipleReference59},
