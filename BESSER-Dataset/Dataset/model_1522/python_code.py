...
class minifsm_Transition:
    ...
    def __init__(self, event: str, Transition: "minifsm_FSM" = None, minifsm_Transition: "minifsm_State" = None, minifsm_Transition5: "minifsm_State" = None, transitions: "minifsm_FSM" = None):
        self.event = event
...
class minifsm_FSM:
    ...
    def __init__(self, minifsm_FSM: set["minifsm_State"] = None, fsm: set["minifsm_Transition"] = None, FSM: "minifsm_Transition" = None):
