...
class TUWien_Student:
    ...
    def __init__(self, name: str, id: int, TUWien_Student: "TUWien_University" = None, student: set["TUWien_Course"] = None, Student: "TUWien_Course" = None):
        self.name = name
        self.id = id
...
class TUWien_Course:
    ...
    def __init__(self, id: str, name: str, TUWien_Course: "TUWien_University" = None, Course: "TUWien_Student" = None, course: set["TUWien_Student"] = None):
        self.id = id
        self.name = name
