...
# Classes
TUWien_University = Class(name="TUWien_University")
TUWien_Course = Class(name="TUWien_Course")
TUWien_Student = Class(name="TUWien_Student")
...
domain_model = DomainModel(
    ...
    associations={courses0, students1, course3, student4},
    generalizations={},
    metadata=None
)
