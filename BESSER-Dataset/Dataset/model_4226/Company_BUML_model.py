...
company_Visitable = Class(name="company_Visitable", is_abstract=True)
...
company_Employee.attributes={company_Employee_salary, company_Employee_name, company_Employee_address}
...
domain_model = DomainModel(
    name="company",
    types={company_Company, Visitable, company_Department, company_Employee, company_Visitable},
