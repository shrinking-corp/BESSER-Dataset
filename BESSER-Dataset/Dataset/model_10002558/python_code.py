...
class Hashtag:
    ...
    def __init__(self, name: str, numOfRepeat: int, user13: "User" = None):
        self.name = name
...
class User:
    ...
    def __init__(self, name: str, myprofile0: "Profile" = None, post2: set["Post"] = None, login4: "Login" = None, group6: set["Group"] = None, hashtag12: set["Hashtag"] = None, pages14: set["Page"] = None, registeration8: "Registration" = None, message10: set["Message"] = None):
        self.name = name
    ...
    def hashtag12(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_User__hashtag12", None)
