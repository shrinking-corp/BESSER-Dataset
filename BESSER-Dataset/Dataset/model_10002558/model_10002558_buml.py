...
Registration.attributes={Registration_fname, Registration_userName, Registration_password, Registration_lname}
...
User_Pages: BinaryAssociation = BinaryAssociation(
    name="User_Pages",
    ends={
        Property(name="pages14", type=Page, multiplicity=Multiplicity(0, 9999)),
...
domain_model = DomainModel(
    name="c0cd4cf5_dc27_474f_98f7_eb8a5d3ec801",
    types={User, Profile, Post, Group, Message, Friend, Hashtag, Page, Registration, Login, Interface_Interface, Enumeration_},
    associations={User_Myprofile, User_Post, User_Login, User_Group, User_Registeration, User_Message, User_Hashtag, User_Pages},
    generalizations={},
    metadata=None
)
