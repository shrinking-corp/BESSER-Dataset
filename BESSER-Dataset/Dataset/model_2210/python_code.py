...
class universityStudies_Specialization:
    ...
    def __init__(self, name: str, universityStudies_Specialization: "universityStudies_Programme" = None, universityStudies_Specialization8: "universityStudies_Specialization" = None, universityStudies_Specialization6: set["universityStudies_Specialization"] = None, universityStudies_Specialization10: set["universityStudies_Semester"] = None):
        self.name = name
...
class universityStudies_Programme:
    ...
    def __init__(self, programmeType: str, numberOfSemesters: int, name: str, universityStudies_Programme: "universityStudies_Course" = None, universityStudies_Programme2: set["universityStudies_Specialization"] = None, universityStudies_Programme4: set["universityStudies_Semester"] = None, Programmes: "universityStudies_Department" = None, Programme: "universityStudies_Department" = None):
...
class universityStudies_Course:
    ...
    def __init__(self, name: str, code: str, credits: str, level: int, universityStudies_Course: set["universityStudies_Programme"] = None, universityStudies_Course20: "universityStudies_CourseSlot" = None, universityStudies_Course22: "universityStudies_ElectiveCourseSlot" = None, universityStudies_Course15: "universityStudies_Department" = None):
        self.name = name
        self.code = code
