...
# Classes
universityStudies_Course = Class(name="universityStudies_Course")
universityStudies_CourseSlot = Class(name="universityStudies_CourseSlot", is_abstract=True)
universityStudies_Programme = Class(name="universityStudies_Programme")
universityStudies_Specialization = Class(name="universityStudies_Specialization")
universityStudies_Semester = Class(name="universityStudies_Semester")
universityStudies_Department = Class(name="universityStudies_Department")
universityStudies_MandatoryCourseSlot = Class(name="universityStudies_MandatoryCourseSlot")
CourseSlot = Class(name="CourseSlot")
universityStudies_ElectiveCourseSlot = Class(name="universityStudies_ElectiveCourseSlot")
...
universityStudies_Course.attributes={universityStudies_Course_credits, universityStudies_Course_name, universityStudies_Course_level, universityStudies_Course_code}
...
universityStudies_Programme.attributes={universityStudies_Programme_name, universityStudies_Programme_numberOfSemesters, universityStudies_Programme_programmeType}
...
domain_model = DomainModel(
    ...
    types={universityStudies_Course, universityStudies_CourseSlot, universityStudies_Programme, universityStudies_Specialization, universityStudies_Semester, universityStudies_Department, universityStudies_MandatoryCourseSlot, CourseSlot, universityStudies_ElectiveCourseSlot, ProgrammeType, Seasons, Credits},
    associations={furtherSpecializations7, semesters9, courseSlots12, Courses14, Programmes16, programmes0, specializations1, semesters3, Department5, course18, optionalCourses21},
