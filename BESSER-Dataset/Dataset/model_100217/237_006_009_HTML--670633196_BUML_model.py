...
HTML_BODY.attributes={HTML_BODY_vlink, HTML_BODY_alink, HTML_BODY_link, HTML_BODY_bgcolor, HTML_BODY_text, HTML_BODY_background}
...
HTML_EMBED.attributes={HTML_EMBED_hspace, HTML_EMBED_vspace, HTML_EMBED_border, HTML_EMBED_height, HTML_EMBED_src, HTML_EMBED_width, HTML_EMBED_align}
...
HTML_IMG.attributes={HTML_IMG_vspace, HTML_IMG_ismap, HTML_IMG_src, HTML_IMG_align, HTML_IMG_hspace, HTML_IMG_alt, HTML_IMG_height, HTML_IMG_width, HTML_IMG_usemap, HTML_IMG_border}
...
HTML_TD.attributes={HTML_TD_width, HTML_TD_align, HTML_TD_colspan, HTML_TD_valign, HTML_TD_rowspan}
...
HTML_INPUT.attributes={HTML_INPUT_align, HTML_INPUT_src, HTML_INPUT_size, HTML_INPUT_type, HTML_INPUT_maxlength, HTML_INPUT_checked, HTML_INPUT_name, HTML_INPUT_inputValue}
...
HTML_FRAMESET.attributes={HTML_FRAMESET_border, HTML_FRAMESET_frameborder, HTML_FRAMESET_rows, HTML_FRAMESET_cols, HTML_FRAMESET_framespacing}
...
HTML_FRAME.attributes={HTML_FRAME_marginheight, HTML_FRAME_noresize, HTML_FRAME_marginwidth, HTML_FRAME_name, HTML_FRAME_scrolling, HTML_FRAME_src}
...
HTML_APPLET.attributes={HTML_APPLET_src, HTML_APPLET_height, HTML_APPLET_align, HTML_APPLET_class_, HTML_APPLET_applet, HTML_APPLET_width}
...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={BODY, HTML_HTML, HEAD, HTMLElement, HTML_HTMLElement, HTML_TITLE, HTML_BODY, HTML_HEAD, HEADElement, HTML, HTML_HEADElement, HTML_LINK, HTML_B, HTML_I, HTML_TT, HTML_PRE, HTML_BIG, HTML_SMALL, HTML_SUB, HTML_SUP, HTML_STRIKE, HTML_FONT, BODYElement, HTML_BODYElement, HTML_H1, HTML_H2, HTML_H3, HTML_H4, HTML_EM, HTML_STRONG, HTML_BR, HTML_MAP, HTML_AREA, HTML_STYLE, HTML_EMBED, HTML_IMG, HTML_SPAN, HTML_A, HTML_DIV, HTML_P, HTML_TABLEElement, HTML_NOEMBED, TD, HTML_TD, HTML_TH, HTML_FORM, HTML_TABLE, TABLEElement, TR, HTML_TR, TABLE, HTML_SELECT, HTML_OPTION, HTML_ListElement, HTML_OL, ListElement, HTML_UL, HTML_LI, HTML_DL, HTML_INPUT, HTML_TEXTAREA, HTML_FRAMESET, HTML_FRAME, HTML_DT, HTML_DD, HTML_APPLET, HTML_PARAM, HTML_OBJECT, HTML_NOFRAME, HTML_IFRAME, FRAME},
    associations={head0, children3, body1, parent4, headElements6, html7, head9, bodyElements11, html12, body15, table18, tds19, tr20, trs17},
    generalizations={gen_HTML_TITLE_HEADElement, gen_HTML_BODY_HTMLElement, gen_HTML_HEAD_HTMLElement, gen_HTML_HEADElement_HTMLElement, gen_HTML_LINK_HEADElement, gen_HTML_B_BODYElement, gen_HTML_I_BODYElement, gen_HTML_TT_BODYElement, gen_HTML_PRE_BODYElement, gen_HTML_BIG_BODYElement, gen_HTML_SMALL_BODYElement, gen_HTML_SUB_BODYElement, gen_HTML_SUP_BODYElement, gen_HTML_STRIKE_BODYElement, gen_HTML_FONT_BODYElement, gen_HTML_BODYElement_HTMLElement, gen_HTML_H1_BODYElement, gen_HTML_H2_BODYElement, gen_HTML_H3_BODYElement, gen_HTML_H4_BODYElement, gen_HTML_EM_BODYElement, gen_HTML_STRONG_BODYElement, gen_HTML_BR_BODYElement, gen_HTML_MAP_BODYElement, gen_HTML_AREA_BODYElement, gen_HTML_STYLE_BODYElement, gen_HTML_EMBED_BODYElement, gen_HTML_IMG_BODYElement, gen_HTML_SPAN_BODYElement, gen_HTML_A_BODYElement, gen_HTML_DIV_BODYElement, gen_HTML_P_BODYElement, gen_HTML_TABLEElement_BODYElement, gen_HTML_NOEMBED_BODYElement, gen_HTML_TD_TABLEElement, gen_HTML_TH_TD, gen_HTML_TABLE_TABLEElement, gen_HTML_TR_TABLEElement, gen_HTML_OL_ListElement, gen_HTML_UL_ListElement, gen_HTML_LI_ListElement, gen_HTML_IFRAME_FRAME},
    metadata=None
)
