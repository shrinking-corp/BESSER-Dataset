...
# Classes
PyDslRep_Model = Class(name="PyDslRep_Model")
PyDslRep_Entity = Class(name="PyDslRep_Entity")
PyDslRep_Environment = Class(name="PyDslRep_Environment")
Entity = Class(name="Entity")
PyDslRep_IP = Class(name="PyDslRep_IP")
PyDslRep_Robot = Class(name="PyDslRep_Robot")
PyDslRep_MoveCollection = Class(name="PyDslRep_MoveCollection")
PyDslRep_Wheel = Class(name="PyDslRep_Wheel")
PyDslRep_AbstractDataMove = Class(name="PyDslRep_AbstractDataMove")
PyDslRep_AbstractMove = Class(name="PyDslRep_AbstractMove")
AbstractDataMove = Class(name="AbstractDataMove")
PyDslRep_DataMove = Class(name="PyDslRep_DataMove")
PyDslRep_AbstractCrossMove = Class(name="PyDslRep_AbstractCrossMove")
PyDslRep_Move = Class(name="PyDslRep_Move")
DataMove = Class(name="DataMove")
PyDslRep_Turn = Class(name="PyDslRep_Turn")
PyDslRep_Sensor = Class(name="PyDslRep_Sensor")
PyDslRep_TypeSensor = Class(name="PyDslRep_TypeSensor")
...
PyDslRep_Robot.attributes={PyDslRep_Robot_port, PyDslRep_Robot_name}
...
PyDslRep_MoveCollection.attributes={PyDslRep_MoveCollection_concurrent, PyDslRep_MoveCollection_name}
...
PyDslRep_DataMove.attributes={PyDslRep_DataMove_type, PyDslRep_DataMove_name, PyDslRep_DataMove_velocity}
...
domain_model = DomainModel(
    name="PyDslRep",
    types={PyDslRep_Model, PyDslRep_Entity, PyDslRep_Environment, Entity, PyDslRep_IP, PyDslRep_Robot, PyDslRep_MoveCollection, PyDslRep_Wheel, PyDslRep_AbstractDataMove, PyDslRep_AbstractMove, AbstractDataMove, PyDslRep_DataMove, PyDslRep_AbstractCrossMove, PyDslRep_Move, DataMove, PyDslRep_Turn, PyDslRep_Sensor, PyDslRep_TypeSensor},
    associations={environment0, ip1, robots2, moves4, wheels6, robot8, moves11, typeM13, type16, typeM14},
    generalizations={gen_PyDslRep_Robot_Entity, gen_PyDslRep_IP_Entity, gen_PyDslRep_Wheel_Entity, gen_PyDslRep_MoveCollection_Entity, gen_PyDslRep_AbstractMove_AbstractDataMove, gen_PyDslRep_AbstractCrossMove_AbstractDataMove, gen_PyDslRep_Environment_Entity, gen_PyDslRep_Move_DataMove, gen_PyDslRep_Turn_DataMove, gen_PyDslRep_Sensor_Entity, gen_PyDslRep_TypeSensor_Entity, gen_PyDslRep_DataMove_Entity},
    metadata=None
)
