...
def test_hyp_pydslrep_turn_is_not_abstract():
    assert not inspect.isabstract(PyDslRep_Turn)


def test_hyp_pydslrep_turn_constructor_exists():
    assert callable(PyDslRep_Turn.__init__)


def test_hyp_pydslrep_turn_constructor_args():
    sig = inspect.signature(PyDslRep_Turn.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pydslrep_move_is_not_abstract():
    assert not inspect.isabstract(PyDslRep_Move)


def test_hyp_pydslrep_move_constructor_exists():
    assert callable(PyDslRep_Move.__init__)


def test_hyp_pydslrep_move_constructor_args():
...
def test_hyp_pydslrep_abstractcrossmove_is_not_abstract():
    assert not inspect.isabstract(PyDslRep_AbstractCrossMove)


def test_hyp_pydslrep_abstractcrossmove_constructor_exists():
    assert callable(PyDslRep_AbstractCrossMove.__init__)


def test_hyp_pydslrep_abstractcrossmove_constructor_args():
    sig = inspect.signature(PyDslRep_AbstractCrossMove.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pydslrep_abstractmove_is_not_abstract():
    assert not inspect.isabstract(PyDslRep_AbstractMove)


def test_hyp_pydslrep_abstractmove_constructor_exists():
    assert callable(PyDslRep_AbstractMove.__init__)


def test_hyp_pydslrep_abstractmove_constructor_args():
    sig = inspect.signature(PyDslRep_AbstractMove.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pydslrep_abstractdatamove_is_not_abstract():
    assert not inspect.isabstract(PyDslRep_AbstractDataMove)


def test_hyp_pydslrep_abstractdatamove_constructor_exists():
    assert callable(PyDslRep_AbstractDataMove.__init__)


def test_hyp_pydslrep_abstractdatamove_constructor_args():
...
def test_hyp_pydslrep_typesensor_is_not_abstract():
    assert not inspect.isabstract(PyDslRep_TypeSensor)


def test_hyp_pydslrep_typesensor_constructor_exists():
    assert callable(PyDslRep_TypeSensor.__init__)


def test_hyp_pydslrep_typesensor_constructor_args():
...
def test_hyp_pydslrep_robot_is_not_abstract():
    assert not inspect.isabstract(PyDslRep_Robot)


def test_hyp_pydslrep_robot_constructor_exists():
    assert callable(PyDslRep_Robot.__init__)


def test_hyp_pydslrep_robot_constructor_args():
...
def test_hyp_pydslrep_sensor_is_not_abstract():
    assert not inspect.isabstract(PyDslRep_Sensor)


def test_hyp_pydslrep_sensor_constructor_exists():
    assert callable(PyDslRep_Sensor.__init__)


def test_hyp_pydslrep_sensor_constructor_args():
...
def test_hyp_pydslrep_movecollection_is_not_abstract():
    assert not inspect.isabstract(PyDslRep_MoveCollection)


def test_hyp_pydslrep_movecollection_constructor_exists():
    assert callable(PyDslRep_MoveCollection.__init__)


def test_hyp_pydslrep_movecollection_constructor_args():
...
def test_hyp_pydslrep_datamove_is_not_abstract():
    assert not inspect.isabstract(PyDslRep_DataMove)


def test_hyp_pydslrep_datamove_constructor_exists():
    assert callable(PyDslRep_DataMove.__init__)


def test_hyp_pydslrep_datamove_constructor_args():
...
def test_hyp_pydslrep_ip_is_not_abstract():
    assert not inspect.isabstract(PyDslRep_IP)


def test_hyp_pydslrep_ip_constructor_exists():
    assert callable(PyDslRep_IP.__init__)


def test_hyp_pydslrep_ip_constructor_args():
...
def test_hyp_pydslrep_wheel_is_not_abstract():
    assert not inspect.isabstract(PyDslRep_Wheel)


def test_hyp_pydslrep_wheel_constructor_exists():
    assert callable(PyDslRep_Wheel.__init__)


def test_hyp_pydslrep_wheel_constructor_args():
...
def test_hyp_pydslrep_environment_is_not_abstract():
    assert not inspect.isabstract(PyDslRep_Environment)


def test_hyp_pydslrep_environment_constructor_exists():
    assert callable(PyDslRep_Environment.__init__)


def test_hyp_pydslrep_environment_constructor_args():
...
def test_hyp_pydslrep_entity_is_not_abstract():
    assert not inspect.isabstract(PyDslRep_Entity)


def test_hyp_pydslrep_entity_constructor_exists():
    assert callable(PyDslRep_Entity.__init__)


def test_hyp_pydslrep_entity_constructor_args():
    sig = inspect.signature(PyDslRep_Entity.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pydslrep_model_is_not_abstract():
    assert not inspect.isabstract(PyDslRep_Model)


def test_hyp_pydslrep_model_constructor_exists():
    assert callable(PyDslRep_Model.__init__)


def test_hyp_pydslrep_model_constructor_args():
...
def test_hyp_pydslrep_move_distance_setter(instance):
...
def test_hyp_pydslrep_typesensor_typeName_setter(instance):
...
def test_hyp_pydslrep_robot_port_setter(instance):
...
@given(instance=PyDslRep_Robot_strategy)
def test_hyp_pydslrep_robot_name_setter(instance):
...
def test_hyp_pydslrep_sensor_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_pydslrep_movecollection_concurrent_setter(instance):
...
@given(instance=PyDslRep_MoveCollection_strategy)
def test_hyp_pydslrep_movecollection_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_pydslrep_datamove_type_setter(instance):
...
@given(instance=PyDslRep_DataMove_strategy)
def test_hyp_pydslrep_datamove_velocity_setter(instance):
...
@given(instance=PyDslRep_DataMove_strategy)
def test_hyp_pydslrep_datamove_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_pydslrep_ip_ip_setter(instance):
...
@given(instance=PyDslRep_IP_strategy)
def test_hyp_pydslrep_ip_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_pydslrep_wheel_radius_setter(instance):
...
@given(instance=PyDslRep_Wheel_strategy)
def test_hyp_pydslrep_wheel_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_pydslrep_environment_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
