...
# Classes
systemworkbench102_Workbench = Class(name="systemworkbench102_Workbench")
Named = Class(name="Named")
systemworkbench102_Thing = Class(name="systemworkbench102_Thing")
systemworkbench102_Thoughts = Class(name="systemworkbench102_Thoughts")
systemworkbench102_System = Class(name="systemworkbench102_System")
systemworkbench102_FunctionProperty = Class(name="systemworkbench102_FunctionProperty")
systemworkbench102_PatternCatalog = Class(name="systemworkbench102_PatternCatalog")
NamedElement = Class(name="NamedElement")
systemworkbench102_Named = Class(name="systemworkbench102_Named")
systemworkbench102_RelatedTo = Class(name="systemworkbench102_RelatedTo")
systemworkbench102_NamedElement = Class(name="systemworkbench102_NamedElement", is_abstract=True)
systemworkbench102_Component = Class(name="systemworkbench102_Component")
systemworkbench102_Function = Class(name="systemworkbench102_Function")
...
domain_model = DomainModel(
    ...
    types={systemworkbench102_Workbench, Named, systemworkbench102_Thing, systemworkbench102_Thoughts, systemworkbench102_System, systemworkbench102_FunctionProperty, systemworkbench102_PatternCatalog, NamedElement, systemworkbench102_Named, systemworkbench102_RelatedTo, systemworkbench102_NamedElement, systemworkbench102_Component, systemworkbench102_Function},
    associations={things0, thoughts1, systemView3, functionProperties5, catalog7, fromThing10, toThing11, relatedTo13, parent17, relations9, property29, associations33, allocatedTo35, functionalArchitecture38, physicalArchitecture41, patterns44, decompositions20, associations22, performs24, decompositions27},
    generalizations={gen_systemworkbench102_Workbench_Named, gen_systemworkbench102_Thing_NamedElement, gen_systemworkbench102_RelatedTo_NamedElement, gen_systemworkbench102_Thoughts_NamedElement, gen_systemworkbench102_FunctionProperty_Named, gen_systemworkbench102_System_Named, gen_systemworkbench102_Component_Named, gen_systemworkbench102_Function_Named},
    metadata=None
)
