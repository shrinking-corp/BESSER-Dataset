...
class systemworkbench102_RelatedTo(NamedElement):
    ...
    def __init__(self, since: str, relations: "systemworkbench102_Thing" = None, systemworkbench102_RelatedTo: "systemworkbench102_Thing" = None, RelatedTo: "systemworkbench102_Thing" = None):
        self.since = since
...
class systemworkbench102_Thing(NamedElement):
    ...
    def __init__(self, id: int, systemworkbench102_Thing: "systemworkbench102_Workbench" = None, Thing: "systemworkbench102_RelatedTo" = None, systemworkbench102_Thing12: "systemworkbench102_RelatedTo" = None, systemworkbench102_Thing15: "systemworkbench102_Thoughts" = None, fromThing: set["systemworkbench102_RelatedTo"] = None):
        self.id = id
...
class systemworkbench102_Workbench(Named):
    ...
    def __init__(self, aprop: str, systemworkbench102_Workbench: set["systemworkbench102_Thing"] = None, systemworkbench102_Workbench2: set["systemworkbench102_Thoughts"] = None, systemworkbench102_Workbench4: "systemworkbench102_System" = None, systemworkbench102_Workbench6: set["systemworkbench102_FunctionProperty"] = None, systemworkbench102_Workbench8: set["systemworkbench102_PatternCatalog"] = None):
        self.aprop = aprop
