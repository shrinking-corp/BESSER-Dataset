...
expression_AssignmentStatement = Class(name="expression_AssignmentStatement")
Statement = Class(name="Statement")
expression_Expression = Class(name="expression_Expression")
expression_VariableAssignmentStatement = Class(name="expression_VariableAssignmentStatement")
AssignmentStatement = Class(name="AssignmentStatement")
expression_Designator = Class(name="expression_Designator")
expression_Model = Class(name="expression_Model")
expression_Phrase = Class(name="expression_Phrase")
expression_StatementList = Class(name="expression_StatementList")
Phrase = Class(name="Phrase")
expression_ExpressionRest = Class(name="expression_ExpressionRest")
expression_KeyValuePair = Class(name="expression_KeyValuePair")
KeyValuePairRest = Class(name="KeyValuePairRest")
expression_KeyValuePairRest = Class(name="expression_KeyValuePairRest")
expression_Term = Class(name="expression_Term")
expression_List = Class(name="expression_List")
Term = Class(name="Term")
expression_EObject = Class(name="expression_EObject")
expression_OrExpression = Class(name="expression_OrExpression")
expression_SelfAssignmentStatement = Class(name="expression_SelfAssignmentStatement")
ExpressionRest = Class(name="ExpressionRest")
expression_FunctionCall = Class(name="expression_FunctionCall")
Expression = Class(name="Expression")
Function = Class(name="Function")
expression_ExpressionList = Class(name="expression_ExpressionList")
expression_ProcedureCall = Class(name="expression_ProcedureCall")
expression_Procedure = Class(name="expression_Procedure")
expression_DashExpression = Class(name="expression_DashExpression")
expression_PointExpression = Class(name="expression_PointExpression")
expression_PowExpression = Class(name="expression_PowExpression")
expression_AndExpression = Class(name="expression_AndExpression")
expression_EqualityExpression = Class(name="expression_EqualityExpression")
expression_ThereIsIn = Class(name="expression_ThereIsIn")
expression_ForallIn = Class(name="expression_ForallIn")
expression_FirstIn = Class(name="expression_FirstIn")
expression_LastIn = Class(name="expression_LastIn")
expression_QualifierExpression = Class(name="expression_QualifierExpression")
expression_Sum = Class(name="expression_Sum")
expression_Count = Class(name="expression_Count")
expression_Reduce = Class(name="expression_Reduce")
expression_UnaryExpression = Class(name="expression_UnaryExpression")
expression_StructureExpression = Class(name="expression_StructureExpression")
expression_Map = Class(name="expression_Map")
expression_Apply = Class(name="expression_Apply")
expression_StringValue = Class(name="expression_StringValue")
expression_IntegerValue = Class(name="expression_IntegerValue")
expression_DoubleValue = Class(name="expression_DoubleValue")
...
domain_model = DomainModel(
    name="expression",
    types={expression_Statement, expression_AssignmentStatement, Statement, expression_Expression, expression_VariableAssignmentStatement, AssignmentStatement, expression_Designator, expression_Model, expression_Phrase, expression_StatementList, Phrase, expression_ExpressionRest, expression_KeyValuePair, KeyValuePairRest, expression_KeyValuePairRest, expression_Term, expression_List, Term, expression_EObject, expression_OrExpression, expression_SelfAssignmentStatement, ExpressionRest, expression_FunctionCall, Expression, Function, expression_ExpressionList, expression_ProcedureCall, expression_Procedure, expression_DashExpression, expression_PointExpression, expression_PowExpression, expression_AndExpression, expression_EqualityExpression, expression_ThereIsIn, expression_ForallIn, expression_FirstIn, expression_LastIn, expression_QualifierExpression, expression_Sum, expression_Count, expression_Reduce, expression_UnaryExpression, expression_StructureExpression, expression_Map, expression_Apply, expression_StringValue, expression_IntegerValue, expression_DoubleValue},
    associations={head1, tail3, expression5, designator6, phrase0, head17, tail20, value22, rest24, structuredExpression26, terms28, value30, condition8, function10, params11, procedure13, params14, left47, right49, left52, right54, left57, left32, right34, left37, right39, left42, right44, right64, expr67, expr69, expr71, right59, left62, usingExpr79, initValue82, expr85, usingExpr87, expr73, expr75, expr77, expr97, expr100, structuredExpression102, keyValuePair105, expr90, usingExpr92, applyExpr95, structuredExpressions107},
    generalizations={gen_expression_StatementList_Phrase, gen_expression_AssignmentStatement_Statement, gen_expression_VariableAssignmentStatement_AssignmentStatement, gen_expression_KeyValuePair_KeyValuePairRest, gen_expression_Term_Expression, gen_expression_List_Term, gen_expression_Designator_Term, gen_expression_OrExpression_Expression, gen_expression_SelfAssignmentStatement_AssignmentStatement, gen_expression_Expression_Phrase, gen_expression_Expression_ExpressionRest, gen_expression_FunctionCall_Expression, gen_expression_DashExpression_Expression, gen_expression_PointExpression_Expression, gen_expression_PowExpression_Expression, gen_expression_AndExpression_Expression, gen_expression_EqualityExpression_Expression, gen_expression_ThereIsIn_Expression, gen_expression_ForallIn_Expression, gen_expression_FirstIn_Expression, gen_expression_LastIn_Expression, gen_expression_QualifierExpression_Expression, gen_expression_Sum_Expression, gen_expression_Count_Expression, gen_expression_Reduce_Expression, gen_expression_UnaryExpression_Expression, gen_expression_StructureExpression_Expression, gen_expression_Map_Expression, gen_expression_Apply_Expression, gen_expression_StringValue_Term, gen_expression_IntegerValue_Term, gen_expression_DoubleValue_Term},
    metadata=None
)
