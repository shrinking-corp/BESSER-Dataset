...
class expression_PowExpression(Expression):
    ...
    def __init__(self, op: str, expression_PowExpression60: "expression_Expression" = None, expression_PowExpression: "expression_Expression" = None):
        self.op = op
...
class expression_QualifierExpression(Expression):
    ...
    def __init__(self, op: str, expression_QualifierExpression65: "expression_Expression" = None, expression_QualifierExpression: "expression_Expression" = None):
        self.op = op
...
class expression_VariableAssignmentStatement(AssignmentStatement):
    ...
    pass
class expression_Expression(ExpressionRest, Phrase):
