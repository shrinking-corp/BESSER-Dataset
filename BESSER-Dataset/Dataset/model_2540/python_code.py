...
class traces_E(RootOut):
    ...
    def __init__(self, name: str, traces_E22: "traces_D" = None, traces_E27: "traces_D" = None, traces_E: "traces_R2_Trace" = None):
        self.name = name
...
class traces_B(RootIn):
    ...
    def __init__(self, name: str, traces_B18: "traces_A" = None, traces_B: "traces_R2_Trace" = None, traces_B14: "traces_A" = None):
        self.name = name
...
class traces_D(RootOut):
    ...
    def __init__(self, name: str, traces_D21: set["traces_E"] = None, traces_D25: "traces_D" = None, traces_D23: "traces_D" = None, traces_D28: "traces_E" = None, traces_D: "traces_R1_Trace" = None, traces_D8: "traces_R1_Trace" = None):
        self.name = name
...
class traces_A(RootIn):
    ...
    def __init__(self, name: str, traces_A16: set["traces_C"] = None, traces_A19: "traces_B" = None, traces_A: "traces_R1_Trace" = None, traces_A13: set["traces_B"] = None):
        self.name = name
