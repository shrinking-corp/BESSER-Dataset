...
# Classes
stm_Statemachine = Class(name="stm_Statemachine")
stm_Event = Class(name="stm_Event")
stm_Command = Class(name="stm_Command")
stm_Guard = Class(name="stm_Guard")
stm_State = Class(name="stm_State")
stm_GuardCall = Class(name="stm_GuardCall")
stm_Parameter = Class(name="stm_Parameter")
stm_SelfEvent = Class(name="stm_SelfEvent")
stm_Transition = Class(name="stm_Transition")
...
stm_Parameter.attributes={stm_Parameter_name, stm_Parameter_type}
...
domain_model = DomainModel(
    name="stm",
    types={stm_Statemachine, stm_Event, stm_Command, stm_Guard, stm_State, stm_GuardCall, stm_Parameter, stm_SelfEvent, stm_Transition},
    associations={events0, commands1, guards3, states5, entryActions7, doAction10, guard29, state31, action34, event37, guard40, action43, guard46, parameters49, stopAction13, states17, selfEvents19, transitions21, exitActions23, event26},
    generalizations={},
    metadata=None
)
