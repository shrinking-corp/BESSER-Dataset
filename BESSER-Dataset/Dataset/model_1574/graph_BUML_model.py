...
graph_Label = Class(name="graph_Label")
Typed = Class(name="Typed")
GraphElement = Class(name="GraphElement")
graph_Entry = Class(name="graph_Entry")
graph_Named = Class(name="graph_Named", is_abstract=True)
graph_Typed = Class(name="graph_Typed", is_abstract=True)
...
domain_model = DomainModel(
    name="graph",
    types={graph_Graph, Named, graph_Edge, graph_Vertex, graph_Label, Typed, GraphElement, graph_Entry, graph_Named, graph_Typed, graph_GraphElement},
    associations={edges0, graph3, label4, outgoingEdges5, ingoingEdges7, graph9, label11, SourceVertex13, targetVertex15, vertices1, entries22, label24, edge17, vertex19},
    generalizations={gen_graph_Graph_Named, gen_graph_Edge_Typed, gen_graph_Label_Named, gen_graph_Vertex_GraphElement, gen_graph_Typed_Named, gen_graph_GraphElement_Typed},
    metadata=None
)
