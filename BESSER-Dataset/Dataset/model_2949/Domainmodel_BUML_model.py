...
domainmodel_Feature.attributes={domainmodel_Feature_type, domainmodel_Feature_many, domainmodel_Feature_s, domainmodel_Feature_name}
...
domain_model = DomainModel(
    name="domainmodel",
    types={domainmodel_Domainmodel, domainmodel_Type, domainmodel_DataType, domainmodel_Entity, Type, domainmodel_Feature},
    associations={elements0, sd1, superType4, features5},
