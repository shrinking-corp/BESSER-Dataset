...
Hardware = Class(name="Hardware", is_abstract=True)
CPU1 = Class(name="CPU1")
RAM1 = Class(name="RAM1")
...
Hardware_serialNo: Property = Property(name="serialNo", type=StringType)
Hardware_manufacturer: Property = Property(name="manufacturer", type=StringType)
Hardware.attributes={Hardware_manufacturer, Hardware_serialNo}

# CPU1 class attributes and methods
CPU1_mhz: Property = Property(name="mhz", type=FloatType)
CPU1.attributes={CPU1_mhz}

# RAM1 class attributes and methods
RAM1_mb: Property = Property(name="mb", type=FloatType)
RAM1.attributes={RAM1_mb}
...
domain_model = DomainModel(
    name="f59b719c_9103_4019_9fca_4d1cbe4e8770",
    types={CPU, Processor, AcceleratorCard, Cache, RAM, Machine, Program, Instruction, Memory_Interface, DeviceCard, Card, Sound, GenericSound, Vendor1Adapter, Vendor2Adapter, Vendor1Sound, Vendor2Sound, ExtensionBoard, FastCard, Hardware, CPU1, RAM1},
