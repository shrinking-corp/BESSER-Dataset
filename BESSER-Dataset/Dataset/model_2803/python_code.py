...
class rules_Node:
    ...
    def __init__(self, type: str, rules_Node10: "rules_Rule" = None, rules_Node13: "rules_Rule" = None, rules_Node: "rules_Rule" = None, source: set["rules_NodeRelation"] = None, Node: "rules_NodeRelation" = None, rules_Node17: "rules_NodeRelation" = None):
        self.type = type
...
class rules_Rule:
    ...
    def __init__(self, name: str, rules_Rule9: set["rules_Node"] = None, rules_Rule12: set["rules_Node"] = None, rules_Rule: "rules_RulesLattice" = None, Rule: "rules_Rule" = None, parents: set["rules_Rule"] = None, Rule5: "rules_Rule" = None, children: set["rules_Rule"] = None, rules_Rule7: set["rules_Node"] = None):
        self.name = name
