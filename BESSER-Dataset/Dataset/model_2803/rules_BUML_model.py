...
# Classes
rules_RulesLattice = Class(name="rules_RulesLattice")
rules_Rule = Class(name="rules_Rule")
rules_Node = Class(name="rules_Node")
rules_NodeRelation = Class(name="rules_NodeRelation")
...
rules_RulesLattice.attributes={rules_RulesLattice_target, rules_RulesLattice_source}
...
rules_NodeRelation.attributes={rules_NodeRelation_relation, rules_NodeRelation_upperBound, rules_NodeRelation_relationTgt, rules_NodeRelation_lowerBound}
...
domain_model = DomainModel(
    ...
    associations={rules0, children2, parents4, premise6, relatedNodes14, source15, target16, conclusion8, nodes11},
    generalizations={},
    metadata=None
)
