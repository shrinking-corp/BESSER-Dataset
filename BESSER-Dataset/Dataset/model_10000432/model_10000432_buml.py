...
HouseHolds.attributes={HouseHolds_Coffee, HouseHolds_WashingMachine, HouseHolds_DishWasher, HouseHolds_Alarm, HouseHolds_TimeID}
...
domain_model = DomainModel(
    name="_3686cd0f_42d1_446b_9e77_b343458f2f01",
    ...
    associations={HomeTheatre_System, Home_Security_System_System, TV_Entertainment, Speakers_Entertainment, HomeTheatre_Entertainment, Sensor_Door, Door_Camera, HomeTheatre_TV, HomeTheatre_Speakers, HouseHolds_Start_Of_Day, HouseHolds_End_Of_Day, MicroPhone_System, Home_Security_System_Alert, Sensor_System, System_HouseHolds},
    generalizations={},
    metadata=None
)
