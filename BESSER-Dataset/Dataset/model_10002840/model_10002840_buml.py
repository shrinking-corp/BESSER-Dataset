...
domain_model = DomainModel(
    name="e1c57171_1264_422b_83ef_83f293d31e24",
    types={take_attendance_call_external, generate_class_wise_attendance_report_external, student_Actor, faculty_Actor, _Component, parent_Actor, admin_Actor, FACULTY, STUDENT, ADMIN, post_attendance_external, answer_attendance_call_external, view_subject_wise_attendance_external, view_cumiliative_attendance_external, login_external, logout_external, send_attendance_sms_external, recieve_attendance_sms_external, modify_list_of_students_external},
