...
# Classes
sm6_Transition = Class(name="sm6_Transition")
sm6_StateMachine = Class(name="sm6_StateMachine")
sm6_State = Class(name="sm6_State")
...
domain_model = DomainModel(
    name="sm6",
    types={sm6_Transition, sm6_StateMachine, sm6_State},
    associations={initialState0, states1, edges2, sm4, outgoing5, incoming6, src8, tgt10},
    generalizations={},
    metadata=None
)
