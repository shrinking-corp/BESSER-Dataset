...
class sm6_State:
    ...
    def __init__(self, name: str, isFinal: str, src: set["sm6_Transition"] = None, tgt: set["sm6_Transition"] = None, State9: "sm6_Transition" = None, State11: "sm6_Transition" = None, sm6_State: "sm6_StateMachine" = None, State: "sm6_StateMachine" = None, states: "sm6_StateMachine" = None):
        self.name = name
...
class sm6_Transition:
    ...
    def __init__(self, event: str, Transition: "sm6_State" = None, Transition7: "sm6_State" = None, outgoing: "sm6_State" = None, incoming: "sm6_State" = None, sm6_Transition: "sm6_StateMachine" = None):
        self.event = event
