...
class Customer:
    ...
    def __init__(self, emailAddress: str, name: str, dateOfBirth: date, address: str, phoneNumber: str, a1: set["account_Account"] = None, login4: "Login" = None):
...
class Login2:
    ...
    def __init__(self, username: str, securityAnswer: str, password: str, securityQuestion: str, lastLoginTime: date):
        self.username = username
        self.securityAnswer = securityAnswer
        self.password = password
        self.securityQuestion = securityQuestion
