...
# Classes
Employees_EmployeeContainer = Class(name="Employees_EmployeeContainer")
Employees_Employee = Class(name="Employees_Employee")
...
Employees_Employee.attributes={Employees_Employee_name, Employees_Employee_salary, Employees_Employee_ID}
