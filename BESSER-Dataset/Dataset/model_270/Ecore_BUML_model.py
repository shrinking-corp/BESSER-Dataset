...
Ecore_EStructuralFeature.attributes={Ecore_EStructuralFeature_transient, Ecore_EStructuralFeature_volatile, Ecore_EStructuralFeature_unsettable, Ecore_EStructuralFeature_changeable, Ecore_EStructuralFeature_derived, Ecore_EStructuralFeature_defaultValueLiteral, Ecore_EStructuralFeature_defaultValue}
...
Ecore_ETypedElement.attributes={Ecore_ETypedElement_many, Ecore_ETypedElement_upperBound, Ecore_ETypedElement_unique, Ecore_ETypedElement_required, Ecore_ETypedElement_lowerBound, Ecore_ETypedElement_ordered}
...
domain_model = DomainModel(
    name="Ecore",
    types={Ecore_EAttribute, EStructuralFeature, Ecore_EDataType, Ecore_EClass, EClassifier, Ecore_EStructuralFeature, Ecore_EClassifier, ENamedElement, Ecore_EOperation, Ecore_EReference, Ecore_ENamedElement, ETypedElement, Ecore_EParameter, Ecore_EPackage, Ecore_EEnum, EDataType, Ecore_EEnumLiteral, Ecore_ETypedElement, Ecore_EStringToStringMapEntry},
    associations={eAttributeType0, eAllContainments15, eAllOperations18, eAllStructuralFeatures20, eAllSuperTypes23, eIDAttribute25, eStructuralFeatures28, eSuperTypes2, eOperations3, eAllAttributes4, eAllReferences7, eReferences9, eAttributes12, eEnum32, eContainingClass33, eParameters34, eExceptions35, ePackage30, eLiterals31, eContainingClass55, eType57, eClassifiers37, eSubpackages39, eSuperPackage42, eOperation44, eOpposite47, eReferenceType49, eKeys52},
    generalizations={gen_Ecore_EAttribute_EStructuralFeature, gen_Ecore_EClass_EClassifier, gen_Ecore_EClassifier_ENamedElement, gen_Ecore_EOperation_ETypedElement, gen_Ecore_EPackage_ENamedElement, gen_Ecore_EDataType_EClassifier, gen_Ecore_EEnum_EDataType, gen_Ecore_EEnumLiteral_ENamedElement, gen_Ecore_ETypedElement_ENamedElement, gen_Ecore_EParameter_ETypedElement, gen_Ecore_EReference_EStructuralFeature, gen_Ecore_EStructuralFeature_ETypedElement},
    metadata=None
)
