...
class statemachine_Transition:
    ...
    def __init__(self, Id: int, statemachine_Transition2: "statemachine_State" = None, statemachine_Transition4: "statemachine_State" = None, statemachine_Transition: "statemachine_StateMachine" = None):
        self.Id = Id
