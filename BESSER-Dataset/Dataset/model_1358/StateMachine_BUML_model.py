...
domain_model = DomainModel(
    name="statemachine",
    types={statemachine_State, statemachine_Initial, State, statemachine_Final, statemachine_Simple, statemachine_StateMachine, statemachine_Transition},
    associations={source1, target3, transitions0},
