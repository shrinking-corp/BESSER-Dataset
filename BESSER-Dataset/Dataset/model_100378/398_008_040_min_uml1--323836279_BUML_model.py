...
# Classes
minuml1_State = Class(name="minuml1_State")
minuml1_Transition = Class(name="minuml1_Transition")
minuml1_ActivityGraph = Class(name="minuml1_ActivityGraph")
StateMachine = Class(name="StateMachine")
minuml1_ModelElement = Class(name="minuml1_ModelElement")
minuml1_Partition = Class(name="minuml1_Partition")
minuml1_StateMachine = Class(name="minuml1_StateMachine")
ModelElement = Class(name="ModelElement")
StateVertex = Class(name="StateVertex")
minuml1_CompositeState = Class(name="minuml1_CompositeState")
State = Class(name="State")
minuml1_StateVertex = Class(name="minuml1_StateVertex", is_abstract=True)
minuml1_FinalState = Class(name="minuml1_FinalState")
minuml1_ActionState = Class(name="minuml1_ActionState")
minuml1_Pseudostate = Class(name="minuml1_Pseudostate")
minuml1_ObjectFlowState = Class(name="minuml1_ObjectFlowState")
minuml1_Guard = Class(name="minuml1_Guard")
minuml1_BooleanExpression = Class(name="minuml1_BooleanExpression")
...
domain_model = DomainModel(
    name="minuml1",
    types={minuml1_State, minuml1_Transition, minuml1_ActivityGraph, StateMachine, minuml1_ModelElement, minuml1_Partition, minuml1_StateMachine, ModelElement, StateVertex, minuml1_CompositeState, State, minuml1_StateVertex, minuml1_FinalState, minuml1_ActionState, minuml1_Pseudostate, minuml1_ObjectFlowState, minuml1_Guard, minuml1_BooleanExpression, PseudostateKind},
    associations={top1, transitions2, partition0, incoming7, parition4, contents5, outgoing6, type10, source11, subvertex9, target12, guard14, expression16},
    generalizations={gen_minuml1_ActivityGraph_StateMachine, gen_minuml1_StateMachine_ModelElement, gen_minuml1_State_StateVertex, gen_minuml1_CompositeState_State, gen_minuml1_Partition_ModelElement, gen_minuml1_StateVertex_ModelElement, gen_minuml1_FinalState_State, gen_minuml1_Transition_ModelElement, gen_minuml1_ActionState_State, gen_minuml1_Pseudostate_StateVertex, gen_minuml1_ObjectFlowState_State, gen_minuml1_Guard_ModelElement},
    metadata=None
)
