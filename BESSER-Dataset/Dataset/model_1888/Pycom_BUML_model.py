...
pycom_Library = Class(name="pycom_Library")
pycom_Import = Class(name="pycom_Import")
pycom_Board = Class(name="pycom_Board")
pycom_ExpMember = Class(name="pycom_ExpMember")
pycom_ModuleType = Class(name="pycom_ModuleType")
pycom_ParameterType = Class(name="pycom_ParameterType")
...
pycom_ModuleName = Class(name="pycom_ModuleName")
...
pycom_CommunicationType = Class(name="pycom_CommunicationType")
...
pycom_Import.attributes={pycom_Import_path, pycom_Import_name}
...
pycom_Board.attributes={pycom_Board_name, pycom_Board_boardType, pycom_Board_communicationRate}
...
pycom_ParameterType.attributes={pycom_ParameterType_text, pycom_ParameterType_number}
...
pycom_CommunicationType.attributes={pycom_CommunicationType_password, pycom_CommunicationType_name, pycom_CommunicationType_ssid}
...
domain_model = DomainModel(
    name="pycom",
    types={pycom_Server, pycom_System, pycom_Library, pycom_Import, pycom_Board, pycom_ExpMember, pycom_ModuleType, pycom_ParameterType, pycom_Connection, pycom_ConditionalAction, pycom_Host, pycom_BoardMember, pycom_Sensor, ExpMember, pycom_Condition, pycom_ComparisonExp, pycom_Expression, pycom_ModuleName, pycom_Pin, pycom_Actuator, BoardMember, pycom_Communication, pycom_CommunicationType, pycom_PinName, pycom_LogicExp, pycom_Boolean, pycom_Function},
    associations={boards3, servers5, libraries0, imports1, ExpMembers27, typeName29, imports7, parameter10, conn12, exps14, host16, library18, boardMembers21, boardMember23, condition25, compExp56, left58, sensorName31, pins33, typeName35, actuatorName37, pins40, type43, power44, input46, logicEx49, nestedCondition52, boolVal54, right60, outputfunction63, board65, functionName68, pins71},
    generalizations={gen_pycom_ConditionalAction_ExpMember, gen_pycom_Actuator_BoardMember, gen_pycom_Communication_BoardMember, gen_pycom_Function_ExpMember},
    metadata=None
)
