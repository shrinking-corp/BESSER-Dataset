...
class pycom_Expression:
    ...
    def __init__(self, outputValue: int, pycom_Expression62: "pycom_ComparisonExp" = None, pycom_Expression64: "pycom_Function" = None, pycom_Expression: "pycom_ComparisonExp" = None):
...
class pycom_ComparisonExp:
    ...
    def __init__(self, op: str, pycom_ComparisonExp61: "pycom_Expression" = None, pycom_ComparisonExp: "pycom_LogicExp" = None, pycom_ComparisonExp59: "pycom_Expression" = None):
        self.op = op
...
class pycom_Condition:
    ...
    def __init__(self, operator: str, pycom_Condition50: "pycom_LogicExp" = None, pycom_Condition53: "pycom_Condition" = None, pycom_Condition51: "pycom_Condition" = None, pycom_Condition: "pycom_ConditionalAction" = None):
...
class pycom_ConditionalAction(ExpMember):
    ...
    def __init__(self, type: str, pycom_ConditionalAction28: set["pycom_ExpMember"] = None, pycom_ConditionalAction: "pycom_Server" = None, pycom_ConditionalAction26: "pycom_Condition" = None):
        self.type = type
...
class pycom_Board:
    ...
    def __init__(self, name: str, boardType: str, communicationRate: int, pycom_Board67: "pycom_Function" = None, pycom_Board: "pycom_System" = None, pycom_Board19: set["pycom_Library"] = None, pycom_Board22: set["pycom_BoardMember"] = None):
        self.name = name
...
class pycom_Import:
    ...
    def __init__(self, name: str, path: str, pycom_Import70: "pycom_Function" = None, pycom_Import: "pycom_System" = None, pycom_Import9: "pycom_Library" = None, pycom_Import11: set["pycom_ParameterType"] = None):
        self.name = name
        self.path = path
...
class pycom_Library:
    ...
    def __init__(self, name: str, pycom_Library: "pycom_System" = None, pycom_Library8: set["pycom_Import"] = None, pycom_Library20: "pycom_Board" = None):
        self.name = name
