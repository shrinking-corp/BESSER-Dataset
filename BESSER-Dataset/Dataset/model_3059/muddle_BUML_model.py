...
domain_model = DomainModel(
    name="muddle",
    types={muddle_Slot, muddle_Muddle, muddle_Type, muddle_MuddleElement, muddle_PrimitiveType, muddle_MuddleElementType, muddle_Feature, Type, muddle_LinkElementType, MuddleElementType, muddle_IntegerType, PrimitiveType, muddle_StringType, muddle_BooleanType, muddle_RealType},
    associations={slots2, types0, elements1, roleInSourceFeature30, roleInTargetFeature33, type3, muddle4, feature5, owningElement6, type9, owningType11, slots13, instances15, features17, superTypes20, subTypes23, sourceFeature25, targetFeature27},
    generalizations={gen_muddle_PrimitiveType_Type, gen_muddle_MuddleElementType_Type, gen_muddle_LinkElementType_MuddleElementType, gen_muddle_IntegerType_PrimitiveType, gen_muddle_StringType_PrimitiveType, gen_muddle_BooleanType_PrimitiveType, gen_muddle_RealType_PrimitiveType},
    metadata=None
)
