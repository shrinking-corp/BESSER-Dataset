...
class Online_Shopping_System_Product:

    def __init__(self, ID: str, Name: str, Supplier: str, line_item15: set["Online_Shopping_System_Line_item"] = None):
        self.ID = ID
        self.Name = Name
    ...
    def line_item15(self, value):
        ...
        old_value = getattr(self, f"_Online_Shopping_System_Product__line_item15", None)
...
class Online_Shopping_System_Line_item:

    def __init__(self, quantity: int, price: str, shopping_Cart11: "Online_Shopping_System_Shopping_Cart" = None, _order__unique_13: "Online_Shopping_System_Order" = None, product14: "Online_Shopping_System_Product" = None):
    ...
    def shopping_Cart11(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Online_Shopping_System_Line_item__shopping_Cart11", None)
    ...
    def product14(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Online_Shopping_System_Line_item__product14", None)
    ...
    def _order__unique_13(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Online_Shopping_System_Line_item___order__unique_13", None)
...
class Online_Shopping_System_Shopping_Cart:

    def __init__(self, created: str, web_User7: "Online_Shopping_System_Web_User" = None, ordered__unique10: set["Online_Shopping_System_Line_item"] = None):
    ...
    def ordered__unique10(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Online_Shopping_System_Shopping_Cart__ordered__unique10", None)
    ...
    def web_User7(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Online_Shopping_System_Shopping_Cart__web_User7", None)
...
class Online_Shopping_System_Order:

    def __init__(self, shipped: str, Ship_to: str, status: str, total: str, Number: str, ordered: str, account9: "Online_Shopping_System_Account" = None, line_item12: set["Online_Shopping_System_Line_item"] = None):
    ...
    def line_item12(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Online_Shopping_System_Order__line_item12", None)
    ...
    def account9(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Online_Shopping_System_Order__account9", None)
...
class Online_Shopping_System_Payment:

    def __init__(self, ID: str, Paid: str, Total: str, Details: str, account4: "Online_Shopping_System_Account" = None):
        self.ID = ID
        self.Paid = Paid
        self.Total = Total
    ...
    def account4(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Online_Shopping_System_Payment__account4", None)
...
class Online_Shopping_System_Account:

    def __init__(self, ID: str, billing_address: str, is_closed: bool, Open: str, Closed: str, customer3: "Online_Shopping_System_Customer" = None, payment5: set["Online_Shopping_System_Payment"] = None, order8: set["Online_Shopping_System_Order"] = None):
        self.ID = ID
    ...
    def order8(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Online_Shopping_System_Account__order8", None)
    ...
    def payment5(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Online_Shopping_System_Account__payment5", None)
    ...
    def customer3(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Online_Shopping_System_Account__customer3", None)
...
class Online_Shopping_System_Customer:

    def __init__(self, ID: str, Address: str, Phone: str, Email: str, web_User1: "Online_Shopping_System_Web_User" = None, account2: "Online_Shopping_System_Account" = None):
        self.ID = ID
    ...
    def web_User1(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Online_Shopping_System_Customer__web_User1", None)
    ...
    def account2(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Online_Shopping_System_Customer__account2", None)
...
class Online_Shopping_System_Web_User:

    def __init__(self, login_id: str, passwd: str, customer0: "Online_Shopping_System_Customer" = None, shopping_Cart6: "Online_Shopping_System_Shopping_Cart" = None):
    ...
    def customer0(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Online_Shopping_System_Web_User__customer0", None)
    ...
    def shopping_Cart6(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Online_Shopping_System_Web_User__shopping_Cart6", None)
