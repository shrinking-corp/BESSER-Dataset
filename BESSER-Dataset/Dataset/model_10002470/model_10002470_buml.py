...
Patient.attributes={Patient_dateOfBirth, Patient_GP_Address, Patient_emailAddress, Patient_phoneNumber, Patient_name, Patient_address}
...
Login.attributes={Login_password, Login_securityAnswer, Login_securityQuestion, Login_username, Login_lastLoginTime}
...
transaction_Interface.attributes={transaction_Interface_type, transaction_Interface_transactionTime, transaction_Interface_amount, transaction_Interface_id}
...
transaction_Community_Hospital.attributes={transaction_Community_Hospital_sourceAccount, transaction_Community_Hospital_targetAccount}
...
Medical_Record_CertificatesOfDepositAccount.attributes={Medical_Record_CertificatesOfDepositAccount_interestRate, Medical_Record_CertificatesOfDepositAccount_timePeriod}
...
Medical_Record_NHS_Number.attributes={Medical_Record_NHS_Number_type, Medical_Record_NHS_Number_balance, Medical_Record_NHS_Number_accountNo}
...
domain_model = DomainModel(
    name="b6f55369_65af_4d2e_8e31_ebb01b47411f",
    types={Patient, Login, transaction_Interface, transaction_Mental_Health_Trust, transaction_Acute_Hospital, transaction_Community_Hospital, Medical_Record_SavingsAccount, Medical_Record_CertificatesOfDepositAccount, Medical_Record_CheckingAccount, Medical_Record_NHS_Number, MyInterface_Interface, transaction_TransactionType, Medical_Record_AccountType},
