...
services_ScoreServiceJDBC.attributes={services_ScoreServiceJDBC_URL, services_ScoreServiceJDBC_SELECT_SCORE, services_ScoreServiceJDBC_PASSWORD, services_ScoreServiceJDBC_USER, services_ScoreServiceJDBC_INSERT_SCORE}
...
CommentServiceJDBCTest.attributes={CommentServiceJDBCTest_URL, CommentServiceJDBCTest_DELETE, CommentServiceJDBCTest_USER, CommentServiceJDBCTest_PASS}
...
RatingServiceTest.attributes={RatingServiceTest_GAME_NAME, RatingServiceTest_TEST_PLAYER_3, RatingServiceTest_TEST_PLAYER, RatingServiceTest_TEST_PLAYER_2}
...
ScoreServiceJDBCTest.attributes={ScoreServiceJDBCTest_PASS, ScoreServiceJDBCTest_URL, ScoreServiceJDBCTest_DELETE, ScoreServiceJDBCTest_USER}
...
deck_Deck.attributes={deck_Deck_inputDestinationRow, deck_Deck_removeItemFromArrayIndex, deck_Deck_foundationIndex, deck_Deck_score, deck_Deck_stepCounter}
...
deck_Stock.attributes={deck_Stock_stock, deck_Stock_STARTING_INDEX}
...
entities_Comment.attributes={entities_Comment_comment, entities_Comment_player, entities_Comment_commentedOn, entities_Comment_game}
...
entities_Rating.attributes={entities_Rating_ratedon, entities_Rating_game, entities_Rating_player, entities_Rating_rating}
...
entities_Score.attributes={entities_Score_playedOn, entities_Score_points, entities_Score_player, entities_Score_game}
...
services_CommentServiceJDBC.attributes={services_CommentServiceJDBC_INSERT_COMMENT, services_CommentServiceJDBC_USER, services_CommentServiceJDBC_URL, services_CommentServiceJDBC_SELECT_COMMENTS, services_CommentServiceJDBC_PASSWORD}
...
services_RatingServiceJDBC.attributes={services_RatingServiceJDBC_USER, services_RatingServiceJDBC_PASSWORD, services_RatingServiceJDBC_URL, services_RatingServiceJDBC_SELECT_AVERAGE_RATING, services_RatingServiceJDBC_INSERT_RATING, services_RatingServiceJDBC_SELECT_RATING}
