...
class deck_Deck:
    ...
    def __init__(self, removeItemFromArrayIndex: int, score: int, stepCounter: int, inputDestinationRow: int, foundationIndex: int, history3: "features_History" = None, pack7: "card_Pack" = None, tableau9: "deck_Tableau" = None, foundations13: "deck_Foundations" = None, stock27: "deck_Stock" = None):
