...
class fiacremm_Process(EModelElement):
    ...
    def __init__(self, Name: str, StateSize: int, VarSize: int, fiacremm_Process30: "fiacremm_Component" = None, fiacremm_Process10: "fiacremm_Port" = None, fiacremm_Process12: set["fiacremm_Trigger"] = None, Process26: "fiacremm_Variable" = None, fiacremm_Process43: "fiacremm_Program" = None, fiacremm_Process: set["fiacremm_Transition"] = None, processes: set["fiacremm_Variable"] = None, fiacremm_Process7: set["fiacremm_State"] = None, process: "fiacremm_State" = None, Process: "fiacremm_State" = None):
        self.Name = Name
...
class fiacremm_Transition(EModelElement):
    ...
    def __init__(self, Name: str, outTransitions: "fiacremm_State" = None, inTransitions: "fiacremm_State" = None, fiacremm_Transition18: "fiacremm_Guard" = None, fiacremm_Transition20: "fiacremm_Trigger" = None, fiacremm_Transition23: "fiacremm_Action" = None, fiacremm_Transition: "fiacremm_Process" = None, Transition: "fiacremm_State" = None, Transition2: "fiacremm_State" = None):
        self.Name = Name
...
class fiacremm_State(EModelElement):
    ...
    def __init__(self, Name: str, State14: "fiacremm_Transition" = None, State16: "fiacremm_Transition" = None, fiacremm_State: "fiacremm_Process" = None, State: "fiacremm_Process" = None, source: set["fiacremm_Transition"] = None, target: set["fiacremm_Transition"] = None, initState: "fiacremm_Process" = None):
        self.Name = Name
...
class fiacremm_Variable(EModelElement):
    ...
    def __init__(self, Name: str, initVal: str, variables28: set["fiacremm_Component"] = None, Variable32: "fiacremm_Component" = None, fiacremm_Variable: "fiacremm_DataType" = None, variables: set["fiacremm_Process"] = None, fiacremm_Variable40: "fiacremm_Program" = None, fiacremm_Variable49: "fiacremm_Trigger" = None, Variable: "fiacremm_Process" = None):
        self.Name = Name
