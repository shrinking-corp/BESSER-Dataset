...
# Classes
fiacremm_Variable = Class(name="fiacremm_Variable")
fiacremm_State = Class(name="fiacremm_State")
EModelElement = Class(name="EModelElement")
fiacremm_Transition = Class(name="fiacremm_Transition")
fiacremm_Process = Class(name="fiacremm_Process")
fiacremm_Component = Class(name="fiacremm_Component")
fiacremm_Port = Class(name="fiacremm_Port")
fiacremm_Trigger = Class(name="fiacremm_Trigger")
fiacremm_Guard = Class(name="fiacremm_Guard")
fiacremm_Action = Class(name="fiacremm_Action")
fiacremm_DataType = Class(name="fiacremm_DataType")
fiacremm_Program = Class(name="fiacremm_Program")
...
fiacremm_Process.attributes={fiacremm_Process_StateSize, fiacremm_Process_VarSize, fiacremm_Process_Name}
...
fiacremm_Component.attributes={fiacremm_Component_Name, fiacremm_Component_ProcessSize, fiacremm_Component_VarSize}
...
fiacremm_Trigger.attributes={fiacremm_Trigger_codeFiacre, fiacremm_Trigger_ArgSize, fiacremm_Trigger_Body, fiacremm_Trigger_Name}
...
fiacremm_Action.attributes={fiacremm_Action_codeFiacre, fiacremm_Action_Body, fiacremm_Action_Name}
...
domain_model = DomainModel(
    name="fiacremm",
    types={fiacremm_Variable, fiacremm_State, EModelElement, fiacremm_Transition, fiacremm_Process, fiacremm_Component, fiacremm_Port, fiacremm_Trigger, fiacremm_Guard, fiacremm_Action, fiacremm_DataType, fiacremm_Program},
    associations={transitions4, variables5, states6, initState8, outTransitions0, inTransitions1, process3, components27, instances29, variables31, outPorts9, alluniqueTriggers11, source13, target15, guard17, trigger19, action22, datatype24, processes25, ports33, components36, variable38, processes41, datatypes44, arguments47, components50},
    generalizations={gen_fiacremm_State_EModelElement, gen_fiacremm_Process_EModelElement, gen_fiacremm_Component_EModelElement, gen_fiacremm_Transition_EModelElement, gen_fiacremm_DataType_EModelElement, gen_fiacremm_Variable_EModelElement, gen_fiacremm_Port_EModelElement, gen_fiacremm_Program_EModelElement, gen_fiacremm_Guard_EModelElement, gen_fiacremm_Trigger_EModelElement, gen_fiacremm_Action_EModelElement},
    metadata=None
)
