...
# Classes
foo_A = Class(name="foo_A")
foo_B = Class(name="foo_B", is_abstract=True)
foo_C = Class(name="foo_C")
J = Class(name="J")
foo_F = Class(name="foo_F")
B = Class(name="B")
foo_D = Class(name="foo_D")
foo_I = Class(name="foo_I")
foo_J = Class(name="foo_J")
foo_E = Class(name="foo_E")
I = Class(name="I")
foo_H = Class(name="foo_H")
...
domain_model = DomainModel(
    name="foo",
    types={foo_A, foo_B, foo_C, J, foo_F, B, foo_D, foo_I, foo_J, foo_E, I, foo_H},
