...
# Classes
school_Academy = Class(name="school_Academy")
...
school_Notation = Class(name="school_Notation")
school_Matter = Class(name="school_Matter")
school_Math = Class(name="school_Math")
...
school_Teacher_m_evaluate: Method = Method(name="evaluate", parameters={Parameter(name='school_student', type=StringType)}, type=StringType)
...
domain_model = DomainModel(
    name="school",
    types={school_Academy, school_Teacher, school_Student, school_School, school_ClassRoom, school_Notation, school_Matter, school_Math, Matter},
    associations={teachers0, students1, schools3, rooms5, teachers7, students10, teacher13, children16, notations19},
