...
class school_Student:
    ...
    def __init__(self, name: str, age: int, school_Student: "school_Academy" = None, school_Student12: "school_School" = None, school_Student18: "school_ClassRoom" = None, school_Student20: set["school_Notation"] = None):
        self.name = name
        self.age = age
...
class school_Teacher:
    ...
    def evaluate(self, school_student) :
        # TODO: Implement evaluate method
        pass

class school_Academy:

    def __init__(self, name: str, school_Academy: set["school_Teacher"] = None, school_Academy2: set["school_Student"] = None, school_Academy4: set["school_School"] = None):
        self.name = name
