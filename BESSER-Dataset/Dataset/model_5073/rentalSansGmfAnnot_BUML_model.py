...
rental_RentalAgency_m_book: Method = Method(name="book", parameters={Parameter(name='rental_rentedObject', type=StringType), Parameter(name='rental_customer', type=StringType), Parameter(name='rental_to', type=StringType), Parameter(name='rental_from_', type=StringType)}, type=StringType)
...
rental_RentalAgency_m_removeCustomer: Method = Method(name="removeCustomer", parameters={Parameter(name='rental_customer', type=StringType)})
rental_RentalAgency_m_removeObject: Method = Method(name="removeObject", parameters={Parameter(name='rental_object', type=StringType)})
rental_RentalAgency_m_isAvailable: Method = Method(name="isAvailable", parameters={Parameter(name='rental_from_', type=StringType), Parameter(name='rental_to', type=StringType), Parameter(name='rental_rentedObject', type=StringType)}, type=BooleanType)
rental_RentalAgency.attributes={rental_RentalAgency_name}
rental_RentalAgency.methods={rental_RentalAgency_m_removeCustomer, rental_RentalAgency_m_addObject, rental_RentalAgency_m_book, rental_RentalAgency_m_removeObject, rental_RentalAgency_m_isAvailable, rental_RentalAgency_m_addCustomer}
...
domain_model = DomainModel(
    ...
    associations={objectsToRent0, customers1, parentAgency6, customer8, rentedObject9, parentAgency11, rentals3, parentAgency5},
    generalizations={},
    metadata=None
)
