...
# Classes
ppo_USAddress = Class(name="ppo_USAddress")
ppo_PurchaseOrder = Class(name="ppo_PurchaseOrder")
ppo_Item = Class(name="ppo_Item")
...
ppo_USAddress_m_hasUSState: Method = Method(name="hasUSState", parameters={Parameter(name='ppo_context', type=StringType), Parameter(name='ppo_diagnostics', type=StringType)}, type=BooleanType)
ppo_USAddress.attributes={ppo_USAddress_country, ppo_USAddress_state, ppo_USAddress_name, ppo_USAddress_zip, ppo_USAddress_city, ppo_USAddress_street}
...
ppo_Item.attributes={ppo_Item_quantity, ppo_Item_comment, ppo_Item_shipDate, ppo_Item_productName, ppo_Item_partNum, ppo_Item_USPrice}
...
domain_model = DomainModel(
    name="ppo",
    types={ppo_USAddress, ppo_PurchaseOrder, ppo_Item},
