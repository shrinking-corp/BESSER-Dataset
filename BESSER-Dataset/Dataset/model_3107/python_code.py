...
class source_Association:
    ...
    def __init__(self, name: str, leftMultiplicity: int, source_Association: "source_Class" = None, source_Association7: "source_Class" = None, source_Association18: "source_ClassDiagram" = None):
        self.name = name
