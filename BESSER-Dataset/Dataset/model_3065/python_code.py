...
class forms_Relationship:
    ...
    def __init__(self, name: str, lowerBound: int, upperBound: int, forms_Relationship21: "forms_Entity" = None, forms_Relationship: "forms_Entity" = None, forms_Relationship19: "forms_Relationship" = None, forms_Relationship17: "forms_Relationship" = None):
        self.name = name
...
class forms_Form:
    ...
    def __init__(self, name: str, title: str, description: str, mainForm: bool, forms_Form: "forms_EFML" = None, forms_Form24: "forms_Entity" = None, forms_Form27: set["forms_Page"] = None, forms_Form33: "forms_RelationshipPageElement" = None):
        self.name = name
        self.title = title
...
class forms_Entity:
    ...
    def __init__(self, name: str, forms_Entity4: set["forms_Attribute"] = None, forms_Entity: "forms_EFML" = None, forms_Entity22: "forms_Relationship" = None, forms_Entity25: "forms_Form" = None, forms_Entity6: "forms_Attribute" = None, forms_Entity9: set["forms_Relationship"] = None, forms_Entity12: "forms_Entity" = None, forms_Entity10: "forms_Entity" = None):
        self.name = name
