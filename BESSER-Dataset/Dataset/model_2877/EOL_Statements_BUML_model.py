...
# Classes
eol_statements_ForStatement = Class(name="eol_statements_ForStatement")
eol_statements_FormalParameterExpression = Class(name="eol_statements_FormalParameterExpression")
eol_statements_Statement = Class(name="eol_statements_Statement", is_abstract=True)
eol_statements_ExpressionStatement = Class(name="eol_statements_ExpressionStatement")
Statement = Class(name="Statement")
eol_statements_Expression = Class(name="eol_statements_Expression", is_abstract=True)
eol_statements_SwitchStatement = Class(name="eol_statements_SwitchStatement")
eol_statements_SwitchCaseExpressionStatement = Class(name="eol_statements_SwitchCaseExpressionStatement")
eol_statements_SwitchCaseDefaultStatement = Class(name="eol_statements_SwitchCaseDefaultStatement")
eol_statements_SwitchCaseStatement = Class(name="eol_statements_SwitchCaseStatement", is_abstract=True)
eol_statements_ExpressionOrStatementBlock = Class(name="eol_statements_ExpressionOrStatementBlock")
SwitchCaseStatement = Class(name="SwitchCaseStatement")
eol_statements_IfStatement = Class(name="eol_statements_IfStatement")
eol_statements_VariableDeclarationExpression = Class(name="eol_statements_VariableDeclarationExpression")
eol_statements_WhileStatement = Class(name="eol_statements_WhileStatement")
eol_statements_ReturnStatement = Class(name="eol_statements_ReturnStatement")
eol_statements_ThrowStatement = Class(name="eol_statements_ThrowStatement")
eol_statements_DeleteStatement = Class(name="eol_statements_DeleteStatement")
eol_statements_AssignmentStatement = Class(name="eol_statements_AssignmentStatement")
eol_statements_SpecialAssignmentStatement = Class(name="eol_statements_SpecialAssignmentStatement")
AssignmentStatement = Class(name="AssignmentStatement")
eol_statements_ContinueStatement = Class(name="eol_statements_ContinueStatement")
eol_statements_AbortStatement = Class(name="eol_statements_AbortStatement")
eol_statements_BreakStatement = Class(name="eol_statements_BreakStatement")
eol_statements_BreakAllStatement = Class(name="eol_statements_BreakAllStatement")
eol_statements_AnnotationStatement = Class(name="eol_statements_AnnotationStatement", is_abstract=True)
eol_statements_NameExpression = Class(name="eol_statements_NameExpression")
eol_statements_SimpleAnnotationStatement = Class(name="eol_statements_SimpleAnnotationStatement")
AnnotationStatement = Class(name="AnnotationStatement")
eol_statements_StringExpression = Class(name="eol_statements_StringExpression")
eol_statements_ExecutableAnnotationStatement = Class(name="eol_statements_ExecutableAnnotationStatement")
eol_statements_ModelDeclarationStatement = Class(name="eol_statements_ModelDeclarationStatement")
eol_statements_ModelDeclarationParameter = Class(name="eol_statements_ModelDeclarationParameter")
...
domain_model = DomainModel(
    name="eol_statements",
    types={eol_statements_ForStatement, eol_statements_FormalParameterExpression, eol_statements_Statement, eol_statements_ExpressionStatement, Statement, eol_statements_Expression, eol_statements_SwitchStatement, eol_statements_SwitchCaseExpressionStatement, eol_statements_SwitchCaseDefaultStatement, eol_statements_SwitchCaseStatement, eol_statements_ExpressionOrStatementBlock, SwitchCaseStatement, eol_statements_IfStatement, eol_statements_VariableDeclarationExpression, eol_statements_WhileStatement, eol_statements_ReturnStatement, eol_statements_ThrowStatement, eol_statements_DeleteStatement, eol_statements_AssignmentStatement, eol_statements_SpecialAssignmentStatement, AssignmentStatement, eol_statements_ContinueStatement, eol_statements_AbortStatement, eol_statements_BreakStatement, eol_statements_BreakAllStatement, eol_statements_AnnotationStatement, eol_statements_NameExpression, eol_statements_SimpleAnnotationStatement, AnnotationStatement, eol_statements_StringExpression, eol_statements_ExecutableAnnotationStatement, eol_statements_ModelDeclarationStatement, eol_statements_ModelDeclarationParameter, Expression},
    associations={elseBody19, iterator22, expr0, expr1, cases3, default5, body7, expr8, condition11, ifBody13, elseIfBodies16, name49, driver50, aliases53, condition23, body26, condition29, body31, expr34, expr36, expr38, lhs40, rhs42, name45, values46, expr47, parameters56},
    generalizations={gen_eol_statements_ForStatement_Statement, gen_eol_statements_ExpressionStatement_Statement, gen_eol_statements_SwitchStatement_Statement, gen_eol_statements_SwitchCaseStatement_Statement, gen_eol_statements_SwitchCaseDefaultStatement_SwitchCaseStatement, gen_eol_statements_SwitchCaseExpressionStatement_SwitchCaseStatement, gen_eol_statements_IfStatement_Statement, gen_eol_statements_WhileStatement_Statement, gen_eol_statements_ReturnStatement_Statement, gen_eol_statements_ThrowStatement_Statement, gen_eol_statements_DeleteStatement_Statement, gen_eol_statements_AssignmentStatement_Statement, gen_eol_statements_SpecialAssignmentStatement_AssignmentStatement, gen_eol_statements_ContinueStatement_Statement, gen_eol_statements_AbortStatement_Statement, gen_eol_statements_BreakStatement_Statement, gen_eol_statements_BreakAllStatement_Statement, gen_eol_statements_AnnotationStatement_Statement, gen_eol_statements_SimpleAnnotationStatement_AnnotationStatement, gen_eol_statements_ExecutableAnnotationStatement_AnnotationStatement, gen_eol_statements_ModelDeclarationStatement_Statement, gen_eol_statements_VariableDeclarationExpression_Expression, gen_eol_statements_NameExpression_Expression},
    metadata=None
)
