...
domain_model = DomainModel(
    name="PetriNet",
    types={PetriNet_Transition, PetriNet_NamedElement, NamedElement, PetriNet_Net, PetriNet_Place},
    associations={transitions1, postt3, pret5, cnet7, prep8, postp10, cnet12, places0},
