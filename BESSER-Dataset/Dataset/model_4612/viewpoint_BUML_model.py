...
viewpoint_DAnalysisSessionEObject.attributes={viewpoint_DAnalysisSessionEObject_resources, viewpoint_DAnalysisSessionEObject_synchronizationStatus, viewpoint_DAnalysisSessionEObject_controlledResources, viewpoint_DAnalysisSessionEObject_open}
...
viewpoint_description_Viewpoint.attributes={viewpoint_description_Viewpoint_modelFileExtension, viewpoint_description_Viewpoint_customizes, viewpoint_description_Viewpoint_reuses, viewpoint_description_Viewpoint_icon, viewpoint_description_Viewpoint_conflicts}
...
viewpoint_BasicLabelStyle.attributes={viewpoint_BasicLabelStyle_labelFormat, viewpoint_BasicLabelStyle_showIcon, viewpoint_BasicLabelStyle_iconPath, viewpoint_BasicLabelStyle_labelColor, viewpoint_BasicLabelStyle_labelSize}
...
viewpoint_description_RepresentationExtensionDescription.attributes={viewpoint_description_RepresentationExtensionDescription_viewpointURI, viewpoint_description_RepresentationExtensionDescription_name, viewpoint_description_RepresentationExtensionDescription_representationName}
...
viewpoint_description_DecorationDescription.attributes={viewpoint_description_DecorationDescription_decoratorPath, viewpoint_description_DecorationDescription_name, viewpoint_description_DecorationDescription_preconditionExpression, viewpoint_description_DecorationDescription_position}
...
viewpoint_description_SelectionDescription.attributes={viewpoint_description_SelectionDescription_candidatesExpression, viewpoint_description_SelectionDescription_multiple, viewpoint_description_SelectionDescription_rootExpression, viewpoint_description_SelectionDescription_message, viewpoint_description_SelectionDescription_tree, viewpoint_description_SelectionDescription_childrenExpression}
...
viewpoint_description_InterpolatedColor.attributes={viewpoint_description_InterpolatedColor_minValueComputationExpression, viewpoint_description_InterpolatedColor_colorValueComputationExpression, viewpoint_description_InterpolatedColor_maxValueComputationExpression}
...
viewpoint_style_BasicLabelStyleDescription.attributes={viewpoint_style_BasicLabelStyleDescription_iconPath, viewpoint_style_BasicLabelStyleDescription_showIcon, viewpoint_style_BasicLabelStyleDescription_labelSize, viewpoint_style_BasicLabelStyleDescription_labelExpression, viewpoint_style_BasicLabelStyleDescription_labelFormat}
...
viewpoint_tool_PaneBasedSelectionWizardDescription.attributes={viewpoint_tool_PaneBasedSelectionWizardDescription_childrenExpression, viewpoint_tool_PaneBasedSelectionWizardDescription_tree, viewpoint_tool_PaneBasedSelectionWizardDescription_choiceOfValuesMessage, viewpoint_tool_PaneBasedSelectionWizardDescription_iconPath, viewpoint_tool_PaneBasedSelectionWizardDescription_rootExpression, viewpoint_tool_PaneBasedSelectionWizardDescription_candidatesExpression, viewpoint_tool_PaneBasedSelectionWizardDescription_windowImagePath, viewpoint_tool_PaneBasedSelectionWizardDescription_selectedValuesMessage, viewpoint_tool_PaneBasedSelectionWizardDescription_message, viewpoint_tool_PaneBasedSelectionWizardDescription_preSelectedCandidatesExpression, viewpoint_tool_PaneBasedSelectionWizardDescription_windowTitle}
