...
class viewpoint_validation_ValidationSet(DocumentedElement):
    ...
    def __init__(self, name: str, viewpoint_validation_ValidationSet214: set["validation_ValidationRule"] = None, viewpoint_validation_ValidationSet217: set["validation_ValidationRule"] = None, viewpoint_validation_ValidationSet: set["validation_ValidationRule"] = None):
        self.name = name
...
class viewpoint_style_BasicLabelStyleDescription:
    ...
    def __init__(self, labelExpression: str, labelSize: int, labelFormat: str, showIcon: bool, iconPath: str, viewpoint_style_BasicLabelStyleDescription: "ColorDescription" = None):
...
class viewpoint_description_ConditionalStyleDescription(ABC):
    ...
    def checkPredicate(self, viewpoint_modelElement, viewpoint_viewVariable, viewpoint_containerVariable) :
...
class DRefreshable:
    ...
    pass
class viewpoint_DRepresentationElement(DMappingBased, DSemanticDecorator, DRefreshable, DStylizable):
