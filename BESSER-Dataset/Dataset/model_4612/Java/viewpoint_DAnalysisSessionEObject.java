...
public class viewpoint_DAnalysisSessionEObject  {
    ...
    public viewpoint_DAnalysisSessionEObject(
        String controlledResources,        String synchronizationStatus,        boolean open,        String resources    ) {
    ...
    public viewpoint_DAnalysisSessionEObject(
        String controlledResources,        String synchronizationStatus,        boolean open,        String resources        ArrayList<viewpoint_DAnalysis> viewpoint_danalysiss,        ArrayList<Viewpoint> viewpoints    ) {
        this.controlledResources = controlledResources;
        this.synchronizationStatus = synchronizationStatus;
        this.open = open;
        this.resources = resources;
