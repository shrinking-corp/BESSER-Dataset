...
def test_stext_TimeEventSpec_unit_value_roundtrip():
    instance = stext_TimeEventSpec(unit="sample_text", value=7)
...
stext_StatechartDefinition_strategy = st.builds(stext_StatechartDefinition)
...
stext_TimeEventSpec_strategy = st.builds(stext_TimeEventSpec, unit=safe_text, value=st.integers())
