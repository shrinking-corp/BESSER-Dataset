...
# Classes
eel_Platform = Class(name="eel_Platform")
eel_Variable = Class(name="eel_Variable")
eel_Measure = Class(name="eel_Measure", is_abstract=True)
eel_MeasurementUncertainty = Class(name="eel_MeasurementUncertainty")
eel_TypedMeasure = Class(name="eel_TypedMeasure", is_abstract=True)
Measure = Class(name="Measure")
eel_MeasureValue = Class(name="eel_MeasureValue")
TypedMeasure = Class(name="TypedMeasure")
eel_MeasureOCL = Class(name="eel_MeasureOCL")
MeasureValue = Class(name="MeasureValue")
eel_MeasureAttribute = Class(name="eel_MeasureAttribute")
eel_MeasureCast = Class(name="eel_MeasureCast")
eel_MeasureBinaryOperation = Class(name="eel_MeasureBinaryOperation", is_abstract=True)
eel_MeasureBinarySumOperation = Class(name="eel_MeasureBinarySumOperation")
eel_EnergyComputation = Class(name="eel_EnergyComputation")
MeasureBinaryProductOperation = Class(name="MeasureBinaryProductOperation")
eel_PowerComputation = Class(name="eel_PowerComputation")
eel_RealTimeDuration = Class(name="eel_RealTimeDuration")
eel_MeasureUnboundOperation = Class(name="eel_MeasureUnboundOperation", is_abstract=True)
eel_MeasureUnboundSumOperation = Class(name="eel_MeasureUnboundSumOperation")
MeasureUnboundOperation = Class(name="MeasureUnboundOperation")
eel_MeasureUnboundProductOperation = Class(name="eel_MeasureUnboundProductOperation")
eel_MeasurementUncertaintyInformation = Class(name="eel_MeasurementUncertaintyInformation", is_abstract=True)
eel_MeasureBinaryProductOperation = Class(name="eel_MeasureBinaryProductOperation")
MeasureBinaryOperation = Class(name="MeasureBinaryOperation")
eel_Interval = Class(name="eel_Interval")
eel_Sampling = Class(name="eel_Sampling")
eel_Sample = Class(name="eel_Sample")
eel_Integral = Class(name="eel_Integral")
eel_NormalDistribution = Class(name="eel_NormalDistribution")
...
eel_Variable.attributes={eel_Variable_vibility, eel_Variable_value, eel_Variable_name}
...
eel_Measure.attributes={eel_Measure_targetClass, eel_Measure_name, eel_Measure_targetOperation, eel_Measure_subname}
eel_Measure.methods={eel_Measure_m_name, eel_Measure_m_type, eel_Measure_m_value}
...
eel_TypedMeasure.methods={eel_TypedMeasure_m_name, eel_TypedMeasure_m_type}
...
eel_PowerComputation.methods={eel_PowerComputation_m_value, eel_PowerComputation_m_type}
...
eel_NormalDistribution.attributes={eel_NormalDistribution_standardDeviation, eel_NormalDistribution_meanValue}
...
domain_model = DomainModel(
    name="eel",
    types={eel_Platform, eel_Variable, eel_Measure, eel_MeasurementUncertainty, eel_TypedMeasure, Measure, eel_MeasureValue, TypedMeasure, eel_MeasureOCL, MeasureValue, eel_MeasureAttribute, eel_MeasureCast, eel_MeasureBinaryOperation, eel_MeasureBinarySumOperation, eel_EnergyComputation, MeasureBinaryProductOperation, eel_PowerComputation, eel_RealTimeDuration, eel_MeasureUnboundOperation, eel_MeasureUnboundSumOperation, MeasureUnboundOperation, eel_MeasureUnboundProductOperation, eel_MeasurementUncertaintyInformation, eel_MeasureBinaryProductOperation, MeasureBinaryOperation, eel_Interval, eel_Sampling, eel_Sample, eel_Integral, eel_NormalDistribution, MeasurementUncertaintyInformation, Visibility, Type},
    associations={variables0, measures1, uncertainty3, measure5, left7, measures12, information14, right9, lowerEndpoint16, upperEndpoint18, samples21, interval22, quantity24},
    generalizations={gen_eel_TypedMeasure_Measure, gen_eel_MeasureValue_TypedMeasure, gen_eel_MeasureOCL_MeasureValue, gen_eel_MeasureAttribute_MeasureValue, gen_eel_MeasureCast_TypedMeasure, gen_eel_MeasureBinaryOperation_TypedMeasure, gen_eel_MeasureBinarySumOperation_MeasureBinaryOperation, gen_eel_EnergyComputation_MeasureBinaryProductOperation, gen_eel_PowerComputation_MeasureBinaryProductOperation, gen_eel_RealTimeDuration_MeasureValue, gen_eel_MeasureUnboundOperation_TypedMeasure, gen_eel_MeasureUnboundSumOperation_MeasureUnboundOperation, gen_eel_MeasureUnboundProductOperation_MeasureUnboundOperation, gen_eel_MeasureBinaryProductOperation_MeasureBinaryOperation, gen_eel_Interval_MeasurementUncertaintyInformation, gen_eel_Sampling_MeasurementUncertaintyInformation, gen_eel_Integral_MeasurementUncertaintyInformation, gen_eel_NormalDistribution_MeasurementUncertaintyInformation},
    metadata=None
)
