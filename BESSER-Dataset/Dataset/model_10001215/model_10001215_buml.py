...
Order.attributes={Order_Cust_id, Order_Order_id}
...
Customer1.attributes={Customer1_customerId, Customer1_phone, Customer1_name, Customer1_address}
...
Order1.attributes={Order1_conformationNo, Order1_deliveryDate, Order1_orderId, Order1_orderDate, Order1_cust, Order1_totalAmount}
...
Item1.attributes={Item1_itemCount, Item1_itemName, Item1_itemCost, Item1_itemCode}
...
SpecialOrder.attributes={SpecialOrder_offerCode, SpecialOrder_orderRange}
...
domain_model = DomainModel(
    name="_93f3dc70_8033_452f_8ecc_0d817fe0eadb",
    ...
    associations={Customer_Order, Manage_customer_accounts_Manager, Register_Customer, Manage_Stock_Manager, Customer_Order2, Item_Stock2, Order_Item, Stock_Manager, Order_Manager, Customer_Place_Order, Manage_Orders_Manager, Generate_Reports_Manager, Update_Order_Customer, Update_Order_Manager, Customer_Login, Item_Stock, Manager_Order, Manager_Stock},
    generalizations={},
    metadata=None
)
