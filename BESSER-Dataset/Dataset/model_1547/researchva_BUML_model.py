...
domain_model = DomainModel(
    name="researchva",
    types={researchva_Researcher, researchva_Write, researchva_Review, researchva_Paper, researchva_Skill, researchva_ReviewNote, Labelled, researchva_PublicationStructure, researchva_Keyword, Named, researchva_Paragraph, Counted, researchva_Named, researchva_Counted, researchva_Labelled},
    associations={writes0, reviews1, res_papers3, skills4, reviews11, paragraph13, reviewNote16, researchers19, papers21, allKeyWords24, paragraphs6, authors7, citedBy9},
    generalizations={gen_researchva_ReviewNote_Named, gen_researchva_Write_Labelled, gen_researchva_Review_Labelled, gen_researchva_PublicationStructure_Named, gen_researchva_Paper_Named, gen_researchva_Paragraph_Counted, gen_researchva_Paragraph_Named, gen_researchva_Keyword_Named},
    metadata=None
)
