...
# Classes
mathCompiler_Expressions = Class(name="mathCompiler_Expressions")
mathCompiler_MathExp = Class(name="mathCompiler_MathExp")
mathCompiler_Expression = Class(name="mathCompiler_Expression")
mathCompiler_Plus = Class(name="mathCompiler_Plus")
Expression = Class(name="Expression")
mathCompiler_Minus = Class(name="mathCompiler_Minus")
mathCompiler_Mult = Class(name="mathCompiler_Mult")
mathCompiler_Div = Class(name="mathCompiler_Div")
mathCompiler_External = Class(name="mathCompiler_External")
mathCompiler_Var = Class(name="mathCompiler_Var")
mathCompiler_Let = Class(name="mathCompiler_Let")
mathCompiler_Num = Class(name="mathCompiler_Num")
...
domain_model = DomainModel(
    name="mathCompiler",
    types={mathCompiler_Expressions, mathCompiler_MathExp, mathCompiler_Expression, mathCompiler_Plus, Expression, mathCompiler_Minus, mathCompiler_Mult, mathCompiler_Div, mathCompiler_External, mathCompiler_Var, mathCompiler_Let, mathCompiler_Num},
    associations={expressions0, exp1, left3, right5, left8, right10, left13, right15, left18, right20, binding23, body25},
    generalizations={gen_mathCompiler_Plus_Expression, gen_mathCompiler_Minus_Expression, gen_mathCompiler_Mult_Expression, gen_mathCompiler_Div_Expression, gen_mathCompiler_External_Expression, gen_mathCompiler_Var_Expression, gen_mathCompiler_Let_Expression, gen_mathCompiler_Num_Expression},
    metadata=None
)
