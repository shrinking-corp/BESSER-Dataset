...
class model_Position:
    ...
    def __init__(self, x: float, y: float, model_Position18: "model_Line" = None, model_Position: "model_XYChild" = None, model_Position39: "model_Polygon" = None):
        self.x = x
        self.y = y
...
class model_GridChild(Child):
    ...
    def __init__(self, horizontalAlignment: str, verticalAlignment: str, spanRows: str, widthHint: str, heightHint: str, grabHorizontalSpace: bool, grabVerticalSpace: bool, spanCols: int, model_GridChild: "model_GridContainer" = None):
...
class model_Dimension:
    ...
    def __init__(self, width: float, height: float, model_Dimension: "model_Symbol" = None, model_Dimension41: "model_RoundedRectangle" = None, model_Dimension14: "model_XYChild" = None, model_Dimension20: "model_Figure" = None):
        self.width = width
        self.height = height
...
class model_Symbol:
    ...
    def __init__(self, backgroundImage: str, onInit: str, onDispose: str, onUpdate: str, scriptModules: str, backgroundColor: str, model_Symbol8: set["model_Connection"] = None, model_Symbol: "model_Primitive" = None, model_Symbol2: set["model_StringToStringMap"] = None, model_Symbol4: "model_Cursor" = None, model_Symbol6: "model_Dimension" = None):
...
class model_Figure(Primitive):
    ...
    def __init__(self, foregroundColor: str, backgroundColor: str, onClick: str, onDoubleClick: str, visible: bool, border: str, opaque: str, toolTip: str, onMouseIn: str, onMouseOut: str, onMouseMove: str, onMouseHover: str, onMouseDrag: str, model_Figure22: "model_Cursor" = None, model_Figure: "model_Dimension" = None):
