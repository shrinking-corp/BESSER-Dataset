...
def test_assoc_corner40_link_reassign_clear():
    a = model_Dimension(height=3.14, width=3.14)
    b1 = model_RoundedRectangle()
    b2 = model_RoundedRectangle()
    _safe_set(a, 'model_Dimension41', b1)
    assert _is_linked(a, 'model_Dimension41', b1)
    if hasattr(b1, 'model_RoundedRectangle'):
        assert _is_linked(b1, 'model_RoundedRectangle', a)
    _safe_set(a, 'model_Dimension41', b2)
    assert _is_linked(a, 'model_Dimension41', b2)
    if hasattr(b1, 'model_RoundedRectangle'):
    ...
    _safe_set(a, 'model_Dimension41', None)
    assert not _is_linked(a, 'model_Dimension41', b2)
    if hasattr(b2, 'model_RoundedRectangle'):
...
def test_assoc_points38_link_reassign_clear():
    a = model_Position(x=3.14, y=3.14)
    b1 = model_Polygon()
    b2 = model_Polygon()
    _safe_set(a, 'model_Position39', b1)
    assert _is_linked(a, 'model_Position39', b1)
    if hasattr(b1, 'model_Polygon'):
        assert _is_linked(b1, 'model_Polygon', a)
    _safe_set(a, 'model_Position39', b2)
    assert _is_linked(a, 'model_Position39', b2)
    if hasattr(b1, 'model_Polygon'):
        assert not _is_linked(b1, 'model_Polygon', a)
    if hasattr(b2, 'model_Polygon'):
        assert _is_linked(b2, 'model_Polygon', a)
    _safe_set(a, 'model_Position39', None)
    assert not _is_linked(a, 'model_Position39', b2)
    if hasattr(b2, 'model_Polygon'):
