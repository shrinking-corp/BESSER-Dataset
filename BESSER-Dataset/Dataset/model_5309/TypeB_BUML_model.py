...
# Classes
TypeB_ListElement = Class(name="TypeB_ListElement")
Element = Class(name="Element")
ElementX = Class(name="ElementX")
ElementR = Class(name="ElementR")
TypeB_Element = Class(name="TypeB_Element")
TypeB_SubElement = Class(name="TypeB_SubElement")
TypeB_AnotherElement = Class(name="TypeB_AnotherElement")
TypeB_ElementX = Class(name="TypeB_ElementX")
TypeB_ElementY = Class(name="TypeB_ElementY")
TypeB_ElementR = Class(name="TypeB_ElementR")
TypeB_ElementS = Class(name="TypeB_ElementS")
...
TypeB_Element.attributes={TypeB_Element_type, TypeB_Element_abstractBaseName, TypeB_Element_nameElement}
...
TypeB_AnotherElement.attributes={TypeB_AnotherElement_abstractBaseName, TypeB_AnotherElement_additionalField, TypeB_AnotherElement_nameElement, TypeB_AnotherElement_type}
...
domain_model = DomainModel(
    name="TypeB",
    types={TypeB_ListElement, Element, ElementX, ElementR, TypeB_Element, TypeB_SubElement, TypeB_AnotherElement, TypeB_ElementX, TypeB_ElementY, TypeB_ElementR, TypeB_ElementS},
