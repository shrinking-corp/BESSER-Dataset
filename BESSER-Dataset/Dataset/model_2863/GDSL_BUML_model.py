...
# Classes
gDSL_ConDecl = Class(name="gDSL_ConDecl")
gDSL_Model = Class(name="gDSL_Model")
gDSL_Decl = Class(name="gDSL_Decl")
gDSL_DeclExport = Class(name="gDSL_DeclExport")
Decl = Class(name="Decl")
gDSL_Val = Class(name="gDSL_Val")
gDSL_TyVars = Class(name="gDSL_TyVars")
gDSL_Ty = Class(name="gDSL_Ty")
gDSL_Type = Class(name="gDSL_Type")
gDSL_Exp = Class(name="gDSL_Exp")
gDSL_CONS = Class(name="gDSL_CONS")
gDSL_TyBind = Class(name="gDSL_TyBind")
gDSL_TyElement = Class(name="gDSL_TyElement")
gDSL_CaseExp = Class(name="gDSL_CaseExp")
gDSL_ClosedExp = Class(name="gDSL_ClosedExp")
gDSL_PAT = Class(name="gDSL_PAT")
CaseExp = Class(name="CaseExp")
gDSL_MonadicExp = Class(name="gDSL_MonadicExp")
gDSL_OrElseExp = Class(name="gDSL_OrElseExp")
ClosedExp = Class(name="ClosedExp")
OrElseExp = Class(name="OrElseExp")
gDSL_AndAlsoExp = Class(name="gDSL_AndAlsoExp")
gDSL_RExp = Class(name="gDSL_RExp")
AndAlsoExp = Class(name="AndAlsoExp")
gDSL_AExp = Class(name="gDSL_AExp")
RExp = Class(name="RExp")
gDSL_MExp = Class(name="gDSL_MExp")
AExp = Class(name="AExp")
gDSL_SelectExp = Class(name="gDSL_SelectExp")
MExp = Class(name="MExp")
gDSL_ApplyExp = Class(name="gDSL_ApplyExp")
SelectExp = Class(name="SelectExp")
gDSL_AtomicExp = Class(name="gDSL_AtomicExp")
gDSL_Args = Class(name="gDSL_Args")
ApplyExp = Class(name="ApplyExp")
gDSL_Field = Class(name="gDSL_Field")
gDSL_ValueDecl = Class(name="gDSL_ValueDecl")
...
gDSL_Val.attributes={gDSL_Val_mid, gDSL_Val_name, gDSL_Val_attr, gDSL_Val_decPat}
...
gDSL_PAT.attributes={gDSL_PAT_id, gDSL_PAT_int, gDSL_PAT_bitpat, gDSL_PAT_uscore}
...
domain_model = DomainModel(
    name="gDSL",
    types={gDSL_ConDecl, gDSL_Model, gDSL_Decl, gDSL_DeclExport, Decl, gDSL_Val, gDSL_TyVars, gDSL_Ty, gDSL_Type, gDSL_Exp, gDSL_CONS, gDSL_TyBind, gDSL_TyElement, gDSL_CaseExp, gDSL_ClosedExp, gDSL_PAT, CaseExp, gDSL_MonadicExp, gDSL_OrElseExp, ClosedExp, OrElseExp, gDSL_AndAlsoExp, gDSL_RExp, AndAlsoExp, gDSL_AExp, RExp, gDSL_MExp, AExp, gDSL_SelectExp, MExp, gDSL_ApplyExp, SelectExp, gDSL_AtomicExp, gDSL_Args, ApplyExp, gDSL_Field, gDSL_ValueDecl},
    associations={tyVars6, conDecl8, value10, decl0, name1, tyVars2, type4, value48, value51, exp13, exps15, attr18, name21, ty23, typeRef26, tyBind29, elements31, param34, resType37, r40, in_43, out46, right81, name54, caseExps56, closedExp59, pat61, exp63, ifCaseExp66, thenCaseExp69, elseCaseExp72, doExp75, exp77, expr98, left80, aexps85, mexps87, applyexps88, atomicExp89, args91, args93, fields96, exps101, valDecl104, exp106, exp109, pat113},
    generalizations={gen_gDSL_Type_Decl, gen_gDSL_DeclExport_Decl, gen_gDSL_Val_Decl, gen_gDSL_ClosedExp_CaseExp, gen_gDSL_OrElseExp_ClosedExp, gen_gDSL_AndAlsoExp_OrElseExp, gen_gDSL_RExp_AndAlsoExp, gen_gDSL_AExp_RExp, gen_gDSL_MExp_AExp, gen_gDSL_SelectExp_MExp, gen_gDSL_ApplyExp_SelectExp, gen_gDSL_AtomicExp_ApplyExp},
    metadata=None
)
