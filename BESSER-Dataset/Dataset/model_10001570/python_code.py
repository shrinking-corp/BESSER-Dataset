...
class Rezervisanje:
    ...
    def __init__(self, RezerID: int, SlobMesto: bool, DatumPolaska: str, DatumDolaska: str, Cena: str, DestiID: int, PutnikID: int, KorisnikID: int, destinacija2: "Destinacija" = None, putnik7: "Putnik" = None, korisnik_IS8: "Korisnik_IS" = None, karta11: set["Karta"] = None):
