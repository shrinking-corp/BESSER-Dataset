...
Korisnik_IS.attributes={Korisnik_IS_ImeKorisnika, Korisnik_IS_PrezimeKorisnika, Korisnik_IS_KorisnikID, Korisnik_IS_Password, Korisnik_IS_UserName}
...
Karta.attributes={Karta_PovratakKarta, Karta_OdlazakKarta, Karta_CenaKarte, Karta_VremePovratka, Karta_RezerID, Karta_VremeOdlaska, Karta_KartaID}
...
Destinacija.attributes={Destinacija_DestiID, Destinacija_DesDrzava, Destinacija_DesGrad}
...
Rezervisanje.attributes={Rezervisanje_PutnikID, Rezervisanje_SlobMesto, Rezervisanje_RezerID, Rezervisanje_Cena, Rezervisanje_KorisnikID, Rezervisanje_DatumPolaska, Rezervisanje_DatumDolaska, Rezervisanje_DestiID}
...
Hotel.attributes={Hotel_ImeHotela, Hotel_DuzinaBoravka, Hotel_HotelID, Hotel_CenaSmestaja, Hotel_DestiID, Hotel_SobaHotela, Hotel_SpratHotela, Hotel_UslugaHotela, Hotel_AdresaHotela}
...
Putnik.attributes={Putnik_Grad, Putnik_ImePut, Putnik_eMail, Putnik_Mobilni, Putnik_PutnikID, Putnik_Adresa, Putnik_PrezimePut, Putnik_JMBG, Putnik_OsigID}
...
domain_model = DomainModel(
    name="_GTHNML7iEeedTfUoC_GfaA",
    types={Korisnik_IS, Karta, Destinacija, Rezervisanje, Hotel, Osiguranje, Putnik},
