...
domain_model = DomainModel(
    name="gradingsystem",
    types={gradingsystem_GradingSystem, gradingsystem_Course, gradingsystem_Grading, gradingsystem_Task, gradingsystem_MinRequirement, gradingsystem_ConcreteTask, Task, gradingsystem_GradingScheme, gradingsystem_Grade, gradingsystem_TaskGroup, MinRequirementsType},
    associations={courses0, gradings1, minRequirement3, grades6, minRequirementNotFulfilledGrade7, tasks10, gradingScheme13, contains4},
