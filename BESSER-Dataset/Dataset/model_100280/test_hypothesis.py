...
def test_model_hlarctype_1_is_not_abstract():
    assert not inspect.isabstract(model_HLArcType_1)


def test_model_hlarctype_1_constructor_exists():
    assert callable(model_HLArcType_1.__init__)


def test_model_hlarctype_1_constructor_args():
...
def test_model_hlarcaddin_has_type():
    assert hasattr(model_HLArcAddin, "type")
    descriptor = None
...
def test_model_petrinet_has_type():
    assert hasattr(model_PetriNet, "type")
    descriptor = None
...
@given(instance=model_HLArcAddin_strategy)
def test_model_hlarcaddin_type_setter(instance):
...
@given(instance=model_PetriNet_strategy)
def test_model_petrinet_type_setter(instance):
    original = instance.type
    instance.type = original
    assert instance.type == original
