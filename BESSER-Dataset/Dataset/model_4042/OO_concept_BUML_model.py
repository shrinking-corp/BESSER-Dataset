...
# Classes
OO_concept_PackageableElement = Class(name="OO_concept_PackageableElement", is_abstract=True)
OO_concept_Package = Class(name="OO_concept_Package")
PackageableElement = Class(name="PackageableElement")
NamedElement = Class(name="NamedElement")
OO_concept_Class = Class(name="OO_concept_Class")
Classifier = Class(name="Classifier")
Type = Class(name="Type")
OO_concept_TypedElement = Class(name="OO_concept_TypedElement", is_abstract=True)
OO_concept_Type = Class(name="OO_concept_Type", is_abstract=True)
OO_concept_BehavioralFeature = Class(name="OO_concept_BehavioralFeature", is_abstract=True)
OO_concept_Behavior = Class(name="OO_concept_Behavior")
Class_ = Class(name="Class")
OO_concept_Operation = Class(name="OO_concept_Operation")
OO_concept_Property = Class(name="OO_concept_Property")
OO_concept_Classifier = Class(name="OO_concept_Classifier", is_abstract=True)
OO_concept_NamedElement = Class(name="OO_concept_NamedElement", is_abstract=True)
OO_concept_Model = Class(name="OO_concept_Model")
Package = Class(name="Package")
TypedElement = Class(name="TypedElement")
BehavioralFeature = Class(name="BehavioralFeature")
OO_concept_Parameter = Class(name="OO_concept_Parameter")
OO_concept_Feature = Class(name="OO_concept_Feature", is_abstract=True)
Feature = Class(name="Feature")
OO_concept_Generalization = Class(name="OO_concept_Generalization")
OO_concept_Dependency = Class(name="OO_concept_Dependency")
...
OO_concept_NamedElement.attributes={OO_concept_NamedElement_visibility, OO_concept_NamedElement_isAbstract, OO_concept_NamedElement_name}
...
domain_model = DomainModel(
    name="OO_concept",
    types={OO_concept_PackageableElement, OO_concept_Package, PackageableElement, NamedElement, OO_concept_Class, Classifier, Type, OO_concept_TypedElement, OO_concept_Type, OO_concept_BehavioralFeature, OO_concept_Behavior, Class_, OO_concept_Operation, OO_concept_Property, OO_concept_Classifier, OO_concept_NamedElement, OO_concept_Model, Package, TypedElement, BehavioralFeature, OO_concept_Parameter, OO_concept_Feature, Feature, OO_concept_Generalization, OO_concept_Dependency, VisibilityKind},
    associations={packagedElement0, client12, generalization15, type16, method17, ownedOperation1, ownedAttribute2, nestedClassifier4, ownedParameter6, general8, specific10, supplier11},
    generalizations={gen_OO_concept_Package_PackageableElement, gen_OO_concept_Package_NamedElement, gen_OO_concept_Class_PackageableElement, gen_OO_concept_Class_Classifier, gen_OO_concept_Class_Type, gen_OO_concept_TypedElement_NamedElement, gen_OO_concept_Type_NamedElement, gen_OO_concept_BehavioralFeature_Feature, gen_OO_concept_Behavior_Class, gen_OO_concept_Model_Package, gen_OO_concept_Operation_TypedElement, gen_OO_concept_Operation_BehavioralFeature, gen_OO_concept_Feature_NamedElement, gen_OO_concept_Property_TypedElement, gen_OO_concept_Property_Feature, gen_OO_concept_Parameter_TypedElement, gen_OO_concept_Dependency_PackageableElement},
    metadata=None
)
