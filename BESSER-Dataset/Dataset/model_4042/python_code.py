...
class OO_concept_NamedElement(ABC):
    ...
    def __init__(self, name: str, isAbstract: bool, visibility: str, OO_concept_NamedElement14: "OO_concept_Dependency" = None, OO_concept_NamedElement: "OO_concept_Dependency" = None):
        self.name = name
...
class OO_concept_Dependency(PackageableElement):
    ...
    pass
class OO_concept_Class(Classifier, Type, PackageableElement):
