...
class graph_GPort(GShapeElement):
    ...
    pass
class graph_GLabel(GEdgeLayoutable, GShapeElement, GAlignable):
...
class graph_GBounds:
    ...
    def __init__(self, height: float, x: float, y: float, width: float, graph_GBounds: "graph_GModelRoot" = None):
        self.height = height
        self.x = x
        self.y = y
        self.width = width
...
class graph_GEdge(GModelElement):
    ...
    def __init__(self, sourceId: str, targetId: str, graph_GEdge: set["graph_GPoint"] = None, graph_GEdge9: "graph_GModelElement" = None, graph_GEdge11: "graph_GModelElement" = None):
...
class graph_GModelElement(ABC):
    ...
    def __init__(self, id: str, cssClasses: str, trace: str, type: str, graph_GModelElement: "graph_GEdge" = None, graph_GModelElement12: "graph_GEdge" = None, GModelElement: "graph_GModelElement" = None, parent: set["graph_GModelElement"] = None, GModelElement4: "graph_GModelElement" = None, children: "graph_GModelElement" = None):
        self.id = id
