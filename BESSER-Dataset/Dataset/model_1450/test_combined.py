...
def test_hyp_gside_exists():
    # Check that the Enumeration exists
    assert GSide is not None

def test_hyp_gside_has_all_literals():
    # Collect the names of literals in this Enumeration
    enum_literals = [lit.name for lit in GSide]
    expected_literals = [
        "left",
        "on",
        "right",
    ...
    for lit_name in expected_literals:
        assert lit_name in enum_literals, f"Literal '' missing in GSide"
