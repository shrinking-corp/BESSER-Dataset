...
graph_GLayoutOptions.attributes={graph_GLayoutOptions_vAlign, graph_GLayoutOptions_hGap, graph_GLayoutOptions_vGap, graph_GLayoutOptions_minHeight, graph_GLayoutOptions_resizeContainer, graph_GLayoutOptions_paddingBottom, graph_GLayoutOptions_paddingLeft, graph_GLayoutOptions_minWidth, graph_GLayoutOptions_paddingFactor, graph_GLayoutOptions_hAlign, graph_GLayoutOptions_paddingRight, graph_GLayoutOptions_paddingTop}
...
graph_GBounds.attributes={graph_GBounds_width, graph_GBounds_x, graph_GBounds_height, graph_GBounds_y}
...
graph_GEdge.attributes={graph_GEdge_sourceId, graph_GEdge_targetId}
...
domain_model = DomainModel(
    name="graph",
    types={graph_GModelElement, graph_GShapeElement, GModelElement, GBoundsAware, graph_GGraph, GModelRoot, graph_GLayoutOptions, graph_GModelRoot, graph_GBounds, graph_GNode, GShapeElement, GEdgeLayoutable, GLayouting, graph_GEdge, graph_GPoint, graph_GCompartment, graph_GLabel, GAlignable, graph_GIssueMarker, graph_GIssue, graph_GPort, graph_GEdgeLayoutable, graph_GEdgePlacement, graph_GLayouting, graph_GButton, graph_GBoundsAware, graph_GDimension, graph_GAlignable, graph_GHtmlRoot, graph_GPreRenderedElement, GSide, GSeverity},
    associations={layoutOptions5, canvasBounds6, routingPoints7, source8, target10, issues13, children1, parent3, edgePlacement18, position14, size16, alignment21, layoutOptions19},
