...
class library_Library:
    ...
    def __init__(self, name: str, library_Library: set["library_Function"] = None, library_Library89: set["library_NodeType"] = None, library_Library91: set["library_Equipment"] = None, library_Library94: set["library_Metric"] = None, library_Library100: set["library_Protocol"] = None, library_Library103: set["library_Tolerance"] = None, library_Library97: set["library_Parameter"] = None, library_Library106: set["library_Expression"] = None, library_Library109: set["library_Unit"] = None, library_Library111: "library_Meta" = None):
        self.name = name
...
class library_Function:
    ...
    def __init__(self, functionName: str, description: str, library_Function72: set["library_Tolerance"] = None, library_Function60: "library_Function" = None, library_Function58: set["library_Function"] = None, library_Function62: set["library_NetXResource"] = None, library_Function65: set["library_Metric"] = None, library_Function75: set["library_Protocol"] = None, library_Function78: set["library_Parameter"] = None, library_Function81: set["library_NetXResource"] = None, library_Function85: "library_Function" = None, library_Function83: set["library_Function"] = None, library_Function87: "library_Library" = None, library_Function: set["library_DiagramInfo"] = None, library_Function56: "library_MultiImage" = None, Function: "library_Expression" = None, library_Function68: set["library_FunctionRelationship"] = None, functionRefs: set["library_Expression"] = None, library_Function130: "library_NodeType" = None, library_Function139: "library_ProductInfo" = None):
...
class library_Parameter:
    ...
    def __init__(self, modifiable: str, name: str, value: str, description: str, expressionName: str, library_Parameter79: "library_Function" = None, library_Parameter98: "library_Library" = None, library_Parameter: "library_Equipment" = None, library_Parameter42: "library_EquipmentGroup" = None):
...
class library_Protocol:
    ...
    def __init__(self, name: str, oSI: str, specification: str, description: str, library_Protocol76: "library_Function" = None, library_Protocol101: "library_Library" = None, library_Protocol: "library_Equipment" = None, library_Protocol144: set["library_Procedure"] = None, library_Protocol147: "library_Company" = None):
        self.name = name
        self.oSI = oSI
...
class library_NetXResource:
    ...
    def __init__(self, detailDisplay: str, expressionName: str, longName: str, shortName: str, summaryDisplay: str, library_NetXResource63: "library_Function" = None, library_NetXResource82: "library_Function" = None, library_NetXResource: "library_Equipment" = None, library_NetXResource23: "library_Equipment" = None, library_NetXResource34: "library_EquipmentGroup" = None, library_NetXResource45: "library_EquipmentGroup" = None, library_NetXResource115: set["library_Value"] = None, library_NetXResource117: set["library_Value"] = None, library_NetXResource120: set["library_Value"] = None, library_NetXResource113: set["library_MetricValueRange"] = None, library_NetXResource126: "library_Unit" = None, library_NetXResource123: set["library_Value"] = None):
...
class library_EquipmentGroup:
    ...
    def __init__(self, description: str, name: str, count: str, library_EquipmentGroup: "library_Equipment" = None, library_EquipmentGroup33: set["library_NetXResource"] = None, equipmentGroupRefs: set["library_Expression"] = None, library_EquipmentGroup38: set["library_Equipment"] = None, library_EquipmentGroup30: set["library_DiagramInfo"] = None, library_EquipmentGroup41: set["library_Parameter"] = None, library_EquipmentGroup44: set["library_NetXResource"] = None, library_EquipmentGroup47: set["library_Equipment"] = None, EquipmentGroup: "library_Expression" = None):
        self.description = description
        self.name = name
        self.count = count
...
class library_Tolerance:
    ...
    def __init__(self, expression: str, level: str, name: str, library_Tolerance73: "library_Function" = None, library_Tolerance104: "library_Library" = None, library_Tolerance: "library_Equipment" = None):
...
class library_Expression:
    ...
    def __init__(self, expressionLines: str, name: str, library_Expression107: "library_Library" = None, Expression: "library_Equipment" = None, Expression36: "library_EquipmentGroup" = None, equipmentExpressionRefs: set["library_Equipment"] = None, functionExpressionRefs: set["library_Function"] = None, expressionRefs: set["library_EquipmentGroup"] = None, library_Expression: set["library_ServiceProfile"] = None, Expression70: "library_Function" = None):
...
class library_Equipment:
    ...
    def __init__(self, count: str, description: str, equipmentCode: str, equipmentName: str, position: str, redundancy: str, state: str, library_Equipment92: "library_Library" = None, library_Equipment: "library_Lifecycle" = None, library_Equipment13: set["library_EquipmentRelationship"] = None, equipmentRefs: set["library_Expression"] = None, library_Equipment16: set["library_Tolerance"] = None, library_Equipment2: set["library_DiagramInfo"] = None, library_Equipment5: "library_Equipment" = None, library_Equipment3: set["library_Equipment"] = None, library_Equipment7: set["library_EquipmentGroup"] = None, library_Equipment9: set["library_NetXResource"] = None, library_Equipment11: set["library_Metric"] = None, library_Equipment18: set["library_Protocol"] = None, library_Equipment20: set["library_Parameter"] = None, library_Equipment22: set["library_NetXResource"] = None, library_Equipment26: "library_Equipment" = None, library_Equipment24: set["library_Equipment"] = None, library_Equipment28: "library_MultiImage" = None, library_Equipment39: "library_EquipmentGroup" = None, library_Equipment48: "library_EquipmentGroup" = None, Equipment: "library_Expression" = None, library_Equipment133: "library_NodeType" = None, library_Equipment136: "library_ProductInfo" = None):
        self.count = count
        self.description = description
