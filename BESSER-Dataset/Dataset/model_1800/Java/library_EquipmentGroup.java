...
public class library_EquipmentGroup  {
    ...
    public library_EquipmentGroup(
        String name,        String count,        String description        ArrayList<library_Equipment> library_equipments,        ArrayList<library_DiagramInfo> library_diagraminfos,        ArrayList<library_Expression> library_expressions,        ArrayList<library_Equipment> library_equipments    ) {
        this.name = name;
        this.count = count;
        this.description = description;
