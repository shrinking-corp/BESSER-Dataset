...
def test_hyp_library_company_is_not_abstract():
    assert not inspect.isabstract(library_Company)


def test_hyp_library_company_constructor_exists():
    assert callable(library_Company.__init__)


def test_hyp_library_company_constructor_args():
...
def test_hyp_library_procedure_is_not_abstract():
    assert not inspect.isabstract(library_Procedure)


def test_hyp_library_procedure_constructor_exists():
    assert callable(library_Procedure.__init__)


def test_hyp_library_procedure_constructor_args():
...
def test_hyp_library_message_is_not_abstract():
    assert not inspect.isabstract(library_Message)


def test_hyp_library_message_constructor_exists():
    assert callable(library_Message.__init__)


def test_hyp_library_message_constructor_args():
...
def test_hyp_ositype_exists():
    # Check that the Enumeration exists
    assert OSIType is not None

def test_hyp_ositype_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_library_procedure_name_setter(instance):
...
def test_hyp_library_meta_version_setter(instance):
...
@given(instance=library_Meta_strategy)
def test_hyp_library_meta_description_setter(instance):
...
@given(instance=library_Meta_strategy)
def test_hyp_library_meta_author_setter(instance):
...
def test_hyp_library_message_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_library_protocol_oSI_setter(instance):
...
@given(instance=library_Protocol_strategy)
def test_hyp_library_protocol_description_setter(instance):
    original = instance.description
    instance.description = original
    assert instance.description == original
...
@given(instance=library_Protocol_strategy)
def test_hyp_library_protocol_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=library_Protocol_strategy)
def test_hyp_library_protocol_specification_setter(instance):
