...
petrinetsemantics_TM3PetriNet_PNSimEvent.attributes={petrinetsemantics_TM3PetriNet_PNSimEvent_date, petrinetsemantics_TM3PetriNet_PNSimEvent_internal, petrinetsemantics_TM3PetriNet_PNSimEvent_name}
...
domain_model = DomainModel(
    ...
    types={Node, petrinetsemantics_DDMMPetriNet_PetriNet, Arc, petrinetsemantics_DDMMPetriNet_Transition, petrinetsemantics_DDMMPetriNet_Node, PetriNet, petrinetsemantics_DDMMPetriNet_Place, petrinetsemantics_DDMMPetriNet_Arc, petrinetsemantics_SDMMPetriNet_Node_dynamic, petrinetsemantics_SDMMPetriNet_Place_dynamic, Node_dynamic, Place, petrinetsemantics_SDMMPetriNet_PetriNet_dynamic, petrinetsemantics_EDMMPetriNet_PetriNetEvent, PNSimEvent, petrinetsemantics_EDMMPetriNet_FireTransitionEvent, PetriNetEvent, Transition, petrinetsemantics_TM3PetriNet_PNScenario, PNTrace, petrinetsemantics_TM3PetriNet_PNTrace, PNScenario, petrinetsemantics_TM3PetriNet_PNSimEvent, ArcKind},
    associations={nodes0, arcs1, net3, outgoings4, incomings6, target8, source10, net12, Node_static14, Place_static16, nodes17, PetriNet_static18, firedTransition21, traces22, simEvents23, scenario24},
    generalizations={gen_petrinetsemantics_DDMMPetriNet_Transition_Node, gen_petrinetsemantics_DDMMPetriNet_Place_Node, gen_petrinetsemantics_SDMMPetriNet_Place_dynamic_Node_dynamic, gen_petrinetsemantics_EDMMPetriNet_PetriNetEvent_PNSimEvent, gen_petrinetsemantics_EDMMPetriNet_FireTransitionEvent_PetriNetEvent},
    metadata=None
)
