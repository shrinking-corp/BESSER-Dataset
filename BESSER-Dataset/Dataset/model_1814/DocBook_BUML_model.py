...
docbook_Identifiable = Class(name="docbook_Identifiable", is_abstract=True)
...
domain_model = DomainModel(
    name="docbook",
    types={docbook_DocBook, Identifiable, docbook_Book, docbook_Article, docbook_TitledElement, TitledElement, docbook_Sect1, docbook_Section, docbook_Para, Section, docbook_Sect2, docbook_Identifiable},
    associations={books0, articles1, sections_13, paras5, sections_26},
    generalizations={gen_docbook_DocBook_Identifiable, gen_docbook_Book_Identifiable, gen_docbook_TitledElement_Identifiable, gen_docbook_Article_TitledElement, gen_docbook_Section_TitledElement, gen_docbook_Sect1_Section, gen_docbook_Sect2_Section, gen_docbook_Para_Identifiable},
    metadata=None
)
