...
def test_hyp_docbook_identifiable_is_not_abstract():
    assert not inspect.isabstract(docbook_Identifiable)


def test_hyp_docbook_identifiable_constructor_exists():
    assert callable(docbook_Identifiable.__init__)


def test_hyp_docbook_identifiable_constructor_args():
    sig = inspect.signature(docbook_Identifiable.__init__)
...
docbook_Identifiable_strategy = st.builds(
    docbook_Identifiable,
    id=
        safe_text
)
...
@given(instance=docbook_Identifiable_strategy)
def test_hyp_docbook_identifiable_id_setter(instance):
...
def test_docbook_Identifiable_id_value_roundtrip():
    instance = docbook_Identifiable(id="sample_text")
...
def test_docbook_Book_isa_Identifiable():
    instance = docbook_Book()
    assert isinstance(instance, Identifiable)


def test_docbook_DocBook_isa_Identifiable():
    instance = docbook_DocBook()
    assert isinstance(instance, Identifiable)


def test_docbook_Para_isa_Identifiable():
    instance = docbook_Para(content="sample_text")
    assert isinstance(instance, Identifiable)


def test_docbook_TitledElement_isa_Identifiable():
    instance = docbook_TitledElement(title="sample_text")
    assert isinstance(instance, Identifiable)
...
docbook_Identifiable_strategy = st.builds(docbook_Identifiable, id=safe_text)
@given(instance=docbook_Identifiable_strategy)
@settings(max_examples=25)
def test_docbook_Identifiable_instantiation(instance):
    assert isinstance(instance, docbook_Identifiable)
