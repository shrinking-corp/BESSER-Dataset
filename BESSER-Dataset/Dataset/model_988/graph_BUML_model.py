...
graph_GraphAsset = Class(name="graph_GraphAsset")
graph_Identifiable = Class(name="graph_Identifiable", is_abstract=True)
graph_NodeResponsibility = Class(name="graph_NodeResponsibility")
graph_Subgraphs = Class(name="graph_Subgraphs")
...
graph_Node.attributes={graph_Node_AttackerObservation, graph_Node_Attacker, graph_Node_visited, graph_Node_name}
...
graph_GraphAsset.attributes={graph_GraphAsset_Label, graph_GraphAsset_Encrypted}
...
domain_model = DomainModel(
    name="graph",
    types={graph_Edge, Identifiable, graph_Node, graph_GraphAsset, graph_Identifiable, graph_NodeResponsibility, graph_Subgraphs, graph_Graph},
    associations={source6, targets9, target0, source1, graphassets4, outedges12, responsibility15, inedges17, nodes20, assets22, outgoingassets25, incomingassets28, subgraphs31},
