...
class graph_Node(Identifiable):
    ...
    def __init__(self, name: str, AttackerObservation: int, visited: bool, Attacker: bool, graph_Node11: "graph_GraphAsset" = None, graph_Node: "graph_Edge" = None, graph_Node3: "graph_Edge" = None, graph_Node13: set["graph_Edge"] = None, graph_Node16: set["graph_NodeResponsibility"] = None, graph_Node18: set["graph_Edge"] = None, graph_Node21: "graph_Subgraphs" = None, graph_Node8: "graph_GraphAsset" = None):
        self.name = name
...
class graph_GraphAsset(Identifiable):
    ...
    def __init__(self, Encrypted: bool, Label: int, graph_GraphAsset10: set["graph_Node"] = None, graph_GraphAsset: "graph_Edge" = None, graph_GraphAsset24: "graph_Subgraphs" = None, graph_GraphAsset27: "graph_NodeResponsibility" = None, graph_GraphAsset30: "graph_NodeResponsibility" = None, graph_GraphAsset7: "graph_Node" = None):
...
class graph_NodeResponsibility(Identifiable):
    ...
    def __init__(self, operation: str, graph_NodeResponsibility: "graph_Node" = None, graph_NodeResponsibility26: set["graph_GraphAsset"] = None, graph_NodeResponsibility29: set["graph_GraphAsset"] = None):
    ...
    def findLeastRestrictiveLabel(self) :
        # TODO: Implement findLeastRestrictiveLabel method
        pass

    def findMostRestrictiveLabel(self) :
