...
# Classes
atem_AbstractComponent = Class(name="atem_AbstractComponent")
atem_HeadComponent = Class(name="atem_HeadComponent")
atem_AtemModel = Class(name="atem_AtemModel")
atem_TemplateStatus = Class(name="atem_TemplateStatus")
atem_Import = Class(name="atem_Import")
atem_Driver = Class(name="atem_Driver")
atem_Head = Class(name="atem_Head")
atem_Preface = Class(name="atem_Preface")
atem_HeaderFooterFragment = Class(name="atem_HeaderFooterFragment")
atem_PageKeepWithNext = Class(name="atem_PageKeepWithNext")
atem_PageHeaderEven = Class(name="atem_PageHeaderEven")
atem_HeaderFooterColumn = Class(name="atem_HeaderFooterColumn")
atem_PageHeaderOdd = Class(name="atem_PageHeaderOdd")
atem_PageFooterEven = Class(name="atem_PageFooterEven")
atem_TemplateTitle = Class(name="atem_TemplateTitle")
HeadComponent = Class(name="HeadComponent")
atem_Commemoration = Class(name="atem_Commemoration")
atem_VersionSwitch = Class(name="atem_VersionSwitch")
...
atem_PageFooterOdd = Class(name="atem_PageFooterOdd")
atem_HeaderFooterColumnLeft = Class(name="atem_HeaderFooterColumnLeft")
HeaderFooterColumn = Class(name="HeaderFooterColumn")
atem_HeaderFooterColumnCenter = Class(name="atem_HeaderFooterColumnCenter")
atem_HeaderFooterColumnRight = Class(name="atem_HeaderFooterColumnRight")
atem_HeaderFooterText = Class(name="atem_HeaderFooterText")
HeaderFooterFragment = Class(name="HeaderFooterFragment")
atem_HeaderFooterDate = Class(name="atem_HeaderFooterDate")
atem_HeaderFooterPageNumber = Class(name="atem_HeaderFooterPageNumber")
atem_HeaderFooterLookup = Class(name="atem_HeaderFooterLookup")
atem_ElementType = Class(name="atem_ElementType")
atem_HeaderFooterTitle = Class(name="atem_HeaderFooterTitle")
atem_HeaderFooterCommemoration = Class(name="atem_HeaderFooterCommemoration")
atem_Info = Class(name="atem_Info")
atem_InfoElementType = Class(name="atem_InfoElementType")
atem_Date = Class(name="atem_Date")
SectionElementType = Class(name="SectionElementType")
atem_ResourceText = Class(name="atem_ResourceText")
ElementType = Class(name="ElementType")
atem_Definition = Class(name="atem_Definition")
atem_Lookup = Class(name="atem_Lookup")
atem_LDP = Class(name="atem_LDP")
atem_LdpType = Class(name="atem_LdpType")
atem_TaggedText = Class(name="atem_TaggedText")
atem_DOP = Class(name="atem_DOP")
atem_DOWN = Class(name="atem_DOWN")
atem_DOWT = Class(name="atem_DOWT")
atem_EOW = Class(name="atem_EOW")
atem_SAEC = Class(name="atem_SAEC")
atem_SOL = Class(name="atem_SOL")
atem_PrefaceElementType = Class(name="atem_PrefaceElementType")
atem_Section = Class(name="atem_Section")
atem_SectionElementType = Class(name="atem_SectionElementType")
atem_All = Class(name="atem_All")
LdpType = Class(name="LdpType")
atem_GenDate = Class(name="atem_GenDate")
atem_GenYear = Class(name="atem_GenYear")
atem_MCD = Class(name="atem_MCD")
atem_MOW = Class(name="atem_MOW")
atem_NOP = Class(name="atem_NOP")
atem_DOM = Class(name="atem_DOM")
atem_PassThroughPdf = Class(name="atem_PassThroughPdf")
atem_Title = Class(name="atem_Title")
atem_SubTitle = Class(name="atem_SubTitle")
atem_DOL = Class(name="atem_DOL")
atem_WOLC = Class(name="atem_WOLC")
atem_WDOLC = Class(name="atem_WDOLC")
atem_SBT = Class(name="atem_SBT")
atem_TemplateFragment = Class(name="atem_TemplateFragment")
atem_PrefaceFragment = Class(name="atem_PrefaceFragment")
atem_SectionFragment = Class(name="atem_SectionFragment")
atem_Break = Class(name="atem_Break")
atem_PageNumber = Class(name="atem_PageNumber")
atem_PassThroughHtml = Class(name="atem_PassThroughHtml")
atem_Hymn = Class(name="atem_Hymn")
atem_Media = Class(name="atem_Media")
atem_Verse = Class(name="atem_Verse")
atem_Paragraph = Class(name="atem_Paragraph")
atem_Actor = Class(name="atem_Actor")
atem_Block = Class(name="atem_Block")
atem_Reading = Class(name="atem_Reading")
atem_Heading1 = Class(name="atem_Heading1")
atem_Heading2 = Class(name="atem_Heading2")
atem_Heading3 = Class(name="atem_Heading3")
atem_Aid = Class(name="atem_Aid")
atem_Version = Class(name="atem_Version")
atem_LitBook = Class(name="atem_LitBook")
atem_SetLocale = Class(name="atem_SetLocale")
atem_Rubric = Class(name="atem_Rubric")
atem_Dialog = Class(name="atem_Dialog")
atem_RestoreLocale = Class(name="atem_RestoreLocale")
atem_WhenDate = Class(name="atem_WhenDate")
atem_WhenDateCase = Class(name="atem_WhenDateCase")
atem_WhenOther = Class(name="atem_WhenOther")
atem_AbstractDateCase = Class(name="atem_AbstractDateCase")
atem_WhenDayName = Class(name="atem_WhenDayName")
atem_WhenDayNameCase = Class(name="atem_WhenDayNameCase")
atem_AbstractDayNameCase = Class(name="atem_AbstractDayNameCase")
atem_DayNameRange = Class(name="atem_DayNameRange")
AbstractDayNameCase = Class(name="AbstractDayNameCase")
atem_DayNameSet = Class(name="atem_DayNameSet")
atem_WhenPentecostarionDay = Class(name="atem_WhenPentecostarionDay")
atem_WhenPeriodCase = Class(name="atem_WhenPeriodCase")
atem_WhenTriodionDay = Class(name="atem_WhenTriodionDay")
atem_DateRange = Class(name="atem_DateRange")
AbstractDateCase = Class(name="AbstractDateCase")
atem_DateSet = Class(name="atem_DateSet")
atem_WhenSundayAfterElevationOfCrossDay = Class(name="atem_WhenSundayAfterElevationOfCrossDay")
atem_WhenLukanCycleDay = Class(name="atem_WhenLukanCycleDay")
atem_WhenPascha = Class(name="atem_WhenPascha")
atem_AbstractDayCase = Class(name="atem_AbstractDayCase")
atem_DayRange = Class(name="atem_DayRange")
AbstractDayCase = Class(name="AbstractDayCase")
atem_WhenMovableCycleDay = Class(name="atem_WhenMovableCycleDay")
atem_ModeOfWeekSet = Class(name="atem_ModeOfWeekSet")
atem_WhenSundaysBeforeTriodion = Class(name="atem_WhenSundaysBeforeTriodion")
atem_SundaysBeforeTriodionCase = Class(name="atem_SundaysBeforeTriodionCase")
atem_DaySet = Class(name="atem_DaySet")
atem_WhenModeOfWeek = Class(name="atem_WhenModeOfWeek")
atem_WhenModeOfWeekCase = Class(name="atem_WhenModeOfWeekCase")
atem_WhenExistsCase = Class(name="atem_WhenExistsCase")
atem_WhenExists = Class(name="atem_WhenExists")
...
atem_Driver.attributes={atem_Driver_dsl_Driver_Status, atem_Driver_dsl_Driver_RegEx}
...
atem_HeaderFooterDate.attributes={atem_HeaderFooterDate_dsl_HeaderFooterDate_Language, atem_HeaderFooterDate_dsl_HeaderFooterDate}
...
atem_Date.attributes={atem_Date_dsl_Date_year, atem_Date_dsl_Date_day, atem_Date_dsl_Date_month}
...
atem_Lookup.attributes={atem_Lookup_dsl_Lookup_Override__Day_Set, atem_Lookup_dsl_Lookup_Media_Off, atem_Lookup_dsl_Lookup_OverrideMode, atem_Lookup_dsl_Lookup_OverrideDay, atem_Lookup_dsl_Lookup_Override_Mode_Set}
...
atem_DayNameRange.attributes={atem_DayNameRange_dsl_DayNameRange_To, atem_DayNameRange_dsl_DayNameRange_from}
...
atem_DateRange.attributes={atem_DateRange_dsl_DateRange_from, atem_DateRange_dsl_DateRange_To}
...
atem_DayRange.attributes={atem_DayRange_dsl_DayRange_from, atem_DayRange_dsl_Range_To}
...
domain_model = DomainModel(
    name="atem",
    types={atem_AbstractComponent, atem_HeadComponent, atem_AtemModel, atem_TemplateStatus, atem_Import, atem_Driver, atem_Head, atem_Preface, atem_HeaderFooterFragment, atem_PageKeepWithNext, atem_PageHeaderEven, atem_HeaderFooterColumn, atem_PageHeaderOdd, atem_PageFooterEven, atem_TemplateTitle, HeadComponent, atem_Commemoration, atem_VersionSwitch, AbstractComponent, InfoElementType, PrefaceElementType, atem_PageFooterOdd, atem_HeaderFooterColumnLeft, HeaderFooterColumn, atem_HeaderFooterColumnCenter, atem_HeaderFooterColumnRight, atem_HeaderFooterText, HeaderFooterFragment, atem_HeaderFooterDate, atem_HeaderFooterPageNumber, atem_HeaderFooterLookup, atem_ElementType, atem_HeaderFooterTitle, atem_HeaderFooterCommemoration, atem_Info, atem_InfoElementType, atem_Date, SectionElementType, atem_ResourceText, ElementType, atem_Definition, atem_Lookup, atem_LDP, atem_LdpType, atem_TaggedText, atem_DOP, atem_DOWN, atem_DOWT, atem_EOW, atem_SAEC, atem_SOL, atem_PrefaceElementType, atem_Section, atem_SectionElementType, atem_All, LdpType, atem_GenDate, atem_GenYear, atem_MCD, atem_MOW, atem_NOP, atem_DOM, atem_PassThroughPdf, atem_Title, atem_SubTitle, atem_DOL, atem_WOLC, atem_WDOLC, atem_SBT, atem_TemplateFragment, atem_PrefaceFragment, atem_SectionFragment, atem_Break, atem_PageNumber, atem_PassThroughHtml, atem_Hymn, atem_Media, atem_Verse, atem_Paragraph, atem_Actor, atem_Block, atem_Reading, atem_Heading1, atem_Heading2, atem_Heading3, atem_Aid, atem_Version, atem_LitBook, atem_SetLocale, atem_Rubric, atem_Dialog, atem_RestoreLocale, atem_WhenDate, atem_WhenDateCase, atem_WhenOther, atem_AbstractDateCase, atem_WhenDayName, atem_WhenDayNameCase, atem_AbstractDayNameCase, atem_DayNameRange, AbstractDayNameCase, atem_DayNameSet, atem_WhenPentecostarionDay, atem_WhenPeriodCase, atem_WhenTriodionDay, atem_DateRange, AbstractDateCase, atem_DateSet, atem_WhenSundayAfterElevationOfCrossDay, atem_WhenLukanCycleDay, atem_WhenPascha, atem_AbstractDayCase, atem_DayRange, AbstractDayCase, atem_WhenMovableCycleDay, atem_ModeOfWeekSet, atem_WhenSundaysBeforeTriodion, atem_SundaysBeforeTriodionCase, atem_DaySet, atem_WhenModeOfWeek, atem_WhenModeOfWeekCase, atem_WhenExistsCase, atem_WhenExists, VersionSwitchType, Language, BreakType, TemplateStatuses, Null, ModeTypes, DowTypes, BookTypes, Seasons, DayOfMonthTypes, PeriodType, DayOfWeek, MonthName},
    associations={dsl_Template_components9, dsl_Head_components11, dsl_Template_Status0, imports1, dsl_Template_Driver3, dsl_Template_head5, dsl_Template_preface7, dsl_TemplateTitle_Elements13, dsl_PageHeader_columns14, dsl_PageHeader_columns15, dsl_Commemoration_Elements25, dsl_PageHeader_columns17, dsl_PageHeader_columns19, dsl_HeaderFooterColumn_fragments21, dsl_HeaderFooterLookup_Elements24, dsl_TaggedText_tag31, dsl_TaggedText33, dsl_Info_Elements36, dsl_ResourceTextRef27, dsl_ResourceTextRef28, dsl_LDP30, dsl_Preface_Elements37, dsl_Section_Role39, dsl_Section_Elements41, dsl_Title_Role49, dsl_Elements51, name43, name45, name47, dsl_Elements66, dsl_Elements69, dsl_SubTitle_Role54, dsl_Elements71, dsl_Elements56, dsl_Elements73, dsl_Para_Role59, dsl_Elements61, dsl_Block_Role64, dsl_Elements79, dsl_Elements81, dsl_Elements83, dsl_Elements85, dsl_Elements87, dsl_Elements75, dsl_Elements77, dsl_WhenDate_Cases89, dsl_WhenDate_Other90, dsl_WhenDateCase_Days92, dsl_WhenDayName_Cases97, dsl_WhenDayName_Other98, dsl_WhenDayNameCase_Days101, dsl_WhenDayNameCase_True_actions103, dsl_WhenPentecostarionDay_Cases106, dsl_WhenPentecostarionDay_Other107, dsl_WhenTriodionDay_Cases110, dsl_WhenDateCase_True_actions94, dsl_WhenSundayAfterElevationOfCrossDay_Cases120, dsl_WhenSundayAfterElevationOfCrossDay_Other122, dsl_WhenLukanCycleDay_Cases125, dsl_WhenLukanCycleDay_Other127, dsl_WhenPascha_true_actions130, dsl_WhenPascha_Other_actions132, dsl_WhenCase_Other_actions135, dsl_WhenPeriodCase_Days138, dsl_WhenPeriodCase_True_actions140, dsl_WhenTriodionDay_Other112, dsl_WhenMovableCycleDay_Cases115, dsl_WhenMovableCycleDay_Other117, dsl_WhenModeOfWeek_Other144, dsl_WhenModeOfWeekCase_Days147, dsl_WhenModeOfWeekCase_True_actions149, dsl_WhenSundaysBeforeTriodion_Cases152, dsl_SundaysBeforeTriodion_Other153, dsl_SundaysBeforeTriodionCase_True_actions156, dsl_WhenModeOfWeek_Cases143, dsl_WhenExists_Cases159, dsl_WhenExists_Other160, dsl_WhenExistsCase_Ref163, dsl_WhenExistsCase_True_actions166},
    generalizations={gen_atem_PageKeepWithNext_HeadComponent, gen_atem_PageHeaderEven_HeadComponent, gen_atem_PageHeaderOdd_HeadComponent, gen_atem_PageFooterEven_HeadComponent, gen_atem_TemplateTitle_HeadComponent, gen_atem_Commemoration_HeadComponent, gen_atem_VersionSwitch_AbstractComponent, gen_atem_VersionSwitch_InfoElementType, gen_atem_VersionSwitch_PrefaceElementType, gen_atem_PageFooterOdd_HeadComponent, gen_atem_HeaderFooterColumnLeft_HeaderFooterColumn, gen_atem_HeaderFooterColumnCenter_HeaderFooterColumn, gen_atem_HeaderFooterColumnRight_HeaderFooterColumn, gen_atem_HeaderFooterText_HeaderFooterFragment, gen_atem_HeaderFooterDate_HeaderFooterFragment, gen_atem_HeaderFooterPageNumber_HeaderFooterFragment, gen_atem_HeaderFooterLookup_HeaderFooterFragment, gen_atem_HeaderFooterTitle_HeaderFooterFragment, gen_atem_HeaderFooterCommemoration_HeaderFooterFragment, gen_atem_Info_AbstractComponent, gen_atem_Date_HeadComponent, gen_atem_Date_SectionElementType, gen_atem_ResourceText_ElementType, gen_atem_Lookup_ElementType, gen_atem_LDP_ElementType, gen_atem_TaggedText_ElementType, gen_atem_DOP_LdpType, gen_atem_DOWN_LdpType, gen_atem_DOWT_LdpType, gen_atem_EOW_LdpType, gen_atem_SAEC_LdpType, gen_atem_SOL_LdpType, gen_atem_Section_AbstractComponent, gen_atem_Section_PrefaceElementType, gen_atem_Section_SectionElementType, gen_atem_All_LdpType, gen_atem_GenDate_LdpType, gen_atem_GenYear_LdpType, gen_atem_MCD_LdpType, gen_atem_MOW_LdpType, gen_atem_NOP_LdpType, gen_atem_DOM_LdpType, gen_atem_PassThroughHtml_AbstractComponent, gen_atem_PassThroughHtml_SectionElementType, gen_atem_PassThroughPdf_AbstractComponent, gen_atem_PassThroughPdf_SectionElementType, gen_atem_Title_AbstractComponent, gen_atem_Title_InfoElementType, gen_atem_Title_PrefaceElementType, gen_atem_Title_SectionElementType, gen_atem_SubTitle_AbstractComponent, gen_atem_SubTitle_InfoElementType, gen_atem_SubTitle_PrefaceElementType, gen_atem_SubTitle_SectionElementType, gen_atem_DOL_LdpType, gen_atem_WOLC_LdpType, gen_atem_WDOLC_LdpType, gen_atem_SBT_LdpType, gen_atem_TemplateFragment_AbstractComponent, gen_atem_TemplateFragment_PrefaceElementType, gen_atem_TemplateFragment_SectionElementType, gen_atem_SectionFragment_AbstractComponent, gen_atem_SectionFragment_PrefaceElementType, gen_atem_SectionFragment_SectionElementType, gen_atem_Break_AbstractComponent, gen_atem_Break_SectionElementType, gen_atem_PageNumber_HeadComponent, gen_atem_Hymn_AbstractComponent, gen_atem_Hymn_SectionElementType, gen_atem_Media_AbstractComponent, gen_atem_Media_SectionElementType, gen_atem_Verse_AbstractComponent, gen_atem_Verse_SectionElementType, gen_atem_Paragraph_AbstractComponent, gen_atem_Paragraph_InfoElementType, gen_atem_Paragraph_PrefaceElementType, gen_atem_Paragraph_SectionElementType, gen_atem_Actor_AbstractComponent, gen_atem_Actor_SectionElementType, gen_atem_Block_AbstractComponent, gen_atem_Block_InfoElementType, gen_atem_Block_PrefaceElementType, gen_atem_Block_SectionElementType, gen_atem_Reading_AbstractComponent, gen_atem_Reading_SectionElementType, gen_atem_Heading1_AbstractComponent, gen_atem_Heading1_SectionElementType, gen_atem_Heading2_AbstractComponent, gen_atem_Heading2_SectionElementType, gen_atem_Heading3_AbstractComponent, gen_atem_Heading3_SectionElementType, gen_atem_Aid_AbstractComponent, gen_atem_Version_AbstractComponent, gen_atem_LitBook_AbstractComponent, gen_atem_SetLocale_AbstractComponent, gen_atem_SetLocale_SectionElementType, gen_atem_Rubric_AbstractComponent, gen_atem_Rubric_SectionElementType, gen_atem_Dialog_AbstractComponent, gen_atem_Dialog_SectionElementType, gen_atem_RestoreLocale_AbstractComponent, gen_atem_RestoreLocale_SectionElementType, gen_atem_WhenDate_AbstractComponent, gen_atem_WhenDate_SectionElementType, gen_atem_WhenDayName_AbstractComponent, gen_atem_WhenDayName_SectionElementType, gen_atem_DayNameRange_AbstractDayNameCase, gen_atem_DayNameSet_AbstractDayNameCase, gen_atem_WhenPentecostarionDay_AbstractComponent, gen_atem_WhenPentecostarionDay_SectionElementType, gen_atem_WhenTriodionDay_AbstractComponent, gen_atem_WhenTriodionDay_SectionElementType, gen_atem_DateRange_AbstractDateCase, gen_atem_DateSet_AbstractDateCase, gen_atem_WhenSundayAfterElevationOfCrossDay_AbstractComponent, gen_atem_WhenSundayAfterElevationOfCrossDay_SectionElementType, gen_atem_WhenLukanCycleDay_AbstractComponent, gen_atem_WhenLukanCycleDay_SectionElementType, gen_atem_WhenPascha_AbstractComponent, gen_atem_WhenPascha_SectionElementType, gen_atem_DayRange_AbstractDayCase, gen_atem_WhenMovableCycleDay_AbstractComponent, gen_atem_WhenMovableCycleDay_SectionElementType, gen_atem_WhenSundaysBeforeTriodion_AbstractComponent, gen_atem_WhenSundaysBeforeTriodion_SectionElementType, gen_atem_DaySet_AbstractDayCase, gen_atem_WhenModeOfWeek_AbstractComponent, gen_atem_WhenModeOfWeek_SectionElementType, gen_atem_WhenExists_AbstractComponent, gen_atem_WhenExists_SectionElementType},
    metadata=None
)
