...
class Reserved:
    ...
    def __init__(self, reserved_date: str, books5: set["Retro_Projetor"] = None, member6: set["Members"] = None):
...
class Borrowed:
    ...
    def __init__(self, borrowed_date: str, returned_date: str, books1: set["Retro_Projetor"] = None, member2: set["Members"] = None):
...
class Ar_Condicionado:
    ...
    def __init__(self, book_id: int, member_id: int, fine_amount: int, borrowed_date: str, returned_date: str, librarian11: set["Quado_Branco"] = None, member12: "Members" = None):
    ...
    def member12(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Ar_Condicionado__member12", None)
    ...
    def librarian11(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Ar_Condicionado__librarian11", None)
...
class Quado_Branco:
    ...
    def __init__(self, member_id: int, member_pwd: str, fname: str, lname: str, gender: str, dob: str, address: str, cont_no: int, books8: set["Retro_Projetor"] = None, fine10: set["Ar_Condicionado"] = None, member15: set["Members"] = None):
        self.member_id = member_id
    ...
    def member15(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Quado_Branco__member15", None)
    ...
    def books8(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Quado_Branco__books8", None)
    ...
    def fine10(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Quado_Branco__fine10", None)
...
class Members:
    ...
    def __init__(self, member_id: int, member_pwd: str, fname: str, lname: str, gender: str, dob: str, address: str, cont_no: int, borrowed3: set["Borrowed"] = None, reserved7: set["Reserved"] = None, fine13: set["Ar_Condicionado"] = None, librarian14: set["Quado_Branco"] = None):
        self.member_id = member_id
        self.member_pwd = member_pwd
        self.fname = fname
        self.lname = lname
    ...
    def librarian14(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Members__librarian14", None)
    ...
    def borrowed3(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Members__borrowed3", None)
    ...
    def reserved7(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Members__reserved7", None)
    ...
    def fine13(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Members__fine13", None)
...
class Retro_Projetor:

    def __init__(self, book_id: int, title: str, author_name: str, ISBN_no: str, publisher: str, book_qty: int, borrowed0: set["Borrowed"] = None, reserved4: set["Reserved"] = None, librarian9: set["Quado_Branco"] = None):
        self.book_id = book_id
        self.title = title
    ...
    def librarian9(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Retro_Projetor__librarian9", None)
    ...
    def borrowed0(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Retro_Projetor__borrowed0", None)
    ...
    def reserved4(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Retro_Projetor__reserved4", None)
