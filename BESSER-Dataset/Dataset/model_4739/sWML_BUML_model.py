...
domain_model = DomainModel(
    name="swml",
    types={swml_Class, swml_Attribute, swml_WebModel, swml_HypertextLayer, swml_ContentLayer, swml_Page, swml_Link, swml_IndexPage, DynamicPage, swml_DetailsPage, swml_DynamicPage, Page, swml_StaticPage, swml_NCLink, Link, swml_CLink, SWMLTypes},
    associations={homePage5, classes8, attributes10, hypertext0, content1, pages3, representativeAttribute12, links15, displayedClass17, target19},
