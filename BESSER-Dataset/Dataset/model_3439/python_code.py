...
class school_School:
    ...
    def __init__(self, name: str, director: str, zipCode: str, city: str, school_School: set["school_Classroom"] = None):
        self.name = name
...
class school_Student:
    ...
    def validate(self, school_context, school_diagnostic) :
