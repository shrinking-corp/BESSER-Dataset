...
def test_hyp_classm_attribute_setter(instance):
...
def test_ClassM_attribute_value_roundtrip():
    instance = ClassM(attribute="sample_text")
...
ClassM_strategy = st.builds(ClassM, attribute=safe_text)
@given(instance=ClassM_strategy)
@settings(max_examples=25)
