...
# Classes
refac_B = Class(name="refac_B")
refac_A = Class(name="refac_A")
refac_C = Class(name="refac_C")
refac_W = Class(name="refac_W")
refac_M = Class(name="refac_M")
refac_N99 = Class(name="refac_N99")
refac_X = Class(name="refac_X")
refac_K = Class(name="refac_K")
...
as_12: BinaryAssociation = BinaryAssociation(
    name="as_12",
    ends={
...
domain_model = DomainModel(
    name="refac",
    types={refac_B, refac_A, refac_C, refac_W, refac_M, refac_N99, refac_X, refac_K},
    associations={bs0, cs1, ws3, ms5, ns9997, b9, as_12, ks14, wc16, k19, k22},
    generalizations={},
    metadata=None
)
