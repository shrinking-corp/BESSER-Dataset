...
class hockeyleague_GoalieStats:
    ...
    def __init__(self, ties: int, emptyNetGoals: int, shutouts: int, goalsAgainst: int, saves: int, penaltyMinutes: int, goals: int, assists: int, points: int, year: str, gamesPlayedIn: int, minutesPlayedIn: int, goalsAgainstAverage: float, wins: int, losses: int, hockeyleague_GoalieStats: "hockeyleague_Goalie" = None, hockeyleague_GoalieStats5: "hockeyleague_Team" = None):
        self.ties = ties
...
class hockeyleague_PlayerStats:
    ...
    def __init__(self, year: str, gamesPlayedIn: int, goals: int, assists: int, points: int, plusMinus: int, penaltyMinutes: int, powerPlayGoals: int, shortHandedGoals: int, gameWinningGoals: int, shots: int, shotPercentage: float, hockeyleague_PlayerStats9: "hockeyleague_Team" = None, hockeyleague_PlayerStats: "hockeyleague_Defence" = None, hockeyleague_PlayerStats2: "hockeyleague_Forward" = None):
        self.year = year
        self.gamesPlayedIn = gamesPlayedIn
        self.goals = goals
        self.assists = assists
...
class hockeyleague_Player(HockeyleagueObject):
    ...
    def __init__(self, number: int, heightMesurement: str, heightValue: int, weightMesurement: str, weightValue: int, shot: str, birthdate: str, birthplace: str):
        self.number = number
