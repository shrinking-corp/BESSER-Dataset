...
# Classes
namespace_XMLNamespaceDocumentRoot = Class(name="namespace_XMLNamespaceDocumentRoot")
namespace_EStringToStringMapEntry = Class(name="namespace_EStringToStringMapEntry")
...
namespace_XMLNamespaceDocumentRoot.attributes={namespace_XMLNamespaceDocumentRoot_base, namespace_XMLNamespaceDocumentRoot_id, namespace_XMLNamespaceDocumentRoot_mixed, namespace_XMLNamespaceDocumentRoot_space, namespace_XMLNamespaceDocumentRoot_lang}
...
domain_model = DomainModel(
    name="namespace",
    types={namespace_XMLNamespaceDocumentRoot, namespace_EStringToStringMapEntry, SpaceType},
