...
# Classes
rdbms_Database = Class(name="rdbms_Database")
ModelElement = Class(name="ModelElement")
rdbms_UserDefinedDataType = Class(name="rdbms_UserDefinedDataType")
rdbms_Table = Class(name="rdbms_Table")
rdbms_SystemDataType = Class(name="rdbms_SystemDataType")
rdbms_ForeignKey = Class(name="rdbms_ForeignKey")
rdbms_Column = Class(name="rdbms_Column")
rdbms_CheckCon = Class(name="rdbms_CheckCon")
rdbms_PKeyAndUnique = Class(name="rdbms_PKeyAndUnique", is_abstract=True)
rdbms_DataType = Class(name="rdbms_DataType", is_abstract=True)
Constraints = Class(name="Constraints")
rdbms_PrimaryKeyCon = Class(name="rdbms_PrimaryKeyCon")
rdbms_UniqueCon = Class(name="rdbms_UniqueCon")
PKeyAndUnique = Class(name="PKeyAndUnique")
DataType = Class(name="DataType")
rdbms_ModelElement = Class(name="rdbms_ModelElement", is_abstract=True)
rdbms_Constraints = Class(name="rdbms_Constraints", is_abstract=True)
...
rdbms_UserDefinedDataType.attributes={rdbms_UserDefinedDataType_precision, rdbms_UserDefinedDataType_defaultValue, rdbms_UserDefinedDataType_length}
...
rdbms_SystemDataType.attributes={rdbms_SystemDataType_predefinedDecPlaces, rdbms_SystemDataType_predefinedLength}
...
rdbms_ForeignKey.attributes={rdbms_ForeignKey_inverseReferentialIntegrityCon, rdbms_ForeignKey_updateActionRHS, rdbms_ForeignKey_deleteActionRHS, rdbms_ForeignKey_match}
...
rdbms_Column.attributes={rdbms_Column_precision, rdbms_Column_length, rdbms_Column_nullable, rdbms_Column_default}
...
rdbms_Constraints.attributes={rdbms_Constraints_deferrable, rdbms_Constraints_deferred}
...
domain_model = DomainModel(
    name="rdbms",
    types={rdbms_Database, ModelElement, rdbms_UserDefinedDataType, rdbms_Table, rdbms_SystemDataType, rdbms_ForeignKey, rdbms_Column, rdbms_CheckCon, rdbms_PKeyAndUnique, rdbms_DataType, Constraints, rdbms_PrimaryKeyCon, rdbms_UniqueCon, PKeyAndUnique, DataType, rdbms_ModelElement, rdbms_Constraints, Action, DeferrableAct, DeferredAct, ReferencingType},
    associations={userDefinedDataTypes0, tables1, dataTypes3, tableUQ8, columns10, tableCHs12, columnInPKandUQ14, columnInFK16, columnDataType18, rhsKey20, lhsAttr23, refersTo26, FKTable29, tableFKs5, tablePK6, PKandUQColumns30, dataType33},
    generalizations={gen_rdbms_Database_ModelElement, gen_rdbms_Table_ModelElement, gen_rdbms_Column_ModelElement, gen_rdbms_ForeignKey_Constraints, gen_rdbms_CheckCon_Constraints, gen_rdbms_PKeyAndUnique_Constraints, gen_rdbms_PrimaryKeyCon_PKeyAndUnique, gen_rdbms_UniqueCon_PKeyAndUnique, gen_rdbms_SystemDataType_DataType, gen_rdbms_UserDefinedDataType_DataType, gen_rdbms_DataType_ModelElement, gen_rdbms_Constraints_ModelElement},
    metadata=None
)
