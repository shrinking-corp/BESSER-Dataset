...
class rdbms_ForeignKey(Constraints):
    ...
    def __init__(self, deleteActionRHS: str, updateActionRHS: str, match: str, inverseReferentialIntegrityCon: bool, rdbms_ForeignKey21: "rdbms_PKeyAndUnique" = None, rdbms_ForeignKey24: set["rdbms_Column"] = None, rdbms_ForeignKey27: "rdbms_Table" = None, tableFKs: "rdbms_Table" = None, ForeignKey: "rdbms_Table" = None, rdbms_ForeignKey: "rdbms_Column" = None):
        ...
        pass
    @property
    def inverseReferentialIntegrityCon(self):
...
class rdbms_SystemDataType(DataType):
    ...
    def __init__(self, predefinedLength: int, predefinedDecPlaces: int, rdbms_SystemDataType35: "rdbms_UserDefinedDataType" = None, rdbms_SystemDataType: "rdbms_Database" = None):
...
class rdbms_UserDefinedDataType(DataType):
    ...
    def __init__(self, precision: int, length: int, defaultValue: str, rdbms_UserDefinedDataType34: "rdbms_SystemDataType" = None, rdbms_UserDefinedDataType: "rdbms_Database" = None):
...
class rdbms_Column(ModelElement):
    ...
    def __init__(self, default: str, nullable: bool, precision: int, length: int, rdbms_Column25: "rdbms_ForeignKey" = None, rdbms_Column32: "rdbms_PKeyAndUnique" = None, rdbms_Column: "rdbms_Table" = None, rdbms_Column15: "rdbms_PKeyAndUnique" = None, rdbms_Column17: "rdbms_ForeignKey" = None, rdbms_Column19: "rdbms_DataType" = None):
