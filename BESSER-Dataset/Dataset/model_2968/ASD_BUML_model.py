...
# Classes
ASD_ServiceDescription = Class(name="ASD_ServiceDescription")
NamedElement = Class(name="NamedElement")
ASD_Operation = Class(name="ASD_Operation")
ASD_InfoType = Class(name="ASD_InfoType")
ASD_Profile = Class(name="ASD_Profile")
ASD_Message = Class(name="ASD_Message")
ASD_AssertionSet = Class(name="ASD_AssertionSet")
ASD_InfoTypeImported = Class(name="ASD_InfoTypeImported")
InfoType = Class(name="InfoType")
ASD_Assertion = Class(name="ASD_Assertion")
ASD_NamedElement = Class(name="ASD_NamedElement", is_abstract=True)
ASD_Annotation = Class(name="ASD_Annotation")
...
ASD_InfoType.attributes={ASD_InfoType_subset, ASD_InfoType_valueRange, ASD_InfoType_valueType}
...
ASD_Assertion.attributes={ASD_Assertion_minVal, ASD_Assertion_dimensionType, ASD_Assertion_subset, ASD_Assertion_role, ASD_Assertion_lType, ASD_Assertion_dimension, ASD_Assertion_maxVal}
...
domain_model = DomainModel(
    name="ASD",
    types={ASD_ServiceDescription, NamedElement, ASD_Operation, ASD_InfoType, ASD_Profile, ASD_Message, ASD_AssertionSet, ASD_InfoTypeImported, InfoType, ASD_Assertion, ASD_NamedElement, ASD_Annotation, EEnumOp, EEnumMes, EEnumSubset, EEnumValueType, EEnumlogicalType, EEnumDimensionType, EEnumIntention},
    associations={service6, infoType7, operation9, operations0, infotypes1, profiles3, contents5, refers20, sets21, service22, infoType12, ref14, message16, service18, owner30, profile24, assertions26, set27, annotations29},
    generalizations={gen_ASD_Message_NamedElement, gen_ASD_ServiceDescription_NamedElement, gen_ASD_Operation_NamedElement, gen_ASD_Profile_NamedElement, gen_ASD_InfoType_NamedElement, gen_ASD_InfoTypeImported_InfoType, gen_ASD_AssertionSet_NamedElement, gen_ASD_Assertion_NamedElement},
    metadata=None
)
