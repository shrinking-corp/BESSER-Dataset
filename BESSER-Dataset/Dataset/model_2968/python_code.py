...
class ASD_Annotation:
    ...
    def __init__(self, key: str, value: str, annotations: "ASD_NamedElement" = None, Annotation: "ASD_NamedElement" = None):
        self.key = key
        self.value = value
...
class ASD_NamedElement(ABC):
    ...
    def __init__(self, name: str, NamedElement: "ASD_Annotation" = None, owner: set["ASD_Annotation"] = None):
        self.name = name
...
class ASD_InfoType(NamedElement):
    ...
    def __init__(self, valueType: str, valueRange: str, subset: str, InfoType8: "ASD_Message" = None, InfoType: "ASD_ServiceDescription" = None, ASD_InfoType: "ASD_InfoType" = None, ASD_InfoType11: set["ASD_InfoType"] = None, ASD_InfoType15: "ASD_InfoType" = None, ASD_InfoType13: "ASD_InfoType" = None, infoType: set["ASD_Message"] = None, infotypes: "ASD_ServiceDescription" = None):
...
class ASD_Operation(NamedElement):
    ...
    def __init__(self, messagePattern: str, operations: "ASD_ServiceDescription" = None, Operation10: "ASD_Message" = None, Operation: "ASD_ServiceDescription" = None, operation: set["ASD_Message"] = None, ASD_Operation: "ASD_Profile" = None):
...
class ASD_Assertion(NamedElement):
    ...
    def __init__(self, dimension: str, dimensionType: str, role: str, minVal: float, maxVal: float, lType: str, subset: str, Assertion: "ASD_AssertionSet" = None, assertions: "ASD_AssertionSet" = None):
...
class ASD_Message(NamedElement):
    ...
    def __init__(self, role: str, subset: str, message: set["ASD_InfoType"] = None, contents: "ASD_Operation" = None, Message: "ASD_Operation" = None, Message17: "ASD_InfoType" = None):
        self.role = role
        self.subset = subset
