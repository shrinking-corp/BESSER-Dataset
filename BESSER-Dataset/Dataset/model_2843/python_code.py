...
class alf_LoopVariableDefinition:
    ...
    def __init__(self, name: str, alf_LoopVariableDefinition228: "alf_QualifiedNameWithBinding" = None, alf_LoopVariableDefinition231: "alf_Expression" = None, alf_LoopVariableDefinition: "alf_ForControl" = None, alf_LoopVariableDefinition222: "alf_Expression" = None, alf_LoopVariableDefinition225: "alf_Expression" = None):
        self.name = name
...
class alf_QualifiedNameWithBinding:
    ...
    def __init__(self, id: str, alf_QualifiedNameWithBinding: "alf_NamedTemplateBinding" = None, alf_QualifiedNameWithBinding23: "alf_TemplateBinding" = None, alf_QualifiedNameWithBinding27: "alf_QualifiedNameWithBinding" = None, alf_QualifiedNameWithBinding25: "alf_QualifiedNameWithBinding" = None, alf_QualifiedNameWithBinding122: "alf_SuperInvocationExpression" = None, alf_QualifiedNameWithBinding124: "alf_InstanceCreationExpression" = None, alf_QualifiedNameWithBinding92: "alf_SequenceOperationExpression" = None, alf_QualifiedNameWithBinding100: "alf_SequenceReductionExpression" = None, alf_QualifiedNameWithBinding229: "alf_LoopVariableDefinition" = None, alf_QualifiedNameWithBinding271: "alf_QualifiedNameList" = None, alf_QualifiedNameWithBinding166: "alf_LocalNameDeclarationStatement" = None):
        self.id = id
...
class alf_NamedTemplateBinding:
    ...
    def __init__(self, formal: str, alf_NamedTemplateBinding21: "alf_QualifiedNameWithBinding" = None, alf_NamedTemplateBinding: "alf_TemplateBinding" = None):
        self.formal = formal
