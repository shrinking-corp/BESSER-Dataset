...
classdiagram_Typeable = Class(name="classdiagram_Typeable", is_abstract=True)
...
domain_model = DomainModel(
    name="classdiagram",
    types={classdiagram_ClassDiagram, classdiagram_Class, classdiagram_Dependency, classdiagram_Association, classdiagram_DataType, classdiagram_Composition, Typeable, classdiagram_Attribute, TypedElement, classdiagram_NamedElement, classdiagram_Typeable, classdiagram_Operation, classdiagram_TypedElement, NamedElement},
    associations={classes0, dependencies1, associations3, datatypes5, compositions7, compositionsAsConstituent29, compositionsAsComposite30, owner32, owner34, parameterTypes36, ownedAttributes9, ownedOperations10, dependenciesAsDependee12, dependenciesAsDepender13, nestedIn16, nested18, superclass21, subclasses24, associationsAsSource26, associationsAsTarget27, constituent47, composite49, dependee37, depender39, type41, source43, target45},
