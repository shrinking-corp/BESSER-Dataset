...
class classdiagram_Dependency:
    ...
    def __init__(self, name: str, Dependency: "classdiagram_Class" = None, Dependency14: "classdiagram_Class" = None, classdiagram_Dependency: "classdiagram_ClassDiagram" = None, dependenciesAsDependee: "classdiagram_Class" = None, dependenciesAsDepender: "classdiagram_Class" = None):
        self.name = name
