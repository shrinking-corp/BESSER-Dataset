...
public class dataflownet_DataflowNet extends Node {
    ...
    public dataflownet_DataflowNet(
        ArrayList<dataflownet_Channel> dataflownet_channels,        ArrayList<dataflownet_Channel> dataflownet_channels,        ArrayList<dataflownet_Node> dataflownet_nodes,        ArrayList<dataflownet_Channel> dataflownet_channels    ) {
