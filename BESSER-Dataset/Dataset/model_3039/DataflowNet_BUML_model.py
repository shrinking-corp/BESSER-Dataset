...
# Classes
dataflownet_Process = Class(name="dataflownet_Process")
dataflownet_StateMachineTransition = Class(name="dataflownet_StateMachineTransition")
dataflownet_NamedElement = Class(name="dataflownet_NamedElement", is_abstract=True)
dataflownet_Node = Class(name="dataflownet_Node", is_abstract=True)
NamedElement = Class(name="NamedElement")
dataflownet_DataflowNet = Class(name="dataflownet_DataflowNet")
dataflownet_StateMachine = Class(name="dataflownet_StateMachine")
Node = Class(name="Node")
dataflownet_StateMachineState = Class(name="dataflownet_StateMachineState")
dataflownet_FiringRule = Class(name="dataflownet_FiringRule")
dataflownet_Channel = Class(name="dataflownet_Channel")
dataflownet_Type = Class(name="dataflownet_Type")
dataflownet_Token = Class(name="dataflownet_Token")
dataflownet_DataflowSystem = Class(name="dataflownet_DataflowSystem")
...
domain_model = DomainModel(
    name="dataflownet",
    types={dataflownet_Process, dataflownet_StateMachineTransition, dataflownet_NamedElement, dataflownet_Node, NamedElement, dataflownet_DataflowNet, dataflownet_StateMachine, Node, dataflownet_StateMachineState, dataflownet_FiringRule, dataflownet_Channel, dataflownet_Type, dataflownet_Token, dataflownet_DataflowSystem, Comparation, Protocol},
    associations={ownChannels11, process14, outputTransitions16, inputTransitions17, parent19, fromState21, toState23, parent0, nodes1, initialState2, firingRules3, outputChannels5, inputChannels6, nodes9, channels45, processes48, inputs25, outputs27, type30, channel32, tokens35, type37, types40, nets42},
    generalizations={gen_dataflownet_StateMachineState_NamedElement, gen_dataflownet_StateMachineTransition_NamedElement, gen_dataflownet_Node_NamedElement, gen_dataflownet_StateMachine_Node, gen_dataflownet_DataflowNet_Node, gen_dataflownet_Process_NamedElement, gen_dataflownet_Channel_NamedElement, gen_dataflownet_FiringRule_NamedElement, gen_dataflownet_DataflowSystem_NamedElement},
    metadata=None
)
