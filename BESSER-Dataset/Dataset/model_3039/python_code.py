...
class dataflownet_DataflowSystem(NamedElement):
    ...
    def __init__(self, protocol: str, dataflownet_DataflowSystem46: set["dataflownet_Channel"] = None, dataflownet_DataflowSystem49: set["dataflownet_Process"] = None, dataflownet_DataflowSystem: set["dataflownet_Type"] = None, dataflownet_DataflowSystem43: set["dataflownet_DataflowNet"] = None):
...
class dataflownet_FiringRule(NamedElement):
    ...
    def __init__(self, compType: str, dataflownet_FiringRule: "dataflownet_StateMachine" = None, dataflownet_FiringRule26: "dataflownet_StateMachineTransition" = None, dataflownet_FiringRule29: "dataflownet_StateMachineTransition" = None, dataflownet_FiringRule33: "dataflownet_Channel" = None, dataflownet_FiringRule36: "dataflownet_Token" = None):
...
class dataflownet_StateMachineTransition(NamedElement):
    ...
    def __init__(self, priority: int, StateMachineTransition: "dataflownet_StateMachineState" = None, StateMachineTransition18: "dataflownet_StateMachineState" = None, outputTransitions: "dataflownet_StateMachineState" = None, inputTransitions: "dataflownet_StateMachineState" = None, dataflownet_StateMachineTransition: set["dataflownet_FiringRule"] = None, dataflownet_StateMachineTransition28: set["dataflownet_FiringRule"] = None):
