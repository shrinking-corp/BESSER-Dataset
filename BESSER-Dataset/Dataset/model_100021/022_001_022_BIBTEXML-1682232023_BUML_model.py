...
BIBTEXML_Article.attributes={BIBTEXML_Article_note, BIBTEXML_Article_volume, BIBTEXML_Article_number, BIBTEXML_Article_pages}
...
BIBTEXML_Manual.attributes={BIBTEXML_Manual_edition, BIBTEXML_Manual_note, BIBTEXML_Manual_organization, BIBTEXML_Manual_address}
...
BIBTEXML_TechReport.attributes={BIBTEXML_TechReport_number, BIBTEXML_TechReport_note, BIBTEXML_TechReport_address, BIBTEXML_TechReport_type}
...
BIBTEXML_Book.attributes={BIBTEXML_Book_edition, BIBTEXML_Book_number, BIBTEXML_Book_volume, BIBTEXML_Book_note, BIBTEXML_Book_series, BIBTEXML_Book_address}
...
BIBTEXML_Proceedings.attributes={BIBTEXML_Proceedings_publisher, BIBTEXML_Proceedings_editor, BIBTEXML_Proceedings_number, BIBTEXML_Proceedings_volume, BIBTEXML_Proceedings_organization, BIBTEXML_Proceedings_note, BIBTEXML_Proceedings_address, BIBTEXML_Proceedings_series}
...
BIBTEXML_ThesisEntry.attributes={BIBTEXML_ThesisEntry_address, BIBTEXML_ThesisEntry_type, BIBTEXML_ThesisEntry_note}
...
BIBTEXML_Misc.attributes={BIBTEXML_Misc_year, BIBTEXML_Misc_howpublished, BIBTEXML_Misc_month, BIBTEXML_Misc_title, BIBTEXML_Misc_note}
...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={BIBTEXML_BibtexFile, Entry, BIBTEXML_Author, BIBTEXML_Entry, BIBTEXML_AuthoredEntry, BIBTEXML_NotedEntry, BIBTEXML_PublisheredEntry, BIBTEXML_SchoolEntry, BIBTEXML_Article, AuthoredEntry, DatedEntry, TitledEntry, JournalEntry, Author, BIBTEXML_BookTitledEntry, BIBTEXML_InstitutionEntry, BIBTEXML_EditoredEntry, BIBTEXML_DatedEntry, BIBTEXML_JournalEntry, BIBTEXML_TitledEntry, BIBTEXML_InCollection, BookTitledEntry, BIBTEXML_Manual, BIBTEXML_TechReport, InstitutionEntry, BIBTEXML_Book, EditoredEntry, PublisheredEntry, BIBTEXML_Booklet, BIBTEXML_InBook, Book, BIBTEXML_Proceedings, BIBTEXML_ThesisEntry, SchoolEntry, BIBTEXML_PhdThesis, ThesisEntry, BIBTEXML_MastersThesis, BIBTEXML_InProceedings, Proceedings, BIBTEXML_Conference, InProceedings, BIBTEXML_Unpublished, NotedEntry, BIBTEXML_Misc},
    associations={entries0, authors1, authors2, authors4},
    generalizations={gen_BIBTEXML_AuthoredEntry_Entry, gen_BIBTEXML_NotedEntry_Entry, gen_BIBTEXML_PublisheredEntry_Entry, gen_BIBTEXML_SchoolEntry_Entry, gen_BIBTEXML_Article_AuthoredEntry, gen_BIBTEXML_Article_DatedEntry, gen_BIBTEXML_Article_TitledEntry, gen_BIBTEXML_Article_JournalEntry, gen_BIBTEXML_BookTitledEntry_Entry, gen_BIBTEXML_InstitutionEntry_Entry, gen_BIBTEXML_EditoredEntry_Entry, gen_BIBTEXML_DatedEntry_Entry, gen_BIBTEXML_JournalEntry_Entry, gen_BIBTEXML_TitledEntry_Entry, gen_BIBTEXML_InCollection_Book, gen_BIBTEXML_InCollection_BookTitledEntry, gen_BIBTEXML_Manual_TitledEntry, gen_BIBTEXML_Manual_AuthoredEntry, gen_BIBTEXML_Manual_DatedEntry, gen_BIBTEXML_TechReport_AuthoredEntry, gen_BIBTEXML_TechReport_InstitutionEntry, gen_BIBTEXML_TechReport_DatedEntry, gen_BIBTEXML_TechReport_TitledEntry, gen_BIBTEXML_Book_AuthoredEntry, gen_BIBTEXML_Book_EditoredEntry, gen_BIBTEXML_Book_PublisheredEntry, gen_BIBTEXML_Book_DatedEntry, gen_BIBTEXML_Book_TitledEntry, gen_BIBTEXML_Booklet_DatedEntry, gen_BIBTEXML_Booklet_TitledEntry, gen_BIBTEXML_InBook_Book, gen_BIBTEXML_Proceedings_DatedEntry, gen_BIBTEXML_Proceedings_TitledEntry, gen_BIBTEXML_ThesisEntry_AuthoredEntry, gen_BIBTEXML_ThesisEntry_DatedEntry, gen_BIBTEXML_ThesisEntry_TitledEntry, gen_BIBTEXML_ThesisEntry_SchoolEntry, gen_BIBTEXML_PhdThesis_ThesisEntry, gen_BIBTEXML_MastersThesis_ThesisEntry, gen_BIBTEXML_InProceedings_AuthoredEntry, gen_BIBTEXML_InProceedings_BookTitledEntry, gen_BIBTEXML_InProceedings_Proceedings, gen_BIBTEXML_Conference_InProceedings, gen_BIBTEXML_Unpublished_AuthoredEntry, gen_BIBTEXML_Unpublished_TitledEntry, gen_BIBTEXML_Unpublished_NotedEntry, gen_BIBTEXML_Unpublished_DatedEntry, gen_BIBTEXML_Misc_Entry},
    metadata=None
)
