...
# Classes
family_Members = Class(name="family_Members")
NamedElement = Class(name="NamedElement")
family_Person = Class(name="family_Person")
family_NamedElement = Class(name="family_NamedElement", is_abstract=True)
...
family_Person.attributes={family_Person_surname, family_Person_gender, family_Person_age}
