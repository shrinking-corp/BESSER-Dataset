...
class SrcAuthoredEntry:
    ...
    pass
class jointPackage_BibTeX2DocBook_SrcArticle(SrcDatedEntry, SrcTitledEntry, SrcAuthoredEntry):
...
class jointPackage_BibTeX2DocBook_SrcBook(SrcDatedEntry, SrcTitledEntry, SrcAuthoredEntry):
...
class SrcProceedings:
    ...
    pass
class jointPackage_BibTeX2DocBook_SrcInProceedings(SrcProceedings, SrcBookTitledEntry, SrcAuthoredEntry):

    pass
class jointPackage_BibTeX2DocBook_SrcProceedings(SrcDatedEntry, SrcTitledEntry):
...
class jointPackage_BibTeX2DocBook_SrcTechReport(SrcDatedEntry, SrcTitledEntry, SrcAuthoredEntry):
...
class jointPackage_BibTeX2DocBook_TrgPara:
    ...
    def paras(self, value):
        ...
        old_value = getattr(self, f"_jointPackage_BibTeX2DocBook_TrgPara__paras", None)
        self.__paras = value
...
class jointPackage_BibTeX2DocBook_SrcBookTitledEntry(SrcBibTeXEntry):
    ...
    def __init__(self, booktitle: str, SrcBibTeXEntry: "jointPackage_BibTeX2DocBook_SrcBibTeXFile" = None):
...
class jointPackage_BibTeX2DocBook_SrcTitledEntry(SrcBibTeXEntry):
    ...
    def __init__(self, title: str, SrcBibTeXEntry: "jointPackage_BibTeX2DocBook_SrcBibTeXFile" = None):
        self.title = title
...
class jointPackage_BibTeX2DocBook_SrcDatedEntry(SrcBibTeXEntry):
    ...
    def __init__(self, year: str, SrcBibTeXEntry: "jointPackage_BibTeX2DocBook_SrcBibTeXFile" = None):
        self.year = year
...
class jointPackage_BibTeX2DocBook_TrgDocBook:
    ...
    pass
class jointPackage_BibTeX2DocBook_SrcThesisEntry(SrcDatedEntry, SrcTitledEntry, SrcAuthoredEntry):
