...
# Classes
jointPackage_BibTeX2DocBook_SrcTechReport = Class(name="jointPackage_BibTeX2DocBook_SrcTechReport")
jointPackage_BibTeX2DocBook_SrcUnpublished = Class(name="jointPackage_BibTeX2DocBook_SrcUnpublished")
jointPackage_BibTeX2DocBook_SrcManual = Class(name="jointPackage_BibTeX2DocBook_SrcManual")
jointPackage_BibTeX2DocBook_SrcProceedings = Class(name="jointPackage_BibTeX2DocBook_SrcProceedings")
jointPackage_BibTeX2DocBook_SrcInProceedings = Class(name="jointPackage_BibTeX2DocBook_SrcInProceedings")
SrcProceedings = Class(name="SrcProceedings")
SrcBookTitledEntry = Class(name="SrcBookTitledEntry")
jointPackage_BibTeX2DocBook_SrcBooklet = Class(name="jointPackage_BibTeX2DocBook_SrcBooklet")
jointPackage_BibTeX2DocBook_SrcBook = Class(name="jointPackage_BibTeX2DocBook_SrcBook")
jointPackage_BibTeX2DocBook_SrcInCollection = Class(name="jointPackage_BibTeX2DocBook_SrcInCollection")
SrcBook = Class(name="SrcBook")
jointPackage_BibTeX2DocBook_SrcInBook = Class(name="jointPackage_BibTeX2DocBook_SrcInBook")
jointPackage_BibTeX2DocBook_SrcPhDThesis = Class(name="jointPackage_BibTeX2DocBook_SrcPhDThesis")
SrcThesisEntry = Class(name="SrcThesisEntry")
jointPackage_BibTeX2DocBook_JointMM = Class(name="jointPackage_BibTeX2DocBook_JointMM")
SrcMasterThesis = Class(name="SrcMasterThesis")
TrgDocBook = Class(name="TrgDocBook")
jointPackage_BibTeX2DocBook_SrcBibTeXFile = Class(name="jointPackage_BibTeX2DocBook_SrcBibTeXFile")
SrcBibTeXEntry = Class(name="SrcBibTeXEntry")
jointPackage_BibTeX2DocBook_SrcArticle = Class(name="jointPackage_BibTeX2DocBook_SrcArticle")
...
jointPackage_BibTeX2DocBook_SrcMisc = Class(name="jointPackage_BibTeX2DocBook_SrcMisc")
jointPackage_BibTeX2DocBook_SrcThesisEntry = Class(name="jointPackage_BibTeX2DocBook_SrcThesisEntry", is_abstract=True)
jointPackage_BibTeX2DocBook_TrgDocBook = Class(name="jointPackage_BibTeX2DocBook_TrgDocBook")
TrgBook = Class(name="TrgBook")
jointPackage_BibTeX2DocBook_TrgBook = Class(name="jointPackage_BibTeX2DocBook_TrgBook")
TrgArticle = Class(name="TrgArticle")
jointPackage_BibTeX2DocBook_TrgTitledElement = Class(name="jointPackage_BibTeX2DocBook_TrgTitledElement", is_abstract=True)
jointPackage_BibTeX2DocBook_TrgArticle = Class(name="jointPackage_BibTeX2DocBook_TrgArticle")
TrgTitledElement = Class(name="TrgTitledElement")
TrgSect1 = Class(name="TrgSect1")
jointPackage_BibTeX2DocBook_TrgSection = Class(name="jointPackage_BibTeX2DocBook_TrgSection", is_abstract=True)
TrgPara = Class(name="TrgPara")
jointPackage_BibTeX2DocBook_TrgSect1 = Class(name="jointPackage_BibTeX2DocBook_TrgSect1")
TrgSection = Class(name="TrgSection")
TrgSect2 = Class(name="TrgSect2")
jointPackage_BibTeX2DocBook_SrcMasterThesis = Class(name="jointPackage_BibTeX2DocBook_SrcMasterThesis")
jointPackage_BibTeX2DocBook_SrcAuthor = Class(name="jointPackage_BibTeX2DocBook_SrcAuthor")
jointPackage_BibTeX2DocBook_SrcBibTeXEntry = Class(name="jointPackage_BibTeX2DocBook_SrcBibTeXEntry", is_abstract=True)
jointPackage_BibTeX2DocBook_SrcAuthoredEntry = Class(name="jointPackage_BibTeX2DocBook_SrcAuthoredEntry", is_abstract=True)
SrcAuthor = Class(name="SrcAuthor")
jointPackage_BibTeX2DocBook_SrcDatedEntry = Class(name="jointPackage_BibTeX2DocBook_SrcDatedEntry", is_abstract=True)
jointPackage_BibTeX2DocBook_SrcTitledEntry = Class(name="jointPackage_BibTeX2DocBook_SrcTitledEntry", is_abstract=True)
jointPackage_BibTeX2DocBook_SrcBookTitledEntry = Class(name="jointPackage_BibTeX2DocBook_SrcBookTitledEntry", is_abstract=True)
jointPackage_BibTeX2DocBook_TrgSect2 = Class(name="jointPackage_BibTeX2DocBook_TrgSect2")
jointPackage_BibTeX2DocBook_TrgPara = Class(name="jointPackage_BibTeX2DocBook_TrgPara")
...
paras8: BinaryAssociation = BinaryAssociation(
    name="paras8",
    ends={
        Property(name="TrgPara", type=jointPackage_BibTeX2DocBook_TrgSection, multiplicity=Multiplicity(1, 1)),
        Property(name="section", type=TrgPara, multiplicity=Multiplicity(1, 9999), is_composite=True)
    }
)
...
section10: BinaryAssociation = BinaryAssociation(
    name="section10",
    ends={
        Property(name="TrgSection", type=jointPackage_BibTeX2DocBook_TrgPara, multiplicity=Multiplicity(1, 1)),
        Property(name="paras", type=TrgSection, multiplicity=Multiplicity(1, 1))
    }
)
...
domain_model = DomainModel(
    ...
    types={jointPackage_BibTeX2DocBook_SrcTechReport, jointPackage_BibTeX2DocBook_SrcUnpublished, jointPackage_BibTeX2DocBook_SrcManual, jointPackage_BibTeX2DocBook_SrcProceedings, jointPackage_BibTeX2DocBook_SrcInProceedings, SrcProceedings, SrcBookTitledEntry, jointPackage_BibTeX2DocBook_SrcBooklet, jointPackage_BibTeX2DocBook_SrcBook, jointPackage_BibTeX2DocBook_SrcInCollection, SrcBook, jointPackage_BibTeX2DocBook_SrcInBook, jointPackage_BibTeX2DocBook_SrcPhDThesis, SrcThesisEntry, jointPackage_BibTeX2DocBook_JointMM, SrcMasterThesis, TrgDocBook, jointPackage_BibTeX2DocBook_SrcBibTeXFile, SrcBibTeXEntry, jointPackage_BibTeX2DocBook_SrcArticle, SrcAuthoredEntry, SrcDatedEntry, SrcTitledEntry, jointPackage_BibTeX2DocBook_SrcMisc, jointPackage_BibTeX2DocBook_SrcThesisEntry, jointPackage_BibTeX2DocBook_TrgDocBook, TrgBook, jointPackage_BibTeX2DocBook_TrgBook, TrgArticle, jointPackage_BibTeX2DocBook_TrgTitledElement, jointPackage_BibTeX2DocBook_TrgArticle, TrgTitledElement, TrgSect1, jointPackage_BibTeX2DocBook_TrgSection, TrgPara, jointPackage_BibTeX2DocBook_TrgSect1, TrgSection, TrgSect2, jointPackage_BibTeX2DocBook_SrcMasterThesis, jointPackage_BibTeX2DocBook_SrcAuthor, jointPackage_BibTeX2DocBook_SrcBibTeXEntry, jointPackage_BibTeX2DocBook_SrcAuthoredEntry, SrcAuthor, jointPackage_BibTeX2DocBook_SrcDatedEntry, jointPackage_BibTeX2DocBook_SrcTitledEntry, jointPackage_BibTeX2DocBook_SrcBookTitledEntry, jointPackage_BibTeX2DocBook_TrgSect2, jointPackage_BibTeX2DocBook_TrgPara},
    associations={sourceRoot0, targetRoot1, entries3, books5, articles6, sections_17, paras8, sections_29, authors4, section10},
    generalizations={gen_jointPackage_BibTeX2DocBook_SrcTechReport_SrcAuthoredEntry, gen_jointPackage_BibTeX2DocBook_SrcTechReport_SrcDatedEntry, gen_jointPackage_BibTeX2DocBook_SrcTechReport_SrcTitledEntry, gen_jointPackage_BibTeX2DocBook_SrcUnpublished_SrcAuthoredEntry, gen_jointPackage_BibTeX2DocBook_SrcUnpublished_SrcTitledEntry, gen_jointPackage_BibTeX2DocBook_SrcManual_SrcTitledEntry, gen_jointPackage_BibTeX2DocBook_SrcProceedings_SrcDatedEntry, gen_jointPackage_BibTeX2DocBook_SrcProceedings_SrcTitledEntry, gen_jointPackage_BibTeX2DocBook_SrcInProceedings_SrcProceedings, gen_jointPackage_BibTeX2DocBook_SrcInProceedings_SrcAuthoredEntry, gen_jointPackage_BibTeX2DocBook_SrcInProceedings_SrcBookTitledEntry, gen_jointPackage_BibTeX2DocBook_SrcBooklet_SrcDatedEntry, gen_jointPackage_BibTeX2DocBook_SrcBook_SrcAuthoredEntry, gen_jointPackage_BibTeX2DocBook_SrcBook_SrcDatedEntry, gen_jointPackage_BibTeX2DocBook_SrcBook_SrcTitledEntry, gen_jointPackage_BibTeX2DocBook_SrcInCollection_SrcBook, gen_jointPackage_BibTeX2DocBook_SrcInCollection_SrcBookTitledEntry, gen_jointPackage_BibTeX2DocBook_SrcInBook_SrcBook, gen_jointPackage_BibTeX2DocBook_SrcPhDThesis_SrcThesisEntry, gen_jointPackage_BibTeX2DocBook_SrcArticle_SrcAuthoredEntry, gen_jointPackage_BibTeX2DocBook_SrcArticle_SrcDatedEntry, gen_jointPackage_BibTeX2DocBook_SrcArticle_SrcTitledEntry, gen_jointPackage_BibTeX2DocBook_SrcMisc_SrcBibTeXEntry, gen_jointPackage_BibTeX2DocBook_SrcThesisEntry_SrcAuthoredEntry, gen_jointPackage_BibTeX2DocBook_SrcThesisEntry_SrcDatedEntry, gen_jointPackage_BibTeX2DocBook_SrcThesisEntry_SrcTitledEntry, gen_jointPackage_BibTeX2DocBook_TrgArticle_TrgTitledElement, gen_jointPackage_BibTeX2DocBook_TrgSection_TrgTitledElement, gen_jointPackage_BibTeX2DocBook_TrgSect1_TrgSection, gen_jointPackage_BibTeX2DocBook_SrcMasterThesis_SrcThesisEntry, gen_jointPackage_BibTeX2DocBook_SrcAuthoredEntry_SrcBibTeXEntry, gen_jointPackage_BibTeX2DocBook_SrcDatedEntry_SrcBibTeXEntry, gen_jointPackage_BibTeX2DocBook_SrcTitledEntry_SrcBibTeXEntry, gen_jointPackage_BibTeX2DocBook_SrcBookTitledEntry_SrcBibTeXEntry, gen_jointPackage_BibTeX2DocBook_TrgSect2_TrgSection},
    metadata=None
)
