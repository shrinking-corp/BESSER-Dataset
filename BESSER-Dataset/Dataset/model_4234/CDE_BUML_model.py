...
# Classes
cde_Employee = Class(name="cde_Employee")
cde_Company = Class(name="cde_Company")
cde_Department = Class(name="cde_Department")
...
domain_model = DomainModel(
    name="cde",
    types={cde_Employee, cde_Company, cde_Department},
    associations={works1, belongs0},
    generalizations={},
    metadata=None
)
