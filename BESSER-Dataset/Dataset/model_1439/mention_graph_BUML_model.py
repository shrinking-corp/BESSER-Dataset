...
# Classes
mention_graph_User = Class(name="mention_graph_User")
Node = Class(name="Node")
mention_graph_HashTag = Class(name="mention_graph_HashTag")
mention_graph_MentionGraph = Class(name="mention_graph_MentionGraph")
mention_graph_Node = Class(name="mention_graph_Node", is_abstract=True)
mention_graph_Edge = Class(name="mention_graph_Edge")
...
domain_model = DomainModel(
    name="mention_graph",
    types={mention_graph_User, Node, mention_graph_HashTag, mention_graph_MentionGraph, mention_graph_Node, mention_graph_Edge},
    associations={relatedHashtags3, nodes0, edges1, source4, target7},
