...
class activitydiagram_IntegerComparisonExpression(BooleanExpression):
    ...
    def __init__(self, operator: str, activitydiagram_IntegerComparisonExpression: "activitydiagram_IntegerExpression" = None, activitydiagram_IntegerComparisonExpression58: "activitydiagram_IntegerExpression" = None):
        self.operator = operator
...
class activitydiagram_ActivityNode(NamedElement):
    ...
    def __init__(self, running: bool, ActivityNode: "activitydiagram_Activity" = None, activitydiagram_ActivityNode: "activitydiagram_ActivityEdge" = None, activitydiagram_ActivityNode10: "activitydiagram_ActivityEdge" = None, nodes: "activitydiagram_Activity" = None):
