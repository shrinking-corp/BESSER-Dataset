...
class cmof_EnumerationLiteral(InstanceSpecification):
    ...
    def classifier_equals_owning_enumeration(self, cmof_diagnostics, cmof_context) :
...
class cmof_ElementImport(DirectedRelationship):
    ...
    def visibility_public_or_private(self, cmof_context, cmof_diagnostics) :
...
class cmof_Constraint(PackageableElement):
    ...
    def __init__(self, Constraint: "cmof_Namespace" = None, cmof_Constraint89: "cmof_ValueSpecification" = None, cmof_Constraint: set["cmof_Element"] = None, ownedRule: "cmof_Namespace" = None, cmof_Constraint107: "cmof_Operation" = None, cmof_Constraint112: "cmof_Operation" = None, cmof_Constraint115: "cmof_Operation" = None):
    ...
    def not_apply_to_self(self, cmof_diagnostics, cmof_context) :
        # TODO: Implement not_apply_to_self method
        pass

    def boolean_value(self, cmof_diagnostics, cmof_context) :
...
class cmof_InstanceSpecification(PackageableElement):
    ...
    def defining_feature(self, cmof_context, cmof_diagnostics) :
        # TODO: Implement defining_feature method
        pass

    def structural_feature(self, cmof_context, cmof_diagnostics) :
        # TODO: Implement structural_feature method
        pass

class cmof_Type(PackageableElement):

    def __init__(self, ownedType_one: "cmof_Package" = None, Type: "cmof_Package" = None, cmof_Type146: "cmof_Association" = None, cmof_Type: "cmof_TypedElement" = None, cmof_Type121: "cmof_Operation" = None, cmof_Type128: "cmof_BehavioralFeature" = None):
...
class cmof_Package(PackageableElement, Namespace):
    ...
    def elements_public_or_private(self, cmof_diagnostics, cmof_context) :
        # TODO: Implement elements_public_or_private method
        pass

class cmof_Operation(BehavioralFeature):

    def __init__(self, isOrdered: str, isQuery: str, isUnique: str, lower: str, upper: str, Operation: "cmof_Class" = None, cmof_Operation134: "cmof_Parameter" = None, Operation144: "cmof_DataType" = None, cmof_Operation: "cmof_Constraint" = None, ownedOperation: "cmof_DataType" = None, cmof_Operation111: set["cmof_Constraint"] = None, cmof_Operation114: set["cmof_Constraint"] = None, cmof_Operation118: "cmof_Operation" = None, cmof_Operation116: set["cmof_Operation"] = None, cmof_Operation120: "cmof_Type" = None, ownedOperation123: "cmof_Class" = None):
...
class cmof_Tag(Element):
    ...
    def __init__(self, name: str, value: str, cmof_Tag190: "cmof_Element" = None, cmof_Tag: set["cmof_Element"] = None):
        self.name = name
        self.value = value
...
class cmof_Factory(Element):
    ...
    def createLink(self, cmof_secondElement, cmof_firstElement, cmof_association) :
    ...
    def createFromString(self, cmof_string, cmof_dataType) :
        # TODO: Implement createFromString method
        pass

class cmof_MultiplicityElement(Element):

    def __init__(self, lower: str, isOrdered: str, isUnique: str, upper: str, cmof_MultiplicityElement: "cmof_ValueSpecification" = None, cmof_MultiplicityElement138: "cmof_ValueSpecification" = None):
        self.lower = lower
        self.isOrdered = isOrdered
        self.isUnique = isUnique
        self.upper = upper
...
class cmof_NamedElement(Element):
    ...
    def __init__(self, name: str, qualifiedName: str, visibility: str, cmof_NamedElement: "cmof_Classifier" = None, cmof_NamedElement70: "cmof_Namespace" = None, NamedElement: "cmof_Namespace" = None, ownedMember: "cmof_Namespace" = None):
        self.name = name
    ...
    def has_qualified_name(self, cmof_diagnostics, cmof_context) :
...
class cmof_Namespace(NamedElement):
    ...
    def __init__(self, importingNamespace74: set["cmof_PackageImport"] = None, importingNamespace: set["cmof_ElementImport"] = None, cmof_Namespace: set["cmof_PackageableElement"] = None, cmof_Namespace69: set["cmof_NamedElement"] = None, namespace: set["cmof_NamedElement"] = None, Namespace: "cmof_NamedElement" = None, context: set["cmof_Constraint"] = None, Namespace78: "cmof_ElementImport" = None, Namespace92: "cmof_Constraint" = None, Namespace97: "cmof_PackageImport" = None):
    ...
    def members_distinguishable(self, cmof_context, cmof_diagnostics) :
...
class cmof_RedefinableElement(NamedElement):
    ...
    def redefinition_context_valid(self, cmof_context, cmof_diagnostics) :
        # TODO: Implement redefinition_context_valid method
        pass

    def redefinition_consistent(self, cmof_context, cmof_diagnostics) :
...
class RedefinableElement:
    ...
    pass
class cmof_Classifier(Namespace, RedefinableElement, Type):

    def __init__(self, isAbstract: str, isFinalSpecialization: str, featuringClassifier: set["cmof_Feature"] = None, cmof_Classifier48: "cmof_Classifier" = None, cmof_Classifier46: set["cmof_Classifier"] = None, specific: set["cmof_Generalization"] = None, cmof_Classifier51: set["cmof_NamedElement"] = None, cmof_Classifier54: "cmof_Classifier" = None, cmof_Classifier52: set["cmof_Classifier"] = None, Classifier: "cmof_Feature" = None, cmof_Classifier: "cmof_RedefinableElement" = None, cmof_Classifier35: "cmof_Class" = None, cmof_Classifier43: set["cmof_Property"] = None, cmof_Classifier158: "cmof_InstanceSpecification" = None, cmof_Classifier103: "cmof_Generalization" = None, Classifier105: "cmof_Generalization" = None):
    ...
    def specialize_type(self, cmof_diagnostics, cmof_context) :
        # TODO: Implement specialize_type method
        pass

    def no_cycles_in_generalization(self, cmof_diagnostics, cmof_context) :
...
class cmof_Feature(RedefinableElement):
    ...
    def __init__(self, isStatic: str, Feature: "cmof_Classifier" = None, feature: set["cmof_Classifier"] = None):
...
class cmof_BehavioralFeature(Namespace, Feature):
    ...
    pass
class cmof_StructuralFeature(MultiplicityElement, TypedElement, Feature):
...
class cmof_ValueSpecification(PackageableElement, TypedElement):
    ...
    def __init__(self, cmof_ValueSpecification: "cmof_Property" = None, cmof_ValueSpecification131: "cmof_Parameter" = None, cmof_ValueSpecification136: "cmof_MultiplicityElement" = None, cmof_ValueSpecification139: "cmof_MultiplicityElement" = None, cmof_ValueSpecification90: "cmof_Constraint" = None, cmof_ValueSpecification162: "cmof_InstanceSpecification" = None, cmof_ValueSpecification166: "cmof_Slot" = None, cmof_ValueSpecification169: "cmof_Expression" = None):
...
class cmof_Association(Classifier, Relationship):
    ...
    def binary_associations(self, cmof_diagnostics, cmof_context) :
        # TODO: Implement binary_associations method
        pass

    def association_ends(self, cmof_context, cmof_diagnostics) :
        # TODO: Implement association_ends method
        pass

    def specialized_end_types(self, cmof_diagnostics, cmof_context) :
...
class cmof_Class(Classifier):
    ...
    def __init__(self, Class: "cmof_Property" = None, cmof_Class: "cmof_Element" = None, cmof_Class34: set["cmof_Classifier"] = None, class_: set["cmof_Property"] = None, class_38: set["cmof_Operation"] = None, cmof_Class41: "cmof_Class" = None, cmof_Class39: set["cmof_Class"] = None, Class124: "cmof_Operation" = None):
        self.Class = Class
...
class cmof_Property(StructuralFeature):
    ...
    def __init__(self, aggregation: str, default: str, isComposite: str, isDerived: str, isDerivedUnion: str, isID: str, cmof_Property9: "cmof_Property" = None, cmof_Property7: "cmof_Property" = None, ownedAttribute: "cmof_Class" = None, ownedAttribute2: "cmof_DataType" = None, memberEnd: "cmof_Association" = None, ownedEnd: "cmof_Association" = None, cmof_Property: "cmof_ValueSpecification" = None, cmof_Property12: "cmof_Property" = None, cmof_Property10: set["cmof_Property"] = None, cmof_Property15: "cmof_Property" = None, cmof_Property13: set["cmof_Property"] = None, Property: "cmof_Class" = None, cmof_Property44: "cmof_Classifier" = None, Property141: "cmof_DataType" = None, cmof_Property149: "cmof_Association" = None, Property151: "cmof_Association" = None, Property153: "cmof_Association" = None):
    ...
    def subsetting_rules(self, cmof_context, cmof_diagnostics) :
    ...
    def subsetting_context_conforms(self, cmof_context, cmof_diagnostics) :
    ...
    def redefined_property_inherited(self, cmof_diagnostics, cmof_context) :
        # TODO: Implement redefined_property_inherited method
        pass

    def derived_union_is_read_only(self, cmof_diagnostics, cmof_context) :
        # TODO: Implement derived_union_is_read_only method
        pass

    def derived_union_is_derived(self, cmof_diagnostics, cmof_context) :
...
class cmof_Object:
    ...
    def set(self, cmof_property, cmof_value):
        # TODO: Implement set method
        pass

    def invoke(self, cmof_op, cmof_arguments) :
...
class cmof_Element(Object):
    ...
    def __init__(self, cmof_Element29: "cmof_Class" = None, cmof_Element: set["cmof_Comment"] = None, Element: "cmof_Element" = None, owner: set["cmof_Element"] = None, Element27: "cmof_Element" = None, ownedElement: "cmof_Element" = None, cmof_Element32: "cmof_Comment" = None, cmof_Element83: "cmof_DirectedRelationship" = None, cmof_Element80: "cmof_DirectedRelationship" = None, cmof_Element85: "cmof_Relationship" = None, cmof_Element87: "cmof_Constraint" = None, cmof_Element191: "cmof_Tag" = None, cmof_Element173: "cmof_Link" = None, cmof_Element176: "cmof_Link" = None, cmof_Element183: "cmof_Exception" = None, cmof_Element186: "cmof_Exception" = None, cmof_Element188: "cmof_Tag" = None):
    ...
    def has_owner(self, cmof_diagnostics, cmof_context) :
    ...
    def isInstanceOfType(self, cmof_type, cmof_includesSubtypes) :
...
class cmof_Extent(Object):
    ...
    def linkExists(self, cmof_secondElement, cmof_association, cmof_firstElement) :
...
class cmof_ReflectiveSequence(ReflectiveCollection):
    ...
    def add(self, cmof_object, cmof_index):
        # TODO: Implement add method
        pass
