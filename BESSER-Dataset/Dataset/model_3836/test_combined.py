...
def test_hyp_database_db_is_not_abstract():
    assert not inspect.isabstract(Database_DB)


def test_hyp_database_db_constructor_exists():
    assert callable(Database_DB.__init__)


def test_hyp_database_db_constructor_args():
...
def test_hyp_database_table_heading_setter(instance):
...
def test_hyp_database_db_title_setter(instance):
