...
# Classes
trace_GenNodeLabelTrace = Class(name="trace_GenNodeLabelTrace")
trace_TraceModel = Class(name="trace_TraceModel")
trace_GenNodeTrace = Class(name="trace_GenNodeTrace")
trace_GenChildNodeTrace = Class(name="trace_GenChildNodeTrace")
trace_GenLinkTrace = Class(name="trace_GenLinkTrace")
trace_ToolGroupTrace = Class(name="trace_ToolGroupTrace")
trace_AbstractTrace = Class(name="trace_AbstractTrace", is_abstract=True)
trace_MatchingTrace = Class(name="trace_MatchingTrace", is_abstract=True)
AbstractTrace = Class(name="AbstractTrace")
MatchingTrace = Class(name="MatchingTrace")
trace_GenCompartmentTrace = Class(name="trace_GenCompartmentTrace")
GenNodeTrace = Class(name="GenNodeTrace")
trace_GenLinkLabelTrace = Class(name="trace_GenLinkLabelTrace")

# trace_GenNodeLabelTrace class attributes and methods
trace_GenNodeLabelTrace_m_setContext: Method = Method(name="setContext", parameters={Parameter(name='trace_genNodeLabel', type=StringType)})
trace_GenNodeLabelTrace.methods={trace_GenNodeLabelTrace_m_setContext}

# trace_TraceModel class attributes and methods
trace_TraceModel_m_getNodeTrace: Method = Method(name="getNodeTrace", parameters={Parameter(name='trace_visualID', type=StringType)}, type=StringType)
trace_TraceModel_m_getLinkTrace: Method = Method(name="getLinkTrace", parameters={Parameter(name='trace_visualID', type=StringType)}, type=StringType)
...
trace_TraceModel.methods={trace_TraceModel_m_getNodeTrace, trace_TraceModel_m_getLinkTrace, trace_TraceModel_m_getAllAbstractTraces, trace_TraceModel_m_purgeUnprocessedTraces}

# trace_GenNodeTrace class attributes and methods
trace_GenNodeTrace_m_setContext: Method = Method(name="setContext", parameters={Parameter(name='trace_genNode', type=StringType)})
...
trace_GenLinkTrace_m_setContext: Method = Method(name="setContext", parameters={Parameter(name='trace_genLink', type=StringType)})
trace_GenLinkTrace.methods={trace_GenLinkTrace_m_setContext}

# trace_ToolGroupTrace class attributes and methods
trace_ToolGroupTrace_m_setContext: Method = Method(name="setContext", parameters={Parameter(name='trace_toolGroup', type=StringType)})
...
trace_AbstractTrace.attributes={trace_AbstractTrace_visualID, trace_AbstractTrace_processed}
...
trace_MatchingTrace_m_getEClassComparision: Method = Method(name="getEClassComparision", parameters={Parameter(name='trace_varName', type=StringType), Parameter(name='trace_eClass', type=StringType)}, type=StringType)
trace_MatchingTrace_m_getEStructuralFeatureComparison: Method = Method(name="getEStructuralFeatureComparison", parameters={Parameter(name='trace_feature', type=StringType), Parameter(name='trace_varName', type=StringType)}, type=StringType)
trace_MatchingTrace.attributes={trace_MatchingTrace_queryText}
trace_MatchingTrace.methods={trace_MatchingTrace_m_getEClassComparision, trace_MatchingTrace_m_getEStructuralFeatureComparison, trace_MatchingTrace_m_getQueryContext}
...
trace_GenCompartmentTrace_m_setContext: Method = Method(name="setContext", parameters={Parameter(name='trace_genCompartment', type=StringType)})
...
trace_GenLinkLabelTrace_m_setContext: Method = Method(name="setContext", parameters={Parameter(name='trace_genLinkLabel', type=StringType)})
...
domain_model = DomainModel(
    name="trace",
    types={trace_GenNodeLabelTrace, trace_TraceModel, trace_GenNodeTrace, trace_GenChildNodeTrace, trace_GenLinkTrace, trace_ToolGroupTrace, trace_AbstractTrace, trace_MatchingTrace, AbstractTrace, MatchingTrace, trace_GenCompartmentTrace, GenNodeTrace, trace_GenLinkLabelTrace},
