...
class trace_GenLinkLabelTrace(MatchingTrace):
    ...
    def setContext(self, trace_genLinkLabel):
...
class trace_GenCompartmentTrace(MatchingTrace):
    ...
    def setContext(self, trace_genCompartment):
        # TODO: Implement setContext method
        pass
...
class trace_MatchingTrace(AbstractTrace):
    ...
    def getEClassComparision(self, trace_eClass, trace_varName) :
        # TODO: Implement getEClassComparision method
        pass

    def getQueryContext(self) :
        # TODO: Implement getQueryContext method
        pass

    def getEStructuralFeatureComparison(self, trace_feature, trace_varName) :
...
class trace_ToolGroupTrace(MatchingTrace):
    ...
    def setContext(self, trace_toolGroup):
        # TODO: Implement setContext method
        pass
...
class trace_GenLinkTrace(MatchingTrace):
    ...
    def setContext(self, trace_genLink):
        # TODO: Implement setContext method
        pass
...
class trace_GenNodeTrace(MatchingTrace):
    ...
    def setContext(self, trace_genNode):
        # TODO: Implement setContext method
        pass
...
class trace_TraceModel:
    ...
    def getLinkTrace(self, trace_visualID) :
    ...
    def getNodeTrace(self, trace_visualID) :
        # TODO: Implement getNodeTrace method
        pass

    def getAllAbstractTraces(self) :
...
class trace_GenNodeLabelTrace(MatchingTrace):
    ...
    def setContext(self, trace_genNodeLabel):
        # TODO: Implement setContext method
        pass
