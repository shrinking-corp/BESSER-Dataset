...
uppaal_CommittedType = Class(name="uppaal_CommittedType")
...
uppaal_UrgentType = Class(name="uppaal_UrgentType")
...
uppaal_LabelType.attributes={uppaal_LabelType_kind, uppaal_LabelType_y, uppaal_LabelType_mixed, uppaal_LabelType_x}
...
uppaal_DocumentRoot.attributes={uppaal_DocumentRoot_system, uppaal_DocumentRoot_imports, uppaal_DocumentRoot_declaration, uppaal_DocumentRoot_instantiation, uppaal_DocumentRoot_mixed}
...
uppaal_NailType.attributes={uppaal_NailType_x, uppaal_NailType_y}
...
uppaal_NameType.attributes={uppaal_NameType_mixed, uppaal_NameType_x, uppaal_NameType_y}
...
uppaal_NtaType.attributes={uppaal_NtaType_instantiation, uppaal_NtaType_imports, uppaal_NtaType_system, uppaal_NtaType_declaration}
...
uppaal_ParameterType.attributes={uppaal_ParameterType_mixed, uppaal_ParameterType_y, uppaal_ParameterType_x}
...
domain_model = DomainModel(
    name="uppaal",
    types={uppaal_EStringToStringMapEntry, uppaal_InitType, uppaal_LabelType, uppaal_CommittedType, uppaal_DocumentRoot, uppaal_NailType, uppaal_NameType, uppaal_NtaType, uppaal_ParameterType, uppaal_SourceType, uppaal_TargetType, uppaal_LocationType, uppaal_TemplateType, uppaal_TransitionType, uppaal_UrgentType},
    associations={xMLNSPrefixMap0, xSISchemaLocation1, committed4, init6, nail12, name14, nta16, parameter18, source20, target22, label8, location10, name30, label33, template24, transition26, urgent28, urgent36, committed39, template42, location51, init54, transition57, source60, target63, label66, name45, parameter48, nail69},
    generalizations={},
    metadata=None
)
