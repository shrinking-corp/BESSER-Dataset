...
Trace_TraceLink.attributes={Trace_TraceLink_sourceType, Trace_TraceLink_description, Trace_TraceLink_targetName, Trace_TraceLink_targetType, Trace_TraceLink_sourceName}
...
domain_model = DomainModel(
    name="Trace",
    types={Trace_TraceLink, Trace_Trace},
    associations={links0},
    generalizations={},
    metadata=None
)
