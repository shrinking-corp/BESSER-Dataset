...
def test_hyp_trace_trace_description_setter(instance):
...
def test_hyp_trace_tracelink_description_setter(instance):
    original = instance.description
    instance.description = original
    assert instance.description == original
...
@given(instance=Trace_TraceLink_strategy)
def test_hyp_trace_tracelink_sourceName_setter(instance):
...
@given(instance=Trace_TraceLink_strategy)
def test_hyp_trace_tracelink_targetName_setter(instance):
...
@given(instance=Trace_TraceLink_strategy)
def test_hyp_trace_tracelink_sourceType_setter(instance):
...
@given(instance=Trace_TraceLink_strategy)
def test_hyp_trace_tracelink_targetType_setter(instance):
