...
# Classes
CLASS_NamedElement = Class(name="CLASS_NamedElement")
CLASS_System = Class(name="CLASS_System")
CLASS_Classifier = Class(name="CLASS_Classifier")
...
domain_model = DomainModel(
    ...
    associations={system0, super2, attributes3, type4, elements6, owner5},
