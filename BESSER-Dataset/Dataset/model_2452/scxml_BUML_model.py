...
# Classes
scxml_StateChart = Class(name="scxml_StateChart")
...
scxml_Node = Class(name="scxml_Node")
scxml_OnEntry = Class(name="scxml_OnEntry")
scxml_OnExit = Class(name="scxml_OnExit")
scxml_TransitionSource = Class(name="scxml_TransitionSource", is_abstract=True)
Node = Class(name="Node")
scxml_CondEventTransition = Class(name="scxml_CondEventTransition")
scxml_TransitionTarget = Class(name="scxml_TransitionTarget", is_abstract=True)
scxml_AbstractState = Class(name="scxml_AbstractState", is_abstract=True)
scxml_SimpleState = Class(name="scxml_SimpleState")
scxml_ParallelState = Class(name="scxml_ParallelState")
...
scxml_EObject = Class(name="scxml_EObject")
scxml_If = Class(name="scxml_If")
scxml_Log = Class(name="scxml_Log")
scxml_Raise = Class(name="scxml_Raise")
State = Class(name="State")
scxml_AbstractSimpleState = Class(name="scxml_AbstractSimpleState", is_abstract=True)
scxml_Invoke = Class(name="scxml_Invoke")
InitialState = Class(name="InitialState")
scxml_ExecutableContent = Class(name="scxml_ExecutableContent")
...
scxml_Conditional = Class(name="scxml_Conditional")
Conditional = Class(name="Conditional")
scxml_ElseIf = Class(name="scxml_ElseIf")
scxml_Else = Class(name="scxml_Else")
scxml_XObject = Class(name="scxml_XObject")
scxml_Data = Class(name="scxml_Data")
scxml_XData = Class(name="scxml_XData")
Data = Class(name="Data")
scxml_IAdaptable = Class(name="scxml_IAdaptable", is_abstract=True)
scxml_EClass = Class(name="scxml_EClass")
scxml_Datamodel = Class(name="scxml_Datamodel")
scxml_DatamodelContainer = Class(name="scxml_DatamodelContainer", is_abstract=True)
IAdaptable = Class(name="IAdaptable")
scxml_DescriptionContainer = Class(name="scxml_DescriptionContainer", is_abstract=True)
scxml_Description = Class(name="scxml_Description")
...
scxml_StateChart.attributes={scxml_StateChart_xmlns, scxml_StateChart_version, scxml_StateChart_exmode, scxml_StateChart_id, scxml_StateChart_profile}
...
scxml_CondEventTransition.attributes={scxml_CondEventTransition_event, scxml_CondEventTransition_cond}
...
scxml_Log.attributes={scxml_Log_expr, scxml_Log_label, scxml_Log_level}
...
scxml_Invoke.attributes={scxml_Invoke_type, scxml_Invoke_srcexpr, scxml_Invoke_typeexpr, scxml_Invoke_src, scxml_Invoke_namelist, scxml_Invoke_idlocation, scxml_Invoke_autoforward, scxml_Invoke_id}
...
scxml_Send.attributes={scxml_Send_target, scxml_Send_type, scxml_Send_eventexpr, scxml_Send_typeexpr, scxml_Send_event, scxml_Send_hints, scxml_Send_hintsexpr, scxml_Send_id, scxml_Send_delay, scxml_Send_delayexpr, scxml_Send_namelist, scxml_Send_targetexpr, scxml_Send_idlocation}
...
scxml_Assign.attributes={scxml_Assign_location, scxml_Assign_expr, scxml_Assign_name}
...
scxml_XObject.attributes={scxml_XObject_classifierName, scxml_XObject_exchange, scxml_XObject_nsUri}
...
scxml_DatamodelContainer_m_getAdapter: Method = Method(name="getAdapter", parameters={Parameter(name='scxml_adapter', type=StringType)}, type=StringType)
...
scxml_DescriptionContainer_m_getAdapter: Method = Method(name="getAdapter", parameters={Parameter(name='scxml_adapter', type=StringType)}, type=StringType)
...
if_27: BinaryAssociation = BinaryAssociation(
    name="if_27",
    ends={
...
raise_30: BinaryAssociation = BinaryAssociation(
    name="raise_30",
    ends={
...
else_45: BinaryAssociation = BinaryAssociation(
    name="else_45",
    ends={
...
domain_model = DomainModel(
    name="scxml",
    types={scxml_StateChart, AbstractState, AbstractSimpleState, DatamodelContainer, DescriptionContainer, scxml_Script, scxml_State, TransitionTarget, TransitionSource, scxml_HistoryState, scxml_Transition, ExecutableContent, scxml_Node, scxml_OnEntry, scxml_OnExit, scxml_TransitionSource, Node, scxml_CondEventTransition, scxml_TransitionTarget, scxml_AbstractState, scxml_SimpleState, scxml_ParallelState, scxml_Content, scxml_FinalState, Transition, scxml_InitialState, scxml_Param, scxml_Donedata, scxml_EObject, scxml_If, scxml_Log, scxml_Raise, State, scxml_AbstractSimpleState, scxml_Invoke, InitialState, scxml_ExecutableContent, Donedata, scxml_Send, scxml_Cancel, scxml_Assign, scxml_Validate, scxml_Conditional, Conditional, scxml_ElseIf, scxml_Else, scxml_XObject, scxml_Data, scxml_XData, Data, scxml_IAdaptable, scxml_EClass, scxml_Datamodel, scxml_DatamodelContainer, IAdaptable, scxml_DescriptionContainer, scxml_Description, HistoryTypeDatatype, ExmodeDatatype, AdapterToken},
    associations={script0, history8, target9, onentry1, onexit2, transition4, state5, parallel6, content13, donedata15, transition10, param12, if_27, log28, raise_30, initial117, initial19, final22, invoke25, send32, cancel34, assign36, validate38, script40, elseif43, else_45, object50, finalize47, type52, data53, datamodel54, description56},
    generalizations={gen_scxml_StateChart_AbstractState, gen_scxml_StateChart_AbstractSimpleState, gen_scxml_StateChart_DatamodelContainer, gen_scxml_StateChart_DescriptionContainer, gen_scxml_State_TransitionTarget, gen_scxml_State_AbstractState, gen_scxml_State_TransitionSource, gen_scxml_State_DatamodelContainer, gen_scxml_Transition_ExecutableContent, gen_scxml_Transition_DescriptionContainer, gen_scxml_Node_DescriptionContainer, gen_scxml_TransitionSource_Node, gen_scxml_TransitionTarget_Node, gen_scxml_FinalState_TransitionTarget, gen_scxml_CondEventTransition_Transition, gen_scxml_InitialState_DescriptionContainer, gen_scxml_ParallelState_State, gen_scxml_SimpleState_State, gen_scxml_SimpleState_AbstractSimpleState, gen_scxml_HistoryState_TransitionTarget, gen_scxml_HistoryState_InitialState, gen_scxml_OnEntry_ExecutableContent, gen_scxml_OnExit_ExecutableContent, gen_scxml_Raise_Donedata, gen_scxml_Send_Donedata, gen_scxml_If_Conditional, gen_scxml_If_ExecutableContent, gen_scxml_ElseIf_Conditional, gen_scxml_Invoke_Donedata, gen_scxml_Data_DescriptionContainer, gen_scxml_XData_Data, gen_scxml_Datamodel_DescriptionContainer, gen_scxml_DatamodelContainer_IAdaptable, gen_scxml_DescriptionContainer_IAdaptable},
    metadata=None
)
