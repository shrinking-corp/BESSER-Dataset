...
# Classes
domainDsl_Domainmodel = Class(name="domainDsl_Domainmodel")
domainDsl_AbstractElement = Class(name="domainDsl_AbstractElement")
domainDsl_PackageDeclaration = Class(name="domainDsl_PackageDeclaration")
AbstractElement = Class(name="AbstractElement")
domainDsl_EType = Class(name="domainDsl_EType")
domainDsl_Type = Class(name="domainDsl_Type")
domainDsl_DataType = Class(name="domainDsl_DataType")
Type = Class(name="Type")
domainDsl_Entity = Class(name="domainDsl_Entity")
domainDsl_Feature = Class(name="domainDsl_Feature")
domainDsl_Validator = Class(name="domainDsl_Validator")
domainDsl_Import = Class(name="domainDsl_Import")
...
domainDsl_Feature.attributes={domainDsl_Feature_many, domainDsl_Feature_defaultVal, domainDsl_Feature_name}
...
domainDsl_Validator.attributes={domainDsl_Validator_name, domainDsl_Validator_value, domainDsl_Validator_svalue}
...
domain_model = DomainModel(
    name="domainDsl",
    types={domainDsl_Domainmodel, domainDsl_AbstractElement, domainDsl_PackageDeclaration, AbstractElement, domainDsl_EType, domainDsl_Type, domainDsl_DataType, Type, domainDsl_Entity, domainDsl_Feature, domainDsl_Validator, domainDsl_Import},
    associations={elements0, superType4, features5, type7, valdiators9, elements1},
    generalizations={gen_domainDsl_PackageDeclaration_AbstractElement, gen_domainDsl_Type_AbstractElement, gen_domainDsl_DataType_Type, gen_domainDsl_Entity_Type, gen_domainDsl_Import_AbstractElement},
    metadata=None
)
