...
dsl_ExecJava = Class(name="dsl_ExecJava")
Action = Class(name="Action")
dsl_FirebaseDatabasePut = Class(name="dsl_FirebaseDatabasePut")
dsl_Process = Class(name="dsl_Process")
dsl_Try = Class(name="dsl_Try")
dsl_Catch = Class(name="dsl_Catch")
dsl_Finally = Class(name="dsl_Finally")
dsl_Action = Class(name="dsl_Action")
dsl_SendMail = Class(name="dsl_SendMail")
dsl_FirebaseReactiveNotification = Class(name="dsl_FirebaseReactiveNotification")
dsl_SmsLeadSms = Class(name="dsl_SmsLeadSms")
dsl_Abort = Class(name="dsl_Abort")
dsl_GooglecontactSelectAll = Class(name="dsl_GooglecontactSelectAll")
dsl_Dropfile = Class(name="dsl_Dropfile")
dsl_Doozle = Class(name="dsl_Doozle")
dsl_GooglecontactPUT = Class(name="dsl_GooglecontactPUT")
dsl_GooglecalPUT = Class(name="dsl_GooglecalPUT")
dsl_FBCLead = Class(name="dsl_FBCLead")
dsl_FBFormDownload = Class(name="dsl_FBFormDownload")
dsl_TrelloPUT = Class(name="dsl_TrelloPUT")
dsl_Fetch = Class(name="dsl_Fetch")
dsl_Rest = Class(name="dsl_Rest")
dsl_RestPart = Class(name="dsl_RestPart")
dsl_TrelloGET = Class(name="dsl_TrelloGET")
dsl_LoadCsv = Class(name="dsl_LoadCsv")
dsl_Transform = Class(name="dsl_Transform")
dsl_Callprocess = Class(name="dsl_Callprocess")
dsl_Updatedaudit = Class(name="dsl_Updatedaudit")
dsl_ClickSendSms = Class(name="dsl_ClickSendSms")
dsl_SlackPUT = Class(name="dsl_SlackPUT")
dsl_Copydata = Class(name="dsl_Copydata")
dsl_WriteCsv = Class(name="dsl_WriteCsv")
...
dsl_Expression.attributes={dsl_Expression_lhs, dsl_Expression_rhs, dsl_Expression_operator}
...
dsl_ExecJava.attributes={dsl_ExecJava_value, dsl_ExecJava_classFqn, dsl_ExecJava_dbSrc}
...
dsl_FirebaseDatabasePut.attributes={dsl_FirebaseDatabasePut_dbSrc, dsl_FirebaseDatabasePut_groupPath, dsl_FirebaseDatabasePut_value, dsl_FirebaseDatabasePut_url, dsl_FirebaseDatabasePut_fbjson, dsl_FirebaseDatabasePut_classFqn}
...
dsl_SendMail.attributes={dsl_SendMail_privateKey, dsl_SendMail_impersonatedUser, dsl_SendMail_dryrunMail, dsl_SendMail_dbSrc, dsl_SendMail_value}
...
dsl_FirebaseReactiveNotification.attributes={dsl_FirebaseReactiveNotification_classFqn, dsl_FirebaseReactiveNotification_dbSrc, dsl_FirebaseReactiveNotification_url, dsl_FirebaseReactiveNotification_groupPath, dsl_FirebaseReactiveNotification_fbjson}
...
dsl_SmsLeadSms.attributes={dsl_SmsLeadSms_url, dsl_SmsLeadSms_dbSrc, dsl_SmsLeadSms_value, dsl_SmsLeadSms_dryrunNumber, dsl_SmsLeadSms_privateKey, dsl_SmsLeadSms_account, dsl_SmsLeadSms_sender}
...
dsl_GooglecontactSelectAll.attributes={dsl_GooglecontactSelectAll_dbSrc, dsl_GooglecontactSelectAll_value, dsl_GooglecontactSelectAll_impersonatedUser, dsl_GooglecontactSelectAll_privateKey, dsl_GooglecontactSelectAll_ptwelveFile, dsl_GooglecontactSelectAll_account, dsl_GooglecontactSelectAll_project}
...
dsl_Doozle.attributes={dsl_Doozle_on, dsl_Doozle_target, dsl_Doozle_value}
...
dsl_GooglecontactPUT.attributes={dsl_GooglecontactPUT_account, dsl_GooglecontactPUT_value, dsl_GooglecontactPUT_dbSrc, dsl_GooglecontactPUT_privateKey, dsl_GooglecontactPUT_ptwelveFile, dsl_GooglecontactPUT_impersonatedUser, dsl_GooglecontactPUT_project}
...
dsl_GooglecalPUT.attributes={dsl_GooglecalPUT_privateKey, dsl_GooglecalPUT_impersonatedUser, dsl_GooglecalPUT_project, dsl_GooglecalPUT_ptwelveFile, dsl_GooglecalPUT_dbSrc, dsl_GooglecalPUT_value, dsl_GooglecalPUT_account}
...
dsl_FBCLead.attributes={dsl_FBCLead_accessToken, dsl_FBCLead_accountId, dsl_FBCLead_target, dsl_FBCLead_value, dsl_FBCLead_appSecret, dsl_FBCLead_campaignId}
...
dsl_FBFormDownload.attributes={dsl_FBFormDownload_accessToken, dsl_FBFormDownload_appSecret, dsl_FBFormDownload_target, dsl_FBFormDownload_formId, dsl_FBFormDownload_accountId, dsl_FBFormDownload_value}
...
dsl_TrelloPUT.attributes={dsl_TrelloPUT_list, dsl_TrelloPUT_key, dsl_TrelloPUT_authtoken, dsl_TrelloPUT_source, dsl_TrelloPUT_value, dsl_TrelloPUT_useraccount}
...
dsl_Fetch.attributes={dsl_Fetch_source, dsl_Fetch_value}
...
dsl_Rest.attributes={dsl_Rest_ackdata, dsl_Rest_headerdata, dsl_Rest_urldata, dsl_Rest_postdatafrom, dsl_Rest_parentName, dsl_Rest_headerdatafrom, dsl_Rest_url, dsl_Rest_parentdata, dsl_Rest_resourcedatafrom, dsl_Rest_authtoken, dsl_Rest_ackdatato, dsl_Rest_method}
...
dsl_TrelloGET.attributes={dsl_TrelloGET_key, dsl_TrelloGET_authtoken, dsl_TrelloGET_value, dsl_TrelloGET_target, dsl_TrelloGET_useraccount, dsl_TrelloGET_board}
...
dsl_LoadCsv.attributes={dsl_LoadCsv_source, dsl_LoadCsv_to, dsl_LoadCsv_value, dsl_LoadCsv_delim}
...
dsl_Callprocess.attributes={dsl_Callprocess_datasource, dsl_Callprocess_source, dsl_Callprocess_target, dsl_Callprocess_value}
...
dsl_Updatedaudit.attributes={dsl_Updatedaudit_datasource, dsl_Updatedaudit_value, dsl_Updatedaudit_logsink}
...
dsl_ClickSendSms.attributes={dsl_ClickSendSms_value, dsl_ClickSendSms_target, dsl_ClickSendSms_userid, dsl_ClickSendSms_securityKey}
...
dsl_SlackPUT.attributes={dsl_SlackPUT_team, dsl_SlackPUT_channel, dsl_SlackPUT_value}
...
dsl_Copydata.attributes={dsl_Copydata_source, dsl_Copydata_value, dsl_Copydata_to}
...
dsl_WriteCsv.attributes={dsl_WriteCsv_value, dsl_WriteCsv_source, dsl_WriteCsv_to, dsl_WriteCsv_delim}
...
try_0: BinaryAssociation = BinaryAssociation(
    name="try_0",
    ends={
...
finally_3: BinaryAssociation = BinaryAssociation(
    name="finally_3",
    ends={
...
domain_model = DomainModel(
    name="dsl",
    types={dsl_Expression, dsl_ExecJava, Action, dsl_FirebaseDatabasePut, dsl_Process, dsl_Try, dsl_Catch, dsl_Finally, dsl_Action, dsl_SendMail, dsl_FirebaseReactiveNotification, dsl_SmsLeadSms, dsl_Abort, dsl_GooglecontactSelectAll, dsl_Dropfile, dsl_Doozle, dsl_GooglecontactPUT, dsl_GooglecalPUT, dsl_FBCLead, dsl_FBFormDownload, dsl_TrelloPUT, dsl_Fetch, dsl_Rest, dsl_RestPart, dsl_TrelloGET, dsl_LoadCsv, dsl_Transform, dsl_Callprocess, dsl_Updatedaudit, dsl_ClickSendSms, dsl_SlackPUT, dsl_Copydata, dsl_WriteCsv},
    associations={condition13, try_0, catch1, finally_3, action5, action7, action10, parts15},
    generalizations={gen_dsl_ExecJava_Action, gen_dsl_FirebaseDatabasePut_Action, gen_dsl_SendMail_Action, gen_dsl_FirebaseReactiveNotification_Action, gen_dsl_SmsLeadSms_Action, gen_dsl_Abort_Action, gen_dsl_GooglecontactSelectAll_Action, gen_dsl_Dropfile_Action, gen_dsl_Doozle_Action, gen_dsl_GooglecontactPUT_Action, gen_dsl_GooglecalPUT_Action, gen_dsl_FBCLead_Action, gen_dsl_FBFormDownload_Action, gen_dsl_TrelloPUT_Action, gen_dsl_Fetch_Action, gen_dsl_Rest_Action, gen_dsl_TrelloGET_Action, gen_dsl_LoadCsv_Action, gen_dsl_Transform_Action, gen_dsl_Callprocess_Action, gen_dsl_Updatedaudit_Action, gen_dsl_ClickSendSms_Action, gen_dsl_SlackPUT_Action, gen_dsl_Copydata_Action, gen_dsl_WriteCsv_Action},
    metadata=None
)
