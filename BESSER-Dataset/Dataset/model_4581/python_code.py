...
class dsl_Action:
    ...
    def __init__(self, name: str, dsl_Action14: "dsl_Expression" = None, dsl_Action: "dsl_Try" = None, dsl_Action9: "dsl_Finally" = None, dsl_Action12: "dsl_Catch" = None):
        self.name = name
...
class dsl_GooglecontactSelectAll(Action):
    ...
    def __init__(self, privateKey: str, ptwelveFile: str, project: str, impersonatedUser: str, dbSrc: str, value: str, account: str):
        self.privateKey = privateKey
...
class dsl_WriteCsv(Action):
    ...
    def __init__(self, to: str, delim: str, value: str, source: str):
        self.to = to
        self.delim = delim
        self.value = value
        self.source = source
...
class dsl_ClickSendSms(Action):
    ...
    def __init__(self, userid: str, securityKey: str, target: str, value: str):
        self.userid = userid
...
class dsl_TrelloGET(Action):
    ...
    def __init__(self, value: str, authtoken: str, key: str, useraccount: str, board: str, target: str):
        self.value = value
...
class dsl_Rest(Action):
    ...
    def __init__(self, authtoken: str, url: str, method: str, resourcedatafrom: str, urldata: str, headerdatafrom: str, headerdata: str, postdatafrom: str, parentName: str, parentdata: str, ackdatato: str, ackdata: str, dsl_Rest: set["dsl_RestPart"] = None):
        self.authtoken = authtoken
        self.url = url
        self.method = method
...
class dsl_SendMail(Action):
    ...
    def __init__(self, privateKey: str, impersonatedUser: str, dbSrc: str, value: str, dryrunMail: str):
        self.privateKey = privateKey
        self.impersonatedUser = impersonatedUser
        self.dbSrc = dbSrc
        self.value = value
...
class dsl_Expression:
    ...
    def __init__(self, operator: str, rhs: str, lhs: str, dsl_Expression: "dsl_Action" = None):
