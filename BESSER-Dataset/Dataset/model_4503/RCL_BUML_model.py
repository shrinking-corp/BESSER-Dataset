...
domain_model = DomainModel(
    name="rcl",
    types={rcl_RoverProgram, rcl_Param, rcl_RclBlock, rcl_Statement, rcl_VarAssignment, Statement, rcl_RoverValue, rcl_Conditional, rcl_RoverExpression, rcl_Loop, rcl_Query, rcl_TemperatureQuery, Query, NumberValue, rcl_HumidityQuery, rcl_MessageQuery, StringValue, rcl_ObstacleQuery, BooleanValue, rcl_NumericExpression, RoverExpression, rcl_StringExpression, rcl_StringValue, rcl_BooleanExpression, rcl_BooleanValue, RoverValue, rcl_NumberValue, rcl_Action, rcl_ForwardAction, Action, rcl_ForwardMinAction, rcl_BackwardAction, rcl_BackwardMinAction, rcl_TurnAction, rcl_TurnDegAction, rcl_StopAction, rcl_SendAction, rcl_VarRef, rcl_LogAction, StringOperator, BooleanOperator, NumericOperator},
    associations={params0, block1, enclosing3, value4, expr5, condTrue6, condFalse9, stmts17, expr12, block14, lhs22, rhs23, lhs26, rhs27, lhs18, rhs19, distance30, distance32, degrees34},
    generalizations={gen_rcl_VarAssignment_Statement, gen_rcl_Conditional_Statement, gen_rcl_Loop_Statement, gen_rcl_RclBlock_Statement, gen_rcl_TemperatureQuery_Query, gen_rcl_TemperatureQuery_NumberValue, gen_rcl_HumidityQuery_Query, gen_rcl_HumidityQuery_NumberValue, gen_rcl_MessageQuery_Query, gen_rcl_MessageQuery_StringValue, gen_rcl_ObstacleQuery_Query, gen_rcl_ObstacleQuery_BooleanValue, gen_rcl_NumericExpression_RoverExpression, gen_rcl_StringExpression_RoverExpression, gen_rcl_BooleanExpression_RoverExpression, gen_rcl_NumberValue_RoverValue, gen_rcl_StringValue_RoverValue, gen_rcl_BooleanValue_RoverValue, gen_rcl_Action_Statement, gen_rcl_ForwardAction_Action, gen_rcl_ForwardMinAction_Action, gen_rcl_BackwardAction_Action, gen_rcl_BackwardMinAction_Action, gen_rcl_TurnAction_Action, gen_rcl_TurnDegAction_Action, gen_rcl_StopAction_Action, gen_rcl_SendAction_Action, gen_rcl_VarRef_BooleanValue, gen_rcl_VarRef_NumberValue, gen_rcl_VarRef_StringValue, gen_rcl_VarRef_Statement, gen_rcl_LogAction_Action},
    metadata=None
)
