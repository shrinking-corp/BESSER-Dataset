...
class rcl_Statement(ABC):
    ...
    def __init__(self, stmts: "rcl_RclBlock" = None, Statement: "rcl_RclBlock" = None):
        self.stmts = stmts
...
class rcl_RclBlock(Statement):
    ...
    def __init__(self, rcl_RclBlock: "rcl_RoverProgram" = None, RclBlock: "rcl_Statement" = None, rcl_RclBlock8: "rcl_Conditional" = None, rcl_RclBlock11: "rcl_Conditional" = None, enclosing: set["rcl_Statement"] = None, rcl_RclBlock16: "rcl_Loop" = None):
...
class rcl_VarRef(StringValue, Statement, NumberValue, BooleanValue):
