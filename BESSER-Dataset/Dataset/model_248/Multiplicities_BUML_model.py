...
ecore_EObject.methods={ecore_EObject_m_eContents, ecore_EObject_m_eClass, ecore_EObject_m_eSet, ecore_EObject_m_eAllContents, ecore_EObject_m_eCrossReferences, ecore_EObject_m_eContainer, ecore_EObject_m_eIsSet, ecore_EObject_m_eContainmentFeature, ecore_EObject_m_eResource, ecore_EObject_m_eInvoke, ecore_EObject_m_eGet, ecore_EObject_m_eGet, ecore_EObject_m_eContainingFeature, ecore_EObject_m_eIsProxy, ecore_EObject_m_eUnset}
...
ecore_EStructuralFeature.attributes={ecore_EStructuralFeature_volatile, ecore_EStructuralFeature_changeable, ecore_EStructuralFeature_unsettable, ecore_EStructuralFeature_derived, ecore_EStructuralFeature_defaultValue, ecore_EStructuralFeature_transient, ecore_EStructuralFeature_defaultValueLiteral}
...
ecore_ETypedElement.attributes={ecore_ETypedElement_upperBound, ecore_ETypedElement_required, ecore_ETypedElement_ordered, ecore_ETypedElement_many, ecore_ETypedElement_unique, ecore_ETypedElement_lowerBound}
...
domain_model = DomainModel(
    name="ecore",
    types={ecore_EDataType, ecore_EAnnotation, EModelElement, ecore_EStringToStringMapEntry, ecore_EModelElement, ecore_EAttribute, EStructuralFeature, ecore_EReference, ecore_EObject, ecore_EClass, EClassifier, ecore_EOperation, ecore_ETypeParameter, ecore_EEnum, EDataType, ecore_EStructuralFeature, ecore_EGenericType, ecore_EClassifier, ENamedElement, ecore_EPackage, ecore_EEnumLiteral, ecore_EFactory, ecore_ENamedElement, ETypedElement, ecore_EParameter, ecore_ETypedElement},
    associations={eAttributeType0, details1, eAllReferences14, eReferences16, eAttributes19, eAllContainments22, eAllOperations25, eModelElement2, contents3, references5, eSuperTypes9, eOperations10, eAllAttributes11, ePackage42, eTypeParameters43, eAllStructuralFeatures27, eAllSuperTypes30, eIDAttribute32, eStructuralFeatures35, eGenericSuperTypes37, eAllGenericSuperTypes39, eLiterals44, eEnum45, ePackage46, eAnnotations48, eFactoryInstance60, eClassifiers61, eSubpackages64, eSuperPackage67, eContainingClass49, eTypeParameters50, eParameters53, eExceptions54, eGenericExceptions57, eType82, eOperation69, eOpposite72, eReferenceType74, eKeys77, eContainingClass80, eGenericType84, eClassifier102, eBounds105, eUpperBound88, eTypeArguments91, eRawType93, eLowerBound97, eTypeParameter99},
