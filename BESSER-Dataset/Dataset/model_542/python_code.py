...
class ExtendedFamilies_Person(ABC):
    ...
    def __init__(self, firstName: str, children: set["ExtendedFamilies_Person"] = None, Person7: "ExtendedFamilies_Person" = None, Person: "ExtendedFamilies_Family" = None, members: "ExtendedFamilies_Family" = None, Person4: "ExtendedFamilies_Person" = None, parents: set["ExtendedFamilies_Person"] = None):
