...
def test_hyp_familyregister_member_is_not_abstract():
    assert not inspect.isabstract(FamilyRegister_Member)


def test_hyp_familyregister_member_constructor_exists():
    assert callable(FamilyRegister_Member.__init__)


def test_hyp_familyregister_member_constructor_args():
...
def test_hyp_familyregister_family_is_not_abstract():
    assert not inspect.isabstract(FamilyRegister_Family)


def test_hyp_familyregister_family_constructor_exists():
    assert callable(FamilyRegister_Family.__init__)


def test_hyp_familyregister_family_constructor_args():
...
def test_hyp_familyregister_familyregister_is_not_abstract():
    assert not inspect.isabstract(FamilyRegister_FamilyRegister)


def test_hyp_familyregister_familyregister_constructor_exists():
    assert callable(FamilyRegister_FamilyRegister.__init__)


def test_hyp_familyregister_familyregister_constructor_args():
...
def test_hyp_familyregister_member_name_setter(instance):
...
def test_hyp_familyregister_family_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
