...
# Classes
FamilyRegister_FamilyRegister = Class(name="FamilyRegister_FamilyRegister")
FamilyRegister_Family = Class(name="FamilyRegister_Family")
FamilyRegister_Member = Class(name="FamilyRegister_Member")
...
domain_model = DomainModel(
    ...
    associations={families0, mother1, father3, son6, daughter9},
    generalizations={},
    metadata=None
)
