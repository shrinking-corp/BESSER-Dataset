...
class FamilyRegister_Member:
    ...
    def __init__(self, name: str, FamilyRegister_Member: "FamilyRegister_Family" = None, FamilyRegister_Member5: "FamilyRegister_Family" = None, FamilyRegister_Member8: "FamilyRegister_Family" = None, FamilyRegister_Member11: "FamilyRegister_Family" = None):
        self.name = name
...
class FamilyRegister_Family:
    ...
    def __init__(self, name: str, FamilyRegister_Family: "FamilyRegister_FamilyRegister" = None, FamilyRegister_Family2: "FamilyRegister_Member" = None, FamilyRegister_Family4: "FamilyRegister_Member" = None, FamilyRegister_Family7: set["FamilyRegister_Member"] = None, FamilyRegister_Family10: set["FamilyRegister_Member"] = None):
        self.name = name
