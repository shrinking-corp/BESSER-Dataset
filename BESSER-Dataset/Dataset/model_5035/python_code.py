...
class party_Party(Tagged):
    ...
    def __init__(self, name: str, uid: str, owner: set["party_ContactInfo"] = None, party_Party: set["party_Identity"] = None, children: "party_Organization" = None, Party: "party_ContactInfo" = None, Party6: "party_Organization" = None, party_Party12: "party_Role" = None, party_Party8: "party_Organization" = None, party_Party18: "party_MatrixRelationship" = None):
        self.name = name
        self.uid = uid
    ...
    def setExternalParent(self, party_externalParent):
...
class party_DateEffectiveObject(Tagged):
    ...
    def isEffective(self, party_date) :
...
class party_Organization(Party):
    ...
    def __init__(self, organizationType: str, Organization: "party_Party" = None, parent: set["party_Party"] = None, party_Organization10: set["party_MatrixRelationship"] = None, party_Organization: set["party_Party"] = None):
