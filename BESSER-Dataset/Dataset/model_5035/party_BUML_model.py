...
# Classes
party_Party = Class(name="party_Party", is_abstract=True)
Tagged = Class(name="Tagged")
party_ContactInfo = Class(name="party_ContactInfo", is_abstract=True)
party_Identity = Class(name="party_Identity")
party_Organization = Class(name="party_Organization")
party_Tagged = Class(name="party_Tagged", is_abstract=True)
party_Tag = Class(name="party_Tag")
party_DateEffectiveObject = Class(name="party_DateEffectiveObject", is_abstract=True)
DateEffectiveObject = Class(name="DateEffectiveObject")
party_Phone = Class(name="party_Phone")
ContactInfo = Class(name="ContactInfo")
party_EMail = Class(name="party_EMail")
party_Address = Class(name="party_Address", is_abstract=True)
party_Custom = Class(name="party_Custom")
party_USAddress = Class(name="party_USAddress")
Address = Class(name="Address")
Party = Class(name="Party")
party_Web = Class(name="party_Web")
URL = Class(name="URL")
party_MatrixRelationship = Class(name="party_MatrixRelationship")
party_Person = Class(name="party_Person")
party_Role = Class(name="party_Role")
party_CommonObject = Class(name="party_CommonObject", is_abstract=True)
party_URL = Class(name="party_URL", is_abstract=True)
...
party_Party_m_setExternalParent: Method = Method(name="setExternalParent", parameters={Parameter(name='party_externalParent', type=StringType)})
party_Party.attributes={party_Party_name, party_Party_uid}
party_Party.methods={party_Party_m_setExternalParent, party_Party_m_getPath}
...
party_Identity.attributes={party_Identity_type, party_Identity_comment, party_Identity_value}
...
party_Tag.attributes={party_Tag_name, party_Tag_comment, party_Tag_value}
...
party_DateEffectiveObject_m_isEffective: Method = Method(name="isEffective", parameters={Parameter(name='party_date', type=StringType)}, type=BooleanType)
party_DateEffectiveObject.attributes={party_DateEffectiveObject_start, party_DateEffectiveObject_end}
...
party_Phone.attributes={party_Phone_areaCode, party_Phone_number, party_Phone_countryCode}
...
party_USAddress.attributes={party_USAddress_zip, party_USAddress_state, party_USAddress_street1, party_USAddress_street2, party_USAddress_city, party_USAddress_recipient}
...
domain_model = DomainModel(
    name="party",
    types={party_Party, Tagged, party_ContactInfo, party_Identity, party_Organization, party_Tagged, party_Tag, party_DateEffectiveObject, DateEffectiveObject, party_Phone, ContactInfo, party_EMail, party_Address, party_Custom, party_USAddress, Address, Party, party_Web, URL, party_MatrixRelationship, party_Person, party_Role, party_CommonObject, party_URL},
    associations={contactInfo0, identity1, parent2, tags3, owner4, children5, matrixedChildren9, party11, owner13, externalChildren7, target16, roles14},
    generalizations={gen_party_Party_Tagged, gen_party_DateEffectiveObject_Tagged, gen_party_ContactInfo_DateEffectiveObject, gen_party_Phone_ContactInfo, gen_party_EMail_URL, gen_party_Address_ContactInfo, gen_party_Custom_ContactInfo, gen_party_USAddress_Address, gen_party_Organization_Party, gen_party_Web_URL, gen_party_Person_Party, gen_party_Role_DateEffectiveObject, gen_party_URL_ContactInfo, gen_party_MatrixRelationship_DateEffectiveObject},
    metadata=None
)
