...
class SOS_set_ModelSort(Sort):
    ...
    def __init__(self, className: str, packageName: str, Sort100: "SOS_set_Set" = None, Sort57: "SOS_adtmm_Variable" = None, Sort: "SOS_adtmm_Operation" = None, Sort55: "SOS_adtmm_Operation" = None):
...
class SOS_set_ModelRelation(Term):
    ...
    def __init__(self, referenceName: str, SOS_set_ModelRelation: "VariableRef" = None, SOS_set_ModelRelation95: "VariableRef" = None, Term73: "SOS_adtmm_AbstractEquation" = None, Term65: "SOS_adtmm_CTerm" = None, Term23: "SOS_Transition" = None, Term83: "SOS_set_SetMembership" = None, Term71: "SOS_adtmm_CTerm" = None, Term26: "SOS_Transition" = None, Term76: "SOS_adtmm_AbstractEquation" = None, Term85: "SOS_set_SetOperator" = None, Term31: "SOS_TypeJudment" = None, Term34: "SOS_TypeJudment" = None, Term88: "SOS_set_SetOperator" = None, Term: "SOS_Transition" = None, Term20: "SOS_Transition" = None, Term80: "SOS_set_SetMembership" = None, Term92: "SOS_set_SetConstructor" = None, Term28: "SOS_TypeJudment" = None):
...
class SOS_set_ModelClassAttribute(Term):
    ...
    def __init__(self, attributeName: str, SOS_set_ModelClassAttribute: "VariableRef" = None, Term73: "SOS_adtmm_AbstractEquation" = None, Term65: "SOS_adtmm_CTerm" = None, Term23: "SOS_Transition" = None, Term83: "SOS_set_SetMembership" = None, Term71: "SOS_adtmm_CTerm" = None, Term26: "SOS_Transition" = None, Term76: "SOS_adtmm_AbstractEquation" = None, Term85: "SOS_set_SetOperator" = None, Term31: "SOS_TypeJudment" = None, Term34: "SOS_TypeJudment" = None, Term88: "SOS_set_SetOperator" = None, Term: "SOS_Transition" = None, Term20: "SOS_Transition" = None, Term80: "SOS_set_SetMembership" = None, Term92: "SOS_set_SetConstructor" = None, Term28: "SOS_TypeJudment" = None):
...
class SOS_adtmm_CTerm(Term):
    ...
    def __init__(self, iter: int, SOS_adtmm_CTerm70: "Term" = None, SOS_adtmm_CTerm: set["Term"] = None, SOS_adtmm_CTerm67: "Operation" = None, Term73: "SOS_adtmm_AbstractEquation" = None, Term65: "SOS_adtmm_CTerm" = None, Term23: "SOS_Transition" = None, Term83: "SOS_set_SetMembership" = None, Term71: "SOS_adtmm_CTerm" = None, Term26: "SOS_Transition" = None, Term76: "SOS_adtmm_AbstractEquation" = None, Term85: "SOS_set_SetOperator" = None, Term31: "SOS_TypeJudment" = None, Term34: "SOS_TypeJudment" = None, Term88: "SOS_set_SetOperator" = None, Term: "SOS_Transition" = None, Term20: "SOS_Transition" = None, Term80: "SOS_set_SetMembership" = None, Term92: "SOS_set_SetConstructor" = None, Term28: "SOS_TypeJudment" = None):
        self.iter = iter
