...
# Classes
effbd201_Function = Class(name="effbd201_Function")
SequenceNode = Class(name="SequenceNode")
ProcessNode = Class(name="ProcessNode")
effbd201_InputPort = Class(name="effbd201_InputPort")
effbd201_Description = Class(name="effbd201_Description")
effbd201_Token = Class(name="effbd201_Token")
effbd201_SequenceNode = Class(name="effbd201_SequenceNode", is_abstract=True)
effbd201_And = Class(name="effbd201_And")
Sequence = Class(name="Sequence")
effbd201_Or = Class(name="effbd201_Or")
effbd201_Sequence = Class(name="effbd201_Sequence", is_abstract=True)
effbd201_Flow = Class(name="effbd201_Flow")
effbd201_OutputPort = Class(name="effbd201_OutputPort")
effbd201_ProcessNode = Class(name="effbd201_ProcessNode", is_abstract=True)
effbd201_LoopExit = Class(name="effbd201_LoopExit")
effbd201_Start = Class(name="effbd201_Start")
effbd201_Final = Class(name="effbd201_Final")
effbd201_Iteration = Class(name="effbd201_Iteration")
effbd201_Loop = Class(name="effbd201_Loop")
Port = Class(name="Port")
effbd201_Port = Class(name="effbd201_Port", is_abstract=True)
effbd201_Item = Class(name="effbd201_Item")
...
effbd201_SequenceNode.attributes={effbd201_SequenceNode_tMax, effbd201_SequenceNode_name, effbd201_SequenceNode_tMin}
...
domain_model = DomainModel(
    name="effbd201",
    types={effbd201_Function, SequenceNode, ProcessNode, effbd201_InputPort, effbd201_Description, effbd201_Token, effbd201_SequenceNode, effbd201_And, Sequence, effbd201_Or, effbd201_Sequence, effbd201_Flow, effbd201_OutputPort, effbd201_ProcessNode, effbd201_LoopExit, effbd201_Start, effbd201_Final, effbd201_Iteration, effbd201_Loop, Port, effbd201_Port, effbd201_Item, FunctionDomain},
    associations={inputPorts8, descriptions10, tokens12, controlFlowEdge15, decompositions1, sequenceNodes2, flows4, outputPorts6, inputflowEdge18, items21, outputflowEdge16},
    generalizations={gen_effbd201_Function_SequenceNode, gen_effbd201_Function_ProcessNode, gen_effbd201_Sequence_SequenceNode, gen_effbd201_And_Sequence, gen_effbd201_Or_Sequence, gen_effbd201_Flow_ProcessNode, gen_effbd201_OutputPort_Port, gen_effbd201_LoopExit_Sequence, gen_effbd201_Start_Sequence, gen_effbd201_Final_Sequence, gen_effbd201_Loop_Sequence, gen_effbd201_InputPort_Port, gen_effbd201_Iteration_Sequence},
    metadata=None
)
