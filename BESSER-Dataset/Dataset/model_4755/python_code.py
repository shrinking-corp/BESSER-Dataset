...
class effbd201_SequenceNode(ABC):
    ...
    def __init__(self, name: str, tMin: int, tMax: int, effbd201_SequenceNode: "effbd201_SequenceNode" = None, effbd201_SequenceNode14: set["effbd201_SequenceNode"] = None):
        self.name = name
        self.tMin = tMin
        self.tMax = tMax
...
class effbd201_Port(ABC):
    ...
    def __init__(self, id: str, effbd201_Port20: "effbd201_Flow" = None, effbd201_Port: set["effbd201_Flow"] = None):
        self.id = id
