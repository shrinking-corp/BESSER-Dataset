...
# Classes
extended_Domainmodel = Class(name="extended_Domainmodel")
extended_AbstractElement = Class(name="extended_AbstractElement")
extended_PackageDeclaration = Class(name="extended_PackageDeclaration")
AbstractElement = Class(name="AbstractElement")
extended_Import = Class(name="extended_Import")
extended_AbstractType = Class(name="extended_AbstractType")
extended_DataType = Class(name="extended_DataType")
AbstractType = Class(name="AbstractType")
extended_EntityType = Class(name="extended_EntityType")
extended_Entity = Class(name="extended_Entity")
extended_Feature = Class(name="extended_Feature")
extended_Page = Class(name="extended_Page")
extended_FormTypes = Class(name="extended_FormTypes")
extended_Form = Class(name="extended_Form")
FormTypes = Class(name="FormTypes")
extended_FormNewEntityOnly = Class(name="extended_FormNewEntityOnly")
extended_FormReport = Class(name="extended_FormReport")
...
extended_Feature.attributes={extended_Feature_min, extended_Feature_name, extended_Feature_required, extended_Feature_max}
...
extended_Page.attributes={extended_Page_footer, extended_Page_name, extended_Page_title, extended_Page_header}
...
extended_Form.attributes={extended_Form_put, extended_Form_post, extended_Form_delete, extended_Form_get}
...
extended_FormReport.attributes={extended_FormReport_filter, extended_FormReport_order, extended_FormReport_pagination}
...
domain_model = DomainModel(
    name="extended",
    types={extended_Domainmodel, extended_AbstractElement, extended_PackageDeclaration, AbstractElement, extended_Import, extended_AbstractType, extended_DataType, AbstractType, extended_EntityType, extended_Entity, extended_Feature, extended_Page, extended_FormTypes, extended_Form, FormTypes, extended_FormNewEntityOnly, extended_FormReport},
    associations={elements0, elements1, entity3, superType5, features7, type9, forms11, entity12},
    generalizations={gen_extended_PackageDeclaration_AbstractElement, gen_extended_Import_AbstractElement, gen_extended_DataType_AbstractType, gen_extended_EntityType_AbstractType, gen_extended_Entity_AbstractElement, gen_extended_Page_AbstractElement, gen_extended_FormTypes_AbstractElement, gen_extended_Form_FormTypes, gen_extended_FormNewEntityOnly_FormTypes, gen_extended_FormReport_FormTypes},
    metadata=None
)
