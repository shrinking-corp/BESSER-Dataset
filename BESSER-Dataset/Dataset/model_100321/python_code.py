...
class ptnet_Fill:
    ...
    def __init__(self, color: str, gradientcolor: str, image: str, gradientrotation: str, Fill: "ptnet_NodeGraphics" = None, Fill52: "ptnet_AnnotationGraphics" = None, fill: "ptnet_NodeGraphics" = None, fill62: "ptnet_AnnotationGraphics" = None):
        self.color = color
...
class ptnet_PetriNet:
    ...
    def __init__(self, id: str, type: str, nets: "ptnet_PetriNetDoc" = None, PetriNet: "ptnet_PetriNetDoc" = None, containerPetriNet: set["ptnet_Page"] = None, containerNamePetriNet: "ptnet_Name" = None, containerPetriNet6: set["ptnet_ToolInfo"] = None, PetriNet10: "ptnet_Page" = None, PetriNet20: "ptnet_Name" = None, PetriNet25: "ptnet_ToolInfo" = None):
        self.id = id
        self.type = type
        self.nets = nets
