...
class mypackage_Customer:
    ...
    def __init__(self, name: str, dateOfBirth: date, address: str, phoneNumber: str, emailAddress: str, attribute: str, account1: set["account_Account"] = None, login4: "mypackage_Login" = None):
        self.name = name
