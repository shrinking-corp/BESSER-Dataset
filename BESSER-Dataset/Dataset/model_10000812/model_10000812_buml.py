...
mypackage_Login.attributes={mypackage_Login_password, mypackage_Login_securityAnswer, mypackage_Login_username, mypackage_Login_lastLoginTime, mypackage_Login_securityQuestion}
...
mypackage_Customer_attribute: Property = Property(name="attribute", type=StringType)
mypackage_Customer.attributes={mypackage_Customer_phoneNumber, mypackage_Customer_name, mypackage_Customer_dateOfBirth, mypackage_Customer_attribute, mypackage_Customer_address, mypackage_Customer_emailAddress}
...
domain_model = DomainModel(
    name="_63624b7a_7045_4acb_9486_16cd9650acf3",
    types={transaction_Transaction, transaction_DepositTransaction, transaction_WithdrawTransaction, transaction_TransferTransaction, account_SavingsAccount, account_CertificatesOfDepositAccount, account_CheckingAccount, account_Account, mypackage_Login, mypackage_Customer, transaction_TransactionType, account_AccountType},
