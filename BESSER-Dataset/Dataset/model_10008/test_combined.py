...
def test_hyp_game_choix_is_not_abstract():
    assert not inspect.isabstract(game_Choix)


def test_hyp_game_choix_constructor_exists():
    assert callable(game_Choix.__init__)


def test_hyp_game_choix_constructor_args():
...
def test_hyp_game_action_is_not_abstract():
    assert not inspect.isabstract(game_Action)


def test_hyp_game_action_constructor_exists():
    assert callable(game_Action.__init__)


def test_hyp_game_action_constructor_args():
    sig = inspect.signature(game_Action.__init__)
    params = list(sig.parameters.keys())



def test_hyp_game_conjonction_is_not_abstract():
    assert not inspect.isabstract(game_Conjonction)


def test_hyp_game_conjonction_constructor_exists():
    assert callable(game_Conjonction.__init__)


def test_hyp_game_conjonction_constructor_args():
    sig = inspect.signature(game_Conjonction.__init__)
    params = list(sig.parameters.keys())



def test_hyp_game_recompense_is_not_abstract():
    assert not inspect.isabstract(game_Recompense)


def test_hyp_game_recompense_constructor_exists():
    assert callable(game_Recompense.__init__)


def test_hyp_game_recompense_constructor_args():
    sig = inspect.signature(game_Recompense.__init__)
    params = list(sig.parameters.keys())



def test_hyp_game_texte_is_not_abstract():
    assert not inspect.isabstract(game_Texte)


def test_hyp_game_texte_constructor_exists():
    assert callable(game_Texte.__init__)


def test_hyp_game_texte_constructor_args():
...
def test_hyp_game_litteral_is_not_abstract():
    assert not inspect.isabstract(game_Litteral)


def test_hyp_game_litteral_constructor_exists():
    assert callable(game_Litteral.__init__)


def test_hyp_game_litteral_constructor_args():
...
def test_hyp_game_description_is_not_abstract():
    assert not inspect.isabstract(game_Description)


def test_hyp_game_description_constructor_exists():
    assert callable(game_Description.__init__)


def test_hyp_game_description_constructor_args():
    sig = inspect.signature(game_Description.__init__)
    params = list(sig.parameters.keys())



def test_hyp_entitelieu_is_not_abstract():
    assert not inspect.isabstract(EntiteLieu)


def test_hyp_entitelieu_constructor_exists():
    assert callable(EntiteLieu.__init__)


def test_hyp_entitelieu_constructor_args():
    sig = inspect.signature(EntiteLieu.__init__)
    params = list(sig.parameters.keys())



def test_hyp_game_connaissancelieu_is_not_abstract():
    assert not inspect.isabstract(game_ConnaissanceLieu)


def test_hyp_game_connaissancelieu_constructor_exists():
    assert callable(game_ConnaissanceLieu.__init__)


def test_hyp_game_connaissancelieu_constructor_args():
    sig = inspect.signature(game_ConnaissanceLieu.__init__)
    params = list(sig.parameters.keys())



def test_hyp_game_condition_is_not_abstract():
    assert not inspect.isabstract(game_Condition)


def test_hyp_game_condition_constructor_exists():
    assert callable(game_Condition.__init__)


def test_hyp_game_condition_constructor_args():
    sig = inspect.signature(game_Condition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_game_personne_is_not_abstract():
    assert not inspect.isabstract(game_Personne)


def test_hyp_game_personne_constructor_exists():
    assert callable(game_Personne.__init__)


def test_hyp_game_personne_constructor_args():
...
def test_hyp_game_entitelieu_is_not_abstract():
    assert not inspect.isabstract(game_EntiteLieu)


def test_hyp_game_entitelieu_constructor_exists():
    assert callable(game_EntiteLieu.__init__)


def test_hyp_game_entitelieu_constructor_args():
    sig = inspect.signature(game_EntiteLieu.__init__)
    params = list(sig.parameters.keys())



def test_hyp_game_gameelement_is_not_abstract():
    assert not inspect.isabstract(game_GameElement)


def test_hyp_game_gameelement_constructor_exists():
    assert callable(game_GameElement.__init__)


def test_hyp_game_gameelement_constructor_args():
...
def test_hyp_game_explorateur_is_not_abstract():
    assert not inspect.isabstract(game_Explorateur)


def test_hyp_game_explorateur_constructor_exists():
    assert callable(game_Explorateur.__init__)


def test_hyp_game_explorateur_constructor_args():
...
def test_hyp_gameelement_is_not_abstract():
    assert not inspect.isabstract(GameElement)


def test_hyp_gameelement_constructor_exists():
    assert callable(GameElement.__init__)


def test_hyp_gameelement_constructor_args():
    sig = inspect.signature(GameElement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_game_objet_is_not_abstract():
    assert not inspect.isabstract(game_Objet)


def test_hyp_game_objet_constructor_exists():
    assert callable(game_Objet.__init__)


def test_hyp_game_objet_constructor_args():
...
def test_hyp_game_lieu_is_not_abstract():
    assert not inspect.isabstract(game_Lieu)


def test_hyp_game_lieu_constructor_exists():
    assert callable(game_Lieu.__init__)


def test_hyp_game_lieu_constructor_args():
    sig = inspect.signature(game_Lieu.__init__)
    params = list(sig.parameters.keys())



def test_hyp_game_connaissance_is_not_abstract():
    assert not inspect.isabstract(game_Connaissance)


def test_hyp_game_connaissance_constructor_exists():
    assert callable(game_Connaissance.__init__)


def test_hyp_game_connaissance_constructor_args():
    sig = inspect.signature(game_Connaissance.__init__)
    params = list(sig.parameters.keys())



def test_hyp_game_chemin_is_not_abstract():
    assert not inspect.isabstract(game_Chemin)


def test_hyp_game_chemin_constructor_exists():
    assert callable(game_Chemin.__init__)


def test_hyp_game_chemin_constructor_args():
    sig = inspect.signature(game_Chemin.__init__)
    params = list(sig.parameters.keys())



def test_hyp_game_interaction_is_not_abstract():
    assert not inspect.isabstract(game_Interaction)


def test_hyp_game_interaction_constructor_exists():
    assert callable(game_Interaction.__init__)


def test_hyp_game_interaction_constructor_args():
    sig = inspect.signature(game_Interaction.__init__)
    params = list(sig.parameters.keys())



def test_hyp_game_packobjets_is_not_abstract():
    assert not inspect.isabstract(game_PackObjets)


def test_hyp_game_packobjets_constructor_exists():
    assert callable(game_PackObjets.__init__)


def test_hyp_game_packobjets_constructor_args():
...
def test_hyp_game_choix_name_setter(instance):
...
def test_hyp_game_texte_contenu_setter(instance):
...
def test_hyp_game_litteral_quantite_setter(instance):
...
@given(instance=game_Litteral_strategy)
def test_hyp_game_litteral_operateur_setter(instance):
...
def test_hyp_game_personne_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_game_gameelement_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_game_explorateur_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=game_Explorateur_strategy)
def test_hyp_game_explorateur_tailleInventaire_setter(instance):
...
def test_hyp_game_objet_taille_setter(instance):
...
def test_hyp_game_packobjets_quantite_setter(instance):
    original = instance.quantite
    instance.quantite = original
    assert instance.quantite == original
