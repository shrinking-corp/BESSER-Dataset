...
class ecore_EPackage(ENamedElement):
    ...
    def __init__(self, nsURI: str, nsPrefix: str, Ecore_ecoreEPackage: "ecore_EClassifier" = None, Ecore_ecoreEPackage47: "ecore_EFactory" = None, ePackage: "ecore_EFactory" = None, ePackage62: set["ecore_EClassifier"] = None, Ecore_ecoreEPackage65: "ecore_EPackage" = None, eSuperPackage: set["ecore_EPackage"] = None, Ecore_ecoreEPackage68: "ecore_EPackage" = None, eSubpackages: "ecore_EPackage" = None):
        self.nsURI = nsURI
        self.nsPrefix = nsPrefix
        self.Ecore_ecoreEPackage = Ecore_ecoreEPackage
        self.Ecore_ecoreEPackage47 = Ecore_ecoreEPackage47
        self.ePackage = ePackage
        self.ePackage62 = ePackage62 if ePackage62 is not None else set()
        self.Ecore_ecoreEPackage65 = Ecore_ecoreEPackage65
        self.eSuperPackage = eSuperPackage if eSuperPackage is not None else set()
        self.Ecore_ecoreEPackage68 = Ecore_ecoreEPackage68
    ...
    def eSubpackages(self, value):
        ...
        if old_value is not None:
            if hasattr(old_value, "Ecore_ecoreEPackage68"):
                opp_val = getattr(old_value, "Ecore_ecoreEPackage68", None)
                if opp_val == self:
                    setattr(old_value, "Ecore_ecoreEPackage68", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "Ecore_ecoreEPackage68"):
                opp_val = getattr(value, "Ecore_ecoreEPackage68", None)
                setattr(value, "Ecore_ecoreEPackage68", self)

    @property
    def Ecore_ecoreEPackage65(self):
        return self.__Ecore_ecoreEPackage65

    @Ecore_ecoreEPackage65.setter
    def Ecore_ecoreEPackage65(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_ecore_EPackage__Ecore_ecoreEPackage65", None)
        self.__Ecore_ecoreEPackage65 = value
    ...
    @property
    def Ecore_ecoreEPackage47(self):
        return self.__Ecore_ecoreEPackage47

    @Ecore_ecoreEPackage47.setter
    def Ecore_ecoreEPackage47(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_ecore_EPackage__Ecore_ecoreEPackage47", None)
        self.__Ecore_ecoreEPackage47 = value
    ...
    def ePackage62(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "Ecore_ecoreEClassifier"):
                    opp_val = getattr(item, "Ecore_ecoreEClassifier", None)
                    
                    if opp_val == self:
                        setattr(item, "Ecore_ecoreEClassifier", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "Ecore_ecoreEClassifier"):
                    ...
                    setattr(item, "Ecore_ecoreEClassifier", self)
                    

    @property
    def Ecore_ecoreEPackage(self):
        return self.__Ecore_ecoreEPackage

    @Ecore_ecoreEPackage.setter
    def Ecore_ecoreEPackage(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_ecore_EPackage__Ecore_ecoreEPackage", None)
        self.__Ecore_ecoreEPackage = value
    ...
    def eSuperPackage(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "Ecore_ecoreEPackage65"):
                    opp_val = getattr(item, "Ecore_ecoreEPackage65", None)
                    
                    if opp_val == self:
                        setattr(item, "Ecore_ecoreEPackage65", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "Ecore_ecoreEPackage65"):
                    ...
                    setattr(item, "Ecore_ecoreEPackage65", self)
    ...
    def ePackage(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "Ecore_ecoreEFactory"):
                opp_val = getattr(old_value, "Ecore_ecoreEFactory", None)
                if opp_val == self:
                    setattr(old_value, "Ecore_ecoreEFactory", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "Ecore_ecoreEFactory"):
                opp_val = getattr(value, "Ecore_ecoreEFactory", None)
                setattr(value, "Ecore_ecoreEFactory", self)

    @property
    def Ecore_ecoreEPackage68(self):
        return self.__Ecore_ecoreEPackage68

    @Ecore_ecoreEPackage68.setter
    def Ecore_ecoreEPackage68(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_ecore_EPackage__Ecore_ecoreEPackage68", None)
        self.__Ecore_ecoreEPackage68 = value
...
class ecore_EClassifier(ENamedElement):
    ...
    def __init__(self, instanceClassName: str, instanceClass: str, defaultValue: str, instanceTypeName: str, ecore_EClassifier: set["ecore_ETypeParameter"] = None, eClassifiers: "ecore_EPackage" = None, Ecore_ecoreEClassifier: "ecore_EPackage" = None, ecore_EClassifier56: "ecore_EOperation" = None, ecore_EClassifier83: "ecore_ETypedElement" = None, ecore_EClassifier95: "ecore_EGenericType" = None, ecore_EClassifier104: "ecore_EGenericType" = None):
        ...
        self.Ecore_ecoreEClassifier = Ecore_ecoreEClassifier
    ...
    def eClassifiers(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "Ecore_ecoreEPackage"):
                opp_val = getattr(old_value, "Ecore_ecoreEPackage", None)
                if opp_val == self:
                    setattr(old_value, "Ecore_ecoreEPackage", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "Ecore_ecoreEPackage"):
                opp_val = getattr(value, "Ecore_ecoreEPackage", None)
                setattr(value, "Ecore_ecoreEPackage", self)
    ...
    @property
    def Ecore_ecoreEClassifier(self):
        return self.__Ecore_ecoreEClassifier

    @Ecore_ecoreEClassifier.setter
    def Ecore_ecoreEClassifier(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_ecore_EClassifier__Ecore_ecoreEClassifier", None)
        self.__Ecore_ecoreEClassifier = value
...
class ecore_EEnumLiteral(ENamedElement):
    ...
    def __init__(self, value: int, instance: str, literal: str, Ecore_ecoreEEnumLiteral: "ecore_EEnum" = None, eLiterals: "ecore_EEnum" = None):
        self.value = value
        self.instance = instance
        self.literal = literal
        self.Ecore_ecoreEEnumLiteral = Ecore_ecoreEEnumLiteral
    ...
    @property
    def Ecore_ecoreEEnumLiteral(self):
        return self.__Ecore_ecoreEEnumLiteral

    @Ecore_ecoreEEnumLiteral.setter
    def Ecore_ecoreEEnumLiteral(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_ecore_EEnumLiteral__Ecore_ecoreEEnumLiteral", None)
        self.__Ecore_ecoreEEnumLiteral = value
    ...
    def eLiterals(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "Ecore_ecoreEEnum"):
                opp_val = getattr(old_value, "Ecore_ecoreEEnum", None)
                if opp_val == self:
                    setattr(old_value, "Ecore_ecoreEEnum", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "Ecore_ecoreEEnum"):
                opp_val = getattr(value, "Ecore_ecoreEEnum", None)
                setattr(value, "Ecore_ecoreEEnum", self)
...
class ecore_EEnum(EDataType):
    ...
    def __init__(self, eEnum: set["ecore_EEnumLiteral"] = None, Ecore_ecoreEEnum: "ecore_EEnumLiteral" = None):
        self.eEnum = eEnum if eEnum is not None else set()
        self.Ecore_ecoreEEnum = Ecore_ecoreEEnum
    ...
    def eEnum(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "Ecore_ecoreEEnumLiteral"):
                    opp_val = getattr(item, "Ecore_ecoreEEnumLiteral", None)
                    
                    if opp_val == self:
                        setattr(item, "Ecore_ecoreEEnumLiteral", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "Ecore_ecoreEEnumLiteral"):
                    ...
                    setattr(item, "Ecore_ecoreEEnumLiteral", self)
                    

    @property
    def Ecore_ecoreEEnum(self):
        return self.__Ecore_ecoreEEnum

    @Ecore_ecoreEEnum.setter
    def Ecore_ecoreEEnum(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_ecore_EEnum__Ecore_ecoreEEnum", None)
        self.__Ecore_ecoreEEnum = value
...
class ecore_EOperation(ETypedElement):
    ...
    def __init__(self, Ecore_ecoreEOperation: "ecore_EClass" = None, ecore_EOperation58: set["ecore_EGenericType"] = None, Ecore_ecoreEOperation70: "ecore_EParameter" = None, eOperations: "ecore_EClass" = None, ecore_EOperation51: set["ecore_ETypeParameter"] = None, eOperation: set["ecore_EParameter"] = None, ecore_EOperation55: set["ecore_EClassifier"] = None, ecore_EOperation: "ecore_EClass" = None):
        self.Ecore_ecoreEOperation = Ecore_ecoreEOperation
        self.ecore_EOperation58 = ecore_EOperation58 if ecore_EOperation58 is not None else set()
        self.Ecore_ecoreEOperation70 = Ecore_ecoreEOperation70
    ...
    def eOperation(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "Ecore_ecoreEParameter"):
                    opp_val = getattr(item, "Ecore_ecoreEParameter", None)
                    
                    if opp_val == self:
                        setattr(item, "Ecore_ecoreEParameter", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "Ecore_ecoreEParameter"):
                    ...
                    setattr(item, "Ecore_ecoreEParameter", self)
                    

    @property
    def Ecore_ecoreEOperation(self):
        return self.__Ecore_ecoreEOperation

    @Ecore_ecoreEOperation.setter
    def Ecore_ecoreEOperation(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_ecore_EOperation__Ecore_ecoreEOperation", None)
        self.__Ecore_ecoreEOperation = value
    ...
    def eOperations(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "Ecore_ecoreEClass"):
                opp_val = getattr(old_value, "Ecore_ecoreEClass", None)
                if opp_val == self:
                    setattr(old_value, "Ecore_ecoreEClass", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "Ecore_ecoreEClass"):
                opp_val = getattr(value, "Ecore_ecoreEClass", None)
                setattr(value, "Ecore_ecoreEClass", self)
    ...
    @property
    def Ecore_ecoreEOperation70(self):
        return self.__Ecore_ecoreEOperation70

    @Ecore_ecoreEOperation70.setter
    def Ecore_ecoreEOperation70(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_ecore_EOperation__Ecore_ecoreEOperation70", None)
        self.__Ecore_ecoreEOperation70 = value
...
class ecore_EStructuralFeature(ETypedElement):
    ...
    def __init__(self, changeable: bool, volatile: bool, transient: bool, defaultValueLiteral: str, defaultValue: str, unsettable: bool, derived: bool, Ecore_ecoreEStructuralFeature: "ecore_EClass" = None, ecore_EStructuralFeature: "ecore_EClass" = None, eStructuralFeatures: "ecore_EClass" = None):
        ...
        self.Ecore_ecoreEStructuralFeature = Ecore_ecoreEStructuralFeature
    ...
    @property
    def Ecore_ecoreEStructuralFeature(self):
        return self.__Ecore_ecoreEStructuralFeature

    @Ecore_ecoreEStructuralFeature.setter
    def Ecore_ecoreEStructuralFeature(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_ecore_EStructuralFeature__Ecore_ecoreEStructuralFeature", None)
        self.__Ecore_ecoreEStructuralFeature = value
    ...
    def eStructuralFeatures(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "Ecore_ecoreEClass81"):
                opp_val = getattr(old_value, "Ecore_ecoreEClass81", None)
                if opp_val == self:
                    setattr(old_value, "Ecore_ecoreEClass81", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "Ecore_ecoreEClass81"):
                opp_val = getattr(value, "Ecore_ecoreEClass81", None)
                setattr(value, "Ecore_ecoreEClass81", self)
...
class ecore_EAttribute(EStructuralFeature):
    ...
    def __init__(self, iD: bool, ecore_EAttribute13: "ecore_EClass" = None, ecore_EAttribute: "ecore_EDataType" = None, ecore_EAttribute21: "ecore_EClass" = None, ecore_EAttribute34: "ecore_EClass" = None, ecore_EAttribute79: "ecore_EReference" = None):
        self.iD = iD
...
class ecore_EClass(EClassifier):
    ...
    def __init__(self, abstract: bool, interface: bool, eContainingClass36: set["ecore_EStructuralFeature"] = None, ecore_EClass: "ecore_EClass" = None, ecore_EClass8: set["ecore_EClass"] = None, eContainingClass: set["ecore_EOperation"] = None, ecore_EClass12: set["ecore_EAttribute"] = None, ecore_EClass15: set["ecore_EReference"] = None, ecore_EClass38: set["ecore_EGenericType"] = None, ecore_EClass40: set["ecore_EGenericType"] = None, Ecore_ecoreEClass: "ecore_EOperation" = None, ecore_EClass17: set["ecore_EReference"] = None, ecore_EClass20: set["ecore_EAttribute"] = None, ecore_EClass23: set["ecore_EReference"] = None, ecore_EClass26: set["ecore_EOperation"] = None, ecore_EClass28: set["ecore_EStructuralFeature"] = None, ecore_EClass31: "ecore_EClass" = None, ecore_EClass29: set["ecore_EClass"] = None, ecore_EClass33: "ecore_EAttribute" = None, ecore_EClass76: "ecore_EReference" = None, Ecore_ecoreEClass81: "ecore_EStructuralFeature" = None):
        ...
        self.Ecore_ecoreEClass = Ecore_ecoreEClass
        ...
        self.Ecore_ecoreEClass81 = Ecore_ecoreEClass81
    ...
    def eContainingClass36(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "Ecore_ecoreEStructuralFeature"):
                    opp_val = getattr(item, "Ecore_ecoreEStructuralFeature", None)
                    
                    if opp_val == self:
                        setattr(item, "Ecore_ecoreEStructuralFeature", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "Ecore_ecoreEStructuralFeature"):
                    ...
                    setattr(item, "Ecore_ecoreEStructuralFeature", self)
                    

    @property
    def Ecore_ecoreEClass81(self):
        return self.__Ecore_ecoreEClass81

    @Ecore_ecoreEClass81.setter
    def Ecore_ecoreEClass81(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_ecore_EClass__Ecore_ecoreEClass81", None)
        self.__Ecore_ecoreEClass81 = value
    ...
    def eContainingClass(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "Ecore_ecoreEOperation"):
                    opp_val = getattr(item, "Ecore_ecoreEOperation", None)
                    
                    if opp_val == self:
                        setattr(item, "Ecore_ecoreEOperation", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "Ecore_ecoreEOperation"):
                    ...
                    setattr(item, "Ecore_ecoreEOperation", self)
    ...
    @property
    def Ecore_ecoreEClass(self):
        return self.__Ecore_ecoreEClass

    @Ecore_ecoreEClass.setter
    def Ecore_ecoreEClass(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_ecore_EClass__Ecore_ecoreEClass", None)
        self.__Ecore_ecoreEClass = value
...
class ecore_EModelElement(ABC):
    ...
    def __init__(self, eModelElement: set["ecore_EAnnotation"] = None, Ecore_ecoreEModelElement: "ecore_EAnnotation" = None):
        self.eModelElement = eModelElement if eModelElement is not None else set()
        self.Ecore_ecoreEModelElement = Ecore_ecoreEModelElement
    ...
    def eModelElement(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "Ecore_ecoreEAnnotation"):
                    opp_val = getattr(item, "Ecore_ecoreEAnnotation", None)
                    
                    if opp_val == self:
                        setattr(item, "Ecore_ecoreEAnnotation", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "Ecore_ecoreEAnnotation"):
                    ...
                    setattr(item, "Ecore_ecoreEAnnotation", self)
                    

    @property
    def Ecore_ecoreEModelElement(self):
        return self.__Ecore_ecoreEModelElement

    @Ecore_ecoreEModelElement.setter
    def Ecore_ecoreEModelElement(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_ecore_EModelElement__Ecore_ecoreEModelElement", None)
        self.__Ecore_ecoreEModelElement = value
...
class ecore_EFactory(EModelElement):
    ...
    def __init__(self, eFactoryInstance: "ecore_EPackage" = None, Ecore_ecoreEFactory: "ecore_EPackage" = None):
        self.eFactoryInstance = eFactoryInstance
        self.Ecore_ecoreEFactory = Ecore_ecoreEFactory
        
        pass
    @property
    def Ecore_ecoreEFactory(self):
        return self.__Ecore_ecoreEFactory

    @Ecore_ecoreEFactory.setter
    def Ecore_ecoreEFactory(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_ecore_EFactory__Ecore_ecoreEFactory", None)
        self.__Ecore_ecoreEFactory = value
    ...
    def eFactoryInstance(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "Ecore_ecoreEPackage47"):
                opp_val = getattr(old_value, "Ecore_ecoreEPackage47", None)
                if opp_val == self:
                    setattr(old_value, "Ecore_ecoreEPackage47", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "Ecore_ecoreEPackage47"):
                opp_val = getattr(value, "Ecore_ecoreEPackage47", None)
                setattr(value, "Ecore_ecoreEPackage47", self)
...
class ecore_EAnnotation(EModelElement):
    ...
    def __init__(self, source: str, Ecore_ecoreEAnnotation: "ecore_EModelElement" = None, ecore_EAnnotation: set["ecore_EStringToStringMapEntry"] = None, eAnnotations: "ecore_EModelElement" = None, ecore_EAnnotation4: set["ecore_EObject"] = None, ecore_EAnnotation6: set["ecore_EObject"] = None):
        self.source = source
        self.Ecore_ecoreEAnnotation = Ecore_ecoreEAnnotation
    ...
    @property
    def Ecore_ecoreEAnnotation(self):
        return self.__Ecore_ecoreEAnnotation

    @Ecore_ecoreEAnnotation.setter
    def Ecore_ecoreEAnnotation(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_ecore_EAnnotation__Ecore_ecoreEAnnotation", None)
        self.__Ecore_ecoreEAnnotation = value
    ...
    def eAnnotations(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "Ecore_ecoreEModelElement"):
                opp_val = getattr(old_value, "Ecore_ecoreEModelElement", None)
                if opp_val == self:
                    setattr(old_value, "Ecore_ecoreEModelElement", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "Ecore_ecoreEModelElement"):
                opp_val = getattr(value, "Ecore_ecoreEModelElement", None)
                setattr(value, "Ecore_ecoreEModelElement", self)
