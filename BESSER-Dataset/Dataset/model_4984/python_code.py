...
class cloudml_core_RequiredPort(Port):
    ...
    def __init__(self, isMandatory: bool, Port: "cloudml_core_PortInstance" = None):
...
class cloudml_core_VMInstance(ExternalComponentInstance):
    ...
    def __init__(self, publicAddress: str, hostname: str, id: str, cloudml_core_VMInstance: set["VMPortInstance"] = None, ExternalComponentInstance: "cloudml_core_CloudMLModel" = None):
...
class cloudml_core_VM(ExternalComponent):
    ...
    def __init__(self, minRam: int, maxRam: int, minCores: int, maxCores: int, minStorage: int, maxStorage: int, os: str, is64os: bool, imageId: str, securityGroup: str, sshKey: str, privateKey: str, groupName: str, providerSpecificTypeName: str, cloudml_core_VM: set["VMPort"] = None, ExternalComponent: "cloudml_core_CloudMLModel" = None):
        self.minRam = minRam
        self.maxRam = maxRam
    ...
    @property
    def providerSpecificTypeName(self):
...
class cloudml_core_ExternalComponentInstance(ComponentInstance):
    ...
    def __init__(self, ips: str, status: str, cloudml_core_ExternalComponentInstance: set["VMPortInstance"] = None, ComponentInstance: "cloudml_core_CloudMLModel" = None, ComponentInstance93: "cloudml_core_ExecutionPlatformInstance" = None, ComponentInstance74: "cloudml_core_PortInstance" = None):
        self.ips = ips
        self.status = status
...
class cloudml_core_Resource(CloudMLElementWithProperties):
    ...
    def __init__(self, configureCommand: str, startCommand: str, stopCommand: str, requireCredentials: bool, downloadCommand: str, uploadCommand: str, installCommand: str, executeLocally: bool):
...
class cloudml_core_DockerResource(Resource):
    ...
    def __init__(self, image: str, dockerFilePath: str, Resource56: "cloudml_core_Relationship" = None, Resource53: "cloudml_core_Relationship" = None, Resource: "cloudml_core_CloudMLElementWithProperties" = None):
        self.image = image
...
class cloudml_core_PuppetResource(Resource):
    ...
    def __init__(self, masterEndpoint: str, repositoryEndpoint: str, configureHostnameCommand: str, username: str, repositoryKey: str, configurationFile: str, manifestEntry: str, Resource56: "cloudml_core_Relationship" = None, Resource53: "cloudml_core_Relationship" = None, Resource: "cloudml_core_CloudMLElementWithProperties" = None):
    ...
    @property
    def configureHostnameCommand(self):
