...
cloudml_core_Resource.attributes={cloudml_core_Resource_requireCredentials, cloudml_core_Resource_downloadCommand, cloudml_core_Resource_uploadCommand, cloudml_core_Resource_configureCommand, cloudml_core_Resource_installCommand, cloudml_core_Resource_stopCommand, cloudml_core_Resource_startCommand, cloudml_core_Resource_executeLocally}
...
cloudml_core_VM.attributes={cloudml_core_VM_is64os, cloudml_core_VM_groupName, cloudml_core_VM_os, cloudml_core_VM_imageId, cloudml_core_VM_maxCores, cloudml_core_VM_maxRam, cloudml_core_VM_minStorage, cloudml_core_VM_providerSpecificTypeName, cloudml_core_VM_maxStorage, cloudml_core_VM_sshKey, cloudml_core_VM_minCores, cloudml_core_VM_privateKey, cloudml_core_VM_securityGroup, cloudml_core_VM_minRam}
...
cloudml_core_Provider.attributes={cloudml_core_Provider_login, cloudml_core_Provider_password, cloudml_core_Provider_credentials}
...
cloudml_core_VMInstance.attributes={cloudml_core_VMInstance_publicAddress, cloudml_core_VMInstance_hostname, cloudml_core_VMInstance_id}
...
cloudml_core_ExternalComponent.attributes={cloudml_core_ExternalComponent_passwd, cloudml_core_ExternalComponent_location, cloudml_core_ExternalComponent_serviceType, cloudml_core_ExternalComponent_endPoint, cloudml_core_ExternalComponent_login, cloudml_core_ExternalComponent_Region}
...
cloudml_core_ResourcesPool.attributes={cloudml_core_ResourcesPool_maxReplicats, cloudml_core_ResourcesPool_nbReplicats, cloudml_core_ResourcesPool_minReplicats, cloudml_core_ResourcesPool_type}
