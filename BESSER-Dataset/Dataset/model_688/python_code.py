...
class Janus_JTL_Relation(NamedElement):
    ...
    def __init__(self, isTopLevel: bool, relation32: set["Domain"] = None, whereOwner: "Pattern" = None, whenOwner: "Pattern" = None, Janus_JTL_Relation: set["Variable"] = None, relation: "Transformation" = None, NamedElement: "Janus_emof_Comment" = None):
...
class Janus_emof_NamedElement(Element):
    ...
    def __init__(self, name: str, Element236: "Janus_imperativeocl_LogExp" = None, Element: "Janus_emof_Tag" = None):
        self.name = name
...
class Janus_emof_Tag(Element):
    ...
    def __init__(self, value: str, name: str, tag: set["Element"] = None, Element236: "Janus_imperativeocl_LogExp" = None, Element: "Janus_emof_Tag" = None):
        self.value = value
        self.name = name
...
class Janus_imperativeocl_TemplateParameterType(Type):
    ...
    def __init__(self, specification: str, Type203: "Janus_imperativeocl_TryExp" = None, Type97: "Janus_essentialocl_TypeExp" = None, Type13: "Janus_emof_Package" = None, Type138: "Janus_essentialocl_CollectionType" = None, Type25: "Janus_emof_TypedElement" = None, Type248: "Janus_imperativeocl_AnonymousTupleType" = None, Type208: "Janus_imperativeocl_RaiseExp" = None, Type: "Janus_emof_Operation" = None, Type225: "Janus_imperativeocl_DictionaryType" = None, Type212: "Janus_imperativeocl_Typedef" = None):
...
class Janus_emof_Class(Type):
    ...
    def __init__(self, isAbstract: bool, Class: set["Property"] = None, class_: set["Operation"] = None, Janus_emof_Class: set["Class"] = None, Type203: "Janus_imperativeocl_TryExp" = None, Type97: "Janus_essentialocl_TypeExp" = None, Type13: "Janus_emof_Package" = None, Type138: "Janus_essentialocl_CollectionType" = None, Type25: "Janus_emof_TypedElement" = None, Type248: "Janus_imperativeocl_AnonymousTupleType" = None, Type208: "Janus_imperativeocl_RaiseExp" = None, Type: "Janus_emof_Operation" = None, Type225: "Janus_imperativeocl_DictionaryType" = None, Type212: "Janus_imperativeocl_Typedef" = None):
