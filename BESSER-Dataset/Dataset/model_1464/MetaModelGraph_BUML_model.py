...
# Classes
MetaModelGraph_Composition = Class(name="MetaModelGraph_Composition")
MetaModelGraph_Reference = Class(name="MetaModelGraph_Reference")
MetaModelGraph_SubClass = Class(name="MetaModelGraph_SubClass")
MetaModelGraph_Graph = Class(name="MetaModelGraph_Graph")
MetaModelGraph_SubGraph = Class(name="MetaModelGraph_SubGraph")
MetaModelGraph_EClass = Class(name="MetaModelGraph_EClass")
MetaModelGraph_Node = Class(name="MetaModelGraph_Node")
MetaModelGraph_Relation = Class(name="MetaModelGraph_Relation", is_abstract=True)
MetaModelGraph_EAttribute = Class(name="MetaModelGraph_EAttribute")
Relation = Class(name="Relation")
MetaModelGraph_EReference = Class(name="MetaModelGraph_EReference")
...
MetaModelGraph_Graph.attributes={MetaModelGraph_Graph_amountEClasses, MetaModelGraph_Graph_amountAbstractEClasses, MetaModelGraph_Graph_amountConcreteEClass}
...
MetaModelGraph_SubGraph.attributes={MetaModelGraph_SubGraph_amountOfParentEClass, MetaModelGraph_SubGraph_amountUnits, MetaModelGraph_SubGraph_amountOfParentAbstractEClass, MetaModelGraph_SubGraph_amountOfAbstractEClass, MetaModelGraph_SubGraph_amountRecursionUnits, MetaModelGraph_SubGraph_amountPackages, MetaModelGraph_SubGraph_amountEClassesOut, MetaModelGraph_SubGraph_height, MetaModelGraph_SubGraph_amountOfRecursionPackages, MetaModelGraph_SubGraph_amountOfConcreteEClass}
...
MetaModelGraph_Node.attributes={MetaModelGraph_Node_insideRecursion, MetaModelGraph_Node_extension, MetaModelGraph_Node_icon, MetaModelGraph_Node_enumModularNotation}
...
domain_model = DomainModel(
    name="MetaModelGraph",
    types={MetaModelGraph_Composition, MetaModelGraph_Reference, MetaModelGraph_SubClass, MetaModelGraph_Graph, MetaModelGraph_SubGraph, MetaModelGraph_EClass, MetaModelGraph_Node, MetaModelGraph_Relation, MetaModelGraph_EAttribute, Relation, MetaModelGraph_EReference, EnumModular},
    associations={compositions16, references17, subClasses19, eClass21, relations24, listNodes26, directSubclasses28, subgraph0, eClassList1, eClassAbstract3, nodes6, relations8, eClassesListOut10, root13, directComposition31, name33, target35, eReference36, parentNode38, eReference40},
