...
class MetaModelGraph_Node:
    ...
    def __init__(self, enumModularNotation: str, insideRecursion: bool, icon: str, extension: str, parentNode: set["MetaModelGraph_Composition"] = None, MetaModelGraph_Node18: set["MetaModelGraph_Reference"] = None, MetaModelGraph_Node20: set["MetaModelGraph_SubClass"] = None, MetaModelGraph_Node22: "MetaModelGraph_EClass" = None, target: set["MetaModelGraph_Relation"] = None, MetaModelGraph_Node27: "MetaModelGraph_Node" = None, MetaModelGraph_Node25: set["MetaModelGraph_Node"] = None, MetaModelGraph_Node29: set["MetaModelGraph_SubClass"] = None, MetaModelGraph_Node: "MetaModelGraph_SubGraph" = None, MetaModelGraph_Node15: "MetaModelGraph_SubGraph" = None, MetaModelGraph_Node32: set["MetaModelGraph_Composition"] = None, MetaModelGraph_Node34: "MetaModelGraph_EAttribute" = None, Node: "MetaModelGraph_Relation" = None, Node39: "MetaModelGraph_Composition" = None):
...
class MetaModelGraph_SubGraph:
    ...
    def __init__(self, amountPackages: int, amountUnits: int, amountRecursionUnits: int, amountOfRecursionPackages: int, height: int, amountOfConcreteEClass: int, amountEClassesOut: int, amountOfAbstractEClass: int, amountOfParentEClass: int, amountOfParentAbstractEClass: int, MetaModelGraph_SubGraph: "MetaModelGraph_Graph" = None, MetaModelGraph_SubGraph7: set["MetaModelGraph_Node"] = None, MetaModelGraph_SubGraph9: set["MetaModelGraph_Relation"] = None, MetaModelGraph_SubGraph11: set["MetaModelGraph_EClass"] = None, MetaModelGraph_SubGraph14: "MetaModelGraph_Node" = None):
    ...
    @property
    def amountOfAbstractEClass(self):
    ...
    @property
    def amountOfConcreteEClass(self):
    ...
    @property
    def amountOfParentAbstractEClass(self):
    ...
    @property
    def amountOfRecursionPackages(self):
...
class MetaModelGraph_Graph:
    ...
    @property
    def amountAbstractEClasses(self):
