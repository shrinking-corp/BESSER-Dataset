...
# Classes
caltrop_Schedule = Class(name="caltrop_Schedule")
caltrop_ActorParameter = Class(name="caltrop_ActorParameter")
Parameter_ = Class(name="Parameter")
caltrop_TypedInputPort = Class(name="caltrop_TypedInputPort")
AbstractTypedIOPort = Class(name="AbstractTypedIOPort")
caltrop_TypedOutputPort = Class(name="caltrop_TypedOutputPort")
Variable = Class(name="Variable")
caltrop_XExpression = Class(name="caltrop_XExpression")
caltrop_Realm = Class(name="caltrop_Realm")
caltrop_FireAction = Class(name="caltrop_FireAction")
ReAction = Class(name="ReAction")
caltrop_InputPattern = Class(name="caltrop_InputPattern")
OutputAction = Class(name="OutputAction")
NamedObj = Class(name="NamedObj")
caltrop_CaltropActorImpl = Class(name="caltrop_CaltropActorImpl")
caltrop_StateVariable = Class(name="caltrop_StateVariable")
caltrop_ReAction = Class(name="caltrop_ReAction")
caltrop_OutputAction = Class(name="caltrop_OutputAction")
caltrop_FunctionDeclaration = Class(name="caltrop_FunctionDeclaration")
caltrop_ActionPattern = Class(name="caltrop_ActionPattern")
PortPattern = Class(name="PortPattern")
ActionPattern = Class(name="ActionPattern")
caltrop_ExpressionChannelSelector = Class(name="caltrop_ExpressionChannelSelector")
ChannelSelector = Class(name="ChannelSelector")
caltrop_KeywordChannelSelector = Class(name="caltrop_KeywordChannelSelector")
JvmTypedObj = Class(name="JvmTypedObj")
caltrop_OutputPattern = Class(name="caltrop_OutputPattern")
caltrop_PortPattern = Class(name="caltrop_PortPattern", is_abstract=True)
caltrop_ChannelSelector = Class(name="caltrop_ChannelSelector", is_abstract=True)
caltrop_Port = Class(name="caltrop_Port")
caltrop_EventAction = Class(name="caltrop_EventAction")
caltrop_EventPattern = Class(name="caltrop_EventPattern")
caltrop_ConversionRelation = Class(name="caltrop_ConversionRelation")
caltrop_JvmTypedObj = Class(name="caltrop_JvmTypedObj")
caltrop_JvmTypeReference = Class(name="caltrop_JvmTypeReference")
caltrop_State = Class(name="caltrop_State")
caltrop_Transition = Class(name="caltrop_Transition")
...
caltrop_StateVariable.attributes={caltrop_StateVariable_binding, caltrop_StateVariable_constant}
...
caltrop_EventPattern__property: Property = Property(name="_property", type=BooleanType)
caltrop_EventPattern.attributes={caltrop_EventPattern_name, caltrop_EventPattern_qualifier, caltrop_EventPattern_variables, caltrop_EventPattern__property}
...
domain_model = DomainModel(
    name="caltrop",
    types={caltrop_Schedule, caltrop_ActorParameter, Parameter_, caltrop_TypedInputPort, AbstractTypedIOPort, caltrop_TypedOutputPort, Variable, caltrop_XExpression, caltrop_Realm, caltrop_FireAction, ReAction, caltrop_InputPattern, OutputAction, NamedObj, caltrop_CaltropActorImpl, caltrop_StateVariable, caltrop_ReAction, caltrop_OutputAction, caltrop_FunctionDeclaration, caltrop_ActionPattern, PortPattern, ActionPattern, caltrop_ExpressionChannelSelector, ChannelSelector, caltrop_KeywordChannelSelector, JvmTypedObj, caltrop_OutputPattern, caltrop_PortPattern, caltrop_ChannelSelector, caltrop_Port, caltrop_EventAction, caltrop_EventPattern, caltrop_ConversionRelation, caltrop_JvmTypedObj, caltrop_JvmTypeReference, caltrop_State, caltrop_Transition, Relation, ChannelSelectorKeyword},
    associations={schedule7, updateExpression9, realm11, inputPatterns13, declarations0, actions1, initActions3, functions5, portRef32, guardExpression34, valueExpressions37, keyExpressions40, guardExpression14, outputPatterns17, bodyExpression19, updateExpression22, delayExpression25, repeatExpression28, channels30, schedule53, source54, target56, actions58, eventPatterns61, varRef62, timeExpression65, guardExpression68, parameters42, bodyExpression44, throwables47, initial49, states51, transitions52, conversionExpression71, guardExpression73},
    generalizations={gen_caltrop_ActorParameter_Parameter, gen_caltrop_TypedInputPort_AbstractTypedIOPort, gen_caltrop_TypedOutputPort_AbstractTypedIOPort, gen_caltrop_StateVariable_Variable, gen_caltrop_FireAction_ReAction, gen_caltrop_ReAction_OutputAction, gen_caltrop_OutputAction_NamedObj, gen_caltrop_InputPattern_PortPattern, gen_caltrop_InputPattern_ActionPattern, gen_caltrop_OutputPattern_PortPattern, gen_caltrop_ExpressionChannelSelector_ChannelSelector, gen_caltrop_KeywordChannelSelector_ChannelSelector, gen_caltrop_FunctionDeclaration_JvmTypedObj, gen_caltrop_EventAction_ReAction, gen_caltrop_EventPattern_ActionPattern, gen_caltrop_State_NamedObj, gen_caltrop_ConversionRelation_Relation},
    metadata=None
)
