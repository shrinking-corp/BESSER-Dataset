...
def test_hyp_caltrop_realm_is_not_abstract():
    assert not inspect.isabstract(caltrop_Realm)


def test_hyp_caltrop_realm_constructor_exists():
    assert callable(caltrop_Realm.__init__)


def test_hyp_caltrop_realm_constructor_args():
...
def test_hyp_caltrop_realm_key_setter(instance):
...
def test_hyp_caltrop_statevariable_binding_setter(instance):
