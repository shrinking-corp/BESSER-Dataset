...
class bpmn_SequenceEdge(NamedBpmnObject, AssociationTarget):
    ...
    def __init__(self, conditionType: str, isDefault: str, SequenceEdge: "bpmn_Graph" = None, outgoingEdges: "bpmn_Vertex" = None, incomingEdges: "bpmn_Vertex" = None, sequenceEdges: "bpmn_Graph" = None, SequenceEdge51: "bpmn_Vertex" = None, SequenceEdge48: "bpmn_Vertex" = None):
...
class bpmn_BpmnDiagram(Identifiable, ArtifactsContainer):
    ...
    def __init__(self, author: str, title: str, BpmnDiagram: "bpmn_MessagingEdge" = None, BpmnDiagram38: "bpmn_Pool" = None, bpmnDiagram: set["bpmn_Pool"] = None, bpmnDiagram15: set["bpmn_MessagingEdge"] = None):
        self.author = author
        self.title = title
...
class bpmn_MessageVertex(NamedBpmnObject, Identifiable):
    ...
    def __init__(self, orderedMessages: str, MessageVertex: "bpmn_MessagingEdge" = None, MessageVertex33: "bpmn_MessagingEdge" = None, target26: set["bpmn_MessagingEdge"] = None, source29: set["bpmn_MessagingEdge"] = None):
...
class bpmn_Activity(Vertex, MessageVertex):
    ...
    def __init__(self, activityType: str, looping: str, Activity: "bpmn_Group" = None, activities: set["bpmn_Group"] = None, activities2: set["bpmn_Lane"] = None, eventHandlers: "bpmn_SubProcess" = None, Activity21: "bpmn_Lane" = None, Activity45: "bpmn_SubProcess" = None):
