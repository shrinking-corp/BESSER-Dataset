...
domain_model = DomainModel(
    name="bpmn",
    types={bpmn_Group, bpmn_Lane, bpmn_SubProcess, bpmn_Activity, Vertex, MessageVertex, bpmn_Artifact, Identifiable, NamedBpmnObject, bpmn_Association, bpmn_ArtifactsContainer, EModelElement, bpmn_AssociationTarget, bpmn_BpmnDiagram, ArtifactsContainer, bpmn_Pool, bpmn_MessagingEdge, bpmn_DataObject, Artifact, bpmn_Graph, AssociationTarget, bpmn_Vertex, bpmn_SequenceEdge, bpmn_MessageVertex, bpmn_Identifiable, bpmn_NamedBpmnObject, Graph, Activity, bpmn_TextAnnotation, ActivityType, DirectionType, SequenceFlowConditionType},
    associations={groups0, lanes1, eventHandlerFor3, associations4, artifactsContainer5, artifacts6, source7, target9, associations11, pools13, messages14, vertices16, sequenceEdges17, activities20, pool22, incomingMessages25, outgoingMessages28, activities19, bpmnDiagram34, lanes35, bpmnDiagram37, source31, target32, source39, target41, graph43, eventHandlers44, incomingEdges49, graph52, outgoingEdges46},
    generalizations={gen_bpmn_Activity_Vertex, gen_bpmn_Activity_MessageVertex, gen_bpmn_Artifact_Identifiable, gen_bpmn_Artifact_NamedBpmnObject, gen_bpmn_ArtifactsContainer_NamedBpmnObject, gen_bpmn_Association_EModelElement, gen_bpmn_BpmnDiagram_Identifiable, gen_bpmn_BpmnDiagram_ArtifactsContainer, gen_bpmn_DataObject_Artifact, gen_bpmn_AssociationTarget_Identifiable, gen_bpmn_Graph_AssociationTarget, gen_bpmn_Graph_ArtifactsContainer, gen_bpmn_Group_Artifact, gen_bpmn_Lane_AssociationTarget, gen_bpmn_Lane_NamedBpmnObject, gen_bpmn_MessageVertex_NamedBpmnObject, gen_bpmn_MessageVertex_Identifiable, gen_bpmn_MessagingEdge_AssociationTarget, gen_bpmn_MessagingEdge_NamedBpmnObject, gen_bpmn_Identifiable_EModelElement, gen_bpmn_Pool_Graph, gen_bpmn_Pool_MessageVertex, gen_bpmn_SubProcess_Activity, gen_bpmn_SubProcess_Graph, gen_bpmn_SequenceEdge_AssociationTarget, gen_bpmn_TextAnnotation_Artifact, gen_bpmn_SequenceEdge_NamedBpmnObject, gen_bpmn_Vertex_AssociationTarget},
    metadata=None
)
