...
class failureLogic_FMEA_FMEDAEntry(FMEAEntry):
    ...
    def __init__(self, diagnosisRate: float, failureLogic_FMEA_FMEDAEntry: "FMEA_failureLogic_ProbDist" = None, FMEAEntry: "failureLogic_FMEA_FMEA" = None):
...
class failureLogic_FTA_Gate(Cause):
    ...
    def __init__(self, gateType: str, failureLogic_FTA_Gate: set["Cause"] = None, Cause26: "failureLogic_FTA_Gate" = None, Cause: "failureLogic_FTA_FaultTree" = None):
...
class failureLogic_ProbDist(BaseElement):
    ...
    def __init__(self, type: str, failureLogic_ProbDist: "failureLogic_Failure" = None, failureLogic_ProbDist22: set["failureLogic_ProbDistParam"] = None):
        self.type = type
...
class failureLogic_Markov_Transition(BaseElement):
    ...
    def __init__(self, transition: float, failureLogic_Markov_Transition36: set["State"] = None, failureLogic_Markov_Transition: "Markov_failureLogic_ProbDist" = None, failureLogic_Markov_Transition33: set["State"] = None):
...
class failureLogic_Failure(BaseElement):
    ...
    def __init__(self, originType: str, failureClass: str, failureRate: float, isCcf: bool, failureLogic_Failure: "failureLogic_ProbDist" = None, failureLogic_Failure4: "failureLogic_Failure" = None, failureLogic_Failure2: set["failureLogic_Failure"] = None, failureLogic_Failure9: "failureLogic_FailureModel" = None, failureLogic_Failure17: "failureLogic_MinimalCutSets" = None, failureLogic_Failure20: "failureLogic_MinimalCutset" = None):
