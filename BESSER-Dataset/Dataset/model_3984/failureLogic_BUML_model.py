...
# Classes
failureLogic_Failure = Class(name="failureLogic_Failure")
BaseElement = Class(name="BaseElement")
failureLogic_ProbDist = Class(name="failureLogic_ProbDist")
failureLogic_SecurityViolation = Class(name="failureLogic_SecurityViolation")
Failure = Class(name="Failure")
failureLogic_MinimalCutSets = Class(name="failureLogic_MinimalCutSets")
failureLogic_FailureLogicPackage = Class(name="failureLogic_FailureLogicPackage")
failureLogic_FailureModel = Class(name="failureLogic_FailureModel")
failureLogic_FTA_FaultTree = Class(name="failureLogic_FTA_FaultTree")
FailureModel = Class(name="FailureModel")
Cause = Class(name="Cause")
failureLogic_FTA_Cause = Class(name="failureLogic_FTA_Cause")
FTA_failureLogic_Failure = Class(name="FTA_failureLogic_Failure")
failureLogic_FTA_Gate = Class(name="failureLogic_FTA_Gate")
failureLogic_MinimalCutset = Class(name="failureLogic_MinimalCutset")
failureLogic_ProbDistParam = Class(name="failureLogic_ProbDistParam")
failureLogic_FMEA_FMEA = Class(name="failureLogic_FMEA_FMEA")
FMEAEntry = Class(name="FMEAEntry")
failureLogic_FMEA_FMEAEntry = Class(name="failureLogic_FMEA_FMEAEntry")
FMEA_failureLogic_Failure = Class(name="FMEA_failureLogic_Failure")
failureLogic_FMEA_FMEDAEntry = Class(name="failureLogic_FMEA_FMEDAEntry")
FMEA_failureLogic_ProbDist = Class(name="FMEA_failureLogic_ProbDist")
failureLogic_Markov_MarkovChain = Class(name="failureLogic_Markov_MarkovChain")
Transition = Class(name="Transition")
State = Class(name="State")
failureLogic_Markov_State = Class(name="failureLogic_Markov_State")
Markov_failureLogic_Failure = Class(name="Markov_failureLogic_Failure")
failureLogic_Markov_Transition = Class(name="failureLogic_Markov_Transition")
Markov_failureLogic_ProbDist = Class(name="Markov_failureLogic_ProbDist")
...
failureLogic_Failure.attributes={failureLogic_Failure_isCcf, failureLogic_Failure_failureRate, failureLogic_Failure_failureClass, failureLogic_Failure_originType}
...
domain_model = DomainModel(
    name="failureLogic",
    types={failureLogic_Failure, BaseElement, failureLogic_ProbDist, failureLogic_SecurityViolation, Failure, failureLogic_MinimalCutSets, failureLogic_FailureLogicPackage, failureLogic_FailureModel, failureLogic_FTA_FaultTree, FailureModel, Cause, failureLogic_FTA_Cause, FTA_failureLogic_Failure, failureLogic_FTA_Gate, failureLogic_MinimalCutset, failureLogic_ProbDistParam, failureLogic_FMEA_FMEA, FMEAEntry, failureLogic_FMEA_FMEAEntry, FMEA_failureLogic_Failure, failureLogic_FMEA_FMEDAEntry, FMEA_failureLogic_ProbDist, failureLogic_Markov_MarkovChain, Transition, State, failureLogic_Markov_State, Markov_failureLogic_Failure, failureLogic_Markov_Transition, Markov_failureLogic_ProbDist, FailureOriginType, CauseType, GateType, FMEAType},
    associations={failureModels0, failureProbDistribution1, ccfFailures3, minimalCutsets5, causes23, failure24, causes25, failures7, subModels11, cutsets13, failures15, failures18, parameters21, toStates35, entries38, effect39, mode40, diagnosisProbDistribution43, transitions27, states28, failState30, transitionProbDistribution31, fromStates32},
    generalizations={gen_failureLogic_Failure_BaseElement, gen_failureLogic_SecurityViolation_Failure, gen_failureLogic_FailureModel_BaseElement, gen_failureLogic_FTA_FaultTree_FailureModel, gen_failureLogic_FTA_Cause_BaseElement, gen_failureLogic_FTA_Gate_Cause, gen_failureLogic_MinimalCutSets_BaseElement, gen_failureLogic_MinimalCutset_BaseElement, gen_failureLogic_ProbDist_BaseElement, gen_failureLogic_ProbDistParam_BaseElement, gen_failureLogic_FMEA_FMEA_FailureModel, gen_failureLogic_FMEA_FMEAEntry_BaseElement, gen_failureLogic_FMEA_FMEDAEntry_FMEAEntry, gen_failureLogic_Markov_MarkovChain_FailureModel, gen_failureLogic_Markov_State_BaseElement, gen_failureLogic_Markov_Transition_BaseElement},
    metadata=None
)
