...
class mm_styles_Style(styles_AbstractStyle, StyleContainer):
    ...
    def __init__(self, stretchV: str, proportional: str, id: str, description: str, horizontalAlignment: str, verticalAlignment: str, angle: str, stretchH: str, styles: "styles_mm_StyleContainer" = None, mm_styles_Style: "styles_Font" = None):
...
class mm_pictograms_AdvancedAnchor(Anchor):
    ...
    def __init__(self, useAnchorLocationAsConnectionEndpoint: bool, Anchor16: "mm_pictograms_Connection" = None, Anchor28: "mm_pictograms_AnchorContainer" = None, Anchor: "mm_pictograms_Connection" = None):
...
class mm_algorithms_PlatformGraphicsAlgorithm(GraphicsAlgorithm):
    ...
    def __init__(self, id: str, GraphicsAlgorithm39: "mm_algorithms_GraphicsAlgorithm" = None, GraphicsAlgorithm: "mm_pictograms_PictogramElement" = None, GraphicsAlgorithm41: "mm_algorithms_GraphicsAlgorithm" = None, GraphicsAlgorithm25: "mm_pictograms_Anchor" = None):
        self.id = id
...
class mm_algorithms_Image(GraphicsAlgorithm):
    ...
    def __init__(self, id: str, stretchH: str, stretchV: str, proportional: str, GraphicsAlgorithm39: "mm_algorithms_GraphicsAlgorithm" = None, GraphicsAlgorithm: "mm_pictograms_PictogramElement" = None, GraphicsAlgorithm41: "mm_algorithms_GraphicsAlgorithm" = None, GraphicsAlgorithm25: "mm_pictograms_Anchor" = None):
        self.id = id
        self.stretchH = stretchH
        self.stretchV = stretchV
        self.proportional = proportional
...
class mm_algorithms_AbstractText(GraphicsAlgorithm):
    ...
    def __init__(self, horizontalAlignment: str, verticalAlignment: str, angle: str, value: str, mm_algorithms_AbstractText: "styles_Font" = None, GraphicsAlgorithm39: "mm_algorithms_GraphicsAlgorithm" = None, GraphicsAlgorithm: "mm_pictograms_PictogramElement" = None, GraphicsAlgorithm41: "mm_algorithms_GraphicsAlgorithm" = None, GraphicsAlgorithm25: "mm_pictograms_Anchor" = None):
        self.horizontalAlignment = horizontalAlignment
        self.verticalAlignment = verticalAlignment
        self.angle = angle
        self.value = value
...
class mm_algorithms_RoundedRectangle(GraphicsAlgorithm):
    ...
    def __init__(self, cornerHeight: int, cornerWidth: int, GraphicsAlgorithm39: "mm_algorithms_GraphicsAlgorithm" = None, GraphicsAlgorithm: "mm_pictograms_PictogramElement" = None, GraphicsAlgorithm41: "mm_algorithms_GraphicsAlgorithm" = None, GraphicsAlgorithm25: "mm_pictograms_Anchor" = None):
...
class mm_algorithms_GraphicsAlgorithm(styles_AbstractStyle, GraphicsAlgorithmContainer):
    ...
    def __init__(self, height: int, x: int, y: int, width: int, mm_algorithms_GraphicsAlgorithm: "styles_Style" = None, parentGraphicsAlgorithm: set["GraphicsAlgorithm"] = None, graphicsAlgorithmChildren: "GraphicsAlgorithm" = None, graphicsAlgorithm: "PictogramElement" = None):
        self.height = height
        self.x = x
        self.y = y
        self.width = width
...
class mm_Property:
    ...
    def __init__(self, value: str, key: str, mm_Property: "mm_PropertyContainer" = None):
        self.value = value
        self.key = key
