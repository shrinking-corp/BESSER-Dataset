...
umlsimp_Parameter = Class(name="umlsimp_Parameter")
umlsimp_TypedElement = Class(name="umlsimp_TypedElement")
umlsimp_Model = Class(name="umlsimp_Model")
umlsimp_ModelElement = Class(name="umlsimp_ModelElement", is_abstract=True)
umlsimp_DataType = Class(name="umlsimp_DataType")
ModelElement = Class(name="ModelElement")
umlsimp_Class = Class(name="umlsimp_Class")
umlsimp_Property = Class(name="umlsimp_Property")
umlsimp_Operation = Class(name="umlsimp_Operation")
...
operations1: BinaryAssociation = BinaryAssociation(
    name="operations1",
    ends={
        Property(name="class_2", type=umlsimp_Operation, multiplicity=Multiplicity(0, 9999), is_composite=True),
        Property(name="Operation", type=umlsimp_Class, multiplicity=Multiplicity(1, 1))
    }
)
class_3: BinaryAssociation = BinaryAssociation(
    name="class_3",
    ends={
...
properties0: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="class_", type=umlsimp_Property, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
domain_model = DomainModel(
    name="umlsimp",
    types={TypedElement, umlsimp_Parameter, umlsimp_TypedElement, umlsimp_Model, umlsimp_ModelElement, umlsimp_DataType, ModelElement, umlsimp_Class, umlsimp_Property, umlsimp_Operation, visType},
    associations={operations1, class_3, ownedParameter4, class_5, type7, modelElements8, properties0},
    generalizations={gen_umlsimp_Operation_TypedElement, gen_umlsimp_Property_TypedElement, gen_umlsimp_Parameter_TypedElement, gen_umlsimp_TypedElement_ModelElement, gen_umlsimp_DataType_ModelElement, gen_umlsimp_Class_ModelElement},
    metadata=None
)
