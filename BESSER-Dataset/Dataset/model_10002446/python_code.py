...
class ScoreBoardGUI:
    ...
    def __init__(self, playersList: str, mainMenuGUI12: "MainMenuGUI" = None, player2: set["Player_Interface"] = None):
...
class GameboardGUI:
    ...
    def __init__(self, rows: int, columns: int, piecesList: str, connect4GUI4: "Connect4GUI" = None, piece0: set["Piece"] = None):
        self.rows = rows
