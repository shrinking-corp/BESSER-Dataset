...
# Classes
GraphConstraint_Graph = Class(name="GraphConstraint_Graph")
GraphConstraint_Edge = Class(name="GraphConstraint_Edge")
GraphConstraint_EClass = Class(name="GraphConstraint_EClass")
GraphConstraint_EReference = Class(name="GraphConstraint_EReference")
GraphConstraint_EAttribute = Class(name="GraphConstraint_EAttribute")
GraphConstraint_Mapping = Class(name="GraphConstraint_Mapping")
GraphConstraint_ElementMapping = Class(name="GraphConstraint_ElementMapping")
GraphConstraint_Node = Class(name="GraphConstraint_Node")
GraphConstraint_GraphElement = Class(name="GraphConstraint_GraphElement", is_abstract=True)
GraphConstraint_NestedGraphConstraint = Class(name="GraphConstraint_NestedGraphConstraint")
GraphConstraint_EPackage = Class(name="GraphConstraint_EPackage")
GraphConstraint_NestedGraphCondition = Class(name="GraphConstraint_NestedGraphCondition", is_abstract=True)
GraphElement = Class(name="GraphElement")
GraphConstraint_Attribute = Class(name="GraphConstraint_Attribute")
GraphConstraint_Variable = Class(name="GraphConstraint_Variable")
GraphConstraint_QuantifiedGraphCondition = Class(name="GraphConstraint_QuantifiedGraphCondition")
NestedGraphCondition = Class(name="NestedGraphCondition")
GraphConstraint_True = Class(name="GraphConstraint_True")
GraphConstraint_Formula = Class(name="GraphConstraint_Formula")
GraphConstraint_EDataType = Class(name="GraphConstraint_EDataType")
...
from_22: BinaryAssociation = BinaryAssociation(
    name="from_22",
    ends={
...
import_3: BinaryAssociation = BinaryAssociation(
    name="import_3",
    ends={
...
domain_model = DomainModel(
    ...
    types={GraphConstraint_Graph, GraphConstraint_Edge, GraphConstraint_EClass, GraphConstraint_EReference, GraphConstraint_EAttribute, GraphConstraint_Mapping, GraphConstraint_ElementMapping, GraphConstraint_Node, GraphConstraint_GraphElement, GraphConstraint_NestedGraphConstraint, GraphConstraint_EPackage, GraphConstraint_NestedGraphCondition, GraphElement, GraphConstraint_Attribute, GraphConstraint_Variable, GraphConstraint_QuantifiedGraphCondition, NestedGraphCondition, GraphConstraint_True, GraphConstraint_Formula, GraphConstraint_EDataType, Quantifier, Operator},
    associations={type10, src12, tgt15, type18, type20, from_22, to24, mappings27, origin29, edges0, nodes1, import_3, condition4, emptyDomain5, attributes8, args47, image31, codomain34, restriction36, restrictionMapping39, codomainMapping42, nested45, type49, formula50, qgc51, gc52, domain53, vars55},
    generalizations={gen_GraphConstraint_Edge_GraphElement, gen_GraphConstraint_Attribute_GraphElement, gen_GraphConstraint_Node_GraphElement, gen_GraphConstraint_QuantifiedGraphCondition_NestedGraphCondition, gen_GraphConstraint_True_NestedGraphCondition, gen_GraphConstraint_Formula_NestedGraphCondition},
    metadata=None
)
