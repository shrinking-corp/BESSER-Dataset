...
def test_hyp_graphconstraint_graph_is_not_abstract():
    assert not inspect.isabstract(GraphConstraint_Graph)


def test_hyp_graphconstraint_graph_constructor_exists():
    assert callable(GraphConstraint_Graph.__init__)


def test_hyp_graphconstraint_graph_constructor_args():
    sig = inspect.signature(GraphConstraint_Graph.__init__)
    params = list(sig.parameters.keys())



def test_hyp_graphconstraint_edatatype_is_not_abstract():
    assert not inspect.isabstract(GraphConstraint_EDataType)


def test_hyp_graphconstraint_edatatype_constructor_exists():
    assert callable(GraphConstraint_EDataType.__init__)


def test_hyp_graphconstraint_edatatype_constructor_args():
    sig = inspect.signature(GraphConstraint_EDataType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_nestedgraphcondition_is_not_abstract():
    assert not inspect.isabstract(NestedGraphCondition)


def test_hyp_nestedgraphcondition_constructor_exists():
    assert callable(NestedGraphCondition.__init__)


def test_hyp_nestedgraphcondition_constructor_args():
    sig = inspect.signature(NestedGraphCondition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_graphconstraint_formula_is_not_abstract():
    assert not inspect.isabstract(GraphConstraint_Formula)


def test_hyp_graphconstraint_formula_constructor_exists():
    assert callable(GraphConstraint_Formula.__init__)


def test_hyp_graphconstraint_formula_constructor_args():
...
def test_hyp_graphconstraint_true_is_not_abstract():
    assert not inspect.isabstract(GraphConstraint_True)


def test_hyp_graphconstraint_true_constructor_exists():
    assert callable(GraphConstraint_True.__init__)


def test_hyp_graphconstraint_true_constructor_args():
    sig = inspect.signature(GraphConstraint_True.__init__)
    params = list(sig.parameters.keys())



def test_hyp_graphconstraint_quantifiedgraphcondition_is_not_abstract():
    assert not inspect.isabstract(GraphConstraint_QuantifiedGraphCondition)


def test_hyp_graphconstraint_quantifiedgraphcondition_constructor_exists():
    assert callable(GraphConstraint_QuantifiedGraphCondition.__init__)


def test_hyp_graphconstraint_quantifiedgraphcondition_constructor_args():
...
def test_hyp_graphconstraint_variable_is_not_abstract():
    assert not inspect.isabstract(GraphConstraint_Variable)


def test_hyp_graphconstraint_variable_constructor_exists():
    assert callable(GraphConstraint_Variable.__init__)


def test_hyp_graphconstraint_variable_constructor_args():
...
def test_hyp_graphconstraint_attribute_is_not_abstract():
    assert not inspect.isabstract(GraphConstraint_Attribute)


def test_hyp_graphconstraint_attribute_constructor_exists():
    assert callable(GraphConstraint_Attribute.__init__)


def test_hyp_graphconstraint_attribute_constructor_args():
...
def test_hyp_graphconstraint_nestedgraphcondition_is_not_abstract():
    assert not inspect.isabstract(GraphConstraint_NestedGraphCondition)


def test_hyp_graphconstraint_nestedgraphcondition_constructor_exists():
    assert callable(GraphConstraint_NestedGraphCondition.__init__)


def test_hyp_graphconstraint_nestedgraphcondition_constructor_args():
    sig = inspect.signature(GraphConstraint_NestedGraphCondition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_graphconstraint_epackage_is_not_abstract():
    assert not inspect.isabstract(GraphConstraint_EPackage)


def test_hyp_graphconstraint_epackage_constructor_exists():
    assert callable(GraphConstraint_EPackage.__init__)


def test_hyp_graphconstraint_epackage_constructor_args():
    sig = inspect.signature(GraphConstraint_EPackage.__init__)
    params = list(sig.parameters.keys())



def test_hyp_graphconstraint_nestedgraphconstraint_is_not_abstract():
    assert not inspect.isabstract(GraphConstraint_NestedGraphConstraint)


def test_hyp_graphconstraint_nestedgraphconstraint_constructor_exists():
    assert callable(GraphConstraint_NestedGraphConstraint.__init__)


def test_hyp_graphconstraint_nestedgraphconstraint_constructor_args():
...
def test_hyp_graphconstraint_graphelement_is_not_abstract():
    assert not inspect.isabstract(GraphConstraint_GraphElement)


def test_hyp_graphconstraint_graphelement_constructor_exists():
    assert callable(GraphConstraint_GraphElement.__init__)


def test_hyp_graphconstraint_graphelement_constructor_args():
...
def test_hyp_graphconstraint_node_is_not_abstract():
    assert not inspect.isabstract(GraphConstraint_Node)


def test_hyp_graphconstraint_node_constructor_exists():
    assert callable(GraphConstraint_Node.__init__)


def test_hyp_graphconstraint_node_constructor_args():
    sig = inspect.signature(GraphConstraint_Node.__init__)
    params = list(sig.parameters.keys())



def test_hyp_graphconstraint_elementmapping_is_not_abstract():
    assert not inspect.isabstract(GraphConstraint_ElementMapping)


def test_hyp_graphconstraint_elementmapping_constructor_exists():
    assert callable(GraphConstraint_ElementMapping.__init__)


def test_hyp_graphconstraint_elementmapping_constructor_args():
    sig = inspect.signature(GraphConstraint_ElementMapping.__init__)
    params = list(sig.parameters.keys())



def test_hyp_graphconstraint_mapping_is_not_abstract():
    assert not inspect.isabstract(GraphConstraint_Mapping)


def test_hyp_graphconstraint_mapping_constructor_exists():
    assert callable(GraphConstraint_Mapping.__init__)


def test_hyp_graphconstraint_mapping_constructor_args():
    sig = inspect.signature(GraphConstraint_Mapping.__init__)
    params = list(sig.parameters.keys())



def test_hyp_graphconstraint_eattribute_is_not_abstract():
    assert not inspect.isabstract(GraphConstraint_EAttribute)


def test_hyp_graphconstraint_eattribute_constructor_exists():
    assert callable(GraphConstraint_EAttribute.__init__)


def test_hyp_graphconstraint_eattribute_constructor_args():
    sig = inspect.signature(GraphConstraint_EAttribute.__init__)
    params = list(sig.parameters.keys())



def test_hyp_graphconstraint_ereference_is_not_abstract():
    assert not inspect.isabstract(GraphConstraint_EReference)


def test_hyp_graphconstraint_ereference_constructor_exists():
    assert callable(GraphConstraint_EReference.__init__)


def test_hyp_graphconstraint_ereference_constructor_args():
    sig = inspect.signature(GraphConstraint_EReference.__init__)
    params = list(sig.parameters.keys())



def test_hyp_graphconstraint_eclass_is_not_abstract():
    assert not inspect.isabstract(GraphConstraint_EClass)


def test_hyp_graphconstraint_eclass_constructor_exists():
    assert callable(GraphConstraint_EClass.__init__)


def test_hyp_graphconstraint_eclass_constructor_args():
    sig = inspect.signature(GraphConstraint_EClass.__init__)
    params = list(sig.parameters.keys())



def test_hyp_graphconstraint_edge_is_not_abstract():
    assert not inspect.isabstract(GraphConstraint_Edge)


def test_hyp_graphconstraint_edge_constructor_exists():
    assert callable(GraphConstraint_Edge.__init__)


def test_hyp_graphconstraint_edge_constructor_args():
...
def test_hyp_graphconstraint_formula_op_setter(instance):
...
def test_hyp_graphconstraint_quantifiedgraphcondition_quantifier_setter(instance):
...
def test_hyp_graphconstraint_variable_name_setter(instance):
...
def test_hyp_graphconstraint_attribute_op_setter(instance):
    original = instance.op
    instance.op = original
    assert instance.op == original
...
@given(instance=GraphConstraint_Attribute_strategy)
def test_hyp_graphconstraint_attribute_value_setter(instance):
...
def test_hyp_graphconstraint_nestedgraphconstraint_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_graphconstraint_graphelement_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
