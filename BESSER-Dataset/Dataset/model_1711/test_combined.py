...
def test_hyp_library_author_birthdate_setter(instance):
...
def test_library_Author_birthdate_value_roundtrip():
    instance = library_Author(birthdate=date(2024, 1, 1), name="sample_text", surname="sample_text")
...
def test_assoc_authors0_link_reassign_clear():
    a = library_Book(pages=7, title="sample_text")
    b1 = library_Author(birthdate=date(2024, 1, 1), name="sample_text", surname="sample_text")
    b2 = library_Author(birthdate=date(2025, 6, 15), name="sample_text_2", surname="sample_text_2")
...
def test_assoc_authors3_link_reassign_clear():
    a = library_Author(birthdate=date(2024, 1, 1), name="sample_text", surname="sample_text")
    b1 = library_Library()
    b2 = library_Library()
...
library_Author_strategy = st.builds(library_Author, birthdate=st.dates(), name=safe_text, surname=safe_text)
@given(instance=library_Author_strategy)
