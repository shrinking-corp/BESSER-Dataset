...
class Attendance:
    ...
    def __init__(self, attendanceID: Admin, checkInTime: str, checkOutTime: Class, profile9: "Profile" = None):
    ...
    @checkOutTime.setter
    def checkOutTime(self, checkOutTime: Class):
    ...
    @attendanceID.setter
    def attendanceID(self, attendanceID: Admin):
