...
Profile.attributes={Profile_user_Name, Profile_f_Name, Profile_l_Name, Profile_password}
...
Normal_user.attributes={Normal_user_userID, Normal_user_password, Normal_user_userName}
...
Calender_Event.attributes={Calender_Event_eventType, Calender_Event_date, Calender_Event_category, Calender_Event_participantAmount, Calender_Event_description, Calender_Event_admin, Calender_Event_volunteer, Calender_Event_time, Calender_Event_nomarlUser}
...
Attendance_attendanceID: Property = Property(name="attendanceID", type=Admin)
Attendance_checkInTime: Property = Property(name="checkInTime", type=StringType)
Attendance_checkOutTime: Property = Property(name="checkOutTime", type=Class_)
...
Payment.attributes={Payment_issuerName, Payment_cardType, Payment_amount, Payment_cardNumber, Payment_expiryDate}
...
Mail.attributes={Mail_sendBy, Mail_subject, Mail_sendTo, Mail_emailID}
...
domain_model = DomainModel(
    name="_6a31994c_5aa7_4c14_a21d_28074b8a5eff",
    types={Profile, SuperAdmin, void, Normal_user, Admin, Volunteer, Calender_Event, Login, Attendance, Logout, Payment, Mail, Class_},
