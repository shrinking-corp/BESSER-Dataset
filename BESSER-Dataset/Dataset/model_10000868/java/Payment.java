...
public class Payment  {
    ...
    public Payment(
        String issuerName,        String expiryDate,        int amount,        String cardType,        int cardNumber    ) {
    ...
    public Payment(
        String issuerName,        String expiryDate,        int amount,        String cardType,        int cardNumber        ArrayList<Admin> admins,        ArrayList<SuperAdmin> superadmins,        ArrayList<Normal_user> normal_users,        ArrayList<Volunteer> volunteers    ) {
        this.issuerName = issuerName;
        this.expiryDate = expiryDate;
        this.amount = amount;
        this.cardType = cardType;
