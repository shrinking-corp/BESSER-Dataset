...
class Library_Book:
    ...
    def __init__(self, pages: int, category: str, blurb: str, title: str, books: "Library_Writer" = None, books2: "Library_Library" = None, Book: "Library_Library" = None, Book8: "Library_Writer" = None):
        self.pages = pages
...
class Library_Library:
    ...
    def __init__(self, name: str, id: int, Library: "Library_Book" = None, library: set["Library_Book"] = None, Library10: "Library_Writer" = None, library5: set["Library_Writer"] = None):
        self.name = name
        self.id = id
...
class Library_Writer:
    ...
    def __init__(self, id: int, name: str, Writer: "Library_Book" = None, writer: set["Library_Book"] = None, writers: "Library_Library" = None, Writer6: "Library_Library" = None):
        self.id = id
        self.name = name
        self.Writer = Writer
