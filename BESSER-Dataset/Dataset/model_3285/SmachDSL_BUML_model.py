...
domain_model = DomainModel(
    name="smachDSL",
    types={smachDSL_PrimitivePackage, smachDSL_Transition, smachDSL_StateMachine, smachDSL_Test, smachDSL_ActionClient, smachDSL_ServiceClient, smachDSL_ActionState},
    associations={clientname7, transitions10, state12, statemachines0, actionclients1, serviceclients3, actionsstates5},
    generalizations={},
    metadata=None
)
