...
class smachDSL_ActionState:
    ...
    def __init__(self, name: str, smachDSL_ActionState8: "smachDSL_ActionClient" = None, smachDSL_ActionState11: set["smachDSL_Transition"] = None, smachDSL_ActionState14: "smachDSL_Transition" = None, smachDSL_ActionState: "smachDSL_StateMachine" = None):
        self.name = name
...
class smachDSL_ActionClient:
    ...
    def __init__(self, name: str, actionname: str, actiontype: str, smachDSL_ActionClient9: "smachDSL_ActionState" = None, smachDSL_ActionClient: "smachDSL_StateMachine" = None):
        self.name = name
