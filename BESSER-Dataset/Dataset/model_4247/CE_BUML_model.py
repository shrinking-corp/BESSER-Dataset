...
# Classes
ce_Employee = Class(name="ce_Employee")
ce_Company = Class(name="ce_Company")
...
ce_Employee.attributes={ce_Employee_name, ce_Employee_address, ce_Employee_department}
