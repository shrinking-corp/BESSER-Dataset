...
def test_hyp_ce_company_is_not_abstract():
    assert not inspect.isabstract(ce_Company)


def test_hyp_ce_company_constructor_exists():
    assert callable(ce_Company.__init__)


def test_hyp_ce_company_constructor_args():
...
def test_hyp_ce_employee_is_not_abstract():
    assert not inspect.isabstract(ce_Employee)


def test_hyp_ce_employee_constructor_exists():
    assert callable(ce_Employee.__init__)


def test_hyp_ce_employee_constructor_args():
...
def test_hyp_ce_company_name_setter(instance):
...
def test_hyp_ce_employee_department_setter(instance):
...
@given(instance=ce_Employee_strategy)
def test_hyp_ce_employee_address_setter(instance):
...
@given(instance=ce_Employee_strategy)
def test_hyp_ce_employee_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
