...
HouseHolds.attributes={HouseHolds_TimeID, HouseHolds_Coffee, HouseHolds_Alarm, HouseHolds_DishWasher, HouseHolds_WashingMachine}
...
domain_model = DomainModel(
    ...
    associations={Home_Security_System_Alert, Sensor_System, System_HouseHolds, HomeTheatre_System, Home_Security_System_System, TV_Entertainment, Speakers_Entertainment, HomeTheatre_Entertainment, Sensor_Door, Door_Camera, HomeTheatre_TV, HomeTheatre_Speakers, HouseHolds_Start_Of_Day, HouseHolds_End_Of_Day, MicroPhone_System},
    generalizations={},
    metadata=None
)
