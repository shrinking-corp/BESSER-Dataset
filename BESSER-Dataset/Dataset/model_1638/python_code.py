...
class cpntools_String(SimpleColorSet):
    ...
    def __init__(self, with_: str, and_: str):
        self.with_ = with_
        self.and_ = and_
...
class cpntools_Arc(DiagramElement):
    ...
    def __init__(self, orientation: str, currentcyckle: str, order: int, headsize: float, Arc: "cpntools_Page" = None, Arc32: "cpntools_Place" = None, arcs: "cpntools_Place" = None, arcs53: "cpntools_Trans" = None, cpntools_Arc: "cpntools_Annot" = None, arcs57: "cpntools_Page" = None, Arc63: "cpntools_Trans" = None):
...
class cpntools_Trans(DiagramElement):
    ...
    def __init__(self, height: int, width: int, explicit: bool, text: str, Trans: "cpntools_Page" = None, Trans54: "cpntools_Arc" = None, cpntools_Trans: "cpntools_TransCond" = None, transs: "cpntools_Page" = None, trans: set["cpntools_Arc"] = None, cpntools_Trans65: "cpntools_TransPriority" = None, cpntools_Trans67: "cpntools_TransTime" = None):
        self.height = height
        self.width = width
...
class cpntools_Place(DiagramElement):
    ...
    def __init__(self, height: int, width: int, text: str, Place: "cpntools_Page" = None, cpntools_Place: "cpntools_ColorSet" = None, cpntools_Place23: "cpntools_Initmark" = None, cpntools_Place25: "cpntools_Port" = None, places: "cpntools_Fusion" = None, places29: "cpntools_Page" = None, place: set["cpntools_Arc"] = None, Place38: "cpntools_Fusion" = None, Place51: "cpntools_Arc" = None):
        self.height = height
        self.width = width
        self.text = text
        self.Place = Place
...
class cpntools_Group:
    ...
    def __init__(self, name: str, group: set["cpntools_DiagramElement"] = None, Group20: "cpntools_DiagramElement" = None, group18: "cpntools_Page" = None, Group: "cpntools_Page" = None):
        self.name = name
...
class cpntools_Page:
    ...
    def __init__(self, name: str, page: set["cpntools_Group"] = None, page7: set["cpntools_Place"] = None, page9: set["cpntools_Auxiliary"] = None, page11: set["cpntools_Trans"] = None, page13: set["cpntools_Arc"] = None, pages: "cpntools_Binder" = None, Page: "cpntools_Group" = None, Page30: "cpntools_Place" = None, Page41: "cpntools_Auxiliary" = None, Page58: "cpntools_Arc" = None, Page61: "cpntools_Trans" = None, Page73: "cpntools_Binder" = None):
        self.name = name
...
class cpntools_Binder:
    ...
    def __init__(self, posx: int, width: int, height: int, posy: int, Binder15: "cpntools_Page" = None, Binder: "cpntools_Cpnet" = None, binder: "cpntools_Cpnet" = None, binder72: set["cpntools_Page"] = None):
        self.posx = posx
        self.width = width
        self.height = height
        self.posy = posy
...
class cpntools_Globbox:
    ...
    def __init__(self, name: str, Globbox34: "cpntools_Declaration" = None, Globbox: "cpntools_Cpnet" = None, globbox: "cpntools_Cpnet" = None, globbox45: set["cpntools_Declaration"] = None):
        self.name = name
