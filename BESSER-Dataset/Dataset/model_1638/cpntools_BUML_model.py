...
# Classes
cpntools_Cpnet = Class(name="cpntools_Cpnet")
cpntools_Fusion = Class(name="cpntools_Fusion")
cpntools_Globbox = Class(name="cpntools_Globbox")
cpntools_Binder = Class(name="cpntools_Binder")
cpntools_Page = Class(name="cpntools_Page")
cpntools_Group = Class(name="cpntools_Group")
cpntools_Place = Class(name="cpntools_Place")
cpntools_Auxiliary = Class(name="cpntools_Auxiliary", is_abstract=True)
cpntools_Trans = Class(name="cpntools_Trans")
cpntools_Arc = Class(name="cpntools_Arc")
cpntools_DiagramElement = Class(name="cpntools_DiagramElement", is_abstract=True)
cpntools_Block = Class(name="cpntools_Block")
DiagramElement = Class(name="DiagramElement")
cpntools_ColorSet = Class(name="cpntools_ColorSet", is_abstract=True)
cpntools_Initmark = Class(name="cpntools_Initmark")
cpntools_Port = Class(name="cpntools_Port")
Declaration = Class(name="Declaration")
cpntools_Declaration = Class(name="cpntools_Declaration", is_abstract=True)
cpntools_Var = Class(name="cpntools_Var")
cpntools_Globref = Class(name="cpntools_Globref")
cpntools_Ml = Class(name="cpntools_Ml")
cpntools_AuxText = Class(name="cpntools_AuxText")
Auxiliary = Class(name="Auxiliary")
cpntools_CompoundColorSet = Class(name="cpntools_CompoundColorSet", is_abstract=True)
cpntools_Unit = Class(name="cpntools_Unit")
SimpleColorSet = Class(name="SimpleColorSet")
cpntools_Annot = Class(name="cpntools_Annot")
cpntools_TransCond = Class(name="cpntools_TransCond")
cpntools_TransPriority = Class(name="cpntools_TransPriority")
cpntools_TransTime = Class(name="cpntools_TransTime")
cpntools_AuxEllipse = Class(name="cpntools_AuxEllipse")
cpntools_AuxBox = Class(name="cpntools_AuxBox")
cpntools_SimpleColorSet = Class(name="cpntools_SimpleColorSet", is_abstract=True)
ColorSet = Class(name="ColorSet")
cpntools_Boolean = Class(name="cpntools_Boolean")
cpntools_Integer = Class(name="cpntools_Integer")
cpntools_LargeInteger = Class(name="cpntools_LargeInteger")
cpntools_Real = Class(name="cpntools_Real")
cpntools_Time = Class(name="cpntools_Time")
cpntools_String = Class(name="cpntools_String")
cpntools_Enumerated = Class(name="cpntools_Enumerated")
cpntools_Index = Class(name="cpntools_Index")
cpntools_Product = Class(name="cpntools_Product")
CompoundColorSet = Class(name="CompoundColorSet")
cpntools_Record = Class(name="cpntools_Record")
cpntools_List = Class(name="cpntools_List")
cpntools_Union = Class(name="cpntools_Union")
cpntools_Subset = Class(name="cpntools_Subset")
cpntools_Alias = Class(name="cpntools_Alias")
...
cpntools_Binder.attributes={cpntools_Binder_width, cpntools_Binder_height, cpntools_Binder_posy, cpntools_Binder_posx}

# cpntools_Page class attributes and methods
cpntools_Page_name: Property = Property(name="name", type=StringType)
cpntools_Page_m_layout: Method = Method(name="layout", parameters={Parameter(name='cpntools_height', type=StringType), Parameter(name='cpntools_width', type=StringType), Parameter(name='cpntools_steps', type=StringType)})
...
cpntools_Place.attributes={cpntools_Place_text, cpntools_Place_width, cpntools_Place_height}
...
cpntools_Trans.attributes={cpntools_Trans_explicit, cpntools_Trans_height, cpntools_Trans_width, cpntools_Trans_text}
...
cpntools_DiagramElement.attributes={cpntools_DiagramElement_fillPattern, cpntools_DiagramElement_lineType, cpntools_DiagramElement_posy, cpntools_DiagramElement_fillColour, cpntools_DiagramElement_fillFilled, cpntools_DiagramElement_lineThick, cpntools_DiagramElement_posx, cpntools_DiagramElement_lineColour}
...
cpntools_ColorSet.attributes={cpntools_ColorSet_declare, cpntools_ColorSet_colorSetType, cpntools_ColorSet_idname, cpntools_ColorSet_timed}
...
cpntools_Unit_with_: Property = Property(name="with_", type=StringType)
cpntools_Unit.attributes={cpntools_Unit_with_}
...
cpntools_Boolean_with_: Property = Property(name="with_", type=StringType)
cpntools_Boolean.attributes={cpntools_Boolean_with_}

# cpntools_Integer class attributes and methods
cpntools_Integer_with_: Property = Property(name="with_", type=StringType)
cpntools_Integer.attributes={cpntools_Integer_with_}

# cpntools_LargeInteger class attributes and methods
cpntools_LargeInteger_with_: Property = Property(name="with_", type=StringType)
cpntools_LargeInteger.attributes={cpntools_LargeInteger_with_}

# cpntools_Real class attributes and methods
cpntools_Real_with_: Property = Property(name="with_", type=StringType)
cpntools_Real.attributes={cpntools_Real_with_}

# cpntools_Time class attributes and methods

# cpntools_String class attributes and methods
cpntools_String_with_: Property = Property(name="with_", type=StringType)
cpntools_String_and_: Property = Property(name="and_", type=StringType)
cpntools_String.attributes={cpntools_String_and_, cpntools_String_with_}

# cpntools_Enumerated class attributes and methods
cpntools_Enumerated_with_: Property = Property(name="with_", type=StringType)
cpntools_Enumerated.attributes={cpntools_Enumerated_with_}

# cpntools_Index class attributes and methods
cpntools_Index_with_: Property = Property(name="with_", type=StringType)
cpntools_Index.attributes={cpntools_Index_with_}
...
domain_model = DomainModel(
    name="cpntools",
    types={cpntools_Cpnet, cpntools_Fusion, cpntools_Globbox, cpntools_Binder, cpntools_Page, cpntools_Group, cpntools_Place, cpntools_Auxiliary, cpntools_Trans, cpntools_Arc, cpntools_DiagramElement, cpntools_Block, DiagramElement, cpntools_ColorSet, cpntools_Initmark, cpntools_Port, Declaration, cpntools_Declaration, cpntools_Var, cpntools_Globref, cpntools_Ml, cpntools_AuxText, Auxiliary, cpntools_CompoundColorSet, cpntools_Unit, SimpleColorSet, cpntools_Annot, cpntools_TransCond, cpntools_TransPriority, cpntools_TransTime, cpntools_AuxEllipse, cpntools_AuxBox, cpntools_SimpleColorSet, ColorSet, cpntools_Boolean, cpntools_Integer, cpntools_LargeInteger, cpntools_Real, cpntools_Time, cpntools_String, cpntools_Enumerated, cpntools_Index, cpntools_Product, CompoundColorSet, cpntools_Record, cpntools_List, cpntools_Union, cpntools_Subset, cpntools_Alias, Orientation, Colour16},
    associations={page17, fusions0, globbox1, binder3, group5, places6, auxiliarys8, transs10, arcs12, binder14, groupElms16, globbox33, block35, group19, type21, initmark22, port24, fusion26, page28, arcs31, places37, cpnet39, page40, cpnet42, declarations44, type46, declarations48, place50, simpleColors68, trans52, annot55, page56, cond59, page60, arcs62, priority64, time66, cpnet69, pages71},
    generalizations={gen_cpntools_Initmark_DiagramElement, gen_cpntools_Port_DiagramElement, gen_cpntools_Place_DiagramElement, gen_cpntools_ColorSet_Declaration, gen_cpntools_Auxiliary_DiagramElement, gen_cpntools_Var_Declaration, gen_cpntools_Globref_Declaration, gen_cpntools_Ml_Declaration, gen_cpntools_Block_Declaration, gen_cpntools_AuxText_Auxiliary, gen_cpntools_Arc_DiagramElement, gen_cpntools_CompoundColorSet_ColorSet, gen_cpntools_Unit_SimpleColorSet, gen_cpntools_Trans_DiagramElement, gen_cpntools_TransCond_DiagramElement, gen_cpntools_TransPriority_DiagramElement, gen_cpntools_TransTime_DiagramElement, gen_cpntools_Annot_DiagramElement, gen_cpntools_AuxEllipse_Auxiliary, gen_cpntools_AuxBox_Auxiliary, gen_cpntools_SimpleColorSet_ColorSet, gen_cpntools_Boolean_SimpleColorSet, gen_cpntools_Integer_SimpleColorSet, gen_cpntools_LargeInteger_SimpleColorSet, gen_cpntools_Real_SimpleColorSet, gen_cpntools_Time_SimpleColorSet, gen_cpntools_String_SimpleColorSet, gen_cpntools_Enumerated_SimpleColorSet, gen_cpntools_Index_SimpleColorSet, gen_cpntools_Product_CompoundColorSet, gen_cpntools_Record_CompoundColorSet, gen_cpntools_List_CompoundColorSet, gen_cpntools_Union_CompoundColorSet, gen_cpntools_Subset_CompoundColorSet, gen_cpntools_Alias_CompoundColorSet},
    metadata=None
)
