...
domain_model = DomainModel(
    name="_04824e44_d387_4d91_a75e_aebd84129f96",
    types={User, Profile, Post, Group, public, secret, Message, Friend, Hashtag, Page, Registration, Login},
    associations={User_Hashtag, User_Pages, User_Myprofile, User_Post, User_Login, User_Group, User_Registeration, User_Message, User_Friends},
    generalizations={},
    metadata=None
)
