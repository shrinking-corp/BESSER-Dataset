...
# Classes
scmodel_StateMachine = Class(name="scmodel_StateMachine")
scmodel_AbstractState = Class(name="scmodel_AbstractState", is_abstract=True)
scmodel_Transition = Class(name="scmodel_Transition")
scmodel_State = Class(name="scmodel_State")
AbstractState = Class(name="AbstractState")
scmodel_FinalState = Class(name="scmodel_FinalState")
State = Class(name="State")
scmodel_CompositeState = Class(name="scmodel_CompositeState")
scmodel_PseudoState = Class(name="scmodel_PseudoState")
scmodel_History = Class(name="scmodel_History")
...
scmodel_StateMachine.attributes={scmodel_StateMachine_nextID, scmodel_StateMachine_uuid, scmodel_StateMachine_priority, scmodel_StateMachine_package, scmodel_StateMachine_agentType, scmodel_StateMachine_className, scmodel_StateMachine_language, scmodel_StateMachine_id}
...
scmodel_AbstractState.attributes={scmodel_AbstractState_uuid, scmodel_AbstractState_onExitImports, scmodel_AbstractState_id, scmodel_AbstractState_onEnterImports, scmodel_AbstractState_onExit, scmodel_AbstractState_onEnter, scmodel_AbstractState_language}
...
scmodel_Transition.attributes={scmodel_Transition_onTransition, scmodel_Transition_onTransitionImports, scmodel_Transition_triggerType, scmodel_Transition_messageCheckerClass, scmodel_Transition_outOfBranch, scmodel_Transition_triggerExpRateCodeImports, scmodel_Transition_triggerTime, scmodel_Transition_triggerTimedCodeImports, scmodel_Transition_messageCheckerCodeImports, scmodel_Transition_triggerTimedCode, scmodel_Transition_triggerExpRateCode, scmodel_Transition_defaultTransition, scmodel_Transition_triggerConditionCode, scmodel_Transition_messageCheckerType, scmodel_Transition_messageCheckerCode, scmodel_Transition_priority, scmodel_Transition_triggerConditionCodeImports, scmodel_Transition_messageCheckerConditionLanguage, scmodel_Transition_guard, scmodel_Transition_triggerProbCodeImports, scmodel_Transition_triggerCodeLanguage, scmodel_Transition_triggerProbCode, scmodel_Transition_selfTransition, scmodel_Transition_guardImports, scmodel_Transition_id, scmodel_Transition_uuid}
...
domain_model = DomainModel(
    name="scmodel",
    types={scmodel_StateMachine, scmodel_AbstractState, scmodel_Transition, scmodel_State, AbstractState, scmodel_FinalState, State, scmodel_CompositeState, scmodel_PseudoState, scmodel_History, PseudoStateTypes, TriggerTypes, MessageCheckerTypes, LanguageTypes},
    associations={states0, transitions1, from_3, to6, children9},
