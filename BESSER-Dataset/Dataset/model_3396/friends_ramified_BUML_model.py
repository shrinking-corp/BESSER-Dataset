...
# Classes
ramRoot_MTpre__Person = Class(name="ramRoot_MTpre__Person")
MTpre__Element = Class(name="MTpre__Element")
ramRoot_MTpre__Classroom = Class(name="ramRoot_MTpre__Classroom")
...
ramRoot_MTpos__Person = Class(name="ramRoot_MTpos__Person")
MTpos__Element = Class(name="MTpos__Element")
ramRoot_MTpos__Classroom = Class(name="ramRoot_MTpos__Classroom")
ramRoot_MTpos__Man = Class(name="ramRoot_MTpos__Man")
MTpos__Person = Class(name="MTpos__Person")
ramRoot_MTpos__Woman = Class(name="ramRoot_MTpos__Woman")
ramRoot_MTpre__Man = Class(name="ramRoot_MTpre__Man")
MTpre__Person = Class(name="MTpre__Person")
ramRoot_MTpre__Woman = Class(name="ramRoot_MTpre__Woman")
...
domain_model = DomainModel(
    name="ramRoot",
    types={ramRoot_MTpre__Person, MTpre__Element, ramRoot_MTpre__Classroom, ramRoot_MT__Element, ramRoot_MTpos__Element, MT__Element, ramRoot_MTpre__Element, ramRoot_GenericNode, ramRoot_MTpos__Person, MTpos__Element, ramRoot_MTpos__Classroom, ramRoot_MTpos__Man, MTpos__Person, ramRoot_MTpos__Woman, ramRoot_MTpre__Man, MTpre__Person, ramRoot_MTpre__Woman},
    associations={person5, teacher_of8, GenericLink0, teacher_of1, friend_with3, friend_with10, person12},
    generalizations={gen_ramRoot_MTpre__Person_MTpre__Element, gen_ramRoot_MTpos__Element_MT__Element, gen_ramRoot_MTpre__Element_MT__Element, gen_ramRoot_GenericNode_MT__Element, gen_ramRoot_MTpos__Person_MTpos__Element, gen_ramRoot_MTpos__Man_MTpos__Person, gen_ramRoot_MTpos__Woman_MTpos__Person, gen_ramRoot_MTpos__Classroom_MTpos__Element, gen_ramRoot_MTpre__Man_MTpre__Person, gen_ramRoot_MTpre__Woman_MTpre__Person, gen_ramRoot_MTpre__Classroom_MTpre__Element},
    metadata=None
)
