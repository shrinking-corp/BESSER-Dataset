...
def test_hyp_fsm_runtimeconcept2_is_not_abstract():
    assert not inspect.isabstract(fsm_RuntimeConcept2)


def test_hyp_fsm_runtimeconcept2_constructor_exists():
    assert callable(fsm_RuntimeConcept2.__init__)


def test_hyp_fsm_runtimeconcept2_constructor_args():
    sig = inspect.signature(fsm_RuntimeConcept2.__init__)
...
def test_hyp_fsm_runtimeconcept1_is_not_abstract():
    assert not inspect.isabstract(fsm_RuntimeConcept1)


def test_hyp_fsm_runtimeconcept1_constructor_exists():
    assert callable(fsm_RuntimeConcept1.__init__)


def test_hyp_fsm_runtimeconcept1_constructor_args():
    sig = inspect.signature(fsm_RuntimeConcept1.__init__)
    params = list(sig.parameters.keys())
...
fsm_RuntimeConcept2_strategy = st.builds(
    fsm_RuntimeConcept2,
    bar=
        safe_text
)
...
fsm_RuntimeConcept1_strategy = st.builds(
    fsm_RuntimeConcept1,
    foo=
        st.integers()
)
...
@given(instance=fsm_RuntimeConcept2_strategy)
def test_hyp_fsm_runtimeconcept2_bar_setter(instance):
...
@given(instance=fsm_RuntimeConcept1_strategy)
def test_hyp_fsm_runtimeconcept1_foo_setter(instance):
...
def test_fsm_RuntimeConcept1_foo_value_roundtrip():
    instance = fsm_RuntimeConcept1(foo=7)
    assert instance.foo == 7
    instance.foo = 13
    assert instance.foo == 13


def test_fsm_RuntimeConcept2_bar_value_roundtrip():
    instance = fsm_RuntimeConcept2(bar="sample_text")
...
def test_assoc_myFoos5_link_reassign_clear():
    a = fsm_RuntimeConcept2(bar="sample_text")
    b1 = fsm_RuntimeConcept1(foo=7)
    b2 = fsm_RuntimeConcept1(foo=13)
    _safe_set(a, 'fsm_RuntimeConcept2', {b1})
    assert _is_linked(a, 'fsm_RuntimeConcept2', b1)
    if hasattr(b1, 'fsm_RuntimeConcept1'):
        assert _is_linked(b1, 'fsm_RuntimeConcept1', a)
    _safe_set(a, 'fsm_RuntimeConcept2', {b2})
    assert _is_linked(a, 'fsm_RuntimeConcept2', b2)
    if hasattr(b1, 'fsm_RuntimeConcept1'):
        assert not _is_linked(b1, 'fsm_RuntimeConcept1', a)
    if hasattr(b2, 'fsm_RuntimeConcept1'):
        assert _is_linked(b2, 'fsm_RuntimeConcept1', a)
    _safe_set(a, 'fsm_RuntimeConcept2', set())
    assert not _is_linked(a, 'fsm_RuntimeConcept2', b2)
    if hasattr(b2, 'fsm_RuntimeConcept1'):
        assert not _is_linked(b2, 'fsm_RuntimeConcept1', a)


def test_assoc_myState14_link_reassign_clear():
    a = fsm_State(name="sample_text")
    b1 = fsm_RuntimeConcept1(foo=7)
    b2 = fsm_RuntimeConcept1(foo=13)
    _safe_set(a, 'fsm_State16', b1)
    assert _is_linked(a, 'fsm_State16', b1)
    if hasattr(b1, 'fsm_RuntimeConcept115'):
        assert _is_linked(b1, 'fsm_RuntimeConcept115', a)
    _safe_set(a, 'fsm_State16', b2)
    assert _is_linked(a, 'fsm_State16', b2)
    if hasattr(b1, 'fsm_RuntimeConcept115'):
        assert not _is_linked(b1, 'fsm_RuntimeConcept115', a)
    if hasattr(b2, 'fsm_RuntimeConcept115'):
        assert _is_linked(b2, 'fsm_RuntimeConcept115', a)
    _safe_set(a, 'fsm_State16', None)
    assert not _is_linked(a, 'fsm_State16', b2)
    if hasattr(b2, 'fsm_RuntimeConcept115'):
        assert not _is_linked(b2, 'fsm_RuntimeConcept115', a)
...
fsm_RuntimeConcept1_strategy = st.builds(fsm_RuntimeConcept1, foo=st.integers())
@given(instance=fsm_RuntimeConcept1_strategy)
@settings(max_examples=25)
def test_fsm_RuntimeConcept1_instantiation(instance):
    assert isinstance(instance, fsm_RuntimeConcept1)


fsm_RuntimeConcept2_strategy = st.builds(fsm_RuntimeConcept2, bar=safe_text)
@given(instance=fsm_RuntimeConcept2_strategy)
@settings(max_examples=25)
def test_fsm_RuntimeConcept2_instantiation(instance):
    assert isinstance(instance, fsm_RuntimeConcept2)
