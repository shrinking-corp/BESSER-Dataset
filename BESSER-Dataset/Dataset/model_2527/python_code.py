...
class abcd_A(NamedElt):
    ...
    def __init__(self, anIntegerAttr: int, aBooleanAttr: str, abcd_A14: "abcd_A" = None, abcd_A12: set["abcd_A"] = None, abcd_A: "abcd_Model" = None, abcd_A5: "abcd_Model" = None):
...
class abcd_Model(NamedElt):
    ...
    def __init__(self, style: str, abcd_Model9: "abcd_C" = None, abcd_Model11: "abcd_D" = None, abcd_Model: set["abcd_A"] = None, abcd_Model2: set["abcd_Other"] = None, abcd_Model4: "abcd_A" = None, abcd_Model7: "abcd_B" = None):
        self.style = style
