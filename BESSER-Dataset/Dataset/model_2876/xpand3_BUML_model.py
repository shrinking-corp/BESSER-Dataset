...
# Classes
xpand3_SyntaxElement = Class(name="xpand3_SyntaxElement", is_abstract=True)
xpand3_File = Class(name="xpand3_File")
SyntaxElement = Class(name="SyntaxElement")
xpand3_ImportStatement = Class(name="xpand3_ImportStatement")
AbstractDeclaration = Class(name="AbstractDeclaration")
xpand3_Identifier = Class(name="xpand3_Identifier")
xpand3_expression_ConstructorCallExpression = Class(name="xpand3_expression_ConstructorCallExpression")
xpand3_expression_FeatureCall = Class(name="xpand3_expression_FeatureCall")
xpand3_expression_CollectionExpression = Class(name="xpand3_expression_CollectionExpression")
FeatureCall = Class(name="FeatureCall")
xpand3_expression_OperationCall = Class(name="xpand3_expression_OperationCall")
xpand3_expression_TypeSelectExpression = Class(name="xpand3_expression_TypeSelectExpression")
xpand3_expression_GlobalVarExpression = Class(name="xpand3_expression_GlobalVarExpression")
xpand3_expression_IfExpression = Class(name="xpand3_expression_IfExpression")
xpand3_DeclaredParameter = Class(name="xpand3_DeclaredParameter")
xpand3_expression_AbstractExpression = Class(name="xpand3_expression_AbstractExpression", is_abstract=True)
xpand3_expression_BooleanOperation = Class(name="xpand3_expression_BooleanOperation")
BinaryOperation = Class(name="BinaryOperation")
xpand3_expression_Cast = Class(name="xpand3_expression_Cast")
AbstractExpression = Class(name="AbstractExpression")
expression_xpand3_Identifier = Class(name="expression_xpand3_Identifier")
xpand3_expression_ChainExpression = Class(name="xpand3_expression_ChainExpression")
xpand3_expression_Literal = Class(name="xpand3_expression_Literal", is_abstract=True)
xpand3_expression_BooleanLiteral = Class(name="xpand3_expression_BooleanLiteral")
Literal = Class(name="Literal")
xpand3_expression_IntegerLiteral = Class(name="xpand3_expression_IntegerLiteral")
xpand3_expression_NullLiteral = Class(name="xpand3_expression_NullLiteral")
xpand3_expression_RealLiteral = Class(name="xpand3_expression_RealLiteral")
xpand3_expression_StringLiteral = Class(name="xpand3_expression_StringLiteral")
xpand3_expression_SwitchExpression = Class(name="xpand3_expression_SwitchExpression")
Case = Class(name="Case")
xpand3_expression_Case = Class(name="xpand3_expression_Case")
xpand3_expression_BinaryOperation = Class(name="xpand3_expression_BinaryOperation")
xpand3_expression_LetExpression = Class(name="xpand3_expression_LetExpression")
xpand3_expression_ListLiteral = Class(name="xpand3_expression_ListLiteral")
xpand3_statement_AbstractStatement = Class(name="xpand3_statement_AbstractStatement", is_abstract=True)
xpand3_statement_ExpandStatement = Class(name="xpand3_statement_ExpandStatement")
AbstractStatement = Class(name="AbstractStatement")
statement_xpand3_Identifier = Class(name="statement_xpand3_Identifier")
xpand3_statement_ExpressionStatement = Class(name="xpand3_statement_ExpressionStatement")
xpand3_statement_ErrorStatement = Class(name="xpand3_statement_ErrorStatement")
xpand3_statement_AbstractStatementWithBody = Class(name="xpand3_statement_AbstractStatementWithBody", is_abstract=True)
xpand3_expression_UnaryOperation = Class(name="xpand3_expression_UnaryOperation")
IfStatement = Class(name="IfStatement")
xpand3_statement_LetStatement = Class(name="xpand3_statement_LetStatement")
xpand3_statement_ProtectStatement = Class(name="xpand3_statement_ProtectStatement")
xpand3_statement_TextStatement = Class(name="xpand3_statement_TextStatement")
xpand3_declaration_AbstractDeclaration = Class(name="xpand3_declaration_AbstractDeclaration", is_abstract=True)
declaration_xpand3_File = Class(name="declaration_xpand3_File")
xpand3_statement_FileStatement = Class(name="xpand3_statement_FileStatement")
AbstractStatementWithBody = Class(name="AbstractStatementWithBody")
xpand3_statement_ForEachStatement = Class(name="xpand3_statement_ForEachStatement")
xpand3_statement_IfStatement = Class(name="xpand3_statement_IfStatement")
xpand3_declaration_AbstractAspect = Class(name="xpand3_declaration_AbstractAspect", is_abstract=True)
xpand3_declaration_ExtensionAspect = Class(name="xpand3_declaration_ExtensionAspect")
AbstractAspect = Class(name="AbstractAspect")
xpand3_declaration_DefinitionAspect = Class(name="xpand3_declaration_DefinitionAspect")
xpand3_declaration_Check = Class(name="xpand3_declaration_Check")
xpand3_declaration_CreateExtension = Class(name="xpand3_declaration_CreateExtension")
Extension = Class(name="Extension")
declaration_xpand3_DeclaredParameter = Class(name="declaration_xpand3_DeclaredParameter")
xpand3_declaration_AbstractNamedDeclaration = Class(name="xpand3_declaration_AbstractNamedDeclaration", is_abstract=True)
declaration_xpand3_Identifier = Class(name="declaration_xpand3_Identifier")
xpand3_declaration_Definition = Class(name="xpand3_declaration_Definition")
AbstractNamedDeclaration = Class(name="AbstractNamedDeclaration")
xpand3_declaration_Extension = Class(name="xpand3_declaration_Extension")
xpand3_declaration_JavaExtension = Class(name="xpand3_declaration_JavaExtension")
...
xpand3_SyntaxElement.attributes={xpand3_SyntaxElement_start, xpand3_SyntaxElement_line, xpand3_SyntaxElement_fileName, xpand3_SyntaxElement_end}
...
domain_model = DomainModel(
    name="xpand3",
    types={xpand3_SyntaxElement, xpand3_File, SyntaxElement, xpand3_ImportStatement, AbstractDeclaration, xpand3_Identifier, xpand3_expression_ConstructorCallExpression, xpand3_expression_FeatureCall, xpand3_expression_CollectionExpression, FeatureCall, xpand3_expression_OperationCall, xpand3_expression_TypeSelectExpression, xpand3_expression_GlobalVarExpression, xpand3_expression_IfExpression, xpand3_DeclaredParameter, xpand3_expression_AbstractExpression, xpand3_expression_BooleanOperation, BinaryOperation, xpand3_expression_Cast, AbstractExpression, expression_xpand3_Identifier, xpand3_expression_ChainExpression, xpand3_expression_Literal, xpand3_expression_BooleanLiteral, Literal, xpand3_expression_IntegerLiteral, xpand3_expression_NullLiteral, xpand3_expression_RealLiteral, xpand3_expression_StringLiteral, xpand3_expression_SwitchExpression, Case, xpand3_expression_Case, xpand3_expression_BinaryOperation, xpand3_expression_LetExpression, xpand3_expression_ListLiteral, xpand3_statement_AbstractStatement, xpand3_statement_ExpandStatement, AbstractStatement, statement_xpand3_Identifier, xpand3_statement_ExpressionStatement, xpand3_statement_ErrorStatement, xpand3_statement_AbstractStatementWithBody, xpand3_expression_UnaryOperation, IfStatement, xpand3_statement_LetStatement, xpand3_statement_ProtectStatement, xpand3_statement_TextStatement, xpand3_declaration_AbstractDeclaration, declaration_xpand3_File, xpand3_statement_FileStatement, AbstractStatementWithBody, xpand3_statement_ForEachStatement, xpand3_statement_IfStatement, xpand3_declaration_AbstractAspect, xpand3_declaration_ExtensionAspect, AbstractAspect, xpand3_declaration_DefinitionAspect, xpand3_declaration_Check, xpand3_declaration_CreateExtension, Extension, declaration_xpand3_DeclaredParameter, xpand3_declaration_AbstractNamedDeclaration, declaration_xpand3_Identifier, xpand3_declaration_Definition, AbstractNamedDeclaration, xpand3_declaration_Extension, xpand3_declaration_JavaExtension},
    associations={imports0, declarations1, importedId3, next15, type18, target20, name22, closure25, eleName27, params30, typeLiteral32, globalVarName34, condition36, name5, type7, type10, target11, first13, literalValue54, switchExpr56, defaultExpr58, cases61, condition63, thenPart65, thenPart38, elsePart41, varExpression44, targetExpression46, varName49, elements52, parameters81, separator83, target86, definition89, expression91, message93, body95, left68, right70, operator73, operator76, operand78, condition112, elseIf114, varName116, varValue118, commentStart121, commentEnd123, id126, owner129, fileNameExpression96, outletNameIdentifier98, target101, separator103, variable106, iteratorName109, returnType140, pointcut143, expression145, body147, msg149, constraint151, toBeCreated154, params130, guard132, name135, body136, body138, javaType156, javaMethod158, javaParamTypes161},
    generalizations={gen_xpand3_File_SyntaxElement, gen_xpand3_ImportStatement_SyntaxElement, gen_xpand3_expression_ConstructorCallExpression_AbstractExpression, gen_xpand3_expression_FeatureCall_AbstractExpression, gen_xpand3_expression_CollectionExpression_FeatureCall, gen_xpand3_expression_OperationCall_FeatureCall, gen_xpand3_expression_TypeSelectExpression_FeatureCall, gen_xpand3_expression_GlobalVarExpression_AbstractExpression, gen_xpand3_expression_IfExpression_AbstractExpression, gen_xpand3_Identifier_SyntaxElement, gen_xpand3_DeclaredParameter_SyntaxElement, gen_xpand3_expression_AbstractExpression_SyntaxElement, gen_xpand3_expression_BooleanOperation_BinaryOperation, gen_xpand3_expression_Cast_AbstractExpression, gen_xpand3_expression_ChainExpression_AbstractExpression, gen_xpand3_expression_Literal_AbstractExpression, gen_xpand3_expression_BooleanLiteral_Literal, gen_xpand3_expression_IntegerLiteral_Literal, gen_xpand3_expression_NullLiteral_Literal, gen_xpand3_expression_RealLiteral_Literal, gen_xpand3_expression_StringLiteral_Literal, gen_xpand3_expression_SwitchExpression_AbstractExpression, gen_xpand3_expression_Case_SyntaxElement, gen_xpand3_expression_BinaryOperation_AbstractExpression, gen_xpand3_expression_LetExpression_AbstractExpression, gen_xpand3_expression_ListLiteral_AbstractExpression, gen_xpand3_statement_AbstractStatement_SyntaxElement, gen_xpand3_statement_ExpandStatement_AbstractStatement, gen_xpand3_statement_ExpressionStatement_AbstractStatement, gen_xpand3_statement_ErrorStatement_AbstractStatement, gen_xpand3_statement_AbstractStatementWithBody_AbstractStatement, gen_xpand3_expression_UnaryOperation_AbstractExpression, gen_xpand3_statement_LetStatement_AbstractStatementWithBody, gen_xpand3_statement_ProtectStatement_AbstractStatementWithBody, gen_xpand3_statement_TextStatement_AbstractStatement, gen_xpand3_declaration_AbstractDeclaration_SyntaxElement, gen_xpand3_statement_FileStatement_AbstractStatementWithBody, gen_xpand3_statement_ForEachStatement_AbstractStatementWithBody, gen_xpand3_statement_IfStatement_AbstractStatementWithBody, gen_xpand3_declaration_AbstractAspect_AbstractDeclaration, gen_xpand3_declaration_ExtensionAspect_AbstractAspect, gen_xpand3_declaration_DefinitionAspect_AbstractAspect, gen_xpand3_declaration_Check_AbstractDeclaration, gen_xpand3_declaration_CreateExtension_Extension, gen_xpand3_declaration_AbstractNamedDeclaration_AbstractDeclaration, gen_xpand3_declaration_Definition_AbstractNamedDeclaration, gen_xpand3_declaration_Extension_AbstractNamedDeclaration, gen_xpand3_declaration_JavaExtension_AbstractNamedDeclaration},
    metadata=None
)
