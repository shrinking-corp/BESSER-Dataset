...
class xpand3_declaration_Extension(AbstractNamedDeclaration):
    ...
    def __init__(self, cached: bool, xpand3_declaration_Extension141: "declaration_xpand3_Identifier" = None, xpand3_declaration_Extension: "AbstractExpression" = None):
        self.cached = cached
...
class xpand3_statement_FileStatement(AbstractStatementWithBody):
    ...
    def __init__(self, once: bool, xpand3_statement_FileStatement99: "statement_xpand3_Identifier" = None, xpand3_statement_FileStatement: "AbstractExpression" = None):
        self.once = once
...
class xpand3_statement_TextStatement(AbstractStatement):
    ...
    def __init__(self, value: str, deleteLine: bool, AbstractStatement: "xpand3_statement_AbstractStatementWithBody" = None, AbstractStatement148: "xpand3_declaration_DefinitionAspect" = None, AbstractStatement137: "xpand3_declaration_Definition" = None):
        self.value = value
...
class xpand3_statement_ExpandStatement(AbstractStatement):
    ...
    def __init__(self, foreach: bool, xpand3_statement_ExpandStatement: set["AbstractExpression"] = None, xpand3_statement_ExpandStatement84: "AbstractExpression" = None, xpand3_statement_ExpandStatement87: "AbstractExpression" = None, xpand3_statement_ExpandStatement90: "statement_xpand3_Identifier" = None, AbstractStatement: "xpand3_statement_AbstractStatementWithBody" = None, AbstractStatement148: "xpand3_declaration_DefinitionAspect" = None, AbstractStatement137: "xpand3_declaration_Definition" = None):
...
class xpand3_declaration_AbstractAspect(AbstractDeclaration):
    ...
    def __init__(self, wildparams: bool, xpand3_declaration_AbstractAspect: "declaration_xpand3_Identifier" = None, AbstractDeclaration: "xpand3_File" = None):
...
class xpand3_declaration_Check(AbstractDeclaration):
    ...
    def __init__(self, errorSeverity: bool, feature: str, xpand3_declaration_Check: "AbstractExpression" = None, xpand3_declaration_Check152: "AbstractExpression" = None, AbstractDeclaration: "xpand3_File" = None):
...
class xpand3_declaration_AbstractDeclaration(SyntaxElement):
    ...
    def __init__(self, isPrivate: bool, xpand3_declaration_AbstractDeclaration131: set["declaration_xpand3_DeclaredParameter"] = None, xpand3_declaration_AbstractDeclaration133: "AbstractExpression" = None, xpand3_declaration_AbstractDeclaration: "declaration_xpand3_File" = None):
...
class xpand3_Identifier(SyntaxElement):
    ...
    def __init__(self, value: str, xpand3_Identifier6: "xpand3_DeclaredParameter" = None, xpand3_Identifier9: "xpand3_DeclaredParameter" = None, xpand3_Identifier: "xpand3_ImportStatement" = None):
        self.value = value
...
class xpand3_SyntaxElement(ABC):
    ...
    def __init__(self, line: int, start: int, end: int, fileName: str):
        self.line = line
        self.start = start
        self.end = end
