...
# Classes
dsml_DEdge = Class(name="dsml_DEdge", is_abstract=True)
DGraphElement = Class(name="DGraphElement")
dsml_DNode = Class(name="dsml_DNode")
dsml_DLabel = Class(name="dsml_DLabel")
dsml_DLink = Class(name="dsml_DLink")
DContainedEdge = Class(name="DContainedEdge")
dsml_DReference = Class(name="dsml_DReference")
DEdge = Class(name="DEdge")
dsml_EReference = Class(name="dsml_EReference")
dsml_DReferenceBridge = Class(name="dsml_DReferenceBridge")
dsml_DGraphElement = Class(name="dsml_DGraphElement", is_abstract=True)
DClassElement = Class(name="DClassElement")
DContainedElement = Class(name="DContainedElement")
dsml_EAttribute = Class(name="dsml_EAttribute")
dsml_DClassBridge = Class(name="dsml_DClassBridge")
dsml_DContainedElement = Class(name="dsml_DContainedElement", is_abstract=True)
dsml_DContainedEdge = Class(name="dsml_DContainedEdge", is_abstract=True)
dsml_DAttributeBridge = Class(name="dsml_DAttributeBridge")
DModelElementBridge = Class(name="DModelElementBridge")
dsml_Diagraph = Class(name="dsml_Diagraph")
dsml_DSemanticBridge = Class(name="dsml_DSemanticBridge")
dsml_DContainment = Class(name="dsml_DContainment")
dsml_DGraph = Class(name="dsml_DGraph")
dsml_DClassElement = Class(name="dsml_DClassElement", is_abstract=True)
dsml_EClass = Class(name="dsml_EClass")
dsml_DModelElementBridge = Class(name="dsml_DModelElementBridge")
...
dsml_DNode.attributes={dsml_DNode_pointOfView, dsml_DNode_pointOfViewName}
...
dsml_DModelElementBridge.attributes={dsml_DModelElementBridge_ecoreName, dsml_DModelElementBridge_ecorePath}
...
domain_model = DomainModel(
    name="dsml",
    types={dsml_DEdge, DGraphElement, dsml_DNode, dsml_DLabel, dsml_DLink, DContainedEdge, dsml_DReference, DEdge, dsml_EReference, dsml_DReferenceBridge, dsml_DGraphElement, DClassElement, DContainedElement, dsml_EAttribute, dsml_DClassBridge, dsml_DContainedElement, dsml_DContainedEdge, dsml_DAttributeBridge, DModelElementBridge, dsml_Diagraph, dsml_DSemanticBridge, dsml_DContainment, dsml_DGraph, dsml_DClassElement, dsml_EClass, dsml_DModelElementBridge},
    associations={edges8, parentPointOfView12, childrenPointOfView14, labels16, sourceReference18, eSourceReferenceBridge20, linkLabels23, targetNode0, targetReference1, sourceNode3, eTargetReferenceBridge6, labelAttribute32, eClassBridge34, containment36, eContainmentReferenceBridge38, dConcreteSyntax41, dAbstractSyntax43, nodes26, rootPointOfView28, eClass31, dModelElements45, eAttributeBridge47},
    generalizations={gen_dsml_DEdge_DGraphElement, gen_dsml_DLink_DContainedEdge, gen_dsml_DLink_DClassElement, gen_dsml_DReference_DEdge, gen_dsml_DNode_DGraphElement, gen_dsml_DNode_DClassElement, gen_dsml_DNode_DContainedElement, gen_dsml_DContainedElement_DGraphElement, gen_dsml_DContainedEdge_DContainedElement, gen_dsml_DContainedEdge_DEdge, gen_dsml_DAttributeBridge_DModelElementBridge, gen_dsml_DReferenceBridge_DModelElementBridge, gen_dsml_DClassBridge_DModelElementBridge, gen_dsml_DContainment_DContainedEdge},
    metadata=None
)
