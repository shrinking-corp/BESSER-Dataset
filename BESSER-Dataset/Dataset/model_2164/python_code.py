...
class DEdge:
    ...
    pass
class dsml_DContainedEdge(DContainedElement, DEdge):
...
class dsml_DLabel:
    ...
    def __init__(self, name: str, dsml_DLabel48: "dsml_DAttributeBridge" = None, dsml_DLabel: "dsml_DNode" = None, dsml_DLabel25: "dsml_DLink" = None):
        self.name = name
...
class dsml_DContainedElement(DGraphElement):
    ...
    pass
class dsml_DNode(DContainedElement, DClassElement, DGraphElement):

    def __init__(self, pointOfView: bool, pointOfViewName: str, dsml_DNode9: set["dsml_DEdge"] = None, DNode: "dsml_DNode" = None, dsml_DNode37: "dsml_DContainedElement" = None, dsml_DNode27: "dsml_DGraph" = None, dsml_DNode30: "dsml_DGraph" = None, childrenPointOfView: "dsml_DNode" = None, DNode15: "dsml_DNode" = None, parentPointOfView: set["dsml_DNode"] = None, dsml_DNode17: set["dsml_DLabel"] = None, dsml_DNode: "dsml_DEdge" = None, dsml_DNode5: "dsml_DEdge" = None):
