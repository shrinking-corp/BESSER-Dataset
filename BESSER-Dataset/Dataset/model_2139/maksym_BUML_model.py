...
# Classes
UML_Activity_mine_Element = Class(name="UML_Activity_mine_Element", is_abstract=True)
UML_Activity_mine_ControlNode = Class(name="UML_Activity_mine_ControlNode", is_abstract=True)
ActivityNode = Class(name="ActivityNode")
UML_Activity_mine_ObjectNode = Class(name="UML_Activity_mine_ObjectNode")
UML_Activity_mine_Action = Class(name="UML_Activity_mine_Action")
UML_Activity_mine_Fork = Class(name="UML_Activity_mine_Fork")
UML_Activity_mine_Activity = Class(name="UML_Activity_mine_Activity")
Element = Class(name="Element")
UML_Activity_mine_ActivityNode = Class(name="UML_Activity_mine_ActivityNode", is_abstract=True)
UML_Activity_mine_ActivityEdge = Class(name="UML_Activity_mine_ActivityEdge")
ControlNode = Class(name="ControlNode")
UML_Activity_mine_Join = Class(name="UML_Activity_mine_Join")
UML_Activity_mine_ActivityInitialNode = Class(name="UML_Activity_mine_ActivityInitialNode")
UML_Activity_mine_ActivityFinalNode = Class(name="UML_Activity_mine_ActivityFinalNode")
UML_Activity_mine_DatastoreNode = Class(name="UML_Activity_mine_DatastoreNode")
ObjectNode = Class(name="ObjectNode")
UML_Activity_mine_ActivityParameterNode = Class(name="UML_Activity_mine_ActivityParameterNode")
UML_Activity_mine_ExpansionNode = Class(name="UML_Activity_mine_ExpansionNode")
UML_Activity_mine_ExpansionRegion = Class(name="UML_Activity_mine_ExpansionRegion")
...
UML_Activity_mine_Element.attributes={UML_Activity_mine_Element_name, UML_Activity_mine_Element_properties, UML_Activity_mine_Element_elementID}
...
UML_Activity_mine_Action.attributes={UML_Activity_mine_Action_inputs, UML_Activity_mine_Action_outputs}
...
domain_model = DomainModel(
    ...
    types={UML_Activity_mine_Element, UML_Activity_mine_ControlNode, ActivityNode, UML_Activity_mine_ObjectNode, UML_Activity_mine_Action, UML_Activity_mine_Fork, UML_Activity_mine_Activity, Element, UML_Activity_mine_ActivityNode, UML_Activity_mine_ActivityEdge, ControlNode, UML_Activity_mine_Join, UML_Activity_mine_ActivityInitialNode, UML_Activity_mine_ActivityFinalNode, UML_Activity_mine_DatastoreNode, ObjectNode, UML_Activity_mine_ActivityParameterNode, UML_Activity_mine_ExpansionNode, UML_Activity_mine_ExpansionRegion, Action, Direction, ExpansionMode, Status},
    associations={incoming6, outgoing7, nodes0, edges1, target3, source4, inputCollections9, outputCollections10, edges13, nodes16},
    generalizations={gen_UML_Activity_mine_ControlNode_ActivityNode, gen_UML_Activity_mine_ObjectNode_ActivityNode, gen_UML_Activity_mine_Action_ActivityNode, gen_UML_Activity_mine_Activity_Element, gen_UML_Activity_mine_ActivityEdge_Element, gen_UML_Activity_mine_ActivityNode_Element, gen_UML_Activity_mine_Fork_ControlNode, gen_UML_Activity_mine_Join_ControlNode, gen_UML_Activity_mine_ActivityInitialNode_ControlNode, gen_UML_Activity_mine_ActivityFinalNode_ControlNode, gen_UML_Activity_mine_DatastoreNode_ObjectNode, gen_UML_Activity_mine_ActivityParameterNode_ObjectNode, gen_UML_Activity_mine_ExpansionNode_ObjectNode, gen_UML_Activity_mine_ExpansionRegion_Action},
    metadata=None
)
