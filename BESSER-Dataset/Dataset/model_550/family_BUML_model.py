...
family_Person.attributes={family_Person_provincia, family_Person_eCivil, family_Person_fechaNacimiento, family_Person_name}
...
domain_model = DomainModel(
    name="family",
    types={family_Family, family_Person, Person, family_Man, family_Woman},
    associations={members0, father1, mother3},
