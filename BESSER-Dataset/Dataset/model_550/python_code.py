...
class family_Person(ABC):
    ...
    def __init__(self, eCivil: str, provincia: str, name: str, fechaNacimiento: str, family_Person: "family_Family" = None, family_Person2: "family_Man" = None, family_Person4: "family_Woman" = None):
        self.eCivil = eCivil
