...
# Classes
simpleuml_NamedElement = Class(name="simpleuml_NamedElement", is_abstract=True)
simpleuml_Feature = Class(name="simpleuml_Feature", is_abstract=True)
...
simpleuml_StructuralFeature = Class(name="simpleuml_StructuralFeature", is_abstract=True)
...
domain_model = DomainModel(
    ...
    associations={generalization0, ownedAttribute1, specific2, general3},
