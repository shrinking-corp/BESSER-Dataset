...
class uml2rdbms_PrimitiveToName:
    ...
    def __init__(self, name: str, typeName: str, uml2rdbms_PrimitiveToName: "uml2rdbms_AttributeToColumn" = None, PrimitiveToName: "uml2rdbms_PackageToSchema" = None, uml2rdbms_PrimitiveToName33: "uml2rdbms_PrimitiveDataType" = None, uml2rdbms_PrimitiveToName36: "uml2rdbms_NonLeafAttribute" = None, primitivesToNames: "uml2rdbms_PackageToSchema" = None):
        self.name = name
...
class uml2rdbms_AssociationToForeignKey(ToColumn):
    ...
    def __init__(self, name: str, uml2rdbms_AssociationToForeignKey: "uml2rdbms_ClassToTable" = None, associationToForeignKeys: "uml2rdbms_ClassToTable" = None, AssociationToForeignKey: "uml2rdbms_ClassToTable" = None, uml2rdbms_AssociationToForeignKey3: "uml2rdbms_Association" = None, uml2rdbms_AssociationToForeignKey5: "uml2rdbms_ForeignKey" = None):
        self.name = name
