...
def test_hyp_uml2rdbms_fromattribute_name_setter(instance):
...
def test_hyp_uml2rdbms_packagetoschema_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=uml2rdbms_PrimitiveToName_strategy)
def test_hyp_uml2rdbms_primitivetoname_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_uml2rdbms_classtotable_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_uml2rdbms_associationtoforeignkey_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_assoc_association2_link_reassign_clear():
    ...
    _safe_set(a, 'uml2rdbms_AssociationToForeignKey3', b1)
    assert _is_linked(a, 'uml2rdbms_AssociationToForeignKey3', b1)
    if hasattr(b1, 'uml2rdbms_Association'):
        assert _is_linked(b1, 'uml2rdbms_Association', a)
    _safe_set(a, 'uml2rdbms_AssociationToForeignKey3', b2)
    assert _is_linked(a, 'uml2rdbms_AssociationToForeignKey3', b2)
    if hasattr(b1, 'uml2rdbms_Association'):
    ...
    _safe_set(a, 'uml2rdbms_AssociationToForeignKey3', None)
    assert not _is_linked(a, 'uml2rdbms_AssociationToForeignKey3', b2)
    if hasattr(b2, 'uml2rdbms_Association'):
        assert not _is_linked(b2, 'uml2rdbms_Association', a)


def test_assoc_associationToForeignKeys8_link_reassign_clear():
...
def test_assoc_foreignKey4_link_reassign_clear():
    a = uml2rdbms_AssociationToForeignKey(name="sample_text")
    b1 = uml2rdbms_ForeignKey()
    b2 = uml2rdbms_ForeignKey()
    _safe_set(a, 'uml2rdbms_AssociationToForeignKey5', b1)
    assert _is_linked(a, 'uml2rdbms_AssociationToForeignKey5', b1)
    if hasattr(b1, 'uml2rdbms_ForeignKey'):
        assert _is_linked(b1, 'uml2rdbms_ForeignKey', a)
    _safe_set(a, 'uml2rdbms_AssociationToForeignKey5', b2)
    assert _is_linked(a, 'uml2rdbms_AssociationToForeignKey5', b2)
    if hasattr(b1, 'uml2rdbms_ForeignKey'):
    ...
    _safe_set(a, 'uml2rdbms_AssociationToForeignKey5', None)
    assert not _is_linked(a, 'uml2rdbms_AssociationToForeignKey5', b2)
    if hasattr(b2, 'uml2rdbms_ForeignKey'):
...
def test_assoc_owner1_link_reassign_clear():
    ...
    if hasattr(b1, 'associationToForeignKeys'):
        assert _is_linked(b1, 'associationToForeignKeys', a)
    _safe_set(a, 'ClassToTable', b2)
    assert _is_linked(a, 'ClassToTable', b2)
    if hasattr(b1, 'associationToForeignKeys'):
        assert not _is_linked(b1, 'associationToForeignKeys', a)
    if hasattr(b2, 'associationToForeignKeys'):
        assert _is_linked(b2, 'associationToForeignKeys', a)
    _safe_set(a, 'ClassToTable', None)
    assert not _is_linked(a, 'ClassToTable', b2)
    if hasattr(b2, 'associationToForeignKeys'):
        assert not _is_linked(b2, 'associationToForeignKeys', a)
...
def test_assoc_referenced0_link_reassign_clear():
    a = uml2rdbms_ClassToTable(name="sample_text")
    b1 = uml2rdbms_AssociationToForeignKey(name="sample_text")
    b2 = uml2rdbms_AssociationToForeignKey(name="sample_text_2")
...
def test_assoc_type35_link_reassign_clear():
    a = uml2rdbms_PrimitiveToName(name="sample_text", typeName="sample_text")
    b1 = uml2rdbms_NonLeafAttribute()
    b2 = uml2rdbms_NonLeafAttribute()
    _safe_set(a, 'uml2rdbms_PrimitiveToName36', b1)
    assert _is_linked(a, 'uml2rdbms_PrimitiveToName36', b1)
    if hasattr(b1, 'uml2rdbms_NonLeafAttribute'):
        assert _is_linked(b1, 'uml2rdbms_NonLeafAttribute', a)
    _safe_set(a, 'uml2rdbms_PrimitiveToName36', b2)
    assert _is_linked(a, 'uml2rdbms_PrimitiveToName36', b2)
    if hasattr(b1, 'uml2rdbms_NonLeafAttribute'):
        assert not _is_linked(b1, 'uml2rdbms_NonLeafAttribute', a)
    if hasattr(b2, 'uml2rdbms_NonLeafAttribute'):
        assert _is_linked(b2, 'uml2rdbms_NonLeafAttribute', a)
    _safe_set(a, 'uml2rdbms_PrimitiveToName36', None)
    assert not _is_linked(a, 'uml2rdbms_PrimitiveToName36', b2)
    if hasattr(b2, 'uml2rdbms_NonLeafAttribute'):
        assert not _is_linked(b2, 'uml2rdbms_NonLeafAttribute', a)
