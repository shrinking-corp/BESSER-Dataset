...
uml2rdbms_PrimitiveToName = Class(name="uml2rdbms_PrimitiveToName")
...
domain_model = DomainModel(
    name="uml2rdbms",
    types={uml2rdbms_AssociationToForeignKey, ToColumn, uml2rdbms_ClassToTable, uml2rdbms_PrimitiveToName, FromAttributeOwner, uml2rdbms_PackageToSchema, uml2rdbms_Class, uml2rdbms_Table, uml2rdbms_Key, uml2rdbms_FromAttribute, uml2rdbms_FromAttributeOwner, uml2rdbms_Attribute, uml2rdbms_Package, uml2rdbms_Association, uml2rdbms_ForeignKey, uml2rdbms_AttributeToColumn, FromAttribute, uml2rdbms_PrimitiveDataType, uml2rdbms_ToColumn, uml2rdbms_Column, uml2rdbms_NonLeafAttribute, uml2rdbms_Schema},
    associations={referenced0, owner1, type6, owner7, associationToForeignKeys8, umlClass9, table11, primaryKey13, owner15, leafs16, attribute18, fromAttributes20, classesToTables22, primitivesToNames25, association2, foreignKey4, primitive32, column34, type35, umlPackage27, schema28, owner30},
