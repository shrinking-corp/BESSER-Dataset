...
outgoingArc5: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_", type=PetriNet_PlaceToTransition, multiplicity=Multiplicity(0, 9999))
    }
)
...
outgoingArc9: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_10", type=PetriNet_TransitionToPlace, multiplicity=Multiplicity(1, 9999))
    }
)
...
domain_model = DomainModel(
    name="PetriNet",
    types={PetriNet_Arc, PetriNet_Place, Element, PetriNet_TransitionToPlace, PetriNet_PlaceToTransition, PetriNet_Transition, PetriNet_LocatedElement, PetriNet_NamedElement, LocatedElement, PetriNet_PetriNet, NamedElement, PetriNet_Element, Arc},
    associations={arcs1, net3, incomingArc4, outgoingArc5, elements0, incomingArc6, outgoingArc9, net12, from_14, to15, from_16, to19},
    generalizations={gen_PetriNet_Element_NamedElement, gen_PetriNet_Place_Element, gen_PetriNet_Transition_Element, gen_PetriNet_NamedElement_LocatedElement, gen_PetriNet_PetriNet_NamedElement, gen_PetriNet_Arc_NamedElement, gen_PetriNet_PlaceToTransition_Arc, gen_PetriNet_TransitionToPlace_Arc},
    metadata=None
)
