...
class rental_Rental:
    ...
    def __init__(self, startDate: date, endDate: date, Rental: "rental_RentalAgency" = None, rentals: "rental_RentalAgency" = None, rental_Rental: "rental_Customer" = None, rental_Rental19: "rental_RentalObject" = None):
...
class rental_Customer:
    ...
    def __init__(self, firstName: str, lastName: str, Customer: "rental_RentalAgency" = None, owner: set["rental_License"] = None, customers: "rental_RentalAgency" = None, Customer13: "rental_License" = None, rental_Customer15: "rental_License" = None, rental_Customer: "rental_Address" = None, rental_Customer17: "rental_Rental" = None):
...
class rental_RentalAgency:
    ...
    def __init__(self, name: str, rental_RentalAgency: "rental_Address" = None, parentAgency: set["rental_RentalObject"] = None, parentAgency3: set["rental_Customer"] = None, parentAgency5: set["rental_Rental"] = None, RentalAgency: "rental_Customer" = None, RentalAgency11: "rental_RentalObject" = None, RentalAgency21: "rental_Rental" = None):
        self.name = name
    ...
    def isAvailable(self, rental_from_, rental_rentedObject, rental_to) :
        # TODO: Implement isAvailable method
        pass

    def book(self, rental_customer, rental_from_, rental_to, rental_rentedObject) :
