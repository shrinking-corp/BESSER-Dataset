...
rental_RentalAgency_m_book: Method = Method(name="book", parameters={Parameter(name='rental_from_', type=StringType), Parameter(name='rental_customer', type=StringType), Parameter(name='rental_to', type=StringType), Parameter(name='rental_rentedObject', type=StringType)}, type=StringType)
...
rental_RentalObject.attributes={rental_RentalObject_available, rental_RentalObject_name, rental_RentalObject_ID}
...
rental_Device.attributes={rental_Device_length, rental_Device_serialNumber, rental_Device_width, rental_Device_height}
...
domain_model = DomainModel(
    ...
    associations={address0, objectsToRent1, customers2, rentals4, licenses8, parentAgency9, parentAgency10, owner12, EReference014, address6, parentAgency20, customer16, rentedObject18},
