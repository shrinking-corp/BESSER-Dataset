...
is_person14: BinaryAssociation = BinaryAssociation(
    name="is_person14",
    ends={
...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={Person, Families_Family, Member, Families_Member, Family},
    associations={familyFather7, familyMother8, familySon10, familyDaughter12, is_person14, father0, mother1, sons3, daughters5},
    generalizations={},
    metadata=None
)
