...
class Patient:
    ...
    def __init__(self, id: int, name: str, telno: int, address: str, age: int, sex: str, roomno: int, bill8: "Bill" = None, receptionist10: "Receptionist" = None, doctors1: set["Doctor"] = None, room4: "Room" = None):
        self.id = id
        self.name = name
        self.telno = telno
