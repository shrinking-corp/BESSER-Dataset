...
class people_Person:
    ...
    def __init__(self, alive: bool, luckyNumbers: int, lotteryChances: str, name: str, nicknames: str, age: int, people_Person3: "people_Person" = None, people_Person1: "people_Person" = None, people_Person5: set["people_Pet"] = None, people_Person: "people_Model" = None):
        self.alive = alive
