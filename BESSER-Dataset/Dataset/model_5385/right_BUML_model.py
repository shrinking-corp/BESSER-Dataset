...
# Classes
p_Class1 = Class(name="p_Class1")
p_Class2 = Class(name="p_Class2")
p_Class3 = Class(name="p_Class3")
p_Class4 = Class(name="p_Class4")
p_Exception1 = Class(name="p_Exception1")
p_Exception2 = Class(name="p_Exception2")
...
p_Class2.methods={p_Class2_m_get6, p_Class2_m_get3, p_Class2_m_get, p_Class2_m_get5, p_Class2_m_get2, p_Class2_m_get4}
...
domain_model = DomainModel(
    name="p",
    types={p_Class1, p_Class2, p_Class3, p_Class4, p_Exception1, p_Exception2},
    associations={},
    generalizations={},
    metadata=None
)
