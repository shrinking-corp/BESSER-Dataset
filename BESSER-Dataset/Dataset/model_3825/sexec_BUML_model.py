...
# Classes
sexec_MappedElement = Class(name="sexec_MappedElement")
sexec_EObject = Class(name="sexec_EObject")
sexec_ExecutionState = Class(name="sexec_ExecutionState")
sexec_ExecutionNode = Class(name="sexec_ExecutionNode")
sexec_ExecutionRegion = Class(name="sexec_ExecutionRegion")
sexec_StateVector = Class(name="sexec_StateVector")
sexec_Step = Class(name="sexec_Step", is_abstract=True)
MappedElement = Class(name="MappedElement")
NamedElement = Class(name="NamedElement")
sexec_ExecutionScope = Class(name="sexec_ExecutionScope")
sexec_ExecutionFlow = Class(name="sexec_ExecutionFlow")
ScopedElement = Class(name="ScopedElement")
ExecutionScope = Class(name="ExecutionScope")
ExecutionNode = Class(name="ExecutionNode")
sexec_ExecutionSynchronization = Class(name="sexec_ExecutionSynchronization")
sexec_TimeEvent = Class(name="sexec_TimeEvent")
Event = Class(name="Event")
sexec_Check = Class(name="sexec_Check")
Step = Class(name="Step")
sexec_Expression = Class(name="sexec_Expression")
sexec_CheckRef = Class(name="sexec_CheckRef")
Check = Class(name="Check")
sexec_Execution = Class(name="sexec_Execution")
sexec_EnterState = Class(name="sexec_EnterState")
sexec_ExitState = Class(name="sexec_ExitState")
sexec_Call = Class(name="sexec_Call")
sexec_ScheduleTimeEvent = Class(name="sexec_ScheduleTimeEvent")
sexec_UnscheduleTimeEvent = Class(name="sexec_UnscheduleTimeEvent")
sexec_ExecutionEntry = Class(name="sexec_ExecutionEntry")
sexec_ExecutionExit = Class(name="sexec_ExecutionExit")
sexec_ExecutionChoice = Class(name="sexec_ExecutionChoice")
sexec_SaveHistory = Class(name="sexec_SaveHistory")
sexec_HistoryEntry = Class(name="sexec_HistoryEntry")
sexec_Trace = Class(name="sexec_Trace", is_abstract=True)
sexec_TraceNodeExecuted = Class(name="sexec_TraceNodeExecuted")
Trace = Class(name="Trace")
sexec_ReactionFired = Class(name="sexec_ReactionFired")
sexec_TraceReactionWillFire = Class(name="sexec_TraceReactionWillFire")
sexec_TraceStateEntered = Class(name="sexec_TraceStateEntered")
sexec_TraceStateExited = Class(name="sexec_TraceStateExited")
sexec_TraceBeginRunCycle = Class(name="sexec_TraceBeginRunCycle")
sexec_TraceEndRunCycle = Class(name="sexec_TraceEndRunCycle")
sexec_StateSwitch = Class(name="sexec_StateSwitch")
sexec_StateCase = Class(name="sexec_StateCase")
...
sexec_StateVector.attributes={sexec_StateVector_size, sexec_StateVector_offset}
...
domain_model = DomainModel(
    name="sexec",
    types={sexec_MappedElement, sexec_EObject, sexec_ExecutionState, sexec_ExecutionNode, sexec_ExecutionRegion, sexec_StateVector, sexec_Step, MappedElement, NamedElement, sexec_ExecutionScope, sexec_ExecutionFlow, ScopedElement, ExecutionScope, ExecutionNode, sexec_ExecutionSynchronization, sexec_TimeEvent, Event, sexec_Check, Step, sexec_Expression, sexec_CheckRef, Check, sexec_Execution, sexec_EnterState, sexec_ExitState, sexec_Call, sexec_ScheduleTimeEvent, sexec_UnscheduleTimeEvent, sexec_ExecutionEntry, sexec_ExecutionExit, sexec_ExecutionChoice, sexec_SaveHistory, sexec_HistoryEntry, sexec_Trace, sexec_TraceNodeExecuted, Trace, sexec_ReactionFired, sexec_TraceReactionWillFire, sexec_TraceStateEntered, sexec_TraceStateExited, sexec_TraceBeginRunCycle, sexec_TraceEndRunCycle, sexec_StateSwitch, sexec_StateCase},
    associations={states1, nodes2, regions4, historyVector6, entryAction8, exitAction10, entryAction13, exitAction16, stateVector19, subScopes22, superScope24, sourceElement0, condition32, refs33, check34, statement35, state37, state39, timeEvent41, timeValue42, historyVector26, nodes29, historyRegion48, state51, step54, region57, initialStep59, region61, historyStep64, node67, state69, state71, timeEvent45, cases47},
    generalizations={gen_sexec_ExecutionNode_MappedElement, gen_sexec_ExecutionNode_NamedElement, gen_sexec_ExecutionState_ExecutionNode, gen_sexec_ExecutionState_ExecutionScope, gen_sexec_ExecutionScope_MappedElement, gen_sexec_ExecutionScope_NamedElement, gen_sexec_ExecutionRegion_ExecutionScope, gen_sexec_ExecutionFlow_ScopedElement, gen_sexec_ExecutionFlow_ExecutionScope, gen_sexec_ExecutionFlow_ExecutionNode, gen_sexec_ExecutionChoice_ExecutionNode, gen_sexec_ExecutionSynchronization_ExecutionNode, gen_sexec_TimeEvent_Event, gen_sexec_Step_NamedElement, gen_sexec_Check_Step, gen_sexec_CheckRef_Check, gen_sexec_Execution_Step, gen_sexec_EnterState_Step, gen_sexec_ExitState_Step, gen_sexec_Call_Step, gen_sexec_ScheduleTimeEvent_Step, gen_sexec_UnscheduleTimeEvent_Step, gen_sexec_ExecutionEntry_ExecutionNode, gen_sexec_ExecutionExit_ExecutionNode, gen_sexec_SaveHistory_Step, gen_sexec_HistoryEntry_Step, gen_sexec_Trace_Step, gen_sexec_TraceNodeExecuted_Trace, gen_sexec_ReactionFired_Trace, gen_sexec_TraceReactionWillFire_Trace, gen_sexec_TraceStateEntered_Trace, gen_sexec_TraceStateExited_Trace, gen_sexec_TraceBeginRunCycle_Trace, gen_sexec_TraceEndRunCycle_Trace, gen_sexec_StateSwitch_Step},
    metadata=None
)
