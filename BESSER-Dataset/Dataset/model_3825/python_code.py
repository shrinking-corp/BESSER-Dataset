...
class sexec_HistoryEntry(Step):
    ...
    def __init__(self, deep: bool, sexec_HistoryEntry: "sexec_Step" = None, sexec_HistoryEntry62: "sexec_ExecutionRegion" = None, sexec_HistoryEntry65: "sexec_Step" = None):
        self.deep = deep
...
class sexec_StateSwitch(Step):
    ...
    def __init__(self, stateConfigurationIdx: int, sexec_StateSwitch49: "sexec_ExecutionRegion" = None, sexec_StateSwitch: set["sexec_StateCase"] = None):
        ...
        pass
    @property
    def stateConfigurationIdx(self):
...
class ScopedElement:
    ...
    pass
class sexec_ExecutionFlow(ScopedElement, ExecutionNode, ExecutionScope):
...
class sexec_Step(NamedElement):
    ...
    def __init__(self, comment: str, sexec_Step56: "sexec_StateCase" = None, sexec_Step60: "sexec_HistoryEntry" = None, sexec_Step66: "sexec_HistoryEntry" = None, sexec_Step: "sexec_ExecutionFlow" = None, sexec_Step12: "sexec_ExecutionFlow" = None, sexec_Step15: "sexec_ExecutionState" = None, sexec_Step18: "sexec_ExecutionState" = None):
...
class sexec_StateVector:
    ...
    def __init__(self, size: int, offset: int, sexec_StateVector28: "sexec_ExecutionRegion" = None, sexec_StateVector: "sexec_ExecutionFlow" = None, sexec_StateVector20: "sexec_ExecutionScope" = None):
        self.size = size
        self.offset = offset
...
class sexec_ExecutionState(ExecutionNode, ExecutionScope):

    def __init__(self, leaf: bool, sexec_ExecutionState: "sexec_ExecutionFlow" = None, sexec_ExecutionState38: "sexec_EnterState" = None, sexec_ExecutionState40: "sexec_ExitState" = None, sexec_ExecutionState53: "sexec_StateCase" = None, sexec_ExecutionState70: "sexec_TraceStateEntered" = None, sexec_ExecutionState72: "sexec_TraceStateExited" = None, sexec_ExecutionState14: "sexec_Step" = None, sexec_ExecutionState17: "sexec_Step" = None):
        self.leaf = leaf
