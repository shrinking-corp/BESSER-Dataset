...
def test_hyp_dbl_createidstatement_is_not_abstract():
    assert not inspect.isabstract(dbl_CreateIdStatement)


def test_hyp_dbl_createidstatement_constructor_exists():
    assert callable(dbl_CreateIdStatement.__init__)


def test_hyp_dbl_createidstatement_constructor_args():
    sig = inspect.signature(dbl_CreateIdStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_elementarysymbol_is_not_abstract():
    assert not inspect.isabstract(ElementarySymbol)


def test_hyp_elementarysymbol_constructor_exists():
    assert callable(ElementarySymbol.__init__)


def test_hyp_elementarysymbol_constructor_args():
    sig = inspect.signature(ElementarySymbol.__init__)
    params = list(sig.parameters.keys())



def test_hyp_dbl_intsymbol_is_not_abstract():
    assert not inspect.isabstract(dbl_IntSymbol)


def test_hyp_dbl_intsymbol_constructor_exists():
    assert callable(dbl_IntSymbol.__init__)


def test_hyp_dbl_intsymbol_constructor_args():
    sig = inspect.signature(dbl_IntSymbol.__init__)
    params = list(sig.parameters.keys())



def test_hyp_dbl_stringsymbol_is_not_abstract():
    assert not inspect.isabstract(dbl_StringSymbol)


def test_hyp_dbl_stringsymbol_constructor_exists():
    assert callable(dbl_StringSymbol.__init__)


def test_hyp_dbl_stringsymbol_constructor_args():
    sig = inspect.signature(dbl_StringSymbol.__init__)
    params = list(sig.parameters.keys())



def test_hyp_dbl_keyword_is_not_abstract():
    assert not inspect.isabstract(dbl_Keyword)


def test_hyp_dbl_keyword_constructor_exists():
    assert callable(dbl_Keyword.__init__)


def test_hyp_dbl_keyword_constructor_args():
...
def test_hyp_dbl_idsymbol_is_not_abstract():
    assert not inspect.isabstract(dbl_IdSymbol)


def test_hyp_dbl_idsymbol_constructor_exists():
    assert callable(dbl_IdSymbol.__init__)


def test_hyp_dbl_idsymbol_constructor_args():
    sig = inspect.signature(dbl_IdSymbol.__init__)
    params = list(sig.parameters.keys())



def test_hyp_plainsymbolreference_is_not_abstract():
    assert not inspect.isabstract(PlainSymbolReference)


def test_hyp_plainsymbolreference_constructor_exists():
    assert callable(PlainSymbolReference.__init__)


def test_hyp_plainsymbolreference_constructor_args():
    sig = inspect.signature(PlainSymbolReference.__init__)
    params = list(sig.parameters.keys())



def test_hyp_l2syntaxexpression_is_not_abstract():
    assert not inspect.isabstract(L2SyntaxExpression)


def test_hyp_l2syntaxexpression_constructor_exists():
    assert callable(L2SyntaxExpression.__init__)


def test_hyp_l2syntaxexpression_constructor_args():
    sig = inspect.signature(L2SyntaxExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_dbl_symbolsequence_is_not_abstract():
    assert not inspect.isabstract(dbl_SymbolSequence)


def test_hyp_dbl_symbolsequence_constructor_exists():
    assert callable(dbl_SymbolSequence.__init__)


def test_hyp_dbl_symbolsequence_constructor_args():
    sig = inspect.signature(dbl_SymbolSequence.__init__)
    params = list(sig.parameters.keys())



def test_hyp_syntaxexpression_is_not_abstract():
    assert not inspect.isabstract(SyntaxExpression)


def test_hyp_syntaxexpression_constructor_exists():
    assert callable(SyntaxExpression.__init__)


def test_hyp_syntaxexpression_constructor_args():
    sig = inspect.signature(SyntaxExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_dbl_l1syntaxexpression_is_not_abstract():
    assert not inspect.isabstract(dbl_L1SyntaxExpression)


def test_hyp_dbl_l1syntaxexpression_constructor_exists():
    assert callable(dbl_L1SyntaxExpression.__init__)


def test_hyp_dbl_l1syntaxexpression_constructor_args():
    sig = inspect.signature(dbl_L1SyntaxExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_dbl_l2syntaxexpression_is_not_abstract():
    assert not inspect.isabstract(dbl_L2SyntaxExpression)


def test_hyp_dbl_l2syntaxexpression_constructor_exists():
    assert callable(dbl_L2SyntaxExpression.__init__)


def test_hyp_dbl_l2syntaxexpression_constructor_args():
    sig = inspect.signature(dbl_L2SyntaxExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_dbl_l3syntaxexpression_is_not_abstract():
    assert not inspect.isabstract(dbl_L3SyntaxExpression)


def test_hyp_dbl_l3syntaxexpression_constructor_exists():
    assert callable(dbl_L3SyntaxExpression.__init__)


def test_hyp_dbl_l3syntaxexpression_constructor_args():
    sig = inspect.signature(dbl_L3SyntaxExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_dbl_syntaxexpression_is_not_abstract():
    assert not inspect.isabstract(dbl_SyntaxExpression)


def test_hyp_dbl_syntaxexpression_constructor_exists():
    assert callable(dbl_SyntaxExpression.__init__)


def test_hyp_dbl_syntaxexpression_constructor_args():
    sig = inspect.signature(dbl_SyntaxExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_complexsymbol_is_not_abstract():
    assert not inspect.isabstract(ComplexSymbol)


def test_hyp_complexsymbol_constructor_exists():
    assert callable(ComplexSymbol.__init__)


def test_hyp_complexsymbol_constructor_args():
    sig = inspect.signature(ComplexSymbol.__init__)
    params = list(sig.parameters.keys())



def test_hyp_syntaxsymbolclassifier_is_not_abstract():
    assert not inspect.isabstract(SyntaxSymbolClassifier)


def test_hyp_syntaxsymbolclassifier_constructor_exists():
    assert callable(SyntaxSymbolClassifier.__init__)


def test_hyp_syntaxsymbolclassifier_constructor_args():
    sig = inspect.signature(SyntaxSymbolClassifier.__init__)
    params = list(sig.parameters.keys())



def test_hyp_dbl_elementarysymbol_is_not_abstract():
    assert not inspect.isabstract(dbl_ElementarySymbol)


def test_hyp_dbl_elementarysymbol_constructor_exists():
    assert callable(dbl_ElementarySymbol.__init__)


def test_hyp_dbl_elementarysymbol_constructor_args():
    sig = inspect.signature(dbl_ElementarySymbol.__init__)
    params = list(sig.parameters.keys())



def test_hyp_dbl_complexsymbol_is_not_abstract():
    assert not inspect.isabstract(dbl_ComplexSymbol)


def test_hyp_dbl_complexsymbol_constructor_exists():
    assert callable(dbl_ComplexSymbol.__init__)


def test_hyp_dbl_complexsymbol_constructor_args():
    sig = inspect.signature(dbl_ComplexSymbol.__init__)
    params = list(sig.parameters.keys())



def test_hyp_l1syntaxexpression_is_not_abstract():
    assert not inspect.isabstract(L1SyntaxExpression)


def test_hyp_l1syntaxexpression_constructor_exists():
    assert callable(L1SyntaxExpression.__init__)


def test_hyp_l1syntaxexpression_constructor_args():
    sig = inspect.signature(L1SyntaxExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_dbl_plainsymbolreference_is_not_abstract():
    assert not inspect.isabstract(dbl_PlainSymbolReference)


def test_hyp_dbl_plainsymbolreference_constructor_exists():
    assert callable(dbl_PlainSymbolReference.__init__)


def test_hyp_dbl_plainsymbolreference_constructor_args():
...
def test_hyp_dbl_annotationliteral_is_not_abstract():
    assert not inspect.isabstract(dbl_AnnotationLiteral)


def test_hyp_dbl_annotationliteral_constructor_exists():
    assert callable(dbl_AnnotationLiteral.__init__)


def test_hyp_dbl_annotationliteral_constructor_args():
...
def test_hyp_dbl_concept_is_not_abstract():
    assert not inspect.isabstract(dbl_Concept)


def test_hyp_dbl_concept_constructor_exists():
    assert callable(dbl_Concept.__init__)


def test_hyp_dbl_concept_constructor_args():
...
def test_hyp_annotateableelement_is_not_abstract():
    assert not inspect.isabstract(AnnotateableElement)


def test_hyp_annotateableelement_constructor_exists():
    assert callable(AnnotateableElement.__init__)


def test_hyp_annotateableelement_constructor_args():
...
def test_hyp_dbl_annotationitem_is_not_abstract():
    assert not inspect.isabstract(dbl_AnnotationItem)


def test_hyp_dbl_annotationitem_constructor_exists():
    assert callable(dbl_AnnotationItem.__init__)


def test_hyp_dbl_annotationitem_constructor_args():
...
def test_hyp_dbl_structuralsymbolreference_is_not_abstract():
    assert not inspect.isabstract(dbl_StructuralSymbolReference)


def test_hyp_dbl_structuralsymbolreference_constructor_exists():
    assert callable(dbl_StructuralSymbolReference.__init__)


def test_hyp_dbl_structuralsymbolreference_constructor_args():
...
def test_hyp_dbl_metasymbol_is_not_abstract():
    assert not inspect.isabstract(dbl_MetaSymbol)


def test_hyp_dbl_metasymbol_constructor_exists():
    assert callable(dbl_MetaSymbol.__init__)


def test_hyp_dbl_metasymbol_constructor_args():
...
def test_hyp_dbl_syntaxdefinition_is_not_abstract():
    assert not inspect.isabstract(dbl_SyntaxDefinition)


def test_hyp_dbl_syntaxdefinition_constructor_exists():
    assert callable(dbl_SyntaxDefinition.__init__)


def test_hyp_dbl_syntaxdefinition_constructor_args():
    sig = inspect.signature(dbl_SyntaxDefinition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_dbl_extensionsemantics_is_not_abstract():
    assert not inspect.isabstract(dbl_ExtensionSemantics)


def test_hyp_dbl_extensionsemantics_constructor_exists():
    assert callable(dbl_ExtensionSemantics.__init__)


def test_hyp_dbl_extensionsemantics_constructor_args():
...
def test_hyp_dbl_syntaxsymbolclassifier_is_not_abstract():
    assert not inspect.isabstract(dbl_SyntaxSymbolClassifier)


def test_hyp_dbl_syntaxsymbolclassifier_constructor_exists():
    assert callable(dbl_SyntaxSymbolClassifier.__init__)


def test_hyp_dbl_syntaxsymbolclassifier_constructor_args():
...
def test_hyp_dbl_annotateableelement_is_not_abstract():
    assert not inspect.isabstract(dbl_AnnotateableElement)


def test_hyp_dbl_annotateableelement_constructor_exists():
    assert callable(dbl_AnnotateableElement.__init__)


def test_hyp_dbl_annotateableelement_constructor_args():
...
def test_hyp_dbl_keyword_keyword_setter(instance):
...
def test_hyp_dbl_expansionstatement_functionContext_setter(instance):
...
@given(instance=dbl_ExpansionStatement_strategy)
def test_hyp_dbl_expansionstatement_classContext_setter(instance):
...
@given(instance=dbl_ExpansionStatement_strategy)
def test_hyp_dbl_expansionstatement_variableContext_setter(instance):
...
def test_hyp_dbl_annotationitem_key_setter(instance):
...
@given(instance=dbl_AnnotationItem_strategy)
def test_hyp_dbl_annotationitem_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_dbl_structuralsymbolreference_list_setter(instance):
...
@given(instance=dbl_StructuralSymbolReference_strategy)
def test_hyp_dbl_structuralsymbolreference_composite_setter(instance):
...
@given(instance=dbl_StructuralSymbolReference_strategy)
def test_hyp_dbl_structuralsymbolreference_localScopedReference_setter(instance):
...
@given(instance=dbl_StructuralSymbolReference_strategy)
def test_hyp_dbl_structuralsymbolreference_globalScopedReference_setter(instance):
...
def test_assoc_body190_link_reassign_clear():
    ...
    b1 = dbl_Statement()
    b2 = dbl_Statement()
    _safe_set(a, 'dbl_Pattern191', b1)
    assert _is_linked(a, 'dbl_Pattern191', b1)
    if hasattr(b1, 'dbl_Statement192'):
        assert _is_linked(b1, 'dbl_Statement192', a)
    _safe_set(a, 'dbl_Pattern191', b2)
    assert _is_linked(a, 'dbl_Pattern191', b2)
    if hasattr(b1, 'dbl_Statement192'):
        assert not _is_linked(b1, 'dbl_Statement192', a)
    if hasattr(b2, 'dbl_Statement192'):
        assert _is_linked(b2, 'dbl_Statement192', a)
    _safe_set(a, 'dbl_Pattern191', None)
    assert not _is_linked(a, 'dbl_Pattern191', b2)
    if hasattr(b2, 'dbl_Statement192'):
        assert not _is_linked(b2, 'dbl_Statement192', a)
...
def test_assoc_context188_link_reassign_clear():
    ...
    if hasattr(b1, 'dbl_Parameter189'):
        assert _is_linked(b1, 'dbl_Parameter189', a)
    _safe_set(a, 'dbl_Pattern', b2)
    assert _is_linked(a, 'dbl_Pattern', b2)
    if hasattr(b1, 'dbl_Parameter189'):
        assert not _is_linked(b1, 'dbl_Parameter189', a)
    if hasattr(b2, 'dbl_Parameter189'):
        assert _is_linked(b2, 'dbl_Parameter189', a)
    _safe_set(a, 'dbl_Pattern', None)
    assert not _is_linked(a, 'dbl_Pattern', b2)
    if hasattr(b2, 'dbl_Parameter189'):
        assert not _is_linked(b2, 'dbl_Parameter189', a)


def test_assoc_differingContext167_link_reassign_clear():
    ...
    if hasattr(b1, 'dbl_IdExpr168'):
        assert _is_linked(b1, 'dbl_IdExpr168', a)
    _safe_set(a, 'dbl_ExpansionStatement', b2)
    assert _is_linked(a, 'dbl_ExpansionStatement', b2)
    if hasattr(b1, 'dbl_IdExpr168'):
        assert not _is_linked(b1, 'dbl_IdExpr168', a)
    if hasattr(b2, 'dbl_IdExpr168'):
        assert _is_linked(b2, 'dbl_IdExpr168', a)
    _safe_set(a, 'dbl_ExpansionStatement', None)
    assert not _is_linked(a, 'dbl_ExpansionStatement', b2)
    if hasattr(b2, 'dbl_IdExpr168'):
        assert not _is_linked(b2, 'dbl_IdExpr168', a)


def test_assoc_exprs171_link_reassign_clear():
    a = dbl_ExpansionStatement(classContext=True, functionContext=True, variableContext=True)
    b1 = dbl_Expression()
    b2 = dbl_Expression()
    _safe_set(a, 'dbl_ExpansionStatement172', {b1})
    assert _is_linked(a, 'dbl_ExpansionStatement172', b1)
    if hasattr(b1, 'dbl_Expression173'):
        assert _is_linked(b1, 'dbl_Expression173', a)
    _safe_set(a, 'dbl_ExpansionStatement172', {b2})
    assert _is_linked(a, 'dbl_ExpansionStatement172', b2)
    if hasattr(b1, 'dbl_Expression173'):
        assert not _is_linked(b1, 'dbl_Expression173', a)
    if hasattr(b2, 'dbl_Expression173'):
        assert _is_linked(b2, 'dbl_Expression173', a)
    _safe_set(a, 'dbl_ExpansionStatement172', set())
    assert not _is_linked(a, 'dbl_ExpansionStatement172', b2)
    if hasattr(b2, 'dbl_Expression173'):
        assert not _is_linked(b2, 'dbl_Expression173', a)
...
def test_assoc_objectAccess69_link_reassign_clear():
    a = dbl_ActivateObject(priority=7)
    b1 = dbl_Expression()
    b2 = dbl_Expression()
    _safe_set(a, 'dbl_ActivateObject', b1)
    assert _is_linked(a, 'dbl_ActivateObject', b1)
    if hasattr(b1, 'dbl_Expression70'):
        assert _is_linked(b1, 'dbl_Expression70', a)
    _safe_set(a, 'dbl_ActivateObject', b2)
    assert _is_linked(a, 'dbl_ActivateObject', b2)
    if hasattr(b1, 'dbl_Expression70'):
        assert not _is_linked(b1, 'dbl_Expression70', a)
    if hasattr(b2, 'dbl_Expression70'):
        assert _is_linked(b2, 'dbl_Expression70', a)
    _safe_set(a, 'dbl_ActivateObject', None)
    assert not _is_linked(a, 'dbl_ActivateObject', b2)
    if hasattr(b2, 'dbl_Expression70'):
        assert not _is_linked(b2, 'dbl_Expression70', a)
...
def test_assoc_parts169_link_reassign_clear():
    a = dbl_ExpansionStatement(classContext=True, functionContext=True, variableContext=True)
    b1 = dbl_ExpansionPart()
    b2 = dbl_ExpansionPart()
    _safe_set(a, 'dbl_ExpansionStatement170', {b1})
    assert _is_linked(a, 'dbl_ExpansionStatement170', b1)
    if hasattr(b1, 'dbl_ExpansionPart'):
        assert _is_linked(b1, 'dbl_ExpansionPart', a)
    _safe_set(a, 'dbl_ExpansionStatement170', {b2})
    assert _is_linked(a, 'dbl_ExpansionStatement170', b2)
    if hasattr(b1, 'dbl_ExpansionPart'):
        assert not _is_linked(b1, 'dbl_ExpansionPart', a)
    if hasattr(b2, 'dbl_ExpansionPart'):
        assert _is_linked(b2, 'dbl_ExpansionPart', a)
    _safe_set(a, 'dbl_ExpansionStatement170', set())
    assert not _is_linked(a, 'dbl_ExpansionStatement170', b2)
    if hasattr(b2, 'dbl_ExpansionPart'):
        assert not _is_linked(b2, 'dbl_ExpansionPart', a)


def test_assoc_referencedElement126_link_reassign_clear():
    a = dbl_NamedElement(name="sample_text")
    b1 = dbl_IdExpr()
    b2 = dbl_IdExpr()
    _safe_set(a, 'dbl_NamedElement', b1)
    assert _is_linked(a, 'dbl_NamedElement', b1)
    if hasattr(b1, 'dbl_IdExpr127'):
        assert _is_linked(b1, 'dbl_IdExpr127', a)
    _safe_set(a, 'dbl_NamedElement', b2)
    assert _is_linked(a, 'dbl_NamedElement', b2)
    if hasattr(b1, 'dbl_IdExpr127'):
        assert not _is_linked(b1, 'dbl_IdExpr127', a)
    if hasattr(b2, 'dbl_IdExpr127'):
        assert _is_linked(b2, 'dbl_IdExpr127', a)
    _safe_set(a, 'dbl_NamedElement', None)
    assert not _is_linked(a, 'dbl_NamedElement', b2)
    if hasattr(b2, 'dbl_IdExpr127'):
        assert not _is_linked(b2, 'dbl_IdExpr127', a)
