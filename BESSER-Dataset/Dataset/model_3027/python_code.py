...
class dbl_Div(L3Expr, BinaryOperator):
    ...
    pass
class dbl_Plus(BinaryOperator, L4Expr):
...
class dbl_CreateObject(TypedElement, L1Expr):
    ...
    pass
class dbl_Cast(UnaryOperator, TypedElement, L2Expr):
...
class dbl_Variable(SimpleStatement, AbstractVariable):
    ...
    def __init__(self, control: bool, class_: bool, dbl_Variable: "dbl_Module" = None, dbl_Variable45: "dbl_Class" = None, dbl_Variable55: "dbl_Expression" = None):
...
class dbl_Function(NamedElement, TypedElement, LocalScope):
    ...
    def __init__(self, class_: bool, abstract: bool, dbl_Function: "dbl_Module" = None, dbl_Function31: set["dbl_Parameter"] = None, dbl_Function48: "dbl_Class" = None):
        self.class_ = class_
...
class dbl_Class(Construct, ConstructiveExtensionAtContentExtensionPoint, AnnotateableElement, Concept, NamedElement, Type):
...
class dbl_Module(Construct, ConstructiveExtensionAtContentExtensionPoint, NamedElement):
...
class dbl_StructuralSymbolReference(NamedElement, PlainSymbolReference):
    ...
    def __init__(self, localScopedReference: bool, globalScopedReference: bool, list: bool, composite: bool):
