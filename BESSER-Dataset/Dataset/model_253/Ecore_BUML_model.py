...
ecore_EObject.methods={ecore_EObject_m_eContainer, ecore_EObject_m_eAllContents, ecore_EObject_m_eResource, ecore_EObject_m_eIsSet, ecore_EObject_m_eContainingFeature, ecore_EObject_m_eGet, ecore_EObject_m_eSet, ecore_EObject_m_eUnset, ecore_EObject_m_eClass, ecore_EObject_m_eContents, ecore_EObject_m_eCrossReferences, ecore_EObject_m_eGet, ecore_EObject_m_eInvoke, ecore_EObject_m_eIsProxy, ecore_EObject_m_eContainmentFeature}
...
ecore_EClass.methods={ecore_EClass_m_getFeatureID, ecore_EClass_m_isSuperTypeOf, ecore_EClass_m_getOperationID, ecore_EClass_m_getOperationCount, ecore_EClass_m_getOverride, ecore_EClass_m_getEStructuralFeature, ecore_EClass_m_getFeatureCount, ecore_EClass_m_getEOperation, ecore_EClass_m_getEStructuralFeature}
...
ecore_EStructuralFeature.attributes={ecore_EStructuralFeature_defaultValue, ecore_EStructuralFeature_transient, ecore_EStructuralFeature_changeable, ecore_EStructuralFeature_volatile, ecore_EStructuralFeature_defaultValueLiteral, ecore_EStructuralFeature_derived, ecore_EStructuralFeature_unsettable}
