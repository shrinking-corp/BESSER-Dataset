...
# Classes
stateMachineEditRules_Transition = Class(name="stateMachineEditRules_Transition")
stateMachineEditRules_State = Class(name="stateMachineEditRules_State")
stateMachineEditRules_DFA = Class(name="stateMachineEditRules_DFA")
...
stateMachineEditRules_State.attributes={stateMachineEditRules_State_isStart, stateMachineEditRules_State_id, stateMachineEditRules_State_isEnd}
...
outgoingTransitions4: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_", type=stateMachineEditRules_Transition, multiplicity=Multiplicity(0, 9999))
    }
)
...
domain_model = DomainModel(
    ...
    associations={to0, from_1, incomingTransitions3, outgoingTransitions4, states6, transitions7},
    generalizations={},
    metadata=None
)
