...
class stateMachineEditRules_State:
    ...
    def __init__(self, id: str, isStart: bool, isEnd: bool, State: "stateMachineEditRules_Transition" = None, State2: "stateMachineEditRules_Transition" = None, to: set["stateMachineEditRules_Transition"] = None, from_: set["stateMachineEditRules_Transition"] = None, stateMachineEditRules_State: "stateMachineEditRules_DFA" = None):
        self.id = id
    ...
    def from_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_stateMachineEditRules_State__from_", None)
...
class stateMachineEditRules_Transition:
    ...
    def __init__(self, input: str, incomingTransitions: "stateMachineEditRules_State" = None, outgoingTransitions: "stateMachineEditRules_State" = None, Transition: "stateMachineEditRules_State" = None, Transition5: "stateMachineEditRules_State" = None, stateMachineEditRules_Transition: "stateMachineEditRules_DFA" = None):
        self.input = input
