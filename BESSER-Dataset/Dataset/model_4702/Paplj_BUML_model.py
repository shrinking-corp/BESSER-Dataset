...
# Classes
paplj_Field = Class(name="paplj_Field")
Member = Class(name="Member")
paplj_Method = Class(name="paplj_Method")
paplj_Param = Class(name="paplj_Param")
paplj_Block2 = Class(name="paplj_Block2")
paplj_Program = Class(name="paplj_Program")
paplj_Import = Class(name="paplj_Import")
paplj_Type = Class(name="paplj_Type")
paplj_Expr = Class(name="paplj_Expr")
paplj_Member = Class(name="paplj_Member")
Symbol = Class(name="Symbol")
paplj_Symbol = Class(name="paplj_Symbol")
paplj_Or = Class(name="paplj_Or")
paplj_Binding = Class(name="paplj_Binding")
Expr = Class(name="Expr")
paplj_If = Class(name="paplj_If")
paplj_Let = Class(name="paplj_Let")
paplj_Assignment = Class(name="paplj_Assignment")
paplj_Mul = Class(name="paplj_Mul")
paplj_And = Class(name="paplj_And")
paplj_Eq = Class(name="paplj_Eq")
paplj_Neq = Class(name="paplj_Neq")
paplj_Lt = Class(name="paplj_Lt")
paplj_Add = Class(name="paplj_Add")
paplj_Sub = Class(name="paplj_Sub")
paplj_Num = Class(name="paplj_Num")
paplj_Bool = Class(name="paplj_Bool")
paplj_This = Class(name="paplj_This")
paplj_Null = Class(name="paplj_Null")
paplj_Div = Class(name="paplj_Div")
paplj_Cast = Class(name="paplj_Cast")
paplj_Not = Class(name="paplj_Not")
paplj_Min = Class(name="paplj_Min")
paplj_MemberRef = Class(name="paplj_MemberRef")
paplj_New = Class(name="paplj_New")
paplj_Var = Class(name="paplj_Var")
...
domain_model = DomainModel(
    name="paplj",
    types={paplj_Field, Member, paplj_Method, paplj_Param, paplj_Block2, paplj_Program, paplj_Import, paplj_Type, paplj_Expr, paplj_Member, Symbol, paplj_Symbol, paplj_Or, paplj_Binding, Expr, paplj_If, paplj_Let, paplj_Assignment, paplj_Mul, paplj_And, paplj_Eq, paplj_Neq, paplj_Lt, paplj_Add, paplj_Sub, paplj_Num, paplj_Bool, paplj_This, paplj_Null, paplj_Div, paplj_Cast, paplj_Not, paplj_Min, paplj_MemberRef, paplj_New, paplj_Var},
    associations={params12, body13, imports0, classes1, expr3, superType6, members8, type10, left38, right40, value15, exprs17, condition20, onTrue22, onFalse25, bindings28, expr30, left33, value35, right70, left73, left43, right45, left48, right50, left53, right55, left58, right60, left63, right65, left68, right75, type100, left78, right80, left83, type85, expr88, expr90, left92, member94, args97, type102, member104, args106},
    generalizations={gen_paplj_Field_Member, gen_paplj_Method_Member, gen_paplj_Member_Symbol, gen_paplj_Or_Expr, gen_paplj_Param_Symbol, gen_paplj_Binding_Symbol, gen_paplj_Block2_Expr, gen_paplj_If_Expr, gen_paplj_Let_Expr, gen_paplj_Assignment_Expr, gen_paplj_Mul_Expr, gen_paplj_And_Expr, gen_paplj_Eq_Expr, gen_paplj_Neq_Expr, gen_paplj_Lt_Expr, gen_paplj_Add_Expr, gen_paplj_Sub_Expr, gen_paplj_Num_Expr, gen_paplj_Bool_Expr, gen_paplj_This_Expr, gen_paplj_Null_Expr, gen_paplj_Div_Expr, gen_paplj_Cast_Expr, gen_paplj_Not_Expr, gen_paplj_Min_Expr, gen_paplj_MemberRef_Expr, gen_paplj_New_Expr, gen_paplj_Var_Expr},
    metadata=None
)
