...
# Classes
workflow_CompilationUnit = Class(name="workflow_CompilationUnit")
workflow_ProcedureDeclaration = Class(name="workflow_ProcedureDeclaration", is_abstract=True)
workflow_Statement = Class(name="workflow_Statement", is_abstract=True)
workflow_Block = Class(name="workflow_Block")
Statement = Class(name="Statement")
workflow_While = Class(name="workflow_While")
workflow_VariableAssignment = Class(name="workflow_VariableAssignment")
workflow_Variable = Class(name="workflow_Variable")
workflow_ProcedureReturn = Class(name="workflow_ProcedureReturn")
workflow_Write = Class(name="workflow_Write")
workflow_Read = Class(name="workflow_Read")
workflow_If = Class(name="workflow_If")
workflow_Expression = Class(name="workflow_Expression", is_abstract=True)
workflow_ParameterDeclaration = Class(name="workflow_ParameterDeclaration")
workflow_Constant = Class(name="workflow_Constant")
Expression = Class(name="Expression")
workflow_ProcedureCall = Class(name="workflow_ProcedureCall")
workflow_Declaration = Class(name="workflow_Declaration", is_abstract=True)
workflow_VariableDeclaration = Class(name="workflow_VariableDeclaration")
Declaration = Class(name="Declaration")
workflow_BinaryExpression = Class(name="workflow_BinaryExpression", is_abstract=True)
workflow_LogicExpression = Class(name="workflow_LogicExpression", is_abstract=True)
BinaryExpression = Class(name="BinaryExpression")
workflow_And = Class(name="workflow_And")
LogicExpression = Class(name="LogicExpression")
workflow_Or = Class(name="workflow_Or")
workflow_EqualityExpression = Class(name="workflow_EqualityExpression", is_abstract=True)
workflow_Equal = Class(name="workflow_Equal")
EqualityExpression = Class(name="EqualityExpression")
workflow_GreaterThan = Class(name="workflow_GreaterThan")
workflow_LessThan = Class(name="workflow_LessThan")
workflow_GreaterThanOrEqual = Class(name="workflow_GreaterThanOrEqual")
workflow_LessThanOrEqual = Class(name="workflow_LessThanOrEqual")
workflow_ArithmeticExpression = Class(name="workflow_ArithmeticExpression", is_abstract=True)
workflow_UnaryExpression = Class(name="workflow_UnaryExpression", is_abstract=True)
workflow_Not = Class(name="workflow_Not")
UnaryExpression = Class(name="UnaryExpression")
workflow_UMinus = Class(name="workflow_UMinus")
workflow_NotEqual = Class(name="workflow_NotEqual")
workflow_Addition = Class(name="workflow_Addition")
ArithmeticExpression = Class(name="ArithmeticExpression")
workflow_Subtraction = Class(name="workflow_Subtraction")
workflow_Multiplication = Class(name="workflow_Multiplication")
workflow_Division = Class(name="workflow_Division")
...
workflow_CompilationUnit.attributes={workflow_CompilationUnit_language, workflow_CompilationUnit_name}
...
workflow_Constant.attributes={workflow_Constant_asReal, workflow_Constant_asString, workflow_Constant_asBoolean, workflow_Constant_asInteger}
...
workflow_VariableDeclaration.attributes={workflow_VariableDeclaration_isConstant, workflow_VariableDeclaration_type}
...
domain_model = DomainModel(
    name="workflow",
    types={workflow_CompilationUnit, workflow_ProcedureDeclaration, workflow_Statement, workflow_Block, Statement, workflow_While, workflow_VariableAssignment, workflow_Variable, workflow_ProcedureReturn, workflow_Write, workflow_Read, workflow_If, workflow_Expression, workflow_ParameterDeclaration, workflow_Constant, Expression, workflow_ProcedureCall, workflow_Declaration, workflow_VariableDeclaration, Declaration, workflow_BinaryExpression, workflow_LogicExpression, BinaryExpression, workflow_And, LogicExpression, workflow_Or, workflow_EqualityExpression, workflow_Equal, EqualityExpression, workflow_GreaterThan, workflow_LessThan, workflow_GreaterThanOrEqual, workflow_LessThanOrEqual, workflow_ArithmeticExpression, workflow_UnaryExpression, workflow_Not, UnaryExpression, workflow_UMinus, workflow_NotEqual, workflow_Addition, ArithmeticExpression, workflow_Subtraction, workflow_Multiplication, workflow_Division, Type, AccessModifiers, Languages},
    associations={declarations0, Alternative6, Condition9, Body11, LValue14, RValue15, Expression18, wVar20, Statement1, Condition2, Body3, Variables24, Body26, Parameter29, Argument31, rVar22, Operand135, Operand237, Operand33},
    generalizations={gen_workflow_Block_Statement, gen_workflow_While_Statement, gen_workflow_VariableAssignment_Statement, gen_workflow_ProcedureReturn_Statement, gen_workflow_Write_Statement, gen_workflow_Read_Statement, gen_workflow_If_Statement, gen_workflow_ProcedureDeclaration_Declaration, gen_workflow_Expression_Statement, gen_workflow_Constant_Expression, gen_workflow_ProcedureCall_Expression, gen_workflow_Declaration_Statement, gen_workflow_VariableDeclaration_Declaration, gen_workflow_BinaryExpression_Expression, gen_workflow_LogicExpression_BinaryExpression, gen_workflow_And_LogicExpression, gen_workflow_Or_LogicExpression, gen_workflow_EqualityExpression_BinaryExpression, gen_workflow_Equal_EqualityExpression, gen_workflow_GreaterThan_EqualityExpression, gen_workflow_LessThan_EqualityExpression, gen_workflow_GreaterThanOrEqual_EqualityExpression, gen_workflow_LessThanOrEqual_EqualityExpression, gen_workflow_UnaryExpression_Expression, gen_workflow_Not_UnaryExpression, gen_workflow_UMinus_UnaryExpression, gen_workflow_ParameterDeclaration_Declaration, gen_workflow_Variable_Expression, gen_workflow_NotEqual_EqualityExpression, gen_workflow_ArithmeticExpression_BinaryExpression, gen_workflow_Addition_ArithmeticExpression, gen_workflow_Subtraction_ArithmeticExpression, gen_workflow_Multiplication_ArithmeticExpression, gen_workflow_Division_ArithmeticExpression},
    metadata=None
)
