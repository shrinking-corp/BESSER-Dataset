...
internalsm_TimeConstraintSpecification.attributes={internalsm_TimeConstraintSpecification_id, internalsm_TimeConstraintSpecification_startTimestamp, internalsm_TimeConstraintSpecification_stopTimestamp, internalsm_TimeConstraintSpecification_expectedLength}
...
domain_model = DomainModel(
    name="internalsm",
    types={internalsm_AtomicEventPattern, internalsm_FinalState, State, internalsm_InitState, internalsm_TrapState, internalsm_StateMachine, internalsm_EventPattern, internalsm_InternalExecutionModel, internalsm_State, internalsm_Transition, internalsm_EventToken, internalsm_TimeConstraint, internalsm_Event, internalsm_Guard, internalsm_TimeConstraintSpecification, NumericCompareOperator, TimeConstraintType, EventProcessingContext},
    associations={eventType11, states13, eventPattern15, stateMachines16, latestEvent18, eventTokens21, outTransitions0, inTransitions1, eventTokens3, timeConstraints4, lastProcessedEvent5, preState7, guard8, postState9, currentState23, recordedEvents25, timeConstraintSpecification28},
