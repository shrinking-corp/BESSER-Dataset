...
def test_hyp_domainmodel_typedelement_is_not_abstract():
    assert not inspect.isabstract(domainmodel_TypedElement)


def test_hyp_domainmodel_typedelement_constructor_exists():
    assert callable(domainmodel_TypedElement.__init__)


def test_hyp_domainmodel_typedelement_constructor_args():
...
def test_hyp_domainmodel_typedelement_name_setter(instance):
