...
domainmodel_StructuralFeature = Class(name="domainmodel_StructuralFeature")
...
domainmodel_Attribute = Class(name="domainmodel_Attribute")
StructuralFeature = Class(name="StructuralFeature")
domainmodel_Reference = Class(name="domainmodel_Reference")
domainmodel_Operation = Class(name="domainmodel_Operation")
domainmodel_Parameter = Class(name="domainmodel_Parameter")
domainmodel_TypedElement = Class(name="domainmodel_TypedElement")
domainmodel_TypeRef = Class(name="domainmodel_TypeRef")
...
domain_model = DomainModel(
    name="domainmodel",
    types={domainmodel_Type, domainmodel_DataType, Type, domainmodel_Entity, domainmodel_Feature, TypedElement, domainmodel_StructuralFeature, Feature, domainmodel_DomainModel, domainmodel_AbstractElement, domainmodel_Import, AbstractElement, domainmodel_PackageDeclaration, domainmodel_Attribute, StructuralFeature, domainmodel_Reference, domainmodel_Operation, domainmodel_Parameter, domainmodel_TypedElement, domainmodel_TypeRef, Visibility},
    associations={superType4, features5, elements0, elements1, opposite8, params9, type10, referenced11},
    generalizations={gen_domainmodel_Type_AbstractElement, gen_domainmodel_DataType_Type, gen_domainmodel_Entity_Type, gen_domainmodel_Feature_TypedElement, gen_domainmodel_StructuralFeature_Feature, gen_domainmodel_Import_AbstractElement, gen_domainmodel_PackageDeclaration_AbstractElement, gen_domainmodel_Attribute_StructuralFeature, gen_domainmodel_Reference_StructuralFeature, gen_domainmodel_Operation_Feature, gen_domainmodel_Parameter_TypedElement},
    metadata=None
)
