...
# Classes
arduinoML_Digital = Class(name="arduinoML_Digital")
arduinoML_App = Class(name="arduinoML_App")
arduinoML_Mode = Class(name="arduinoML_Mode")
arduinoML_Brick = Class(name="arduinoML_Brick", is_abstract=True)
NamedElement = Class(name="NamedElement")
arduinoML_Actuator = Class(name="arduinoML_Actuator")
Brick = Class(name="Brick")
arduinoML_State = Class(name="arduinoML_State")
arduinoML_Action = Class(name="arduinoML_Action")
arduinoML_TransitionState = Class(name="arduinoML_TransitionState")
arduinoML_Transition = Class(name="arduinoML_Transition", is_abstract=True)
arduinoML_Analog = Class(name="arduinoML_Analog")
arduinoML_NamedElement = Class(name="arduinoML_NamedElement", is_abstract=True)
arduinoML_TransitionMode = Class(name="arduinoML_TransitionMode")
...
arduinoML_Transition.attributes={arduinoML_Transition_comp, arduinoML_Transition_a_values, arduinoML_Transition_unit, arduinoML_Transition_d_values, arduinoML_Transition_time}
...
domain_model = DomainModel(
    name="arduinoML",
    types={arduinoML_Digital, arduinoML_App, arduinoML_Mode, arduinoML_Brick, NamedElement, arduinoML_Actuator, Brick, arduinoML_State, arduinoML_Action, arduinoML_TransitionState, arduinoML_Transition, arduinoML_Analog, arduinoML_NamedElement, arduinoML_TransitionMode, Transition, Compare, Signal, Time_unit},
    associations={initial_mode0, modes1, bricks4, actions6, transitions_state7, actuator8, digitals10, analogs11, bricks13, states16, initial19, transitions_mode22, next_state23, state25, mode26, next_mode27},
    generalizations={gen_arduinoML_Digital_Brick, gen_arduinoML_App_NamedElement, gen_arduinoML_Brick_NamedElement, gen_arduinoML_Actuator_Brick, gen_arduinoML_Analog_Brick, gen_arduinoML_State_NamedElement, gen_arduinoML_Mode_NamedElement, gen_arduinoML_TransitionState_Transition, gen_arduinoML_TransitionMode_Transition},
    metadata=None
)
