...
class ColOrRowElement:
    ...
    pass
class Excel_Row(ColOrRowElement):
    ...
    def t_rows(self, value):
        ...
        old_value = getattr(self, f"_Excel_Row__t_rows", None)
        self.__t_rows = value
    ...
    def c_row(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Excel_Row__c_row", None)
...
class Excel_Column(ColOrRowElement):
    ...
    def t_cols(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Excel_Column__t_cols", None)
        self.__t_cols = value
...
class Excel_Cell(TableElement):
    ...
    def d_cell(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Excel_Cell__d_cell", None)
        self.__d_cell = value
    ...
    def r_cells(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Excel_Cell__r_cells", None)
...
class Excel_ColOrRowElement(TableElement):
...
class Excel_Worksheet:
    ...
    def t_worksheet(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Excel_Worksheet__t_worksheet", None)
    ...
    def wb_worksheets(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Excel_Worksheet__wb_worksheets", None)
...
class ValueType:
    ...
    pass
class Excel_BooleanValue(ValueType):

    def __init__(self, value: str, ValueType: "Excel_Data" = None):
        self.value = value
...
class Excel_NumberValue(ValueType):
...
class Excel_DateTimeTypeValue(ValueType):

    pass
class Excel_ErrorValue(ValueType):

    pass
class Excel_StringValue(ValueType):
...
class Data:
    ...
    pass
class Excel_ValueType(ABC):

    pass
class Excel_DateTimeType:
