...
# Classes
library_MultimediaItem = Class(name="library_MultimediaItem", is_abstract=True)
library_DVD = Class(name="library_DVD")
MultimediaItem = Class(name="MultimediaItem")
library_BlueRay = Class(name="library_BlueRay")
library_CD = Class(name="library_CD")
library_LibraryShelf = Class(name="library_LibraryShelf")
...
domain_model = DomainModel(
    name="library",
    types={library_MultimediaItem, library_DVD, MultimediaItem, library_BlueRay, library_CD, library_LibraryShelf, library_Item, library_Book, Item},
    associations={items0},
    generalizations={gen_library_MultimediaItem_Item, gen_library_DVD_MultimediaItem, gen_library_BlueRay_MultimediaItem, gen_library_CD_MultimediaItem, gen_library_Book_Item},
    metadata=None
)
