...
class sAAP_StateMachine:
    ...
    def __init__(self, name: str, sAAP_StateMachine: set["sAAP_State"] = None, sAAP_StateMachine5: set["sAAP_Transition"] = None):
        self.name = name
...
class sAAP_Transition:
    ...
    def __init__(self, name: str, Transition: "sAAP_State" = None, Transition2: "sAAP_State" = None, sAAP_Transition: "sAAP_StateMachine" = None, outgoing: "sAAP_State" = None, incoming: "sAAP_State" = None):
        self.name = name
...
class sAAP_State:
    ...
    def __init__(self, name: str, default: bool, from_: set["sAAP_Transition"] = None, to: set["sAAP_Transition"] = None, sAAP_State: "sAAP_StateMachine" = None, State: "sAAP_Transition" = None, State8: "sAAP_Transition" = None):
        self.name = name
    ...
    def from_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_sAAP_State__from_", None)
