...
# Classes
sAAP_State = Class(name="sAAP_State")
sAAP_Transition = Class(name="sAAP_Transition")
sAAP_StateMachine = Class(name="sAAP_StateMachine")
...
sAAP_State.attributes={sAAP_State_default, sAAP_State_name}
...
outgoing0: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_", type=sAAP_Transition, multiplicity=Multiplicity(0, 9999))
    }
)
...
domain_model = DomainModel(
    ...
    associations={outgoing0, incoming1, state3, transition4, from_6, to7},
    generalizations={},
    metadata=None
)
