...
class core_COREFeatureImpactNode(COREImpactNode):
    ...
    def __init__(self, relativeFeatureWeight: int, core_COREFeatureImpactNode: "core_COREFeature" = None, core_COREFeatureImpactNode106: set["core_COREWeightedMapping"] = None):
        ...
        pass
    @property
    def relativeFeatureWeight(self):
...
class core_COREFeature(COREModelElement):
    ...
    def __init__(self, parentRelationship: str, realizes: set["core_COREModel"] = None, core_COREFeature: set["core_COREReuse"] = None, COREFeature22: "core_COREFeature" = None, parent: set["core_COREFeature"] = None, COREFeature25: "core_COREFeature" = None, children: "core_COREFeature" = None, COREFeature: "core_COREModel" = None, core_COREFeature39: "core_COREInterface" = None, core_COREFeature28: "core_COREFeature" = None, core_COREFeature26: set["core_COREFeature"] = None, core_COREFeature31: "core_COREFeature" = None, core_COREFeature29: set["core_COREFeature"] = None, core_COREFeature33: set["core_CORERelativity"] = None, source: set["core_CORERelativity_Opt2"] = None, features: set["core_CORERelativity_Opt2"] = None, core_COREFeature77: "core_COREFeatureModel" = None, core_COREFeature80: "core_COREFeatureModel" = None, core_COREFeature104: "core_COREFeatureImpactNode" = None, COREFeature121: "core_CORERelativity_Opt2" = None, core_COREFeature68: "core_COREConfiguration" = None, core_COREFeature71: "core_COREConfiguration" = None, core_COREFeature115: "core_CORERelativity" = None, COREFeature118: "core_CORERelativity_Opt2" = None):
...
class core_COREImpactNode(COREModelElement):
    ...
    def __init__(self, scalingFactor: float, offset: float, core_COREImpactNode: "core_COREImpactModel" = None, core_COREImpactNode48: "core_COREInterface" = None, source63: set["core_COREContribution"] = None, COREImpactNode: "core_COREContribution" = None, COREImpactNode93: "core_COREContribution" = None, impacts: set["core_COREContribution"] = None):
...
class core_COREContribution:
    ...
    def __init__(self, relativeWeight: int, COREContribution: "core_COREImpactNode" = None, core_COREContribution: "core_COREImpactModel" = None, outgoing: "core_COREImpactNode" = None, incoming: "core_COREImpactNode" = None, COREContribution65: "core_COREImpactNode" = None):
