...
# Classes
core_LayoutContainerMap = Class(name="core_LayoutContainerMap")
core_COREContribution = Class(name="core_COREContribution")
core_COREInterface = Class(name="core_COREInterface")
core_COREFeatureModel = Class(name="core_COREFeatureModel")
...
core_COREFeature = Class(name="core_COREFeature")
core_COREConcern = Class(name="core_COREConcern")
core_COREImpactModel = Class(name="core_COREImpactModel")
COREModel = Class(name="COREModel")
core_COREImpactNode = Class(name="core_COREImpactNode")
core_CORENamedElement = Class(name="core_CORENamedElement", is_abstract=True)
core_COREConfiguration = Class(name="core_COREConfiguration", is_abstract=True)
core_COREReuseConfiguration = Class(name="core_COREReuseConfiguration")
core_COREPattern = Class(name="core_COREPattern", is_abstract=True)
core_CORERelativity = Class(name="core_CORERelativity")
core_CORERelativity_Opt2 = Class(name="core_CORERelativity_Opt2")
...
core_COREConcernConfiguration = Class(name="core_COREConcernConfiguration")
core_COREImpactModelBinding = Class(name="core_COREImpactModelBinding")
COREConfiguration = Class(name="COREConfiguration")
core_LayoutMap = Class(name="core_LayoutMap")
core_EObject = Class(name="core_EObject")
core_LayoutElement = Class(name="core_LayoutElement")
core_COREFeatureImpactNode = Class(name="core_COREFeatureImpactNode")
COREImpactNode = Class(name="COREImpactNode")
core_COREWeightedMapping = Class(name="core_COREWeightedMapping")
core_COREModelCompositionSpecification = Class(name="core_COREModelCompositionSpecification", is_abstract=True)
...
core_LayoutElement.attributes={core_LayoutElement_y, core_LayoutElement_x}
...
domain_model = DomainModel(
    name="core",
    types={core_LayoutContainerMap, core_COREContribution, core_COREInterface, core_COREFeatureModel, COREModelElement, core_COREReuse, core_COREModel, CORENamedElement, core_COREModelReuse, core_COREModelElement, core_COREFeature, core_COREConcern, core_COREImpactModel, COREModel, core_COREImpactNode, core_CORENamedElement, core_COREConfiguration, core_COREReuseConfiguration, core_COREPattern, core_CORERelativity, core_CORERelativity_Opt2, core_COREBinding, core_CORECompositionSpecification, core_COREMapping, core_COREConcernConfiguration, core_COREImpactModelBinding, COREConfiguration, core_LayoutMap, core_EObject, core_LayoutElement, core_COREFeatureImpactNode, COREImpactNode, core_COREWeightedMapping, core_COREModelCompositionSpecification, COREFeatureRelationshipType, COREVisibilityType, COREPartialityType},
    associations={layouts6, contributions8, models10, interface11, featureModel12, impactModel14, realizedBy17, reuses19, children21, parent24, modelReuses0, modelElements1, realizes3, coreConcern4, impactModelElements5, selectable37, customizable40, usable43, impacted46, defaults49, reusedConcern51, configurations54, selectedConfiguration56, extends60, requires27, excludes30, relatedTo32, outgoing34, incoming35, features75, root78, configurations81, defaultConfiguration83, relatedFeatures86, reuse88, outgoing62, incoming64, selected66, reexposed69, extendingConfigurations72, reusedConfiguration107, reuse110, relatedToFeature113, source116, source91, impacts92, key94, value95, key97, value100, represents103, weightedMappings105, features119},
    generalizations={gen_core_COREConcern_CORENamedElement, gen_core_COREFeature_COREModelElement, gen_core_COREModel_CORENamedElement, gen_core_COREImpactModel_COREModel, gen_core_COREReuse_CORENamedElement, gen_core_COREImpactNode_COREModelElement, gen_core_COREModelElement_CORENamedElement, gen_core_COREFeatureModel_COREModel, gen_core_COREConcernConfiguration_COREConfiguration, gen_core_COREReuseConfiguration_COREConfiguration, gen_core_CORERelativity_COREModelElement, gen_core_COREFeatureImpactNode_COREImpactNode},
    metadata=None
)
