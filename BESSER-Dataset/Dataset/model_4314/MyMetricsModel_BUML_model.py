...
# Classes
MetricModel_Metric = Class(name="MetricModel_Metric")
MetricModel_ActivityMetric = Class(name="MetricModel_ActivityMetric")
Metric = Class(name="Metric")
MetricModel_TaskMetric = Class(name="MetricModel_TaskMetric")
MetricModel_MetricPlanModel = Class(name="MetricModel_MetricPlanModel")
...
MetricModel_Metric.attributes={MetricModel_Metric_form, MetricModel_Metric_description, MetricModel_Metric_unit, MetricModel_Metric_type, MetricModel_Metric_name, MetricModel_Metric_id}
...
MetricModel_ActivityMetric.attributes={MetricModel_ActivityMetric_activityEnd, MetricModel_ActivityMetric_activityBegin}
...
domain_model = DomainModel(
    name="MetricModel",
    types={MetricModel_Metric, MetricModel_ActivityMetric, Metric, MetricModel_TaskMetric, MetricModel_MetricPlanModel, MetricType, BaseElement, ColectType, MetricUnit},
