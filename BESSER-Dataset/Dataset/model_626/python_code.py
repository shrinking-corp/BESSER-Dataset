...
class model_Writer:
    ...
    def __init__(self, Pseudonym: bool, firstName: str, lastName: str, EMail: str, BirthDate: date, writers: set["model_Book"] = None, writers6: "model_Library" = None, Writer8: "model_Book" = None, Writer: "model_Library" = None):
...
class model_Library:
    ...
    def __init__(self, name: str, Library: "model_Writer" = None, library: set["model_Writer"] = None, model_Library: set["model_Book"] = None, model_Library3: "model_Librarian" = None):
        self.name = name
