...
model_Writer.attributes={model_Writer_Pseudonym, model_Writer_EMail, model_Writer_lastName, model_Writer_firstName, model_Writer_BirthDate}
...
domain_model = DomainModel(
    name="model",
    types={model_Library, model_Computer, model_Mainboard, model_Writer, model_Book, model_Librarian, model_TableWithoutMultiplicity, model_TableWithUnique, model_PowerBlock, model_Container, model_Content, model_TableWithMultiplicity, model_TableContent, model_TableContentWithoutValidation, TableContent, model_TableContentWithValidation},
    associations={books4, library5, writers7, mainboard9, writers0, books1, librarian2, content14, content16, powerBlock10, contents12, content13},
