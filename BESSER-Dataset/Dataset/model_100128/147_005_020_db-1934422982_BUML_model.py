...
# Classes
db_DBDriver = Class(name="db_DBDriver")
db_Query = Class(name="db_Query")
db_DBConnection = Class(name="db_DBConnection")
DBResource = Class(name="DBResource")
db_QueryParameter = Class(name="db_QueryParameter")
db_SafiResultSet = Class(name="db_SafiResultSet")
db_SafiDriverManager = Class(name="db_SafiDriverManager")
db_Variable = Class(name="db_Variable")
db_config_ServerResource = Class(name="db_config_ServerResource")
db_DBResource = Class(name="db_DBResource", is_abstract=True)
db_config_Role = Class(name="db_config_Role")
config_Entitlement = Class(name="config_Entitlement")
db_config_Entitlement = Class(name="db_config_Entitlement")
db_config_User = Class(name="db_config_User")
config_Role = Class(name="config_Role")
db_config_Saflet = Class(name="db_config_Saflet")
config_User = Class(name="config_User")
db_config_SafiServer = Class(name="db_config_SafiServer")
ServerResource = Class(name="ServerResource")
config_Prompt = Class(name="config_Prompt")
db_config_Prompt = Class(name="db_config_Prompt")
db_config_SFTPInfo = Class(name="db_config_SFTPInfo", is_abstract=True)
db_config_TelephonySubsystem = Class(name="db_config_TelephonySubsystem")
config_SafiServer = Class(name="config_SafiServer")
config_SafletProject = Class(name="config_SafletProject")
db_config_SafletProject = Class(name="db_config_SafletProject")
config_Saflet = Class(name="config_Saflet")
...
db_DBDriver_m_getConnection: Method = Method(name="getConnection", parameters={Parameter(name='db_name', type=StringType)}, type=StringType)
db_DBDriver.attributes={db_DBDriver_pooling, db_DBDriver_exampleUrl, db_DBDriver_websiteUrl, db_DBDriver_driverClassName, db_DBDriver_urlRegexPattern, db_DBDriver_defaultPort, db_DBDriver_default, db_DBDriver_guideUrl, db_DBDriver_jars}
...
db_Query_m_getResultSet: Method = Method(name="getResultSet", parameters={Parameter(name='db_name', type=StringType)}, type=StringType)
db_Query_m_getParameter: Method = Method(name="getParameter", parameters={Parameter(name='db_name', type=StringType)}, type=StringType)
db_Query_m_getParameter: Method = Method(name="getParameter", parameters={Parameter(name='db_index', type=StringType)}, type=StringType)
db_Query.attributes={db_Query_catalog, db_Query_queryType, db_Query_querySql}
...
db_DBConnection_m_getQuery: Method = Method(name="getQuery", parameters={Parameter(name='db_name', type=StringType)}, type=StringType)
db_DBConnection.attributes={db_DBConnection_acquireIncrement, db_DBConnection_minPoolSize, db_DBConnection_properties, db_DBConnection_loginTimeout, db_DBConnection_transactionMode, db_DBConnection_password, db_DBConnection_url, db_DBConnection_maxPoolSize, db_DBConnection_maxIdleTime, db_DBConnection_user}
...
db_SafiResultSet.attributes={db_SafiResultSet_useCache, db_SafiResultSet_holdabilityMode, db_SafiResultSet_scrollable, db_SafiResultSet_scrollMode, db_SafiResultSet_readOnly}

# db_SafiDriverManager class attributes and methods
db_SafiDriverManager_m_getDriver: Method = Method(name="getDriver", parameters={Parameter(name='db_name', type=StringType)}, type=StringType)
...
db_Variable.attributes={db_Variable_defaultValue, db_Variable_scope, db_Variable_name, db_Variable_type}
...
db_config_ServerResource.attributes={db_config_ServerResource_id, db_config_ServerResource_lastUpdated, db_config_ServerResource_description, db_config_ServerResource_lastModified, db_config_ServerResource_name}
...
db_DBResource.attributes={db_DBResource_name, db_DBResource_lastUpdated, db_DBResource_lastModified, db_DBResource_id}
...
db_config_User.attributes={db_config_User_password, db_config_User_lastname, db_config_User_firstname}
...
db_config_Saflet.attributes={db_config_Saflet_code, db_config_Saflet_subsystemId}
...
db_config_SafiServer.attributes={db_config_SafiServer_debug, db_config_SafiServer_bindIP, db_config_SafiServer_managementPort, db_config_SafiServer_running, db_config_SafiServer_dbPort}
...
db_config_SFTPInfo.attributes={db_config_SFTPInfo_sftpPassword, db_config_SFTPInfo_sftpPort, db_config_SFTPInfo_sftpUser}
...
db_config_TelephonySubsystem.attributes={db_config_TelephonySubsystem_running, db_config_TelephonySubsystem_managerName, db_config_TelephonySubsystem_managerPassword, db_config_TelephonySubsystem_visibleSafiServerIP, db_config_TelephonySubsystem_hostname, db_config_TelephonySubsystem_enabled, db_config_TelephonySubsystem_promptDirectory, db_config_TelephonySubsystem_managerPort, db_config_TelephonySubsystem_versionId, db_config_TelephonySubsystem_platformId, db_config_TelephonySubsystem_private}
...
prompts28: BinaryAssociation = BinaryAssociation(
    name="prompts28",
    ends={
        Property(name="Prompt", type=db_config_SafletProject, multiplicity=Multiplicity(1, 1)),
        Property(name="project29", type=config_Prompt, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
project30: BinaryAssociation = BinaryAssociation(
    name="project30",
    ends={
        Property(name="SafletProject31", type=db_config_Prompt, multiplicity=Multiplicity(1, 1)),
        Property(name="prompts", type=config_SafletProject, multiplicity=Multiplicity(0, 1))
    }
)
safiServer32: BinaryAssociation = BinaryAssociation(
    name="safiServer32",
    ends={
...
project26: BinaryAssociation = BinaryAssociation(
    name="project26",
    ends={
        Property(name="SafletProject", type=db_config_Saflet, multiplicity=Multiplicity(1, 1)),
        Property(name="saflets", type=config_SafletProject, multiplicity=Multiplicity(0, 1))
    }
)
saflets27: BinaryAssociation = BinaryAssociation(
    name="saflets27",
    ends={
        Property(name="Saflet", type=db_config_SafletProject, multiplicity=Multiplicity(1, 1)),
        Property(name="project", type=config_Saflet, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
domain_model = DomainModel(
    name="db",
    types={db_DBDriver, db_Query, db_DBConnection, DBResource, db_QueryParameter, db_SafiResultSet, db_SafiDriverManager, db_Variable, db_config_ServerResource, db_DBResource, db_config_Role, config_Entitlement, db_config_Entitlement, db_config_User, config_Role, db_config_Saflet, config_User, db_config_SafiServer, ServerResource, config_Prompt, db_config_Prompt, db_config_SFTPInfo, db_config_TelephonySubsystem, config_SafiServer, config_SafletProject, db_config_SafletProject, config_Saflet, QueryType, RSHoldabilityMode, RSScrollMode, SQLDataType, VariableScope, VariableType, TransactionMode, SynchMode},
    associations={driver0, queries1, parameters4, connection5, resultSets7, connections2, driverManager3, drivers11, query13, query9, entitlements24, roles25, createdBy15, modifiedBy16, user19, users21, prompts28, project30, safiServer32, project26, saflets27},
    generalizations={gen_db_DBDriver_DBResource, gen_db_DBConnection_DBResource, gen_db_Query_DBResource, gen_db_QueryParameter_DBResource, gen_db_SafiDriverManager_DBResource, gen_db_SafiResultSet_DBResource, gen_db_config_Role_ServerResource, gen_db_config_Entitlement_ServerResource, gen_db_config_User_ServerResource, gen_db_config_Saflet_ServerResource, gen_db_config_SafiServer_ServerResource, gen_db_config_Prompt_ServerResource, gen_db_config_TelephonySubsystem_ServerResource, gen_db_config_SafletProject_ServerResource},
    metadata=None
)
