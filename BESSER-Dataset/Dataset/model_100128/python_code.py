...
class db_config_SafletProject(ServerResource):
    ...
    def __init__(self, enabled: bool, project29: set["config_Prompt"] = None, project: set["config_Saflet"] = None):
...
class db_config_SafiServer(ServerResource):
    ...
    def __init__(self, running: bool, debug: bool, dbPort: int, bindIP: str, managementPort: int, db_config_SafiServer: "config_User" = None, db_config_SafiServer22: set["config_User"] = None):
        self.running = running
        self.debug = debug
        self.dbPort = dbPort
        self.bindIP = bindIP
...
class db_DBConnection(DBResource):
    ...
    def __init__(self, url: str, user: str, password: str, loginTimeout: int, properties: str, transactionMode: str, minPoolSize: int, maxPoolSize: int, acquireIncrement: int, maxIdleTime: int, connections: "db_DBDriver" = None, connection: set["db_Query"] = None, DBConnection6: "db_Query" = None, DBConnection: "db_DBDriver" = None):
        self.url = url
        self.user = user
        self.password = password
...
class db_Query(DBResource):
    ...
    def __init__(self, queryType: str, querySql: str, catalog: str, Query: "db_DBConnection" = None, query: set["db_QueryParameter"] = None, queries: "db_DBConnection" = None, query8: set["db_SafiResultSet"] = None, Query14: "db_SafiResultSet" = None, Query10: "db_QueryParameter" = None):
...
class db_DBDriver(DBResource):
    ...
    def __init__(self, driverClassName: str, defaultPort: int, urlRegexPattern: str, pooling: bool, exampleUrl: str, jars: str, default: bool, guideUrl: str, websiteUrl: str, DBDriver: "db_DBConnection" = None, driver: set["db_DBConnection"] = None, drivers: "db_SafiDriverManager" = None, DBDriver12: "db_SafiDriverManager" = None):
