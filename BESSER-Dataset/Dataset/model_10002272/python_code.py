...
class Nurse:
    ...
    def __init__(self, department: Department, manager7: "Manager" = None, department_211: "Department" = None):
...
class Doctor:
    ...
    def __init__(self, department: Department, manager5: "Manager" = None, department_29: "Department" = None):
        self.department = department
...
class Department:
    ...
    def __init__(self, departmentID: str, departmentName: str, doctorList: str, nurseList: str, hospital1: "Hospital" = None, doctor8: "Doctor" = None, nurse10: "Nurse" = None):
