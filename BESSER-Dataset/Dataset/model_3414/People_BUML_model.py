...
people_Universe = Class(name="people_Universe")
...
people_Person_m_child: Method = Method(name="child", parameters={Parameter(name='people_childName', type=StringType)}, type=StringType)
...
domain_model = DomainModel(
    ...
    associations={children1, father6, mother9, people11, parents3},
    generalizations={},
    metadata=None
)
