...
class people_Person:
    ...
    def __init__(self, gender: str, name: str, people_Person: "people_Person" = None, people_Person0: set["people_Person"] = None, people_Person7: "people_Person" = None, people_Person5: "people_Person" = None, people_Person10: "people_Person" = None, people_Person8: "people_Person" = None, people_Person12: "people_Universe" = None, people_Person4: "people_Person" = None, people_Person2: set["people_Person"] = None):
        self.gender = gender
        self.name = name
    ...
    def child(self, people_childName) :
