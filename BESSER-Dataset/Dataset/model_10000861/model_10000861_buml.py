...
Calender_Event.attributes={Calender_Event_eventType, Calender_Event_time, Calender_Event_date, Calender_Event_volunteer, Calender_Event_nomarlUser, Calender_Event_category, Calender_Event_description, Calender_Event_participantAmount, Calender_Event_admin}
...
Payment.attributes={Payment_amount, Payment_cardType, Payment_cardNumber, Payment_issuerName, Payment_expiryDate}
...
domain_model = DomainModel(
    name="_69ace7ef_bee3_4ece_ab4e_92161857075b",
    types={SuperAdmin, void, Normal_user, Admin, Volunteer, Calender_Event, Login, Attendance, Logout, Payment, Mail, Profile},
