...
aadl2_Element_m_not_own_self: Method = Method(name="not_own_self", parameters={Parameter(name='aadl2_context', type=StringType), Parameter(name='aadl2_diagnostics', type=StringType)}, type=BooleanType)
aadl2_Element_m_has_owner: Method = Method(name="has_owner", parameters={Parameter(name='aadl2_context', type=StringType), Parameter(name='aadl2_diagnostics', type=StringType)}, type=BooleanType)
...
aadl2_Element.methods={aadl2_Element_m_getOwner, aadl2_Element_m_allOwnedElements, aadl2_Element_m_has_owner, aadl2_Element_m_not_own_self, aadl2_Element_m_mustBeOwned}

# Element class attributes and methods

# aadl2_Type class attributes and methods
aadl2_Type_m_conformsTo: Method = Method(name="conformsTo", parameters={Parameter(name='aadl2_other', type=StringType)}, type=StringType)
...
aadl2_NamedElement_m_getPropertyValues: Method = Method(name="getPropertyValues", parameters={Parameter(name='aadl2_propertyName', type=StringType), Parameter(name='aadl2_propertySetName', type=StringType)}, type=StringType)
aadl2_NamedElement_m_has_no_qualified_name: Method = Method(name="has_no_qualified_name", parameters={Parameter(name='aadl2_context', type=StringType), Parameter(name='aadl2_diagnostics', type=StringType)}, type=BooleanType)
aadl2_NamedElement_m_has_qualified_name: Method = Method(name="has_qualified_name", parameters={Parameter(name='aadl2_diagnostics', type=StringType), Parameter(name='aadl2_context', type=StringType)}, type=BooleanType)
...
aadl2_NamedElement_m_isDistinguishableFrom: Method = Method(name="isDistinguishableFrom", parameters={Parameter(name='aadl2_ns', type=StringType), Parameter(name='aadl2_n', type=StringType)}, type=StringType)
aadl2_NamedElement.attributes={aadl2_NamedElement_qualifiedName, aadl2_NamedElement_name}
aadl2_NamedElement.methods={aadl2_NamedElement_m_getPropertyValues, aadl2_NamedElement_m_separator, aadl2_NamedElement_m_has_qualified_name, aadl2_NamedElement_m_getNamespace, aadl2_NamedElement_m_isDistinguishableFrom, aadl2_NamedElement_m_qualifiedName, aadl2_NamedElement_m_allNamespaces, aadl2_NamedElement_m_has_no_qualified_name}
...
aadl2_Classifier_m_no_cycles_in_generalization: Method = Method(name="no_cycles_in_generalization", parameters={Parameter(name='aadl2_context', type=StringType), Parameter(name='aadl2_diagnostics', type=StringType)}, type=BooleanType)
aadl2_Classifier_m_specialize_type: Method = Method(name="specialize_type", parameters={Parameter(name='aadl2_context', type=StringType), Parameter(name='aadl2_diagnostics', type=StringType)}, type=BooleanType)
...
aadl2_Classifier_m_inheritableMembers: Method = Method(name="inheritableMembers", parameters={Parameter(name='aadl2_c', type=StringType)}, type=NamedElement)
aadl2_Classifier_m_hasVisibilityOf: Method = Method(name="hasVisibilityOf", parameters={Parameter(name='aadl2_n', type=StringType)}, type=StringType)
aadl2_Classifier_m_inherit: Method = Method(name="inherit", parameters={Parameter(name='aadl2_inhs', type=StringType)}, type=NamedElement)
aadl2_Classifier_m_maySpecializeType: Method = Method(name="maySpecializeType", parameters={Parameter(name='aadl2_c', type=StringType)}, type=StringType)
aadl2_Classifier.attributes={aadl2_Classifier_noAnnexes, aadl2_Classifier_noProperties, aadl2_Classifier_noPrototypes}
aadl2_Classifier.methods={aadl2_Classifier_m_allParents, aadl2_Classifier_m_parents, aadl2_Classifier_m_specialize_type, aadl2_Classifier_m_hasVisibilityOf, aadl2_Classifier_m_inherit, aadl2_Classifier_m_inheritedMember, aadl2_Classifier_m_no_cycles_in_generalization, aadl2_Classifier_m_inheritableMembers, aadl2_Classifier_m_allFeatures, aadl2_Classifier_m_maySpecializeType}
...
aadl2_Prototype_m_categoryConstraint: Method = Method(name="categoryConstraint", parameters={Parameter(name='aadl2_diagnostics', type=StringType), Parameter(name='aadl2_context', type=StringType)}, type=BooleanType)
...
aadl2_Namespace_m_members_distinguishable: Method = Method(name="members_distinguishable", parameters={Parameter(name='aadl2_diagnostics', type=StringType), Parameter(name='aadl2_context', type=StringType)}, type=BooleanType)
aadl2_Namespace_m_getNamesOfMember: Method = Method(name="getNamesOfMember", parameters={Parameter(name='aadl2_element', type=StringType)}, type=StringType)
...
aadl2_ComponentClassifier.attributes={aadl2_ComponentClassifier_derivedModes, aadl2_ComponentClassifier_noModes, aadl2_ComponentClassifier_noFlows}
...
domain_model = DomainModel(
    name="aadl2",
    types={aadl2_Element, Element, aadl2_Type, NamedElement, aadl2_Comment, aadl2_NamedElement, aadl2_PropertyExpression, aadl2_MetaclassReference, aadl2_PropertyOwner, aadl2_BasicProperty, TypedElement, aadl2_PropertyAssociation, aadl2_Property, aadl2_ContainedNamedElement, aadl2_Classifier, aadl2_ModalPropertyValue, BasicProperty, AbstractNamedValue, ArraySizeProperty, Namespace, aadl2_PropertyType, aadl2_TypedElement, Type, aadl2_AbstractNamedValue, aadl2_ArraySizeProperty, PropertyOwner, aadl2_Generalization, aadl2_AnnexSubclause, aadl2_ClassifierFeature, aadl2_Prototype, aadl2_PrototypeBinding, aadl2_Namespace, ModalElement, aadl2_ModalElement, aadl2_Mode, ModeFeature, aadl2_ModeFeature, ClassifierFeature, DirectedRelationship, aadl2_DirectedRelationship, Relationship, aadl2_Relationship, aadl2_ContainmentPathElement, aadl2_ArrayRange, StructuralFeature, CalledSubprogram, aadl2_StructuralFeature, RefinableElement, aadl2_RefinableElement, aadl2_CalledSubprogram, aadl2_ArrayableElement, aadl2_ComponentImplementationReference, aadl2_ComponentImplementation, aadl2_BehavioralFeature, aadl2_ArrayDimension, aadl2_ArraySize, aadl2_EndToEndFlow, aadl2_AbstractSubcomponent, aadl2_AccessConnection, aadl2_ParameterConnection, aadl2_PortConnection, ComponentClassifier, aadl2_ComponentType, aadl2_Subcomponent, aadl2_FlowImplementation, aadl2_Connection, aadl2_ImplementationExtension, aadl2_Realization, aadl2_EventDataSource, aadl2_PortProxy, aadl2_SubprogramProxy, aadl2_ComponentClassifier, Classifier, SubcomponentType, FeatureClassifier, aadl2_FeatureConnection, aadl2_FeatureGroupConnection, aadl2_ProcessorFeature, aadl2_InternalFeature, aadl2_EventSource, aadl2_Context, aadl2_TriggerPort, aadl2_Feature, aadl2_ModeTransition, aadl2_SubcomponentType, aadl2_FeatureClassifier, aadl2_ModeTransitionTrigger, aadl2_FeatureConnectionEnd, ConnectionEnd, aadl2_ConnectionEnd, aadl2_FlowSpecification, aadl2_TypeExtension, aadl2_FeatureGroup, aadl2_AbstractFeature, FeatureConnectionEnd, ArrayableElement, aadl2_ComponentPrototype, aadl2_Flow, aadl2_ModalPath, aadl2_FlowElement, EndToEndFlowElement, aadl2_EndToEndFlowElement, Prototype, FlowFeature, ModalPath, FlowElement, aadl2_FlowEnd, aadl2_FlowFeature, Flow, aadl2_FeatureGroupType, aadl2_FeatureGroupPrototype, aadl2_CallContext, aadl2_DirectedFeature, Feature, aadl2_FeatureGroupConnectionEnd, Generalization_, DirectedFeature, Context, FeatureGroupConnectionEnd, CallContext, aadl2_FeatureType, aadl2_GroupExtension, aadl2_BusAccess, aadl2_DataAccess, aadl2_DataPort, FeatureType, aadl2_Parameter, aadl2_EventDataPort, aadl2_EventPort, aadl2_Access, AccessConnectionEnd, aadl2_AccessConnectionEnd, aadl2_SubprogramAccess, aadl2_SubprogramGroupAccess, Access, Bus, aadl2_BusSubcomponentType, aadl2_PortConnectionEnd, aadl2_Data, aadl2_Bus, Data, ParameterConnectionEnd, PortConnectionEnd, aadl2_DataSubcomponentType, aadl2_ParameterConnectionEnd, Port, Subprogram, aadl2_SubprogramSubcomponentType, aadl2_Port, TriggerPort, aadl2_Subprogram, aadl2_FeaturePrototype, SubprogramGroup, aadl2_SubprogramGroupSubcomponentType, aadl2_SubprogramGroup, aadl2_FlowSegment, aadl2_ModeBinding, aadl2_ConnectedElement, aadl2_EndToEndFlowSegment, Connection, InternalFeature, aadl2_DataClassifier, DataSubcomponentType, Subcomponent, Abstract, aadl2_AbstractSubcomponentType, aadl2_Abstract, aadl2_SubprogramClassifier, SubprogramSubcomponentType, aadl2_AnnexLibrary, aadl2_DefaultAnnexLibrary, AnnexLibrary, aadl2_DefaultAnnexSubclause, AnnexSubclause, aadl2_PublicPackageSection, PackageSection, aadl2_PrivatePackageSection, ProcessorFeature, aadl2_ComponentTypeRename, aadl2_FeatureGroupTypeRename, aadl2_ModelUnit, aadl2_AadlPackage, ModelUnit, aadl2_PackageSection, aadl2_PackageRename, aadl2_ComponentPrototypeBinding, PrototypeBinding, aadl2_ComponentPrototypeActual, aadl2_FeatureGroupPrototypeActual, FeaturePrototypeActual, aadl2_FeaturePrototypeActual, aadl2_FeaturePrototypeBinding, aadl2_AccessSpecification, aadl2_PortSpecification, aadl2_FeatureGroupPrototypeBinding, aadl2_FeaturePrototypeReference, aadl2_SubprogramCallSequence, BehavioralFeature, aadl2_SubprogramCall, aadl2_BehavioredImplementation, ComponentImplementation, aadl2_AbstractType, ComponentType, aadl2_AbstractClassifier, AbstractClassifier, AbstractSubcomponentType, BusSubcomponentType, DeviceSubcomponentType, MemorySubcomponentType, ProcessorSubcomponentType, ProcessSubcomponentType, SubprogramGroupSubcomponentType, aadl2_DeviceSubcomponentType, Device, SystemSubcomponentType, aadl2_Device, ThreadGroupSubcomponentType, ThreadSubcomponentType, aadl2_ProcessorSubcomponentType, Processor, VirtualBusSubcomponentType, VirtualProcessorSubcomponentType, aadl2_VirtualProcessorSubcomponentType, VirtualProcessor, aadl2_VirtualProcessor, aadl2_VirtualBusSubcomponentType, VirtualBus, aadl2_VirtualBus, aadl2_ThreadGroupSubcomponentType, ThreadGroup, aadl2_ThreadGroup, aadl2_ThreadSubcomponentType, Thread, aadl2_Thread, aadl2_SystemSubcomponentType, System, aadl2_System, aadl2_ProcessSubcomponentType, Process, aadl2_Process, aadl2_MemorySubcomponentType, Memory, aadl2_Memory, aadl2_Processor, aadl2_AbstractImplementation, BehavioredImplementation, aadl2_BusSubcomponent, aadl2_DataSubcomponent, aadl2_DeviceSubcomponent, aadl2_MemorySubcomponent, aadl2_ProcessSubcomponent, aadl2_ProcessorSubcomponent, aadl2_SystemSubcomponent, aadl2_SubprogramSubcomponent, aadl2_SubprogramGroupSubcomponent, aadl2_ThreadSubcomponent, aadl2_ThreadGroupSubcomponent, aadl2_VirtualBusSubcomponent, aadl2_VirtualProcessorSubcomponent, aadl2_BusType, BusClassifier, aadl2_AbstractPrototype, ComponentPrototype, aadl2_BusClassifier, aadl2_DataImplementation, aadl2_BusImplementation, aadl2_BusPrototype, aadl2_DataType, DataClassifier, aadl2_DeviceImplementation, aadl2_DataPrototype, aadl2_DeviceClassifier, aadl2_DeviceType, DeviceClassifier, aadl2_MemoryImplementation, aadl2_DevicePrototype, aadl2_MemoryClassifier, aadl2_MemoryType, MemoryClassifier, aadl2_MemoryPrototype, aadl2_SubprogramType, SubprogramClassifier, aadl2_SubprogramImplementation, aadl2_SystemClassifier, aadl2_SystemType, SystemClassifier, aadl2_SubprogramPrototype, aadl2_SubprogramGroupClassifier, aadl2_SubprogramGroupType, SubprogramGroupClassifier, aadl2_SubprogramGroupImplementation, aadl2_SubprogramGroupPrototype, aadl2_SystemImplementation, aadl2_SystemPrototype, aadl2_ProcessorClassifier, aadl2_ProcessorType, ProcessorClassifier, aadl2_ProcessClassifier, aadl2_ProcessType, ProcessClassifier, aadl2_ProcessorImplementation, aadl2_ProcessorPrototype, aadl2_ProcessImplementation, aadl2_ProcessPrototype, aadl2_ThreadClassifier, aadl2_ThreadType, ThreadClassifier, aadl2_ThreadImplementation, aadl2_ThreadPrototype, aadl2_ThreadGroupClassifier, aadl2_ThreadGroupType, ThreadGroupClassifier, aadl2_ThreadGroupImplementation, aadl2_ThreadGroupPrototype, aadl2_VirtualBusImplementation, aadl2_VirtualBusPrototype, aadl2_VirtualProcessorClassifier, aadl2_VirtualProcessorType, VirtualProcessorClassifier, aadl2_VirtualBusClassifier, aadl2_VirtualBusType, VirtualBusClassifier, aadl2_VirtualProcessorImplementation, aadl2_VirtualProcessorPrototype, aadl2_PropertyConstant, aadl2_StringLiteral, PropertyValue, aadl2_PropertyValue, PropertyExpression, aadl2_NumberValue, aadl2_BasicPropertyAssociation, aadl2_EnumerationLiteral, aadl2_ClassifierValue, aadl2_ReferenceValue, ContainedNamedElement, aadl2_BooleanLiteral, aadl2_RangeValue, aadl2_UnitLiteral, EnumerationLiteral, aadl2_RecordValue, aadl2_ComputedValue, aadl2_ListValue, aadl2_NamedValue, aadl2_PropertySet, aadl2_IntegerLiteral, NumberValue, aadl2_RealLiteral, aadl2_Operation, aadl2_GlobalNamespace, aadl2_NonListType, PropertyType, aadl2_AadlBoolean, NonListType, aadl2_AadlString, aadl2_AadlInteger, NumberType, aadl2_NumberType, aadl2_UnitsType, aadl2_AadlReal, aadl2_ClassifierType, aadl2_RangeType, aadl2_NumericRange, EnumerationType, aadl2_EnumerationType, aadl2_ListType, aadl2_RecordType, aadl2_RecordField, aadl2_ReferenceType, FlowKind, DirectionType, AccessType, AccessCategory, PortCategory, ComponentCategory, OperationKind},
    associations={ownedElement1, ownedComment2, defaultValue13, appliesToMetaclass15, appliesToClassifier17, appliesTo20, ownedPropertyAssociation4, property5, appliesTo7, inBinding9, ownedValue11, propertyType22, ownedPropertyType23, type26, inheritedMember28, generalization31, general33, ownedAnnexSubclause35, classifierFeature27, ownedMember41, member43, ownedPrototype37, ownedPrototypeBinding39, inMode58, featuringClassifier46, general47, specific49, source51, target53, relatedElement56, formal67, containmentPathElement70, arrayRange72, namedElement74, refined60, refinementContext62, refinedElement65, sizeProperty81, arrayDimension83, implementation85, ownedPrototypeBinding86, ownedValue77, size80, ownedEndToEndFlow104, ownedAbstractSubcomponent106, ownedAccessConnection108, ownedParameterConnection110, ownedPortConnection112, type89, ownedSubcomponent91, extended94, ownedFlowImplementation96, ownedConnection98, ownedExtension100, ownedRealization102, ownedEventDataSource124, ownedPortProxy126, ownedSubprogramProxy128, ownedMode130, ownedFeatureConnection114, ownedFeatureGroupConnection116, ownedProcessorFeature118, ownedInternalFeature120, ownedEventSource122, context142, triggerPort144, ownedFeature146, extended149, ownedModeTransition132, source134, destination137, ownedTrigger140, prototype159, featureClassifier161, refined164, classifier166, ownedFlowSpecification151, ownedExtension153, ownedFeatureGroup155, ownedAbstractFeature157, inModeOrTransition180, constrainingClassifier169, refined173, outEnd175, InEnd177, featureGroupType192, featureGroupPrototype194, context181, feature184, extended187, featureType190, ownedExtension205, ownedBusAccess207, ownedDataAccess209, ownedDataPort211, ownedFeature196, extended200, inverse203, ownedFeatureGroup217, ownedParameter220, ownedEventDataPort213, ownedEventPort215, ownedSubprogramAccess222, ownedSubprogramGroupAccess224, ownedAbstractFeature226, extended229, busFeatureClassifier232, dataFeatureClassifier234, dataFeatureClassifier239, dataFeatureClassifier242, dataFeatureClassifier236, subprogramFeatureClassifier245, featurePrototype249, constrainingClassifier251, constrainingFeatureGroupType254, subcomponentType257, ownedPrototypeBinding259, subprogramGroupFeatureClassifier247, implementationReference267, refined271, classifier273, parentMode276, derivedMode279, specification282, prototype262, ownedModeBinding265, flowElement287, context289, destination292, source294, refined298, ownedFlowSegment285, extended305, implemented308, refined312, ownedEndToEndFlowSegment314, flowElement316, context318, context300, connectionEnd303, dataClassifier323, abstractSubcomponentType321, subprogramClassifier328, parsedAnnexLibrary330, parsedAnnexSubclause331, dataClassifier325, ownedComponentTypeRename335, ownedClassifier337, ownedFeatureGroupTypeRename340, ownedAnnexLibrary342, importedUnit345, renamedPackage347, ownedPublicSection349, privateSection333, ownedPackageRename334, publicSection359, renamedComponentType360, renamedFeatureGroupType363, actual366, binding367, ownedPrivateSection351, publicSection353, privateSection356, actual373, binding374, featureType377, actual380, classifier381, componentPrototype383, subcomponentType370, prototype391, ownedSubprogramCall393, calledSubprogram394, context396, subprogramCall398, ownedSubprogramCallSequence400, classifier386, componentPrototype388, ownedBusAccess403, ownedDataAccess405, ownedSubprogramAccess408, ownedDataPort411, ownedEventPort414, ownedEventDataPort417, ownedSubprogramGroupAccess420, ownedBusSubcomponent423, ownedDataSubcomponent424, busSubcomponentType448, ownedDeviceSubcomponent426, ownedMemorySubcomponent428, ownedProcessSubcomponent430, ownedProcessorSubcomponent432, ownedSystemSubcomponent434, ownedSubprogramSubcomponent436, ownedSubprogramGroupSubcomponent438, ownedThreadSubcomponent440, ownedThreadGroupSubcomponent442, ownedVirtualBusSubcomponent444, ownedVirtualProcessorSubcomponent446, subprogramSubcomponentType464, dataSubcomponentType451, deviceSubcomponentType454, memorySubcomponentType456, processSubcomponentType458, processorSubcomponentType460, systemSubcomponentType462, ownedBusAccess478, subprogramGroupSubcomponentType467, threadSubcomponentType470, threadGroupSubcomponentType472, virtualBusSubcomponentType474, virtualProcessorSubcomponentType476, ownedDataPort480, ownedEventDataPort483, ownedEventPort486, ownedVirtualBusSubcomponent489, ownedSubprogramAccess491, ownedDataAccess493, ownedSubprogramGroupAccess496, ownedSubprogramGroupAccess518, ownedDataSubcomponent499, ownedSubprogramSubcomponent501, ownedDataPort504, ownedEventDataPort506, ownedEventPort509, ownedBusAccess512, ownedSubprogramAccess515, ownedBusSubcomponent521, ownedDataSubcomponent523, ownedVirtualBusSubcomponent526, ownedBusAccess529, ownedDataPort531, ownedEventDataPort534, ownedEventPort537, ownedDataSubcomponent562, ownedBusSubcomponent540, ownedMemorySubcomponent542, ownedEventDataPort545, ownedEventPort547, ownedParameter550, ownedDataAccess553, ownedSubprogramAccess556, ownedSubprogramGroupAccess559, ownedSubprogramSubcomponent564, ownedSubprogramAccess567, ownedSubprogramGroupAccess569, ownedSubprogramSubcomponent572, ownedSubprogramGroupSubcomponent574, ownedDataSubcomponent577, ownedDeviceSubcomponent605, ownedMemorySubcomponent608, ownedBusAccess580, ownedDataAccess582, ownedDataPort585, ownedSubprogramGroupAccess588, ownedSubprogramAccess591, ownedEventPort594, ownedEventDataPort597, ownedBusSubcomponent600, ownedDataSubcomponent602, ownedEventDataPort634, ownedEventPort637, ownedProcessSubcomponent611, ownedProcessorSubcomponent614, ownedSubprogramSubcomponent617, ownedSubprogramGroupSubcomponent620, ownedSystemSubcomponent623, ownedVirtualBusSubcomponent626, ownedVirtualProcessorSubcomponent629, ownedDataPort632, ownedDataPort660, ownedBusAccess640, ownedSubprogramAccess643, ownedSubprogramGroupAccess646, ownedBusSubcomponent649, ownedMemorySubcomponent651, ownedVirtualBusSubcomponent654, ownedVirtualProcessorSubcomponent657, ownedThreadSubcomponent685, ownedThreadGroupSubcomponent688, ownedEventDataPort662, ownedEventPort665, ownedDataAccess668, ownedSubprogramAccess671, ownedSubprogramGroupAccess674, ownedDataSubcomponent677, ownedSubprogramSubcomponent679, ownedSubprogramGroupSubcomponent682, ownedDataPort691, ownedSubprogramGroupAccess705, ownedEventDataPort693, ownedSubprogramGroupSubcomponent708, ownedSubprogramSubcomponent710, ownedDataSubcomponent713, ownedDataPort716, ownedEventPort696, ownedEventDataPort718, ownedDataAccess699, ownedSubprogramAccess702, ownedSubprogramAccess727, ownedSubprogramGroupAccess730, ownedDataSubcomponent733, ownedThreadSubcomponent735, ownedThreadGroupSubcomponent738, ownedSubprogramSubcomponent741, ownedSubprogramGroupSubcomponent744, ownedEventPort721, ownedDataAccess724, ownedEventDataPort749, ownedEventPort752, ownedVirtualBusSubcomponent755, ownedDataPort757, ownedEventDataPort759, ownedEventPort762, ownedDataPort747, ownedSubprogramAccess765, ownedSubprogramGroupAccess768, ownedVirtualBusSubcomponent771, ownedVirtualProcessorSubcomponent773, propertyType781, ownedPropertyType783, constantValue786, property776, ownedValue778, factor793, classifier796, minimum798, maximum800, delta803, unit789, baseUnit791, ownedPropertyExpression806, ownedFieldValue808, ownedListElement810, namedValue812, importedUnit821, ownedAnnexSubclause824, package827, propertySet829, ownedUnitsType832, ownedPropertyType813, ownedProperty815, ownedPropertyConstant818, ownedLiteral838, upperBound839, lowerBound842, classifierReference845, ownedNumberType847, numberType849, unitsType833, range836, ownedElementType856, elementType858, ownedField852, namedElementReference854},
    generalizations={gen_aadl2_Comment_Element, gen_aadl2_Type_NamedElement, gen_aadl2_NamedElement_Element, gen_aadl2_BasicProperty_TypedElement, gen_aadl2_PropertyAssociation_Element, gen_aadl2_Property_BasicProperty, gen_aadl2_Property_AbstractNamedValue, gen_aadl2_Property_ArraySizeProperty, gen_aadl2_PropertyOwner_Element, gen_aadl2_Classifier_Namespace, gen_aadl2_Classifier_Type, gen_aadl2_TypedElement_NamedElement, gen_aadl2_PropertyType_Type, gen_aadl2_PropertyExpression_Element, gen_aadl2_MetaclassReference_PropertyOwner, gen_aadl2_ClassifierFeature_NamedElement, gen_aadl2_Namespace_NamedElement, gen_aadl2_AnnexSubclause_ModalElement, gen_aadl2_ModalElement_NamedElement, gen_aadl2_Mode_ModeFeature, gen_aadl2_ModeFeature_ClassifierFeature, gen_aadl2_Generalization_DirectedRelationship, gen_aadl2_DirectedRelationship_Relationship, gen_aadl2_Relationship_Element, gen_aadl2_ContainedNamedElement_Element, gen_aadl2_ContainmentPathElement_Element, gen_aadl2_ArrayRange_Element, gen_aadl2_Prototype_StructuralFeature, gen_aadl2_Prototype_CalledSubprogram, gen_aadl2_StructuralFeature_RefinableElement, gen_aadl2_StructuralFeature_ClassifierFeature, gen_aadl2_RefinableElement_NamedElement, gen_aadl2_PrototypeBinding_Element, gen_aadl2_ArrayableElement_Element, gen_aadl2_ComponentImplementationReference_Element, gen_aadl2_ModalPropertyValue_ModalElement, gen_aadl2_BehavioralFeature_ClassifierFeature, gen_aadl2_ArrayDimension_Element, gen_aadl2_ArraySize_Element, gen_aadl2_ComponentImplementation_ComponentClassifier, gen_aadl2_ComponentClassifier_Classifier, gen_aadl2_ComponentClassifier_SubcomponentType, gen_aadl2_ComponentClassifier_FeatureClassifier, gen_aadl2_Context_NamedElement, gen_aadl2_TriggerPort_NamedElement, gen_aadl2_ComponentType_ComponentClassifier, gen_aadl2_SubcomponentType_Type, gen_aadl2_ModeTransition_ModeFeature, gen_aadl2_ModeTransitionTrigger_Element, gen_aadl2_FeatureConnectionEnd_ConnectionEnd, gen_aadl2_ConnectionEnd_NamedElement, gen_aadl2_Feature_StructuralFeature, gen_aadl2_Feature_FeatureConnectionEnd, gen_aadl2_Feature_ArrayableElement, gen_aadl2_Flow_NamedElement, gen_aadl2_ModalPath_ModalElement, gen_aadl2_FlowElement_EndToEndFlowElement, gen_aadl2_EndToEndFlowElement_NamedElement, gen_aadl2_ComponentPrototype_Prototype, gen_aadl2_ComponentPrototype_SubcomponentType, gen_aadl2_ComponentPrototype_FeatureClassifier, gen_aadl2_FlowSpecification_FlowFeature, gen_aadl2_FlowSpecification_ModalPath, gen_aadl2_FlowSpecification_FlowElement, gen_aadl2_FlowFeature_StructuralFeature, gen_aadl2_FlowFeature_Flow, gen_aadl2_DirectedFeature_Feature, gen_aadl2_FeatureGroupConnectionEnd_ConnectionEnd, gen_aadl2_FlowEnd_Element, gen_aadl2_TypeExtension_Generalization, gen_aadl2_FeatureGroup_DirectedFeature, gen_aadl2_FeatureGroup_Context, gen_aadl2_FeatureGroup_FeatureGroupConnectionEnd, gen_aadl2_FeatureGroup_CallContext, gen_aadl2_FeatureGroupType_Classifier, gen_aadl2_FeatureGroupType_FeatureType, gen_aadl2_Access_Feature, gen_aadl2_Access_AccessConnectionEnd, gen_aadl2_AccessConnectionEnd_ConnectionEnd, gen_aadl2_GroupExtension_Generalization, gen_aadl2_BusAccess_Access, gen_aadl2_BusAccess_Bus, gen_aadl2_PortConnectionEnd_ConnectionEnd, gen_aadl2_Data_NamedElement, gen_aadl2_DataSubcomponentType_Data, gen_aadl2_DataSubcomponentType_SubcomponentType, gen_aadl2_DataSubcomponentType_FeatureClassifier, gen_aadl2_Bus_NamedElement, gen_aadl2_BusSubcomponentType_Bus, gen_aadl2_BusSubcomponentType_SubcomponentType, gen_aadl2_BusSubcomponentType_FeatureClassifier, gen_aadl2_DataAccess_Access, gen_aadl2_DataAccess_Data, gen_aadl2_DataAccess_FlowElement, gen_aadl2_DataAccess_ParameterConnectionEnd, gen_aadl2_DataAccess_PortConnectionEnd, gen_aadl2_ParameterConnectionEnd_ConnectionEnd, gen_aadl2_EventPort_Port, gen_aadl2_Parameter_DirectedFeature, gen_aadl2_Parameter_Context, gen_aadl2_Parameter_ParameterConnectionEnd, gen_aadl2_DataPort_Port, gen_aadl2_DataPort_Context, gen_aadl2_DataPort_Data, gen_aadl2_DataPort_ParameterConnectionEnd, gen_aadl2_SubprogramAccess_Access, gen_aadl2_SubprogramAccess_Subprogram, gen_aadl2_Port_DirectedFeature, gen_aadl2_Port_PortConnectionEnd, gen_aadl2_Port_TriggerPort, gen_aadl2_Subprogram_NamedElement, gen_aadl2_Subprogram_CalledSubprogram, gen_aadl2_SubprogramSubcomponentType_SubcomponentType, gen_aadl2_SubprogramSubcomponentType_Subprogram, gen_aadl2_SubprogramSubcomponentType_FeatureClassifier, gen_aadl2_EventDataPort_Port, gen_aadl2_EventDataPort_Context, gen_aadl2_EventDataPort_Data, gen_aadl2_EventDataPort_ParameterConnectionEnd, gen_aadl2_AbstractFeature_DirectedFeature, gen_aadl2_AbstractFeature_TriggerPort, gen_aadl2_FeaturePrototype_Prototype, gen_aadl2_FeatureGroupPrototype_Prototype, gen_aadl2_FeatureGroupPrototype_FeatureType, gen_aadl2_Subcomponent_StructuralFeature, gen_aadl2_Subcomponent_ModalElement, gen_aadl2_Subcomponent_Context, gen_aadl2_Subcomponent_FlowElement, gen_aadl2_Subcomponent_ArrayableElement, gen_aadl2_SubprogramGroupAccess_Access, gen_aadl2_SubprogramGroupAccess_SubprogramGroup, gen_aadl2_SubprogramGroupAccess_CallContext, gen_aadl2_SubprogramGroup_NamedElement, gen_aadl2_SubprogramGroupSubcomponentType_SubcomponentType, gen_aadl2_SubprogramGroupSubcomponentType_SubprogramGroup, gen_aadl2_SubprogramGroupSubcomponentType_FeatureClassifier, gen_aadl2_ModeBinding_Element, gen_aadl2_FlowImplementation_ModalPath, gen_aadl2_FlowImplementation_ClassifierFeature, gen_aadl2_FlowImplementation_Flow, gen_aadl2_FlowSegment_Element, gen_aadl2_Connection_StructuralFeature, gen_aadl2_Connection_ModalPath, gen_aadl2_Connection_FlowElement, gen_aadl2_ImplementationExtension_Generalization, gen_aadl2_Realization_Generalization, gen_aadl2_EndToEndFlow_FlowFeature, gen_aadl2_EndToEndFlow_ModalPath, gen_aadl2_EndToEndFlow_EndToEndFlowElement, gen_aadl2_EndToEndFlowSegment_Element, gen_aadl2_ConnectedElement_Element, gen_aadl2_AbstractSubcomponentType_Abstract, gen_aadl2_AbstractSubcomponentType_SubcomponentType, gen_aadl2_AccessConnection_Connection, gen_aadl2_ParameterConnection_Connection, gen_aadl2_PortConnection_Connection, gen_aadl2_FeatureConnection_Connection, gen_aadl2_FeatureGroupConnection_Connection, gen_aadl2_ProcessorFeature_StructuralFeature, gen_aadl2_ProcessorFeature_ModalElement, gen_aadl2_InternalFeature_StructuralFeature, gen_aadl2_InternalFeature_ModalElement, gen_aadl2_InternalFeature_FeatureConnectionEnd, gen_aadl2_InternalFeature_PortConnectionEnd, gen_aadl2_InternalFeature_TriggerPort, gen_aadl2_EventSource_InternalFeature, gen_aadl2_EventDataSource_InternalFeature, gen_aadl2_DataClassifier_ComponentClassifier, gen_aadl2_DataClassifier_DataSubcomponentType, gen_aadl2_AbstractSubcomponent_Subcomponent, gen_aadl2_AbstractSubcomponent_Abstract, gen_aadl2_Abstract_NamedElement, gen_aadl2_SubprogramClassifier_ComponentClassifier, gen_aadl2_SubprogramClassifier_SubprogramSubcomponentType, gen_aadl2_AnnexLibrary_NamedElement, gen_aadl2_DefaultAnnexLibrary_AnnexLibrary, gen_aadl2_DefaultAnnexSubclause_AnnexSubclause, gen_aadl2_PublicPackageSection_PackageSection, gen_aadl2_PortProxy_ProcessorFeature, gen_aadl2_PortProxy_FeatureConnectionEnd, gen_aadl2_PortProxy_PortConnectionEnd, gen_aadl2_PortProxy_TriggerPort, gen_aadl2_SubprogramProxy_ProcessorFeature, gen_aadl2_SubprogramProxy_AccessConnectionEnd, gen_aadl2_SubprogramProxy_CalledSubprogram, gen_aadl2_PackageRename_NamedElement, gen_aadl2_AadlPackage_ModelUnit, gen_aadl2_PackageSection_Namespace, gen_aadl2_ModelUnit_NamedElement, gen_aadl2_PrivatePackageSection_PackageSection, gen_aadl2_ComponentTypeRename_NamedElement, gen_aadl2_FeatureGroupTypeRename_NamedElement, gen_aadl2_ComponentPrototypeBinding_PrototypeBinding, gen_aadl2_ComponentPrototypeActual_ArrayableElement, gen_aadl2_FeatureGroupPrototypeActual_FeaturePrototypeActual, gen_aadl2_FeaturePrototypeActual_ArrayableElement, gen_aadl2_FeaturePrototypeBinding_PrototypeBinding, gen_aadl2_AccessSpecification_FeaturePrototypeActual, gen_aadl2_PortSpecification_FeaturePrototypeActual, gen_aadl2_FeatureGroupPrototypeBinding_PrototypeBinding, gen_aadl2_FeaturePrototypeReference_FeaturePrototypeActual, gen_aadl2_SubprogramCallSequence_BehavioralFeature, gen_aadl2_SubprogramCallSequence_ModalElement, gen_aadl2_SubprogramCall_BehavioralFeature, gen_aadl2_SubprogramCall_Context, gen_aadl2_BehavioredImplementation_ComponentImplementation, gen_aadl2_AbstractClassifier_SubprogramSubcomponentType, gen_aadl2_AbstractType_ComponentType, gen_aadl2_AbstractClassifier_ComponentClassifier, gen_aadl2_AbstractType_AbstractClassifier, gen_aadl2_AbstractClassifier_AbstractSubcomponentType, gen_aadl2_AbstractType_CallContext, gen_aadl2_AbstractClassifier_BusSubcomponentType, gen_aadl2_AbstractClassifier_DataSubcomponentType, gen_aadl2_AbstractClassifier_DeviceSubcomponentType, gen_aadl2_AbstractClassifier_MemorySubcomponentType, gen_aadl2_AbstractClassifier_ProcessorSubcomponentType, gen_aadl2_AbstractClassifier_ProcessSubcomponentType, gen_aadl2_AbstractClassifier_SubprogramGroupSubcomponentType, gen_aadl2_DeviceSubcomponentType_Device, gen_aadl2_DeviceSubcomponentType_SubcomponentType, gen_aadl2_AbstractClassifier_SystemSubcomponentType, gen_aadl2_Device_NamedElement, gen_aadl2_AbstractClassifier_ThreadGroupSubcomponentType, gen_aadl2_AbstractClassifier_ThreadSubcomponentType, gen_aadl2_ProcessorSubcomponentType_Processor, gen_aadl2_ProcessorSubcomponentType_SubcomponentType, gen_aadl2_AbstractClassifier_VirtualBusSubcomponentType, gen_aadl2_AbstractClassifier_VirtualProcessorSubcomponentType, gen_aadl2_VirtualProcessorSubcomponentType_SubcomponentType, gen_aadl2_VirtualProcessorSubcomponentType_VirtualProcessor, gen_aadl2_VirtualProcessor_NamedElement, gen_aadl2_VirtualBusSubcomponentType_SubcomponentType, gen_aadl2_VirtualBusSubcomponentType_VirtualBus, gen_aadl2_VirtualBus_NamedElement, gen_aadl2_ThreadGroupSubcomponentType_SubcomponentType, gen_aadl2_ThreadGroupSubcomponentType_ThreadGroup, gen_aadl2_ThreadGroup_NamedElement, gen_aadl2_ThreadSubcomponentType_SubcomponentType, gen_aadl2_ThreadSubcomponentType_Thread, gen_aadl2_Thread_NamedElement, gen_aadl2_SystemSubcomponentType_SubcomponentType, gen_aadl2_SystemSubcomponentType_System, gen_aadl2_System_NamedElement, gen_aadl2_ProcessSubcomponentType_Process, gen_aadl2_ProcessSubcomponentType_SubcomponentType, gen_aadl2_Process_NamedElement, gen_aadl2_MemorySubcomponentType_Memory, gen_aadl2_MemorySubcomponentType_SubcomponentType, gen_aadl2_Memory_NamedElement, gen_aadl2_Processor_NamedElement, gen_aadl2_AbstractImplementation_BehavioredImplementation, gen_aadl2_AbstractImplementation_AbstractClassifier, gen_aadl2_DataSubcomponent_Subcomponent, gen_aadl2_BusSubcomponent_Subcomponent, gen_aadl2_BusSubcomponent_AccessConnectionEnd, gen_aadl2_BusSubcomponent_Bus, gen_aadl2_DataSubcomponent_AccessConnectionEnd, gen_aadl2_DataSubcomponent_Data, gen_aadl2_DataSubcomponent_ParameterConnectionEnd, gen_aadl2_DataSubcomponent_PortConnectionEnd, gen_aadl2_DeviceSubcomponent_Subcomponent, gen_aadl2_DeviceSubcomponent_Device, gen_aadl2_MemorySubcomponent_Subcomponent, gen_aadl2_MemorySubcomponent_Memory, gen_aadl2_ProcessSubcomponent_Subcomponent, gen_aadl2_ProcessSubcomponent_Process, gen_aadl2_ProcessorSubcomponent_Subcomponent, gen_aadl2_ProcessorSubcomponent_Processor, gen_aadl2_SystemSubcomponent_Subcomponent, gen_aadl2_SystemSubcomponent_System, gen_aadl2_BusType_ComponentType, gen_aadl2_BusType_BusClassifier, gen_aadl2_SubprogramSubcomponent_Subcomponent, gen_aadl2_SubprogramSubcomponent_AccessConnectionEnd, gen_aadl2_SubprogramSubcomponent_Subprogram, gen_aadl2_SubprogramGroupSubcomponent_Subcomponent, gen_aadl2_SubprogramGroupSubcomponent_AccessConnectionEnd, gen_aadl2_SubprogramGroupSubcomponent_SubprogramGroup, gen_aadl2_SubprogramGroupSubcomponent_CallContext, gen_aadl2_ThreadSubcomponent_Subcomponent, gen_aadl2_ThreadSubcomponent_Thread, gen_aadl2_ThreadGroupSubcomponent_Subcomponent, gen_aadl2_ThreadGroupSubcomponent_ThreadGroup, gen_aadl2_VirtualBusSubcomponent_Subcomponent, gen_aadl2_VirtualBusSubcomponent_VirtualBus, gen_aadl2_VirtualProcessorSubcomponent_Subcomponent, gen_aadl2_VirtualProcessorSubcomponent_VirtualProcessor, gen_aadl2_AbstractPrototype_ComponentPrototype, gen_aadl2_AbstractPrototype_AbstractSubcomponentType, gen_aadl2_AbstractPrototype_BusSubcomponentType, gen_aadl2_AbstractPrototype_DataSubcomponentType, gen_aadl2_AbstractPrototype_DeviceSubcomponentType, gen_aadl2_AbstractPrototype_MemorySubcomponentType, gen_aadl2_AbstractPrototype_ProcessorSubcomponentType, gen_aadl2_AbstractPrototype_ProcessSubcomponentType, gen_aadl2_AbstractPrototype_SubprogramGroupSubcomponentType, gen_aadl2_AbstractPrototype_SubprogramSubcomponentType, gen_aadl2_AbstractPrototype_SystemSubcomponentType, gen_aadl2_AbstractPrototype_ThreadGroupSubcomponentType, gen_aadl2_AbstractPrototype_ThreadSubcomponentType, gen_aadl2_AbstractPrototype_VirtualBusSubcomponentType, gen_aadl2_AbstractPrototype_VirtualProcessorSubcomponentType, gen_aadl2_BusClassifier_ComponentClassifier, gen_aadl2_BusClassifier_BusSubcomponentType, gen_aadl2_DataImplementation_ComponentImplementation, gen_aadl2_DataImplementation_DataClassifier, gen_aadl2_BusImplementation_ComponentImplementation, gen_aadl2_BusImplementation_BusClassifier, gen_aadl2_BusPrototype_ComponentPrototype, gen_aadl2_BusPrototype_BusSubcomponentType, gen_aadl2_DataType_ComponentType, gen_aadl2_DataType_DataClassifier, gen_aadl2_DataType_CallContext, gen_aadl2_DeviceImplementation_ComponentImplementation, gen_aadl2_DataPrototype_ComponentPrototype, gen_aadl2_DataPrototype_DataSubcomponentType, gen_aadl2_DeviceClassifier_ComponentClassifier, gen_aadl2_DeviceClassifier_DeviceSubcomponentType, gen_aadl2_DeviceType_ComponentType, gen_aadl2_DeviceType_DeviceClassifier, gen_aadl2_MemoryImplementation_ComponentImplementation, gen_aadl2_MemoryImplementation_MemoryClassifier, gen_aadl2_DeviceImplementation_DeviceClassifier, gen_aadl2_DevicePrototype_ComponentPrototype, gen_aadl2_DevicePrototype_DeviceSubcomponentType, gen_aadl2_MemoryClassifier_ComponentClassifier, gen_aadl2_MemoryClassifier_MemorySubcomponentType, gen_aadl2_MemoryType_ComponentType, gen_aadl2_MemoryType_MemoryClassifier, gen_aadl2_MemoryPrototype_ComponentPrototype, gen_aadl2_MemoryPrototype_MemorySubcomponentType, gen_aadl2_SubprogramType_ComponentType, gen_aadl2_SubprogramType_SubprogramClassifier, gen_aadl2_SubprogramType_CallContext, gen_aadl2_SubprogramImplementation_BehavioredImplementation, gen_aadl2_SubprogramImplementation_SubprogramClassifier, gen_aadl2_SubprogramGroupPrototype_SubprogramGroupSubcomponentType, gen_aadl2_SystemClassifier_ComponentClassifier, gen_aadl2_SystemClassifier_SystemSubcomponentType, gen_aadl2_SystemType_ComponentType, gen_aadl2_SystemType_SystemClassifier, gen_aadl2_SubprogramPrototype_ComponentPrototype, gen_aadl2_SubprogramPrototype_SubprogramSubcomponentType, gen_aadl2_SubprogramGroupClassifier_ComponentClassifier, gen_aadl2_SubprogramGroupClassifier_SubprogramGroupSubcomponentType, gen_aadl2_SubprogramGroupType_ComponentType, gen_aadl2_SubprogramGroupType_SubprogramGroupClassifier, gen_aadl2_SubprogramGroupType_CallContext, gen_aadl2_SubprogramGroupImplementation_ComponentImplementation, gen_aadl2_SubprogramGroupImplementation_SubprogramGroupClassifier, gen_aadl2_SubprogramGroupPrototype_ComponentPrototype, gen_aadl2_SystemImplementation_ComponentImplementation, gen_aadl2_SystemImplementation_SystemClassifier, gen_aadl2_SystemPrototype_ComponentPrototype, gen_aadl2_SystemPrototype_SystemSubcomponentType, gen_aadl2_ProcessorClassifier_ComponentClassifier, gen_aadl2_ProcessorClassifier_ProcessorSubcomponentType, gen_aadl2_ProcessorType_ComponentType, gen_aadl2_ProcessorType_ProcessorClassifier, gen_aadl2_ProcessClassifier_ComponentClassifier, gen_aadl2_ProcessClassifier_ProcessSubcomponentType, gen_aadl2_ProcessType_ComponentType, gen_aadl2_ProcessType_ProcessClassifier, gen_aadl2_ProcessorImplementation_ComponentImplementation, gen_aadl2_ProcessorImplementation_ProcessorClassifier, gen_aadl2_ProcessorPrototype_ComponentPrototype, gen_aadl2_ProcessorPrototype_ProcessorSubcomponentType, gen_aadl2_ProcessImplementation_ComponentImplementation, gen_aadl2_ProcessImplementation_ProcessClassifier, gen_aadl2_ProcessPrototype_ComponentPrototype, gen_aadl2_ProcessPrototype_ProcessSubcomponentType, gen_aadl2_ThreadClassifier_ComponentClassifier, gen_aadl2_ThreadClassifier_ThreadSubcomponentType, gen_aadl2_ThreadType_ComponentType, gen_aadl2_ThreadType_ThreadClassifier, gen_aadl2_ThreadImplementation_BehavioredImplementation, gen_aadl2_ThreadImplementation_ThreadClassifier, gen_aadl2_ThreadPrototype_ComponentPrototype, gen_aadl2_ThreadPrototype_ThreadSubcomponentType, gen_aadl2_ThreadGroupClassifier_ComponentClassifier, gen_aadl2_ThreadGroupClassifier_ThreadGroupSubcomponentType, gen_aadl2_ThreadGroupType_ComponentType, gen_aadl2_ThreadGroupType_ThreadGroupClassifier, gen_aadl2_ThreadGroupImplementation_ComponentImplementation, gen_aadl2_ThreadGroupImplementation_ThreadGroupClassifier, gen_aadl2_ThreadGroupPrototype_ComponentPrototype, gen_aadl2_ThreadGroupPrototype_ThreadGroupSubcomponentType, gen_aadl2_VirtualBusImplementation_ComponentImplementation, gen_aadl2_VirtualBusImplementation_VirtualBusClassifier, gen_aadl2_VirtualBusPrototype_ComponentPrototype, gen_aadl2_VirtualBusPrototype_VirtualBusSubcomponentType, gen_aadl2_VirtualProcessorClassifier_ComponentClassifier, gen_aadl2_VirtualProcessorClassifier_VirtualProcessorSubcomponentType, gen_aadl2_VirtualProcessorType_ComponentType, gen_aadl2_VirtualProcessorType_VirtualProcessorClassifier, gen_aadl2_VirtualBusClassifier_ComponentClassifier, gen_aadl2_VirtualBusClassifier_VirtualBusSubcomponentType, gen_aadl2_VirtualBusType_ComponentType, gen_aadl2_VirtualBusType_VirtualBusClassifier, gen_aadl2_VirtualProcessorImplementation_ComponentImplementation, gen_aadl2_VirtualProcessorImplementation_VirtualProcessorClassifier, gen_aadl2_VirtualProcessorPrototype_ComponentPrototype, gen_aadl2_VirtualProcessorPrototype_VirtualProcessorSubcomponentType, gen_aadl2_PropertyConstant_TypedElement, gen_aadl2_PropertyConstant_AbstractNamedValue, gen_aadl2_PropertyConstant_ArraySizeProperty, gen_aadl2_StringLiteral_PropertyValue, gen_aadl2_PropertyValue_PropertyExpression, gen_aadl2_NumberValue_PropertyValue, gen_aadl2_BasicPropertyAssociation_Element, gen_aadl2_EnumerationLiteral_NamedElement, gen_aadl2_EnumerationLiteral_AbstractNamedValue, gen_aadl2_ClassifierValue_PropertyOwner, gen_aadl2_ClassifierValue_PropertyValue, gen_aadl2_ReferenceValue_ContainedNamedElement, gen_aadl2_ReferenceValue_PropertyValue, gen_aadl2_BooleanLiteral_PropertyValue, gen_aadl2_RangeValue_PropertyValue, gen_aadl2_UnitLiteral_EnumerationLiteral, gen_aadl2_RecordValue_PropertyValue, gen_aadl2_ComputedValue_PropertyValue, gen_aadl2_ListValue_PropertyExpression, gen_aadl2_NamedValue_PropertyValue, gen_aadl2_PropertySet_Namespace, gen_aadl2_PropertySet_ModelUnit, gen_aadl2_IntegerLiteral_NumberValue, gen_aadl2_RealLiteral_NumberValue, gen_aadl2_Operation_PropertyExpression, gen_aadl2_GlobalNamespace_Namespace, gen_aadl2_NonListType_PropertyType, gen_aadl2_AadlBoolean_NonListType, gen_aadl2_AadlString_NonListType, gen_aadl2_AadlInteger_NumberType, gen_aadl2_NumberType_NonListType, gen_aadl2_NumericRange_Element, gen_aadl2_AadlReal_NumberType, gen_aadl2_ClassifierType_NonListType, gen_aadl2_RangeType_NonListType, gen_aadl2_UnitsType_EnumerationType, gen_aadl2_EnumerationType_Namespace, gen_aadl2_EnumerationType_NonListType, gen_aadl2_ListType_PropertyType, gen_aadl2_RecordType_Namespace, gen_aadl2_RecordType_NonListType, gen_aadl2_RecordField_BasicProperty, gen_aadl2_ReferenceType_NonListType},
    metadata=None
)
