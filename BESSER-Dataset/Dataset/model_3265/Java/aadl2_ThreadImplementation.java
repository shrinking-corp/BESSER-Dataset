...
public class aadl2_ThreadImplementation extends ThreadClassifier, BehavioredImplementation {
    ...
    public aadl2_ThreadImplementation(
    ) {
        super(
        );
    ...
    public aadl2_ThreadImplementation(
        ArrayList<aadl2_DataSubcomponent> aadl2_datasubcomponents,        ArrayList<aadl2_SubprogramGroupSubcomponent> aadl2_subprogramgroupsubcomponents,        ArrayList<aadl2_SubprogramSubcomponent> aadl2_subprogramsubcomponents    ) {
