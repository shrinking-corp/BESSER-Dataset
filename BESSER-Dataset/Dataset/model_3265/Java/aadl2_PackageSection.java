...
public class aadl2_PackageSection extends Namespace {
    ...
    public aadl2_PackageSection(
        String noAnnexes,        String noProperties        ArrayList<aadl2_AnnexLibrary> aadl2_annexlibrarys,        ArrayList<aadl2_Classifier> aadl2_classifiers,        ArrayList<aadl2_PackageRename> aadl2_packagerenames,        ArrayList<aadl2_ModelUnit> aadl2_modelunits,        ArrayList<aadl2_FeatureGroupTypeRename> aadl2_featuregrouptyperenames,        ArrayList<aadl2_ComponentTypeRename> aadl2_componenttyperenames    ) {
        this.noAnnexes = noAnnexes;
        this.noProperties = noProperties;
