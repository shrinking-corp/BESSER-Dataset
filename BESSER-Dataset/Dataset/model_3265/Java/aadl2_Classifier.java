...
public class aadl2_Classifier extends Type, Namespace {
    ...
    public aadl2_Classifier(
        String noPrototypes,        String noProperties,        String noAnnexes        ArrayList<aadl2_NamedElement> aadl2_namedelements,        ArrayList<aadl2_ClassifierFeature> aadl2_classifierfeatures,        ArrayList<aadl2_Classifier> aadl2_classifiers,        ArrayList<aadl2_PrototypeBinding> aadl2_prototypebindings    ) {
        this.noPrototypes = noPrototypes;
        this.noProperties = noProperties;
        this.noAnnexes = noAnnexes;
