...
public class aadl2_AbstractImplementation extends AbstractClassifier, BehavioredImplementation {
    ...
    public aadl2_AbstractImplementation(
        ArrayList<aadl2_ProcessSubcomponent> aadl2_processsubcomponents,        ArrayList<aadl2_SubprogramGroupSubcomponent> aadl2_subprogramgroupsubcomponents,        ArrayList<aadl2_DataSubcomponent> aadl2_datasubcomponents,        ArrayList<aadl2_ProcessorSubcomponent> aadl2_processorsubcomponents,        ArrayList<aadl2_SystemSubcomponent> aadl2_systemsubcomponents,        ArrayList<aadl2_SubprogramSubcomponent> aadl2_subprogramsubcomponents,        ArrayList<aadl2_ThreadSubcomponent> aadl2_threadsubcomponents,        ArrayList<aadl2_DeviceSubcomponent> aadl2_devicesubcomponents,        ArrayList<aadl2_ThreadGroupSubcomponent> aadl2_threadgroupsubcomponents,        ArrayList<aadl2_VirtualProcessorSubcomponent> aadl2_virtualprocessorsubcomponents,        ArrayList<aadl2_VirtualBusSubcomponent> aadl2_virtualbussubcomponents,        ArrayList<aadl2_MemorySubcomponent> aadl2_memorysubcomponents,        ArrayList<aadl2_BusSubcomponent> aadl2_bussubcomponents    ) {
