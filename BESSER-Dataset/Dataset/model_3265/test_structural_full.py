...
def test_aadl2_InternalFeature_direction_value_roundtrip():
    instance = aadl2_InternalFeature(direction="sample_text")
    assert instance.direction == "sample_text"
    instance.direction = "sample_text_2"
    assert instance.direction == "sample_text_2"
...
def test_aadl2_PortProxy_direction_value_roundtrip():
    instance = aadl2_PortProxy(direction="sample_text")
    assert instance.direction == "sample_text"
    instance.direction = "sample_text_2"
    assert instance.direction == "sample_text_2"
...
def test_aadl2_AbstractSubcomponentType_isa_Abstract():
...
def test_aadl2_Property_isa_ArraySizeProperty():
    instance = aadl2_Property(emptyListDefault="sample_text", inherit="sample_text")
...
def test_aadl2_BusAccess_isa_Bus():
    instance = aadl2_BusAccess()
...
def test_aadl2_BusSubcomponentType_isa_Bus():
...
def test_aadl2_DataAccess_isa_Data():
    instance = aadl2_DataAccess()
    assert isinstance(instance, Data)


def test_aadl2_DataPort_isa_Data():
    instance = aadl2_DataPort()
    assert isinstance(instance, Data)
...
def test_aadl2_DataSubcomponentType_isa_Data():
    instance = aadl2_DataSubcomponentType()
    assert isinstance(instance, Data)


def test_aadl2_EventDataPort_isa_Data():
    instance = aadl2_EventDataPort()
    assert isinstance(instance, Data)
...
def test_aadl2_DeviceSubcomponentType_isa_Device():
...
def test_aadl2_BusSubcomponentType_isa_FeatureClassifier():
    instance = aadl2_BusSubcomponentType()
...
def test_aadl2_DataSubcomponentType_isa_FeatureClassifier():
    instance = aadl2_DataSubcomponentType()
    assert isinstance(instance, FeatureClassifier)


def test_aadl2_SubprogramGroupSubcomponentType_isa_FeatureClassifier():
    instance = aadl2_SubprogramGroupSubcomponentType()
    assert isinstance(instance, FeatureClassifier)


def test_aadl2_SubprogramSubcomponentType_isa_FeatureClassifier():
...
def test_aadl2_MemorySubcomponentType_isa_Memory():
...
def test_aadl2_InternalFeature_isa_ModalElement():
    instance = aadl2_InternalFeature(direction="sample_text")
    assert isinstance(instance, ModalElement)
...
def test_aadl2_ProcessorFeature_isa_ModalElement():
...
def test_aadl2_ProcessSubcomponentType_isa_Process():
...
def test_aadl2_ProcessorSubcomponentType_isa_Processor():
...
def test_aadl2_SubprogramAccess_isa_Subprogram():
    instance = aadl2_SubprogramAccess()
...
def test_aadl2_SubprogramSubcomponentType_isa_Subprogram():
    instance = aadl2_SubprogramSubcomponentType()
    assert isinstance(instance, Subprogram)
...
def test_aadl2_SubprogramGroupAccess_isa_SubprogramGroup():
    instance = aadl2_SubprogramGroupAccess()
...
def test_aadl2_SubprogramGroupSubcomponentType_isa_SubprogramGroup():
    instance = aadl2_SubprogramGroupSubcomponentType()
    assert isinstance(instance, SubprogramGroup)
...
def test_aadl2_SystemSubcomponentType_isa_System():
    instance = aadl2_SystemSubcomponentType()
    assert isinstance(instance, System)
...
def test_aadl2_ThreadSubcomponentType_isa_Thread():
    instance = aadl2_ThreadSubcomponentType()
    assert isinstance(instance, Thread)
...
def test_aadl2_ThreadGroupSubcomponentType_isa_ThreadGroup():
    instance = aadl2_ThreadGroupSubcomponentType()
    assert isinstance(instance, ThreadGroup)
...
def test_aadl2_VirtualBusSubcomponentType_isa_VirtualBus():
    instance = aadl2_VirtualBusSubcomponentType()
    assert isinstance(instance, VirtualBus)
...
def test_aadl2_VirtualProcessorSubcomponentType_isa_VirtualProcessor():
    instance = aadl2_VirtualProcessorSubcomponentType()
    assert isinstance(instance, VirtualProcessor)
...
def test_assoc_InEnd177_link_reassign_clear():
    a = aadl2_FlowSpecification(kind="sample_text")
    b1 = aadl2_FlowEnd()
    b2 = aadl2_FlowEnd()
    _safe_set(a, 'aadl2_FlowSpecification178', b1)
    assert _is_linked(a, 'aadl2_FlowSpecification178', b1)
    if hasattr(b1, 'aadl2_FlowEnd179'):
        assert _is_linked(b1, 'aadl2_FlowEnd179', a)
    _safe_set(a, 'aadl2_FlowSpecification178', b2)
    assert _is_linked(a, 'aadl2_FlowSpecification178', b2)
    if hasattr(b1, 'aadl2_FlowEnd179'):
        assert not _is_linked(b1, 'aadl2_FlowEnd179', a)
    if hasattr(b2, 'aadl2_FlowEnd179'):
        assert _is_linked(b2, 'aadl2_FlowEnd179', a)
    _safe_set(a, 'aadl2_FlowSpecification178', None)
    assert not _is_linked(a, 'aadl2_FlowSpecification178', b2)
    if hasattr(b2, 'aadl2_FlowEnd179'):
        assert not _is_linked(b2, 'aadl2_FlowEnd179', a)


def test_assoc_actual366_link_reassign_clear():
...
def test_assoc_arrayRange72_link_reassign_clear():
    ...
    _safe_set(a, 'aadl2_ContainmentPathElement73', {b1})
    assert _is_linked(a, 'aadl2_ContainmentPathElement73', b1)
    if hasattr(b1, 'aadl2_ArrayRange'):
        assert _is_linked(b1, 'aadl2_ArrayRange', a)
    _safe_set(a, 'aadl2_ContainmentPathElement73', {b2})
    assert _is_linked(a, 'aadl2_ContainmentPathElement73', b2)
    if hasattr(b1, 'aadl2_ArrayRange'):
        assert not _is_linked(b1, 'aadl2_ArrayRange', a)
    if hasattr(b2, 'aadl2_ArrayRange'):
        assert _is_linked(b2, 'aadl2_ArrayRange', a)
    _safe_set(a, 'aadl2_ContainmentPathElement73', set())
    assert not _is_linked(a, 'aadl2_ContainmentPathElement73', b2)
    if hasattr(b2, 'aadl2_ArrayRange'):
        assert not _is_linked(b2, 'aadl2_ArrayRange', a)


def test_assoc_baseUnit791_link_reassign_clear():
    a = aadl2_UnitLiteral()
    b1 = aadl2_UnitLiteral()
    b2 = aadl2_UnitLiteral()
    _safe_set(a, 'aadl2_UnitLiteral790', b1)
    assert _is_linked(a, 'aadl2_UnitLiteral790', b1)
    if hasattr(b1, 'aadl2_UnitLiteral792'):
        assert _is_linked(b1, 'aadl2_UnitLiteral792', a)
    _safe_set(a, 'aadl2_UnitLiteral790', b2)
    assert _is_linked(a, 'aadl2_UnitLiteral790', b2)
    if hasattr(b1, 'aadl2_UnitLiteral792'):
        assert not _is_linked(b1, 'aadl2_UnitLiteral792', a)
    if hasattr(b2, 'aadl2_UnitLiteral792'):
        assert _is_linked(b2, 'aadl2_UnitLiteral792', a)
    _safe_set(a, 'aadl2_UnitLiteral790', None)
    assert not _is_linked(a, 'aadl2_UnitLiteral790', b2)
    if hasattr(b2, 'aadl2_UnitLiteral792'):
        assert not _is_linked(b2, 'aadl2_UnitLiteral792', a)


def test_assoc_binding367_link_reassign_clear():
    a = aadl2_ComponentPrototypeActual(category="sample_text")
    b1 = aadl2_PrototypeBinding()
    b2 = aadl2_PrototypeBinding()
    _safe_set(a, 'aadl2_ComponentPrototypeActual368', {b1})
    assert _is_linked(a, 'aadl2_ComponentPrototypeActual368', b1)
    if hasattr(b1, 'aadl2_PrototypeBinding369'):
        assert _is_linked(b1, 'aadl2_PrototypeBinding369', a)
    _safe_set(a, 'aadl2_ComponentPrototypeActual368', {b2})
    assert _is_linked(a, 'aadl2_ComponentPrototypeActual368', b2)
    if hasattr(b1, 'aadl2_PrototypeBinding369'):
        assert not _is_linked(b1, 'aadl2_PrototypeBinding369', a)
    if hasattr(b2, 'aadl2_PrototypeBinding369'):
        assert _is_linked(b2, 'aadl2_PrototypeBinding369', a)
    _safe_set(a, 'aadl2_ComponentPrototypeActual368', set())
    assert not _is_linked(a, 'aadl2_ComponentPrototypeActual368', b2)
    if hasattr(b2, 'aadl2_PrototypeBinding369'):
        assert not _is_linked(b2, 'aadl2_PrototypeBinding369', a)


def test_assoc_classifier166_link_reassign_clear():
    a = aadl2_Classifier(noAnnexes="sample_text", noProperties="sample_text", noPrototypes="sample_text")
    b1 = aadl2_Feature()
    b2 = aadl2_Feature()
    _safe_set(a, 'aadl2_Classifier168', b1)
    assert _is_linked(a, 'aadl2_Classifier168', b1)
    if hasattr(b1, 'aadl2_Feature167'):
        assert _is_linked(b1, 'aadl2_Feature167', a)
    _safe_set(a, 'aadl2_Classifier168', b2)
    assert _is_linked(a, 'aadl2_Classifier168', b2)
    if hasattr(b1, 'aadl2_Feature167'):
        assert not _is_linked(b1, 'aadl2_Feature167', a)
    if hasattr(b2, 'aadl2_Feature167'):
        assert _is_linked(b2, 'aadl2_Feature167', a)
    _safe_set(a, 'aadl2_Classifier168', None)
    assert not _is_linked(a, 'aadl2_Classifier168', b2)
    if hasattr(b2, 'aadl2_Feature167'):
        assert not _is_linked(b2, 'aadl2_Feature167', a)


def test_assoc_classifier273_link_reassign_clear():
    ...
    if hasattr(b1, 'aadl2_ComponentClassifier275'):
        assert _is_linked(b1, 'aadl2_ComponentClassifier275', a)
    _safe_set(a, 'aadl2_Subcomponent274', b2)
    assert _is_linked(a, 'aadl2_Subcomponent274', b2)
    if hasattr(b1, 'aadl2_ComponentClassifier275'):
        assert not _is_linked(b1, 'aadl2_ComponentClassifier275', a)
    if hasattr(b2, 'aadl2_ComponentClassifier275'):
        assert _is_linked(b2, 'aadl2_ComponentClassifier275', a)
    _safe_set(a, 'aadl2_Subcomponent274', None)
    assert not _is_linked(a, 'aadl2_Subcomponent274', b2)
    if hasattr(b2, 'aadl2_ComponentClassifier275'):
        assert not _is_linked(b2, 'aadl2_ComponentClassifier275', a)


def test_assoc_classifier381_link_reassign_clear():
    ...
    _safe_set(a, 'aadl2_ComponentClassifier382', b1)
    assert _is_linked(a, 'aadl2_ComponentClassifier382', b1)
    if hasattr(b1, 'aadl2_AccessSpecification'):
        assert _is_linked(b1, 'aadl2_AccessSpecification', a)
    _safe_set(a, 'aadl2_ComponentClassifier382', b2)
    assert _is_linked(a, 'aadl2_ComponentClassifier382', b2)
    if hasattr(b1, 'aadl2_AccessSpecification'):
    ...
    _safe_set(a, 'aadl2_ComponentClassifier382', None)
    assert not _is_linked(a, 'aadl2_ComponentClassifier382', b2)
    if hasattr(b2, 'aadl2_AccessSpecification'):
        assert not _is_linked(b2, 'aadl2_AccessSpecification', a)


def test_assoc_classifier386_link_reassign_clear():
    ...
    if hasattr(b1, 'aadl2_ComponentClassifier387'):
        assert _is_linked(b1, 'aadl2_ComponentClassifier387', a)
    _safe_set(a, 'aadl2_PortSpecification', b2)
    assert _is_linked(a, 'aadl2_PortSpecification', b2)
    if hasattr(b1, 'aadl2_ComponentClassifier387'):
        assert not _is_linked(b1, 'aadl2_ComponentClassifier387', a)
    if hasattr(b2, 'aadl2_ComponentClassifier387'):
        assert _is_linked(b2, 'aadl2_ComponentClassifier387', a)
    _safe_set(a, 'aadl2_PortSpecification', None)
    assert not _is_linked(a, 'aadl2_PortSpecification', b2)
    if hasattr(b2, 'aadl2_ComponentClassifier387'):
        assert not _is_linked(b2, 'aadl2_ComponentClassifier387', a)


def test_assoc_classifier796_link_reassign_clear():
    a = aadl2_Classifier(noAnnexes="sample_text", noProperties="sample_text", noPrototypes="sample_text")
    b1 = aadl2_ClassifierValue()
    b2 = aadl2_ClassifierValue()
    _safe_set(a, 'aadl2_Classifier797', b1)
    assert _is_linked(a, 'aadl2_Classifier797', b1)
    if hasattr(b1, 'aadl2_ClassifierValue'):
        assert _is_linked(b1, 'aadl2_ClassifierValue', a)
    _safe_set(a, 'aadl2_Classifier797', b2)
    assert _is_linked(a, 'aadl2_Classifier797', b2)
    if hasattr(b1, 'aadl2_ClassifierValue'):
    ...
    _safe_set(a, 'aadl2_Classifier797', None)
    assert not _is_linked(a, 'aadl2_Classifier797', b2)
    if hasattr(b2, 'aadl2_ClassifierValue'):
        assert not _is_linked(b2, 'aadl2_ClassifierValue', a)


def test_assoc_classifierFeature27_link_reassign_clear():
    a = aadl2_Classifier(noAnnexes="sample_text", noProperties="sample_text", noPrototypes="sample_text")
...
def test_assoc_classifierReference845_link_reassign_clear():
    a = aadl2_MetaclassReference(annexName="sample_text", metaclassName="sample_text")
    b1 = aadl2_ClassifierType()
    b2 = aadl2_ClassifierType()
    _safe_set(a, 'aadl2_MetaclassReference846', b1)
    assert _is_linked(a, 'aadl2_MetaclassReference846', b1)
    if hasattr(b1, 'aadl2_ClassifierType'):
        assert _is_linked(b1, 'aadl2_ClassifierType', a)
    _safe_set(a, 'aadl2_MetaclassReference846', b2)
    assert _is_linked(a, 'aadl2_MetaclassReference846', b2)
    if hasattr(b1, 'aadl2_ClassifierType'):
    ...
    _safe_set(a, 'aadl2_MetaclassReference846', None)
    assert not _is_linked(a, 'aadl2_MetaclassReference846', b2)
    if hasattr(b2, 'aadl2_ClassifierType'):
        assert not _is_linked(b2, 'aadl2_ClassifierType', a)


def test_assoc_componentPrototype383_link_reassign_clear():
    a = aadl2_ComponentPrototype(array="sample_text")
    b1 = aadl2_AccessSpecification(category="sample_text", kind="sample_text")
    b2 = aadl2_AccessSpecification(category="sample_text_2", kind="sample_text_2")
    _safe_set(a, 'aadl2_ComponentPrototype385', b1)
    assert _is_linked(a, 'aadl2_ComponentPrototype385', b1)
    if hasattr(b1, 'aadl2_AccessSpecification384'):
        assert _is_linked(b1, 'aadl2_AccessSpecification384', a)
    _safe_set(a, 'aadl2_ComponentPrototype385', b2)
    assert _is_linked(a, 'aadl2_ComponentPrototype385', b2)
    if hasattr(b1, 'aadl2_AccessSpecification384'):
        assert not _is_linked(b1, 'aadl2_AccessSpecification384', a)
    if hasattr(b2, 'aadl2_AccessSpecification384'):
        assert _is_linked(b2, 'aadl2_AccessSpecification384', a)
    _safe_set(a, 'aadl2_ComponentPrototype385', None)
    assert not _is_linked(a, 'aadl2_ComponentPrototype385', b2)
    if hasattr(b2, 'aadl2_AccessSpecification384'):
        assert not _is_linked(b2, 'aadl2_AccessSpecification384', a)


def test_assoc_componentPrototype388_link_reassign_clear():
    a = aadl2_PortSpecification(category="sample_text", direction="sample_text")
    b1 = aadl2_ComponentPrototype(array="sample_text")
    b2 = aadl2_ComponentPrototype(array="sample_text_2")
    _safe_set(a, 'aadl2_PortSpecification389', b1)
    assert _is_linked(a, 'aadl2_PortSpecification389', b1)
    if hasattr(b1, 'aadl2_ComponentPrototype390'):
        assert _is_linked(b1, 'aadl2_ComponentPrototype390', a)
    _safe_set(a, 'aadl2_PortSpecification389', b2)
    assert _is_linked(a, 'aadl2_PortSpecification389', b2)
    if hasattr(b1, 'aadl2_ComponentPrototype390'):
        assert not _is_linked(b1, 'aadl2_ComponentPrototype390', a)
    if hasattr(b2, 'aadl2_ComponentPrototype390'):
        assert _is_linked(b2, 'aadl2_ComponentPrototype390', a)
    _safe_set(a, 'aadl2_PortSpecification389', None)
    assert not _is_linked(a, 'aadl2_PortSpecification389', b2)
    if hasattr(b2, 'aadl2_ComponentPrototype390'):
        assert not _is_linked(b2, 'aadl2_ComponentPrototype390', a)


def test_assoc_constrainingClassifier169_link_reassign_clear():
    a = aadl2_ComponentPrototype(array="sample_text")
    b1 = aadl2_ComponentClassifier(derivedModes="sample_text", noFlows="sample_text", noModes="sample_text")
    b2 = aadl2_ComponentClassifier(derivedModes="sample_text_2", noFlows="sample_text_2", noModes="sample_text_2")
    _safe_set(a, 'aadl2_ComponentPrototype170', b1)
    assert _is_linked(a, 'aadl2_ComponentPrototype170', b1)
    if hasattr(b1, 'aadl2_ComponentClassifier171'):
        assert _is_linked(b1, 'aadl2_ComponentClassifier171', a)
    _safe_set(a, 'aadl2_ComponentPrototype170', b2)
    assert _is_linked(a, 'aadl2_ComponentPrototype170', b2)
    if hasattr(b1, 'aadl2_ComponentClassifier171'):
        assert not _is_linked(b1, 'aadl2_ComponentClassifier171', a)
    if hasattr(b2, 'aadl2_ComponentClassifier171'):
        assert _is_linked(b2, 'aadl2_ComponentClassifier171', a)
    _safe_set(a, 'aadl2_ComponentPrototype170', None)
    assert not _is_linked(a, 'aadl2_ComponentPrototype170', b2)
    if hasattr(b2, 'aadl2_ComponentClassifier171'):
        assert not _is_linked(b2, 'aadl2_ComponentClassifier171', a)


def test_assoc_constrainingClassifier251_link_reassign_clear():
    a = aadl2_FeaturePrototype(direction="sample_text")
    b1 = aadl2_ComponentClassifier(derivedModes="sample_text", noFlows="sample_text", noModes="sample_text")
    b2 = aadl2_ComponentClassifier(derivedModes="sample_text_2", noFlows="sample_text_2", noModes="sample_text_2")
    _safe_set(a, 'aadl2_FeaturePrototype252', b1)
    assert _is_linked(a, 'aadl2_FeaturePrototype252', b1)
    if hasattr(b1, 'aadl2_ComponentClassifier253'):
        assert _is_linked(b1, 'aadl2_ComponentClassifier253', a)
    _safe_set(a, 'aadl2_FeaturePrototype252', b2)
    assert _is_linked(a, 'aadl2_FeaturePrototype252', b2)
    if hasattr(b1, 'aadl2_ComponentClassifier253'):
        assert not _is_linked(b1, 'aadl2_ComponentClassifier253', a)
    if hasattr(b2, 'aadl2_ComponentClassifier253'):
        assert _is_linked(b2, 'aadl2_ComponentClassifier253', a)
    _safe_set(a, 'aadl2_FeaturePrototype252', None)
    assert not _is_linked(a, 'aadl2_FeaturePrototype252', b2)
    if hasattr(b2, 'aadl2_ComponentClassifier253'):
        assert not _is_linked(b2, 'aadl2_ComponentClassifier253', a)


def test_assoc_containmentPathElement70_link_reassign_clear():
    a = aadl2_ContainmentPathElement(annexName="sample_text")
    b1 = aadl2_ContainedNamedElement()
    b2 = aadl2_ContainedNamedElement()
    _safe_set(a, 'aadl2_ContainmentPathElement', b1)
    assert _is_linked(a, 'aadl2_ContainmentPathElement', b1)
    if hasattr(b1, 'aadl2_ContainedNamedElement71'):
        assert _is_linked(b1, 'aadl2_ContainedNamedElement71', a)
    _safe_set(a, 'aadl2_ContainmentPathElement', b2)
    assert _is_linked(a, 'aadl2_ContainmentPathElement', b2)
    if hasattr(b1, 'aadl2_ContainedNamedElement71'):
        assert not _is_linked(b1, 'aadl2_ContainedNamedElement71', a)
    if hasattr(b2, 'aadl2_ContainedNamedElement71'):
        assert _is_linked(b2, 'aadl2_ContainedNamedElement71', a)
    _safe_set(a, 'aadl2_ContainmentPathElement', None)
    assert not _is_linked(a, 'aadl2_ContainmentPathElement', b2)
    if hasattr(b2, 'aadl2_ContainedNamedElement71'):
        assert not _is_linked(b2, 'aadl2_ContainedNamedElement71', a)


def test_assoc_dataClassifier325_link_reassign_clear():
    a = aadl2_PortProxy(direction="sample_text")
    b1 = aadl2_DataClassifier()
    b2 = aadl2_DataClassifier()
    _safe_set(a, 'aadl2_PortProxy326', b1)
    assert _is_linked(a, 'aadl2_PortProxy326', b1)
    if hasattr(b1, 'aadl2_DataClassifier327'):
        assert _is_linked(b1, 'aadl2_DataClassifier327', a)
    _safe_set(a, 'aadl2_PortProxy326', b2)
    assert _is_linked(a, 'aadl2_PortProxy326', b2)
    if hasattr(b1, 'aadl2_DataClassifier327'):
        assert not _is_linked(b1, 'aadl2_DataClassifier327', a)
    if hasattr(b2, 'aadl2_DataClassifier327'):
        assert _is_linked(b2, 'aadl2_DataClassifier327', a)
    _safe_set(a, 'aadl2_PortProxy326', None)
    assert not _is_linked(a, 'aadl2_PortProxy326', b2)
    if hasattr(b2, 'aadl2_DataClassifier327'):
        assert not _is_linked(b2, 'aadl2_DataClassifier327', a)
...
def test_assoc_derivedMode279_link_reassign_clear():
    a = aadl2_Mode(derived="sample_text", initial="sample_text")
    b1 = aadl2_ModeBinding()
    b2 = aadl2_ModeBinding()
    _safe_set(a, 'aadl2_Mode281', b1)
    assert _is_linked(a, 'aadl2_Mode281', b1)
    if hasattr(b1, 'aadl2_ModeBinding280'):
        assert _is_linked(b1, 'aadl2_ModeBinding280', a)
    _safe_set(a, 'aadl2_Mode281', b2)
    assert _is_linked(a, 'aadl2_Mode281', b2)
    if hasattr(b1, 'aadl2_ModeBinding280'):
        assert not _is_linked(b1, 'aadl2_ModeBinding280', a)
    if hasattr(b2, 'aadl2_ModeBinding280'):
        assert _is_linked(b2, 'aadl2_ModeBinding280', a)
    _safe_set(a, 'aadl2_Mode281', None)
    assert not _is_linked(a, 'aadl2_Mode281', b2)
    if hasattr(b2, 'aadl2_ModeBinding280'):
        assert not _is_linked(b2, 'aadl2_ModeBinding280', a)


def test_assoc_destination137_link_reassign_clear():
    a = aadl2_Mode(derived="sample_text", initial="sample_text")
    b1 = aadl2_ModeTransition()
    b2 = aadl2_ModeTransition()
    _safe_set(a, 'aadl2_Mode139', b1)
    assert _is_linked(a, 'aadl2_Mode139', b1)
    if hasattr(b1, 'aadl2_ModeTransition138'):
        assert _is_linked(b1, 'aadl2_ModeTransition138', a)
    _safe_set(a, 'aadl2_Mode139', b2)
    assert _is_linked(a, 'aadl2_Mode139', b2)
    if hasattr(b1, 'aadl2_ModeTransition138'):
        assert not _is_linked(b1, 'aadl2_ModeTransition138', a)
    if hasattr(b2, 'aadl2_ModeTransition138'):
        assert _is_linked(b2, 'aadl2_ModeTransition138', a)
    _safe_set(a, 'aadl2_Mode139', None)
    assert not _is_linked(a, 'aadl2_Mode139', b2)
    if hasattr(b2, 'aadl2_ModeTransition138'):
        assert not _is_linked(b2, 'aadl2_ModeTransition138', a)


def test_assoc_destination292_link_reassign_clear():
    a = aadl2_Connection(bidirectional="sample_text")
    b1 = aadl2_ConnectedElement()
    b2 = aadl2_ConnectedElement()
    _safe_set(a, 'aadl2_Connection293', b1)
    assert _is_linked(a, 'aadl2_Connection293', b1)
    if hasattr(b1, 'aadl2_ConnectedElement'):
        assert _is_linked(b1, 'aadl2_ConnectedElement', a)
    _safe_set(a, 'aadl2_Connection293', b2)
    assert _is_linked(a, 'aadl2_Connection293', b2)
    if hasattr(b1, 'aadl2_ConnectedElement'):
    ...
    _safe_set(a, 'aadl2_Connection293', None)
    assert not _is_linked(a, 'aadl2_Connection293', b2)
    if hasattr(b2, 'aadl2_ConnectedElement'):
        assert not _is_linked(b2, 'aadl2_ConnectedElement', a)


def test_assoc_extended149_link_reassign_clear():
    ...
    _safe_set(a, 'aadl2_ComponentType148', b1)
    assert _is_linked(a, 'aadl2_ComponentType148', b1)
    if hasattr(b1, 'aadl2_ComponentType150'):
        assert _is_linked(b1, 'aadl2_ComponentType150', a)
    _safe_set(a, 'aadl2_ComponentType148', b2)
    assert _is_linked(a, 'aadl2_ComponentType148', b2)
    if hasattr(b1, 'aadl2_ComponentType150'):
        assert not _is_linked(b1, 'aadl2_ComponentType150', a)
    if hasattr(b2, 'aadl2_ComponentType150'):
        assert _is_linked(b2, 'aadl2_ComponentType150', a)
    _safe_set(a, 'aadl2_ComponentType148', None)
    assert not _is_linked(a, 'aadl2_ComponentType148', b2)
    if hasattr(b2, 'aadl2_ComponentType150'):
        assert not _is_linked(b2, 'aadl2_ComponentType150', a)


def test_assoc_extended187_link_reassign_clear():
    a = aadl2_ComponentType(noFeatures="sample_text")
    b1 = aadl2_TypeExtension()
    b2 = aadl2_TypeExtension()
    _safe_set(a, 'aadl2_ComponentType189', b1)
    assert _is_linked(a, 'aadl2_ComponentType189', b1)
    if hasattr(b1, 'aadl2_TypeExtension188'):
        assert _is_linked(b1, 'aadl2_TypeExtension188', a)
    _safe_set(a, 'aadl2_ComponentType189', b2)
    assert _is_linked(a, 'aadl2_ComponentType189', b2)
    if hasattr(b1, 'aadl2_TypeExtension188'):
        assert not _is_linked(b1, 'aadl2_TypeExtension188', a)
    if hasattr(b2, 'aadl2_TypeExtension188'):
        assert _is_linked(b2, 'aadl2_TypeExtension188', a)
    _safe_set(a, 'aadl2_ComponentType189', None)
    assert not _is_linked(a, 'aadl2_ComponentType189', b2)
    if hasattr(b2, 'aadl2_TypeExtension188'):
        assert not _is_linked(b2, 'aadl2_TypeExtension188', a)


def test_assoc_extended305_link_reassign_clear():
    ...
    _safe_set(a, 'aadl2_ComponentImplementation307', b1)
    assert _is_linked(a, 'aadl2_ComponentImplementation307', b1)
    if hasattr(b1, 'aadl2_ImplementationExtension306'):
        assert _is_linked(b1, 'aadl2_ImplementationExtension306', a)
    _safe_set(a, 'aadl2_ComponentImplementation307', b2)
    assert _is_linked(a, 'aadl2_ComponentImplementation307', b2)
    if hasattr(b1, 'aadl2_ImplementationExtension306'):
        assert not _is_linked(b1, 'aadl2_ImplementationExtension306', a)
    if hasattr(b2, 'aadl2_ImplementationExtension306'):
        assert _is_linked(b2, 'aadl2_ImplementationExtension306', a)
    _safe_set(a, 'aadl2_ComponentImplementation307', None)
    assert not _is_linked(a, 'aadl2_ComponentImplementation307', b2)
    if hasattr(b2, 'aadl2_ImplementationExtension306'):
        assert not _is_linked(b2, 'aadl2_ImplementationExtension306', a)


def test_assoc_extended94_link_reassign_clear():
    a = aadl2_ComponentImplementation(noCalls="sample_text", noConnections="sample_text", noSubcomponents="sample_text")
    ...
    _safe_set(a, 'aadl2_ComponentImplementation93', b1)
    assert _is_linked(a, 'aadl2_ComponentImplementation93', b1)
    if hasattr(b1, 'aadl2_ComponentImplementation95'):
        assert _is_linked(b1, 'aadl2_ComponentImplementation95', a)
    _safe_set(a, 'aadl2_ComponentImplementation93', b2)
    assert _is_linked(a, 'aadl2_ComponentImplementation93', b2)
    if hasattr(b1, 'aadl2_ComponentImplementation95'):
    ...
    _safe_set(a, 'aadl2_ComponentImplementation93', None)
    assert not _is_linked(a, 'aadl2_ComponentImplementation93', b2)
    if hasattr(b2, 'aadl2_ComponentImplementation95'):
        assert not _is_linked(b2, 'aadl2_ComponentImplementation95', a)


def test_assoc_factor793_link_reassign_clear():
    a = aadl2_UnitLiteral()
    b1 = aadl2_NumberValue()
    b2 = aadl2_NumberValue()
    _safe_set(a, 'aadl2_UnitLiteral794', b1)
    assert _is_linked(a, 'aadl2_UnitLiteral794', b1)
    if hasattr(b1, 'aadl2_NumberValue795'):
        assert _is_linked(b1, 'aadl2_NumberValue795', a)
    _safe_set(a, 'aadl2_UnitLiteral794', b2)
    assert _is_linked(a, 'aadl2_UnitLiteral794', b2)
    if hasattr(b1, 'aadl2_NumberValue795'):
        assert not _is_linked(b1, 'aadl2_NumberValue795', a)
    if hasattr(b2, 'aadl2_NumberValue795'):
        assert _is_linked(b2, 'aadl2_NumberValue795', a)
    _safe_set(a, 'aadl2_UnitLiteral794', None)
    assert not _is_linked(a, 'aadl2_UnitLiteral794', b2)
    if hasattr(b2, 'aadl2_NumberValue795'):
        assert not _is_linked(b2, 'aadl2_NumberValue795', a)


def test_assoc_featureGroupPrototype194_link_reassign_clear():
    a = aadl2_FeatureGroup(inverse="sample_text")
    b1 = aadl2_FeatureGroupPrototype()
    b2 = aadl2_FeatureGroupPrototype()
    _safe_set(a, 'aadl2_FeatureGroup195', b1)
    assert _is_linked(a, 'aadl2_FeatureGroup195', b1)
    if hasattr(b1, 'aadl2_FeatureGroupPrototype'):
        assert _is_linked(b1, 'aadl2_FeatureGroupPrototype', a)
    _safe_set(a, 'aadl2_FeatureGroup195', b2)
    assert _is_linked(a, 'aadl2_FeatureGroup195', b2)
    if hasattr(b1, 'aadl2_FeatureGroupPrototype'):
    ...
    _safe_set(a, 'aadl2_FeatureGroup195', None)
    assert not _is_linked(a, 'aadl2_FeatureGroup195', b2)
    if hasattr(b2, 'aadl2_FeatureGroupPrototype'):
        assert not _is_linked(b2, 'aadl2_FeatureGroupPrototype', a)


def test_assoc_featureGroupType192_link_reassign_clear():
    a = aadl2_FeatureGroup(inverse="sample_text")
    b1 = aadl2_FeatureGroupType()
    b2 = aadl2_FeatureGroupType()
    _safe_set(a, 'aadl2_FeatureGroup193', b1)
    assert _is_linked(a, 'aadl2_FeatureGroup193', b1)
    if hasattr(b1, 'aadl2_FeatureGroupType'):
        assert _is_linked(b1, 'aadl2_FeatureGroupType', a)
    _safe_set(a, 'aadl2_FeatureGroup193', b2)
    assert _is_linked(a, 'aadl2_FeatureGroup193', b2)
    if hasattr(b1, 'aadl2_FeatureGroupType'):
    ...
    _safe_set(a, 'aadl2_FeatureGroup193', None)
    assert not _is_linked(a, 'aadl2_FeatureGroup193', b2)
    if hasattr(b2, 'aadl2_FeatureGroupType'):
        assert not _is_linked(b2, 'aadl2_FeatureGroupType', a)


def test_assoc_featurePrototype249_link_reassign_clear():
    a = aadl2_FeaturePrototype(direction="sample_text")
    ...
    if hasattr(b1, 'aadl2_AbstractFeature250'):
        assert _is_linked(b1, 'aadl2_AbstractFeature250', a)
    _safe_set(a, 'aadl2_FeaturePrototype', b2)
    assert _is_linked(a, 'aadl2_FeaturePrototype', b2)
    if hasattr(b1, 'aadl2_AbstractFeature250'):
        assert not _is_linked(b1, 'aadl2_AbstractFeature250', a)
    if hasattr(b2, 'aadl2_AbstractFeature250'):
        assert _is_linked(b2, 'aadl2_AbstractFeature250', a)
    _safe_set(a, 'aadl2_FeaturePrototype', None)
    assert not _is_linked(a, 'aadl2_FeaturePrototype', b2)
    if hasattr(b2, 'aadl2_AbstractFeature250'):
        assert not _is_linked(b2, 'aadl2_AbstractFeature250', a)


def test_assoc_featureType190_link_reassign_clear():
    a = aadl2_FeatureGroup(inverse="sample_text")
    b1 = aadl2_FeatureType()
    b2 = aadl2_FeatureType()
    _safe_set(a, 'aadl2_FeatureGroup191', b1)
    assert _is_linked(a, 'aadl2_FeatureGroup191', b1)
    if hasattr(b1, 'aadl2_FeatureType'):
        assert _is_linked(b1, 'aadl2_FeatureType', a)
    _safe_set(a, 'aadl2_FeatureGroup191', b2)
    assert _is_linked(a, 'aadl2_FeatureGroup191', b2)
    if hasattr(b1, 'aadl2_FeatureType'):
        assert not _is_linked(b1, 'aadl2_FeatureType', a)
    if hasattr(b2, 'aadl2_FeatureType'):
        assert _is_linked(b2, 'aadl2_FeatureType', a)
    _safe_set(a, 'aadl2_FeatureGroup191', None)
    assert not _is_linked(a, 'aadl2_FeatureGroup191', b2)
    if hasattr(b2, 'aadl2_FeatureType'):
        assert not _is_linked(b2, 'aadl2_FeatureType', a)


def test_assoc_featuringClassifier46_link_reassign_clear():
    a = aadl2_Classifier(noAnnexes="sample_text", noProperties="sample_text", noPrototypes="sample_text")
    b1 = aadl2_ClassifierFeature()
    b2 = aadl2_ClassifierFeature()
...
def test_assoc_formal67_link_reassign_clear():
    a = aadl2_Prototype()
    b1 = aadl2_PrototypeBinding()
    b2 = aadl2_PrototypeBinding()
    _safe_set(a, 'aadl2_Prototype69', b1)
    assert _is_linked(a, 'aadl2_Prototype69', b1)
    if hasattr(b1, 'aadl2_PrototypeBinding68'):
        assert _is_linked(b1, 'aadl2_PrototypeBinding68', a)
    _safe_set(a, 'aadl2_Prototype69', b2)
    assert _is_linked(a, 'aadl2_Prototype69', b2)
    if hasattr(b1, 'aadl2_PrototypeBinding68'):
        assert not _is_linked(b1, 'aadl2_PrototypeBinding68', a)
    if hasattr(b2, 'aadl2_PrototypeBinding68'):
        assert _is_linked(b2, 'aadl2_PrototypeBinding68', a)
    _safe_set(a, 'aadl2_Prototype69', None)
    assert not _is_linked(a, 'aadl2_Prototype69', b2)
    if hasattr(b2, 'aadl2_PrototypeBinding68'):
        assert not _is_linked(b2, 'aadl2_PrototypeBinding68', a)


def test_assoc_general33_link_reassign_clear():
    a = aadl2_Classifier(noAnnexes="sample_text", noProperties="sample_text", noPrototypes="sample_text")
    b1 = aadl2_Classifier(noAnnexes="sample_text", noProperties="sample_text", noPrototypes="sample_text")
    b2 = aadl2_Classifier(noAnnexes="sample_text_2", noProperties="sample_text_2", noPrototypes="sample_text_2")
    _safe_set(a, 'aadl2_Classifier32', {b1})
    assert _is_linked(a, 'aadl2_Classifier32', b1)
    if hasattr(b1, 'aadl2_Classifier34'):
        assert _is_linked(b1, 'aadl2_Classifier34', a)
    _safe_set(a, 'aadl2_Classifier32', {b2})
    assert _is_linked(a, 'aadl2_Classifier32', b2)
    if hasattr(b1, 'aadl2_Classifier34'):
        assert not _is_linked(b1, 'aadl2_Classifier34', a)
    if hasattr(b2, 'aadl2_Classifier34'):
        assert _is_linked(b2, 'aadl2_Classifier34', a)
    _safe_set(a, 'aadl2_Classifier32', set())
    assert not _is_linked(a, 'aadl2_Classifier32', b2)
    if hasattr(b2, 'aadl2_Classifier34'):
        assert not _is_linked(b2, 'aadl2_Classifier34', a)
...
def test_assoc_general47_link_reassign_clear():
    ...
    _safe_set(a, 'aadl2_Classifier48', b1)
    assert _is_linked(a, 'aadl2_Classifier48', b1)
    if hasattr(b1, 'aadl2_Generalization'):
        assert _is_linked(b1, 'aadl2_Generalization', a)
    _safe_set(a, 'aadl2_Classifier48', b2)
    assert _is_linked(a, 'aadl2_Classifier48', b2)
    if hasattr(b1, 'aadl2_Generalization'):
    ...
    _safe_set(a, 'aadl2_Classifier48', None)
    assert not _is_linked(a, 'aadl2_Classifier48', b2)
    if hasattr(b2, 'aadl2_Generalization'):
        assert not _is_linked(b2, 'aadl2_Generalization', a)


def test_assoc_generalization31_link_reassign_clear():
    a = aadl2_Classifier(noAnnexes="sample_text", noProperties="sample_text", noPrototypes="sample_text")
    b1 = aadl2_Generalization_()
    b2 = aadl2_Generalization_()
...
def test_assoc_implementation85_link_reassign_clear():
    a = aadl2_ComponentImplementation(noCalls="sample_text", noConnections="sample_text", noSubcomponents="sample_text")
...
def test_assoc_implementationReference267_link_reassign_clear():
    a = aadl2_Subcomponent(allModes="sample_text")
    b1 = aadl2_ComponentImplementationReference()
    b2 = aadl2_ComponentImplementationReference()
    _safe_set(a, 'aadl2_Subcomponent268', {b1})
    assert _is_linked(a, 'aadl2_Subcomponent268', b1)
    if hasattr(b1, 'aadl2_ComponentImplementationReference269'):
        assert _is_linked(b1, 'aadl2_ComponentImplementationReference269', a)
    _safe_set(a, 'aadl2_Subcomponent268', {b2})
    assert _is_linked(a, 'aadl2_Subcomponent268', b2)
    if hasattr(b1, 'aadl2_ComponentImplementationReference269'):
        assert not _is_linked(b1, 'aadl2_ComponentImplementationReference269', a)
    if hasattr(b2, 'aadl2_ComponentImplementationReference269'):
        assert _is_linked(b2, 'aadl2_ComponentImplementationReference269', a)
    _safe_set(a, 'aadl2_Subcomponent268', set())
    assert not _is_linked(a, 'aadl2_Subcomponent268', b2)
    if hasattr(b2, 'aadl2_ComponentImplementationReference269'):
        assert not _is_linked(b2, 'aadl2_ComponentImplementationReference269', a)


def test_assoc_implemented308_link_reassign_clear():
    a = aadl2_ComponentType(noFeatures="sample_text")
    b1 = aadl2_Realization()
    b2 = aadl2_Realization()
    _safe_set(a, 'aadl2_ComponentType310', b1)
    assert _is_linked(a, 'aadl2_ComponentType310', b1)
    if hasattr(b1, 'aadl2_Realization309'):
        assert _is_linked(b1, 'aadl2_Realization309', a)
    _safe_set(a, 'aadl2_ComponentType310', b2)
    assert _is_linked(a, 'aadl2_ComponentType310', b2)
    if hasattr(b1, 'aadl2_Realization309'):
        assert not _is_linked(b1, 'aadl2_Realization309', a)
    if hasattr(b2, 'aadl2_Realization309'):
        assert _is_linked(b2, 'aadl2_Realization309', a)
    _safe_set(a, 'aadl2_ComponentType310', None)
    assert not _is_linked(a, 'aadl2_ComponentType310', b2)
    if hasattr(b2, 'aadl2_Realization309'):
        assert not _is_linked(b2, 'aadl2_Realization309', a)


def test_assoc_importedUnit345_link_reassign_clear():
    a = aadl2_PackageSection(noAnnexes="sample_text", noProperties="sample_text")
    b1 = aadl2_ModelUnit()
    b2 = aadl2_ModelUnit()
    _safe_set(a, 'aadl2_PackageSection346', {b1})
    assert _is_linked(a, 'aadl2_PackageSection346', b1)
    if hasattr(b1, 'aadl2_ModelUnit'):
        assert _is_linked(b1, 'aadl2_ModelUnit', a)
    _safe_set(a, 'aadl2_PackageSection346', {b2})
    assert _is_linked(a, 'aadl2_PackageSection346', b2)
    if hasattr(b1, 'aadl2_ModelUnit'):
        assert not _is_linked(b1, 'aadl2_ModelUnit', a)
    if hasattr(b2, 'aadl2_ModelUnit'):
        assert _is_linked(b2, 'aadl2_ModelUnit', a)
    _safe_set(a, 'aadl2_PackageSection346', set())
    assert not _is_linked(a, 'aadl2_PackageSection346', b2)
    if hasattr(b2, 'aadl2_ModelUnit'):
...
def test_assoc_inMode58_link_reassign_clear():
    a = aadl2_Mode(derived="sample_text", initial="sample_text")
...
def test_assoc_inModeOrTransition180_link_reassign_clear():
    a = aadl2_ModalPath()
...
def test_assoc_inheritedMember28_link_reassign_clear():
    a = aadl2_NamedElement(name="sample_text", qualifiedName="sample_text")
    b1 = aadl2_Classifier(noAnnexes="sample_text", noProperties="sample_text", noPrototypes="sample_text")
    b2 = aadl2_Classifier(noAnnexes="sample_text_2", noProperties="sample_text_2", noPrototypes="sample_text_2")
    _safe_set(a, 'aadl2_NamedElement30', b1)
    assert _is_linked(a, 'aadl2_NamedElement30', b1)
    if hasattr(b1, 'aadl2_Classifier29'):
        assert _is_linked(b1, 'aadl2_Classifier29', a)
    _safe_set(a, 'aadl2_NamedElement30', b2)
    assert _is_linked(a, 'aadl2_NamedElement30', b2)
    if hasattr(b1, 'aadl2_Classifier29'):
        assert not _is_linked(b1, 'aadl2_Classifier29', a)
    if hasattr(b2, 'aadl2_Classifier29'):
        assert _is_linked(b2, 'aadl2_Classifier29', a)
    _safe_set(a, 'aadl2_NamedElement30', None)
    assert not _is_linked(a, 'aadl2_NamedElement30', b2)
    if hasattr(b2, 'aadl2_Classifier29'):
        assert not _is_linked(b2, 'aadl2_Classifier29', a)


def test_assoc_member43_link_reassign_clear():
    a = aadl2_Namespace()
    ...
    _safe_set(a, 'aadl2_Namespace44', {b1})
    assert _is_linked(a, 'aadl2_Namespace44', b1)
    if hasattr(b1, 'aadl2_NamedElement45'):
        assert _is_linked(b1, 'aadl2_NamedElement45', a)
    _safe_set(a, 'aadl2_Namespace44', {b2})
    assert _is_linked(a, 'aadl2_Namespace44', b2)
    if hasattr(b1, 'aadl2_NamedElement45'):
        assert not _is_linked(b1, 'aadl2_NamedElement45', a)
    if hasattr(b2, 'aadl2_NamedElement45'):
        assert _is_linked(b2, 'aadl2_NamedElement45', a)
    _safe_set(a, 'aadl2_Namespace44', set())
    assert not _is_linked(a, 'aadl2_Namespace44', b2)
    if hasattr(b2, 'aadl2_NamedElement45'):
        assert not _is_linked(b2, 'aadl2_NamedElement45', a)


def test_assoc_namedElement74_link_reassign_clear():
    a = aadl2_NamedElement(name="sample_text", qualifiedName="sample_text")
    b1 = aadl2_ContainmentPathElement(annexName="sample_text")
    b2 = aadl2_ContainmentPathElement(annexName="sample_text_2")
    _safe_set(a, 'aadl2_NamedElement76', b1)
    assert _is_linked(a, 'aadl2_NamedElement76', b1)
    if hasattr(b1, 'aadl2_ContainmentPathElement75'):
        assert _is_linked(b1, 'aadl2_ContainmentPathElement75', a)
    _safe_set(a, 'aadl2_NamedElement76', b2)
    assert _is_linked(a, 'aadl2_NamedElement76', b2)
    if hasattr(b1, 'aadl2_ContainmentPathElement75'):
        assert not _is_linked(b1, 'aadl2_ContainmentPathElement75', a)
    if hasattr(b2, 'aadl2_ContainmentPathElement75'):
        assert _is_linked(b2, 'aadl2_ContainmentPathElement75', a)
    _safe_set(a, 'aadl2_NamedElement76', None)
    assert not _is_linked(a, 'aadl2_NamedElement76', b2)
    if hasattr(b2, 'aadl2_ContainmentPathElement75'):
        assert not _is_linked(b2, 'aadl2_ContainmentPathElement75', a)


def test_assoc_namedElementReference854_link_reassign_clear():
    a = aadl2_MetaclassReference(annexName="sample_text", metaclassName="sample_text")
    b1 = aadl2_ReferenceType()
    b2 = aadl2_ReferenceType()
    _safe_set(a, 'aadl2_MetaclassReference855', b1)
    assert _is_linked(a, 'aadl2_MetaclassReference855', b1)
    if hasattr(b1, 'aadl2_ReferenceType'):
        assert _is_linked(b1, 'aadl2_ReferenceType', a)
    _safe_set(a, 'aadl2_MetaclassReference855', b2)
    assert _is_linked(a, 'aadl2_MetaclassReference855', b2)
    if hasattr(b1, 'aadl2_ReferenceType'):
    ...
    _safe_set(a, 'aadl2_MetaclassReference855', None)
    assert not _is_linked(a, 'aadl2_MetaclassReference855', b2)
    if hasattr(b2, 'aadl2_ReferenceType'):
        assert not _is_linked(b2, 'aadl2_ReferenceType', a)


def test_assoc_outEnd175_link_reassign_clear():
    a = aadl2_FlowSpecification(kind="sample_text")
    b1 = aadl2_FlowEnd()
    b2 = aadl2_FlowEnd()
    _safe_set(a, 'aadl2_FlowSpecification176', b1)
    assert _is_linked(a, 'aadl2_FlowSpecification176', b1)
    if hasattr(b1, 'aadl2_FlowEnd'):
        assert _is_linked(b1, 'aadl2_FlowEnd', a)
    _safe_set(a, 'aadl2_FlowSpecification176', b2)
    assert _is_linked(a, 'aadl2_FlowSpecification176', b2)
    if hasattr(b1, 'aadl2_FlowEnd'):
        assert not _is_linked(b1, 'aadl2_FlowEnd', a)
    if hasattr(b2, 'aadl2_FlowEnd'):
        assert _is_linked(b2, 'aadl2_FlowEnd', a)
    _safe_set(a, 'aadl2_FlowSpecification176', None)
    assert not _is_linked(a, 'aadl2_FlowSpecification176', b2)
    if hasattr(b2, 'aadl2_FlowEnd'):
        assert not _is_linked(b2, 'aadl2_FlowEnd', a)


def test_assoc_ownedAbstractFeature157_link_reassign_clear():
    a = aadl2_ComponentType(noFeatures="sample_text")
    b1 = aadl2_AbstractFeature()
    b2 = aadl2_AbstractFeature()
    _safe_set(a, 'aadl2_ComponentType158', {b1})
    assert _is_linked(a, 'aadl2_ComponentType158', b1)
    if hasattr(b1, 'aadl2_AbstractFeature'):
        assert _is_linked(b1, 'aadl2_AbstractFeature', a)
    _safe_set(a, 'aadl2_ComponentType158', {b2})
    assert _is_linked(a, 'aadl2_ComponentType158', b2)
    if hasattr(b1, 'aadl2_AbstractFeature'):
    ...
    _safe_set(a, 'aadl2_ComponentType158', set())
    assert not _is_linked(a, 'aadl2_ComponentType158', b2)
    if hasattr(b2, 'aadl2_AbstractFeature'):
        assert not _is_linked(b2, 'aadl2_AbstractFeature', a)


def test_assoc_ownedAbstractSubcomponent106_link_reassign_clear():
    a = aadl2_ComponentImplementation(noCalls="sample_text", noConnections="sample_text", noSubcomponents="sample_text")
...
def test_assoc_ownedAccessConnection108_link_reassign_clear():
    a = aadl2_ComponentImplementation(noCalls="sample_text", noConnections="sample_text", noSubcomponents="sample_text")
...
def test_assoc_ownedAnnexLibrary342_link_reassign_clear():
    a = aadl2_PackageSection(noAnnexes="sample_text", noProperties="sample_text")
    ...
    if hasattr(b1, 'aadl2_AnnexLibrary344'):
        assert _is_linked(b1, 'aadl2_AnnexLibrary344', a)
    _safe_set(a, 'aadl2_PackageSection343', {b2})
    assert _is_linked(a, 'aadl2_PackageSection343', b2)
    if hasattr(b1, 'aadl2_AnnexLibrary344'):
        assert not _is_linked(b1, 'aadl2_AnnexLibrary344', a)
    if hasattr(b2, 'aadl2_AnnexLibrary344'):
        assert _is_linked(b2, 'aadl2_AnnexLibrary344', a)
    _safe_set(a, 'aadl2_PackageSection343', set())
    assert not _is_linked(a, 'aadl2_PackageSection343', b2)
    if hasattr(b2, 'aadl2_AnnexLibrary344'):
        assert not _is_linked(b2, 'aadl2_AnnexLibrary344', a)


def test_assoc_ownedAnnexSubclause35_link_reassign_clear():
    a = aadl2_Classifier(noAnnexes="sample_text", noProperties="sample_text", noPrototypes="sample_text")
    b1 = aadl2_AnnexSubclause()
    b2 = aadl2_AnnexSubclause()
    _safe_set(a, 'aadl2_Classifier36', {b1})
    assert _is_linked(a, 'aadl2_Classifier36', b1)
    if hasattr(b1, 'aadl2_AnnexSubclause'):
        assert _is_linked(b1, 'aadl2_AnnexSubclause', a)
    _safe_set(a, 'aadl2_Classifier36', {b2})
    assert _is_linked(a, 'aadl2_Classifier36', b2)
    if hasattr(b1, 'aadl2_AnnexSubclause'):
    ...
    _safe_set(a, 'aadl2_Classifier36', set())
    assert not _is_linked(a, 'aadl2_Classifier36', b2)
    if hasattr(b2, 'aadl2_AnnexSubclause'):
        assert not _is_linked(b2, 'aadl2_AnnexSubclause', a)


def test_assoc_ownedClassifier337_link_reassign_clear():
    a = aadl2_PackageSection(noAnnexes="sample_text", noProperties="sample_text")
    b1 = aadl2_Classifier(noAnnexes="sample_text", noProperties="sample_text", noPrototypes="sample_text")
    b2 = aadl2_Classifier(noAnnexes="sample_text_2", noProperties="sample_text_2", noPrototypes="sample_text_2")
    _safe_set(a, 'aadl2_PackageSection338', {b1})
    assert _is_linked(a, 'aadl2_PackageSection338', b1)
    if hasattr(b1, 'aadl2_Classifier339'):
        assert _is_linked(b1, 'aadl2_Classifier339', a)
    _safe_set(a, 'aadl2_PackageSection338', {b2})
    assert _is_linked(a, 'aadl2_PackageSection338', b2)
    if hasattr(b1, 'aadl2_Classifier339'):
        assert not _is_linked(b1, 'aadl2_Classifier339', a)
    if hasattr(b2, 'aadl2_Classifier339'):
        assert _is_linked(b2, 'aadl2_Classifier339', a)
    _safe_set(a, 'aadl2_PackageSection338', set())
    assert not _is_linked(a, 'aadl2_PackageSection338', b2)
    if hasattr(b2, 'aadl2_Classifier339'):
        assert not _is_linked(b2, 'aadl2_Classifier339', a)
...
def test_assoc_ownedComponentTypeRename335_link_reassign_clear():
    a = aadl2_PackageSection(noAnnexes="sample_text", noProperties="sample_text")
    b1 = aadl2_ComponentTypeRename(category="sample_text")
    b2 = aadl2_ComponentTypeRename(category="sample_text_2")
    _safe_set(a, 'aadl2_PackageSection336', {b1})
    assert _is_linked(a, 'aadl2_PackageSection336', b1)
    if hasattr(b1, 'aadl2_ComponentTypeRename'):
        assert _is_linked(b1, 'aadl2_ComponentTypeRename', a)
    _safe_set(a, 'aadl2_PackageSection336', {b2})
    assert _is_linked(a, 'aadl2_PackageSection336', b2)
    if hasattr(b1, 'aadl2_ComponentTypeRename'):
    ...
    _safe_set(a, 'aadl2_PackageSection336', set())
    assert not _is_linked(a, 'aadl2_PackageSection336', b2)
    if hasattr(b2, 'aadl2_ComponentTypeRename'):
        assert not _is_linked(b2, 'aadl2_ComponentTypeRename', a)


def test_assoc_ownedConnection98_link_reassign_clear():
    a = aadl2_Connection(bidirectional="sample_text")
    b1 = aadl2_ComponentImplementation(noCalls="sample_text", noConnections="sample_text", noSubcomponents="sample_text")
    b2 = aadl2_ComponentImplementation(noCalls="sample_text_2", noConnections="sample_text_2", noSubcomponents="sample_text_2")
...
def test_assoc_ownedEndToEndFlow104_link_reassign_clear():
    a = aadl2_ComponentImplementation(noCalls="sample_text", noConnections="sample_text", noSubcomponents="sample_text")
...
def test_assoc_ownedEventDataSource124_link_reassign_clear():
    a = aadl2_ComponentImplementation(noCalls="sample_text", noConnections="sample_text", noSubcomponents="sample_text")
    b1 = aadl2_EventDataSource()
    b2 = aadl2_EventDataSource()
    _safe_set(a, 'aadl2_ComponentImplementation125', {b1})
    assert _is_linked(a, 'aadl2_ComponentImplementation125', b1)
    if hasattr(b1, 'aadl2_EventDataSource'):
        assert _is_linked(b1, 'aadl2_EventDataSource', a)
    _safe_set(a, 'aadl2_ComponentImplementation125', {b2})
    assert _is_linked(a, 'aadl2_ComponentImplementation125', b2)
    if hasattr(b1, 'aadl2_EventDataSource'):
    ...
    _safe_set(a, 'aadl2_ComponentImplementation125', set())
    assert not _is_linked(a, 'aadl2_ComponentImplementation125', b2)
    if hasattr(b2, 'aadl2_EventDataSource'):
        assert not _is_linked(b2, 'aadl2_EventDataSource', a)


def test_assoc_ownedEventSource122_link_reassign_clear():
    a = aadl2_ComponentImplementation(noCalls="sample_text", noConnections="sample_text", noSubcomponents="sample_text")
    b1 = aadl2_EventSource()
    b2 = aadl2_EventSource()
    _safe_set(a, 'aadl2_ComponentImplementation123', {b1})
    assert _is_linked(a, 'aadl2_ComponentImplementation123', b1)
    if hasattr(b1, 'aadl2_EventSource'):
        assert _is_linked(b1, 'aadl2_EventSource', a)
    _safe_set(a, 'aadl2_ComponentImplementation123', {b2})
    assert _is_linked(a, 'aadl2_ComponentImplementation123', b2)
    if hasattr(b1, 'aadl2_EventSource'):
        assert not _is_linked(b1, 'aadl2_EventSource', a)
    if hasattr(b2, 'aadl2_EventSource'):
        assert _is_linked(b2, 'aadl2_EventSource', a)
    _safe_set(a, 'aadl2_ComponentImplementation123', set())
    assert not _is_linked(a, 'aadl2_ComponentImplementation123', b2)
    if hasattr(b2, 'aadl2_EventSource'):
        assert not _is_linked(b2, 'aadl2_EventSource', a)


def test_assoc_ownedExtension100_link_reassign_clear():
    a = aadl2_ComponentImplementation(noCalls="sample_text", noConnections="sample_text", noSubcomponents="sample_text")
    b1 = aadl2_ImplementationExtension()
    b2 = aadl2_ImplementationExtension()
    ...
    _safe_set(a, 'aadl2_ComponentImplementation101', None)
    assert not _is_linked(a, 'aadl2_ComponentImplementation101', b2)
    if hasattr(b2, 'aadl2_ImplementationExtension'):
        assert not _is_linked(b2, 'aadl2_ImplementationExtension', a)


def test_assoc_ownedExtension153_link_reassign_clear():
    a = aadl2_ComponentType(noFeatures="sample_text")
    b1 = aadl2_TypeExtension()
    b2 = aadl2_TypeExtension()
    _safe_set(a, 'aadl2_ComponentType154', b1)
    assert _is_linked(a, 'aadl2_ComponentType154', b1)
    if hasattr(b1, 'aadl2_TypeExtension'):
        assert _is_linked(b1, 'aadl2_TypeExtension', a)
    _safe_set(a, 'aadl2_ComponentType154', b2)
    assert _is_linked(a, 'aadl2_ComponentType154', b2)
    if hasattr(b1, 'aadl2_TypeExtension'):
    ...
    _safe_set(a, 'aadl2_ComponentType154', None)
    assert not _is_linked(a, 'aadl2_ComponentType154', b2)
    if hasattr(b2, 'aadl2_TypeExtension'):
...
def test_assoc_ownedFeatureConnection114_link_reassign_clear():
    a = aadl2_ComponentImplementation(noCalls="sample_text", noConnections="sample_text", noSubcomponents="sample_text")
...
def test_assoc_ownedFeatureGroup155_link_reassign_clear():
    a = aadl2_FeatureGroup(inverse="sample_text")
    b1 = aadl2_ComponentType(noFeatures="sample_text")
    b2 = aadl2_ComponentType(noFeatures="sample_text_2")
    _safe_set(a, 'aadl2_FeatureGroup', b1)
    assert _is_linked(a, 'aadl2_FeatureGroup', b1)
    if hasattr(b1, 'aadl2_ComponentType156'):
        assert _is_linked(b1, 'aadl2_ComponentType156', a)
    _safe_set(a, 'aadl2_FeatureGroup', b2)
    assert _is_linked(a, 'aadl2_FeatureGroup', b2)
    if hasattr(b1, 'aadl2_ComponentType156'):
        assert not _is_linked(b1, 'aadl2_ComponentType156', a)
    if hasattr(b2, 'aadl2_ComponentType156'):
        assert _is_linked(b2, 'aadl2_ComponentType156', a)
    _safe_set(a, 'aadl2_FeatureGroup', None)
    assert not _is_linked(a, 'aadl2_FeatureGroup', b2)
    if hasattr(b2, 'aadl2_ComponentType156'):
        assert not _is_linked(b2, 'aadl2_ComponentType156', a)


def test_assoc_ownedFeatureGroup217_link_reassign_clear():
    a = aadl2_FeatureGroup(inverse="sample_text")
    b1 = aadl2_FeatureGroupType()
    b2 = aadl2_FeatureGroupType()
    _safe_set(a, 'aadl2_FeatureGroup219', b1)
    assert _is_linked(a, 'aadl2_FeatureGroup219', b1)
    if hasattr(b1, 'aadl2_FeatureGroupType218'):
        assert _is_linked(b1, 'aadl2_FeatureGroupType218', a)
    _safe_set(a, 'aadl2_FeatureGroup219', b2)
    assert _is_linked(a, 'aadl2_FeatureGroup219', b2)
    if hasattr(b1, 'aadl2_FeatureGroupType218'):
        assert not _is_linked(b1, 'aadl2_FeatureGroupType218', a)
    if hasattr(b2, 'aadl2_FeatureGroupType218'):
        assert _is_linked(b2, 'aadl2_FeatureGroupType218', a)
    _safe_set(a, 'aadl2_FeatureGroup219', None)
    assert not _is_linked(a, 'aadl2_FeatureGroup219', b2)
    if hasattr(b2, 'aadl2_FeatureGroupType218'):
        assert not _is_linked(b2, 'aadl2_FeatureGroupType218', a)


def test_assoc_ownedFeatureGroupConnection116_link_reassign_clear():
    a = aadl2_ComponentImplementation(noCalls="sample_text", noConnections="sample_text", noSubcomponents="sample_text")
    b1 = aadl2_FeatureGroupConnection()
    b2 = aadl2_FeatureGroupConnection()
    _safe_set(a, 'aadl2_ComponentImplementation117', {b1})
    assert _is_linked(a, 'aadl2_ComponentImplementation117', b1)
    if hasattr(b1, 'aadl2_FeatureGroupConnection'):
        assert _is_linked(b1, 'aadl2_FeatureGroupConnection', a)
    _safe_set(a, 'aadl2_ComponentImplementation117', {b2})
    assert _is_linked(a, 'aadl2_ComponentImplementation117', b2)
    if hasattr(b1, 'aadl2_FeatureGroupConnection'):
    ...
    _safe_set(a, 'aadl2_ComponentImplementation117', set())
    assert not _is_linked(a, 'aadl2_ComponentImplementation117', b2)
    if hasattr(b2, 'aadl2_FeatureGroupConnection'):
        assert not _is_linked(b2, 'aadl2_FeatureGroupConnection', a)


def test_assoc_ownedFeatureGroupTypeRename340_link_reassign_clear():
    a = aadl2_PackageSection(noAnnexes="sample_text", noProperties="sample_text")
...
def test_assoc_ownedFlowImplementation96_link_reassign_clear():
    ...
    if hasattr(b1, 'aadl2_ComponentImplementation97'):
        assert _is_linked(b1, 'aadl2_ComponentImplementation97', a)
    _safe_set(a, 'aadl2_FlowImplementation', b2)
    assert _is_linked(a, 'aadl2_FlowImplementation', b2)
    if hasattr(b1, 'aadl2_ComponentImplementation97'):
        assert not _is_linked(b1, 'aadl2_ComponentImplementation97', a)
    if hasattr(b2, 'aadl2_ComponentImplementation97'):
        assert _is_linked(b2, 'aadl2_ComponentImplementation97', a)
    _safe_set(a, 'aadl2_FlowImplementation', None)
    assert not _is_linked(a, 'aadl2_FlowImplementation', b2)
    if hasattr(b2, 'aadl2_ComponentImplementation97'):
        assert not _is_linked(b2, 'aadl2_ComponentImplementation97', a)


def test_assoc_ownedFlowSegment285_link_reassign_clear():
    a = aadl2_FlowImplementation(kind="sample_text")
    b1 = aadl2_FlowSegment()
    b2 = aadl2_FlowSegment()
    _safe_set(a, 'aadl2_FlowImplementation286', {b1})
    assert _is_linked(a, 'aadl2_FlowImplementation286', b1)
    if hasattr(b1, 'aadl2_FlowSegment'):
        assert _is_linked(b1, 'aadl2_FlowSegment', a)
    _safe_set(a, 'aadl2_FlowImplementation286', {b2})
    assert _is_linked(a, 'aadl2_FlowImplementation286', b2)
    if hasattr(b1, 'aadl2_FlowSegment'):
        assert not _is_linked(b1, 'aadl2_FlowSegment', a)
    if hasattr(b2, 'aadl2_FlowSegment'):
        assert _is_linked(b2, 'aadl2_FlowSegment', a)
    _safe_set(a, 'aadl2_FlowImplementation286', set())
    assert not _is_linked(a, 'aadl2_FlowImplementation286', b2)
    if hasattr(b2, 'aadl2_FlowSegment'):
        assert not _is_linked(b2, 'aadl2_FlowSegment', a)


def test_assoc_ownedFlowSpecification151_link_reassign_clear():
    a = aadl2_FlowSpecification(kind="sample_text")
    b1 = aadl2_ComponentType(noFeatures="sample_text")
    b2 = aadl2_ComponentType(noFeatures="sample_text_2")
    _safe_set(a, 'aadl2_FlowSpecification', b1)
    assert _is_linked(a, 'aadl2_FlowSpecification', b1)
    if hasattr(b1, 'aadl2_ComponentType152'):
        assert _is_linked(b1, 'aadl2_ComponentType152', a)
    _safe_set(a, 'aadl2_FlowSpecification', b2)
    assert _is_linked(a, 'aadl2_FlowSpecification', b2)
    if hasattr(b1, 'aadl2_ComponentType152'):
        assert not _is_linked(b1, 'aadl2_ComponentType152', a)
    if hasattr(b2, 'aadl2_ComponentType152'):
        assert _is_linked(b2, 'aadl2_ComponentType152', a)
    _safe_set(a, 'aadl2_FlowSpecification', None)
    assert not _is_linked(a, 'aadl2_FlowSpecification', b2)
    if hasattr(b2, 'aadl2_ComponentType152'):
        assert not _is_linked(b2, 'aadl2_ComponentType152', a)


def test_assoc_ownedInternalFeature120_link_reassign_clear():
    a = aadl2_InternalFeature(direction="sample_text")
    b1 = aadl2_ComponentImplementation(noCalls="sample_text", noConnections="sample_text", noSubcomponents="sample_text")
    b2 = aadl2_ComponentImplementation(noCalls="sample_text_2", noConnections="sample_text_2", noSubcomponents="sample_text_2")
    _safe_set(a, 'aadl2_InternalFeature', b1)
    assert _is_linked(a, 'aadl2_InternalFeature', b1)
    if hasattr(b1, 'aadl2_ComponentImplementation121'):
        assert _is_linked(b1, 'aadl2_ComponentImplementation121', a)
    _safe_set(a, 'aadl2_InternalFeature', b2)
    assert _is_linked(a, 'aadl2_InternalFeature', b2)
    if hasattr(b1, 'aadl2_ComponentImplementation121'):
        assert not _is_linked(b1, 'aadl2_ComponentImplementation121', a)
    if hasattr(b2, 'aadl2_ComponentImplementation121'):
        assert _is_linked(b2, 'aadl2_ComponentImplementation121', a)
    _safe_set(a, 'aadl2_InternalFeature', None)
    assert not _is_linked(a, 'aadl2_InternalFeature', b2)
    if hasattr(b2, 'aadl2_ComponentImplementation121'):
        assert not _is_linked(b2, 'aadl2_ComponentImplementation121', a)


def test_assoc_ownedMember41_link_reassign_clear():
    a = aadl2_Namespace()
    b1 = aadl2_NamedElement(name="sample_text", qualifiedName="sample_text")
    b2 = aadl2_NamedElement(name="sample_text_2", qualifiedName="sample_text_2")
    _safe_set(a, 'aadl2_Namespace', {b1})
    assert _is_linked(a, 'aadl2_Namespace', b1)
    if hasattr(b1, 'aadl2_NamedElement42'):
        assert _is_linked(b1, 'aadl2_NamedElement42', a)
    _safe_set(a, 'aadl2_Namespace', {b2})
    assert _is_linked(a, 'aadl2_Namespace', b2)
    if hasattr(b1, 'aadl2_NamedElement42'):
        assert not _is_linked(b1, 'aadl2_NamedElement42', a)
    if hasattr(b2, 'aadl2_NamedElement42'):
        assert _is_linked(b2, 'aadl2_NamedElement42', a)
    _safe_set(a, 'aadl2_Namespace', set())
    assert not _is_linked(a, 'aadl2_Namespace', b2)
    if hasattr(b2, 'aadl2_NamedElement42'):
        assert not _is_linked(b2, 'aadl2_NamedElement42', a)


def test_assoc_ownedMode130_link_reassign_clear():
    a = aadl2_Mode(derived="sample_text", initial="sample_text")
    b1 = aadl2_ComponentClassifier(derivedModes="sample_text", noFlows="sample_text", noModes="sample_text")
    b2 = aadl2_ComponentClassifier(derivedModes="sample_text_2", noFlows="sample_text_2", noModes="sample_text_2")
    _safe_set(a, 'aadl2_Mode131', b1)
    assert _is_linked(a, 'aadl2_Mode131', b1)
    if hasattr(b1, 'aadl2_ComponentClassifier'):
        assert _is_linked(b1, 'aadl2_ComponentClassifier', a)
    _safe_set(a, 'aadl2_Mode131', b2)
    assert _is_linked(a, 'aadl2_Mode131', b2)
    if hasattr(b1, 'aadl2_ComponentClassifier'):
    ...
    _safe_set(a, 'aadl2_Mode131', None)
    assert not _is_linked(a, 'aadl2_Mode131', b2)
    if hasattr(b2, 'aadl2_ComponentClassifier'):
        assert not _is_linked(b2, 'aadl2_ComponentClassifier', a)


def test_assoc_ownedModeBinding265_link_reassign_clear():
    a = aadl2_Subcomponent(allModes="sample_text")
    b1 = aadl2_ModeBinding()
    b2 = aadl2_ModeBinding()
    _safe_set(a, 'aadl2_Subcomponent266', {b1})
    assert _is_linked(a, 'aadl2_Subcomponent266', b1)
    if hasattr(b1, 'aadl2_ModeBinding'):
        assert _is_linked(b1, 'aadl2_ModeBinding', a)
    _safe_set(a, 'aadl2_Subcomponent266', {b2})
    assert _is_linked(a, 'aadl2_Subcomponent266', b2)
    if hasattr(b1, 'aadl2_ModeBinding'):
        assert not _is_linked(b1, 'aadl2_ModeBinding', a)
    if hasattr(b2, 'aadl2_ModeBinding'):
        assert _is_linked(b2, 'aadl2_ModeBinding', a)
    _safe_set(a, 'aadl2_Subcomponent266', set())
    assert not _is_linked(a, 'aadl2_Subcomponent266', b2)
    if hasattr(b2, 'aadl2_ModeBinding'):
        assert not _is_linked(b2, 'aadl2_ModeBinding', a)


def test_assoc_ownedModeTransition132_link_reassign_clear():
    a = aadl2_ComponentClassifier(derivedModes="sample_text", noFlows="sample_text", noModes="sample_text")
    b1 = aadl2_ModeTransition()
    b2 = aadl2_ModeTransition()
    _safe_set(a, 'aadl2_ComponentClassifier133', {b1})
    assert _is_linked(a, 'aadl2_ComponentClassifier133', b1)
    if hasattr(b1, 'aadl2_ModeTransition'):
        assert _is_linked(b1, 'aadl2_ModeTransition', a)
    _safe_set(a, 'aadl2_ComponentClassifier133', {b2})
    assert _is_linked(a, 'aadl2_ComponentClassifier133', b2)
    if hasattr(b1, 'aadl2_ModeTransition'):
    ...
    _safe_set(a, 'aadl2_ComponentClassifier133', set())
    assert not _is_linked(a, 'aadl2_ComponentClassifier133', b2)
    if hasattr(b2, 'aadl2_ModeTransition'):
        assert not _is_linked(b2, 'aadl2_ModeTransition', a)


def test_assoc_ownedPackageRename334_link_reassign_clear():
    a = aadl2_PackageSection(noAnnexes="sample_text", noProperties="sample_text")
...
def test_assoc_ownedParameterConnection110_link_reassign_clear():
    a = aadl2_ComponentImplementation(noCalls="sample_text", noConnections="sample_text", noSubcomponents="sample_text")
...
def test_assoc_ownedPortConnection112_link_reassign_clear():
    a = aadl2_ComponentImplementation(noCalls="sample_text", noConnections="sample_text", noSubcomponents="sample_text")
...
def test_assoc_ownedPortProxy126_link_reassign_clear():
    a = aadl2_PortProxy(direction="sample_text")
    b1 = aadl2_ComponentImplementation(noCalls="sample_text", noConnections="sample_text", noSubcomponents="sample_text")
    b2 = aadl2_ComponentImplementation(noCalls="sample_text_2", noConnections="sample_text_2", noSubcomponents="sample_text_2")
    _safe_set(a, 'aadl2_PortProxy', b1)
    assert _is_linked(a, 'aadl2_PortProxy', b1)
    if hasattr(b1, 'aadl2_ComponentImplementation127'):
        assert _is_linked(b1, 'aadl2_ComponentImplementation127', a)
    _safe_set(a, 'aadl2_PortProxy', b2)
    assert _is_linked(a, 'aadl2_PortProxy', b2)
    if hasattr(b1, 'aadl2_ComponentImplementation127'):
        assert not _is_linked(b1, 'aadl2_ComponentImplementation127', a)
    if hasattr(b2, 'aadl2_ComponentImplementation127'):
        assert _is_linked(b2, 'aadl2_ComponentImplementation127', a)
    _safe_set(a, 'aadl2_PortProxy', None)
    assert not _is_linked(a, 'aadl2_PortProxy', b2)
    if hasattr(b2, 'aadl2_ComponentImplementation127'):
        assert not _is_linked(b2, 'aadl2_ComponentImplementation127', a)


def test_assoc_ownedProcessorFeature118_link_reassign_clear():
    a = aadl2_ComponentImplementation(noCalls="sample_text", noConnections="sample_text", noSubcomponents="sample_text")
    b1 = aadl2_ProcessorFeature()
    b2 = aadl2_ProcessorFeature()
    _safe_set(a, 'aadl2_ComponentImplementation119', {b1})
    assert _is_linked(a, 'aadl2_ComponentImplementation119', b1)
    if hasattr(b1, 'aadl2_ProcessorFeature'):
        assert _is_linked(b1, 'aadl2_ProcessorFeature', a)
    _safe_set(a, 'aadl2_ComponentImplementation119', {b2})
    assert _is_linked(a, 'aadl2_ComponentImplementation119', b2)
    if hasattr(b1, 'aadl2_ProcessorFeature'):
    ...
    _safe_set(a, 'aadl2_ComponentImplementation119', set())
    assert not _is_linked(a, 'aadl2_ComponentImplementation119', b2)
    if hasattr(b2, 'aadl2_ProcessorFeature'):
        assert not _is_linked(b2, 'aadl2_ProcessorFeature', a)


def test_assoc_ownedProperty815_link_reassign_clear():
    a = aadl2_Property(emptyListDefault="sample_text", inherit="sample_text")
    b1 = aadl2_PropertySet()
    b2 = aadl2_PropertySet()
    _safe_set(a, 'aadl2_Property817', b1)
    assert _is_linked(a, 'aadl2_Property817', b1)
    if hasattr(b1, 'aadl2_PropertySet816'):
        assert _is_linked(b1, 'aadl2_PropertySet816', a)
    _safe_set(a, 'aadl2_Property817', b2)
    assert _is_linked(a, 'aadl2_Property817', b2)
    if hasattr(b1, 'aadl2_PropertySet816'):
        assert not _is_linked(b1, 'aadl2_PropertySet816', a)
    if hasattr(b2, 'aadl2_PropertySet816'):
        assert _is_linked(b2, 'aadl2_PropertySet816', a)
    _safe_set(a, 'aadl2_Property817', None)
    assert not _is_linked(a, 'aadl2_Property817', b2)
    if hasattr(b2, 'aadl2_PropertySet816'):
        assert not _is_linked(b2, 'aadl2_PropertySet816', a)
...
def test_assoc_ownedPropertyExpression806_link_reassign_clear():
    a = aadl2_Operation(op="sample_text")
    b1 = aadl2_PropertyExpression()
    b2 = aadl2_PropertyExpression()
    _safe_set(a, 'aadl2_Operation', {b1})
    assert _is_linked(a, 'aadl2_Operation', b1)
    if hasattr(b1, 'aadl2_PropertyExpression807'):
        assert _is_linked(b1, 'aadl2_PropertyExpression807', a)
    _safe_set(a, 'aadl2_Operation', {b2})
    assert _is_linked(a, 'aadl2_Operation', b2)
    if hasattr(b1, 'aadl2_PropertyExpression807'):
        assert not _is_linked(b1, 'aadl2_PropertyExpression807', a)
    if hasattr(b2, 'aadl2_PropertyExpression807'):
        assert _is_linked(b2, 'aadl2_PropertyExpression807', a)
    _safe_set(a, 'aadl2_Operation', set())
    assert not _is_linked(a, 'aadl2_Operation', b2)
    if hasattr(b2, 'aadl2_PropertyExpression807'):
        assert not _is_linked(b2, 'aadl2_PropertyExpression807', a)


def test_assoc_ownedPrototype37_link_reassign_clear():
    a = aadl2_Prototype()
    b1 = aadl2_Classifier(noAnnexes="sample_text", noProperties="sample_text", noPrototypes="sample_text")
    b2 = aadl2_Classifier(noAnnexes="sample_text_2", noProperties="sample_text_2", noPrototypes="sample_text_2")
    _safe_set(a, 'aadl2_Prototype', b1)
    assert _is_linked(a, 'aadl2_Prototype', b1)
    if hasattr(b1, 'aadl2_Classifier38'):
        assert _is_linked(b1, 'aadl2_Classifier38', a)
    _safe_set(a, 'aadl2_Prototype', b2)
    assert _is_linked(a, 'aadl2_Prototype', b2)
    if hasattr(b1, 'aadl2_Classifier38'):
        assert not _is_linked(b1, 'aadl2_Classifier38', a)
    if hasattr(b2, 'aadl2_Classifier38'):
        assert _is_linked(b2, 'aadl2_Classifier38', a)
    _safe_set(a, 'aadl2_Prototype', None)
    assert not _is_linked(a, 'aadl2_Prototype', b2)
    if hasattr(b2, 'aadl2_Classifier38'):
        assert not _is_linked(b2, 'aadl2_Classifier38', a)


def test_assoc_ownedPrototypeBinding259_link_reassign_clear():
    a = aadl2_Subcomponent(allModes="sample_text")
    b1 = aadl2_PrototypeBinding()
    b2 = aadl2_PrototypeBinding()
    _safe_set(a, 'aadl2_Subcomponent260', {b1})
    assert _is_linked(a, 'aadl2_Subcomponent260', b1)
    if hasattr(b1, 'aadl2_PrototypeBinding261'):
        assert _is_linked(b1, 'aadl2_PrototypeBinding261', a)
    _safe_set(a, 'aadl2_Subcomponent260', {b2})
    assert _is_linked(a, 'aadl2_Subcomponent260', b2)
    if hasattr(b1, 'aadl2_PrototypeBinding261'):
        assert not _is_linked(b1, 'aadl2_PrototypeBinding261', a)
    if hasattr(b2, 'aadl2_PrototypeBinding261'):
        assert _is_linked(b2, 'aadl2_PrototypeBinding261', a)
    _safe_set(a, 'aadl2_Subcomponent260', set())
    assert not _is_linked(a, 'aadl2_Subcomponent260', b2)
    if hasattr(b2, 'aadl2_PrototypeBinding261'):
        assert not _is_linked(b2, 'aadl2_PrototypeBinding261', a)


def test_assoc_ownedPrototypeBinding39_link_reassign_clear():
    a = aadl2_Classifier(noAnnexes="sample_text", noProperties="sample_text", noPrototypes="sample_text")
    b1 = aadl2_PrototypeBinding()
    b2 = aadl2_PrototypeBinding()
    _safe_set(a, 'aadl2_Classifier40', {b1})
    assert _is_linked(a, 'aadl2_Classifier40', b1)
    if hasattr(b1, 'aadl2_PrototypeBinding'):
        assert _is_linked(b1, 'aadl2_PrototypeBinding', a)
    _safe_set(a, 'aadl2_Classifier40', {b2})
    assert _is_linked(a, 'aadl2_Classifier40', b2)
    if hasattr(b1, 'aadl2_PrototypeBinding'):
    ...
    _safe_set(a, 'aadl2_Classifier40', set())
    assert not _is_linked(a, 'aadl2_Classifier40', b2)
    if hasattr(b2, 'aadl2_PrototypeBinding'):
        assert not _is_linked(b2, 'aadl2_PrototypeBinding', a)


def test_assoc_ownedRealization102_link_reassign_clear():
    a = aadl2_ComponentImplementation(noCalls="sample_text", noConnections="sample_text", noSubcomponents="sample_text")
    b1 = aadl2_Realization()
    b2 = aadl2_Realization()
    ...
    _safe_set(a, 'aadl2_ComponentImplementation103', None)
    assert not _is_linked(a, 'aadl2_ComponentImplementation103', b2)
    if hasattr(b2, 'aadl2_Realization'):
        assert not _is_linked(b2, 'aadl2_Realization', a)


def test_assoc_ownedSubcomponent91_link_reassign_clear():
    a = aadl2_Subcomponent(allModes="sample_text")
    b1 = aadl2_ComponentImplementation(noCalls="sample_text", noConnections="sample_text", noSubcomponents="sample_text")
    b2 = aadl2_ComponentImplementation(noCalls="sample_text_2", noConnections="sample_text_2", noSubcomponents="sample_text_2")
    _safe_set(a, 'aadl2_Subcomponent', b1)
    assert _is_linked(a, 'aadl2_Subcomponent', b1)
    if hasattr(b1, 'aadl2_ComponentImplementation92'):
        assert _is_linked(b1, 'aadl2_ComponentImplementation92', a)
    _safe_set(a, 'aadl2_Subcomponent', b2)
    assert _is_linked(a, 'aadl2_Subcomponent', b2)
    if hasattr(b1, 'aadl2_ComponentImplementation92'):
        assert not _is_linked(b1, 'aadl2_ComponentImplementation92', a)
    if hasattr(b2, 'aadl2_ComponentImplementation92'):
        assert _is_linked(b2, 'aadl2_ComponentImplementation92', a)
    _safe_set(a, 'aadl2_Subcomponent', None)
    assert not _is_linked(a, 'aadl2_Subcomponent', b2)
    if hasattr(b2, 'aadl2_ComponentImplementation92'):
        assert not _is_linked(b2, 'aadl2_ComponentImplementation92', a)


def test_assoc_ownedSubprogramCallSequence400_link_reassign_clear():
    a = aadl2_BehavioredImplementation()
    b1 = aadl2_SubprogramCallSequence()
    b2 = aadl2_SubprogramCallSequence()
    _safe_set(a, 'aadl2_BehavioredImplementation401', {b1})
    assert _is_linked(a, 'aadl2_BehavioredImplementation401', b1)
    if hasattr(b1, 'aadl2_SubprogramCallSequence402'):
        assert _is_linked(b1, 'aadl2_SubprogramCallSequence402', a)
    _safe_set(a, 'aadl2_BehavioredImplementation401', {b2})
    assert _is_linked(a, 'aadl2_BehavioredImplementation401', b2)
    if hasattr(b1, 'aadl2_SubprogramCallSequence402'):
        assert not _is_linked(b1, 'aadl2_SubprogramCallSequence402', a)
    if hasattr(b2, 'aadl2_SubprogramCallSequence402'):
        assert _is_linked(b2, 'aadl2_SubprogramCallSequence402', a)
    _safe_set(a, 'aadl2_BehavioredImplementation401', set())
    assert not _is_linked(a, 'aadl2_BehavioredImplementation401', b2)
    if hasattr(b2, 'aadl2_SubprogramCallSequence402'):
        assert not _is_linked(b2, 'aadl2_SubprogramCallSequence402', a)


def test_assoc_ownedSubprogramProxy128_link_reassign_clear():
    a = aadl2_ComponentImplementation(noCalls="sample_text", noConnections="sample_text", noSubcomponents="sample_text")
    b1 = aadl2_SubprogramProxy()
    b2 = aadl2_SubprogramProxy()
    _safe_set(a, 'aadl2_ComponentImplementation129', {b1})
    assert _is_linked(a, 'aadl2_ComponentImplementation129', b1)
    if hasattr(b1, 'aadl2_SubprogramProxy'):
        assert _is_linked(b1, 'aadl2_SubprogramProxy', a)
    _safe_set(a, 'aadl2_ComponentImplementation129', {b2})
    assert _is_linked(a, 'aadl2_ComponentImplementation129', b2)
    if hasattr(b1, 'aadl2_SubprogramProxy'):
    ...
    _safe_set(a, 'aadl2_ComponentImplementation129', set())
    assert not _is_linked(a, 'aadl2_ComponentImplementation129', b2)
    if hasattr(b2, 'aadl2_SubprogramProxy'):
...
def test_assoc_parentMode276_link_reassign_clear():
    a = aadl2_Mode(derived="sample_text", initial="sample_text")
    b1 = aadl2_ModeBinding()
    b2 = aadl2_ModeBinding()
    _safe_set(a, 'aadl2_Mode278', b1)
    assert _is_linked(a, 'aadl2_Mode278', b1)
    if hasattr(b1, 'aadl2_ModeBinding277'):
        assert _is_linked(b1, 'aadl2_ModeBinding277', a)
    _safe_set(a, 'aadl2_Mode278', b2)
    assert _is_linked(a, 'aadl2_Mode278', b2)
    if hasattr(b1, 'aadl2_ModeBinding277'):
        assert not _is_linked(b1, 'aadl2_ModeBinding277', a)
    if hasattr(b2, 'aadl2_ModeBinding277'):
        assert _is_linked(b2, 'aadl2_ModeBinding277', a)
    _safe_set(a, 'aadl2_Mode278', None)
    assert not _is_linked(a, 'aadl2_Mode278', b2)
    if hasattr(b2, 'aadl2_ModeBinding277'):
        assert not _is_linked(b2, 'aadl2_ModeBinding277', a)


def test_assoc_parsedAnnexLibrary330_link_reassign_clear():
...
def test_assoc_parsedAnnexSubclause331_link_reassign_clear():
    ...
    if hasattr(b1, 'aadl2_AnnexSubclause332'):
        assert _is_linked(b1, 'aadl2_AnnexSubclause332', a)
    _safe_set(a, 'aadl2_DefaultAnnexSubclause', b2)
    assert _is_linked(a, 'aadl2_DefaultAnnexSubclause', b2)
    if hasattr(b1, 'aadl2_AnnexSubclause332'):
        assert not _is_linked(b1, 'aadl2_AnnexSubclause332', a)
    if hasattr(b2, 'aadl2_AnnexSubclause332'):
        assert _is_linked(b2, 'aadl2_AnnexSubclause332', a)
    _safe_set(a, 'aadl2_DefaultAnnexSubclause', None)
    assert not _is_linked(a, 'aadl2_DefaultAnnexSubclause', b2)
    if hasattr(b2, 'aadl2_AnnexSubclause332'):
        assert not _is_linked(b2, 'aadl2_AnnexSubclause332', a)
...
def test_assoc_prototype159_link_reassign_clear():
    a = aadl2_ComponentPrototype(array="sample_text")
    b1 = aadl2_Feature()
    b2 = aadl2_Feature()
    _safe_set(a, 'aadl2_ComponentPrototype', b1)
    assert _is_linked(a, 'aadl2_ComponentPrototype', b1)
    if hasattr(b1, 'aadl2_Feature160'):
        assert _is_linked(b1, 'aadl2_Feature160', a)
    _safe_set(a, 'aadl2_ComponentPrototype', b2)
    assert _is_linked(a, 'aadl2_ComponentPrototype', b2)
    if hasattr(b1, 'aadl2_Feature160'):
        assert not _is_linked(b1, 'aadl2_Feature160', a)
    if hasattr(b2, 'aadl2_Feature160'):
        assert _is_linked(b2, 'aadl2_Feature160', a)
    _safe_set(a, 'aadl2_ComponentPrototype', None)
    assert not _is_linked(a, 'aadl2_ComponentPrototype', b2)
    if hasattr(b2, 'aadl2_Feature160'):
        assert not _is_linked(b2, 'aadl2_Feature160', a)


def test_assoc_prototype262_link_reassign_clear():
    a = aadl2_Subcomponent(allModes="sample_text")
    b1 = aadl2_ComponentPrototype(array="sample_text")
    b2 = aadl2_ComponentPrototype(array="sample_text_2")
    _safe_set(a, 'aadl2_Subcomponent263', b1)
    assert _is_linked(a, 'aadl2_Subcomponent263', b1)
    if hasattr(b1, 'aadl2_ComponentPrototype264'):
        assert _is_linked(b1, 'aadl2_ComponentPrototype264', a)
    _safe_set(a, 'aadl2_Subcomponent263', b2)
    assert _is_linked(a, 'aadl2_Subcomponent263', b2)
    if hasattr(b1, 'aadl2_ComponentPrototype264'):
        assert not _is_linked(b1, 'aadl2_ComponentPrototype264', a)
    if hasattr(b2, 'aadl2_ComponentPrototype264'):
        assert _is_linked(b2, 'aadl2_ComponentPrototype264', a)
    _safe_set(a, 'aadl2_Subcomponent263', None)
    assert not _is_linked(a, 'aadl2_Subcomponent263', b2)
    if hasattr(b2, 'aadl2_ComponentPrototype264'):
        assert not _is_linked(b2, 'aadl2_ComponentPrototype264', a)


def test_assoc_prototype391_link_reassign_clear():
    ...
    if hasattr(b1, 'aadl2_FeaturePrototype392'):
        assert _is_linked(b1, 'aadl2_FeaturePrototype392', a)
    _safe_set(a, 'aadl2_FeaturePrototypeReference', b2)
    assert _is_linked(a, 'aadl2_FeaturePrototypeReference', b2)
    if hasattr(b1, 'aadl2_FeaturePrototype392'):
        assert not _is_linked(b1, 'aadl2_FeaturePrototype392', a)
    if hasattr(b2, 'aadl2_FeaturePrototype392'):
        assert _is_linked(b2, 'aadl2_FeaturePrototype392', a)
    _safe_set(a, 'aadl2_FeaturePrototypeReference', None)
    assert not _is_linked(a, 'aadl2_FeaturePrototypeReference', b2)
    if hasattr(b2, 'aadl2_FeaturePrototype392'):
        assert not _is_linked(b2, 'aadl2_FeaturePrototype392', a)


def test_assoc_refined173_link_reassign_clear():
    a = aadl2_FlowSpecification(kind="sample_text")
    b1 = aadl2_FlowSpecification(kind="sample_text")
    b2 = aadl2_FlowSpecification(kind="sample_text_2")
    _safe_set(a, 'aadl2_FlowSpecification172', b1)
    assert _is_linked(a, 'aadl2_FlowSpecification172', b1)
    if hasattr(b1, 'aadl2_FlowSpecification174'):
        assert _is_linked(b1, 'aadl2_FlowSpecification174', a)
    _safe_set(a, 'aadl2_FlowSpecification172', b2)
    assert _is_linked(a, 'aadl2_FlowSpecification172', b2)
    if hasattr(b1, 'aadl2_FlowSpecification174'):
        assert not _is_linked(b1, 'aadl2_FlowSpecification174', a)
    if hasattr(b2, 'aadl2_FlowSpecification174'):
        assert _is_linked(b2, 'aadl2_FlowSpecification174', a)
    _safe_set(a, 'aadl2_FlowSpecification172', None)
    assert not _is_linked(a, 'aadl2_FlowSpecification172', b2)
    if hasattr(b2, 'aadl2_FlowSpecification174'):
        assert not _is_linked(b2, 'aadl2_FlowSpecification174', a)


def test_assoc_refined271_link_reassign_clear():
    a = aadl2_Subcomponent(allModes="sample_text")
    b1 = aadl2_Subcomponent(allModes="sample_text")
    b2 = aadl2_Subcomponent(allModes="sample_text_2")
    _safe_set(a, 'aadl2_Subcomponent270', b1)
    assert _is_linked(a, 'aadl2_Subcomponent270', b1)
    if hasattr(b1, 'aadl2_Subcomponent272'):
        assert _is_linked(b1, 'aadl2_Subcomponent272', a)
    _safe_set(a, 'aadl2_Subcomponent270', b2)
    assert _is_linked(a, 'aadl2_Subcomponent270', b2)
    if hasattr(b1, 'aadl2_Subcomponent272'):
        assert not _is_linked(b1, 'aadl2_Subcomponent272', a)
    if hasattr(b2, 'aadl2_Subcomponent272'):
        assert _is_linked(b2, 'aadl2_Subcomponent272', a)
    _safe_set(a, 'aadl2_Subcomponent270', None)
    assert not _is_linked(a, 'aadl2_Subcomponent270', b2)
    if hasattr(b2, 'aadl2_Subcomponent272'):
        assert not _is_linked(b2, 'aadl2_Subcomponent272', a)


def test_assoc_refined298_link_reassign_clear():
    a = aadl2_Connection(bidirectional="sample_text")
    b1 = aadl2_Connection(bidirectional="sample_text")
    b2 = aadl2_Connection(bidirectional="sample_text_2")
    _safe_set(a, 'aadl2_Connection297', b1)
    assert _is_linked(a, 'aadl2_Connection297', b1)
    if hasattr(b1, 'aadl2_Connection299'):
        assert _is_linked(b1, 'aadl2_Connection299', a)
    _safe_set(a, 'aadl2_Connection297', b2)
    assert _is_linked(a, 'aadl2_Connection297', b2)
    if hasattr(b1, 'aadl2_Connection299'):
        assert not _is_linked(b1, 'aadl2_Connection299', a)
    if hasattr(b2, 'aadl2_Connection299'):
        assert _is_linked(b2, 'aadl2_Connection299', a)
    _safe_set(a, 'aadl2_Connection297', None)
    assert not _is_linked(a, 'aadl2_Connection297', b2)
    if hasattr(b2, 'aadl2_Connection299'):
        assert not _is_linked(b2, 'aadl2_Connection299', a)


def test_assoc_refined60_link_reassign_clear():
    a = aadl2_Prototype()
    b1 = aadl2_Prototype()
    b2 = aadl2_Prototype()
    _safe_set(a, 'aadl2_Prototype59', b1)
    assert _is_linked(a, 'aadl2_Prototype59', b1)
    if hasattr(b1, 'aadl2_Prototype61'):
        assert _is_linked(b1, 'aadl2_Prototype61', a)
    _safe_set(a, 'aadl2_Prototype59', b2)
    assert _is_linked(a, 'aadl2_Prototype59', b2)
    if hasattr(b1, 'aadl2_Prototype61'):
        assert not _is_linked(b1, 'aadl2_Prototype61', a)
    if hasattr(b2, 'aadl2_Prototype61'):
        assert _is_linked(b2, 'aadl2_Prototype61', a)
    _safe_set(a, 'aadl2_Prototype59', None)
    assert not _is_linked(a, 'aadl2_Prototype59', b2)
    if hasattr(b2, 'aadl2_Prototype61'):
        assert not _is_linked(b2, 'aadl2_Prototype61', a)


def test_assoc_refinementContext62_link_reassign_clear():
    a = aadl2_Classifier(noAnnexes="sample_text", noProperties="sample_text", noPrototypes="sample_text")
    b1 = aadl2_RefinableElement()
    b2 = aadl2_RefinableElement()
    _safe_set(a, 'aadl2_Classifier63', b1)
    assert _is_linked(a, 'aadl2_Classifier63', b1)
    if hasattr(b1, 'aadl2_RefinableElement'):
        assert _is_linked(b1, 'aadl2_RefinableElement', a)
    _safe_set(a, 'aadl2_Classifier63', b2)
    assert _is_linked(a, 'aadl2_Classifier63', b2)
    if hasattr(b1, 'aadl2_RefinableElement'):
    ...
    _safe_set(a, 'aadl2_Classifier63', None)
    assert not _is_linked(a, 'aadl2_Classifier63', b2)
    if hasattr(b2, 'aadl2_RefinableElement'):
        assert not _is_linked(b2, 'aadl2_RefinableElement', a)


def test_assoc_relatedElement56_link_reassign_clear():
    a = aadl2_Element()
    b1 = aadl2_Relationship()
    b2 = aadl2_Relationship()
    _safe_set(a, 'aadl2_Element57', b1)
    assert _is_linked(a, 'aadl2_Element57', b1)
    if hasattr(b1, 'aadl2_Relationship'):
        assert _is_linked(b1, 'aadl2_Relationship', a)
    _safe_set(a, 'aadl2_Element57', b2)
    assert _is_linked(a, 'aadl2_Element57', b2)
    if hasattr(b1, 'aadl2_Relationship'):
        assert not _is_linked(b1, 'aadl2_Relationship', a)
    if hasattr(b2, 'aadl2_Relationship'):
        assert _is_linked(b2, 'aadl2_Relationship', a)
    _safe_set(a, 'aadl2_Element57', None)
    assert not _is_linked(a, 'aadl2_Element57', b2)
    if hasattr(b2, 'aadl2_Relationship'):
        assert not _is_linked(b2, 'aadl2_Relationship', a)


def test_assoc_renamedComponentType360_link_reassign_clear():
    a = aadl2_ComponentTypeRename(category="sample_text")
    b1 = aadl2_ComponentType(noFeatures="sample_text")
    b2 = aadl2_ComponentType(noFeatures="sample_text_2")
    _safe_set(a, 'aadl2_ComponentTypeRename361', b1)
    assert _is_linked(a, 'aadl2_ComponentTypeRename361', b1)
    if hasattr(b1, 'aadl2_ComponentType362'):
        assert _is_linked(b1, 'aadl2_ComponentType362', a)
    _safe_set(a, 'aadl2_ComponentTypeRename361', b2)
    assert _is_linked(a, 'aadl2_ComponentTypeRename361', b2)
    if hasattr(b1, 'aadl2_ComponentType362'):
        assert not _is_linked(b1, 'aadl2_ComponentType362', a)
    if hasattr(b2, 'aadl2_ComponentType362'):
        assert _is_linked(b2, 'aadl2_ComponentType362', a)
    _safe_set(a, 'aadl2_ComponentTypeRename361', None)
    assert not _is_linked(a, 'aadl2_ComponentTypeRename361', b2)
    if hasattr(b2, 'aadl2_ComponentType362'):
        assert not _is_linked(b2, 'aadl2_ComponentType362', a)


def test_assoc_renamedPackage347_link_reassign_clear():
    a = aadl2_PackageRename(renameAll="sample_text")
    b1 = aadl2_AadlPackage()
    b2 = aadl2_AadlPackage()
    _safe_set(a, 'aadl2_PackageRename348', b1)
    assert _is_linked(a, 'aadl2_PackageRename348', b1)
    if hasattr(b1, 'aadl2_AadlPackage'):
        assert _is_linked(b1, 'aadl2_AadlPackage', a)
    _safe_set(a, 'aadl2_PackageRename348', b2)
    assert _is_linked(a, 'aadl2_PackageRename348', b2)
    if hasattr(b1, 'aadl2_AadlPackage'):
        assert not _is_linked(b1, 'aadl2_AadlPackage', a)
    if hasattr(b2, 'aadl2_AadlPackage'):
        assert _is_linked(b2, 'aadl2_AadlPackage', a)
    _safe_set(a, 'aadl2_PackageRename348', None)
    assert not _is_linked(a, 'aadl2_PackageRename348', b2)
    if hasattr(b2, 'aadl2_AadlPackage'):
        assert not _is_linked(b2, 'aadl2_AadlPackage', a)


def test_assoc_size80_link_reassign_clear():
...
def test_assoc_sizeProperty81_link_reassign_clear():
    a = aadl2_ArraySize(size="sample_text")
    b1 = aadl2_ArraySizeProperty()
    b2 = aadl2_ArraySizeProperty()
    _safe_set(a, 'aadl2_ArraySize82', b1)
    assert _is_linked(a, 'aadl2_ArraySize82', b1)
    if hasattr(b1, 'aadl2_ArraySizeProperty'):
        assert _is_linked(b1, 'aadl2_ArraySizeProperty', a)
    _safe_set(a, 'aadl2_ArraySize82', b2)
    assert _is_linked(a, 'aadl2_ArraySize82', b2)
    if hasattr(b1, 'aadl2_ArraySizeProperty'):
    ...
    _safe_set(a, 'aadl2_ArraySize82', None)
    assert not _is_linked(a, 'aadl2_ArraySize82', b2)
    if hasattr(b2, 'aadl2_ArraySizeProperty'):
...
def test_assoc_source134_link_reassign_clear():
    ...
    b1 = aadl2_ModeTransition()
    b2 = aadl2_ModeTransition()
    _safe_set(a, 'aadl2_Mode136', b1)
    assert _is_linked(a, 'aadl2_Mode136', b1)
    if hasattr(b1, 'aadl2_ModeTransition135'):
        assert _is_linked(b1, 'aadl2_ModeTransition135', a)
    _safe_set(a, 'aadl2_Mode136', b2)
    assert _is_linked(a, 'aadl2_Mode136', b2)
    if hasattr(b1, 'aadl2_ModeTransition135'):
        assert not _is_linked(b1, 'aadl2_ModeTransition135', a)
    if hasattr(b2, 'aadl2_ModeTransition135'):
        assert _is_linked(b2, 'aadl2_ModeTransition135', a)
    _safe_set(a, 'aadl2_Mode136', None)
    assert not _is_linked(a, 'aadl2_Mode136', b2)
    if hasattr(b2, 'aadl2_ModeTransition135'):
        assert not _is_linked(b2, 'aadl2_ModeTransition135', a)


def test_assoc_source294_link_reassign_clear():
    a = aadl2_Connection(bidirectional="sample_text")
    b1 = aadl2_ConnectedElement()
    b2 = aadl2_ConnectedElement()
    _safe_set(a, 'aadl2_Connection295', b1)
    assert _is_linked(a, 'aadl2_Connection295', b1)
    if hasattr(b1, 'aadl2_ConnectedElement296'):
        assert _is_linked(b1, 'aadl2_ConnectedElement296', a)
    _safe_set(a, 'aadl2_Connection295', b2)
    assert _is_linked(a, 'aadl2_Connection295', b2)
    if hasattr(b1, 'aadl2_ConnectedElement296'):
        assert not _is_linked(b1, 'aadl2_ConnectedElement296', a)
    if hasattr(b2, 'aadl2_ConnectedElement296'):
        assert _is_linked(b2, 'aadl2_ConnectedElement296', a)
    _safe_set(a, 'aadl2_Connection295', None)
    assert not _is_linked(a, 'aadl2_Connection295', b2)
    if hasattr(b2, 'aadl2_ConnectedElement296'):
        assert not _is_linked(b2, 'aadl2_ConnectedElement296', a)
...
def test_assoc_source51_link_reassign_clear():
    ...
    _safe_set(a, 'aadl2_Element52', b1)
    assert _is_linked(a, 'aadl2_Element52', b1)
    if hasattr(b1, 'aadl2_DirectedRelationship'):
        assert _is_linked(b1, 'aadl2_DirectedRelationship', a)
    _safe_set(a, 'aadl2_Element52', b2)
    assert _is_linked(a, 'aadl2_Element52', b2)
    if hasattr(b1, 'aadl2_DirectedRelationship'):
    ...
    _safe_set(a, 'aadl2_Element52', None)
    assert not _is_linked(a, 'aadl2_Element52', b2)
    if hasattr(b2, 'aadl2_DirectedRelationship'):
        assert not _is_linked(b2, 'aadl2_DirectedRelationship', a)


def test_assoc_specific49_link_reassign_clear():
    a = aadl2_Classifier(noAnnexes="sample_text", noProperties="sample_text", noPrototypes="sample_text")
    b1 = aadl2_Generalization_()
    b2 = aadl2_Generalization_()
    _safe_set(a, 'Classifier50', b1)
    assert _is_linked(a, 'Classifier50', b1)
    if hasattr(b1, 'generalization'):
        assert _is_linked(b1, 'generalization', a)
    _safe_set(a, 'Classifier50', b2)
    assert _is_linked(a, 'Classifier50', b2)
    if hasattr(b1, 'generalization'):
        assert not _is_linked(b1, 'generalization', a)
    if hasattr(b2, 'generalization'):
        assert _is_linked(b2, 'generalization', a)
    _safe_set(a, 'Classifier50', None)
    assert not _is_linked(a, 'Classifier50', b2)
    if hasattr(b2, 'generalization'):
        assert not _is_linked(b2, 'generalization', a)


def test_assoc_specification282_link_reassign_clear():
    a = aadl2_FlowSpecification(kind="sample_text")
    b1 = aadl2_FlowImplementation(kind="sample_text")
    b2 = aadl2_FlowImplementation(kind="sample_text_2")
    _safe_set(a, 'aadl2_FlowSpecification284', b1)
    assert _is_linked(a, 'aadl2_FlowSpecification284', b1)
    if hasattr(b1, 'aadl2_FlowImplementation283'):
        assert _is_linked(b1, 'aadl2_FlowImplementation283', a)
    _safe_set(a, 'aadl2_FlowSpecification284', b2)
    assert _is_linked(a, 'aadl2_FlowSpecification284', b2)
    if hasattr(b1, 'aadl2_FlowImplementation283'):
        assert not _is_linked(b1, 'aadl2_FlowImplementation283', a)
    if hasattr(b2, 'aadl2_FlowImplementation283'):
        assert _is_linked(b2, 'aadl2_FlowImplementation283', a)
    _safe_set(a, 'aadl2_FlowSpecification284', None)
    assert not _is_linked(a, 'aadl2_FlowSpecification284', b2)
    if hasattr(b2, 'aadl2_FlowImplementation283'):
        assert not _is_linked(b2, 'aadl2_FlowImplementation283', a)


def test_assoc_subcomponentType257_link_reassign_clear():
    a = aadl2_Subcomponent(allModes="sample_text")
    b1 = aadl2_SubcomponentType()
    b2 = aadl2_SubcomponentType()
    _safe_set(a, 'aadl2_Subcomponent258', b1)
    assert _is_linked(a, 'aadl2_Subcomponent258', b1)
    if hasattr(b1, 'aadl2_SubcomponentType'):
        assert _is_linked(b1, 'aadl2_SubcomponentType', a)
    _safe_set(a, 'aadl2_Subcomponent258', b2)
    assert _is_linked(a, 'aadl2_Subcomponent258', b2)
    if hasattr(b1, 'aadl2_SubcomponentType'):
    ...
    _safe_set(a, 'aadl2_Subcomponent258', None)
    assert not _is_linked(a, 'aadl2_Subcomponent258', b2)
    if hasattr(b2, 'aadl2_SubcomponentType'):
        assert not _is_linked(b2, 'aadl2_SubcomponentType', a)


def test_assoc_subcomponentType370_link_reassign_clear():
    a = aadl2_ComponentPrototypeActual(category="sample_text")
    b1 = aadl2_SubcomponentType()
    b2 = aadl2_SubcomponentType()
    _safe_set(a, 'aadl2_ComponentPrototypeActual371', b1)
    assert _is_linked(a, 'aadl2_ComponentPrototypeActual371', b1)
    if hasattr(b1, 'aadl2_SubcomponentType372'):
        assert _is_linked(b1, 'aadl2_SubcomponentType372', a)
    _safe_set(a, 'aadl2_ComponentPrototypeActual371', b2)
    assert _is_linked(a, 'aadl2_ComponentPrototypeActual371', b2)
    if hasattr(b1, 'aadl2_SubcomponentType372'):
        assert not _is_linked(b1, 'aadl2_SubcomponentType372', a)
    if hasattr(b2, 'aadl2_SubcomponentType372'):
        assert _is_linked(b2, 'aadl2_SubcomponentType372', a)
    _safe_set(a, 'aadl2_ComponentPrototypeActual371', None)
    assert not _is_linked(a, 'aadl2_ComponentPrototypeActual371', b2)
    if hasattr(b2, 'aadl2_SubcomponentType372'):
        assert not _is_linked(b2, 'aadl2_SubcomponentType372', a)


def test_assoc_subprogramCall398_link_reassign_clear():
    a = aadl2_BehavioredImplementation()
    ...
    if hasattr(b1, 'aadl2_SubprogramCall399'):
        assert _is_linked(b1, 'aadl2_SubprogramCall399', a)
    _safe_set(a, 'aadl2_BehavioredImplementation', {b2})
    assert _is_linked(a, 'aadl2_BehavioredImplementation', b2)
    if hasattr(b1, 'aadl2_SubprogramCall399'):
        assert not _is_linked(b1, 'aadl2_SubprogramCall399', a)
    if hasattr(b2, 'aadl2_SubprogramCall399'):
        assert _is_linked(b2, 'aadl2_SubprogramCall399', a)
    _safe_set(a, 'aadl2_BehavioredImplementation', set())
    assert not _is_linked(a, 'aadl2_BehavioredImplementation', b2)
    if hasattr(b2, 'aadl2_SubprogramCall399'):
        assert not _is_linked(b2, 'aadl2_SubprogramCall399', a)
...
def test_assoc_target53_link_reassign_clear():
    ...
    if hasattr(b1, 'aadl2_DirectedRelationship54'):
        assert _is_linked(b1, 'aadl2_DirectedRelationship54', a)
    _safe_set(a, 'aadl2_Element55', b2)
    assert _is_linked(a, 'aadl2_Element55', b2)
    if hasattr(b1, 'aadl2_DirectedRelationship54'):
        assert not _is_linked(b1, 'aadl2_DirectedRelationship54', a)
    if hasattr(b2, 'aadl2_DirectedRelationship54'):
        assert _is_linked(b2, 'aadl2_DirectedRelationship54', a)
    _safe_set(a, 'aadl2_Element55', None)
    assert not _is_linked(a, 'aadl2_Element55', b2)
    if hasattr(b2, 'aadl2_DirectedRelationship54'):
        assert not _is_linked(b2, 'aadl2_DirectedRelationship54', a)
...
def test_assoc_type89_link_reassign_clear():
    ...
    if hasattr(b1, 'aadl2_ComponentImplementation90'):
        assert _is_linked(b1, 'aadl2_ComponentImplementation90', a)
    _safe_set(a, 'aadl2_ComponentType', b2)
    assert _is_linked(a, 'aadl2_ComponentType', b2)
    if hasattr(b1, 'aadl2_ComponentImplementation90'):
        assert not _is_linked(b1, 'aadl2_ComponentImplementation90', a)
    if hasattr(b2, 'aadl2_ComponentImplementation90'):
        assert _is_linked(b2, 'aadl2_ComponentImplementation90', a)
    _safe_set(a, 'aadl2_ComponentType', None)
    assert not _is_linked(a, 'aadl2_ComponentType', b2)
    if hasattr(b2, 'aadl2_ComponentImplementation90'):
        assert not _is_linked(b2, 'aadl2_ComponentImplementation90', a)


def test_assoc_unit789_link_reassign_clear():
    a = aadl2_UnitLiteral()
    b1 = aadl2_NumberValue()
    b2 = aadl2_NumberValue()
...
aadl2_InternalFeature_strategy = st.builds(aadl2_InternalFeature, direction=safe_text)
...
aadl2_PortProxy_strategy = st.builds(aadl2_PortProxy, direction=safe_text)
