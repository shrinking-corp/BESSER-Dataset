...
def test_hyp_genmymodelreverse_javax_swing_timer_is_not_abstract():
    assert not inspect.isabstract(genmymodelreverse_javax_swing_Timer)


def test_hyp_genmymodelreverse_javax_swing_timer_constructor_exists():
    assert callable(genmymodelreverse_javax_swing_Timer.__init__)


def test_hyp_genmymodelreverse_javax_swing_timer_constructor_args():
...
def test_hyp_genmymodelreverse_java_awt_event_keyevent_is_not_abstract():
    assert not inspect.isabstract(genmymodelreverse_java_awt_event_KeyEvent)


def test_hyp_genmymodelreverse_java_awt_event_keyevent_constructor_exists():
    assert callable(genmymodelreverse_java_awt_event_KeyEvent.__init__)


def test_hyp_genmymodelreverse_java_awt_event_keyevent_constructor_args():
    sig = inspect.signature(genmymodelreverse_java_awt_event_KeyEvent.__init__)
    params = list(sig.parameters.keys())



def test_hyp_genmymodelreverse_java_awt_event_keyadapter_is_not_abstract():
    assert not inspect.isabstract(genmymodelreverse_java_awt_event_KeyAdapter)


def test_hyp_genmymodelreverse_java_awt_event_keyadapter_constructor_exists():
    assert callable(genmymodelreverse_java_awt_event_KeyAdapter.__init__)


def test_hyp_genmymodelreverse_java_awt_event_keyadapter_constructor_args():
    sig = inspect.signature(genmymodelreverse_java_awt_event_KeyAdapter.__init__)
    params = list(sig.parameters.keys())



def test_hyp_genmymodelreverse_java_awt_event_actionlistener_interface_is_not_abstract():
    assert not inspect.isabstract(genmymodelreverse_java_awt_event_ActionListener_Interface)


def test_hyp_genmymodelreverse_java_awt_event_actionlistener_interface_constructor_exists():
    assert callable(genmymodelreverse_java_awt_event_ActionListener_Interface.__init__)


def test_hyp_genmymodelreverse_java_awt_event_actionlistener_interface_constructor_args():
...
def test_hyp_genmymodelreverse_java_nio_charset_charset_is_not_abstract():
    assert not inspect.isabstract(genmymodelreverse_java_nio_charset_Charset)


def test_hyp_genmymodelreverse_java_nio_charset_charset_constructor_exists():
    assert callable(genmymodelreverse_java_nio_charset_Charset.__init__)


def test_hyp_genmymodelreverse_java_nio_charset_charset_constructor_args():
...
def test_hyp_genmymodelreverse_java_awt_image_is_not_abstract():
    assert not inspect.isabstract(genmymodelreverse_java_awt_Image)


def test_hyp_genmymodelreverse_java_awt_image_constructor_exists():
    assert callable(genmymodelreverse_java_awt_Image.__init__)


def test_hyp_genmymodelreverse_java_awt_image_constructor_args():
    sig = inspect.signature(genmymodelreverse_java_awt_Image.__init__)
    params = list(sig.parameters.keys())



def test_hyp_snake_main_is_not_abstract():
    assert not inspect.isabstract(snake_Main)


def test_hyp_snake_main_constructor_exists():
    assert callable(snake_Main.__init__)


def test_hyp_snake_main_constructor_args():
...
def test_hyp_snake_tadapter_is_not_abstract():
    assert not inspect.isabstract(snake_TAdapter)


def test_hyp_snake_tadapter_constructor_exists():
    assert callable(snake_TAdapter.__init__)


def test_hyp_snake_tadapter_constructor_args():
    sig = inspect.signature(snake_TAdapter.__init__)
    params = list(sig.parameters.keys())



def test_hyp_snake_gamescene_is_not_abstract():
    assert not inspect.isabstract(snake_GameScene)


def test_hyp_snake_gamescene_constructor_exists():
    assert callable(snake_GameScene.__init__)


def test_hyp_snake_gamescene_constructor_args():
...
def test_hyp_snake_gamescene_has_DOT_SIZE():
...
def test_hyp_snake_gamescene_has_upDirection():
...
def test_hyp_snake_gamescene_has_bg():
...
def test_hyp_snake_gamescene_has_x():
...
def test_hyp_snake_gamescene_has_timer():
...
def test_hyp_snake_gamescene_has_level():
...
def test_hyp_snake_gamescene_has_leftDirection():
...
def test_hyp_snake_gamescene_has_apple():
...
def test_hyp_snake_gamescene_has_head():
...
def test_hyp_snake_gamescene_has_DELAY():
...
def test_hyp_snake_gamescene_has_inGame():
...
def test_hyp_snake_gamescene_has_B_WIDTH():
...
def test_hyp_snake_gamescene_has_bodyLength():
...
def test_hyp_snake_gamescene_has_B_HEIGHT():
...
def test_hyp_snake_gamescene_has_myScore():
...
def test_hyp_snake_gamescene_has_y():
...
def test_hyp_snake_gamescene_has_serialVersionUID():
...
def test_hyp_snake_gamescene_has_apple_x():
...
def test_hyp_snake_gamescene_has_ALL_DOTS():
...
def test_hyp_snake_gamescene_has_apple_y():
...
def test_hyp_snake_gamescene_has_RAND_POS():
...
def test_hyp_snake_gamescene_has_bodySegment():
...
def test_hyp_snake_gamescene_has_downDirection():
...
def test_hyp_snake_gamescene_has_rightDirection():
...
def test_hyp_snake_main_serialVersionUID_setter(instance):
...
def test_hyp_snake_gamescene_instantiation(instance):
    assert isinstance(instance, snake_GameScene)



@given(instance=snake_GameScene_strategy)
def test_hyp_snake_gamescene_DOT_SIZE_setter(instance):
...
@given(instance=snake_GameScene_strategy)
def test_hyp_snake_gamescene_upDirection_setter(instance):
...
@given(instance=snake_GameScene_strategy)
def test_hyp_snake_gamescene_bg_setter(instance):
...
@given(instance=snake_GameScene_strategy)
def test_hyp_snake_gamescene_x_setter(instance):
    original = instance.x
    instance.x = original
...
@given(instance=snake_GameScene_strategy)
def test_hyp_snake_gamescene_timer_setter(instance):
...
@given(instance=snake_GameScene_strategy)
def test_hyp_snake_gamescene_level_setter(instance):
...
@given(instance=snake_GameScene_strategy)
def test_hyp_snake_gamescene_leftDirection_setter(instance):
...
@given(instance=snake_GameScene_strategy)
def test_hyp_snake_gamescene_apple_setter(instance):
...
@given(instance=snake_GameScene_strategy)
def test_hyp_snake_gamescene_head_setter(instance):
...
@given(instance=snake_GameScene_strategy)
def test_hyp_snake_gamescene_DELAY_setter(instance):
...
@given(instance=snake_GameScene_strategy)
def test_hyp_snake_gamescene_inGame_setter(instance):
...
@given(instance=snake_GameScene_strategy)
def test_hyp_snake_gamescene_B_WIDTH_setter(instance):
...
@given(instance=snake_GameScene_strategy)
def test_hyp_snake_gamescene_bodyLength_setter(instance):
...
@given(instance=snake_GameScene_strategy)
def test_hyp_snake_gamescene_B_HEIGHT_setter(instance):
...
@given(instance=snake_GameScene_strategy)
def test_hyp_snake_gamescene_myScore_setter(instance):
...
@given(instance=snake_GameScene_strategy)
def test_hyp_snake_gamescene_y_setter(instance):
    original = instance.y
    instance.y = original
...
@given(instance=snake_GameScene_strategy)
def test_hyp_snake_gamescene_serialVersionUID_setter(instance):
    original = instance.serialVersionUID
    instance.serialVersionUID = original
    assert instance.serialVersionUID == original
...
@given(instance=snake_GameScene_strategy)
def test_hyp_snake_gamescene_apple_x_setter(instance):
...
@given(instance=snake_GameScene_strategy)
def test_hyp_snake_gamescene_ALL_DOTS_setter(instance):
...
@given(instance=snake_GameScene_strategy)
def test_hyp_snake_gamescene_apple_y_setter(instance):
...
@given(instance=snake_GameScene_strategy)
def test_hyp_snake_gamescene_RAND_POS_setter(instance):
...
@given(instance=snake_GameScene_strategy)
def test_hyp_snake_gamescene_bodySegment_setter(instance):
...
@given(instance=snake_GameScene_strategy)
def test_hyp_snake_gamescene_downDirection_setter(instance):
...
@given(instance=snake_GameScene_strategy)
def test_hyp_snake_gamescene_rightDirection_setter(instance):
...
@settings(max_examples=50)
def test_hyp_snake_backgrounds_instantiation(instance):
    assert isinstance(instance, snake_Backgrounds)



@given(instance=snake_Backgrounds_strategy)
def test_hyp_snake_backgrounds_backgrounds_setter(instance):
