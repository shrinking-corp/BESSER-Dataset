...
domain_model = DomainModel(
    name="FeatureModel",
    types={FeatureModel_RequireConstraint, FeatureModel_FeatureModel, NamedElement, FeatureModel_Comment, FeatureModel_Constraint, FeatureModel_Feature, FeatureModel_Group, FeatureModel_NamedElement, FeatureModel_ExcludeConstraint, Constraint, GroupType},
    associations={children10, requiredConstraints12, requireConstraints13, group15, comments0, constraints1, root3, groups5, element7, excludeConstraintsA16, excludeConstraintsB17, requiredFeature19, feature20, excludedFeatureA22, excludedFeatureB24, features26},
