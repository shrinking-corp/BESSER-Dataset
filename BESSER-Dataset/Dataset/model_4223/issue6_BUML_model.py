...
organization_Company = Class(name="organization_Company")
organization_Department = Class(name="organization_Department")
organization_ABase = Class(name="organization_ABase", is_abstract=True)
organization_core_Cass = Class(name="organization_core_Cass")
organization_Employee = Class(name="organization_Employee")
...
domain_model = DomainModel(
    name="organization",
    types={ABase, organization_Company, organization_Department, organization_ABase, organization_core_Cass, organization_Employee},
