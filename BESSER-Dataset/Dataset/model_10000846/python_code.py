...
class Shipment:
    ...
    def __init__(self, Date: date, Forbidden_to_ship: str, SippingType: str, pireodofShip: int, has_shippment3: set["Costomer"] = None):
        self.Date = Date
...
class Costomer:
    ...
    def __init__(self, Name: str, Email: str, mobileNumber: int, ID: int, Address: str, ship_to1: set["Order"] = None, Costomer_Shipment_02: set["Shipment"] = None):
        self.Name = Name
        self.Email = Email
