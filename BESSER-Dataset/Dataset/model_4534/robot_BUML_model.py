...
# Classes
robot_Program = Class(name="robot_Program")
robot_Instruction = Class(name="robot_Instruction", is_abstract=True)
robot_Bip = Class(name="robot_Bip")
Instruction = Class(name="Instruction")
robot_SetTurnAngle = Class(name="robot_SetTurnAngle")
robot_Turn = Class(name="robot_Turn")
robot_Move = Class(name="robot_Move")
robot_StopEngine = Class(name="robot_StopEngine")
robot_StopProgram = Class(name="robot_StopProgram")
robot_Obstacle = Class(name="robot_Obstacle")
ExpBool = Class(name="ExpBool")
robot_While = Class(name="robot_While")
robot_ExpBool = Class(name="robot_ExpBool", is_abstract=True)
robot_HasTurned = Class(name="robot_HasTurned")
robot_And = Class(name="robot_And")
robot_Not = Class(name="robot_Not")
robot_If = Class(name="robot_If")
...
domain_model = DomainModel(
    name="robot",
    types={robot_Program, robot_Instruction, robot_Bip, Instruction, robot_SetTurnAngle, robot_Turn, robot_Move, robot_StopEngine, robot_StopProgram, robot_Obstacle, ExpBool, robot_While, robot_ExpBool, robot_HasTurned, robot_And, robot_Not, robot_If},
    associations={instruction0, instruction9, left12, right14, expbool1, instruction2, expbool5, expbool7},
    generalizations={gen_robot_Bip_Instruction, gen_robot_SetTurnAngle_Instruction, gen_robot_Turn_Instruction, gen_robot_Move_Instruction, gen_robot_StopEngine_Instruction, gen_robot_StopProgram_Instruction, gen_robot_Obstacle_ExpBool, gen_robot_While_ExpBool, gen_robot_HasTurned_ExpBool, gen_robot_And_ExpBool, gen_robot_Not_ExpBool, gen_robot_If_ExpBool},
    metadata=None
)
