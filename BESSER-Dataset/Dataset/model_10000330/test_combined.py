...
@given(instance=Customer_strategy)
def test_hyp_customer_userid_setter(instance):
...
def test_Customer_name_value_roundtrip():
    instance = Customer(name="sample_text", password="sample_text", userid=7)
...
def test_Customer_userid_value_roundtrip():
    instance = Customer(name="sample_text", password="sample_text", userid=7)
...
def test_MonitorComplaint_complaintid_value_roundtrip():
    instance = MonitorComplaint(complaintid=7, complainttype="sample_text", date=date(2024, 1, 1))
...
Customer_strategy = st.builds(Customer, name=safe_text, password=safe_text, userid=st.integers())
@given(instance=Customer_strategy)
@settings(max_examples=25)
...
MonitorComplaint_strategy = st.builds(MonitorComplaint, complaintid=st.integers(), complainttype=safe_text, date=st.dates())
@given(instance=MonitorComplaint_strategy)
@settings(max_examples=25)
