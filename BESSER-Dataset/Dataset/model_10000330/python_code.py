...
class DBDetails:
    ...
    def __init__(self, isloggedin: bool, iIssessionout: bool):
...
class MonitorComplaint:
    ...
    def __init__(self, complaintid: int, date: date, complainttype: str):
        self.complaintid = complaintid
        self.date = date
        self.complainttype = complainttype
...
class Customer:
    ...
    def __init__(self, userid: int, name: str, password: str):
        self.userid = userid
        self.name = name
        self.password = password
