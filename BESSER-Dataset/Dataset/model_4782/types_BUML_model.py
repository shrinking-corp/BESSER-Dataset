...
types_Property.attributes={types_Property_external, types_Property_const, types_Property_readonly}
...
domain_model = DomainModel(
    name="types",
    types={types_PackageMember, types_Package, NamedElement, types_Domain, types_Type, PackageMember, types_TypeConstraint, types_Declaration, TypedElement, types_Operation, Declaration, types_Parameter, types_Property, types_TypedElement, types_Event, types_EnumerationType, PrimitiveType, types_Enumerator, types_PrimitiveType, Type, types_ComplexType, ParameterizedType, types_TypeParameter, types_ParameterizedType, types_RangeConstraint, TypeConstraint, types_TypeAlias, Direction},
    associations={member0, domain1, constraint3, parameters4, owningOperation5, type6, typeArguments8, enumerator11, baseType13, features14, superTypes16, owningEnumeration18, bound19, parameter21},
    generalizations={gen_types_Package_NamedElement, gen_types_EnumerationType_PrimitiveType, gen_types_Type_PackageMember, gen_types_Declaration_TypedElement, gen_types_Declaration_NamedElement, gen_types_Operation_Declaration, gen_types_Operation_PackageMember, gen_types_Property_Declaration, gen_types_Parameter_TypedElement, gen_types_Parameter_NamedElement, gen_types_Event_Declaration, gen_types_PrimitiveType_Type, gen_types_ComplexType_ParameterizedType, gen_types_Enumerator_NamedElement, gen_types_TypeParameter_Type, gen_types_ParameterizedType_Type, gen_types_PackageMember_NamedElement, gen_types_RangeConstraint_TypeConstraint, gen_types_TypeAlias_TypedElement, gen_types_TypeAlias_Type},
    metadata=None
)
