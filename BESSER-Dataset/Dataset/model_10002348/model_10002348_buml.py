...
Package_ShoppingCart = Class(name="Package_ShoppingCart")
...
Account.attributes={Account_open, Account_closed, Account_billingAddress, Account_isClosed}
...
Order.attributes={Order_status, Order_number, Order_ordered, Order_shipTo, Order_shipped, Order_total}
...
# Package_ShoppingCart class attributes and methods
Package_ShoppingCart_creationDate: Property = Property(name="creationDate", type=DateType)
Package_ShoppingCart.attributes={Package_ShoppingCart_creationDate}
...
WebUser_ShoppingCart: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="shoppingCart2", type=Package_ShoppingCart, multiplicity=Multiplicity(0, 1)),
...
Account_ShoppingCart: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="cart8", type=Package_ShoppingCart, multiplicity=Multiplicity(1, 1)),
...
ShoppingCart_LineItem: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="sc11", type=Package_ShoppingCart, multiplicity=Multiplicity(1, 1))
    }
)
...
domain_model = DomainModel(
    name="aaff22b1_42df_4fee_8227_1598f876225c",
    types={Customer, Payment, Account, WebUser, Order, LineItem, Product, Package_ShoppingCart, UserState, OrderStatus},
