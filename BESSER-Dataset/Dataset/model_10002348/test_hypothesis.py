...
def test_package_shoppingcart_is_not_abstract():
    assert not inspect.isabstract(Package_ShoppingCart)


def test_package_shoppingcart_constructor_exists():
    assert callable(Package_ShoppingCart.__init__)


def test_package_shoppingcart_constructor_args():
    sig = inspect.signature(Package_ShoppingCart.__init__)
    params = list(sig.parameters.keys())
    assert "creationDate" in params, "Missing parameter 'creationDate'"

def test_package_shoppingcart_has_creationDate():
    assert hasattr(Package_ShoppingCart, "creationDate")
    descriptor = None
    for klass in Package_ShoppingCart.__mro__:
...
@given(instance=Package_ShoppingCart_strategy)
def test_package_shoppingcart_creationDate_setter(instance):
