...
class Package_ShoppingCart:
    ...
    def webUser3(self, value):
        ...
        old_value = getattr(self, f"_Package_ShoppingCart__webUser3", None)
    ...
    def account9(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Package_ShoppingCart__account9", None)
    ...
    def items10(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Package_ShoppingCart__items10", None)
...
class LineItem:
    ...
    def __init__(self, quantity: int, price: float, sc11: "Package_ShoppingCart" = None, product13: "Product" = None, order15: "Order" = None):
...
class WebUser:
    ...
    def __init__(self, login: str, password: str, state: UserState, shoppingCart2: "Package_ShoppingCart" = None, customer4: "Customer" = None):
        self.login = login
...
class Account:
    ...
    def __init__(self, billingAddress: str, open: date, closed: date, isClosed: bool, customer7: "Customer" = None, cart8: "Package_ShoppingCart" = None, order16: set["Order"] = None, p0: set["Payment"] = None):
