...
# Classes
dsl_RunTimeModel = Class(name="dsl_RunTimeModel")
dsl_EnvironmentMetaData = Class(name="dsl_EnvironmentMetaData")
dsl_AppMetaData = Class(name="dsl_AppMetaData")
dsl_ServiceMetaData = Class(name="dsl_ServiceMetaData")
dsl_Metadata = Class(name="dsl_Metadata")
dsl_State = Class(name="dsl_State")
dsl_Resource = Class(name="dsl_Resource")
dsl_Specification = Class(name="dsl_Specification")
dsl_Trigger = Class(name="dsl_Trigger")
dsl_IfDoSpec = Class(name="dsl_IfDoSpec")
dsl_ElseIfDoSpec = Class(name="dsl_ElseIfDoSpec")
dsl_ElseDoSpec = Class(name="dsl_ElseDoSpec")
Metadata = Class(name="Metadata")
dsl_Element = Class(name="dsl_Element")
dsl_Action = Class(name="dsl_Action")
dsl_OrElement = Class(name="dsl_OrElement")
Element = Class(name="Element")
dsl_AndElement = Class(name="dsl_AndElement")
dsl_DiffElement = Class(name="dsl_DiffElement")
dsl_EqualElement = Class(name="dsl_EqualElement")
dsl_LargerElement = Class(name="dsl_LargerElement")
dsl_SmallerEqualElement = Class(name="dsl_SmallerEqualElement")
dsl_PlusElement = Class(name="dsl_PlusElement")
dsl_MinusElement = Class(name="dsl_MinusElement")
dsl_MultiplicationElement = Class(name="dsl_MultiplicationElement")
dsl_DivisionElement = Class(name="dsl_DivisionElement")
dsl_LargerEqualElement = Class(name="dsl_LargerEqualElement")
dsl_SmallerElement = Class(name="dsl_SmallerElement")
dsl_Number_Object = Class(name="dsl_Number_Object")
dsl_Boolean_Object = Class(name="dsl_Boolean_Object")
dsl_Resource_Object = Class(name="dsl_Resource_Object")
dsl_State_Object = Class(name="dsl_State_Object")
dsl_NegateElement = Class(name="dsl_NegateElement")
dsl_ModuloElement = Class(name="dsl_ModuloElement")
...
dsl_Specification.attributes={dsl_Specification_priority, dsl_Specification_specID}
...
domain_model = DomainModel(
    name="dsl",
    types={dsl_RunTimeModel, dsl_EnvironmentMetaData, dsl_AppMetaData, dsl_ServiceMetaData, dsl_Metadata, dsl_State, dsl_Resource, dsl_Specification, dsl_Trigger, dsl_IfDoSpec, dsl_ElseIfDoSpec, dsl_ElseDoSpec, Metadata, dsl_Element, dsl_Action, dsl_OrElement, Element, dsl_AndElement, dsl_DiffElement, dsl_EqualElement, dsl_LargerElement, dsl_SmallerEqualElement, dsl_PlusElement, dsl_MinusElement, dsl_MultiplicationElement, dsl_DivisionElement, dsl_LargerEqualElement, dsl_SmallerElement, dsl_Number_Object, dsl_Boolean_Object, dsl_Resource_Object, dsl_State_Object, dsl_NegateElement, dsl_ModuloElement},
    associations={envData0, appData1, servicesData3, specifications6, trigger8, ifdo10, elseIfDo12, elseDo14, resource16, state19, states5, condition22, action24, condition26, action29, action32, resources35, resource38, left44, right46, left49, right51, left54, right56, left59, right61, left64, right66, state41, right76, left79, right81, left84, right86, left89, right91, left94, right96, left99, right101, left69, right71, left74, value109, value111, exp113, left104, right106},
    generalizations={gen_dsl_AppMetaData_Metadata, gen_dsl_EnvironmentMetaData_Metadata, gen_dsl_ServiceMetaData_Metadata, gen_dsl_OrElement_Element, gen_dsl_AndElement_Element, gen_dsl_DiffElement_Element, gen_dsl_EqualElement_Element, gen_dsl_LargerElement_Element, gen_dsl_SmallerEqualElement_Element, gen_dsl_PlusElement_Element, gen_dsl_MinusElement_Element, gen_dsl_MultiplicationElement_Element, gen_dsl_DivisionElement_Element, gen_dsl_LargerEqualElement_Element, gen_dsl_SmallerElement_Element, gen_dsl_Number_Object_Element, gen_dsl_Boolean_Object_Element, gen_dsl_Resource_Object_Element, gen_dsl_State_Object_Element, gen_dsl_NegateElement_Element, gen_dsl_ModuloElement_Element},
    metadata=None
)
