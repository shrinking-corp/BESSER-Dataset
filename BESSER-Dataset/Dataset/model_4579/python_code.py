...
class dsl_Resource:
    ...
    def __init__(self, name: str, dsl_Resource18: "dsl_Trigger" = None, dsl_Resource: set["dsl_State"] = None, dsl_Resource37: "dsl_EnvironmentMetaData" = None, dsl_Resource40: "dsl_Action" = None, dsl_Resource110: "dsl_Resource_Object" = None):
        self.name = name
...
class dsl_State:
    ...
    def __init__(self, name: str, dsl_State21: "dsl_Trigger" = None, dsl_State: "dsl_Resource" = None, dsl_State43: "dsl_Action" = None, dsl_State112: "dsl_State_Object" = None):
        self.name = name
