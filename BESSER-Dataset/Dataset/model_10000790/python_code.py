...
class Post:
    ...
    def __init__(self, privacy: str, info: str, price: int, user3: "User" = None):
...
class User:
    ...
    def __init__(self, name: str, myprofile0: "Profile" = None, post2: set["Post"] = None, login4: "Login" = None, group6: set["Group"] = None, registeration8: "Registration" = None, message10: set["Message"] = None, friends12: set["Friend"] = None, hashtag14: set["Hashtag"] = None, pages16: set["Page"] = None):
        self.name = name
    ...
    def hashtag14(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_User__hashtag14", None)
    ...
    def pages16(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_User__pages16", None)
...
class Registration:
    ...
    def __init__(self, fname: str, lname: str, password: secretGroup, userName: str, user9: "User" = None):
        self.fname = fname
        self.lname = lname
        self.password = password
        self.userName = userName
    ...
    def password(self):
        return self.__password
    @password.setter
    def password(self, password: secretGroup):
        self.__password = password
...
class Page:
    ...
    def __init__(self, name: str, user17: "User" = None):
        self.name = name
        self.user17 = user17
...
class Hashtag:
    ...
    def __init__(self, name: str, numOfRepeat: int, user15: "User" = None):
        self.name = name
