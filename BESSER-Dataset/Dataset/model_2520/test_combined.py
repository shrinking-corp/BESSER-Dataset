...
def test_hyp_ext_f_is_not_abstract():
    assert not inspect.isabstract(ext_F)


def test_hyp_ext_f_constructor_exists():
    assert callable(ext_F.__init__)


def test_hyp_ext_f_constructor_args():
...
def test_hyp_ext_exte_is_not_abstract():
    assert not inspect.isabstract(ext_ExtE)


def test_hyp_ext_exte_constructor_exists():
    assert callable(ext_ExtE.__init__)


def test_hyp_ext_exte_constructor_args():
...
def test_hyp_ext_f_id_setter(instance):
...
def test_hyp_ext_exte_value_setter(instance):
