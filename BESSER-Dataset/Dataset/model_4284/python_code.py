...
class pokerleague_Competition(DescribedEntity):
    ...
    def __init__(self, startDate: date, endDate: date, minimalAttendance: int, defaultBuyIn: int, defaultMinPlayers: int, defaultMaxPlayers: int, defaultTournamentAnnouncementLead: int, Competition: "pokerleague_Tournament" = None, pokerleague_Competition: "pokerleague_PrizeMoneyRuleSet" = None, competition: set["pokerleague_Tournament"] = None, pokerleague_Competition8: set["pokerleague_Player"] = None):
    ...
    @property
    def defaultTournamentAnnouncementLead(self):
...
class pokerleague_Tournament(DescribedEntity):
    ...
    def __init__(self, defaultBuyIn: int, tournamentAnnouncementLead: int, tournamentStart: str, tournamentEnd: str, minPlayers: int, maxPlayers: int, pokerleague_Tournament: "pokerleague_PrizeMoneyRuleSet" = None, tournament: set["pokerleague_Invitation"] = None, tournaments: "pokerleague_Competition" = None, tournament14: set["pokerleague_Game"] = None, Tournament16: "pokerleague_Invitation" = None, Tournament: "pokerleague_Competition" = None, Tournament23: "pokerleague_Game" = None):
        self.defaultBuyIn = defaultBuyIn
    ...
    @property
    def tournamentAnnouncementLead(self):
...
class pokerleague_Player(IdentifiableEntity):
    ...
    def __init__(self, active: bool, nick: str, firstName: str, lastName: str, emailAddress: str, pokerleague_Player18: "pokerleague_Invitation" = None, pokerleague_Player: "pokerleague_Competition" = None, pokerleague_Player28: "pokerleague_PlayerInGame" = None):
        self.active = active
        self.nick = nick
