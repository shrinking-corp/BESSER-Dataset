...
# Classes
pokerleague_DescribedEntity = Class(name="pokerleague_DescribedEntity", is_abstract=True)
IdentifiableEntity = Class(name="IdentifiableEntity")
pokerleague_Player = Class(name="pokerleague_Player")
pokerleague_PrizeMoneyRuleSet = Class(name="pokerleague_PrizeMoneyRuleSet")
DescribedEntity = Class(name="DescribedEntity")
pokerleague_Serializable = Class(name="pokerleague_Serializable", is_abstract=True)
pokerleague_DataStructureVersion = Class(name="pokerleague_DataStructureVersion")
Serializable = Class(name="Serializable")
pokerleague_DataVersion = Class(name="pokerleague_DataVersion")
pokerleague_Settings = Class(name="pokerleague_Settings")
pokerleague_IdentifiableEntity = Class(name="pokerleague_IdentifiableEntity", is_abstract=True)
pokerleague_PrizeMoneyRule = Class(name="pokerleague_PrizeMoneyRule")
pokerleague_Invitation = Class(name="pokerleague_Invitation")
pokerleague_PrizeMoneyFormula = Class(name="pokerleague_PrizeMoneyFormula")
pokerleague_Game = Class(name="pokerleague_Game")
pokerleague_Competition = Class(name="pokerleague_Competition")
pokerleague_InvitationEvent = Class(name="pokerleague_InvitationEvent")
pokerleague_Tournament = Class(name="pokerleague_Tournament")
pokerleague_PlayerInGame = Class(name="pokerleague_PlayerInGame")
...
pokerleague_Player.attributes={pokerleague_Player_firstName, pokerleague_Player_lastName, pokerleague_Player_nick, pokerleague_Player_emailAddress, pokerleague_Player_active}
...
pokerleague_IdentifiableEntity.attributes={pokerleague_IdentifiableEntity_id, pokerleague_IdentifiableEntity_obsolete, pokerleague_IdentifiableEntity_proxy}
...
pokerleague_Invitation.attributes={pokerleague_Invitation_ordinal, pokerleague_Invitation_uuid, pokerleague_Invitation_reply}
...
pokerleague_Competition.attributes={pokerleague_Competition_defaultTournamentAnnouncementLead, pokerleague_Competition_endDate, pokerleague_Competition_defaultMaxPlayers, pokerleague_Competition_defaultBuyIn, pokerleague_Competition_startDate, pokerleague_Competition_defaultMinPlayers, pokerleague_Competition_minimalAttendance}
...
pokerleague_InvitationEvent.attributes={pokerleague_InvitationEvent_sent, pokerleague_InvitationEvent_eventTime, pokerleague_InvitationEvent_eventType}
...
pokerleague_Tournament.attributes={pokerleague_Tournament_defaultBuyIn, pokerleague_Tournament_tournamentEnd, pokerleague_Tournament_tournamentStart, pokerleague_Tournament_maxPlayers, pokerleague_Tournament_tournamentAnnouncementLead, pokerleague_Tournament_minPlayers}
...
domain_model = DomainModel(
    name="pokerleague",
    types={pokerleague_DescribedEntity, IdentifiableEntity, pokerleague_Player, pokerleague_PrizeMoneyRuleSet, DescribedEntity, pokerleague_Serializable, pokerleague_DataStructureVersion, Serializable, pokerleague_DataVersion, pokerleague_Settings, pokerleague_IdentifiableEntity, pokerleague_PrizeMoneyRule, pokerleague_Invitation, pokerleague_PrizeMoneyFormula, pokerleague_Game, pokerleague_Competition, pokerleague_InvitationEvent, pokerleague_Tournament, pokerleague_PlayerInGame, InvitationReply, InvitationEventType},
    associations={defaultPrizeMoneyRuleSet9, prizeMoneyRules0, invitations11, prizeMoneyRuleSet1, competition12, prizeMoneyFormulas2, games13, prizeMoneyRule3, tournament15, player17, defaultPrizeMoneyRuleSet5, tournaments6, players7, tournament22, prizeMoneyRuleSet24, playersInGame26, player27, game29, events19, invitation20},
    generalizations={gen_pokerleague_DescribedEntity_IdentifiableEntity, gen_pokerleague_Player_IdentifiableEntity, gen_pokerleague_DataStructureVersion_Serializable, gen_pokerleague_DataVersion_Serializable, gen_pokerleague_Settings_Serializable, gen_pokerleague_IdentifiableEntity_Serializable, gen_pokerleague_Tournament_DescribedEntity, gen_pokerleague_PrizeMoneyRuleSet_DescribedEntity, gen_pokerleague_PrizeMoneyRule_IdentifiableEntity, gen_pokerleague_PrizeMoneyFormula_IdentifiableEntity, gen_pokerleague_Invitation_IdentifiableEntity, gen_pokerleague_Competition_DescribedEntity, gen_pokerleague_Game_IdentifiableEntity, gen_pokerleague_PlayerInGame_IdentifiableEntity, gen_pokerleague_InvitationEvent_IdentifiableEntity},
    metadata=None
)
