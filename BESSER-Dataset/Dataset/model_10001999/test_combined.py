...
def test_hyp_c_attrCA_setter(instance):
...
def test_B_attrB_value_roundtrip():
    instance = B(attrB="sample_text")
    assert instance.attrB == "sample_text"
    instance.attrB = "sample_text_2"
    assert instance.attrB == "sample_text_2"


def test_C_attrC2_value_roundtrip():
    instance = C(attrC2=True, attrCA=7)
    assert instance.attrC2 == True
    instance.attrC2 = False
    assert instance.attrC2 == False


def test_C_attrCA_value_roundtrip():
    instance = C(attrC2=True, attrCA=7)
    assert instance.attrCA == 7
    instance.attrCA = 13
    assert instance.attrCA == 13


def test_assoc_A_B_link_reassign_clear():
    a = B(attrB="sample_text")
...
def test_assoc_B_C_link_reassign_clear():
    a = C(attrC2=True, attrCA=7)
    b1 = B(attrB="sample_text")
    b2 = B(attrB="sample_text_2")
    _safe_set(a, 'b3', b1)
...
B_strategy = st.builds(B, attrB=safe_text)
@given(instance=B_strategy)
@settings(max_examples=25)
...
C_strategy = st.builds(C, attrC2=st.booleans(), attrCA=st.integers())
@given(instance=C_strategy)
@settings(max_examples=25)
