...
domain_model = DomainModel(
    name="RDBMS",
    types={RDBMS_Schema, RDBMS_Table, RDBMS_ForeignKey, RDBMS_Column, RDBMS_Key},
    associations={table0, foreignKey1, schema3, column4, hasKey5, hasForeignKey7, column20, referredBy23, schema25, refersTo27, owner29, column31, owner10, hasKey12, hasForeignKey15, owner18},
    generalizations={},
    metadata=None
)
