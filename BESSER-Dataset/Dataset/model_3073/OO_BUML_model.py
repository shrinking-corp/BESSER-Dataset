...
# Classes
OO_Feature = Class(name="OO_Feature", is_abstract=True)
OO_Datatype = Class(name="OO_Datatype")
OO_Model = Class(name="OO_Model")
Package = Class(name="Package")
OO_PackageableElement = Class(name="OO_PackageableElement", is_abstract=True)
NamedElement = Class(name="NamedElement")
OO_Package = Class(name="OO_Package")
OO_AnnotatedElement = Class(name="OO_AnnotatedElement", is_abstract=True)
OO_Annotation = Class(name="OO_Annotation")
OO_NamedElement = Class(name="OO_NamedElement", is_abstract=True)
AnnotatedElement = Class(name="AnnotatedElement")
PackageableElement = Class(name="PackageableElement")
OO_Classifier = Class(name="OO_Classifier", is_abstract=True)
OO_ExternalClass = Class(name="OO_ExternalClass")
Class_ = Class(name="Class")
OO_Class = Class(name="OO_Class")
Classifier = Class(name="Classifier")
OO_StructuralFeature = Class(name="OO_StructuralFeature", is_abstract=True)
Feature = Class(name="Feature")
OO_Operation = Class(name="OO_Operation")
OO_Parameter = Class(name="OO_Parameter")
OO_Reference = Class(name="OO_Reference")
StructuralFeature = Class(name="StructuralFeature")
OO_Attribute = Class(name="OO_Attribute")
...
domain_model = DomainModel(
    name="OO",
    types={OO_Feature, OO_Datatype, OO_Model, Package, OO_PackageableElement, NamedElement, OO_Package, OO_AnnotatedElement, OO_Annotation, OO_NamedElement, AnnotatedElement, PackageableElement, OO_Classifier, OO_ExternalClass, Class_, OO_Class, Classifier, OO_StructuralFeature, Feature, OO_Operation, OO_Parameter, OO_Reference, StructuralFeature, OO_Attribute, VisibilityEnum},
    associations={extendedBy6, features8, owner9, type11, package0, annotations1, contents2, extends4, parameters12, type14, owner16},
    generalizations={gen_OO_Datatype_Classifier, gen_OO_Feature_NamedElement, gen_OO_Model_Package, gen_OO_PackageableElement_NamedElement, gen_OO_NamedElement_AnnotatedElement, gen_OO_Package_PackageableElement, gen_OO_Classifier_PackageableElement, gen_OO_ExternalClass_Class, gen_OO_Class_Classifier, gen_OO_StructuralFeature_Feature, gen_OO_Operation_Feature, gen_OO_Parameter_NamedElement, gen_OO_Reference_StructuralFeature, gen_OO_Attribute_StructuralFeature},
    metadata=None
)
