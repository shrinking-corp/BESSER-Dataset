...
class jsm_MMethodImplementationParameter:
    ...
    def __init__(self, final: bool, name: str, parameters62: "jsm_AbstractMMethodImplementation" = None, MMethodImplementationParameter: "jsm_AbstractMMethodImplementation" = None):
        self.final = final
        self.name = name
...
class AbstractMExternalType:
    ...
    pass
class jsm_MExternalInterface(AbstractMExternalType, AbstractMInterface):
...
class jsm_AbstractMExternalType(ABC):
    ...
    def __init__(self, fullQualifiedName: str, jsm_AbstractMExternalType: "jsm_MExternalTypeReference" = None, externalTypes: "jsm_MRoot" = None, AbstractMExternalType: "jsm_MRoot" = None):
