...
# Classes
grapho_Edge = Class(name="grapho_Edge")
grapho_GraphO = Class(name="grapho_GraphO")
GraphElement = Class(name="GraphElement")
grapho_GraphElement = Class(name="grapho_GraphElement", is_abstract=True)
grapho_Node = Class(name="grapho_Node")
grapho_GraphOEditor = Class(name="grapho_GraphOEditor")
...
grapho_Node.attributes={grapho_Node_color, grapho_Node_shape, grapho_Node_label, grapho_Node_style}
...
domain_model = DomainModel(
    name="grapho",
    types={grapho_Edge, grapho_GraphO, GraphElement, grapho_GraphElement, grapho_Node, grapho_GraphOEditor},
    associations={nodeA1, nodeB2, elements0},
    generalizations={gen_grapho_Edge_GraphElement, gen_grapho_GraphO_GraphElement, gen_grapho_Node_GraphElement},
    metadata=None
)
