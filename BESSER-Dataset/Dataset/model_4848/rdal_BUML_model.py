...
core_RequirementsContainer = Class(name="core_RequirementsContainer")
...
core_IdentifiedElement.attributes={core_IdentifiedElement_id, core_IdentifiedElement_name, core_IdentifiedElement_description}
...
core_ContractualElement.attributes={core_ContractualElement_droppingReason, core_ContractualElement_scheduleDate, core_ContractualElement_timeCriticality, core_ContractualElement_dropped, core_ContractualElement_sources, core_ContractualElement_satisfactionLevel, core_ContractualElement_originDate}
...
core_Uncertainty.attributes={core_Uncertainty_scheduleImpact, core_Uncertainty_maturityIndex, core_Uncertainty_costsImpact, core_Uncertainty_propRiskIndex, core_Uncertainty_volatility, core_Uncertainty_riskIndex, core_Uncertainty_precedence}
...
core_Actor.attributes={core_Actor_phoneNumber, core_Actor_email, core_Actor_address}
...
core_ModelElementReference.attributes={core_ModelElementReference_satisfactionLevel, core_ModelElementReference_weight, core_ModelElementReference_verifies, core_ModelElementReference_reason}
...
domain_model = DomainModel(
    name="core",
    types={core_IdentifiedElement, core_ContractualElement, IdentifiedElement, core_Uncertainty, core_StakeHolder, core_EObject, core_Category, core_ReferencedModelElements, core_Actor, core_Expression, core_VerifiableElement, ContractualElement, core_Specification, VerifiableElement, core_SystemOverview, core_RequirementsGroup, core_VerificationActivity, core_Conflict, core_Rationale, core_Goal, core_SystemContext, core_Variable, core_Interaction, core_ConstraintLanguagesSpecification, Actor, core_AbstractRequirement, core_Requirement, AbstractRequirement, core_RequirementsContainer, core_RefExpressionCollectedModelElements, ReferencedModelElements, core_FormalLanguageExpression, core_RefUserSelectedModelElements, core_ModelElementReference, core_Assumption, core_Trace, core_TraceModelElementReference, ModelElementReference, RequirementsCoverageData, core_RequirementsCoverageData, core_RefDerivedModelElements, Direction, AssumptionType, RiskKind, VerificationMethod, AgregationType, VariableType, ContainerType},
    associations={changeUncertainty0, stakeholders1, evolvedTo3, tracedTo5, category7, satisfiedBy9, agents11, derivedFrom14, rationales17, contactInformation18, expression20, condition22, modes25, actors28, systOverview30, requirementGroups32, verificationActivities33, conflicts35, primaryActors42, goals45, systemToBe47, contexts50, systemBoundary52, globalSystem54, actors57, systemBoundary60, systemModes63, images66, interactions69, entity71, constraintLanguagesSpecification37, specifies39, goals75, contractualElements76, rationales77, requirements78, specification79, containedRequirements81, verifiedBy82, group83, assignedVariable85, conditionVariables88, refinedBY92, conflicts74, derivations98, subRequirements100, requirements102, imageRequirement103, requirement105, externalRef107, expression110, queryExpression113, modelElementReferences114, assumptions93, imageAssumption95, modelElement115, requirement125, parent117, requirements128, specifications118, feature120, contract123},
    generalizations={gen_core_ContractualElement_IdentifiedElement, gen_core_Uncertainty_IdentifiedElement, gen_core_VerifiableElement_ContractualElement, gen_core_Specification_VerifiableElement, gen_core_SystemOverview_ContractualElement, gen_core_SystemContext_IdentifiedElement, gen_core_Actor_IdentifiedElement, gen_core_Interaction_IdentifiedElement, gen_core_Conflict_IdentifiedElement, gen_core_StakeHolder_Actor, gen_core_RequirementsGroup_VerifiableElement, gen_core_AbstractRequirement_VerifiableElement, gen_core_Requirement_AbstractRequirement, gen_core_Goal_ContractualElement, gen_core_Assumption_AbstractRequirement, gen_core_VerificationActivity_IdentifiedElement, gen_core_RefExpressionCollectedModelElements_ReferencedModelElements, gen_core_RefUserSelectedModelElements_ReferencedModelElements, gen_core_ReferencedModelElements_IdentifiedElement, gen_core_Trace_ReferencedModelElements, gen_core_TraceModelElementReference_ModelElementReference, gen_core_TraceModelElementReference_RequirementsCoverageData, gen_core_RequirementsCoverageData_IdentifiedElement, gen_core_Variable_IdentifiedElement, gen_core_RefDerivedModelElements_ReferencedModelElements, gen_core_Rationale_IdentifiedElement, gen_core_ModelElementReference_IdentifiedElement, gen_core_RequirementsContainer_IdentifiedElement},
    metadata=None
)
