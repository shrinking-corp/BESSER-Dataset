...
class core_Assumption(AbstractRequirement):
    ...
    def __init__(self, type: str, assumptions: "core_Requirement" = None, imageAssumption: "core_Requirement" = None, Assumption: "core_Requirement" = None, Assumption96: "core_Requirement" = None):
        self.type = type
...
class ModelElementReference:
    ...
    pass
class core_TraceModelElementReference(ModelElementReference, RequirementsCoverageData):
...
class core_AbstractRequirement(VerifiableElement):
    ...
    def __init__(self, risk: str, AbstractRequirement: "core_RequirementsGroup" = None, core_AbstractRequirement: "core_AbstractRequirement" = None, core_AbstractRequirement80: set["core_AbstractRequirement"] = None, requirement: set["core_VerificationActivity"] = None, requirements: "core_RequirementsGroup" = None, core_AbstractRequirement86: "core_Variable" = None, core_AbstractRequirement89: set["core_Variable"] = None, AbstractRequirement106: "core_VerificationActivity" = None):
        self.risk = risk
...
class core_Specification(VerifiableElement):
    ...
    def __init__(self, version: str, core_Specification: set["core_Actor"] = None, core_Specification31: "core_SystemOverview" = None, specification: set["core_RequirementsGroup"] = None, core_Specification34: set["core_VerificationActivity"] = None, core_Specification36: set["core_Conflict"] = None, core_Specification43: set["core_EObject"] = None, core_Specification38: "core_ConstraintLanguagesSpecification" = None, core_Specification40: set["core_EObject"] = None, Specification: "core_RequirementsGroup" = None, core_Specification119: "core_Trace" = None):
...
class core_Goal(ContractualElement):
    ...
    def __init__(self, priority: str, core_Goal: "core_SystemOverview" = None, Goal: "core_Conflict" = None, goals: set["core_Conflict"] = None):
...
class core_VerificationActivity(IdentifiedElement):
    ...
    def __init__(self, verificationMethod: str, passed: bool, core_VerificationActivity: "core_Specification" = None, VerificationActivity: "core_AbstractRequirement" = None, verifiedBy: "core_AbstractRequirement" = None, core_VerificationActivity108: set["core_EObject"] = None, core_VerificationActivity111: "core_Expression" = None):
...
class core_Conflict(IdentifiedElement):
    ...
    def __init__(self, degree: str, core_Conflict: "core_Specification" = None, conflicts: set["core_Goal"] = None, Conflict: "core_Goal" = None):
        self.degree = degree
...
class core_Actor(IdentifiedElement):
    ...
    def __init__(self, address: str, email: str, phoneNumber: str, core_Actor: "core_ContractualElement" = None, core_Actor29: "core_Specification" = None, core_Actor59: "core_SystemContext" = None, core_Actor70: set["core_Interaction"] = None, core_Actor67: set["core_EObject"] = None):
...
class core_ContractualElement(IdentifiedElement):
    ...
    def __init__(self, sources: str, originDate: str, scheduleDate: str, dropped: bool, timeCriticality: str, droppingReason: str, satisfactionLevel: str, core_ContractualElement: "core_Uncertainty" = None, contractualElements: set["core_StakeHolder"] = None, core_ContractualElement4: "core_ContractualElement" = None, core_ContractualElement2: set["core_ContractualElement"] = None, core_ContractualElement6: set["core_EObject"] = None, core_ContractualElement8: "core_Category" = None, core_ContractualElement10: set["core_ReferencedModelElements"] = None, core_ContractualElement12: set["core_EObject"] = None, core_ContractualElement15: set["core_EObject"] = None, contract: set["core_Rationale"] = None, core_ContractualElement19: set["core_Actor"] = None, core_ContractualElement21: "core_Expression" = None, core_ContractualElement23: "core_Expression" = None, core_ContractualElement26: set["core_EObject"] = None, ContractualElement: "core_StakeHolder" = None, ContractualElement124: "core_Rationale" = None):
