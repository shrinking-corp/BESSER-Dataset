...
public class metrics_MetricSource  {
    ...
    public metrics_MetricSource(
        String name,        String metricLocation    ) {
        this.name = name;
    ...
    public metrics_MetricSource(
        String name,        String metricLocation        ArrayList<metrics_Metric> metrics_metrics,        ArrayList<metrics_MappingStatistic> metrics_mappingstatistics    ) {
        this.name = name;
        this.metricLocation = metricLocation;
