...
class metrics_Metric:
    ...
    def __init__(self, name: str, description: str, measurementKind: str, measurementPoint: str, metricCalculation: str, metrics_Metric: "metrics_Metric" = None, metrics_Metric6: set["metrics_Metric"] = None, metricRefs: "metrics_MetricSource" = None, metrics_Metric10: "metrics_Unit" = None, Metric: "metrics_MetricSource" = None, metrics_Metric18: "metrics_ValueDataKind" = None):
        self.name = name
...
class metrics_MappingXLS(Mapping):
    ...
    def __init__(self, headerRow: str, firstDataRow: str, sheetNumber: str, metrics_MappingXLS: set["metrics_MappingXLSColumn"] = None):
