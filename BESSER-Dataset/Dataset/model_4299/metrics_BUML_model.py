...
metrics_MappingRecordXLS = Class(name="metrics_MappingRecordXLS")
...
metrics_MappingXLSColumn = Class(name="metrics_MappingXLSColumn")
...
metrics_IdentifierDataKind.attributes={metrics_IdentifierDataKind_objectKind, metrics_IdentifierDataKind_objectProperty}
...
metrics_MappingStatistic.attributes={metrics_MappingStatistic_message, metrics_MappingStatistic_totalRecords}
...
metrics_MappingXLS.attributes={metrics_MappingXLS_sheetNumber, metrics_MappingXLS_headerRow, metrics_MappingXLS_firstDataRow}
...
metrics_Metric.attributes={metrics_Metric_description, metrics_Metric_measurementKind, metrics_Metric_name, metrics_Metric_metricCalculation, metrics_Metric_measurementPoint}
...
domain_model = DomainModel(
    name="metrics",
    types={metrics_DataKind, metrics_IdentifierDataKind, DataKind, metrics_Mapping, metrics_MappingCSV, Mapping, metrics_MappingRDBMS, metrics_MappingRecord, metrics_MappingRecordXLS, MappingRecord, metrics_MappingStatistic, metrics_DateTimeRange, metrics_MappingXLS, metrics_MappingXLSColumn, metrics_Metric, metrics_MetricSource, metrics_Unit, metrics_MetricValueRange, metrics_Value, metrics_ValueDataKind, KindHintType, ObjectKindType, ValueKindType},
    ...
    generalizations={gen_metrics_IdentifierDataKind_DataKind, gen_metrics_MappingCSV_Mapping, gen_metrics_MappingRDBMS_Mapping, gen_metrics_MappingRecordXLS_MappingRecord, gen_metrics_MappingXLS_Mapping, gen_metrics_ValueDataKind_DataKind},
    metadata=None
)
