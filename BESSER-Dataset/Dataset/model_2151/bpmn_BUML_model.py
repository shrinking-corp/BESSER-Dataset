...
bpmn_IdentifiableNode = Class(name="bpmn_IdentifiableNode")
...
bpmn_Activity.attributes={bpmn_Activity_looping, bpmn_Activity_orderedMessages, bpmn_Activity_activityType}
...
domain_model = DomainModel(
    name="bpmn",
    types={bpmn_Activity, Vertex, NamedBpmnObject, bpmn_MessagingEdge, bpmn_Group, bpmn_Lane, bpmn_SubProcess, bpmn_Artifact, Identifiable, bpmn_Association, bpmn_ArtifactsContainer, EModelElement, bpmn_Pool, bpmn_DataObject, Artifact, bpmn_IdentifiableNode, bpmn_BpmnDiagram, ArtifactsContainer, bpmn_Identifiable, bpmn_Graph, IdentifiableNode, bpmn_Vertex, bpmn_SequenceEdge, Graph, bpmn_NamedBpmnObject, Activity, bpmn_TextAnnotation, ActivityType, DirectionType, SequenceFlowConditionType},
    associations={incomingMessages0, outgoingMessages1, groups3, lane5, eventHandlerFor4, associations7, artifactsContainer9, artifacts10, pools15, messages16, source11, target13, sequenceEdges20, activities22, associations23, vertices19, pool28, bpmnDiagram30, source31, target33, activities26, lanes35, bpmnDiagram37, target42, eventHandlers44, graph39, source40, outgoingEdges46, incomingEdges49, graph52},
    generalizations={gen_bpmn_Activity_Vertex, gen_bpmn_Activity_NamedBpmnObject, gen_bpmn_Artifact_Identifiable, gen_bpmn_Artifact_NamedBpmnObject, gen_bpmn_ArtifactsContainer_NamedBpmnObject, gen_bpmn_Association_EModelElement, gen_bpmn_DataObject_Artifact, gen_bpmn_BpmnDiagram_Identifiable, gen_bpmn_BpmnDiagram_ArtifactsContainer, gen_bpmn_Group_Artifact, gen_bpmn_Identifiable_EModelElement, gen_bpmn_IdentifiableNode_Identifiable, gen_bpmn_Graph_IdentifiableNode, gen_bpmn_Graph_ArtifactsContainer, gen_bpmn_MessagingEdge_Identifiable, gen_bpmn_MessagingEdge_NamedBpmnObject, gen_bpmn_Lane_Identifiable, gen_bpmn_Lane_NamedBpmnObject, gen_bpmn_Pool_Graph, gen_bpmn_Pool_NamedBpmnObject, gen_bpmn_SequenceEdge_Identifiable, gen_bpmn_SequenceEdge_NamedBpmnObject, gen_bpmn_SubProcess_Activity, gen_bpmn_SubProcess_Graph, gen_bpmn_TextAnnotation_Artifact, gen_bpmn_Vertex_IdentifiableNode},
    metadata=None
)
