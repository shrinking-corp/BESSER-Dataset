...
class bpmn_Association(EModelElement):
    ...
    def __init__(self, direction: str, associations: "bpmn_Artifact" = None, associations14: "bpmn_IdentifiableNode" = None, Association25: "bpmn_IdentifiableNode" = None, Association: "bpmn_Artifact" = None):
...
class bpmn_IdentifiableNode(Identifiable):
    ...
    pass
class bpmn_SubProcess(Graph, Activity):

    def __init__(self, isTransaction: str, eventHandlerFor: set["bpmn_Activity"] = None, SubProcess: "bpmn_Activity" = None):
...
class bpmn_ArtifactsContainer(NamedBpmnObject):
    ...
    pass
class bpmn_Pool(Graph, NamedBpmnObject):
...
class bpmn_SequenceEdge(Identifiable, NamedBpmnObject):
    ...
    def __init__(self, conditionType: str, isDefault: str, SequenceEdge: "bpmn_Graph" = None, incomingEdges: "bpmn_Vertex" = None, sequenceEdges: "bpmn_Graph" = None, outgoingEdges: "bpmn_Vertex" = None, SequenceEdge48: "bpmn_Vertex" = None, SequenceEdge51: "bpmn_Vertex" = None):
...
class Vertex:
    ...
    pass
class bpmn_Activity(Vertex, NamedBpmnObject):

    def __init__(self, orderedMessages: str, looping: str, activityType: str, Activity: "bpmn_Group" = None, Activity32: "bpmn_MessagingEdge" = None, Activity34: "bpmn_MessagingEdge" = None, Activity27: "bpmn_Lane" = None, Activity45: "bpmn_SubProcess" = None, target: set["bpmn_MessagingEdge"] = None, source: set["bpmn_MessagingEdge"] = None, activities: set["bpmn_Group"] = None, activities6: "bpmn_Lane" = None, eventHandlers: "bpmn_SubProcess" = None):
