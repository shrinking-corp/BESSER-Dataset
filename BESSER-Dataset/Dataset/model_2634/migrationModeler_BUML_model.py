...
# Classes
migrationmodeler_EdgeRepresentation = Class(name="migrationmodeler_EdgeRepresentation")
migrationmodeler_Diagram = Class(name="migrationmodeler_Diagram")
Representation = Class(name="Representation")
migrationmodeler_Container = Class(name="migrationmodeler_Container")
migrationmodeler_Node = Class(name="migrationmodeler_Node")
migrationmodeler_Edge = Class(name="migrationmodeler_Edge")
migrationmodeler_Filter = Class(name="migrationmodeler_Filter")
migrationmodeler_Layer = Class(name="migrationmodeler_Layer")
migrationmodeler_GraphicalElement = Class(name="migrationmodeler_GraphicalElement", is_abstract=True)
migrationmodeler_AbstractNode = Class(name="migrationmodeler_AbstractNode", is_abstract=True)
GraphicalElement = Class(name="GraphicalElement")
AbstractNode = Class(name="AbstractNode")
migrationmodeler_NodeRepresentation = Class(name="migrationmodeler_NodeRepresentation")
migrationmodeler_Bordered = Class(name="migrationmodeler_Bordered")
migrationmodeler_BorderedRepresentation = Class(name="migrationmodeler_BorderedRepresentation")
migrationmodeler_ContainerRepresentation = Class(name="migrationmodeler_ContainerRepresentation")
migrationmodeler_AbstractRepresentation = Class(name="migrationmodeler_AbstractRepresentation", is_abstract=True)
migrationmodeler_Layout = Class(name="migrationmodeler_Layout")
AbstractRepresentation = Class(name="AbstractRepresentation")
migrationmodeler_Point = Class(name="migrationmodeler_Point")
migrationmodeler_EdgeStyle = Class(name="migrationmodeler_EdgeStyle")
migrationmodeler_AbstractNodeRepresentation = Class(name="migrationmodeler_AbstractNodeRepresentation", is_abstract=True)
migrationmodeler_NodeStyle = Class(name="migrationmodeler_NodeStyle")
AbstractNodeRepresentation = Class(name="AbstractNodeRepresentation")
migrationmodeler_ContainerStyle = Class(name="migrationmodeler_ContainerStyle")
migrationmodeler_Color = Class(name="migrationmodeler_Color")
migrationmodeler_BasicLabelStyle = Class(name="migrationmodeler_BasicLabelStyle")
BorderedStyle = Class(name="BorderedStyle")
migrationmodeler_TestCase = Class(name="migrationmodeler_TestCase")
migrationmodeler_Representation = Class(name="migrationmodeler_Representation", is_abstract=True)
migrationmodeler_BorderedStyle = Class(name="migrationmodeler_BorderedStyle")
LabelStyle = Class(name="LabelStyle")
migrationmodeler_FlatContainerStyle = Class(name="migrationmodeler_FlatContainerStyle")
ContainerStyle = Class(name="ContainerStyle")
migrationmodeler_LabelStyle = Class(name="migrationmodeler_LabelStyle")
BasicLabelStyle = Class(name="BasicLabelStyle")
migrationmodeler_Dot = Class(name="migrationmodeler_Dot")
NodeStyle = Class(name="NodeStyle")
migrationmodeler_GaugeSection = Class(name="migrationmodeler_GaugeSection")
migrationmodeler_Ellipse = Class(name="migrationmodeler_Ellipse")
migrationmodeler_Lozenge = Class(name="migrationmodeler_Lozenge")
migrationmodeler_ShapeContainerStyle = Class(name="migrationmodeler_ShapeContainerStyle")
migrationmodeler_Square = Class(name="migrationmodeler_Square")
migrationmodeler_BundledImage = Class(name="migrationmodeler_BundledImage")
migrationmodeler_WorkspaceImage = Class(name="migrationmodeler_WorkspaceImage")
migrationmodeler_GaugeCompositeStyle = Class(name="migrationmodeler_GaugeCompositeStyle")
migrationmodeler_Note = Class(name="migrationmodeler_Note")
...
migrationmodeler_AbstractRepresentation.attributes={migrationmodeler_AbstractRepresentation_hidden, migrationmodeler_AbstractRepresentation_mappingId, migrationmodeler_AbstractRepresentation_pinned, migrationmodeler_AbstractRepresentation_displayed}
...
migrationmodeler_Layout.attributes={migrationmodeler_Layout_height, migrationmodeler_Layout_y, migrationmodeler_Layout_x, migrationmodeler_Layout_width}
...
migrationmodeler_Point.attributes={migrationmodeler_Point_y, migrationmodeler_Point_x}
...
migrationmodeler_NodeStyle.attributes={migrationmodeler_NodeStyle_hideLabelByDefault, migrationmodeler_NodeStyle_labelPosition}
...
migrationmodeler_Color.attributes={migrationmodeler_Color_red, migrationmodeler_Color_blue, migrationmodeler_Color_green}
...
migrationmodeler_BasicLabelStyle.attributes={migrationmodeler_BasicLabelStyle_iconPath, migrationmodeler_BasicLabelStyle_labelFormat, migrationmodeler_BasicLabelStyle_labelSize, migrationmodeler_BasicLabelStyle_showIcon}
...
migrationmodeler_GaugeSection.attributes={migrationmodeler_GaugeSection_max, migrationmodeler_GaugeSection_min, migrationmodeler_GaugeSection_label, migrationmodeler_GaugeSection_value}
...
migrationmodeler_Ellipse.attributes={migrationmodeler_Ellipse_verticalDiameter, migrationmodeler_Ellipse_horizontalDiameter}
...
migrationmodeler_Lozenge.attributes={migrationmodeler_Lozenge_width, migrationmodeler_Lozenge_height}
...
domain_model = DomainModel(
    ...
    types={migrationmodeler_EdgeRepresentation, migrationmodeler_Diagram, Representation, migrationmodeler_Container, migrationmodeler_Node, migrationmodeler_Edge, migrationmodeler_Filter, migrationmodeler_Layer, migrationmodeler_GraphicalElement, migrationmodeler_AbstractNode, GraphicalElement, AbstractNode, migrationmodeler_NodeRepresentation, migrationmodeler_Bordered, migrationmodeler_BorderedRepresentation, migrationmodeler_ContainerRepresentation, migrationmodeler_AbstractRepresentation, migrationmodeler_Layout, AbstractRepresentation, migrationmodeler_Point, migrationmodeler_EdgeStyle, migrationmodeler_AbstractNodeRepresentation, migrationmodeler_NodeStyle, AbstractNodeRepresentation, migrationmodeler_ContainerStyle, migrationmodeler_Color, migrationmodeler_BasicLabelStyle, BorderedStyle, migrationmodeler_TestCase, migrationmodeler_Representation, migrationmodeler_BorderedStyle, LabelStyle, migrationmodeler_FlatContainerStyle, ContainerStyle, migrationmodeler_LabelStyle, BasicLabelStyle, migrationmodeler_Dot, NodeStyle, migrationmodeler_GaugeSection, migrationmodeler_Ellipse, migrationmodeler_Lozenge, migrationmodeler_ShapeContainerStyle, migrationmodeler_Square, migrationmodeler_BundledImage, migrationmodeler_WorkspaceImage, migrationmodeler_GaugeCompositeStyle, migrationmodeler_Note, RoutingStyle, LabelPosition, FontFormat, LabelAlignment, ContainerShape, BackgroundStyle, AlignmentKind, BundledImageShape},
    associations={elements14, containers0, nodes1, edges3, filters5, layers7, nodeRepresentations9, borderedRepresentations11, containerRepresentations12, edgeRepresentations16, source18, target21, layout24, source25, target28, bendpoints31, ownedStyle33, bordereds35, ownedStyle37, ownedStyle39, color41, beginLabelStyle43, centerLabelStyle45, endLabelStyle48, representations51, borderColor52, backgroundColor64, foregroundColor66, labelColor54, backgroundColor57, backgroundColor59, foregroundColor61, color73, backgroundColor69, color71, color75, color77, sections79, color81},
    generalizations={gen_migrationmodeler_Edge_GraphicalElement, gen_migrationmodeler_Diagram_Representation, gen_migrationmodeler_AbstractNode_GraphicalElement, gen_migrationmodeler_Node_AbstractNode, gen_migrationmodeler_Bordered_AbstractNode, gen_migrationmodeler_Container_GraphicalElement, gen_migrationmodeler_EdgeRepresentation_AbstractRepresentation, gen_migrationmodeler_AbstractNodeRepresentation_AbstractRepresentation, gen_migrationmodeler_NodeRepresentation_AbstractNodeRepresentation, gen_migrationmodeler_BorderedRepresentation_AbstractNodeRepresentation, gen_migrationmodeler_ContainerRepresentation_AbstractRepresentation, gen_migrationmodeler_NodeStyle_BorderedStyle, gen_migrationmodeler_NodeStyle_LabelStyle, gen_migrationmodeler_FlatContainerStyle_ContainerStyle, gen_migrationmodeler_ContainerStyle_LabelStyle, gen_migrationmodeler_ContainerStyle_BorderedStyle, gen_migrationmodeler_LabelStyle_BasicLabelStyle, gen_migrationmodeler_Dot_NodeStyle, gen_migrationmodeler_Ellipse_NodeStyle, gen_migrationmodeler_Lozenge_NodeStyle, gen_migrationmodeler_ShapeContainerStyle_ContainerStyle, gen_migrationmodeler_Square_NodeStyle, gen_migrationmodeler_BundledImage_NodeStyle, gen_migrationmodeler_WorkspaceImage_NodeStyle, gen_migrationmodeler_WorkspaceImage_ContainerStyle, gen_migrationmodeler_GaugeCompositeStyle_NodeStyle, gen_migrationmodeler_Note_NodeStyle},
    metadata=None
)
