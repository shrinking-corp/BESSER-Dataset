...
domain_model = DomainModel(
    name="gfsm",
    types={gfsm_Machine, gfsm_Transition, gfsm_State, gfsm_Guard},
    associations={outgoings4, incommings5, states7, transitions8, initialState11, from_0, to1, guard3},
    generalizations={},
    metadata=None
)
