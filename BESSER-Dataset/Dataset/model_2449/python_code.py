...
class gfsm_State:
    ...
    def __init__(self, name: str, from_: set["gfsm_Transition"] = None, to: set["gfsm_Transition"] = None, gfsm_State: "gfsm_Machine" = None, gfsm_State13: "gfsm_Machine" = None, State: "gfsm_Transition" = None, State2: "gfsm_Transition" = None):
        self.name = name
...
class gfsm_Transition:
    ...
    def __init__(self, event: str, Transition: "gfsm_State" = None, Transition6: "gfsm_State" = None, gfsm_Transition10: "gfsm_Machine" = None, outgoings: "gfsm_State" = None, incommings: "gfsm_State" = None, gfsm_Transition: "gfsm_Guard" = None):
        self.event = event
