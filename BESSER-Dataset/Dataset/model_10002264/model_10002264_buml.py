...
Product.attributes={Product_id, Product_name, Product_description}
...
Payment.attributes={Payment_id, Payment_comments, Payment_total}
...
Order.attributes={Order_status, Order_finalTotal, Order_shippingAddress, Order_id}
...
Customer.attributes={Customer_id, Customer_login, Customer_password, Customer_firstname, Customer_isBan, Customer_lastname, Customer_emailAddress}
...
domain_model = DomainModel(
    name="a0d4e913_de62_4bf8_b6e4_e5ede7d2d5b2",
