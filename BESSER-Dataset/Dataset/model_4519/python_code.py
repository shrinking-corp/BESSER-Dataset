...
class Primitives_Expression(Instruction):
    ...
    def __init__(self, Primitives_Expression3: "Primitives_Back" = None, Primitives_Expression5: "Primitives_Left" = None, Primitives_Expression7: "Primitives_Right" = None, Primitives_Expression: "Primitives_Forward" = None):
    ...
    def eval(self, Primitives_context) :
