...
# Classes
Primitives_LogoProgram = Class(name="Primitives_LogoProgram")
Primitives_Instruction = Class(name="Primitives_Instruction", is_abstract=True)
Primitives_Back = Class(name="Primitives_Back")
Primitives_Left = Class(name="Primitives_Left")
Primitives_Right = Class(name="Primitives_Right")
Primitives_Primitive = Class(name="Primitives_Primitive", is_abstract=True)
Instruction = Class(name="Instruction")
Primitives_Forward = Class(name="Primitives_Forward")
Primitive = Class(name="Primitive")
Primitives_Expression = Class(name="Primitives_Expression", is_abstract=True)
...
Primitives_Expression_m_eval: Method = Method(name="eval", parameters={Parameter(name='Primitives_context', type=StringType)}, type=StringType)
...
domain_model = DomainModel(
    name="Primitives",
    types={Primitives_LogoProgram, Primitives_Instruction, Primitives_Back, Primitives_Left, Primitives_Right, Primitives_Primitive, Instruction, Primitives_Forward, Primitive, Primitives_Expression},
    associations={instructions0, steps2, angle4, angle6, steps1},
    generalizations={gen_Primitives_Back_Primitive, gen_Primitives_Left_Primitive, gen_Primitives_Right_Primitive, gen_Primitives_Expression_Instruction, gen_Primitives_Primitive_Instruction, gen_Primitives_Forward_Primitive},
    metadata=None
)
