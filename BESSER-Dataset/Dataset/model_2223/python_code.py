...
class programme_SemesterCourse:
    ...
    def __init__(self, courseType: str, programme_SemesterCourse: "programme_Semester" = None, programme_SemesterCourse18: "programme_Course" = None):
...
class programme_StudyYear:
    ...
    def __init__(self, year: int, programme_StudyYear12: "programme_Specialization" = None, programme_StudyYear: "programme_Programme" = None, programme_StudyYear14: set["programme_Semester"] = None):
        self.year = year
...
class programme_Specialization:
    ...
    def __init__(self, name: str, programme_Specialization11: set["programme_StudyYear"] = None, programme_Specialization: "programme_Programme" = None, programme_Specialization9: "programme_Specialization" = None, programme_Specialization7: set["programme_Specialization"] = None):
        self.name = name
...
class programme_Course:
    ...
    def __init__(self, name: str, code: str, taugtIn: str, level: str, credits: float, programme_Course: "programme_Department" = None, programme_Course19: "programme_SemesterCourse" = None):
        self.name = name
        self.code = code
...
class programme_Programme:
    ...
    def __init__(self, name: str, programmeType: str, code: str, programme_Programme: "programme_Department" = None, programme_Programme4: set["programme_Specialization"] = None, programme_Programme6: set["programme_StudyYear"] = None):
        self.name = name
...
class programme_Department:
    ...
    def __init__(self, name: str, programme_Department: set["programme_Programme"] = None, programme_Department2: set["programme_Course"] = None):
        self.name = name
