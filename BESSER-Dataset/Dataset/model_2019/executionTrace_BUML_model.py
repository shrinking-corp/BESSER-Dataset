...
# Classes
executionTrace_MapEntry = Class(name="executionTrace_MapEntry")
executionTrace_ExecutionTrace = Class(name="executionTrace_ExecutionTrace")
executionTrace_Execution = Class(name="executionTrace_Execution", is_abstract=True)
executionTrace_StoryPatternObjectBound = Class(name="executionTrace_StoryPatternObjectBound")
executionTrace_StoryPatternObjectNotBound = Class(name="executionTrace_StoryPatternObjectNotBound")
executionTrace_StoryPatternObjectBindingRevoked = Class(name="executionTrace_StoryPatternObjectBindingRevoked")
executionTrace_StoryPatternLinkExecution = Class(name="executionTrace_StoryPatternLinkExecution", is_abstract=True)
executionTrace_ActivityExecution = Class(name="executionTrace_ActivityExecution")
Execution = Class(name="Execution")
executionTrace_ActivityNodeExecution = Class(name="executionTrace_ActivityNodeExecution")
executionTrace_ActivityEdgeTraversal = Class(name="executionTrace_ActivityEdgeTraversal")
executionTrace_StoryPatternExecution = Class(name="executionTrace_StoryPatternExecution", is_abstract=True)
executionTrace_StoryPatternInitialization = Class(name="executionTrace_StoryPatternInitialization")
executionTrace_StoryPatternMatching = Class(name="executionTrace_StoryPatternMatching")
executionTrace_StoryPatternApplication = Class(name="executionTrace_StoryPatternApplication")
executionTrace_StoryPatternObjectExecution = Class(name="executionTrace_StoryPatternObjectExecution", is_abstract=True)
executionTrace_InstanceObjectCreation = Class(name="executionTrace_InstanceObjectCreation")
executionTrace_InstanceObjectDeletion = Class(name="executionTrace_InstanceObjectDeletion")
executionTrace_InstanceLinkModification = Class(name="executionTrace_InstanceLinkModification", is_abstract=True)
executionTrace_InstanceLinkCreation = Class(name="executionTrace_InstanceLinkCreation")
executionTrace_InstanceLinkDeletion = Class(name="executionTrace_InstanceLinkDeletion")
executionTrace_TraversingLink = Class(name="executionTrace_TraversingLink")
executionTrace_LinkCheck = Class(name="executionTrace_LinkCheck", is_abstract=True)
executionTrace_LinkCheckSuccessful = Class(name="executionTrace_LinkCheckSuccessful")
executionTrace_LinkCheckFailed = Class(name="executionTrace_LinkCheckFailed")
executionTrace_ExpressionEvaluation = Class(name="executionTrace_ExpressionEvaluation")
executionTrace_InstanceObjectModification = Class(name="executionTrace_InstanceObjectModification", is_abstract=True)
executionTrace_StoryPatternObjectConstraintHolds = Class(name="executionTrace_StoryPatternObjectConstraintHolds")
executionTrace_StoryPatternObjectConstraintViolated = Class(name="executionTrace_StoryPatternObjectConstraintViolated")
executionTrace_StoryPatternConstraintEvaluation = Class(name="executionTrace_StoryPatternConstraintEvaluation", is_abstract=True)
executionTrace_StoryPatternConstraintHolds = Class(name="executionTrace_StoryPatternConstraintHolds")
executionTrace_StoryPatternConstraintViolated = Class(name="executionTrace_StoryPatternConstraintViolated")
executionTrace_AttributeValueSet = Class(name="executionTrace_AttributeValueSet")
executionTrace_VariableModification = Class(name="executionTrace_VariableModification", is_abstract=True)
executionTrace_VariableCreated = Class(name="executionTrace_VariableCreated")
executionTrace_VariableDeleted = Class(name="executionTrace_VariableDeleted")
executionTrace_VariableChanged = Class(name="executionTrace_VariableChanged")
executionTrace_StoryPatternObjectConstraintEvaluation = Class(name="executionTrace_StoryPatternObjectConstraintEvaluation", is_abstract=True)
...
executionTrace_MapEntry.attributes={executionTrace_MapEntry_key, executionTrace_MapEntry_value}
...
executionTrace_ExecutionTrace.attributes={executionTrace_ExecutionTrace_totalExecutionTimeMsec, executionTrace_ExecutionTrace_totalExecutionTime, executionTrace_ExecutionTrace_description}
...
executionTrace_Execution.attributes={executionTrace_Execution_executionTimeMsec, executionTrace_Execution_executionFinishedTimeStamp, executionTrace_Execution_executionStartedTimeStamp, executionTrace_Execution_executionTime}
...
executionTrace_InstanceLinkModification.attributes={executionTrace_InstanceLinkModification_targetInstanceObject, executionTrace_InstanceLinkModification_sourceInstanceObject}
...
executionTrace_VariableModification.attributes={executionTrace_VariableModification_variableName, executionTrace_VariableModification_value}
...
domain_model = DomainModel(
    name="executionTrace",
    types={executionTrace_MapEntry, executionTrace_ExecutionTrace, executionTrace_Execution, executionTrace_StoryPatternObjectBound, executionTrace_StoryPatternObjectNotBound, executionTrace_StoryPatternObjectBindingRevoked, executionTrace_StoryPatternLinkExecution, executionTrace_ActivityExecution, Execution, executionTrace_ActivityNodeExecution, executionTrace_ActivityEdgeTraversal, executionTrace_StoryPatternExecution, executionTrace_StoryPatternInitialization, executionTrace_StoryPatternMatching, executionTrace_StoryPatternApplication, executionTrace_StoryPatternObjectExecution, executionTrace_InstanceObjectCreation, executionTrace_InstanceObjectDeletion, executionTrace_InstanceLinkModification, executionTrace_InstanceLinkCreation, executionTrace_InstanceLinkDeletion, executionTrace_TraversingLink, executionTrace_LinkCheck, executionTrace_LinkCheckSuccessful, executionTrace_LinkCheckFailed, executionTrace_ExpressionEvaluation, executionTrace_InstanceObjectModification, executionTrace_StoryPatternObjectConstraintHolds, executionTrace_StoryPatternObjectConstraintViolated, executionTrace_StoryPatternConstraintEvaluation, executionTrace_StoryPatternConstraintHolds, executionTrace_StoryPatternConstraintViolated, executionTrace_AttributeValueSet, executionTrace_VariableModification, executionTrace_VariableCreated, executionTrace_VariableDeleted, executionTrace_VariableChanged, executionTrace_StoryPatternObjectConstraintEvaluation},
    associations={elements2, executions0, container4},
    generalizations={gen_executionTrace_StoryPatternLinkExecution_Execution, gen_executionTrace_ActivityExecution_Execution, gen_executionTrace_ActivityNodeExecution_Execution, gen_executionTrace_ActivityEdgeTraversal_Execution, gen_executionTrace_StoryPatternExecution_Execution, gen_executionTrace_StoryPatternObjectExecution_Execution, gen_executionTrace_InstanceLinkModification_Execution, gen_executionTrace_ExpressionEvaluation_Execution, gen_executionTrace_InstanceObjectModification_Execution, gen_executionTrace_AttributeValueSet_Execution, gen_executionTrace_VariableModification_Execution},
    metadata=None
)
