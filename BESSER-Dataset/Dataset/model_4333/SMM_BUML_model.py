...
smm_Scope.attributes={smm_Scope_enumerated, smm_Scope_recognizer, smm_Scope_name, smm_Scope_class_}
...
smm_RankingInterval.attributes={smm_RankingInterval_minimumEndpoint, smm_RankingInterval_symbol, smm_RankingInterval_minimumOpen, smm_RankingInterval_maximumEndpoint, smm_RankingInterval_maximumOpen}
...
domain_model = DomainModel(
    name="smm",
    types={smm_CategoryRelationship, SmmRelationship, smm_Category, smm_SmmElement, smm_SmmModel, smm_Attribute, smm_Annotation, SmmElement, smm_SmmRelationship, smm_Characteristic, smm_Scope, smm_Observation, smm_MeasurementRelationship, smm_Measure, smm_Measurement, smm_MeasureRelationship, smm_DimensionalMeasure, Measure, smm_Ranking, smm_RankingInterval, smm_NamedMeasure, smm_RescaledMeasure, smm_RatioMeasure, BinaryMeasure, smm_Counting, DirectMeasure, smm_DimensionalMeasurement, Measurement, smm_Grade, smm_BinaryMeasure, DimensionalMeasure, smm_DirectMeasure, smm_CollectiveMeasure, smm_DirectMeasurement, DimensionalMeasurement, smm_Count, DirectMeasurement, smm_CollectiveMeasurement, smm_AggregatedMeasurement, smm_NamedMeasurement, smm_ReScaledMeasurement, Accumulator},
    associations={from_5, to6, category9, categoryElement12, outCategory14, inCategory15, model0, attribute1, annotation2, modelElement4, trait35, scope36, measure37, observation39, outMeasurement40, inMeasurement42, categoryMeasure17, category19, equivalentFrom22, equivalentTo25, refinement28, measurement29, outMeasure30, inMeasure32, interval49, rank50, from_45, to47, baseMeasurement63, parent52, characteristics53, measures55, baseMeasure157, baseMeasure258, baseMeasure61, owner74, from_64, to66, baseMeasurement68, baseMeasurement70, owner72},
    generalizations={gen_smm_CategoryRelationship_SmmRelationship, gen_smm_Category_SmmElement, gen_smm_SmmModel_SmmElement, gen_smm_SmmRelationship_SmmElement, gen_smm_Measurement_SmmElement, gen_smm_Measure_SmmElement, gen_smm_DimensionalMeasure_Measure, gen_smm_Ranking_Measure, gen_smm_RankingInterval_SmmElement, gen_smm_Observation_SmmElement, gen_smm_MeasureRelationship_SmmRelationship, gen_smm_NamedMeasure_DimensionalMeasure, gen_smm_RescaledMeasure_DimensionalMeasure, gen_smm_RatioMeasure_BinaryMeasure, gen_smm_Counting_DirectMeasure, gen_smm_DimensionalMeasurement_Measurement, gen_smm_Grade_Measurement, gen_smm_MeasurementRelationship_SmmRelationship, gen_smm_Characteristic_SmmElement, gen_smm_Scope_SmmElement, gen_smm_BinaryMeasure_DimensionalMeasure, gen_smm_DirectMeasure_DimensionalMeasure, gen_smm_CollectiveMeasure_DimensionalMeasure, gen_smm_DirectMeasurement_DimensionalMeasurement, gen_smm_Count_DirectMeasurement, gen_smm_CollectiveMeasurement_DimensionalMeasurement, gen_smm_AggregatedMeasurement_DimensionalMeasurement, gen_smm_NamedMeasurement_DimensionalMeasurement, gen_smm_ReScaledMeasurement_DimensionalMeasurement, gen_smm_Attribute_SmmElement, gen_smm_Annotation_SmmElement},
    metadata=None
)
