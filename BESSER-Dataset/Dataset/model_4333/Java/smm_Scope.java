...
public class smm_Scope extends SmmElement {
    ...
    public smm_Scope(
        String class_,        String recognizer,        String name,        boolean enumerated    ) {
        super(
        );
        this.class_ = class_;
    ...
    public smm_Scope(
        String class_,        String recognizer,        String name,        boolean enumerated        ArrayList<smm_Measure> smm_measures    ) {
        this.class_ = class_;
        this.recognizer = recognizer;
        this.name = name;
        this.enumerated = enumerated;
