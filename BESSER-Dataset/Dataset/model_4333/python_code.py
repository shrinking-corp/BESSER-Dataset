...
class smm_Measurement(SmmElement):
    ...
    def __init__(self, error: str, Measurement: "smm_Measure" = None, Measurement65: "smm_MeasurementRelationship" = None, Measurement67: "smm_MeasurementRelationship" = None, measurement: "smm_Measure" = None, smm_Measurement: "smm_Observation" = None, from_41: set["smm_MeasurementRelationship"] = None, to43: set["smm_MeasurementRelationship"] = None):
        self.error = error
        ...
        self.from_41 = from_41 if from_41 is not None else set()
    ...
    @property
    def from_41(self):
        return self.__from_41

    @from_41.setter
    def from_41(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_smm_Measurement__from_41", None)
        self.__from_41 = value if value is not None else set()
...
class smm_Scope(SmmElement):
    ...
    def __init__(self, class_: str, enumerated: bool, name: str, recognizer: str, scope: set["smm_Measure"] = None, Scope: "smm_Measure" = None):
        self.class_ = class_
...
class smm_Measure(SmmElement):
    ...
    def __init__(self, library: str, name: str, equivalentTo: set["smm_Measure"] = None, Measure26: "smm_Measure" = None, equivalentFrom: set["smm_Measure"] = None, smm_Measure: "smm_Measure" = None, smm_Measure27: set["smm_Measure"] = None, measure: set["smm_Measurement"] = None, from_31: set["smm_MeasureRelationship"] = None, to33: set["smm_MeasureRelationship"] = None, Measure46: "smm_MeasureRelationship" = None, Measure48: "smm_MeasureRelationship" = None, Measure54: "smm_Characteristic" = None, Measure56: "smm_Scope" = None, characteristics: "smm_Characteristic" = None, measures: "smm_Scope" = None, Measure38: "smm_Measurement" = None, Measure: "smm_Category" = None, categoryMeasure: set["smm_Category"] = None, Measure23: "smm_Measure" = None):
    ...
    def from_31(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_smm_Measure__from_31", None)
...
class smm_Characteristic(SmmElement):
    ...
    def __init__(self, name: str, smm_Characteristic: "smm_Characteristic" = None, smm_Characteristic51: "smm_Characteristic" = None, trait: set["smm_Measure"] = None, Characteristic: "smm_Measure" = None):
        self.name = name
...
class smm_SmmElement(ABC):
    ...
    def __init__(self, modelElement: "smm_SmmModel" = None, SmmElement75: "smm_Annotation" = None, SmmElement73: "smm_Attribute" = None, owner: set["smm_Attribute"] = None, owner3: set["smm_Annotation"] = None, SmmElement: "smm_SmmModel" = None):
...
class smm_Category(SmmElement):
    ...
    def __init__(self, name: str, Category: "smm_CategoryRelationship" = None, Category7: "smm_CategoryRelationship" = None, Category10: "smm_Category" = None, categoryElement: set["smm_Category"] = None, Category13: "smm_Category" = None, category: set["smm_Category"] = None, from_: set["smm_CategoryRelationship"] = None, to: set["smm_CategoryRelationship"] = None, category18: set["smm_Measure"] = None, Category20: "smm_Measure" = None):
        self.name = name
    ...
    def from_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_smm_Category__from_", None)
...
class smm_MeasurementRelationship(SmmRelationship):
    ...
    def __init__(self, name: str, outMeasurement: "smm_Measurement" = None, inMeasurement: "smm_Measurement" = None, MeasurementRelationship: "smm_Measurement" = None, MeasurementRelationship44: "smm_Measurement" = None):
        self.name = name
    ...
    def MeasurementRelationship(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "from_41"):
                opp_val = getattr(old_value, "from_41", None)
                if isinstance(opp_val, set):
                    opp_val.discard(self)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "from_41"):
                opp_val = getattr(value, "from_41", None)
                if opp_val is None:
                    setattr(value, "from_41", set([self]))
                elif isinstance(opp_val, set):
                    opp_val.add(self)
