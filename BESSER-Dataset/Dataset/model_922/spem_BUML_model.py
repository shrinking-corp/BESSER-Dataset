...
# Classes
spem_Process = Class(name="spem_Process")
...
spem_Activity.attributes={spem_Activity_name, spem_Activity_durationmax, spem_Activity_durationmin}
...
domain_model = DomainModel(
    ...
    associations={linkToSuccessor3, linkToPredecessor5, process7, successor8, activities0, workSquences1, predecessor10, process12},
    generalizations={},
    metadata=None
)
