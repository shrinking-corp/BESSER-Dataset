...
# Classes
fmp_Feature = Class(name="fmp_Feature")
Clonable = Class(name="Clonable")
fmp_Reference = Class(name="fmp_Reference")
fmp_TypedValue = Class(name="fmp_TypedValue")
fmp_Node = Class(name="fmp_Node", is_abstract=True)
fmp_Constraint = Class(name="fmp_Constraint")
fmp_FeatureGroup = Class(name="fmp_FeatureGroup")
Node = Class(name="Node")
fmp_Clonable = Class(name="fmp_Clonable", is_abstract=True)
fmp_Project = Class(name="fmp_Project")
...
fmp_TypedValue.attributes={fmp_TypedValue_integerValue, fmp_TypedValue_stringValue, fmp_TypedValue_floatValue}
...
fmp_Node.attributes={fmp_Node_max, fmp_Node_min, fmp_Node_id}
...
domain_model = DomainModel(
    name="fmp",
    types={fmp_Feature, Clonable, fmp_Reference, fmp_TypedValue, fmp_Node, fmp_Constraint, fmp_FeatureGroup, Node, fmp_Clonable, fmp_Project, ValueType, ConfigState},
    associations={configurations1, references2, typedValue3, describedNode5, constraints6, confs9, origin12, metaModel21, metaMetaModel24, featureValue27, clones31, prototype33, children15, properties16, feature17, model19},
    generalizations={gen_fmp_Feature_Clonable, gen_fmp_FeatureGroup_Node, gen_fmp_Clonable_Node, gen_fmp_Reference_Clonable},
    metadata=None
)
