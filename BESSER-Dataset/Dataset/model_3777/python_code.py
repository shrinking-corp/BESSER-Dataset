...
class fmp_Clonable(Node):
    ...
    def __init__(self, state: str, Clonable: "fmp_Clonable" = None, prototype: set["fmp_Clonable"] = None, Clonable34: "fmp_Clonable" = None, clones: "fmp_Clonable" = None):
        self.state = state
...
class fmp_Node(ABC):
    ...
    def __init__(self, max: int, min: int, id: str, Node: "fmp_Feature" = None, fmp_Node: "fmp_Node" = None, fmp_Node14: set["fmp_Node"] = None, describedNode: "fmp_Feature" = None, Node10: "fmp_Node" = None, origin: set["fmp_Node"] = None, Node13: "fmp_Node" = None, confs: "fmp_Node" = None):
        self.max = max
        self.min = min
        self.id = id
        self.Node = Node
...
class fmp_Feature(Clonable):
    ...
    def __init__(self, name: str, valueType: str, fmp_Feature: "fmp_Feature" = None, fmp_Feature0: set["fmp_Feature"] = None, feature: set["fmp_Reference"] = None, fmp_Feature4: "fmp_TypedValue" = None, properties: "fmp_Node" = None, fmp_Feature7: set["fmp_Constraint"] = None, Feature: "fmp_Node" = None, Feature18: "fmp_Reference" = None, fmp_Feature20: "fmp_Project" = None, fmp_Feature23: "fmp_Project" = None, fmp_Feature26: "fmp_Project" = None, fmp_Feature29: "fmp_TypedValue" = None):
        self.name = name
