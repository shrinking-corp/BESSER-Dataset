...
class researchvc_Paragraph(Counted, Named):
    ...
    def __init__(self, content: str, researchvc_Paragraph14: set["researchvc_ReviewNote"] = None, researchvc_Paragraph: "researchvc_Paper" = None, researchvc_Paragraph17: "researchvc_Write" = None):
        self.content = content
