...
class Project_Project:
    ...
    def __init__(self, name: str, budget: int, Project: "Project_Employee" = None, Project4: "Project_Department" = None, WorksOn_Project: set["Project_Employee"] = None, Controls_Project: "Project_Department" = None):
        self.name = name
        self.budget = budget
    ...
    def WorksOn_Project(self, value):
        ...
        old_value = getattr(self, f"_Project_Project__WorksOn_Project", None)
    ...
    def Controls_Project(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Project_Project__Controls_Project", None)
    ...
    def Project4(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Project_Project__Project4", None)
...
class Project_Department:
    ...
    def __init__(self, name: str, location: str, budget: int, Department: "Project_Employee" = None, WorksIn_Department: set["Project_Employee"] = None, Controls_Department: set["Project_Project"] = None, Department8: "Project_Project" = None):
        self.name = name
    ...
    def Department(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Project_Department__Department", None)
    ...
    def Controls_Department(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Project_Department__Controls_Department", None)
    ...
    def Department8(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Project_Department__Department8", None)
    ...
    def WorksIn_Department(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Project_Department__WorksIn_Department", None)
...
class Project_Employee:
    ...
    def __init__(self, name: str, salary: int, WorksIn_Employee: set["Project_Department"] = None, WorksOn_Employee: set["Project_Project"] = None, Employee: "Project_Department" = None, Employee6: "Project_Project" = None):
        self.name = name
        self.salary = salary
    ...
    def WorksOn_Employee(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Project_Employee__WorksOn_Employee", None)
    ...
    def WorksIn_Employee(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Project_Employee__WorksIn_Employee", None)
    ...
    def Employee6(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Project_Employee__Employee6", None)
    ...
    def Employee(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Project_Employee__Employee", None)
