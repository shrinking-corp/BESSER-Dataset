...
def test_hyp_project_department_is_not_abstract():
    assert not inspect.isabstract(Project_Department)


def test_hyp_project_department_constructor_exists():
    assert callable(Project_Department.__init__)


def test_hyp_project_department_constructor_args():
...
def test_hyp_project_employee_is_not_abstract():
    assert not inspect.isabstract(Project_Employee)


def test_hyp_project_employee_constructor_exists():
    assert callable(Project_Employee.__init__)


def test_hyp_project_employee_constructor_args():
...
def test_hyp_project_project_budget_setter(instance):
...
def test_hyp_project_department_budget_setter(instance):
    original = instance.budget
    instance.budget = original
    assert instance.budget == original
...
@given(instance=Project_Department_strategy)
def test_hyp_project_department_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=Project_Department_strategy)
def test_hyp_project_department_location_setter(instance):
...
def test_hyp_project_employee_salary_setter(instance):
...
@given(instance=Project_Employee_strategy)
def test_hyp_project_employee_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
