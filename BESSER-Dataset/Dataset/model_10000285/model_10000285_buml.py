...
Booking.attributes={Booking_checkOutDate, Booking_checkInDate, Booking__numberOfNights, Booking_bookingDate}
...
Contact.attributes={Contact_address, Contact_name, Contact_phone, Contact_email}
...
domain_model = DomainModel(
    name="_236f8053_da4d_4dc5_b96d_07bf95240c22",
    ...
    associations={Manager_Add_delete_Room_Types, Manager_Add_delete_Rooms, Guest_Make_Booking, Guest_Cancel_Booking, Receptionist_Make_Booking, Receptionist_Cancel_Booking, Receptionist_Guest_Check_in, Receptionist_Guest_Check_out, Booking_Contact, HotelBusiness_Hotel, Hotel_RoomType, RoomType_Room, Guest_Room, _hotel, Add_delete_Hotels_Administrator},
    generalizations={},
    metadata=None
)
