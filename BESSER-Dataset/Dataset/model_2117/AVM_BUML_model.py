...
avm_Component.attributes={avm_Component_Classifications, avm_Component_Supercedes, avm_Component_Version, avm_Component_ID, avm_Component_SchemaVersion, avm_Component_Name}
...
avm_DomainModel.attributes={avm_DomainModel_Name, avm_DomainModel_Author, avm_DomainModel_Notes, avm_DomainModel_YPosition, avm_DomainModel_XPosition}
...
avm_Property.attributes={avm_Property_Notes, avm_Property_OnDataSheet, avm_Property_YPosition, avm_Property_Definition, avm_Property_XPosition, avm_Property_ID, avm_Property_Name}
...
avm_Resource.attributes={avm_Resource_ID, avm_Resource_Hash, avm_Resource_Path, avm_Resource_Notes, avm_Resource_XPosition, avm_Resource_Name, avm_Resource_YPosition}
...
avm_Connector.attributes={avm_Connector_Name, avm_Connector_Definition, avm_Connector_Notes, avm_Connector_XPosition, avm_Connector_YPosition}
...
avm_Port.attributes={avm_Port_YPosition, avm_Port_XPosition, avm_Port_Definition, avm_Port_Name, avm_Port_Notes}
...
avm_Value.attributes={avm_Value_DataType, avm_Value_DimensionType, avm_Value_Dimensions, avm_Value_Unit}
...
avm_CalculatedValue.attributes={avm_CalculatedValue_Expression, avm_CalculatedValue_Type}
...
avm_DomainModelMetric.attributes={avm_DomainModelMetric_Notes, avm_DomainModelMetric_ID, avm_DomainModelMetric_YPosition, avm_DomainModelMetric_XPosition}
...
avm_ComponentInstance.attributes={avm_ComponentInstance_YPosition, avm_ComponentInstance_XPosition, avm_ComponentInstance_Name, avm_ComponentInstance_ID, avm_ComponentInstance_ComponentID, avm_ComponentInstance_DesignSpaceSrcComponentID}
...
avm_Design.attributes={avm_Design_DesignSpaceSrcID, avm_Design_Name, avm_Design_SchemaVersion, avm_Design_DesignID}
...
avm_Container.attributes={avm_Container_XPosition, avm_Container_Name, avm_Container_YPosition}
...
avm_TestBenchValueBase.attributes={avm_TestBenchValueBase_YPosition, avm_TestBenchValueBase_Name, avm_TestBenchValueBase_Notes, avm_TestBenchValueBase_ID, avm_TestBenchValueBase_XPosition}
...
avm_modelica_Limit.attributes={avm_modelica_Limit_Notes, avm_modelica_Limit_VariableLocator, avm_modelica_Limit_Name, avm_modelica_Limit_ToleranceTimeWindow, avm_modelica_Limit_BoundType}
...
avm_modelica_SolverSettings.attributes={avm_modelica_SolverSettings_StopTime, avm_modelica_SolverSettings_IntervalLength, avm_modelica_SolverSettings_ToolSpecificAnnotations, avm_modelica_SolverSettings_StartTime, avm_modelica_SolverSettings_JobManagerToolSelection, avm_modelica_SolverSettings_Tolerance, avm_modelica_SolverSettings_NumberOfIntervals, avm_modelica_SolverSettings_Solver, avm_modelica_SolverSettings_IntervalMethod}
...
domain_model = DomainModel(
    name="avm",
    types={avm_Component, avm_DomainModel, avm_Formula, avm_Property, avm_Resource, avm_Connector, avm_DistributionRestriction, avm_Port, avm_AnalysisConstruct, avm_Value, ValueNode, avm_ValueExpressionType, avm_DataSource, avm_FixedValue, ValueExpressionType, avm_CalculatedValue, avm_DerivedValue, avm_ValueNode, ConnectorCompositionTarget, avm_assemblyDetail, avm_ConnectorFeature, PortMapTarget, avm_DomainModelPort, Port, avm_DomainModelParameter, avm_ParametricValue, avm_UniformDistribution, avm_PrimitiveProperty, Property_, avm_ProbabilisticValue, avm_NormalDistribution, ProbabilisticValue, avm_SecurityClassification, DistributionRestriction, avm_Proprietary, avm_ITAR, avm_DomainModelMetric, avm_ComponentInstance, avm_CompoundProperty, avm_ParametricEnumeratedValue, avm_AbstractPort, avm_Design, avm_Container, avm_DesignDomainFeature, avm_ConnectorCompositionTarget, avm_Compound, Container, avm_Optional, DesignSpaceContainer, avm_Alternative, avm_ValueFlowMux, avm_ComponentPortInstance, avm_ComponentPrimitivePropertyInstance, avm_ComponentConnectorInstance, avm_DesignSpaceContainer, avm_PortMapTarget, avm_Parameter, avm_Metric, avm_TestInjectionPoint, avm_SimpleFormula, Formula, avm_ComplexFormula, avm_Operand, avm_DoDDistributionStatement, avm_TestBench, avm_TopLevelSystemUnderTest, avm_InterpreterTask, WorkflowTaskBase, avm_ExecutionTask, avm_Workflow, avm_Settings, ContainerInstanceBase, TestBenchValueBase, avm_ContainerInstanceBase, avm_TestBenchValueBase, avm_WorkflowTaskBase, avm_modelica_ModelicaModel, DomainModel_, Parameter_, Connector, Metric, Limit, Redeclare, avm_modelica_Connector, DomainModelPort, avm_modelica_Parameter, DomainModelParameter, modelica_avm_Value, avm_modelica_Metric, DomainModelMetric, avm_modelica_Limit, avm_cad_Datum, avm_modelica_Redeclare, avm_modelica_SolverSettings, Settings, avm_cad_CADModel, Datum, avm_cad_Geometry2D, Geometry, avm_cad_Geometry3D, avm_cad_Circle, Geometry2D, PointReference, avm_cad_Parameter, cad_avm_Value, avm_cad_Point, avm_cad_Axis, avm_cad_Plane, Plane, avm_cad_CoordinateSystem, avm_cad_Metric, avm_cad_Geometry, AnalysisConstruct, avm_cad_PointReference, Point, avm_cad_Polygon, avm_cad_Surface, avm_cad_ExtrudedGeometry, Geometry3D, avm_cad_Sphere, avm_cad_CustomGeometry, CustomGeometryInput, avm_cad_CustomGeometryInput, avm_cad_TranslationalJointSpec, PlaneReference, avm_cad_PlaneReference, avm_cad_GuideDatum, ConnectorFeature, avm_cad_AssemblyRoot, DesignDomainFeature, cad_avm_ComponentInstance, avm_cad_KinematicJointSpec, avm_cad_RevoluteJointSpec, KinematicJointSpec, Axis, avm_adamsCar_AdamsCarModel, FileReference, avm_adamsCar_Parameter, adamsCar_avm_Value, avm_adamsCar_FileReference, avm_manufacturing_ManufacturingModel, avm_manufacturing_Parameter, manufacturing_avm_Value, avm_manufacturing_Metric, avm_cyber_CyberModel, CalculationTypeEnum, DataTypeEnum, DimensionTypeEnum, SimpleFormulaOperation, DoDDistributionStatementEnum, BoundTypeEnum, RedeclareTypeEnum, IntervalMethod, JobManagerToolSelection, CustomGeometryInputOperationEnum, PartIntersectionEnum, GeometryQualifierEnum, ModelType},
    associations={DomainModel0, Formula13, Property1, ValueSource21, ResourceDependency3, UsesResource15, Connector5, DistributionRestriction7, Port9, AnalysisConstruct11, ValueExpression18, DataSource19, Default35, Maximum37, Minimum40, AssignedValue43, Role22, Property25, DefaultJoin28, Connector31, ConnectorFeature33, Value53, Mean46, StandardDeviation48, Value51, Property73, ComponentInstance76, Port78, CompoundProperty56, PrimitiveProperty57, AssignedValue60, Enum61, FromResource64, RootContainer67, DomainFeature68, Container71, PortMap101, ConnectorComposition103, Connector81, JoinData84, Formula87, ValueFlowMux90, PortInstance91, PrimitivePropertyInstance93, ConnectorInstance95, Value97, Parameter114, Metric116, TestInjectionPoint118, ApplyJoinData104, Operand107, Operand109, ValueSource110, TopLevelSystemUnderTest113, TestComponent120, Workflow123, Settings125, TestStructure127, Value130, Task132, TargetValue152, Source134, Parameter137, Connector138, Metric140, Limit142, Redeclare144, Parameter146, Redeclare148, Value151, DatumMetric163, Value154, Datum156, Parameter157, ModelMetric160, CircleCenter169, Value165, SurfaceReverseMap166, Metric167, InputGeometry188, ReferredPoint189, CircleEdge170, PolygonPoint173, ExtrusionHeight175, ExtrusionSurface177, DirectionReferencePoint179, SphereCenter182, SphereEdge184, CustomGeometryInput187, DefaultRotation206, MaximumRotation209, AlignmentPlane212, AlignmentAxis214, MinimumTranslation217, DefaultTranslation220, MaximumTranslation223, TranslationLimitReference226, ReferencePlane190, ReferredPlane191, Datum193, AssemblyRootComponentInstance195, AlignmentPlane196, AlignmentAxis198, RotationLimitReference200, MinimumRotation203, Parameter240, FileReference242, Value244, ParameterSwap245, FileReferenceSwap247, Parameter229, Metric231, Value234, Connector235, Parameter237},
    generalizations={gen_avm_Value_ValueNode, gen_avm_FixedValue_ValueExpressionType, gen_avm_CalculatedValue_ValueExpressionType, gen_avm_DerivedValue_ValueExpressionType, gen_avm_Connector_ConnectorCompositionTarget, gen_avm_Port_PortMapTarget, gen_avm_DomainModelPort_Port, gen_avm_ParametricValue_ValueExpressionType, gen_avm_UniformDistribution_ProbabilisticValue, gen_avm_PrimitiveProperty_Property, gen_avm_ProbabilisticValue_ValueExpressionType, gen_avm_NormalDistribution_ProbabilisticValue, gen_avm_SecurityClassification_DistributionRestriction, gen_avm_Proprietary_DistributionRestriction, gen_avm_ITAR_DistributionRestriction, gen_avm_CompoundProperty_Property, gen_avm_ParametricEnumeratedValue_ValueExpressionType, gen_avm_AbstractPort_Port, gen_avm_ComponentConnectorInstance_ConnectorCompositionTarget, gen_avm_Compound_Container, gen_avm_Optional_DesignSpaceContainer, gen_avm_Alternative_DesignSpaceContainer, gen_avm_ComponentPortInstance_PortMapTarget, gen_avm_DesignSpaceContainer_Container, gen_avm_Formula_ValueNode, gen_avm_SimpleFormula_Formula, gen_avm_ComplexFormula_Formula, gen_avm_DoDDistributionStatement_DistributionRestriction, gen_avm_InterpreterTask_WorkflowTaskBase, gen_avm_ExecutionTask_WorkflowTaskBase, gen_avm_TopLevelSystemUnderTest_ContainerInstanceBase, gen_avm_Parameter_TestBenchValueBase, gen_avm_Metric_TestBenchValueBase, gen_avm_TestInjectionPoint_ContainerInstanceBase, gen_avm_ValueFlowMux_ValueNode, gen_avm_modelica_ModelicaModel_DomainModel, gen_avm_modelica_Connector_DomainModelPort, gen_avm_modelica_Parameter_DomainModelParameter, gen_avm_modelica_Metric_DomainModelMetric, gen_avm_cad_Datum_DomainModelPort, gen_avm_modelica_Redeclare_DomainModelParameter, gen_avm_modelica_SolverSettings_Settings, gen_avm_cad_CADModel_DomainModel, gen_avm_cad_Geometry2D_Geometry, gen_avm_cad_Geometry3D_Geometry, gen_avm_cad_Circle_Geometry2D, gen_avm_cad_Parameter_DomainModelParameter, gen_avm_cad_Point_Datum, gen_avm_cad_Axis_Datum, gen_avm_cad_Plane_Datum, gen_avm_cad_CoordinateSystem_Datum, gen_avm_cad_Metric_DomainModelMetric, gen_avm_cad_Geometry_AnalysisConstruct, gen_avm_cad_Polygon_Geometry2D, gen_avm_cad_Surface_Geometry3D, gen_avm_cad_ExtrudedGeometry_Geometry3D, gen_avm_cad_Sphere_Geometry3D, gen_avm_cad_CustomGeometry_Geometry, gen_avm_cad_TranslationalJointSpec_KinematicJointSpec, gen_avm_cad_GuideDatum_ConnectorFeature, gen_avm_cad_AssemblyRoot_DesignDomainFeature, gen_avm_cad_KinematicJointSpec_ConnectorFeature, gen_avm_cad_RevoluteJointSpec_KinematicJointSpec, gen_avm_adamsCar_AdamsCarModel_DomainModel, gen_avm_adamsCar_Parameter_DomainModelParameter, gen_avm_manufacturing_ManufacturingModel_DomainModel, gen_avm_manufacturing_Parameter_DomainModelParameter, gen_avm_manufacturing_Metric_DomainModelMetric, gen_avm_cyber_CyberModel_DomainModel},
    metadata=None
)
