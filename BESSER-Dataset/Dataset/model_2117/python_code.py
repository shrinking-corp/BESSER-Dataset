...
class avm_cyber_CyberModel(DomainModel_):
    ...
    def __init__(self, Locator: str, Type: str, Class: str, avm_cyber_CyberModel: set["Connector"] = None, avm_cyber_CyberModel238: set["Parameter"] = None):
        self.Locator = Locator
        self.Type = Type
        self.Class = Class
...
class avm_modelica_ModelicaModel(DomainModel_):
    ...
    def __init__(self, Class: str, avm_modelica_ModelicaModel145: set["Redeclare"] = None, avm_modelica_ModelicaModel: set["Parameter"] = None, avm_modelica_ModelicaModel139: set["Connector"] = None, avm_modelica_ModelicaModel141: set["Metric"] = None, avm_modelica_ModelicaModel143: set["Limit"] = None):
        self.Class = Class
...
class avm_Workflow:
    ...
    def __init__(self, Name: str, avm_Workflow: "avm_TestBench" = None, avm_Workflow133: set["avm_WorkflowTaskBase"] = None):
        self.Name = Name
...
class avm_TestBench:
    ...
    def __init__(self, Name: str, avm_TestBench115: set["avm_Parameter"] = None, avm_TestBench117: set["avm_Metric"] = None, avm_TestBench119: set["avm_TestInjectionPoint"] = None, avm_TestBench: "avm_TopLevelSystemUnderTest" = None, avm_TestBench121: set["avm_ComponentInstance"] = None, avm_TestBench124: "avm_Workflow" = None, avm_TestBench126: set["avm_Settings"] = None, avm_TestBench128: set["avm_DomainModel_"] = None):
        self.Name = Name
...
class avm_Container(ABC):
    ...
    def __init__(self, Name: str, XPosition: str, YPosition: str, avm_Container74: set["avm_Property"] = None, avm_Container77: set["avm_ComponentInstance"] = None, avm_Container79: set["avm_Port"] = None, avm_Container: "avm_Design" = None, avm_Container72: "avm_Container" = None, avm_Container70: set["avm_Container"] = None, avm_Container82: set["avm_Connector"] = None, avm_Container85: set["avm_assemblyDetail"] = None, avm_Container88: set["avm_Formula"] = None):
        self.Name = Name
        self.XPosition = XPosition
        self.YPosition = YPosition
...
class avm_DomainModelMetric(ABC):
    ...
    def __init__(self, Notes: str, XPosition: str, YPosition: str, ID: str, avm_DomainModelMetric: "avm_Value" = None):
        self.Notes = Notes
        self.XPosition = XPosition
        self.YPosition = YPosition
        self.ID = ID
...
class avm_DataSource:
    ...
    def __init__(self, Notes: str, avm_DataSource65: set["avm_Resource"] = None, avm_DataSource: "avm_Value" = None):
        self.Notes = Notes
...
class avm_Value(ValueNode):
    ...
    def __init__(self, DimensionType: str, DataType: str, Dimensions: str, Unit: str, avm_Value: "avm_ValueExpressionType" = None, avm_Value20: set["avm_DataSource"] = None, avm_Value54: "avm_PrimitiveProperty" = None, avm_Value52: "avm_DomainModelMetric" = None, avm_Value99: "avm_ComponentPrimitivePropertyInstance" = None, avm_Value131: "avm_TestBenchValueBase" = None):
...
class avm_Port(PortMapTarget):
    ...
    def __init__(self, Notes: str, XPosition: str, Definition: str, YPosition: str, Name: str, avm_Port80: "avm_Container" = None, avm_Port: "avm_Component" = None, avm_Port24: "avm_Connector" = None):
        self.Notes = Notes
        self.XPosition = XPosition
...
class avm_Resource:
    ...
    def __init__(self, Name: str, Path: str, Hash: str, ID: str, Notes: str, XPosition: str, YPosition: str, avm_Resource66: "avm_DataSource" = None, avm_Resource: "avm_Component" = None, avm_Resource17: "avm_DomainModel_" = None):
        self.Name = Name
        self.Path = Path
        self.Hash = Hash
        self.ID = ID
...
class avm_Property(ABC):
    ...
    def __init__(self, Name: str, OnDataSheet: str, Notes: str, Definition: str, ID: str, XPosition: str, YPosition: str, avm_Property75: "avm_Container" = None, avm_Property: "avm_Component" = None, avm_Property27: "avm_Connector" = None):
        self.Name = Name
...
class avm_DomainModel_(ABC):
    ...
    def avm_DomainModel16(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_avm_DomainModel___avm_DomainModel16", None)
    ...
    def avm_DomainModel129(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_avm_DomainModel___avm_DomainModel129", None)
...
class avm_Component:
    ...
    def __init__(self, Name: str, Supercedes: str, Version: str, SchemaVersion: str, Classifications: str, ID: str, avm_Component: set["avm_DomainModel_"] = None, avm_Component14: set["avm_Formula"] = None, avm_Component2: set["avm_Property"] = None, avm_Component4: set["avm_Resource"] = None, avm_Component6: set["avm_Connector"] = None, avm_Component8: set["avm_DistributionRestriction"] = None, avm_Component10: set["avm_Port"] = None, avm_Component12: set["avm_AnalysisConstruct"] = None):
        self.Name = Name
