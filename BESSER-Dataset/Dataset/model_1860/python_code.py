...
class typeslibrary_NativeType:
    ...
    def __init__(self, name: str, spec: str, typeslibrary_NativeType: "typeslibrary_NativeTypesLibrary" = None, typeslibrary_NativeType2: "typeslibrary_TypeInstance" = None, typeslibrary_NativeType5: "typeslibrary_NativeType" = None, typeslibrary_NativeType3: "typeslibrary_NativeType" = None):
        self.name = name
        self.spec = spec
