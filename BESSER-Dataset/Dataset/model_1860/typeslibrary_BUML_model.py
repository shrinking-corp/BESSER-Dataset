...
# Classes
typeslibrary_NativeTypesLibrary = Class(name="typeslibrary_NativeTypesLibrary")
TypesLibrary = Class(name="TypesLibrary")
typeslibrary_UserDefinedTypeRef = Class(name="typeslibrary_UserDefinedTypeRef")
typeslibrary_UserDefinedTypesLibrary = Class(name="typeslibrary_UserDefinedTypesLibrary")
typeslibrary_NativeType = Class(name="typeslibrary_NativeType")
typeslibrary_TypeInstance = Class(name="typeslibrary_TypeInstance")
Type = Class(name="Type")
typeslibrary_ComplexNamedType = Class(name="typeslibrary_ComplexNamedType")
UserDefinedType = Class(name="UserDefinedType")
typeslibrary_UserDefinedType = Class(name="typeslibrary_UserDefinedType", is_abstract=True)
typeslibrary_SimpleNamedType = Class(name="typeslibrary_SimpleNamedType")
typeslibrary_Type = Class(name="typeslibrary_Type", is_abstract=True)
typeslibrary_TypesLibraryUser = Class(name="typeslibrary_TypesLibraryUser", is_abstract=True)
typeslibrary_TypesLibrary = Class(name="typeslibrary_TypesLibrary", is_abstract=True)
...
typeslibrary_NativeTypesLibrary_m_findTypeByName: Method = Method(name="findTypeByName", parameters={Parameter(name='typeslibrary_name', type=StringType)}, type=StringType)
...
typeslibrary_TypeInstance.attributes={typeslibrary_TypeInstance_precision, typeslibrary_TypeInstance_literals, typeslibrary_TypeInstance_length}
...
domain_model = DomainModel(
    name="typeslibrary",
    types={typeslibrary_NativeTypesLibrary, TypesLibrary, typeslibrary_UserDefinedTypeRef, typeslibrary_UserDefinedTypesLibrary, typeslibrary_NativeType, typeslibrary_TypeInstance, Type, typeslibrary_ComplexNamedType, UserDefinedType, typeslibrary_UserDefinedType, typeslibrary_SimpleNamedType, typeslibrary_Type, typeslibrary_TypesLibraryUser, typeslibrary_TypesLibrary, NativeTypeKind, TypesLibraryKind},
    associations={type9, userDefinedTypes11, nativeTypes0, nativeType1, mapsTo4, types6, type7, usedLibraries13},
    generalizations={gen_typeslibrary_NativeTypesLibrary_TypesLibrary, gen_typeslibrary_UserDefinedTypeRef_Type, gen_typeslibrary_UserDefinedTypesLibrary_TypesLibrary, gen_typeslibrary_TypeInstance_Type, gen_typeslibrary_ComplexNamedType_UserDefinedType, gen_typeslibrary_SimpleNamedType_UserDefinedType},
    metadata=None
)
