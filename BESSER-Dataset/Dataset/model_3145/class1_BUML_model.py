...
# Classes
classm1_CNamedElement = Class(name="classm1_CNamedElement", is_abstract=True)
classm1_Class = Class(name="classm1_Class")
CNamedElement = Class(name="CNamedElement")
classm1_Attribute = Class(name="classm1_Attribute")
...
domain_model = DomainModel(
    name="classm1",
    types={classm1_CNamedElement, classm1_Class, CNamedElement, classm1_Attribute, Visibility},
