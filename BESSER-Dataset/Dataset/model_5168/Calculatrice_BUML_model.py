...
calculatrice_Number = Class(name="calculatrice_Number")
CalcExpr = Class(name="CalcExpr")
calculatrice_VarCall = Class(name="calculatrice_VarCall")
calculatrice_Calculatrice = Class(name="calculatrice_Calculatrice")
calculatrice_Calc = Class(name="calculatrice_Calc")
calculatrice_BoolExpr = Class(name="calculatrice_BoolExpr")
calculatrice_CalcExpr = Class(name="calculatrice_CalcExpr")
calculatrice_Condition = Class(name="calculatrice_Condition")
Calc = Class(name="Calc")
calculatrice_Boolean = Class(name="calculatrice_Boolean")
...
calculatrice_Calc.attributes={calculatrice_Calc_varName, calculatrice_Calc_boolName, calculatrice_Calc_decl}
...
domain_model = DomainModel(
    name="calculatrice",
    types={Condition, calculatrice_Number, CalcExpr, calculatrice_VarCall, calculatrice_Calculatrice, calculatrice_Calc, calculatrice_BoolExpr, calculatrice_CalcExpr, calculatrice_Condition, Calc, calculatrice_Boolean, BoolExpr},
    associations={thenBlock11, elseBlock14, left18, right21, calculs0, b1, e3, left6, right9},
    generalizations={gen_calculatrice_BoolExpr_Condition, gen_calculatrice_Number_CalcExpr, gen_calculatrice_VarCall_CalcExpr, gen_calculatrice_Condition_Calc, gen_calculatrice_Boolean_BoolExpr},
    metadata=None
)
