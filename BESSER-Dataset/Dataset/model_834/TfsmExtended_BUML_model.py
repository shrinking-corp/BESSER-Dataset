...
domain_model = DomainModel(
    name="tfsmextended",
    types={tfsmextended_TFSM, NamedElement, tfsmextended_State, tfsmextended_Guard, tfsmextended_NamedElement, tfsmextended_TemporalGuard, Guard, tfsmextended_EventGuard, tfsmextended_FSMEvent, tfsmextended_FSMClock, tfsmextended_Transition, tfsmextended_EvaluateGuard, tfsmextended_TimedSystem},
    associations={ownedStates0, initialState1, currentState8, owningFSM11, outgoingTransitions12, incomingTransitions13, source15, target17, ownedGuard19, generatedEvents21, onClock24, triggeringEvent26, localEvents2, localClock4, ownedTransitions6, tfsms31, globalClocks33, globalEvents36, sollicitingTransitions28},
    generalizations={gen_tfsmextended_TFSM_NamedElement, gen_tfsmextended_State_NamedElement, gen_tfsmextended_Transition_NamedElement, gen_tfsmextended_Guard_NamedElement, gen_tfsmextended_TemporalGuard_Guard, gen_tfsmextended_EventGuard_Guard, gen_tfsmextended_FSMEvent_NamedElement, gen_tfsmextended_TimedSystem_NamedElement, gen_tfsmextended_EvaluateGuard_Guard, gen_tfsmextended_FSMClock_NamedElement},
    metadata=None
)
