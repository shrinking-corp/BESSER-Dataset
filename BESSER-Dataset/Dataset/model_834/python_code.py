...
class tfsmextended_FSMClock(NamedElement):
    ...
    def __init__(self, numberOfTicks: str, tfsmextended_FSMClock25: "tfsmextended_TemporalGuard" = None, tfsmextended_FSMClock: "tfsmextended_TFSM" = None, tfsmextended_FSMClock35: "tfsmextended_TimedSystem" = None):
...
class tfsmextended_FSMEvent(NamedElement):
    ...
    def __init__(self, isTriggered: bool, tfsmextended_FSMEvent29: set["tfsmextended_Transition"] = None, tfsmextended_FSMEvent23: "tfsmextended_Transition" = None, tfsmextended_FSMEvent27: "tfsmextended_EventGuard" = None, tfsmextended_FSMEvent: "tfsmextended_TFSM" = None, tfsmextended_FSMEvent38: "tfsmextended_TimedSystem" = None):
