...
uml2rdbms_PackageToSchema = Class(name="uml2rdbms_PackageToSchema")
uml2rdbms_AttributeToColumn = Class(name="uml2rdbms_AttributeToColumn")
FromAttribute = Class(name="FromAttribute")
ToColumn = Class(name="ToColumn")
uml2rdbms_PrimitiveToName = Class(name="uml2rdbms_PrimitiveToName", is_abstract=True)
uml2rdbms_AssociationToForeignKey = Class(name="uml2rdbms_AssociationToForeignKey")
UmlToRdbmsModelElement = Class(name="UmlToRdbmsModelElement")
uml2rdbms_Association = Class(name="uml2rdbms_Association")
uml2rdbms_ForeignKey = Class(name="uml2rdbms_ForeignKey")
uml2rdbms_ClassToTable = Class(name="uml2rdbms_ClassToTable")
uml2rdbms_BooleanToBoolean = Class(name="uml2rdbms_BooleanToBoolean")
PrimitiveToName = Class(name="PrimitiveToName")
uml2rdbms_Schema = Class(name="uml2rdbms_Schema")
uml2rdbms_Key = Class(name="uml2rdbms_Key")
uml2rdbms_Table = Class(name="uml2rdbms_Table")
uml2rdbms_Class = Class(name="uml2rdbms_Class")
uml2rdbms_FromAttribute = Class(name="uml2rdbms_FromAttribute", is_abstract=True)
uml2rdbms_Attribute = Class(name="uml2rdbms_Attribute")
uml2rdbms_FromAttributeOwner = Class(name="uml2rdbms_FromAttributeOwner", is_abstract=True)
uml2rdbms_IntegerToNumber = Class(name="uml2rdbms_IntegerToNumber")
uml2rdbms_NonLeafAttribute = Class(name="uml2rdbms_NonLeafAttribute")
uml2rdbms_Package = Class(name="uml2rdbms_Package")
uml2rdbms_PrimitiveDataType = Class(name="uml2rdbms_PrimitiveDataType")
uml2rdbms_StringToVarchar = Class(name="uml2rdbms_StringToVarchar")
uml2rdbms_ToColumn = Class(name="uml2rdbms_ToColumn", is_abstract=True)
uml2rdbms_Column = Class(name="uml2rdbms_Column")
uml2rdbms_UmlToRdbmsModelElement = Class(name="uml2rdbms_UmlToRdbmsModelElement", is_abstract=True)
...
domain_model = DomainModel(
    name="uml2rdbms",
    types={FromAttributeOwner, uml2rdbms_PackageToSchema, uml2rdbms_AttributeToColumn, FromAttribute, ToColumn, uml2rdbms_PrimitiveToName, uml2rdbms_AssociationToForeignKey, UmlToRdbmsModelElement, uml2rdbms_Association, uml2rdbms_ForeignKey, uml2rdbms_ClassToTable, uml2rdbms_BooleanToBoolean, PrimitiveToName, uml2rdbms_Schema, uml2rdbms_Key, uml2rdbms_Table, uml2rdbms_Class, uml2rdbms_FromAttribute, uml2rdbms_Attribute, uml2rdbms_FromAttributeOwner, uml2rdbms_IntegerToNumber, uml2rdbms_NonLeafAttribute, uml2rdbms_Package, uml2rdbms_PrimitiveDataType, uml2rdbms_StringToVarchar, uml2rdbms_ToColumn, uml2rdbms_Column, uml2rdbms_UmlToRdbmsModelElement},
    associations={associationsToForeignKeys7, type0, association1, foreignKey2, owner4, referenced5, classesToTables22, primitivesToNames25, owner8, schema27, primaryKey9, table11, umlClass13, attribute15, leafs16, owner19, fromAttributes20, umlPackage28, owner30, primitive32, column34},
    generalizations={gen_uml2rdbms_ClassToTable_FromAttributeOwner, gen_uml2rdbms_ClassToTable_ToColumn, gen_uml2rdbms_ClassToTable_UmlToRdbmsModelElement, gen_uml2rdbms_AttributeToColumn_FromAttribute, gen_uml2rdbms_AttributeToColumn_ToColumn, gen_uml2rdbms_AssociationToForeignKey_ToColumn, gen_uml2rdbms_AssociationToForeignKey_UmlToRdbmsModelElement, gen_uml2rdbms_PackageToSchema_UmlToRdbmsModelElement, gen_uml2rdbms_BooleanToBoolean_PrimitiveToName, gen_uml2rdbms_FromAttribute_UmlToRdbmsModelElement, gen_uml2rdbms_IntegerToNumber_PrimitiveToName, gen_uml2rdbms_NonLeafAttribute_FromAttributeOwner, gen_uml2rdbms_NonLeafAttribute_FromAttribute, gen_uml2rdbms_PrimitiveToName_UmlToRdbmsModelElement, gen_uml2rdbms_StringToVarchar_PrimitiveToName},
    metadata=None
)
