...
class uml2rdbms_FromAttribute(UmlToRdbmsModelElement):
    ...
    def __init__(self, kind: str, uml2rdbms_FromAttribute: "uml2rdbms_Attribute" = None, uml2rdbms_FromAttribute17: set["uml2rdbms_AttributeToColumn"] = None, fromAttributes: "uml2rdbms_FromAttributeOwner" = None, FromAttribute: "uml2rdbms_FromAttributeOwner" = None):
        self.kind = kind
...
class uml2rdbms_PrimitiveToName(UmlToRdbmsModelElement):
    ...
    def __init__(self, typeName: str, PrimitiveToName: "uml2rdbms_PackageToSchema" = None, primitivesToNames: "uml2rdbms_PackageToSchema" = None, uml2rdbms_PrimitiveToName33: "uml2rdbms_PrimitiveDataType" = None, uml2rdbms_PrimitiveToName: "uml2rdbms_AttributeToColumn" = None):
...
class ToColumn:
    ...
    pass
class uml2rdbms_AssociationToForeignKey(ToColumn, UmlToRdbmsModelElement):

    pass
class FromAttribute:

    pass
class uml2rdbms_AttributeToColumn(ToColumn, FromAttribute):
...
class FromAttributeOwner:
    ...
    pass
class uml2rdbms_NonLeafAttribute(FromAttributeOwner, FromAttribute):

    pass
class uml2rdbms_ClassToTable(ToColumn, UmlToRdbmsModelElement, FromAttributeOwner):
