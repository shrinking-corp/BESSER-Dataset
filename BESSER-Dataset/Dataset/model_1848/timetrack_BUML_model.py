...
# Classes
timetrack_User = Class(name="timetrack_User")
timetrack_Library = Class(name="timetrack_Library")
timetrack_Project = Class(name="timetrack_Project")
timetrack_TimeEntry = Class(name="timetrack_TimeEntry")
...
timetrack_User.attributes={timetrack_User_password, timetrack_User_name, timetrack_User_sap_password, timetrack_User_sap_name}
...
timetrack_TimeEntry_from_: Property = Property(name="from_", type=DateType)
...
timetrack_TimeEntry.attributes={timetrack_TimeEntry_sync_date, timetrack_TimeEntry_notes, timetrack_TimeEntry_day, timetrack_TimeEntry_from_, timetrack_TimeEntry_duration, timetrack_TimeEntry_factured, timetrack_TimeEntry_till}
...
domain_model = DomainModel(
    name="timetrack",
    types={timetrack_User, timetrack_Library, timetrack_Project, timetrack_TimeEntry},
    associations={project1, listBook3, listTimeEntry5, listProject8, user0},
    generalizations={},
    metadata=None
)
