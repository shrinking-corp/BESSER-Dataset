...
class timetrack_TimeEntry:
    ...
    def __init__(self, day: date, from_: date, till: date, duration: date, factured: bool, notes: str, sync_date: date, timetrack_TimeEntry2: "timetrack_Project" = None, timetrack_TimeEntry7: "timetrack_Library" = None, timetrack_TimeEntry: "timetrack_User" = None):
        self.day = day
        self.from_ = from_
        self.till = till
