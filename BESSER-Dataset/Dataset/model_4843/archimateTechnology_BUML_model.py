...
# Classes
ArchimateTechnology_NodeElement = Class(name="ArchimateTechnology_NodeElement", is_abstract=True)
ArchimateTechnology_Node = Class(name="ArchimateTechnology_Node")
NodeElement = Class(name="NodeElement")
ArchimateTechnology_Device = Class(name="ArchimateTechnology_Device")
ArchimateTechnology_Network = Class(name="ArchimateTechnology_Network")
ArchimateTechnology_CommunicationPath = Class(name="ArchimateTechnology_CommunicationPath")
ArchimateTechnology_SystemSoftware = Class(name="ArchimateTechnology_SystemSoftware")
ArchimateTechnology_InfrastructureFunction = Class(name="ArchimateTechnology_InfrastructureFunction")
ArchimateTechnology_InfrastructureService = Class(name="ArchimateTechnology_InfrastructureService")
ArchimateTechnology_Artifact = Class(name="ArchimateTechnology_Artifact")
ArchimateTechnology_Grouping = Class(name="ArchimateTechnology_Grouping")
ArchimateTechnology_Junction = Class(name="ArchimateTechnology_Junction")
Relationship = Class(name="Relationship")
ArchimateTechnology_Relationship = Class(name="ArchimateTechnology_Relationship", is_abstract=True)
ArchimateTechnology_Association = Class(name="ArchimateTechnology_Association")
ArchimateTechnology_InfrastructureInterface = Class(name="ArchimateTechnology_InfrastructureInterface")
ArchimateTechnology_UsedBy = Class(name="ArchimateTechnology_UsedBy")
ArchimateTechnology_Realization = Class(name="ArchimateTechnology_Realization")
ArchimateTechnology_Assignment = Class(name="ArchimateTechnology_Assignment")
ArchimateTechnology_Aggregation = Class(name="ArchimateTechnology_Aggregation")
ArchimateTechnology_Composition = Class(name="ArchimateTechnology_Composition")
ArchimateTechnology_Flow = Class(name="ArchimateTechnology_Flow")
ArchimateTechnology_Triggering = Class(name="ArchimateTechnology_Triggering")
ArchimateTechnology_Specialization = Class(name="ArchimateTechnology_Specialization")
ArchimateTechnology_Access = Class(name="ArchimateTechnology_Access")
...
domain_model = DomainModel(
    ...
    types={ArchimateTechnology_NodeElement, ArchimateTechnology_Node, NodeElement, ArchimateTechnology_Device, ArchimateTechnology_Network, ArchimateTechnology_CommunicationPath, ArchimateTechnology_SystemSoftware, ArchimateTechnology_InfrastructureFunction, ArchimateTechnology_InfrastructureService, ArchimateTechnology_Artifact, ArchimateTechnology_Grouping, ArchimateTechnology_Junction, Relationship, ArchimateTechnology_Relationship, ArchimateTechnology_Association, ArchimateTechnology_InfrastructureInterface, ArchimateTechnology_UsedBy, ArchimateTechnology_Realization, ArchimateTechnology_Assignment, ArchimateTechnology_Aggregation, ArchimateTechnology_Composition, ArchimateTechnology_Flow, ArchimateTechnology_Triggering, ArchimateTechnology_Specialization, ArchimateTechnology_Access},
    associations={source0, target1},
    generalizations={gen_ArchimateTechnology_Node_NodeElement, gen_ArchimateTechnology_Device_NodeElement, gen_ArchimateTechnology_Network_NodeElement, gen_ArchimateTechnology_CommunicationPath_NodeElement, gen_ArchimateTechnology_SystemSoftware_NodeElement, gen_ArchimateTechnology_InfrastructureFunction_NodeElement, gen_ArchimateTechnology_InfrastructureService_NodeElement, gen_ArchimateTechnology_Artifact_NodeElement, gen_ArchimateTechnology_Grouping_NodeElement, gen_ArchimateTechnology_Junction_Relationship, gen_ArchimateTechnology_Association_Relationship, gen_ArchimateTechnology_InfrastructureInterface_NodeElement, gen_ArchimateTechnology_UsedBy_Relationship, gen_ArchimateTechnology_Realization_Relationship, gen_ArchimateTechnology_Assignment_Relationship, gen_ArchimateTechnology_Aggregation_Relationship, gen_ArchimateTechnology_Composition_Relationship, gen_ArchimateTechnology_Flow_Relationship, gen_ArchimateTechnology_Triggering_Relationship, gen_ArchimateTechnology_Specialization_Relationship, gen_ArchimateTechnology_Access_Relationship},
    metadata=None
)
