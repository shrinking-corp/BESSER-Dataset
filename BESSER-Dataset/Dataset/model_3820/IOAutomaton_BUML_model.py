...
# Classes
ioAutomaton_AutomatonCollection = Class(name="ioAutomaton_AutomatonCollection")
ioAutomaton_Automaton = Class(name="ioAutomaton_Automaton")
ioAutomaton_SystemActor = Class(name="ioAutomaton_SystemActor")
...
ioAutomaton_OutMessage = Class(name="ioAutomaton_OutMessage")
ioAutomaton_Return = Class(name="ioAutomaton_Return")
ioAutomaton_Actor = Class(name="ioAutomaton_Actor")
...
domain_model = DomainModel(
    name="ioAutomaton",
    types={ioAutomaton_AutomatonCollection, ioAutomaton_Automaton, ioAutomaton_SystemActor, ioAutomaton_State, ioAutomaton_Transition, State, ioAutomaton_Operation, ioAutomaton_OutMessage, ioAutomaton_Return, ioAutomaton_Actor},
    associations={automaton0, mainActor1, state2, transition3, collection5, startState7, automaton9, outgoingTransition11, incomingTransition13, automaton15, preState17, operation19, outMessage20, returnValue22, postState24, operation26, receiver29, returnValue31},
