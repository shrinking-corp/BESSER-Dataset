...
public class gmfgraph_GridLayoutData extends LayoutData {
    ...
    public gmfgraph_GridLayoutData(
        int verticalSpan,        String horizontalAlignment,        int horizontalSpan,        String verticalAlignment,        int horizontalIndent,        boolean grabExcessVerticalSpace,        boolean grabExcessHorizontalSpace    ) {
        super(
        );
