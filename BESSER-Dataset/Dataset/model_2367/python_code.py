...
class relational_Column(ModelElement):
    ...
    def __init__(self, name: str, type: str, isPrimaryKey: bool, isUnique: bool, ownedColumns: "relational_Table" = None, Column: "relational_Table" = None):
        self.name = name
        self.type = type
...
class relational_Table(ModelElement):
    ...
    def __init__(self, name: str, Table13: "relational_Column" = None, Table: "relational_Schema" = None, owner5: set["relational_Column"] = None, foreignTable: set["relational_ForeignKey"] = None, ownedTables: "relational_Schema" = None, Table10: "relational_ForeignKey" = None, relational_Table: "relational_ForeignKey" = None):
        self.name = name
