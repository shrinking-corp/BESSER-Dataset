...
# Classes
traces_Value = Class(name="traces_Value")
traces_SimulatorRun = Class(name="traces_SimulatorRun")
traces_Variable = Class(name="traces_Variable")
...
traces_Value.attributes={traces_Value_valueMax, traces_Value_clockMax, traces_Value_clockMin, traces_Value_valueMin}
...
traces_SimulatorRun.attributes={traces_SimulatorRun_id, traces_SimulatorRun_behaviorName, traces_SimulatorRun_timestamp}
...
domain_model = DomainModel(
    name="traces",
    types={traces_Value, traces_SimulatorRun, traces_Variable},
    associations={run1, values2, variable3, variables0},
    generalizations={},
    metadata=None
)
