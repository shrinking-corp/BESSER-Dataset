...
class traces_Variable:
    ...
    def __init__(self, name: str, variables: "traces_SimulatorRun" = None, variable: set["traces_Value"] = None, Variable4: "traces_Value" = None, Variable: "traces_SimulatorRun" = None):
        self.name = name
...
class traces_SimulatorRun:
    ...
    def __init__(self, id: int, timestamp: date, behaviorName: str, SimulatorRun: "traces_Variable" = None, run: set["traces_Variable"] = None):
        self.id = id
