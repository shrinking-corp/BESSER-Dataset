...
class PetriNet_Transition:
    ...
    def __init__(self, name: str, Transition: "PetriNet_Net" = None, transitions: "PetriNet_Net" = None, dst11: "PetriNet_Place" = None, src14: "PetriNet_Place" = None, Transition5: "PetriNet_Place" = None, Transition7: "PetriNet_Place" = None):
        self.name = name
...
class PetriNet_Place:
    ...
    def __init__(self, name: str, Place: "PetriNet_Net" = None, Place12: "PetriNet_Transition" = None, Place15: "PetriNet_Transition" = None, places: "PetriNet_Net" = None, dst: set["PetriNet_Transition"] = None, src: set["PetriNet_Transition"] = None):
        self.name = name
        self.Place = Place
