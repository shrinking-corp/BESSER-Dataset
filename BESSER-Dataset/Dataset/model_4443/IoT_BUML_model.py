...
# Classes
ioT_System = Class(name="ioT_System")
ioT_EObject = Class(name="ioT_EObject")
ioT_SensorType = Class(name="ioT_SensorType")
ioT_SensorTypes = Class(name="ioT_SensorTypes")
ioT_Sensor = Class(name="ioT_Sensor")
ioT_SensorGroup = Class(name="ioT_SensorGroup")
ioT_SensorGetMethod = Class(name="ioT_SensorGetMethod")
ioT_Method = Class(name="ioT_Method")
ioT_ServerType = Class(name="ioT_ServerType")
ioT_ServerTypes = Class(name="ioT_ServerTypes")
ioT_Server = Class(name="ioT_Server")
ioT_Ip = Class(name="ioT_Ip")
ioT_Portnumber = Class(name="ioT_Portnumber")
ioT_DestinationType = Class(name="ioT_DestinationType")
ioT_DestinationTypes = Class(name="ioT_DestinationTypes")
ioT_Destination = Class(name="ioT_Destination")
ioT_FetchData = Class(name="ioT_FetchData")
Condition = Class(name="Condition")
ioT_DeviceType = Class(name="ioT_DeviceType")
ioT_DeviceTypes = Class(name="ioT_DeviceTypes")
ioT_Device = Class(name="ioT_Device")
ioT_Time = Class(name="ioT_Time")
ioT_Condition = Class(name="ioT_Condition")
ioT_OrCondition = Class(name="ioT_OrCondition")
ioT_AndCondition = Class(name="ioT_AndCondition")
ioT_FetchDataCondition = Class(name="ioT_FetchDataCondition")
ioT_FetchDataExpression = Class(name="ioT_FetchDataExpression")
ioT_LiteralNumber = Class(name="ioT_LiteralNumber")
ioT_ComparisonCondition = Class(name="ioT_ComparisonCondition")
ioT_LiteralBool = Class(name="ioT_LiteralBool")
...
ioT_Method.attributes={ioT_Method_name, ioT_Method_parameters}
...
domain_model = DomainModel(
    name="ioT",
    types={ioT_System, ioT_EObject, ioT_SensorType, ioT_SensorTypes, ioT_Sensor, ioT_SensorGroup, ioT_SensorGetMethod, ioT_Method, ioT_ServerType, ioT_ServerTypes, ioT_Server, ioT_Ip, ioT_Portnumber, ioT_DestinationType, ioT_DestinationTypes, ioT_Destination, ioT_FetchData, Condition, ioT_DeviceType, ioT_DeviceTypes, ioT_Device, ioT_Time, ioT_Condition, ioT_OrCondition, ioT_AndCondition, ioT_FetchDataCondition, ioT_FetchDataExpression, ioT_LiteralNumber, ioT_ComparisonCondition, ioT_LiteralBool},
    associations={system0, types1, type2, sensors4, method6, type11, devices13, types16, type17, ip19, port21, types23, type24, filter26, device28, type7, types10, duration38, condition40, else_43, left45, right47, destination31, condition34, triggered36, left50, right52, left55, right57},
    generalizations={gen_ioT_Method_Condition, gen_ioT_OrCondition_Condition, gen_ioT_AndCondition_Condition, gen_ioT_LiteralNumber_Condition, gen_ioT_ComparisonCondition_Condition, gen_ioT_LiteralBool_Condition},
    metadata=None
)
