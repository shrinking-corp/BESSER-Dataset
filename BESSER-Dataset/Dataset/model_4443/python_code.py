...
class ioT_FetchDataExpression:
    ...
    def __init__(self, timeUnit: str, ioT_FetchDataExpression39: "ioT_Time" = None, ioT_FetchDataExpression: "ioT_FetchData" = None):
...
class ioT_DeviceType:
    ...
    def __init__(self, name: str, ioT_DeviceType12: "ioT_Device" = None, ioT_DeviceType: "ioT_DeviceTypes" = None):
        self.name = name
...
class ioT_SensorType:
    ...
    def __init__(self, name: str, ioT_SensorType: "ioT_SensorTypes" = None, ioT_SensorType3: "ioT_Sensor" = None, ioT_SensorType9: "ioT_SensorGetMethod" = None):
        self.name = name
