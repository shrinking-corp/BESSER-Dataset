...
# Classes
testmodel_TestElement = Class(name="testmodel_TestElement")
EObject = Class(name="EObject")
testmodel_TestElementContainer = Class(name="testmodel_TestElementContainer")
testmodel_TestElementToTestElementMap = Class(name="testmodel_TestElementToTestElementMap")
testmodel_StringToStringMap = Class(name="testmodel_StringToStringMap")
testmodel_TestElementToStringMap = Class(name="testmodel_TestElementToStringMap")
testmodel_StringToTestElementMap = Class(name="testmodel_StringToTestElementMap")
...
testmodel_TestElement.attributes={testmodel_TestElement_strings, testmodel_TestElement_name, testmodel_TestElement_description}
...
testmodel_StringToStringMap.attributes={testmodel_StringToStringMap_key, testmodel_StringToStringMap_value}
...
domain_model = DomainModel(
    name="testmodel",
    types={testmodel_TestElement, EObject, testmodel_TestElementContainer, testmodel_TestElementToTestElementMap, testmodel_StringToStringMap, testmodel_TestElementToStringMap, testmodel_StringToTestElementMap},
    associations={reference6, containedElement9, otherReference12, containedElements215, references1, containedElements3, value30, key33, value36, container17, elementMap18, stringToStringMap20, elementToStringMap22, stringToElementMap24, elements26, key27},
