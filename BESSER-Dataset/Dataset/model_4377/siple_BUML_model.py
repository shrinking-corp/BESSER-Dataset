...
# Classes
siple_CompilationUnit = Class(name="siple_CompilationUnit")
siple_ProcedureDeclaration = Class(name="siple_ProcedureDeclaration")
siple_Statement = Class(name="siple_Statement", is_abstract=True)
siple_Block = Class(name="siple_Block")
Statement = Class(name="Statement")
siple_If = Class(name="siple_If")
siple_Expression = Class(name="siple_Expression", is_abstract=True)
siple_While = Class(name="siple_While")
siple_VariableAssignment = Class(name="siple_VariableAssignment")
siple_ProcedureReturn = Class(name="siple_ProcedureReturn")
siple_Write = Class(name="siple_Write")
siple_Read = Class(name="siple_Read")
siple_Declaration = Class(name="siple_Declaration", is_abstract=True)
siple_Constant = Class(name="siple_Constant")
Expression = Class(name="Expression")
siple_Reference = Class(name="siple_Reference")
siple_ProcedureCall = Class(name="siple_ProcedureCall")
siple_NestedExpression = Class(name="siple_NestedExpression")
siple_UnaryExpression = Class(name="siple_UnaryExpression", is_abstract=True)
siple_Not = Class(name="siple_Not")
UnaryExpression = Class(name="UnaryExpression")
siple_UMinus = Class(name="siple_UMinus")
siple_RealCoercion = Class(name="siple_RealCoercion")
siple_VariableDeclaration = Class(name="siple_VariableDeclaration")
Declaration = Class(name="Declaration")
siple_LogicExpression = Class(name="siple_LogicExpression", is_abstract=True)
BinaryExpression = Class(name="BinaryExpression")
siple_And = Class(name="siple_And")
LogicExpression = Class(name="LogicExpression")
siple_Or = Class(name="siple_Or")
siple_EqualityExpression = Class(name="siple_EqualityExpression", is_abstract=True)
siple_Equal = Class(name="siple_Equal")
EqualityExpression = Class(name="EqualityExpression")
siple_GreaterThan = Class(name="siple_GreaterThan")
siple_LesserThan = Class(name="siple_LesserThan")
siple_GreaterThanEqual = Class(name="siple_GreaterThanEqual")
siple_LesserThanEqual = Class(name="siple_LesserThanEqual")
siple_ArithmeticExpression = Class(name="siple_ArithmeticExpression", is_abstract=True)
siple_Addition = Class(name="siple_Addition")
ArithmeticExpression = Class(name="ArithmeticExpression")
siple_Subtraction = Class(name="siple_Subtraction")
siple_Multiplication = Class(name="siple_Multiplication")
siple_Division = Class(name="siple_Division")
siple_Dereference = Class(name="siple_Dereference")
siple_BinaryExpression = Class(name="siple_BinaryExpression", is_abstract=True)
...
siple_Statement_m_Interpret: Method = Method(name="Interpret", parameters={Parameter(name='siple_vm', type=StringType)})
...
siple_Expression_m_Value: Method = Method(name="Value", parameters={Parameter(name='siple_vm', type=StringType)}, type=StringType)
...
siple_Declaration.attributes={siple_Declaration_IsParameterDeclaration, siple_Declaration_Name, siple_Declaration_Type}
...
siple_Constant.attributes={siple_Constant_AsInteger, siple_Constant_AsBoolean, siple_Constant_Lexem, siple_Constant_AsReal}
...
domain_model = DomainModel(
    name="siple",
    types={siple_CompilationUnit, siple_ProcedureDeclaration, siple_Statement, siple_Block, Statement, siple_If, siple_Expression, siple_While, siple_VariableAssignment, siple_ProcedureReturn, siple_Write, siple_Read, siple_Declaration, siple_Constant, Expression, siple_Reference, siple_ProcedureCall, siple_NestedExpression, siple_UnaryExpression, siple_Not, UnaryExpression, siple_UMinus, siple_RealCoercion, siple_VariableDeclaration, Declaration, siple_LogicExpression, BinaryExpression, siple_And, LogicExpression, siple_Or, siple_EqualityExpression, siple_Equal, EqualityExpression, siple_GreaterThan, siple_LesserThan, siple_GreaterThanEqual, siple_LesserThanEqual, siple_ArithmeticExpression, siple_Addition, ArithmeticExpression, siple_Subtraction, siple_Multiplication, siple_Division, siple_Dereference, siple_BinaryExpression},
    associations={MainProcedure1, ProcedureInContext3, Statement5, IsProcedureBody7, Condition10, Body11, Alternative14, Condition17, Body19, LValue22, RValue24, Expression27, Expression29, Expression31, Declaration0, Parameter33, Body35, Declaration38, Procedure40, Argument42, Declaration45, Expression48, Operand50, Operand254, Operand152},
    generalizations={gen_siple_Block_Statement, gen_siple_If_Statement, gen_siple_While_Statement, gen_siple_VariableAssignment_Statement, gen_siple_ProcedureReturn_Statement, gen_siple_Write_Statement, gen_siple_Read_Statement, gen_siple_Declaration_Statement, gen_siple_ProcedureDeclaration_Declaration, gen_siple_Expression_Statement, gen_siple_Constant_Expression, gen_siple_Reference_Expression, gen_siple_ProcedureCall_Expression, gen_siple_NestedExpression_Expression, gen_siple_UnaryExpression_Expression, gen_siple_Not_UnaryExpression, gen_siple_UMinus_UnaryExpression, gen_siple_RealCoercion_UnaryExpression, gen_siple_VariableDeclaration_Declaration, gen_siple_LogicExpression_BinaryExpression, gen_siple_And_LogicExpression, gen_siple_Or_LogicExpression, gen_siple_EqualityExpression_BinaryExpression, gen_siple_Equal_EqualityExpression, gen_siple_GreaterThan_EqualityExpression, gen_siple_LesserThan_EqualityExpression, gen_siple_GreaterThanEqual_EqualityExpression, gen_siple_LesserThanEqual_EqualityExpression, gen_siple_ArithmeticExpression_BinaryExpression, gen_siple_Addition_ArithmeticExpression, gen_siple_Subtraction_ArithmeticExpression, gen_siple_Multiplication_ArithmeticExpression, gen_siple_Division_ArithmeticExpression, gen_siple_Dereference_UnaryExpression, gen_siple_BinaryExpression_Expression},
    metadata=None
)
