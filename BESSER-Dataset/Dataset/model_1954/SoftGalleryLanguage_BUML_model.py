...
# Classes
softGalleryLanguage_Model = Class(name="softGalleryLanguage_Model")
softGalleryLanguage_EObject = Class(name="softGalleryLanguage_EObject")
softGalleryLanguage_Domain = Class(name="softGalleryLanguage_Domain")
softGalleryLanguage_Entity = Class(name="softGalleryLanguage_Entity")
softGalleryLanguage_Functionality = Class(name="softGalleryLanguage_Functionality")
softGalleryLanguage_ExceptionsDomain = Class(name="softGalleryLanguage_ExceptionsDomain")
softGalleryLanguage_Entities = Class(name="softGalleryLanguage_Entities")
softGalleryLanguage_AtributePhoto = Class(name="softGalleryLanguage_AtributePhoto")
softGalleryLanguage_AtributeAlbum = Class(name="softGalleryLanguage_AtributeAlbum")
softGalleryLanguage_AtributeUserDomain = Class(name="softGalleryLanguage_AtributeUserDomain")
softGalleryLanguage_Functionalities = Class(name="softGalleryLanguage_Functionalities")
softGalleryLanguage_ProfileManagement = Class(name="softGalleryLanguage_ProfileManagement")
softGalleryLanguage_AppAccess = Class(name="softGalleryLanguage_AppAccess")
softGalleryLanguage_AlbumManagement = Class(name="softGalleryLanguage_AlbumManagement")
softGalleryLanguage_PhotoActions = Class(name="softGalleryLanguage_PhotoActions")
softGalleryLanguage_LandingActions = Class(name="softGalleryLanguage_LandingActions")
softGalleryLanguage_ProfileManagementFunctions = Class(name="softGalleryLanguage_ProfileManagementFunctions")
softGalleryLanguage_AppAccessFunctions = Class(name="softGalleryLanguage_AppAccessFunctions")
softGalleryLanguage_ExceptionsType = Class(name="softGalleryLanguage_ExceptionsType")
softGalleryLanguage_AlbumManagementFunctions = Class(name="softGalleryLanguage_AlbumManagementFunctions")
softGalleryLanguage_PhotoActionsFunctions = Class(name="softGalleryLanguage_PhotoActionsFunctions")
softGalleryLanguage_LandingFunctions = Class(name="softGalleryLanguage_LandingFunctions")
softGalleryLanguage_PhotoException = Class(name="softGalleryLanguage_PhotoException")
softGalleryLanguage_AlbumException = Class(name="softGalleryLanguage_AlbumException")
softGalleryLanguage_UserException = Class(name="softGalleryLanguage_UserException")
softGalleryLanguage_Architecture = Class(name="softGalleryLanguage_Architecture")
softGalleryLanguage_NTiers = Class(name="softGalleryLanguage_NTiers")
softGalleryLanguage_Layer = Class(name="softGalleryLanguage_Layer")
softGalleryLanguage_PresentationLayer = Class(name="softGalleryLanguage_PresentationLayer")
softGalleryLanguage_PresentationContent = Class(name="softGalleryLanguage_PresentationContent")
softGalleryLanguage_PresentationSegments = Class(name="softGalleryLanguage_PresentationSegments")
softGalleryLanguage_BusinessLogicLayer = Class(name="softGalleryLanguage_BusinessLogicLayer")
softGalleryLanguage_BusinessLogicContent = Class(name="softGalleryLanguage_BusinessLogicContent")
softGalleryLanguage_BusinessLogicSegments = Class(name="softGalleryLanguage_BusinessLogicSegments")
softGalleryLanguage_LayerRelations = Class(name="softGalleryLanguage_LayerRelations")
softGalleryLanguage_ControllerSegmentElement = Class(name="softGalleryLanguage_ControllerSegmentElement")
softGalleryLanguage_SpecificationSegmentElement = Class(name="softGalleryLanguage_SpecificationSegmentElement")
softGalleryLanguage_CriteriaAttributeType = Class(name="softGalleryLanguage_CriteriaAttributeType")
softGalleryLanguage_DataPersistenceLayer = Class(name="softGalleryLanguage_DataPersistenceLayer")
softGalleryLanguage_DataPersistenceContent = Class(name="softGalleryLanguage_DataPersistenceContent")
softGalleryLanguage_DataPersistenceSegments = Class(name="softGalleryLanguage_DataPersistenceSegments")
softGalleryLanguage_SegmentStructure = Class(name="softGalleryLanguage_SegmentStructure")
softGalleryLanguage_SegmentStructureContent = Class(name="softGalleryLanguage_SegmentStructureContent")
softGalleryLanguage_DirectoryContent = Class(name="softGalleryLanguage_DirectoryContent")
softGalleryLanguage_Directories = Class(name="softGalleryLanguage_Directories")
softGalleryLanguage_MultipleFile = Class(name="softGalleryLanguage_MultipleFile")
softGalleryLanguage_SingleFile = Class(name="softGalleryLanguage_SingleFile")
softGalleryLanguage_Technology = Class(name="softGalleryLanguage_Technology")
softGalleryLanguage_LayerSource = Class(name="softGalleryLanguage_LayerSource")
softGalleryLanguage_LayerTarget = Class(name="softGalleryLanguage_LayerTarget")
softGalleryLanguage_ArchitectureComponents = Class(name="softGalleryLanguage_ArchitectureComponents")
softGalleryLanguage_FrontEnd = Class(name="softGalleryLanguage_FrontEnd")
softGalleryLanguage_BackEnd = Class(name="softGalleryLanguage_BackEnd")
softGalleryLanguage_PersistenceDataComponent = Class(name="softGalleryLanguage_PersistenceDataComponent")
softGalleryLanguage_NTiersConnections = Class(name="softGalleryLanguage_NTiersConnections")
softGalleryLanguage_NTierConnectionContent = Class(name="softGalleryLanguage_NTierConnectionContent")
softGalleryLanguage_NTierSource = Class(name="softGalleryLanguage_NTierSource")
softGalleryLanguage_NTierTarget = Class(name="softGalleryLanguage_NTierTarget")
softGalleryLanguage_NTiersRelations = Class(name="softGalleryLanguage_NTiersRelations")
softGalleryLanguage_Technologies = Class(name="softGalleryLanguage_Technologies")
softGalleryLanguage_Spring = Class(name="softGalleryLanguage_Spring")
softGalleryLanguage_React = Class(name="softGalleryLanguage_React")
softGalleryLanguage_PostgreSQL = Class(name="softGalleryLanguage_PostgreSQL")
softGalleryLanguage_AmazonWebServices = Class(name="softGalleryLanguage_AmazonWebServices")
softGalleryLanguage_SpringBootApplication = Class(name="softGalleryLanguage_SpringBootApplication")
softGalleryLanguage_Configuration = Class(name="softGalleryLanguage_Configuration")
softGalleryLanguage_EnableGlobalMethodSecurity = Class(name="softGalleryLanguage_EnableGlobalMethodSecurity")
softGalleryLanguage_EnableAuthorizationServer = Class(name="softGalleryLanguage_EnableAuthorizationServer")
softGalleryLanguage_EnableResourceServer = Class(name="softGalleryLanguage_EnableResourceServer")
softGalleryLanguage_EnableWebSecurity = Class(name="softGalleryLanguage_EnableWebSecurity")
softGalleryLanguage_SpringComponent = Class(name="softGalleryLanguage_SpringComponent")
softGalleryLanguage_OrderSpring = Class(name="softGalleryLanguage_OrderSpring")
softGalleryLanguage_SpringRepository = Class(name="softGalleryLanguage_SpringRepository")
softGalleryLanguage_SpringRepositories = Class(name="softGalleryLanguage_SpringRepositories")
softGalleryLanguage_SpringRepositoryAnnotation = Class(name="softGalleryLanguage_SpringRepositoryAnnotation")
softGalleryLanguage_RestController = Class(name="softGalleryLanguage_RestController")
softGalleryLanguage_Specification = Class(name="softGalleryLanguage_Specification")
softGalleryLanguage_Predicate = Class(name="softGalleryLanguage_Predicate")
softGalleryLanguage_SearchCriteria = Class(name="softGalleryLanguage_SearchCriteria")
softGalleryLanguage_Autowired = Class(name="softGalleryLanguage_Autowired")
softGalleryLanguage_ResponseEntity = Class(name="softGalleryLanguage_ResponseEntity")
softGalleryLanguage_MappingType = Class(name="softGalleryLanguage_MappingType")
softGalleryLanguage_ResponseParameter = Class(name="softGalleryLanguage_ResponseParameter")
softGalleryLanguage_SpringEntity = Class(name="softGalleryLanguage_SpringEntity")
softGalleryLanguage_RequestMapping = Class(name="softGalleryLanguage_RequestMapping")
MappingType = Class(name="MappingType")
softGalleryLanguage_RequestMappingValue = Class(name="softGalleryLanguage_RequestMappingValue")
softGalleryLanguage_RequestMappingMethod = Class(name="softGalleryLanguage_RequestMappingMethod")
softGalleryLanguage_RequestMappingProduces = Class(name="softGalleryLanguage_RequestMappingProduces")
softGalleryLanguage_PostMapping = Class(name="softGalleryLanguage_PostMapping")
softGalleryLanguage_GetMapping = Class(name="softGalleryLanguage_GetMapping")
softGalleryLanguage_PutMapping = Class(name="softGalleryLanguage_PutMapping")
softGalleryLanguage_DeleteMapping = Class(name="softGalleryLanguage_DeleteMapping")
softGalleryLanguage_ResponseParameterAnnotation = Class(name="softGalleryLanguage_ResponseParameterAnnotation")
softGalleryLanguage_ResponseParameterType = Class(name="softGalleryLanguage_ResponseParameterType")
softGalleryLanguage_ResponseParameterName = Class(name="softGalleryLanguage_ResponseParameterName")
softGalleryLanguage_ExceptionHandler = Class(name="softGalleryLanguage_ExceptionHandler")
softGalleryLanguage_ExceptionProcess = Class(name="softGalleryLanguage_ExceptionProcess")
softGalleryLanguage_ReactComponents = Class(name="softGalleryLanguage_ReactComponents")
softGalleryLanguage_SpringEntityAnnotationTypes = Class(name="softGalleryLanguage_SpringEntityAnnotationTypes")
softGalleryLanguage_StorageClient = Class(name="softGalleryLanguage_StorageClient")
softGalleryLanguage_StorageMember = Class(name="softGalleryLanguage_StorageMember")
softGalleryLanguage_StorageMemberType = Class(name="softGalleryLanguage_StorageMemberType")
softGalleryLanguage_StorageMemberAnnotation = Class(name="softGalleryLanguage_StorageMemberAnnotation")
softGalleryLanguage_StorageAction = Class(name="softGalleryLanguage_StorageAction")
softGalleryLanguage_StorageActionAnnotation = Class(name="softGalleryLanguage_StorageActionAnnotation")
softGalleryLanguage_StorageActionReturn = Class(name="softGalleryLanguage_StorageActionReturn")
softGalleryLanguage_StorageActionMember = Class(name="softGalleryLanguage_StorageActionMember")
softGalleryLanguage_StorageActionMemberType = Class(name="softGalleryLanguage_StorageActionMemberType")
softGalleryLanguage_StorageActionMemberName = Class(name="softGalleryLanguage_StorageActionMemberName")
softGalleryLanguage_ReactModules = Class(name="softGalleryLanguage_ReactModules")
softGalleryLanguage_ReactSubModules = Class(name="softGalleryLanguage_ReactSubModules")
softGalleryLanguage_ReactConfiguration = Class(name="softGalleryLanguage_ReactConfiguration")
softGalleryLanguage_ComponentsUI = Class(name="softGalleryLanguage_ComponentsUI")
softGalleryLanguage_ReactActions = Class(name="softGalleryLanguage_ReactActions")
softGalleryLanguage_ReactLibraries = Class(name="softGalleryLanguage_ReactLibraries")
softGalleryLanguage_ReactInfo = Class(name="softGalleryLanguage_ReactInfo")
softGalleryLanguage_ReactDependencies = Class(name="softGalleryLanguage_ReactDependencies")
softGalleryLanguage_ReactConfigurations = Class(name="softGalleryLanguage_ReactConfigurations")
softGalleryLanguage_ReactDependenciesRules = Class(name="softGalleryLanguage_ReactDependenciesRules")
softGalleryLanguage_ReactDependenciesSubRules = Class(name="softGalleryLanguage_ReactDependenciesSubRules")
softGalleryLanguage_SingleDependencies = Class(name="softGalleryLanguage_SingleDependencies")
softGalleryLanguage_PackageName = Class(name="softGalleryLanguage_PackageName")
softGalleryLanguage_PackageVersion = Class(name="softGalleryLanguage_PackageVersion")
softGalleryLanguage_DOMConfigurations = Class(name="softGalleryLanguage_DOMConfigurations")
softGalleryLanguage_ComponentsLogic = Class(name="softGalleryLanguage_ComponentsLogic")
softGalleryLanguage_ComponentsStyles = Class(name="softGalleryLanguage_ComponentsStyles")
softGalleryLanguage_LogicContent = Class(name="softGalleryLanguage_LogicContent")
softGalleryLanguage_LogicStructure = Class(name="softGalleryLanguage_LogicStructure")
softGalleryLanguage_ComponentClass = Class(name="softGalleryLanguage_ComponentClass")
softGalleryLanguage_UIContent = Class(name="softGalleryLanguage_UIContent")
softGalleryLanguage_ViewComponentCont = Class(name="softGalleryLanguage_ViewComponentCont")
softGalleryLanguage_SubcomponentCont = Class(name="softGalleryLanguage_SubcomponentCont")
softGalleryLanguage_ReactImports = Class(name="softGalleryLanguage_ReactImports")
softGalleryLanguage_ReactFunctions = Class(name="softGalleryLanguage_ReactFunctions")
softGalleryLanguage_Props = Class(name="softGalleryLanguage_Props")
softGalleryLanguage_StyleProperties = Class(name="softGalleryLanguage_StyleProperties")
softGalleryLanguage_ReactImportContent = Class(name="softGalleryLanguage_ReactImportContent")
softGalleryLanguage_ReactConstructor = Class(name="softGalleryLanguage_ReactConstructor")
softGalleryLanguage_ReactCoreFunctions = Class(name="softGalleryLanguage_ReactCoreFunctions")
softGalleryLanguage_State = Class(name="softGalleryLanguage_State")
softGalleryLanguage_CoreFunctionsDeclaration = Class(name="softGalleryLanguage_CoreFunctionsDeclaration")
softGalleryLanguage_StateContent = Class(name="softGalleryLanguage_StateContent")
softGalleryLanguage_PropsType = Class(name="softGalleryLanguage_PropsType")
softGalleryLanguage_ComponentsStylesContent = Class(name="softGalleryLanguage_ComponentsStylesContent")
softGalleryLanguage_StylePropertiesContent = Class(name="softGalleryLanguage_StylePropertiesContent")
softGalleryLanguage_ReactActionsContent = Class(name="softGalleryLanguage_ReactActionsContent")
softGalleryLanguage_ReactServicesRelation = Class(name="softGalleryLanguage_ReactServicesRelation")
softGalleryLanguage_ReactServicesType = Class(name="softGalleryLanguage_ReactServicesType")
softGalleryLanguage_ReactServiceContent = Class(name="softGalleryLanguage_ReactServiceContent")
softGalleryLanguage_ReactServiceContRequest = Class(name="softGalleryLanguage_ReactServiceContRequest")
softGalleryLanguage_ReactServiceRequestProps = Class(name="softGalleryLanguage_ReactServiceRequestProps")
softGalleryLanguage_ReactsRelationServ = Class(name="softGalleryLanguage_ReactsRelationServ")
softGalleryLanguage_ReactLibrary = Class(name="softGalleryLanguage_ReactLibrary")
softGalleryLanguage_ReactInformation = Class(name="softGalleryLanguage_ReactInformation")
softGalleryLanguage_Row = Class(name="softGalleryLanguage_Row")
softGalleryLanguage_Cluster = Class(name="softGalleryLanguage_Cluster")
softGalleryLanguage_Database = Class(name="softGalleryLanguage_Database")
softGalleryLanguage_Schema = Class(name="softGalleryLanguage_Schema")
softGalleryLanguage_Index_p = Class(name="softGalleryLanguage_Index_p")
softGalleryLanguage_ViewSchema = Class(name="softGalleryLanguage_ViewSchema")
softGalleryLanguage_Table_p = Class(name="softGalleryLanguage_Table_p")
softGalleryLanguage_ForeignKey = Class(name="softGalleryLanguage_ForeignKey")
softGalleryLanguage_ForeignKey_n = Class(name="softGalleryLanguage_ForeignKey_n")
softGalleryLanguage_ForeignKeyRef = Class(name="softGalleryLanguage_ForeignKeyRef")
softGalleryLanguage_RefTable_p = Class(name="softGalleryLanguage_RefTable_p")
softGalleryLanguage_ColumnP = Class(name="softGalleryLanguage_ColumnP")
softGalleryLanguage_DatatypeDB = Class(name="softGalleryLanguage_DatatypeDB")
softGalleryLanguage_Constraint = Class(name="softGalleryLanguage_Constraint")
softGalleryLanguage_PublicAccess = Class(name="softGalleryLanguage_PublicAccess")
softGalleryLanguage_Policy = Class(name="softGalleryLanguage_Policy")
softGalleryLanguage_Trigger = Class(name="softGalleryLanguage_Trigger")
softGalleryLanguage_Function = Class(name="softGalleryLanguage_Function")
softGalleryLanguage_PostgresUser = Class(name="softGalleryLanguage_PostgresUser")
softGalleryLanguage_Privilege = Class(name="softGalleryLanguage_Privilege")
softGalleryLanguage_Query = Class(name="softGalleryLanguage_Query")
softGalleryLanguage_Clause = Class(name="softGalleryLanguage_Clause")
softGalleryLanguage_AmazonSimpleStorageService = Class(name="softGalleryLanguage_AmazonSimpleStorageService")
softGalleryLanguage_BatchOperation = Class(name="softGalleryLanguage_BatchOperation")
softGalleryLanguage_Bucket = Class(name="softGalleryLanguage_Bucket")
softGalleryLanguage_BucketAccess = Class(name="softGalleryLanguage_BucketAccess")
softGalleryLanguage_ObjectsPublic = Class(name="softGalleryLanguage_ObjectsPublic")
softGalleryLanguage_BucketObjectsNotPublic = Class(name="softGalleryLanguage_BucketObjectsNotPublic")
softGalleryLanguage_OnlyAuthorized = Class(name="softGalleryLanguage_OnlyAuthorized")
softGalleryLanguage_AmazonFolder = Class(name="softGalleryLanguage_AmazonFolder")
softGalleryLanguage_AmazonFile = Class(name="softGalleryLanguage_AmazonFile")
softGalleryLanguage_Metadata = Class(name="softGalleryLanguage_Metadata")
softGalleryLanguage_AmazonElasticComputeCloud = Class(name="softGalleryLanguage_AmazonElasticComputeCloud")
...
softGalleryLanguage_AppAccessFunctions.attributes={softGalleryLanguage_AppAccessFunctions_loginName, softGalleryLanguage_AppAccessFunctions_registerName}
...
softGalleryLanguage_AlbumManagementFunctions.attributes={softGalleryLanguage_AlbumManagementFunctions_selectAlbName, softGalleryLanguage_AlbumManagementFunctions_createdAlbName}
...
softGalleryLanguage_PresentationSegments.attributes={softGalleryLanguage_PresentationSegments_presentationAName, softGalleryLanguage_PresentationSegments_presentationCName, softGalleryLanguage_PresentationSegments_presentationSName}
...
softGalleryLanguage_DOMConfigurations.attributes={softGalleryLanguage_DOMConfigurations_elements, softGalleryLanguage_DOMConfigurations_name}
...
softGalleryLanguage_ReactFunctions.attributes={softGalleryLanguage_ReactFunctions_lifecycleclass, softGalleryLanguage_ReactFunctions_renderclass}
...
softGalleryLanguage_PropsType.attributes={softGalleryLanguage_PropsType_nameProps, softGalleryLanguage_PropsType_propsdatas}
...
domain_model = DomainModel(
    ...
    types={softGalleryLanguage_Model, softGalleryLanguage_EObject, softGalleryLanguage_Domain, softGalleryLanguage_Entity, softGalleryLanguage_Functionality, softGalleryLanguage_ExceptionsDomain, softGalleryLanguage_Entities, softGalleryLanguage_AtributePhoto, softGalleryLanguage_AtributeAlbum, softGalleryLanguage_AtributeUserDomain, softGalleryLanguage_Functionalities, softGalleryLanguage_ProfileManagement, softGalleryLanguage_AppAccess, softGalleryLanguage_AlbumManagement, softGalleryLanguage_PhotoActions, softGalleryLanguage_LandingActions, softGalleryLanguage_ProfileManagementFunctions, softGalleryLanguage_AppAccessFunctions, softGalleryLanguage_ExceptionsType, softGalleryLanguage_AlbumManagementFunctions, softGalleryLanguage_PhotoActionsFunctions, softGalleryLanguage_LandingFunctions, softGalleryLanguage_PhotoException, softGalleryLanguage_AlbumException, softGalleryLanguage_UserException, softGalleryLanguage_Architecture, softGalleryLanguage_NTiers, softGalleryLanguage_Layer, softGalleryLanguage_PresentationLayer, softGalleryLanguage_PresentationContent, softGalleryLanguage_PresentationSegments, softGalleryLanguage_BusinessLogicLayer, softGalleryLanguage_BusinessLogicContent, softGalleryLanguage_BusinessLogicSegments, softGalleryLanguage_LayerRelations, softGalleryLanguage_ControllerSegmentElement, softGalleryLanguage_SpecificationSegmentElement, softGalleryLanguage_CriteriaAttributeType, softGalleryLanguage_DataPersistenceLayer, softGalleryLanguage_DataPersistenceContent, softGalleryLanguage_DataPersistenceSegments, softGalleryLanguage_SegmentStructure, softGalleryLanguage_SegmentStructureContent, softGalleryLanguage_DirectoryContent, softGalleryLanguage_Directories, softGalleryLanguage_MultipleFile, softGalleryLanguage_SingleFile, softGalleryLanguage_Technology, softGalleryLanguage_LayerSource, softGalleryLanguage_LayerTarget, softGalleryLanguage_ArchitectureComponents, softGalleryLanguage_FrontEnd, softGalleryLanguage_BackEnd, softGalleryLanguage_PersistenceDataComponent, softGalleryLanguage_NTiersConnections, softGalleryLanguage_NTierConnectionContent, softGalleryLanguage_NTierSource, softGalleryLanguage_NTierTarget, softGalleryLanguage_NTiersRelations, softGalleryLanguage_Technologies, softGalleryLanguage_Spring, softGalleryLanguage_React, softGalleryLanguage_PostgreSQL, softGalleryLanguage_AmazonWebServices, softGalleryLanguage_SpringBootApplication, softGalleryLanguage_Configuration, softGalleryLanguage_EnableGlobalMethodSecurity, softGalleryLanguage_EnableAuthorizationServer, softGalleryLanguage_EnableResourceServer, softGalleryLanguage_EnableWebSecurity, softGalleryLanguage_SpringComponent, softGalleryLanguage_OrderSpring, softGalleryLanguage_SpringRepository, softGalleryLanguage_SpringRepositories, softGalleryLanguage_SpringRepositoryAnnotation, softGalleryLanguage_RestController, softGalleryLanguage_Specification, softGalleryLanguage_Predicate, softGalleryLanguage_SearchCriteria, softGalleryLanguage_Autowired, softGalleryLanguage_ResponseEntity, softGalleryLanguage_MappingType, softGalleryLanguage_ResponseParameter, softGalleryLanguage_SpringEntity, softGalleryLanguage_RequestMapping, MappingType, softGalleryLanguage_RequestMappingValue, softGalleryLanguage_RequestMappingMethod, softGalleryLanguage_RequestMappingProduces, softGalleryLanguage_PostMapping, softGalleryLanguage_GetMapping, softGalleryLanguage_PutMapping, softGalleryLanguage_DeleteMapping, softGalleryLanguage_ResponseParameterAnnotation, softGalleryLanguage_ResponseParameterType, softGalleryLanguage_ResponseParameterName, softGalleryLanguage_ExceptionHandler, softGalleryLanguage_ExceptionProcess, softGalleryLanguage_ReactComponents, softGalleryLanguage_SpringEntityAnnotationTypes, softGalleryLanguage_StorageClient, softGalleryLanguage_StorageMember, softGalleryLanguage_StorageMemberType, softGalleryLanguage_StorageMemberAnnotation, softGalleryLanguage_StorageAction, softGalleryLanguage_StorageActionAnnotation, softGalleryLanguage_StorageActionReturn, softGalleryLanguage_StorageActionMember, softGalleryLanguage_StorageActionMemberType, softGalleryLanguage_StorageActionMemberName, softGalleryLanguage_ReactModules, softGalleryLanguage_ReactSubModules, softGalleryLanguage_ReactConfiguration, softGalleryLanguage_ComponentsUI, softGalleryLanguage_ReactActions, softGalleryLanguage_ReactLibraries, softGalleryLanguage_ReactInfo, softGalleryLanguage_ReactDependencies, softGalleryLanguage_ReactConfigurations, softGalleryLanguage_ReactDependenciesRules, softGalleryLanguage_ReactDependenciesSubRules, softGalleryLanguage_SingleDependencies, softGalleryLanguage_PackageName, softGalleryLanguage_PackageVersion, softGalleryLanguage_DOMConfigurations, softGalleryLanguage_ComponentsLogic, softGalleryLanguage_ComponentsStyles, softGalleryLanguage_LogicContent, softGalleryLanguage_LogicStructure, softGalleryLanguage_ComponentClass, softGalleryLanguage_UIContent, softGalleryLanguage_ViewComponentCont, softGalleryLanguage_SubcomponentCont, softGalleryLanguage_ReactImports, softGalleryLanguage_ReactFunctions, softGalleryLanguage_Props, softGalleryLanguage_StyleProperties, softGalleryLanguage_ReactImportContent, softGalleryLanguage_ReactConstructor, softGalleryLanguage_ReactCoreFunctions, softGalleryLanguage_State, softGalleryLanguage_CoreFunctionsDeclaration, softGalleryLanguage_StateContent, softGalleryLanguage_PropsType, softGalleryLanguage_ComponentsStylesContent, softGalleryLanguage_StylePropertiesContent, softGalleryLanguage_ReactActionsContent, softGalleryLanguage_ReactServicesRelation, softGalleryLanguage_ReactServicesType, softGalleryLanguage_ReactServiceContent, softGalleryLanguage_ReactServiceContRequest, softGalleryLanguage_ReactServiceRequestProps, softGalleryLanguage_ReactsRelationServ, softGalleryLanguage_ReactLibrary, softGalleryLanguage_ReactInformation, softGalleryLanguage_Row, softGalleryLanguage_Cluster, softGalleryLanguage_Database, softGalleryLanguage_Schema, softGalleryLanguage_Index_p, softGalleryLanguage_ViewSchema, softGalleryLanguage_Table_p, softGalleryLanguage_ForeignKey, softGalleryLanguage_ForeignKey_n, softGalleryLanguage_ForeignKeyRef, softGalleryLanguage_RefTable_p, softGalleryLanguage_ColumnP, softGalleryLanguage_DatatypeDB, softGalleryLanguage_Constraint, softGalleryLanguage_PublicAccess, softGalleryLanguage_Policy, softGalleryLanguage_Trigger, softGalleryLanguage_Function, softGalleryLanguage_PostgresUser, softGalleryLanguage_Privilege, softGalleryLanguage_Query, softGalleryLanguage_Clause, softGalleryLanguage_AmazonSimpleStorageService, softGalleryLanguage_BatchOperation, softGalleryLanguage_Bucket, softGalleryLanguage_BucketAccess, softGalleryLanguage_ObjectsPublic, softGalleryLanguage_BucketObjectsNotPublic, softGalleryLanguage_OnlyAuthorized, softGalleryLanguage_AmazonFolder, softGalleryLanguage_AmazonFile, softGalleryLanguage_Metadata, softGalleryLanguage_AmazonElasticComputeCloud},
    associations={elements0, entitydomain1, entityfuncs2, exceptionsdomain4, elements6, atributePhoto8, atributeAlbum10, atributeUserDomain12, elements14, functions16, elements18, items20, resources22, aditionals24, items26, items28, items30, items32, items34, businessLogicSegments55, exceptionsType36, photoException38, albumException40, userException42, elements44, elements46, layer48, presentationLayer50, elements52, businessLogicLayer53, controllerSegmentElement56, specificationSegmentElement58, criteriaAttributeType60, elements62, elements63, elements65, elements66, directories68, elements71, layerorigin72, layertarget73, archFeComponent75, archBeComponent76, archPdComponent78, ntierconnections80, ntierorigin81, ntiertarget83, ntierconnection85, ntierconnection87, elements90, techspring91, techreact93, techpostgresql95, techamazon97, elements99, elements101, elements104, elements106, elements107, elements109, elements111, type113, elements114, value116, method117, produces119, elements121, elements124, springEntityAnnotationTypes125, elements126, elements128, elements130, elements132, reacts134, reactmodules136, reactmodulesconf138, reactmodulescomp140, reactmodulesact142, reactmoduleslib144, reactmodulesinf146, dependencies148, configurations150, dependencies152, dependencies154, dependencies156, dependencies158, configurations161, componentslogic163, componentclassprop191, componentsui165, componentstyle167, logiccomponents169, logiccomponents171, logiccomponents173, uicomponents175, componentcontent177, subcomponentcontent179, uicontent181, uicontent184, componentclassimp187, componentclassfunc189, stylecontent209, reactsimports193, reactconstructors195, reactcorefuncs197, componentstateclass199, componentfuncclass201, statecontents203, propsconts205, stylescontents207, stylespropscontents211, reactactcontent213, reactrelcontent215, reactservcontent217, reactservrequest218, reactservrequestprops220, servicesrels222, reactrelationcontent224, reactlibraries227, reactinformation229, elements231, elements233, elements236, elements237, elements240, elements242, elements244, elements245, elements247, elements248, elements250, elements251, elements254, elements256, elements258, elements260},
    generalizations={gen_softGalleryLanguage_RequestMapping_MappingType, gen_softGalleryLanguage_PostMapping_MappingType, gen_softGalleryLanguage_GetMapping_MappingType, gen_softGalleryLanguage_PutMapping_MappingType, gen_softGalleryLanguage_DeleteMapping_MappingType},
    metadata=None
)
