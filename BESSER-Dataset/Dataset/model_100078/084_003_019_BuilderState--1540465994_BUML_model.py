...
builderState_IEObjectDescription.methods={builderState_IEObjectDescription_m_getUserData, builderState_IEObjectDescription_m_getUserDataKeys, builderState_IEObjectDescription_m_getQualifiedName, builderState_IEObjectDescription_m_getEObjectURI, builderState_IEObjectDescription_m_getEObjectOrProxy}
...
builderState_IReferenceDescription.attributes={builderState_IReferenceDescription_containerEObjectURI, builderState_IReferenceDescription_targetEObjectUri, builderState_IReferenceDescription_sourceEObjectUri, builderState_IReferenceDescription_indexInList}
...
builderState_ResourceDescription_m_getExportedObjects: Method = Method(name="getExportedObjects", parameters={Parameter(name='builderState_type', type=StringType), Parameter(name='builderState_ignoreCase', type=StringType), Parameter(name='builderState_name', type=StringType)}, type=StringType)
...
builderState_ResourceDescription.methods={builderState_ResourceDescription_m_getExportedObjects, builderState_ResourceDescription_m_getExportedObjectsByType, builderState_ResourceDescription_m_isEmpty, builderState_ResourceDescription_m_getExportedObjectsByObject}
...
domain_model = DomainModel(
    name="builderState",
    types={builderState_IEObjectDescription, builderState_IReferenceDescription, builderState_EObjectDescription, IEObjectDescription, builderState_ResourceDescription, builderState_EClass, builderState_UserDataEntry, builderState_ReferenceDescription, IReferenceDescription},
    associations={exportedObjects0, referenceDescriptions1, eClass4, userData3},
    generalizations={gen_builderState_EObjectDescription_IEObjectDescription, gen_builderState_ReferenceDescription_IReferenceDescription},
    metadata=None
)
