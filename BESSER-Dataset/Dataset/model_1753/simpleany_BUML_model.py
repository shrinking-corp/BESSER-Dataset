...
# Classes
simpleanySimplified_Book = Class(name="simpleanySimplified_Book")
simpleanySimplified_Description = Class(name="simpleanySimplified_Description")
MixedBaseClass = Class(name="MixedBaseClass")
simpleanySimplified_Library = Class(name="simpleanySimplified_Library")
simpleanySimplified_MixedData = Class(name="simpleanySimplified_MixedData", is_abstract=True)
simpleanySimplified_MixedText = Class(name="simpleanySimplified_MixedText")
MixedData = Class(name="MixedData")
simpleanySimplified_MixedFeature = Class(name="simpleanySimplified_MixedFeature")
simpleanySimplified_MixedBaseClass = Class(name="simpleanySimplified_MixedBaseClass", is_abstract=True)
...
simpleanySimplified_Book.attributes={simpleanySimplified_Book_name, simpleanySimplified_Book_author, simpleanySimplified_Book_title}
...
domain_model = DomainModel(
    ...
    types={simpleanySimplified_Book, simpleanySimplified_Description, MixedBaseClass, simpleanySimplified_Library, simpleanySimplified_MixedData, simpleanySimplified_MixedText, MixedData, simpleanySimplified_MixedFeature, simpleanySimplified_MixedBaseClass},
    associations={description0, descriptions2, books4, mixed6},
    generalizations={gen_simpleanySimplified_Description_MixedBaseClass, gen_simpleanySimplified_MixedText_MixedData, gen_simpleanySimplified_MixedFeature_MixedData},
    metadata=None
)
