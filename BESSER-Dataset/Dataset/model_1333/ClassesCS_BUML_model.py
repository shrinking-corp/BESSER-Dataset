...
classescs_Element = Class(name="classescs_Element")
...
domain_model = DomainModel(
    name="classescs",
    types={classescs_ClassCS, classescs_PathNameCS, classescs_PathElementCS, classescs_ElementCS, classescs_Element, classescs_NamedElementCS, ElementCS, classescs_PackageCS, NamedElementCS, classescs_RootCS},
    associations={ownedClasses1, extends2, ast0, path4, ownedPackages6},
    generalizations={gen_classescs_ClassCS_NamedElementCS, gen_classescs_PathNameCS_ElementCS, gen_classescs_NamedElementCS_ElementCS, gen_classescs_PackageCS_NamedElementCS, gen_classescs_PathElementCS_NamedElementCS, gen_classescs_RootCS_ElementCS},
    metadata=None
)
