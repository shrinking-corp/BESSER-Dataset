...
# Classes
ecoreJavascriptDelegatesTest_Company = Class(name="ecoreJavascriptDelegatesTest_Company")
ecoreJavascriptDelegatesTest_Employee = Class(name="ecoreJavascriptDelegatesTest_Employee")
...
ecoreJavascriptDelegatesTest_Company.attributes={ecoreJavascriptDelegatesTest_Company_size, ecoreJavascriptDelegatesTest_Company_name}
...
ecoreJavascriptDelegatesTest_Employee_m_reportsTo: Method = Method(name="reportsTo", parameters={Parameter(name='ecoreJavascriptDelegatesTest_manager', type=StringType)}, type=BooleanType)
ecoreJavascriptDelegatesTest_Employee_m_checkNameLength: Method = Method(name="checkNameLength", parameters={Parameter(name='ecoreJavascriptDelegatesTest_diagnostics', type=StringType), Parameter(name='ecoreJavascriptDelegatesTest_context', type=StringType)}, type=BooleanType)
