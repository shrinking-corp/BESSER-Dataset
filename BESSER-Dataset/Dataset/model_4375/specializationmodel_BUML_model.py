...
# Classes
specializationModel_Feature = Class(name="specializationModel_Feature")
specializationModel_Project = Class(name="specializationModel_Project")
specializationModel_Relation = Class(name="specializationModel_Relation")
specializationModel_FeatureGroup = Class(name="specializationModel_FeatureGroup")
Node = Class(name="Node")
specializationModel_TypedValue = Class(name="specializationModel_TypedValue")
specializationModel_Node = Class(name="specializationModel_Node")
specializationModel_RelationFG = Class(name="specializationModel_RelationFG")
Relation = Class(name="Relation")
specializationModel_RelationFeature = Class(name="specializationModel_RelationFeature")
...
specializationModel_Feature.attributes={specializationModel_Feature_realName, specializationModel_Feature_valueType, specializationModel_Feature_state, specializationModel_Feature_name}
...
specializationModel_Project.attributes={specializationModel_Project_featureModelURI, specializationModel_Project_infiniteDomain, specializationModel_Project_numberOfProducts, specializationModel_Project_nameConstraintsFile, specializationModel_Project_nameConfigFile, specializationModel_Project_userConstraintsState}
...
specializationModel_TypedValue.attributes={specializationModel_TypedValue_stringValue, specializationModel_TypedValue_floatValue, specializationModel_TypedValue_integerValue}
...
specializationModel_RelationFeature.attributes={specializationModel_RelationFeature_upperBound, specializationModel_RelationFeature_lowerBound, specializationModel_RelationFeature_type}
...
domain_model = DomainModel(
    ...
    types={specializationModel_Feature, specializationModel_Project, specializationModel_Relation, specializationModel_FeatureGroup, Node, specializationModel_TypedValue, specializationModel_Node, specializationModel_RelationFG, Relation, specializationModel_RelationFeature, ConfigState, ValueType, FeatureType, FeatureGroupType},
    associations={featureValue9, features12, relations14, children16, typedValue0, references2, children4, referenciated7, target28, father19, source21, target23, source26},
