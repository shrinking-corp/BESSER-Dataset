...
class specializationModel_TypedValue:
    ...
    def __init__(self, integerValue: str, stringValue: str, floatValue: str, specializationModel_TypedValue10: "specializationModel_Feature" = None, specializationModel_TypedValue: "specializationModel_Feature" = None):
...
class specializationModel_Feature(Node):
    ...
    def __init__(self, name: str, valueType: str, state: str, realName: str, specializationModel_Feature27: "specializationModel_RelationFeature" = None, specializationModel_Feature11: "specializationModel_TypedValue" = None, specializationModel_Feature17: "specializationModel_FeatureGroup" = None, specializationModel_Feature: "specializationModel_TypedValue" = None, specializationModel_Feature3: "specializationModel_Feature" = None, specializationModel_Feature1: "specializationModel_Feature" = None, specializationModel_Feature5: set["specializationModel_Node"] = None, specializationModel_Feature8: "specializationModel_Feature" = None, specializationModel_Feature6: set["specializationModel_Feature"] = None, specializationModel_Feature30: "specializationModel_RelationFeature" = None):
        self.name = name
