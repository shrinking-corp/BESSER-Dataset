...
def test_hyp_application_is_not_abstract():
    assert not inspect.isabstract(Application)


def test_hyp_application_constructor_exists():
    assert callable(Application.__init__)


def test_hyp_application_constructor_args():
...
def test_hyp_application_has_scan():
...
def test_hyp_application_has_deck():
...
def test_hyp_card_has_cardValue():
...
def test_hyp_deck_has__cards__():
...
def test_hyp_show_top_results_usecase_is_not_abstract():
    assert not inspect.isabstract(Show_Top_Results_UseCase)


def test_hyp_show_top_results_usecase_constructor_exists():
    assert callable(Show_Top_Results_UseCase.__init__)


def test_hyp_show_top_results_usecase_constructor_args():
    sig = inspect.signature(Show_Top_Results_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_play_multiple_times_usecase_is_not_abstract():
    assert not inspect.isabstract(Play_Multiple_Times_UseCase)


def test_hyp_play_multiple_times_usecase_constructor_exists():
    assert callable(Play_Multiple_Times_UseCase.__init__)


def test_hyp_play_multiple_times_usecase_constructor_args():
    sig = inspect.signature(Play_Multiple_Times_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_play_once_usecase_is_not_abstract():
    assert not inspect.isabstract(Play_Once_UseCase)


def test_hyp_play_once_usecase_constructor_exists():
    assert callable(Play_Once_UseCase.__init__)


def test_hyp_play_once_usecase_constructor_args():
    sig = inspect.signature(Play_Once_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_play_for_me_usecase_is_not_abstract():
    assert not inspect.isabstract(Play_for_Me_UseCase)


def test_hyp_play_for_me_usecase_constructor_exists():
    assert callable(Play_for_Me_UseCase.__init__)


def test_hyp_play_for_me_usecase_constructor_args():
    sig = inspect.signature(Play_for_Me_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_amalgamate_usecase_is_not_abstract():
    assert not inspect.isabstract(Amalgamate_UseCase)


def test_hyp_amalgamate_usecase_constructor_exists():
    assert callable(Amalgamate_UseCase.__init__)


def test_hyp_amalgamate_usecase_constructor_args():
    sig = inspect.signature(Amalgamate_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_current_over_two_usecase_is_not_abstract():
    assert not inspect.isabstract(Current_over_two_UseCase)


def test_hyp_current_over_two_usecase_constructor_exists():
    assert callable(Current_over_two_UseCase.__init__)


def test_hyp_current_over_two_usecase_constructor_args():
    sig = inspect.signature(Current_over_two_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_current_onto_previous_usecase_is_not_abstract():
    assert not inspect.isabstract(Current_onto_Previous_UseCase)


def test_hyp_current_onto_previous_usecase_constructor_exists():
    assert callable(Current_onto_Previous_UseCase.__init__)


def test_hyp_current_onto_previous_usecase_constructor_args():
    sig = inspect.signature(Current_onto_Previous_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_make_move_usecase_is_not_abstract():
    assert not inspect.isabstract(Make_Move_UseCase)


def test_hyp_make_move_usecase_constructor_exists():
    assert callable(Make_Move_UseCase.__init__)


def test_hyp_make_move_usecase_constructor_args():
    sig = inspect.signature(Make_Move_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_deal_a_card_usecase_is_not_abstract():
    assert not inspect.isabstract(Deal_a_Card_UseCase)


def test_hyp_deal_a_card_usecase_constructor_exists():
    assert callable(Deal_a_Card_UseCase.__init__)


def test_hyp_deal_a_card_usecase_constructor_args():
    sig = inspect.signature(Deal_a_Card_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_show_deck_usecase_is_not_abstract():
    assert not inspect.isabstract(Show_Deck_UseCase)


def test_hyp_show_deck_usecase_constructor_exists():
    assert callable(Show_Deck_UseCase.__init__)


def test_hyp_show_deck_usecase_constructor_args():
    sig = inspect.signature(Show_Deck_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_shuffle_deck_usecase_is_not_abstract():
    assert not inspect.isabstract(Shuffle_Deck_UseCase)


def test_hyp_shuffle_deck_usecase_constructor_exists():
    assert callable(Shuffle_Deck_UseCase.__init__)


def test_hyp_shuffle_deck_usecase_constructor_args():
...
def test_hyp_application_instantiation(instance):
    assert isinstance(instance, Application)



@given(instance=Application_strategy)
def test_hyp_application_scan_setter(instance):
...
@given(instance=Application_strategy)
def test_hyp_application_deck_setter(instance):
...
@given(instance=Card_strategy)
def test_hyp_card_cardValue_setter(instance):
...
@given(instance=Deck_strategy)
def test_hyp_deck__cards___setter(instance):
...
@given(instance=Deck_strategy)
def test_hyp_deck_scan_setter(instance):
    original = instance.scan
    instance.scan = original
    assert instance.scan == original
