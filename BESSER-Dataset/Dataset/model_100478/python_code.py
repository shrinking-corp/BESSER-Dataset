...
class tfsm_TFSM(NamedElement):
    ...
    def __init__(self, TFSM: "tfsm_State" = None, owningFSM: set["tfsm_State"] = None, tfsm_TFSM: "tfsm_State" = None, tfsm_TFSM3: set["tfsm_FSMEvent"] = None, tfsm_TFSM5: "tfsm_FSMClock" = None, tfsm_TFSM7: set["tfsm_Transition"] = None, tfsm_TFSM9: "tfsm_State" = None, tfsm_TFSM32: "tfsm_TimedSystem" = None):
        self.TFSM = TFSM
...
class tfsm_FSMClock(NamedElement):
    ...
    def __init__(self, numberOfTicks: int, tfsm_FSMClock25: "tfsm_TemporalGuard" = None, tfsm_FSMClock35: "tfsm_TimedSystem" = None, tfsm_FSMClock: "tfsm_TFSM" = None):
...
class tfsm_FSMEvent(NamedElement):
    ...
    def __init__(self, tfsm_FSMEvent23: "tfsm_Transition" = None, tfsm_FSMEvent27: "tfsm_EventGuard" = None, tfsm_FSMEvent38: "tfsm_TimedSystem" = None, tfsm_FSMEvent: "tfsm_TFSM" = None, tfsm_FSMEvent29: set["tfsm_Transition"] = None):
...
class tfsm_State(NamedElement):
    ...
    def __init__(self, OnEnterAction: str, ownedStates: "tfsm_TFSM" = None, State: "tfsm_TFSM" = None, tfsm_State: "tfsm_TFSM" = None, source: set["tfsm_Transition"] = None, target: set["tfsm_Transition"] = None, State16: "tfsm_Transition" = None, State18: "tfsm_Transition" = None, tfsm_State10: "tfsm_TFSM" = None):
