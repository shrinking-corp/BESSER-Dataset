...
tfsm_TFSM_m_changeCurrentState: Method = Method(name="changeCurrentState", parameters={Parameter(name='tfsm_newState', type=StringType)})
tfsm_TFSM.methods={tfsm_TFSM_m_init, tfsm_TFSM_m_changeCurrentState}
...
domain_model = DomainModel(
    name="tfsm",
    types={tfsm_State, tfsm_FSMEvent, tfsm_FSMClock, tfsm_Transition, tfsm_TFSM, NamedElement, tfsm_Guard, tfsm_NamedElement, tfsm_TemporalGuard, Guard, tfsm_EventGuard, tfsm_EvaluateGuard, tfsm_TimedSystem},
    associations={ownedStates0, initialState1, localEvents2, localClock4, ownedTransitions6, outgoingTransitions12, incomingTransitions13, source15, target17, currentState8, ownedGuard19, generatedEvents21, owningFSM11, onClock24, triggeringEvent26, globalClocks33, globalEvents36, sollicitingTransitions28, tfsms31},
    generalizations={gen_tfsm_TFSM_NamedElement, gen_tfsm_Transition_NamedElement, gen_tfsm_State_NamedElement, gen_tfsm_TemporalGuard_Guard, gen_tfsm_EventGuard_Guard, gen_tfsm_FSMEvent_NamedElement, gen_tfsm_EvaluateGuard_Guard, gen_tfsm_Guard_NamedElement, gen_tfsm_FSMClock_NamedElement, gen_tfsm_TimedSystem_NamedElement},
    metadata=None
)
