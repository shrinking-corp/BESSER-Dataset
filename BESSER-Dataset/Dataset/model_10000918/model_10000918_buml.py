...
domain_model = DomainModel(
    name="_6f626fce_f105_47c7_a737_d8c7254d3fcf",
    types={Monopoly, Titulo, TituloPropiedad, TituloFerrocarril, TituloServicio, Servicio, Propiedad, Ferrocarril, ParqueoLibre, IrACarcel, Carcel, Salida, CasillaTarjeta, Impuestos, TSalirCarcel, Tarjeta1, TPagarBanco1, TPagarPorEdificios, TCobrarJugadores1, TAvanzar1, TAvanzarPagarDoble1, TIrACarcel1, TCobrarBanco1, TPagarJugadores1, TPagarPorEdificios1, Tarjeta, TPagarBanco, TPagarJugadores, TCobrarBanco, TAvanzar, TAvanzarPagarDoble, Monopoly1, TIrACarcel, TCobrarJugadores, Jugador, Dados, Casilla},
    associations={Monopoly_Tarjeta, Monopoly_Tarjeta2, Monopoly_Dados, Servicio_TituloServicio, Ferrocarril_TituloFerrocarril, Propiedad_TituloPropiedad, Jugador_Titulo, Monopoly_Jugador, Monopoly_Jugador2, Jugador_TSalirCarcel, Monopoly_Casilla},
    generalizations={},
    metadata=None
)
