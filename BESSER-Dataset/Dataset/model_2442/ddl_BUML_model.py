...
ddl_Schema.attributes={ddl_Schema_conformite, ddl_Schema_version, ddl_Schema_prix}
...
domain_model = DomainModel(
    name="ddl",
    types={ddl_Column, ddl_Schema, DataElement, ddl_Table, ddl_DataType, ddl_DataElement},
    associations={table0, types1, column3, type5},
    generalizations={gen_ddl_Table_DataElement, gen_ddl_Schema_DataElement, gen_ddl_Column_DataElement, gen_ddl_DataType_DataElement},
    metadata=None
)
