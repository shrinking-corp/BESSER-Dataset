...
class fm_Feature:
    ...
    def __init__(self, id: str, name: str, description: str, comment: str, lower: int, upper: int, root: bool, orphan: bool, optional: bool, mandatory: bool, cloneable: bool, Feature: "fm_Feature" = None, features: "fm_Feature" = None, features11: "fm_Group" = None, fm_Feature: "fm_FeatureModel" = None, fm_Feature3: "fm_FeatureModel" = None, fm_Feature7: "fm_EObject" = None, feature: set["fm_Attribute"] = None, Feature15: "fm_Feature" = None, parentFeature: set["fm_Feature"] = None, parent: set["fm_Group"] = None, fm_Feature19: "fm_FeatureModel" = None, Feature22: "fm_Group" = None, Feature24: "fm_Group" = None, Feature26: "fm_Attribute" = None):
        self.id = id
        self.name = name
        self.description = description
        self.comment = comment
