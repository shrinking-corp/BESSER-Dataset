...
uncertainty_aMember = Class(name="uncertainty_aMember")
Families_FamilyRegistry = Class(name="Families_FamilyRegistry")
uncertainty_aFamilyRegistry = Class(name="uncertainty_aFamilyRegistry")
...
Families_uncertainty_aFamilyRegistry = Class(name="Families_uncertainty_aFamilyRegistry", is_abstract=True)
Families_uncertainty_aFamily = Class(name="Families_uncertainty_aFamily", is_abstract=True)
Families_uncertainty_uMember = Class(name="Families_uncertainty_uMember")
uncertainty_Families_Member = Class(name="uncertainty_Families_Member")
uMember = Class(name="uMember")
Families_uncertainty_aMember = Class(name="Families_uncertainty_aMember", is_abstract=True)
Families_uncertainty_uFamilyRegistry = Class(name="Families_uncertainty_uFamilyRegistry")
uncertainty_Families_FamilyRegistry = Class(name="uncertainty_Families_FamilyRegistry")
...
domain_model = DomainModel(
    name="Families",
    types={Families_Member, uncertainty_aMember, Families_FamilyRegistry, uncertainty_aFamilyRegistry, aFamily, Families_uncertainty_ModelElement, ModelElement, Families_uncertainty_UData, Families_uncertainty_uFamily, uncertainty_UData, uncertainty_Families_Family, uFamily, Families_Family, uncertainty_ModelElement, uncertainty_aFamily, aMember, uFamilyRegistry, Families_uncertainty_aFamilyRegistry, Families_uncertainty_aFamily, Families_uncertainty_uMember, uncertainty_Families_Member, uMember, Families_uncertainty_aMember, Families_uncertainty_uFamilyRegistry, uncertainty_Families_FamilyRegistry, OperatorType},
    associations={relatives13, families15, include16, exclude17, uleft20, uright21, sons0, daughters1, mother4, father7, links11, upoint36, upoint24, uleft26, uright27, upoint30, uleft32, uright33},
    generalizations={gen_Families_Member_uncertainty_ModelElement, gen_Families_Member_uncertainty_aMember, gen_Families_FamilyRegistry_uncertainty_ModelElement, gen_Families_FamilyRegistry_uncertainty_aFamilyRegistry, gen_Families_uncertainty_uFamily_uncertainty_aFamily, gen_Families_uncertainty_uFamily_uncertainty_UData, gen_Families_Family_uncertainty_ModelElement, gen_Families_Family_uncertainty_aFamily, gen_Families_uncertainty_uMember_uncertainty_aMember, gen_Families_uncertainty_uMember_uncertainty_UData, gen_Families_uncertainty_uFamilyRegistry_uncertainty_aFamilyRegistry, gen_Families_uncertainty_uFamilyRegistry_uncertainty_UData},
    metadata=None
)
