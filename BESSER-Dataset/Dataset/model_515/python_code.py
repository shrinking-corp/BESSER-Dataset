...
class Families_Family(uncertainty_ModelElement, uncertainty_aFamily):
    ...
    def __init__(self, lastName: str, address: str, Families_Family: set["aMember"] = None, Families_Family2: set["aMember"] = None, Families_Family5: "aMember" = None, Families_Family8: "aMember" = None, Families_Family12: "Families_Family" = None, Families_Family10: set["Families_Family"] = None):
