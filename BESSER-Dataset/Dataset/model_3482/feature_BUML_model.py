...
feature_DiscreteDomain = Class(name="feature_DiscreteDomain")
...
domain_model = DomainModel(
    name="feature",
    types={feature_FeatureModel, feature_Feature, feature_Domain, feature_Constraint, Identifiable, feature_DiscreteDomain, Domain, feature_ContinuousDomain, feature_Interval, feature_Identifiable, feature_Expression, feature_UnaryExpression, Expression, feature_BinaryExpression, feature_Attribute, feature_Group, feature_OrExpression, feature_ImpliesExpression, feature_ExcludesExpression, feature_NestedExpression, feature_AttributeComparisonExpression, feature_AttributeOperand, feature_AttributeReference, AttributeOperand, feature_AtomicExpression, feature_FeatureReference, AtomicExpression, feature_NotExpression, UnaryExpression, feature_AndExpression, BinaryExpression, feature_AttributeValueLiteral, SelectedState, AttributeComparisonOperator},
    associations={root0, domains1, constraints3, childFeatures8, feature11, domain12, intervals14, expression15, operand17, attributes5, groups6, attribute126, attribute227, attribute30, operand119, operand221, feature24},
    generalizations={gen_feature_DiscreteDomain_Domain, gen_feature_ContinuousDomain_Domain, gen_feature_Domain_Identifiable, gen_feature_Constraint_Identifiable, gen_feature_UnaryExpression_Expression, gen_feature_BinaryExpression_Expression, gen_feature_Feature_Identifiable, gen_feature_Group_Identifiable, gen_feature_AndExpression_BinaryExpression, gen_feature_OrExpression_BinaryExpression, gen_feature_ImpliesExpression_BinaryExpression, gen_feature_ExcludesExpression_BinaryExpression, gen_feature_NestedExpression_UnaryExpression, gen_feature_AttributeComparisonExpression_AtomicExpression, gen_feature_AttributeReference_AttributeOperand, gen_feature_AtomicExpression_Expression, gen_feature_FeatureReference_AtomicExpression, gen_feature_NotExpression_UnaryExpression, gen_feature_AttributeValueLiteral_AttributeOperand},
    metadata=None
)
