...
class feature_Group(Identifiable):
    ...
    def __init__(self, minCardinality: int, maxCardinality: int, feature_Group9: set["feature_Feature"] = None, feature_Group: "feature_Feature" = None):
...
class feature_Feature(Identifiable):
    ...
    def __init__(self, name: str, selected: str, feature_Feature10: "feature_Group" = None, Feature: "feature_Attribute" = None, feature: set["feature_Attribute"] = None, feature_Feature7: set["feature_Group"] = None, feature_Feature: "feature_FeatureModel" = None, feature_Feature25: "feature_FeatureReference" = None):
        self.name = name
...
class feature_FeatureModel:
    ...
    def __init__(self, name: str, feature_FeatureModel4: set["feature_Constraint"] = None, feature_FeatureModel: "feature_Feature" = None, feature_FeatureModel2: set["feature_Domain"] = None):
        self.name = name
