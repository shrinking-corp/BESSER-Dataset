...
def test_feature_discretedomain_has_values():
    assert hasattr(feature_DiscreteDomain, "values")
    descriptor = None
    for klass in feature_DiscreteDomain.__mro__:
...
@given(instance=feature_DiscreteDomain_strategy)
def test_feature_discretedomain_values_setter(instance):
