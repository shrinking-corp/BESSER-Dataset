...
# Classes
fsmtest_SignalDeclaration = Class(name="fsmtest_SignalDeclaration")
fsmtest_TransitionDeclaration = Class(name="fsmtest_TransitionDeclaration")
fsmtest_PreconditionDeclaration = Class(name="fsmtest_PreconditionDeclaration")
fsmtest_PostconditionDeclaration = Class(name="fsmtest_PostconditionDeclaration")
fsmtest_ConditionDeclaration = Class(name="fsmtest_ConditionDeclaration")
fsmtest_Model = Class(name="fsmtest_Model")
fsmtest_FsmDefinition = Class(name="fsmtest_FsmDefinition")
fsmtest_RandomTest = Class(name="fsmtest_RandomTest")
fsmtest_StateDeclaration = Class(name="fsmtest_StateDeclaration")
fsmtest_LoopsDeclaration = Class(name="fsmtest_LoopsDeclaration")
fsmtest_SeedDeclaration = Class(name="fsmtest_SeedDeclaration")
fsmtest_GuardDeclaration = Class(name="fsmtest_GuardDeclaration")
...
fsmtest_SignalDeclaration.attributes={fsmtest_SignalDeclaration_port, fsmtest_SignalDeclaration_signame, fsmtest_SignalDeclaration_strVal, fsmtest_SignalDeclaration_intVal}
...
domain_model = DomainModel(
    name="fsmtest",
    types={fsmtest_SignalDeclaration, fsmtest_TransitionDeclaration, fsmtest_PreconditionDeclaration, fsmtest_PostconditionDeclaration, fsmtest_ConditionDeclaration, fsmtest_Model, fsmtest_FsmDefinition, fsmtest_RandomTest, fsmtest_StateDeclaration, fsmtest_LoopsDeclaration, fsmtest_SeedDeclaration, fsmtest_GuardDeclaration},
    associations={signal12, destination13, trigger15, triggers18, precondition21, postcondition23, FsmDefinitions0, RandomTests1, states3, fsm5, loopsDeclaration8, seedDeclaration10, signal25, signal27, signal30, condition33, transitions36},
    generalizations={},
    metadata=None
)
