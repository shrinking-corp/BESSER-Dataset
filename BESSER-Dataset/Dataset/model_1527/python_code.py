...
class fsmtest_TransitionDeclaration:
    ...
    def __init__(self, name: str, fsmtest_TransitionDeclaration: "fsmtest_StateDeclaration" = None, fsmtest_TransitionDeclaration16: "fsmtest_SignalDeclaration" = None, fsmtest_TransitionDeclaration19: set["fsmtest_GuardDeclaration"] = None, fsmtest_TransitionDeclaration22: set["fsmtest_PreconditionDeclaration"] = None, fsmtest_TransitionDeclaration24: set["fsmtest_PostconditionDeclaration"] = None, fsmtest_TransitionDeclaration38: "fsmtest_StateDeclaration" = None):
        self.name = name
...
class fsmtest_SignalDeclaration:
    ...
    def __init__(self, port: str, signame: str, intVal: int, strVal: str, fsmtest_SignalDeclaration: "fsmtest_GuardDeclaration" = None, fsmtest_SignalDeclaration17: "fsmtest_TransitionDeclaration" = None, fsmtest_SignalDeclaration26: "fsmtest_ConditionDeclaration" = None, fsmtest_SignalDeclaration29: "fsmtest_PreconditionDeclaration" = None, fsmtest_SignalDeclaration32: "fsmtest_PostconditionDeclaration" = None):
        self.port = port
