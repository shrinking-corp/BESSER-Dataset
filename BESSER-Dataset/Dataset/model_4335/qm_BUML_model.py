...
# Classes
qm_Factor = Class(name="qm_Factor")
qm_Evaluation = Class(name="qm_Evaluation", is_abstract=True)
qm_Measure = Class(name="qm_Measure")
qm_MeasurementMethod = Class(name="qm_MeasurementMethod", is_abstract=True)
qm_Tool = Class(name="qm_Tool")
qm_Tag = Class(name="qm_Tag")
qm_Source = Class(name="qm_Source")
qm_QualityModel = Class(name="qm_QualityModel")
NamedElement = Class(name="NamedElement")
qm_Entity = Class(name="qm_Entity")
qm_AnnotationBase = Class(name="qm_AnnotationBase", is_abstract=True)
qm_TaggedElement = Class(name="qm_TaggedElement", is_abstract=True)
QualityModelElement = Class(name="QualityModelElement")
qm_Specialization = Class(name="qm_Specialization")
qm_QualityModelElement = Class(name="qm_QualityModelElement", is_abstract=True)
qm_DescribedElement = Class(name="qm_DescribedElement", is_abstract=True)
AnnotatedElement = Class(name="AnnotatedElement")
qm_NamedElement = Class(name="qm_NamedElement", is_abstract=True)
DescribedElement = Class(name="DescribedElement")
qm_AnnotatedElement = Class(name="qm_AnnotatedElement", is_abstract=True)
TaggedElement = Class(name="TaggedElement")
qm_Annotation = Class(name="qm_Annotation")
qm_CharacterizingElement = Class(name="qm_CharacterizingElement", is_abstract=True)
CharacterizingElement = Class(name="CharacterizingElement")
qm_Impact = Class(name="qm_Impact")
qm_FactorRefinement = Class(name="qm_FactorRefinement")
qm_Decomposition = Class(name="qm_Decomposition")
qm_Measurement = Class(name="qm_Measurement")
qm_MeasureRefinement = Class(name="qm_MeasureRefinement")
qm_QIESLEvaluation = Class(name="qm_QIESLEvaluation")
TextEvaluation = Class(name="TextEvaluation")
qm_TextEvaluation = Class(name="qm_TextEvaluation")
Evaluation = Class(name="Evaluation")
qm_FormBasedEvaluation = Class(name="qm_FormBasedEvaluation", is_abstract=True)
qm_SingleMeasureEvaluation = Class(name="qm_SingleMeasureEvaluation")
FormBasedEvaluation = Class(name="FormBasedEvaluation")
MeasureEvaluation = Class(name="MeasureEvaluation")
qm_FactorAggregation = Class(name="qm_FactorAggregation", is_abstract=True)
qm_NormalizationMeasure = Class(name="qm_NormalizationMeasure")
Measure = Class(name="Measure")
qm_QIESLAggregation = Class(name="qm_QIESLAggregation")
TextAggregation = Class(name="TextAggregation")
qm_TextAggregation = Class(name="qm_TextAggregation")
MeasureAggregation = Class(name="MeasureAggregation")
qm_FormBasedMeasureAggregation = Class(name="qm_FormBasedMeasureAggregation", is_abstract=True)
qm_FactorRanking = Class(name="qm_FactorRanking")
Ranking = Class(name="Ranking")
qm_LinearFunction = Class(name="qm_LinearFunction", is_abstract=True)
Function = Class(name="Function")
qm_Function = Class(name="qm_Function", is_abstract=True)
qm_MeasureAggregation = Class(name="qm_MeasureAggregation", is_abstract=True)
MeasurementMethod = Class(name="MeasurementMethod")
qm_Instrument = Class(name="qm_Instrument", is_abstract=True)
qm_ManualInstrument = Class(name="qm_ManualInstrument")
Instrument = Class(name="Instrument")
qm_ToolBasedInstrument = Class(name="qm_ToolBasedInstrument")
qm_QualityModelResult = Class(name="qm_QualityModelResult")
qm_MeasurementResult = Class(name="qm_MeasurementResult", is_abstract=True)
qm_EvaluationResult = Class(name="qm_EvaluationResult")
Result = Class(name="Result")
qm_NumberMeasurementResult = Class(name="qm_NumberMeasurementResult")
MeasurementResult = Class(name="MeasurementResult")
qm_DoubleInterval = Class(name="qm_DoubleInterval")
qm_FindingsMeasurementResult = Class(name="qm_FindingsMeasurementResult")
qm_FindingMessage = Class(name="qm_FindingMessage")
qm_LinearIncreasingFunction = Class(name="qm_LinearIncreasingFunction")
LinearFunction = Class(name="LinearFunction")
qm_LinearDecreasingFunction = Class(name="qm_LinearDecreasingFunction")
qm_WeightedSumFactorAggregation = Class(name="qm_WeightedSumFactorAggregation")
FactorAggregation = Class(name="FactorAggregation")
qm_FindingsUnionMeasureAggregation = Class(name="qm_FindingsUnionMeasureAggregation")
FormBasedMeasureAggregation = Class(name="FormBasedMeasureAggregation")
qm_NumberMeanMeasureAggregation = Class(name="qm_NumberMeanMeasureAggregation")
qm_ManualEvaluation = Class(name="qm_ManualEvaluation")
qm_MeasureEvaluation = Class(name="qm_MeasureEvaluation", is_abstract=True)
qm_Ranking = Class(name="qm_Ranking", is_abstract=True)
qm_MultiMeasureEvaluation = Class(name="qm_MultiMeasureEvaluation", is_abstract=True)
qm_WeightedSumMultiMeasureEvaluation = Class(name="qm_WeightedSumMultiMeasureEvaluation")
MultiMeasureEvaluation = Class(name="MultiMeasureEvaluation")
qm_MeasureRanking = Class(name="qm_MeasureRanking")
qm_SingleMeasureEvaluationResult = Class(name="qm_SingleMeasureEvaluationResult")
EvaluationResult = Class(name="EvaluationResult")
qm_MultiMeasureEvaluationResult = Class(name="qm_MultiMeasureEvaluationResult")
qm_MeasureRankingEvaluationResult = Class(name="qm_MeasureRankingEvaluationResult")
qm_Result = Class(name="qm_Result", is_abstract=True)
...
qm_QualityModel.attributes={qm_QualityModel_schoolGradeBoundary4, qm_QualityModel_schoolGradeBoundary5, qm_QualityModel_schoolGradeBoundary3, qm_QualityModel_schoolGradeBoundary6, qm_QualityModel_schoolGradeBoundary2}
...
qm_Annotation.attributes={qm_Annotation_value, qm_Annotation_key}
...
qm_Impact.attributes={qm_Impact_effect, qm_Impact_justification}
...
qm_LinearFunction.attributes={qm_LinearFunction_lowerBound, qm_LinearFunction_upperBound}
...
qm_FindingsMeasurementResult.attributes={qm_FindingsMeasurementResult_count, qm_FindingsMeasurementResult_findings}
...
domain_model = DomainModel(
    name="qm",
    types={qm_Factor, qm_Evaluation, qm_Measure, qm_MeasurementMethod, qm_Tool, qm_Tag, qm_Source, qm_QualityModel, NamedElement, qm_Entity, qm_AnnotationBase, qm_TaggedElement, QualityModelElement, qm_Specialization, qm_QualityModelElement, qm_DescribedElement, AnnotatedElement, qm_NamedElement, DescribedElement, qm_AnnotatedElement, TaggedElement, qm_Annotation, qm_CharacterizingElement, CharacterizingElement, qm_Impact, qm_FactorRefinement, qm_Decomposition, qm_Measurement, qm_MeasureRefinement, qm_QIESLEvaluation, TextEvaluation, qm_TextEvaluation, Evaluation, qm_FormBasedEvaluation, qm_SingleMeasureEvaluation, FormBasedEvaluation, MeasureEvaluation, qm_FactorAggregation, qm_NormalizationMeasure, Measure, qm_QIESLAggregation, TextAggregation, qm_TextAggregation, MeasureAggregation, qm_FormBasedMeasureAggregation, qm_FactorRanking, Ranking, qm_LinearFunction, Function, qm_Function, qm_MeasureAggregation, MeasurementMethod, qm_Instrument, qm_ManualInstrument, Instrument, qm_ToolBasedInstrument, qm_QualityModelResult, qm_MeasurementResult, qm_EvaluationResult, Result, qm_NumberMeasurementResult, MeasurementResult, qm_DoubleInterval, qm_FindingsMeasurementResult, qm_FindingMessage, qm_LinearIncreasingFunction, LinearFunction, qm_LinearDecreasingFunction, qm_WeightedSumFactorAggregation, FactorAggregation, qm_FindingsUnionMeasureAggregation, FormBasedMeasureAggregation, qm_NumberMeanMeasureAggregation, qm_ManualEvaluation, qm_MeasureEvaluation, qm_Ranking, qm_MultiMeasureEvaluation, qm_WeightedSumMultiMeasureEvaluation, MultiMeasureEvaluation, qm_MeasureRanking, qm_SingleMeasureEvaluationResult, EvaluationResult, qm_MultiMeasureEvaluationResult, qm_MeasureRankingEvaluationResult, qm_Result, Effect, Type},
    associations={factors1, evaluations3, measures5, measurementMethods7, tools9, tags11, sources13, requires16, entities0, advancedAnnotations20, qualityModel22, taggedBy24, isA25, isADirect27, originatesFrom17, qualityModel18, annotations19, child41, characterizes43, influences45, influencesDirect47, refines48, refinesDirect51, qualityModel53, partOf28, partOfDirect31, qualityModel33, parent35, child37, parent39, child63, parent65, parent67, child69, parent71, child72, measures75, measuresDirect77, source55, target57, evaluates59, qualityModel61, factor95, qualityModel80, refines83, refinesDirect86, determines88, qualityModel90, tool92, qualityModel93, measurementResults106, evaluationResults107, resultsFrom109, value112, findingMessages113, rankings97, measure99, normlizationMeasure101, function103, rankings105, value114, resultsFrom117, evaluationResults120, value121, resultsFrom124},
    generalizations={gen_qm_QualityModel_NamedElement, gen_qm_Tag_NamedElement, gen_qm_TaggedElement_QualityModelElement, gen_qm_Entity_NamedElement, gen_qm_Source_NamedElement, gen_qm_DescribedElement_AnnotatedElement, gen_qm_NamedElement_DescribedElement, gen_qm_AnnotatedElement_TaggedElement, gen_qm_CharacterizingElement_NamedElement, gen_qm_Factor_CharacterizingElement, gen_qm_Specialization_AnnotatedElement, gen_qm_Decomposition_AnnotatedElement, gen_qm_FactorRefinement_AnnotatedElement, gen_qm_Measurement_AnnotatedElement, gen_qm_MeasureRefinement_AnnotatedElement, gen_qm_Measure_CharacterizingElement, gen_qm_Impact_AnnotatedElement, gen_qm_Evaluation_NamedElement, gen_qm_QIESLEvaluation_TextEvaluation, gen_qm_TextEvaluation_Evaluation, gen_qm_FormBasedEvaluation_Evaluation, gen_qm_SingleMeasureEvaluation_FormBasedEvaluation, gen_qm_SingleMeasureEvaluation_MeasureEvaluation, gen_qm_FactorAggregation_FormBasedEvaluation, gen_qm_NormalizationMeasure_Measure, gen_qm_QIESLAggregation_TextAggregation, gen_qm_TextAggregation_MeasureAggregation, gen_qm_FormBasedMeasureAggregation_MeasureAggregation, gen_qm_FactorRanking_Ranking, gen_qm_LinearFunction_Function, gen_qm_MeasurementMethod_AnnotatedElement, gen_qm_MeasureAggregation_MeasurementMethod, gen_qm_MeasureAggregation_NamedElement, gen_qm_Instrument_MeasurementMethod, gen_qm_ManualInstrument_Instrument, gen_qm_ManualInstrument_NamedElement, gen_qm_ToolBasedInstrument_Instrument, gen_qm_Tool_NamedElement, gen_qm_MeasurementResult_Result, gen_qm_NumberMeasurementResult_MeasurementResult, gen_qm_FindingsMeasurementResult_MeasurementResult, gen_qm_EvaluationResult_Result, gen_qm_LinearIncreasingFunction_LinearFunction, gen_qm_LinearDecreasingFunction_LinearFunction, gen_qm_WeightedSumFactorAggregation_FactorAggregation, gen_qm_FindingsUnionMeasureAggregation_FormBasedMeasureAggregation, gen_qm_NumberMeanMeasureAggregation_FormBasedMeasureAggregation, gen_qm_ManualEvaluation_Evaluation, gen_qm_MultiMeasureEvaluation_FormBasedEvaluation, gen_qm_WeightedSumMultiMeasureEvaluation_MultiMeasureEvaluation, gen_qm_MeasureRanking_MeasureEvaluation, gen_qm_MeasureRanking_Ranking, gen_qm_SingleMeasureEvaluationResult_EvaluationResult, gen_qm_MultiMeasureEvaluationResult_EvaluationResult},
    metadata=None
)
