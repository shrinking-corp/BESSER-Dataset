...
public class qm_QualityModel extends NamedElement {
    ...
    public qm_QualityModel(
        String schoolGradeBoundary2,        String schoolGradeBoundary5,        String schoolGradeBoundary3,        String schoolGradeBoundary6,        String schoolGradeBoundary4    ) {
        super(
        );
    ...
    public qm_QualityModel(
        String schoolGradeBoundary2,        String schoolGradeBoundary5,        String schoolGradeBoundary3,        String schoolGradeBoundary6,        String schoolGradeBoundary4        ArrayList<qm_Tag> qm_tags,        ArrayList<qm_Measure> qm_measures,        ArrayList<qm_Evaluation> qm_evaluations,        ArrayList<qm_Source> qm_sources,        ArrayList<qm_MeasurementMethod> qm_measurementmethods,        ArrayList<qm_Factor> qm_factors,        ArrayList<qm_Tool> qm_tools    ) {
        this.schoolGradeBoundary2 = schoolGradeBoundary2;
        this.schoolGradeBoundary5 = schoolGradeBoundary5;
        this.schoolGradeBoundary3 = schoolGradeBoundary3;
        this.schoolGradeBoundary6 = schoolGradeBoundary6;
