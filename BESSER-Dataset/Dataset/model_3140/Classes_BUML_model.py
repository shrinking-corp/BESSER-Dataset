...
classes_ClassModel = Class(name="classes_ClassModel")
classes_Content = Class(name="classes_Content")
classes_Constant = Class(name="classes_Constant")
Content = Class(name="Content")
Description = Class(name="Description")
classes_Value = Class(name="classes_Value")
classes_IntegerLiteral = Class(name="classes_IntegerLiteral")
Value = Class(name="Value")
classes_ConstantRef = Class(name="classes_ConstantRef")
classes_Attribute = Class(name="classes_Attribute")
classes_Type = Class(name="classes_Type")
classes_BuiltInType = Class(name="classes_BuiltInType")
Type = Class(name="Type")
classes_StringType = Class(name="classes_StringType")
BuiltInType = Class(name="BuiltInType")
classes_IntegerType = Class(name="classes_IntegerType")
classes_ClassRef = Class(name="classes_ClassRef")
classes_Description = Class(name="classes_Description")
...
classes_Attribute.attributes={classes_Attribute_name, classes_Attribute_visibility}
...
domain_model = DomainModel(
    name="classes",
    types={classes_Association, classes_Class, classes_ClassModel, classes_Content, classes_Constant, Content, Description, classes_Value, classes_IntegerLiteral, Value, classes_ConstantRef, classes_Attribute, classes_Type, classes_BuiltInType, Type, classes_StringType, BuiltInType, classes_IntegerType, classes_ClassRef, classes_Description, Visibility},
    associations={initial1, content0, source2, target3, lowerBound6, upperBound9, subClasses13, attributes15, type17, lowerBound19, upperBound22, target25, target27},
    generalizations={gen_classes_Association_Content, gen_classes_Association_Description, gen_classes_Constant_Content, gen_classes_Constant_Description, gen_classes_IntegerLiteral_Value, gen_classes_ConstantRef_Value, gen_classes_Class_Content, gen_classes_Class_Description, gen_classes_Attribute_Description, gen_classes_BuiltInType_Type, gen_classes_StringType_BuiltInType, gen_classes_IntegerType_BuiltInType, gen_classes_ClassRef_Type},
    metadata=None
)
