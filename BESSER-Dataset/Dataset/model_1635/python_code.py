...
class ptn_AbstractNode(ABC):
    ...
    def __init__(self, tMax: int, name: str, tMin: int, ptn_AbstractNode: "ptn_Place" = None):
        self.tMax = tMax
        self.name = name
        self.tMin = tMin
...
class ptn_AbstractTransition(AbstractNode):
    ...
    def __init__(self, guard: str, ptn_AbstractTransition9: set["ptn_Place"] = None, ptn_AbstractTransition: "ptn_Place" = None):
        self.guard = guard
