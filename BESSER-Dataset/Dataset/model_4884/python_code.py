...
class builds_ChangeArtifact:
    ...
    def __init__(self, prevRevision: str, revision: str, dead: bool, editType: str, file: str, relativePath: str, builds_ChangeArtifact: "builds_Change" = None):
...
class builds_ParameterDefinition(ABC):
    ...
    def __init__(self, name: str, description: str, parameterDefinitions: "builds_BuildPlan" = None, ParameterDefinition: "builds_BuildPlan" = None):
        self.name = name
        self.description = description
...
class builds_ChangeSet:
    ...
    def __init__(self, kind: str, builds_ChangeSet45: set["builds_Change"] = None, builds_ChangeSet: "builds_Build" = None):
        self.kind = kind
...
class builds_Build(BuildElement):
    ...
    def __init__(self, label: str, summary: str, id: str, buildNumber: int, timestamp: str, duration: str, displayName: str, state: str, status: str, builds_Build6: "builds_BuildServer" = None, build: "builds_TestResult" = None, builds_Build9: set["builds_User"] = None, builds_Build11: set["builds_BuildCause"] = None, builds_Build39: "builds_BuildModel" = None, Build: "builds_TestResult" = None, builds_Build: set["builds_Artifact"] = None, builds_Build2: "builds_ChangeSet" = None, builds_Build4: "builds_BuildPlan" = None, builds_Build28: "builds_BuildPlan" = None):
        self.label = label
...
class builds_BuildPlan(BuildElement):
    ...
    def __init__(self, selected: bool, summary: str, state: str, status: str, description: str, flags: str, health: int, id: str, info: str, BuildPlan48: "builds_ParameterDefinition" = None, builds_BuildPlan50: "builds_BuildParameterDefinition" = None, builds_BuildPlan: "builds_Build" = None, builds_BuildPlan27: "builds_Build" = None, containingBuildPlan: set["builds_ParameterDefinition"] = None, builds_BuildPlan31: set["builds_HealthReport"] = None, builds_BuildPlan36: "builds_BuildModel" = None, builds_BuildPlan19: "builds_BuildServer" = None, BuildPlan: "builds_BuildPlan" = None, parent: set["builds_BuildPlan"] = None, BuildPlan25: "builds_BuildPlan" = None, children: "builds_BuildPlan" = None):
