...
# Classes
tinylibrary_Library = Class(name="tinylibrary_Library")
tinylibrary_Book = Class(name="tinylibrary_Book")
tinylibrary_Employee = Class(name="tinylibrary_Employee")
tinylibrary_Writer = Class(name="tinylibrary_Writer")
tinylibrary_Person = Class(name="tinylibrary_Person", is_abstract=True)
...
tinylibrary_Book.attributes={tinylibrary_Book_isbn, tinylibrary_Book_title, tinylibrary_Book_category, tinylibrary_Book_pages, tinylibrary_Book_damaged, tinylibrary_Book_published}
...
tinylibrary_Person.attributes={tinylibrary_Person_firstName, tinylibrary_Person_name, tinylibrary_Person_lastName}
