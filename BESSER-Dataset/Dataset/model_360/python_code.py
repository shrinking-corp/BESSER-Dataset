...
class tinylibrary_Book:
    ...
    def __init__(self, title: str, category: str, isbn: str, pages: str, published: date, damaged: str, tinylibrary_Book: "tinylibrary_Library" = None, Book: "tinylibrary_Writer" = None, books: set["tinylibrary_Writer"] = None):
        self.title = title
