...
class pcm_pc_qos_performance_pc_SystemSpecifiedExecutionTime(SpecifiedExecutionTime):
    ...
    def __init__(self):
        ...
        pass
    def SystemSpecifiedExecutionTimeMustReferenceRequiredRoleOfASystem(self, pcm_pc_diagnostics, pcm_pc_context) :
...
class pcm_pc_qos_reliability_pc_SpecifiedReliabilityAnnotation(SpecifiedQoSAnnotation):
    ...
    def __init__(self, specifiedReliabilityAnnotation__ExternalFailureOccurrenceDescription: set["ExternalFailureOccurrenceDescription"] = None, SpecifiedQoSAnnotation: "pcm_pc_qosannotations_pc_QoSAnnotations" = None):
    ...
    def specifiedReliabilityAnnotation__ExternalFailureOccurrenceDescription(self, value):
        ...
        old_value = getattr(self, f"_pcm_pc_qos_reliability_pc_SpecifiedReliabilityAnnotation__specifiedReliabilityAnnotation__ExternalFailureOccurrenceDescription", None)
    ...
    def SumOfReliabilityAnnotationFailureProbabilitiesMustNotExceed1(self, pcm_pc_context, pcm_pc_diagnostics) :
        # TODO: Implement SumOfReliabilityAnnotationFailureProbabilitiesMustNotExceed1 method
        pass

    def SpecifiedReliabilityAnnotationMustReferenceRequiredRoleOfASystem(self, pcm_pc_diagnostics, pcm_pc_context) :
        # TODO: Implement SpecifiedReliabilityAnnotationMustReferenceRequiredRoleOfASystem method
        pass

    def MultipleExternalOccurrenceDescriptionsPerFailureTypeNotAllowed(self, pcm_pc_diagnostics, pcm_pc_context) :
...
class pcm_pc_seff_performance_pc_ParametricResourceDemand:
    ...
    def __init__(self, parametricResourceDemand_PCMRandomVariable: "PCMRandomVariable" = None, pcm_pc_seff_performance_pc_ParametricResourceDemand: "ProcessingResourceType" = None, resourceDemand_Action: "AbstractInternalControlFlowAction" = None):
    ...
    def pcm_pc_seff_performance_pc_ParametricResourceDemand(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "ProcessingResourceType414"):
                opp_val = getattr(old_value, "ProcessingResourceType414", None)
                if opp_val == self:
                    setattr(old_value, "ProcessingResourceType414", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "ProcessingResourceType414"):
                opp_val = getattr(value, "ProcessingResourceType414", None)
                setattr(value, "ProcessingResourceType414", self)
    ...
    def resourceDemand_Action(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_seff_performance_pc_ParametricResourceDemand__resourceDemand_Action", None)
        self.__resourceDemand_Action = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "AbstractInternalControlFlowAction416"):
                opp_val = getattr(old_value, "AbstractInternalControlFlowAction416", None)
                if opp_val == self:
                    setattr(old_value, "AbstractInternalControlFlowAction416", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "AbstractInternalControlFlowAction416"):
                opp_val = getattr(value, "AbstractInternalControlFlowAction416", None)
                setattr(value, "AbstractInternalControlFlowAction416", self)
    ...
    def parametricResourceDemand_PCMRandomVariable(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_seff_performance_pc_ParametricResourceDemand__parametricResourceDemand_PCMRandomVariable", None)
    ...
    def DemandedProcessingResourceMustBeUniqueWithinAbstractInternalControlFlowAction(self, pcm_pc_diagnostics, pcm_pc_context) :
...
class seff_pc_CallAction:
    ...
    pass
class pcm_pc_seff_pc_InternalCallAction(seff_pc_AbstractInternalControlFlowAction, seff_pc_CallAction):
...
class pcm_pc_seff_pc_EmitEventAction(seff_pc_AbstractAction, seff_pc_CallAction):
    ...
    pass
class pcm_pc_seff_pc_ExternalCallAction(seff_reliability_pc_FailureHandlingEntity, seff_pc_AbstractAction, seff_pc_CallReturnAction):

    def __init__(self, retryCount: int, pcm_pc_seff_pc_ExternalCallAction: "OperationSignature" = None, pcm_pc_seff_pc_ExternalCallAction373: "OperationRequiredRole" = None):
        self.retryCount = retryCount
        self.pcm_pc_seff_pc_ExternalCallAction = pcm_pc_seff_pc_ExternalCallAction
        self.pcm_pc_seff_pc_ExternalCallAction373 = pcm_pc_seff_pc_ExternalCallAction373
    ...
    @property
    def pcm_pc_seff_pc_ExternalCallAction373(self):
        return self.__pcm_pc_seff_pc_ExternalCallAction373

    @pcm_pc_seff_pc_ExternalCallAction373.setter
    def pcm_pc_seff_pc_ExternalCallAction373(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_seff_pc_ExternalCallAction__pcm_pc_seff_pc_ExternalCallAction373", None)
        self.__pcm_pc_seff_pc_ExternalCallAction373 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "OperationRequiredRole374"):
                opp_val = getattr(old_value, "OperationRequiredRole374", None)
                if opp_val == self:
                    setattr(old_value, "OperationRequiredRole374", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "OperationRequiredRole374"):
                opp_val = getattr(value, "OperationRequiredRole374", None)
                setattr(value, "OperationRequiredRole374", self)
    ...
    def pcm_pc_seff_pc_ExternalCallAction(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "OperationSignature371"):
                opp_val = getattr(old_value, "OperationSignature371", None)
                if opp_val == self:
                    setattr(old_value, "OperationSignature371", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "OperationSignature371"):
                opp_val = getattr(value, "OperationSignature371", None)
                setattr(value, "OperationSignature371", self)

    def OperationRequiredRoleMustBeReferencedByContainer(self, pcm_pc_context, pcm_pc_diagnostics) :
        # TODO: Implement OperationRequiredRoleMustBeReferencedByContainer method
        pass

    def SignatureBelongsToRole(self, pcm_pc_diagnostics, pcm_pc_context) :
...
class pcm_pc_seff_reliability_pc_RecoveryActionBehaviour(seff_reliability_pc_FailureHandlingEntity, seff_pc_ResourceDemandingBehaviour):
    ...
    def __init__(self, pcm_pc_seff_reliability_pc_RecoveryActionBehaviour: set["seff_reliability_pc_RecoveryActionBehaviour"] = None, recoveryActionBehaviours__RecoveryAction: "seff_reliability_pc_RecoveryAction" = None):
    ...
    def recoveryActionBehaviours__RecoveryAction(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_seff_reliability_pc_RecoveryActionBehaviour__recoveryActionBehaviours__RecoveryAction", None)
    ...
    def RecoveryActionBehaviourIsNotSuccessorOfItself(self, pcm_pc_context, pcm_pc_diagnostics) :
        # TODO: Implement RecoveryActionBehaviourIsNotSuccessorOfItself method
        pass

    def RecoveryActionBehaviourHasOnlyOnePredecessor(self, pcm_pc_context, pcm_pc_diagnostics) :
        # TODO: Implement RecoveryActionBehaviourHasOnlyOnePredecessor method
        pass

    def SuccessorsOfRecoveryActionBehaviourHandleDisjointFailureTypes(self, pcm_pc_diagnostics, pcm_pc_context) :
...
class pcm_pc_seff_pc_ServiceEffectSpecification:
    ...
    def __init__(self, seffTypeID: str, pcm_pc_seff_pc_ServiceEffectSpecification: "Signature" = None, serviceEffectSpecifications__BasicComponent: "BasicComponent" = None):
    ...
    def serviceEffectSpecifications__BasicComponent(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_seff_pc_ServiceEffectSpecification__serviceEffectSpecifications__BasicComponent", None)
        self.__serviceEffectSpecifications__BasicComponent = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "BasicComponent351"):
                opp_val = getattr(old_value, "BasicComponent351", None)
                if opp_val == self:
                    setattr(old_value, "BasicComponent351", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "BasicComponent351"):
                opp_val = getattr(value, "BasicComponent351", None)
                setattr(value, "BasicComponent351", self)

    def ReferencedSignatureMustBelongToInterfaceReferencedByProvidedRole(self, pcm_pc_diagnostics, pcm_pc_context) :
...
class pcm_pc_seff_pc_ProbabilisticBranchTransition(AbstractBranchTransition):
    ...
    def __init__(self, branchProbability: float, AbstractBranchTransition346: "pcm_pc_seff_pc_BranchAction" = None, AbstractBranchTransition: "pcm_pc_seff_pc_ResourceDemandingBehaviour" = None):
...
class pcm_pc_seff_pc_StartAction(AbstractInternalControlFlowAction):
    ...
    def __init__(self, AbstractInternalControlFlowAction403: "pcm_pc_seff_performance_pc_ResourceCall" = None, AbstractInternalControlFlowAction: "pcm_pc_seff_performance_pc_InfrastructureCall" = None, AbstractInternalControlFlowAction416: "pcm_pc_seff_performance_pc_ParametricResourceDemand" = None):
        
        pass
    def StartActionPredecessorMustNotBeDefined(self, pcm_pc_context, pcm_pc_diagnostics) :
...
class pcm_pc_seff_pc_BranchAction(AbstractInternalControlFlowAction):
    ...
    def __init__(self, branchAction_AbstractBranchTransition: set["AbstractBranchTransition"] = None, AbstractInternalControlFlowAction403: "pcm_pc_seff_performance_pc_ResourceCall" = None, AbstractInternalControlFlowAction: "pcm_pc_seff_performance_pc_InfrastructureCall" = None, AbstractInternalControlFlowAction416: "pcm_pc_seff_performance_pc_ParametricResourceDemand" = None):
    ...
    def branchAction_AbstractBranchTransition(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_seff_pc_BranchAction__branchAction_AbstractBranchTransition", None)
        self.__branchAction_AbstractBranchTransition = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "AbstractBranchTransition346"):
                    opp_val = getattr(item, "AbstractBranchTransition346", None)
                    
                    if opp_val == self:
                        setattr(item, "AbstractBranchTransition346", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "AbstractBranchTransition346"):
                    ...
                    setattr(item, "AbstractBranchTransition346", self)
                    

    def AllProbabilisticBranchProbabilitiesMustSumUpTo1(self, pcm_pc_diagnostics, pcm_pc_context) :
        # TODO: Implement AllProbabilisticBranchProbabilitiesMustSumUpTo1 method
        pass

    def EitherGuardedBranchesOrProbabilisiticBranchTransitions(self, pcm_pc_context, pcm_pc_diagnostics) :
...
class pcm_pc_seff_pc_AcquireAction(AbstractInternalControlFlowAction):
    ...
    def __init__(self, timeout: bool, timeoutValue: float, pcm_pc_seff_pc_AcquireAction: "PassiveResource" = None, AbstractInternalControlFlowAction403: "pcm_pc_seff_performance_pc_ResourceCall" = None, AbstractInternalControlFlowAction: "pcm_pc_seff_performance_pc_InfrastructureCall" = None, AbstractInternalControlFlowAction416: "pcm_pc_seff_performance_pc_ParametricResourceDemand" = None):
    ...
    def pcm_pc_seff_pc_AcquireAction(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "PassiveResource378"):
                opp_val = getattr(old_value, "PassiveResource378", None)
                if opp_val == self:
                    setattr(old_value, "PassiveResource378", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "PassiveResource378"):
                opp_val = getattr(value, "PassiveResource378", None)
                setattr(value, "PassiveResource378", self)

    def TimeoutValueOfAcquireActionMustNotBeNegative(self, pcm_pc_diagnostics, pcm_pc_context) :
...
class pcm_pc_seff_reliability_pc_RecoveryAction(AbstractInternalControlFlowAction):
    ...
    def __init__(self, pcm_pc_seff_reliability_pc_RecoveryAction: "seff_reliability_pc_RecoveryActionBehaviour" = None, recoveryAction__RecoveryActionBehaviour: set["seff_reliability_pc_RecoveryActionBehaviour"] = None, AbstractInternalControlFlowAction403: "pcm_pc_seff_performance_pc_ResourceCall" = None, AbstractInternalControlFlowAction: "pcm_pc_seff_performance_pc_InfrastructureCall" = None, AbstractInternalControlFlowAction416: "pcm_pc_seff_performance_pc_ParametricResourceDemand" = None):
    ...
    def pcm_pc_seff_reliability_pc_RecoveryAction(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "seff_reliability_pc_RecoveryActionBehaviour420"):
                opp_val = getattr(old_value, "seff_reliability_pc_RecoveryActionBehaviour420", None)
                if opp_val == self:
                    setattr(old_value, "seff_reliability_pc_RecoveryActionBehaviour420", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "seff_reliability_pc_RecoveryActionBehaviour420"):
                opp_val = getattr(value, "seff_reliability_pc_RecoveryActionBehaviour420", None)
                setattr(value, "seff_reliability_pc_RecoveryActionBehaviour420", self)
    ...
    def recoveryAction__RecoveryActionBehaviour(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_seff_reliability_pc_RecoveryAction__recoveryAction__RecoveryActionBehaviour", None)
    ...
    def PrimaryBehaviourOfRecoveryActionMustBeSet(self, pcm_pc_context, pcm_pc_diagnostics) :
...
class pcm_pc_seff_pc_InternalAction(AbstractInternalControlFlowAction):
    ...
    def internalAction__InternalFailureOccurrenceDescription(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_seff_pc_InternalAction__internalAction__InternalFailureOccurrenceDescription", None)
        self.__internalAction__InternalFailureOccurrenceDescription = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "InternalFailureOccurrenceDescription393"):
                    opp_val = getattr(item, "InternalFailureOccurrenceDescription393", None)
                    
                    if opp_val == self:
                        setattr(item, "InternalFailureOccurrenceDescription393", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "InternalFailureOccurrenceDescription393"):
                    ...
                    setattr(item, "InternalFailureOccurrenceDescription393", self)
                    

    def MultipleInternalOccurrenceDescriptionsPerFailureTypeNotAllowed(self, pcm_pc_context, pcm_pc_diagnostics) :
        # TODO: Implement MultipleInternalOccurrenceDescriptionsPerFailureTypeNotAllowed method
        pass

    def SumOfInternalActionFailureProbabilitiesMustNotExceed1(self, pcm_pc_context, pcm_pc_diagnostics) :
...
class pcm_pc_seff_pc_StopAction(AbstractInternalControlFlowAction):
    ...
    def __init__(self, AbstractInternalControlFlowAction403: "pcm_pc_seff_performance_pc_ResourceCall" = None, AbstractInternalControlFlowAction: "pcm_pc_seff_performance_pc_InfrastructureCall" = None, AbstractInternalControlFlowAction416: "pcm_pc_seff_performance_pc_ParametricResourceDemand" = None):
        ...
        pass
    def StopActionSuccessorMustNotBeDefined(self, pcm_pc_diagnostics, pcm_pc_context) :
...
class pcm_pc_parameter_pc_VariableCharacterisation:
    ...
    def __init__(self, type: str, variableCharacterisation_VariableUsage: "VariableUsage" = None, variableCharacterisation_Specification: "PCMRandomVariable" = None):
        self.type = type
    ...
    def variableCharacterisation_VariableUsage(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_parameter_pc_VariableCharacterisation__variableCharacterisation_VariableUsage", None)
        self.__variableCharacterisation_VariableUsage = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "VariableUsage312"):
                opp_val = getattr(old_value, "VariableUsage312", None)
                if opp_val == self:
                    setattr(old_value, "VariableUsage312", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "VariableUsage312"):
                opp_val = getattr(value, "VariableUsage312", None)
                setattr(value, "VariableUsage312", self)
    ...
    def variableCharacterisation_Specification(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_parameter_pc_VariableCharacterisation__variableCharacterisation_Specification", None)
        self.__variableCharacterisation_Specification = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "PCMRandomVariable310"):
                opp_val = getattr(old_value, "PCMRandomVariable310", None)
                if opp_val == self:
                    setattr(old_value, "PCMRandomVariable310", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "PCMRandomVariable310"):
                opp_val = getattr(value, "PCMRandomVariable310", None)
                setattr(value, "PCMRandomVariable310", self)
...
class pcm_pc_seff_performance_pc_InfrastructureCall(CallAction):
    ...
    def __init__(self, pcm_pc_seff_performance_pc_InfrastructureCall: "InfrastructureSignature" = None, infrastructureCall__PCMRandomVariable: "PCMRandomVariable" = None, infrastructureCall__Action: "AbstractInternalControlFlowAction" = None, pcm_pc_seff_performance_pc_InfrastructureCall400: "InfrastructureRequiredRole" = None, CallAction: "pcm_pc_parameter_pc_VariableUsage" = None):
        ...
        self.pcm_pc_seff_performance_pc_InfrastructureCall400 = pcm_pc_seff_performance_pc_InfrastructureCall400
    ...
    def infrastructureCall__PCMRandomVariable(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_seff_performance_pc_InfrastructureCall__infrastructureCall__PCMRandomVariable", None)
        self.__infrastructureCall__PCMRandomVariable = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "PCMRandomVariable397"):
                opp_val = getattr(old_value, "PCMRandomVariable397", None)
                if opp_val == self:
                    setattr(old_value, "PCMRandomVariable397", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "PCMRandomVariable397"):
                opp_val = getattr(value, "PCMRandomVariable397", None)
                setattr(value, "PCMRandomVariable397", self)
    ...
    def infrastructureCall__Action(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_seff_performance_pc_InfrastructureCall__infrastructureCall__Action", None)
    ...
    @property
    def pcm_pc_seff_performance_pc_InfrastructureCall400(self):
        return self.__pcm_pc_seff_performance_pc_InfrastructureCall400

    @pcm_pc_seff_performance_pc_InfrastructureCall400.setter
    def pcm_pc_seff_performance_pc_InfrastructureCall400(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_seff_performance_pc_InfrastructureCall__pcm_pc_seff_performance_pc_InfrastructureCall400", None)
        self.__pcm_pc_seff_performance_pc_InfrastructureCall400 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "InfrastructureRequiredRole401"):
                opp_val = getattr(old_value, "InfrastructureRequiredRole401", None)
                if opp_val == self:
                    setattr(old_value, "InfrastructureRequiredRole401", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "InfrastructureRequiredRole401"):
                opp_val = getattr(value, "InfrastructureRequiredRole401", None)
                setattr(value, "InfrastructureRequiredRole401", self)
    ...
    def pcm_pc_seff_performance_pc_InfrastructureCall(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "InfrastructureSignature395"):
                opp_val = getattr(old_value, "InfrastructureSignature395", None)
                if opp_val == self:
                    setattr(old_value, "InfrastructureSignature395", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "InfrastructureSignature395"):
                opp_val = getattr(value, "InfrastructureSignature395", None)
                setattr(value, "InfrastructureSignature395", self)

    def SignatureMustBelongToUsedRequiredRole(self, pcm_pc_context, pcm_pc_diagnostics) :
        # TODO: Implement SignatureMustBelongToUsedRequiredRole method
        pass

    def SignatureRoleCombinationMustBeUniqueWithinAbstractInternalControlFlowAction(self, pcm_pc_context, pcm_pc_diagnostics) :
        # TODO: Implement SignatureRoleCombinationMustBeUniqueWithinAbstractInternalControlFlowAction method
        pass

    def ReferencedRequiredRoleMustBeRequiredByComponent(self, pcm_pc_context, pcm_pc_diagnostics) :
...
class pcm_pc_seff_performance_pc_ResourceCall(CallAction):
    ...
    def __init__(self, resourceCall__Action: "AbstractInternalControlFlowAction" = None, pcm_pc_seff_performance_pc_ResourceCall: "entity_pc_ResourceRequiredRole" = None, pcm_pc_seff_performance_pc_ResourceCall407: "ResourceSignature" = None, resourceCall__PCMRandomVariable: "PCMRandomVariable" = None, CallAction: "pcm_pc_parameter_pc_VariableUsage" = None):
        ...
        self.pcm_pc_seff_performance_pc_ResourceCall407 = pcm_pc_seff_performance_pc_ResourceCall407
    ...
    def resourceCall__Action(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_seff_performance_pc_ResourceCall__resourceCall__Action", None)
        self.__resourceCall__Action = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "AbstractInternalControlFlowAction403"):
                opp_val = getattr(old_value, "AbstractInternalControlFlowAction403", None)
                if opp_val == self:
                    setattr(old_value, "AbstractInternalControlFlowAction403", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "AbstractInternalControlFlowAction403"):
                opp_val = getattr(value, "AbstractInternalControlFlowAction403", None)
                setattr(value, "AbstractInternalControlFlowAction403", self)
    ...
    def pcm_pc_seff_performance_pc_ResourceCall(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "entity_pc_ResourceRequiredRole405"):
                opp_val = getattr(old_value, "entity_pc_ResourceRequiredRole405", None)
                if opp_val == self:
                    setattr(old_value, "entity_pc_ResourceRequiredRole405", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "entity_pc_ResourceRequiredRole405"):
                opp_val = getattr(value, "entity_pc_ResourceRequiredRole405", None)
                setattr(value, "entity_pc_ResourceRequiredRole405", self)
    ...
    def resourceCall__PCMRandomVariable(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_seff_performance_pc_ResourceCall__resourceCall__PCMRandomVariable", None)
        self.__resourceCall__PCMRandomVariable = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "PCMRandomVariable410"):
                opp_val = getattr(old_value, "PCMRandomVariable410", None)
                if opp_val == self:
                    setattr(old_value, "PCMRandomVariable410", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "PCMRandomVariable410"):
                opp_val = getattr(value, "PCMRandomVariable410", None)
                setattr(value, "PCMRandomVariable410", self)

    @property
    def pcm_pc_seff_performance_pc_ResourceCall407(self):
        return self.__pcm_pc_seff_performance_pc_ResourceCall407

    @pcm_pc_seff_performance_pc_ResourceCall407.setter
    def pcm_pc_seff_performance_pc_ResourceCall407(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_seff_performance_pc_ResourceCall__pcm_pc_seff_performance_pc_ResourceCall407", None)
        self.__pcm_pc_seff_performance_pc_ResourceCall407 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "ResourceSignature408"):
                opp_val = getattr(old_value, "ResourceSignature408", None)
                if opp_val == self:
                    setattr(old_value, "ResourceSignature408", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "ResourceSignature408"):
                opp_val = getattr(value, "ResourceSignature408", None)
                setattr(value, "ResourceSignature408", self)

    def ResourceRequiredRoleMustBeReferencedByComponent(self, pcm_pc_context, pcm_pc_diagnostics) :
        # TODO: Implement ResourceRequiredRoleMustBeReferencedByComponent method
        pass

    def ResourceSignatureBelongsToResourceRequiredRole(self, pcm_pc_diagnostics, pcm_pc_context) :
        # TODO: Implement ResourceSignatureBelongsToResourceRequiredRole method
        pass

    def SignatureRoleCombinationMustBeUniqueWithinAbstractInternalControlFlowAction(self, pcm_pc_diagnostics, pcm_pc_context) :
        # TODO: Implement SignatureRoleCombinationMustBeUniqueWithinAbstractInternalControlFlowAction method
        pass
...
class entity_pc_ComposedProvidingRequiringEntity:
    ...
    pass
class pcm_pc_subsystem_pc_SubSystem(repository_pc_RepositoryComponent, entity_pc_ComposedProvidingRequiringEntity):

    pass
class pcm_pc_completions_pc_Completion(repository_pc_ImplementationComponentType, entity_pc_ComposedProvidingRequiringEntity):

    pass
class pcm_pc_repository_pc_CompositeComponent(repository_pc_ImplementationComponentType, entity_pc_ComposedProvidingRequiringEntity):

    def __init__(self):
        
        pass
    def RequireSameInterfaces(self, pcm_pc_context, pcm_pc_diagnostics) :
        # TODO: Implement RequireSameInterfaces method
        pass

    def ProvideSameInterfaces(self, pcm_pc_diagnostics, pcm_pc_context) :
...
class pcm_pc_repository_pc_OperationSignature(Signature):
    ...
    def __init__(self, pcm_pc_repository_pc_OperationSignature: "DataType" = None, signatures__OperationInterface: "OperationInterface" = None, operationSignature__Parameter: set["Parameter"] = None, Signature425: "pcm_pc_qosannotations_pc_SpecifiedQoSAnnotation" = None, Signature: "pcm_pc_seff_pc_ServiceEffectSpecification" = None, Signature434: "pcm_pc_qosannotations_pc_SpecifiedOutputParameterAbstraction" = None):
    ...
    def signatures__OperationInterface(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_repository_pc_OperationSignature__signatures__OperationInterface", None)
    ...
    def pcm_pc_repository_pc_OperationSignature(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "DataType255"):
                opp_val = getattr(old_value, "DataType255", None)
                if opp_val == self:
                    setattr(old_value, "DataType255", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "DataType255"):
                opp_val = getattr(value, "DataType255", None)
                setattr(value, "DataType255", self)
    ...
    def operationSignature__Parameter(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_repository_pc_OperationSignature__operationSignature__Parameter", None)
        self.__operationSignature__Parameter = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "Parameter253"):
                    opp_val = getattr(item, "Parameter253", None)
                    
                    if opp_val == self:
                        setattr(item, "Parameter253", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "Parameter253"):
                    ...
                    setattr(item, "Parameter253", self)
                    

    def ParameterNamesHaveToBeUniqueForASignature(self, pcm_pc_context, pcm_pc_diagnostics) :
...
class pcm_pc_repository_pc_RequiredCharacterisation:
    ...
    def __init__(self, type: str, pcm_pc_repository_pc_RequiredCharacterisation: "Parameter" = None, requiredCharacterisations: "Interface" = None):
        self.type = type
    ...
    def requiredCharacterisations(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_repository_pc_RequiredCharacterisation__requiredCharacterisations", None)
        self.__requiredCharacterisations = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "Interface232"):
                opp_val = getattr(old_value, "Interface232", None)
                if opp_val == self:
                    setattr(old_value, "Interface232", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "Interface232"):
                opp_val = getattr(value, "Interface232", None)
                setattr(value, "Interface232", self)
...
class pcm_pc_reliability_pc_NetworkInducedFailureType(FailureType):
    ...
    def __init__(self, networkInducedFailureType__CommunicationLinkResourceType: "CommunicationLinkResourceType" = None, FailureType: "pcm_pc_repository_pc_Repository" = None, FailureType320: "pcm_pc_reliability_pc_ExternalFailureOccurrenceDescription" = None, FailureType242: "pcm_pc_repository_pc_Signature" = None, FailureType423: "pcm_pc_seff_reliability_pc_FailureHandlingEntity" = None):
    ...
    def networkInducedFailureType__CommunicationLinkResourceType(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_reliability_pc_NetworkInducedFailureType__networkInducedFailureType__CommunicationLinkResourceType", None)
    ...
    def NetworkInducedFailureTypeHasCommunicationLinkResourceType(self, pcm_pc_diagnostics, pcm_pc_context) :
...
class pcm_pc_repository_pc_OperationInterface(Interface):
    ...
    def __init__(self, interface__OperationSignature: set["OperationSignature"] = None, Interface232: "pcm_pc_repository_pc_RequiredCharacterisation" = None, Interface224: "pcm_pc_repository_pc_Interface" = None, Interface: "pcm_pc_repository_pc_Repository" = None):
    ...
    def interface__OperationSignature(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_repository_pc_OperationInterface__interface__OperationSignature", None)
        self.__interface__OperationSignature = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "OperationSignature257"):
                    opp_val = getattr(item, "OperationSignature257", None)
                    
                    if opp_val == self:
                        setattr(item, "OperationSignature257", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "OperationSignature257"):
                    ...
                    setattr(item, "OperationSignature257", self)
                    

    def SignaturesHaveToBeUniqueForAnInterface(self, pcm_pc_context, pcm_pc_diagnostics) :
...
class pcm_pc_repository_pc_PrimitiveDataType(DataType):
    ...
    def __init__(self, type: str, DataType: "pcm_pc_repository_pc_Parameter" = None, DataType274: "pcm_pc_repository_pc_InnerDeclaration" = None, DataType270: "pcm_pc_repository_pc_CollectionDataType" = None, DataType255: "pcm_pc_repository_pc_OperationSignature" = None, DataType222: "pcm_pc_repository_pc_Repository" = None):
        self.type = type
...
class pcm_pc_repository_pc_Parameter:
    ...
    def __init__(self, parameterName: str, modifier__Parameter: str, pcm_pc_repository_pc_Parameter: "DataType" = None, parameter__EventType: "EventType" = None, parameter__ResourceSignature: "ResourceSignature" = None, parameters__InfrastructureSignature: "InfrastructureSignature" = None, parameters__OperationSignature: "OperationSignature" = None):
    ...
    def parameter__ResourceSignature(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_repository_pc_Parameter__parameter__ResourceSignature", None)
    ...
    def parameters__InfrastructureSignature(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_repository_pc_Parameter__parameters__InfrastructureSignature", None)
    ...
    def parameter__EventType(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_repository_pc_Parameter__parameter__EventType", None)
    ...
    def parameters__OperationSignature(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_repository_pc_Parameter__parameters__OperationSignature", None)
        self.__parameters__OperationSignature = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "OperationSignature212"):
                opp_val = getattr(old_value, "OperationSignature212", None)
                if opp_val == self:
                    setattr(old_value, "OperationSignature212", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "OperationSignature212"):
                opp_val = getattr(value, "OperationSignature212", None)
                setattr(value, "OperationSignature212", self)
...
class pcm_pc_repository_pc_BasicComponent(ImplementationComponentType):
    ...
    def basicComponent_ServiceEffectSpecification(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_repository_pc_BasicComponent__basicComponent_ServiceEffectSpecification", None)
    ...
    def basicComponent_PassiveResource(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_repository_pc_BasicComponent__basicComponent_PassiveResource", None)
        self.__basicComponent_PassiveResource = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "PassiveResource202"):
                    opp_val = getattr(item, "PassiveResource202", None)
                    
                    if opp_val == self:
                        setattr(item, "PassiveResource202", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "PassiveResource202"):
                    ...
                    setattr(item, "PassiveResource202", self)
                    

    def ProvideSameInterfacesAsImplementationType(self, pcm_pc_context, pcm_pc_diagnostics) :
        # TODO: Implement ProvideSameInterfacesAsImplementationType method
        pass

    def NoSeffTypeUsedTwice(self, pcm_pc_diagnostics, pcm_pc_context) :
        # TODO: Implement NoSeffTypeUsedTwice method
        pass

    def RequireSameInterfacesAsImplementationType(self, pcm_pc_context, pcm_pc_diagnostics) :
...
class pcm_pc_usagemodel_pc_BranchTransition:
    ...
    def __init__(self, branchProbability: float, branchTransition_ScenarioBehaviour: "ScenarioBehaviour" = None, branchTransitions_Branch: "Branch" = None):
        self.branchProbability = branchProbability
    ...
    def branchTransition_ScenarioBehaviour(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_usagemodel_pc_BranchTransition__branchTransition_ScenarioBehaviour", None)
        self.__branchTransition_ScenarioBehaviour = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "ScenarioBehaviour183"):
                opp_val = getattr(old_value, "ScenarioBehaviour183", None)
                if opp_val == self:
                    setattr(old_value, "ScenarioBehaviour183", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "ScenarioBehaviour183"):
                opp_val = getattr(value, "ScenarioBehaviour183", None)
                setattr(value, "ScenarioBehaviour183", self)
    ...
    def branchTransitions_Branch(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_usagemodel_pc_BranchTransition__branchTransitions_Branch", None)
...
class pcm_pc_usagemodel_pc_Start(AbstractUserAction):
    ...
    def __init__(self, AbstractUserAction180: "pcm_pc_usagemodel_pc_ScenarioBehaviour" = None, AbstractUserAction171: "pcm_pc_usagemodel_pc_AbstractUserAction" = None, AbstractUserAction: "pcm_pc_usagemodel_pc_AbstractUserAction" = None):
        
        pass
    def StartHasNoPredecessor(self, pcm_pc_context, pcm_pc_diagnostics) :
        # TODO: Implement StartHasNoPredecessor method
        pass

class pcm_pc_usagemodel_pc_Branch(AbstractUserAction):

    def __init__(self, branch_BranchTransition: set["BranchTransition"] = None, AbstractUserAction180: "pcm_pc_usagemodel_pc_ScenarioBehaviour" = None, AbstractUserAction171: "pcm_pc_usagemodel_pc_AbstractUserAction" = None, AbstractUserAction: "pcm_pc_usagemodel_pc_AbstractUserAction" = None):
    ...
    def branch_BranchTransition(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_usagemodel_pc_Branch__branch_BranchTransition", None)
        self.__branch_BranchTransition = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "BranchTransition185"):
                    opp_val = getattr(item, "BranchTransition185", None)
                    
                    if opp_val == self:
                        setattr(item, "BranchTransition185", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "BranchTransition185"):
                    ...
                    setattr(item, "BranchTransition185", self)
                    

    def AllBranchProbabilitiesMustSumUpTo1(self, pcm_pc_diagnostics, pcm_pc_context) :
...
class pcm_pc_usagemodel_pc_Stop(AbstractUserAction):
    ...
    def __init__(self, AbstractUserAction180: "pcm_pc_usagemodel_pc_ScenarioBehaviour" = None, AbstractUserAction171: "pcm_pc_usagemodel_pc_AbstractUserAction" = None, AbstractUserAction: "pcm_pc_usagemodel_pc_AbstractUserAction" = None):
        ...
        pass
    def StopHasNoSuccessor(self, pcm_pc_context, pcm_pc_diagnostics) :
        # TODO: Implement StopHasNoSuccessor method
        pass

class pcm_pc_usagemodel_pc_EntryLevelSystemCall(AbstractUserAction):

    def __init__(self, priority: int, pcm_pc_usagemodel_pc_EntryLevelSystemCall: "OperationProvidedRole" = None, pcm_pc_usagemodel_pc_EntryLevelSystemCall164: "OperationSignature" = None, entryLevelSystemCall_OutputParameterUsage: set["VariableUsage"] = None, entryLevelSystemCall_InputParameterUsage: set["VariableUsage"] = None, AbstractUserAction180: "pcm_pc_usagemodel_pc_ScenarioBehaviour" = None, AbstractUserAction171: "pcm_pc_usagemodel_pc_AbstractUserAction" = None, AbstractUserAction: "pcm_pc_usagemodel_pc_AbstractUserAction" = None):
        self.priority = priority
        self.pcm_pc_usagemodel_pc_EntryLevelSystemCall = pcm_pc_usagemodel_pc_EntryLevelSystemCall
        self.pcm_pc_usagemodel_pc_EntryLevelSystemCall164 = pcm_pc_usagemodel_pc_EntryLevelSystemCall164
    ...
    @property
    def pcm_pc_usagemodel_pc_EntryLevelSystemCall164(self):
        return self.__pcm_pc_usagemodel_pc_EntryLevelSystemCall164

    @pcm_pc_usagemodel_pc_EntryLevelSystemCall164.setter
    def pcm_pc_usagemodel_pc_EntryLevelSystemCall164(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_usagemodel_pc_EntryLevelSystemCall__pcm_pc_usagemodel_pc_EntryLevelSystemCall164", None)
        self.__pcm_pc_usagemodel_pc_EntryLevelSystemCall164 = value
    ...
    def pcm_pc_usagemodel_pc_EntryLevelSystemCall(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "OperationProvidedRole162"):
                opp_val = getattr(old_value, "OperationProvidedRole162", None)
                if opp_val == self:
                    setattr(old_value, "OperationProvidedRole162", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "OperationProvidedRole162"):
                opp_val = getattr(value, "OperationProvidedRole162", None)
                setattr(value, "OperationProvidedRole162", self)
    ...
    def entryLevelSystemCall_OutputParameterUsage(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_usagemodel_pc_EntryLevelSystemCall__entryLevelSystemCall_OutputParameterUsage", None)
        self.__entryLevelSystemCall_OutputParameterUsage = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "VariableUsage166"):
                    opp_val = getattr(item, "VariableUsage166", None)
                    
                    if opp_val == self:
                        setattr(item, "VariableUsage166", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "VariableUsage166"):
                    ...
                    setattr(item, "VariableUsage166", self)
    ...
    def entryLevelSystemCall_InputParameterUsage(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_usagemodel_pc_EntryLevelSystemCall__entryLevelSystemCall_InputParameterUsage", None)
    ...
    def EntryLevelSystemCallMustReferenceProvidedRoleOfASystem(self, pcm_pc_context, pcm_pc_diagnostics) :
        # TODO: Implement EntryLevelSystemCallMustReferenceProvidedRoleOfASystem method
        pass

    def EntryLevelSystemCallSignatureMustMatchItsProvidedRole(self, pcm_pc_diagnostics, pcm_pc_context) :
...
class pcm_pc_usagemodel_pc_OpenWorkload(Workload):
    ...
    def __init__(self, openWorkload_PCMRandomVariable: "PCMRandomVariable" = None, Workload: "pcm_pc_usagemodel_pc_UsageScenario" = None):
    ...
    def openWorkload_PCMRandomVariable(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_usagemodel_pc_OpenWorkload__openWorkload_PCMRandomVariable", None)
        self.__openWorkload_PCMRandomVariable = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "PCMRandomVariable191"):
                opp_val = getattr(old_value, "PCMRandomVariable191", None)
                if opp_val == self:
                    setattr(old_value, "PCMRandomVariable191", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "PCMRandomVariable191"):
                opp_val = getattr(value, "PCMRandomVariable191", None)
                setattr(value, "PCMRandomVariable191", self)

    def InterArrivalTimeInOpenWorkloadNeedsToBeSpecified(self, pcm_pc_diagnostics, pcm_pc_context) :
        # TODO: Implement InterArrivalTimeInOpenWorkloadNeedsToBeSpecified method
        pass

class pcm_pc_usagemodel_pc_ClosedWorkload(Workload):

    def __init__(self, population: int, closedWorkload_PCMRandomVariable: "PCMRandomVariable" = None, Workload: "pcm_pc_usagemodel_pc_UsageScenario" = None):
    ...
    def closedWorkload_PCMRandomVariable(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_usagemodel_pc_ClosedWorkload__closedWorkload_PCMRandomVariable", None)
    ...
    def PopulationInClosedWorkloadNeedsToBeSpecified(self, pcm_pc_diagnostics, pcm_pc_context) :
        # TODO: Implement PopulationInClosedWorkloadNeedsToBeSpecified method
        pass

    def ThinkTimeInClosedWorkloadNeedsToBeSpecified(self, pcm_pc_context, pcm_pc_diagnostics) :
...
class pcm_pc_repository_pc_ProvidesComponentType(RepositoryComponent):
    ...
    def __init__(self, RepositoryComponent: "pcm_pc_composition_pc_AssemblyContext" = None, RepositoryComponent218: "pcm_pc_repository_pc_Repository" = None):
        
        pass
    def AtLeastOneInterfaceHasToBeProvidedByAUsefullProvidesComponentType(self, pcm_pc_context, pcm_pc_diagnostics) :
...
class pcm_pc_repository_pc_ImplementationComponentType(RepositoryComponent):
    ...
    def __init__(self, componentType: str, pcm_pc_repository_pc_ImplementationComponentType: set["CompleteComponentType"] = None, pcm_pc_repository_pc_ImplementationComponentType205: set["VariableUsage"] = None, RepositoryComponent: "pcm_pc_composition_pc_AssemblyContext" = None, RepositoryComponent218: "pcm_pc_repository_pc_Repository" = None):
        ...
        self.pcm_pc_repository_pc_ImplementationComponentType205 = pcm_pc_repository_pc_ImplementationComponentType205 if pcm_pc_repository_pc_ImplementationComponentType205 is not None else set()
    ...
    @property
    def pcm_pc_repository_pc_ImplementationComponentType205(self):
        return self.__pcm_pc_repository_pc_ImplementationComponentType205

    @pcm_pc_repository_pc_ImplementationComponentType205.setter
    def pcm_pc_repository_pc_ImplementationComponentType205(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_repository_pc_ImplementationComponentType__pcm_pc_repository_pc_ImplementationComponentType205", None)
        self.__pcm_pc_repository_pc_ImplementationComponentType205 = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "VariableUsage206"):
                    opp_val = getattr(item, "VariableUsage206", None)
                    
                    if opp_val == self:
                        setattr(item, "VariableUsage206", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "VariableUsage206"):
                    ...
                    setattr(item, "VariableUsage206", self)
                    

    def ProvidedInterfaceHaveToConformToComponentType(self, pcm_pc_diagnostics, pcm_pc_context) :
        # TODO: Implement ProvidedInterfaceHaveToConformToComponentType method
        pass

    def RequiredInterfacesHaveToConformToCompleteType(self, pcm_pc_context, pcm_pc_diagnostics) :
        # TODO: Implement RequiredInterfacesHaveToConformToCompleteType method
        pass

    def providedInterfacesHaveToConformToCompleteType(self, pcm_pc_context, pcm_pc_diagnostics) :
...
class pcm_pc_repository_pc_CompleteComponentType(RepositoryComponent):
    ...
    def __init__(self, pcm_pc_repository_pc_CompleteComponentType: set["ProvidesComponentType"] = None, RepositoryComponent: "pcm_pc_composition_pc_AssemblyContext" = None, RepositoryComponent218: "pcm_pc_repository_pc_Repository" = None):
    ...
    def AtLeastOneInterfaceHasToBeProvidedOrRequiredByAUsefullCompleteComponentType(self, pcm_pc_context, pcm_pc_diagnostics) :
        # TODO: Implement AtLeastOneInterfaceHasToBeProvidedOrRequiredByAUsefullCompleteComponentType method
        pass

    def providedInterfacesHaveToConformToProvidedType2(self, pcm_pc_context, pcm_pc_diagnostics) :
...
class pcm_pc_composition_pc_RequiredDelegationConnector(DelegationConnector):
    ...
    def __init__(self, pcm_pc_composition_pc_RequiredDelegationConnector: "OperationRequiredRole" = None, pcm_pc_composition_pc_RequiredDelegationConnector66: "OperationRequiredRole" = None, pcm_pc_composition_pc_RequiredDelegationConnector69: "composition_pc_AssemblyContext" = None):
        self.pcm_pc_composition_pc_RequiredDelegationConnector = pcm_pc_composition_pc_RequiredDelegationConnector
        self.pcm_pc_composition_pc_RequiredDelegationConnector66 = pcm_pc_composition_pc_RequiredDelegationConnector66
        self.pcm_pc_composition_pc_RequiredDelegationConnector69 = pcm_pc_composition_pc_RequiredDelegationConnector69
        
        pass
    @property
    def pcm_pc_composition_pc_RequiredDelegationConnector66(self):
        return self.__pcm_pc_composition_pc_RequiredDelegationConnector66

    @pcm_pc_composition_pc_RequiredDelegationConnector66.setter
    def pcm_pc_composition_pc_RequiredDelegationConnector66(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_composition_pc_RequiredDelegationConnector__pcm_pc_composition_pc_RequiredDelegationConnector66", None)
        self.__pcm_pc_composition_pc_RequiredDelegationConnector66 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "OperationRequiredRole67"):
                opp_val = getattr(old_value, "OperationRequiredRole67", None)
                if opp_val == self:
                    setattr(old_value, "OperationRequiredRole67", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "OperationRequiredRole67"):
                opp_val = getattr(value, "OperationRequiredRole67", None)
                setattr(value, "OperationRequiredRole67", self)
    ...
    @property
    def pcm_pc_composition_pc_RequiredDelegationConnector69(self):
        return self.__pcm_pc_composition_pc_RequiredDelegationConnector69

    @pcm_pc_composition_pc_RequiredDelegationConnector69.setter
    def pcm_pc_composition_pc_RequiredDelegationConnector69(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_composition_pc_RequiredDelegationConnector__pcm_pc_composition_pc_RequiredDelegationConnector69", None)
        self.__pcm_pc_composition_pc_RequiredDelegationConnector69 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "composition_pc_AssemblyContext70"):
                opp_val = getattr(old_value, "composition_pc_AssemblyContext70", None)
                if opp_val == self:
                    setattr(old_value, "composition_pc_AssemblyContext70", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "composition_pc_AssemblyContext70"):
                opp_val = getattr(value, "composition_pc_AssemblyContext70", None)
                setattr(value, "composition_pc_AssemblyContext70", self)

    def ComponentOfAssemblyContextAndInnerRoleRequiringComponentNeedToBeTheSame(self, pcm_pc_diagnostics, pcm_pc_context) :
        # TODO: Implement ComponentOfAssemblyContextAndInnerRoleRequiringComponentNeedToBeTheSame method
        pass

    def RequiredDelegationConnectorandtheconnectedComponentmustbepartofthesamecompositestructure(self, pcm_pc_diagnostics, pcm_pc_context) :
        # TODO: Implement RequiredDelegationConnectorandtheconnectedComponentmustbepartofthesamecompositestructure method
        pass

    def RequiringEntityOfOuterRequiredRoleMustBeTheSameAsTheParentOfTheRequiredDelegationConnector(self, pcm_pc_diagnostics, pcm_pc_context) :
...
class pcm_pc_composition_pc_ProvidedDelegationConnector(DelegationConnector):
    ...
    def __init__(self, pcm_pc_composition_pc_ProvidedDelegationConnector: "OperationProvidedRole" = None, pcm_pc_composition_pc_ProvidedDelegationConnector59: "OperationProvidedRole" = None, pcm_pc_composition_pc_ProvidedDelegationConnector62: "composition_pc_AssemblyContext" = None):
        self.pcm_pc_composition_pc_ProvidedDelegationConnector = pcm_pc_composition_pc_ProvidedDelegationConnector
        self.pcm_pc_composition_pc_ProvidedDelegationConnector59 = pcm_pc_composition_pc_ProvidedDelegationConnector59
        self.pcm_pc_composition_pc_ProvidedDelegationConnector62 = pcm_pc_composition_pc_ProvidedDelegationConnector62
        
        pass
    @property
    def pcm_pc_composition_pc_ProvidedDelegationConnector59(self):
        return self.__pcm_pc_composition_pc_ProvidedDelegationConnector59

    @pcm_pc_composition_pc_ProvidedDelegationConnector59.setter
    def pcm_pc_composition_pc_ProvidedDelegationConnector59(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_composition_pc_ProvidedDelegationConnector__pcm_pc_composition_pc_ProvidedDelegationConnector59", None)
        self.__pcm_pc_composition_pc_ProvidedDelegationConnector59 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "OperationProvidedRole60"):
                opp_val = getattr(old_value, "OperationProvidedRole60", None)
                if opp_val == self:
                    setattr(old_value, "OperationProvidedRole60", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "OperationProvidedRole60"):
                opp_val = getattr(value, "OperationProvidedRole60", None)
                setattr(value, "OperationProvidedRole60", self)
    ...
    @property
    def pcm_pc_composition_pc_ProvidedDelegationConnector62(self):
        return self.__pcm_pc_composition_pc_ProvidedDelegationConnector62

    @pcm_pc_composition_pc_ProvidedDelegationConnector62.setter
    def pcm_pc_composition_pc_ProvidedDelegationConnector62(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_composition_pc_ProvidedDelegationConnector__pcm_pc_composition_pc_ProvidedDelegationConnector62", None)
        self.__pcm_pc_composition_pc_ProvidedDelegationConnector62 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "composition_pc_AssemblyContext63"):
                opp_val = getattr(old_value, "composition_pc_AssemblyContext63", None)
                if opp_val == self:
                    setattr(old_value, "composition_pc_AssemblyContext63", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "composition_pc_AssemblyContext63"):
                opp_val = getattr(value, "composition_pc_AssemblyContext63", None)
                setattr(value, "composition_pc_AssemblyContext63", self)

    def ProvidedDelegationConnectorandtheconnectedComponentmustbepartofthesamecompositestructure(self, pcm_pc_diagnostics, pcm_pc_context) :
        # TODO: Implement ProvidedDelegationConnectorandtheconnectedComponentmustbepartofthesamecompositestructure method
        pass

    def ComponentOfAssemblyContextAndInnerRoleProvidingComponentNeedToBeTheSame(self, pcm_pc_diagnostics, pcm_pc_context) :
...
class pcm_pc_reliability_pc_ExternalFailureOccurrenceDescription(FailureOccurrenceDescription):
    ...
    def __init__(self, externalFailureOccurrenceDescriptions__SpecifiedReliabilityAnnotation: "qos_reliability_pc_SpecifiedReliabilityAnnotation" = None, pcm_pc_reliability_pc_ExternalFailureOccurrenceDescription: "FailureType" = None):
    ...
    def pcm_pc_reliability_pc_ExternalFailureOccurrenceDescription(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "FailureType320"):
                opp_val = getattr(old_value, "FailureType320", None)
                if opp_val == self:
                    setattr(old_value, "FailureType320", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "FailureType320"):
                opp_val = getattr(value, "FailureType320", None)
                setattr(value, "FailureType320", self)
    ...
    def externalFailureOccurrenceDescriptions__SpecifiedReliabilityAnnotation(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_reliability_pc_ExternalFailureOccurrenceDescription__externalFailureOccurrenceDescriptions__SpecifiedReliabilityAnnotation", None)
    ...
    def NoResourceTimeoutFailureAllowedForExternalFailureOccurrenceDescription(self, pcm_pc_context, pcm_pc_diagnostics) :
...
class pcm_pc_reliability_pc_InternalFailureOccurrenceDescription(FailureOccurrenceDescription):
    ...
    def internalFailureOccurrenceDescriptions__SoftwareInducedFailureType(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_reliability_pc_InternalFailureOccurrenceDescription__internalFailureOccurrenceDescriptions__SoftwareInducedFailureType", None)
    ...
    def internalFailureOccurrenceDescriptions__InternalAction(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_reliability_pc_InternalFailureOccurrenceDescription__internalFailureOccurrenceDescriptions__InternalAction", None)
    ...
    def NoResourceTimeoutFailureAllowedForInternalFailureOccurrenceDescription(self, pcm_pc_diagnostics, pcm_pc_context) :
...
class pcm_pc_reliability_pc_HardwareInducedFailureType(FailureType):
    ...
    def __init__(self, hardwareInducedFailureType__ProcessingResourceType: "ProcessingResourceType" = None, FailureType: "pcm_pc_repository_pc_Repository" = None, FailureType320: "pcm_pc_reliability_pc_ExternalFailureOccurrenceDescription" = None, FailureType242: "pcm_pc_repository_pc_Signature" = None, FailureType423: "pcm_pc_seff_reliability_pc_FailureHandlingEntity" = None):
    ...
    def hardwareInducedFailureType__ProcessingResourceType(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_reliability_pc_HardwareInducedFailureType__hardwareInducedFailureType__ProcessingResourceType", None)
    ...
    def HardwareInducedFailureTypeHasProcessingResourceType(self, pcm_pc_context, pcm_pc_diagnostics) :
...
class pcm_pc_reliability_pc_FailureOccurrenceDescription:
    ...
    def EnsureValidFailureProbabilityRange(self, pcm_pc_context, pcm_pc_diagnostics) :
...
class pcm_pc_entity_pc_ComposedProvidingRequiringEntity(composition_pc_ComposedStructure, entity_pc_InterfaceProvidingRequiringEntity):
    ...
    def __init__(self, ComposedStructure38: "pcm_pc_composition_pc_ResourceRequiredDelegationConnector" = None, ComposedStructure145: "pcm_pc_composition_pc_AssemblyContext" = None, ComposedStructure: "pcm_pc_composition_pc_Connector" = None, ComposedStructure44: "pcm_pc_composition_pc_EventChannel" = None):
        
        pass
    def ProvidedRolesMustBeBound(self, pcm_pc_context, pcm_pc_diagnostics) :
...
class pcm_pc_composition_pc_AssemblyConnector(Connector):
    ...
    def __init__(self, pcm_pc_composition_pc_AssemblyConnector: "composition_pc_AssemblyContext" = None, pcm_pc_composition_pc_AssemblyConnector74: "composition_pc_AssemblyContext" = None, pcm_pc_composition_pc_AssemblyConnector77: "OperationProvidedRole" = None, pcm_pc_composition_pc_AssemblyConnector80: "OperationRequiredRole" = None):
        self.pcm_pc_composition_pc_AssemblyConnector = pcm_pc_composition_pc_AssemblyConnector
        self.pcm_pc_composition_pc_AssemblyConnector74 = pcm_pc_composition_pc_AssemblyConnector74
        self.pcm_pc_composition_pc_AssemblyConnector77 = pcm_pc_composition_pc_AssemblyConnector77
        self.pcm_pc_composition_pc_AssemblyConnector80 = pcm_pc_composition_pc_AssemblyConnector80
        
        pass
    @property
    def pcm_pc_composition_pc_AssemblyConnector80(self):
        return self.__pcm_pc_composition_pc_AssemblyConnector80

    @pcm_pc_composition_pc_AssemblyConnector80.setter
    def pcm_pc_composition_pc_AssemblyConnector80(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_composition_pc_AssemblyConnector__pcm_pc_composition_pc_AssemblyConnector80", None)
        self.__pcm_pc_composition_pc_AssemblyConnector80 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "OperationRequiredRole81"):
                opp_val = getattr(old_value, "OperationRequiredRole81", None)
                if opp_val == self:
                    setattr(old_value, "OperationRequiredRole81", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "OperationRequiredRole81"):
                opp_val = getattr(value, "OperationRequiredRole81", None)
                setattr(value, "OperationRequiredRole81", self)

    @property
    def pcm_pc_composition_pc_AssemblyConnector77(self):
        return self.__pcm_pc_composition_pc_AssemblyConnector77

    @pcm_pc_composition_pc_AssemblyConnector77.setter
    def pcm_pc_composition_pc_AssemblyConnector77(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_composition_pc_AssemblyConnector__pcm_pc_composition_pc_AssemblyConnector77", None)
        self.__pcm_pc_composition_pc_AssemblyConnector77 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "OperationProvidedRole78"):
                opp_val = getattr(old_value, "OperationProvidedRole78", None)
                if opp_val == self:
                    setattr(old_value, "OperationProvidedRole78", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "OperationProvidedRole78"):
                opp_val = getattr(value, "OperationProvidedRole78", None)
                setattr(value, "OperationProvidedRole78", self)

    @property
    def pcm_pc_composition_pc_AssemblyConnector74(self):
        return self.__pcm_pc_composition_pc_AssemblyConnector74

    @pcm_pc_composition_pc_AssemblyConnector74.setter
    def pcm_pc_composition_pc_AssemblyConnector74(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_composition_pc_AssemblyConnector__pcm_pc_composition_pc_AssemblyConnector74", None)
        self.__pcm_pc_composition_pc_AssemblyConnector74 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "composition_pc_AssemblyContext75"):
                opp_val = getattr(old_value, "composition_pc_AssemblyContext75", None)
                if opp_val == self:
                    setattr(old_value, "composition_pc_AssemblyContext75", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "composition_pc_AssemblyContext75"):
                opp_val = getattr(value, "composition_pc_AssemblyContext75", None)
                setattr(value, "composition_pc_AssemblyContext75", self)
    ...
    def pcm_pc_composition_pc_AssemblyConnector(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "composition_pc_AssemblyContext72"):
                opp_val = getattr(old_value, "composition_pc_AssemblyContext72", None)
                if opp_val == self:
                    setattr(old_value, "composition_pc_AssemblyContext72", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "composition_pc_AssemblyContext72"):
                opp_val = getattr(value, "composition_pc_AssemblyContext72", None)
                setattr(value, "composition_pc_AssemblyContext72", self)

    def AssemblyConnectorsReferencedInterfacesMustMatch(self, pcm_pc_context, pcm_pc_diagnostics) :
        # TODO: Implement AssemblyConnectorsReferencedInterfacesMustMatch method
        pass

    def AssemblyConnectorsReferencedProvidedRolesAndChildContextMustMatch(self, pcm_pc_context, pcm_pc_diagnostics) :
        # TODO: Implement AssemblyConnectorsReferencedProvidedRolesAndChildContextMustMatch method
        pass

    def AssemblyConnectorsReferencedRequiredRoleAndChildContextMustMatch(self, pcm_pc_diagnostics, pcm_pc_context) :
...
class pcm_pc_resourceenvironment_pc_CommunicationLinkResourceSpecification(Identifier):
    ...
    def __init__(self, failureProbability: float, pcm_pc_resourceenvironment_pc_CommunicationLinkResourceSpecification: "CommunicationLinkResourceType" = None, communicationLinkResourceSpecification_latency_PCMRandomVariable: "PCMRandomVariable" = None, communicationLinkResourceSpecifcation_throughput_PCMRandomVariable: "PCMRandomVariable" = None, communicationLinkResourceSpecifications_LinkingResource: "LinkingResource" = None):
        self.failureProbability = failureProbability
    ...
    def communicationLinkResourceSpecifications_LinkingResource(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_resourceenvironment_pc_CommunicationLinkResourceSpecification__communicationLinkResourceSpecifications_LinkingResource", None)
        self.__communicationLinkResourceSpecifications_LinkingResource = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "LinkingResource474"):
                opp_val = getattr(old_value, "LinkingResource474", None)
                if opp_val == self:
                    setattr(old_value, "LinkingResource474", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "LinkingResource474"):
                opp_val = getattr(value, "LinkingResource474", None)
                setattr(value, "LinkingResource474", self)
    ...
    def communicationLinkResourceSpecifcation_throughput_PCMRandomVariable(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_resourceenvironment_pc_CommunicationLinkResourceSpecification__communicationLinkResourceSpecifcation_throughput_PCMRandomVariable", None)
    ...
    def pcm_pc_resourceenvironment_pc_CommunicationLinkResourceSpecification(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "CommunicationLinkResourceType476"):
                opp_val = getattr(old_value, "CommunicationLinkResourceType476", None)
                if opp_val == self:
                    setattr(old_value, "CommunicationLinkResourceType476", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "CommunicationLinkResourceType476"):
                opp_val = getattr(value, "CommunicationLinkResourceType476", None)
                setattr(value, "CommunicationLinkResourceType476", self)
    ...
    def communicationLinkResourceSpecification_latency_PCMRandomVariable(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_resourceenvironment_pc_CommunicationLinkResourceSpecification__communicationLinkResourceSpecification_latency_PCMRandomVariable", None)
        self.__communicationLinkResourceSpecification_latency_PCMRandomVariable = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "PCMRandomVariable478"):
                opp_val = getattr(old_value, "PCMRandomVariable478", None)
                if opp_val == self:
                    setattr(old_value, "PCMRandomVariable478", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "PCMRandomVariable478"):
                opp_val = getattr(value, "PCMRandomVariable478", None)
                setattr(value, "PCMRandomVariable478", self)

class pcm_pc_resourceenvironment_pc_ProcessingResourceSpecification(Identifier):

    def __init__(self, MTTR: float, MTTF: float, requiredByContainer: bool, numberOfReplicas: int, pcm_pc_resourceenvironment_pc_ProcessingResourceSpecification467: "ProcessingResourceType" = None, pcm_pc_resourceenvironment_pc_ProcessingResourceSpecification: "SchedulingPolicy" = None, processingResourceSpecification_processingRate_PCMRandomVariable: "PCMRandomVariable" = None, activeResourceSpecifications_ResourceContainer: "ResourceContainer" = None):
        self.MTTR = MTTR
        self.MTTF = MTTF
        self.requiredByContainer = requiredByContainer
        self.numberOfReplicas = numberOfReplicas
        self.pcm_pc_resourceenvironment_pc_ProcessingResourceSpecification467 = pcm_pc_resourceenvironment_pc_ProcessingResourceSpecification467
    ...
    def activeResourceSpecifications_ResourceContainer(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_resourceenvironment_pc_ProcessingResourceSpecification__activeResourceSpecifications_ResourceContainer", None)
        self.__activeResourceSpecifications_ResourceContainer = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "ResourceContainer472"):
                opp_val = getattr(old_value, "ResourceContainer472", None)
                if opp_val == self:
                    setattr(old_value, "ResourceContainer472", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "ResourceContainer472"):
                opp_val = getattr(value, "ResourceContainer472", None)
                setattr(value, "ResourceContainer472", self)
    ...
    def pcm_pc_resourceenvironment_pc_ProcessingResourceSpecification(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "SchedulingPolicy465"):
                opp_val = getattr(old_value, "SchedulingPolicy465", None)
                if opp_val == self:
                    setattr(old_value, "SchedulingPolicy465", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "SchedulingPolicy465"):
                opp_val = getattr(value, "SchedulingPolicy465", None)
                setattr(value, "SchedulingPolicy465", self)
    ...
    def processingResourceSpecification_processingRate_PCMRandomVariable(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_resourceenvironment_pc_ProcessingResourceSpecification__processingResourceSpecification_processingRate_PCMRandomVariable", None)
        self.__processingResourceSpecification_processingRate_PCMRandomVariable = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "PCMRandomVariable470"):
                opp_val = getattr(old_value, "PCMRandomVariable470", None)
                if opp_val == self:
                    setattr(old_value, "PCMRandomVariable470", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "PCMRandomVariable470"):
                opp_val = getattr(value, "PCMRandomVariable470", None)
                setattr(value, "PCMRandomVariable470", self)

    @property
    def pcm_pc_resourceenvironment_pc_ProcessingResourceSpecification467(self):
        return self.__pcm_pc_resourceenvironment_pc_ProcessingResourceSpecification467

    @pcm_pc_resourceenvironment_pc_ProcessingResourceSpecification467.setter
    def pcm_pc_resourceenvironment_pc_ProcessingResourceSpecification467(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_resourceenvironment_pc_ProcessingResourceSpecification__pcm_pc_resourceenvironment_pc_ProcessingResourceSpecification467", None)
        self.__pcm_pc_resourceenvironment_pc_ProcessingResourceSpecification467 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "ProcessingResourceType468"):
                opp_val = getattr(old_value, "ProcessingResourceType468", None)
                if opp_val == self:
                    setattr(old_value, "ProcessingResourceType468", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "ProcessingResourceType468"):
                opp_val = getattr(value, "ProcessingResourceType468", None)
                setattr(value, "ProcessingResourceType468", self)

class pcm_pc_seff_pc_ResourceDemandingSEFF(seff_pc_ResourceDemandingBehaviour, Identifier, seff_pc_ServiceEffectSpecification):

    pass
class pcm_pc_seff_pc_ResourceDemandingBehaviour(Identifier):

    def __init__(self, bodyBehaviour_Loop336: "AbstractLoopAction" = None, branchBehaviour_BranchTransition: "AbstractBranchTransition" = None, resourceDemandingBehaviour_AbstractAction: set["AbstractAction"] = None):
        self.bodyBehaviour_Loop336 = bodyBehaviour_Loop336
        ...
        pass
    @property
    def bodyBehaviour_Loop336(self):
        return self.__bodyBehaviour_Loop336

    @bodyBehaviour_Loop336.setter
    def bodyBehaviour_Loop336(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_seff_pc_ResourceDemandingBehaviour__bodyBehaviour_Loop336", None)
        self.__bodyBehaviour_Loop336 = value
    ...
    def branchBehaviour_BranchTransition(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_seff_pc_ResourceDemandingBehaviour__branchBehaviour_BranchTransition", None)
    ...
    def resourceDemandingBehaviour_AbstractAction(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_seff_pc_ResourceDemandingBehaviour__resourceDemandingBehaviour_AbstractAction", None)
        self.__resourceDemandingBehaviour_AbstractAction = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "AbstractAction339"):
                    opp_val = getattr(item, "AbstractAction339", None)
                    
                    if opp_val == self:
                        setattr(item, "AbstractAction339", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "AbstractAction339"):
                    ...
                    setattr(item, "AbstractAction339", self)
                    

    def ExactlyOneStopAction(self, pcm_pc_diagnostics, pcm_pc_context) :
        # TODO: Implement ExactlyOneStopAction method
        pass

    def ExactlyOneStartAction(self, pcm_pc_diagnostics, pcm_pc_context) :
        # TODO: Implement ExactlyOneStartAction method
        pass

    def EachActionExceptStartActionandStopActionMustHhaveAPredecessorAndSuccessor(self, pcm_pc_context, pcm_pc_diagnostics) :
...
class entity_pc_Entity:
    ...
    pass
class pcm_pc_repository_pc_CollectionDataType(entity_pc_Entity, repository_pc_DataType):

    pass
class pcm_pc_system_pc_System(entity_pc_Entity, entity_pc_ComposedProvidingRequiringEntity):
    ...
    def system_QoSAnnotations(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_system_pc_System__system_QoSAnnotations", None)
        self.__system_QoSAnnotations = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "QoSAnnotations448"):
                    opp_val = getattr(item, "QoSAnnotations448", None)
                    
                    if opp_val == self:
                        setattr(item, "QoSAnnotations448", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "QoSAnnotations448"):
                    ...
                    setattr(item, "QoSAnnotations448", self)
                    

    def SystemMustHaveAtLeastOneProvidedRole(self, pcm_pc_context, pcm_pc_diagnostics) :
...
class pcm_pc_composition_pc_ComposedStructure(Entity):
    ...
    def __init__(self, parentStructure__AssemblyContext: set["composition_pc_AssemblyContext"] = None, parentStructure_ResourceRequiredDelegationConnector: set["composition_pc_ResourceRequiredDelegationConnector"] = None, parentStructure__EventChannel: set["composition_pc_EventChannel"] = None, parentStructure__Connector: set["composition_pc_Connector"] = None):
    ...
    def parentStructure__EventChannel(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_composition_pc_ComposedStructure__parentStructure__EventChannel", None)
    ...
    def parentStructure__Connector(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_composition_pc_ComposedStructure__parentStructure__Connector", None)
    ...
    def parentStructure__AssemblyContext(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_composition_pc_ComposedStructure__parentStructure__AssemblyContext", None)
    ...
    def parentStructure_ResourceRequiredDelegationConnector(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_composition_pc_ComposedStructure__parentStructure_ResourceRequiredDelegationConnector", None)
    ...
    def MultipleConnectorsConstraint(self, pcm_pc_context, pcm_pc_diagnostics) :
        # TODO: Implement MultipleConnectorsConstraint method
        pass

    def MultipleConnectorsConstraintForAssemblyConnectors(self, pcm_pc_context, pcm_pc_diagnostics) :
...
class pcm_pc_qosannotations_pc_QoSAnnotations(Entity):
    ...
    def qosAnnotations_System(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_qosannotations_pc_QoSAnnotations__qosAnnotations_System", None)
    ...
    def qosAnnotations_SpecifiedQoSAnnotation(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_qosannotations_pc_QoSAnnotations__qosAnnotations_SpecifiedQoSAnnotation", None)
    ...
    def qosAnnotations_SpecifiedOutputParameterAbstraction(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_qosannotations_pc_QoSAnnotations__qosAnnotations_SpecifiedOutputParameterAbstraction", None)
        self.__qosAnnotations_SpecifiedOutputParameterAbstraction = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "SpecifiedOutputParameterAbstraction430"):
                    opp_val = getattr(item, "SpecifiedOutputParameterAbstraction430", None)
                    
                    if opp_val == self:
                        setattr(item, "SpecifiedOutputParameterAbstraction430", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "SpecifiedOutputParameterAbstraction430"):
                    ...
                    setattr(item, "SpecifiedOutputParameterAbstraction430", self)
                    

    def MultipleReliabilityAnnotationsPerExternalCallNotAllowed(self, pcm_pc_diagnostics, pcm_pc_context) :
...
class pcm_pc_repository_pc_Interface(Entity):
    ...
    def __init__(self, pcm_pc_repository_pc_Interface226: set["Protocol"] = None, interface_RequiredCharacterisation: set["RequiredCharacterisation"] = None, interfaces__Repository: "Repository" = None, pcm_pc_repository_pc_Interface: set["Interface"] = None):
        self.pcm_pc_repository_pc_Interface226 = pcm_pc_repository_pc_Interface226 if pcm_pc_repository_pc_Interface226 is not None else set()
    ...
    def interfaces__Repository(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_repository_pc_Interface__interfaces__Repository", None)
        self.__interfaces__Repository = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "Repository229"):
                opp_val = getattr(old_value, "Repository229", None)
                if opp_val == self:
                    setattr(old_value, "Repository229", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "Repository229"):
                opp_val = getattr(value, "Repository229", None)
                setattr(value, "Repository229", self)
    ...
    def interface_RequiredCharacterisation(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_repository_pc_Interface__interface_RequiredCharacterisation", None)
    ...
    def pcm_pc_repository_pc_Interface(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "Interface224"):
                    opp_val = getattr(item, "Interface224", None)
                    
                    if opp_val == self:
                        setattr(item, "Interface224", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "Interface224"):
                    ...
                    setattr(item, "Interface224", self)
                    

    @property
    def pcm_pc_repository_pc_Interface226(self):
        return self.__pcm_pc_repository_pc_Interface226

    @pcm_pc_repository_pc_Interface226.setter
    def pcm_pc_repository_pc_Interface226(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_repository_pc_Interface__pcm_pc_repository_pc_Interface226", None)
        self.__pcm_pc_repository_pc_Interface226 = value if value is not None else set()
    ...
    def NoProtocolTypeIDUsedTwice(self, pcm_pc_diagnostics, pcm_pc_context) :
...
class pcm_pc_allocation_pc_Allocation(Entity):
    ...
    def __init__(self, pcm_pc_allocation_pc_Allocation: "ResourceEnvironment" = None, pcm_pc_allocation_pc_Allocation492: "System" = None, allocation_AllocationContext: set["AllocationContext"] = None):
        self.pcm_pc_allocation_pc_Allocation = pcm_pc_allocation_pc_Allocation
        self.pcm_pc_allocation_pc_Allocation492 = pcm_pc_allocation_pc_Allocation492
    ...
    def allocation_AllocationContext(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_allocation_pc_Allocation__allocation_AllocationContext", None)
    ...
    def pcm_pc_allocation_pc_Allocation(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "ResourceEnvironment490"):
                opp_val = getattr(old_value, "ResourceEnvironment490", None)
                if opp_val == self:
                    setattr(old_value, "ResourceEnvironment490", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "ResourceEnvironment490"):
                opp_val = getattr(value, "ResourceEnvironment490", None)
                setattr(value, "ResourceEnvironment490", self)

    @property
    def pcm_pc_allocation_pc_Allocation492(self):
        return self.__pcm_pc_allocation_pc_Allocation492

    @pcm_pc_allocation_pc_Allocation492.setter
    def pcm_pc_allocation_pc_Allocation492(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_allocation_pc_Allocation__pcm_pc_allocation_pc_Allocation492", None)
        self.__pcm_pc_allocation_pc_Allocation492 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "System493"):
                opp_val = getattr(old_value, "System493", None)
                if opp_val == self:
                    setattr(old_value, "System493", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "System493"):
                opp_val = getattr(value, "System493", None)
                setattr(value, "System493", self)

    def CommunicatingServersHaveToBeConnectedByLinkingResource(self, pcm_pc_context, pcm_pc_diagnostics) :
        # TODO: Implement CommunicatingServersHaveToBeConnectedByLinkingResource method
        pass

    def EachAssemblyContextWithinSystemHasToBeAllocatedExactlyOnce(self, pcm_pc_context, pcm_pc_diagnostics) :
...
class pcm_pc_allocation_pc_AllocationContext(Entity):
    ...
    def __init__(self, pcm_pc_allocation_pc_AllocationContext: "ResourceContainer" = None, pcm_pc_allocation_pc_AllocationContext484: "composition_pc_AssemblyContext" = None, allocationContexts_Allocation: "Allocation" = None, pcm_pc_allocation_pc_AllocationContext488: "composition_pc_EventChannel" = None):
        self.pcm_pc_allocation_pc_AllocationContext = pcm_pc_allocation_pc_AllocationContext
        self.pcm_pc_allocation_pc_AllocationContext484 = pcm_pc_allocation_pc_AllocationContext484
        self.allocationContexts_Allocation = allocationContexts_Allocation
        self.pcm_pc_allocation_pc_AllocationContext488 = pcm_pc_allocation_pc_AllocationContext488
    ...
    @property
    def pcm_pc_allocation_pc_AllocationContext488(self):
        return self.__pcm_pc_allocation_pc_AllocationContext488

    @pcm_pc_allocation_pc_AllocationContext488.setter
    def pcm_pc_allocation_pc_AllocationContext488(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_allocation_pc_AllocationContext__pcm_pc_allocation_pc_AllocationContext488", None)
        self.__pcm_pc_allocation_pc_AllocationContext488 = value
    ...
    def allocationContexts_Allocation(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_allocation_pc_AllocationContext__allocationContexts_Allocation", None)
    ...
    @property
    def pcm_pc_allocation_pc_AllocationContext484(self):
        return self.__pcm_pc_allocation_pc_AllocationContext484

    @pcm_pc_allocation_pc_AllocationContext484.setter
    def pcm_pc_allocation_pc_AllocationContext484(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_allocation_pc_AllocationContext__pcm_pc_allocation_pc_AllocationContext484", None)
        self.__pcm_pc_allocation_pc_AllocationContext484 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "composition_pc_AssemblyContext485"):
                opp_val = getattr(old_value, "composition_pc_AssemblyContext485", None)
                if opp_val == self:
                    setattr(old_value, "composition_pc_AssemblyContext485", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "composition_pc_AssemblyContext485"):
                opp_val = getattr(value, "composition_pc_AssemblyContext485", None)
                setattr(value, "composition_pc_AssemblyContext485", self)

    def OneAssemblyContextOrOneEventChannelShouldBeReferred(self, pcm_pc_diagnostics, pcm_pc_context) :
...
class pcm_pc_resourcetype_pc_ResourceSignature(Entity):
    ...
    def resourceSignatures__ResourceInterface(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_resourcetype_pc_ResourceSignature__resourceSignatures__ResourceInterface", None)
        self.__resourceSignatures__ResourceInterface = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "ResourceInterface280"):
                opp_val = getattr(old_value, "ResourceInterface280", None)
                if opp_val == self:
                    setattr(old_value, "ResourceInterface280", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "ResourceInterface280"):
                opp_val = getattr(value, "ResourceInterface280", None)
                setattr(value, "ResourceInterface280", self)
    ...
    def resourceSignature__Parameter(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_resourcetype_pc_ResourceSignature__resourceSignature__Parameter", None)
        self.__resourceSignature__Parameter = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "Parameter278"):
                opp_val = getattr(old_value, "Parameter278", None)
                if opp_val == self:
                    setattr(old_value, "Parameter278", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "Parameter278"):
                opp_val = getattr(value, "Parameter278", None)
                setattr(value, "Parameter278", self)
...
class pcm_pc_repository_pc_Repository(Entity):
    ...
    def repository__RepositoryComponent(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_repository_pc_Repository__repository__RepositoryComponent", None)
        self.__repository__RepositoryComponent = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "RepositoryComponent218"):
                    opp_val = getattr(item, "RepositoryComponent218", None)
                    
                    if opp_val == self:
                        setattr(item, "RepositoryComponent218", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "RepositoryComponent218"):
                    ...
                    setattr(item, "RepositoryComponent218", self)
    ...
    def repository__FailureType(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_repository_pc_Repository__repository__FailureType", None)
    ...
    def repository__Interface(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_repository_pc_Repository__repository__Interface", None)
    ...
    def repository__DataType(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_repository_pc_Repository__repository__DataType", None)
        self.__repository__DataType = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "DataType222"):
                    opp_val = getattr(item, "DataType222", None)
                    
                    if opp_val == self:
                        setattr(item, "DataType222", None)
...
class pcm_pc_usagemodel_pc_ScenarioBehaviour(Entity):
    ...
    def scenarioBehaviour_UsageScenario(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_usagemodel_pc_ScenarioBehaviour__scenarioBehaviour_UsageScenario", None)
        self.__scenarioBehaviour_UsageScenario = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "UsageScenario175"):
                opp_val = getattr(old_value, "UsageScenario175", None)
                if opp_val == self:
                    setattr(old_value, "UsageScenario175", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "UsageScenario175"):
                opp_val = getattr(value, "UsageScenario175", None)
                setattr(value, "UsageScenario175", self)
    ...
    def branchedBehaviour_BranchTransition(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_usagemodel_pc_ScenarioBehaviour__branchedBehaviour_BranchTransition", None)
    ...
    def scenarioBehaviour_AbstractUserAction(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_usagemodel_pc_ScenarioBehaviour__scenarioBehaviour_AbstractUserAction", None)
        self.__scenarioBehaviour_AbstractUserAction = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "AbstractUserAction180"):
                    opp_val = getattr(item, "AbstractUserAction180", None)
                    
                    if opp_val == self:
                        setattr(item, "AbstractUserAction180", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "AbstractUserAction180"):
                    ...
                    setattr(item, "AbstractUserAction180", self)
    ...
    def bodyBehaviour_Loop(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_usagemodel_pc_ScenarioBehaviour__bodyBehaviour_Loop", None)
        self.__bodyBehaviour_Loop = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "Loop178"):
                opp_val = getattr(old_value, "Loop178", None)
                if opp_val == self:
                    setattr(old_value, "Loop178", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "Loop178"):
                opp_val = getattr(value, "Loop178", None)
                setattr(value, "Loop178", self)

    def Exactlyonestart(self, pcm_pc_context, pcm_pc_diagnostics) :
        # TODO: Implement Exactlyonestart method
        pass

    def EachuseractionexceptStartandStopmusthaveapredecessorandsuccessor(self, pcm_pc_diagnostics, pcm_pc_context) :
        # TODO: Implement EachuseractionexceptStartandStopmusthaveapredecessorandsuccessor method
        pass

    def Exactlyonestop(self, pcm_pc_context, pcm_pc_diagnostics) :
...
class entity_pc_ResourceInterfaceProvidingEntity:
    ...
    pass
class pcm_pc_resourcetype_pc_ResourceType(entity_pc_Entity, entity_pc_ResourceInterfaceProvidingEntity, UnitCarryingElement):
...
class pcm_pc_core_pc_PCMRandomVariable(RandomVariable):
    ...
    def __init__(self, timeSpecification_Delay: "Delay" = None, capacity_PassiveResource: "PassiveResource" = None, specification_VariableCharacterisation: "VariableCharacterisation" = None, numberOfCalls__InfrastructureCall: "seff_performance_pc_InfrastructureCall" = None, numberOfCalls__ResourceCall: "seff_performance_pc_ResourceCall" = None, specification_ParametericResourceDemand: "seff_performance_pc_ParametricResourceDemand" = None, iterationCount_LoopAction: "LoopAction" = None, branchCondition_GuardedBranchTransition: "GuardedBranchTransition" = None, specification_SpecifiedExecutionTime: "qos_performance_pc_SpecifiedExecutionTime" = None, filterCondition__EventChannelSinkConnector: "composition_pc_EventChannelSinkConnector" = None, thinkTime_ClosedWorkload: "ClosedWorkload" = None, throughput_CommunicationLinkResourceSpecification: "CommunicationLinkResourceSpecification" = None, processingRate_ProcessingResourceSpecification: "ProcessingResourceSpecification" = None, latency_CommunicationLinkResourceSpecification: "CommunicationLinkResourceSpecification" = None, filterCondition__AssemblyEventConnector: "composition_pc_AssemblyEventConnector" = None, loopIteration_Loop: "Loop" = None, interArrivalTime_OpenWorkload: "OpenWorkload" = None):
    ...
    def latency_CommunicationLinkResourceSpecification(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_core_pc_PCMRandomVariable__latency_CommunicationLinkResourceSpecification", None)
        self.__latency_CommunicationLinkResourceSpecification = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "CommunicationLinkResourceSpecification18"):
                opp_val = getattr(old_value, "CommunicationLinkResourceSpecification18", None)
                if opp_val == self:
                    setattr(old_value, "CommunicationLinkResourceSpecification18", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "CommunicationLinkResourceSpecification18"):
                opp_val = getattr(value, "CommunicationLinkResourceSpecification18", None)
                setattr(value, "CommunicationLinkResourceSpecification18", self)
    ...
    def specification_ParametericResourceDemand(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_core_pc_PCMRandomVariable__specification_ParametericResourceDemand", None)
    ...
    def numberOfCalls__ResourceCall(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_core_pc_PCMRandomVariable__numberOfCalls__ResourceCall", None)
    ...
    def throughput_CommunicationLinkResourceSpecification(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_core_pc_PCMRandomVariable__throughput_CommunicationLinkResourceSpecification", None)
    ...
    def thinkTime_ClosedWorkload(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_core_pc_PCMRandomVariable__thinkTime_ClosedWorkload", None)
    ...
    def capacity_PassiveResource(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_core_pc_PCMRandomVariable__capacity_PassiveResource", None)
    ...
    def processingRate_ProcessingResourceSpecification(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_core_pc_PCMRandomVariable__processingRate_ProcessingResourceSpecification", None)
    ...
    def branchCondition_GuardedBranchTransition(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_core_pc_PCMRandomVariable__branchCondition_GuardedBranchTransition", None)
    ...
    def filterCondition__AssemblyEventConnector(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_core_pc_PCMRandomVariable__filterCondition__AssemblyEventConnector", None)
    ...
    def specification_SpecifiedExecutionTime(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_core_pc_PCMRandomVariable__specification_SpecifiedExecutionTime", None)
    ...
    def specification_VariableCharacterisation(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_core_pc_PCMRandomVariable__specification_VariableCharacterisation", None)
    ...
    def interArrivalTime_OpenWorkload(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_core_pc_PCMRandomVariable__interArrivalTime_OpenWorkload", None)
    ...
    def filterCondition__EventChannelSinkConnector(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_core_pc_PCMRandomVariable__filterCondition__EventChannelSinkConnector", None)
    ...
    def numberOfCalls__InfrastructureCall(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_core_pc_PCMRandomVariable__numberOfCalls__InfrastructureCall", None)
    ...
    def timeSpecification_Delay(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_core_pc_PCMRandomVariable__timeSpecification_Delay", None)
    ...
    def loopIteration_Loop(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_core_pc_PCMRandomVariable__loopIteration_Loop", None)
    ...
    def iterationCount_LoopAction(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_pcm_pc_core_pc_PCMRandomVariable__iterationCount_LoopAction", None)
    ...
    def SpecificationMustNotBeNULL(self, pcm_pc_diagnostics, pcm_pc_context) :
