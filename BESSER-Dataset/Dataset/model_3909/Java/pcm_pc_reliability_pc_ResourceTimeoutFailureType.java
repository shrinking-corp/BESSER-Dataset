...
public class pcm_pc_reliability_pc_ResourceTimeoutFailureType extends SoftwareInducedFailureType {
    ...
    public pcm_pc_reliability_pc_ResourceTimeoutFailureType(
    ) {
        super(
        );
    }
