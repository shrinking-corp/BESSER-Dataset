...
public class pcm_pc_composition_pc_ProvidedInfrastructureDelegationConnector extends DelegationConnector {
    ...
    public pcm_pc_composition_pc_ProvidedInfrastructureDelegationConnector(
    ) {
        super(
        );
    }
