...
class smm_Scope(SmmElement):
    ...
    def __init__(self, class_: str, enumerated: bool, name: str, recognizer: str, Scope: "smm_Measure" = None, scope: set["smm_Measure"] = None):
        self.class_ = class_
...
class smm_Measure(SmmElement):
    ...
    def __init__(self, library: str, name: str, Measure: "smm_Category" = None, categoryMeasure: set["smm_Category"] = None, Measure23: "smm_Measure" = None, equivalentTo: set["smm_Measure"] = None, Measure26: "smm_Measure" = None, equivalentFrom: set["smm_Measure"] = None, smm_Measure: "smm_Measure" = None, smm_Measure27: set["smm_Measure"] = None, measure: set["smm_Measurement"] = None, measures: "smm_Scope" = None, Measure38: "smm_Measurement" = None, Measure46: "smm_MeasureRelationship" = None, Measure48: "smm_MeasureRelationship" = None, from_31: set["smm_MeasureRelationship"] = None, to33: set["smm_MeasureRelationship"] = None, characteristics: "smm_Characteristic" = None, Measure56: "smm_Scope" = None, Measure54: "smm_Characteristic" = None):
