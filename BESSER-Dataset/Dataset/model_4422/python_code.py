...
class ArduinoMetamodel_State:
    ...
    def __init__(self, name: str, isInitial: bool, State: "ArduinoMetamodel_Transition" = None, State17: "ArduinoMetamodel_Transition" = None, ArduinoMetamodel_State: "ArduinoMetamodel_FiniteStateMachine" = None, target: set["ArduinoMetamodel_Transition"] = None, source: set["ArduinoMetamodel_Transition"] = None):
        self.name = name
