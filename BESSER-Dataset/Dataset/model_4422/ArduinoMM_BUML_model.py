...
# Classes
ArduinoMetamodel_Project = Class(name="ArduinoMetamodel_Project")
ArduinoMetamodel_ArduinoBoardUNO = Class(name="ArduinoMetamodel_ArduinoBoardUNO")
ArduinoMetamodel_Metodo = Class(name="ArduinoMetamodel_Metodo")
ArduinoMetamodel_FiniteStateMachine = Class(name="ArduinoMetamodel_FiniteStateMachine")
ArduinoMetamodel_PWM = Class(name="ArduinoMetamodel_PWM")
Analog = Class(name="Analog")
ArduinoMetamodel_Instruccion = Class(name="ArduinoMetamodel_Instruccion")
ArduinoMetamodel_Digital = Class(name="ArduinoMetamodel_Digital")
ArduinoMetamodel_Analog = Class(name="ArduinoMetamodel_Analog")
ArduinoMetamodel_Pin = Class(name="ArduinoMetamodel_Pin", is_abstract=True)
Pin = Class(name="Pin")
ArduinoMetamodel_delay = Class(name="ArduinoMetamodel_delay")
Instruccion = Class(name="Instruccion")
ArduinoMetamodel_State = Class(name="ArduinoMetamodel_State")
ArduinoMetamodel_Transition = Class(name="ArduinoMetamodel_Transition")
ArduinoMetamodel_Action = Class(name="ArduinoMetamodel_Action")
...
ArduinoMetamodel_State.attributes={ArduinoMetamodel_State_name, ArduinoMetamodel_State_isInitial}
...
domain_model = DomainModel(
    ...
    types={ArduinoMetamodel_Project, ArduinoMetamodel_ArduinoBoardUNO, ArduinoMetamodel_Metodo, ArduinoMetamodel_FiniteStateMachine, ArduinoMetamodel_PWM, Analog, ArduinoMetamodel_Instruccion, ArduinoMetamodel_Digital, ArduinoMetamodel_Analog, ArduinoMetamodel_Pin, Pin, ArduinoMetamodel_delay, Instruccion, ArduinoMetamodel_State, ArduinoMetamodel_Transition, ArduinoMetamodel_Action, AnalogID, DigitalID, PinMode},
    associations={boards0, metodos1, fsm3, instrucciones9, digitalpins5, analogpins7, source15, target16, states18, incoming11, outgoing12, actions14},
    generalizations={gen_ArduinoMetamodel_Analog_Pin, gen_ArduinoMetamodel_PWM_Analog, gen_ArduinoMetamodel_Digital_Pin, gen_ArduinoMetamodel_delay_Instruccion},
    metadata=None
)
