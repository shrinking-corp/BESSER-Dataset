...
class simpleocl_LocalVariable(VariableDeclaration):
    ...
    def __init__(self, eq: str, LocalVariable62: "simpleocl_IterateExp" = None, LocalVariable64: "simpleocl_LetExp" = None, LocalVariable: "simpleocl_OclExpression" = None, variable: "simpleocl_LetExp" = None, initializedVariable: "simpleocl_OclExpression" = None, result: "simpleocl_IterateExp" = None):
        self.eq = eq
...
class simpleocl_OperationCall(PropertyCall):
    ...
    def __init__(self, operationName: str, parentOperation: set["simpleocl_OclExpression"] = None, OperationCall: "simpleocl_OclExpression" = None):
        self.operationName = operationName
...
class simpleocl_TupleTypeAttribute(LocatedElement):
    ...
    def __init__(self, name: str, TupleTypeAttribute114: "simpleocl_TupleType" = None, tupleTypeAttribute: "simpleocl_OclType" = None, attributes: "simpleocl_TupleType" = None, TupleTypeAttribute: "simpleocl_OclType" = None):
        self.name = name
...
class simpleocl_VariableDeclaration(LocatedElement):
    ...
    def __init__(self, varName: str, VariableDeclaration: "simpleocl_VariableExp" = None, variableDeclaration: "simpleocl_OclType" = None, referredVariable: set["simpleocl_VariableExp"] = None, VariableDeclaration104: "simpleocl_OclType" = None):
