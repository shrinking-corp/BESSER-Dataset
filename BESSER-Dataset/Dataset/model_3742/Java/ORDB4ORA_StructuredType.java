...
public class ORDB4ORA_StructuredType extends Datatype {
    ...
    public ORDB4ORA_StructuredType(
        boolean is_final,        String Name,        boolean is_instantiable    ) {
        super(
        );
    ...
    public ORDB4ORA_StructuredType(
        boolean is_final,        String Name,        boolean is_instantiable        ArrayList<ORDB4ORA_Attribute> ordb4ora_attributes    ) {
        this.is_final = is_final;
        this.Name = Name;
        this.is_instantiable = is_instantiable;
