...
class ORDB4ORA_Trigger:
    ...
    def __init__(self, Action: str, Name: str, Body: str, Event: str, ORDB4ORA_Trigger: set["ORDB4ORA_StructuralComponent"] = None, triggers: "ORDB4ORA_Table" = None, Trigger: "ORDB4ORA_Table" = None):
        self.Action = Action
        self.Name = Name
        self.Body = Body
        self.Event = Event
...
class ORDB4ORA_StructuralComponent:
    ...
    def __init__(self, Name: str, ORDB4ORA_StructuralComponent: "ORDB4ORA_Datatype" = None, ORDB4ORA_StructuralComponent49: set["ORDB4ORA_Feature"] = None, attributes: set["ORDB4ORA_Restriction"] = None, ORDB4ORA_StructuralComponent70: "ORDB4ORA_Trigger" = None, ORDB4ORA_StructuralComponent83: "ORDB4ORA_View" = None, StructuralComponent: "ORDB4ORA_Restriction" = None):
        self.Name = Name
...
class ORDB4ORA_Package:
    ...
    def __init__(self, Name: str, Package30: "ORDB4ORA_Operation" = None, Package: "ORDB4ORA_Model" = None, package: set["ORDB4ORA_Operation"] = None, package36: "ORDB4ORA_Model" = None):
        self.Name = Name
...
class ORDB4ORA_Operation(ABC):
    ...
    def __init__(self, Name: str, Body: str, operations: "ORDB4ORA_Package" = None, Operation32: "ORDB4ORA_OperationParameter" = None, Operation: "ORDB4ORA_Model" = None, operation: set["ORDB4ORA_OperationParameter"] = None, operation27: "ORDB4ORA_Model" = None, Operation34: "ORDB4ORA_Package" = None):
        self.Name = Name
        self.Body = Body
...
class ORDB4ORA_Method:
    ...
    def __init__(self, Body: str, Name: str, Method: "ORDB4ORA_MethodParameter" = None, ORDB4ORA_Method: "ORDB4ORA_Method" = None, ORDB4ORA_Method5: "ORDB4ORA_Method" = None, method: "ORDB4ORA_StructuredType" = None, method10: set["ORDB4ORA_MethodParameter"] = None, Method54: "ORDB4ORA_StructuredType" = None, ORDB4ORA_Method12: "ORDB4ORA_Datatype" = None):
        self.Body = Body
        self.Name = Name
        self.Method = Method
...
class ORDB4ORA_Model:
    ...
    def __init__(self, Name: str, Model: "ORDB4ORA_Datatype" = None, Model66: "ORDB4ORA_Table" = None, model: set["ORDB4ORA_Datatype"] = None, model17: set["ORDB4ORA_Table"] = None, model20: set["ORDB4ORA_Operation"] = None, model22: set["ORDB4ORA_Package"] = None, Model28: "ORDB4ORA_Operation" = None, Model37: "ORDB4ORA_Package" = None):
        self.Name = Name
        self.Model = Model
...
class ORDB4ORA_Table:
    ...
    def __init__(self, Name: str, Table: "ORDB4ORA_Column" = None, ORDB4ORA_Table: "ORDB4ORA_ForeignKey" = None, Table72: "ORDB4ORA_Trigger" = None, table: set["ORDB4ORA_Restriction"] = None, table63: set["ORDB4ORA_Column"] = None, table65: "ORDB4ORA_Model" = None, table68: set["ORDB4ORA_Trigger"] = None, ORDB4ORA_Table80: "ORDB4ORA_View" = None, Table18: "ORDB4ORA_Model" = None, Table43: "ORDB4ORA_Restriction" = None):
        self.Name = Name
        self.Table = Table
...
class ORDB4ORA_DatetimeType(BuiltInType):
    ...
    def __init__(self, SecondPrecision_Min: int, SecondPrecision_Max: int, SecondPrecision_Def: int, Descriptor: str, DayPrecision_Min: int, DayPrecision_Max: int, DayPrecision_Def: int, YearPrecision_Min: int, YearPrecision_Max: int, YearPrecision_Def: int):
...
class ORDB4ORA_BuiltInCharacterType(BuiltInType):
    ...
    def __init__(self, Semantic: str, Size_Min: int, Size_Max: int, Size_Def: int, Descriptor: str):
...
class ORDB4ORA_StructuredType(Datatype):
    ...
    def __init__(self, is_instantiable: bool, is_final: bool, Name: str, StructuredType: "ORDB4ORA_Attribute" = None, StructuredType8: "ORDB4ORA_Method" = None, structured: set["ORDB4ORA_Attribute"] = None, structured53: set["ORDB4ORA_Method"] = None, structuredType: set["ORDB4ORA_TypedTable"] = None, StructuredType76: "ORDB4ORA_TypedTable" = None, ORDB4ORA_StructuredType: "ORDB4ORA_ReferenceType" = None, ORDB4ORA_StructuredType59: "ORDB4ORA_StructuredType" = None, ORDB4ORA_StructuredType57: "ORDB4ORA_StructuredType" = None):
