...
class jsm_AbstractMResource(ABC):
    ...
    def __init__(self, name: str, derived: bool, resources: "jsm_MPackage" = None, AbstractMResource8: "jsm_AbstractMResource" = None, superOf: set["jsm_AbstractMResource"] = None, AbstractMResource11: "jsm_AbstractMResource" = None, derivedFrom: set["jsm_AbstractMResource"] = None, AbstractMResource: "jsm_MPackage" = None):
        self.name = name
...
class jsm_MPackage(AbstractMPackageContainer):
    ...
    def __init__(self, name: str, MPackage: "jsm_AbstractMPackageContainer" = None, packages: "jsm_AbstractMPackageContainer" = None, MPackage5: "jsm_AbstractMResource" = None, package: set["jsm_AbstractMResource"] = None):
        self.name = name
...
class AbstractMClass:
    ...
    pass
class jsm_MDeclaredClass(AbstractMDeclaredType, AbstractMClass):
...
class jsm_MConstructorParameter(AbstractMTypeWithNameDeclaration):
    ...
    def __init__(self, final: bool, parameters68: "jsm_MConstructor" = None, MConstructorParameter: "jsm_MConstructor" = None):
        self.final = final
...
class jsm_CDeclarationStatement(AbstractMTypeWithNameDeclaration, AbstractCStatement):
...
class AbstractMInterface:
    ...
    pass
class jsm_MDeclaredInterface(AbstractMDeclaredType, AbstractMInterface):
...
class jsm_MExternalInterface(AbstractMInterface, AbstractMExternalType):
    ...
    pass
class jsm_MExternalClass(AbstractMExternalType, AbstractMClass):
...
class jsm_AbstractMDeclaredType(AbstractMTypeContainer):
    ...
    def __init__(self, name: str, types: "jsm_AbstractMTypeContainer" = None, jsm_AbstractMDeclaredType: "jsm_MDeclaredTypeReference" = None, AbstractMDeclaredType: "jsm_AbstractMTypeContainer" = None):
        self.name = name
        self.types = types
