...
# Classes
jsm_AbstractMPackageContainer = Class(name="jsm_AbstractMPackageContainer", is_abstract=True)
jsm_MPackage = Class(name="jsm_MPackage")
jsm_MRoot = Class(name="jsm_MRoot")
AbstractMPackageContainer = Class(name="AbstractMPackageContainer")
jsm_AbstractMExternalType = Class(name="jsm_AbstractMExternalType", is_abstract=True)
jsm_MResource = Class(name="jsm_MResource")
AbstractMResource = Class(name="AbstractMResource")
jsm_AbstractMTypeContainer = Class(name="jsm_AbstractMTypeContainer", is_abstract=True)
jsm_AbstractMResource = Class(name="jsm_AbstractMResource", is_abstract=True)
jsm_AbstractMType = Class(name="jsm_AbstractMType", is_abstract=True)
jsm_AbstractMTypeReference = Class(name="jsm_AbstractMTypeReference", is_abstract=True)
jsm_MDeclaredTypeReference = Class(name="jsm_MDeclaredTypeReference")
AbstractMTypeReference = Class(name="AbstractMTypeReference")
jsm_MExternalTypeReference = Class(name="jsm_MExternalTypeReference")
jsm_MPrimitiveTypeReference = Class(name="jsm_MPrimitiveTypeReference")
jsm_AbstractModifiers = Class(name="jsm_AbstractModifiers", is_abstract=True)
jsm_AbstractMMethodLike = Class(name="jsm_AbstractMMethodLike", is_abstract=True)
AbstractModifiers = Class(name="AbstractModifiers")
jsm_AbstractCStatement = Class(name="jsm_AbstractCStatement", is_abstract=True)
jsm_AbstractMTypeWithNameDeclaration = Class(name="jsm_AbstractMTypeWithNameDeclaration", is_abstract=True)
jsm_AbstractMDeclaredType = Class(name="jsm_AbstractMDeclaredType", is_abstract=True)
jsm_MStaticClassFieldDeclaration = Class(name="jsm_MStaticClassFieldDeclaration")
jsm_MInstanceClassFieldDeclaration = Class(name="jsm_MInstanceClassFieldDeclaration")
jsm_MCompilationUnit = Class(name="jsm_MCompilationUnit")
AbstractMTypeContainer = Class(name="AbstractMTypeContainer")
jsm_MConstructor = Class(name="jsm_MConstructor")
jsm_AbstractMMethodImplementation = Class(name="jsm_AbstractMMethodImplementation", is_abstract=True)
jsm_MNativeMethodDeclaration = Class(name="jsm_MNativeMethodDeclaration")
jsm_MAbstractDeclaredClass = Class(name="jsm_MAbstractDeclaredClass")
MDeclaredClass = Class(name="MDeclaredClass")
jsm_MAbstractClassMethodDeclaration = Class(name="jsm_MAbstractClassMethodDeclaration")
jsm_MExternalClass = Class(name="jsm_MExternalClass")
AbstractMExternalType = Class(name="AbstractMExternalType")
jsm_MDeclaredInterface = Class(name="jsm_MDeclaredInterface")
AbstractMInterface = Class(name="AbstractMInterface")
jsm_MConstantInterfaceFieldDeclaration = Class(name="jsm_MConstantInterfaceFieldDeclaration")
jsm_MInterfaceMethodDeclaration = Class(name="jsm_MInterfaceMethodDeclaration")
jsm_MExternalInterface = Class(name="jsm_MExternalInterface")
jsm_AbstractMFieldDeclaration = Class(name="jsm_AbstractMFieldDeclaration", is_abstract=True)
AbstractMTypeWithNameDeclaration = Class(name="AbstractMTypeWithNameDeclaration")
jsm_AbstractCExpression = Class(name="jsm_AbstractCExpression", is_abstract=True)
jsm_AbstractMClassFieldDeclaration = Class(name="jsm_AbstractMClassFieldDeclaration", is_abstract=True)
...
jsm_AbstractMClass = Class(name="jsm_AbstractMClass", is_abstract=True)
AbstractMType = Class(name="AbstractMType")
jsm_MDeclaredClass = Class(name="jsm_MDeclaredClass")
AbstractMClass = Class(name="AbstractMClass")
AbstractMDeclaredType = Class(name="AbstractMDeclaredType")
jsm_AbstractMInterface = Class(name="jsm_AbstractMInterface", is_abstract=True)
jsm_MMethodDeclarationParameter = Class(name="jsm_MMethodDeclarationParameter")
jsm_MImplicitMethodDeclaration = Class(name="jsm_MImplicitMethodDeclaration")
AbstractMMethodDeclaration = Class(name="AbstractMMethodDeclaration")
jsm_MDirectMethodImplementation = Class(name="jsm_MDirectMethodImplementation")
jsm_AbstractMImplementableMethodDeclaration = Class(name="jsm_AbstractMImplementableMethodDeclaration", is_abstract=True)
jsm_MDeclaredMethodImplementation = Class(name="jsm_MDeclaredMethodImplementation")
...
jsm_MMethodImplementationParameter = Class(name="jsm_MMethodImplementationParameter")
AbstractMMethodImplementation = Class(name="AbstractMMethodImplementation")
jsm_AbstractMMethodDeclaration = Class(name="jsm_AbstractMMethodDeclaration", is_abstract=True)
jsm_CBlockStatement = Class(name="jsm_CBlockStatement")
AbstractCStatement = Class(name="AbstractCStatement")
jsm_CDeclarationStatement = Class(name="jsm_CDeclarationStatement")
jsm_CExpressionStatement = Class(name="jsm_CExpressionStatement")
jsm_CIfStatement = Class(name="jsm_CIfStatement")
jsm_CUnparsedStatement = Class(name="jsm_CUnparsedStatement")
jsm_CConditionalExpression = Class(name="jsm_CConditionalExpression")
AbstractCExpression = Class(name="AbstractCExpression")
jsm_CUnparsedExpression = Class(name="jsm_CUnparsedExpression")
jsm_MConstructorParameter = Class(name="jsm_MConstructorParameter")
...
jsm_AbstractMResource.attributes={jsm_AbstractMResource_name, jsm_AbstractMResource_derived}
...
jsm_MMethodImplementationParameter.attributes={jsm_MMethodImplementationParameter_final, jsm_MMethodImplementationParameter_name}
...
domain_model = DomainModel(
    name="jsm",
    types={jsm_AbstractMPackageContainer, jsm_MPackage, jsm_MRoot, AbstractMPackageContainer, jsm_AbstractMExternalType, jsm_MResource, AbstractMResource, jsm_AbstractMTypeContainer, jsm_AbstractMResource, jsm_AbstractMType, jsm_AbstractMTypeReference, jsm_MDeclaredTypeReference, AbstractMTypeReference, jsm_MExternalTypeReference, jsm_MPrimitiveTypeReference, jsm_AbstractModifiers, jsm_AbstractMMethodLike, AbstractModifiers, jsm_AbstractCStatement, jsm_AbstractMTypeWithNameDeclaration, jsm_AbstractMDeclaredType, jsm_MStaticClassFieldDeclaration, jsm_MInstanceClassFieldDeclaration, jsm_MCompilationUnit, AbstractMTypeContainer, jsm_MConstructor, jsm_AbstractMMethodImplementation, jsm_MNativeMethodDeclaration, jsm_MAbstractDeclaredClass, MDeclaredClass, jsm_MAbstractClassMethodDeclaration, jsm_MExternalClass, AbstractMExternalType, jsm_MDeclaredInterface, AbstractMInterface, jsm_MConstantInterfaceFieldDeclaration, jsm_MInterfaceMethodDeclaration, jsm_MExternalInterface, jsm_AbstractMFieldDeclaration, AbstractMTypeWithNameDeclaration, jsm_AbstractCExpression, jsm_AbstractMClassFieldDeclaration, AbstractMFieldDeclaration, AbstractMClassFieldDeclaration, jsm_AbstractMClass, AbstractMType, jsm_MDeclaredClass, AbstractMClass, AbstractMDeclaredType, jsm_AbstractMInterface, jsm_MMethodDeclarationParameter, jsm_MImplicitMethodDeclaration, AbstractMMethodDeclaration, jsm_MDirectMethodImplementation, jsm_AbstractMImplementableMethodDeclaration, jsm_MDeclaredMethodImplementation, AbstractMImplementableMethodDeclaration, AbstractMMethodLike, jsm_MMethodImplementationParameter, AbstractMMethodImplementation, jsm_AbstractMMethodDeclaration, jsm_CBlockStatement, AbstractCStatement, jsm_CDeclarationStatement, jsm_CExpressionStatement, jsm_CIfStatement, jsm_CUnparsedStatement, jsm_CConditionalExpression, AbstractCExpression, jsm_CUnparsedExpression, jsm_MConstructorParameter, MPrimitiveTypes, MVisibility},
    associations={packages0, externalTypes1, packageContainer2, package4, derivedFrom7, superOf10, resources3, imports13, typeContainer14, root15, type16, type17, statement18, types12, staticFields23, instanceFields24, constructors26, implementedMethods28, nativeMethods30, abstractMethods32, extends34, constants36, methods38, initialValue40, owner41, type19, owner42, extends20, implements21, parameters45, methodDeclaration46, owner47, implementations48, owner50, owner51, owner53, owner55, parameters57, declaration58, declaration59, methodImplementation61, owner44, constructor67, statements70, value72, expression74, condition76, trueStatement78, falseStatement81, condition84, trueExpression86, falseExpression89, owner64, parameters66},
    generalizations={gen_jsm_MRoot_AbstractMPackageContainer, gen_jsm_MPackage_AbstractMPackageContainer, gen_jsm_MResource_AbstractMResource, gen_jsm_AbstractMDeclaredType_AbstractMTypeContainer, gen_jsm_MDeclaredTypeReference_AbstractMTypeReference, gen_jsm_MExternalTypeReference_AbstractMTypeReference, gen_jsm_MPrimitiveTypeReference_AbstractMTypeReference, gen_jsm_AbstractMMethodLike_AbstractModifiers, gen_jsm_MCompilationUnit_AbstractMResource, gen_jsm_MCompilationUnit_AbstractMTypeContainer, gen_jsm_MAbstractDeclaredClass_MDeclaredClass, gen_jsm_MExternalClass_AbstractMClass, gen_jsm_MExternalClass_AbstractMExternalType, gen_jsm_AbstractMInterface_AbstractMType, gen_jsm_MDeclaredInterface_AbstractMInterface, gen_jsm_MDeclaredInterface_AbstractMDeclaredType, gen_jsm_MExternalInterface_AbstractMInterface, gen_jsm_MExternalInterface_AbstractMExternalType, gen_jsm_AbstractMFieldDeclaration_AbstractMTypeWithNameDeclaration, gen_jsm_AbstractMClassFieldDeclaration_AbstractMFieldDeclaration, gen_jsm_MStaticClassFieldDeclaration_AbstractMClassFieldDeclaration, gen_jsm_MInstanceClassFieldDeclaration_AbstractMClassFieldDeclaration, gen_jsm_AbstractMClass_AbstractMType, gen_jsm_MDeclaredClass_AbstractMClass, gen_jsm_MDeclaredClass_AbstractMDeclaredType, gen_jsm_MMethodDeclarationParameter_AbstractMTypeWithNameDeclaration, gen_jsm_MImplicitMethodDeclaration_AbstractMMethodDeclaration, gen_jsm_AbstractMImplementableMethodDeclaration_AbstractMMethodDeclaration, gen_jsm_MAbstractClassMethodDeclaration_AbstractMImplementableMethodDeclaration, gen_jsm_MInterfaceMethodDeclaration_AbstractMImplementableMethodDeclaration, gen_jsm_MNativeMethodDeclaration_AbstractMMethodDeclaration, gen_jsm_AbstractMMethodImplementation_AbstractMMethodLike, gen_jsm_MDeclaredMethodImplementation_AbstractMMethodImplementation, gen_jsm_MDirectMethodImplementation_AbstractMMethodImplementation, gen_jsm_MConstructor_AbstractMMethodLike, gen_jsm_MConstantInterfaceFieldDeclaration_AbstractMFieldDeclaration, gen_jsm_AbstractMMethodDeclaration_AbstractMTypeWithNameDeclaration, gen_jsm_CBlockStatement_AbstractCStatement, gen_jsm_CDeclarationStatement_AbstractCStatement, gen_jsm_CDeclarationStatement_AbstractMTypeWithNameDeclaration, gen_jsm_CExpressionStatement_AbstractCStatement, gen_jsm_CIfStatement_AbstractCStatement, gen_jsm_CUnparsedStatement_AbstractCStatement, gen_jsm_CConditionalExpression_AbstractCExpression, gen_jsm_CUnparsedExpression_AbstractCExpression, gen_jsm_MConstructorParameter_AbstractMTypeWithNameDeclaration},
    metadata=None
)
