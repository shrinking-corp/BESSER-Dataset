...
domain_model = DomainModel(
    name="sql",
    types={sql_sqlDataTypes_String, DataType, sql_sqlDataTypes_DataType, sql_sqlDataTypes_Boolean, sql_sqlDataTypes_Real, sql_sqlDataTypes_Date, sql_sqlDataTypes_TimeStamp, Date, sql_sqlDataTypes_Integer, sql_sqlDataTypes_Float, sql_sqlDataTypes_Double, limit_LimitExpression, sql_parameter_SelectParameter, sql_parameter_SelectParameterAll, SelectParameter, sql_parameter_SelectParameterDistinct, sql_column_ColumnExpression, column_SingleColumnExpression, sql_column_SingleColumnExpression, expression_Expression, sql_select_SelectExpression, parameter_SelectParameter, column_ColumnExpression, from_FromExpression, where_WhereExpression, groupBy_GroupByExpression, having_HavingExpression, set_SetExpression, orderBy_OrderByExpression, from_TableListExpression, sql_from_TableExpression, SelectExpression, from_Table, sql_from_Table, sql_from_TableListExpression, from_TableExpression, from_JoinTableExpression, sql_from_JoinTableExpression, from_JoinOperation, column_ColumnOperation, sql_column_ColumnOperation, sql_column_ColumnOperationCount, ColumnOperation, sql_column_ColumnOperationMin, sql_column_ColumnOperationMax, sql_column_ColumnOperationSum, sql_column_ColumnOperationAvg, sql_column_ColumnOperationEvery, sql_column_ColumnOperationSome, sql_column_Column, sql_from_FromExpression, sql_orderBy_OrderByAliasExpression, sql_orderBy_OrderBySelectExpression, sql_orderBy_OrderByParameter, sql_orderBy_OrderByParameterAsc, OrderByParameter, sql_orderBy_OrderByParameterDesc, sql_groupBy_GroupByExpression, sql_having_HavingExpression, sql_set_SetExpression, sql_from_JoinOperation, sql_from_JoinOperationInner, JoinOperation, sql_from_JoinOperationLeft, sql_from_JoinOperationRight, sql_from_JoinOperationOuter, sql_where_WhereExpression, sql_orderBy_OrderByExpression, orderBy_OrderByParameter, sql_orderBy_OrderByColumnExpression, OrderByExpression, column_Column, sql_set_SetOperationIntersect, sql_limit_LimitExpression, sql_expression_Expression, sql_expression_SimpleExpression, Expression, expression_AndOrExpressionOperation, condition_Condition, expression_ExpressionOperationNot, sql_expression_ExpressionOperation, set_SetOperation, sql_set_SetOperation, sql_set_SetOperationUnion, SetOperation, sql_set_SetOperationMinus, parameter_SelectParameterDistinct, sql_set_SetOperationExcept, sql_condition_ExistsCondition, sql_condition_BetweenCondition, sql_condition_InCondition, sql_condition_LikeCondition, sql_condition_ConditionOperation, sql_condition_ConditionOperationEqual, ConditionOperation, sql_condition_ConditionOperationLesser, sql_condition_ConditionOperationLessEqual, sql_expression_AndOrExpressionOperation, ExpressionOperation, sql_expression_ExpressionOperationNot, sql_expression_ExpressionOperationAnd, AndOrExpressionOperation, sql_expression_ExpressionOperationOr, sql_condition_Condition, sql_condition_SimpleCondition, Condition, value_Value, sql_condition_OperationCondition, SimpleCondition, condition_ConditionOperation, sql_condition_IsNullCondition, value_ValueFrontOperation, sql_value_ConditionValue, sql_value_FunctionValue, sql_term_Term, sql_term_BooleanTerm, Term, sql_term_BooleanTermTrue, BooleanTerm, sql_term_BooleanTermFalse, sql_term_NullTerm, sql_term_ColumnTerm, sql_condition_ConditionOperationGreater, sql_condition_ConditionOperationGreatEqual, sql_condition_ConditionOperationUnEqual, sql_condition_ConditionOperationUnEqual2, sql_value_Value, sql_value_ValueFrontOperation, ValueOperation, sql_value_ValueFrontOperationPlus, ValueFrontOperation, sql_value_ValueFrontOperationMinus, sql_value_ValueOperation, sql_value_ValueOperationMultiply, sql_value_ValueOperationDivide, sql_value_ValueOperationParallel, sql_value_SimpleValue, Value, term_Term, value_ValueOperation, sql_term_SimpleTerm, sql_term_SimpleTermString, SimpleTerm, sql_term_SimpleTermFloat, sql_term_SimpleTermInteger, sql_term_SimpleTermChar, sql_term_CountStarTerm, sql_term_StarTerm},
    associations={limit15, columnExpressions17, expression18, parameter0, columns1, from_3, where5, groupBy7, having9, set11, orderBy13, tables24, selectExpression25, table26, table28, joinTable29, join31, joinTable32, operation19, parameter21, selectExpression42, expression44, expression46, expression35, expression38, parameter40, columnReference41, selectParameter55, selectParameter57, operations59, conditions60, notOperation62, selectExpression48, setOperation50, selectParameter52, selectParameter54, operationNot66, selectExpression68, selectExpression70, operationNot72, operationNot75, values64, operation65, operations78, frontOperation80, condition82, parameters84, terms77, tableReference86, column88, columnReference91},
    generalizations={gen_sql_sqlDataTypes_String_DataType, gen_sql_sqlDataTypes_Boolean_DataType, gen_sql_sqlDataTypes_Real_DataType, gen_sql_sqlDataTypes_Date_DataType, gen_sql_sqlDataTypes_TimeStamp_Date, gen_sql_sqlDataTypes_Integer_DataType, gen_sql_sqlDataTypes_Float_DataType, gen_sql_sqlDataTypes_Double_DataType, gen_sql_parameter_SelectParameterAll_SelectParameter, gen_sql_parameter_SelectParameterDistinct_SelectParameter, gen_sql_column_ColumnOperationCount_ColumnOperation, gen_sql_column_ColumnOperationMin_ColumnOperation, gen_sql_column_ColumnOperationMax_ColumnOperation, gen_sql_column_ColumnOperationSum_ColumnOperation, gen_sql_column_ColumnOperationAvg_ColumnOperation, gen_sql_column_ColumnOperationEvery_ColumnOperation, gen_sql_column_ColumnOperationSome_ColumnOperation, gen_sql_orderBy_OrderByAliasExpression_OrderByExpression, gen_sql_orderBy_OrderBySelectExpression_OrderByExpression, gen_sql_orderBy_OrderByParameterAsc_OrderByParameter, gen_sql_orderBy_OrderByParameterDesc_OrderByParameter, gen_sql_from_JoinOperationInner_JoinOperation, gen_sql_from_JoinOperationLeft_JoinOperation, gen_sql_from_JoinOperationRight_JoinOperation, gen_sql_from_JoinOperationOuter_JoinOperation, gen_sql_orderBy_OrderByColumnExpression_OrderByExpression, gen_sql_set_SetOperationIntersect_SetOperation, gen_sql_expression_SimpleExpression_Expression, gen_sql_set_SetOperationUnion_SetOperation, gen_sql_set_SetOperationMinus_SetOperation, gen_sql_set_SetOperationExcept_SetOperation, gen_sql_condition_ExistsCondition_SimpleCondition, gen_sql_condition_BetweenCondition_SimpleCondition, gen_sql_condition_InCondition_SimpleCondition, gen_sql_condition_LikeCondition_SimpleCondition, gen_sql_condition_ConditionOperationEqual_ConditionOperation, gen_sql_condition_ConditionOperationLesser_ConditionOperation, gen_sql_condition_ConditionOperationLessEqual_ConditionOperation, gen_sql_expression_AndOrExpressionOperation_ExpressionOperation, gen_sql_expression_ExpressionOperationNot_ExpressionOperation, gen_sql_expression_ExpressionOperationAnd_AndOrExpressionOperation, gen_sql_expression_ExpressionOperationOr_AndOrExpressionOperation, gen_sql_condition_SimpleCondition_Condition, gen_sql_condition_OperationCondition_SimpleCondition, gen_sql_condition_IsNullCondition_SimpleCondition, gen_sql_value_ConditionValue_Value, gen_sql_value_FunctionValue_Value, gen_sql_term_BooleanTerm_Term, gen_sql_term_BooleanTermTrue_BooleanTerm, gen_sql_term_BooleanTermFalse_BooleanTerm, gen_sql_term_NullTerm_Term, gen_sql_term_ColumnTerm_Term, gen_sql_condition_ConditionOperationGreater_ConditionOperation, gen_sql_condition_ConditionOperationGreatEqual_ConditionOperation, gen_sql_condition_ConditionOperationUnEqual_ConditionOperation, gen_sql_condition_ConditionOperationUnEqual2_ConditionOperation, gen_sql_value_ValueFrontOperation_ValueOperation, gen_sql_value_ValueFrontOperationPlus_ValueFrontOperation, gen_sql_value_ValueFrontOperationMinus_ValueFrontOperation, gen_sql_value_ValueOperationMultiply_ValueOperation, gen_sql_value_ValueOperationDivide_ValueOperation, gen_sql_value_ValueOperationParallel_ValueOperation, gen_sql_value_SimpleValue_Value, gen_sql_term_SimpleTerm_Term, gen_sql_term_SimpleTermString_SimpleTerm, gen_sql_term_SimpleTermFloat_SimpleTerm, gen_sql_term_SimpleTermInteger_SimpleTerm, gen_sql_term_SimpleTermChar_SimpleTerm, gen_sql_term_CountStarTerm_Term, gen_sql_term_StarTerm_Term},
    metadata=None
)
