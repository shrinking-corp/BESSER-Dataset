...
class sql_column_SingleColumnExpression:
    ...
    def __init__(self, alias: str, sql_column_SingleColumnExpression20: "column_ColumnOperation" = None, sql_column_SingleColumnExpression22: "parameter_SelectParameter" = None, sql_column_SingleColumnExpression: "expression_Expression" = None):
        self.alias = alias
