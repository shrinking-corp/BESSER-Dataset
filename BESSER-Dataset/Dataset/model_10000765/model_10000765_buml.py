...
domain_model = DomainModel(
    name="_5d6e90e9_d5f7_45fa_acba_3156b44b09be",
    ...
    associations={Monopoly_Tarjeta2, Monopoly_Dados, Servicio_TituloServicio, Ferrocarril_TituloFerrocarril, Propiedad_TituloPropiedad, Jugador_Titulo, Jugador_TSalirCarcel, Monopoly_Casilla, Monopoly_Jugador, Monopoly_Jugador2, Monopoly_Tarjeta},
    generalizations={},
    metadata=None
)
