...
# Classes
my_NamedElement = Class(name="my_NamedElement")
my_Column = Class(name="my_Column")
NamedElement = Class(name="NamedElement")
my_Table = Class(name="my_Table")
my_Database = Class(name="my_Database")
my_FKRelation = Class(name="my_FKRelation")
...
my_Column.attributes={my_Column_size, my_Column_primary, my_Column_type, my_Column_unique}
...
domain_model = DomainModel(
    name="my",
    types={my_NamedElement, my_Column, NamedElement, my_Table, my_Database, my_FKRelation, ColumnType},
    associations={columns0, tables1, fkrelations3, target5, source8},
    generalizations={gen_my_Column_NamedElement, gen_my_Table_NamedElement, gen_my_Database_NamedElement},
    metadata=None
)
