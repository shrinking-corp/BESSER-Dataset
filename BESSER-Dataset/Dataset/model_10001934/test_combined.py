...
def test_hyp_cardtester_is_not_abstract():
    assert not inspect.isabstract(CardTester)


def test_hyp_cardtester_constructor_exists():
    assert callable(CardTester.__init__)


def test_hyp_cardtester_constructor_args():
...
@given(instance=Card_strategy)
def test_hyp_card_pointValue_setter(instance):
