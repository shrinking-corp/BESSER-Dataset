...
class adfg_PeriodicActor(Actor):
    ...
    def __init__(self, periodLowerBound: str, deadline: str, wcet: str, period: str, periodUpperBound: str, phase: str, PeriodicActor22: "adfg_AffineRelation" = None, PeriodicActor: "adfg_AffineRelation" = None, target40: set["adfg_AffineRelation"] = None, source37: set["adfg_AffineRelation"] = None):
...
class adfg_AffineRelation:
    ...
    def __init__(self, n: int, phi: int, d: int, AffineRelation: "adfg_Graph" = None, affineRelationTarget: "adfg_PeriodicActor" = None, affineRelations: "adfg_Graph" = None, affineRelationSource: "adfg_PeriodicActor" = None, AffineRelation41: "adfg_PeriodicActor" = None, AffineRelation38: "adfg_PeriodicActor" = None):
        self.n = n
        self.phi = phi
        self.d = d
...
class adfg_Connection:
    ...
    def __init__(self, size: int, id: int, Connection: "adfg_Graph" = None, connection: "adfg_OutputPort" = None, connection27: "adfg_InputPort" = None, connections: "adfg_Graph" = None, Connection33: "adfg_InputPort" = None, Connection35: "adfg_OutputPort" = None):
        self.size = size
        self.id = id
...
class adfg_Graph:
    ...
    def __init__(self, name: str, nbActors: int, nbBuffers: int, id: int, sourceCode: str, processorUtilization: float, bufferingRequirements: int, owner9: set["adfg_Connection"] = None, adfg_Graph: "adfg_GraphConnection" = None, adfg_Graph13: "adfg_GraphConnection" = None, Graph17: "adfg_Actor" = None, graphs: "adfg_Application" = None, owner5: set["adfg_Actor"] = None, owner7: set["adfg_AffineRelation"] = None, Graph24: "adfg_AffineRelation" = None, Graph29: "adfg_Connection" = None, Graph: "adfg_Application" = None):
        self.name = name
    ...
    @property
    def bufferingRequirements(self):
...
class adfg_Application:
    ...
    def __init__(self, nbGraphs: int, name: str, nbProcessors: int, dynamicChecking: bool, schedulingAlgorithm: str, sourceCode: str, Application15: "adfg_GraphConnection" = None, Application: "adfg_Graph" = None, owner: set["adfg_Graph"] = None, owner2: set["adfg_GraphConnection"] = None):
