...
# Classes
adfg_Application = Class(name="adfg_Application")
adfg_Graph = Class(name="adfg_Graph")
adfg_GraphConnection = Class(name="adfg_GraphConnection")
adfg_Connection = Class(name="adfg_Connection")
adfg_Port = Class(name="adfg_Port", is_abstract=True)
adfg_Actor = Class(name="adfg_Actor", is_abstract=True)
adfg_AffineRelation = Class(name="adfg_AffineRelation")
adfg_OutputPort = Class(name="adfg_OutputPort")
adfg_InputPort = Class(name="adfg_InputPort")
Port = Class(name="Port")
adfg_PeriodicActor = Class(name="adfg_PeriodicActor")
adfg_Channel = Class(name="adfg_Channel")
Connection = Class(name="Connection")
adfg_AperiodicActor = Class(name="adfg_AperiodicActor")
adfg_LossyChannel = Class(name="adfg_LossyChannel")
...
adfg_Application.attributes={adfg_Application_nbGraphs, adfg_Application_name, adfg_Application_schedulingAlgorithm, adfg_Application_sourceCode, adfg_Application_nbProcessors, adfg_Application_dynamicChecking}
...
adfg_Graph.attributes={adfg_Graph_nbActors, adfg_Graph_sourceCode, adfg_Graph_id, adfg_Graph_processorUtilization, adfg_Graph_nbBuffers, adfg_Graph_bufferingRequirements, adfg_Graph_name}
...
adfg_Port.attributes={adfg_Port_sequence, adfg_Port_type, adfg_Port_name}
...
adfg_Actor.attributes={adfg_Actor_procNumber, adfg_Actor_nbPorts, adfg_Actor_priority, adfg_Actor_name, adfg_Actor_sourceCode}
...
adfg_AffineRelation.attributes={adfg_AffineRelation_n, adfg_AffineRelation_d, adfg_AffineRelation_phi}
...
adfg_PeriodicActor.attributes={adfg_PeriodicActor_periodUpperBound, adfg_PeriodicActor_phase, adfg_PeriodicActor_period, adfg_PeriodicActor_deadline, adfg_PeriodicActor_wcet, adfg_PeriodicActor_periodLowerBound}
...
domain_model = DomainModel(
    name="adfg",
    types={adfg_Application, adfg_Graph, adfg_GraphConnection, adfg_Connection, adfg_Port, adfg_Actor, adfg_AffineRelation, adfg_OutputPort, adfg_InputPort, Port, adfg_PeriodicActor, adfg_Channel, Connection, adfg_AperiodicActor, adfg_LossyChannel, Actor},
    associations={graphs0, GraphConnections1, connections8, source10, target11, owner14, owner16, ports18, owner3, nodes4, affineRelations6, target21, owner23, source25, target26, owner28, owner30, connection32, connection34, source20, affineRelationTarget39, affineRelationSource36},
    generalizations={gen_adfg_InputPort_Port, gen_adfg_OutputPort_Port, gen_adfg_Channel_Connection, gen_adfg_AperiodicActor_Actor, gen_adfg_LossyChannel_Connection, gen_adfg_PeriodicActor_Actor},
    metadata=None
)
