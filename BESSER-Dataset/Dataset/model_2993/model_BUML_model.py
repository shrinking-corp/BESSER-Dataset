...
model_Revision = Class(name="model_Revision")
model_Discussion = Class(name="model_Discussion")
model_VersionHistory = Class(name="model_VersionHistory")
model_Article = Class(name="model_Article")
Content = Class(name="Content")
model_Media = Class(name="model_Media")
model_MetaData = Class(name="model_MetaData")
model_Internal = Class(name="model_Internal")
model_Node = Class(name="model_Node", is_abstract=True)
model_User = Class(name="model_User")
model_Role = Class(name="model_Role", is_abstract=True)
model_RegisteredUser = Class(name="model_RegisteredUser")
UnregisteredUser = Class(name="UnregisteredUser")
model_Talk = Class(name="model_Talk")
model_AutoConfirmedUser = Class(name="model_AutoConfirmedUser")
RegisteredUser = Class(name="RegisteredUser")
model_Administrator = Class(name="model_Administrator")
AutoConfirmedUser = Class(name="AutoConfirmedUser")
model_SysOp = Class(name="model_SysOp")
Administrator = Class(name="Administrator")
model_WikiProject = Class(name="model_WikiProject")
Internal = Class(name="Internal")
model_UnregisteredUser = Class(name="model_UnregisteredUser")
...
model_Content.methods={model_Content_m_addDiscussionItem, model_Content_m_render, model_Content_m_createNewRevision, model_Content_m_renderHTML}
...
model_Revision.attributes={model_Revision_creationDate, model_Revision_content}
...
model_Discussion.methods={model_Discussion_m_add, model_Discussion_m_renderHTML}
...
model_Article.attributes={model_Article_typePrefix, model_Article_content}
...
model_Media.methods={model_Media_m_addMetaData, model_Media_m_getFileUsage, model_Media_m_removeMetaData, model_Media_m_addContentToFileUsage, model_Media_m_getMetaData, model_Media_m_removeContent}
...
model_Internal.attributes={model_Internal_content, model_Internal_typePrefix}
...
model_Node.methods={model_Node_m_renderHTML, model_Node_m_getURI, model_Node_m_render, model_Node_m_getTypePrefix}
...
model_AutoConfirmedUser.methods={model_AutoConfirmedUser_m_moveArticle, model_AutoConfirmedUser_m_moveMedia, model_AutoConfirmedUser_m_createArticle, model_AutoConfirmedUser_m_uploadMedia}
...
model_SysOp.methods={model_SysOp_m_blockAdmin, model_SysOp_m_makeAdmin, model_SysOp_m_removeAdmin}
...
domain_model = DomainModel(
    name="model",
    types={model_Content, Node, model_Revision, model_Discussion, model_VersionHistory, model_Article, Content, model_Media, model_MetaData, model_Internal, model_Node, model_User, model_Role, model_RegisteredUser, UnregisteredUser, model_Talk, model_AutoConfirmedUser, RegisteredUser, model_Administrator, AutoConfirmedUser, model_SysOp, Administrator, model_WikiProject, Internal, model_UnregisteredUser, Role},
    associations={revisions0, discussionPage1, currentRevision3, versionHistoryPage6, usage8, meta9, role11, author12, talkPage15, member16},
    generalizations={gen_model_Content_Node, gen_model_Article_Content, gen_model_Media_Content, gen_model_Internal_Content, gen_model_User_Node, gen_model_RegisteredUser_UnregisteredUser, gen_model_AutoConfirmedUser_RegisteredUser, gen_model_Administrator_AutoConfirmedUser, gen_model_SysOp_Administrator, gen_model_WikiProject_Internal, gen_model_UnregisteredUser_Role},
    metadata=None
)
