...
class Customer:
    ...
    def __init__(self, firstname: str, lastname: str, emailAddress: str, id: int, login: str, password: str, isBan: bool, Shopping_cart1: "ShoppingCart" = None, account3: "Account" = None):
        ...
        self.isBan = isBan
        self.Shopping_cart1 = Shopping_cart1
    ...
    @property
    def Shopping_cart1(self):
        return self.__Shopping_cart1
    @Shopping_cart1.setter
    def Shopping_cart1(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Customer__Shopping_cart1", None)
        self.__Shopping_cart1 = value
...
class Payment:
    ...
    def __init__(self, id: int, total: int, comments: str, account6: "Account" = None, order9: "Order" = None):
        self.id = id
        self.total = total
    ...
    def account6(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Payment__account6", None)
...
class ShoppingCart:
    ...
    def __init__(self, id: int, creationDate: date, c0: "Customer" = None, account4: "Account" = None, item11: set["Item"] = None):
        self.id = id
    ...
    def account4(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_ShoppingCart__account4", None)
    ...
    def c0(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "Shopping_cart1"):
                opp_val = getattr(old_value, "Shopping_cart1", None)
                if opp_val == self:
                    setattr(old_value, "Shopping_cart1", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "Shopping_cart1"):
                opp_val = getattr(value, "Shopping_cart1", None)
                setattr(value, "Shopping_cart1", self)
