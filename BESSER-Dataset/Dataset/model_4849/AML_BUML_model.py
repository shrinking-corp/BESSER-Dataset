...
# Classes
aml_AggregationRule = Class(name="aml_AggregationRule")
aml_Template = Class(name="aml_Template")
aml_Argument = Class(name="aml_Argument")
aml_Exhibit = Class(name="aml_Exhibit")
aml_Collection = Class(name="aml_Collection")
aml_EObject = Class(name="aml_EObject")
aml_Parameter = Class(name="aml_Parameter")
aml_AmlDocument = Class(name="aml_AmlDocument")
aml_DiscoveryMethod = Class(name="aml_DiscoveryMethod")
aml_Annotation = Class(name="aml_Annotation")
aml_Person = Class(name="aml_Person")
aml_Memo = Class(name="aml_Memo")
aml_Belief = Class(name="aml_Belief")
aml_Witness = Class(name="aml_Witness")
aml_Flag = Class(name="aml_Flag")
aml_Answer = Class(name="aml_Answer")
aml_ArgumentTemplate = Class(name="aml_ArgumentTemplate")
aml_MetaData = Class(name="aml_MetaData")
aml_CreatingTool = Class(name="aml_CreatingTool")
aml_Evidence = Class(name="aml_Evidence")
aml_Choice = Class(name="aml_Choice")
aml_CollectionItem = Class(name="aml_CollectionItem")
aml_Question = Class(name="aml_Question")
aml_NationState = Class(name="aml_NationState")
aml_Creator = Class(name="aml_Creator")
aml_Coverage = Class(name="aml_Coverage")
aml_Dependent = Class(name="aml_Dependent")
aml_DocumentRoot = Class(name="aml_DocumentRoot")
aml_EStringToStringMapEntry = Class(name="aml_EStringToStringMapEntry")
aml_End = Class(name="aml_End")
aml_EvidenceExhibit = Class(name="aml_EvidenceExhibit")
aml_List = Class(name="aml_List")
aml_Interval = Class(name="aml_Interval")
aml_Period = Class(name="aml_Period")
aml_QuestionRelationships = Class(name="aml_QuestionRelationships")
aml_Reader = Class(name="aml_Reader")
aml_Relevance = Class(name="aml_Relevance")
aml_Publisher = Class(name="aml_Publisher")
aml_Start = Class(name="aml_Start")
aml_Reliability = Class(name="aml_Reliability")
aml_Value = Class(name="aml_Value")
...
aml_Collection.attributes={aml_Collection_label1, aml_Collection_label, aml_Collection_id, aml_Collection_objectType, aml_Collection_group}
...
aml_AmlDocument.attributes={aml_AmlDocument_version, aml_AmlDocument_group}
...
aml_DiscoveryMethod.attributes={aml_DiscoveryMethod_description, aml_DiscoveryMethod_id, aml_DiscoveryMethod_url, aml_DiscoveryMethod_importType, aml_DiscoveryMethod_autoTrigger, aml_DiscoveryMethod_label, aml_DiscoveryMethod_type}
...
aml_Annotation.attributes={aml_Annotation_group, aml_Annotation_id, aml_Annotation_mixed}
...
aml_Person.attributes={aml_Person_lastName, aml_Person_description, aml_Person_middleName, aml_Person_id, aml_Person_organization, aml_Person_nickName, aml_Person_firstName, aml_Person_department, aml_Person_email}
...
aml_Memo.attributes={aml_Memo_type, aml_Memo_subject, aml_Memo_id, aml_Memo_body}
...
aml_Belief.attributes={aml_Belief_ordinal, aml_Belief_label, aml_Belief_description, aml_Belief_symbol}
...
aml_Witness.attributes={aml_Witness_description, aml_Witness_idRef, aml_Witness_timestamp}
...
aml_Answer.attributes={aml_Answer_group, aml_Answer_rationale, aml_Answer_questionId}
...
aml_MetaData.attributes={aml_MetaData_date, aml_MetaData_group, aml_MetaData_description, aml_MetaData_securityMarking, aml_MetaData_subject, aml_MetaData_title}
...
aml_CreatingTool.attributes={aml_CreatingTool_toolType, aml_CreatingTool_label, aml_CreatingTool_version}
...
aml_Choice.attributes={aml_Choice_symbol, aml_Choice_label, aml_Choice_description, aml_Choice_ordinal}
...
aml_CollectionItem.attributes={aml_CollectionItem_ordinal, aml_CollectionItem_idRef, aml_CollectionItem_objectType}
...
aml_Question.attributes={aml_Question_amplification, aml_Question_label, aml_Question_description, aml_Question_group, aml_Question_id}
...
aml_NationState.attributes={aml_NationState_region, aml_NationState_actor, aml_NationState_event, aml_NationState_group, aml_NationState_perspective}
...
aml_Creator.attributes={aml_Creator_idRef, aml_Creator_description, aml_Creator_objectType}
...
aml_DocumentRoot.attributes={aml_DocumentRoot_subject, aml_DocumentRoot_label, aml_DocumentRoot_url, aml_DocumentRoot_idRef, aml_DocumentRoot_organization, aml_DocumentRoot_symbol, aml_DocumentRoot_securityMarking, aml_DocumentRoot_perspective, aml_DocumentRoot_lastName, aml_DocumentRoot_event, aml_DocumentRoot_department, aml_DocumentRoot_mixed, aml_DocumentRoot_date, aml_DocumentRoot_body, aml_DocumentRoot_middleName, aml_DocumentRoot_actor, aml_DocumentRoot_nickName, aml_DocumentRoot_title, aml_DocumentRoot_label1, aml_DocumentRoot_rationale, aml_DocumentRoot_firstName, aml_DocumentRoot_region, aml_DocumentRoot_description, aml_DocumentRoot_id, aml_DocumentRoot_email, aml_DocumentRoot_description1}
...
aml_EvidenceExhibit.attributes={aml_EvidenceExhibit_value, aml_EvidenceExhibit_idRef, aml_EvidenceExhibit_questionId}
...
aml_Period.attributes={aml_Period_label, aml_Period_group}
...
aml_Reader.attributes={aml_Reader_idRef, aml_Reader_objectType, aml_Reader_description}
...
aml_Relevance.attributes={aml_Relevance_label, aml_Relevance_ordinal, aml_Relevance_description, aml_Relevance_symbol}
...
aml_Publisher.attributes={aml_Publisher_idRef, aml_Publisher_description, aml_Publisher_objectType}
...
aml_Reliability.attributes={aml_Reliability_description, aml_Reliability_label, aml_Reliability_symbol, aml_Reliability_ordinal}
...
domain_model = DomainModel(
    name="aml",
    types={aml_AggregationRule, aml_Template, aml_Argument, aml_Exhibit, aml_Collection, aml_EObject, aml_Parameter, aml_AmlDocument, aml_DiscoveryMethod, aml_Annotation, aml_Person, aml_Memo, aml_Belief, aml_Witness, aml_Flag, aml_Answer, aml_ArgumentTemplate, aml_MetaData, aml_CreatingTool, aml_Evidence, aml_Choice, aml_CollectionItem, aml_Question, aml_NationState, aml_Creator, aml_Coverage, aml_Dependent, aml_DocumentRoot, aml_EStringToStringMapEntry, aml_End, aml_EvidenceExhibit, aml_List, aml_Interval, aml_Period, aml_QuestionRelationships, aml_Reader, aml_Relevance, aml_Publisher, aml_Start, aml_Reliability, aml_Value, ObjectType, ObjectType1, ObjectType2, ObjectType3, Type},
    associations={template3, argument4, exhibit6, collection8, method0, parameter1, memo12, discoveryMethod14, person10, belief20, witness21, annotation23, aggregationRule26, memo16, flag18, metaData34, creatingTool36, annotation38, evidence29, discoveryMethod31, argumentTemplate41, answer43, creatingTool49, annotation52, question55, argumentTemplate57, metaData46, nationState62, collectionItem60, argumentTemplate63, annotation66, xSISchemaLocation70, aggregationRule73, amlDocument76, annotation79, answer82, xMLNSPrefixMap69, argumentTemplate91, belief94, choice97, collection99, collectionItem102, contributor105, archive85, argument88, creator114, dependent116, discoveryMethod118, coverage108, creatingTool111, evidenceExhibit126, exhibit128, flag131, format134, identifier137, end121, evidence123, language145, list148, memo150, metaData153, image140, interval143, nationState159, parameter162, period165, person167, method156, questionRelationships175, reader177, relation179, relevance182, publisher170, question172, source189, start192, reliability184, rights186, value200, witness202, template194, type197, evidenceExhibit205, reliability211, witness214, annotation217, archive220, relevance208, metaData223, annotation226, witness229, li232, creator235, reader238, creator241, reader244, publisher247, contributor250, type253, format256, identifier259, source262, language265, relation268, rights274, image277, period280, coverage271, value283, start286, end289, dependent292, choice298, questionRelationships301, aggregationRule304, discoveryMethod307, annotation310, type295, metaData313, creatingTool316, annotation319, question322, interval325, list328},
    generalizations={},
    metadata=None
)
