...
servicefeaturemodel_Configurations = Class(name="servicefeaturemodel_Configurations")
...
servicefeaturemodel_GroupRelationship = Class(name="servicefeaturemodel_GroupRelationship", is_abstract=True)
...
servicefeaturemodel_ServiceFeatureDiagram.attributes={servicefeaturemodel_ServiceFeatureDiagram_name, servicefeaturemodel_ServiceFeatureDiagram_description, servicefeaturemodel_ServiceFeatureDiagram_id}
...
servicefeaturemodel_ServiceFeature.attributes={servicefeaturemodel_ServiceFeature_requirementWeight, servicefeaturemodel_ServiceFeature_name, servicefeaturemodel_ServiceFeature_id, servicefeaturemodel_ServiceFeature_description, servicefeaturemodel_ServiceFeature_required}
...
servicefeaturemodel_Configuration.attributes={servicefeaturemodel_Configuration_selected, servicefeaturemodel_Configuration_id, servicefeaturemodel_Configuration_description, servicefeaturemodel_Configuration_name}
...
servicefeaturemodel_AttributeType.attributes={servicefeaturemodel_AttributeType_description, servicefeaturemodel_AttributeType_domain, servicefeaturemodel_AttributeType_aggregationRule, servicefeaturemodel_AttributeType_requirement, servicefeaturemodel_AttributeType_name, servicefeaturemodel_AttributeType_requirementWeight, servicefeaturemodel_AttributeType_scaleOrder, servicefeaturemodel_AttributeType_toBeEvaluated, servicefeaturemodel_AttributeType_customAttributeTypePriority}
...
servicefeaturemodel_Preference.attributes={servicefeaturemodel_Preference_value, servicefeaturemodel_Preference_stakeholderGroup, servicefeaturemodel_Preference_creationDate, servicefeaturemodel_Preference_description}
...
domain_model = DomainModel(
    ...
    types={servicefeaturemodel_Service, servicefeaturemodel_ServiceFeatureDiagram, servicefeaturemodel_Configurations, servicefeaturemodel_AttributeTypes, servicefeaturemodel_ServiceFeature, servicefeaturemodel_Attribute, servicefeaturemodel_GroupRelationship, servicefeaturemodel_OR, GroupRelationship, servicefeaturemodel_Requires, servicefeaturemodel_Excludes, servicefeaturemodel_XOR, servicefeaturemodel_Configuration, servicefeaturemodel_OptionalServiceFeature, ServiceFeature, servicefeaturemodel_AttributeType, servicefeaturemodel_Preference, servicefeaturemodel_MandatoryServiceFeature, AggregationRules, ScaleOrders, AttributeDomain, FeatureTypes},
    associations={serviceFeatureDiagram0, configurations1, attributeTypes3, attributes5, groupRelationship6, serviceFeature20, requires8, excludes10, serviceFeatures13, serviceFeatures23, attributeType15, serviceFeatures26, serviceFeature17, preferences28, attributes30, optionalServiceFeatures33, configurations35, attributeTypes38},
    generalizations={gen_servicefeaturemodel_OR_GroupRelationship, gen_servicefeaturemodel_XOR_GroupRelationship, gen_servicefeaturemodel_OptionalServiceFeature_ServiceFeature, gen_servicefeaturemodel_MandatoryServiceFeature_ServiceFeature},
    metadata=None
)
