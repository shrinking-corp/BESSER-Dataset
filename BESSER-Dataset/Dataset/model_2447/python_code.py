...
class fsa_Transition:
    ...
    def __init__(self, description: str, fsa_Transition: "fsa_State" = None, fsa_Transition8: "fsa_FSA" = None, fsa_Transition4: "fsa_State" = None):
...
class fsa_State:
    ...
    def __init__(self, name: str, final: bool, temporalProperties: str, fsa_State: "fsa_FSA" = None, fsa_State2: "fsa_Transition" = None, fsa_State11: "fsa_FSA" = None, fsa_State14: "fsa_FSA" = None, fsa_State5: "fsa_Transition" = None):
        self.name = name
        self.final = final
