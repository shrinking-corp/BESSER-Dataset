...
domain_model = DomainModel(
    name="_7eba0922_0a20_493b_8a46_9910900105cd",
    ...
    associations={Machine_Processor, Machine_Memory, Processor_Memory, Program_Instruction, Processor_Program, Cache_RAM, ExtensionBoard_Card, Vendor1Adapter_Vendor1Sound, Vendor2Adapter_Vendor2Sound, Machine_Card, AcceleratorCard_CPU},
    generalizations={},
    metadata=None
)
