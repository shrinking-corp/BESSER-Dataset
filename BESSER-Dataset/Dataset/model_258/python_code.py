...
class ecore_EClassifier(ENamedElement):
    ...
    def __init__(self, instanceClassName: str, instanceClass: str, defaultValue: str, eClassifiers: "ecore_EPackage" = None, ecore_EClassifier: "ecore_EOperation" = None, ecore_EClassifier67: "ecore_ETypedElement" = None, EClassifier: "ecore_EPackage" = None):
