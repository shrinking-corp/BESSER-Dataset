...
class features_FeatureVersion(FeatureVersionDescriptor):
    ...
    def __init__(self, version: str, news: str, FeatureVersion: "features_Feature" = None, featureVersions: "features_Feature" = None):
...
class features_Feature(FeatureDescriptor):
    ...
    def __init__(self, identifier: str, provider: str, name: str, description: str, Feature: "features_FeatureSet" = None, features: "features_FeatureSet" = None, feature: set["features_FeatureVersion"] = None, Feature4: "features_FeatureVersion" = None):
        self.identifier = identifier
