...
# Classes
features_Feature = Class(name="features_Feature")
FeatureDescriptor = Class(name="FeatureDescriptor")
features_FeatureSetDescriptor = Class(name="features_FeatureSetDescriptor", is_abstract=True)
features_FeatureDescriptor = Class(name="features_FeatureDescriptor", is_abstract=True)
features_FeatureVersionDescriptor = Class(name="features_FeatureVersionDescriptor", is_abstract=True)
features_FeatureSet = Class(name="features_FeatureSet")
FeatureSetDescriptor = Class(name="FeatureSetDescriptor")
features_FeatureVersion = Class(name="features_FeatureVersion")
...
features_Feature.attributes={features_Feature_provider, features_Feature_identifier, features_Feature_description, features_Feature_name}
...
features_FeatureSet.attributes={features_FeatureSet_description, features_FeatureSet_name, features_FeatureSet_identifier}
...
domain_model = DomainModel(
    name="features",
    types={features_Feature, FeatureDescriptor, features_FeatureSetDescriptor, features_FeatureDescriptor, features_FeatureVersionDescriptor, features_FeatureSet, FeatureSetDescriptor, features_FeatureVersion, FeatureVersionDescriptor},
    associations={features0, featureSet1, featureVersions2, feature3},
    generalizations={gen_features_Feature_FeatureDescriptor, gen_features_FeatureSet_FeatureSetDescriptor, gen_features_FeatureVersion_FeatureVersionDescriptor},
    metadata=None
)
