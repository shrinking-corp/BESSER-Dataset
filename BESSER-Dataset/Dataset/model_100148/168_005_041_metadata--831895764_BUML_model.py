...
connection_Connection.attributes={connection_Connection_ContextMode, connection_Connection_contextName, connection_Connection_version, connection_Connection_ContextId}
...
connection_MetadataTable.attributes={connection_MetadataTable_attachedCDC, connection_MetadataTable_activatedCDC, connection_MetadataTable_tableType, connection_MetadataTable_sourceName}
...
connection_AbstractMetadataObject.attributes={connection_AbstractMetadataObject_comment, connection_AbstractMetadataObject_label, connection_AbstractMetadataObject_id, connection_AbstractMetadataObject_properties, connection_AbstractMetadataObject_synchronised, connection_AbstractMetadataObject_divergency, connection_AbstractMetadataObject_readOnly}
...
connection_MetadataColumn.attributes={connection_MetadataColumn_sourceType, connection_MetadataColumn_displayField, connection_MetadataColumn_talendType, connection_MetadataColumn_pattern, connection_MetadataColumn_nullable, connection_MetadataColumn_relationshipType, connection_MetadataColumn_originalLength, connection_MetadataColumn_relatedEntity, connection_MetadataColumn_key, connection_MetadataColumn_originalField, connection_MetadataColumn_defaultValue}
...
connection_FileConnection.attributes={connection_FileConnection_TextEnclosure, connection_FileConnection_Server, connection_FileConnection_EscapeType, connection_FileConnection_RowSeparatorValue, connection_FileConnection_Encoding, connection_FileConnection_FilePath, connection_FileConnection_UseLimit, connection_FileConnection_RowSeparatorType, connection_FileConnection_FirstLineCaption, connection_FileConnection_EscapeChar, connection_FileConnection_RemoveEmptyRow, connection_FileConnection_UseHeader, connection_FileConnection_FooterValue, connection_FileConnection_Format, connection_FileConnection_UseFooter, connection_FileConnection_CsvOption, connection_FileConnection_LimitValue, connection_FileConnection_TextIdentifier, connection_FileConnection_HeaderValue, connection_FileConnection_FieldSeparatorValue}
...
connection_MDMConnection.attributes={connection_MDMConnection_Password, connection_MDMConnection_Port, connection_MDMConnection_protocol, connection_MDMConnection_context, connection_MDMConnection_Datacluster, connection_MDMConnection_Universe, connection_MDMConnection_Datamodel, connection_MDMConnection_Username, connection_MDMConnection_Server}
...
connection_Concept.attributes={connection_Concept_LoopExpression, connection_Concept_xPathPrefix, connection_Concept_LoopLimit, connection_Concept_conceptType, connection_Concept_inputModel}
...
connection_DatabaseConnection.attributes={connection_DatabaseConnection_DatabaseType, connection_DatabaseConnection_ServerName, connection_DatabaseConnection_DriverClass, connection_DatabaseConnection_dbVersionString, connection_DatabaseConnection_Username, connection_DatabaseConnection_DBRootPath, connection_DatabaseConnection_AdditionalParams, connection_DatabaseConnection_StandardSQL, connection_DatabaseConnection_FileFieldName, connection_DatabaseConnection_Password, connection_DatabaseConnection_UiSchema, connection_DatabaseConnection_URL, connection_DatabaseConnection_DriverJarPath, connection_DatabaseConnection_DbmsId, connection_DatabaseConnection_ProductId, connection_DatabaseConnection_Port, connection_DatabaseConnection_SqlSynthax, connection_DatabaseConnection_NullChar, connection_DatabaseConnection_SystemSQL, connection_DatabaseConnection_cdcTypeMode, connection_DatabaseConnection_DatasourceName, connection_DatabaseConnection_SID, connection_DatabaseConnection_StringQuote, connection_DatabaseConnection_SQLMode}
...
connection_SAPIDocUnit.attributes={connection_SAPIDocUnit_htmlFile, connection_SAPIDocUnit_useHtmlOutput, connection_SAPIDocUnit_gatewayService, connection_SAPIDocUnit_useXmlOutput, connection_SAPIDocUnit_programId, connection_SAPIDocUnit_xmlFile}
...
connection_SAPConnection.attributes={connection_SAPConnection_jcoVersion, connection_SAPConnection_Host, connection_SAPConnection_Username, connection_SAPConnection_Client, connection_SAPConnection_currentFucntion, connection_SAPConnection_Password, connection_SAPConnection_Language, connection_SAPConnection_SystemNumber}
...
connection_SAPFunctionParameterColumn.attributes={connection_SAPFunctionParameterColumn_ParameterType, connection_SAPFunctionParameterColumn_Length, connection_SAPFunctionParameterColumn_Value, connection_SAPFunctionParameterColumn_StructureOrTableName, connection_SAPFunctionParameterColumn_DataType}
...
connection_XmlFileConnection.attributes={connection_XmlFileConnection_fileContent, connection_XmlFileConnection_XmlFilePath, connection_XmlFileConnection_MaskXPattern, connection_XmlFileConnection_Encoding, connection_XmlFileConnection_Guess, connection_XmlFileConnection_XsdFilePath, connection_XmlFileConnection_inputModel, connection_XmlFileConnection_outputFilePath}
...
connection_XMLFileNode.attributes={connection_XMLFileNode_Attribute, connection_XMLFileNode_XMLPath, connection_XMLFileNode_RelatedColumn, connection_XMLFileNode_DefaultValue, connection_XMLFileNode_Type, connection_XMLFileNode_Order}
...
connection_LDAPSchemaConnection.attributes={connection_LDAPSchemaConnection_CountLimit, connection_LDAPSchemaConnection_Protocol, connection_LDAPSchemaConnection_Referrals, connection_LDAPSchemaConnection_BindPassword, connection_LDAPSchemaConnection_SelectedDN, connection_LDAPSchemaConnection_LimitValue, connection_LDAPSchemaConnection_StorePath, connection_LDAPSchemaConnection_EncryptionMethodName, connection_LDAPSchemaConnection_TimeOutLimit, connection_LDAPSchemaConnection_Port, connection_LDAPSchemaConnection_GetBaseDNsFromRoot, connection_LDAPSchemaConnection_Separator, connection_LDAPSchemaConnection_BaseDNs, connection_LDAPSchemaConnection_Filter, connection_LDAPSchemaConnection_Value, connection_LDAPSchemaConnection_BindPrincipal, connection_LDAPSchemaConnection_UseLimit, connection_LDAPSchemaConnection_UseAdvanced, connection_LDAPSchemaConnection_ReturnAttributes, connection_LDAPSchemaConnection_Host, connection_LDAPSchemaConnection_UseAuthen, connection_LDAPSchemaConnection_SavePassword, connection_LDAPSchemaConnection_Aliases}
...
connection_LdifFileConnection.attributes={connection_LdifFileConnection_UseLimit, connection_LdifFileConnection_value, connection_LdifFileConnection_FilePath, connection_LdifFileConnection_LimitEntry, connection_LdifFileConnection_Server}
...
connection_FileExcelConnection.attributes={connection_FileExcelConnection_decimalSeparator, connection_FileExcelConnection_firstColumn, connection_FileExcelConnection_sheetList, connection_FileExcelConnection_sheetColumns, connection_FileExcelConnection_selectAllSheets, connection_FileExcelConnection_lastColumn, connection_FileExcelConnection_SheetName, connection_FileExcelConnection_thousandSeparator, connection_FileExcelConnection_advancedSpearator}
...
connection_WSDLSchemaConnection.attributes={connection_WSDLSchemaConnection_portNameSpace, connection_WSDLSchemaConnection_proxyPort, connection_WSDLSchemaConnection_proxyPassword, connection_WSDLSchemaConnection_isInputModel, connection_WSDLSchemaConnection_Encoding, connection_WSDLSchemaConnection_proxyHost, connection_WSDLSchemaConnection_Password, connection_WSDLSchemaConnection_serverNameSpace, connection_WSDLSchemaConnection_Value, connection_WSDLSchemaConnection_portName, connection_WSDLSchemaConnection_timeOut, connection_WSDLSchemaConnection_proxyUser, connection_WSDLSchemaConnection_UserName, connection_WSDLSchemaConnection_WSDL, connection_WSDLSchemaConnection_needAuth, connection_WSDLSchemaConnection_parameters, connection_WSDLSchemaConnection_useProxy, connection_WSDLSchemaConnection_EndpointURI, connection_WSDLSchemaConnection_methodName, connection_WSDLSchemaConnection_serverName}
...
connection_CDCType.attributes={connection_CDCType_linkDB, connection_CDCType_journalName}
...
connection_WSDLParameter.attributes={connection_WSDLParameter_ParameterInfo, connection_WSDLParameter_Element, connection_WSDLParameter_ParameterInfoParent, connection_WSDLParameter_Column, connection_WSDLParameter_source, connection_WSDLParameter_Expression}
...
connection_SalesforceSchemaConnection.attributes={connection_SalesforceSchemaConnection_proxyPassword, connection_SalesforceSchemaConnection_password, connection_SalesforceSchemaConnection_queryCondition, connection_SalesforceSchemaConnection_userName, connection_SalesforceSchemaConnection_proxyPort, connection_SalesforceSchemaConnection_proxyHost, connection_SalesforceSchemaConnection_timeOut, connection_SalesforceSchemaConnection_batchSize, connection_SalesforceSchemaConnection_useCustomModuleName, connection_SalesforceSchemaConnection_webServiceUrl, connection_SalesforceSchemaConnection_useProxy, connection_SalesforceSchemaConnection_moduleName, connection_SalesforceSchemaConnection_proxyUsername, connection_SalesforceSchemaConnection_useAlphbet, connection_SalesforceSchemaConnection_useHttpProxy}
...
connection_HL7Connection.attributes={connection_HL7Connection_StartChar, connection_HL7Connection_outputFilePath, connection_HL7Connection_EndChar}
...
connection_HL7FileNode.attributes={connection_HL7FileNode_FilePath, connection_HL7FileNode_Order, connection_HL7FileNode_RelatedColumn, connection_HL7FileNode_DefaultValue, connection_HL7FileNode_Repeatable, connection_HL7FileNode_Attribute}
...
connection_HeaderFooterConnection.attributes={connection_HeaderFooterConnection_mainCode, connection_HeaderFooterConnection_libraries, connection_HeaderFooterConnection_isHeader, connection_HeaderFooterConnection_imports}
...
connection_FTPConnection.attributes={connection_FTPConnection_Proxypassword, connection_FTPConnection_Proxyhost, connection_FTPConnection_Method, connection_FTPConnection_Port, connection_FTPConnection_Host, connection_FTPConnection_FTPS, connection_FTPConnection_Ecoding, connection_FTPConnection_KeystoreFile, connection_FTPConnection_Usesocks, connection_FTPConnection_SFTP, connection_FTPConnection_Mode, connection_FTPConnection_Proxyport, connection_FTPConnection_Password, connection_FTPConnection_Proxyuser, connection_FTPConnection_CustomEncode, connection_FTPConnection_KeystorePassword, connection_FTPConnection_Username}
...
connection_ConditionType.attributes={connection_ConditionType_value, connection_ConditionType_inputColumn, connection_ConditionType_function, connection_ConditionType_operator}
...
connection_BRMSConnection.attributes={connection_BRMSConnection_xmlField, connection_BRMSConnection_className, connection_BRMSConnection_tacWebappName, connection_BRMSConnection_package, connection_BRMSConnection_moduleUsed, connection_BRMSConnection_urlName}
...
connection_ValidationRulesConnection.attributes={connection_ValidationRulesConnection_baseSchema, connection_ValidationRulesConnection_refColumnNames, connection_ValidationRulesConnection_isDelete, connection_ValidationRulesConnection_isRejectLink, connection_ValidationRulesConnection_logicalOperator, connection_ValidationRulesConnection_isUpdate, connection_ValidationRulesConnection_isDisallow, connection_ValidationRulesConnection_type, connection_ValidationRulesConnection_baseColumnNames, connection_ValidationRulesConnection_isSelect, connection_ValidationRulesConnection_isInsert, connection_ValidationRulesConnection_javaCondition, connection_ValidationRulesConnection_refSchema, connection_ValidationRulesConnection_sqlCondition}
...
connection_EDIFACTConnection.attributes={connection_EDIFACTConnection_XmlPath, connection_EDIFACTConnection_XmlName, connection_EDIFACTConnection_FileName}
...
connection_EDIFACTColumn.attributes={connection_EDIFACTColumn_EDIXpath, connection_EDIFACTColumn_EDIColumnName}
...
connection_InnerJoinMap.attributes={connection_InnerJoinMap_value, connection_InnerJoinMap_key}
...
connection_relational_TdSqlDataType.attributes={connection_relational_TdSqlDataType_localTypeName, connection_relational_TdSqlDataType_autoIncrement, connection_relational_TdSqlDataType_unsignedAttribute, connection_relational_TdSqlDataType_searchable, connection_relational_TdSqlDataType_caseSensitive, connection_relational_TdSqlDataType_nullable, connection_relational_TdSqlDataType_javaDataType}
...
connection_relational_TdExpression.attributes={connection_relational_TdExpression_name, connection_relational_TdExpression_modificationDate, connection_relational_TdExpression_version}
...
connection60: BinaryAssociation = BinaryAssociation(
    name="connection60",
    ends={
...
cdcTypes61: BinaryAssociation = BinaryAssociation(
    name="cdcTypes61",
    ends={
...
subscribers62: BinaryAssociation = BinaryAssociation(
    name="subscribers62",
    ends={
        Property(name="connection_SubscriberTable", type=connection_CDCType, multiplicity=Multiplicity(1, 1)),
        Property(name="connection_CDCType63", type=connection_SubscriberTable, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
cdcConnection64: BinaryAssociation = BinaryAssociation(
    name="cdcConnection64",
    ends={
        Property(name="connection_CDCConnection66", type=connection_CDCType, multiplicity=Multiplicity(1, 1)),
        Property(name="connection_CDCType65", type=connection_CDCConnection, multiplicity=Multiplicity(0, 1))
    }
)
...
modules58: BinaryAssociation = BinaryAssociation(
    name="modules58",
    ends={
        Property(name="SalesforceModuleUnit", type=connection_SalesforceSchemaConnection, multiplicity=Multiplicity(1, 1)),
        Property(name="connection59", type=connection_SalesforceModuleUnit, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
schema80: BinaryAssociation = BinaryAssociation(
    name="schema80",
    ends={
...
root81: BinaryAssociation = BinaryAssociation(
    name="root81",
    ends={
...
functionUnit67: BinaryAssociation = BinaryAssociation(
    name="functionUnit67",
    ends={
        Property(name="SAPFunctionUnit68", type=connection_SAPTestInputParameterTable, multiplicity=Multiplicity(1, 1)),
        Property(name="TestInputParameterTable", type=connection_SAPFunctionUnit, multiplicity=Multiplicity(0, 1))
    }
)
conceptTargets69: BinaryAssociation = BinaryAssociation(
    name="conceptTargets69",
    ends={
        Property(name="ConceptTarget", type=connection_Concept, multiplicity=Multiplicity(1, 1)),
        Property(name="schema70", type=connection_ConceptTarget, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
group71: BinaryAssociation = BinaryAssociation(
    name="group71",
    ends={
        Property(name="connection_XMLFileNode73", type=connection_Concept, multiplicity=Multiplicity(1, 1)),
        Property(name="connection_Concept72", type=connection_XMLFileNode, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
root74: BinaryAssociation = BinaryAssociation(
    name="root74",
    ends={
        Property(name="connection_XMLFileNode76", type=connection_Concept, multiplicity=Multiplicity(1, 1)),
        Property(name="connection_Concept75", type=connection_XMLFileNode, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
loop77: BinaryAssociation = BinaryAssociation(
    name="loop77",
    ends={
        Property(name="connection_XMLFileNode79", type=connection_Concept, multiplicity=Multiplicity(1, 1)),
        Property(name="connection_Concept78", type=connection_XMLFileNode, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
conditions90: BinaryAssociation = BinaryAssociation(
    name="conditions90",
    ends={
...
root82: BinaryAssociation = BinaryAssociation(
    name="root82",
    ends={
        Property(name="connection_XMLFileNode83", type=connection_BRMSConnection, multiplicity=Multiplicity(1, 1)),
        Property(name="connection_BRMSConnection", type=connection_XMLFileNode, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
group84: BinaryAssociation = BinaryAssociation(
    name="group84",
    ends={
        Property(name="connection_XMLFileNode86", type=connection_BRMSConnection, multiplicity=Multiplicity(1, 1)),
        Property(name="connection_BRMSConnection85", type=connection_XMLFileNode, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
loop87: BinaryAssociation = BinaryAssociation(
    name="loop87",
    ends={
        Property(name="connection_XMLFileNode89", type=connection_BRMSConnection, multiplicity=Multiplicity(1, 1)),
        Property(name="connection_BRMSConnection88", type=connection_XMLFileNode, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
MetadataTable93: BinaryAssociation = BinaryAssociation(
    name="MetadataTable93",
    ends={
        Property(name="connection_MetadataTable94", type=connection_SalesforceModuleUnit, multiplicity=Multiplicity(1, 1)),
...
innerJoins91: BinaryAssociation = BinaryAssociation(
    name="innerJoins91",
    ends={
        Property(name="connection_InnerJoinMap", type=connection_ValidationRulesConnection, multiplicity=Multiplicity(1, 1)),
        Property(name="connection_ValidationRulesConnection92", type=connection_InnerJoinMap, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
connection95: BinaryAssociation = BinaryAssociation(
    name="connection95",
    ends={
...
tables96: BinaryAssociation = BinaryAssociation(
    name="tables96",
    ends={
        Property(name="connection_MetadataTable98", type=connection_SalesforceModuleUnit, multiplicity=Multiplicity(1, 1)),
        Property(name="connection_SalesforceModuleUnit97", type=connection_MetadataTable, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
sqlDataType99: BinaryAssociation = BinaryAssociation(
    name="sqlDataType99",
    ends={
...
xsdElementDeclaration100: BinaryAssociation = BinaryAssociation(
    name="xsdElementDeclaration100",
    ends={
...
ownedDocument101: BinaryAssociation = BinaryAssociation(
    name="ownedDocument101",
    ends={
        Property(name="xml_TdXmlSchema", type=connection_xml_TdXmlElementType, multiplicity=Multiplicity(1, 1)),
        Property(name="connection_xml_TdXmlElementType102", type=xml_TdXmlSchema, multiplicity=Multiplicity(0, 1))
    }
)
xmlContent103: BinaryAssociation = BinaryAssociation(
    name="xmlContent103",
    ends={
        Property(name="xml_TdXmlContent", type=connection_xml_TdXmlElementType, multiplicity=Multiplicity(1, 1)),
        Property(name="connection_xml_TdXmlElementType104", type=xml_TdXmlContent, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
xmlElements105: BinaryAssociation = BinaryAssociation(
    name="xmlElements105",
    ends={
...
domain_model = DomainModel(
    name="connection",
    types={connection_Metadata, AbstractMetadataObject, connection_Connection, softwaredeployment_DataProvider, connection_QueriesConnection, connection_MetadataTable, connection_AbstractMetadataObject, connection_MetadataColumn, record_Field, connection_FileConnection, Connection, ModelElement, core_Class, connection_MDMConnection, connection_Concept, connection_DelimitedFileConnection, FileConnection, connection_PositionalFileConnection, connection_EbcdicConnection, connection_DatabaseConnection, connection_SAPFunctionUnit, connection_SAPIDocUnit, connection_CDCConnection, connection_SAPConnection, connection_SAPFunctionParameterColumn, connection_SAPFunctionParameterTable, connection_InputSAPFunctionParameterTable, connection_OutputSAPFunctionParameterTable, connection_SAPTestInputParameterTable, connection_SchemaTarget, SAPFunctionParameterTable, connection_RegexpFileConnection, connection_XmlFileConnection, connection_XmlXPathLoopDescriptor, connection_XMLFileNode, connection_GenericSchemaConnection, connection_LDAPSchemaConnection, connection_Query, connection_LdifFileConnection, connection_FileExcelConnection, connection_WSDLSchemaConnection, connection_CDCType, connection_SubscriberTable, connection_WSDLParameter, connection_SalesforceSchemaConnection, connection_SalesforceModuleUnit, connection_HL7Connection, connection_HL7FileNode, connection_HeaderFooterConnection, TdTable, connection_ConceptTarget, connection_FTPConnection, connection_GenericPackage, Package, connection_ConditionType, connection_BRMSConnection, connection_ValidationRulesConnection, connection_EDIFACTConnection, connection_EDIFACTColumn, MetadataColumn, connection_InnerJoinMap, connection_relational_TdTable, MetadataTable, relational_Table, connection_relational_TdView, relational_View, connection_relational_TdColumn, relational_TdSqlDataType, connection_relational_TdSqlDataType, SQLSimpleType, connection_relational_TdTrigger, Trigger, connection_relational_TdProcedure, Procedure, connection_relational_TdExpression, Expression, connection_softwaredeployment_TdDataManager, DataManager, connection_softwaredeployment_TdSoftwareSystem, SoftwareSystem, xml_connection_EObject, connection_softwaredeployment_TdMachine, Machine, xml_TdXmlSchema, connection_xml_TdXmlElementType, ElementType, xml_TdXmlContent, connection_xml_TdXmlContent, Content, xml_TdXmlElementType, connection_xml_TdXmlSchema, Schema, FileFormat, FieldSeparator, Escape, RowSeparator, MDMConnectionProtocol, MdmConceptType, LogicalOperator, RuleType, Function, Operator, DevelopmentStatus},
    associations={connections0, queries1, table2, columns3, connection6, schemas9, Funtions12, IDocs14, cdcConns10, ParameterTable29, InputParameterTable16, OutputParameterTable17, MetadataTable19, connection21, tables22, TestInputParameterTable25, connection27, root38, loop41, schema44, columns30, functionUnit31, functionUnit33, schema35, group37, connection51, schemaTargets52, connection46, query47, queries49, connection60, cdcTypes61, subscribers62, cdcConnection64, parameterValue54, outputParameter55, modules58, schema80, root81, functionUnit67, conceptTargets69, group71, root74, loop77, conditions90, root82, group84, loop87, MetadataTable93, innerJoins91, connection95, tables96, sqlDataType99, xsdElementDeclaration100, ownedDocument101, xmlContent103, xmlElements105},
    generalizations={gen_connection_Metadata_AbstractMetadataObject, gen_connection_Connection_AbstractMetadataObject, gen_connection_Connection_softwaredeployment_DataProvider, gen_connection_MetadataColumn_AbstractMetadataObject, gen_connection_MetadataColumn_record_Field, gen_connection_FileConnection_Connection, gen_connection_AbstractMetadataObject_ModelElement, gen_connection_MetadataTable_AbstractMetadataObject, gen_connection_MetadataTable_core_Class, gen_connection_MDMConnection_Connection, gen_connection_DelimitedFileConnection_FileConnection, gen_connection_PositionalFileConnection_FileConnection, gen_connection_EbcdicConnection_FileConnection, gen_connection_DatabaseConnection_Connection, gen_connection_SAPFunctionUnit_AbstractMetadataObject, gen_connection_SAPConnection_Connection, gen_connection_SAPFunctionParameterColumn_AbstractMetadataObject, gen_connection_SAPIDocUnit_AbstractMetadataObject, gen_connection_SAPFunctionParameterTable_AbstractMetadataObject, gen_connection_InputSAPFunctionParameterTable_SAPFunctionParameterTable, gen_connection_OutputSAPFunctionParameterTable_SAPFunctionParameterTable, gen_connection_RegexpFileConnection_FileConnection, gen_connection_XmlFileConnection_Connection, gen_connection_GenericSchemaConnection_Connection, gen_connection_LDAPSchemaConnection_Connection, gen_connection_Query_AbstractMetadataObject, gen_connection_LdifFileConnection_Connection, gen_connection_FileExcelConnection_FileConnection, gen_connection_WSDLSchemaConnection_Connection, gen_connection_CDCType_AbstractMetadataObject, gen_connection_SalesforceSchemaConnection_Connection, gen_connection_HL7Connection_FileConnection, gen_connection_SubscriberTable_TdTable, gen_connection_SAPTestInputParameterTable_SAPFunctionParameterTable, gen_connection_Concept_TdTable, gen_connection_FTPConnection_Connection, gen_connection_HeaderFooterConnection_Connection, gen_connection_GenericPackage_Package, gen_connection_BRMSConnection_Connection, gen_connection_ValidationRulesConnection_Connection, gen_connection_EDIFACTConnection_Connection, gen_connection_EDIFACTColumn_MetadataColumn, gen_connection_SalesforceModuleUnit_AbstractMetadataObject, gen_connection_relational_TdTable_MetadataTable, gen_connection_relational_TdTable_relational_Table, gen_connection_relational_TdView_MetadataTable, gen_connection_relational_TdView_relational_View, gen_connection_relational_TdColumn_MetadataColumn, gen_connection_relational_TdSqlDataType_SQLSimpleType, gen_connection_relational_TdTrigger_Trigger, gen_connection_relational_TdProcedure_Procedure, gen_connection_relational_TdExpression_Expression, gen_connection_softwaredeployment_TdDataManager_DataManager, gen_connection_softwaredeployment_TdSoftwareSystem_SoftwareSystem, gen_connection_softwaredeployment_TdMachine_Machine, gen_connection_xml_TdXmlElementType_ElementType, gen_connection_xml_TdXmlContent_Content, gen_connection_xml_TdXmlSchema_Schema},
    metadata=None
)
