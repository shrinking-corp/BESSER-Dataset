...
public class connection_SAPConnection extends Connection {
    ...
    public connection_SAPConnection(
        String jcoVersion,        String Host,        String Username,        String Client,        String SystemNumber,        String Password,        String Language,        String currentFucntion    ) {
        super(
        );
    ...
    public connection_SAPConnection(
        String jcoVersion,        String Host,        String Username,        String Client,        String SystemNumber,        String Password,        String Language,        String currentFucntion        ArrayList<connection_SAPIDocUnit> connection_sapidocunits,        ArrayList<connection_SAPFunctionUnit> connection_sapfunctionunits    ) {
        this.jcoVersion = jcoVersion;
        this.Host = Host;
        this.Username = Username;
        this.Client = Client;
