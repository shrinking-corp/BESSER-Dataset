...
testPackage_ExistsInBoth_strategy = st.builds(testPackage_ExistsInBoth)
...
testPackage_sub_OnlyInWorkingCopy_strategy = st.builds(testPackage_sub_OnlyInWorkingCopy)
