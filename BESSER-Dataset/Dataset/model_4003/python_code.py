...
class JavaMM_Type(ABC):
    ...
    def __init__(self, name: str, JavaMM_Type15: "JavaMM_Container" = None, JavaMM_Type: "JavaMM_Attribute" = None):
        self.name = name
...
class JavaMM_Attribute:
    ...
    def __init__(self, name: str, visibility: str, JavaMM_Attribute12: set["JavaMM_Annotation"] = None, JavaMM_Attribute: "JavaMM_Class" = None, JavaMM_Attribute10: "JavaMM_Type" = None):
        self.name = name
