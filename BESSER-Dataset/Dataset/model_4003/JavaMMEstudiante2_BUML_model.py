...
# Classes
JavaMM_Attribute = Class(name="JavaMM_Attribute")
JavaMM_Type = Class(name="JavaMM_Type", is_abstract=True)
JavaMM_Program = Class(name="JavaMM_Program")
JavaMM_Package = Class(name="JavaMM_Package")
JavaMM_PrimitiveType = Class(name="JavaMM_PrimitiveType")
JavaMM_Container = Class(name="JavaMM_Container")
JavaMM_Class = Class(name="JavaMM_Class", is_abstract=True)
Type = Class(name="Type")
JavaMM_Annotation = Class(name="JavaMM_Annotation")
JavaMM_EntityClass = Class(name="JavaMM_EntityClass")
Class_ = Class(name="Class")
JavaMM_DAOClass = Class(name="JavaMM_DAOClass")
JavaMM_TestClass = Class(name="JavaMM_TestClass")
...
JavaMM_Annotation.attributes={JavaMM_Annotation_content, JavaMM_Annotation_type}
...
domain_model = DomainModel(
    name="JavaMM",
    types={JavaMM_Attribute, JavaMM_Type, JavaMM_Program, JavaMM_Package, JavaMM_PrimitiveType, JavaMM_Container, JavaMM_Class, Type, JavaMM_Annotation, JavaMM_EntityClass, Class_, JavaMM_DAOClass, JavaMM_TestClass, Visibility},
    associations={attributes7, type9, packages0, primitiveTypes1, containerTypes3, classes5, annotations11, param13, entities16, dao17, entity19},
