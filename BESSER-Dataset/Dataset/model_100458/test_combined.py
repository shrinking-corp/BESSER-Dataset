...
def test_hyp_stext_eventraisedreferenceexpression_is_not_abstract():
    assert not inspect.isabstract(stext_EventRaisedReferenceExpression)


def test_hyp_stext_eventraisedreferenceexpression_constructor_exists():
    assert callable(stext_EventRaisedReferenceExpression.__init__)


def test_hyp_stext_eventraisedreferenceexpression_constructor_args():
