...
def test_stext_regularstate_is_not_abstract():
    assert not inspect.isabstract(stext_RegularState)


def test_stext_regularstate_constructor_exists():
    assert callable(stext_RegularState.__init__)


def test_stext_regularstate_constructor_args():
...
def test_stext_eventraisedreferenceexpression_is_not_abstract():
    assert not inspect.isabstract(stext_EventRaisedReferenceExpression)


def test_stext_eventraisedreferenceexpression_constructor_exists():
    assert callable(stext_EventRaisedReferenceExpression.__init__)


def test_stext_eventraisedreferenceexpression_constructor_args():
    sig = inspect.signature(stext_EventRaisedReferenceExpression.__init__)
    params = list(sig.parameters.keys())
...
stext_EventRaisedReferenceExpression_strategy = st.builds(
    stext_EventRaisedReferenceExpression,
)
