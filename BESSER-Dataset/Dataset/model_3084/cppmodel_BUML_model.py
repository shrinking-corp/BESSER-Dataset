...
# Classes
cppmodel_CPPNamedElement = Class(name="cppmodel_CPPNamedElement", is_abstract=True)
cppmodel_OOPLNameProvider = Class(name="cppmodel_OOPLNameProvider")
cppmodel_CPPQualifiedNamedElement = Class(name="cppmodel_CPPQualifiedNamedElement", is_abstract=True)
CPPNamedElement = Class(name="CPPNamedElement")
cppmodel_CPPModel = Class(name="cppmodel_CPPModel")
CPPQualifiedNamedElement = Class(name="CPPQualifiedNamedElement")
cppmodel_Model = Class(name="cppmodel_Model")
cppmodel_CPPBodyFile = Class(name="cppmodel_CPPBodyFile")
cppmodel_CPPHeaderFile = Class(name="cppmodel_CPPHeaderFile")
cppmodel_CPPDirectory = Class(name="cppmodel_CPPDirectory")
cppmodel_CPPProtocol = Class(name="cppmodel_CPPProtocol")
cppmodel_CPPPackage = Class(name="cppmodel_CPPPackage")
cppmodel_Package = Class(name="cppmodel_Package")
cppmodel_CPPClass = Class(name="cppmodel_CPPClass")
OOPLClass = Class(name="OOPLClass")
cppmodel_XTProtocol = Class(name="cppmodel_XTProtocol")
cppmodel_CPPSourceFile = Class(name="cppmodel_CPPSourceFile", is_abstract=True)
cppmodel_CPPExternalHeaderInclusion = Class(name="cppmodel_CPPExternalHeaderInclusion")
CPPSourceFile = Class(name="CPPSourceFile")
cppmodel_CPPComponent = Class(name="cppmodel_CPPComponent")
cppmodel_CPPMakeFile = Class(name="cppmodel_CPPMakeFile")
cppmodel_XTComponent = Class(name="cppmodel_XTComponent")
cppmodel_CPPPort = Class(name="cppmodel_CPPPort")
cppmodel_CPPExternalHeader = Class(name="cppmodel_CPPExternalHeader")
cppmodel_CPPRelation = Class(name="cppmodel_CPPRelation")
OOPLRelation = Class(name="OOPLRelation")
cppmodel_CPPOperation = Class(name="cppmodel_CPPOperation")
cppmodel_Operation = Class(name="cppmodel_Operation")
cppmodel_Signal = Class(name="cppmodel_Signal")
cppmodel_Snippet = Class(name="cppmodel_Snippet")
cppmodel_XTPort = Class(name="cppmodel_XTPort")
cppmodel_CPPProtocolOperationDefinition = Class(name="cppmodel_CPPProtocolOperationDefinition")
cppmodel_XTProtocolOperationDefinition = Class(name="cppmodel_XTProtocolOperationDefinition")
cppmodel_CPPSignal = Class(name="cppmodel_CPPSignal")
cppmodel_CPPProtocolOperationImplementation = Class(name="cppmodel_CPPProtocolOperationImplementation")
cppmodel_XTProtocolOperationImplementation = Class(name="cppmodel_XTProtocolOperationImplementation")
cppmodel_CPPClassReference = Class(name="cppmodel_CPPClassReference")
OOPLClassReference = Class(name="OOPLClassReference")
cppmodel_CPPClassReferenceStorage = Class(name="cppmodel_CPPClassReferenceStorage")
OOPLClassReferenceStorage = Class(name="OOPLClassReferenceStorage")
cppmodel_CPPClassRefSimpleCollection = Class(name="cppmodel_CPPClassRefSimpleCollection")
OOPLClassRefSimpleCollection = Class(name="OOPLClassRefSimpleCollection")
cppmodel_CPPTransition = Class(name="cppmodel_CPPTransition")
cppmodel_CPPClassRefAssocCollection = Class(name="cppmodel_CPPClassRefAssocCollection")
OOPLClassRefAssocCollection = Class(name="OOPLClassRefAssocCollection")
cppmodel_CPPAttribute = Class(name="cppmodel_CPPAttribute")
cppmodel_Attribute = Class(name="cppmodel_Attribute")
cppmodel_CPPSequence = Class(name="cppmodel_CPPSequence")
cppmodel_OOPLDataType = Class(name="cppmodel_OOPLDataType")
cppmodel_CPPState = Class(name="cppmodel_CPPState")
cppmodel_State = Class(name="cppmodel_State")
cppmodel_TypedMultiplicityElement = Class(name="cppmodel_TypedMultiplicityElement")
cppmodel_Transition = Class(name="cppmodel_Transition")
cppmodel_CPPEvent = Class(name="cppmodel_CPPEvent")
cppmodel_XTEvent = Class(name="cppmodel_XTEvent")
cppmodel_CPPFormalParameter = Class(name="cppmodel_CPPFormalParameter")
cppmodel_Parameter = Class(name="cppmodel_Parameter")
cppmodel_CPPReturnValue = Class(name="cppmodel_CPPReturnValue")
cppmodel_CPPExternalBridge = Class(name="cppmodel_CPPExternalBridge")
cppmodel_CPPExternalLibrary = Class(name="cppmodel_CPPExternalLibrary")
cppmodel_CPPBasicType = Class(name="cppmodel_CPPBasicType")
OOPLBasicType = Class(name="OOPLBasicType")
OOPLSequence = Class(name="OOPLSequence")
cppmodel_CPPEnumType = Class(name="cppmodel_CPPEnumType")
OOPLEnumType = Class(name="OOPLEnumType")
cppmodel_CPPEnumerator = Class(name="cppmodel_CPPEnumerator")
OOPLEnumerator = Class(name="OOPLEnumerator")
cppmodel_CPPStructType = Class(name="cppmodel_CPPStructType")
OOPLStructType = Class(name="OOPLStructType")
cppmodel_CPPStructMember = Class(name="cppmodel_CPPStructMember")
OOPLStructMember = Class(name="OOPLStructMember")
cppmodel_CPPUserDefinedType = Class(name="cppmodel_CPPUserDefinedType")
OOPLUserDefinedType = Class(name="OOPLUserDefinedType")
cppmodel_XTClass = Class(name="cppmodel_XTClass")
...
cppmodel_CPPHeaderFile.attributes={cppmodel_CPPHeaderFile_includePath, cppmodel_CPPHeaderFile_includeName, cppmodel_CPPHeaderFile_includeDirectory}
...
cppmodel_CPPDirectory.attributes={cppmodel_CPPDirectory_parentDirectory, cppmodel_CPPDirectory_path, cppmodel_CPPDirectory_name}
...
cppmodel_CPPSourceFile.attributes={cppmodel_CPPSourceFile_generationName, cppmodel_CPPSourceFile_generationPath, cppmodel_CPPSourceFile_generationDirectory}
...
domain_model = DomainModel(
    name="cppmodel",
    types={cppmodel_CPPNamedElement, cppmodel_OOPLNameProvider, cppmodel_CPPQualifiedNamedElement, CPPNamedElement, cppmodel_CPPModel, CPPQualifiedNamedElement, cppmodel_Model, cppmodel_CPPBodyFile, cppmodel_CPPHeaderFile, cppmodel_CPPDirectory, cppmodel_CPPProtocol, cppmodel_CPPPackage, cppmodel_Package, cppmodel_CPPClass, OOPLClass, cppmodel_XTProtocol, cppmodel_CPPSourceFile, cppmodel_CPPExternalHeaderInclusion, CPPSourceFile, cppmodel_CPPComponent, cppmodel_CPPMakeFile, cppmodel_XTComponent, cppmodel_CPPPort, cppmodel_CPPExternalHeader, cppmodel_CPPRelation, OOPLRelation, cppmodel_CPPOperation, cppmodel_Operation, cppmodel_Signal, cppmodel_Snippet, cppmodel_XTPort, cppmodel_CPPProtocolOperationDefinition, cppmodel_XTProtocolOperationDefinition, cppmodel_CPPSignal, cppmodel_CPPProtocolOperationImplementation, cppmodel_XTProtocolOperationImplementation, cppmodel_CPPClassReference, OOPLClassReference, cppmodel_CPPClassReferenceStorage, OOPLClassReferenceStorage, cppmodel_CPPClassRefSimpleCollection, OOPLClassRefSimpleCollection, cppmodel_CPPTransition, cppmodel_CPPClassRefAssocCollection, OOPLClassRefAssocCollection, cppmodel_CPPAttribute, cppmodel_Attribute, cppmodel_CPPSequence, cppmodel_OOPLDataType, cppmodel_CPPState, cppmodel_State, cppmodel_TypedMultiplicityElement, cppmodel_Transition, cppmodel_CPPEvent, cppmodel_XTEvent, cppmodel_CPPFormalParameter, cppmodel_Parameter, cppmodel_CPPReturnValue, cppmodel_CPPExternalBridge, cppmodel_CPPExternalLibrary, cppmodel_CPPBasicType, OOPLBasicType, OOPLSequence, cppmodel_CPPEnumType, OOPLEnumType, cppmodel_CPPEnumerator, OOPLEnumerator, cppmodel_CPPStructType, OOPLStructType, cppmodel_CPPStructMember, OOPLStructMember, cppmodel_CPPUserDefinedType, OOPLUserDefinedType, cppmodel_XTClass, CPPParameterPassingKind},
    associations={ooplNameProvider0, externalHeaderDir19, subElements2, commonModel3, bodyFile4, declarationHeaderFile6, definitionHeaderFile8, apiHeaderFile11, headerDir14, bodyDir16, bodyFile40, externalBodySkeletonDir22, commonPackage25, bodyFile26, headerFile29, headerDir32, bodyDir35, headerFile38, xtProtocol43, headerFile44, includedHeaders47, externalHeaderInclusion49, subDirectories52, files54, makeRulesFile57, externalBodySkeletonDirectory81, xtComponent59, mainHeaderFile60, mainBodyFile63, declarationHeaderFile66, definitionHeaderFile69, headerDirectory72, bodyDirectory75, externalHeaderDirectory78, compiledBody87, externalHeader84, commonOperation86, commonSignal103, xtPort89, headerFile90, externalHeaderFile93, bodyFile96, externalBodySkeletonFile99, xtProtocolOperationDefinition102, xtProtocolOperationImplementation104, compiledExitBody116, cppAttribute105, commonAttribute106, unnamedSequenceType108, type110, commonState112, compiledEntryBody113, unnamedSequenceType136, commonTypedMultiplicityElement139, commonTransition119, compiledEffectBody120, compiledGuardBody123, xtEvent126, commonParameter127, unnamedSequenceType128, type131, type134, headerFile143, externalHeader141, bodyFile145, xtClass148},
    generalizations={gen_cppmodel_CPPQualifiedNamedElement_CPPNamedElement, gen_cppmodel_CPPModel_CPPQualifiedNamedElement, gen_cppmodel_CPPProtocol_CPPQualifiedNamedElement, gen_cppmodel_CPPPackage_CPPQualifiedNamedElement, gen_cppmodel_CPPClass_CPPQualifiedNamedElement, gen_cppmodel_CPPClass_OOPLClass, gen_cppmodel_CPPHeaderFile_CPPSourceFile, gen_cppmodel_CPPComponent_CPPQualifiedNamedElement, gen_cppmodel_CPPBodyFile_CPPSourceFile, gen_cppmodel_CPPRelation_CPPQualifiedNamedElement, gen_cppmodel_CPPRelation_OOPLRelation, gen_cppmodel_CPPOperation_CPPQualifiedNamedElement, gen_cppmodel_CPPPort_CPPQualifiedNamedElement, gen_cppmodel_CPPProtocolOperationDefinition_CPPQualifiedNamedElement, gen_cppmodel_CPPSignal_CPPQualifiedNamedElement, gen_cppmodel_CPPProtocolOperationImplementation_CPPQualifiedNamedElement, gen_cppmodel_CPPClassReference_OOPLClassReference, gen_cppmodel_CPPClassReference_CPPQualifiedNamedElement, gen_cppmodel_CPPClassReferenceStorage_CPPQualifiedNamedElement, gen_cppmodel_CPPClassReferenceStorage_OOPLClassReferenceStorage, gen_cppmodel_CPPClassRefSimpleCollection_CPPQualifiedNamedElement, gen_cppmodel_CPPClassRefSimpleCollection_OOPLClassRefSimpleCollection, gen_cppmodel_CPPTransition_CPPQualifiedNamedElement, gen_cppmodel_CPPClassRefAssocCollection_CPPQualifiedNamedElement, gen_cppmodel_CPPClassRefAssocCollection_OOPLClassRefAssocCollection, gen_cppmodel_CPPAttribute_CPPQualifiedNamedElement, gen_cppmodel_CPPState_CPPQualifiedNamedElement, gen_cppmodel_CPPEvent_CPPQualifiedNamedElement, gen_cppmodel_CPPFormalParameter_CPPQualifiedNamedElement, gen_cppmodel_CPPReturnValue_CPPQualifiedNamedElement, gen_cppmodel_CPPExternalBridge_CPPQualifiedNamedElement, gen_cppmodel_CPPBasicType_OOPLBasicType, gen_cppmodel_CPPBasicType_CPPQualifiedNamedElement, gen_cppmodel_CPPSequence_OOPLSequence, gen_cppmodel_CPPEnumType_OOPLEnumType, gen_cppmodel_CPPEnumType_CPPQualifiedNamedElement, gen_cppmodel_CPPEnumerator_OOPLEnumerator, gen_cppmodel_CPPEnumerator_CPPQualifiedNamedElement, gen_cppmodel_CPPStructType_OOPLStructType, gen_cppmodel_CPPStructType_CPPQualifiedNamedElement, gen_cppmodel_CPPStructMember_OOPLStructMember, gen_cppmodel_CPPStructMember_CPPQualifiedNamedElement, gen_cppmodel_CPPUserDefinedType_OOPLUserDefinedType, gen_cppmodel_CPPUserDefinedType_CPPQualifiedNamedElement, gen_cppmodel_CPPMakeFile_CPPSourceFile},
    metadata=None
)
