...
class cppmodel_CPPSequence(OOPLSequence):
    ...
    def __init__(self, cppContainer: str, cppmodel_CPPSequence130: "cppmodel_CPPFormalParameter" = None, cppmodel_CPPSequence: "cppmodel_CPPAttribute" = None, cppmodel_CPPSequence138: "cppmodel_CPPReturnValue" = None):
...
class cppmodel_CPPExternalHeader:
    ...
    def __init__(self, name: str, cppmodel_CPPExternalHeader142: "cppmodel_CPPExternalLibrary" = None, cppmodel_CPPExternalHeader: "cppmodel_CPPExternalHeaderInclusion" = None):
        self.name = name
...
class cppmodel_CPPDirectory:
    ...
    def __init__(self, name: str, parentDirectory: str, path: str, cppmodel_CPPDirectory: "cppmodel_CPPModel" = None, cppmodel_CPPDirectory18: "cppmodel_CPPModel" = None, cppmodel_CPPDirectory24: "cppmodel_CPPModel" = None, cppmodel_CPPDirectory34: "cppmodel_CPPPackage" = None, cppmodel_CPPDirectory37: "cppmodel_CPPPackage" = None, cppmodel_CPPDirectory53: "cppmodel_CPPDirectory" = None, cppmodel_CPPDirectory51: set["cppmodel_CPPDirectory"] = None, cppmodel_CPPDirectory55: set["cppmodel_CPPSourceFile"] = None, cppmodel_CPPDirectory58: "cppmodel_CPPMakeFile" = None, cppmodel_CPPDirectory83: "cppmodel_CPPComponent" = None, cppmodel_CPPDirectory21: "cppmodel_CPPModel" = None, cppmodel_CPPDirectory74: "cppmodel_CPPComponent" = None, cppmodel_CPPDirectory77: "cppmodel_CPPComponent" = None, cppmodel_CPPDirectory80: "cppmodel_CPPComponent" = None):
        self.name = name
...
class cppmodel_CPPHeaderFile(CPPSourceFile):
    ...
    def __init__(self, includeDirectory: str, includeName: str, includePath: str, cppmodel_CPPHeaderFile13: "cppmodel_CPPModel" = None, cppmodel_CPPHeaderFile31: "cppmodel_CPPPackage" = None, cppmodel_CPPHeaderFile39: "cppmodel_CPPClass" = None, cppmodel_CPPHeaderFile46: "cppmodel_CPPProtocol" = None, cppmodel_CPPHeaderFile48: "cppmodel_CPPSourceFile" = None, cppmodel_CPPHeaderFile: "cppmodel_CPPModel" = None, cppmodel_CPPHeaderFile10: "cppmodel_CPPModel" = None, cppmodel_CPPHeaderFile144: "cppmodel_CPPExternalBridge" = None, cppmodel_CPPHeaderFile62: "cppmodel_CPPComponent" = None, cppmodel_CPPHeaderFile68: "cppmodel_CPPComponent" = None, cppmodel_CPPHeaderFile71: "cppmodel_CPPComponent" = None, cppmodel_CPPHeaderFile92: "cppmodel_CPPPort" = None, cppmodel_CPPHeaderFile95: "cppmodel_CPPPort" = None):
...
class cppmodel_CPPStructType(OOPLStructType, CPPQualifiedNamedElement):
    ...
    pass
class cppmodel_CPPClassRefAssocCollection(OOPLClassRefAssocCollection, CPPQualifiedNamedElement):
...
class cppmodel_CPPRelation(OOPLRelation, CPPQualifiedNamedElement):

    pass
class cppmodel_CPPEnumerator(OOPLEnumerator, CPPQualifiedNamedElement):
...
class cppmodel_CPPUserDefinedType(OOPLUserDefinedType, CPPQualifiedNamedElement):

    pass
class cppmodel_CPPFormalParameter(CPPQualifiedNamedElement):

    def __init__(self, passingMode: str, cppmodel_CPPFormalParameter129: "cppmodel_CPPSequence" = None, cppmodel_CPPFormalParameter132: "cppmodel_OOPLDataType" = None, cppmodel_CPPFormalParameter: "cppmodel_Parameter" = None):
...
class cppmodel_CPPProtocolOperationImplementation(CPPQualifiedNamedElement):
    ...
    pass
class cppmodel_CPPClassReference(OOPLClassReference, CPPQualifiedNamedElement):
...
class cppmodel_CPPPackage(CPPQualifiedNamedElement):
    ...
    pass
class cppmodel_CPPClass(OOPLClass, CPPQualifiedNamedElement):

    pass
class cppmodel_CPPEvent(CPPQualifiedNamedElement):

    pass
class cppmodel_CPPStructMember(OOPLStructMember, CPPQualifiedNamedElement):

    pass
class cppmodel_CPPClassReferenceStorage(OOPLClassReferenceStorage, CPPQualifiedNamedElement):
