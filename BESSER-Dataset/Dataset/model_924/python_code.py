...
class petrinetsemantics_DDMMPetriNet_Arc:
    ...
    def __init__(self, kind: str, weight: int, outgoings: "Node" = None, arcs: "PetriNet" = None, incomings: "Node" = None):
        self.kind = kind
        self.weight = weight
...
class petrinetsemantics_DDMMPetriNet_Transition(Node):
    ...
    def __init__(self, min_time: int, max_time: int, Node9: "petrinetsemantics_DDMMPetriNet_Arc" = None, Node15: "petrinetsemantics_SDMMPetriNet_Node_dynamic" = None, Node: "petrinetsemantics_DDMMPetriNet_PetriNet" = None, Node11: "petrinetsemantics_DDMMPetriNet_Arc" = None):
...
class petrinetsemantics_DDMMPetriNet_Place(Node):
    ...
    def __init__(self, initialMarking: int, Node9: "petrinetsemantics_DDMMPetriNet_Arc" = None, Node15: "petrinetsemantics_SDMMPetriNet_Node_dynamic" = None, Node: "petrinetsemantics_DDMMPetriNet_PetriNet" = None, Node11: "petrinetsemantics_DDMMPetriNet_Arc" = None):
