...
class statemachine_State(ABC):
    ...
    def __init__(self, name: str, statemachine_State: "statemachine_StateMachine" = None, statemachine_State4: set["statemachine_Transition"] = None, statemachine_State6: set["statemachine_Need"] = None, statemachine_State9: "statemachine_Transition" = None):
        self.name = name
