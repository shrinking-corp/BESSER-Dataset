...
class university_Professor:
    ...
    def __init__(self, name: str, university_Professor: "university_University" = None, Professor: "university_Course" = None, professors: set["university_Course"] = None):
        self.name = name
...
class university_Course:
    ...
    def __init__(self, name: str, university_Course: "university_University" = None, courses: set["university_Professor"] = None, Course: "university_Professor" = None):
        self.name = name
