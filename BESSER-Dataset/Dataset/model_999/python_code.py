...
class graph_Edge:
    ...
    def __init__(self, name: str, graph_Edge4: "graph_Node" = None, graph_Edge7: "graph_Node" = None, graph_Edge: "graph_Graph" = None):
        self.name = name
...
class graph_Node:
    ...
    def __init__(self, name: str, graph_Node5: "graph_Edge" = None, graph_Node8: "graph_Edge" = None, graph_Node: "graph_Graph" = None):
        self.name = name
