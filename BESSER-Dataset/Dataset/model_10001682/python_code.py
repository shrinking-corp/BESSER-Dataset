...
class B:
    ...
    def __init__(self, attB: int, c0: "C" = None, a5: "A" = None):
        self.attB = attB
        self.c0 = c0
        self.a5 = a5
    ...
    def c0(self, value):
        ...
        if old_value is not None:
            if hasattr(old_value, "b1"):
                ...
                if opp_val == self:
                    setattr(old_value, "b1", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "b1"):
                opp_val = getattr(value, "b1", None)
                setattr(value, "b1", self)
...
class A1:
    ...
    def __init__(self, b: bool, d: int, c6: "B1" = None):
        self.b = b
        self.d = d
        self.c6 = c6
    ...
    def c6(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_A1__c6", None)
        self.__c6 = value
