...
class C:
    ...
    def __init__(self, attC1: int, attC2: bool, class41: "B" = None):
        self.attC1 = attC1
        self.attC2 = attC2
    ...
    @property
    def class41(self):
        return self.__class41
    @class41.setter
    def class41(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_C__class41", None)
        self.__class41 = value
    ...
    def c0(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "class41"):
                    opp_val = getattr(item, "class41", None)
                    
                    if opp_val == self:
                        setattr(item, "class41", None)
