...
class ntnustudies_Semester:
    ...
    def __init__(self, type: str, year: int, Semester: "ntnustudies_Programme" = None, ntnustudies_Semester: "ntnustudies_Specialization" = None, ntnustudies_Semester11: set["ntnustudies_Course"] = None, semesters: "ntnustudies_Programme" = None, ntnustudies_Semester16: "ntnustudies_ChosenSemester" = None):
        self.type = type
        self.year = year
...
class ntnustudies_Specialization:
    ...
    def __init__(self, name: str, specializationChoicePointSemester: int, Specialization: "ntnustudies_Programme" = None, specializations: "ntnustudies_Programme" = None, ntnustudies_Specialization: set["ntnustudies_Course"] = None, ntnustudies_Specialization7: "ntnustudies_Specialization" = None, ntnustudies_Specialization5: "ntnustudies_Specialization" = None, ntnustudies_Specialization9: set["ntnustudies_Semester"] = None, ntnustudies_Specialization23: "ntnustudies_StudyPlan" = None):
        self.name = name
        ...
        pass
    @property
    def specializationChoicePointSemester(self):
...
class ntnustudies_Course:
    ...
    def __init__(self, code: str, name: str, credtis: float, semesters: str, level: str, type: str, ntnustudies_Course: "ntnustudies_Specialization" = None, ntnustudies_Course12: "ntnustudies_Semester" = None, ntnustudies_Course28: "ntnustudies_Department" = None, ntnustudies_Course19: "ntnustudies_ChosenSemester" = None):
        self.code = code
        self.name = name
