...
# Classes
ntnustudies_Course = Class(name="ntnustudies_Course")
ntnustudies_Programme = Class(name="ntnustudies_Programme")
ntnustudies_Specialization = Class(name="ntnustudies_Specialization")
ntnustudies_Semester = Class(name="ntnustudies_Semester")
ntnustudies_ChosenSemester = Class(name="ntnustudies_ChosenSemester")
ntnustudies_Department = Class(name="ntnustudies_Department")
ntnustudies_StudyPlan = Class(name="ntnustudies_StudyPlan")
...
ntnustudies_Course.attributes={ntnustudies_Course_credtis, ntnustudies_Course_name, ntnustudies_Course_type, ntnustudies_Course_code, ntnustudies_Course_level, ntnustudies_Course_semesters}
...
ntnustudies_Specialization.attributes={ntnustudies_Specialization_specializationChoicePointSemester, ntnustudies_Specialization_name}
...
ntnustudies_Department.attributes={ntnustudies_Department_shortName, ntnustudies_Department_name}
...
domain_model = DomainModel(
    name="ntnustudies",
    types={ntnustudies_Course, ntnustudies_Programme, ntnustudies_Specialization, ntnustudies_Semester, ntnustudies_ChosenSemester, ntnustudies_Department, ntnustudies_StudyPlan, semesterType, courseLevel, courseType},
    associations={specializations0, semesters1, programme3, courses4, requiredSpecialization6, semesters8, possibleCourses10, programme13, semester15, programme20, specializations21, chosenSemesters24, courses27, programmes29, courses17},
    generalizations={},
    metadata=None
)
