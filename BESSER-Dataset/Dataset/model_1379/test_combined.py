...
def test_hyp_tsm_namedelement_is_not_abstract():
    assert not inspect.isabstract(tsm_NamedElement)


def test_hyp_tsm_namedelement_constructor_exists():
    assert callable(tsm_NamedElement.__init__)


def test_hyp_tsm_namedelement_constructor_args():
...
def test_hyp_tsm_timeevent_is_not_abstract():
    assert not inspect.isabstract(tsm_TimeEvent)


def test_hyp_tsm_timeevent_constructor_exists():
    assert callable(tsm_TimeEvent.__init__)


def test_hyp_tsm_timeevent_constructor_args():
...
def test_hyp_tsm_transition_is_not_abstract():
    assert not inspect.isabstract(tsm_Transition)


def test_hyp_tsm_transition_constructor_exists():
    assert callable(tsm_Transition.__init__)


def test_hyp_tsm_transition_constructor_args():
    sig = inspect.signature(tsm_Transition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tsm_statemachine_is_not_abstract():
    assert not inspect.isabstract(tsm_StateMachine)


def test_hyp_tsm_statemachine_constructor_exists():
    assert callable(tsm_StateMachine.__init__)


def test_hyp_tsm_statemachine_constructor_args():
    sig = inspect.signature(tsm_StateMachine.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tsm_state_is_not_abstract():
    assert not inspect.isabstract(tsm_State)


def test_hyp_tsm_state_constructor_exists():
    assert callable(tsm_State.__init__)


def test_hyp_tsm_state_constructor_args():
...
def test_hyp_tsm_namedelement_name_setter(instance):
...
def test_hyp_tsm_timeevent_time_setter(instance):
