...
# Classes
tsm_State = Class(name="tsm_State")
tsm_StateMachine = Class(name="tsm_StateMachine")
NamedElement = Class(name="NamedElement")
tsm_TimeEvent = Class(name="tsm_TimeEvent")
tsm_Transition = Class(name="tsm_Transition")
tsm_NamedElement = Class(name="tsm_NamedElement", is_abstract=True)
...
domain_model = DomainModel(
    name="tsm",
    types={tsm_State, tsm_StateMachine, NamedElement, tsm_TimeEvent, tsm_Transition, tsm_NamedElement},
    associations={outgoing7, timer9, states0, transitions1, start3, incoming6, target11, source12},
    generalizations={gen_tsm_StateMachine_NamedElement, gen_tsm_Transition_NamedElement, gen_tsm_State_NamedElement},
    metadata=None
)
