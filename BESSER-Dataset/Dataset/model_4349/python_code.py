...
class RefinementsEcore_EClass(EClassifier):
    ...
    def __init__(self, abstract: bool, interface: bool, RefinementsEcore_EClass39: "RefinementsEcore_EReference" = None, RefinementsEcore_EClass14: "RefinementsEcore_EAttribute" = None, eContainingClass17: set["RefinementsEcore_EStructuralFeature"] = None, RefinementsEcore_EClass: "RefinementsEcore_EClass" = None, RefinementsEcore_EClass5: set["RefinementsEcore_EClass"] = None, eContainingClass: set["RefinementsEcore_EOperation"] = None, RefinementsEcore_EClass9: set["RefinementsEcore_EReference"] = None, RefinementsEcore_EClass11: set["RefinementsEcore_EAttribute"] = None, EClass: "RefinementsEcore_EOperation" = None, EClass47: "RefinementsEcore_EStructuralFeature" = None):
...
class RefinementsEcore_EReference(EStructuralFeature):
    ...
    def __init__(self, containment: bool, container: bool, resolveProxies: bool, RefinementsEcore_EReference34: "RefinementsEcore_EReference" = None, RefinementsEcore_EReference38: "RefinementsEcore_EClass" = None, RefinementsEcore_EReference41: set["RefinementsEcore_EAttribute"] = None, RefinementsEcore_EReference45: "RefinementsEcore_EReference" = None, RefinementsEcore_EReference43: "RefinementsEcore_EReference" = None, RefinementsEcore_EReference: "RefinementsEcore_EClass" = None, RefinementsEcore_EReference36: "RefinementsEcore_EReference" = None):
...
class RefinementsEcore_EAttribute(EStructuralFeature):
    ...
    def __init__(self, iD: int, RefinementsEcore_EAttribute42: "RefinementsEcore_EReference" = None, RefinementsEcore_EAttribute15: "RefinementsEcore_EClass" = None, RefinementsEcore_EAttribute: "RefinementsEcore_EDataType" = None, RefinementsEcore_EAttribute3: "RefinementsEcore_EAttribute" = None, RefinementsEcore_EAttribute1: "RefinementsEcore_EAttribute" = None, RefinementsEcore_EAttribute12: "RefinementsEcore_EClass" = None):
        self.iD = iD
...
class RefinementsEcore_EPackage(ENamedElement):
    ...
    def __init__(self, nsURI: str, nsPrefix: str, ePackage: set["RefinementsEcore_EClassifier"] = None, EPackage28: "RefinementsEcore_EPackage" = None, eSuperPackage: set["RefinementsEcore_EPackage"] = None, EPackage31: "RefinementsEcore_EPackage" = None, eSubpackages: "RefinementsEcore_EPackage" = None, EPackage: "RefinementsEcore_EClassifier" = None):
        self.nsURI = nsURI
...
class RefinementsEcore_EStructuralFeature(ETypedElement):
    ...
    def __init__(self, changeable: bool, volatile: bool, transient: bool, defaultValueLiteral: str, unsettable: bool, derived: bool, EStructuralFeature: "RefinementsEcore_EClass" = None, eStructuralFeatures: "RefinementsEcore_EClass" = None):
