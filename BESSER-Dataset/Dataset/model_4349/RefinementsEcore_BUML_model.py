...
# Classes
RefinementsEcore_EStructuralFeature = Class(name="RefinementsEcore_EStructuralFeature", is_abstract=True)
RefinementsEcore_EClassifier = Class(name="RefinementsEcore_EClassifier", is_abstract=True)
ENamedElement = Class(name="ENamedElement")
RefinementsEcore_EAttribute = Class(name="RefinementsEcore_EAttribute")
EStructuralFeature = Class(name="EStructuralFeature")
RefinementsEcore_EDataType = Class(name="RefinementsEcore_EDataType")
RefinementsEcore_EAnnotation = Class(name="RefinementsEcore_EAnnotation")
EModelElement = Class(name="EModelElement")
RefinementsEcore_EModelElement = Class(name="RefinementsEcore_EModelElement", is_abstract=True)
RefinementsEcore_EClass = Class(name="RefinementsEcore_EClass")
EClassifier = Class(name="EClassifier")
RefinementsEcore_EOperation = Class(name="RefinementsEcore_EOperation")
RefinementsEcore_EReference = Class(name="RefinementsEcore_EReference")
RefinementsEcore_EPackage = Class(name="RefinementsEcore_EPackage")
RefinementsEcore_EEnum = Class(name="RefinementsEcore_EEnum")
EDataType = Class(name="EDataType")
RefinementsEcore_EEnumLiteral = Class(name="RefinementsEcore_EEnumLiteral")
RefinementsEcore_ENamedElement = Class(name="RefinementsEcore_ENamedElement", is_abstract=True)
ETypedElement = Class(name="ETypedElement")
RefinementsEcore_EParameter = Class(name="RefinementsEcore_EParameter")
RefinementsEcore_ETypedElement = Class(name="RefinementsEcore_ETypedElement", is_abstract=True)
...
RefinementsEcore_EStructuralFeature.attributes={RefinementsEcore_EStructuralFeature_volatile, RefinementsEcore_EStructuralFeature_defaultValueLiteral, RefinementsEcore_EStructuralFeature_transient, RefinementsEcore_EStructuralFeature_derived, RefinementsEcore_EStructuralFeature_changeable, RefinementsEcore_EStructuralFeature_unsettable}
...
RefinementsEcore_EClassifier.attributes={RefinementsEcore_EClassifier_instanceClassName, RefinementsEcore_EClassifier_instanceClass, RefinementsEcore_EClassifier_instanceTypeName}
...
RefinementsEcore_EClass.attributes={RefinementsEcore_EClass_interface, RefinementsEcore_EClass_abstract}
...
RefinementsEcore_EReference.attributes={RefinementsEcore_EReference_container, RefinementsEcore_EReference_containment, RefinementsEcore_EReference_resolveProxies}
...
RefinementsEcore_EPackage.attributes={RefinementsEcore_EPackage_nsURI, RefinementsEcore_EPackage_nsPrefix}
...
RefinementsEcore_EEnumLiteral.attributes={RefinementsEcore_EEnumLiteral_literal, RefinementsEcore_EEnumLiteral_value}
...
RefinementsEcore_ETypedElement.attributes={RefinementsEcore_ETypedElement_ordered, RefinementsEcore_ETypedElement_many, RefinementsEcore_ETypedElement_required, RefinementsEcore_ETypedElement_unique, RefinementsEcore_ETypedElement_lowerBound, RefinementsEcore_ETypedElement_upperBound}
...
domain_model = DomainModel(
    ...
    types={RefinementsEcore_EStructuralFeature, RefinementsEcore_EClassifier, ENamedElement, RefinementsEcore_EAttribute, EStructuralFeature, RefinementsEcore_EDataType, RefinementsEcore_EAnnotation, EModelElement, RefinementsEcore_EModelElement, RefinementsEcore_EClass, EClassifier, RefinementsEcore_EOperation, RefinementsEcore_EReference, RefinementsEcore_EPackage, RefinementsEcore_EEnum, EDataType, RefinementsEcore_EEnumLiteral, RefinementsEcore_ENamedElement, ETypedElement, RefinementsEcore_EParameter, RefinementsEcore_ETypedElement},
    associations={eIDAttribute13, eStructuralFeatures16, eAttributeType0, Refines2, eModelElement4, eSuperTypes6, eOperations7, eReferences8, eAttributes10, eExceptions24, eClassifiers25, eSubpackages27, eSuperPackage30, ePackage18, eLiterals19, eEnum20, eAnnotations21, eContainingClass22, eParameters23, eOperation32, eOpposite35, eReferenceType37, eKeys40, Refines44, eContainingClass46, eType48},
    generalizations={gen_RefinementsEcore_EClassifier_ENamedElement, gen_RefinementsEcore_EAttribute_EStructuralFeature, gen_RefinementsEcore_EAnnotation_EModelElement, gen_RefinementsEcore_EClass_EClassifier, gen_RefinementsEcore_EPackage_ENamedElement, gen_RefinementsEcore_EDataType_EClassifier, gen_RefinementsEcore_EEnum_EDataType, gen_RefinementsEcore_EEnumLiteral_ENamedElement, gen_RefinementsEcore_ENamedElement_EModelElement, gen_RefinementsEcore_EOperation_ETypedElement, gen_RefinementsEcore_EParameter_ETypedElement, gen_RefinementsEcore_EReference_EStructuralFeature, gen_RefinementsEcore_EStructuralFeature_ETypedElement, gen_RefinementsEcore_ETypedElement_ENamedElement},
    metadata=None
)
