...
domain_model = DomainModel(
    name="UML2",
    types={UML2_ExtensionEnd, Property_, UML2_LinkEndData, UML2_Property, UML2_LinkEndCreationData, LinkEndData, UML2_Port, UML2_QualifierValue},
    associations={qualifier6, end0, qualifier1, qualifier4},
