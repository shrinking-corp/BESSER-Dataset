...
class afmmm_Feature:
    ...
    def __init__(self, name: str, afmmm_Feature: "afmmm_AttributedFeatureDiagram" = None, afmmm_Feature3: "afmmm_AttributedFeatureDiagram" = None, afmmm_Feature9: set["afmmm_Attribute"] = None, afmmm_Feature12: "afmmm_Relation" = None, afmmm_Feature15: "afmmm_Relation" = None):
        self.name = name
