...
# Classes
afmmm_AttributedFeatureDiagram = Class(name="afmmm_AttributedFeatureDiagram")
afmmm_Feature = Class(name="afmmm_Feature")
afmmm_CrossTreeConstraint = Class(name="afmmm_CrossTreeConstraint")
afmmm_Relation = Class(name="afmmm_Relation", is_abstract=True)
afmmm_Attribute = Class(name="afmmm_Attribute")
afmmm_Mandatory = Class(name="afmmm_Mandatory")
Relation = Class(name="Relation")
afmmm_Or = Class(name="afmmm_Or")
afmmm_Domain = Class(name="afmmm_Domain", is_abstract=True)
afmmm_Boolean = Class(name="afmmm_Boolean")
Domain = Class(name="Domain")
afmmm_Integer = Class(name="afmmm_Integer")
afmmm_Real = Class(name="afmmm_Real")
afmmm_Enum = Class(name="afmmm_Enum")
afmmm_AttributedFeatureModel = Class(name="afmmm_AttributedFeatureModel")
afmmm_EClass0 = Class(name="afmmm_EClass0")
afmmm_Optional = Class(name="afmmm_Optional")
afmmm_Mutex = Class(name="afmmm_Mutex")
afmmm_XOr = Class(name="afmmm_XOr")
...
domain_model = DomainModel(
    name="afmmm",
    types={afmmm_AttributedFeatureDiagram, afmmm_Feature, afmmm_CrossTreeConstraint, afmmm_Relation, afmmm_Attribute, afmmm_Mandatory, Relation, afmmm_Or, afmmm_Domain, afmmm_Boolean, Domain, afmmm_Integer, afmmm_Real, afmmm_Enum, afmmm_AttributedFeatureModel, afmmm_EClass0, afmmm_Optional, afmmm_Mutex, afmmm_XOr},
    associations={features0, root1, readableConstraints4, relations6, attributes8, parent10, children13, diagram16, constraint18, domains21, domain23},
    generalizations={gen_afmmm_Mandatory_Relation, gen_afmmm_Or_Relation, gen_afmmm_Boolean_Domain, gen_afmmm_Integer_Domain, gen_afmmm_Real_Domain, gen_afmmm_Enum_Domain, gen_afmmm_Optional_Relation, gen_afmmm_Mutex_Relation, gen_afmmm_XOr_Relation},
    metadata=None
)
