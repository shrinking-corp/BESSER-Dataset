...
# Classes
devs_AtomicModel = Class(name="devs_AtomicModel")
devs_State = Class(name="devs_State")
devs_Event = Class(name="devs_Event")
devs_Transition = Class(name="devs_Transition")
devs_OutputFunction = Class(name="devs_OutputFunction")
devs_InputEvent = Class(name="devs_InputEvent")
Event = Class(name="Event")
devs_ExternalTransition = Class(name="devs_ExternalTransition")
devs_OutputEvent = Class(name="devs_OutputEvent")
devs_InternalTransition = Class(name="devs_InternalTransition")
...
target22: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="in_", type=devs_State, multiplicity=Multiplicity(1, 1))
    }
)
...
domain_model = DomainModel(
    name="devs",
    types={devs_AtomicModel, devs_State, devs_Event, devs_Transition, devs_OutputFunction, devs_InputEvent, Event, devs_ExternalTransition, devs_OutputEvent, devs_InternalTransition, Transition},
    associations={state0, event1, transition3, outputFunction5, in_7, out9, outF11, atomicModel14, atomicModel15, externalTransition17, outputFunction18, source20, target22, atomicModel24, inputEvent26, source27, outputEvent29, atomicModel30},
    generalizations={gen_devs_InputEvent_Event, gen_devs_InternalTransition_Transition, gen_devs_ExternalTransition_Transition, gen_devs_OutputEvent_Event},
    metadata=None
)
