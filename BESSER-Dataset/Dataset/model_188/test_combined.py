...
def test_hyp_idiagramholder_is_not_abstract():
    assert not inspect.isabstract(IDiagramHolder)


def test_hyp_idiagramholder_constructor_exists():
    assert callable(IDiagramHolder.__init__)


def test_hyp_idiagramholder_constructor_args():
...
def test_hyp_highlevelnets_common_idiagramholder_is_not_abstract():
    assert not inspect.isabstract(highlevelnets_common_IDiagramHolder)


def test_hyp_highlevelnets_common_idiagramholder_constructor_exists():
    assert callable(highlevelnets_common_IDiagramHolder.__init__)


def test_hyp_highlevelnets_common_idiagramholder_constructor_args():
...
def test_hyp_common_idiagramholder_is_not_abstract():
    assert not inspect.isabstract(common_IDiagramHolder)


def test_hyp_common_idiagramholder_constructor_exists():
    assert callable(common_IDiagramHolder.__init__)


def test_hyp_common_idiagramholder_constructor_args():
    sig = inspect.signature(common_IDiagramHolder.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tokentypes_tokentype_is_not_abstract():
    assert not inspect.isabstract(tokentypes_TokenType)


def test_hyp_tokentypes_tokentype_constructor_exists():
    assert callable(tokentypes_TokenType.__init__)


def test_hyp_tokentypes_tokentype_constructor_args():
...
def test_hyp_highlevelnets_common_ientityidentifiable_id_setter(instance):
