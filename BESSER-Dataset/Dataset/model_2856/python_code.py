...
class ir_State:
    ...
    def __init__(self, name: str, PriorityGraph: str, Action2TargetMap: str, ir_State: "ir_Schedule" = None, ir_State254: "ir_Schedule" = None):
        self.name = name
...
class ir_PortPeek(PortAccess):
    ...
    def __init__(self, position: int, ir_PortPeek211: "ir_Guard" = None, ir_PortPeek: "ir_VariableReference" = None):
...
class ir_PortRead(PortAccess):
    ...
    pass
class ir_PortWrite(Block, PortAccess):
...
class Scope:
    ...
    pass
class ir_Block(Scope, Statement):
...
class ir_Action(Scope):
    ...
    def __init__(self, tag: str, ir_Action: "ir_Actor" = None, ir_Action19: "ir_Actor" = None, ir_Action26: set["ir_Guard"] = None, ir_Action28: set["ir_PortWrite"] = None, ir_Action30: set["ir_PortRead"] = None, ir_Action32: set["ir_Statement"] = None, ir_Action251: "ir_Schedule" = None):
        self.tag = tag
...
class ir_ProcExpression(Scope, Expression):

    pass
class ir_LambdaExpression(Scope, Expression):
...
class ir_TaggedExpression:
    ...
    def __init__(self, tag: str, ir_TaggedExpression: "ir_ActorInstance" = None, ir_TaggedExpression55: "ir_Expression" = None, ir_TaggedExpression96: "ir_Connection" = None, ir_TaggedExpression213: "ir_TypeExternal" = None, ir_TaggedExpression176: "ir_Declaration" = None):
        self.tag = tag
...
class ir_Declaration(Node):
    ...
    def __init__(self, name: str, ir_Declaration: "ir_Scope" = None, ir_Declaration93: "ir_TypeConstructorCall" = None, ir_Declaration58: "ir_VariableExpression" = None, ir_Declaration137: "ir_ProcCall" = None, ir_Declaration172: "ir_Scope" = None, ir_Declaration175: set["ir_TaggedExpression"] = None, ir_Declaration178: "ir_ForwardDeclaration" = None, ir_Declaration226: "ir_TypeUser" = None):
        self.name = name
...
class ir_Member(Node):
    ...
    def __init__(self, name: str, ir_Member119: "ir_VariableReference" = None, ir_Member72: set["ir_Expression"] = None, ir_Member75: "ir_Type" = None, ir_Member: "ir_VariableExpression" = None):
        self.name = name
...
class ir_PortInstance(Node):
    ...
    def __init__(self, name: str, ir_PortInstance40: "ir_ActorInstance" = None, ir_PortInstance44: set["ir_Connection"] = None, ir_PortInstance47: "ir_ActorInstance" = None, ir_PortInstance108: "ir_ToSink" = None, ir_PortInstance: "ir_ActorInstance" = None, ir_PortInstance98: "ir_Point2PointConnection" = None, ir_PortInstance101: "ir_Point2PointConnection" = None, ir_PortInstance103: "ir_FromSource" = None):
        self.name = name
...
class ir_Variable(Declaration):
    ...
    def __init__(self, constant: bool, parameter: bool, ir_Variable: "ir_AbstractActor" = None, ir_Variable113: "ir_VariableReference" = None, ir_Variable189: "ir_LambdaExpression" = None, ir_Variable183: "ir_Expression" = None, ir_Variable186: "ir_Type" = None, ir_Variable194: "ir_ProcExpression" = None, ir_Variable197: "ir_ProcExpression" = None, ir_Variable224: "ir_TypeRecord" = None, ir_Variable240: "ir_TypeConstructor" = None):
...
class ir_Port(Node):
    ...
    def __init__(self, name: str, ir_Port: "ir_AbstractActor" = None, ir_Port13: "ir_AbstractActor" = None, ir_Port106: "ir_FromSource" = None, ir_Port34: "ir_Type" = None, ir_Port111: "ir_ToSink" = None, ir_Port159: "ir_PortAccess" = None):
        self.name = name
