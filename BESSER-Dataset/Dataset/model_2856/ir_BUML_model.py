...
# Classes
ir_AbstractActor = Class(name="ir_AbstractActor")
ir_TypeActor = Class(name="ir_TypeActor")
ir_Port = Class(name="ir_Port")
ir_Variable = Class(name="ir_Variable")
ir_Scope = Class(name="ir_Scope")
Node = Class(name="Node")
ir_Declaration = Class(name="ir_Declaration")
ir_Node = Class(name="ir_Node")
ir_Annotation = Class(name="ir_Annotation")
ir_VariableImport = Class(name="ir_VariableImport")
Declaration = Class(name="Declaration")
ir_VariableExternal = Class(name="ir_VariableExternal")
ir_Type = Class(name="ir_Type")
ir_TypeDeclarationImport = Class(name="ir_TypeDeclarationImport")
ir_TaggedExpression = Class(name="ir_TaggedExpression")
ir_Namespace = Class(name="ir_Namespace")
Scope = Class(name="Scope")
ir_Expression = Class(name="ir_Expression")
ir_ExternalActor = Class(name="ir_ExternalActor")
AbstractActor = Class(name="AbstractActor")
ir_Actor = Class(name="ir_Actor")
ir_Action = Class(name="ir_Action")
ir_Schedule = Class(name="ir_Schedule")
ir_Network = Class(name="ir_Network")
ir_Connection = Class(name="ir_Connection")
ir_ActorInstance = Class(name="ir_ActorInstance")
ir_Guard = Class(name="ir_Guard")
ir_PortWrite = Class(name="ir_PortWrite")
ir_PortRead = Class(name="ir_PortRead")
ir_Statement = Class(name="ir_Statement")
Variable = Class(name="Variable")
ir_PortInstance = Class(name="ir_PortInstance")
ir_BinaryExpression = Class(name="ir_BinaryExpression")
ir_UnaryExpression = Class(name="ir_UnaryExpression")
ir_ExpressionCall = Class(name="ir_ExpressionCall")
ir_FunctionCall = Class(name="ir_FunctionCall")
ExpressionCall = Class(name="ExpressionCall")
ir_LiteralExpression = Class(name="ir_LiteralExpression")
Expression = Class(name="Expression")
ir_IntegerLiteral = Class(name="ir_IntegerLiteral")
LiteralExpression = Class(name="LiteralExpression")
ir_TypeConstructorCall = Class(name="ir_TypeConstructorCall")
ir_FloatLiteral = Class(name="ir_FloatLiteral")
ir_BooleanLiteral = Class(name="ir_BooleanLiteral")
ir_StringLiteral = Class(name="ir_StringLiteral")
ir_VariableExpression = Class(name="ir_VariableExpression")
ir_Point2PointConnection = Class(name="ir_Point2PointConnection")
Connection = Class(name="Connection")
ir_Member = Class(name="ir_Member")
ir_FromSource = Class(name="ir_FromSource")
ir_ListExpression = Class(name="ir_ListExpression")
ir_Generator = Class(name="ir_Generator")
ir_ToSink = Class(name="ir_ToSink")
ir_VariableReference = Class(name="ir_VariableReference")
ir_Assign = Class(name="ir_Assign")
Statement = Class(name="Statement")
ir_ReturnValue = Class(name="ir_ReturnValue")
ir_ProcCall = Class(name="ir_ProcCall")
ir_WhileLoop = Class(name="ir_WhileLoop")
ir_Block = Class(name="ir_Block")
ir_ForEach = Class(name="ir_ForEach")
ir_IfStatement = Class(name="ir_IfStatement")
ir_ProcExpression = Class(name="ir_ProcExpression")
ir_PortAccess = Class(name="ir_PortAccess")
Block = Class(name="Block")
PortAccess = Class(name="PortAccess")
ir_PortPeek = Class(name="ir_PortPeek")
ir_ForwardDeclaration = Class(name="ir_ForwardDeclaration")
ir_LambdaExpression = Class(name="ir_LambdaExpression")
ir_TypeUndef = Class(name="ir_TypeUndef")
ir_TypeUser = Class(name="ir_TypeUser")
ir_IfExpression = Class(name="ir_IfExpression")
LambdaExpression = Class(name="LambdaExpression")
ir_TypeBool = Class(name="ir_TypeBool")
Type = Class(name="Type")
ir_TypeExternal = Class(name="ir_TypeExternal")
ir_TypeInt = Class(name="ir_TypeInt")
ir_TypeList = Class(name="ir_TypeList")
ir_TypeFloat = Class(name="ir_TypeFloat")
ir_TypeUint = Class(name="ir_TypeUint")
ir_TypeString = Class(name="ir_TypeString")
ir_TypeRecord = Class(name="ir_TypeRecord")
ir_TypeLambda = Class(name="ir_TypeLambda")
ir_TypeProc = Class(name="ir_TypeProc")
ir_TypeConstructor = Class(name="ir_TypeConstructor")
ir_TypeDeclaration = Class(name="ir_TypeDeclaration")
ir_State = Class(name="ir_State")
ir_AnnotationArgument = Class(name="ir_AnnotationArgument")
...
ir_State.attributes={ir_State_Action2TargetMap, ir_State_PriorityGraph, ir_State_name}
...
ir_AnnotationArgument.attributes={ir_AnnotationArgument_value, ir_AnnotationArgument_id}
...
domain_model = DomainModel(
    name="ir",
    types={ir_AbstractActor, ir_TypeActor, ir_Port, ir_Variable, ir_Scope, Node, ir_Declaration, ir_Node, ir_Annotation, ir_VariableImport, Declaration, ir_VariableExternal, ir_Type, ir_TypeDeclarationImport, ir_TaggedExpression, ir_Namespace, Scope, ir_Expression, ir_ExternalActor, AbstractActor, ir_Actor, ir_Action, ir_Schedule, ir_Network, ir_Connection, ir_ActorInstance, ir_Guard, ir_PortWrite, ir_PortRead, ir_Statement, Variable, ir_PortInstance, ir_BinaryExpression, ir_UnaryExpression, ir_ExpressionCall, ir_FunctionCall, ExpressionCall, ir_LiteralExpression, Expression, ir_IntegerLiteral, LiteralExpression, ir_TypeConstructorCall, ir_FloatLiteral, ir_BooleanLiteral, ir_StringLiteral, ir_VariableExpression, ir_Point2PointConnection, Connection, ir_Member, ir_FromSource, ir_ListExpression, ir_Generator, ir_ToSink, ir_VariableReference, ir_Assign, Statement, ir_ReturnValue, ir_ProcCall, ir_WhileLoop, ir_Block, ir_ForEach, ir_IfStatement, ir_ProcExpression, ir_PortAccess, Block, PortAccess, ir_PortPeek, ir_ForwardDeclaration, ir_LambdaExpression, ir_TypeUndef, ir_TypeUser, ir_IfExpression, LambdaExpression, ir_TypeBool, Type, ir_TypeExternal, ir_TypeInt, ir_TypeList, ir_TypeFloat, ir_TypeUint, ir_TypeString, ir_TypeRecord, ir_TypeLambda, ir_TypeProc, ir_TypeConstructor, ir_TypeDeclaration, ir_State, ir_AnnotationArgument},
    associations={actors6, type7, inputPorts9, outputPorts11, declarations0, outer2, annotations4, type5, outputs38, actualParameters41, connections43, actor46, type49, parameters14, context51, expression54, actions16, initializers17, schedule20, connections22, actors23, guards25, outputs27, inputs29, statements31, type33, inputs36, sink109, index71, type74, operand177, operand279, operand82, parameters84, function86, parameters89, typedef91, attributes94, variable57, source97, index59, target99, member62, target102, generators64, source104, expressions65, source68, source107, elseBlock149, condition152, declaration112, statements155, index114, member117, type120, target123, expression125, value128, inParameters130, outParameters132, procedure135, body138, condition139, body142, generators144, thenBlock147, parameters188, body190, port158, repeat160, expressions163, variables166, variable169, scope171, attributes174, declaration177, type179, initValue182, type185, declaration225, parameters193, outputs195, body198, thenExpression201, elseExpression203, condition206, peeks209, attributes212, size214, size216, type218, size221, members223, inputTypes227, outputType229, inputTypes232, outputTypes234, typedef237, parameters238, type241, constructor244, states247, freeRunners249, initialState252, arguments255},
    generalizations={gen_ir_AbstractActor_Scope, gen_ir_Scope_Node, gen_ir_VariableImport_Declaration, gen_ir_VariableExternal_Declaration, gen_ir_TypeDeclarationImport_Declaration, gen_ir_Namespace_Scope, gen_ir_PortInstance_Node, gen_ir_Expression_Node, gen_ir_ExternalActor_AbstractActor, gen_ir_Actor_AbstractActor, gen_ir_Network_AbstractActor, gen_ir_Action_Scope, gen_ir_Port_Node, gen_ir_ActorInstance_Variable, gen_ir_BinaryExpression_Expression, gen_ir_UnaryExpression_Expression, gen_ir_ExpressionCall_Expression, gen_ir_FunctionCall_ExpressionCall, gen_ir_LiteralExpression_Expression, gen_ir_IntegerLiteral_LiteralExpression, gen_ir_TypeConstructorCall_ExpressionCall, gen_ir_FloatLiteral_LiteralExpression, gen_ir_BooleanLiteral_LiteralExpression, gen_ir_StringLiteral_LiteralExpression, gen_ir_Connection_Node, gen_ir_VariableExpression_Expression, gen_ir_Point2PointConnection_Connection, gen_ir_FromSource_Connection, gen_ir_ListExpression_Expression, gen_ir_ToSink_Connection, gen_ir_Generator_Scope, gen_ir_Member_Node, gen_ir_Statement_Node, gen_ir_VariableReference_Node, gen_ir_Block_Scope, gen_ir_Block_Statement, gen_ir_Assign_Statement, gen_ir_ReturnValue_Statement, gen_ir_ProcCall_Statement, gen_ir_WhileLoop_Statement, gen_ir_ForEach_Statement, gen_ir_IfStatement_Statement, gen_ir_ProcExpression_Scope, gen_ir_ProcExpression_Expression, gen_ir_PortAccess_Node, gen_ir_PortWrite_Block, gen_ir_PortWrite_PortAccess, gen_ir_PortRead_PortAccess, gen_ir_PortPeek_PortAccess, gen_ir_Declaration_Node, gen_ir_ForwardDeclaration_Declaration, gen_ir_Variable_Declaration, gen_ir_LambdaExpression_Scope, gen_ir_LambdaExpression_Expression, gen_ir_TypeUndef_Type, gen_ir_TypeActor_Type, gen_ir_TypeUser_Type, gen_ir_IfExpression_Expression, gen_ir_Guard_LambdaExpression, gen_ir_TypeBool_Type, gen_ir_TypeExternal_Type, gen_ir_TypeInt_Type, gen_ir_TypeList_Type, gen_ir_TypeFloat_Type, gen_ir_TypeUint_Type, gen_ir_TypeString_Type, gen_ir_TypeRecord_Type, gen_ir_TypeRecord_Node, gen_ir_TypeLambda_Type, gen_ir_TypeProc_Type, gen_ir_TypeConstructor_Declaration, gen_ir_TypeDeclaration_Declaration},
    metadata=None
)
