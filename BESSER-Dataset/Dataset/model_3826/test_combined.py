...
def test_hyp_stext_package_is_not_abstract():
    assert not inspect.isabstract(stext_Package)


def test_hyp_stext_package_constructor_exists():
    assert callable(stext_Package.__init__)


def test_hyp_stext_package_constructor_args():
...
stext_Package_strategy = st.builds(stext_Package)
