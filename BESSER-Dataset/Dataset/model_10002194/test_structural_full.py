...
def test_assoc_B_A_link_reassign_clear():
    ...
    _safe_set(a, 'a2', b1)
    assert _is_linked(a, 'a2', b1)
    if hasattr(b1, 'b3'):
        assert _is_linked(b1, 'b3', a)
    _safe_set(a, 'a2', b2)
    assert _is_linked(a, 'a2', b2)
    if hasattr(b1, 'b3'):
        assert not _is_linked(b1, 'b3', a)
    if hasattr(b2, 'b3'):
        assert _is_linked(b2, 'b3', a)
    _safe_set(a, 'a2', None)
    assert not _is_linked(a, 'a2', b2)
    if hasattr(b2, 'b3'):
        assert not _is_linked(b2, 'b3', a)
...
def test_assoc_Z2_A_link_reassign_clear():
