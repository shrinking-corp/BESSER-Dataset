...
class System:
    ...
    def __init__(self, name: str, id: str, session: str, visits3: "User" = None, maintains5: "Admin" = None, has6: "Flightlist" = None, system8: "Timinglist" = None):
        self.name = name
        self.id = id
...
class User:
    ...
    def __init__(self, username: str, password: str, attribute: str, books0: set["Ticket"] = None, system2: "System" = None):
