...
User.attributes={User_attribute, User_password, User_username}
...
Ticket.attributes={Ticket_flightname, Ticket_passengername, Ticket_ticketid, Ticket_source, Ticket_price, Ticket_destination}
...
Admin.attributes={Admin_adminname, Admin_password, Admin_mobile, Admin_gender, Admin_type}
...
Timinglist.attributes={Timinglist_flightname, Timinglist_time, Timinglist_source, Timinglist_destination}
...
domain_model = DomainModel(
    name="_40263ea9_b9b0_4fca_a817_46b8ca09ad18",
    types={User, Ticket, System, Admin, Flightlist, Timinglist},
    associations={User_Ticket, User_System, Admin_System, System_Flightlist, System_Timinglist},
    generalizations={},
    metadata=None
)
