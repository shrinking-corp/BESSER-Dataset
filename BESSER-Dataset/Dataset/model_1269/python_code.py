...
class columnFamilyDataModel_ColumnFamily:
    ...
    def __init__(self, name: str, columnFamilyDataModel_ColumnFamily13: "columnFamilyDataModel_Column" = None, columnFamilyDataModel_ColumnFamily: "columnFamilyDataModel_Table" = None):
        self.name = name
...
class columnFamilyDataModel_Column:
    ...
    def __init__(self, name: str, columnFamilyDataModel_Column12: "columnFamilyDataModel_ColumnFamily" = None, columnFamilyDataModel_Column: "columnFamilyDataModel_Table" = None, columnFamilyDataModel_Column10: "columnFamilyDataModel_Type" = None, columnFamilyDataModel_Column19: "columnFamilyDataModel_Key" = None):
        self.name = name
