...
# Classes
columnFamilyDataModel_ColumnFamilyDataModel = Class(name="columnFamilyDataModel_ColumnFamilyDataModel")
columnFamilyDataModel_Table = Class(name="columnFamilyDataModel_Table")
columnFamilyDataModel_SimpleType = Class(name="columnFamilyDataModel_SimpleType")
Type = Class(name="Type")
columnFamilyDataModel_Collection = Class(name="columnFamilyDataModel_Collection", is_abstract=True)
columnFamilyDataModel_List = Class(name="columnFamilyDataModel_List")
Collection = Class(name="Collection")
columnFamilyDataModel_Set = Class(name="columnFamilyDataModel_Set")
columnFamilyDataModel_Map = Class(name="columnFamilyDataModel_Map")
columnFamilyDataModel_Tuple = Class(name="columnFamilyDataModel_Tuple")
columnFamilyDataModel_UserDefinedType = Class(name="columnFamilyDataModel_UserDefinedType")
columnFamilyDataModel_Field = Class(name="columnFamilyDataModel_Field")
columnFamilyDataModel_ColumnFamily = Class(name="columnFamilyDataModel_ColumnFamily")
columnFamilyDataModel_Column = Class(name="columnFamilyDataModel_Column")
columnFamilyDataModel_PartitionKey = Class(name="columnFamilyDataModel_PartitionKey")
columnFamilyDataModel_ClusteringKey = Class(name="columnFamilyDataModel_ClusteringKey")
columnFamilyDataModel_Type = Class(name="columnFamilyDataModel_Type", is_abstract=True)
columnFamilyDataModel_Key = Class(name="columnFamilyDataModel_Key", is_abstract=True)
Key = Class(name="Key")
...
domain_model = DomainModel(
    ...
    types={columnFamilyDataModel_ColumnFamilyDataModel, columnFamilyDataModel_Table, columnFamilyDataModel_SimpleType, Type, columnFamilyDataModel_Collection, columnFamilyDataModel_List, Collection, columnFamilyDataModel_Set, columnFamilyDataModel_Map, columnFamilyDataModel_Tuple, columnFamilyDataModel_UserDefinedType, columnFamilyDataModel_Field, columnFamilyDataModel_ColumnFamily, columnFamilyDataModel_Column, columnFamilyDataModel_PartitionKey, columnFamilyDataModel_ClusteringKey, columnFamilyDataModel_Type, columnFamilyDataModel_Key, Key, PrimitiveType},
    associations={columnFamily11, fields14, type15, tables0, columnFamilies1, columns3, partitionKeys5, clusteringKeys7, type9, column18},
