...
# Classes
USE_Class = Class(name="USE_Class")
USE_Type = Class(name="USE_Type", is_abstract=True)
USE_Parameter = Class(name="USE_Parameter")
USE_EnumerationType = Class(name="USE_EnumerationType")
Type = Class(name="Type")
USE_Attribute = Class(name="USE_Attribute")
USE_Operation = Class(name="USE_Operation")
USE_OCLExpression = Class(name="USE_OCLExpression")
USE_Model = Class(name="USE_Model")
USE_Enumeration = Class(name="USE_Enumeration")
USE_Association = Class(name="USE_Association")
USE_Role = Class(name="USE_Role")
USE_CollectionType = Class(name="USE_CollectionType")
USE_SimpleType = Class(name="USE_SimpleType")
USE_ReferenceType = Class(name="USE_ReferenceType")
USE_Literal = Class(name="USE_Literal")
...
USE_Class.attributes={USE_Class_name, USE_Class_abstract}
...
USE_Role.attributes={USE_Role_name, USE_Role_ordered, USE_Role_upperBound, USE_Role_lowerBound}
...
class_37: BinaryAssociation = BinaryAssociation(
    name="class_37",
    ends={
...
domain_model = DomainModel(
    name="USE",
    types={USE_Class, USE_Type, USE_Parameter, USE_EnumerationType, Type, USE_Attribute, USE_Operation, USE_OCLExpression, USE_Model, USE_Enumeration, USE_Association, USE_Role, USE_CollectionType, USE_SimpleType, USE_ReferenceType, USE_Literal, AssocKind, SimpleTypes, CollectionTypes},
    associations={type14, parameters16, implementation18, type21, preCondition24, postCondition27, type30, superClasses1, attributes2, operations4, invariants6, classes8, enumerations10, associations12, role41, className43, enum33, baseType35, class_37, literals39},
