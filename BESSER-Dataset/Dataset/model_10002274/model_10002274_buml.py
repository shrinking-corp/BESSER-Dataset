...
domain_model = DomainModel(
    name="a2cb8b5d_e8e7_4f0d_9914_5875204ca8d2",
    ...
    associations={Machine_Memory, Processor_Memory, Program_Instruction, Machine_Processor, Processor_Program, Vendor2Adapter_Vendor2Sound, Machine_Card, AcceleratorCard_CPU, Cache_RAM, ExtensionBoard_Card, Vendor1Adapter_Vendor1Sound},
    generalizations={},
    metadata=None
)
