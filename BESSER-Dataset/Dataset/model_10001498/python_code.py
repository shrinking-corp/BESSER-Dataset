...
class C1:
    ...
    def __init__(self, attC1: int, attC2: bool, b29: "B2" = None):
        self.attC1 = attC1
        self.attC2 = attC2
        self.b29 = b29
    ...
    def b29(self, value):
        ...
        old_value = getattr(self, f"_C1__b29", None)
        self.__b29 = value
...
class B2:
    ...
    def __init__(self, attB: int, a7: "A2" = None, c8: set["C1"] = None):
        self.attB = attB
        self.a7 = a7
    ...
    def c8(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "b29"):
                    opp_val = getattr(item, "b29", None)
                    
                    if opp_val == self:
                        setattr(item, "b29", None)
