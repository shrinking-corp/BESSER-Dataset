...
R_A2: BinaryAssociation = BinaryAssociation(
    name="R_A2",
    ends={
        Property(name="aR4", type=A2, multiplicity=Multiplicity(0, 9999)),
...
B2_C2: BinaryAssociation = BinaryAssociation(
    name="B2_C2",
    ends={
        Property(name="c8", type=C1, multiplicity=Multiplicity(0, 9999)),
        Property(name="b29", type=B2, multiplicity=Multiplicity(0, 1))
    }
)

# Domain Model
domain_model = DomainModel(
    name="_B0uvwOwREei9dNtZPq67hQ",
    types={A, B, C, A2, B2, C1, R, Y, Z, C2, C3},
    associations={A_B, B_C, R_A2, A2_B2, B2_C2},
    generalizations={},
    metadata=None
)
