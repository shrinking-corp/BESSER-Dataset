...
# Classes
y4fsm_Region = Class(name="y4fsm_Region")
State = Class(name="State")
y4fsm_State = Class(name="y4fsm_State", is_abstract=True)
y4fsm_Foo = Class(name="y4fsm_Foo")
y4fsm_Bar = Class(name="y4fsm_Bar")
...
domain_model = DomainModel(
    name="y4fsm",
    types={y4fsm_Region, State, y4fsm_State, y4fsm_Foo, y4fsm_Bar},
