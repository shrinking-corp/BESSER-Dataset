...
# Classes
statespace_StateSpace = Class(name="statespace_StateSpace")
Storage = Class(name="Storage")
statespace_Rule = Class(name="statespace_Rule")
statespace_State = Class(name="statespace_State")
statespace_Model = Class(name="statespace_Model")
statespace_EqualityHelper = Class(name="statespace_EqualityHelper")
statespace_EStringToStringMapEntry = Class(name="statespace_EStringToStringMapEntry")
statespace_Transition = Class(name="statespace_Transition")
statespace_EObjectIntegerMapEntry = Class(name="statespace_EObjectIntegerMapEntry")
statespace_EAttribute = Class(name="statespace_EAttribute")
statespace_EClass = Class(name="statespace_EClass")
statespace_Storage = Class(name="statespace_Storage")
statespace_EObject = Class(name="statespace_EObject")
...
statespace_StateSpace_m_removeState: Method = Method(name="removeState", parameters={Parameter(name='statespace_state', type=StringType)}, type=BooleanType)
...
statespace_StateSpace.attributes={statespace_StateSpace_layoutHideIndizes, statespace_StateSpace_layoutStateRepulsion, statespace_StateSpace_stateCount, statespace_StateSpace_maxStateDistance, statespace_StateSpace_allParameterKeys, statespace_StateSpace_layoutHideLabels, statespace_StateSpace_layoutTransitionAttraction, statespace_StateSpace_transitionCount, statespace_StateSpace_layoutZoomLevel}
statespace_StateSpace.methods={statespace_StateSpace_m_updateEqualityHelper, statespace_StateSpace_m_incTransitionCount, statespace_StateSpace_m_removeState}
...
statespace_State_m_getOutgoing: Method = Method(name="getOutgoing", parameters={Parameter(name='statespace_target', type=StringType), Parameter(name='statespace_paramIDs', type=StringType), Parameter(name='statespace_rule', type=StringType), Parameter(name='statespace_match', type=StringType)}, type=StringType)
statespace_State.attributes={statespace_State_index, statespace_State_open, statespace_State_hashCode, statespace_State_pruned, statespace_State_objectKeys, statespace_State_objectCount, statespace_State_derivedFrom, statespace_State_location, statespace_State_goal}
...
statespace_Model_m_getCopy: Method = Method(name="getCopy", parameters={Parameter(name='statespace_match', type=StringType)}, type=StringType)
statespace_Model_m_updateObjectKeys: Method = Method(name="updateObjectKeys", parameters={Parameter(name='statespace_identityTypes', type=StringType)}, type=BooleanType)
statespace_Model_m_collectMissingRootObjects: Method = Method(name="collectMissingRootObjects", parameters={})
statespace_Model.attributes={statespace_Model_eGraph, statespace_Model_objectKeys, statespace_Model_resource, statespace_Model_objectCount}
statespace_Model.methods={statespace_Model_m_getCopy, statespace_Model_m_collectMissingRootObjects, statespace_Model_m_updateObjectKeys}
...
statespace_EqualityHelper_m_equals: Method = Method(name="equals", parameters={Parameter(name='statespace_model2', type=StringType), Parameter(name='statespace_model1', type=StringType)}, type=BooleanType)
statespace_EqualityHelper_m_hashCode: Method = Method(name="hashCode", parameters={Parameter(name='statespace_model', type=StringType)}, type=IntegerType)
statespace_EqualityHelper_m_setStateSpace: Method = Method(name="setStateSpace", parameters={Parameter(name='statespace_stateSpace', type=StringType)})
statespace_EqualityHelper.attributes={statespace_EqualityHelper_checkLinkOrder}
statespace_EqualityHelper.methods={statespace_EqualityHelper_m_setStateSpace, statespace_EqualityHelper_m_equals, statespace_EqualityHelper_m_hashCode}
...
statespace_Transition.attributes={statespace_Transition_match, statespace_Transition_parameterCount, statespace_Transition_parameterKeys}
...
statespace_Storage_m_setData: Method = Method(name="setData", parameters={Parameter(name='statespace_value', type=StringType), Parameter(name='statespace_index', type=StringType)})
statespace_Storage_m_getData: Method = Method(name="getData", parameters={Parameter(name='statespace_endIndex', type=StringType), Parameter(name='statespace_beginIndex', type=StringType)}, type=StringType)
statespace_Storage_m_getData: Method = Method(name="getData", parameters={Parameter(name='statespace_index', type=StringType)}, type=IntegerType)
statespace_Storage_m_setData: Method = Method(name="setData", parameters={Parameter(name='statespace_beginIndex', type=StringType), Parameter(name='statespace_value', type=StringType)})
statespace_Storage_m_setData: Method = Method(name="setData", parameters={Parameter(name='statespace_beginIndex', type=StringType), Parameter(name='statespace_value', type=StringType), Parameter(name='statespace_endIndex', type=StringType)})
statespace_Storage.attributes={statespace_Storage_data}
statespace_Storage.methods={statespace_Storage_m_setData, statespace_Storage_m_getData, statespace_Storage_m_setData, statespace_Storage_m_setData, statespace_Storage_m_getData}
...
domain_model = DomainModel(
    name="statespace",
    types={statespace_StateSpace, Storage, statespace_Rule, statespace_State, statespace_Model, statespace_EqualityHelper, statespace_EStringToStringMapEntry, statespace_Transition, statespace_EObjectIntegerMapEntry, statespace_EAttribute, statespace_EClass, statespace_Storage, statespace_EObject},
    associations={openStates4, rules0, states1, initialStates2, model15, equalityHelper7, properties9, incoming11, outgoing12, stateSpace14, objectHashCodes17, objectKeysMap19, source22, target24, rule26, ignoredAttributes28, identityTypes30, key32},
