...
class Company_Company:
    ...
    def __init__(self, name: str, Company_Company: set["Company_Person"] = None, Company_Company6: set["Company_Project"] = None, Company_Company17: "Company_CompanyModel" = None, Company_Company9: "Company_Address" = None, Company_Company11: set["Company_Division"] = None):
        self.name = name
