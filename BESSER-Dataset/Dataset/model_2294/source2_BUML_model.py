...
# Classes
scheduleOfCourse_Shift = Class(name="scheduleOfCourse_Shift")
scheduleOfCourse_Occupation = Class(name="scheduleOfCourse_Occupation")
scheduleOfCourse_Lesson = Class(name="scheduleOfCourse_Lesson")
scheduleOfCourse_Room = Class(name="scheduleOfCourse_Room")
scheduleOfCourse_LessonPeriod = Class(name="scheduleOfCourse_LessonPeriod")
scheduleOfCourse_CourseLoad = Class(name="scheduleOfCourse_CourseLoad")
scheduleOfCourse_Capacity = Class(name="scheduleOfCourse_Capacity")
scheduleOfCourse_TopLevelSpace = Class(name="scheduleOfCourse_TopLevelSpace")
scheduleOfCourse_scheduleOfCourse = Class(name="scheduleOfCourse_scheduleOfCourse")
...
scheduleOfCourse_Shift.attributes={scheduleOfCourse_Shift_name, scheduleOfCourse_Shift_types}
...
scheduleOfCourse_Occupation.attributes={scheduleOfCourse_Occupation_current, scheduleOfCourse_Occupation_max}
...
scheduleOfCourse_Room.attributes={scheduleOfCourse_Room_name, scheduleOfCourse_Room_id, scheduleOfCourse_Room_type, scheduleOfCourse_Room_description}
...
scheduleOfCourse_CourseLoad.attributes={scheduleOfCourse_CourseLoad_totalQuantity, scheduleOfCourse_CourseLoad_type, scheduleOfCourse_CourseLoad_unitQuantity}
...
domain_model = DomainModel(
    ...
    associations={occupation0, lessons1, rooms3, lessonPeriods5, courseLoads6, shifts8, room11, topLevelSpace14, capacity16},
    generalizations={},
    metadata=None
)
