...
class programmes_CourseGroup:
    ...
    def __init__(self, name: str, coursesType: str, programmes_CourseGroup10: set["programmes_Course"] = None, programmes_CourseGroup: "programmes_Programme" = None):
        self.name = name
...
class programmes_Semester:
    ...
    def __init__(self, semesterType: str, year: int, programmes_Semester: "programmes_Specialization" = None, programmeSemester: "programmes_Programme" = None, programmes_Semester8: set["programmes_Course"] = None, Semester: "programmes_Programme" = None):
...
class programmes_Programme:
    ...
    def __init__(self, name: str, code: str, Programme6: "programmes_Semester" = None, specializesIn: set["programmes_Specialization"] = None, programme: set["programmes_Semester"] = None, programmes_Programme: set["programmes_CourseGroup"] = None, Programme: "programmes_Specialization" = None, programmes_Programme13: "programmes_University" = None):
        self.name = name
        self.code = code
