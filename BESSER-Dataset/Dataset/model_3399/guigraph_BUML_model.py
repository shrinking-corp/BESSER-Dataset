...
# Classes
guigraph_Arc = Class(name="guigraph_Arc", is_abstract=True)
guigraph_GuiGraphNode = Class(name="guigraph_GuiGraphNode", is_abstract=True)
Predicate = Class(name="Predicate")
guigraph_Widget = Class(name="guigraph_Widget")
guigraph_Form = Class(name="guigraph_Form")
Widget = Class(name="Widget")
Place = Class(name="Place")
guigraph_Transition = Class(name="guigraph_Transition", is_abstract=True)
GuiGraphNode = Class(name="GuiGraphNode")
rules_IRealTimeConsumer = Class(name="rules_IRealTimeConsumer")
guigraph_NoWidgetNode = Class(name="guigraph_NoWidgetNode")
guigraph_Place = Class(name="guigraph_Place", is_abstract=True)
guigraph_ConditionActionTransition = Class(name="guigraph_ConditionActionTransition")
Transition = Class(name="Transition")
guigraph_PreGenerationSequence = Class(name="guigraph_PreGenerationSequence")
guigraph_GuiGraph = Class(name="guigraph_GuiGraph")
AbstractModelElement = Class(name="AbstractModelElement")
guigraph_StandardArc = Class(name="guigraph_StandardArc")
Arc = Class(name="Arc")
guigraph_InhibitorArc = Class(name="guigraph_InhibitorArc")
guigraph_PageTransition = Class(name="guigraph_PageTransition")
guigraph_PageMappingArc = Class(name="guigraph_PageMappingArc")
guigraph_TimerTransition = Class(name="guigraph_TimerTransition")
...
guigraph_Transition.attributes={guigraph_Transition_timeMin, guigraph_Transition_timingType, guigraph_Transition_terminates, guigraph_Transition_risk, guigraph_Transition_timeMax}
...
guigraph_Place.attributes={guigraph_Place_provideAsInterface, guigraph_Place_initialTokens}
...
domain_model = DomainModel(
    name="guigraph",
    types={guigraph_Arc, guigraph_GuiGraphNode, Predicate, guigraph_Widget, guigraph_Form, Widget, Place, guigraph_Transition, GuiGraphNode, rules_IRealTimeConsumer, guigraph_NoWidgetNode, guigraph_Place, guigraph_ConditionActionTransition, Transition, guigraph_PreGenerationSequence, guigraph_GuiGraph, AbstractModelElement, guigraph_StandardArc, Arc, guigraph_InhibitorArc, guigraph_PageTransition, guigraph_PageMappingArc, guigraph_TimerTransition, ITimeConsumer, TimingType},
    associations={arcs0, nodes1, invariant3, children6, applicationCondition7, actions9, source12, target15, page18, mapping20, consumer11},
    generalizations={gen_guigraph_Widget_AbstractModelElement, gen_guigraph_Form_Widget, gen_guigraph_Form_Place, gen_guigraph_Transition_GuiGraphNode, gen_guigraph_Transition_rules_IRealTimeConsumer, gen_guigraph_GuiGraphNode_AbstractModelElement, gen_guigraph_NoWidgetNode_Place, gen_guigraph_Place_GuiGraphNode, gen_guigraph_ConditionActionTransition_Transition, gen_guigraph_GuiGraph_AbstractModelElement, gen_guigraph_StandardArc_Arc, gen_guigraph_InhibitorArc_Arc, gen_guigraph_PageTransition_GuiGraphNode, gen_guigraph_PageMappingArc_Arc, gen_guigraph_TimerTransition_Transition, gen_guigraph_Arc_AbstractModelElement},
    metadata=None
)
