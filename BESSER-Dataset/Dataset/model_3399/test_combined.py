...
def test_hyp_guigraph_pagemappingarc_is_not_abstract():
    assert not inspect.isabstract(guigraph_PageMappingArc)


def test_hyp_guigraph_pagemappingarc_constructor_exists():
    assert callable(guigraph_PageMappingArc.__init__)


def test_hyp_guigraph_pagemappingarc_constructor_args():
...
def test_hyp_guigraph_place_provideAsInterface_setter(instance):
...
@given(instance=guigraph_Transition_strategy)
def test_hyp_guigraph_transition_risk_setter(instance):
