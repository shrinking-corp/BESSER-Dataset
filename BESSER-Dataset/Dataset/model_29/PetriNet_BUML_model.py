...
# Classes
petrinet_Network = Class(name="petrinet_Network")
...
petrinet_Arc.attributes={petrinet_Arc_kind, petrinet_Arc_readOnly, petrinet_Arc_tokensCount}
...
domain_model = DomainModel(
    name="petrinet",
    types={petrinet_Network, petrinet_Node, petrinet_Arc, petrinet_Transition, Node, petrinet_Place, ArcKind},
