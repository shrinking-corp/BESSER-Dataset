...
# Classes
adl101_Provided = Class(name="adl101_Provided")
adl101_Interface = Class(name="adl101_Interface", is_abstract=True)
adl101_Binding = Class(name="adl101_Binding")
adl101_Content = Class(name="adl101_Content")
adl101_Component = Class(name="adl101_Component")
adl101_Required = Class(name="adl101_Required")
...
adl101_Interface.attributes={adl101_Interface_signature, adl101_Interface_name}
...
adl101_Content.attributes={adl101_Content_expression, adl101_Content_language}
...
domain_model = DomainModel(
    name="adl101",
    types={adl101_Provided, adl101_Interface, adl101_Binding, adl101_Content, adl101_Component, adl101_Required, Interface},
    associations={bindings0, from_1, to4, contentParent7, subComponents9, requiredInterfaces10, providedInterfaces12, content14},
    generalizations={gen_adl101_Provided_Interface, gen_adl101_Required_Interface},
    metadata=None
)
