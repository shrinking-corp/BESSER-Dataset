...
# Classes
viewmodeltrace_EObject = Class(name="viewmodeltrace_EObject")
viewmodeltrace_JavaObjectMatchArgument = Class(name="viewmodeltrace_JavaObjectMatchArgument")
viewmodeltrace_ViewModelTrace = Class(name="viewmodeltrace_ViewModelTrace")
viewmodeltrace_LogicModel = Class(name="viewmodeltrace_LogicModel")
viewmodeltrace_Trace = Class(name="viewmodeltrace_Trace", is_abstract=True)
viewmodeltrace_MatchArgumentTuple = Class(name="viewmodeltrace_MatchArgumentTuple")
viewmodeltrace_MatchArgument = Class(name="viewmodeltrace_MatchArgument", is_abstract=True)
viewmodeltrace_EObjectMatchArgument = Class(name="viewmodeltrace_EObjectMatchArgument")
MatchArgument = Class(name="MatchArgument")
viewmodeltrace_VariableInstantiationTrace = Class(name="viewmodeltrace_VariableInstantiationTrace")
Trace = Class(name="Trace")
viewmodeltrace_StringVariablePair = Class(name="viewmodeltrace_StringVariablePair")
viewmodeltrace_Variable = Class(name="viewmodeltrace_Variable")
viewmodeltrace_ConstraintTrace = Class(name="viewmodeltrace_ConstraintTrace")
viewmodeltrace_Constraint = Class(name="viewmodeltrace_Constraint")
...
domain_model = DomainModel(
    name="viewmodeltrace",
    types={viewmodeltrace_EObject, viewmodeltrace_JavaObjectMatchArgument, viewmodeltrace_ViewModelTrace, viewmodeltrace_LogicModel, viewmodeltrace_Trace, viewmodeltrace_MatchArgumentTuple, viewmodeltrace_MatchArgument, viewmodeltrace_EObjectMatchArgument, MatchArgument, viewmodeltrace_VariableInstantiationTrace, Trace, viewmodeltrace_StringVariablePair, viewmodeltrace_Variable, viewmodeltrace_ConstraintTrace, viewmodeltrace_Constraint, TraceState},
    associations={value4, logicModel0, traces1, elements3, argumentTuple5, variables8, value9, localVariables11, constraints13},
