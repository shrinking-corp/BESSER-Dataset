...
# Classes
custostorage_A = Class(name="custostorage_A")
custostorage_B = Class(name="custostorage_B")
custostorage_C = Class(name="custostorage_C")
custostorage_D = Class(name="custostorage_D")
custostorage_E = Class(name="custostorage_E")
custostorage_F = Class(name="custostorage_F")
custostorage_AAbstract = Class(name="custostorage_AAbstract", is_abstract=True)
custostorage_BAbstract = Class(name="custostorage_BAbstract", is_abstract=True)
custostorage_CAbstract = Class(name="custostorage_CAbstract", is_abstract=True)
custostorage_DAbstract = Class(name="custostorage_DAbstract", is_abstract=True)
custostorage_EAbstract = Class(name="custostorage_EAbstract", is_abstract=True)
custostorage_FAbstract = Class(name="custostorage_FAbstract", is_abstract=True)
