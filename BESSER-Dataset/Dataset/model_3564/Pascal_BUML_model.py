...
pascal_var_decl = Class(name="pascal_var_decl")
pascal_var_list = Class(name="pascal_var_list")
pascal_Pascal = Class(name="pascal_Pascal")
pascal_program = Class(name="pascal_program")
pascal_var_block = Class(name="pascal_var_block")
pascal_block = Class(name="pascal_block")
pascal_statement = Class(name="pascal_statement")
pascal_atrib = Class(name="pascal_atrib")
pascal_expression = Class(name="pascal_expression")
pascal_arit_expression = Class(name="pascal_arit_expression")
expression = Class(name="expression")
pascal_repetitive_arit_expression = Class(name="pascal_repetitive_arit_expression")
pascal_rel_expression = Class(name="pascal_rel_expression")
...
pascal_var_decl.attributes={pascal_var_decl_value, pascal_var_decl_var_type, pascal_var_decl_var_id}
...
pascal_rel_expression.attributes={pascal_rel_expression_close, pascal_rel_expression_open, pascal_rel_expression_first, pascal_rel_expression_op, pascal_rel_expression_second}
...
domain_model = DomainModel(
    name="pascal",
    types={pascal_EObject, pascal_var_decl, pascal_var_list, pascal_Pascal, pascal_program, pascal_var_block, pascal_block, pascal_statement, pascal_atrib, pascal_expression, pascal_arit_expression, expression, pascal_repetitive_arit_expression, pascal_rel_expression, type},
    associations={var_statements5, head0, declarations1, scope3, statements7, atrib_block9, exp11, exp13, exp15},
