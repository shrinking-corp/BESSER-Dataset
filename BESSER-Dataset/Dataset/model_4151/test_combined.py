...
def test_hyp_greetings_refgreeting_is_not_abstract():
    assert not inspect.isabstract(greetings_RefGreeting)


def test_hyp_greetings_refgreeting_constructor_exists():
    assert callable(greetings_RefGreeting.__init__)


def test_hyp_greetings_refgreeting_constructor_args():
    sig = inspect.signature(greetings_RefGreeting.__init__)
    params = list(sig.parameters.keys())



def test_hyp_greetings_hellogreeting_is_not_abstract():
    assert not inspect.isabstract(greetings_HelloGreeting)


def test_hyp_greetings_hellogreeting_constructor_exists():
    assert callable(greetings_HelloGreeting.__init__)


def test_hyp_greetings_hellogreeting_constructor_args():
...
def test_hyp_greetings_model_is_not_abstract():
    assert not inspect.isabstract(greetings_Model)


def test_hyp_greetings_model_constructor_exists():
    assert callable(greetings_Model.__init__)


def test_hyp_greetings_model_constructor_args():
...
def test_hyp_greetings_hellogreeting_name_setter(instance):
