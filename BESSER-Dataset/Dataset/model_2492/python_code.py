...
class z6fsm_AbstractState(ABC):
    ...
    def __init__(self, id: str, z6fsm_AbstractState3: "z6fsm_AbstractState" = None, z6fsm_AbstractState1: set["z6fsm_AbstractState"] = None, z6fsm_AbstractState: "z6fsm_Region" = None):
        self.id = id
