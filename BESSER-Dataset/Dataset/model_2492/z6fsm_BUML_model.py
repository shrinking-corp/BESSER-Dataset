...
# Classes
z6fsm_State = Class(name="z6fsm_State")
AbstractState = Class(name="AbstractState")
z6fsm_Foo = Class(name="z6fsm_Foo")
z6fsm_Region = Class(name="z6fsm_Region")
z6fsm_AbstractState = Class(name="z6fsm_AbstractState", is_abstract=True)
...
domain_model = DomainModel(
    name="z6fsm",
    types={z6fsm_State, AbstractState, z6fsm_Foo, z6fsm_Region, z6fsm_AbstractState},
