...
# Classes
vql_VQLImportSection = Class(name="vql_VQLImportSection")
XImportSection = Class(name="XImportSection")
vql_Pattern = Class(name="vql_Pattern")
vql_EClassifierConstraint = Class(name="vql_EClassifierConstraint")
Constraint = Class(name="Constraint")
UnaryTypeConstraint = Class(name="UnaryTypeConstraint")
vql_EnumValue = Class(name="vql_EnumValue")
ValueReference = Class(name="ValueReference")
vql_EEnum = Class(name="vql_EEnum")
vql_EEnumLiteral = Class(name="vql_EEnumLiteral")
vql_PatternModel = Class(name="vql_PatternModel")
vql_ClassType = Class(name="vql_ClassType")
EntityType = Class(name="EntityType")
vql_EClassifier = Class(name="vql_EClassifier")
vql_ReferenceType = Class(name="vql_ReferenceType")
RelationType = Class(name="RelationType")
vql_EStructuralFeature = Class(name="vql_EStructuralFeature")
vql_PackageImport = Class(name="vql_PackageImport")
vql_PatternImport = Class(name="vql_PatternImport")
vql_EPackage = Class(name="vql_EPackage")
vql_PatternBody = Class(name="vql_PatternBody")
vql_AnnotationParameter = Class(name="vql_AnnotationParameter")
vql_ValueReference = Class(name="vql_ValueReference")
vql_Expression = Class(name="vql_Expression")
Expression = Class(name="Expression")
vql_Type = Class(name="vql_Type")
vql_VariableReference = Class(name="vql_VariableReference")
vql_Annotation = Class(name="vql_Annotation")
vql_Modifiers = Class(name="vql_Modifiers")
vql_Variable = Class(name="vql_Variable")
vql_Constraint = Class(name="vql_Constraint")
vql_PatternCall = Class(name="vql_PatternCall")
CallableRelation = Class(name="CallableRelation")
vql_LiteralValueReference = Class(name="vql_LiteralValueReference")
vql_ComputationValue = Class(name="vql_ComputationValue")
vql_ParameterRef = Class(name="vql_ParameterRef")
Variable = Class(name="Variable")
vql_Parameter = Class(name="vql_Parameter")
vql_LocalVariable = Class(name="vql_LocalVariable")
vql_JavaType = Class(name="vql_JavaType")
vql_EntityType = Class(name="vql_EntityType")
Type = Class(name="Type")
vql_PatternCompositionConstraint = Class(name="vql_PatternCompositionConstraint")
vql_CallableRelation = Class(name="vql_CallableRelation", is_abstract=True)
vql_CompareConstraint = Class(name="vql_CompareConstraint")
vql_CheckConstraint = Class(name="vql_CheckConstraint")
vql_XExpression = Class(name="vql_XExpression")
vql_PathExpressionConstraint = Class(name="vql_PathExpressionConstraint")
vql_StringValue = Class(name="vql_StringValue")
LiteralValueReference = Class(name="LiteralValueReference")
vql_JvmDeclaredType = Class(name="vql_JvmDeclaredType")
vql_RelationType = Class(name="vql_RelationType")
vql_TypeCheckConstraint = Class(name="vql_TypeCheckConstraint")
vql_ListValue = Class(name="vql_ListValue")
vql_FunctionEvaluationValue = Class(name="vql_FunctionEvaluationValue")
ComputationValue = Class(name="ComputationValue")
vql_AggregatedValue = Class(name="vql_AggregatedValue")
vql_JvmType = Class(name="vql_JvmType")
vql_UnaryTypeConstraint = Class(name="vql_UnaryTypeConstraint", is_abstract=True)
vql_NumberValue = Class(name="vql_NumberValue")
vql_XNumberLiteral = Class(name="vql_XNumberLiteral")
vql_BoolValue = Class(name="vql_BoolValue")
vql_XBooleanLiteral = Class(name="vql_XBooleanLiteral")
...
vql_VariableReference.attributes={vql_VariableReference_var, vql_VariableReference_aggregator}
...
domain_model = DomainModel(
    name="vql",
    types={vql_VQLImportSection, XImportSection, vql_Pattern, vql_EClassifierConstraint, Constraint, UnaryTypeConstraint, vql_EnumValue, ValueReference, vql_EEnum, vql_EEnumLiteral, vql_PatternModel, vql_ClassType, EntityType, vql_EClassifier, vql_ReferenceType, RelationType, vql_EStructuralFeature, vql_PackageImport, vql_PatternImport, vql_EPackage, vql_PatternBody, vql_AnnotationParameter, vql_ValueReference, vql_Expression, Expression, vql_Type, vql_VariableReference, vql_Annotation, vql_Modifiers, vql_Variable, vql_Constraint, vql_PatternCall, CallableRelation, vql_LiteralValueReference, vql_ComputationValue, vql_ParameterRef, Variable, vql_Parameter, vql_LocalVariable, vql_JavaType, vql_EntityType, Type, vql_PatternCompositionConstraint, vql_CallableRelation, vql_CompareConstraint, vql_CheckConstraint, vql_XExpression, vql_PathExpressionConstraint, vql_StringValue, LiteralValueReference, vql_JvmDeclaredType, vql_RelationType, vql_TypeCheckConstraint, vql_ListValue, vql_FunctionEvaluationValue, ComputationValue, vql_AggregatedValue, vql_JvmType, vql_UnaryTypeConstraint, vql_NumberValue, vql_XNumberLiteral, vql_BoolValue, vql_XBooleanLiteral, ExecutionType, ParameterDirection, CompareFeature, ClosureType},
    associations={ePackage3, pattern5, patterns7, enumeration10, literal11, importPackages13, patterns15, metamodel18, classname20, refname22, packageImport0, patternImport1, parameters27, bodies29, parameters31, value33, type35, annotations23, modifiers25, constraints39, variables41, patternRef44, parameters46, referredParam49, variable37, call52, leftOperand53, rightOperand55, expression58, edgeTypes59, sourceType61, src64, dst67, classRef51, value71, values72, expression74, aggregator76, call78, aggregateType81, type83, var84, value70},
    generalizations={gen_vql_VQLImportSection_XImportSection, gen_vql_EClassifierConstraint_Constraint, gen_vql_EClassifierConstraint_UnaryTypeConstraint, gen_vql_EnumValue_ValueReference, gen_vql_ClassType_EntityType, gen_vql_ReferenceType_RelationType, gen_vql_Variable_Expression, gen_vql_VariableReference_ValueReference, gen_vql_PatternCall_CallableRelation, gen_vql_ValueReference_Expression, gen_vql_LiteralValueReference_ValueReference, gen_vql_ComputationValue_ValueReference, gen_vql_ParameterRef_Variable, gen_vql_Parameter_Variable, gen_vql_LocalVariable_Variable, gen_vql_JavaType_EntityType, gen_vql_EntityType_Type, gen_vql_PatternCompositionConstraint_Constraint, gen_vql_CompareConstraint_Constraint, gen_vql_CheckConstraint_Constraint, gen_vql_PathExpressionConstraint_Constraint, gen_vql_PathExpressionConstraint_CallableRelation, gen_vql_StringValue_LiteralValueReference, gen_vql_RelationType_Type, gen_vql_TypeCheckConstraint_Constraint, gen_vql_TypeCheckConstraint_UnaryTypeConstraint, gen_vql_ListValue_LiteralValueReference, gen_vql_FunctionEvaluationValue_ComputationValue, gen_vql_AggregatedValue_ComputationValue, gen_vql_UnaryTypeConstraint_CallableRelation, gen_vql_NumberValue_LiteralValueReference, gen_vql_BoolValue_LiteralValueReference},
    metadata=None
)
