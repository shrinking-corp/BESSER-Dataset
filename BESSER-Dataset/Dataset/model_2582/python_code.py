...
class vql_Annotation:
    ...
    def __init__(self, name: str, vql_Annotation32: set["vql_AnnotationParameter"] = None, vql_Annotation: "vql_Pattern" = None):
        self.name = name
...
class vql_Variable(Expression):
    ...
    def __init__(self, name: str, vql_Variable: "vql_Pattern" = None, vql_Variable36: "vql_Type" = None, vql_Variable43: "vql_PatternBody" = None, vql_Variable50: "vql_ParameterRef" = None, vql_Variable38: "vql_VariableReference" = None):
        self.name = name
...
class vql_ValueReference(Expression):
    ...
    def __init__(self, vql_ValueReference73: "vql_ListValue" = None, vql_ValueReference: "vql_AnnotationParameter" = None, vql_ValueReference48: "vql_PatternCall" = None, vql_ValueReference54: "vql_CompareConstraint" = None, vql_ValueReference57: "vql_CompareConstraint" = None, vql_ValueReference69: "vql_PathExpressionConstraint" = None):
...
class vql_PatternImport:
    ...
    def __init__(self, packageName: str, vql_PatternImport6: "vql_Pattern" = None, vql_PatternImport8: set["vql_Pattern"] = None, vql_PatternImport: "vql_VQLImportSection" = None):
...
class vql_PackageImport:
    ...
    def __init__(self, alias: str, vql_PackageImport4: "vql_EPackage" = None, vql_PackageImport19: "vql_ClassType" = None, vql_PackageImport: "vql_VQLImportSection" = None):
        self.alias = alias
...
class vql_VariableReference(ValueReference):
    ...
    def __init__(self, aggregator: bool, var: str, vql_VariableReference86: "vql_UnaryTypeConstraint" = None, vql_VariableReference: "vql_Variable" = None, vql_VariableReference66: "vql_PathExpressionConstraint" = None):
...
class vql_Pattern:
    ...
    def __init__(self, name: str, vql_Pattern: "vql_PatternImport" = None, vql_Pattern9: "vql_PatternImport" = None, vql_Pattern17: "vql_PatternModel" = None, vql_Pattern28: set["vql_Variable"] = None, vql_Pattern30: set["vql_PatternBody"] = None, vql_Pattern24: set["vql_Annotation"] = None, vql_Pattern26: "vql_Modifiers" = None, vql_Pattern45: "vql_PatternCall" = None):
        self.name = name
...
class vql_VQLImportSection(XImportSection):
    ...
    def __init__(self, vql_VQLImportSection14: "vql_PatternModel" = None, vql_VQLImportSection: set["vql_PackageImport"] = None, vql_VQLImportSection2: set["vql_PatternImport"] = None):
...
class vql_CallableRelation(ABC):
    ...
    def __init__(self, transitive: str, vql_CallableRelation80: "vql_AggregatedValue" = None, vql_CallableRelation: "vql_PatternCompositionConstraint" = None):
