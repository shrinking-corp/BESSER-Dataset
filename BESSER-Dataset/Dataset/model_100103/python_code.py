...
class tp4_Review(Labelled):
    ...
    def __init__(self, date: date, tp4_Review24: "tp4_ReviewNote" = None, tp4_Review: "tp4_Researcher" = None):
        self.date = date
...
class tp4_Write(Labelled):
    ...
    def __init__(self, timeSpent: int, tp4_Write21: "tp4_Paragraph" = None, tp4_Write: "tp4_Researcher" = None):
...
class tp4_Researcher:
    ...
    def __init__(self, name: str, forName: str, authors: set["tp4_Paper"] = None, tp4_Researcher6: set["tp4_Skill"] = None, tp4_Researcher8: "tp4_Position" = None, Researcher: "tp4_Paper" = None, tp4_Researcher27: "tp4_PublicationStructure" = None, tp4_Researcher: set["tp4_Write"] = None, tp4_Researcher3: set["tp4_Review"] = None):
        self.name = name
...
class tp4_PublicationProcess(Named):
    ...
    def __init__(self, minTime: int, maxTime: int, tp4_PublicationProcess17: "tp4_Progress" = None, tp4_PublicationProcess32: "tp4_PublicationSystem" = None, tp4_PublicationProcess: set["tp4_Phases"] = None):
