...
def test_assoc_controller9_link_reassign_clear():
    ...
    if hasattr(b1, 'AssistantMVC_Controller11'):
        assert _is_linked(b1, 'AssistantMVC_Controller11', a)
    _safe_set(a, 'AssistantMVC_View10', b2)
    assert _is_linked(a, 'AssistantMVC_View10', b2)
    if hasattr(b1, 'AssistantMVC_Controller11'):
        assert not _is_linked(b1, 'AssistantMVC_Controller11', a)
    if hasattr(b2, 'AssistantMVC_Controller11'):
        assert _is_linked(b2, 'AssistantMVC_Controller11', a)
    _safe_set(a, 'AssistantMVC_View10', None)
    assert not _is_linked(a, 'AssistantMVC_View10', b2)
    if hasattr(b2, 'AssistantMVC_Controller11'):
        assert not _is_linked(b2, 'AssistantMVC_Controller11', a)
