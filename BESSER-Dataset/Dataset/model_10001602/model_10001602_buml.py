...
Customer.attributes={Customer_emailAddress, Customer_name, Customer_dateOfBirth, Customer_phoneNumber, Customer_address}
...
domain_model = DomainModel(
    name="_IbxNoIr5Eeq3N_Xh6gsEIQ",
    types={Customer, transaction_Transaction, transaction_DepositTransaction, transaction_WithdrawTransaction, transaction_TransferTransaction, account_SavingsAccount, account_CertificatesOfDepositAccount, account_CheckingAccount, account_Account, Login, transaction_TransactionType, account_AccountType},
