...
feature_Model = Class(name="feature_Model")
...
feature_Feature.attributes={feature_Feature_isSelected, feature_Feature_max, feature_Feature_attribute, feature_Feature_min, feature_Feature_name}
...
domain_model = DomainModel(
    name="feature",
    types={feature_Feature, feature_Model},
