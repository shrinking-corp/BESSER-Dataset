...
def test_hyp_units_av_perjoinpointscope_is_not_abstract():
    assert not inspect.isabstract(units_av_PerJoinPointScope)


def test_hyp_units_av_perjoinpointscope_constructor_exists():
    assert callable(units_av_PerJoinPointScope.__init__)


def test_hyp_units_av_perjoinpointscope_constructor_args():
    sig = inspect.signature(units_av_PerJoinPointScope.__init__)
    params = list(sig.parameters.keys())



def test_hyp_units_av_globalscope_is_not_abstract():
    assert not inspect.isabstract(units_av_GlobalScope)


def test_hyp_units_av_globalscope_constructor_exists():
    assert callable(units_av_GlobalScope.__init__)


def test_hyp_units_av_globalscope_constructor_args():
    sig = inspect.signature(units_av_GlobalScope.__init__)
    params = list(sig.parameters.keys())



def test_hyp_units_av_eobject_is_not_abstract():
    assert not inspect.isabstract(units_av_EObject)


def test_hyp_units_av_eobject_constructor_exists():
    assert callable(units_av_EObject.__init__)


def test_hyp_units_av_eobject_constructor_args():
    sig = inspect.signature(units_av_EObject.__init__)
    params = list(sig.parameters.keys())



def test_hyp_units_av_advice_is_not_abstract():
    assert not inspect.isabstract(units_av_Advice)


def test_hyp_units_av_advice_constructor_exists():
    assert callable(units_av_Advice.__init__)


def test_hyp_units_av_advice_constructor_args():
    sig = inspect.signature(units_av_Advice.__init__)
    params = list(sig.parameters.keys())



def test_hyp_units_av_baseunit_is_not_abstract():
    assert not inspect.isabstract(units_av_BaseUnit)


def test_hyp_units_av_baseunit_constructor_exists():
    assert callable(units_av_BaseUnit.__init__)


def test_hyp_units_av_baseunit_constructor_args():
...
def test_hyp_units_av_unit_is_not_abstract():
    assert not inspect.isabstract(units_av_Unit)


def test_hyp_units_av_unit_constructor_exists():
    assert callable(units_av_Unit.__init__)


def test_hyp_units_av_unit_constructor_args():
    sig = inspect.signature(units_av_Unit.__init__)
    params = list(sig.parameters.keys())



def test_hyp_units_av_unitcarryingelement_is_not_abstract():
    assert not inspect.isabstract(units_av_UnitCarryingElement)


def test_hyp_units_av_unitcarryingelement_constructor_exists():
    assert callable(units_av_UnitCarryingElement.__init__)


def test_hyp_units_av_unitcarryingelement_constructor_args():
...
def test_hyp_units_av_unitpower_is_not_abstract():
    assert not inspect.isabstract(units_av_UnitPower)


def test_hyp_units_av_unitpower_constructor_exists():
    assert callable(units_av_UnitPower.__init__)


def test_hyp_units_av_unitpower_constructor_args():
...
def test_hyp_units_av_unitliteral_is_not_abstract():
    assert not inspect.isabstract(units_av_UnitLiteral)


def test_hyp_units_av_unitliteral_constructor_exists():
    assert callable(units_av_UnitLiteral.__init__)


def test_hyp_units_av_unitliteral_constructor_args():
    sig = inspect.signature(units_av_UnitLiteral.__init__)
    params = list(sig.parameters.keys())



def test_hyp_units_av_unitmultiplication_is_not_abstract():
    assert not inspect.isabstract(units_av_UnitMultiplication)


def test_hyp_units_av_unitmultiplication_constructor_exists():
    assert callable(units_av_UnitMultiplication.__init__)


def test_hyp_units_av_unitmultiplication_constructor_args():
    sig = inspect.signature(units_av_UnitMultiplication.__init__)
    params = list(sig.parameters.keys())



def test_hyp_units_av_unitrepository_is_not_abstract():
    assert not inspect.isabstract(units_av_UnitRepository)


def test_hyp_units_av_unitrepository_constructor_exists():
    assert callable(units_av_UnitRepository.__init__)


def test_hyp_units_av_unitrepository_constructor_args():
...
def test_hyp_units_av_baseunit_name_setter(instance):
...
def test_hyp_units_av_unitcarryingelement_unitSpecification_setter(instance):
...
def test_hyp_units_av_unitpower_exponent_setter(instance):
