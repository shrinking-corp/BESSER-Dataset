...
# Classes
units_av_UnitRepository = Class(name="units_av_UnitRepository")
units_av_UnitMultiplication = Class(name="units_av_UnitMultiplication")
Unit = Class(name="Unit")
units_av_UnitCarryingElement = Class(name="units_av_UnitCarryingElement")
units_av_Unit = Class(name="units_av_Unit")
units_av_BaseUnit = Class(name="units_av_BaseUnit")
units_av_UnitPower = Class(name="units_av_UnitPower")
units_av_UnitLiteral = Class(name="units_av_UnitLiteral")
units_av_Advice = Class(name="units_av_Advice")
units_av_EObject = Class(name="units_av_EObject")
units_av_GlobalScope = Class(name="units_av_GlobalScope")
units_av_PerJoinPointScope = Class(name="units_av_PerJoinPointScope")
...
domain_model = DomainModel(
    name="units_av",
    types={units_av_UnitRepository, units_av_UnitMultiplication, Unit, units_av_UnitCarryingElement, units_av_Unit, units_av_BaseUnit, units_av_UnitPower, units_av_UnitLiteral, units_av_Advice, units_av_EObject, units_av_GlobalScope, units_av_PerJoinPointScope},
    associations={units1, unit0, units2, unit4, baseUnit6, children8, scopedObject9, scopedObject11},
    generalizations={gen_units_av_UnitMultiplication_Unit, gen_units_av_UnitPower_Unit, gen_units_av_UnitLiteral_Unit},
    metadata=None
)
