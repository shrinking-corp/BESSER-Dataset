...
class graph_Declaration:
    ...
    def __init__(self, name: str, type: str, graph_Declaration4: "graph_AssignStmt" = None, graph_Declaration61: "graph_VariableRef" = None, graph_Declaration23: "graph_MoveStmt" = None, graph_Declaration: "graph_Program" = None):
        self.name = name
        self.type = type
...
class graph_Vertex:
    ...
    def __init__(self, name: str, graph_Vertex63: "graph_GraphConstant" = None, graph_Vertex: "graph_Edge" = None, graph_Vertex27: "graph_Edge" = None, graph_Vertex71: "graph_ParticleConstant" = None):
        self.name = name
