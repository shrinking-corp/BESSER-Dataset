...
# Classes
featuremodel_Rule = Class(name="featuremodel_Rule")
featuremodel_FeatureModel = Class(name="featuremodel_FeatureModel")
featuremodel_Description = Class(name="featuremodel_Description")
featuremodel_Attribute = Class(name="featuremodel_Attribute")
featuremodel_Feature = Class(name="featuremodel_Feature")
featuremodel_Constraint = Class(name="featuremodel_Constraint")
Rule = Class(name="Rule")
featuremodel_Group = Class(name="featuremodel_Group")
featuremodel_AttributeValueBoolean = Class(name="featuremodel_AttributeValueBoolean")
featuremodel_AttributeValueEObject = Class(name="featuremodel_AttributeValueEObject")
featuremodel_EObject = Class(name="featuremodel_EObject")
featuremodel_AttributeValue = Class(name="featuremodel_AttributeValue", is_abstract=True)
featuremodel_AttributeType = Class(name="featuremodel_AttributeType", is_abstract=True)
featuremodel_AttributeTypeInt = Class(name="featuremodel_AttributeTypeInt")
AttributeType = Class(name="AttributeType")
featuremodel_AttributeTypeString = Class(name="featuremodel_AttributeTypeString")
featuremodel_AttributeTypeBoolean = Class(name="featuremodel_AttributeTypeBoolean")
featuremodel_AttributeTypeEObject = Class(name="featuremodel_AttributeTypeEObject")
featuremodel_AttributeValueInt = Class(name="featuremodel_AttributeValueInt")
AttributeValue = Class(name="AttributeValue")
featuremodel_AttributeValueString = Class(name="featuremodel_AttributeValueString")
...
featuremodel_Description.attributes={featuremodel_Description_id, featuremodel_Description_text}
...
featuremodel_Attribute.attributes={featuremodel_Attribute_id, featuremodel_Attribute_setable, featuremodel_Attribute_name}
...
featuremodel_Feature.attributes={featuremodel_Feature_type, featuremodel_Feature_id, featuremodel_Feature_name}
...
featuremodel_Group.attributes={featuremodel_Group_id, featuremodel_Group_upper, featuremodel_Group_lower}
...
domain_model = DomainModel(
    name="featuremodel",
    types={featuremodel_Rule, featuremodel_FeatureModel, featuremodel_Description, featuremodel_Attribute, featuremodel_Feature, featuremodel_Constraint, Rule, featuremodel_Group, featuremodel_AttributeValueBoolean, featuremodel_AttributeValueEObject, featuremodel_EObject, featuremodel_AttributeValue, featuremodel_AttributeType, featuremodel_AttributeTypeInt, AttributeType, featuremodel_AttributeTypeString, featuremodel_AttributeTypeBoolean, featuremodel_AttributeTypeEObject, featuremodel_AttributeValueInt, AttributeValue, featuremodel_AttributeValueString, VariabilityType},
    associations={description0, attributes1, root3, constraints5, description7, features10, value28, description12, attributes15, children18, description21, defaultValue24, type26},
    generalizations={gen_featuremodel_Constraint_Rule, gen_featuremodel_AttributeValueBoolean_AttributeValue, gen_featuremodel_AttributeValueEObject_AttributeValue, gen_featuremodel_AttributeTypeInt_AttributeType, gen_featuremodel_AttributeTypeString_AttributeType, gen_featuremodel_AttributeTypeBoolean_AttributeType, gen_featuremodel_AttributeTypeEObject_AttributeType, gen_featuremodel_AttributeValueInt_AttributeValue, gen_featuremodel_AttributeValueString_AttributeValue},
    metadata=None
)
