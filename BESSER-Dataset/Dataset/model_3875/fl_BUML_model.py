...
# Classes
fl_ApplyExp = Class(name="fl_ApplyExp")
fl_BinaryExp = Class(name="fl_BinaryExp", is_abstract=True)
fl_Program = Class(name="fl_Program")
fl_Function = Class(name="fl_Function")
fl_Argument = Class(name="fl_Argument")
fl_Exp = Class(name="fl_Exp", is_abstract=True)
fl_LiteralExp = Class(name="fl_LiteralExp")
Exp = Class(name="Exp")
fl_ArgumentExp = Class(name="fl_ArgumentExp")
fl_IfThenElseExp = Class(name="fl_IfThenElseExp")
fl_PlusExp = Class(name="fl_PlusExp")
BinaryExp = Class(name="BinaryExp")
fl_MinusExp = Class(name="fl_MinusExp")
fl_EqualExp = Class(name="fl_EqualExp")
...
if_7: BinaryAssociation = BinaryAssociation(
    name="if_7",
    ends={
...
domain_model = DomainModel(
    name="fl",
    types={fl_ApplyExp, fl_BinaryExp, fl_Program, fl_Function, fl_Argument, fl_Exp, fl_LiteralExp, Exp, fl_ArgumentExp, fl_IfThenElseExp, fl_PlusExp, BinaryExp, fl_MinusExp, fl_EqualExp},
    associations={else_12, function15, argument17, left20, function0, argument1, definition3, argument5, if_7, then9, right22},
    generalizations={gen_fl_ApplyExp_Exp, gen_fl_BinaryExp_Exp, gen_fl_LiteralExp_Exp, gen_fl_ArgumentExp_Exp, gen_fl_IfThenElseExp_Exp, gen_fl_PlusExp_BinaryExp, gen_fl_MinusExp_BinaryExp, gen_fl_EqualExp_BinaryExp},
    metadata=None
)
