...
class Player:
    ...
    def __init__(self, board: Board, rand: Random, INITIAL_MONEY: int, INITIAL_POSITION: int, PASS_GO_MONEY: int, name: str, money: Money, position: int, property1: str, inJail: bool, isRetire: bool, isAI: bool, isBankrupt: bool, money1: "Money" = None, board3: "Board1" = None):
        self.board = board
        self.rand = rand
