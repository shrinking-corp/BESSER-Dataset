...
domain_model = DomainModel(
    name="_5beff25c_d129_4b11_899c_d3d8f6caf2d5",
    ...
    associations={Cache_RAM, ExtensionBoard_Card, Vendor1Adapter_Vendor1Sound, Machine_Memory, Processor_Memory, Program_Instruction, Machine_Processor, Processor_Program, Vendor2Adapter_Vendor2Sound, Machine_Card, AcceleratorCard_CPU},
    generalizations={},
    metadata=None
)
