...
# Classes
ktest301_AbstractComponent = Class(name="ktest301_AbstractComponent", is_abstract=True)
ktest301_Content = Class(name="ktest301_Content")
ktest301_Attributes = Class(name="ktest301_Attributes")
ktest301_Attribute = Class(name="ktest301_Attribute")
ktest301_Required = Class(name="ktest301_Required")
ktest301_Provided = Class(name="ktest301_Provided")
ktest301_Interface = Class(name="ktest301_Interface", is_abstract=True)
NamedElement = Class(name="NamedElement")
ktest301_Binding = Class(name="ktest301_Binding")
ktest301_NamedElement = Class(name="ktest301_NamedElement", is_abstract=True)
ktest301_Type = Class(name="ktest301_Type", is_abstract=True)
Interface = Class(name="Interface")
ktest301_Item = Class(name="ktest301_Item")
Type = Class(name="Type")
ktest301_Component = Class(name="ktest301_Component")
...
ktest301_Content_class_: Property = Property(name="class_", type=StringType)
ktest301_Content_language: Property = Property(name="language", type=StringType)
ktest301_Content.attributes={ktest301_Content_class_, ktest301_Content_language}
...
domain_model = DomainModel(
    name="ktest301",
    types={ktest301_AbstractComponent, ktest301_Content, ktest301_Attributes, ktest301_Attribute, ktest301_Required, ktest301_Provided, ktest301_Interface, NamedElement, ktest301_Binding, ktest301_NamedElement, ktest301_Type, Interface, ktest301_Item, Type, ktest301_Component, AbstractComponent},
    associations={content0, attributes1, from_8, to11, attributes14, requiredInterfaces3, providedInterfaces5, bindings7, items18, subComponents17},
    generalizations={gen_ktest301_Binding_NamedElement, gen_ktest301_Interface_NamedElement, gen_ktest301_Type_Interface, gen_ktest301_Item_NamedElement, gen_ktest301_Required_Type, gen_ktest301_Provided_Type, gen_ktest301_Component_AbstractComponent, gen_ktest301_Component_NamedElement},
    metadata=None
)
