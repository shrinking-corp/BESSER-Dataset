...
class umlState_StateRule:
    ...
    def __init__(self, name: str, umlState_StateRule: "umlState_SubmachineRule" = None, umlState_StateRule6: "umlState_ExitRule" = None, umlState_StateRule2: "umlState_EntryRule" = None, umlState_StateRule4: "umlState_DoRule" = None):
        self.name = name
