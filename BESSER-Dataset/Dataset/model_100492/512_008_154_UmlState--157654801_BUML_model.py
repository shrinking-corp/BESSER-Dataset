...
umlState_ExitRule.attributes={umlState_ExitRule_behaviorName, umlState_ExitRule_kind}
...
domain_model = DomainModel(
    name="umlState",
    types={umlState_StateRule, umlState_SubmachineRule, umlState_EntryRule, umlState_QualifiedName, umlState_StateMachine, umlState_Namespace, umlState_DoRule, umlState_ExitRule, BehaviorKind},
    associations={submachine0, path7, submachine9, path11, remaining14, entry1, do3, exit5},
    generalizations={},
    metadata=None
)
