...
opf_Package_prefix: Property = Property(name="prefix", type=StringType)
opf_Package_lang: Property = Property(name="lang", type=StringType)
opf_Package_dir: Property = Property(name="dir", type=StringType)
opf_Package_id: Property = Property(name="id", type=StringType)
opf_Package.attributes={opf_Package_id, opf_Package_dir, opf_Package_prefix, opf_Package_lang, opf_Package_version, opf_Package_generateCoverHTML, opf_Package_includeReferencedResources, opf_Package_generateTableOfContents, opf_Package_uniqueIdentifier}
...
opf_Meta_id: Property = Property(name="id", type=StringType)
opf_Meta_property: Property = Property(name="property", type=StringType)
opf_Meta_refines: Property = Property(name="refines", type=StringType)
opf_Meta_scheme: Property = Property(name="scheme", type=StringType)
opf_Meta_dir: Property = Property(name="dir", type=StringType)
opf_Meta.attributes={opf_Meta_content, opf_Meta_property, opf_Meta_id, opf_Meta_refines, opf_Meta_name, opf_Meta_dir, opf_Meta_scheme}
...
opf_Item_properties: Property = Property(name="properties", type=StringType)
opf_Item_media_overlay: Property = Property(name="media_overlay", type=StringType)
opf_Item.attributes={opf_Item_properties, opf_Item_file, opf_Item_href, opf_Item_fallback_style, opf_Item_title, opf_Item_id, opf_Item_media_overlay, opf_Item_noToc, opf_Item_generated, opf_Item_fallback, opf_Item_required_namespace, opf_Item_media_type, opf_Item_required_modules, opf_Item_sourcePath}
...
opf_Reference.attributes={opf_Reference_title, opf_Reference_href, opf_Reference_type}
...
domain_model = DomainModel(
    name="opf",
    types={opf_Package, opf_Metadata, opf_Manifest, opf_Spine, opf_Guide, opf_Tours, opf_Title, opf_Creator, opf_Contributor, opf_Subject, opf_Date, opf_Description, opf_Publisher, opf_Format, opf_Identifier, opf_Source, opf_Type, opf_Relation, opf_Coverage, opf_Language, opf_Meta, opf_Item, opf_Rights, opf_Itemref, opf_Reference, Role, Type},
    associations={metadata0, manifest1, spine3, guide5, tours7, creators11, titles9, contributors19, subjects13, dates21, descriptions15, publishers17, formats25, identifiers27, types23, languages31, relations33, coverages35, sources29, rights37, metas39, items41, spineItems43, guideItems45},
    generalizations={},
    metadata=None
)
