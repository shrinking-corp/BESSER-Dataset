...
def test_hyp_hexamle_4_rhs_x_is_not_abstract():
    assert not inspect.isabstract(hExamle_4_RHS_X)


def test_hyp_hexamle_4_rhs_x_constructor_exists():
    assert callable(hExamle_4_RHS_X.__init__)


def test_hyp_hexamle_4_rhs_x_constructor_args():
...
def test_hyp_hexamle_4_rhs_x_att1_setter(instance):
...
def test_hExamle_4_RHS_X_att1_value_roundtrip():
    instance = hExamle_4_RHS_X(att1="sample_text")
...
hExamle_4_RHS_X_strategy = st.builds(hExamle_4_RHS_X, att1=safe_text)
@given(instance=hExamle_4_RHS_X_strategy)
