...
class Entertainment:
    ...
    def __init__(self, DeviceID: int, homeTheatre29: set["HomeTheatre"] = None, tV25: set["TV"] = None, speakers27: set["Speakers"] = None):
...
class HouseHolds:
    ...
    def __init__(self, TimeID: str, Coffee: str, DishWasher: str, Alarm: str, WashingMachine: str, start_Of_Day8: "Start_Of_Day" = None, end_Of_Day10: "End_Of_Day" = None, system19: "System" = None):
        self.TimeID = TimeID
        self.Coffee = Coffee
...
class HomeTheatre:
    ...
    def __init__(self, HTID: str, entertainment28: "Entertainment" = None, tV4: "TV" = None, speakers6: "Speakers" = None, system20: "System" = None):
        self.HTID = HTID
...
class Sensor:
    ...
    def __init__(self, SensorID: int, SensorType: int, door0: "Door" = None, system16: "System" = None):
