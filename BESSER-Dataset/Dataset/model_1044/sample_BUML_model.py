...
# Classes
sample_State = Class(name="sample_State")
sample_FSM = Class(name="sample_FSM")
sample_Transition = Class(name="sample_Transition")
sample_Initstate = Class(name="sample_Initstate")
State = Class(name="State")
sample_Finalstate = Class(name="sample_Finalstate")
...
domain_model = DomainModel(
    name="sample",
    types={sample_State, sample_FSM, sample_Transition, sample_Initstate, State, sample_Finalstate},
    associations={state1, transition0, StateTo3, stateFrom6},
