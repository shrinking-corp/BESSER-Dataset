...
def test_hyp_trgarc_is_not_abstract():
    assert not inspect.isabstract(TrgArc)


def test_hyp_trgarc_constructor_exists():
    assert callable(TrgArc.__init__)


def test_hyp_trgarc_constructor_args():
    sig = inspect.signature(TrgArc.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jointpackage_grafcet2petrinet_trgplacetotransition_is_not_abstract():
    assert not inspect.isabstract(jointPackage_Grafcet2PetriNet_TrgPlaceToTransition)


def test_hyp_jointpackage_grafcet2petrinet_trgplacetotransition_constructor_exists():
    assert callable(jointPackage_Grafcet2PetriNet_TrgPlaceToTransition.__init__)


def test_hyp_jointpackage_grafcet2petrinet_trgplacetotransition_constructor_args():
    sig = inspect.signature(jointPackage_Grafcet2PetriNet_TrgPlaceToTransition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jointpackage_grafcet2petrinet_trgtransitiontoplace_is_not_abstract():
    assert not inspect.isabstract(jointPackage_Grafcet2PetriNet_TrgTransitionToPlace)


def test_hyp_jointpackage_grafcet2petrinet_trgtransitiontoplace_constructor_exists():
    assert callable(jointPackage_Grafcet2PetriNet_TrgTransitionToPlace.__init__)


def test_hyp_jointpackage_grafcet2petrinet_trgtransitiontoplace_constructor_args():
    sig = inspect.signature(jointPackage_Grafcet2PetriNet_TrgTransitionToPlace.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trgelement_is_not_abstract():
    assert not inspect.isabstract(TrgElement)


def test_hyp_trgelement_constructor_exists():
    assert callable(TrgElement.__init__)


def test_hyp_trgelement_constructor_args():
    sig = inspect.signature(TrgElement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jointpackage_grafcet2petrinet_trgtransition_is_not_abstract():
    assert not inspect.isabstract(jointPackage_Grafcet2PetriNet_TrgTransition)


def test_hyp_jointpackage_grafcet2petrinet_trgtransition_constructor_exists():
    assert callable(jointPackage_Grafcet2PetriNet_TrgTransition.__init__)


def test_hyp_jointpackage_grafcet2petrinet_trgtransition_constructor_args():
    sig = inspect.signature(jointPackage_Grafcet2PetriNet_TrgTransition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jointpackage_grafcet2petrinet_trgplace_is_not_abstract():
    assert not inspect.isabstract(jointPackage_Grafcet2PetriNet_TrgPlace)


def test_hyp_jointpackage_grafcet2petrinet_trgplace_constructor_exists():
    assert callable(jointPackage_Grafcet2PetriNet_TrgPlace.__init__)


def test_hyp_jointpackage_grafcet2petrinet_trgplace_constructor_args():
    sig = inspect.signature(jointPackage_Grafcet2PetriNet_TrgPlace.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trgnamedelement_is_not_abstract():
    assert not inspect.isabstract(TrgNamedElement)


def test_hyp_trgnamedelement_constructor_exists():
    assert callable(TrgNamedElement.__init__)


def test_hyp_trgnamedelement_constructor_args():
    sig = inspect.signature(TrgNamedElement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jointpackage_grafcet2petrinet_trgarc_is_not_abstract():
    assert not inspect.isabstract(jointPackage_Grafcet2PetriNet_TrgArc)


def test_hyp_jointpackage_grafcet2petrinet_trgarc_constructor_exists():
    assert callable(jointPackage_Grafcet2PetriNet_TrgArc.__init__)


def test_hyp_jointpackage_grafcet2petrinet_trgarc_constructor_args():
...
def test_hyp_jointpackage_grafcet2petrinet_trgelement_is_not_abstract():
    assert not inspect.isabstract(jointPackage_Grafcet2PetriNet_TrgElement)


def test_hyp_jointpackage_grafcet2petrinet_trgelement_constructor_exists():
    assert callable(jointPackage_Grafcet2PetriNet_TrgElement.__init__)


def test_hyp_jointpackage_grafcet2petrinet_trgelement_constructor_args():
...
def test_hyp_jointpackage_grafcet2petrinet_trgnamedelement_is_not_abstract():
    assert not inspect.isabstract(jointPackage_Grafcet2PetriNet_TrgNamedElement)


def test_hyp_jointpackage_grafcet2petrinet_trgnamedelement_constructor_exists():
    assert callable(jointPackage_Grafcet2PetriNet_TrgNamedElement.__init__)


def test_hyp_jointpackage_grafcet2petrinet_trgnamedelement_constructor_args():
...
def test_hyp_jointpackage_grafcet2petrinet_trglocatedelement_is_not_abstract():
    assert not inspect.isabstract(jointPackage_Grafcet2PetriNet_TrgLocatedElement)


def test_hyp_jointpackage_grafcet2petrinet_trglocatedelement_constructor_exists():
    assert callable(jointPackage_Grafcet2PetriNet_TrgLocatedElement.__init__)


def test_hyp_jointpackage_grafcet2petrinet_trglocatedelement_constructor_args():
...
def test_hyp_jointpackage_grafcet2petrinet_srcnamedelement_is_not_abstract():
    assert not inspect.isabstract(jointPackage_Grafcet2PetriNet_SrcNamedElement)


def test_hyp_jointpackage_grafcet2petrinet_srcnamedelement_constructor_exists():
    assert callable(jointPackage_Grafcet2PetriNet_SrcNamedElement.__init__)


def test_hyp_jointpackage_grafcet2petrinet_srcnamedelement_constructor_args():
...
def test_hyp_srcconnection_is_not_abstract():
    assert not inspect.isabstract(SrcConnection)


def test_hyp_srcconnection_constructor_exists():
    assert callable(SrcConnection.__init__)


def test_hyp_srcconnection_constructor_args():
    sig = inspect.signature(SrcConnection.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jointpackage_grafcet2petrinet_srcsteptotransition_is_not_abstract():
    assert not inspect.isabstract(jointPackage_Grafcet2PetriNet_SrcStepToTransition)


def test_hyp_jointpackage_grafcet2petrinet_srcsteptotransition_constructor_exists():
    assert callable(jointPackage_Grafcet2PetriNet_SrcStepToTransition.__init__)


def test_hyp_jointpackage_grafcet2petrinet_srcsteptotransition_constructor_args():
    sig = inspect.signature(jointPackage_Grafcet2PetriNet_SrcStepToTransition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jointpackage_grafcet2petrinet_srctransitiontostep_is_not_abstract():
    assert not inspect.isabstract(jointPackage_Grafcet2PetriNet_SrcTransitionToStep)


def test_hyp_jointpackage_grafcet2petrinet_srctransitiontostep_constructor_exists():
    assert callable(jointPackage_Grafcet2PetriNet_SrcTransitionToStep.__init__)


def test_hyp_jointpackage_grafcet2petrinet_srctransitiontostep_constructor_args():
...
def test_hyp_jointpackage_grafcet2petrinet_srctransition_is_not_abstract():
    assert not inspect.isabstract(jointPackage_Grafcet2PetriNet_SrcTransition)


def test_hyp_jointpackage_grafcet2petrinet_srctransition_constructor_exists():
    assert callable(jointPackage_Grafcet2PetriNet_SrcTransition.__init__)


def test_hyp_jointpackage_grafcet2petrinet_srctransition_constructor_args():
...
def test_hyp_jointpackage_grafcet2petrinet_srcstep_is_not_abstract():
    assert not inspect.isabstract(jointPackage_Grafcet2PetriNet_SrcStep)


def test_hyp_jointpackage_grafcet2petrinet_srcstep_constructor_exists():
    assert callable(jointPackage_Grafcet2PetriNet_SrcStep.__init__)


def test_hyp_jointpackage_grafcet2petrinet_srcstep_constructor_args():
...
def test_hyp_jointpackage_grafcet2petrinet_srcelement_is_not_abstract():
    assert not inspect.isabstract(jointPackage_Grafcet2PetriNet_SrcElement)


def test_hyp_jointpackage_grafcet2petrinet_srcelement_constructor_exists():
    assert callable(jointPackage_Grafcet2PetriNet_SrcElement.__init__)


def test_hyp_jointpackage_grafcet2petrinet_srcelement_constructor_args():
    sig = inspect.signature(jointPackage_Grafcet2PetriNet_SrcElement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jointpackage_grafcet2petrinet_srcconnection_is_not_abstract():
    assert not inspect.isabstract(jointPackage_Grafcet2PetriNet_SrcConnection)


def test_hyp_jointpackage_grafcet2petrinet_srcconnection_constructor_exists():
    assert callable(jointPackage_Grafcet2PetriNet_SrcConnection.__init__)


def test_hyp_jointpackage_grafcet2petrinet_srcconnection_constructor_args():
    sig = inspect.signature(jointPackage_Grafcet2PetriNet_SrcConnection.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jointpackage_grafcet2petrinet_srclocatedelement_is_not_abstract():
    assert not inspect.isabstract(jointPackage_Grafcet2PetriNet_SrcLocatedElement)


def test_hyp_jointpackage_grafcet2petrinet_srclocatedelement_constructor_exists():
    assert callable(jointPackage_Grafcet2PetriNet_SrcLocatedElement.__init__)


def test_hyp_jointpackage_grafcet2petrinet_srclocatedelement_constructor_args():
...
def test_hyp_jointpackage_grafcet2petrinet_trgpetrinet_is_not_abstract():
    assert not inspect.isabstract(jointPackage_Grafcet2PetriNet_TrgPetriNet)


def test_hyp_jointpackage_grafcet2petrinet_trgpetrinet_constructor_exists():
    assert callable(jointPackage_Grafcet2PetriNet_TrgPetriNet.__init__)


def test_hyp_jointpackage_grafcet2petrinet_trgpetrinet_constructor_args():
    sig = inspect.signature(jointPackage_Grafcet2PetriNet_TrgPetriNet.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jointpackage_grafcet2petrinet_srcgrafcet_is_not_abstract():
    assert not inspect.isabstract(jointPackage_Grafcet2PetriNet_SrcGrafcet)


def test_hyp_jointpackage_grafcet2petrinet_srcgrafcet_constructor_exists():
    assert callable(jointPackage_Grafcet2PetriNet_SrcGrafcet.__init__)


def test_hyp_jointpackage_grafcet2petrinet_srcgrafcet_constructor_args():
    sig = inspect.signature(jointPackage_Grafcet2PetriNet_SrcGrafcet.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jointpackage_grafcet2petrinet_jointmm_is_not_abstract():
    assert not inspect.isabstract(jointPackage_Grafcet2PetriNet_JointMM)


def test_hyp_jointpackage_grafcet2petrinet_jointmm_constructor_exists():
    assert callable(jointPackage_Grafcet2PetriNet_JointMM.__init__)


def test_hyp_jointpackage_grafcet2petrinet_jointmm_constructor_args():
...
def test_hyp_jointpackage_grafcet2petrinet_trgarc_weight_setter(instance):
...
def test_hyp_jointpackage_grafcet2petrinet_trgnamedelement_name_setter(instance):
...
def test_hyp_jointpackage_grafcet2petrinet_trglocatedelement_location_setter(instance):
...
def test_hyp_jointpackage_grafcet2petrinet_srcnamedelement_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_jointpackage_grafcet2petrinet_srctransition_condition_setter(instance):
...
def test_hyp_jointpackage_grafcet2petrinet_srcstep_action_setter(instance):
...
@given(instance=jointPackage_Grafcet2PetriNet_SrcStep_strategy)
def test_hyp_jointpackage_grafcet2petrinet_srcstep_isActive_setter(instance):
...
@given(instance=jointPackage_Grafcet2PetriNet_SrcStep_strategy)
def test_hyp_jointpackage_grafcet2petrinet_srcstep_isInitial_setter(instance):
...
def test_hyp_jointpackage_grafcet2petrinet_srclocatedelement_location_setter(instance):
    original = instance.location
    instance.location = original
    assert instance.location == original
