...
# Classes
jointPackage_Grafcet2PetriNet_JointMM = Class(name="jointPackage_Grafcet2PetriNet_JointMM")
jointPackage_Grafcet2PetriNet_SrcGrafcet = Class(name="jointPackage_Grafcet2PetriNet_SrcGrafcet")
jointPackage_Grafcet2PetriNet_TrgPetriNet = Class(name="jointPackage_Grafcet2PetriNet_TrgPetriNet")
jointPackage_Grafcet2PetriNet_SrcLocatedElement = Class(name="jointPackage_Grafcet2PetriNet_SrcLocatedElement", is_abstract=True)
SrcNamedElement = Class(name="SrcNamedElement")
jointPackage_Grafcet2PetriNet_SrcElement = Class(name="jointPackage_Grafcet2PetriNet_SrcElement", is_abstract=True)
jointPackage_Grafcet2PetriNet_SrcConnection = Class(name="jointPackage_Grafcet2PetriNet_SrcConnection", is_abstract=True)
jointPackage_Grafcet2PetriNet_SrcStep = Class(name="jointPackage_Grafcet2PetriNet_SrcStep")
SrcElement = Class(name="SrcElement")
jointPackage_Grafcet2PetriNet_SrcTransitionToStep = Class(name="jointPackage_Grafcet2PetriNet_SrcTransitionToStep")
jointPackage_Grafcet2PetriNet_SrcStepToTransition = Class(name="jointPackage_Grafcet2PetriNet_SrcStepToTransition")
jointPackage_Grafcet2PetriNet_SrcTransition = Class(name="jointPackage_Grafcet2PetriNet_SrcTransition")
SrcConnection = Class(name="SrcConnection")
jointPackage_Grafcet2PetriNet_SrcNamedElement = Class(name="jointPackage_Grafcet2PetriNet_SrcNamedElement", is_abstract=True)
SrcLocatedElement = Class(name="SrcLocatedElement")
jointPackage_Grafcet2PetriNet_TrgLocatedElement = Class(name="jointPackage_Grafcet2PetriNet_TrgLocatedElement", is_abstract=True)
jointPackage_Grafcet2PetriNet_TrgNamedElement = Class(name="jointPackage_Grafcet2PetriNet_TrgNamedElement", is_abstract=True)
TrgLocatedElement = Class(name="TrgLocatedElement")
TrgNamedElement = Class(name="TrgNamedElement")
jointPackage_Grafcet2PetriNet_TrgElement = Class(name="jointPackage_Grafcet2PetriNet_TrgElement", is_abstract=True)
jointPackage_Grafcet2PetriNet_TrgArc = Class(name="jointPackage_Grafcet2PetriNet_TrgArc", is_abstract=True)
jointPackage_Grafcet2PetriNet_TrgPlace = Class(name="jointPackage_Grafcet2PetriNet_TrgPlace")
TrgElement = Class(name="TrgElement")
jointPackage_Grafcet2PetriNet_TrgTransitionToPlace = Class(name="jointPackage_Grafcet2PetriNet_TrgTransitionToPlace")
jointPackage_Grafcet2PetriNet_TrgPlaceToTransition = Class(name="jointPackage_Grafcet2PetriNet_TrgPlaceToTransition")
jointPackage_Grafcet2PetriNet_TrgTransition = Class(name="jointPackage_Grafcet2PetriNet_TrgTransition")
...
jointPackage_Grafcet2PetriNet_SrcStep.attributes={jointPackage_Grafcet2PetriNet_SrcStep_isActive, jointPackage_Grafcet2PetriNet_SrcStep_isInitial, jointPackage_Grafcet2PetriNet_SrcStep_action}
...
outgoingConnections8: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_", type=jointPackage_Grafcet2PetriNet_SrcStepToTransition, multiplicity=Multiplicity(0, 9999))
    }
)
...
outgoingConnections12: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_13", type=jointPackage_Grafcet2PetriNet_SrcTransitionToStep, multiplicity=Multiplicity(0, 9999))
    }
)
...
outgoingArc32: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_33", type=jointPackage_Grafcet2PetriNet_TrgPlaceToTransition, multiplicity=Multiplicity(0, 9999))
    }
)
...
outgoingArc37: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_38", type=jointPackage_Grafcet2PetriNet_TrgTransitionToPlace, multiplicity=Multiplicity(1, 9999))
    }
)
...
from_42: BinaryAssociation = BinaryAssociation(
    name="from_42",
    ends={
...
from_44: BinaryAssociation = BinaryAssociation(
    name="from_44",
    ends={
...
from_19: BinaryAssociation = BinaryAssociation(
    name="from_19",
    ends={
...
domain_model = DomainModel(
    ...
    types={jointPackage_Grafcet2PetriNet_JointMM, jointPackage_Grafcet2PetriNet_SrcGrafcet, jointPackage_Grafcet2PetriNet_TrgPetriNet, jointPackage_Grafcet2PetriNet_SrcLocatedElement, SrcNamedElement, jointPackage_Grafcet2PetriNet_SrcElement, jointPackage_Grafcet2PetriNet_SrcConnection, jointPackage_Grafcet2PetriNet_SrcStep, SrcElement, jointPackage_Grafcet2PetriNet_SrcTransitionToStep, jointPackage_Grafcet2PetriNet_SrcStepToTransition, jointPackage_Grafcet2PetriNet_SrcTransition, SrcConnection, jointPackage_Grafcet2PetriNet_SrcNamedElement, SrcLocatedElement, jointPackage_Grafcet2PetriNet_TrgLocatedElement, jointPackage_Grafcet2PetriNet_TrgNamedElement, TrgLocatedElement, TrgNamedElement, jointPackage_Grafcet2PetriNet_TrgElement, jointPackage_Grafcet2PetriNet_TrgArc, jointPackage_Grafcet2PetriNet_TrgPlace, TrgElement, jointPackage_Grafcet2PetriNet_TrgTransitionToPlace, jointPackage_Grafcet2PetriNet_TrgPlaceToTransition, jointPackage_Grafcet2PetriNet_TrgTransition, TrgArc},
    associations={sourceRoot0, targetRoot1, elements3, connections4, grafcet6, incomingConnections7, outgoingConnections8, incomingConnections9, outgoingConnections12, grafcet15, from_17, to18, to22, elements25, arcs26, net28, incomingArc30, outgoingArc32, incomingArc34, outgoingArc37, net40, from_42, to43, from_44, from_19, to47},
    generalizations={gen_jointPackage_Grafcet2PetriNet_SrcGrafcet_SrcNamedElement, gen_jointPackage_Grafcet2PetriNet_SrcElement_SrcNamedElement, gen_jointPackage_Grafcet2PetriNet_SrcStep_SrcElement, gen_jointPackage_Grafcet2PetriNet_SrcTransition_SrcElement, gen_jointPackage_Grafcet2PetriNet_SrcConnection_SrcNamedElement, gen_jointPackage_Grafcet2PetriNet_SrcStepToTransition_SrcConnection, gen_jointPackage_Grafcet2PetriNet_SrcTransitionToStep_SrcConnection, gen_jointPackage_Grafcet2PetriNet_SrcNamedElement_SrcLocatedElement, gen_jointPackage_Grafcet2PetriNet_TrgNamedElement_TrgLocatedElement, gen_jointPackage_Grafcet2PetriNet_TrgPetriNet_TrgNamedElement, gen_jointPackage_Grafcet2PetriNet_TrgElement_TrgNamedElement, gen_jointPackage_Grafcet2PetriNet_TrgPlace_TrgElement, gen_jointPackage_Grafcet2PetriNet_TrgTransition_TrgElement, gen_jointPackage_Grafcet2PetriNet_TrgArc_TrgNamedElement, gen_jointPackage_Grafcet2PetriNet_TrgPlaceToTransition_TrgArc, gen_jointPackage_Grafcet2PetriNet_TrgTransitionToPlace_TrgArc},
    metadata=None
)
