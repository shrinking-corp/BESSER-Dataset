...
# Classes
ioautomaton_AutomatonContainer = Class(name="ioautomaton_AutomatonContainer")
...
domain_model = DomainModel(
    ...
    associations={_return20, automaton0, state1, transition3, initialstate5, outgoingtransition8, incomingtransition9, operation11, _return13, outmessage15, prestate17, poststate18, _object23, operation25},
    generalizations={},
    metadata=None
)
