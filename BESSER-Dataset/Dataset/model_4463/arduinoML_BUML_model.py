...
arduinoML_Signal = Class(name="arduinoML_Signal", is_abstract=True)
arduinoML_Condition = Class(name="arduinoML_Condition")
arduinoML_App = Class(name="arduinoML_App")
arduinoML_State = Class(name="arduinoML_State")
arduinoML_StringSignal = Class(name="arduinoML_StringSignal")
arduinoML_KeyboardSensor = Class(name="arduinoML_KeyboardSensor")
Sensor = Class(name="Sensor")
arduinoML_LCDScreenActuator = Class(name="arduinoML_LCDScreenActuator")
Actuator = Class(name="Actuator")
arduinoML_DigitalSignal = Class(name="arduinoML_DigitalSignal")
...
domain_model = DomainModel(
    name="arduinoML",
    types={arduinoML_Brick, NamedElement, arduinoML_Actuator, Brick, arduinoML_Sensor, arduinoML_NamedElement, arduinoML_Action, arduinoML_Transition, arduinoML_Signal, arduinoML_Condition, arduinoML_App, arduinoML_State, arduinoML_StringSignal, arduinoML_KeyboardSensor, Sensor, arduinoML_LCDScreenActuator, Actuator, arduinoML_DigitalSignal, Signal, DigitalSignalEnum, Operator},
    associations={actions6, transition8, actuator10, value12, next14, conditions17, sensor19, bricks0, states1, initial3, signal21},
    generalizations={gen_arduinoML_Brick_NamedElement, gen_arduinoML_Actuator_Brick, gen_arduinoML_Sensor_Brick, gen_arduinoML_State_NamedElement, gen_arduinoML_Condition_NamedElement, gen_arduinoML_StringSignal_Signal, gen_arduinoML_KeyboardSensor_Sensor, gen_arduinoML_LCDScreenActuator_Actuator, gen_arduinoML_DigitalSignal_Signal},
    metadata=None
)
