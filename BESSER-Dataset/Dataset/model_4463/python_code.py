...
class arduinoML_Condition(NamedElement):
    ...
    def __init__(self, operator: str, arduinoML_Condition: "arduinoML_Transition" = None, arduinoML_Condition20: "arduinoML_Sensor" = None, arduinoML_Condition22: "arduinoML_Signal" = None):
