...
public class ExtendedFamilies_Person  {
    ...
    private ExtendedFamilies_Person extendedfamilies_person;
    ...
    public ExtendedFamilies_Person(
        String firstName        ArrayList<ExtendedFamilies_Person> extendedfamilies_persons    ) {
        this.firstName = firstName;
    ...
    public ExtendedFamilies_Person getExtendedfamilies_person() {
        return extendedfamilies_person;
    }

    public void setExtendedfamilies_person(ExtendedFamilies_Person extendedfamilies_person) {
        this.extendedfamilies_person = extendedfamilies_person;
    }
