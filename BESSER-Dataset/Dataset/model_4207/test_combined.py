...
def test_hyp_mydsl_selecao_is_not_abstract():
    assert not inspect.isabstract(myDsl_Selecao)


def test_hyp_mydsl_selecao_constructor_exists():
    assert callable(myDsl_Selecao.__init__)


def test_hyp_mydsl_selecao_constructor_args():
...
def test_hyp_mydsl_expressao_is_not_abstract():
    assert not inspect.isabstract(myDsl_Expressao)


def test_hyp_mydsl_expressao_constructor_exists():
    assert callable(myDsl_Expressao.__init__)


def test_hyp_mydsl_expressao_constructor_args():
...
def test_hyp_mydsl_expressao_name_setter(instance):
