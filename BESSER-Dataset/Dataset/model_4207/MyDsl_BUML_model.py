...
myDsl_Expressao = Class(name="myDsl_Expressao")
Greeting = Class(name="Greeting")
myDsl_Selecao = Class(name="myDsl_Selecao")
...
domain_model = DomainModel(
    name="myDsl",
    types={myDsl_Model, myDsl_Greeting, myDsl_Expressao, Greeting, myDsl_Selecao, myDsl_Define},
