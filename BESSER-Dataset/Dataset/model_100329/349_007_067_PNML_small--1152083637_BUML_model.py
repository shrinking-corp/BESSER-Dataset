...
pnml_Element.attributes={pnml_Element_id, pnml_Element_location}
...
domain_model = DomainModel(
    name="pnml",
    types={pnml_PNMLDocument, pnml_NetElement, pnml_ArcPlace2Transition, pnml_PlaceElement, Element, pnml_TransitionElement, pnml_ArcTransition2Place, pnml_Element},
    associations={nets0, source1, target2, contents9, target4, source6},
    generalizations={gen_pnml_ArcPlace2Transition_Element, gen_pnml_PlaceElement_Element, gen_pnml_TransitionElement_Element, gen_pnml_ArcTransition2Place_Element, gen_pnml_NetElement_Element},
    metadata=None
)
