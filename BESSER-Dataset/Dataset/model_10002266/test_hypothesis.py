...
def test_generate_attendance_report_external_is_not_abstract():
    assert not inspect.isabstract(generate_attendance_report_external)


def test_generate_attendance_report_external_constructor_exists():
    assert callable(generate_attendance_report_external.__init__)


def test_generate_attendance_report_external_constructor_args():
