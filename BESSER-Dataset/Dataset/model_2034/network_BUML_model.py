...
network_RunTimeNetwork = Class(name="network_RunTimeNetwork")
network_CurrentStateMapState = Class(name="network_CurrentStateMapState")
network_ChannelBuffer = Class(name="network_ChannelBuffer")
...
domain_model = DomainModel(
    name="network",
    types={network_State, network_Transition, network_Network, AbstractElement, network_Statemachine, network_Channel, network_AbstractElement, network_RunTimeNetwork, network_CurrentStateMapState, network_ChannelBuffer, TypeOfChannel, Event},
    associations={channel1, state3, initState5, transition8, source10, target13, channel16, statemachine0, network19, currentstatemapstate21, channelbuffer23, state25, key28},
    generalizations={gen_network_Statemachine_AbstractElement, gen_network_State_AbstractElement, gen_network_Channel_AbstractElement, gen_network_Network_AbstractElement},
    metadata=None
)
