...
uml_StringExpression = Class(name="uml_StringExpression")
...
uml_PackageMerge = Class(name="uml_PackageMerge")
uml_PackageableElement = Class(name="uml_PackageableElement", is_abstract=True)
uml_ProfileApplication = Class(name="uml_ProfileApplication")
...
uml_Constraint = Class(name="uml_Constraint")
...
uml_GeneralizationSet = Class(name="uml_GeneralizationSet")
...
uml_TemplateableElement = Class(name="uml_TemplateableElement", is_abstract=True)
uml_TemplateBinding = Class(name="uml_TemplateBinding")
uml_TemplateSignature = Class(name="uml_TemplateSignature")
uml_TemplateParameterSubstitution = Class(name="uml_TemplateParameterSubstitution")
uml_TemplateParameter = Class(name="uml_TemplateParameter")
uml_Substitution = Class(name="uml_Substitution")
uml_CollaborationUse = Class(name="uml_CollaborationUse")
uml_UseCase = Class(name="uml_UseCase")
uml_RedefinableElement = Class(name="uml_RedefinableElement", is_abstract=True)
uml_ParameterableElement = Class(name="uml_ParameterableElement", is_abstract=True)
...
uml_OpaqueExpression = Class(name="uml_OpaqueExpression")
...
uml_ParameterSet = Class(name="uml_ParameterSet")
...
uml_DataType = Class(name="uml_DataType")
uml_MultiplicityElement = Class(name="uml_MultiplicityElement", is_abstract=True)
uml_ConnectableElement = Class(name="uml_ConnectableElement", is_abstract=True)
uml_ConnectorEnd = Class(name="uml_ConnectorEnd")
uml_DeployedArtifact = Class(name="uml_DeployedArtifact", is_abstract=True)
uml_DeploymentSpecification = Class(name="uml_DeploymentSpecification")
Artifact = Class(name="Artifact")
uml_Artifact = Class(name="uml_Artifact")
DeployedArtifact = Class(name="DeployedArtifact")
uml_DeploymentTarget = Class(name="uml_DeploymentTarget", is_abstract=True)
uml_Deployment = Class(name="uml_Deployment")
uml_BehavioralFeature = Class(name="uml_BehavioralFeature", is_abstract=True)
Feature = Class(name="Feature")
uml_Manifestation = Class(name="uml_Manifestation")
BehavioralFeature = Class(name="BehavioralFeature")
uml_Interface = Class(name="uml_Interface")
EncapsulatedClassifier = Class(name="EncapsulatedClassifier")
BehavioredClassifier = Class(name="BehavioredClassifier")
uml_Reception = Class(name="uml_Reception")
uml_Extension = Class(name="uml_Extension")
Class_ = Class(name="Class")
uml_BehavioredClassifier = Class(name="uml_BehavioredClassifier", is_abstract=True)
uml_ProtocolStateMachine = Class(name="uml_ProtocolStateMachine")
uml_Signal = Class(name="uml_Signal")
StateMachine = Class(name="StateMachine")
uml_ProtocolConformance = Class(name="uml_ProtocolConformance")
...
uml_InterfaceRealization = Class(name="uml_InterfaceRealization")
uml_Trigger = Class(name="uml_Trigger")
uml_Event = Class(name="uml_Event", is_abstract=True)
uml_Vertex = Class(name="uml_Vertex", is_abstract=True)
uml_Transition = Class(name="uml_Transition")
uml_ConnectionPointReference = Class(name="uml_ConnectionPointReference")
uml_Port = Class(name="uml_Port")
Property_ = Class(name="Property")
Vertex = Class(name="Vertex")
uml_EncapsulatedClassifier = Class(name="uml_EncapsulatedClassifier", is_abstract=True)
StructuredClassifier = Class(name="StructuredClassifier")
uml_StructuredClassifier = Class(name="uml_StructuredClassifier", is_abstract=True)
uml_Connector = Class(name="uml_Connector")
uml_Profile = Class(name="uml_Profile")
Package = Class(name="Package")
uml_Model = Class(name="uml_Model")
Association = Class(name="Association")
uml_ExtensionEnd = Class(name="uml_ExtensionEnd")
uml_Stereotype = Class(name="uml_Stereotype")
uml_Image = Class(name="uml_Image")
uml_Collaboration = Class(name="uml_Collaboration")
uml_Include = Class(name="uml_Include")
uml_Extend = Class(name="uml_Extend")
uml_ExtensionPoint = Class(name="uml_ExtensionPoint")
uml_OperationTemplateParameter = Class(name="uml_OperationTemplateParameter")
TemplateParameter = Class(name="TemplateParameter")
uml_StructuralFeature = Class(name="uml_StructuralFeature", is_abstract=True)
uml_ConnectableElementTemplateParameter = Class(name="uml_ConnectableElementTemplateParameter")
uml_ClassifierTemplateParameter = Class(name="uml_ClassifierTemplateParameter")
Expression = Class(name="Expression")
uml_Expression = Class(name="uml_Expression")
uml_Usage = Class(name="uml_Usage")
uml_RedefinableTemplateSignature = Class(name="uml_RedefinableTemplateSignature")
TemplateSignature = Class(name="TemplateSignature")
uml_Slot = Class(name="uml_Slot")
uml_Enumeration = Class(name="uml_Enumeration")
DataType = Class(name="DataType")
uml_EnumerationLiteral = Class(name="uml_EnumerationLiteral")
uml_LiteralInteger = Class(name="uml_LiteralInteger")
LiteralSpecification = Class(name="LiteralSpecification")
InstanceSpecification = Class(name="InstanceSpecification")
uml_InstanceSpecification = Class(name="uml_InstanceSpecification")
uml_LiteralString = Class(name="uml_LiteralString")
uml_LiteralBoolean = Class(name="uml_LiteralBoolean")
uml_PrimitiveType = Class(name="uml_PrimitiveType")
uml_LiteralSpecification = Class(name="uml_LiteralSpecification", is_abstract=True)
uml_FunctionBehavior = Class(name="uml_FunctionBehavior")
OpaqueBehavior = Class(name="OpaqueBehavior")
uml_OpaqueAction = Class(name="uml_OpaqueAction")
Action = Class(name="Action")
uml_InputPin = Class(name="uml_InputPin")
uml_OutputPin = Class(name="uml_OutputPin")
uml_Action = Class(name="uml_Action", is_abstract=True)
ExecutableNode = Class(name="ExecutableNode")
uml_ExecutableNode = Class(name="uml_ExecutableNode", is_abstract=True)
ActivityNode = Class(name="ActivityNode")
uml_ExceptionHandler = Class(name="uml_ExceptionHandler")
uml_ActivityNode = Class(name="uml_ActivityNode", is_abstract=True)
uml_StructuredActivityNode = Class(name="uml_StructuredActivityNode")
uml_Activity = Class(name="uml_Activity")
uml_LiteralNull = Class(name="uml_LiteralNull")
uml_InstanceValue = Class(name="uml_InstanceValue")
uml_LiteralUnlimitedNatural = Class(name="uml_LiteralUnlimitedNatural")
uml_OpaqueBehavior = Class(name="uml_OpaqueBehavior")
uml_ActivityGroup = Class(name="uml_ActivityGroup", is_abstract=True)
ActivityGroup = Class(name="ActivityGroup")
uml_Variable = Class(name="uml_Variable")
uml_ActivityEdge = Class(name="uml_ActivityEdge", is_abstract=True)
uml_ActivityPartition = Class(name="uml_ActivityPartition")
uml_InterruptibleActivityRegion = Class(name="uml_InterruptibleActivityRegion")
uml_ObjectNode = Class(name="uml_ObjectNode", is_abstract=True)
uml_ControlNode = Class(name="uml_ControlNode", is_abstract=True)
uml_ControlFlow = Class(name="uml_ControlFlow")
ActivityEdge = Class(name="ActivityEdge")
uml_InitialNode = Class(name="uml_InitialNode")
ControlNode = Class(name="ControlNode")
uml_ActivityParameterNode = Class(name="uml_ActivityParameterNode")
Pin = Class(name="Pin")
uml_Pin = Class(name="uml_Pin")
ObjectNode = Class(name="ObjectNode")
uml_CallAction = Class(name="uml_CallAction", is_abstract=True)
InvocationAction = Class(name="InvocationAction")
uml_InvocationAction = Class(name="uml_InvocationAction", is_abstract=True)
uml_SendSignalAction = Class(name="uml_SendSignalAction")
uml_CallOperationAction = Class(name="uml_CallOperationAction")
CallAction = Class(name="CallAction")
uml_CallBehaviorAction = Class(name="uml_CallBehaviorAction")
uml_SequenceNode = Class(name="uml_SequenceNode")
StructuredActivityNode = Class(name="StructuredActivityNode")
uml_Gate = Class(name="uml_Gate")
uml_ValuePin = Class(name="uml_ValuePin")
InputPin = Class(name="InputPin")
uml_Message = Class(name="uml_Message")
uml_MessageEnd = Class(name="uml_MessageEnd", is_abstract=True)
uml_Interaction = Class(name="uml_Interaction")
InteractionFragment = Class(name="InteractionFragment")
uml_Lifeline = Class(name="uml_Lifeline")
uml_InteractionFragment = Class(name="uml_InteractionFragment", is_abstract=True)
uml_GeneralOrdering = Class(name="uml_GeneralOrdering")
uml_InteractionOperand = Class(name="uml_InteractionOperand")
uml_PartDecomposition = Class(name="uml_PartDecomposition")
InteractionUse = Class(name="InteractionUse")
uml_InteractionUse = Class(name="uml_InteractionUse")
MessageEnd = Class(name="MessageEnd")
uml_OccurrenceSpecification = Class(name="uml_OccurrenceSpecification")
uml_MessageOccurrenceSpecification = Class(name="uml_MessageOccurrenceSpecification")
OccurrenceSpecification = Class(name="OccurrenceSpecification")
uml_InteractionConstraint = Class(name="uml_InteractionConstraint")
Constraint = Class(name="Constraint")
uml_ExecutionSpecification = Class(name="uml_ExecutionSpecification", is_abstract=True)
uml_StateInvariant = Class(name="uml_StateInvariant")
uml_ActionExecutionSpecification = Class(name="uml_ActionExecutionSpecification")
ExecutionSpecification = Class(name="ExecutionSpecification")
uml_BehaviorExecutionSpecification = Class(name="uml_BehaviorExecutionSpecification")
uml_ExecutionEvent = Class(name="uml_ExecutionEvent")
Event = Class(name="Event")
uml_CreationEvent = Class(name="uml_CreationEvent")
uml_DestructionEvent = Class(name="uml_DestructionEvent")
uml_SendOperationEvent = Class(name="uml_SendOperationEvent")
MessageEvent = Class(name="MessageEvent")
uml_MessageEvent = Class(name="uml_MessageEvent", is_abstract=True)
uml_SendSignalEvent = Class(name="uml_SendSignalEvent")
uml_ComponentRealization = Class(name="uml_ComponentRealization")
uml_Component = Class(name="uml_Component")
uml_ExecutionOccurrenceSpecification = Class(name="uml_ExecutionOccurrenceSpecification")
uml_ReceiveOperationEvent = Class(name="uml_ReceiveOperationEvent")
uml_ReceiveSignalEvent = Class(name="uml_ReceiveSignalEvent")
uml_Actor = Class(name="uml_Actor")
uml_CallEvent = Class(name="uml_CallEvent")
uml_ChangeEvent = Class(name="uml_ChangeEvent")
uml_SignalEvent = Class(name="uml_SignalEvent")
uml_AnyReceiveEvent = Class(name="uml_AnyReceiveEvent")
uml_ForkNode = Class(name="uml_ForkNode")
uml_FlowFinalNode = Class(name="uml_FlowFinalNode")
FinalNode = Class(name="FinalNode")
uml_FinalNode = Class(name="uml_FinalNode", is_abstract=True)
uml_CentralBufferNode = Class(name="uml_CentralBufferNode")
uml_MergeNode = Class(name="uml_MergeNode")
uml_DecisionNode = Class(name="uml_DecisionNode")
uml_ObjectFlow = Class(name="uml_ObjectFlow")
uml_ActivityFinalNode = Class(name="uml_ActivityFinalNode")
uml_Continuation = Class(name="uml_Continuation")
uml_ConsiderIgnoreFragment = Class(name="uml_ConsiderIgnoreFragment")
CombinedFragment = Class(name="CombinedFragment")
uml_Node = Class(name="uml_Node")
uml_CommunicationPath = Class(name="uml_CommunicationPath")
uml_Device = Class(name="uml_Device")
Node = Class(name="Node")
uml_ExecutionEnvironment = Class(name="uml_ExecutionEnvironment")
uml_CombinedFragment = Class(name="uml_CombinedFragment")
uml_RemoveStructuralFeatureValueAction = Class(name="uml_RemoveStructuralFeatureValueAction")
WriteStructuralFeatureAction = Class(name="WriteStructuralFeatureAction")
uml_CreateObjectAction = Class(name="uml_CreateObjectAction")
uml_DestroyObjectAction = Class(name="uml_DestroyObjectAction")
uml_TestIdentityAction = Class(name="uml_TestIdentityAction")
uml_ReadSelfAction = Class(name="uml_ReadSelfAction")
uml_StructuralFeatureAction = Class(name="uml_StructuralFeatureAction", is_abstract=True)
uml_ReadStructuralFeatureAction = Class(name="uml_ReadStructuralFeatureAction")
StructuralFeatureAction = Class(name="StructuralFeatureAction")
uml_WriteStructuralFeatureAction = Class(name="uml_WriteStructuralFeatureAction", is_abstract=True)
uml_ClearStructuralFeatureAction = Class(name="uml_ClearStructuralFeatureAction")
uml_AddStructuralFeatureValueAction = Class(name="uml_AddStructuralFeatureValueAction")
uml_LinkAction = Class(name="uml_LinkAction", is_abstract=True)
uml_LinkEndData = Class(name="uml_LinkEndData")
uml_QualifierValue = Class(name="uml_QualifierValue")
uml_ReadLinkAction = Class(name="uml_ReadLinkAction")
LinkAction = Class(name="LinkAction")
uml_LinkEndCreationData = Class(name="uml_LinkEndCreationData")
LinkEndData = Class(name="LinkEndData")
uml_CreateLinkAction = Class(name="uml_CreateLinkAction")
WriteLinkAction = Class(name="WriteLinkAction")
uml_WriteLinkAction = Class(name="uml_WriteLinkAction", is_abstract=True)
uml_DestroyLinkAction = Class(name="uml_DestroyLinkAction")
uml_LinkEndDestructionData = Class(name="uml_LinkEndDestructionData")
uml_ClearAssociationAction = Class(name="uml_ClearAssociationAction")
uml_BroadcastSignalAction = Class(name="uml_BroadcastSignalAction")
uml_SendObjectAction = Class(name="uml_SendObjectAction")
uml_ValueSpecificationAction = Class(name="uml_ValueSpecificationAction")
uml_TimeExpression = Class(name="uml_TimeExpression")
uml_Observation = Class(name="uml_Observation", is_abstract=True)
uml_Duration = Class(name="uml_Duration")
uml_DurationInterval = Class(name="uml_DurationInterval")
Interval = Class(name="Interval")
uml_Interval = Class(name="uml_Interval")
uml_TimeConstraint = Class(name="uml_TimeConstraint")
IntervalConstraint = Class(name="IntervalConstraint")
uml_IntervalConstraint = Class(name="uml_IntervalConstraint")
uml_TimeInterval = Class(name="uml_TimeInterval")
uml_DurationConstraint = Class(name="uml_DurationConstraint")
uml_TimeObservation = Class(name="uml_TimeObservation")
Observation = Class(name="Observation")
uml_DurationObservation = Class(name="uml_DurationObservation")
uml_FinalState = Class(name="uml_FinalState")
State = Class(name="State")
uml_TimeEvent = Class(name="uml_TimeEvent")
uml_VariableAction = Class(name="uml_VariableAction", is_abstract=True)
uml_ReadVariableAction = Class(name="uml_ReadVariableAction")
VariableAction = Class(name="VariableAction")
uml_WriteVariableAction = Class(name="uml_WriteVariableAction", is_abstract=True)
uml_ClearVariableAction = Class(name="uml_ClearVariableAction")
uml_AddVariableValueAction = Class(name="uml_AddVariableValueAction")
WriteVariableAction = Class(name="WriteVariableAction")
uml_RaiseExceptionAction = Class(name="uml_RaiseExceptionAction")
uml_ActionInputPin = Class(name="uml_ActionInputPin")
uml_InformationItem = Class(name="uml_InformationItem")
uml_InformationFlow = Class(name="uml_InformationFlow")
uml_ReadExtentAction = Class(name="uml_ReadExtentAction")
uml_RemoveVariableValueAction = Class(name="uml_RemoveVariableValueAction")
uml_ReadLinkObjectEndAction = Class(name="uml_ReadLinkObjectEndAction")
uml_ReclassifyObjectAction = Class(name="uml_ReclassifyObjectAction")
uml_ReadIsClassifiedObjectAction = Class(name="uml_ReadIsClassifiedObjectAction")
uml_StartClassifierBehaviorAction = Class(name="uml_StartClassifierBehaviorAction")
uml_ReadLinkObjectEndQualifierAction = Class(name="uml_ReadLinkObjectEndQualifierAction")
uml_CreateLinkObjectAction = Class(name="uml_CreateLinkObjectAction")
CreateLinkAction = Class(name="CreateLinkAction")
uml_AcceptEventAction = Class(name="uml_AcceptEventAction")
uml_AcceptCallAction = Class(name="uml_AcceptCallAction")
AcceptEventAction = Class(name="AcceptEventAction")
uml_ReplyAction = Class(name="uml_ReplyAction")
uml_UnmarshallAction = Class(name="uml_UnmarshallAction")
uml_ReduceAction = Class(name="uml_ReduceAction")
uml_StartObjectBehaviorAction = Class(name="uml_StartObjectBehaviorAction")
uml_JoinNode = Class(name="uml_JoinNode")
uml_DataStoreNode = Class(name="uml_DataStoreNode")
CentralBufferNode = Class(name="CentralBufferNode")
uml_ConditionalNode = Class(name="uml_ConditionalNode")
uml_Clause = Class(name="uml_Clause")
uml_LoopNode = Class(name="uml_LoopNode")
uml_ExpansionNode = Class(name="uml_ExpansionNode")
uml_ExpansionRegion = Class(name="uml_ExpansionRegion")
uml_ProtocolTransition = Class(name="uml_ProtocolTransition")
Transition = Class(name="Transition")
uml_AssociationClass = Class(name="uml_AssociationClass")
...
uml_Property.attributes={uml_Property_isComposite, uml_Property_aggregation, uml_Property_isDerived, uml_Property_isDerivedUnion, uml_Property_default}
...
uml_OpaqueExpression.attributes={uml_OpaqueExpression_language, uml_OpaqueExpression_body}
...
uml_Parameter.attributes={uml_Parameter_isException, uml_Parameter_effect, uml_Parameter_isStream, uml_Parameter_direction, uml_Parameter_default}
...
uml_Operation.attributes={uml_Operation_isUnique, uml_Operation_upper, uml_Operation_lower, uml_Operation_isOrdered, uml_Operation_isQuery}
...
uml_MultiplicityElement.attributes={uml_MultiplicityElement_upper, uml_MultiplicityElement_isOrdered, uml_MultiplicityElement_isUnique, uml_MultiplicityElement_lower}
...
uml_DeploymentSpecification.attributes={uml_DeploymentSpecification_executionLocation, uml_DeploymentSpecification_deploymentLocation}
...
uml_BehavioralFeature.attributes={uml_BehavioralFeature_concurrency, uml_BehavioralFeature_isAbstract}
...
uml_State.attributes={uml_State_isComposite, uml_State_isOrthogonal, uml_State_isSimple, uml_State_isSubmachineState}
...
uml_Image.attributes={uml_Image_location, uml_Image_content, uml_Image_format}
...
uml_OpaqueAction.attributes={uml_OpaqueAction_body, uml_OpaqueAction_language}
...
uml_Activity.attributes={uml_Activity_isSingleExecution, uml_Activity_isReadOnly}
...
uml_ActivityPartition.attributes={uml_ActivityPartition_isDimension, uml_ActivityPartition_isExternal}
...
uml_ObjectNode.attributes={uml_ObjectNode_ordering, uml_ObjectNode_isControlType}
...
uml_DestroyObjectAction.attributes={uml_DestroyObjectAction_isDestroyLinks, uml_DestroyObjectAction_isDestroyOwnedObjects}
...
domain_model = DomainModel(
    name="uml",
    types={uml_Element, EModelElement, uml_Comment, Element, uml_StringExpression, DirectedRelationship, uml_DirectedRelationship, Relationship, uml_Package, Namespace, PackageableElement, TemplateableElement, uml_Type, uml_PackageMerge, uml_PackageableElement, uml_ProfileApplication, NamedElement, ParameterableElement, uml_NamedElement, uml_Dependency, uml_Namespace, uml_Relationship, uml_ElementImport, uml_PackageImport, uml_Constraint, uml_Classifier, RedefinableElement, Type, uml_Generalization, uml_GeneralizationSet, uml_Feature, uml_ValueSpecification, TypedElement, uml_TypedElement, uml_Association, Classifier, uml_Property, uml_TemplateableElement, uml_TemplateBinding, uml_TemplateSignature, uml_TemplateParameterSubstitution, uml_TemplateParameter, uml_Substitution, uml_CollaborationUse, uml_UseCase, uml_RedefinableElement, uml_ParameterableElement, uml_Realization, Abstraction, uml_Abstraction, Dependency, uml_OpaqueExpression, ValueSpecification, uml_Parameter, uml_Behavior, ConnectableElement, MultiplicityElement, uml_ParameterSet, uml_Operation, Realization, StructuralFeature, DeploymentTarget, uml_Class, uml_DataType, uml_MultiplicityElement, uml_ConnectableElement, uml_ConnectorEnd, uml_DeployedArtifact, uml_DeploymentSpecification, Artifact, uml_Artifact, DeployedArtifact, uml_DeploymentTarget, uml_Deployment, uml_BehavioralFeature, Feature, uml_Manifestation, BehavioralFeature, uml_Interface, EncapsulatedClassifier, BehavioredClassifier, uml_Reception, uml_Extension, Class_, uml_BehavioredClassifier, uml_ProtocolStateMachine, uml_Signal, StateMachine, uml_ProtocolConformance, uml_StateMachine, Behavior, uml_Region, uml_State, uml_Pseudostate, uml_InterfaceRealization, uml_Trigger, uml_Event, uml_Vertex, uml_Transition, uml_ConnectionPointReference, uml_Port, Property_, Vertex, uml_EncapsulatedClassifier, StructuredClassifier, uml_StructuredClassifier, uml_Connector, uml_Profile, Package, uml_Model, Association, uml_ExtensionEnd, uml_Stereotype, uml_Image, uml_Collaboration, uml_Include, uml_Extend, uml_ExtensionPoint, uml_OperationTemplateParameter, TemplateParameter, uml_StructuralFeature, uml_ConnectableElementTemplateParameter, uml_ClassifierTemplateParameter, Expression, uml_Expression, uml_Usage, uml_RedefinableTemplateSignature, TemplateSignature, uml_Slot, uml_Enumeration, DataType, uml_EnumerationLiteral, uml_LiteralInteger, LiteralSpecification, InstanceSpecification, uml_InstanceSpecification, uml_LiteralString, uml_LiteralBoolean, uml_PrimitiveType, uml_LiteralSpecification, uml_FunctionBehavior, OpaqueBehavior, uml_OpaqueAction, Action, uml_InputPin, uml_OutputPin, uml_Action, ExecutableNode, uml_ExecutableNode, ActivityNode, uml_ExceptionHandler, uml_ActivityNode, uml_StructuredActivityNode, uml_Activity, uml_LiteralNull, uml_InstanceValue, uml_LiteralUnlimitedNatural, uml_OpaqueBehavior, uml_ActivityGroup, ActivityGroup, uml_Variable, uml_ActivityEdge, uml_ActivityPartition, uml_InterruptibleActivityRegion, uml_ObjectNode, uml_ControlNode, uml_ControlFlow, ActivityEdge, uml_InitialNode, ControlNode, uml_ActivityParameterNode, Pin, uml_Pin, ObjectNode, uml_CallAction, InvocationAction, uml_InvocationAction, uml_SendSignalAction, uml_CallOperationAction, CallAction, uml_CallBehaviorAction, uml_SequenceNode, StructuredActivityNode, uml_Gate, uml_ValuePin, InputPin, uml_Message, uml_MessageEnd, uml_Interaction, InteractionFragment, uml_Lifeline, uml_InteractionFragment, uml_GeneralOrdering, uml_InteractionOperand, uml_PartDecomposition, InteractionUse, uml_InteractionUse, MessageEnd, uml_OccurrenceSpecification, uml_MessageOccurrenceSpecification, OccurrenceSpecification, uml_InteractionConstraint, Constraint, uml_ExecutionSpecification, uml_StateInvariant, uml_ActionExecutionSpecification, ExecutionSpecification, uml_BehaviorExecutionSpecification, uml_ExecutionEvent, Event, uml_CreationEvent, uml_DestructionEvent, uml_SendOperationEvent, MessageEvent, uml_MessageEvent, uml_SendSignalEvent, uml_ComponentRealization, uml_Component, uml_ExecutionOccurrenceSpecification, uml_ReceiveOperationEvent, uml_ReceiveSignalEvent, uml_Actor, uml_CallEvent, uml_ChangeEvent, uml_SignalEvent, uml_AnyReceiveEvent, uml_ForkNode, uml_FlowFinalNode, FinalNode, uml_FinalNode, uml_CentralBufferNode, uml_MergeNode, uml_DecisionNode, uml_ObjectFlow, uml_ActivityFinalNode, uml_Continuation, uml_ConsiderIgnoreFragment, CombinedFragment, uml_Node, uml_CommunicationPath, uml_Device, Node, uml_ExecutionEnvironment, uml_CombinedFragment, uml_RemoveStructuralFeatureValueAction, WriteStructuralFeatureAction, uml_CreateObjectAction, uml_DestroyObjectAction, uml_TestIdentityAction, uml_ReadSelfAction, uml_StructuralFeatureAction, uml_ReadStructuralFeatureAction, StructuralFeatureAction, uml_WriteStructuralFeatureAction, uml_ClearStructuralFeatureAction, uml_AddStructuralFeatureValueAction, uml_LinkAction, uml_LinkEndData, uml_QualifierValue, uml_ReadLinkAction, LinkAction, uml_LinkEndCreationData, LinkEndData, uml_CreateLinkAction, WriteLinkAction, uml_WriteLinkAction, uml_DestroyLinkAction, uml_LinkEndDestructionData, uml_ClearAssociationAction, uml_BroadcastSignalAction, uml_SendObjectAction, uml_ValueSpecificationAction, uml_TimeExpression, uml_Observation, uml_Duration, uml_DurationInterval, Interval, uml_Interval, uml_TimeConstraint, IntervalConstraint, uml_IntervalConstraint, uml_TimeInterval, uml_DurationConstraint, uml_TimeObservation, Observation, uml_DurationObservation, uml_FinalState, State, uml_TimeEvent, uml_VariableAction, uml_ReadVariableAction, VariableAction, uml_WriteVariableAction, uml_ClearVariableAction, uml_AddVariableValueAction, WriteVariableAction, uml_RaiseExceptionAction, uml_ActionInputPin, uml_InformationItem, uml_InformationFlow, uml_ReadExtentAction, uml_RemoveVariableValueAction, uml_ReadLinkObjectEndAction, uml_ReclassifyObjectAction, uml_ReadIsClassifiedObjectAction, uml_StartClassifierBehaviorAction, uml_ReadLinkObjectEndQualifierAction, uml_CreateLinkObjectAction, CreateLinkAction, uml_AcceptEventAction, uml_AcceptCallAction, AcceptEventAction, uml_ReplyAction, uml_UnmarshallAction, uml_ReduceAction, uml_StartObjectBehaviorAction, uml_JoinNode, uml_DataStoreNode, CentralBufferNode, uml_ConditionalNode, uml_Clause, uml_LoopNode, uml_ExpansionNode, uml_ExpansionRegion, uml_ProtocolTransition, Transition, uml_AssociationClass, VisibilityKind, TransitionKind, PseudostateKind, ConnectorKind, CallConcurrencyKind, AggregationKind, ParameterDirectionKind, ParameterEffectKind, ObjectNodeOrderingKind, MessageKind, MessageSort, InteractionOperatorKind, ExpansionKind},
    associations={annotatedElement0, ownedElement2, owner4, ownedComment6, nameExpression20, supplier21, client23, source24, target26, ownedType9, packageMerge10, packagedElement11, nestedPackage13, nestingPackage15, profileApplication17, clientDependency18, namespace19, importedMember37, ownedMember40, importedElement42, relatedElement29, elementImport31, packageImport32, ownedRule34, member35, endType62, navigableOwnedEnd64, generalization66, powertypeExtent67, feature68, importingNamespace44, importedPackage46, importingNamespace48, constrainedElement50, specification52, context54, type56, package57, ownedEnd59, memberEnd60, templateBinding94, ownedTemplateSignature95, signature96, parameterSubstitution97, boundElement98, parameter100, inheritedMember69, redefinedClassifier72, general75, substitution77, attribute78, representation81, collaborationUse83, ownedUseCase86, useCase88, redefinedElement90, redefinitionContext91, general129, generalizationSet131, specific133, powertype135, generalization137, ownedParameter102, template103, signature105, parameteredElement107, ownedParameteredElement108, default110, ownedDefault112, owningTemplateParameter115, templateParameter117, formal119, actual121, ownedActual124, templateBinding127, mapping145, result146, behavior148, parameterSet150, operation151, featuringClassifier139, contract141, substitutingClassifier143, definingEnd162, role165, partWithPort168, class_171, datatype173, defaultValue153, upperValue156, lowerValue158, end161, deployedElement196, deployedArtifact198, configuration199, location200, deployment202, redefinedProperty175, owningAssociation177, defaultValue178, opposite182, subsettedProperty185, association187, qualifier190, associationEnd193, deployment195, precondition220, postcondition223, redefinedOperation227, datatype229, bodyCondition232, type235, ownedParameter238, method240, nestedArtifact205, manifestation206, ownedOperation208, ownedAttribute211, utilizedElement214, interface217, class_218, specification263, nestedClassifier264, ownedOperation267, superClass269, ownedReception271, extension273, ownedBehavior274, raisedException241, ownedParameterSet244, redefinedBehavior247, ownedParameter249, context252, precondition254, postcondition257, ownedParameterSet260, protocol299, signal301, ownedAttribute303, conformance306, region307, submachineState308, connectionPoint309, classifierBehavior277, interfaceRealization280, ownedTrigger281, contract283, implementingClassifier284, ownedAttribute285, ownedOperation288, nestedClassifier290, redefinedInterface294, ownedReception296, container328, source330, target333, redefinedTransition337, guard339, effect342, trigger345, event348, extendedStateMachine312, subvertex313, transition314, state316, extendedRegion319, stateMachine320, outgoing322, incoming323, container326, submachine364, connection366, connectionPoint367, redefinedState371, stateInvariant372, entry375, exit378, doActivity381, port350, required352, redefinedPort356, provided358, protocol361, generalMachine401, specificMachine403, ownedPort404, ownedAttribute406, part408, role411, deferrableTrigger384, region387, entry390, exit391, state394, stateMachine396, state398, ownedStereotype431, metaclassReference433, metamodelReference436, parameter439, condition440, ownedConnector414, type416, redefinedConnector420, end422, contract425, metaclass428, icon430, type448, roleBinding450, collaborationRole453, include456, extend457, extensionPoint459, subject460, addition463, includingCase465, ownedAttribute443, extendedCase467, ownedOperation445, condition469, extendedSignature479, inheritedParameter480, classifier483, constrainingClassifier486, subExpression489, owningExpression491, operand493, mergedPackage495, receivingPackage497, appliedProfile499, extensionLocation472, extension474, useCase476, classifier505, slot507, specification508, applyingPackage501, ownedLiteral503, enumeration504, definingFeature511, value512, owningInstance515, inputValue518, outputValue519, output521, input523, context526, localPrecondition529, localPostcondition532, handler535, inStructuredNode536, activity537, instance516, inGroup546, redefinedNode548, variable549, edge550, node552, subgroup555, outgoing539, superGroup558, incoming540, inActivity560, inPartition542, containedEdge562, inInterruptibleRegion544, interrupts598, inStructuredNode600, structuredNode567, variable568, node570, edge572, partition575, group577, scope579, activityScope581, source584, target586, redefinedEdge589, inPartition590, guard592, weight595, containedNode564, upperBound633, inGroup603, activity605, node608, subpartition611, superPartition614, represents616, edge619, node622, interruptingEdge624, handlerBody626, exceptionInput627, exceptionType629, protectedNode632, inState636, selection639, result642, argument644, onPort646, target649, signal651, operation654, target656, behavior659, executableNode661, action686, parameter663, value665, receiveEvent667, sendEvent668, connector671, interaction674, argument675, signature678, message681, lifeline684, fragment685, after719, toBefore721, formalGate688, message690, covered692, generalOrdering694, enclosingInteraction695, enclosingOperand697, represents699, interaction701, selector703, decomposedAs706, coveredBy708, refersTo710, actualGate712, argument715, before718, signal748, event722, toAfter724, guard726, fragment727, minint729, maxint732, start735, finish737, invariant740, action742, behavior744, operation746, abstraction772, execution750, operation752, signal754, operation756, changeExpression758, signal760, decisionInput762, decisionInputFlow764, transformation766, selection769, realizingClassifier773, required775, provided777, packagedElement780, realization783, nestedNode785, operand786, cfragmentGate788, result822, message791, classifier793, result795, target798, first800, second802, result805, result808, structuralFeature810, object812, result815, value817, result819, removeAt824, insertAt826, endData828, inputValue829, value832, end835, qualifier838, qualifier840, value843, result846, insertAt848, destroyAt850, object852, association854, signal857, target859, request861, value864, result866, expr869, observation871, expr873, observation875, max880, event883, event885, when887, variable889, result890, value892, insertAt894, min878, removeAt896, exception898, fromAction900, represented902, realization904, conveyed906, informationSource909, informationTarget912, realizingActivityEdge915, realizingConnector918, realizingMessage921, result924, object945, classifier926, oldClassifier929, newClassifier931, object934, classifier937, result939, object942, object947, end949, result952, object955, result957, qualifier960, result963, result965, trigger967, returnInformation970, replyToCall972, returnInformation974, replyValue977, result980, unmarshallType982, object985, reducer988, result990, collection993, joinSpec998, clause1000, result1001, test1004, body1007, predecessorClause1011, successorClause1013, decider1015, bodyOutput1018, object996, referred1052, setupPart1023, decider1026, test1029, result1032, loopVariable1035, bodyOutput1038, loopVariableInput1041, regionAsOutput1044, regionAsInput1045, inputElement1047, outputElement1048, postCondition1050, bodyPart1021, preCondition1055},
    generalizations={gen_uml_Element_EModelElement, gen_uml_Comment_Element, gen_uml_Dependency_PackageableElement, gen_uml_Dependency_DirectedRelationship, gen_uml_DirectedRelationship_Relationship, gen_uml_Package_Namespace, gen_uml_Package_PackageableElement, gen_uml_Package_TemplateableElement, gen_uml_PackageableElement_NamedElement, gen_uml_PackageableElement_ParameterableElement, gen_uml_NamedElement_Element, gen_uml_ElementImport_DirectedRelationship, gen_uml_Relationship_Element, gen_uml_Namespace_NamedElement, gen_uml_Classifier_Namespace, gen_uml_Classifier_RedefinableElement, gen_uml_Classifier_Type, gen_uml_Classifier_TemplateableElement, gen_uml_PackageImport_DirectedRelationship, gen_uml_Constraint_PackageableElement, gen_uml_ValueSpecification_PackageableElement, gen_uml_ValueSpecification_TypedElement, gen_uml_TypedElement_NamedElement, gen_uml_Type_PackageableElement, gen_uml_Association_Classifier, gen_uml_Association_Relationship, gen_uml_TemplateableElement_Element, gen_uml_TemplateBinding_DirectedRelationship, gen_uml_TemplateSignature_Element, gen_uml_RedefinableElement_NamedElement, gen_uml_GeneralizationSet_PackageableElement, gen_uml_Feature_RedefinableElement, gen_uml_TemplateParameter_Element, gen_uml_ParameterableElement_Element, gen_uml_TemplateParameterSubstitution_Element, gen_uml_Generalization_DirectedRelationship, gen_uml_Realization_Abstraction, gen_uml_Abstraction_Dependency, gen_uml_OpaqueExpression_ValueSpecification, gen_uml_Parameter_ConnectableElement, gen_uml_Parameter_MultiplicityElement, gen_uml_Substitution_Realization, gen_uml_ConnectorEnd_MultiplicityElement, gen_uml_Property_StructuralFeature, gen_uml_Property_ConnectableElement, gen_uml_Property_DeploymentTarget, gen_uml_MultiplicityElement_Element, gen_uml_ConnectableElement_TypedElement, gen_uml_ConnectableElement_ParameterableElement, gen_uml_Deployment_Dependency, gen_uml_DeployedArtifact_NamedElement, gen_uml_DeploymentSpecification_Artifact, gen_uml_Artifact_Classifier, gen_uml_Artifact_DeployedArtifact, gen_uml_DeploymentTarget_NamedElement, gen_uml_BehavioralFeature_Namespace, gen_uml_BehavioralFeature_Feature, gen_uml_Manifestation_Abstraction, gen_uml_Operation_BehavioralFeature, gen_uml_Operation_ParameterableElement, gen_uml_Operation_TemplateableElement, gen_uml_Class_EncapsulatedClassifier, gen_uml_Class_BehavioredClassifier, gen_uml_BehavioredClassifier_Classifier, gen_uml_Behavior_Class, gen_uml_Reception_BehavioralFeature, gen_uml_Signal_Classifier, gen_uml_ProtocolStateMachine_StateMachine, gen_uml_StateMachine_Behavior, gen_uml_InterfaceRealization_Realization, gen_uml_Interface_Classifier, gen_uml_Trigger_NamedElement, gen_uml_Region_Namespace, gen_uml_Region_RedefinableElement, gen_uml_Vertex_NamedElement, gen_uml_Transition_Namespace, gen_uml_Transition_RedefinableElement, gen_uml_Event_PackageableElement, gen_uml_Port_Property, gen_uml_State_Namespace, gen_uml_State_RedefinableElement, gen_uml_State_Vertex, gen_uml_ProtocolConformance_DirectedRelationship, gen_uml_EncapsulatedClassifier_StructuredClassifier, gen_uml_StructuredClassifier_Classifier, gen_uml_ConnectionPointReference_Vertex, gen_uml_Pseudostate_Vertex, gen_uml_Image_Element, gen_uml_Profile_Package, gen_uml_Model_Package, gen_uml_ParameterSet_NamedElement, gen_uml_Connector_Feature, gen_uml_Extension_Association, gen_uml_ExtensionEnd_Property, gen_uml_Stereotype_Class, gen_uml_CollaborationUse_NamedElement, gen_uml_Collaboration_BehavioredClassifier, gen_uml_Collaboration_StructuredClassifier, gen_uml_UseCase_BehavioredClassifier, gen_uml_Include_NamedElement, gen_uml_Include_DirectedRelationship, gen_uml_DataType_Classifier, gen_uml_Extend_NamedElement, gen_uml_Extend_DirectedRelationship, gen_uml_OperationTemplateParameter_TemplateParameter, gen_uml_StructuralFeature_Feature, gen_uml_StructuralFeature_TypedElement, gen_uml_StructuralFeature_MultiplicityElement, gen_uml_ConnectableElementTemplateParameter_TemplateParameter, gen_uml_ClassifierTemplateParameter_TemplateParameter, gen_uml_StringExpression_Expression, gen_uml_StringExpression_TemplateableElement, gen_uml_Expression_ValueSpecification, gen_uml_Usage_Dependency, gen_uml_PackageMerge_DirectedRelationship, gen_uml_ProfileApplication_DirectedRelationship, gen_uml_ExtensionPoint_RedefinableElement, gen_uml_RedefinableTemplateSignature_RedefinableElement, gen_uml_RedefinableTemplateSignature_TemplateSignature, gen_uml_InstanceSpecification_DeploymentTarget, gen_uml_InstanceSpecification_PackageableElement, gen_uml_InstanceSpecification_DeployedArtifact, gen_uml_Slot_Element, gen_uml_Enumeration_DataType, gen_uml_EnumerationLiteral_InstanceSpecification, gen_uml_LiteralInteger_LiteralSpecification, gen_uml_LiteralString_LiteralSpecification, gen_uml_LiteralBoolean_LiteralSpecification, gen_uml_PrimitiveType_DataType, gen_uml_LiteralSpecification_ValueSpecification, gen_uml_FunctionBehavior_OpaqueBehavior, gen_uml_OpaqueAction_Action, gen_uml_Action_ExecutableNode, gen_uml_ExecutableNode_ActivityNode, gen_uml_ActivityNode_RedefinableElement, gen_uml_LiteralNull_LiteralSpecification, gen_uml_InstanceValue_ValueSpecification, gen_uml_LiteralUnlimitedNatural_LiteralSpecification, gen_uml_OpaqueBehavior_Behavior, gen_uml_StructuredActivityNode_Action, gen_uml_StructuredActivityNode_Namespace, gen_uml_StructuredActivityNode_ActivityGroup, gen_uml_ActivityGroup_Element, gen_uml_Activity_Behavior, gen_uml_Variable_ConnectableElement, gen_uml_Variable_MultiplicityElement, gen_uml_ActivityEdge_RedefinableElement, gen_uml_ActivityPartition_NamedElement, gen_uml_ActivityPartition_ActivityGroup, gen_uml_InterruptibleActivityRegion_ActivityGroup, gen_uml_ExceptionHandler_Element, gen_uml_ObjectNode_ActivityNode, gen_uml_ObjectNode_TypedElement, gen_uml_ControlNode_ActivityNode, gen_uml_ControlFlow_ActivityEdge, gen_uml_InitialNode_ControlNode, gen_uml_ActivityParameterNode_ObjectNode, gen_uml_OutputPin_Pin, gen_uml_Pin_ObjectNode, gen_uml_Pin_MultiplicityElement, gen_uml_InputPin_Pin, gen_uml_CallAction_InvocationAction, gen_uml_InvocationAction_Action, gen_uml_SendSignalAction_InvocationAction, gen_uml_CallOperationAction_CallAction, gen_uml_CallBehaviorAction_CallAction, gen_uml_SequenceNode_StructuredActivityNode, gen_uml_ValuePin_InputPin, gen_uml_Message_NamedElement, gen_uml_MessageEnd_NamedElement, gen_uml_Interaction_Behavior, gen_uml_Interaction_InteractionFragment, gen_uml_OccurrenceSpecification_InteractionFragment, gen_uml_InteractionFragment_NamedElement, gen_uml_Lifeline_NamedElement, gen_uml_PartDecomposition_InteractionUse, gen_uml_InteractionUse_InteractionFragment, gen_uml_Gate_MessageEnd, gen_uml_GeneralOrdering_NamedElement, gen_uml_SendSignalEvent_MessageEvent, gen_uml_MessageOccurrenceSpecification_OccurrenceSpecification, gen_uml_MessageOccurrenceSpecification_MessageEnd, gen_uml_InteractionOperand_Namespace, gen_uml_InteractionOperand_InteractionFragment, gen_uml_InteractionConstraint_Constraint, gen_uml_ExecutionSpecification_InteractionFragment, gen_uml_StateInvariant_InteractionFragment, gen_uml_ActionExecutionSpecification_ExecutionSpecification, gen_uml_BehaviorExecutionSpecification_ExecutionSpecification, gen_uml_ExecutionEvent_Event, gen_uml_CreationEvent_Event, gen_uml_DestructionEvent_Event, gen_uml_SendOperationEvent_MessageEvent, gen_uml_MessageEvent_Event, gen_uml_ComponentRealization_Realization, gen_uml_ExecutionOccurrenceSpecification_OccurrenceSpecification, gen_uml_ReceiveOperationEvent_MessageEvent, gen_uml_ReceiveSignalEvent_MessageEvent, gen_uml_Actor_BehavioredClassifier, gen_uml_CallEvent_MessageEvent, gen_uml_ChangeEvent_Event, gen_uml_SignalEvent_MessageEvent, gen_uml_AnyReceiveEvent_MessageEvent, gen_uml_ForkNode_ControlNode, gen_uml_FlowFinalNode_FinalNode, gen_uml_FinalNode_ControlNode, gen_uml_CentralBufferNode_ObjectNode, gen_uml_MergeNode_ControlNode, gen_uml_DecisionNode_ControlNode, gen_uml_ObjectFlow_ActivityEdge, gen_uml_ActivityFinalNode_FinalNode, gen_uml_Continuation_InteractionFragment, gen_uml_ConsiderIgnoreFragment_CombinedFragment, gen_uml_Component_Class, gen_uml_Node_Class, gen_uml_Node_DeploymentTarget, gen_uml_CommunicationPath_Association, gen_uml_Device_Node, gen_uml_ExecutionEnvironment_Node, gen_uml_CombinedFragment_InteractionFragment, gen_uml_RemoveStructuralFeatureValueAction_WriteStructuralFeatureAction, gen_uml_CreateObjectAction_Action, gen_uml_DestroyObjectAction_Action, gen_uml_TestIdentityAction_Action, gen_uml_ReadSelfAction_Action, gen_uml_StructuralFeatureAction_Action, gen_uml_ReadStructuralFeatureAction_StructuralFeatureAction, gen_uml_WriteStructuralFeatureAction_StructuralFeatureAction, gen_uml_ClearStructuralFeatureAction_StructuralFeatureAction, gen_uml_AddStructuralFeatureValueAction_WriteStructuralFeatureAction, gen_uml_LinkAction_Action, gen_uml_LinkEndData_Element, gen_uml_QualifierValue_Element, gen_uml_ReadLinkAction_LinkAction, gen_uml_LinkEndCreationData_LinkEndData, gen_uml_CreateLinkAction_WriteLinkAction, gen_uml_WriteLinkAction_LinkAction, gen_uml_DestroyLinkAction_WriteLinkAction, gen_uml_LinkEndDestructionData_LinkEndData, gen_uml_ClearAssociationAction_Action, gen_uml_BroadcastSignalAction_InvocationAction, gen_uml_SendObjectAction_InvocationAction, gen_uml_ValueSpecificationAction_Action, gen_uml_TimeExpression_ValueSpecification, gen_uml_Observation_PackageableElement, gen_uml_Duration_ValueSpecification, gen_uml_DurationInterval_Interval, gen_uml_Interval_ValueSpecification, gen_uml_TimeConstraint_IntervalConstraint, gen_uml_IntervalConstraint_Constraint, gen_uml_TimeInterval_Interval, gen_uml_DurationConstraint_IntervalConstraint, gen_uml_TimeObservation_Observation, gen_uml_DurationObservation_Observation, gen_uml_FinalState_State, gen_uml_TimeEvent_Event, gen_uml_VariableAction_Action, gen_uml_ReadVariableAction_VariableAction, gen_uml_WriteVariableAction_VariableAction, gen_uml_ClearVariableAction_VariableAction, gen_uml_AddVariableValueAction_WriteVariableAction, gen_uml_RaiseExceptionAction_Action, gen_uml_ActionInputPin_InputPin, gen_uml_InformationItem_Classifier, gen_uml_InformationFlow_PackageableElement, gen_uml_InformationFlow_DirectedRelationship, gen_uml_ReadExtentAction_Action, gen_uml_RemoveVariableValueAction_WriteVariableAction, gen_uml_ReclassifyObjectAction_Action, gen_uml_ReadIsClassifiedObjectAction_Action, gen_uml_StartClassifierBehaviorAction_Action, gen_uml_ReadLinkObjectEndAction_Action, gen_uml_ReadLinkObjectEndQualifierAction_Action, gen_uml_CreateLinkObjectAction_CreateLinkAction, gen_uml_AcceptEventAction_Action, gen_uml_AcceptCallAction_AcceptEventAction, gen_uml_ReplyAction_Action, gen_uml_UnmarshallAction_Action, gen_uml_ReduceAction_Action, gen_uml_StartObjectBehaviorAction_CallAction, gen_uml_JoinNode_ControlNode, gen_uml_DataStoreNode_CentralBufferNode, gen_uml_ConditionalNode_StructuredActivityNode, gen_uml_Clause_Element, gen_uml_LoopNode_StructuredActivityNode, gen_uml_ExpansionNode_ObjectNode, gen_uml_ExpansionRegion_StructuredActivityNode, gen_uml_ProtocolTransition_Transition, gen_uml_AssociationClass_Class, gen_uml_AssociationClass_Association},
    metadata=None
)
