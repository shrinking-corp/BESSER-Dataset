...
# Classes
StateMachineDiagram_Meta_Application = Class(name="StateMachineDiagram_Meta_Application")
StateMachineDiagram_Meta_StateMachine = Class(name="StateMachineDiagram_Meta_StateMachine")
StateMachineDiagram_Meta_Vertex = Class(name="StateMachineDiagram_Meta_Vertex", is_abstract=True)
StateMachineDiagram_Meta_Transition = Class(name="StateMachineDiagram_Meta_Transition")
StateMachineDiagram_Meta_Pseudostate = Class(name="StateMachineDiagram_Meta_Pseudostate")
Vertex = Class(name="Vertex")
StateMachineDiagram_Meta_State = Class(name="StateMachineDiagram_Meta_State", is_abstract=True)
StateMachineDiagram_Meta_ViewController = Class(name="StateMachineDiagram_Meta_ViewController")
State = Class(name="State")
StateMachineDiagram_Meta_Event = Class(name="StateMachineDiagram_Meta_Event")
...
StateMachineDiagram_Meta_Transition.attributes={StateMachineDiagram_Meta_Transition_name, StateMachineDiagram_Meta_Transition_trigger}
...
domain_model = DomainModel(
    ...
    types={StateMachineDiagram_Meta_Application, StateMachineDiagram_Meta_StateMachine, StateMachineDiagram_Meta_Vertex, StateMachineDiagram_Meta_Transition, StateMachineDiagram_Meta_Pseudostate, Vertex, StateMachineDiagram_Meta_State, StateMachineDiagram_Meta_ViewController, State, StateMachineDiagram_Meta_Event},
    associations={statemachine0, vertex1, transition3, outgoing5, incoming6, source8, target9, statemachine11},
