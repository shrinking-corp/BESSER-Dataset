...
def test_statemachinediagram_meta_viewcontroller_is_not_abstract():
    assert not inspect.isabstract(StateMachineDiagram_Meta_ViewController)


def test_statemachinediagram_meta_viewcontroller_constructor_exists():
    assert callable(StateMachineDiagram_Meta_ViewController.__init__)


def test_statemachinediagram_meta_viewcontroller_constructor_args():
