...
class graphDsl_Component:
    ...
    def __init__(self, name: str, graphDsl_Component6: "graphDsl_ComponentProperties" = None, graphDsl_Component: "graphDsl_ComponentOrFacet" = None):
        self.name = name
