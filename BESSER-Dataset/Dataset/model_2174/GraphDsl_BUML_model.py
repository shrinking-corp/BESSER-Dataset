...
# Classes
graphDsl_Graph = Class(name="graphDsl_Graph")
graphDsl_ComponentOrFacet = Class(name="graphDsl_ComponentOrFacet")
graphDsl_ImportsProperty = Class(name="graphDsl_ImportsProperty")
graphDsl_FacetsProperty = Class(name="graphDsl_FacetsProperty")
graphDsl_ExtendsProperty = Class(name="graphDsl_ExtendsProperty")
graphDsl_ExportsVariable = Class(name="graphDsl_ExportsVariable")
graphDsl_ImportsVariable = Class(name="graphDsl_ImportsVariable")
graphDsl_Component = Class(name="graphDsl_Component")
graphDsl_Facet = Class(name="graphDsl_Facet")
graphDsl_ComponentProperties = Class(name="graphDsl_ComponentProperties")
graphDsl_FacetProperties = Class(name="graphDsl_FacetProperties")
graphDsl_OptionalProperty = Class(name="graphDsl_OptionalProperty")
graphDsl_InstallerProperty = Class(name="graphDsl_InstallerProperty")
graphDsl_FacetProperty = Class(name="graphDsl_FacetProperty")
graphDsl_ChildrenProperty = Class(name="graphDsl_ChildrenProperty")
graphDsl_ExportsProperty = Class(name="graphDsl_ExportsProperty")
...
graphDsl_ImportsVariable.attributes={graphDsl_ImportsVariable_isOptional, graphDsl_ImportsVariable_isExternal, graphDsl_ImportsVariable_componentName, graphDsl_ImportsVariable_componentProperty}
...
domain_model = DomainModel(
    name="graphDsl",
    types={graphDsl_Graph, graphDsl_ComponentOrFacet, graphDsl_ImportsProperty, graphDsl_FacetsProperty, graphDsl_ExtendsProperty, graphDsl_ExportsVariable, graphDsl_ImportsVariable, graphDsl_Component, graphDsl_Facet, graphDsl_ComponentProperties, graphDsl_FacetProperties, graphDsl_OptionalProperty, graphDsl_InstallerProperty, graphDsl_FacetProperty, graphDsl_ChildrenProperty, graphDsl_ExportsProperty},
    associations={components0, exportsProperty17, childrenProperty19, exportsProperty22, importsProperty25, facetsProperty27, extendsProperty29, exportsVariables31, importsVariables33, component1, facet3, properties5, properties7, optionalProperties9, installerProperty11, properties13, childrenProperty15},
    generalizations={},
    metadata=None
)
