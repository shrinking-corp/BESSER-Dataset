...
# Classes
collection_Item = Class(name="collection_Item")
collection_DataSet = Class(name="collection_DataSet")
collection_SmartInformationObjectCollection = Class(name="collection_SmartInformationObjectCollection")
ItemsCollection = Class(name="ItemsCollection")
collection_ItemsCollection = Class(name="collection_ItemsCollection", is_abstract=True)
collection_ManualCollection = Class(name="collection_ManualCollection")
collection_RemoteCollection = Class(name="collection_RemoteCollection")
collection_Tag = Class(name="collection_Tag")
collection_MetaTag = Class(name="collection_MetaTag")
collection_Category = Class(name="collection_Category")
collection_Person = Class(name="collection_Person")
collection_Organisation = Class(name="collection_Organisation")
...
collection_SmartInformationObjectCollection_m_addPositive: Method = Method(name="addPositive", parameters={Parameter(name='collection_item', type=StringType)}, type=StringType)
collection_SmartInformationObjectCollection_m_addNegative: Method = Method(name="addNegative", parameters={Parameter(name='collection_item', type=StringType)}, type=StringType)
collection_SmartInformationObjectCollection_m_remove: Method = Method(name="remove", parameters={Parameter(name='collection_item', type=StringType)}, type=StringType)
collection_SmartInformationObjectCollection.attributes={collection_SmartInformationObjectCollection_includePersons, collection_SmartInformationObjectCollection_includeOrganisations, collection_SmartInformationObjectCollection_includeContents, collection_SmartInformationObjectCollection_minimumAge}
collection_SmartInformationObjectCollection.methods={collection_SmartInformationObjectCollection_m_addPositive, collection_SmartInformationObjectCollection_m_addNegative, collection_SmartInformationObjectCollection_m_remove}
...
collection_ManualCollection_m_addItem: Method = Method(name="addItem", parameters={Parameter(name='collection_item', type=StringType)}, type=StringType)
collection_ManualCollection_m_removeItem: Method = Method(name="removeItem", parameters={Parameter(name='collection_item', type=StringType)}, type=StringType)
...
domain_model = DomainModel(
    name="collection",
    types={collection_Item, collection_DataSet, collection_SmartInformationObjectCollection, ItemsCollection, collection_ItemsCollection, collection_ManualCollection, collection_RemoteCollection, collection_Tag, collection_MetaTag, collection_Category, collection_Person, collection_Organisation},
    associations={items0, dataSet1, positiveTags3, negativeTags4, positiveMetaTags7, positiveCategories9, positivePersons11, negativeMetaTags13, negativeCategories16, negativePersons19, positiveOrganisations22, negativeOrganisations24},
