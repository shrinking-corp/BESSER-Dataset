...
public class table_DTableElementStyle extends IdentifiedElement {
    ...
    public table_DTableElementStyle(
        String foregroundColor,        boolean defaultForegroundStyle,        String backgroundColor,        String labelFormat,        int labelSize,        boolean defaultBackgroundStyle    ) {
        super(
        );
