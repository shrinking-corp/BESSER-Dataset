...
class table_description_TableDescription(description_DocumentedElement, description_EndUserDocumentedElement, description_RepresentationDescription):
    ...
    def __init__(self, preconditionExpression: str, domainClass: str, initialHeaderColumnWidth: int, table_description_TableDescription40: set["tool_RepresentationCreationDescription"] = None, table_description_TableDescription43: set["tool_RepresentationCreationDescription"] = None, table_description_TableDescription: set["tool_RepresentationCreationDescription"] = None, table_description_TableDescription54: set["LineMapping"] = None, table_description_TableDescription57: set["LineMapping"] = None, table_description_TableDescription60: set["LineMapping"] = None, table_description_TableDescription63: set["CreateLineTool"] = None, table_description_TableDescription65: set["CreateLineTool"] = None, table_description_TableDescription68: set["CreateLineTool"] = None, table_description_TableDescription71: set["description_table_EObject"] = None, table_description_TableDescription46: set["tool_RepresentationNavigationDescription"] = None, table_description_TableDescription48: set["tool_RepresentationNavigationDescription"] = None, table_description_TableDescription51: set["tool_RepresentationNavigationDescription"] = None):
        self.preconditionExpression = preconditionExpression
        self.domainClass = domainClass
...
class table_DTableElementStyle(IdentifiedElement):
    ...
    def __init__(self, labelFormat: str, defaultForegroundStyle: bool, defaultBackgroundStyle: bool, foregroundColor: str, backgroundColor: str, labelSize: int, table_DTableElementStyle37: "table_DColumn" = None, table_DTableElementStyle: "table_DLine" = None):
...
class table_DColumn(DTableElement):
    ...
    def __init__(self, label: str, visible: bool, width: int, table_DColumn36: "table_DTableElementStyle" = None, DColumn: "table_DTable" = None, column: set["table_DCell"] = None, table_DColumn: "ColumnMapping" = None, columns: "table_DTable" = None, DColumn15: "table_DCell" = None, table_DColumn33: set["table_DCell"] = None):
        self.label = label
...
class table_DLine(LineContainer, DTableElement):
    ...
    def __init__(self, visible: bool, collapsed: bool, label: str, table_DLine: "LineMapping" = None, line: set["table_DCell"] = None, DLine: "table_LineContainer" = None, lines: "table_LineContainer" = None, table_DLine8: set["table_DCell"] = None, table_DLine10: "table_DTableElementStyle" = None, DLine12: "table_DCell" = None):
        self.visible = visible
...
class table_DCell(DTableElement, DSemanticDecorator):
    ...
    def __init__(self, label: str, DCell: "table_DLine" = None, table_DCell: "table_DLine" = None, DCell29: "table_DColumn" = None, cells: "table_DLine" = None, cells14: "table_DColumn" = None, table_DCell34: "table_DColumn" = None, table_DCell17: "table_DCellStyle" = None, table_DCell19: "CellUpdater" = None, table_DCell21: "IntersectionMapping" = None):
        self.label = label
        self.DCell = DCell
