...
class ER_Entity(ERElem):
    ...
    def __init__(self, name: str, Entity: "ER_ERSchema" = None, Entity18: "ER_RelshipEnd" = None, Entity20: "ER_ERAttribute" = None, entity: set["ER_ERAttribute"] = None, entity5: set["ER_RelshipEnd"] = None, entities: "ER_ERSchema" = None):
        self.name = name
        self.Entity = Entity
