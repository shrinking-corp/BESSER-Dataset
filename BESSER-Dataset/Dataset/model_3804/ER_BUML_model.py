...
# Classes
ER_ERElem = Class(name="ER_ERElem", is_abstract=True)
ER_ERSchema = Class(name="ER_ERSchema")
ERElem = Class(name="ERElem")
ER_Entity = Class(name="ER_Entity")
ER_Relship = Class(name="ER_Relship")
ER_ERAttribute = Class(name="ER_ERAttribute")
ER_RelshipEnd = Class(name="ER_RelshipEnd")
...
domain_model = DomainModel(
    name="ER",
    types={ER_ERElem, ER_ERSchema, ERElem, ER_Entity, ER_Relship, ER_ERAttribute, ER_RelshipEnd},
    associations={entities0, relships1, attrs7, ends9, schema12, relship14, entity16, entity19, relship21, attrs3, ends4, schema6},
    generalizations={gen_ER_ERSchema_ERElem, gen_ER_Entity_ERElem, gen_ER_Relship_ERElem, gen_ER_RelshipEnd_ERElem, gen_ER_ERAttribute_ERElem},
    metadata=None
)
