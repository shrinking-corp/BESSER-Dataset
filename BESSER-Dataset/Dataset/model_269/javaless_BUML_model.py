...
# Classes
javaless_EClass = Class(name="javaless_EClass")
EClassifier = Class(name="EClassifier")
javaless_EOperation = Class(name="javaless_EOperation")
javaless_EReference = Class(name="javaless_EReference")
javaless_EAttribute = Class(name="javaless_EAttribute")
EStructuralFeature = Class(name="EStructuralFeature")
javaless_EDataType = Class(name="javaless_EDataType")
javaless_EAnnotation = Class(name="javaless_EAnnotation")
EModelElement = Class(name="EModelElement")
javaless_EStringToStringMapEntry = Class(name="javaless_EStringToStringMapEntry")
javaless_EModelElement = Class(name="javaless_EModelElement", is_abstract=True)
javaless_EObject = Class(name="javaless_EObject")
javaless_EPackage = Class(name="javaless_EPackage")
javaless_EEnum = Class(name="javaless_EEnum")
EDataType = Class(name="EDataType")
javaless_EEnumLiteral = Class(name="javaless_EEnumLiteral")
javaless_EFactory = Class(name="javaless_EFactory")
javaless_EStructuralFeature = Class(name="javaless_EStructuralFeature", is_abstract=True)
javaless_EClassifier = Class(name="javaless_EClassifier", is_abstract=True)
ENamedElement = Class(name="ENamedElement")
ETypedElement = Class(name="ETypedElement")
javaless_EParameter = Class(name="javaless_EParameter")
EObject = Class(name="EObject")
javaless_ENamedElement = Class(name="javaless_ENamedElement", is_abstract=True)
javaless_ETypedElement = Class(name="javaless_ETypedElement", is_abstract=True)
...
javaless_EClass_m_isSuperTypeOf: Method = Method(name="isSuperTypeOf", parameters={Parameter(name='javaless_someClass', type=StringType)}, type=BooleanType)
javaless_EClass_m_getFeatureCount: Method = Method(name="getFeatureCount", parameters={}, type=IntegerType)
javaless_EClass_m_getEStructuralFeature: Method = Method(name="getEStructuralFeature", parameters={Parameter(name='javaless_featureID', type=StringType)}, type=EStructuralFeature)
javaless_EClass_m_getFeatureID: Method = Method(name="getFeatureID", parameters={Parameter(name='javaless_feature', type=StringType)}, type=IntegerType)
javaless_EClass_m_getEStructuralFeature: Method = Method(name="getEStructuralFeature", parameters={Parameter(name='javaless_featureName', type=StringType)}, type=EStructuralFeature)
javaless_EClass.attributes={javaless_EClass_abstract, javaless_EClass_interface}
javaless_EClass.methods={javaless_EClass_m_getFeatureCount, javaless_EClass_m_getEStructuralFeature, javaless_EClass_m_getEStructuralFeature, javaless_EClass_m_isSuperTypeOf, javaless_EClass_m_getFeatureID}
...
javaless_EReference.attributes={javaless_EReference_resolveProxies, javaless_EReference_container, javaless_EReference_containment}
...
javaless_EStringToStringMapEntry.attributes={javaless_EStringToStringMapEntry_key, javaless_EStringToStringMapEntry_value}

# javaless_EModelElement class attributes and methods
javaless_EModelElement_m_getEAnnotation: Method = Method(name="getEAnnotation", parameters={Parameter(name='javaless_source', type=StringType)}, type=StringType)
...
javaless_EObject_m_eGet: Method = Method(name="eGet", parameters={Parameter(name='javaless_feature', type=StringType)}, type=StringType)
javaless_EObject_m_eGet: Method = Method(name="eGet", parameters={Parameter(name='javaless_feature', type=StringType), Parameter(name='javaless_resolve', type=StringType)}, type=StringType)
javaless_EObject_m_eSet: Method = Method(name="eSet", parameters={Parameter(name='javaless_feature', type=StringType), Parameter(name='javaless_newValue', type=StringType)})
javaless_EObject_m_eIsSet: Method = Method(name="eIsSet", parameters={Parameter(name='javaless_feature', type=StringType)}, type=BooleanType)
javaless_EObject_m_eUnset: Method = Method(name="eUnset", parameters={Parameter(name='javaless_feature', type=StringType)})
...
javaless_EObject.methods={javaless_EObject_m_eIsSet, javaless_EObject_m_eContents, javaless_EObject_m_eGet, javaless_EObject_m_eResource, javaless_EObject_m_eClass, javaless_EObject_m_eContainmentFeature, javaless_EObject_m_eSet, javaless_EObject_m_eUnset, javaless_EObject_m_eAllContents, javaless_EObject_m_eContainer, javaless_EObject_m_eIsProxy, javaless_EObject_m_eCrossReferences, javaless_EObject_m_eContainingFeature, javaless_EObject_m_eGet}
...
javaless_EPackage_m_getEClassifier: Method = Method(name="getEClassifier", parameters={Parameter(name='javaless_name', type=StringType)}, type=EClassifier)
...
javaless_EEnum_m_getEEnumLiteral: Method = Method(name="getEEnumLiteral", parameters={Parameter(name='javaless_name', type=StringType)}, type=StringType)
javaless_EEnum_m_getEEnumLiteral: Method = Method(name="getEEnumLiteral", parameters={Parameter(name='javaless_value', type=StringType)}, type=StringType)
javaless_EEnum_m_getEEnumLiteralByLiteral: Method = Method(name="getEEnumLiteralByLiteral", parameters={Parameter(name='javaless_literal', type=StringType)}, type=StringType)
javaless_EEnum.methods={javaless_EEnum_m_getEEnumLiteral, javaless_EEnum_m_getEEnumLiteral, javaless_EEnum_m_getEEnumLiteralByLiteral}
...
javaless_EEnumLiteral.attributes={javaless_EEnumLiteral_instance, javaless_EEnumLiteral_value, javaless_EEnumLiteral_literal}

# javaless_EFactory class attributes and methods
javaless_EFactory_m_create: Method = Method(name="create", parameters={Parameter(name='javaless_eClass', type=StringType)}, type=StringType)
javaless_EFactory_m_createFromString: Method = Method(name="createFromString", parameters={Parameter(name='javaless_literalValue', type=StringType), Parameter(name='javaless_eDataType', type=StringType)}, type=StringType)
javaless_EFactory_m_convertToString: Method = Method(name="convertToString", parameters={Parameter(name='javaless_eDataType', type=StringType), Parameter(name='javaless_instanceValue', type=StringType)}, type=StringType)
javaless_EFactory.methods={javaless_EFactory_m_convertToString, javaless_EFactory_m_create, javaless_EFactory_m_createFromString}
...
javaless_EStructuralFeature.attributes={javaless_EStructuralFeature_derived, javaless_EStructuralFeature_volatile, javaless_EStructuralFeature_transient, javaless_EStructuralFeature_defaultValueLiteral, javaless_EStructuralFeature_defaultValue, javaless_EStructuralFeature_changeable, javaless_EStructuralFeature_unsettable}
javaless_EStructuralFeature.methods={javaless_EStructuralFeature_m_getContainerClass, javaless_EStructuralFeature_m_getFeatureID}
...
javaless_EClassifier_m_isInstance: Method = Method(name="isInstance", parameters={Parameter(name='javaless_object', type=StringType)}, type=BooleanType)
javaless_EClassifier_m_getClassifierID: Method = Method(name="getClassifierID", parameters={}, type=IntegerType)
javaless_EClassifier.attributes={javaless_EClassifier_instanceClassName, javaless_EClassifier_instanceClass, javaless_EClassifier_defaultValue}
...
javaless_ETypedElement.attributes={javaless_ETypedElement_unique, javaless_ETypedElement_upperBound, javaless_ETypedElement_lowerBound, javaless_ETypedElement_ordered, javaless_ETypedElement_many, javaless_ETypedElement_required}
...
domain_model = DomainModel(
    name="javaless",
    types={javaless_EClass, EClassifier, javaless_EOperation, javaless_EReference, javaless_EAttribute, EStructuralFeature, javaless_EDataType, javaless_EAnnotation, EModelElement, javaless_EStringToStringMapEntry, javaless_EModelElement, javaless_EObject, javaless_EPackage, javaless_EEnum, EDataType, javaless_EEnumLiteral, javaless_EFactory, javaless_EStructuralFeature, javaless_EClassifier, ENamedElement, ETypedElement, javaless_EParameter, EObject, javaless_ENamedElement, javaless_ETypedElement},
    associations={references5, eSuperTypes9, eOperations10, eAllAttributes11, eAllReferences14, eReferences16, eAttributes19, eAllContainments22, eAttributeType0, details1, eModelElement2, contents3, ePackage37, eLiterals38, eEnum39, eAllOperations25, eAllStructuralFeatures27, eAllSuperTypes30, eIDAttribute32, eStructuralFeatures35, eContainingClass43, eParameters44, eExceptions45, eFactoryInstance47, eClassifiers48, eSubpackages51, ePackage40, eAnnotations42, eContainingClass64, eType66, eSuperPackage54, eOperation56, eOpposite59, eReferenceType61},
    generalizations={gen_javaless_EClass_EClassifier, gen_javaless_EAttribute_EStructuralFeature, gen_javaless_EAnnotation_EModelElement, gen_javaless_EDataType_EClassifier, gen_javaless_EEnum_EDataType, gen_javaless_EEnumLiteral_ENamedElement, gen_javaless_EFactory_EModelElement, gen_javaless_EClassifier_ENamedElement, gen_javaless_EOperation_ETypedElement, gen_javaless_EPackage_ENamedElement, gen_javaless_EModelElement_EObject, gen_javaless_ENamedElement_EModelElement, gen_javaless_ETypedElement_ENamedElement, gen_javaless_EParameter_ETypedElement, gen_javaless_EReference_EStructuralFeature, gen_javaless_EStructuralFeature_ETypedElement},
    metadata=None
)
