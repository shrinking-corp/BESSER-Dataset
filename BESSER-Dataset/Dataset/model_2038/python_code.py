...
class etatma_State:
    ...
    def __init__(self, name: str, etatma_State: "etatma_StateMachine" = None, State: "etatma_Transition" = None, State5: "etatma_Transition" = None, from_: "etatma_Transition" = None, to: "etatma_Transition" = None):
        self.name = name
    ...
    def from_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_etatma_State__from_", None)
        self.__from_ = value
...
class etatma_Transition:
    ...
    def __init__(self, name: str, outgoing: "etatma_State" = None, incoming: "etatma_State" = None, Transition: "etatma_State" = None, Transition8: "etatma_State" = None, etatma_Transition: "etatma_StateMachine" = None):
        self.name = name
