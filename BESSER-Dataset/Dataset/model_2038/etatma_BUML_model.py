...
# Classes
etatma_StateMachine = Class(name="etatma_StateMachine")
etatma_Transition = Class(name="etatma_Transition")
etatma_State = Class(name="etatma_State")
...
outgoing6: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_", type=etatma_Transition, multiplicity=Multiplicity(0, 1))
    }
)
...
domain_model = DomainModel(
    ...
    associations={transition0, state1, from_3, to4, outgoing6, incoming7},
    generalizations={},
    metadata=None
)
