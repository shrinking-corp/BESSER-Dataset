...
# Classes
compositefsm_Transition = Class(name="compositefsm_Transition")
compositefsm_FSM = Class(name="compositefsm_FSM")
compositefsm_State = Class(name="compositefsm_State")
...
compositefsm_Transition.attributes={compositefsm_Transition_output, compositefsm_Transition_input}
...
domain_model = DomainModel(
    name="compositefsm",
    types={compositefsm_Transition, compositefsm_FSM, compositefsm_State},
    associations={owningFSM5, outgoingTransition6, incomingTransition7, subStates10, superState13, ownedState0, initialState1, finalState2, source15, target17},
    generalizations={},
    metadata=None
)
