...
class compositefsm_State:
    ...
    def __init__(self, name: str, ownedState: "compositefsm_FSM" = None, source: set["compositefsm_Transition"] = None, target: set["compositefsm_Transition"] = None, State11: "compositefsm_State" = None, superState: set["compositefsm_State"] = None, State14: "compositefsm_State" = None, subStates: "compositefsm_State" = None, State: "compositefsm_FSM" = None, compositefsm_State: "compositefsm_FSM" = None, compositefsm_State4: "compositefsm_FSM" = None, State16: "compositefsm_Transition" = None, State18: "compositefsm_Transition" = None):
        self.name = name
