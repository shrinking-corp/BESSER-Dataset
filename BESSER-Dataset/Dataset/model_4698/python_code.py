...
class familytree_Person(ABC):
    ...
    def __init__(self, relationshipStatus: str, died: bool, dayOfDeath: date, locationOfBirth: str, firstName: str, secondName: str, dayOfBirth: date, nameOfBirth: str, imagePaths: str, familytree_Person: "familytree_FamilyTree" = None, Person: "familytree_Person" = None, parents: set["familytree_Person"] = None, Person4: "familytree_Person" = None, children: set["familytree_Person"] = None, Person7: "familytree_Person" = None, inRelationTo: "familytree_Person" = None, Person10: "familytree_Person" = None, inRelationWith: "familytree_Person" = None):
