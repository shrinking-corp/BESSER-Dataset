...
# Classes
familytree_Person = Class(name="familytree_Person", is_abstract=True)
familytree_FamilyTree = Class(name="familytree_FamilyTree")
familytree_Woman = Class(name="familytree_Woman")
Person = Class(name="Person")
familytree_Man = Class(name="familytree_Man")
...
familytree_Person.attributes={familytree_Person_dayOfBirth, familytree_Person_locationOfBirth, familytree_Person_firstName, familytree_Person_secondName, familytree_Person_imagePaths, familytree_Person_nameOfBirth, familytree_Person_died, familytree_Person_relationshipStatus, familytree_Person_dayOfDeath}
...
domain_model = DomainModel(
    name="familytree",
    types={familytree_Person, familytree_FamilyTree, familytree_Woman, Person, familytree_Man, RelationshipStatus},
    associations={children1, parents3, inRelationWith6, inRelationTo9, members11},
