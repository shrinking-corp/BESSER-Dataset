...
class room_Documentation:
    ...
    def __init__(self, text: str, room_Documentation: "room_RoomModel" = None, room_Documentation18: "room_RoomClass" = None, room_Documentation100: "room_Message" = None, room_Documentation133: "room_ActorClass" = None, room_Documentation148: "room_ActorClass" = None, room_Documentation160: "room_Port" = None, room_Documentation170: "room_ActorContainerRef" = None, room_Documentation210: "room_State" = None, room_Documentation57: "room_Attribute" = None, room_Documentation65: "room_Operation" = None, room_Documentation235: "room_ChoicePoint" = None, room_Documentation240: "room_Transition" = None):
        self.text = text
...
class room_RoomModel:
    ...
    def __init__(self, name: str, room_RoomModel: "room_Documentation" = None, room_RoomModel2: set["room_Import"] = None, room_RoomModel4: set["room_PrimitiveType"] = None, room_RoomModel6: set["room_ExternalType"] = None, room_RoomModel8: set["room_DataClass"] = None, room_RoomModel10: set["room_ProtocolClass"] = None, room_RoomModel12: set["room_ActorClass"] = None, room_RoomModel14: set["room_SubSystemClass"] = None, room_RoomModel16: set["room_LogicalSystem"] = None):
        self.name = name
...
class room_BaseState(State):
    ...
    def __init__(self, name: str, room_BaseState252: "room_StateTerminal" = None, room_BaseState259: "room_SubStateTrPointTerminal" = None, room_BaseState: "room_RefinedState" = None):
        self.name = name
...
class room_LogicalThread:
    ...
    def __init__(self, name: str, prio: int, room_LogicalThread180: set["room_ActorInstancePath"] = None, room_LogicalThread: "room_SubSystemClass" = None):
        self.name = name
        self.prio = prio
...
class room_TrPoint(StateGraphNode):
    ...
    def __init__(self, name: str, room_TrPoint254: "room_TrPointTerminal" = None, room_TrPoint256: "room_SubStateTrPointTerminal" = None, room_TrPoint: "room_StateGraph" = None):
        self.name = name
...
class room_ChoicePoint(StateGraphNode):
    ...
    def __init__(self, name: str, room_ChoicePoint261: "room_ChoicepointTerminal" = None, room_ChoicePoint: "room_StateGraph" = None, room_ChoicePoint234: "room_Documentation" = None):
        self.name = name
...
class room_State(StateGraphNode):
    ...
    def __init__(self, room_State: "room_Documentation" = None, room_State212: "room_DetailCode" = None, room_State215: "room_DetailCode" = None, room_State221: "room_StateGraph" = None, room_State225: "room_StateGraph" = None, room_State218: "room_DetailCode" = None):
...
class room_ActorContainerRef:
    ...
    def __init__(self, name: str, room_ActorContainerRef: "room_Documentation" = None, room_ActorContainerRef188: "room_BindingEndPoint" = None, room_ActorContainerRef197: "room_RefSAPoint" = None, room_ActorContainerRef202: "room_SPPoint" = None):
        self.name = name
...
class room_Port(InterfaceItem):
    ...
    def __init__(self, conjugated: bool, multiplicity: int, room_Port: "room_ActorClass" = None, room_Port136: "room_ActorClass" = None, room_Port159: "room_Documentation" = None, room_Port163: "room_ExternalPort" = None, room_Port176: "room_SubSystemClass" = None, room_Port191: "room_BindingEndPoint" = None):
...
class room_ActorClass(ActorContainerClass):
    ...
    def __init__(self, abstract: bool, commType: str, room_ActorClass: "room_RoomModel" = None, room_ActorClass128: "room_ActorClass" = None, room_ActorClass126: "room_ActorClass" = None, room_ActorClass130: set["room_Port"] = None, room_ActorClass132: "room_Documentation" = None, room_ActorClass135: set["room_Port"] = None, room_ActorClass138: set["room_ExternalPort"] = None, room_ActorClass140: set["room_ServiceImplementation"] = None, room_ActorClass142: set["room_SAPRef"] = None, room_ActorClass144: set["room_Attribute"] = None, room_ActorClass147: "room_Documentation" = None, room_ActorClass155: "room_StateGraph" = None, room_ActorClass150: set["room_Annotation"] = None, room_ActorClass152: set["room_StandardOperation"] = None, room_ActorClass208: "room_ActorRef" = None):
...
class room_Message:
    ...
    def __init__(self, priv: bool, name: str, room_Message96: "room_VarDecl" = None, room_Message99: "room_Documentation" = None, room_Message114: "room_MessageHandler" = None, room_Message122: "room_SemanticsRule" = None, room_Message: "room_PortOperation" = None, room_Message84: "room_ProtocolClass" = None, room_Message87: "room_ProtocolClass" = None, room_Message268: "room_MessageFromIf" = None):
        self.priv = priv
        self.name = name
...
class room_Operation:
    ...
    def __init__(self, name: str, room_Operation: set["room_VarDecl"] = None, room_Operation61: "room_RefableType" = None, room_Operation64: "room_Documentation" = None, room_Operation67: "room_DetailCode" = None):
        self.name = name
...
class room_Attribute:
    ...
    def __init__(self, name: str, size: int, defaultValueLiteral: str, room_Attribute145: "room_ActorClass" = None, room_Attribute106: "room_PortClass" = None, room_Attribute: "room_DataClass" = None, room_Attribute53: "room_RefableType" = None, room_Attribute56: "room_Documentation" = None):
        self.name = name
        self.size = size
...
class room_RefableType:
    ...
    def __init__(self, ref: bool, room_RefableType54: "room_Attribute" = None, room_RefableType62: "room_Operation" = None, room_RefableType: "room_VarDecl" = None, room_RefableType35: "room_DataType" = None):
        self.ref = ref
...
class room_VarDecl:
    ...
    def __init__(self, name: str, room_VarDecl59: "room_Operation" = None, room_VarDecl: "room_RefableType" = None, room_VarDecl97: "room_Message" = None):
        self.name = name
...
class room_DetailCode:
    ...
    def __init__(self, commands: str, room_DetailCode: "room_ActorContainerClass" = None, room_DetailCode27: "room_ActorContainerClass" = None, room_DetailCode30: "room_ActorContainerClass" = None, room_DetailCode41: "room_DataClass" = None, room_DetailCode44: "room_DataClass" = None, room_DetailCode47: "room_DataClass" = None, room_DetailCode117: "room_MessageHandler" = None, room_DetailCode103: "room_PortClass" = None, room_DetailCode213: "room_State" = None, room_DetailCode68: "room_Operation" = None, room_DetailCode75: "room_ProtocolClass" = None, room_DetailCode78: "room_ProtocolClass" = None, room_DetailCode81: "room_ProtocolClass" = None, room_DetailCode274: "room_Guard" = None, room_DetailCode216: "room_State" = None, room_DetailCode243: "room_Transition" = None, room_DetailCode219: "room_State" = None, room_DetailCode248: "room_GuardedTransition" = None, room_DetailCode250: "room_CPBranchTransition" = None):
...
class room_ProtocolClass(RoomClass):
    ...
    def __init__(self, commType: str, room_ProtocolClass: "room_RoomModel" = None, room_ProtocolClass72: "room_ProtocolClass" = None, room_ProtocolClass70: "room_ProtocolClass" = None, room_ProtocolClass157: "room_InterfaceItem" = None, room_ProtocolClass74: "room_DetailCode" = None, room_ProtocolClass77: "room_DetailCode" = None, room_ProtocolClass80: "room_DetailCode" = None, room_ProtocolClass83: set["room_Message"] = None, room_ProtocolClass86: set["room_Message"] = None, room_ProtocolClass89: "room_PortClass" = None, room_ProtocolClass91: "room_PortClass" = None, room_ProtocolClass94: "room_ProtocolSemantics" = None):
        self.commType = commType
