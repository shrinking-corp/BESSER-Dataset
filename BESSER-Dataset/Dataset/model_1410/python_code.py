...
class trialStatemachine_LabeledTransition:
    ...
    def __init__(self, id: str, trialStatemachine_LabeledTransition13: "trialStatemachine_State" = None, trialStatemachine_LabeledTransition16: "trialStatemachine_Action" = None, trialStatemachine_LabeledTransition: "trialStatemachine_State" = None):
        self.id = id
...
class trialStatemachine_State:
    ...
    def __init__(self, name: str, trialStatemachine_State5: "trialStatemachine_Region" = None, trialStatemachine_State8: "trialStatemachine_Region" = None, trialStatemachine_State11: "trialStatemachine_Region" = None, trialStatemachine_State14: "trialStatemachine_LabeledTransition" = None, trialStatemachine_State: set["trialStatemachine_LabeledTransition"] = None):
        self.name = name
