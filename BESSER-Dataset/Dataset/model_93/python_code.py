...
class javaMM_Modifier(ASTNode):
    ...
    def __init__(self, visibility: str, inheritance: str, static: str, transient: str, volatile: str, native: str, strictfp: str, synchronized: str, Modifier: "javaMM_BodyDeclaration" = None, modifier: "javaMM_BodyDeclaration" = None, modifier252: "javaMM_SingleVariableDeclaration" = None, modifier255: "javaMM_VariableDeclarationStatement" = None, modifier257: "javaMM_VariableDeclarationExpression" = None, Modifier355: "javaMM_VariableDeclarationExpression" = None, Modifier360: "javaMM_VariableDeclarationStatement" = None, Modifier294: "javaMM_SingleVariableDeclaration" = None):
...
class javaMM_NamedElement(ASTNode):
    ...
    def __init__(self, name: str, proxy: str, NamedElement: "javaMM_ImportDeclaration" = None, importedElement: set["javaMM_ImportDeclaration"] = None, javaMM_NamedElement: "javaMM_MemberRef" = None):
        self.name = name
        self.proxy = proxy
...
class javaMM_SingleVariableDeclaration(VariableDeclaration):
    ...
    def __init__(self, varargs: str, SingleVariableDeclaration: "javaMM_AbstractMethodDeclaration" = None, SingleVariableDeclaration100: "javaMM_CatchClause" = None, SingleVariableDeclaration152: "javaMM_EnhancedForStatement" = None, SingleVariableDeclaration253: "javaMM_Modifier" = None, exception: "javaMM_CatchClause" = None, parameter: "javaMM_EnhancedForStatement" = None, singleVariableDeclaration: "javaMM_Modifier" = None, javaMM_SingleVariableDeclaration: "javaMM_TypeAccess" = None, javaMM_SingleVariableDeclaration298: set["javaMM_Annotation"] = None, parameters: "javaMM_AbstractMethodDeclaration" = None):
        self.varargs = varargs
