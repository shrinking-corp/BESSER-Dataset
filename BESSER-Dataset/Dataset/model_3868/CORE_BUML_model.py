...
# Classes
core_COREModel = Class(name="core_COREModel", is_abstract=True)
COREModelElement = Class(name="COREModelElement")
core_COREReuse = Class(name="core_COREReuse")
core_COREBinding = Class(name="core_COREBinding", is_abstract=True)
CORECompositionSpecification = Class(name="CORECompositionSpecification")
core_COREMapping = Class(name="core_COREMapping", is_abstract=True)
CORENamedElement = Class(name="CORENamedElement")
core_COREModelReuse = Class(name="core_COREModelReuse")
core_COREModelElement = Class(name="core_COREModelElement", is_abstract=True)
core_COREFeature = Class(name="core_COREFeature", is_abstract=True)
core_COREImpactModel = Class(name="core_COREImpactModel", is_abstract=True)
COREModel = Class(name="COREModel")
core_COREConcern = Class(name="core_COREConcern")
core_COREInterface = Class(name="core_COREInterface")
core_COREPattern = Class(name="core_COREPattern", is_abstract=True)
core_COREFeatureModel = Class(name="core_COREFeatureModel", is_abstract=True)
core_CORECompositionSpecification = Class(name="core_CORECompositionSpecification", is_abstract=True)
core_CORENamedElement = Class(name="core_CORENamedElement", is_abstract=True)
core_COREImpactModelElement = Class(name="core_COREImpactModelElement", is_abstract=True)
core_COREConfiguration = Class(name="core_COREConfiguration")
...
core_COREFeature_m_addFeature: Method = Method(name="addFeature", parameters={Parameter(name='core_position', type=StringType), Parameter(name='core_child_name', type=StringType), Parameter(name='core_association', type=StringType)}, type=BooleanType)
core_COREFeature_m_delete: Method = Method(name="delete", parameters={}, type=BooleanType)
core_COREFeature_m_rename: Method = Method(name="rename", parameters={Parameter(name='core_core_feature_name', type=StringType)})
core_COREFeature_m_changeLink: Method = Method(name="changeLink", parameters={Parameter(name='core_new_association', type=StringType)}, type=BooleanType)
core_COREFeature_m_changeParent: Method = Method(name="changeParent", parameters={Parameter(name='core_new_association', type=StringType), Parameter(name='core_feature', type=StringType)}, type=BooleanType)
core_COREFeature_m_requires: Method = Method(name="requires", parameters={Parameter(name='core_feature', type=StringType)}, type=BooleanType)
core_COREFeature_m_excludes: Method = Method(name="excludes", parameters={Parameter(name='core_feature', type=StringType)}, type=BooleanType)
core_COREFeature_m_removeConstraint: Method = Method(name="removeConstraint", parameters={Parameter(name='core_feature', type=StringType)}, type=BooleanType)
core_COREFeature_m_addRealizedBy: Method = Method(name="addRealizedBy", parameters={Parameter(name='core_model', type=StringType)}, type=BooleanType)
core_COREFeature_m_AssociateReuse: Method = Method(name="AssociateReuse", parameters={Parameter(name='core_reuse', type=StringType), Parameter(name='core_selected', type=StringType), Parameter(name='core_reexposed', type=StringType)}, type=BooleanType)
core_COREFeature.methods={core_COREFeature_m_rename, core_COREFeature_m_changeParent, core_COREFeature_m_AssociateReuse, core_COREFeature_m_requires, core_COREFeature_m_addFeature, core_COREFeature_m_excludes, core_COREFeature_m_delete, core_COREFeature_m_addRealizedBy, core_COREFeature_m_removeConstraint, core_COREFeature_m_changeLink}
...
domain_model = DomainModel(
    name="core",
    types={core_COREModel, COREModelElement, core_COREReuse, core_COREBinding, CORECompositionSpecification, core_COREMapping, CORENamedElement, core_COREModelReuse, core_COREModelElement, core_COREFeature, core_COREImpactModel, COREModel, core_COREConcern, core_COREInterface, core_COREPattern, core_COREFeatureModel, core_CORECompositionSpecification, core_CORENamedElement, core_COREImpactModelElement, core_COREConfiguration, COREFeatureRelationshipType, COREFeatureSelectionStatus},
    associations={realizedBy8, reuses9, coreMappings10, modelReuse0, modelElements1, realizes3, models4, interface6, reusedConcern32, configurations35, selected38, selected41, reexposed44, compositions47, modelReuse50, source11, mappedTo13, mappedFrom16, selectable19, customizable22, usable25, impacted28, defaults30},
    generalizations={gen_core_COREFeature_COREModelElement, gen_core_COREBinding_CORECompositionSpecification, gen_core_COREModelElement_CORENamedElement, gen_core_COREModel_CORENamedElement, gen_core_COREImpactModel_COREModel, gen_core_COREConcern_CORENamedElement, gen_core_COREPattern_CORECompositionSpecification, gen_core_COREImpactModelElement_COREModelElement, gen_core_COREConfiguration_CORENamedElement, gen_core_COREFeatureModel_COREModel},
    metadata=None
)
