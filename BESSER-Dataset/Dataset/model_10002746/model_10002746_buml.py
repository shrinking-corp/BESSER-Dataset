...
Costomer.attributes={Costomer_mobileNumber, Costomer_Address, Costomer_Name, Costomer_ID, Costomer_Email}
...
Shipment.attributes={Shipment_Date, Shipment_SippingType, Shipment_Forbidden_to_ship, Shipment_pireodofShip}
...
Item.attributes={Item_Quantity, Item_price, Item_ItemID}
...
domain_model = DomainModel(
    name="d5900f5d_858c_4e68_8a5b_00643ecf1155",
    types={Client_4_UseCase, Client_3_UseCase, Internet_____________________network_UseCase, Shipment_server_Component, Order_server_Component, customer_Actor, Company_Actor, Shipping_UseCase, Point_system_UseCase, Pay_UseCase, Cancel_UseCase, Get_dedcuted_percent_UseCase, Se_price_UseCase, Set_period_of_ship_UseCase, set_deducted_percent_UseCase, Normal_UseCase, express_UseCase, Cash_UseCase, Credit_card_UseCase, UseCase_UseCase, UseCase2_UseCase, Actor_Actor, mysubject_Component, Costomer, Shipment, MyClass, Express, Normal, Order, Item, Cahs, CreditCard, Payment, Shipmment_UseCase, Client_1_UseCase, Client_2_UseCase},
    associations={Order_Costomer, Costomer_Shipment, Item_Order, Order_Payment, Client_1_Internet_network, Client_2_Internet_network, Client_3_Internet_network, Client_4_Internet_network, Order_server_Internet_network, Shipment_server_Internet_network, Company_Set_period_of_ship, Company_Se_price, Company_set_deducted_percent, customer_Point_system, customer_Pay, customer_Cancel, customer_Get_dedcuted_percent, Company_Shipping, customer_Shipping},
    generalizations={},
    metadata=None
)
