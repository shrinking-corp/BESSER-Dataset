...
# Classes
ACG_LocatedElement = Class(name="ACG_LocatedElement", is_abstract=True)
ACG_ACG = Class(name="ACG_ACG")
LocatedElement = Class(name="LocatedElement")
ACGElement = Class(name="ACGElement")
ACG_ACGElement = Class(name="ACG_ACGElement", is_abstract=True)
ACG = Class(name="ACG")
ACG_Function = Class(name="ACG_Function")
Parameter_ = Class(name="Parameter")
Expression = Class(name="Expression")
ACG_Attribute = Class(name="ACG_Attribute")
ACG_Parameter = Class(name="ACG_Parameter")
VariableDecl = Class(name="VariableDecl")
ACG_Node = Class(name="ACG_Node", is_abstract=True)
ACG_ASMNode = Class(name="ACG_ASMNode")
Node = Class(name="Node")
ACG_CodeNode = Class(name="ACG_CodeNode")
ACG_SimpleNode = Class(name="ACG_SimpleNode")
ACG_StatementBlock = Class(name="ACG_StatementBlock", is_abstract=True)
Statement = Class(name="Statement")
ACG_Statement = Class(name="ACG_Statement", is_abstract=True)
ACG_CompoundStat = Class(name="ACG_CompoundStat", is_abstract=True)
ACG_ForEachStat = Class(name="ACG_ForEachStat")
CompoundStat = Class(name="CompoundStat")
ACG_OnceStat = Class(name="ACG_OnceStat")
ACG_VariableStat = Class(name="ACG_VariableStat")
ACG_OperationStat = Class(name="ACG_OperationStat")
ACG_ConditionalStat = Class(name="ACG_ConditionalStat")
StatementBlock = Class(name="StatementBlock")
ACG_AnalyzeStat = Class(name="ACG_AnalyzeStat")
ACG_ReportStat = Class(name="ACG_ReportStat")
ACG_FieldStat = Class(name="ACG_FieldStat")
ACG_ParamStat = Class(name="ACG_ParamStat")
ACG_EmitStat = Class(name="ACG_EmitStat", is_abstract=True)
ACG_LabelStat = Class(name="ACG_LabelStat")
EmitStat = Class(name="EmitStat")
ACG_NewStat = Class(name="ACG_NewStat")
ACG_NewinStat = Class(name="ACG_NewinStat")
ACG_DeleteStat = Class(name="ACG_DeleteStat")
ACG_DupStat = Class(name="ACG_DupStat")
ACG_LetStat = Class(name="ACG_LetStat")
ACG_DupX1Stat = Class(name="ACG_DupX1Stat")
ACG_SwapStat = Class(name="ACG_SwapStat")
ACG_IterateStat = Class(name="ACG_IterateStat")
ACG_EndIterateStat = Class(name="ACG_EndIterateStat")
ACG_GetAsmStat = Class(name="ACG_GetAsmStat")
ACG_FindMEStat = Class(name="ACG_FindMEStat")
ACG_PushTStat = Class(name="ACG_PushTStat")
ACG_PushFStat = Class(name="ACG_PushFStat")
ACG_EmitWithOperandStat = Class(name="ACG_EmitWithOperandStat", is_abstract=True)
ACG_PushStat = Class(name="ACG_PushStat")
EmitWithOperandStat = Class(name="EmitWithOperandStat")
ACG_PushIStat = Class(name="ACG_PushIStat")
ACG_PushDStat = Class(name="ACG_PushDStat")
ACG_LoadStat = Class(name="ACG_LoadStat")
ACG_StoreStat = Class(name="ACG_StoreStat")
ACG_CallStat = Class(name="ACG_CallStat")
ACG_PCallStat = Class(name="ACG_PCallStat")
ACG_SuperCallStat = Class(name="ACG_SuperCallStat")
ACG_GetStat = Class(name="ACG_GetStat")
ACG_SetStat = Class(name="ACG_SetStat")
ACG_EmitWithLabelRefStat = Class(name="ACG_EmitWithLabelRefStat", is_abstract=True)
LabelStat = Class(name="LabelStat")
ACG_IfStat = Class(name="ACG_IfStat")
EmitWithLabelRefStat = Class(name="EmitWithLabelRefStat")
ACG_GotoStat = Class(name="ACG_GotoStat")
ACG_VariableDecl = Class(name="ACG_VariableDecl")
ACG_Expression = Class(name="ACG_Expression", is_abstract=True)
ACG_VariableExp = Class(name="ACG_VariableExp")
ACG_SelfExp = Class(name="ACG_SelfExp")
ACG_PopStat = Class(name="ACG_PopStat")
ACG_IsAExp = Class(name="ACG_IsAExp")
ACG_LetExp = Class(name="ACG_LetExp")
ACG_PropertyCallExp = Class(name="ACG_PropertyCallExp", is_abstract=True)
ACG_NavigationExp = Class(name="ACG_NavigationExp")
PropertyCallExp = Class(name="PropertyCallExp")
ACG_IteratorExp = Class(name="ACG_IteratorExp")
ACG_OperationCallExp = Class(name="ACG_OperationCallExp")
ACG_LastExp = Class(name="ACG_LastExp")
ACG_IfExp = Class(name="ACG_IfExp")
ACG_OperatorCallExp = Class(name="ACG_OperatorCallExp")
OperationCallExp = Class(name="OperationCallExp")
ACG_LiteralExp = Class(name="ACG_LiteralExp", is_abstract=True)
ACG_OclUndefinedExp = Class(name="ACG_OclUndefinedExp")
LiteralExp = Class(name="LiteralExp")
ACG_CollectionExp = Class(name="ACG_CollectionExp", is_abstract=True)
ACG_SequenceExp = Class(name="ACG_SequenceExp")
CollectionExp = Class(name="CollectionExp")
ACG_BooleanExp = Class(name="ACG_BooleanExp")
ACG_IntegerExp = Class(name="ACG_IntegerExp")
ACG_StringExp = Class(name="ACG_StringExp")
...
ACG_LocatedElement.attributes={ACG_LocatedElement_location, ACG_LocatedElement_commentsAfter, ACG_LocatedElement_commentsBefore}
...
ACG_Node.attributes={ACG_Node_mode, ACG_Node_element}
...
elements0: BinaryAssociation = BinaryAssociation(
    name="elements0",
    ends={
        Property(name="ACGElement", type=ACG_ACG, multiplicity=Multiplicity(1, 1)),
        Property(name="acg", type=ACGElement, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
acg1: BinaryAssociation = BinaryAssociation(
    name="acg1",
    ends={
        Property(name="ACG", type=ACG_ACGElement, multiplicity=Multiplicity(1, 1)),
        Property(name="elements", type=ACG, multiplicity=Multiplicity(1, 1))
    }
)
...
body3: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="ACG_Function4", type=Expression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
body5: BinaryAssociation = BinaryAssociation(
    name="body5",
    ends={
        Property(name="Expression6", type=ACG_Attribute, multiplicity=Multiplicity(1, 1)),
        Property(name="ACG_Attribute", type=Expression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
guard7: BinaryAssociation = BinaryAssociation(
    name="guard7",
    ends={
        Property(name="Expression8", type=ACG_Node, multiplicity=Multiplicity(1, 1)),
...
name9: BinaryAssociation = BinaryAssociation(
    name="name9",
    ends={
        Property(name="Expression10", type=ACG_ASMNode, multiplicity=Multiplicity(1, 1)),
...
collection13: BinaryAssociation = BinaryAssociation(
    name="collection13",
    ends={
        Property(name="Expression15", type=ACG_ForEachStat, multiplicity=Multiplicity(1, 1)),
        Property(name="ACG_ForEachStat14", type=Expression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
definition16: BinaryAssociation = BinaryAssociation(
    name="definition16",
    ends={
        Property(name="Expression17", type=ACG_VariableStat, multiplicity=Multiplicity(1, 1)),
...
name18: BinaryAssociation = BinaryAssociation(
    name="name18",
    ends={
        Property(name="Expression20", type=ACG_VariableStat, multiplicity=Multiplicity(1, 1)),
        Property(name="ACG_VariableStat19", type=Expression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
context21: BinaryAssociation = BinaryAssociation(
    name="context21",
    ends={
        Property(name="Expression22", type=ACG_OperationStat, multiplicity=Multiplicity(1, 1)),
...
name23: BinaryAssociation = BinaryAssociation(
    name="name23",
    ends={
        Property(name="Expression25", type=ACG_OperationStat, multiplicity=Multiplicity(1, 1)),
        Property(name="ACG_OperationStat24", type=Expression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
condition26: BinaryAssociation = BinaryAssociation(
    name="condition26",
    ends={
        Property(name="Expression27", type=ACG_ConditionalStat, multiplicity=Multiplicity(1, 1)),
        Property(name="ACG_ConditionalStat", type=Expression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
elseStatements28: BinaryAssociation = BinaryAssociation(
    name="elseStatements28",
    ends={
        Property(name="Statement30", type=ACG_ConditionalStat, multiplicity=Multiplicity(1, 1)),
        Property(name="ACG_ConditionalStat29", type=Statement, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
value33: BinaryAssociation = BinaryAssociation(
    name="value33",
    ends={
        Property(name="ACG_LetStat34", type=Expression, multiplicity=Multiplicity(1, 1), is_composite=True),
        Property(name="Expression35", type=ACG_LetStat, multiplicity=Multiplicity(1, 1))
    }
)
target36: BinaryAssociation = BinaryAssociation(
    name="target36",
    ends={
        Property(name="Expression37", type=ACG_AnalyzeStat, multiplicity=Multiplicity(1, 1)),
        Property(name="ACG_AnalyzeStat", type=Expression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
message38: BinaryAssociation = BinaryAssociation(
    name="message38",
    ends={
        Property(name="Expression39", type=ACG_ReportStat, multiplicity=Multiplicity(1, 1)),
        Property(name="ACG_ReportStat", type=Expression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
name40: BinaryAssociation = BinaryAssociation(
    name="name40",
    ends={
        Property(name="Expression41", type=ACG_FieldStat, multiplicity=Multiplicity(1, 1)),
...
type42: BinaryAssociation = BinaryAssociation(
    name="type42",
    ends={
        Property(name="Expression44", type=ACG_FieldStat, multiplicity=Multiplicity(1, 1)),
        Property(name="ACG_FieldStat43", type=Expression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
name45: BinaryAssociation = BinaryAssociation(
    name="name45",
    ends={
        Property(name="Expression46", type=ACG_ParamStat, multiplicity=Multiplicity(1, 1)),
...
type47: BinaryAssociation = BinaryAssociation(
    name="type47",
    ends={
        Property(name="Expression49", type=ACG_ParamStat, multiplicity=Multiplicity(1, 1)),
        Property(name="ACG_ParamStat48", type=Expression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
id50: BinaryAssociation = BinaryAssociation(
    name="id50",
    ends={
        Property(name="Expression51", type=ACG_LabelStat, multiplicity=Multiplicity(1, 1)),
...
variable31: BinaryAssociation = BinaryAssociation(
    name="variable31",
    ends={
        Property(name="VariableDecl32", type=ACG_LetStat, multiplicity=Multiplicity(1, 1)),
...
operand52: BinaryAssociation = BinaryAssociation(
    name="operand52",
    ends={
        Property(name="Expression53", type=ACG_EmitWithOperandStat, multiplicity=Multiplicity(1, 1)),
        Property(name="ACG_EmitWithOperandStat", type=Expression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
label54: BinaryAssociation = BinaryAssociation(
    name="label54",
    ends={
...
variable55: BinaryAssociation = BinaryAssociation(
    name="variable55",
    ends={
        Property(name="VariableDecl56", type=ACG_VariableExp, multiplicity=Multiplicity(1, 1)),
...
condition57: BinaryAssociation = BinaryAssociation(
    name="condition57",
    ends={
        Property(name="Expression58", type=ACG_IfExp, multiplicity=Multiplicity(1, 1)),
        Property(name="ACG_IfExp", type=Expression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
thenExp59: BinaryAssociation = BinaryAssociation(
    name="thenExp59",
    ends={
        Property(name="Expression61", type=ACG_IfExp, multiplicity=Multiplicity(1, 1)),
        Property(name="ACG_IfExp60", type=Expression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
elseExp62: BinaryAssociation = BinaryAssociation(
    name="elseExp62",
    ends={
        Property(name="Expression64", type=ACG_IfExp, multiplicity=Multiplicity(1, 1)),
        Property(name="ACG_IfExp63", type=Expression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
source65: BinaryAssociation = BinaryAssociation(
    name="source65",
    ends={
        Property(name="Expression66", type=ACG_IsAExp, multiplicity=Multiplicity(1, 1)),
...
variable67: BinaryAssociation = BinaryAssociation(
    name="variable67",
    ends={
        Property(name="VariableDecl68", type=ACG_LetExp, multiplicity=Multiplicity(1, 1)),
...
value69: BinaryAssociation = BinaryAssociation(
    name="value69",
    ends={
        Property(name="Expression71", type=ACG_LetExp, multiplicity=Multiplicity(1, 1)),
        Property(name="ACG_LetExp70", type=Expression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
in_72: BinaryAssociation = BinaryAssociation(
    name="in_72",
    ends={
        Property(name="Expression74", type=ACG_LetExp, multiplicity=Multiplicity(1, 1)),
        Property(name="ACG_LetExp73", type=Expression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
source75: BinaryAssociation = BinaryAssociation(
    name="source75",
    ends={
        Property(name="Expression76", type=ACG_PropertyCallExp, multiplicity=Multiplicity(1, 1)),
...
iterator77: BinaryAssociation = BinaryAssociation(
    name="iterator77",
    ends={
        Property(name="VariableDecl78", type=ACG_IteratorExp, multiplicity=Multiplicity(1, 1)),
        Property(name="ACG_IteratorExp", type=VariableDecl, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
body79: BinaryAssociation = BinaryAssociation(
    name="body79",
    ends={
        Property(name="Expression81", type=ACG_IteratorExp, multiplicity=Multiplicity(1, 1)),
        Property(name="ACG_IteratorExp80", type=Expression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
elements84: BinaryAssociation = BinaryAssociation(
    name="elements84",
    ends={
        Property(name="Expression85", type=ACG_CollectionExp, multiplicity=Multiplicity(1, 1)),
...
arguments82: BinaryAssociation = BinaryAssociation(
    name="arguments82",
    ends={
        Property(name="Expression83", type=ACG_OperationCallExp, multiplicity=Multiplicity(1, 1)),
...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={ACG_LocatedElement, ACG_ACG, LocatedElement, ACGElement, ACG_ACGElement, ACG, ACG_Function, Parameter_, Expression, ACG_Attribute, ACG_Parameter, VariableDecl, ACG_Node, ACG_ASMNode, Node, ACG_CodeNode, ACG_SimpleNode, ACG_StatementBlock, Statement, ACG_Statement, ACG_CompoundStat, ACG_ForEachStat, CompoundStat, ACG_OnceStat, ACG_VariableStat, ACG_OperationStat, ACG_ConditionalStat, StatementBlock, ACG_AnalyzeStat, ACG_ReportStat, ACG_FieldStat, ACG_ParamStat, ACG_EmitStat, ACG_LabelStat, EmitStat, ACG_NewStat, ACG_NewinStat, ACG_DeleteStat, ACG_DupStat, ACG_LetStat, ACG_DupX1Stat, ACG_SwapStat, ACG_IterateStat, ACG_EndIterateStat, ACG_GetAsmStat, ACG_FindMEStat, ACG_PushTStat, ACG_PushFStat, ACG_EmitWithOperandStat, ACG_PushStat, EmitWithOperandStat, ACG_PushIStat, ACG_PushDStat, ACG_LoadStat, ACG_StoreStat, ACG_CallStat, ACG_PCallStat, ACG_SuperCallStat, ACG_GetStat, ACG_SetStat, ACG_EmitWithLabelRefStat, LabelStat, ACG_IfStat, EmitWithLabelRefStat, ACG_GotoStat, ACG_VariableDecl, ACG_Expression, ACG_VariableExp, ACG_SelfExp, ACG_PopStat, ACG_IsAExp, ACG_LetExp, ACG_PropertyCallExp, ACG_NavigationExp, PropertyCallExp, ACG_IteratorExp, ACG_OperationCallExp, ACG_LastExp, ACG_IfExp, ACG_OperatorCallExp, OperationCallExp, ACG_LiteralExp, ACG_OclUndefinedExp, LiteralExp, ACG_CollectionExp, ACG_SequenceExp, CollectionExp, ACG_BooleanExp, ACG_IntegerExp, ACG_StringExp, Severity},
    associations={elements0, acg1, parameters2, body3, body5, guard7, name9, statements11, iterator12, collection13, definition16, name18, context21, name23, condition26, elseStatements28, value33, target36, message38, name40, type42, name45, type47, id50, variable31, operand52, label54, variable55, condition57, thenExp59, elseExp62, source65, variable67, value69, in_72, source75, iterator77, body79, elements84, arguments82},
    generalizations={gen_ACG_ACG_LocatedElement, gen_ACG_ACGElement_LocatedElement, gen_ACG_Function_ACGElement, gen_ACG_Attribute_ACGElement, gen_ACG_Parameter_VariableDecl, gen_ACG_Node_ACGElement, gen_ACG_ASMNode_Node, gen_ACG_CodeNode_Node, gen_ACG_SimpleNode_Node, gen_ACG_StatementBlock_LocatedElement, gen_ACG_Statement_LocatedElement, gen_ACG_CompoundStat_Statement, gen_ACG_CompoundStat_StatementBlock, gen_ACG_ForEachStat_CompoundStat, gen_ACG_OnceStat_CompoundStat, gen_ACG_VariableStat_CompoundStat, gen_ACG_OperationStat_CompoundStat, gen_ACG_ConditionalStat_CompoundStat, gen_ACG_Node_StatementBlock, gen_ACG_AnalyzeStat_CompoundStat, gen_ACG_ReportStat_Statement, gen_ACG_FieldStat_Statement, gen_ACG_ParamStat_Statement, gen_ACG_EmitStat_Statement, gen_ACG_LabelStat_EmitStat, gen_ACG_NewStat_EmitStat, gen_ACG_NewinStat_EmitStat, gen_ACG_DeleteStat_EmitStat, gen_ACG_DupStat_EmitStat, gen_ACG_LetStat_CompoundStat, gen_ACG_SwapStat_EmitStat, gen_ACG_IterateStat_EmitStat, gen_ACG_EndIterateStat_EmitStat, gen_ACG_GetAsmStat_EmitStat, gen_ACG_FindMEStat_EmitStat, gen_ACG_PushTStat_EmitStat, gen_ACG_PushFStat_EmitStat, gen_ACG_EmitWithOperandStat_EmitStat, gen_ACG_PushStat_EmitWithOperandStat, gen_ACG_PushIStat_EmitWithOperandStat, gen_ACG_PushDStat_EmitWithOperandStat, gen_ACG_LoadStat_EmitWithOperandStat, gen_ACG_StoreStat_EmitWithOperandStat, gen_ACG_CallStat_EmitWithOperandStat, gen_ACG_PCallStat_EmitWithOperandStat, gen_ACG_SuperCallStat_EmitWithOperandStat, gen_ACG_GetStat_EmitWithOperandStat, gen_ACG_SetStat_EmitWithOperandStat, gen_ACG_EmitWithLabelRefStat_EmitStat, gen_ACG_IfStat_EmitWithLabelRefStat, gen_ACG_GotoStat_EmitWithLabelRefStat, gen_ACG_VariableDecl_LocatedElement, gen_ACG_Expression_LocatedElement, gen_ACG_VariableExp_Expression, gen_ACG_DupX1Stat_EmitStat, gen_ACG_PopStat_EmitStat, gen_ACG_IsAExp_Expression, gen_ACG_LetExp_Expression, gen_ACG_PropertyCallExp_Expression, gen_ACG_NavigationExp_PropertyCallExp, gen_ACG_IteratorExp_PropertyCallExp, gen_ACG_SelfExp_Expression, gen_ACG_OperationCallExp_PropertyCallExp, gen_ACG_LastExp_Expression, gen_ACG_IfExp_Expression, gen_ACG_OperatorCallExp_OperationCallExp, gen_ACG_LiteralExp_Expression, gen_ACG_OclUndefinedExp_LiteralExp, gen_ACG_CollectionExp_LiteralExp, gen_ACG_SequenceExp_CollectionExp, gen_ACG_BooleanExp_LiteralExp, gen_ACG_IntegerExp_LiteralExp, gen_ACG_StringExp_LiteralExp},
    metadata=None
)
