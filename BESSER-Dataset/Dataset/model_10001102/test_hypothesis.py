...
def test_shoppingcart_has_UpdateCartDetails():
    assert hasattr(ShoppingCart, "UpdateCartDetails")
    descriptor = None
    for klass in ShoppingCart.__mro__:
        if "UpdateCartDetails" in klass.__dict__:
            descriptor = klass.__dict__["UpdateCartDetails"]
            break
    assert isinstance(descriptor, property)
...
def test_shoppingcart_has_Addcartitem():
    assert hasattr(ShoppingCart, "Addcartitem")
    descriptor = None
    for klass in ShoppingCart.__mro__:
        if "Addcartitem" in klass.__dict__:
            descriptor = klass.__dict__["Addcartitem"]
            break
    assert isinstance(descriptor, property)
...
@given(instance=ShoppingCart_strategy)
def test_shoppingcart_UpdateCartDetails_setter(instance):
...
@given(instance=ShoppingCart_strategy)
def test_shoppingcart_Addcartitem_setter(instance):
