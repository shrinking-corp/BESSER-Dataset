...
ShoppingCart_Addcartitem: Property = Property(name="Addcartitem", type=StringType)
ShoppingCart_UpdateCartDetails: Property = Property(name="UpdateCartDetails", type=StringType)
ShoppingCart.attributes={ShoppingCart_Addcartitem, ShoppingCart_creationDate, ShoppingCart_UpdateCartDetails}
...
Account.attributes={Account_billingAddress, Account_isClosed, Account_open, Account_closed}
...
Order.attributes={Order_number, Order_status, Order_shipTo, Order_total, Order_shipped, Order_ordered}
...
domain_model = DomainModel(
    name="_8578be50_e9f0_421f_ab9f_9ac689563c9f",
    types={Customer, Payment, ShoppingCart, Account, WebUser, Order, LineItem, Product, Actor_Actor, UserState, OrderStatus},
