...
# Classes
type_AnyType = Class(name="type_AnyType")
type_ProcessingInstruction = Class(name="type_ProcessingInstruction")
type_XMLTypeDocumentRoot = Class(name="type_XMLTypeDocumentRoot")
type_EStringToStringMapEntry = Class(name="type_EStringToStringMapEntry")
type_SimpleAnyType = Class(name="type_SimpleAnyType")
AnyType = Class(name="AnyType")
type_EDataType = Class(name="type_EDataType")
...
type_XMLTypeDocumentRoot.attributes={type_XMLTypeDocumentRoot_mixed, type_XMLTypeDocumentRoot_comment, type_XMLTypeDocumentRoot_text, type_XMLTypeDocumentRoot_cDATA}
...
domain_model = DomainModel(
    name="type",
    types={type_AnyType, type_ProcessingInstruction, type_XMLTypeDocumentRoot, type_EStringToStringMapEntry, type_SimpleAnyType, AnyType, type_EDataType},
    associations={xMLNSPrefixMap1, xSISchemaLocation2, instanceType0, processingInstruction5},
