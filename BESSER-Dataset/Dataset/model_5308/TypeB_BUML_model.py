...
# Classes
typeB_DefinitionB = Class(name="typeB_DefinitionB")
typeB_RootB = Class(name="typeB_RootB")
typeB_ElementB = Class(name="typeB_ElementB")
...
domain_model = DomainModel(
    name="typeB",
    types={typeB_DefinitionB, typeB_RootB, typeB_ElementB},
