...
class emfdb_A:
    ...
    def __init__(self, strings: str, primitiveValues: float, notUniqueValues: float, string: str, emfdb_A: set["emfdb_B"] = None, emfdb_A2: set["emfdb_C"] = None):
...
class emfdb_B:
    ...
    def __init__(self, string: str, emfdb_B4: "emfdb_D" = None, emfdb_B: "emfdb_A" = None):
        self.string = string
