...
def test_hyp_emfdb_a_notUniqueValues_setter(instance):
...
@given(instance=emfdb_A_strategy)
def test_hyp_emfdb_a_primitiveValues_setter(instance):
...
@given(instance=emfdb_A_strategy)
def test_hyp_emfdb_a_strings_setter(instance):
...
def test_emfdb_A_notUniqueValues_value_roundtrip():
    instance = emfdb_A(notUniqueValues=3.14, primitiveValues=3.14, string="sample_text", strings="sample_text")
    assert instance.notUniqueValues == 3.14
    instance.notUniqueValues = 9.99
    assert instance.notUniqueValues == 9.99


def test_emfdb_A_primitiveValues_value_roundtrip():
    instance = emfdb_A(notUniqueValues=3.14, primitiveValues=3.14, string="sample_text", strings="sample_text")
    assert instance.primitiveValues == 3.14
    instance.primitiveValues = 9.99
    assert instance.primitiveValues == 9.99
...
def test_emfdb_A_strings_value_roundtrip():
    instance = emfdb_A(notUniqueValues=3.14, primitiveValues=3.14, string="sample_text", strings="sample_text")
...
def test_assoc_blist0_link_reassign_clear():
    ...
    b1 = emfdb_A(notUniqueValues=3.14, primitiveValues=3.14, string="sample_text", strings="sample_text")
    b2 = emfdb_A(notUniqueValues=9.99, primitiveValues=9.99, string="sample_text_2", strings="sample_text_2")
...
emfdb_A_strategy = st.builds(emfdb_A, notUniqueValues=st.floats(allow_nan=False, allow_infinity=False), primitiveValues=st.floats(allow_nan=False, allow_infinity=False), string=safe_text, strings=safe_text)
@given(instance=emfdb_A_strategy)
