...
# Classes
emfdb_D = Class(name="emfdb_D")
emfdb_E = Class(name="emfdb_E")
emfdb_A = Class(name="emfdb_A")
emfdb_B = Class(name="emfdb_B")
emfdb_C = Class(name="emfdb_C")
...
emfdb_A.attributes={emfdb_A_strings, emfdb_A_string, emfdb_A_notUniqueValues, emfdb_A_primitiveValues}
...
domain_model = DomainModel(
    name="emfdb",
    types={emfdb_D, emfdb_E, emfdb_A, emfdb_B, emfdb_C},
    associations={d3, elist5, blist0, cmap1},
    generalizations={},
    metadata=None
)
