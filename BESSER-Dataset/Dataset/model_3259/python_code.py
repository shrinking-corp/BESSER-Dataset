...
class iso20022_MessageAttribute(MessageElement):
    ...
    def MessageAttributeHasExactlyOneType(self, iso20022_diagnostics, iso20022_context) :
...
class iso20022_BusinessAttribute(BusinessElement):
    ...
    def BusinessAttributeHasExactlyOneType(self, iso20022_context, iso20022_diagnostics) :
        # TODO: Implement BusinessAttributeHasExactlyOneType method
        pass

    def NoDerivingCodeSetType(self, iso20022_diagnostics, iso20022_context) :
...
class iso20022_BusinessAssociationEnd(BusinessElement):
    ...
    def __init__(self, aggregation: str, iso20022_BusinessAssociationEnd: "iso20022_BusinessAssociationEnd" = None, iso20022_BusinessAssociationEnd112: "iso20022_BusinessAssociationEnd" = None, associationDomain: "iso20022_BusinessComponent" = None, BusinessAssociationEnd: "iso20022_BusinessComponent" = None):
    ...
    def AtMostOneAggregatedEnd(self, iso20022_diagnostics, iso20022_context) :
...
class TopLevelDictionaryEntry:
    ...
    pass
class iso20022_DataType(TopLevelDictionaryEntry, BusinessElementType, LogicalType):
...
class iso20022_MessageElement(MessageConcept, MessageConstruct):
    ...
    def __init__(self, isTechnical: bool, isDerived: bool, MessageElement117: "iso20022_MessageElementContainer" = None, derivationElement: "iso20022_BusinessComponent" = None, derivation85: "iso20022_BusinessElement" = None, messageElement: "iso20022_MessageElementContainer" = None, iso20022_MessageElement: "iso20022_Xor" = None, MessageElement: "iso20022_BusinessComponent" = None, MessageElement101: "iso20022_BusinessElement" = None):
        self.isTechnical = isTechnical
    ...
    def NoMoreThanOneTrace(self, iso20022_diagnostics, iso20022_context) :
...
class iso20022_MessageElementContainer(MessageComponentType):
    ...
    def __init__(self, componentContext: set["iso20022_MessageElement"] = None, MessageElementContainer: "iso20022_MessageElement" = None, iso20022_MessageElementContainer: "iso20022_EndPointCategory" = None):
    ...
    def technicalElement(self, iso20022_diagnostics, iso20022_context) :
...
class iso20022_BusinessComponent(BusinessConcept, TopLevelDictionaryEntry, BusinessElementType):
    ...
    def __init__(self, BusinessComponent115: "iso20022_BusinessAssociationEnd" = None, BusinessComponent: "iso20022_MessageElement" = None, BusinessComponent91: "iso20022_BusinessComponent" = None, superType: set["iso20022_BusinessComponent"] = None, BusinessComponent94: "iso20022_BusinessComponent" = None, subType: "iso20022_BusinessComponent" = None, elementContext: set["iso20022_BusinessElement"] = None, trace: set["iso20022_MessageComponentType"] = None, type: set["iso20022_BusinessAssociationEnd"] = None, BusinessComponent107: "iso20022_MessageComponentType" = None, businessComponentTrace: set["iso20022_MessageElement"] = None, BusinessComponent104: "iso20022_BusinessElement" = None, iso20022_BusinessComponent: "iso20022_BusinessAttribute" = None):
...
class iso20022_MessageTransmission(RepositoryConcept):
    ...
    def __init__(self, messageTypeDescription: str, MessageTransmission: "iso20022_MessageDefinition" = None, trace175: set["iso20022_MessageDefinition"] = None, messageTransmission: "iso20022_Send" = None, messageTransmission180: set["iso20022_Receive"] = None, MessageTransmission185: "iso20022_Send" = None, MessageTransmission128: "iso20022_BusinessTransaction" = None, MessageTransmission169: "iso20022_Receive" = None, transmission: "iso20022_BusinessTransaction" = None):
...
class iso20022_BusinessTransaction(TopLevelCatalogueEntry):
    ...
    def __init__(self, BusinessTransaction187: "iso20022_MessageTransportMode" = None, businessTransaction127: set["iso20022_MessageTransmission"] = None, businessTransaction130: "iso20022_MessageTransportMode" = None, BusinessTransaction133: "iso20022_BusinessTransaction" = None, parentTransaction: set["iso20022_BusinessTransaction"] = None, BusinessTransaction136: "iso20022_BusinessTransaction" = None, subTransaction: "iso20022_BusinessTransaction" = None, businessTransactionTrace: set["iso20022_MessageChoreography"] = None, BusinessTransaction: "iso20022_MessageChoreography" = None, businessProcessTrace: "iso20022_BusinessProcess" = None, businessTransaction: set["iso20022_Participant"] = None, BusinessTransaction173: "iso20022_MessageTransmission" = None, BusinessTransaction154: "iso20022_BusinessProcess" = None, BusinessTransaction160: "iso20022_Participant" = None):
...
class iso20022_MessageTransportMode(TopLevelCatalogueEntry):
    ...
    def __init__(self, messageDeliveryWindow: str, messageSendingWindow: str, deliveryAssurance: str, durability: str, messageCasting: str, messageDeliveryOrder: str, messageValidationLevel: str, messageValidationOnOff: str, messageValidationResults: str, receiverAsynchronicity: str, senderAsynchronicity: str, boundedCommunicationDelay: str, maximumClockVariation: str, maximumMessageSize: str, messageTransportMode: set["iso20022_BusinessTransaction"] = None, MessageTransportMode: "iso20022_BusinessTransaction" = None):
...
class iso20022_MessageSet(TopLevelCatalogueEntry):
    ...
    def __init__(self, MessageSet: "iso20022_MessageDefinition" = None, messageSet63: set["iso20022_MessageDefinition"] = None, MessageSet68: "iso20022_Syntax" = None, MessageSet70: "iso20022_Encoding" = None, generatedFor: set["iso20022_Syntax"] = None, messageSet: set["iso20022_Encoding"] = None):
...
class iso20022_Syntax(ModelEntity):
    ...
    def GeneratedForDerivation(self, iso20022_diagnostics, iso20022_context) :
...
class iso20022_MessageDefinitionIdentifier(ModelEntity):
    ...
    def __init__(self, messageFunctionality: str, flavour: str, version: str, businessArea: str, iso20022_MessageDefinitionIdentifier: "iso20022_MessageDefinition" = None):
...
class iso20022_RepositoryConcept(ModelEntity):
    ...
    def __init__(self, name: str, definition: str, example: str, registrationStatus: str, removalDate: date, RepositoryConcept: "iso20022_Constraint" = None, iso20022_RepositoryConcept: set["iso20022_SemanticMarkup"] = None, iso20022_RepositoryConcept29: set["iso20022_Doclet"] = None, owner: set["iso20022_Constraint"] = None):
        self.name = name
    ...
    def NameFirstLetterUppercase(self, iso20022_diagnostics, iso20022_context) :
        # TODO: Implement NameFirstLetterUppercase method
        pass

class iso20022_BusinessProcessCatalogue(ModelEntity):

    def __init__(self, businessProcessCatalogue: "iso20022_Repository" = None, businessProcessCatalogue36: set["iso20022_TopLevelCatalogueEntry"] = None, BusinessProcessCatalogue40: "iso20022_Repository" = None, BusinessProcessCatalogue: "iso20022_TopLevelCatalogueEntry" = None):
...
class iso20022_CodeSet(String):
    ...
    def __init__(self, identificationScheme: str, CodeSet: "iso20022_Code" = None, CodeSet202: "iso20022_CodeSet" = None, derivation201: "iso20022_CodeSet" = None, CodeSet206: "iso20022_CodeSet" = None, trace205: set["iso20022_CodeSet"] = None, owner208: set["iso20022_Code"] = None):
