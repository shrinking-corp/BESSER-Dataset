...
public class iso20022_MessageDefinition extends RepositoryType {
    ...
    public iso20022_MessageDefinition(
        String xmlName,        String xmlTag,        String rootElement    ) {
        super(
        );
    ...
    public iso20022_MessageDefinition(
        String xmlName,        String xmlTag,        String rootElement        ArrayList<iso20022_SyntaxMessageScheme> iso20022_syntaxmessageschemes,        ArrayList<iso20022_MessageChoreography> iso20022_messagechoreographys,        ArrayList<iso20022_MessageSet> iso20022_messagesets    ) {
        this.xmlName = xmlName;
        this.xmlTag = xmlTag;
        this.rootElement = rootElement;
