...
class Native_App_AccountType(Enum):
    pass
class WmMediaPager_Mini_App_TransactionType(Enum):
    pass
...
class Customer:
    ...
    def __init__(self, name: str, dateOfBirth: date, address: str, phoneNumber: str, emailAddress: str, a1: set["Native_App_Activity___ViewController___WmMediaPagerEvents"] = None, login4: "Login" = None):
        self.name = name
...
class Native_App_Activity___ViewController___WmMediaPagerEvents:

    def __init__(self, accountNo: str, type: Native_App_AccountType, balance: float, customer0: "Customer" = None, transactions2: set["WmMediaPager_Mini_App_WmMediaPager"] = None):
    ...
    def type(self):
        return self.__type
    @type.setter
    def type(self, type: Native_App_AccountType):
        self.__type = type
    ...
    def customer0(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Native_App_Activity___ViewController___WmMediaPagerEvents__customer0", None)
    ...
    def transactions2(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Native_App_Activity___ViewController___WmMediaPagerEvents__transactions2", None)
...
class Native_App_CheckingAccount:
...
class Native_App_CertificatesOfDepositAccount:
...
class Native_App_SavingsAccount:
...
class WmMediaPager_Mini_App_WmMediaPagerEvents:

    def __init__(self, id: int, type: WmMediaPager_Mini_App_TransactionType, transactionTime: date, amount: float):
        self.id = id
        self.type = type
    ...
    def type(self):
        return self.__type
    @type.setter
    def type(self, type: WmMediaPager_Mini_App_TransactionType):
        self.__type = type



class WmMediaPager_Mini_App_TransferTransaction:

    def __init__(self, targetAccount: Native_App_Activity___ViewController___WmMediaPagerEvents, sourceAccount: Native_App_Activity___ViewController___WmMediaPagerEvents):
    ...
    def sourceAccount(self, sourceAccount: Native_App_Activity___ViewController___WmMediaPagerEvents):
    ...
    def targetAccount(self, targetAccount: Native_App_Activity___ViewController___WmMediaPagerEvents):
        self.__targetAccount = targetAccount



class WmMediaPager_Mini_App_WithdrawTransaction:

    pass


class WmMediaPager_Mini_App_DepositTransaction:

    pass


class WmMediaPager_Mini_App_WmMediaPager:

    def __init__(self, id: int, type: WmMediaPager_Mini_App_TransactionType, transactionTime: date, amount: float, account3: "Native_App_Activity___ViewController___WmMediaPagerEvents" = None):
        self.id = id
        self.type = type
        self.transactionTime = transactionTime
        self.amount = amount
    ...
    def account3(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_WmMediaPager_Mini_App_WmMediaPager__account3", None)
