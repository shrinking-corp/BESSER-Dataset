...
# Classes
iritptn_PetriNet = Class(name="iritptn_PetriNet")
iritptn_Node = Class(name="iritptn_Node")
iritptn_Arc = Class(name="iritptn_Arc")
iritptn_Transition = Class(name="iritptn_Transition")
Node = Class(name="Node")
iritptn_Place = Class(name="iritptn_Place")
...
domain_model = DomainModel(
    name="iritptn",
    types={iritptn_PetriNet, iritptn_Node, iritptn_Arc, iritptn_Transition, Node, iritptn_Place, ArcKind},
    associations={nodes0, arc1, source12, ingoings3, outgoings5, net7, target8, net10},
    generalizations={gen_iritptn_Transition_Node, gen_iritptn_Place_Node},
    metadata=None
)
