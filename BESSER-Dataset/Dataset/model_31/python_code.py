...
class iritptn_Arc:
    ...
    def __init__(self, weight: int, kind: str, Arc: "iritptn_PetriNet" = None, outgoings: "iritptn_Node" = None, Arc4: "iritptn_Node" = None, Arc6: "iritptn_Node" = None, ingoings: "iritptn_Node" = None, arc: "iritptn_PetriNet" = None):
        self.weight = weight
        self.kind = kind
        self.Arc = Arc
...
class iritptn_Node:
    ...
    def __init__(self, name: str, Node: "iritptn_PetriNet" = None, Node13: "iritptn_Arc" = None, target: set["iritptn_Arc"] = None, source: set["iritptn_Arc"] = None, nodes: "iritptn_PetriNet" = None, Node9: "iritptn_Arc" = None):
        self.name = name
        self.Node = Node
        self.Node13 = Node13
...
class iritptn_PetriNet:
    ...
    def __init__(self, name: str, net: set["iritptn_Node"] = None, net2: set["iritptn_Arc"] = None, PetriNet: "iritptn_Node" = None, PetriNet11: "iritptn_Arc" = None):
        self.name = name
