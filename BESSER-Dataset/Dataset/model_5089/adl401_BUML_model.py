...
# Classes
adl401_Interface = Class(name="adl401_Interface", is_abstract=True)
adl401_Content = Class(name="adl401_Content")
adl401_Component = Class(name="adl401_Component")
adl401_EClass0 = Class(name="adl401_EClass0")
adl401_Required = Class(name="adl401_Required")
Interface = Class(name="Interface")
adl401_Provided = Class(name="adl401_Provided")
adl401_Binding = Class(name="adl401_Binding")
...
adl401_Content.attributes={adl401_Content_language, adl401_Content_expression}
...
domain_model = DomainModel(
    name="adl401",
    types={adl401_Interface, adl401_Content, adl401_Component, adl401_EClass0, adl401_Required, Interface, adl401_Provided, adl401_Binding},
    associations={from_1, to4, contentParent7, EReference08, bindings0, erefs017, subComponents10, requiredInterfaces11, providedInterfaces13, content15},
