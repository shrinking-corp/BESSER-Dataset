...
class di_View(ABC):
    ...
    def __init__(self, id: str, context: str, definition: str, sourceConnector: str, targetConnector: str, di_View: "di_DocumentRoot" = None, di_View23: set["di_Style"] = None, di_View26: set["di_Node"] = None):
        self.id = id
...
class di_DocumentRoot:
    ...
    def __init__(self, mixed: str, di_DocumentRoot: set["di_EStringToStringMapEntry"] = None, di_DocumentRoot14: set["di_View"] = None, di_DocumentRoot5: set["di_EStringToStringMapEntry"] = None, di_DocumentRoot8: set["di_Bendpoint"] = None, di_DocumentRoot11: set["di_Connector"] = None, di_DocumentRoot16: set["di_Diagram"] = None, di_DocumentRoot19: set["di_Node"] = None, di_DocumentRoot21: set["di_Style"] = None):
        self.mixed = mixed
...
class di_Connector(View):
    ...
    def __init__(self, source: str, target: str, di_Connector: set["di_Bendpoint"] = None, di_Connector2: "di_Diagram" = None, di_Connector12: "di_DocumentRoot" = None):
        self.source = source
        self.target = target
