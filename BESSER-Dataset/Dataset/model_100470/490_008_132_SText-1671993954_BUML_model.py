...
stext_Parameter = Class(name="stext_Parameter")
...
stext_Feature = Class(name="stext_Feature")
stext_TypedElementReferenceExpression = Class(name="stext_TypedElementReferenceExpression")
stext_NamedElement = Class(name="stext_NamedElement")
...
# stext_Parameter class attributes and methods
...
stext_TimeEventSpec.attributes={stext_TimeEventSpec_type, stext_TimeEventSpec_value, stext_TimeEventSpec_unit}
...
# stext_Feature class attributes and methods

# stext_TypedElementReferenceExpression class attributes and methods

# stext_NamedElement class attributes and methods
...
definitionScopes4: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="stext_StatechartScope", type=stext_StatechartSpecification, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_StatechartSpecification5", type=stext_StatechartScope, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
reaction8: BinaryAssociation = BinaryAssociation(
    name="reaction8",
    ends={
        Property(name="stext_TransitionReaction", type=stext_TransitionSpecification, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_TransitionSpecification9", type=stext_TransitionReaction, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
derivation10: BinaryAssociation = BinaryAssociation(
    name="derivation10",
    ends={
        Property(name="stext_EventDerivation", type=stext_EventDefinition, multiplicity=Multiplicity(1, 1)),
...
condition11: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="stext_EventDerivation12", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
value13: BinaryAssociation = BinaryAssociation(
    name="value13",
    ends={
        Property(name="stext_Expression15", type=stext_EventDerivation, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_EventDerivation14", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
initialValue16: BinaryAssociation = BinaryAssociation(
    name="initialValue16",
    ends={
        Property(name="stext_Expression17", type=stext_VariableDefinition, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_VariableDefinition", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
params18: BinaryAssociation = BinaryAssociation(
    name="params18",
    ends={
        Property(name="stext_Parameter", type=stext_OperationDefinition, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_OperationDefinition", type=stext_Parameter, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
properties23: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="stext_ReactionProperties24", type=stext_ReactionProperty, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
entrypoint25: BinaryAssociation = BinaryAssociation(
    name="entrypoint25",
    ends={
...
exitpoint26: BinaryAssociation = BinaryAssociation(
    name="exitpoint26",
    ends={
...
event27: BinaryAssociation = BinaryAssociation(
    name="event27",
    ends={
        Property(name="stext_Expression28", type=stext_RegularEventSpec, multiplicity=Multiplicity(1, 1)),
...
properties20: BinaryAssociation = BinaryAssociation(
    name="properties20",
    ends={
        Property(name="stext_ReactionProperties22", type=stext_TransitionReaction, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_TransitionReaction21", type=stext_ReactionProperties, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
triggers29: BinaryAssociation = BinaryAssociation(
    name="triggers29",
    ends={
...
guardExpression30: BinaryAssociation = BinaryAssociation(
    name="guardExpression30",
    ends={
        Property(name="stext_Expression32", type=stext_ReactionTrigger, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_ReactionTrigger31", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
actions33: BinaryAssociation = BinaryAssociation(
    name="actions33",
    ends={
        Property(name="stext_Expression34", type=stext_ReactionEffect, multiplicity=Multiplicity(1, 1)),
...
event35: BinaryAssociation = BinaryAssociation(
    name="event35",
    ends={
        Property(name="stext_Expression36", type=stext_EventRaisingExpression, multiplicity=Multiplicity(1, 1)),
...
value37: BinaryAssociation = BinaryAssociation(
    name="value37",
    ends={
        Property(name="stext_Expression39", type=stext_EventRaisingExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_EventRaisingExpression38", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
varRef40: BinaryAssociation = BinaryAssociation(
    name="varRef40",
    ends={
        Property(name="stext_Expression41", type=stext_AssignmentExpression, multiplicity=Multiplicity(1, 1)),
...
expression42: BinaryAssociation = BinaryAssociation(
    name="expression42",
    ends={
        Property(name="stext_Expression44", type=stext_AssignmentExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_AssignmentExpression43", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
...
owner103: BinaryAssociation = BinaryAssociation(
    name="owner103",
    ends={
        Property(name="stext_Expression104", type=stext_FeatureCall, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_FeatureCall", type=stext_Expression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
feature105: BinaryAssociation = BinaryAssociation(
    name="feature105",
    ends={
        Property(name="stext_Feature", type=stext_FeatureCall, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_FeatureCall106", type=stext_Feature, multiplicity=Multiplicity(0, 1))
    }
)
args107: BinaryAssociation = BinaryAssociation(
    name="args107",
    ends={
        Property(name="stext_Expression109", type=stext_FeatureCall, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_FeatureCall108", type=stext_Expression, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
reference110: BinaryAssociation = BinaryAssociation(
    name="reference110",
    ends={
        Property(name="stext_NamedElement", type=stext_TypedElementReferenceExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="stext_TypedElementReferenceExpression", type=stext_NamedElement, multiplicity=Multiplicity(0, 1))
    }
)
value111: BinaryAssociation = BinaryAssociation(
    name="value111",
    ends={
        Property(name="stext_Expression112", type=stext_EventValueReferenceExpression, multiplicity=Multiplicity(1, 1)),
...
gen_stext_TypedElementReferenceExpression_Expression = Generalization(general=Expression, specific=stext_TypedElementReferenceExpression)
...
domain_model = DomainModel(
    name="stext",
    types={stext_Root, stext_DefRoot, stext_StateSpecification, stext_TransitionRoot, stext_TransitionSpecification, stext_StatechartScope, stext_Scope, stext_TransitionReaction, Scope, stext_InterfaceScope, StatechartScope, NamedElement, stext_InternalScope, stext_EventDefinition, Event, stext_EventDerivation, stext_Expression, stext_VariableDefinition, Variable, Property_, stext_OperationDefinition, Declaration, Operation, stext_Parameter, stext_StatechartRoot, DefRoot, stext_StatechartSpecification, stext_StateRoot, stext_ReactionProperty, stext_EntryPointSpec, ReactionProperty, stext_Entrypoint, stext_ExitPointSpec, stext_Exitpoint, stext_EventSpec, stext_RegularEventSpec, EventSpec, stext_TimeEventSpec, stext_BuiltinEventSpec, stext_EntryEvent, BuiltinEventSpec, stext_ExitEvent, stext_OnCycleEvent, stext_AlwaysEvent, stext_DefaultEvent, Statement, stext_Literal, stext_BoolLiteral, Literal, stext_IntLiteral, stext_RealLiteral, stext_HexLiteral, stext_StringLiteral, stext_LocalReaction, Reaction, stext_ReactionProperties, stext_SimpleScope, stext_ReactionTrigger, Trigger, stext_ReactionEffect, Effect, stext_EventRaisingExpression, Expression, stext_AssignmentExpression, stext_ConditionalExpression, stext_LogicalAndExpression, stext_LogicalNotExpression, stext_BitwiseXorExpression, stext_BitwiseOrExpression, stext_BitwiseAndExpression, stext_LogicalRelationExpression, stext_ShiftExpression, stext_LogicalOrExpression, stext_NumericalMultiplyDivideExpression, stext_NumericalUnaryExpression, stext_PrimitiveValueExpression, stext_FeatureCall, stext_Feature, stext_TypedElementReferenceExpression, stext_NamedElement, stext_EventValueReferenceExpression, stext_ActiveStateReferenceExpression, stext_State, stext_NumericalAddSubtractExpression, Direction, TimeEventType, AssignmentOperator, AdditiveOperator, MultiplicativeOperator, UnaryOperator, RelationalOperator, TimeUnit, ShiftOperator},
    associations={roots0, def_2, def_3, definitionScopes4, scope6, reaction8, derivation10, condition11, value13, initialValue16, params18, def_1, properties23, entrypoint25, exitpoint26, event27, properties19, properties20, triggers29, guardExpression30, actions33, event35, value37, varRef40, expression42, condition45, rightOperand55, leftOperand58, rightOperand60, operand63, leftOperand65, rightOperand67, leftOperand70, rightOperand72, leftOperand75, rightOperand77, leftOperand80, rightOperand82, leftOperand85, rightOperand87, trueCase47, falseCase50, leftOperand53, leftOperand95, rightOperand97, operand100, value102, owner103, feature105, args107, reference110, value111, value113, leftOperand90, rightOperand92},
    generalizations={gen_stext_TransitionRoot_DefRoot, gen_stext_StatechartScope_Scope, gen_stext_InterfaceScope_StatechartScope, gen_stext_InterfaceScope_NamedElement, gen_stext_InternalScope_StatechartScope, gen_stext_EventDefinition_Event, gen_stext_EventDefinition_Event, gen_stext_VariableDefinition_Variable, gen_stext_VariableDefinition_Property, gen_stext_OperationDefinition_Declaration, gen_stext_OperationDefinition_Operation, gen_stext_StatechartRoot_DefRoot, gen_stext_StateRoot_DefRoot, gen_stext_EntryPointSpec_ReactionProperty, gen_stext_ExitPointSpec_ReactionProperty, gen_stext_RegularEventSpec_EventSpec, gen_stext_TimeEventSpec_EventSpec, gen_stext_BuiltinEventSpec_EventSpec, gen_stext_EntryEvent_BuiltinEventSpec, gen_stext_ExitEvent_BuiltinEventSpec, gen_stext_OnCycleEvent_BuiltinEventSpec, gen_stext_AlwaysEvent_BuiltinEventSpec, gen_stext_DefaultEvent_BuiltinEventSpec, gen_stext_Expression_Statement, gen_stext_BoolLiteral_Literal, gen_stext_IntLiteral_Literal, gen_stext_RealLiteral_Literal, gen_stext_HexLiteral_Literal, gen_stext_StringLiteral_Literal, gen_stext_LocalReaction_Declaration, gen_stext_LocalReaction_Reaction, gen_stext_TransitionReaction_Reaction, gen_stext_SimpleScope_Scope, gen_stext_Entrypoint_Declaration, gen_stext_Exitpoint_Declaration, gen_stext_ReactionTrigger_Trigger, gen_stext_ReactionEffect_Effect, gen_stext_EventRaisingExpression_Expression, gen_stext_AssignmentExpression_Expression, gen_stext_ConditionalExpression_Expression, gen_stext_LogicalAndExpression_Expression, gen_stext_LogicalNotExpression_Expression, gen_stext_BitwiseXorExpression_Expression, gen_stext_BitwiseOrExpression_Expression, gen_stext_BitwiseAndExpression_Expression, gen_stext_LogicalRelationExpression_Expression, gen_stext_ShiftExpression_Expression, gen_stext_LogicalOrExpression_Expression, gen_stext_NumericalMultiplyDivideExpression_Expression, gen_stext_NumericalUnaryExpression_Expression, gen_stext_PrimitiveValueExpression_Expression, gen_stext_FeatureCall_Expression, gen_stext_TypedElementReferenceExpression_Expression, gen_stext_EventValueReferenceExpression_Expression, gen_stext_ActiveStateReferenceExpression_Expression, gen_stext_NumericalAddSubtractExpression_Expression},
    metadata=None
)
