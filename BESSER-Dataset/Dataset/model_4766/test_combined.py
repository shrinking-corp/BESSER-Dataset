...
def test_hyp_syswbeff106prepa_port_is_not_abstract():
    assert not inspect.isabstract(syswbeff106prepa_Port)


def test_hyp_syswbeff106prepa_port_constructor_exists():
    assert callable(syswbeff106prepa_Port.__init__)


def test_hyp_syswbeff106prepa_port_constructor_args():
...
def test_hyp_syswbeff106prepa_workbench_is_not_abstract():
    assert not inspect.isabstract(syswbeff106prepa_Workbench)


def test_hyp_syswbeff106prepa_workbench_constructor_exists():
    assert callable(syswbeff106prepa_Workbench.__init__)


def test_hyp_syswbeff106prepa_workbench_constructor_args():
    sig = inspect.signature(syswbeff106prepa_Workbench.__init__)
    params = list(sig.parameters.keys())



def test_hyp_syswbeff106prepa_pattern_is_not_abstract():
    assert not inspect.isabstract(syswbeff106prepa_Pattern)


def test_hyp_syswbeff106prepa_pattern_constructor_exists():
    assert callable(syswbeff106prepa_Pattern.__init__)


def test_hyp_syswbeff106prepa_pattern_constructor_args():
    sig = inspect.signature(syswbeff106prepa_Pattern.__init__)
    params = list(sig.parameters.keys())



def test_hyp_syswbeff106prepa_patterncatalog_is_not_abstract():
    assert not inspect.isabstract(syswbeff106prepa_PatternCatalog)


def test_hyp_syswbeff106prepa_patterncatalog_constructor_exists():
    assert callable(syswbeff106prepa_PatternCatalog.__init__)


def test_hyp_syswbeff106prepa_patterncatalog_constructor_args():
...
def test_hyp_syswbeff106prepa_function_is_not_abstract():
    assert not inspect.isabstract(syswbeff106prepa_Function)


def test_hyp_syswbeff106prepa_function_constructor_exists():
    assert callable(syswbeff106prepa_Function.__init__)


def test_hyp_syswbeff106prepa_function_constructor_args():
...
def test_hyp_syswbeff106prepa_system_is_not_abstract():
    assert not inspect.isabstract(syswbeff106prepa_System)


def test_hyp_syswbeff106prepa_system_constructor_exists():
    assert callable(syswbeff106prepa_System.__init__)


def test_hyp_syswbeff106prepa_system_constructor_args():
...
def test_hyp_syswbeff106prepa_flow_is_not_abstract():
    assert not inspect.isabstract(syswbeff106prepa_Flow)


def test_hyp_syswbeff106prepa_flow_constructor_exists():
    assert callable(syswbeff106prepa_Flow.__init__)


def test_hyp_syswbeff106prepa_flow_constructor_args():
    sig = inspect.signature(syswbeff106prepa_Flow.__init__)
    params = list(sig.parameters.keys())



def test_hyp_syswbeff106prepa_outputport_is_not_abstract():
    assert not inspect.isabstract(syswbeff106prepa_OutputPort)


def test_hyp_syswbeff106prepa_outputport_constructor_exists():
    assert callable(syswbeff106prepa_OutputPort.__init__)


def test_hyp_syswbeff106prepa_outputport_constructor_args():
    sig = inspect.signature(syswbeff106prepa_OutputPort.__init__)
    params = list(sig.parameters.keys())



def test_hyp_syswbeff106prepa_inputport_is_not_abstract():
    assert not inspect.isabstract(syswbeff106prepa_InputPort)


def test_hyp_syswbeff106prepa_inputport_constructor_exists():
    assert callable(syswbeff106prepa_InputPort.__init__)


def test_hyp_syswbeff106prepa_inputport_constructor_args():
    sig = inspect.signature(syswbeff106prepa_InputPort.__init__)
    params = list(sig.parameters.keys())



def test_hyp_syswbeff106prepa_abstractfunction_is_not_abstract():
    assert not inspect.isabstract(syswbeff106prepa_AbstractFunction)


def test_hyp_syswbeff106prepa_abstractfunction_constructor_exists():
    assert callable(syswbeff106prepa_AbstractFunction.__init__)


def test_hyp_syswbeff106prepa_abstractfunction_constructor_args():
...
def test_hyp_syswbeff106prepa_port_name_setter(instance):
...
def test_hyp_syswbeff106prepa_patterncatalog_id_setter(instance):
...
def test_hyp_syswbeff106prepa_system_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
def test_hyp_syswbeff106prepa_abstractfunction_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
