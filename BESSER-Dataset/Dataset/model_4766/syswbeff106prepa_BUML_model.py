...
# Classes
syswbeff106prepa_AbstractFunction = Class(name="syswbeff106prepa_AbstractFunction", is_abstract=True)
syswbeff106prepa_InputPort = Class(name="syswbeff106prepa_InputPort")
syswbeff106prepa_OutputPort = Class(name="syswbeff106prepa_OutputPort")
syswbeff106prepa_Flow = Class(name="syswbeff106prepa_Flow")
syswbeff106prepa_System = Class(name="syswbeff106prepa_System")
Port = Class(name="Port")
syswbeff106prepa_Function = Class(name="syswbeff106prepa_Function")
syswbeff106prepa_PatternCatalog = Class(name="syswbeff106prepa_PatternCatalog")
syswbeff106prepa_Pattern = Class(name="syswbeff106prepa_Pattern")
syswbeff106prepa_Workbench = Class(name="syswbeff106prepa_Workbench")
AbstractFunction = Class(name="AbstractFunction")
syswbeff106prepa_Port = Class(name="syswbeff106prepa_Port", is_abstract=True)
...
from_24: BinaryAssociation = BinaryAssociation(
    name="from_24",
    ends={
...
domain_model = DomainModel(
    ...
    types={syswbeff106prepa_AbstractFunction, syswbeff106prepa_InputPort, syswbeff106prepa_OutputPort, syswbeff106prepa_Flow, syswbeff106prepa_System, Port, syswbeff106prepa_Function, syswbeff106prepa_PatternCatalog, syswbeff106prepa_Pattern, syswbeff106prepa_Workbench, AbstractFunction, syswbeff106prepa_Port},
    associations={associations1, inputports2, outputports4, flows6, functionalArchitecture8, patterns9, systemView10, catalog12, equivalent16, pdecompositions19, fdecompositions22, from_24, to27},
    generalizations={gen_syswbeff106prepa_InputPort_Port, gen_syswbeff106prepa_Pattern_AbstractFunction, gen_syswbeff106prepa_Function_AbstractFunction, gen_syswbeff106prepa_OutputPort_Port},
    metadata=None
)
