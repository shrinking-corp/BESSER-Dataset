...
author3: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="articles", type=BibText_Author, multiplicity=Multiplicity(1, 1))
    }
)
...
entries0: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="BibText_BibTextFile", type=BibText_BibTextEntry, multiplicity=Multiplicity(2, 4), is_composite=True)
    }
)
...
domain_model = DomainModel(
    name="BibText",
    types={LocatedElement, BibText_Attribute, BibText_Article, BibTextEntry, BibText_Author, BibText_Year, Attribute, BibText_LocatedElement, BibText_BibTextFile, BibText_BibTextEntry},
    associations={attributes1, author3, articles4, entries0},
