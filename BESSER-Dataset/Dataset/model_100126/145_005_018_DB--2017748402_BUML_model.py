...
domain_model = DomainModel(
    name="DB",
    types={NamedElement, DB_Table, DatabaseElement, DB_Column, DB_ForeignKey, DB_NamedElement, DB_Database, DB_DatabaseElement},
    associations={database1, columns2, primaryKeys3, table4, parent5, child7, contents0},
