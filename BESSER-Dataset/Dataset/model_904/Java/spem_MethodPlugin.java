...
public class spem_MethodPlugin extends MethodLibraryPackageableElement {
    ...
    public spem_MethodPlugin(
        ArrayList<spem_MethodPlugin> spem_methodplugins,        ArrayList<spem_ProcessPackage> spem_processpackages,        ArrayList<spem_MethodContentPackage> spem_methodcontentpackages    ) {
