...
class spem_Default_TaskDefinitionParameter(WorkDefinitionParameter):
    ...
    def __init__(self, name: str, optionality: str, spem_Default_TaskDefinitionParameter98: "spem_WorkProductDefinition" = None, spem_Default_TaskDefinitionParameter: "spem_TaskDefinition" = None):
        self.name = name
...
class spem_TaskUse(WorkBreakdownElement, MethodContentUse):
    ...
    def __init__(self, preCondition: str, postCondition: str, spem_TaskUse106: "spem_TaskDefinition" = None, spem_TaskUse109: set["spem_Qualification"] = None, spem_TaskUse112: set["spem_Step"] = None, spem_TaskUse: "spem_ProcessPerformer" = None, spem_TaskUse115: set["spem_ProcessParameter"] = None):
...
class spem_Step(DescribableElement, WorkDefinition, VariabilityElement):
    ...
    def __init__(self, name: str, spem_Step: "spem_TaskDefinition" = None, spem_Step113: "spem_TaskUse" = None, Step: "spem_Step" = None, successor74: "spem_Step" = None, Step78: "spem_Step" = None, predecessor77: "spem_Step" = None):
        self.name = name
...
class spem_Activity(WorkBreakdownElement, WorkDefinition, VariabilityElement):
    ...
    def __init__(self, useKind: str, isEnactable: bool, spem_Activity14: set["spem_BreakdownElement"] = None, spem_Activity17: set["spem_BreakdownElement"] = None, spem_Activity20: set["spem_ProcessParameter"] = None, spem_Activity22: "spem_MethodConfiguration" = None, spem_Activity24: set["spem_MethodConfiguration"] = None, spem_Activity29: "spem_ProcessPerformer" = None, spem_Activity: "spem_Activity" = None, spem_Activity11: "spem_Activity" = None, spem_Activity129: "spem_ProcessComponent" = None):
...
class spem_ProcessParameter(WorkDefinitionParameter, BreakdownElement):
    ...
    def __init__(self, optionality: str, spem_ProcessParameter116: "spem_TaskUse" = None, spem_ProcessParameter: "spem_Activity" = None, spem_ProcessParameter48: "spem_WorkProductUse" = None):
        self.optionality = optionality
...
class spem_WorkProductPort(ProcessElement):
    ...
    def __init__(self, isOptional: bool, portKind: str, spem_WorkProductPort175: "spem_WorkProductDefinition" = None, spem_WorkProductPort: "spem_ProcessComponent" = None, spem_WorkProductPort136: "spem_ProcessComponentUse" = None, spem_WorkProductPort178: "spem_WorkProductPortConnector" = None):
