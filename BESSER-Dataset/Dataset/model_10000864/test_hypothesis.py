...
def test_restaurant_has_attribute():
    assert hasattr(Restaurant, "attribute")
    descriptor = None
...
def test_restaurant_has_attribute2():
    assert hasattr(Restaurant, "attribute2")
    descriptor = None
    for klass in Restaurant.__mro__:
...
@given(instance=Restaurant_strategy)
def test_restaurant_attribute_setter(instance):
...
@given(instance=Restaurant_strategy)
def test_restaurant_attribute2_setter(instance):
