...
def test_hyp_myenumeration_exists():
    # Check that the Enumeration exists
    assert MyEnumeration is not None

def test_hyp_myenumeration_has_all_literals():
...
def test_hyp_restaurant_attribute_setter(instance):
...
@given(instance=Restaurant_strategy)
def test_hyp_restaurant_attribute2_setter(instance):
...
def test_Restaurant_attribute_value_roundtrip():
    instance = Restaurant(attribute="sample_text", attribute2="sample_text")
    assert instance.attribute == "sample_text"
    instance.attribute = "sample_text_2"
    assert instance.attribute == "sample_text_2"


def test_Restaurant_attribute2_value_roundtrip():
    instance = Restaurant(attribute="sample_text", attribute2="sample_text")
...
Restaurant_strategy = st.builds(Restaurant, attribute=safe_text, attribute2=safe_text)
@given(instance=Restaurant_strategy)
@settings(max_examples=25)
