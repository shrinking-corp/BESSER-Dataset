...
def test_hyp_ling_feature_is_not_abstract():
    assert not inspect.isabstract(ling_Feature)


def test_hyp_ling_feature_constructor_exists():
    assert callable(ling_Feature.__init__)


def test_hyp_ling_feature_constructor_args():
...
def test_hyp_ling_entity_is_not_abstract():
    assert not inspect.isabstract(ling_Entity)


def test_hyp_ling_entity_constructor_exists():
    assert callable(ling_Entity.__init__)


def test_hyp_ling_entity_constructor_args():
    sig = inspect.signature(ling_Entity.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ling_datatype_is_not_abstract():
    assert not inspect.isabstract(ling_DataType)


def test_hyp_ling_datatype_constructor_exists():
    assert callable(ling_DataType.__init__)


def test_hyp_ling_datatype_constructor_args():
...
def test_hyp_ling_import_is_not_abstract():
    assert not inspect.isabstract(ling_Import)


def test_hyp_ling_import_constructor_exists():
    assert callable(ling_Import.__init__)


def test_hyp_ling_import_constructor_args():
...
def test_hyp_ling_type_is_not_abstract():
    assert not inspect.isabstract(ling_Type)


def test_hyp_ling_type_constructor_exists():
    assert callable(ling_Type.__init__)


def test_hyp_ling_type_constructor_args():
...
def test_hyp_ling_packagedeclaration_is_not_abstract():
    assert not inspect.isabstract(ling_PackageDeclaration)


def test_hyp_ling_packagedeclaration_constructor_exists():
    assert callable(ling_PackageDeclaration.__init__)


def test_hyp_ling_packagedeclaration_constructor_args():
...
def test_hyp_ling_abstractelement_is_not_abstract():
    assert not inspect.isabstract(ling_AbstractElement)


def test_hyp_ling_abstractelement_constructor_exists():
    assert callable(ling_AbstractElement.__init__)


def test_hyp_ling_abstractelement_constructor_args():
    sig = inspect.signature(ling_AbstractElement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ling_domainmodel_is_not_abstract():
    assert not inspect.isabstract(ling_Domainmodel)


def test_hyp_ling_domainmodel_constructor_exists():
    assert callable(ling_Domainmodel.__init__)


def test_hyp_ling_domainmodel_constructor_args():
...
def test_hyp_ling_feature_many_setter(instance):
...
@given(instance=ling_Feature_strategy)
def test_hyp_ling_feature_name_setter(instance):
...
def test_hyp_ling_import_importedNamespace_setter(instance):
...
def test_hyp_ling_type_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_ling_packagedeclaration_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
