...
class petrinet_Node(ABC):
    ...
    def __init__(self, name: str, petrinet_Node: "petrinet_Petrinet" = None, target: set["petrinet_Arc"] = None, petrinet_Node5: set["petrinet_Arc"] = None, petrinet_Node9: "petrinet_Arc" = None, Node: "petrinet_Arc" = None):
        self.name = name
