...
# Classes
MM1_ContainerMM1 = Class(name="MM1_ContainerMM1")
MM1_A = Class(name="MM1_A", is_abstract=True)
MM1_C = Class(name="MM1_C")
MM1_D = Class(name="MM1_D")
MM1_B = Class(name="MM1_B")
A = Class(name="A")
...
domain_model = DomainModel(
    name="MM1",
    types={MM1_ContainerMM1, MM1_A, MM1_C, MM1_D, MM1_B, A},
    associations={as_0, ds1},
    generalizations={gen_MM1_C_A, gen_MM1_B_A},
    metadata=None
)
