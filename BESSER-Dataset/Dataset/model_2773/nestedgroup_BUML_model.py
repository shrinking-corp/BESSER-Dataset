...
# Classes
nestedgroup_CType = Class(name="nestedgroup_CType")
nestedgroup_Element = Class(name="nestedgroup_Element")
nestedgroup_A = Class(name="nestedgroup_A")
...
nestedgroup_Element.attributes={nestedgroup_Element_name, nestedgroup_Element_true, nestedgroup_Element_mixed}
...
nestedgroup_A.attributes={nestedgroup_A_name, nestedgroup_A_group, nestedgroup_A_b}
...
domain_model = DomainModel(
    name="nestedgroup",
    types={nestedgroup_CType, nestedgroup_Element, nestedgroup_A},
    associations={c0, recursive4, c1},
    generalizations={},
    metadata=None
)
