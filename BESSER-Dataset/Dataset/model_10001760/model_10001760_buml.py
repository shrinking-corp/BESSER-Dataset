...
Sensor_Status: Property = Property(name="Status", type=BooleanType)
Sensor.attributes={Sensor_SensorID, Sensor_Status, Sensor_SensorType}
...
HouseHolds.attributes={HouseHolds_Coffee, HouseHolds_Alarm, HouseHolds_TimeID, HouseHolds_DishWasher, HouseHolds_WashingMachine}
...
domain_model = DomainModel(
    ...
    associations={HomeTheatre_TV, HomeTheatre_Speakers, HouseHolds_Start_Of_Day, HouseHolds_End_Of_Day, MicroPhone_System, Home_Security_System_Alert, Sensor_System, System_HouseHolds, HomeTheatre_System, Home_Security_System_System, TV_Entertainment, Speakers_Entertainment, HomeTheatre_Entertainment, Sensor_Door, Door_Camera},
    generalizations={},
    metadata=None
)
