...
di_BPMNShape.attributes={di_BPMNShape_isMarkerVisible, di_BPMNShape_isHorizontal, di_BPMNShape_isExpanded, di_BPMNShape_participantBandKind, di_BPMNShape_isMessageVisible}
...
domain_model = DomainModel(
    name="di",
    types={di_DocumentRoot, di_EStringToStringMapEntry, di_BPMNDiagram, di_BPMNEdge, di_BPMNLabel, di_BPMNLabelStyle, di_BPMNPlane, di_BPMNShape, Diagram, LabeledEdge, BaseElement, di_DiagramElement, Label, Style, di_Font, Plane, LabeledShape, MessageVisibleKind, ParticipantBandKind},
