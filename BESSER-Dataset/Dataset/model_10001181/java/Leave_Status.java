...
public class Leave_Status  {
    ...
    public Leave_Status(
        String Leave_Title,        LocalDate Leave_ApplyDate,        int Leave_NoOfDays,        LocalDate Leave_StartDate,        int leave_id,        LocalDate Leave_EndDate,        String Leave_Status,        int Emp_Id,        String Leave_detail    ) {
