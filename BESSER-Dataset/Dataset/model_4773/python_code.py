...
class types_Property:
    ...
    def __init__(self, name: str, types_Property12: "types_ServiceType" = None, types_Property: "types_ClassType" = None, types_Property5: "types_TypeReference" = None, types_Property20: "types_Operation" = None):
        self.name = name
