...
def test_mindstorms_exploreforward_is_not_abstract():
    assert not inspect.isabstract(mindstorms_ExploreForward)


def test_mindstorms_exploreforward_constructor_exists():
    assert callable(mindstorms_ExploreForward.__init__)


def test_mindstorms_exploreforward_constructor_args():
    sig = inspect.signature(mindstorms_ExploreForward.__init__)
    params = list(sig.parameters.keys())



def test_mindstorms_returnbottletobase_is_not_abstract():
    assert not inspect.isabstract(mindstorms_ReturnBottleToBase)


def test_mindstorms_returnbottletobase_constructor_exists():
    assert callable(mindstorms_ReturnBottleToBase.__init__)


def test_mindstorms_returnbottletobase_constructor_args():
    sig = inspect.signature(mindstorms_ReturnBottleToBase.__init__)
    params = list(sig.parameters.keys())



def test_mindstorms_avoidobstacle_is_not_abstract():
    assert not inspect.isabstract(mindstorms_AvoidObstacle)


def test_mindstorms_avoidobstacle_constructor_exists():
    assert callable(mindstorms_AvoidObstacle.__init__)


def test_mindstorms_avoidobstacle_constructor_args():
    sig = inspect.signature(mindstorms_AvoidObstacle.__init__)
    params = list(sig.parameters.keys())



def test_mindstorms_conditioncontainer_is_not_abstract():
    assert not inspect.isabstract(mindstorms_ConditionContainer)


def test_mindstorms_conditioncontainer_constructor_exists():
    assert callable(mindstorms_ConditionContainer.__init__)


def test_mindstorms_conditioncontainer_constructor_args():
...
def test_mindstorms_arbitrator_is_not_abstract():
    assert not inspect.isabstract(mindstorms_Arbitrator)


def test_mindstorms_arbitrator_constructor_exists():
    assert callable(mindstorms_Arbitrator.__init__)


def test_mindstorms_arbitrator_constructor_args():
    sig = inspect.signature(mindstorms_Arbitrator.__init__)
    params = list(sig.parameters.keys())



def test_mindstorms_reuseinstruction_is_not_abstract():
    assert not inspect.isabstract(mindstorms_ReuseInstruction)


def test_mindstorms_reuseinstruction_constructor_exists():
    assert callable(mindstorms_ReuseInstruction.__init__)


def test_mindstorms_reuseinstruction_constructor_args():
    sig = inspect.signature(mindstorms_ReuseInstruction.__init__)
    params = list(sig.parameters.keys())



def test_mindstorms_procedure_is_not_abstract():
    assert not inspect.isabstract(mindstorms_Procedure)


def test_mindstorms_procedure_constructor_exists():
    assert callable(mindstorms_Procedure.__init__)


def test_mindstorms_procedure_constructor_args():
...
def test_mindstorms_blockcontainer_is_not_abstract():
    assert not inspect.isabstract(mindstorms_BlockContainer)


def test_mindstorms_blockcontainer_constructor_exists():
    assert callable(mindstorms_BlockContainer.__init__)


def test_mindstorms_blockcontainer_constructor_args():
...
def test_mindstorms_behavior_is_not_abstract():
    assert not inspect.isabstract(mindstorms_Behavior)


def test_mindstorms_behavior_constructor_exists():
    assert callable(mindstorms_Behavior.__init__)


def test_mindstorms_behavior_constructor_args():
...
def test_mindstorms_main_is_not_abstract():
    assert not inspect.isabstract(mindstorms_Main)


def test_mindstorms_main_constructor_exists():
    assert callable(mindstorms_Main.__init__)


def test_mindstorms_main_constructor_args():
...
def test_mindstorms_gotoenemy_is_not_abstract():
    assert not inspect.isabstract(mindstorms_GoToEnemy)


def test_mindstorms_gotoenemy_constructor_exists():
    assert callable(mindstorms_GoToEnemy.__init__)


def test_mindstorms_gotoenemy_constructor_args():
