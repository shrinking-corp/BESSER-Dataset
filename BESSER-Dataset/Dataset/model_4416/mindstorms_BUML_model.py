...
mindstorms_Flow = Class(name="mindstorms_Flow", is_abstract=True)
mindstorms_Sensor = Class(name="mindstorms_Sensor", is_abstract=True)
Condition = Class(name="Condition")
mindstorms_Condition = Class(name="mindstorms_Condition", is_abstract=True)
mindstorms_If = Class(name="mindstorms_If")
Flow = Class(name="Flow")
mindstorms_While = Class(name="mindstorms_While")
mindstorms_GoForward = Class(name="mindstorms_GoForward")
Action = Class(name="Action")
mindstorms_GoBackward = Class(name="mindstorms_GoBackward")
mindstorms_Main = Class(name="mindstorms_Main")
mindstorms_Instruction = Class(name="mindstorms_Instruction", is_abstract=True)
NamedElement = Class(name="NamedElement")
mindstorms_BlockContainer = Class(name="mindstorms_BlockContainer", is_abstract=True)
mindstorms_Block = Class(name="mindstorms_Block", is_abstract=True)
mindstorms_Procedure = Class(name="mindstorms_Procedure")
Instruction = Class(name="Instruction")
BlockContainer = Class(name="BlockContainer")
mindstorms_Arbitrator = Class(name="mindstorms_Arbitrator")
ConditionContainer = Class(name="ConditionContainer")
mindstorms_Behavior = Class(name="mindstorms_Behavior")
mindstorms_ReuseInstruction = Class(name="mindstorms_ReuseInstruction")
mindstorms_ConditionContainer = Class(name="mindstorms_ConditionContainer", is_abstract=True)
mindstorms_Rotate = Class(name="mindstorms_Rotate")
mindstorms_GoTo = Class(name="mindstorms_GoTo")
mindstorms_ReturnToBase = Class(name="mindstorms_ReturnToBase")
mindstorms_Grab = Class(name="mindstorms_Grab")
mindstorms_Release = Class(name="mindstorms_Release")
mindstorms_Delay = Class(name="mindstorms_Delay")
mindstorms_AvoidObstacle = Class(name="mindstorms_AvoidObstacle")
Behavior = Class(name="Behavior")
mindstorms_ReturnBottleToBase = Class(name="mindstorms_ReturnBottleToBase")
mindstorms_ExploreForward = Class(name="mindstorms_ExploreForward")
mindstorms_TouchSensor = Class(name="mindstorms_TouchSensor")
Sensor = Class(name="Sensor")
mindstorms_UltrasonicSensor = Class(name="mindstorms_UltrasonicSensor")
mindstorms_ColorSensor = Class(name="mindstorms_ColorSensor")
mindstorms_GoToEnemy = Class(name="mindstorms_GoToEnemy")
...
domain_model = DomainModel(
    name="mindstorms",
    types={mindstorms_NamedElement, mindstorms_Action, Block, mindstorms_Flow, mindstorms_Sensor, Condition, mindstorms_Condition, mindstorms_If, Flow, mindstorms_While, mindstorms_GoForward, Action, mindstorms_GoBackward, mindstorms_Main, mindstorms_Instruction, NamedElement, mindstorms_BlockContainer, mindstorms_Block, mindstorms_Procedure, Instruction, BlockContainer, mindstorms_Arbitrator, ConditionContainer, mindstorms_Behavior, mindstorms_ReuseInstruction, mindstorms_ConditionContainer, mindstorms_Rotate, mindstorms_GoTo, mindstorms_ReturnToBase, mindstorms_Grab, mindstorms_Release, mindstorms_Delay, mindstorms_AvoidObstacle, Behavior, mindstorms_ReturnBottleToBase, mindstorms_ExploreForward, mindstorms_TouchSensor, Sensor, mindstorms_UltrasonicSensor, mindstorms_ColorSensor, mindstorms_GoToEnemy, OperatorKind, Color},
    associations={instructions0, blocks1, behaviors2, reuse3, reuse6, condition8},
    generalizations={gen_mindstorms_Action_Block, gen_mindstorms_Flow_Block, gen_mindstorms_Flow_BlockContainer, gen_mindstorms_Flow_ConditionContainer, gen_mindstorms_Sensor_NamedElement, gen_mindstorms_Sensor_Condition, gen_mindstorms_If_Flow, gen_mindstorms_While_Flow, gen_mindstorms_GoForward_Action, gen_mindstorms_GoBackward_Action, gen_mindstorms_Instruction_NamedElement, gen_mindstorms_Procedure_Instruction, gen_mindstorms_Procedure_BlockContainer, gen_mindstorms_Arbitrator_Instruction, gen_mindstorms_Arbitrator_ConditionContainer, gen_mindstorms_Behavior_NamedElement, gen_mindstorms_Behavior_BlockContainer, gen_mindstorms_Behavior_ConditionContainer, gen_mindstorms_ReuseInstruction_Instruction, gen_mindstorms_Block_Instruction, gen_mindstorms_Rotate_Action, gen_mindstorms_GoTo_Action, gen_mindstorms_ReturnToBase_Action, gen_mindstorms_Grab_Action, gen_mindstorms_Release_Action, gen_mindstorms_Delay_Action, gen_mindstorms_AvoidObstacle_Behavior, gen_mindstorms_ReturnBottleToBase_Behavior, gen_mindstorms_ExploreForward_Behavior, gen_mindstorms_TouchSensor_Sensor, gen_mindstorms_UltrasonicSensor_Sensor, gen_mindstorms_ColorSensor_Sensor, gen_mindstorms_GoToEnemy_Action},
    metadata=None
)
