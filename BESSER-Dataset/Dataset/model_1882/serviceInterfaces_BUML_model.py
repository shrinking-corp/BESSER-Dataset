...
domain_model = DomainModel(
    ...
    types={serviceInterfaces_InterfaceRepository, serviceInterfaces_Package, Packageable, serviceInterfaces_Interface, serviceInterfaces_codegen_InjectorAcceptorInterfaceL1, Interface, TransformationLibrary, serviceInterfaces_codegen_TransformationLibrary, serviceInterfaces_codegen_SlotPlugInterfaceL1, serviceInterfaces_Packageable, serviceInterfaces_codegen_Pointcut, serviceInterfaces_codegen_ClassPointcut, serviceInterfaces_codegen_MethodPoincut, serviceInterfaces_codegen_ImportElementPointcut, serviceInterfaces_codegen_StatementPoincut, serviceInterfaces_modelingenv_InjectorAcceptorInterfaceL0, JavaTypeDeclaration, serviceInterfaces_modelingenv_JavaTypeDeclaration, serviceInterfaces_modelingenv_JavaInterface, Operation, Pointcut, serviceInterfaces_modelingenv_JavaClass, serviceInterfaces_modelingenv_Operation, serviceInterfaces_modelingenv_SlotPlugInterfaceL0, ExtensionPoint, serviceInterfaces_modelingenv_ExtensionPoint, CodeGenLanguage, PointcutType, InjectionMode},
    associations={contents0, contents1, injectorProvides3, pointcuts4, injectorImplements5, operations7, slot9, operations6},
