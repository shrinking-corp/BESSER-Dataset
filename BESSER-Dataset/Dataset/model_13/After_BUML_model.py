...
domain_model = DomainModel(
    name="lit_petriNets",
    types={lit_petriNets_Net, lit_petriNets_Place, lit_petriNets_Arc, lit_petriNets_TPArc, lit_petriNets_PTArc, Arc, lit_petriNets_Transition},
    associations={places0, arcs3, net5, in_6, out7, net8, in_10, out13, net16, src18, dst20, src22, transitions1, dst25},
