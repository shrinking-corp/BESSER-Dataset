...
def test_hyp_myclass_instantiation(instance):
    assert isinstance(instance, MyClass)



@given(instance=MyClass_strategy)
def test_hyp_myclass_Abb_setter(instance):
...
@given(instance=MyClass_strategy)
def test_hyp_myclass_ABC_setter(instance):
