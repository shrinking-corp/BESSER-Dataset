...
# Classes
henshin_text_ModelElement = Class(name="henshin_text_ModelElement")
henshin_text_EPackage = Class(name="henshin_text_EPackage")
henshin_text_Parameter = Class(name="henshin_text_Parameter")
henshin_text_RuleElement = Class(name="henshin_text_RuleElement")
henshin_text_JavaImport = Class(name="henshin_text_JavaImport")
RuleElement = Class(name="RuleElement")
henshin_text_CheckDangling = Class(name="henshin_text_CheckDangling")
henshin_text_InjectiveMatching = Class(name="henshin_text_InjectiveMatching")
henshin_text_Conditions = Class(name="henshin_text_Conditions")
henshin_text_Model = Class(name="henshin_text_Model")
henshin_text_EPackageImport = Class(name="henshin_text_EPackageImport")
henshin_text_EReference = Class(name="henshin_text_EReference")
henshin_text_Node = Class(name="henshin_text_Node")
RuleNodeTypes = Class(name="RuleNodeTypes")
ConditionNodeTypes = Class(name="ConditionNodeTypes")
henshin_text_EClass = Class(name="henshin_text_EClass")
henshin_text_Attribute = Class(name="henshin_text_Attribute")
henshin_text_MultiRuleReuseNode = Class(name="henshin_text_MultiRuleReuseNode")
henshin_text_EAttribute = Class(name="henshin_text_EAttribute")
henshin_text_Expression = Class(name="henshin_text_Expression")
henshin_text_Graph = Class(name="henshin_text_Graph")
henshin_text_GraphElements = Class(name="henshin_text_GraphElements")
henshin_text_Edges = Class(name="henshin_text_Edges")
GraphElements = Class(name="GraphElements")
henshin_text_Edge = Class(name="henshin_text_Edge")
henshin_text_RuleNodeTypes = Class(name="henshin_text_RuleNodeTypes")
henshin_text_ConditionGraph = Class(name="henshin_text_ConditionGraph")
henshin_text_ConditionGraphElements = Class(name="henshin_text_ConditionGraphElements")
henshin_text_ConditionEdges = Class(name="henshin_text_ConditionEdges")
henshin_text_ConditionEdge = Class(name="henshin_text_ConditionEdge")
henshin_text_ConditionNodeTypes = Class(name="henshin_text_ConditionNodeTypes")
henshin_text_ConditionNode = Class(name="henshin_text_ConditionNode")
henshin_text_Match = Class(name="henshin_text_Match")
henshin_text_MultiRule = Class(name="henshin_text_MultiRule")
henshin_text_Formula = Class(name="henshin_text_Formula")
ConditionGraphElements = Class(name="ConditionGraphElements")
henshin_text_Logic = Class(name="henshin_text_Logic")
henshin_text_SequentialProperties = Class(name="henshin_text_SequentialProperties")
UnitElement = Class(name="UnitElement")
henshin_text_Strict = Class(name="henshin_text_Strict")
SequentialProperties = Class(name="SequentialProperties")
henshin_text_Rollback = Class(name="henshin_text_Rollback")
henshin_text_List = Class(name="henshin_text_List")
henshin_text_IndependentUnit = Class(name="henshin_text_IndependentUnit")
henshin_text_ConditionalUnit = Class(name="henshin_text_ConditionalUnit")
henshin_text_PriorityUnit = Class(name="henshin_text_PriorityUnit")
henshin_text_ConditionReuseNode = Class(name="henshin_text_ConditionReuseNode")
henshin_text_UnitElement = Class(name="henshin_text_UnitElement")
henshin_text_IteratedUnit = Class(name="henshin_text_IteratedUnit")
henshin_text_LoopUnit = Class(name="henshin_text_LoopUnit")
henshin_text_ParameterType = Class(name="henshin_text_ParameterType")
henshin_text_Rule = Class(name="henshin_text_Rule")
ModelElement = Class(name="ModelElement")
henshin_text_Unit = Class(name="henshin_text_Unit")
henshin_text_ORorXOR = Class(name="henshin_text_ORorXOR")
Logic = Class(name="Logic")
henshin_text_AND = Class(name="henshin_text_AND")
henshin_text_Not = Class(name="henshin_text_Not")
henshin_text_ConditionGraphRef = Class(name="henshin_text_ConditionGraphRef")
henshin_text_AndExpression = Class(name="henshin_text_AndExpression")
henshin_text_EqualityExpression = Class(name="henshin_text_EqualityExpression")
henshin_text_ComparisonExpression = Class(name="henshin_text_ComparisonExpression")
henshin_text_PlusExpression = Class(name="henshin_text_PlusExpression")
henshin_text_MinusExpression = Class(name="henshin_text_MinusExpression")
henshin_text_Call = Class(name="henshin_text_Call")
henshin_text_OrExpression = Class(name="henshin_text_OrExpression")
Expression = Class(name="Expression")
henshin_text_BracketExpression = Class(name="henshin_text_BracketExpression")
henshin_text_NotExpression = Class(name="henshin_text_NotExpression")
henshin_text_ParameterValue = Class(name="henshin_text_ParameterValue")
henshin_text_JavaClassValue = Class(name="henshin_text_JavaClassValue")
henshin_text_JavaAttributeValue = Class(name="henshin_text_JavaAttributeValue")
henshin_text_StringValue = Class(name="henshin_text_StringValue")
henshin_text_NumberValue = Class(name="henshin_text_NumberValue")
henshin_text_IntegerValue = Class(name="henshin_text_IntegerValue")
henshin_text_NaturalValue = Class(name="henshin_text_NaturalValue")
henshin_text_MulOrDivExpression = Class(name="henshin_text_MulOrDivExpression")
henshin_text_BoolValue = Class(name="henshin_text_BoolValue")
...
henshin_text_Parameter.attributes={henshin_text_Parameter_kind, henshin_text_Parameter_name}
...
if_66: BinaryAssociation = BinaryAssociation(
    name="if_66",
    ends={
...
domain_model = DomainModel(
    name="henshin_text",
    types={henshin_text_ModelElement, henshin_text_EPackage, henshin_text_Parameter, henshin_text_RuleElement, henshin_text_JavaImport, RuleElement, henshin_text_CheckDangling, henshin_text_InjectiveMatching, henshin_text_Conditions, henshin_text_Model, henshin_text_EPackageImport, henshin_text_EReference, henshin_text_Node, RuleNodeTypes, ConditionNodeTypes, henshin_text_EClass, henshin_text_Attribute, henshin_text_MultiRuleReuseNode, henshin_text_EAttribute, henshin_text_Expression, henshin_text_Graph, henshin_text_GraphElements, henshin_text_Edges, GraphElements, henshin_text_Edge, henshin_text_RuleNodeTypes, henshin_text_ConditionGraph, henshin_text_ConditionGraphElements, henshin_text_ConditionEdges, henshin_text_ConditionEdge, henshin_text_ConditionNodeTypes, henshin_text_ConditionNode, henshin_text_Match, henshin_text_MultiRule, henshin_text_Formula, ConditionGraphElements, henshin_text_Logic, henshin_text_SequentialProperties, UnitElement, henshin_text_Strict, SequentialProperties, henshin_text_Rollback, henshin_text_List, henshin_text_IndependentUnit, henshin_text_ConditionalUnit, henshin_text_PriorityUnit, henshin_text_ConditionReuseNode, henshin_text_UnitElement, henshin_text_IteratedUnit, henshin_text_LoopUnit, henshin_text_ParameterType, henshin_text_Rule, ModelElement, henshin_text_Unit, henshin_text_ORorXOR, Logic, henshin_text_AND, henshin_text_Not, henshin_text_ConditionGraphRef, henshin_text_AndExpression, henshin_text_EqualityExpression, henshin_text_ComparisonExpression, henshin_text_PlusExpression, henshin_text_MinusExpression, henshin_text_Call, henshin_text_OrExpression, Expression, henshin_text_BracketExpression, henshin_text_NotExpression, henshin_text_ParameterValue, henshin_text_JavaClassValue, henshin_text_JavaAttributeValue, henshin_text_StringValue, henshin_text_NumberValue, henshin_text_IntegerValue, henshin_text_NaturalValue, henshin_text_MulOrDivExpression, henshin_text_BoolValue, ParameterKind, Type},
    associations={transformationsystem1, ref3, parameters5, ePackageimports0, target12, type15, nodetype17, attribute18, name20, attribute22, name25, attributeConditions7, graphElements8, edges9, source10, conditionGraphs32, conditionGraphElements34, edges36, source37, target39, type42, type45, value27, multiruleElements30, formula31, subElements62, listOfLists64, if_66, then68, else_71, listOfLists74, attribute47, name49, attribute51, name54, value57, subSequence61, type83, type85, iterations76, subElement78, subElement81, ruleElements88, unitElements90, left92, right94, left97, right99, negation102, left116, right118, left121, right123, left126, right128, left131, right133, conditionGraphRef104, elementCall106, parameters108, left111, right113, expression146, expression148, value150, javaParameter152, left136, right138, left141, right143},
    generalizations={gen_henshin_text_JavaImport_RuleElement, gen_henshin_text_CheckDangling_RuleElement, gen_henshin_text_InjectiveMatching_RuleElement, gen_henshin_text_Conditions_RuleElement, gen_henshin_text_Node_GraphElements, gen_henshin_text_Node_RuleNodeTypes, gen_henshin_text_Node_ConditionNodeTypes, gen_henshin_text_MultiRuleReuseNode_GraphElements, gen_henshin_text_MultiRuleReuseNode_RuleNodeTypes, gen_henshin_text_Graph_RuleElement, gen_henshin_text_Edges_GraphElements, gen_henshin_text_ConditionEdges_ConditionGraphElements, gen_henshin_text_ConditionNode_ConditionGraphElements, gen_henshin_text_ConditionNode_ConditionNodeTypes, gen_henshin_text_MultiRule_GraphElements, gen_henshin_text_Formula_GraphElements, gen_henshin_text_Formula_ConditionGraphElements, gen_henshin_text_SequentialProperties_UnitElement, gen_henshin_text_Strict_SequentialProperties, gen_henshin_text_Rollback_SequentialProperties, gen_henshin_text_IndependentUnit_UnitElement, gen_henshin_text_ConditionalUnit_UnitElement, gen_henshin_text_PriorityUnit_UnitElement, gen_henshin_text_ConditionReuseNode_ConditionGraphElements, gen_henshin_text_IteratedUnit_UnitElement, gen_henshin_text_LoopUnit_UnitElement, gen_henshin_text_Rule_ModelElement, gen_henshin_text_Unit_ModelElement, gen_henshin_text_ORorXOR_Logic, gen_henshin_text_AND_Logic, gen_henshin_text_Not_Logic, gen_henshin_text_ConditionGraphRef_Logic, gen_henshin_text_AndExpression_Expression, gen_henshin_text_EqualityExpression_Expression, gen_henshin_text_ComparisonExpression_Expression, gen_henshin_text_PlusExpression_Expression, gen_henshin_text_MinusExpression_Expression, gen_henshin_text_Call_UnitElement, gen_henshin_text_OrExpression_Expression, gen_henshin_text_BracketExpression_Expression, gen_henshin_text_NotExpression_Expression, gen_henshin_text_ParameterValue_Expression, gen_henshin_text_JavaClassValue_Expression, gen_henshin_text_JavaAttributeValue_Expression, gen_henshin_text_StringValue_Expression, gen_henshin_text_NumberValue_Expression, gen_henshin_text_IntegerValue_Expression, gen_henshin_text_NaturalValue_Expression, gen_henshin_text_MulOrDivExpression_Expression, gen_henshin_text_BoolValue_Expression},
    metadata=None
)
