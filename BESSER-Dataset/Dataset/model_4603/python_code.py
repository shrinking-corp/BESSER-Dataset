...
class henshin_text_ConditionNodeTypes:
    ...
    def __init__(self, name: str, henshin_text_ConditionNodeTypes: "henshin_text_ConditionEdge" = None, henshin_text_ConditionNodeTypes41: "henshin_text_ConditionEdge" = None, henshin_text_ConditionNodeTypes50: "henshin_text_ConditionReuseNode" = None):
        self.name = name
...
class henshin_text_Edge:
    ...
    def __init__(self, actiontype: str, henshin_text_Edge13: "henshin_text_RuleNodeTypes" = None, henshin_text_Edge16: "henshin_text_EReference" = None, henshin_text_Edge: "henshin_text_Edges" = None, henshin_text_Edge11: "henshin_text_RuleNodeTypes" = None):
...
class ConditionNodeTypes:
    ...
    pass
class henshin_text_ConditionNode(ConditionGraphElements, ConditionNodeTypes):
...
class henshin_text_MultiRuleReuseNode(RuleNodeTypes, GraphElements):
    ...
    pass
class henshin_text_Node(GraphElements, RuleNodeTypes, ConditionNodeTypes):
