...
@given(instance=henshin_text_Parameter_strategy)
def test_hyp_henshin_text_parameter_kind_setter(instance):
...
def test_henshin_text_Parameter_kind_value_roundtrip():
    instance = henshin_text_Parameter(kind="sample_text", name="sample_text")
...
def test_assoc_parameters108_link_reassign_clear():
    a = henshin_text_Parameter(kind="sample_text", name="sample_text")
    b1 = henshin_text_Call()
    b2 = henshin_text_Call()
...
def test_assoc_type83_link_reassign_clear():
    ...
    b1 = henshin_text_Parameter(kind="sample_text", name="sample_text")
    b2 = henshin_text_Parameter(kind="sample_text_2", name="sample_text_2")
...
henshin_text_Parameter_strategy = st.builds(henshin_text_Parameter, kind=safe_text, name=safe_text)
@given(instance=henshin_text_Parameter_strategy)
@settings(max_examples=25)
