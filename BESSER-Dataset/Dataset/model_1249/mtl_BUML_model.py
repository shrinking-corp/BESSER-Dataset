...
mtl_TypedModel = Class(name="mtl_TypedModel")
mtl_ModuleElement = Class(name="mtl_ModuleElement", is_abstract=True)
ENamedElement = Class(name="ENamedElement")
utilities_ASTNode = Class(name="utilities_ASTNode")
mtl_TemplateExpression = Class(name="mtl_TemplateExpression")
OCLExpression = Class(name="OCLExpression")
mtl_Block = Class(name="mtl_Block")
TemplateExpression = Class(name="TemplateExpression")
mtl_InitSection = Class(name="mtl_InitSection")
ASTNode = Class(name="ASTNode")
Variable = Class(name="Variable")
mtl_Module = Class(name="mtl_Module")
EPackage = Class(name="EPackage")
mtl_Query = Class(name="mtl_Query")
mtl_EClassifier = Class(name="mtl_EClassifier")
mtl_QueryInvocation = Class(name="mtl_QueryInvocation")
mtl_ProtectedAreaBlock = Class(name="mtl_ProtectedAreaBlock")
mtl_ForBlock = Class(name="mtl_ForBlock")
mtl_Template = Class(name="mtl_Template")
Block = Class(name="Block")
ModuleElement = Class(name="ModuleElement")
mtl_TemplateInvocation = Class(name="mtl_TemplateInvocation")
mtl_FileBlock = Class(name="mtl_FileBlock")
mtl_TraceBlock = Class(name="mtl_TraceBlock")
mtl_Macro = Class(name="mtl_Macro")
mtl_MacroInvocation = Class(name="mtl_MacroInvocation")
mtl_EPackage = Class(name="mtl_EPackage")
mtl_IfBlock = Class(name="mtl_IfBlock")
mtl_LetBlock = Class(name="mtl_LetBlock")
mtl_Comment = Class(name="mtl_Comment")
mtl_CommentBody = Class(name="mtl_CommentBody")
mtl_Documentation = Class(name="mtl_Documentation")
Comment = Class(name="Comment")
mtl_DocumentedElement = Class(name="mtl_DocumentedElement", is_abstract=True)
mtl_ModuleDocumentation = Class(name="mtl_ModuleDocumentation")
Documentation = Class(name="Documentation")
mtl_ModuleElementDocumentation = Class(name="mtl_ModuleElementDocumentation")
mtl_ParameterDocumentation = Class(name="mtl_ParameterDocumentation")
...
mtl_CommentBody.attributes={mtl_CommentBody_value, mtl_CommentBody_startPosition, mtl_CommentBody_endPosition}
...
else_72: BinaryAssociation = BinaryAssociation(
    name="else_72",
    ends={
...
domain_model = DomainModel(
    name="mtl",
    types={DocumentedElement, mtl_TypedModel, mtl_ModuleElement, ENamedElement, utilities_ASTNode, mtl_TemplateExpression, OCLExpression, mtl_Block, TemplateExpression, mtl_InitSection, ASTNode, Variable, mtl_Module, EPackage, mtl_Query, mtl_EClassifier, mtl_QueryInvocation, mtl_ProtectedAreaBlock, mtl_ForBlock, mtl_Template, Block, ModuleElement, mtl_TemplateInvocation, mtl_FileBlock, mtl_TraceBlock, mtl_Macro, mtl_MacroInvocation, mtl_EPackage, mtl_IfBlock, mtl_LetBlock, mtl_Comment, mtl_CommentBody, mtl_Documentation, Comment, mtl_DocumentedElement, mtl_ModuleDocumentation, Documentation, mtl_ModuleElementDocumentation, mtl_ParameterDocumentation, VisibilityKind, OpenModeKind},
    associations={input0, extends2, imports5, ownedModuleElement7, init9, body10, variable12, after33, each36, parameter39, expression41, type44, definition46, argument48, marker51, loopVariable53, iterSet55, before58, overrides15, parameter16, guard19, post22, definition25, argument27, before30, fileUrl86, uniqId88, charset91, modelElement94, parameter96, type98, definition101, argument103, takesTypesFrom106, each61, after64, guard67, ifExpr70, else_72, elseIf76, elseLet79, else_80, letVariable83, body108, documentedElement109, documentation110, parametersDocumentation111},
    generalizations={gen_mtl_Module_DocumentedElement, gen_mtl_ModuleElement_ENamedElement, gen_mtl_ModuleElement_utilities_ASTNode, gen_mtl_TemplateExpression_OCLExpression, gen_mtl_Block_TemplateExpression, gen_mtl_InitSection_ASTNode, gen_mtl_Module_EPackage, gen_mtl_Query_ModuleElement, gen_mtl_Query_DocumentedElement, gen_mtl_QueryInvocation_TemplateExpression, gen_mtl_ProtectedAreaBlock_Block, gen_mtl_ForBlock_Block, gen_mtl_Template_Block, gen_mtl_Template_ModuleElement, gen_mtl_Template_DocumentedElement, gen_mtl_TemplateInvocation_TemplateExpression, gen_mtl_FileBlock_Block, gen_mtl_TraceBlock_Block, gen_mtl_Macro_Block, gen_mtl_Macro_ModuleElement, gen_mtl_Macro_DocumentedElement, gen_mtl_MacroInvocation_TemplateExpression, gen_mtl_IfBlock_Block, gen_mtl_LetBlock_Block, gen_mtl_ParameterDocumentation_Comment, gen_mtl_Comment_ModuleElement, gen_mtl_Documentation_Comment, gen_mtl_ModuleDocumentation_Documentation, gen_mtl_ModuleElementDocumentation_Documentation},
    metadata=None
)
