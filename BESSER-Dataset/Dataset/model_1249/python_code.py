...
class mtl_IfBlock(Block):
    ...
    pass
class mtl_Macro(ModuleElement, Block, DocumentedElement):
...
class mtl_Template(ModuleElement, Block, DocumentedElement):
...
class mtl_TemplateInvocation(TemplateExpression):
    ...
    def __init__(self, super: bool, mtl_TemplateInvocation34: "OCLExpression" = None, mtl_TemplateInvocation37: "OCLExpression" = None, mtl_TemplateInvocation: "mtl_Template" = None, mtl_TemplateInvocation28: set["OCLExpression"] = None, mtl_TemplateInvocation31: "OCLExpression" = None):
        self.super = super
