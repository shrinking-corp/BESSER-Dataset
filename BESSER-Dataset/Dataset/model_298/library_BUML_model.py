...
library_Writer_m_writeBook: Method = Method(name="writeBook", parameters={Parameter(name='library_pages', type=StringType), Parameter(name='library_booksname', type=StringType), Parameter(name='library_category', type=StringType)})
