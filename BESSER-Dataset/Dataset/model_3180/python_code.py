...
class rell_Comparison(Expression):
    ...
    def __init__(self, op: str, rell_Comparison73: "rell_Expression" = None, rell_Comparison: "rell_Expression" = None):
        self.op = op
...
class rell_ConditionElement:
    ...
    def __init__(self, compareName: str, rell_ConditionElement: "rell_Conditions" = None, rell_ConditionElement26: "rell_Expression" = None):
...
class rell_VariableDeclaration:
    ...
    def __init__(self, name: str, rell_VariableDeclaration: "rell_Variable" = None, rell_VariableDeclaration86: "rell_VariableRef" = None, rell_VariableDeclaration33: "rell_VariableInit" = None, rell_VariableDeclaration42: "rell_RelAttrubutesList" = None, rell_VariableDeclaration45: "rell_Attribute" = None, rell_VariableDeclaration47: "rell_TypeReference" = None):
        self.name = name
