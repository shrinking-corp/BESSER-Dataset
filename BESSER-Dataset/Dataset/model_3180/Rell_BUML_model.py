...
# Classes
rell_Model = Class(name="rell_Model")
rell_ClassDefinition = Class(name="rell_ClassDefinition")
rell_Operation = Class(name="rell_Operation")
rell_Attribute = Class(name="rell_Attribute")
rell_RelAttrubutesList = Class(name="rell_RelAttrubutesList")
rell_Statement = Class(name="rell_Statement")
rell_Variable = Class(name="rell_Variable")
Statement = Class(name="Statement")
rell_VariableDeclaration = Class(name="rell_VariableDeclaration")
rell_Expression = Class(name="rell_Expression")
rell_Update = Class(name="rell_Update")
Relational = Class(name="Relational")
rell_VariableInit = Class(name="rell_VariableInit")
rell_Delete = Class(name="rell_Delete")
rell_Create = Class(name="rell_Create")
rell_ConditionElement = Class(name="rell_ConditionElement")
rell_TypeReference = Class(name="rell_TypeReference")
rell_PrimitiveType = Class(name="rell_PrimitiveType")
rell_ClassType = Class(name="rell_ClassType")
rell_Or = Class(name="rell_Or")
Expression = Class(name="Expression")
rell_And = Class(name="rell_And")
rell_Relational = Class(name="rell_Relational")
rell_Conditions = Class(name="rell_Conditions")
rell_Comparison = Class(name="rell_Comparison")
rell_Plus = Class(name="rell_Plus")
rell_Minus = Class(name="rell_Minus")
rell_IntConstant = Class(name="rell_IntConstant")
rell_StringConstant = Class(name="rell_StringConstant")
rell_BoolConstant = Class(name="rell_BoolConstant")
rell_VariableRef = Class(name="rell_VariableRef")
rell_MulOrDiv = Class(name="rell_MulOrDiv")
rell_Not = Class(name="rell_Not")
rell_Equality = Class(name="rell_Equality")
...
or_38: BinaryAssociation = BinaryAssociation(
    name="or_38",
    ends={
...
domain_model = DomainModel(
    name="rell",
    types={rell_Model, rell_ClassDefinition, rell_Operation, rell_Attribute, rell_RelAttrubutesList, rell_Statement, rell_Variable, Statement, rell_VariableDeclaration, rell_Expression, rell_Update, Relational, rell_VariableInit, rell_Delete, rell_Create, rell_ConditionElement, rell_TypeReference, rell_PrimitiveType, rell_ClassType, rell_Or, Expression, rell_And, rell_Relational, rell_Conditions, rell_Comparison, rell_Plus, rell_Minus, rell_IntConstant, rell_StringConstant, rell_BoolConstant, rell_VariableRef, rell_MulOrDiv, rell_Not, rell_Equality},
    associations={entities0, operations1, superType4, attributes6, parameters8, statements10, variable13, declaration14, expression16, variableList22, elements23, expr25, varInit29, name31, expression34, or_38, value40, variable43, type46, primitive48, entityType50, entityRef52, left55, right57, relation19, conditions20, right67, left70, right72, left75, right77, left80, right82, variable85, left87, right89, expression92, left60, right62, left65},
    generalizations={gen_rell_Variable_Statement, gen_rell_Update_Relational, gen_rell_Delete_Relational, gen_rell_Create_Relational, gen_rell_VariableInit_Statement, gen_rell_Or_Expression, gen_rell_And_Expression, gen_rell_Relational_Statement, gen_rell_Comparison_Expression, gen_rell_Plus_Expression, gen_rell_Minus_Expression, gen_rell_IntConstant_Expression, gen_rell_StringConstant_Expression, gen_rell_BoolConstant_Expression, gen_rell_VariableRef_Expression, gen_rell_MulOrDiv_Expression, gen_rell_Not_Expression, gen_rell_Equality_Expression},
    metadata=None
)
