...
class cmof_ElementImport(DirectedRelationship):
    ...
    def imported_element_is_public(self, cmof_context, cmof_diagnostics) :
...
class cmof_Constraint(PackageableElement):
    ...
    def __init__(self, Constraint: "cmof_Namespace" = None, cmof_Constraint: set["cmof_Element"] = None, cmof_Constraint89: "cmof_ValueSpecification" = None, ownedRule: "cmof_Namespace" = None, cmof_Constraint112: "cmof_Operation" = None, cmof_Constraint115: "cmof_Operation" = None, cmof_Constraint107: "cmof_Operation" = None):
    ...
    def no_side_effects(self, cmof_context, cmof_diagnostics) :
        # TODO: Implement no_side_effects method
        pass

class cmof_Type(PackageableElement):

    def __init__(self, cmof_Type146: "cmof_Association" = None, ownedType_one: "cmof_Package" = None, Type: "cmof_Package" = None, cmof_Type: "cmof_TypedElement" = None, cmof_Type121: "cmof_Operation" = None, cmof_Type128: "cmof_BehavioralFeature" = None):
...
class cmof_Operation(BehavioralFeature):
    ...
    def __init__(self, isOrdered: str, isQuery: str, isUnique: str, lower: str, upper: str, Operation: "cmof_Class" = None, Operation144: "cmof_DataType" = None, cmof_Operation111: set["cmof_Constraint"] = None, cmof_Operation114: set["cmof_Constraint"] = None, cmof_Operation118: "cmof_Operation" = None, cmof_Operation116: set["cmof_Operation"] = None, cmof_Operation: "cmof_Constraint" = None, ownedOperation: "cmof_DataType" = None, cmof_Operation134: "cmof_Parameter" = None, cmof_Operation120: "cmof_Type" = None, ownedOperation123: "cmof_Class" = None):
...
class cmof_MultiplicityElement(Element):
    ...
    def value_specification_constant(self, cmof_diagnostics, cmof_context) :
...
class cmof_NamedElement(Element):
    ...
    def __init__(self, name: str, qualifiedName: str, visibility: str, cmof_NamedElement: "cmof_Classifier" = None, ownedMember: "cmof_Namespace" = None, cmof_NamedElement70: "cmof_Namespace" = None, NamedElement: "cmof_Namespace" = None):
        self.name = name
    ...
    def visibility_needs_ownership(self, cmof_diagnostics, cmof_context) :
...
class cmof_Classifier(Namespace, RedefinableElement, Type):
    ...
    def __init__(self, isAbstract: str, isFinalSpecialization: str, cmof_Classifier48: "cmof_Classifier" = None, cmof_Classifier46: set["cmof_Classifier"] = None, specific: set["cmof_Generalization"] = None, cmof_Classifier43: set["cmof_Property"] = None, cmof_Classifier51: set["cmof_NamedElement"] = None, Classifier: "cmof_Feature" = None, cmof_Classifier: "cmof_RedefinableElement" = None, cmof_Classifier35: "cmof_Class" = None, featuringClassifier: set["cmof_Feature"] = None, cmof_Classifier54: "cmof_Classifier" = None, cmof_Classifier52: set["cmof_Classifier"] = None, cmof_Classifier103: "cmof_Generalization" = None, Classifier105: "cmof_Generalization" = None, cmof_Classifier158: "cmof_InstanceSpecification" = None):
...
class cmof_Parameter(MultiplicityElement, TypedElement):
    ...
    def __init__(self, direction: str, default: str, cmof_Parameter133: "cmof_Operation" = None, cmof_Parameter: "cmof_BehavioralFeature" = None, cmof_Parameter130: "cmof_ValueSpecification" = None):
...
class cmof_Association(Classifier, Relationship):
    ...
    def specialized_end_number(self, cmof_context, cmof_diagnostics) :
...
class cmof_Property(StructuralFeature):
    ...
    def __init__(self, aggregation: str, default: str, isComposite: str, isDerived: str, isDerivedUnion: str, isID: str, cmof_Property44: "cmof_Classifier" = None, ownedAttribute: "cmof_Class" = None, ownedAttribute2: "cmof_DataType" = None, memberEnd: "cmof_Association" = None, ownedEnd: "cmof_Association" = None, cmof_Property12: "cmof_Property" = None, cmof_Property10: set["cmof_Property"] = None, cmof_Property15: "cmof_Property" = None, cmof_Property13: set["cmof_Property"] = None, cmof_Property: "cmof_ValueSpecification" = None, cmof_Property9: "cmof_Property" = None, cmof_Property7: "cmof_Property" = None, Property: "cmof_Class" = None, cmof_Property149: "cmof_Association" = None, Property151: "cmof_Association" = None, Property141: "cmof_DataType" = None, Property153: "cmof_Association" = None):
