...
public class cmof_Classifier extends Namespace, RedefinableElement, Type {
    ...
    public cmof_Classifier(
        String isAbstract,        String isFinalSpecialization        ArrayList<cmof_Feature> cmof_features,        ArrayList<cmof_Classifier> cmof_classifiers,        ArrayList<cmof_Property> cmof_propertys    ) {
        this.isAbstract = isAbstract;
        this.isFinalSpecialization = isFinalSpecialization;
