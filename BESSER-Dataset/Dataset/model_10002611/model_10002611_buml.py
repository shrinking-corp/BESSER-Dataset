...
Order.attributes={Order_shipTo, Order_total, Order_status, Order_ordered, Order_shipped, Order_number}
...
domain_model = DomainModel(
    name="c6333731_a769_4617_aa88_22c9d7e21e00",
    types={Customer, Payment, ShoppingCart, Account, WebUser, Order, LineItem, Product, UserState, OrderStatus},
    associations={ShoppingCart_LineItem, Product_LineItem, Order_LineItem, Account_Payment, WebUser_ShoppingCart, WebUser_Customer, Customer_Account, Account_ShoppingCart, Account_Order, Payment_Order},
    generalizations={},
    metadata=None
)
