...
# Classes
eol_types_Type = Class(name="eol_types_Type")
eol_types_AnyType = Class(name="eol_types_AnyType")
Type = Class(name="Type")
eol_types_ModelType = Class(name="eol_types_ModelType")
AnyType = Class(name="AnyType")
eol_types_ModelElementType = Class(name="eol_types_ModelElementType")
eol_types_PseudoType = Class(name="eol_types_PseudoType", is_abstract=True)
eol_types_SelfType = Class(name="eol_types_SelfType")
PseudoType = Class(name="PseudoType")
eol_types_SelfContentType = Class(name="eol_types_SelfContentType")
eol_types_MapType = Class(name="eol_types_MapType")
eol_types_BagType = Class(name="eol_types_BagType")
CollectionType = Class(name="CollectionType")
eol_types_OrderedCollectionType = Class(name="eol_types_OrderedCollectionType", is_abstract=True)
eol_types_UniqueCollectionType = Class(name="eol_types_UniqueCollectionType", is_abstract=True)
eol_types_SetType = Class(name="eol_types_SetType")
UniqueCollectionType = Class(name="UniqueCollectionType")
eol_types_OrderedSetType = Class(name="eol_types_OrderedSetType")
OrderedCollectionType = Class(name="OrderedCollectionType")
eol_types_SequenceType = Class(name="eol_types_SequenceType")
eol_types_PrimitiveType = Class(name="eol_types_PrimitiveType", is_abstract=True)
eol_types_BooleanType = Class(name="eol_types_BooleanType")
PrimitiveType = Class(name="PrimitiveType")
eol_types_RealType = Class(name="eol_types_RealType")
eol_types_IntegerType = Class(name="eol_types_IntegerType")
RealType = Class(name="RealType")
eol_types_StringType = Class(name="eol_types_StringType")
eol_types_NativeType = Class(name="eol_types_NativeType")
eol_types_VoidType = Class(name="eol_types_VoidType")
eol_types_InvalidType = Class(name="eol_types_InvalidType")
eol_types_CollectionType = Class(name="eol_types_CollectionType")
...
eol_types_ModelElementType.attributes={eol_types_ModelElementType_elementName, eol_types_ModelElementType_modelName}
