...
GameView.attributes={GameView_showStrategy, GameView_splitButton, GameView_bet, GameView_dealButton, GameView_hitButton, GameView_standButton, GameView_doubleButton}
...
Player.attributes={Player_profile, Player_hand, Player_money}
...
PlayerView.attributes={PlayerView_moneyBox, PlayerView_status, PlayerView_busted, PlayerView_player, PlayerView_cardTotal, PlayerView_cardLabels}
...
BlackjackGame.attributes={BlackjackGame_player, BlackjackGame_deck, BlackjackGame_dealer, BlackjackGame_bet}
...
Card.attributes={Card_suit, Card_avatar, Card_name, Card_valueSoft, Card_Count, Card_rank, Card_valueHard}
...
domain_model = DomainModel(
    name="f65d0e45_69a1_471c_affd_1dfdf6c9282f",
    ...
    associations={Dealer_Blackjack, Blackjack_Deck, BasePlayer_PlayerView, Player_Profile, Dealer_Hand, Player_Hand, Hand_Card, Deck_Card, LoginView_Profile2, GameLauncher_LoginView, Profile_Blackjack, Blackjack_GameView, Blackjack_Strategy, PlayerView_GameView, Player_Blackjack},
    generalizations={},
    metadata=None
)
