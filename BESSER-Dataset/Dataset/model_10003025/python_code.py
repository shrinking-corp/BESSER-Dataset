...
class Card:
    ...
    def __init__(self, rank: str, Count: int, name: str, avatar: str, valueSoft: str, valueHard: str, suit: str, hand27: "Hand" = None, deck29: "Deck" = None):
        self.rank = rank
        self.Count = Count
        self.name = name
        self.avatar = avatar
...
class BlackjackGame:
    ...
    def __init__(self, deck: Deck, dealer: Dealer, player: Player, bet: int, dealer15: "Dealer" = None, deck216: "Deck" = None, profile5: "Profile" = None, gameView6: "GameView" = None, strategy8: "Strategy" = None, player13: "Player" = None):
        self.deck = deck
        self.dealer = dealer
        self.player = player
        self.bet = bet
...
class PlayerView:
    ...
    def __init__(self, cardLabels: JLabel, cardTotal: JLabel, busted: JLabel, moneyBox: JLabel, status: JLabel, player: BasePlayer, basePlayer19: "BasePlayer" = None, gameView10: "GameView" = None):
...
class Player:
    ...
    def __init__(self, hand: Hand, profile: Profile, money: int, profile220: "Profile" = None, hand24: set["Hand"] = None, blackjack12: "BlackjackGame" = None):
        self.hand = hand
