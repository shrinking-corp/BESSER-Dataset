...
def test_hyp_megal_querystatement_is_not_abstract():
    assert not inspect.isabstract(megal_QueryStatement)


def test_hyp_megal_querystatement_constructor_exists():
    assert callable(megal_QueryStatement.__init__)


def test_hyp_megal_querystatement_constructor_args():
    sig = inspect.signature(megal_QueryStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_megal_queryentry_is_not_abstract():
    assert not inspect.isabstract(megal_QueryEntry)


def test_hyp_megal_queryentry_constructor_exists():
    assert callable(megal_QueryEntry.__init__)


def test_hyp_megal_queryentry_constructor_args():
    sig = inspect.signature(megal_QueryEntry.__init__)
    params = list(sig.parameters.keys())



def test_hyp_queryentry_is_not_abstract():
    assert not inspect.isabstract(QueryEntry)


def test_hyp_queryentry_constructor_exists():
    assert callable(QueryEntry.__init__)


def test_hyp_queryentry_constructor_args():
    sig = inspect.signature(QueryEntry.__init__)
    params = list(sig.parameters.keys())



def test_hyp_megal_queryreference_is_not_abstract():
    assert not inspect.isabstract(megal_QueryReference)


def test_hyp_megal_queryreference_constructor_exists():
    assert callable(megal_QueryReference.__init__)


def test_hyp_megal_queryreference_constructor_args():
    sig = inspect.signature(megal_QueryReference.__init__)
    params = list(sig.parameters.keys())



def test_hyp_megal_queryentity_is_not_abstract():
    assert not inspect.isabstract(megal_QueryEntity)


def test_hyp_megal_queryentity_constructor_exists():
    assert callable(megal_QueryEntity.__init__)


def test_hyp_megal_queryentity_constructor_args():
    sig = inspect.signature(megal_QueryEntity.__init__)
    params = list(sig.parameters.keys())



def test_hyp_megal_querystring_is_not_abstract():
    assert not inspect.isabstract(megal_QueryString)


def test_hyp_megal_querystring_constructor_exists():
    assert callable(megal_QueryString.__init__)


def test_hyp_megal_querystring_constructor_args():
...
def test_hyp_megal_querypos_is_not_abstract():
    assert not inspect.isabstract(megal_QueryPos)


def test_hyp_megal_querypos_constructor_exists():
    assert callable(megal_QueryPos.__init__)


def test_hyp_megal_querypos_constructor_args():
...
def test_hyp_megal_queryparam_is_not_abstract():
    assert not inspect.isabstract(megal_QueryParam)


def test_hyp_megal_queryparam_constructor_exists():
    assert callable(megal_QueryParam.__init__)


def test_hyp_megal_queryparam_constructor_args():
...
def test_hyp_megaldeclaration_is_not_abstract():
    assert not inspect.isabstract(MegalDeclaration)


def test_hyp_megaldeclaration_constructor_exists():
    assert callable(MegalDeclaration.__init__)


def test_hyp_megaldeclaration_constructor_args():
    sig = inspect.signature(MegalDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_megal_megalpair_is_not_abstract():
    assert not inspect.isabstract(megal_MegalPair)


def test_hyp_megal_megalpair_constructor_exists():
    assert callable(megal_MegalPair.__init__)


def test_hyp_megal_megalpair_constructor_args():
    sig = inspect.signature(megal_MegalPair.__init__)
    params = list(sig.parameters.keys())



def test_hyp_megal_megalrelationship_is_not_abstract():
    assert not inspect.isabstract(megal_MegalRelationship)


def test_hyp_megal_megalrelationship_constructor_exists():
    assert callable(megal_MegalRelationship.__init__)


def test_hyp_megal_megalrelationship_constructor_args():
    sig = inspect.signature(megal_MegalRelationship.__init__)
    params = list(sig.parameters.keys())



def test_hyp_megalnamed_is_not_abstract():
    assert not inspect.isabstract(MegalNamed)


def test_hyp_megalnamed_constructor_exists():
    assert callable(MegalNamed.__init__)


def test_hyp_megalnamed_constructor_args():
    sig = inspect.signature(MegalNamed.__init__)
    params = list(sig.parameters.keys())



def test_hyp_megal_megalrelationshiptype_is_not_abstract():
    assert not inspect.isabstract(megal_MegalRelationshipType)


def test_hyp_megal_megalrelationshiptype_constructor_exists():
    assert callable(megal_MegalRelationshipType.__init__)


def test_hyp_megal_megalrelationshiptype_constructor_args():
...
def test_hyp_megal_megalentitytype_is_not_abstract():
    assert not inspect.isabstract(megal_MegalEntityType)


def test_hyp_megal_megalentitytype_constructor_exists():
    assert callable(megal_MegalEntityType.__init__)


def test_hyp_megal_megalentitytype_constructor_args():
    sig = inspect.signature(megal_MegalEntityType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_megal_megalnamed_is_not_abstract():
    assert not inspect.isabstract(megal_MegalNamed)


def test_hyp_megal_megalnamed_constructor_exists():
    assert callable(megal_MegalNamed.__init__)


def test_hyp_megal_megalnamed_constructor_args():
...
def test_hyp_megal_megalentity_is_not_abstract():
    assert not inspect.isabstract(megal_MegalEntity)


def test_hyp_megal_megalentity_constructor_exists():
    assert callable(megal_MegalEntity.__init__)


def test_hyp_megal_megalentity_constructor_args():
...
def test_hyp_megalelement_is_not_abstract():
    assert not inspect.isabstract(MegalElement)


def test_hyp_megalelement_constructor_exists():
    assert callable(MegalElement.__init__)


def test_hyp_megalelement_constructor_args():
    sig = inspect.signature(MegalElement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_megal_megallink_is_not_abstract():
    assert not inspect.isabstract(megal_MegalLink)


def test_hyp_megal_megallink_constructor_exists():
    assert callable(megal_MegalLink.__init__)


def test_hyp_megal_megallink_constructor_args():
...
def test_hyp_megal_megaldeclaration_is_not_abstract():
    assert not inspect.isabstract(megal_MegalDeclaration)


def test_hyp_megal_megaldeclaration_constructor_exists():
    assert callable(megal_MegalDeclaration.__init__)


def test_hyp_megal_megaldeclaration_constructor_args():
    sig = inspect.signature(megal_MegalDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_megal_megalfile_is_not_abstract():
    assert not inspect.isabstract(megal_MegalFile)


def test_hyp_megal_megalfile_constructor_exists():
    assert callable(megal_MegalFile.__init__)


def test_hyp_megal_megalfile_constructor_args():
...
def test_hyp_megal_megalelement_is_not_abstract():
    assert not inspect.isabstract(megal_MegalElement)


def test_hyp_megal_megalelement_constructor_exists():
    assert callable(megal_MegalElement.__init__)


def test_hyp_megal_megalelement_constructor_args():
    sig = inspect.signature(megal_MegalElement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_megal_selection_is_not_abstract():
    assert not inspect.isabstract(megal_Selection)


def test_hyp_megal_selection_constructor_exists():
    assert callable(megal_Selection.__init__)


def test_hyp_megal_selection_constructor_args():
    sig = inspect.signature(megal_Selection.__init__)
    params = list(sig.parameters.keys())



def test_hyp_megal_megalannotation_is_not_abstract():
    assert not inspect.isabstract(megal_MegalAnnotation)


def test_hyp_megal_megalannotation_constructor_exists():
    assert callable(megal_MegalAnnotation.__init__)


def test_hyp_megal_megalannotation_constructor_args():
...
def test_hyp_megal_querystring_value_setter(instance):
...
def test_hyp_megal_querypos_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_megal_queryparam_name_setter(instance):
...
def test_hyp_megal_megalrelationshiptype_rightBoth_setter(instance):
...
@given(instance=megal_MegalRelationshipType_strategy)
def test_hyp_megal_megalrelationshiptype_rightMany_setter(instance):
...
@given(instance=megal_MegalRelationshipType_strategy)
def test_hyp_megal_megalrelationshiptype_leftBoth_setter(instance):
...
@given(instance=megal_MegalRelationshipType_strategy)
def test_hyp_megal_megalrelationshiptype_leftMany_setter(instance):
...
def test_hyp_megal_megalnamed_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_megal_megalentity_many_setter(instance):
...
def test_hyp_megal_megallink_to_setter(instance):
...
def test_hyp_megal_megalfile_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_megal_megalannotation_key_setter(instance):
