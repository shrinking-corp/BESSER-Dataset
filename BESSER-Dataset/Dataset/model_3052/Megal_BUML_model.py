...
# Classes
megal_MegalAnnotation = Class(name="megal_MegalAnnotation")
megal_Selection = Class(name="megal_Selection")
megal_MegalElement = Class(name="megal_MegalElement", is_abstract=True)
megal_MegalFile = Class(name="megal_MegalFile")
MegalElement = Class(name="MegalElement")
megal_MegalDeclaration = Class(name="megal_MegalDeclaration", is_abstract=True)
megal_MegalLink = Class(name="megal_MegalLink")
megal_MegalEntity = Class(name="megal_MegalEntity")
megal_MegalNamed = Class(name="megal_MegalNamed", is_abstract=True)
megal_MegalEntityType = Class(name="megal_MegalEntityType")
MegalNamed = Class(name="MegalNamed")
megal_MegalRelationship = Class(name="megal_MegalRelationship")
MegalDeclaration = Class(name="MegalDeclaration")
megal_MegalRelationshipType = Class(name="megal_MegalRelationshipType")
megal_MegalPair = Class(name="megal_MegalPair")
megal_QueryParam = Class(name="megal_QueryParam")
QueryEntry = Class(name="QueryEntry")
megal_QueryReference = Class(name="megal_QueryReference")
megal_QueryString = Class(name="megal_QueryString")
megal_QueryEntity = Class(name="megal_QueryEntity")
megal_QueryPos = Class(name="megal_QueryPos")
megal_QueryEntry = Class(name="megal_QueryEntry", is_abstract=True)
megal_QueryStatement = Class(name="megal_QueryStatement")
...
megal_MegalRelationshipType.attributes={megal_MegalRelationshipType_leftBoth, megal_MegalRelationshipType_rightBoth, megal_MegalRelationshipType_leftMany, megal_MegalRelationshipType_rightMany}
...
domain_model = DomainModel(
    name="megal",
    types={megal_MegalAnnotation, megal_Selection, megal_MegalElement, megal_MegalFile, MegalElement, megal_MegalDeclaration, megal_MegalLink, megal_MegalEntity, megal_MegalNamed, megal_MegalEntityType, MegalNamed, megal_MegalRelationship, MegalDeclaration, megal_MegalRelationshipType, megal_MegalPair, megal_QueryParam, QueryEntry, megal_QueryReference, megal_QueryString, megal_QueryEntity, megal_QueryPos, megal_QueryEntry, megal_QueryStatement},
    associations={selection0, annotations1, declarations3, bindings4, imports7, link9, first11, set24, first26, second29, supertype33, left34, right37, leftParams40, rightParams43, type46, second14, type17, left18, right21, predicate59, object62, type65, ref67, entity69, params50, select52, query54, subject56},
    generalizations={gen_megal_MegalFile_MegalElement, gen_megal_MegalLink_MegalElement, gen_megal_MegalNamed_MegalDeclaration, gen_megal_MegalEntityType_MegalNamed, gen_megal_MegalRelationshipType_MegalNamed, gen_megal_MegalEntity_MegalNamed, gen_megal_MegalDeclaration_MegalElement, gen_megal_MegalRelationship_MegalDeclaration, gen_megal_MegalPair_MegalDeclaration, gen_megal_QueryParam_QueryEntry, gen_megal_QueryReference_QueryEntry, gen_megal_QueryString_QueryEntry, gen_megal_QueryEntity_QueryEntry, gen_megal_QueryPos_QueryEntry},
    metadata=None
)
