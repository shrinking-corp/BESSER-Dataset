...
swml_ContentLayer = Class(name="swml_ContentLayer")
swml_Page = Class(name="swml_Page", is_abstract=True)
swml_Class = Class(name="swml_Class")
swml_Attribute = Class(name="swml_Attribute")
swml_HypertextLayer = Class(name="swml_HypertextLayer")
swml_IndexPage = Class(name="swml_IndexPage")
DynamicPage = Class(name="DynamicPage")
swml_DetailsPage = Class(name="swml_DetailsPage")
swml_DynamicPage = Class(name="swml_DynamicPage")
Page = Class(name="Page")
swml_StaticPage = Class(name="swml_StaticPage")
swml_NCLink = Class(name="swml_NCLink")
Link = Class(name="Link")
swml_CLink = Class(name="swml_CLink")
swml_Link = Class(name="swml_Link")
...
domain_model = DomainModel(
    name="swml",
    types={swml_WebModel, swml_ContentLayer, swml_Page, swml_Class, swml_Attribute, swml_HypertextLayer, swml_IndexPage, DynamicPage, swml_DetailsPage, swml_DynamicPage, Page, swml_StaticPage, swml_NCLink, Link, swml_CLink, swml_Link, SWMLTypes},
    associations={hypertext0, content1, pages3, homePage5, classes8, attributes10, representativeAttribute12, displayedClass17, target19, links15},
