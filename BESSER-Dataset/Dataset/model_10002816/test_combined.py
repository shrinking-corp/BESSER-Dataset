...
def test_hyp_recollector_is_not_abstract():
    assert not inspect.isabstract(Recollector)


def test_hyp_recollector_constructor_exists():
    assert callable(Recollector.__init__)


def test_hyp_recollector_constructor_args():
...
def test_hyp_user_account_password_setter(instance):
...
@given(instance=User_Account_strategy)
def test_hyp_user_account_full_name_setter(instance):
...
@given(instance=User_Account_strategy)
def test_hyp_user_account_telephone_setter(instance):
...
def test_hyp_recollector_longitude_setter(instance):
...
@given(instance=Recollector_strategy)
def test_hyp_recollector_full_name_setter(instance):
    original = instance.full_name
    instance.full_name = original
    assert instance.full_name == original
...
@given(instance=Recollector_strategy)
def test_hyp_recollector_latitude_setter(instance):
...
@given(instance=Recollector_strategy)
def test_hyp_recollector_id_setter(instance):
...
@given(instance=Recollector_strategy)
def test_hyp_recollector_telephone_setter(instance):
    original = instance.telephone
    instance.telephone = original
    assert instance.telephone == original
...
def test_Recollector_full_name_value_roundtrip():
    instance = Recollector(full_name="sample_text", id="sample_text", latitude="sample_text", longitude="sample_text", telephone="sample_text")
    assert instance.full_name == "sample_text"
    instance.full_name = "sample_text_2"
    assert instance.full_name == "sample_text_2"


def test_Recollector_id_value_roundtrip():
    instance = Recollector(full_name="sample_text", id="sample_text", latitude="sample_text", longitude="sample_text", telephone="sample_text")
...
def test_Recollector_latitude_value_roundtrip():
    instance = Recollector(full_name="sample_text", id="sample_text", latitude="sample_text", longitude="sample_text", telephone="sample_text")
...
def test_Recollector_longitude_value_roundtrip():
    instance = Recollector(full_name="sample_text", id="sample_text", latitude="sample_text", longitude="sample_text", telephone="sample_text")
...
def test_Recollector_telephone_value_roundtrip():
    instance = Recollector(full_name="sample_text", id="sample_text", latitude="sample_text", longitude="sample_text", telephone="sample_text")
...
def test_User_Account_email_value_roundtrip():
    instance = User_Account(email="sample_text", full_name="sample_text", password="sample_text", telephone="sample_text")
    assert instance.email == "sample_text"
    instance.email = "sample_text_2"
    assert instance.email == "sample_text_2"


def test_User_Account_full_name_value_roundtrip():
    instance = User_Account(email="sample_text", full_name="sample_text", password="sample_text", telephone="sample_text")
    assert instance.full_name == "sample_text"
    instance.full_name = "sample_text_2"
    assert instance.full_name == "sample_text_2"
...
def test_User_Account_password_value_roundtrip():
    instance = User_Account(email="sample_text", full_name="sample_text", password="sample_text", telephone="sample_text")
...
def test_User_Account_telephone_value_roundtrip():
    instance = User_Account(email="sample_text", full_name="sample_text", password="sample_text", telephone="sample_text")
    assert instance.telephone == "sample_text"
    instance.telephone = "sample_text_2"
    assert instance.telephone == "sample_text_2"
...
Recollector_strategy = st.builds(Recollector, full_name=safe_text, id=safe_text, latitude=safe_text, longitude=safe_text, telephone=safe_text)
@given(instance=Recollector_strategy)
@settings(max_examples=25)
...
User_Account_strategy = st.builds(User_Account, email=safe_text, full_name=safe_text, password=safe_text, telephone=safe_text)
@given(instance=User_Account_strategy)
@settings(max_examples=25)
