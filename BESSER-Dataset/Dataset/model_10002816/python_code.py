...
class Order:
    ...
    def __init__(self, shipped: bool, shipTo: str, total: float, status: OrderStatus, number: int, ordered: date, items8: set["LineItem"] = None, account11: "Account" = None, payment13: "Payment" = None):
...
class User_Account:
    ...
    def __init__(self, email: str, password: str, full_name: str, telephone: str):
        self.email = email
...
class Account:
    ...
    def __init__(self, billingAddress: str, open: date, closed: date, isClosed: bool, p0: set["Payment"] = None, cart2: "ShoppingCart" = None, order10: set["Order"] = None):
...
class ShoppingCart:
    ...
    def __init__(self, creationDate: date, account3: "Account" = None, items4: "LineItem" = None):
...
class Recollector:
    ...
    def __init__(self, id: str, full_name: str, telephone: str, latitude: str, longitude: str):
        self.id = id
        self.full_name = full_name
        self.telephone = telephone
