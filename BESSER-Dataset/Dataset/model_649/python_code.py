...
class mm2_Member:
    ...
    def __init__(self, name: str, mm2_Member12: set["mm2_Medium"] = None, mm2_Member: "mm2_Library" = None):
        self.name = name
...
class mm2_Library:
    ...
    def __init__(self, name: str, mm2_Library2: set["mm2_Medium"] = None, mm2_Library4: set["mm2_Category"] = None, mm2_Library: set["mm2_Member"] = None):
        self.name = name
