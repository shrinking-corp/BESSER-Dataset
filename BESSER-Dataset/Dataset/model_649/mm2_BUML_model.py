...
# Classes
mm2_Library = Class(name="mm2_Library")
mm2_Medium = Class(name="mm2_Medium")
mm2_Category = Class(name="mm2_Category")
mm2_Member = Class(name="mm2_Member")
...
mm2_Medium.attributes={mm2_Medium_name, mm2_Medium_type}
...
domain_model = DomainModel(
    name="mm2",
    types={mm2_Library, mm2_Medium, mm2_Category, mm2_Member},
    associations={mediums1, categories3, categories6, mediums8, loans11, members0},
    generalizations={},
    metadata=None
)
