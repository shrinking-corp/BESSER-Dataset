...
java_Class_declaration.attributes={java_Class_declaration_className, java_Class_declaration_modifiers, java_Class_declaration_extend, java_Class_declaration_implement, java_Class_declaration_implements}
...
java_Expression.attributes={java_Expression_name, java_Expression_super, java_Expression_null, java_Expression_this}
...
java_Expression_aux.attributes={java_Expression_aux_numericSign, java_Expression_aux_bitSign, java_Expression_aux_sgin, java_Expression_aux_logicalSign, java_Expression_aux_testingSign, java_Expression_aux_stringSign, java_Expression_aux_name}
...
java_Logical_Expression_NR.attributes={java_Logical_Expression_NR_false, java_Logical_Expression_NR_true}
...
java_Literal_Expression.attributes={java_Literal_Expression_exp1, java_Literal_Expression_string, java_Literal_Expression_char, java_Literal_Expression_exp}
...
java_Float_Literal.attributes={java_Float_Literal_exp, java_Float_Literal_floatTypeSufix, java_Float_Literal_decimalDigits1, java_Float_Literal_decimalDigits2}
...
java_Try_statement.attributes={java_Try_statement_finally_, java_Try_statement_try_, java_Try_statement_catchs}
...
try_135: BinaryAssociation = BinaryAssociation(
    name="try_135",
    ends={
...
domain_model = DomainModel(
    name="java",
    types={java_Head, java_Compilation_unit, java_Package_statement, java_Import_statement, java_Type_declaration, java_EObject, java_Interface_declaration, java_Method_declaration, java_Type, java_Parameter_list, java_Statement_block, java_Method_call, Return_value, java_Parameter_list_method_call, java_Constructor_declaration, java_Field_declaration, java_Class_declaration, java_Variable_declarator, java_Variable_initializer, java_Expression, java_Numeric_Expression_NR, java_Expression_aux, java_Logical_Expression_NR, java_Bit_Expression_NR, java_Cast_Expression, java_Creating_Expression, java_Literal_Expression, java_Parameter, java_Variable_declaration, java_Ampersand_Rule, java_Float_Literal, java_Arg_List, java_Static_initializer, Statement, java_Statement, java_Return_Statement, java_If_Statement, java_Do_Statement, java_While_Statement, java_For_Statement, java_Switch_Statement, java_Try_statement, java_Return_value},
    associations={elements0, package1, imports3, type_declarations5, name7, fields10, name12, type15, parameter16, statement18, parameter20, parameters21, statement23, fields9, type34, name36, names38, initializer41, expression43, variableInitializer146, variableIniatializer249, numericExpression351, aux53, logicalExpression55, bitExpression57, castExpression59, creatingExpression61, literalExpression63, parameter26, parameters28, type31, exp273, exp176, ampersand79, expressionBit81, exp284, argList65, aux68, expression101, expression270, expression104, expressions107, expression110, name113, statements115, returnSmt117, variable119, expressionx122, argList86, expression89, type92, expression95, expression98, statement138, expression140, expressions143, statements146, variable149, expression152, expression2155, expression3158, statement161, expression164, ifStatement125, doStatement127, whileStatement129, forStatement131, switchStatement133, try_135, statement179, elseStatement182, rv185, tryStatement187, RIGHT_PARENTHESISparameters190, catchStatements193, finallyStatement196, statement167, statement170, expression173, expression176},
