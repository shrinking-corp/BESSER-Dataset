...
class metamodel_ConnectionToEntity:
    ...
    def __init__(self, name: str, cardinalityMany: bool, metamodel_ConnectionToEntity: "metamodel_Entity" = None, metamodel_ConnectionToEntity5: "metamodel_Entity" = None, metamodel_ConnectionToEntity12: "metamodel_Entity" = None):
        self.name = name
...
class metamodel_Variable(ABC):
    ...
    def __init__(self, name: str, metamodel_Variable: "metamodel_Entity" = None, metamodel_Variable15: "metamodel_Type" = None, metamodel_Variable17: "metamodel_Validation_ValueRestriction" = None):
        self.name = name
...
class metamodel_Entity(Type):
    ...
    def __init__(self, base: str, metamodel_Entity: set["metamodel_Variable"] = None, metamodel_Entity2: set["metamodel_ConnectionToEntity"] = None, metamodel_Entity4: set["metamodel_ConnectionToEntity"] = None, metamodel_Entity7: set["metamodel_EntityObserver"] = None, metamodel_Entity9: set["metamodel_ActsAs"] = None, metamodel_Entity13: "metamodel_ConnectionToEntity" = None, metamodel_Entity29: "metamodel_Model" = None):
        self.base = base
