...
# Classes
metamodel_PlainVariable = Class(name="metamodel_PlainVariable")
Variable = Class(name="Variable")
metamodel_Entity = Class(name="metamodel_Entity")
Type = Class(name="Type")
metamodel_Variable = Class(name="metamodel_Variable", is_abstract=True)
metamodel_ConnectionToEntity = Class(name="metamodel_ConnectionToEntity")
metamodel_EntityObserver = Class(name="metamodel_EntityObserver")
metamodel_ActsAs = Class(name="metamodel_ActsAs")
metamodel_Type = Class(name="metamodel_Type", is_abstract=True)
metamodel_Datatype = Class(name="metamodel_Datatype")
metamodel_Validation_ValueRestriction = Class(name="metamodel_Validation_ValueRestriction")
metamodel_ValueRestriction_Value = Class(name="metamodel_ValueRestriction_Value")
metamodel_TransientVariable = Class(name="metamodel_TransientVariable")
metamodel_Extension_MQPublishing = Class(name="metamodel_Extension_MQPublishing")
metamodel_Controller = Class(name="metamodel_Controller")
metamodel_StaticVariable = Class(name="metamodel_StaticVariable")
metamodel_View = Class(name="metamodel_View")
metamodel_Model = Class(name="metamodel_Model")
...
metamodel_ConnectionToEntity.attributes={metamodel_ConnectionToEntity_cardinalityMany, metamodel_ConnectionToEntity_name}
...
domain_model = DomainModel(
    name="metamodel",
    types={metamodel_PlainVariable, Variable, metamodel_Entity, Type, metamodel_Variable, metamodel_ConnectionToEntity, metamodel_EntityObserver, metamodel_ActsAs, metamodel_Type, metamodel_Datatype, metamodel_Validation_ValueRestriction, metamodel_ValueRestriction_Value, metamodel_TransientVariable, metamodel_Extension_MQPublishing, metamodel_Controller, metamodel_StaticVariable, metamodel_View, metamodel_Model},
    associations={hasAttribute0, belongsToEntity1, hasEntity3, isObservedBy6, actsAs8, restrictsTo10, otherEntity11, type14, validatedBy16, extendedBy19, belongsTo21, hasControllers22, hasViews24, hasEntities27, types30},
    generalizations={gen_metamodel_PlainVariable_Variable, gen_metamodel_Entity_Type, gen_metamodel_Datatype_Type, gen_metamodel_TransientVariable_Variable, gen_metamodel_Controller_Type, gen_metamodel_StaticVariable_Variable, gen_metamodel_View_Type, gen_metamodel_Model_Type},
    metadata=None
)
