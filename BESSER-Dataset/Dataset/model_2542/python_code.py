...
class fastfst_iDecFact:
    ...
    def __init__(self, name: str, value: int, fastfst_iDecFact: "fastfst_ModelFastfst" = None):
        self.name = name
        self.value = value
...
class fastfst_nTeetHSSp:
    ...
    def __init__(self, name: str, value: float, fastfst_nTeetHSSp: "fastfst_ModelFastfst" = None):
        self.name = name
        self.value = value
...
class fastfst_nOverHang:
    ...
    def __init__(self, value: float, name: str, fastfst_nOverHang: "fastfst_ModelFastfst" = None):
        self.value = value
        self.name = name
...
class fastfst_nNacCMzn:
    ...
    def __init__(self, name: str, value: float, fastfst_nNacCMzn: "fastfst_ModelFastfst" = None):
        self.name = name
        self.value = value
...
class fastfst_nBlPitchF_3_:
    ...
    def __init__(self, value: float, name: str, fastfst_nBlPitchF_3_: "fastfst_ModelFastfst" = None):
        self.value = value
        self.name = name
...
class fastfst_bTwSSDOF2:
    ...
    def __init__(self, name: str, value: bool, fastfst_bTwSSDOF2: "fastfst_ModelFastfst" = None):
        self.name = name
        self.value = value
...
class fastfst_nTPitManE_3_:
    ...
    def __init__(self, name: str, value: float, fastfst_nTPitManE_3_: "fastfst_ModelFastfst" = None):
        self.name = name
        self.value = value
