...
shop_Shop = Class(name="shop_Shop")
shop_Customer = Class(name="shop_Customer")
shop_Sale = Class(name="shop_Sale")
shop_Employee = Class(name="shop_Employee")
shop_AccountBook = Class(name="shop_AccountBook")
Valuable = Class(name="Valuable")
shop_Payment = Class(name="shop_Payment", is_abstract=True)
shop_Person = Class(name="shop_Person", is_abstract=True)
shop_Valuable = Class(name="shop_Valuable", is_abstract=True)
shop_ChequePayment = Class(name="shop_ChequePayment")
Payment = Class(name="Payment")
shop_CashPayment = Class(name="shop_CashPayment")
shop_ElectronicPayment = Class(name="shop_ElectronicPayment")
shop_BankOperation = Class(name="shop_BankOperation")
...
shop_AccountBook_m_depositCash: Method = Method(name="depositCash", parameters={Parameter(name='shop_cashValue', type=StringType), Parameter(name='shop_date', type=StringType)})
shop_AccountBook_m_depositCheques: Method = Method(name="depositCheques", parameters={Parameter(name='shop_date', type=StringType), Parameter(name='shop_cheques', type=StringType)})
...
shop_Person.attributes={shop_Person_lastName, shop_Person_emails, shop_Person_phoneNumbers, shop_Person_birthDate, shop_Person_firstName, shop_Person_address}
...
domain_model = DomainModel(
    name="shop",
    types={Person, shop_Shop, shop_Customer, shop_Sale, shop_Employee, shop_AccountBook, Valuable, shop_Payment, shop_Person, shop_Valuable, shop_ChequePayment, Payment, shop_CashPayment, shop_ElectronicPayment, shop_BankOperation, PaymentType},
    associations={sales6, customers0, sales1, employees3, accountBook5, customer7, employees8, payments10, sales11, sale13, bankOperations15, shop16, payments17},
