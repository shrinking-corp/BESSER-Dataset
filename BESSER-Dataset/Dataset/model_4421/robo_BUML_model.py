...
# Classes
robo_Sensor = Class(name="robo_Sensor")
robo_Robot = Class(name="robo_Robot")
robo_Program = Class(name="robo_Program")
robo_Setup = Class(name="robo_Setup")
robo_Motor = Class(name="robo_Motor")
robo_command_Command = Class(name="robo_command_Command", is_abstract=True)
robo_command_Drive = Class(name="robo_command_Drive")
Command = Class(name="Command")
robo_expression_Variable = Class(name="robo_expression_Variable")
Expr = Class(name="Expr")
Condition = Class(name="Condition")
robo_command_Loop = Class(name="robo_command_Loop")
robo_command_Branch = Class(name="robo_command_Branch")
robo_command_Assignment = Class(name="robo_command_Assignment")
robo_expression_Expr = Class(name="robo_expression_Expr", is_abstract=True)
robo_expression_Operation = Class(name="robo_expression_Operation")
robo_expression_Literal = Class(name="robo_expression_Literal")
robo_condition_Condition = Class(name="robo_condition_Condition", is_abstract=True)
robo_condition_Comparison = Class(name="robo_condition_Comparison")
...
robo_Sensor.attributes={robo_Sensor_port, robo_Sensor_type, robo_Sensor_mode, robo_Sensor_name}
...
robo_Motor.attributes={robo_Motor_speed, robo_Motor_type, robo_Motor_reversed, robo_Motor_port}
...
domain_model = DomainModel(
    name="robo",
    types={robo_Sensor, robo_Robot, robo_Program, robo_Setup, robo_Motor, robo_command_Command, robo_command_Drive, Command, robo_expression_Variable, Expr, Condition, robo_command_Loop, robo_command_Branch, robo_command_Assignment, robo_expression_Expr, robo_expression_Operation, robo_expression_Literal, robo_condition_Condition, robo_condition_Comparison, MotorPort, MotorType, SensorPort, SensorType, SensorMode, Direction, ExprOperation, ComparisonOperator},
    ...
    generalizations={gen_robo_command_Drive_Command, gen_robo_expression_Variable_Expr, gen_robo_command_Loop_Command, gen_robo_command_Branch_Command, gen_robo_command_Assignment_Command, gen_robo_expression_Operation_Expr, gen_robo_expression_Literal_Expr, gen_robo_condition_Comparison_Condition},
    metadata=None
)
