...
# Classes
transformation_ExtentMetamodel = Class(name="transformation_ExtentMetamodel")
transformation_DataTypeMapping = Class(name="transformation_DataTypeMapping")
AbstractMapping = Class(name="AbstractMapping")
transformation_Transformation = Class(name="transformation_Transformation")
transformation_MetamodelDeclaration = Class(name="transformation_MetamodelDeclaration", is_abstract=True)
transformation_AbstractMapping = Class(name="transformation_AbstractMapping", is_abstract=True)
transformation_EPackage = Class(name="transformation_EPackage")
transformation_ExplicitMetamodel = Class(name="transformation_ExplicitMetamodel")
MetamodelDeclaration = Class(name="MetamodelDeclaration")
transformation_SourceMetamodel = Class(name="transformation_SourceMetamodel")
ExplicitMetamodel = Class(name="ExplicitMetamodel")
transformation_TargetMetamodel = Class(name="transformation_TargetMetamodel")
transformation_If = Class(name="transformation_If")
Expression = Class(name="Expression")
transformation_EDataType = Class(name="transformation_EDataType")
transformation_ContentMapping = Class(name="transformation_ContentMapping", is_abstract=True)
transformation_ClassMapping = Class(name="transformation_ClassMapping")
transformation_EClass = Class(name="transformation_EClass")
transformation_CompositeMapping = Class(name="transformation_CompositeMapping")
ContentMapping = Class(name="ContentMapping")
transformation_ConditionalMapping = Class(name="transformation_ConditionalMapping")
transformation_WhenClause = Class(name="transformation_WhenClause")
transformation_OtherwiseClause = Class(name="transformation_OtherwiseClause")
CompositeMapping = Class(name="CompositeMapping")
transformation_Expression = Class(name="transformation_Expression", is_abstract=True)
transformation_ResultMapping = Class(name="transformation_ResultMapping")
transformation_FeatureMapping = Class(name="transformation_FeatureMapping")
transformation_EStructuralFeature = Class(name="transformation_EStructuralFeature")
transformation_VariableDefinition = Class(name="transformation_VariableDefinition")
transformation_VariableInitialization = Class(name="transformation_VariableInitialization")
transformation_Minus = Class(name="transformation_Minus")
transformation_FeatureAccess = Class(name="transformation_FeatureAccess")
transformation_ETypedElement = Class(name="transformation_ETypedElement")
transformation_Let = Class(name="transformation_Let")
transformation_ConditionalExpression = Class(name="transformation_ConditionalExpression")
transformation_BinaryExpression = Class(name="transformation_BinaryExpression", is_abstract=True)
transformation_CoalescingExpression = Class(name="transformation_CoalescingExpression")
BinaryExpression = Class(name="BinaryExpression")
transformation_LogicalExpression = Class(name="transformation_LogicalExpression", is_abstract=True)
transformation_Or = Class(name="transformation_Or")
LogicalExpression = Class(name="LogicalExpression")
transformation_And = Class(name="transformation_And")
transformation_EqualityExpression = Class(name="transformation_EqualityExpression", is_abstract=True)
transformation_Equal = Class(name="transformation_Equal")
EqualityExpression = Class(name="EqualityExpression")
transformation_Different = Class(name="transformation_Different")
transformation_RelationalExpression = Class(name="transformation_RelationalExpression", is_abstract=True)
transformation_Less = Class(name="transformation_Less")
RelationalExpression = Class(name="RelationalExpression")
transformation_Greater = Class(name="transformation_Greater")
transformation_LessOrEqual = Class(name="transformation_LessOrEqual")
transformation_GreaterOrEqual = Class(name="transformation_GreaterOrEqual")
transformation_ArithmeticExpression = Class(name="transformation_ArithmeticExpression", is_abstract=True)
transformation_Addition = Class(name="transformation_Addition")
ArithmeticExpression = Class(name="ArithmeticExpression")
transformation_Subtraction = Class(name="transformation_Subtraction")
transformation_Multiplication = Class(name="transformation_Multiplication")
transformation_Division = Class(name="transformation_Division")
transformation_UnaryExpression = Class(name="transformation_UnaryExpression", is_abstract=True)
transformation_Negation = Class(name="transformation_Negation")
UnaryExpression = Class(name="UnaryExpression")
transformation_EnumLiteral = Class(name="transformation_EnumLiteral")
transformation_EEnumLiteral = Class(name="transformation_EEnumLiteral")
transformation_BooleanLiteral = Class(name="transformation_BooleanLiteral")
transformation_IntegerLiteral = Class(name="transformation_IntegerLiteral")
transformation_ExtentExpression = Class(name="transformation_ExtentExpression")
transformation_RealLiteral = Class(name="transformation_RealLiteral")
transformation_TypeOfExpression = Class(name="transformation_TypeOfExpression")
transformation_StringLiteral = Class(name="transformation_StringLiteral")
transformation_Invocation = Class(name="transformation_Invocation")
transformation_Lambda = Class(name="transformation_Lambda")
transformation_Map = Class(name="transformation_Map")
transformation_EClassifier = Class(name="transformation_EClassifier")
transformation_Source = Class(name="transformation_Source")
transformation_VariableUse = Class(name="transformation_VariableUse")
transformation_ClassLiteral = Class(name="transformation_ClassLiteral")
...
transformation_FeatureAccess.attributes={transformation_FeatureAccess_spreading, transformation_FeatureAccess_nullable}
...
domain_model = DomainModel(
    name="transformation",
    types={transformation_ExtentMetamodel, transformation_DataTypeMapping, AbstractMapping, transformation_Transformation, transformation_MetamodelDeclaration, transformation_AbstractMapping, transformation_EPackage, transformation_ExplicitMetamodel, MetamodelDeclaration, transformation_SourceMetamodel, ExplicitMetamodel, transformation_TargetMetamodel, transformation_If, Expression, transformation_EDataType, transformation_ContentMapping, transformation_ClassMapping, transformation_EClass, transformation_CompositeMapping, ContentMapping, transformation_ConditionalMapping, transformation_WhenClause, transformation_OtherwiseClause, CompositeMapping, transformation_Expression, transformation_ResultMapping, transformation_FeatureMapping, transformation_EStructuralFeature, transformation_VariableDefinition, transformation_VariableInitialization, transformation_Minus, transformation_FeatureAccess, transformation_ETypedElement, transformation_Let, transformation_ConditionalExpression, transformation_BinaryExpression, transformation_CoalescingExpression, BinaryExpression, transformation_LogicalExpression, transformation_Or, LogicalExpression, transformation_And, transformation_EqualityExpression, transformation_Equal, EqualityExpression, transformation_Different, transformation_RelationalExpression, transformation_Less, RelationalExpression, transformation_Greater, transformation_LessOrEqual, transformation_GreaterOrEqual, transformation_ArithmeticExpression, transformation_Addition, ArithmeticExpression, transformation_Subtraction, transformation_Multiplication, transformation_Division, transformation_UnaryExpression, transformation_Negation, UnaryExpression, transformation_EnumLiteral, transformation_EEnumLiteral, transformation_BooleanLiteral, transformation_IntegerLiteral, transformation_ExtentExpression, transformation_RealLiteral, transformation_TypeOfExpression, transformation_StringLiteral, transformation_Invocation, transformation_Lambda, transformation_Map, transformation_EClassifier, transformation_Source, transformation_VariableUse, transformation_ClassLiteral},
    associations={sourceMetamodel5, metamodelDeclarations0, mappings1, package3, condition36, thenExpression38, elseExpression41, source6, target7, content10, source12, target13, content16, children19, whenClauses21, otherwiseClause22, condition24, value26, target28, value29, variable32, value33, object64, feature66, variables44, result46, condition49, trueExpression51, falseExpression54, left57, right59, operand62, enumConstant90, source68, object70, function72, parameters74, parameters77, result79, value82, target84, variable86, objectType88},
    generalizations={gen_transformation_ExtentMetamodel_MetamodelDeclaration, gen_transformation_DataTypeMapping_AbstractMapping, gen_transformation_ExplicitMetamodel_MetamodelDeclaration, gen_transformation_SourceMetamodel_ExplicitMetamodel, gen_transformation_TargetMetamodel_ExplicitMetamodel, gen_transformation_If_Expression, gen_transformation_ClassMapping_AbstractMapping, gen_transformation_CompositeMapping_ContentMapping, gen_transformation_ConditionalMapping_ContentMapping, gen_transformation_WhenClause_CompositeMapping, gen_transformation_OtherwiseClause_CompositeMapping, gen_transformation_ResultMapping_ContentMapping, gen_transformation_FeatureMapping_ContentMapping, gen_transformation_Negation_UnaryExpression, gen_transformation_Minus_UnaryExpression, gen_transformation_FeatureAccess_Expression, gen_transformation_Let_Expression, gen_transformation_ConditionalExpression_Expression, gen_transformation_BinaryExpression_Expression, gen_transformation_CoalescingExpression_BinaryExpression, gen_transformation_LogicalExpression_BinaryExpression, gen_transformation_Or_LogicalExpression, gen_transformation_And_LogicalExpression, gen_transformation_EqualityExpression_BinaryExpression, gen_transformation_Equal_EqualityExpression, gen_transformation_Different_EqualityExpression, gen_transformation_RelationalExpression_BinaryExpression, gen_transformation_Less_RelationalExpression, gen_transformation_Greater_RelationalExpression, gen_transformation_LessOrEqual_RelationalExpression, gen_transformation_GreaterOrEqual_RelationalExpression, gen_transformation_ArithmeticExpression_BinaryExpression, gen_transformation_Addition_ArithmeticExpression, gen_transformation_Subtraction_ArithmeticExpression, gen_transformation_Multiplication_ArithmeticExpression, gen_transformation_Division_ArithmeticExpression, gen_transformation_UnaryExpression_Expression, gen_transformation_EnumLiteral_Expression, gen_transformation_BooleanLiteral_Expression, gen_transformation_IntegerLiteral_Expression, gen_transformation_ExtentExpression_Expression, gen_transformation_RealLiteral_Expression, gen_transformation_TypeOfExpression_Expression, gen_transformation_StringLiteral_Expression, gen_transformation_Invocation_Expression, gen_transformation_Lambda_Expression, gen_transformation_Map_Expression, gen_transformation_Source_Expression, gen_transformation_VariableUse_Expression, gen_transformation_ClassLiteral_Expression},
    metadata=None
)
