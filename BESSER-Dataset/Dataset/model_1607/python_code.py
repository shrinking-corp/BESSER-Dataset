...
class pnmlcoremodel_Line:
    ...
    def __init__(self, color: str, shape: str, width: str, style: str, Line53: "pnmlcoremodel_AnnotationGraphics" = None, line: "pnmlcoremodel_NodeGraphics" = None, line65: "pnmlcoremodel_ArcGraphics" = None, line68: "pnmlcoremodel_AnnotationGraphics" = None, Line74: "pnmlcoremodel_ArcGraphics" = None, Line: "pnmlcoremodel_NodeGraphics" = None):
        self.color = color
        self.shape = shape
        self.width = width
        self.style = style
...
class pnmlcoremodel_Fill:
    ...
    def __init__(self, color: str, gradientcolor: str, gradientrotation: str, image: str, Fill50: "pnmlcoremodel_AnnotationGraphics" = None, fill: "pnmlcoremodel_NodeGraphics" = None, fill60: "pnmlcoremodel_AnnotationGraphics" = None, Fill: "pnmlcoremodel_NodeGraphics" = None):
        self.color = color
...
class pnmlcoremodel_PnObject(ABC):
    ...
    def __init__(self, id: str, PnObject26: "pnmlcoremodel_ToolInfo" = None, PnObject: "pnmlcoremodel_Page" = None, containerNamePnObject: "pnmlcoremodel_Name" = None, containerPnObject: set["pnmlcoremodel_ToolInfo"] = None, objects: "pnmlcoremodel_Page" = None, PnObject21: "pnmlcoremodel_Name" = None):
        self.id = id
...
class pnmlcoremodel_PetriNet:
    ...
    def __init__(self, id: str, type: str, containerNamePetriNet: "pnmlcoremodel_Name" = None, containerPetriNet4: set["pnmlcoremodel_ToolInfo"] = None, nets: "pnmlcoremodel_PetriNetDoc" = None, PetriNet: "pnmlcoremodel_PetriNetDoc" = None, containerPetriNet: set["pnmlcoremodel_Page"] = None, PetriNet23: "pnmlcoremodel_ToolInfo" = None, PetriNet8: "pnmlcoremodel_Page" = None, PetriNet18: "pnmlcoremodel_Name" = None):
        self.id = id
        self.type = type
...
class pnmlcoremodel_PetriNetDoc:
    ...
    def __init__(self, xmlns: str, PetriNetDoc: "pnmlcoremodel_PetriNet" = None, containerPetriNetDoc: set["pnmlcoremodel_PetriNet"] = None):
        self.xmlns = xmlns
...
class pnmlcoremodel_ToolInfo:
    ...
    def __init__(self, version: str, formattedXMLBuffer: str, toolInfoGrammarURI: str, tool: str, ToolInfo: "pnmlcoremodel_PetriNet" = None, toolspecifics: "pnmlcoremodel_PetriNet" = None, toolspecifics25: "pnmlcoremodel_PnObject" = None, toolspecifics28: "pnmlcoremodel_Label" = None, containerToolInfo: "pnmlcoremodel_AnyObject" = None, ToolInfo14: "pnmlcoremodel_PnObject" = None, ToolInfo98: "pnmlcoremodel_AnyObject" = None, ToolInfo31: "pnmlcoremodel_Label" = None):
