...
public class uma_WorkProductDescriptor extends Descriptor {
    ...
    public uma_WorkProductDescriptor(
        String activityEntryState,        String activityExitState        ArrayList<uma_WorkProductDescriptor> uma_workproductdescriptors,        ArrayList<uma_WorkProductDescriptor> uma_workproductdescriptors    ) {
        this.activityEntryState = activityEntryState;
        this.activityExitState = activityExitState;
