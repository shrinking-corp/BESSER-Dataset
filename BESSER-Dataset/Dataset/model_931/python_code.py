...
class uma_Ellipse(GraphicPrimitive):
    ...
    def __init__(self, radiusY: str, rotation: str, startAngle: str, endAngle: str, radiusX: str, uma_Ellipse: "uma_Point" = None):
...
class uma_PracticeDescription(ContentDescription):
    ...
    def __init__(self, application: str, levelsOfAdoption: str, additionalInfo: str, problem: str, background: str, goals: str):
...
class uma_Point:
    ...
    def __init__(self, x: str, y: str, uma_Point: "uma_GraphElement" = None, uma_Point89: "uma_DiagramLink" = None, uma_Point120: "uma_Ellipse" = None, uma_Point105: "uma_GraphEdge" = None, uma_Point107: "uma_Diagram" = None, uma_Point118: "uma_Polyline" = None):
        self.x = x
        self.y = y
...
class uma_Activity(WorkBreakdownElement, WorkDefinition, VariabilityElement):

    def __init__(self, isEnactable: str, superActivities: set["uma_BreakdownElement"] = None, Activity: "uma_BreakdownElement" = None, uma_Activity: set["uma_Roadmap"] = None, uma_Activity124: set["uma_SupportingMaterial"] = None, uma_Activity127: set["uma_Checklist"] = None, uma_Activity130: set["uma_Concept"] = None, uma_Activity133: set["uma_Example"] = None, uma_Activity136: set["uma_Guideline"] = None, uma_Activity139: set["uma_ReusableAsset"] = None, uma_Activity213: "uma_Practice" = None, uma_Activity254: "uma_Discipline" = None):
...
class uma_DiagramElement(MethodElement):
    ...
    def __init__(self, isVisible: str, DiagramElement101: "uma_Reference" = None, DiagramElement: "uma_GraphElement" = None, contained: "uma_GraphElement" = None, referenced: set["uma_Reference"] = None, uma_DiagramElement: set["uma_Property"] = None):
...
class uma_MethodUnit(MethodElement):
    ...
    def __init__(self, version: str, authors: str, changeDate: str, changeDescription: str, uma_MethodUnit: "uma_SupportingMaterial" = None):
