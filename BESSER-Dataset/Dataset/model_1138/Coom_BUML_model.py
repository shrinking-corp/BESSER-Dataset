...
# Classes
coom_ComponentOnOffManifest = Class(name="coom_ComponentOnOffManifest")
coom_Version = Class(name="coom_Version")
coom_State = Class(name="coom_State")
coom_Transition = Class(name="coom_Transition")
...
coom_Version.attributes={coom_Version_majorMalue, coom_Version_minorValue}
...
coom_State.attributes={coom_State_initial, coom_State_name}
