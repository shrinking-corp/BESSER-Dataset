...
# Classes
platoon_TurnCommand = Class(name="platoon_TurnCommand")
platoon_HeadwayConstraint = Class(name="platoon_HeadwayConstraint")
...
domain_model = DomainModel(
    name="platoon",
    types={platoon_TurnCommand, platoon_HeadwayConstraint, Constraint, platoon_Platoon, platoon_Constraint, platoon_World, platoon_LeadingVehicle, platoon_FollowVehicle, platoon_Route, platoon_Command, platoon_Vehicle, Vehicle, platoon_ForwardCommand, Command, platoon_Constraints},
    associations={LV0, FV1, commands3, follows4, route6, platoon9, route11, constraints14, constraints16},
    generalizations={gen_platoon_TurnCommand_Command, gen_platoon_HeadwayConstraint_Constraint, gen_platoon_FollowVehicle_Vehicle, gen_platoon_LeadingVehicle_Vehicle, gen_platoon_ForwardCommand_Command},
    metadata=None
)
