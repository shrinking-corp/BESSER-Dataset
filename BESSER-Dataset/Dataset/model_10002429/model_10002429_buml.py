...
# Classes
ShoppingBAsket = Class(name="ShoppingBAsket")
...
# ShoppingBAsket class attributes and methods
ShoppingBAsket_id: Property = Property(name="id", type=IntegerType)
ShoppingBAsket_creationDate: Property = Property(name="creationDate", type=DateType)
ShoppingBAsket.attributes={ShoppingBAsket_id, ShoppingBAsket_creationDate}
...
Item.attributes={Item_quantity, Item_price, Item_id}
...
Account.attributes={Account_id, Account_billingAddress, Account_openDate}
...
Order.attributes={Order_finalTotal, Order_shippingAddress, Order_id, Order_status}
...
Customer.attributes={Customer_id, Customer_password, Customer_isBan, Customer_emailAddress, Customer_lastname, Customer_login, Customer_firstname}
...
association2: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="cart1", type=ShoppingBAsket, multiplicity=Multiplicity(0, 1))
    }
)
...
association4: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="shoppingcart5", type=ShoppingBAsket, multiplicity=Multiplicity(1, 1))
    }
)
...
association7: BinaryAssociation = BinaryAssociation(
    name="association7",
    ends={
        Property(name="shoppingcart10", type=ShoppingBAsket, multiplicity=Multiplicity(1, 1)),
...
domain_model = DomainModel(
    name="b28d5cd4_635c_4b96_befb_71f09079cb46",
    types={ShoppingBAsket, Item, Product, Account, Payment, Order, Customer, OrderStatus},
