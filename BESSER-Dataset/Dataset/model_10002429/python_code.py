...
class Customer:
    ...
    def __init__(self, firstname: str, lastname: str, emailAddress: str, id: int, login: str, password: str, isBan: bool, cart1: "ShoppingBAsket" = None, account3: "Account" = None):
...
class Account:
    ...
    def __init__(self, id: int, openDate: date, billingAddress: str, payment7: set["Payment"] = None, customer2: "Customer" = None, shoppingcart5: "ShoppingBAsket" = None):
        self.id = id
...
class Item:
    ...
    def __init__(self, quantity: int, price: float, id: int, shoppingcart10: "ShoppingBAsket" = None, product13: "Product" = None):
...
class ShoppingBAsket:
    ...
    def __init__(self, id: int, creationDate: date, item11: set["Item"] = None, c0: "Customer" = None, accnt4: "Account" = None):
        self.id = id
    ...
    def c0(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_ShoppingBAsket__c0", None)
        self.__c0 = value
    ...
    def accnt4(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_ShoppingBAsket__accnt4", None)
        self.__accnt4 = value
    ...
    def item11(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_ShoppingBAsket__item11", None)
