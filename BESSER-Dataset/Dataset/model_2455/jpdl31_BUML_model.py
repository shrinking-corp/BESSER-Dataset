...
jpdl31_ActionType.attributes={jpdl31_ActionType_expression, jpdl31_ActionType_acceptPropagatedEvents, jpdl31_ActionType_mixed, jpdl31_ActionType_any, jpdl31_ActionType_name, jpdl31_ActionType_async_, jpdl31_ActionType_configType, jpdl31_ActionType_class_, jpdl31_ActionType_refName}
...
jpdl31_AssignmentType.attributes={jpdl31_AssignmentType_expression, jpdl31_AssignmentType_pooledActors, jpdl31_AssignmentType_actorId}
...
jpdl31_ConditionType.attributes={jpdl31_ConditionType_expression, jpdl31_ConditionType_mixed, jpdl31_ConditionType_any, jpdl31_ConditionType_group}
...
jpdl31_CreateTimerType.attributes={jpdl31_CreateTimerType_duedate, jpdl31_CreateTimerType_name, jpdl31_CreateTimerType_transition, jpdl31_CreateTimerType_repeat}
...
jpdl31_ScriptType.attributes={jpdl31_ScriptType_name, jpdl31_ScriptType_any, jpdl31_ScriptType_mixed, jpdl31_ScriptType_acceptPropagatedEvents}
...
jpdl31_DecisionType.attributes={jpdl31_DecisionType_expression, jpdl31_DecisionType_async_, jpdl31_DecisionType_group, jpdl31_DecisionType_name}
...
jpdl31_Delegation.attributes={jpdl31_Delegation_configType, jpdl31_Delegation_class_, jpdl31_Delegation_mixed, jpdl31_Delegation_any}
...
jpdl31_ExceptionHandlerType.attributes={jpdl31_ExceptionHandlerType_exceptionClass, jpdl31_ExceptionHandlerType_group}
...
jpdl31_TransitionType1.attributes={jpdl31_TransitionType1_group, jpdl31_TransitionType1_to, jpdl31_TransitionType1_name}
...
jpdl31_ForkType.attributes={jpdl31_ForkType_name, jpdl31_ForkType_async_, jpdl31_ForkType_group}
...
jpdl31_ProcessStateType.attributes={jpdl31_ProcessStateType_async_, jpdl31_ProcessStateType_name, jpdl31_ProcessStateType_group}
...
jpdl31_NodeType.attributes={jpdl31_NodeType_async_, jpdl31_NodeType_name, jpdl31_NodeType_nodeContentElements}
...
jpdl31_ProcessDefinitionType.attributes={jpdl31_ProcessDefinitionType_group, jpdl31_ProcessDefinitionType_name}
...
jpdl31_TaskType.attributes={jpdl31_TaskType_duedate, jpdl31_TaskType_group, jpdl31_TaskType_signalling, jpdl31_TaskType_name, jpdl31_TaskType_blocking, jpdl31_TaskType_description, jpdl31_TaskType_priority, jpdl31_TaskType_swimlane}
...
jpdl31_TaskNodeType.attributes={jpdl31_TaskNodeType_group, jpdl31_TaskNodeType_name, jpdl31_TaskNodeType_signal, jpdl31_TaskNodeType_createTasks, jpdl31_TaskNodeType_endTasks, jpdl31_TaskNodeType_async_}
...
jpdl31_StartStateType.attributes={jpdl31_StartStateType_name, jpdl31_StartStateType_group}
...
jpdl31_SuperStateType.attributes={jpdl31_SuperStateType_async_, jpdl31_SuperStateType_name, jpdl31_SuperStateType_group}
...
jpdl31_VariableType.attributes={jpdl31_VariableType_mappedName, jpdl31_VariableType_name, jpdl31_VariableType_access, jpdl31_VariableType_any}
...
domain_model = DomainModel(
    name="jpdl31",
    types={jpdl31_ActionType, jpdl31_AssignmentType, Delegation, jpdl31_CancelTimerType, jpdl31_ConditionType, jpdl31_CreateTimerType, jpdl31_ScriptType, jpdl31_DecisionType, jpdl31_Delegation, jpdl31_EventType, jpdl31_ExceptionHandlerType, jpdl31_TransitionType1, jpdl31_DocumentRoot, jpdl31_EStringToStringMapEntry, jpdl31_ForkType, jpdl31_JoinType, jpdl31_EndStateType, jpdl31_ProcessStateType, jpdl31_NodeType, jpdl31_ProcessDefinitionType, jpdl31_SwimlaneType, jpdl31_TaskType, jpdl31_TaskNodeType, jpdl31_TimerType, jpdl31_StartStateType, jpdl31_StateType, jpdl31_SuperStateType, jpdl31_TransitionType, jpdl31_VariableType, jpdl31_SubProcessType, BooleanType, ConfigType, ConfigTypeType, ConfigTypeType1, PriorityTypeMember0, SignalType, TypeTypeMember1},
    associations={action0, script1, handler3, event4, exceptionHandler6, transition8, action14, assignment17, cancelTimer19, controller21, xMLNSPrefixMap10, xSISchemaLocation11, event32, exceptionHandler35, fork38, join40, createTimer24, decision27, endState30, processDefinition44, processState46, script48, node42, swimlane57, task59, taskNode61, timer63, startState51, state53, superState55, event69, exceptionHandler72, action75, transition65, variable67, action87, script90, script78, createTimer81, cancelTimer84, event96, exceptionHandler99, timer102, script93, event108, exceptionHandler111, timer114, transition117, transition105, createTimer126, cancelTimer129, event132, exceptionHandler135, action120, script123, timer138, transition141, state153, taskNode156, superState159, processState162, swimlane144, startState147, node150, endState174, action177, script180, createTimer183, fork165, join168, decision171, exceptionHandler192, task195, subProcess198, cancelTimer186, event189, exceptionHandler206, timer209, transition212, variable200, event203, task215, exceptionHandler224, transition218, event221, event227, exceptionHandler230, timer233, node239, transition236, superState249, processState251, fork254, join257, state242, taskNode245, exceptionHandler269, timer272, transition275, decision260, endState263, event266, task281, event284, exceptionHandler287, timer290, assignment278, assignment296, controller299, transition293, action308, event302, timer305, action314, script317, script311, exceptionHandler326, condition329, createTimer320, cancelTimer323, createTimer337, cancelTimer340, exceptionHandler343, action331, script334},
