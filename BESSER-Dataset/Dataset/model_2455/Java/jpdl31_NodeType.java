...
public class jpdl31_NodeType  {
    ...
    public jpdl31_NodeType(
        String async_,        String name,        String nodeContentElements        ArrayList<jpdl31_ExceptionHandlerType> jpdl31_exceptionhandlertypes,        ArrayList<jpdl31_EventType> jpdl31_eventtypes    ) {
        this.async_ = async_;
        this.name = name;
        this.nodeContentElements = nodeContentElements;
