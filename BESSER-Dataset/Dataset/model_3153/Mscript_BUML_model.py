...
ast_StructDefinition = Class(name="ast_StructDefinition")
ast_StructMemberDeclaration = Class(name="ast_StructMemberDeclaration")
ast_DataTypeSpecifier = Class(name="ast_DataTypeSpecifier")
ast_FunctionDefinition = Class(name="ast_FunctionDefinition")
CallableElement = Class(name="CallableElement")
ast_TemplateParameterDeclaration = Class(name="ast_TemplateParameterDeclaration")
ast_InputParameterDeclaration = Class(name="ast_InputParameterDeclaration")
ast_Module = Class(name="ast_Module")
ast_Definition = Class(name="ast_Definition", is_abstract=True)
ast_DataTypeDefinition = Class(name="ast_DataTypeDefinition", is_abstract=True)
Definition = Class(name="Definition")
ast_EnumerationDefinition = Class(name="ast_EnumerationDefinition")
DataTypeDefinition = Class(name="DataTypeDefinition")
ast_EnumerationLiteralDeclaration = Class(name="ast_EnumerationLiteralDeclaration")
ast_TypeAliasDefinition = Class(name="ast_TypeAliasDefinition")
ast_ParameterDeclaration = Class(name="ast_ParameterDeclaration", is_abstract=True)
ParameterDeclaration = Class(name="ParameterDeclaration")
ast_OutputParameterDeclaration = Class(name="ast_OutputParameterDeclaration")
ast_Check = Class(name="ast_Check")
ast_Assertion = Class(name="ast_Assertion")
ast_FunctionObjectDeclaration = Class(name="ast_FunctionObjectDeclaration")
ast_StateVariableDeclaration = Class(name="ast_StateVariableDeclaration")
ast_Equation = Class(name="ast_Equation")
ast_Expression = Class(name="ast_Expression")
ast_CallableElement = Class(name="ast_CallableElement", is_abstract=True)
ast_IfExpression = Class(name="ast_IfExpression")
ast_SwitchExpression = Class(name="ast_SwitchExpression")
ast_SwitchCase = Class(name="ast_SwitchCase")
ast_DataType = Class(name="ast_DataType")
ast_LetExpression = Class(name="ast_LetExpression")
Expression = Class(name="Expression")
ast_LetExpressionVariableDeclaration = Class(name="ast_LetExpressionVariableDeclaration")
ast_LetExpressionVariableDeclarationPart = Class(name="ast_LetExpressionVariableDeclarationPart")
ast_ArraySubscript = Class(name="ast_ArraySubscript")
ast_IterationCall = Class(name="ast_IterationCall")
ast_IterationVariable = Class(name="ast_IterationVariable")
ast_IterationAccumulator = Class(name="ast_IterationAccumulator")
ast_ArrayElementAccess = Class(name="ast_ArrayElementAccess")
ast_UnitConstructionOperator = Class(name="ast_UnitConstructionOperator")
ast_Unit = Class(name="ast_Unit")
ast_ParenthesizedExpression = Class(name="ast_ParenthesizedExpression")
ast_EndExpression = Class(name="ast_EndExpression")
ast_RangeExpression = Class(name="ast_RangeExpression")
ast_ImpliesExpression = Class(name="ast_ImpliesExpression")
ast_DerivativeOperator = Class(name="ast_DerivativeOperator")
ast_ArrayConstructionOperator = Class(name="ast_ArrayConstructionOperator")
ast_ArrayConstructionIterationClause = Class(name="ast_ArrayConstructionIterationClause")
ast_ArrayConcatenationOperator = Class(name="ast_ArrayConcatenationOperator")
ast_ExpressionList = Class(name="ast_ExpressionList")
ast_TypeTestExpression = Class(name="ast_TypeTestExpression")
ast_AdditiveExpression = Class(name="ast_AdditiveExpression")
ast_MultiplicativeExpression = Class(name="ast_MultiplicativeExpression")
ast_LogicalOrExpression = Class(name="ast_LogicalOrExpression")
ast_LogicalAndExpression = Class(name="ast_LogicalAndExpression")
ast_EqualityExpression = Class(name="ast_EqualityExpression")
ast_RelationalExpression = Class(name="ast_RelationalExpression")
ast_VariableAccess = Class(name="ast_VariableAccess")
FeatureCall = Class(name="FeatureCall")
ast_StepExpression = Class(name="ast_StepExpression", is_abstract=True)
ast_RangeStepExpression = Class(name="ast_RangeStepExpression")
StepExpression = Class(name="StepExpression")
ast_AdditiveStepExpression = Class(name="ast_AdditiveStepExpression")
ast_PowerExpression = Class(name="ast_PowerExpression")
ast_UnaryExpression = Class(name="ast_UnaryExpression")
ast_PostfixExpression = Class(name="ast_PostfixExpression")
ast_FeatureCall = Class(name="ast_FeatureCall", is_abstract=True)
...
ast_NegateStepExpression = Class(name="ast_NegateStepExpression")
ast_PrimitiveStepExpression = Class(name="ast_PrimitiveStepExpression", is_abstract=True)
ast_StepLiteral = Class(name="ast_StepLiteral")
PrimitiveStepExpression = Class(name="PrimitiveStepExpression")
ast_StepN = Class(name="ast_StepN")
ast_FunctionCall = Class(name="ast_FunctionCall")
ast_MemberVariableAccess = Class(name="ast_MemberVariableAccess")
ast_AlgorithmExpression = Class(name="ast_AlgorithmExpression")
ast_Compound = Class(name="ast_Compound")
Statement = Class(name="Statement")
ast_Statement = Class(name="ast_Statement", is_abstract=True)
...
ast_BuiltinDefinition = Class(name="ast_BuiltinDefinition")
ast_BuiltinFunction = Class(name="ast_BuiltinFunction")
BuiltinDefinition = Class(name="BuiltinDefinition")
ast_BuiltinVariable = Class(name="ast_BuiltinVariable")
...
domain_model = DomainModel(
    name="ast",
    types={ast_PrimitiveType, ast_StructDefinition, ast_StructMemberDeclaration, ast_DataTypeSpecifier, ast_FunctionDefinition, CallableElement, ast_TemplateParameterDeclaration, ast_InputParameterDeclaration, ast_Module, ast_Definition, ast_DataTypeDefinition, Definition, ast_EnumerationDefinition, DataTypeDefinition, ast_EnumerationLiteralDeclaration, ast_TypeAliasDefinition, ast_ParameterDeclaration, ParameterDeclaration, ast_OutputParameterDeclaration, ast_Check, ast_Assertion, ast_FunctionObjectDeclaration, ast_StateVariableDeclaration, ast_Equation, ast_Expression, ast_CallableElement, ast_IfExpression, ast_SwitchExpression, ast_SwitchCase, ast_DataType, ast_LetExpression, Expression, ast_LetExpressionVariableDeclaration, ast_LetExpressionVariableDeclarationPart, ast_ArraySubscript, ast_IterationCall, ast_IterationVariable, ast_IterationAccumulator, ast_ArrayElementAccess, ast_UnitConstructionOperator, ast_Unit, ast_ParenthesizedExpression, ast_EndExpression, ast_RangeExpression, ast_ImpliesExpression, ast_DerivativeOperator, ast_ArrayConstructionOperator, ast_ArrayConstructionIterationClause, ast_ArrayConcatenationOperator, ast_ExpressionList, ast_TypeTestExpression, ast_AdditiveExpression, ast_MultiplicativeExpression, ast_LogicalOrExpression, ast_LogicalAndExpression, ast_EqualityExpression, ast_RelationalExpression, ast_VariableAccess, FeatureCall, ast_StepExpression, ast_RangeStepExpression, StepExpression, ast_AdditiveStepExpression, ast_PowerExpression, ast_UnaryExpression, ast_PostfixExpression, ast_FeatureCall, ast_Assignment, ast_VariableDeclaration, ast_IfStatement, ast_NegateStepExpression, ast_PrimitiveStepExpression, ast_StepLiteral, PrimitiveStepExpression, ast_StepN, ast_FunctionCall, ast_MemberVariableAccess, ast_AlgorithmExpression, ast_Compound, Statement, ast_Statement, ast_ContinueStatement, ast_BreakStatement, ast_ReturnStatement, ast_BuiltinDefinition, ast_BuiltinFunction, BuiltinDefinition, ast_BuiltinVariable, ast_WhileStatement, ast_DoWhileStatement, ast_ForStatement, AssertionStatusKind, FunctionKind, EqualityOperator, RelationalOperator, AdditiveOperator, MultiplicativeOperator, PowerOperator, UnaryOperator, PostfixOperator},
    associations={type2, memberDeclarations3, type4, templateParameterDeclarations6, inputParameterDeclarations7, definitions0, literalDeclarations1, condition28, message31, outputParameterDeclarations9, checks11, assertions12, functionObjectDeclarations14, stateVariableDeclarations16, equations18, function20, templateArguments21, inputParameterTypes22, outputParameterTypes25, condition60, thenExpression62, elseExpression65, controlExpression68, cases70, functionName34, templateArguments37, leftHandSide40, rightHandSide43, type46, definedType48, variableDeclarations51, targetExpression52, parts55, assignedExpression57, subscripts83, expression85, target88, variables90, accumulator92, breakCondition94, defaultExpression72, caseExpression75, resultExpression78, array81, unit115, expressions116, operands118, leftOperand120, expression97, initializer100, variable103, expressions104, iterationClauses106, collectionExpression108, rows111, expressions112, expression145, type147, leftOperand150, rightOperand152, rightOperand122, leftOperand125, rightOperand127, leftOperand130, rightOperand132, leftOperand135, rightOperand137, leftOperand140, rightOperand142, stepExpression171, start172, end174, leftOperand155, rightOperand157, operand160, exponent162, operand165, operand167, feature169, target194, expression196, initializer199, condition201, thenStatement203, leftOperand177, rightOperand179, operand182, arguments184, target186, memberVariable188, body191, statements192, expression233, elseStatement206, condition209, body211, condition214, body216, declaredIterationVariable219, iterationVariable221, collectionExpression224, condition227, body230},
    generalizations={gen_ast_StructDefinition_DataTypeDefinition, gen_ast_FunctionDefinition_Definition, gen_ast_FunctionDefinition_CallableElement, gen_ast_DataTypeDefinition_Definition, gen_ast_EnumerationDefinition_DataTypeDefinition, gen_ast_TypeAliasDefinition_DataTypeDefinition, gen_ast_ParameterDeclaration_CallableElement, gen_ast_TemplateParameterDeclaration_ParameterDeclaration, gen_ast_InputParameterDeclaration_ParameterDeclaration, gen_ast_OutputParameterDeclaration_ParameterDeclaration, gen_ast_IfExpression_Expression, gen_ast_SwitchExpression_Expression, gen_ast_StateVariableDeclaration_CallableElement, gen_ast_FunctionObjectDeclaration_CallableElement, gen_ast_LetExpression_Expression, gen_ast_LetExpressionVariableDeclarationPart_CallableElement, gen_ast_IterationCall_Expression, gen_ast_ArrayElementAccess_Expression, gen_ast_UnitConstructionOperator_Expression, gen_ast_ParenthesizedExpression_Expression, gen_ast_EndExpression_Expression, gen_ast_RangeExpression_Expression, gen_ast_ImpliesExpression_Expression, gen_ast_IterationVariable_CallableElement, gen_ast_IterationAccumulator_CallableElement, gen_ast_DerivativeOperator_Expression, gen_ast_ArrayConstructionOperator_Expression, gen_ast_ArrayConcatenationOperator_Expression, gen_ast_TypeTestExpression_Expression, gen_ast_AdditiveExpression_Expression, gen_ast_MultiplicativeExpression_Expression, gen_ast_LogicalOrExpression_Expression, gen_ast_LogicalAndExpression_Expression, gen_ast_EqualityExpression_Expression, gen_ast_RelationalExpression_Expression, gen_ast_VariableAccess_FeatureCall, gen_ast_RangeStepExpression_StepExpression, gen_ast_AdditiveStepExpression_StepExpression, gen_ast_PowerExpression_Expression, gen_ast_UnaryExpression_Expression, gen_ast_PostfixExpression_Expression, gen_ast_FeatureCall_Expression, gen_ast_Assignment_Statement, gen_ast_VariableDeclaration_Statement, gen_ast_VariableDeclaration_CallableElement, gen_ast_IfStatement_Statement, gen_ast_NegateStepExpression_StepExpression, gen_ast_PrimitiveStepExpression_StepExpression, gen_ast_StepLiteral_PrimitiveStepExpression, gen_ast_StepN_PrimitiveStepExpression, gen_ast_FunctionCall_FeatureCall, gen_ast_MemberVariableAccess_Expression, gen_ast_AlgorithmExpression_Expression, gen_ast_Compound_Statement, gen_ast_ContinueStatement_Statement, gen_ast_BreakStatement_Statement, gen_ast_ReturnStatement_Statement, gen_ast_BuiltinDefinition_Definition, gen_ast_BuiltinDefinition_CallableElement, gen_ast_BuiltinFunction_BuiltinDefinition, gen_ast_BuiltinVariable_BuiltinDefinition, gen_ast_WhileStatement_Statement, gen_ast_DoWhileStatement_Statement, gen_ast_ForStatement_Statement},
    metadata=None
)
