...
class ast_IterationCall(Expression):
    ...
    def __init__(self, identifier: str, ast_IterationCall98: "ast_Expression" = None, ast_IterationCall: "ast_Expression" = None, ast_IterationCall91: set["ast_IterationVariable"] = None, ast_IterationCall93: "ast_IterationAccumulator" = None, ast_IterationCall95: "ast_Expression" = None):
...
class ast_Assertion:
    ...
    def __init__(self, static: bool, statusKind: str, ast_Assertion29: "ast_Expression" = None, ast_Assertion32: "ast_Expression" = None, ast_Assertion: "ast_FunctionDefinition" = None):
        self.static = static
...
class ast_VariableDeclaration(CallableElement, Statement):
