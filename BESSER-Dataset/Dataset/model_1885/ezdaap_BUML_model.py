...
# Classes
ezdaap_EZDaapPlayList = Class(name="ezdaap_EZDaapPlayList")
ezdaap_EZDaapSong = Class(name="ezdaap_EZDaapSong")
ezdaap_EZDaapAlbum = Class(name="ezdaap_EZDaapAlbum")
ezdaap_EZDaapArtist = Class(name="ezdaap_EZDaapArtist")
ezdaap_EZDaapITunesInstance = Class(name="ezdaap_EZDaapITunesInstance")
ezdaap_EZDaapLibrary = Class(name="ezdaap_EZDaapLibrary")
ezdaap_EZDaapDictionary = Class(name="ezdaap_EZDaapDictionary")
ezdaap_EZDaapManager = Class(name="ezdaap_EZDaapManager")
EZDaapElem = Class(name="EZDaapElem")
EZDaapIntelPropertyElem = Class(name="EZDaapIntelPropertyElem")
ezdaap_EZDaapLibraryUnit = Class(name="ezdaap_EZDaapLibraryUnit", is_abstract=True)
EZDaapLibraryUnit = Class(name="EZDaapLibraryUnit")
ezdaap_EZDaapElem = Class(name="ezdaap_EZDaapElem")
ezdaap_EZDaapIntelPropertyElem = Class(name="ezdaap_EZDaapIntelPropertyElem")
...
ezdaap_EZDaapITunesInstance.attributes={ezdaap_EZDaapITunesInstance_revID, ezdaap_EZDaapITunesInstance_serverName, ezdaap_EZDaapITunesInstance_sessionID, ezdaap_EZDaapITunesInstance_id}
...
domain_model = DomainModel(
    name="ezdaap",
    types={ezdaap_EZDaapPlayList, ezdaap_EZDaapSong, ezdaap_EZDaapAlbum, ezdaap_EZDaapArtist, ezdaap_EZDaapITunesInstance, ezdaap_EZDaapLibrary, ezdaap_EZDaapDictionary, ezdaap_EZDaapManager, EZDaapElem, EZDaapIntelPropertyElem, ezdaap_EZDaapLibraryUnit, EZDaapLibraryUnit, ezdaap_EZDaapElem, ezdaap_EZDaapIntelPropertyElem, DAAP_COMM_CST, DAAP_CONNECTION_KIND},
    associations={libraries0, palylists1, songs3, Albums5, artists7, iTunes9, songs11, songs14, elements17, artists19},
    generalizations={gen_ezdaap_EZDaapSong_EZDaapElem, gen_ezdaap_EZDaapSong_EZDaapIntelPropertyElem, gen_ezdaap_EZDaapAlbum_EZDaapIntelPropertyElem, gen_ezdaap_EZDaapAlbum_EZDaapElem, gen_ezdaap_EZDaapPlayList_EZDaapElem, gen_ezdaap_EZDaapLibrary_EZDaapLibraryUnit, gen_ezdaap_EZDaapElem_EZDaapLibraryUnit},
    metadata=None
)
