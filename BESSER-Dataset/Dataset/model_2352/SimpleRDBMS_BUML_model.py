...
rdbms_RModelElement = Class(name="rdbms_RModelElement", is_abstract=True)
...
domain_model = DomainModel(
    name="rdbms",
    types={rdbms_Key, rdbms_Column, RModelElement, rdbms_Table, rdbms_ForeignKey, rdbms_RModelElement, rdbms_Schema},
    associations={foreignKeys1, keys3, refersTo4, columns5, owner0, tables14, columns16, schema18, keys19, owner6, owner9, column11, foreignKeys22},
    generalizations={gen_rdbms_ForeignKey_RModelElement, gen_rdbms_Column_RModelElement, gen_rdbms_Table_RModelElement, gen_rdbms_Key_RModelElement, gen_rdbms_Schema_RModelElement},
    metadata=None
)
