...
class rdbms_Column(RModelElement):
    ...
    def __init__(self, type: str, column: set["rdbms_Key"] = None, Column: "rdbms_ForeignKey" = None, columns: "rdbms_Table" = None, Column17: "rdbms_Table" = None, Column13: "rdbms_Key" = None, columns2: set["rdbms_ForeignKey"] = None):
        self.type = type
