...
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Integer_m_equals: Method = Method(name="equals", parameters={Parameter(name='SysML_ValueTypes_QUDV_x', type=StringType)}, type=BooleanType)
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Integer_m_lessOrEqual: Method = Method(name="lessOrEqual", parameters={Parameter(name='SysML_ValueTypes_QUDV_x', type=StringType)}, type=BooleanType)
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Integer_m_lessThan: Method = Method(name="lessThan", parameters={Parameter(name='SysML_ValueTypes_QUDV_x', type=StringType)}, type=BooleanType)
...
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Integer.methods={SysML_ValueTypes_QUDV_PrimitiveValueTypes_Integer_m_equals, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Integer_m_plus, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Integer_m_times, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Integer_m_lessOrEqual, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Integer_m_lessThan}
...
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Number_m_equals: Method = Method(name="equals", parameters={Parameter(name='SysML_ValueTypes_QUDV_x', type=StringType)}, type=BooleanType)
...
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Complex_m_equals: Method = Method(name="equals", parameters={Parameter(name='SysML_ValueTypes_QUDV_x', type=StringType)}, type=BooleanType)
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Complex_m_lessOrEqual: Method = Method(name="lessOrEqual", parameters={Parameter(name='SysML_ValueTypes_QUDV_x', type=StringType)}, type=BooleanType)
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Complex_m_lessThan: Method = Method(name="lessThan", parameters={Parameter(name='SysML_ValueTypes_QUDV_x', type=StringType)}, type=BooleanType)
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Complex.methods={SysML_ValueTypes_QUDV_PrimitiveValueTypes_Complex_m_times, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Complex_m_lessOrEqual, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Complex_m_plus, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Complex_m_lessThan, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Complex_m_equals}

# SysML_ValueTypes_QUDV_PrimitiveValueTypes_Rational class attributes and methods
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Rational_m_equivalent: Method = Method(name="equivalent", parameters={Parameter(name='SysML_ValueTypes_QUDV_r', type=StringType)}, type=BooleanType)
...
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Real_m_equals: Method = Method(name="equals", parameters={Parameter(name='SysML_ValueTypes_QUDV_x', type=StringType)}, type=BooleanType)
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Real_m_lessOrEqual: Method = Method(name="lessOrEqual", parameters={Parameter(name='SysML_ValueTypes_QUDV_x', type=StringType)}, type=BooleanType)
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Real_m_lessThan: Method = Method(name="lessThan", parameters={Parameter(name='SysML_ValueTypes_QUDV_x', type=StringType)}, type=BooleanType)
...
SysML_ValueTypes_QUDV_UnitAndQuantityKind_QuantityKind.attributes={SysML_ValueTypes_QUDV_UnitAndQuantityKind_QuantityKind_symbol, SysML_ValueTypes_QUDV_UnitAndQuantityKind_QuantityKind_definitionURI, SysML_ValueTypes_QUDV_UnitAndQuantityKind_QuantityKind_name, SysML_ValueTypes_QUDV_UnitAndQuantityKind_QuantityKind_description}
...
SysML_ValueTypes_QUDV_UnitAndQuantityKind_Unit.attributes={SysML_ValueTypes_QUDV_UnitAndQuantityKind_Unit_definitionURI, SysML_ValueTypes_QUDV_UnitAndQuantityKind_Unit_name, SysML_ValueTypes_QUDV_UnitAndQuantityKind_Unit_symbol, SysML_ValueTypes_QUDV_UnitAndQuantityKind_Unit_description}
...
SysML_ValueTypes_QUDV_QUDV_SystemOfQuantities.attributes={SysML_ValueTypes_QUDV_QUDV_SystemOfQuantities_description, SysML_ValueTypes_QUDV_QUDV_SystemOfQuantities_definitionURI, SysML_ValueTypes_QUDV_QUDV_SystemOfQuantities_symbol, SysML_ValueTypes_QUDV_QUDV_SystemOfQuantities_name}
SysML_ValueTypes_QUDV_QUDV_SystemOfQuantities.methods={SysML_ValueTypes_QUDV_QUDV_SystemOfQuantities_m_allBaseQuantityKinds, SysML_ValueTypes_QUDV_QUDV_SystemOfQuantities_m_getDimension, SysML_ValueTypes_QUDV_QUDV_SystemOfQuantities_m_allAccessibleSystemOfQuantities, SysML_ValueTypes_QUDV_QUDV_SystemOfQuantities_m_allIncludedSystemOfQuantities, SysML_ValueTypes_QUDV_QUDV_SystemOfQuantities_m_allQuantityKinds, SysML_ValueTypes_QUDV_QUDV_SystemOfQuantities_m_allAccessibleQuantityKinds}
...
SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_isCoherent: Method = Method(name="isCoherent", parameters={Parameter(name='SysML_ValueTypes_QUDV_du', type=StringType)}, type=BooleanType)
...
SysML_ValueTypes_QUDV_QUDV_SystemOfUnits.methods={SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_allBaseQuantityKinds, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_allAccessibleSystemOfUnits, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_allBaseUnits, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_getUnit, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_allIncludedSystemOfUnits, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_allUnits, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_isCoherent, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_allPrefixes, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_getEffectiveSystemOfQuantities, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_getAdoptedQuantityKindForAdoptedBaseUnitOfMeasurementUnit, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_allMeasurementUnitsDefinedForSomeQuantityKind, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_getKindOfQuantitiesForMeasurementUnit, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_isCoherent, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_allAccessibleUnits, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_getAdoptedBaseUnitForMeasurementUnit}
...
domain_model = DomainModel(
    ...
    types={Dimension, Prefix, QuantityKindFactor, SystemOfQuantities, SystemOfUnits, SysML_ValueTypes_QUDV_ROOT_RESOURCE_SHAPE_CONTAINER, Number, QuantityKind, Unit, Real, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Integer, UnitFactor, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Number, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Complex, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Rational, Integer, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Real, SysML_ValueTypes_QUDV_UnitAndQuantityKind_QuantityKind, SysML_ValueTypes_QUDV_UnitAndQuantityKind_Unit, SysML_ValueTypes_QUDV_QUDV_ConversionBasedUnit, SysML_ValueTypes_QUDV_QUDV_AffineConversionUnit, ConversionBasedUnit, SysML_ValueTypes_QUDV_QUDV_Dimension, SysML_ValueTypes_QUDV_QUDV_DerivedQuantityKind, SysML_ValueTypes_QUDV_QUDV_DerivedUnit, SysML_ValueTypes_QUDV_QUDV_Prefix, Rational, SysML_ValueTypes_QUDV_QUDV_GeneralConversionUnit, SysML_ValueTypes_QUDV_QUDV_LinearConversionUnit, SysML_ValueTypes_QUDV_QUDV_PrefixedUnit, SysML_ValueTypes_QUDV_QUDV_QuantityKind, SysML_ValueTypes_QUDV_QUDV_SimpleUnit, SysML_ValueTypes_QUDV_QUDV_SystemOfQuantities, SysML_ValueTypes_QUDV_QUDV_QuantityKindFactor, SysML_ValueTypes_QUDV_QUDV_SimpleQuantityKind, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits, SysML_ValueTypes_QUDV_QUDV_Unit, SysML_ValueTypes_QUDV_QUDV_UnitFactor},
    associations={unit3, dimension5, prefix7, quantityKindFactor9, systemOfQuantities11, systemOfUnits13, number0, quantityKind1, realPart17, imaginaryPart18, unitFactor15, numerator21, quantityKind25, denominator22, referenceUnit32, factor27, offset29, factor36, factor34, factor40, factor42, factor38, dependsOnQuantityKinds45, general47, prefix43, exponent50, quantityKind52, baseQuantityKind55, includedSystemOfQuantities57, quantityKind60, usedSystemOfQuantities63, baseUnit66, includedSystemOfUnits68, dependsOnUnits83, prefix71, systemOfQuantities74, unit77, usedSystemOfUnits80, general85, exponent88, unit90},
    generalizations={gen_SysML_ValueTypes_QUDV_PrimitiveValueTypes_Integer_Number, gen_SysML_ValueTypes_QUDV_PrimitiveValueTypes_Complex_Number, gen_SysML_ValueTypes_QUDV_PrimitiveValueTypes_Rational_Number, gen_SysML_ValueTypes_QUDV_PrimitiveValueTypes_Real_Number, gen_SysML_ValueTypes_QUDV_QUDV_ConversionBasedUnit_Unit, gen_SysML_ValueTypes_QUDV_QUDV_AffineConversionUnit_ConversionBasedUnit, gen_SysML_ValueTypes_QUDV_QUDV_DerivedQuantityKind_QuantityKind, gen_SysML_ValueTypes_QUDV_QUDV_DerivedUnit_Unit, gen_SysML_ValueTypes_QUDV_QUDV_GeneralConversionUnit_ConversionBasedUnit, gen_SysML_ValueTypes_QUDV_QUDV_LinearConversionUnit_ConversionBasedUnit, gen_SysML_ValueTypes_QUDV_QUDV_PrefixedUnit_ConversionBasedUnit, gen_SysML_ValueTypes_QUDV_QUDV_QuantityKind_QuantityKind, gen_SysML_ValueTypes_QUDV_QUDV_SimpleUnit_Unit, gen_SysML_ValueTypes_QUDV_QUDV_SimpleQuantityKind_QuantityKind, gen_SysML_ValueTypes_QUDV_QUDV_Unit_Unit},
    metadata=None
)
