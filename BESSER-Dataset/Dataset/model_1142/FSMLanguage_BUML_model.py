...
# Classes
gemoc_FSM = Class(name="gemoc_FSM")
gemoc_State = Class(name="gemoc_State")
gemoc_Transition = Class(name="gemoc_Transition")
...
gemoc_FSM_m_setCurrentState: Method = Method(name="setCurrentState", parameters={Parameter(name='gemoc_state', type=StringType)})
gemoc_FSM.attributes={gemoc_FSM_name}
gemoc_FSM.methods={gemoc_FSM_m_print, gemoc_FSM_m_setCurrentState, gemoc_FSM_m_main, gemoc_FSM_m_initialize}

# gemoc_State class attributes and methods
gemoc_State_name: Property = Property(name="name", type=StringType)
gemoc_State_m_step: Method = Method(name="step", parameters={Parameter(name='gemoc_inputString', type=StringType)})
gemoc_State_m_isValidTrigger: Method = Method(name="isValidTrigger", parameters={Parameter(name='gemoc_trigger', type=StringType)})
...
src10: BinaryAssociation = BinaryAssociation(
    name="src10",
    ends={
        Property(name="State11", type=gemoc_Transition, multiplicity=Multiplicity(1, 1)),
...
fSM6: BinaryAssociation = BinaryAssociation(
    name="fSM6",
    ends={
        Property(name="gemoc_FSM8", type=gemoc_State, multiplicity=Multiplicity(1, 1)),
        Property(name="gemoc_State7", type=gemoc_FSM, multiplicity=Multiplicity(0, 1))
    }
)
...
domain_model = DomainModel(
    ...
    associations={state0, transition1, state9, src10, incoming3, outcoming4, fSM6},
    generalizations={},
    metadata=None
)
