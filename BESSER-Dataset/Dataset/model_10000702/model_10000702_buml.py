...
Order.attributes={Order_shipTo, Order_ordered, Order_shipped, Order_number, Order_status, Order_total}
...
domain_model = DomainModel(
    name="_56fa0f6b_46c3_469b_a7d3_daadb186a759",
    types={WebUser, Order, LineItem, Product, Customer, Payment, ShoppingCart, Account, UserState, OrderStatus},
