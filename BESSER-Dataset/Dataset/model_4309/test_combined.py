...
def test_hyp_simple_metrics_metric_is_not_abstract():
    assert not inspect.isabstract(simple_metrics_Metric)


def test_hyp_simple_metrics_metric_constructor_exists():
    assert callable(simple_metrics_Metric.__init__)


def test_hyp_simple_metrics_metric_constructor_args():
...
def test_hyp_simple_metrics_metricsset_is_not_abstract():
    assert not inspect.isabstract(simple_metrics_MetricsSet)


def test_hyp_simple_metrics_metricsset_constructor_exists():
    assert callable(simple_metrics_MetricsSet.__init__)


def test_hyp_simple_metrics_metricsset_constructor_args():
...
def test_hyp_simple_metrics_metric_name_setter(instance):
...
@given(instance=simple_metrics_Metric_strategy)
def test_hyp_simple_metrics_metric_value_setter(instance):
...
def test_hyp_simple_metrics_metricsset_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
