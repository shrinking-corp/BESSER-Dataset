...
class railway_Semaphore(RailwayElement):
    ...
    def __init__(self, signal: str, railway_Semaphore18: "railway_RailwayContainer" = None, railway_Semaphore: "railway_Route" = None, railway_Semaphore9: "railway_Route" = None):
        self.signal = signal
