...
def test_assoc_entry4_link_reassign_clear():
...
def test_assoc_exit7_link_reassign_clear():
    ...
    b1 = railway_Route()
    b2 = railway_Route()
    _safe_set(a, 'railway_Semaphore9', b1)
    assert _is_linked(a, 'railway_Semaphore9', b1)
    if hasattr(b1, 'railway_Route8'):
        assert _is_linked(b1, 'railway_Route8', a)
    _safe_set(a, 'railway_Semaphore9', b2)
    assert _is_linked(a, 'railway_Semaphore9', b2)
    if hasattr(b1, 'railway_Route8'):
        assert not _is_linked(b1, 'railway_Route8', a)
    if hasattr(b2, 'railway_Route8'):
        assert _is_linked(b2, 'railway_Route8', a)
    _safe_set(a, 'railway_Semaphore9', None)
    assert not _is_linked(a, 'railway_Semaphore9', b2)
    if hasattr(b2, 'railway_Route8'):
        assert not _is_linked(b2, 'railway_Route8', a)
...
def test_assoc_invalids15_link_reassign_clear():
    a = railway_RailwayElement(id=7)
    b1 = railway_RailwayContainer()
    b2 = railway_RailwayContainer()
    _safe_set(a, 'railway_RailwayElement', b1)
    assert _is_linked(a, 'railway_RailwayElement', b1)
    if hasattr(b1, 'railway_RailwayContainer'):
        assert _is_linked(b1, 'railway_RailwayContainer', a)
    _safe_set(a, 'railway_RailwayElement', b2)
    assert _is_linked(a, 'railway_RailwayElement', b2)
    if hasattr(b1, 'railway_RailwayContainer'):
    ...
    _safe_set(a, 'railway_RailwayElement', None)
    assert not _is_linked(a, 'railway_RailwayElement', b2)
    if hasattr(b2, 'railway_RailwayContainer'):
        assert not _is_linked(b2, 'railway_RailwayContainer', a)


def test_assoc_positions3_link_reassign_clear():
    a = railway_SwitchPosition(position="sample_text")
...
def test_assoc_semaphores16_link_reassign_clear():
    a = railway_Semaphore(signal="sample_text")
    b1 = railway_RailwayContainer()
    b2 = railway_RailwayContainer()
    _safe_set(a, 'railway_Semaphore18', b1)
    assert _is_linked(a, 'railway_Semaphore18', b1)
    if hasattr(b1, 'railway_RailwayContainer17'):
        assert _is_linked(b1, 'railway_RailwayContainer17', a)
    _safe_set(a, 'railway_Semaphore18', b2)
    assert _is_linked(a, 'railway_Semaphore18', b2)
    if hasattr(b1, 'railway_RailwayContainer17'):
        assert not _is_linked(b1, 'railway_RailwayContainer17', a)
    if hasattr(b2, 'railway_RailwayContainer17'):
        assert _is_linked(b2, 'railway_RailwayContainer17', a)
    _safe_set(a, 'railway_Semaphore18', None)
    assert not _is_linked(a, 'railway_Semaphore18', b2)
    if hasattr(b2, 'railway_RailwayContainer17'):
        assert not _is_linked(b2, 'railway_RailwayContainer17', a)


def test_assoc_switch12_link_reassign_clear():
    a = railway_SwitchPosition(position="sample_text")
    b1 = railway_Switch(currentPosition="sample_text")
    b2 = railway_Switch(currentPosition="sample_text_2")
