...
def test_hyp_sql_element_is_not_abstract():
    assert not inspect.isabstract(sql_Element)


def test_hyp_sql_element_constructor_exists():
    assert callable(sql_Element.__init__)


def test_hyp_sql_element_constructor_args():
...
def test_hyp_sql_element_name_setter(instance):
