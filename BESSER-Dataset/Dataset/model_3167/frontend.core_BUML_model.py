...
# Classes
core_LocatedElement = Class(name="core_LocatedElement", is_abstract=True)
core_NamedElement = Class(name="core_NamedElement", is_abstract=True)
core_DefinitionParameter = Class(name="core_DefinitionParameter", is_abstract=True)
NamedElement = Class(name="NamedElement")
core_ModuleParameter = Class(name="core_ModuleParameter")
DefinitionParameter = Class(name="DefinitionParameter")
core_ModuleDefinition = Class(name="core_ModuleDefinition", is_abstract=True)
LocatedElement = Class(name="LocatedElement")
AnnotableElement = Class(name="AnnotableElement")
core_AnnotableElement = Class(name="core_AnnotableElement", is_abstract=True)
core_Annotation = Class(name="core_Annotation", is_abstract=True)
core_ImplicitlyAnnotableElement = Class(name="core_ImplicitlyAnnotableElement")
core_SingleAnnotation = Class(name="core_SingleAnnotation", is_abstract=True)
core_PotencyAnnotation = Class(name="core_PotencyAnnotation")
SingleAnnotation = Class(name="SingleAnnotation")
core_GenericAnnotation = Class(name="core_GenericAnnotation")
core_AnnotationParameter = Class(name="core_AnnotationParameter", is_abstract=True)
core_RepresentModel = Class(name="core_RepresentModel", is_abstract=True)
core_TransformationDefinition = Class(name="core_TransformationDefinition", is_abstract=True)
ModuleDefinition = Class(name="ModuleDefinition")
core_TransformationDefinitionParameter = Class(name="core_TransformationDefinitionParameter")
core_ImportedModel = Class(name="core_ImportedModel")
core_InlineModel = Class(name="core_InlineModel")
core_UseDeclaration = Class(name="core_UseDeclaration")
core_RequireDeclaration = Class(name="core_RequireDeclaration")
core_EclecticTransformationDefinition = Class(name="core_EclecticTransformationDefinition")
TransformationDefinition = Class(name="TransformationDefinition")
RepresentModel = Class(name="RepresentModel")
core_OptimizationsAnnotation = Class(name="core_OptimizationsAnnotation")
Annotation = Class(name="Annotation")
core_MetamodelModelAnnotation = Class(name="core_MetamodelModelAnnotation")
RequireParameter = Class(name="RequireParameter")
core_Variable = Class(name="core_Variable", is_abstract=True)
core_Statement = Class(name="core_Statement", is_abstract=True)
core_Expression = Class(name="core_Expression", is_abstract=True)
Statement = Class(name="Statement")
core_DefineVariable = Class(name="core_DefineVariable")
Variable = Class(name="Variable")
core_PropertyWrite = Class(name="core_PropertyWrite")
Expression = Class(name="Expression")
core_ModelReference = Class(name="core_ModelReference")
ClassUse = Class(name="ClassUse")
core_VariableReference = Class(name="core_VariableReference")
core_MethodCall = Class(name="core_MethodCall")
core_KeywordMethodCall = Class(name="core_KeywordMethodCall")
core_KeywordParameter = Class(name="core_KeywordParameter")
core_RequireParameter = Class(name="core_RequireParameter", is_abstract=True)
core_RequireModelParameter = Class(name="core_RequireModelParameter")
core_ClosureDeclaration = Class(name="core_ClosureDeclaration")
core_ClosureParameter = Class(name="core_ClosureParameter")
core_ResolveLink = Class(name="core_ResolveLink")
core_IfExpr = Class(name="core_IfExpr")
core_IfBranch = Class(name="core_IfBranch")
core_NumLiteral = Class(name="core_NumLiteral")
core_DoubleLiteral = Class(name="core_DoubleLiteral")
core_StringLiteral = Class(name="core_StringLiteral")
core_BinaryExpr = Class(name="core_BinaryExpr")
core_BooleanLiteral = Class(name="core_BooleanLiteral")
...
core_TraceUse = Class(name="core_TraceUse")
core_TraceDefinition = Class(name="core_TraceDefinition")
core_TypedWithClass = Class(name="core_TypedWithClass", is_abstract=True)
core_TraceInterface = Class(name="core_TraceInterface")
core_TracedModelParameter = Class(name="core_TracedModelParameter")
core_TraceElement = Class(name="core_TraceElement")
core_InlineClass = Class(name="core_InlineClass")
core_InlineFeature = Class(name="core_InlineFeature")
core_InlineAttribute = Class(name="core_InlineAttribute")
InlineFeature = Class(name="InlineFeature")
core_InlineReference = Class(name="core_InlineReference")
core_MatchTrace = Class(name="core_MatchTrace")
core_TypeExpression = Class(name="core_TypeExpression", is_abstract=True)
core_PutTrace = Class(name="core_PutTrace")
core_PutTraceParameter = Class(name="core_PutTraceParameter")
core_TraceCompareExpression = Class(name="core_TraceCompareExpression")
...
core_LocatedElement.attributes={core_LocatedElement_column, core_LocatedElement_row, core_LocatedElement_file}
...
core_UseDeclaration_as_: Property = Property(name="as_", type=StringType)
core_UseDeclaration.attributes={core_UseDeclaration_module, core_UseDeclaration_as_}
...
core_PropertyWrite__property: Property = Property(name="_property", type=StringType)
core_PropertyWrite.attributes={core_PropertyWrite__property}
...
core_MethodCall.attributes={core_MethodCall_methodName, core_MethodCall_withParameters}
...
core_ResolveLink.attributes={core_ResolveLink_isExternal, core_ResolveLink_featureName, core_ResolveLink_linkName}
...
domain_model = DomainModel(
    name="core",
    types={core_LocatedElement, core_NamedElement, core_DefinitionParameter, NamedElement, core_ModuleParameter, DefinitionParameter, core_ModuleDefinition, LocatedElement, AnnotableElement, core_AnnotableElement, core_Annotation, core_ImplicitlyAnnotableElement, core_SingleAnnotation, core_PotencyAnnotation, SingleAnnotation, core_GenericAnnotation, core_AnnotationParameter, core_RepresentModel, core_TransformationDefinition, ModuleDefinition, core_TransformationDefinitionParameter, core_ImportedModel, core_InlineModel, core_UseDeclaration, core_RequireDeclaration, core_EclecticTransformationDefinition, TransformationDefinition, RepresentModel, core_OptimizationsAnnotation, Annotation, core_MetamodelModelAnnotation, RequireParameter, core_Variable, core_Statement, core_Expression, Statement, core_DefineVariable, Variable, core_PropertyWrite, Expression, core_ModelReference, ClassUse, core_VariableReference, core_MethodCall, core_KeywordMethodCall, core_KeywordParameter, core_RequireParameter, core_RequireModelParameter, core_ClosureDeclaration, core_ClosureParameter, core_ResolveLink, core_IfExpr, core_IfBranch, core_NumLiteral, core_DoubleLiteral, core_StringLiteral, core_BinaryExpr, core_BooleanLiteral, core_ClassUse, TypeExpression, ImplicitlyAnnotableElement, core_TraceUse, core_TraceDefinition, core_TypedWithClass, core_TraceInterface, core_TracedModelParameter, core_TraceElement, core_InlineClass, core_InlineFeature, core_InlineAttribute, InlineFeature, core_InlineReference, core_MatchTrace, core_TypeExpression, core_PutTrace, core_PutTraceParameter, core_TraceCompareExpression, BinaryOp, ResolveTraceCardinality},
    associations={annotatedWith0, annotations1, annotatedElement2, parameters3, inModels4, outModels5, importedModels8, inlineModels10, annotations12, uses14, requires16, transformations18, model22, expression23, receptor24, expression25, variable28, receptor30, parameters32, receptor35, parameters37, parameters20, right44, statements47, formalParameters48, expr50, module52, then55, elsifs56, else_59, condition62, statements65, value39, left42, model68, trace70, type_71, definitions73, elements75, type77, classes79, features81, type83, trace86, traceExpr88, traceVar90, expr93, trace96, parameters98, value100, traceVar103},
    generalizations={gen_core_DefinitionParameter_NamedElement, gen_core_ModuleParameter_DefinitionParameter, gen_core_ModuleDefinition_LocatedElement, gen_core_ModuleDefinition_NamedElement, gen_core_ModuleDefinition_AnnotableElement, gen_core_PotencyAnnotation_SingleAnnotation, gen_core_RepresentModel_AnnotableElement, gen_core_TransformationDefinition_ModuleDefinition, gen_core_EclecticTransformationDefinition_TransformationDefinition, gen_core_TransformationDefinitionParameter_DefinitionParameter, gen_core_TransformationDefinitionParameter_RepresentModel, gen_core_ImportedModel_RepresentModel, gen_core_ImportedModel_NamedElement, gen_core_UseDeclaration_RepresentModel, gen_core_RequireDeclaration_RepresentModel, gen_core_OptimizationsAnnotation_Annotation, gen_core_MetamodelModelAnnotation_Annotation, gen_core_SingleAnnotation_Annotation, gen_core_RequireModelParameter_RequireParameter, gen_core_Statement_LocatedElement, gen_core_Expression_Statement, gen_core_DefineVariable_Statement, gen_core_DefineVariable_Variable, gen_core_PropertyWrite_Expression, gen_core_ModelReference_ClassUse, gen_core_ModelReference_Expression, gen_core_VariableReference_Expression, gen_core_MethodCall_Expression, gen_core_KeywordMethodCall_Expression, gen_core_ClosureDeclaration_Expression, gen_core_ClosureParameter_Variable, gen_core_ResolveLink_Expression, gen_core_IfExpr_Expression, gen_core_NumLiteral_Expression, gen_core_DoubleLiteral_Expression, gen_core_StringLiteral_Expression, gen_core_BinaryExpr_Expression, gen_core_BooleanLiteral_Expression, gen_core_ClassUse_TypeExpression, gen_core_ClassUse_ImplicitlyAnnotableElement, gen_core_TraceUse_TypeExpression, gen_core_TraceInterface_ModuleDefinition, gen_core_TracedModelParameter_DefinitionParameter, gen_core_TracedModelParameter_RepresentModel, gen_core_TraceDefinition_NamedElement, gen_core_TraceElement_NamedElement, gen_core_InlineModel_ModuleDefinition, gen_core_InlineModel_RepresentModel, gen_core_InlineClass_NamedElement, gen_core_InlineFeature_NamedElement, gen_core_InlineAttribute_InlineFeature, gen_core_InlineReference_InlineFeature, gen_core_MatchTrace_Expression, gen_core_PutTrace_Expression},
    metadata=None
)
