...
def test_assoc_author4_link_reassign_clear():
    ...
    if hasattr(b1, 'extlibrary_BookOnTape5'):
        assert _is_linked(b1, 'extlibrary_BookOnTape5', a)
    _safe_set(a, 'extlibrary_Writer', b2)
    assert _is_linked(a, 'extlibrary_Writer', b2)
    if hasattr(b1, 'extlibrary_BookOnTape5'):
        assert not _is_linked(b1, 'extlibrary_BookOnTape5', a)
    if hasattr(b2, 'extlibrary_BookOnTape5'):
        assert _is_linked(b2, 'extlibrary_BookOnTape5', a)
    _safe_set(a, 'extlibrary_Writer', None)
    assert not _is_linked(a, 'extlibrary_Writer', b2)
    if hasattr(b2, 'extlibrary_BookOnTape5'):
        assert not _is_linked(b2, 'extlibrary_BookOnTape5', a)
...
def test_assoc_borrowed8_link_reassign_clear():
...
def test_assoc_borrowers2_link_reassign_clear():
    a = extlibrary_Lendable(copies=7)
    b1 = extlibrary_Borrower()
    b2 = extlibrary_Borrower()
...
def test_assoc_cast6_link_reassign_clear():
    ...
    _safe_set(a, 'extlibrary_Person7', None)
    assert not _is_linked(a, 'extlibrary_Person7', b2)
    if hasattr(b2, 'extlibrary_VideoCassette'):
        assert not _is_linked(b2, 'extlibrary_VideoCassette', a)


def test_assoc_reader3_link_reassign_clear():
    a = extlibrary_Person(firstName="sample_text", lastName="sample_text")
    b1 = extlibrary_BookOnTape()
    b2 = extlibrary_BookOnTape()
