...
domain_model = DomainModel(
    name="extlibrary",
    types={extlibrary_Book, CirculatingItem, extlibrary_VideoCassette, Addressable, extlibrary_Writer, Person, extlibrary_Item, extlibrary_Lendable, extlibrary_Borrower, extlibrary_CirculatingItem, Item, Lendable, extlibrary_Periodical, extlibrary_AudioVisualItem, extlibrary_BookOnTape, AudioVisualItem, extlibrary_Person, extlibrary_Employee, extlibrary_Addressable, BookCategory},
    associations={cast6, borrowed8, author0, books1, borrowers2, reader3, author4, manager10},
    generalizations={gen_extlibrary_Book_CirculatingItem, gen_extlibrary_VideoCassette_AudioVisualItem, gen_extlibrary_Borrower_Person, gen_extlibrary_Person_Addressable, gen_extlibrary_Writer_Person, gen_extlibrary_CirculatingItem_Item, gen_extlibrary_CirculatingItem_Lendable, gen_extlibrary_Periodical_Item, gen_extlibrary_AudioVisualItem_CirculatingItem, gen_extlibrary_BookOnTape_AudioVisualItem, gen_extlibrary_Employee_Person},
    metadata=None
)
