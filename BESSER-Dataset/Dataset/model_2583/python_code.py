...
class afpText_FNPRG:
    ...
    def __init__(self, Reserved: str, LcHeight: str, UscoreWdf: str, UscorePos: str, CapMHt: str, MaxAscHt: str, MaxDesDp: str, Reserved2: str, Retired: str, Reserved3: str, UscoreWd: str, afpText_FNPRG: "afpText_FNP" = None):
...
class afpText_GSPCOL(triplet):
    ...
    def __init__(self, COLSIZE4: str, COLVALUE: str, RES1: str, COLSPCE: str, RES2: str, COLSIZE1: str, COLSIZE2: str, COLSIZE3: str):
...
class afpText_TileSetColor(triplet):
    ...
    def __init__(self, CSPACE: str, RESERVED: str, SIZE1: str, SIZE2: str, SIZE3: str, SIZE4: str, CVAL1: str, CVAL2: str, CVAL3: str, CVAL4: str):
        self.CSPACE = CSPACE
        self.RESERVED = RESERVED
        self.SIZE1 = SIZE1
        self.SIZE2 = SIZE2
...
class afpText_WindowSpecification(triplet):
    ...
    def __init__(self, FLAGS: str, RES3: str, CFORMAT: str, UBASE: str, XRESOL: str, YRESOL: str, IMGXYRES: str, XLWIND: str, XRWIND: str, YBWIND: str, YTWIND: str):
        self.FLAGS = FLAGS
        self.RES3 = RES3
...
class afpText_DataObjectFontDescriptor(triplet):
    ...
    def __init__(self, DOFtFlgs: str, FontTech: str, VFS: str, HFS: str, CharRot: str, EncEnv: str, EncID: str, Reserved: str):
...
class afpText_IDEStructure(triplet):
    ...
    def __init__(self, SIZE4: str, FLAGS: str, FORMAT: str, SIZE1: str, SIZE2: str, SIZE3: str):
        self.SIZE4 = SIZE4
        self.FLAGS = FLAGS
        self.FORMAT = FORMAT
        self.SIZE1 = SIZE1
...
class afpText_GCBOX(triplet):
    ...
    def __init__(self, YPOS1: str, HAXIS: str, VAXIS: str, RES: str, XPOS1: str):
        self.YPOS1 = YPOS1
        self.HAXIS = HAXIS
        self.VAXIS = VAXIS
        self.RES = RES
...
class afpText_GSAP(triplet):
    ...
    def __init__(self, P: str, Q: str, R: str, S: str):
        self.P = P
        self.Q = Q
        self.R = R
        self.S = S
...
class afpText_LocalDateAndTimeStamp(triplet):
    ...
    def __init__(self, StampType: str, THunYear: str, TenYear: str, Day: str, Hour: str, Minute: str, Second: str, HundSec: str):
...
class afpText_SIA(triplet):
    ...
    def __init__(self, ADJSTMNT: str, DIRCTION: str):
...
class afpText_PPORG:
    ...
    def __init__(self, ProcFlgs: str, XocaOset: str, YocaOset: str, RGLength: str, ObjType: str, afpText_PPORG: "afpText_PPO" = None, afpText_PPORG185: set["afpText_triplet"] = None):
...
class afpText_MPGRG:
    ...
    def __init__(self, RGLength: str, afpText_MPGRG179: set["afpText_triplet"] = None, afpText_MPGRG: "afpText_MPG" = None):
        self.RGLength = RGLength
...
class afpText_MMTRG:
    ...
    def __init__(self, RGLength: str, afpText_MMTRG176: set["afpText_triplet"] = None, afpText_MMTRG: "afpText_MMT" = None):
        self.RGLength = RGLength
...
class afpText_MMDRG:
    ...
    def __init__(self, RGLength: str, afpText_MMDRG173: set["afpText_triplet"] = None, afpText_MMDRG: "afpText_MMD" = None):
        self.RGLength = RGLength
...
class afpText_MIORG:
    ...
    def __init__(self, RGLength: str, afpText_MIORG170: set["afpText_triplet"] = None, afpText_MIORG: "afpText_MIO" = None):
        self.RGLength = RGLength
...
class afpText_MGORG:
    ...
    def __init__(self, RGLength: str, afpText_MGORG167: set["afpText_triplet"] = None, afpText_MGORG: "afpText_MGO" = None):
        self.RGLength = RGLength
...
class afpText_MCARG:
    ...
    def __init__(self, RGLength: str, afpText_MCARG158: set["afpText_triplet"] = None, afpText_MCARG: "afpText_MCA" = None):
        self.RGLength = RGLength
...
class afpText_MDRRG:
    ...
    def __init__(self, RGLength: str, afpText_MDRRG164: set["afpText_triplet"] = None, afpText_MDRRG: "afpText_MDR" = None):
        self.RGLength = RGLength
...
class afpText_MCF1RG:
    ...
    def __init__(self, CFLid: str, Sectid: str, CFName: str, CPName: str, FCSName: str, CharRot: str, afpText_MCF1RG: "afpText_MCF1" = None):
        self.CFLid = CFLid
        self.Sectid = Sectid
        self.CFName = CFName
        self.CPName = CPName
...
class afpText_FND(structuredField):
    ...
    def __init__(self, NomHSize: str, MinHSize: str, DsnGenCls: str, DsnSubCls: str, DsnSpcGrp: str, Reserved1: str, FtDsFlags: str, Reserved2: str, GCSID: str, FGID: str, TypeFcDesc: str, FtWtClass: str, FtWdClass: str, MaxPtSize: str, NomPtSize: str, MinPtSize: str, MaxHSize: str, afpText_FND: set["afpText_triplet"] = None):
...
class afpText_PGD(structuredField):
    ...
    def __init__(self, Reserved: str, XpgBase: str, YpgBase: str, XpgUnits: str, YpgUnits: str, XpgSize: str, YpgSize: str, afpText_PGD: set["afpText_triplet"] = None):
        self.Reserved = Reserved
...
class afpText_FNC(structuredField):
    ...
    def __init__(self, Retired: str, PatTech: str, Reserved1: str, FntFlags: str, XUnitBase: str, YUnitBase: str, XftUnits: str, YftUnits: str, MaxBoxWd: str, MaxBoxHt: str, FNORGLen: str, FNIRGLen: str, PatAlign: str, RPatDCnt: str, FNPRGLen: str, FNMRGLen: str, ResXUBase: str, ResYUBase: str, XfrUnits: str, YfrUnits: str, OPatDCnt: str, Reserved2: str, FNNRGLen: str, FNNDCnt: str, FNNMapCnt: str, afpText_FNC: set["afpText_triplet"] = None):
        self.Retired = Retired
...
class afpText_IPO(structuredField):
    ...
    def __init__(self, YolOset: str, OvlyOrent: str, OvlyName: str, XolOset: str, afpText_IPO: set["afpText_triplet"] = None):
...
class afpText_BDD(structuredField):
    ...
    def __init__(self, UBASE: str, Reserved: str, XUPUB: str, YUPUB: str, TYPE: str, MOD: str, LID: str, COLOR: str, MODULEWIDTH: str, ELEMENTHEIGHT: str, MULT: str, WENE: str, XEXTENT: str, YEXTENT: str, Reserved2: str, afpText_BDD: set["afpText_triplet"] = None):
        self.UBASE = UBASE
        self.Reserved = Reserved
        self.XUPUB = XUPUB
        self.YUPUB = YUPUB
...
class afpText_ICP(structuredField):
    ...
    def __init__(self, YCOset: str, XCSize: str, YCSize: str, XFilSize: str, YFilSize: str, XCOset: str):
        self.YCOset = YCOset
        self.XCSize = XCSize
        self.YCSize = YCSize
...
class afpText_IOC(structuredField):
    ...
    def __init__(self, XoaOset: str, XoaOrent: str, YoaOrent: str, ConData1: str, XMap: str, YMap: str, ConData2: str, YoaOset: str):
...
class afpText_IOB(structuredField):
    ...
    def __init__(self, ObjName: str, ObjType: str, XoaOset: str, YoaOset: str, XoaOrent: str, YoaOrent: str, XocaOset: str, YocaOset: str, RefCSys: str, afpText_IOB: set["afpText_triplet"] = None):
        self.ObjName = ObjName
        self.ObjType = ObjType
        self.XoaOset = XoaOset
        self.YoaOset = YoaOset
...
class afpText_BDA(structuredField):
    ...
    def __init__(self, Flags: str, Xoffset: str, Yoffset: str, Data: str):
        self.Flags = Flags
        self.Xoffset = Xoffset
        self.Yoffset = Yoffset
        self.Data = Data
