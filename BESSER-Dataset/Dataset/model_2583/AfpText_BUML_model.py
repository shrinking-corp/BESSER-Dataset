...
# Classes
afpText_Model = Class(name="afpText_Model")
afpText_structuredField = Class(name="afpText_structuredField")
afpText_LineData = Class(name="afpText_LineData")
structuredField = Class(name="structuredField")
afpText_BAG = Class(name="afpText_BAG")
afpText_triplet = Class(name="afpText_triplet")
afpText_BBC = Class(name="afpText_BBC")
afpText_BCA = Class(name="afpText_BCA")
afpText_BCF = Class(name="afpText_BCF")
afpText_BCP = Class(name="afpText_BCP")
afpText_BDA = Class(name="afpText_BDA")
afpText_BDD = Class(name="afpText_BDD")
afpText_BDG = Class(name="afpText_BDG")
afpText_BDI = Class(name="afpText_BDI")
afpText_BDM = Class(name="afpText_BDM")
afpText_BDT = Class(name="afpText_BDT")
afpText_BDX = Class(name="afpText_BDX")
afpText_BFG = Class(name="afpText_BFG")
afpText_BFM = Class(name="afpText_BFM")
afpText_BFN = Class(name="afpText_BFN")
afpText_BGR = Class(name="afpText_BGR")
afpText_BII = Class(name="afpText_BII")
afpText_BIM = Class(name="afpText_BIM")
afpText_BMM = Class(name="afpText_BMM")
afpText_BMO = Class(name="afpText_BMO")
afpText_BNG = Class(name="afpText_BNG")
afpText_BOC = Class(name="afpText_BOC")
afpText_BOG = Class(name="afpText_BOG")
afpText_BPF = Class(name="afpText_BPF")
afpText_BPG = Class(name="afpText_BPG")
afpText_BPM = Class(name="afpText_BPM")
afpText_BPS = Class(name="afpText_BPS")
afpText_BPT = Class(name="afpText_BPT")
afpText_BRS = Class(name="afpText_BRS")
afpText_BSG = Class(name="afpText_BSG")
afpText_CAT = Class(name="afpText_CAT")
afpText_CDD = Class(name="afpText_CDD")
afpText_CFC = Class(name="afpText_CFC")
afpText_CFI = Class(name="afpText_CFI")
afpText_CFIRG = Class(name="afpText_CFIRG")
afpText_CPC = Class(name="afpText_CPC")
afpText_CPD = Class(name="afpText_CPD")
afpText_CPI = Class(name="afpText_CPI")
afpText_CPIRG = Class(name="afpText_CPIRG")
afpText_CTC = Class(name="afpText_CTC")
afpText_BRG = Class(name="afpText_BRG")
afpText_DXD = Class(name="afpText_DXD")
afpText_EAG = Class(name="afpText_EAG")
afpText_EBC = Class(name="afpText_EBC")
afpText_ECA = Class(name="afpText_ECA")
afpText_ECF = Class(name="afpText_ECF")
afpText_ECP = Class(name="afpText_ECP")
afpText_EDG = Class(name="afpText_EDG")
afpText_EDI = Class(name="afpText_EDI")
afpText_EDM = Class(name="afpText_EDM")
afpText_EDT = Class(name="afpText_EDT")
afpText_EDX = Class(name="afpText_EDX")
afpText_EFG = Class(name="afpText_EFG")
afpText_EFM = Class(name="afpText_EFM")
afpText_EFN = Class(name="afpText_EFN")
afpText_EGR = Class(name="afpText_EGR")
afpText_EII = Class(name="afpText_EII")
afpText_EMM = Class(name="afpText_EMM")
afpText_EMO = Class(name="afpText_EMO")
afpText_ENG = Class(name="afpText_ENG")
afpText_EOC = Class(name="afpText_EOC")
afpText_EOG = Class(name="afpText_EOG")
afpText_EPF = Class(name="afpText_EPF")
afpText_EPG = Class(name="afpText_EPG")
afpText_EPM = Class(name="afpText_EPM")
afpText_EPS = Class(name="afpText_EPS")
afpText_EIM = Class(name="afpText_EIM")
afpText_ERG = Class(name="afpText_ERG")
afpText_ERS = Class(name="afpText_ERS")
afpText_ESG = Class(name="afpText_ESG")
afpText_FNC = Class(name="afpText_FNC")
afpText_FND = Class(name="afpText_FND")
afpText_EPT = Class(name="afpText_EPT")
afpText_FNG = Class(name="afpText_FNG")
afpText_FNI = Class(name="afpText_FNI")
afpText_FNIRG = Class(name="afpText_FNIRG")
afpText_FNN = Class(name="afpText_FNN")
afpText_FNM = Class(name="afpText_FNM")
afpText_FNMRG = Class(name="afpText_FNMRG")
afpText_FNO = Class(name="afpText_FNO")
afpText_FNORG = Class(name="afpText_FNORG")
afpText_FNP = Class(name="afpText_FNP")
afpText_FNPRG = Class(name="afpText_FNPRG")
afpText_GAD = Class(name="afpText_GAD")
afpText_GDD = Class(name="afpText_GDD")
afpText_IDD = Class(name="afpText_IDD")
afpText_IEL = Class(name="afpText_IEL")
afpText_IID = Class(name="afpText_IID")
afpText_IMM = Class(name="afpText_IMM")
afpText_IOB = Class(name="afpText_IOB")
afpText_IOC = Class(name="afpText_IOC")
afpText_ICP = Class(name="afpText_ICP")
afpText_IPD = Class(name="afpText_IPD")
afpText_IPG = Class(name="afpText_IPG")
afpText_IPS = Class(name="afpText_IPS")
afpText_IRD = Class(name="afpText_IRD")
afpText_IPO = Class(name="afpText_IPO")
afpText_LLERG = Class(name="afpText_LLERG")
afpText_LNC = Class(name="afpText_LNC")
afpText_LND = Class(name="afpText_LND")
afpText_MBC = Class(name="afpText_MBC")
afpText_MBCRG = Class(name="afpText_MBCRG")
afpText_LLE = Class(name="afpText_LLE")
afpText_MCCRG = Class(name="afpText_MCCRG")
afpText_MCD = Class(name="afpText_MCD")
afpText_MCDRG = Class(name="afpText_MCDRG")
afpText_MCF = Class(name="afpText_MCF")
afpText_MCFRG = Class(name="afpText_MCFRG")
afpText_MCF1 = Class(name="afpText_MCF1")
afpText_MCF1RG = Class(name="afpText_MCF1RG")
afpText_MDD = Class(name="afpText_MDD")
afpText_MDR = Class(name="afpText_MDR")
afpText_MDRRG = Class(name="afpText_MDRRG")
afpText_MFC = Class(name="afpText_MFC")
afpText_MCA = Class(name="afpText_MCA")
afpText_MCARG = Class(name="afpText_MCARG")
afpText_MCC = Class(name="afpText_MCC")
afpText_MGORG = Class(name="afpText_MGORG")
afpText_MIO = Class(name="afpText_MIO")
afpText_MIORG = Class(name="afpText_MIORG")
afpText_MMC = Class(name="afpText_MMC")
afpText_MMCRG = Class(name="afpText_MMCRG")
afpText_MMD = Class(name="afpText_MMD")
afpText_MMDRG = Class(name="afpText_MMDRG")
afpText_MMO = Class(name="afpText_MMO")
afpText_MMORG = Class(name="afpText_MMORG")
afpText_MMT = Class(name="afpText_MMT")
afpText_MMTRG = Class(name="afpText_MMTRG")
afpText_MPG = Class(name="afpText_MPG")
afpText_MPGRG = Class(name="afpText_MPGRG")
afpText_MPO = Class(name="afpText_MPO")
afpText_MPORG = Class(name="afpText_MPORG")
afpText_MPS = Class(name="afpText_MPS")
afpText_MPSRG = Class(name="afpText_MPSRG")
afpText_MGO = Class(name="afpText_MGO")
afpText_OBD = Class(name="afpText_OBD")
afpText_OBP = Class(name="afpText_OBP")
afpText_OCD = Class(name="afpText_OCD")
afpText_PEC = Class(name="afpText_PEC")
afpText_PFC = Class(name="afpText_PFC")
afpText_PGD = Class(name="afpText_PGD")
afpText_MSU = Class(name="afpText_MSU")
afpText_MSURG = Class(name="afpText_MSURG")
afpText_NOP = Class(name="afpText_NOP")
afpText_PGPRG = Class(name="afpText_PGPRG")
afpText_PGP1 = Class(name="afpText_PGP1")
afpText_PMC = Class(name="afpText_PMC")
afpText_PPO = Class(name="afpText_PPO")
afpText_PPORG = Class(name="afpText_PPORG")
afpText_PTD = Class(name="afpText_PTD")
afpText_PTD1 = Class(name="afpText_PTD1")
afpText_PGP = Class(name="afpText_PGP")
afpText_FGD = Class(name="afpText_FGD")
afpText_PTX = Class(name="afpText_PTX")
afpText_TLE = Class(name="afpText_TLE")
afpText_BandImageRG = Class(name="afpText_BandImageRG")
afpText_TileTOCRG = Class(name="afpText_TileTOCRG")
afpText_SamplingRatiosRG = Class(name="afpText_SamplingRatiosRG")
afpText_ExternalAlgorithmRG = Class(name="afpText_ExternalAlgorithmRG")
afpText_FNNRG = Class(name="afpText_FNNRG")
afpText_GCBEZRG = Class(name="afpText_GCBEZRG")
afpText_GCCBEZRG = Class(name="afpText_GCCBEZRG")
afpText_GFLTRG = Class(name="afpText_GFLTRG")
afpText_GCFLTRG = Class(name="afpText_GCFLTRG")
afpText_GLINERG = Class(name="afpText_GLINERG")
afpText_GCLINERG = Class(name="afpText_GCLINERG")
afpText_GMRKRG = Class(name="afpText_GMRKRG")
afpText_GCMRKRG = Class(name="afpText_GCMRKRG")
afpText_GRLINERG = Class(name="afpText_GRLINERG")
afpText_GCRLINERG = Class(name="afpText_GCRLINERG")
afpText_DBR = Class(name="afpText_DBR")
afpText_DIR = Class(name="afpText_DIR")
afpText_ESU = Class(name="afpText_ESU")
afpText_NOPCS = Class(name="afpText_NOPCS")
afpText_OVS = Class(name="afpText_OVS")
afpText_RMB = Class(name="afpText_RMB")
afpText_RMI = Class(name="afpText_RMI")
afpText_RPS = Class(name="afpText_RPS")
afpText_SBI = Class(name="afpText_SBI")
afpText_SCFL = Class(name="afpText_SCFL")
afpText_SEC = Class(name="afpText_SEC")
afpText_SIA = Class(name="afpText_SIA")
afpText_SIM = Class(name="afpText_SIM")
afpText_STC = Class(name="afpText_STC")
afpText_STO = Class(name="afpText_STO")
afpText_SVI = Class(name="afpText_SVI")
afpText_AMB = Class(name="afpText_AMB")
triplet = Class(name="triplet")
afpText_AMI = Class(name="afpText_AMI")
afpText_BLN = Class(name="afpText_BLN")
afpText_BSU = Class(name="afpText_BSU")
afpText_USC = Class(name="afpText_USC")
afpText_AttributeQualifier = Class(name="afpText_AttributeQualifier")
afpText_AttributeValue = Class(name="afpText_AttributeValue")
afpText_CGCSGID = Class(name="afpText_CGCSGID")
afpText_CRCResourceManagement = Class(name="afpText_CRCResourceManagement")
afpText_CharacterRotation = Class(name="afpText_CharacterRotation")
afpText_ColorSpecification = Class(name="afpText_ColorSpecification")
afpText_Comment = Class(name="afpText_Comment")
afpText_DataObjectFontDescriptor = Class(name="afpText_DataObjectFontDescriptor")
afpText_DescriptorPosition = Class(name="afpText_DescriptorPosition")
afpText_EncodingSchemeID = Class(name="afpText_EncodingSchemeID")
afpText_FontResolution = Class(name="afpText_FontResolution")
afpText_TBM = Class(name="afpText_TBM")
afpText_TRN = Class(name="afpText_TRN")
afpText_LocalDateAndTimeStamp = Class(name="afpText_LocalDateAndTimeStamp")
afpText_UniversalDateAndTimeStamp = Class(name="afpText_UniversalDateAndTimeStamp")
afpText_MappingOption = Class(name="afpText_MappingOption")
afpText_MediaEjectControl = Class(name="afpText_MediaEjectControl")
afpText_MediumMapPageNumber = Class(name="afpText_MediumMapPageNumber")
afpText_MediumOrientation = Class(name="afpText_MediumOrientation")
afpText_MeasurementUnits = Class(name="afpText_MeasurementUnits")
afpText_MODCAInterchangeSet = Class(name="afpText_MODCAInterchangeSet")
afpText_ObjectAreaSize = Class(name="afpText_ObjectAreaSize")
afpText_ObjectClassification = Class(name="afpText_ObjectClassification")
afpText_FullyQualifiedName = Class(name="afpText_FullyQualifiedName")
afpText_ObjectOffset = Class(name="afpText_ObjectOffset")
afpText_ResourceObjectType = Class(name="afpText_ResourceObjectType")
afpText_PagePositionInformation = Class(name="afpText_PagePositionInformation")
afpText_PresentationControl = Class(name="afpText_PresentationControl")
afpText_PresentationSpaceResetMixing = Class(name="afpText_PresentationSpaceResetMixing")
afpText_PresentationSpaceMixingRules = Class(name="afpText_PresentationSpaceMixingRules")
afpText_ResourceLocalIdentifier = Class(name="afpText_ResourceLocalIdentifier")
afpText_ResourceSectionNumber = Class(name="afpText_ResourceSectionNumber")
afpText_TextOrientation = Class(name="afpText_TextOrientation")
afpText_FontHorizontalScaleFactor = Class(name="afpText_FontHorizontalScaleFactor")
afpText_FontDescriptorSpecification = Class(name="afpText_FontDescriptorSpecification")
afpText_BeginSegment = Class(name="afpText_BeginSegment")
afpText_EndSegment = Class(name="afpText_EndSegment")
afpText_ObjectFunctionSetSpecification = Class(name="afpText_ObjectFunctionSetSpecification")
afpText_BeginTransparencyMask = Class(name="afpText_BeginTransparencyMask")
afpText_EndTransparencyMask = Class(name="afpText_EndTransparencyMask")
afpText_BeginImage = Class(name="afpText_BeginImage")
afpText_EndImage = Class(name="afpText_EndImage")
afpText_ImageSize = Class(name="afpText_ImageSize")
afpText_ImageEncoding = Class(name="afpText_ImageEncoding")
afpText_IDESize = Class(name="afpText_IDESize")
afpText_ImageLUTID = Class(name="afpText_ImageLUTID")
afpText_BandImage = Class(name="afpText_BandImage")
afpText_BeginTile = Class(name="afpText_BeginTile")
afpText_EndTile = Class(name="afpText_EndTile")
afpText_ExternalAlgorithm = Class(name="afpText_ExternalAlgorithm")
afpText_TilePosition = Class(name="afpText_TilePosition")
afpText_TileSize = Class(name="afpText_TileSize")
afpText_TileSetColor = Class(name="afpText_TileSetColor")
afpText_SetBiLevelImageColor = Class(name="afpText_SetBiLevelImageColor")
afpText_IOCAFunctionSetIdentification = Class(name="afpText_IOCAFunctionSetIdentification")
afpText_ImageData = Class(name="afpText_ImageData")
afpText_BandImageData = Class(name="afpText_BandImageData")
afpText_IncludeTile = Class(name="afpText_IncludeTile")
afpText_ImageSubsampling = Class(name="afpText_ImageSubsampling")
afpText_SamplingRatios = Class(name="afpText_SamplingRatios")
afpText_IDEStructure = Class(name="afpText_IDEStructure")
afpText_TileTOC = Class(name="afpText_TileTOC")
afpText_FNNRG2 = Class(name="afpText_FNNRG2")
afpText_BeginSegmentCommand = Class(name="afpText_BeginSegmentCommand")
afpText_EndSegmentCommand = Class(name="afpText_EndSegmentCommand")
afpText_GBAR = Class(name="afpText_GBAR")
afpText_GBIMG = Class(name="afpText_GBIMG")
afpText_GCBIMG = Class(name="afpText_GCBIMG")
afpText_GBOX = Class(name="afpText_GBOX")
afpText_GCHST = Class(name="afpText_GCHST")
afpText_GCCHST = Class(name="afpText_GCCHST")
afpText_GCOMT = Class(name="afpText_GCOMT")
afpText_GEAR = Class(name="afpText_GEAR")
afpText_GEIMG = Class(name="afpText_GEIMG")
afpText_GEPROL = Class(name="afpText_GEPROL")
afpText_GFLT = Class(name="afpText_GFLT")
afpText_GCFLT = Class(name="afpText_GCFLT")
afpText_GFARC = Class(name="afpText_GFARC")
afpText_GCFARC = Class(name="afpText_GCFARC")
afpText_GIMD = Class(name="afpText_GIMD")
afpText_GLINE = Class(name="afpText_GLINE")
afpText_GCLINE = Class(name="afpText_GCLINE")
afpText_GCBOX = Class(name="afpText_GCBOX")
afpText_GCMRK = Class(name="afpText_GCMRK")
afpText_GNOP1 = Class(name="afpText_GNOP1")
afpText_GPARC = Class(name="afpText_GPARC")
afpText_GCPARC = Class(name="afpText_GCPARC")
afpText_GRLINE = Class(name="afpText_GRLINE")
afpText_GCRLINE = Class(name="afpText_GCRLINE")
afpText_GSGCH = Class(name="afpText_GSGCH")
afpText_GSAP = Class(name="afpText_GSAP")
afpText_GSBMX = Class(name="afpText_GSBMX")
afpText_GSCA = Class(name="afpText_GSCA")
afpText_GMRK = Class(name="afpText_GMRK")
afpText_GSCR = Class(name="afpText_GSCR")
afpText_GSCS = Class(name="afpText_GSCS")
afpText_GSCH = Class(name="afpText_GSCH")
afpText_GSCOL = Class(name="afpText_GSCOL")
afpText_GSCP = Class(name="afpText_GSCP")
afpText_GSECOL = Class(name="afpText_GSECOL")
afpText_GSFLW = Class(name="afpText_GSFLW")
afpText_GSLT = Class(name="afpText_GSLT")
afpText_GSLW = Class(name="afpText_GSLW")
afpText_GSMC = Class(name="afpText_GSMC")
afpText_GSMP = Class(name="afpText_GSMP")
afpText_GSMS = Class(name="afpText_GSMS")
afpText_GSMT = Class(name="afpText_GSMT")
afpText_GSMX = Class(name="afpText_GSMX")
afpText_GSPS = Class(name="afpText_GSPS")
afpText_GSPT = Class(name="afpText_GSPT")
afpText_GSCC = Class(name="afpText_GSCC")
afpText_GSCD = Class(name="afpText_GSCD")
afpText_GSLE = Class(name="afpText_GSLE")
afpText_GSLJ = Class(name="afpText_GSLJ")
afpText_GCBEZ = Class(name="afpText_GCBEZ")
afpText_GCCBEZ = Class(name="afpText_GCCBEZ")
afpText_WindowSpecification = Class(name="afpText_WindowSpecification")
afpText_DrawingOrderSubset = Class(name="afpText_DrawingOrderSubset")
afpText_TonerSaver = Class(name="afpText_TonerSaver")
afpText_ColorFidelity = Class(name="afpText_ColorFidelity")
afpText_FontFidelity = Class(name="afpText_FontFidelity")
afpText_TextFidelity = Class(name="afpText_TextFidelity")
afpText_GSPCOL = Class(name="afpText_GSPCOL")
afpText_CMRFidelity = Class(name="afpText_CMRFidelity")
afpText_ObjectByteExtent = Class(name="afpText_ObjectByteExtent")
afpText_ObjectByteOffset = Class(name="afpText_ObjectByteOffset")
afpText_ObjectStructuredFieldExtent = Class(name="afpText_ObjectStructuredFieldExtent")
afpText_ObjectStructuredFieldOffset = Class(name="afpText_ObjectStructuredFieldOffset")
afpText_ObjectCount = Class(name="afpText_ObjectCount")
afpText_ObjectOriginIdentifier = Class(name="afpText_ObjectOriginIdentifier")
afpText_LineDataObjectPositionMigration = Class(name="afpText_LineDataObjectPositionMigration")
afpText_ColorManagementResourceDescriptor = Class(name="afpText_ColorManagementResourceDescriptor")
afpText_ImageResolution = Class(name="afpText_ImageResolution")
afpText_MediaFidelity = Class(name="afpText_MediaFidelity")
afpText_FinishingFidelity = Class(name="afpText_FinishingFidelity")
afpText_ExtendedResourceLocalIdentifier = Class(name="afpText_ExtendedResourceLocalIdentifier")
afpText_MetricAdjustment = Class(name="afpText_MetricAdjustment")
afpText_ExtensionFont = Class(name="afpText_ExtensionFont")
afpText_RenderingIntent = Class(name="afpText_RenderingIntent")
afpText_FontCodedGraphicCharacterSetGlobalIdentifier = Class(name="afpText_FontCodedGraphicCharacterSetGlobalIdentifier")
afpText_LocaleSelector = Class(name="afpText_LocaleSelector")
afpText_FinishingOperation = Class(name="afpText_FinishingOperation")
afpText_UP3iFinishingOperation = Class(name="afpText_UP3iFinishingOperation")
afpText_DeviceAppearance = Class(name="afpText_DeviceAppearance")
afpText_ObjectContainerPresentationSpaceSize = Class(name="afpText_ObjectContainerPresentationSpaceSize")
afpText_PageOverlayConditionalProcessing = Class(name="afpText_PageOverlayConditionalProcessing")
afpText_ResourceUsageAttribute = Class(name="afpText_ResourceUsageAttribute")
afpText_ResourceObjectInclude = Class(name="afpText_ResourceObjectInclude")
...
afpText_BDA.attributes={afpText_BDA_Yoffset, afpText_BDA_Flags, afpText_BDA_Data, afpText_BDA_Xoffset}
...
afpText_BDD.attributes={afpText_BDD_XUPUB, afpText_BDD_YEXTENT, afpText_BDD_MODULEWIDTH, afpText_BDD_Reserved, afpText_BDD_Reserved2, afpText_BDD_MOD, afpText_BDD_YUPUB, afpText_BDD_XEXTENT, afpText_BDD_WENE, afpText_BDD_LID, afpText_BDD_MULT, afpText_BDD_UBASE, afpText_BDD_TYPE, afpText_BDD_COLOR, afpText_BDD_ELEMENTHEIGHT}
...
afpText_CDD.attributes={afpText_CDD_XocBase, afpText_CDD_YocUnits, afpText_CDD_XocUnits, afpText_CDD_YocBase, afpText_CDD_YocSize, afpText_CDD_XocSize}
...
afpText_CFC.attributes={afpText_CFC_CFIRGLen, afpText_CFC_Retired1}
...
afpText_CFIRG.attributes={afpText_CFIRG_FCSName, afpText_CFIRG_Section, afpText_CFIRG_CPName, afpText_CFIRG_SVSize, afpText_CFIRG_Reserved, afpText_CFIRG_SHScale}
...
afpText_CPC.attributes={afpText_CPC_PrtFlags, afpText_CPC_VSCharSN, afpText_CPC_DefCharID, afpText_CPC_VSFlags, afpText_CPC_VSChar, afpText_CPC_CPIRGLen}
...
afpText_CPD.attributes={afpText_CPD_EncScheme, afpText_CPD_GCGIDLen, afpText_CPD_CPGID, afpText_CPD_CPDesc, afpText_CPD_GCSGID, afpText_CPD_NumCdPts}
...
afpText_CPIRG.attributes={afpText_CPIRG_PrtFlags, afpText_CPIRG_GCGID, afpText_CPIRG_CodePoint, afpText_CPIRG_Count}
...
afpText_FNC.attributes={afpText_FNC_ResYUBase, afpText_FNC_FNIRGLen, afpText_FNC_FNMRGLen, afpText_FNC_RPatDCnt, afpText_FNC_YftUnits, afpText_FNC_FNNRGLen, afpText_FNC_YUnitBase, afpText_FNC_FNNDCnt, afpText_FNC_Reserved1, afpText_FNC_PatAlign, afpText_FNC_PatTech, afpText_FNC_MaxBoxHt, afpText_FNC_YfrUnits, afpText_FNC_MaxBoxWd, afpText_FNC_FNORGLen, afpText_FNC_XfrUnits, afpText_FNC_Retired, afpText_FNC_XUnitBase, afpText_FNC_FNNMapCnt, afpText_FNC_FntFlags, afpText_FNC_Reserved2, afpText_FNC_ResXUBase, afpText_FNC_XftUnits, afpText_FNC_OPatDCnt, afpText_FNC_FNPRGLen}
...
afpText_FND.attributes={afpText_FND_MinPtSize, afpText_FND_MaxPtSize, afpText_FND_FtDsFlags, afpText_FND_FtWdClass, afpText_FND_DsnSubCls, afpText_FND_Reserved2, afpText_FND_FGID, afpText_FND_TypeFcDesc, afpText_FND_FtWtClass, afpText_FND_DsnSpcGrp, afpText_FND_GCSID, afpText_FND_MaxHSize, afpText_FND_MinHSize, afpText_FND_NomPtSize, afpText_FND_DsnGenCls, afpText_FND_NomHSize, afpText_FND_Reserved1}
...
afpText_FNIRG.attributes={afpText_FNIRG_AscendHt, afpText_FNIRG_FNMCnt, afpText_FNIRG_CSpace, afpText_FNIRG_CharInc, afpText_FNIRG_ASpace, afpText_FNIRG_Reserved, afpText_FNIRG_Reserved2, afpText_FNIRG_GCGID, afpText_FNIRG_BSpace, afpText_FNIRG_BaseOset, afpText_FNIRG_DescendDp}
...
afpText_FNMRG.attributes={afpText_FNMRG_CharBoxWd, afpText_FNMRG_CharBoxHt, afpText_FNMRG_PatDOset}
...
afpText_FNORG.attributes={afpText_FNORG_MinASp, afpText_FNORG_MaxCharInc, afpText_FNORG_MaxBOset, afpText_FNORG_MaxBExt, afpText_FNORG_OrntFlgs, afpText_FNORG_Reserved3, afpText_FNORG_EmSpInc, afpText_FNORG_CharRot, afpText_FNORG_FigSpInc, afpText_FNORG_Reserved2, afpText_FNORG_NomCharInc, afpText_FNORG_DefBInc, afpText_FNORG_SpCharInc, afpText_FNORG_Reserved}
...
afpText_FNPRG.attributes={afpText_FNPRG_LcHeight, afpText_FNPRG_Reserved2, afpText_FNPRG_Reserved3, afpText_FNPRG_MaxDesDp, afpText_FNPRG_UscoreWdf, afpText_FNPRG_UscorePos, afpText_FNPRG_MaxAscHt, afpText_FNPRG_UscoreWd, afpText_FNPRG_Reserved, afpText_FNPRG_Retired, afpText_FNPRG_CapMHt}
...
afpText_IDD.attributes={afpText_IDD_XSIZE, afpText_IDD_YSIZE, afpText_IDD_XRESOL, afpText_IDD_YRESOL, afpText_IDD_UNITBASE}
...
afpText_IID.attributes={afpText_IID_YSize, afpText_IID_ConData2, afpText_IID_YCSizeD, afpText_IID_YBase, afpText_IID_Color, afpText_IID_XSize, afpText_IID_XCSizeD, afpText_IID_ConData3, afpText_IID_ConData1, afpText_IID_YUnits, afpText_IID_XBase, afpText_IID_XUnits}
...
afpText_IOB.attributes={afpText_IOB_RefCSys, afpText_IOB_XoaOrent, afpText_IOB_YocaOset, afpText_IOB_YoaOset, afpText_IOB_XoaOset, afpText_IOB_XocaOset, afpText_IOB_YoaOrent, afpText_IOB_ObjName, afpText_IOB_ObjType}
...
afpText_IOC.attributes={afpText_IOC_XMap, afpText_IOC_XoaOrent, afpText_IOC_YMap, afpText_IOC_YoaOrent, afpText_IOC_ConData2, afpText_IOC_YoaOset, afpText_IOC_XoaOset, afpText_IOC_ConData1}
...
afpText_ICP.attributes={afpText_ICP_YFilSize, afpText_ICP_XFilSize, afpText_ICP_YCOset, afpText_ICP_YCSize, afpText_ICP_XCOset, afpText_ICP_XCSize}
...
afpText_IPG.attributes={afpText_IPG_PgName, afpText_IPG_IPgFlgs}
...
afpText_IPO.attributes={afpText_IPO_OvlyOrent, afpText_IPO_XolOset, afpText_IPO_YolOset, afpText_IPO_OvlyName}
...
afpText_LLERG.attributes={afpText_LLERG_RGLength, afpText_LLERG_RGFunct}
...
afpText_LND.attributes={afpText_LND_NLNDccp, afpText_LND_SupName, afpText_LND_LNDFlgs, afpText_LND_SubpgID, afpText_LND_NLNDskp, afpText_LND_BPos, afpText_LND_SOLid, afpText_LND_NLNDsp, afpText_LND_NLNDreu, afpText_LND_IPos, afpText_LND_DataStrt, afpText_LND_TxtColor, afpText_LND_ChnlCde, afpText_LND_CCPID, afpText_LND_TxtOrent, afpText_LND_DataLgth, afpText_LND_FntLID}
...
afpText_MCCRG.attributes={afpText_MCCRG_Stopnum, afpText_MCCRG_MMCid, afpText_MCCRG_Startnum}
...
afpText_MCF1RG.attributes={afpText_MCF1RG_Sectid, afpText_MCF1RG_CharRot, afpText_MCF1RG_CPName, afpText_MCF1RG_FCSName, afpText_MCF1RG_CFLid, afpText_MCF1RG_CFName}
...
afpText_MDD.attributes={afpText_MDD_XmBase, afpText_MDD_XmUnits, afpText_MDD_MDDFlgs, afpText_MDD_YmBase, afpText_MDD_YmUnits, afpText_MDD_YmSize, afpText_MDD_XmSize}
...
afpText_MFC.attributes={afpText_MFC_MFCScpe, afpText_MFC_MFCFlgs, afpText_MFC_MedColl}
...
afpText_MMORG.attributes={afpText_MMORG_OVLid, afpText_MMORG_Flags, afpText_MMORG_OVLname}
...
afpText_MPSRG.attributes={afpText_MPSRG_Reserved, afpText_MPSRG_PsegName}
...
afpText_OBP.attributes={afpText_OBP_XocaOset, afpText_OBP_XoaOrent, afpText_OBP_YoaOrent, afpText_OBP_YocaOset, afpText_OBP_XocaOrent, afpText_OBP_OAPosID, afpText_OBP_YoaOset, afpText_OBP_YocaOrent, afpText_OBP_RGLength, afpText_OBP_XoaOset, afpText_OBP_RefCSys}
...
afpText_PGD.attributes={afpText_PGD_YpgSize, afpText_PGD_YpgBase, afpText_PGD_XpgSize, afpText_PGD_YpgUnits, afpText_PGD_Reserved, afpText_PGD_XpgBase, afpText_PGD_XpgUnits}
...
afpText_PGPRG.attributes={afpText_PGPRG_PGorient, afpText_PGPRG_YmOset, afpText_PGPRG_RGLength, afpText_PGPRG_SHside, afpText_PGPRG_PMCid, afpText_PGPRG_PgFlgs, afpText_PGPRG_XmOset}
...
afpText_PPORG.attributes={afpText_PPORG_XocaOset, afpText_PPORG_ObjType, afpText_PPORG_ProcFlgs, afpText_PPORG_YocaOset, afpText_PPORG_RGLength}
...
afpText_PTD.attributes={afpText_PTD_XPUNITVL, afpText_PTD_YPEXTENT, afpText_PTD_YPUNITVL, afpText_PTD_YPBASE, afpText_PTD_XPEXTENT, afpText_PTD_RESERVED, afpText_PTD_XPBASE}
...
afpText_PTD1.attributes={afpText_PTD1_XPUNITVL, afpText_PTD1_XPBASE, afpText_PTD1_RESERVED, afpText_PTD1_YPBASE, afpText_PTD1_YPEXTENT, afpText_PTD1_XPEXTENT, afpText_PTD1_YPUNITVL}
...
afpText_TileTOCRG.attributes={afpText_TileTOCRG_XOFFSET, afpText_TileTOCRG_THSIZE, afpText_TileTOCRG_RELRES, afpText_TileTOCRG_DATAPOS, afpText_TileTOCRG_COMPR, afpText_TileTOCRG_TVSIZE, afpText_TileTOCRG_YOFFSET}
...
afpText_SamplingRatiosRG.attributes={afpText_SamplingRatiosRG_VSAMPLE, afpText_SamplingRatiosRG_HSAMPLE}
...
afpText_ExternalAlgorithmRG.attributes={afpText_ExternalAlgorithmRG_DIRCTN, afpText_ExternalAlgorithmRG_PADBDRY, afpText_ExternalAlgorithmRG_PADALMT}
...
afpText_FNNRG.attributes={afpText_FNNRG_GCGID, afpText_FNNRG_TSOffset}
...
afpText_GCBEZRG.attributes={afpText_GCBEZRG_XPOS, afpText_GCBEZRG_YPOS}
...
afpText_GCCBEZRG.attributes={afpText_GCCBEZRG_XPOS, afpText_GCCBEZRG_YPOS}
...
afpText_GFLTRG.attributes={afpText_GFLTRG_YPOS, afpText_GFLTRG_XPOS}
...
afpText_GCFLTRG.attributes={afpText_GCFLTRG_YPOS, afpText_GCFLTRG_XPOS}
...
afpText_GLINERG.attributes={afpText_GLINERG_YPOS, afpText_GLINERG_XPOS}
...
afpText_GCMRKRG.attributes={afpText_GCMRKRG_XPOS, afpText_GCMRKRG_YPOS}
...
afpText_GCRLINERG.attributes={afpText_GCRLINERG_YOFFS, afpText_GCRLINERG_XOSSF}
...
afpText_DIR.attributes={afpText_DIR_RWIDTH, afpText_DIR_RWIDTHFRACTION, afpText_DIR_RLENGTH}
...
afpText_OVS.attributes={afpText_OVS_OVERCHAR, afpText_OVS_BYPSIDEN}
...
afpText_SEC.attributes={afpText_SEC_COLSIZE4, afpText_SEC_COLSIZE2, afpText_SEC_COLVALUE, afpText_SEC_RESERVED, afpText_SEC_COLSPCE, afpText_SEC_COLSIZE3, afpText_SEC_COLSIZE1}
...
afpText_SIA.attributes={afpText_SIA_DIRCTION, afpText_SIA_ADJSTMNT}
...
afpText_STC.attributes={afpText_STC_PRECSION, afpText_STC_FRGCOLOR}
...
afpText_AttributeQualifier.attributes={afpText_AttributeQualifier_LevNum, afpText_AttributeQualifier_SeqNum}
...
afpText_CRCResourceManagement.attributes={afpText_CRCResourceManagement_RMValue, afpText_CRCResourceManagement_ResClassFlg, afpText_CRCResourceManagement_FmtQual}
...
afpText_ColorSpecification.attributes={afpText_ColorSpecification_ColSize3, afpText_ColorSpecification_ColSize1, afpText_ColorSpecification_Color, afpText_ColorSpecification_ColSize4, afpText_ColorSpecification_ColSpce, afpText_ColorSpecification_ColSize2}
...
afpText_DataObjectFontDescriptor.attributes={afpText_DataObjectFontDescriptor_HFS, afpText_DataObjectFontDescriptor_Reserved, afpText_DataObjectFontDescriptor_VFS, afpText_DataObjectFontDescriptor_EncEnv, afpText_DataObjectFontDescriptor_CharRot, afpText_DataObjectFontDescriptor_DOFtFlgs, afpText_DataObjectFontDescriptor_FontTech, afpText_DataObjectFontDescriptor_EncID}
...
afpText_EncodingSchemeID.attributes={afpText_EncodingSchemeID_ESidUD, afpText_EncodingSchemeID_ESidCP}
...
afpText_FontResolution.attributes={afpText_FontResolution_MetTech, afpText_FontResolution_RPuBase, afpText_FontResolution_RPUnits}
...
afpText_LocalDateAndTimeStamp.attributes={afpText_LocalDateAndTimeStamp_Day, afpText_LocalDateAndTimeStamp_Second, afpText_LocalDateAndTimeStamp_TenYear, afpText_LocalDateAndTimeStamp_Minute, afpText_LocalDateAndTimeStamp_HundSec, afpText_LocalDateAndTimeStamp_StampType, afpText_LocalDateAndTimeStamp_THunYear, afpText_LocalDateAndTimeStamp_Hour}
...
afpText_UniversalDateAndTimeStamp.attributes={afpText_UniversalDateAndTimeStamp_YearAD, afpText_UniversalDateAndTimeStamp_Reserved, afpText_UniversalDateAndTimeStamp_Day, afpText_UniversalDateAndTimeStamp_UTCDiffH, afpText_UniversalDateAndTimeStamp_UTCDiffM, afpText_UniversalDateAndTimeStamp_Second, afpText_UniversalDateAndTimeStamp_Month, afpText_UniversalDateAndTimeStamp_Hour, afpText_UniversalDateAndTimeStamp_TimeZone, afpText_UniversalDateAndTimeStamp_Minute}
...
afpText_MeasurementUnits.attributes={afpText_MeasurementUnits_XoaUnits, afpText_MeasurementUnits_XoaBase, afpText_MeasurementUnits_YoaUnits, afpText_MeasurementUnits_YoaBase}
...
afpText_ObjectAreaSize.attributes={afpText_ObjectAreaSize_YoaSize, afpText_ObjectAreaSize_XoaSize, afpText_ObjectAreaSize_SizeType}
...
afpText_ObjectClassification.attributes={afpText_ObjectClassification_ObjLev, afpText_ObjectClassification_ObjClass, afpText_ObjectClassification_StrucFlgs, afpText_ObjectClassification_RegObjId, afpText_ObjectClassification_ObjTpName, afpText_ObjectClassification_CompName}
...
afpText_FullyQualifiedName.attributes={afpText_FullyQualifiedName_FQNFormat, afpText_FullyQualifiedName_FQName, afpText_FullyQualifiedName_FQNType}
...
afpText_ObjectOffset.attributes={afpText_ObjectOffset_ObjOset, afpText_ObjectOffset_ObjTpe, afpText_ObjectOffset_ObjOstHi}
...
afpText_ResourceObjectType.attributes={afpText_ResourceObjectType_ObjType, afpText_ResourceObjectType_ConData}
...
afpText_ResourceLocalIdentifier.attributes={afpText_ResourceLocalIdentifier_ResLID, afpText_ResourceLocalIdentifier_ResType}
...
afpText_FontDescriptorSpecification.attributes={afpText_FontDescriptorSpecification_FtHeight, afpText_FontDescriptorSpecification_FtDsFlags, afpText_FontDescriptorSpecification_FtWdClass, afpText_FontDescriptorSpecification_FtUsFlags, afpText_FontDescriptorSpecification_FtWidth, afpText_FontDescriptorSpecification_FtWtClass}
...
afpText_ObjectFunctionSetSpecification.attributes={afpText_ObjectFunctionSetSpecification_ArchVrsn, afpText_ObjectFunctionSetSpecification_ObjType, afpText_ObjectFunctionSetSpecification_DCAFnSet, afpText_ObjectFunctionSetSpecification_OCAFnSet}
...
afpText_ImageSize.attributes={afpText_ImageSize_VSIZE, afpText_ImageSize_HSIZE, afpText_ImageSize_VRESOL, afpText_ImageSize_UNITBASE, afpText_ImageSize_HRESOL}
...
afpText_ImageEncoding.attributes={afpText_ImageEncoding_COMPRID, afpText_ImageEncoding_BITORDR, afpText_ImageEncoding_RECID}
...
afpText_TilePosition.attributes={afpText_TilePosition_YOFFSET, afpText_TilePosition_XOFFSET}
...
afpText_TileSize.attributes={afpText_TileSize_TVSIZE, afpText_TileSize_RELRES, afpText_TileSize_THSIZE}
...
afpText_TileSetColor.attributes={afpText_TileSetColor_SIZE1, afpText_TileSetColor_CVAL3, afpText_TileSetColor_CVAL4, afpText_TileSetColor_SIZE2, afpText_TileSetColor_SIZE3, afpText_TileSetColor_CVAL2, afpText_TileSetColor_CVAL1, afpText_TileSetColor_CSPACE, afpText_TileSetColor_SIZE4, afpText_TileSetColor_RESERVED}
...
afpText_SetBiLevelImageColor.attributes={afpText_SetBiLevelImageColor_Reserved, afpText_SetBiLevelImageColor_AREA, afpText_SetBiLevelImageColor_NAMECOLR}
...
afpText_IOCAFunctionSetIdentification.attributes={afpText_IOCAFunctionSetIdentification_FCNSET, afpText_IOCAFunctionSetIdentification_CATEGORY}
...
afpText_BandImageData.attributes={afpText_BandImageData_DATA, afpText_BandImageData_BANDNUM, afpText_BandImageData_RESERVED}
...
afpText_IDEStructure.attributes={afpText_IDEStructure_SIZE2, afpText_IDEStructure_SIZE3, afpText_IDEStructure_FLAGS, afpText_IDEStructure_FORMAT, afpText_IDEStructure_SIZE4, afpText_IDEStructure_SIZE1}
...
afpText_BeginSegmentCommand.attributes={afpText_BeginSegmentCommand_LENGTH, afpText_BeginSegmentCommand_NAME, afpText_BeginSegmentCommand_PSNAME, afpText_BeginSegmentCommand_SEGL, afpText_BeginSegmentCommand_FLAG2, afpText_BeginSegmentCommand_FLAG1}
...
afpText_GBIMG.attributes={afpText_GBIMG_XPOS, afpText_GBIMG_FORMAT, afpText_GBIMG_HEIGHT, afpText_GBIMG_WIDTH, afpText_GBIMG_YPOS, afpText_GBIMG_RES}
...
afpText_GCBIMG.attributes={afpText_GCBIMG_HEIGHT, afpText_GCBIMG_FORMAT, afpText_GCBIMG_WIDTH, afpText_GCBIMG_RES}
...
afpText_GBOX.attributes={afpText_GBOX_YPOS0, afpText_GBOX_YPOS1, afpText_GBOX_XPOS0, afpText_GBOX_VAXIS, afpText_GBOX_RES, afpText_GBOX_XPOS1, afpText_GBOX_HAXIS}
...
afpText_GCHST.attributes={afpText_GCHST_YPOS, afpText_GCHST_XPOS, afpText_GCHST_CP}
...
afpText_GFARC.attributes={afpText_GFARC_MH, afpText_GFARC_MFR, afpText_GFARC_XPOS, afpText_GFARC_YPOS}
...
afpText_GCFARC.attributes={afpText_GCFARC_MH, afpText_GCFARC_MFR}
...
afpText_GCBOX.attributes={afpText_GCBOX_HAXIS, afpText_GCBOX_VAXIS, afpText_GCBOX_XPOS1, afpText_GCBOX_YPOS1, afpText_GCBOX_RES}
...
afpText_GPARC.attributes={afpText_GPARC_YCENT, afpText_GPARC_YPOS, afpText_GPARC_MH, afpText_GPARC_MFR, afpText_GPARC_XPOS, afpText_GPARC_SWEEP, afpText_GPARC_XCENT, afpText_GPARC_START}
...
afpText_GCPARC.attributes={afpText_GCPARC_MFR, afpText_GCPARC_START, afpText_GCPARC_SWEEP, afpText_GCPARC_MH, afpText_GCPARC_YCENT, afpText_GCPARC_XCENT}
...
afpText_GSAP.attributes={afpText_GSAP_S, afpText_GSAP_P, afpText_GSAP_R, afpText_GSAP_Q}
...
afpText_GSCA.attributes={afpText_GSCA_XPOS, afpText_GSCA_YPOS}
...
afpText_GSFLW.attributes={afpText_GSFLW_MH, afpText_GSFLW_MFR}
...
afpText_GSMC.attributes={afpText_GSMC_CELLWI, afpText_GSMC_CELLHI}
...
afpText_GSCC.attributes={afpText_GSCC_CELLHI, afpText_GSCC_CELLWFR, afpText_GSCC_CELLWI, afpText_GSCC_CELLHFR}
...
afpText_WindowSpecification.attributes={afpText_WindowSpecification_YRESOL, afpText_WindowSpecification_IMGXYRES, afpText_WindowSpecification_CFORMAT, afpText_WindowSpecification_XRWIND, afpText_WindowSpecification_YTWIND, afpText_WindowSpecification_UBASE, afpText_WindowSpecification_FLAGS, afpText_WindowSpecification_XRESOL, afpText_WindowSpecification_RES3, afpText_WindowSpecification_XLWIND, afpText_WindowSpecification_YBWIND}
...
afpText_ColorFidelity.attributes={afpText_ColorFidelity_ColSub, afpText_ColorFidelity_RepCoEx, afpText_ColorFidelity_StpCoEx}
...
afpText_TextFidelity.attributes={afpText_TextFidelity_RepTxtEx, afpText_TextFidelity_StpTxtEx}
...
afpText_GSPCOL.attributes={afpText_GSPCOL_COLSIZE4, afpText_GSPCOL_COLSPCE, afpText_GSPCOL_COLSIZE3, afpText_GSPCOL_COLVALUE, afpText_GSPCOL_COLSIZE2, afpText_GSPCOL_COLSIZE1, afpText_GSPCOL_RES2, afpText_GSPCOL_RES1}
...
afpText_ObjectByteOffset.attributes={afpText_ObjectByteOffset_DirByOff, afpText_ObjectByteOffset_DirByHi}
...
afpText_ObjectStructuredFieldOffset.attributes={afpText_ObjectStructuredFieldOffset_SFOff, afpText_ObjectStructuredFieldOffset_SFOffHi}
...
afpText_ObjectCount.attributes={afpText_ObjectCount_SobjNmHi, afpText_ObjectCount_SubObj, afpText_ObjectCount_SObjNum}
...
afpText_ObjectOriginIdentifier.attributes={afpText_ObjectOriginIdentifier_System, afpText_ObjectOriginIdentifier_MedID, afpText_ObjectOriginIdentifier_SysID, afpText_ObjectOriginIdentifier_DSID}
...
afpText_ColorManagementResourceDescriptor.attributes={afpText_ColorManagementResourceDescriptor_CMRScpe, afpText_ColorManagementResourceDescriptor_ProcMode}
...
afpText_ImageResolution.attributes={afpText_ImageResolution_YResol, afpText_ImageResolution_XBase, afpText_ImageResolution_XResol, afpText_ImageResolution_YBase}
...
afpText_ExtendedResourceLocalIdentifier.attributes={afpText_ExtendedResourceLocalIdentifier_ResLID, afpText_ExtendedResourceLocalIdentifier_ResType}
...
afpText_MetricAdjustment.attributes={afpText_MetricAdjustment_VUniformIncrement, afpText_MetricAdjustment_HUniformIncrement, afpText_MetricAdjustment_VBaselineIncrement, afpText_MetricAdjustment_YUPUB, afpText_MetricAdjustment_UnitBase, afpText_MetricAdjustment_XUPUB, afpText_MetricAdjustment_HBaselineIncrement}
...
afpText_RenderingIntent.attributes={afpText_RenderingIntent_GOCARI, afpText_RenderingIntent_PTOCRI, afpText_RenderingIntent_Reserved, afpText_RenderingIntent_OCRI, afpText_RenderingIntent_Reserved2, afpText_RenderingIntent_IOCARI}
...
afpText_FontCodedGraphicCharacterSetGlobalIdentifier.attributes={afpText_FontCodedGraphicCharacterSetGlobalIdentifier_CPGID, afpText_FontCodedGraphicCharacterSetGlobalIdentifier_GCSGID}
...
afpText_LocaleSelector.attributes={afpText_LocaleSelector_VarCde, afpText_LocaleSelector_LangCode, afpText_LocaleSelector_LocFlgs, afpText_LocaleSelector_Reserved, afpText_LocaleSelector_RegCde, afpText_LocaleSelector_ScrptCde}
...
afpText_FinishingOperation.attributes={afpText_FinishingOperation_RefEdge, afpText_FinishingOperation_FOpType, afpText_FinishingOperation_AxOffst, afpText_FinishingOperation_OpPos, afpText_FinishingOperation_FOpCnt}
...
afpText_PageOverlayConditionalProcessing.attributes={afpText_PageOverlayConditionalProcessing_PgOvType, afpText_PageOverlayConditionalProcessing_Level}
...
afpText_ResourceObjectInclude.attributes={afpText_ResourceObjectInclude_ObjName, afpText_ResourceObjectInclude_ObOrent, afpText_ResourceObjectInclude_YobjOset, afpText_ResourceObjectInclude_XobjOset, afpText_ResourceObjectInclude_ObjType}
...
domain_model = DomainModel(
    name="afpText",
    types={afpText_Model, afpText_structuredField, afpText_LineData, structuredField, afpText_BAG, afpText_triplet, afpText_BBC, afpText_BCA, afpText_BCF, afpText_BCP, afpText_BDA, afpText_BDD, afpText_BDG, afpText_BDI, afpText_BDM, afpText_BDT, afpText_BDX, afpText_BFG, afpText_BFM, afpText_BFN, afpText_BGR, afpText_BII, afpText_BIM, afpText_BMM, afpText_BMO, afpText_BNG, afpText_BOC, afpText_BOG, afpText_BPF, afpText_BPG, afpText_BPM, afpText_BPS, afpText_BPT, afpText_BRS, afpText_BSG, afpText_CAT, afpText_CDD, afpText_CFC, afpText_CFI, afpText_CFIRG, afpText_CPC, afpText_CPD, afpText_CPI, afpText_CPIRG, afpText_CTC, afpText_BRG, afpText_DXD, afpText_EAG, afpText_EBC, afpText_ECA, afpText_ECF, afpText_ECP, afpText_EDG, afpText_EDI, afpText_EDM, afpText_EDT, afpText_EDX, afpText_EFG, afpText_EFM, afpText_EFN, afpText_EGR, afpText_EII, afpText_EMM, afpText_EMO, afpText_ENG, afpText_EOC, afpText_EOG, afpText_EPF, afpText_EPG, afpText_EPM, afpText_EPS, afpText_EIM, afpText_ERG, afpText_ERS, afpText_ESG, afpText_FNC, afpText_FND, afpText_EPT, afpText_FNG, afpText_FNI, afpText_FNIRG, afpText_FNN, afpText_FNM, afpText_FNMRG, afpText_FNO, afpText_FNORG, afpText_FNP, afpText_FNPRG, afpText_GAD, afpText_GDD, afpText_IDD, afpText_IEL, afpText_IID, afpText_IMM, afpText_IOB, afpText_IOC, afpText_ICP, afpText_IPD, afpText_IPG, afpText_IPS, afpText_IRD, afpText_IPO, afpText_LLERG, afpText_LNC, afpText_LND, afpText_MBC, afpText_MBCRG, afpText_LLE, afpText_MCCRG, afpText_MCD, afpText_MCDRG, afpText_MCF, afpText_MCFRG, afpText_MCF1, afpText_MCF1RG, afpText_MDD, afpText_MDR, afpText_MDRRG, afpText_MFC, afpText_MCA, afpText_MCARG, afpText_MCC, afpText_MGORG, afpText_MIO, afpText_MIORG, afpText_MMC, afpText_MMCRG, afpText_MMD, afpText_MMDRG, afpText_MMO, afpText_MMORG, afpText_MMT, afpText_MMTRG, afpText_MPG, afpText_MPGRG, afpText_MPO, afpText_MPORG, afpText_MPS, afpText_MPSRG, afpText_MGO, afpText_OBD, afpText_OBP, afpText_OCD, afpText_PEC, afpText_PFC, afpText_PGD, afpText_MSU, afpText_MSURG, afpText_NOP, afpText_PGPRG, afpText_PGP1, afpText_PMC, afpText_PPO, afpText_PPORG, afpText_PTD, afpText_PTD1, afpText_PGP, afpText_FGD, afpText_PTX, afpText_TLE, afpText_BandImageRG, afpText_TileTOCRG, afpText_SamplingRatiosRG, afpText_ExternalAlgorithmRG, afpText_FNNRG, afpText_GCBEZRG, afpText_GCCBEZRG, afpText_GFLTRG, afpText_GCFLTRG, afpText_GLINERG, afpText_GCLINERG, afpText_GMRKRG, afpText_GCMRKRG, afpText_GRLINERG, afpText_GCRLINERG, afpText_DBR, afpText_DIR, afpText_ESU, afpText_NOPCS, afpText_OVS, afpText_RMB, afpText_RMI, afpText_RPS, afpText_SBI, afpText_SCFL, afpText_SEC, afpText_SIA, afpText_SIM, afpText_STC, afpText_STO, afpText_SVI, afpText_AMB, triplet, afpText_AMI, afpText_BLN, afpText_BSU, afpText_USC, afpText_AttributeQualifier, afpText_AttributeValue, afpText_CGCSGID, afpText_CRCResourceManagement, afpText_CharacterRotation, afpText_ColorSpecification, afpText_Comment, afpText_DataObjectFontDescriptor, afpText_DescriptorPosition, afpText_EncodingSchemeID, afpText_FontResolution, afpText_TBM, afpText_TRN, afpText_LocalDateAndTimeStamp, afpText_UniversalDateAndTimeStamp, afpText_MappingOption, afpText_MediaEjectControl, afpText_MediumMapPageNumber, afpText_MediumOrientation, afpText_MeasurementUnits, afpText_MODCAInterchangeSet, afpText_ObjectAreaSize, afpText_ObjectClassification, afpText_FullyQualifiedName, afpText_ObjectOffset, afpText_ResourceObjectType, afpText_PagePositionInformation, afpText_PresentationControl, afpText_PresentationSpaceResetMixing, afpText_PresentationSpaceMixingRules, afpText_ResourceLocalIdentifier, afpText_ResourceSectionNumber, afpText_TextOrientation, afpText_FontHorizontalScaleFactor, afpText_FontDescriptorSpecification, afpText_BeginSegment, afpText_EndSegment, afpText_ObjectFunctionSetSpecification, afpText_BeginTransparencyMask, afpText_EndTransparencyMask, afpText_BeginImage, afpText_EndImage, afpText_ImageSize, afpText_ImageEncoding, afpText_IDESize, afpText_ImageLUTID, afpText_BandImage, afpText_BeginTile, afpText_EndTile, afpText_ExternalAlgorithm, afpText_TilePosition, afpText_TileSize, afpText_TileSetColor, afpText_SetBiLevelImageColor, afpText_IOCAFunctionSetIdentification, afpText_ImageData, afpText_BandImageData, afpText_IncludeTile, afpText_ImageSubsampling, afpText_SamplingRatios, afpText_IDEStructure, afpText_TileTOC, afpText_FNNRG2, afpText_BeginSegmentCommand, afpText_EndSegmentCommand, afpText_GBAR, afpText_GBIMG, afpText_GCBIMG, afpText_GBOX, afpText_GCHST, afpText_GCCHST, afpText_GCOMT, afpText_GEAR, afpText_GEIMG, afpText_GEPROL, afpText_GFLT, afpText_GCFLT, afpText_GFARC, afpText_GCFARC, afpText_GIMD, afpText_GLINE, afpText_GCLINE, afpText_GCBOX, afpText_GCMRK, afpText_GNOP1, afpText_GPARC, afpText_GCPARC, afpText_GRLINE, afpText_GCRLINE, afpText_GSGCH, afpText_GSAP, afpText_GSBMX, afpText_GSCA, afpText_GMRK, afpText_GSCR, afpText_GSCS, afpText_GSCH, afpText_GSCOL, afpText_GSCP, afpText_GSECOL, afpText_GSFLW, afpText_GSLT, afpText_GSLW, afpText_GSMC, afpText_GSMP, afpText_GSMS, afpText_GSMT, afpText_GSMX, afpText_GSPS, afpText_GSPT, afpText_GSCC, afpText_GSCD, afpText_GSLE, afpText_GSLJ, afpText_GCBEZ, afpText_GCCBEZ, afpText_WindowSpecification, afpText_DrawingOrderSubset, afpText_TonerSaver, afpText_ColorFidelity, afpText_FontFidelity, afpText_TextFidelity, afpText_GSPCOL, afpText_CMRFidelity, afpText_ObjectByteExtent, afpText_ObjectByteOffset, afpText_ObjectStructuredFieldExtent, afpText_ObjectStructuredFieldOffset, afpText_ObjectCount, afpText_ObjectOriginIdentifier, afpText_LineDataObjectPositionMigration, afpText_ColorManagementResourceDescriptor, afpText_ImageResolution, afpText_MediaFidelity, afpText_FinishingFidelity, afpText_ExtendedResourceLocalIdentifier, afpText_MetricAdjustment, afpText_ExtensionFont, afpText_RenderingIntent, afpText_FontCodedGraphicCharacterSetGlobalIdentifier, afpText_LocaleSelector, afpText_FinishingOperation, afpText_UP3iFinishingOperation, afpText_DeviceAppearance, afpText_ObjectContainerPresentationSpaceSize, afpText_PageOverlayConditionalProcessing, afpText_ResourceUsageAttribute, afpText_ResourceObjectInclude},
    associations={structuredFields0, triplets1, triplets2, triplets4, triplets6, triplets8, triplets10, triplets12, triplets14, triplets16, triplets18, triplets20, triplets22, triplets24, triplets26, triplets28, triplets30, triplets32, triplets34, triplets36, triplets38, triplets40, triplets42, triplets44, triplets46, triplets48, triplets50, triplets52, rg54, rg55, triplets56, triplets58, triplets60, triplets62, triplets64, triplets66, triplets68, triplets70, triplets72, triplets74, triplets76, triplets78, triplets80, triplets82, triplets84, rg86, rg87, rg88, rg89, triplets90, triplets92, triplets94, triplets96, triplets98, triplets100, triplets102, triplets104, rg106, triplets107, rg109, rg111, rg112, rg113, rg114, triplets115, rg117, rg110, rg120, rg121, rg122, rg123, rg124, rg125, rg126, rg127, rg128, triplets118, triplets130, triplets132, triplets134, rg129, rg138, triplets139, rg141, triplets142, triplets136, triplets146, triplets148, triplets144, triplets157, triplets160, triplets163, triplets166, triplets169, triplets172, triplets175, triplets178, triplets151, triplets154, triplets184, triplets181, rg187, rg188, rg189, rg190, rg191, rg192, rg193, rg196, rg197, rg198, rg194, rg195, rg199, rg200},
    generalizations={gen_afpText_LineData_structuredField, gen_afpText_BAG_structuredField, gen_afpText_BBC_structuredField, gen_afpText_BCA_structuredField, gen_afpText_BCF_structuredField, gen_afpText_BCP_structuredField, gen_afpText_BDA_structuredField, gen_afpText_BDD_structuredField, gen_afpText_BDG_structuredField, gen_afpText_BDI_structuredField, gen_afpText_BDM_structuredField, gen_afpText_BDT_structuredField, gen_afpText_BDX_structuredField, gen_afpText_BFG_structuredField, gen_afpText_BFM_structuredField, gen_afpText_BFN_structuredField, gen_afpText_BGR_structuredField, gen_afpText_BII_structuredField, gen_afpText_BIM_structuredField, gen_afpText_BMM_structuredField, gen_afpText_BMO_structuredField, gen_afpText_BNG_structuredField, gen_afpText_BOC_structuredField, gen_afpText_BOG_structuredField, gen_afpText_BPF_structuredField, gen_afpText_BPG_structuredField, gen_afpText_BPM_structuredField, gen_afpText_BPS_structuredField, gen_afpText_BPT_structuredField, gen_afpText_BRS_structuredField, gen_afpText_BSG_structuredField, gen_afpText_CAT_structuredField, gen_afpText_CDD_structuredField, gen_afpText_CFC_structuredField, gen_afpText_CFI_structuredField, gen_afpText_CPC_structuredField, gen_afpText_CPD_structuredField, gen_afpText_CPI_structuredField, gen_afpText_BRG_structuredField, gen_afpText_DXD_structuredField, gen_afpText_EAG_structuredField, gen_afpText_EBC_structuredField, gen_afpText_ECA_structuredField, gen_afpText_ECF_structuredField, gen_afpText_ECP_structuredField, gen_afpText_EDG_structuredField, gen_afpText_EDI_structuredField, gen_afpText_EDM_structuredField, gen_afpText_EDT_structuredField, gen_afpText_EDX_structuredField, gen_afpText_EFG_structuredField, gen_afpText_EFM_structuredField, gen_afpText_EFN_structuredField, gen_afpText_EGR_structuredField, gen_afpText_EII_structuredField, gen_afpText_CTC_structuredField, gen_afpText_EMM_structuredField, gen_afpText_EMO_structuredField, gen_afpText_ENG_structuredField, gen_afpText_EOC_structuredField, gen_afpText_EOG_structuredField, gen_afpText_EPF_structuredField, gen_afpText_EPG_structuredField, gen_afpText_EPM_structuredField, gen_afpText_EPS_structuredField, gen_afpText_EIM_structuredField, gen_afpText_ERG_structuredField, gen_afpText_ERS_structuredField, gen_afpText_ESG_structuredField, gen_afpText_FNC_structuredField, gen_afpText_FND_structuredField, gen_afpText_EPT_structuredField, gen_afpText_FNG_structuredField, gen_afpText_FNI_structuredField, gen_afpText_FNN_structuredField, gen_afpText_FNM_structuredField, gen_afpText_FNO_structuredField, gen_afpText_FNP_structuredField, gen_afpText_GAD_structuredField, gen_afpText_GDD_structuredField, gen_afpText_IDD_structuredField, gen_afpText_IEL_structuredField, gen_afpText_IID_structuredField, gen_afpText_IMM_structuredField, gen_afpText_IOB_structuredField, gen_afpText_IOC_structuredField, gen_afpText_ICP_structuredField, gen_afpText_IPD_structuredField, gen_afpText_IPG_structuredField, gen_afpText_IPS_structuredField, gen_afpText_IRD_structuredField, gen_afpText_IPO_structuredField, gen_afpText_LNC_structuredField, gen_afpText_LND_structuredField, gen_afpText_MBC_structuredField, gen_afpText_LLE_structuredField, gen_afpText_MCD_structuredField, gen_afpText_MCF_structuredField, gen_afpText_MCF1_structuredField, gen_afpText_MDD_structuredField, gen_afpText_MDR_structuredField, gen_afpText_MFC_structuredField, gen_afpText_MCA_structuredField, gen_afpText_MCC_structuredField, gen_afpText_MIO_structuredField, gen_afpText_MMC_structuredField, gen_afpText_MMD_structuredField, gen_afpText_MMO_structuredField, gen_afpText_MMT_structuredField, gen_afpText_MPG_structuredField, gen_afpText_MPO_structuredField, gen_afpText_MPS_structuredField, gen_afpText_MGO_structuredField, gen_afpText_NOP_structuredField, gen_afpText_OBD_structuredField, gen_afpText_OBP_structuredField, gen_afpText_OCD_structuredField, gen_afpText_PEC_structuredField, gen_afpText_PFC_structuredField, gen_afpText_PGD_structuredField, gen_afpText_MSU_structuredField, gen_afpText_PGP1_structuredField, gen_afpText_PMC_structuredField, gen_afpText_PPO_structuredField, gen_afpText_PTD_structuredField, gen_afpText_PTD1_structuredField, gen_afpText_PGP_structuredField, gen_afpText_TLE_structuredField, gen_afpText_FGD_structuredField, gen_afpText_PTX_structuredField, gen_afpText_DBR_triplet, gen_afpText_DIR_triplet, gen_afpText_ESU_triplet, gen_afpText_NOPCS_triplet, gen_afpText_OVS_triplet, gen_afpText_RMB_triplet, gen_afpText_RMI_triplet, gen_afpText_RPS_triplet, gen_afpText_SBI_triplet, gen_afpText_SCFL_triplet, gen_afpText_SEC_triplet, gen_afpText_SIA_triplet, gen_afpText_SIM_triplet, gen_afpText_STC_triplet, gen_afpText_STO_triplet, gen_afpText_AMB_triplet, gen_afpText_AMI_triplet, gen_afpText_BLN_triplet, gen_afpText_BSU_triplet, gen_afpText_USC_triplet, gen_afpText_AttributeQualifier_triplet, gen_afpText_AttributeValue_triplet, gen_afpText_CGCSGID_triplet, gen_afpText_CRCResourceManagement_triplet, gen_afpText_CharacterRotation_triplet, gen_afpText_ColorSpecification_triplet, gen_afpText_Comment_triplet, gen_afpText_DataObjectFontDescriptor_triplet, gen_afpText_DescriptorPosition_triplet, gen_afpText_EncodingSchemeID_triplet, gen_afpText_FontResolution_triplet, gen_afpText_SVI_triplet, gen_afpText_TBM_triplet, gen_afpText_TRN_triplet, gen_afpText_LocalDateAndTimeStamp_triplet, gen_afpText_UniversalDateAndTimeStamp_triplet, gen_afpText_MappingOption_triplet, gen_afpText_MediaEjectControl_triplet, gen_afpText_MediumMapPageNumber_triplet, gen_afpText_MediumOrientation_triplet, gen_afpText_MeasurementUnits_triplet, gen_afpText_MODCAInterchangeSet_triplet, gen_afpText_ObjectAreaSize_triplet, gen_afpText_ObjectClassification_triplet, gen_afpText_FullyQualifiedName_triplet, gen_afpText_ObjectOffset_triplet, gen_afpText_ResourceObjectType_triplet, gen_afpText_PagePositionInformation_triplet, gen_afpText_PresentationControl_triplet, gen_afpText_PresentationSpaceResetMixing_triplet, gen_afpText_PresentationSpaceMixingRules_triplet, gen_afpText_ResourceLocalIdentifier_triplet, gen_afpText_ResourceSectionNumber_triplet, gen_afpText_TextOrientation_triplet, gen_afpText_FontHorizontalScaleFactor_triplet, gen_afpText_FontDescriptorSpecification_triplet, gen_afpText_BeginSegment_triplet, gen_afpText_EndSegment_triplet, gen_afpText_ObjectFunctionSetSpecification_triplet, gen_afpText_BeginTransparencyMask_triplet, gen_afpText_EndTransparencyMask_triplet, gen_afpText_BeginImage_triplet, gen_afpText_EndImage_triplet, gen_afpText_ImageSize_triplet, gen_afpText_ImageEncoding_triplet, gen_afpText_IDESize_triplet, gen_afpText_ImageLUTID_triplet, gen_afpText_BandImage_triplet, gen_afpText_BeginTile_triplet, gen_afpText_EndTile_triplet, gen_afpText_ExternalAlgorithm_triplet, gen_afpText_TilePosition_triplet, gen_afpText_TileSize_triplet, gen_afpText_TileSetColor_triplet, gen_afpText_SetBiLevelImageColor_triplet, gen_afpText_IOCAFunctionSetIdentification_triplet, gen_afpText_ImageData_triplet, gen_afpText_BandImageData_triplet, gen_afpText_IncludeTile_triplet, gen_afpText_ImageSubsampling_triplet, gen_afpText_SamplingRatios_triplet, gen_afpText_IDEStructure_triplet, gen_afpText_TileTOC_triplet, gen_afpText_FNNRG2_triplet, gen_afpText_BeginSegmentCommand_triplet, gen_afpText_EndSegmentCommand_triplet, gen_afpText_GBAR_triplet, gen_afpText_GBIMG_triplet, gen_afpText_GCBIMG_triplet, gen_afpText_GBOX_triplet, gen_afpText_GCHST_triplet, gen_afpText_GCCHST_triplet, gen_afpText_GCOMT_triplet, gen_afpText_GEAR_triplet, gen_afpText_GEIMG_triplet, gen_afpText_GEPROL_triplet, gen_afpText_GFLT_triplet, gen_afpText_GCFLT_triplet, gen_afpText_GFARC_triplet, gen_afpText_GCFARC_triplet, gen_afpText_GIMD_triplet, gen_afpText_GLINE_triplet, gen_afpText_GCLINE_triplet, gen_afpText_GCBOX_triplet, gen_afpText_GCMRK_triplet, gen_afpText_GNOP1_triplet, gen_afpText_GPARC_triplet, gen_afpText_GCPARC_triplet, gen_afpText_GRLINE_triplet, gen_afpText_GCRLINE_triplet, gen_afpText_GSGCH_triplet, gen_afpText_GSAP_triplet, gen_afpText_GSBMX_triplet, gen_afpText_GSCA_triplet, gen_afpText_GMRK_triplet, gen_afpText_GSCR_triplet, gen_afpText_GSCS_triplet, gen_afpText_GSCH_triplet, gen_afpText_GSCOL_triplet, gen_afpText_GSCP_triplet, gen_afpText_GSECOL_triplet, gen_afpText_GSFLW_triplet, gen_afpText_GSLT_triplet, gen_afpText_GSLW_triplet, gen_afpText_GSMC_triplet, gen_afpText_GSMP_triplet, gen_afpText_GSMS_triplet, gen_afpText_GSMT_triplet, gen_afpText_GSMX_triplet, gen_afpText_GSPS_triplet, gen_afpText_GSPT_triplet, gen_afpText_GSCC_triplet, gen_afpText_GSCD_triplet, gen_afpText_GSLE_triplet, gen_afpText_GSLJ_triplet, gen_afpText_GCBEZ_triplet, gen_afpText_GCCBEZ_triplet, gen_afpText_WindowSpecification_triplet, gen_afpText_DrawingOrderSubset_triplet, gen_afpText_TonerSaver_triplet, gen_afpText_ColorFidelity_triplet, gen_afpText_FontFidelity_triplet, gen_afpText_TextFidelity_triplet, gen_afpText_GSPCOL_triplet, gen_afpText_CMRFidelity_triplet, gen_afpText_ObjectByteExtent_triplet, gen_afpText_ObjectByteOffset_triplet, gen_afpText_ObjectStructuredFieldExtent_triplet, gen_afpText_ObjectStructuredFieldOffset_triplet, gen_afpText_ObjectCount_triplet, gen_afpText_ObjectOriginIdentifier_triplet, gen_afpText_LineDataObjectPositionMigration_triplet, gen_afpText_ColorManagementResourceDescriptor_triplet, gen_afpText_ImageResolution_triplet, gen_afpText_MediaFidelity_triplet, gen_afpText_FinishingFidelity_triplet, gen_afpText_ExtendedResourceLocalIdentifier_triplet, gen_afpText_MetricAdjustment_triplet, gen_afpText_ExtensionFont_triplet, gen_afpText_RenderingIntent_triplet, gen_afpText_FontCodedGraphicCharacterSetGlobalIdentifier_triplet, gen_afpText_LocaleSelector_triplet, gen_afpText_FinishingOperation_triplet, gen_afpText_UP3iFinishingOperation_triplet, gen_afpText_DeviceAppearance_triplet, gen_afpText_ObjectContainerPresentationSpaceSize_triplet, gen_afpText_PageOverlayConditionalProcessing_triplet, gen_afpText_ResourceUsageAttribute_triplet, gen_afpText_ResourceObjectInclude_triplet},
    metadata=None
)
