...
public class IntegerComparisonExpression_evaluateGREATER_EQUALSExitEventOccurrence  {
    ...
    public IntegerComparisonExpression_evaluateGREATER_EQUALSExitEventOccurrence(
    ) {
    }
