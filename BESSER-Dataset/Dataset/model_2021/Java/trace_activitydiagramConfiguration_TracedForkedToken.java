...
public class trace_activitydiagramConfiguration_TracedForkedToken extends TracedToken {
    ...
    public trace_activitydiagramConfiguration_TracedForkedToken(
    ) {
        super(
        );
    ...
    public trace_activitydiagramConfiguration_TracedForkedToken(
        ArrayList<ForkedToken_baseToken_State> forkedtoken_basetoken_states,        ArrayList<ForkedToken_remainingOffersCount_State> forkedtoken_remainingofferscount_states,        ArrayList<ForkedToken_baseTokenIsWithdrawn_State> forkedtoken_basetokeniswithdrawn_states    ) {
