...
class trace_States_ActivityNode_running_State:
    ...
    def __init__(self, running: bool, runningTrace: "activitydiagram_TracedActivityNode" = None, activityNode_running_States: set["States_trace_GlobalState"] = None):
    ...
    def runningTrace(self, value):
        ...
        old_value = getattr(self, f"_trace_States_ActivityNode_running_State__runningTrace", None)
        self.__runningTrace = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "TracedActivityNode"):
                opp_val = getattr(old_value, "TracedActivityNode", None)
                if opp_val == self:
                    setattr(old_value, "TracedActivityNode", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "TracedActivityNode"):
                opp_val = getattr(value, "TracedActivityNode", None)
                setattr(value, "TracedActivityNode", self)
    ...
    def activityNode_running_States(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "GlobalState700"):
                    opp_val = getattr(item, "GlobalState700", None)
                    
                    if opp_val == self:
                        setattr(item, "GlobalState700", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "GlobalState700"):
                    ...
                    setattr(item, "GlobalState700", self)
...
class trace_States_ForkedToken_baseTokenIsWithdrawn_State:
    ...
    def __init__(self, baseTokenIsWithdrawn: bool, baseTokenIsWithdrawnTrace: "activitydiagramConfiguration_TracedForkedToken" = None, forkedToken_baseTokenIsWithdrawn_States: set["States_trace_GlobalState"] = None):
    ...
    def baseTokenIsWithdrawnTrace(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_trace_States_ForkedToken_baseTokenIsWithdrawn_State__baseTokenIsWithdrawnTrace", None)
        self.__baseTokenIsWithdrawnTrace = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "TracedForkedToken680"):
                opp_val = getattr(old_value, "TracedForkedToken680", None)
                if opp_val == self:
                    setattr(old_value, "TracedForkedToken680", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "TracedForkedToken680"):
                opp_val = getattr(value, "TracedForkedToken680", None)
                setattr(value, "TracedForkedToken680", self)
    ...
    def forkedToken_baseTokenIsWithdrawn_States(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "GlobalState682"):
                    opp_val = getattr(item, "GlobalState682", None)
                    
                    if opp_val == self:
                        setattr(item, "GlobalState682", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "GlobalState682"):
                    ...
                    setattr(item, "GlobalState682", self)
...
class trace_States_ForkedToken_remainingOffersCount_State:
    ...
    def __init__(self, remainingOffersCount: int, remainingOffersCountTrace: "activitydiagramConfiguration_TracedForkedToken" = None, forkedToken_remainingOffersCount_States: set["States_trace_GlobalState"] = None):
    ...
    def remainingOffersCountTrace(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_trace_States_ForkedToken_remainingOffersCount_State__remainingOffersCountTrace", None)
    ...
    def forkedToken_remainingOffersCount_States(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "GlobalState672"):
                    opp_val = getattr(item, "GlobalState672", None)
                    
                    if opp_val == self:
                        setattr(item, "GlobalState672", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "GlobalState672"):
                    ...
                    setattr(item, "GlobalState672", self)
