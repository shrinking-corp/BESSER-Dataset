...
# Classes
junitmodel_JUnitTestCase = Class(name="junitmodel_JUnitTestCase")
TestCaseElement = Class(name="TestCaseElement")
junitmodel_JUnitTestSuite = Class(name="junitmodel_JUnitTestSuite")
TestContainer = Class(name="TestContainer")
junitmodel_JUnitRoot = Class(name="junitmodel_JUnitRoot")
TestRoot = Class(name="TestRoot")
junitmodel_JUnitProblem = Class(name="junitmodel_JUnitProblem")
TestProblem = Class(name="TestProblem")
junitmodel_JUnitComparisonProblem = Class(name="junitmodel_JUnitComparisonProblem")
JUnitProblem = Class(name="JUnitProblem")
ComparisonProblem = Class(name="ComparisonProblem")
junitmodel_JUnitTraceStackframe = Class(name="junitmodel_JUnitTraceStackframe")
