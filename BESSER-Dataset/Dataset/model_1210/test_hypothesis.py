...
def test_ocl_expressions_unlimitednaturalliteralexp_has_longSymbol():
    assert hasattr(ocl_expressions_UnlimitedNaturalLiteralExp, "longSymbol")
    descriptor = None
    for klass in ocl_expressions_UnlimitedNaturalLiteralExp.__mro__:
...
def test_ocl_expressions_unlimitednaturalliteralexp_has_extendedIntegerSymbol():
    assert hasattr(ocl_expressions_UnlimitedNaturalLiteralExp, "extendedIntegerSymbol")
    descriptor = None
    for klass in ocl_expressions_UnlimitedNaturalLiteralExp.__mro__:
...
def test_ocl_expressions_integerliteralexp_has_extendedIntegerSymbol():
    assert hasattr(ocl_expressions_IntegerLiteralExp, "extendedIntegerSymbol")
    descriptor = None
...
def test_ocl_expressions_integerliteralexp_has_longSymbol():
    assert hasattr(ocl_expressions_IntegerLiteralExp, "longSymbol")
    descriptor = None
    for klass in ocl_expressions_IntegerLiteralExp.__mro__:
        if "longSymbol" in klass.__dict__:
            descriptor = klass.__dict__["longSymbol"]
...
@given(instance=ocl_expressions_UnlimitedNaturalLiteralExp_strategy)
def test_ocl_expressions_unlimitednaturalliteralexp_longSymbol_setter(instance):
...
@given(instance=ocl_expressions_UnlimitedNaturalLiteralExp_strategy)
def test_ocl_expressions_unlimitednaturalliteralexp_extendedIntegerSymbol_setter(instance):
...
@given(instance=ocl_expressions_IntegerLiteralExp_strategy)
def test_ocl_expressions_integerliteralexp_extendedIntegerSymbol_setter(instance):
    original = instance.extendedIntegerSymbol
    instance.extendedIntegerSymbol = original
    assert instance.extendedIntegerSymbol == original
...
@given(instance=ocl_expressions_IntegerLiteralExp_strategy)
def test_ocl_expressions_integerliteralexp_longSymbol_setter(instance):
    original = instance.longSymbol
    instance.longSymbol = original
    assert instance.longSymbol == original
