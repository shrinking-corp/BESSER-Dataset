...
@given(instance=ocl_expressions_UnlimitedNaturalLiteralExp_strategy)
def test_hyp_ocl_expressions_unlimitednaturalliteralexp_longSymbol_setter(instance):
...
@given(instance=ocl_expressions_UnlimitedNaturalLiteralExp_strategy)
def test_hyp_ocl_expressions_unlimitednaturalliteralexp_extendedIntegerSymbol_setter(instance):
...
def test_hyp_ocl_expressions_integerliteralexp_extendedIntegerSymbol_setter(instance):
    original = instance.extendedIntegerSymbol
    instance.extendedIntegerSymbol = original
    assert instance.extendedIntegerSymbol == original
...
@given(instance=ocl_expressions_IntegerLiteralExp_strategy)
def test_hyp_ocl_expressions_integerliteralexp_longSymbol_setter(instance):
    original = instance.longSymbol
    instance.longSymbol = original
    assert instance.longSymbol == original
...
def test_ocl_expressions_IntegerLiteralExp_extendedIntegerSymbol_value_roundtrip():
    instance = ocl_expressions_IntegerLiteralExp(extendedIntegerSymbol="sample_text", integerSymbol="sample_text", longSymbol="sample_text")
    assert instance.extendedIntegerSymbol == "sample_text"
    instance.extendedIntegerSymbol = "sample_text_2"
    assert instance.extendedIntegerSymbol == "sample_text_2"
...
def test_ocl_expressions_IntegerLiteralExp_longSymbol_value_roundtrip():
    instance = ocl_expressions_IntegerLiteralExp(extendedIntegerSymbol="sample_text", integerSymbol="sample_text", longSymbol="sample_text")
    assert instance.longSymbol == "sample_text"
    instance.longSymbol = "sample_text_2"
    assert instance.longSymbol == "sample_text_2"
...
def test_ocl_expressions_UnlimitedNaturalLiteralExp_extendedIntegerSymbol_value_roundtrip():
    instance = ocl_expressions_UnlimitedNaturalLiteralExp(extendedIntegerSymbol="sample_text", integerSymbol="sample_text", longSymbol="sample_text", unlimited=True)
    assert instance.extendedIntegerSymbol == "sample_text"
    instance.extendedIntegerSymbol = "sample_text_2"
    assert instance.extendedIntegerSymbol == "sample_text_2"
...
def test_ocl_expressions_UnlimitedNaturalLiteralExp_longSymbol_value_roundtrip():
    instance = ocl_expressions_UnlimitedNaturalLiteralExp(extendedIntegerSymbol="sample_text", integerSymbol="sample_text", longSymbol="sample_text", unlimited=True)
    assert instance.longSymbol == "sample_text"
    instance.longSymbol = "sample_text_2"
    assert instance.longSymbol == "sample_text_2"
...
ocl_expressions_IntegerLiteralExp_strategy = st.builds(ocl_expressions_IntegerLiteralExp, extendedIntegerSymbol=safe_text, integerSymbol=safe_text, longSymbol=safe_text)
@given(instance=ocl_expressions_IntegerLiteralExp_strategy)
@settings(max_examples=25)
...
ocl_expressions_UnlimitedNaturalLiteralExp_strategy = st.builds(ocl_expressions_UnlimitedNaturalLiteralExp, extendedIntegerSymbol=safe_text, integerSymbol=safe_text, longSymbol=safe_text, unlimited=st.booleans())
@given(instance=ocl_expressions_UnlimitedNaturalLiteralExp_strategy)
@settings(max_examples=25)
