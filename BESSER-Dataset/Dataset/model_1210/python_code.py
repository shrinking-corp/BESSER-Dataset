...
class ocl_expressions_IfExp:
    ...
    def boolean_condition(self, ocl_context, ocl_diagnostics) :
...
class ocl_expressions_CollectionLiteralExp:
    ...
    def sequence_kind(self, ocl_diagnostics, ocl_context) :
...
class ocl_types_TupleType:
    ...
    def features_only_properties(self, ocl_diagnostics, ocl_context) :
...
class ocl_expressions_TupleLiteralPart:
    ...
    def __init__(self):
        ...
        pass
    def value_type(self, ocl_context, ocl_diagnostics) :
...
class ocl_expressions_PropertyCallExp:
    ...
    def __init__(self):
        ...
        pass
    def property_type(self, ocl_context, ocl_diagnostics) :
...
class ocl_expressions_OperationCallExp:
    ...
    def arguments_conform(self, ocl_diagnostics, ocl_context) :
...
class ocl_expressions_MessageExp:
    ...
    def operation_arguments(self, ocl_context, ocl_diagnostics) :
        # TODO: Implement operation_arguments method
        pass

    def target_not_collection(self, ocl_diagnostics, ocl_context) :
...
class ocl_expressions_IteratorExp:
    ...
    def collect_type(self, ocl_context, ocl_diagnostics) :
...
class ocl_expressions_LoopExp(ABC):
    ...
    def loop_variable_type(self, ocl_diagnostics, ocl_context) :
...
class ocl_expressions_IterateExp:
    ...
    def result_init(self, ocl_context, ocl_diagnostics) :
