...
class stateMachine_State(IDElement):
    ...
    def __init__(self, kind: str, source: set["stateMachine_Transition"] = None, target: set["stateMachine_Transition"] = None, State: "stateMachine_Transition" = None, State10: "stateMachine_Transition" = None, stateMachine_State: "stateMachine_StateMachine" = None):
        self.kind = kind
