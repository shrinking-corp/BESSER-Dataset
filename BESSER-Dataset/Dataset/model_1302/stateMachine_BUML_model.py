...
stateMachine_IDElement = Class(name="stateMachine_IDElement")
...
domain_model = DomainModel(
    name="stateMachine",
    types={stateMachine_Transition, stateMachine_Event, stateMachine_IDElement, stateMachine_StateMachine, IDElement, stateMachine_State, StateKind},
    associations={transitions1, events3, outgoing5, incoming6, source8, target9, trigger11, effect14, states0},
    generalizations={gen_stateMachine_State_IDElement, gen_stateMachine_Transition_IDElement, gen_stateMachine_Event_IDElement, gen_stateMachine_StateMachine_IDElement},
    metadata=None
)
