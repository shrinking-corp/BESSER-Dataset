...
studyprogram_Specialization = Class(name="studyprogram_Specialization")
studyprogram_Slot = Class(name="studyprogram_Slot")
...
studyprogram_Semester.attributes={studyprogram_Semester_season, studyprogram_Semester_year}
...
studyprogram_Course.attributes={studyprogram_Course_credits, studyprogram_Course_name}
...
domain_model = DomainModel(
    name="studyprogram",
    types={studyprogram_Program, studyprogram_Semester, studyprogram_Specialization, studyprogram_Slot, studyprogram_Course, studyprogram_Department, Season},
    associations={baseSemesters0, specializations1, specializationSemesters3, slots9, availableCourses11, selectedCourse13, courses16, programs18, additionalSpecializations7},
    generalizations={},
    metadata=None
)
