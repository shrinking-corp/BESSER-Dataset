...
# Classes
euml_Generalization = Class(name="euml_Generalization")
Relations = Class(name="Relations")
euml_NamedElement = Class(name="euml_NamedElement", is_abstract=True)
euml_Package = Class(name="euml_Package")
NamedElement = Class(name="NamedElement")
euml_Class = Class(name="euml_Class")
euml_Dependecy = Class(name="euml_Dependecy")
euml_Attribute = Class(name="euml_Attribute")
euml_Operation = Class(name="euml_Operation")
euml_Realization = Class(name="euml_Realization")
euml_Relations = Class(name="euml_Relations", is_abstract=True)
...
domain_model = DomainModel(
    name="euml",
    types={euml_Generalization, Relations, euml_NamedElement, euml_Package, NamedElement, euml_Class, euml_Dependecy, euml_Attribute, euml_Operation, euml_Realization, euml_Relations},
    associations={realizations10, generalizations12, type14, returnType17, classes0, packages2, dependencies4, attributes6, operations8, target20},
    generalizations={gen_euml_Dependecy_Relations, gen_euml_Attribute_NamedElement, gen_euml_Operation_NamedElement, gen_euml_Package_NamedElement, gen_euml_Class_NamedElement, gen_euml_Generalization_Relations, gen_euml_Realization_Relations},
    metadata=None
)
