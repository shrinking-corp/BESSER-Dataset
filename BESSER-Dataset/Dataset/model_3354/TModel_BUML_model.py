...
# Classes
Trmodel_loader = Class(name="Trmodel_loader")
Trmodel_Operation = Class(name="Trmodel_Operation", is_abstract=True)
Trmodel_LoadModel = Class(name="Trmodel_LoadModel")
Trmodel_Table = Class(name="Trmodel_Table")
Trmodel_Column = Class(name="Trmodel_Column")
Trmodel_Add = Class(name="Trmodel_Add")
Operation = Class(name="Operation")
Trmodel_Delete = Class(name="Trmodel_Delete")
Trmodel_Update = Class(name="Trmodel_Update")
