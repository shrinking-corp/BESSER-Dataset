...
class Brosser_la_voiture_UseCase:

    pass


class Rincer_la_voiture__UseCase:

    pass


class Metre_de_la_mousse_UseCase:

    pass


class Lavage_de_la_voiture__UseCase:

    pass


class Prendre_le_re_u_UseCase:

    pass


class choisir_le_type_de_payement_UseCase:

    pass


class D_finir_le_type_de_voiture_UseCase:

    pass


class choisir_le_type_de_lavage_UseCase:

    pass


class donner_des_informayions_UseCase:
...
class Delivering_Management:
    ...
    def __init__(self, client_name: str, client_key: str, deliver_boy_id: str, user13: "User" = None, delivery_Boy18: "Delivery_Boy" = None, cleaning_Management5: "Cleaning_Management" = None):
...
class Payment:
    ...
    def __init__(self, Type_of_payment: str, money_Dispenser16: "Money_Dispenser" = None, primary_Info1: "Primary_Info" = None, cleaning_Management2: "Cleaning_Management" = None, user9: "User" = None):
...
class Cleaning_Management:
    ...
    def __init__(self, water: str, powderized_wash: str, brushing: str, cleaner14: "Cleaner" = None, payment3: "Payment" = None, delivering_Management4: "Delivering_Management" = None, user11: "User" = None):
        self.water = water
