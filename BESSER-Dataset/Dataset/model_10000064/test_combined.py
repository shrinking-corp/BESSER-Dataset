...
def test_hyp_brosser_la_voiture_usecase_is_not_abstract():
    assert not inspect.isabstract(Brosser_la_voiture_UseCase)


def test_hyp_brosser_la_voiture_usecase_constructor_exists():
    assert callable(Brosser_la_voiture_UseCase.__init__)


def test_hyp_brosser_la_voiture_usecase_constructor_args():
    sig = inspect.signature(Brosser_la_voiture_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_rincer_la_voiture__usecase_is_not_abstract():
    assert not inspect.isabstract(Rincer_la_voiture__UseCase)


def test_hyp_rincer_la_voiture__usecase_constructor_exists():
    assert callable(Rincer_la_voiture__UseCase.__init__)


def test_hyp_rincer_la_voiture__usecase_constructor_args():
    sig = inspect.signature(Rincer_la_voiture__UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_metre_de_la_mousse_usecase_is_not_abstract():
    assert not inspect.isabstract(Metre_de_la_mousse_UseCase)


def test_hyp_metre_de_la_mousse_usecase_constructor_exists():
    assert callable(Metre_de_la_mousse_UseCase.__init__)


def test_hyp_metre_de_la_mousse_usecase_constructor_args():
    sig = inspect.signature(Metre_de_la_mousse_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_lavage_de_la_voiture__usecase_is_not_abstract():
    assert not inspect.isabstract(Lavage_de_la_voiture__UseCase)


def test_hyp_lavage_de_la_voiture__usecase_constructor_exists():
    assert callable(Lavage_de_la_voiture__UseCase.__init__)


def test_hyp_lavage_de_la_voiture__usecase_constructor_args():
    sig = inspect.signature(Lavage_de_la_voiture__UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_prendre_le_re_u_usecase_is_not_abstract():
    assert not inspect.isabstract(Prendre_le_re_u_UseCase)


def test_hyp_prendre_le_re_u_usecase_constructor_exists():
    assert callable(Prendre_le_re_u_UseCase.__init__)


def test_hyp_prendre_le_re_u_usecase_constructor_args():
    sig = inspect.signature(Prendre_le_re_u_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_choisir_le_type_de_payement_usecase_is_not_abstract():
    assert not inspect.isabstract(choisir_le_type_de_payement_UseCase)


def test_hyp_choisir_le_type_de_payement_usecase_constructor_exists():
    assert callable(choisir_le_type_de_payement_UseCase.__init__)


def test_hyp_choisir_le_type_de_payement_usecase_constructor_args():
    sig = inspect.signature(choisir_le_type_de_payement_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_d_finir_le_type_de_voiture_usecase_is_not_abstract():
    assert not inspect.isabstract(D_finir_le_type_de_voiture_UseCase)


def test_hyp_d_finir_le_type_de_voiture_usecase_constructor_exists():
    assert callable(D_finir_le_type_de_voiture_UseCase.__init__)


def test_hyp_d_finir_le_type_de_voiture_usecase_constructor_args():
    sig = inspect.signature(D_finir_le_type_de_voiture_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_choisir_le_type_de_lavage_usecase_is_not_abstract():
    assert not inspect.isabstract(choisir_le_type_de_lavage_UseCase)


def test_hyp_choisir_le_type_de_lavage_usecase_constructor_exists():
    assert callable(choisir_le_type_de_lavage_UseCase.__init__)


def test_hyp_choisir_le_type_de_lavage_usecase_constructor_args():
    sig = inspect.signature(choisir_le_type_de_lavage_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_donner_des_informayions_usecase_is_not_abstract():
    assert not inspect.isabstract(donner_des_informayions_UseCase)


def test_hyp_donner_des_informayions_usecase_constructor_exists():
    assert callable(donner_des_informayions_UseCase.__init__)


def test_hyp_donner_des_informayions_usecase_constructor_args():
    sig = inspect.signature(donner_des_informayions_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_payer_usecase_is_not_abstract():
    assert not inspect.isabstract(Payer_UseCase)


def test_hyp_payer_usecase_constructor_exists():
    assert callable(Payer_UseCase.__init__)


def test_hyp_payer_usecase_constructor_args():
...
Brosser_la_voiture_UseCase_strategy = st.builds(Brosser_la_voiture_UseCase)
...
D_finir_le_type_de_voiture_UseCase_strategy = st.builds(D_finir_le_type_de_voiture_UseCase)
...
Lavage_de_la_voiture__UseCase_strategy = st.builds(Lavage_de_la_voiture__UseCase)
...
Metre_de_la_mousse_UseCase_strategy = st.builds(Metre_de_la_mousse_UseCase)
...
Payer_UseCase_strategy = st.builds(Payer_UseCase)
...
Prendre_le_re_u_UseCase_strategy = st.builds(Prendre_le_re_u_UseCase)
...
Rincer_la_voiture__UseCase_strategy = st.builds(Rincer_la_voiture__UseCase)
...
choisir_le_type_de_lavage_UseCase_strategy = st.builds(choisir_le_type_de_lavage_UseCase)
...
choisir_le_type_de_payement_UseCase_strategy = st.builds(choisir_le_type_de_payement_UseCase)
...
donner_des_informayions_UseCase_strategy = st.builds(donner_des_informayions_UseCase)
