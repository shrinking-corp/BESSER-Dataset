...
# Classes
multiview2_C = Class(name="multiview2_C")
multiview2_A = Class(name="multiview2_A")
Named = Class(name="Named")
multiview2_B = Class(name="multiview2_B")
multiview2_E = Class(name="multiview2_E")
multiview2_Named = Class(name="multiview2_Named")
multiview2_F = Class(name="multiview2_F")
...
domain_model = DomainModel(
    name="multiview2",
    types={multiview2_C, multiview2_A, Named, multiview2_B, multiview2_E, multiview2_Named, multiview2_F},
    associations={es1, cs3, bs0, fs5},
    generalizations={gen_multiview2_B_Named, gen_multiview2_C_Named, gen_multiview2_A_Named, gen_multiview2_E_Named, gen_multiview2_F_Named},
    metadata=None
)
