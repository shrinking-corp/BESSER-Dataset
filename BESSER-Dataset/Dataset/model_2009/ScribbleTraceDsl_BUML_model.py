...
# Classes
scribbleTraceDsl_Trace = Class(name="scribbleTraceDsl_Trace")
scribbleTraceDsl_Stepdefn = Class(name="scribbleTraceDsl_Stepdefn")
scribbleTraceDsl_Messagetransfer = Class(name="scribbleTraceDsl_Messagetransfer")
Stepdefn = Class(name="Stepdefn")
scribbleTraceDsl_Parameter = Class(name="scribbleTraceDsl_Parameter")
