...
class model_physical_PhysicalColumn(ModelObject):
    ...
    def __init__(self, comment: str, dataType: str, typeName: str, size: int, octectLength: int, decimalDigits: int, radix: int, defaultValue: str, nullable: bool, position: int, columns: "PhysicalTable" = None):
        self.comment = comment
...
class model_ModelPropertyType:
    ...
    def __init__(self, id: str, name: str, description: str, admissibleValues: str, defaultValue: str, ModelPropertyType: "model_ModelPropertyCategory" = None, propertyTypes: "model_ModelPropertyCategory" = None, model_ModelPropertyType: "model_ModelProperty" = None, model_ModelPropertyType18: "model_Model" = None):
        self.id = id
        self.name = name
        self.description = description
...
class model_ModelPropertyCategory:
    ...
    def __init__(self, name: str, description: str, model_ModelPropertyCategory0: "model_ModelPropertyCategory" = None, model_ModelPropertyCategory4: "model_ModelPropertyCategory" = None, model_ModelPropertyCategory2: set["model_ModelPropertyCategory"] = None, category: set["model_ModelPropertyType"] = None, ModelPropertyCategory: "model_ModelPropertyType" = None, model_ModelPropertyCategory21: "model_Model" = None, model_ModelPropertyCategory: "model_ModelPropertyCategory" = None):
        self.name = name
        self.description = description
