...
# Classes
kernel_commons_NamedElement = Class(name="kernel_commons_NamedElement", is_abstract=True)
kernel_statements_Statement = Class(name="kernel_statements_Statement", is_abstract=True)
commons_LabellableElement = Class(name="commons_LabellableElement")
members_Member = Class(name="members_Member")
kernel_statements_StatementListContainer = Class(name="kernel_statements_StatementListContainer", is_abstract=True)
Statement = Class(name="Statement")
kernel_statements_StatementContainer = Class(name="kernel_statements_StatementContainer", is_abstract=True)
kernel_statements_Condition = Class(name="kernel_statements_Condition")
...
kernel_statements_WhileLoop = Class(name="kernel_statements_WhileLoop")
kernel_statements_Block = Class(name="kernel_statements_Block")
statements_StatementListContainer = Class(name="statements_StatementListContainer")
kernel_statements_Jump = Class(name="kernel_statements_Jump", is_abstract=True)
LabellableElement = Class(name="LabellableElement")
kernel_statements_Goto = Class(name="kernel_statements_Goto")
Jump = Class(name="Jump")
kernel_statements_NonDeterministicBlock = Class(name="kernel_statements_NonDeterministicBlock")
kernel_statements_ParallelBlock = Class(name="kernel_statements_ParallelBlock")
kernel_statements_Abort = Class(name="kernel_statements_Abort")
kernel_statements_ExceptionHandlerStatement = Class(name="kernel_statements_ExceptionHandlerStatement")
kernel_statements_StatementWithException = Class(name="kernel_statements_StatementWithException")
ExceptionHandlerStatement = Class(name="ExceptionHandlerStatement")
kernel_statements_Conditional = Class(name="kernel_statements_Conditional", is_abstract=True)
Expression = Class(name="Expression")
procedures_ProcedureCall = Class(name="procedures_ProcedureCall")
...
kernel_statements_ExpressionStatement = Class(name="kernel_statements_ExpressionStatement")
kernel_statements_Skip = Class(name="kernel_statements_Skip")
kernel_statements_Return = Class(name="kernel_statements_Return")
kernel_procedures_Procedure = Class(name="kernel_procedures_Procedure")
procedures_Procedure = Class(name="procedures_Procedure")
...
End = Class(name="End")
kernel_procedures_MainProcedure = Class(name="kernel_procedures_MainProcedure")
kernel_statements_ProcedureCall = Class(name="kernel_statements_ProcedureCall")
kernel_expressions_Expression = Class(name="kernel_expressions_Expression")
SubExpression = Class(name="SubExpression")
kernel_expressions_SubExpression = Class(name="kernel_expressions_SubExpression", is_abstract=True)
ElementReference = Class(name="ElementReference")
kernel_expressions_Defines = Class(name="kernel_expressions_Defines")
Definition = Class(name="Definition")
kernel_expressions_Affects = Class(name="kernel_expressions_Affects")
kernel_expressions_Uses = Class(name="kernel_expressions_Uses")
Usage = Class(name="Usage")
kernel_expressions_Definition = Class(name="kernel_expressions_Definition", is_abstract=True)
kernel_expressions_Usage = Class(name="kernel_expressions_Usage", is_abstract=True)
kernel_containers_KernelRoot = Class(name="kernel_containers_KernelRoot", is_abstract=True)
kernel_containers_CompilationUnit = Class(name="kernel_containers_CompilationUnit")
KernelRoot = Class(name="KernelRoot")
MainProcedure = Class(name="MainProcedure")
kernel_members_Member = Class(name="kernel_members_Member", is_abstract=True)
kernel_dataitems_DataItem = Class(name="kernel_dataitems_DataItem")
commons_Variable = Class(name="commons_Variable")
kernel_parameters_Parameter = Class(name="kernel_parameters_Parameter")
DataItem = Class(name="DataItem")
ReferenceableElement = Class(name="ReferenceableElement")
kernel_references_ReferenceableElement = Class(name="kernel_references_ReferenceableElement", is_abstract=True)
NamedElement = Class(name="NamedElement")
kernel_references_Reference = Class(name="kernel_references_Reference", is_abstract=True)
kernel_references_Argument = Class(name="kernel_references_Argument")
kernel_references_ElementReference = Class(name="kernel_references_ElementReference", is_abstract=True)
...
kernel_parameters_Parameter.attributes={kernel_parameters_Parameter_correspondingArgument, kernel_parameters_Parameter_byReference}
...
domain_model = DomainModel(
    name="kernel",
    types={kernel_commons_NamedElement, kernel_statements_Statement, commons_LabellableElement, members_Member, kernel_statements_StatementListContainer, Statement, kernel_statements_StatementContainer, kernel_statements_Condition, statements_Statement, statements_StatementContainer, statements_Conditional, kernel_statements_WhileLoop, kernel_statements_Block, statements_StatementListContainer, kernel_statements_Jump, LabellableElement, kernel_statements_Goto, Jump, kernel_statements_NonDeterministicBlock, kernel_statements_ParallelBlock, kernel_statements_Abort, kernel_statements_ExceptionHandlerStatement, kernel_statements_StatementWithException, ExceptionHandlerStatement, kernel_statements_Conditional, Expression, procedures_ProcedureCall, references_ElementReference, Argument, ReturnSite, kernel_statements_ExpressionStatement, kernel_statements_Skip, kernel_statements_Return, kernel_procedures_Procedure, procedures_Procedure, references_ReferenceableElement, Member, Parameter_, ProcedureCall, Start, End, kernel_procedures_MainProcedure, kernel_statements_ProcedureCall, kernel_expressions_Expression, SubExpression, kernel_expressions_SubExpression, ElementReference, kernel_expressions_Defines, Definition, kernel_expressions_Affects, kernel_expressions_Uses, Usage, kernel_expressions_Definition, kernel_expressions_Usage, kernel_containers_KernelRoot, kernel_containers_CompilationUnit, KernelRoot, MainProcedure, kernel_members_Member, kernel_dataitems_DataItem, commons_Variable, kernel_parameters_Parameter, DataItem, ReferenceableElement, kernel_references_ReferenceableElement, NamedElement, kernel_references_Reference, kernel_references_Argument, kernel_references_ElementReference, ExecutionOrder},
    associations={statements0, statement1, elseStatement3, target5, exceptionStatements6, condition7, arguments8, returnSite9, expression11, members13, parameters14, callers16, start18, end20, members22, start24, end27, children30, reaches31, mainProcedure32, declarations33, start36, end39, target42},
    generalizations={gen_kernel_statements_Statement_commons_LabellableElement, gen_kernel_statements_Statement_members_Member, gen_kernel_statements_Condition_statements_Statement, gen_kernel_statements_Condition_statements_StatementContainer, gen_kernel_statements_Condition_statements_Conditional, gen_kernel_statements_WhileLoop_statements_Statement, gen_kernel_statements_WhileLoop_statements_StatementContainer, gen_kernel_statements_WhileLoop_statements_Conditional, gen_kernel_statements_Block_statements_Statement, gen_kernel_statements_Block_statements_StatementListContainer, gen_kernel_statements_Jump_Statement, gen_kernel_statements_Goto_Jump, gen_kernel_statements_NonDeterministicBlock_statements_Statement, gen_kernel_statements_NonDeterministicBlock_statements_StatementListContainer, gen_kernel_statements_ParallelBlock_statements_Statement, gen_kernel_statements_ParallelBlock_statements_StatementListContainer, gen_kernel_statements_Abort_Statement, gen_kernel_statements_ExceptionHandlerStatement_commons_LabellableElement, gen_kernel_statements_ExceptionHandlerStatement_statements_StatementContainer, gen_kernel_statements_StatementWithException_statements_Statement, gen_kernel_statements_StatementWithException_statements_StatementContainer, gen_kernel_statements_ProcedureCall_procedures_ProcedureCall, gen_kernel_statements_ProcedureCall_references_ElementReference, gen_kernel_statements_ExpressionStatement_Statement, gen_kernel_statements_Skip_Statement, gen_kernel_statements_Return_Statement, gen_kernel_procedures_Procedure_commons_LabellableElement, gen_kernel_procedures_Procedure_procedures_Procedure, gen_kernel_procedures_Procedure_members_Member, gen_kernel_procedures_Procedure_references_ReferenceableElement, gen_kernel_procedures_MainProcedure_LabellableElement, gen_kernel_statements_ProcedureCall_statements_Statement, gen_kernel_expressions_Expression_LabellableElement, gen_kernel_expressions_SubExpression_ElementReference, gen_kernel_expressions_Defines_Definition, gen_kernel_expressions_Affects_Definition, gen_kernel_expressions_Uses_Usage, gen_kernel_expressions_Definition_SubExpression, gen_kernel_expressions_Usage_SubExpression, gen_kernel_containers_KernelRoot_LabellableElement, gen_kernel_containers_CompilationUnit_KernelRoot, gen_kernel_dataitems_DataItem_references_ReferenceableElement, gen_kernel_dataitems_DataItem_members_Member, gen_kernel_dataitems_DataItem_commons_Variable, gen_kernel_parameters_Parameter_DataItem, gen_kernel_references_ReferenceableElement_NamedElement, gen_kernel_references_Argument_ElementReference},
    metadata=None
)
