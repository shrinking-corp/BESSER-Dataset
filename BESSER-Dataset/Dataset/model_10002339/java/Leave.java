...
public class Leave  {
    ...
    public Leave(
        String Leave_Status,        LocalDate Leave_EndDate,        String Leave_detail,        LocalDate Leave_ApplyDate,        String Leave_Title,        int leave_id,        int Leave_NoOfDays,        int Emp_Id,        LocalDate Leave_StartDate    ) {
