...
statemachines_Util = Class(name="statemachines_Util")
statemachines_almostuml_StateMachine = Class(name="statemachines_almostuml_StateMachine")
NamedElement = Class(name="NamedElement")
Region = Class(name="Region")
almostuml_statemachines_EventOccurrence = Class(name="almostuml_statemachines_EventOccurrence")
...
statemachines_CustomSystem_m_initialize: Method = Method(name="initialize", parameters={Parameter(name='statemachines_args', type=StringType)})
...
statemachines_Util_m_log: Method = Method(name="log", parameters={Parameter(name='statemachines_l', type=StringType)})
...
statemachines_almostuml_Region_m_handleEvent: Method = Method(name="handleEvent", parameters={Parameter(name='statemachines_eventOccurrence', type=StringType)})
...
statemachines_almostuml_State_m_handle: Method = Method(name="handle", parameters={Parameter(name='statemachines_eventOccurrence', type=StringType)})
...
statemachines_almostuml_FinalState_m_handle: Method = Method(name="handle", parameters={Parameter(name='statemachines_eventOccurrence', type=StringType)})
...
exit14: BinaryAssociation = BinaryAssociation(
    name="exit14",
    ends={
        Property(name="Behavior16", type=statemachines_almostuml_State, multiplicity=Multiplicity(1, 1)),
        Property(name="statemachines_almostuml_State15", type=Behavior, multiplicity=Multiplicity(0, 1))
    }
)
doActivity17: BinaryAssociation = BinaryAssociation(
    name="doActivity17",
    ends={
        Property(name="Behavior19", type=statemachines_almostuml_State, multiplicity=Multiplicity(1, 1)),
        Property(name="statemachines_almostuml_State18", type=Behavior, multiplicity=Multiplicity(0, 1))
    }
)
region20: BinaryAssociation = BinaryAssociation(
    name="region20",
    ends={
        Property(name="Region22", type=statemachines_almostuml_State, multiplicity=Multiplicity(1, 1)),
        Property(name="statemachines_almostuml_State21", type=Region, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
container23: BinaryAssociation = BinaryAssociation(
    name="container23",
    ends={
        Property(name="Region24", type=statemachines_almostuml_Vertex, multiplicity=Multiplicity(1, 1)),
...
queue6: BinaryAssociation = BinaryAssociation(
    name="queue6",
    ends={
...
subvertex7: BinaryAssociation = BinaryAssociation(
    name="subvertex7",
    ends={
...
stateMachine9: BinaryAssociation = BinaryAssociation(
    name="stateMachine9",
    ends={
        Property(name="StateMachine10", type=statemachines_almostuml_Region, multiplicity=Multiplicity(1, 1)),
        Property(name="region", type=StateMachine, multiplicity=Multiplicity(0, 1))
    }
)
currentState11: BinaryAssociation = BinaryAssociation(
    name="currentState11",
    ends={
        Property(name="State", type=statemachines_almostuml_Region, multiplicity=Multiplicity(1, 1)),
        Property(name="statemachines_almostuml_Region12", type=State, multiplicity=Multiplicity(0, 1))
    }
)
source25: BinaryAssociation = BinaryAssociation(
    name="source25",
    ends={
        Property(name="Vertex26", type=statemachines_almostuml_Transition, multiplicity=Multiplicity(1, 1)),
...
target27: BinaryAssociation = BinaryAssociation(
    name="target27",
    ends={
        Property(name="Vertex29", type=statemachines_almostuml_Transition, multiplicity=Multiplicity(1, 1)),
        Property(name="statemachines_almostuml_Transition28", type=Vertex, multiplicity=Multiplicity(1, 1))
    }
)
trigger30: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="statemachines_almostuml_Transition31", type=Trigger, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
guard32: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="statemachines_almostuml_Transition33", type=Constraint, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
effect34: BinaryAssociation = BinaryAssociation(
    name="effect34",
    ends={
        Property(name="Behavior36", type=statemachines_almostuml_Transition, multiplicity=Multiplicity(1, 1)),
        Property(name="statemachines_almostuml_Transition35", type=Behavior, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
...
domain_model = DomainModel(
    name="statemachines",
    types={StateMachine, statemachines_CustomEvent, Event, statemachines_EventOccurrence, statemachines_CustomSystem, statemachines_almostuml_Vertex, statemachines_almostuml_Transition, statemachines_Util, statemachines_almostuml_StateMachine, NamedElement, Region, almostuml_statemachines_EventOccurrence, statemachines_almostuml_Region, Vertex, Transition, State, statemachines_almostuml_State, almostuml_NamedElement, almostuml_Vertex, Behavior, Trigger, Constraint, statemachines_almostuml_Trigger, statemachines_almostuml_Constraint, statemachines_almostuml_Behavior, statemachines_almostuml_NamedElement, statemachines_almostuml_Event, statemachines_almostuml_FinalState, statemachines_almostuml_Pseudostate, PseudostateKind},
    associations={statemachine0, events1, entry13, exit14, doActivity17, region20, container23, event3, region5, queue6, subvertex7, transition8, stateMachine9, currentState11, source25, target27, trigger30, guard32, effect34, event37},
