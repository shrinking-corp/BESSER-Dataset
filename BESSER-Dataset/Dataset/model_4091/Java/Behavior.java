...
public class Behavior  {
    ...
    private statemachines_almostuml_State statemachines_almostuml_state;
    ...
    public statemachines_almostuml_State getStatemachines_almostuml_state() {
        return statemachines_almostuml_state;
    }

    public void setStatemachines_almostuml_state(statemachines_almostuml_State statemachines_almostuml_state) {
        this.statemachines_almostuml_state = statemachines_almostuml_state;
    }
    public statemachines_almostuml_State getStatemachines_almostuml_state() {
        return statemachines_almostuml_state;
    }
