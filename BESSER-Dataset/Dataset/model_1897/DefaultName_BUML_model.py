...
graphbt_StandardNode.attributes={graphbt_StandardNode_label, graphbt_StandardNode_behaviorRef, graphbt_StandardNode_leaf, graphbt_StandardNode_traceabilityStatus, graphbt_StandardNode_componentRef, graphbt_StandardNode_operator, graphbt_StandardNode_traceabilityLink}
...
graphbt_Node.attributes={graphbt_Node_id, graphbt_Node_index}
...
graphbt_Component.attributes={graphbt_Component_componentDesc, graphbt_Component_id, graphbt_Component_componentRef, graphbt_Component_componentName, graphbt_Component_enumerated}
...
graphbt_Requirement.attributes={graphbt_Requirement_Key, graphbt_Requirement_Description, graphbt_Requirement_Requirement, graphbt_Requirement_Id}
...
graphbt_Behavior.attributes={graphbt_Behavior_behaviorRef, graphbt_Behavior_behaviorDesc, graphbt_Behavior_technicalDetail, graphbt_Behavior_behaviorName, graphbt_Behavior_behaviorType}
...
graphbt_Library.attributes={graphbt_Library_name, graphbt_Library_text, graphbt_Library_desc, graphbt_Library_location, graphbt_Library_id}
...
graphbt_Layout.attributes={graphbt_Layout_z, graphbt_Layout_width, graphbt_Layout_height, graphbt_Layout_x, graphbt_Layout_y, graphbt_Layout_cRef}
...
graphbt_Author.attributes={graphbt_Author_contact, graphbt_Author_name, graphbt_Author_role}
...
domain_model = DomainModel(
    name="graphbt",
    types={graphbt_ComponentList, graphbt_RequirementList, graphbt_BEModel, graphbt_BehaviorTree, graphbt_FormulaList, graphbt_Libraries, graphbt_StandardNode, graphbt_LayoutList, graphbt_AuthorList, graphbt_Node, graphbt_Edge, graphbt_SpecialEdge, graphbt_Component, graphbt_Attribute, graphbt_Link, graphbt_EmptyNode, Node, graphbt_Requirement, graphbt_State, graphbt_Behavior, graphbt_Library, graphbt_CTEdge, graphbt_MapInformation, graphbt_MethodDeclaration, graphbt_Information, graphbt_InputType, GUIImplementable, graphbt_Formula, graphbt_OperatorClass, graphbt_TraceabilityStatusClass, graphbt_AlternativeClass, graphbt_OutputType, graphbt_GUIImplementable, graphbt_GUI, graphbt_InputGUI, GUI, graphbt_OutputGUI, graphbt_Parameter, graphbt_Layout, graphbt_Button, Layout, graphbt_Author, BehaviorType, Composition, Branch, Operator, EventType, SpecialEdgeEnum, TraceabilityStatus},
    associations={dbt0, componentList1, requirementList3, formulaList5, libraries7, reversionNode9, errorReversionNode11, layoutList14, authorList16, rootNode18, edge20, specialE22, attributes32, childNode24, container26, parent30, states49, behaviors52, attributes55, state33, initialState35, relatedTo39, behaviors41, uses43, attributes45, methods47, info74, traceabilityLink58, components60, requirements63, formula66, target68, source71, import_76, parameters79, layouts81, authors83},
