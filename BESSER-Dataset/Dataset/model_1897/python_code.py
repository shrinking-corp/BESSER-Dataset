...
class graphbt_Library:
    ...
    def __init__(self, name: str, text: str, desc: str, location: str, id: str, graphbt_Library50: set["graphbt_State"] = None, graphbt_Library53: set["graphbt_Behavior"] = None, graphbt_Library56: set["graphbt_Attribute"] = None, graphbt_Library: "graphbt_Component" = None, graphbt_Library48: set["graphbt_MethodDeclaration"] = None, graphbt_Library78: "graphbt_Libraries" = None):
        self.name = name
        self.text = text
        self.desc = desc
...
class graphbt_State:
    ...
    def __init__(self, name: str, ref: str, desc: str, graphbt_State51: "graphbt_Library" = None, graphbt_State: "graphbt_Component" = None, graphbt_State37: "graphbt_Component" = None, graphbt_State46: "graphbt_MapInformation" = None):
        self.name = name
        self.ref = ref
        self.desc = desc
...
class graphbt_BEModel:
    ...
    def __init__(self, name: str, subtitle: str, version: str, graphbt_BEModel: "graphbt_BehaviorTree" = None, graphbt_BEModel2: "graphbt_ComponentList" = None, graphbt_BEModel4: "graphbt_RequirementList" = None, graphbt_BEModel6: "graphbt_FormulaList" = None, graphbt_BEModel8: "graphbt_Libraries" = None, graphbt_BEModel10: set["graphbt_StandardNode"] = None, graphbt_BEModel12: set["graphbt_StandardNode"] = None, graphbt_BEModel15: "graphbt_LayoutList" = None, graphbt_BEModel17: "graphbt_AuthorList" = None):
        self.name = name
