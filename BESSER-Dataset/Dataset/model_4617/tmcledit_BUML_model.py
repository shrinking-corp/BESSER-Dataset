...
# Classes
model_TopicType = Class(name="model_TopicType")
TMCLConstruct = Class(name="TMCLConstruct")
AbstractRegExpConstraint = Class(name="AbstractRegExpConstraint")
model_TopicReifiesConstraint = Class(name="model_TopicReifiesConstraint")
model_ItemIdentifierConstraint = Class(name="model_ItemIdentifierConstraint")
model_AbstractRegExpConstraint = Class(name="model_AbstractRegExpConstraint", is_abstract=True)
...
model_RolePlayerConstraint = Class(name="model_RolePlayerConstraint")
AbstractCardinalityConstraint = Class(name="AbstractCardinalityConstraint")
model_RoleConstraint = Class(name="model_RoleConstraint")
model_TopicMapSchema = Class(name="model_TopicMapSchema")
model_OccurrenceTypeConstraint = Class(name="model_OccurrenceTypeConstraint")
model_NameTypeConstraint = Class(name="model_NameTypeConstraint")
model_AssociationTypeConstraint = Class(name="model_AssociationTypeConstraint")
model_SubjectIdentifierConstraint = Class(name="model_SubjectIdentifierConstraint")
model_MappingElement = Class(name="model_MappingElement")
model_SubjectLocatorConstraint = Class(name="model_SubjectLocatorConstraint")
model_AssociationNode = Class(name="model_AssociationNode")
AbstractTypedConstraint = Class(name="AbstractTypedConstraint")
model_Diagram = Class(name="model_Diagram")
OnoObject = Class(name="OnoObject")
model_Node = Class(name="model_Node")
model_TypeNode = Class(name="model_TypeNode")
Node = Class(name="Node")
model_Bendpoint = Class(name="model_Bendpoint")
model_Edge = Class(name="model_Edge")
model_LabelPos = Class(name="model_LabelPos")
model_ScopeConstraint = Class(name="model_ScopeConstraint")
model_Comment = Class(name="model_Comment")
model_File = Class(name="model_File")
model_RoleType = Class(name="model_RoleType")
model_AbstractCardinalityConstraint = Class(name="model_AbstractCardinalityConstraint", is_abstract=True)
model_AbstractTypedConstraint = Class(name="model_AbstractTypedConstraint", is_abstract=True)
model_ScopedTopicType = Class(name="model_ScopedTopicType", is_abstract=True)
TopicType = Class(name="TopicType")
model_AssociationType = Class(name="model_AssociationType")
ScopedTopicType = Class(name="ScopedTopicType")
ScopedReifiableTopicType = Class(name="ScopedReifiableTopicType")
model_RoleCombinationConstraint = Class(name="model_RoleCombinationConstraint")
model_OccurrenceType = Class(name="model_OccurrenceType")
...
model_NameType = Class(name="model_NameType")
model_AbstractTypedCardinalityConstraint = Class(name="model_AbstractTypedCardinalityConstraint")
model_AbstractConstraint = Class(name="model_AbstractConstraint", is_abstract=True)
model_TMCLConstruct = Class(name="model_TMCLConstruct")
model_Annotation = Class(name="model_Annotation")
model_ReifierConstraint = Class(name="model_ReifierConstraint")
model_ReifiableTopicType = Class(name="model_ReifiableTopicType")
model_ScopedReifiableTopicType = Class(name="model_ScopedReifiableTopicType")
ReifiableTopicType = Class(name="ReifiableTopicType")
model_AbstractRegExpTopicType = Class(name="model_AbstractRegExpTopicType", is_abstract=True)
model_DomainDiagram = Class(name="model_DomainDiagram")
Diagram = Class(name="Diagram")
model_OnoObject = Class(name="model_OnoObject", is_abstract=True)
model_AbstractUniqueValueTopicType = Class(name="model_AbstractUniqueValueTopicType")
...
model_TopicType.attributes={model_TopicType_locators, model_TopicType_abstract, model_TopicType_idType, model_TopicType_name, model_TopicType_kind, model_TopicType_identifiers}
...
model_TopicMapSchema.attributes={model_TopicMapSchema_name, model_TopicMapSchema_version, model_TopicMapSchema_schemaResource, model_TopicMapSchema_includes, model_TopicMapSchema_baseLocator}
...
model_MappingElement.attributes={model_MappingElement_key, model_MappingElement_value}
...
model_Comment.attributes={model_Comment_height, model_Comment_width, model_Comment_content}
...
model_AbstractCardinalityConstraint.attributes={model_AbstractCardinalityConstraint_cardMax, model_AbstractCardinalityConstraint_cardMin}
...
model_TMCLConstruct.attributes={model_TMCLConstruct_description, model_TMCLConstruct_comment, model_TMCLConstruct_see_also}
...
domain_model = DomainModel(
    name="model",
    types={model_TopicType, TMCLConstruct, AbstractRegExpConstraint, model_TopicReifiesConstraint, model_ItemIdentifierConstraint, model_AbstractRegExpConstraint, AbstractConstraint, AbstractTypedCardinalityConstraint, model_RolePlayerConstraint, AbstractCardinalityConstraint, model_RoleConstraint, model_TopicMapSchema, model_OccurrenceTypeConstraint, model_NameTypeConstraint, model_AssociationTypeConstraint, model_SubjectIdentifierConstraint, model_MappingElement, model_SubjectLocatorConstraint, model_AssociationNode, AbstractTypedConstraint, model_Diagram, OnoObject, model_Node, model_TypeNode, Node, model_Bendpoint, model_Edge, model_LabelPos, model_ScopeConstraint, model_Comment, model_File, model_RoleType, model_AbstractCardinalityConstraint, model_AbstractTypedConstraint, model_ScopedTopicType, TopicType, model_AssociationType, ScopedTopicType, ScopedReifiableTopicType, model_RoleCombinationConstraint, model_OccurrenceType, AbstractRegExpTopicType, AbstractUniqueValueTopicType, model_NameType, model_AbstractTypedCardinalityConstraint, model_AbstractConstraint, model_TMCLConstruct, model_Annotation, model_ReifierConstraint, model_ReifiableTopicType, model_ScopedReifiableTopicType, ReifiableTopicType, model_AbstractRegExpTopicType, model_DomainDiagram, Diagram, model_OnoObject, model_AbstractUniqueValueTopicType, TopicId, EdgeType, KindOfTopicType},
    associations={subjectLocatorConstraints11, overlap14, topicReifiesConstraints16, itemIdentifierConstraints18, player20, isa1, role22, ako3, occurrenceConstraints5, topicTypes24, nameConstraints7, associationTypeConstraints26, subjectIdentifierConstraints9, mappings28, associationConstraint46, playerConstraints30, edges48, topicType33, bendpoints35, source36, target38, roleConstraint41, labelPositions44, nodes50, comments53, diagrams55, topicMapSchema57, type60, scope62, roles63, roleCombinations65, player67, otherPlayer70, otherRole73, role76, annotations79, reifierConstraint80},
    generalizations={gen_model_TopicType_TMCLConstruct, gen_model_SubjectLocatorConstraint_AbstractRegExpConstraint, gen_model_SubjectLocatorConstraint_AbstractCardinalityConstraint, gen_model_AbstractRegExpConstraint_AbstractConstraint, gen_model_OccurrenceTypeConstraint_AbstractTypedCardinalityConstraint, gen_model_NameTypeConstraint_AbstractTypedCardinalityConstraint, gen_model_RolePlayerConstraint_AbstractCardinalityConstraint, gen_model_TopicMapSchema_TMCLConstruct, gen_model_SubjectIdentifierConstraint_AbstractRegExpConstraint, gen_model_SubjectIdentifierConstraint_AbstractCardinalityConstraint, gen_model_AssociationNode_Node, gen_model_AssociationTypeConstraint_AbstractTypedConstraint, gen_model_Diagram_OnoObject, gen_model_MappingElement_OnoObject, gen_model_Node_OnoObject, gen_model_TypeNode_Node, gen_model_Bendpoint_OnoObject, gen_model_Edge_OnoObject, gen_model_ScopeConstraint_AbstractTypedCardinalityConstraint, gen_model_File_OnoObject, gen_model_RoleConstraint_AbstractTypedCardinalityConstraint, gen_model_RoleType_TopicType, gen_model_AbstractCardinalityConstraint_AbstractConstraint, gen_model_LabelPos_OnoObject, gen_model_AbstractTypedConstraint_AbstractConstraint, gen_model_ScopedTopicType_TopicType, gen_model_AssociationType_ScopedTopicType, gen_model_AssociationType_ScopedReifiableTopicType, gen_model_AbstractTypedCardinalityConstraint_AbstractTypedConstraint, gen_model_OccurrenceType_ScopedTopicType, gen_model_OccurrenceType_ScopedReifiableTopicType, gen_model_OccurrenceType_AbstractRegExpTopicType, gen_model_OccurrenceType_AbstractUniqueValueTopicType, gen_model_Comment_Node, gen_model_RoleCombinationConstraint_AbstractConstraint, gen_model_NameType_ScopedTopicType, gen_model_NameType_ScopedReifiableTopicType, gen_model_NameType_AbstractRegExpTopicType, gen_model_NameType_AbstractUniqueValueTopicType, gen_model_AbstractTypedCardinalityConstraint_AbstractCardinalityConstraint, gen_model_AbstractRegExpTopicType_TopicType, gen_model_AbstractConstraint_TMCLConstruct, gen_model_TopicReifiesConstraint_AbstractTypedCardinalityConstraint, gen_model_TMCLConstruct_OnoObject, gen_model_ReifierConstraint_AbstractTypedCardinalityConstraint, gen_model_ReifiableTopicType_TopicType, gen_model_ScopedReifiableTopicType_ScopedTopicType, gen_model_ScopedReifiableTopicType_ReifiableTopicType, gen_model_Annotation_OnoObject, gen_model_DomainDiagram_Diagram, gen_model_AbstractUniqueValueTopicType_TopicType, gen_model_ItemIdentifierConstraint_AbstractRegExpConstraint, gen_model_ItemIdentifierConstraint_AbstractCardinalityConstraint},
    metadata=None
)
