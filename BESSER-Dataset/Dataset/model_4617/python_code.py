...
class ScopedTopicType:
    ...
    pass
class model_NameType(AbstractRegExpTopicType, AbstractUniqueValueTopicType, ScopedReifiableTopicType, ScopedTopicType):

    pass
class model_ScopedReifiableTopicType(ReifiableTopicType, ScopedTopicType):

    pass
class model_OccurrenceType(AbstractRegExpTopicType, AbstractUniqueValueTopicType, ScopedReifiableTopicType, ScopedTopicType):
...
class model_AssociationType(ScopedReifiableTopicType, ScopedTopicType):
...
class model_Node(OnoObject):
    ...
    def __init__(self, posX: int, posY: int, model_Node: "model_Edge" = None, model_Node40: "model_Edge" = None, model_Node52: "model_Diagram" = None):
        self.posX = posX
        self.posY = posY
...
class model_TopicType(TMCLConstruct):
    ...
    def __init__(self, kind: str, name: str, locators: str, identifiers: str, idType: str, abstract: bool, model_TopicType17: set["model_TopicReifiesConstraint"] = None, model_TopicType19: set["model_ItemIdentifierConstraint"] = None, model_TopicType21: "model_RolePlayerConstraint" = None, model_TopicType: "model_TopicType" = None, model_TopicType0: set["model_TopicType"] = None, model_TopicType4: "model_TopicType" = None, model_TopicType2: set["model_TopicType"] = None, model_TopicType6: set["model_OccurrenceTypeConstraint"] = None, model_TopicType25: "model_TopicMapSchema" = None, model_TopicType8: set["model_NameTypeConstraint"] = None, model_TopicType10: set["model_SubjectIdentifierConstraint"] = None, model_TopicType34: "model_TypeNode" = None, model_TopicType12: set["model_SubjectLocatorConstraint"] = None, model_TopicType15: "model_TopicType" = None, model_TopicType13: set["model_TopicType"] = None, model_TopicType61: "model_AbstractTypedConstraint" = None, model_TopicType69: "model_RoleCombinationConstraint" = None, model_TopicType72: "model_RoleCombinationConstraint" = None, model_TopicType75: "model_RoleCombinationConstraint" = None, model_TopicType78: "model_RoleCombinationConstraint" = None):
        self.kind = kind
        self.name = name
