...
class trace_Event(EModelElement):
    ...
    def __init__(self, timestamp: str, Event: "trace_Trace" = None, events: "trace_Trace" = None, trace_Event: set["trace_Slice"] = None, trace_Event7: "trace_Slice" = None):
...
class trace_Slice(EModelElement):
    ...
    def __init__(self, name: str, kind: str, kindLabel: str, trace_Slice: "trace_Trace" = None, trace_Slice4: "trace_Event" = None, trace_Slice6: set["trace_Event"] = None, Slice: "trace_Slice" = None, parent: set["trace_Slice"] = None, Slice12: "trace_Slice" = None, ownedSubSlices: "trace_Slice" = None, trace_Slice14: "trace_Properties" = None, trace_Slice17: "trace_Slice" = None, trace_Slice15: set["trace_Slice"] = None):
        self.name = name
        self.kind = kind
    ...
    def getHierarchicalName(self, trace_separator) :
        # TODO: Implement getHierarchicalName method
        pass

    def getAggregatedEvents(self) :
        # TODO: Implement getAggregatedEvents method
        pass

class trace_Trace(EModelElement):

    def __init__(self, range: str, hostId: str, precision: str, trace: set["trace_Event"] = None, trace_Trace: set["trace_Slice"] = None, Trace: "trace_Event" = None):
        self.range = range
        self.hostId = hostId
