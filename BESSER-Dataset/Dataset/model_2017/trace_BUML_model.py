...
trace_Event = Class(name="trace_Event")
trace_Slice = Class(name="trace_Slice")
trace_SchedulingEvent = Class(name="trace_SchedulingEvent")
trace_MessageEvent = Class(name="trace_MessageEvent")
trace_Properties = Class(name="trace_Properties")
trace_ResourceEvent = Class(name="trace_ResourceEvent")
Event = Class(name="Event")
trace_ValueChangeEvent = Class(name="trace_ValueChangeEvent")
trace_EStructuralFeature = Class(name="trace_EStructuralFeature")
trace_EObject = Class(name="trace_EObject")
trace_ObjectValueChangeEvent = Class(name="trace_ObjectValueChangeEvent")
ValueChangeEvent = Class(name="ValueChangeEvent")
trace_DurationValueChangeEvent = Class(name="trace_DurationValueChangeEvent")
trace_DataSizeValueChangeEvent = Class(name="trace_DataSizeValueChangeEvent")
trace_NumberValueChangeEvent = Class(name="trace_NumberValueChangeEvent")
...
trace_Trace.attributes={trace_Trace_range, trace_Trace_hostId, trace_Trace_precision}
...
trace_Slice_m_getHierarchicalName: Method = Method(name="getHierarchicalName", parameters={Parameter(name='trace_separator', type=StringType)}, type=StringType)
...
trace_Slice.attributes={trace_Slice_kind, trace_Slice_kindLabel, trace_Slice_name}
...
trace_Properties.attributes={trace_Properties_remainingTime, trace_Properties_absoluteDeadline, trace_Properties_executionTime, trace_Properties_blockingTime, trace_Properties_responseTime, trace_Properties_range, trace_Properties_index}
...
domain_model = DomainModel(
    name="trace",
    types={trace_Trace, EModelElement, trace_Event, trace_Slice, trace_SchedulingEvent, trace_MessageEvent, trace_Properties, trace_ResourceEvent, Event, trace_ValueChangeEvent, trace_EStructuralFeature, trace_EObject, trace_ObjectValueChangeEvent, ValueChangeEvent, trace_DurationValueChangeEvent, trace_DataSizeValueChangeEvent, trace_NumberValueChangeEvent, SchedulingEventKind, ResourceEventKind, MessageEventKind, SliceKind},
    associations={events0, slices1, trace2, about3, events5, ownedSubSlices9, parent11, properties13, subSlices16, property18, object19, value21},
    generalizations={gen_trace_Trace_EModelElement, gen_trace_Event_EModelElement, gen_trace_SchedulingEvent_Event, gen_trace_MessageEvent_Event, gen_trace_Slice_EModelElement, gen_trace_ResourceEvent_Event, gen_trace_Properties_EModelElement, gen_trace_ValueChangeEvent_Event, gen_trace_ObjectValueChangeEvent_ValueChangeEvent, gen_trace_DurationValueChangeEvent_ValueChangeEvent, gen_trace_DataSizeValueChangeEvent_ValueChangeEvent, gen_trace_NumberValueChangeEvent_ValueChangeEvent},
    metadata=None
)
