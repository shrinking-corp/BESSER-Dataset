...
public class idl_EventDcl extends Event {
    ...
    public idl_EventDcl(
        boolean isTruncatable,        boolean isCustom    ) {
        super(
        );
    ...
    public idl_EventDcl(
        boolean isTruncatable,        boolean isCustom        ArrayList<idl_ScopedName> idl_scopednames,        ArrayList<idl_Export> idl_exports,        ArrayList<idl_ScopedName> idl_scopednames    ) {
        this.isTruncatable = isTruncatable;
        this.isCustom = isCustom;
