...
HouseHolds.attributes={HouseHolds_Coffee, HouseHolds_Alarm, HouseHolds_WashingMachine, HouseHolds_TimeID, HouseHolds_DishWasher}
...
domain_model = DomainModel(
    name="_1c26315b_307f_4570_ae50_385324c911e0",
    ...
    associations={Home_Security_System_System, TV_Entertainment, Speakers_Entertainment, HomeTheatre_Entertainment, Sensor_Door, Door_Camera, HomeTheatre_TV, HomeTheatre_Speakers, HouseHolds_Start_Of_Day, HouseHolds_End_Of_Day, MicroPhone_System, Home_Security_System_Alert, Sensor_System, System_HouseHolds, HomeTheatre_System},
    generalizations={},
    metadata=None
)
