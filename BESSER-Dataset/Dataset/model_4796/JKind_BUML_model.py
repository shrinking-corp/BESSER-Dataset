...
domain_model = DomainModel(
    name="jkind",
    types={jkind_Node, jkind_Type, jkind_Field, IdRef, jkind_Expr, jkind_VariableGroup, jkind_File, jkind_Typedef, jkind_Constant, jkind_IdRef, jkind_AbbreviationType, Typedef, jkind_RecordType, jkind_Equation, jkind_Assertion, jkind_Property, jkind_Variable, jkind_ProjectionExpr, jkind_IdExpr, jkind_IntExpr, jkind_RealExpr, jkind_BoolExpr, jkind_IfThenElseExpr, jkind_IntType, Type, jkind_BoolType, jkind_RealType, jkind_SubrangeType, jkind_UserType, jkind_BinaryExpr, Expr, jkind_UnaryExpr, jkind_NodeCallExpr, jkind_RecordExpr},
    associations={nodes3, type5, expr7, inputs9, outputs11, typedefs0, constants1, rhs31, ref34, expr37, type40, fields42, types43, locals14, equations17, assertions19, properties21, variables23, type25, lhs28, expr55, field57, id60, cond61, then63, def_46, left48, right50, expr53, else_66, node69, args71, type74, fields76, exprs79},
    generalizations={gen_jkind_Constant_IdRef, gen_jkind_AbbreviationType_Typedef, gen_jkind_RecordType_Typedef, gen_jkind_Variable_IdRef, gen_jkind_ProjectionExpr_Expr, gen_jkind_IdExpr_Expr, gen_jkind_IntExpr_Expr, gen_jkind_RealExpr_Expr, gen_jkind_BoolExpr_Expr, gen_jkind_IfThenElseExpr_Expr, gen_jkind_IntType_Type, gen_jkind_BoolType_Type, gen_jkind_RealType_Type, gen_jkind_SubrangeType_Type, gen_jkind_UserType_Type, gen_jkind_BinaryExpr_Expr, gen_jkind_UnaryExpr_Expr, gen_jkind_NodeCallExpr_Expr, gen_jkind_RecordExpr_Expr},
    metadata=None
)
