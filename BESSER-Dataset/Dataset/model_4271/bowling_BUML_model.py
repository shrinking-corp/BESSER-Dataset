...
bowling_Player.attributes={bowling_Player_isProfessional, bowling_Player_street, bowling_Player_name, bowling_Player_dateOfBirth, bowling_Player_streetNumber, bowling_Player_height, bowling_Player_eMail}
...
domain_model = DomainModel(
    name="bowling",
    types={bowling_Player, bowling_Game, bowling_League, bowling_Tournament, bowling_Matchup, TournamentType},
    associations={games6, games0, players1, matchups2, league3, matchup8, player9},
    generalizations={},
    metadata=None
)
