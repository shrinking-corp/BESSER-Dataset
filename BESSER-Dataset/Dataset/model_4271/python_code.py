...
class bowling_Matchup:
    ...
    def __init__(self, date: date, matchup: set["bowling_Game"] = None, bowling_Matchup: "bowling_Tournament" = None, Matchup: "bowling_Game" = None):
        self.date = date
...
class bowling_Game:
    ...
    def __init__(self, frames: int, Game7: "bowling_Matchup" = None, Game: "bowling_Player" = None, games: "bowling_Matchup" = None, games10: "bowling_Player" = None):
        self.frames = frames
        self.Game7 = Game7
        self.Game = Game
        self.games = games
...
class bowling_Player:
    ...
    def __init__(self, name: str, street: str, streetNumber: int, dateOfBirth: date, height: float, isProfessional: bool, eMail: str, player: set["bowling_Game"] = None, bowling_Player: "bowling_League" = None, Player: "bowling_Game" = None):
        self.name = name
        self.street = street
