...
class db_Column(DatabaseElement):
    ...
    def __init__(self, type: str, columns: "db_Table" = None, db_Column6: "db_ForeignKey" = None, db_Column9: "db_ForeignKey" = None, Column: "db_Table" = None, db_Column: "db_Table" = None):
        self.type = type
