...
# Classes
studyprogram_University = Class(name="studyprogram_University")
studyprogram_Department = Class(name="studyprogram_Department")
studyprogram_Course = Class(name="studyprogram_Course")
studyprogram_Program = Class(name="studyprogram_Program")
studyprogram_StudyPlan = Class(name="studyprogram_StudyPlan")
studyprogram_ElectiveCourses = Class(name="studyprogram_ElectiveCourses")
studyprogram_ObligatoryCourses = Class(name="studyprogram_ObligatoryCourses")
studyprogram_Year = Class(name="studyprogram_Year")
studyprogram_Semester = Class(name="studyprogram_Semester")
studyprogram_SemesterCourse = Class(name="studyprogram_SemesterCourse")
studyprogram_Specialisation = Class(name="studyprogram_Specialisation")
...
studyprogram_Course.attributes={studyprogram_Course_credits, studyprogram_Course_semester, studyprogram_Course_name}
...
studyprogram_SemesterCourse.attributes={studyprogram_SemesterCourse_name, studyprogram_SemesterCourse_type}
...
domain_model = DomainModel(
    name="studyprogram",
    types={studyprogram_University, studyprogram_Department, studyprogram_Course, studyprogram_Program, studyprogram_StudyPlan, studyprogram_ElectiveCourses, studyprogram_ObligatoryCourses, studyprogram_Year, studyprogram_Semester, studyprogram_SemesterCourse, studyprogram_Specialisation, CourseType, SemesterType},
    associations={departments0, school1, courses2, programs3, department5, studyPlans7, electiveCourses8, obligatoryCourses10, semesters17, studyPlan18, year20, semesterCourses22, semester23, course25, years26, studyPlan27, department29, program31, courses33, years12, program13, spesialisations15, program35, courses37},
    generalizations={},
    metadata=None
)
