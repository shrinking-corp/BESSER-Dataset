...
class studyprogram_SemesterCourse:
    ...
    def __init__(self, type: str, name: str, SemesterCourse: "studyprogram_Semester" = None, semesterCourses: "studyprogram_Semester" = None, studyprogram_SemesterCourse: set["studyprogram_Course"] = None):
        self.type = type
        self.name = name
...
class studyprogram_Semester:
    ...
    def __init__(self, type: str, Semester: "studyprogram_Year" = None, semesters: "studyprogram_Year" = None, semester: set["studyprogram_SemesterCourse"] = None, Semester24: "studyprogram_SemesterCourse" = None):
        self.type = type
...
class studyprogram_Year:
    ...
    def __init__(self, value: int, Year: "studyprogram_StudyPlan" = None, year: set["studyprogram_Semester"] = None, years: "studyprogram_StudyPlan" = None, Year21: "studyprogram_Semester" = None, studyprogram_Year: "studyprogram_Specialisation" = None):
        self.value = value
        self.Year = Year
...
class studyprogram_Course:
    ...
    def __init__(self, semester: str, name: str, credits: str, studyprogram_Course38: "studyprogram_ObligatoryCourses" = None, Course: "studyprogram_Department" = None, studyprogram_Course: "studyprogram_SemesterCourse" = None, courses: "studyprogram_Department" = None, studyprogram_Course34: "studyprogram_ElectiveCourses" = None):
        self.semester = semester
        self.name = name
...
class studyprogram_Department:
    ...
    def __init__(self, name: str, Department: "studyprogram_University" = None, departments: "studyprogram_University" = None, department: set["studyprogram_Course"] = None, department4: set["studyprogram_Program"] = None, Department6: "studyprogram_Program" = None, Department30: "studyprogram_Course" = None):
        self.name = name
