...
class gmfgraph_Dimension:
    ...
    def __init__(self, dx: int, dy: int, gmfgraph_Dimension: "gmfgraph_Figure" = None, gmfgraph_Dimension40: "gmfgraph_Figure" = None, gmfgraph_Dimension43: "gmfgraph_Figure" = None, gmfgraph_Dimension102: "gmfgraph_DefaultSizeFacet" = None, gmfgraph_Dimension85: "gmfgraph_GridLayoutData" = None, gmfgraph_Dimension90: "gmfgraph_GridLayout" = None, gmfgraph_Dimension93: "gmfgraph_GridLayout" = None, gmfgraph_Dimension95: "gmfgraph_BorderLayout" = None, gmfgraph_Dimension100: "gmfgraph_XYLayoutData" = None):
        self.dx = dx
        self.dy = dy
...
class gmfgraph_Node(AbstractNode):
    ...
    def __init__(self, resizeConstraint: str, affixedParentSide: str, gmfgraph_Node22: "gmfgraph_ChildAccess" = None, gmfgraph_Node: "gmfgraph_Canvas" = None):
...
class gmfgraph_RealFigure(AbstractFigure):
    ...
    def __init__(self, name: str, gmfgraph_RealFigure: "gmfgraph_FigureGallery" = None, gmfgraph_RealFigure104: set["gmfgraph_Figure"] = None, gmfgraph_RealFigure60: "gmfgraph_FigureRef" = None, gmfgraph_RealFigure71: "gmfgraph_FigureAccessor" = None):
        self.name = name
