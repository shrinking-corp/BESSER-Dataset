...
class iso20022_Decimal(DataType):
    ...
    def __init__(self, pattern: str, minInclusive: str, minExclusive: str, maxInclusive: str, maxExclusive: str, totalDigits: str, fractionDigits: str):
        self.pattern = pattern
        self.minInclusive = minInclusive
        self.minExclusive = minExclusive
        self.maxInclusive = maxInclusive
...
class iso20022_String(DataType):
    ...
    def __init__(self, length: str, pattern: str, minLength: str, maxLength: str):
        self.length = length
        self.pattern = pattern
        self.minLength = minLength
        self.maxLength = maxLength
...
class iso20022_MessageElementContainer(MessageComponentType):
    ...
    def MessageElementsHaveUniqueNames(self, iso20022_diagnostics, iso20022_context) :
        # TODO: Implement MessageElementsHaveUniqueNames method
        pass

class iso20022_BusinessElement(BusinessConcept, Construct):

    def __init__(self, isDerived: bool, BusinessElement: "iso20022_MessageElement" = None, businessElementTrace: set["iso20022_MessageElement"] = None, BusinessElement96: "iso20022_BusinessComponent" = None, iso20022_BusinessElement: "iso20022_BusinessElementType" = None, element: "iso20022_BusinessComponent" = None):
...
class iso20022_MessageBuildingBlock(MessageConstruct):
    ...
    def __init__(self, iso20022_MessageBuildingBlock: "iso20022_MessageDefinition" = None, iso20022_MessageBuildingBlock79: "iso20022_Xor" = None, iso20022_MessageBuildingBlock109: "iso20022_DataType" = None, messageBuildingBlock: "iso20022_MessageComponentType" = None, MessageBuildingBlock: "iso20022_MessageComponentType" = None):
    ...
    def MessageBuildingBlockHasExactlyOneType(self, iso20022_diagnostics, iso20022_context) :
...
class iso20022_MessageTransportMode(TopLevelCatalogueEntry):
    ...
    def __init__(self, maximumMessageSize: str, messageDeliveryWindow: str, messageSendingWindow: str, deliveryAssurance: str, durability: str, messageCasting: str, messageDeliveryOrder: str, messageValidationLevel: str, messageValidationOnOff: str, messageValidationResults: str, receiverAsynchronicity: str, senderAsynchronicity: str, boundedCommunicationDelay: str, maximumClockVariation: str, messageTransportMode: set["iso20022_BusinessTransaction"] = None, MessageTransportMode: "iso20022_BusinessTransaction" = None):
...
class iso20022_BusinessTransaction(TopLevelCatalogueEntry):
    ...
    def __init__(self, businessTransaction: set["iso20022_Participant"] = None, businessTransaction127: set["iso20022_MessageTransmission"] = None, BusinessTransaction: "iso20022_MessageChoreography" = None, businessProcessTrace: "iso20022_BusinessProcess" = None, BusinessTransaction154: "iso20022_BusinessProcess" = None, BusinessTransaction133: "iso20022_BusinessTransaction" = None, parentTransaction: set["iso20022_BusinessTransaction"] = None, BusinessTransaction136: "iso20022_BusinessTransaction" = None, subTransaction: "iso20022_BusinessTransaction" = None, businessTransactionTrace: set["iso20022_MessageChoreography"] = None, BusinessTransaction173: "iso20022_MessageTransmission" = None, BusinessTransaction160: "iso20022_Participant" = None, BusinessTransaction187: "iso20022_MessageTransportMode" = None, businessTransaction130: "iso20022_MessageTransportMode" = None):
    ...
    def MessageTransmissionsHaveUniqueNames(self, iso20022_diagnostics, iso20022_context) :
...
class iso20022_MessageSet(TopLevelCatalogueEntry):
    ...
    def GeneratedSyntaxDerivation(self, iso20022_context, iso20022_diagnostics) :
...
class iso20022_MessageTransmission(RepositoryConcept):
    ...
    def __init__(self, messageTypeDescription: str, MessageTransmission128: "iso20022_BusinessTransaction" = None, MessageTransmission: "iso20022_MessageDefinition" = None, transmission: "iso20022_BusinessTransaction" = None, trace175: set["iso20022_MessageDefinition"] = None, messageTransmission: "iso20022_Send" = None, MessageTransmission169: "iso20022_Receive" = None, messageTransmission180: set["iso20022_Receive"] = None, MessageTransmission185: "iso20022_Send" = None):
...
class iso20022_MessageDefinition(RepositoryType):
    ...
    def __init__(self, xmlName: str, xmlTag: str, rootElement: str, MessageDefinition: "iso20022_SyntaxMessageScheme" = None, messageDefinition: set["iso20022_MessageSet"] = None, messageDefinition49: "iso20022_BusinessArea" = None, messageDefinition51: set["iso20022_Xor"] = None, iso20022_MessageDefinition: set["iso20022_MessageBuildingBlock"] = None, MessageDefinition64: "iso20022_MessageSet" = None, MessageDefinition82: "iso20022_Xor" = None, messageDefinition54: set["iso20022_MessageChoreography"] = None, derivation56: set["iso20022_MessageTransmission"] = None, iso20022_MessageDefinition58: "iso20022_MessageDefinitionIdentifier" = None, messageDefinitionTrace: set["iso20022_SyntaxMessageScheme"] = None, MessageDefinition74: "iso20022_BusinessArea" = None, MessageDefinition123: "iso20022_MessageChoreography" = None, MessageDefinition176: "iso20022_MessageTransmission" = None):
...
class iso20022_RepositoryConcept(ModelEntity):
    ...
    def __init__(self, example: str, name: str, definition: str, registrationStatus: str, removalDate: date, iso20022_RepositoryConcept29: set["iso20022_Doclet"] = None, iso20022_RepositoryConcept: set["iso20022_SemanticMarkup"] = None, owner: set["iso20022_Constraint"] = None, RepositoryConcept: "iso20022_Constraint" = None):
    ...
    def RemovalDateRegistrationStatus(self, iso20022_context, iso20022_diagnostics) :
...
class iso20022_TransportMessage(ModelEntity):
    ...
    def __init__(self, transportMessage: "iso20022_MessageInstance" = None, receivedMessage: set["iso20022_MessagingEndpoint"] = None, TransportMessage: "iso20022_MessagingEndpoint" = None, TransportMessage11: "iso20022_MessagingEndpoint" = None, sentMessage: "iso20022_MessagingEndpoint" = None, TransportMessage24: "iso20022_MessageInstance" = None):
    ...
    def sameMessageTransportSystem(self, iso20022_context, iso20022_diagnostics) :
...
class iso20022_SemanticMarkupElement(ModelEntity):
    ...
    def __init__(self, value: str, name: str, iso20022_SemanticMarkupElement: "iso20022_SemanticMarkup" = None):
        self.value = value
        self.name = name
