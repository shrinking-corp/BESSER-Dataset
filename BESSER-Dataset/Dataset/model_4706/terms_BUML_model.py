...
containerNamedOperator16: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="def_17", type=terms_NamedOperator, multiplicity=Multiplicity(0, 1))
    }
)
...
def_41: BinaryAssociation = BinaryAssociation(
    name="def_41",
    ends={
...
domain_model = DomainModel(
    name="terms",
    types={terms_Declarations, terms_TermsDeclaration, terms_Declaration, terms_Partition, Sort, terms_Term, terms_Operator, terms_NamedOperator, terms_HLMarking, terms_Condition, terms_Sort, terms_MultisetSort, terms_NamedSort, terms_VariableDecl, terms_ProductSort, terms_Type, terms_All, terms_Empty, terms_PartitionElement, Term, terms_HLAnnotation, TermsDeclaration, terms_Variable, terms_BuiltInConstant, Operator, terms_MultisetOperator, terms_Tuple, terms_BuiltInSort, terms_UserSort, terms_SortDecl, terms_BuiltInOperator, SortDecl, terms_UserOperator, terms_OperatorDecl, OperatorDecl},
    associations={declaration0, containerDeclaration1, containerDeclarations2, containerPartition12, basis13, sort14, containerOperator15, containerNamedOperator16, containerHLMarking18, multi3, containerNamedSort4, containerVariableDecl5, containerProductSort6, containerType7, containerAll9, containerEmpty10, containerPartitionElement24, subterm25, containerCondition20, containerHLAnnotation22, sort31, containerNamedOperator33, output26, input28, elementSort36, variableDecl35, sortdef38, declaration40, parameters43, declaration46, def_41},
    generalizations={gen_terms_MultisetSort_Sort, gen_terms_Operator_Term, gen_terms_VariableDecl_TermsDeclaration, gen_terms_Variable_Term, gen_terms_BuiltInConstant_Operator, gen_terms_MultisetOperator_Operator, gen_terms_Tuple_Operator, gen_terms_BuiltInSort_Sort, gen_terms_ProductSort_Sort, gen_terms_UserSort_Sort, gen_terms_SortDecl_TermsDeclaration, gen_terms_BuiltInOperator_Operator, gen_terms_NamedSort_SortDecl, gen_terms_UserOperator_Operator, gen_terms_OperatorDecl_TermsDeclaration, gen_terms_NamedOperator_OperatorDecl},
    metadata=None
)
