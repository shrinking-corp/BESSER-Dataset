...
class SpecificationElement:
    ...
    pass
class sgraph_Transition(Reaction, SpecificationElement, DocumentedElement):

    pass
class sgraph_Statechart(SpecificationElement, NamedElement, DomainElement, CompositeElement, ScopedElement, ReactiveElement, DocumentedElement):

    pass
class sgraph_State(SpecificationElement, CompositeElement, ScopedElement, RegularState, ReactiveElement, DocumentedElement):
