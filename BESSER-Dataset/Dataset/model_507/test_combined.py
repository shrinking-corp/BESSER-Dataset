...
def test_assoc_daughters6_link_reassign_clear():
    ...
    b1 = Families_Family(name="sample_text")
    b2 = Families_Family(name="sample_text_2")
...
def test_assoc_daughtersInverse15_link_reassign_clear():
    a = Families_FamilyMember(name="sample_text")
    b1 = Families_Family(name="sample_text")
    b2 = Families_Family(name="sample_text_2")
...
def test_assoc_families0_link_reassign_clear():
    ...
    b1 = Families_FamilyRegister()
    b2 = Families_FamilyRegister()
...
def test_assoc_fatherInverse9_link_reassign_clear():
    a = Families_FamilyMember(name="sample_text")
    b1 = Families_Family(name="sample_text")
    b2 = Families_Family(name="sample_text_2")
...
def test_assoc_motherInverse11_link_reassign_clear():
    a = Families_FamilyMember(name="sample_text")
    b1 = Families_Family(name="sample_text")
    b2 = Families_Family(name="sample_text_2")
...
def test_assoc_sonsInverse13_link_reassign_clear():
    a = Families_FamilyMember(name="sample_text")
    b1 = Families_Family(name="sample_text")
    b2 = Families_Family(name="sample_text_2")
    _safe_set(a, 'sons', b1)
