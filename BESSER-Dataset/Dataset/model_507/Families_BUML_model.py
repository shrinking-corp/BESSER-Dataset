...
domain_model = DomainModel(
    name="Families",
    types={Families_FamilyMember, Families_FamilyRegister, Families_Family},
    associations={families0, father1, mother2, sons4, daughters6, familiesInverse8, fatherInverse9, motherInverse11, sonsInverse13, daughtersInverse15},
    generalizations={},
    metadata=None
)
