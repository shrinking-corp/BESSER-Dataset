...
# Classes
Paper_Author = Class(name="Paper_Author")
Paper_Papers = Class(name="Paper_Papers")
Paper_Paper = Class(name="Paper_Paper")
...
domain_model = DomainModel(
    name="Paper",
    types={Paper_Author, Paper_Papers, Paper_Paper},
    associations={authors1, papers0},
    generalizations={},
    metadata=None
)
