...
Patron.attributes={Patron_name, Patron_position, Patron_id}
...
domain_model = DomainModel(
    name="_7wtOEBwBEeejtu_xKNOcrQ",
    types={Book, Magazine, Patron, Computer, Media, Staff},
    associations={Patron_Magazine, Patron_Media, Patron_Computer, Staff_Book, Staff_Magazine, Staff_Media, Staff_Computer, Patron_Book},
    generalizations={},
    metadata=None
)
