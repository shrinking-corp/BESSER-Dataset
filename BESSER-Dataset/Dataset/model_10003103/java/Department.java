...
public class Department  {
    ...
    public Department(
        None hod,        None students__,        None course,        None teachers__    ) {
        this.hod = hod;
    ...
    public Department(
        None hod,        None students__,        None course,        None teachers__        ArrayList<Student> students,        ArrayList<Employee_Interface> employee_interfaces    ) {
        this.hod = hod;
        this.students__ = students__;
        this.course = course;
        this.teachers__ = teachers__;
