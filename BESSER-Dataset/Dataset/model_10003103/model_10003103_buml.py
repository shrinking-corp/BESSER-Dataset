...
Department.attributes={Department_teachers__, Department_hod, Department_students__, Department_course}
...
domain_model = DomainModel(
    name="ff6036ca_d4a8_47ef_b1b9_2eede64eca9f",
    ...
    associations={Department_Course, Course_Subject, Department_Student, Department_Employee, Student_Access_Information, Admin_Student, Admin_Employee, Access_Information_Attendance, Access_Information_Department, Employee_Access_Information},
    generalizations={},
    metadata=None
)
