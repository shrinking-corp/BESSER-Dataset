...
# Classes
gmf_all_mappings_Mapping = Class(name="gmf_all_mappings_Mapping")
TopNodeReference = Class(name="TopNodeReference")
VisualEffectMapping = Class(name="VisualEffectMapping")
gmf_all_mappings_NeedsContainment = Class(name="gmf_all_mappings_NeedsContainment", is_abstract=True)
mappings_gmf_all_EReference = Class(name="mappings_gmf_all_EReference")
...
gmf_all_mappings_MappingEntry = Class(name="gmf_all_mappings_MappingEntry", is_abstract=True)
mappings_gmf_all_EClass = Class(name="mappings_gmf_all_EClass")
Constraint = Class(name="Constraint")
ElementInitializer = Class(name="ElementInitializer")
LabelMapping = Class(name="LabelMapping")
gmf_all_mappings_NodeMapping = Class(name="gmf_all_mappings_NodeMapping")
mappings_MappingEntry = Class(name="mappings_MappingEntry")
mappings_MenuOwner = Class(name="mappings_MenuOwner")
mappings_ToolOwner = Class(name="mappings_ToolOwner")
mappings_AppearanceSteward = Class(name="mappings_AppearanceSteward")
Node = Class(name="Node")
gmf_all_mappings_NodeReference = Class(name="gmf_all_mappings_NodeReference", is_abstract=True)
NeedsContainment = Class(name="NeedsContainment")
NodeMapping = Class(name="NodeMapping")
gmf_all_mappings_ChildReference = Class(name="gmf_all_mappings_ChildReference")
NodeReference = Class(name="NodeReference")
CompartmentMapping = Class(name="CompartmentMapping")
gmf_all_mappings_TopNodeReference = Class(name="gmf_all_mappings_TopNodeReference")
mappings_gmf_all_EPackage = Class(name="mappings_gmf_all_EPackage")
Palette = Class(name="Palette")
ChildReference = Class(name="ChildReference")
gmf_all_mappings_CompartmentMapping = Class(name="gmf_all_mappings_CompartmentMapping")
Compartment = Class(name="Compartment")
gmf_all_mappings_LinkMapping = Class(name="gmf_all_mappings_LinkMapping")
mappings_NeedsContainment = Class(name="mappings_NeedsContainment")
Connection = Class(name="Connection")
mappings_gmf_all_EStructuralFeature = Class(name="mappings_gmf_all_EStructuralFeature")
LinkConstraints = Class(name="LinkConstraints")
gmf_all_mappings_CanvasMapping = Class(name="gmf_all_mappings_CanvasMapping")
Canvas = Class(name="Canvas")
ValueExpression = Class(name="ValueExpression")
MainMenu = Class(name="MainMenu")
Toolbar = Class(name="Toolbar")
gmf_all_mappings_LabelMapping = Class(name="gmf_all_mappings_LabelMapping")
DiagramLabel = Class(name="DiagramLabel")
MappingEntry = Class(name="MappingEntry")
gmf_all_mappings_FeatureLabelMapping = Class(name="gmf_all_mappings_FeatureLabelMapping")
mappings_gmf_all_EAttribute = Class(name="mappings_gmf_all_EAttribute")
gmf_all_mappings_OclChoiceLabelMapping = Class(name="gmf_all_mappings_OclChoiceLabelMapping")
gmf_all_mappings_DesignLabelMapping = Class(name="gmf_all_mappings_DesignLabelMapping")
gmf_all_mappings_ExpressionLabelMapping = Class(name="gmf_all_mappings_ExpressionLabelMapping")
gmf_all_mappings_Constraint = Class(name="gmf_all_mappings_Constraint")
gmf_all_mappings_LinkConstraints = Class(name="gmf_all_mappings_LinkConstraints")
gmf_all_mappings_FeatureInitializer = Class(name="gmf_all_mappings_FeatureInitializer", is_abstract=True)
gmf_all_mappings_ValueExpression = Class(name="gmf_all_mappings_ValueExpression")
gmf_all_mappings_ElementInitializer = Class(name="gmf_all_mappings_ElementInitializer", is_abstract=True)
gmf_all_mappings_FeatureSeqInitializer = Class(name="gmf_all_mappings_FeatureSeqInitializer")
...
gmf_all_mappings_FeatureValueSpec = Class(name="gmf_all_mappings_FeatureValueSpec")
gmf_all_mappings_ReferenceNewElementSpec = Class(name="gmf_all_mappings_ReferenceNewElementSpec")
gmf_all_mappings_MenuOwner = Class(name="gmf_all_mappings_MenuOwner", is_abstract=True)
ContextMenu = Class(name="ContextMenu")
gmf_all_mappings_ToolOwner = Class(name="gmf_all_mappings_ToolOwner", is_abstract=True)
AbstractTool = Class(name="AbstractTool")
gmf_all_mappings_AppearanceSteward = Class(name="gmf_all_mappings_AppearanceSteward", is_abstract=True)
gmf_all_mappings_AuditContainer = Class(name="gmf_all_mappings_AuditContainer")
gmf_all_mappings_DomainAttributeTarget = Class(name="gmf_all_mappings_DomainAttributeTarget")
gmf_all_mappings_RuleBase = Class(name="gmf_all_mappings_RuleBase", is_abstract=True)
gmf_all_mappings_AuditRule = Class(name="gmf_all_mappings_AuditRule")
RuleBase = Class(name="RuleBase")
Auditable = Class(name="Auditable")
gmf_all_mappings_DomainElementTarget = Class(name="gmf_all_mappings_DomainElementTarget")
mappings_Auditable = Class(name="mappings_Auditable")
mappings_Measurable = Class(name="mappings_Measurable")
gmf_all_mappings_NotationElementTarget = Class(name="gmf_all_mappings_NotationElementTarget")
gmf_all_mappings_DiagramElementTarget = Class(name="gmf_all_mappings_DiagramElementTarget")
gmf_all_mappings_MetricContainer = Class(name="gmf_all_mappings_MetricContainer")
MetricRule = Class(name="MetricRule")
gmf_all_mappings_MetricRule = Class(name="gmf_all_mappings_MetricRule")
Measurable = Class(name="Measurable")
gmf_all_mappings_AuditedMetricTarget = Class(name="gmf_all_mappings_AuditedMetricTarget")
gmf_all_tooldef_PaletteSeparator = Class(name="gmf_all_tooldef_PaletteSeparator")
gmf_all_tooldef_ToolGroup = Class(name="gmf_all_tooldef_ToolGroup")
ToolContainer = Class(name="ToolContainer")
gmf_all_mappings_Auditable = Class(name="gmf_all_mappings_Auditable", is_abstract=True)
gmf_all_mappings_Measurable = Class(name="gmf_all_mappings_Measurable", is_abstract=True)
gmf_all_mappings_VisualEffectMapping = Class(name="gmf_all_mappings_VisualEffectMapping")
Pin = Class(name="Pin")
gmf_all_tooldef_ToolRegistry = Class(name="gmf_all_tooldef_ToolRegistry")
MenuAction = Class(name="MenuAction")
Menu = Class(name="Menu")
gmf_all_tooldef_AbstractTool = Class(name="gmf_all_tooldef_AbstractTool", is_abstract=True)
Image = Class(name="Image")
gmf_all_tooldef_ToolContainer = Class(name="gmf_all_tooldef_ToolContainer", is_abstract=True)
gmf_all_tooldef_MenuAction = Class(name="gmf_all_tooldef_MenuAction")
ContributionItem = Class(name="ContributionItem")
gmf_all_tooldef_ItemRef = Class(name="gmf_all_tooldef_ItemRef")
gmf_all_tooldef_Palette = Class(name="gmf_all_tooldef_Palette")
gmf_all_tooldef_StandardTool = Class(name="gmf_all_tooldef_StandardTool")
gmf_all_tooldef_CreationTool = Class(name="gmf_all_tooldef_CreationTool")
gmf_all_tooldef_GenericTool = Class(name="gmf_all_tooldef_GenericTool")
gmf_all_tooldef_ItemBase = Class(name="gmf_all_tooldef_ItemBase", is_abstract=True)
gmf_all_tooldef_Menu = Class(name="gmf_all_tooldef_Menu", is_abstract=True)
ItemBase = Class(name="ItemBase")
gmf_all_tooldef_Separator = Class(name="gmf_all_tooldef_Separator")
gmf_all_tooldef_PredefinedItem = Class(name="gmf_all_tooldef_PredefinedItem")
gmf_all_tooldef_PredefinedMenu = Class(name="gmf_all_tooldef_PredefinedMenu")
tooldef_Menu = Class(name="tooldef_Menu")
tooldef_PredefinedItem = Class(name="tooldef_PredefinedItem")
gmf_all_tooldef_ContributionItem = Class(name="gmf_all_tooldef_ContributionItem", is_abstract=True)
gmf_all_gmfgraph_Canvas = Class(name="gmf_all_gmfgraph_Canvas")
Identity = Class(name="Identity")
gmf_all_tooldef_ContextMenu = Class(name="gmf_all_tooldef_ContextMenu")
gmf_all_tooldef_PopupMenu = Class(name="gmf_all_tooldef_PopupMenu")
tooldef_ContributionItem = Class(name="tooldef_ContributionItem")
gmf_all_tooldef_MainMenu = Class(name="gmf_all_tooldef_MainMenu")
gmf_all_tooldef_Toolbar = Class(name="gmf_all_tooldef_Toolbar")
gmf_all_tooldef_Image = Class(name="gmf_all_tooldef_Image", is_abstract=True)
gmf_all_tooldef_DefaultImage = Class(name="gmf_all_tooldef_DefaultImage")
gmf_all_tooldef_BundleImage = Class(name="gmf_all_tooldef_BundleImage")
gmf_all_tooldef_StyleSelector = Class(name="gmf_all_tooldef_StyleSelector", is_abstract=True)
gmf_all_tooldef_GenericStyleSelector = Class(name="gmf_all_tooldef_GenericStyleSelector")
gmf_all_gmfgraph_AbstractNode = Class(name="gmf_all_gmfgraph_AbstractNode", is_abstract=True)
DiagramElement = Class(name="DiagramElement")
gmf_all_gmfgraph_Node = Class(name="gmf_all_gmfgraph_Node")
AbstractNode = Class(name="AbstractNode")
FigureGallery = Class(name="FigureGallery")
gmf_all_gmfgraph_FigureGallery = Class(name="gmf_all_gmfgraph_FigureGallery")
...
gmf_all_gmfgraph_Identity = Class(name="gmf_all_gmfgraph_Identity", is_abstract=True)
gmf_all_gmfgraph_DiagramElement = Class(name="gmf_all_gmfgraph_DiagramElement", is_abstract=True)
VisualFacet = Class(name="VisualFacet")
gmf_all_gmfgraph_Figure = Class(name="gmf_all_gmfgraph_Figure", is_abstract=True)
Layoutable = Class(name="Layoutable")
ChildAccess = Class(name="ChildAccess")
gmf_all_gmfgraph_Connection = Class(name="gmf_all_gmfgraph_Connection")
gmf_all_gmfgraph_Compartment = Class(name="gmf_all_gmfgraph_Compartment")
gmf_all_gmfgraph_DiagramLabel = Class(name="gmf_all_gmfgraph_DiagramLabel")
gmf_all_gmfgraph_VisualFacet = Class(name="gmf_all_gmfgraph_VisualFacet", is_abstract=True)
gmf_all_gmfgraph_GeneralFacet = Class(name="gmf_all_gmfgraph_GeneralFacet")
gmf_all_gmfgraph_AlignmentFacet = Class(name="gmf_all_gmfgraph_AlignmentFacet")
gmf_all_gmfgraph_GradientFacet = Class(name="gmf_all_gmfgraph_GradientFacet")
gmf_all_gmfgraph_LabelOffsetFacet = Class(name="gmf_all_gmfgraph_LabelOffsetFacet")
gmf_all_gmfgraph_DefaultSizeFacet = Class(name="gmf_all_gmfgraph_DefaultSizeFacet")
Dimension = Class(name="Dimension")
gmf_all_gmfgraph_RealFigure = Class(name="gmf_all_gmfgraph_RealFigure", is_abstract=True)
gmfgraph_AbstractFigure = Class(name="gmfgraph_AbstractFigure")
gmfgraph_PinOwner = Class(name="gmfgraph_PinOwner")
gmfgraph_CustomAttributeOwner = Class(name="gmfgraph_CustomAttributeOwner")
Color = Class(name="Color")
Font = Class(name="Font")
Insets = Class(name="Insets")
Point = Class(name="Point")
gmf_all_gmfgraph_AbstractFigure = Class(name="gmf_all_gmfgraph_AbstractFigure", is_abstract=True)
Figure = Class(name="Figure")
gmf_all_gmfgraph_FigureDescriptor = Class(name="gmf_all_gmfgraph_FigureDescriptor")
gmf_all_gmfgraph_ChildAccess = Class(name="gmf_all_gmfgraph_ChildAccess")
gmf_all_gmfgraph_Ellipse = Class(name="gmf_all_gmfgraph_Ellipse")
gmf_all_gmfgraph_Polyline = Class(name="gmf_all_gmfgraph_Polyline")
gmf_all_gmfgraph_FigureRef = Class(name="gmf_all_gmfgraph_FigureRef")
AbstractFigure = Class(name="AbstractFigure")
gmf_all_gmfgraph_ConnectionFigure = Class(name="gmf_all_gmfgraph_ConnectionFigure", is_abstract=True)
gmf_all_gmfgraph_DecorationFigure = Class(name="gmf_all_gmfgraph_DecorationFigure", is_abstract=True)
gmf_all_gmfgraph_Shape = Class(name="gmf_all_gmfgraph_Shape", is_abstract=True)
gmf_all_gmfgraph_Label = Class(name="gmf_all_gmfgraph_Label")
gmf_all_gmfgraph_LabeledContainer = Class(name="gmf_all_gmfgraph_LabeledContainer")
gmf_all_gmfgraph_VerticalLabel = Class(name="gmf_all_gmfgraph_VerticalLabel")
gmf_all_gmfgraph_Rectangle = Class(name="gmf_all_gmfgraph_Rectangle")
Shape = Class(name="Shape")
gmf_all_gmfgraph_InvisibleRectangle = Class(name="gmf_all_gmfgraph_InvisibleRectangle")
gmf_all_gmfgraph_RoundedRectangle = Class(name="gmf_all_gmfgraph_RoundedRectangle")
gmf_all_gmfgraph_CustomFigure = Class(name="gmf_all_gmfgraph_CustomFigure")
gmfgraph_RealFigure = Class(name="gmfgraph_RealFigure")
gmfgraph_CustomClass = Class(name="gmfgraph_CustomClass")
gmf_all_gmfgraph_Polygon = Class(name="gmf_all_gmfgraph_Polygon")
Polyline = Class(name="Polyline")
gmf_all_gmfgraph_ScalablePolygon = Class(name="gmf_all_gmfgraph_ScalablePolygon")
Polygon = Class(name="Polygon")
gmf_all_gmfgraph_PolylineConnection = Class(name="gmf_all_gmfgraph_PolylineConnection")
gmfgraph_Polyline = Class(name="gmfgraph_Polyline")
gmfgraph_ConnectionFigure = Class(name="gmfgraph_ConnectionFigure")
DecorationFigure = Class(name="DecorationFigure")
gmf_all_gmfgraph_PolylineDecoration = Class(name="gmf_all_gmfgraph_PolylineDecoration")
gmfgraph_DecorationFigure = Class(name="gmfgraph_DecorationFigure")
gmf_all_gmfgraph_PolygonDecoration = Class(name="gmf_all_gmfgraph_PolygonDecoration")
gmfgraph_Polygon = Class(name="gmfgraph_Polygon")
gmf_all_gmfgraph_CustomAttributeOwner = Class(name="gmf_all_gmfgraph_CustomAttributeOwner", is_abstract=True)
CustomAttribute = Class(name="CustomAttribute")
gmf_all_gmfgraph_CustomClass = Class(name="gmf_all_gmfgraph_CustomClass", is_abstract=True)
CustomAttributeOwner = Class(name="CustomAttributeOwner")
gmf_all_gmfgraph_CustomAttribute = Class(name="gmf_all_gmfgraph_CustomAttribute")
gmf_all_gmfgraph_FigureAccessor = Class(name="gmf_all_gmfgraph_FigureAccessor")
gmf_all_gmfgraph_Dimension = Class(name="gmf_all_gmfgraph_Dimension")
gmf_all_gmfgraph_Insets = Class(name="gmf_all_gmfgraph_Insets")
FigureAccessor = Class(name="FigureAccessor")
gmf_all_gmfgraph_CustomDecoration = Class(name="gmf_all_gmfgraph_CustomDecoration")
gmfgraph_CustomFigure = Class(name="gmfgraph_CustomFigure")
gmf_all_gmfgraph_CustomConnection = Class(name="gmf_all_gmfgraph_CustomConnection")
gmf_all_gmfgraph_Color = Class(name="gmf_all_gmfgraph_Color", is_abstract=True)
gmf_all_gmfgraph_RGBColor = Class(name="gmf_all_gmfgraph_RGBColor")
gmf_all_gmfgraph_ConstantColor = Class(name="gmf_all_gmfgraph_ConstantColor")
gmf_all_gmfgraph_Font = Class(name="gmf_all_gmfgraph_Font", is_abstract=True)
gmf_all_gmfgraph_BasicFont = Class(name="gmf_all_gmfgraph_BasicFont")
gmf_all_gmfgraph_Point = Class(name="gmf_all_gmfgraph_Point")
gmf_all_gmfgraph_LayoutData = Class(name="gmf_all_gmfgraph_LayoutData", is_abstract=True)
gmf_all_gmfgraph_CustomLayoutData = Class(name="gmf_all_gmfgraph_CustomLayoutData")
gmfgraph_LayoutData = Class(name="gmfgraph_LayoutData")
gmf_all_gmfgraph_Border = Class(name="gmf_all_gmfgraph_Border", is_abstract=True)
gmf_all_gmfgraph_BorderRef = Class(name="gmf_all_gmfgraph_BorderRef")
gmf_all_gmfgraph_LineBorder = Class(name="gmf_all_gmfgraph_LineBorder")
gmf_all_gmfgraph_MarginBorder = Class(name="gmf_all_gmfgraph_MarginBorder")
gmf_all_gmfgraph_CompoundBorder = Class(name="gmf_all_gmfgraph_CompoundBorder")
gmf_all_gmfgraph_CustomBorder = Class(name="gmf_all_gmfgraph_CustomBorder")
gmfgraph_Border = Class(name="gmfgraph_Border")
gmf_all_gmfgraph_BorderLayout = Class(name="gmf_all_gmfgraph_BorderLayout")
gmf_all_gmfgraph_GridLayoutData = Class(name="gmf_all_gmfgraph_GridLayoutData")
LayoutData = Class(name="LayoutData")
gmf_all_gmfgraph_BorderLayoutData = Class(name="gmf_all_gmfgraph_BorderLayoutData")
gmf_all_gmfgraph_Layoutable = Class(name="gmf_all_gmfgraph_Layoutable", is_abstract=True)
gmf_all_gmfgraph_Layout = Class(name="gmf_all_gmfgraph_Layout", is_abstract=True)
gmf_all_gmfgraph_LayoutRef = Class(name="gmf_all_gmfgraph_LayoutRef")
gmf_all_gmfgraph_CustomLayout = Class(name="gmf_all_gmfgraph_CustomLayout")
gmfgraph_Layout = Class(name="gmfgraph_Layout")
gmf_all_gmfgraph_GridLayout = Class(name="gmf_all_gmfgraph_GridLayout")
gmf_all_gmfgraph_Rectangle2D = Class(name="gmf_all_gmfgraph_Rectangle2D")
gmf_all_gmfgraph_Pin = Class(name="gmf_all_gmfgraph_Pin", is_abstract=True)
gmf_all_gmfgraph_FlowLayout = Class(name="gmf_all_gmfgraph_FlowLayout")
gmf_all_gmfgraph_XYLayout = Class(name="gmf_all_gmfgraph_XYLayout")
gmf_all_gmfgraph_XYLayoutData = Class(name="gmf_all_gmfgraph_XYLayoutData")
gmf_all_gmfgraph_StackLayout = Class(name="gmf_all_gmfgraph_StackLayout")
gmf_all_gmfgraph_CenterLayout = Class(name="gmf_all_gmfgraph_CenterLayout")
gmf_all_gmfgraph_SVGFigure = Class(name="gmf_all_gmfgraph_SVGFigure")
SVGProperty = Class(name="SVGProperty")
Rectangle2D = Class(name="Rectangle2D")
gmf_all_gmfgraph_SVGProperty = Class(name="gmf_all_gmfgraph_SVGProperty")
gmf_all_gmfgraph_CustomPin = Class(name="gmf_all_gmfgraph_CustomPin")
gmf_all_gmfgraph_ColorPin = Class(name="gmf_all_gmfgraph_ColorPin")
gmf_all_gmfgraph_VisiblePin = Class(name="gmf_all_gmfgraph_VisiblePin")
gmf_all_gmfgraph_PinOwner = Class(name="gmf_all_gmfgraph_PinOwner", is_abstract=True)
...
gmf_all_mappings_FeatureLabelMapping.attributes={gmf_all_mappings_FeatureLabelMapping_viewMethod, gmf_all_mappings_FeatureLabelMapping_viewPattern, gmf_all_mappings_FeatureLabelMapping_editPattern, gmf_all_mappings_FeatureLabelMapping_editorPattern, gmf_all_mappings_FeatureLabelMapping_editMethod}
...
gmf_all_mappings_AuditContainer.attributes={gmf_all_mappings_AuditContainer_id, gmf_all_mappings_AuditContainer_description, gmf_all_mappings_AuditContainer_name}
...
gmf_all_mappings_RuleBase.attributes={gmf_all_mappings_RuleBase_description, gmf_all_mappings_RuleBase_name}
...
gmf_all_mappings_AuditRule.attributes={gmf_all_mappings_AuditRule_severity, gmf_all_mappings_AuditRule_useInLiveMode, gmf_all_mappings_AuditRule_message, gmf_all_mappings_AuditRule_id}
...
gmf_all_tooldef_AbstractTool.attributes={gmf_all_tooldef_AbstractTool_description, gmf_all_tooldef_AbstractTool_title}
...
gmf_all_tooldef_StyleSelector_m_isOk: Method = Method(name="isOk", parameters={Parameter(name='gmf_all_style', type=StringType)}, type=BooleanType)
...
gmf_all_gmfgraph_Node.attributes={gmf_all_gmfgraph_Node_resizeConstraint, gmf_all_gmfgraph_Node_affixedParentSide}
...
gmf_all_gmfgraph_Compartment.attributes={gmf_all_gmfgraph_Compartment_needsTitle, gmf_all_gmfgraph_Compartment_collapsible}
...
gmf_all_gmfgraph_DiagramLabel.attributes={gmf_all_gmfgraph_DiagramLabel_elementIcon, gmf_all_gmfgraph_DiagramLabel_external}
...
gmf_all_gmfgraph_GeneralFacet.attributes={gmf_all_gmfgraph_GeneralFacet_data, gmf_all_gmfgraph_GeneralFacet_identifier}
...
gmf_all_gmfgraph_LabelOffsetFacet.attributes={gmf_all_gmfgraph_LabelOffsetFacet_x, gmf_all_gmfgraph_LabelOffsetFacet_y}
...
gmf_all_gmfgraph_Shape.attributes={gmf_all_gmfgraph_Shape_lineKind, gmf_all_gmfgraph_Shape_fill, gmf_all_gmfgraph_Shape_outline, gmf_all_gmfgraph_Shape_lineWidth, gmf_all_gmfgraph_Shape_xorOutline, gmf_all_gmfgraph_Shape_xorFill}
...
gmf_all_gmfgraph_CustomAttribute.attributes={gmf_all_gmfgraph_CustomAttribute_directAccess, gmf_all_gmfgraph_CustomAttribute_value, gmf_all_gmfgraph_CustomAttribute_multiStatementValue, gmf_all_gmfgraph_CustomAttribute_name}
...
gmf_all_gmfgraph_Insets.attributes={gmf_all_gmfgraph_Insets_bottom, gmf_all_gmfgraph_Insets_top, gmf_all_gmfgraph_Insets_right, gmf_all_gmfgraph_Insets_left}
...
gmf_all_gmfgraph_RGBColor.attributes={gmf_all_gmfgraph_RGBColor_blue, gmf_all_gmfgraph_RGBColor_red, gmf_all_gmfgraph_RGBColor_green}
...
gmf_all_gmfgraph_BasicFont.attributes={gmf_all_gmfgraph_BasicFont_height, gmf_all_gmfgraph_BasicFont_style, gmf_all_gmfgraph_BasicFont_faceName}
...
gmf_all_gmfgraph_GridLayoutData.attributes={gmf_all_gmfgraph_GridLayoutData_grabExcessHorizontalSpace, gmf_all_gmfgraph_GridLayoutData_verticalSpan, gmf_all_gmfgraph_GridLayoutData_horizontalSpan, gmf_all_gmfgraph_GridLayoutData_horizontalIndent, gmf_all_gmfgraph_GridLayoutData_verticalAlignment, gmf_all_gmfgraph_GridLayoutData_horizontalAlignment, gmf_all_gmfgraph_GridLayoutData_grabExcessVerticalSpace}
...
gmf_all_gmfgraph_BorderLayoutData.attributes={gmf_all_gmfgraph_BorderLayoutData_alignment, gmf_all_gmfgraph_BorderLayoutData_vertical}
...
gmf_all_gmfgraph_GridLayout.attributes={gmf_all_gmfgraph_GridLayout_equalWidth, gmf_all_gmfgraph_GridLayout_numColumns}
...
gmf_all_gmfgraph_Rectangle2D.attributes={gmf_all_gmfgraph_Rectangle2D_height, gmf_all_gmfgraph_Rectangle2D_x, gmf_all_gmfgraph_Rectangle2D_y, gmf_all_gmfgraph_Rectangle2D_width}
...
gmf_all_gmfgraph_FlowLayout.attributes={gmf_all_gmfgraph_FlowLayout_matchMinorSize, gmf_all_gmfgraph_FlowLayout_vertical, gmf_all_gmfgraph_FlowLayout_forceSingleLine, gmf_all_gmfgraph_FlowLayout_majorSpacing, gmf_all_gmfgraph_FlowLayout_minorAlignment, gmf_all_gmfgraph_FlowLayout_minorSpacing, gmf_all_gmfgraph_FlowLayout_majorAlignment}
...
gmf_all_gmfgraph_SVGFigure.attributes={gmf_all_gmfgraph_SVGFigure_noCanvasHeight, gmf_all_gmfgraph_SVGFigure_documentURI, gmf_all_gmfgraph_SVGFigure_noCanvasWidth}
...
gmf_all_gmfgraph_SVGProperty.attributes={gmf_all_gmfgraph_SVGProperty_type, gmf_all_gmfgraph_SVGProperty_getter, gmf_all_gmfgraph_SVGProperty_setter, gmf_all_gmfgraph_SVGProperty_query, gmf_all_gmfgraph_SVGProperty_attribute, gmf_all_gmfgraph_SVGProperty_callSuper}
...
visualEffects20: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="VisualEffectMapping", type=gmf_all_mappings_MappingEntry, multiplicity=Multiplicity(1, 1)),
        Property(name="parentMapEntry", type=VisualEffectMapping, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
labelMappings16: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="LabelMapping", type=gmf_all_mappings_MappingEntry, multiplicity=Multiplicity(1, 1)),
        Property(name="mapEntry", type=LabelMapping, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
diagramNode37: BinaryAssociation = BinaryAssociation(
    name="diagramNode37",
    ends={
...
containmentFeature21: BinaryAssociation = BinaryAssociation(
    name="containmentFeature21",
    ends={
...
childrenFeature22: BinaryAssociation = BinaryAssociation(
    name="childrenFeature22",
    ends={
        Property(name="mappings_gmf_all_EReference23", type=gmf_all_mappings_NodeReference, multiplicity=Multiplicity(1, 1)),
...
child24: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="gmf_all_mappings_NodeReference25", type=NodeMapping, multiplicity=Multiplicity(0, 1))
    }
)
parentNode26: BinaryAssociation = BinaryAssociation(
    name="parentNode26",
    ends={
        Property(name="NodeMapping27", type=gmf_all_mappings_ChildReference, multiplicity=Multiplicity(1, 1)),
        Property(name="children", type=NodeMapping, multiplicity=Multiplicity(1, 1))
    }
)
compartment28: BinaryAssociation = BinaryAssociation(
    name="compartment28",
    ends={
        Property(name="CompartmentMapping", type=gmf_all_mappings_ChildReference, multiplicity=Multiplicity(1, 1)),
        Property(name="children29", type=CompartmentMapping, multiplicity=Multiplicity(0, 1))
    }
)
ownedChild30: BinaryAssociation = BinaryAssociation(
    name="ownedChild30",
    ends={
        Property(name="NodeMapping31", type=gmf_all_mappings_ChildReference, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_mappings_ChildReference", type=NodeMapping, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
referencedChild32: BinaryAssociation = BinaryAssociation(
    name="referencedChild32",
    ends={
        Property(name="NodeMapping34", type=gmf_all_mappings_ChildReference, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_mappings_ChildReference33", type=NodeMapping, multiplicity=Multiplicity(0, 1))
    }
)
ownedChild35: BinaryAssociation = BinaryAssociation(
    name="ownedChild35",
    ends={
        Property(name="NodeMapping36", type=gmf_all_mappings_TopNodeReference, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_mappings_TopNodeReference", type=NodeMapping, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
domainModel55: BinaryAssociation = BinaryAssociation(
    name="domainModel55",
    ends={
        Property(name="mappings_gmf_all_EPackage", type=gmf_all_mappings_CanvasMapping, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_mappings_CanvasMapping56", type=mappings_gmf_all_EPackage, multiplicity=Multiplicity(0, 1))
    }
)
domainMetaElement57: BinaryAssociation = BinaryAssociation(
    name="domainMetaElement57",
    ends={
        Property(name="mappings_gmf_all_EClass59", type=gmf_all_mappings_CanvasMapping, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_mappings_CanvasMapping58", type=mappings_gmf_all_EClass, multiplicity=Multiplicity(0, 1))
    }
)
palette60: BinaryAssociation = BinaryAssociation(
    name="palette60",
    ends={
        Property(name="Palette", type=gmf_all_mappings_CanvasMapping, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_mappings_CanvasMapping61", type=Palette, multiplicity=Multiplicity(0, 1))
    }
)
children38: BinaryAssociation = BinaryAssociation(
    name="children38",
    ends={
        Property(name="ChildReference", type=gmf_all_mappings_NodeMapping, multiplicity=Multiplicity(1, 1)),
        Property(name="parentNode", type=ChildReference, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
compartments39: BinaryAssociation = BinaryAssociation(
    name="compartments39",
    ends={
        Property(name="CompartmentMapping41", type=gmf_all_mappings_NodeMapping, multiplicity=Multiplicity(1, 1)),
        Property(name="parentNode40", type=CompartmentMapping, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
compartment42: BinaryAssociation = BinaryAssociation(
    name="compartment42",
    ends={
...
parentNode43: BinaryAssociation = BinaryAssociation(
    name="parentNode43",
    ends={
        Property(name="NodeMapping44", type=gmf_all_mappings_CompartmentMapping, multiplicity=Multiplicity(1, 1)),
        Property(name="compartments", type=NodeMapping, multiplicity=Multiplicity(1, 1))
    }
)
children45: BinaryAssociation = BinaryAssociation(
    name="children45",
    ends={
        Property(name="ChildReference46", type=gmf_all_mappings_CompartmentMapping, multiplicity=Multiplicity(1, 1)),
        Property(name="compartment", type=ChildReference, multiplicity=Multiplicity(0, 9999))
    }
)
diagramLink47: BinaryAssociation = BinaryAssociation(
    name="diagramLink47",
    ends={
...
sourceMetaFeature48: BinaryAssociation = BinaryAssociation(
    name="sourceMetaFeature48",
    ends={
        Property(name="mappings_gmf_all_EStructuralFeature", type=gmf_all_mappings_LinkMapping, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_mappings_LinkMapping49", type=mappings_gmf_all_EStructuralFeature, multiplicity=Multiplicity(0, 1))
    }
)
linkMetaFeature50: BinaryAssociation = BinaryAssociation(
    name="linkMetaFeature50",
    ends={
        Property(name="mappings_gmf_all_EStructuralFeature52", type=gmf_all_mappings_LinkMapping, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_mappings_LinkMapping51", type=mappings_gmf_all_EStructuralFeature, multiplicity=Multiplicity(0, 1))
    }
)
creationConstraints53: BinaryAssociation = BinaryAssociation(
    name="creationConstraints53",
    ends={
        Property(name="LinkConstraints", type=gmf_all_mappings_LinkMapping, multiplicity=Multiplicity(1, 1)),
        Property(name="linkMapping", type=LinkConstraints, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
diagramCanvas54: BinaryAssociation = BinaryAssociation(
    name="diagramCanvas54",
    ends={
...
itemsExpression74: BinaryAssociation = BinaryAssociation(
    name="itemsExpression74",
    ends={
        Property(name="ValueExpression", type=gmf_all_mappings_OclChoiceLabelMapping, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_mappings_OclChoiceLabelMapping75", type=ValueExpression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
menuContributions62: BinaryAssociation = BinaryAssociation(
    name="menuContributions62",
    ends={
        Property(name="MainMenu", type=gmf_all_mappings_CanvasMapping, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_mappings_CanvasMapping63", type=MainMenu, multiplicity=Multiplicity(0, 9999))
    }
)
toolbarContributions64: BinaryAssociation = BinaryAssociation(
    name="toolbarContributions64",
    ends={
        Property(name="Toolbar", type=gmf_all_mappings_CanvasMapping, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_mappings_CanvasMapping65", type=Toolbar, multiplicity=Multiplicity(0, 9999))
    }
)
diagramLabel66: BinaryAssociation = BinaryAssociation(
    name="diagramLabel66",
    ends={
...
mapEntry67: BinaryAssociation = BinaryAssociation(
    name="mapEntry67",
    ends={
        Property(name="MappingEntry", type=gmf_all_mappings_LabelMapping, multiplicity=Multiplicity(1, 1)),
        Property(name="labelMappings", type=MappingEntry, multiplicity=Multiplicity(1, 1))
    }
)
features68: BinaryAssociation = BinaryAssociation(
    name="features68",
    ends={
...
editableFeatures69: BinaryAssociation = BinaryAssociation(
    name="editableFeatures69",
    ends={
        Property(name="mappings_gmf_all_EAttribute71", type=gmf_all_mappings_FeatureLabelMapping, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_mappings_FeatureLabelMapping70", type=mappings_gmf_all_EAttribute, multiplicity=Multiplicity(0, 9999))
    }
)
feature72: BinaryAssociation = BinaryAssociation(
    name="feature72",
    ends={
        Property(name="mappings_gmf_all_EStructuralFeature73", type=gmf_all_mappings_OclChoiceLabelMapping, multiplicity=Multiplicity(1, 1)),
...
targetEnd91: BinaryAssociation = BinaryAssociation(
    name="targetEnd91",
    ends={
        Property(name="Constraint93", type=gmf_all_mappings_LinkConstraints, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_mappings_LinkConstraints92", type=Constraint, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
showExpression76: BinaryAssociation = BinaryAssociation(
    name="showExpression76",
    ends={
        Property(name="ValueExpression78", type=gmf_all_mappings_OclChoiceLabelMapping, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_mappings_OclChoiceLabelMapping77", type=ValueExpression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
viewExpression79: BinaryAssociation = BinaryAssociation(
    name="viewExpression79",
    ends={
        Property(name="ValueExpression80", type=gmf_all_mappings_ExpressionLabelMapping, multiplicity=Multiplicity(1, 1)),
...
editExpression81: BinaryAssociation = BinaryAssociation(
    name="editExpression81",
    ends={
        Property(name="ValueExpression83", type=gmf_all_mappings_ExpressionLabelMapping, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_mappings_ExpressionLabelMapping82", type=ValueExpression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
validateExpression84: BinaryAssociation = BinaryAssociation(
    name="validateExpression84",
    ends={
        Property(name="Constraint86", type=gmf_all_mappings_ExpressionLabelMapping, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_mappings_ExpressionLabelMapping85", type=Constraint, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
linkMapping87: BinaryAssociation = BinaryAssociation(
    name="linkMapping87",
    ends={
        Property(name="LinkMapping88", type=gmf_all_mappings_LinkConstraints, multiplicity=Multiplicity(1, 1)),
        Property(name="creationConstraints", type=LinkMapping, multiplicity=Multiplicity(1, 1))
    }
)
sourceEnd89: BinaryAssociation = BinaryAssociation(
    name="sourceEnd89",
    ends={
        Property(name="Constraint90", type=gmf_all_mappings_LinkConstraints, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_mappings_LinkConstraints", type=Constraint, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
feature100: BinaryAssociation = BinaryAssociation(
    name="feature100",
    ends={
        Property(name="mappings_gmf_all_EStructuralFeature101", type=gmf_all_mappings_FeatureInitializer, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_mappings_FeatureInitializer", type=mappings_gmf_all_EStructuralFeature, multiplicity=Multiplicity(1, 1))
    }
)
mappingEntry94: BinaryAssociation = BinaryAssociation(
    name="mappingEntry94",
    ends={
        Property(name="MappingEntry95", type=gmf_all_mappings_ElementInitializer, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_mappings_ElementInitializer", type=MappingEntry, multiplicity=Multiplicity(1, 1))
    }
)
initializers96: BinaryAssociation = BinaryAssociation(
    name="initializers96",
    ends={
        Property(name="FeatureInitializer", type=gmf_all_mappings_FeatureSeqInitializer, multiplicity=Multiplicity(1, 1)),
        Property(name="featureSeqInitializer", type=FeatureInitializer, multiplicity=Multiplicity(1, 9999), is_composite=True)
    }
)
elementClass97: BinaryAssociation = BinaryAssociation(
    name="elementClass97",
    ends={
        Property(name="mappings_gmf_all_EClass98", type=gmf_all_mappings_FeatureSeqInitializer, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_mappings_FeatureSeqInitializer", type=mappings_gmf_all_EClass, multiplicity=Multiplicity(0, 1))
    }
)
creatingInitializer99: BinaryAssociation = BinaryAssociation(
    name="creatingInitializer99",
    ends={
        Property(name="ReferenceNewElementSpec", type=gmf_all_mappings_FeatureSeqInitializer, multiplicity=Multiplicity(1, 1)),
        Property(name="newElementInitializers", type=ReferenceNewElementSpec, multiplicity=Multiplicity(0, 1))
    }
)
parentContainer111: BinaryAssociation = BinaryAssociation(
    name="parentContainer111",
    ends={
        Property(name="AuditContainer112", type=gmf_all_mappings_AuditContainer, multiplicity=Multiplicity(1, 1)),
        Property(name="childContainers", type=AuditContainer, multiplicity=Multiplicity(0, 1))
    }
)
audits113: BinaryAssociation = BinaryAssociation(
    name="audits113",
    ends={
        Property(name="AuditRule", type=gmf_all_mappings_AuditContainer, multiplicity=Multiplicity(1, 1)),
        Property(name="container", type=AuditRule, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
featureSeqInitializer102: BinaryAssociation = BinaryAssociation(
    name="featureSeqInitializer102",
    ends={
        Property(name="FeatureSeqInitializer", type=gmf_all_mappings_FeatureInitializer, multiplicity=Multiplicity(1, 1)),
        Property(name="initializers", type=FeatureSeqInitializer, multiplicity=Multiplicity(1, 1))
    }
)
value103: BinaryAssociation = BinaryAssociation(
    name="value103",
    ends={
        Property(name="ValueExpression104", type=gmf_all_mappings_FeatureValueSpec, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_mappings_FeatureValueSpec", type=ValueExpression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
newElementInitializers105: BinaryAssociation = BinaryAssociation(
    name="newElementInitializers105",
    ends={
        Property(name="FeatureSeqInitializer106", type=gmf_all_mappings_ReferenceNewElementSpec, multiplicity=Multiplicity(1, 1)),
        Property(name="creatingInitializer", type=FeatureSeqInitializer, multiplicity=Multiplicity(1, 9999), is_composite=True)
    }
)
contextMenu107: BinaryAssociation = BinaryAssociation(
    name="contextMenu107",
    ends={
...
tool108: BinaryAssociation = BinaryAssociation(
    name="tool108",
    ends={
...
appearanceStyle109: BinaryAssociation = BinaryAssociation(
    name="appearanceStyle109",
    ends={
        Property(name="StyleSelector110", type=gmf_all_mappings_AppearanceSteward, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_mappings_AppearanceSteward", type=StyleSelector, multiplicity=Multiplicity(0, 1))
    }
)
element122: BinaryAssociation = BinaryAssociation(
    name="element122",
    ends={
        Property(name="mappings_gmf_all_EClass123", type=gmf_all_mappings_DomainElementTarget, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_mappings_DomainElementTarget", type=mappings_gmf_all_EClass, multiplicity=Multiplicity(1, 1))
    }
)
childContainers114: BinaryAssociation = BinaryAssociation(
    name="childContainers114",
    ends={
        Property(name="AuditContainer115", type=gmf_all_mappings_AuditContainer, multiplicity=Multiplicity(1, 1)),
        Property(name="parentContainer", type=AuditContainer, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
rule116: BinaryAssociation = BinaryAssociation(
    name="rule116",
    ends={
        Property(name="Constraint117", type=gmf_all_mappings_AuditRule, multiplicity=Multiplicity(1, 1)),
...
target118: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="gmf_all_mappings_AuditRule119", type=Auditable, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
container120: BinaryAssociation = BinaryAssociation(
    name="container120",
    ends={
        Property(name="AuditContainer121", type=gmf_all_mappings_AuditRule, multiplicity=Multiplicity(1, 1)),
        Property(name="audits", type=AuditContainer, multiplicity=Multiplicity(1, 1))
    }
)
attribute124: BinaryAssociation = BinaryAssociation(
    name="attribute124",
    ends={
        Property(name="mappings_gmf_all_EAttribute125", type=gmf_all_mappings_DomainAttributeTarget, multiplicity=Multiplicity(1, 1)),
...
element126: BinaryAssociation = BinaryAssociation(
    name="element126",
    ends={
        Property(name="MappingEntry127", type=gmf_all_mappings_DiagramElementTarget, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_mappings_DiagramElementTarget", type=MappingEntry, multiplicity=Multiplicity(1, 1))
    }
)
metric138: BinaryAssociation = BinaryAssociation(
    name="metric138",
    ends={
        Property(name="MetricRule139", type=gmf_all_mappings_AuditedMetricTarget, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_mappings_AuditedMetricTarget", type=MetricRule, multiplicity=Multiplicity(1, 1))
    }
)
element128: BinaryAssociation = BinaryAssociation(
    name="element128",
    ends={
        Property(name="mappings_gmf_all_EClass129", type=gmf_all_mappings_NotationElementTarget, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_mappings_NotationElementTarget", type=mappings_gmf_all_EClass, multiplicity=Multiplicity(1, 1))
    }
)
metrics130: BinaryAssociation = BinaryAssociation(
    name="metrics130",
    ends={
        Property(name="MetricRule", type=gmf_all_mappings_MetricContainer, multiplicity=Multiplicity(1, 1)),
        Property(name="container131", type=MetricRule, multiplicity=Multiplicity(1, 9999), is_composite=True)
    }
)
rule132: BinaryAssociation = BinaryAssociation(
    name="rule132",
    ends={
        Property(name="ValueExpression133", type=gmf_all_mappings_MetricRule, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_mappings_MetricRule", type=ValueExpression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
target134: BinaryAssociation = BinaryAssociation(
    name="target134",
    ends={
        Property(name="Measurable", type=gmf_all_mappings_MetricRule, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_mappings_MetricRule135", type=Measurable, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
container136: BinaryAssociation = BinaryAssociation(
    name="container136",
    ends={
        Property(name="MetricContainer137", type=gmf_all_mappings_MetricRule, multiplicity=Multiplicity(1, 1)),
        Property(name="metrics", type=MetricContainer, multiplicity=Multiplicity(1, 1))
    }
)
tools153: BinaryAssociation = BinaryAssociation(
    name="tools153",
    ends={
        Property(name="AbstractTool154", type=gmf_all_tooldef_ToolContainer, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_tooldef_ToolContainer", type=AbstractTool, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
diagramPin140: BinaryAssociation = BinaryAssociation(
    name="diagramPin140",
    ends={
...
parentMapEntry141: BinaryAssociation = BinaryAssociation(
    name="parentMapEntry141",
    ends={
        Property(name="MappingEntry142", type=gmf_all_mappings_VisualEffectMapping, multiplicity=Multiplicity(1, 1)),
        Property(name="visualEffects", type=MappingEntry, multiplicity=Multiplicity(1, 1))
    }
)
sharedActions143: BinaryAssociation = BinaryAssociation(
    name="sharedActions143",
    ends={
...
allMenus144: BinaryAssociation = BinaryAssociation(
    name="allMenus144",
    ends={
        Property(name="Menu", type=gmf_all_tooldef_ToolRegistry, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_tooldef_ToolRegistry145", type=Menu, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
palette146: BinaryAssociation = BinaryAssociation(
    name="palette146",
    ends={
        Property(name="Palette148", type=gmf_all_tooldef_ToolRegistry, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_tooldef_ToolRegistry147", type=Palette, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
smallIcon149: BinaryAssociation = BinaryAssociation(
    name="smallIcon149",
    ends={
...
largeIcon150: BinaryAssociation = BinaryAssociation(
    name="largeIcon150",
    ends={
        Property(name="Image152", type=gmf_all_tooldef_AbstractTool, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_tooldef_AbstractTool151", type=Image, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
item162: BinaryAssociation = BinaryAssociation(
    name="item162",
    ends={
        Property(name="ItemBase163", type=gmf_all_tooldef_ItemRef, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_tooldef_ItemRef", type=ItemBase, multiplicity=Multiplicity(1, 1))
    }
)
active155: BinaryAssociation = BinaryAssociation(
    name="active155",
    ends={
        Property(name="AbstractTool156", type=gmf_all_tooldef_ToolGroup, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_tooldef_ToolGroup", type=AbstractTool, multiplicity=Multiplicity(0, 1))
    }
)
default157: BinaryAssociation = BinaryAssociation(
    name="default157",
    ends={
        Property(name="AbstractTool158", type=gmf_all_tooldef_Palette, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_tooldef_Palette", type=AbstractTool, multiplicity=Multiplicity(0, 1))
    }
)
items159: BinaryAssociation = BinaryAssociation(
    name="items159",
    ends={
...
icon160: BinaryAssociation = BinaryAssociation(
    name="icon160",
    ends={
        Property(name="Image161", type=gmf_all_tooldef_ContributionItem, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_tooldef_ContributionItem", type=Image, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
default164: BinaryAssociation = BinaryAssociation(
    name="default164",
    ends={
        Property(name="MenuAction165", type=gmf_all_tooldef_ContextMenu, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_tooldef_ContextMenu", type=MenuAction, multiplicity=Multiplicity(0, 1))
    }
)
facets188: BinaryAssociation = BinaryAssociation(
    name="facets188",
    ends={
        Property(name="VisualFacet", type=gmf_all_gmfgraph_DiagramElement, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_DiagramElement189", type=VisualFacet, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
figures166: BinaryAssociation = BinaryAssociation(
    name="figures166",
    ends={
...
nodes167: BinaryAssociation = BinaryAssociation(
    name="nodes167",
    ends={
        Property(name="Node169", type=gmf_all_gmfgraph_Canvas, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_Canvas168", type=Node, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
connections170: BinaryAssociation = BinaryAssociation(
    name="connections170",
    ends={
        Property(name="Connection172", type=gmf_all_gmfgraph_Canvas, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_Canvas171", type=Connection, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
compartments173: BinaryAssociation = BinaryAssociation(
    name="compartments173",
    ends={
        Property(name="Compartment175", type=gmf_all_gmfgraph_Canvas, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_Canvas174", type=Compartment, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
labels176: BinaryAssociation = BinaryAssociation(
    name="labels176",
    ends={
        Property(name="DiagramLabel178", type=gmf_all_gmfgraph_Canvas, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_Canvas177", type=DiagramLabel, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
figures179: BinaryAssociation = BinaryAssociation(
    name="figures179",
    ends={
...
descriptors180: BinaryAssociation = BinaryAssociation(
    name="descriptors180",
    ends={
        Property(name="FigureDescriptor", type=gmf_all_gmfgraph_FigureGallery, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_FigureGallery181", type=FigureDescriptor, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
borders182: BinaryAssociation = BinaryAssociation(
    name="borders182",
    ends={
        Property(name="Border", type=gmf_all_gmfgraph_FigureGallery, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_FigureGallery183", type=Border, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
layouts184: BinaryAssociation = BinaryAssociation(
    name="layouts184",
    ends={
        Property(name="Layout", type=gmf_all_gmfgraph_FigureGallery, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_FigureGallery185", type=Layout, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
figure186: BinaryAssociation = BinaryAssociation(
    name="figure186",
    ends={
        Property(name="FigureDescriptor187", type=gmf_all_gmfgraph_DiagramElement, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_DiagramElement", type=FigureDescriptor, multiplicity=Multiplicity(1, 1))
    }
)
defaultSize198: BinaryAssociation = BinaryAssociation(
    name="defaultSize198",
    ends={
...
descriptor199: BinaryAssociation = BinaryAssociation(
    name="descriptor199",
    ends={
        Property(name="FigureDescriptor200", type=gmf_all_gmfgraph_Figure, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_Figure", type=FigureDescriptor, multiplicity=Multiplicity(0, 1))
    }
)
contentPane190: BinaryAssociation = BinaryAssociation(
    name="contentPane190",
    ends={
...
accessor191: BinaryAssociation = BinaryAssociation(
    name="accessor191",
    ends={
        Property(name="ChildAccess192", type=gmf_all_gmfgraph_Compartment, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_Compartment", type=ChildAccess, multiplicity=Multiplicity(0, 1))
    }
)
accessor193: BinaryAssociation = BinaryAssociation(
    name="accessor193",
    ends={
        Property(name="ChildAccess194", type=gmf_all_gmfgraph_DiagramLabel, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_DiagramLabel", type=ChildAccess, multiplicity=Multiplicity(0, 1))
    }
)
container195: BinaryAssociation = BinaryAssociation(
    name="container195",
    ends={
        Property(name="ChildAccess197", type=gmf_all_gmfgraph_DiagramLabel, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_DiagramLabel196", type=ChildAccess, multiplicity=Multiplicity(0, 1))
    }
)
children234: BinaryAssociation = BinaryAssociation(
    name="children234",
    ends={
        Property(name="Figure235", type=gmf_all_gmfgraph_RealFigure, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_RealFigure", type=Figure, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
foregroundColor201: BinaryAssociation = BinaryAssociation(
    name="foregroundColor201",
    ends={
        Property(name="Color", type=gmf_all_gmfgraph_Figure, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_Figure202", type=Color, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
backgroundColor203: BinaryAssociation = BinaryAssociation(
    name="backgroundColor203",
    ends={
        Property(name="Color205", type=gmf_all_gmfgraph_Figure, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_Figure204", type=Color, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
maximumSize206: BinaryAssociation = BinaryAssociation(
    name="maximumSize206",
    ends={
        Property(name="Dimension208", type=gmf_all_gmfgraph_Figure, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_Figure207", type=Dimension, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
minimumSize209: BinaryAssociation = BinaryAssociation(
    name="minimumSize209",
    ends={
        Property(name="Dimension211", type=gmf_all_gmfgraph_Figure, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_Figure210", type=Dimension, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
preferredSize212: BinaryAssociation = BinaryAssociation(
    name="preferredSize212",
    ends={
        Property(name="Dimension214", type=gmf_all_gmfgraph_Figure, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_Figure213", type=Dimension, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
font215: BinaryAssociation = BinaryAssociation(
    name="font215",
    ends={
        Property(name="Font", type=gmf_all_gmfgraph_Figure, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_Figure216", type=Font, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
insets217: BinaryAssociation = BinaryAssociation(
    name="insets217",
    ends={
        Property(name="Insets", type=gmf_all_gmfgraph_Figure, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_Figure218", type=Insets, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
border219: BinaryAssociation = BinaryAssociation(
    name="border219",
    ends={
        Property(name="Border221", type=gmf_all_gmfgraph_Figure, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_Figure220", type=Border, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
location222: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="gmf_all_gmfgraph_Figure223", type=Point, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
size224: BinaryAssociation = BinaryAssociation(
    name="size224",
    ends={
        Property(name="Point226", type=gmf_all_gmfgraph_Figure, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_Figure225", type=Point, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
actualFigure227: BinaryAssociation = BinaryAssociation(
    name="actualFigure227",
    ends={
...
accessors228: BinaryAssociation = BinaryAssociation(
    name="accessors228",
    ends={
        Property(name="ChildAccess229", type=gmf_all_gmfgraph_FigureDescriptor, multiplicity=Multiplicity(1, 1)),
        Property(name="owner", type=ChildAccess, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
owner230: BinaryAssociation = BinaryAssociation(
    name="owner230",
    ends={
        Property(name="FigureDescriptor231", type=gmf_all_gmfgraph_ChildAccess, multiplicity=Multiplicity(1, 1)),
        Property(name="accessors", type=FigureDescriptor, multiplicity=Multiplicity(1, 1))
    }
)
figure232: BinaryAssociation = BinaryAssociation(
    name="figure232",
    ends={
        Property(name="Figure233", type=gmf_all_gmfgraph_ChildAccess, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_ChildAccess", type=Figure, multiplicity=Multiplicity(1, 1))
    }
)
figure236: BinaryAssociation = BinaryAssociation(
    name="figure236",
    ends={
        Property(name="RealFigure237", type=gmf_all_gmfgraph_FigureRef, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_FigureRef", type=RealFigure, multiplicity=Multiplicity(1, 1))
    }
)
resolvedChildren238: BinaryAssociation = BinaryAssociation(
    name="resolvedChildren238",
    ends={
        Property(name="Figure239", type=gmf_all_gmfgraph_Shape, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_Shape", type=Figure, multiplicity=Multiplicity(0, 9999))
    }
)
typedFigure247: BinaryAssociation = BinaryAssociation(
    name="typedFigure247",
    ends={
        Property(name="RealFigure248", type=gmf_all_gmfgraph_FigureAccessor, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_FigureAccessor", type=RealFigure, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
template240: BinaryAssociation = BinaryAssociation(
    name="template240",
    ends={
        Property(name="Point241", type=gmf_all_gmfgraph_Polyline, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_Polyline", type=Point, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
sourceDecoration242: BinaryAssociation = BinaryAssociation(
    name="sourceDecoration242",
    ends={
...
targetDecoration243: BinaryAssociation = BinaryAssociation(
    name="targetDecoration243",
    ends={
        Property(name="DecorationFigure245", type=gmf_all_gmfgraph_PolylineConnection, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_PolylineConnection244", type=DecorationFigure, multiplicity=Multiplicity(0, 1))
    }
)
attributes246: BinaryAssociation = BinaryAssociation(
    name="attributes246",
    ends={
...
customChildren249: BinaryAssociation = BinaryAssociation(
    name="customChildren249",
    ends={
...
owner261: BinaryAssociation = BinaryAssociation(
    name="owner261",
    ends={
        Property(name="Layoutable", type=gmf_all_gmfgraph_LayoutData, multiplicity=Multiplicity(1, 1)),
        Property(name="layoutData", type=Layoutable, multiplicity=Multiplicity(1, 1))
    }
)
actual250: BinaryAssociation = BinaryAssociation(
    name="actual250",
    ends={
        Property(name="Border251", type=gmf_all_gmfgraph_BorderRef, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_BorderRef", type=Border, multiplicity=Multiplicity(1, 1))
    }
)
color252: BinaryAssociation = BinaryAssociation(
    name="color252",
    ends={
        Property(name="Color253", type=gmf_all_gmfgraph_LineBorder, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_LineBorder", type=Color, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
insets254: BinaryAssociation = BinaryAssociation(
    name="insets254",
    ends={
        Property(name="Insets255", type=gmf_all_gmfgraph_MarginBorder, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_MarginBorder", type=Insets, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
outer256: BinaryAssociation = BinaryAssociation(
    name="outer256",
    ends={
        Property(name="Border257", type=gmf_all_gmfgraph_CompoundBorder, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_CompoundBorder", type=Border, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
inner258: BinaryAssociation = BinaryAssociation(
    name="inner258",
    ends={
        Property(name="Border260", type=gmf_all_gmfgraph_CompoundBorder, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_CompoundBorder259", type=Border, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
margins270: BinaryAssociation = BinaryAssociation(
    name="margins270",
    ends={
        Property(name="Dimension271", type=gmf_all_gmfgraph_GridLayout, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_GridLayout", type=Dimension, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
spacing272: BinaryAssociation = BinaryAssociation(
    name="spacing272",
    ends={
        Property(name="Dimension274", type=gmf_all_gmfgraph_GridLayout, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_GridLayout273", type=Dimension, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
spacing275: BinaryAssociation = BinaryAssociation(
    name="spacing275",
    ends={
        Property(name="Dimension276", type=gmf_all_gmfgraph_BorderLayout, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_BorderLayout", type=Dimension, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
sizeHint262: BinaryAssociation = BinaryAssociation(
    name="sizeHint262",
    ends={
        Property(name="Dimension263", type=gmf_all_gmfgraph_GridLayoutData, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_GridLayoutData", type=Dimension, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
layoutData264: BinaryAssociation = BinaryAssociation(
    name="layoutData264",
    ends={
        Property(name="LayoutData", type=gmf_all_gmfgraph_Layoutable, multiplicity=Multiplicity(1, 1)),
        Property(name="owner265", type=LayoutData, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
layout266: BinaryAssociation = BinaryAssociation(
    name="layout266",
    ends={
        Property(name="Layout267", type=gmf_all_gmfgraph_Layoutable, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_Layoutable", type=Layout, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
actual268: BinaryAssociation = BinaryAssociation(
    name="actual268",
    ends={
        Property(name="Layout269", type=gmf_all_gmfgraph_LayoutRef, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_LayoutRef", type=Layout, multiplicity=Multiplicity(1, 1))
    }
)
topLeft277: BinaryAssociation = BinaryAssociation(
    name="topLeft277",
    ends={
        Property(name="Point278", type=gmf_all_gmfgraph_XYLayoutData, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_XYLayoutData", type=Point, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
size279: BinaryAssociation = BinaryAssociation(
    name="size279",
    ends={
        Property(name="Dimension281", type=gmf_all_gmfgraph_XYLayoutData, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_XYLayoutData280", type=Dimension, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
properties282: BinaryAssociation = BinaryAssociation(
    name="properties282",
    ends={
...
areaOfInterest283: BinaryAssociation = BinaryAssociation(
    name="areaOfInterest283",
    ends={
        Property(name="Rectangle2D", type=gmf_all_gmfgraph_SVGFigure, multiplicity=Multiplicity(1, 1)),
        Property(name="gmf_all_gmfgraph_SVGFigure284", type=Rectangle2D, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
pins285: BinaryAssociation = BinaryAssociation(
    name="pins285",
    ends={
        Property(name="Pin286", type=gmf_all_gmfgraph_PinOwner, multiplicity=Multiplicity(1, 1)),
...
domain_model = DomainModel(
    name="gmf_all",
    types={gmf_all_mappings_Mapping, TopNodeReference, VisualEffectMapping, gmf_all_mappings_NeedsContainment, mappings_gmf_all_EReference, LinkMapping, CanvasMapping, StyleSelector, AuditContainer, MetricContainer, gmf_all_mappings_MappingEntry, mappings_gmf_all_EClass, Constraint, ElementInitializer, LabelMapping, gmf_all_mappings_NodeMapping, mappings_MappingEntry, mappings_MenuOwner, mappings_ToolOwner, mappings_AppearanceSteward, Node, gmf_all_mappings_NodeReference, NeedsContainment, NodeMapping, gmf_all_mappings_ChildReference, NodeReference, CompartmentMapping, gmf_all_mappings_TopNodeReference, mappings_gmf_all_EPackage, Palette, ChildReference, gmf_all_mappings_CompartmentMapping, Compartment, gmf_all_mappings_LinkMapping, mappings_NeedsContainment, Connection, mappings_gmf_all_EStructuralFeature, LinkConstraints, gmf_all_mappings_CanvasMapping, Canvas, ValueExpression, MainMenu, Toolbar, gmf_all_mappings_LabelMapping, DiagramLabel, MappingEntry, gmf_all_mappings_FeatureLabelMapping, mappings_gmf_all_EAttribute, gmf_all_mappings_OclChoiceLabelMapping, gmf_all_mappings_DesignLabelMapping, gmf_all_mappings_ExpressionLabelMapping, gmf_all_mappings_Constraint, gmf_all_mappings_LinkConstraints, gmf_all_mappings_FeatureInitializer, gmf_all_mappings_ValueExpression, gmf_all_mappings_ElementInitializer, gmf_all_mappings_FeatureSeqInitializer, FeatureInitializer, ReferenceNewElementSpec, AuditRule, FeatureSeqInitializer, gmf_all_mappings_FeatureValueSpec, gmf_all_mappings_ReferenceNewElementSpec, gmf_all_mappings_MenuOwner, ContextMenu, gmf_all_mappings_ToolOwner, AbstractTool, gmf_all_mappings_AppearanceSteward, gmf_all_mappings_AuditContainer, gmf_all_mappings_DomainAttributeTarget, gmf_all_mappings_RuleBase, gmf_all_mappings_AuditRule, RuleBase, Auditable, gmf_all_mappings_DomainElementTarget, mappings_Auditable, mappings_Measurable, gmf_all_mappings_NotationElementTarget, gmf_all_mappings_DiagramElementTarget, gmf_all_mappings_MetricContainer, MetricRule, gmf_all_mappings_MetricRule, Measurable, gmf_all_mappings_AuditedMetricTarget, gmf_all_tooldef_PaletteSeparator, gmf_all_tooldef_ToolGroup, ToolContainer, gmf_all_mappings_Auditable, gmf_all_mappings_Measurable, gmf_all_mappings_VisualEffectMapping, Pin, gmf_all_tooldef_ToolRegistry, MenuAction, Menu, gmf_all_tooldef_AbstractTool, Image, gmf_all_tooldef_ToolContainer, gmf_all_tooldef_MenuAction, ContributionItem, gmf_all_tooldef_ItemRef, gmf_all_tooldef_Palette, gmf_all_tooldef_StandardTool, gmf_all_tooldef_CreationTool, gmf_all_tooldef_GenericTool, gmf_all_tooldef_ItemBase, gmf_all_tooldef_Menu, ItemBase, gmf_all_tooldef_Separator, gmf_all_tooldef_PredefinedItem, gmf_all_tooldef_PredefinedMenu, tooldef_Menu, tooldef_PredefinedItem, gmf_all_tooldef_ContributionItem, gmf_all_gmfgraph_Canvas, Identity, gmf_all_tooldef_ContextMenu, gmf_all_tooldef_PopupMenu, tooldef_ContributionItem, gmf_all_tooldef_MainMenu, gmf_all_tooldef_Toolbar, gmf_all_tooldef_Image, gmf_all_tooldef_DefaultImage, gmf_all_tooldef_BundleImage, gmf_all_tooldef_StyleSelector, gmf_all_tooldef_GenericStyleSelector, gmf_all_gmfgraph_AbstractNode, DiagramElement, gmf_all_gmfgraph_Node, AbstractNode, FigureGallery, gmf_all_gmfgraph_FigureGallery, RealFigure, FigureDescriptor, Border, Layout, gmf_all_gmfgraph_Identity, gmf_all_gmfgraph_DiagramElement, VisualFacet, gmf_all_gmfgraph_Figure, Layoutable, ChildAccess, gmf_all_gmfgraph_Connection, gmf_all_gmfgraph_Compartment, gmf_all_gmfgraph_DiagramLabel, gmf_all_gmfgraph_VisualFacet, gmf_all_gmfgraph_GeneralFacet, gmf_all_gmfgraph_AlignmentFacet, gmf_all_gmfgraph_GradientFacet, gmf_all_gmfgraph_LabelOffsetFacet, gmf_all_gmfgraph_DefaultSizeFacet, Dimension, gmf_all_gmfgraph_RealFigure, gmfgraph_AbstractFigure, gmfgraph_PinOwner, gmfgraph_CustomAttributeOwner, Color, Font, Insets, Point, gmf_all_gmfgraph_AbstractFigure, Figure, gmf_all_gmfgraph_FigureDescriptor, gmf_all_gmfgraph_ChildAccess, gmf_all_gmfgraph_Ellipse, gmf_all_gmfgraph_Polyline, gmf_all_gmfgraph_FigureRef, AbstractFigure, gmf_all_gmfgraph_ConnectionFigure, gmf_all_gmfgraph_DecorationFigure, gmf_all_gmfgraph_Shape, gmf_all_gmfgraph_Label, gmf_all_gmfgraph_LabeledContainer, gmf_all_gmfgraph_VerticalLabel, gmf_all_gmfgraph_Rectangle, Shape, gmf_all_gmfgraph_InvisibleRectangle, gmf_all_gmfgraph_RoundedRectangle, gmf_all_gmfgraph_CustomFigure, gmfgraph_RealFigure, gmfgraph_CustomClass, gmf_all_gmfgraph_Polygon, Polyline, gmf_all_gmfgraph_ScalablePolygon, Polygon, gmf_all_gmfgraph_PolylineConnection, gmfgraph_Polyline, gmfgraph_ConnectionFigure, DecorationFigure, gmf_all_gmfgraph_PolylineDecoration, gmfgraph_DecorationFigure, gmf_all_gmfgraph_PolygonDecoration, gmfgraph_Polygon, gmf_all_gmfgraph_CustomAttributeOwner, CustomAttribute, gmf_all_gmfgraph_CustomClass, CustomAttributeOwner, gmf_all_gmfgraph_CustomAttribute, gmf_all_gmfgraph_FigureAccessor, gmf_all_gmfgraph_Dimension, gmf_all_gmfgraph_Insets, FigureAccessor, gmf_all_gmfgraph_CustomDecoration, gmfgraph_CustomFigure, gmf_all_gmfgraph_CustomConnection, gmf_all_gmfgraph_Color, gmf_all_gmfgraph_RGBColor, gmf_all_gmfgraph_ConstantColor, gmf_all_gmfgraph_Font, gmf_all_gmfgraph_BasicFont, gmf_all_gmfgraph_Point, gmf_all_gmfgraph_LayoutData, gmf_all_gmfgraph_CustomLayoutData, gmfgraph_LayoutData, gmf_all_gmfgraph_Border, gmf_all_gmfgraph_BorderRef, gmf_all_gmfgraph_LineBorder, gmf_all_gmfgraph_MarginBorder, gmf_all_gmfgraph_CompoundBorder, gmf_all_gmfgraph_CustomBorder, gmfgraph_Border, gmf_all_gmfgraph_BorderLayout, gmf_all_gmfgraph_GridLayoutData, LayoutData, gmf_all_gmfgraph_BorderLayoutData, gmf_all_gmfgraph_Layoutable, gmf_all_gmfgraph_Layout, gmf_all_gmfgraph_LayoutRef, gmf_all_gmfgraph_CustomLayout, gmfgraph_Layout, gmf_all_gmfgraph_GridLayout, gmf_all_gmfgraph_Rectangle2D, gmf_all_gmfgraph_Pin, gmf_all_gmfgraph_FlowLayout, gmf_all_gmfgraph_XYLayout, gmf_all_gmfgraph_XYLayoutData, gmf_all_gmfgraph_StackLayout, gmf_all_gmfgraph_CenterLayout, gmf_all_gmfgraph_SVGFigure, SVGProperty, Rectangle2D, gmf_all_gmfgraph_SVGProperty, gmf_all_gmfgraph_CustomPin, gmf_all_gmfgraph_ColorPin, gmf_all_gmfgraph_VisiblePin, gmf_all_gmfgraph_PinOwner, LabelTextAccessMethod, Severity, Language, StandardToolKind, ActionKind, AppearanceStyle, ColorConstants, FontStyle, Direction, LineKind, Alignment, SVGPropertyType},
    associations={relatedDiagrams17, visualEffects20, nodes0, links1, diagram3, appearanceStyles5, audits7, metrics9, domainMetaElement11, domainSpecialization12, domainInitializer14, labelMappings16, diagramNode37, containmentFeature21, childrenFeature22, child24, parentNode26, compartment28, ownedChild30, referencedChild32, ownedChild35, domainModel55, domainMetaElement57, palette60, children38, compartments39, compartment42, parentNode43, children45, diagramLink47, sourceMetaFeature48, linkMetaFeature50, creationConstraints53, diagramCanvas54, itemsExpression74, menuContributions62, toolbarContributions64, diagramLabel66, mapEntry67, features68, editableFeatures69, feature72, targetEnd91, showExpression76, viewExpression79, editExpression81, validateExpression84, linkMapping87, sourceEnd89, feature100, mappingEntry94, initializers96, elementClass97, creatingInitializer99, parentContainer111, audits113, featureSeqInitializer102, value103, newElementInitializers105, contextMenu107, tool108, appearanceStyle109, element122, childContainers114, rule116, target118, container120, attribute124, element126, metric138, element128, metrics130, rule132, target134, container136, tools153, diagramPin140, parentMapEntry141, sharedActions143, allMenus144, palette146, smallIcon149, largeIcon150, item162, active155, default157, items159, icon160, default164, facets188, figures166, nodes167, connections170, compartments173, labels176, figures179, descriptors180, borders182, layouts184, figure186, defaultSize198, descriptor199, contentPane190, accessor191, accessor193, container195, children234, foregroundColor201, backgroundColor203, maximumSize206, minimumSize209, preferredSize212, font215, insets217, border219, location222, size224, actualFigure227, accessors228, owner230, figure232, figure236, resolvedChildren238, typedFigure247, template240, sourceDecoration242, targetDecoration243, attributes246, customChildren249, owner261, actual250, color252, insets254, outer256, inner258, margins270, spacing272, spacing275, sizeHint262, layoutData264, layout266, actual268, topLeft277, size279, properties282, areaOfInterest283, pins285},
    generalizations={gen_gmf_all_mappings_NodeMapping_mappings_MappingEntry, gen_gmf_all_mappings_NodeMapping_mappings_MenuOwner, gen_gmf_all_mappings_NodeMapping_mappings_ToolOwner, gen_gmf_all_mappings_NodeMapping_mappings_AppearanceSteward, gen_gmf_all_mappings_NodeReference_NeedsContainment, gen_gmf_all_mappings_ChildReference_NodeReference, gen_gmf_all_mappings_TopNodeReference_NodeReference, gen_gmf_all_mappings_LinkMapping_mappings_MappingEntry, gen_gmf_all_mappings_LinkMapping_mappings_NeedsContainment, gen_gmf_all_mappings_LinkMapping_mappings_MenuOwner, gen_gmf_all_mappings_LinkMapping_mappings_ToolOwner, gen_gmf_all_mappings_LinkMapping_mappings_AppearanceSteward, gen_gmf_all_mappings_FeatureLabelMapping_LabelMapping, gen_gmf_all_mappings_OclChoiceLabelMapping_LabelMapping, gen_gmf_all_mappings_DesignLabelMapping_LabelMapping, gen_gmf_all_mappings_ExpressionLabelMapping_LabelMapping, gen_gmf_all_mappings_Constraint_ValueExpression, gen_gmf_all_mappings_FeatureSeqInitializer_ElementInitializer, gen_gmf_all_mappings_FeatureValueSpec_FeatureInitializer, gen_gmf_all_mappings_ReferenceNewElementSpec_FeatureInitializer, gen_gmf_all_mappings_DomainAttributeTarget_Auditable, gen_gmf_all_mappings_AuditRule_RuleBase, gen_gmf_all_mappings_DomainElementTarget_mappings_Auditable, gen_gmf_all_mappings_DomainElementTarget_mappings_Measurable, gen_gmf_all_mappings_NotationElementTarget_mappings_Auditable, gen_gmf_all_mappings_NotationElementTarget_mappings_Measurable, gen_gmf_all_mappings_DiagramElementTarget_mappings_Auditable, gen_gmf_all_mappings_DiagramElementTarget_mappings_Measurable, gen_gmf_all_mappings_MetricRule_RuleBase, gen_gmf_all_mappings_AuditedMetricTarget_Auditable, gen_gmf_all_tooldef_PaletteSeparator_AbstractTool, gen_gmf_all_tooldef_ToolGroup_ToolContainer, gen_gmf_all_tooldef_ToolContainer_AbstractTool, gen_gmf_all_tooldef_MenuAction_ContributionItem, gen_gmf_all_tooldef_ItemRef_ItemBase, gen_gmf_all_tooldef_Palette_ToolContainer, gen_gmf_all_tooldef_StandardTool_AbstractTool, gen_gmf_all_tooldef_CreationTool_AbstractTool, gen_gmf_all_tooldef_GenericTool_AbstractTool, gen_gmf_all_tooldef_Separator_ItemBase, gen_gmf_all_tooldef_PredefinedItem_ItemBase, gen_gmf_all_tooldef_PredefinedMenu_tooldef_Menu, gen_gmf_all_tooldef_PredefinedMenu_tooldef_PredefinedItem, gen_gmf_all_tooldef_ContributionItem_ItemBase, gen_gmf_all_tooldef_ContextMenu_Menu, gen_gmf_all_tooldef_PopupMenu_tooldef_Menu, gen_gmf_all_tooldef_PopupMenu_tooldef_ContributionItem, gen_gmf_all_tooldef_MainMenu_Menu, gen_gmf_all_tooldef_Toolbar_Menu, gen_gmf_all_tooldef_DefaultImage_Image, gen_gmf_all_tooldef_BundleImage_Image, gen_gmf_all_tooldef_GenericStyleSelector_StyleSelector, gen_gmf_all_gmfgraph_AbstractNode_DiagramElement, gen_gmf_all_gmfgraph_Node_AbstractNode, gen_gmf_all_gmfgraph_Canvas_Identity, gen_gmf_all_gmfgraph_FigureGallery_Identity, gen_gmf_all_gmfgraph_DiagramElement_Identity, gen_gmf_all_gmfgraph_Figure_Layoutable, gen_gmf_all_gmfgraph_Connection_DiagramElement, gen_gmf_all_gmfgraph_Compartment_DiagramElement, gen_gmf_all_gmfgraph_DiagramLabel_Node, gen_gmf_all_gmfgraph_GeneralFacet_VisualFacet, gen_gmf_all_gmfgraph_AlignmentFacet_VisualFacet, gen_gmf_all_gmfgraph_GradientFacet_VisualFacet, gen_gmf_all_gmfgraph_LabelOffsetFacet_VisualFacet, gen_gmf_all_gmfgraph_DefaultSizeFacet_VisualFacet, gen_gmf_all_gmfgraph_RealFigure_gmfgraph_AbstractFigure, gen_gmf_all_gmfgraph_RealFigure_gmfgraph_PinOwner, gen_gmf_all_gmfgraph_RealFigure_gmfgraph_CustomAttributeOwner, gen_gmf_all_gmfgraph_AbstractFigure_Figure, gen_gmf_all_gmfgraph_FigureDescriptor_Identity, gen_gmf_all_gmfgraph_Ellipse_Shape, gen_gmf_all_gmfgraph_Polyline_Shape, gen_gmf_all_gmfgraph_FigureRef_AbstractFigure, gen_gmf_all_gmfgraph_ConnectionFigure_RealFigure, gen_gmf_all_gmfgraph_DecorationFigure_RealFigure, gen_gmf_all_gmfgraph_Shape_RealFigure, gen_gmf_all_gmfgraph_Label_RealFigure, gen_gmf_all_gmfgraph_LabeledContainer_RealFigure, gen_gmf_all_gmfgraph_VerticalLabel_RealFigure, gen_gmf_all_gmfgraph_Rectangle_Shape, gen_gmf_all_gmfgraph_InvisibleRectangle_RealFigure, gen_gmf_all_gmfgraph_RoundedRectangle_Shape, gen_gmf_all_gmfgraph_CustomFigure_gmfgraph_RealFigure, gen_gmf_all_gmfgraph_CustomFigure_gmfgraph_CustomClass, gen_gmf_all_gmfgraph_Polygon_Polyline, gen_gmf_all_gmfgraph_ScalablePolygon_Polygon, gen_gmf_all_gmfgraph_PolylineConnection_gmfgraph_Polyline, gen_gmf_all_gmfgraph_PolylineConnection_gmfgraph_ConnectionFigure, gen_gmf_all_gmfgraph_PolylineDecoration_gmfgraph_Polyline, gen_gmf_all_gmfgraph_PolylineDecoration_gmfgraph_DecorationFigure, gen_gmf_all_gmfgraph_PolygonDecoration_gmfgraph_Polygon, gen_gmf_all_gmfgraph_PolygonDecoration_gmfgraph_DecorationFigure, gen_gmf_all_gmfgraph_CustomClass_CustomAttributeOwner, gen_gmf_all_gmfgraph_CustomDecoration_gmfgraph_CustomFigure, gen_gmf_all_gmfgraph_CustomDecoration_gmfgraph_DecorationFigure, gen_gmf_all_gmfgraph_CustomConnection_gmfgraph_CustomFigure, gen_gmf_all_gmfgraph_CustomConnection_gmfgraph_ConnectionFigure, gen_gmf_all_gmfgraph_RGBColor_Color, gen_gmf_all_gmfgraph_ConstantColor_Color, gen_gmf_all_gmfgraph_BasicFont_Font, gen_gmf_all_gmfgraph_CustomLayoutData_gmfgraph_LayoutData, gen_gmf_all_gmfgraph_CustomLayoutData_gmfgraph_CustomClass, gen_gmf_all_gmfgraph_BorderRef_Border, gen_gmf_all_gmfgraph_LineBorder_Border, gen_gmf_all_gmfgraph_MarginBorder_Border, gen_gmf_all_gmfgraph_CompoundBorder_Border, gen_gmf_all_gmfgraph_CustomBorder_gmfgraph_Border, gen_gmf_all_gmfgraph_CustomBorder_gmfgraph_CustomClass, gen_gmf_all_gmfgraph_BorderLayout_Layout, gen_gmf_all_gmfgraph_GridLayoutData_LayoutData, gen_gmf_all_gmfgraph_BorderLayoutData_LayoutData, gen_gmf_all_gmfgraph_LayoutRef_Layout, gen_gmf_all_gmfgraph_CustomLayout_gmfgraph_Layout, gen_gmf_all_gmfgraph_CustomLayout_gmfgraph_CustomClass, gen_gmf_all_gmfgraph_GridLayout_Layout, gen_gmf_all_gmfgraph_Pin_Identity, gen_gmf_all_gmfgraph_FlowLayout_Layout, gen_gmf_all_gmfgraph_XYLayout_Layout, gen_gmf_all_gmfgraph_XYLayoutData_LayoutData, gen_gmf_all_gmfgraph_StackLayout_Layout, gen_gmf_all_gmfgraph_CenterLayout_Layout, gen_gmf_all_gmfgraph_SVGFigure_RealFigure, gen_gmf_all_gmfgraph_CustomPin_Pin, gen_gmf_all_gmfgraph_ColorPin_Pin, gen_gmf_all_gmfgraph_VisiblePin_Pin},
    metadata=None
)
