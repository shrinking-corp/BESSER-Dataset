...
class uma_Ellipse(GraphicPrimitive):
    ...
    def __init__(self, startAngle: str, endAngle: str, radiusX: str, radiusY: str, rotation: str, uma_Ellipse: "uma_Point" = None):
...
class uma_Property(DiagramElement):
    ...
    def __init__(self, value: str, key: str, uma_Property: "uma_DiagramElement" = None):
        self.value = value
        self.key = key
...
class uma_DiagramLink(DiagramElement):
    ...
    def __init__(self, zoom: str, DiagramLink: "uma_Diagram" = None, uma_DiagramLink: "uma_Point" = None, DiagramLink308: "uma_GraphElement" = None, diagramLink: "uma_Diagram" = None, link: "uma_GraphElement" = None):
        self.zoom = zoom
...
class uma_Diagram(GraphNode):
    ...
    def __init__(self, zoom: str, uma_Diagram302: "uma_Point" = None, uma_Diagram: "uma_ProcessPackage" = None, diagram: set["uma_DiagramLink"] = None, diagram300: "uma_SemanticModelBridge" = None, Diagram: "uma_DiagramLink" = None, Diagram332: "uma_SemanticModelBridge" = None):
        self.zoom = zoom
...
class uma_Point:
    ...
    def __init__(self, x: str, y: str, uma_Point: "uma_Diagram" = None, uma_Point320: "uma_DiagramLink" = None, uma_Point306: "uma_GraphElement" = None, uma_Point328: "uma_GraphEdge" = None, uma_Point345: "uma_Polyline" = None, uma_Point347: "uma_Ellipse" = None):
        self.x = x
        self.y = y
...
class uma_WorkProductDescriptor(Descriptor):
    ...
    def __init__(self, activityEntryState: str, activityExitState: str, uma_WorkProductDescriptor170: "uma_WorkProductDescriptor" = None, uma_WorkProductDescriptor168: set["uma_WorkProductDescriptor"] = None, uma_WorkProductDescriptor189: "uma_RoleDescriptor" = None, uma_WorkProductDescriptor: "uma_Milestone" = None, uma_WorkProductDescriptor161: "uma_WorkProduct" = None, WorkProductDescriptor: "uma_WorkProductDescriptor" = None, impacts: set["uma_WorkProductDescriptor"] = None, WorkProductDescriptor167: "uma_WorkProductDescriptor" = None, impactedBy: set["uma_WorkProductDescriptor"] = None, uma_WorkProductDescriptor192: "uma_RoleDescriptor" = None, uma_WorkProductDescriptor172: set["uma_WorkProduct"] = None, uma_WorkProductDescriptor212: "uma_TaskDescriptor" = None, uma_WorkProductDescriptor215: "uma_TaskDescriptor" = None, uma_WorkProductDescriptor206: "uma_TaskDescriptor" = None, uma_WorkProductDescriptor209: "uma_TaskDescriptor" = None, uma_WorkProductDescriptor340: "uma_ProcessComponentInterface" = None):
...
class uma_BreakdownElement(ProcessElement):
    ...
    def __init__(self, prefix: str, isPlanned: str, hasMultipleOccurrences: str, isOptional: str, uma_BreakdownElement: "uma_BreakdownElement" = None, uma_BreakdownElement103: "uma_BreakdownElement" = None, uma_BreakdownElement107: "uma_BreakdownElement" = None, uma_BreakdownElement105: "uma_BreakdownElement" = None, uma_BreakdownElement109: "uma_PlanningData" = None, breakdownElements: "uma_Activity" = None, uma_BreakdownElement112: set["uma_Checklist"] = None, BreakdownElement: "uma_Activity" = None, uma_BreakdownElement115: set["uma_Concept"] = None, uma_BreakdownElement118: set["uma_Example"] = None, uma_BreakdownElement121: set["uma_Guideline"] = None, uma_BreakdownElement124: set["uma_ReusableAsset"] = None, uma_BreakdownElement127: set["uma_SupportingMaterial"] = None, uma_BreakdownElement130: set["uma_Template"] = None, uma_BreakdownElement133: set["uma_Report"] = None, uma_BreakdownElement136: set["uma_EstimationConsiderations"] = None, uma_BreakdownElement139: set["uma_ToolMentor"] = None):
        self.prefix = prefix
...
class VariabilityElement:
    ...
    pass
class uma_Activity(WorkDefinition, FulfillableElement, VariabilityElement, WorkBreakdownElement):
...
class uma_MethodElement(PackageableElement):
    ...
    def __init__(self, suppressed: str, orderingGuide: str, guid: str, presentationName: str, briefDescription: str, uma_MethodElement: set["uma_Constraint"] = None, uma_MethodElement2: set["uma_MethodElementProperty"] = None, uma_MethodElement4: set["uma_Kind"] = None, uma_MethodElement342: "uma_UMASemanticModelBridge" = None):
