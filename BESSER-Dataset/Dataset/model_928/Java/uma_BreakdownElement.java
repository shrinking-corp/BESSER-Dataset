...
public class uma_BreakdownElement extends ProcessElement {
    ...
    public uma_BreakdownElement(
        String hasMultipleOccurrences,        String isPlanned,        String prefix,        String isOptional    ) {
        super(
        );
    ...
    public uma_BreakdownElement(
        String hasMultipleOccurrences,        String isPlanned,        String prefix,        String isOptional        ArrayList<uma_Checklist> uma_checklists,        ArrayList<uma_Template> uma_templates,        ArrayList<uma_SupportingMaterial> uma_supportingmaterials,        ArrayList<uma_Example> uma_examples,        ArrayList<uma_EstimationConsiderations> uma_estimationconsiderationss,        ArrayList<uma_Report> uma_reports,        ArrayList<uma_Guideline> uma_guidelines,        ArrayList<uma_ToolMentor> uma_toolmentors,        ArrayList<uma_Concept> uma_concepts,        ArrayList<uma_ReusableAsset> uma_reusableassets    ) {
        this.hasMultipleOccurrences = hasMultipleOccurrences;
        this.isPlanned = isPlanned;
        this.prefix = prefix;
        this.isOptional = isOptional;
