...
class library_Book:
    ...
    def __init__(self, title: str, pages: int, library_Book7: set["library_Writer"] = None, library_Book: "library_Library" = None, library_Book5: "library_Writer" = None):
        self.title = title
        self.pages = pages
...
class library_Writer:
    ...
    def __init__(self, firstName: str, lastName: str, library_Writer8: "library_Book" = None, library_Writer: "library_Library" = None, library_Writer4: set["library_Book"] = None):
