...
class Class_Class(Classifier):
    ...
    def __init__(self, isAbstract: str, Class_Class: set["Class"] = None, owner: set["Attribute"] = None, Classifier: "Class_Attribute" = None):
...
class Class_Attribute(NamedElt):
    ...
    def __init__(self, multiValued: str, Class_Attribute: "Classifier" = None, attr: "Class" = None):
