...
domain_model = DomainModel(
    name="fsmcore",
    types={fsmcore_StateMachine, NamedElement, fsmcore_State, fsmcore_Transition, fsmcore_Program, fsmcore_Constraint, fsmcore_Trigger, fsmcore_NamedElement},
    associations={states0, transitions1, doAction3, incoming5, outgoing6, guard8, trigger10, target12, source13},
    generalizations={gen_fsmcore_StateMachine_NamedElement, gen_fsmcore_State_NamedElement, gen_fsmcore_Transition_NamedElement},
    metadata=None
)
