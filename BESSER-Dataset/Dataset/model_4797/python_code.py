...
class alldatatypes_BigDecimals(Type):
    ...
    @property
    def bigDecimal_01_EmptyDefault(self):
    ...
    @property
    def notEditableBigDecimal_01(self):
...
class alldatatypes_Shorts(Type):
    ...
    @property
    def short_01_EmptyDefault(self):
...
class alldatatypes_Floats(Type):
    ...
    @property
    def float_01_EmptyDefault(self):
...
class alldatatypes_Integers(Type):
    ...
    def __init__(self, int_01: int, int_1: int, int_01_EmptyDefault: int, notEditableInt_01: int, ints: int, hiddenInt_01: int):
        self.int_01 = int_01
        self.int_1 = int_1
...
class alldatatypes_Doubles(Type):
    ...
    @property
    def double_01_EmptyDefault(self):
...
class alldatatypes_Booleans(Type):
    ...
    def __init__(self, boolean_01_EmptyDefault: bool, boolean_1: bool, notEditableBoolean_01: bool, boolean_01: bool):
    ...
    @property
    def boolean_01_EmptyDefault(self):
    ...
    @property
    def notEditableBoolean_01(self):
...
class alldatatypes_BigIntegers(Type):
    ...
    @property
    def bigInt_01_EmptyDefault(self):
...
class alldatatypes_Strings(Type):
    ...
    def __init__(self, text_01_EmptyDefault: str, text_01: str, text_1: str, textarea: str, link_01: str, html_01: str, notEditableText_01: str):
