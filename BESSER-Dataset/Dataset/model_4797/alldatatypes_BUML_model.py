...
# Classes
alldatatypes_Type = Class(name="alldatatypes_Type", is_abstract=True)
alldatatypes_Strings = Class(name="alldatatypes_Strings")
Type = Class(name="Type")
alldatatypes_Dates = Class(name="alldatatypes_Dates")
alldatatypes_Enums = Class(name="alldatatypes_Enums")
alldatatypes_Element = Class(name="alldatatypes_Element", is_abstract=True)
alldatatypes_Root = Class(name="alldatatypes_Root")
Element = Class(name="Element")
alldatatypes_Integers = Class(name="alldatatypes_Integers")
alldatatypes_Longs = Class(name="alldatatypes_Longs")
alldatatypes_Shorts = Class(name="alldatatypes_Shorts")
alldatatypes_Doubles = Class(name="alldatatypes_Doubles")
alldatatypes_Floats = Class(name="alldatatypes_Floats")
alldatatypes_Booleans = Class(name="alldatatypes_Booleans")
alldatatypes_BigIntegers = Class(name="alldatatypes_BigIntegers")
alldatatypes_BigDecimals = Class(name="alldatatypes_BigDecimals")
...
alldatatypes_Strings.attributes={alldatatypes_Strings_text_01, alldatatypes_Strings_notEditableText_01, alldatatypes_Strings_textarea, alldatatypes_Strings_text_1, alldatatypes_Strings_text_01_EmptyDefault, alldatatypes_Strings_link_01, alldatatypes_Strings_html_01}
...
alldatatypes_Dates.attributes={alldatatypes_Dates_notEditableDate_01, alldatatypes_Dates_dates, alldatatypes_Dates_dateEmptyDefault_01, alldatatypes_Dates_date_1, alldatatypes_Dates_date_01_HMSms, alldatatypes_Dates_date_01, alldatatypes_Dates_date_01_HM, alldatatypes_Dates_date_01_HMS}
...
alldatatypes_Enums.attributes={alldatatypes_Enums_states, alldatatypes_Enums_statesMin1Max2, alldatatypes_Enums_enum_1, alldatatypes_Enums_notEditableEnum_01, alldatatypes_Enums_heavy, alldatatypes_Enums_statesMax2, alldatatypes_Enums_enum_01, alldatatypes_Enums_enums, alldatatypes_Enums_enum_01_EmptyDefault}
...
alldatatypes_Integers.attributes={alldatatypes_Integers_int_1, alldatatypes_Integers_int_01_EmptyDefault, alldatatypes_Integers_hiddenInt_01, alldatatypes_Integers_int_01, alldatatypes_Integers_notEditableInt_01, alldatatypes_Integers_ints}
...
alldatatypes_Longs.attributes={alldatatypes_Longs_long_1, alldatatypes_Longs_long_01_EmptyDefault, alldatatypes_Longs_notEditableLong_01, alldatatypes_Longs_long_01}
...
alldatatypes_Shorts.attributes={alldatatypes_Shorts_short_1, alldatatypes_Shorts_notEditableShort_01, alldatatypes_Shorts_short_01, alldatatypes_Shorts_short_01_EmptyDefault}
...
alldatatypes_Doubles.attributes={alldatatypes_Doubles_notEditableDouble_01, alldatatypes_Doubles_double_01, alldatatypes_Doubles_double_1, alldatatypes_Doubles_double_01_EmptyDefault}
...
alldatatypes_Floats.attributes={alldatatypes_Floats_notEditableFloat_01, alldatatypes_Floats_float_1, alldatatypes_Floats_float_01, alldatatypes_Floats_float_01_EmptyDefault}
...
alldatatypes_Booleans.attributes={alldatatypes_Booleans_boolean_01_EmptyDefault, alldatatypes_Booleans_boolean_01, alldatatypes_Booleans_boolean_1, alldatatypes_Booleans_notEditableBoolean_01}
...
alldatatypes_BigIntegers.attributes={alldatatypes_BigIntegers_bigInt_1, alldatatypes_BigIntegers_bigInt_01_EmptyDefault, alldatatypes_BigIntegers_bigInt_01, alldatatypes_BigIntegers_notEditableBigInt_01, alldatatypes_BigIntegers_bigInts}
...
alldatatypes_BigDecimals.attributes={alldatatypes_BigDecimals_notEditableBigDecimal_01, alldatatypes_BigDecimals_bigDecimal_01, alldatatypes_BigDecimals_bigDecimal_1, alldatatypes_BigDecimals_bigDecimals, alldatatypes_BigDecimals_bigDecimal_01_EmptyDefault}
...
domain_model = DomainModel(
    name="alldatatypes",
    types={alldatatypes_Type, alldatatypes_Strings, Type, alldatatypes_Dates, alldatatypes_Enums, alldatatypes_Element, alldatatypes_Root, Element, alldatatypes_Integers, alldatatypes_Longs, alldatatypes_Shorts, alldatatypes_Doubles, alldatatypes_Floats, alldatatypes_Booleans, alldatatypes_BigIntegers, alldatatypes_BigDecimals, AEnum, StateWithoutDefault, Heavy},
    associations={types0},
    generalizations={gen_alldatatypes_Type_Element, gen_alldatatypes_Strings_Type, gen_alldatatypes_Dates_Type, gen_alldatatypes_Enums_Type, gen_alldatatypes_Root_Element, gen_alldatatypes_Integers_Type, gen_alldatatypes_Longs_Type, gen_alldatatypes_Shorts_Type, gen_alldatatypes_Doubles_Type, gen_alldatatypes_Floats_Type, gen_alldatatypes_Booleans_Type, gen_alldatatypes_BigIntegers_Type, gen_alldatatypes_BigDecimals_Type},
    metadata=None
)
