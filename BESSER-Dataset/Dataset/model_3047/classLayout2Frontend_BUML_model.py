...
# Classes
classLayout2Frontend_Project = Class(name="classLayout2Frontend_Project")
EntitiesModel = Class(name="EntitiesModel")
SiteView = Class(name="SiteView")
PageView = Class(name="PageView")
classLayout2Frontend_Entities_Property = Class(name="classLayout2Frontend_Entities_Property")
PropertyType = Class(name="PropertyType")
classLayout2Frontend_Entities_Enumeration = Class(name="classLayout2Frontend_Entities_Enumeration")
Literal = Class(name="Literal")
classLayout2Frontend_Entities_PropertyType = Class(name="classLayout2Frontend_Entities_PropertyType", is_abstract=True)
classLayout2Frontend_Entities_Literal = Class(name="classLayout2Frontend_Entities_Literal")
classLayout2Frontend_Entities_PrimitiveType = Class(name="classLayout2Frontend_Entities_PrimitiveType")
ContainerView = Class(name="ContainerView")
classLayout2Frontend_Entities_EntitiesModel = Class(name="classLayout2Frontend_Entities_EntitiesModel")
EntityModelElement = Class(name="EntityModelElement")
classLayout2Frontend_Entities_EntityModelElement = Class(name="classLayout2Frontend_Entities_EntityModelElement", is_abstract=True)
classLayout2Frontend_Entities_Association = Class(name="classLayout2Frontend_Entities_Association", is_abstract=True)
StructuralFeature = Class(name="StructuralFeature")
Entity = Class(name="Entity")
classLayout2Frontend_Entities_Composition = Class(name="classLayout2Frontend_Entities_Composition")
Association = Class(name="Association")
classLayout2Frontend_Entities_Reference = Class(name="classLayout2Frontend_Entities_Reference")
classLayout2Frontend_Entities_Entity = Class(name="classLayout2Frontend_Entities_Entity")
classLayout2Frontend_Views_InputForm = Class(name="classLayout2Frontend_Views_InputForm")
classLayout2Frontend_Views_StaticContainer = Class(name="classLayout2Frontend_Views_StaticContainer")
classLayout2Frontend_Views_Input = Class(name="classLayout2Frontend_Views_Input", is_abstract=True)
AtomicView = Class(name="AtomicView")
classLayout2Frontend_Views_InputText = Class(name="classLayout2Frontend_Views_InputText")
Input = Class(name="Input")
classLayout2Frontend_Views_Selection = Class(name="classLayout2Frontend_Views_Selection", is_abstract=True)
classLayout2Frontend_Views_Output = Class(name="classLayout2Frontend_Views_Output", is_abstract=True)
classLayout2Frontend_Views_TextArea = Class(name="classLayout2Frontend_Views_TextArea")
Output = Class(name="Output")
classLayout2Frontend_Entities_StructuralFeature = Class(name="classLayout2Frontend_Entities_StructuralFeature", is_abstract=True)
classLayout2Frontend_Views_SiteView = Class(name="classLayout2Frontend_Views_SiteView")
classLayout2Frontend_Views_ContainerView = Class(name="classLayout2Frontend_Views_ContainerView", is_abstract=True)
ElementView = Class(name="ElementView")
classLayout2Frontend_Views_AtomicView = Class(name="classLayout2Frontend_Views_AtomicView", is_abstract=True)
classLayout2Frontend_Views_ElementView = Class(name="classLayout2Frontend_Views_ElementView", is_abstract=True)
classLayout2Frontend_Views_IterationContainer = Class(name="classLayout2Frontend_Views_IterationContainer")
IterationFilter = Class(name="IterationFilter")
classLayout2Frontend_Views_Image = Class(name="classLayout2Frontend_Views_Image")
classLayout2Frontend_Views_PageView = Class(name="classLayout2Frontend_Views_PageView")
classLayout2Frontend_Views_IterationFilter = Class(name="classLayout2Frontend_Views_IterationFilter")
classLayout2Frontend_Views_Dropdownlist = Class(name="classLayout2Frontend_Views_Dropdownlist")
Selection = Class(name="Selection")
classLayout2Frontend_Views_RadioButtonGroup = Class(name="classLayout2Frontend_Views_RadioButtonGroup")
classLayout2Frontend_Views_CheckList = Class(name="classLayout2Frontend_Views_CheckList")
classLayout2Frontend_Views_Autocomplete = Class(name="classLayout2Frontend_Views_Autocomplete")
classLayout2Frontend_Views_FileUpload = Class(name="classLayout2Frontend_Views_FileUpload")
classLayout2Frontend_Views_List = Class(name="classLayout2Frontend_Views_List")
...
classLayout2Frontend_Views_SiteView.attributes={classLayout2Frontend_Views_SiteView_name, classLayout2Frontend_Views_SiteView_displayName, classLayout2Frontend_Views_SiteView_templateColor, classLayout2Frontend_Views_SiteView_templateName}
...
classLayout2Frontend_Views_ElementView.attributes={classLayout2Frontend_Views_ElementView_description, classLayout2Frontend_Views_ElementView_dsisplayName, classLayout2Frontend_Views_ElementView_name}
...
domain_model = DomainModel(
    ...
    types={classLayout2Frontend_Project, EntitiesModel, SiteView, PageView, classLayout2Frontend_Entities_Property, PropertyType, classLayout2Frontend_Entities_Enumeration, Literal, classLayout2Frontend_Entities_PropertyType, classLayout2Frontend_Entities_Literal, classLayout2Frontend_Entities_PrimitiveType, ContainerView, classLayout2Frontend_Entities_EntitiesModel, EntityModelElement, classLayout2Frontend_Entities_EntityModelElement, classLayout2Frontend_Entities_Association, StructuralFeature, Entity, classLayout2Frontend_Entities_Composition, Association, classLayout2Frontend_Entities_Reference, classLayout2Frontend_Entities_Entity, classLayout2Frontend_Views_InputForm, classLayout2Frontend_Views_StaticContainer, classLayout2Frontend_Views_Input, AtomicView, classLayout2Frontend_Views_InputText, Input, classLayout2Frontend_Views_Selection, classLayout2Frontend_Views_Output, classLayout2Frontend_Views_TextArea, Output, classLayout2Frontend_Entities_StructuralFeature, classLayout2Frontend_Views_SiteView, classLayout2Frontend_Views_ContainerView, ElementView, classLayout2Frontend_Views_AtomicView, classLayout2Frontend_Views_ElementView, classLayout2Frontend_Views_IterationContainer, IterationFilter, classLayout2Frontend_Views_Image, classLayout2Frontend_Views_PageView, classLayout2Frontend_Views_IterationFilter, classLayout2Frontend_Views_Dropdownlist, Selection, classLayout2Frontend_Views_RadioButtonGroup, classLayout2Frontend_Views_CheckList, classLayout2Frontend_Views_Autocomplete, classLayout2Frontend_Views_FileUpload, classLayout2Frontend_Views_List, LayoutType},
    associations={entitiesmodel0, siteViews1, type13, literals14, pageViews3, containerViews5, modelElements7, target8, superclass9, structuralFeatures11, iterationFilters23, pageViews15, elements17, entity18, property21, elementViews24, input26},
    generalizations={gen_classLayout2Frontend_Entities_Property_StructuralFeature, gen_classLayout2Frontend_Entities_Enumeration_PropertyType, gen_classLayout2Frontend_Entities_PropertyType_EntityModelElement, gen_classLayout2Frontend_Entities_Literal_EntityModelElement, gen_classLayout2Frontend_Entities_PrimitiveType_PropertyType, gen_classLayout2Frontend_Entities_Association_StructuralFeature, gen_classLayout2Frontend_Entities_Composition_Association, gen_classLayout2Frontend_Entities_Reference_Association, gen_classLayout2Frontend_Entities_Entity_EntityModelElement, gen_classLayout2Frontend_Views_InputForm_ContainerView, gen_classLayout2Frontend_Views_StaticContainer_ContainerView, gen_classLayout2Frontend_Views_Input_AtomicView, gen_classLayout2Frontend_Views_InputText_Input, gen_classLayout2Frontend_Views_Selection_Input, gen_classLayout2Frontend_Views_Output_AtomicView, gen_classLayout2Frontend_Views_TextArea_Output, gen_classLayout2Frontend_Entities_StructuralFeature_EntityModelElement, gen_classLayout2Frontend_Views_ContainerView_ElementView, gen_classLayout2Frontend_Views_AtomicView_ElementView, gen_classLayout2Frontend_Views_IterationContainer_ContainerView, gen_classLayout2Frontend_Views_Image_Output, gen_classLayout2Frontend_Views_Dropdownlist_Selection, gen_classLayout2Frontend_Views_RadioButtonGroup_Selection, gen_classLayout2Frontend_Views_CheckList_Selection, gen_classLayout2Frontend_Views_Autocomplete_Selection, gen_classLayout2Frontend_Views_FileUpload_Input, gen_classLayout2Frontend_Views_List_Selection},
    metadata=None
)
