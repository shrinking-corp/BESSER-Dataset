...
public class xpdl1_DocumentRoot  {
    ...
    public xpdl1_DocumentRoot(
        String priority,        String responsible,        String cost,        String version,        String duration,        String codepage,        String vendor,        String mixed,        String countrykey,        String performer,        String workingTime,        String xPDLVersion,        String priorityUnit,        String documentation,        String author,        String waitingTime,        String validTo,        String icon,        String created,        String costUnit,        String validFrom,        String limit,        String description,        String length,        String actualParameter,        String initialValue    ) {
    ...
    public xpdl1_DocumentRoot(
        String priority,        String responsible,        String cost,        String version,        String duration,        String codepage,        String vendor,        String mixed,        String countrykey,        String performer,        String workingTime,        String xPDLVersion,        String priorityUnit,        String documentation,        String author,        String waitingTime,        String validTo,        String icon,        String created,        String costUnit,        String validFrom,        String limit,        String description,        String length,        String actualParameter,        String initialValue        ArrayList<xpdl1_ActivityType> xpdl1_activitytypes,        ArrayList<xpdl1_ConformanceClassType> xpdl1_conformanceclasstypes,        ArrayList<xpdl1_RouteType> xpdl1_routetypes,        ArrayList<xpdl1_ArrayTypeType> xpdl1_arraytypetypes,        ArrayList<xpdl1_ExternalReferenceType> xpdl1_externalreferencetypes,        ArrayList<xpdl1_BasicTypeType> xpdl1_basictypetypes,        ArrayList<xpdl1_ApplicationsType> xpdl1_applicationstypes,        ArrayList<xpdl1_ApplicationType> xpdl1_applicationtypes,        ArrayList<xpdl1_ExtendedAttributesType> xpdl1_extendedattributestypes,        ArrayList<xpdl1_ActivitiesType> xpdl1_activitiestypes,        ArrayList<xpdl1_DeclaredTypeType> xpdl1_declaredtypetypes,        ArrayList<xpdl1_SchemaTypeType> xpdl1_schematypetypes,        ArrayList<xpdl1_TransitionRestrictionsType> xpdl1_transitionrestrictionstypes,        ArrayList<xpdl1_ImplementationType> xpdl1_implementationtypes,        ArrayList<xpdl1_ActualParametersType> xpdl1_actualparameterstypes,        ArrayList<xpdl1_AutomaticType> xpdl1_automatictypes,        ArrayList<xpdl1_XpressionType> xpdl1_xpressiontypes,        ArrayList<xpdl1_FormalParametersType> xpdl1_formalparameterstypes,        ArrayList<xpdl1_ActivitySetsType> xpdl1_activitysetstypes,        ArrayList<xpdl1_DeadlineType> xpdl1_deadlinetypes,        ArrayList<xpdl1_UnionTypeType> xpdl1_uniontypetypes,        ArrayList<xpdl1_RecordTypeType> xpdl1_recordtypetypes,        ArrayList<xpdl1_EnumerationTypeType> xpdl1_enumerationtypetypes,        ArrayList<xpdl1_FinishModeType> xpdl1_finishmodetypes,        ArrayList<xpdl1_ActivitySetType> xpdl1_activitysettypes,        ArrayList<xpdl1_DataFieldType> xpdl1_datafieldtypes,        ArrayList<xpdl1_DataTypeType> xpdl1_datatypetypes,        ArrayList<xpdl1_SimulationInformationType> xpdl1_simulationinformationtypes,        ArrayList<xpdl1_TransitionsType> xpdl1_transitionstypes,        ArrayList<xpdl1_DataFieldsType> xpdl1_datafieldstypes,        ArrayList<xpdl1_StartModeType> xpdl1_startmodetypes,        ArrayList<xpdl1_ListTypeType> xpdl1_listtypetypes,        ArrayList<xpdl1_ConditionType> xpdl1_conditiontypes,        ArrayList<xpdl1_BlockActivityType> xpdl1_blockactivitytypes    ) {
        this.priority = priority;
        this.responsible = responsible;
        this.cost = cost;
        this.version = version;
