...
# Classes
TypeB_CDescription = Class(name="TypeB_CDescription")
TypeB_A = Class(name="TypeB_A")
TypeB_B = Class(name="TypeB_B")
TypeB_C = Class(name="TypeB_C")
TypeB_BDescription1 = Class(name="TypeB_BDescription1")
TypeB_BDescription2 = Class(name="TypeB_BDescription2")
TypeB_BDescription3 = Class(name="TypeB_BDescription3")
...
domain_model = DomainModel(
    name="TypeB",
    types={TypeB_CDescription, TypeB_A, TypeB_B, TypeB_C, TypeB_BDescription1, TypeB_BDescription2, TypeB_BDescription3},
    associations={description9, bElements0, cElements1, description13, description25, description37},
    generalizations={},
    metadata=None
)
