...
Order.attributes={Order_status, Order_number, Order_shipTo, Order_shipped, Order_ordered, Order_total}
...
domain_model = DomainModel(
    name="_2fe01a2e_3ba7_4746_a545_3d0b992f8216",
    types={Customer, Payment, ShoppingCart, Account, WebUser, Order, LineItem, Product, UserState, OrderStatus},
    associations={Account_Payment, WebUser_ShoppingCart, WebUser_Customer, Customer_Account, Account_ShoppingCart, ShoppingCart_LineItem, Product_LineItem, Order_LineItem, Payment_Order, Account_Order},
    generalizations={},
    metadata=None
)
