...
class Order:
    ...
    def __init__(self, number: int, ordered: date, shipped: bool, shipTo: str, total: float, status: OrderStatus, items14: set["LineItem"] = None, payment19: "Payment" = None, account17: "Account" = None):
        self.number = number
