...
class ale_Apply(Expression):
    ...
    def __init__(self, name: str, varName: str, ale_Apply: "ale_Expression" = None, ale_Apply103: "ale_typeLiteral" = None, ale_Apply106: "ale_Expression" = None, ale_Apply109: set["ale_Expression"] = None):
        self.name = name
...
class ale_Mult(Expression):
    ...
    def __init__(self, op: str, ale_Mult114: "ale_Expression" = None, ale_Mult: "ale_Expression" = None):
        self.op = op
...
class ale_rSwitch:
    ...
    def __init__(self, paramName: str, ale_rSwitch: "ale_ExpressionStmt" = None, ale_rSwitch76: "ale_ExpressionStmt" = None, ale_rSwitch74: set["ale_rCase"] = None):
...
class ale_Variable:
    ...
    def __init__(self, name: str, ale_Variable: "ale_Operation" = None, ale_Variable18: "ale_rType" = None):
        self.name = name
...
class ale_rType:
    ...
    def __init__(self, name: str, ale_rType: "ale_Operation" = None, ale_rType19: "ale_Variable" = None, ale_rType80: "ale_rCase" = None, ale_rType24: "ale_Attribute" = None, ale_rType28: "ale_VarDecl" = None):
        self.name = name
...
class ale_BehavioredClass:
    ...
    def __init__(self, name: str, ale_BehavioredClass: "ale_Unit" = None, ale_BehavioredClass6: set["ale_Attribute"] = None, ale_BehavioredClass8: set["ale_Operation"] = None):
        self.name = name
