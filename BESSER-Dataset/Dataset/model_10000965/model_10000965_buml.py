...
Machine_Machine: BinaryAssociation = BinaryAssociation(
    name="Machine_Machine",
    ends={
        Property(name="machine22", type=Machine, multiplicity=Multiplicity(0, 1)),
...
domain_model = DomainModel(
    name="_75cba0cf_3885_4fb3_be31_477992f8056f",
    ...
    associations={Machine_Memory, Processor_Memory, Program_Instruction, Machine_Processor, Processor_Program, Cache_RAM, ExtensionBoard_Card, Vendor1Adapter_Vendor1Sound, Vendor2Adapter_Vendor2Sound, Machine_Card, AcceleratorCard_CPU, Machine_Machine},
    generalizations={},
    metadata=None
)
