...
Person.attributes={Person_Balance, Person_Long, Person_Last_Seen, Person_Lat, Person_Ssn, Person_Gender, Person_ID, Person_Image, Person_PhoneNumeber, Person_InsuranceNumber, Person_Name, Person_Email, Person_Password}
...
Diagnosis.attributes={Diagnosis_LIst_of_Diagnosis, Diagnosis_ID, Diagnosis_Patient_Id, Diagnosis_Doctor_Id, Diagnosis_LIst_of_Instructions, Diagnosis_LIst_of_Symptoms, Diagnosis_LIst_of_Medical_Test, Diagnosis_Condition, Diagnosis_LIst_of_Medicine, Diagnosis_Date}
...
Medical_test.attributes={Medical_test_Date, Medical_test_name, Medical_test_Lab, Medical_test_ID, Medical_test_Image}
...
Instructions.attributes={Instructions_descriptions, Instructions_name, Instructions_ID}
...
Symptoms.attributes={Symptoms_name, Symptoms_ID}
...
Medicine.attributes={Medicine_ActiveIngredient, Medicine_ID, Medicine_Type, Medicine_name, Medicine_Price}
...
Patient.attributes={Patient_MedicalTest, Patient_Surgeries, Patient_weight, Patient_DiagnosisList, Patient_Medicine, Patient_Allergies, Patient_Height}
...
domain_model = DomainModel(
    name="_9d4fb6c5_dcd6_4393_a42d_edbcf9eecd2d",
