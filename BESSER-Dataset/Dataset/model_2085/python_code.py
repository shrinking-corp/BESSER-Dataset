...
class sxfm_Data:
    ...
    def __init__(self, value: str, name: str, sxfm_Data: "sxfm_MetadataSet" = None):
        self.value = value
        self.name = name
...
class ContainerElement:
    ...
    pass
class sxfm_Optional(Feature, ContainerElement, ConstraintableElement, VariableFeature, ContainableElement):

    pass
class sxfm_Mandatory(Feature, ContainerElement, ConstraintableElement, CommonFeature, ContainableElement):
...
class sxfm_Constraint:
    ...
    def __init__(self, id: int, sxfm_Constraint15: "sxfm_ConstraintsSet" = None, sxfm_Constraint: "sxfm_Or" = None):
        self.id = id
...
class sxfm_GroupedFeature(ContainerElement, VariableFeature, ConstraintableElement, Feature):
...
class sxfm_Root(ContainerElement, Feature, CommonFeature):
...
class sxfm_FeatureModel:
    ...
    def __init__(self, name: str, sxfm_FeatureModel10: set["sxfm_FeatureModelConfiguaration"] = None, sxfm_FeatureModel: "sxfm_ConstraintsSet" = None, sxfm_FeatureModel6: "sxfm_FeatureTree" = None, sxfm_FeatureModel8: "sxfm_MetadataSet" = None):
        self.name = name
...
class sxfm_Group(CardinalizedElement):
    ...
    def __init__(self, id: str, sxfm_Group2: set["sxfm_GroupedFeature"] = None, sxfm_Group: "sxfm_Feature" = None):
        self.id = id
...
class sxfm_Feature(ABC):
    ...
    def __init__(self, name: str, id: str, treeLevel: int, description: str, sxfm_Feature28: "sxfm_FeatureChoice" = None, sxfm_Feature: set["sxfm_Group"] = None):
        self.name = name
        self.id = id
