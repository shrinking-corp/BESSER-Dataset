...
class pdb1_Person:
    ...
    def __init__(self, firstName: str, lastName: str, birthday: str, placeOfBirth: str, id: str, incrementalID: str, persons: "pdb1_Database" = None, Person: "pdb1_Database" = None):
...
class pdb1_Database:
    ...
    def __init__(self, name: str, Database: "pdb1_Person" = None, database: set["pdb1_Person"] = None):
        self.name = name
