...
# Classes
pdb1_Database = Class(name="pdb1_Database")
pdb1_Person = Class(name="pdb1_Person")
...
pdb1_Person.attributes={pdb1_Person_placeOfBirth, pdb1_Person_birthday, pdb1_Person_lastName, pdb1_Person_incrementalID, pdb1_Person_firstName, pdb1_Person_id}
...
domain_model = DomainModel(
    name="pdb1",
    types={pdb1_Database, pdb1_Person},
    associations={database1, persons0},
    generalizations={},
    metadata=None
)
