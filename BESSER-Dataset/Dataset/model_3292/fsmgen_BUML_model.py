...
# Classes
fsmgen_ModelComponent = Class(name="fsmgen_ModelComponent")
fsmgen_Node = Class(name="fsmgen_Node")
fsmgen_Link = Class(name="fsmgen_Link")
fsmgen_StateGraph = Class(name="fsmgen_StateGraph")
fsmgen_GraphContainer = Class(name="fsmgen_GraphContainer")
FSMGenElement = Class(name="FSMGenElement")
fsmgen_Graph = Class(name="fsmgen_Graph")
fsmgen_EObject = Class(name="fsmgen_EObject")
fsmgen_TransitionBase = Class(name="fsmgen_TransitionBase")
fsmgen_GraphItem = Class(name="fsmgen_GraphItem")
GraphItem = Class(name="GraphItem")
fsmgen_StateGraphNode = Class(name="fsmgen_StateGraphNode")
fsmgen_CommonTrigger = Class(name="fsmgen_CommonTrigger")
fsmgen_AbstractInterfaceItem = Class(name="fsmgen_AbstractInterfaceItem")
fsmgen_FSMGenElement = Class(name="fsmgen_FSMGenElement")
...
fsmgen_GraphContainer.attributes={fsmgen_GraphContainer_initializedChainHeads, fsmgen_GraphContainer_initializedCommonData, fsmgen_GraphContainer_initializedTriggersInStates}
...
fsmgen_CommonTrigger.attributes={fsmgen_CommonTrigger_hasGuard, fsmgen_CommonTrigger_trigger}
...
domain_model = DomainModel(
    name="fsmgen",
    types={fsmgen_ModelComponent, fsmgen_Node, fsmgen_Link, fsmgen_StateGraph, fsmgen_GraphContainer, FSMGenElement, fsmgen_Graph, fsmgen_EObject, fsmgen_TransitionBase, fsmgen_GraphItem, GraphItem, fsmgen_StateGraphNode, fsmgen_CommonTrigger, fsmgen_AbstractInterfaceItem, fsmgen_FSMGenElement},
    associations={graph0, component1, nodes3, links4, stateGraph6, graph20, source22, target24, chainHeads27, commonData28, node8, graph10, subgraph11, outgoing13, incoming15, stateGraphNode17, caughtTriggers18, transition30, msg32, ifitem35, links37},
    generalizations={gen_fsmgen_Graph_FSMGenElement, gen_fsmgen_GraphContainer_FSMGenElement, gen_fsmgen_Link_GraphItem, gen_fsmgen_GraphItem_FSMGenElement, gen_fsmgen_Node_GraphItem, gen_fsmgen_CommonTrigger_FSMGenElement},
    metadata=None
)
