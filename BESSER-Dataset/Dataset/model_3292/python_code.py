...
class fsmgen_Graph(FSMGenElement):
    ...
    def __init__(self, fsmgen_Graph: "fsmgen_GraphContainer" = None, graph: set["fsmgen_Node"] = None, graph5: set["fsmgen_Link"] = None, fsmgen_Graph7: "fsmgen_StateGraph" = None, Graph21: "fsmgen_Link" = None, subgraph: "fsmgen_Node" = None, Graph: "fsmgen_Node" = None, Graph12: "fsmgen_Node" = None):
...
class fsmgen_GraphContainer(FSMGenElement):
    ...
    def __init__(self, initializedTriggersInStates: bool, initializedChainHeads: bool, initializedCommonData: bool, fsmgen_GraphContainer: "fsmgen_Graph" = None, fsmgen_GraphContainer2: "fsmgen_ModelComponent" = None):
        ...
        pass
    @property
    def initializedCommonData(self):
    ...
    @property
    def initializedChainHeads(self):
    ...
    @property
    def initializedTriggersInStates(self):
...
class fsmgen_Link(GraphItem):
    ...
    def __init__(self, ifitemTriggered: bool, Link: "fsmgen_Graph" = None, links: "fsmgen_Graph" = None, outgoing: "fsmgen_Node" = None, incoming: "fsmgen_Node" = None, fsmgen_Link: "fsmgen_Link" = None, fsmgen_Link26: set["fsmgen_Link"] = None, fsmgen_Link29: "fsmgen_EObject" = None, Link14: "fsmgen_Node" = None, Link16: "fsmgen_Node" = None, fsmgen_Link31: "fsmgen_TransitionBase" = None, fsmgen_Link39: "fsmgen_CommonTrigger" = None):
...
class fsmgen_Node(GraphItem):
    ...
    def __init__(self, inheritanceLevel: int, Node: "fsmgen_Graph" = None, Node23: "fsmgen_Link" = None, Node25: "fsmgen_Link" = None, Node9: "fsmgen_Graph" = None, nodes: "fsmgen_Graph" = None, node: "fsmgen_Graph" = None, source: set["fsmgen_Link"] = None, target: set["fsmgen_Link"] = None, fsmgen_Node: "fsmgen_StateGraphNode" = None, fsmgen_Node19: set["fsmgen_CommonTrigger"] = None):
