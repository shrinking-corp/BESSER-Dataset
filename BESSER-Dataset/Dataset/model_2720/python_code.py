...
class k7_L1:
    ...
    def __init__(self, id1: str, id2: int, k7_L129: "k7_C" = None, k7_L132: "k7_M" = None, k7_L1: "k7_M" = None):
        self.id1 = id1
        self.id2 = id2
...
class k7_T1(T2):
    ...
    def __init__(self, name: str, k7_T1: "k7_X" = None, k7_T149: "k7_DsmlRelation" = None, k7_T152: "k7_DsmlRelation" = None, k7_T156: set["k7_DsmlRelation"] = None, k7_T154: set["k7_T2"] = None):
        self.name = name
        self.k7_T1 = k7_T1
...
class k7_Y:
    ...
    def __init__(self, y: int, k7_Y16: "k7_B" = None, k7_Y: "k7_X" = None):
        self.y = y
        self.k7_Y16 = k7_Y16
        self.k7_Y = k7_Y
