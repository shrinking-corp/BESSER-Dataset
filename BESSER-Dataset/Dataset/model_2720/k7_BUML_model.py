...
# Classes
k7_X = Class(name="k7_X")
k7_C = Class(name="k7_C", is_abstract=True)
k7_P = Class(name="k7_P")
k7_Z = Class(name="k7_Z")
k7_Y = Class(name="k7_Y")
k7_W = Class(name="k7_W")
k7_L4 = Class(name="k7_L4")
k7_T1 = Class(name="k7_T1")
k7_A = Class(name="k7_A")
B = Class(name="B")
k7_B = Class(name="k7_B")
C = Class(name="C")
k7_I = Class(name="k7_I")
G = Class(name="G")
k7_G = Class(name="k7_G", is_abstract=True)
k7_M = Class(name="k7_M")
k7_J = Class(name="k7_J")
A = Class(name="A")
N = Class(name="N")
k7_K = Class(name="k7_K")
k7_Q = Class(name="k7_Q")
P = Class(name="P")
k7_L2 = Class(name="k7_L2")
J = Class(name="J")
k7_L1 = Class(name="k7_L1")
k7_N = Class(name="k7_N")
M = Class(name="M")
k7_L3 = Class(name="k7_L3")
L1 = Class(name="L1")
k7_T2 = Class(name="k7_T2")
k7_DsmlRelation = Class(name="k7_DsmlRelation")
T2 = Class(name="T2")
...
k7_Z.attributes={k7_Z_z2, k7_Z_z1, k7_Z_z3}
...
k7_L2.attributes={k7_L2_l2, k7_L2_l1}
...
k7_L1.attributes={k7_L1_id1, k7_L1_id2}
...
k7_DsmlRelation.attributes={k7_DsmlRelation_mandatory, k7_DsmlRelation_details, k7_DsmlRelation_name}
...
domain_model = DomainModel(
    name="k7",
    types={k7_X, k7_C, k7_P, k7_Z, k7_Y, k7_W, k7_L4, k7_T1, k7_A, B, k7_B, C, k7_I, G, k7_G, k7_M, k7_J, A, N, k7_K, k7_Q, P, k7_L2, J, k7_L1, k7_N, M, k7_L3, L1, k7_T2, k7_DsmlRelation, T2},
    associations={xcs0, ps1, zs3, ys5, w7, l4s9, t1s11, is_13, y14, mcs17, a21, ks23, js25, l2s27, l1c28, l1m31, l2q34, l2k37, ml119, l3z40, p42, a45, fromDsml48, toDsml50, relateds55, t2s53},
    generalizations={gen_k7_A_B, gen_k7_B_C, gen_k7_C_G, gen_k7_M_G, gen_k7_J_A, gen_k7_P_N, gen_k7_Q_P, gen_k7_I_G, gen_k7_K_J, gen_k7_N_M, gen_k7_L3_L1, gen_k7_T1_T2},
    metadata=None
)
