...
ecore_EClass.methods={ecore_EClass_m_getFeatureID, ecore_EClass_m_getEStructuralFeature, ecore_EClass_m_isSuperTypeOf, ecore_EClass_m_op_getEStructuralFeature, ecore_EClass_m_getFeatureCount}
...
ecore_EEnum.methods={ecore_EEnum_m_op_getEEnumLiteral, ecore_EEnum_m_getEEnumLiteral, ecore_EEnum_m_getEEnumLiteralByLiteral}
...
ecore_EStructuralFeature.attributes={ecore_EStructuralFeature_volatile, ecore_EStructuralFeature_transient, ecore_EStructuralFeature_defaultValueLiteral, ecore_EStructuralFeature_unsettable, ecore_EStructuralFeature_derived, ecore_EStructuralFeature_defaultValue, ecore_EStructuralFeature_changeable}
...
ecore_ETypedElement.attributes={ecore_ETypedElement_required, ecore_ETypedElement_ordered, ecore_ETypedElement_lowerBound, ecore_ETypedElement_unique, ecore_ETypedElement_many, ecore_ETypedElement_upperBound}
...
eFactoryInstance49: BinaryAssociation = BinaryAssociation(
    name="eFactoryInstance49",
    ends={
...
eClassifiers50: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="ePackage51", type=EClassifier, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
eSubpackages52: BinaryAssociation = BinaryAssociation(
    name="eSubpackages52",
    ends={
        Property(name="EPackage53", type=ecore_EPackage, multiplicity=Multiplicity(1, 1)),
...
eOpposite58: BinaryAssociation = BinaryAssociation(
    name="eOpposite58",
    ends={
        Property(name="EReference59", type=ecore_EReference, multiplicity=Multiplicity(1, 1)),
        Property(name="ecore_EReference", type=EReference, multiplicity=Multiplicity(0, 1))
    }
)
eReferenceType60: BinaryAssociation = BinaryAssociation(
    name="eReferenceType60",
    ends={
        Property(name="EClass62", type=ecore_EReference, multiplicity=Multiplicity(1, 1)),
        Property(name="ecore_EReference61", type=EClass, multiplicity=Multiplicity(1, 1))
    }
)
eContainingClass66: BinaryAssociation = BinaryAssociation(
    name="eContainingClass66",
    ends={
        Property(name="EClass67", type=ecore_EStructuralFeature, multiplicity=Multiplicity(1, 1)),
        Property(name="eStructuralFeatures", type=EClass, multiplicity=Multiplicity(0, 1))
    }
)
eContainingClass68: BinaryAssociation = BinaryAssociation(
    name="eContainingClass68",
    ends={
        Property(name="EClass69", type=ecore_EOperation, multiplicity=Multiplicity(1, 1)),
        Property(name="eOperations", type=EClass, multiplicity=Multiplicity(0, 1))
    }
)
eTypeParameters70: BinaryAssociation = BinaryAssociation(
    name="eTypeParameters70",
    ends={
        Property(name="ETypeParameter71", type=ecore_EOperation, multiplicity=Multiplicity(1, 1)),
        Property(name="ecore_EOperation", type=ETypeParameter, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
eParameters72: BinaryAssociation = BinaryAssociation(
    name="eParameters72",
    ends={
...
eExceptions73: BinaryAssociation = BinaryAssociation(
    name="eExceptions73",
    ends={
        Property(name="EClassifier75", type=ecore_EOperation, multiplicity=Multiplicity(1, 1)),
        Property(name="ecore_EOperation74", type=EClassifier, multiplicity=Multiplicity(0, 9999))
    }
)
eKeys63: BinaryAssociation = BinaryAssociation(
    name="eKeys63",
    ends={
        Property(name="EAttribute65", type=ecore_EReference, multiplicity=Multiplicity(1, 1)),
        Property(name="ecore_EReference64", type=EAttribute, multiplicity=Multiplicity(0, 9999))
    }
)
...
eGenericExceptions76: BinaryAssociation = BinaryAssociation(
    name="eGenericExceptions76",
    ends={
        Property(name="EGenericType78", type=ecore_EOperation, multiplicity=Multiplicity(1, 1)),
        Property(name="ecore_EOperation77", type=EGenericType, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
domain_model = DomainModel(
    name="ecore",
    types={ecore_EAttribute, EStructuralFeature, EDataType, ecore_EAnnotation, EModelElement, EStringToStringMapEntry, EObject, EClass, EOperation, EAttribute, EReference, ecore_EClass, EClassifier, EGenericType, ecore_EClassifier, ENamedElement, EPackage, ETypeParameter, ecore_EDataType, ecore_EEnum, EEnumLiteral, ecore_EEnumLiteral, EEnum, ecore_EModelElement, EAnnotation, ecore_ENamedElement, ecore_EObject, ecore_EFactory, ecore_EPackage, EFactory, ecore_EParameter, ETypedElement, ecore_EReference, ecore_EStructuralFeature, ecore_EOperation, EParameter, ecore_EStringToStringMapEntry, ecore_EGenericType, ecore_ETypedElement, ecore_ETypeParameter},
    associations={eAttributeType0, details1, eModelElement2, contents3, references5, eSuperTypes8, eOperations9, eAllAttributes10, eAllReferences12, eReferences14, eAttributes17, eAllStructuralFeatures26, eAllSuperTypes28, eIDAttribute31, eStructuralFeatures34, eGenericSuperTypes37, eAllGenericSuperTypes39, eAllContainments20, eAllOperations23, ePackage42, eTypeParameters43, eLiterals44, eEnum45, ePackage46, eAnnotations48, eFactoryInstance49, eClassifiers50, eSubpackages52, eSuperPackage54, eOperation56, eOpposite58, eReferenceType60, eContainingClass66, eContainingClass68, eTypeParameters70, eParameters72, eExceptions73, eKeys63, eType79, eGenericType81, eUpperBound84, eTypeArguments86, eRawType89, eLowerBound92, eTypeParameter95, eClassifier98, eGenericExceptions76, eBounds101},
    generalizations={gen_ecore_EAttribute_EStructuralFeature, gen_ecore_EAnnotation_EModelElement, gen_ecore_EClass_EClassifier, gen_ecore_EClassifier_ENamedElement, gen_ecore_EDataType_EClassifier, gen_ecore_EEnum_EDataType, gen_ecore_EEnumLiteral_ENamedElement, gen_ecore_EModelElement_EObject, gen_ecore_ENamedElement_EModelElement, gen_ecore_EFactory_EModelElement, gen_ecore_EPackage_ENamedElement, gen_ecore_EParameter_ETypedElement, gen_ecore_EReference_EStructuralFeature, gen_ecore_EStructuralFeature_ETypedElement, gen_ecore_EOperation_ETypedElement, gen_ecore_EGenericType_EObject, gen_ecore_ETypedElement_ENamedElement, gen_ecore_ETypeParameter_ENamedElement},
    metadata=None
)
