...
class ecore_ETypedElement(ENamedElement):
    ...
    def __init__(self, many: str, required: str, ordered: str, unique: str, lowerBound: str, upperBound: str, ecore_ETypedElement: "EClassifier" = None, ecore_ETypedElement82: "EGenericType" = None):
        self.many = many
...
class ecore_EClassifier(ENamedElement):
    ...
    def __init__(self, instanceClass: str, defaultValue: str, instanceTypeName: str, instanceClassName: str, eClassifiers: "EPackage" = None, ecore_EClassifier: set["ETypeParameter"] = None):
...
class ecore_EDataType(EClassifier):
    ...
    def __init__(self, serializable: str, EClassifier: "ecore_EPackage" = None, EClassifier75: "ecore_EOperation" = None, EClassifier100: "ecore_EGenericType" = None, EClassifier80: "ecore_ETypedElement" = None, EClassifier91: "ecore_EGenericType" = None):
...
class ecore_EClass(EClassifier):
    ...
    def __init__(self, abstract: str, interface: str, ecore_EClass: set["EClass"] = None, eContainingClass: set["EOperation"] = None, ecore_EClass11: set["EAttribute"] = None, ecore_EClass13: set["EReference"] = None, ecore_EClass15: set["EReference"] = None, ecore_EClass18: set["EAttribute"] = None, ecore_EClass27: set["EStructuralFeature"] = None, ecore_EClass29: set["EClass"] = None, ecore_EClass32: "EAttribute" = None, eContainingClass35: set["EStructuralFeature"] = None, ecore_EClass38: set["EGenericType"] = None, ecore_EClass40: set["EGenericType"] = None, ecore_EClass21: set["EReference"] = None, ecore_EClass24: set["EOperation"] = None, EClassifier: "ecore_EPackage" = None, EClassifier75: "ecore_EOperation" = None, EClassifier100: "ecore_EGenericType" = None, EClassifier80: "ecore_ETypedElement" = None, EClassifier91: "ecore_EGenericType" = None):
...
class ecore_EModelElement(EObject):
    ...
    def __init__(self, eModelElement: set["EAnnotation"] = None, EObject7: "ecore_EAnnotation" = None, EObject: "ecore_EAnnotation" = None):
