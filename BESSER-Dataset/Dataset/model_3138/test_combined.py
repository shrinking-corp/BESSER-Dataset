...
def test_hyp_uml_14_structuralfeature_targetScope_setter(instance):
...
@given(instance=UML_14_StructuralFeature_strategy)
def test_hyp_uml_14_structuralfeature_ordering_setter(instance):
...
@given(instance=UML_14_StructuralFeature_strategy)
def test_hyp_uml_14_structuralfeature_changeability_setter(instance):
...
def test_hyp_uml_14_generalizableelement_isRoot_setter(instance):
    original = instance.isRoot
    instance.isRoot = original
    assert instance.isRoot == original
...
@given(instance=UML_14_GeneralizableElement_strategy)
def test_hyp_uml_14_generalizableelement_isLeaf_setter(instance):
    original = instance.isLeaf
    instance.isLeaf = original
    assert instance.isLeaf == original
...
def test_hyp_uml_14_feature_ownerScope_setter(instance):
...
@given(instance=UML_14_Feature_strategy)
def test_hyp_uml_14_feature_visibility_setter(instance):
    original = instance.visibility
    instance.visibility = original
    assert instance.visibility == original
