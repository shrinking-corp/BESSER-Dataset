...
public class UML_14_Classifier extends NameSpace, GeneralizableElement {
    ...
    public UML_14_Classifier(
        ArrayList<UML_14_Feature> uml_14_features,        ArrayList<UML_14_Parameter> uml_14_parameters    ) {
