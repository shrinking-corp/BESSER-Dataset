...
User.attributes={User_username, User_password, User_lastname, User_firstname, User_attribute, User_id}
...
Position.attributes={Position_createdAt, Position_longitude, Position_id, Position_latitude}
...
Address.attributes={Address_id, Address_zipCode, Address_country, Address_city, Address_street}
...
Store.attributes={Store_name, Store_photoPath, Store_id}
...
Product.attributes={Product_name, Product_photoPath, Product_id, Product_price, Product_description}
...
Offer.attributes={Offer_endDate, Offer_id, Offer_discount, Offer_beginDate}
...
domain_model = DomainModel(
    name="_59c830a2_5c8b_4571_b997_a5ee899954f8",
