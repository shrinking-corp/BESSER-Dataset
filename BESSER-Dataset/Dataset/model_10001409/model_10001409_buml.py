...
pcb_PCB.attributes={pcb_PCB_pid, pcb_PCB_startDiskOutputBufferAddress, pcb_PCB_numIO, pcb_PCB_elapsedWaitTime, pcb_PCB_elapsedRunTime, pcb_PCB_startDiskInputBufferAddress, pcb_PCB_executionCount, pcb_PCB_instructionLength, pcb_PCB_cpuid, pcb_PCB_startDiskInstructionAddress, pcb_PCB_startDiskTempBufferAddress, pcb_PCB_inputBufferLength, pcb_PCB_priority, pcb_PCB_clock, pcb_PCB_outputBufferLength, pcb_PCB_programCounter, pcb_PCB_tempBufferLength}
...
cpu_CPU.attributes={cpu_CPU_cpuids, cpu_CPU_shutdown, cpu_CPU_previousInstruction, cpu_CPU_numProcesses, cpu_CPU_log, cpu_CPU_pcb, cpu_CPU_cache, cpu_CPU_idleTime, cpu_CPU_register, cpu_CPU_dmaChannel, cpu_CPU_executeTime, cpu_CPU_cpuid}
...
cpu_ArithmeticExecutableInstruction.attributes={cpu_ArithmeticExecutableInstruction_s2, cpu_ArithmeticExecutableInstruction_d, cpu_ArithmeticExecutableInstruction_s1}
...
cpu_ConditionalExecutableInstruction.attributes={cpu_ConditionalExecutableInstruction_cache, cpu_ConditionalExecutableInstruction_bReg, cpu_ConditionalExecutableInstruction_data, cpu_ConditionalExecutableInstruction_dReg, cpu_ConditionalExecutableInstruction_cpu}
...
cpu_UnconditionalJumpExecutableInstruction.attributes={cpu_UnconditionalJumpExecutableInstruction_address, cpu_UnconditionalJumpExecutableInstruction_cpu}
...
cpu_IOExecutableInstruction.attributes={cpu_IOExecutableInstruction_reg2, cpu_IOExecutableInstruction_address, cpu_IOExecutableInstruction_reg1}
...
driver_Driver.attributes={driver_Driver_scheduler, driver_Driver_idleTimes, driver_Driver_threads, driver_Driver_registerSize, driver_Driver_cpus, driver_Driver_ramSize, driver_Driver_taskManager, driver_Driver_disk, driver_Driver_cacheSize, driver_Driver_loader, driver_Driver_dispatcher, driver_Driver_executeTimes}
...
driver_Loader.attributes={driver_Loader_pid, driver_Loader_tempBuffSize, driver_Loader_currAddress, driver_Loader_startInputBufferAddress, driver_Loader_endOutputBufferAddress, driver_Loader_outputBuffSize, driver_Loader_startInstructionAddress, driver_Loader_endInstructionAddress, driver_Loader_priority, driver_Loader_startTempBufferAddress, driver_Loader_inputBuffSize, driver_Loader_endTempBufferAddress, driver_Loader_endInputBufferAddres, driver_Loader_disk, driver_Loader_startOutputBufferAddress, driver_Loader_programFile, driver_Loader_processList, driver_Loader_instructionsLength}
...
driver_Dispatcher.attributes={driver_Dispatcher_cpus, driver_Dispatcher_mmu, driver_Dispatcher_taskManager}
...
driver_Scheduler.attributes={driver_Scheduler_schedulingMethod, driver_Scheduler_taskManager, driver_Scheduler_disk, driver_Scheduler_mmu}
