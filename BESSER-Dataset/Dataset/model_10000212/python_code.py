...
class Warehouse:
    ...
    def __init__(self, database: str, location: str, product31: set["Product"] = None, shipment28: set["Shipment"] = None):
...
class Product:
    ...
    def __init__(self, name: str, id: int, type: str, warehouse30: set["Warehouse"] = None, oRDER25: set["Order"] = None):
        self.name = name
        self.id = id
        self.type = type
