...
class eavlibrary_Writer:
    ...
    def __init__(self, name: str, Writer: "eavlibrary_Book" = None, eavlibrary_Writer: "eavlibrary_Library" = None, author: set["eavlibrary_Book"] = None, eavlibrary_Writer6: "eavlibrary_City" = None):
        self.name = name
        self.Writer = Writer
