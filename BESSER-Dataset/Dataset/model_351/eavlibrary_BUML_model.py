...
eavlibrary_Book.attributes={eavlibrary_Book_category, eavlibrary_Book_test, eavlibrary_Book_title, eavlibrary_Book_pages}
...
domain_model = DomainModel(
    name="eavlibrary",
    types={eavlibrary_Book, eavlibrary_Writer, eavlibrary_City, eavlibrary_Library, BookCategory},
    associations={author0, writers1, books2, books4, city5},
    generalizations={},
    metadata=None
)
