...
class fiacre_Transition(EModelElement):
    ...
    def __init__(self, Transition: "fiacre_State" = None, fiacre_Transition: "fiacre_Process" = None, transition: set["fiacre_State"] = None):
...
class fiacre_State(EModelElement):
    ...
    def __init__(self, ID: str, state: set["fiacre_Transition"] = None, fiacre_State: "fiacre_Process" = None, State: "fiacre_Transition" = None):
        self.ID = ID
...
class fiacre_Component(EModelElement):
    ...
    def __init__(self, ID: str, Component: "fiacre_Variable" = None, fiacre_Component15: "fiacre_Program" = None, fiacre_Component: set["fiacre_Process"] = None, component: set["fiacre_Variable"] = None):
        self.ID = ID
...
class fiacre_Variable(EModelElement):
    ...
    def __init__(self, ID: str, Variable: "fiacre_Process" = None, fiacre_Variable: "fiacre_DataType" = None, variable: set["fiacre_Process"] = None, variable9: set["fiacre_Component"] = None, fiacre_Variable18: "fiacre_Program" = None, Variable13: "fiacre_Component" = None):
        self.ID = ID
...
class fiacre_Process(EModelElement):
    ...
    def __init__(self, ID: str, fiacre_Process: set["fiacre_State"] = None, fiacre_Process3: set["fiacre_Transition"] = None, process: set["fiacre_Variable"] = None, Process: "fiacre_Variable" = None, fiacre_Process21: "fiacre_Program" = None, fiacre_Process11: "fiacre_Component" = None):
        self.ID = ID
