...
# Classes
fiacre_Process = Class(name="fiacre_Process")
fiacre_Variable = Class(name="fiacre_Variable")
fiacre_DataType = Class(name="fiacre_DataType")
fiacre_Component = Class(name="fiacre_Component")
fiacre_State = Class(name="fiacre_State")
EModelElement = Class(name="EModelElement")
fiacre_Transition = Class(name="fiacre_Transition")
fiacre_Init = Class(name="fiacre_Init")
...
fiacre_Transition.methods={fiacre_Transition_m_Trigger, fiacre_Transition_m_Guard, fiacre_Transition_m_Action}
...
domain_model = DomainModel(
    name="fiacre",
    types={fiacre_Process, fiacre_Variable, fiacre_DataType, fiacre_Component, fiacre_State, EModelElement, fiacre_Transition, fiacre_Init, State, fiacre_Program},
    associations={transition0, state1, transition2, variable4, state5, datatype6, process7, component8, component14, variable16, process19, process10, variable12},
    generalizations={gen_fiacre_Process_EModelElement, gen_fiacre_Transition_EModelElement, gen_fiacre_DataType_EModelElement, gen_fiacre_Variable_EModelElement, gen_fiacre_State_EModelElement, gen_fiacre_Init_State, gen_fiacre_Component_EModelElement, gen_fiacre_Program_EModelElement},
    metadata=None
)
