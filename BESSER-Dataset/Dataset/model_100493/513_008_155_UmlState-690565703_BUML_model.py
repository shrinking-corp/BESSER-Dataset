...
umlState_DoRule.attributes={umlState_DoRule_kind, umlState_DoRule_behaviorName}
...
domain_model = DomainModel(
    name="umlState",
    types={umlState_StateRule, umlState_SubmachineRule, umlState_EntryRule, umlState_DoRule, umlState_QualifiedName, umlState_StateMachine, umlState_Namespace, umlState_ExitRule, BehaviorKind},
    associations={submachine0, entry1, do3, path7, submachine9, path11, remaining14, exit5},
    generalizations={},
    metadata=None
)
