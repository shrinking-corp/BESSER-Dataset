...
class graph_Node:
    ...
    def __init__(self, name: str, source: set["graph_Edge"] = None, graph_Node: "graph_Graph" = None, target: set["graph_Edge"] = None, Node: "graph_Edge" = None, Node6: "graph_Edge" = None):
        self.name = name
