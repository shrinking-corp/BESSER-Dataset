...
public class bpmn2_Process extends FlowElementsContainer, CallableElement {
    ...
    public bpmn2_Process(
        boolean isExecutable,        boolean isClosed,        String processType    ) {
        super(
        );
    ...
    public bpmn2_Process(
        boolean isExecutable,        boolean isClosed,        String processType        ArrayList<bpmn2_Process> bpmn2_processs,        ArrayList<bpmn2_CorrelationSubscription> bpmn2_correlationsubscriptions,        ArrayList<bpmn2_Artifact> bpmn2_artifacts,        ArrayList<bpmn2_ResourceRole> bpmn2_resourceroles    ) {
        this.isExecutable = isExecutable;
        this.isClosed = isClosed;
        this.processType = processType;
