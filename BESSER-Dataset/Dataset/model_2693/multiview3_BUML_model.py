...
multiview3_B = Class(name="multiview3_B")
multiview3_E = Class(name="multiview3_E")
multiview3_K = Class(name="multiview3_K")
multiview3_C = Class(name="multiview3_C")
multiview3_F = Class(name="multiview3_F")
multiview3_H = Class(name="multiview3_H")
multiview3_Named = Class(name="multiview3_Named")
multiview3_A = Class(name="multiview3_A")
multiview3_M = Class(name="multiview3_M")
multiview3_W = Class(name="multiview3_W")
...
domain_model = DomainModel(
    name="multiview3",
    types={Named, multiview3_B, multiview3_E, multiview3_K, multiview3_C, multiview3_F, multiview3_H, multiview3_Named, multiview3_A, multiview3_M, multiview3_W},
    associations={bs0, es1, aks3, cs5, bfs7, hs9, ks11, ms19, wc21, fs14, ws17},
    generalizations={gen_multiview3_A_Named, gen_multiview3_B_Named, gen_multiview3_C_Named, gen_multiview3_H_Named, gen_multiview3_K_Named, gen_multiview3_M_Named, gen_multiview3_W_Named, gen_multiview3_E_Named, gen_multiview3_F_Named},
    metadata=None
)
