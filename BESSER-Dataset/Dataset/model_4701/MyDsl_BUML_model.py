...
myDsl_TopLevelCmd = Class(name="myDsl_TopLevelCmd")
myDsl_Expr = Class(name="myDsl_Expr")
myDsl_Def = Class(name="myDsl_Def")
TopLevelCmd = Class(name="TopLevelCmd")
myDsl_App = Class(name="myDsl_App")
Expr = Class(name="Expr")
myDsl_Var = Class(name="myDsl_Var")
myDsl_This = Class(name="myDsl_This")
myDsl_Bool = Class(name="myDsl_Bool")
myDsl_Copy = Class(name="myDsl_Copy")
myDsl_With = Class(name="myDsl_With")
myDsl_Not = Class(name="myDsl_Not")
myDsl_If = Class(name="myDsl_If")
myDsl_Let = Class(name="myDsl_Let")
myDsl_Int = Class(name="myDsl_Int")
myDsl_Skip = Class(name="myDsl_Skip")
myDsl_Project = Class(name="myDsl_Project")
myDsl_BObject = Class(name="myDsl_BObject")
myDsl_Field = Class(name="myDsl_Field")
myDsl_ArithOpPlus = Class(name="myDsl_ArithOpPlus")
myDsl_ArithOpMinus = Class(name="myDsl_ArithOpMinus")
myDsl_ArithOpTimes = Class(name="myDsl_ArithOpTimes")
myDsl_ArithOpDivide = Class(name="myDsl_ArithOpDivide")
myDsl_Fun = Class(name="myDsl_Fun")
myDsl_Assign = Class(name="myDsl_Assign")
myDsl_BoolOpOr = Class(name="myDsl_BoolOpOr")
myDsl_Seq = Class(name="myDsl_Seq")
myDsl_CmpOpEqual = Class(name="myDsl_CmpOpEqual")
myDsl_ArithOpRemainder = Class(name="myDsl_ArithOpRemainder")
myDsl_BoolOpAnd = Class(name="myDsl_BoolOpAnd")
myDsl_CmpOpUnequal = Class(name="myDsl_CmpOpUnequal")
myDsl_CmpOpLess = Class(name="myDsl_CmpOpLess")
...
domain_model = DomainModel(
    name="myDsl",
    types={myDsl_File, myDsl_TopLevelCmd, myDsl_Expr, myDsl_Def, TopLevelCmd, myDsl_App, Expr, myDsl_Var, myDsl_This, myDsl_Bool, myDsl_Copy, myDsl_With, myDsl_Not, myDsl_If, myDsl_Let, myDsl_Int, myDsl_Skip, myDsl_Project, myDsl_BObject, myDsl_Field, myDsl_ArithOpPlus, myDsl_ArithOpMinus, myDsl_ArithOpTimes, myDsl_ArithOpDivide, myDsl_Fun, myDsl_Assign, myDsl_BoolOpOr, myDsl_Seq, myDsl_CmpOpEqual, myDsl_ArithOpRemainder, myDsl_BoolOpAnd, myDsl_CmpOpUnequal, myDsl_CmpOpLess},
    associations={commands0, expr1, lhs2, rhs4, copy10, lhs12, rhs14, value17, cond19, thn21, els24, exp7, fields9, rhs36, lhs39, rhs41, lhs44, rhs46, lhs49, rhs51, lhs27, rhs29, body32, lhs34, lhs64, rhs66, lhs69, rhs71, lhs74, rhs76, lhs79, lhs54, rhs56, lhs59, rhs61, lhs89, rhs91, value94, rhs81, lhs84, rhs86},
    generalizations={gen_myDsl_Def_TopLevelCmd, gen_myDsl_App_TopLevelCmd, gen_myDsl_App_Expr, gen_myDsl_Var_TopLevelCmd, gen_myDsl_Var_Expr, gen_myDsl_This_TopLevelCmd, gen_myDsl_This_Expr, gen_myDsl_Bool_TopLevelCmd, gen_myDsl_Bool_Expr, gen_myDsl_Copy_TopLevelCmd, gen_myDsl_Copy_Expr, gen_myDsl_With_TopLevelCmd, gen_myDsl_With_Expr, gen_myDsl_Not_TopLevelCmd, gen_myDsl_Not_Expr, gen_myDsl_If_TopLevelCmd, gen_myDsl_If_Expr, gen_myDsl_Let_TopLevelCmd, gen_myDsl_Let_Expr, gen_myDsl_Int_TopLevelCmd, gen_myDsl_Int_Expr, gen_myDsl_Skip_TopLevelCmd, gen_myDsl_Skip_Expr, gen_myDsl_Project_TopLevelCmd, gen_myDsl_Project_Expr, gen_myDsl_BObject_TopLevelCmd, gen_myDsl_BObject_Expr, gen_myDsl_ArithOpPlus_TopLevelCmd, gen_myDsl_ArithOpPlus_Expr, gen_myDsl_ArithOpMinus_TopLevelCmd, gen_myDsl_ArithOpMinus_Expr, gen_myDsl_ArithOpTimes_TopLevelCmd, gen_myDsl_ArithOpTimes_Expr, gen_myDsl_ArithOpDivide_TopLevelCmd, gen_myDsl_ArithOpDivide_Expr, gen_myDsl_Fun_TopLevelCmd, gen_myDsl_Fun_Expr, gen_myDsl_Assign_TopLevelCmd, gen_myDsl_Assign_Expr, gen_myDsl_BoolOpAnd_Expr, gen_myDsl_BoolOpOr_TopLevelCmd, gen_myDsl_BoolOpOr_Expr, gen_myDsl_Seq_TopLevelCmd, gen_myDsl_Seq_Expr, gen_myDsl_CmpOpEqual_TopLevelCmd, gen_myDsl_CmpOpEqual_Expr, gen_myDsl_ArithOpRemainder_TopLevelCmd, gen_myDsl_ArithOpRemainder_Expr, gen_myDsl_BoolOpAnd_TopLevelCmd, gen_myDsl_CmpOpLess_TopLevelCmd, gen_myDsl_CmpOpLess_Expr, gen_myDsl_CmpOpUnequal_TopLevelCmd, gen_myDsl_CmpOpUnequal_Expr},
    metadata=None
)
