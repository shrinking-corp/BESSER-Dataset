...
def test_hyp_mydsl_field_is_not_abstract():
    assert not inspect.isabstract(myDsl_Field)


def test_hyp_mydsl_field_constructor_exists():
    assert callable(myDsl_Field.__init__)


def test_hyp_mydsl_field_constructor_args():
...
def test_hyp_mydsl_arithopremainder_is_not_abstract():
    assert not inspect.isabstract(myDsl_ArithOpRemainder)


def test_hyp_mydsl_arithopremainder_constructor_exists():
    assert callable(myDsl_ArithOpRemainder.__init__)


def test_hyp_mydsl_arithopremainder_constructor_args():
...
def test_hyp_mydsl_bool_is_not_abstract():
    assert not inspect.isabstract(myDsl_Bool)


def test_hyp_mydsl_bool_constructor_exists():
    assert callable(myDsl_Bool.__init__)


def test_hyp_mydsl_bool_constructor_args():
...
def test_hyp_mydsl_cmpopunequal_is_not_abstract():
    assert not inspect.isabstract(myDsl_CmpOpUnequal)


def test_hyp_mydsl_cmpopunequal_constructor_exists():
    assert callable(myDsl_CmpOpUnequal.__init__)


def test_hyp_mydsl_cmpopunequal_constructor_args():
    sig = inspect.signature(myDsl_CmpOpUnequal.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mydsl_boolopor_is_not_abstract():
    assert not inspect.isabstract(myDsl_BoolOpOr)


def test_hyp_mydsl_boolopor_constructor_exists():
    assert callable(myDsl_BoolOpOr.__init__)


def test_hyp_mydsl_boolopor_constructor_args():
    sig = inspect.signature(myDsl_BoolOpOr.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mydsl_project_is_not_abstract():
    assert not inspect.isabstract(myDsl_Project)


def test_hyp_mydsl_project_constructor_exists():
    assert callable(myDsl_Project.__init__)


def test_hyp_mydsl_project_constructor_args():
...
def test_hyp_mydsl_copy_is_not_abstract():
    assert not inspect.isabstract(myDsl_Copy)


def test_hyp_mydsl_copy_constructor_exists():
    assert callable(myDsl_Copy.__init__)


def test_hyp_mydsl_copy_constructor_args():
    sig = inspect.signature(myDsl_Copy.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mydsl_int_is_not_abstract():
    assert not inspect.isabstract(myDsl_Int)


def test_hyp_mydsl_int_constructor_exists():
    assert callable(myDsl_Int.__init__)


def test_hyp_mydsl_int_constructor_args():
...
def test_hyp_mydsl_boolopand_is_not_abstract():
    assert not inspect.isabstract(myDsl_BoolOpAnd)


def test_hyp_mydsl_boolopand_constructor_exists():
    assert callable(myDsl_BoolOpAnd.__init__)


def test_hyp_mydsl_boolopand_constructor_args():
    sig = inspect.signature(myDsl_BoolOpAnd.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mydsl_this_is_not_abstract():
    assert not inspect.isabstract(myDsl_This)


def test_hyp_mydsl_this_constructor_exists():
    assert callable(myDsl_This.__init__)


def test_hyp_mydsl_this_constructor_args():
    sig = inspect.signature(myDsl_This.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mydsl_assign_is_not_abstract():
    assert not inspect.isabstract(myDsl_Assign)


def test_hyp_mydsl_assign_constructor_exists():
    assert callable(myDsl_Assign.__init__)


def test_hyp_mydsl_assign_constructor_args():
...
def test_hyp_mydsl_cmpopless_is_not_abstract():
    assert not inspect.isabstract(myDsl_CmpOpLess)


def test_hyp_mydsl_cmpopless_constructor_exists():
    assert callable(myDsl_CmpOpLess.__init__)


def test_hyp_mydsl_cmpopless_constructor_args():
    sig = inspect.signature(myDsl_CmpOpLess.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mydsl_seq_is_not_abstract():
    assert not inspect.isabstract(myDsl_Seq)


def test_hyp_mydsl_seq_constructor_exists():
    assert callable(myDsl_Seq.__init__)


def test_hyp_mydsl_seq_constructor_args():
    sig = inspect.signature(myDsl_Seq.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mydsl_with_is_not_abstract():
    assert not inspect.isabstract(myDsl_With)


def test_hyp_mydsl_with_constructor_exists():
    assert callable(myDsl_With.__init__)


def test_hyp_mydsl_with_constructor_args():
    sig = inspect.signature(myDsl_With.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mydsl_bobject_is_not_abstract():
    assert not inspect.isabstract(myDsl_BObject)


def test_hyp_mydsl_bobject_constructor_exists():
    assert callable(myDsl_BObject.__init__)


def test_hyp_mydsl_bobject_constructor_args():
    sig = inspect.signature(myDsl_BObject.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mydsl_arithopminus_is_not_abstract():
    assert not inspect.isabstract(myDsl_ArithOpMinus)


def test_hyp_mydsl_arithopminus_constructor_exists():
    assert callable(myDsl_ArithOpMinus.__init__)


def test_hyp_mydsl_arithopminus_constructor_args():
    sig = inspect.signature(myDsl_ArithOpMinus.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mydsl_cmpopequal_is_not_abstract():
    assert not inspect.isabstract(myDsl_CmpOpEqual)


def test_hyp_mydsl_cmpopequal_constructor_exists():
    assert callable(myDsl_CmpOpEqual.__init__)


def test_hyp_mydsl_cmpopequal_constructor_args():
    sig = inspect.signature(myDsl_CmpOpEqual.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mydsl_fun_is_not_abstract():
    assert not inspect.isabstract(myDsl_Fun)


def test_hyp_mydsl_fun_constructor_exists():
    assert callable(myDsl_Fun.__init__)


def test_hyp_mydsl_fun_constructor_args():
...
def test_hyp_mydsl_arithoptimes_is_not_abstract():
    assert not inspect.isabstract(myDsl_ArithOpTimes)


def test_hyp_mydsl_arithoptimes_constructor_exists():
    assert callable(myDsl_ArithOpTimes.__init__)


def test_hyp_mydsl_arithoptimes_constructor_args():
    sig = inspect.signature(myDsl_ArithOpTimes.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mydsl_app_is_not_abstract():
    assert not inspect.isabstract(myDsl_App)


def test_hyp_mydsl_app_constructor_exists():
    assert callable(myDsl_App.__init__)


def test_hyp_mydsl_app_constructor_args():
    sig = inspect.signature(myDsl_App.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mydsl_arithopdivide_is_not_abstract():
    assert not inspect.isabstract(myDsl_ArithOpDivide)


def test_hyp_mydsl_arithopdivide_constructor_exists():
    assert callable(myDsl_ArithOpDivide.__init__)


def test_hyp_mydsl_arithopdivide_constructor_args():
    sig = inspect.signature(myDsl_ArithOpDivide.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mydsl_skip_is_not_abstract():
    assert not inspect.isabstract(myDsl_Skip)


def test_hyp_mydsl_skip_constructor_exists():
    assert callable(myDsl_Skip.__init__)


def test_hyp_mydsl_skip_constructor_args():
    sig = inspect.signature(myDsl_Skip.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mydsl_arithopplus_is_not_abstract():
    assert not inspect.isabstract(myDsl_ArithOpPlus)


def test_hyp_mydsl_arithopplus_constructor_exists():
    assert callable(myDsl_ArithOpPlus.__init__)


def test_hyp_mydsl_arithopplus_constructor_args():
    sig = inspect.signature(myDsl_ArithOpPlus.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mydsl_def_is_not_abstract():
    assert not inspect.isabstract(myDsl_Def)


def test_hyp_mydsl_def_constructor_exists():
    assert callable(myDsl_Def.__init__)


def test_hyp_mydsl_def_constructor_args():
...
def test_hyp_mydsl_toplevelcmd_is_not_abstract():
    assert not inspect.isabstract(myDsl_TopLevelCmd)


def test_hyp_mydsl_toplevelcmd_constructor_exists():
    assert callable(myDsl_TopLevelCmd.__init__)


def test_hyp_mydsl_toplevelcmd_constructor_args():
...
def test_hyp_mydsl_field_name_setter(instance):
...
def test_hyp_mydsl_var_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_mydsl_let_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_mydsl_bool_value_setter(instance):
...
def test_hyp_mydsl_project_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_mydsl_int_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_mydsl_assign_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_mydsl_fun_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_mydsl_def_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
