...
class FiniteStateMachines_State:
    ...
    def __init__(self, isEndState: bool, isStartState: bool, name: str, FiniteStateMachines_State: "FiniteStateMachines_FiniteStateMachine" = None, startState: set["FiniteStateMachines_Transition"] = None, State: "FiniteStateMachines_Transition" = None, FiniteStateMachines_State7: "FiniteStateMachines_Transition" = None):
...
class FiniteStateMachines_FiniteStateMachine:
    ...
    def __init__(self, id: str, FiniteStateMachines_FiniteStateMachine: set["FiniteStateMachines_State"] = None, FiniteStateMachines_FiniteStateMachine2: set["FiniteStateMachines_Transition"] = None):
        self.id = id
