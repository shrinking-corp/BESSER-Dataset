...
# Classes
FiniteStateMachines_FiniteStateMachine = Class(name="FiniteStateMachines_FiniteStateMachine")
FiniteStateMachines_State = Class(name="FiniteStateMachines_State")
FiniteStateMachines_Transition = Class(name="FiniteStateMachines_Transition")
...
FiniteStateMachines_State.attributes={FiniteStateMachines_State_isEndState, FiniteStateMachines_State_name, FiniteStateMachines_State_isStartState}
...
domain_model = DomainModel(
    ...
    types={FiniteStateMachines_FiniteStateMachine, FiniteStateMachines_State, FiniteStateMachines_Transition},
    associations={states0, transitions1, transitions3, startState4, endState5},
    generalizations={},
    metadata=None
)
