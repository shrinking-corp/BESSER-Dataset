...
Customer.attributes={Customer_Customer_Name, Customer_Credit_Card_Info, Customer_Address, Customer_email}
...
User.attributes={User_Password, User_User_Id, User_Login_Status}
...
Shopping_Cart.attributes={Shopping_Cart_Product_id, Shopping_Cart_Quantity, Shopping_Cart_Cart_id}
...
Orders.attributes={Orders_Status, Orders_Date_Created, Orders_Order_id, Orders_Customer_Id, Orders_Date_Shipped}
...
Shipping_Info.attributes={Shipping_Info_Shipping_Type, Shipping_Info_Shipping_Id}
...
Order_Details.attributes={Order_Details_Order_Id, Order_Details_Product_Name, Order_Details_Quantity, Order_Details_Product_Id, Order_Details_Unicast, Order_Details_Sub_Total}
