...
family_Parent = Class(name="family_Parent")
...
family_Person.attributes={family_Person_lastname, family_Person_firstname, family_Person_birthdate}
...
domain_model = DomainModel(
    name="family",
    types={family_Person, family_Parent, Person, family_Child, family_Mother, Parent, family_Father, family_Family},
    associations={children0, husband1, wife2, mother5, father8, members11},
    generalizations={gen_family_Father_Parent, gen_family_Parent_Person, gen_family_Mother_Parent, gen_family_Child_Person},
    metadata=None
)
