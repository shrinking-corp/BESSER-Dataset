...
def test_hyp_sqlmetamodel_foreingkey_is_not_abstract():
    assert not inspect.isabstract(SqlMetamodel_ForeingKey)


def test_hyp_sqlmetamodel_foreingkey_constructor_exists():
    assert callable(SqlMetamodel_ForeingKey.__init__)


def test_hyp_sqlmetamodel_foreingkey_constructor_args():
    sig = inspect.signature(SqlMetamodel_ForeingKey.__init__)
    params = list(sig.parameters.keys())



def test_hyp_sqlmetamodel_primarykey_is_not_abstract():
    assert not inspect.isabstract(SqlMetamodel_PrimaryKey)


def test_hyp_sqlmetamodel_primarykey_constructor_exists():
    assert callable(SqlMetamodel_PrimaryKey.__init__)


def test_hyp_sqlmetamodel_primarykey_constructor_args():
    sig = inspect.signature(SqlMetamodel_PrimaryKey.__init__)
    params = list(sig.parameters.keys())



def test_hyp_sqlmetamodel_constraint_is_not_abstract():
    assert not inspect.isabstract(SqlMetamodel_Constraint)


def test_hyp_sqlmetamodel_constraint_constructor_exists():
    assert callable(SqlMetamodel_Constraint.__init__)


def test_hyp_sqlmetamodel_constraint_constructor_args():
...
def test_hyp_sqlmetamodel_column_is_not_abstract():
    assert not inspect.isabstract(SqlMetamodel_Column)


def test_hyp_sqlmetamodel_column_constructor_exists():
    assert callable(SqlMetamodel_Column.__init__)


def test_hyp_sqlmetamodel_column_constructor_args():
...
def test_hyp_sqlmetamodel_table_is_not_abstract():
    assert not inspect.isabstract(SqlMetamodel_Table)


def test_hyp_sqlmetamodel_table_constructor_exists():
    assert callable(SqlMetamodel_Table.__init__)


def test_hyp_sqlmetamodel_table_constructor_args():
...
def test_hyp_sqlmetamodel_schema_is_not_abstract():
    assert not inspect.isabstract(SqlMetamodel_Schema)


def test_hyp_sqlmetamodel_schema_constructor_exists():
    assert callable(SqlMetamodel_Schema.__init__)


def test_hyp_sqlmetamodel_schema_constructor_args():
...
def test_hyp_sqlmetamodel_constraint_name_setter(instance):
...
def test_hyp_sqlmetamodel_column_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=SqlMetamodel_Column_strategy)
def test_hyp_sqlmetamodel_column_nullable_setter(instance):
...
@given(instance=SqlMetamodel_Column_strategy)
def test_hyp_sqlmetamodel_column_type_setter(instance):
...
def test_hyp_sqlmetamodel_table_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_sqlmetamodel_schema_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
