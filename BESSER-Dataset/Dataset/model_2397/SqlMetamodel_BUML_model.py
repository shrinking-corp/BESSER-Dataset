...
# Classes
SqlMetamodel_Schema = Class(name="SqlMetamodel_Schema")
SqlMetamodel_Table = Class(name="SqlMetamodel_Table")
SqlMetamodel_Column = Class(name="SqlMetamodel_Column")
SqlMetamodel_Constraint = Class(name="SqlMetamodel_Constraint")
SqlMetamodel_PrimaryKey = Class(name="SqlMetamodel_PrimaryKey")
SqlMetamodel_ForeingKey = Class(name="SqlMetamodel_ForeingKey")
...
SqlMetamodel_Column.attributes={SqlMetamodel_Column_name, SqlMetamodel_Column_type, SqlMetamodel_Column_nullable}
...
domain_model = DomainModel(
    name="SqlMetamodel",
    types={SqlMetamodel_Schema, SqlMetamodel_Table, SqlMetamodel_Column, SqlMetamodel_Constraint, SqlMetamodel_PrimaryKey, SqlMetamodel_ForeingKey, Constraint, TypeData},
    associations={table0, column1, constraint3, primaryKey5, refTable7},
