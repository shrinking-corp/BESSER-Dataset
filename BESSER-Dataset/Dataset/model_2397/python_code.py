...
class SqlMetamodel_Table:
    ...
    def __init__(self, name: str, SqlMetamodel_Table: "SqlMetamodel_Schema" = None, SqlMetamodel_Table2: set["SqlMetamodel_Column"] = None, SqlMetamodel_Table4: set["SqlMetamodel_Constraint"] = None, SqlMetamodel_Table6: "SqlMetamodel_PrimaryKey" = None, SqlMetamodel_Table8: "SqlMetamodel_ForeingKey" = None):
        self.name = name
