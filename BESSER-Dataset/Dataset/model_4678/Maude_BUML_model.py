...
# Classes
Maude_MaudeTopEl = Class(name="Maude_MaudeTopEl", is_abstract=True)
Maude_MaudeSpec = Class(name="Maude_MaudeSpec")
Maude_RenMapping = Class(name="Maude_RenMapping", is_abstract=True)
Maude_CompModExp = Class(name="Maude_CompModExp")
Maude_ModuleIdModExp = Class(name="Maude_ModuleIdModExp")
Maude_Module = Class(name="Maude_Module", is_abstract=True)
Maude_ModExpression = Class(name="Maude_ModExpression", is_abstract=True)
Maude_InstModExp = Class(name="Maude_InstModExp")
ModExpression = Class(name="ModExpression")
Maude_View = Class(name="Maude_View")
Maude_RenModExp = Class(name="Maude_RenModExp")
Maude_ModImportation = Class(name="Maude_ModImportation")
ModElement = Class(name="ModElement")
Maude_TheoryIdModExp = Class(name="Maude_TheoryIdModExp")
Maude_Theory = Class(name="Maude_Theory", is_abstract=True)
Maude_Parameter = Class(name="Maude_Parameter")
MaudeTopEl = Class(name="MaudeTopEl")
Maude_ModElement = Class(name="Maude_ModElement", is_abstract=True)
Maude_FTheory = Class(name="Maude_FTheory")
Theory = Class(name="Theory")
Maude_STheory = Class(name="Maude_STheory")
Maude_FModule = Class(name="Maude_FModule")
Module = Class(name="Module")
Maude_SModule = Class(name="Maude_SModule")
Maude_Statement = Class(name="Maude_Statement", is_abstract=True)
Maude_Condition = Class(name="Maude_Condition", is_abstract=True)
Maude_Type = Class(name="Maude_Type", is_abstract=True)
Maude_Sort = Class(name="Maude_Sort")
Type = Class(name="Type")
Maude_SubsortRel = Class(name="Maude_SubsortRel")
Maude_Kind = Class(name="Maude_Kind")
Maude_Operation = Class(name="Maude_Operation")
Maude_MembershipCond = Class(name="Maude_MembershipCond")
EquationalCond = Class(name="EquationalCond")
Maude_BooleanCond = Class(name="Maude_BooleanCond")
Maude_MatchingCond = Class(name="Maude_MatchingCond")
Maude_Membership = Class(name="Maude_Membership")
Statement = Class(name="Statement")
Maude_Term = Class(name="Maude_Term", is_abstract=True)
Maude_Equation = Class(name="Maude_Equation")
Maude_Rule = Class(name="Maude_Rule")
Maude_EquationalCond = Class(name="Maude_EquationalCond", is_abstract=True)
Condition = Class(name="Condition")
Maude_RewriteCond = Class(name="Maude_RewriteCond")
ViewMapping = Class(name="ViewMapping")
Maude_TermMapping = Class(name="Maude_TermMapping")
Maude_SortMapping = Class(name="Maude_SortMapping")
RenMapping = Class(name="RenMapping")
Maude_EqualCond = Class(name="Maude_EqualCond")
Maude_Constant = Class(name="Maude_Constant")
Term = Class(name="Term")
Maude_RecTerm = Class(name="Maude_RecTerm")
Maude_Variable = Class(name="Maude_Variable")
Maude_ViewMapping = Class(name="Maude_ViewMapping", is_abstract=True)
Maude_OpTypedMapping = Class(name="Maude_OpTypedMapping")
Maude_OpMapping = Class(name="Maude_OpMapping")
Maude_LabelMapping = Class(name="Maude_LabelMapping")
...
Maude_LabelMapping_from_: Property = Property(name="from_", type=StringType)
Maude_LabelMapping_to: Property = Property(name="to", type=StringType)
Maude_LabelMapping.attributes={Maude_LabelMapping_to, Maude_LabelMapping_from_}
...
from_71: BinaryAssociation = BinaryAssociation(
    name="from_71",
    ends={
...
from_86: BinaryAssociation = BinaryAssociation(
    name="from_86",
    ends={
...
from_88: BinaryAssociation = BinaryAssociation(
    name="from_88",
    ends={
...
domain_model = DomainModel(
    name="Maude",
    types={Maude_MaudeTopEl, Maude_MaudeSpec, Maude_RenMapping, Maude_CompModExp, Maude_ModuleIdModExp, Maude_Module, Maude_ModExpression, Maude_InstModExp, ModExpression, Maude_View, Maude_RenModExp, Maude_ModImportation, ModElement, Maude_TheoryIdModExp, Maude_Theory, Maude_Parameter, MaudeTopEl, Maude_ModElement, Maude_FTheory, Theory, Maude_STheory, Maude_FModule, Module, Maude_SModule, Maude_Statement, Maude_Condition, Maude_Type, Maude_Sort, Type, Maude_SubsortRel, Maude_Kind, Maude_Operation, Maude_MembershipCond, EquationalCond, Maude_BooleanCond, Maude_MatchingCond, Maude_Membership, Statement, Maude_Term, Maude_Equation, Maude_Rule, Maude_EquationalCond, Condition, Maude_RewriteCond, ViewMapping, Maude_TermMapping, Maude_SortMapping, RenMapping, Maude_EqualCond, Maude_Constant, Term, Maude_RecTerm, Maude_Variable, Maude_ViewMapping, Maude_OpTypedMapping, Maude_OpMapping, Maude_LabelMapping, ImportationMode},
    associations={els0, printableEls1, renamings9, modExps11, modExp4, views5, modExp7, module23, theory24, imports26, module13, theory14, modExp15, els17, els18, params20, coarity37, arity38, conds41, subsortRels28, supersortRels29, kind31, sorts32, subsorts33, supersorts35, rhs58, rhs60, rhs62, term42, sort43, lhs45, rhs47, lhs50, rhs52, lhs55, from_79, to81, from_84, rhs64, type66, args69, from_71, to74, els77, from_86, from_88},
    generalizations={gen_Maude_CompModExp_ModExpression, gen_Maude_ModuleIdModExp_ModExpression, gen_Maude_InstModExp_ModExpression, gen_Maude_RenModExp_ModExpression, gen_Maude_ModImportation_ModElement, gen_Maude_TheoryIdModExp_ModExpression, gen_Maude_Parameter_ModExpression, gen_Maude_Theory_MaudeTopEl, gen_Maude_FTheory_Theory, gen_Maude_STheory_Theory, gen_Maude_Module_MaudeTopEl, gen_Maude_FModule_Module, gen_Maude_SModule_Module, gen_Maude_Statement_ModElement, gen_Maude_Sort_Type, gen_Maude_Sort_ModElement, gen_Maude_Kind_Type, gen_Maude_SubsortRel_ModElement, gen_Maude_Operation_ModElement, gen_Maude_MembershipCond_EquationalCond, gen_Maude_BooleanCond_EquationalCond, gen_Maude_MatchingCond_EquationalCond, gen_Maude_Membership_Statement, gen_Maude_Equation_Statement, gen_Maude_Rule_Statement, gen_Maude_EquationalCond_Condition, gen_Maude_RewriteCond_Condition, gen_Maude_RenMapping_ViewMapping, gen_Maude_TermMapping_ViewMapping, gen_Maude_SortMapping_RenMapping, gen_Maude_EqualCond_EquationalCond, gen_Maude_Constant_Term, gen_Maude_RecTerm_Term, gen_Maude_Variable_Term, gen_Maude_View_MaudeTopEl, gen_Maude_OpTypedMapping_RenMapping, gen_Maude_OpMapping_RenMapping, gen_Maude_LabelMapping_RenMapping},
    metadata=None
)
