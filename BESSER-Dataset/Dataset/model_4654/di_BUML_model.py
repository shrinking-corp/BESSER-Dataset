...
di_ExtensionType = Class(name="di_ExtensionType")
...
domain_model = DomainModel(
    name="di",
    types={di_Diagram, di_Point, di_Label, Node, di_DiagramElement, di_ExtensionType, di_Edge, DiagramElement, di_Shape, di_Style, di_DocumentRoot, di_Bounds, di_LabeledEdge, Edge, di_LabeledShape, Shape, di_Node, di_Plane, di_EStringToStringMapEntry},
    associations={waypoint1, extension0, diagramElement3, bounds5, bounds2, edge16, label19, labeledEdge22, labeledShape24, xMLNSPrefixMap7, xSISchemaLocation8, diagramElement11, diagram14, node26, plane28, shape31, style34},
    generalizations={gen_di_Label_Node, gen_di_Edge_DiagramElement, gen_di_Shape_Node, gen_di_LabeledEdge_Edge, gen_di_LabeledShape_Shape, gen_di_Node_DiagramElement, gen_di_Plane_Node},
    metadata=None
)
