...
# Classes
debugSeq_DebugSeqModel = Class(name="debugSeq_DebugSeqModel")
debugSeq_DebugVars = Class(name="debugSeq_DebugVars")
debugSeq_Sequences = Class(name="debugSeq_Sequences")
debugSeq_Statement = Class(name="debugSeq_Statement")
debugSeq_VariableDeclaration = Class(name="debugSeq_VariableDeclaration")
Statement = Class(name="Statement")
debugSeq_Expression = Class(name="debugSeq_Expression")
debugSeq_Sequence = Class(name="debugSeq_Sequence")
debugSeq_BitOr = Class(name="debugSeq_BitOr")
debugSeq_CodeBlock = Class(name="debugSeq_CodeBlock")
debugSeq_Block = Class(name="debugSeq_Block")
CodeBlock = Class(name="CodeBlock")
debugSeq_Control = Class(name="debugSeq_Control")
Parameter_ = Class(name="Parameter")
debugSeq_Parameter = Class(name="debugSeq_Parameter")
debugSeq_Assignment = Class(name="debugSeq_Assignment")
Expression = Class(name="Expression")
debugSeq_Ternary = Class(name="debugSeq_Ternary")
debugSeq_Or = Class(name="debugSeq_Or")
debugSeq_And = Class(name="debugSeq_And")
debugSeq_Minus = Class(name="debugSeq_Minus")
debugSeq_BitXor = Class(name="debugSeq_BitXor")
debugSeq_BitAnd = Class(name="debugSeq_BitAnd")
debugSeq_Equality = Class(name="debugSeq_Equality")
debugSeq_Comparison = Class(name="debugSeq_Comparison")
debugSeq_Shift = Class(name="debugSeq_Shift")
debugSeq_Plus = Class(name="debugSeq_Plus")
debugSeq_QueryValue = Class(name="debugSeq_QueryValue")
debugSeq_Mul = Class(name="debugSeq_Mul")
debugSeq_Div = Class(name="debugSeq_Div")
debugSeq_Rem = Class(name="debugSeq_Rem")
debugSeq_Not = Class(name="debugSeq_Not")
debugSeq_BitNot = Class(name="debugSeq_BitNot")
debugSeq_SequenceCall = Class(name="debugSeq_SequenceCall")
debugSeq_Query = Class(name="debugSeq_Query")
debugSeq_Message = Class(name="debugSeq_Message")
debugSeq_LoadDebugInfo = Class(name="debugSeq_LoadDebugInfo")
debugSeq_Read8 = Class(name="debugSeq_Read8")
debugSeq_Read16 = Class(name="debugSeq_Read16")
debugSeq_Read32 = Class(name="debugSeq_Read32")
debugSeq_Read64 = Class(name="debugSeq_Read64")
debugSeq_ReadAP = Class(name="debugSeq_ReadAP")
debugSeq_ReadDP = Class(name="debugSeq_ReadDP")
debugSeq_Write8 = Class(name="debugSeq_Write8")
debugSeq_DapDelay = Class(name="debugSeq_DapDelay")
debugSeq_Write16 = Class(name="debugSeq_Write16")
debugSeq_Write32 = Class(name="debugSeq_Write32")
debugSeq_Write64 = Class(name="debugSeq_Write64")
debugSeq_WriteAP = Class(name="debugSeq_WriteAP")
debugSeq_WriteDP = Class(name="debugSeq_WriteDP")
debugSeq_IntConstant = Class(name="debugSeq_IntConstant")
debugSeq_DapWriteABORT = Class(name="debugSeq_DapWriteABORT")
debugSeq_DapSwjPins = Class(name="debugSeq_DapSwjPins")
debugSeq_DapSwjClock = Class(name="debugSeq_DapSwjClock")
debugSeq_DapSwjSequence = Class(name="debugSeq_DapSwjSequence")
debugSeq_DapJtagSequence = Class(name="debugSeq_DapJtagSequence")
debugSeq_StringConstant = Class(name="debugSeq_StringConstant")
debugSeq_VariableRef = Class(name="debugSeq_VariableRef")
...
debugSeq_DebugVars.attributes={debugSeq_DebugVars_version, debugSeq_DebugVars_configfile, debugSeq_DebugVars_pname}
...
debugSeq_Sequence.attributes={debugSeq_Sequence_name, debugSeq_Sequence_disable, debugSeq_Sequence_info, debugSeq_Sequence_pname}
...
if_12: BinaryAssociation = BinaryAssociation(
    name="if_12",
    ends={
...
while_14: BinaryAssociation = BinaryAssociation(
    name="while_14",
    ends={
...
domain_model = DomainModel(
    name="debugSeq",
    types={debugSeq_DebugSeqModel, debugSeq_DebugVars, debugSeq_Sequences, debugSeq_Statement, debugSeq_VariableDeclaration, Statement, debugSeq_Expression, debugSeq_Sequence, debugSeq_BitOr, debugSeq_CodeBlock, debugSeq_Block, CodeBlock, debugSeq_Control, Parameter_, debugSeq_Parameter, debugSeq_Assignment, Expression, debugSeq_Ternary, debugSeq_Or, debugSeq_And, debugSeq_Minus, debugSeq_BitXor, debugSeq_BitAnd, debugSeq_Equality, debugSeq_Comparison, debugSeq_Shift, debugSeq_Plus, debugSeq_QueryValue, debugSeq_Mul, debugSeq_Div, debugSeq_Rem, debugSeq_Not, debugSeq_BitNot, debugSeq_SequenceCall, debugSeq_Query, debugSeq_Message, debugSeq_LoadDebugInfo, debugSeq_Read8, debugSeq_Read16, debugSeq_Read32, debugSeq_Read64, debugSeq_ReadAP, debugSeq_ReadDP, debugSeq_Write8, debugSeq_DapDelay, debugSeq_Write16, debugSeq_Write32, debugSeq_Write64, debugSeq_WriteAP, debugSeq_WriteDP, debugSeq_IntConstant, debugSeq_DapWriteABORT, debugSeq_DapSwjPins, debugSeq_DapSwjClock, debugSeq_DapSwjSequence, debugSeq_DapJtagSequence, debugSeq_StringConstant, debugSeq_VariableRef},
    associations={debugvars0, sequences1, statements3, value5, sequences6, right40, codeblocks8, statements10, if_12, while_14, codeblocks17, left20, right22, left25, exp127, exp230, left33, right35, left38, right75, left43, right45, left48, right50, left53, right55, left58, right60, left63, right65, left68, right70, left73, default104, left78, right80, left83, right85, left88, right90, left93, right95, expression98, expression100, type102, addr125, default107, type109, parameters111, addr113, addr115, addr117, addr119, addr121, addr123, delay155, val127, addr130, val132, addr135, val137, addr140, val142, addr145, val147, addr150, val152, value157, pinout159, pinselect161, pinwait164, value167, cnt169, val171, cnt174, tms176, tdi179, variable182},
    generalizations={gen_debugSeq_VariableDeclaration_Statement, gen_debugSeq_BitOr_Expression, gen_debugSeq_Block_CodeBlock, gen_debugSeq_Control_CodeBlock, gen_debugSeq_Expression_Statement, gen_debugSeq_Expression_Parameter, gen_debugSeq_Assignment_Expression, gen_debugSeq_Ternary_Expression, gen_debugSeq_Or_Expression, gen_debugSeq_And_Expression, gen_debugSeq_Minus_Expression, gen_debugSeq_BitXor_Expression, gen_debugSeq_BitAnd_Expression, gen_debugSeq_Equality_Expression, gen_debugSeq_Comparison_Expression, gen_debugSeq_Shift_Expression, gen_debugSeq_Plus_Expression, gen_debugSeq_QueryValue_Expression, gen_debugSeq_Mul_Expression, gen_debugSeq_Div_Expression, gen_debugSeq_Rem_Expression, gen_debugSeq_Not_Expression, gen_debugSeq_BitNot_Expression, gen_debugSeq_SequenceCall_Expression, gen_debugSeq_Query_Expression, gen_debugSeq_Message_Expression, gen_debugSeq_LoadDebugInfo_Expression, gen_debugSeq_Read8_Expression, gen_debugSeq_Read16_Expression, gen_debugSeq_Read32_Expression, gen_debugSeq_Read64_Expression, gen_debugSeq_ReadAP_Expression, gen_debugSeq_ReadDP_Expression, gen_debugSeq_Write8_Expression, gen_debugSeq_DapDelay_Expression, gen_debugSeq_Write16_Expression, gen_debugSeq_Write32_Expression, gen_debugSeq_Write64_Expression, gen_debugSeq_WriteAP_Expression, gen_debugSeq_WriteDP_Expression, gen_debugSeq_IntConstant_Expression, gen_debugSeq_DapWriteABORT_Expression, gen_debugSeq_DapSwjPins_Expression, gen_debugSeq_DapSwjClock_Expression, gen_debugSeq_DapSwjSequence_Expression, gen_debugSeq_DapJtagSequence_Expression, gen_debugSeq_StringConstant_Expression, gen_debugSeq_VariableRef_Expression},
    metadata=None
)
