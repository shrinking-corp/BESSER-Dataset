...
class debugSeq_Query(Expression):
    ...
    def __init__(self, message: str, debugSeq_Query105: "debugSeq_Expression" = None, debugSeq_Query: "debugSeq_Expression" = None):
...
class debugSeq_Equality(Expression):
    ...
    def __init__(self, op: str, debugSeq_Equality61: "debugSeq_Expression" = None, debugSeq_Equality: "debugSeq_Expression" = None):
        self.op = op
...
class debugSeq_Sequence:
    ...
    def __init__(self, name: str, disable: str, pname: str, info: str, debugSeq_Sequence: "debugSeq_Sequences" = None, debugSeq_Sequence9: set["debugSeq_CodeBlock"] = None):
        self.name = name
...
class Statement:
    ...
    pass
class debugSeq_Expression(Parameter, Statement):
