...
# Classes
myDot_Ref = Class(name="myDot_Ref")
myDot_Model = Class(name="myDot_Model")
myDot_Entity = Class(name="myDot_Entity")
myDot_Usage = Class(name="myDot_Usage")
myDot_Feature = Class(name="myDot_Feature")
myDot_Attribute = Class(name="myDot_Attribute")
Feature = Class(name="Feature")
myDot_Reference = Class(name="myDot_Reference")
myDot_DotExpression = Class(name="myDot_DotExpression")
Ref = Class(name="Ref")
myDot_EntityRef = Class(name="myDot_EntityRef")
...
domain_model = DomainModel(
    name="myDot",
    types={myDot_Ref, myDot_Model, myDot_Entity, myDot_Usage, myDot_Feature, myDot_Attribute, Feature, myDot_Reference, myDot_DotExpression, Ref, myDot_EntityRef, DataType},
    associations={ref7, entities0, usages1, features3, type5, ref9, tail11, entity14},
