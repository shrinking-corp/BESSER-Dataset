...
statemachine_State.attributes={statemachine_State_exit, statemachine_State_entry, statemachine_State_do}
...
statemachine_DataElement.attributes={statemachine_DataElement_name, statemachine_DataElement_port, statemachine_DataElement_ioType}
...
statemachine_Transition.attributes={statemachine_Transition_expression, statemachine_Transition_id, statemachine_Transition_priority}
...
domain_model = DomainModel(
    name="statemachine",
    types={statemachine_State, Node, statemachine_Pseudostate, statemachine_DataElement, statemachine_Region, statemachine_Node, statemachine_Transition, statemachine_FinalState, State, statemachine_Variable, DataElement, statemachine_Event, statemachine_Statechart, PseudoTypes, DataTypes, IOTypes, TriggerTypes},
    associations={sourceNode3, region6, state0, targetNode1, transition12, dataElement8, region9},
    generalizations={gen_statemachine_State_Node, gen_statemachine_Pseudostate_Node, gen_statemachine_FinalState_State, gen_statemachine_Variable_DataElement, gen_statemachine_Event_DataElement},
    metadata=None
)
