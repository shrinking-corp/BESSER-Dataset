...
class statemachine_Region:
    ...
    def __init__(self, priority: int, statemachine_Region7: "statemachine_State" = None, statemachine_Region: set["statemachine_Node"] = None, statemachine_Region11: "statemachine_Statechart" = None):
...
class statemachine_Statechart:
    ...
    def __init__(self, name: str, UUID: str, statemachine_Statechart13: set["statemachine_Transition"] = None, statemachine_Statechart: set["statemachine_DataElement"] = None, statemachine_Statechart10: set["statemachine_Region"] = None):
        self.name = name
        self.UUID = UUID
...
class statemachine_Node:
    ...
    def __init__(self, name: str, id: int, statemachine_Node5: "statemachine_Transition" = None, statemachine_Node: "statemachine_Region" = None, statemachine_Node2: "statemachine_Transition" = None):
        self.name = name
        self.id = id
