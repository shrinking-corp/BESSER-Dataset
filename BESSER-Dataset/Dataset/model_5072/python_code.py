...
class rental_Rental:
    ...
    def __init__(self, startDate: date, endDate: date, rental_Rental: "rental_Customer" = None, rental_Rental10: "rental_RentalObject" = None, rentals: "rental_RentalAgency" = None, Rental: "rental_RentalAgency" = None):
...
class rental_Customer:
    ...
    def __init__(self, firstName: str, lastName: str, rental_Customer: "rental_Rental" = None, Customer: "rental_RentalAgency" = None, customers: "rental_RentalAgency" = None):
...
class rental_RentalObject:
    ...
    def __init__(self, ID: str, name: str, picture: str, objectsToRent: "rental_RentalAgency" = None, rental_RentalObject: "rental_Rental" = None, RentalObject: "rental_RentalAgency" = None):
        self.ID = ID
        self.name = name
...
class rental_RentalAgency:
    ...
    def __init__(self, name: str, RentalAgency7: "rental_RentalObject" = None, parentAgency: set["rental_RentalObject"] = None, parentAgency2: set["rental_Customer"] = None, RentalAgency12: "rental_Rental" = None, parentAgency4: set["rental_Rental"] = None, RentalAgency: "rental_Customer" = None):
        self.name = name
    ...
    def removeObject(self, rental_object):
    ...
    def isAvailable(self, rental_rentedObject, rental_from_, rental_to) :
        # TODO: Implement isAvailable method
        pass

    def removeCustomer(self, rental_customer):
