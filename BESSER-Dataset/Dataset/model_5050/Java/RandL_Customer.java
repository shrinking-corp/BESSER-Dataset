...
public class RandL_Customer  {
    ...
    public RandL_Customer(
        String age,        String title,        String name,        String gender,        String isMale    ) {
        this.age = age;
        this.title = title;
        this.name = name;
        this.gender = gender;
    ...
    public RandL_Customer(
        String age,        String title,        String name,        String gender,        String isMale        ArrayList<RandL_Membership> randl_memberships,        ArrayList<RandL_LoyaltyProgram> randl_loyaltyprograms,        ArrayList<RandL_CustomerCard> randl_customercards    ) {
        this.age = age;
        this.title = title;
        this.name = name;
        this.gender = gender;
