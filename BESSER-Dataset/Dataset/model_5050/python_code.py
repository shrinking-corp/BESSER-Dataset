...
class RandL_Customer:
    ...
    def __init__(self, gender: str, isMale: str, name: str, title: str, age: str, Customer: "RandL_CustomerCard" = None, RandL_Customer: "RandL_Membership" = None, RandL_Customer53: "RandL_Container_RandL" = None, owner: set["RandL_CustomerCard"] = None, RandL_Customer99: set["RandL_Membership"] = None, Customer114: "RandL_LoyaltyProgram" = None, RandL_Customer92: "RandL_Date" = None, participants: set["RandL_LoyaltyProgram"] = None):
        self.gender = gender
        self.isMale = isMale
        self.name = name
        self.title = title
...
class RandL_ProgramPartner:
    ...
    def __init__(self, name: str, numberOfCustomers: str, partner: set["RandL_Service"] = None, partners: set["RandL_LoyaltyProgram"] = None, ProgramPartner109: "RandL_LoyaltyProgram" = None, RandL_ProgramPartner: "RandL_Container_RandL" = None, ProgramPartner: "RandL_Service" = None):
        self.name = name
...
class RandL_LoyaltyAccount:
    ...
    def __init__(self, points: str, totalPointsEarned: str, number: str, LoyaltyAccount: "RandL_Transaction" = None, RandL_LoyaltyAccount73: "RandL_Container_RandL" = None, RandL_LoyaltyAccount: set["RandL_Service"] = None, account: "RandL_Membership" = None, account14: set["RandL_Transaction"] = None, LoyaltyAccount48: "RandL_Membership" = None):
        self.points = points
...
class RandL_LoyaltyProgram:
    ...
    def __init__(self, name: str, LoyaltyProgram: "RandL_ServiceLevel" = None, RandL_LoyaltyProgram68: "RandL_Container_RandL" = None, LoyaltyProgram18: "RandL_ProgramPartner" = None, RandL_LoyaltyProgram: "RandL_Membership" = None, programs: set["RandL_ProgramPartner"] = None, program: set["RandL_ServiceLevel"] = None, programs113: set["RandL_Customer"] = None, RandL_LoyaltyProgram116: set["RandL_Membership"] = None, LoyaltyProgram95: "RandL_Customer" = None):
        self.name = name
    ...
    def addTransaction(self, RandL_accNr, RandL_amnt, RandL_d, RandL_pName, RandL_servId):
