...
RandL_LoyaltyProgram_m_addService: Method = Method(name="addService", parameters={Parameter(name='RandL_l', type=StringType), Parameter(name='RandL_p', type=StringType), Parameter(name='RandL_s', type=StringType)})
...
RandL_LoyaltyProgram_m_addTransaction: Method = Method(name="addTransaction", parameters={Parameter(name='RandL_pName', type=StringType), Parameter(name='RandL_amnt', type=StringType), Parameter(name='RandL_accNr', type=StringType), Parameter(name='RandL_servId', type=StringType), Parameter(name='RandL_d', type=StringType)})
...
RandL_LoyaltyProgram.methods={RandL_LoyaltyProgram_m_addService, RandL_LoyaltyProgram_m_getServices, RandL_LoyaltyProgram_m_enroll, RandL_LoyaltyProgram_m_selectPopularPartners, RandL_LoyaltyProgram_m_getServices, RandL_LoyaltyProgram_m_enrollAndCreateCustomer, RandL_LoyaltyProgram_m_addTransaction}
...
RandL_Service.attributes={RandL_Service_serviceNr, RandL_Service_pointsEarned, RandL_Service_pointsBurned, RandL_Service_condition, RandL_Service_description}
...
RandL_LoyaltyAccount.attributes={RandL_LoyaltyAccount_number, RandL_LoyaltyAccount_points, RandL_LoyaltyAccount_totalPointsEarned}
RandL_LoyaltyAccount.methods={RandL_LoyaltyAccount_m_burn, RandL_LoyaltyAccount_m_earn, RandL_LoyaltyAccount_m_isEmpty, RandL_LoyaltyAccount_m_getCustomerName}
...
RandL_TransactionReportLine.attributes={RandL_TransactionReportLine_partnerName, RandL_TransactionReportLine_amount, RandL_TransactionReportLine_points, RandL_TransactionReportLine_serviceDesc}
...
RandL_Customer.attributes={RandL_Customer_name, RandL_Customer_title, RandL_Customer_age, RandL_Customer_gender, RandL_Customer_isMale}
...
domain_model = DomainModel(
    name="RandL",
    types={RandL_ServiceLevel, RandL_LoyaltyProgram, RandL_Service, RandL_Membership, RandL_Transaction, RandL_Date, RandL_LoyaltyAccount, RandL_CustomerCard, RandL_Earning, Transaction, RandL_ProgramPartner, RandL_Burning, RandL_TransactionReport, RandL_TransactionReportLine, RandL_Customer, RandL_Container_RandL, RandLColor, Gender},
    associations={program0, availableServices1, Membership2, date3, account4, generatedBy5, card8, usedServices10, Membership11, transactions13, deliveredServices15, programs17, until19, from_21, goodThru27, validFrom30, myLevel33, owner35, Membership36, transactions38, lines24, card25, account46, programs49, participants50, ref_RandL_Customer52, ref_RandL_Date54, ref_RandL_CustomerCard57, ref_RandL_Membership60, ref_RandL_Service63, ref_RandL_LoyaltyProgram66, ref_RandL_Earning69, ref_RandL_LoyaltyAccount71, ref_RandL_ServiceLevel74, currentLevel41, card43, ref_RandL_ProgramPartner80, ref_RandL_Burning82, ref_RandL_TransactionReportLine84, partner86, transactions87, level89, ref_RandL_TransactionReport77, cards96, memberships98, levels110, participants112, memberships115, date101, dateOfBirth91, transaction104, programs94, report107, partners108},
