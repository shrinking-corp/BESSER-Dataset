...
# Classes
trip_model_OtherService = Class(name="trip_model_OtherService")
Service = Class(name="Service")
trip_model_Service = Class(name="trip_model_Service")
trip_model_location = Class(name="trip_model_location")
trip_model_TravelService = Class(name="trip_model_TravelService")
trip_model_Trip = Class(name="trip_model_Trip")
trip_model_TripModel = Class(name="trip_model_TripModel")
...
trip_model_Service.attributes={trip_model_Service_Duration, trip_model_Service_Rating, trip_model_Service_name, trip_model_Service_Cost, trip_model_Service_Type}
...
trip_model_Trip.attributes={trip_model_Trip_name, trip_model_Trip_Start, trip_model_Trip_End}
...
domain_model = DomainModel(
    name="trip_model",
    types={trip_model_OtherService, Service, trip_model_Service, trip_model_location, trip_model_TravelService, trip_model_Trip, trip_model_TripModel},
