...
class trip_model_Trip:
    ...
    def __init__(self, End: date, name: str, Start: date, trip_model_Trip11: "trip_model_location" = None, trip_model_Trip14: "trip_model_TripModel" = None, trip_model_Trip: set["trip_model_Service"] = None, trip_model_Trip8: "trip_model_location" = None):
        self.End = End
        self.name = name
        self.Start = Start
...
class trip_model_location:
    ...
    def __init__(self, name: str, trip_model_location12: "trip_model_Trip" = None, trip_model_location17: "trip_model_TripModel" = None, trip_model_location: "trip_model_OtherService" = None, trip_model_location2: "trip_model_TravelService" = None, trip_model_location5: "trip_model_TravelService" = None, trip_model_location9: "trip_model_Trip" = None):
        self.name = name
