...
class epo_Supplier:
    ...
    def __init__(self, name: str, epo_Supplier18: set["epo_PurchaseOrder"] = None, epo_Supplier: set["epo_Customer"] = None, epo_Supplier12: set["epo_PurchaseOrder"] = None, epo_Supplier15: set["epo_PurchaseOrder"] = None):
        self.name = name
...
class epo_PurchaseOrder:
    ...
    def __init__(self, comment: str, orderDate: str, status: str, totalAmount: int, order: set["epo_Item"] = None, epo_PurchaseOrder: "epo_Address" = None, epo_PurchaseOrder4: "epo_Address" = None, orders: "epo_Customer" = None, epo_PurchaseOrder9: "epo_PurchaseOrder" = None, epo_PurchaseOrder7: "epo_PurchaseOrder" = None, PurchaseOrder: "epo_Item" = None, epo_PurchaseOrder19: "epo_Supplier" = None, PurchaseOrder21: "epo_Customer" = None, epo_PurchaseOrder13: "epo_Supplier" = None, epo_PurchaseOrder16: "epo_Supplier" = None):
...
class epo_Item:
    ...
    def __init__(self, comment: str, shipDate: str, partNum: str, productName: str, quantity: int, USPrice: int, Item: "epo_PurchaseOrder" = None, items: "epo_PurchaseOrder" = None):
        self.comment = comment
...
class epo_Customer:
    ...
    def __init__(self, customerID: int, Customer: "epo_PurchaseOrder" = None, customer: set["epo_PurchaseOrder"] = None, epo_Customer: "epo_Supplier" = None):
