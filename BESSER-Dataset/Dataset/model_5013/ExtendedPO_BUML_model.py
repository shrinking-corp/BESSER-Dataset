...
# Classes
epo_USAddress = Class(name="epo_USAddress")
Address = Class(name="Address")
epo_Address = Class(name="epo_Address", is_abstract=True)
epo_Customer = Class(name="epo_Customer")
epo_Item = Class(name="epo_Item")
epo_PurchaseOrder = Class(name="epo_PurchaseOrder")
epo_GlobalAddress = Class(name="epo_GlobalAddress")
GlobalLocation = Class(name="GlobalLocation")
epo_GlobalLocation = Class(name="epo_GlobalLocation")
epo_CanadianAddress = Class(name="epo_CanadianAddress")
epo_Supplier = Class(name="epo_Supplier")
...
epo_USAddress.attributes={epo_USAddress_state, epo_USAddress_city, epo_USAddress_zip, epo_USAddress_street}
...
epo_Item.attributes={epo_Item_shipDate, epo_Item_comment, epo_Item_productName, epo_Item_partNum, epo_Item_quantity, epo_Item_USPrice}
...
epo_PurchaseOrder.attributes={epo_PurchaseOrder_status, epo_PurchaseOrder_comment, epo_PurchaseOrder_orderDate, epo_PurchaseOrder_totalAmount}
...
epo_CanadianAddress.attributes={epo_CanadianAddress_street, epo_CanadianAddress_postalCode, epo_CanadianAddress_city, epo_CanadianAddress_province}
...
domain_model = DomainModel(
    name="epo",
    types={epo_USAddress, Address, epo_Address, epo_Customer, epo_Item, epo_PurchaseOrder, epo_GlobalAddress, GlobalLocation, epo_GlobalLocation, epo_CanadianAddress, epo_Supplier, OrderStatus},
    associations={items1, billTo2, shipTo3, customer6, previousOrder8, order0, shippedOrders17, orders20, customers10, orders11, pendingOrders14},
