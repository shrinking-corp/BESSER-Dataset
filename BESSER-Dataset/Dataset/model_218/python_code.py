...
class ecore_EPackage(ENamedElement):
    ...
    def __init__(self, nsUri: str, nsPrefix: str, EPackage: "ecore_EClassifier" = None, EPackage45: "ecore_EPackage" = None, eSuperPackage: set["ecore_EPackage"] = None, EPackage48: "ecore_EPackage" = None, eSubpackages: "ecore_EPackage" = None, ePackage50: set["ecore_EClassifier"] = None, EPackage52: "ecore_EFactory" = None, ePackage: "ecore_EFactory" = None):
        self.nsUri = nsUri
...
class ecore_EClassifier(ENamedElement):
    ...
    def __init__(self, instanceClassName: str, instanceClass: str, defaultValue: str, instanceTypeName: str, eClassifiers: "ecore_EPackage" = None, ecore_EClassifier: set["ecore_ETypeParameter"] = None, EClassifier: "ecore_EPackage" = None, ecore_EClassifier80: "ecore_EOperation" = None, ecore_EClassifier86: "ecore_ETypedElement" = None, ecore_EClassifier64: "ecore_EGenericType" = None, ecore_EClassifier73: "ecore_EGenericType" = None):
