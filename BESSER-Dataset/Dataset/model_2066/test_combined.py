...
def test_hyp_activitydiagram_stringvalue_is_not_abstract():
    assert not inspect.isabstract(activitydiagram_StringValue)


def test_hyp_activitydiagram_stringvalue_constructor_exists():
    assert callable(activitydiagram_StringValue.__init__)


def test_hyp_activitydiagram_stringvalue_constructor_args():
...
def test_hyp_activitydiagram_stringvariable_is_not_abstract():
    assert not inspect.isabstract(activitydiagram_StringVariable)


def test_hyp_activitydiagram_stringvariable_constructor_exists():
    assert callable(activitydiagram_StringVariable.__init__)


def test_hyp_activitydiagram_stringvariable_constructor_args():
...
def test_hyp_integercomparisionoperator_exists():
    # Check that the Enumeration exists
    assert IntegerComparisionOperator is not None

def test_hyp_integercomparisionoperator_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_activitydiagram_stringvalue_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_activitydiagram_booleanvariable_eoperation0_changes_state(instance):
...
def test_activitydiagram_StringValue_value_value_roundtrip():
    instance = activitydiagram_StringValue(value="sample_text")
...
def test_activitydiagram_Variable_isa_NamedElement():
    instance = activitydiagram_Variable()
    assert isinstance(instance, NamedElement)
...
def test_activitydiagram_StringValue_isa_Value():
    instance = activitydiagram_StringValue(value="sample_text")
    assert isinstance(instance, Value)
...
def test_activitydiagram_StringVariable_isa_Variable():
    instance = activitydiagram_StringVariable()
    assert isinstance(instance, Variable)


def test_assoc_assignee23_link_reassign_clear():
    a = activitydiagram_BooleanVariable()
    b1 = activitydiagram_BooleanExpression()
    b2 = activitydiagram_BooleanExpression()
    _safe_set(a, 'activitydiagram_BooleanVariable24', b1)
    assert _is_linked(a, 'activitydiagram_BooleanVariable24', b1)
    if hasattr(b1, 'activitydiagram_BooleanExpression'):
        assert _is_linked(b1, 'activitydiagram_BooleanExpression', a)
    _safe_set(a, 'activitydiagram_BooleanVariable24', b2)
    assert _is_linked(a, 'activitydiagram_BooleanVariable24', b2)
    if hasattr(b1, 'activitydiagram_BooleanExpression'):
    ...
    _safe_set(a, 'activitydiagram_BooleanVariable24', None)
    assert not _is_linked(a, 'activitydiagram_BooleanVariable24', b2)
    if hasattr(b2, 'activitydiagram_BooleanExpression'):
        assert not _is_linked(b2, 'activitydiagram_BooleanExpression', a)


def test_assoc_assignee25_link_reassign_clear():
    ...
    if hasattr(b1, 'activitydiagram_IntegerVariable26'):
        assert _is_linked(b1, 'activitydiagram_IntegerVariable26', a)
    ...
    if hasattr(b1, 'activitydiagram_IntegerVariable26'):
        assert not _is_linked(b1, 'activitydiagram_IntegerVariable26', a)
    if hasattr(b2, 'activitydiagram_IntegerVariable26'):
        assert _is_linked(b2, 'activitydiagram_IntegerVariable26', a)
    ...
    if hasattr(b2, 'activitydiagram_IntegerVariable26'):
        assert not _is_linked(b2, 'activitydiagram_IntegerVariable26', a)
...
def test_assoc_assignee27_link_reassign_clear():
    ...
    if hasattr(b1, 'activitydiagram_BooleanVariable28'):
        assert _is_linked(b1, 'activitydiagram_BooleanVariable28', a)
    ...
    if hasattr(b1, 'activitydiagram_BooleanVariable28'):
        assert not _is_linked(b1, 'activitydiagram_BooleanVariable28', a)
    if hasattr(b2, 'activitydiagram_BooleanVariable28'):
        assert _is_linked(b2, 'activitydiagram_BooleanVariable28', a)
    ...
    if hasattr(b2, 'activitydiagram_BooleanVariable28'):
        assert not _is_linked(b2, 'activitydiagram_BooleanVariable28', a)


def test_assoc_guard15_link_reassign_clear():
    a = activitydiagram_BooleanVariable()
...
def test_assoc_operand131_link_reassign_clear():
    a = activitydiagram_BooleanVariable()
...
def test_assoc_operand233_link_reassign_clear():
    a = activitydiagram_BooleanVariable()
    b1 = activitydiagram_BooleanBinaryExpression(operator="sample_text")
    b2 = activitydiagram_BooleanBinaryExpression(operator="sample_text_2")
    _safe_set(a, 'activitydiagram_BooleanVariable35', b1)
    assert _is_linked(a, 'activitydiagram_BooleanVariable35', b1)
    if hasattr(b1, 'activitydiagram_BooleanBinaryExpression34'):
        assert _is_linked(b1, 'activitydiagram_BooleanBinaryExpression34', a)
    _safe_set(a, 'activitydiagram_BooleanVariable35', b2)
    assert _is_linked(a, 'activitydiagram_BooleanVariable35', b2)
    if hasattr(b1, 'activitydiagram_BooleanBinaryExpression34'):
        assert not _is_linked(b1, 'activitydiagram_BooleanBinaryExpression34', a)
    if hasattr(b2, 'activitydiagram_BooleanBinaryExpression34'):
        assert _is_linked(b2, 'activitydiagram_BooleanBinaryExpression34', a)
    _safe_set(a, 'activitydiagram_BooleanVariable35', None)
    assert not _is_linked(a, 'activitydiagram_BooleanVariable35', b2)
    if hasattr(b2, 'activitydiagram_BooleanBinaryExpression34'):
        assert not _is_linked(b2, 'activitydiagram_BooleanBinaryExpression34', a)
...
def test_assoc_operand29_link_reassign_clear():
    ...
    _safe_set(a, 'activitydiagram_BooleanVariable30', b1)
    assert _is_linked(a, 'activitydiagram_BooleanVariable30', b1)
    if hasattr(b1, 'activitydiagram_BooleanUnaryExpression'):
        assert _is_linked(b1, 'activitydiagram_BooleanUnaryExpression', a)
    _safe_set(a, 'activitydiagram_BooleanVariable30', b2)
    assert _is_linked(a, 'activitydiagram_BooleanVariable30', b2)
    if hasattr(b1, 'activitydiagram_BooleanUnaryExpression'):
    ...
    _safe_set(a, 'activitydiagram_BooleanVariable30', None)
    assert not _is_linked(a, 'activitydiagram_BooleanVariable30', b2)
    if hasattr(b2, 'activitydiagram_BooleanUnaryExpression'):
...
activitydiagram_StringValue_strategy = st.builds(activitydiagram_StringValue, value=safe_text)
@given(instance=activitydiagram_StringValue_strategy)
@settings(max_examples=25)
...
activitydiagram_StringVariable_strategy = st.builds(activitydiagram_StringVariable)
