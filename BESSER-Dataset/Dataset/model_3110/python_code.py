...
class ClassM_Classifier:
    ...
    def __init__(self, name: str, ClassM_Classifier4: "ClassM_Model" = None, ClassM_Classifier: "ClassM_Attribute" = None):
        self.name = name
...
class ClassM_Attribute:
    ...
    def __init__(self, name: str, is_primary: bool, Attribute: "ClassM_Class" = None, attrs: "ClassM_Class" = None, ClassM_Attribute: "ClassM_Classifier" = None):
        self.name = name
