...
# Classes
pickupnet_Customer = Class(name="pickupnet_Customer")
pickupnet_Driver = Class(name="pickupnet_Driver")
pickupnet_Shipment = Class(name="pickupnet_Shipment")
pickupnet_Station = Class(name="pickupnet_Station")
pickupnet_Address = Class(name="pickupnet_Address")
pickupnet_GeoLocation = Class(name="pickupnet_GeoLocation")
...
pickupnet_Customer.attributes={pickupnet_Customer_twitterUserName, pickupnet_Customer_name, pickupnet_Customer_id}
...
pickupnet_Driver.attributes={pickupnet_Driver_name, pickupnet_Driver_id}
...
pickupnet_Shipment.attributes={pickupnet_Shipment_status, pickupnet_Shipment_id}

# pickupnet_Station class attributes and methods
pickupnet_Station_m_registerCustomer: Method = Method(name="registerCustomer", parameters={Parameter(name='pickupnet_customer', type=StringType)})
pickupnet_Station_m_registerDriver: Method = Method(name="registerDriver", parameters={Parameter(name='pickupnet_driver', type=StringType)})
pickupnet_Station_m_acceptShipment: Method = Method(name="acceptShipment", parameters={Parameter(name='pickupnet_shipment', type=StringType)})
pickupnet_Station.methods={pickupnet_Station_m_registerDriver, pickupnet_Station_m_registerCustomer, pickupnet_Station_m_acceptShipment}
...
domain_model = DomainModel(
    name="pickupnet",
    types={pickupnet_Customer, pickupnet_Driver, pickupnet_Shipment, pickupnet_Station, pickupnet_Address, pickupnet_GeoLocation, ShipmentStatus},
    associations={customers0, drivers1, shipments3, assignments5, orders6, driver8, orderer9, shipToAddress10, pickUpAddress12, geoLocation15},
    generalizations={},
    metadata=None
)
