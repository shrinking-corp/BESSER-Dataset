...
HouseHolds.attributes={HouseHolds_WashingMachine, HouseHolds_DishWasher, HouseHolds_Alarm, HouseHolds_TimeID, HouseHolds_Coffee}
...
domain_model = DomainModel(
    name="_983688d6_44ed_4a1e_b849_653c15d5a455",
    ...
    associations={Door_Camera, HomeTheatre_TV, HomeTheatre_Speakers, HouseHolds_Start_Of_Day, HouseHolds_End_Of_Day, MicroPhone_System, Home_Security_System_Alert, Sensor_System, System_HouseHolds, HomeTheatre_System, Home_Security_System_System, TV_Entertainment, Speakers_Entertainment, HomeTheatre_Entertainment, Sensor_Door},
    generalizations={},
    metadata=None
)
