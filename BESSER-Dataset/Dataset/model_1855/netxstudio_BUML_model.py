...
# Classes
netxstudio_Library = Class(name="netxstudio_Library")
netxstudio_Network = Class(name="netxstudio_Network")
netxstudio_Parameter = Class(name="netxstudio_Parameter")
netxstudio_Protocol = Class(name="netxstudio_Protocol")
netxstudio_Company = Class(name="netxstudio_Company")
netxstudio_Tolerance = Class(name="netxstudio_Tolerance")
netxstudio_Expression = Class(name="netxstudio_Expression")
netxstudio_User = Class(name="netxstudio_User")
netxstudio_Function = Class(name="netxstudio_Function")
netxstudio_Equipment = Class(name="netxstudio_Equipment")
netxstudio_Metric = Class(name="netxstudio_Metric")
netxstudio_Unit = Class(name="netxstudio_Unit")
netxstudio_RFSService = Class(name="netxstudio_RFSService")
netxstudio_Meta = Class(name="netxstudio_Meta")
netxstudio_MetricSource = Class(name="netxstudio_MetricSource")
netxstudio_Room = Class(name="netxstudio_Room")
netxstudio_Country = Class(name="netxstudio_Country")
netxstudio_Site = Class(name="netxstudio_Site")
...
domain_model = DomainModel(
    name="netxstudio",
    types={netxstudio_Library, netxstudio_Network, netxstudio_Parameter, netxstudio_Protocol, netxstudio_Company, netxstudio_Tolerance, netxstudio_Expression, netxstudio_User, netxstudio_Function, netxstudio_Equipment, netxstudio_Metric, netxstudio_Unit, netxstudio_RFSService, netxstudio_Meta, netxstudio_MetricSource, netxstudio_Room, netxstudio_Country, netxstudio_Site},
    associations={networks0, parameters7, protocols9, companies11, tolerances13, expressions15, users17, functions1, equipments3, metrics5, units25, services27, versions29, metricSources31, rooms19, countries21, sites23},
    generalizations={},
    metadata=None
)
