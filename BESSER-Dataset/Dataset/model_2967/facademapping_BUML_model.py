...
# Classes
facademapping_Mapping = Class(name="facademapping_Mapping")
facademapping_EObject = Class(name="facademapping_EObject")
facademapping_StereotypedMapping = Class(name="facademapping_StereotypedMapping")
Mapping = Class(name="Mapping")
facademapping_FacadeMappping = Class(name="facademapping_FacadeMappping")
...
domain_model = DomainModel(
    name="facademapping",
    types={facademapping_Mapping, facademapping_EObject, facademapping_StereotypedMapping, Mapping, facademapping_FacadeMappping, ExtensionDefinitionKind},
    associations={umlElement0, specificDomainElement1, appliedStereotypes4, mappings6},
