...
# Classes
architecture_Model = Class(name="architecture_Model")
architecture_DomainDeclaration = Class(name="architecture_DomainDeclaration")
architecture_AbstractModel = Class(name="architecture_AbstractModel")
architecture_Import = Class(name="architecture_Import")
architecture_Component = Class(name="architecture_Component")
architecture_Architecture = Class(name="architecture_Architecture")
architecture_Operation = Class(name="architecture_Operation")
architecture_Variable = Class(name="architecture_Variable")
architecture_Binding = Class(name="architecture_Binding")
architecture_AtomicType = Class(name="architecture_AtomicType")
...
domain_model = DomainModel(
    name="architecture",
    types={architecture_Model, architecture_DomainDeclaration, architecture_AbstractModel, architecture_Import, architecture_Component, architecture_Architecture, architecture_Operation, architecture_Variable, architecture_Binding, architecture_AtomicType, Type},
    associations={package0, elements1, imp3, comp5, arch7, ops9, opsReq11, operations14, vars17, bind19, provider21, proMember24, receiver27, recMember30, type33, arg35, type38, compType41},
    generalizations={},
    metadata=None
)
