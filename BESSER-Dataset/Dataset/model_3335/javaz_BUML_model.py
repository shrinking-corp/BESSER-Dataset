...
# Classes
javaz_Method = Class(name="javaz_Method")
javaz_Javaz = Class(name="javaz_Javaz")
JavaElement = Class(name="JavaElement")
javaz_JavaPackageX = Class(name="javaz_JavaPackageX")
javaz_JavaClass = Class(name="javaz_JavaClass")
javaz_JavaParameter = Class(name="javaz_JavaParameter")
javaz_Field = Class(name="javaz_Field")
javaz_JavaElement = Class(name="javaz_JavaElement")
javaz_Block = Class(name="javaz_Block")
...
javaz_Method.attributes={javaz_Method_final, javaz_Method_static, javaz_Method_synchronized, javaz_Method_visibility, javaz_Method_native, javaz_Method_constructor, javaz_Method_abstract}
...
javaz_JavaClass.attributes={javaz_JavaClass_rewritable, javaz_JavaClass_needToGenerate, javaz_JavaClass_kind, javaz_JavaClass_final, javaz_JavaClass_public}
...
javaz_JavaParameter.attributes={javaz_JavaParameter_type, javaz_JavaParameter_parameterKind, javaz_JavaParameter_kind, javaz_JavaParameter_final}
...
javaz_Field.attributes={javaz_Field_volatile, javaz_Field_transient, javaz_Field_static, javaz_Field_final, javaz_Field_type, javaz_Field_visibility}
...
domain_model = DomainModel(
    name="javaz",
    types={javaz_Method, javaz_Javaz, JavaElement, javaz_JavaPackageX, javaz_JavaClass, javaz_JavaParameter, javaz_Field, javaz_JavaElement, javaz_Block, JavaVisibilityKind, JavaKind, JavaParameterKind},
    associations={classes1, packages0, methods3, fields5, imports8, package10, extends14, implements17, parameters19, block21},
    generalizations={gen_javaz_JavaClass_JavaElement, gen_javaz_Javaz_JavaElement, gen_javaz_JavaParameter_JavaElement, gen_javaz_JavaPackageX_JavaElement, gen_javaz_Method_JavaElement, gen_javaz_Field_JavaElement},
    metadata=None
)
