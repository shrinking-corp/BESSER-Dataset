...
OCL_DefOclModuleElement = Class(name="OCL_DefOclModuleElement")
OclModuleElement = Class(name="OclModuleElement")
OCL_DeriveOclModuleElement = Class(name="OCL_DeriveOclModuleElement")
Parameter_ = Class(name="Parameter")
OCL_OclContextDefinition = Class(name="OCL_OclContextDefinition")
Element = Class(name="Element")
Class_ = Class(name="Class")
OCL_OclModule = Class(name="OCL_OclModule")
Package = Class(name="Package")
OCL_Invariant = Class(name="OCL_Invariant")
OCL_OclOperation = Class(name="OCL_OclOperation")
Operation = Class(name="Operation")
OclFeature = Class(name="OclFeature")
Variable = Class(name="Variable")
OclExpression = Class(name="OclExpression")
OCL_OclProperty = Class(name="OCL_OclProperty")
Property_ = Class(name="Property")
OCL_OclFeature = Class(name="OCL_OclFeature", is_abstract=True)
OCL_OclModuleElement = Class(name="OCL_OclModuleElement", is_abstract=True)
TypedElement = Class(name="TypedElement")
MultiplicityElement = Class(name="MultiplicityElement")
OCL_DataType = Class(name="OCL_DataType", is_abstract=True)
OCL_Type = Class(name="OCL_Type", is_abstract=True)
OCL_Package = Class(name="OCL_Package")
OCL_MultiplicityElement = Class(name="OCL_MultiplicityElement", is_abstract=True)
OCL_Object = Class(name="OCL_Object", is_abstract=True)
OCL_Extent = Class(name="OCL_Extent")
Object = Class(name="Object")
OCL_NamedElement = Class(name="OCL_NamedElement", is_abstract=True)
OCL_Enumeration = Class(name="OCL_Enumeration")
EnumerationLiteral = Class(name="EnumerationLiteral")
OCL_Tag = Class(name="OCL_Tag")
OCL_Comment = Class(name="OCL_Comment")
NamedElement = Class(name="NamedElement")
OCL_URIExtent = Class(name="OCL_URIExtent")
Extent = Class(name="Extent")
OCL_PrimitiveType = Class(name="OCL_PrimitiveType", is_abstract=True)
...
OCL_TypedElement = Class(name="OCL_TypedElement", is_abstract=True)
Type = Class(name="Type")
OCL_Element = Class(name="OCL_Element", is_abstract=True)
OCL_EnumerationLiteral = Class(name="OCL_EnumerationLiteral")
OCL_Parameter = Class(name="OCL_Parameter")
OCL_Operation = Class(name="OCL_Operation")
OCL_Property = Class(name="OCL_Property")
OCL_Class = Class(name="OCL_Class")
OCL_AnyType = Class(name="OCL_AnyType")
OCL_VoidType = Class(name="OCL_VoidType")
...
OCL_InvalidType = Class(name="OCL_InvalidType")
OCL_EnumLiteralExp = Class(name="OCL_EnumLiteralExp")
LiteralExp = Class(name="LiteralExp")
OCL_TupleLiteralExp = Class(name="OCL_TupleLiteralExp")
OCL_CollectionType = Class(name="OCL_CollectionType", is_abstract=True)
OCL_BagType = Class(name="OCL_BagType")
OCL_TupleLiteralPart = Class(name="OCL_TupleLiteralPart")
OCL_FeaturePropertyCall = Class(name="OCL_FeaturePropertyCall", is_abstract=True)
CallExp = Class(name="CallExp")
OCL_InvalidLiteralExp = Class(name="OCL_InvalidLiteralExp")
OCL_NullLiteralExp = Class(name="OCL_NullLiteralExp")
OCL_LiteralExp = Class(name="OCL_LiteralExp", is_abstract=True)
TupleLiteralPart = Class(name="TupleLiteralPart")
OCL_CollectionRange = Class(name="OCL_CollectionRange")
CollectionLiteralPart = Class(name="CollectionLiteralPart")
OCL_CollectionItem = Class(name="OCL_CollectionItem")
OCL_CollectionLiteralPart = Class(name="OCL_CollectionLiteralPart", is_abstract=True)
OCL_CollectionLiteralExp = Class(name="OCL_CollectionLiteralExp")
OCL_NumericLiteralExp = Class(name="OCL_NumericLiteralExp", is_abstract=True)
PrimitiveLiteralExp = Class(name="PrimitiveLiteralExp")
OCL_PrimitiveLiteralExp = Class(name="OCL_PrimitiveLiteralExp", is_abstract=True)
...
OCL_IntegerLiteralExp = Class(name="OCL_IntegerLiteralExp")
NumericLiteralExp = Class(name="NumericLiteralExp")
OCL_StringLiteralExp = Class(name="OCL_StringLiteralExp")
...
OCL_PropertyCallExp = Class(name="OCL_PropertyCallExp")
OCL_Variable = Class(name="OCL_Variable")
...
OCL_CallExp = Class(name="OCL_CallExp", is_abstract=True)
OCL_BooleanLiteralExp = Class(name="OCL_BooleanLiteralExp")
OCL_RealLiteralExp = Class(name="OCL_RealLiteralExp")
...
OCL_MultiplicityElement.attributes={OCL_MultiplicityElement_isOrdered, OCL_MultiplicityElement_isUnique, OCL_MultiplicityElement_upper, OCL_MultiplicityElement_lower}
...
OCL_Tag.attributes={OCL_Tag_name, OCL_Tag_value}
...
OCL_Property.attributes={OCL_Property_isReadOnly, OCL_Property_isComposite, OCL_Property_default, OCL_Property_isId, OCL_Property_isDerived}
...
in_77: BinaryAssociation = BinaryAssociation(
    name="in_77",
    ends={
...
domain_model = DomainModel(
    name="OCL",
    types={OclContextDefinition, OCL_DefOclModuleElement, OclModuleElement, OCL_DeriveOclModuleElement, Parameter_, OCL_OclContextDefinition, Element, Class_, OCL_OclModule, Package, OCL_Invariant, OCL_OclOperation, Operation, OclFeature, Variable, OclExpression, OCL_OclProperty, Property_, OCL_OclFeature, OCL_OclModuleElement, TypedElement, MultiplicityElement, OCL_DataType, OCL_Type, OCL_Package, OCL_MultiplicityElement, OCL_Object, OCL_Extent, Object, OCL_NamedElement, OCL_Enumeration, EnumerationLiteral, OCL_Tag, OCL_Comment, NamedElement, OCL_URIExtent, Extent, OCL_PrimitiveType, DataType, OCL_IntegerType, PrimitiveType, OCL_RealType, OCL_BooleanType, OCL_StringType, OCL_TypedElement, Type, OCL_Element, OCL_EnumerationLiteral, OCL_Parameter, OCL_Operation, OCL_Property, OCL_Class, OCL_AnyType, OCL_VoidType, OCL_TupleType, OCL_SetType, CollectionType, OCL_SequenceType, OCL_OrderedSetType, OCL_InvalidType, OCL_EnumLiteralExp, LiteralExp, OCL_TupleLiteralExp, OCL_CollectionType, OCL_BagType, OCL_TupleLiteralPart, OCL_FeaturePropertyCall, CallExp, OCL_InvalidLiteralExp, OCL_NullLiteralExp, OCL_LiteralExp, TupleLiteralPart, OCL_CollectionRange, CollectionLiteralPart, OCL_CollectionItem, OCL_CollectionLiteralPart, OCL_CollectionLiteralExp, OCL_NumericLiteralExp, PrimitiveLiteralExp, OCL_PrimitiveLiteralExp, OCL_IterateExp, LoopExp, OCL_OperationCallExp, FeaturePropertyCall, OCL_CollectionOperationCallExp, OperationCallExp, OCL_OperatorCallExp, OCL_IntegerLiteralExp, NumericLiteralExp, OCL_StringLiteralExp, OCL_IteratorExp, OCL_LoopExp, Iterator, OCL_Iterator, OCL_VariableExp, OCL_PropertyCallExp, OCL_Variable, OCL_LetExp, OCL_IfExp, OCL_OclExpression, OCL_CallExp, OCL_BooleanLiteralExp, OCL_RealLiteralExp, CollectionKind},
    associations={contextDefinition11, feature12, refAttr13, specification14, contextElement17, ownedElements18, specification19, returnVariable0, body1, contextVariable3, body6, contextVariable8, ownedType26, nestedPackage28, ownedLiteral30, element31, contextVariable21, annotatedElement24, type25, referredEnumLiteral42, ownedParameter32, raisedException34, opposite37, ownedAttribute38, ownedOperation40, elementType44, value46, attribute48, result60, part51, first52, last54, item57, part59, variable75, argument62, body64, iterator66, referredVariable68, bindParameter70, initExpression72, in_77, elseExpression80, thenExpression82, condition85, source88},
    generalizations={gen_OCL_DefOclModuleElement_OclModuleElement, gen_OCL_DeriveOclModuleElement_OclModuleElement, gen_OCL_OclContextDefinition_Element, gen_OCL_OclModule_Package, gen_OCL_Invariant_OclModuleElement, gen_OCL_OclOperation_Operation, gen_OCL_OclOperation_OclFeature, gen_OCL_OclProperty_Property, gen_OCL_OclProperty_OclFeature, gen_OCL_Parameter_TypedElement, gen_OCL_Parameter_MultiplicityElement, gen_OCL_DataType_Type, gen_OCL_Type_NamedElement, gen_OCL_Package_NamedElement, gen_OCL_Extent_Object, gen_OCL_NamedElement_Element, gen_OCL_Enumeration_DataType, gen_OCL_Tag_Element, gen_OCL_Comment_Element, gen_OCL_URIExtent_Extent, gen_OCL_PrimitiveType_DataType, gen_OCL_IntegerType_PrimitiveType, gen_OCL_RealType_PrimitiveType, gen_OCL_BooleanType_PrimitiveType, gen_OCL_StringType_PrimitiveType, gen_OCL_TypedElement_NamedElement, gen_OCL_EnumerationLiteral_NamedElement, gen_OCL_Element_Object, gen_OCL_Operation_TypedElement, gen_OCL_Operation_MultiplicityElement, gen_OCL_Property_TypedElement, gen_OCL_Property_MultiplicityElement, gen_OCL_Class_Type, gen_OCL_AnyType_Class, gen_OCL_VoidType_Type, gen_OCL_TupleType_DataType, gen_OCL_SetType_CollectionType, gen_OCL_SequenceType_CollectionType, gen_OCL_OrderedSetType_CollectionType, gen_OCL_InvalidType_Type, gen_OCL_EnumLiteralExp_LiteralExp, gen_OCL_TupleLiteralExp_LiteralExp, gen_OCL_CollectionType_DataType, gen_OCL_BagType_CollectionType, gen_OCL_TupleLiteralPart_TypedElement, gen_OCL_FeaturePropertyCall_CallExp, gen_OCL_InvalidLiteralExp_LiteralExp, gen_OCL_NullLiteralExp_LiteralExp, gen_OCL_LiteralExp_OclExpression, gen_OCL_CollectionRange_CollectionLiteralPart, gen_OCL_CollectionItem_CollectionLiteralPart, gen_OCL_CollectionLiteralPart_TypedElement, gen_OCL_CollectionLiteralExp_LiteralExp, gen_OCL_NumericLiteralExp_PrimitiveLiteralExp, gen_OCL_PrimitiveLiteralExp_LiteralExp, gen_OCL_IterateExp_LoopExp, gen_OCL_OperationCallExp_FeaturePropertyCall, gen_OCL_CollectionOperationCallExp_OperationCallExp, gen_OCL_OperatorCallExp_OperationCallExp, gen_OCL_IntegerLiteralExp_NumericLiteralExp, gen_OCL_StringLiteralExp_PrimitiveLiteralExp, gen_OCL_IteratorExp_LoopExp, gen_OCL_LoopExp_CallExp, gen_OCL_Iterator_Variable, gen_OCL_VariableExp_OclExpression, gen_OCL_PropertyCallExp_FeaturePropertyCall, gen_OCL_Variable_TypedElement, gen_OCL_LetExp_OclExpression, gen_OCL_IfExp_OclExpression, gen_OCL_OclExpression_TypedElement, gen_OCL_CallExp_OclExpression, gen_OCL_BooleanLiteralExp_PrimitiveLiteralExp, gen_OCL_RealLiteralExp_NumericLiteralExp},
    metadata=None
)
