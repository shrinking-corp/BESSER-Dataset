...
# Classes
transformationtrace_RuleParameterTrace = Class(name="transformationtrace_RuleParameterTrace")
transformationtrace_TransformationTrace = Class(name="transformationtrace_TransformationTrace")
transformationtrace_ActivationTrace = Class(name="transformationtrace_ActivationTrace")
...
domain_model = DomainModel(
    ...
    types={transformationtrace_RuleParameterTrace, transformationtrace_TransformationTrace, transformationtrace_ActivationTrace},
