...
def test_assoc_association14_link_reassign_clear():
    ...
    b1 = UML2_Association()
    b2 = UML2_Association()
    _safe_set(a, 'UML2_Property15', b1)
    assert _is_linked(a, 'UML2_Property15', b1)
    if hasattr(b1, 'UML2_Association'):
        assert _is_linked(b1, 'UML2_Association', a)
    _safe_set(a, 'UML2_Property15', b2)
    assert _is_linked(a, 'UML2_Property15', b2)
    if hasattr(b1, 'UML2_Association'):
        assert not _is_linked(b1, 'UML2_Association', a)
    if hasattr(b2, 'UML2_Association'):
        assert _is_linked(b2, 'UML2_Association', a)
    _safe_set(a, 'UML2_Property15', None)
    assert not _is_linked(a, 'UML2_Property15', b2)
    if hasattr(b2, 'UML2_Association'):
...
def test_assoc_classifier6_link_reassign_clear():
    a = UML2_Classifier(isAbstract=True)
    b1 = UML2_InstanceSpecification()
    b2 = UML2_InstanceSpecification()
    _safe_set(a, 'UML2_Classifier8', b1)
    assert _is_linked(a, 'UML2_Classifier8', b1)
    if hasattr(b1, 'UML2_InstanceSpecification7'):
        assert _is_linked(b1, 'UML2_InstanceSpecification7', a)
    _safe_set(a, 'UML2_Classifier8', b2)
    assert _is_linked(a, 'UML2_Classifier8', b2)
    if hasattr(b1, 'UML2_InstanceSpecification7'):
        assert not _is_linked(b1, 'UML2_InstanceSpecification7', a)
    if hasattr(b2, 'UML2_InstanceSpecification7'):
        assert _is_linked(b2, 'UML2_InstanceSpecification7', a)
    _safe_set(a, 'UML2_Classifier8', None)
    assert not _is_linked(a, 'UML2_Classifier8', b2)
    if hasattr(b2, 'UML2_InstanceSpecification7'):
        assert not _is_linked(b2, 'UML2_InstanceSpecification7', a)


def test_assoc_context_34_link_reassign_clear():
    a = UML2_Classifier(isAbstract=True)
    b1 = UML2_Action()
    b2 = UML2_Action()
...
def test_assoc_definingFeature32_link_reassign_clear():
    ...
    if hasattr(b1, 'UML2_Slot33'):
        assert _is_linked(b1, 'UML2_Slot33', a)
    _safe_set(a, 'UML2_StructuralFeature', b2)
    assert _is_linked(a, 'UML2_StructuralFeature', b2)
    if hasattr(b1, 'UML2_Slot33'):
        assert not _is_linked(b1, 'UML2_Slot33', a)
    if hasattr(b2, 'UML2_Slot33'):
        assert _is_linked(b2, 'UML2_Slot33', a)
    _safe_set(a, 'UML2_StructuralFeature', None)
    assert not _is_linked(a, 'UML2_StructuralFeature', b2)
    if hasattr(b2, 'UML2_Slot33'):
        assert not _is_linked(b2, 'UML2_Slot33', a)


def test_assoc_end42_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b1 = UML2_LinkEndData()
    b2 = UML2_LinkEndData()
    _safe_set(a, 'UML2_Property44', b1)
    assert _is_linked(a, 'UML2_Property44', b1)
    if hasattr(b1, 'UML2_LinkEndData43'):
        assert _is_linked(b1, 'UML2_LinkEndData43', a)
    _safe_set(a, 'UML2_Property44', b2)
    assert _is_linked(a, 'UML2_Property44', b2)
    if hasattr(b1, 'UML2_LinkEndData43'):
        assert not _is_linked(b1, 'UML2_LinkEndData43', a)
    if hasattr(b2, 'UML2_LinkEndData43'):
        assert _is_linked(b2, 'UML2_LinkEndData43', a)
    _safe_set(a, 'UML2_Property44', None)
    assert not _is_linked(a, 'UML2_Property44', b2)
    if hasattr(b2, 'UML2_LinkEndData43'):
        assert not _is_linked(b2, 'UML2_LinkEndData43', a)


def test_assoc_feature53_link_reassign_clear():
    a = UML2_Feature(isStatic=True)
    b1 = UML2_Classifier(isAbstract=True)
    b2 = UML2_Classifier(isAbstract=False)
    _safe_set(a, 'UML2_Feature55', b1)
    assert _is_linked(a, 'UML2_Feature55', b1)
    if hasattr(b1, 'UML2_Classifier54'):
        assert _is_linked(b1, 'UML2_Classifier54', a)
    _safe_set(a, 'UML2_Feature55', b2)
    assert _is_linked(a, 'UML2_Feature55', b2)
    if hasattr(b1, 'UML2_Classifier54'):
        assert not _is_linked(b1, 'UML2_Classifier54', a)
    if hasattr(b2, 'UML2_Classifier54'):
        assert _is_linked(b2, 'UML2_Classifier54', a)
    _safe_set(a, 'UML2_Feature55', None)
    assert not _is_linked(a, 'UML2_Feature55', b2)
    if hasattr(b2, 'UML2_Classifier54'):
        assert not _is_linked(b2, 'UML2_Classifier54', a)


def test_assoc_featuringClassifier0_link_reassign_clear():
    a = UML2_Feature(isStatic=True)
    b1 = UML2_Classifier(isAbstract=True)
    b2 = UML2_Classifier(isAbstract=False)
    _safe_set(a, 'UML2_Feature', {b1})
    assert _is_linked(a, 'UML2_Feature', b1)
    if hasattr(b1, 'UML2_Classifier'):
        assert _is_linked(b1, 'UML2_Classifier', a)
    _safe_set(a, 'UML2_Feature', {b2})
    assert _is_linked(a, 'UML2_Feature', b2)
    if hasattr(b1, 'UML2_Classifier'):
        assert not _is_linked(b1, 'UML2_Classifier', a)
    if hasattr(b2, 'UML2_Classifier'):
        assert _is_linked(b2, 'UML2_Classifier', a)
    _safe_set(a, 'UML2_Feature', set())
    assert not _is_linked(a, 'UML2_Feature', b2)
    if hasattr(b2, 'UML2_Classifier'):
        assert not _is_linked(b2, 'UML2_Classifier', a)
...
def test_assoc_general75_link_reassign_clear():
    ...
    _safe_set(a, 'UML2_Classifier77', b1)
    assert _is_linked(a, 'UML2_Classifier77', b1)
    if hasattr(b1, 'UML2_Generalization76'):
        assert _is_linked(b1, 'UML2_Generalization76', a)
    _safe_set(a, 'UML2_Classifier77', b2)
    assert _is_linked(a, 'UML2_Classifier77', b2)
    if hasattr(b1, 'UML2_Generalization76'):
    ...
    _safe_set(a, 'UML2_Classifier77', None)
    assert not _is_linked(a, 'UML2_Classifier77', b2)
    if hasattr(b2, 'UML2_Generalization76'):
        assert not _is_linked(b2, 'UML2_Generalization76', a)


def test_assoc_generalization59_link_reassign_clear():
    a = UML2_Classifier(isAbstract=True)
    b1 = UML2_Generalization()
    b2 = UML2_Generalization()
    _safe_set(a, 'UML2_Classifier60', {b1})
    assert _is_linked(a, 'UML2_Classifier60', b1)
    if hasattr(b1, 'UML2_Generalization'):
        assert _is_linked(b1, 'UML2_Generalization', a)
    _safe_set(a, 'UML2_Classifier60', {b2})
    assert _is_linked(a, 'UML2_Classifier60', b2)
    if hasattr(b1, 'UML2_Generalization'):
    ...
    _safe_set(a, 'UML2_Classifier60', set())
    assert not _is_linked(a, 'UML2_Classifier60', b2)
    if hasattr(b2, 'UML2_Generalization'):
        assert not _is_linked(b2, 'UML2_Generalization', a)


def test_assoc_inheritedMember56_link_reassign_clear():
    a = UML2_NamedElement(name="sample_text", visibility="sample_text")
    b1 = UML2_Classifier(isAbstract=True)
    b2 = UML2_Classifier(isAbstract=False)
    _safe_set(a, 'UML2_NamedElement58', b1)
    assert _is_linked(a, 'UML2_NamedElement58', b1)
    if hasattr(b1, 'UML2_Classifier57'):
        assert _is_linked(b1, 'UML2_Classifier57', a)
    _safe_set(a, 'UML2_NamedElement58', b2)
    assert _is_linked(a, 'UML2_NamedElement58', b2)
    if hasattr(b1, 'UML2_Classifier57'):
        assert not _is_linked(b1, 'UML2_Classifier57', a)
    if hasattr(b2, 'UML2_Classifier57'):
        assert _is_linked(b2, 'UML2_Classifier57', a)
    _safe_set(a, 'UML2_NamedElement58', None)
    assert not _is_linked(a, 'UML2_NamedElement58', b2)
    if hasattr(b2, 'UML2_Classifier57'):
        assert not _is_linked(b2, 'UML2_Classifier57', a)


def test_assoc_member19_link_reassign_clear():
    a = UML2_NamedElement(name="sample_text", visibility="sample_text")
    b1 = UML2_Namespace()
    b2 = UML2_Namespace()
...
def test_assoc_memberEnd68_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b1 = UML2_Association()
    b2 = UML2_Association()
    _safe_set(a, 'UML2_Property70', b1)
    assert _is_linked(a, 'UML2_Property70', b1)
    if hasattr(b1, 'UML2_Association69'):
        assert _is_linked(b1, 'UML2_Association69', a)
    _safe_set(a, 'UML2_Property70', b2)
    assert _is_linked(a, 'UML2_Property70', b2)
    if hasattr(b1, 'UML2_Association69'):
        assert not _is_linked(b1, 'UML2_Association69', a)
    if hasattr(b2, 'UML2_Association69'):
        assert _is_linked(b2, 'UML2_Association69', a)
    _safe_set(a, 'UML2_Property70', None)
    assert not _is_linked(a, 'UML2_Property70', b2)
    if hasattr(b2, 'UML2_Association69'):
        assert not _is_linked(b2, 'UML2_Association69', a)


def test_assoc_nestedClassifier36_link_reassign_clear():
    a = UML2_Classifier(isAbstract=True)
    b1 = UML2_Class(isActive=True)
    b2 = UML2_Class(isActive=False)
    _safe_set(a, 'UML2_Classifier37', b1)
    assert _is_linked(a, 'UML2_Classifier37', b1)
    if hasattr(b1, 'UML2_Class'):
        assert _is_linked(b1, 'UML2_Class', a)
    _safe_set(a, 'UML2_Classifier37', b2)
    assert _is_linked(a, 'UML2_Classifier37', b2)
    if hasattr(b1, 'UML2_Class'):
        assert not _is_linked(b1, 'UML2_Class', a)
    if hasattr(b2, 'UML2_Class'):
        assert _is_linked(b2, 'UML2_Class', a)
    _safe_set(a, 'UML2_Classifier37', None)
    assert not _is_linked(a, 'UML2_Classifier37', b2)
    if hasattr(b2, 'UML2_Class'):
        assert not _is_linked(b2, 'UML2_Class', a)


def test_assoc_ownedEnd65_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b1 = UML2_Association()
    b2 = UML2_Association()
    _safe_set(a, 'UML2_Property67', b1)
    assert _is_linked(a, 'UML2_Property67', b1)
    if hasattr(b1, 'UML2_Association66'):
        assert _is_linked(b1, 'UML2_Association66', a)
    _safe_set(a, 'UML2_Property67', b2)
    assert _is_linked(a, 'UML2_Property67', b2)
    if hasattr(b1, 'UML2_Association66'):
        assert not _is_linked(b1, 'UML2_Association66', a)
    if hasattr(b2, 'UML2_Association66'):
        assert _is_linked(b2, 'UML2_Association66', a)
    _safe_set(a, 'UML2_Property67', None)
    assert not _is_linked(a, 'UML2_Property67', b2)
    if hasattr(b2, 'UML2_Association66'):
        assert not _is_linked(b2, 'UML2_Association66', a)
...
def test_assoc_ownedReception38_link_reassign_clear():
    a = UML2_Class(isActive=True)
    b1 = UML2_Reception()
    b2 = UML2_Reception()
    _safe_set(a, 'UML2_Class39', {b1})
    assert _is_linked(a, 'UML2_Class39', b1)
    if hasattr(b1, 'UML2_Reception'):
        assert _is_linked(b1, 'UML2_Reception', a)
    _safe_set(a, 'UML2_Class39', {b2})
    assert _is_linked(a, 'UML2_Class39', b2)
    if hasattr(b1, 'UML2_Reception'):
        assert not _is_linked(b1, 'UML2_Reception', a)
    if hasattr(b2, 'UML2_Reception'):
        assert _is_linked(b2, 'UML2_Reception', a)
    _safe_set(a, 'UML2_Class39', set())
    assert not _is_linked(a, 'UML2_Class39', b2)
    if hasattr(b2, 'UML2_Reception'):
...
def test_assoc_qualifier17_link_reassign_clear():
    ...
    _safe_set(a, 'UML2_Property16', {b1})
    assert _is_linked(a, 'UML2_Property16', b1)
    if hasattr(b1, 'UML2_Property18'):
        assert _is_linked(b1, 'UML2_Property18', a)
    _safe_set(a, 'UML2_Property16', {b2})
    assert _is_linked(a, 'UML2_Property16', b2)
    if hasattr(b1, 'UML2_Property18'):
        assert not _is_linked(b1, 'UML2_Property18', a)
    if hasattr(b2, 'UML2_Property18'):
        assert _is_linked(b2, 'UML2_Property18', a)
    _safe_set(a, 'UML2_Property16', set())
    assert not _is_linked(a, 'UML2_Property16', b2)
    if hasattr(b2, 'UML2_Property18'):
        assert not _is_linked(b2, 'UML2_Property18', a)
...
def test_assoc_qualifier47_link_reassign_clear():
    ...
    if hasattr(b1, 'UML2_QualifierValue48'):
        assert _is_linked(b1, 'UML2_QualifierValue48', a)
    _safe_set(a, 'UML2_Property49', b2)
    assert _is_linked(a, 'UML2_Property49', b2)
    if hasattr(b1, 'UML2_QualifierValue48'):
        assert not _is_linked(b1, 'UML2_QualifierValue48', a)
    if hasattr(b2, 'UML2_QualifierValue48'):
        assert _is_linked(b2, 'UML2_QualifierValue48', a)
    _safe_set(a, 'UML2_Property49', None)
    assert not _is_linked(a, 'UML2_Property49', b2)
    if hasattr(b2, 'UML2_QualifierValue48'):
        assert not _is_linked(b2, 'UML2_QualifierValue48', a)


def test_assoc_structuralFeature71_link_reassign_clear():
    a = UML2_StructuralFeature(isReadOnly=True)
    b1 = UML2_StructuralFeatureAction()
    b2 = UML2_StructuralFeatureAction()
    _safe_set(a, 'UML2_StructuralFeature72', b1)
    assert _is_linked(a, 'UML2_StructuralFeature72', b1)
    if hasattr(b1, 'UML2_StructuralFeatureAction'):
        assert _is_linked(b1, 'UML2_StructuralFeatureAction', a)
    _safe_set(a, 'UML2_StructuralFeature72', b2)
    assert _is_linked(a, 'UML2_StructuralFeature72', b2)
    if hasattr(b1, 'UML2_StructuralFeatureAction'):
    ...
    _safe_set(a, 'UML2_StructuralFeature72', None)
    assert not _is_linked(a, 'UML2_StructuralFeature72', b2)
    if hasattr(b2, 'UML2_StructuralFeatureAction'):
        assert not _is_linked(b2, 'UML2_StructuralFeatureAction', a)


def test_assoc_subsettedProperty13_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b1 = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b2 = UML2_Property(aggregation="sample_text_2", isComposite=False, isDerived=False, isDerivedUnion=False)
    _safe_set(a, 'UML2_Property', b1)
    assert _is_linked(a, 'UML2_Property', b1)
    if hasattr(b1, 'UML2_Property12'):
        assert _is_linked(b1, 'UML2_Property12', a)
    _safe_set(a, 'UML2_Property', b2)
    assert _is_linked(a, 'UML2_Property', b2)
    if hasattr(b1, 'UML2_Property12'):
        assert not _is_linked(b1, 'UML2_Property12', a)
    if hasattr(b2, 'UML2_Property12'):
        assert _is_linked(b2, 'UML2_Property12', a)
    _safe_set(a, 'UML2_Property', None)
    assert not _is_linked(a, 'UML2_Property', b2)
    if hasattr(b2, 'UML2_Property12'):
        assert not _is_linked(b2, 'UML2_Property12', a)
