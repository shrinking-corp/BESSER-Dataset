...
# Classes
componentmodel_Component = Class(name="componentmodel_Component", is_abstract=True)
componentmodel_Port = Class(name="componentmodel_Port", is_abstract=True)
componentmodel_PrimitiveComponent = Class(name="componentmodel_PrimitiveComponent")
Component = Class(name="Component")
componentmodel_NumericProperty = Class(name="componentmodel_NumericProperty")
Property_ = Class(name="Property")
componentmodel_EnumProperty = Class(name="componentmodel_EnumProperty")
componentmodel_Property = Class(name="componentmodel_Property", is_abstract=True)
...
componentmodel_Port.attributes={componentmodel_Port_type, componentmodel_Port_typePackage, componentmodel_Port_description, componentmodel_Port_name}
...
componentmodel_NumericProperty.attributes={componentmodel_NumericProperty_defaultValue, componentmodel_NumericProperty_minValue, componentmodel_NumericProperty_maxValue}
...
componentmodel_Property.attributes={componentmodel_Property_name, componentmodel_Property_description}
...
domain_model = DomainModel(
    name="componentmodel",
    types={componentmodel_Component, componentmodel_Port, componentmodel_PrimitiveComponent, Component, componentmodel_NumericProperty, Property_, componentmodel_EnumProperty, componentmodel_Property, componentmodel_CompositeComponent, componentmodel_InPort, Port, componentmodel_OutPort},
    associations={ports0, propagatesFrom11, sink13, propagatesTo16, properties1, components2, delegatesTo5, source6, delegatesFrom8},
    generalizations={gen_componentmodel_PrimitiveComponent_Component, gen_componentmodel_OutPort_Port, gen_componentmodel_NumericProperty_Property, gen_componentmodel_EnumProperty_Property, gen_componentmodel_CompositeComponent_Component, gen_componentmodel_InPort_Port},
    metadata=None
)
