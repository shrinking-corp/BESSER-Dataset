...
# Classes
menus_Person = Class(name="menus_Person")
menus_PersonDirectory = Class(name="menus_PersonDirectory")
...
menus_Person.attributes={menus_Person_pregnant, menus_Person_dateOfBirth, menus_Person_lastname, menus_Person_sex, menus_Person_firstname}
