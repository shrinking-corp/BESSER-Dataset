...
bowling_Player.attributes={bowling_Player_dateOfBirth, bowling_Player_isProfessional, bowling_Player_height, bowling_Player_name}
...
domain_model = DomainModel(
    ...
    associations={games0, player1, matchups3, games4, matchup5, player6},
    generalizations={},
    metadata=None
)
