...
public class UML2WithID_LoopNode extends StructuredActivityNode {
    ...
    public UML2WithID_LoopNode(
        boolean isTestedFirst        ArrayList<UML2WithID_ActivityNode> uml2withid_activitynodes,        ArrayList<UML2WithID_OutputPin> uml2withid_outputpins,        ArrayList<UML2WithID_InputPin> uml2withid_inputpins,        ArrayList<UML2WithID_ActivityNode> uml2withid_activitynodes,        ArrayList<UML2WithID_ActivityNode> uml2withid_activitynodes,        ArrayList<UML2WithID_OutputPin> uml2withid_outputpins,        ArrayList<UML2WithID_OutputPin> uml2withid_outputpins    ) {
        this.isTestedFirst = isTestedFirst;
