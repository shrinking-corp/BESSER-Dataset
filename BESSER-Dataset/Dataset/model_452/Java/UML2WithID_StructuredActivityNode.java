...
public class UML2WithID_StructuredActivityNode extends Action, ActivityGroup, Namespace {
    ...
    public UML2WithID_StructuredActivityNode(
        boolean mustIsolate        ArrayList<UML2WithID_ActivityEdge> uml2withid_activityedges,        ArrayList<UML2WithID_ActivityNode> uml2withid_activitynodes    ) {
        this.mustIsolate = mustIsolate;
