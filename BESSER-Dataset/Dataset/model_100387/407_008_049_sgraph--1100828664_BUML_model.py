...
sgraph_State.attributes={sgraph_State_subchart, sgraph_State_orthogonal, sgraph_State_substatechartId, sgraph_State_leaf, sgraph_State_simple, sgraph_State_composite}
