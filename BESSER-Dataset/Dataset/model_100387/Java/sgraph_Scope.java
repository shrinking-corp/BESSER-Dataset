...
public class sgraph_Scope  {
    ...
    private sgraph_ScopedElement sgraph_scopedelement;
    ...
    public sgraph_Scope(
        ArrayList<sgraph_Variable> sgraph_variables,        ArrayList<sgraph_Event> sgraph_events,        ArrayList<sgraph_Declaration> sgraph_declarations    ) {
    ...
    public sgraph_ScopedElement getSgraph_scopedelement() {
        return sgraph_scopedelement;
    }

    public void setSgraph_scopedelement(sgraph_ScopedElement sgraph_scopedelement) {
        this.sgraph_scopedelement = sgraph_scopedelement;
    }
