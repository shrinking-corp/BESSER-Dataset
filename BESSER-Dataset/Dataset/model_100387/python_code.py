...
class SpecificationElement:
    ...
    pass
class sgraph_State(DocumentedElement, ScopedElement, RegularState, ReactiveElement, CompositeElement, SpecificationElement):
...
class sgraph_Declaration(NamedElement):
    ...
    pass
class sgraph_Statechart(DocumentedElement, ScopedElement, ReactiveElement, NamedElement, CompositeElement, SpecificationElement):
