...
domain_model = DomainModel(
    name="database",
    types={database_RefColumn, database_RefPKey, database_RefFKey, database_FKey, RefFKey, database_Column, database_RefTable, RefColumn, database_RefType, database_Database, RefDatabase, database_RefProcedure, database_Table, RefTable, database_Parameter, RefParameter, database_Type, RefType, database_PKey, RefPKey, database_RefDatabase, database_Procedure, RefProcedure, database_RefParameter},
    associations={columns0, pkeys1, fkeys3, columns5, reference6, type8, tables10, procedures12, type18, columns20, parameters14, return_15},
    generalizations={gen_database_FKey_RefFKey, gen_database_Column_RefColumn, gen_database_Database_RefDatabase, gen_database_Table_RefTable, gen_database_Parameter_RefParameter, gen_database_Type_RefType, gen_database_PKey_RefPKey, gen_database_Procedure_RefProcedure},
    metadata=None
)
