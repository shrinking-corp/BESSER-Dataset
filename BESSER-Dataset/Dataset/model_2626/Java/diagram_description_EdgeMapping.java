...
public class diagram_description_EdgeMapping extends description_IEdgeMapping, description_DocumentedElement, description_DiagramElementMapping {
    ...
    public diagram_description_EdgeMapping(
        String sourceFinderExpression,        boolean useDomainElement,        String pathExpression,        String domainClass,        String targetExpression,        String targetFinderExpression    ) {
        super(
        );
