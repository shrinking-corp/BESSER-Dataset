...
public class diagram_description_ContainerMapping extends description_DragAndDropTargetDescription, description_AbstractNodeMapping {
    ...
    public diagram_description_ContainerMapping(
        String childrenPresentation        ArrayList<ContainerMapping> containermappings,        ArrayList<ContainerMapping> containermappings,        ArrayList<ContainerMapping> containermappings,        ArrayList<NodeMapping> nodemappings,        ArrayList<NodeMapping> nodemappings,        ArrayList<NodeMapping> nodemappings    ) {
        this.childrenPresentation = childrenPresentation;
