...
# Classes
ansic_DomainModel = Class(name="ansic_DomainModel")
ansic_translation_unit = Class(name="ansic_translation_unit")
ansic_external_declaration = Class(name="ansic_external_declaration")
ansic_declaration_specifiers = Class(name="ansic_declaration_specifiers")
ansic_type_specifier = Class(name="ansic_type_specifier")
ansic_type_qualifier = Class(name="ansic_type_qualifier")
ansic_alignment_specifier = Class(name="ansic_alignment_specifier")
ansic_type_name = Class(name="ansic_type_name")
ansic_constant_expression = Class(name="ansic_constant_expression")
ansic_atomic_type_specifier = Class(name="ansic_atomic_type_specifier")
ansic_struct_or_union_specifier = Class(name="ansic_struct_or_union_specifier")
ansic_enum_specifier = Class(name="ansic_enum_specifier")
ansic_enumerator_list = Class(name="ansic_enumerator_list")
ansic_enumerator = Class(name="ansic_enumerator")
ansic_enumerator_list_linha = Class(name="ansic_enumerator_list_linha")
ansic_enumeration_constant = Class(name="ansic_enumeration_constant")
ansic_translation_unit_linha = Class(name="ansic_translation_unit_linha")
ansic_function_definition = Class(name="ansic_function_definition")
ansic_declaration = Class(name="ansic_declaration")
ansic_struct_or_union_specifier_complement = Class(name="ansic_struct_or_union_specifier_complement")
ansic_struct_declaration = Class(name="ansic_struct_declaration")
ansic_struct_declaration_list_linha = Class(name="ansic_struct_declaration_list_linha")
ansic_specifier_qualifier_list = Class(name="ansic_specifier_qualifier_list")
ansic_struct_declarator_list = Class(name="ansic_struct_declarator_list")
ansic_static_assert_declaration = Class(name="ansic_static_assert_declaration")
ansic_struct_declarator = Class(name="ansic_struct_declarator")
ansic_struct_declarator_list_linha = Class(name="ansic_struct_declarator_list_linha")
ansic_declarator = Class(name="ansic_declarator")
ansic_struct_declaration_list = Class(name="ansic_struct_declaration_list")
ansic_init_declarator_list = Class(name="ansic_init_declarator_list")
ansic_declaration_list = Class(name="ansic_declaration_list")
ansic_compound_statement = Class(name="ansic_compound_statement")
ansic_declaration_list_linha = Class(name="ansic_declaration_list_linha")
ansic_pointer = Class(name="ansic_pointer")
ansic_direct_declarator = Class(name="ansic_direct_declarator")
ansic_type_qualifier_list = Class(name="ansic_type_qualifier_list")
direct_abstract_declarator_complement = Class(name="direct_abstract_declarator_complement")
ansic_type_qualifier_list_linha = Class(name="ansic_type_qualifier_list_linha")
ansic_direct_declarator_linha = Class(name="ansic_direct_declarator_linha")
ansic_direct_declarator_complemento = Class(name="ansic_direct_declarator_complemento")
ansic_identifier_list = Class(name="ansic_identifier_list")
ansic_parameter_lista = Class(name="ansic_parameter_lista")
ansic_parameter_declaration = Class(name="ansic_parameter_declaration")
ansic_parameter_list_linha = Class(name="ansic_parameter_list_linha")
ansic_abstract_declarator = Class(name="ansic_abstract_declarator")
ansic_direct_abstract_declarator = Class(name="ansic_direct_abstract_declarator")
ansic_direct_abstract_declarator_linha = Class(name="ansic_direct_abstract_declarator_linha")
ansic_initializer = Class(name="ansic_initializer")
ansic_initializer_list = Class(name="ansic_initializer_list")
ansic_direct_abstract_declarator_complement = Class(name="ansic_direct_abstract_declarator_complement")
ansic_assignment_expression = Class(name="ansic_assignment_expression")
ansic_parameter_type_list = Class(name="ansic_parameter_type_list")
ansic_constant = Class(name="ansic_constant")
ansic_expression = Class(name="ansic_expression")
ansic_generic_selection = Class(name="ansic_generic_selection")
ansic_generic_assoc_list = Class(name="ansic_generic_assoc_list")
ansic_generic_association = Class(name="ansic_generic_association")
ansic_generic_assoc_list_linha = Class(name="ansic_generic_assoc_list_linha")
ansic_postfix_expression = Class(name="ansic_postfix_expression")
ansic_postfix_expression_linha = Class(name="ansic_postfix_expression_linha")
ansic_designation = Class(name="ansic_designation")
ansic_init_declarator_list_linha = Class(name="ansic_init_declarator_list_linha")
ansic_initializer_list_linha = Class(name="ansic_initializer_list_linha")
ansic_initializer_list_complement = Class(name="ansic_initializer_list_complement")
ansic_identifier_list_linha = Class(name="ansic_identifier_list_linha")
ansic_primary_expression = Class(name="ansic_primary_expression")
ansic_conditional_expression = Class(name="ansic_conditional_expression")
ansic_postfix_expression_complement = Class(name="ansic_postfix_expression_complement")
ansic_argument_expression_list = Class(name="ansic_argument_expression_list")
ansic_argument_expression_list_linha = Class(name="ansic_argument_expression_list_linha")
ansic_unary_expression = Class(name="ansic_unary_expression")
ansic_cast_expression = Class(name="ansic_cast_expression")
ansic_multiplicative_expression = Class(name="ansic_multiplicative_expression")
ansic_multiplicative_expression_linha = Class(name="ansic_multiplicative_expression_linha")
ansic_multiplicative_expression_complement = Class(name="ansic_multiplicative_expression_complement")
ansic_additive_expression = Class(name="ansic_additive_expression")
ansic_designator_list = Class(name="ansic_designator_list")
ansic_designator = Class(name="ansic_designator")
ansic_designator_list_linha = Class(name="ansic_designator_list_linha")
ansic_shift_expression = Class(name="ansic_shift_expression")
ansic_shift_expression_linha = Class(name="ansic_shift_expression_linha")
ansic_shift_expression_complement = Class(name="ansic_shift_expression_complement")
ansic_relational_expression = Class(name="ansic_relational_expression")
ansic_relational_expression_linha = Class(name="ansic_relational_expression_linha")
ansic_relational_expression_complement = Class(name="ansic_relational_expression_complement")
ansic_equality_expression = Class(name="ansic_equality_expression")
ansic_equality_expression_linha = Class(name="ansic_equality_expression_linha")
ansic_equality_expression_complement = Class(name="ansic_equality_expression_complement")
ansic_statement = Class(name="ansic_statement")
ansic_labeled_statement = Class(name="ansic_labeled_statement")
ansic_expression_statement = Class(name="ansic_expression_statement")
ansic_selection_statement = Class(name="ansic_selection_statement")
ansic_additive_expression_linha = Class(name="ansic_additive_expression_linha")
ansic_additive_expression_complement = Class(name="ansic_additive_expression_complement")
ansic_block_item_list = Class(name="ansic_block_item_list")
ansic_block_item = Class(name="ansic_block_item")
ansic_block_item_list_linha = Class(name="ansic_block_item_list_linha")
ansic_iteration_statement = Class(name="ansic_iteration_statement")
ansic_jump_statement = Class(name="ansic_jump_statement")
ansic_and_expression = Class(name="ansic_and_expression")
ansic_and_expression_linha = Class(name="ansic_and_expression_linha")
ansic_exclusive_or_expression = Class(name="ansic_exclusive_or_expression")
ansic_exclusive_or_expression_linha = Class(name="ansic_exclusive_or_expression_linha")
ansic_inclusive_or_expression = Class(name="ansic_inclusive_or_expression")
ansic_inclusive_or_expression_linha = Class(name="ansic_inclusive_or_expression_linha")
ansic_logical_and_expression = Class(name="ansic_logical_and_expression")
ansic_logical_and_expression_linha = Class(name="ansic_logical_and_expression_linha")
ansic_logical_or_expression = Class(name="ansic_logical_or_expression")
ansic_logical_or_expression_linha = Class(name="ansic_logical_or_expression_linha")
ansic_conditional_expression_linha = Class(name="ansic_conditional_expression_linha")
postfix_expression = Class(name="postfix_expression")
ansic_expression_linha = Class(name="ansic_expression_linha")
ansic_init_declarator = Class(name="ansic_init_declarator")
ansic_EnumeratorListLinhaAction = Class(name="ansic_EnumeratorListLinhaAction")
enumerator_list_linha = Class(name="enumerator_list_linha")
ansic_StructOrUnionSpecifierComplementAction = Class(name="ansic_StructOrUnionSpecifierComplementAction")
struct_or_union_specifier_complement = Class(name="struct_or_union_specifier_complement")
ansic_StructDeclarationListLinhaAction = Class(name="ansic_StructDeclarationListLinhaAction")
struct_declaration_list_linha = Class(name="struct_declaration_list_linha")
ansic_StructDeclaratorListLinhaAction = Class(name="ansic_StructDeclaratorListLinhaAction")
struct_declarator_list_linha = Class(name="struct_declarator_list_linha")
ansic_DeclarationListLinhaAction = Class(name="ansic_DeclarationListLinhaAction")
declaration_list_linha = Class(name="declaration_list_linha")
ansic_TypeQualifierListLinhaAtion = Class(name="ansic_TypeQualifierListLinhaAtion")
type_qualifier_list_linha = Class(name="type_qualifier_list_linha")
ansic_DirectAbstractDeclarratorLinhaAction = Class(name="ansic_DirectAbstractDeclarratorLinhaAction")
direct_abstract_declarator_linha = Class(name="direct_abstract_declarator_linha")
ansic_IdentifierListLinhaAction = Class(name="ansic_IdentifierListLinhaAction")
identifier_list_linha = Class(name="identifier_list_linha")
ansic_string_ufcg = Class(name="ansic_string_ufcg")
generic_assoc_list_linha = Class(name="generic_assoc_list_linha")
ansic_PostfixExpressionLinhaAction = Class(name="ansic_PostfixExpressionLinhaAction")
postfix_expression_linha = Class(name="postfix_expression_linha")
ansic_InitializerListLinhaAction = Class(name="ansic_InitializerListLinhaAction")
initializer_list_linha = Class(name="initializer_list_linha")
ansic_DesignatorListLinhaAction = Class(name="ansic_DesignatorListLinhaAction")
designator_list_linha = Class(name="designator_list_linha")
ansic_PostFixEmpryParams = Class(name="ansic_PostFixEmpryParams")
postfix_expression_complement = Class(name="postfix_expression_complement")
ansic_ArgumentExpressionListLinhaAction = Class(name="ansic_ArgumentExpressionListLinhaAction")
argument_expression_list_linha = Class(name="argument_expression_list_linha")
ansic_PlusPlus = Class(name="ansic_PlusPlus")
unary_expression = Class(name="unary_expression")
ansic_InitDecclaratorListLinhaAction = Class(name="ansic_InitDecclaratorListLinhaAction")
init_declarator_list_linha = Class(name="init_declarator_list_linha")
ansic_TranlationUnitLinhaAction = Class(name="ansic_TranlationUnitLinhaAction")
translation_unit_linha = Class(name="translation_unit_linha")
ansic_GenericAssocListLinhaAction = Class(name="ansic_GenericAssocListLinhaAction")
...
ansic_declaration_specifiers.attributes={ansic_declaration_specifiers_function_specifier, ansic_declaration_specifiers_storage_class_specifier}
...
ansic_struct_or_union_specifier.attributes={ansic_struct_or_union_specifier_identifier, ansic_struct_or_union_specifier_struct_or_union}
...
ansic_constant.attributes={ansic_constant_i_constant, ansic_constant_enumz, ansic_constant_f_constant, ansic_constant_char}
...
ansic_jump_statement_break_: Property = Property(name="break_", type=StringType)
ansic_jump_statement_return_vazio: Property = Property(name="return_vazio", type=StringType)
ansic_jump_statement_return_: Property = Property(name="return_", type=StringType)
ansic_jump_statement.attributes={ansic_jump_statement_break_, ansic_jump_statement_identifier, ansic_jump_statement_return_vazio, ansic_jump_statement_return_}
...
domain_model = DomainModel(
    name="ansic",
    types={ansic_DomainModel, ansic_translation_unit, ansic_external_declaration, ansic_declaration_specifiers, ansic_type_specifier, ansic_type_qualifier, ansic_alignment_specifier, ansic_type_name, ansic_constant_expression, ansic_atomic_type_specifier, ansic_struct_or_union_specifier, ansic_enum_specifier, ansic_enumerator_list, ansic_enumerator, ansic_enumerator_list_linha, ansic_enumeration_constant, ansic_translation_unit_linha, ansic_function_definition, ansic_declaration, ansic_struct_or_union_specifier_complement, ansic_struct_declaration, ansic_struct_declaration_list_linha, ansic_specifier_qualifier_list, ansic_struct_declarator_list, ansic_static_assert_declaration, ansic_struct_declarator, ansic_struct_declarator_list_linha, ansic_declarator, ansic_struct_declaration_list, ansic_init_declarator_list, ansic_declaration_list, ansic_compound_statement, ansic_declaration_list_linha, ansic_pointer, ansic_direct_declarator, ansic_type_qualifier_list, direct_abstract_declarator_complement, ansic_type_qualifier_list_linha, ansic_direct_declarator_linha, ansic_direct_declarator_complemento, ansic_identifier_list, ansic_parameter_lista, ansic_parameter_declaration, ansic_parameter_list_linha, ansic_abstract_declarator, ansic_direct_abstract_declarator, ansic_direct_abstract_declarator_linha, ansic_initializer, ansic_initializer_list, ansic_direct_abstract_declarator_complement, ansic_assignment_expression, ansic_parameter_type_list, ansic_constant, ansic_expression, ansic_generic_selection, ansic_generic_assoc_list, ansic_generic_association, ansic_generic_assoc_list_linha, ansic_postfix_expression, ansic_postfix_expression_linha, ansic_designation, ansic_init_declarator_list_linha, ansic_initializer_list_linha, ansic_initializer_list_complement, ansic_identifier_list_linha, ansic_primary_expression, ansic_conditional_expression, ansic_postfix_expression_complement, ansic_argument_expression_list, ansic_argument_expression_list_linha, ansic_unary_expression, ansic_cast_expression, ansic_multiplicative_expression, ansic_multiplicative_expression_linha, ansic_multiplicative_expression_complement, ansic_additive_expression, ansic_designator_list, ansic_designator, ansic_designator_list_linha, ansic_shift_expression, ansic_shift_expression_linha, ansic_shift_expression_complement, ansic_relational_expression, ansic_relational_expression_linha, ansic_relational_expression_complement, ansic_equality_expression, ansic_equality_expression_linha, ansic_equality_expression_complement, ansic_statement, ansic_labeled_statement, ansic_expression_statement, ansic_selection_statement, ansic_additive_expression_linha, ansic_additive_expression_complement, ansic_block_item_list, ansic_block_item, ansic_block_item_list_linha, ansic_iteration_statement, ansic_jump_statement, ansic_and_expression, ansic_and_expression_linha, ansic_exclusive_or_expression, ansic_exclusive_or_expression_linha, ansic_inclusive_or_expression, ansic_inclusive_or_expression_linha, ansic_logical_and_expression, ansic_logical_and_expression_linha, ansic_logical_or_expression, ansic_logical_or_expression_linha, ansic_conditional_expression_linha, postfix_expression, ansic_expression_linha, ansic_init_declarator, ansic_EnumeratorListLinhaAction, enumerator_list_linha, ansic_StructOrUnionSpecifierComplementAction, struct_or_union_specifier_complement, ansic_StructDeclarationListLinhaAction, struct_declaration_list_linha, ansic_StructDeclaratorListLinhaAction, struct_declarator_list_linha, ansic_DeclarationListLinhaAction, declaration_list_linha, ansic_TypeQualifierListLinhaAtion, type_qualifier_list_linha, ansic_DirectAbstractDeclarratorLinhaAction, direct_abstract_declarator_linha, ansic_IdentifierListLinhaAction, identifier_list_linha, ansic_string_ufcg, generic_assoc_list_linha, ansic_PostfixExpressionLinhaAction, postfix_expression_linha, ansic_InitializerListLinhaAction, initializer_list_linha, ansic_DesignatorListLinhaAction, designator_list_linha, ansic_PostFixEmpryParams, postfix_expression_complement, ansic_ArgumentExpressionListLinhaAction, argument_expression_list_linha, ansic_PlusPlus, unary_expression, ansic_InitDecclaratorListLinhaAction, init_declarator_list_linha, ansic_TranlationUnitLinhaAction, translation_unit_linha, ansic_GenericAssocListLinhaAction},
    associations={geetings0, declaration_specifiers10, type_specifier11, type_qualifier13, alignment_specifier15, type_name17, constant_expression19, atomic_type_specifier21, struct_or_union_specifier23, enum_specifier25, enumerator_list27, enumarator29, enumerator_list_linha31, enumeration_constant33, conditional_expression35, type_name38, external_declaration1, translation_unit_linha3, function_definitio5, declaration7, struct_or_union_specifier_complement43, struct_declaration45, struct_declaration_list_linha47, specifier_qualifier_list49, struct_declarator_list51, static_assert_declaration53, struct_declarator55, struct_declarator_list_linha57, constant_expression59, declarator62, struct_declaration_list41, declaration_specifiers73, init_declarator_list76, static_assert_declaration78, declaration_specifiers81, declarator84, declaration_list87, compound_statement89, declaration91, declaration_list_linha94, pointer96, direct_declarator98, type_qualifier_list100, pointer103, type_qualifier105, type_qualifier_list_linha108, direct_declarator_linha110, declarator112, direct_declarator_complemento115, type_specifier64, specifier_qualifier_list68, type_qualifier70, identifier_list127, parameter_lista129, parameter_declarations131, parameter_declaration133, parameter_list_linha136, declaration_specifiers138, declarator141, abstract_declarator144, pointer146, direct_abstract_declarator149, abstract_declarator151, type_qualifier_list154, assignment_expression157, parameter_type_list160, direct_abstract_declarator_linha163, init_declarator_list165, assignment_expression166, assignment_expression169, type_qualifier_list171, direct_declarator_linha118, type_qualifier_list120, assignment_expression123, parameter_type_list125, constant179, expression180, generic_selection182, assignment_expression184, generic_assoc_list187, generic_association189, generic_assoc_list_linha191, type_name193, assignment_expression196, primary_expression199, postfix_expression_linha201, designation203, initializer205, init_declarator_list_linha208, designation210, initializer212, parameter_type_list174, identifier_list_linha177, constant_expression221, constant_expression223, expression226, argument_expression_list228, assignment_expressions230, postfix_expression233, unary_expression236, cast_expression238, type_name240, unary_expression243, type_name246, cast_expression250, cast_expression252, multiplicative_expression_linha254, multiplicative_expression_complement256, multiplicative_expression_linha259, cast_expression261, multiplicative_expression264, designator_list215, designator217, designator_list_linha219, multiplicative_expression273, additive_expression276, shift_expression_linha278, shift_expression_complement280, shift_expression_linha283, additive_expression285, shift_expression288, relational_expression_linha290, shift_expression_complement292, relational_expression_linha296, shift_expression298, relational_expression300, equality_expression_linha302, equality_expression_complement304, equality_expression_linha307, relational_expression309, labeled_statement312, compound_statement313, expression_statement316, additive_expression_linha266, additive_expression_complement268, additive_expression_linha271, expression324, expression327, statement330, expression_statement333, expression_statement2336, declaration339, expression342, statement345, statement2348, statement351, conditional_expression354, block_item_list357, block_item359, block_item_list_linha361, selection_statement318, iteration_statement320, jump_statement322, expression375, equality_expression378, and_expression_linha380, equality_expression382, and_expression_linha386, and_expression388, exclusive_or_expression_linha390, and_expression392, exclusive_or_expression_linha396, exclusive_or_expression398, inclusive_or_expression_linha400, exclusive_or_expression402, inclusive_or_expression_linha406, inclusive_or_expression408, logical_and_expression_linha410, inclusive_or_expression412, logical_and_expression_linha416, logical_and_expression418, logical_or_expression_linha420, block_item363, block_item_list_linha367, declaration369, statement372, logical_or_expression428, conditional_expression_linha431, expression433, conditional_expression436, conditional_expression_linha440, conditional_expression442, unary_expression445, assignment_expression449, initializer_list451, specifier_qualifier_list454, abstract_declarator457, assignment_expression460, expression_linha463, assignment_expression465, expression_linha469, conditional_expression471, init_declarator474, init_declarator_list_linha476, logical_and_expression422, logical_or_expression_linha426, enumerator485, enumerator_list_linha487, struct_declaration_list490, struct_declaration492, struct_declaration_list_linha494, struct_declarator497, struct_declarator_list_linha499, declaration502, declaration_list_linha504, type_qualifier507, type_qualifier_list_linha509, direct_abstract_declarator_complement512, direct_abstract_declarator_linha514, identifier_list_linha517, declarator479, initializer482, generic_association524, generic_assoc_list_linha526, postfix_expression_complement529, postfix_expression_linha531, initializer_list_complement534, init_declarator_list_linha536, designator539, designator_list_linha541, assignment_expression544, argument_expression_list_linha546, init_declarator548, init_declarator_list_linha550, external_declaration519, translation_unit_linha521},
    generalizations={gen_ansic_type_qualifier_list_direct_abstract_declarator_complement, gen_ansic_type_name_postfix_expression, gen_ansic_EnumeratorListLinhaAction_enumerator_list_linha, gen_ansic_StructOrUnionSpecifierComplementAction_struct_or_union_specifier_complement, gen_ansic_StructDeclarationListLinhaAction_struct_declaration_list_linha, gen_ansic_StructDeclaratorListLinhaAction_struct_declarator_list_linha, gen_ansic_DeclarationListLinhaAction_declaration_list_linha, gen_ansic_TypeQualifierListLinhaAtion_type_qualifier_list_linha, gen_ansic_DirectAbstractDeclarratorLinhaAction_direct_abstract_declarator_linha, gen_ansic_IdentifierListLinhaAction_identifier_list_linha, gen_ansic_GenericAssocListLinhaAction_generic_assoc_list_linha, gen_ansic_PostfixExpressionLinhaAction_postfix_expression_linha, gen_ansic_InitializerListLinhaAction_initializer_list_linha, gen_ansic_DesignatorListLinhaAction_designator_list_linha, gen_ansic_PostFixEmpryParams_postfix_expression_complement, gen_ansic_ArgumentExpressionListLinhaAction_argument_expression_list_linha, gen_ansic_PlusPlus_unary_expression, gen_ansic_InitDecclaratorListLinhaAction_init_declarator_list_linha, gen_ansic_TranlationUnitLinhaAction_translation_unit_linha},
    metadata=None
)
