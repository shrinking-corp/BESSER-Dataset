...
domain_model = DomainModel(
    name="expressions",
    types={expressions_Expression, FileRegion, expressions_ConstExpression, Expression, expressions_OrExpression, expressions_XOrExpression, expressions_AddExpression, expressions_MultExpression, expressions_UnaryExpression, expressions_ScopeLiteral, expressions_IdlTypeDcl, expressions_IntegerLiteral, expressions_AndExpression, expressions_ShiftExpression, expressions_WideStringLiteral, expressions_WideCharacterLiteral, expressions_StringLiteral, expressions_CharacterLiteral, expressions_FloatingPointLiteral, expressions_DoubleLiteral, expressions_BooleanLiteral, expressions_FixedPtLiteral, AddType, MultiType, UnaryType, ShiftType},
    associations={expression0, left1, right3, left6, right8, left21, right23, left26, right28, expr31, value33, left11, right13, left16, right18},
    generalizations={gen_expressions_Expression_FileRegion, gen_expressions_ConstExpression_Expression, gen_expressions_OrExpression_Expression, gen_expressions_XOrExpression_Expression, gen_expressions_AddExpression_Expression, gen_expressions_MultExpression_Expression, gen_expressions_UnaryExpression_Expression, gen_expressions_ScopeLiteral_Expression, gen_expressions_IntegerLiteral_Expression, gen_expressions_AndExpression_Expression, gen_expressions_ShiftExpression_Expression, gen_expressions_WideStringLiteral_Expression, gen_expressions_WideCharacterLiteral_Expression, gen_expressions_StringLiteral_Expression, gen_expressions_CharacterLiteral_Expression, gen_expressions_FloatingPointLiteral_Expression, gen_expressions_DoubleLiteral_Expression, gen_expressions_BooleanLiteral_Expression, gen_expressions_FixedPtLiteral_Expression},
    metadata=None
)
