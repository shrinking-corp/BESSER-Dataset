...
sgraph_Import = Class(name="sgraph_Import")
...
sgraph_RegularState = Class(name="sgraph_RegularState", is_abstract=True)
sgraph_ImportDeclaration = Class(name="sgraph_ImportDeclaration")
...
sgraph_Statechart_domainID: Property = Property(name="domainID", type=StringType)
sgraph_Statechart.attributes={sgraph_Statechart_domainID}
...
# sgraph_Import class attributes and methods
sgraph_Import_importedNamespace: Property = Property(name="importedNamespace", type=StringType)
sgraph_Import.attributes={sgraph_Import_importedNamespace}
...
sgraph_State.attributes={sgraph_State_subchart, sgraph_State_substatechartId, sgraph_State_simple, sgraph_State_leaf, sgraph_State_orthogonal, sgraph_State_composite}
...
imports10: BinaryAssociation = BinaryAssociation(
    name="imports10",
    ends={
        Property(name="sgraph_Import", type=sgraph_Statechart, multiplicity=Multiplicity(1, 1)),
        Property(name="sgraph_Statechart", type=sgraph_Import, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
properties19: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="sgraph_Reaction20", type=sgraph_ReactionProperty, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
reactions11: BinaryAssociation = BinaryAssociation(
    name="reactions11",
    ends={
...
localReactions12: BinaryAssociation = BinaryAssociation(
    name="localReactions12",
    ends={
        Property(name="sgraph_Reaction14", type=sgraph_ReactiveElement, multiplicity=Multiplicity(1, 1)),
        Property(name="sgraph_ReactiveElement13", type=sgraph_Reaction, multiplicity=Multiplicity(0, 9999))
    }
)
trigger15: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="sgraph_Reaction16", type=sgraph_Trigger, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
effect17: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="sgraph_Reaction18", type=sgraph_Effect, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
...
events22: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="sgraph_Scope23", type=sgraph_Event, multiplicity=Multiplicity(0, 9999))
    }
)
variables24: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="sgraph_Scope25", type=sgraph_Variable, multiplicity=Multiplicity(0, 9999))
    }
)
scopes26: BinaryAssociation = BinaryAssociation(
    name="scopes26",
    ends={
        Property(name="sgraph_Scope27", type=sgraph_ScopedElement, multiplicity=Multiplicity(1, 1)),
...
regions30: BinaryAssociation = BinaryAssociation(
    name="regions30",
    ends={
        Property(name="Region31", type=sgraph_CompositeElement, multiplicity=Multiplicity(1, 1)),
        Property(name="composite", type=sgraph_Region, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
substatechart28: BinaryAssociation = BinaryAssociation(
    name="substatechart28",
    ends={
...
declaration32: BinaryAssociation = BinaryAssociation(
    name="declaration32",
    ends={
        Property(name="sgraph_Declaration33", type=sgraph_ImportDeclaration, multiplicity=Multiplicity(1, 1)),
...
domain_model = DomainModel(
    name="sgraph",
    types={sgraph_Transition, sgraph_Pseudostate, Vertex, sgraph_Vertex, NamedElement, sgraph_Region, sgraph_FinalState, RegularState, sgraph_CompositeElement, SpecificationElement, Reaction, DocumentedElement, sgraph_Variable, Declaration, sgraph_Event, sgraph_Choice, Pseudostate, sgraph_Statechart, ReactiveElement, ScopedElement, CompositeElement, sgraph_Import, sgraph_Entry, sgraph_ReactionProperty, sgraph_Exit, sgraph_ReactiveElement, sgraph_Reaction, sgraph_Trigger, sgraph_Effect, sgraph_Synchronization, sgraph_State, sgraph_SpecificationElement, sgraph_Declaration, sgraph_Scope, sgraph_ScopedElement, sgraph_RegularState, sgraph_ImportDeclaration, EntryKind, ChoiceKind},
    associations={incomingTransitions1, parentRegion0, outgoingTransitions2, vertices4, composite5, target6, source8, imports10, properties19, reactions11, localReactions12, trigger15, effect17, declarations21, events22, variables24, scopes26, regions30, substatechart28, declaration32},
    generalizations={gen_sgraph_Pseudostate_Vertex, gen_sgraph_Vertex_NamedElement, gen_sgraph_FinalState_RegularState, gen_sgraph_Region_NamedElement, gen_sgraph_Transition_SpecificationElement, gen_sgraph_Transition_Reaction, gen_sgraph_Transition_DocumentedElement, gen_sgraph_Variable_Declaration, gen_sgraph_Event_Declaration, gen_sgraph_Choice_Pseudostate, gen_sgraph_Statechart_SpecificationElement, gen_sgraph_Statechart_ReactiveElement, gen_sgraph_Statechart_ScopedElement, gen_sgraph_Statechart_CompositeElement, gen_sgraph_Statechart_NamedElement, gen_sgraph_Statechart_DocumentedElement, gen_sgraph_Entry_Pseudostate, gen_sgraph_Exit_Pseudostate, gen_sgraph_Synchronization_Pseudostate, gen_sgraph_State_SpecificationElement, gen_sgraph_Declaration_NamedElement, gen_sgraph_RegularState_Vertex, gen_sgraph_State_ReactiveElement, gen_sgraph_State_ScopedElement, gen_sgraph_State_RegularState, gen_sgraph_State_CompositeElement, gen_sgraph_State_DocumentedElement, gen_sgraph_ImportDeclaration_Declaration},
    metadata=None
)
