...
class RegularState:
    ...
    pass
class sgraph_State(DocumentedElement, CompositeElement, ScopedElement, ReactiveElement, SpecificationElement, RegularState):
...
class NamedElement:
    ...
    pass
class sgraph_Statechart(DocumentedElement, CompositeElement, ReactiveElement, ScopedElement, SpecificationElement, NamedElement):
