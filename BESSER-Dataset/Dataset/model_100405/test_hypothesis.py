...
def test_sgraph_statechart_has_domainID():
    assert hasattr(sgraph_Statechart, "domainID")
    descriptor = None
    for klass in sgraph_Statechart.__mro__:
...
@given(instance=sgraph_Statechart_strategy)
def test_sgraph_statechart_domainID_setter(instance):
