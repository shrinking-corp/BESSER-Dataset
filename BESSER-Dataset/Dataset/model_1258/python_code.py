...
class QVTOperational_VarParameter:
    ...
    def __init__(self, kind: str, QVTOperational_VarParameter38: "ImperativeOperation" = None, QVTOperational_VarParameter: "ImperativeOperation" = None):
        self.kind = kind
...
class QVTOperational_ImperativeOperation:
    ...
    def __init__(self, isBlackbox: str, QVTOperational_ImperativeOperation4: "ImperativeOperation" = None, QVTOperational_ImperativeOperation6: set["VarParameter"] = None, QVTOperational_ImperativeOperation: "OperationBody" = None, QVTOperational_ImperativeOperation2: "VarParameter" = None):
        self.isBlackbox = isBlackbox
...
class QVTOperational_Helper(ImperativeOperation):
    ...
    def __init__(self, isQuery: str, ImperativeOperation36: "QVTOperational_VarParameter" = None, ImperativeOperation: "QVTOperational_ImperativeOperation" = None, ImperativeOperation30: "QVTOperational_OperationBody" = None, ImperativeOperation39: "QVTOperational_VarParameter" = None):
