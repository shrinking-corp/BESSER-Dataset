...
domain_model = DomainModel(
    name="QVTOperational",
    types={QVTOperational_Constructor, ImperativeOperation, QVTOperational_ConstructorBody, OperationBody, QVTOperational_ContextualProperty, QVTOperational_EntryOperation, QVTOperational_Helper, QVTOperational_ImperativeCallExp, QVTOperational_ImperativeOperation, VarParameter, QVTOperational_Library, Module, QVTOperational_MappingBody, QVTOperational_MappingCallExp, ImperativeCallExp, QVTOperational_MappingOperation, MappingOperation, QVTOperational_MappingParameter, ModelParameter, QVTOperational_ModelParameter, QVTOperational_ModelType, QVTOperational_Module, EntryOperation, ModuleImport, ModelType, QVTOperational_ModuleImport, QVTOperational_ObjectExp, ConstructorBody, QVTOperational_OperationBody, QVTOperational_OperationalTransformation, QVTOperational_ResolveExp, QVTOperational_ResolveInExp, ResolveExp, QVTOperational_VarParameter, ImportKind, DirectionKind},
    associations={body0, context1, overridden3, result5, disjunct8, inherited9, merged12, extent15, entry16, moduleImport17, usedModelType19, binding21, importedModule23, module25, body28, resOwner37, operation29, modelParameter31, inMapping33, ctxOwner35},
