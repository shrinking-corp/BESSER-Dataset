...
domain_model = DomainModel(
    name="lit_petriNets",
    types={lit_petriNets_Place, lit_petriNets_Transition, lit_petriNets_Arc, lit_petriNets_PTArc, lit_petriNets_TPArc, Arc, lit_petriNets_Net},
    associations={places0, transitions1, arcs3, net5, out6, in_7, net8, in_10, out13, src16, dst18, src20, dst23, net26},
