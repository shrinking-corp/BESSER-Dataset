...
class lit_petriNets_Transition:
    ...
    def __init__(self, name: str, Transition: "lit_petriNets_Net" = None, transitions: "lit_petriNets_Net" = None, dst11: set["lit_petriNets_PTArc"] = None, src14: set["lit_petriNets_TPArc"] = None, Transition19: "lit_petriNets_PTArc" = None, Transition22: "lit_petriNets_TPArc" = None):
        self.name = name
...
class lit_petriNets_Place:
    ...
    def __init__(self, name: str, Place: "lit_petriNets_Net" = None, places: "lit_petriNets_Net" = None, src: set["lit_petriNets_PTArc"] = None, dst: set["lit_petriNets_TPArc"] = None, Place17: "lit_petriNets_PTArc" = None, Place25: "lit_petriNets_TPArc" = None):
        self.name = name
        self.Place = Place
        self.places = places
    ...
    def Place25(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "in_24"):
                opp_val = getattr(old_value, "in_24", None)
                if opp_val == self:
                    setattr(old_value, "in_24", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "in_24"):
                opp_val = getattr(value, "in_24", None)
                setattr(value, "in_24", self)
