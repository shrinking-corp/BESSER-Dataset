...
class Profile:
    ...
    def __init__(self, username: str, money: int, blackjack4: "BlackjackGame" = None, player21: "Player" = None, loginView1: "LoginView" = None):
...
class LoginView:
    ...
    def __init__(self, user: Profile, gameLauncher3: "GameLauncher" = None, profile0: "Profile" = None):
        self.user = user
