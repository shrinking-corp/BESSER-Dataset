...
Card.attributes={Card_name, Card_avatar, Card_Count, Card_rank, Card_valueSoft, Card_suit, Card_valueHard}
...
GameView.attributes={GameView_doubleButton, GameView_bet, GameView_splitButton, GameView_standButton, GameView_showStrategy, GameView_hitButton, GameView_dealButton}
...
PlayerView.attributes={PlayerView_player, PlayerView_status, PlayerView_cardTotal, PlayerView_moneyBox, PlayerView_busted, PlayerView_cardLabels}
...
BlackjackGame.attributes={BlackjackGame_deck, BlackjackGame_bet, BlackjackGame_player, BlackjackGame_dealer}
...
domain_model = DomainModel(
    name="f80841a6_3b5e_4530_9cf2_fa1d64b254da",
    types={GameLauncher, LoginView, Card, Strategy, JButton, GameView, BasePlayer, User_Actor, UseCase_UseCase, JLabel, Player, Dealer, PlayerView, BlackjackGame, Deck, Hand, Profile},
