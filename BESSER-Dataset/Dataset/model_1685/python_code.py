...
class relationpattern_Category(ABC):
    ...
    def affectation(self, relationpattern_cible, relationpattern_source) :
        # TODO: Implement affectation method
        pass

    def compare(self, relationpattern_n1, relationpattern_n2) :
        # TODO: Implement compare method
        pass

    def affectationInterval(self, relationpattern_target) :
        # TODO: Implement affectationInterval method
        pass

class relationpattern_TargetNode(ABC):

    def __init__(self, relationpattern_TargetNode21: "relationpattern_Category" = None, relationpattern_TargetNode: "relationpattern_Arrow" = None):
    ...
    def compare(self, relationpattern_noeud) :
        # TODO: Implement compare method
        pass
...
class relationpattern_Arrow(ABC):
    ...
    def __init__(self, relationpattern_Arrow18: "relationpattern_Category" = None, relationpattern_Arrow: "relationpattern_SourceNode" = None, relationpattern_Arrow13: "relationpattern_TargetNode" = None):
...
class relationpattern_World(Category):
    ...
    def compare(self, relationpattern_personne1, relationpattern_personne2) :
        # TODO: Implement compare method
        pass

    def affectationInterval(self, relationpattern_thingb) :
        # TODO: Implement affectationInterval method
        pass

    def affectation(self, relationpattern_role, relationpattern_personne) :
        # TODO: Implement affectation method
        pass
...
class NamedElement:
    ...
    pass
class relationpattern_RelatedTo(NamedElement, Arrow):

    def __init__(self, relationpattern_RelatedTo: "relationpattern_ThingA" = None, relationpattern_RelatedTo2: "relationpattern_ThingB" = None, relationpattern_RelatedTo10: "relationpattern_World" = None):
...
class relationpattern_ThingB(NamedElement, TargetNode):
    ...
    def compare(self, relationpattern_role) :
        # TODO: Implement compare method
        pass
...
class SourceNode:
    ...
    pass
class relationpattern_ThingA(NamedElement, SourceNode):
    ...
    def compare(self, relationpattern_personne) :
        # TODO: Implement compare method
        pass
