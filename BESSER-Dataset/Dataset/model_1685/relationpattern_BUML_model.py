...
# Classes
relationpattern_ThingA = Class(name="relationpattern_ThingA")
SourceNode = Class(name="SourceNode")
NamedElement = Class(name="NamedElement")
relationpattern_RelatedTo = Class(name="relationpattern_RelatedTo")
Arrow = Class(name="Arrow")
relationpattern_World = Class(name="relationpattern_World")
Category = Class(name="Category")
relationpattern_SourceNode = Class(name="relationpattern_SourceNode", is_abstract=True)
relationpattern_Arrow = Class(name="relationpattern_Arrow", is_abstract=True)
relationpattern_ThingB = Class(name="relationpattern_ThingB")
TargetNode = Class(name="TargetNode")
relationpattern_NamedElement = Class(name="relationpattern_NamedElement")
relationpattern_TargetNode = Class(name="relationpattern_TargetNode", is_abstract=True)
relationpattern_Category = Class(name="relationpattern_Category", is_abstract=True)
...
relationpattern_ThingA_m_compare: Method = Method(name="compare", parameters={Parameter(name='relationpattern_personne', type=StringType)}, type=IntegerType)
...
relationpattern_ThingA.methods={relationpattern_ThingA_m_compare, relationpattern_ThingA_m_succ, relationpattern_ThingA_m_pred}
...
relationpattern_World_m_compare: Method = Method(name="compare", parameters={Parameter(name='relationpattern_role1', type=StringType), Parameter(name='relationpattern_role2', type=StringType)}, type=IntegerType)
relationpattern_World_m_compare: Method = Method(name="compare", parameters={Parameter(name='relationpattern_personne1', type=StringType), Parameter(name='relationpattern_personne2', type=StringType)}, type=IntegerType)
relationpattern_World_m_affectation: Method = Method(name="affectation", parameters={Parameter(name='relationpattern_personne', type=StringType), Parameter(name='relationpattern_role', type=StringType)}, type=StringType)
relationpattern_World_m_affectationInterval: Method = Method(name="affectationInterval", parameters={Parameter(name='relationpattern_thingb', type=StringType)}, type=StringType)
relationpattern_World.methods={relationpattern_World_m_compare, relationpattern_World_m_compare, relationpattern_World_m_affectation, relationpattern_World_m_affectationInterval}

# Category class attributes and methods

# relationpattern_SourceNode class attributes and methods
relationpattern_SourceNode_m_compare: Method = Method(name="compare", parameters={Parameter(name='relationpattern_noeud', type=StringType)}, type=IntegerType)
...
relationpattern_SourceNode.methods={relationpattern_SourceNode_m_compare, relationpattern_SourceNode_m_succ, relationpattern_SourceNode_m_pred}
...
relationpattern_ThingB_m_compare: Method = Method(name="compare", parameters={Parameter(name='relationpattern_role', type=StringType)}, type=IntegerType)
...
relationpattern_ThingB.methods={relationpattern_ThingB_m_pred, relationpattern_ThingB_m_compare, relationpattern_ThingB_m_succ}
...
relationpattern_TargetNode_m_compare: Method = Method(name="compare", parameters={Parameter(name='relationpattern_noeud', type=StringType)}, type=IntegerType)
...
relationpattern_TargetNode.methods={relationpattern_TargetNode_m_pred, relationpattern_TargetNode_m_succ, relationpattern_TargetNode_m_compare}
...
relationpattern_Category_m_affectationInterval: Method = Method(name="affectationInterval", parameters={Parameter(name='relationpattern_target', type=StringType)}, type=SourceNode)
relationpattern_Category_m_affectation: Method = Method(name="affectation", parameters={Parameter(name='relationpattern_source', type=StringType), Parameter(name='relationpattern_cible', type=StringType)}, type=Arrow)
relationpattern_Category_m_compare: Method = Method(name="compare", parameters={Parameter(name='relationpattern_n2', type=StringType), Parameter(name='relationpattern_n1', type=StringType)}, type=IntegerType)
relationpattern_Category_m_compare: Method = Method(name="compare", parameters={Parameter(name='relationpattern_n1', type=StringType), Parameter(name='relationpattern_n2', type=StringType)}, type=IntegerType)
relationpattern_Category.attributes={relationpattern_Category_nom}
relationpattern_Category.methods={relationpattern_Category_m_affectation, relationpattern_Category_m_compare, relationpattern_Category_m_compare, relationpattern_Category_m_affectationInterval}
...
domain_model = DomainModel(
    ...
    types={relationpattern_ThingA, SourceNode, NamedElement, relationpattern_RelatedTo, Arrow, relationpattern_World, Category, relationpattern_SourceNode, relationpattern_Arrow, relationpattern_ThingB, TargetNode, relationpattern_NamedElement, relationpattern_TargetNode, relationpattern_Category, Scale},
    associations={thingA0, thingB1, thingsa3, thingsb5, relations8, sources14, fleches16, targets19, source11, cible12},
    generalizations={gen_relationpattern_ThingA_SourceNode, gen_relationpattern_ThingA_NamedElement, gen_relationpattern_RelatedTo_Arrow, gen_relationpattern_RelatedTo_NamedElement, gen_relationpattern_World_Category, gen_relationpattern_ThingB_TargetNode, gen_relationpattern_ThingB_NamedElement},
    metadata=None
)
