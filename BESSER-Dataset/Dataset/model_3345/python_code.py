...
class StringElement:
    ...
    pass
class JavaSimplified_Method(CommentedElement, StringElement, NamedElement):
...
class JavaSimplified_Field(CommentedElement, TypedElement, NamedElement, StringElement):
