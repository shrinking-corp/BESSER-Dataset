...
class UnresolvedItem:
    ...
    pass
class java__UnresolvedEnumDeclaration(UnresolvedItem, EnumDeclaration):
...
class java__UnresolvedClassDeclaration(UnresolvedItem, ClassDeclaration):
    ...
    pass
class java__UnresolvedInterfaceDeclaration(UnresolvedItem, InterfaceDeclaration):
...
class java__CompilationUnit(NamedElement):
    ...
    def __init__(self, originalFilePath: str, java__CompilationUnit: "java__ASTNode" = None, java__CompilationUnit108: "java__ClassFile" = None, java__CompilationUnit137: set["java__AbstractTypeDeclaration"] = None, java__CompilationUnit129: set["java__Comment"] = None, java__CompilationUnit132: set["java__ImportDeclaration"] = None, java__CompilationUnit134: "java__Package" = None, java__CompilationUnit242: "java__Model" = None):
...
class java__VariableDeclaration(NamedElement):
    ...
    def __init__(self, extraArrayDimensions: int, VariableDeclaration: "java__SingleVariableAccess" = None, variable: set["java__SingleVariableAccess"] = None, java__VariableDeclaration: "java__Expression" = None):
        self.extraArrayDimensions = extraArrayDimensions
...
class java__NamedElement(ASTNode):
    ...
    def __init__(self, name: str, proxy: bool, java__NamedElement: "java__MemberRef" = None, NamedElement: "java__ImportDeclaration" = None, importedElement: set["java__ImportDeclaration"] = None):
        self.name = name
        self.proxy = proxy
...
class java__Modifier(ASTNode):
    ...
    def __init__(self, inheritance: str, static: bool, transient: bool, volatile: bool, native: bool, strictfp: bool, synchronized: bool, visibility: str, Modifier: "java__BodyDeclaration" = None, modifier: "java__BodyDeclaration" = None, modifier252: "java__SingleVariableDeclaration" = None, modifier255: "java__VariableDeclarationStatement" = None, modifier257: "java__VariableDeclarationExpression" = None, Modifier294: "java__SingleVariableDeclaration" = None, Modifier355: "java__VariableDeclarationExpression" = None, Modifier360: "java__VariableDeclarationStatement" = None):
...
class java__MethodRefParameter(ASTNode):
    ...
    def __init__(self, name: str, varargs: bool, java__MethodRefParameter233: "java__TypeAccess" = None, java__MethodRefParameter: "java__MethodRef" = None):
        self.name = name
