...
public class java__AbstractMethodDeclaration extends BodyDeclaration {
    ...
    public java__AbstractMethodDeclaration(
        ArrayList<java__TypeAccess> java__typeaccesss,        ArrayList<java__TypeParameter> java__typeparameters,        ArrayList<java__SingleVariableDeclaration> java__singlevariabledeclarations,        ArrayList<java__MethodRef> java__methodrefs,        ArrayList<java__AbstractMethodInvocation> java__abstractmethodinvocations    ) {
