...
domain_model = DomainModel(
    name="swml",
    types={swml_HypertextLayer, swml_ContentLayer, swml_Page, swml_Class, swml_Attribute, swml_WebModel, swml_IndexPage, DynamicPage, swml_DetailsPage, swml_DynamicPage, Page, swml_StaticPage, swml_NCLink, Link, swml_CLink, swml_Link, SWMLTypes},
    associations={hypertext0, content1, pages3, homePage5, classes8, attributes10, representativeAttribute12, displayedClass16, target18, source20, links15},
