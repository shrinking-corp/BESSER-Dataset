...
class swml_Page(ABC):
    ...
    def __init__(self, name: str, swml_Page: "swml_HypertextLayer" = None, swml_Page7: "swml_HypertextLayer" = None, swml_Page19: "swml_Link" = None, Page: "swml_Link" = None, source: set["swml_Link"] = None):
        self.name = name
