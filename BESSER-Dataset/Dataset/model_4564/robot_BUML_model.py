...
# Classes
robot_robot_Command = Class(name="robot_robot_Command", is_abstract=True)
Expression = Class(name="Expression")
robot_FlotCtrl_Expression = Class(name="robot_FlotCtrl_Expression", is_abstract=True)
robot_FlotCtrl_WhileLoop = Class(name="robot_FlotCtrl_WhileLoop")
BoolExp = Class(name="BoolExp")
robot_robot_MoveCmd = Class(name="robot_robot_MoveCmd")
Command = Class(name="Command")
robot_robot_ObstacleCmd = Class(name="robot_robot_ObstacleCmd")
FlotCtrl_BoolExp = Class(name="FlotCtrl_BoolExp")
robot_Command = Class(name="robot_Command")
robot_robot_Bip = Class(name="robot_robot_Bip")
robot_robot_SetTurnAngleCmd = Class(name="robot_robot_SetTurnAngleCmd")
robot_robot_HasTurnedCmd = Class(name="robot_robot_HasTurnedCmd")
robot_robot_TurnCmd = Class(name="robot_robot_TurnCmd")
robot_robot_StopEngineCmd = Class(name="robot_robot_StopEngineCmd")
robot_robot_StopProgramCmd = Class(name="robot_robot_StopProgramCmd")
robot_robot_PrintCmd = Class(name="robot_robot_PrintCmd")
robot_robot_ProgramUnit = Class(name="robot_robot_ProgramUnit")
robot_FlotCtrl_NegExp = Class(name="robot_FlotCtrl_NegExp")
robot_FlotCtrl_BoolExp = Class(name="robot_FlotCtrl_BoolExp", is_abstract=True)
robot_FlotCtrl_AndExp = Class(name="robot_FlotCtrl_AndExp")
robot_FlotCtrl_IfBlock = Class(name="robot_FlotCtrl_IfBlock")
...
robot_robot_TurnCmd.attributes={robot_robot_TurnCmd_angle, robot_robot_TurnCmd_power}
...
robot_robot_PrintCmd.attributes={robot_robot_PrintCmd_duration, robot_robot_PrintCmd_msg, robot_robot_PrintCmd_line, robot_robot_PrintCmd_col}
...
domain_model = DomainModel(
    name="robot",
    types={robot_robot_Command, Expression, robot_FlotCtrl_Expression, robot_FlotCtrl_WhileLoop, BoolExp, robot_robot_MoveCmd, Command, robot_robot_ObstacleCmd, FlotCtrl_BoolExp, robot_Command, robot_robot_Bip, robot_robot_SetTurnAngleCmd, robot_robot_HasTurnedCmd, robot_robot_TurnCmd, robot_robot_StopEngineCmd, robot_robot_StopProgramCmd, robot_robot_PrintCmd, robot_robot_ProgramUnit, robot_FlotCtrl_NegExp, robot_FlotCtrl_BoolExp, robot_FlotCtrl_AndExp, robot_FlotCtrl_IfBlock},
    associations={block0, loopCond1, block2, exp5, leftExp7, rightExp9, condition12, thenBlock14, elseBlock17},
    generalizations={gen_robot_robot_Command_Expression, gen_robot_FlotCtrl_WhileLoop_Expression, gen_robot_robot_MoveCmd_Command, gen_robot_robot_ObstacleCmd_FlotCtrl_BoolExp, gen_robot_robot_ObstacleCmd_robot_Command, gen_robot_robot_Bip_Command, gen_robot_robot_SetTurnAngleCmd_Command, gen_robot_robot_HasTurnedCmd_FlotCtrl_BoolExp, gen_robot_robot_HasTurnedCmd_robot_Command, gen_robot_robot_TurnCmd_Command, gen_robot_robot_StopEngineCmd_Command, gen_robot_robot_StopProgramCmd_Command, gen_robot_robot_PrintCmd_Command, gen_robot_FlotCtrl_NegExp_BoolExp, gen_robot_FlotCtrl_BoolExp_Expression, gen_robot_FlotCtrl_AndExp_BoolExp, gen_robot_FlotCtrl_IfBlock_Expression},
    metadata=None
)
