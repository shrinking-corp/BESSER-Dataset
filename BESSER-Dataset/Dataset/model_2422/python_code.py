...
class ingest_DbTable:
    ...
    def __init__(self, name: str, ingest_DbTable3: set["ingest_SqoopImport"] = None, ingest_DbTable6: "ingest_DbSchema" = None, ingest_DbTable: set["ingest_DbColumn"] = None):
        self.name = name
...
class ingest_DbSchema:
    ...
    def __init__(self, name: str, ingest_DbSchema5: set["ingest_DbTable"] = None, ingest_DbSchema: "ingest_Database" = None):
        self.name = name
