...
# Classes
ingest_Database = Class(name="ingest_Database")
ingest_SqoopImport = Class(name="ingest_SqoopImport")
ingest_SqoopHiveImport = Class(name="ingest_SqoopHiveImport")
SqoopImport = Class(name="SqoopImport")
ingest_SqoopHiveIncrementalImport = Class(name="ingest_SqoopHiveIncrementalImport")
SqoopHiveImport = Class(name="SqoopHiveImport")
ingest_DbSchema = Class(name="ingest_DbSchema")
ingest_DbTable = Class(name="ingest_DbTable")
ingest_DbColumn = Class(name="ingest_DbColumn")
ingest_Catalogue = Class(name="ingest_Catalogue")
...
ingest_Database.attributes={ingest_Database_jdbcUrl, ingest_Database_label, ingest_Database_jdbcPassword, ingest_Database_jdbcUser, ingest_Database_jdbcDriver}
...
ingest_SqoopHiveImport.attributes={ingest_SqoopHiveImport_targetHiveTable, ingest_SqoopHiveImport_targetHiveDatabase}
...
ingest_DbColumn.attributes={ingest_DbColumn_name, ingest_DbColumn_jdbcPrecision, ingest_DbColumn_jdbcType, ingest_DbColumn_jdbcScale}
...
domain_model = DomainModel(
    name="ingest",
    types={ingest_Database, ingest_SqoopImport, ingest_SqoopHiveImport, SqoopImport, ingest_SqoopHiveIncrementalImport, SqoopHiveImport, ingest_DbSchema, ingest_DbTable, ingest_DbColumn, ingest_Catalogue},
    associations={sqoopImports2, tables4, checkColumn7, schemas0, columns1, databases9},
