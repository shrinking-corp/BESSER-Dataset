...
def test_hyp_c1_constructor_args():
    ...
    assert "atC2" in params, "Missing parameter 'atC2'"
...
@given(instance=C1_strategy)
def test_hyp_c1_atC2_setter(instance):
    original = instance.atC2
    instance.atC2 = original
    assert instance.atC2 == original
...
@given(instance=C_strategy)
def test_hyp_c_atC2_setter(instance):
    original = instance.atC2
    instance.atC2 = original
    assert instance.atC2 == original
...
def test_C_atC2_value_roundtrip():
    instance = C(atC2=True, attC1=7)
    assert instance.atC2 == True
    instance.atC2 = False
    assert instance.atC2 == False
...
def test_C1_atC2_value_roundtrip():
    instance = C1(atC2=True, attC1=7)
    assert instance.atC2 == True
    instance.atC2 = False
    assert instance.atC2 == False
...
C_strategy = st.builds(C, atC2=st.booleans(), attC1=st.integers())
@given(instance=C_strategy)
@settings(max_examples=25)
...
C1_strategy = st.builds(C1, atC2=st.booleans(), attC1=st.integers())
@given(instance=C1_strategy)
@settings(max_examples=25)
