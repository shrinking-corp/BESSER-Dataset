...
spreadsheet_Spreadsheet.attributes={spreadsheet_Spreadsheet_FilePath, spreadsheet_Spreadsheet_Label}
spreadsheet_Spreadsheet.methods={spreadsheet_Spreadsheet_m_readFile, spreadsheet_Spreadsheet_m_getSheet, spreadsheet_Spreadsheet_m_getSheet}
...
spreadsheet_Sheet.attributes={spreadsheet_Sheet_SheetName, spreadsheet_Sheet_SheetIndex}
spreadsheet_Sheet.methods={spreadsheet_Sheet_m_getRow, spreadsheet_Sheet_m_getColumn}
...
spreadsheet_Cell.attributes={spreadsheet_Cell_StringValue, spreadsheet_Cell_ValueFormatted, spreadsheet_Cell_DoubleValue, spreadsheet_Cell_CellType}
...
domain_model = DomainModel(
    name="spreadsheet",
    types={spreadsheet_Spreadsheet, spreadsheet_Sheet, spreadsheet_Row, spreadsheet_Column, spreadsheet_Cell, CellType},
    associations={Sheet0, Row1, Column3, Spreadsheet5, Cell8, Sheet10, Cell13, Sheet16, Row19, Column22},
    generalizations={},
    metadata=None
)
