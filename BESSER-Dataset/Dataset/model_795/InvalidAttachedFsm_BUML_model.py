...
FSM = Class(name="FSM")
ecore_ENamedElement = Class(name="ecore_ENamedElement")
...
domain_model = DomainModel(
    name="ecore",
    types={ecore_FSM, ecore_State, EClass, ecore_Transition, FSM, ecore_ENamedElement, ecore_EClass},
    associations={ownedState0, initialState1, finalState2, owningFSM5, source11, target13, myFSMs15, outgoingTransition6, incomingTransition7, myClasses9},
