...
class base_ModelElementTrace(IdElement):
    ...
    def __init__(self, uri: str, base_ModelElementTrace: "base_ElementAccess" = None, base_ModelElementTrace7: "base_ModelTrace" = None, base_ModelElementTrace11: "base_PropertyTrace" = None):
        self.uri = uri
