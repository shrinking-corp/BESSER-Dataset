...
# Classes
base_ElementAccess = Class(name="base_ElementAccess")
Access = Class(name="Access")
base_ModelElementTrace = Class(name="base_ModelElementTrace")
base_AllInstancesAccess = Class(name="base_AllInstancesAccess")
base_ModelTypeTrace = Class(name="base_ModelTypeTrace")
base_PropertyAccess = Class(name="base_PropertyAccess")
base_IdElement = Class(name="base_IdElement", is_abstract=True)
base_ModuleTrace = Class(name="base_ModuleTrace", is_abstract=True)
IdElement = Class(name="IdElement")
base_ExecutionTrace = Class(name="base_ExecutionTrace", is_abstract=True)
base_Access = Class(name="base_Access", is_abstract=True)
base_PropertyTrace = Class(name="base_PropertyTrace")
base_ModelTrace = Class(name="base_ModelTrace")
...
domain_model = DomainModel(
    name="base",
    types={base_ElementAccess, Access, base_ModelElementTrace, base_AllInstancesAccess, base_ModelTypeTrace, base_PropertyAccess, base_IdElement, base_ModuleTrace, IdElement, base_ExecutionTrace, base_Access, base_PropertyTrace, base_ModelTrace},
    associations={element1, type2, accesses0, property3, model4, model6, element9},
    generalizations={gen_base_ElementAccess_Access, gen_base_AllInstancesAccess_Access, gen_base_PropertyAccess_Access, gen_base_ModuleTrace_IdElement, gen_base_ExecutionTrace_IdElement, gen_base_Access_IdElement, gen_base_ModelTrace_IdElement, gen_base_ModelTypeTrace_IdElement, gen_base_ModelElementTrace_IdElement, gen_base_PropertyTrace_IdElement},
    metadata=None
)
