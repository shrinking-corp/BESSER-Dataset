...
root_sub2_E_strategy = st.builds(root_sub2_E)
...
root_sub_C_strategy = st.builds(root_sub_C)
...
root_sub_D_strategy = st.builds(root_sub_D)
...
root_subsub_E_strategy = st.builds(root_subsub_E)
...
root_subsub_F_strategy = st.builds(root_subsub_F)
