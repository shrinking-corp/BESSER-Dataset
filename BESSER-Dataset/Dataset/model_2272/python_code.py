...
class Univerity_Person:
    ...
    def __init__(self, Name: str, Email: str, Univerity_Person: "Univerity_Courses" = None, Univerity_Person6: "Univerity_Courses" = None, Univerity_Person9: "Univerity_Person" = None, Univerity_Person7: "Univerity_Person" = None):
        self.Name = Name
        self.Email = Email
...
class Univerity_Courses:
    ...
    def __init__(self, Name: str, CFU: int, Semester: str, Univerity_Courses: "Univerity_Courses" = None, Univerity_Courses0: set["Univerity_Courses"] = None, Univerity_Courses3: "Univerity_Person" = None, Univerity_Courses5: set["Univerity_Person"] = None, Univerity_Courses11: "Univerity_University" = None):
        self.Name = Name
        self.CFU = CFU
