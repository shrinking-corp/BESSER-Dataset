...
# Classes
cstat1_SubState1 = Class(name="cstat1_SubState1")
AbstractState = Class(name="AbstractState")
cstat1_SubState2 = Class(name="cstat1_SubState2")
cstat1_Transition = Class(name="cstat1_Transition")
cstat1_AbstractState = Class(name="cstat1_AbstractState", is_abstract=True)
cstat1_Action = Class(name="cstat1_Action")
cstat1_EClass0 = Class(name="cstat1_EClass0")
cstat1_StateChart = Class(name="cstat1_StateChart")
cstat1_State = Class(name="cstat1_State")
...
cstat1_AbstractState.attributes={cstat1_AbstractState_type, cstat1_AbstractState_id}
...
cstat1_Action.attributes={cstat1_Action_expression, cstat1_Action_mode}
...
domain_model = DomainModel(
    name="cstat1",
    types={cstat1_SubState1, AbstractState, cstat1_SubState2, cstat1_Transition, cstat1_AbstractState, cstat1_Action, cstat1_EClass0, cstat1_StateChart, cstat1_State, StateType, ActionMode},
    associations={sub2s0, sub1s2, fromState5, toState6, transitions9, actions12, states1},
    generalizations={gen_cstat1_SubState1_AbstractState, gen_cstat1_SubState2_AbstractState, gen_cstat1_State_AbstractState},
    metadata=None
)
