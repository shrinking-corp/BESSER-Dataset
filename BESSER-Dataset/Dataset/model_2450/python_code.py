...
class cstat1_AbstractState(ABC):
    ...
    def __init__(self, id: str, type: str, cstat1_AbstractState: "cstat1_Transition" = None, cstat1_AbstractState8: "cstat1_Transition" = None, cstat1_AbstractState10: set["cstat1_Transition"] = None, cstat1_AbstractState13: set["cstat1_Action"] = None):
        self.id = id
        self.type = type
