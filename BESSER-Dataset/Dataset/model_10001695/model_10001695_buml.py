...
candyCrushPackage_Game.attributes={candyCrushPackage_Game_score, candyCrushPackage_Game_SOUNDS_PATH, candyCrushPackage_Game_SEP, candyCrushPackage_Game_WINDOW_HEIGHT, candyCrushPackage_Game_playerName, candyCrushPackage_Game_WINDOW_WIDTH, candyCrushPackage_Game_IMAGES_PATH}
...
candyCrushPackage_Menu.attributes={candyCrushPackage_Menu_buttonBGColor, candyCrushPackage_Menu_movesLabel, candyCrushPackage_Menu_menuBGColor, candyCrushPackage_Menu_highScoreLabel}
...
candyCrushPackage_Board.attributes={candyCrushPackage_Board_secondPressedCandy, candyCrushPackage_Board_swapTimerCount, candyCrushPackage_Board_swapDirection, candyCrushPackage_Board_HORIZONTAL_GAP, candyCrushPackage_Board_isSwapBack, candyCrushPackage_Board_dropTimer, candyCrushPackage_Board_isFirstPressed, candyCrushPackage_Board_selfCrushCandy, candyCrushPackage_Board_movesPerGame, candyCrushPackage_Board_moveDistance, candyCrushPackage_Board_candyWidth, candyCrushPackage_Board_VERTICAL_GAP, candyCrushPackage_Board_baseScorePerCandy, candyCrushPackage_Board_selfCrushTimer, candyCrushPackage_Board_SIZE, candyCrushPackage_Board_delay, candyCrushPackage_Board_cascadeTimer, candyCrushPackage_Board_candyHeight, candyCrushPackage_Board_gameScore, candyCrushPackage_Board_dropTimerCount, candyCrushPackage_Board_crushTimerCount, candyCrushPackage_Board_swapTimer, candyCrushPackage_Board_crushTimer, candyCrushPackage_Board_selfCrushTimerCount, candyCrushPackage_Board_movesLeft, candyCrushPackage_Board_BOARD_HEIGHT, candyCrushPackage_Board_scorePerCandy, candyCrushPackage_Board_BOARD_WIDTH, candyCrushPackage_Board_firstPressedCandy}
...
candyCrushPackage_CandyButton.attributes={candyCrushPackage_CandyButton_y, candyCrushPackage_CandyButton_image, candyCrushPackage_CandyButton_x, candyCrushPackage_CandyButton_button}
...
domain_model = DomainModel(
    name="_PFYoEI49Eeqwvcm2LAkYWA",
    types={JButton_external, candyCrushPackage_Candy, candyCrushPackage_Visitor_Interface, candyCrushPackage_Visited_Interface, candyCrushPackage_RegularCandy, candyCrushPackage_Game, candyCrushPackage_Menu, candyCrushPackage_Board, candyCrushPackage_StrippedCandy, candyCrushPackage_WrappedCandy, candyCrushPackage_ColorBombCandy, candyCrushPackage_CandyButton, candyCrushPackage_JFrame, candyCrushPackage_JPanel, candyCrushPackage_ActionListener_Interface, ImageIcon_external, Color_external, candyCrushPackage_SwapDirection},
    associations={CandyButton_ImageIcon, CandyButton_JButton, Game_Menu, Game_Board, Candy_Candy, Board_Candy, Board_CandyButton, Menu_Color},
    generalizations={},
    metadata=None
)
