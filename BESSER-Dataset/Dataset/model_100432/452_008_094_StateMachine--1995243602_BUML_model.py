...
domain_model = DomainModel(
    name="StateMachine",
    types={StateMachine_StateMachine, NamedElement, StateMachine_State, StateMachine_Transition, StateMachine_Trigger, StateMachine_StateMachineBehavioralModel, StateMachine_Guard, StateMachine_Action, StateMachine_RDMElement, StateMachine_CompositeState, State, StateMachine_NamedElement, StateMachine_ChangeTrainHeadingSpeed, ActionExpression, StateMachine_Train, StateMachine_ChangeSignalAllowedSpeed, StateMachine_Signal, StateMachine_ChangeTurnoutDirection, StateMachine_Turnout, StateMachine_ChangeTrainCurrentTrackElement, StateMachine_TrackElement, StateMachine_TrainCurrentHeadingSpeed, GuardExpression, StateMachine_TrainCurrentlyStandsOn, StateMachine_TurnoutCurrentDirection, StateMachine_SignalCurrentAllowedSpeed, StateMachine_TrainHeadingSpeedChanged, TriggerExpression, StateMachine_TrainTrackElementChanged, StateMachine_SignalAllowedSpeedChanged, StateMachine_TurnoutDirectionChanged, StateMachine_NextTrackElementIs, StateMachine_RouteElement, StateMachine_TurnoutHasDesiredDirection, StateMachine_TurnoutDesiredDirection, StateMachine_ActionExpression, Action, StateMachine_GuardExpression, Guard, StateMachine_TriggerExpression, Trigger},
    associations={statemachines0, states1, transitions3, triggers5, guards7, actions9, referredObject14, outgoingTransitions16, incomingTransitions17, sourceState19, activeState11, trigger22, guard25, action28, statemachine31, targetState20, train33, turnout35, train36, newTrackElements38, train40, signal34, train42, trackElements44, turnout47, signal49, train51, trackElement63, train53, trackElements55, signal58, turnout60, routeElement62, turnout66, desiredDirection68},
    generalizations={gen_StateMachine_StateMachine_NamedElement, gen_StateMachine_State_NamedElement, gen_StateMachine_Transition_NamedElement, gen_StateMachine_CompositeState_State, gen_StateMachine_Action_NamedElement, gen_StateMachine_ChangeTrainHeadingSpeed_ActionExpression, gen_StateMachine_ChangeSignalAllowedSpeed_ActionExpression, gen_StateMachine_Trigger_NamedElement, gen_StateMachine_Guard_NamedElement, gen_StateMachine_ChangeTurnoutDirection_ActionExpression, gen_StateMachine_ChangeTrainCurrentTrackElement_ActionExpression, gen_StateMachine_TrainCurrentHeadingSpeed_GuardExpression, gen_StateMachine_TrainCurrentlyStandsOn_GuardExpression, gen_StateMachine_TurnoutCurrentDirection_GuardExpression, gen_StateMachine_SignalCurrentAllowedSpeed_GuardExpression, gen_StateMachine_TrainHeadingSpeedChanged_TriggerExpression, gen_StateMachine_TrainTrackElementChanged_TriggerExpression, gen_StateMachine_SignalAllowedSpeedChanged_TriggerExpression, gen_StateMachine_TurnoutDirectionChanged_TriggerExpression, gen_StateMachine_NextTrackElementIs_GuardExpression, gen_StateMachine_TurnoutHasDesiredDirection_GuardExpression, gen_StateMachine_ActionExpression_Action, gen_StateMachine_GuardExpression_Guard, gen_StateMachine_TriggerExpression_Trigger},
    metadata=None
)
