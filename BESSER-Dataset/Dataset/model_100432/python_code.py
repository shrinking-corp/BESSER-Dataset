...
class StateMachine_TurnoutCurrentDirection(GuardExpression):
    ...
    def __init__(self, currentTurnoutDirection: str, StateMachine_TurnoutCurrentDirection: "StateMachine_Turnout" = None):
        ...
        pass
    @property
    def currentTurnoutDirection(self):
...
class StateMachine_Transition(NamedElement):
    ...
    def __init__(self, isEnabled: bool, isFireable: bool, Transition: "StateMachine_State" = None, Transition18: "StateMachine_State" = None, outgoingTransitions: "StateMachine_State" = None, StateMachine_Transition: "StateMachine_StateMachine" = None, StateMachine_Transition23: "StateMachine_Trigger" = None, StateMachine_Transition26: set["StateMachine_Guard"] = None, StateMachine_Transition29: set["StateMachine_Action"] = None, incomingTransitions: "StateMachine_State" = None):
...
class StateMachine_State(NamedElement):
    ...
    def __init__(self, isInitial: bool, isActive: bool, sourceState: set["StateMachine_Transition"] = None, targetState: set["StateMachine_Transition"] = None, State: "StateMachine_Transition" = None, StateMachine_State13: "StateMachine_StateMachine" = None, StateMachine_State: "StateMachine_StateMachine" = None, State21: "StateMachine_Transition" = None):
