...
# Classes
research16_Phase = Class(name="research16_Phase")
research16_Researcher = Class(name="research16_Researcher")
research16_Write = Class(name="research16_Write")
research16_Review = Class(name="research16_Review")
research16_Paper = Class(name="research16_Paper")
research16_Skill = Class(name="research16_Skill")
research16_Position = Class(name="research16_Position")
research16_Collaboration = Class(name="research16_Collaboration")
research16_PublicationProcess = Class(name="research16_PublicationProcess")
Named = Class(name="Named")
research16_State = Class(name="research16_State")
Counted = Class(name="Counted")
research16_ReviewNote = Class(name="research16_ReviewNote")
Labelled = Class(name="Labelled")
research16_Paragraph = Class(name="research16_Paragraph")
research16_Progress = Class(name="research16_Progress")
research16_PaperKeyword = Class(name="research16_PaperKeyword")
research16_KnowledgeManager = Class(name="research16_KnowledgeManager")
research16_PublicationSystem = Class(name="research16_PublicationSystem")
research16_PublicationStatus = Class(name="research16_PublicationStatus")
research16_Named = Class(name="research16_Named", is_abstract=True)
research16_Counted = Class(name="research16_Counted", is_abstract=True)
research16_Labelled = Class(name="research16_Labelled", is_abstract=True)
research16_PublicationStructure = Class(name="research16_PublicationStructure")
research16_StateMachineVariable = Class(name="research16_StateMachineVariable")
research16_StateMachineObject = Class(name="research16_StateMachineObject", is_abstract=True)
research16_Transition = Class(name="research16_Transition")
StateMachineObject = Class(name="StateMachineObject")
research16_Keyword = Class(name="research16_Keyword")
research16_Action = Class(name="research16_Action")
...
research16_Researcher.attributes={research16_Researcher_forName, research16_Researcher_name}
...
research16_Action.attributes={research16_Action_actionStatement, research16_Action_actionLabel}
...
domain_model = DomainModel(
    name="research16",
    types={research16_Phase, research16_Researcher, research16_Write, research16_Review, research16_Paper, research16_Skill, research16_Position, research16_Collaboration, research16_PublicationProcess, Named, research16_State, Counted, research16_ReviewNote, Labelled, research16_Paragraph, research16_Progress, research16_PaperKeyword, research16_KnowledgeManager, research16_PublicationSystem, research16_PublicationStatus, research16_Named, research16_Counted, research16_Labelled, research16_PublicationStructure, research16_StateMachineVariable, research16_StateMachineObject, research16_Transition, StateMachineObject, research16_Keyword, research16_Action, StateType},
    associations={phases0, writes1, reviews2, res_papers4, skills5, res_position7, collaborations9, keywords14, citedBy17, state19, reviews21, process23, paper25, paragraph27, paragraphs11, progress12, authors13, researchers33, papers35, knowledgeMan38, processView40, structuralView42, positions45, behaviorView48, reviewNote30, kpapers53, allkeywords55, keyword58, col_paper61, machineVariables64, pubStates66, parent51, target73, transitions76, s_actions79, next83, t_actions69, source70},
    generalizations={gen_research16_Paper_Named, gen_research16_PublicationProcess_Named, gen_research16_Paragraph_Counted, gen_research16_Paragraph_Named, gen_research16_ReviewNote_Named, gen_research16_Progress_Labelled, gen_research16_Write_Labelled, gen_research16_PublicationSystem_Named, gen_research16_Review_Labelled, gen_research16_PublicationStructure_Named, gen_research16_KnowledgeManager_Named, gen_research16_Transition_StateMachineObject, gen_research16_Position_Named, gen_research16_Keyword_Named, gen_research16_State_StateMachineObject},
    metadata=None
)
