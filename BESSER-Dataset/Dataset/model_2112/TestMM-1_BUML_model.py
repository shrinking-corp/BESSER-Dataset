...
# Classes
TestMM1_Test = Class(name="TestMM1_Test")
TestMM1_Action = Class(name="TestMM1_Action")
...
TestMM1_Action.attributes={TestMM1_Action_xpath, TestMM1_Action_type, TestMM1_Action_description, TestMM1_Action_id, TestMM1_Action_value}
...
domain_model = DomainModel(
    name="TestMM1",
    types={TestMM1_Test, TestMM1_Action, ActionType},
