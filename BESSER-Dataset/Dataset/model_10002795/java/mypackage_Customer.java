...
public class mypackage_Customer  {
    ...
    public mypackage_Customer(
        String phoneNumber,        LocalDate dateOfBirth,        String emailAddress,        String name,        String address    ) {
    ...
    public mypackage_Customer(
        String phoneNumber,        LocalDate dateOfBirth,        String emailAddress,        String name,        String address        ArrayList<account_Account> account_accounts    ) {
        this.phoneNumber = phoneNumber;
        this.dateOfBirth = dateOfBirth;
        this.emailAddress = emailAddress;
        this.name = name;
