...
class account_Account:
    ...
    def __init__(self, balance: float, accountNo: str, type: account_AccountType, customer0: "mypackage_Customer" = None, transactions2: set["transaction_Transaction"] = None):
...
class transaction_Transaction:
    ...
    def __init__(self, transactionTime: date, amount: float, id: int, type: transaction_TransactionType, account3: "account_Account" = None):
