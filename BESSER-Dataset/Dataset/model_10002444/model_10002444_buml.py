...
Drinks.attributes={Drinks_cocktail, Drinks_wine, Drinks_softDrink, Drinks_spirits, Drinks_beer}
...
domain_model = DomainModel(
    name="b40523ff_0062_455c_9ebe_e7d6b8ea5221",
    ...
    associations={Waiter_Input_Order2, Bill_Payment, Bill_Table, Bill_Order, Order_Menu, Order_Drinks, Bill_Discount, Diner_Order_food, Diner_Pay_for_food, Waiter_Input_Order, Waiter_Alerted_to_Serve_drinks, Waiter_Alerted_to_Serve_Food, Waiter_Print_bill, Waiter_Input_payment_details, Kitchen_Staff_Alerted_to_Prepare_food, Bar_Staff_Alerted_to_Prepare_drinks, Management_Grant_discount, Management_View_statistics},
    generalizations={},
    metadata=None
)
