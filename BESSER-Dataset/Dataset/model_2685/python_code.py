...
class simplecont_C:
    ...
    def __init__(self, id: str, simplecont_C: "simplecont_A" = None, simplecont_C4: "simplecont_B" = None):
        self.id = id
...
class simplecont_B:
    ...
    def __init__(self, name: str, simplecont_B: "simplecont_A" = None, simplecont_B5: "simplecont_C" = None):
        self.name = name
...
class simplecont_A:
    ...
    def __init__(self, name: str, simplecont_A: set["simplecont_B"] = None, simplecont_A2: set["simplecont_C"] = None, simplecont_A7: "simplecont_X" = None):
        self.name = name
