...
# Classes
arduino_AbstractDevice = Class(name="arduino_AbstractDevice")
arduino_Handler = Class(name="arduino_Handler")
arduino_Interrupt = Class(name="arduino_Interrupt")
arduino_Poll = Class(name="arduino_Poll")
arduino_Task = Class(name="arduino_Task")
arduino_LoopItem = Class(name="arduino_LoopItem")
arduino_SystemDefinition = Class(name="arduino_SystemDefinition")
arduino_CommunicationParams = Class(name="arduino_CommunicationParams")
arduino_Message = Class(name="arduino_Message")
arduino_Sketch = Class(name="arduino_Sketch")
arduino_PortProtocol = Class(name="arduino_PortProtocol")
arduino_PortTCP = Class(name="arduino_PortTCP")
PortProtocol = Class(name="PortProtocol")
arduino_PortConnectionData = Class(name="arduino_PortConnectionData")
arduino_HighLevelOperation = Class(name="arduino_HighLevelOperation")
arduino_Precondition = Class(name="arduino_Precondition")
arduino_Sensor = Class(name="arduino_Sensor")
arduino_Actuator = Class(name="arduino_Actuator")
AbstractDevice = Class(name="AbstractDevice")
arduino_IODevice = Class(name="arduino_IODevice")
arduino_OutOnlyMessage = Class(name="arduino_OutOnlyMessage")
Message = Class(name="Message")
arduino_OutInMessage = Class(name="arduino_OutInMessage")
arduino_Dispatch = Class(name="arduino_Dispatch")
OutOnlyMessage = Class(name="OutOnlyMessage")
arduino_Request = Class(name="arduino_Request")
OutInMessage = Class(name="OutInMessage")
arduino_Invitation = Class(name="arduino_Invitation")
arduino_OutOperation = Class(name="arduino_OutOperation")
HighLevelOperation = Class(name="HighLevelOperation")
arduino_Precondition1 = Class(name="arduino_Precondition1")
arduino_EObject = Class(name="arduino_EObject")
arduino_EmptyPrecondition = Class(name="arduino_EmptyPrecondition")
arduino_SensorValuePrecondition = Class(name="arduino_SensorValuePrecondition")
arduino_AskInvitation = Class(name="arduino_AskInvitation")
arduino_GrantRequest = Class(name="arduino_GrantRequest")
InAcquireOperation = Class(name="InAcquireOperation")
arduino_ServeDispatch = Class(name="arduino_ServeDispatch")
arduino_AcceptInvitation = Class(name="arduino_AcceptInvitation")
arduino_Serial = Class(name="arduino_Serial")
SupportSpecification = Class(name="SupportSpecification")
arduino_TCP = Class(name="arduino_TCP")
arduino_InOperation = Class(name="arduino_InOperation")
arduino_InAcquireOperation = Class(name="arduino_InAcquireOperation")
InOperation = Class(name="InOperation")
arduino_SupportSpecification = Class(name="arduino_SupportSpecification")
arduino_DemandRequest = Class(name="arduino_DemandRequest")
OutOperation = Class(name="OutOperation")
arduino_ForwardDispatch = Class(name="arduino_ForwardDispatch")
arduino_SupportData = Class(name="arduino_SupportData")
arduino_ExplicitSupportData = Class(name="arduino_ExplicitSupportData")
SupportData = Class(name="SupportData")
arduino_IP = Class(name="arduino_IP")
...
arduino_Interrupt.attributes={arduino_Interrupt_name, arduino_Interrupt_eventKind, arduino_Interrupt_interruptKind}
...
arduino_Poll.attributes={arduino_Poll_l, arduino_Poll_h, arduino_Poll_type}
...
arduino_CommunicationParams.attributes={arduino_CommunicationParams_ip, arduino_CommunicationParams_type, arduino_CommunicationParams_dns, arduino_CommunicationParams_mac, arduino_CommunicationParams_subnet, arduino_CommunicationParams_baudrate, arduino_CommunicationParams_gateway}
...
arduino_Sketch.attributes={arduino_Sketch_hardware, arduino_Sketch_defineSystem, arduino_Sketch_name}
...
domain_model = DomainModel(
    name="arduino",
    types={arduino_AbstractDevice, arduino_Handler, arduino_Interrupt, arduino_Poll, arduino_Task, arduino_LoopItem, arduino_SystemDefinition, arduino_CommunicationParams, arduino_Message, arduino_Sketch, arduino_PortProtocol, arduino_PortTCP, PortProtocol, arduino_PortConnectionData, arduino_HighLevelOperation, arduino_Precondition, arduino_Sensor, arduino_Actuator, AbstractDevice, arduino_IODevice, arduino_OutOnlyMessage, Message, arduino_OutInMessage, arduino_Dispatch, OutOnlyMessage, arduino_Request, OutInMessage, arduino_Invitation, arduino_OutOperation, HighLevelOperation, arduino_Precondition1, arduino_EObject, arduino_EmptyPrecondition, arduino_SensorValuePrecondition, arduino_AskInvitation, arduino_GrantRequest, InAcquireOperation, arduino_ServeDispatch, arduino_AcceptInvitation, arduino_Serial, SupportSpecification, arduino_TCP, arduino_InOperation, arduino_InAcquireOperation, InOperation, arduino_SupportSpecification, arduino_DemandRequest, OutOperation, arduino_ForwardDispatch, arduino_SupportData, arduino_ExplicitSupportData, SupportData, arduino_IP},
    associations={devices0, handlers1, interrupts3, pollings5, tasks7, loop9, systemDefinition11, mydata13, handler26, sensor29, handler32, info35, messages15, operation17, task19, precondition22, sensor24, pre136, pre39, pre41, sensor43, forward55, receiver56, ask59, receiver60, grant63, serve65, accept67, sender45, receiver47, support49, demand51, receiver52, info69},
    generalizations={gen_arduino_PortTCP_PortProtocol, gen_arduino_Actuator_AbstractDevice, gen_arduino_Sensor_AbstractDevice, gen_arduino_IODevice_AbstractDevice, gen_arduino_OutOnlyMessage_Message, gen_arduino_OutInMessage_Message, gen_arduino_Dispatch_OutOnlyMessage, gen_arduino_Request_OutInMessage, gen_arduino_Invitation_OutInMessage, gen_arduino_OutOperation_HighLevelOperation, gen_arduino_AskInvitation_OutOperation, gen_arduino_GrantRequest_InAcquireOperation, gen_arduino_ServeDispatch_InAcquireOperation, gen_arduino_AcceptInvitation_InAcquireOperation, gen_arduino_Serial_SupportSpecification, gen_arduino_TCP_SupportSpecification, gen_arduino_InOperation_HighLevelOperation, gen_arduino_InAcquireOperation_InOperation, gen_arduino_DemandRequest_OutOperation, gen_arduino_ForwardDispatch_OutOperation, gen_arduino_ExplicitSupportData_SupportData},
    metadata=None
)
