...
public class Requirement  {
    ...
    public Requirement(
        String req_description,        String requirement_type,        String user_id,        String requirement_location    ) {
    ...
    public Requirement(
        String req_description,        String requirement_type,        String user_id,        String requirement_location        ArrayList<Reg_User> reg_users    ) {
        this.req_description = req_description;
        this.requirement_type = requirement_type;
        this.user_id = user_id;
        this.requirement_location = requirement_location;
