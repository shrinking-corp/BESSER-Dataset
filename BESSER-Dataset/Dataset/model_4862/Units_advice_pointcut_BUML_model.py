...
# Classes
units_av_pc_UnitCarryingElement = Class(name="units_av_pc_UnitCarryingElement")
units_av_pc_Unit = Class(name="units_av_pc_Unit")
units_av_pc_Pointcut = Class(name="units_av_pc_Pointcut")
units_av_pc_BaseUnit = Class(name="units_av_pc_BaseUnit")
units_av_pc_UnitRepository = Class(name="units_av_pc_UnitRepository")
units_av_pc_UnitMultiplication = Class(name="units_av_pc_UnitMultiplication")
Unit = Class(name="Unit")
units_av_pc_UnitPower = Class(name="units_av_pc_UnitPower")
units_av_pc_UnitLiteral = Class(name="units_av_pc_UnitLiteral")
units_av_pc_Advice = Class(name="units_av_pc_Advice")
units_av_pc_EObject = Class(name="units_av_pc_EObject")
units_av_pc_GlobalScope = Class(name="units_av_pc_GlobalScope")
units_av_pc_PerJoinPointScope = Class(name="units_av_pc_PerJoinPointScope")
...
domain_model = DomainModel(
    name="units_av_pc",
    types={units_av_pc_UnitCarryingElement, units_av_pc_Unit, units_av_pc_Pointcut, units_av_pc_BaseUnit, units_av_pc_UnitRepository, units_av_pc_UnitMultiplication, Unit, units_av_pc_UnitPower, units_av_pc_UnitLiteral, units_av_pc_Advice, units_av_pc_EObject, units_av_pc_GlobalScope, units_av_pc_PerJoinPointScope},
    associations={unit0, scopedObject11, children13, units1, units2, unit4, baseUnit6, children8, scopedObject9},
