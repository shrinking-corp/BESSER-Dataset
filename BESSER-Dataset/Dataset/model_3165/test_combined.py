...
def test_hyp_mynode_is_not_abstract():
    assert not inspect.isabstract(MyNode)


def test_hyp_mynode_constructor_exists():
    assert callable(MyNode.__init__)


def test_hyp_mynode_constructor_args():
    sig = inspect.signature(MyNode.__init__)
    params = list(sig.parameters.keys())



def test_hyp_softwaretraces_trace_is_not_abstract():
    assert not inspect.isabstract(softwaretraces_Trace)


def test_hyp_softwaretraces_trace_constructor_exists():
    assert callable(softwaretraces_Trace.__init__)


def test_hyp_softwaretraces_trace_constructor_args():
...
def test_hyp_softwaretraces_feature_is_not_abstract():
    assert not inspect.isabstract(softwaretraces_Feature)


def test_hyp_softwaretraces_feature_constructor_exists():
    assert callable(softwaretraces_Feature.__init__)


def test_hyp_softwaretraces_feature_constructor_args():
...
def test_hyp_softwaretraces_model_is_not_abstract():
    assert not inspect.isabstract(softwaretraces_Model)


def test_hyp_softwaretraces_model_constructor_exists():
    assert callable(softwaretraces_Model.__init__)


def test_hyp_softwaretraces_model_constructor_args():
...
def test_hyp_softwaretraces_mynode_is_not_abstract():
    assert not inspect.isabstract(softwaretraces_MyNode)


def test_hyp_softwaretraces_mynode_constructor_exists():
    assert callable(softwaretraces_MyNode.__init__)


def test_hyp_softwaretraces_mynode_constructor_args():
...
def test_hyp_softwaretraces_trace_projectName_setter(instance):
...
@given(instance=softwaretraces_Trace_strategy)
def test_hyp_softwaretraces_trace_fileName_setter(instance):
...
@given(instance=softwaretraces_Trace_strategy)
def test_hyp_softwaretraces_trace_lineNumber_setter(instance):
...
def test_hyp_softwaretraces_feature_name_setter(instance):
...
def test_hyp_softwaretraces_model_resourceFileName_setter(instance):
