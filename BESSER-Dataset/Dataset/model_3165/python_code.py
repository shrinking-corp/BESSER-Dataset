...
class softwaretraces_Trace(MyNode):
    ...
    def __init__(self, fileName: str, lineNumber: int, projectName: str, softwaretraces_Trace11: "softwaretraces_Trace" = None, softwaretraces_Trace9: set["softwaretraces_Trace"] = None, softwaretraces_Trace: "softwaretraces_Model" = None, softwaretraces_Trace8: "softwaretraces_Feature" = None):
