...
featureDiagram_Model = Class(name="featureDiagram_Model")
...
featureDiagram_And = Class(name="featureDiagram_And")
featureDiagram_Or = Class(name="featureDiagram_Or")
featureDiagram_Xor = Class(name="featureDiagram_Xor")
featureDiagram_Card = Class(name="featureDiagram_Card")
featureDiagram_ConstraintEdge = Class(name="featureDiagram_ConstraintEdge")
featureDiagram_Operator = Class(name="featureDiagram_Operator", is_abstract=True)
...
domain_model = DomainModel(
    name="featureDiagram",
    types={featureDiagram_FeatureDiagram, featureDiagram_Feature, featureDiagram_Model, featureDiagram_PrimitiveFeature, Feature, featureDiagram_Constraint, featureDiagram_Opt, Operator, featureDiagram_And, featureDiagram_Or, featureDiagram_Xor, featureDiagram_Card, featureDiagram_ConstraintEdge, featureDiagram_Operator, featureDiagram_Require, Constraint, featureDiagram_Mutex},
    associations={features0, models6, children9, parents12, target14, constraint17, source18, owningFeature21, owningCE23, root1, constraintEdges2, owningFeatureDiagram4, operator5},
