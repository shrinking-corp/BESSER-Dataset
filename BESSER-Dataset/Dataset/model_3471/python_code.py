...
class featureDiagram_Feature:
    ...
    def __init__(self, selected: str, optional: str, name: str, owningFeature: "featureDiagram_Operator" = None, Feature: "featureDiagram_FeatureDiagram" = None, featureDiagram_Feature7: set["featureDiagram_Model"] = None, Feature10: "featureDiagram_Feature" = None, parents: set["featureDiagram_Feature"] = None, Feature13: "featureDiagram_Feature" = None, children: set["featureDiagram_Feature"] = None, featureDiagram_Feature16: "featureDiagram_ConstraintEdge" = None, featureDiagram_Feature20: "featureDiagram_ConstraintEdge" = None, Feature22: "featureDiagram_Operator" = None, featureDiagram_Feature: "featureDiagram_FeatureDiagram" = None, features: "featureDiagram_FeatureDiagram" = None):
...
class featureDiagram_FeatureDiagram:
    ...
    def __init__(self, graphTypeTree: str, owningFeatureDiagram: set["featureDiagram_Feature"] = None, featureDiagram_FeatureDiagram: "featureDiagram_Feature" = None, featureDiagram_FeatureDiagram3: set["featureDiagram_ConstraintEdge"] = None, FeatureDiagram: "featureDiagram_Feature" = None):
