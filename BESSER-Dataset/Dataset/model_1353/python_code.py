...
class statemachine_Transition(ObeoDSMObject):
    ...
    def __init__(self, guard: str, outcomingTransitions: "statemachine_AbstractState" = None, incomingTransitions: "statemachine_AbstractState" = None, statemachine_Transition: "statemachine_StateMachineDescription" = None, Transition: "statemachine_AbstractState" = None, Transition6: "statemachine_AbstractState" = None):
        self.guard = guard
