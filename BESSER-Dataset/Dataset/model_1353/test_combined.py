...
def test_hyp_statemachine_statemachinedescription_is_not_abstract():
    assert not inspect.isabstract(statemachine_StateMachineDescription)


def test_hyp_statemachine_statemachinedescription_constructor_exists():
    assert callable(statemachine_StateMachineDescription.__init__)


def test_hyp_statemachine_statemachinedescription_constructor_args():
...
def test_hyp_statemachinedescription_is_not_abstract():
    assert not inspect.isabstract(StateMachineDescription)


def test_hyp_statemachinedescription_constructor_exists():
    assert callable(StateMachineDescription.__init__)


def test_hyp_statemachinedescription_constructor_args():
...
def test_hyp_obeodsmobject_is_not_abstract():
    assert not inspect.isabstract(ObeoDSMObject)


def test_hyp_obeodsmobject_constructor_exists():
    assert callable(ObeoDSMObject.__init__)


def test_hyp_obeodsmobject_constructor_args():
...
def test_hyp_statemachine_transition_guard_setter(instance):
