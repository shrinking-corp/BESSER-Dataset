...
statemachine_StateMachineDescription = Class(name="statemachine_StateMachineDescription", is_abstract=True)
...
outcomingTransitions5: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_", type=statemachine_Transition, multiplicity=Multiplicity(0, 9999))
    }
)
...
domain_model = DomainModel(
    name="statemachine",
    types={statemachine_NamedElement, ObeoDSMObject, statemachine_StateMachine, StateMachineDescription, Behaviour, statemachine_Region, statemachine_State, AbstractState, NamedElement, statemachine_StateMachineDescription, statemachine_AbstractState, statemachine_Transition, statemachine_InitialState, statemachine_FinalState},
    associations={regions0, states1, from_7, to8, transitions2, incomingTransitions4, outcomingTransitions5},
    generalizations={gen_statemachine_NamedElement_ObeoDSMObject, gen_statemachine_StateMachine_StateMachineDescription, gen_statemachine_StateMachine_Behaviour, gen_statemachine_State_AbstractState, gen_statemachine_State_NamedElement, gen_statemachine_StateMachineDescription_NamedElement, gen_statemachine_InitialState_AbstractState, gen_statemachine_FinalState_AbstractState, gen_statemachine_Region_StateMachineDescription, gen_statemachine_AbstractState_ObeoDSMObject, gen_statemachine_Transition_ObeoDSMObject},
    metadata=None
)
