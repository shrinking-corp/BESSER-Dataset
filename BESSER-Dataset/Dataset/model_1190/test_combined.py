...
def test_hyp_essentialocl_typetype_is_not_abstract():
    assert not inspect.isabstract(EssentialOCL_TypeType)


def test_hyp_essentialocl_typetype_constructor_exists():
    assert callable(EssentialOCL_TypeType.__init__)


def test_hyp_essentialocl_typetype_constructor_args():
