...
class statemachine_Command(NamedElement):
    ...
    def __init__(self, code: str, statemachine_Command10: "statemachine_State" = None, statemachine_Command: "statemachine_Statemachine" = None):
        self.code = code
...
class statemachine_Event(NamedElement):
    ...
    def __init__(self, code: str, statemachine_Event15: "statemachine_Transition" = None, statemachine_Event: "statemachine_Statemachine" = None, statemachine_Event3: "statemachine_Statemachine" = None):
        self.code = code
