...
statemachine_NamedElement.attributes={statemachine_NamedElement_displayname, statemachine_NamedElement_name}
...
domain_model = DomainModel(
    name="statemachine",
    types={statemachine_Statemachine, statemachine_Event, statemachine_Command, statemachine_State, statemachine_NamedElement, NamedElement, statemachine_Transition},
    associations={events0, resetEvents1, commands4, states6, state16, actions8, transitions11, event13},
