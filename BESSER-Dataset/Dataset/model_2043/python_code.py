...
class Behaviour_Server(Place):
    ...
    def __init__(self, capacity: int, server: "Behaviour_WaitingLine" = None, Behaviour_Server24: "Behaviour_PreTransitionConnection" = None, Behaviour_Server: "Behaviour_QueuePlace" = None, Server: "Behaviour_WaitingLine" = None):
...
class Behaviour_WaitingLine(Place):
    ...
    def __init__(self, schedulingPolicy: str, WaitingLine: "Behaviour_Server" = None, Behaviour_WaitingLine: "Behaviour_QueuePlace" = None, waitingLine: "Behaviour_Server" = None, Behaviour_WaitingLine28: set["Behaviour_PostTransitionConnection"] = None):
...
class Behaviour_PreTransitionConnection(Connection):
    ...
    def __init__(self, requiredTokenAmount: int, Behaviour_PreTransitionConnection25: "Behaviour_Server" = None, Behaviour_PreTransitionConnection: "Behaviour_Transition" = None, Behaviour_PreTransitionConnection10: "Behaviour_DefaultPlace" = None, Behaviour_PreTransitionConnection18: "Behaviour_StartPlace" = None):
