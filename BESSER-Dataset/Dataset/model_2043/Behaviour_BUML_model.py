...
# Classes
Behaviour_Place = Class(name="Behaviour_Place", is_abstract=True)
Identifier = Class(name="Identifier")
Behaviour_Token = Class(name="Behaviour_Token")
Behaviour_Transition = Class(name="Behaviour_Transition", is_abstract=True)
Behaviour_PostTransitionConnection = Class(name="Behaviour_PostTransitionConnection")
Behaviour_PreTransitionConnection = Class(name="Behaviour_PreTransitionConnection")
Behaviour_Connection = Class(name="Behaviour_Connection", is_abstract=True)
Connection = Class(name="Connection")
Behaviour_DefaultPlace = Class(name="Behaviour_DefaultPlace")
Place = Class(name="Place")
Behaviour_QueuePlace = Class(name="Behaviour_QueuePlace", is_abstract=True)
Behaviour_Server = Class(name="Behaviour_Server")
Behaviour_WaitingLine = Class(name="Behaviour_WaitingLine")
Behaviour_StartPlace = Class(name="Behaviour_StartPlace")
Behaviour_ConditionalTransition = Class(name="Behaviour_ConditionalTransition")
Transition = Class(name="Transition")
Behaviour_TransitionFunction = Class(name="Behaviour_TransitionFunction")
Behaviour_StochasticTransition = Class(name="Behaviour_StochasticTransition")
Behaviour_Colour = Class(name="Behaviour_Colour")
Behaviour_Description = Class(name="Behaviour_Description")
...
domain_model = DomainModel(
    name="Behaviour",
    types={Behaviour_Place, Identifier, Behaviour_Token, Behaviour_Transition, Behaviour_PostTransitionConnection, Behaviour_PreTransitionConnection, Behaviour_Connection, Connection, Behaviour_DefaultPlace, Place, Behaviour_QueuePlace, Behaviour_Server, Behaviour_WaitingLine, Behaviour_StartPlace, Behaviour_ConditionalTransition, Transition, Behaviour_TransitionFunction, Behaviour_StochasticTransition, Behaviour_Colour, Behaviour_Description},
    associations={token0, waitingLine22, preTransition23, outgoingEdges1, incommingEdges2, place4, transition6, preTransitions9, postTransitions11, server14, waitingLine15, preTransitions17, transitionFunction19, transitionFunction20, server26, postTransitions27, attributes30, arrows32, place34, transition37, token40, transitionConnection43, emittedToken46},
    generalizations={gen_Behaviour_Place_Identifier, gen_Behaviour_Server_Place, gen_Behaviour_WaitingLine_Place, gen_Behaviour_Transition_Identifier, gen_Behaviour_Connection_Identifier, gen_Behaviour_PostTransitionConnection_Connection, gen_Behaviour_PreTransitionConnection_Connection, gen_Behaviour_DefaultPlace_Place, gen_Behaviour_QueuePlace_Place, gen_Behaviour_StartPlace_Place, gen_Behaviour_ConditionalTransition_Transition, gen_Behaviour_StochasticTransition_Transition, gen_Behaviour_Token_Identifier, gen_Behaviour_Description_Identifier, gen_Behaviour_Colour_Identifier},
    metadata=None
)
