...
def test_model_diagrammodelarchimateobject_has_figureDelegateType():
    assert hasattr(model_DiagramModelArchimateObject, "figureDelegateType")
    descriptor = None
    for klass in model_DiagramModelArchimateObject.__mro__:
        if "figureDelegateType" in klass.__dict__:
            descriptor = klass.__dict__["figureDelegateType"]
            break
    assert isinstance(descriptor, property)
...
@given(instance=model_DiagramModelArchimateObject_strategy)
def test_model_diagrammodelarchimateobject_figureDelegateType_setter(instance):
