...
class model_SketchModelSticky(DiagramModelObject, DiagramModelContainer, TextContent, TextPosition, Properties):

    pass
class Documentable:

    pass
class model_DiagramModelGroup(DiagramModelObject, DiagramModelContainer, Properties, Documentable):

    pass
class model_DiagramModelConnection(FontAttribute, Connectable, Documentable, LineObject, Properties):
...
class model_DiagramModel(DiagramModelContainer, ArchimateModelObject, Properties, Documentable):
