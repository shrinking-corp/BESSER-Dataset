...
def test_hyp_model_diagrammodelarchimateobject_constructor_args():
    ...
    params = list(sig.parameters.keys())
    assert "figureDelegateType" in params, "Missing parameter 'figureDelegateType'"
...
def test_hyp_model_diagrammodelarchimateobject_figureDelegateType_setter(instance):
    original = instance.figureDelegateType
    instance.figureDelegateType = original
    assert instance.figureDelegateType == original
...
def test_hyp_model_diagrammodelnote_borderType_setter(instance):
...
def test_model_DiagramModelArchimateObject_figureDelegateType_value_roundtrip():
    instance = model_DiagramModelArchimateObject(figureDelegateType="sample_text")
    assert instance.figureDelegateType == "sample_text"
    instance.figureDelegateType = "sample_text_2"
    assert instance.figureDelegateType == "sample_text_2"
...
def test_assoc_archimateElement28_link_reassign_clear():
    a = model_DiagramModelArchimateObject(figureDelegateType="sample_text")
...
model_DiagramModelArchimateObject_strategy = st.builds(model_DiagramModelArchimateObject, figureDelegateType=safe_text)
@given(instance=model_DiagramModelArchimateObject_strategy)
@settings(max_examples=25)
