...
class alf_QualifiedNameWithBinding:
    ...
    def __init__(self, id: str, alf_QualifiedNameWithBinding100: "alf_SequenceReductionExpression" = None, alf_QualifiedNameWithBinding: "alf_NamedTemplateBinding" = None, alf_QualifiedNameWithBinding23: "alf_TemplateBinding" = None, alf_QualifiedNameWithBinding27: "alf_QualifiedNameWithBinding" = None, alf_QualifiedNameWithBinding25: "alf_QualifiedNameWithBinding" = None, alf_QualifiedNameWithBinding166: "alf_LocalNameDeclarationStatement" = None, alf_QualifiedNameWithBinding229: "alf_LoopVariableDefinition" = None, alf_QualifiedNameWithBinding92: "alf_SequenceOperationExpression" = None, alf_QualifiedNameWithBinding124: "alf_InstanceCreationExpression" = None, alf_QualifiedNameWithBinding122: "alf_SuperInvocationExpression" = None, alf_QualifiedNameWithBinding271: "alf_QualifiedNameList" = None):
        self.id = id
...
class alf_AssignmentCompletion:
    ...
    def __init__(self, op: str, alf_AssignmentCompletion: "alf_Test" = None, alf_AssignmentCompletion285: "alf_ThisInvocationStatement" = None, alf_AssignmentCompletion290: "alf_VariableDeclarationCompletion" = None, alf_AssignmentCompletion292: "alf_SequenceElement" = None, alf_AssignmentCompletion278: "alf_InvocationOrAssignementOrDeclarationStatement" = None):
        self.op = op
...
class alf_SequenceConstructionOrAccessCompletion:
    ...
    def __init__(self, multiplicityIndicator: bool, alf_SequenceConstructionOrAccessCompletion: "alf_NameExpression" = None, alf_SequenceConstructionOrAccessCompletion136: "alf_AccessCompletion" = None, alf_SequenceConstructionOrAccessCompletion138: "alf_PartialSequenceConstructionCompletion" = None, alf_SequenceConstructionOrAccessCompletion140: "alf_SequenceConstructionExpression" = None):
        ...
        pass
    @property
    def multiplicityIndicator(self):
...
class alf_NameExpression(NonLiteralValueSpecification, ValueSpecification):
    ...
    def __init__(self, prefixOp: str, id: str, postfixOp: str, alf_NameExpression56: "alf_ClassificationExpression" = None, alf_NameExpression: "alf_QualifiedNamePath" = None, alf_NameExpression9: "alf_Tuple" = None, alf_NameExpression11: "alf_SequenceConstructionOrAccessCompletion" = None, alf_NameExpression13: "alf_SuffixExpression" = None, alf_NameExpression273: "alf_InvocationOrAssignementOrDeclarationStatement" = None):
...
class alf_VariableDeclarationCompletion:
    ...
    def __init__(self, multiplicityIndicator: bool, variableName: str, alf_VariableDeclarationCompletion289: "alf_AssignmentCompletion" = None, alf_VariableDeclarationCompletion: "alf_InvocationOrAssignementOrDeclarationStatement" = None):
        self.multiplicityIndicator = multiplicityIndicator
...
class alf_LoopVariableDefinition:
    ...
    def __init__(self, name: str, alf_LoopVariableDefinition222: "alf_Expression" = None, alf_LoopVariableDefinition225: "alf_Expression" = None, alf_LoopVariableDefinition228: "alf_QualifiedNameWithBinding" = None, alf_LoopVariableDefinition231: "alf_Expression" = None, alf_LoopVariableDefinition: "alf_ForControl" = None):
        self.name = name
...
class alf_InlineStatement(Statement):
    ...
    def __init__(self, body: str, langageName: str):
        self.body = body
