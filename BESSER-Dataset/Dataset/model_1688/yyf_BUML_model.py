...
# Classes
yyf_Alias = Class(name="yyf_Alias")
yyf_Bar = Class(name="yyf_Bar")
yyf_Base = Class(name="yyf_Base")
NamedElement = Class(name="NamedElement")
yyf_Relation = Class(name="yyf_Relation")
yyf_Foo = Class(name="yyf_Foo")
yyf_Output = Class(name="yyf_Output")
yyf_NamedElement = Class(name="yyf_NamedElement", is_abstract=True)
...
domain_model = DomainModel(
    name="yyf",
    types={yyf_Alias, yyf_Bar, yyf_Base, NamedElement, yyf_Relation, yyf_Foo, yyf_Output, yyf_NamedElement},
    associations={aliases4, bars5, fromThing7, toThing8, subRelations11, relations0, foos1, ouputs2, output13},
    generalizations={gen_yyf_Relation_NamedElement, gen_yyf_Base_NamedElement},
    metadata=None
)
