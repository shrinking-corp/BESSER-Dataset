...
class yyf_Relation(NamedElement):
    ...
    def __init__(self, since: str, relations: "yyf_Base" = None, yyf_Relation: "yyf_Base" = None, yyf_Relation12: "yyf_Relation" = None, yyf_Relation10: set["yyf_Relation"] = None, Relation: "yyf_Base" = None):
        self.since = since
...
class yyf_Base(NamedElement):
    ...
    def __init__(self, id: int, Base: "yyf_Relation" = None, yyf_Base9: "yyf_Relation" = None, fromThing: set["yyf_Relation"] = None, yyf_Base: set["yyf_Foo"] = None, yyf_Base3: set["yyf_Output"] = None):
        self.id = id
        self.Base = Base
