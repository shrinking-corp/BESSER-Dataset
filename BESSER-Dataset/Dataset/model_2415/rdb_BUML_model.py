...
# Classes
rdb_Model = Class(name="rdb_Model")
NamedElement = Class(name="NamedElement")
rdb_Schema = Class(name="rdb_Schema")
rdb_SchemaElement = Class(name="rdb_SchemaElement", is_abstract=True)
rdb_Table = Class(name="rdb_Table")
NamedColumnSet = Class(name="NamedColumnSet")
rdb_TableColumn = Class(name="rdb_TableColumn")
...
rdb_Column = Class(name="rdb_Column", is_abstract=True)
Column = Class(name="Column")
Domain = Class(name="Domain")
rdb_Element = Class(name="rdb_Element")
rdb_NamedColumnSet = Class(name="rdb_NamedColumnSet", is_abstract=True)
SchemaElement = Class(name="SchemaElement")
rdb_NamedElement = Class(name="rdb_NamedElement", is_abstract=True)
Element = Class(name="Element")
rdb_constraints_UniqueConstraint = Class(name="rdb_constraints_UniqueConstraint")
ColumnRefConstraint = Class(name="ColumnRefConstraint")
rdb_constraints_PrimaryKey = Class(name="rdb_constraints_PrimaryKey")
rdb_constraints_ForeignKey = Class(name="rdb_constraints_ForeignKey")
rdb_constraints_Index = Class(name="rdb_constraints_Index")
IndexedColumn = Class(name="IndexedColumn")
rdb_constraints_IndexedColumn = Class(name="rdb_constraints_IndexedColumn")
rdb_datatypes_Domain = Class(name="rdb_datatypes_Domain")
datatypes_PrimitiveDataType = Class(name="datatypes_PrimitiveDataType")
rdb_datatypes_DataType = Class(name="rdb_datatypes_DataType", is_abstract=True)
rdb_datatypes_PrimitiveDataType = Class(name="rdb_datatypes_PrimitiveDataType")
DataType = Class(name="DataType")
rdb_view_View = Class(name="rdb_view_View")
ViewColumn = Class(name="ViewColumn")
PrimitiveDataType = Class(name="PrimitiveDataType")
rdb_constraints_Constraint = Class(name="rdb_constraints_Constraint", is_abstract=True)
rdb_constraints_CheckConstraint = Class(name="rdb_constraints_CheckConstraint")
Constraint = Class(name="Constraint")
rdb_constraints_ColumnRefConstraint = Class(name="rdb_constraints_ColumnRefConstraint", is_abstract=True)
constraints_rdb_TableColumn = Class(name="constraints_rdb_TableColumn")
rdb_view_ReferencedViewColumn = Class(name="rdb_view_ReferencedViewColumn")
view_rdb_Column = Class(name="view_rdb_Column")
ViewAlias = Class(name="ViewAlias")
rdb_view_ViewAlias = Class(name="rdb_view_ViewAlias")
view_rdb_NamedColumnSet = Class(name="view_rdb_NamedColumnSet")
rdb_view_ViewColumn = Class(name="rdb_view_ViewColumn", is_abstract=True)
rdb_view_ViewExpressionColumn = Class(name="rdb_view_ViewExpressionColumn")
...
rdb_datatypes_DataType.attributes={rdb_datatypes_DataType_check, rdb_datatypes_DataType_default, rdb_datatypes_DataType_nullable, rdb_datatypes_DataType_var, rdb_datatypes_DataType_decimalDigits, rdb_datatypes_DataType_size}
...
domain_model = DomainModel(
    name="rdb",
    types={rdb_Model, NamedElement, rdb_Schema, rdb_SchemaElement, rdb_Table, NamedColumnSet, rdb_TableColumn, PrimaryKey, UniqueConstraint, ForeignKey, Index, CheckConstraint, rdb_Column, Column, Domain, rdb_Element, rdb_NamedColumnSet, SchemaElement, rdb_NamedElement, Element, rdb_constraints_UniqueConstraint, ColumnRefConstraint, rdb_constraints_PrimaryKey, rdb_constraints_ForeignKey, rdb_constraints_Index, IndexedColumn, rdb_constraints_IndexedColumn, rdb_datatypes_Domain, datatypes_PrimitiveDataType, rdb_datatypes_DataType, rdb_datatypes_PrimitiveDataType, DataType, rdb_view_View, ViewColumn, PrimitiveDataType, rdb_constraints_Constraint, rdb_constraints_CheckConstraint, Constraint, rdb_constraints_ColumnRefConstraint, constraints_rdb_TableColumn, rdb_view_ReferencedViewColumn, view_rdb_Column, ViewAlias, rdb_view_ViewAlias, view_rdb_NamedColumnSet, rdb_view_ViewColumn, rdb_view_ViewExpressionColumn},
    associations={schemas2, elements3, columns5, primaryKey6, uniqueConstraints8, foreignKeys10, indices12, checks14, domain16, parent1, includedColumns20, referredUC21, indexedColumns23, refColumn24, parentDomain26, type18, refColumn32, columns28, referencedTablesAndViews29, referencedTableOrView31},
    generalizations={gen_rdb_Model_NamedElement, gen_rdb_Schema_NamedElement, gen_rdb_SchemaElement_NamedElement, gen_rdb_Table_NamedColumnSet, gen_rdb_Column_NamedElement, gen_rdb_TableColumn_Column, gen_rdb_NamedColumnSet_SchemaElement, gen_rdb_NamedElement_Element, gen_rdb_constraints_UniqueConstraint_ColumnRefConstraint, gen_rdb_constraints_PrimaryKey_UniqueConstraint, gen_rdb_constraints_ForeignKey_ColumnRefConstraint, gen_rdb_constraints_Index_Constraint, gen_rdb_constraints_IndexedColumn_NamedElement, gen_rdb_datatypes_Domain_SchemaElement, gen_rdb_datatypes_Domain_datatypes_PrimitiveDataType, gen_rdb_datatypes_DataType_NamedElement, gen_rdb_datatypes_PrimitiveDataType_DataType, gen_rdb_view_View_NamedColumnSet, gen_rdb_constraints_Constraint_NamedElement, gen_rdb_constraints_CheckConstraint_Constraint, gen_rdb_constraints_ColumnRefConstraint_Constraint, gen_rdb_view_ReferencedViewColumn_ViewColumn, gen_rdb_view_ViewAlias_NamedElement, gen_rdb_view_ViewColumn_Column, gen_rdb_view_ViewExpressionColumn_ViewColumn},
    metadata=None
)
