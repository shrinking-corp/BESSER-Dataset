...
# Classes
tgg_TripleGraphGrammarFile = Class(name="tgg_TripleGraphGrammarFile")
tgg_Import = Class(name="tgg_Import")
tgg_Using = Class(name="tgg_Using")
tgg_Schema = Class(name="tgg_Schema")
tgg_Rule = Class(name="tgg_Rule")
tgg_EPackage = Class(name="tgg_EPackage")
tgg_CorrType = Class(name="tgg_CorrType")
tgg_AttrCondDef = Class(name="tgg_AttrCondDef")
tgg_EClass = Class(name="tgg_EClass")
tgg_Param = Class(name="tgg_Param")
tgg_Adornment = Class(name="tgg_Adornment")
tgg_EDataType = Class(name="tgg_EDataType")
tgg_ComplementRule = Class(name="tgg_ComplementRule")
tgg_Nac = Class(name="tgg_Nac")
tgg_AttrCond = Class(name="tgg_AttrCond")
tgg_AttrCondDefLibrary = Class(name="tgg_AttrCondDefLibrary")
NamedElements = Class(name="NamedElements")
tgg_ParamValue = Class(name="tgg_ParamValue")
tgg_LocalVariable = Class(name="tgg_LocalVariable")
ParamValue = Class(name="ParamValue")
NamePattern = Class(name="NamePattern")
tgg_ObjectVariablePattern = Class(name="tgg_ObjectVariablePattern")
tgg_CorrVariablePattern = Class(name="tgg_CorrVariablePattern")
tgg_ContextLinkVariablePattern = Class(name="tgg_ContextLinkVariablePattern")
tgg_EAttribute = Class(name="tgg_EAttribute")
tgg_Expression = Class(name="tgg_Expression")
tgg_EnumExpression = Class(name="tgg_EnumExpression")
Expression = Class(name="Expression")
tgg_EEnum = Class(name="tgg_EEnum")
tgg_EEnumLiteral = Class(name="tgg_EEnumLiteral")
tgg_AttributeExpression = Class(name="tgg_AttributeExpression")
tgg_EObject = Class(name="tgg_EObject")
tgg_LiteralExpression = Class(name="tgg_LiteralExpression")
OperatorPattern = Class(name="OperatorPattern")
tgg_AttributeAssignment = Class(name="tgg_AttributeAssignment")
tgg_AttributeConstraint = Class(name="tgg_AttributeConstraint")
tgg_LinkVariablePattern = Class(name="tgg_LinkVariablePattern")
tgg_ContextObjectVariablePattern = Class(name="tgg_ContextObjectVariablePattern")
tgg_OperatorPattern = Class(name="tgg_OperatorPattern")
tgg_NamedElements = Class(name="tgg_NamedElements")
tgg_NamePattern = Class(name="tgg_NamePattern")
tgg_EReference = Class(name="tgg_EReference")
tgg_Operator = Class(name="tgg_Operator")
...
domain_model = DomainModel(
    name="tgg",
    types={tgg_TripleGraphGrammarFile, tgg_Import, tgg_Using, tgg_Schema, tgg_Rule, tgg_EPackage, tgg_CorrType, tgg_AttrCondDef, tgg_EClass, tgg_Param, tgg_Adornment, tgg_EDataType, tgg_ComplementRule, tgg_Nac, tgg_AttrCond, tgg_AttrCondDefLibrary, NamedElements, tgg_ParamValue, tgg_LocalVariable, ParamValue, NamePattern, tgg_ObjectVariablePattern, tgg_CorrVariablePattern, tgg_ContextLinkVariablePattern, tgg_EAttribute, tgg_Expression, tgg_EnumExpression, Expression, tgg_EEnum, tgg_EEnumLiteral, tgg_AttributeExpression, tgg_EObject, tgg_LiteralExpression, OperatorPattern, tgg_AttributeAssignment, tgg_AttributeConstraint, tgg_LinkVariablePattern, tgg_ContextObjectVariablePattern, tgg_OperatorPattern, tgg_NamedElements, tgg_NamePattern, tgg_EReference, tgg_Operator},
    associations={imports0, using1, schema3, sourceTypes13, targetTypes15, correspondenceTypes18, attributeCondDefs20, super23, source25, target27, params30, allowedSyncAdornments32, allowedGenAdornments34, type37, rules5, complementRules7, nacs9, attrConditions52, library11, name54, values57, attributeCondDefs59, type62, source65, target68, type71, supertypes40, schema42, sourcePatterns45, targetPatterns47, correspondencePatterns50, linkVariablePatterns85, attribute87, valueExp89, attribute91, valueExp94, eenum97, literal98, objectVar100, attribute101, attributeAssignments74, attributeConstraints76, linkVariablePatterns78, type80, attributeConstraints82, sourcePatterns118, targetPatterns121, correspondencePatterns124, attrConditions127, rule130, sourcePatterns133, targetPatterns136, attrConditions139, op142, type104, target106, type109, target112, kernel115},
    generalizations={gen_tgg_CorrType_NamedElements, gen_tgg_AttrCondDef_NamedElements, gen_tgg_Schema_NamedElements, gen_tgg_AttrCondDefLibrary_NamedElements, gen_tgg_LocalVariable_ParamValue, gen_tgg_CorrVariablePattern_NamePattern, gen_tgg_ObjectVariablePattern_NamePattern, gen_tgg_Rule_NamedElements, gen_tgg_Expression_ParamValue, gen_tgg_EnumExpression_Expression, gen_tgg_AttributeExpression_Expression, gen_tgg_LiteralExpression_Expression, gen_tgg_LinkVariablePattern_OperatorPattern, gen_tgg_Nac_NamedElements, gen_tgg_NamePattern_OperatorPattern, gen_tgg_NamePattern_NamedElements, gen_tgg_ComplementRule_NamedElements},
    metadata=None
)
