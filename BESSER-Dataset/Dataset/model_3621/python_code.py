...
class tgg_ContextObjectVariablePattern:
    ...
    def __init__(self, name: str, tgg_ContextObjectVariablePattern86: set["tgg_ContextLinkVariablePattern"] = None, tgg_ContextObjectVariablePattern: "tgg_EClass" = None, tgg_ContextObjectVariablePattern83: set["tgg_AttributeConstraint"] = None, tgg_ContextObjectVariablePattern135: "tgg_Nac" = None, tgg_ContextObjectVariablePattern138: "tgg_Nac" = None, tgg_ContextObjectVariablePattern114: "tgg_ContextLinkVariablePattern" = None):
        self.name = name
...
class tgg_AttributeConstraint:
    ...
    def __init__(self, op: str, tgg_AttributeConstraint88: "tgg_EAttribute" = None, tgg_AttributeConstraint90: "tgg_Expression" = None, tgg_AttributeConstraint: "tgg_ObjectVariablePattern" = None, tgg_AttributeConstraint84: "tgg_ContextObjectVariablePattern" = None):
        self.op = op
...
class tgg_AttributeAssignment:
    ...
    def __init__(self, op: str, tgg_AttributeAssignment92: "tgg_EAttribute" = None, tgg_AttributeAssignment95: "tgg_Expression" = None, tgg_AttributeAssignment: "tgg_ObjectVariablePattern" = None):
        self.op = op
...
class NamedElements:
    ...
    pass
class tgg_NamePattern(NamedElements, OperatorPattern):
...
class tgg_Rule(NamedElements):
    ...
    def __init__(self, abstractRule: bool, tgg_Rule41: "tgg_Rule" = None, tgg_Rule39: set["tgg_Rule"] = None, tgg_Rule43: "tgg_Schema" = None, tgg_Rule46: set["tgg_ObjectVariablePattern"] = None, tgg_Rule48: set["tgg_ObjectVariablePattern"] = None, tgg_Rule51: set["tgg_CorrVariablePattern"] = None, tgg_Rule: "tgg_TripleGraphGrammarFile" = None, tgg_Rule53: set["tgg_AttrCond"] = None, tgg_Rule132: "tgg_Nac" = None, tgg_Rule117: "tgg_ComplementRule" = None):
