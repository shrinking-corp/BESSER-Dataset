...
def test_hyp_tgg_operator_is_not_abstract():
    assert not inspect.isabstract(tgg_Operator)


def test_hyp_tgg_operator_constructor_exists():
    assert callable(tgg_Operator.__init__)


def test_hyp_tgg_operator_constructor_args():
...
def test_hyp_tgg_ereference_is_not_abstract():
    assert not inspect.isabstract(tgg_EReference)


def test_hyp_tgg_ereference_constructor_exists():
    assert callable(tgg_EReference.__init__)


def test_hyp_tgg_ereference_constructor_args():
    sig = inspect.signature(tgg_EReference.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tgg_namedelements_is_not_abstract():
    assert not inspect.isabstract(tgg_NamedElements)


def test_hyp_tgg_namedelements_constructor_exists():
    assert callable(tgg_NamedElements.__init__)


def test_hyp_tgg_namedelements_constructor_args():
...
def test_hyp_tgg_operatorpattern_is_not_abstract():
    assert not inspect.isabstract(tgg_OperatorPattern)


def test_hyp_tgg_operatorpattern_constructor_exists():
    assert callable(tgg_OperatorPattern.__init__)


def test_hyp_tgg_operatorpattern_constructor_args():
    sig = inspect.signature(tgg_OperatorPattern.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tgg_contextobjectvariablepattern_is_not_abstract():
    assert not inspect.isabstract(tgg_ContextObjectVariablePattern)


def test_hyp_tgg_contextobjectvariablepattern_constructor_exists():
    assert callable(tgg_ContextObjectVariablePattern.__init__)


def test_hyp_tgg_contextobjectvariablepattern_constructor_args():
...
def test_hyp_tgg_attributeconstraint_is_not_abstract():
    assert not inspect.isabstract(tgg_AttributeConstraint)


def test_hyp_tgg_attributeconstraint_constructor_exists():
    assert callable(tgg_AttributeConstraint.__init__)


def test_hyp_tgg_attributeconstraint_constructor_args():
...
def test_hyp_tgg_attributeassignment_is_not_abstract():
    assert not inspect.isabstract(tgg_AttributeAssignment)


def test_hyp_tgg_attributeassignment_constructor_exists():
    assert callable(tgg_AttributeAssignment.__init__)


def test_hyp_tgg_attributeassignment_constructor_args():
...
def test_hyp_operatorpattern_is_not_abstract():
    assert not inspect.isabstract(OperatorPattern)


def test_hyp_operatorpattern_constructor_exists():
    assert callable(OperatorPattern.__init__)


def test_hyp_operatorpattern_constructor_args():
    sig = inspect.signature(OperatorPattern.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tgg_linkvariablepattern_is_not_abstract():
    assert not inspect.isabstract(tgg_LinkVariablePattern)


def test_hyp_tgg_linkvariablepattern_constructor_exists():
    assert callable(tgg_LinkVariablePattern.__init__)


def test_hyp_tgg_linkvariablepattern_constructor_args():
    sig = inspect.signature(tgg_LinkVariablePattern.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tgg_eobject_is_not_abstract():
    assert not inspect.isabstract(tgg_EObject)


def test_hyp_tgg_eobject_constructor_exists():
    assert callable(tgg_EObject.__init__)


def test_hyp_tgg_eobject_constructor_args():
    sig = inspect.signature(tgg_EObject.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tgg_eenumliteral_is_not_abstract():
    assert not inspect.isabstract(tgg_EEnumLiteral)


def test_hyp_tgg_eenumliteral_constructor_exists():
    assert callable(tgg_EEnumLiteral.__init__)


def test_hyp_tgg_eenumliteral_constructor_args():
    sig = inspect.signature(tgg_EEnumLiteral.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tgg_eenum_is_not_abstract():
    assert not inspect.isabstract(tgg_EEnum)


def test_hyp_tgg_eenum_constructor_exists():
    assert callable(tgg_EEnum.__init__)


def test_hyp_tgg_eenum_constructor_args():
...
def test_hyp_tgg_literalexpression_is_not_abstract():
    assert not inspect.isabstract(tgg_LiteralExpression)


def test_hyp_tgg_literalexpression_constructor_exists():
    assert callable(tgg_LiteralExpression.__init__)


def test_hyp_tgg_literalexpression_constructor_args():
...
def test_hyp_tgg_attributeexpression_is_not_abstract():
    assert not inspect.isabstract(tgg_AttributeExpression)


def test_hyp_tgg_attributeexpression_constructor_exists():
    assert callable(tgg_AttributeExpression.__init__)


def test_hyp_tgg_attributeexpression_constructor_args():
    sig = inspect.signature(tgg_AttributeExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tgg_enumexpression_is_not_abstract():
    assert not inspect.isabstract(tgg_EnumExpression)


def test_hyp_tgg_enumexpression_constructor_exists():
    assert callable(tgg_EnumExpression.__init__)


def test_hyp_tgg_enumexpression_constructor_args():
    sig = inspect.signature(tgg_EnumExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tgg_eattribute_is_not_abstract():
    assert not inspect.isabstract(tgg_EAttribute)


def test_hyp_tgg_eattribute_constructor_exists():
    assert callable(tgg_EAttribute.__init__)


def test_hyp_tgg_eattribute_constructor_args():
    sig = inspect.signature(tgg_EAttribute.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tgg_contextlinkvariablepattern_is_not_abstract():
    assert not inspect.isabstract(tgg_ContextLinkVariablePattern)


def test_hyp_tgg_contextlinkvariablepattern_constructor_exists():
    assert callable(tgg_ContextLinkVariablePattern.__init__)


def test_hyp_tgg_contextlinkvariablepattern_constructor_args():
    sig = inspect.signature(tgg_ContextLinkVariablePattern.__init__)
    params = list(sig.parameters.keys())



def test_hyp_namepattern_is_not_abstract():
    assert not inspect.isabstract(NamePattern)


def test_hyp_namepattern_constructor_exists():
    assert callable(NamePattern.__init__)


def test_hyp_namepattern_constructor_args():
    sig = inspect.signature(NamePattern.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tgg_corrvariablepattern_is_not_abstract():
    assert not inspect.isabstract(tgg_CorrVariablePattern)


def test_hyp_tgg_corrvariablepattern_constructor_exists():
    assert callable(tgg_CorrVariablePattern.__init__)


def test_hyp_tgg_corrvariablepattern_constructor_args():
    sig = inspect.signature(tgg_CorrVariablePattern.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tgg_objectvariablepattern_is_not_abstract():
    assert not inspect.isabstract(tgg_ObjectVariablePattern)


def test_hyp_tgg_objectvariablepattern_constructor_exists():
    assert callable(tgg_ObjectVariablePattern.__init__)


def test_hyp_tgg_objectvariablepattern_constructor_args():
    sig = inspect.signature(tgg_ObjectVariablePattern.__init__)
    params = list(sig.parameters.keys())



def test_hyp_paramvalue_is_not_abstract():
    assert not inspect.isabstract(ParamValue)


def test_hyp_paramvalue_constructor_exists():
    assert callable(ParamValue.__init__)


def test_hyp_paramvalue_constructor_args():
    sig = inspect.signature(ParamValue.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tgg_expression_is_not_abstract():
    assert not inspect.isabstract(tgg_Expression)


def test_hyp_tgg_expression_constructor_exists():
    assert callable(tgg_Expression.__init__)


def test_hyp_tgg_expression_constructor_args():
    sig = inspect.signature(tgg_Expression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tgg_localvariable_is_not_abstract():
    assert not inspect.isabstract(tgg_LocalVariable)


def test_hyp_tgg_localvariable_constructor_exists():
    assert callable(tgg_LocalVariable.__init__)


def test_hyp_tgg_localvariable_constructor_args():
...
def test_hyp_tgg_paramvalue_is_not_abstract():
    assert not inspect.isabstract(tgg_ParamValue)


def test_hyp_tgg_paramvalue_constructor_exists():
    assert callable(tgg_ParamValue.__init__)


def test_hyp_tgg_paramvalue_constructor_args():
    sig = inspect.signature(tgg_ParamValue.__init__)
    params = list(sig.parameters.keys())



def test_hyp_namedelements_is_not_abstract():
    assert not inspect.isabstract(NamedElements)


def test_hyp_namedelements_constructor_exists():
    assert callable(NamedElements.__init__)


def test_hyp_namedelements_constructor_args():
    sig = inspect.signature(NamedElements.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tgg_namepattern_is_not_abstract():
    assert not inspect.isabstract(tgg_NamePattern)


def test_hyp_tgg_namepattern_constructor_exists():
    assert callable(tgg_NamePattern.__init__)


def test_hyp_tgg_namepattern_constructor_args():
    sig = inspect.signature(tgg_NamePattern.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tgg_attrconddeflibrary_is_not_abstract():
    assert not inspect.isabstract(tgg_AttrCondDefLibrary)


def test_hyp_tgg_attrconddeflibrary_constructor_exists():
    assert callable(tgg_AttrCondDefLibrary.__init__)


def test_hyp_tgg_attrconddeflibrary_constructor_args():
    sig = inspect.signature(tgg_AttrCondDefLibrary.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tgg_attrcond_is_not_abstract():
    assert not inspect.isabstract(tgg_AttrCond)


def test_hyp_tgg_attrcond_constructor_exists():
    assert callable(tgg_AttrCond.__init__)


def test_hyp_tgg_attrcond_constructor_args():
    sig = inspect.signature(tgg_AttrCond.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tgg_nac_is_not_abstract():
    assert not inspect.isabstract(tgg_Nac)


def test_hyp_tgg_nac_constructor_exists():
    assert callable(tgg_Nac.__init__)


def test_hyp_tgg_nac_constructor_args():
    sig = inspect.signature(tgg_Nac.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tgg_complementrule_is_not_abstract():
    assert not inspect.isabstract(tgg_ComplementRule)


def test_hyp_tgg_complementrule_constructor_exists():
    assert callable(tgg_ComplementRule.__init__)


def test_hyp_tgg_complementrule_constructor_args():
    sig = inspect.signature(tgg_ComplementRule.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tgg_edatatype_is_not_abstract():
    assert not inspect.isabstract(tgg_EDataType)


def test_hyp_tgg_edatatype_constructor_exists():
    assert callable(tgg_EDataType.__init__)


def test_hyp_tgg_edatatype_constructor_args():
    sig = inspect.signature(tgg_EDataType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tgg_adornment_is_not_abstract():
    assert not inspect.isabstract(tgg_Adornment)


def test_hyp_tgg_adornment_constructor_exists():
    assert callable(tgg_Adornment.__init__)


def test_hyp_tgg_adornment_constructor_args():
...
def test_hyp_tgg_param_is_not_abstract():
    assert not inspect.isabstract(tgg_Param)


def test_hyp_tgg_param_constructor_exists():
    assert callable(tgg_Param.__init__)


def test_hyp_tgg_param_constructor_args():
...
def test_hyp_tgg_eclass_is_not_abstract():
    assert not inspect.isabstract(tgg_EClass)


def test_hyp_tgg_eclass_constructor_exists():
    assert callable(tgg_EClass.__init__)


def test_hyp_tgg_eclass_constructor_args():
    sig = inspect.signature(tgg_EClass.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tgg_attrconddef_is_not_abstract():
    assert not inspect.isabstract(tgg_AttrCondDef)


def test_hyp_tgg_attrconddef_constructor_exists():
    assert callable(tgg_AttrCondDef.__init__)


def test_hyp_tgg_attrconddef_constructor_args():
...
def test_hyp_tgg_corrtype_is_not_abstract():
    assert not inspect.isabstract(tgg_CorrType)


def test_hyp_tgg_corrtype_constructor_exists():
    assert callable(tgg_CorrType.__init__)


def test_hyp_tgg_corrtype_constructor_args():
    sig = inspect.signature(tgg_CorrType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tgg_epackage_is_not_abstract():
    assert not inspect.isabstract(tgg_EPackage)


def test_hyp_tgg_epackage_constructor_exists():
    assert callable(tgg_EPackage.__init__)


def test_hyp_tgg_epackage_constructor_args():
    sig = inspect.signature(tgg_EPackage.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tgg_rule_is_not_abstract():
    assert not inspect.isabstract(tgg_Rule)


def test_hyp_tgg_rule_constructor_exists():
    assert callable(tgg_Rule.__init__)


def test_hyp_tgg_rule_constructor_args():
...
def test_hyp_tgg_schema_is_not_abstract():
    assert not inspect.isabstract(tgg_Schema)


def test_hyp_tgg_schema_constructor_exists():
    assert callable(tgg_Schema.__init__)


def test_hyp_tgg_schema_constructor_args():
    sig = inspect.signature(tgg_Schema.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tgg_using_is_not_abstract():
    assert not inspect.isabstract(tgg_Using)


def test_hyp_tgg_using_constructor_exists():
    assert callable(tgg_Using.__init__)


def test_hyp_tgg_using_constructor_args():
...
def test_hyp_tgg_import_is_not_abstract():
    assert not inspect.isabstract(tgg_Import)


def test_hyp_tgg_import_constructor_exists():
    assert callable(tgg_Import.__init__)


def test_hyp_tgg_import_constructor_args():
...
def test_hyp_tgg_triplegraphgrammarfile_is_not_abstract():
    assert not inspect.isabstract(tgg_TripleGraphGrammarFile)


def test_hyp_tgg_triplegraphgrammarfile_constructor_exists():
    assert callable(tgg_TripleGraphGrammarFile.__init__)


def test_hyp_tgg_triplegraphgrammarfile_constructor_args():
...
def test_hyp_tgg_operator_value_setter(instance):
...
def test_hyp_tgg_namedelements_name_setter(instance):
...
def test_hyp_tgg_contextobjectvariablepattern_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_tgg_attributeconstraint_op_setter(instance):
...
def test_hyp_tgg_attributeassignment_op_setter(instance):
    original = instance.op
    instance.op = original
    assert instance.op == original
...
def test_hyp_tgg_literalexpression_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_tgg_localvariable_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_tgg_adornment_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_tgg_param_paramName_setter(instance):
...
def test_hyp_tgg_attrconddef_userDefined_setter(instance):
...
def test_hyp_tgg_rule_abstractRule_setter(instance):
...
def test_hyp_tgg_using_importedNamespace_setter(instance):
...
def test_hyp_tgg_import_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
