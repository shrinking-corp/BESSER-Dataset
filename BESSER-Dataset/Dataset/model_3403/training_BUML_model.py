...
domain_model = DomainModel(
    name="training",
    types={training_Person, training_TrainingOrganization, Person, training_Session, training_Training, training_Trainer, training_Trainee},
    associations={Trainees3, people5, sessions7, training10, canBeProvidedBy13, canProvide14, training0, trainer1},
