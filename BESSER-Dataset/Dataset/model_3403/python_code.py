...
class training_Training:
    ...
    def __init__(self, title: str, training_Training12: "training_TrainingOrganization" = None, canProvide: set["training_Trainer"] = None, Training: "training_Trainer" = None, training_Training: "training_Session" = None):
        self.title = title
...
class training_Session:
    ...
    def __init__(self, date: date, training_Session4: set["training_Person"] = None, training_Session9: "training_TrainingOrganization" = None, training_Session: "training_Training" = None, training_Session2: "training_Trainer" = None):
        self.date = date
