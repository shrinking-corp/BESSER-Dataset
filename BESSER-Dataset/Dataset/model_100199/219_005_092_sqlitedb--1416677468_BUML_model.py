...
# Classes
model_DatabaseVersions = Class(name="model_DatabaseVersions")
model_Database = Class(name="model_Database")
TableMapping = Class(name="TableMapping")
model_DatabaseVersion = Class(name="model_DatabaseVersion")
Table = Class(name="Table")
ColumnMapping = Class(name="ColumnMapping")
NameProvider = Class(name="NameProvider")
Index = Class(name="Index")
model_common_NameProvider = Class(name="model_common_NameProvider", is_abstract=True)
model_common_MappingEntry = Class(name="model_common_MappingEntry")
model_common_StringToTableMappingEntryMap = Class(name="model_common_StringToTableMappingEntryMap")
View = Class(name="View")
Trigger = Class(name="Trigger")
model_common_TableMapping = Class(name="model_common_TableMapping")
model_common_StringToColumnMappingEntryMap = Class(name="model_common_StringToColumnMappingEntryMap")
StringToTableMappingEntryMap = Class(name="StringToTableMappingEntryMap")
model_common_ColumnMapping = Class(name="model_common_ColumnMapping")
StringToColumnMappingEntryMap = Class(name="StringToColumnMappingEntryMap")
model_table_Table = Class(name="model_table_Table")
Column = Class(name="Column")
TableConstraint = Class(name="TableConstraint")
model_table_TableConstraint = Class(name="model_table_TableConstraint", is_abstract=True)
model_table_PrimaryKeyTableConstraint = Class(name="model_table_PrimaryKeyTableConstraint")
IndexedColumn = Class(name="IndexedColumn")
table_model_Database = Class(name="table_model_Database")
model_table_CheckTableConstraint = Class(name="model_table_CheckTableConstraint")
Expression = Class(name="Expression")
model_table_ForeignKeyTableConstraint = Class(name="model_table_ForeignKeyTableConstraint")
model_column_Column = Class(name="model_column_Column")
model_table_UniqueTableConstraint = Class(name="model_table_UniqueTableConstraint")
ColumnConstraint = Class(name="ColumnConstraint")
model_column_IndexedColumn = Class(name="model_column_IndexedColumn")
model_column_ColumnConstraint = Class(name="model_column_ColumnConstraint", is_abstract=True)
model_column_CheckColumnConstraint = Class(name="model_column_CheckColumnConstraint")
model_column_DefaultValueColumnConstraint = Class(name="model_column_DefaultValueColumnConstraint", is_abstract=True)
model_column_DefaultExpressionValueColumnConstraint = Class(name="model_column_DefaultExpressionValueColumnConstraint")
model_column_DefaultStringValueColumnConstraint = Class(name="model_column_DefaultStringValueColumnConstraint")
model_column_DefaultIntegerValueColumnConstraint = Class(name="model_column_DefaultIntegerValueColumnConstraint")
model_column_DefaultRealValueColumnConstraint = Class(name="model_column_DefaultRealValueColumnConstraint")
model_column_PrimaryKeyColumnConstraint = Class(name="model_column_PrimaryKeyColumnConstraint")
model_column_NotNullColumnConstraint = Class(name="model_column_NotNullColumnConstraint")
model_column_UniqueColumnConstraint = Class(name="model_column_UniqueColumnConstraint")
model_index_Index = Class(name="model_index_Index", is_abstract=True)
index_model_Database = Class(name="index_model_Database")
model_trigger_Trigger = Class(name="model_trigger_Trigger")
trigger_model_Database = Class(name="trigger_model_Database")
model_expression_Expression = Class(name="model_expression_Expression", is_abstract=True)
model_view_View = Class(name="model_view_View")
view_model_Database = Class(name="view_model_Database")
...
model_DatabaseVersions.attributes={model_DatabaseVersions_packageName, model_DatabaseVersions_fileName}
...
model_common_TableMapping_m_getPrevious: Method = Method(name="getPrevious", parameters={Parameter(name='model_current', type=StringType)}, type=StringType)
model_common_TableMapping_m_getAllPrevious: Method = Method(name="getAllPrevious", parameters={})
model_common_TableMapping_m_getCurrent: Method = Method(name="getCurrent", parameters={Parameter(name='model_previous', type=StringType)}, type=StringType)
...
model_common_TableMapping_m_put: Method = Method(name="put", parameters={Parameter(name='model_previous', type=StringType), Parameter(name='model_current', type=StringType)})
model_common_TableMapping.methods={model_common_TableMapping_m_put, model_common_TableMapping_m_getPrevious, model_common_TableMapping_m_entries, model_common_TableMapping_m_getAllPrevious, model_common_TableMapping_m_getCurrent, model_common_TableMapping_m_getAllCurrent}
...
model_common_ColumnMapping_m_getCurrent: Method = Method(name="getCurrent", parameters={Parameter(name='model_previous', type=StringType)}, type=StringType)
model_common_ColumnMapping_m_getAllCurrent: Method = Method(name="getAllCurrent", parameters={})
model_common_ColumnMapping_m_put: Method = Method(name="put", parameters={Parameter(name='model_previous', type=StringType), Parameter(name='model_current', type=StringType)})
model_common_ColumnMapping_m_getPrevious: Method = Method(name="getPrevious", parameters={Parameter(name='model_current', type=StringType)}, type=StringType)
model_common_ColumnMapping_m_entries: Method = Method(name="entries", parameters={})
model_common_ColumnMapping.methods={model_common_ColumnMapping_m_getCurrent, model_common_ColumnMapping_m_put, model_common_ColumnMapping_m_getAllPrevious, model_common_ColumnMapping_m_getPrevious, model_common_ColumnMapping_m_getAllCurrent, model_common_ColumnMapping_m_entries}
...
triggers15: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="database16", type=Trigger, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
indexes17: BinaryAssociation = BinaryAssociation(
    name="indexes17",
    ends={
        Property(name="Index", type=model_Database, multiplicity=Multiplicity(1, 1)),
        Property(name="database18", type=Index, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
views13: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="database14", type=View, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
prev2entryMap19: BinaryAssociation = BinaryAssociation(
    name="prev2entryMap19",
    ends={
...
curr2entryMap20: BinaryAssociation = BinaryAssociation(
    name="curr2entryMap20",
    ends={
        Property(name="StringToTableMappingEntryMap22", type=model_common_TableMapping, multiplicity=Multiplicity(1, 1)),
        Property(name="model_common_TableMapping21", type=StringToTableMappingEntryMap, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
prev2entryMap23: BinaryAssociation = BinaryAssociation(
    name="prev2entryMap23",
    ends={
...
curr2entryMap24: BinaryAssociation = BinaryAssociation(
    name="curr2entryMap24",
    ends={
        Property(name="StringToColumnMappingEntryMap26", type=model_common_ColumnMapping, multiplicity=Multiplicity(1, 1)),
        Property(name="model_common_ColumnMapping25", type=StringToColumnMappingEntryMap, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
constraints29: BinaryAssociation = BinaryAssociation(
    name="constraints29",
    ends={
        Property(name="TableConstraint", type=model_table_Table, multiplicity=Multiplicity(1, 1)),
        Property(name="table30", type=TableConstraint, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
table31: BinaryAssociation = BinaryAssociation(
    name="table31",
    ends={
        Property(name="Table32", type=model_table_TableConstraint, multiplicity=Multiplicity(1, 1)),
        Property(name="constraints", type=Table, multiplicity=Multiplicity(1, 1))
    }
)
columns33: BinaryAssociation = BinaryAssociation(
    name="columns33",
    ends={
...
database27: BinaryAssociation = BinaryAssociation(
    name="database27",
    ends={
...
columns37: BinaryAssociation = BinaryAssociation(
    name="columns37",
    ends={
        Property(name="Column38", type=model_table_ForeignKeyTableConstraint, multiplicity=Multiplicity(1, 1)),
        Property(name="model_table_ForeignKeyTableConstraint", type=Column, multiplicity=Multiplicity(1, 9999))
    }
)
foreignTable39: BinaryAssociation = BinaryAssociation(
    name="foreignTable39",
    ends={
        Property(name="Table41", type=model_table_ForeignKeyTableConstraint, multiplicity=Multiplicity(1, 1)),
        Property(name="model_table_ForeignKeyTableConstraint40", type=Table, multiplicity=Multiplicity(1, 1))
    }
)
foreignColumns42: BinaryAssociation = BinaryAssociation(
    name="foreignColumns42",
    ends={
        Property(name="Column44", type=model_table_ForeignKeyTableConstraint, multiplicity=Multiplicity(1, 1)),
        Property(name="model_table_ForeignKeyTableConstraint43", type=Column, multiplicity=Multiplicity(1, 9999))
    }
)
columns34: BinaryAssociation = BinaryAssociation(
    name="columns34",
    ends={
        Property(name="IndexedColumn35", type=model_table_UniqueTableConstraint, multiplicity=Multiplicity(1, 1)),
        Property(name="model_table_UniqueTableConstraint", type=IndexedColumn, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
constraints47: BinaryAssociation = BinaryAssociation(
    name="constraints47",
    ends={
        Property(name="ColumnConstraint", type=model_column_Column, multiplicity=Multiplicity(1, 1)),
        Property(name="column", type=ColumnConstraint, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
column50: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="constraints51", type=Column, multiplicity=Multiplicity(1, 1))
    }
)
table45: BinaryAssociation = BinaryAssociation(
    name="table45",
    ends={
        Property(name="Table46", type=model_column_Column, multiplicity=Multiplicity(1, 1)),
...
domain_model = DomainModel(
    name="model",
    types={model_DatabaseVersions, model_Database, TableMapping, model_DatabaseVersion, Table, ColumnMapping, NameProvider, Index, model_common_NameProvider, model_common_MappingEntry, model_common_StringToTableMappingEntryMap, View, Trigger, model_common_TableMapping, model_common_StringToColumnMappingEntryMap, StringToTableMappingEntryMap, model_common_ColumnMapping, StringToColumnMappingEntryMap, model_table_Table, Column, TableConstraint, model_table_TableConstraint, model_table_PrimaryKeyTableConstraint, IndexedColumn, table_model_Database, model_table_CheckTableConstraint, Expression, model_table_ForeignKeyTableConstraint, model_column_Column, model_table_UniqueTableConstraint, ColumnConstraint, model_column_IndexedColumn, model_column_ColumnConstraint, model_column_CheckColumnConstraint, model_column_DefaultValueColumnConstraint, model_column_DefaultExpressionValueColumnConstraint, model_column_DefaultStringValueColumnConstraint, model_column_DefaultIntegerValueColumnConstraint, model_column_DefaultRealValueColumnConstraint, model_column_PrimaryKeyColumnConstraint, model_column_NotNullColumnConstraint, model_column_UniqueColumnConstraint, model_index_Index, index_model_Database, model_trigger_Trigger, trigger_model_Database, model_expression_Expression, model_view_View, view_model_Database, DataType},
    associations={versions0, database1, previousVersion4, nextVersion6, tables12, tableMapping8, columnMapping10, triggers15, indexes17, views13, prev2entryMap19, curr2entryMap20, prev2entryMap23, curr2entryMap24, columns28, constraints29, table31, columns33, database27, expression36, columns37, foreignTable39, foreignColumns42, columns34, constraints47, column48, column50, table45, expression53, database55, database57, database59},
    generalizations={gen_model_Database_NameProvider, gen_model_table_PrimaryKeyTableConstraint_TableConstraint, gen_model_table_Table_NameProvider, gen_model_table_CheckTableConstraint_TableConstraint, gen_model_table_ForeignKeyTableConstraint_TableConstraint, gen_model_column_Column_NameProvider, gen_model_table_UniqueTableConstraint_TableConstraint, gen_model_column_CheckColumnConstraint_ColumnConstraint, gen_model_column_DefaultValueColumnConstraint_ColumnConstraint, gen_model_column_PrimaryKeyColumnConstraint_ColumnConstraint, gen_model_column_NotNullColumnConstraint_ColumnConstraint, gen_model_column_UniqueColumnConstraint_ColumnConstraint, gen_model_trigger_Trigger_NameProvider, gen_model_view_View_NameProvider},
    metadata=None
)
