...
class model_common_TableMapping:
    ...
    def __init__(self, model_common_TableMapping: set["StringToTableMappingEntryMap"] = None, model_common_TableMapping21: set["StringToTableMappingEntryMap"] = None):
...
class model_column_Column(NameProvider):
    ...
    def __init__(self, type: str, column: set["ColumnConstraint"] = None, columns: "Table" = None):
        self.type = type
