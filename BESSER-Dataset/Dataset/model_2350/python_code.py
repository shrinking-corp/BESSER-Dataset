...
class simplerdbms_Column(RModelElement):
    ...
    def __init__(self, type: str, Column14: "simplerdbms_Key" = None, Column18: "simplerdbms_Table" = None, column: "simplerdbms_Table" = None, column2: set["simplerdbms_ForeignKey"] = None, column4: set["simplerdbms_Key"] = None, Column: "simplerdbms_ForeignKey" = None):
        self.type = type
