...
domain_model = DomainModel(
    name="simplerdbms",
    types={simplerdbms_Column, RModelElement, simplerdbms_Table, simplerdbms_ForeignKey, simplerdbms_Key, simplerdbms_Schema, simplerdbms_RModelElement},
    associations={owner0, foreignKeys1, key3, refersTo5, column6, owner7, schema9, owner11, column13, tables15, column17, schema19, theKey20},
