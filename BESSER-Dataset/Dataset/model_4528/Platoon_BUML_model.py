...
# Classes
platoon_Model = Class(name="platoon_Model")
...
platoon_LV = Class(name="platoon_LV")
platoon_FV = Class(name="platoon_FV")
platoon_Action = Class(name="platoon_Action")
platoon_Turn = Class(name="platoon_Turn")
Action = Class(name="Action")
platoon_Forward = Class(name="platoon_Forward")
platoon_Left = Class(name="platoon_Left")
Turn = Class(name="Turn")
platoon_Right = Class(name="platoon_Right")
Vehicle = Class(name="Vehicle")
platoon_Vehicle = Class(name="platoon_Vehicle")
...
domain_model = DomainModel(
    name="platoon",
    types={platoon_Model, platoon_Platoon, platoon_Route, platoon_Constraints, platoon_LV, platoon_FV, platoon_Action, platoon_Turn, Action, platoon_Forward, platoon_Left, Turn, platoon_Right, Vehicle, platoon_Vehicle},
    associations={platoons0, routes1, constraints3, first5, followers7, actions14, pulledBy9, route11},
    generalizations={gen_platoon_Turn_Action, gen_platoon_Forward_Action, gen_platoon_Left_Turn, gen_platoon_Right_Turn, gen_platoon_FV_Vehicle, gen_platoon_LV_Vehicle},
    metadata=None
)
