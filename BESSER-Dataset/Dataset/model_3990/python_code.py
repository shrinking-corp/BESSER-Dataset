...
class xpdl_ExternalReferenceType(XpdlTypeType):
    ...
    def __init__(self, namespace: str, xref: str, location: str, xpdl_ExternalReferenceType31: "xpdl_TypeDeclarationType" = None, xpdl_ExternalReferenceType: "xpdl_DataTypeType" = None):
