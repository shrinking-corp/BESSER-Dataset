...
xpdl_ExternalReferenceType.attributes={xpdl_ExternalReferenceType_location, xpdl_ExternalReferenceType_xref, xpdl_ExternalReferenceType_namespace}
...
xpdl_ExternalPackage.attributes={xpdl_ExternalPackage_name, xpdl_ExternalPackage_href, xpdl_ExternalPackage_id}
...
xpdl_ExtendedAttributeType.attributes={xpdl_ExtendedAttributeType_any, xpdl_ExtendedAttributeType_group, xpdl_ExtendedAttributeType_name, xpdl_ExtendedAttributeType_value, xpdl_ExtendedAttributeType_mixed}
...
xpdl_FormalParameterType.attributes={xpdl_FormalParameterType_id, xpdl_FormalParameterType_description, xpdl_FormalParameterType_mode, xpdl_FormalParameterType_name}
...
xpdl_TypeDeclarationType.attributes={xpdl_TypeDeclarationType_description, xpdl_TypeDeclarationType_name, xpdl_TypeDeclarationType_id}
...
domain_model = DomainModel(
    name="xpdl",
    types={xpdl_BasicTypeType, XpdlTypeType, xpdl_DataTypeType, xpdl_DeclaredTypeType, xpdl_SchemaTypeType, xpdl_ExternalReferenceType, ExtendedAnnotationType, xpdl_Extensible, xpdl_ExternalPackages, xpdl_ExternalPackage, Extensible, xpdl_ExtendedAttributesType, xpdl_ExtendedAttributeType, xpdl_FormalParametersType, xpdl_FormalParameterType, xpdl_XSDSchema, xpdl_TypeDeclarationsType, xpdl_TypeDeclarationType, xpdl_ScriptType, xpdl_XpdlTypeType, xpdl_extensions_ExtendedAnnotationType, XSDAnnotation, ModeType, TypeType},
    associations={basicType0, declaredType1, schemaType3, externalReference5, extendedAnnotation8, extendedAttributes10, externalPackage12, extendedAttribute7, formalParameter13, dataType14, schema17, typeDeclaration19, basicType20, declaredType23, schemaType26, externalReference29},
    generalizations={gen_xpdl_BasicTypeType_XpdlTypeType, gen_xpdl_ExternalPackage_Extensible, gen_xpdl_DeclaredTypeType_XpdlTypeType, gen_xpdl_SchemaTypeType_XpdlTypeType, gen_xpdl_ExternalReferenceType_XpdlTypeType, gen_xpdl_TypeDeclarationType_Extensible, gen_xpdl_extensions_ExtendedAnnotationType_XSDAnnotation},
    metadata=None
)
