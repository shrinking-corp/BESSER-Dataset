...
class RefOntoUML_DataType(Classifier):
    ...
    def createOwnedOperation(self, RefOntoUML_returnType, RefOntoUML_parameterNames, RefOntoUML_parameterTypes, RefOntoUML_name):
        # TODO: Implement createOwnedOperation method
        pass

    def createOwnedAttribute(self, RefOntoUML_name, RefOntoUML_upper, RefOntoUML_lower, RefOntoUML_type) :
...
class RefOntoUML_Class(Classifier):
    ...
    def createOwnedOperation(self, RefOntoUML_parameterTypes, RefOntoUML_parameterNames, RefOntoUML_returnType, RefOntoUML_name):
        # TODO: Implement createOwnedOperation method
        pass

class RefOntoUML_Property(StructuralFeature):

    def __init__(self, isDerived: str, isDerivedUnion: str, default: str, aggregation: str, isComposite: str, memberEnd: "RefOntoUML_Association" = None, Property125: "RefOntoUML_Class" = None, Property127: "RefOntoUML_DataType" = None, Property: "RefOntoUML_Association" = None, Property60: "RefOntoUML_Association" = None, RefOntoUML_Property: "RefOntoUML_Association" = None, RefOntoUML_Property78: "RefOntoUML_Classifier" = None, RefOntoUML_Property106: "RefOntoUML_Property" = None, RefOntoUML_Property104: set["RefOntoUML_Property"] = None, ownedEnd: "RefOntoUML_Association" = None, RefOntoUML_Property109: "RefOntoUML_ValueSpecification" = None, RefOntoUML_Property113: "RefOntoUML_Property" = None, RefOntoUML_Property111: "RefOntoUML_Property" = None, ownedAttribute: "RefOntoUML_Class" = None, ownedAttribute103: "RefOntoUML_DataType" = None, RefOntoUML_Property116: "RefOntoUML_Property" = None, RefOntoUML_Property114: set["RefOntoUML_Property"] = None):
...
class RefOntoUML_Association(Classifier, Relationship):
    ...
    def __init__(self, isDerived: str, Association118: "RefOntoUML_Property" = None, owningAssociation: set["RefOntoUML_Property"] = None, association: set["RefOntoUML_Property"] = None, RefOntoUML_Association: set["RefOntoUML_Type"] = None, RefOntoUML_Association64: set["RefOntoUML_Property"] = None, Association: "RefOntoUML_Property" = None):
        self.isDerived = isDerived
...
class RefOntoUML_Namespace(NamedElement):
    ...
    def __init__(self, RefOntoUML_Namespace37: set["RefOntoUML_PackageableElement"] = None, namespace: set["RefOntoUML_NamedElement"] = None, importingNamespace: set["RefOntoUML_ElementImport"] = None, importingNamespace32: set["RefOntoUML_PackageImport"] = None, context: set["RefOntoUML_Constraintx"] = None, RefOntoUML_Namespace: set["RefOntoUML_NamedElement"] = None, Namespace48: "RefOntoUML_PackageImport" = None, Namespace44: "RefOntoUML_ElementImport" = None, Namespace: "RefOntoUML_NamedElement" = None, Namespace54: "RefOntoUML_Constraintx" = None):
...
class RefOntoUML_Constraintx(PackageableElement):
    ...
    def not_applied_to_self(self, RefOntoUML_diagnostics, RefOntoUML_context) :
...
class RefOntoUML_Type(PackageableElement):
    ...
    def __init__(self, Type: "RefOntoUML_Package" = None, ownedType: "RefOntoUML_Package" = None, RefOntoUML_Type: "RefOntoUML_TypedElement" = None, RefOntoUML_Type62: "RefOntoUML_Association" = None):
        self.Type = Type
    ...
    def createAssociation(self, RefOntoUML_end1Upper, RefOntoUML_end1IsNavigable, RefOntoUML_end2Name, RefOntoUML_end2Lower, RefOntoUML_end1Aggregation, RefOntoUML_end2Upper, RefOntoUML_end1Name, RefOntoUML_end1Lower, RefOntoUML_end2IsNavigable, RefOntoUML_end2Aggregation, RefOntoUML_end1Type) :
...
class RefOntoUML_NamedElement(Element):
    ...
    def __init__(self, name: str, visibility: str, qualifiedName: str, NamedElement40: "RefOntoUML_Namespace" = None, RefOntoUML_NamedElement35: "RefOntoUML_Namespace" = None, RefOntoUML_NamedElement21: "RefOntoUML_Dependency" = None, client: set["RefOntoUML_Dependency"] = None, ownedMember: "RefOntoUML_Namespace" = None, RefOntoUML_NamedElement: "RefOntoUML_StringExpression" = None, NamedElement: "RefOntoUML_Dependency" = None, RefOntoUML_NamedElement69: "RefOntoUML_Classifier" = None):
        self.name = name
        self.visibility = visibility
