...
FlatQVT_Element_m_set: Method = Method(name="set", parameters={Parameter(name='FlatQVT_property', type=StringType), Parameter(name='FlatQVT_object', type=StringType)})
FlatQVT_Element_m_unset: Method = Method(name="unset", parameters={Parameter(name='FlatQVT_property', type=StringType)})
FlatQVT_Element.methods={FlatQVT_Element_m_unset, FlatQVT_Element_m_getMetaClass, FlatQVT_Element_m_isSet, FlatQVT_Element_m_equals, FlatQVT_Element_m_set, FlatQVT_Element_m_container, FlatQVT_Element_m_get}
...
FlatQVT_Factory.methods={FlatQVT_Factory_m_create, FlatQVT_Factory_m_createFromString, FlatQVT_Factory_m_convertToString}
...
FlatQVT_MultiplicityElement.attributes={FlatQVT_MultiplicityElement_isUnique, FlatQVT_MultiplicityElement_upper, FlatQVT_MultiplicityElement_lower, FlatQVT_MultiplicityElement_isOrdered}
...
FlatQVT_Property.attributes={FlatQVT_Property_default, FlatQVT_Property_isID, FlatQVT_Property_isReadOnly, FlatQVT_Property_isDerived, FlatQVT_Property_isComposite}
...
FlatQVT_ReflectiveCollection.methods={FlatQVT_ReflectiveCollection_m_clear, FlatQVT_ReflectiveCollection_m_size, FlatQVT_ReflectiveCollection_m_add, FlatQVT_ReflectiveCollection_m_remove, FlatQVT_ReflectiveCollection_m_addAll}
...
FlatQVT_ReflectiveSequence.methods={FlatQVT_ReflectiveSequence_m_set, FlatQVT_ReflectiveSequence_m_get, FlatQVT_ReflectiveSequence_m_add, FlatQVT_ReflectiveSequence_m_remove}
...
FlatQVT_URIExtent.methods={FlatQVT_URIExtent_m_contextURI, FlatQVT_URIExtent_m_element, FlatQVT_URIExtent_m_uri}
...
domain_model = DomainModel(
    name="FlatQVT",
    types={LogExp, FlatQVT_AssignExp, FlatQVT_AltExp, ImperativeExpression, OclExpression, FlatQVT_AnyType, Type, FlatQVT_Area, BottomPattern, GuardPattern, FlatQVT_AssertExp, RealizedVariable, FlatQVT_BreakExp, FlatQVT_CallExp, FlatQVT_CatchExp, FlatQVT_Assignment, Element, FlatQVT_BagType, CollectionType, FlatQVT_BlockExp, FlatQVT_BooleanLiteralExp, PrimitiveLiteralExp, FlatQVT_BottomPattern, CorePattern, Area, Assignment, EnforcementOperation, FlatQVT_CollectionRange, FlatQVT_CollectionTemplateExp, TemplateExp, FlatQVT_Class, Property_, Operation, Class_, FlatQVT_CollectionItem, CollectionLiteralPart, FlatQVT_CollectionLiteralExp, LiteralExp, FlatQVT_CollectionLiteralPart, TypedElement, CollectionLiteralExp, FlatQVT_Constructor, ImperativeOperation, FlatQVT_ConstructorBody, OperationBody, FlatQVT_ContextualProperty, FlatQVT_ContinueExp, Variable, FlatQVT_CoreDomain, Domain, FlatQVT_CorePattern, Pattern, FlatQVT_CollectionType, DataType, FlatQVT_DataType, FlatQVT_Comment, FlatQVT_DictLiteralExp, NamedElement, FlatQVT_ComputeExp, FlatQVT_DictionaryType, FlatQVT_Domain, Rule, TypedModel, FlatQVT_DomainPattern, FlatQVT_Element, Object, DictLiteralPart, FlatQVT_DictLiteralPart, OperationCallExp, FlatQVT_EntryOperation, FlatQVT_EnumLiteralExp, EnumerationLiteral, FlatQVT_Enumeration, FlatQVT_EnumerationLiteral, Enumeration_, FlatQVT_ExpressionInOcl, Comment, FlatQVT_EnforcementOperation, Package, FlatQVT_FeatureCallExp, CallExp, FlatQVT_ForExp, ImperativeLoopExp, FlatQVT_Function, FlatQVT_FunctionParameter, Parameter_, FlatQVT_GuardPattern, FlatQVT_Helper, FlatQVT_IfExp, FlatQVT_Extent, FlatQVT_Factory, FlatQVT_ImperativeIterateExp, FlatQVT_ImperativeLoopExp, LoopExp, FlatQVT_ImperativeOperation, VarParameter, FlatQVT_InstantiationExp, FlatQVT_ImperativeCallExp, FlatQVT_ImperativeExpression, FlatQVT_IteratorExp, FlatQVT_Key, RelationalTransformation, FlatQVT_LetExp, FlatQVT_Library, Module, FlatQVT_ListLiteralExp, FlatQVT_IntegerLiteralExp, NumericLiteralExp, FlatQVT_InvalidLiteralExp, FlatQVT_InvalidType, FlatQVT_IterateExp, FlatQVT_Mapping, Mapping, FlatQVT_MappingBody, FlatQVT_ListType, FlatQVT_LiteralExp, FlatQVT_LogExp, FlatQVT_LoopExp, Relation, FlatQVT_MappingParameter, ModelParameter, RelationDomain, FlatQVT_ModelParameter, FlatQVT_ModelType, FlatQVT_MappingCallExp, ImperativeCallExp, FlatQVT_MappingOperation, MappingOperation, Tag, ModelType, FlatQVT_ModuleImport, FlatQVT_MultiplicityElement, FlatQVT_NamedElement, FlatQVT_NavigationCallExp, FeatureCallExp, FlatQVT_Module, EntryOperation, ModuleImport, PropertyTemplateItem, FlatQVT_OclExpression, FlatQVT_Operation, MultiplicityElement, FlatQVT_OperationBody, FlatQVT_OperationCallExp, FlatQVT_NullLiteralExp, FlatQVT_NumericLiteralExp, FlatQVT_Object, FlatQVT_ObjectExp, InstantiationExp, ConstructorBody, FlatQVT_ObjectTemplateExp, FlatQVT_OppositePropertyCallExp, PropertyCallExp, FlatQVT_OrderedSetType, FlatQVT_OrderedTupleLiteralExp, OrderedTupleLiteralPart, FlatQVT_OrderedTupleLiteralPart, FlatQVT_OrderedTupleType, FlatQVT_OperationalTransformation, FlatQVT_Pattern, Predicate, FlatQVT_Predicate, FlatQVT_PrimitiveLiteralExp, FlatQVT_PrimitiveType, FlatQVT_Property, FlatQVT_Package, FlatQVT_Parameter, FlatQVT_PropertyTemplateItem, ObjectTemplateExp, FlatQVT_RaiseExp, FlatQVT_RealLiteralExp, FlatQVT_RealizedVariable, FlatQVT_ReflectiveCollection, FlatQVT_PropertyAssignment, FlatQVT_PropertyCallExp, NavigationCallExp, FlatQVT_Relation, RelationImplementation, FlatQVT_RelationCallExp, FlatQVT_ReflectiveSequence, ReflectiveCollection, FlatQVT_RelationDomainAssignment, FlatQVT_RelationImplementation, FlatQVT_RelationalTransformation, Transformation, Key, FlatQVT_ResolveExp, FlatQVT_RelationDomain, RelationDomainAssignment, DomainPattern, FlatQVT_ReturnExp, FlatQVT_Rule, FlatQVT_SequenceType, FlatQVT_SetType, FlatQVT_ResolveInExp, ResolveExp, FlatQVT_Tag, FlatQVT_TemplateExp, FlatQVT_StringLiteralExp, FlatQVT_SwitchExp, AltExp, FlatQVT_TryExp, CatchExp, FlatQVT_TupleLiteralExp, TupleLiteralPart, FlatQVT_TupleLiteralPart, FlatQVT_TemplateParameterType, FlatQVT_Transformation, FlatQVT_TypeExp, FlatQVT_TypedElement, FlatQVT_TypedModel, FlatQVT_Typedef, TupleLiteralExp, FlatQVT_TupleType, FlatQVT_Type, FlatQVT_UnlinkExp, FlatQVT_UnpackExp, FlatQVT_VarParameter, FlatQVT_URIExtent, Extent, FlatQVT_UnlimitedNaturalExp, FlatQVT_VariableExp, FlatQVT_VariableInitExp, FlatQVT_VoidType, FlatQVT_WhileExp, FlatQVT_Variable, LetExp, FlatQVT_VariableAssignment, CollectionKind, DirectionKind, EnforcementMode, ImportKind, SeverityKind},
    associations={log9, defaultValue11, left13, body0, condition1, bottomPattern4, guardPattern5, assertion7, realizedVariable31, source33, body35, value16, bottomPattern19, value21, body24, area26, assignment27, enforcementOperation29, collectionLiteralExp47, first48, last50, exception37, ownedAttribute39, ownedOperation40, superClass42, item44, part46, context67, initExpression69, member53, overridden72, referredCollectionType55, rest57, variable75, elementType59, annotatedElement61, body62, returnedElement64, keyType83, rule85, typedModel86, templateExpression88, part77, key78, value80, operationCallExp92, referredEnumLiteral94, ownedLiteral95, enumeration97, bodyExpression98, contextVariable100, generatedType103, ownedComment89, bottomPattern90, package112, queryExpression113, area115, condition117, elseExpression119, parameterVariable106, resultVariable109, target125, condition127, body129, context130, overridden132, result134, argument137, thenExpression122, result145, identifies147, oppositePart149, part152, transformation155, in_157, variable159, element162, extent139, instantiatedClass142, body166, iterator168, context171, local172, refinement175, specification178, endSection181, initSection183, condition164, merged190, refinedRelation193, when195, where198, extent201, referredDomain202, additionalCondition204, disjunct186, inherited187, moduleImport213, ownedTag215, ownedVariable217, usedModelType220, binding222, importedModule224, module226, metamodel206, configProperty209, entry211, part233, referredClass234, class_237, ownedParameter239, raisedException241, content244, operation246, variable249, body229, referredObject230, intermediateProperty259, modelParameter262, refined265, relation268, part271, value272, elementType274, argument252, referredOperation254, intermediateClass257, operation284, bindsTo286, predicate288, conditionExpression290, pattern292, class_294, nestedPackage276, nestingPackage278, ownedType281, objContainer306, referredProperty307, value310, argument313, exception315, opposite296, slotExpression299, targetProperty301, referredProperty304, operationalImpl318, variable319, when322, where325, argument328, rootVariable336, valueExp339, variable341, impl344, inDirectionOf346, relation349, ownedKey352, condition353, referredRelation330, defaultAssignment333, pattern334, value360, domain362, overrides363, transformation366, target355, inMapping358, element372, bindsTo373, where375, alternativePart368, elsePart369, modelParameter380, ownedTag383, rule386, exceptClause389, tryBody390, part393, extends378, package401, referredType403, type405, dependsOn407, transformation409, usedPackage412, base415, attribute394, tupleLiteralExp396, value398, item420, target422, source425, targetVariable427, ctxOwner430, resOwner432, condition417, referredVariable444, referredVariable446, body448, condition450, initExpression435, letExp437, representedParameter439, targetVariable442},
    generalizations={gen_FlatQVT_AssignExp_ImperativeExpression, gen_FlatQVT_AltExp_ImperativeExpression, gen_FlatQVT_AnyType_Type, gen_FlatQVT_AssertExp_ImperativeExpression, gen_FlatQVT_BreakExp_ImperativeExpression, gen_FlatQVT_CallExp_OclExpression, gen_FlatQVT_CatchExp_ImperativeExpression, gen_FlatQVT_Assignment_Element, gen_FlatQVT_BagType_CollectionType, gen_FlatQVT_BlockExp_ImperativeExpression, gen_FlatQVT_BooleanLiteralExp_PrimitiveLiteralExp, gen_FlatQVT_BottomPattern_CorePattern, gen_FlatQVT_CollectionRange_CollectionLiteralPart, gen_FlatQVT_CollectionTemplateExp_TemplateExp, gen_FlatQVT_Class_Type, gen_FlatQVT_CollectionItem_CollectionLiteralPart, gen_FlatQVT_CollectionLiteralExp_LiteralExp, gen_FlatQVT_CollectionLiteralPart_TypedElement, gen_FlatQVT_Constructor_ImperativeOperation, gen_FlatQVT_ConstructorBody_OperationBody, gen_FlatQVT_ContextualProperty_Property, gen_FlatQVT_ContinueExp_ImperativeExpression, gen_FlatQVT_CoreDomain_Domain, gen_FlatQVT_CoreDomain_Area, gen_FlatQVT_CorePattern_Pattern, gen_FlatQVT_CollectionType_DataType, gen_FlatQVT_DataType_Type, gen_FlatQVT_Comment_Element, gen_FlatQVT_DictLiteralExp_LiteralExp, gen_FlatQVT_ComputeExp_ImperativeExpression, gen_FlatQVT_DictionaryType_CollectionType, gen_FlatQVT_Domain_NamedElement, gen_FlatQVT_DomainPattern_Pattern, gen_FlatQVT_Element_Object, gen_FlatQVT_DictLiteralPart_Element, gen_FlatQVT_EntryOperation_ImperativeOperation, gen_FlatQVT_EnumLiteralExp_LiteralExp, gen_FlatQVT_Enumeration_DataType, gen_FlatQVT_EnumerationLiteral_NamedElement, gen_FlatQVT_ExpressionInOcl_TypedElement, gen_FlatQVT_EnforcementOperation_Element, gen_FlatQVT_FeatureCallExp_CallExp, gen_FlatQVT_ForExp_ImperativeLoopExp, gen_FlatQVT_Function_Operation, gen_FlatQVT_FunctionParameter_Variable, gen_FlatQVT_FunctionParameter_Parameter, gen_FlatQVT_GuardPattern_CorePattern, gen_FlatQVT_Helper_ImperativeOperation, gen_FlatQVT_IfExp_OclExpression, gen_FlatQVT_Extent_Object, gen_FlatQVT_Factory_Element, gen_FlatQVT_ImperativeIterateExp_ImperativeLoopExp, gen_FlatQVT_ImperativeLoopExp_LoopExp, gen_FlatQVT_ImperativeLoopExp_ImperativeExpression, gen_FlatQVT_ImperativeOperation_Operation, gen_FlatQVT_InstantiationExp_ImperativeExpression, gen_FlatQVT_ImperativeCallExp_OperationCallExp, gen_FlatQVT_ImperativeCallExp_ImperativeExpression, gen_FlatQVT_ImperativeExpression_OclExpression, gen_FlatQVT_IteratorExp_LoopExp, gen_FlatQVT_Key_Element, gen_FlatQVT_LetExp_OclExpression, gen_FlatQVT_Library_Module, gen_FlatQVT_ListLiteralExp_LiteralExp, gen_FlatQVT_IntegerLiteralExp_NumericLiteralExp, gen_FlatQVT_InvalidLiteralExp_LiteralExp, gen_FlatQVT_InvalidType_Type, gen_FlatQVT_IterateExp_LoopExp, gen_FlatQVT_Mapping_Rule, gen_FlatQVT_Mapping_Area, gen_FlatQVT_MappingBody_OperationBody, gen_FlatQVT_ListType_CollectionType, gen_FlatQVT_LiteralExp_OclExpression, gen_FlatQVT_LogExp_OperationCallExp, gen_FlatQVT_LogExp_ImperativeExpression, gen_FlatQVT_LoopExp_CallExp, gen_FlatQVT_LoopExp_OclExpression, gen_FlatQVT_MappingParameter_VarParameter, gen_FlatQVT_ModelParameter_VarParameter, gen_FlatQVT_ModelType_Class, gen_FlatQVT_MappingCallExp_ImperativeCallExp, gen_FlatQVT_MappingOperation_ImperativeOperation, gen_FlatQVT_ModuleImport_Element, gen_FlatQVT_NamedElement_Element, gen_FlatQVT_NavigationCallExp_FeatureCallExp, gen_FlatQVT_Module_Class, gen_FlatQVT_Module_Package, gen_FlatQVT_OclExpression_TypedElement, gen_FlatQVT_Operation_TypedElement, gen_FlatQVT_Operation_MultiplicityElement, gen_FlatQVT_OperationBody_Element, gen_FlatQVT_NullLiteralExp_LiteralExp, gen_FlatQVT_NumericLiteralExp_PrimitiveLiteralExp, gen_FlatQVT_ObjectExp_InstantiationExp, gen_FlatQVT_ObjectTemplateExp_TemplateExp, gen_FlatQVT_OppositePropertyCallExp_PropertyCallExp, gen_FlatQVT_OrderedSetType_CollectionType, gen_FlatQVT_OrderedTupleLiteralExp_LiteralExp, gen_FlatQVT_OrderedTupleLiteralPart_Element, gen_FlatQVT_OrderedTupleType_Class, gen_FlatQVT_OperationCallExp_FeatureCallExp, gen_FlatQVT_OperationalTransformation_Module, gen_FlatQVT_Pattern_Element, gen_FlatQVT_Predicate_Element, gen_FlatQVT_PrimitiveLiteralExp_LiteralExp, gen_FlatQVT_PrimitiveType_DataType, gen_FlatQVT_Property_TypedElement, gen_FlatQVT_Property_MultiplicityElement, gen_FlatQVT_Package_NamedElement, gen_FlatQVT_Parameter_TypedElement, gen_FlatQVT_Parameter_MultiplicityElement, gen_FlatQVT_PropertyTemplateItem_Element, gen_FlatQVT_RaiseExp_ImperativeExpression, gen_FlatQVT_RealLiteralExp_NumericLiteralExp, gen_FlatQVT_RealizedVariable_Variable, gen_FlatQVT_PropertyAssignment_Assignment, gen_FlatQVT_PropertyCallExp_NavigationCallExp, gen_FlatQVT_Relation_Rule, gen_FlatQVT_RelationCallExp_OclExpression, gen_FlatQVT_ReflectiveCollection_Object, gen_FlatQVT_ReflectiveSequence_ReflectiveCollection, gen_FlatQVT_RelationDomainAssignment_Element, gen_FlatQVT_RelationImplementation_Element, gen_FlatQVT_RelationalTransformation_Transformation, gen_FlatQVT_ResolveExp_CallExp, gen_FlatQVT_ResolveExp_ImperativeExpression, gen_FlatQVT_RelationDomain_Domain, gen_FlatQVT_ReturnExp_ImperativeExpression, gen_FlatQVT_Rule_NamedElement, gen_FlatQVT_SequenceType_CollectionType, gen_FlatQVT_SetType_CollectionType, gen_FlatQVT_ResolveInExp_ResolveExp, gen_FlatQVT_Tag_Element, gen_FlatQVT_TemplateExp_LiteralExp, gen_FlatQVT_StringLiteralExp_PrimitiveLiteralExp, gen_FlatQVT_SwitchExp_ImperativeExpression, gen_FlatQVT_TryExp_ImperativeExpression, gen_FlatQVT_TupleLiteralExp_LiteralExp, gen_FlatQVT_TupleLiteralPart_TypedElement, gen_FlatQVT_TemplateParameterType_Type, gen_FlatQVT_Transformation_Class, gen_FlatQVT_Transformation_Package, gen_FlatQVT_TypeExp_OclExpression, gen_FlatQVT_TypedElement_NamedElement, gen_FlatQVT_TypedModel_NamedElement, gen_FlatQVT_Typedef_Class, gen_FlatQVT_TupleType_Class, gen_FlatQVT_TupleType_DataType, gen_FlatQVT_Type_NamedElement, gen_FlatQVT_UnlinkExp_ImperativeExpression, gen_FlatQVT_UnpackExp_ImperativeExpression, gen_FlatQVT_VarParameter_Variable, gen_FlatQVT_VarParameter_Parameter, gen_FlatQVT_URIExtent_Extent, gen_FlatQVT_UnlimitedNaturalExp_NumericLiteralExp, gen_FlatQVT_VariableExp_OclExpression, gen_FlatQVT_VariableInitExp_ImperativeExpression, gen_FlatQVT_VoidType_Type, gen_FlatQVT_WhileExp_ImperativeExpression, gen_FlatQVT_Variable_TypedElement, gen_FlatQVT_VariableAssignment_Assignment},
    metadata=None
)
