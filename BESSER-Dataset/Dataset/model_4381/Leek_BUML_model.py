...
# Classes
leek_Statement = Class(name="leek_Statement")
leek_BreakStatement = Class(name="leek_BreakStatement")
Statement = Class(name="Statement")
leek_ContinueStatement = Class(name="leek_ContinueStatement")
leek_StatementBlock = Class(name="leek_StatementBlock")
leek_AffectationStatement = Class(name="leek_AffectationStatement")
leek_Affectation = Class(name="leek_Affectation")
...
leek_VariableReference = Class(name="leek_VariableReference")
leek_AffectationDecrement = Class(name="leek_AffectationDecrement")
leek_Expression = Class(name="leek_Expression")
leek_AffectationIncrement = Class(name="leek_AffectationIncrement")
leek_AffectationPostfixStatement = Class(name="leek_AffectationPostfixStatement")
leek_AffectationPrefixStatement = Class(name="leek_AffectationPrefixStatement")
leek_If = Class(name="leek_If")
leek_IfCondition = Class(name="leek_IfCondition")
leek_Iteration = Class(name="leek_Iteration")
leek_While = Class(name="leek_While")
Iteration = Class(name="Iteration")
leek_For = Class(name="leek_For")
leek_ForInitializer = Class(name="leek_ForInitializer")
leek_Script = Class(name="leek_Script")
leek_ForAffectation = Class(name="leek_ForAffectation")
leek_ForIn = Class(name="leek_ForIn")
leek_ForInVariableReference = Class(name="leek_ForInVariableReference")
leek_FunctionDeclaration = Class(name="leek_FunctionDeclaration")
Expression = Class(name="Expression")
leek_VariableDeclaration = Class(name="leek_VariableDeclaration")
ForInVariableReference = Class(name="ForInVariableReference")
leek_LocalDeclaration = Class(name="leek_LocalDeclaration")
leek_GlobalDeclaration = Class(name="leek_GlobalDeclaration")
leek_ArrayLiteral = Class(name="leek_ArrayLiteral")
leek_Postfix = Class(name="leek_Postfix")
leek_Prefix = Class(name="leek_Prefix")
AffectationPostfixStatement = Class(name="AffectationPostfixStatement")
Postfix = Class(name="Postfix")
leek_FunctionCall = Class(name="leek_FunctionCall")
leek_ReturnStatement = Class(name="leek_ReturnStatement")
leek_Include = Class(name="leek_Include")
leek_EmptyStatement = Class(name="leek_EmptyStatement")
leek_PostfixDecrement = Class(name="leek_PostfixDecrement")
leek_PostfixIncrement = Class(name="leek_PostfixIncrement")
leek_PrefixDecrement = Class(name="leek_PrefixDecrement")
AffectationPrefixStatement = Class(name="AffectationPrefixStatement")
Prefix = Class(name="Prefix")
leek_PrefixIncrement = Class(name="leek_PrefixIncrement")
leek_Comparison = Class(name="leek_Comparison")
leek_Equals = Class(name="leek_Equals")
leek_TypedDifferent = Class(name="leek_TypedDifferent")
leek_Different = Class(name="leek_Different")
leek_LessOrEquals = Class(name="leek_LessOrEquals")
leek_Less = Class(name="leek_Less")
leek_MoreOrEquals = Class(name="leek_MoreOrEquals")
leek_More = Class(name="leek_More")
leek_Or = Class(name="leek_Or")
leek_And = Class(name="leek_And")
leek_Plus = Class(name="leek_Plus")
leek_Minus = Class(name="leek_Minus")
leek_Div = Class(name="leek_Div")
leek_TernaryIf = Class(name="leek_TernaryIf")
leek_UnitaryMinus = Class(name="leek_UnitaryMinus")
leek_Not = Class(name="leek_Not")
leek_RealLiteral = Class(name="leek_RealLiteral")
leek_IntLiteral = Class(name="leek_IntLiteral")
leek_StringLiteral = Class(name="leek_StringLiteral")
leek_NullLiteral = Class(name="leek_NullLiteral")
leek_FalseLiteral = Class(name="leek_FalseLiteral")
leek_TrueLiteral = Class(name="leek_TrueLiteral")
leek_Multi = Class(name="leek_Multi")
...
domain_model = DomainModel(
    name="leek",
    types={leek_Statement, leek_BreakStatement, Statement, leek_ContinueStatement, leek_StatementBlock, leek_AffectationStatement, leek_Affectation, AffectationStatement, IfCondition, ForInitializer, ForAffectation, leek_VariableReference, leek_AffectationDecrement, leek_Expression, leek_AffectationIncrement, leek_AffectationPostfixStatement, leek_AffectationPrefixStatement, leek_If, leek_IfCondition, leek_Iteration, leek_While, Iteration, leek_For, leek_ForInitializer, leek_Script, leek_ForAffectation, leek_ForIn, leek_ForInVariableReference, leek_FunctionDeclaration, Expression, leek_VariableDeclaration, ForInVariableReference, leek_LocalDeclaration, leek_GlobalDeclaration, leek_ArrayLiteral, leek_Postfix, leek_Prefix, AffectationPostfixStatement, Postfix, leek_FunctionCall, leek_ReturnStatement, leek_Include, leek_EmptyStatement, leek_PostfixDecrement, leek_PostfixIncrement, leek_PrefixDecrement, AffectationPrefixStatement, Prefix, leek_PrefixIncrement, leek_Comparison, leek_Equals, leek_TypedDifferent, leek_Different, leek_LessOrEquals, leek_Less, leek_MoreOrEquals, leek_More, leek_Or, leek_And, leek_Plus, leek_Minus, leek_Div, leek_TernaryIf, leek_UnitaryMinus, leek_Not, leek_RealLiteral, leek_IntLiteral, leek_StringLiteral, leek_NullLiteral, leek_FalseLiteral, leek_TrueLiteral, leek_Multi},
    associations={statements0, statements1, variable3, variable4, decrement6, variable8, increment10, condition13, then14, else_17, statement20, condition22, initializer24, increment28, key30, value31, array34, value37, parameters40, body41, variables44, variables46, values48, variable50, dimensions53, function56, condition25, value61, value63, value65, right67, right69, left71, right73, left76, right78, left81, right83, left86, right88, left91, args58, left96, right98, left101, right103, left106, right108, left111, right113, left116, right118, left121, right123, left126, right128, left136, right93, right138, left141, then143, else_146, expression149, expression151, left131, right133},
    generalizations={gen_leek_BreakStatement_Statement, gen_leek_ContinueStatement_Statement, gen_leek_StatementBlock_Statement, gen_leek_AffectationStatement_Statement, gen_leek_Affectation_AffectationStatement, gen_leek_Affectation_IfCondition, gen_leek_Affectation_ForInitializer, gen_leek_Affectation_ForAffectation, gen_leek_AffectationDecrement_AffectationStatement, gen_leek_AffectationIncrement_AffectationStatement, gen_leek_AffectationPostfixStatement_AffectationStatement, gen_leek_AffectationPrefixStatement_AffectationStatement, gen_leek_If_Statement, gen_leek_Iteration_Statement, gen_leek_While_Iteration, gen_leek_For_Iteration, gen_leek_ForIn_Iteration, gen_leek_FunctionDeclaration_Statement, gen_leek_FunctionDeclaration_Expression, gen_leek_VariableDeclaration_ForInVariableReference, gen_leek_VariableDeclaration_ForInitializer, gen_leek_LocalDeclaration_Statement, gen_leek_GlobalDeclaration_Statement, gen_leek_Expression_IfCondition, gen_leek_Expression_ForAffectation, gen_leek_ArrayLiteral_Expression, gen_leek_Postfix_Expression, gen_leek_Prefix_Expression, gen_leek_VariableReference_AffectationPostfixStatement, gen_leek_VariableReference_ForInVariableReference, gen_leek_VariableReference_Postfix, gen_leek_FunctionCall_Statement, gen_leek_FunctionCall_Expression, gen_leek_ReturnStatement_Statement, gen_leek_Include_Statement, gen_leek_EmptyStatement_Statement, gen_leek_PostfixDecrement_AffectationPostfixStatement, gen_leek_PostfixDecrement_Postfix, gen_leek_PostfixIncrement_AffectationPostfixStatement, gen_leek_PostfixIncrement_Postfix, gen_leek_PrefixDecrement_AffectationPrefixStatement, gen_leek_PrefixDecrement_Prefix, gen_leek_PrefixIncrement_AffectationPrefixStatement, gen_leek_PrefixIncrement_Prefix, gen_leek_Comparison_Expression, gen_leek_Equals_Expression, gen_leek_TypedDifferent_Expression, gen_leek_Different_Expression, gen_leek_LessOrEquals_Expression, gen_leek_Less_Expression, gen_leek_MoreOrEquals_Expression, gen_leek_More_Expression, gen_leek_Or_Expression, gen_leek_And_Expression, gen_leek_Plus_Expression, gen_leek_Minus_Expression, gen_leek_Div_Expression, gen_leek_TernaryIf_Expression, gen_leek_UnitaryMinus_Expression, gen_leek_Not_Expression, gen_leek_RealLiteral_Expression, gen_leek_IntLiteral_Expression, gen_leek_StringLiteral_Expression, gen_leek_NullLiteral_Expression, gen_leek_FalseLiteral_Expression, gen_leek_TrueLiteral_Expression, gen_leek_Multi_Expression},
    metadata=None
)
