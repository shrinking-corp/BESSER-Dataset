...
class AffectationPrefixStatement:
    ...
    pass
class leek_PrefixIncrement(Prefix, AffectationPrefixStatement):

    pass
class leek_PrefixDecrement(Prefix, AffectationPrefixStatement):
...
class leek_VariableDeclaration(ForInitializer, ForInVariableReference):
    ...
    def __init__(self, byAdress: bool, name: str, leek_VariableDeclaration: "leek_FunctionDeclaration" = None, leek_VariableDeclaration45: "leek_LocalDeclaration" = None, leek_VariableDeclaration47: "leek_GlobalDeclaration" = None, leek_VariableDeclaration52: "leek_VariableReference" = None):
...
class leek_AffectationDecrement(AffectationStatement):
    ...
    pass
class leek_Affectation(ForInitializer, AffectationStatement, ForAffectation, IfCondition):
...
class leek_Iteration(Statement):
    ...
    pass
class leek_FunctionCall(Expression, Statement):
...
class leek_StatementBlock(Statement):
    ...
    pass
class leek_FunctionDeclaration(Expression, Statement):

    def __init__(self, name: str, leek_FunctionDeclaration57: "leek_FunctionCall" = None, leek_FunctionDeclaration: set["leek_VariableDeclaration"] = None, leek_FunctionDeclaration42: "leek_StatementBlock" = None):
        self.name = name
