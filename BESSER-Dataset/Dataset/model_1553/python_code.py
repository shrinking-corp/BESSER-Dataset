...
class model_R4EUserReviews:
    ...
    def __init__(self, name: str, createdReviews: str, model_R4EUserReviews: set["model_MapNameToReview"] = None, model_R4EUserReviews82: "model_R4EReviewGroup" = None, model_R4EUserReviews94: "model_MapUserIDToUserReviews" = None):
        self.name = name
...
class model_R4EContent(Location):
    ...
    def __init__(self, info: str, model_R4EContent: "model_R4EDelta" = None, model_R4EContent64: "model_R4EDelta" = None, model_R4EContent69: "model_R4EPosition" = None):
        self.info = info
...
class model_MapKeyToInfoAttributes:
    ...
    def __init__(self, key: str, value: str, model_MapKeyToInfoAttributes: "model_R4EItem" = None, model_MapKeyToInfoAttributes72: "model_R4EFileVersion" = None, model_MapKeyToInfoAttributes59: "model_R4EFileContext" = None, model_MapKeyToInfoAttributes48: "model_R4EComment" = None):
        self.key = key
        self.value = value
...
class model_R4EFileContext(R4EIDComponent):
    ...
    def __init__(self, type: str, model_R4EFileContext50: set["model_R4EDelta"] = None, model_R4EFileContext52: "model_R4EFileVersion" = None, model_R4EFileContext55: "model_R4EFileVersion" = None, model_R4EFileContext58: set["model_MapKeyToInfoAttributes"] = None, model_R4EFileContext: "model_R4EItem" = None):
        self.type = type
...
class model_R4EID:
    ...
    def __init__(self, sequenceID: int, userID: str, model_R4EID85: "model_R4EIDComponent" = None, model_R4EID88: "model_MapIDToComponent" = None, model_R4EID: "model_R4EParticipant" = None):
...
class model_R4EReviewPhaseInfo:
    ...
    def __init__(self, endDate: date, type: str, phaseOwnerID: str, startDate: date, model_R4EReviewPhaseInfo: "model_R4EFormalReview" = None, model_R4EReviewPhaseInfo27: "model_R4EFormalReview" = None):
...
class model_R4EParticipant(R4EUser):
    ...
    def __init__(self, roles: str, focusArea: str, isPartOfDecision: bool, model_R4EParticipant: "model_R4EFormalReview" = None, model_R4EParticipant36: set["model_R4EID"] = None, model_R4EParticipant38: set["model_MapDateToDuration"] = None):
        self.roles = roles
...
class model_R4EFileVersion:
    ...
    def __init__(self, fileRevision: str, platformURI: str, versionID: str, repositoryPath: str, name: str, resource: str, localVersionID: str, model_R4EFileVersion71: set["model_MapKeyToInfoAttributes"] = None, model_R4EFileVersion53: "model_R4EFileContext" = None, model_R4EFileVersion56: "model_R4EFileContext" = None, model_R4EFileVersion96: "model_R4EAnomalyTextPosition" = None, model_R4EFileVersion: "model_R4EAnomaly" = None):
...
class model_R4EItem(R4EIDComponent, Item):
    ...
    def __init__(self, description: str, addedById: str, repositoryRef: str, ProjectURIs: str, authorRep: str, submitted: date, model_R4EItem42: set["model_MapKeyToInfoAttributes"] = None, model_R4EItem: "model_R4EUser" = None, model_R4EItem40: set["model_R4EFileContext"] = None):
...
class model_MapToUsers:
    ...
    def __init__(self, key: str, model_MapToUsers77: "model_R4EUser" = None, model_MapToUsers: "model_R4EReview" = None):
        self.key = key
...
class model_MapUserIDToUserReviews:
    ...
    def __init__(self, key: str, model_MapUserIDToUserReviews93: "model_R4EUserReviews" = None, model_MapUserIDToUserReviews: "model_R4EReviewGroup" = None):
        self.key = key
...
class model_MapNameToReview:
    ...
    def __init__(self, key: str, model_MapNameToReview74: "model_R4EReview" = None, model_MapNameToReview80: "model_R4EUserReviews" = None, model_MapNameToReview: "model_R4EReviewGroup" = None):
        self.key = key
...
class model_MapToAnomalyType:
    ...
    def __init__(self, key: str, model_MapToAnomalyType66: "model_R4EAnomalyType" = None, model_MapToAnomalyType: "model_R4EReviewGroup" = None):
        self.key = key
...
class model_R4EAnomalyType(CommentType):
    ...
    def __init__(self, type: str, model_R4EAnomalyType67: "model_MapToAnomalyType" = None, model_R4EAnomalyType: "model_R4EReviewGroup" = None):
        self.type = type
...
class R4EReviewComponent:
    ...
    pass
class model_R4EUser(R4EReviewComponent, User):

    def __init__(self, sequenceIDCounter: int, reviewCreatedByMe: bool, groupPaths: str, reviewCompleted: bool, reviewCompletedCode: int, model_R4EUser78: "model_MapToUsers" = None, model_R4EUser: "model_R4EReview" = None, model_R4EUser29: set["model_R4EComment"] = None, model_R4EUser31: set["model_R4EItem"] = None, model_R4EUser33: "model_R4EReview" = None):
...
class model_R4EReview(Review, R4EReviewComponent):

    def __init__(self, name: str, project: str, components: str, entryCriteria: str, extraNotes: str, objectives: str, referenceMaterial: str, startDate: date, endDate: date, dueDate: date, type: str, modifiedDate: date, model_R4EReview75: "model_MapNameToReview" = None, model_R4EReview: "model_R4EReviewDecision" = None, model_R4EReview9: "model_R4EAnomaly" = None, model_R4EReview11: set["model_MapToUsers"] = None, model_R4EReview13: "model_R4EUser" = None, model_R4EReview15: set["model_MapIDToComponent"] = None, model_R4EReview17: "model_R4EMeetingData" = None, model_R4EReview34: "model_R4EUser" = None):
        self.name = name
...
class model_R4ETaskReference(R4EReviewComponent, TaskReference):

    pass
class model_R4EComment(R4EIDComponent, R4EReviewComponent, Comment):

    def __init__(self, createdOn: date, model_R4EComment44: "model_R4EAnomaly" = None, model_R4EComment: "model_R4EUser" = None, model_R4EComment47: set["model_MapKeyToInfoAttributes"] = None):
...
class model_R4EIDComponent(R4EReviewComponent):
    ...
    pass
class model_R4EAnomaly(R4EComment, Topic, R4EReviewComponent):

    def __init__(self, state: str, dueDate: date, rank: str, notAcceptedReason: str, isImported: bool, ruleID: str, decidedByID: str, fixedByID: str, followUpByID: str, model_R4EAnomaly45: "model_R4EComment" = None, model_R4EAnomaly19: "model_R4EDesignRule" = None, model_R4EAnomaly: "model_R4EReview" = None, model_R4EAnomaly21: "model_R4EFileVersion" = None):
        self.state = state
        self.dueDate = dueDate
        self.rank = rank
...
class ReviewGroup:
    ...
    pass
class model_R4EReviewGroup(R4EReviewComponent, ReviewGroup):

    def __init__(self, name: str, folder: str, defaultEntryCriteria: str, availableProjects: str, availableComponents: str, designRuleLocations: str, model_R4EReviewGroup83: "model_R4EUserReviews" = None, model_R4EReviewGroup: set["model_R4EAnomalyType"] = None, model_R4EReviewGroup2: set["model_MapToAnomalyType"] = None, model_R4EReviewGroup4: set["model_MapNameToReview"] = None, model_R4EReviewGroup6: set["model_MapUserIDToUserReviews"] = None):
        self.name = name
        self.folder = folder
