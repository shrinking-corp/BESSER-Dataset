...
# Classes
model_R4EReviewGroup = Class(name="model_R4EReviewGroup")
...
model_R4EDesignRule = Class(name="model_R4EDesignRule")
model_R4EAnomalyType = Class(name="model_R4EAnomalyType")
model_MapToAnomalyType = Class(name="model_MapToAnomalyType")
model_MapNameToReview = Class(name="model_MapNameToReview")
model_MapUserIDToUserReviews = Class(name="model_MapUserIDToUserReviews")
model_R4EReview = Class(name="model_R4EReview")
Review = Class(name="Review")
model_R4EReviewDecision = Class(name="model_R4EReviewDecision")
model_R4EAnomaly = Class(name="model_R4EAnomaly")
model_MapToUsers = Class(name="model_MapToUsers")
model_R4EUser = Class(name="model_R4EUser")
model_MapIDToComponent = Class(name="model_MapIDToComponent")
model_R4EMeetingData = Class(name="model_R4EMeetingData")
model_R4EComment = Class(name="model_R4EComment")
model_R4EItem = Class(name="model_R4EItem")
model_R4EFileVersion = Class(name="model_R4EFileVersion")
model_R4EFormalReview = Class(name="model_R4EFormalReview")
R4EReview = Class(name="R4EReview")
model_R4EParticipant = Class(name="model_R4EParticipant")
model_R4EReviewPhaseInfo = Class(name="model_R4EReviewPhaseInfo")
model_R4ETextPosition = Class(name="model_R4ETextPosition")
R4EPosition = Class(name="R4EPosition")
User = Class(name="User")
model_R4EReviewComponent = Class(name="model_R4EReviewComponent")
ReviewComponent = Class(name="ReviewComponent")
R4EUser = Class(name="R4EUser")
model_R4EID = Class(name="model_R4EID")
model_MapDateToDuration = Class(name="model_MapDateToDuration")
R4EIDComponent = Class(name="R4EIDComponent")
Item = Class(name="Item")
model_R4EFileContext = Class(name="model_R4EFileContext")
model_MapKeyToInfoAttributes = Class(name="model_MapKeyToInfoAttributes")
model_R4ETextContent = Class(name="model_R4ETextContent")
R4EContent = Class(name="R4EContent")
CommentType = Class(name="CommentType")
model_R4ETaskReference = Class(name="model_R4ETaskReference")
TaskReference = Class(name="TaskReference")
model_R4EReviewState = Class(name="model_R4EReviewState")
ReviewState = Class(name="ReviewState")
Comment = Class(name="Comment")
model_R4EDelta = Class(name="model_R4EDelta")
model_R4EContent = Class(name="model_R4EContent", is_abstract=True)
model_R4ECommentType = Class(name="model_R4ECommentType")
Location = Class(name="Location")
model_R4EPosition = Class(name="model_R4EPosition")
model_R4EUserReviews = Class(name="model_R4EUserReviews")
model_R4EIDComponent = Class(name="model_R4EIDComponent")
model_R4EAnomalyTextPosition = Class(name="model_R4EAnomalyTextPosition")
...
model_R4EReviewGroup.attributes={model_R4EReviewGroup_availableComponents, model_R4EReviewGroup_defaultEntryCriteria, model_R4EReviewGroup_availableProjects, model_R4EReviewGroup_name, model_R4EReviewGroup_folder, model_R4EReviewGroup_designRuleLocations}
...
model_R4EReview.attributes={model_R4EReview_project, model_R4EReview_endDate, model_R4EReview_extraNotes, model_R4EReview_name, model_R4EReview_dueDate, model_R4EReview_startDate, model_R4EReview_objectives, model_R4EReview_referenceMaterial, model_R4EReview_modifiedDate, model_R4EReview_type, model_R4EReview_entryCriteria, model_R4EReview_components}
...
model_R4EAnomaly.attributes={model_R4EAnomaly_decidedByID, model_R4EAnomaly_fixedByID, model_R4EAnomaly_followUpByID, model_R4EAnomaly_notAcceptedReason, model_R4EAnomaly_state, model_R4EAnomaly_rank, model_R4EAnomaly_isImported, model_R4EAnomaly_dueDate, model_R4EAnomaly_ruleID}
...
model_R4EUser.attributes={model_R4EUser_groupPaths, model_R4EUser_sequenceIDCounter, model_R4EUser_reviewCreatedByMe, model_R4EUser_reviewCompleted, model_R4EUser_reviewCompletedCode}
...
model_R4EMeetingData.attributes={model_R4EMeetingData_startTime, model_R4EMeetingData_sender, model_R4EMeetingData_subject, model_R4EMeetingData_id, model_R4EMeetingData_sentCount, model_R4EMeetingData_receivers, model_R4EMeetingData_duration, model_R4EMeetingData_body, model_R4EMeetingData_location}
...
model_R4EItem.attributes={model_R4EItem_addedById, model_R4EItem_ProjectURIs, model_R4EItem_description, model_R4EItem_submitted, model_R4EItem_repositoryRef, model_R4EItem_authorRep}
...
model_R4EFileVersion.attributes={model_R4EFileVersion_name, model_R4EFileVersion_platformURI, model_R4EFileVersion_resource, model_R4EFileVersion_versionID, model_R4EFileVersion_repositoryPath, model_R4EFileVersion_localVersionID, model_R4EFileVersion_fileRevision}
...
model_R4EParticipant.attributes={model_R4EParticipant_roles, model_R4EParticipant_isPartOfDecision, model_R4EParticipant_focusArea}
...
model_R4EReviewPhaseInfo.attributes={model_R4EReviewPhaseInfo_startDate, model_R4EReviewPhaseInfo_phaseOwnerID, model_R4EReviewPhaseInfo_endDate, model_R4EReviewPhaseInfo_type}
...
model_R4ETextPosition.attributes={model_R4ETextPosition_endLine, model_R4ETextPosition_startPosition, model_R4ETextPosition_length, model_R4ETextPosition_startLine}
...
model_MapDateToDuration.attributes={model_MapDateToDuration_value, model_MapDateToDuration_key}
...
model_R4EUserReviews.attributes={model_R4EUserReviews_name, model_R4EUserReviews_createdReviews}
...
domain_model = DomainModel(
    name="model",
    types={model_R4EReviewGroup, ReviewGroup, R4EReviewComponent, Topic, R4EComment, model_R4EDesignRule, model_R4EAnomalyType, model_MapToAnomalyType, model_MapNameToReview, model_MapUserIDToUserReviews, model_R4EReview, Review, model_R4EReviewDecision, model_R4EAnomaly, model_MapToUsers, model_R4EUser, model_MapIDToComponent, model_R4EMeetingData, model_R4EComment, model_R4EItem, model_R4EFileVersion, model_R4EFormalReview, R4EReview, model_R4EParticipant, model_R4EReviewPhaseInfo, model_R4ETextPosition, R4EPosition, User, model_R4EReviewComponent, ReviewComponent, R4EUser, model_R4EID, model_MapDateToDuration, R4EIDComponent, Item, model_R4EFileContext, model_MapKeyToInfoAttributes, model_R4ETextContent, R4EContent, CommentType, model_R4ETaskReference, TaskReference, model_R4EReviewState, ReviewState, Comment, model_R4EDelta, model_R4EContent, model_R4ECommentType, Location, model_R4EPosition, model_R4EUserReviews, model_R4EIDComponent, model_R4EAnomalyTextPosition, R4ETextPosition, R4EAnomalyState, R4EReviewPhase, R4EUserRole, R4EDecision, R4EReviewType, R4EContextType},
    associations={rule18, availableAnomalyTypes0, anomalyTypeKeyToReference1, reviewsMap3, userReviews5, decision7, anomalyTemplate8, usersMap10, createdBy12, idsMap14, activeMeeting16, addedComments28, addedItems30, fixedInVersion20, phaseOwner22, phases23, current25, infoAtt46, reviewInstance32, reviewedContent35, timeLog37, fileContextList39, infoAtt41, anomaly43, infoAtt70, deltas49, base51, target54, infoAtt57, base60, target62, value65, location68, value73, value76, invitedToMap79, group81, id84, key86, value89, value92, file95},
    generalizations={gen_model_R4EReviewGroup_ReviewGroup, gen_model_R4EReviewGroup_R4EReviewComponent, gen_model_R4EAnomaly_Topic, gen_model_R4EAnomaly_R4EReviewComponent, gen_model_R4EAnomaly_R4EComment, gen_model_R4EReview_Review, gen_model_R4EReview_R4EReviewComponent, gen_model_R4EFormalReview_R4EReview, gen_model_R4ETextPosition_R4EPosition, gen_model_R4EUser_User, gen_model_R4EUser_R4EReviewComponent, gen_model_R4EReviewComponent_ReviewComponent, gen_model_R4EParticipant_R4EUser, gen_model_R4EItem_R4EIDComponent, gen_model_R4EItem_Item, gen_model_R4ETextContent_R4EContent, gen_model_R4EAnomalyType_CommentType, gen_model_R4ETaskReference_TaskReference, gen_model_R4ETaskReference_R4EReviewComponent, gen_model_R4EReviewState_ReviewState, gen_model_R4EComment_Comment, gen_model_R4EComment_R4EReviewComponent, gen_model_R4EComment_R4EIDComponent, gen_model_R4EFileContext_R4EIDComponent, gen_model_R4EDelta_R4EIDComponent, gen_model_R4ECommentType_CommentType, gen_model_R4EContent_Location, gen_model_R4EIDComponent_R4EReviewComponent, gen_model_R4EAnomalyTextPosition_R4ETextPosition},
    metadata=None
)
