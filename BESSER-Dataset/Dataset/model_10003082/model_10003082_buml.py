...
Patient.attributes={Patient_sex, Patient_id, Patient_age, Patient_address, Patient_telno, Patient_name, Patient_roomno}
...
Doctor.attributes={Doctor_phno, Doctor_specialization, Doctor_name, Doctor_address, Doctor_docid, Doctor_department}
...
Department.attributes={Department_id, Department_name, Department_doctorid}
...
Bill.attributes={Bill_amount, Bill_billno, Bill_patientname}
...
domain_model = DomainModel(
    name="fc576270_e0e4_42ab_8edb_924ac3a3593f",
    types={Patient, Room, Receptionist, Person, Doctor, Department, Bill, Staff, Nurse},
