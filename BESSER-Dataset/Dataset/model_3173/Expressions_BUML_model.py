...
expressions_EvalExpression = Class(name="expressions_EvalExpression")
expressions_Or = Class(name="expressions_Or")
Expression = Class(name="Expression")
expressions_And = Class(name="expressions_And")
expressions_Equality = Class(name="expressions_Equality")
expressions_Comparison = Class(name="expressions_Comparison")
...
expressions_MulOrDiv = Class(name="expressions_MulOrDiv")
...
domain_model = DomainModel(
    name="expressions",
    types={expressions_Expression, expressions_Variable, AbstractElement, expressions_EvalExpression, expressions_Or, Expression, expressions_And, expressions_Equality, expressions_Comparison, expressions_ExpressionsModel, expressions_AbstractElement, expressions_Plus, expressions_Minus, expressions_MulOrDiv, expressions_Not, expressions_IntConstant, expressions_StringConstant, expressions_BoolConstant, expressions_VariableRef},
    associations={expression1, left3, right5, left8, right10, left13, right15, elements0, left23, right25, left28, right30, left33, right35, expression38, left18, right20, variable40},
    generalizations={gen_expressions_Variable_AbstractElement, gen_expressions_EvalExpression_AbstractElement, gen_expressions_Or_Expression, gen_expressions_And_Expression, gen_expressions_Equality_Expression, gen_expressions_Plus_Expression, gen_expressions_Minus_Expression, gen_expressions_MulOrDiv_Expression, gen_expressions_Not_Expression, gen_expressions_Comparison_Expression, gen_expressions_IntConstant_Expression, gen_expressions_StringConstant_Expression, gen_expressions_BoolConstant_Expression, gen_expressions_VariableRef_Expression},
    metadata=None
)
