...
# Classes
library_Borrowable = Class(name="library_Borrowable", is_abstract=True)
library_Customer = Class(name="library_Customer")
library_borrowables_CD = Class(name="library_borrowables_CD")
Borrowable = Class(name="Borrowable")
library_CityLibrary = Class(name="library_CityLibrary")
library_borrowables_Magazine = Class(name="library_borrowables_Magazine")
library_borrowables_Book = Class(name="library_borrowables_Book")
...
domain_model = DomainModel(
    name="library",
    types={library_Borrowable, library_Customer, library_borrowables_CD, Borrowable, library_CityLibrary, library_borrowables_Magazine, library_borrowables_Book},
    associations={borrowables0, customers1, borrowed2, library4},
