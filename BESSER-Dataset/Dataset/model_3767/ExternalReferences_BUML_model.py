...
fsm_Transition_m_foo: Method = Method(name="foo", parameters={Parameter(name='fsm_arg1', type=StringType), Parameter(name='fsm_arg2', type=StringType)}, type=StringType)
fsm_Transition.attributes={fsm_Transition_a, fsm_Transition_b, fsm_Transition_c}
