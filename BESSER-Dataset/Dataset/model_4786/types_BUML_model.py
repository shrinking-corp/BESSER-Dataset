...
domain_model = DomainModel(
    name="types",
    types={types_Feature, TypedElement, types_ComplexType, types_Operation, types_Type, NamedElement, types_TypeConstraint, Feature, types_Parameter, types_Property, types_TypedElement, types_Event, types_EnumerationType, PrimitiveType, types_Enumerator, types_PrimitiveType, Type},
    associations={owningType1, constraint0, parameters2, owningOperation3, type4, enumerator6, baseType8, features9, superTypes11, owningEnumeration12},
    generalizations={gen_types_Feature_TypedElement, gen_types_Feature_NamedElement, gen_types_Type_NamedElement, gen_types_Operation_Feature, gen_types_Property_Feature, gen_types_Parameter_TypedElement, gen_types_Parameter_NamedElement, gen_types_Event_Feature, gen_types_EnumerationType_PrimitiveType, gen_types_PrimitiveType_Type, gen_types_ComplexType_Type, gen_types_Enumerator_NamedElement, gen_types_TypeConstraint_NamedElement},
    metadata=None
)
