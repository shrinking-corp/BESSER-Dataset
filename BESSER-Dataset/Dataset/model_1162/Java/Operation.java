...
public class Operation  {
    ...
    private OCL_Parameter ocl_parameter;
    ...
    public OCL_Parameter getOcl_parameter() {
        return ocl_parameter;
    }

    public void setOcl_parameter(OCL_Parameter ocl_parameter) {
        this.ocl_parameter = ocl_parameter;
    }
