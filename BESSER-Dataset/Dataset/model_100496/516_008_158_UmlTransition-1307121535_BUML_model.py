...
domain_model = DomainModel(
    name="umlTransition",
    types={umlTransition_GuardRule, umlTransition_EffectRule, umlTransition_CallOrSignalEventRule, EventRule, umlTransition_NamedElement, umlTransition_TransitionRule, umlTransition_EventRule, umlTransition_AnyReceiveEventRule, umlTransition_TimeEventRule, umlTransition_RelativeTimeEventRule, TimeEventRule, umlTransition_AbsoluteTimeEventRule, umlTransition_ChangeEventRule, BehaviorKind},
    associations={guard1, effect3, triggers0, operationOrSignal5},
