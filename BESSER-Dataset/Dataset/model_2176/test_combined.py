...
def test_hyp_tree_tree_label_setter(instance):
...
def test_Tree_Tree_label_value_roundtrip():
    instance = Tree_Tree(label="sample_text")
...
def test_assoc_children1_link_reassign_clear():
    a = Tree_Tree(label="sample_text")
    b1 = Tree_Tree(label="sample_text")
    b2 = Tree_Tree(label="sample_text_2")
    _safe_set(a, 'Tree', b1)
...
Tree_Tree_strategy = st.builds(Tree_Tree, label=safe_text)
@given(instance=Tree_Tree_strategy)
