...
class Booking:
    ...
    def __init__(self, endTime: str, reservedTables: str, customer_name: str, contact_no: int, email_id: str, booking_id: int, date: date, startTime: str, ReservationManagementSystem_Booking_17: "ReservationManagementSystem" = None, reservedBy13: set["Table"] = None):
