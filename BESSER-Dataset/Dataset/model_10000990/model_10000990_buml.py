...
Booking.attributes={Booking_email_id, Booking_date, Booking_startTime, Booking_customer_name, Booking_endTime, Booking_contact_no, Booking_reservedTables, Booking_booking_id}
...
Food.attributes={Food_name, Food_served, Food_food_id, Food_price, Food_prepared}
...
domain_model = DomainModel(
    name="_77f9cbbe_a750_4dab_8456_770d8797cd4e",
    types={ReservationManagementSystem, Booking, Table, Report, Order, Food, Staff, StaffUI, CustomerUI},
