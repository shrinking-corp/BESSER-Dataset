...
class myDsl_Role:
    ...
    def __init__(self, many: bool, name: str, myDsl_Role: "myDsl_Association" = None, myDsl_Role11: "myDsl_Entity" = None, myDsl_Role16: "myDsl_Type" = None):
        self.many = many
        self.name = name
...
class myDsl_Attribute:
    ...
    def __init__(self, many: bool, name: str, myDsl_Attribute: "myDsl_Association" = None, myDsl_Attribute8: "myDsl_Entity" = None, myDsl_Attribute13: "myDsl_Type" = None):
        self.many = many
        self.name = name
...
class myDsl_Type:
    ...
    def __init__(self, name: str, myDsl_Type: "myDsl_Domainmodel" = None, myDsl_Type14: "myDsl_Attribute" = None, myDsl_Type17: "myDsl_Role" = None):
        self.name = name
