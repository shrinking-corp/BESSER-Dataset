...
myDsl_Association = Class(name="myDsl_Association")
myDsl_Attribute = Class(name="myDsl_Attribute")
myDsl_Role = Class(name="myDsl_Role")
...
myDsl_Attribute.attributes={myDsl_Attribute_many, myDsl_Attribute_name}
...
domain_model = DomainModel(
    ...
    associations={elements0, attribute1, role2, superType5, attribute6, role9, type12, type15},
