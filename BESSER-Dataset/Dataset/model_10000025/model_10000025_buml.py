...
Account.attributes={Account_billingAddress, Account_closed, Account_open}

# WebUser class attributes and methods
WebUser_state: Property = Property(name="state", type=UserState)
WebUser.attributes={WebUser_state}
...
Order.attributes={Order_ordered, Order_total, Order_status, Order_number, Order_shipped, Order_shipTo}
...
domain_model = DomainModel(
    name="_0427fdfc_668f_46e2_a0af_ebb8cfe78608",
    types={Customer, Payment, ShoppingCart, Account, WebUser, Order, LineItem, Product, UserState, OrderStatus},
    associations={Account_Order, Payment_Order, Account_Payment, WebUser_ShoppingCart, WebUser_Customer, Customer_Account, Account_ShoppingCart, ShoppingCart_LineItem, Product_LineItem, Order_LineItem},
    generalizations={},
    metadata=None
)
