...
class WebUser:
    ...
    def __init__(self, state: UserState, shoppingCart2: "ShoppingCart" = None, customer4: "Customer" = None):
        self.state = state
...
class Account:
    ...
    def __init__(self, billingAddress: str, open: date, closed: date, order16: set["Order"] = None, p0: set["Payment"] = None, customer7: "Customer" = None, cart8: "ShoppingCart" = None):
