...
@given(instance=Attendance_strategy)
def test_hyp_attendance_endTime_setter(instance):
...
@given(instance=Attendance_strategy)
def test_hyp_attendance_startTime_setter(instance):
...
@given(instance=Leave_strategy)
def test_hyp_leave_Leave_Type_setter(instance):
...
def test_hyp_employee_Emp_Designation_setter(instance):
