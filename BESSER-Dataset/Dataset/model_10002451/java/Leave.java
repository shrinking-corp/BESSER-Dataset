...
public class Leave  {
    ...
    public Leave(
        int Leave_NoOfDays,        int leave_id,        LocalDate Leave_StartDate,        String Leave_Title,        int Emp_Id,        LocalDate Leave_EndDate,        String Leave_Status,        LocalDate Leave_ApplyDate,        String Leave_Type    ) {
