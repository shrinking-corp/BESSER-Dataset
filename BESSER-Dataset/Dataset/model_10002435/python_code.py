...
class Item:
    ...
    def __init__(self, productId: str, price: float, colour: str, size: str, user5: "Account" = None, Shopping_Cart_Login_19: "Shopping_Cart" = None):
...
class Order:
    ...
    def __init__(self, quantity: int, price: Item, user3: "Account" = None, friend6: set["Shopping_Cart"] = None):
...
class Account:
    ...
    def __init__(self, Username: str, Password: int, myprofile0: "Customer" = None, post2: set["Order"] = None, login4: "Item" = None):
