...
class exhaustive_GenericTest:
    ...
    def genericOperationParameters(self, exhaustive_foo, exhaustive_bar):
...
class exhaustive_OperationsTest:
    ...
    def manyParameters(self, exhaustive_p2, exhaustive_p1):
...
class exhaustive_AttributesTest(InterfaceTest, MultipleSuperTest):
    ...
    def __init__(self, lowerBound1: str, lowerBound2: str, lowerBoundN: str, upperBound0: str, upperBound1: date, upperBound2: str, upperBoundN: str, orderedYes: str, orderenedNo: str, transientYes: float, transientNo: str, uniqueYes: str, uniqueNo: str, unsettableYes: str, unsettableNo: str, volatileYes: str, volatileNo: str, changeableYes: float, changeableNo: str, defaultValue: str, derivedYes: str, derivedNo: str, idYes: str, idNo: str, lowerBound0: int, opposite1: "exhaustive_ReferencesTest" = None, AttributesTest: "exhaustive_ReferencesTest" = None, exhaustive_AttributesTest: "exhaustive_ReferencesTest" = None, exhaustive_AttributesTest11: "exhaustive_ReferencesTest" = None, exhaustive_AttributesTest14: "exhaustive_ReferencesTest" = None, exhaustive_AttributesTest17: "exhaustive_ReferencesTest" = None, exhaustive_AttributesTest20: "exhaustive_ReferencesTest" = None, exhaustive_AttributesTest23: "exhaustive_ReferencesTest" = None, exhaustive_AttributesTest26: "exhaustive_ReferencesTest" = None, exhaustive_AttributesTest29: "exhaustive_ReferencesTest" = None, exhaustive_AttributesTest32: "exhaustive_ReferencesTest" = None, exhaustive_AttributesTest35: "exhaustive_ReferencesTest" = None, exhaustive_AttributesTest38: "exhaustive_ReferencesTest" = None):
