...
# Classes
hlp_HighLevelProgram = Class(name="hlp_HighLevelProgram")
VariableDeclarationScope = Class(name="VariableDeclarationScope")
Nameable = Class(name="Nameable")
hlp_Task = Class(name="hlp_Task")
hlp_ScheduleInstruction = Class(name="hlp_ScheduleInstruction")
hlp_VariableDeclaration = Class(name="hlp_VariableDeclaration")
hlp_Variable = Class(name="hlp_Variable")
hlp_Expression = Class(name="hlp_Expression", is_abstract=True)
hlp_ParenthesisExpression = Class(name="hlp_ParenthesisExpression")
hlp_Block = Class(name="hlp_Block")
hlp_IfStatement = Class(name="hlp_IfStatement")
hlp_Condition = Class(name="hlp_Condition")
hlp_Assignment = Class(name="hlp_Assignment")
Statement = Class(name="Statement")
hlp_VariableReference = Class(name="hlp_VariableReference")
hlp_Statement = Class(name="hlp_Statement", is_abstract=True)
hlp_LiteralValue = Class(name="hlp_LiteralValue")
AtomicExpression = Class(name="AtomicExpression")
hlp_AddExpression = Class(name="hlp_AddExpression")
ArithmeticExpression = Class(name="ArithmeticExpression")
hlp_AtomicExpression = Class(name="hlp_AtomicExpression", is_abstract=True)
Expression = Class(name="Expression")
hlp_BinaryExpression = Class(name="hlp_BinaryExpression", is_abstract=True)
hlp_SubtractExpression = Class(name="hlp_SubtractExpression")
hlp_MultiplyExpression = Class(name="hlp_MultiplyExpression")
hlp_DivideExpression = Class(name="hlp_DivideExpression")
hlp_UnaryExpression = Class(name="hlp_UnaryExpression", is_abstract=True)
hlp_UnaryMinusExpression = Class(name="hlp_UnaryMinusExpression")
UnaryExpression = Class(name="UnaryExpression")
hlp_ArithmeticExpression = Class(name="hlp_ArithmeticExpression", is_abstract=True)
BinaryExpression = Class(name="BinaryExpression")
hlp_SynchronizedStatement = Class(name="hlp_SynchronizedStatement")
hlp_VariableDeclarationScope = Class(name="hlp_VariableDeclarationScope", is_abstract=True)
hlp_Loop = Class(name="hlp_Loop", is_abstract=True)
hlp_ConditionalLoop = Class(name="hlp_ConditionalLoop", is_abstract=True)
Loop = Class(name="Loop")
hlp_WhileLoop = Class(name="hlp_WhileLoop")
ConditionalLoop = Class(name="ConditionalLoop")
hlp_ForLoop = Class(name="hlp_ForLoop")
hlp_Nameable = Class(name="hlp_Nameable", is_abstract=True)
hlp_ExpressionStatement = Class(name="hlp_ExpressionStatement")
...
domain_model = DomainModel(
    name="hlp",
    types={hlp_HighLevelProgram, VariableDeclarationScope, Nameable, hlp_Task, hlp_ScheduleInstruction, hlp_VariableDeclaration, hlp_Variable, hlp_Expression, hlp_ParenthesisExpression, hlp_Block, hlp_IfStatement, hlp_Condition, hlp_Assignment, Statement, hlp_VariableReference, hlp_Statement, hlp_LiteralValue, AtomicExpression, hlp_AddExpression, ArithmeticExpression, hlp_AtomicExpression, Expression, hlp_BinaryExpression, hlp_SubtractExpression, hlp_MultiplyExpression, hlp_DivideExpression, hlp_UnaryExpression, hlp_UnaryMinusExpression, UnaryExpression, hlp_ArithmeticExpression, BinaryExpression, hlp_SynchronizedStatement, hlp_VariableDeclarationScope, hlp_Loop, hlp_ConditionalLoop, Loop, hlp_WhileLoop, ConditionalLoop, hlp_ForLoop, hlp_Nameable, hlp_ExpressionStatement, ComparisonOperator},
    associations={tasks0, scheduleInstruction1, variable3, initialValue4, operand18, statements20, thenBlock21, elseBlock23, condition26, leftHandSide28, rightHandSide31, leftHandSide6, rightHandSide7, variable10, leftHandSide13, rightHandSide15, expression48, expression50, block52, variableReferences54, block57, tasks60, variableDeclarations34, block36, condition38, variableReference40, bound142, bound245},
    generalizations={gen_hlp_HighLevelProgram_VariableDeclarationScope, gen_hlp_HighLevelProgram_Nameable, gen_hlp_ParenthesisExpression_Expression, gen_hlp_IfStatement_Statement, gen_hlp_Variable_Nameable, gen_hlp_Assignment_Statement, gen_hlp_LiteralValue_AtomicExpression, gen_hlp_AddExpression_ArithmeticExpression, gen_hlp_VariableReference_AtomicExpression, gen_hlp_AtomicExpression_Expression, gen_hlp_BinaryExpression_Expression, gen_hlp_SubtractExpression_ArithmeticExpression, gen_hlp_MultiplyExpression_ArithmeticExpression, gen_hlp_DivideExpression_ArithmeticExpression, gen_hlp_UnaryExpression_Expression, gen_hlp_UnaryMinusExpression_UnaryExpression, gen_hlp_ArithmeticExpression_BinaryExpression, gen_hlp_SynchronizedStatement_Statement, gen_hlp_Task_VariableDeclarationScope, gen_hlp_Task_Nameable, gen_hlp_Loop_Statement, gen_hlp_ConditionalLoop_Loop, gen_hlp_WhileLoop_ConditionalLoop, gen_hlp_ForLoop_Loop, gen_hlp_ExpressionStatement_Statement},
    metadata=None
)
