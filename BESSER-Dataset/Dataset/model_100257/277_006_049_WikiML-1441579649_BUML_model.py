...
wikiML_Image.attributes={wikiML_Image_hAlign, wikiML_Image_name, wikiML_Image_type}
...
domain_model = DomainModel(
    name="wikiML",
    types={wikiML_WikiPage, wikiML_ParagraphTypes, wikiML_BlockQuote, ParagraphTypes, wikiML_AnyTextSequence, wikiML_Template, wikiML_AboutTemplate, Template, wikiML_MainTemplate, wikiML_OrderListItem, wikiML_Paragraph, wikiML_UnorderedList, wikiML_UnorderListItem, wikiML_Image, wikiML_AbstractUnformattedInlineContent, wikiML_QuoteTemplate, wikiML_OrderedList, wikiML_Category, wikiML_Text, wikiML_Heading2, wikiML_Heading3, wikiML_Heading4, wikiML_Heading5, wikiML_Bold, AbstractFormattedInlineContent, wikiML_Italic, wikiML_ItalicBold, AbstractUnformattedInlineContent, wikiML_HyperLink, wikiML_AnyText, wikiML_Internal, HyperLink, wikiML_External, wikiML_AbstractFormattedInlineContent, AnyText, ViewType, HorizontalAlign},
    associations={elements0, content1, content2, content4, items6, end7, items9, end10, itemtext13, itemtext16, altText19, name23, headingValue224, headingValue326, headingValue428, headingValue530, caption20, name32, altText34, link35, anchor37, content40},
    generalizations={gen_wikiML_BlockQuote_ParagraphTypes, gen_wikiML_Template_ParagraphTypes, gen_wikiML_AboutTemplate_Template, gen_wikiML_MainTemplate_Template, gen_wikiML_UnorderedList_ParagraphTypes, gen_wikiML_Image_ParagraphTypes, gen_wikiML_QuoteTemplate_Template, gen_wikiML_OrderedList_ParagraphTypes, gen_wikiML_Category_ParagraphTypes, gen_wikiML_Heading2_ParagraphTypes, gen_wikiML_Heading3_ParagraphTypes, gen_wikiML_Heading4_ParagraphTypes, gen_wikiML_Heading5_ParagraphTypes, gen_wikiML_Bold_AbstractFormattedInlineContent, gen_wikiML_Italic_AbstractFormattedInlineContent, gen_wikiML_ItalicBold_AbstractFormattedInlineContent, gen_wikiML_AbstractUnformattedInlineContent_AnyText, gen_wikiML_Text_AbstractUnformattedInlineContent, gen_wikiML_HyperLink_AbstractUnformattedInlineContent, gen_wikiML_Internal_HyperLink, gen_wikiML_External_HyperLink, gen_wikiML_AbstractFormattedInlineContent_AnyText, gen_wikiML_AnyText_ParagraphTypes, gen_wikiML_Paragraph_ParagraphTypes},
    metadata=None
)
