...
# Classes
accounting_AccountGroup = Class(name="accounting_AccountGroup")
accounting_Account = Class(name="accounting_Account", is_abstract=True)
Account = Class(name="Account")
accounting_ReportGroup = Class(name="accounting_ReportGroup")
accounting_Accounting = Class(name="accounting_Accounting")
Serializable = Class(name="Serializable")
accounting_Vat = Class(name="accounting_Vat")
accounting_BalanceAccount = Class(name="accounting_BalanceAccount")
accounting_Report = Class(name="accounting_Report")
accounting_JournalGroup = Class(name="accounting_JournalGroup")
accounting_PLAccount = Class(name="accounting_PLAccount")
accounting_JournalStatement = Class(name="accounting_JournalStatement")
accounting_Serializable = Class(name="accounting_Serializable", is_abstract=True)
...
domain_model = DomainModel(
    name="accounting",
    types={accounting_AccountGroup, accounting_Account, Account, accounting_ReportGroup, accounting_Accounting, Serializable, accounting_Vat, accounting_BalanceAccount, accounting_Report, accounting_JournalGroup, accounting_PLAccount, accounting_JournalStatement, accounting_Serializable},
    associations={report11, account0, accountGroup1, vat3, vatAccount5, report7, journalGroup9, vat23, journalGroups13, journalStatements15, debitAccount17, creditAccount20, debitReportGroup26, creditReportGroup28, reportGroup32, account34},
    generalizations={gen_accounting_BalanceAccount_Account, gen_accounting_Accounting_Serializable, gen_accounting_PLAccount_Account},
    metadata=None
)
