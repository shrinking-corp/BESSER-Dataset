...
class accounting_JournalStatement:
    ...
    def __init__(self, description: str, date: str, amount: str, accounting_JournalStatement24: "accounting_Vat" = None, accounting_JournalStatement: "accounting_JournalGroup" = None, accounting_JournalStatement18: "accounting_Account" = None, accounting_JournalStatement21: "accounting_Account" = None):
...
class accounting_Vat:
    ...
    def __init__(self, rate: str, name: str, accounting_Vat: "accounting_Accounting" = None, accounting_Vat25: "accounting_JournalStatement" = None):
        self.rate = rate
        self.name = name
