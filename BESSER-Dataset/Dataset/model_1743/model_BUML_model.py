...
model_PersonBNode = Class(name="model_PersonBNode")
model_BookBNode = Class(name="model_BookBNode")
model_BNode = Class(name="model_BNode")
model_Library = Class(name="model_Library")
model_Location = Class(name="model_Location")
model_MappedLibrary = Class(name="model_MappedLibrary")
...
model_ETypes.attributes={model_ETypes_eInt, model_ETypes_eLong, model_ETypes_eChar, model_ETypes_eDouble, model_ETypes_eShort, model_ETypes_eDate, model_ETypes_eBoolean, model_ETypes_eByte, model_ETypes_eByteArray, model_ETypes_eFloat, model_ETypes_eBigDecimal, model_ETypes_eBigInteger, model_ETypes_uris, model_ETypes_eString}
...
model_PrimaryObject.attributes={model_PrimaryObject_name, model_PrimaryObject_unsettableAttribute, model_PrimaryObject_unsettableAttributeWithDefault, model_PrimaryObject_featureMapAttributeType1, model_PrimaryObject_featureMapAttributeType2, model_PrimaryObject_featureMapAttributeCollection, model_PrimaryObject_featureMapReferenceCollection, model_PrimaryObject_id}
...
model_TargetObject.attributes={model_TargetObject_id, model_TargetObject_singleAttribute, model_TargetObject_arrayAttribute}
...
domain_model = DomainModel(
    name="model",
    types={model_ETypes, model_Person, model_Book, model_PersonBNode, model_BookBNode, model_BNode, model_Library, model_Location, model_MappedLibrary, model_PrimaryObject, model_TargetObject},
    associations={latestBook11, featuredBook14, books0, authors1, books2, authors3, child7, books8, location9, singleNonContainmentReference26, multipleNonContainmentReference29, singleContainmentReferenceNoProxies32, multipleContainmentReferenceNoProxies35, singleContainmentReferenceProxies38, multipleContainmentReferenceProxies41, location17, rareBooks19, regularBooks22, unsettableReference25, featureMapReferenceType244, featureMapReferenceType147},
    generalizations={},
    metadata=None
)
