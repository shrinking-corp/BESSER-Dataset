...
class SQL2003_Trigger:
    ...
    def __init__(self, name: str, event: str, actionTime: str, triggeredAction: str, Trigger: "SQL2003_Table" = None, triggers: "SQL2003_Table" = None, SQL2003_Trigger: set["SQL2003_StructuralComponent"] = None):
        self.name = name
        self.event = event
...
class SQL2003_StructuralComponent(ABC):
    ...
    def __init__(self, name: str, StructuralComponent: "SQL2003_Restriction" = None, columns52: set["SQL2003_Restriction"] = None, SQL2003_StructuralComponent54: set["SQL2003_Feature"] = None, SQL2003_StructuralComponent: "SQL2003_DataType" = None, components: set["SQL2003_View"] = None, SQL2003_StructuralComponent79: "SQL2003_Trigger" = None, StructuralComponent92: "SQL2003_View" = None):
        self.name = name
...
class SQL2003_Method:
    ...
    def __init__(self, name: str, body: str, SQL2003_Method: "SQL2003_Method" = None, SQL2003_Method15: "SQL2003_Method" = None, methods: "SQL2003_StructuredType" = None, Method: "SQL2003_MethodParameter" = None, SQL2003_Method20: "SQL2003_DataType" = None, method: set["SQL2003_MethodParameter"] = None, Method62: "SQL2003_StructuredType" = None):
        self.name = name
        self.body = body
...
class SQL2003_Table(ABC):
    ...
    def __init__(self, name: str, Table: "SQL2003_Column" = None, Table38: "SQL2003_Restriction" = None, Table47: "SQL2003_Schema" = None, tables: "SQL2003_Schema" = None, table: set["SQL2003_Column"] = None, tables69: set["SQL2003_View"] = None, table72: set["SQL2003_Trigger"] = None, Table77: "SQL2003_Trigger" = None, table74: set["SQL2003_Restriction"] = None, Table89: "SQL2003_View" = None):
        self.name = name
        self.Table = Table
...
class SQL2003_Schema:
    ...
    def __init__(self, name: str, Schema9: "SQL2003_DataType" = None, Schema: "SQL2003_BehaviouralComponent" = None, schema46: set["SQL2003_Table"] = None, schema: set["SQL2003_BehaviouralComponent"] = None, schema44: set["SQL2003_DataType"] = None, Schema66: "SQL2003_Table" = None):
        self.name = name
...
class SQL2003_BehaviouralComponent(ABC):
    ...
    def __init__(self, name: str, body: str, behaviouralComponent: set["SQL2003_ParameterWithMode"] = None, behaviouralComponents: "SQL2003_Schema" = None, BehaviouralComponent: "SQL2003_ParameterWithMode" = None, BehaviouralComponent42: "SQL2003_Schema" = None):
        self.name = name
        self.body = body
