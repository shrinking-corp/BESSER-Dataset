...
public class SQL2003_Trigger  {
    ...
    public SQL2003_Trigger(
        String event,        String triggeredAction,        String actionTime,        String name    ) {
        this.event = event;
    ...
    public SQL2003_Trigger(
        String event,        String triggeredAction,        String actionTime,        String name        ArrayList<SQL2003_StructuralComponent> sql2003_structuralcomponents    ) {
        this.event = event;
        this.triggeredAction = triggeredAction;
        this.actionTime = actionTime;
        this.name = name;
