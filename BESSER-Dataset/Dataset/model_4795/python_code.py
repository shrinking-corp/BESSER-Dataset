...
class jkind_Field:
    ...
    def __init__(self, name: str, jkind_Field59: "jkind_ProjectionExpr" = None, jkind_Field: "jkind_RecordType" = None, jkind_Field78: "jkind_RecordExpr" = None):
        self.name = name
...
class jkind_Node:
    ...
    def __init__(self, main: str, name: str, jkind_Node18: set["jkind_Equation"] = None, jkind_Node20: set["jkind_Assertion"] = None, jkind_Node22: set["jkind_Property"] = None, jkind_Node: "jkind_File" = None, jkind_Node10: set["jkind_VariableGroup"] = None, jkind_Node12: set["jkind_VariableGroup"] = None, jkind_Node15: set["jkind_VariableGroup"] = None, jkind_Node70: "jkind_NodeCallExpr" = None):
        self.main = main
        self.name = name
