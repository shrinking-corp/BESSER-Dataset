...
example4_Sirius_A_strategy = st.builds(example4_Sirius_A)
...
example4_Sirius_B_strategy = st.builds(example4_Sirius_B)
...
example4_Sirius_Container_strategy = st.builds(example4_Sirius_Container)
...
example4_Sirius_Element_strategy = st.builds(example4_Sirius_Element)
