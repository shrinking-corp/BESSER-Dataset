...
# Classes
example4_Sirius_Container = Class(name="example4_Sirius_Container")
example4_Sirius_Element = Class(name="example4_Sirius_Element")
example4_Sirius_A = Class(name="example4_Sirius_A")
example4_Sirius_B = Class(name="example4_Sirius_B")
...
domain_model = DomainModel(
    ...
    types={example4_Sirius_Container, example4_Sirius_Element, example4_Sirius_A, example4_Sirius_B},
