...
class Room:
    ...
    def __init__(self, RoomNo: int, RoomType: str, patient9: "Patient" = None):
        self.RoomNo = RoomNo
    ...
    def patient9(self, value):
        ...
        old_value = getattr(self, f"_Room__patient9", None)
...
class Bill:
    ...
    def __init__(self, Amount: str, BillNo: str, Patient_Id: int, receptionist5: "Receptionist" = None, patient7: "Patient" = None):
        self.Amount = Amount
        self.BillNo = BillNo
...
class Patient:
    ...
    def __init__(self, Id: int, Name: str, PhNo_: int, Address: str, Age: int, WardNo: int, doctor1: "Doctor" = None, receptionist2: "Receptionist" = None, bill6: "Bill" = None, rooms8: "Room" = None):
        self.Id = Id
        self.Name = Name
        self.PhNo_ = PhNo_
