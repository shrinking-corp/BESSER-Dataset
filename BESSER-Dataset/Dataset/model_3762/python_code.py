...
class movies_Place:
    ...
    def __init__(self, id: str, name: str, movies_Place: "movies_MoviesDB" = None, movies_Place9: "movies_Copy" = None):
        self.id = id
        self.name = name
...
class movies_Movie:
    ...
    def __init__(self, summary: str, actors: str, title: str, director: str, genre: str, movies_Movie: set["movies_Copy"] = None, movies_Movie2: set["movies_CriticsReview"] = None, movies_Movie4: "movies_MoviesDB" = None):
