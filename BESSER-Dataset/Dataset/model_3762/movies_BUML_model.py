...
# Classes
movies_Copy = Class(name="movies_Copy")
movies_CriticsReview = Class(name="movies_CriticsReview")
movies_Movie = Class(name="movies_Movie")
movies_CustomerReview = Class(name="movies_CustomerReview")
CriticsReview = Class(name="CriticsReview")
movies_MoviesDB = Class(name="movies_MoviesDB")
movies_Place = Class(name="movies_Place")
...
movies_CriticsReview.attributes={movies_CriticsReview_rating, movies_CriticsReview_reviewedBy}
...
movies_Movie.attributes={movies_Movie_summary, movies_Movie_genre, movies_Movie_title, movies_Movie_actors, movies_Movie_director}
...
domain_model = DomainModel(
    name="movies",
    types={movies_Copy, movies_CriticsReview, movies_Movie, movies_CustomerReview, CriticsReview, movies_MoviesDB, movies_Place, GenreTypes},
    associations={copies0, review1, movies3, places5, place7},
