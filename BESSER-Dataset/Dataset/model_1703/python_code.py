...
class emapsample_StringToWriterMapEntry:
    ...
    def __init__(self, key: str, emapsample_StringToWriterMapEntry7: "emapsample_Writer" = None, emapsample_StringToWriterMapEntry: "emapsample_Book" = None):
        self.key = key
...
class emapsample_Writer(Identifiable):
    ...
    def __init__(self, name: str, emapsample_Writer: "emapsample_StringToWriterMapEntry" = None, emapsample_Writer16: "emapsample_WriterToNameMapEntry" = None, emapsample_Writer10: "emapsample_WriterToBookMapEntry" = None):
        self.name = name
