...
# Classes
emapsample_Book = Class(name="emapsample_Book")
emapsample_BookStore = Class(name="emapsample_BookStore")
Identifiable = Class(name="Identifiable")
emapsample_WriterToBookMapEntry = Class(name="emapsample_WriterToBookMapEntry")
emapsample_EStringToStringMapEntry = Class(name="emapsample_EStringToStringMapEntry")
emapsample_WriterToNameMapEntry = Class(name="emapsample_WriterToNameMapEntry")
emapsample_Writer = Class(name="emapsample_Writer")
emapsample_StringToWriterMapEntry = Class(name="emapsample_StringToWriterMapEntry")
...
domain_model = DomainModel(
    name="emapsample",
    types={emapsample_Book, emapsample_BookStore, Identifiable, emapsample_WriterToBookMapEntry, emapsample_EStringToStringMapEntry, emapsample_WriterToNameMapEntry, emapsample_Writer, emapsample_StringToWriterMapEntry},
    associations={booksByWriter1, keyWords2, namesByWriter4, value6, writers0, value11, key14, key8},
