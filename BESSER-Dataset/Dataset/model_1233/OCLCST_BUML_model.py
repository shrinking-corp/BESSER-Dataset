...
# Classes
ocl_cst_CSTNode = Class(name="ocl_cst_CSTNode", is_abstract=True)
ContextDeclCS = Class(name="ContextDeclCS")
PackageDeclarationCS = Class(name="PackageDeclarationCS")
ocl_cst_PathNameCS = Class(name="ocl_cst_PathNameCS")
TypeCS = Class(name="TypeCS")
ocl_cst_TypeCS = Class(name="ocl_cst_TypeCS", is_abstract=True)
OCLExpressionCS = Class(name="OCLExpressionCS")
ocl_cst_OCLExpressionCS = Class(name="ocl_cst_OCLExpressionCS", is_abstract=True)
ocl_cst_ContextDeclCS = Class(name="ocl_cst_ContextDeclCS", is_abstract=True)
ocl_cst_PropertyContextCS = Class(name="ocl_cst_PropertyContextCS")
SimpleNameCS = Class(name="SimpleNameCS")
InitOrDerValueCS = Class(name="InitOrDerValueCS")
ocl_cst_SimpleNameCS = Class(name="ocl_cst_SimpleNameCS")
ocl_cst_InitOrDerValueCS = Class(name="ocl_cst_InitOrDerValueCS", is_abstract=True)
ocl_cst_PackageDeclarationCS = Class(name="ocl_cst_PackageDeclarationCS")
CSTNode = Class(name="CSTNode")
PathNameCS = Class(name="PathNameCS")
ocl_cst_InvOrDefCS = Class(name="ocl_cst_InvOrDefCS", is_abstract=True)
ocl_cst_OperationContextDeclCS = Class(name="ocl_cst_OperationContextDeclCS")
OperationCS = Class(name="OperationCS")
PrePostOrBodyDeclCS = Class(name="PrePostOrBodyDeclCS")
ocl_cst_OperationCS = Class(name="ocl_cst_OperationCS")
VariableCS = Class(name="VariableCS")
ocl_cst_VariableCS = Class(name="ocl_cst_VariableCS")
ocl_cst_PrePostOrBodyDeclCS = Class(name="ocl_cst_PrePostOrBodyDeclCS")
ocl_cst_DerValueCS = Class(name="ocl_cst_DerValueCS")
ocl_cst_InitValueCS = Class(name="ocl_cst_InitValueCS")
ocl_cst_ClassifierContextDeclCS = Class(name="ocl_cst_ClassifierContextDeclCS")
InvOrDefCS = Class(name="InvOrDefCS")
ocl_cst_DefExpressionCS = Class(name="ocl_cst_DefExpressionCS")
ocl_cst_VariableExpCS = Class(name="ocl_cst_VariableExpCS")
IsMarkedPreCS = Class(name="IsMarkedPreCS")
ocl_cst_IsMarkedPreCS = Class(name="ocl_cst_IsMarkedPreCS")
ocl_cst_PrimitiveTypeCS = Class(name="ocl_cst_PrimitiveTypeCS")
cst_SimpleNameCS = Class(name="cst_SimpleNameCS")
cst_TypeCS = Class(name="cst_TypeCS")
ocl_cst_TupleTypeCS = Class(name="ocl_cst_TupleTypeCS")
ocl_cst_CollectionTypeCS = Class(name="ocl_cst_CollectionTypeCS")
ocl_cst_LetExpCS = Class(name="ocl_cst_LetExpCS")
ocl_cst_InvCS = Class(name="ocl_cst_InvCS")
ocl_cst_DefCS = Class(name="ocl_cst_DefCS")
DefExpressionCS = Class(name="DefExpressionCS")
ocl_cst_MessageExpCS = Class(name="ocl_cst_MessageExpCS")
OCLMessageArgCS = Class(name="OCLMessageArgCS")
ocl_cst_OCLMessageArgCS = Class(name="ocl_cst_OCLMessageArgCS")
ocl_cst_LiteralExpCS = Class(name="ocl_cst_LiteralExpCS", is_abstract=True)
ocl_cst_EnumLiteralExpCS = Class(name="ocl_cst_EnumLiteralExpCS")
LiteralExpCS = Class(name="LiteralExpCS")
ocl_cst_CollectionLiteralExpCS = Class(name="ocl_cst_CollectionLiteralExpCS")
CollectionLiteralPartCS = Class(name="CollectionLiteralPartCS")
ocl_cst_CollectionLiteralPartCS = Class(name="ocl_cst_CollectionLiteralPartCS")
ocl_cst_IfExpCS = Class(name="ocl_cst_IfExpCS")
ocl_cst_PrimitiveLiteralExpCS = Class(name="ocl_cst_PrimitiveLiteralExpCS")
ocl_cst_IntegerLiteralExpCS = Class(name="ocl_cst_IntegerLiteralExpCS")
PrimitiveLiteralExpCS = Class(name="PrimitiveLiteralExpCS")
ocl_cst_UnlimitedNaturalLiteralExpCS = Class(name="ocl_cst_UnlimitedNaturalLiteralExpCS")
ocl_cst_RealLiteralExpCS = Class(name="ocl_cst_RealLiteralExpCS")
ocl_cst_StringLiteralExpCS = Class(name="ocl_cst_StringLiteralExpCS")
ocl_cst_BooleanLiteralExpCS = Class(name="ocl_cst_BooleanLiteralExpCS")
ocl_cst_NullLiteralExpCS = Class(name="ocl_cst_NullLiteralExpCS")
ocl_cst_InvalidLiteralExpCS = Class(name="ocl_cst_InvalidLiteralExpCS")
ocl_cst_CollectionRangeCS = Class(name="ocl_cst_CollectionRangeCS")
ocl_cst_CallExpCS = Class(name="ocl_cst_CallExpCS")
ocl_cst_LoopExpCS = Class(name="ocl_cst_LoopExpCS")
CallExpCS = Class(name="CallExpCS")
ocl_cst_TupleLiteralExpCS = Class(name="ocl_cst_TupleLiteralExpCS")
ocl_cst_OperationCallExpCS = Class(name="ocl_cst_OperationCallExpCS")
FeatureCallExpCS = Class(name="FeatureCallExpCS")
ocl_cst_StateExpCS = Class(name="ocl_cst_StateExpCS")
ocl_cst_OCLDocumentCS = Class(name="ocl_cst_OCLDocumentCS")
ocl_cst_IteratorExpCS = Class(name="ocl_cst_IteratorExpCS")
LoopExpCS = Class(name="LoopExpCS")
ocl_cst_IterateExpCS = Class(name="ocl_cst_IterateExpCS")
ocl_cst_FeatureCallExpCS = Class(name="ocl_cst_FeatureCallExpCS")
...
ocl_cst_CSTNode.attributes={ocl_cst_CSTNode_startToken, ocl_cst_CSTNode_ast, ocl_cst_CSTNode_endOffset, ocl_cst_CSTNode_endToken, ocl_cst_CSTNode_startOffset}
...
domain_model = DomainModel(
    name="ocl",
    types={ocl_cst_CSTNode, ContextDeclCS, PackageDeclarationCS, ocl_cst_PathNameCS, TypeCS, ocl_cst_TypeCS, OCLExpressionCS, ocl_cst_OCLExpressionCS, ocl_cst_ContextDeclCS, ocl_cst_PropertyContextCS, SimpleNameCS, InitOrDerValueCS, ocl_cst_SimpleNameCS, ocl_cst_InitOrDerValueCS, ocl_cst_PackageDeclarationCS, CSTNode, PathNameCS, ocl_cst_InvOrDefCS, ocl_cst_OperationContextDeclCS, OperationCS, PrePostOrBodyDeclCS, ocl_cst_OperationCS, VariableCS, ocl_cst_VariableCS, ocl_cst_PrePostOrBodyDeclCS, ocl_cst_DerValueCS, ocl_cst_InitValueCS, ocl_cst_ClassifierContextDeclCS, InvOrDefCS, ocl_cst_DefExpressionCS, ocl_cst_VariableExpCS, IsMarkedPreCS, ocl_cst_IsMarkedPreCS, ocl_cst_PrimitiveTypeCS, cst_SimpleNameCS, cst_TypeCS, ocl_cst_TupleTypeCS, ocl_cst_CollectionTypeCS, ocl_cst_LetExpCS, ocl_cst_InvCS, ocl_cst_DefCS, DefExpressionCS, ocl_cst_MessageExpCS, OCLMessageArgCS, ocl_cst_OCLMessageArgCS, ocl_cst_LiteralExpCS, ocl_cst_EnumLiteralExpCS, LiteralExpCS, ocl_cst_CollectionLiteralExpCS, CollectionLiteralPartCS, ocl_cst_CollectionLiteralPartCS, ocl_cst_IfExpCS, ocl_cst_PrimitiveLiteralExpCS, ocl_cst_IntegerLiteralExpCS, PrimitiveLiteralExpCS, ocl_cst_UnlimitedNaturalLiteralExpCS, ocl_cst_RealLiteralExpCS, ocl_cst_StringLiteralExpCS, ocl_cst_BooleanLiteralExpCS, ocl_cst_NullLiteralExpCS, ocl_cst_InvalidLiteralExpCS, ocl_cst_CollectionRangeCS, ocl_cst_CallExpCS, ocl_cst_LoopExpCS, CallExpCS, ocl_cst_TupleLiteralExpCS, ocl_cst_OperationCallExpCS, FeatureCallExpCS, ocl_cst_StateExpCS, ocl_cst_OCLDocumentCS, ocl_cst_IteratorExpCS, LoopExpCS, ocl_cst_IterateExpCS, ocl_cst_FeatureCallExpCS, SimpleTypeEnum, PrePostOrBodyEnum, CollectionTypeIdentifierEnum, MessageExpKind, DotOrArrowEnum},
    associations={contextDecls1, packageDeclarationCS3, pathNameCS5, simpleNameCS7, typeCS9, initOrDerValueCS11, initOrDerValueCS13, expressionCS15, pathNameCS0, constraints21, simpleNameCS24, invOrDefCS26, operationCS29, prePostOrBodyDecls30, pathNameCS32, simpleNameCS34, parameters37, typeCS39, typeCS42, initExpression44, simpleNameCS47, expressionCS49, pathNameCS17, invOrDefCS19, operationCS55, variableCS57, expressionCS60, arguments63, simpleNameCS65, isMarkedPreCS68, variables70, typeCS72, variables74, expressionCS52, defExpressionCS54, elseExpression81, condition84, target87, simpleNameCS89, arguments92, typeCS94, expression96, pathNameCS99, simpleNameCS101, collectionLiteralParts104, inExpression76, thenExpression79, lastExpressionCS109, source111, simpleNameCS113, variable1116, expressionCS105, variables107, arguments124, isMarkedPreCS126, packageDeclarations129, variable2118, body121},
    generalizations={gen_ocl_cst_PathNameCS_TypeCS, gen_ocl_cst_TypeCS_OCLExpressionCS, gen_ocl_cst_OCLExpressionCS_CSTNode, gen_ocl_cst_ContextDeclCS_CSTNode, gen_ocl_cst_PropertyContextCS_ContextDeclCS, gen_ocl_cst_SimpleNameCS_OCLExpressionCS, gen_ocl_cst_InitOrDerValueCS_CSTNode, gen_ocl_cst_PackageDeclarationCS_CSTNode, gen_ocl_cst_InvOrDefCS_CSTNode, gen_ocl_cst_OperationContextDeclCS_ContextDeclCS, gen_ocl_cst_OperationCS_CSTNode, gen_ocl_cst_VariableCS_CSTNode, gen_ocl_cst_PrePostOrBodyDeclCS_CSTNode, gen_ocl_cst_DerValueCS_InitOrDerValueCS, gen_ocl_cst_InitValueCS_InitOrDerValueCS, gen_ocl_cst_ClassifierContextDeclCS_ContextDeclCS, gen_ocl_cst_DefExpressionCS_CSTNode, gen_ocl_cst_VariableExpCS_OCLExpressionCS, gen_ocl_cst_IsMarkedPreCS_CSTNode, gen_ocl_cst_PrimitiveTypeCS_cst_SimpleNameCS, gen_ocl_cst_PrimitiveTypeCS_cst_TypeCS, gen_ocl_cst_TupleTypeCS_TypeCS, gen_ocl_cst_CollectionTypeCS_TypeCS, gen_ocl_cst_LetExpCS_OCLExpressionCS, gen_ocl_cst_InvCS_InvOrDefCS, gen_ocl_cst_DefCS_InvOrDefCS, gen_ocl_cst_MessageExpCS_OCLExpressionCS, gen_ocl_cst_OCLMessageArgCS_CSTNode, gen_ocl_cst_LiteralExpCS_OCLExpressionCS, gen_ocl_cst_EnumLiteralExpCS_LiteralExpCS, gen_ocl_cst_CollectionLiteralExpCS_LiteralExpCS, gen_ocl_cst_CollectionLiteralPartCS_CSTNode, gen_ocl_cst_IfExpCS_OCLExpressionCS, gen_ocl_cst_PrimitiveLiteralExpCS_LiteralExpCS, gen_ocl_cst_IntegerLiteralExpCS_PrimitiveLiteralExpCS, gen_ocl_cst_UnlimitedNaturalLiteralExpCS_PrimitiveLiteralExpCS, gen_ocl_cst_RealLiteralExpCS_PrimitiveLiteralExpCS, gen_ocl_cst_StringLiteralExpCS_PrimitiveLiteralExpCS, gen_ocl_cst_BooleanLiteralExpCS_PrimitiveLiteralExpCS, gen_ocl_cst_NullLiteralExpCS_LiteralExpCS, gen_ocl_cst_InvalidLiteralExpCS_LiteralExpCS, gen_ocl_cst_CollectionRangeCS_CollectionLiteralPartCS, gen_ocl_cst_CallExpCS_OCLExpressionCS, gen_ocl_cst_LoopExpCS_CallExpCS, gen_ocl_cst_TupleLiteralExpCS_LiteralExpCS, gen_ocl_cst_OperationCallExpCS_FeatureCallExpCS, gen_ocl_cst_StateExpCS_TypeCS, gen_ocl_cst_OCLDocumentCS_CSTNode, gen_ocl_cst_IteratorExpCS_LoopExpCS, gen_ocl_cst_IterateExpCS_LoopExpCS, gen_ocl_cst_FeatureCallExpCS_CallExpCS},
    metadata=None
)
