...
class Projects_Company:
    ...
    def __init__(self, name: str, Company: "Projects_Worker" = None, Company7: "Projects_Project" = None, company: set["Projects_Project"] = None, employer: set["Projects_Worker"] = None):
        self.name = name
    ...
    def createProject(self, Projects_ws, Projects_s, Projects_qs, Projects_n) :
...
class Projects_Worker:
    ...
    def __init__(self, nickname: str, salary: int, employees: "Projects_Company" = None, workers: set["Projects_Qualification"] = None, members: set["Projects_Project"] = None, Worker10: "Projects_Project" = None, Worker: "Projects_Company" = None, Worker21: "Projects_Qualification" = None):
...
class Projects_Project:
    ...
    def __init__(self, name: str, size: str, status: str, Project5: "Projects_Worker" = None, projects: "Projects_Company" = None, projects9: set["Projects_Worker"] = None, projects12: set["Projects_Qualification"] = None, Project16: "Projects_Project" = None, successors: set["Projects_Project"] = None, Project19: "Projects_Project" = None, predecessors: set["Projects_Project"] = None, Project: "Projects_Company" = None, Project23: "Projects_Qualification" = None):
        self.name = name
        self.size = size
        self.status = status
