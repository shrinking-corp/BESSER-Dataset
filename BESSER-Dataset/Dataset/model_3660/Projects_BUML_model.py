...
Projects_Company_m_createProject: Method = Method(name="createProject", parameters={Parameter(name='Projects_qs', type=StringType), Parameter(name='Projects_ws', type=StringType), Parameter(name='Projects_s', type=StringType), Parameter(name='Projects_n', type=StringType)}, type=StringType)
...
Projects_Company.methods={Projects_Company_m_fire, Projects_Company_m_finish, Projects_Company_m_createWorker, Projects_Company_m_start, Projects_Company_m_hire, Projects_Company_m_createProject}
...
Projects_Project.attributes={Projects_Project_size, Projects_Project_name, Projects_Project_status}
...
domain_model = DomainModel(
    name="Projects",
    types={Projects_Company, Projects_Qualification, Projects_Project, Projects_Worker, Projects_Training, Project, ProjectSize, ProjectStatus},
    associations={employer2, qualifications3, projects4, company6, members8, requirements11, predecessors15, successors18, projects0, employees1, workers20, projects22, trainings24, trained25},
