...
standardPetriNets_Place.attributes={standardPetriNets_Place_capacity, standardPetriNets_Place_name, standardPetriNets_Place_numOfTokens}
...
domain_model = DomainModel(
    ...
    types={standardPetriNets_Place, standardPetriNets_Transition, standardPetriNets_OutputArc, standardPetriNets_PetriNet, standardPetriNets_InputArc},
    associations={inputArcToTransition1, outputArcFromTransition3, outputArcToPlace5, containsPlaces8, inputArcFromPlace0, containsOutputArcs16, containsTransitions10, containsInputArcs13},
    generalizations={},
    metadata=None
)
