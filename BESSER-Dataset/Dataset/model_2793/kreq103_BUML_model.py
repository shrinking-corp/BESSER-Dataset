...
# Classes
kreq103_Bbbb = Class(name="kreq103_Bbbb")
kreq103_Cccc = Class(name="kreq103_Cccc")
kreq103_Gggg = Class(name="kreq103_Gggg")
kreq103_Ffff = Class(name="kreq103_Ffff")
...
domain_model = DomainModel(
    name="kreq103",
    types={kreq103_Bbbb, kreq103_Cccc, kreq103_Gggg, kreq103_Ffff, RequirementOrigin, ComponentPosition, CategoryType, ComponentType, BasicFlowTransformationType},
    associations={cs0, gs1, fs3, subFs6},
    generalizations={},
    metadata=None
)
