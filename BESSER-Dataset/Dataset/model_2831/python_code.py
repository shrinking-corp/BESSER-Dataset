...
class mm_styles_AbstractStyle(ABC):
    ...
    def __init__(self, lineWidth: str, lineStyle: str, filled: str, lineVisible: str, transparency: str, mm_styles_AbstractStyle: "styles_Color" = None, mm_styles_AbstractStyle56: "styles_Color" = None, mm_styles_AbstractStyle59: "styles_RenderingStyle" = None):
        ...
        self.mm_styles_AbstractStyle56 = mm_styles_AbstractStyle56
        self.mm_styles_AbstractStyle59 = mm_styles_AbstractStyle59
    ...
    @property
    def mm_styles_AbstractStyle56(self):
        return self.__mm_styles_AbstractStyle56

    @mm_styles_AbstractStyle56.setter
    def mm_styles_AbstractStyle56(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_mm_styles_AbstractStyle__mm_styles_AbstractStyle56", None)
        self.__mm_styles_AbstractStyle56 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "styles_Color57"):
                opp_val = getattr(old_value, "styles_Color57", None)
                if opp_val == self:
                    setattr(old_value, "styles_Color57", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "styles_Color57"):
                opp_val = getattr(value, "styles_Color57", None)
                setattr(value, "styles_Color57", self)
    ...
    def mm_styles_AbstractStyle(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "styles_Color54"):
                opp_val = getattr(old_value, "styles_Color54", None)
                if opp_val == self:
                    setattr(old_value, "styles_Color54", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "styles_Color54"):
                opp_val = getattr(value, "styles_Color54", None)
                setattr(value, "styles_Color54", self)

    @property
    def mm_styles_AbstractStyle59(self):
        return self.__mm_styles_AbstractStyle59

    @mm_styles_AbstractStyle59.setter
    def mm_styles_AbstractStyle59(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_mm_styles_AbstractStyle__mm_styles_AbstractStyle59", None)
        self.__mm_styles_AbstractStyle59 = value
...
class mm_pictograms_AdvancedAnchor(Anchor):
    ...
    def __init__(self, useAnchorLocationAsConnectionEndpoint: bool, Anchor28: "mm_pictograms_AnchorContainer" = None, Anchor: "mm_pictograms_Connection" = None, Anchor16: "mm_pictograms_Connection" = None):
...
class mm_algorithms_PlatformGraphicsAlgorithm(GraphicsAlgorithm):
    ...
    def __init__(self, id: str, GraphicsAlgorithm41: "mm_algorithms_GraphicsAlgorithm" = None, GraphicsAlgorithm39: "mm_algorithms_GraphicsAlgorithm" = None, GraphicsAlgorithm25: "mm_pictograms_Anchor" = None, GraphicsAlgorithm: "mm_pictograms_PictogramElement" = None):
        self.id = id
...
class mm_algorithms_Image(GraphicsAlgorithm):
    ...
    def __init__(self, id: str, stretchH: str, stretchV: str, proportional: str, GraphicsAlgorithm41: "mm_algorithms_GraphicsAlgorithm" = None, GraphicsAlgorithm39: "mm_algorithms_GraphicsAlgorithm" = None, GraphicsAlgorithm25: "mm_pictograms_Anchor" = None, GraphicsAlgorithm: "mm_pictograms_PictogramElement" = None):
        self.id = id
...
class mm_algorithms_AbstractText(GraphicsAlgorithm):
    ...
    def __init__(self, verticalAlignment: str, angle: str, value: str, horizontalAlignment: str, mm_algorithms_AbstractText: "styles_Font" = None, GraphicsAlgorithm41: "mm_algorithms_GraphicsAlgorithm" = None, GraphicsAlgorithm39: "mm_algorithms_GraphicsAlgorithm" = None, GraphicsAlgorithm25: "mm_pictograms_Anchor" = None, GraphicsAlgorithm: "mm_pictograms_PictogramElement" = None):
...
class mm_algorithms_RoundedRectangle(GraphicsAlgorithm):
    ...
    def __init__(self, cornerHeight: int, cornerWidth: int, GraphicsAlgorithm41: "mm_algorithms_GraphicsAlgorithm" = None, GraphicsAlgorithm39: "mm_algorithms_GraphicsAlgorithm" = None, GraphicsAlgorithm25: "mm_pictograms_Anchor" = None, GraphicsAlgorithm: "mm_pictograms_PictogramElement" = None):
...
class mm_algorithms_GraphicsAlgorithm(GraphicsAlgorithmContainer, styles_AbstractStyle):
    ...
    def __init__(self, width: int, height: int, x: int, y: int, parentGraphicsAlgorithm: set["GraphicsAlgorithm"] = None, graphicsAlgorithmChildren: "GraphicsAlgorithm" = None, graphicsAlgorithm: "PictogramElement" = None, mm_algorithms_GraphicsAlgorithm: "styles_Style" = None):
        self.width = width
        self.height = height
        self.x = x
        self.y = y
...
class mm_styles_Style(styles_AbstractStyle, StyleContainer):
    ...
    def __init__(self, id: str, description: str, horizontalAlignment: str, verticalAlignment: str, angle: str, stretchH: str, stretchV: str, proportional: str, mm_styles_Style: "styles_Font" = None, styles: "styles_mm_StyleContainer" = None):
        self.id = id
    ...
    def mm_styles_Style(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "styles_Font51"):
                opp_val = getattr(old_value, "styles_Font51", None)
                if opp_val == self:
                    setattr(old_value, "styles_Font51", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "styles_Font51"):
                opp_val = getattr(value, "styles_Font51", None)
                setattr(value, "styles_Font51", self)
