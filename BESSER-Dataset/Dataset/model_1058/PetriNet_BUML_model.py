...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={PetriNet_Element, PetriNet_PetriNet, Element, Place, Transition, PetriNet, PetriNet_Transition, PetriNet_Arc, PetriNet_PlaceToTransArc, PetriNet_TransToPlaceArc, Arc, PetriNet_Place, TransToPlaceArc, PlaceToTransArc},
    associations={places0, transitions1, net6, incoming7, outgoing10, source13, target15, source17, target20, arcs2, incoming4, outgoing5},
