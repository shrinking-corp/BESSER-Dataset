...
class fragdial_Content:
    ...
    def __init__(self, class_: str, language: str, fragdial_Content: "fragdial_AbstractComponent" = None, fragdial_Content19: "fragdial_AbstractComponent" = None, fragdial_Content22: set["fragdial_Include"] = None, fragdial_Content24: set["fragdial_Ldflag"] = None):
        self.class_ = class_
        self.language = language
