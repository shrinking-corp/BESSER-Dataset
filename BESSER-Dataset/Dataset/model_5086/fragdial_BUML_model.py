...
# Classes
fragdial_AbstractComponent = Class(name="fragdial_AbstractComponent", is_abstract=True)
fragdial_Interface = Class(name="fragdial_Interface", is_abstract=True)
fragdial_Content = Class(name="fragdial_Content")
fragdial_Attributes = Class(name="fragdial_Attributes")
fragdial_Output = Class(name="fragdial_Output")
fragdial_Controller = Class(name="fragdial_Controller")
fragdial_Required = Class(name="fragdial_Required")
fragdial_Provided = Class(name="fragdial_Provided")
fragdial_Binding = Class(name="fragdial_Binding")
fragdial_Include = Class(name="fragdial_Include")
fragdial_Ldflag = Class(name="fragdial_Ldflag")
fragdial_Attribute = Class(name="fragdial_Attribute")
Interface = Class(name="Interface")
fragdial_Component = Class(name="fragdial_Component")
AbstractComponent = Class(name="AbstractComponent")
fragdial_Component1 = Class(name="fragdial_Component1")
fragdial_Component2 = Class(name="fragdial_Component2")
fragdial_Component3 = Class(name="fragdial_Component3")
...
fragdial_Interface.attributes={fragdial_Interface_signature, fragdial_Interface_contingency, fragdial_Interface_cardinality, fragdial_Interface_startProperty, fragdial_Interface_name}

# fragdial_Content class attributes and methods
fragdial_Content_class_: Property = Property(name="class_", type=StringType)
fragdial_Content_language: Property = Property(name="language", type=StringType)
fragdial_Content.attributes={fragdial_Content_language, fragdial_Content_class_}
...
fragdial_Attribute.attributes={fragdial_Attribute_name, fragdial_Attribute_value}
...
domain_model = DomainModel(
    name="fragdial",
    types={fragdial_AbstractComponent, fragdial_Interface, fragdial_Content, fragdial_Attributes, fragdial_Output, fragdial_Controller, fragdial_Required, fragdial_Provided, fragdial_Binding, fragdial_Include, fragdial_Ldflag, fragdial_Attribute, Interface, fragdial_Component, AbstractComponent, fragdial_Component1, fragdial_Component2, fragdial_Component3},
    associations={providedInterfaces9, content0, attributes1, output3, controller5, requiredInterfaces7, contentParent18, bindings11, from_12, to15, includes21, ldflags23, attributes25, nestedComponents127, subComponents29, nestedComponents231, nestedComponents333},
    generalizations={gen_fragdial_Required_Interface, gen_fragdial_Provided_Interface, gen_fragdial_Component_AbstractComponent, gen_fragdial_Component1_AbstractComponent, gen_fragdial_Component2_AbstractComponent, gen_fragdial_Component3_AbstractComponent},
    metadata=None
)
