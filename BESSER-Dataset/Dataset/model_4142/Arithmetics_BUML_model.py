...
domain_model = DomainModel(
    name="arithmetics",
    types={arithmetics_Multi, arithmetics_Div, arithmetics_NumberLiteral, arithmetics_Evaluation, arithmetics_Expression, arithmetics_Plus, Expression, arithmetics_Minus},
    associations={left6, right8, left11, right13, left16, right18, expression0, left1, right3},
    generalizations={gen_arithmetics_Multi_Expression, gen_arithmetics_Div_Expression, gen_arithmetics_NumberLiteral_Expression, gen_arithmetics_Plus_Expression, gen_arithmetics_Minus_Expression},
    metadata=None
)
