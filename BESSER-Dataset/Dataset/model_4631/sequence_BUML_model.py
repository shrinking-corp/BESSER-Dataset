...
# Classes
sequence_description_InstanceRoleMapping = Class(name="sequence_description_InstanceRoleMapping")
NodeMapping = Class(name="NodeMapping")
sequence_description_EventMapping = Class(name="sequence_description_EventMapping", is_abstract=True)
sequence_description_DelimitedEventMapping = Class(name="sequence_description_DelimitedEventMapping", is_abstract=True)
EventMapping = Class(name="EventMapping")
sequence_description_ExecutionMapping = Class(name="sequence_description_ExecutionMapping")
description_NodeMapping = Class(name="description_NodeMapping")
sequence_SequenceDDiagram = Class(name="sequence_SequenceDDiagram")
...
sequence_description_SequenceDiagramDescription = Class(name="sequence_description_SequenceDiagramDescription")
DiagramDescription = Class(name="DiagramDescription")
sequence_description_InteractionUseMapping = Class(name="sequence_description_InteractionUseMapping")
FrameMapping = Class(name="FrameMapping")
sequence_description_CombinedFragmentMapping = Class(name="sequence_description_CombinedFragmentMapping")
sequence_description_OperandMapping = Class(name="sequence_description_OperandMapping")
sequence_description_ObservationPointMapping = Class(name="sequence_description_ObservationPointMapping")
sequence_tool_SequenceDiagramToolDescription = Class(name="sequence_tool_SequenceDiagramToolDescription")
sequence_tool_OrderedElementCreationTool = Class(name="sequence_tool_OrderedElementCreationTool", is_abstract=True)
MessageEndVariable = Class(name="MessageEndVariable")
description_DelimitedEventMapping = Class(name="description_DelimitedEventMapping")
sequence_description_StateMapping = Class(name="sequence_description_StateMapping")
sequence_description_EndOfLifeMapping = Class(name="sequence_description_EndOfLifeMapping")
sequence_description_MessageMapping = Class(name="sequence_description_MessageMapping", is_abstract=True)
description_EdgeMapping = Class(name="description_EdgeMapping")
description_EventMapping = Class(name="description_EventMapping")
sequence_tool_CoveringElementCreationTool = Class(name="sequence_tool_CoveringElementCreationTool", is_abstract=True)
CoveredLifelinesVariable = Class(name="CoveredLifelinesVariable")
sequence_tool_InstanceRoleCreationTool = Class(name="sequence_tool_InstanceRoleCreationTool")
tool_NodeCreationDescription = Class(name="tool_NodeCreationDescription")
tool_SequenceDiagramToolDescription = Class(name="tool_SequenceDiagramToolDescription")
tool_ElementVariable = Class(name="tool_ElementVariable")
sequence_description_BasicMessageMapping = Class(name="sequence_description_BasicMessageMapping")
MessageMapping = Class(name="MessageMapping")
sequence_description_ReturnMessageMapping = Class(name="sequence_description_ReturnMessageMapping")
sequence_tool_LifelineCreationTool = Class(name="sequence_tool_LifelineCreationTool")
tool_ContainerCreationDescription = Class(name="tool_ContainerCreationDescription")
sequence_tool_MessageCreationTool = Class(name="sequence_tool_MessageCreationTool")
tool_EdgeCreationDescription = Class(name="tool_EdgeCreationDescription")
tool_OrderedElementCreationTool = Class(name="tool_OrderedElementCreationTool")
sequence_description_CreationMessageMapping = Class(name="sequence_description_CreationMessageMapping")
sequence_tool_ExecutionCreationTool = Class(name="sequence_tool_ExecutionCreationTool")
sequence_description_DestructionMessageMapping = Class(name="sequence_description_DestructionMessageMapping")
sequence_description_MessageEndVariable = Class(name="sequence_description_MessageEndVariable")
sequence_tool_StateCreationTool = Class(name="sequence_tool_StateCreationTool")
AbstractVariable = Class(name="AbstractVariable")
sequence_description_CoveredLifelinesVariable = Class(name="sequence_description_CoveredLifelinesVariable")
sequence_description_FrameMapping = Class(name="sequence_description_FrameMapping", is_abstract=True)
description_ContainerMapping = Class(name="description_ContainerMapping")
sequence_tool_CombinedFragmentCreationTool = Class(name="sequence_tool_CombinedFragmentCreationTool")
sequence_tool_OperandCreationTool = Class(name="sequence_tool_OperandCreationTool")
sequence_ordering_EventEndsOrdering = Class(name="sequence_ordering_EventEndsOrdering")
sequence_tool_ObservationPointCreationTool = Class(name="sequence_tool_ObservationPointCreationTool")
sequence_tool_ReorderTool = Class(name="sequence_tool_ReorderTool")
...
sequence_tool_InstanceRoleReorderTool = Class(name="sequence_tool_InstanceRoleReorderTool")
InstanceRoleMapping = Class(name="InstanceRoleMapping")
sequence_tool_InteractionUseCreationTool = Class(name="sequence_tool_InteractionUseCreationTool")
tool_CoveringElementCreationTool = Class(name="tool_CoveringElementCreationTool")
ordering_sequence_SequenceDDiagram = Class(name="ordering_sequence_SequenceDDiagram")
EventEnd = Class(name="EventEnd")
sequence_ordering_EventEnd = Class(name="sequence_ordering_EventEnd", is_abstract=True)
ordering_sequence_EObject = Class(name="ordering_sequence_EObject")
sequence_ordering_SingleEventEnd = Class(name="sequence_ordering_SingleEventEnd")
sequence_ordering_CompoundEventEnd = Class(name="sequence_ordering_CompoundEventEnd")
SingleEventEnd = Class(name="SingleEventEnd")
sequence_ordering_InstanceRolesOrdering = Class(name="sequence_ordering_InstanceRolesOrdering")
sequence_template_TTransformer = Class(name="sequence_template_TTransformer")
template_sequence_EObject = Class(name="template_sequence_EObject")
sequence_template_TAbstractMapping = Class(name="sequence_template_TAbstractMapping")
TTransformer = Class(name="TTransformer")
sequence_template_TMessageExtremity = Class(name="sequence_template_TMessageExtremity", is_abstract=True)
sequence_template_TLifelineMapping = Class(name="sequence_template_TLifelineMapping")
template_TAbstractMapping = Class(name="template_TAbstractMapping")
sequence_template_TSequenceDiagram = Class(name="sequence_template_TSequenceDiagram")
description_RepresentationTemplate = Class(name="description_RepresentationTemplate")
template_TTransformer = Class(name="template_TTransformer")
TLifelineMapping = Class(name="TLifelineMapping")
TMessageMapping = Class(name="TMessageMapping")
template_TMessageExtremity = Class(name="template_TMessageExtremity")
...
sequence_template_TLifelineStyle = Class(name="sequence_template_TLifelineStyle")
ColorDescription = Class(name="ColorDescription")
sequence_template_TConditionalLifelineStyle = Class(name="sequence_template_TConditionalLifelineStyle")
sequence_template_TExecutionMapping = Class(name="sequence_template_TExecutionMapping")
TExecutionStyle = Class(name="TExecutionStyle")
TConditionalExecutionStyle = Class(name="TConditionalExecutionStyle")
sequence_template_TExecutionStyle = Class(name="sequence_template_TExecutionStyle")
sequence_template_TConditionalExecutionStyle = Class(name="sequence_template_TConditionalExecutionStyle")
sequence_template_TMessageMapping = Class(name="sequence_template_TMessageMapping", is_abstract=True)
...
sequence_template_TConditionalMessageStyle = Class(name="sequence_template_TConditionalMessageStyle")
sequence_template_TBasicMessageMapping = Class(name="sequence_template_TBasicMessageMapping")
TSourceTargetMessageMapping = Class(name="TSourceTargetMessageMapping")
TMessageExtremity = Class(name="TMessageExtremity")
sequence_template_TSourceTargetMessageMapping = Class(name="sequence_template_TSourceTargetMessageMapping", is_abstract=True)
sequence_template_TMessageStyle = Class(name="sequence_template_TMessageStyle")
sequence_template_TReturnMessageMapping = Class(name="sequence_template_TReturnMessageMapping")
TBasicMessageMapping = Class(name="TBasicMessageMapping")
sequence_template_TCreationMessageMapping = Class(name="sequence_template_TCreationMessageMapping")
sequence_template_TDestructionMessageMapping = Class(name="sequence_template_TDestructionMessageMapping")
...
sequence_description_DelimitedEventMapping.attributes={sequence_description_DelimitedEventMapping_startingEndFinderExpression, sequence_description_DelimitedEventMapping_finishingEndFinderExpression}
...
sequence_description_FrameMapping.attributes={sequence_description_FrameMapping_coveredLifelinesExpression, sequence_description_FrameMapping_centerLabelExpression}
...
sequence_template_TSequenceDiagram.attributes={sequence_template_TSequenceDiagram_endsOrdering, sequence_template_TSequenceDiagram_domainClass}
...
sequence_template_TExecutionMapping.attributes={sequence_template_TExecutionMapping_startingEndFinderExpression, sequence_template_TExecutionMapping_finishingEndFinderExpression, sequence_template_TExecutionMapping_recursive}
...
sequence_template_TSourceTargetMessageMapping.attributes={sequence_template_TSourceTargetMessageMapping_targetFinderExpression, sequence_template_TSourceTargetMessageMapping_sourceFinderExpression, sequence_template_TSourceTargetMessageMapping_useDomainElement}
...
sequence_template_TMessageStyle.attributes={sequence_template_TMessageStyle_targetArrow, sequence_template_TMessageStyle_labelExpression, sequence_template_TMessageStyle_lineStyle, sequence_template_TMessageStyle_sourceArrow}
...
domain_model = DomainModel(
    name="sequence",
    types={sequence_description_InstanceRoleMapping, NodeMapping, sequence_description_EventMapping, sequence_description_DelimitedEventMapping, EventMapping, sequence_description_ExecutionMapping, description_NodeMapping, sequence_SequenceDDiagram, DSemanticDiagram, EventEndsOrdering, InstanceRolesOrdering, sequence_description_SequenceDiagramDescription, DiagramDescription, sequence_description_InteractionUseMapping, FrameMapping, sequence_description_CombinedFragmentMapping, sequence_description_OperandMapping, sequence_description_ObservationPointMapping, sequence_tool_SequenceDiagramToolDescription, sequence_tool_OrderedElementCreationTool, MessageEndVariable, description_DelimitedEventMapping, sequence_description_StateMapping, sequence_description_EndOfLifeMapping, sequence_description_MessageMapping, description_EdgeMapping, description_EventMapping, sequence_tool_CoveringElementCreationTool, CoveredLifelinesVariable, sequence_tool_InstanceRoleCreationTool, tool_NodeCreationDescription, tool_SequenceDiagramToolDescription, tool_ElementVariable, sequence_description_BasicMessageMapping, MessageMapping, sequence_description_ReturnMessageMapping, sequence_tool_LifelineCreationTool, tool_ContainerCreationDescription, sequence_tool_MessageCreationTool, tool_EdgeCreationDescription, tool_OrderedElementCreationTool, sequence_description_CreationMessageMapping, sequence_tool_ExecutionCreationTool, sequence_description_DestructionMessageMapping, sequence_description_MessageEndVariable, sequence_tool_StateCreationTool, AbstractVariable, sequence_description_CoveredLifelinesVariable, sequence_description_FrameMapping, description_ContainerMapping, sequence_tool_CombinedFragmentCreationTool, sequence_tool_OperandCreationTool, sequence_ordering_EventEndsOrdering, sequence_tool_ObservationPointCreationTool, sequence_tool_ReorderTool, tool_AbstractToolDescription, tool_InitialOperation, sequence_tool_InstanceRoleReorderTool, InstanceRoleMapping, sequence_tool_InteractionUseCreationTool, tool_CoveringElementCreationTool, ordering_sequence_SequenceDDiagram, EventEnd, sequence_ordering_EventEnd, ordering_sequence_EObject, sequence_ordering_SingleEventEnd, sequence_ordering_CompoundEventEnd, SingleEventEnd, sequence_ordering_InstanceRolesOrdering, sequence_template_TTransformer, template_sequence_EObject, sequence_template_TAbstractMapping, TTransformer, sequence_template_TMessageExtremity, sequence_template_TLifelineMapping, template_TAbstractMapping, sequence_template_TSequenceDiagram, description_RepresentationTemplate, template_TTransformer, TLifelineMapping, TMessageMapping, template_TMessageExtremity, TExecutionMapping, style_NodeStyleDescription, TLifelineStyle, TConditionalLifelineStyle, sequence_template_TLifelineStyle, ColorDescription, sequence_template_TConditionalLifelineStyle, sequence_template_TExecutionMapping, TExecutionStyle, TConditionalExecutionStyle, sequence_template_TExecutionStyle, sequence_template_TConditionalExecutionStyle, sequence_template_TMessageMapping, TAbstractMapping, TMessageStyle, TConditionalMessageStyle, sequence_template_TConditionalMessageStyle, sequence_template_TBasicMessageMapping, TSourceTargetMessageMapping, TMessageExtremity, sequence_template_TSourceTargetMessageMapping, sequence_template_TMessageStyle, sequence_template_TReturnMessageMapping, TBasicMessageMapping, sequence_template_TCreationMessageMapping, sequence_template_TDestructionMessageMapping},
    associations={semanticOrdering0, graphicalOrdering1, instanceRoleSemanticOrdering4, startingEndPredecessor6, finishingEndPredecessor7, coveredLifelines10, predecessor11, mappings12, startingEndPredecessorBefore13, startingEndPredecessorAfter16, finishingEndPredecessorBefore19, finishingEndPredecessorAfter22, onEventMovedOperation25, mappings27, predecessorBefore28, predecessorAfter31, instanceRoleMoved34, sequenceDiagram37, eventEnds38, semanticEnd40, semanticEvent41, eventEnds43, semanticInstanceRoles44, outputs46, lifelineMappings47, messageMappings48, executionMappings50, instanceRoleStyle51, lifelineStyle53, endOfLifeStyle55, conditionalLifeLineStyles58, lifelineColor60, style61, executionMappings63, style65, conditionalStyles67, borderColor69, backgroundColor71, style74, style76, conditionalStyle77, style81, target83, source84, strokeColor79, invocationMapping86, target87, target89},
    generalizations={gen_sequence_description_InstanceRoleMapping_NodeMapping, gen_sequence_description_DelimitedEventMapping_EventMapping, gen_sequence_description_ExecutionMapping_description_NodeMapping, gen_sequence_SequenceDDiagram_DSemanticDiagram, gen_sequence_description_SequenceDiagramDescription_DiagramDescription, gen_sequence_description_InteractionUseMapping_FrameMapping, gen_sequence_description_CombinedFragmentMapping_FrameMapping, gen_sequence_description_OperandMapping_description_ContainerMapping, gen_sequence_description_OperandMapping_description_DelimitedEventMapping, gen_sequence_description_ObservationPointMapping_NodeMapping, gen_sequence_description_ExecutionMapping_description_DelimitedEventMapping, gen_sequence_description_StateMapping_description_NodeMapping, gen_sequence_description_StateMapping_description_DelimitedEventMapping, gen_sequence_description_EndOfLifeMapping_NodeMapping, gen_sequence_description_MessageMapping_description_EdgeMapping, gen_sequence_description_MessageMapping_description_EventMapping, gen_sequence_tool_InstanceRoleCreationTool_tool_NodeCreationDescription, gen_sequence_tool_InstanceRoleCreationTool_tool_SequenceDiagramToolDescription, gen_sequence_description_BasicMessageMapping_MessageMapping, gen_sequence_description_ReturnMessageMapping_MessageMapping, gen_sequence_tool_LifelineCreationTool_tool_ContainerCreationDescription, gen_sequence_tool_LifelineCreationTool_tool_SequenceDiagramToolDescription, gen_sequence_tool_MessageCreationTool_tool_SequenceDiagramToolDescription, gen_sequence_tool_MessageCreationTool_tool_EdgeCreationDescription, gen_sequence_tool_MessageCreationTool_tool_OrderedElementCreationTool, gen_sequence_description_CreationMessageMapping_MessageMapping, gen_sequence_tool_ExecutionCreationTool_tool_NodeCreationDescription, gen_sequence_tool_ExecutionCreationTool_tool_SequenceDiagramToolDescription, gen_sequence_description_DestructionMessageMapping_MessageMapping, gen_sequence_tool_ExecutionCreationTool_tool_OrderedElementCreationTool, gen_sequence_description_MessageEndVariable_AbstractVariable, gen_sequence_tool_StateCreationTool_tool_NodeCreationDescription, gen_sequence_tool_StateCreationTool_tool_SequenceDiagramToolDescription, gen_sequence_tool_StateCreationTool_tool_OrderedElementCreationTool, gen_sequence_description_CoveredLifelinesVariable_AbstractVariable, gen_sequence_description_FrameMapping_description_ContainerMapping, gen_sequence_description_FrameMapping_description_DelimitedEventMapping, gen_sequence_tool_CombinedFragmentCreationTool_tool_ContainerCreationDescription, gen_sequence_tool_CombinedFragmentCreationTool_tool_SequenceDiagramToolDescription, gen_sequence_tool_CombinedFragmentCreationTool_tool_OrderedElementCreationTool, gen_sequence_tool_CombinedFragmentCreationTool_tool_CoveringElementCreationTool, gen_sequence_tool_OperandCreationTool_tool_ContainerCreationDescription, gen_sequence_tool_OperandCreationTool_tool_SequenceDiagramToolDescription, gen_sequence_tool_OperandCreationTool_tool_OrderedElementCreationTool, gen_sequence_tool_ObservationPointCreationTool_tool_NodeCreationDescription, gen_sequence_tool_ObservationPointCreationTool_tool_SequenceDiagramToolDescription, gen_sequence_tool_ObservationPointCreationTool_tool_OrderedElementCreationTool, gen_sequence_tool_ReorderTool_tool_AbstractToolDescription, gen_sequence_tool_ReorderTool_tool_SequenceDiagramToolDescription, gen_sequence_tool_InstanceRoleReorderTool_tool_AbstractToolDescription, gen_sequence_tool_InstanceRoleReorderTool_tool_SequenceDiagramToolDescription, gen_sequence_tool_InteractionUseCreationTool_tool_ContainerCreationDescription, gen_sequence_tool_InteractionUseCreationTool_tool_SequenceDiagramToolDescription, gen_sequence_tool_InteractionUseCreationTool_tool_OrderedElementCreationTool, gen_sequence_tool_InteractionUseCreationTool_tool_CoveringElementCreationTool, gen_sequence_ordering_SingleEventEnd_EventEnd, gen_sequence_ordering_CompoundEventEnd_EventEnd, gen_sequence_template_TAbstractMapping_TTransformer, gen_sequence_template_TLifelineMapping_template_TAbstractMapping, gen_sequence_template_TSequenceDiagram_description_RepresentationTemplate, gen_sequence_template_TSequenceDiagram_template_TTransformer, gen_sequence_template_TLifelineMapping_template_TMessageExtremity, gen_sequence_template_TLifelineStyle_TTransformer, gen_sequence_template_TConditionalLifelineStyle_TTransformer, gen_sequence_template_TExecutionMapping_template_TAbstractMapping, gen_sequence_template_TExecutionMapping_template_TMessageExtremity, gen_sequence_template_TExecutionStyle_TTransformer, gen_sequence_template_TConditionalExecutionStyle_TTransformer, gen_sequence_template_TMessageMapping_TAbstractMapping, gen_sequence_template_TConditionalMessageStyle_TTransformer, gen_sequence_template_TBasicMessageMapping_TSourceTargetMessageMapping, gen_sequence_template_TSourceTargetMessageMapping_TMessageMapping, gen_sequence_template_TMessageStyle_TTransformer, gen_sequence_template_TReturnMessageMapping_TMessageMapping, gen_sequence_template_TCreationMessageMapping_TSourceTargetMessageMapping, gen_sequence_template_TDestructionMessageMapping_TSourceTargetMessageMapping},
    metadata=None
)
