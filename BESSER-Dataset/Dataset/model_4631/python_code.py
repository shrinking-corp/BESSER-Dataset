...
class sequence_template_TExecutionMapping(template_TMessageExtremity, template_TAbstractMapping):
    ...
    def __init__(self, finishingEndFinderExpression: str, startingEndFinderExpression: str, recursive: bool, sequence_template_TExecutionMapping: set["TExecutionMapping"] = None, sequence_template_TExecutionMapping66: "TExecutionStyle" = None, sequence_template_TExecutionMapping68: set["TConditionalExecutionStyle"] = None):
...
class tool_SequenceDiagramToolDescription:
    ...
    pass
class sequence_tool_CombinedFragmentCreationTool(tool_CoveringElementCreationTool, tool_OrderedElementCreationTool, tool_ContainerCreationDescription, tool_SequenceDiagramToolDescription):

    pass
class sequence_tool_MessageCreationTool(tool_OrderedElementCreationTool, tool_EdgeCreationDescription, tool_SequenceDiagramToolDescription):

    pass
class sequence_tool_ReorderTool(tool_AbstractToolDescription, tool_SequenceDiagramToolDescription):

    pass
class sequence_tool_OperandCreationTool(tool_OrderedElementCreationTool, tool_ContainerCreationDescription, tool_SequenceDiagramToolDescription):

    pass
class sequence_tool_LifelineCreationTool(tool_ContainerCreationDescription, tool_SequenceDiagramToolDescription):

    pass
class sequence_tool_InteractionUseCreationTool(tool_CoveringElementCreationTool, tool_OrderedElementCreationTool, tool_ContainerCreationDescription, tool_SequenceDiagramToolDescription):
...
class tool_NodeCreationDescription:
    ...
    pass
class sequence_tool_ObservationPointCreationTool(tool_OrderedElementCreationTool, tool_NodeCreationDescription, tool_SequenceDiagramToolDescription):

    pass
class sequence_tool_StateCreationTool(tool_OrderedElementCreationTool, tool_NodeCreationDescription, tool_SequenceDiagramToolDescription):

    pass
class sequence_tool_ExecutionCreationTool(tool_OrderedElementCreationTool, tool_NodeCreationDescription, tool_SequenceDiagramToolDescription):
