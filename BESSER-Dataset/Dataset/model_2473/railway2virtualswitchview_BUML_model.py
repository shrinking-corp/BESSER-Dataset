...
# Classes
railway2virtualswitchview_Switch2VirtualSwitch = Class(name="railway2virtualswitchview_Switch2VirtualSwitch")
railway2virtualswitchview_Switch = Class(name="railway2virtualswitchview_Switch")
railway2virtualswitchview_VirtualSwitch = Class(name="railway2virtualswitchview_VirtualSwitch")
railway2virtualswitchview_Railway2VirtualSwitchViewTrace = Class(name="railway2virtualswitchview_Railway2VirtualSwitchViewTrace")
railway2virtualswitchview_RailwayContainer = Class(name="railway2virtualswitchview_RailwayContainer")
...
domain_model = DomainModel(
    ...
    types={railway2virtualswitchview_Switch2VirtualSwitch, railway2virtualswitchview_Switch, railway2virtualswitchview_VirtualSwitch, railway2virtualswitchview_Railway2VirtualSwitchViewTrace, railway2virtualswitchview_RailwayContainer},
    associations={switch0, virtualSwitch1, traceLinks3, source5},
    generalizations={},
    metadata=None
)
