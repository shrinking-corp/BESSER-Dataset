...
railway2virtualswitchview_Railway2VirtualSwitchViewTrace_strategy = st.builds(railway2virtualswitchview_Railway2VirtualSwitchViewTrace)
...
railway2virtualswitchview_RailwayContainer_strategy = st.builds(railway2virtualswitchview_RailwayContainer)
...
railway2virtualswitchview_Switch_strategy = st.builds(railway2virtualswitchview_Switch)
...
railway2virtualswitchview_Switch2VirtualSwitch_strategy = st.builds(railway2virtualswitchview_Switch2VirtualSwitch)
...
railway2virtualswitchview_VirtualSwitch_strategy = st.builds(railway2virtualswitchview_VirtualSwitch)
