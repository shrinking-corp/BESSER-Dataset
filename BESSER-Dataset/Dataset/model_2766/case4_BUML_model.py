...
# Classes
case4_D = Class(name="case4_D")
T = Class(name="T")
case4_N = Class(name="case4_N")
Named = Class(name="Named")
case4_T = Class(name="case4_T")
case4_A = Class(name="case4_A")
case4_B = Class(name="case4_B")
case4_Named = Class(name="case4_Named")
case4_E = Class(name="case4_E")
D = Class(name="D")
...
domain_model = DomainModel(
    name="case4",
    types={case4_D, T, case4_N, Named, case4_T, case4_A, case4_B, case4_Named, case4_E, D},
    associations={ts0, as_1, bs3, d5, ds7},
    generalizations={gen_case4_D_T, gen_case4_N_Named, gen_case4_T_Named, gen_case4_A_Named, gen_case4_B_Named, gen_case4_E_Named, gen_case4_E_D},
    metadata=None
)
