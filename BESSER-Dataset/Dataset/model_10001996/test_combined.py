...
def test_hyp_c_attC7_setter(instance):
...
@given(instance=C_strategy)
def test_hyp_c_attc3_setter(instance):
...
def test_C_attC7_value_roundtrip():
    instance = C(attC7=7, attc3=True)
    assert instance.attC7 == 7
    instance.attC7 = 13
    assert instance.attC7 == 13


def test_C_attc3_value_roundtrip():
    instance = C(attC7=7, attc3=True)
    assert instance.attc3 == True
    instance.attc3 = False
    assert instance.attc3 == False
...
C_strategy = st.builds(C, attC7=st.integers(), attc3=st.booleans())
@given(instance=C_strategy)
@settings(max_examples=25)
