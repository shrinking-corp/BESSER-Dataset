...
C_attC7: Property = Property(name="attC7", type=IntegerType)
C_attc3: Property = Property(name="attc3", type=BooleanType)
C.attributes={C_attc3, C_attC7}
...
domain_model = DomainModel(
    name="_iV__UPbkEeiqn80yrzdh8w",
    types={Y, R, Z, A, B, C, C1, C2},
