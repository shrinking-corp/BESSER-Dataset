...
def test_janus_essentialocl_variable_has_varType():
    assert hasattr(Janus_essentialocl_Variable, "varType")
    descriptor = None
    for klass in Janus_essentialocl_Variable.__mro__:
...
@given(instance=Janus_essentialocl_Variable_strategy)
def test_janus_essentialocl_variable_varType_setter(instance):
