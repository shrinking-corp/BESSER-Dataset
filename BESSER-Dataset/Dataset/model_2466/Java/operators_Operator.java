...
public class operators_Operator extends Company {
    ...
    public operators_Operator(
        ArrayList<operators_Network> operators_networks,        ArrayList<operators_Warehouse> operators_warehouses,        ArrayList<operators_ResourceExpansion> operators_resourceexpansions    ) {
