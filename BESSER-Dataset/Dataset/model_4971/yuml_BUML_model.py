...
# Classes
yuml_Class = Class(name="yuml_Class")
ColorableElement = Class(name="ColorableElement")
yuml_Attribute = Class(name="yuml_Attribute")
yuml_Method = Class(name="yuml_Method")
yuml_Model = Class(name="yuml_Model")
yuml_ModelElement = Class(name="yuml_ModelElement", is_abstract=True)
yuml_ColorableElement = Class(name="yuml_ColorableElement", is_abstract=True)
ModelElement = Class(name="ModelElement")
yuml_Relationship = Class(name="yuml_Relationship", is_abstract=True)
yuml_Association = Class(name="yuml_Association")
Relationship = Class(name="Relationship")
yuml_Cardinality = Class(name="yuml_Cardinality")
ClassMember = Class(name="ClassMember")
yuml_Inheritance = Class(name="yuml_Inheritance")
yuml_ClassMember = Class(name="yuml_ClassMember", is_abstract=True)
yuml_Note = Class(name="yuml_Note")
yuml_NoteAssociation = Class(name="yuml_NoteAssociation")
yuml_Equivalence = Class(name="yuml_Equivalence")
...
yuml_Attribute.attributes={yuml_Attribute_type, yuml_Attribute_stereotype}
...
yuml_Relationship.attributes={yuml_Relationship_sourceLabel, yuml_Relationship_targetLabel}
...
yuml_Association.attributes={yuml_Association_navigableSource, yuml_Association_targetVisibility, yuml_Association_navigableTarget, yuml_Association_type, yuml_Association_sourceVisibility}
...
yuml_Cardinality.attributes={yuml_Cardinality_lowerBound, yuml_Cardinality_upperBound}
...
yuml_ClassMember.attributes={yuml_ClassMember_visibility, yuml_ClassMember_name}
...
domain_model = DomainModel(
    name="yuml",
    types={yuml_Class, ColorableElement, yuml_Attribute, yuml_Method, yuml_Model, yuml_ModelElement, yuml_ColorableElement, ModelElement, yuml_Relationship, yuml_Association, Relationship, yuml_Cardinality, ClassMember, yuml_Inheritance, yuml_ClassMember, yuml_Note, yuml_NoteAssociation, yuml_Equivalence, AssociationType, Visibility},
    associations={attributes1, methods2, elements0, targetCardinality9, source4, target6, sourceCardinality8, note12},
    generalizations={gen_yuml_Class_ColorableElement, gen_yuml_ColorableElement_ModelElement, gen_yuml_Relationship_ModelElement, gen_yuml_Association_Relationship, gen_yuml_Attribute_ClassMember, gen_yuml_Inheritance_Relationship, gen_yuml_Method_ClassMember, gen_yuml_Note_ColorableElement, gen_yuml_NoteAssociation_Relationship, gen_yuml_Equivalence_Relationship},
    metadata=None
)
