...
class yuml_Association(Relationship):
    ...
    def __init__(self, navigableTarget: bool, type: str, navigableSource: bool, sourceVisibility: str, targetVisibility: str, yuml_Association10: "yuml_Cardinality" = None, yuml_Association: "yuml_Cardinality" = None):
