...
boolexp_BinaryExp = Class(name="boolexp_BinaryExp", is_abstract=True)
Exp = Class(name="Exp")
...
domain_model = DomainModel(
    name="boolexp",
    types={boolexp_Lit, boolexp_And, BinaryExp, boolexp_Or, boolexp_Tru, Lit, boolexp_Fals, boolexp_Exp, boolexp_BinaryExp, Exp},
    associations={lhs0, rhs1},
    generalizations={gen_boolexp_Lit_Exp, gen_boolexp_And_BinaryExp, gen_boolexp_Or_BinaryExp, gen_boolexp_Tru_Lit, gen_boolexp_Fals_Lit, gen_boolexp_BinaryExp_Exp},
    metadata=None
)
