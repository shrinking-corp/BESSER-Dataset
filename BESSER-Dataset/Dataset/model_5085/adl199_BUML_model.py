...
# Classes
adl199_AbstractComponent = Class(name="adl199_AbstractComponent", is_abstract=True)
adl199_Content = Class(name="adl199_Content")
adl199_Required = Class(name="adl199_Required")
adl199_Provided = Class(name="adl199_Provided")
adl199_Delegation = Class(name="adl199_Delegation")
adl199_Interface = Class(name="adl199_Interface", is_abstract=True)
adl199_Binding = Class(name="adl199_Binding")
Interface = Class(name="Interface")
adl199_Component = Class(name="adl199_Component")
AbstractComponent = Class(name="AbstractComponent")
adl199_AtomicComponent = Class(name="adl199_AtomicComponent")
...
adl199_Content.attributes={adl199_Content_expression, adl199_Content_language}
...
adl199_Interface.attributes={adl199_Interface_signature, adl199_Interface_name}
...
domain_model = DomainModel(
    name="adl199",
    types={adl199_AbstractComponent, adl199_Content, adl199_Required, adl199_Provided, adl199_Delegation, adl199_Interface, adl199_Binding, Interface, adl199_Component, AbstractComponent, adl199_AtomicComponent},
    associations={content0, requiredInterfaces1, providedInterfaces3, delegationInterfaces5, bindings7, from_8, to11, parent14, subComponents17},
