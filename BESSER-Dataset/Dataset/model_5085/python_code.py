...
class adl199_Interface(ABC):
    ...
    def __init__(self, name: str, signature: str, adl199_Interface: set["adl199_Binding"] = None, adl199_Interface10: "adl199_Binding" = None, adl199_Interface13: "adl199_Binding" = None):
        self.name = name
...
class adl199_AbstractComponent(ABC):
    ...
    def __init__(self, name: str, adl199_AbstractComponent4: set["adl199_Provided"] = None, adl199_AbstractComponent6: set["adl199_Delegation"] = None, adl199_AbstractComponent16: "adl199_Content" = None, adl199_AbstractComponent18: "adl199_Component" = None, adl199_AbstractComponent: "adl199_Content" = None, adl199_AbstractComponent2: set["adl199_Required"] = None):
        self.name = name
