...
def test_UML2WithID_NamedElement_visibility_value_roundtrip():
    instance = UML2WithID_NamedElement(visibility="sample_text")
...
def test_assoc_member0_link_reassign_clear():
    a = UML2WithID_NamedElement(visibility="sample_text")
...
UML2WithID_NamedElement_strategy = st.builds(UML2WithID_NamedElement, visibility=safe_text)
@given(instance=UML2WithID_NamedElement_strategy)
@settings(max_examples=25)
