...
class basic_Library:
    ...
    def __init__(self, senchaTouchVersions: str, name: str, builtin: bool, versions: str, basic_Library: set["basic_LibrarySource"] = None):
...
class basic_Parameter:
    ...
    def __init__(self, name: str, type: str, description: str, basic_Parameter: "basic_Event" = None):
        self.name = name
        self.type = type
...
class basic_File:
    ...
    def addAlias(self, basic_sourceEnd, basic_name, basic_type, basic_sourceStart):
