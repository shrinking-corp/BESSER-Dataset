...
class devs_OutputFunction:
    ...
    def __init__(self, name: str, outputFunction31: "devs_AtomicModel" = None, OutputFunction: "devs_AtomicModel" = None, OutputFunction13: "devs_State" = None, OutputFunction19: "devs_OutputEvent" = None, outF: "devs_State" = None, outputFunction: "devs_OutputEvent" = None):
        self.name = name
...
class devs_Transition:
    ...
    def __init__(self, name: str, Transition: "devs_AtomicModel" = None, Transition8: "devs_State" = None, Transition10: "devs_State" = None, out: "devs_State" = None, in_: "devs_State" = None, transition: "devs_AtomicModel" = None):
        self.name = name
    ...
    def in_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_devs_Transition__in_", None)
        self.__in_ = value
...
class devs_State:
    ...
    def __init__(self, lifeTime: float, name: str, state: "devs_AtomicModel" = None, State: "devs_AtomicModel" = None, target: set["devs_Transition"] = None, source: set["devs_Transition"] = None, source12: "devs_OutputFunction" = None, State21: "devs_Transition" = None, State23: "devs_Transition" = None, State28: "devs_OutputFunction" = None):
...
class devs_AtomicModel:
    ...
    def __init__(self, name: str, AtomicModel32: "devs_OutputFunction" = None, AtomicModel: "devs_State" = None, AtomicModel16: "devs_Event" = None, atomicModel: set["devs_State"] = None, atomicModel2: set["devs_Event"] = None, atomicModel4: set["devs_Transition"] = None, atomicModel6: set["devs_OutputFunction"] = None, AtomicModel25: "devs_Transition" = None):
        self.name = name
