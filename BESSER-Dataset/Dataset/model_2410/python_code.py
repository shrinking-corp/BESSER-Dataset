...
class relationalMetaModel_RelationalForeignKey:
    ...
    def __init__(self, Name: str, RelationalForeignKey4: "relationalMetaModel_RelationalTable" = None, ForeignKeys: "relationalMetaModel_RelationalTable" = None, ReferencedBy: "relationalMetaModel_RelationalTable" = None, RelationalForeignKey: "relationalMetaModel_RelationalTable" = None):
        self.Name = Name
...
class relationalMetaModel_RelationalTable:
    ...
    def __init__(self, Name: str, ReferencedTable: set["relationalMetaModel_RelationalForeignKey"] = None, RelationalTable6: "relationalMetaModel_RelationalForeignKey" = None, RelationalTable8: "relationalMetaModel_RelationalForeignKey" = None, RelationalTable: "relationalMetaModel_RelationalSchema" = None, Tables: "relationalMetaModel_RelationalSchema" = None, OwnedByTable: set["relationalMetaModel_RelationalForeignKey"] = None):
        self.Name = Name
