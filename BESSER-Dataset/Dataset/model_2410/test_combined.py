...
def test_hyp_relationalmetamodel_relationalforeignkey_is_not_abstract():
    assert not inspect.isabstract(relationalMetaModel_RelationalForeignKey)


def test_hyp_relationalmetamodel_relationalforeignkey_constructor_exists():
    assert callable(relationalMetaModel_RelationalForeignKey.__init__)


def test_hyp_relationalmetamodel_relationalforeignkey_constructor_args():
...
def test_hyp_relationalmetamodel_relationalschema_is_not_abstract():
    assert not inspect.isabstract(relationalMetaModel_RelationalSchema)


def test_hyp_relationalmetamodel_relationalschema_constructor_exists():
    assert callable(relationalMetaModel_RelationalSchema.__init__)


def test_hyp_relationalmetamodel_relationalschema_constructor_args():
...
def test_hyp_relationalmetamodel_relationaltable_is_not_abstract():
    assert not inspect.isabstract(relationalMetaModel_RelationalTable)


def test_hyp_relationalmetamodel_relationaltable_constructor_exists():
    assert callable(relationalMetaModel_RelationalTable.__init__)


def test_hyp_relationalmetamodel_relationaltable_constructor_args():
...
def test_hyp_relationalmetamodel_relationalforeignkey_Name_setter(instance):
...
def test_hyp_relationalmetamodel_relationalschema_Name_setter(instance):
    original = instance.Name
    instance.Name = original
    assert instance.Name == original
...
def test_hyp_relationalmetamodel_relationaltable_Name_setter(instance):
    original = instance.Name
    instance.Name = original
    assert instance.Name == original
