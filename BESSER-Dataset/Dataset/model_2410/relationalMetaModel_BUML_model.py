...
# Classes
relationalMetaModel_RelationalTable = Class(name="relationalMetaModel_RelationalTable")
relationalMetaModel_RelationalSchema = Class(name="relationalMetaModel_RelationalSchema")
relationalMetaModel_RelationalForeignKey = Class(name="relationalMetaModel_RelationalForeignKey")
...
domain_model = DomainModel(
    ...
    types={relationalMetaModel_RelationalTable, relationalMetaModel_RelationalSchema, relationalMetaModel_RelationalForeignKey},
