...
class error4_RelatedTo(NamedElement):
    ...
    def __init__(self, since: str, RelatedTo: "error4_Thing" = None, error4_RelatedTo8: "error4_Component" = None, relations: "error4_Thing" = None, error4_RelatedTo: "error4_Thing" = None):
        self.since = since
...
class error4_Thing(NamedElement):
    ...
    def __init__(self, id: int, error4_Thing: "error4_World" = None, fromThing: set["error4_RelatedTo"] = None, error4_Thing3: set["error4_Component"] = None, Thing: "error4_RelatedTo" = None, error4_Thing6: "error4_RelatedTo" = None):
        self.id = id
