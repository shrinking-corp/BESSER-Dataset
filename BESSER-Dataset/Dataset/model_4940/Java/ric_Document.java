...
public class ric_Document extends EventComponent {
    ...
    public ric_Document(
        boolean index,        String title,        String fileName        ArrayList<ric_List> ric_lists,        ArrayList<ric_RichWidget> ric_richwidgets,        ArrayList<ric_LineBreak> ric_linebreaks,        ArrayList<ric_Form> ric_forms    ) {
        this.index = index;
        this.title = title;
        this.fileName = fileName;
