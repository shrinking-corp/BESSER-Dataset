...
public class ric_Section  {
    ...
    public ric_Section(
        String title        ArrayList<ric_Form> ric_forms,        ArrayList<ric_RichWidget> ric_richwidgets,        ArrayList<ric_LineBreak> ric_linebreaks,        ArrayList<ric_ObjectComponent> ric_objectcomponents,        ArrayList<ric_InlineComponent> ric_inlinecomponents,        ArrayList<ric_List> ric_lists,        ArrayList<ric_BlockLevelComponent> ric_blocklevelcomponents    ) {
        this.title = title;
