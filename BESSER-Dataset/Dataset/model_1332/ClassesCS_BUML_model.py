...
# Classes
classescs_EObject = Class(name="classescs_EObject")
classescs_NamedElementCS = Class(name="classescs_NamedElementCS", is_abstract=True)
ElementCS = Class(name="ElementCS")
classescs_ElementCS = Class(name="classescs_ElementCS", is_abstract=True)
classescs_ArgumentCS = Class(name="classescs_ArgumentCS")
classescs_PackageCS = Class(name="classescs_PackageCS")
NamedElementCS = Class(name="NamedElementCS")
classescs_ClassCS = Class(name="classescs_ClassCS")
classescs_PathNameCS = Class(name="classescs_PathNameCS")
classescs_PropertyCS = Class(name="classescs_PropertyCS")
classescs_OperationCS = Class(name="classescs_OperationCS")
classescs_PathElementCS = Class(name="classescs_PathElementCS")
classescs_RootCS = Class(name="classescs_RootCS")
classescs_NameExpCS = Class(name="classescs_NameExpCS")
classescs_RoundedBracketClause = Class(name="classescs_RoundedBracketClause")
...
domain_model = DomainModel(
    name="classescs",
    types={classescs_EObject, classescs_NamedElementCS, ElementCS, classescs_ElementCS, classescs_ArgumentCS, classescs_PackageCS, NamedElementCS, classescs_ClassCS, classescs_PathNameCS, classescs_PropertyCS, classescs_OperationCS, classescs_PathElementCS, classescs_RootCS, classescs_NameExpCS, classescs_RoundedBracketClause},
    associations={ast0, args31, ownedClasses1, ownedPackages3, extends5, properties7, operations9, path11, ownedPackages13, typeRef15, bodyExps18, resultRef20, name23, roundedBrackets26, ownedNameExp29},
    generalizations={gen_classescs_NamedElementCS_ElementCS, gen_classescs_RoundedBracketClause_ElementCS, gen_classescs_ArgumentCS_NamedElementCS, gen_classescs_PackageCS_NamedElementCS, gen_classescs_ClassCS_NamedElementCS, gen_classescs_PathNameCS_ElementCS, gen_classescs_PathElementCS_NamedElementCS, gen_classescs_RootCS_ElementCS, gen_classescs_PropertyCS_NamedElementCS, gen_classescs_OperationCS_NamedElementCS, gen_classescs_NameExpCS_ElementCS},
    metadata=None
)
