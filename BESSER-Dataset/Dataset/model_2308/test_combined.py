...
def test_hyp_persons_locatedelement_is_not_abstract():
    assert not inspect.isabstract(Persons_LocatedElement)


def test_hyp_persons_locatedelement_constructor_exists():
    assert callable(Persons_LocatedElement.__init__)


def test_hyp_persons_locatedelement_constructor_args():
...
Persons_LocatedElement_strategy = st.builds(Persons_LocatedElement)
