...
class uma_WorkProductDescriptor(Descriptor):
    ...
    def __init__(self, responsibleRole: str, group2: str, externalInputTo: str, impactedBy: str, impacts: str, mandatoryInputTo: str, optionalInputTo: str, outputFrom: str, deliverableParts: str, activityEntryState: str, activityExitState: str, workProduct: str, uma_WorkProductDescriptor: "uma_ProcessComponentInterface" = None):
...
class uma_DocumentRoot:
    ...
    def __init__(self, mixed: str, uma_DocumentRoot16: set["uma_MethodConfiguration"] = None, uma_DocumentRoot18: set["uma_MethodLibrary"] = None, uma_DocumentRoot20: set["uma_MethodPlugin"] = None, uma_DocumentRoot: set["uma_EStringToStringMapEntry"] = None, uma_DocumentRoot13: set["uma_EStringToStringMapEntry"] = None):
        self.mixed = mixed
...
class uma_MethodPlugin(MethodUnit):
    ...
    def __init__(self, userChangeable: str, referencedMethodPlugin: str, supporting: str, uma_MethodPlugin: "uma_DocumentRoot" = None, uma_MethodPlugin28: "uma_MethodLibrary" = None, uma_MethodPlugin35: set["uma_MethodPackage"] = None):
...
class uma_MethodConfiguration(MethodUnit):
    ...
    def __init__(self, defaultView: str, processView: str, subtractedCategory: str, addedCategory: str, baseConfiguration: str, methodPluginSelection: str, methodPackageSelection: str, uma_MethodConfiguration: "uma_DocumentRoot" = None, uma_MethodConfiguration31: "uma_MethodLibrary" = None):
...
class uma_Task(ContentElement):
    ...
    def __init__(self, precondition: str, postcondition: str, performedBy: str, group2: str, mandatoryInput: str, output: str, additionallyPerformedBy: str, optionalInput: str, estimate: str, estimationConsiderations: str, toolMentor: str):
...
class uma_BreakdownElement(ProcessElement):
    ...
    def __init__(self, presentedAfter: str, presentedBefore: str, planningData: str, superActivity: str, group1: str, checklist: str, concept: str, supportingMaterial: str, whitepaper: str, hasMultipleOccurrences: str, isOptional: str, isPlanned: str, prefix: str, example: str, guideline: str, reusableAsset: str, uma_BreakdownElement: "uma_Activity" = None):
...
class uma_TaskDescriptor(WorkBreakdownElement):
    ...
    def __init__(self, assistedBy: str, externalInput: str, mandatoryInput: str, optionalInput: str, output: str, isSynchronizedWithSource: str, task: str, group3: str, performedPrimarilyBy: str, additionallyPerformedBy: str, uma_TaskDescriptor: "uma_ProcessComponentInterface" = None, uma_TaskDescriptor51: set["uma_Section"] = None):
...
class uma_Activity(WorkBreakdownElement):
    ...
    def __init__(self, precondition: str, postcondition: str, roadmap: str, isEnactable: str, variabilityBasedOnElement: str, variabilityType: str, group3: str, uma_Activity: set["uma_BreakdownElement"] = None):
        self.precondition = precondition
        self.postcondition = postcondition
