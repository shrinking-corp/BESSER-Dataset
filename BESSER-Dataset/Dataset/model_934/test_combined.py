...
def test_assoc_aggregatedRole3_link_reassign_clear():
...
def test_assoc_breakdownElement0_link_reassign_clear():
...
def test_assoc_containedArtifact2_link_reassign_clear():
    ...
    if hasattr(b1, 'uma_Artifact1'):
        assert _is_linked(b1, 'uma_Artifact1', a)
    _safe_set(a, 'uma_Artifact', b2)
    assert _is_linked(a, 'uma_Artifact', b2)
    if hasattr(b1, 'uma_Artifact1'):
        assert not _is_linked(b1, 'uma_Artifact1', a)
    if hasattr(b2, 'uma_Artifact1'):
        assert _is_linked(b2, 'uma_Artifact1', a)
    _safe_set(a, 'uma_Artifact', None)
    assert not _is_linked(a, 'uma_Artifact', b2)
    if hasattr(b2, 'uma_Artifact1'):
        assert not _is_linked(b2, 'uma_Artifact1', a)


def test_assoc_contentCategory4_link_reassign_clear():
