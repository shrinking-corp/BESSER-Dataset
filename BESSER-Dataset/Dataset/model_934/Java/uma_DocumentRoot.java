...
public class uma_DocumentRoot  {
    ...
    public uma_DocumentRoot(
        String mixed        ArrayList<uma_MethodPlugin> uma_methodplugins,        ArrayList<uma_MethodConfiguration> uma_methodconfigurations,        ArrayList<uma_MethodLibrary> uma_methodlibrarys    ) {
        this.mixed = mixed;
