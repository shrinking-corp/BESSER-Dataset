...
# Classes
iot_Etiqueta = Class(name="iot_Etiqueta")
iot_Estado = Class(name="iot_Estado")
iot_Evento = Class(name="iot_Evento")
iot_Model = Class(name="iot_Model")
iot_Dispositivo = Class(name="iot_Dispositivo")
iot_Or = Class(name="iot_Or")
Expression = Class(name="Expression")
iot_And = Class(name="iot_And")
iot_Equality = Class(name="iot_Equality")
iot_Transicion = Class(name="iot_Transicion")
iot_AbstractElement = Class(name="iot_AbstractElement")
...
iot_IfBlock = Class(name="iot_IfBlock")
iot_Variable = Class(name="iot_Variable")
iot_StringConstant = Class(name="iot_StringConstant")
iot_BoolConstant = Class(name="iot_BoolConstant")
iot_VariableRef = Class(name="iot_VariableRef")
iot_Comparison = Class(name="iot_Comparison")
iot_Plus = Class(name="iot_Plus")
iot_Minus = Class(name="iot_Minus")
iot_MulOrDiv = Class(name="iot_MulOrDiv")
iot_Not = Class(name="iot_Not")
iot_IntConstant = Class(name="iot_IntConstant")
...
iot_Etiqueta.attributes={iot_Etiqueta_name, iot_Etiqueta_value, iot_Etiqueta_typeName}
...
iot_Evento.attributes={iot_Evento_name, iot_Evento_typeName}
...
domain_model = DomainModel(
    name="iot",
    types={iot_Etiqueta, iot_Estado, iot_Evento, iot_Model, iot_Dispositivo, iot_Or, Expression, iot_And, iot_Equality, iot_Transicion, iot_AbstractElement, iot_IfStatement, AbstractElement, iot_Expression, iot_IfBlock, iot_Variable, iot_StringConstant, iot_BoolConstant, iot_VariableRef, iot_Comparison, iot_Plus, iot_Minus, iot_MulOrDiv, iot_Not, iot_IntConstant},
    associations={dispositivos0, superType2, etiquetas4, estados6, eventos8, left31, right33, left36, right38, left41, transiciones10, elementos12, evento14, estado17, expression20, thenBlock21, elseBlock23, elementos26, expression29, variable68, right43, left46, right48, left51, right53, left56, right58, left61, right63, expression66},
    generalizations={gen_iot_Or_Expression, gen_iot_And_Expression, gen_iot_Equality_Expression, gen_iot_IfStatement_AbstractElement, gen_iot_Variable_AbstractElement, gen_iot_Expression_AbstractElement, gen_iot_IntConstant_Expression, gen_iot_StringConstant_Expression, gen_iot_BoolConstant_Expression, gen_iot_VariableRef_Expression, gen_iot_Comparison_Expression, gen_iot_Plus_Expression, gen_iot_Minus_Expression, gen_iot_MulOrDiv_Expression, gen_iot_Not_Expression},
    metadata=None
)
