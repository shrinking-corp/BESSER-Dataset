...
class iot_Dispositivo:
    ...
    def __init__(self, name: str, iot_Dispositivo: "iot_Model" = None, iot_Dispositivo3: "iot_Dispositivo" = None, iot_Dispositivo1: "iot_Dispositivo" = None, iot_Dispositivo5: set["iot_Etiqueta"] = None, iot_Dispositivo7: set["iot_Estado"] = None, iot_Dispositivo9: set["iot_Evento"] = None, iot_Dispositivo11: set["iot_Transicion"] = None):
        self.name = name
