...
def test_hyp_iot_ifblock_is_not_abstract():
    assert not inspect.isabstract(iot_IfBlock)


def test_hyp_iot_ifblock_constructor_exists():
    assert callable(iot_IfBlock.__init__)


def test_hyp_iot_ifblock_constructor_args():
...
def test_hyp_iot_abstractelement_is_not_abstract():
    assert not inspect.isabstract(iot_AbstractElement)


def test_hyp_iot_abstractelement_constructor_exists():
    assert callable(iot_AbstractElement.__init__)


def test_hyp_iot_abstractelement_constructor_args():
    sig = inspect.signature(iot_AbstractElement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_iot_transicion_is_not_abstract():
    assert not inspect.isabstract(iot_Transicion)


def test_hyp_iot_transicion_constructor_exists():
    assert callable(iot_Transicion.__init__)


def test_hyp_iot_transicion_constructor_args():
...
def test_hyp_iot_boolconstant_is_not_abstract():
    assert not inspect.isabstract(iot_BoolConstant)


def test_hyp_iot_boolconstant_constructor_exists():
    assert callable(iot_BoolConstant.__init__)


def test_hyp_iot_boolconstant_constructor_args():
...
def test_hyp_iot_minus_is_not_abstract():
    assert not inspect.isabstract(iot_Minus)


def test_hyp_iot_minus_constructor_exists():
    assert callable(iot_Minus.__init__)


def test_hyp_iot_minus_constructor_args():
    sig = inspect.signature(iot_Minus.__init__)
    params = list(sig.parameters.keys())



def test_hyp_iot_intconstant_is_not_abstract():
    assert not inspect.isabstract(iot_IntConstant)


def test_hyp_iot_intconstant_constructor_exists():
    assert callable(iot_IntConstant.__init__)


def test_hyp_iot_intconstant_constructor_args():
...
def test_hyp_iot_plus_is_not_abstract():
    assert not inspect.isabstract(iot_Plus)


def test_hyp_iot_plus_constructor_exists():
    assert callable(iot_Plus.__init__)


def test_hyp_iot_plus_constructor_args():
    sig = inspect.signature(iot_Plus.__init__)
    params = list(sig.parameters.keys())



def test_hyp_iot_not_is_not_abstract():
    assert not inspect.isabstract(iot_Not)


def test_hyp_iot_not_constructor_exists():
    assert callable(iot_Not.__init__)


def test_hyp_iot_not_constructor_args():
    sig = inspect.signature(iot_Not.__init__)
    params = list(sig.parameters.keys())



def test_hyp_iot_stringconstant_is_not_abstract():
    assert not inspect.isabstract(iot_StringConstant)


def test_hyp_iot_stringconstant_constructor_exists():
    assert callable(iot_StringConstant.__init__)


def test_hyp_iot_stringconstant_constructor_args():
...
def test_hyp_iot_equality_is_not_abstract():
    assert not inspect.isabstract(iot_Equality)


def test_hyp_iot_equality_constructor_exists():
    assert callable(iot_Equality.__init__)


def test_hyp_iot_equality_constructor_args():
...
def test_hyp_iot_variableref_is_not_abstract():
    assert not inspect.isabstract(iot_VariableRef)


def test_hyp_iot_variableref_constructor_exists():
    assert callable(iot_VariableRef.__init__)


def test_hyp_iot_variableref_constructor_args():
    sig = inspect.signature(iot_VariableRef.__init__)
    params = list(sig.parameters.keys())



def test_hyp_iot_mulordiv_is_not_abstract():
    assert not inspect.isabstract(iot_MulOrDiv)


def test_hyp_iot_mulordiv_constructor_exists():
    assert callable(iot_MulOrDiv.__init__)


def test_hyp_iot_mulordiv_constructor_args():
...
def test_hyp_iot_dispositivo_is_not_abstract():
    assert not inspect.isabstract(iot_Dispositivo)


def test_hyp_iot_dispositivo_constructor_exists():
    assert callable(iot_Dispositivo.__init__)


def test_hyp_iot_dispositivo_constructor_args():
...
def test_hyp_iot_evento_is_not_abstract():
    assert not inspect.isabstract(iot_Evento)


def test_hyp_iot_evento_constructor_exists():
    assert callable(iot_Evento.__init__)


def test_hyp_iot_evento_constructor_args():
...
def test_hyp_iot_estado_is_not_abstract():
    assert not inspect.isabstract(iot_Estado)


def test_hyp_iot_estado_constructor_exists():
    assert callable(iot_Estado.__init__)


def test_hyp_iot_estado_constructor_args():
...
def test_hyp_iot_etiqueta_is_not_abstract():
    assert not inspect.isabstract(iot_Etiqueta)


def test_hyp_iot_etiqueta_constructor_exists():
    assert callable(iot_Etiqueta.__init__)


def test_hyp_iot_etiqueta_constructor_args():
...
def test_hyp_iot_variable_name_setter(instance):
...
def test_hyp_iot_boolconstant_value_setter(instance):
...
def test_hyp_iot_intconstant_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_iot_stringconstant_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_iot_equality_op_setter(instance):
...
def test_hyp_iot_comparison_op_setter(instance):
    original = instance.op
    instance.op = original
    assert instance.op == original
...
def test_hyp_iot_mulordiv_op_setter(instance):
    original = instance.op
    instance.op = original
    assert instance.op == original
...
def test_hyp_iot_dispositivo_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_iot_evento_typeName_setter(instance):
...
@given(instance=iot_Evento_strategy)
def test_hyp_iot_evento_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_iot_estado_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_iot_etiqueta_typeName_setter(instance):
    original = instance.typeName
    instance.typeName = original
    assert instance.typeName == original
...
@given(instance=iot_Etiqueta_strategy)
def test_hyp_iot_etiqueta_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=iot_Etiqueta_strategy)
def test_hyp_iot_etiqueta_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
