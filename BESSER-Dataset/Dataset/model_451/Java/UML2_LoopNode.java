...
public class UML2_LoopNode extends StructuredActivityNode {
    ...
    public UML2_LoopNode(
        boolean isTestedFirst        ArrayList<UML2_InputPin> uml2_inputpins,        ArrayList<UML2_ActivityNode> uml2_activitynodes,        ArrayList<UML2_OutputPin> uml2_outputpins,        ArrayList<UML2_OutputPin> uml2_outputpins,        ArrayList<UML2_ActivityNode> uml2_activitynodes,        ArrayList<UML2_OutputPin> uml2_outputpins,        ArrayList<UML2_ActivityNode> uml2_activitynodes    ) {
        this.isTestedFirst = isTestedFirst;
