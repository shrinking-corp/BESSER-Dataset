...
public class UML2_Package extends PackageableElement, Namespace {
    ...
    private List<UML2_Package> uml2_packages;
    ...
    public UML2_Package(
        ...
        this.uml2_packages = new ArrayList<>();
    }

    public UML2_Package(
        ArrayList<UML2_Type> uml2_types,        ArrayList<UML2_PackageableElement> uml2_packageableelements,        ArrayList<UML2_Package> uml2_packages    ) {
        this.uml2_types = uml2_types;
        this.uml2_packageableelements = uml2_packageableelements;
        this.uml2_packages = uml2_packages;
    }
    ...
    public List<UML2_Package> getUml2_packages() {
        return uml2_packages;
    }

    public void addUml2_package(Uml2_package uml2_package) {
        this.uml2_packages.add(uml2_package);
    }
