...
public class UML2_State extends RedefinableElement, Vertex, Namespace {
    ...
    public UML2_State(
        boolean isComposite,        boolean isOrthogonal,        boolean isSimple,        boolean isSubmachineState    ) {
        super(
        );
    ...
    public UML2_State(
        boolean isComposite,        boolean isOrthogonal,        boolean isSimple,        boolean isSubmachineState        ArrayList<UML2_Trigger> uml2_triggers    ) {
        this.isComposite = isComposite;
        this.isOrthogonal = isOrthogonal;
        this.isSimple = isSimple;
        this.isSubmachineState = isSubmachineState;
