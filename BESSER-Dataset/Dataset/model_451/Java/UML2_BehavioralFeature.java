...
public class UML2_BehavioralFeature extends Namespace, Feature {
    ...
    public UML2_BehavioralFeature(
        String concurrency,        boolean isAbstract        ArrayList<UML2_Parameter> uml2_parameters,        ArrayList<UML2_Behavior> uml2_behaviors,        ArrayList<UML2_Parameter> uml2_parameters,        ArrayList<UML2_Type> uml2_types,        ArrayList<UML2_Parameter> uml2_parameters    ) {
        this.concurrency = concurrency;
        this.isAbstract = isAbstract;
