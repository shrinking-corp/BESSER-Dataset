...
public class UML2_Behavior extends Class {
    ...
    public UML2_Behavior(
        boolean isReentrant        ArrayList<UML2_Behavior> uml2_behaviors,        ArrayList<UML2_Parameter> uml2_parameters,        ArrayList<UML2_Constraint> uml2_constraints,        ArrayList<UML2_Parameter> uml2_parameters,        ArrayList<UML2_Constraint> uml2_constraints,        ArrayList<UML2_Parameter> uml2_parameters,        ArrayList<UML2_ParameterSet> uml2_parametersets    ) {
        this.isReentrant = isReentrant;
