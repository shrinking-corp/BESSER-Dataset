...
# Classes
familyleft2_Father = Class(name="familyleft2_Father")
Person = Class(name="Person")
familyleft2_Family = Class(name="familyleft2_Family")
familyleft2_Mother = Class(name="familyleft2_Mother")
familyleft2_Son = Class(name="familyleft2_Son")
familyleft2_Daughter = Class(name="familyleft2_Daughter")
familyleft2_Person = Class(name="familyleft2_Person", is_abstract=True)
...
familyleft2_Person.attributes={familyleft2_Person_age, familyleft2_Person_isMale, familyleft2_Person_name}
...
domain_model = DomainModel(
    name="familyleft2",
    types={familyleft2_Father, Person, familyleft2_Family, familyleft2_Mother, familyleft2_Son, familyleft2_Daughter, familyleft2_Person},
