...
class TokenTrace_Token(MultiLiteralConstraint):
    ...
    def __init__(self, referenceCount: int, assignedProbability: str, computedProbability: str, scale: str, name: str, message: str, tokenType: str, TokenTrace_Token18: set["TokenTrace_Literal"] = None, TokenTrace_Token: "TokenTrace_TokenTrace" = None, TokenTrace_Token5: "TokenTrace_TokenTrace" = None, TokenTrace_Token10: "TokenTrace_Token" = None, TokenTrace_Token8: set["TokenTrace_Token"] = None, TokenTrace_Token12: "TokenTrace_EObject" = None, TokenTrace_Token15: "TokenTrace_Literal" = None):
