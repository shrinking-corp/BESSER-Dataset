...
# Classes
TokenTrace_TokenTrace = Class(name="TokenTrace_TokenTrace")
TokenTrace_Token = Class(name="TokenTrace_Token")
TokenTrace_EObject = Class(name="TokenTrace_EObject")
TokenTrace_Literal = Class(name="TokenTrace_Literal")
...
TokenTrace_Token.attributes={TokenTrace_Token_message, TokenTrace_Token_tokenType, TokenTrace_Token_name, TokenTrace_Token_assignedProbability, TokenTrace_Token_computedProbability, TokenTrace_Token_scale, TokenTrace_Token_referenceCount}
...
domain_model = DomainModel(
    ...
    associations={literalSink17, root0, instanceRoot1, tokens3, inferredRootLiteral6, tokens9, relatedEObject11, tokenLiteral14},
