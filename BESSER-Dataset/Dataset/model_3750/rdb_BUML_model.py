...
rdb_UserComment = Class(name="rdb_UserComment")
rdb_Style = Class(name="rdb_Style")
rdb_Column = Class(name="rdb_Column")
rdb_DB = Class(name="rdb_DB")
ERDInfo = Class(name="ERDInfo")
rdb_View = Class(name="rdb_View")
Table = Class(name="Table")
rdb_ERDInfo = Class(name="rdb_ERDInfo")
...
rdb_Table.attributes={rdb_Table_comment, rdb_Table_schema, rdb_Table_name, rdb_Table_logicalName, rdb_Table_constraints}
...
rdb_Relation.attributes={rdb_Relation_column_name, rdb_Relation_constraint_name, rdb_Relation_referenced_column_name, rdb_Relation_comment, rdb_Relation_target_kind, rdb_Relation_type, rdb_Relation_source_kind, rdb_Relation_bendpoint}
...
rdb_Style.attributes={rdb_Style_columnType, rdb_Style_tableTitle, rdb_Style_columnPrimaryKey, rdb_Style_columnNullCheck, rdb_Style_columnName, rdb_Style_columnComment, rdb_Style_grid, rdb_Style_scale}
...
rdb_Column.attributes={rdb_Column_field, rdb_Column_default, rdb_Column_key, rdb_Column_comment, rdb_Column_type, rdb_Column_extra, rdb_Column_logicalField, rdb_Column_null}
...
rdb_DB.attributes={rdb_DB_url, rdb_DB_id, rdb_DB_sid, rdb_DB_comment, rdb_DB_key, rdb_DB_dbType}
...
domain_model = DomainModel(
    name="rdb",
    types={rdb_Table, rdb_Relation, rdb_UserComment, rdb_Style, rdb_Column, rdb_DB, ERDInfo, rdb_View, Table, rdb_ERDInfo, RelationKind},
    associations={tables0, references1, DBComment3, styledReference4, columns6, db7, incomingLinks8, source16, target18, db20, tableName22, outgoingLinks10, UserCommentReference12, table14, style24, db25},
