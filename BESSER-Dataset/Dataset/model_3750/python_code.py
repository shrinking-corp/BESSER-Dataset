...
class rdb_DB(ERDInfo):
    ...
    def __init__(self, dbType: str, key: str, url: str, id: str, sid: str, comment: str, db: set["rdb_Table"] = None, db2: set["rdb_Relation"] = None, rdb_DB: "rdb_UserComment" = None, db5: set["rdb_Style"] = None, DB: "rdb_Table" = None, DB21: "rdb_Relation" = None, DB26: "rdb_Style" = None):
        self.dbType = dbType
        self.key = key
        self.url = url
        self.id = id
...
class rdb_Column:
    ...
    def __init__(self, comment: str, field: str, type: str, null: str, default: str, extra: str, logicalField: str, key: str, Column: "rdb_Table" = None, columns: "rdb_Table" = None):
        self.comment = comment
        self.field = field
        self.type = type
        self.null = null
...
class rdb_Style:
    ...
    def __init__(self, scale: str, tableTitle: str, columnPrimaryKey: str, columnName: str, columnComment: str, columnType: str, columnNullCheck: str, grid: str, Style: "rdb_DB" = None, rdb_Style: "rdb_ERDInfo" = None, styledReference: "rdb_DB" = None):
        self.scale = scale
...
class rdb_UserComment:
    ...
    def __init__(self, comment: str, rdb_UserComment: "rdb_DB" = None, rdb_UserComment13: "rdb_Table" = None):
        self.comment = comment
...
class rdb_Relation:
    ...
    def __init__(self, type: str, source_kind: str, target_kind: str, column_name: str, referenced_column_name: str, bendpoint: str, comment: str, constraint_name: str, Relation: "rdb_DB" = None, Relation9: "rdb_Table" = None, outgoingLinks: "rdb_Table" = None, incomingLinks: "rdb_Table" = None, references: "rdb_DB" = None, Relation11: "rdb_Table" = None):
        self.type = type
    ...
    @property
    def referenced_column_name(self):
...
class rdb_Table:
    ...
    def __init__(self, schema: str, name: str, constraints: str, logicalName: str, comment: str, Table: "rdb_DB" = None, table: set["rdb_Column"] = None, tables: "rdb_DB" = None, target: set["rdb_Relation"] = None, Table17: "rdb_Relation" = None, Table19: "rdb_Relation" = None, rdb_Table23: "rdb_View" = None, source: set["rdb_Relation"] = None, rdb_Table: set["rdb_UserComment"] = None, Table15: "rdb_Column" = None):
        self.schema = schema
        self.name = name
