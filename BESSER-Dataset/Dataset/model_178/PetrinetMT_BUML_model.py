...
petrinet_NetStopEvent = Class(name="petrinet_NetStopEvent")
petrinet_TransitionFireEvent = Class(name="petrinet_TransitionFireEvent")
petrinet_Place = Class(name="petrinet_Place")

# petrinet_Net class attributes and methods
petrinet_Net_m_initializeModel: Method = Method(name="initializeModel", parameters={Parameter(name='petrinet_args', type=StringType)})
...
petrinet_Net.methods={petrinet_Net_m_stop, petrinet_Net_m_run, petrinet_Net_m_fireEnabledTransition, petrinet_Net_m_initializeModel}
...
petrinet_Transition.methods={petrinet_Transition_m_isEnabled, petrinet_Transition_m_fire, petrinet_Transition_m_fire_PreCondition}
...
domain_model = DomainModel(
    name="petrinet",
    types={petrinet_Net, petrinet_Transition, petrinet_Token, petrinet_NetStopEvent, petrinet_TransitionFireEvent, petrinet_Place},
    associations={transitions1, input3, output6, tokens9, net11, transition13, places0},
    generalizations={},
    metadata=None
)
