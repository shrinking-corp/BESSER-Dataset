...
# Classes
Graph_NamedElement = Class(name="Graph_NamedElement")
Graph_Graph = Class(name="Graph_Graph")
NamedElement = Class(name="NamedElement")
Graph_GraphElement = Class(name="Graph_GraphElement")
Graph_Node = Class(name="Graph_Node")
GraphElement = Class(name="GraphElement")
Graph_DirectedArc = Class(name="Graph_DirectedArc")
...
Graph_GraphElement.attributes={Graph_GraphElement_color, Graph_GraphElement_label}
...
domain_model = DomainModel(
    name="Graph",
    types={Graph_NamedElement, Graph_Graph, NamedElement, Graph_GraphElement, Graph_Node, GraphElement, Graph_DirectedArc},
