...
def test_hyp_graph_directedarc_is_not_abstract():
    assert not inspect.isabstract(Graph_DirectedArc)


def test_hyp_graph_directedarc_constructor_exists():
    assert callable(Graph_DirectedArc.__init__)


def test_hyp_graph_directedarc_constructor_args():
...
def test_hyp_graph_namedelement_is_not_abstract():
    assert not inspect.isabstract(Graph_NamedElement)


def test_hyp_graph_namedelement_constructor_exists():
    assert callable(Graph_NamedElement.__init__)


def test_hyp_graph_namedelement_constructor_args():
...
def test_hyp_graph_directedarc_weight_setter(instance):
...
def test_hyp_graph_node_style_setter(instance):
...
@given(instance=Graph_Node_strategy)
def test_hyp_graph_node_shape_setter(instance):
...
def test_hyp_graph_graphelement_label_setter(instance):
...
@given(instance=Graph_GraphElement_strategy)
def test_hyp_graph_graphelement_color_setter(instance):
...
def test_hyp_graph_namedelement_name_setter(instance):
