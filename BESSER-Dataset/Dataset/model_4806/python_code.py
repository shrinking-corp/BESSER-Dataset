...
class model_ServiceInstance(Service, ElementWithResources):
    ...
    def __init__(self, totalMessages: str, totalData: str, id: str, address: str, containers: str, model_ServiceInstance: set["model_Message"] = None, model_ServiceInstance32: "model_StringToServiceInstance" = None, model_ServiceInstance9: "model_Host" = None, model_ServiceInstance12: "model_Message" = None, model_ServiceInstance15: "model_Message" = None):
        self.totalMessages = totalMessages
        self.totalData = totalData
        self.id = id
...
class model_StringToServiceInstance:
    ...
    def __init__(self, key: str, model_StringToServiceInstance31: "model_ServiceInstance" = None, model_StringToServiceInstance: "model_Host" = None):
        self.key = key
...
class model_Host(ElementWithResources):
    ...
    def __init__(self, name: str, hostAddress: str, cores: str, model_Host19: set["model_StringToDoubleMap"] = None, model_Host29: "model_StringToHost" = None, model_Host: "model_ServiceInstance" = None, model_Host17: set["model_StringToServiceInstance"] = None):
        self.name = name
...
class model_Affinity:
    ...
    def __init__(self, degree: str, model_Affinity5: "model_Service" = None, model_Affinity: "model_Service" = None):
        self.degree = degree
...
class model_Service(ABC):
    ...
    def __init__(self, name: str, application: str, stateful: str, model_Service6: "model_Affinity" = None, model_Service26: "model_StringToService" = None, model_Service: set["model_Affinity"] = None):
        self.name = name
...
class model_StringToApplication:
    ...
    def __init__(self, key: str, model_StringToApplication36: "model_Application" = None, model_StringToApplication: "model_Cluster" = None):
        self.key = key
...
class model_StringToHost:
    ...
    def __init__(self, key: str, model_StringToHost28: "model_Host" = None, model_StringToHost: "model_Cluster" = None):
        self.key = key
...
class model_Cluster:
    ...
    def move(self, model_destinationHost, model_application, model_serviceId, model_sourceHost):
