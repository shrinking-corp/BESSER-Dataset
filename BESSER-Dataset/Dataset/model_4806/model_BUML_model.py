...
# Classes
model_Cluster = Class(name="model_Cluster")
model_StringToHost = Class(name="model_StringToHost")
model_StringToApplication = Class(name="model_StringToApplication")
model_Service = Class(name="model_Service", is_abstract=True)
model_Affinity = Class(name="model_Affinity")
model_Host = Class(name="model_Host")
model_StringToServiceInstance = Class(name="model_StringToServiceInstance")
model_StringToDoubleMap = Class(name="model_StringToDoubleMap")
model_ElementWithResources = Class(name="model_ElementWithResources", is_abstract=True)
model_ServiceInstance = Class(name="model_ServiceInstance")
Service = Class(name="Service")
ElementWithResources = Class(name="ElementWithResources")
model_Message = Class(name="model_Message")
model_Application = Class(name="model_Application")
model_StringToService = Class(name="model_StringToService")

# model_Cluster class attributes and methods
model_Cluster_environment: Property = Property(name="environment", type=StringType)
model_Cluster_m_move: Method = Method(name="move", parameters={Parameter(name='model_application', type=StringType), Parameter(name='model_destinationHost', type=StringType), Parameter(name='model_serviceId', type=StringType), Parameter(name='model_sourceHost', type=StringType)})
...
model_ServiceInstance.attributes={model_ServiceInstance_totalMessages, model_ServiceInstance_address, model_ServiceInstance_containers, model_ServiceInstance_id, model_ServiceInstance_totalData}
...
model_Message.attributes={model_Message_avgResponseTime, model_Message_timestamp, model_Message_name, model_Message_messageSize, model_Message_uid}
...
model_Application.attributes={model_Application_totalData, model_Application_weight, model_Application_totalMessages, model_Application_name}
...
with_4: BinaryAssociation = BinaryAssociation(
    name="with_4",
    ends={
...
domain_model = DomainModel(
    name="model",
    types={model_Cluster, model_StringToHost, model_StringToApplication, model_Service, model_Affinity, model_Host, model_StringToServiceInstance, model_StringToDoubleMap, model_ElementWithResources, model_ServiceInstance, Service, ElementWithResources, model_Message, model_Application, model_StringToService, Environment},
    associations={hosts0, applications1, hasAffinities3, host8, source10, destination13, services16, resourceReserved18, with_4, messages7, value25, value27, value30, services33, value35, resourceLimit20, metrics22},
    generalizations={gen_model_Host_ElementWithResources, gen_model_ServiceInstance_Service, gen_model_ServiceInstance_ElementWithResources},
    metadata=None
)
