...
Property_.attributes={Property__address, Property__property_type, Property__location, Property__property_id}
...
Reg_User.attributes={Reg_User_Address, Reg_User_password, Reg_User_username}
...
Advertiser.attributes={Advertiser_advertiesment_id, Advertiser_advertiser_id}
...
Payment.attributes={Payment_pay_id, Payment_card_no, Payment_pay_mode, Payment_ex_date, Payment_pay_amount}
...
Requirement.attributes={Requirement_user_id, Requirement_req_description, Requirement_requirement_type, Requirement_requirement_location}
...
Request.attributes={Request_requser_id, Request_request_type, Request_request_id, Request_request_details}
...
Advertiesment.attributes={Advertiesment_end_date, Advertiesment_start_date, Advertiesment_advertiesment_id, Advertiesment_advertiser_id}
...
domain_model = DomainModel(
    name="df8805ff_c97c_436d_8cc9_baf3471015d3",
    types={Property_, User, Reg_User, Unreg_User, Advertiser, Buyer, Seller, Administrator, Payment, Requirement, Request, Management, Advertiesment},
    associations={Payment_Property, User_Administrator, Advertiser_Advertiesment, Property_Seller, User_Request, Property_Buyer, Reg_User_Requirement, Property_Management, Payment_Reg_User},
    generalizations={},
    metadata=None
)
