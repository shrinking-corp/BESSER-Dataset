...
class Requirement:
    ...
    def __init__(self, requirement_type: str, req_description: str, requirement_location: str, user_id: str, user11: set["Reg_User"] = None):
...
class Payment:
    ...
    def __init__(self, pay_id: int, pay_mode: str, card_no: str, ex_date: str, pay_amount: str, property16: set["Property"] = None, reg_User14: set["Reg_User"] = None):
        self.pay_id = pay_id
...
class Administrator:
    ...
    def __init__(self, password: str, admin_name: str, employee1: set["User"] = None):
...
class Property:
    ...
    def __init__(self, property_id: str, property_type: str, address: str, location: str, payment17: "Payment" = None, owner4: "Seller" = None, user8: "Buyer" = None, management12: set["Management"] = None):
        self.property_id = property_id
