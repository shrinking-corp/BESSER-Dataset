...
# Classes
test101_C = Class(name="test101_C")
test101_A = Class(name="test101_A")
test101_D = Class(name="test101_D")
test101_G = Class(name="test101_G")
G = Class(name="G")
test101_F = Class(name="test101_F")
test101_N = Class(name="test101_N")
test101_E = Class(name="test101_E")
D = Class(name="D")
test101_J = Class(name="test101_J")
E = Class(name="E")
test101_Q = Class(name="test101_Q")
M = Class(name="M")
test101_I = Class(name="test101_I")
test101_K = Class(name="test101_K")
test101_L1 = Class(name="test101_L1")
B = Class(name="B")
test101_B = Class(name="test101_B")
test101_M = Class(name="test101_M")
...
is_19: BinaryAssociation = BinaryAssociation(
    name="is_19",
    ends={
...
domain_model = DomainModel(
    name="test101",
    types={test101_C, test101_A, test101_D, test101_G, G, test101_F, test101_N, test101_E, D, test101_J, E, test101_Q, M, test101_I, test101_K, test101_L1, B, test101_B, test101_M},
    associations={as_0, ds1, gs7, fs9, gs11, ns14, js16, qs17, is_19, ks21, l1s3, bs5, from_23, to26},
    generalizations={gen_test101_D_G, gen_test101_E_D, gen_test101_F_E, gen_test101_G_M, gen_test101_A_B},
    metadata=None
)
