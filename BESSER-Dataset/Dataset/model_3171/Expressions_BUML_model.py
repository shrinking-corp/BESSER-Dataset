...
domain_model = DomainModel(
    name="expressions",
    types={expressions_ExpressionsModel, expressions_Variable, AbstractElement, expressions_Expression, expressions_Plus, Expression, expressions_Minus, expressions_MulOrDiv, expressions_Or, expressions_And, expressions_Equality, expressions_AbstractElement, expressions_IntConstant, expressions_StringConstant, expressions_BoolConstant, expressions_VariableRef, expressions_Comparison},
    associations={elements0, expression1, left2, right4, left7, right9, left12, right14, left17, right19, left22, right24, left27, right29, right34, variable37, left32},
    generalizations={gen_expressions_Variable_AbstractElement, gen_expressions_Expression_AbstractElement, gen_expressions_Plus_Expression, gen_expressions_Minus_Expression, gen_expressions_MulOrDiv_Expression, gen_expressions_Or_Expression, gen_expressions_And_Expression, gen_expressions_Equality_Expression, gen_expressions_IntConstant_Expression, gen_expressions_StringConstant_Expression, gen_expressions_BoolConstant_Expression, gen_expressions_VariableRef_Expression, gen_expressions_Comparison_Expression},
    metadata=None
)
