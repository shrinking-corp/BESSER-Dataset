...
class expressions_Equality(Expression):
    ...
    def __init__(self, op: str, expressions_Equality: "expressions_Expression" = None, expressions_Equality30: "expressions_Expression" = None):
        self.op = op
...
class expressions_Comparison(Expression):
    ...
    def __init__(self, op: str, expressions_Comparison35: "expressions_Expression" = None, expressions_Comparison: "expressions_Expression" = None):
        self.op = op
