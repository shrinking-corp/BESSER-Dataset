...
class DLabeledElement:
    ...
    pass
class diagraph_DLabeledEdge(DOwnedEdge, DLabeledElement, DLineEdge):
...
class diagraph_DNode(DLabeledElement, DOwnedElement):
    ...
    def __init__(self, shape: str, layout: bool, navigationLink: str, navigationSource: "diagraph_DViewNavigation" = None, node: set["diagraph_DContainment"] = None, diagraph_DNode16: "diagraph_DOwnedElement" = None, DNode: "diagraph_DViewNavigation" = None, DNode23: "diagraph_DContainment" = None, diagraph_DNode28: "diagraph_DSimpleEdge" = None, diagraph_DNode: "diagraph_DEdge" = None):
        self.shape = shape
        self.layout = layout
