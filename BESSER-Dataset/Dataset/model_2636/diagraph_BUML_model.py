...
diagraph_DLabel.attributes={diagraph_DLabel_propagated, diagraph_DLabel_abztract, diagraph_DLabel_inferred}
...
diagraph_DNode.attributes={diagraph_DNode_layout, diagraph_DNode_shape, diagraph_DNode_navigationLink}
...
diagraph_DGraphElement.attributes={diagraph_DGraphElement_icon, diagraph_DGraphElement_abztract, diagraph_DGraphElement_name}
...
diagraph_DLabeledElement.attributes={diagraph_DLabeledElement_expression, diagraph_DLabeledElement_labls}
...
domain_model = DomainModel(
    name="diagraph",
    types={diagraph_DEdge, diagraph_DLabel, DGraphElement, diagraph_DNode, diagraph_EReference, diagraph_DGraphElement, diagraph_ENamedElement, diagraph_DGraph, DLabeledElement, DOwnedElement, diagraph_DViewNavigation, diagraph_DContainment, diagraph_DLabeledEdge, DOwnedEdge, DLineEdge, diagraph_DReference, diagraph_DNestedEdge, diagraph_DPointOfView, diagraph_DLabeledElement, diagraph_EClass, diagraph_DOwnedElement, diagraph_DOwnedEdge, DEdge, diagraph_DCompartmentEdge, DNestedEdge, DNode, diagraph_DAffixedEdge, diagraph_EAttribute, diagraph_DLineEdge, DSimpleEdge, diagraph_DNavigationEdge, diagraph_DGeneric, diagraph_DSimpleEdge, DShape},
    associations={target0, targetReference1, semanticRole3, graph4, viewNavigation5, containments6, sourceReference7, source9, elements10, pointOfView11, eClaz12, dlabels13, owner15, navigationTarget17, navigationSource19, attribute20, node22, edges24, source27},
