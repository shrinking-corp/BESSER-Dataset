...
class gore_GoalModel:
    ...
    def __init__(self, internalId: str, GoalModel13: "gore_Actor" = None, GoalModel17: "gore_Configuration" = None, GoalModel: "gore_Goal" = None, goalModel: "gore_Goal" = None, goalModel24: set["gore_Actor"] = None, goalModel26: "gore_Configuration" = None, gore_GoalModel: set["gore_DifferentialRelation"] = None):
    ...
    def filterRelations(self, gore_value, gore_indicator, gore_parameter) :
...
class gore_QualityConstraint(DefinableRequirement):
    ...
    def __init__(self, QualityConstraint: "gore_Softgoal" = None, constraints: "gore_Softgoal" = None):
...
class gore_Requirement(OclAny):
    ...
    def __init__(self, refinementType: str, Requirement: "gore_Requirement" = None, parent: set["gore_Requirement"] = None, Requirement4: "gore_Requirement" = None, children: "gore_Requirement" = None):
