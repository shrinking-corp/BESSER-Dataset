...
# Classes
graphbt_RequirementList = Class(name="graphbt_RequirementList")
graphbt_FormulaList = Class(name="graphbt_FormulaList")
graphbt_Libraries = Class(name="graphbt_Libraries")
graphbt_StandardNode = Class(name="graphbt_StandardNode")
graphbt_LayoutList = Class(name="graphbt_LayoutList")
graphbt_AuthorList = Class(name="graphbt_AuthorList")
graphbt_Node = Class(name="graphbt_Node")
graphbt_BEModel = Class(name="graphbt_BEModel")
graphbt_BehaviorTree = Class(name="graphbt_BehaviorTree")
graphbt_ComponentList = Class(name="graphbt_ComponentList")
graphbt_EmptyNode = Class(name="graphbt_EmptyNode")
Node = Class(name="Node")
graphbt_Edge = Class(name="graphbt_Edge")
graphbt_SpecialEdge = Class(name="graphbt_SpecialEdge")
graphbt_Link = Class(name="graphbt_Link")
graphbt_MapInformation = Class(name="graphbt_MapInformation")
graphbt_MethodDeclaration = Class(name="graphbt_MethodDeclaration")
graphbt_Requirement = Class(name="graphbt_Requirement")
graphbt_Component = Class(name="graphbt_Component")
graphbt_Attribute = Class(name="graphbt_Attribute")
graphbt_State = Class(name="graphbt_State")
graphbt_Behavior = Class(name="graphbt_Behavior")
graphbt_Library = Class(name="graphbt_Library")
graphbt_CTEdge = Class(name="graphbt_CTEdge")
graphbt_Information = Class(name="graphbt_Information")
graphbt_InputType = Class(name="graphbt_InputType")
GUIImplementable = Class(name="GUIImplementable")
graphbt_OutputType = Class(name="graphbt_OutputType")
graphbt_GUIImplementable = Class(name="graphbt_GUIImplementable")
graphbt_GUI = Class(name="graphbt_GUI")
graphbt_InputGUI = Class(name="graphbt_InputGUI")
GUI = Class(name="GUI")
graphbt_OutputGUI = Class(name="graphbt_OutputGUI")
graphbt_Formula = Class(name="graphbt_Formula")
graphbt_OperatorClass = Class(name="graphbt_OperatorClass")
graphbt_TraceabilityStatusClass = Class(name="graphbt_TraceabilityStatusClass")
graphbt_AlternativeClass = Class(name="graphbt_AlternativeClass")
graphbt_Parameter = Class(name="graphbt_Parameter")
graphbt_Layout = Class(name="graphbt_Layout")
graphbt_Button = Class(name="graphbt_Button")
Layout = Class(name="Layout")
graphbt_Author = Class(name="graphbt_Author")
...
graphbt_StandardNode.attributes={graphbt_StandardNode_leaf, graphbt_StandardNode_traceabilityStatus, graphbt_StandardNode_operator, graphbt_StandardNode_traceabilityLink, graphbt_StandardNode_behaviorRef, graphbt_StandardNode_label, graphbt_StandardNode_componentRef}
...
graphbt_BEModel.attributes={graphbt_BEModel_subtitle, graphbt_BEModel_name, graphbt_BEModel_version}
...
graphbt_Edge.attributes={graphbt_Edge_composition, graphbt_Edge_branch}
...
graphbt_SpecialEdge.attributes={graphbt_SpecialEdge_type, graphbt_SpecialEdge_destination}

# graphbt_Link class attributes and methods

# graphbt_MapInformation class attributes and methods
graphbt_MapInformation_m_getValue: Method = Method(name="getValue", parameters={Parameter(name='graphbt_key', type=StringType)}, type=StringType)
graphbt_MapInformation_m_setValue: Method = Method(name="setValue", parameters={Parameter(name='graphbt_value', type=StringType), Parameter(name='graphbt_key', type=StringType)})
...
graphbt_MethodDeclaration.attributes={graphbt_MethodDeclaration_type, graphbt_MethodDeclaration_name}
...
graphbt_Component_m_getAttribute: Method = Method(name="getAttribute", parameters={Parameter(name='graphbt_name', type=StringType)}, type=StringType)
graphbt_Component.attributes={graphbt_Component_componentRef, graphbt_Component_componentDesc, graphbt_Component_componentName, graphbt_Component_enumerated, graphbt_Component_id}
...
graphbt_Attribute.attributes={graphbt_Attribute_name, graphbt_Attribute_value, graphbt_Attribute_type}
...
graphbt_State.attributes={graphbt_State_name, graphbt_State_desc, graphbt_State_ref}
...
graphbt_Behavior.attributes={graphbt_Behavior_behaviorRef, graphbt_Behavior_behaviorName, graphbt_Behavior_behaviorDesc, graphbt_Behavior_technicalDetail, graphbt_Behavior_behaviorType}
...
graphbt_Library.attributes={graphbt_Library_desc, graphbt_Library_location, graphbt_Library_text, graphbt_Library_name, graphbt_Library_id}
...
graphbt_Information.attributes={graphbt_Information_key, graphbt_Information_value}
...
graphbt_GUI.attributes={graphbt_GUI_identifier, graphbt_GUI_codeImplementation}
...
graphbt_Layout.attributes={graphbt_Layout_y, graphbt_Layout_width, graphbt_Layout_height, graphbt_Layout_cRef, graphbt_Layout_z, graphbt_Layout_x}
...
graphbt_Author.attributes={graphbt_Author_role, graphbt_Author_contact, graphbt_Author_name}
...
import_76: BinaryAssociation = BinaryAssociation(
    name="import_76",
    ends={
...
domain_model = DomainModel(
    name="graphbt",
    types={graphbt_RequirementList, graphbt_FormulaList, graphbt_Libraries, graphbt_StandardNode, graphbt_LayoutList, graphbt_AuthorList, graphbt_Node, graphbt_BEModel, graphbt_BehaviorTree, graphbt_ComponentList, graphbt_EmptyNode, Node, graphbt_Edge, graphbt_SpecialEdge, graphbt_Link, graphbt_MapInformation, graphbt_MethodDeclaration, graphbt_Requirement, graphbt_Component, graphbt_Attribute, graphbt_State, graphbt_Behavior, graphbt_Library, graphbt_CTEdge, graphbt_Information, graphbt_InputType, GUIImplementable, graphbt_OutputType, graphbt_GUIImplementable, graphbt_GUI, graphbt_InputGUI, GUI, graphbt_OutputGUI, graphbt_Formula, graphbt_OperatorClass, graphbt_TraceabilityStatusClass, graphbt_AlternativeClass, graphbt_Parameter, graphbt_Layout, graphbt_Button, Layout, graphbt_Author, SpecialEdgeEnum, TraceabilityStatus, Composition, Branch, Operator, BehaviorType, EventType},
    associations={requirementList3, formulaList5, libraries7, reversionNode9, errorReversionNode11, layoutList14, authorList16, rootNode18, dbt0, componentList1, container26, parent30, edge20, specialE22, childNode24, attributes45, methods47, states49, behaviors52, attributes55, traceabilityLink58, attributes32, state33, initialState35, relatedTo39, behaviors41, uses43, info74, import_76, components60, requirements63, formula66, target68, source71, parameters79, layouts81, authors83},
