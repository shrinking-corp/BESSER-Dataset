...
class graphbt_BehaviorTree:
    ...
    def __init__(self, name: str, graphbt_BehaviorTree19: "graphbt_Node" = None, graphbt_BehaviorTree: "graphbt_BEModel" = None):
        self.name = name
...
class graphbt_BEModel:
    ...
    def __init__(self, subtitle: str, version: str, name: str, graphbt_BEModel4: "graphbt_RequirementList" = None, graphbt_BEModel6: "graphbt_FormulaList" = None, graphbt_BEModel8: "graphbt_Libraries" = None, graphbt_BEModel10: set["graphbt_StandardNode"] = None, graphbt_BEModel12: set["graphbt_StandardNode"] = None, graphbt_BEModel15: "graphbt_LayoutList" = None, graphbt_BEModel17: "graphbt_AuthorList" = None, graphbt_BEModel: "graphbt_BehaviorTree" = None, graphbt_BEModel2: "graphbt_ComponentList" = None):
...
class graphbt_Node:
    ...
    def __init__(self, index: int, id: str, graphbt_Node: "graphbt_BehaviorTree" = None, graphbt_Node70: "graphbt_Link" = None, graphbt_Node73: "graphbt_Link" = None, graphbt_Node28: "graphbt_Edge" = None, graphbt_Node21: "graphbt_Edge" = None, graphbt_Node23: "graphbt_SpecialEdge" = None):
        self.index = index
        self.id = id
...
class graphbt_TraceabilityStatusClass:
    ...
    def __init__(self, traceabilityStatusLiteral: str):
        ...
        pass
    @property
    def traceabilityStatusLiteral(self):
...
class graphbt_Library:
    ...
    def __init__(self, name: str, text: str, desc: str, location: str, id: str, graphbt_Library48: set["graphbt_MethodDeclaration"] = None, graphbt_Library50: set["graphbt_State"] = None, graphbt_Library53: set["graphbt_Behavior"] = None, graphbt_Library56: set["graphbt_Attribute"] = None, graphbt_Library: "graphbt_Component" = None, graphbt_Library78: "graphbt_Libraries" = None):
        self.name = name
        self.text = text
        self.desc = desc
...
class graphbt_Behavior:
    ...
    def __init__(self, behaviorType: str, behaviorName: str, behaviorRef: str, behaviorDesc: str, technicalDetail: str, graphbt_Behavior54: "graphbt_Library" = None, graphbt_Behavior: "graphbt_Component" = None):
...
class graphbt_State:
    ...
    def __init__(self, ref: str, desc: str, name: str, graphbt_State46: "graphbt_MapInformation" = None, graphbt_State51: "graphbt_Library" = None, graphbt_State: "graphbt_Component" = None, graphbt_State37: "graphbt_Component" = None):
        self.ref = ref
        self.desc = desc
        self.name = name
...
class graphbt_Attribute:
    ...
    def __init__(self, type: str, name: str, value: str, graphbt_Attribute57: "graphbt_Library" = None, graphbt_Attribute: "graphbt_Component" = None):
        self.type = type
        self.name = name
        self.value = value
...
class graphbt_Component:
    ...
    def getAttribute(self, graphbt_name) :
...
class graphbt_MethodDeclaration:
    ...
    def __init__(self, name: str, type: str, graphbt_MethodDeclaration80: set["graphbt_Parameter"] = None, graphbt_MethodDeclaration: "graphbt_Library" = None):
        self.name = name
        self.type = type
...
class graphbt_MapInformation:
    ...
    def setValue(self, graphbt_key, graphbt_value):
        # TODO: Implement setValue method
        pass

    def getValue(self, graphbt_key) :
...
class graphbt_Edge:
    ...
    def __init__(self, branch: str, composition: str, graphbt_Edge27: "graphbt_Node" = None, graphbt_Edge: "graphbt_Node" = None, graphbt_Edge25: set["graphbt_Link"] = None):
        self.branch = branch
