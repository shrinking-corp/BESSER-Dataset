...
class siddhi_MINUTES:
    ...
    def __init__(self, minutes: str, min: str, minute: str):
...
class siddhi_DAYS:
    ...
    def __init__(self, days: str, day: str):
        self.days = days
        self.day = day
...
class siddhi_SECONDS:
    ...
    def __init__(self, second: str, seconds: str, sec: str):
        self.second = second
...
class siddhi_IN:
    ...
    def __init__(self, in_: str, siddhi_IN: "siddhi_MathInOperation" = None):
        self.in_ = in_
...
class siddhi_RightAbsentPatternSource1(RightAbsentPatternSource):
    ...
    def __init__(self, fb: str, siddhi_RightAbsentPatternSource1653: "siddhi_EveryAbsentPatternSource" = None, siddhi_RightAbsentPatternSource1: "siddhi_RightAbsentPatternSource" = None):
        self.fb = fb
...
class siddhi_SignedDoubleValue:
    ...
    pass
class siddhi_BoolValue(FALSE, TRUE):
...
class siddhi_NotOperation(MathOtherOperations):
    ...
    pass
class siddhi_NullCheck(IS, MathOtherOperations, NULL):
...
class ALL:
    ...
    pass
class siddhi_OutputRateType(LAST, ALL, FIRST):
...
class siddhi_OR:
    ...
    def __init__(self, or_: str, siddhi_OR: "siddhi_ConditionRanges" = None, siddhi_OR157: "siddhi_QueryOutput" = None, siddhi_OR340: "siddhi_LogicalStatefulSource" = None, siddhi_OR365: "siddhi_LogicalAbsentStatefulSource" = None, siddhi_OR659: "siddhi_MathLogicalOperation" = None, siddhi_OR627: "siddhi_Keyword" = None):
        self.or_ = or_
...
class siddhi_AS:
    ...
    def __init__(self, a: str, siddhi_AS200: "siddhi_OutAttr" = None, siddhi_AS: "siddhi_ConditionRange" = None, siddhi_AS451: "siddhi_MainSource" = None, siddhi_AS612: "siddhi_Keyword" = None):
        self.a = a
...
class siddhi_AttributeReference(SetAssignment):
    ...
    def __init__(self, name: str, hash1: str, hash2: str, siddhi_AttributeReference: "siddhi_DefinitionAggregation" = None, siddhi_AttributeReference187: "siddhi_GroupBy" = None, siddhi_AttributeReference195: "siddhi_OutputAttribute" = None, siddhi_AttributeReference525: "siddhi_SourceOrEventReference" = None, siddhi_AttributeReference528: "siddhi_AttributeIndex" = None, siddhi_AttributeReference531: "siddhi_FeaturesOrOutAttrReference" = None, siddhi_AttributeReference499: "siddhi_NullCheck" = None, siddhi_AttributeReference515: "siddhi_Literal" = None, siddhi_AttributeReference517: "siddhi_Expression" = None, siddhi_AttributeReference520: "siddhi_SourceOrEventReference" = None, siddhi_AttributeReference522: "siddhi_AttributeIndex" = None):
        self.name = name
        self.hash1 = hash1
        self.hash2 = hash2
...
class siddhi_Name:
    ...
    def __init__(self, na: str, siddhi_Name: "siddhi_Annotation" = None, siddhi_Name105: "siddhi_Features" = None, siddhi_Name100: "siddhi_PropertyName" = None, siddhi_Name444: "siddhi_StreamAlias" = None, siddhi_Name574: "siddhi_FunctionNamespace" = None, siddhi_Name577: "siddhi_FunctionId" = None, siddhi_Name505: "siddhi_StreamReference" = None, siddhi_Name666: "siddhi_MathInOperation" = None, siddhi_Name641: "siddhi_APP" = None):
        self.na = na
...
class siddhi_AggregationTimeInterval(AggregationTime):
    ...
    pass
class siddhi_AggregationTimeDuration(WEEKS, HOURS, YEARS, MINUTES, SECONDS, MONTHS, DAYS):
...
class OUTPUT:
    ...
    pass
class siddhi_OutputRate(OUTPUT, SNAPSHOT, EVENTS):
...
class siddhi_AttributeType(OBJECT, INTS, STRINGS, DOUBLE, LONG, FLOAT, BOOL):
...
class RETURN:
    ...
    pass
class siddhi_QueryOutput(DELETE, FOR, INTO, UPDATE, RETURN, INSERT):

    pass
class siddhi_AnonymousStream(FROM, RETURN):
...
class TRIGGER:
    ...
    pass
class siddhi_OutputEventType(RAW, ALL, EXPIRED, CURRENT, EVENTS):
...
class siddhi_Source1(Source1OrStandardStatefulSource):
    ...
    def __init__(self, inner: str, siddhi_Source170: "siddhi_DefinitionAggregation" = None, siddhi_Source1: "siddhi_DefinitionStream" = None, siddhi_Source132: "siddhi_DefinitionTable" = None, siddhi_Source141: "siddhi_DefinitionWindow" = None, siddhi_Source1110: "siddhi_Source" = None, siddhi_Source1162: "siddhi_Target" = None):
        self.inner = inner
...
class DEFINE:
    ...
    pass
class siddhi_DefinitionTable(DEFINE, TABLE):
...
class siddhi_Query(FROM):
    ...
    pass
class siddhi_ExecPartition(PARTITION, BEGIN, WITH, END):

    pass
class siddhi_ExecutionElement:

    pass
class siddhi_DefinitionAggregation(FROM, BY, AGGREGATION, DEFINE, AGGREGATE):

    pass
class siddhi_DefinitionFunction(FUNCTION, DEFINE, RETURN):

    pass
class siddhi_DefinitionTrigger(AT, TRIGGER, DEFINE):

    pass
class siddhi_DefinitionWindow(OUTPUT, WINDOW, DEFINE):
...
class siddhi_MathGtLtOperation(MathOperation):
    ...
    def __init__(self, lt: str, gt_eq: str, lt_eq: str, gt: str, siddhi_MathGtLtOperation: "siddhi_MathOperation" = None):
        self.lt = lt
        self.gt_eq = gt_eq
        self.lt_eq = lt_eq
        self.gt = gt
...
class siddhi_WithinTime(WITHIN):
    ...
    pass
class siddhi_joins(RIGHT, FULL, LEFT, JOIN, OUTER, INNER):
...
class AbsentPatternSourceChain:
    ...
    pass
class siddhi_EVERY(EverySequenceSourceChain, AbsentPatternSourceChain, EveryAbsentPatternSource, EveryAbsentSequenceSourceChain, LeftAbsentPatternSource, RightAbsentPatternSource):

    def __init__(self, every1: str, siddhi_EVERY79: "siddhi_DefinitionAggregation" = None, siddhi_EVERY: "siddhi_DefinitionTrigger" = None, siddhi_EVERY172: "siddhi_OutputRate" = None, siddhi_EVERY310: "siddhi_EveryPatternSourceChain" = None, siddhi_EVERY615: "siddhi_Keyword" = None):
        self.every1 = every1
...
class siddhi_BasicSource:
    ...
    pass
class siddhi_NOT(LogicalAbsentStatefulSource, BasicAbsentPatternSource):

    def __init__(self, not1: str, siddhi_NOT: "siddhi_LogicalAbsentStatefulSource" = None, siddhi_NOT672: "siddhi_NotOperation" = None, siddhi_NOT630: "siddhi_Keyword" = None, siddhi_NOT635: "siddhi_BasicSource" = None, siddhi_NOT638: "siddhi_ForTime" = None):
        self.not1 = not1
...
class siddhi_AND:
    ...
    def __init__(self, and_: str, siddhi_AND: "siddhi_LogicalStatefulSource" = None, siddhi_AND349: "siddhi_LogicalAbsentStatefulSource" = None, siddhi_AND656: "siddhi_MathLogicalOperation" = None, siddhi_AND624: "siddhi_Keyword" = None):
        self.and_ = and_
...
class siddhi_StandardStatefulSource(SequenceSource, SequenceCollectionStatefulSource, Source1OrStandardStatefulSource, PatternCollectionStatefulSource):
    ...
    def __init__(self, zero_or_more: str, zero_or_one: str, one_or_more: str, siddhi_StandardStatefulSource335: "siddhi_LogicalStatefulSource" = None, siddhi_StandardStatefulSource346: "siddhi_LogicalAbsentStatefulSource" = None, siddhi_StandardStatefulSource: "siddhi_PatternSource" = None, siddhi_StandardStatefulSource535: "siddhi_Collect" = None, siddhi_StandardStatefulSource537: "siddhi_Source" = None, siddhi_StandardStatefulSource540: "siddhi_BasicSourceStreamHandlers" = None):
...
class siddhi_LeftAbsentSequenceSource:
    ...
    def __init__(self, op: str, cp: str, comma: str, comm: str, siddhi_LeftAbsentSequenceSource240: "siddhi_EObject" = None, siddhi_LeftAbsentSequenceSource243: "siddhi_LeftAbsentSequenceSource" = None, siddhi_LeftAbsentSequenceSource241: "siddhi_LeftAbsentSequenceSource" = None, siddhi_LeftAbsentSequenceSource245: "siddhi_WithinTime" = None, siddhi_LeftAbsentSequenceSource248: "siddhi_BasicAbsentPatternSource" = None, siddhi_LeftAbsentSequenceSource251: "siddhi_SequenceSourceChain" = None, siddhi_LeftAbsentSequenceSource: "siddhi_AbsentSequenceSourceChain" = None, siddhi_LeftAbsentSequenceSource238: "siddhi_LeftAbsentSequenceSource" = None, siddhi_LeftAbsentSequenceSource236: "siddhi_LeftAbsentSequenceSource" = None):
        self.op = op
        self.cp = cp
        self.comma = comma
        self.comm = comm
