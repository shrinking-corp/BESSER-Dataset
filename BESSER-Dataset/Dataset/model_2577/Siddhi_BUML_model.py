...
# Classes
siddhi_SiddhiQL = Class(name="siddhi_SiddhiQL")
siddhi_DefinitionWindow = Class(name="siddhi_DefinitionWindow")
siddhi_DefinitionTrigger = Class(name="siddhi_DefinitionTrigger")
siddhi_DefinitionFunction = Class(name="siddhi_DefinitionFunction")
siddhi_DefinitionAggregation = Class(name="siddhi_DefinitionAggregation")
siddhi_ExecutionElement = Class(name="siddhi_ExecutionElement")
siddhi_ExecPartition = Class(name="siddhi_ExecPartition")
siddhi_Query = Class(name="siddhi_Query")
DEFINE = Class(name="DEFINE")
STREAM = Class(name="STREAM")
siddhi_Annotation = Class(name="siddhi_Annotation")
siddhi_Source1 = Class(name="siddhi_Source1")
siddhi_Features = Class(name="siddhi_Features")
TABLE = Class(name="TABLE")
siddhi_ExecutionPlan = Class(name="siddhi_ExecutionPlan")
siddhi_AppAnnotation = Class(name="siddhi_AppAnnotation")
siddhi_DefinitionStream = Class(name="siddhi_DefinitionStream")
siddhi_DefinitionTable = Class(name="siddhi_DefinitionTable")
siddhi_FunctionOperation = Class(name="siddhi_FunctionOperation")
siddhi_OutputEventType = Class(name="siddhi_OutputEventType")
TRIGGER = Class(name="TRIGGER")
AT = Class(name="AT")
siddhi_TriggerName = Class(name="siddhi_TriggerName")
siddhi_EVERY = Class(name="siddhi_EVERY")
siddhi_TimeValue = Class(name="siddhi_TimeValue")
siddhi_StringValue = Class(name="siddhi_StringValue")
FUNCTION = Class(name="FUNCTION")
RETURN = Class(name="RETURN")
siddhi_FunctionName = Class(name="siddhi_FunctionName")
siddhi_LanguageName = Class(name="siddhi_LanguageName")
siddhi_AttributeType = Class(name="siddhi_AttributeType")
siddhi_FunctionBody = Class(name="siddhi_FunctionBody")
...
siddhi_AggregationTime = Class(name="siddhi_AggregationTime")
siddhi_AggregationTimeDuration = Class(name="siddhi_AggregationTimeDuration")
siddhi_AggregationTimeInterval = Class(name="siddhi_AggregationTimeInterval")
...
siddhi_AggregationTimeRange = Class(name="siddhi_AggregationTimeRange")
siddhi_Name = Class(name="siddhi_Name")
siddhi_AnnotationElement = Class(name="siddhi_AnnotationElement")
siddhi_PropertyName = Class(name="siddhi_PropertyName")
BY = Class(name="BY")
siddhi_StandardStream = Class(name="siddhi_StandardStream")
siddhi_GroupByQuerySelection = Class(name="siddhi_GroupByQuerySelection")
siddhi_AttributeReference = Class(name="siddhi_AttributeReference")
siddhi_PropertySeparator = Class(name="siddhi_PropertySeparator")
...
siddhi_Source = Class(name="siddhi_Source")
...
END = Class(name="END")
siddhi_PartitionWithStream = Class(name="siddhi_PartitionWithStream")
siddhi_PropertyValue = Class(name="siddhi_PropertyValue")
siddhi_Expression = Class(name="siddhi_Expression")
siddhi_AS = Class(name="siddhi_AS")
siddhi_QueryInput = Class(name="siddhi_QueryInput")
siddhi_QuerySection = Class(name="siddhi_QuerySection")
siddhi_OutputRate = Class(name="siddhi_OutputRate")
siddhi_QueryOutput = Class(name="siddhi_QueryOutput")
INSERT = Class(name="INSERT")
INTO = Class(name="INTO")
DELETE = Class(name="DELETE")
FOR = Class(name="FOR")
UPDATE = Class(name="UPDATE")
siddhi_Target = Class(name="siddhi_Target")
siddhi_ON = Class(name="siddhi_ON")
siddhi_ConditionRanges = Class(name="siddhi_ConditionRanges")
PartitionWithStream = Class(name="PartitionWithStream")
siddhi_OF = Class(name="siddhi_OF")
siddhi_ConditionRange = Class(name="siddhi_ConditionRange")
siddhi_OR = Class(name="siddhi_OR")
SET = Class(name="SET")
siddhi_SetAssignment = Class(name="siddhi_SetAssignment")
ALL = Class(name="ALL")
...
siddhi_OutputRateType = Class(name="siddhi_OutputRateType")
LAST = Class(name="LAST")
FIRST = Class(name="FIRST")
SELECT = Class(name="SELECT")
siddhi_OutputAttribute = Class(name="siddhi_OutputAttribute")
siddhi_GroupBy = Class(name="siddhi_GroupBy")
siddhi_SetClause = Class(name="siddhi_SetClause")
siddhi_Attribute = Class(name="siddhi_Attribute")
siddhi_JoinStream = Class(name="siddhi_JoinStream")
siddhi_SequenceStream = Class(name="siddhi_SequenceStream")
siddhi_PatternStream = Class(name="siddhi_PatternStream")
siddhi_AnonymousStream = Class(name="siddhi_AnonymousStream")
siddhi_EverySequenceSourceChain = Class(name="siddhi_EverySequenceSourceChain")
siddhi_EveryAbsentSequenceSourceChain = Class(name="siddhi_EveryAbsentSequenceSourceChain")
siddhi_SequenceSource = Class(name="siddhi_SequenceSource")
siddhi_WithinTime = Class(name="siddhi_WithinTime")
siddhi_SequenceSourceChain = Class(name="siddhi_SequenceSourceChain")
siddhi_AbsentSequenceSourceChain = Class(name="siddhi_AbsentSequenceSourceChain")
siddhi_HavingExpr = Class(name="siddhi_HavingExpr")
GROUP = Class(name="GROUP")
HAVING = Class(name="HAVING")
siddhi_OutAttr = Class(name="siddhi_OutAttr")
siddhi_EObject = Class(name="siddhi_EObject")
siddhi_BasicAbsentPatternSource = Class(name="siddhi_BasicAbsentPatternSource")
siddhi_LeftAbsentSequenceSource = Class(name="siddhi_LeftAbsentSequenceSource")
siddhi_RightAbsentSequenceSource = Class(name="siddhi_RightAbsentSequenceSource")
siddhi_EveryPatternSourceChain = Class(name="siddhi_EveryPatternSourceChain")
PatternStream = Class(name="PatternStream")
siddhi_PatternSourceChain = Class(name="siddhi_PatternSourceChain")
SequenceSourceChain = Class(name="SequenceSourceChain")
siddhi_SequenceCollectionStatefulSource = Class(name="siddhi_SequenceCollectionStatefulSource")
SequenceSource = Class(name="SequenceSource")
siddhi_AND = Class(name="siddhi_AND")
siddhi_Collect = Class(name="siddhi_Collect")
siddhi_NOT = Class(name="siddhi_NOT")
siddhi_BasicSource = Class(name="siddhi_BasicSource")
siddhi_AbsentPatternSourceChain = Class(name="siddhi_AbsentPatternSourceChain")
siddhi_PatternSource = Class(name="siddhi_PatternSource")
siddhi_LogicalStatefulSource = Class(name="siddhi_LogicalStatefulSource")
siddhi_PatternCollectionStatefulSource = Class(name="siddhi_PatternCollectionStatefulSource")
siddhi_StandardStatefulSource = Class(name="siddhi_StandardStatefulSource")
siddhi_LogicalAbsentStatefulSource = Class(name="siddhi_LogicalAbsentStatefulSource")
siddhi_LeftAbsentPatternSource = Class(name="siddhi_LeftAbsentPatternSource")
siddhi_RightAbsentPatternSource = Class(name="siddhi_RightAbsentPatternSource")
siddhi_EveryAbsentPatternSource = Class(name="siddhi_EveryAbsentPatternSource")
AbsentPatternSourceChain = Class(name="AbsentPatternSourceChain")
siddhi_ForTime = Class(name="siddhi_ForTime")
siddhi_WithinTimeRange = Class(name="siddhi_WithinTimeRange")
siddhi_Per1 = Class(name="siddhi_Per1")
siddhi_joins = Class(name="siddhi_joins")
WITHIN = Class(name="WITHIN")
PER = Class(name="PER")
siddhi_StreamAlias = Class(name="siddhi_StreamAlias")
...
siddhi_MainSource = Class(name="siddhi_MainSource")
JoinSource = Class(name="JoinSource")
StandardStream = Class(name="StandardStream")
siddhi_Win = Class(name="siddhi_Win")
siddhi_JoinSource = Class(name="siddhi_JoinSource")
siddhi_UNIDIRECTIONAL = Class(name="siddhi_UNIDIRECTIONAL")
siddhi_BasicSourceStreamHandler = Class(name="siddhi_BasicSourceStreamHandler")
siddhi_Filter = Class(name="siddhi_Filter")
siddhi_StreamFunction = Class(name="siddhi_StreamFunction")
siddhi_MathOperation = Class(name="siddhi_MathOperation")
Expression = Class(name="Expression")
siddhi_MathAddsubOperation = Class(name="siddhi_MathAddsubOperation")
MathOperation = Class(name="MathOperation")
siddhi_BasicSourceStreamHandlers = Class(name="siddhi_BasicSourceStreamHandlers")
siddhi_BasicSourceStreamHandlers1 = Class(name="siddhi_BasicSourceStreamHandlers1")
siddhi_NullCheck = Class(name="siddhi_NullCheck")
MathOtherOperations = Class(name="MathOtherOperations")
IS = Class(name="IS")
NULL = Class(name="NULL")
siddhi_StreamReference = Class(name="siddhi_StreamReference")
siddhi_AttributeIndex = Class(name="siddhi_AttributeIndex")
siddhi_ConstantValue = Class(name="siddhi_ConstantValue")
SetAssignment = Class(name="SetAssignment")
siddhi_SourceOrEventReference = Class(name="siddhi_SourceOrEventReference")
siddhi_MathDivmulOperation = Class(name="siddhi_MathDivmulOperation")
MathAddsubOperation = Class(name="MathAddsubOperation")
siddhi_MathOtherOperations = Class(name="siddhi_MathOtherOperations")
MathDivmulOperation = Class(name="MathDivmulOperation")
siddhi_Literal = Class(name="siddhi_Literal")
...
siddhi_Source1OrStandardStatefulSource = Class(name="siddhi_Source1OrStandardStatefulSource")
siddhi_AttributeNameReference = Class(name="siddhi_AttributeNameReference")
siddhi_BoolValue = Class(name="siddhi_BoolValue")
siddhi_SignedDoubleValue = Class(name="siddhi_SignedDoubleValue")
siddhi_SignedFloatValue = Class(name="siddhi_SignedFloatValue")
siddhi_FeaturesOrOutAttrReference = Class(name="siddhi_FeaturesOrOutAttrReference")
siddhi_FeaturesOrOutAttr = Class(name="siddhi_FeaturesOrOutAttr")
siddhi_AttributeList = Class(name="siddhi_AttributeList")
TRUE = Class(name="TRUE")
FALSE = Class(name="FALSE")
siddhi_YearValue = Class(name="siddhi_YearValue")
siddhi_MonthValue = Class(name="siddhi_MonthValue")
siddhi_WeekValue = Class(name="siddhi_WeekValue")
siddhi_DayValue = Class(name="siddhi_DayValue")
siddhi_HourValue = Class(name="siddhi_HourValue")
siddhi_SignedLongValue = Class(name="siddhi_SignedLongValue")
siddhi_FunctionNamespace = Class(name="siddhi_FunctionNamespace")
siddhi_FunctionId = Class(name="siddhi_FunctionId")
MILLISECONDS = Class(name="MILLISECONDS")
siddhi_DOUBLE_LITERAL = Class(name="siddhi_DOUBLE_LITERAL")
SignedDoubleValue = Class(name="SignedDoubleValue")
siddhi_E = Class(name="siddhi_E")
siddhi_D = Class(name="siddhi_D")
siddhi_FLOAT_LITERAL = Class(name="siddhi_FLOAT_LITERAL")
SignedFloatValue = Class(name="SignedFloatValue")
siddhi_F = Class(name="siddhi_F")
siddhi_LONG_LITERAL = Class(name="siddhi_LONG_LITERAL")
SignedLongValue = Class(name="SignedLongValue")
siddhi_L = Class(name="siddhi_L")
siddhi_Keyword = Class(name="siddhi_Keyword")
Name = Class(name="Name")
siddhi_MinuteValue = Class(name="siddhi_MinuteValue")
siddhi_SecondValue = Class(name="siddhi_SecondValue")
siddhi_MillisecondValue = Class(name="siddhi_MillisecondValue")
...
siddhi_IN = Class(name="siddhi_IN")
siddhi_APP = Class(name="siddhi_APP")
AppAnnotation = Class(name="AppAnnotation")
siddhi_STREAM = Class(name="siddhi_STREAM")
siddhi_DEFINE = Class(name="siddhi_DEFINE")
...
siddhi_FLOAT = Class(name="siddhi_FLOAT")
siddhi_BOOL = Class(name="siddhi_BOOL")
siddhi_OBJECT = Class(name="siddhi_OBJECT")
siddhi_ALL = Class(name="siddhi_ALL")
siddhi_EVENTS = Class(name="siddhi_EVENTS")
siddhi_RAW = Class(name="siddhi_RAW")
siddhi_EXPIRED = Class(name="siddhi_EXPIRED")
siddhi_CURRENT = Class(name="siddhi_CURRENT")
siddhi_LAST = Class(name="siddhi_LAST")
siddhi_IS = Class(name="siddhi_IS")
siddhi_NULL = Class(name="siddhi_NULL")
siddhi_TRIGGER = Class(name="siddhi_TRIGGER")
siddhi_AT = Class(name="siddhi_AT")
siddhi_FUNCTION = Class(name="siddhi_FUNCTION")
siddhi_RETURN = Class(name="siddhi_RETURN")
siddhi_FROM = Class(name="siddhi_FROM")
siddhi_TABLE = Class(name="siddhi_TABLE")
siddhi_WINDOW = Class(name="siddhi_WINDOW")
siddhi_OUTPUT = Class(name="siddhi_OUTPUT")
siddhi_STRINGS = Class(name="siddhi_STRINGS")
siddhi_INTS = Class(name="siddhi_INTS")
siddhi_LONG = Class(name="siddhi_LONG")
siddhi_DOUBLE = Class(name="siddhi_DOUBLE")
siddhi_SELECT = Class(name="siddhi_SELECT")
siddhi_GROUP = Class(name="siddhi_GROUP")
siddhi_BY = Class(name="siddhi_BY")
siddhi_HAVING = Class(name="siddhi_HAVING")
siddhi_SNAPSHOT = Class(name="siddhi_SNAPSHOT")
siddhi_FIRST = Class(name="siddhi_FIRST")
siddhi_INSERT = Class(name="siddhi_INSERT")
siddhi_INTO = Class(name="siddhi_INTO")
siddhi_BEGIN = Class(name="siddhi_BEGIN")
siddhi_PLAN = Class(name="siddhi_PLAN")
siddhi_DELETE = Class(name="siddhi_DELETE")
siddhi_FOR = Class(name="siddhi_FOR")
siddhi_UPDATE = Class(name="siddhi_UPDATE")
siddhi_END = Class(name="siddhi_END")
siddhi_PARTITION = Class(name="siddhi_PARTITION")
siddhi_WITH = Class(name="siddhi_WITH")
siddhi_AGGREGATION = Class(name="siddhi_AGGREGATION")
siddhi_AGGREGATE = Class(name="siddhi_AGGREGATE")
siddhi_SET = Class(name="siddhi_SET")
siddhi_PER = Class(name="siddhi_PER")
siddhi_YEARS = Class(name="siddhi_YEARS")
siddhi_WITHIN = Class(name="siddhi_WITHIN")
siddhi_LEFT = Class(name="siddhi_LEFT")
siddhi_RIGHT = Class(name="siddhi_RIGHT")
siddhi_FULL = Class(name="siddhi_FULL")
siddhi_JOIN = Class(name="siddhi_JOIN")
siddhi_INNER = Class(name="siddhi_INNER")
siddhi_OUTER = Class(name="siddhi_OUTER")
siddhi_SECONDS = Class(name="siddhi_SECONDS")
siddhi_MILLISECONDS = Class(name="siddhi_MILLISECONDS")
siddhi_FALSE = Class(name="siddhi_FALSE")
siddhi_TRUE = Class(name="siddhi_TRUE")
siddhi_LeftAbsentSequenceSource1 = Class(name="siddhi_LeftAbsentSequenceSource1")
LeftAbsentSequenceSource = Class(name="LeftAbsentSequenceSource")
siddhi_RightAbsentSequenceSource1 = Class(name="siddhi_RightAbsentSequenceSource1")
RightAbsentSequenceSource = Class(name="RightAbsentSequenceSource")
siddhi_LeftAbsentPatternSource1 = Class(name="siddhi_LeftAbsentPatternSource1")
siddhi_RightAbsentPatternSource1 = Class(name="siddhi_RightAbsentPatternSource1")
siddhi_MathLogicalOperation = Class(name="siddhi_MathLogicalOperation")
siddhi_MONTHS = Class(name="siddhi_MONTHS")
siddhi_WEEKS = Class(name="siddhi_WEEKS")
siddhi_DAYS = Class(name="siddhi_DAYS")
siddhi_HOURS = Class(name="siddhi_HOURS")
siddhi_MINUTES = Class(name="siddhi_MINUTES")
siddhi_MathEqualOperation = Class(name="siddhi_MathEqualOperation")
siddhi_NotOperation = Class(name="siddhi_NotOperation")
siddhi_MathInOperation = Class(name="siddhi_MathInOperation")
siddhi_MathGtLtOperation = Class(name="siddhi_MathGtLtOperation")
...
siddhi_AttributeReference.attributes={siddhi_AttributeReference_hash2, siddhi_AttributeReference_hash1, siddhi_AttributeReference_name}
...
siddhi_OR_or_: Property = Property(name="or_", type=StringType)
siddhi_OR.attributes={siddhi_OR_or_}
...
siddhi_LeftAbsentSequenceSource.attributes={siddhi_LeftAbsentSequenceSource_op, siddhi_LeftAbsentSequenceSource_comm, siddhi_LeftAbsentSequenceSource_comma, siddhi_LeftAbsentSequenceSource_cp}
...
siddhi_RightAbsentSequenceSource.attributes={siddhi_RightAbsentSequenceSource_op, siddhi_RightAbsentSequenceSource_comma, siddhi_RightAbsentSequenceSource_comm, siddhi_RightAbsentSequenceSource_cp}
...
siddhi_AND_and_: Property = Property(name="and_", type=StringType)
siddhi_AND.attributes={siddhi_AND_and_}
...
siddhi_Collect.attributes={siddhi_Collect_start, siddhi_Collect_end}
...
siddhi_MathAddsubOperation.attributes={siddhi_MathAddsubOperation_add, siddhi_MathAddsubOperation_substract}
...
siddhi_MathDivmulOperation.attributes={siddhi_MathDivmulOperation_devide, siddhi_MathDivmulOperation_multiply, siddhi_MathDivmulOperation_mod}
...
siddhi_IN_in_: Property = Property(name="in_", type=StringType)
siddhi_IN.attributes={siddhi_IN_in_}
...
siddhi_IS_is_: Property = Property(name="is_", type=StringType)
siddhi_IS.attributes={siddhi_IS_is_}
...
siddhi_RETURN_return_: Property = Property(name="return_", type=StringType)
siddhi_RETURN.attributes={siddhi_RETURN_return_}

# siddhi_FROM class attributes and methods
siddhi_FROM_from_: Property = Property(name="from_", type=StringType)
siddhi_FROM.attributes={siddhi_FROM_from_}
...
siddhi_FOR_for_: Property = Property(name="for_", type=StringType)
siddhi_FOR.attributes={siddhi_FOR_for_}
...
siddhi_YEARS.attributes={siddhi_YEARS_year, siddhi_YEARS_years}
...
siddhi_SECONDS.attributes={siddhi_SECONDS_sec, siddhi_SECONDS_seconds, siddhi_SECONDS_second}
...
siddhi_MILLISECONDS.attributes={siddhi_MILLISECONDS_millisecond, siddhi_MILLISECONDS_millisec, siddhi_MILLISECONDS_milliseconds}
...
siddhi_MONTHS.attributes={siddhi_MONTHS_month, siddhi_MONTHS_months}
...
siddhi_WEEKS.attributes={siddhi_WEEKS_week, siddhi_WEEKS_weeks}
...
siddhi_DAYS.attributes={siddhi_DAYS_day, siddhi_DAYS_days}
...
siddhi_HOURS.attributes={siddhi_HOURS_hour, siddhi_HOURS_hours}
...
siddhi_MINUTES.attributes={siddhi_MINUTES_min, siddhi_MINUTES_minute, siddhi_MINUTES_minutes}
...
siddhi_MathGtLtOperation.attributes={siddhi_MathGtLtOperation_lt, siddhi_MathGtLtOperation_gt_eq, siddhi_MathGtLtOperation_lt_eq, siddhi_MathGtLtOperation_gt}
...
or_125: BinaryAssociation = BinaryAssociation(
    name="or_125",
    ends={
...
or_155: BinaryAssociation = BinaryAssociation(
    name="or_155",
    ends={
...
and_336: BinaryAssociation = BinaryAssociation(
    name="and_336",
    ends={
...
or_338: BinaryAssociation = BinaryAssociation(
    name="or_338",
    ends={
...
and_347: BinaryAssociation = BinaryAssociation(
    name="and_347",
    ends={
...
not_350: BinaryAssociation = BinaryAssociation(
    name="not_350",
    ends={
...
and_622: BinaryAssociation = BinaryAssociation(
    name="and_622",
    ends={
...
or_625: BinaryAssociation = BinaryAssociation(
    name="or_625",
    ends={
...
not_628: BinaryAssociation = BinaryAssociation(
    name="not_628",
    ends={
...
and_655: BinaryAssociation = BinaryAssociation(
    name="and_655",
    ends={
...
or_657: BinaryAssociation = BinaryAssociation(
    name="or_657",
    ends={
...
not_671: BinaryAssociation = BinaryAssociation(
    name="not_671",
    ends={
...
in_663: BinaryAssociation = BinaryAssociation(
    name="in_663",
    ends={
...
domain_model = DomainModel(
    name="siddhi",
    types={siddhi_SiddhiQL, siddhi_DefinitionWindow, siddhi_DefinitionTrigger, siddhi_DefinitionFunction, siddhi_DefinitionAggregation, siddhi_ExecutionElement, siddhi_ExecPartition, siddhi_Query, DEFINE, STREAM, siddhi_Annotation, siddhi_Source1, siddhi_Features, TABLE, siddhi_ExecutionPlan, siddhi_AppAnnotation, siddhi_DefinitionStream, siddhi_DefinitionTable, siddhi_FunctionOperation, siddhi_OutputEventType, TRIGGER, AT, siddhi_TriggerName, siddhi_EVERY, siddhi_TimeValue, siddhi_StringValue, FUNCTION, RETURN, siddhi_FunctionName, siddhi_LanguageName, siddhi_AttributeType, siddhi_FunctionBody, AGGREGATION, FROM, AGGREGATE, WINDOW, OUTPUT, siddhi_AggregationTime, siddhi_AggregationTimeDuration, siddhi_AggregationTimeInterval, AggregationTime, SECONDS, MINUTES, HOURS, DAYS, WEEKS, MONTHS, YEARS, siddhi_AggregationTimeRange, siddhi_Name, siddhi_AnnotationElement, siddhi_PropertyName, BY, siddhi_StandardStream, siddhi_GroupByQuerySelection, siddhi_AttributeReference, siddhi_PropertySeparator, FeaturesOrOutAttr, STRINGS, INTS, LONG, FLOAT, DOUBLE, BOOL, OBJECT, siddhi_Source, Source1OrStandardStatefulSource, PARTITION, WITH, BEGIN, END, siddhi_PartitionWithStream, siddhi_PropertyValue, siddhi_Expression, siddhi_AS, siddhi_QueryInput, siddhi_QuerySection, siddhi_OutputRate, siddhi_QueryOutput, INSERT, INTO, DELETE, FOR, UPDATE, siddhi_Target, siddhi_ON, siddhi_ConditionRanges, PartitionWithStream, siddhi_OF, siddhi_ConditionRange, siddhi_OR, SET, siddhi_SetAssignment, ALL, EVENTS, RAW, EXPIRED, CURRENT, SNAPSHOT, siddhi_OutputRateType, LAST, FIRST, SELECT, siddhi_OutputAttribute, siddhi_GroupBy, siddhi_SetClause, siddhi_Attribute, siddhi_JoinStream, siddhi_SequenceStream, siddhi_PatternStream, siddhi_AnonymousStream, siddhi_EverySequenceSourceChain, siddhi_EveryAbsentSequenceSourceChain, siddhi_SequenceSource, siddhi_WithinTime, siddhi_SequenceSourceChain, siddhi_AbsentSequenceSourceChain, siddhi_HavingExpr, GROUP, HAVING, siddhi_OutAttr, siddhi_EObject, siddhi_BasicAbsentPatternSource, siddhi_LeftAbsentSequenceSource, siddhi_RightAbsentSequenceSource, siddhi_EveryPatternSourceChain, PatternStream, siddhi_PatternSourceChain, SequenceSourceChain, siddhi_SequenceCollectionStatefulSource, SequenceSource, siddhi_AND, siddhi_Collect, siddhi_NOT, siddhi_BasicSource, siddhi_AbsentPatternSourceChain, siddhi_PatternSource, siddhi_LogicalStatefulSource, siddhi_PatternCollectionStatefulSource, siddhi_StandardStatefulSource, siddhi_LogicalAbsentStatefulSource, siddhi_LeftAbsentPatternSource, siddhi_RightAbsentPatternSource, siddhi_EveryAbsentPatternSource, AbsentPatternSourceChain, siddhi_ForTime, siddhi_WithinTimeRange, siddhi_Per1, siddhi_joins, WITHIN, PER, siddhi_StreamAlias, LEFT, OUTER, JOIN, RIGHT, FULL, INNER, JoinStream, siddhi_MainSource, JoinSource, StandardStream, siddhi_Win, siddhi_JoinSource, siddhi_UNIDIRECTIONAL, siddhi_BasicSourceStreamHandler, siddhi_Filter, siddhi_StreamFunction, siddhi_MathOperation, Expression, siddhi_MathAddsubOperation, MathOperation, siddhi_BasicSourceStreamHandlers, siddhi_BasicSourceStreamHandlers1, siddhi_NullCheck, MathOtherOperations, IS, NULL, siddhi_StreamReference, siddhi_AttributeIndex, siddhi_ConstantValue, SetAssignment, siddhi_SourceOrEventReference, siddhi_MathDivmulOperation, MathAddsubOperation, siddhi_MathOtherOperations, MathDivmulOperation, siddhi_Literal, SequenceCollectionStatefulSource, PatternCollectionStatefulSource, siddhi_Source1OrStandardStatefulSource, siddhi_AttributeNameReference, siddhi_BoolValue, siddhi_SignedDoubleValue, siddhi_SignedFloatValue, siddhi_FeaturesOrOutAttrReference, siddhi_FeaturesOrOutAttr, siddhi_AttributeList, TRUE, FALSE, siddhi_YearValue, siddhi_MonthValue, siddhi_WeekValue, siddhi_DayValue, siddhi_HourValue, siddhi_SignedLongValue, siddhi_FunctionNamespace, siddhi_FunctionId, MILLISECONDS, siddhi_DOUBLE_LITERAL, SignedDoubleValue, siddhi_E, siddhi_D, siddhi_FLOAT_LITERAL, SignedFloatValue, siddhi_F, siddhi_LONG_LITERAL, SignedLongValue, siddhi_L, siddhi_Keyword, Name, siddhi_MinuteValue, siddhi_SecondValue, siddhi_MillisecondValue, LogicalAbsentStatefulSource, EveryAbsentPatternSource, LeftAbsentPatternSource, RightAbsentPatternSource, siddhi_IN, siddhi_APP, AppAnnotation, siddhi_STREAM, siddhi_DEFINE, BasicAbsentPatternSource, EverySequenceSourceChain, EveryAbsentSequenceSourceChain, siddhi_FLOAT, siddhi_BOOL, siddhi_OBJECT, siddhi_ALL, siddhi_EVENTS, siddhi_RAW, siddhi_EXPIRED, siddhi_CURRENT, siddhi_LAST, siddhi_IS, siddhi_NULL, siddhi_TRIGGER, siddhi_AT, siddhi_FUNCTION, siddhi_RETURN, siddhi_FROM, siddhi_TABLE, siddhi_WINDOW, siddhi_OUTPUT, siddhi_STRINGS, siddhi_INTS, siddhi_LONG, siddhi_DOUBLE, siddhi_SELECT, siddhi_GROUP, siddhi_BY, siddhi_HAVING, siddhi_SNAPSHOT, siddhi_FIRST, siddhi_INSERT, siddhi_INTO, siddhi_BEGIN, siddhi_PLAN, siddhi_DELETE, siddhi_FOR, siddhi_UPDATE, siddhi_END, siddhi_PARTITION, siddhi_WITH, siddhi_AGGREGATION, siddhi_AGGREGATE, siddhi_SET, siddhi_PER, siddhi_YEARS, siddhi_WITHIN, siddhi_LEFT, siddhi_RIGHT, siddhi_FULL, siddhi_JOIN, siddhi_INNER, siddhi_OUTER, siddhi_SECONDS, siddhi_MILLISECONDS, siddhi_FALSE, siddhi_TRUE, siddhi_LeftAbsentSequenceSource1, LeftAbsentSequenceSource, siddhi_RightAbsentSequenceSource1, RightAbsentSequenceSource, siddhi_LeftAbsentPatternSource1, siddhi_RightAbsentPatternSource1, siddhi_MathLogicalOperation, siddhi_MONTHS, siddhi_WEEKS, siddhi_DAYS, siddhi_HOURS, siddhi_MINUTES, siddhi_MathEqualOperation, siddhi_NotOperation, siddhi_MathInOperation, siddhi_MathGtLtOperation},
    associations={def_window7, defTrigger9, defFunction11, defAggregation13, exElement15, execPartition17, que19, ann21, src23, feature25, ann127, src30, elements0, appAnn1, defStream3, defTable5, funcOp45, opEventType47, tn49, every51, tv53, sv55, fn57, ln59, attr_type61, func_body63, feature33, ann236, src39, feature42, eve77, aggrTime80, aggrtimeDur82, name84, annElement86, ann89, ann65, src68, stdStream71, groupByQuerySel73, attrRef75, ps101, nam103, type106, strId109, ann4111, partWithStream114, qu116, propName91, propVal93, sv95, name98, expr127, a129, sv131, ann3134, qInp137, querySec139, outRate141, qOutput143, outEventType145, tar148, on150, of119, str_id2120, conRange123, or_125, src163, setAssignment166, op_rate_type168, every170, tv173, out_att176, grp_by178, grpByQuerySel180, expr152, or_155, setClause158, na160, attr196, a198, js201, seqSrcChanin203, ps205, anonStream207, everySequenceSourceChain209, everyAbsentSequenceSourceChain211, seqSource213, wt215, ssc217, absSeqSrcChain219, seqSrcChain221, absentSequenceSourceChain225, having183, attr_ref185, expr188, outAttr191, attr_ref193, right239, leftAbsentSequenceSource242, wt6244, basicAbsentPatternSource247, sequenceSourceChain250, left1254, right1257, rightAbsentSequenceSource260, wt7262, sequenceSourceChain265, basicAbsentPatternSource268, left272, wt5227, basicAbsentPatternSource230, leftAbsentSequenceSource232, rightAbsentSequenceSource234, left237, qi283, qs286, out_rate289, op_event_type292, left296, right298, eps301, wt303, psc306, every308, left312, right315, psc_2318, right275, wt1277, wt280, stdSource333, and_336, or_338, logicalAbsStatefulSrc342, stdSource344, and_347, not_350, bs352, basicAbsentPatternSource1354, basicAbsentPatternSource2357, basicAbsentPatternSource360, o363, absentPatternSrcChain367, wt320, ps323, lss325, pss327, stdss329, logicalAbsStatefulSrc331, tv373, left376, right377, leftAbsPS381, wt2383, everyAbsPS386, everyPSC389, leftAbsPatternSrc393, left1396, right1398, rightAbsPS401, wt3403, everyPSC1406, everyAbsPS1409, wt1368, basicAbsentPS371, wtr425, p427, join429, left_uni431, startPattern434, endPattern437, exp440, nam443, tv445, left_source412, right_source414, right_uni417, on419, expr422, basicSsHandler462, exp464, fo467, func_op470, fil473, sf475, exp477, fo480, func_op483, mlo487, left489, window448, a449, strAlias452, postWindowHandlers455, src457, basicSSh460, stream_ref496, attr_ref497, fo500, name503, aatr_index506, const_val508, fo510, attrRef513, expression516, name1519, OPEN_SQARE_BRACKETSattribute_index1521, right491, op492, lit494, coll534, src536, basic_ss_handlers539, src542, basic_ss_handlers545, na548, attrName1550, bv552, sdv554, name2524, OPEN_SQARE_BRACKETSattribute_index2527, featuresOrAttrRef530, srcoutAttrref532, attrList570, name572, name575, attr578, mathOp581, yv584, mv586, wv588, dv590, hv592, sfv556, slv558, tv560, sv563, funcNamespace566, funcId568, e603, d604, e606, f608, l610, minv594, secv596, msecv598, sv600, a611, every613, uni616, on619, and_622, or_625, not_628, of631, name640, ann5642, basicSrc634, ft637, left645, right647, left650, right652, and_655, or_657, right667, right669, not_671, right660, in_663, name664},
    generalizations={gen_siddhi_DefinitionStream_DEFINE, gen_siddhi_DefinitionStream_STREAM, gen_siddhi_DefinitionTable_DEFINE, gen_siddhi_DefinitionTable_TABLE, gen_siddhi_DefinitionTrigger_DEFINE, gen_siddhi_DefinitionTrigger_TRIGGER, gen_siddhi_DefinitionTrigger_AT, gen_siddhi_DefinitionFunction_DEFINE, gen_siddhi_DefinitionFunction_FUNCTION, gen_siddhi_DefinitionFunction_RETURN, gen_siddhi_DefinitionAggregation_DEFINE, gen_siddhi_DefinitionAggregation_AGGREGATION, gen_siddhi_DefinitionAggregation_FROM, gen_siddhi_DefinitionAggregation_AGGREGATE, gen_siddhi_DefinitionWindow_DEFINE, gen_siddhi_DefinitionWindow_WINDOW, gen_siddhi_DefinitionWindow_OUTPUT, gen_siddhi_AggregationTimeInterval_AggregationTime, gen_siddhi_AggregationTimeDuration_SECONDS, gen_siddhi_AggregationTimeDuration_MINUTES, gen_siddhi_AggregationTimeDuration_HOURS, gen_siddhi_AggregationTimeDuration_DAYS, gen_siddhi_AggregationTimeDuration_WEEKS, gen_siddhi_AggregationTimeDuration_MONTHS, gen_siddhi_AggregationTimeDuration_YEARS, gen_siddhi_AggregationTimeRange_AggregationTime, gen_siddhi_DefinitionAggregation_BY, gen_siddhi_Features_FeaturesOrOutAttr, gen_siddhi_AttributeType_STRINGS, gen_siddhi_AttributeType_INTS, gen_siddhi_AttributeType_LONG, gen_siddhi_AttributeType_FLOAT, gen_siddhi_AttributeType_DOUBLE, gen_siddhi_AttributeType_BOOL, gen_siddhi_AttributeType_OBJECT, gen_siddhi_Source1_Source1OrStandardStatefulSource, gen_siddhi_ExecPartition_PARTITION, gen_siddhi_ExecPartition_WITH, gen_siddhi_ExecPartition_BEGIN, gen_siddhi_ExecPartition_END, gen_siddhi_Query_FROM, gen_siddhi_QueryOutput_INSERT, gen_siddhi_QueryOutput_INTO, gen_siddhi_QueryOutput_DELETE, gen_siddhi_QueryOutput_FOR, gen_siddhi_QueryOutput_UPDATE, gen_siddhi_QueryOutput_RETURN, gen_siddhi_ConditionRanges_PartitionWithStream, gen_siddhi_SetClause_SET, gen_siddhi_OutputEventType_ALL, gen_siddhi_OutputEventType_EVENTS, gen_siddhi_OutputEventType_RAW, gen_siddhi_OutputEventType_EXPIRED, gen_siddhi_OutputEventType_CURRENT, gen_siddhi_OutputRate_OUTPUT, gen_siddhi_OutputRate_EVENTS, gen_siddhi_OutputRate_SNAPSHOT, gen_siddhi_OutputRateType_ALL, gen_siddhi_OutputRateType_LAST, gen_siddhi_OutputRateType_FIRST, gen_siddhi_GroupByQuerySelection_SELECT, gen_siddhi_OutAttr_FeaturesOrOutAttr, gen_siddhi_GroupBy_GROUP, gen_siddhi_GroupBy_BY, gen_siddhi_HavingExpr_HAVING, gen_siddhi_AnonymousStream_RETURN, gen_siddhi_EveryPatternSourceChain_PatternStream, gen_siddhi_SequenceSource_SequenceSourceChain, gen_siddhi_SequenceCollectionStatefulSource_SequenceSource, gen_siddhi_AnonymousStream_FROM, gen_siddhi_LogicalStatefulSource_SequenceSource, gen_siddhi_LogicalAbsentStatefulSource_SequenceSource, gen_siddhi_AbsentPatternSourceChain_PatternStream, gen_siddhi_LeftAbsentPatternSource_AbsentPatternSourceChain, gen_siddhi_RightAbsentPatternSource_AbsentPatternSourceChain, gen_siddhi_EveryAbsentPatternSource_AbsentPatternSourceChain, gen_siddhi_ForTime_FOR, gen_siddhi_WithinTimeRange_WITHIN, gen_siddhi_Per1_PER, gen_siddhi_StreamAlias_Source1OrStandardStatefulSource, gen_siddhi_WithinTime_WITHIN, gen_siddhi_joins_LEFT, gen_siddhi_joins_OUTER, gen_siddhi_joins_JOIN, gen_siddhi_joins_RIGHT, gen_siddhi_joins_FULL, gen_siddhi_joins_INNER, gen_siddhi_StandardStream_JoinStream, gen_siddhi_MainSource_JoinSource, gen_siddhi_MainSource_StandardStream, gen_siddhi_BasicSourceStreamHandlers1_WINDOW, gen_siddhi_Win_WINDOW, gen_siddhi_MathOperation_Expression, gen_siddhi_MathAddsubOperation_MathOperation, gen_siddhi_NullCheck_MathOtherOperations, gen_siddhi_NullCheck_IS, gen_siddhi_NullCheck_NULL, gen_siddhi_AttributeReference_SetAssignment, gen_siddhi_MathDivmulOperation_MathAddsubOperation, gen_siddhi_MathOtherOperations_MathDivmulOperation, gen_siddhi_StandardStatefulSource_SequenceCollectionStatefulSource, gen_siddhi_StandardStatefulSource_PatternCollectionStatefulSource, gen_siddhi_StandardStatefulSource_Source1OrStandardStatefulSource, gen_siddhi_AttributeIndex_LAST, gen_siddhi_StandardStatefulSource_SequenceSource, gen_siddhi_BoolValue_TRUE, gen_siddhi_BoolValue_FALSE, gen_siddhi_HourValue_HOURS, gen_siddhi_MinuteValue_MINUTES, gen_siddhi_SecondValue_SECONDS, gen_siddhi_MillisecondValue_MILLISECONDS, gen_siddhi_DOUBLE_LITERAL_SignedDoubleValue, gen_siddhi_FLOAT_LITERAL_SignedFloatValue, gen_siddhi_LONG_LITERAL_SignedLongValue, gen_siddhi_Keyword_Name, gen_siddhi_Keyword_STREAM, gen_siddhi_Keyword_DEFINE, gen_siddhi_Keyword_FROM, gen_siddhi_Keyword_SELECT, gen_siddhi_Keyword_INSERT, gen_siddhi_Keyword_INTO, gen_siddhi_Keyword_ALL, gen_siddhi_Keyword_EVENTS, gen_siddhi_Keyword_TABLE, gen_siddhi_Keyword_WINDOW, gen_siddhi_Keyword_OUTPUT, gen_siddhi_Keyword_RAW, gen_siddhi_Keyword_EXPIRED, gen_siddhi_Keyword_CURRENT, gen_siddhi_Keyword_RETURN, gen_siddhi_Keyword_PARTITION, gen_siddhi_Keyword_WITHIN, gen_siddhi_Keyword_LEFT, gen_siddhi_YearValue_YEARS, gen_siddhi_MonthValue_MONTHS, gen_siddhi_WeekValue_WEEKS, gen_siddhi_DayValue_DAYS, gen_siddhi_Keyword_HOURS, gen_siddhi_Keyword_MINUTES, gen_siddhi_Keyword_SECONDS, gen_siddhi_Keyword_MILLISECONDS, gen_siddhi_Keyword_STRINGS, gen_siddhi_Keyword_INTS, gen_siddhi_Keyword_LONG, gen_siddhi_Keyword_FLOAT, gen_siddhi_Keyword_DOUBLE, gen_siddhi_Keyword_BOOL, gen_siddhi_Keyword_OBJECT, gen_siddhi_Keyword_IS, gen_siddhi_Keyword_NULL, gen_siddhi_Keyword_SNAPSHOT, gen_siddhi_Keyword_LAST, gen_siddhi_Keyword_FIRST, gen_siddhi_Keyword_GROUP, gen_siddhi_Keyword_BY, gen_siddhi_Keyword_RIGHT, gen_siddhi_Keyword_FULL, gen_siddhi_Keyword_JOIN, gen_siddhi_Keyword_OUTER, gen_siddhi_Keyword_INNER, gen_siddhi_Keyword_YEARS, gen_siddhi_Keyword_MONTHS, gen_siddhi_Keyword_WEEKS, gen_siddhi_Keyword_DAYS, gen_siddhi_Keyword_TRUE, gen_siddhi_Keyword_FALSE, gen_siddhi_Keyword_UPDATE, gen_siddhi_Keyword_HAVING, gen_siddhi_Keyword_WITH, gen_siddhi_Keyword_BEGIN, gen_siddhi_Keyword_END, gen_siddhi_Keyword_DELETE, gen_siddhi_Keyword_FOR, gen_siddhi_NOT_LogicalAbsentStatefulSource, gen_siddhi_EVERY_EveryAbsentSequenceSourceChain, gen_siddhi_EVERY_AbsentPatternSourceChain, gen_siddhi_EVERY_EveryAbsentPatternSource, gen_siddhi_EVERY_LeftAbsentPatternSource, gen_siddhi_EVERY_RightAbsentPatternSource, gen_siddhi_APP_AppAnnotation, gen_siddhi_NOT_BasicAbsentPatternSource, gen_siddhi_EVERY_EverySequenceSourceChain, gen_siddhi_LeftAbsentSequenceSource1_LeftAbsentSequenceSource, gen_siddhi_RightAbsentSequenceSource1_RightAbsentSequenceSource, gen_siddhi_LeftAbsentPatternSource1_LeftAbsentPatternSource, gen_siddhi_RightAbsentPatternSource1_RightAbsentPatternSource, gen_siddhi_MathLogicalOperation_MathOperation, gen_siddhi_MathEqualOperation_MathOperation, gen_siddhi_NotOperation_MathOtherOperations, gen_siddhi_MathInOperation_MathOperation, gen_siddhi_MathGtLtOperation_MathOperation},
    metadata=None
)
