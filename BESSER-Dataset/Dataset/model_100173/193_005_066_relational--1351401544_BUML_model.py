...
relational_Database = Class(name="relational_Database")
ModelElement = Class(name="ModelElement")
relational_ModelElement = Class(name="relational_ModelElement", is_abstract=True)
...
relational_Database.attributes={relational_Database_name, relational_Database_url}
...
relational_Column.attributes={relational_Column_isUnique, relational_Column_type, relational_Column_name, relational_Column_isPrimaryKey}
...
domain_model = DomainModel(
    name="relational",
    types={relational_Schema, relational_Table, relational_Database, ModelElement, relational_ModelElement, relational_Column, relational_ForeignKey, Type},
    ...
    generalizations={gen_relational_Schema_ModelElement, gen_relational_Database_ModelElement, gen_relational_Table_ModelElement, gen_relational_ForeignKey_ModelElement, gen_relational_Column_ModelElement},
    metadata=None
)
