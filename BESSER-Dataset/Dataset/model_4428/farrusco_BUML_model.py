...
farrusco_BumperDireito = Class(name="farrusco_BumperDireito")
farrusco_BumperEsquerdo = Class(name="farrusco_BumperEsquerdo")
...
farrusco_AlterarEstado.attributes={farrusco_AlterarEstado_fail_policy, farrusco_AlterarEstado_runn_policy, farrusco_AlterarEstado_succ_policy}
...
farrusco_Servo.attributes={farrusco_Servo_max, farrusco_Servo_inc, farrusco_Servo_min}
...
domain_model = DomainModel(
    name="farrusco",
    types={farrusco_Node, farrusco_Filho, farrusco_Irmao, farrusco_Robot, Node, farrusco_Behavior, farrusco_AlterarEstado, farrusco_Prioridade, Behavior, farrusco_Paralelo, farrusco_BumperDireito, farrusco_BumperEsquerdo, farrusco_Espera, farrusco_Actuate, farrusco_Motor, Actuate, farrusco_Action, farrusco_Condition, Action, farrusco_Distancia, Condition, farrusco_LED, farrusco_Servo},
    associations={nodes0, child1, next3, source10, target13, source5, target7},
    generalizations={gen_farrusco_Behavior_Node, gen_farrusco_Paralelo_Behavior, gen_farrusco_AlterarEstado_Behavior, gen_farrusco_Prioridade_Behavior, gen_farrusco_BumperDireito_Condition, gen_farrusco_BumperEsquerdo_Condition, gen_farrusco_Espera_Condition, gen_farrusco_Actuate_Action, gen_farrusco_Motor_Actuate, gen_farrusco_Action_Node, gen_farrusco_Condition_Action, gen_farrusco_Distancia_Condition, gen_farrusco_LED_Actuate, gen_farrusco_Servo_Actuate},
    metadata=None
)
