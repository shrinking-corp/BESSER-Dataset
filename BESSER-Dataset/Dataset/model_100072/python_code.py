...
class Ant_Delete(FileTask):
    ...
    def __init__(self, failonerror: str, includeEmptyDirs: str, includes: str, includesfile: str, excludes: str, excludesfile: str, defaultexcludes: str, file: str, dir: str, verbose: str, quiet: str):
...
class Ant_Javadoc(DocumentationTask):
    ...
    def __init__(self, defaultexcludes: str, author: str, version: str, use: str, windowtitle: str, sourcepath: str, destdir: str, packagenames: str):
        self.defaultexcludes = defaultexcludes
        self.author = author
...
class Ant_Project:
    ...
    def __init__(self, name: str, basedir: str, description: str, Ant_Project6: set["TaskDef"] = None, Ant_Project8: set["Target"] = None, Ant_Project: "Target" = None, Ant_Project2: "Path" = None, Ant_Project4: set["Property"] = None):
        self.name = name
        self.basedir = basedir
        self.description = description
