...
# Classes
pcg_Graph = Class(name="pcg_Graph")
pcg_Vertex = Class(name="pcg_Vertex")
pcg_Edge = Class(name="pcg_Edge")
pcg_Resource = Class(name="pcg_Resource")
...
pcg_Resource.attributes={pcg_Resource_id, pcg_Resource_title}
