...
class dgf_DReference(DVertex):
    ...
    def __init__(self, _property: bool):
...
class DTypedElement:
    ...
    pass
class dgf_DLink(DTypedElement, DContainedVertex):
...
class DGraphElement:
    ...
    pass
class dgf_DNode(DTypedElement, DGraphElement, DContainedElement):

    def __init__(self, pointOfView: str, dgf_DNode9: "dgf_DContainedElement" = None, dgf_DNode: "dgf_DVertex" = None, dgf_DNode3: "dgf_DVertex" = None, dgf_DNode5: set["dgf_DVertex"] = None):
