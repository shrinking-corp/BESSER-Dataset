...
domain_model = DomainModel(
    ...
    associations={schools19, families0, cities1, companies3, fathers5, mothers7, daughters10, sons12, registeredIn15, worksIn16, goesTo17, contains18, companies20, neighborhoods22, ordinary25, special27, students30, employees31, isIn32, family33, livesIn35},
    generalizations={gen_families_City_NamedElement, gen_families_Country_NamedElement, gen_families_Parent_Member, gen_families_Child_Member, gen_families_Neighborhood_NamedElement, gen_families_School_NamedElement, gen_families_Company_NamedElement},
    metadata=None
)
