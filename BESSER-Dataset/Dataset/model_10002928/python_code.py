...
class ATM:
    ...
    def __init__(self, location: str, ManagedBy: str, bANK1: "ADMIN" = None):
...
class Account:
    ...
    def __init__(self, AccountNumber: str, Balance: str, bANK3: "ADMIN" = None, customer5: "Customer" = None, aTM__Transactions6: "ATM__Transactions" = None):
        self.AccountNumber = AccountNumber
        self.Balance = Balance
        self.bANK3 = bANK3
...
class ADMIN:
    ...
    def __init__(self, Code: str, Address: str, account2: "Account" = None, aTM0: "ATM" = None):
        self.Code = Code
    ...
    def aTM0(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_ADMIN__aTM0", None)
        self.__aTM0 = value
    ...
    def account2(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_ADMIN__account2", None)
