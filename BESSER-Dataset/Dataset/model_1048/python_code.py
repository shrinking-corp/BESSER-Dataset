...
class minifsm_Transition:
    ...
    def __init__(self, event: str, Transition: "minifsm_FSM" = None, transitions: "minifsm_FSM" = None, minifsm_Transition: "minifsm_State" = None, minifsm_Transition8: "minifsm_State" = None):
        self.event = event
