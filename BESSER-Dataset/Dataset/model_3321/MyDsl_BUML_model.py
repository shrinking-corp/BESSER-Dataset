...
myDsl_Compilation_unit = Class(name="myDsl_Compilation_unit")
myDsl_Import_statement = Class(name="myDsl_Import_statement")
myDsl_Type_declaration = Class(name="myDsl_Type_declaration")
myDsl_Class_declaration = Class(name="myDsl_Class_declaration")
myDsl_Interface_declaration = Class(name="myDsl_Interface_declaration")
myDsl_Field_declaration = Class(name="myDsl_Field_declaration")
myDsl_Variable_declaration = Class(name="myDsl_Variable_declaration")
myDsl_Constructor_declaration = Class(name="myDsl_Constructor_declaration")
myDsl_Method_declaration = Class(name="myDsl_Method_declaration")
myDsl_Static_initializer = Class(name="myDsl_Static_initializer")
myDsl_Type = Class(name="myDsl_Type")
myDsl_Parameter_list = Class(name="myDsl_Parameter_list")
myDsl_Statement_block = Class(name="myDsl_Statement_block")
myDsl_Package_statement = Class(name="myDsl_Package_statement")
myDsl_Parameter = Class(name="myDsl_Parameter")
myDsl_Variable_declarator = Class(name="myDsl_Variable_declarator")
myDsl_Variable_initializer = Class(name="myDsl_Variable_initializer")
myDsl_Array_initializer = Class(name="myDsl_Array_initializer")
...
myDsl_If_statement = Class(name="myDsl_If_statement")
myDsl_Do_Statement = Class(name="myDsl_Do_Statement")
myDsl_While_Statement = Class(name="myDsl_While_Statement")
myDsl_For_Statement = Class(name="myDsl_For_Statement")
myDsl_Switch_statement = Class(name="myDsl_Switch_statement")
myDsl_Try_statement = Class(name="myDsl_Try_statement")
myDsl_Numeric_Expression_NR = Class(name="myDsl_Numeric_Expression_NR")
myDsl_Expression_aux = Class(name="myDsl_Expression_aux")
myDsl_Logical_Expression_NR = Class(name="myDsl_Logical_Expression_NR")
myDsl_Bit_Expression_NR = Class(name="myDsl_Bit_Expression_NR")
myDsl_Cast_Expression = Class(name="myDsl_Cast_Expression")
myDsl_Literal_Expression = Class(name="myDsl_Literal_Expression")
myDsl_Arg_List = Class(name="myDsl_Arg_List")
myDsl_Ampersand_Rule = Class(name="myDsl_Ampersand_Rule")
myDsl_Float_Literal = Class(name="myDsl_Float_Literal")
myDsl_Creating_Expression = Class(name="myDsl_Creating_Expression")
...
myDsl_Import_statement.attributes={myDsl_Import_statement_pacName, myDsl_Import_statement_className}
...
myDsl_Class_declaration.attributes={myDsl_Class_declaration_classHerdada, myDsl_Class_declaration_className, myDsl_Class_declaration_interfaceImplementada, myDsl_Class_declaration_interfacesImplementadas, myDsl_Class_declaration_modifiers}
...
myDsl_Interface_declaration.attributes={myDsl_Interface_declaration_interfaceName, myDsl_Interface_declaration_interfacesHerdadas, myDsl_Interface_declaration_interfaceHerdada, myDsl_Interface_declaration_modifiers}
...
myDsl_Constructor_declaration.attributes={myDsl_Constructor_declaration_lParen, myDsl_Constructor_declaration_modifiersConstructor, myDsl_Constructor_declaration_nameConstructor, myDsl_Constructor_declaration_rparent}
...
myDsl_Method_declaration.attributes={myDsl_Method_declaration_rparent, myDsl_Method_declaration_nameMethod, myDsl_Method_declaration_modifiersMethod, myDsl_Method_declaration_lParen, myDsl_Method_declaration_debug}
...
myDsl_Expression.attributes={myDsl_Expression_super, myDsl_Expression_null, myDsl_Expression_this, myDsl_Expression_name}
...
myDsl_Type_specifier.attributes={myDsl_Type_specifier_primitiveType, myDsl_Type_specifier_className}
...
myDsl_Statement.attributes={myDsl_Statement_nameStatement, myDsl_Statement_rparent, myDsl_Statement_name, myDsl_Statement_g, myDsl_Statement_ret}
...
myDsl_Do_Statement.attributes={myDsl_Do_Statement_rparent, myDsl_Do_Statement_lparent}
...
myDsl_Try_statement.attributes={myDsl_Try_statement_rparent, myDsl_Try_statement_lParen}
...
myDsl_Expression_aux.attributes={myDsl_Expression_aux_logicalSign, myDsl_Expression_aux_stringSign, myDsl_Expression_aux_numericSign, myDsl_Expression_aux_testingSign, myDsl_Expression_aux_bitSign, myDsl_Expression_aux_name, myDsl_Expression_aux_sgin, myDsl_Expression_aux_logicOp}
...
myDsl_Logical_Expression_NR.attributes={myDsl_Logical_Expression_NR_false, myDsl_Logical_Expression_NR_true, myDsl_Logical_Expression_NR_exclamation}
...
myDsl_Literal_Expression.attributes={myDsl_Literal_Expression_exp1, myDsl_Literal_Expression_exp, myDsl_Literal_Expression_string, myDsl_Literal_Expression_charLit}
...
myDsl_Ampersand_Rule.attributes={myDsl_Ampersand_Rule_a2, myDsl_Ampersand_Rule_a1}
...
myDsl_Float_Literal.attributes={myDsl_Float_Literal_decimalDigits2, myDsl_Float_Literal_decimalDigits1, myDsl_Float_Literal_exp, myDsl_Float_Literal_floatTypeSufix}
...
domain_model = DomainModel(
    name="myDsl",
    types={myDsl_Model, myDsl_Compilation_unit, myDsl_Import_statement, myDsl_Type_declaration, myDsl_Class_declaration, myDsl_Interface_declaration, myDsl_Field_declaration, myDsl_Variable_declaration, myDsl_Constructor_declaration, myDsl_Method_declaration, myDsl_Static_initializer, myDsl_Type, myDsl_Parameter_list, myDsl_Statement_block, myDsl_Package_statement, myDsl_Parameter, myDsl_Variable_declarator, myDsl_Variable_initializer, myDsl_Array_initializer, myDsl_Expression, myDsl_Type_specifier, myDsl_Statement, myDsl_If_statement, myDsl_Do_Statement, myDsl_While_Statement, myDsl_For_Statement, myDsl_Switch_statement, myDsl_Try_statement, myDsl_Numeric_Expression_NR, myDsl_Expression_aux, myDsl_Logical_Expression_NR, myDsl_Bit_Expression_NR, myDsl_Cast_Expression, myDsl_Literal_Expression, myDsl_Arg_List, myDsl_Ampersand_Rule, myDsl_Float_Literal, myDsl_Creating_Expression},
    associations={greetings0, name1, imports3, typeDeclarations5, classDec7, interfaceDec9, fieldsDeclaration11, fieldsDeclaration13, variableDeclaration16, contructorName18, methodName20, staticinitializer22, typeMethod24, parameterListMethod26, statementMethod28, parameterListConstructor30, statementConstructor33, parameter36, parameters38, type41, type44, nameVariable47, names49, vari52, array_init54, expression56, variableinitializer58, typeSpecifier61, name63, statments66, expressionStatement71, ifStatement74, doStatement76, whileStatement78, forStatement80, switchStatement82, expression84, syncStatement88, statementBlock90, tryStatement93, statement96, variable98, expression101, expression2104, expression3107, statement110, numericExpression3113, aux115, logicalExpression117, bitExpression119, variableDeclaration68, literalExpression125, argList127, aux130, expression2132, expressionComma135, exp2138, exp1141, ampersand144, expressionBit146, logicExp149, exp2152, castExpression121, creatingExpression123, typeSpecifier157, expression160, type163, expression166, expression169, expression172, expression175, expressions178, expression181, expression184, expression2187, switchStatements190, expression193, whileStatement196, doStatement199, argList154, idStatement205, elseStatement208, tryStatement211, parameters214, catchStatement217, finallyStatement220, expression202},
    generalizations={},
    metadata=None
)
