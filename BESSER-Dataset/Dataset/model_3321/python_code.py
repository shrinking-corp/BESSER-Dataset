...
class myDsl_Creating_Expression:
    ...
    def __init__(self, className: str, myDsl_Creating_Expression: "myDsl_Expression" = None, myDsl_Creating_Expression158: "myDsl_Type_specifier" = None, myDsl_Creating_Expression161: "myDsl_Expression" = None, myDsl_Creating_Expression155: "myDsl_Arg_List" = None):
...
class myDsl_Float_Literal:
    ...
    def __init__(self, decimalDigits2: int, exp: str, floatTypeSufix: str, decimalDigits1: int, myDsl_Float_Literal: "myDsl_Literal_Expression" = None):
...
class myDsl_Expression_aux:
    ...
    def __init__(self, name: str, sgin: str, numericSign: str, testingSign: str, logicalSign: str, stringSign: str, bitSign: str, logicOp: str, myDsl_Expression_aux: "myDsl_Expression" = None, myDsl_Expression_aux128: "myDsl_Arg_List" = None, myDsl_Expression_aux131: "myDsl_Expression_aux" = None, myDsl_Expression_aux129: "myDsl_Expression_aux" = None, myDsl_Expression_aux133: "myDsl_Expression" = None, myDsl_Expression_aux136: "myDsl_Expression" = None, myDsl_Expression_aux139: "myDsl_Expression" = None, myDsl_Expression_aux142: "myDsl_Expression" = None, myDsl_Expression_aux145: "myDsl_Ampersand_Rule" = None, myDsl_Expression_aux147: "myDsl_Expression" = None, myDsl_Expression_aux150: "myDsl_Expression" = None):
        self.name = name
        self.sgin = sgin
...
class myDsl_Statement:
    ...
    def __init__(self, g: str, rparent: str, ret: str, nameStatement: str, name: str, myDsl_Statement: "myDsl_Statement_block" = None, myDsl_Statement72: set["myDsl_Expression"] = None, myDsl_Statement75: "myDsl_If_statement" = None, myDsl_Statement77: "myDsl_Do_Statement" = None, myDsl_Statement79: "myDsl_While_Statement" = None, myDsl_Statement81: "myDsl_For_Statement" = None, myDsl_Statement83: "myDsl_Switch_statement" = None, myDsl_Statement85: "myDsl_Expression" = None, myDsl_Statement89: "myDsl_Statement" = None, myDsl_Statement87: "myDsl_Statement" = None, myDsl_Statement91: "myDsl_Statement_block" = None, myDsl_Statement94: "myDsl_Try_statement" = None, myDsl_Statement97: "myDsl_Statement" = None, myDsl_Statement95: "myDsl_Statement" = None, myDsl_Statement112: "myDsl_For_Statement" = None, myDsl_Statement69: "myDsl_Variable_declaration" = None, myDsl_Statement192: "myDsl_Switch_statement" = None, myDsl_Statement198: "myDsl_While_Statement" = None, myDsl_Statement201: "myDsl_Do_Statement" = None, myDsl_Statement207: "myDsl_If_statement" = None, myDsl_Statement210: "myDsl_If_statement" = None, myDsl_Statement213: "myDsl_Try_statement" = None, myDsl_Statement219: "myDsl_Try_statement" = None, myDsl_Statement222: "myDsl_Try_statement" = None):
        self.g = g
        self.rparent = rparent
        self.ret = ret
...
class myDsl_Expression:
    ...
    def __init__(self, null: str, super: str, this: str, name: str, myDsl_Expression: "myDsl_Variable_initializer" = None, myDsl_Expression73: "myDsl_Statement" = None, myDsl_Expression86: "myDsl_Statement" = None, myDsl_Expression103: "myDsl_For_Statement" = None, myDsl_Expression106: "myDsl_For_Statement" = None, myDsl_Expression109: "myDsl_For_Statement" = None, myDsl_Expression114: "myDsl_Numeric_Expression_NR" = None, myDsl_Expression116: "myDsl_Expression_aux" = None, myDsl_Expression118: "myDsl_Logical_Expression_NR" = None, myDsl_Expression120: "myDsl_Bit_Expression_NR" = None, myDsl_Expression126: "myDsl_Literal_Expression" = None, myDsl_Expression134: "myDsl_Expression_aux" = None, myDsl_Expression137: "myDsl_Expression_aux" = None, myDsl_Expression140: "myDsl_Expression_aux" = None, myDsl_Expression143: "myDsl_Expression_aux" = None, myDsl_Expression148: "myDsl_Expression_aux" = None, myDsl_Expression151: "myDsl_Expression_aux" = None, myDsl_Expression122: "myDsl_Cast_Expression" = None, myDsl_Expression124: "myDsl_Creating_Expression" = None, myDsl_Expression162: "myDsl_Creating_Expression" = None, myDsl_Expression168: "myDsl_Cast_Expression" = None, myDsl_Expression171: "myDsl_Bit_Expression_NR" = None, myDsl_Expression174: "myDsl_Logical_Expression_NR" = None, myDsl_Expression177: "myDsl_Arg_List" = None, myDsl_Expression180: "myDsl_Arg_List" = None, myDsl_Expression183: "myDsl_Numeric_Expression_NR" = None, myDsl_Expression186: "myDsl_Switch_statement" = None, myDsl_Expression189: "myDsl_Switch_statement" = None, myDsl_Expression195: "myDsl_While_Statement" = None, myDsl_Expression204: "myDsl_If_statement" = None):
        self.null = null
        self.super = super
        self.this = this
        self.name = name
...
class myDsl_Statement_block:
    ...
    def __init__(self, rCurly: str, lCurly: str, myDsl_Statement_block: "myDsl_Method_declaration" = None, myDsl_Statement_block35: "myDsl_Constructor_declaration" = None, myDsl_Statement_block65: "myDsl_Static_initializer" = None, myDsl_Statement_block67: set["myDsl_Statement"] = None, myDsl_Statement_block92: "myDsl_Statement" = None):
        self.rCurly = rCurly
        self.lCurly = lCurly
...
class myDsl_Type:
    ...
    def __init__(self, typeVector: str, myDsl_Type: "myDsl_Method_declaration" = None, myDsl_Type43: "myDsl_Parameter" = None, myDsl_Type46: "myDsl_Variable_declaration" = None, myDsl_Type62: "myDsl_Type_specifier" = None, myDsl_Type165: "myDsl_Cast_Expression" = None):
...
class myDsl_Method_declaration:
    ...
    def __init__(self, modifiersMethod: str, nameMethod: str, lParen: str, rparent: str, debug: str, myDsl_Method_declaration: "myDsl_Field_declaration" = None, myDsl_Method_declaration25: "myDsl_Type" = None, myDsl_Method_declaration27: "myDsl_Parameter_list" = None, myDsl_Method_declaration29: "myDsl_Statement_block" = None):
...
class myDsl_Constructor_declaration:
    ...
    def __init__(self, nameConstructor: str, lParen: str, rparent: str, modifiersConstructor: str, myDsl_Constructor_declaration: "myDsl_Field_declaration" = None, myDsl_Constructor_declaration31: "myDsl_Parameter_list" = None, myDsl_Constructor_declaration34: "myDsl_Statement_block" = None):
...
class myDsl_Variable_declaration:
    ...
    def __init__(self, modifiersVariable: str, myDsl_Variable_declaration: "myDsl_Field_declaration" = None, myDsl_Variable_declaration45: "myDsl_Type" = None, myDsl_Variable_declaration48: "myDsl_Variable_declarator" = None, myDsl_Variable_declaration50: set["myDsl_Variable_declarator"] = None, myDsl_Variable_declaration100: "myDsl_For_Statement" = None, myDsl_Variable_declaration70: "myDsl_Statement" = None):
...
class myDsl_Field_declaration:
    ...
    def __init__(self, comment: str, myDsl_Field_declaration: "myDsl_Interface_declaration" = None, myDsl_Field_declaration15: "myDsl_Class_declaration" = None, myDsl_Field_declaration17: "myDsl_Variable_declaration" = None, myDsl_Field_declaration19: "myDsl_Constructor_declaration" = None, myDsl_Field_declaration21: "myDsl_Method_declaration" = None, myDsl_Field_declaration23: "myDsl_Static_initializer" = None):
...
class myDsl_Class_declaration:
    ...
    def __init__(self, modifiers: str, className: str, classHerdada: str, interfaceImplementada: str, interfacesImplementadas: str, myDsl_Class_declaration: "myDsl_Type_declaration" = None, myDsl_Class_declaration14: set["myDsl_Field_declaration"] = None):
        ...
        pass
    @property
    def interfaceImplementada(self):
    ...
    @property
    def interfacesImplementadas(self):
...
class myDsl_Import_statement:
    ...
    def __init__(self, className: str, pacName: str, myDsl_Import_statement: "myDsl_Compilation_unit" = None):
        self.className = className
        self.pacName = pacName
