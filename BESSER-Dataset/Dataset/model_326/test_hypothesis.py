...
def test_library_library_has_requestCount():
    assert hasattr(library_Library, "requestCount")
    descriptor = None
...
def test_library_library_has_internalRequestCount():
    assert hasattr(library_Library, "internalRequestCount")
    descriptor = None
    for klass in library_Library.__mro__:
...
def test_library_library_has_sumOfPages():
    assert hasattr(library_Library, "sumOfPages")
    descriptor = None
    for klass in library_Library.__mro__:
...
@given(instance=library_Library_strategy)
def test_library_library_requestCount_setter(instance):
...
@given(instance=library_Library_strategy)
def test_library_library_internalRequestCount_setter(instance):
...
@given(instance=library_Library_strategy)
def test_library_library_sumOfPages_setter(instance):
