...
qvtoperational_Class = Class(name="qvtoperational_Class")
qvtoperational_OCLExpression = Class(name="qvtoperational_OCLExpression")
qvtoperational_Property = Class(name="qvtoperational_Property")
qvtoperational_DummyRelation = Class(name="qvtoperational_DummyRelation")
Element = Class(name="Element")
qvtoperational_DummyRelationDomain = Class(name="qvtoperational_DummyRelationDomain")
qvtoperational_DummyRelationalTransformation = Class(name="qvtoperational_DummyRelationalTransformation")
...
qvtoperational_Package = Class(name="qvtoperational_Package")
...
qvtoperational_TemplateableElement = Class(name="qvtoperational_TemplateableElement")
qvtoperational_Variable = Class(name="qvtoperational_Variable")
...
qvtoperational_Tag = Class(name="qvtoperational_Tag")
qvtoperational_Element = Class(name="qvtoperational_Element")
...
qvtoperational_Tag.attributes={qvtoperational_Tag_value, qvtoperational_Tag_name}
...
domain_model = DomainModel(
    name="qvtoperational",
    types={qvtoperational_Constructor, ImperativeOperation, qvtoperational_ConstructorBody, OperationBody, qvtoperational_ContextualProperty, Property_, qvtoperational_Class, qvtoperational_OCLExpression, qvtoperational_Property, qvtoperational_DummyRelation, Element, qvtoperational_DummyRelationDomain, qvtoperational_DummyRelationalTransformation, qvtoperational_EntryOperation, qvtoperational_Helper, qvtoperational_ImperativeCallExp, OperationCallExp, ImperativeExpression, qvtoperational_ImperativeOperation, Operation, qvtoperational_Library, Module, qvtoperational_MappingBody, qvtoperational_MappingCallExp, ImperativeCallExp, qvtoperational_MappingOperation, MappingOperation, DummyRelation, VarParameter, qvtoperational_Package, qvtoperational_Module, EntryOperation, ModuleImport, qvtoperational_TemplateableElement, qvtoperational_Variable, ModelType, qvtoperational_ModuleImport, qvtoperational_ObjectExp, InstantiationExp, ConstructorBody, qvtoperational_MappingParameter, ModelParameter, DummyRelationDomain, qvtoperational_ModelParameter, qvtoperational_ModelType, Class_, qvtoperational_OperationalTransformation, Dummy2, qvtoperational_ResolveExp, CallExp, qvtoperational_ResolveInExp, ResolveExp, qvtoperational_VarParameter, Variable, Parameter_, qvtoperational_OperationBody, qvtoperational_Tag, qvtoperational_Element, DirectionKind, ImportKind},
    associations={context0, initExpression1, overridden3, body5, result10, endSection13, initSection15, disjunct18, inherited19, merged22, refinedRelation25, when27, where30, context6, overridden8, additionalCondition36, metamodel38, configProperty40, entry42, moduleImport44, ownedTag46, ownedVariable48, usedModelType50, binding52, importedModule54, module56, body59, referredObject60, extent33, referredDomain34, variable68, intermediateClass71, intermediateProperty73, modelParameter76, refined79, relation81, condition84, target86, inMapping89, ctxOwner91, resOwner93, content63, operation65, elements96},
    generalizations={gen_qvtoperational_Constructor_ImperativeOperation, gen_qvtoperational_ConstructorBody_OperationBody, gen_qvtoperational_ContextualProperty_Property, gen_qvtoperational_DummyRelation_Element, gen_qvtoperational_DummyRelationDomain_Element, gen_qvtoperational_DummyRelationalTransformation_Element, gen_qvtoperational_EntryOperation_ImperativeOperation, gen_qvtoperational_Helper_ImperativeOperation, gen_qvtoperational_ImperativeCallExp_OperationCallExp, gen_qvtoperational_ImperativeCallExp_ImperativeExpression, gen_qvtoperational_ImperativeOperation_Operation, gen_qvtoperational_Library_Module, gen_qvtoperational_MappingBody_OperationBody, gen_qvtoperational_MappingCallExp_ImperativeCallExp, gen_qvtoperational_MappingOperation_ImperativeOperation, gen_qvtoperational_Module_Class, gen_qvtoperational_ModuleImport_Element, gen_qvtoperational_ObjectExp_InstantiationExp, gen_qvtoperational_MappingParameter_VarParameter, gen_qvtoperational_ModelParameter_VarParameter, gen_qvtoperational_ModelType_Class, gen_qvtoperational_OperationalTransformation_Module, gen_qvtoperational_ResolveExp_CallExp, gen_qvtoperational_ResolveExp_ImperativeExpression, gen_qvtoperational_ResolveInExp_ResolveExp, gen_qvtoperational_VarParameter_Variable, gen_qvtoperational_VarParameter_Parameter, gen_qvtoperational_OperationBody_Element, gen_qvtoperational_Tag_Element},
    metadata=None
)
