...
class qvtoperational_ResolveExp(ImperativeExpression, CallExp):
    ...
    def __init__(self, isDeferred: str, isInverse: str, one: str, qvtoperational_ResolveExp: "qvtoperational_OCLExpression" = None, qvtoperational_ResolveExp87: "qvtoperational_Variable" = None):
...
class qvtoperational_Helper(ImperativeOperation):
    ...
    def __init__(self, isQuery: str, ImperativeOperation67: "qvtoperational_OperationBody" = None, ImperativeOperation95: "qvtoperational_VarParameter" = None, ImperativeOperation92: "qvtoperational_VarParameter" = None, ImperativeOperation: "qvtoperational_ImperativeOperation" = None):
