...
def test_library3_customertype_has_borrowedBookSince():
    assert hasattr(library3_CustomerType, "borrowedBookSince")
    descriptor = None
...
def test_library3_booktype_has_download():
    assert hasattr(library3_BookType, "download")
    descriptor = None
    for klass in library3_BookType.__mro__:
...
def test_library3_booktype_has_dimension():
    assert hasattr(library3_BookType, "dimension")
    descriptor = None
    for klass in library3_BookType.__mro__:
...
@given(instance=library3_CustomerType_strategy)
def test_library3_customertype_borrowedBookSince_setter(instance):
...
@given(instance=library3_BookType_strategy)
def test_library3_booktype_download_setter(instance):
...
@given(instance=library3_BookType_strategy)
def test_library3_booktype_dimension_setter(instance):
