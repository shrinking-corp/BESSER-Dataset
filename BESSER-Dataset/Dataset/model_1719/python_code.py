...
class library3_CustomerType:
    ...
    def __init__(self, borrowedBookSince: str, firstName: str, lastName: str, borrowedBookId: str, library3_CustomerType: "library3_LibraryType" = None):
...
class library3_BookType:
    ...
    def __init__(self, name: str, title: str, author: str, pages: str, dimension: str, download: str, isbn: str, library3_BookType: "library3_BookInfoType" = None, library3_BookType9: "library3_LibraryType" = None):
        self.name = name
        self.title = title
        self.author = author
        self.pages = pages
