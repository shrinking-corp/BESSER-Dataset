...
# Classes
library3_BookInfoType = Class(name="library3_BookInfoType")
library3_BookType = Class(name="library3_BookType")
library3_DocumentRoot = Class(name="library3_DocumentRoot")
library3_EStringToStringMapEntry = Class(name="library3_EStringToStringMapEntry")
library3_CustomerType = Class(name="library3_CustomerType")
library3_LibraryType = Class(name="library3_LibraryType")
...
library3_BookType.attributes={library3_BookType_download, library3_BookType_dimension, library3_BookType_title, library3_BookType_pages, library3_BookType_isbn, library3_BookType_author, library3_BookType_name}
...
library3_CustomerType.attributes={library3_CustomerType_firstName, library3_CustomerType_lastName, library3_CustomerType_borrowedBookId, library3_CustomerType_borrowedBookSince}
...
domain_model = DomainModel(
    name="library3",
    types={library3_BookInfoType, library3_BookType, library3_DocumentRoot, library3_EStringToStringMapEntry, library3_CustomerType, library3_LibraryType},
    associations={xMLNSPrefixMap1, xSISchemaLocation2, bookInfo0, library5, book7, customer10},
    generalizations={},
    metadata=None
)
