...
Appdelegate_Actor = Class(name="Appdelegate_Actor")
Class_ = Class(name="Class")
Appdelegate = Class(name="Appdelegate")
RVBAppdelegate = Class(name="RVBAppdelegate")
RVBHomeScreenViewController = Class(name="RVBHomeScreenViewController")
...
# Appdelegate_Actor class attributes and methods

# Class class attributes and methods

# Appdelegate class attributes and methods

# RVBAppdelegate class attributes and methods

# RVBHomeScreenViewController class attributes and methods
...
domain_model = DomainModel(
    name="_7f07c46e_30eb_4975_a35c_c79df6885e19",
    types={ShoppingCartExample_ShoppingCart, ShoppingCartExample_Order, ShoppingCartExample_LineItem, ShoppingCartExample_Account, ShoppingCartExample_Customer, Appdelegate_Actor, Class_, Appdelegate, RVBAppdelegate, RVBHomeScreenViewController},
