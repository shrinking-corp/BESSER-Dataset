...
def test_rvbappdelegate_is_not_abstract():
    assert not inspect.isabstract(RVBAppdelegate)


def test_rvbappdelegate_constructor_exists():
    assert callable(RVBAppdelegate.__init__)


def test_rvbappdelegate_constructor_args():
    sig = inspect.signature(RVBAppdelegate.__init__)
    params = list(sig.parameters.keys())



def test_appdelegate_is_not_abstract():
    assert not inspect.isabstract(Appdelegate)


def test_appdelegate_constructor_exists():
    assert callable(Appdelegate.__init__)


def test_appdelegate_constructor_args():
...
def test_appdelegate_actor_is_not_abstract():
    assert not inspect.isabstract(Appdelegate_Actor)


def test_appdelegate_actor_constructor_exists():
    assert callable(Appdelegate_Actor.__init__)


def test_appdelegate_actor_constructor_args():
