...
# Classes
hlcorestructure_Name = Class(name="hlcorestructure_Name")
hlcorestructure_ToolInfo = Class(name="hlcorestructure_ToolInfo")
hlcorestructure_Declaration = Class(name="hlcorestructure_Declaration")
PnObject = Class(name="PnObject")
hlcorestructure_PetriNetDoc = Class(name="hlcorestructure_PetriNetDoc")
hlcorestructure_PetriNet = Class(name="hlcorestructure_PetriNet")
hlcorestructure_Page = Class(name="hlcorestructure_Page")
Annotation = Class(name="Annotation")
hlcorestructure_PnObject = Class(name="hlcorestructure_PnObject", is_abstract=True)
hlcorestructure_NodeGraphics = Class(name="hlcorestructure_NodeGraphics")
hlcorestructure_Line = Class(name="hlcorestructure_Line")
hlcorestructure_Node = Class(name="hlcorestructure_Node", is_abstract=True)
hlcorestructure_Graphics = Class(name="hlcorestructure_Graphics", is_abstract=True)
hlcorestructure_Coordinate = Class(name="hlcorestructure_Coordinate", is_abstract=True)
Coordinate = Class(name="Coordinate")
hlcorestructure_Label = Class(name="hlcorestructure_Label", is_abstract=True)
hlcorestructure_AnyObject = Class(name="hlcorestructure_AnyObject", is_abstract=True)
Graphics = Class(name="Graphics")
hlcorestructure_Position = Class(name="hlcorestructure_Position")
hlcorestructure_Dimension = Class(name="hlcorestructure_Dimension")
hlcorestructure_Fill = Class(name="hlcorestructure_Fill")
hlcorestructure_Annotation = Class(name="hlcorestructure_Annotation", is_abstract=True)
hlcorestructure_ArcGraphics = Class(name="hlcorestructure_ArcGraphics")
hlcorestructure_Offset = Class(name="hlcorestructure_Offset")
hlcorestructure_AnnotationGraphics = Class(name="hlcorestructure_AnnotationGraphics")
hlcorestructure_Font = Class(name="hlcorestructure_Font")
hlcorestructure_Arc = Class(name="hlcorestructure_Arc")
hlcorestructure_HLAnnotation = Class(name="hlcorestructure_HLAnnotation")
hlcorestructure_PlaceNode = Class(name="hlcorestructure_PlaceNode", is_abstract=True)
Node = Class(name="Node")
hlcorestructure_RefPlace = Class(name="hlcorestructure_RefPlace")
hlcorestructure_TransitionNode = Class(name="hlcorestructure_TransitionNode", is_abstract=True)
hlcorestructure_RefTransition = Class(name="hlcorestructure_RefTransition")
hlcorestructure_Place = Class(name="hlcorestructure_Place")
PlaceNode = Class(name="PlaceNode")
hlcorestructure_Type = Class(name="hlcorestructure_Type")
hlcorestructure_HLMarking = Class(name="hlcorestructure_HLMarking")
TransitionNode = Class(name="TransitionNode")
hlcorestructure_Unparsed = Class(name="hlcorestructure_Unparsed")
hlcorestructure_AnySort = Class(name="hlcorestructure_AnySort")
hlcorestructure_ArbitrarySort = Class(name="hlcorestructure_ArbitrarySort")
hlcorestructure_HLCoreAnnotation = Class(name="hlcorestructure_HLCoreAnnotation", is_abstract=True)
HLCoreAnnotation = Class(name="HLCoreAnnotation")
hlcorestructure_Sort = Class(name="hlcorestructure_Sort")
hlcorestructure_Transition = Class(name="hlcorestructure_Transition")
hlcorestructure_Condition = Class(name="hlcorestructure_Condition")
hlcorestructure_Attribute = Class(name="hlcorestructure_Attribute", is_abstract=True)
Label = Class(name="Label")
hlcorestructure_Declarations = Class(name="hlcorestructure_Declarations")
hlcorestructure_Term = Class(name="hlcorestructure_Term")
...
hlcorestructure_ToolInfo.attributes={hlcorestructure_ToolInfo_tool, hlcorestructure_ToolInfo_version, hlcorestructure_ToolInfo_formattedXMLBuffer, hlcorestructure_ToolInfo_toolInfoGrammarURI}
...
hlcorestructure_Line.attributes={hlcorestructure_Line_color, hlcorestructure_Line_style, hlcorestructure_Line_shape, hlcorestructure_Line_width}
...
hlcorestructure_Font.attributes={hlcorestructure_Font_family, hlcorestructure_Font_decoration, hlcorestructure_Font_align, hlcorestructure_Font_weight, hlcorestructure_Font_size, hlcorestructure_Font_style, hlcorestructure_Font_rotation}
...
domain_model = DomainModel(
    ...
    types={hlcorestructure_Name, hlcorestructure_ToolInfo, hlcorestructure_Declaration, PnObject, hlcorestructure_PetriNetDoc, hlcorestructure_PetriNet, hlcorestructure_Page, Annotation, hlcorestructure_PnObject, hlcorestructure_NodeGraphics, hlcorestructure_Line, hlcorestructure_Node, hlcorestructure_Graphics, hlcorestructure_Coordinate, Coordinate, hlcorestructure_Label, hlcorestructure_AnyObject, Graphics, hlcorestructure_Position, hlcorestructure_Dimension, hlcorestructure_Fill, hlcorestructure_Annotation, hlcorestructure_ArcGraphics, hlcorestructure_Offset, hlcorestructure_AnnotationGraphics, hlcorestructure_Font, hlcorestructure_Arc, hlcorestructure_HLAnnotation, hlcorestructure_PlaceNode, Node, hlcorestructure_RefPlace, hlcorestructure_TransitionNode, hlcorestructure_RefTransition, hlcorestructure_Place, PlaceNode, hlcorestructure_Type, hlcorestructure_HLMarking, TransitionNode, hlcorestructure_Unparsed, hlcorestructure_AnySort, hlcorestructure_ArbitrarySort, hlcorestructure_HLCoreAnnotation, HLCoreAnnotation, hlcorestructure_Sort, hlcorestructure_Transition, hlcorestructure_Condition, hlcorestructure_Attribute, Label, hlcorestructure_Declarations, hlcorestructure_Term, PNType, LineShape, CSS2Color, Gradient, FontAlign, FontDecoration, CSS2FontFamily, CSS2FontSize, CSS2FontStyle, CSS2FontWeight, LineStyle},
    associations={name2, toolspecifics3, containerPetriNetDoc5, declaration6, nets0, pages1, containerNamePetriNet20, containerNamePnObject22, objects7, containerPetriNet8, nodegraphics10, declaration12, name14, toolspecifics16, containerPage18, fill37, line38, containerNode40, containerPage41, containerPetriNet25, containerPnObject27, containerLabel30, toolInfoModel32, toolspecifics33, position35, dimension36, containerAnnotation59, containerNodeGraphics60, containerAnnotationGraphics62, containerArcGraphics44, containerPNodeGraphics45, containerAnnotationGraphics47, containerDNodeGraphics48, offset50, fill51, line54, font57, containerArcGraphics67, containerAnnotationGraphics70, positions73, line75, containerArc78, containerNodeGraphics65, nodegraphics91, source79, target81, arcgraphics83, hlinscription85, InArcs87, OutArcs89, referencingPlaces95, referencingTransitions96, type98, hlinitialMarking99, containerAnnotationGraphics93, containerToolInfo106, containerUnparsed108, containerAnySort109, containerArbitrarySort110, structure111, ref101, condition102, ref103, annotationgraphics104, structure119, containerArc121, structure123, containerDeclarationPetriNet124, containerDeclarationPage126, containerPlace112, structure113, containerPlace114, structure116, containerTransition118},
    generalizations={gen_hlcorestructure_Page_PnObject, gen_hlcorestructure_Name_Annotation, gen_hlcorestructure_Position_Coordinate, gen_hlcorestructure_NodeGraphics_Graphics, gen_hlcorestructure_Offset_Coordinate, gen_hlcorestructure_Dimension_Coordinate, gen_hlcorestructure_AnnotationGraphics_Graphics, gen_hlcorestructure_ArcGraphics_Graphics, gen_hlcorestructure_Arc_PnObject, gen_hlcorestructure_Node_PnObject, gen_hlcorestructure_PlaceNode_Node, gen_hlcorestructure_TransitionNode_Node, gen_hlcorestructure_Place_PlaceNode, gen_hlcorestructure_RefTransition_TransitionNode, gen_hlcorestructure_HLCoreAnnotation_Annotation, gen_hlcorestructure_Type_HLCoreAnnotation, gen_hlcorestructure_Transition_TransitionNode, gen_hlcorestructure_RefPlace_PlaceNode, gen_hlcorestructure_Attribute_Label, gen_hlcorestructure_Annotation_Label, gen_hlcorestructure_HLAnnotation_HLCoreAnnotation, gen_hlcorestructure_Declaration_HLCoreAnnotation, gen_hlcorestructure_HLMarking_HLCoreAnnotation, gen_hlcorestructure_Condition_HLCoreAnnotation},
    metadata=None
)
