...
class hlcorestructure_Fill:
    ...
    def __init__(self, color: str, gradientcolor: str, gradientrotation: str, image: str, fill: "hlcorestructure_NodeGraphics" = None, fill63: "hlcorestructure_AnnotationGraphics" = None, Fill53: "hlcorestructure_AnnotationGraphics" = None, Fill: "hlcorestructure_NodeGraphics" = None):
        self.color = color
...
class hlcorestructure_Line:
    ...
    def __init__(self, style: str, color: str, shape: str, width: str, Line56: "hlcorestructure_AnnotationGraphics" = None, line68: "hlcorestructure_ArcGraphics" = None, line71: "hlcorestructure_AnnotationGraphics" = None, Line77: "hlcorestructure_ArcGraphics" = None, line: "hlcorestructure_NodeGraphics" = None, Line: "hlcorestructure_NodeGraphics" = None):
        self.style = style
        self.color = color
        self.shape = shape
        self.width = width
...
class hlcorestructure_PnObject(ABC):
    ...
    def __init__(self, id: str, PnObject29: "hlcorestructure_ToolInfo" = None, PnObject24: "hlcorestructure_Name" = None, PnObject: "hlcorestructure_Page" = None, containerNamePnObject: "hlcorestructure_Name" = None, containerPnObject: set["hlcorestructure_ToolInfo"] = None, objects: "hlcorestructure_Page" = None):
        self.id = id
...
class hlcorestructure_PetriNet:
    ...
    def __init__(self, id: str, type: str, containerNamePetriNet: "hlcorestructure_Name" = None, containerPetriNet4: set["hlcorestructure_ToolInfo"] = None, nets: "hlcorestructure_PetriNetDoc" = None, containerDeclarationPetriNet: set["hlcorestructure_Declaration"] = None, PetriNet: "hlcorestructure_PetriNetDoc" = None, PetriNet26: "hlcorestructure_ToolInfo" = None, containerPetriNet: set["hlcorestructure_Page"] = None, PetriNet21: "hlcorestructure_Name" = None, PetriNet9: "hlcorestructure_Page" = None, PetriNet125: "hlcorestructure_Declaration" = None):
        self.id = id
        self.type = type
...
class hlcorestructure_PetriNetDoc:
    ...
    def __init__(self, xmlns: str, PetriNetDoc: "hlcorestructure_PetriNet" = None, containerPetriNetDoc: set["hlcorestructure_PetriNet"] = None):
        self.xmlns = xmlns
...
class hlcorestructure_ToolInfo:
    ...
    def __init__(self, tool: str, version: str, formattedXMLBuffer: str, toolInfoGrammarURI: str, ToolInfo: "hlcorestructure_PetriNet" = None, toolspecifics: "hlcorestructure_PetriNet" = None, toolspecifics28: "hlcorestructure_PnObject" = None, toolspecifics31: "hlcorestructure_Label" = None, containerToolInfo: "hlcorestructure_AnyObject" = None, ToolInfo34: "hlcorestructure_Label" = None, ToolInfo17: "hlcorestructure_PnObject" = None, ToolInfo107: "hlcorestructure_AnyObject" = None):
        self.tool = tool
...
class hlcorestructure_Name(Annotation):
    ...
    def __init__(self, text: str, Name: "hlcorestructure_PetriNet" = None, name: "hlcorestructure_PetriNet" = None, name23: "hlcorestructure_PnObject" = None, Name15: "hlcorestructure_PnObject" = None):
        self.text = text
        self.Name = Name
        self.name = name
        self.name23 = name23
