...
class simpleStateMachineMetaModel_State:
    ...
    def __init__(self, Name: str, State: "simpleStateMachineMetaModel_SimpleStateMachine" = None, simpleStateMachineMetaModel_State: "simpleStateMachineMetaModel_SimpleStateMachine" = None, State7: "simpleStateMachineMetaModel_Transition" = None, State9: "simpleStateMachineMetaModel_Transition" = None, States: "simpleStateMachineMetaModel_SimpleStateMachine" = None, Source: set["simpleStateMachineMetaModel_Transition"] = None, Target: set["simpleStateMachineMetaModel_Transition"] = None):
        self.Name = Name
        self.State = State
...
class simpleStateMachineMetaModel_SimpleStateMachine:
    ...
    def __init__(self, Name: str, SimpleStateMachine: set["simpleStateMachineMetaModel_State"] = None, SimpleStateMachine2: set["simpleStateMachineMetaModel_Transition"] = None, simpleStateMachineMetaModel_SimpleStateMachine: "simpleStateMachineMetaModel_State" = None, SimpleStateMachine5: "simpleStateMachineMetaModel_Transition" = None, SimpleStateMachine11: "simpleStateMachineMetaModel_State" = None):
        self.Name = Name
