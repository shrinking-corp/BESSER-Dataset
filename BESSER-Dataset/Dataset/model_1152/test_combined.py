...
def test_hyp_simplestatemachinemetamodel_transition_is_not_abstract():
    assert not inspect.isabstract(simpleStateMachineMetaModel_Transition)


def test_hyp_simplestatemachinemetamodel_transition_constructor_exists():
    assert callable(simpleStateMachineMetaModel_Transition.__init__)


def test_hyp_simplestatemachinemetamodel_transition_constructor_args():
...
def test_hyp_simplestatemachinemetamodel_state_is_not_abstract():
    assert not inspect.isabstract(simpleStateMachineMetaModel_State)


def test_hyp_simplestatemachinemetamodel_state_constructor_exists():
    assert callable(simpleStateMachineMetaModel_State.__init__)


def test_hyp_simplestatemachinemetamodel_state_constructor_args():
...
def test_hyp_simplestatemachinemetamodel_simplestatemachine_is_not_abstract():
    assert not inspect.isabstract(simpleStateMachineMetaModel_SimpleStateMachine)


def test_hyp_simplestatemachinemetamodel_simplestatemachine_constructor_exists():
    assert callable(simpleStateMachineMetaModel_SimpleStateMachine.__init__)


def test_hyp_simplestatemachinemetamodel_simplestatemachine_constructor_args():
...
def test_hyp_simplestatemachinemetamodel_transition_Name_setter(instance):
...
def test_hyp_simplestatemachinemetamodel_state_Name_setter(instance):
    original = instance.Name
    instance.Name = original
    assert instance.Name == original
...
def test_hyp_simplestatemachinemetamodel_simplestatemachine_Name_setter(instance):
    original = instance.Name
    instance.Name = original
    assert instance.Name == original
