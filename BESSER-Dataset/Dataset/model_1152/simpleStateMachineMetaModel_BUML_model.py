...
# Classes
simpleStateMachineMetaModel_SimpleStateMachine = Class(name="simpleStateMachineMetaModel_SimpleStateMachine")
simpleStateMachineMetaModel_State = Class(name="simpleStateMachineMetaModel_State")
simpleStateMachineMetaModel_Transition = Class(name="simpleStateMachineMetaModel_Transition")
...
domain_model = DomainModel(
    ...
    associations={States0, Transitions1, InitialState3, SimpleStateMachine4, Source6, Target8, SimpleStateMachine10, Outgoing12, Incoming14},
    generalizations={},
    metadata=None
)
