...
collection_SmartInformationObjectCollection.attributes={collection_SmartInformationObjectCollection_includeContents, collection_SmartInformationObjectCollection_includePersons, collection_SmartInformationObjectCollection_includeOrganisations, collection_SmartInformationObjectCollection_minimumAge}
...
domain_model = DomainModel(
    name="collection",
    types={collection_ItemsCollection, collection_Item, collection_DataSet, collection_SmartInformationObjectCollection, ItemsCollection, collection_MetaTag, collection_Category, collection_Person, collection_Organisation, collection_ManualCollection, collection_Tag, collection_RemoteCollection},
    associations={items0, dataSet1, negativeTags4, positiveMetaTags7, positiveCategories9, positivePersons11, negativeMetaTags13, negativeCategories16, negativePersons19, positiveOrganisations22, negativeOrganisations24, positiveTags3},
