...
Customer.attributes={Customer_login, Customer_isBan, Customer_emailAddress, Customer_lastname, Customer_id, Customer_password, Customer_firstname}
...
domain_model = DomainModel(
    name="cd67e3e3_e9d8_4ba1_b56a_ec32a9545ebc",
