...
# Classes
testSubpackages2_root_class2 = Class(name="testSubpackages2_root_class2")
testSubpackages1_subpackage3_class4 = Class(name="testSubpackages1_subpackage3_class4")
...
domain_model = DomainModel(
    ...
    types={testSubpackages2_root_class2, testSubpackages1_subpackage3_class4},
