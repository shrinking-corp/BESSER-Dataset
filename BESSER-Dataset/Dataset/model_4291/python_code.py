...
class gametournament_QualificationPhase:
    ...
    def __init__(self, gametournament_QualificationPhase: "gametournament_Tournament" = None, gametournament_QualificationPhase8: set["gametournament_Pool"] = None, gametournament_QualificationPhase14: "gametournament_FinalPhase" = None):
...
class gametournament_Gamer:
    ...
    def __init__(self, firstName: str, lastName: str, pseudo: str, victories: int, matches: int, gametournament_Gamer: "gametournament_Tournament" = None, gametournament_Gamer17: "gametournament_Pool" = None, gametournament_Gamer20: "gametournament_Pool" = None, gametournament_Gamer11: "gametournament_FinalPhase" = None):
