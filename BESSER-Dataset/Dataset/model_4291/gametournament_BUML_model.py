...
# Classes
gametournament_Tournament = Class(name="gametournament_Tournament")
gametournament_Game = Class(name="gametournament_Game")
gametournament_Gamer = Class(name="gametournament_Gamer")
gametournament_FinalPhase = Class(name="gametournament_FinalPhase")
gametournament_QualificationPhase = Class(name="gametournament_QualificationPhase")
gametournament_Pool = Class(name="gametournament_Pool")
...
gametournament_Tournament.attributes={gametournament_Tournament_startDate, gametournament_Tournament_location, gametournament_Tournament_name, gametournament_Tournament_endDate, gametournament_Tournament_prize}
...
gametournament_Game.attributes={gametournament_Game_type, gametournament_Game_name}
...
gametournament_Gamer.attributes={gametournament_Gamer_firstName, gametournament_Gamer_pseudo, gametournament_Gamer_lastName, gametournament_Gamer_victories, gametournament_Gamer_matches}
...
domain_model = DomainModel(
    name="gametournament",
    types={gametournament_Tournament, gametournament_Game, gametournament_Gamer, gametournament_FinalPhase, gametournament_QualificationPhase, gametournament_Pool, GameType},
    associations={game0, gamers1, finalPhase3, qualificationPhase5, pools7, qualificationphase12, participants15, classment18, finalists9},
    generalizations={},
    metadata=None
)
