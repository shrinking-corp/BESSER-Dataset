...
imp_Skip = Class(name="imp_Skip")
Stmt = Class(name="Stmt")
imp_Assign = Class(name="imp_Assign")
...
domain_model = DomainModel(
    name="imp",
    types={imp_Stmt, imp_Skip, Stmt, imp_Assign, imp_Expr, imp_Block, imp_Unary, imp_Binary, imp_If, imp_While, imp_IntConst, Expr, imp_Var, imp_ArrayDecl, imp_BoolConst, imp_Store, imp_StringToValueMap, imp_Value, imp_IntValue, Value, imp_BoolValue, imp_ArrayValue, UnaryOp, BinaryOp},
    associations={exp0, index1, index18, expr20, lhs22, rhs24, stmts4, cond5, lhs7, rhs10, cond13, body15, values32, values27, value28, values30},
    generalizations={gen_imp_Skip_Stmt, gen_imp_Assign_Stmt, gen_imp_Block_Stmt, gen_imp_Unary_Expr, gen_imp_Binary_Expr, gen_imp_If_Stmt, gen_imp_While_Stmt, gen_imp_IntConst_Expr, gen_imp_Var_Expr, gen_imp_ArrayDecl_Expr, gen_imp_BoolConst_Expr, gen_imp_IntValue_Value, gen_imp_BoolValue_Value, gen_imp_ArrayValue_Value},
    metadata=None
)
