...
be_jebouquine_entities_Client.attributes={be_jebouquine_entities_Client_nomClient, be_jebouquine_entities_Client_telephoneClient, be_jebouquine_entities_Client_motDePasseClient, be_jebouquine_entities_Client_idClient, be_jebouquine_entities_Client_etatLogin, be_jebouquine_entities_Client_emailClient, be_jebouquine_entities_Client_adresseClient}
...
be_jebouquine_entities_Administrateur.attributes={be_jebouquine_entities_Administrateur_motDePasseAdministrateur, be_jebouquine_entities_Administrateur_prenomAdministrateur, be_jebouquine_entities_Administrateur_idAdministrateur, be_jebouquine_entities_Administrateur_emailAdministrateur, be_jebouquine_entities_Administrateur_nomAdministrateur}
...
be_jebouquine_entities_Livre.attributes={be_jebouquine_entities_Livre_idAuteur, be_jebouquine_entities_Livre_idLangue, be_jebouquine_entities_Livre_photoLivre, be_jebouquine_entities_Livre_prix, be_jebouquine_entities_Livre_titre, be_jebouquine_entities_Livre_idEditeur, be_jebouquine_entities_Livre_idLivre, be_jebouquine_entities_Livre_dateApparition, be_jebouquine_entities_Livre_isbn, be_jebouquine_entities_Livre_idCategorie, be_jebouquine_entities_Livre_quantiteEnStock}
...
be_jebouquine_entities_Commande.attributes={be_jebouquine_entities_Commande_dateCommande, be_jebouquine_entities_Commande_idEtat, be_jebouquine_entities_Commande_idcommande, be_jebouquine_entities_Commande_idLivraisonInfo, be_jebouquine_entities_Commande_idClient}
...
be_jebouquine_entities_Commentaire.attributes={be_jebouquine_entities_Commentaire_idClient, be_jebouquine_entities_Commentaire_idCommentaire, be_jebouquine_entities_Commentaire_idLivre, be_jebouquine_entities_Commentaire_textCommentaire, be_jebouquine_entities_Commentaire_dateCommentaire}
...
be_jebouquine_bo_PanierBO.attributes={be_jebouquine_bo_PanierBO_quantity, be_jebouquine_bo_PanierBO_idPanier, be_jebouquine_bo_PanierBO_listLivres, be_jebouquine_bo_PanierBO_date}
...
domain_model = DomainModel(
    name="_76043991_de29_43cb_af8d_67b9784d157e",
    ...
    associations={Administrateur_S_authentifier, Systeme_Paiement_Payer_commande, Client_S_authentifier, Parcourir_les_livres_Visiteur, Rechercher_un_livre_Visiteur, Visiteur_Consulter_l_aide, Client_Commande, LigneCommande_Livre, Livre_Editeur, Rechercher_un_livre_Recherche_par_critere, Parcourir_les_livres_Afficher_la_liste_des_livres, Rechercher_un_livre_Afficher_la_liste_des_livres, Livre_Auteur, Livre_Categorie, Client_Commentaire, Commande_EtatCommande, Langue_Livre, Livre_Commentaire, Visiteur_Gerer_panier, Commande_LigneCommande, Commande_LivraisonInfo},
    generalizations={},
    metadata=None
)
