...
class be_jebouquine_entities_Commentaire:
    ...
    def __init__(self, idCommentaire: int, dateCommentaire: date, textCommentaire: str, idLivre: int, idClient: int, livre29: "be_jebouquine_entities_Livre" = None, client23: "be_jebouquine_entities_Client" = None):
