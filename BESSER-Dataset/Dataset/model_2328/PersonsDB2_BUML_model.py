...
# Classes
pdb2_Database = Class(name="pdb2_Database")
pdb2_Person = Class(name="pdb2_Person")
...
pdb2_Person.attributes={pdb2_Person_incrementalID, pdb2_Person_name, pdb2_Person_placeOfBirth, pdb2_Person_id, pdb2_Person_birthday}
