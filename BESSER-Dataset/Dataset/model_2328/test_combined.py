...
def test_hyp_pdb2_person_is_not_abstract():
    assert not inspect.isabstract(pdb2_Person)


def test_hyp_pdb2_person_constructor_exists():
    assert callable(pdb2_Person.__init__)


def test_hyp_pdb2_person_constructor_args():
...
def test_hyp_pdb2_database_is_not_abstract():
    assert not inspect.isabstract(pdb2_Database)


def test_hyp_pdb2_database_constructor_exists():
    assert callable(pdb2_Database.__init__)


def test_hyp_pdb2_database_constructor_args():
...
def test_hyp_pdb2_person_name_setter(instance):
...
@given(instance=pdb2_Person_strategy)
def test_hyp_pdb2_person_placeOfBirth_setter(instance):
...
@given(instance=pdb2_Person_strategy)
def test_hyp_pdb2_person_birthday_setter(instance):
...
@given(instance=pdb2_Person_strategy)
def test_hyp_pdb2_person_incrementalID_setter(instance):
...
@given(instance=pdb2_Person_strategy)
def test_hyp_pdb2_person_id_setter(instance):
...
def test_hyp_pdb2_database_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
