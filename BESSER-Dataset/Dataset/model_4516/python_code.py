...
class smarthome_Home:
    ...
    def __init__(self, fileEvents: str, smarthome_Home4: set["smarthome_Pattern"] = None, smarthome_Home6: set["smarthome_NamedEntity"] = None, smarthome_Home: set["smarthome_Room"] = None, smarthome_Home2: set["smarthome_Person"] = None):
