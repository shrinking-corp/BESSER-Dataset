...
# Classes
smarthome_Pattern = Class(name="smarthome_Pattern")
smarthome_NamedEntity = Class(name="smarthome_NamedEntity", is_abstract=True)
smarthome_Sensor = Class(name="smarthome_Sensor", is_abstract=True)
NamedEntity = Class(name="NamedEntity")
smarthome_AnalogSensor = Class(name="smarthome_AnalogSensor")
Sensor = Class(name="Sensor")
smarthome_Home = Class(name="smarthome_Home")
smarthome_Room = Class(name="smarthome_Room")
smarthome_Person = Class(name="smarthome_Person")
smarthome_SensorPredicate = Class(name="smarthome_SensorPredicate")
Predicate = Class(name="Predicate")
smarthome_PersonPredicate = Class(name="smarthome_PersonPredicate")
smarthome_DigitalSensor = Class(name="smarthome_DigitalSensor")
smarthome_CSVSensor = Class(name="smarthome_CSVSensor")
smarthome_Tag = Class(name="smarthome_Tag")
smarthome_Rule = Class(name="smarthome_Rule")
smarthome_Predicate = Class(name="smarthome_Predicate", is_abstract=True)
smarthome_Duration = Class(name="smarthome_Duration")
smarthome_Mode = Class(name="smarthome_Mode")
...
smarthome_SensorPredicate.attributes={smarthome_SensorPredicate_value, smarthome_SensorPredicate_operator}
...
smarthome_Duration.attributes={smarthome_Duration_precision, smarthome_Duration_time}
...
domain_model = DomainModel(
    name="smarthome",
    types={smarthome_Pattern, smarthome_NamedEntity, smarthome_Sensor, NamedEntity, smarthome_AnalogSensor, Sensor, smarthome_Home, smarthome_Room, smarthome_Person, smarthome_SensorPredicate, Predicate, smarthome_PersonPredicate, smarthome_DigitalSensor, smarthome_CSVSensor, smarthome_Tag, smarthome_Rule, smarthome_Predicate, smarthome_Duration, smarthome_Mode, Activity, Operator, Precision},
    associations={patterns3, monitoredEntities5, rooms0, persons1, ankleRight17, belt20, chest23, sensor26, sensors7, rules9, predicates11, duration13, ankleLeft15, person28},
    generalizations={gen_smarthome_Sensor_NamedEntity, gen_smarthome_AnalogSensor_Sensor, gen_smarthome_SensorPredicate_Predicate, gen_smarthome_DigitalSensor_Sensor, gen_smarthome_Tag_NamedEntity, gen_smarthome_Room_NamedEntity, gen_smarthome_Pattern_NamedEntity, gen_smarthome_Person_NamedEntity, gen_smarthome_PersonPredicate_Predicate},
    metadata=None
)
