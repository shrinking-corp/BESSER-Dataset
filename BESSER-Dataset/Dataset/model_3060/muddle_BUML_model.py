...
muddle_Feature.attributes={muddle_Feature_many, muddle_Feature_name, muddle_Feature_primary, muddle_Feature_runtime}
...
domain_model = DomainModel(
    name="muddle",
    types={muddle_Muddle, muddle_Type, muddle_MuddleElement, Type, muddle_LinkElementType, MuddleElementType, muddle_Slot, muddle_MuddleElementType, muddle_Feature, muddle_PrimitiveType, muddle_IntegerType, PrimitiveType, muddle_StringType, muddle_BooleanType, muddle_RealType},
    associations={types0, elements1, owningType11, slots13, instances15, features17, superTypes20, subTypes23, sourceFeature25, slots2, type3, muddle4, feature5, owningElement6, type9, targetFeature27, roleInSourceFeature30, roleInTargetFeature33},
    generalizations={gen_muddle_MuddleElementType_Type, gen_muddle_LinkElementType_MuddleElementType, gen_muddle_PrimitiveType_Type, gen_muddle_IntegerType_PrimitiveType, gen_muddle_StringType_PrimitiveType, gen_muddle_BooleanType_PrimitiveType, gen_muddle_RealType_PrimitiveType},
    metadata=None
)
