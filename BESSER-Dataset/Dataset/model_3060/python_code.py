...
class muddle_Feature:
    ...
    def __init__(self, name: str, many: bool, primary: bool, runtime: bool, features: "muddle_MuddleElementType" = None, feature: set["muddle_Slot"] = None, Feature18: "muddle_MuddleElementType" = None, muddle_Feature26: "muddle_LinkElementType" = None, Feature: "muddle_Slot" = None, muddle_Feature: "muddle_Type" = None, muddle_Feature29: "muddle_LinkElementType" = None, muddle_Feature32: "muddle_LinkElementType" = None, muddle_Feature35: "muddle_LinkElementType" = None):
        self.name = name
        self.many = many
...
class muddle_Slot:
    ...
    def __init__(self, values: str, Slot14: "muddle_Feature" = None, Slot: "muddle_MuddleElement" = None, slots: "muddle_Feature" = None, slots7: "muddle_MuddleElement" = None):
        self.values = values
        self.Slot14 = Slot14
        self.Slot = Slot
        self.slots = slots
...
class muddle_MuddleElement:
    ...
    def __init__(self, id: str, MuddleElement16: "muddle_MuddleElementType" = None, owningElement: set["muddle_Slot"] = None, instances: "muddle_MuddleElementType" = None, elements: "muddle_Muddle" = None, MuddleElement8: "muddle_Slot" = None, MuddleElement: "muddle_Muddle" = None):
        self.id = id
...
class muddle_Type(ABC):
    ...
    def __init__(self, name: str, muddle_Type10: "muddle_Feature" = None, muddle_Type: "muddle_Muddle" = None):
        self.name = name
