...
public class lit_petriNets_Place  {
    ...
    public lit_petriNets_Place(
        String name        ArrayList<lit_petriNets_PTArc> lit_petrinets_ptarcs,        ArrayList<lit_petriNets_TPArc> lit_petrinets_tparcs    ) {
        this.name = name;
