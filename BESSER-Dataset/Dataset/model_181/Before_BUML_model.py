...
domain_model = DomainModel(
    name="lit_petriNets",
    types={lit_petriNets_Arc, lit_petriNets_TPArc, lit_petriNets_PTArc, Arc, lit_petriNets_Net, lit_petriNets_Place, lit_petriNets_Transition},
    associations={transitions1, arcs3, net4, in_5, out6, net7, in_9, out12, net15, src18, places0, dst20, src22, dst25},
