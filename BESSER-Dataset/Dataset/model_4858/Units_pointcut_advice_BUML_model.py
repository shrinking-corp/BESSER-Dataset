...
# Classes
units_pc_av_UnitCarryingElement = Class(name="units_pc_av_UnitCarryingElement")
units_pc_av_Unit = Class(name="units_pc_av_Unit")
units_pc_av_BaseUnit = Class(name="units_pc_av_BaseUnit")
units_pc_av_UnitRepository = Class(name="units_pc_av_UnitRepository")
units_pc_av_UnitMultiplication = Class(name="units_pc_av_UnitMultiplication")
Unit = Class(name="Unit")
units_pc_av_Advice = Class(name="units_pc_av_Advice")
units_pc_av_GlobalScope = Class(name="units_pc_av_GlobalScope")
units_pc_av_PerJoinPointScope = Class(name="units_pc_av_PerJoinPointScope")
units_pc_av_UnitPower = Class(name="units_pc_av_UnitPower")
units_pc_av_UnitLiteral = Class(name="units_pc_av_UnitLiteral")
units_pc_av_Pointcut = Class(name="units_pc_av_Pointcut")
units_pc_av_EObject = Class(name="units_pc_av_EObject")
...
domain_model = DomainModel(
    name="units_pc_av",
    types={units_pc_av_UnitCarryingElement, units_pc_av_Unit, units_pc_av_BaseUnit, units_pc_av_UnitRepository, units_pc_av_UnitMultiplication, Unit, units_pc_av_Advice, units_pc_av_GlobalScope, units_pc_av_PerJoinPointScope, units_pc_av_UnitPower, units_pc_av_UnitLiteral, units_pc_av_Pointcut, units_pc_av_EObject},
    associations={unit0, units1, units2, children9, scopedObject11, scopedObject13, unit4, baseUnit6, children8},
