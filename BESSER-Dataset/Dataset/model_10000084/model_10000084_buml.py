...
Elevator_Request = Class(name="Elevator_Request")
Elevator1 = Class(name="Elevator1")
...
Elevator_Controller.attributes={Elevator_Controller_Floor_ID, Elevator_Controller_attribute, Elevator_Controller_Position, Elevator_Controller_Direction}
...
Elevator_Controller_2.attributes={Elevator_Controller_2_Direction, Elevator_Controller_2_Floor_ID, Elevator_Controller_2_attribute, Elevator_Controller_2_Position}
...
Floor_button.attributes={Floor_button_Floor_num, Floor_button_Direction}

# Bridge class attributes and methods

# Floor class attributes and methods
Floor_Id: Property = Property(name="Id", type=IntegerType)
Floor.attributes={Floor_Id}

# Elevator_Request class attributes and methods

# Elevator1 class attributes and methods
Elevator1_id: Property = Property(name="id", type=IntegerType)
Elevator1.attributes={Elevator1_id}
...
domain_model = DomainModel(
    name="_0c3dc996_0a54_41d2_bcea_963c3911120f",
    types={Elevator_Controller, _unnamed, Elevator_Controller_2, _unnamed1, Elevator, Door, Button, Elevator_button, Floor_button, Bridge, Floor, Elevator_Request, Elevator1},
