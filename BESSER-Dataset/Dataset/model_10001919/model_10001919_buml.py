...
Booking.attributes={Booking_endTime, Booking_reservedTables, Booking_date, Booking_contact_no, Booking_customer_name, Booking_booking_id, Booking_email_id, Booking_startTime}
...
Food.attributes={Food_prepared, Food_price, Food_food_id, Food_served, Food_name}
