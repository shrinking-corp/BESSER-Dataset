...
class C1:
    ...
    def __init__(self, attC1: int, attC2: bool, B_C2_19: set["B1"] = None):
        self.attC1 = attC1
        self.attC2 = attC2
        self.B_C2_19 = B_C2_19 if B_C2_19 is not None else set()
    ...
    def B_C2_19(self, value):
        ...
        self.__B_C2_19 = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "c8"):
                    opp_val = getattr(item, "c8", None)
...
class A1:
    ...
    def r7(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "a6"):
                opp_val = getattr(old_value, "a6", None)
                if isinstance(opp_val, set):
                    opp_val.discard(self)
        ...
        if value is not None:
            if hasattr(value, "a6"):
                opp_val = getattr(value, "a6", None)
                if opp_val is None:
                    setattr(value, "a6", set([self]))
                elif isinstance(opp_val, set):
                    opp_val.add(self)
...
class C:
    ...
    def __init__(self, attC1: int, attC2: bool, b3: set["B"] = None):
        self.attC1 = attC1
        self.attC2 = attC2
