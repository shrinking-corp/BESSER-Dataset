...
# Classes
model_DoorsFolder = Class(name="model_DoorsFolder")
DoorsTreeNode = Class(name="DoorsTreeNode")
model_DoorsModule = Class(name="model_DoorsModule")
model_DoorsObject = Class(name="model_DoorsObject")
model_DoorsLink = Class(name="model_DoorsLink")
model_DoorsTableRow = Class(name="model_DoorsTableRow")
DoorsObject = Class(name="DoorsObject")
model_AttributeMap = Class(name="model_AttributeMap")
model_DoorsTreeNode = Class(name="model_DoorsTreeNode", is_abstract=True)
...
model_DoorsModule_m_setObjectAttributes: Method = Method(name="setObjectAttributes", parameters={Parameter(name='model_attrs', type=StringType)})
model_DoorsModule_m_getView: Method = Method(name="getView", parameters={}, type=StringType)
model_DoorsModule.methods={model_DoorsModule_m_getView, model_DoorsModule_m_setObjectAttributes, model_DoorsModule_m_getObjectAttributes}
...
model_DoorsObject.attributes={model_DoorsObject_objectText, model_DoorsObject_objectHeading, model_DoorsObject_objectNumber, model_DoorsObject_objectIdentifier, model_DoorsObject_objectShortText, model_DoorsObject_text, model_DoorsObject_absoluteNumber}
model_DoorsObject.methods={model_DoorsObject_m_getObjectLevel, model_DoorsObject_m_isHeading}
...
model_DoorsLink_m_resolve: Method = Method(name="resolve", parameters={Parameter(name='model_sourceOverride', type=StringType)}, type=DoorsObject)
model_DoorsLink.attributes={model_DoorsLink_targetObject, model_DoorsLink_targetModule}
...
model_AttributeMap.attributes={model_AttributeMap_key, model_AttributeMap_value}
...
model_DoorsTreeNode_m_getChild: Method = Method(name="getChild", parameters={Parameter(name='model_name', type=StringType)}, type=DoorsTreeNode)
model_DoorsTreeNode_m_hasTag: Method = Method(name="hasTag", parameters={Parameter(name='model_tag', type=StringType)}, type=BooleanType)
model_DoorsTreeNode_m_hasTag: Method = Method(name="hasTag", parameters={Parameter(name='model_pattern', type=StringType)}, type=BooleanType)
model_DoorsTreeNode_m_getTags: Method = Method(name="getTags", parameters={}, type=StringType)
model_DoorsTreeNode_m_setTag: Method = Method(name="setTag", parameters={Parameter(name='model_tag', type=StringType)})
model_DoorsTreeNode_m_removeTag: Method = Method(name="removeTag", parameters={Parameter(name='model_tag', type=StringType)})
model_DoorsTreeNode_m_removeTag: Method = Method(name="removeTag", parameters={Parameter(name='model_pattern', type=StringType)})
model_DoorsTreeNode_m_canCopyFrom: Method = Method(name="canCopyFrom", parameters={Parameter(name='model_node', type=StringType)}, type=BooleanType)
...
model_DoorsTreeNode.methods={model_DoorsTreeNode_m_hasTag, model_DoorsTreeNode_m_hasTag, model_DoorsTreeNode_m_toString, model_DoorsTreeNode_m_setTag, model_DoorsTreeNode_m_getTags, model_DoorsTreeNode_m_canCopyFrom, model_DoorsTreeNode_m_removeTag, model_DoorsTreeNode_m_removeTag, model_DoorsTreeNode_m_getChild}
...
domain_model = DomainModel(
    ...
    associations={children3, parent5, attributes7, outgoingLinks0, source1},
