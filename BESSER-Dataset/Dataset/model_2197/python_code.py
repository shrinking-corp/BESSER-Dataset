...
class model_DoorsTreeNode(ABC):
    ...
    def __init__(self, name: str, fullName: str, fullNameSegments: str, DoorsTreeNode: "model_DoorsTreeNode" = None, parent: set["model_DoorsTreeNode"] = None, DoorsTreeNode6: "model_DoorsTreeNode" = None, children: "model_DoorsTreeNode" = None, model_DoorsTreeNode: set["model_AttributeMap"] = None):
        self.name = name
    ...
    def hasTag(self, model_pattern) :
        # TODO: Implement hasTag method
        pass

    def removeTag(self, model_pattern):
        # TODO: Implement removeTag method
        pass

    def setTag(self, model_tag):
        # TODO: Implement setTag method
        pass

    def getChild(self, model_name) :
        # TODO: Implement getChild method
        pass

    def canCopyFrom(self, model_node) :
...
class model_DoorsLink:
    ...
    def resolve(self, model_sourceOverride) :
...
class model_DoorsObject(DoorsTreeNode):
    ...
    def __init__(self, objectIdentifier: str, objectNumber: str, absoluteNumber: int, objectText: str, objectShortText: str, objectHeading: str, text: str, source: set["model_DoorsLink"] = None, DoorsObject: "model_DoorsLink" = None):
...
class model_DoorsModule(DoorsTreeNode):
    ...
    def setObjectAttributes(self, model_attrs):
