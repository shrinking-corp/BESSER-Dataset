...
# Classes
SimplePersons_PersonRegister = Class(name="SimplePersons_PersonRegister")
SimplePersons_Person = Class(name="SimplePersons_Person", is_abstract=True)
SimplePersons_Male = Class(name="SimplePersons_Male")
Person = Class(name="Person")
SimplePersons_Female = Class(name="SimplePersons_Female")
...
domain_model = DomainModel(
    name="SimplePersons",
    types={SimplePersons_PersonRegister, SimplePersons_Person, SimplePersons_Male, Person, SimplePersons_Female},
