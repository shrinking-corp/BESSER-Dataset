...
# Classes
rdbms_RdbmsTable = Class(name="rdbms_RdbmsTable")
RdbmsElement = Class(name="RdbmsElement")
rdbms_RdbmsElement = Class(name="rdbms_RdbmsElement", is_abstract=True)
rdbms_RdbmsJunctionTable = Class(name="rdbms_RdbmsJunctionTable")
rdbms_RdbmsField = Class(name="rdbms_RdbmsField", is_abstract=True)
rdbms_RdbmsUniqueConstraint = Class(name="rdbms_RdbmsUniqueConstraint")
rdbms_RdbmsIdentifierField = Class(name="rdbms_RdbmsIdentifierField")
rdbms_RdbmsIndex = Class(name="rdbms_RdbmsIndex")
rdbms_RdbmsFieldType = Class(name="rdbms_RdbmsFieldType")
rdbms_RdbmsForeignKey = Class(name="rdbms_RdbmsForeignKey")
RdbmsIdentifierField = Class(name="RdbmsIdentifierField")
RdbmsTable = Class(name="RdbmsTable")
RdbmsField = Class(name="RdbmsField")
rdbms_RdbmsView = Class(name="rdbms_RdbmsView")
rdbms_RdbmsViewField = Class(name="rdbms_RdbmsViewField", is_abstract=True)
rdbms_RdbmsTableAlias = Class(name="rdbms_RdbmsTableAlias")
rdbms_RdbmsViewRelation = Class(name="rdbms_RdbmsViewRelation")
rdbms_RdbmsViewIdentifierField = Class(name="rdbms_RdbmsViewIdentifierField")
rdbms_RdbmsViewValueField = Class(name="rdbms_RdbmsViewValueField")
RdbmsViewAliasField = Class(name="RdbmsViewAliasField")
rdbms_RdbmsViewExpressionField = Class(name="rdbms_RdbmsViewExpressionField")
RdbmsViewField = Class(name="RdbmsViewField")
rdbms_RdbmsExpression = Class(name="rdbms_RdbmsExpression", is_abstract=True)
RdbmsViewTableField = Class(name="RdbmsViewTableField")
rdbms_RdbmsModifyTableOperation = Class(name="rdbms_RdbmsModifyTableOperation")
rdbms_RdbmsModel = Class(name="rdbms_RdbmsModel")
rdbms_RdbmsConfiguration = Class(name="rdbms_RdbmsConfiguration")
rdbms_RdbmsTableOperation = Class(name="rdbms_RdbmsTableOperation", is_abstract=True)
rdbms_RdbmsViewRecord = Class(name="rdbms_RdbmsViewRecord")
rdbms_RdbmsValueField = Class(name="rdbms_RdbmsValueField")
rdbms_RdbmsFeature = Class(name="rdbms_RdbmsFeature")
rdbms_RdbmsLabelExpression = Class(name="rdbms_RdbmsLabelExpression")
RdbmsExpression = Class(name="RdbmsExpression")
rdbms_RdbmsRelationExpression = Class(name="rdbms_RdbmsRelationExpression")
rdbms_RdbmsViewAliasField = Class(name="rdbms_RdbmsViewAliasField", is_abstract=True)
rdbms_RdbmsViewForeignIdentifierField = Class(name="rdbms_RdbmsViewForeignIdentifierField")
RdbmsTableOperation = Class(name="RdbmsTableOperation")
rdbms_RdbmsCreateFieldOperation = Class(name="rdbms_RdbmsCreateFieldOperation")
rdbms_RdbmsModifyFieldOperation = Class(name="rdbms_RdbmsModifyFieldOperation")
rdbms_RdbmsDeleteFieldOperation = Class(name="rdbms_RdbmsDeleteFieldOperation")
rdbms_RdbmsFieldOperation = Class(name="rdbms_RdbmsFieldOperation", is_abstract=True)
RdbmsFieldOperation = Class(name="RdbmsFieldOperation")
rdbms_RdbmsViewTableField = Class(name="rdbms_RdbmsViewTableField", is_abstract=True)
rdbms_RdbmsViewRecordValue = Class(name="rdbms_RdbmsViewRecordValue")
rdbms_RdbmsCreateTableOperation = Class(name="rdbms_RdbmsCreateTableOperation")
rdbms_RdbmsDeleteTableOperation = Class(name="rdbms_RdbmsDeleteTableOperation")
rdbms_RdbmsOperationMeta = Class(name="rdbms_RdbmsOperationMeta")
...
rdbms_RdbmsElement.attributes={rdbms_RdbmsElement_description, rdbms_RdbmsElement_originalPackage, rdbms_RdbmsElement_name, rdbms_RdbmsElement_uuid, rdbms_RdbmsElement_originalName, rdbms_RdbmsElement_shortName, rdbms_RdbmsElement_fullName, rdbms_RdbmsElement_sqlName}
...
rdbms_RdbmsField.attributes={rdbms_RdbmsField_mandatory, rdbms_RdbmsField_size, rdbms_RdbmsField_scale, rdbms_RdbmsField_rdbmsTypeName, rdbms_RdbmsField_storageByte, rdbms_RdbmsField_precision}
...
rdbms_RdbmsFieldType.attributes={rdbms_RdbmsFieldType_uuid, rdbms_RdbmsFieldType_storageByte, rdbms_RdbmsFieldType_precision, rdbms_RdbmsFieldType_rdbmsTypeName, rdbms_RdbmsFieldType_name, rdbms_RdbmsFieldType_size, rdbms_RdbmsFieldType_description, rdbms_RdbmsFieldType_scale}
...
rdbms_RdbmsForeignKey.attributes={rdbms_RdbmsForeignKey_readOnly, rdbms_RdbmsForeignKey_foreignKeySqlName, rdbms_RdbmsForeignKey_deferred, rdbms_RdbmsForeignKey_deleteOnCascade, rdbms_RdbmsForeignKey_inheritenceBased}
...
rdbms_RdbmsModifyFieldOperation.attributes={rdbms_RdbmsModifyFieldOperation_changedValueFieldToForeignKey, rdbms_RdbmsModifyFieldOperation_mandatoryChanged, rdbms_RdbmsModifyFieldOperation_sizeChanged, rdbms_RdbmsModifyFieldOperation_typeChanged, rdbms_RdbmsModifyFieldOperation_changedForeignKeyToValueField, rdbms_RdbmsModifyFieldOperation_nameChanged}
...
domain_model = DomainModel(
    name="rdbms",
    types={rdbms_RdbmsTable, RdbmsElement, rdbms_RdbmsElement, rdbms_RdbmsJunctionTable, rdbms_RdbmsField, rdbms_RdbmsUniqueConstraint, rdbms_RdbmsIdentifierField, rdbms_RdbmsIndex, rdbms_RdbmsFieldType, rdbms_RdbmsForeignKey, RdbmsIdentifierField, RdbmsTable, RdbmsField, rdbms_RdbmsView, rdbms_RdbmsViewField, rdbms_RdbmsTableAlias, rdbms_RdbmsViewRelation, rdbms_RdbmsViewIdentifierField, rdbms_RdbmsViewValueField, RdbmsViewAliasField, rdbms_RdbmsViewExpressionField, RdbmsViewField, rdbms_RdbmsExpression, RdbmsViewTableField, rdbms_RdbmsModifyTableOperation, rdbms_RdbmsModel, rdbms_RdbmsConfiguration, rdbms_RdbmsTableOperation, rdbms_RdbmsViewRecord, rdbms_RdbmsValueField, rdbms_RdbmsFeature, rdbms_RdbmsLabelExpression, RdbmsExpression, rdbms_RdbmsRelationExpression, rdbms_RdbmsViewAliasField, rdbms_RdbmsViewForeignIdentifierField, RdbmsTableOperation, rdbms_RdbmsCreateFieldOperation, rdbms_RdbmsModifyFieldOperation, rdbms_RdbmsDeleteFieldOperation, rdbms_RdbmsFieldOperation, RdbmsFieldOperation, rdbms_RdbmsViewTableField, rdbms_RdbmsViewRecordValue, rdbms_RdbmsCreateTableOperation, rdbms_RdbmsDeleteTableOperation, rdbms_RdbmsOperationMeta},
    associations={table12, fields14, fields0, uniqueConstraints1, primaryKey3, indexes4, parent7, table9, type10, referenceKey11, field116, field217, foreignKeys20, fields21, primaryTable22, relations23, primaryIdentifierField25, tables27, view29, expressions31, alias54, rdbmsFieldTypes32, rdbmsTables34, rdbmsViews37, configuration40, tableOperations42, viewRecords44, features46, table48, view51, field53, referenceIdentifier84, createFieldOperations57, modifyFieldOperations58, deleteFieldOperations60, previousTable62, field65, previousField67, fromAlias70, toAlias73, fromField76, toField79, tableField82, table86, fields88, values90, view92, identifierField95, valueField98, table100, previousModel103, currentModel105, incrementalModel108},
    generalizations={gen_rdbms_RdbmsTable_RdbmsElement, gen_rdbms_RdbmsField_RdbmsElement, gen_rdbms_RdbmsForeignKey_RdbmsIdentifierField, gen_rdbms_RdbmsUniqueConstraint_RdbmsElement, gen_rdbms_RdbmsJunctionTable_RdbmsTable, gen_rdbms_RdbmsIdentifierField_RdbmsField, gen_rdbms_RdbmsView_RdbmsElement, gen_rdbms_RdbmsViewField_RdbmsElement, gen_rdbms_RdbmsViewValueField_RdbmsViewAliasField, gen_rdbms_RdbmsViewExpressionField_RdbmsViewField, gen_rdbms_RdbmsExpression_RdbmsElement, gen_rdbms_RdbmsViewAliasField_RdbmsViewTableField, gen_rdbms_RdbmsValueField_RdbmsField, gen_rdbms_RdbmsViewIdentifierField_RdbmsViewAliasField, gen_rdbms_RdbmsTableAlias_RdbmsElement, gen_rdbms_RdbmsLabelExpression_RdbmsExpression, gen_rdbms_RdbmsRelationExpression_RdbmsExpression, gen_rdbms_RdbmsViewForeignIdentifierField_RdbmsViewTableField, gen_rdbms_RdbmsModifyTableOperation_RdbmsTableOperation, gen_rdbms_RdbmsFieldOperation_RdbmsElement, gen_rdbms_RdbmsCreateFieldOperation_RdbmsFieldOperation, gen_rdbms_RdbmsModifyFieldOperation_RdbmsFieldOperation, gen_rdbms_RdbmsDeleteFieldOperation_RdbmsFieldOperation, gen_rdbms_RdbmsViewTableField_RdbmsViewField, gen_rdbms_RdbmsIndex_RdbmsElement, gen_rdbms_RdbmsTableOperation_RdbmsElement, gen_rdbms_RdbmsCreateTableOperation_RdbmsTableOperation, gen_rdbms_RdbmsDeleteTableOperation_RdbmsTableOperation},
    metadata=None
)
