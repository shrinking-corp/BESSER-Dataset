...
class rdbms_RdbmsViewRecordValue:
    ...
    def __init__(self, value: str, rdbms_RdbmsViewRecordValue: "rdbms_RdbmsViewRecord" = None, rdbms_RdbmsViewRecordValue96: "rdbms_RdbmsViewIdentifierField" = None, rdbms_RdbmsViewRecordValue99: "rdbms_RdbmsViewValueField" = None):
        self.value = value
...
class rdbms_RdbmsModifyFieldOperation(RdbmsFieldOperation):
    ...
    def __init__(self, typeChanged: bool, mandatoryChanged: bool, sizeChanged: str, nameChanged: str, changedValueFieldToForeignKey: str, changedForeignKeyToValueField: str, rdbms_RdbmsModifyFieldOperation: "rdbms_RdbmsModifyTableOperation" = None, rdbms_RdbmsModifyFieldOperation68: "rdbms_RdbmsField" = None):
        ...
        pass
    @property
    def changedForeignKeyToValueField(self):
    ...
    @property
    def changedValueFieldToForeignKey(self):
...
class rdbms_RdbmsModel:
    ...
    def __init__(self, version: str, rdbms_RdbmsModel: set["rdbms_RdbmsFieldType"] = None, rdbms_RdbmsModel35: set["rdbms_RdbmsTable"] = None, rdbms_RdbmsModel104: "rdbms_RdbmsOperationMeta" = None, rdbms_RdbmsModel107: "rdbms_RdbmsOperationMeta" = None, rdbms_RdbmsModel110: "rdbms_RdbmsOperationMeta" = None, rdbms_RdbmsModel38: set["rdbms_RdbmsView"] = None, rdbms_RdbmsModel41: "rdbms_RdbmsConfiguration" = None, rdbms_RdbmsModel43: set["rdbms_RdbmsTableOperation"] = None, rdbms_RdbmsModel45: set["rdbms_RdbmsViewRecord"] = None):
...
class rdbms_RdbmsForeignKey(RdbmsIdentifierField):
    ...
    def __init__(self, inheritenceBased: bool, foreignKeySqlName: str, deleteOnCascade: bool, deferred: bool, readOnly: bool, foreignKeys: "rdbms_RdbmsIdentifierField" = None, rdbms_RdbmsForeignKey: "rdbms_RdbmsJunctionTable" = None, rdbms_RdbmsForeignKey19: "rdbms_RdbmsJunctionTable" = None, RdbmsForeignKey: "rdbms_RdbmsIdentifierField" = None):
...
class rdbms_RdbmsFieldType:
    ...
    def __init__(self, description: str, size: int, precision: int, scale: int, storageByte: int, name: str, rdbmsTypeName: str, uuid: str, rdbms_RdbmsFieldType: "rdbms_RdbmsField" = None, rdbms_RdbmsFieldType33: "rdbms_RdbmsModel" = None):
...
class rdbms_RdbmsElement(ABC):
    ...
    def __init__(self, sqlName: str, originalName: str, originalPackage: str, name: str, uuid: str, shortName: str, fullName: str, description: str):
...
class rdbms_RdbmsViewField(RdbmsElement):
    ...
    def __init__(self, inherited: bool, RdbmsViewField: "rdbms_RdbmsView" = None, fields30: "rdbms_RdbmsView" = None):
...
class rdbms_RdbmsField(RdbmsElement):
    ...
    def __init__(self, mandatory: bool, rdbmsTypeName: str, size: int, precision: int, scale: int, storageByte: int, rdbms_RdbmsField15: "rdbms_RdbmsUniqueConstraint" = None, RdbmsField: "rdbms_RdbmsTable" = None, fields: "rdbms_RdbmsTable" = None, rdbms_RdbmsField: "rdbms_RdbmsFieldType" = None, rdbms_RdbmsField83: "rdbms_RdbmsViewTableField" = None, rdbms_RdbmsField89: "rdbms_RdbmsIndex" = None, rdbms_RdbmsField66: "rdbms_RdbmsFieldOperation" = None, rdbms_RdbmsField69: "rdbms_RdbmsModifyFieldOperation" = None):
...
class rdbms_RdbmsView(RdbmsElement):
    ...
    def __init__(self, originUuid: str, view: set["rdbms_RdbmsViewField"] = None, rdbms_RdbmsView: "rdbms_RdbmsTableAlias" = None, rdbms_RdbmsView24: set["rdbms_RdbmsViewRelation"] = None, rdbms_RdbmsView26: "rdbms_RdbmsViewIdentifierField" = None, view28: set["rdbms_RdbmsTableAlias"] = None, RdbmsView: "rdbms_RdbmsViewField" = None, rdbms_RdbmsView94: "rdbms_RdbmsViewRecord" = None, rdbms_RdbmsView39: "rdbms_RdbmsModel" = None, RdbmsView52: "rdbms_RdbmsTableAlias" = None):
