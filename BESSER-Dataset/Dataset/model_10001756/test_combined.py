...
def test_hyp_myclass_asdasda___setter(instance):
...
def test_MyClass_asdasda___value_roundtrip():
    instance = MyClass(asdasda__="sample_text")
    assert instance.asdasda__ == "sample_text"
    instance.asdasda__ = "sample_text_2"
    assert instance.asdasda__ == "sample_text_2"
...
MyClass_strategy = st.builds(MyClass, asdasda__=safe_text)
@given(instance=MyClass_strategy)
