...
domain_model = DomainModel(
    name="model",
    types={model_Diagram, model_Node, model_Edge, model_TypeNode, Node, model_AssociationNode, model_BendPoint, EdgeType},
    associations={nodes0, edges1, bendpoints3, source5, target8},
    generalizations={gen_model_TypeNode_Node, gen_model_AssociationNode_Node},
    metadata=None
)
