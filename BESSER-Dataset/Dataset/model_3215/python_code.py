...
class gast_types_GASTClass(types_Member, types_GASTType):
    ...
    def __init__(self, linesOfComments: int, local: bool, primitive: bool, interface: bool, anonymous: bool, inner: bool, localClasses: "Function" = None, classes: "Package" = None, gast_types_GASTClass: set["GASTClass"] = None, surroundingClass: set["TypeAlias"] = None, innerClasses: "GASTClass" = None, gast_types_GASTClass206: set["InheritanceTypeAccess"] = None, gast_types_GASTClass208: "Field" = None, gastClass: set["GASTClass"] = None, friendClasses: "GASTClass" = None, gast_types_GASTClass220: set["Access"] = None, gast_types_GASTClass223: set["GASTClass"] = None, surroundingClass184: set["Delegate"] = None, surroundingClass187: set["Constructor"] = None, surroundingClass189: set["Destructor"] = None, surroundingClass191: set["Field"] = None, surroundingClass193: set["Method"] = None, gast_types_GASTClass215: set["Function"] = None, gast_types_GASTClass218: set["Property"] = None, surroundingClass201: set["GASTClass"] = None):
...
class gast_functions_Delegate(types_Member, functions_Function, types_GASTType):
    ...
    def __init__(self, innerDelegate: bool, innerDelegates: "GASTClass" = None, delegates: "Package" = None, gast_functions_Delegate: "GASTClass" = None, gast_functions_Delegate267: set["Function"] = None):
...
class gast_types_TypeAlias(types_Member, types_TypeDecorator):
    ...
    def __init__(self, innerTypeAlias: bool, innerTypeAliases: "GASTClass" = None, gast_types_TypeAlias: "GASTType" = None, typeAliases: "Package" = None):
...
class gast_functions_Function(core_NamedModelElement, core_SourceEntity):
    ...
    def __init__(self, linesOfCode: int, numberOfEdgesInCFG: int, numberOfStatements: int, maximumNestingLevel: int, linesOfComments: int, numberOfNodesInCFG: int, operator: bool, surroundingFunction298: "BlockStatement" = None, surroundingFunction301: set["GASTClass"] = None, function: "DeclarationTypeAccess" = None, surroundingFunction: set["FormalParameter"] = None, surroundingFunction289: set["LocalVariable"] = None, gast_functions_Function: set["Statement"] = None, gast_functions_Function293: set["ThrowTypeAccess"] = None, gast_functions_Function295: set["Access"] = None):
...
class gast_core_NamedModelElement(ModelElement):
    ...
    def __init__(self, simpleName: str, ModelElement263: "gast_accesses_Access" = None, ModelElement: "gast_core_Root" = None, ModelElement105: "gast_core_Root" = None):
...
class gast_core_Root(ModelElement):
    ...
    def __init__(self, linesOfComments: int, linesOfCode: int, gast_core_Root85: set["GASTClass"] = None, gast_core_Root: set["Access"] = None, gast_core_Root79: set["GASTClass"] = None, gast_core_Root82: set["GASTClass"] = None, gast_core_Root88: set["GASTClass"] = None, gast_core_Root91: set["ModelElement"] = None, gast_core_Root93: set["GlobalVariable"] = None, root: set["Package"] = None, root98: set["Clone"] = None, gast_core_Root100: set["StructuralAbstraction"] = None, gast_core_Root102: set["GASTType"] = None, gast_core_Root104: set["ModelElement"] = None, root107: set["BasePath"] = None, root109: set["GlobalFunction"] = None, ModelElement263: "gast_accesses_Access" = None, ModelElement: "gast_core_Root" = None, ModelElement105: "gast_core_Root" = None):
        self.linesOfComments = linesOfComments
        self.linesOfCode = linesOfCode
...
class gast_core_BasePath(ModelElement):
    ...
    def __init__(self, path: str, basePaths: "Root" = None, basePath: set["Directory"] = None, ModelElement263: "gast_accesses_Access" = None, ModelElement: "gast_core_Root" = None, ModelElement105: "gast_core_Root" = None):
        self.path = path
...
class gast_core_File(NamedModelElement):
    ...
    def __init__(self, sourceFile: bool, assemblyFile: bool, linesOfCode: int, size: str, fullQualifiedPath: str, fileSystemPath: str, gast_core_File127: set["GlobalVariable"] = None, gast_core_File: "Root" = None, gast_core_File121: set["GASTType"] = None, gast_core_File124: set["GASTType"] = None, gast_core_File130: set["GlobalFunction"] = None, gast_core_File142: set["File"] = None, files: "Directory" = None, gast_core_File133: set["GlobalFunction"] = None, gast_core_File136: set["GlobalVariable"] = None, gast_core_File139: set["Package"] = None):
...
class gast_core_Package(NamedModelElement):
    ...
    def __init__(self, linesOfComments: int, linesOfCode: int, qualifiedName: str, surroundingPackage64: set["GASTClass"] = None, gast_core_Package: set["GASTClass"] = None, gast_core_Package46: set["GASTClass"] = None, gast_core_Package49: set["GASTClass"] = None, gast_core_Package52: set["GASTClass"] = None, gast_core_Package55: set["Access"] = None, surroundingPackage: set["Delegate"] = None, surroundingPackage58: set["GlobalFunction"] = None, surroundingPackage60: set["GlobalVariable"] = None, packages: "Root" = None, surroundingPackage67: set["Package"] = None, subPackages: "Package" = None, gast_core_Package71: set["Package"] = None, surroundingPackage74: set["TypeAlias"] = None):
        self.linesOfComments = linesOfComments
        self.linesOfCode = linesOfCode
        self.qualifiedName = qualifiedName
...
class gast_functions_GlobalFunction(Function):
    ...
    def __init__(self, kind: str, globalFunctions: "Package" = None, globalFunctions280: "Root" = None, Function256: "gast_accesses_FunctionAccess" = None, Function245: "gast_accesses_DeclarationTypeAccess" = None, Function195: "gast_types_GASTClass" = None, Function248: "gast_accesses_DelegateAccess" = None, Function268: "gast_functions_Delegate" = None, Function312: "gast_variables_LocalVariable" = None, Function241: "gast_accesses_BaseAccess" = None, Function304: "gast_variables_FormalParameter" = None, Function: "gast_statements_BlockStatement" = None, Function216: "gast_types_GASTClass" = None):
        self.kind = kind
...
class gast_statements_BlockStatement(Statement):
    ...
    def __init__(self, synchronized: bool, blockstatement: set["Statement"] = None, body17: "Function" = None, Statement233: "gast_accesses_BaseAccess" = None, Statement235: "gast_accesses_BaseAccess" = None, Statement21: "gast_statements_Branch" = None, Statement291: "gast_functions_Function" = None, Statement160: "gast_annotations_CloneInstance" = None, Statement: "gast_statements_Statement" = None, Statement15: "gast_statements_BlockStatement" = None, Statement33: "gast_statements_LoopStatement" = None):
...
class gast_statements_JumpStatement(Statement):
    ...
    def __init__(self, kind: str, gast_statements_JumpStatement: "GASTExpression" = None, Statement233: "gast_accesses_BaseAccess" = None, Statement235: "gast_accesses_BaseAccess" = None, Statement21: "gast_statements_Branch" = None, Statement291: "gast_functions_Function" = None, Statement160: "gast_annotations_CloneInstance" = None, Statement: "gast_statements_Statement" = None, Statement15: "gast_statements_BlockStatement" = None, Statement33: "gast_statements_LoopStatement" = None):
        self.kind = kind
...
class gast_statements_LoopStatement(Statement):
    ...
    def __init__(self, kind: str, loopstatement: "Statement" = None, gast_statements_LoopStatement: "GASTExpression" = None, gast_statements_LoopStatement27: "GASTExpression" = None, gast_statements_LoopStatement30: "GASTExpression" = None, Statement233: "gast_accesses_BaseAccess" = None, Statement235: "gast_accesses_BaseAccess" = None, Statement21: "gast_statements_Branch" = None, Statement291: "gast_functions_Function" = None, Statement160: "gast_annotations_CloneInstance" = None, Statement: "gast_statements_Statement" = None, Statement15: "gast_statements_BlockStatement" = None, Statement33: "gast_statements_LoopStatement" = None):
        self.kind = kind
