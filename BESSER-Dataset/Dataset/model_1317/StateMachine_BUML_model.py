...
stateMachine_Variables = Class(name="stateMachine_Variables")
stateMachine_Events = Class(name="stateMachine_Events")
stateMachine_States = Class(name="stateMachine_States")
...
domain_model = DomainModel(
    name="stateMachine",
    types={stateMachine_StateMachine, stateMachine_Variables, stateMachine_Events, stateMachine_States, stateMachine_Variable, stateMachine_Event, stateMachine_State, stateMachine_Condition, stateMachine_Transition},
    associations={vardefs0, eventdefs1, statedefs3, vars5, events7, start9, states11, event16, condition19, target21, variable24, transitions14},
    generalizations={},
    metadata=None
)
