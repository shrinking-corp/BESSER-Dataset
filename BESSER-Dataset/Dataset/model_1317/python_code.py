...
class stateMachine_State:
    ...
    def __init__(self, name: str, stateMachine_State: "stateMachine_States" = None, stateMachine_State13: "stateMachine_States" = None, stateMachine_State23: "stateMachine_Transition" = None, stateMachine_State15: set["stateMachine_Transition"] = None):
        self.name = name
