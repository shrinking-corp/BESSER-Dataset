...
class User:
    ...
    def __init__(self, First_Name: str, Last_Name: str, ID_Number: int, Password: str, login12: "Login" = None, has_user2: "Database" = None):
...
class Course:
    ...
    def __init__(self, CourseName: str, CourseNumber: str, Course_Teacher: Teacher, teacher11: "Teacher" = None, takes_course0: set["Student"] = None):
...
class Database:
    ...
    def __init__(self, Materials: Database, Schedules: Database, Grades: Database, Accounts: Database, teacher15: set["Teacher"] = None, User_Database_13: "User" = None, login5: "Login" = None, admin6: "Admin" = None, Student_Database_19: "Student" = None):
