...
petrinet_Transition.methods={petrinet_Transition_m_isEnabled, petrinet_Transition_m_fire}

# Node class attributes and methods

# petrinet_Place class attributes and methods
petrinet_Place_capacity: Property = Property(name="capacity", type=IntegerType)
petrinet_Place_m_hasCapacity: Method = Method(name="hasCapacity", parameters={Parameter(name='petrinet_amount', type=StringType)}, type=BooleanType)
...
domain_model = DomainModel(
    ...
    associations={out3, in_4, tokens6, nodes0, arcs1, source7, target8},
