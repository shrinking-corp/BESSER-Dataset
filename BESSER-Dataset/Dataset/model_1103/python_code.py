...
class petrinet_Arc:
    ...
    def __init__(self, weight: int, Arc: "petrinet_Node" = None, Arc5: "petrinet_Node" = None, petrinet_Arc: "petrinet_PetriNet" = None, out: "petrinet_Node" = None, in_: "petrinet_Node" = None):
        self.weight = weight
        self.Arc = Arc
        self.Arc5 = Arc5
    ...
    def in_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_petrinet_Arc__in_", None)
        self.__in_ = value
...
class petrinet_Place(Node):
    ...
    def hasCapacity(self, petrinet_amount) :
