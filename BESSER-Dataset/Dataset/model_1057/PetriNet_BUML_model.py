...
PetriNet_WeightedArc = Class(name="PetriNet_WeightedArc")
...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={PetriNet_Arc, PetriNet_PlaceToTransArc, PetriNet_Element, PetriNet_PetriNet, Element, Place, Transition, Arc, PetriNet_Place, TransToPlaceArc, PlaceToTransArc, PetriNet, PetriNet_Transition, PetriNet_TransToPlaceArc, PetriNet_WeightedArc},
    associations={places0, transitions1, arcs2, incoming4, outgoing5, net6, incoming7, outgoing10, source13, target15, source17, target20},
    generalizations={gen_PetriNet_PlaceToTransArc_Arc, gen_PetriNet_PetriNet_Element, gen_PetriNet_Place_Element, gen_PetriNet_Transition_Element, gen_PetriNet_TransToPlaceArc_Arc, gen_PetriNet_WeightedArc_Arc},
    metadata=None
)
