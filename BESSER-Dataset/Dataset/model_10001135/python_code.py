...
class ShoppingCart:
    ...
    def __init__(self, id: int, creationDate: date, accnt4: "Account" = None, item11: set["Item"] = None, c0: "Customer" = None):
        self.id = id
...
class Customer:
    ...
    def __init__(self, firstname: str, lastname: str, emailAddress: str, id: int, login: str, password: str, isBan: bool, account3: "Account" = None, cart1: "ShoppingCart" = None):
