...
uisut_UIState.attributes={uisut_UIState_isInitial, uisut_UIState_pic}
...
uisut_UISUTElement.attributes={uisut_UISUTElement_name, uisut_UISUTElement_id, uisut_UISUTElement_description}
...
domain_model = DomainModel(
    name="uisut",
    types={uisut_UISUT, UISUTElement, uisut_UIStatemachine, uisut_ApplicationSystem, uisut_AbstractState, uisut_UITransition, uisut_UIDataVariable, uisut_UIState, AbstractState, uisut_UIControl, uisut_UITrigger, uisut_UICondition, uisut_Action, uisut_UserTrigger, UITrigger, uisut_ComponentTrigger, uisut_InitialState, uisut_FinalState, uisut_UISUTElement},
    associations={itsSTM0, itsUISUT1, itsState3, itsTransition5, itsDataVariable7, addedDataVariable10, deletedDataVariable13, itsTrgtState16, itsSrcState17, itsTrigger19, itsCondition21, itsAction23, guardedDataVariable25, itsInputDaa28, itsOutputData31, itsUIControl9, itsInTransition34, itsOutTransition35},
