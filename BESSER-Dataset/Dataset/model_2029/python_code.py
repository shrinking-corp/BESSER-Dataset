...
class uisut_UIState(AbstractState):
    ...
    def __init__(self, pic: str, isInitial: bool, uisut_UIState11: set["uisut_UIDataVariable"] = None, uisut_UIState14: set["uisut_UIDataVariable"] = None, uisut_UIState: set["uisut_UIControl"] = None):
        self.pic = pic
...
class uisut_UITransition(UISUTElement):
    ...
    def __init__(self, triggerStr: str, guardStr: str, actionStr: str, scriptStr: str, uisut_UITransition: "uisut_UIStatemachine" = None, itsInTransition: "uisut_AbstractState" = None, itsOutTransition: "uisut_AbstractState" = None, uisut_UITransition20: "uisut_UITrigger" = None, uisut_UITransition22: "uisut_UICondition" = None, uisut_UITransition24: "uisut_Action" = None, uisut_UITransition26: set["uisut_UIDataVariable"] = None, UITransition: "uisut_AbstractState" = None, UITransition36: "uisut_AbstractState" = None):
...
class uisut_UIControl(UISUTElement):
    ...
    def __init__(self, variableName: str, valueExpression: str, uisut_UIControl29: "uisut_UIDataVariable" = None, uisut_UIControl32: "uisut_UIDataVariable" = None, uisut_UIControl: "uisut_UIState" = None):
