...
class drn_DepXYZ(DepXYZ_IMPL):
    ...
    def __init__(self, distanceCST: str, tempsCST: str, drn_DepXYZ76: "drn_Parametre" = None, drn_DepXYZ: "drn_Parametre" = None):
...
class drn_DepY_Impl(Expression):
    ...
    def __init__(self, name: str, distanceCST: str, tempsCST: str, drn_DepY_Impl: "drn_And" = None, drn_DepY_Impl37: "drn_Parametre" = None, drn_DepY_Impl34: "drn_Parametre" = None):
        self.name = name
        self.distanceCST = distanceCST
        self.tempsCST = tempsCST
...
class drn_And(Expression):
    ...
    def __init__(self, name: str, drn_And: set["drn_Rotate"] = None, drn_And24: set["drn_DepX_Impl"] = None, drn_And26: set["drn_DepY_Impl"] = None, drn_And28: set["drn_DepXZ_IMPL"] = None, drn_And30: set["drn_DepXY_IMPL"] = None, drn_And32: set["drn_DepZ_Impl"] = None):
        self.name = name
...
class drn_DepXY_IMPL(Expression):
    ...
    def __init__(self, name: str, tempsCST: str, drn_DepXY_IMPL52: "drn_Parametre" = None, drn_DepXY_IMPL: "drn_And" = None):
        self.name = name
        self.tempsCST = tempsCST
...
class drn_RefPart(Expression):
    ...
    def __init__(self, params: str, drn_RefPart20: "drn_Assignement" = None, drn_RefPart: "drn_Model" = None):
        self.params = params
...
class drn_Assignement:
    ...
    def __init__(self, name: str, drn_Assignement21: "drn_RefPart" = None, drn_Assignement8: set["drn_Parametre"] = None, drn_Assignement10: set["drn_Expression"] = None, drn_Assignement: "drn_Model" = None):
        self.name = name
...
class drn_Expression:
    ...
    def __init__(self, repeatCST: str, drn_Expression12: "drn_Parametre" = None, drn_Expression15: set["drn_With"] = None, drn_Expression18: "drn_Expression" = None, drn_Expression16: set["drn_Expression"] = None, drn_Expression: "drn_Assignement" = None):
...
class drn_Parametre:
    ...
    def __init__(self, name: str, drn_Parametre13: "drn_Expression" = None, drn_Parametre53: "drn_DepXY_IMPL" = None, drn_Parametre38: "drn_DepY_Impl" = None, drn_Parametre41: "drn_DepX_Impl" = None, drn_Parametre: "drn_Assignement" = None, drn_Parametre35: "drn_DepY_Impl" = None, drn_Parametre44: "drn_DepX_Impl" = None, drn_Parametre47: "drn_DepZ_Impl" = None, drn_Parametre50: "drn_DepZ_Impl" = None, drn_Parametre65: "drn_CERCLEYZ" = None, drn_Parametre67: "drn_CARREYZ" = None, drn_Parametre55: "drn_DepXY" = None, drn_Parametre57: "drn_CERCLEXY" = None, drn_Parametre59: "drn_CARREXY" = None, drn_Parametre61: "drn_DepYZ_IMPL" = None, drn_Parametre63: "drn_DepYZ" = None, drn_Parametre77: "drn_DepXYZ" = None, drn_Parametre69: "drn_DepXZ" = None, drn_Parametre72: "drn_DepXZ" = None, drn_Parametre74: "drn_DepXYZ" = None, drn_Parametre80: "drn_Rotate" = None, drn_Parametre83: "drn_Rotate" = None, drn_Parametre85: "drn_Wait" = None, drn_Parametre89: "drn_LedBlink" = None):
        self.name = name
