...
class tutorial_Member:
    ...
    def __init__(self, name: str, members: "tutorial_Library" = None, tutorial_Member: set["tutorial_Loan"] = None, tutorial_Member12: set["tutorial_Book"] = None, Member: "tutorial_Library" = None, tutorial_Member19: "tutorial_Loan" = None):
        self.name = name
...
class tutorial_Loan:
    ...
    def __init__(self, date: date, tutorial_Loan6: "tutorial_Book" = None, tutorial_Loan10: "tutorial_Member" = None, tutorial_Loan: "tutorial_Library" = None, tutorial_Loan15: "tutorial_Book" = None, tutorial_Loan18: "tutorial_Member" = None):
        self.date = date
...
class tutorial_Book:
    ...
    def __init__(self, name: str, copies: str, tutorial_Book: set["tutorial_Loan"] = None, tutorial_Book13: "tutorial_Member" = None, Book: "tutorial_Library" = None, books: "tutorial_Library" = None, tutorial_Book16: "tutorial_Loan" = None):
        self.name = name
        self.copies = copies
