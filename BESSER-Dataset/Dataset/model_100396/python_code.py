...
class RegularState:
    ...
    pass
class sgraph_State(SpecificationElement, RegularState, ReactiveElement, CompositeElement, ScopedElement):
...
class sgraph_Declaration(NamedElement):
    ...
    pass
class sgraph_Statechart(SpecificationElement, ReactiveElement, NamedElement, CompositeElement, ScopedElement):
