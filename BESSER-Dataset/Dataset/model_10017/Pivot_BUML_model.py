...
# Classes
pivot_Element = Class(name="pivot_Element", is_abstract=True)
pivot_Detail = Class(name="pivot_Detail")
pivot_AnyType = Class(name="pivot_AnyType")
Class_ = Class(name="Class")
pivot_AssociationClass = Class(name="pivot_AssociationClass")
pivot_Property = Class(name="pivot_Property")
pivot_Annotation = Class(name="pivot_Annotation")
NamedElement = Class(name="NamedElement")
pivot_BooleanLiteralExp = Class(name="pivot_BooleanLiteralExp")
PrimitiveLiteralExp = Class(name="PrimitiveLiteralExp")
pivot_CallExp = Class(name="pivot_CallExp", is_abstract=True)
OCLExpression = Class(name="OCLExpression")
pivot_AssociationClassCallExp = Class(name="pivot_AssociationClassCallExp")
NavigationCallExp = Class(name="NavigationCallExp")
pivot_BagType = Class(name="pivot_BagType")
CollectionType = Class(name="CollectionType")
pivot_Behavior = Class(name="pivot_Behavior", is_abstract=True)
pivot_Transition = Class(name="pivot_Transition")
pivot_Constraint = Class(name="pivot_Constraint")
pivot_Package = Class(name="pivot_Package")
pivot_CollectionItem = Class(name="pivot_CollectionItem")
CollectionLiteralPart = Class(name="CollectionLiteralPart")
pivot_CollectionLiteralExp = Class(name="pivot_CollectionLiteralExp")
LiteralExp = Class(name="LiteralExp")
pivot_OCLExpression = Class(name="pivot_OCLExpression", is_abstract=True)
pivot_CallOperationAction = Class(name="pivot_CallOperationAction")
pivot_Operation = Class(name="pivot_Operation")
pivot_Class = Class(name="pivot_Class")
Type = Class(name="Type")
Namespace = Class(name="Namespace")
TemplateableElement = Class(name="TemplateableElement")
pivot_StereotypeExtender = Class(name="pivot_StereotypeExtender")
pivot_CollectionLiteralPart = Class(name="pivot_CollectionLiteralPart", is_abstract=True)
TypedElement = Class(name="TypedElement")
pivot_CollectionRange = Class(name="pivot_CollectionRange")
pivot_CompleteModel = Class(name="pivot_CompleteModel")
pivot_StandardLibrary = Class(name="pivot_StandardLibrary")
pivot_OrphanCompletePackage = Class(name="pivot_OrphanCompletePackage")
pivot_Model = Class(name="pivot_Model")
pivot_PrimitiveCompletePackage = Class(name="pivot_PrimitiveCompletePackage")
pivot_CollectionType = Class(name="pivot_CollectionType")
DataType = Class(name="DataType")
pivot_Type = Class(name="pivot_Type", is_abstract=True)
pivot_Comment = Class(name="pivot_Comment")
Element = Class(name="Element")
pivot_CompleteClass = Class(name="pivot_CompleteClass")
pivot_CompletePackage = Class(name="pivot_CompletePackage")
pivot_CompleteEnvironment = Class(name="pivot_CompleteEnvironment")
pivot_State = Class(name="pivot_State")
pivot_ConnectionPointReference = Class(name="pivot_ConnectionPointReference")
Vertex = Class(name="Vertex")
pivot_Pseudostate = Class(name="pivot_Pseudostate")
pivot_Namespace = Class(name="pivot_Namespace", is_abstract=True)
pivot_LanguageExpression = Class(name="pivot_LanguageExpression", is_abstract=True)
pivot_DynamicBehavior = Class(name="pivot_DynamicBehavior")
Behavior = Class(name="Behavior")
DynamicType = Class(name="DynamicType")
pivot_DynamicElement = Class(name="pivot_DynamicElement")
pivot_DynamicProperty = Class(name="pivot_DynamicProperty")
pivot_DataType = Class(name="pivot_DataType")
pivot_DynamicType = Class(name="pivot_DynamicType")
DynamicElement = Class(name="DynamicElement")
pivot_DynamicValueSpecification = Class(name="pivot_DynamicValueSpecification")
ValueSpecification = Class(name="ValueSpecification")
Visitable = Class(name="Visitable")
pivot_EnumLiteralExp = Class(name="pivot_EnumLiteralExp")
pivot_EnumerationLiteral = Class(name="pivot_EnumerationLiteral")
pivot_Enumeration = Class(name="pivot_Enumeration")
pivot_ElementExtension = Class(name="pivot_ElementExtension")
pivot_Stereotype = Class(name="pivot_Stereotype")
pivot_Feature = Class(name="pivot_Feature", is_abstract=True)
InstanceSpecification = Class(name="InstanceSpecification")
pivot_ExpressionInOCL = Class(name="pivot_ExpressionInOCL")
LanguageExpression = Class(name="LanguageExpression")
pivot_Variable = Class(name="pivot_Variable")
pivot_Import = Class(name="pivot_Import")
pivot_InstanceSpecification = Class(name="pivot_InstanceSpecification")
pivot_Slot = Class(name="pivot_Slot")
pivot_FeatureCallExp = Class(name="pivot_FeatureCallExp", is_abstract=True)
CallExp = Class(name="CallExp")
pivot_FinalState = Class(name="pivot_FinalState")
State = Class(name="State")
pivot_IfExp = Class(name="pivot_IfExp")
pivot_IntegerLiteralExp = Class(name="pivot_IntegerLiteralExp")
NumericLiteralExp = Class(name="NumericLiteralExp")
pivot_InvalidLiteralExp = Class(name="pivot_InvalidLiteralExp")
pivot_InvalidType = Class(name="pivot_InvalidType")
pivot_IterateExp = Class(name="pivot_IterateExp")
LoopExp = Class(name="LoopExp")
ReferringElement = Class(name="ReferringElement")
pivot_Iteration = Class(name="pivot_Iteration")
Operation = Class(name="Operation")
pivot_Parameter = Class(name="pivot_Parameter")
pivot_IteratorExp = Class(name="pivot_IteratorExp")
pivot_LambdaType = Class(name="pivot_LambdaType")
pivot_Precedence = Class(name="pivot_Precedence")
pivot_LiteralExp = Class(name="pivot_LiteralExp", is_abstract=True)
pivot_LoopExp = Class(name="pivot_LoopExp", is_abstract=True)
pivot_LetExp = Class(name="pivot_LetExp")
pivot_Library = Class(name="pivot_Library")
Package = Class(name="Package")
pivot_SendSignalAction = Class(name="pivot_SendSignalAction")
pivot_MessageType = Class(name="pivot_MessageType")
pivot_Signal = Class(name="pivot_Signal")
pivot_MapLiteralExp = Class(name="pivot_MapLiteralExp")
pivot_MapLiteralPart = Class(name="pivot_MapLiteralPart")
pivot_MapType = Class(name="pivot_MapType")
pivot_MessageExp = Class(name="pivot_MessageExp")
pivot_NullLiteralExp = Class(name="pivot_NullLiteralExp")
pivot_NumericLiteralExp = Class(name="pivot_NumericLiteralExp", is_abstract=True)
Feature = Class(name="Feature")
pivot_MorePivotable = Class(name="pivot_MorePivotable", is_abstract=True)
pivot_Nameable = Class(name="pivot_Nameable", is_abstract=True)
pivot_NamedElement = Class(name="pivot_NamedElement", is_abstract=True)
Nameable = Class(name="Nameable")
pivot_NavigationCallExp = Class(name="pivot_NavigationCallExp", is_abstract=True)
FeatureCallExp = Class(name="FeatureCallExp")
pivot_OperationCallExp = Class(name="pivot_OperationCallExp")
pivot_ProfileApplication = Class(name="pivot_ProfileApplication")
VariableDeclaration = Class(name="VariableDeclaration")
pivot_OppositePropertyCallExp = Class(name="pivot_OppositePropertyCallExp")
pivot_OrderedSetType = Class(name="pivot_OrderedSetType")
CompletePackage = Class(name="CompletePackage")
pivot_Pivotable = Class(name="pivot_Pivotable", is_abstract=True)
pivot_PrimitiveLiteralExp = Class(name="pivot_PrimitiveLiteralExp", is_abstract=True)
pivot_PrimitiveType = Class(name="pivot_PrimitiveType")
pivot_Profile = Class(name="pivot_Profile")
pivot_PropertyCallExp = Class(name="pivot_PropertyCallExp")
pivot_StateMachine = Class(name="pivot_StateMachine")
pivot_RealLiteralExp = Class(name="pivot_RealLiteralExp")
pivot_ReferringElement = Class(name="pivot_ReferringElement", is_abstract=True)
pivot_Region = Class(name="pivot_Region")
pivot_Vertex = Class(name="pivot_Vertex", is_abstract=True)
pivot_ShadowPart = Class(name="pivot_ShadowPart")
pivot_SelfType = Class(name="pivot_SelfType")
pivot_SequenceType = Class(name="pivot_SequenceType")
pivot_SetType = Class(name="pivot_SetType")
pivot_ShadowExp = Class(name="pivot_ShadowExp")
pivot_Trigger = Class(name="pivot_Trigger")
pivot_ValueSpecification = Class(name="pivot_ValueSpecification", is_abstract=True)
pivot_StateExp = Class(name="pivot_StateExp")
pivot_TemplateableElement = Class(name="pivot_TemplateableElement", is_abstract=True)
pivot_TemplateSignature = Class(name="pivot_TemplateSignature")
pivot_TemplateParameter = Class(name="pivot_TemplateParameter")
pivot_StringLiteralExp = Class(name="pivot_StringLiteralExp")
pivot_TemplateBinding = Class(name="pivot_TemplateBinding")
pivot_TemplateParameterSubstitution = Class(name="pivot_TemplateParameterSubstitution")
pivot_WildcardType = Class(name="pivot_WildcardType")
pivot_TupleLiteralExp = Class(name="pivot_TupleLiteralExp")
pivot_TupleLiteralPart = Class(name="pivot_TupleLiteralPart")
pivot_TupleType = Class(name="pivot_TupleType")
pivot_TypeExp = Class(name="pivot_TypeExp")
pivot_VariableDeclaration = Class(name="pivot_VariableDeclaration", is_abstract=True)
pivot_TypedElement = Class(name="pivot_TypedElement", is_abstract=True)
pivot_UnlimitedNaturalLiteralExp = Class(name="pivot_UnlimitedNaturalLiteralExp")
pivot_UnspecifiedValueExp = Class(name="pivot_UnspecifiedValueExp")
pivot_VariableExp = Class(name="pivot_VariableExp")
pivot_Visitable = Class(name="pivot_Visitable", is_abstract=True)
pivot_VoidType = Class(name="pivot_VoidType")
...
pivot_Element_m_getValue: Method = Method(name="getValue", parameters={Parameter(name='pivot_stereotype', type=StringType), Parameter(name='pivot_propertyName', type=StringType)}, type=Element)
...
pivot_Property_m_isAttribute: Method = Method(name="isAttribute", parameters={Parameter(name='pivot_p', type=StringType)}, type=StringType)
pivot_Property_m_validateCompatibleDefaultExpression: Method = Method(name="validateCompatibleDefaultExpression", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_Property.attributes={pivot_Property_isDerived, pivot_Property_isID, pivot_Property_isImplicit, pivot_Property_isReadOnly, pivot_Property_isTransient, pivot_Property_isUnsettable, pivot_Property_isComposite, pivot_Property_defaultValue, pivot_Property_isVolatile, pivot_Property_isResolveProxies, pivot_Property_defaultValueString}
pivot_Property.methods={pivot_Property_m_isAttribute, pivot_Property_m_validateCompatibleDefaultExpression}
...
pivot_BooleanLiteralExp_m_validateTypeIsBoolean: Method = Method(name="validateTypeIsBoolean", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_CallExp_m_validateTypeIsNotInvalid: Method = Method(name="validateTypeIsNotInvalid", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_Constraint_m_validateUniqueName: Method = Method(name="validateUniqueName", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_Package.attributes={pivot_Package_nsPrefix, pivot_Package_URI}

# pivot_CollectionItem class attributes and methods
pivot_CollectionItem_m_validateTypeIsItemType: Method = Method(name="validateTypeIsItemType", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_CollectionLiteralExp_m_validateBagKindIsBag: Method = Method(name="validateBagKindIsBag", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_CollectionLiteralExp_m_validateCollectionKindIsConcrete: Method = Method(name="validateCollectionKindIsConcrete", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_CollectionLiteralExp_m_validateOrderedSetKindIsOrderedSet: Method = Method(name="validateOrderedSetKindIsOrderedSet", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_CollectionLiteralExp_m_validateSequenceKindIsSequence: Method = Method(name="validateSequenceKindIsSequence", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_CollectionLiteralExp_m_validateSetKindIsSet: Method = Method(name="validateSetKindIsSet", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_CollectionLiteralExp.attributes={pivot_CollectionLiteralExp_kind}
pivot_CollectionLiteralExp.methods={pivot_CollectionLiteralExp_m_validateBagKindIsBag, pivot_CollectionLiteralExp_m_validateSetKindIsSet, pivot_CollectionLiteralExp_m_validateOrderedSetKindIsOrderedSet, pivot_CollectionLiteralExp_m_validateCollectionKindIsConcrete, pivot_CollectionLiteralExp_m_validateSequenceKindIsSequence}
...
pivot_Operation_m_validateCompatibleReturn: Method = Method(name="validateCompatibleReturn", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_Operation_m_validateLoadableImplementation: Method = Method(name="validateLoadableImplementation", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_Operation_m_validateUniquePostconditionName: Method = Method(name="validateUniquePostconditionName", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_Operation_m_validateUniquePreconditionName: Method = Method(name="validateUniquePreconditionName", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_Operation.attributes={pivot_Operation_isInvalidating, pivot_Operation_isTypeof, pivot_Operation_isValidating}
pivot_Operation.methods={pivot_Operation_m_validateUniquePreconditionName, pivot_Operation_m_validateUniquePostconditionName, pivot_Operation_m_validateLoadableImplementation, pivot_Operation_m_validateCompatibleReturn}
...
pivot_Class_m_validateUniqueInvariantName: Method = Method(name="validateUniqueInvariantName", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_Class.attributes={pivot_Class_instanceClassName, pivot_Class_isActive, pivot_Class_isAbstract, pivot_Class_isInterface}
...
pivot_CollectionLiteralPart_m_validateTypeIsNotInvalid: Method = Method(name="validateTypeIsNotInvalid", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_CompleteModel_m_getOwnedCompletePackage: Method = Method(name="getOwnedCompletePackage", parameters={Parameter(name='pivot_name', type=StringType)}, type=StringType)
...
pivot_Type_m_specializeIn: Method = Method(name="specializeIn", parameters={Parameter(name='pivot_expr', type=StringType), Parameter(name='pivot_selfType', type=StringType)}, type=Type)
pivot_Type.methods={pivot_Type_m_flattenedType, pivot_Type_m_isClass, pivot_Type_m_specializeIn, pivot_Type_m_isTemplateParameter}
...
pivot_CompletePackage_m_getOwnedCompleteClass: Method = Method(name="getOwnedCompleteClass", parameters={Parameter(name='pivot_name', type=StringType)}, type=StringType)
...
pivot_State.attributes={pivot_State_isSubmachineState, pivot_State_isComposite, pivot_State_isOrthogonal, pivot_State_isSimple}
...
pivot_LanguageExpression.attributes={pivot_LanguageExpression_body, pivot_LanguageExpression_language}
...
pivot_EnumLiteralExp_m_validateTypeIsEnumerationType: Method = Method(name="validateTypeIsEnumerationType", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_Feature_m_validateTypeIsNotInvalid: Method = Method(name="validateTypeIsNotInvalid", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_Variable_m_validateCompatibleInitialiserType: Method = Method(name="validateCompatibleInitialiserType", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_IfExp_m_validateConditionTypeIsBoolean: Method = Method(name="validateConditionTypeIsBoolean", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_IfExp_m_validateTypeIsNotInvalid: Method = Method(name="validateTypeIsNotInvalid", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_IntegerLiteralExp_m_validateTypeIsInteger: Method = Method(name="validateTypeIsInteger", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_IterateExp_m_validateOneInitializer: Method = Method(name="validateOneInitializer", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_IterateExp_m_validateSafeIteratorIsRequired: Method = Method(name="validateSafeIteratorIsRequired", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_IterateExp_m_validateSafeSourceCanBeNull: Method = Method(name="validateSafeSourceCanBeNull", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_IterateExp_m_validateTypeIsResultType: Method = Method(name="validateTypeIsResultType", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_IterateExp_m_validateBodyTypeConformsToResultType: Method = Method(name="validateBodyTypeConformsToResultType", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_IterateExp_m_validateUnsafeSourceCanNotBeNull: Method = Method(name="validateUnsafeSourceCanNotBeNull", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_IterateExp.methods={pivot_IterateExp_m_validateTypeIsResultType, pivot_IterateExp_m_validateOneInitializer, pivot_IterateExp_m_validateUnsafeSourceCanNotBeNull, pivot_IterateExp_m_validateSafeSourceCanBeNull, pivot_IterateExp_m_validateBodyTypeConformsToResultType, pivot_IterateExp_m_validateSafeIteratorIsRequired}
...
pivot_IteratorExp_m_validateAnyTypeIsSourceElementType: Method = Method(name="validateAnyTypeIsSourceElementType", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_IteratorExp_m_validateClosureBodyTypeIsConformanttoIteratorType: Method = Method(name="validateClosureBodyTypeIsConformanttoIteratorType", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_IteratorExp_m_validateClosureElementTypeIsSourceElementType: Method = Method(name="validateClosureElementTypeIsSourceElementType", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_IteratorExp_m_validateClosureHasOneIterator: Method = Method(name="validateClosureHasOneIterator", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_IteratorExp_m_validateAnyBodyTypeIsBoolean: Method = Method(name="validateAnyBodyTypeIsBoolean", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_IteratorExp_m_validateAnyHasOneIterator: Method = Method(name="validateAnyHasOneIterator", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_IteratorExp_m_validateSafeIteratorIsRequired: Method = Method(name="validateSafeIteratorIsRequired", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_IteratorExp_m_validateSafeSourceCanBeNull: Method = Method(name="validateSafeSourceCanBeNull", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_IteratorExp_m_validateSortedByElementTypeIsSourceElementType: Method = Method(name="validateSortedByElementTypeIsSourceElementType", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_IteratorExp_m_validateSortedByIsOrderedIfSourceIsOrdered: Method = Method(name="validateSortedByIsOrderedIfSourceIsOrdered", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_IteratorExp_m_validateSortedByIteratorTypeIsComparable: Method = Method(name="validateSortedByIteratorTypeIsComparable", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_IteratorExp_m_validateClosureSourceElementTypeIsBodyElementType: Method = Method(name="validateClosureSourceElementTypeIsBodyElementType", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_IteratorExp_m_validateClosureTypeIsUniqueCollection: Method = Method(name="validateClosureTypeIsUniqueCollection", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_IteratorExp_m_validateCollectElementTypeIsFlattenedBodyType: Method = Method(name="validateCollectElementTypeIsFlattenedBodyType", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_IteratorExp_m_validateCollectTypeIsUnordered: Method = Method(name="validateCollectTypeIsUnordered", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_IteratorExp_m_validateIteratorTypeIsSourceElementType: Method = Method(name="validateIteratorTypeIsSourceElementType", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_IteratorExp_m_validateUnsafeSourceCanNotBeNull: Method = Method(name="validateUnsafeSourceCanNotBeNull", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_IteratorExp.methods={pivot_IteratorExp_m_validateClosureHasOneIterator, pivot_IteratorExp_m_validateCollectElementTypeIsFlattenedBodyType, pivot_IteratorExp_m_validateAnyTypeIsSourceElementType, pivot_IteratorExp_m_validateCollectTypeIsUnordered, pivot_IteratorExp_m_validateIteratorTypeIsSourceElementType, pivot_IteratorExp_m_validateUnsafeSourceCanNotBeNull, pivot_IteratorExp_m_validateClosureBodyTypeIsConformanttoIteratorType, pivot_IteratorExp_m_validateClosureSourceElementTypeIsBodyElementType, pivot_IteratorExp_m_validateSortedByIsOrderedIfSourceIsOrdered, pivot_IteratorExp_m_validateAnyBodyTypeIsBoolean, pivot_IteratorExp_m_validateAnyHasOneIterator, pivot_IteratorExp_m_validateSafeSourceCanBeNull, pivot_IteratorExp_m_validateSafeIteratorIsRequired, pivot_IteratorExp_m_validateClosureElementTypeIsSourceElementType, pivot_IteratorExp_m_validateSortedByElementTypeIsSourceElementType, pivot_IteratorExp_m_validateClosureTypeIsUniqueCollection, pivot_IteratorExp_m_validateSortedByIteratorTypeIsComparable}
...
pivot_LoopExp_m_validateNoInitializers: Method = Method(name="validateNoInitializers", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_LoopExp_m_validateSourceIsCollection: Method = Method(name="validateSourceIsCollection", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_LetExp_m_validateTypeIsInType: Method = Method(name="validateTypeIsInType", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_LetExp_m_validateTypeIsNotInvalid: Method = Method(name="validateTypeIsNotInvalid", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_MessageExp_m_validateOneCallOrOneSend: Method = Method(name="validateOneCallOrOneSend", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_MessageExp_m_validateTargetIsNotACollection: Method = Method(name="validateTargetIsNotACollection", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_OperationCallExp_m_validateArgumentCount: Method = Method(name="validateArgumentCount", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_OperationCallExp_m_validateArgumentTypeIsConformant: Method = Method(name="validateArgumentTypeIsConformant", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_OperationCallExp_m_validateSafeSourceCanBeNull: Method = Method(name="validateSafeSourceCanBeNull", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_OperationCallExp.methods={pivot_OperationCallExp_m_validateArgumentCount, pivot_OperationCallExp_m_validateSafeSourceCanBeNull, pivot_OperationCallExp_m_validateArgumentTypeIsConformant}
...
pivot_PropertyCallExp_m_validateCompatibleResultType: Method = Method(name="validateCompatibleResultType", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_PropertyCallExp_m_validateNonStaticSourceTypeIsConformant: Method = Method(name="validateNonStaticSourceTypeIsConformant", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_PropertyCallExp_m_validateSafeSourceCanBeNull: Method = Method(name="validateSafeSourceCanBeNull", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_PropertyCallExp_m_validateUnsafeSourceCanNotBeNull: Method = Method(name="validateUnsafeSourceCanNotBeNull", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_PropertyCallExp.methods={pivot_PropertyCallExp_m_validateSafeSourceCanBeNull, pivot_PropertyCallExp_m_validateNonStaticSourceTypeIsConformant, pivot_PropertyCallExp_m_getSpecializedReferredPropertyOwningType, pivot_PropertyCallExp_m_getSpecializedReferredPropertyType, pivot_PropertyCallExp_m_validateCompatibleResultType, pivot_PropertyCallExp_m_validateUnsafeSourceCanNotBeNull}
...
pivot_ShadowPart_m_validateTypeIsNotInvalid: Method = Method(name="validateTypeIsNotInvalid", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_ShadowPart.methods={pivot_ShadowPart_m_validateTypeIsNotInvalid}

# pivot_SelfType class attributes and methods
pivot_SelfType_m_specializeIn: Method = Method(name="specializeIn", parameters={Parameter(name='pivot_selfType', type=StringType), Parameter(name='pivot_expr', type=StringType)}, type=Type)
...
pivot_ShadowExp_m_validateTypeIsNotInvalid: Method = Method(name="validateTypeIsNotInvalid", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_ValueSpecification.methods={pivot_ValueSpecification_m_booleanValue, pivot_ValueSpecification_m_unlimitedValue, pivot_ValueSpecification_m_isComputable, pivot_ValueSpecification_m_integerValue, pivot_ValueSpecification_m_stringValue, pivot_ValueSpecification_m_isNull}

# pivot_StateExp class attributes and methods
pivot_StateExp_m_validateTypeIsNotInvalid: Method = Method(name="validateTypeIsNotInvalid", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_VariableDeclaration_m_validateTypeIsNotInvalid: Method = Method(name="validateTypeIsNotInvalid", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_TypedElement_m_CompatibleBody: Method = Method(name="CompatibleBody", parameters={Parameter(name='pivot_bodySpecification', type=StringType)}, type=StringType)
...
pivot_VariableExp_m_validateTypeIsNotInvalid: Method = Method(name="validateTypeIsNotInvalid", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
extenders11: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="class_", type=pivot_StereotypeExtender, multiplicity=Multiplicity(0, 9999))
    }
)
...
class_344: BinaryAssociation = BinaryAssociation(
    name="class_344",
    ends={
...
# OCL Constraints
UniquePreconditionName: Constraint = Constraint(
    name="UniquePreconditionName",
    context=pivot_Operation,
    expression="context Operation inv: ownedPreconditions->isUnique(p | p?.name)",
    language="OCL"
)
UniquePostconditionName: Constraint = Constraint(
    name="UniquePostconditionName",
    context=pivot_Operation,
    expression="context Operation inv: ownedPostconditions->isUnique(p | p?.name)",
    language="OCL"
)
TypeIsNotInvalid: Constraint = Constraint(
    name="TypeIsNotInvalid",
    context=pivot_Feature,
    expression="context Feature inv: type <> OclInvalid",
    language="OCL"
)
TypeIsNotInvalid1: Constraint = Constraint(
    name="TypeIsNotInvalid1",
    context=pivot_VariableDeclaration,
    expression="context VariableDeclaration inv: type <> OclInvalid",
    language="OCL"
)
TypeIsNotInvalid2: Constraint = Constraint(
    name="TypeIsNotInvalid2",
    context=pivot_CollectionLiteralPart,
    expression="context CollectionLiteralPart inv: type <> OclInvalid",
    language="OCL"
)
TypeIsNotInvalid3: Constraint = Constraint(
    name="TypeIsNotInvalid3",
    context=pivot_ShadowPart,
    expression="context ShadowPart inv: type <> OclInvalid",
    language="OCL"
)
TypeIsNotInvalid4: Constraint = Constraint(
    name="TypeIsNotInvalid4",
    context=pivot_CallExp,
    expression="context CallExp inv: type <> OclInvalid",
    language="OCL"
)
TypeIsNotInvalid5: Constraint = Constraint(
    name="TypeIsNotInvalid5",
    context=pivot_IfExp,
    expression="context IfExp inv: type <> OclInvalid",
    language="OCL"
)
TypeIsNotInvalid6: Constraint = Constraint(
    name="TypeIsNotInvalid6",
    context=pivot_LetExp,
    expression="context LetExp inv: type <> OclInvalid",
    language="OCL"
)
TypeIsNotInvalid7: Constraint = Constraint(
    name="TypeIsNotInvalid7",
    context=pivot_ShadowExp,
    expression="context ShadowExp inv: type <> OclInvalid",
    language="OCL"
)
TypeIsNotInvalid8: Constraint = Constraint(
    name="TypeIsNotInvalid8",
    context=pivot_StateExp,
    expression="context StateExp inv: type <> OclInvalid",
    language="OCL"
)
TypeIsNotInvalid9: Constraint = Constraint(
    name="TypeIsNotInvalid9",
    context=pivot_VariableExp,
    expression="context VariableExp inv: type <> OclInvalid",
    language="OCL"
)
UniqueInvariantName: Constraint = Constraint(
    name="UniqueInvariantName",
    context=pivot_Class,
    expression="context Class inv: ownedInvariants->isUnique(p | p?.name)",
    language="OCL"
)
CompatibleInitialiserType: Constraint = Constraint(
    name="CompatibleInitialiserType",
    context=pivot_Variable,
    expression="context Variable inv: ownedInit <> null implies ownedInit?.type?.conformsTo(type)",
    language="OCL"
)
ClosureBodyTypeIsConformanttoIteratorType: Constraint = Constraint(
    name="ClosureBodyTypeIsConformanttoIteratorType",
    context=pivot_IteratorExp,
    expression="context IteratorExp inv: true",
    language="OCL"
)
SortedByIteratorTypeIsComparable: Constraint = Constraint(
    name="SortedByIteratorTypeIsComparable",
    context=pivot_IteratorExp,
    expression="context IteratorExp inv: true",
    language="OCL"
)
TypeIsReferredPropertyType: Constraint = Constraint(
    name="TypeIsReferredPropertyType",
    context=pivot_PropertyCallExp,
    expression="context PropertyCallExp inv: type = referredProperty.type",
    language="OCL"
)
TypeIsBoolean: Constraint = Constraint(
    name="TypeIsBoolean",
    context=pivot_BooleanLiteralExp,
    expression="context BooleanLiteralExp inv: self.type = Boolean",
    language="OCL"
)
CollectionKindIsConcrete: Constraint = Constraint(
    name="CollectionKindIsConcrete",
    context=pivot_CollectionLiteralExp,
    expression="context CollectionLiteralExp inv: kind <> CollectionKind_Collection",
    language="OCL"
)
SetKindIsSet: Constraint = Constraint(
    name="SetKindIsSet",
    context=pivot_CollectionLiteralExp,
    expression="context CollectionLiteralExp inv: kind = CollectionKind_Set implies type.oclIsKindOf(SetType)",
    language="OCL"
)
OrderedSetKindIsOrderedSet: Constraint = Constraint(
    name="OrderedSetKindIsOrderedSet",
    context=pivot_CollectionLiteralExp,
    expression="context CollectionLiteralExp inv: kind = CollectionKind_OrderedSet implies type.oclIsKindOf(OrderedSetType)",
    language="OCL"
)
SequenceKindIsSequence: Constraint = Constraint(
    name="SequenceKindIsSequence",
    context=pivot_CollectionLiteralExp,
    expression="context CollectionLiteralExp inv: kind = CollectionKind_Sequence implies type.oclIsKindOf(SequenceType)",
    language="OCL"
)
BagKindIsBag: Constraint = Constraint(
    name="BagKindIsBag",
    context=pivot_CollectionLiteralExp,
    expression="context CollectionLiteralExp inv: kind = CollectionKind_Bag implies type.oclIsKindOf(BagType)",
    language="OCL"
)
ElementTypeIsCommonElementType: Constraint = Constraint(
    name="ElementTypeIsCommonElementType",
    context=pivot_CollectionLiteralExp,
    expression="context CollectionLiteralExp inv: let elementType : Type = part->iterate (p; c : Classifier = OclVoid | c.commonSuperType (p.type))/* CollectionLiteralPartNo additional well-formedness rules. */",
    language="OCL"
)
TypeIsItemType: Constraint = Constraint(
    name="TypeIsItemType",
    context=pivot_CollectionItem,
    expression="context CollectionItem inv: type = ownedItem.type",
    language="OCL"
)
TypeIsCommonType: Constraint = Constraint(
    name="TypeIsCommonType",
    context=pivot_CollectionRange,
    expression="context CollectionRange inv: type = first.type.commonSuperType (last.type)",
    language="OCL"
)
TypeIsEnumerationType: Constraint = Constraint(
    name="TypeIsEnumerationType",
    context=pivot_EnumLiteralExp,
    expression="context EnumLiteralExp inv: self.type = referredLiteral?.owningEnumeration",
    language="OCL"
)
ConditionTypeIsBoolean: Constraint = Constraint(
    name="ConditionTypeIsBoolean",
    context=pivot_IfExp,
    expression="context IfExp inv: self.ownedCondition.type = Boolean/* The type of the if expression is the most common supertype of the else and then expressions. */",
    language="OCL"
)
TypeIsCommonType10: Constraint = Constraint(
    name="TypeIsCommonType10",
    context=pivot_IfExp,
    expression="context IfExp inv: self.type = thenExpression.type.commonSuperType(elseExpression.type)",
    language="OCL"
)
TypeIsInteger: Constraint = Constraint(
    name="TypeIsInteger",
    context=pivot_IntegerLiteralExp,
    expression="context IntegerLiteralExp inv: self.type = Integer",
    language="OCL"
)
AnyHasOneIterator: Constraint = Constraint(
    name="AnyHasOneIterator",
    context=pivot_IteratorExp,
    expression="context IteratorExp inv: name = 'any' implies ownedIterators->size() = 1",
    language="OCL"
)
AnyTypeIsSourceElementType: Constraint = Constraint(
    name="AnyTypeIsSourceElementType",
    context=pivot_IteratorExp,
    expression="context IteratorExp inv: name = 'any' implies type = ownedSource?.type?.oclAsType(CollectionType).elementType",
    language="OCL"
)
AnyBodyTypeIsBoolean: Constraint = Constraint(
    name="AnyBodyTypeIsBoolean",
    context=pivot_IteratorExp,
    expression="context IteratorExp inv: name = 'any' implies ownedBody.type = 'Boolean'",
    language="OCL"
)
ClosureHasOneIterator: Constraint = Constraint(
    name="ClosureHasOneIterator",
    context=pivot_IteratorExp,
    expression="context IteratorExp inv: name = 'closure' implies ownedIterators->size() = 1",
    language="OCL"
)
ClosureTypeIsUniqueCollection: Constraint = Constraint(
    name="ClosureTypeIsUniqueCollection",
    context=pivot_IteratorExp,
    expression="context IteratorExp inv: name = 'closure' impliesif ownedSource?.type?.oclIsKindOf(SequenceType) or ownedSource?.type.oclIsKindOf(OrderedSetType) thentype.oclIsKindOf(OrderedSetType)elsetype.oclIsKindOf(SetType)endif",
    language="OCL"
)
ClosureSourceElementTypeIsBodyElementType: Constraint = Constraint(
    name="ClosureSourceElementTypeIsBodyElementType",
    context=pivot_IteratorExp,
    expression="context IteratorExp inv: name = 'closure' impliesownedSource?.type.oclAsType(CollectionType).elementType =if ownedBody.type.oclIsKindOf(CollectionType)then ownedBody.type.oclAsType(CollectionType).elementTypeelse ownedBody.typeendif",
    language="OCL"
)
UniqueName: Constraint = Constraint(
    name="UniqueName",
    context=pivot_Constraint,
    expression="context Constraint inv: true -- _'context'.ownedRule->excluding(self)->forAll(name <> self.name or stereotype <> self.stereotype)",
    language="OCL"
)
has_owner: Constraint = Constraint(
    name="has_owner",
    context=pivot_Element,
    expression="context Element inv: /*** An element may not directly or indirectly own itself.*/",
    language="OCL"
)
DerivedIsInitialised: Constraint = Constraint(
    name="DerivedIsInitialised",
    context=pivot_Property,
    expression="context Property inv: isDerived implies ownedRule->one(stereotype = 'derivation') or ownedRule->one(stereotype = 'initial')",
    language="OCL"
)
CompatibleInitialiser: Constraint = Constraint(
    name="CompatibleInitialiser",
    context=pivot_Property,
    expression="context Property inv: isDerived implies defaultExpression <> null",
    language="OCL"
)
CompatibleDefaultExpression: Constraint = Constraint(
    name="CompatibleDefaultExpression",
    context=pivot_Property,
    expression="context Property inv: ownedExpression <> null and ownedExpression.oclAsType(ExpressionInOCL).ownedBody <> null implies CompatibleBody(ownedExpression)",
    language="OCL"
)
CompatibleReturn: Constraint = Constraint(
    name="CompatibleReturn",
    context=pivot_Operation,
    expression="context Operation inv: bodyExpression <> null and bodyExpression.oclAsType(ExpressionInOCL).ownedBody <> null implies CompatibleBody(bodyExpression)",
    language="OCL"
)
LoadableImplementation: Constraint = Constraint(
    name="LoadableImplementation",
    context=pivot_Operation,
    expression="context Operation inv: true",
    language="OCL"
)
Unnamed25: Constraint = Constraint(
    name="Unnamed25",
    context=pivot_CompleteModel,
    expression="context CompleteModel inv: name2rootCompletePackage.values = allRootPackages",
    language="OCL"
)
Unnamed26: Constraint = Constraint(
    name="Unnamed26",
    context=pivot_CompleteModel,
    expression="context CompleteModel inv: allRootPackageCompleteURIs->forAll(n | name2rootCompletePackage[n].partialPackages = allRootPackages->select(completeURI = n))",
    language="OCL"
)
Unnamed27: Constraint = Constraint(
    name="Unnamed27",
    context=pivot_CompletePackage,
    expression="context CompletePackage inv: name2nestedCompletePackage.keys = allNestedPackageNames",
    language="OCL"
)
Unnamed28: Constraint = Constraint(
    name="Unnamed28",
    context=pivot_CompletePackage,
    expression="context CompletePackage inv: name2nestedCompletePackage.values = allNestedPackages",
    language="OCL"
)
Unnamed29: Constraint = Constraint(
    name="Unnamed29",
    context=pivot_CompletePackage,
    expression="context CompletePackage inv: allNestedPackageNames->forAll(n | name2nestedCompletePackage[n].partialPackages = allNestedPackages->select(name = n))",
    language="OCL"
)
Unnamed33: Constraint = Constraint(
    name="Unnamed33",
    context=pivot_CompleteClass,
    expression="context CompleteClass inv: name2completeClass.keys = allClassNames",
    language="OCL"
)
Unnamed34: Constraint = Constraint(
    name="Unnamed34",
    context=pivot_CompleteClass,
    expression="context CompleteClass inv: name2completeClass.values = allClasses",
    language="OCL"
)
Unnamed35: Constraint = Constraint(
    name="Unnamed35",
    context=pivot_CompleteClass,
    expression="context CompleteClass inv: allClassNames->forAll(n | name2completeClass[n].partialClasses = allClasses->select(name = n))",
    language="OCL"
)
Unnamed36: Constraint = Constraint(
    name="Unnamed36",
    context=pivot_CompleteModel,
    expression="context CompleteModel inv: allClasses->forAll(c | class2completeClass[c].partialClasses->includes(c))",
    language="OCL"
)
Unnamed37: Constraint = Constraint(
    name="Unnamed37",
    context=pivot_CompleteModel,
    expression="context CompleteModel inv: allClasses->size() = class2completeClass.values.partialClasses->size()",
    language="OCL"
)
Unnamed38: Constraint = Constraint(
    name="Unnamed38",
    context=pivot_CompleteModel,
    expression="context CompleteModel inv: allClasses->size() = class2completeClass.values.partialClasses->asSet()->size()*/",
    language="OCL"
)
ClosureElementTypeIsSourceElementType: Constraint = Constraint(
    name="ClosureElementTypeIsSourceElementType",
    context=pivot_IteratorExp,
    expression="context IteratorExp inv: name = 'closure' impliestype.oclAsType(CollectionType).elementType= ownedSource?.type.oclAsType(CollectionType).elementType",
    language="OCL"
)
CollectTypeIsUnordered: Constraint = Constraint(
    name="CollectTypeIsUnordered",
    context=pivot_IteratorExp,
    expression="context IteratorExp inv: name = 'collect' impliesif ownedSource?.type.oclIsKindOf(SequenceType) or ownedSource?.type.oclIsKindOf(OrderedSetType) thentype.oclIsKindOf(SequenceType)elsetype.oclIsKindOf(BagType)endif",
    language="OCL"
)
CollectElementTypeIsFlattenedBodyType: Constraint = Constraint(
    name="CollectElementTypeIsFlattenedBodyType",
    context=pivot_IteratorExp,
    expression="context IteratorExp inv: name = 'collect' impliestype.oclAsType(CollectionType).elementType = ownedBody.type.flattenedType()",
    language="OCL"
)
SortedByIsOrderedIfSourceIsOrdered: Constraint = Constraint(
    name="SortedByIsOrderedIfSourceIsOrdered",
    context=pivot_IteratorExp,
    expression="context IteratorExp inv: name = 'sortedBy' impliesif ownedSource?.type.oclIsKindOf(SequenceType) or ownedSource?.type.oclIsKindOf(BagType) thentype.oclIsKindOf(SequenceType)elsetype.oclIsKindOf(OrderedSetType)endif",
    language="OCL"
)
SortedByElementTypeIsSourceElementType: Constraint = Constraint(
    name="SortedByElementTypeIsSourceElementType",
    context=pivot_IteratorExp,
    expression="context IteratorExp inv: name = 'sortedBy' impliestype.oclAsType(CollectionType).elementType =ownedBody.type.oclAsType(CollectionType).elementType",
    language="OCL"
)
TypeIsResultType: Constraint = Constraint(
    name="TypeIsResultType",
    context=pivot_IterateExp,
    expression="context IterateExp inv: type = ownedResult?.type",
    language="OCL"
)
BodyTypeConformsToResultType: Constraint = Constraint(
    name="BodyTypeConformsToResultType",
    context=pivot_IterateExp,
    expression="context IterateExp inv: ownedBody.type.conformsTo(ownedResult?.type)",
    language="OCL"
)
OneInitializer: Constraint = Constraint(
    name="OneInitializer",
    context=pivot_IterateExp,
    expression="context IterateExp inv: self.ownedResult?.ownedInit->size() = 1/*------------- unescaped in */",
    language="OCL"
)
TypeIsInType: Constraint = Constraint(
    name="TypeIsInType",
    context=pivot_LetExp,
    expression="context LetExp inv: type = ownedIn.type/** LiteralExpNo additional well-formedness rules. */",
    language="OCL"
)
SourceIsCollection: Constraint = Constraint(
    name="SourceIsCollection",
    context=pivot_LoopExp,
    expression="context LoopExp inv: ownedSource?.type.oclIsKindOf(CollectionType)",
    language="OCL"
)
NoInitializers: Constraint = Constraint(
    name="NoInitializers",
    context=pivot_LoopExp,
    expression="context LoopExp inv: self.ownedIterators->forAll(p | p?.ownedInit->isEmpty())",
    language="OCL"
)
IteratorTypeIsSourceElementType: Constraint = Constraint(
    name="IteratorTypeIsSourceElementType",
    context=pivot_IteratorExp,
    expression="context IteratorExp inv: self.ownedIterators->forAll(p | ownedSource?.type.oclAsType(CollectionType).elementType.conformsTo(p?.type))/** Safe navigation is not necessary when the source collection is null-free. */",
    language="OCL"
)
SafeSourceCanBeNull: Constraint = Constraint(
    name="SafeSourceCanBeNull",
    context=pivot_IteratorExp,
    expression="context IteratorExp inv: isSafe implies not ownedSource?.type.oclAsType(CollectionType).isNullFree/** Safe navigation is not necessary when an iterator can be null. */",
    language="OCL"
)
SafeIteratorIsRequired: Constraint = Constraint(
    name="SafeIteratorIsRequired",
    context=pivot_IteratorExp,
    expression="context IteratorExp inv: isSafe implies ownedIterators?->forAll(isRequired)/** Safe navigation is necessary when an iterator cannot be null and the source collection is not null-free. */",
    language="OCL"
)
UnsafeSourceCanNotBeNull: Constraint = Constraint(
    name="UnsafeSourceCanNotBeNull",
    context=pivot_IteratorExp,
    expression="context IteratorExp inv: (not isSafe and ownedIterators?->exists(isRequired)) implies ownedSource?.type.oclAsType(CollectionType).isNullFree",
    language="OCL"
)
SafeSourceCanBeNull11: Constraint = Constraint(
    name="SafeSourceCanBeNull11",
    context=pivot_IterateExp,
    expression="context IterateExp inv: isSafe implies not ownedSource?.type.oclAsType(CollectionType).isNullFree/** Safe navigation is not necessary when an iterator can be null. */",
    language="OCL"
)
SafeIteratorIsRequired12: Constraint = Constraint(
    name="SafeIteratorIsRequired12",
    context=pivot_IterateExp,
    expression="context IterateExp inv: isSafe implies ownedIterators?->forAll(isRequired)/** Safe navigation is necessary when an iterator cannot be null and the source collection is not null-free. */",
    language="OCL"
)
UnsafeSourceCanNotBeNull13: Constraint = Constraint(
    name="UnsafeSourceCanNotBeNull13",
    context=pivot_IterateExp,
    expression="context IterateExp inv: (not isSafe and ownedIterators?->exists(isRequired)) implies ownedSource?.type.oclAsType(CollectionType).isNullFree/** FeatureCallExpNo additional well-formedness rules. *//** NumericLiteralExpNo additional well-formedness rules. *//** OCLExpressionNo additional well-formedness rules. */",
    language="OCL"
)
Unnamed: Constraint = Constraint(
    name="Unnamed",
    context=pivot_MessageExp,
    expression="context MessageExp inv: calledOperation->notEmpty() implies",
    language="OCL"
)
Unnamed14: Constraint = Constraint(
    name="Unnamed14",
    context=pivot_MessageExp,
    expression="context MessageExp inv: sentSignal->notEmpty() implies",
    language="OCL"
)
Unnamed15: Constraint = Constraint(
    name="Unnamed15",
    context=pivot_MessageExp,
    expression="context MessageExp inv: calledOperation->notEmpty() implies",
    language="OCL"
)
OneCallOrOneSend: Constraint = Constraint(
    name="OneCallOrOneSend",
    context=pivot_MessageExp,
    expression="context MessageExp inv: ownedCalledOperation->size() + ownedSentSignal->size() = 1",
    language="OCL"
)
TargetIsNotACollection: Constraint = Constraint(
    name="TargetIsNotACollection",
    context=pivot_MessageExp,
    expression="context MessageExp inv: not ownedTarget.type.oclIsKindOf(CollectionType)/*------------- spelling: arguments */",
    language="OCL"
)
ArgumentTypeIsConformant: Constraint = Constraint(
    name="ArgumentTypeIsConformant",
    context=pivot_OperationCallExp,
    expression="context OperationCallExp inv: let operation : Operation = self.referredOperation inlet parameters : OrderedSet(Parameter) = operation?.ownedParameters inlet selfType : Type = operation?.owningClass inSequence{1..ownedArguments->size()}->forAll (i |let argument : OCLExpression = ownedArguments->at(i) inlet parameter : Parameter = parameters->at(i) inlet parameterType : Type = parameter?.type inlet requiredType : Type = if parameter?.isTypeof then Class else parameterType.specializeIn(self, selfType) endif inargument?.type.conformsTo(requiredType))/*------------- spelling: arguments */",
    language="OCL"
)
ArgumentCount: Constraint = Constraint(
    name="ArgumentCount",
    context=pivot_OperationCallExp,
    expression="context OperationCallExp inv: ownedArguments->size() = referredOperation?.ownedParameters->size()/** Safe navigation is not necessary when the source cannot be null. */",
    language="OCL"
)
SafeSourceCanBeNull16: Constraint = Constraint(
    name="SafeSourceCanBeNull16",
    context=pivot_OperationCallExp,
    expression="context OperationCallExp inv: (ownedSource <> null) and isSafe implies not ownedSource?.isRequired/** Safe navigation is necessary when the source could be null. -- unless infix with an OclVoid overload */",
    language="OCL"
)
UnsafeSourceCanNotBeNull17: Constraint = Constraint(
    name="UnsafeSourceCanNotBeNull17",
    context=pivot_OperationCallExp,
    expression="context OperationCallExp inv: (ownedSource <> null) and not isSafe implies ownedSource?.isRequired",
    language="OCL"
)
StaticSourceIsNull: Constraint = Constraint(
    name="StaticSourceIsNull",
    context=pivot_OperationCallExp,
    expression="context OperationCallExp inv: referredOperation.isStatic implies source = null",
    language="OCL"
)
NonStaticSourceIsConformant: Constraint = Constraint(
    name="NonStaticSourceIsConformant",
    context=pivot_OperationCallExp,
    expression="context OperationCallExp inv: let operation : Operation = self.referredOperation in",
    language="OCL"
)
NonStaticSourceTypeIsConformant: Constraint = Constraint(
    name="NonStaticSourceTypeIsConformant",
    context=pivot_PropertyCallExp,
    expression="context PropertyCallExp inv: not referredProperty?.isStatic impliesownedSource?.type.conformsTo(getSpecializedReferredPropertyOwningType())/** The type of the call expression is the type of the referred property. */",
    language="OCL"
)
CompatibleResultType: Constraint = Constraint(
    name="CompatibleResultType",
    context=pivot_PropertyCallExp,
    expression="context PropertyCallExp inv: type = getSpecializedReferredPropertyType()/** Safe navigation is not necessary when the source cannot be null. */",
    language="OCL"
)
SafeSourceCanBeNull18: Constraint = Constraint(
    name="SafeSourceCanBeNull18",
    context=pivot_PropertyCallExp,
    expression="context PropertyCallExp inv: (ownedSource <> null) and isSafe implies not ownedSource?.isRequired/** Safe navigation is necessary when the source could be null. */",
    language="OCL"
)
UnsafeSourceCanNotBeNull19: Constraint = Constraint(
    name="UnsafeSourceCanNotBeNull19",
    context=pivot_PropertyCallExp,
    expression="context PropertyCallExp inv: (ownedSource <> null) and not isSafe implies ownedSource?.isRequired",
    language="OCL"
)
StaticSourceIsNull20: Constraint = Constraint(
    name="StaticSourceIsNull20",
    context=pivot_PropertyCallExp,
    expression="context PropertyCallExp inv: referredProperty.isStatic implies source.oclAsType(Type).conformsTo(getSpecializedReferredPropertyOwningType())",
    language="OCL"
)
Unnamed21: Constraint = Constraint(
    name="Unnamed21",
    context=pivot_CompleteModel,
    expression="context CompleteModel inv: packageURI2completeURI.keys = allRootPackageURIs",
    language="OCL"
)
Unnamed22: Constraint = Constraint(
    name="Unnamed22",
    context=pivot_CompleteModel,
    expression="context CompleteModel inv: completeURI2packageURIs.keys->forAll(c | completeURI2packageURIs[c]->forAll(p | packageURI2completeURI[p] = c))",
    language="OCL"
)
Unnamed23: Constraint = Constraint(
    name="Unnamed23",
    context=pivot_CompleteModel,
    expression="context CompleteModel inv: packageURI2completeURI.keys->forAll(p | completeURI2packageURIs[packageURI2completeURI[p]]->includes(p))",
    language="OCL"
)
Unnamed24: Constraint = Constraint(
    name="Unnamed24",
    context=pivot_CompleteModel,
    expression="context CompleteModel inv: name2rootCompletePackage.keys = allRootPackageURIs",
    language="OCL"
)
...
domain_model = DomainModel(
    name="pivot",
    types={pivot_Element, pivot_Detail, pivot_AnyType, Class_, pivot_AssociationClass, pivot_Property, pivot_Annotation, NamedElement, pivot_BooleanLiteralExp, PrimitiveLiteralExp, pivot_CallExp, OCLExpression, pivot_AssociationClassCallExp, NavigationCallExp, pivot_BagType, CollectionType, pivot_Behavior, pivot_Transition, pivot_Constraint, pivot_Package, pivot_CollectionItem, CollectionLiteralPart, pivot_CollectionLiteralExp, LiteralExp, pivot_OCLExpression, pivot_CallOperationAction, pivot_Operation, pivot_Class, Type, Namespace, TemplateableElement, pivot_StereotypeExtender, pivot_CollectionLiteralPart, TypedElement, pivot_CollectionRange, pivot_CompleteModel, pivot_StandardLibrary, pivot_OrphanCompletePackage, pivot_Model, pivot_PrimitiveCompletePackage, pivot_CollectionType, DataType, pivot_Type, pivot_Comment, Element, pivot_CompleteClass, pivot_CompletePackage, pivot_CompleteEnvironment, pivot_State, pivot_ConnectionPointReference, Vertex, pivot_Pseudostate, pivot_Namespace, pivot_LanguageExpression, pivot_DynamicBehavior, Behavior, DynamicType, pivot_DynamicElement, pivot_DynamicProperty, pivot_DataType, pivot_DynamicType, DynamicElement, pivot_DynamicValueSpecification, ValueSpecification, Visitable, pivot_EnumLiteralExp, pivot_EnumerationLiteral, pivot_Enumeration, pivot_ElementExtension, pivot_Stereotype, pivot_Feature, InstanceSpecification, pivot_ExpressionInOCL, LanguageExpression, pivot_Variable, pivot_Import, pivot_InstanceSpecification, pivot_Slot, pivot_FeatureCallExp, CallExp, pivot_FinalState, State, pivot_IfExp, pivot_IntegerLiteralExp, NumericLiteralExp, pivot_InvalidLiteralExp, pivot_InvalidType, pivot_IterateExp, LoopExp, ReferringElement, pivot_Iteration, Operation, pivot_Parameter, pivot_IteratorExp, pivot_LambdaType, pivot_Precedence, pivot_LiteralExp, pivot_LoopExp, pivot_LetExp, pivot_Library, Package, pivot_SendSignalAction, pivot_MessageType, pivot_Signal, pivot_MapLiteralExp, pivot_MapLiteralPart, pivot_MapType, pivot_MessageExp, pivot_NullLiteralExp, pivot_NumericLiteralExp, Feature, pivot_MorePivotable, pivot_Nameable, pivot_NamedElement, Nameable, pivot_NavigationCallExp, FeatureCallExp, pivot_OperationCallExp, pivot_ProfileApplication, VariableDeclaration, pivot_OppositePropertyCallExp, pivot_OrderedSetType, CompletePackage, pivot_Pivotable, pivot_PrimitiveLiteralExp, pivot_PrimitiveType, pivot_Profile, pivot_PropertyCallExp, pivot_StateMachine, pivot_RealLiteralExp, pivot_ReferringElement, pivot_Region, pivot_Vertex, pivot_ShadowPart, pivot_SelfType, pivot_SequenceType, pivot_SetType, pivot_ShadowExp, pivot_Trigger, pivot_ValueSpecification, pivot_StateExp, pivot_TemplateableElement, pivot_TemplateSignature, pivot_TemplateParameter, pivot_StringLiteralExp, pivot_TemplateBinding, pivot_TemplateParameterSubstitution, pivot_WildcardType, pivot_TupleLiteralExp, pivot_TupleLiteralPart, pivot_TupleType, pivot_TypeExp, pivot_VariableDeclaration, pivot_TypedElement, pivot_UnlimitedNaturalLiteralExp, pivot_UnspecifiedValueExp, pivot_VariableExp, pivot_Visitable, pivot_VoidType, AssociativityKind, CollectionKind, PseudostateKind, TransitionKind},
    associations={ownedContents0, ownedDetails1, references3, unownedAttributes6, referredAssociationClass7, owningTransition8, ownedBehaviors12, ownedInvariants13, ownedOperations15, ownedProperties16, owningPackage19, superClasses21, ownedItem23, ownedSource9, operation10, extenders11, ownedParts25, ownedFirst26, ownedCompleteModel38, ownedStandardLibrary39, orphanCompletePackage41, ownedCompletePackages42, owningCompleteEnvironment44, partialModels45, primitiveCompletePackage47, ownedCompleteClasses49, ownedLast28, elementType31, annotatedElements32, owningElement33, owningCompletePackage35, partialClasses36, owningState65, ownedCompletePackages51, owningCompleteModel54, owningCompletePackage57, partialPackages60, entries61, exits62, ownedSpecification71, owningPostContext72, owningPreContext74, owningState76, constrainedElements66, context69, metaType85, referredProperty87, owningTransition78, redefinedConstraints81, behavioralClass83, ownedDynamicProperties88, annotatingComments90, ownedAnnotations92, stereotype99, referredLiteral100, ownedLiterals101, ownedComments94, ownedExtensions96, base97, ownedResult110, owningEnumeration102, ownedBody103, ownedContext105, ownedParameters107, ownedElse115, ownedThen118, importedNamespace121, classes123, ownedSlots125, ownedCondition113, ownedSpecification126, owningPackage128, ownedResult130, ownedAccumulators132, ownedIterators133, contextType136, parameterType138, resultType141, ownedPrecedences150, ownedBody151, owningConstraint144, ownedIn145, ownedVariable147, ownedArguments171, ownedCalledOperation173, ownedSentSignal176, ownedTarget178, referredOperation181, referredSignal183, ownedIterators153, ownedImports185, referredIteration156, ownedPackages188, ownedParts159, ownedKey160, ownedValue163, keyType166, valueType168, typeValue199, bodyExpression202, ownedConstraints191, navigationSource194, qualifiers196, precedence211, raisedExceptions214, redefinedOperations218, ownedParameters205, ownedPostconditions206, ownedPreconditions208, owningClass210, ownedClasses230, ownedInstances232, ownedPackages235, ownedProfileApplications238, owningPackage241, owningOperation243, ownedArguments220, referredOperation222, referredProperty225, importedPackages228, appliedProfile249, owningPackage250, associationClass252, coercions245, profileApplications247, ownedExpression259, owningClass262, redefinedProperties265, referredProperty268, subsettedProperty271, keys254, opposite257, owningState275, owningStateMachine277, extendedRegion280, ownedSubvertexes281, ownedTransitions282, referredProperty273, ownedParts293, ownedInit294, referredProperty297, definingProperty300, owningState285, owningStateMachine287, signal290, ownedConnectionPoints308, ownedConnections309, ownedDeferrableTriggers311, ownedDoActivity313, ownedEntry315, ownedExit318, ownedValues302, owningInstance304, owningCompleteEnvironment306, referredState331, extendedStateMachines334, ownedConnectionPoints335, ownedRegions337, submachineStates340, ownedRegions321, ownedStateInvariant323, redefinedState327, submachines329, owningElement348, templateSignature349, constrainingClasses350, owningSignature352, actual354, ownedExtenders342, class_344, owningStereotype346, ownedSubstitutions347, ownedBindings365, ownedSignature368, unspecializedElement372, ownedEffect373, ownedGuard374, formal356, ownedWildcard359, owningBinding361, ownedParameters362, owningElement363, owningTransition388, ownedParts390, ownedInit391, referredType394, ownedTriggers377, owningRegion380, source382, target384, owningState386, ownedInit398, representedParameter401, type396, referredVariable406, typeValue404, upperBound417, incomingTransitions408, outgoingTransitions410, owningRegion412, lowerBound414},
    constraints={UniquePreconditionName, UniquePostconditionName, TypeIsNotInvalid, TypeIsNotInvalid1, TypeIsNotInvalid2, TypeIsNotInvalid3, TypeIsNotInvalid4, TypeIsNotInvalid5, TypeIsNotInvalid6, TypeIsNotInvalid7, TypeIsNotInvalid8, TypeIsNotInvalid9, UniqueInvariantName, CompatibleInitialiserType, ClosureBodyTypeIsConformanttoIteratorType, SortedByIteratorTypeIsComparable, TypeIsReferredPropertyType, TypeIsBoolean, CollectionKindIsConcrete, SetKindIsSet, OrderedSetKindIsOrderedSet, SequenceKindIsSequence, BagKindIsBag, ElementTypeIsCommonElementType, TypeIsItemType, TypeIsCommonType, TypeIsEnumerationType, ConditionTypeIsBoolean, TypeIsCommonType10, TypeIsInteger, AnyHasOneIterator, AnyTypeIsSourceElementType, AnyBodyTypeIsBoolean, ClosureHasOneIterator, ClosureTypeIsUniqueCollection, ClosureSourceElementTypeIsBodyElementType, UniqueName, has_owner, DerivedIsInitialised, CompatibleInitialiser, CompatibleDefaultExpression, CompatibleReturn, LoadableImplementation, Unnamed25, Unnamed26, Unnamed27, Unnamed28, Unnamed29,    Unnamed33, Unnamed34, Unnamed35, Unnamed36, Unnamed37, Unnamed38, ClosureElementTypeIsSourceElementType, CollectTypeIsUnordered, CollectElementTypeIsFlattenedBodyType, SortedByIsOrderedIfSourceIsOrdered, SortedByElementTypeIsSourceElementType, TypeIsResultType, BodyTypeConformsToResultType, OneInitializer, TypeIsInType, SourceIsCollection, NoInitializers, IteratorTypeIsSourceElementType, SafeSourceCanBeNull, SafeIteratorIsRequired, UnsafeSourceCanNotBeNull, SafeSourceCanBeNull11, SafeIteratorIsRequired12, UnsafeSourceCanNotBeNull13, Unnamed, Unnamed14, Unnamed15, OneCallOrOneSend, TargetIsNotACollection, ArgumentTypeIsConformant, ArgumentCount, SafeSourceCanBeNull16, UnsafeSourceCanNotBeNull17, StaticSourceIsNull, NonStaticSourceIsConformant, NonStaticSourceTypeIsConformant, CompatibleResultType, SafeSourceCanBeNull18, UnsafeSourceCanNotBeNull19, StaticSourceIsNull20, Unnamed21, Unnamed22, Unnamed23, Unnamed24},
    generalizations={gen_pivot_Annotation_NamedElement, gen_pivot_AnyType_Class, gen_pivot_AssociationClass_Class, gen_pivot_BooleanLiteralExp_PrimitiveLiteralExp, gen_pivot_CallExp_OCLExpression, gen_pivot_AssociationClassCallExp_NavigationCallExp, gen_pivot_BagType_CollectionType, gen_pivot_Behavior_Class, gen_pivot_CollectionItem_CollectionLiteralPart, gen_pivot_CollectionLiteralExp_LiteralExp, gen_pivot_CallOperationAction_NamedElement, gen_pivot_Class_Type, gen_pivot_Class_Namespace, gen_pivot_Class_TemplateableElement, gen_pivot_CollectionLiteralPart_TypedElement, gen_pivot_CollectionRange_CollectionLiteralPart, gen_pivot_CompleteModel_NamedElement, gen_pivot_CompletePackage_NamedElement, gen_pivot_CollectionType_DataType, gen_pivot_Comment_Element, gen_pivot_CompleteClass_NamedElement, gen_pivot_CompleteEnvironment_Element, gen_pivot_Constraint_NamedElement, gen_pivot_ConnectionPointReference_Vertex, gen_pivot_DynamicBehavior_Behavior, gen_pivot_DynamicBehavior_DynamicType, gen_pivot_DynamicElement_Element, gen_pivot_DynamicProperty_Element, gen_pivot_DataType_Class, gen_pivot_Detail_NamedElement, gen_pivot_DynamicType_Class, gen_pivot_DynamicType_DynamicElement, gen_pivot_DynamicValueSpecification_ValueSpecification, gen_pivot_Element_Visitable, gen_pivot_EnumLiteralExp_LiteralExp, gen_pivot_Enumeration_DataType, gen_pivot_ElementExtension_Class, gen_pivot_Feature_TypedElement, gen_pivot_EnumerationLiteral_InstanceSpecification, gen_pivot_ExpressionInOCL_LanguageExpression, gen_pivot_Import_NamedElement, gen_pivot_InstanceSpecification_NamedElement, gen_pivot_FeatureCallExp_CallExp, gen_pivot_FinalState_State, gen_pivot_IfExp_OCLExpression, gen_pivot_IntegerLiteralExp_NumericLiteralExp, gen_pivot_InvalidLiteralExp_LiteralExp, gen_pivot_InvalidType_Class, gen_pivot_IterateExp_LoopExp, gen_pivot_IterateExp_ReferringElement, gen_pivot_Iteration_Operation, gen_pivot_IteratorExp_LoopExp, gen_pivot_IteratorExp_ReferringElement, gen_pivot_LambdaType_DataType, gen_pivot_LanguageExpression_ValueSpecification, gen_pivot_Library_Package, gen_pivot_LiteralExp_OCLExpression, gen_pivot_LoopExp_CallExp, gen_pivot_LetExp_OCLExpression, gen_pivot_MessageType_Class, gen_pivot_Model_Namespace, gen_pivot_MapLiteralExp_LiteralExp, gen_pivot_MapLiteralPart_Element, gen_pivot_MapType_DataType, gen_pivot_MessageExp_OCLExpression, gen_pivot_NullLiteralExp_PrimitiveLiteralExp, gen_pivot_NumericLiteralExp_PrimitiveLiteralExp, gen_pivot_OCLExpression_TypedElement, gen_pivot_Operation_Feature, gen_pivot_Operation_Namespace, gen_pivot_Operation_TemplateableElement, gen_pivot_NamedElement_Element, gen_pivot_NamedElement_Nameable, gen_pivot_Namespace_NamedElement, gen_pivot_NavigationCallExp_FeatureCallExp, gen_pivot_OperationCallExp_FeatureCallExp, gen_pivot_OperationCallExp_ReferringElement, gen_pivot_Parameter_VariableDeclaration, gen_pivot_OppositePropertyCallExp_NavigationCallExp, gen_pivot_OrderedSetType_CollectionType, gen_pivot_OrphanCompletePackage_CompletePackage, gen_pivot_Package_Namespace, gen_pivot_Property_Feature, gen_pivot_Precedence_NamedElement, gen_pivot_PrimitiveCompletePackage_CompletePackage, gen_pivot_PrimitiveLiteralExp_LiteralExp, gen_pivot_PrimitiveType_DataType, gen_pivot_Profile_Package, gen_pivot_ProfileApplication_Element, gen_pivot_PropertyCallExp_NavigationCallExp, gen_pivot_PropertyCallExp_ReferringElement, gen_pivot_RealLiteralExp_NumericLiteralExp, gen_pivot_Region_Namespace, gen_pivot_Pseudostate_Vertex, gen_pivot_ShadowPart_TypedElement, gen_pivot_Signal_Class, gen_pivot_Slot_Element, gen_pivot_SelfType_Class, gen_pivot_SendSignalAction_NamedElement, gen_pivot_SequenceType_CollectionType, gen_pivot_SetType_CollectionType, gen_pivot_ShadowExp_OCLExpression, gen_pivot_StandardLibrary_Element, gen_pivot_State_Namespace, gen_pivot_State_Vertex, gen_pivot_StateMachine_Behavior, gen_pivot_Stereotype_Class, gen_pivot_StateExp_OCLExpression, gen_pivot_TemplateParameter_Type, gen_pivot_TemplateParameterSubstitution_Element, gen_pivot_StereotypeExtender_Element, gen_pivot_StringLiteralExp_PrimitiveLiteralExp, gen_pivot_TemplateBinding_Element, gen_pivot_TemplateableElement_Element, gen_pivot_Transition_Namespace, gen_pivot_TemplateSignature_Element, gen_pivot_TupleLiteralExp_LiteralExp, gen_pivot_TupleLiteralPart_VariableDeclaration, gen_pivot_TupleType_DataType, gen_pivot_Type_NamedElement, gen_pivot_TypeExp_OCLExpression, gen_pivot_TypeExp_ReferringElement, gen_pivot_Trigger_NamedElement, gen_pivot_Variable_VariableDeclaration, gen_pivot_VariableDeclaration_TypedElement, gen_pivot_TypedElement_NamedElement, gen_pivot_UnlimitedNaturalLiteralExp_NumericLiteralExp, gen_pivot_UnspecifiedValueExp_OCLExpression, gen_pivot_ValueSpecification_TypedElement, gen_pivot_VariableExp_ReferringElement, gen_pivot_Vertex_NamedElement, gen_pivot_VariableExp_OCLExpression, gen_pivot_VoidType_Class, gen_pivot_WildcardType_Class},
    metadata=None
)
