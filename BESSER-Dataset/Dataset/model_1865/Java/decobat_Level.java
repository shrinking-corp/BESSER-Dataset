...
public class decobat_Level  {
    ...
    public decobat_Level(
        String description,        String code,        String name,        String shortDescription    ) {
    ...
    public decobat_Level(
        String description,        String code,        String name,        String shortDescription        ArrayList<decobat_Library> decobat_librarys    ) {
        this.description = description;
        this.code = code;
        this.name = name;
        this.shortDescription = shortDescription;
