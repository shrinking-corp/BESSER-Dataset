...
class graph_ElkShape(ElkGraphElement):
    ...
    def setDimensions(self, graph_width, graph_height):
        # TODO: Implement setDimensions method
        pass

    def setLocation(self, graph_y, graph_x):
...
class graph_ElkNode(ElkConnectableShape):
    ...
    def __init__(self, hierarchical: bool, parent7: set["graph_ElkPort"] = None, containingNode: set["graph_ElkEdge"] = None, ElkNode17: "graph_ElkPort" = None, ElkNode19: "graph_ElkEdge" = None, ElkNode: "graph_ElkNode" = None, parent10: set["graph_ElkNode"] = None, ElkNode13: "graph_ElkNode" = None, children: "graph_ElkNode" = None):
...
class graph_ElkEdge(ElkGraphElement):
    ...
    def __init__(self, hyperedge: bool, hierarchical: bool, selfloop: bool, connected: bool, ElkEdge: "graph_ElkConnectableShape" = None, ElkEdge5: "graph_ElkConnectableShape" = None, ElkEdge15: "graph_ElkNode" = None, containedEdges: "graph_ElkNode" = None, outgoingEdges: set["graph_ElkConnectableShape"] = None, incomingEdges: set["graph_ElkConnectableShape"] = None, parent24: set["graph_ElkEdgeSection"] = None, ElkEdge27: "graph_ElkEdgeSection" = None):
...
class graph_ElkEdgeSection(EMapPropertyHolder):
    ...
    def __init__(self, startX: float, startY: float, endX: float, endY: float, identifier: str, incomingSections: set["graph_ElkEdgeSection"] = None, ElkEdgeSection38: "graph_ElkEdgeSection" = None, outgoingSections: set["graph_ElkEdgeSection"] = None, ElkEdgeSection: "graph_ElkEdge" = None, graph_ElkEdgeSection: set["graph_ElkBendPoint"] = None, sections: "graph_ElkEdge" = None, graph_ElkEdgeSection29: "graph_ElkConnectableShape" = None, graph_ElkEdgeSection31: "graph_ElkConnectableShape" = None, ElkEdgeSection35: "graph_ElkEdgeSection" = None):
        self.startX = startX
        self.startY = startY
        self.endX = endX
        self.endY = endY
    ...
    def setStartLocation(self, graph_x, graph_y):
        # TODO: Implement setStartLocation method
        pass

    def setEndLocation(self, graph_y, graph_x):
...
class graph_ElkPropertyToValueMapEntry:
    ...
    def __init__(self, key: str, value: str, graph_ElkPropertyToValueMapEntry: "graph_EMapPropertyHolder" = None):
        self.key = key
        self.value = value
...
class graph_IPropertyHolder(ABC):
    ...
    def __init__(self):
        ...
        pass
    def setProperty(self, graph_property, graph_value) :
        # TODO: Implement setProperty method
        pass

    def hasProperty(self, graph_property) :
        # TODO: Implement hasProperty method
        pass

    def getProperty(self, graph_property):
    ...
    def copyProperties(self, graph_source) :
