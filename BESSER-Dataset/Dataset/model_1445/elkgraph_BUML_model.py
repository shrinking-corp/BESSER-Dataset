...
# Classes
graph_IPropertyHolder = Class(name="graph_IPropertyHolder", is_abstract=True)
graph_EMapPropertyHolder = Class(name="graph_EMapPropertyHolder", is_abstract=True)
IPropertyHolder = Class(name="IPropertyHolder")
graph_ElkPropertyToValueMapEntry = Class(name="graph_ElkPropertyToValueMapEntry")
graph_ElkGraphElement = Class(name="graph_ElkGraphElement", is_abstract=True)
EMapPropertyHolder = Class(name="EMapPropertyHolder")
graph_ElkLabel = Class(name="graph_ElkLabel")
ElkShape = Class(name="ElkShape")
graph_ElkConnectableShape = Class(name="graph_ElkConnectableShape", is_abstract=True)
graph_ElkEdge = Class(name="graph_ElkEdge")
graph_ElkNode = Class(name="graph_ElkNode")
ElkConnectableShape = Class(name="ElkConnectableShape")
graph_ElkPort = Class(name="graph_ElkPort")
graph_ElkShape = Class(name="graph_ElkShape", is_abstract=True)
ElkGraphElement = Class(name="ElkGraphElement")
graph_ElkEdgeSection = Class(name="graph_ElkEdgeSection")
graph_ElkBendPoint = Class(name="graph_ElkBendPoint")

# graph_IPropertyHolder class attributes and methods
graph_IPropertyHolder_m_setProperty: Method = Method(name="setProperty", parameters={Parameter(name='graph_property', type=StringType), Parameter(name='graph_value', type=StringType)}, type=StringType)
graph_IPropertyHolder_m_getProperty: Method = Method(name="getProperty", parameters={Parameter(name='graph_property', type=StringType)})
graph_IPropertyHolder_m_hasProperty: Method = Method(name="hasProperty", parameters={Parameter(name='graph_property', type=StringType)}, type=BooleanType)
graph_IPropertyHolder_m_copyProperties: Method = Method(name="copyProperties", parameters={Parameter(name='graph_source', type=StringType)}, type=StringType)
graph_IPropertyHolder_m_getAllProperties: Method = Method(name="getAllProperties", parameters={})
graph_IPropertyHolder.methods={graph_IPropertyHolder_m_getProperty, graph_IPropertyHolder_m_copyProperties, graph_IPropertyHolder_m_getAllProperties, graph_IPropertyHolder_m_hasProperty, graph_IPropertyHolder_m_setProperty}
...
graph_ElkEdge.attributes={graph_ElkEdge_selfloop, graph_ElkEdge_hierarchical, graph_ElkEdge_hyperedge, graph_ElkEdge_connected}
...
graph_ElkShape_m_setLocation: Method = Method(name="setLocation", parameters={Parameter(name='graph_x', type=StringType), Parameter(name='graph_y', type=StringType)})
graph_ElkShape_m_setDimensions: Method = Method(name="setDimensions", parameters={Parameter(name='graph_width', type=StringType), Parameter(name='graph_height', type=StringType)})
graph_ElkShape.attributes={graph_ElkShape_width, graph_ElkShape_x, graph_ElkShape_height, graph_ElkShape_y}
graph_ElkShape.methods={graph_ElkShape_m_setDimensions, graph_ElkShape_m_setLocation}
...
graph_ElkEdgeSection_m_setStartLocation: Method = Method(name="setStartLocation", parameters={Parameter(name='graph_y', type=StringType), Parameter(name='graph_x', type=StringType)})
graph_ElkEdgeSection_m_setEndLocation: Method = Method(name="setEndLocation", parameters={Parameter(name='graph_y', type=StringType), Parameter(name='graph_x', type=StringType)})
graph_ElkEdgeSection.attributes={graph_ElkEdgeSection_identifier, graph_ElkEdgeSection_endY, graph_ElkEdgeSection_startY, graph_ElkEdgeSection_endX, graph_ElkEdgeSection_startX}
graph_ElkEdgeSection.methods={graph_ElkEdgeSection_m_setEndLocation, graph_ElkEdgeSection_m_setStartLocation}
...
graph_ElkBendPoint_m_set: Method = Method(name="set", parameters={Parameter(name='graph_y', type=StringType), Parameter(name='graph_x', type=StringType)})
graph_ElkBendPoint.attributes={graph_ElkBendPoint_x, graph_ElkBendPoint_y}
...
domain_model = DomainModel(
    name="graph",
    types={graph_IPropertyHolder, graph_EMapPropertyHolder, IPropertyHolder, graph_ElkPropertyToValueMapEntry, graph_ElkGraphElement, EMapPropertyHolder, graph_ElkLabel, ElkShape, graph_ElkConnectableShape, graph_ElkEdge, graph_ElkNode, ElkConnectableShape, graph_ElkPort, graph_ElkShape, ElkGraphElement, graph_ElkEdgeSection, graph_ElkBendPoint},
    associations={properties0, labels1, parent2, outgoingEdges3, incomingEdges4, ports6, containedEdges14, parent16, containingNode18, sources20, targets21, sections23, children9, parent12, bendPoints25, parent26, outgoingShape28, incomingShape30, outgoingSections34, incomingSections37},
    generalizations={gen_graph_EMapPropertyHolder_IPropertyHolder, gen_graph_ElkGraphElement_EMapPropertyHolder, gen_graph_ElkLabel_ElkShape, gen_graph_ElkConnectableShape_ElkShape, gen_graph_ElkNode_ElkConnectableShape, gen_graph_ElkShape_ElkGraphElement, gen_graph_ElkPort_ElkConnectableShape, gen_graph_ElkEdge_ElkGraphElement, gen_graph_ElkEdgeSection_EMapPropertyHolder},
    metadata=None
)
