...
class tracker_Animal(ABC):
    ...
    def __init__(self, sexCode: str, birthDate: str, sex: str, species: str, idNumber: str, breed: str, age: str, speciesCode: str, tracker_Animal: "tracker_AnimalId" = None, tracker_Animal13: "tracker_Animals" = None):
