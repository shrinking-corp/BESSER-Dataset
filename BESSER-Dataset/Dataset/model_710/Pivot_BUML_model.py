...
pivot_Property.attributes={pivot_Property_implicit, pivot_Property_isResolveProxies, pivot_Property_isUnsettable, pivot_Property_isID, pivot_Property_isTransient, pivot_Property_default, pivot_Property_isDerived, pivot_Property_isReadOnly, pivot_Property_isComposite, pivot_Property_isVolatile}
...
pivot_Operation_m_LoadableImplementation: Method = Method(name="LoadableImplementation", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_Operation_m_UniquePostconditionName: Method = Method(name="UniquePostconditionName", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_CollectionLiteralExp_m_CollectionKindIsConcrete: Method = Method(name="CollectionKindIsConcrete", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_CollectionLiteralExp.methods={pivot_CollectionLiteralExp_m_OrderedSetKindIsOrderedSet, pivot_CollectionLiteralExp_m_SetKindIsSet, pivot_CollectionLiteralExp_m_BagKindIsBag, pivot_CollectionLiteralExp_m_CollectionKindIsConcrete, pivot_CollectionLiteralExp_m_SequenceKindIsSequence}
...
pivot_OpaqueExpression.attributes={pivot_OpaqueExpression_body, pivot_OpaqueExpression_message, pivot_OpaqueExpression_language}
...
pivot_IteratorExp_m_CollectNestedTypeIsBag: Method = Method(name="CollectNestedTypeIsBag", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_IteratorExp_m_OneHasOneIterator: Method = Method(name="OneHasOneIterator", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_IteratorExp_m_SortedByHasOneIterator: Method = Method(name="SortedByHasOneIterator", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_IteratorExp_m_RejectOrSelectHasOneIterator: Method = Method(name="RejectOrSelectHasOneIterator", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_IteratorExp_m_ClosureElementTypeIsSourceElementType: Method = Method(name="ClosureElementTypeIsSourceElementType", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_IteratorExp.methods={pivot_IteratorExp_m_RejectOrSelectTypeIsBoolean, pivot_IteratorExp_m_SortedByHasOneIterator, pivot_IteratorExp_m_IsUniqueTypeIsBoolean, pivot_IteratorExp_m_AnyTypeIsSourceElementType, pivot_IteratorExp_m_ClosureSourceElementTypeIsBodyElementType, pivot_IteratorExp_m_OneHasOneIterator, pivot_IteratorExp_m_ForAllBodyTypeIsBoolean, pivot_IteratorExp_m_IteratorTypeIsSourceElementType, pivot_IteratorExp_m_AnyBodyTypeIsBoolean, pivot_IteratorExp_m_CollectElementTypeIsSourceElementType, pivot_IteratorExp_m_CollectNestedHasOneIterator, pivot_IteratorExp_m_OneTypeIsBoolean, pivot_IteratorExp_m_SortedByIsOrderedIfSourceIsOrdered, pivot_IteratorExp_m_ClosureTypeIsUniqueCollection, pivot_IteratorExp_m_CollectNestedTypeIsBodyType, pivot_IteratorExp_m_RejectOrSelectHasOneIterator, pivot_IteratorExp_m_CollectHasOneIterator, pivot_IteratorExp_m_SortedByElementTypeIsSourceElementType, pivot_IteratorExp_m_RejectOrSelectTypeIsSourceType, pivot_IteratorExp_m_IsUniqueHasOneIterator, pivot_IteratorExp_m_CollectTypeIsUnordered, pivot_IteratorExp_m_CollectNestedTypeIsBag, pivot_IteratorExp_m_ClosureElementTypeIsSourceElementType, pivot_IteratorExp_m_AnyHasOneIterator, pivot_IteratorExp_m_ExistsTypeIsBoolean, pivot_IteratorExp_m_ClosureBodyTypeIsConformanttoIteratorType, pivot_IteratorExp_m_ClosureHasOneIterator, pivot_IteratorExp_m_ExistsBodyTypeIsBoolean, pivot_IteratorExp_m_SortedByIteratorTypeIsComparable, pivot_IteratorExp_m_ForAllTypeIsBoolean, pivot_IteratorExp_m_OneBodyTypeIsBoolean}
...
pivot_PropertyCallExp.methods={pivot_PropertyCallExp_m_CompatibleResultType, pivot_PropertyCallExp_m_getSpecializedReferredPropertyType, pivot_PropertyCallExp_m_NonStaticSourceTypeIsConformant, pivot_PropertyCallExp_m_getSpecializedReferredPropertyOwningType}
...
pivot_ValueSpecification.methods={pivot_ValueSpecification_m_unlimitedValue, pivot_ValueSpecification_m_isNull, pivot_ValueSpecification_m_isComputable, pivot_ValueSpecification_m_stringValue, pivot_ValueSpecification_m_booleanValue, pivot_ValueSpecification_m_integerValue}
...
in_95: BinaryAssociation = BinaryAssociation(
    name="in_95",
    ends={
...
class_155: BinaryAssociation = BinaryAssociation(
    name="class_155",
    ends={
...
class_176: BinaryAssociation = BinaryAssociation(
    name="class_176",
    ends={
...
domain_model = DomainModel(
    name="pivot",
    types={pivot_Detail, pivot_AnyType, Class_, pivot_AssociationClass, pivot_Property, pivot_AssociationClassCallExp, NavigationCallExp, pivot_BagType, CollectionType, pivot_Behavior, pivot_BooleanLiteralExp, PrimitiveLiteralExp, pivot_Annotation, NamedElement, pivot_Element, pivot_CollectionItem, CollectionLiteralPart, pivot_CallExp, OCLExpression, pivot_OCLExpression, pivot_CallOperationAction, pivot_Operation, pivot_Class, Type, Namespace, pivot_CollectionLiteralPart, TypedElement, pivot_CollectionRange, pivot_CollectionType, DataType, pivot_Type, pivot_CollectionLiteralExp, LiteralExp, pivot_OpaqueExpression, pivot_Namespace, pivot_ConstructorExp, pivot_ConstructorPart, pivot_Comment, Element, pivot_ConnectionPointReference, Vertex, pivot_Pseudostate, pivot_State, pivot_Constraint, pivot_DynamicType, DynamicElement, Visitable, pivot_DataType, pivot_DynamicElement, pivot_DynamicProperty, pivot_ExpressionInOCL, OpaqueExpression, pivot_ElementExtension, pivot_EnumLiteralExp, pivot_EnumerationLiteral, pivot_Enumeration, pivot_Import, pivot_IntegerLiteralExp, NumericLiteralExp, pivot_InvalidLiteralExp, pivot_InvalidType, pivot_IterateExp, LoopExp, pivot_Variable, ReferringElement, pivot_Feature, TypedMultiplicityElement, pivot_FeatureCallExp, CallExp, pivot_FinalState, State, pivot_IfExp, pivot_Iteration, Operation, pivot_Parameter, pivot_IteratorExp, pivot_Library, Package, pivot_Precedence, pivot_LiteralExp, pivot_LoopExp, pivot_LambdaType, pivot_LetExp, pivot_Signal, pivot_Metaclass, pivot_MorePivotable, pivot_Nameable, pivot_NamedElement, Nameable, pivot_MessageExp, pivot_SendSignalAction, pivot_MessageType, pivot_NavigationCallExp, FeatureCallExp, pivot_NullLiteralExp, pivot_NumericLiteralExp, ValueSpecification, Feature, TemplateableElement, ParameterableElement, pivot_OperationCallExp, pivot_OperationTemplateParameter, TemplateParameter, pivot_PackageableElement, VariableDeclaration, pivot_ParameterableElement, pivot_TemplateParameter, pivot_OrderedSetType, pivot_Package, pivot_Pivotable, pivot_PrimitiveLiteralExp, pivot_PrimitiveType, pivot_Profile, pivot_StateMachine, pivot_RealLiteralExp, pivot_PropertyCallExp, pivot_SelfType, pivot_SequenceType, pivot_SetType, pivot_ReferringElement, pivot_Region, pivot_Transition, pivot_Vertex, pivot_Root, pivot_Stereotype, pivot_StringLiteralExp, pivot_TemplateBinding, pivot_TemplateSignature, pivot_TemplateParameterSubstitution, pivot_TemplateableElement, pivot_Trigger, pivot_StateExp, Behavior, pivot_TemplateParameterType, pivot_TupleLiteralPart, pivot_TupleType, pivot_TupleLiteralExp, pivot_TypeExp, pivot_TypeTemplateParameter, pivot_UnspecifiedValueExp, pivot_ValueSpecification, pivot_TypedElement, pivot_TypedMultiplicityElement, pivot_UnlimitedNaturalLiteralExp, pivot_UnspecifiedType, pivot_Visitable, pivot_Visitor, pivot_VoidType, pivot_VariableDeclaration, pivot_VariableExp, AssociativityKind, CollectionKind, PseudostateKind, TransitionKind},
    associations={ownedDetail1, reference3, unownedAttribute6, referredAssociationClass7, ownedContent0, ownedBehavior10, item11, source8, operation9, part13, first14, last16, elementType19, constrainedElement28, specification30, context32, annotatedElement20, entry22, state23, exit25, referredProperty44, ownedProperty46, ownedComment48, part34, referredProperty35, initExpression37, behavioralType40, metaType42, ownedLiteral56, enumeration57, bodyExpression58, extension51, stereotype52, base54, referredEnumLiteral55, elseExpression76, importedNamespace79, contextVariable60, resultVariable62, parameterVariable65, messageExpression68, condition71, thenExpression73, result81, ownedIterator83, ownedAccumulator84, variable97, ownedPrecedence100, body101, iterator103, referredIteration106, contextType87, parameterType89, resultType92, in_95, referredSignal119, referredOperation120, instanceType123, ownedAnnotation125, target109, argument111, calledOperation114, sentSignal117, ownedRule127, qualifier130, navigationSource132, class_155, argument158, referredOperation160, raisedException135, ownedParameter138, owningType139, precondition140, postcondition143, bodyExpression146, precedence149, redefinedOperation153, operation172, owningTemplateParameter173, templateParameter174, nestedPackage164, nestingPackage166, importedPackage169, ownedType170, class_176, opposite180, association182, defaultExpression183, referredProperty200, stateMachine202, state204, keys187, redefinedProperty190, subsettedProperty193, referredProperty196, owningType198, nestedPackage218, imports220, signal223, transition207, stateMachine208, state210, extendedRegion214, subvertex216, stateInvariant236, entry239, exit242, doActivity245, submachine226, connection227, redefinedState231, region233, signature265, parameterSubstitution266, boundElement267, connectionPoint248, deferrableTrigger251, referredState253, region255, connectionPoint258, submachineState261, extendedStateMachine263, formal278, actual280, ownedActual283, templateBinding286, signature269, parameteredElement271, ownedParameteredElement272, default274, ownedDefault275, templateBinding294, ownedTemplateSignature296, unspecializedElement299, parameter287, ownedParameter290, template292, part313, initExpression314, source300, target302, guard304, effect306, trigger309, container312, referredType330, constrainingType332, package317, ownedAttribute319, ownedOperation321, superClass325, ownedInvariant327, upperBound338, type334, initExpression341, lowerBound336, outgoing350, incoming352, representedParameter344, referredVariable347, container348},
    generalizations={gen_pivot_AnyType_Class, gen_pivot_AssociationClass_Class, gen_pivot_AssociationClassCallExp_NavigationCallExp, gen_pivot_BagType_CollectionType, gen_pivot_Behavior_Class, gen_pivot_BooleanLiteralExp_PrimitiveLiteralExp, gen_pivot_Annotation_NamedElement, gen_pivot_CollectionItem_CollectionLiteralPart, gen_pivot_CallExp_OCLExpression, gen_pivot_CallOperationAction_NamedElement, gen_pivot_Class_Type, gen_pivot_Class_Namespace, gen_pivot_CollectionLiteralPart_TypedElement, gen_pivot_CollectionRange_CollectionLiteralPart, gen_pivot_CollectionType_DataType, gen_pivot_CollectionLiteralExp_LiteralExp, gen_pivot_ConstructorExp_OCLExpression, gen_pivot_Comment_Element, gen_pivot_ConnectionPointReference_Vertex, gen_pivot_Constraint_NamedElement, gen_pivot_DynamicType_Type, gen_pivot_DynamicType_DynamicElement, gen_pivot_Element_Visitable, gen_pivot_ConstructorPart_TypedElement, gen_pivot_DataType_Class, gen_pivot_Detail_NamedElement, gen_pivot_DynamicElement_Element, gen_pivot_DynamicProperty_Element, gen_pivot_EnumerationLiteral_NamedElement, gen_pivot_ExpressionInOCL_OpaqueExpression, gen_pivot_ElementExtension_Type, gen_pivot_EnumLiteralExp_LiteralExp, gen_pivot_Enumeration_DataType, gen_pivot_Import_NamedElement, gen_pivot_IntegerLiteralExp_NumericLiteralExp, gen_pivot_InvalidLiteralExp_LiteralExp, gen_pivot_InvalidType_Class, gen_pivot_IterateExp_LoopExp, gen_pivot_IterateExp_ReferringElement, gen_pivot_Feature_TypedMultiplicityElement, gen_pivot_FeatureCallExp_CallExp, gen_pivot_FinalState_State, gen_pivot_IfExp_OCLExpression, gen_pivot_Iteration_Operation, gen_pivot_IteratorExp_LoopExp, gen_pivot_IteratorExp_ReferringElement, gen_pivot_Library_Package, gen_pivot_LiteralExp_OCLExpression, gen_pivot_LoopExp_CallExp, gen_pivot_LambdaType_DataType, gen_pivot_LetExp_OCLExpression, gen_pivot_Metaclass_Class, gen_pivot_NamedElement_Element, gen_pivot_NamedElement_Nameable, gen_pivot_MessageExp_OCLExpression, gen_pivot_MessageType_Type, gen_pivot_Namespace_NamedElement, gen_pivot_NavigationCallExp_FeatureCallExp, gen_pivot_NullLiteralExp_PrimitiveLiteralExp, gen_pivot_NumericLiteralExp_PrimitiveLiteralExp, gen_pivot_OCLExpression_TypedElement, gen_pivot_OpaqueExpression_ValueSpecification, gen_pivot_Operation_Feature, gen_pivot_Operation_Namespace, gen_pivot_Operation_TemplateableElement, gen_pivot_Operation_ParameterableElement, gen_pivot_OperationCallExp_FeatureCallExp, gen_pivot_OperationCallExp_ReferringElement, gen_pivot_OperationTemplateParameter_TemplateParameter, gen_pivot_PackageableElement_ParameterableElement, gen_pivot_Parameter_TypedMultiplicityElement, gen_pivot_Parameter_VariableDeclaration, gen_pivot_ParameterableElement_Element, gen_pivot_OrderedSetType_CollectionType, gen_pivot_Package_Namespace, gen_pivot_Package_TemplateableElement, gen_pivot_Precedence_NamedElement, gen_pivot_PrimitiveLiteralExp_LiteralExp, gen_pivot_PrimitiveType_DataType, gen_pivot_Profile_Package, gen_pivot_Property_Feature, gen_pivot_Property_ParameterableElement, gen_pivot_Pseudostate_Vertex, gen_pivot_RealLiteralExp_NumericLiteralExp, gen_pivot_PropertyCallExp_NavigationCallExp, gen_pivot_PropertyCallExp_ReferringElement, gen_pivot_SelfType_Class, gen_pivot_SendSignalAction_NamedElement, gen_pivot_SequenceType_CollectionType, gen_pivot_SetType_CollectionType, gen_pivot_Signal_NamedElement, gen_pivot_State_Vertex, gen_pivot_State_Namespace, gen_pivot_Region_Namespace, gen_pivot_Root_Namespace, gen_pivot_Stereotype_Class, gen_pivot_StringLiteralExp_PrimitiveLiteralExp, gen_pivot_TemplateBinding_Element, gen_pivot_TemplateParameter_Element, gen_pivot_StateExp_OCLExpression, gen_pivot_StateMachine_Behavior, gen_pivot_TemplateParameterSubstitution_Element, gen_pivot_TemplateParameterType_Type, gen_pivot_Transition_Namespace, gen_pivot_TemplateSignature_Element, gen_pivot_TemplateableElement_Element, gen_pivot_TupleLiteralPart_VariableDeclaration, gen_pivot_TupleType_DataType, gen_pivot_Type_NamedElement, gen_pivot_Type_TemplateableElement, gen_pivot_Type_ParameterableElement, gen_pivot_Trigger_NamedElement, gen_pivot_TupleLiteralExp_LiteralExp, gen_pivot_TypeExp_OCLExpression, gen_pivot_TypeExp_ReferringElement, gen_pivot_TypeTemplateParameter_TemplateParameter, gen_pivot_UnspecifiedValueExp_OCLExpression, gen_pivot_ValueSpecification_TypedElement, gen_pivot_ValueSpecification_ParameterableElement, gen_pivot_TypedElement_NamedElement, gen_pivot_Variable_VariableDeclaration, gen_pivot_TypedMultiplicityElement_TypedElement, gen_pivot_UnlimitedNaturalLiteralExp_NumericLiteralExp, gen_pivot_UnspecifiedType_Class, gen_pivot_VoidType_Class, gen_pivot_VariableDeclaration_TypedElement, gen_pivot_VariableExp_OCLExpression, gen_pivot_VariableExp_ReferringElement, gen_pivot_Vertex_NamedElement},
    metadata=None
)
