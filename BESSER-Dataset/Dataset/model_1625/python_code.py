...
class petrinetv2_Transition:
    ...
    def __init__(self, name: str, petrinetv2_Transition7: set["petrinetv2_Place"] = None, petrinetv2_Transition: "petrinetv2_Net" = None, petrinetv2_Transition4: set["petrinetv2_Place"] = None):
        self.name = name
...
class petrinetv2_Place:
    ...
    def __init__(self, name: str, initialTokens: int, petrinetv2_Place: "petrinetv2_Net" = None, petrinetv2_Place8: "petrinetv2_Transition" = None, petrinetv2_Place10: set["petrinetv2_Token"] = None, petrinetv2_Place5: "petrinetv2_Transition" = None):
        self.name = name
