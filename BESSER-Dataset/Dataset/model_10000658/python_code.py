...
class Librarian:
    ...
    def __init__(self, fname: str, lname: str, gender: str, dob: str, address: str, cont_no: int, member_id: int, member_pwd: str, books8: set["Books"] = None, fine10: set["Fine"] = None, member15: set["Member"] = None):
        self.fname = fname
        self.lname = lname
        self.gender = gender
        self.dob = dob
...
class Member:
    ...
    def __init__(self, member_id: int, member_pwd: str, fname: str, lname: str, gender: str, dob: str, address: str, cont_no: int, borrowed3: set["Borrowed"] = None, reserved7: set["Reserved"] = None, fine13: set["Fine"] = None, librarian14: set["Librarian"] = None):
        self.member_id = member_id
        self.member_pwd = member_pwd
        self.fname = fname
        self.lname = lname
...
class Books:
    ...
    def __init__(self, book_id: int, title: str, author_name: str, ISBN_no: str, publisher: str, book_qty: int, borrowed0: set["Borrowed"] = None, reserved4: set["Reserved"] = None, librarian9: set["Librarian"] = None):
        self.book_id = book_id
        self.title = title
