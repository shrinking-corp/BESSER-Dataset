...
# Classes
componentBasedSystem_ComponentBasedSystem = Class(name="componentBasedSystem_ComponentBasedSystem")
componentBasedSystem_Allocation = Class(name="componentBasedSystem_Allocation")
componentBasedSystem_Repository = Class(name="componentBasedSystem_Repository")
componentBasedSystem_Environment = Class(name="componentBasedSystem_Environment")
ProvidedRole = Class(name="ProvidedRole")
RequiredRole = Class(name="RequiredRole")
componentBasedSystem_Component = Class(name="componentBasedSystem_Component")
BehaviourDescription = Class(name="BehaviourDescription")
componentBasedSystem_Service = Class(name="componentBasedSystem_Service")
componentBasedSystem_Interface = Class(name="componentBasedSystem_Interface")
componentBasedSystem_AssemblyContext = Class(name="componentBasedSystem_AssemblyContext")
Type = Class(name="Type")
AssemblyConnector = Class(name="AssemblyConnector")
componentBasedSystem_DelegationConnector = Class(name="componentBasedSystem_DelegationConnector")
componentBasedSystem_Container = Class(name="componentBasedSystem_Container")
componentBasedSystem_Link = Class(name="componentBasedSystem_Link")
componentBasedSystem_Parameter = Class(name="componentBasedSystem_Parameter")
ReturnType = Class(name="ReturnType")
ParameterType = Class(name="ParameterType")
componentBasedSystem_AllocationContext = Class(name="componentBasedSystem_AllocationContext")
componentBasedSystem_Signature = Class(name="componentBasedSystem_Signature")
componentBasedSystem_CompositeComponent = Class(name="componentBasedSystem_CompositeComponent")
Component = Class(name="Component")
componentBasedSystem_dataTypes_Simple = Class(name="componentBasedSystem_dataTypes_Simple")
dataTypes_ParameterType = Class(name="dataTypes_ParameterType")
dataTypes_ReturnType = Class(name="dataTypes_ReturnType")
componentBasedSystem_dataTypes_Complex = Class(name="componentBasedSystem_dataTypes_Complex")
Simple = Class(name="Simple")
componentBasedSystem_dataTypes_ParameterType = Class(name="componentBasedSystem_dataTypes_ParameterType")
componentBasedSystem_dataTypes_Void = Class(name="componentBasedSystem_dataTypes_Void")
componentBasedSystem_dataTypes_ReturnType = Class(name="componentBasedSystem_dataTypes_ReturnType")
Role = Class(name="Role")
componentBasedSystem_behaviourDescription_DescriptionElement = Class(name="componentBasedSystem_behaviourDescription_DescriptionElement")
componentBasedSystem_behaviourDescription_InternalAction = Class(name="componentBasedSystem_behaviourDescription_InternalAction")
DescriptionElement = Class(name="DescriptionElement")
componentBasedSystem_behaviourDescription_ExternalCall = Class(name="componentBasedSystem_behaviourDescription_ExternalCall")
componentBasedSystem_behaviourDescription_Loop = Class(name="componentBasedSystem_behaviourDescription_Loop")
componentBasedSystem_behaviourDescription_Branch = Class(name="componentBasedSystem_behaviourDescription_Branch")
componentBasedSystem_behaviourDescription_BehaviourDescription = Class(name="componentBasedSystem_behaviourDescription_BehaviourDescription")
componentBasedSystem_roles_Role = Class(name="componentBasedSystem_roles_Role")
roles_componentBasedSystem_Interface = Class(name="roles_componentBasedSystem_Interface")
componentBasedSystem_roles_RequiredRole = Class(name="componentBasedSystem_roles_RequiredRole")
componentBasedSystem_roles_ProvidedRole = Class(name="componentBasedSystem_roles_ProvidedRole")
componentBasedSystem_roles_AssemblyConnector = Class(name="componentBasedSystem_roles_AssemblyConnector")
roles_componentBasedSystem_AssemblyContext = Class(name="roles_componentBasedSystem_AssemblyContext")
componentBasedSystem_dataTypes_Type = Class(name="componentBasedSystem_dataTypes_Type")

# componentBasedSystem_ComponentBasedSystem class attributes and methods
componentBasedSystem_ComponentBasedSystem_m_GetContainerOfContext: Method = Method(name="GetContainerOfContext", parameters={Parameter(name='componentBasedSystem_context', type=StringType)}, type=StringType)
...
componentBasedSystem_Environment_m_IsLinked: Method = Method(name="IsLinked", parameters={Parameter(name='componentBasedSystem_c1', type=StringType), Parameter(name='componentBasedSystem_c2', type=StringType)}, type=BooleanType)
...
domain_model = DomainModel(
    ...
    types={componentBasedSystem_ComponentBasedSystem, componentBasedSystem_Allocation, componentBasedSystem_Repository, componentBasedSystem_Environment, ProvidedRole, RequiredRole, componentBasedSystem_Component, BehaviourDescription, componentBasedSystem_Service, componentBasedSystem_Interface, componentBasedSystem_AssemblyContext, Type, AssemblyConnector, componentBasedSystem_DelegationConnector, componentBasedSystem_Container, componentBasedSystem_Link, componentBasedSystem_Parameter, ReturnType, ParameterType, componentBasedSystem_AllocationContext, componentBasedSystem_Signature, componentBasedSystem_CompositeComponent, Component, componentBasedSystem_dataTypes_Simple, dataTypes_ParameterType, dataTypes_ReturnType, componentBasedSystem_dataTypes_Complex, Simple, componentBasedSystem_dataTypes_ParameterType, componentBasedSystem_dataTypes_Void, componentBasedSystem_dataTypes_ReturnType, Role, componentBasedSystem_behaviourDescription_DescriptionElement, componentBasedSystem_behaviourDescription_InternalAction, DescriptionElement, componentBasedSystem_behaviourDescription_ExternalCall, componentBasedSystem_behaviourDescription_Loop, componentBasedSystem_behaviourDescription_Branch, componentBasedSystem_behaviourDescription_BehaviourDescription, componentBasedSystem_roles_Role, roles_componentBasedSystem_Interface, componentBasedSystem_roles_RequiredRole, componentBasedSystem_roles_ProvidedRole, componentBasedSystem_roles_AssemblyConnector, roles_componentBasedSystem_AssemblyContext, componentBasedSystem_dataTypes_Type, simpleTypes},
    associations={allocation5, repository7, environment9, providedrole11, requiredrole13, behaviourdescription15, service16, requiredrole18, providedrole21, assemblycontext0, type1, assemblyconnector3, delegationconnector27, container29, parameter30, returntype32, parametertype34, component36, container39, assemblycontext41, signature24, assemblycontext25, container46, link49, interface52, component55, allocationcontext58, correspondingSignatures61, simple64, role44, descriptionelement65, descriptionelement66, descriptionelement68, interface70, providedrole71, requiredrole73, providedAssemblyContext76, requiredAssemblyContext78},
    generalizations={gen_componentBasedSystem_CompositeComponent_Component, gen_componentBasedSystem_dataTypes_Simple_dataTypes_ParameterType, gen_componentBasedSystem_dataTypes_Simple_dataTypes_ReturnType, gen_componentBasedSystem_dataTypes_Complex_dataTypes_ReturnType, gen_componentBasedSystem_dataTypes_Complex_dataTypes_ParameterType, gen_componentBasedSystem_dataTypes_ParameterType_Type, gen_componentBasedSystem_dataTypes_Void_ReturnType, gen_componentBasedSystem_dataTypes_ReturnType_Type, gen_componentBasedSystem_behaviourDescription_InternalAction_DescriptionElement, gen_componentBasedSystem_behaviourDescription_ExternalCall_DescriptionElement, gen_componentBasedSystem_behaviourDescription_Loop_DescriptionElement, gen_componentBasedSystem_behaviourDescription_Branch_DescriptionElement, gen_componentBasedSystem_roles_RequiredRole_Role, gen_componentBasedSystem_roles_ProvidedRole_Role},
    metadata=None
)
