...
class componentBasedSystem_roles_AssemblyConnector:
    ...
    def __init__(self, name: str, componentBasedSystem_roles_AssemblyConnector: "ProvidedRole" = None, componentBasedSystem_roles_AssemblyConnector74: "RequiredRole" = None, componentBasedSystem_roles_AssemblyConnector77: "roles_componentBasedSystem_AssemblyContext" = None, componentBasedSystem_roles_AssemblyConnector79: "roles_componentBasedSystem_AssemblyContext" = None):
        self.name = name
...
class componentBasedSystem_Signature:
    ...
    def __init__(self, name: str, componentBasedSystem_Signature31: set["componentBasedSystem_Parameter"] = None, componentBasedSystem_Signature33: "ReturnType" = None, componentBasedSystem_Signature: "componentBasedSystem_Interface" = None, componentBasedSystem_Signature63: "componentBasedSystem_Service" = None):
        self.name = name
...
class componentBasedSystem_Link:
    ...
    def __init__(self, name: str, componentBasedSystem_Link: set["componentBasedSystem_Container"] = None, componentBasedSystem_Link51: "componentBasedSystem_Environment" = None):
        self.name = name
...
class componentBasedSystem_Container:
    ...
    def __init__(self, name: str, componentBasedSystem_Container: "componentBasedSystem_Link" = None, componentBasedSystem_Container40: "componentBasedSystem_AllocationContext" = None, componentBasedSystem_Container48: "componentBasedSystem_Environment" = None):
        self.name = name
...
class componentBasedSystem_AssemblyContext:
    ...
    def __init__(self, name: str, componentBasedSystem_AssemblyContext: "componentBasedSystem_ComponentBasedSystem" = None, componentBasedSystem_AssemblyContext37: "componentBasedSystem_Component" = None, componentBasedSystem_AssemblyContext43: "componentBasedSystem_AllocationContext" = None, componentBasedSystem_AssemblyContext26: "componentBasedSystem_CompositeComponent" = None):
        self.name = name
...
class componentBasedSystem_Component:
    ...
    def __init__(self, name: str, componentBasedSystem_Component: set["BehaviourDescription"] = None, componentBasedSystem_Component17: set["componentBasedSystem_Service"] = None, componentBasedSystem_Component19: set["RequiredRole"] = None, componentBasedSystem_Component22: set["ProvidedRole"] = None, componentBasedSystem_Component38: "componentBasedSystem_AssemblyContext" = None, componentBasedSystem_Component57: "componentBasedSystem_Repository" = None):
        self.name = name
...
class componentBasedSystem_Environment:
    ...
    def IsLinked(self, componentBasedSystem_c1, componentBasedSystem_c2) :
...
class componentBasedSystem_ComponentBasedSystem:
    ...
    def __init__(self, componentBasedSystem_ComponentBasedSystem6: "componentBasedSystem_Allocation" = None, componentBasedSystem_ComponentBasedSystem8: "componentBasedSystem_Repository" = None, componentBasedSystem_ComponentBasedSystem10: "componentBasedSystem_Environment" = None, componentBasedSystem_ComponentBasedSystem12: set["ProvidedRole"] = None, componentBasedSystem_ComponentBasedSystem14: set["RequiredRole"] = None, componentBasedSystem_ComponentBasedSystem: set["componentBasedSystem_AssemblyContext"] = None, componentBasedSystem_ComponentBasedSystem2: set["Type"] = None, componentBasedSystem_ComponentBasedSystem4: set["AssemblyConnector"] = None):
    ...
    def GetContainerOfContext(self, componentBasedSystem_context) :
