...
class entities_Comment:
    ...
    def __init__(self, commentedOn: genmymodelreverse_java_util_Date, player: str, game: str, comment: str):
...
class deck_Tableau:
    ...
    def __init__(self, columns: str, tableau817: set["card_Card"] = None, tableau719: set["card_Card"] = None, tableau321: set["card_Card"] = None, tableau623: set["card_Card"] = None, tableau125: set["card_Card"] = None, tableau25: set["card_Card"] = None, deck8: "deck_Deck" = None, tableau429: set["card_Card"] = None, tableau531: set["card_Card"] = None, tableau933: set["card_Card"] = None, tableau1035: set["card_Card"] = None):
...
class deck_Deck:
    ...
    def __init__(self, removeItemFromArrayIndex: int, score: int, stepCounter: int, inputDestinationRow: int, foundationIndex: int, foundations13: "deck_Foundations" = None, history3: "features_History" = None, pack7: "card_Pack" = None, tableau9: "deck_Tableau" = None, stock27: "deck_Stock" = None):
...
class card_Pack:
    ...
    def deck6(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_card_Pack__deck6", None)
        self.__deck6 = value
...
class card_Card:
    ...
    def __init__(self, rank: int, flipped: bool, tableau16: "deck_Tableau" = None, tableau18: "deck_Tableau" = None, tableau20: "deck_Tableau" = None, tableau22: "deck_Tableau" = None, tableau24: "deck_Tableau" = None, tableau4: "deck_Tableau" = None, tableau28: "deck_Tableau" = None, tableau30: "deck_Tableau" = None, tableau32: "deck_Tableau" = None, tableau34: "deck_Tableau" = None):
        self.rank = rank
