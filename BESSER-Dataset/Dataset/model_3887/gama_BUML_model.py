...
# Classes
gama_EVariable = Class(name="gama_EVariable")
gama_EExperimentLink = Class(name="gama_EExperimentLink")
gama_EAspectLink = Class(name="gama_EAspectLink")
gama_EActionLink = Class(name="gama_EActionLink")
gama_EReflexLink = Class(name="gama_EReflexLink")
gama_ESubSpeciesLink = Class(name="gama_ESubSpeciesLink")
gama_EGamaModel = Class(name="gama_EGamaModel")
gama_EGamaObject = Class(name="gama_EGamaObject")
gama_EGamaLink = Class(name="gama_EGamaLink")
gama_EFacet = Class(name="gama_EFacet")
gama_ESpecies = Class(name="gama_ESpecies")
EGamaObject = Class(name="EGamaObject")
gama_EInheritLink = Class(name="gama_EInheritLink")
gama_EPlanLink = Class(name="gama_EPlanLink")
gama_EStateLink = Class(name="gama_EStateLink")
gama_ETaskLink = Class(name="gama_ETaskLink")
gama_EAspect = Class(name="gama_EAspect")
gama_EPerceiveLink = Class(name="gama_EPerceiveLink")
gama_ERuleLink = Class(name="gama_ERuleLink")
gama_ELayerAspect = Class(name="gama_ELayerAspect")
gama_EEquationLink = Class(name="gama_EEquationLink")
gama_EReflex = Class(name="gama_EReflex")
gama_EExperiment = Class(name="gama_EExperiment")
ESpecies = Class(name="ESpecies")
gama_EDisplayLink = Class(name="gama_EDisplayLink")
gama_EParameter = Class(name="gama_EParameter")
gama_EMonitor = Class(name="gama_EMonitor")
gama_EGUIExperiment = Class(name="gama_EGUIExperiment")
EExperiment = Class(name="EExperiment")
gama_EBatchExperiment = Class(name="gama_EBatchExperiment")
EGamaLink = Class(name="EGamaLink")
gama_EAction = Class(name="gama_EAction")
gama_EDisplay = Class(name="gama_EDisplay")
gama_ELayer = Class(name="gama_ELayer")
gama_EChartLayer = Class(name="gama_EChartLayer")
gama_EWorldAgent = Class(name="gama_EWorldAgent")
gama_EPlan = Class(name="gama_EPlan")
gama_EState = Class(name="gama_EState")
gama_ETask = Class(name="gama_ETask")
gama_EGrid = Class(name="gama_EGrid")
gama_EPerceive = Class(name="gama_EPerceive")
gama_ERule = Class(name="gama_ERule")
gama_EEquation = Class(name="gama_EEquation")
...
gama_EVariable.attributes={gama_EVariable_update, gama_EVariable_hasError, gama_EVariable_type, gama_EVariable_min, gama_EVariable_max, gama_EVariable_function, gama_EVariable_init, gama_EVariable_error, gama_EVariable_name}
...
gama_EGamaObject.attributes={gama_EGamaObject_name, gama_EGamaObject_hasError, gama_EGamaObject_colorPicto, gama_EGamaObject_error}
...
gama_EFacet.attributes={gama_EFacet_value, gama_EFacet_name}
...
gama_ESpecies.attributes={gama_ESpecies_skills, gama_ESpecies_init, gama_ESpecies_reflexList}
...
gama_ELayerAspect.attributes={gama_ELayerAspect_imageSize, gama_ELayerAspect_texture, gama_ELayerAspect_colorRBG, gama_ELayerAspect_color, gama_ELayerAspect_shapeType, gama_ELayerAspect_width, gama_ELayerAspect_empty, gama_ELayerAspect_size, gama_ELayerAspect_textSize, gama_ELayerAspect_path, gama_ELayerAspect_rotate, gama_ELayerAspect_shape, gama_ELayerAspect_heigth, gama_ELayerAspect_type, gama_ELayerAspect_gamlCode, gama_ELayerAspect_depth, gama_ELayerAspect_isColorCst, gama_ELayerAspect_points, gama_ELayerAspect_expression, gama_ELayerAspect_text, gama_ELayerAspect_radius, gama_ELayerAspect_at}
...
gama_EParameter.attributes={gama_EParameter_max, gama_EParameter_init, gama_EParameter_variable, gama_EParameter_among, gama_EParameter_min, gama_EParameter_category, gama_EParameter_step}
...
gama_EDisplay.attributes={gama_EDisplay_defineGamlCode, gama_EDisplay_layerList, gama_EDisplay_gamlCode}
...
gama_ELayer.attributes={gama_ELayer_isColorCst, gama_ELayer_agents, gama_ELayer_color, gama_ELayer_size, gama_ELayer_type, gama_ELayer_gamlCode, gama_ELayer_text, gama_ELayer_aspect, gama_ELayer_grid, gama_ELayer_showLines, gama_ELayer_species, gama_ELayer_colorRBG, gama_ELayer_chart_type, gama_ELayer_file}
...
gama_EChartLayer.attributes={gama_EChartLayer_value, gama_EChartLayer_style, gama_EChartLayer_color}
...
domain_model = DomainModel(
    name="gama",
    types={gama_EVariable, gama_EExperimentLink, gama_EAspectLink, gama_EActionLink, gama_EReflexLink, gama_ESubSpeciesLink, gama_EGamaModel, gama_EGamaObject, gama_EGamaLink, gama_EFacet, gama_ESpecies, EGamaObject, gama_EInheritLink, gama_EPlanLink, gama_EStateLink, gama_ETaskLink, gama_EAspect, gama_EPerceiveLink, gama_ERuleLink, gama_ELayerAspect, gama_EEquationLink, gama_EReflex, gama_EExperiment, ESpecies, gama_EDisplayLink, gama_EParameter, gama_EMonitor, gama_EGUIExperiment, EExperiment, gama_EBatchExperiment, EGamaLink, gama_EAction, gama_EDisplay, gama_ELayer, gama_EChartLayer, gama_EWorldAgent, gama_EPlan, gama_EState, gama_ETask, gama_EGrid, gama_EPerceive, gama_ERule, gama_EEquation},
    associations={variables5, experimentLinks6, aspectLinks8, actionLinks10, reflexLinks12, microSpeciesLinks14, objects0, links1, model3, facets4, macroSpeciesLinks16, inheritsFrom20, inheritingLinks22, planLinks24, stateLinks26, taskLinks28, perceiveLinks30, aspectLinks41, ruleLinks32, layers43, equationLinks34, reflexLinks45, experimentLink47, displayLinks49, parameters51, monitors53, target55, source57, model60, actionLinks36, variables38, action68, species71, aspect74, species77, reflex80, species83, experiment86, display88, layers90, displayLink92, macro62, micro65, chartlayers101, species103, experiment106, owner95, display98, parent112, child115, owner118, planLinks121, stateLinks123, taskLinks125, plan127, species130, aspect109, task139, species142, perceiveLinks145, perceive147, species150, ruleLinks153, rule155, species158, equationLinks161, equation163, species166, state133, species136},
    generalizations={gen_gama_ESpecies_EGamaObject, gen_gama_EAspect_EGamaObject, gen_gama_EReflex_EGamaObject, gen_gama_EExperiment_ESpecies, gen_gama_EGUIExperiment_EExperiment, gen_gama_EBatchExperiment_EExperiment, gen_gama_ESubSpeciesLink_EGamaLink, gen_gama_EAction_EGamaObject, gen_gama_EAspectLink_EGamaLink, gen_gama_EReflexLink_EGamaLink, gen_gama_EDisplayLink_EGamaLink, gen_gama_EDisplay_EGamaObject, gen_gama_EActionLink_EGamaLink, gen_gama_EExperimentLink_EGamaLink, gen_gama_ELayerAspect_EGamaObject, gen_gama_EWorldAgent_ESpecies, gen_gama_ELayer_EGamaObject, gen_gama_EChartLayer_EGamaObject, gen_gama_EParameter_EGamaObject, gen_gama_EMonitor_EGamaObject, gen_gama_EPlan_EGamaObject, gen_gama_EState_EGamaObject, gen_gama_ETask_EGamaObject, gen_gama_EPlanLink_EGamaLink, gen_gama_EInheritLink_EGamaLink, gen_gama_ETaskLink_EGamaLink, gen_gama_EGrid_ESpecies, gen_gama_EPerceive_EGamaObject, gen_gama_EPerceiveLink_EGamaLink, gen_gama_ERule_EGamaObject, gen_gama_ERuleLink_EGamaLink, gen_gama_EEquation_EGamaObject, gen_gama_EEquationLink_EGamaLink, gen_gama_EStateLink_EGamaLink},
    metadata=None
)
