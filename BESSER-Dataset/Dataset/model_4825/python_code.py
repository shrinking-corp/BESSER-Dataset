...
class model_ArchimateModel(FolderContainer, ArchimateModelObject, Properties):
    ...
    def __init__(self, file: str, version: str, purpose: str, model_ArchimateModel: "model_Metadata" = None):
        self.file = file
...
class model_Folder(Documentable, ArchimateModelObject, Properties, FolderContainer):
...
class DiagramModelContainer:
    ...
    pass
class model_DiagramModelArchimateObject(TextPosition, DiagramModelObject, DiagramModelContainer, DiagramModelArchimateComponent):
...
class model_DiagramModel(DiagramModelContainer, Documentable, ArchimateModelObject, Properties):
...
class model_DiagramModelObject(TextAlignment, Connectable, LineObject, FontAttribute):
    ...
    def setBounds(self, model_y, model_height, model_width, model_x):
...
class TextContent:
    ...
    pass
class model_SketchModelSticky(TextContent, DiagramModelContainer, Properties, TextPosition, DiagramModelObject):

    pass
class model_DiagramModelNote(TextPosition, DiagramModelObject, TextContent):
...
class model_TechnologyInterface(TechnologyElement, ActiveStructureElement):
    ...
    pass
class model_DiagramModelConnection(Connectable, Properties, FontAttribute, LineObject, Documentable):
...
class model_DiagramModelComponent(Cloneable, Identifier, Nameable, Adapter):
