...
thingML_NamedElement = Class(name="thingML_NamedElement")
thingML_AnnotatedElement = Class(name="thingML_AnnotatedElement")
thingML_Variable = Class(name="thingML_Variable")
NamedElement = Class(name="NamedElement")
AnnotatedElement = Class(name="AnnotatedElement")
thingML_TypeRef = Class(name="thingML_TypeRef")
thingML_Expression = Class(name="thingML_Expression")
...
thingML_Type = Class(name="thingML_Type")
...
thingML_Handler = Class(name="thingML_Handler")
thingML_Event = Class(name="thingML_Event")
thingML_Action = Class(name="thingML_Action")
Variable = Class(name="Variable")
thingML_FinalState = Class(name="thingML_FinalState")
thingML_StateContainer = Class(name="thingML_StateContainer")
...
thingML_ForAction = Class(name="thingML_ForAction")
...
thingML_ArrayInit = Class(name="thingML_ArrayInit")
...
thingML_EventReference = Class(name="thingML_EventReference")
thingML_FunctionCallExpression = Class(name="thingML_FunctionCallExpression")
thingML_Instance = Class(name="thingML_Instance")
thingML_AbstractConnector = Class(name="thingML_AbstractConnector")
thingML_ConfigPropertyAssign = Class(name="thingML_ConfigPropertyAssign")
Literal = Class(name="Literal")
thingML_ByteLiteral = Class(name="thingML_ByteLiteral")
thingML_CharLiteral = Class(name="thingML_CharLiteral")
...
thingML_CastExpression = Class(name="thingML_CastExpression")
thingML_ExpressionGroup = Class(name="thingML_ExpressionGroup")
...
thingML_Import_from_: Property = Property(name="from_", type=StringType)
thingML_Import.attributes={thingML_Import_from_, thingML_Import_importURI}
...
domain_model = DomainModel(
    name="thingML",
    types={thingML_PlatformAnnotation, thingML_NamedElement, thingML_AnnotatedElement, thingML_Variable, NamedElement, AnnotatedElement, thingML_TypeRef, thingML_Expression, thingML_PrimitiveType, Type, thingML_ThingMLModel, thingML_Import, thingML_Type, thingML_Protocol, thingML_Configuration, thingML_Property, thingML_Function, thingML_PropertyAssign, thingML_CompositeState, thingML_Parameter, thingML_ObjectType, thingML_Enumeration, thingML_EnumerationLiteral, thingML_Literal, thingML_Thing, thingML_Message, thingML_Port, thingML_RequiredPort, Port, thingML_ProvidedPort, thingML_InternalPort, thingML_State, thingML_InternalTransition, thingML_Transition, thingML_Handler, thingML_Event, thingML_Action, Variable, thingML_FinalState, thingML_StateContainer, thingML_ReceiveMessage, Event, thingML_ActionBlock, Action, thingML_ExternStatement, thingML_LocalVariable, Handler, State, StateContainer, thingML_Region, thingML_Session, thingML_VariableAssignment, thingML_Increment, thingML_Decrement, thingML_ForAction, thingML_PropertyReference, thingML_LoopAction, thingML_SendAction, thingML_ErrorAction, thingML_StartSession, thingML_FunctionCallStatement, thingML_ExternExpression, Expression, thingML_ArrayInit, thingML_EnumLiteralRef, thingML_ConditionalAction, thingML_ReturnAction, thingML_PrintAction, thingML_DoubleLiteral, thingML_EventReference, thingML_FunctionCallExpression, thingML_Instance, thingML_AbstractConnector, thingML_ConfigPropertyAssign, Literal, thingML_ByteLiteral, thingML_CharLiteral, thingML_IntegerLiteral, thingML_BooleanLiteral, thingML_StringLiteral, thingML_ExternalConnector, thingML_OrExpression, thingML_AndExpression, thingML_Connector, AbstractConnector, thingML_LowerExpression, thingML_GreaterOrEqualExpression, thingML_LowerOrEqualExpression, thingML_PlusExpression, thingML_EqualsExpression, thingML_NotEqualsExpression, thingML_GreaterExpression, thingML_DivExpression, thingML_ModExpression, thingML_CastExpression, thingML_ExpressionGroup, thingML_MinusExpression, thingML_TimesExpression, thingML_NotExpression, thingML_UnaryMinus, thingML_ArrayIndex},
    associations={annotations7, typeRef8, type9, cardinality12, imports0, types1, protocols3, configs5, properties26, functions28, assign30, behaviour32, property34, index37, init40, parameters43, typeRef45, typeRef14, literals16, init18, includes21, messages22, ports24, receives59, properties62, entry64, exit67, internal70, outgoing72, event74, body48, init50, parameters53, sends56, initial91, substate93, port96, message98, actions101, segments103, guard75, action78, target81, region84, session86, maxInstances88, property115, index117, expression120, var123, var125, variable127, index129, array132, action134, init105, port107, message109, parameters112, msg154, session156, function158, parameters160, segments163, values165, condition137, action139, condition142, action144, elseAction147, exp150, msg152, property172, receiveMsg175, parameter177, function180, parameters182, instances185, connectors187, propassigns189, enum167, literal169, required211, srv213, provided216, inst218, port220, protocol223, lhs226, rhs228, lhs231, type191, instance194, property197, index200, init203, annotations206, cli209, lhs246, rhs248, lhs251, rhs253, lhs256, rhs258, lhs261, rhs263, rhs233, lhs236, rhs238, lhs241, rhs243, lhs281, rhs283, lhs286, rhs288, term291, type293, lhs266, rhs268, lhs271, rhs273, lhs276, rhs278, index304, term296, term298, term300, array302},
    generalizations={gen_thingML_Variable_NamedElement, gen_thingML_Variable_AnnotatedElement, gen_thingML_Type_NamedElement, gen_thingML_Type_AnnotatedElement, gen_thingML_PrimitiveType_Type, gen_thingML_PropertyAssign_AnnotatedElement, gen_thingML_Protocol_NamedElement, gen_thingML_Protocol_AnnotatedElement, gen_thingML_Function_NamedElement, gen_thingML_Function_AnnotatedElement, gen_thingML_ObjectType_Type, gen_thingML_Enumeration_Type, gen_thingML_EnumerationLiteral_NamedElement, gen_thingML_EnumerationLiteral_AnnotatedElement, gen_thingML_Thing_Type, gen_thingML_RequiredPort_Port, gen_thingML_ProvidedPort_Port, gen_thingML_InternalPort_Port, gen_thingML_State_NamedElement, gen_thingML_State_AnnotatedElement, gen_thingML_Handler_NamedElement, gen_thingML_Handler_AnnotatedElement, gen_thingML_Property_Variable, gen_thingML_Message_NamedElement, gen_thingML_Message_AnnotatedElement, gen_thingML_Parameter_Variable, gen_thingML_Port_NamedElement, gen_thingML_Port_AnnotatedElement, gen_thingML_Region_StateContainer, gen_thingML_FinalState_State, gen_thingML_StateContainer_NamedElement, gen_thingML_StateContainer_AnnotatedElement, gen_thingML_Event_NamedElement, gen_thingML_ReceiveMessage_Event, gen_thingML_ActionBlock_Action, gen_thingML_ExternStatement_Action, gen_thingML_LocalVariable_Variable, gen_thingML_LocalVariable_Action, gen_thingML_Transition_Handler, gen_thingML_InternalTransition_Handler, gen_thingML_CompositeState_State, gen_thingML_CompositeState_StateContainer, gen_thingML_Session_StateContainer, gen_thingML_VariableAssignment_Action, gen_thingML_Increment_Action, gen_thingML_Decrement_Action, gen_thingML_ForAction_Action, gen_thingML_LoopAction_Action, gen_thingML_SendAction_Action, gen_thingML_ErrorAction_Action, gen_thingML_StartSession_Action, gen_thingML_FunctionCallStatement_Action, gen_thingML_ExternExpression_Expression, gen_thingML_Literal_Expression, gen_thingML_ArrayInit_Expression, gen_thingML_ConditionalAction_Action, gen_thingML_ReturnAction_Action, gen_thingML_PrintAction_Action, gen_thingML_DoubleLiteral_Literal, gen_thingML_PropertyReference_Expression, gen_thingML_EventReference_Expression, gen_thingML_FunctionCallExpression_Expression, gen_thingML_Configuration_NamedElement, gen_thingML_Configuration_AnnotatedElement, gen_thingML_Instance_NamedElement, gen_thingML_Instance_AnnotatedElement, gen_thingML_EnumLiteralRef_Literal, gen_thingML_ByteLiteral_Literal, gen_thingML_CharLiteral_Literal, gen_thingML_IntegerLiteral_Literal, gen_thingML_BooleanLiteral_Literal, gen_thingML_StringLiteral_Literal, gen_thingML_ExternalConnector_AbstractConnector, gen_thingML_OrExpression_Expression, gen_thingML_AndExpression_Expression, gen_thingML_AbstractConnector_NamedElement, gen_thingML_AbstractConnector_AnnotatedElement, gen_thingML_Connector_AbstractConnector, gen_thingML_LowerExpression_Expression, gen_thingML_GreaterOrEqualExpression_Expression, gen_thingML_LowerOrEqualExpression_Expression, gen_thingML_PlusExpression_Expression, gen_thingML_EqualsExpression_Expression, gen_thingML_NotEqualsExpression_Expression, gen_thingML_GreaterExpression_Expression, gen_thingML_DivExpression_Expression, gen_thingML_ModExpression_Expression, gen_thingML_CastExpression_Expression, gen_thingML_ExpressionGroup_Expression, gen_thingML_MinusExpression_Expression, gen_thingML_TimesExpression_Expression, gen_thingML_NotExpression_Expression, gen_thingML_UnaryMinus_Expression, gen_thingML_ArrayIndex_Expression},
    metadata=None
)
