...
# Classes
model_Stop = Class(name="model_Stop")
model_Repeat = Class(name="model_Repeat")
Ending = Class(name="Ending")
model_StartOver = Class(name="model_StartOver")
model_Root = Class(name="model_Root")
model_RoboProse = Class(name="model_RoboProse")
model_Main = Class(name="model_Main")
model_EventListener = Class(name="model_EventListener")
ActionsList = Class(name="ActionsList")
model_Event = Class(name="model_Event", is_abstract=True)
model_ActionsList = Class(name="model_ActionsList", is_abstract=True)
model_Action = Class(name="model_Action", is_abstract=True)
model_Ending = Class(name="model_Ending", is_abstract=True)
model_RotorAction = Class(name="model_RotorAction", is_abstract=True)
Action = Class(name="Action")
model_Move = Class(name="model_Move")
RotorAction = Class(name="RotorAction")
ContinuosAction = Class(name="ContinuosAction")
RandomAction = Class(name="RandomAction")
model_Turn = Class(name="model_Turn")
model_Wait = Class(name="model_Wait")
model_Obstacle = Class(name="model_Obstacle")
Event = Class(name="Event")
model_Tapped = Class(name="model_Tapped")
model_ContinuosAction = Class(name="model_ContinuosAction", is_abstract=True)
model_RandomAction = Class(name="model_RandomAction", is_abstract=True)
...
model_Turn.attributes={model_Turn_direction, model_Turn_degrees}
...
domain_model = DomainModel(
    name="model",
    types={model_Stop, model_Repeat, Ending, model_StartOver, model_Root, model_RoboProse, model_Main, model_EventListener, ActionsList, model_Event, model_ActionsList, model_Action, model_Ending, model_RotorAction, Action, model_Move, RotorAction, ContinuosAction, RandomAction, model_Turn, model_Wait, model_Obstacle, Event, model_Tapped, model_ContinuosAction, model_RandomAction, MOVE_DIRECTION, TURN_DIRECTION},
    associations={robot0, main1, listeners3, sublisteners6, event8, actions10, ending11},
    generalizations={gen_model_Turn_RotorAction, gen_model_Turn_ContinuosAction, gen_model_Turn_RandomAction, gen_model_Stop_ContinuosAction, gen_model_Repeat_Ending, gen_model_StartOver_Ending, gen_model_Main_ActionsList, gen_model_EventListener_ActionsList, gen_model_RotorAction_Action, gen_model_Move_RotorAction, gen_model_Move_ContinuosAction, gen_model_Move_RandomAction, gen_model_Wait_Ending, gen_model_Obstacle_Event, gen_model_Tapped_Event, gen_model_ContinuosAction_Action, gen_model_RandomAction_Action},
    metadata=None
)
