...
# Classes
familyleft1_Father = Class(name="familyleft1_Father")
familyleft1_Family = Class(name="familyleft1_Family")
familyleft1_Mother = Class(name="familyleft1_Mother")
familyleft1_Son = Class(name="familyleft1_Son")
...
familyleft1_Family.attributes={familyleft1_Family_location, familyleft1_Family_surname}
...
familyleft1_Son.attributes={familyleft1_Son_age, familyleft1_Son_sex, familyleft1_Son_name}
...
domain_model = DomainModel(
    name="familyleft1",
    types={familyleft1_Father, familyleft1_Family, familyleft1_Mother, familyleft1_Son},
    associations={family0, family1, family3, father5, mother6, sons8},
    generalizations={},
    metadata=None
)
