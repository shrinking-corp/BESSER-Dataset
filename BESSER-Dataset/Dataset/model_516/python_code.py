...
class familyleft1_Son:
    ...
    def __init__(self, name: str, age: int, sex: str, sons: "familyleft1_Family" = None, Son: "familyleft1_Family" = None):
        self.name = name
        self.age = age
        self.sex = sex
        self.sons = sons
...
class familyleft1_Family:
    ...
    def __init__(self, surname: str, location: str, Family: "familyleft1_Father" = None, Family2: "familyleft1_Mother" = None, Family4: "familyleft1_Son" = None, family: "familyleft1_Father" = None, family7: "familyleft1_Mother" = None, family9: set["familyleft1_Son"] = None):
...
class familyleft1_Father:
    ...
    def __init__(self, name: str, age: int, father: "familyleft1_Family" = None, Father: "familyleft1_Family" = None):
        self.name = name
        self.age = age
        self.father = father
        self.Father = Father
