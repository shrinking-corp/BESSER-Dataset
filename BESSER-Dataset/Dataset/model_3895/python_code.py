...
class workflow_IWorkflowJob(IWorkflowNode):
    ...
    @property
    def jobDescriptionFileName(self):
...
class workflow_IWorkflowNode(IWorkflowElement):
    ...
    def __init__(self, isStart: bool, isFinish: bool, nodes: "workflow_IWorkflow" = None, node: set["workflow_IOutputPort"] = None, node21: set["workflow_IInputPort"] = None, IWorkflowNode: "workflow_IInputPort" = None, IWorkflowNode8: "workflow_IOutputPort" = None, IWorkflowNode12: "workflow_IWorkflow" = None):
