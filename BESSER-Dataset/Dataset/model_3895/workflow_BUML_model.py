...
# Classes
workflow_IPort = Class(name="workflow_IPort", is_abstract=True)
IWorkflowElement = Class(name="IWorkflowElement")
workflow_ILink = Class(name="workflow_ILink")
workflow_IWorkflow = Class(name="workflow_IWorkflow")
workflow_IInputPort = Class(name="workflow_IInputPort")
workflow_IOutputPort = Class(name="workflow_IOutputPort")
workflow_IWorkflowJob = Class(name="workflow_IWorkflowJob")
IWorkflowNode = Class(name="IWorkflowNode")
workflow_IWorkflowElement = Class(name="workflow_IWorkflowElement", is_abstract=True)
IPort = Class(name="IPort")
workflow_IWorkflowNode = Class(name="workflow_IWorkflowNode", is_abstract=True)
...
workflow_IWorkflowElement.attributes={workflow_IWorkflowElement_id, workflow_IWorkflowElement_name}
...
domain_model = DomainModel(
    name="workflow",
    types={workflow_IPort, IWorkflowElement, workflow_ILink, workflow_IWorkflow, workflow_IInputPort, workflow_IOutputPort, workflow_IWorkflowJob, IWorkflowNode, workflow_IWorkflowElement, IPort, workflow_IWorkflowNode},
    associations={workflow0, target1, source3, workflow16, outputs18, inputs20, node5, links6, node7, links9, nodes11, links13},
    generalizations={gen_workflow_IPort_IWorkflowElement, gen_workflow_ILink_IWorkflowElement, gen_workflow_IWorkflowJob_IWorkflowNode, gen_workflow_IWorkflowNode_IWorkflowElement, gen_workflow_IInputPort_IPort, gen_workflow_IOutputPort_IPort, gen_workflow_IWorkflow_IWorkflowElement},
    metadata=None
)
