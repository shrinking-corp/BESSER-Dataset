...
def test_w_has_attC1():
    assert hasattr(W, "attC1")
    descriptor = None
...
def test_w_has_attC2():
    assert hasattr(W, "attC2")
    descriptor = None
    for klass in W.__mro__:
...
def test_n_has_attB():
    assert hasattr(N, "attB")
    descriptor = None
    for klass in N.__mro__:
...
@given(instance=M_strategy)
def test_m_attA_setter(instance):
...
@given(instance=W_strategy)
def test_w_attC1_setter(instance):
...
@given(instance=W_strategy)
def test_w_attC2_setter(instance):
...
@given(instance=N_strategy)
def test_n_attB_setter(instance):
...
@given(instance=T_strategy)
def test_t_attY_setter(instance):
