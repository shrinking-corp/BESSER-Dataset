...
# Classes
edatatypeColumn_Book = Class(name="edatatypeColumn_Book")
...
edatatypeColumn_Book.attributes={edatatypeColumn_Book_title, edatatypeColumn_Book_pages, edatatypeColumn_Book_weight, edatatypeColumn_Book_author}
