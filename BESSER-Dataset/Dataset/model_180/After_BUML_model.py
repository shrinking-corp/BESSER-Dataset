...
domain_model = DomainModel(
    name="lit_petriNets",
    types={lit_petriNets_Net, lit_petriNets_Place, lit_petriNets_Transition, lit_petriNets_Arc, Arc, lit_petriNets_TPArc, lit_petriNets_PTArc},
    associations={places0, transitions1, arcs3, net5, out7, net8, in_10, out13, net16, s18, d20, s22, in_6, d25},
