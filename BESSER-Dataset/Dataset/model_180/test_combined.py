...
def test_hyp_lit_petrinets_tparc_is_not_abstract():
    assert not inspect.isabstract(lit_petriNets_TPArc)


def test_hyp_lit_petrinets_tparc_constructor_exists():
    assert callable(lit_petriNets_TPArc.__init__)


def test_hyp_lit_petrinets_tparc_constructor_args():
    sig = inspect.signature(lit_petriNets_TPArc.__init__)
    params = list(sig.parameters.keys())



def test_hyp_lit_petrinets_ptarc_is_not_abstract():
    assert not inspect.isabstract(lit_petriNets_PTArc)


def test_hyp_lit_petrinets_ptarc_constructor_exists():
    assert callable(lit_petriNets_PTArc.__init__)


def test_hyp_lit_petrinets_ptarc_constructor_args():
    sig = inspect.signature(lit_petriNets_PTArc.__init__)
    params = list(sig.parameters.keys())



def test_hyp_lit_petrinets_arc_is_not_abstract():
    assert not inspect.isabstract(lit_petriNets_Arc)


def test_hyp_lit_petrinets_arc_constructor_exists():
    assert callable(lit_petriNets_Arc.__init__)


def test_hyp_lit_petrinets_arc_constructor_args():
...
def test_assoc_d20_link_reassign_clear():
...
def test_assoc_d25_link_reassign_clear():
...
def test_assoc_s18_link_reassign_clear():
    a = lit_petriNets_Place(name="sample_text")
    b1 = lit_petriNets_PTArc()
    b2 = lit_petriNets_PTArc()
...
def test_assoc_s22_link_reassign_clear():
    a = lit_petriNets_Transition(name="sample_text")
    b1 = lit_petriNets_TPArc()
    b2 = lit_petriNets_TPArc()
