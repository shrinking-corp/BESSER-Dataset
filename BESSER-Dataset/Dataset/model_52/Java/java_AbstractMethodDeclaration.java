...
public class java_AbstractMethodDeclaration extends BodyDeclaration {
    ...
    public java_AbstractMethodDeclaration(
        ArrayList<java_MethodRef> java_methodrefs,        ArrayList<java_AbstractMethodInvocation> java_abstractmethodinvocations,        ArrayList<java_TypeAccess> java_typeaccesss,        ArrayList<java_SingleVariableDeclaration> java_singlevariabledeclarations,        ArrayList<java_TypeParameter> java_typeparameters    ) {
