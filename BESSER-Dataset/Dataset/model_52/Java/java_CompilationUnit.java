...
public class java_CompilationUnit extends NamedElement {
    ...
    public java_CompilationUnit(
        String originalFilePath        ArrayList<java_AbstractTypeDeclaration> java_abstracttypedeclarations,        ArrayList<java_ImportDeclaration> java_importdeclarations,        ArrayList<java_Comment> java_comments    ) {
        this.originalFilePath = originalFilePath;
