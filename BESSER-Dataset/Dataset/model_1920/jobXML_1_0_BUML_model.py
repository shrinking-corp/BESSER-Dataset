...
# Classes
jbatch_CheckpointAlgorithm = Class(name="jbatch_CheckpointAlgorithm")
jbatch_Chunk = Class(name="jbatch_Chunk")
jbatch_Analyzer = Class(name="jbatch_Analyzer")
jbatch_Properties = Class(name="jbatch_Properties")
jbatch_Batchlet = Class(name="jbatch_Batchlet")
jbatch_ItemReader = Class(name="jbatch_ItemReader")
jbatch_ItemProcessor = Class(name="jbatch_ItemProcessor")
jbatch_ItemWriter = Class(name="jbatch_ItemWriter")
jbatch_ExceptionClassFilter = Class(name="jbatch_ExceptionClassFilter")
jbatch_End = Class(name="jbatch_End")
jbatch_Fail = Class(name="jbatch_Fail")
jbatch_Next = Class(name="jbatch_Next")
jbatch_Collector = Class(name="jbatch_Collector")
jbatch_Decision = Class(name="jbatch_Decision")
jbatch_Job = Class(name="jbatch_Job")
jbatch_IncludeType = Class(name="jbatch_IncludeType")
jbatch_ExcludeType = Class(name="jbatch_ExcludeType")
jbatch_Stop = Class(name="jbatch_Stop")
jbatch_DocumentRoot = Class(name="jbatch_DocumentRoot")
jbatch_EStringToStringMapEntry = Class(name="jbatch_EStringToStringMapEntry")
jbatch_Split = Class(name="jbatch_Split")
jbatch_Step = Class(name="jbatch_Step")
jbatch_Flow = Class(name="jbatch_Flow")
jbatch_Listeners = Class(name="jbatch_Listeners")
jbatch_Partition = Class(name="jbatch_Partition")
jbatch_PartitionMapper = Class(name="jbatch_PartitionMapper")
jbatch_PartitionPlan = Class(name="jbatch_PartitionPlan")
jbatch_Listener = Class(name="jbatch_Listener")
jbatch_Property = Class(name="jbatch_Property")
jbatch_PartitionReducer = Class(name="jbatch_PartitionReducer")
...
jbatch_Chunk.attributes={jbatch_Chunk_timeLimit, jbatch_Chunk_skipLimit, jbatch_Chunk_checkpointPolicy, jbatch_Chunk_itemCount, jbatch_Chunk_retryLimit}
...
jbatch_Fail.attributes={jbatch_Fail_on, jbatch_Fail_exitStatus}
...
jbatch_Next.attributes={jbatch_Next_on, jbatch_Next_to}
...
jbatch_Decision.attributes={jbatch_Decision_transitionElements, jbatch_Decision_id, jbatch_Decision_ref}
...
jbatch_Job.attributes={jbatch_Job_id, jbatch_Job_restartable, jbatch_Job_group, jbatch_Job_version}

# jbatch_IncludeType class attributes and methods
jbatch_IncludeType_class_: Property = Property(name="class_", type=StringType)
jbatch_IncludeType.attributes={jbatch_IncludeType_class_}

# jbatch_ExcludeType class attributes and methods
jbatch_ExcludeType_class_: Property = Property(name="class_", type=StringType)
jbatch_ExcludeType.attributes={jbatch_ExcludeType_class_}
...
jbatch_Stop.attributes={jbatch_Stop_on, jbatch_Stop_exitStatus, jbatch_Stop_restart}
...
jbatch_Split.attributes={jbatch_Split_next, jbatch_Split_id}
...
jbatch_Step.attributes={jbatch_Step_allowStartIfComplete, jbatch_Step_id, jbatch_Step_next1, jbatch_Step_transitionElements, jbatch_Step_startLimit}
...
jbatch_Flow.attributes={jbatch_Flow_transitionElements, jbatch_Flow_group, jbatch_Flow_next1, jbatch_Flow_id}
...
domain_model = DomainModel(
    name="jbatch",
    types={jbatch_CheckpointAlgorithm, jbatch_Chunk, jbatch_Analyzer, jbatch_Properties, jbatch_Batchlet, jbatch_ItemReader, jbatch_ItemProcessor, jbatch_ItemWriter, jbatch_ExceptionClassFilter, jbatch_End, jbatch_Fail, jbatch_Next, jbatch_Collector, jbatch_Decision, jbatch_Job, jbatch_IncludeType, jbatch_ExcludeType, jbatch_Stop, jbatch_DocumentRoot, jbatch_EStringToStringMapEntry, jbatch_Split, jbatch_Step, jbatch_Flow, jbatch_Listeners, jbatch_Partition, jbatch_PartitionMapper, jbatch_PartitionPlan, jbatch_Listener, jbatch_Property, jbatch_PartitionReducer},
    associations={properties1, properties3, properties0, retryableExceptionClasses15, noRollbackExceptionClasses18, reader5, processor6, writer8, checkpointAlgorithm10, skippableExceptionClasses13, end25, fail27, next29, properties21, properties23, job37, include39, exclude41, stop31, xMLNSPrefixMap33, xSISchemaLocation34, flow46, split48, step50, end52, fail55, decision43, properties64, properties67, properties70, next58, stop61, flow81, split84, properties73, listeners76, decision78, mapper95, plan96, collector98, step87, properties90, listener92, properties112, property115, analyzer101, reducer104, properties106, properties109, listeners123, batchlet126, chunk129, partition132, end135, flow117, properties120, fail138, next141, stop144},
    generalizations={},
    metadata=None
)
