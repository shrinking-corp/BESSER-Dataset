...
def test_psample_variable_has_isParameter():
    assert hasattr(psample_Variable, "isParameter")
    descriptor = None
    for klass in psample_Variable.__mro__:
...
def test_psample_primitivetypevariable_has_isParameter():
    assert hasattr(psample_PrimitiveTypeVariable, "isParameter")
    descriptor = None
    for klass in psample_PrimitiveTypeVariable.__mro__:
        if "isParameter" in klass.__dict__:
            descriptor = klass.__dict__["isParameter"]
            break
    assert isinstance(descriptor, property)
...
@given(instance=psample_Variable_strategy)
def test_psample_variable_isParameter_setter(instance):
...
@given(instance=psample_PrimitiveTypeVariable_strategy)
def test_psample_primitivetypevariable_isParameter_setter(instance):
    original = instance.isParameter
    instance.isParameter = original
    assert instance.isParameter == original
