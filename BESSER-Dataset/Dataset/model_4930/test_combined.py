...
def test_hyp_webapp_formwidget_is_not_abstract():
    assert not inspect.isabstract(webapp_FormWidget)


def test_hyp_webapp_formwidget_constructor_exists():
    assert callable(webapp_FormWidget.__init__)


def test_hyp_webapp_formwidget_constructor_args():
...
def test_hyp_webapp_spinner_is_not_abstract():
    assert not inspect.isabstract(webapp_Spinner)


def test_hyp_webapp_spinner_constructor_exists():
    assert callable(webapp_Spinner.__init__)


def test_hyp_webapp_spinner_constructor_args():
...
def test_hyp_webapp_imagesblock_is_not_abstract():
    assert not inspect.isabstract(webapp_ImagesBlock)


def test_hyp_webapp_imagesblock_constructor_exists():
    assert callable(webapp_ImagesBlock.__init__)


def test_hyp_webapp_imagesblock_constructor_args():
...
def test_hyp_webapp_gallery_is_not_abstract():
    assert not inspect.isabstract(webapp_Gallery)


def test_hyp_webapp_gallery_constructor_exists():
    assert callable(webapp_Gallery.__init__)


def test_hyp_webapp_gallery_constructor_args():
...
def test_hyp_webapp_video_is_not_abstract():
    assert not inspect.isabstract(webapp_Video)


def test_hyp_webapp_video_constructor_exists():
    assert callable(webapp_Video.__init__)


def test_hyp_webapp_video_constructor_args():
...
def test_hyp_webapp_widget_is_not_abstract():
    assert not inspect.isabstract(webapp_Widget)


def test_hyp_webapp_widget_constructor_exists():
    assert callable(webapp_Widget.__init__)


def test_hyp_webapp_widget_constructor_args():
...
def test_hyp_webapp_section_is_not_abstract():
    assert not inspect.isabstract(webapp_Section)


def test_hyp_webapp_section_constructor_exists():
    assert callable(webapp_Section.__init__)


def test_hyp_webapp_section_constructor_args():
...
def test_hyp_webapp_staticview_is_not_abstract():
    assert not inspect.isabstract(webapp_StaticView)


def test_hyp_webapp_staticview_constructor_exists():
    assert callable(webapp_StaticView.__init__)


def test_hyp_webapp_staticview_constructor_args():
    sig = inspect.signature(webapp_StaticView.__init__)
    params = list(sig.parameters.keys())



def test_hyp_webapp_modelview_is_not_abstract():
    assert not inspect.isabstract(webapp_ModelView)


def test_hyp_webapp_modelview_constructor_exists():
    assert callable(webapp_ModelView.__init__)


def test_hyp_webapp_modelview_constructor_args():
    sig = inspect.signature(webapp_ModelView.__init__)
    params = list(sig.parameters.keys())



def test_hyp_webapp_routermapping_is_not_abstract():
    assert not inspect.isabstract(webapp_RouterMapping)


def test_hyp_webapp_routermapping_constructor_exists():
    assert callable(webapp_RouterMapping.__init__)


def test_hyp_webapp_routermapping_constructor_args():
...
def test_hyp_webapp_parameter_is_not_abstract():
    assert not inspect.isabstract(webapp_Parameter)


def test_hyp_webapp_parameter_constructor_exists():
    assert callable(webapp_Parameter.__init__)


def test_hyp_webapp_parameter_constructor_args():
    sig = inspect.signature(webapp_Parameter.__init__)
    params = list(sig.parameters.keys())



def test_hyp_webapp_operation_is_not_abstract():
    assert not inspect.isabstract(webapp_Operation)


def test_hyp_webapp_operation_constructor_exists():
    assert callable(webapp_Operation.__init__)


def test_hyp_webapp_operation_constructor_args():
...
def test_hyp_webapp_abstractview_is_not_abstract():
    assert not inspect.isabstract(webapp_AbstractView)


def test_hyp_webapp_abstractview_constructor_exists():
    assert callable(webapp_AbstractView.__init__)


def test_hyp_webapp_abstractview_constructor_args():
...
def test_hyp_webapp_reference_is_not_abstract():
    assert not inspect.isabstract(webapp_Reference)


def test_hyp_webapp_reference_constructor_exists():
    assert callable(webapp_Reference.__init__)


def test_hyp_webapp_reference_constructor_args():
...
def test_hyp_webapp_application_is_not_abstract():
    assert not inspect.isabstract(webapp_Application)


def test_hyp_webapp_application_constructor_exists():
    assert callable(webapp_Application.__init__)


def test_hyp_webapp_application_constructor_args():
...
def test_hyp_webapp_formwidget_label_setter(instance):
...
def test_hyp_webapp_table_bordered_setter(instance):
...
@given(instance=webapp_Table_strategy)
def test_hyp_webapp_table_columnNames_setter(instance):
...
@given(instance=webapp_Table_strategy)
def test_hyp_webapp_table_striped_setter(instance):
...
@given(instance=webapp_Table_strategy)
def test_hyp_webapp_table_rowNames_setter(instance):
...
def test_hyp_webapp_spinner_values_setter(instance):
...
def test_hyp_webapp_checkbox_description_setter(instance):
...
def test_hyp_webapp_imagesblock_imagesPath_setter(instance):
...
def test_hyp_webapp_gallery_imagesPath_setter(instance):
    original = instance.imagesPath
    instance.imagesPath = original
    assert instance.imagesPath == original
...
def test_hyp_webapp_video_path_setter(instance):
...
def test_hyp_webapp_text_columnNumber_setter(instance):
...
def test_hyp_webapp_widget_title_setter(instance):
...
def test_hyp_webapp_section_description_setter(instance):
    original = instance.description
    instance.description = original
    assert instance.description == original
...
@given(instance=webapp_Section_strategy)
def test_hyp_webapp_section_title_setter(instance):
    original = instance.title
    instance.title = original
    assert instance.title == original
...
def test_hyp_webapp_routermapping_path_setter(instance):
    original = instance.path
    instance.path = original
    assert instance.path == original
...
def test_hyp_webapp_attribute_defaultValue_setter(instance):
...
def test_hyp_webapp_abstractview_description_setter(instance):
    original = instance.description
    instance.description = original
    assert instance.description == original
