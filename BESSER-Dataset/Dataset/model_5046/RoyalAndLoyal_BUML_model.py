...
RandL_LoyaltyProgram_m_addService: Method = Method(name="addService", parameters={Parameter(name='RandL_l', type=StringType), Parameter(name='RandL_s', type=StringType), Parameter(name='RandL_p', type=StringType)})
...
RandL_LoyaltyProgram_m_enrollAndCreateCustomer: Method = Method(name="enrollAndCreateCustomer", parameters={Parameter(name='RandL_n', type=StringType), Parameter(name='RandL_d', type=StringType)}, type=StringType)
...
RandL_LoyaltyProgram_m_addTransaction: Method = Method(name="addTransaction", parameters={Parameter(name='RandL_servId', type=StringType), Parameter(name='RandL_amnt', type=StringType), Parameter(name='RandL_d', type=StringType), Parameter(name='RandL_pName', type=StringType), Parameter(name='RandL_accNr', type=StringType)})
...
RandL_LoyaltyProgram.methods={RandL_LoyaltyProgram_m_enroll, RandL_LoyaltyProgram_m_getServices, RandL_LoyaltyProgram_m_enrollAndCreateCustomer, RandL_LoyaltyProgram_m_getServices, RandL_LoyaltyProgram_m_addTransaction, RandL_LoyaltyProgram_m_addService, RandL_LoyaltyProgram_m_selectPopularPartners}
...
RandL_Service.attributes={RandL_Service_serviceNr, RandL_Service_condition, RandL_Service_description, RandL_Service_pointsBurned, RandL_Service_pointsEarned}
...
RandL_Date_m_fromYMD: Method = Method(name="fromYMD", parameters={Parameter(name='RandL_k', type=StringType), Parameter(name='RandL_y', type=StringType), Parameter(name='RandL_m', type=StringType)}, type=StringType)
RandL_Date.attributes={RandL_Date_month, RandL_Date_year, RandL_Date_day}
RandL_Date.methods={RandL_Date_m_isEqual, RandL_Date_m_isBefore, RandL_Date_m_isAfter, RandL_Date_m_fromYMD}
...
RandL_LoyaltyAccount.attributes={RandL_LoyaltyAccount_totalPointsEarned, RandL_LoyaltyAccount_number, RandL_LoyaltyAccount_points}
RandL_LoyaltyAccount.methods={RandL_LoyaltyAccount_m_earn, RandL_LoyaltyAccount_m_burn, RandL_LoyaltyAccount_m_isEmpty, RandL_LoyaltyAccount_m_getCustomerName}
...
RandL_CustomerCard.attributes={RandL_CustomerCard_printedName, RandL_CustomerCard_color, RandL_CustomerCard_valid}
...
RandL_TransactionReport.attributes={RandL_TransactionReport_totalEarned, RandL_TransactionReport_name, RandL_TransactionReport_balance, RandL_TransactionReport_totalBurned, RandL_TransactionReport_number}
...
domain_model = DomainModel(
    name="RandL",
    types={RandL_ServiceLevel, RandL_LoyaltyProgram, RandL_Service, RandL_Membership, RandL_Transaction, RandL_Earning, Transaction, RandL_ProgramPartner, RandL_Date, RandL_LoyaltyAccount, RandL_CustomerCard, RandL_TransactionReportLine, RandL_Burning, RandL_TransactionReport, RandL_Customer, RandL_Container_RandL, RandLColor, Gender},
    associations={program0, availableServices1, Membership2, usedServices10, Membership11, transactions13, date3, account4, generatedBy5, card8, until19, from_21, lines24, deliveredServices15, programs17, validFrom30, myLevel33, owner35, Membership36, card25, goodThru27, currentLevel41, card43, transactions38, ref_RandL_Date54, ref_RandL_CustomerCard57, ref_RandL_Membership60, ref_RandL_Service63, ref_RandL_LoyaltyProgram66, ref_RandL_Earning69, ref_RandL_LoyaltyAccount71, ref_RandL_ServiceLevel74, account46, programs49, participants50, ref_RandL_Customer52, level89, dateOfBirth91, programs94, cards96, ref_RandL_TransactionReport77, ref_RandL_ProgramPartner80, ref_RandL_Burning82, ref_RandL_TransactionReportLine84, partner86, transactions87, memberships98, date101, transaction104, report107, levels110, participants112, memberships115, partners108},
