...
public class RandL_Customer  {
    ...
    public RandL_Customer(
        String gender,        String age,        String isMale,        String name,        String title    ) {
        this.gender = gender;
        this.age = age;
        this.isMale = isMale;
        this.name = name;
    ...
    public RandL_Customer(
        String gender,        String age,        String isMale,        String name,        String title        ArrayList<RandL_LoyaltyProgram> randl_loyaltyprograms,        ArrayList<RandL_CustomerCard> randl_customercards,        ArrayList<RandL_Membership> randl_memberships    ) {
        this.gender = gender;
        this.age = age;
        this.isMale = isMale;
        this.name = name;
