...
# Classes
ScaffoldGraph_Graph = Class(name="ScaffoldGraph_Graph")
ScaffoldGraph_Vertex = Class(name="ScaffoldGraph_Vertex")
ScaffoldGraph_Edge = Class(name="ScaffoldGraph_Edge")
...
domain_model = DomainModel(
    ...
    associations={EVout7, vertices0, edges1, VEin3, VEout4, EVin6},
    generalizations={},
    metadata=None
)
