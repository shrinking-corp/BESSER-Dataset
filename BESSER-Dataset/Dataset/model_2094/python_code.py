...
class ftp_HydraulicValue(TypedPortValue):
    ...
    def __init__(self, anyPressure: bool, flow: float, pressure: float, anyFlow: bool):
...
class ftp_Port:
    ...
    def __init__(self, name: str, type: str, ftp_Port: "ftp_Connection" = None, ftp_Port17: "ftp_Connection" = None, ftp_Port24: "ftp_PortValue" = None, ftp_Port21: "ftp_ComposedComponent" = None):
        self.name = name
        self.type = type
