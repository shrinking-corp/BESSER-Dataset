...
# Classes
ftp_OrGate = Class(name="ftp_OrGate")
FTNode = Class(name="FTNode")
ftp_AndGate = Class(name="ftp_AndGate")
ftp_Fault = Class(name="ftp_Fault")
ftp_Observation = Class(name="ftp_Observation")
ftp_Component = Class(name="ftp_Component")
ftp_PortValue = Class(name="ftp_PortValue")
CompositionElement = Class(name="CompositionElement")
ftp_Port = Class(name="ftp_Port")
ftp_Connection = Class(name="ftp_Connection")
ftp_DigintalConnection = Class(name="ftp_DigintalConnection")
Connection = Class(name="Connection")
ftp_FaultTree = Class(name="ftp_FaultTree")
ftp_FTNode = Class(name="ftp_FTNode")
ftp_TypedPortValue = Class(name="ftp_TypedPortValue")
ftp_Resistor = Class(name="ftp_Resistor")
PrimitiveComponent = Class(name="PrimitiveComponent")
ftp_ElectricalPort = Class(name="ftp_ElectricalPort")
ftp_Capacitor = Class(name="ftp_Capacitor")
ftp_AnalogBattery = Class(name="ftp_AnalogBattery")
ftp_AnalogSwitch = Class(name="ftp_AnalogSwitch")
ftp_SignalPort = Class(name="ftp_SignalPort")
ftp_AnalogLamp = Class(name="ftp_AnalogLamp")
ftp_AnalogConnection = Class(name="ftp_AnalogConnection")
ftp_SignalConnection = Class(name="ftp_SignalConnection")
DigintalConnection = Class(name="DigintalConnection")
ftp_ElectricalConnection = Class(name="ftp_ElectricalConnection")
AnalogConnection = Class(name="AnalogConnection")
ftp_HydraulicConnection = Class(name="ftp_HydraulicConnection")
ftp_MechanicalConnection = Class(name="ftp_MechanicalConnection")
ftp_PrimitiveComponent = Class(name="ftp_PrimitiveComponent")
Component = Class(name="Component")
ftp_ComposedComponent = Class(name="ftp_ComposedComponent")
ftp_CompositionElement = Class(name="ftp_CompositionElement")
ftp_DigitalLamp = Class(name="ftp_DigitalLamp")
ftp_Not = Class(name="ftp_Not")
ftp_Xor = Class(name="ftp_Xor")
ftp_And = Class(name="ftp_And")
ftp_NTransistor = Class(name="ftp_NTransistor")
ftp_PTransistor = Class(name="ftp_PTransistor")
ftp_DFlipFlop = Class(name="ftp_DFlipFlop")
ftp_VisualPort = Class(name="ftp_VisualPort")
ftp_DigitalBattery = Class(name="ftp_DigitalBattery")
ftp_DigitalSwitch = Class(name="ftp_DigitalSwitch")
Port = Class(name="Port")
ftp_HydraulicPort = Class(name="ftp_HydraulicPort")
ftp_VisualConnection = Class(name="ftp_VisualConnection")
ftp_FaultTreeContext = Class(name="ftp_FaultTreeContext")
ftp_RootEvent = Class(name="ftp_RootEvent")
ftp_MechanicalPort = Class(name="ftp_MechanicalPort")
ftp_SignalValue = Class(name="ftp_SignalValue")
TypedPortValue = Class(name="TypedPortValue")
ftp_ElectricalValue = Class(name="ftp_ElectricalValue")
ftp_VisualValue = Class(name="ftp_VisualValue")
ftp_FloatValue = Class(name="ftp_FloatValue")
ftp_SignalConstant = Class(name="ftp_SignalConstant")
ftp_HydraulicValue = Class(name="ftp_HydraulicValue")
...
ftp_Component.attributes={ftp_Component_type, ftp_Component_name}
...
ftp_Port.attributes={ftp_Port_type, ftp_Port_name}
...
ftp_ElectricalValue.attributes={ftp_ElectricalValue_anyCurrent, ftp_ElectricalValue_voltage, ftp_ElectricalValue_current, ftp_ElectricalValue_anyVoltage}
...
ftp_HydraulicValue.attributes={ftp_HydraulicValue_pressure, ftp_HydraulicValue_flow, ftp_HydraulicValue_anyFlow, ftp_HydraulicValue_anyPressure}
...
domain_model = DomainModel(
    name="ftp",
    types={ftp_OrGate, FTNode, ftp_AndGate, ftp_Fault, ftp_Observation, ftp_Component, ftp_PortValue, CompositionElement, ftp_Port, ftp_Connection, ftp_DigintalConnection, Connection, ftp_FaultTree, ftp_FTNode, ftp_TypedPortValue, ftp_Resistor, PrimitiveComponent, ftp_ElectricalPort, ftp_Capacitor, ftp_AnalogBattery, ftp_AnalogSwitch, ftp_SignalPort, ftp_AnalogLamp, ftp_AnalogConnection, ftp_SignalConnection, DigintalConnection, ftp_ElectricalConnection, AnalogConnection, ftp_HydraulicConnection, ftp_MechanicalConnection, ftp_PrimitiveComponent, Component, ftp_ComposedComponent, ftp_CompositionElement, ftp_DigitalLamp, ftp_Not, ftp_Xor, ftp_And, ftp_NTransistor, ftp_PTransistor, ftp_DFlipFlop, ftp_VisualPort, ftp_DigitalBattery, ftp_DigitalSwitch, Port, ftp_HydraulicPort, ftp_VisualConnection, ftp_FaultTreeContext, ftp_RootEvent, ftp_MechanicalPort, ftp_SignalValue, TypedPortValue, ftp_ElectricalValue, ftp_VisualValue, ftp_FloatValue, ftp_SignalConstant, ftp_HydraulicValue, SignalValues, VisualValues},
    associations={inputs4, inputs6, component8, portValues9, faulttree11, fromPort14, toPort15, ftnodes0, root1, port22, value25, inPort27, outPort28, inPort31, outPort33, inPort36, setPort38, outPort40, inPort43, outPort45, composition18, ports19, setPort57, outPort60, inPort63, outPort65, lightPort68, gate71, source73, drain76, gate79, source81, drain84, inPort87, lightPort48, inPort50, outPort52, inPort55, clockPort89, outPort92, statePort95, composition98, observations100, inputs103, outPort105},
    generalizations={gen_ftp_OrGate_FTNode, gen_ftp_AndGate_FTNode, gen_ftp_Fault_FTNode, gen_ftp_Component_CompositionElement, gen_ftp_Connection_CompositionElement, gen_ftp_DigintalConnection_Connection, gen_ftp_Resistor_PrimitiveComponent, gen_ftp_Capacitor_PrimitiveComponent, gen_ftp_AnalogBattery_PrimitiveComponent, gen_ftp_AnalogSwitch_PrimitiveComponent, gen_ftp_AnalogLamp_PrimitiveComponent, gen_ftp_AnalogConnection_Connection, gen_ftp_SignalConnection_DigintalConnection, gen_ftp_ElectricalConnection_AnalogConnection, gen_ftp_HydraulicConnection_AnalogConnection, gen_ftp_MechanicalConnection_AnalogConnection, gen_ftp_PrimitiveComponent_Component, gen_ftp_ComposedComponent_Component, gen_ftp_DigitalLamp_PrimitiveComponent, gen_ftp_Not_PrimitiveComponent, gen_ftp_Xor_PrimitiveComponent, gen_ftp_And_PrimitiveComponent, gen_ftp_NTransistor_PrimitiveComponent, gen_ftp_PTransistor_PrimitiveComponent, gen_ftp_DFlipFlop_PrimitiveComponent, gen_ftp_DigitalBattery_PrimitiveComponent, gen_ftp_DigitalSwitch_PrimitiveComponent, gen_ftp_SignalPort_Port, gen_ftp_ElectricalPort_Port, gen_ftp_HydraulicPort_Port, gen_ftp_VisualPort_Port, gen_ftp_VisualConnection_Connection, gen_ftp_RootEvent_FTNode, gen_ftp_MechanicalPort_Port, gen_ftp_SignalValue_TypedPortValue, gen_ftp_ElectricalValue_TypedPortValue, gen_ftp_VisualValue_TypedPortValue, gen_ftp_FloatValue_TypedPortValue, gen_ftp_SignalConstant_PrimitiveComponent, gen_ftp_HydraulicValue_TypedPortValue},
    metadata=None
)
