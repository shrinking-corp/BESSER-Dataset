...
class ktest401_RelatedTo(NamedElement):
    ...
    def __init__(self, since: str, ktest401_RelatedTo21: "ktest401_EClass1" = None, relations: "ktest401_Thing" = None, ktest401_RelatedTo: "ktest401_Thing" = None, ktest401_RelatedTo12: set["ktest401_EClass1"] = None, RelatedTo: "ktest401_Thing" = None):
        self.since = since
...
class ktest401_Article(NamedElement):
    ...
    def __init__(self, aid: str, ktest401_Article18: "ktest401_Line" = None, ktest401_Article: "ktest401_World" = None):
        self.aid = aid
...
class ktest401_Thing(NamedElement):
    ...
    def __init__(self, id: int, ktest401_Thing5: set["ktest401_Line"] = None, ktest401_Thing7: set["ktest401_EClass0"] = None, ktest401_Thing15: "ktest401_Line" = None, Thing: "ktest401_RelatedTo" = None, ktest401_Thing10: "ktest401_RelatedTo" = None, ktest401_Thing: "ktest401_World" = None, fromThing: set["ktest401_RelatedTo"] = None):
        self.id = id
