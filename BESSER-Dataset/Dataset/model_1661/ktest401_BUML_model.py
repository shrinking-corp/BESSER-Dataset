...
# Classes
ktest401_Thing = Class(name="ktest401_Thing")
ktest401_Article = Class(name="ktest401_Article")
NamedElement = Class(name="NamedElement")
ktest401_RelatedTo = Class(name="ktest401_RelatedTo")
ktest401_Line = Class(name="ktest401_Line")
ktest401_EClass0 = Class(name="ktest401_EClass0")
ktest401_NamedElement = Class(name="ktest401_NamedElement", is_abstract=True)
ktest401_World = Class(name="ktest401_World")
ktest401_EClass1 = Class(name="ktest401_EClass1")
...
ktest401_EClass1.attributes={ktest401_EClass1_foo, ktest401_EClass1_bar}
...
domain_model = DomainModel(
    name="ktest401",
    types={ktest401_Thing, ktest401_Article, NamedElement, ktest401_RelatedTo, ktest401_Line, ktest401_EClass0, ktest401_NamedElement, ktest401_World, ktest401_EClass1},
    associations={things0, e1s1, relations3, lines4, e0s6, src13, trg16, EReference019, fromThing8, toThing9, e1s11, EReference122},
    generalizations={gen_ktest401_Thing_NamedElement, gen_ktest401_Line_NamedElement, gen_ktest401_Article_NamedElement, gen_ktest401_EClass0_NamedElement, gen_ktest401_EClass1_NamedElement, gen_ktest401_RelatedTo_NamedElement},
    metadata=None
)
