...
def test_hyp_ktest401_world_is_not_abstract():
    assert not inspect.isabstract(ktest401_World)


def test_hyp_ktest401_world_constructor_exists():
    assert callable(ktest401_World.__init__)


def test_hyp_ktest401_world_constructor_args():
    sig = inspect.signature(ktest401_World.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ktest401_namedelement_is_not_abstract():
    assert not inspect.isabstract(ktest401_NamedElement)


def test_hyp_ktest401_namedelement_constructor_exists():
    assert callable(ktest401_NamedElement.__init__)


def test_hyp_ktest401_namedelement_constructor_args():
...
def test_hyp_ktest401_eclass1_is_not_abstract():
    assert not inspect.isabstract(ktest401_EClass1)


def test_hyp_ktest401_eclass1_constructor_exists():
    assert callable(ktest401_EClass1.__init__)


def test_hyp_ktest401_eclass1_constructor_args():
...
def test_hyp_ktest401_line_is_not_abstract():
    assert not inspect.isabstract(ktest401_Line)


def test_hyp_ktest401_line_constructor_exists():
    assert callable(ktest401_Line.__init__)


def test_hyp_ktest401_line_constructor_args():
...
def test_hyp_ktest401_relatedto_is_not_abstract():
    assert not inspect.isabstract(ktest401_RelatedTo)


def test_hyp_ktest401_relatedto_constructor_exists():
    assert callable(ktest401_RelatedTo.__init__)


def test_hyp_ktest401_relatedto_constructor_args():
...
def test_hyp_ktest401_eclass0_is_not_abstract():
    assert not inspect.isabstract(ktest401_EClass0)


def test_hyp_ktest401_eclass0_constructor_exists():
    assert callable(ktest401_EClass0.__init__)


def test_hyp_ktest401_eclass0_constructor_args():
    sig = inspect.signature(ktest401_EClass0.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ktest401_article_is_not_abstract():
    assert not inspect.isabstract(ktest401_Article)


def test_hyp_ktest401_article_constructor_exists():
    assert callable(ktest401_Article.__init__)


def test_hyp_ktest401_article_constructor_args():
...
def test_hyp_ktest401_thing_is_not_abstract():
    assert not inspect.isabstract(ktest401_Thing)


def test_hyp_ktest401_thing_constructor_exists():
    assert callable(ktest401_Thing.__init__)


def test_hyp_ktest401_thing_constructor_args():
...
def test_hyp_ktest401_namedelement_name_setter(instance):
...
def test_hyp_ktest401_eclass1_bar_setter(instance):
...
@given(instance=ktest401_EClass1_strategy)
def test_hyp_ktest401_eclass1_foo_setter(instance):
...
def test_hyp_ktest401_line_quant_setter(instance):
...
@given(instance=ktest401_Line_strategy)
def test_hyp_ktest401_line_articleAid_setter(instance):
...
def test_hyp_ktest401_relatedto_since_setter(instance):
...
def test_hyp_ktest401_article_aid_setter(instance):
...
def test_hyp_ktest401_thing_id_setter(instance):
