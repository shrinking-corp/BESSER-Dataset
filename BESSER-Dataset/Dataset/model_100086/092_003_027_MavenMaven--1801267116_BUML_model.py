...
MavenMaven_Xmlns.attributes={MavenMaven_Xmlns_name, MavenMaven_Xmlns_value}
...
MavenMaven_JellyForEach.attributes={MavenMaven_JellyForEach_items, MavenMaven_JellyForEach_var, MavenMaven_JellyForEach_indexVar}
...
MavenMaven_Mapper.attributes={MavenMaven_Mapper_classpathref, MavenMaven_Mapper_classname, MavenMaven_Mapper_classpath, MavenMaven_Mapper_type, MavenMaven_Mapper_to, MavenMaven_Mapper_from_}
...
MavenMaven_InExcludes.attributes={MavenMaven_InExcludes_ifCondition, MavenMaven_InExcludes_name, MavenMaven_InExcludes_unless}
...
MavenMaven_FilterSet.attributes={MavenMaven_FilterSet_starttoken, MavenMaven_FilterSet_endtoken}
...
MavenMaven_Javadoc.attributes={MavenMaven_Javadoc_packagenames, MavenMaven_Javadoc_use, MavenMaven_Javadoc_destdir, MavenMaven_Javadoc_windowtitle, MavenMaven_Javadoc_version, MavenMaven_Javadoc_defaultexcludes, MavenMaven_Javadoc_sourcepath, MavenMaven_Javadoc_author}
...
MavenMaven_Echo.attributes={MavenMaven_Echo_file, MavenMaven_Echo_append, MavenMaven_Echo_message}
...
MavenMaven_FormatTstamp.attributes={MavenMaven_FormatTstamp_locale, MavenMaven_FormatTstamp_unit, MavenMaven_FormatTstamp_property, MavenMaven_FormatTstamp_offset, MavenMaven_FormatTstamp_pattern}
...
MavenMaven_Javac.attributes={MavenMaven_Javac_srcdir, MavenMaven_Javac_fork, MavenMaven_Javac_debug, MavenMaven_Javac_deprecation, MavenMaven_Javac_destdir, MavenMaven_Javac_optimize}
...
MavenMaven_Delete.attributes={MavenMaven_Delete_dir, MavenMaven_Delete_defaultexcludes, MavenMaven_Delete_failonerror, MavenMaven_Delete_quiet, MavenMaven_Delete_includeEmptyDirs, MavenMaven_Delete_excludes, MavenMaven_Delete_verbose, MavenMaven_Delete_includesfile, MavenMaven_Delete_file, MavenMaven_Delete_excludesfile, MavenMaven_Delete_includes}
...
MavenMaven_Jar.attributes={MavenMaven_Jar_jarfile, MavenMaven_Jar_encoding, MavenMaven_Jar_manifest, MavenMaven_Jar_compress, MavenMaven_Jar_basedir}
...
MavenMaven_Copy.attributes={MavenMaven_Copy_tofile, MavenMaven_Copy_includeEmptyDirs, MavenMaven_Copy_filtering, MavenMaven_Copy_overwrite, MavenMaven_Copy_file, MavenMaven_Copy_flatten, MavenMaven_Copy_presservelastmodified, MavenMaven_Copy_todir}
...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={MavenMaven_AntProperty, ContentsGoal, MavenMaven_AntPropertyName, MavenMaven_AntPropertyValue, AntPropertyName, MavenMaven_AntPropertyLocation, MavenMaven_Project, Xmlns, Goal, Path, AntProperty, AntTaskDef, PrePostGoal, MavenMaven_Xmlns, MavenMaven_PrePostGoal, AbstractGoal, MavenMaven_PreGoal, MavenMaven_PostGoal, MavenMaven_Goal, MavenMaven_AntPropertyFile, MavenMaven_AntPropertyEnv, MavenMaven_JellyCommand, MavenMaven_JellySet, JellyCommand, MavenMaven_JellyForEach, MavenMaven_AbstractGoal, MavenMaven_ContentsGoal, MavenMaven_AttainGoal, MavenMaven_ExcludesFile, MavenMaven_FileList, MavenMaven_Filter, MavenMaven_FiltersFile, PreGoal, PostGoal, MavenMaven_Pattern, MavenMaven_Basic, Pattern, MavenMaven_Mapper, Basic, MavenMaven_InExcludes, MavenMaven_Includes, InExcludes, MavenMaven_Excludes, MavenMaven_IncludesFile, MavenMaven_Path, PathElement, FileSet, MavenMaven_PathElement, MavenMaven_Set, MavenMaven_PatternSet, Set, MavenMaven_FileSet, PatternSet, Includes, Excludes, MavenMaven_FilterSet, Filter, FiltersFile, MavenMaven_ExecutionTask, PreDefinedTask, MavenMaven_Exec, ExecutionTask, MavenMaven_Java, ClassPath, MavenMaven_ClassPath, MavenMaven_Task, MavenMaven_AntTaskDef, MavenMaven_NewTask, Task, Attribut, MavenMaven_Attribut, MavenMaven_PreDefinedTask, MavenMaven_DocumentationTask, MavenMaven_Javadoc, DocumentationTask, MavenMaven_MiscellaneousTask, MavenMaven_Echo, MiscellaneousTask, MavenMaven_Tstamp, FormatTstamp, MavenMaven_FormatTstamp, MavenMaven_CompileTask, MavenMaven_Javac, CompileTask, FilterSet, Mapper, MavenMaven_Delete, MavenMaven_ArchiveTask, MavenMaven_Jar, ArchiveTask, MavenMaven_FileTask, MavenMaven_Mkdir, FileTask, MavenMaven_Copy},
    associations={xmlns0, default1, path3, properties5, taskdefs7, prePostGoals9, goals11, centralGoal19, centralGoal21, contents14, contentsGoal15, attainGoal17, preGoal23, postGoal24, filtersfile33, path35, pathElement37, fileset39, inexcludes26, patternset27, include28, exclude30, filter32, pathElement41, fileset43, taskName46, attributes48, inExcludes52, classPath54, classPath50, format51, fileset57, filterset59, mapper61},
    generalizations={gen_MavenMaven_AntProperty_ContentsGoal, gen_MavenMaven_AntPropertyName_AntProperty, gen_MavenMaven_AntPropertyValue_AntPropertyName, gen_MavenMaven_AntPropertyLocation_AntPropertyName, gen_MavenMaven_PrePostGoal_AbstractGoal, gen_MavenMaven_PreGoal_PrePostGoal, gen_MavenMaven_PostGoal_PrePostGoal, gen_MavenMaven_Goal_AbstractGoal, gen_MavenMaven_AntPropertyFile_AntProperty, gen_MavenMaven_AntPropertyEnv_AntProperty, gen_MavenMaven_JellyCommand_ContentsGoal, gen_MavenMaven_JellySet_JellyCommand, gen_MavenMaven_JellyForEach_JellyCommand, gen_MavenMaven_AttainGoal_ContentsGoal, gen_MavenMaven_IncludesFile_InExcludes, gen_MavenMaven_ExcludesFile_InExcludes, gen_MavenMaven_FileList_Basic, gen_MavenMaven_Filter_Basic, gen_MavenMaven_FiltersFile_Basic, gen_MavenMaven_Basic_Pattern, gen_MavenMaven_Mapper_Basic, gen_MavenMaven_InExcludes_Basic, gen_MavenMaven_Includes_InExcludes, gen_MavenMaven_Excludes_InExcludes, gen_MavenMaven_Path_Set, gen_MavenMaven_PathElement_Basic, gen_MavenMaven_Set_Pattern, gen_MavenMaven_PatternSet_Set, gen_MavenMaven_FileSet_Set, gen_MavenMaven_FilterSet_Set, gen_MavenMaven_ExecutionTask_PreDefinedTask, gen_MavenMaven_Exec_ExecutionTask, gen_MavenMaven_Java_ExecutionTask, gen_MavenMaven_ClassPath_Set, gen_MavenMaven_Task_ContentsGoal, gen_MavenMaven_AntTaskDef_ContentsGoal, gen_MavenMaven_NewTask_Task, gen_MavenMaven_PreDefinedTask_Task, gen_MavenMaven_DocumentationTask_PreDefinedTask, gen_MavenMaven_Javadoc_DocumentationTask, gen_MavenMaven_MiscellaneousTask_PreDefinedTask, gen_MavenMaven_Echo_MiscellaneousTask, gen_MavenMaven_Tstamp_MiscellaneousTask, gen_MavenMaven_CompileTask_PreDefinedTask, gen_MavenMaven_Javac_CompileTask, gen_MavenMaven_Delete_FileTask, gen_MavenMaven_ArchiveTask_PreDefinedTask, gen_MavenMaven_Jar_ArchiveTask, gen_MavenMaven_FileTask_PreDefinedTask, gen_MavenMaven_Mkdir_FileTask, gen_MavenMaven_Copy_FileTask},
    metadata=None
)
