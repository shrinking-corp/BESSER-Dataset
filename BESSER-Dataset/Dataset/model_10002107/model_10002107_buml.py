...
Profile.attributes={Profile_password, Profile_username, Profile_about}
...
Registration.attributes={Registration_lname, Registration_userName, Registration_password, Registration_fname}
...
domain_model = DomainModel(
    name="_oh2_EGSTEeqK2M3E1LfZ7Q",
    types={Profile, Post, Group, public, secret, Message, Friend, Hashtag, Page, Registration, Login, User},
