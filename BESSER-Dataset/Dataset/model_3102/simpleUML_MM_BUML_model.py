...
# Classes
simpleUML_MM_ClassModel = Class(name="simpleUML_MM_ClassModel")
simpleUML_MM_Classifier = Class(name="simpleUML_MM_Classifier", is_abstract=True)
simpleUML_MM_Association = Class(name="simpleUML_MM_Association")
simpleUML_MM_Class = Class(name="simpleUML_MM_Class")
simpleUML_MM_Attribute = Class(name="simpleUML_MM_Attribute")
Classifier = Class(name="Classifier")
simpleUML_MM_PrimitiveDataType = Class(name="simpleUML_MM_PrimitiveDataType")
...
simpleUML_MM_Attribute.attributes={simpleUML_MM_Attribute_name, simpleUML_MM_Attribute_is_primary}
...
domain_model = DomainModel(
    name="simpleUML_MM",
    types={simpleUML_MM_ClassModel, simpleUML_MM_Classifier, simpleUML_MM_Association, simpleUML_MM_Class, simpleUML_MM_Attribute, Classifier, simpleUML_MM_PrimitiveDataType},
    associations={classifier11, src0, dest1, type4, attrs5, parent9, association13},
