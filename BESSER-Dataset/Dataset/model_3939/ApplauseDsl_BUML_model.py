...
applauseDsl_NamedElement = Class(name="applauseDsl_NamedElement")
applauseDsl_Type = Class(name="applauseDsl_Type")
NamedElement = Class(name="NamedElement")
applauseDsl_DataType = Class(name="applauseDsl_DataType")
Type = Class(name="Type")
UIComponentOrDataType = Class(name="UIComponentOrDataType")
applauseDsl_Entity = Class(name="applauseDsl_Entity")
applauseDsl_Attribute = Class(name="applauseDsl_Attribute")
applauseDsl_Platform = Class(name="applauseDsl_Platform")
applauseDsl_PlatformMapping = Class(name="applauseDsl_PlatformMapping")
applauseDsl_TypeMapping = Class(name="applauseDsl_TypeMapping")
PlatformMapping = Class(name="PlatformMapping")
applauseDsl_DataSource = Class(name="applauseDsl_DataSource")
applauseDsl_AbsoluteRESTURL = Class(name="applauseDsl_AbsoluteRESTURL")
applauseDsl_DataSourceAccessMethod = Class(name="applauseDsl_DataSourceAccessMethod")
applauseDsl_RESTURL = Class(name="applauseDsl_RESTURL")
applauseDsl_DataSourceBodySpecification = Class(name="applauseDsl_DataSourceBodySpecification")
ReferrableElement = Class(name="ReferrableElement")
applauseDsl_UrlFragment = Class(name="applauseDsl_UrlFragment")
RESTURL = Class(name="RESTURL")
applauseDsl_RelativeRESTURL = Class(name="applauseDsl_RelativeRESTURL")
applauseDsl_UrlPathFragment = Class(name="applauseDsl_UrlPathFragment")
UrlFragment = Class(name="UrlFragment")
applauseDsl_Variable = Class(name="applauseDsl_Variable")
applauseDsl_Screen = Class(name="applauseDsl_Screen")
applauseDsl_Parameter = Class(name="applauseDsl_Parameter")
applauseDsl_RESTSpecification = Class(name="applauseDsl_RESTSpecification")
applauseDsl_ScreenSectionItems = Class(name="applauseDsl_ScreenSectionItems")
applauseDsl_ScreenListItemCell = Class(name="applauseDsl_ScreenListItemCell")
applauseDsl_ListItemCellDeclaration = Class(name="applauseDsl_ListItemCellDeclaration")
applauseDsl_RESTMethodCall = Class(name="applauseDsl_RESTMethodCall")
applauseDsl_LoopVariable = Class(name="applauseDsl_LoopVariable")
applauseDsl_UIComponentMemberConfiguration = Class(name="applauseDsl_UIComponentMemberConfiguration")
applauseDsl_ReferrableElement = Class(name="applauseDsl_ReferrableElement")
applauseDsl_UIActionSpecification = Class(name="applauseDsl_UIActionSpecification")
applauseDsl_UIActionNavigateAction = Class(name="applauseDsl_UIActionNavigateAction")
UIActionSpecification = Class(name="UIActionSpecification")
applauseDsl_DataSourceCall = Class(name="applauseDsl_DataSourceCall")
applauseDsl_ScreenSection = Class(name="applauseDsl_ScreenSection")
applauseDsl_UIAction = Class(name="applauseDsl_UIAction")
applauseDsl_UIActionDeleteAction = Class(name="applauseDsl_UIActionDeleteAction")
applauseDsl_UIComponentMemberDeclaration = Class(name="applauseDsl_UIComponentMemberDeclaration")
applauseDsl_UIComponentDeclaration = Class(name="applauseDsl_UIComponentDeclaration")
applauseDsl_UIComponentOrDataType = Class(name="applauseDsl_UIComponentOrDataType")
applauseDsl_UIComponentMemberCall = Class(name="applauseDsl_UIComponentMemberCall")
applauseDsl_Expression = Class(name="applauseDsl_Expression")
applauseDsl_EntityMemberCall = Class(name="applauseDsl_EntityMemberCall")
Expression = Class(name="Expression")
applauseDsl_EntityMemberCallTail = Class(name="applauseDsl_EntityMemberCallTail")
applauseDsl_StringLiteral = Class(name="applauseDsl_StringLiteral")
applauseDsl_AttributeReference = Class(name="applauseDsl_AttributeReference")
...
applauseDsl_Attribute.attributes={applauseDsl_Attribute_name, applauseDsl_Attribute_many}
...
applauseDsl_UIAction.attributes={applauseDsl_UIAction_icon, applauseDsl_UIAction_gesture, applauseDsl_UIAction_order, applauseDsl_UIAction_title}
...
domain_model = DomainModel(
    name="applauseDsl",
    types={applauseDsl_Model, applauseDsl_NamedElement, applauseDsl_Type, NamedElement, applauseDsl_DataType, Type, UIComponentOrDataType, applauseDsl_Entity, applauseDsl_Attribute, applauseDsl_Platform, applauseDsl_PlatformMapping, applauseDsl_TypeMapping, PlatformMapping, applauseDsl_DataSource, applauseDsl_AbsoluteRESTURL, applauseDsl_DataSourceAccessMethod, applauseDsl_RESTURL, applauseDsl_DataSourceBodySpecification, ReferrableElement, applauseDsl_UrlFragment, RESTURL, applauseDsl_RelativeRESTURL, applauseDsl_UrlPathFragment, UrlFragment, applauseDsl_Variable, applauseDsl_Screen, applauseDsl_Parameter, applauseDsl_RESTSpecification, applauseDsl_ScreenSectionItems, applauseDsl_ScreenListItemCell, applauseDsl_ListItemCellDeclaration, applauseDsl_RESTMethodCall, applauseDsl_LoopVariable, applauseDsl_UIComponentMemberConfiguration, applauseDsl_ReferrableElement, applauseDsl_UIActionSpecification, applauseDsl_UIActionNavigateAction, UIActionSpecification, applauseDsl_DataSourceCall, applauseDsl_ScreenSection, applauseDsl_UIAction, applauseDsl_UIActionDeleteAction, applauseDsl_UIComponentMemberDeclaration, applauseDsl_UIComponentDeclaration, applauseDsl_UIComponentOrDataType, applauseDsl_UIComponentMemberCall, applauseDsl_Expression, applauseDsl_EntityMemberCall, Expression, applauseDsl_EntityMemberCallTail, applauseDsl_StringLiteral, applauseDsl_AttributeReference, RESTVerb, ScreenKind, GestureKind, UIActionKind, ActionVerb},
    associations={elements0, superType2, attributes3, type5, mappings7, type8, baseUrl9, resourceType10, restSpecification17, path19, body21, bodycontents23, type26, fragments29, host31, parameterReference34, inputParameter36, methods13, declaredParameters15, datasource44, items47, items49, type51, restMethod53, variable55, configurations57, actions59, action62, datasource38, sections40, actions42, members68, members70, type72, datasource74, restMethod77, datasource80, type83, value85, component87, member90, head93, tail95, targetScreen64, variable66, head97, tail101, value103},
