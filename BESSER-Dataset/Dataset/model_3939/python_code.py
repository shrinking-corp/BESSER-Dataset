...
class applauseDsl_DataSourceAccessMethod:
    ...
    def __init__(self, name: str, returnsMany: bool, applauseDsl_DataSourceAccessMethod18: "applauseDsl_RESTSpecification" = None, applauseDsl_DataSourceAccessMethod: "applauseDsl_DataSource" = None, applauseDsl_DataSourceAccessMethod16: set["applauseDsl_Parameter"] = None, applauseDsl_DataSourceAccessMethod79: "applauseDsl_RESTMethodCall" = None):
        self.name = name
...
class applauseDsl_UIComponentMemberDeclaration:
    ...
    def __init__(self, name: str, applauseDsl_UIComponentMemberDeclaration89: "applauseDsl_UIComponentMemberCall" = None, applauseDsl_UIComponentMemberDeclaration92: "applauseDsl_UIComponentMemberCall" = None, applauseDsl_UIComponentMemberDeclaration: "applauseDsl_ListItemCellDeclaration" = None, applauseDsl_UIComponentMemberDeclaration71: "applauseDsl_UIComponentDeclaration" = None, applauseDsl_UIComponentMemberDeclaration73: "applauseDsl_UIComponentOrDataType" = None):
        self.name = name
...
class applauseDsl_UIAction:
    ...
    def __init__(self, title: str, icon: str, gesture: str, order: int, applauseDsl_UIAction61: "applauseDsl_ScreenListItemCell" = None, applauseDsl_UIAction63: "applauseDsl_UIActionSpecification" = None, applauseDsl_UIAction: "applauseDsl_Screen" = None):
        self.title = title
        self.icon = icon
...
class applauseDsl_ScreenSection:
    ...
    def __init__(self, title: str, applauseDsl_ScreenSection45: "applauseDsl_DataSourceCall" = None, applauseDsl_ScreenSection48: "applauseDsl_ScreenSectionItems" = None, applauseDsl_ScreenSection: "applauseDsl_Screen" = None):
        self.title = title
...
class applauseDsl_DataSourceCall:
    ...
    def __init__(self, name: str, applauseDsl_DataSourceCall46: "applauseDsl_ScreenSection" = None, applauseDsl_DataSourceCall: "applauseDsl_Screen" = None, applauseDsl_DataSourceCall76: "applauseDsl_RESTMethodCall" = None, applauseDsl_DataSourceCall81: "applauseDsl_DataSource" = None):
        self.name = name
...
class applauseDsl_Screen(NamedElement):
    ...
    def __init__(self, kind: str, title: str, applauseDsl_Screen65: "applauseDsl_UIActionNavigateAction" = None, applauseDsl_Screen: "applauseDsl_Parameter" = None, applauseDsl_Screen39: "applauseDsl_DataSourceCall" = None, applauseDsl_Screen41: set["applauseDsl_ScreenSection"] = None, applauseDsl_Screen43: set["applauseDsl_UIAction"] = None):
        self.kind = kind
        self.title = title
