...
# Classes
cloudml_core_WithProperties = Class(name="cloudml_core_WithProperties", is_abstract=True)
...
cloudml_core_DeploymentModel = Class(name="cloudml_core_DeploymentModel")
...
cloudml_core_NamedElement = Class(name="cloudml_core_NamedElement", is_abstract=True)
...
cloudml_core_Node = Class(name="cloudml_core_Node")
BindingInstance = Class(name="BindingInstance")
cloudml_core_ArtefactPort = Class(name="cloudml_core_ArtefactPort", is_abstract=True)
cloudml_core_ServerPort = Class(name="cloudml_core_ServerPort")
ArtefactPort = Class(name="ArtefactPort")
cloudml_core_ClientPort = Class(name="cloudml_core_ClientPort")
cloudml_core_Artefact = Class(name="cloudml_core_Artefact")
cloudml_core_ArtefactPortInstance = Class(name="cloudml_core_ArtefactPortInstance")
cloudml_core_Composite = Class(name="cloudml_core_Composite")
cloudml_core_Binding = Class(name="cloudml_core_Binding")
cloudml_core_BindingInstance = Class(name="cloudml_core_BindingInstance")
cloudml_core_UploadCommand = Class(name="cloudml_core_UploadCommand")
cloudml_core_ServerPortInstance = Class(name="cloudml_core_ServerPortInstance")
ArtefactPortInstance = Class(name="ArtefactPortInstance")
cloudml_core_ClientPortInstance = Class(name="cloudml_core_ClientPortInstance")
cloudml_core_ArtefactInstance = Class(name="cloudml_core_ArtefactInstance")
ServerPortInstance = Class(name="ServerPortInstance")
ClientPortInstance = Class(name="ClientPortInstance")
cloudml_core_NodeInstance = Class(name="cloudml_core_NodeInstance")
...
cloudml_core_Resource.attributes={cloudml_core_Resource_startCommand, cloudml_core_Resource_deployingCommand, cloudml_core_Resource_stopCommand, cloudml_core_Resource_configurationCommand, cloudml_core_Resource_retrievingCommand}
...
cloudml_core_Node.attributes={cloudml_core_Node_minRam, cloudml_core_Node_securityGroup, cloudml_core_Node_privateKey, cloudml_core_Node_sshKey, cloudml_core_Node_minDisk, cloudml_core_Node_groupName, cloudml_core_Node_imageID, cloudml_core_Node_is64os, cloudml_core_Node_minCore, cloudml_core_Node_location, cloudml_core_Node_OS}
...
cloudml_core_ArtefactPort.attributes={cloudml_core_ArtefactPort_portNumber, cloudml_core_ArtefactPort_isRemote}
...
domain_model = DomainModel(
    name="cloudml",
    types={cloudml_core_WithProperties, Property_, cloudml_core_Resource, WithProperties, UploadCommand, cloudml_core_Provider, cloudml_core_DeploymentModel, Provider, Artefact, Node, cloudml_core_CloudMLElement, cloudml_core_NamedElement, CloudMLElement, cloudml_core_Property, NamedElement, Resource, Binding, ServerPort, ArtefactInstance, ClientPort, NodeInstance, cloudml_core_Node, BindingInstance, cloudml_core_ArtefactPort, cloudml_core_ServerPort, ArtefactPort, cloudml_core_ClientPort, cloudml_core_Artefact, cloudml_core_ArtefactPortInstance, cloudml_core_Composite, cloudml_core_Binding, cloudml_core_BindingInstance, cloudml_core_UploadCommand, cloudml_core_ServerPortInstance, ArtefactPortInstance, cloudml_core_ClientPortInstance, cloudml_core_ArtefactInstance, ServerPortInstance, ClientPortInstance, cloudml_core_NodeInstance},
    associations={properties0, uploadCommand1, providers2, artefactTypes3, destination15, nodeTypes5, resource16, bindingTypes7, provided18, artefactInstances9, required20, nodeInstances11, cloudProvider22, bindingInstances13, type24, containedArtefacts37, client39, server41, clientResource44, serverResource47, type50, client52, server55, type26, destination28, provided31, required33, type35},
    generalizations={gen_cloudml_core_WithProperties_NamedElement, gen_cloudml_core_Resource_WithProperties, gen_cloudml_core_Provider_WithProperties, gen_cloudml_core_DeploymentModel_WithProperties, gen_cloudml_core_NamedElement_CloudMLElement, gen_cloudml_core_Property_NamedElement, gen_cloudml_core_Node_WithProperties, gen_cloudml_core_ArtefactPort_WithProperties, gen_cloudml_core_ServerPort_ArtefactPort, gen_cloudml_core_ClientPort_ArtefactPort, gen_cloudml_core_Artefact_WithProperties, gen_cloudml_core_ArtefactPortInstance_WithProperties, gen_cloudml_core_Composite_NamedElement, gen_cloudml_core_Binding_WithProperties, gen_cloudml_core_BindingInstance_WithProperties, gen_cloudml_core_ServerPortInstance_ArtefactPortInstance, gen_cloudml_core_ClientPortInstance_ArtefactPortInstance, gen_cloudml_core_ArtefactInstance_WithProperties, gen_cloudml_core_NodeInstance_WithProperties},
    metadata=None
)
