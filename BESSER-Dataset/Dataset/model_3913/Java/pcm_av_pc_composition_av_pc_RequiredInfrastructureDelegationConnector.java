...
public class pcm_av_pc_composition_av_pc_RequiredInfrastructureDelegationConnector extends DelegationConnector {
    ...
    public pcm_av_pc_composition_av_pc_RequiredInfrastructureDelegationConnector(
    ) {
        super(
        );
    }
