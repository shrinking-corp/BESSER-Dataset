...
public class pcm_av_pc_completions_av_pc_NetworkDemandParametricResourceDemand extends ParametricResourceDemand {
    ...
    public pcm_av_pc_completions_av_pc_NetworkDemandParametricResourceDemand(
    ) {
        super(
        );
    }
