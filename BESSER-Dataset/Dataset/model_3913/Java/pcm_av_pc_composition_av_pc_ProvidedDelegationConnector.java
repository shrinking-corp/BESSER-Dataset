...
public class pcm_av_pc_composition_av_pc_ProvidedDelegationConnector extends DelegationConnector {
    ...
    public pcm_av_pc_composition_av_pc_ProvidedDelegationConnector(
    ) {
        super(
        );
    }
