...
public class pcm_av_pc_composition_av_pc_SinkDelegationConnector extends DelegationConnector {
    ...
    public pcm_av_pc_composition_av_pc_SinkDelegationConnector(
    ) {
        super(
        );
    }
    ...
    public void setSinkrole(SinkRole sinkrole) {
