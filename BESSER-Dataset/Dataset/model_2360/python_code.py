...
class SimpleRDBMS_RdbmsColumn(RdbmsModelElement):
    ...
    def __init__(self, rdbmsType: str, rdbmsColumn2: set["SimpleRDBMS_RdbmsKey"] = None, rdbmsColumn4: set["SimpleRDBMS_RdbmsForeignKey"] = None, RdbmsColumn: "SimpleRDBMS_RdbmsForeignKey" = None, rdbmsColumn: "SimpleRDBMS_RdbmsTable" = None, RdbmsColumn12: "SimpleRDBMS_RdbmsKey" = None, RdbmsColumn21: "SimpleRDBMS_RdbmsTable" = None):
