...
domain_model = DomainModel(
    name="SimpleRDBMS",
    types={SimpleRDBMS_RdbmsForeignKey, SimpleRDBMS_RdbmsColumn, RdbmsModelElement, SimpleRDBMS_RdbmsTable, SimpleRDBMS_RdbmsKey, SimpleRDBMS_RdbmsModelElement, SimpleRDBMS_RdbmsSchema},
    associations={rdbmsKey1, rdbmsForeignKey3, rdbmsOwner5, rdbmsRefersTo7, rdbmsColumn9, rdbmsOwner0, rdbmsForeignKey22, rdbmsKey25, rdbmsSchema28, rdbmsColumn11, rdbmsRefersToOpposite13, rdbmsOwner15, rdbmsTable18, rdbmsColumn20},
    generalizations={gen_SimpleRDBMS_RdbmsForeignKey_RdbmsModelElement, gen_SimpleRDBMS_RdbmsKey_RdbmsModelElement, gen_SimpleRDBMS_RdbmsColumn_RdbmsModelElement, gen_SimpleRDBMS_RdbmsSchema_RdbmsModelElement, gen_SimpleRDBMS_RdbmsTable_RdbmsModelElement},
    metadata=None
)
