...
sgraph_State.attributes={sgraph_State_composite, sgraph_State_simple, sgraph_State_substatechartId, sgraph_State_leaf, sgraph_State_orthogonal, sgraph_State_subchart}
...
domain_model = DomainModel(
    name="sgraph",
    types={sgraph_Pseudostate, Vertex, sgraph_Vertex, NamedElement, sgraph_Region, sgraph_Reaction, sgraph_Transition, sgraph_CompositeElement, SpecificationElement, Reaction, sgraph_FinalState, RegularState, sgraph_Variable, Declaration, sgraph_Event, sgraph_Choice, Pseudostate, sgraph_Statechart, ReactiveElement, ScopedElement, CompositeElement, sgraph_Entry, sgraph_Trigger, sgraph_Effect, sgraph_SpecificationElement, sgraph_Declaration, sgraph_Statement, sgraph_RegularState, sgraph_ReactiveElement, sgraph_Exit, sgraph_Scope, sgraph_ScopedElement, sgraph_Synchronization, sgraph_State, EntryKind, ChoiceKind},
    associations={incomingTransitions1, outgoingTransitions2, parentRegion0, trigger10, effect11, vertices4, composite5, target6, source8, reactions13, localReactions15, declarations18, events19, variables21, scopes23, substatechart25, regions26},
    generalizations={gen_sgraph_Region_NamedElement, gen_sgraph_Pseudostate_Vertex, gen_sgraph_Vertex_NamedElement, gen_sgraph_Transition_SpecificationElement, gen_sgraph_Transition_Reaction, gen_sgraph_FinalState_RegularState, gen_sgraph_Variable_Declaration, gen_sgraph_Event_Declaration, gen_sgraph_Choice_Pseudostate, gen_sgraph_Statechart_SpecificationElement, gen_sgraph_Statechart_ReactiveElement, gen_sgraph_Statechart_ScopedElement, gen_sgraph_Statechart_CompositeElement, gen_sgraph_Statechart_NamedElement, gen_sgraph_Entry_Pseudostate, gen_sgraph_Declaration_NamedElement, gen_sgraph_RegularState_Vertex, gen_sgraph_Exit_Pseudostate, gen_sgraph_Synchronization_Pseudostate, gen_sgraph_State_SpecificationElement, gen_sgraph_State_ReactiveElement, gen_sgraph_State_ScopedElement, gen_sgraph_State_RegularState, gen_sgraph_State_CompositeElement},
    metadata=None
)
