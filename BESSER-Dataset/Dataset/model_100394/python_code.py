...
class sgraph_Statechart(CompositeElement, NamedElement, SpecificationElement, ScopedElement, ReactiveElement):
...
class sgraph_Pseudostate(Vertex):
    ...
    pass
class sgraph_State(CompositeElement, RegularState, SpecificationElement, ScopedElement, ReactiveElement):

    def __init__(self, simple: bool, composite: bool, leaf: bool, orthogonal: bool, substatechartId: str, subchart: bool, sgraph_State: "sgraph_Statechart" = None):
        self.simple = simple
