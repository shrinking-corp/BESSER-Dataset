...
# Classes
DAG_Graph = Class(name="DAG_Graph")
DAG_Revision = Class(name="DAG_Revision")
DAG_Node = Class(name="DAG_Node")
...
domain_model = DomainModel(
    name="DAG",
    types={DAG_Graph, DAG_Revision, DAG_Node, DAG_Edge},
    associations={revision9, from_11, to13, nodes0, parents2, children4, outgoing6, incoming7},
    generalizations={},
    metadata=None
)
