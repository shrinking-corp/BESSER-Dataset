...
class DAG_Edge:
    ...
    def __init__(self, ID: int, name: str, outgoing: "DAG_Node" = None, incoming: "DAG_Node" = None, Edge: "DAG_Node" = None, Edge8: "DAG_Node" = None):
        self.ID = ID
        self.name = name
...
class DAG_Node:
    ...
    def __init__(self, ID: int, name: str, level: int, DAG_Node10: "DAG_Revision" = None, Node12: "DAG_Edge" = None, Node14: "DAG_Edge" = None, DAG_Node: "DAG_Graph" = None, Node: "DAG_Node" = None, children: set["DAG_Node"] = None, Node5: "DAG_Node" = None, parents: set["DAG_Node"] = None, from_: set["DAG_Edge"] = None, to: set["DAG_Edge"] = None):
        self.ID = ID
        self.name = name
        self.level = level
    ...
    def from_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_DAG_Node__from_", None)
