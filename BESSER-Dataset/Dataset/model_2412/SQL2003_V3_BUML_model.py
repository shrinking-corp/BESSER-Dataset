...
# Classes
SQL2003_V3_ARRAY = Class(name="SQL2003_V3_ARRAY")
CollectionType = Class(name="CollectionType")
SQL2003_V3_Attribute = Class(name="SQL2003_V3_Attribute")
StructuralComponent = Class(name="StructuralComponent")
SQL2003_V3_StructuredType = Class(name="SQL2003_V3_StructuredType")
SQL2003_V3_BaseTable = Class(name="SQL2003_V3_BaseTable")
Table = Class(name="Table")
SQL2003_V3_BehaviouralComponent = Class(name="SQL2003_V3_BehaviouralComponent", is_abstract=True)
SQL2003_V3_Schema = Class(name="SQL2003_V3_Schema")
SQL2003_V3_ParameterWithMode = Class(name="SQL2003_V3_ParameterWithMode")
SQL2003_V3_BinaryStringType = Class(name="SQL2003_V3_BinaryStringType")
PredefinedType = Class(name="PredefinedType")
SQL2003_V3_BooleanType = Class(name="SQL2003_V3_BooleanType")
SQL2003_V3_CharacterStringType = Class(name="SQL2003_V3_CharacterStringType")
SQL2003_V3_DataType = Class(name="SQL2003_V3_DataType", is_abstract=True)
SQL2003_V3_Column = Class(name="SQL2003_V3_Column")
SQL2003_V3_Table = Class(name="SQL2003_V3_Table", is_abstract=True)
SQL2003_V3_ColumnConstraint = Class(name="SQL2003_V3_ColumnConstraint", is_abstract=True)
Restriction = Class(name="Restriction")
SQL2003_V3_ConstructedType = Class(name="SQL2003_V3_ConstructedType", is_abstract=True)
DataType = Class(name="DataType")
SQL2003_V3_DatetimeFeature = Class(name="SQL2003_V3_DatetimeFeature")
Feature = Class(name="Feature")
SQL2003_V3_DatetimeType = Class(name="SQL2003_V3_DatetimeType")
SQL2003_V3_DerivedTable = Class(name="SQL2003_V3_DerivedTable")
SQL2003_V3_DistinctType = Class(name="SQL2003_V3_DistinctType")
UserDefinedType = Class(name="UserDefinedType")
SQL2003_V3_PredefinedType = Class(name="SQL2003_V3_PredefinedType", is_abstract=True)
SQL2003_V3_Feature = Class(name="SQL2003_V3_Feature", is_abstract=True)
SQL2003_V3_Domain = Class(name="SQL2003_V3_Domain")
SQL2003_V3_CollectionType = Class(name="SQL2003_V3_CollectionType", is_abstract=True)
ConstructedType = Class(name="ConstructedType")
SQL2003_V3_Field = Class(name="SQL2003_V3_Field")
SQL2003_V3_ROW = Class(name="SQL2003_V3_ROW")
SQL2003_V3_Function = Class(name="SQL2003_V3_Function")
BehaviouralComponent = Class(name="BehaviouralComponent")
SQL2003_V3_IntervalFeature = Class(name="SQL2003_V3_IntervalFeature")
SQL2003_V3_IntervalType = Class(name="SQL2003_V3_IntervalType")
SQL2003_V3_MULTISET = Class(name="SQL2003_V3_MULTISET")
SQL2003_V3_Method = Class(name="SQL2003_V3_Method")
SQL2003_V3_StructuralComponent = Class(name="SQL2003_V3_StructuralComponent", is_abstract=True)
SQL2003_V3_DomainConstraint = Class(name="SQL2003_V3_DomainConstraint")
TableConstraint = Class(name="TableConstraint")
Parameter_ = Class(name="Parameter")
SQL2003_V3_NotNull = Class(name="SQL2003_V3_NotNull")
ColumnConstraint = Class(name="ColumnConstraint")
SQL2003_V3_NumericFeature = Class(name="SQL2003_V3_NumericFeature")
SQL2003_V3_NumericType = Class(name="SQL2003_V3_NumericType")
SQL2003_V3_Parameter = Class(name="SQL2003_V3_Parameter", is_abstract=True)
SQL2003_V3_MethodParameter = Class(name="SQL2003_V3_MethodParameter")
SQL2003_V3_PrimaryKey = Class(name="SQL2003_V3_PrimaryKey")
UniqueConstraint = Class(name="UniqueConstraint")
SQL2003_V3_Procedure = Class(name="SQL2003_V3_Procedure")
SQL2003_V3_ReferenceType = Class(name="SQL2003_V3_ReferenceType")
SQL2003_V3_ReferentialConstraint = Class(name="SQL2003_V3_ReferentialConstraint")
SQL2003_V3_UniqueConstraint = Class(name="SQL2003_V3_UniqueConstraint")
SQL2003_V3_Restriction = Class(name="SQL2003_V3_Restriction", is_abstract=True)
SQL2003_V3_View = Class(name="SQL2003_V3_View")
SQL2003_V3_TypedTable = Class(name="SQL2003_V3_TypedTable")
SQL2003_V3_StringFeature = Class(name="SQL2003_V3_StringFeature")
SQL2003_V3_TableCheckConstraint = Class(name="SQL2003_V3_TableCheckConstraint")
SQL2003_V3_TableConstraint = Class(name="SQL2003_V3_TableConstraint", is_abstract=True)
SQL2003_V3_Trigger = Class(name="SQL2003_V3_Trigger")
SQL2003_V3_TriggerDescriptor = Class(name="SQL2003_V3_TriggerDescriptor")
BaseTable = Class(name="BaseTable")
SQL2003_V3_XMLType = Class(name="SQL2003_V3_XMLType")
SQL2003_V3_UserDefinedType = Class(name="SQL2003_V3_UserDefinedType", is_abstract=True)
...
SQL2003_V3_StructuredType.attributes={SQL2003_V3_StructuredType_is_final, SQL2003_V3_StructuredType_is_instantiable}
...
SQL2003_V3_BinaryStringType.attributes={SQL2003_V3_BinaryStringType_length_def, SQL2003_V3_BinaryStringType_descriptor}
...
SQL2003_V3_CharacterStringType.attributes={SQL2003_V3_CharacterStringType_descriptor, SQL2003_V3_CharacterStringType_length_def}
...
SQL2003_V3_DatetimeFeature.attributes={SQL2003_V3_DatetimeFeature_key, SQL2003_V3_DatetimeFeature_value}
...
SQL2003_V3_Domain.attributes={SQL2003_V3_Domain_default, SQL2003_V3_Domain_expression, SQL2003_V3_Domain_name}
...
SQL2003_V3_IntervalFeature.attributes={SQL2003_V3_IntervalFeature_value, SQL2003_V3_IntervalFeature_key}
...
SQL2003_V3_ReferentialConstraint.attributes={SQL2003_V3_ReferentialConstraint_update_action, SQL2003_V3_ReferentialConstraint_delete_action, SQL2003_V3_ReferentialConstraint_match}
...
SQL2003_V3_StringFeature.attributes={SQL2003_V3_StringFeature_value, SQL2003_V3_StringFeature_key}
...
SQL2003_V3_TriggerDescriptor.attributes={SQL2003_V3_TriggerDescriptor_actionTime, SQL2003_V3_TriggerDescriptor_level, SQL2003_V3_TriggerDescriptor_triggeredAction, SQL2003_V3_TriggerDescriptor_event}
...
domain_model = DomainModel(
    name="SQL2003_V3",
    types={SQL2003_V3_ARRAY, CollectionType, SQL2003_V3_Attribute, StructuralComponent, SQL2003_V3_StructuredType, SQL2003_V3_BaseTable, Table, SQL2003_V3_BehaviouralComponent, SQL2003_V3_Schema, SQL2003_V3_ParameterWithMode, SQL2003_V3_BinaryStringType, PredefinedType, SQL2003_V3_BooleanType, SQL2003_V3_CharacterStringType, SQL2003_V3_DataType, SQL2003_V3_Column, SQL2003_V3_Table, SQL2003_V3_ColumnConstraint, Restriction, SQL2003_V3_ConstructedType, DataType, SQL2003_V3_DatetimeFeature, Feature, SQL2003_V3_DatetimeType, SQL2003_V3_DerivedTable, SQL2003_V3_DistinctType, UserDefinedType, SQL2003_V3_PredefinedType, SQL2003_V3_Feature, SQL2003_V3_Domain, SQL2003_V3_CollectionType, ConstructedType, SQL2003_V3_Field, SQL2003_V3_ROW, SQL2003_V3_Function, BehaviouralComponent, SQL2003_V3_IntervalFeature, SQL2003_V3_IntervalType, SQL2003_V3_MULTISET, SQL2003_V3_Method, SQL2003_V3_StructuralComponent, SQL2003_V3_DomainConstraint, TableConstraint, Parameter_, SQL2003_V3_NotNull, ColumnConstraint, SQL2003_V3_NumericFeature, SQL2003_V3_NumericType, SQL2003_V3_Parameter, SQL2003_V3_MethodParameter, SQL2003_V3_PrimaryKey, UniqueConstraint, SQL2003_V3_Procedure, SQL2003_V3_ReferenceType, SQL2003_V3_ReferentialConstraint, SQL2003_V3_UniqueConstraint, SQL2003_V3_Restriction, SQL2003_V3_View, SQL2003_V3_TypedTable, SQL2003_V3_StringFeature, SQL2003_V3_TableCheckConstraint, SQL2003_V3_TableConstraint, SQL2003_V3_Trigger, SQL2003_V3_TriggerDescriptor, BaseTable, SQL2003_V3_XMLType, SQL2003_V3_UserDefinedType, DerivedTable, BinaryStringTypes, BooleanTypes, CharacterStringTypes, DatetimeFeatures, DatetimeTypes, IntervalFeatures, IntervalTypes, MatchTypes, Multiplier, NumericFeatures, NumericRadix, NumericTypes, ParameterMode, ReferentialAction, StringFeatures, TriggerActionTime, TriggerEvent, TriggerLevel, Unit, XMLTypes},
    associations={structured0, schema1, parametersWithMode2, type5, table7, schema8, source_type10, features11, schema12, super_type4, domain16, row17, return_type18, override21, defines14, constraint15, method28, type29, structured22, return_type24, parameters27, is_source_of32, super_type34, fields36, sub_types38, type40, references41, table42, columns44, behaviouralComponents47, datatypes49, behaviouralComponent31, type57, views59, restrictions60, features62, has_domain65, super_type68, attributes70, methods71, tables51, domains54, restrictions82, description85, updateColumns86, trigger88, structured89, supertable92, subtables95, typed74, schema76, columns78, views79, components99, tables97},
    generalizations={gen_SQL2003_V3_ARRAY_CollectionType, gen_SQL2003_V3_Attribute_StructuralComponent, gen_SQL2003_V3_BaseTable_Table, gen_SQL2003_V3_BinaryStringType_PredefinedType, gen_SQL2003_V3_BooleanType_PredefinedType, gen_SQL2003_V3_CharacterStringType_PredefinedType, gen_SQL2003_V3_Column_StructuralComponent, gen_SQL2003_V3_ColumnConstraint_Restriction, gen_SQL2003_V3_ConstructedType_DataType, gen_SQL2003_V3_DatetimeFeature_Feature, gen_SQL2003_V3_DatetimeType_PredefinedType, gen_SQL2003_V3_DerivedTable_Table, gen_SQL2003_V3_DistinctType_UserDefinedType, gen_SQL2003_V3_CollectionType_ConstructedType, gen_SQL2003_V3_Field_StructuralComponent, gen_SQL2003_V3_Function_BehaviouralComponent, gen_SQL2003_V3_IntervalFeature_Feature, gen_SQL2003_V3_IntervalType_PredefinedType, gen_SQL2003_V3_MULTISET_CollectionType, gen_SQL2003_V3_DomainConstraint_TableConstraint, gen_SQL2003_V3_MethodParameter_Parameter, gen_SQL2003_V3_NotNull_ColumnConstraint, gen_SQL2003_V3_NumericFeature_Feature, gen_SQL2003_V3_NumericType_PredefinedType, gen_SQL2003_V3_ParameterWithMode_Parameter, gen_SQL2003_V3_PrimaryKey_UniqueConstraint, gen_SQL2003_V3_Procedure_BehaviouralComponent, gen_SQL2003_V3_ROW_ConstructedType, gen_SQL2003_V3_ReferenceType_ConstructedType, gen_SQL2003_V3_ReferentialConstraint_TableConstraint, gen_SQL2003_V3_PredefinedType_DataType, gen_SQL2003_V3_StructuredType_UserDefinedType, gen_SQL2003_V3_StringFeature_Feature, gen_SQL2003_V3_TableCheckConstraint_TableConstraint, gen_SQL2003_V3_TableConstraint_Restriction, gen_SQL2003_V3_Trigger_Restriction, gen_SQL2003_V3_TypedTable_BaseTable, gen_SQL2003_V3_UniqueConstraint_TableConstraint, gen_SQL2003_V3_XMLType_PredefinedType, gen_SQL2003_V3_UserDefinedType_DataType, gen_SQL2003_V3_View_DerivedTable},
    metadata=None
)
