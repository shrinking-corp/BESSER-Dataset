...
# Classes
acad_G_CallTaking = Class(name="acad_G_CallTaking")
acad_D_DataUpd = Class(name="acad_D_DataUpd")
DomainAssumption = Class(name="DomainAssumption")
acad_G_ResourceId = Class(name="acad_G_ResourceId")
acad_G_ResourceMob = Class(name="acad_G_ResourceMob")
acad_G_ObtainMap = Class(name="acad_G_ObtainMap")
acad_G_IncidentUpd = Class(name="acad_G_IncidentUpd")
acad_D_MaxCalls = Class(name="acad_D_MaxCalls")
acad_G_GenDispatch = Class(name="acad_G_GenDispatch")
HardGoal = Class(name="HardGoal")
acad_T_RadioPos = Class(name="acad_T_RadioPos")
acad_D_MDTUse = Class(name="acad_D_MDTUse")
acad_T_MonitorStatus = Class(name="acad_T_MonitorStatus")
acad_T_DispStatus = Class(name="acad_T_DispStatus")
acad_T_DispDepArriv = Class(name="acad_T_DispDepArriv")
acad_T_ReplAmb = Class(name="acad_T_ReplAmb")
acad_T_Except = Class(name="acad_T_Except")
acad_G_RegCall = Class(name="acad_G_RegCall")
acad_T_ConfirmCall = Class(name="acad_T_ConfirmCall")
Task = Class(name="Task")
acad_G_AssignIncident = Class(name="acad_G_AssignIncident")
acad_T_SearchDuplic = Class(name="acad_T_SearchDuplic")
acad_T_CreateOrAssign = Class(name="acad_T_CreateOrAssign")
acad_T_InputInfo = Class(name="acad_T_InputInfo")
acad_T_DetectLoc = Class(name="acad_T_DetectLoc")
acad_T_SpecConfig = Class(name="acad_T_SpecConfig")
acad_T_ConfIncident = Class(name="acad_T_ConfIncident")
acad_T_DetBestAmb = Class(name="acad_T_DetBestAmb")
acad_T_InformStat = Class(name="acad_T_InformStat")
acad_G_RouteAssist = Class(name="acad_G_RouteAssist")
acad_D_DriverKnows = Class(name="acad_D_DriverKnows")
acad_T_AcadAssists = Class(name="acad_T_AcadAssists")
acad_T_StaffAssists = Class(name="acad_T_StaffAssists")
acad_T_Feedback = Class(name="acad_T_Feedback")
acad_D_GazetUpd = Class(name="acad_D_GazetUpd")
acad_G_ManualMap = Class(name="acad_G_ManualMap")
acad_T_CheckGazet = Class(name="acad_T_CheckGazet")
acad_T_CheckPaper = Class(name="acad_T_CheckPaper")
acad_G_DispExcept = Class(name="acad_G_DispExcept")
acad_G_MonitorRes = Class(name="acad_G_MonitorRes")
acad_G_UpdPosition = Class(name="acad_G_UpdPosition")
acad_D_MDTPos = Class(name="acad_D_MDTPos")
acad_AR12 = Class(name="acad_AR12")
acad_AR13 = Class(name="acad_AR13")
acad_AR14 = Class(name="acad_AR14")
acad_AR15 = Class(name="acad_AR15")
acad_AcadGoalModel = Class(name="acad_AcadGoalModel")
GoalModel = Class(name="GoalModel")
acad_CV_MST = Class(name="acad_CV_MST")
Parameter_ = Class(name="Parameter")
acad_T_ExceptQueue = Class(name="acad_T_ExceptQueue")
acad_T_CloseIncident = Class(name="acad_T_CloseIncident")
acad_S_FastDispatch = Class(name="acad_S_FastDispatch")
Softgoal = Class(name="Softgoal")
acad_Q_Dispatch = Class(name="acad_Q_Dispatch")
QualityConstraint = Class(name="QualityConstraint")
acad_S_FastAssist = Class(name="acad_S_FastAssist")
acad_Q_IncidResolv = Class(name="acad_Q_IncidResolv")
acad_S_FastArriv = Class(name="acad_S_FastArriv")
acad_Q_AmbArriv = Class(name="acad_Q_AmbArriv")
acad_S_LowCost = Class(name="acad_S_LowCost")
acad_Q_MaxCost = Class(name="acad_Q_MaxCost")
acad_S_UserFriendly = Class(name="acad_S_UserFriendly")
acad_Q_MaxTimeMsg = Class(name="acad_Q_MaxTimeMsg")
acad_AR1 = Class(name="acad_AR1")
EcaAwReq = Class(name="EcaAwReq")
acad_AR2 = Class(name="acad_AR2")
acad_AR3 = Class(name="acad_AR3")
acad_AR4 = Class(name="acad_AR4")
acad_AR5 = Class(name="acad_AR5")
acad_AR6 = Class(name="acad_AR6")
acad_AR7 = Class(name="acad_AR7")
acad_AR8 = Class(name="acad_AR8")
acad_AR9 = Class(name="acad_AR9")
acad_AR10 = Class(name="acad_AR10")
acad_AR11 = Class(name="acad_AR11")
...
domain_model = DomainModel(
    name="acad",
    types={acad_G_CallTaking, acad_D_DataUpd, DomainAssumption, acad_G_ResourceId, acad_G_ResourceMob, acad_G_ObtainMap, acad_G_IncidentUpd, acad_D_MaxCalls, acad_G_GenDispatch, HardGoal, acad_T_RadioPos, acad_D_MDTUse, acad_T_MonitorStatus, acad_T_DispStatus, acad_T_DispDepArriv, acad_T_ReplAmb, acad_T_Except, acad_G_RegCall, acad_T_ConfirmCall, Task, acad_G_AssignIncident, acad_T_SearchDuplic, acad_T_CreateOrAssign, acad_T_InputInfo, acad_T_DetectLoc, acad_T_SpecConfig, acad_T_ConfIncident, acad_T_DetBestAmb, acad_T_InformStat, acad_G_RouteAssist, acad_D_DriverKnows, acad_T_AcadAssists, acad_T_StaffAssists, acad_T_Feedback, acad_D_GazetUpd, acad_G_ManualMap, acad_T_CheckGazet, acad_T_CheckPaper, acad_G_DispExcept, acad_G_MonitorRes, acad_G_UpdPosition, acad_D_MDTPos, acad_AR12, acad_AR13, acad_AR14, acad_AR15, acad_AcadGoalModel, GoalModel, acad_CV_MST, Parameter_, acad_T_ExceptQueue, acad_T_CloseIncident, acad_S_FastDispatch, Softgoal, acad_Q_Dispatch, QualityConstraint, acad_S_FastAssist, acad_Q_IncidResolv, acad_S_FastArriv, acad_Q_AmbArriv, acad_S_LowCost, acad_Q_MaxCost, acad_S_UserFriendly, acad_Q_MaxTimeMsg, acad_AR1, EcaAwReq, acad_AR2, acad_AR3, acad_AR4, acad_AR5, acad_AR6, acad_AR7, acad_AR8, acad_AR9, acad_AR10, acad_AR11},
    associations={},
    generalizations={gen_acad_G_CallTaking_HardGoal, gen_acad_D_DataUpd_DomainAssumption, gen_acad_G_ResourceId_HardGoal, gen_acad_G_ResourceMob_HardGoal, gen_acad_G_ObtainMap_HardGoal, gen_acad_G_IncidentUpd_HardGoal, gen_acad_D_MaxCalls_DomainAssumption, gen_acad_G_GenDispatch_HardGoal, gen_acad_T_RadioPos_Task, gen_acad_D_MDTUse_DomainAssumption, gen_acad_T_MonitorStatus_Task, gen_acad_T_DispStatus_Task, gen_acad_T_DispDepArriv_Task, gen_acad_T_ReplAmb_Task, gen_acad_T_Except_Task, gen_acad_G_RegCall_HardGoal, gen_acad_T_ConfirmCall_Task, gen_acad_G_AssignIncident_HardGoal, gen_acad_T_SearchDuplic_Task, gen_acad_T_CreateOrAssign_Task, gen_acad_T_InputInfo_Task, gen_acad_T_DetectLoc_Task, gen_acad_T_SpecConfig_Task, gen_acad_T_ConfIncident_Task, gen_acad_T_DetBestAmb_Task, gen_acad_T_InformStat_Task, gen_acad_G_RouteAssist_HardGoal, gen_acad_D_DriverKnows_DomainAssumption, gen_acad_T_AcadAssists_Task, gen_acad_T_StaffAssists_Task, gen_acad_T_Feedback_Task, gen_acad_D_GazetUpd_DomainAssumption, gen_acad_G_ManualMap_HardGoal, gen_acad_T_CheckGazet_Task, gen_acad_T_CheckPaper_Task, gen_acad_G_DispExcept_HardGoal, gen_acad_G_MonitorRes_HardGoal, gen_acad_G_UpdPosition_HardGoal, gen_acad_D_MDTPos_DomainAssumption, gen_acad_AR12_EcaAwReq, gen_acad_AR13_EcaAwReq, gen_acad_AR14_EcaAwReq, gen_acad_AR15_EcaAwReq, gen_acad_AcadGoalModel_GoalModel, gen_acad_CV_MST_Parameter, gen_acad_T_ExceptQueue_Task, gen_acad_T_CloseIncident_Task, gen_acad_S_FastDispatch_Softgoal, gen_acad_Q_Dispatch_QualityConstraint, gen_acad_S_FastAssist_Softgoal, gen_acad_Q_IncidResolv_QualityConstraint, gen_acad_S_FastArriv_Softgoal, gen_acad_Q_AmbArriv_QualityConstraint, gen_acad_S_LowCost_Softgoal, gen_acad_Q_MaxCost_QualityConstraint, gen_acad_S_UserFriendly_Softgoal, gen_acad_Q_MaxTimeMsg_QualityConstraint, gen_acad_AR1_EcaAwReq, gen_acad_AR2_EcaAwReq, gen_acad_AR3_EcaAwReq, gen_acad_AR4_EcaAwReq, gen_acad_AR5_EcaAwReq, gen_acad_AR6_EcaAwReq, gen_acad_AR7_EcaAwReq, gen_acad_AR8_EcaAwReq, gen_acad_AR9_EcaAwReq, gen_acad_AR10_EcaAwReq, gen_acad_AR11_EcaAwReq},
    metadata=None
)
