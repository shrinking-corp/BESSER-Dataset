...
class remes_Edge:
    ...
    def __init__(self, actionGuard: str, actionBody: str, Edge: "remes_EntryPoint" = None, remes_Edge: "LogicalRoot" = None, exitEdges: "remes_ExitPoint" = None, entryEdges: "remes_EntryPoint" = None, remes_Edge44: "ActionRoot" = None, Edge30: "remes_ExitPoint" = None):
...
class remes_Constant(Referable):
    ...
    def __init__(self, global_: bool, type: str, value: str, Constant: "remes_Mode" = None, constants: "remes_Mode" = None):
...
class remes_Variable(Referable):
    ...
    def __init__(self, value: str, type: str, vectorSize: int, global_: bool, readable: bool, writable: bool, Variable: "remes_Mode" = None, variables: "remes_Mode" = None):
        self.value = value
        self.type = type
...
class remes_ControlPath(ABC):
    ...
    def __init__(self, name: str, ControlPath: "remes_EntryPoint" = None, ControlPath32: "remes_ExitPoint" = None, container: "remes_EntryPoint" = None, container3: "remes_ExitPoint" = None):
        self.name = name
...
class remes_Mode(ControlPath):
    ...
    def __init__(self, initialization: str, scope6: set["remes_Resource"] = None, remes_Mode: "remes_RemesDiagram" = None, scope: set["remes_Variable"] = None, scope8: set["remes_Constant"] = None, Mode: "remes_Variable" = None, Mode53: "remes_Resource" = None, Mode56: "remes_Constant" = None):
        self.initialization = initialization
