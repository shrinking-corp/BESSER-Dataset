...
remes_Variable.attributes={remes_Variable_type, remes_Variable_writable, remes_Variable_vectorSize, remes_Variable_readable, remes_Variable_global_, remes_Variable_value}
...
remes_Constant.attributes={remes_Constant_type, remes_Constant_value, remes_Constant_global_}
...
domain_model = DomainModel(
    name="remes",
    types={remes_RemesDiagram, remes_Mode, remes_ControlPath, remes_EntryPoint, remes_ExitPoint, ControlPath, remes_Variable, remes_Constant, remes_CompositeMode, Mode, remes_SubMode, remes_ConditionalConnector, remes_InitPoint, remes_CompositeEntryPoint, remes_CompositeExitPoint, remes_WritePoint, LogicalRoot, remes_Point, Point, remes_InitEdge, remes_Edge, remes_Resource, ExitPoint, EntryPoint, ActionRoot, remes_Referable, Referable, ResourceRoot, remes_WriteEdge, PrimitiveTypes, ResourceTypes},
    associations={modes0, entryPoint1, exitPoint2, variables4, constants7, subModes9, conditionalConnectors10, initPoint12, compositeEntryPoint14, compositeExitPoint15, writePoint17, parent19, parsedInvariant20, parent21, initEdge23, container24, entryEdges26, container27, resources5, container31, composite33, composite35, parsedActionGuard37, connectFrom39, connectTo41, parsedActionBody43, connectFrom45, connectTo47, parsedInitialization48, scope51, scope52, parsedExpression54, exitEdges28, scope55, connectTo57, connectFrom59, container60, writeEdges62},
    generalizations={gen_remes_Mode_ControlPath, gen_remes_CompositeMode_Mode, gen_remes_SubMode_Mode, gen_remes_ConditionalConnector_ControlPath, gen_remes_InitPoint_Point, gen_remes_EntryPoint_Point, gen_remes_ExitPoint_Point, gen_remes_CompositeEntryPoint_ExitPoint, gen_remes_CompositeExitPoint_EntryPoint, gen_remes_Variable_Referable, gen_remes_Resource_Referable, gen_remes_WritePoint_Point, gen_remes_Constant_Referable},
    metadata=None
)
