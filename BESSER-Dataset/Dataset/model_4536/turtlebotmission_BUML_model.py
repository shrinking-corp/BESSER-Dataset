...
domain_model = DomainModel(
    ...
    types={turtlebotmission_WayPoint, turtlebotmission_Mission, turtlebotmission_TurtleBot, NamedElement, turtlebotmission_Area, turtlebotmission_WaypointType, turtlebotmission_NamedElement, turtlebotmission_Task, turtlebotmission_LineTask, Task, turtlebotmission_ShortestPathTask, turtlebotmission_ReturnToStartTask},
    associations={bot_start3, waypoints5, missions8, area0, waypointtypes1, waypointtypes10, task13, waypoints15, waypoints17},
