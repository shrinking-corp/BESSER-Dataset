...
def test_hyp_jpql_jvmtype_is_not_abstract():
    assert not inspect.isabstract(jPQL_JvmType)


def test_hyp_jpql_jvmtype_constructor_exists():
    assert callable(jPQL_JvmType.__init__)


def test_hyp_jpql_jvmtype_constructor_args():
...
def test_hyp_jpql_query_is_not_abstract():
    assert not inspect.isabstract(jPQL_Query)


def test_hyp_jpql_query_constructor_exists():
    assert callable(jPQL_Query.__init__)


def test_hyp_jpql_query_constructor_args():
