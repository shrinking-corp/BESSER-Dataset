...
CuentaBancaria = Class(name="CuentaBancaria")
...
# CuentaBancaria class attributes and methods
CuentaBancaria_saldo: Property = Property(name="saldo", type=IntegerType)
CuentaBancaria.attributes={CuentaBancaria_saldo}

# Class class attributes and methods

# Domain Model
domain_model = DomainModel(
    name="_LYB9QFxOEeiba6mIiOhFVA",
    types={Gato, CuentaBancaria, Class_},
    associations={},
    generalizations={},
    metadata=None
)
