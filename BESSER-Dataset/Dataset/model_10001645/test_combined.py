...
def test_hyp_cuentabancaria_is_not_abstract():
    assert not inspect.isabstract(CuentaBancaria)


def test_hyp_cuentabancaria_constructor_exists():
    assert callable(CuentaBancaria.__init__)


def test_hyp_cuentabancaria_constructor_args():
...
def test_hyp_cuentabancaria_saldo_setter(instance):
