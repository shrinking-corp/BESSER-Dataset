...
class tracker_Animal(ABC):
    ...
    def __init__(self, birthDate: date, sex: str, id: str, comments: str, lastEventDateTime: date, weight: str, weightGainPerDay: str, type: str, visualID: str, ageInDays: int, alternativeID: str, species: str, breed: str, sexCode: str, speciesCode: str, tracker_Animal3: "tracker_Animal" = None, tracker_Animal1: "tracker_Animal" = None, tracker_Animal6: "tracker_Animal" = None, tracker_Animal4: "tracker_Animal" = None, tracker_Animal: set["tracker_Tag"] = None, tracker_Animal10: "tracker_Premises" = None):
...
class tracker_EventSchema:
    ...
    def __init__(self, name: str, description: str, animalType: str, tracker_EventSchema26: set["tracker_EventAttributeSchema"] = None, tracker_EventSchema29: "tracker_Schema" = None, tracker_EventSchema: "tracker_GenericEvent" = None):
        self.name = name
        self.description = description
...
class tracker_Premises:
    ...
    def findAnimal(self, tracker_id) :
...
class tracker_GenericEvent(Event):
    ...
    def findSchema(self, tracker_eventAttribute) :
...
class tracker_HerdTest(Event):
    ...
    @property
    def daysSinceBredEstimate(self):
...
class tracker_USBeefGrading(Event):
    ...
    def __init__(self, yieldGrade: str, qualityGrade: str, qualityGradeLevel: str):
...
class tracker_ReplacedTag(Event):
    ...
    def __init__(self, oldId: str, usainNumberUsedForOldId: bool, tracker_ReplacedTag: "tracker_Tag" = None):
        ...
        pass
    @property
    def usainNumberUsedForOldId(self):
...
class tracker_Tag:
    ...
    def __init__(self, usainNumberUsed: bool, id: str, tag: set["tracker_Event"] = None, tracker_Tag: "tracker_Animal" = None, tracker_Tag13: "tracker_Premises" = None, Tag: "tracker_Event" = None, tracker_Tag19: "tracker_ReplacedTag" = None):
