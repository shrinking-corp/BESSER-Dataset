...
domain_model = DomainModel(
    name="arithmetics",
    types={arithmetics_Module, arithmetics_Import, arithmetics_Statement, arithmetics_Definition, Statement, AbstractDefinition, arithmetics_DeclaredParameter, arithmetics_Expression, arithmetics_AbstractDefinition, arithmetics_Evaluation, arithmetics_Plus, Expression, arithmetics_Minus, arithmetics_Multi, arithmetics_Div, arithmetics_NumberLiteral, arithmetics_FunctionCall},
    associations={imports0, statements1, module3, args6, expr7, expression9, left11, right13, left16, right18, left21, right23, left26, right28, func31, args32},
    generalizations={gen_arithmetics_Definition_Statement, gen_arithmetics_Definition_AbstractDefinition, gen_arithmetics_DeclaredParameter_AbstractDefinition, gen_arithmetics_Evaluation_Statement, gen_arithmetics_Plus_Expression, gen_arithmetics_Minus_Expression, gen_arithmetics_Multi_Expression, gen_arithmetics_Div_Expression, gen_arithmetics_NumberLiteral_Expression, gen_arithmetics_FunctionCall_Expression},
    metadata=None
)
