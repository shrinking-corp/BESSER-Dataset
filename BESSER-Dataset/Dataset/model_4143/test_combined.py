...
def test_assoc_func31_link_reassign_clear():
...
def test_assoc_imports0_link_reassign_clear():
    ...
    b1 = arithmetics_Import()
    b2 = arithmetics_Import()
...
def test_assoc_module3_link_reassign_clear():
    ...
    b1 = arithmetics_Import()
    b2 = arithmetics_Import()
    _safe_set(a, 'arithmetics_Module5', b1)
    assert _is_linked(a, 'arithmetics_Module5', b1)
    if hasattr(b1, 'arithmetics_Import4'):
        assert _is_linked(b1, 'arithmetics_Import4', a)
    _safe_set(a, 'arithmetics_Module5', b2)
    assert _is_linked(a, 'arithmetics_Module5', b2)
    if hasattr(b1, 'arithmetics_Import4'):
        assert not _is_linked(b1, 'arithmetics_Import4', a)
    if hasattr(b2, 'arithmetics_Import4'):
        assert _is_linked(b2, 'arithmetics_Import4', a)
    _safe_set(a, 'arithmetics_Module5', None)
    assert not _is_linked(a, 'arithmetics_Module5', b2)
    if hasattr(b2, 'arithmetics_Import4'):
        assert not _is_linked(b2, 'arithmetics_Import4', a)
...
arithmetics_Import_strategy = st.builds(arithmetics_Import)
