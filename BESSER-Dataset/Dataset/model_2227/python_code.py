...
class studyprograms_CourseAccess:
    ...
    def __init__(self, Access: str, studyprograms_CourseAccess: "studyprograms_Semester" = None, studyprograms_CourseAccess12: set["studyprograms_Course"] = None):
        self.Access = Access
...
class studyprograms_Semester:
    ...
    def __init__(self, semesterCode: str, year: int, semesterType: str, studyprograms_Semester: "studyprograms_Programme" = None, studyprograms_Semester5: "studyprograms_Specialisation" = None, studyprograms_Semester10: set["studyprograms_CourseAccess"] = None):
