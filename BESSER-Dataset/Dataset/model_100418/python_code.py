...
class statechart_Transition:
    ...
    def __init__(self, TE: str, name: str, statechart_Transition: "statechart_Model" = None, statechart_Transition14: "statechart_Node" = None, statechart_Transition17: "statechart_Node" = None):
        self.TE = TE
        self.name = name
...
class statechart_Node:
    ...
    def __init__(self, name: str, label: str, type: str, activity: str, statechart_Node: "statechart_Model" = None, statechart_Node6: set["statechart_Variable"] = None, Node: "statechart_Node" = None, Father_of: set["statechart_Node"] = None, Node12: "statechart_Node" = None, Children: "statechart_Node" = None, statechart_Node15: "statechart_Transition" = None, statechart_Node18: "statechart_Transition" = None):
        self.name = name
        self.label = label
        self.type = type
        ...
        self.Node = Node
        self.Father_of = Father_of if Father_of is not None else set()
        self.Node12 = Node12
    ...
    @property
    def Father_of(self):
        return self.__Father_of

    @Father_of.setter
    def Father_of(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_statechart_Node__Father_of", None)
        self.__Father_of = value if value is not None else set()
    ...
    def Node(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "Father_of"):
                opp_val = getattr(old_value, "Father_of", None)
                if isinstance(opp_val, set):
                    opp_val.discard(self)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "Father_of"):
                opp_val = getattr(value, "Father_of", None)
                if opp_val is None:
                    setattr(value, "Father_of", set([self]))
                elif isinstance(opp_val, set):
                    opp_val.add(self)

class statechart_Model:

    def __init__(self, name: str, statechart_Model: set["statechart_Node"] = None, statechart_Model2: set["statechart_Transition"] = None, statechart_Model4: set["statechart_Variable"] = None):
        self.name = name
