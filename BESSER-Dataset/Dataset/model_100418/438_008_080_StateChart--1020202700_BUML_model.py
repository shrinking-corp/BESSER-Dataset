...
# Classes
statechart_Model = Class(name="statechart_Model")
statechart_Node = Class(name="statechart_Node")
statechart_Transition = Class(name="statechart_Transition")
statechart_Variable = Class(name="statechart_Variable")

# statechart_Model class attributes and methods
statechart_Model_name: Property = Property(name="name", type=StringType)
statechart_Model.attributes={statechart_Model_name}
...
statechart_Node.attributes={statechart_Node_name, statechart_Node_type, statechart_Node_activity, statechart_Node_label}
...
statechart_Transition.attributes={statechart_Transition_name, statechart_Transition_TE}
...
Children9: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="Father_of", type=statechart_Node, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
Father_of11: BinaryAssociation = BinaryAssociation(
    name="Father_of11",
    ends={
...
domain_model = DomainModel(
    ...
    associations={nodes0, transitions1, variables3, variables5, Children9, Father_of11, source13, target16},
    generalizations={},
    metadata=None
)
