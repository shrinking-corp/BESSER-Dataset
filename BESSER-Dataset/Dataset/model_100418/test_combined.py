...
def test_statechart_Model_name_value_roundtrip():
    instance = statechart_Model(name="sample_text")
...
def test_statechart_Node_activity_value_roundtrip():
    instance = statechart_Node(activity="sample_text", label="sample_text", name="sample_text", type="sample_text")
...
def test_statechart_Transition_TE_value_roundtrip():
    instance = statechart_Transition(TE="sample_text", name="sample_text")
...
def test_assoc_Children9_link_reassign_clear():
    a = statechart_Node(activity="sample_text", label="sample_text", name="sample_text", type="sample_text")
    b1 = statechart_Node(activity="sample_text", label="sample_text", name="sample_text", type="sample_text")
    b2 = statechart_Node(activity="sample_text_2", label="sample_text_2", name="sample_text_2", type="sample_text_2")
    _safe_set(a, 'Father_of', {b1})
    assert _is_linked(a, 'Father_of', b1)
    if hasattr(b1, 'Node'):
        assert _is_linked(b1, 'Node', a)
    _safe_set(a, 'Father_of', {b2})
    assert _is_linked(a, 'Father_of', b2)
    if hasattr(b1, 'Node'):
        assert not _is_linked(b1, 'Node', a)
    if hasattr(b2, 'Node'):
        assert _is_linked(b2, 'Node', a)
    _safe_set(a, 'Father_of', set())
    assert not _is_linked(a, 'Father_of', b2)
    if hasattr(b2, 'Node'):
        assert not _is_linked(b2, 'Node', a)


def test_assoc_Father_of11_link_reassign_clear():
    a = statechart_Node(activity="sample_text", label="sample_text", name="sample_text", type="sample_text")
    b1 = statechart_Node(activity="sample_text", label="sample_text", name="sample_text", type="sample_text")
    b2 = statechart_Node(activity="sample_text_2", label="sample_text_2", name="sample_text_2", type="sample_text_2")
...
def test_assoc_nodes0_link_reassign_clear():
    a = statechart_Node(activity="sample_text", label="sample_text", name="sample_text", type="sample_text")
    b1 = statechart_Model(name="sample_text")
    b2 = statechart_Model(name="sample_text_2")
...
def test_assoc_source13_link_reassign_clear():
    a = statechart_Transition(TE="sample_text", name="sample_text")
    b1 = statechart_Node(activity="sample_text", label="sample_text", name="sample_text", type="sample_text")
    b2 = statechart_Node(activity="sample_text_2", label="sample_text_2", name="sample_text_2", type="sample_text_2")
...
statechart_Model_strategy = st.builds(statechart_Model, name=safe_text)
@given(instance=statechart_Model_strategy)
...
statechart_Node_strategy = st.builds(statechart_Node, activity=safe_text, label=safe_text, name=safe_text, type=safe_text)
@given(instance=statechart_Node_strategy)
@settings(max_examples=25)
...
statechart_Transition_strategy = st.builds(statechart_Transition, TE=safe_text, name=safe_text)
@given(instance=statechart_Transition_strategy)
@settings(max_examples=25)
