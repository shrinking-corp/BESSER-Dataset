...
class graphmodel_Entity:
    ...
    def __init__(self, y: str, width: str, ID: str, name: str, text: str, description: str, value: str, type: str, className: str, group: str, category: str, accessModifier: str, x: str, height: str):
        self.y = y
        self.width = width
        self.ID = ID
        self.name = name
