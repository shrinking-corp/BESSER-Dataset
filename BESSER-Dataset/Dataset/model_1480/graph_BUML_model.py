...
# Classes
graphmodel_ModellingType = Class(name="graphmodel_ModellingType")
graphmodel_Entity = Class(name="graphmodel_Entity")
graphmodel_Graph = Class(name="graphmodel_Graph")
Entity = Class(name="Entity")
graphmodel_Node = Class(name="graphmodel_Node")
graphmodel_Edge = Class(name="graphmodel_Edge")
graphmodel_Property = Class(name="graphmodel_Property")
graphmodel_Operation = Class(name="graphmodel_Operation")
...
graphmodel_Entity.attributes={graphmodel_Entity_width, graphmodel_Entity_text, graphmodel_Entity_ID, graphmodel_Entity_name, graphmodel_Entity_accessModifier, graphmodel_Entity_type, graphmodel_Entity_category, graphmodel_Entity_y, graphmodel_Entity_group, graphmodel_Entity_className, graphmodel_Entity_x, graphmodel_Entity_description, graphmodel_Entity_value, graphmodel_Entity_height}
...
domain_model = DomainModel(
    name="graphmodel",
    types={graphmodel_ModellingType, graphmodel_Entity, graphmodel_Graph, Entity, graphmodel_Node, graphmodel_Edge, graphmodel_Property, graphmodel_Operation},
    associations={nodes0, edges1, parentNode4, subNodes7, properties9, operations11, source13, target16},
    generalizations={gen_graphmodel_Graph_Entity, gen_graphmodel_Node_Entity, gen_graphmodel_Property_Entity, gen_graphmodel_Operation_Entity, gen_graphmodel_Edge_Entity},
    metadata=None
)
