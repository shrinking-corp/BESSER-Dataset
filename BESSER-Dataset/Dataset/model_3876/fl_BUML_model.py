...
# Classes
fl_Expr = Class(name="fl_Expr", is_abstract=True)
fl_Argument = Class(name="fl_Argument")
fl_Binary = Class(name="fl_Binary")
fl_Apply = Class(name="fl_Apply")
Expr = Class(name="Expr")
fl_EStringToStringMapEntry = Class(name="fl_EStringToStringMapEntry")
fl_ProgramType = Class(name="fl_ProgramType")
fl_Function = Class(name="fl_Function")
fl_DocumentRoot = Class(name="fl_DocumentRoot")
fl_Literal = Class(name="fl_Literal")
fl_IfThenElse = Class(name="fl_IfThenElse")
...
domain_model = DomainModel(
    name="fl",
    types={fl_Expr, fl_Argument, fl_Binary, fl_Apply, Expr, fl_EStringToStringMapEntry, fl_ProgramType, fl_Function, fl_DocumentRoot, fl_Literal, fl_IfThenElse, Ops},
    associations={arg0, left1, xMLNSPrefixMap6, xSISchemaLocation7, fragment10, program13, right3, thenExpr19, elseExpr22, rhs15, ifExpr17, function25},
    generalizations={gen_fl_Argument_Expr, gen_fl_Binary_Expr, gen_fl_Apply_Expr, gen_fl_Literal_Expr, gen_fl_IfThenElse_Expr},
    metadata=None
)
