...
class Employee:
    ...
    def __init__(self, EmpID: int, Name: str, jopType: str, Contact_: str):
        self.EmpID = EmpID
        self.Name = Name
        self.jopType = jopType
    ...
    @property
    def jopType(self):
        return self.__jopType
    @jopType.setter
    def jopType(self, jopType: str):
        self.__jopType = jopType

    @property
    def Contact_(self):
        return self.__Contact_
    @Contact_.setter
    def Contact_(self, Contact_: str):
        self.__Contact_ = Contact_
...
class Booking:
    ...
    def __init__(self, booking_Id: str, type: int, name: str, contact: str, date: str, reservedTables: str, is_in7: "RMS" = None, is_reserved_by5: set["Table"] = None):
...
class Report:
    ...
    def __init__(self, totalSales: str, profit: str, orders: str, generates10: "RMS" = None):
