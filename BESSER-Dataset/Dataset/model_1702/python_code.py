...
class library_t_book:
    ...
    def __init__(self, tagName: str, text: str, pages: int, title: str, library_t_book: "library_t_library" = None, library_t_book2: "library_t_library" = None, library_t_book5: set["library_t_author"] = None, library_t_book7: "library_t_published" = None, library_t_book10: "library_t_author" = None, library_t_book13: "library_t_published" = None):
        self.tagName = tagName
        self.text = text
        self.pages = pages
        self.title = title
