...
# Classes
library_t_library = Class(name="library_t_library")
library_t_book = Class(name="library_t_book")
library_t_author = Class(name="library_t_author")
library_t_published = Class(name="library_t_published")
...
library_t_book.attributes={library_t_book_text, library_t_book_tagName, library_t_book_title, library_t_book_pages}
...
library_t_published.attributes={library_t_published_tagName, library_t_published_text}
