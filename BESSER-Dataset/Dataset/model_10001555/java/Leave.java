...
public class Leave  {
    ...
    public Leave(
        int Leave_NoOfDays,        int leave_id,        LocalDate Leave_ApplyDate,        String Leave_Status,        String Leave_Title,        int Emp_Id,        LocalDate Leave_EndDate,        String Leave_detail,        LocalDate Leave_StartDate    ) {
