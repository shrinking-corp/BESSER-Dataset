...
# Classes
testintentionsAssistance_OutVariable = Class(name="testintentionsAssistance_OutVariable")
testintentionsAssistance_Variable = Class(name="testintentionsAssistance_Variable")
testintentionsAssistance_Data = Class(name="testintentionsAssistance_Data")
testintentionsAssistance_Inst = Class(name="testintentionsAssistance_Inst")
testintentionsAssistance_Expression = Class(name="testintentionsAssistance_Expression")
testintentionsAssistance_TestIntention = Class(name="testintentionsAssistance_TestIntention")
testintentionsAssistance_Model = Class(name="testintentionsAssistance_Model")
testintentionsAssistance_DomainDeclaration = Class(name="testintentionsAssistance_DomainDeclaration")
AbstractElement = Class(name="AbstractElement")
testintentionsAssistance_AbstractElement = Class(name="testintentionsAssistance_AbstractElement")
testintentionsAssistance_Import = Class(name="testintentionsAssistance_Import")
testintentionsAssistance_Function = Class(name="testintentionsAssistance_Function")
testintentionsAssistance_Plus = Class(name="testintentionsAssistance_Plus")
testintentionsAssistance_Minus = Class(name="testintentionsAssistance_Minus")
testintentionsAssistance_MulOrDiv = Class(name="testintentionsAssistance_MulOrDiv")
testintentionsAssistance_Not = Class(name="testintentionsAssistance_Not")
testintentionsAssistance_Or = Class(name="testintentionsAssistance_Or")
Expression = Class(name="Expression")
testintentionsAssistance_And = Class(name="testintentionsAssistance_And")
testintentionsAssistance_Equality = Class(name="testintentionsAssistance_Equality")
testintentionsAssistance_Comparison = Class(name="testintentionsAssistance_Comparison")
testintentionsAssistance_INT = Class(name="testintentionsAssistance_INT")
testintentionsAssistance_STRING = Class(name="testintentionsAssistance_STRING")
testintentionsAssistance_Boolean = Class(name="testintentionsAssistance_Boolean")
testintentionsAssistance_Double = Class(name="testintentionsAssistance_Double")
testintentionsAssistance_VariableRef = Class(name="testintentionsAssistance_VariableRef")
...
testintentionsAssistance_OutVariable.attributes={testintentionsAssistance_OutVariable_name, testintentionsAssistance_OutVariable_type}
...
domain_model = DomainModel(
    ...
    types={testintentionsAssistance_OutVariable, testintentionsAssistance_Variable, testintentionsAssistance_Data, testintentionsAssistance_Inst, testintentionsAssistance_Expression, testintentionsAssistance_TestIntention, testintentionsAssistance_Model, testintentionsAssistance_DomainDeclaration, AbstractElement, testintentionsAssistance_AbstractElement, testintentionsAssistance_Import, testintentionsAssistance_Function, testintentionsAssistance_Plus, testintentionsAssistance_Minus, testintentionsAssistance_MulOrDiv, testintentionsAssistance_Not, testintentionsAssistance_Or, Expression, testintentionsAssistance_And, testintentionsAssistance_Equality, testintentionsAssistance_Comparison, testintentionsAssistance_INT, testintentionsAssistance_STRING, testintentionsAssistance_Boolean, testintentionsAssistance_Double, testintentionsAssistance_VariableRef, Type},
    associations={out3, arg4, arg16, inst9, variable10, valeur13, elements0, elements1, left40, right42, left45, right47, left50, right52, expression15, outvar17, left20, right22, left25, right27, left30, right32, left35, right37, expression55, variable57},
    generalizations={gen_testintentionsAssistance_Data_AbstractElement, gen_testintentionsAssistance_TestIntention_AbstractElement, gen_testintentionsAssistance_DomainDeclaration_AbstractElement, gen_testintentionsAssistance_Import_AbstractElement, gen_testintentionsAssistance_Function_AbstractElement, gen_testintentionsAssistance_Plus_Expression, gen_testintentionsAssistance_Minus_Expression, gen_testintentionsAssistance_MulOrDiv_Expression, gen_testintentionsAssistance_Not_Expression, gen_testintentionsAssistance_Or_Expression, gen_testintentionsAssistance_And_Expression, gen_testintentionsAssistance_Equality_Expression, gen_testintentionsAssistance_Comparison_Expression, gen_testintentionsAssistance_INT_Expression, gen_testintentionsAssistance_STRING_Expression, gen_testintentionsAssistance_Boolean_Expression, gen_testintentionsAssistance_Double_Expression, gen_testintentionsAssistance_VariableRef_Expression},
    metadata=None
)
