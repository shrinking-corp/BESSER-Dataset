...
# Classes
smalluml_Role = Class(name="smalluml_Role")
smalluml_Heritage = Class(name="smalluml_Heritage")
...
smalluml_Float = Class(name="smalluml_Float")
Type = Class(name="Type")
smalluml_Int = Class(name="smalluml_Int")
...
smalluml_Diagram = Class(name="smalluml_Diagram")
...
return_6: BinaryAssociation = BinaryAssociation(
    name="return_6",
    ends={
...
domain_model = DomainModel(
    name="smalluml",
    types={smalluml_Role, smalluml_Heritage, smalluml_Class, NamedElement, smalluml_Method, smalluml_Type, smalluml_Association, smalluml_Float, Type, smalluml_Int, smalluml_Boolean, smalluml_String, smalluml_NamedElement, smalluml_Diagram},
    associations={used9, user10, mother13, child15, class_18, method0, attribute1, parameters3, return_6, assoc21, heritage23, class_26},
    generalizations={gen_smalluml_Heritage_NamedElement, gen_smalluml_Role_NamedElement, gen_smalluml_Type_NamedElement, gen_smalluml_Class_NamedElement, gen_smalluml_Method_NamedElement, gen_smalluml_Association_NamedElement, gen_smalluml_Float_Type, gen_smalluml_Int_Type, gen_smalluml_Boolean_Type, gen_smalluml_String_Type},
    metadata=None
)
