...
def test_hyp_smalluml_diagram_is_not_abstract():
    assert not inspect.isabstract(smalluml_Diagram)


def test_hyp_smalluml_diagram_constructor_exists():
    assert callable(smalluml_Diagram.__init__)


def test_hyp_smalluml_diagram_constructor_args():
...
def test_hyp_smalluml_int_is_not_abstract():
    assert not inspect.isabstract(smalluml_Int)


def test_hyp_smalluml_int_constructor_exists():
    assert callable(smalluml_Int.__init__)


def test_hyp_smalluml_int_constructor_args():
...
def test_hyp_smalluml_float_is_not_abstract():
    assert not inspect.isabstract(smalluml_Float)


def test_hyp_smalluml_float_constructor_exists():
    assert callable(smalluml_Float.__init__)


def test_hyp_smalluml_float_constructor_args():
...
def test_hyp_smalluml_heritage_is_not_abstract():
    assert not inspect.isabstract(smalluml_Heritage)


def test_hyp_smalluml_heritage_constructor_exists():
    assert callable(smalluml_Heritage.__init__)


def test_hyp_smalluml_heritage_constructor_args():
...
def test_hyp_smalluml_role_upper_setter(instance):
...
@given(instance=smalluml_Role_strategy)
def test_hyp_smalluml_role_lower_setter(instance):
