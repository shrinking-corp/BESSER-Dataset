...
# Classes
noreflectioncompany_Company = Class(name="noreflectioncompany_Company")
noreflectioncompany_Employee = Class(name="noreflectioncompany_Employee")
...
noreflectioncompany_Company_m_dummyInvariant: Method = Method(name="dummyInvariant", parameters={Parameter(name='noreflectioncompany_diagnostics', type=StringType), Parameter(name='noreflectioncompany_context', type=StringType)}, type=BooleanType)
noreflectioncompany_Company.attributes={noreflectioncompany_Company_size, noreflectioncompany_Company_name}
...
noreflectioncompany_Employee_m_reportsTo: Method = Method(name="reportsTo", parameters={Parameter(name='noreflectioncompany_manager', type=StringType)}, type=BooleanType)
noreflectioncompany_Employee_m_hasNameAsOperation: Method = Method(name="hasNameAsOperation", parameters={}, type=BooleanType)
noreflectioncompany_Employee_m_noManagerImpliesDirectReports: Method = Method(name="noManagerImpliesDirectReports", parameters={Parameter(name='noreflectioncompany_context', type=StringType), Parameter(name='noreflectioncompany_diagnostics', type=StringType)}, type=BooleanType)
...
noreflectioncompany_Employee.methods={noreflectioncompany_Employee_m_reportsTo, noreflectioncompany_Employee_m_noManagerImpliesDirectReports, noreflectioncompany_Employee_m_hasNameAsOperation}
