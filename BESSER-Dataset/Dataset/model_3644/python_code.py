...
class noreflectioncompany_Employee:
    ...
    def reportsTo(self, noreflectioncompany_manager) :
    ...
    def noManagerImpliesDirectReports(self, noreflectioncompany_context, noreflectioncompany_diagnostics) :
...
class noreflectioncompany_Company:
    ...
    def dummyInvariant(self, noreflectioncompany_diagnostics, noreflectioncompany_context) :
