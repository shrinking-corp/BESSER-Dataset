...
# Classes
MicrocontrollerModeling_Microcontroller = Class(name="MicrocontrollerModeling_Microcontroller")
MicrocontrollerModeling_Pin = Class(name="MicrocontrollerModeling_Pin")
MicrocontrollerModeling_CLanguage = Class(name="MicrocontrollerModeling_CLanguage")
MicrocontrollerModeling_Processor = Class(name="MicrocontrollerModeling_Processor")
MicrocontrollerModeling_ROM = Class(name="MicrocontrollerModeling_ROM")
MicrocontrollerModeling_PinOperation = Class(name="MicrocontrollerModeling_PinOperation")
MicrocontrollerModeling_Function = Class(name="MicrocontrollerModeling_Function")
MicrocontrollerModeling_Parameter = Class(name="MicrocontrollerModeling_Parameter")
MicrocontrollerModeling_Instruction = Class(name="MicrocontrollerModeling_Instruction")
Function = Class(name="Function")
MicrocontrollerModeling_Memory = Class(name="MicrocontrollerModeling_Memory", is_abstract=True)
MicrocontrollerModeling_Flash = Class(name="MicrocontrollerModeling_Flash")
MicrocontrollerModeling_RAM = Class(name="MicrocontrollerModeling_RAM")
MicrocontrollerModeling_Register = Class(name="MicrocontrollerModeling_Register")
MicrocontrollerModeling_Library = Class(name="MicrocontrollerModeling_Library")
MicrocontrollerModeling_TimerConfig = Class(name="MicrocontrollerModeling_TimerConfig")
MicrocontrollerModeling_PinMode = Class(name="MicrocontrollerModeling_PinMode")
Memory = Class(name="Memory")
MicrocontrollerModeling_EEPROM = Class(name="MicrocontrollerModeling_EEPROM")
ROM = Class(name="ROM")
...
MicrocontrollerModeling_Microcontroller.attributes={MicrocontrollerModeling_Microcontroller_wordMemory, MicrocontrollerModeling_Microcontroller_manufacturer, MicrocontrollerModeling_Microcontroller_family, MicrocontrollerModeling_Microcontroller_name}
...
MicrocontrollerModeling_Pin.attributes={MicrocontrollerModeling_Pin_nature, MicrocontrollerModeling_Pin_name, MicrocontrollerModeling_Pin_number}
...
MicrocontrollerModeling_CLanguage.attributes={MicrocontrollerModeling_CLanguage_filesExtension, MicrocontrollerModeling_CLanguage_hasMain, MicrocontrollerModeling_CLanguage_name}
...
MicrocontrollerModeling_Register.attributes={MicrocontrollerModeling_Register_name, MicrocontrollerModeling_Register_type}
...
domain_model = DomainModel(
    ...
    types={MicrocontrollerModeling_Microcontroller, MicrocontrollerModeling_Pin, MicrocontrollerModeling_CLanguage, MicrocontrollerModeling_Processor, MicrocontrollerModeling_ROM, MicrocontrollerModeling_PinOperation, MicrocontrollerModeling_Function, MicrocontrollerModeling_Parameter, MicrocontrollerModeling_Instruction, Function, MicrocontrollerModeling_Memory, MicrocontrollerModeling_Flash, MicrocontrollerModeling_RAM, MicrocontrollerModeling_Register, MicrocontrollerModeling_Library, MicrocontrollerModeling_TimerConfig, MicrocontrollerModeling_PinMode, Memory, MicrocontrollerModeling_EEPROM, ROM, EEPROM, SpeedUnit, MemoryUnit, PinNature, TimerOp, RegType, PinModes, WordSize, OperationName},
    associations={pins0, clanguage1, processor3, rom5, pinoperation19, parameters21, instructions22, flash7, ram9, registers11, libraries13, timerconfig15, pinmodes17},
    generalizations={gen_MicrocontrollerModeling_TimerConfig_Function, gen_MicrocontrollerModeling_PinOperation_Function, gen_MicrocontrollerModeling_ROM_Memory, gen_MicrocontrollerModeling_EEPROM_ROM, gen_MicrocontrollerModeling_Flash_EEPROM, gen_MicrocontrollerModeling_RAM_Memory},
    metadata=None
)
