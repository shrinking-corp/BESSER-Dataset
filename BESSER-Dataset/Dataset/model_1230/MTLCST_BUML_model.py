...
# Classes
cst_CSTNode = Class(name="cst_CSTNode", is_abstract=True)
cst_Module = Class(name="cst_Module")
EPackage = Class(name="EPackage")
CSTNode = Class(name="CSTNode")
cst_TypedModel = Class(name="cst_TypedModel")
cst_ModuleElement = Class(name="cst_ModuleElement", is_abstract=True)
cst_ModuleExtendsValue = Class(name="cst_ModuleExtendsValue")
cst_ModuleImportsValue = Class(name="cst_ModuleImportsValue")
cst_Documentation = Class(name="cst_Documentation")
cst_Comment = Class(name="cst_Comment")
ModuleElement = Class(name="ModuleElement")
TemplateExpression = Class(name="TemplateExpression")
cst_Template = Class(name="cst_Template")
Block = Class(name="Block")
cst_TemplateOverridesValue = Class(name="cst_TemplateOverridesValue")
cst_Variable = Class(name="cst_Variable")
cst_ModelExpression = Class(name="cst_ModelExpression")
cst_TemplateExpression = Class(name="cst_TemplateExpression")
cst_EPackage = Class(name="cst_EPackage")
cst_TextExpression = Class(name="cst_TextExpression")
cst_Block = Class(name="cst_Block")
cst_InitSection = Class(name="cst_InitSection")
cst_ProtectedAreaBlock = Class(name="cst_ProtectedAreaBlock")
cst_ForBlock = Class(name="cst_ForBlock")
cst_LetBlock = Class(name="cst_LetBlock")
cst_FileBlock = Class(name="cst_FileBlock")
cst_TraceBlock = Class(name="cst_TraceBlock")
cst_Macro = Class(name="cst_Macro")
cst_Query = Class(name="cst_Query")
cst_IfBlock = Class(name="cst_IfBlock")
...
cst_CSTNode.attributes={cst_CSTNode_startPosition, cst_CSTNode_endPosition}
...
cst_Variable.attributes={cst_Variable_name, cst_Variable_type}
...
else_66: BinaryAssociation = BinaryAssociation(
    name="else_66",
    ends={
...
domain_model = DomainModel(
    name="cst",
    types={cst_CSTNode, cst_Module, EPackage, CSTNode, cst_TypedModel, cst_ModuleElement, cst_ModuleExtendsValue, cst_ModuleImportsValue, cst_Documentation, cst_Comment, ModuleElement, TemplateExpression, cst_Template, Block, cst_TemplateOverridesValue, cst_Variable, cst_ModelExpression, cst_TemplateExpression, cst_EPackage, cst_TextExpression, cst_Block, cst_InitSection, cst_ProtectedAreaBlock, cst_ForBlock, cst_LetBlock, cst_FileBlock, cst_TraceBlock, cst_Macro, cst_Query, cst_IfBlock, Comment, VisibilityKind, OpenModeKind},
    associations={input0, ownedModuleElement1, extends3, imports5, documentation7, takesTypesFrom9, overrides11, parameter12, guard14, post16, initExpression19, before23, each26, after29, init31, body32, variable34, marker37, loopVariable39, iterSet41, before44, ifExpr56, else_58, elseIf62, elseLet65, else_66, letVariable69, fileUrl72, uniqId74, charset77, modelElement80, parameter82, parameter84, each47, after50, guard53, expression86},
    generalizations={gen_cst_Module_EPackage, gen_cst_Module_CSTNode, gen_cst_ModuleExtendsValue_CSTNode, gen_cst_ModuleElement_CSTNode, gen_cst_Comment_ModuleElement, gen_cst_Comment_TemplateExpression, gen_cst_Template_Block, gen_cst_Template_ModuleElement, gen_cst_TemplateOverridesValue_CSTNode, gen_cst_Variable_CSTNode, gen_cst_TemplateExpression_CSTNode, gen_cst_ModelExpression_TemplateExpression, gen_cst_ModuleImportsValue_CSTNode, gen_cst_TypedModel_CSTNode, gen_cst_TextExpression_TemplateExpression, gen_cst_Block_TemplateExpression, gen_cst_InitSection_CSTNode, gen_cst_ProtectedAreaBlock_Block, gen_cst_ForBlock_Block, gen_cst_IfBlock_Block, gen_cst_LetBlock_Block, gen_cst_FileBlock_Block, gen_cst_TraceBlock_Block, gen_cst_Macro_Block, gen_cst_Macro_ModuleElement, gen_cst_Query_ModuleElement, gen_cst_Documentation_Comment},
    metadata=None
)
