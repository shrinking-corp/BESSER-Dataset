...
# Classes
database_FKey = Class(name="database_FKey")
RefFKey = Class(name="RefFKey")
database_Column = Class(name="database_Column")
database_RefTable = Class(name="database_RefTable", is_abstract=True)
RefColumn = Class(name="RefColumn")
database_RefType = Class(name="database_RefType", is_abstract=True)
...
database_RefColumn = Class(name="database_RefColumn", is_abstract=True)
database_RefPKey = Class(name="database_RefPKey", is_abstract=True)
database_RefFKey = Class(name="database_RefFKey", is_abstract=True)
database_Type = Class(name="database_Type")
RefType = Class(name="RefType")
database_PKey = Class(name="database_PKey")
RefPKey = Class(name="RefPKey")
database_RefProcedure = Class(name="database_RefProcedure", is_abstract=True)
database_RefDatabase = Class(name="database_RefDatabase", is_abstract=True)
database_Procedure = Class(name="database_Procedure")
RefProcedure = Class(name="RefProcedure")
database_RefParameter = Class(name="database_RefParameter", is_abstract=True)
database_Parameter = Class(name="database_Parameter")
...
return_15: BinaryAssociation = BinaryAssociation(
    name="return_15",
    ends={
...
domain_model = DomainModel(
    name="database",
    types={database_FKey, RefFKey, database_Column, database_RefTable, RefColumn, database_RefType, database_Database, RefDatabase, database_Table, RefTable, database_RefColumn, database_RefPKey, database_RefFKey, database_Type, RefType, database_PKey, RefPKey, database_RefProcedure, database_RefDatabase, database_Procedure, RefProcedure, database_RefParameter, database_Parameter, RefParameter},
    associations={columns5, reference6, type8, columns0, pkeys1, fkeys3, columns20, tables10, procedures12, parameters14, return_15, type18},
    generalizations={gen_database_FKey_RefFKey, gen_database_Column_RefColumn, gen_database_Database_RefDatabase, gen_database_Table_RefTable, gen_database_Type_RefType, gen_database_PKey_RefPKey, gen_database_Procedure_RefProcedure, gen_database_Parameter_RefParameter},
    metadata=None
)
