...
class mt_statements_Comment(Statement):
    ...
    def __init__(self, value: str, Statement30: "mt_statements_If" = None, Statement33: "mt_statements_If" = None, Statement11: "mt_core_FilePath" = None, Statement: "mt_core_Script" = None, Statement40: "mt_statements_For" = None):
        self.value = value
...
class mt_core_ScriptDescriptor(ASTNode):
    ...
    def __init__(self, name: str, type: str, description: str, mt_core_ScriptDescriptor9: "Expression" = None, mt_core_ScriptDescriptor: "FilePath" = None):
        self.name = name
        self.type = type
...
class mt_core_Method:
    ...
    def __init__(self, name: str, return_: str, mt_core_Method: set["Parameter"] = None):
        self.name = name
...
class mt_expressions_Operator(Expression):
    ...
    def __init__(self, operator: str, mt_expressions_Operator: set["Expression"] = None, Expression37: "mt_statements_For" = None, Expression23: "mt_expressions_Operator" = None, Expression42: "mt_statements_Feature" = None, Expression21: "mt_expressions_Not" = None, Expression27: "mt_statements_If" = None, Expression: "mt_core_ScriptDescriptor" = None, Expression25: "mt_expressions_Parenthesis" = None, Expression19: "mt_expressions_Call" = None, Expression16: "mt_expressions_Call" = None):
