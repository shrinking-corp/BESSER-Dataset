...
rdbmsMM_dummy = Class(name="rdbmsMM_dummy")
...
domain_model = DomainModel(
    name="rdbmsMM",
    types={rdbmsMM_Schema, rdbmsMM_Table, rdbmsMM_ForeignKey, rdbmsMM_Column, rdbmsMM_Key, rdbmsMM_dummy},
    associations={hasForeignKey7, owner10, hasKey12, hasForeignKey15, table0, foreignKey1, schema3, column4, hasKey5, owner18, column20, referredBy23, schema25, refersTo27, owner29, column31, containsSchema34},
    generalizations={},
    metadata=None
)
