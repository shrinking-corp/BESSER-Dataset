...
class rdbmsMM_Key:
    ...
    def __init__(self, name: str, Key14: "rdbmsMM_Column" = None, Key: "rdbmsMM_Table" = None, hasKey: "rdbmsMM_Table" = None, hasKey21: set["rdbmsMM_Column"] = None, refersTo: set["rdbmsMM_ForeignKey"] = None, Key28: "rdbmsMM_ForeignKey" = None):
        self.name = name
        self.Key14 = Key14
        self.Key = Key
        self.hasKey = hasKey
...
class rdbmsMM_Column:
    ...
    def __init__(self, name: str, type: str, column: "rdbmsMM_Table" = None, column13: set["rdbmsMM_Key"] = None, column16: set["rdbmsMM_ForeignKey"] = None, Column: "rdbmsMM_Table" = None, Column22: "rdbmsMM_Key" = None, Column33: "rdbmsMM_ForeignKey" = None):
        self.name = name
        self.type = type
        self.column = column
...
class rdbmsMM_ForeignKey:
    ...
    def __init__(self, name: str, ForeignKey9: "rdbmsMM_Table" = None, ForeignKey17: "rdbmsMM_Column" = None, ForeignKey: "rdbmsMM_Schema" = None, ForeignKey24: "rdbmsMM_Key" = None, foreignKey: "rdbmsMM_Schema" = None, referredBy: "rdbmsMM_Key" = None, hasForeignKey: "rdbmsMM_Table" = None, hasForeignKey32: set["rdbmsMM_Column"] = None):
        self.name = name
...
class rdbmsMM_Table:
    ...
    def __init__(self, name: str, owner8: set["rdbmsMM_ForeignKey"] = None, Table11: "rdbmsMM_Column" = None, Table: "rdbmsMM_Schema" = None, table: "rdbmsMM_Schema" = None, owner: set["rdbmsMM_Column"] = None, owner6: "rdbmsMM_Key" = None, Table19: "rdbmsMM_Key" = None, Table30: "rdbmsMM_ForeignKey" = None):
        self.name = name
...
class rdbmsMM_Schema:
    ...
    def __init__(self, name: str, schema: set["rdbmsMM_Table"] = None, schema2: set["rdbmsMM_ForeignKey"] = None, Schema: "rdbmsMM_Table" = None, Schema26: "rdbmsMM_ForeignKey" = None, rdbmsMM_Schema: "rdbmsMM_dummy" = None):
        self.name = name
