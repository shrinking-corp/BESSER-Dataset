...
# Classes
EFM_FeatureModel = Class(name="EFM_FeatureModel")
EFM_FMConstraint = Class(name="EFM_FMConstraint", is_abstract=True)
EFM_Feature = Class(name="EFM_Feature")
EFM_FMElement = Class(name="EFM_FMElement")
FMElement = Class(name="FMElement")
EFM_Attribute = Class(name="EFM_Attribute")
EFM_FeatCardinality = Class(name="EFM_FeatCardinality")
EFM_NodeFeature = Class(name="EFM_NodeFeature")
EFM_Exclusive = Class(name="EFM_Exclusive")
Alternative = Class(name="Alternative")
EFM_Alternative = Class(name="EFM_Alternative")
Feature = Class(name="Feature")
EFM_Cardinality = Class(name="EFM_Cardinality", is_abstract=True)
EFM_Value = Class(name="EFM_Value")
EFM_BooleanConstraint = Class(name="EFM_BooleanConstraint", is_abstract=True)
FMConstraint = Class(name="FMConstraint")
Cardinality = Class(name="Cardinality")
EFM_Implies = Class(name="EFM_Implies")
BooleanConstraint = Class(name="BooleanConstraint")
EFM_Excludes = Class(name="EFM_Excludes")
EFM_Requires = Class(name="EFM_Requires")
EFM_Operation = Class(name="EFM_Operation")
EFM_Functional = Class(name="EFM_Functional")
EFM_Comparison = Class(name="EFM_Comparison")
EFM_RangeOperation = Class(name="EFM_RangeOperation")
Operation = Class(name="Operation")
EFM_ValueOperation = Class(name="EFM_ValueOperation")
EFM_IntValue = Class(name="EFM_IntValue")
EFM_Colocated = Class(name="EFM_Colocated")
NodeFeatureElement = Class(name="NodeFeatureElement")
EFM_HostedBy = Class(name="EFM_HostedBy")
EFM_NotHostedBy = Class(name="EFM_NotHostedBy")
EFM_Separated = Class(name="EFM_Separated")
EFM_ResourceVerification = Class(name="EFM_ResourceVerification")
EFM_NodeFeatureElement = Class(name="EFM_NodeFeatureElement", is_abstract=True)
...
EFM_Cardinality.attributes={EFM_Cardinality_cardinalityMax, EFM_Cardinality_configValue, EFM_Cardinality_cardinalityMin}
...
from_30: BinaryAssociation = BinaryAssociation(
    name="from_30",
    ends={
...
from_43: BinaryAssociation = BinaryAssociation(
    name="from_43",
    ends={
...
from_58: BinaryAssociation = BinaryAssociation(
    name="from_58",
    ends={
...
from_64: BinaryAssociation = BinaryAssociation(
    name="from_64",
    ends={
...
domain_model = DomainModel(
    name="EFM",
    types={EFM_FeatureModel, EFM_FMConstraint, EFM_Feature, EFM_FMElement, FMElement, EFM_Attribute, EFM_FeatCardinality, EFM_NodeFeature, EFM_Exclusive, Alternative, EFM_Alternative, Feature, EFM_Cardinality, EFM_Value, EFM_BooleanConstraint, FMConstraint, Cardinality, EFM_Implies, BooleanConstraint, EFM_Excludes, EFM_Requires, EFM_Operation, EFM_Functional, EFM_Comparison, EFM_RangeOperation, Operation, EFM_ValueOperation, EFM_IntValue, EFM_Colocated, NodeFeatureElement, EFM_HostedBy, EFM_NotHostedBy, EFM_Separated, EFM_ResourceVerification, EFM_NodeFeatureElement, ComparisonOperator, Operator, LogicalOperator},
    associations={constraints0, action22, rootFeature1, attributes3, subFeatures6, featureCardinality8, nodeFeature10, variants12, value14, from_16, to18, conditions21, fromAgain45, from_25, to27, from_30, to31, feature34, attribute37, attribute39, value41, from_43, NodeAttributes48, NodeCardinalities51, HostedBy54, NotHostedBy56, from_58, to61, from_64, to66, fromAtt69, extF71, extF74, From77},
    generalizations={gen_EFM_Feature_FMElement, gen_EFM_Exclusive_Alternative, gen_EFM_Alternative_Feature, gen_EFM_Attribute_FMElement, gen_EFM_BooleanConstraint_FMConstraint, gen_EFM_FeatCardinality_Cardinality, gen_EFM_Implies_BooleanConstraint, gen_EFM_Excludes_BooleanConstraint, gen_EFM_Requires_FMConstraint, gen_EFM_Functional_FMConstraint, gen_EFM_Comparison_FMConstraint, gen_EFM_RangeOperation_Operation, gen_EFM_ValueOperation_Operation, gen_EFM_Colocated_FMConstraint, gen_EFM_NodeFeature_NodeFeatureElement, gen_EFM_HostedBy_FMConstraint, gen_EFM_Separated_FMConstraint, gen_EFM_ResourceVerification_FMConstraint, gen_EFM_NotHostedBy_FMConstraint},
    metadata=None
)
