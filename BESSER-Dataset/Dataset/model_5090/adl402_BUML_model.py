...
# Classes
adl402_Interface = Class(name="adl402_Interface", is_abstract=True)
adl402_Binding = Class(name="adl402_Binding", is_abstract=True)
adl402_Component = Class(name="adl402_Component")
adl402_EClass0 = Class(name="adl402_EClass0")
adl402_Required = Class(name="adl402_Required")
Interface = Class(name="Interface")
adl402_Provided = Class(name="adl402_Provided")
adl402_Content = Class(name="adl402_Content")
adl402_EClass1 = Class(name="adl402_EClass1")
Binding = Class(name="Binding")
adl402_EClass2 = Class(name="adl402_EClass2")
...
adl402_Interface.attributes={adl402_Interface_name, adl402_Interface_signature}
...
adl402_Content.attributes={adl402_Content_language, adl402_Content_expression}
...
domain_model = DomainModel(
    name="adl402",
    types={adl402_Interface, adl402_Binding, adl402_Component, adl402_EClass0, adl402_Required, Interface, adl402_Provided, adl402_Content, adl402_EClass1, Binding, adl402_EClass2},
    associations={bindings0, contentParent7, EReference08, subComponents10, requiredInterfaces11, providedInterfaces13, content15, from_1, to4, erefs017},
