...
Order.attributes={Order_shipped, Order_total, Order_shipTo, Order_ordered, Order_status, Order_number}
...
domain_model = DomainModel(
    name="b7b88ab0_9735_4d19_91e1_02b4ded67864",
    types={Customer, Payment, ShoppingCart, Account, WebUser, Order, LineItem, Product, UserState, OrderStatus},
    associations={Account_ShoppingCart, ShoppingCart_LineItem, Product_LineItem, Order_LineItem, Account_Order, Payment_Order, Account_Payment, WebUser_ShoppingCart, WebUser_Customer, Customer_Account},
    generalizations={},
    metadata=None
)
