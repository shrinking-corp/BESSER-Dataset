...
def test_application_mashup_has_keepDeletedItemsList():
    assert hasattr(application_Mashup, "keepDeletedItemsList")
    descriptor = None
    for klass in application_Mashup.__mro__:
...
@given(instance=application_Mashup_strategy)
def test_application_mashup_keepDeletedItemsList_setter(instance):
