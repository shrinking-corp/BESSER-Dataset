...
class application_Interface(ConfigurableElement):
    ...
    def __init__(self, urlSuffix: str, frontEndCaching: str, interfaces: "application_Mashup" = None, application_Interface: "application_MashupContainer" = None, interface: "application_Security" = None, Interface26: "application_Security" = None, Interface: "application_Mashup" = None):
...
class application_Source(ConfigurableElement):
    ...
    def __init__(self, bundleId: str, state: str, activeState: str, logLevel: str, removeDataOnStop: str, updateRound: str, application_Source2: "application_DataSet" = None, sources: "application_Mashup" = None, application_Source: "application_Persistency" = None, Source: "application_Mashup" = None):
...
class application_Mashup(Source):
    ...
    def __init__(self, workingDirectory: str, cacheAttachments: str, cacheDataSet: str, backupDataSet: str, backupIntervall: str, cacheDelay: str, sourceIdentCounter: str, keepDeletedItemsList: str, Mashup: "application_Source" = None, configurableMashups: set["application_MashupAdmin"] = None, Mashup24: "application_Interface" = None, application_Mashup11: "application_MashupContainer" = None, application_Mashup16: "application_MashupContainer" = None, application_Mashup19: "application_MashupContainer" = None, Mashup33: "application_MashupAdmin" = None, application_Mashup: set["application_MappingRule"] = None, mashup: set["application_Source"] = None, mashup7: set["application_Interface"] = None):
