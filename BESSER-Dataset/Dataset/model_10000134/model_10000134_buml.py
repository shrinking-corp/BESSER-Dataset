...
domain_model = DomainModel(
    name="_1089f050_80c4_4137_a91f_352182191721",
    types={GenericSound, Vendor1Adapter, Vendor2Adapter, Vendor1Sound, Vendor2Sound, ExtensionBoard, FastCard, Actor_Actor, CPU, Processor, AcceleratorCard, Cache, RAM, Machine, Program, Instruction, Memory_Interface, DeviceCard, Card, Sound},
