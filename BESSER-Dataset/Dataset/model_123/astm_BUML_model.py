...
astm_SpecificClassType = Class(name="astm_SpecificClassType")
...
astm_SourceLocation.attributes={astm_SourceLocation_endColumn, astm_SourceLocation_endLine, astm_SourceLocation_startLine, astm_SourceLocation_startColumn}
