...
def test_astm_specificclasstype_is_not_abstract():
    assert not inspect.isabstract(astm_SpecificClassType)


def test_astm_specificclasstype_constructor_exists():
    assert callable(astm_SpecificClassType.__init__)


def test_astm_specificclasstype_constructor_args():
...
def test_astm_specificclasstype_has_package():
    assert hasattr(astm_SpecificClassType, "package")
    descriptor = None
    for klass in astm_SpecificClassType.__mro__:
        if "package" in klass.__dict__:
            descriptor = klass.__dict__["package"]
            break
    assert isinstance(descriptor, property)

def test_astm_specificclasstype_has_imports():
    assert hasattr(astm_SpecificClassType, "imports")
    descriptor = None
    for klass in astm_SpecificClassType.__mro__:
...
@given(instance=astm_SpecificClassType_strategy)
def test_astm_specificclasstype_package_setter(instance):
...
@given(instance=astm_SpecificClassType_strategy)
def test_astm_specificclasstype_imports_setter(instance):
