...
class StartGame:
    ...
    def __init__(self, playerOrder: str, t1: Team, t2: Team, trick: Trick, lead: int, turn: int, bidNumber: int, deck: Deck, p1: Player, p2: Player, p3: Player, p4: Player, player6: set["Player"] = None, team8: set["Team"] = None, deck10: set["Deck"] = None, trick12: set["Trick"] = None):
