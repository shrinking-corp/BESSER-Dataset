...
def test_hyp_clinicasaudeperfeita_consulta_usecase_is_not_abstract():
    assert not inspect.isabstract(clinicasaudeperfeita_Consulta_UseCase)


def test_hyp_clinicasaudeperfeita_consulta_usecase_constructor_exists():
    assert callable(clinicasaudeperfeita_Consulta_UseCase.__init__)


def test_hyp_clinicasaudeperfeita_consulta_usecase_constructor_args():
    sig = inspect.signature(clinicasaudeperfeita_Consulta_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_clinicasaudeperfeita_medico_actor_is_not_abstract():
    assert not inspect.isabstract(clinicasaudeperfeita_Medico_Actor)


def test_hyp_clinicasaudeperfeita_medico_actor_constructor_exists():
    assert callable(clinicasaudeperfeita_Medico_Actor.__init__)


def test_hyp_clinicasaudeperfeita_medico_actor_constructor_args():
    sig = inspect.signature(clinicasaudeperfeita_Medico_Actor.__init__)
    params = list(sig.parameters.keys())



def test_hyp_clinicasaudeperfeita_marca_consulta_usecase_is_not_abstract():
    assert not inspect.isabstract(clinicasaudeperfeita_Marca_consulta_UseCase)


def test_hyp_clinicasaudeperfeita_marca_consulta_usecase_constructor_exists():
    assert callable(clinicasaudeperfeita_Marca_consulta_UseCase.__init__)


def test_hyp_clinicasaudeperfeita_marca_consulta_usecase_constructor_args():
    sig = inspect.signature(clinicasaudeperfeita_Marca_consulta_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_clinicasaudeperfeita_recepcionista_actor_is_not_abstract():
    assert not inspect.isabstract(clinicasaudeperfeita_Recepcionista_Actor)


def test_hyp_clinicasaudeperfeita_recepcionista_actor_constructor_exists():
    assert callable(clinicasaudeperfeita_Recepcionista_Actor.__init__)


def test_hyp_clinicasaudeperfeita_recepcionista_actor_constructor_args():
    sig = inspect.signature(clinicasaudeperfeita_Recepcionista_Actor.__init__)
    params = list(sig.parameters.keys())



def test_hyp_clinicasaudeperfeita_analisa_consulta_usecase_is_not_abstract():
    assert not inspect.isabstract(clinicasaudeperfeita_Analisa_consulta_UseCase)


def test_hyp_clinicasaudeperfeita_analisa_consulta_usecase_constructor_exists():
    assert callable(clinicasaudeperfeita_Analisa_consulta_UseCase.__init__)


def test_hyp_clinicasaudeperfeita_analisa_consulta_usecase_constructor_args():
    sig = inspect.signature(clinicasaudeperfeita_Analisa_consulta_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_clinicasaudeperfeita_paciente_actor_is_not_abstract():
    assert not inspect.isabstract(clinicasaudeperfeita_Paciente_Actor)


def test_hyp_clinicasaudeperfeita_paciente_actor_constructor_exists():
    assert callable(clinicasaudeperfeita_Paciente_Actor.__init__)


def test_hyp_clinicasaudeperfeita_paciente_actor_constructor_args():
...
def test_hyp_clinicasaudeperfeita_medico_is_not_abstract():
    assert not inspect.isabstract(clinicasaudeperfeita_Medico)


def test_hyp_clinicasaudeperfeita_medico_constructor_exists():
    assert callable(clinicasaudeperfeita_Medico.__init__)


def test_hyp_clinicasaudeperfeita_medico_constructor_args():
...
def test_hyp_clinicasaudeperfeita_medico_has_idade():
...
def test_hyp_clinicasaudeperfeita_medico_has_cpf():
...
def test_hyp_clinicasaudeperfeita_medico_has_agenda():
...
def test_hyp_clinicasaudeperfeita_medico_has_nome():
...
def test_hyp_clinicasaudeperfeita_recepcionista_is_not_abstract():
    assert not inspect.isabstract(clinicasaudeperfeita_Recepcionista)


def test_hyp_clinicasaudeperfeita_recepcionista_constructor_exists():
    assert callable(clinicasaudeperfeita_Recepcionista.__init__)


def test_hyp_clinicasaudeperfeita_recepcionista_constructor_args():
...
def test_hyp_clinicasaudeperfeita_medicamento_is_not_abstract():
    assert not inspect.isabstract(clinicasaudeperfeita_Medicamento)


def test_hyp_clinicasaudeperfeita_medicamento_constructor_exists():
    assert callable(clinicasaudeperfeita_Medicamento.__init__)


def test_hyp_clinicasaudeperfeita_medicamento_constructor_args():
...
def test_hyp_clinicasaudeperfeita_exame_is_not_abstract():
    assert not inspect.isabstract(clinicasaudeperfeita_Exame)


def test_hyp_clinicasaudeperfeita_exame_constructor_exists():
    assert callable(clinicasaudeperfeita_Exame.__init__)


def test_hyp_clinicasaudeperfeita_exame_constructor_args():
...
def test_hyp_clinicasaudeperfeita_consulta_is_not_abstract():
    assert not inspect.isabstract(clinicasaudeperfeita_Consulta)


def test_hyp_clinicasaudeperfeita_consulta_constructor_exists():
    assert callable(clinicasaudeperfeita_Consulta.__init__)


def test_hyp_clinicasaudeperfeita_consulta_constructor_args():
...
def test_hyp_clinicasaudeperfeita_consulta_has_medico():
...
def test_hyp_clinicasaudeperfeita_consulta_has_medicamentos():
...
def test_hyp_clinicasaudeperfeita_consulta_has_data():
...
def test_hyp_clinicasaudeperfeita_consulta_has_problemasPaciente():
...
def test_hyp_clinicasaudeperfeita_consulta_has_orientacoesMedicas():
...
def test_hyp_clinicasaudeperfeita_consulta_has_paciente():
...
def test_hyp_clinicasaudeperfeita_consulta_has_exame():
...
def test_hyp_clinicasaudeperfeita_consulta_has_marcada():
...
def test_hyp_clinicasaudeperfeita_consulta_has_realizada():
...
def test_hyp_clinicasaudeperfeita_consulta_has_hora():
...
def test_hyp_clinicasaudeperfeita_compromisso_is_not_abstract():
    assert not inspect.isabstract(clinicasaudeperfeita_Compromisso)


def test_hyp_clinicasaudeperfeita_compromisso_constructor_exists():
    assert callable(clinicasaudeperfeita_Compromisso.__init__)


def test_hyp_clinicasaudeperfeita_compromisso_constructor_args():
...
def test_hyp_clinicasaudeperfeita_paciente_is_not_abstract():
    assert not inspect.isabstract(clinicasaudeperfeita_Paciente)


def test_hyp_clinicasaudeperfeita_paciente_constructor_exists():
    assert callable(clinicasaudeperfeita_Paciente.__init__)


def test_hyp_clinicasaudeperfeita_paciente_constructor_args():
...
def test_hyp_clinicasaudeperfeita_medico_instantiation(instance):
    assert isinstance(instance, clinicasaudeperfeita_Medico)



@given(instance=clinicasaudeperfeita_Medico_strategy)
def test_hyp_clinicasaudeperfeita_medico_idade_setter(instance):
...
@given(instance=clinicasaudeperfeita_Medico_strategy)
def test_hyp_clinicasaudeperfeita_medico_cpf_setter(instance):
...
@given(instance=clinicasaudeperfeita_Medico_strategy)
def test_hyp_clinicasaudeperfeita_medico_agenda_setter(instance):
...
@given(instance=clinicasaudeperfeita_Medico_strategy)
def test_hyp_clinicasaudeperfeita_medico_nome_setter(instance):
...
def test_hyp_clinicasaudeperfeita_recepcionista_cpf_setter(instance):
    original = instance.cpf
    instance.cpf = original
    assert instance.cpf == original
...
@given(instance=clinicasaudeperfeita_Recepcionista_strategy)
def test_hyp_clinicasaudeperfeita_recepcionista_nome_setter(instance):
    original = instance.nome
    instance.nome = original
    assert instance.nome == original
...
@given(instance=clinicasaudeperfeita_Recepcionista_strategy)
def test_hyp_clinicasaudeperfeita_recepcionista_idade_setter(instance):
    original = instance.idade
    instance.idade = original
    assert instance.idade == original
...
def test_hyp_clinicasaudeperfeita_medicamento_nome_setter(instance):
    original = instance.nome
    instance.nome = original
    assert instance.nome == original
...
def test_hyp_clinicasaudeperfeita_exame_nome_setter(instance):
    original = instance.nome
    instance.nome = original
    assert instance.nome == original
...
@settings(max_examples=50)
def test_hyp_clinicasaudeperfeita_consulta_instantiation(instance):
    assert isinstance(instance, clinicasaudeperfeita_Consulta)



@given(instance=clinicasaudeperfeita_Consulta_strategy)
def test_hyp_clinicasaudeperfeita_consulta_medico_setter(instance):
...
@given(instance=clinicasaudeperfeita_Consulta_strategy)
def test_hyp_clinicasaudeperfeita_consulta_medicamentos_setter(instance):
...
@given(instance=clinicasaudeperfeita_Consulta_strategy)
def test_hyp_clinicasaudeperfeita_consulta_data_setter(instance):
...
@given(instance=clinicasaudeperfeita_Consulta_strategy)
def test_hyp_clinicasaudeperfeita_consulta_problemasPaciente_setter(instance):
...
@given(instance=clinicasaudeperfeita_Consulta_strategy)
def test_hyp_clinicasaudeperfeita_consulta_orientacoesMedicas_setter(instance):
...
@given(instance=clinicasaudeperfeita_Consulta_strategy)
def test_hyp_clinicasaudeperfeita_consulta_paciente_setter(instance):
...
@given(instance=clinicasaudeperfeita_Consulta_strategy)
def test_hyp_clinicasaudeperfeita_consulta_exame_setter(instance):
...
@given(instance=clinicasaudeperfeita_Consulta_strategy)
def test_hyp_clinicasaudeperfeita_consulta_marcada_setter(instance):
...
@given(instance=clinicasaudeperfeita_Consulta_strategy)
def test_hyp_clinicasaudeperfeita_consulta_realizada_setter(instance):
...
@given(instance=clinicasaudeperfeita_Consulta_strategy)
def test_hyp_clinicasaudeperfeita_consulta_hora_setter(instance):
...
def test_hyp_clinicasaudeperfeita_compromisso_hora_setter(instance):
    original = instance.hora
    instance.hora = original
    assert instance.hora == original
...
@given(instance=clinicasaudeperfeita_Compromisso_strategy)
def test_hyp_clinicasaudeperfeita_compromisso_descricao_setter(instance):
...
@given(instance=clinicasaudeperfeita_Compromisso_strategy)
def test_hyp_clinicasaudeperfeita_compromisso_data_setter(instance):
    original = instance.data
    instance.data = original
    assert instance.data == original
...
def test_hyp_clinicasaudeperfeita_paciente_cpf_setter(instance):
    original = instance.cpf
    instance.cpf = original
    assert instance.cpf == original
...
@given(instance=clinicasaudeperfeita_Paciente_strategy)
def test_hyp_clinicasaudeperfeita_paciente_nome_setter(instance):
    original = instance.nome
    instance.nome = original
    assert instance.nome == original
...
@given(instance=clinicasaudeperfeita_Paciente_strategy)
def test_hyp_clinicasaudeperfeita_paciente_idade_setter(instance):
    original = instance.idade
    instance.idade = original
    assert instance.idade == original
...
@given(instance=clinicasaudeperfeita_Paciente_strategy)
def test_hyp_clinicasaudeperfeita_paciente_cSus_setter(instance):
