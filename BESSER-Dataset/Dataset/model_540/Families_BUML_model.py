...
families_Pet = Class(name="families_Pet")
families_Person = Class(name="families_Person")
families_Dog = Class(name="families_Dog")
families_District = Class(name="families_District")
families_NamedElement = Class(name="families_NamedElement", is_abstract=True)
families_Suburb = Class(name="families_Suburb")
District = Class(name="District")
families_Model = Class(name="families_Model")
families_Bike = Class(name="families_Bike")
families_Account = Class(name="families_Account")
Pet = Class(name="Pet")
families_Band = Class(name="families_Band")
...
families_Family.attributes={families_Family_nuclear, families_Family_numberOfChildren, families_Family_id, families_Family_lotteryNumbers, families_Family_averageAge, families_Family_address, families_Family_averageAgePrecise}
...
families_Dog.attributes={families_Dog_breed, families_Dog_loud}
...
domain_model = DomainModel(
    name="families",
    types={families_Family, NamedElement, families_Pet, families_Person, families_Dog, families_District, families_NamedElement, families_Suburb, District, families_Model, families_Bike, families_Account, Pet, families_Band, DogBreed},
    associations={pets0, members1, dogs3, families22, dogs23, contents25, contents226, district5, sharedAccounts6, accounts8, friends12, parents15, allParents18, district20, rider29, owner31, members34},
    generalizations={gen_families_Family_NamedElement, gen_families_Suburb_District, gen_families_Model_NamedElement, gen_families_Pet_NamedElement, gen_families_Person_NamedElement, gen_families_Dog_Pet},
    metadata=None
)
