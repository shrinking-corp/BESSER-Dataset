...
class families_Family(NamedElement):
    ...
    def __init__(self, numberOfChildren: int, id: str, nuclear: bool, averageAge: float, lotteryNumbers: int, averageAgePrecise: float, address: str, families_Family: set["families_Pet"] = None, families_Family2: set["families_Person"] = None, families_Family4: set["families_Dog"] = None, Family: "families_District" = None, families: "families_District" = None, families_Family33: "families_Bike" = None):
