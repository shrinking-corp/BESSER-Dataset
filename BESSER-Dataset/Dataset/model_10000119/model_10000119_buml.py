...
# Classes
Stanovnik = Class(name="Stanovnik")
...
# Stanovnik class attributes and methods
...
User_Myprofile: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="user1", type=Stanovnik, multiplicity=Multiplicity(1, 1))
    }
)
User_Post: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="user3", type=Stanovnik, multiplicity=Multiplicity(1, 1))
    }
)
User_Login: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="user5", type=Stanovnik, multiplicity=Multiplicity(1, 1))
    }
)
User_Group: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="user7", type=Stanovnik, multiplicity=Multiplicity(1, 1))
    }
)
User_Message: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="user9", type=Stanovnik, multiplicity=Multiplicity(1, 1))
    }
)

# Domain Model
domain_model = DomainModel(
    name="_0f05d323_c8ec_4765_a9b8_ad9b6d2fdc24",
    types={Stanovnik, Profile, Post, Group, Message, Friend, Login},
