...
# Classes
model_Process = Class(name="model_Process")
BPELExtensibleElement = Class(name="BPELExtensibleElement")
model_MessageExchanges = Class(name="model_MessageExchanges")
model_PartnerLink = Class(name="model_PartnerLink")
Role = Class(name="Role")
PartnerLinkType = Class(name="PartnerLinkType")
model_PartnerLinks = Class(name="model_PartnerLinks")
model_Variables = Class(name="model_Variables")
model_Activity = Class(name="model_Activity")
model_FaultHandler = Class(name="model_FaultHandler")
model_EventHandler = Class(name="model_EventHandler")
model_CorrelationSets = Class(name="model_CorrelationSets")
model_Import = Class(name="model_Import")
model_Extensions = Class(name="model_Extensions")
model_Invoke = Class(name="model_Invoke")
PartnerActivity = Class(name="PartnerActivity")
model_Variable = Class(name="model_Variable")
model_CompensationHandler = Class(name="model_CompensationHandler")
model_FromParts = Class(name="model_FromParts")
model_Catch = Class(name="model_Catch")
model_CatchAll = Class(name="model_CatchAll")
model_Targets = Class(name="model_Targets")
model_Sources = Class(name="model_Sources")
model_CorrelationSet = Class(name="model_CorrelationSet")
Property_ = Class(name="Property")
Activity = Class(name="Activity")
model_MessageExchange = Class(name="model_MessageExchange")
model_PartnerActivity = Class(name="model_PartnerActivity")
model_Correlations = Class(name="model_Correlations")
model_ToParts = Class(name="model_ToParts")
model_Link = Class(name="model_Link")
model_Source = Class(name="model_Source")
model_Target = Class(name="model_Target")
Message = Class(name="Message")
XSDElementDeclaration = Class(name="XSDElementDeclaration")
model_Reply = Class(name="model_Reply")
model_Wait = Class(name="model_Wait")
model_Expression = Class(name="model_Expression")
model_Empty = Class(name="model_Empty")
model_Sequence = Class(name="model_Sequence")
PortType = Class(name="PortType")
Operation = Class(name="Operation")
model_Receive = Class(name="model_Receive")
model_Exit = Class(name="model_Exit")
model_Throw = Class(name="model_Throw")
model_Links = Class(name="model_Links")
model_CompletionCondition = Class(name="model_CompletionCondition")
model_While = Class(name="model_While")
model_Condition = Class(name="model_Condition")
model_Pick = Class(name="model_Pick")
model_OnMessage = Class(name="model_OnMessage")
model_OnAlarm = Class(name="model_OnAlarm")
model_Flow = Class(name="model_Flow")
model_Scope = Class(name="model_Scope")
model_Assign = Class(name="model_Assign")
model_Copy = Class(name="model_Copy")
model_To = Class(name="model_To")
model_From = Class(name="model_From")
model_Extension = Class(name="model_Extension")
Part = Class(name="Part")
model_Query = Class(name="model_Query")
AbstractAssignBound = Class(name="AbstractAssignBound")
model_TerminationHandler = Class(name="model_TerminationHandler")
model_CompensateScope = Class(name="model_CompensateScope")
model_AbstractAssignBound = Class(name="model_AbstractAssignBound", is_abstract=True)
XSDTypeDefinition = Class(name="XSDTypeDefinition")
model_ServiceRef = Class(name="model_ServiceRef")
ExtensibilityElement = Class(name="ExtensibilityElement")
model_OnEvent = Class(name="model_OnEvent")
model_BooleanExpression = Class(name="model_BooleanExpression")
Expression = Class(name="Expression")
model_Correlation = Class(name="model_Correlation")
model_UnknownExtensibilityAttribute = Class(name="model_UnknownExtensibilityAttribute")
UnknownExtensibilityElement = Class(name="UnknownExtensibilityElement")
model_Rethrow = Class(name="model_Rethrow")
ExtensibleElement = Class(name="ExtensibleElement")
WSDLElement = Class(name="WSDLElement")
model_OpaqueActivity = Class(name="model_OpaqueActivity")
model_ExtensionActivity = Class(name="model_ExtensionActivity")
model_FromPart = Class(name="model_FromPart")
model_ToPart = Class(name="model_ToPart")
model_RepeatUntil = Class(name="model_RepeatUntil")
model_ForEach = Class(name="model_ForEach")
model_ElseIf = Class(name="model_ElseIf")
model_Else = Class(name="model_Else")
model_Validate = Class(name="model_Validate")
model_If = Class(name="model_If")
model_Branches = Class(name="model_Branches")
model_wsdl_WSDLElement = Class(name="model_wsdl_WSDLElement", is_abstract=True)
model_BPELExtensibleElement = Class(name="model_BPELExtensibleElement")
model_Documentation = Class(name="model_Documentation")
model_Compensate = Class(name="model_Compensate")
model_wsdl_Operation = Class(name="model_wsdl_Operation")
wsdl_IOperation = Class(name="wsdl_IOperation")
model_wsdl_PortType = Class(name="model_wsdl_PortType")
wsdl_ExtensibleElement = Class(name="wsdl_ExtensibleElement")
wsdl_IPortType = Class(name="wsdl_IPortType")
model_wsdl_Part = Class(name="model_wsdl_Part")
wsdl_IPart = Class(name="wsdl_IPart")
Input = Class(name="Input")
Output = Class(name="Output")
Fault = Class(name="Fault")
model_wsdl_Message = Class(name="model_wsdl_Message")
wsdl_IMessage = Class(name="wsdl_IMessage")
BindingOperation = Class(name="BindingOperation")
model_wsdl_BindingOperation = Class(name="model_wsdl_BindingOperation")
wsdl_IBindingOperation = Class(name="wsdl_IBindingOperation")
BindingInput = Class(name="BindingInput")
BindingOutput = Class(name="BindingOutput")
model_wsdl_Binding = Class(name="model_wsdl_Binding")
wsdl_IBinding = Class(name="wsdl_IBinding")
BindingFault = Class(name="BindingFault")
Port = Class(name="Port")
model_wsdl_Port = Class(name="model_wsdl_Port")
wsdl_IPort = Class(name="wsdl_IPort")
Binding = Class(name="Binding")
model_wsdl_ExtensibilityElement = Class(name="model_wsdl_ExtensibilityElement")
wsdl_WSDLElement = Class(name="wsdl_WSDLElement")
wsdl_IExtensibilityElement = Class(name="wsdl_IExtensibilityElement")
model_wsdl_Definition = Class(name="model_wsdl_Definition")
wsdl_IDefinition = Class(name="wsdl_IDefinition")
model_wsdl_Service = Class(name="model_wsdl_Service")
wsdl_IService = Class(name="wsdl_IService")
Service = Class(name="Service")
Namespace = Class(name="Namespace")
model_wsdl_Import = Class(name="model_wsdl_Import")
wsdl_IImport = Class(name="wsdl_IImport")
Import = Class(name="Import")
Types = Class(name="Types")
model_wsdl_ExtensibleElement = Class(name="model_wsdl_ExtensibleElement", is_abstract=True)
wsdl_IElementExtensible = Class(name="wsdl_IElementExtensible")
wsdl_IAttributeExtensible = Class(name="wsdl_IAttributeExtensible")
model_wsdl_Input = Class(name="model_wsdl_Input")
wsdl_MessageReference = Class(name="wsdl_MessageReference")
wsdl_IInput = Class(name="wsdl_IInput")
model_wsdl_Output = Class(name="model_wsdl_Output")
wsdl_IOutput = Class(name="wsdl_IOutput")
model_wsdl_Fault = Class(name="model_wsdl_Fault")
wsdl_IFault = Class(name="wsdl_IFault")
Definition = Class(name="Definition")
XSDSchema = Class(name="XSDSchema")
model_wsdl_BindingOutput = Class(name="model_wsdl_BindingOutput")
wsdl_IBindingOutput = Class(name="wsdl_IBindingOutput")
model_wsdl_BindingFault = Class(name="model_wsdl_BindingFault")
wsdl_IBindingFault = Class(name="wsdl_IBindingFault")
model_wsdl_BindingInput = Class(name="model_wsdl_BindingInput")
wsdl_IBindingInput = Class(name="wsdl_IBindingInput")
model_wsdl_Namespace = Class(name="model_wsdl_Namespace")
model_wsdl_IPortType = Class(name="model_wsdl_IPortType", is_abstract=True)
IAttributeExtensible = Class(name="IAttributeExtensible")
IElementExtensible = Class(name="IElementExtensible")
model_wsdl_IInput = Class(name="model_wsdl_IInput", is_abstract=True)
model_wsdl_IOperation = Class(name="model_wsdl_IOperation", is_abstract=True)
model_wsdl_IFault = Class(name="model_wsdl_IFault", is_abstract=True)
model_wsdl_IMessage = Class(name="model_wsdl_IMessage", is_abstract=True)
model_wsdl_IPart = Class(name="model_wsdl_IPart", is_abstract=True)
model_wsdl_IOutput = Class(name="model_wsdl_IOutput", is_abstract=True)
model_wsdl_IPort = Class(name="model_wsdl_IPort", is_abstract=True)
model_wsdl_IBinding = Class(name="model_wsdl_IBinding", is_abstract=True)
model_wsdl_IService = Class(name="model_wsdl_IService", is_abstract=True)
model_wsdl_IBindingInput = Class(name="model_wsdl_IBindingInput", is_abstract=True)
model_wsdl_IBindingOutput = Class(name="model_wsdl_IBindingOutput", is_abstract=True)
model_wsdl_IBindingFault = Class(name="model_wsdl_IBindingFault", is_abstract=True)
model_wsdl_IBindingOperation = Class(name="model_wsdl_IBindingOperation", is_abstract=True)
model_wsdl_IDefinition = Class(name="model_wsdl_IDefinition", is_abstract=True)
model_wsdl_IExtensibilityElement = Class(name="model_wsdl_IExtensibilityElement", is_abstract=True)
model_wsdl_IImport = Class(name="model_wsdl_IImport", is_abstract=True)
model_wsdl_IList = Class(name="model_wsdl_IList", is_abstract=True)
model_wsdl_IMap = Class(name="model_wsdl_IMap", is_abstract=True)
model_wsdl_IURL = Class(name="model_wsdl_IURL", is_abstract=True)
model_wsdl_IIterator = Class(name="model_wsdl_IIterator", is_abstract=True)
model_wsdl_ITypes = Class(name="model_wsdl_ITypes", is_abstract=True)
model_wsdl_UnknownExtensibilityElement = Class(name="model_wsdl_UnknownExtensibilityElement")
model_wsdl_XSDSchemaExtensibilityElement = Class(name="model_wsdl_XSDSchemaExtensibilityElement")
wsdl_ExtensibilityElement = Class(name="wsdl_ExtensibilityElement")
wsdl_ISchema = Class(name="wsdl_ISchema")
model_wsdl_IExtensionRegistry = Class(name="model_wsdl_IExtensionRegistry", is_abstract=True)
model_wsdl_Types = Class(name="model_wsdl_Types")
wsdl_ITypes = Class(name="wsdl_ITypes")
model_wsdl_IElementExtensible = Class(name="model_wsdl_IElementExtensible", is_abstract=True)
model_wsdl_IAttributeExtensible = Class(name="model_wsdl_IAttributeExtensible", is_abstract=True)
model_wsdl_IObject = Class(name="model_wsdl_IObject", is_abstract=True)
model_wsdl_ISchema = Class(name="model_wsdl_ISchema", is_abstract=True)
IExtensibilityElement = Class(name="IExtensibilityElement")
model_xsd_XSDAnnotation = Class(name="model_xsd_XSDAnnotation")
xsd_XSDComponent = Class(name="xsd_XSDComponent")
xsd_XSDRedefineContent = Class(name="xsd_XSDRedefineContent")
model_wsdl_MessageReference = Class(name="model_wsdl_MessageReference", is_abstract=True)
model_xsd_XSDAttributeDeclaration = Class(name="model_xsd_XSDAttributeDeclaration")
xsd_XSDFeature = Class(name="xsd_XSDFeature")
xsd_XSDSchemaContent = Class(name="xsd_XSDSchemaContent")
...
model_xsd_XSDAttributeGroupContent = Class(name="model_xsd_XSDAttributeGroupContent", is_abstract=True)
XSDConcreteComponent = Class(name="XSDConcreteComponent")
xsd_XSDAttributeGroupContent = Class(name="xsd_XSDAttributeGroupContent")
...
model_xsd_XSDAttributeGroupDefinition = Class(name="model_xsd_XSDAttributeGroupDefinition")
xsd_XSDRedefinableComponent = Class(name="xsd_XSDRedefinableComponent")
model_xsd_XSDAttributeUse = Class(name="model_xsd_XSDAttributeUse")
model_xsd_XSDBoundedFacet = Class(name="model_xsd_XSDBoundedFacet")
XSDFundamentalFacet = Class(name="XSDFundamentalFacet")
model_xsd_XSDCardinalityFacet = Class(name="model_xsd_XSDCardinalityFacet")
model_xsd_XSDComplexTypeContent = Class(name="model_xsd_XSDComplexTypeContent", is_abstract=True)
XSDComponent = Class(name="XSDComponent")
XSDComplexTypeContent = Class(name="XSDComplexTypeContent")
model_xsd_XSDComplexTypeDefinition = Class(name="model_xsd_XSDComplexTypeDefinition")
xsd_XSDTypeDefinition = Class(name="xsd_XSDTypeDefinition")
xsd_XSDScope = Class(name="xsd_XSDScope")
XSDParticle = Class(name="XSDParticle")
model_xsd_XSDComponent = Class(name="model_xsd_XSDComponent", is_abstract=True)
model_xsd_XSDConcreteComponent = Class(name="model_xsd_XSDConcreteComponent", is_abstract=True)
XSDDiagnostic = Class(name="XSDDiagnostic")
model_xsd_XSDConstrainingFacet = Class(name="model_xsd_XSDConstrainingFacet", is_abstract=True)
XSDFacet = Class(name="XSDFacet")
model_xsd_XSDDiagnostic = Class(name="model_xsd_XSDDiagnostic")
model_xsd_XSDElementDeclaration = Class(name="model_xsd_XSDElementDeclaration")
xsd_XSDTerm = Class(name="xsd_XSDTerm")
model_xsd_XSDEnumerationFacet = Class(name="model_xsd_XSDEnumerationFacet")
XSDRepeatableFacet = Class(name="XSDRepeatableFacet")
model_xsd_XSDFacet = Class(name="model_xsd_XSDFacet", is_abstract=True)
...
model_xsd_XSDFixedFacet = Class(name="model_xsd_XSDFixedFacet", is_abstract=True)
XSDConstrainingFacet = Class(name="XSDConstrainingFacet")
model_xsd_XSDFractionDigitsFacet = Class(name="model_xsd_XSDFractionDigitsFacet")
XSDFixedFacet = Class(name="XSDFixedFacet")
model_xsd_XSDFundamentalFacet = Class(name="model_xsd_XSDFundamentalFacet", is_abstract=True)
model_xsd_XSDFeature = Class(name="model_xsd_XSDFeature", is_abstract=True)
XSDNamedComponent = Class(name="XSDNamedComponent")
XSDXPathDefinition = Class(name="XSDXPathDefinition")
model_xsd_XSDImport = Class(name="model_xsd_XSDImport")
XSDSchemaDirective = Class(name="XSDSchemaDirective")
model_xsd_XSDInclude = Class(name="model_xsd_XSDInclude")
XSDSchemaCompositor = Class(name="XSDSchemaCompositor")
model_xsd_XSDLengthFacet = Class(name="model_xsd_XSDLengthFacet")
model_xsd_XSDMaxExclusiveFacet = Class(name="model_xsd_XSDMaxExclusiveFacet")
XSDMaxFacet = Class(name="XSDMaxFacet")
model_xsd_XSDMaxFacet = Class(name="model_xsd_XSDMaxFacet", is_abstract=True)
model_xsd_XSDMaxInclusiveFacet = Class(name="model_xsd_XSDMaxInclusiveFacet")
model_xsd_XSDMaxLengthFacet = Class(name="model_xsd_XSDMaxLengthFacet")
model_xsd_XSDIdentityConstraintDefinition = Class(name="model_xsd_XSDIdentityConstraintDefinition")
model_xsd_XSDMinInclusiveFacet = Class(name="model_xsd_XSDMinInclusiveFacet")
model_xsd_XSDMinLengthFacet = Class(name="model_xsd_XSDMinLengthFacet")
model_xsd_XSDModelGroup = Class(name="model_xsd_XSDModelGroup")
XSDTerm = Class(name="XSDTerm")
model_xsd_XSDModelGroupDefinition = Class(name="model_xsd_XSDModelGroupDefinition")
xsd_XSDParticleContent = Class(name="xsd_XSDParticleContent")
XSDModelGroup = Class(name="XSDModelGroup")
XSDModelGroupDefinition = Class(name="XSDModelGroupDefinition")
model_xsd_XSDMinExclusiveFacet = Class(name="model_xsd_XSDMinExclusiveFacet")
XSDMinFacet = Class(name="XSDMinFacet")
model_xsd_XSDMinFacet = Class(name="model_xsd_XSDMinFacet", is_abstract=True)
model_xsd_XSDNotationDeclaration = Class(name="model_xsd_XSDNotationDeclaration")
xsd_XSDNamedComponent = Class(name="xsd_XSDNamedComponent")
model_xsd_XSDNumericFacet = Class(name="model_xsd_XSDNumericFacet")
model_xsd_XSDOrderedFacet = Class(name="model_xsd_XSDOrderedFacet")
model_xsd_XSDParticle = Class(name="model_xsd_XSDParticle")
XSDParticleContent = Class(name="XSDParticleContent")
model_xsd_XSDParticleContent = Class(name="model_xsd_XSDParticleContent", is_abstract=True)
model_xsd_XSDPatternFacet = Class(name="model_xsd_XSDPatternFacet")
model_xsd_XSDRedefinableComponent = Class(name="model_xsd_XSDRedefinableComponent", is_abstract=True)
model_xsd_XSDNamedComponent = Class(name="model_xsd_XSDNamedComponent", is_abstract=True)
XSDRedefineContent = Class(name="XSDRedefineContent")
model_xsd_XSDRepeatableFacet = Class(name="model_xsd_XSDRepeatableFacet", is_abstract=True)
model_xsd_XSDSchema = Class(name="model_xsd_XSDSchema")
model_xsd_XSDRedefineContent = Class(name="model_xsd_XSDRedefineContent", is_abstract=True)
XSDSchemaContent = Class(name="XSDSchemaContent")
model_xsd_XSDRedefine = Class(name="model_xsd_XSDRedefine")
model_xsd_XSDSchemaCompositor = Class(name="model_xsd_XSDSchemaCompositor", is_abstract=True)
model_xsd_XSDSchemaContent = Class(name="model_xsd_XSDSchemaContent", is_abstract=True)
model_xsd_XSDSchemaDirective = Class(name="model_xsd_XSDSchemaDirective", is_abstract=True)
model_xsd_XSDScope = Class(name="model_xsd_XSDScope", is_abstract=True)
XSDNotationDeclaration = Class(name="XSDNotationDeclaration")
XSDMaxInclusiveFacet = Class(name="XSDMaxInclusiveFacet")
model_xsd_XSDSimpleTypeDefinition = Class(name="model_xsd_XSDSimpleTypeDefinition")
xsd_XSDComplexTypeContent = Class(name="xsd_XSDComplexTypeContent")
...
model_xsd_XSDTerm = Class(name="model_xsd_XSDTerm", is_abstract=True)
model_xsd_XSDTotalDigitsFacet = Class(name="model_xsd_XSDTotalDigitsFacet")
model_xsd_XSDTypeDefinition = Class(name="model_xsd_XSDTypeDefinition", is_abstract=True)
model_xsd_XSDWhiteSpaceFacet = Class(name="model_xsd_XSDWhiteSpaceFacet")
model_xsd_XSDWildcard = Class(name="model_xsd_XSDWildcard")
model_xsd_XSDXPathDefinition = Class(name="model_xsd_XSDXPathDefinition")
model_messageproperties_Property = Class(name="model_messageproperties_Property")
Query = Class(name="Query")
model_messageproperties_Query = Class(name="model_messageproperties_Query")
model_messageproperties_PropertyAlias = Class(name="model_messageproperties_PropertyAlias")
model_partnerlinktype_PartnerLinkType = Class(name="model_partnerlinktype_PartnerLinkType")
model_partnerlinktype_Role = Class(name="model_partnerlinktype_Role")
...
model_Process.attributes={model_Process_variableAccessSerializable, model_Process_targetNamespace, model_Process_name, model_Process_exitOnStandardFault, model_Process_abstractProcessProfile, model_Process_queryLanguage, model_Process_expressionLanguage, model_Process_suppressJoinFailure}
...
model_Activity.attributes={model_Activity_suppressJoinFailure, model_Activity_name}
...
model_Expression.attributes={model_Expression_body, model_Expression_expressionLanguage, model_Expression_opaque}
...
model_Copy.attributes={model_Copy_ignoreMissingFromData, model_Copy_keepSrcElementName}
...
model_From.attributes={model_From_literal, model_From_unsafeLiteral, model_From_opaque, model_From_endpointReference}
...
model_Extension.attributes={model_Extension_mustUnderstand, model_Extension_namespace}
...
model_ServiceRef.attributes={model_ServiceRef_referenceScheme, model_ServiceRef_value}
...
model_wsdl_WSDLElement_m_setEnclosingDefinition: Method = Method(name="setEnclosingDefinition", parameters={Parameter(name='model_definition', type=StringType)})
...
model_Documentation.attributes={model_Documentation_source, model_Documentation_lang, model_Documentation_value}
...
model_wsdl_Operation.attributes={model_wsdl_Operation_undefined, model_wsdl_Operation_name, model_wsdl_Operation_style}
...
model_wsdl_Part.attributes={model_wsdl_Part_name, model_wsdl_Part_typeName, model_wsdl_Part_elementName}
...
model_wsdl_Binding.attributes={model_wsdl_Binding_qName, model_wsdl_Binding_undefined}
...
model_wsdl_Definition_m_setDocument: Method = Method(name="setDocument", parameters={Parameter(name='model_document', type=StringType)})
model_wsdl_Definition.attributes={model_wsdl_Definition_qName, model_wsdl_Definition_targetNamespace, model_wsdl_Definition_location, model_wsdl_Definition_encoding}
model_wsdl_Definition.methods={model_wsdl_Definition_m_getDocument, model_wsdl_Definition_m_setDocument}
...
model_wsdl_Import_m_setSchema: Method = Method(name="setSchema", parameters={Parameter(name='model_schema', type=StringType)})
model_wsdl_Import.attributes={model_wsdl_Import_locationURI, model_wsdl_Import_namespaceURI}
model_wsdl_Import.methods={model_wsdl_Import_m_getSchema, model_wsdl_Import_m_setSchema}
...
model_wsdl_BindingOutput_m_setOutput: Method = Method(name="setOutput", parameters={Parameter(name='model_output', type=StringType)})
...
model_wsdl_BindingFault_m_setFault: Method = Method(name="setFault", parameters={Parameter(name='model_fault', type=StringType)})
model_wsdl_BindingFault.attributes={model_wsdl_BindingFault_name}
model_wsdl_BindingFault.methods={model_wsdl_BindingFault_m_getFault, model_wsdl_BindingFault_m_setFault}
...
model_wsdl_BindingInput_m_setInput: Method = Method(name="setInput", parameters={Parameter(name='model_input', type=StringType)})
model_wsdl_BindingInput.attributes={model_wsdl_BindingInput_name}
model_wsdl_BindingInput.methods={model_wsdl_BindingInput_m_getInput, model_wsdl_BindingInput_m_setInput}
...
model_wsdl_IPortType_m_addOperation: Method = Method(name="addOperation", parameters={Parameter(name='model_operation', type=StringType)})
model_wsdl_IPortType_m_getOperation: Method = Method(name="getOperation", parameters={Parameter(name='model_name', type=StringType), Parameter(name='model_outputName', type=StringType), Parameter(name='model_inputName', type=StringType)}, type=StringType)
model_wsdl_IPortType_m_getOperations: Method = Method(name="getOperations", parameters={}, type=StringType)
model_wsdl_IPortType.methods={model_wsdl_IPortType_m_getOperations, model_wsdl_IPortType_m_getOperation, model_wsdl_IPortType_m_addOperation}
...
model_wsdl_IInput_m_setMessage: Method = Method(name="setMessage", parameters={Parameter(name='model_message', type=StringType)})
...
model_wsdl_IOperation_m_addFault: Method = Method(name="addFault", parameters={Parameter(name='model_fault', type=StringType)})
model_wsdl_IOperation_m_getFault: Method = Method(name="getFault", parameters={Parameter(name='model_name', type=StringType)}, type=StringType)
...
model_wsdl_IOperation_m_setParameterOrdering: Method = Method(name="setParameterOrdering", parameters={Parameter(name='model_parameterOrder', type=StringType)})
model_wsdl_IOperation_m_getInput: Method = Method(name="getInput", parameters={}, type=StringType)
model_wsdl_IOperation_m_setInput: Method = Method(name="setInput", parameters={Parameter(name='model_input', type=StringType)})
model_wsdl_IOperation_m_getOutput: Method = Method(name="getOutput", parameters={}, type=StringType)
model_wsdl_IOperation_m_setOutput: Method = Method(name="setOutput", parameters={Parameter(name='model_output', type=StringType)})
model_wsdl_IOperation.methods={model_wsdl_IOperation_m_setParameterOrdering, model_wsdl_IOperation_m_getOutput, model_wsdl_IOperation_m_setInput, model_wsdl_IOperation_m_addFault, model_wsdl_IOperation_m_getInput, model_wsdl_IOperation_m_setOutput, model_wsdl_IOperation_m_getFaults, model_wsdl_IOperation_m_getFault, model_wsdl_IOperation_m_getParameterOrdering}
...
model_wsdl_IFault_m_setMessage: Method = Method(name="setMessage", parameters={Parameter(name='model_message', type=StringType)})
...
model_wsdl_IMessage_m_addPart: Method = Method(name="addPart", parameters={Parameter(name='model_part', type=StringType)})
model_wsdl_IMessage_m_getPart: Method = Method(name="getPart", parameters={Parameter(name='model_name', type=StringType)}, type=StringType)
model_wsdl_IMessage_m_getParts: Method = Method(name="getParts", parameters={}, type=StringType)
model_wsdl_IMessage_m_getOrderedParts: Method = Method(name="getOrderedParts", parameters={Parameter(name='model_partOrder', type=StringType)}, type=StringType)
model_wsdl_IMessage.methods={model_wsdl_IMessage_m_getOrderedParts, model_wsdl_IMessage_m_addPart, model_wsdl_IMessage_m_getParts, model_wsdl_IMessage_m_getPart}

# model_wsdl_IPart class attributes and methods

# model_wsdl_IOutput class attributes and methods
model_wsdl_IOutput_m_setMessage: Method = Method(name="setMessage", parameters={Parameter(name='model_message', type=StringType)})
model_wsdl_IOutput_m_getMessage: Method = Method(name="getMessage", parameters={}, type=StringType)
model_wsdl_IOutput.methods={model_wsdl_IOutput_m_getMessage, model_wsdl_IOutput_m_setMessage}
...
model_wsdl_IPort_m_setBinding: Method = Method(name="setBinding", parameters={Parameter(name='model_binding', type=StringType)})
...
model_wsdl_IBinding_m_addBindingOperation: Method = Method(name="addBindingOperation", parameters={Parameter(name='model_bindingOperation', type=StringType)})
model_wsdl_IBinding_m_getBindingOperation: Method = Method(name="getBindingOperation", parameters={Parameter(name='model_name', type=StringType), Parameter(name='model_outputName', type=StringType), Parameter(name='model_inputName', type=StringType)}, type=StringType)
...
model_wsdl_IBinding_m_setPortType: Method = Method(name="setPortType", parameters={Parameter(name='model_portType', type=StringType)})
model_wsdl_IBinding.methods={model_wsdl_IBinding_m_setPortType, model_wsdl_IBinding_m_getPortType, model_wsdl_IBinding_m_addBindingOperation, model_wsdl_IBinding_m_getBindingOperations, model_wsdl_IBinding_m_getBindingOperation}
...
model_wsdl_IService_m_getPort: Method = Method(name="getPort", parameters={Parameter(name='model_name', type=StringType)}, type=StringType)
model_wsdl_IService_m_addPort: Method = Method(name="addPort", parameters={Parameter(name='model_port', type=StringType)})
model_wsdl_IService.methods={model_wsdl_IService_m_getPorts, model_wsdl_IService_m_getPort, model_wsdl_IService_m_addPort}
...
model_wsdl_IBindingOperation_m_getBindingFault: Method = Method(name="getBindingFault", parameters={Parameter(name='model_name', type=StringType)}, type=StringType)
...
model_wsdl_IBindingOperation_m_setOperation: Method = Method(name="setOperation", parameters={Parameter(name='model_operation', type=StringType)})
model_wsdl_IBindingOperation_m_getBindingInput: Method = Method(name="getBindingInput", parameters={}, type=StringType)
model_wsdl_IBindingOperation_m_setBindingInput: Method = Method(name="setBindingInput", parameters={Parameter(name='model_bindingInput', type=StringType)})
model_wsdl_IBindingOperation_m_getBindingOutput: Method = Method(name="getBindingOutput", parameters={}, type=StringType)
model_wsdl_IBindingOperation_m_setBindingOutput: Method = Method(name="setBindingOutput", parameters={Parameter(name='model_bindingOutput', type=StringType)})
model_wsdl_IBindingOperation_m_addBindingFault: Method = Method(name="addBindingFault", parameters={Parameter(name='model_bindingFault', type=StringType)})
model_wsdl_IBindingOperation.methods={model_wsdl_IBindingOperation_m_getOperation, model_wsdl_IBindingOperation_m_getBindingFault, model_wsdl_IBindingOperation_m_addBindingFault, model_wsdl_IBindingOperation_m_getBindingFaults, model_wsdl_IBindingOperation_m_getBindingInput, model_wsdl_IBindingOperation_m_setBindingInput, model_wsdl_IBindingOperation_m_setBindingOutput, model_wsdl_IBindingOperation_m_getBindingOutput, model_wsdl_IBindingOperation_m_setOperation}

# model_wsdl_IDefinition class attributes and methods
model_wsdl_IDefinition_m_addBinding: Method = Method(name="addBinding", parameters={Parameter(name='model_binding', type=StringType)})
model_wsdl_IDefinition_m_addImport: Method = Method(name="addImport", parameters={Parameter(name='model_importDef', type=StringType)})
model_wsdl_IDefinition_m_addMessage: Method = Method(name="addMessage", parameters={Parameter(name='model_message', type=StringType)})
model_wsdl_IDefinition_m_addNamespace: Method = Method(name="addNamespace", parameters={Parameter(name='model_prefix', type=StringType), Parameter(name='model_namespaceURI', type=StringType)})
model_wsdl_IDefinition_m_addPortType: Method = Method(name="addPortType", parameters={Parameter(name='model_portType', type=StringType)})
model_wsdl_IDefinition_m_addService: Method = Method(name="addService", parameters={Parameter(name='model_service', type=StringType)})
...
model_wsdl_IDefinition_m_getBinding: Method = Method(name="getBinding", parameters={Parameter(name='model_name', type=StringType)}, type=StringType)
...
model_wsdl_IDefinition_m_getImports: Method = Method(name="getImports", parameters={Parameter(name='model_namespaceURI', type=StringType)}, type=StringType)
model_wsdl_IDefinition_m_getMessage: Method = Method(name="getMessage", parameters={Parameter(name='model_name', type=StringType)}, type=StringType)
model_wsdl_IDefinition_m_getMessages: Method = Method(name="getMessages", parameters={}, type=StringType)
model_wsdl_IDefinition_m_getNamespace: Method = Method(name="getNamespace", parameters={Parameter(name='model_prefix', type=StringType)}, type=StringType)
model_wsdl_IDefinition_m_getNamespaces: Method = Method(name="getNamespaces", parameters={}, type=StringType)
model_wsdl_IDefinition_m_getPortType: Method = Method(name="getPortType", parameters={Parameter(name='model_name', type=StringType)}, type=StringType)
model_wsdl_IDefinition_m_getPortTypes: Method = Method(name="getPortTypes", parameters={}, type=StringType)
model_wsdl_IDefinition_m_getPrefix: Method = Method(name="getPrefix", parameters={Parameter(name='model_namespaceURI', type=StringType)}, type=StringType)
model_wsdl_IDefinition_m_getService: Method = Method(name="getService", parameters={Parameter(name='model_name', type=StringType)}, type=StringType)
...
model_wsdl_IDefinition_m_setExtensionRegistry: Method = Method(name="setExtensionRegistry", parameters={Parameter(name='model_extensionRegistry', type=StringType)})
...
model_wsdl_IDefinition_m_removeService: Method = Method(name="removeService", parameters={Parameter(name='model_name', type=StringType)}, type=StringType)
model_wsdl_IDefinition_m_removeBinding: Method = Method(name="removeBinding", parameters={Parameter(name='model_name', type=StringType)}, type=StringType)
model_wsdl_IDefinition_m_removePortType: Method = Method(name="removePortType", parameters={Parameter(name='model_name', type=StringType)}, type=StringType)
model_wsdl_IDefinition_m_removeMessage: Method = Method(name="removeMessage", parameters={Parameter(name='model_name', type=StringType)}, type=StringType)
model_wsdl_IDefinition_m_getTypes: Method = Method(name="getTypes", parameters={}, type=StringType)
model_wsdl_IDefinition_m_setTypes: Method = Method(name="setTypes", parameters={Parameter(name='model_types', type=StringType)})
model_wsdl_IDefinition_m_getDocumentBaseURI: Method = Method(name="getDocumentBaseURI", parameters={}, type=StringType)
model_wsdl_IDefinition_m_setDocumentBaseURI: Method = Method(name="setDocumentBaseURI", parameters={Parameter(name='model_documentBase', type=StringType)})
model_wsdl_IDefinition.methods={model_wsdl_IDefinition_m_getService, model_wsdl_IDefinition_m_addMessage, model_wsdl_IDefinition_m_createPortType, model_wsdl_IDefinition_m_getServices, model_wsdl_IDefinition_m_getBindings, model_wsdl_IDefinition_m_getPortTypes, model_wsdl_IDefinition_m_getImports, model_wsdl_IDefinition_m_addPortType, model_wsdl_IDefinition_m_setTypes, model_wsdl_IDefinition_m_getImports, model_wsdl_IDefinition_m_createTypes, model_wsdl_IDefinition_m_createBindingFault, model_wsdl_IDefinition_m_addBinding, model_wsdl_IDefinition_m_createPort, model_wsdl_IDefinition_m_createInput, model_wsdl_IDefinition_m_createBinding, model_wsdl_IDefinition_m_getDocumentBaseURI, model_wsdl_IDefinition_m_createPart, model_wsdl_IDefinition_m_createService, model_wsdl_IDefinition_m_removeService, model_wsdl_IDefinition_m_removeBinding, model_wsdl_IDefinition_m_getPortType, model_wsdl_IDefinition_m_removePortType, model_wsdl_IDefinition_m_getTypes, model_wsdl_IDefinition_m_getMessages, model_wsdl_IDefinition_m_getBinding, model_wsdl_IDefinition_m_createBindingOutput, model_wsdl_IDefinition_m_getMessage, model_wsdl_IDefinition_m_addImport, model_wsdl_IDefinition_m_createOperation, model_wsdl_IDefinition_m_setExtensionRegistry, model_wsdl_IDefinition_m_addNamespace, model_wsdl_IDefinition_m_getPrefix, model_wsdl_IDefinition_m_getExtensionRegistry, model_wsdl_IDefinition_m_createImport, model_wsdl_IDefinition_m_createBindingInput, model_wsdl_IDefinition_m_createFault, model_wsdl_IDefinition_m_addService, model_wsdl_IDefinition_m_createOutput, model_wsdl_IDefinition_m_setDocumentBaseURI, model_wsdl_IDefinition_m_createMessage, model_wsdl_IDefinition_m_getNamespace, model_wsdl_IDefinition_m_createBindingOperation, model_wsdl_IDefinition_m_getNamespaces, model_wsdl_IDefinition_m_removeMessage}
...
model_wsdl_Types_m_getSchemas: Method = Method(name="getSchemas", parameters={Parameter(name='model_namespaceURI', type=StringType)}, type=StringType)
...
model_wsdl_IElementExtensible_m_addExtensibilityElement: Method = Method(name="addExtensibilityElement", parameters={Parameter(name='model_extElement', type=StringType)})
...
model_wsdl_IAttributeExtensible_m_getExtensionAttribute: Method = Method(name="getExtensionAttribute", parameters={Parameter(name='model_name', type=StringType)}, type=StringType)
model_wsdl_IAttributeExtensible_m_setExtensionAttribute: Method = Method(name="setExtensionAttribute", parameters={Parameter(name='model_name', type=StringType), Parameter(name='model_value', type=StringType)})
...
model_wsdl_IAttributeExtensible.methods={model_wsdl_IAttributeExtensible_m_setExtensionAttribute, model_wsdl_IAttributeExtensible_m_getExtensionAttributes, model_wsdl_IAttributeExtensible_m_getExtensionAttribute, model_wsdl_IAttributeExtensible_m_getNativeAttributeNames}
...
model_xsd_XSDAnnotation.attributes={model_xsd_XSDAnnotation_attributes, model_xsd_XSDAnnotation_applicationInformation, model_xsd_XSDAnnotation_userInformation}
...
model_xsd_XSDAttributeUse.attributes={model_xsd_XSDAttributeUse_constraint, model_xsd_XSDAttributeUse_required, model_xsd_XSDAttributeUse_value, model_xsd_XSDAttributeUse_lexicalValue, model_xsd_XSDAttributeUse_use}
...
model_xsd_XSDComplexTypeDefinition.attributes={model_xsd_XSDComplexTypeDefinition_lexicalFinal, model_xsd_XSDComplexTypeDefinition_block, model_xsd_XSDComplexTypeDefinition_final, model_xsd_XSDComplexTypeDefinition_mixed, model_xsd_XSDComplexTypeDefinition_derivationMethod, model_xsd_XSDComplexTypeDefinition_abstract, model_xsd_XSDComplexTypeDefinition_contentTypeCategory, model_xsd_XSDComplexTypeDefinition_prohibitedSubstitutions}
...
model_xsd_XSDDiagnostic.attributes={model_xsd_XSDDiagnostic_line, model_xsd_XSDDiagnostic_message, model_xsd_XSDDiagnostic_column, model_xsd_XSDDiagnostic_locationURI, model_xsd_XSDDiagnostic_severity, model_xsd_XSDDiagnostic_key, model_xsd_XSDDiagnostic_annotationURI, model_xsd_XSDDiagnostic_substitutions, model_xsd_XSDDiagnostic_node}
...
model_xsd_XSDElementDeclaration.attributes={model_xsd_XSDElementDeclaration_substitutionGroupExclusions, model_xsd_XSDElementDeclaration_disallowedSubstitutions, model_xsd_XSDElementDeclaration_abstract, model_xsd_XSDElementDeclaration_block, model_xsd_XSDElementDeclaration_elementDeclarationReference, model_xsd_XSDElementDeclaration_lexicalFinal, model_xsd_XSDElementDeclaration_circular, model_xsd_XSDElementDeclaration_nillable}
...
model_xsd_XSDFacet.attributes={model_xsd_XSDFacet_effectiveValue, model_xsd_XSDFacet_facetName, model_xsd_XSDFacet_lexicalValue}
...
model_xsd_XSDFeature_global_: Property = Property(name="global_", type=BooleanType)
model_xsd_XSDFeature_featureReference: Property = Property(name="featureReference", type=BooleanType)
model_xsd_XSDFeature.attributes={model_xsd_XSDFeature_value, model_xsd_XSDFeature_form, model_xsd_XSDFeature_global_, model_xsd_XSDFeature_constraint, model_xsd_XSDFeature_featureReference, model_xsd_XSDFeature_lexicalValue}
...
model_xsd_XSDMaxFacet.attributes={model_xsd_XSDMaxFacet_value, model_xsd_XSDMaxFacet_exclusive, model_xsd_XSDMaxFacet_inclusive}
...
model_xsd_XSDParticle.attributes={model_xsd_XSDParticle_minOccurs, model_xsd_XSDParticle_maxOccurs}
...
model_xsd_XSDNamedComponent.attributes={model_xsd_XSDNamedComponent_name, model_xsd_XSDNamedComponent_qName, model_xsd_XSDNamedComponent_uRI, model_xsd_XSDNamedComponent_aliasURI, model_xsd_XSDNamedComponent_targetNamespace, model_xsd_XSDNamedComponent_aliasName}
...
model_xsd_XSDSchema.attributes={model_xsd_XSDSchema_version, model_xsd_XSDSchema_document, model_xsd_XSDSchema_blockDefault, model_xsd_XSDSchema_schemaLocation, model_xsd_XSDSchema_elementFormDefault, model_xsd_XSDSchema_finalDefault, model_xsd_XSDSchema_targetNamespace, model_xsd_XSDSchema_attributeFormDefault}
...
model_xsd_XSDSimpleTypeDefinition.attributes={model_xsd_XSDSimpleTypeDefinition_lexicalFinal, model_xsd_XSDSimpleTypeDefinition_validFacets, model_xsd_XSDSimpleTypeDefinition_variety, model_xsd_XSDSimpleTypeDefinition_final}
...
model_xsd_XSDWildcard.attributes={model_xsd_XSDWildcard_lexicalNamespaceConstraint, model_xsd_XSDWildcard_processContents, model_xsd_XSDWildcard_namespaceConstraintCategory, model_xsd_XSDWildcard_namespaceConstraint}
...
model_xsd_XSDXPathDefinition.attributes={model_xsd_XSDXPathDefinition_variety, model_xsd_XSDXPathDefinition_value}
...
model_messageproperties_Property.attributes={model_messageproperties_Property_type, model_messageproperties_Property_qName, model_messageproperties_Property_ID, model_messageproperties_Property_name}
...
model_messageproperties_PropertyAlias.attributes={model_messageproperties_PropertyAlias_propertyName, model_messageproperties_PropertyAlias_part, model_messageproperties_PropertyAlias_messageType, model_messageproperties_PropertyAlias_XSDElement, model_messageproperties_PropertyAlias_ID, model_messageproperties_PropertyAlias_type}
...
model_partnerlinktype_PartnerLinkType.attributes={model_partnerlinktype_PartnerLinkType_ID, model_partnerlinktype_PartnerLinkType_name}
...
model_partnerlinktype_Role.attributes={model_partnerlinktype_Role_portType, model_partnerlinktype_Role_ID, model_partnerlinktype_Role_name}
...
for_83: BinaryAssociation = BinaryAssociation(
    name="for_83",
    ends={
...
for_105: BinaryAssociation = BinaryAssociation(
    name="for_105",
    ends={
...
from_117: BinaryAssociation = BinaryAssociation(
    name="from_117",
    ends={
...
from_239: BinaryAssociation = BinaryAssociation(
    name="from_239",
    ends={
...
else_324: BinaryAssociation = BinaryAssociation(
    name="else_324",
    ends={
...
domain_model = DomainModel(
    name="model",
    types={model_Process, BPELExtensibleElement, model_MessageExchanges, model_PartnerLink, Role, PartnerLinkType, model_PartnerLinks, model_Variables, model_Activity, model_FaultHandler, model_EventHandler, model_CorrelationSets, model_Import, model_Extensions, model_Invoke, PartnerActivity, model_Variable, model_CompensationHandler, model_FromParts, model_Catch, model_CatchAll, model_Targets, model_Sources, model_CorrelationSet, Property_, Activity, model_MessageExchange, model_PartnerActivity, model_Correlations, model_ToParts, model_Link, model_Source, model_Target, Message, XSDElementDeclaration, model_Reply, model_Wait, model_Expression, model_Empty, model_Sequence, PortType, Operation, model_Receive, model_Exit, model_Throw, model_Links, model_CompletionCondition, model_While, model_Condition, model_Pick, model_OnMessage, model_OnAlarm, model_Flow, model_Scope, model_Assign, model_Copy, model_To, model_From, model_Extension, Part, model_Query, AbstractAssignBound, model_TerminationHandler, model_CompensateScope, model_AbstractAssignBound, XSDTypeDefinition, model_ServiceRef, ExtensibilityElement, model_OnEvent, model_BooleanExpression, Expression, model_Correlation, model_UnknownExtensibilityAttribute, UnknownExtensibilityElement, model_Rethrow, ExtensibleElement, WSDLElement, model_OpaqueActivity, model_ExtensionActivity, model_FromPart, model_ToPart, model_RepeatUntil, model_ForEach, model_ElseIf, model_Else, model_Validate, model_If, model_Branches, model_wsdl_WSDLElement, model_BPELExtensibleElement, model_Documentation, model_Compensate, model_wsdl_Operation, wsdl_IOperation, model_wsdl_PortType, wsdl_ExtensibleElement, wsdl_IPortType, model_wsdl_Part, wsdl_IPart, Input, Output, Fault, model_wsdl_Message, wsdl_IMessage, BindingOperation, model_wsdl_BindingOperation, wsdl_IBindingOperation, BindingInput, BindingOutput, model_wsdl_Binding, wsdl_IBinding, BindingFault, Port, model_wsdl_Port, wsdl_IPort, Binding, model_wsdl_ExtensibilityElement, wsdl_WSDLElement, wsdl_IExtensibilityElement, model_wsdl_Definition, wsdl_IDefinition, model_wsdl_Service, wsdl_IService, Service, Namespace, model_wsdl_Import, wsdl_IImport, Import, Types, model_wsdl_ExtensibleElement, wsdl_IElementExtensible, wsdl_IAttributeExtensible, model_wsdl_Input, wsdl_MessageReference, wsdl_IInput, model_wsdl_Output, wsdl_IOutput, model_wsdl_Fault, wsdl_IFault, Definition, XSDSchema, model_wsdl_BindingOutput, wsdl_IBindingOutput, model_wsdl_BindingFault, wsdl_IBindingFault, model_wsdl_BindingInput, wsdl_IBindingInput, model_wsdl_Namespace, model_wsdl_IPortType, IAttributeExtensible, IElementExtensible, model_wsdl_IInput, model_wsdl_IOperation, model_wsdl_IFault, model_wsdl_IMessage, model_wsdl_IPart, model_wsdl_IOutput, model_wsdl_IPort, model_wsdl_IBinding, model_wsdl_IService, model_wsdl_IBindingInput, model_wsdl_IBindingOutput, model_wsdl_IBindingFault, model_wsdl_IBindingOperation, model_wsdl_IDefinition, model_wsdl_IExtensibilityElement, model_wsdl_IImport, model_wsdl_IList, model_wsdl_IMap, model_wsdl_IURL, model_wsdl_IIterator, model_wsdl_ITypes, model_wsdl_UnknownExtensibilityElement, model_wsdl_XSDSchemaExtensibilityElement, wsdl_ExtensibilityElement, wsdl_ISchema, model_wsdl_IExtensionRegistry, model_wsdl_Types, wsdl_ITypes, model_wsdl_IElementExtensible, model_wsdl_IAttributeExtensible, model_wsdl_IObject, model_wsdl_ISchema, IExtensibilityElement, model_xsd_XSDAnnotation, xsd_XSDComponent, xsd_XSDRedefineContent, model_wsdl_MessageReference, model_xsd_XSDAttributeDeclaration, xsd_XSDFeature, xsd_XSDSchemaContent, XSDAnnotation, XSDSimpleTypeDefinition, XSDAttributeDeclaration, model_xsd_XSDAttributeGroupContent, XSDConcreteComponent, xsd_XSDAttributeGroupContent, XSDAttributeGroupContent, XSDAttributeUse, XSDWildcard, XSDAttributeGroupDefinition, model_xsd_XSDAttributeGroupDefinition, xsd_XSDRedefinableComponent, model_xsd_XSDAttributeUse, model_xsd_XSDBoundedFacet, XSDFundamentalFacet, model_xsd_XSDCardinalityFacet, model_xsd_XSDComplexTypeContent, XSDComponent, XSDComplexTypeContent, model_xsd_XSDComplexTypeDefinition, xsd_XSDTypeDefinition, xsd_XSDScope, XSDParticle, model_xsd_XSDComponent, model_xsd_XSDConcreteComponent, XSDDiagnostic, model_xsd_XSDConstrainingFacet, XSDFacet, model_xsd_XSDDiagnostic, model_xsd_XSDElementDeclaration, xsd_XSDTerm, model_xsd_XSDEnumerationFacet, XSDRepeatableFacet, model_xsd_XSDFacet, XSDIdentityConstraintDefinition, XSDScope, XSDFeature, model_xsd_XSDFixedFacet, XSDConstrainingFacet, model_xsd_XSDFractionDigitsFacet, XSDFixedFacet, model_xsd_XSDFundamentalFacet, model_xsd_XSDFeature, XSDNamedComponent, XSDXPathDefinition, model_xsd_XSDImport, XSDSchemaDirective, model_xsd_XSDInclude, XSDSchemaCompositor, model_xsd_XSDLengthFacet, model_xsd_XSDMaxExclusiveFacet, XSDMaxFacet, model_xsd_XSDMaxFacet, model_xsd_XSDMaxInclusiveFacet, model_xsd_XSDMaxLengthFacet, model_xsd_XSDIdentityConstraintDefinition, model_xsd_XSDMinInclusiveFacet, model_xsd_XSDMinLengthFacet, model_xsd_XSDModelGroup, XSDTerm, model_xsd_XSDModelGroupDefinition, xsd_XSDParticleContent, XSDModelGroup, XSDModelGroupDefinition, model_xsd_XSDMinExclusiveFacet, XSDMinFacet, model_xsd_XSDMinFacet, model_xsd_XSDNotationDeclaration, xsd_XSDNamedComponent, model_xsd_XSDNumericFacet, model_xsd_XSDOrderedFacet, model_xsd_XSDParticle, XSDParticleContent, model_xsd_XSDParticleContent, model_xsd_XSDPatternFacet, model_xsd_XSDRedefinableComponent, model_xsd_XSDNamedComponent, XSDRedefineContent, model_xsd_XSDRepeatableFacet, model_xsd_XSDSchema, model_xsd_XSDRedefineContent, XSDSchemaContent, model_xsd_XSDRedefine, model_xsd_XSDSchemaCompositor, model_xsd_XSDSchemaContent, model_xsd_XSDSchemaDirective, model_xsd_XSDScope, XSDNotationDeclaration, XSDMaxInclusiveFacet, model_xsd_XSDSimpleTypeDefinition, xsd_XSDComplexTypeContent, XSDMaxExclusiveFacet, XSDLengthFacet, XSDWhiteSpaceFacet, XSDEnumerationFacet, XSDPatternFacet, XSDCardinalityFacet, XSDNumericFacet, XSDMaxLengthFacet, XSDMinLengthFacet, XSDMinInclusiveFacet, XSDMinExclusiveFacet, XSDOrderedFacet, XSDBoundedFacet, XSDTotalDigitsFacet, XSDFractionDigitsFacet, model_xsd_XSDTerm, model_xsd_XSDTotalDigitsFacet, model_xsd_XSDTypeDefinition, model_xsd_XSDWhiteSpaceFacet, model_xsd_XSDWildcard, model_xsd_XSDXPathDefinition, model_messageproperties_Property, Query, model_messageproperties_Query, model_messageproperties_PropertyAlias, model_partnerlinktype_PartnerLinkType, model_partnerlinktype_Role, CorrelationPattern, EndpointReferenceRole, XSDAttributeUseCategory, XSDCardinality, XSDComplexFinal, XSDCompositor, XSDConstraint, XSDContentTypeCategory, XSDDerivationMethod, XSDDiagnosticSeverity, XSDDisallowedSubstitutions, XSDForm, XSDIdentityConstraintCategory, XSDProcessContents, XSDProhibitedSubstitutions, XSDSimpleFinal, XSDSubstitutionGroupExclusions, XSDVariety, XSDWhiteSpace, XSDXPathVariety, XSDNamespaceConstraintCategory, XSDOrdered},
    associations={messageExchanges15, myRole17, partnerRole18, PartnerLinkType21, partnerLinks0, variables1, activity3, faultHandlers5, eventHandlers7, correlationSets9, imports11, extensions13, properties31, outputVariable32, inputVariable33, compensationHandler36, faultHandler38, fromParts41, catch23, catchAll25, targets27, sources29, variable58, toParts60, messageExchange63, partnerLink65, toParts43, sources45, targets46, faultVariable48, activity51, faultMessageType54, faultElement56, faultVariable81, for_83, until84, correlations67, portType69, operation71, variable73, fromParts75, messageExchange78, activities96, links98, completionCondition100, activity102, activities87, activity89, condition91, messages93, alarm94, faultHandlers119, compensationHandler121, activity124, variables127, for_105, until108, repeatEvery111, copy114, to115, from_117, variable149, part151, partnerLink153, property156, query159, expression161, correlationSets130, eventHandlers133, partnerLinks136, terminationHandler139, messageExchanges141, target144, activity146, type166, messageExchange189, serviceRef164, variable168, activity171, portType174, partnerLink177, correlations180, operation183, fromParts186, alarm194, events197, set192, children210, children213, Link199, activity201, transitionCondition203, Link206, activity208, children227, children216, children219, children222, activity224, partnerLink248, correlations251, messageType230, XSDElement233, type236, from_239, activity242, variable245, operation254, portType257, messageType260, XSDElement263, correlationSets266, fromParts269, messageExchange272, children275, joinCondition278, children281, fromVariable291, part293, children284, toVariable286, part288, activity307, activity310, startCounterValue296, finalCounterValue298, counterName301, completionCondition304, elseIf322, else_324, condition312, activity315, variables318, condition320, branches338, activity326, condition329, activity332, activity335, children344, documentation340, children341, eOperations347, eParts357, eInput349, eOutput350, eFaults352, eParameterOrdering354, ePortType367, eBindingOperations369, eOperation371, typeDefinition359, elementDeclaration361, eBindingInput373, eMessage364, eBindingOutput375, ePorts379, eBinding380, eBindingFaults377, ePortTypes387, eBindings390, eServices393, eNamespaces395, eImports381, eTypes382, eMessages384, eSchema398, eExtensibilityElements400, eDefinition397, eInput401, eOutput403, eFault405, children407, schema408, eMessage410, annotation412, anonymousTypeDefinition413, typeDefinition415, resolvedAttributeDeclaration418, annotation420, contents422, attributeUses424, attributeWildcardContent426, attributeWildcard428, resolvedAttributeGroupDefinition431, syntheticWildcard433, attributeDeclaration436, content438, contentAnnotation441, baseTypeDefinition443, content446, contentType448, attributeContents454, attributeWildcard457, attributeWildcardContent460, rootTypeDefinition463, syntheticParticle466, syntheticWildcard468, attributeUses451, schema475, diagnostics478, container471, rootContainer472, primaryComponent482, annotation485, anonymousTypeDefinition487, components480, identityConstraintDefinitions493, resolvedElementDeclaration495, substitutionGroupAffiliation498, substitutionGroup501, annotation504, typeDefinition490, scope509, resolvedFeature510, type512, simpleTypeDefinition506, annotation515, referencedKey517, selector520, fields522, annotation525, annotation527, annotation529, contents531, particles534, annotation537, modelGroup539, annotation543, content545, term546, resolvedModelGroupDefinition541, contents550, annotations552, contents554, elementDeclarations555, attributeDeclarations558, attributeGroupDefinitions561, typeDefinitions564, modelGroupDefinitions567, annotations548, annotations575, allDiagnostics578, referencingDirectives581, rootVersion583, originalVersion586, incorporatedVersions589, schemaForSchema592, incorporatedSchema595, resolvedSchema597, identityConstraintDefinitions570, notationDeclarations573, contents599, facetContents601, facets603, memberTypeDefinitions606, fundamentalFacets609, baseTypeDefinition611, primitiveTypeDefinition614, itemTypeDefinition617, rootTypeDefinition620, minFacet623, maxFacet625, minExclusiveFacet631, maxExclusiveFacet633, lengthFacet635, whiteSpaceFacet637, enumerationFacets639, patternFacets641, cardinalityFacet643, numericFacet645, maxLengthFacet647, minLengthFacet649, maxInclusiveFacet627, minInclusiveFacet629, orderedFacet655, boundedFacet657, effectiveMaxFacet659, effectiveWhiteSpaceFacet662, effectiveMaxLengthFacet665, effectiveFractionDigitsFacet668, effectivePatternFacet671, effectiveEnumerationFacet674, effectiveTotalDigitsFacet677, totalDigitsFacet651, fractionDigitsFacet653, effectiveMinFacet686, syntheticFacets689, annotation691, derivationAnnotation693, annotations696, effectiveMinLengthFacet680, effectiveLengthFacet683, baseType702, simpleType705, complexType708, annotation711, annotations713, rootType699, annotation716, wsdlPart718, query720, role722},
    generalizations={gen_model_Process_BPELExtensibleElement, gen_model_PartnerLink_BPELExtensibleElement, gen_model_Invoke_PartnerActivity, gen_model_FaultHandler_BPELExtensibleElement, gen_model_Activity_BPELExtensibleElement, gen_model_CorrelationSet_BPELExtensibleElement, gen_model_Reply_Activity, gen_model_PartnerActivity_Activity, gen_model_Link_BPELExtensibleElement, gen_model_Catch_BPELExtensibleElement, gen_model_Reply_PartnerActivity, gen_model_Wait_Activity, gen_model_Empty_Activity, gen_model_Receive_PartnerActivity, gen_model_Exit_Activity, gen_model_Throw_Activity, gen_model_OnAlarm_BPELExtensibleElement, gen_model_Sequence_Activity, gen_model_While_Activity, gen_model_Pick_Activity, gen_model_Flow_Activity, gen_model_Scope_Activity, gen_model_Assign_Activity, gen_model_Copy_BPELExtensibleElement, gen_model_Extension_BPELExtensibleElement, gen_model_To_BPELExtensibleElement, gen_model_To_AbstractAssignBound, gen_model_CompensateScope_Activity, gen_model_CompensationHandler_BPELExtensibleElement, gen_model_OnMessage_BPELExtensibleElement, gen_model_From_BPELExtensibleElement, gen_model_From_AbstractAssignBound, gen_model_Expression_ExtensibilityElement, gen_model_EventHandler_BPELExtensibleElement, gen_model_BooleanExpression_Expression, gen_model_Correlation_BPELExtensibleElement, gen_model_MessageExchange_BPELExtensibleElement, gen_model_MessageExchanges_BPELExtensibleElement, gen_model_Source_BPELExtensibleElement, gen_model_Target_BPELExtensibleElement, gen_model_PartnerLinks_BPELExtensibleElement, gen_model_Correlations_BPELExtensibleElement, gen_model_Variable_BPELExtensibleElement, gen_model_Variables_BPELExtensibleElement, gen_model_CorrelationSets_BPELExtensibleElement, gen_model_Links_BPELExtensibleElement, gen_model_CatchAll_BPELExtensibleElement, gen_model_UnknownExtensibilityAttribute_UnknownExtensibilityElement, gen_model_OnEvent_BPELExtensibleElement, gen_model_Import_BPELExtensibleElement, gen_model_Rethrow_Activity, gen_model_Query_WSDLElement, gen_model_ServiceRef_ExtensibleElement, gen_model_Condition_Expression, gen_model_Targets_BPELExtensibleElement, gen_model_Sources_BPELExtensibleElement, gen_model_OpaqueActivity_Activity, gen_model_Extensions_BPELExtensibleElement, gen_model_ExtensionActivity_Activity, gen_model_FromPart_BPELExtensibleElement, gen_model_ToPart_BPELExtensibleElement, gen_model_RepeatUntil_Activity, gen_model_ForEach_Activity, gen_model_TerminationHandler_BPELExtensibleElement, gen_model_Validate_Activity, gen_model_If_Activity, gen_model_CompletionCondition_BPELExtensibleElement, gen_model_Branches_Expression, gen_model_ElseIf_BPELExtensibleElement, gen_model_Else_BPELExtensibleElement, gen_model_ToParts_BPELExtensibleElement, gen_model_BPELExtensibleElement_ExtensibleElement, gen_model_Documentation_BPELExtensibleElement, gen_model_Compensate_Activity, gen_model_FromParts_BPELExtensibleElement, gen_model_wsdl_Operation_wsdl_ExtensibleElement, gen_model_wsdl_Operation_wsdl_IOperation, gen_model_wsdl_PortType_wsdl_ExtensibleElement, gen_model_wsdl_PortType_wsdl_IPortType, gen_model_wsdl_Part_wsdl_ExtensibleElement, gen_model_wsdl_Part_wsdl_IPart, gen_model_wsdl_Message_wsdl_ExtensibleElement, gen_model_wsdl_Message_wsdl_IMessage, gen_model_wsdl_BindingOperation_wsdl_ExtensibleElement, gen_model_wsdl_BindingOperation_wsdl_IBindingOperation, gen_model_wsdl_Binding_wsdl_ExtensibleElement, gen_model_wsdl_Binding_wsdl_IBinding, gen_model_wsdl_Port_wsdl_ExtensibleElement, gen_model_wsdl_Port_wsdl_IPort, gen_model_wsdl_ExtensibilityElement_wsdl_WSDLElement, gen_model_wsdl_ExtensibilityElement_wsdl_IExtensibilityElement, gen_model_wsdl_Definition_wsdl_ExtensibleElement, gen_model_wsdl_Definition_wsdl_IDefinition, gen_model_wsdl_Service_wsdl_ExtensibleElement, gen_model_wsdl_Service_wsdl_IService, gen_model_wsdl_Import_wsdl_ExtensibleElement, gen_model_wsdl_Import_wsdl_IImport, gen_model_wsdl_ExtensibleElement_wsdl_WSDLElement, gen_model_wsdl_ExtensibleElement_wsdl_IElementExtensible, gen_model_wsdl_ExtensibleElement_wsdl_IAttributeExtensible, gen_model_wsdl_Input_wsdl_MessageReference, gen_model_wsdl_Input_wsdl_IInput, gen_model_wsdl_Output_wsdl_MessageReference, gen_model_wsdl_Output_wsdl_IOutput, gen_model_wsdl_Fault_wsdl_MessageReference, gen_model_wsdl_Fault_wsdl_IFault, gen_model_wsdl_BindingOutput_wsdl_ExtensibleElement, gen_model_wsdl_BindingOutput_wsdl_IBindingOutput, gen_model_wsdl_BindingFault_wsdl_ExtensibleElement, gen_model_wsdl_BindingFault_wsdl_IBindingFault, gen_model_wsdl_BindingInput_wsdl_ExtensibleElement, gen_model_wsdl_BindingInput_wsdl_IBindingInput, gen_model_wsdl_IPortType_IAttributeExtensible, gen_model_wsdl_IOperation_IElementExtensible, gen_model_wsdl_IInput_IAttributeExtensible, gen_model_wsdl_IFault_IAttributeExtensible, gen_model_wsdl_IMessage_IElementExtensible, gen_model_wsdl_IPart_IAttributeExtensible, gen_model_wsdl_IOutput_IAttributeExtensible, gen_model_wsdl_IPort_IElementExtensible, gen_model_wsdl_IBinding_IElementExtensible, gen_model_wsdl_IService_IElementExtensible, gen_model_wsdl_IBindingInput_IElementExtensible, gen_model_wsdl_IBindingOutput_IElementExtensible, gen_model_wsdl_IBindingFault_IElementExtensible, gen_model_wsdl_IBindingOperation_IElementExtensible, gen_model_wsdl_IDefinition_IElementExtensible, gen_model_wsdl_IImport_IAttributeExtensible, gen_model_wsdl_UnknownExtensibilityElement_ExtensibilityElement, gen_model_wsdl_XSDSchemaExtensibilityElement_wsdl_ExtensibilityElement, gen_model_wsdl_XSDSchemaExtensibilityElement_wsdl_ISchema, gen_model_wsdl_Types_wsdl_ExtensibleElement, gen_model_wsdl_Types_wsdl_ITypes, gen_model_wsdl_ISchema_IExtensibilityElement, gen_model_xsd_XSDAnnotation_xsd_XSDComponent, gen_model_xsd_XSDAnnotation_xsd_XSDRedefineContent, gen_model_wsdl_MessageReference_ExtensibleElement, gen_model_xsd_XSDAttributeDeclaration_xsd_XSDFeature, gen_model_xsd_XSDAttributeDeclaration_xsd_XSDSchemaContent, gen_model_xsd_XSDAttributeGroupContent_XSDConcreteComponent, gen_model_xsd_XSDAttributeGroupDefinition_xsd_XSDAttributeGroupContent, gen_model_xsd_XSDAttributeGroupDefinition_xsd_XSDRedefineContent, gen_model_xsd_XSDAttributeGroupDefinition_xsd_XSDRedefinableComponent, gen_model_xsd_XSDAttributeUse_xsd_XSDComponent, gen_model_xsd_XSDAttributeUse_xsd_XSDAttributeGroupContent, gen_model_xsd_XSDBoundedFacet_XSDFundamentalFacet, gen_model_xsd_XSDCardinalityFacet_XSDFundamentalFacet, gen_model_xsd_XSDComplexTypeContent_XSDComponent, gen_model_xsd_XSDComplexTypeDefinition_xsd_XSDTypeDefinition, gen_model_xsd_XSDComplexTypeDefinition_xsd_XSDScope, gen_model_xsd_XSDComponent_XSDConcreteComponent, gen_model_xsd_XSDConstrainingFacet_XSDFacet, gen_model_xsd_XSDDiagnostic_XSDConcreteComponent, gen_model_xsd_XSDElementDeclaration_xsd_XSDFeature, gen_model_xsd_XSDElementDeclaration_xsd_XSDSchemaContent, gen_model_xsd_XSDElementDeclaration_xsd_XSDTerm, gen_model_xsd_XSDEnumerationFacet_XSDRepeatableFacet, gen_model_xsd_XSDFacet_XSDComponent, gen_model_xsd_XSDFixedFacet_XSDConstrainingFacet, gen_model_xsd_XSDFractionDigitsFacet_XSDFixedFacet, gen_model_xsd_XSDFeature_XSDNamedComponent, gen_model_xsd_XSDImport_XSDSchemaDirective, gen_model_xsd_XSDInclude_XSDSchemaCompositor, gen_model_xsd_XSDLengthFacet_XSDFixedFacet, gen_model_xsd_XSDMaxExclusiveFacet_XSDMaxFacet, gen_model_xsd_XSDMaxFacet_XSDFixedFacet, gen_model_xsd_XSDMaxInclusiveFacet_XSDMaxFacet, gen_model_xsd_XSDMaxLengthFacet_XSDFixedFacet, gen_model_xsd_XSDFundamentalFacet_XSDFacet, gen_model_xsd_XSDIdentityConstraintDefinition_XSDNamedComponent, gen_model_xsd_XSDMinInclusiveFacet_XSDMinFacet, gen_model_xsd_XSDMinLengthFacet_XSDFixedFacet, gen_model_xsd_XSDModelGroup_XSDTerm, gen_model_xsd_XSDModelGroupDefinition_xsd_XSDRedefinableComponent, gen_model_xsd_XSDModelGroupDefinition_xsd_XSDParticleContent, gen_model_xsd_XSDModelGroupDefinition_xsd_XSDRedefineContent, gen_model_xsd_XSDMinExclusiveFacet_XSDMinFacet, gen_model_xsd_XSDMinFacet_XSDFixedFacet, gen_model_xsd_XSDNotationDeclaration_xsd_XSDNamedComponent, gen_model_xsd_XSDNotationDeclaration_xsd_XSDSchemaContent, gen_model_xsd_XSDNumericFacet_XSDFundamentalFacet, gen_model_xsd_XSDOrderedFacet_XSDFundamentalFacet, gen_model_xsd_XSDParticle_XSDComplexTypeContent, gen_model_xsd_XSDParticleContent_XSDConcreteComponent, gen_model_xsd_XSDPatternFacet_XSDRepeatableFacet, gen_model_xsd_XSDRedefinableComponent_xsd_XSDNamedComponent, gen_model_xsd_XSDRedefinableComponent_xsd_XSDRedefineContent, gen_model_xsd_XSDNamedComponent_XSDComponent, gen_model_xsd_XSDRepeatableFacet_XSDConstrainingFacet, gen_model_xsd_XSDSchema_XSDScope, gen_model_xsd_XSDRedefineContent_XSDSchemaContent, gen_model_xsd_XSDRedefine_XSDSchemaCompositor, gen_model_xsd_XSDSchemaCompositor_XSDSchemaDirective, gen_model_xsd_XSDSchemaContent_XSDConcreteComponent, gen_model_xsd_XSDSchemaDirective_XSDSchemaContent, gen_model_xsd_XSDScope_XSDComponent, gen_model_xsd_XSDSimpleTypeDefinition_xsd_XSDTypeDefinition, gen_model_xsd_XSDSimpleTypeDefinition_xsd_XSDComplexTypeContent, gen_model_xsd_XSDTerm_xsd_XSDComponent, gen_model_xsd_XSDTerm_xsd_XSDParticleContent, gen_model_xsd_XSDTotalDigitsFacet_XSDFixedFacet, gen_model_xsd_XSDTypeDefinition_xsd_XSDRedefinableComponent, gen_model_xsd_XSDTypeDefinition_xsd_XSDRedefineContent, gen_model_xsd_XSDWhiteSpaceFacet_XSDFixedFacet, gen_model_xsd_XSDWildcard_XSDTerm, gen_model_xsd_XSDXPathDefinition_XSDComponent, gen_model_messageproperties_Property_ExtensibilityElement, gen_model_messageproperties_Query_ExtensibilityElement, gen_model_messageproperties_PropertyAlias_ExtensibilityElement, gen_model_partnerlinktype_PartnerLinkType_ExtensibilityElement, gen_model_partnerlinktype_Role_ExtensibilityElement},
    metadata=None
)
