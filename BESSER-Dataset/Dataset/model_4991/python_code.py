...
class simulink_Goto(VirtualBlock):
    ...
    def __init__(self, tagVisibility: str, gotoTag: str, Goto: "simulink_From" = None, gotoBlock: set["simulink_From"] = None, simulink_Goto: "simulink_GotoTagVisibility" = None):
...
class simulink_BusSignalMapping:
    ...
    def __init__(self, mappingPath: str, incomplete: bool, BusSignalMapping: "simulink_BusSelector" = None, simulink_BusSignalMapping52: "simulink_OutPort" = None, mappings: "simulink_BusSelector" = None, simulink_BusSignalMapping: "simulink_OutPort" = None):
...
class simulink_Parameter:
    ...
    def __init__(self, readOnly: bool, name: str, type: str, value: str, simulink_Parameter: "simulink_Block" = None, simulink_Parameter20: "simulink_Port" = None):
