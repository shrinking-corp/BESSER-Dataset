...
simulink_Enable = Class(name="simulink_Enable")
simulink_IdentifierReference = Class(name="simulink_IdentifierReference")
...
simulink_Trigger = Class(name="simulink_Trigger")
simulink_LibraryLinkReference = Class(name="simulink_LibraryLinkReference")
...
simulink_SingleConnection = Class(name="simulink_SingleConnection")
...
simulink_BusSignalMapping = Class(name="simulink_BusSignalMapping")
simulink_Connection = Class(name="simulink_Connection", is_abstract=True)
InPort = Class(name="InPort")
simulink_SimulinkModel = Class(name="simulink_SimulinkModel")
simulink_BusSpecification = Class(name="simulink_BusSpecification", is_abstract=True)
simulink_BusCreator = Class(name="simulink_BusCreator")
simulink_Goto = Class(name="simulink_Goto")
VirtualBlock = Class(name="VirtualBlock")
simulink_From = Class(name="simulink_From")
simulink_VirtualBlock = Class(name="simulink_VirtualBlock", is_abstract=True)
Block = Class(name="Block")
simulink_MultiConnection = Class(name="simulink_MultiConnection")
Connection = Class(name="Connection")
simulink_GotoTagVisibility = Class(name="simulink_GotoTagVisibility")
...
simulink_TriggerBlock = Class(name="simulink_TriggerBlock")
InPortBlock = Class(name="InPortBlock")
simulink_EnableBlock = Class(name="simulink_EnableBlock")
simulink_SimulinkReference = Class(name="simulink_SimulinkReference", is_abstract=True)
...
simulink_SimulinkModel.attributes={simulink_SimulinkModel_file, simulink_SimulinkModel_version, simulink_SimulinkModel_library}
...
connection22: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_", type=simulink_Connection, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
...
domain_model = DomainModel(
    name="simulink",
    types={simulink_SimulinkElement, simulink_Enable, simulink_IdentifierReference, simulink_Block, SimulinkElement, simulink_Parameter, simulink_Port, simulink_Trigger, simulink_LibraryLinkReference, simulink_InPort, simulink_OutPort, simulink_SubSystem, Port, simulink_SingleConnection, simulink_PortBlock, simulink_BusSelector, BusSpecification, simulink_BusSignalMapping, simulink_Connection, InPort, simulink_SimulinkModel, simulink_BusSpecification, simulink_BusCreator, simulink_Goto, VirtualBlock, simulink_From, simulink_VirtualBlock, Block, simulink_MultiConnection, Connection, simulink_GotoTagVisibility, simulink_OutPortBlock, PortBlock, simulink_InPortBlock, simulink_TriggerBlock, InPortBlock, simulink_EnableBlock, simulink_SimulinkReference, simulink_ModelReference, SimulinkReference, simulink_State, OutPort, EnableStates, TriggerType, TagVisibility},
    associations={trigger3, enabler5, simulinkRef0, parameters1, ports2, sourceBlockRef15, inports7, outports9, parent11, sourceBlock13, connection21, container17, portBlock18, parameters19, connection22, from_23, gotoBlock27, mappings24, busCreator25, fromBlocks26, to33, port35, contains28, connections30, parent32, element37, gotoBlock39, subBlocks40, referencedModel43, modelRef45, selector48, mappingFrom49, mappingTo51},
    generalizations={gen_simulink_Block_SimulinkElement, gen_simulink_InPort_Port, gen_simulink_Port_SimulinkElement, gen_simulink_BusSelector_BusSpecification, gen_simulink_OutPort_Port, gen_simulink_Connection_SimulinkElement, gen_simulink_Trigger_InPort, gen_simulink_Enable_InPort, gen_simulink_From_VirtualBlock, gen_simulink_SimulinkModel_SimulinkElement, gen_simulink_BusCreator_BusSpecification, gen_simulink_Goto_VirtualBlock, gen_simulink_VirtualBlock_Block, gen_simulink_PortBlock_VirtualBlock, gen_simulink_MultiConnection_Connection, gen_simulink_SingleConnection_Connection, gen_simulink_GotoTagVisibility_VirtualBlock, gen_simulink_OutPortBlock_PortBlock, gen_simulink_InPortBlock_PortBlock, gen_simulink_TriggerBlock_InPortBlock, gen_simulink_EnableBlock_InPortBlock, gen_simulink_ModelReference_Block, gen_simulink_SubSystem_Block, gen_simulink_LibraryLinkReference_SimulinkReference, gen_simulink_BusSpecification_Block, gen_simulink_IdentifierReference_SimulinkReference, gen_simulink_State_OutPort},
    metadata=None
)
