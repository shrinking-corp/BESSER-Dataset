...
# Classes
ric_IdentifiableComponent = Class(name="ric_IdentifiableComponent", is_abstract=True)
ric_ClassifiableComponent = Class(name="ric_ClassifiableComponent", is_abstract=True)
ric_EventComponent = Class(name="ric_EventComponent", is_abstract=True)
ric_Event = Class(name="ric_Event")
ric_FormControl = Class(name="ric_FormControl", is_abstract=True)
...
ric_Label = Class(name="ric_Label")
ric_PhraseElement = Class(name="ric_PhraseElement")
ric_ValueConstraint = Class(name="ric_ValueConstraint")
ric_NumberValueConstraint = Class(name="ric_NumberValueConstraint")
ric_Form = Class(name="ric_Form")
ric_RequiredFieldConstraint = Class(name="ric_RequiredFieldConstraint")
ric_ValidDateConstraint = Class(name="ric_ValidDateConstraint")
ric_Button = Class(name="ric_Button")
FormControl = Class(name="FormControl")
ric_Script = Class(name="ric_Script")
ric_TextArea = Class(name="ric_TextArea")
ric_Checkbox = Class(name="ric_Checkbox")
ric_Radio = Class(name="ric_Radio")
ric_Select = Class(name="ric_Select")
ric_SelectItem = Class(name="ric_SelectItem")
ric_Document = Class(name="ric_Document")
ric_Fieldset = Class(name="ric_Fieldset")
ric_BlockLevelComponent = Class(name="ric_BlockLevelComponent", is_abstract=True)
ric_InlineComponent = Class(name="ric_InlineComponent", is_abstract=True)
ric_TextField = Class(name="ric_TextField")
ric_InputFile = Class(name="ric_InputFile")
ric_ObjectComponent = Class(name="ric_ObjectComponent", is_abstract=True)
ric_LineBreak = Class(name="ric_LineBreak")
ric_RichWidget = Class(name="ric_RichWidget", is_abstract=True)
ric_List = Class(name="ric_List", is_abstract=True)
ric_Span = Class(name="ric_Span")
InlineComponent = Class(name="InlineComponent")
ric_Heading = Class(name="ric_Heading")
ric_RadioGroup = Class(name="ric_RadioGroup")
ric_CheckGroup = Class(name="ric_CheckGroup")
ric_Div = Class(name="ric_Div")
BlockLevelComponent = Class(name="BlockLevelComponent")
ric_Paragraph = Class(name="ric_Paragraph")
ric_Link = Class(name="ric_Link")
ric_Image = Class(name="ric_Image")
ObjectComponent = Class(name="ObjectComponent")
ric_AccordionPanel = Class(name="ric_AccordionPanel")
ric_Section = Class(name="ric_Section")
ric_TabbedPanel = Class(name="ric_TabbedPanel")
RichWidget = Class(name="RichWidget")
ric_Tab = Class(name="ric_Tab")
ric_MessageDialogButton = Class(name="ric_MessageDialogButton")
ric_Datepicker = Class(name="ric_Datepicker")
TextField = Class(name="TextField")
ric_MessageDialog = Class(name="ric_MessageDialog")
ric_Portal = Class(name="ric_Portal")
ric_HeaderRegion = Class(name="ric_HeaderRegion")
ric_NavigationRegion = Class(name="ric_NavigationRegion")
ric_ContextualNavigationRegion = Class(name="ric_ContextualNavigationRegion")
ric_SearchRegion = Class(name="ric_SearchRegion")
ric_ContentRegion = Class(name="ric_ContentRegion")
ric_FooterRegion = Class(name="ric_FooterRegion")
ric_Logo = Class(name="ric_Logo")
ric_FormControlConstraint = Class(name="ric_FormControlConstraint", is_abstract=True)
FormControlConstraint = Class(name="FormControlConstraint")
ric_LinkGroup = Class(name="ric_LinkGroup")
ric_OrderedList = Class(name="ric_OrderedList")
List = Class(name="List")
ric_ListItem = Class(name="ric_ListItem")
ric_UnorderedList = Class(name="ric_UnorderedList")
...
ric_ClassifiableComponent_class_: Property = Property(name="class_", type=StringType)
ric_ClassifiableComponent.attributes={ric_ClassifiableComponent_class_}
...
ric_Button.attributes={ric_Button_disabled, ric_Button_image, ric_Button_type}
...
ric_SelectItem.attributes={ric_SelectItem_value, ric_SelectItem_itemLabel, ric_SelectItem_selected}
...
ric_TextField.attributes={ric_TextField_maxChars, ric_TextField_charWidth, ric_TextField_password, ric_TextField_readonly}
...
ric_InputFile.attributes={ric_InputFile_readonly, ric_InputFile_charWidth, ric_InputFile_maxChars}
...
ric_ObjectComponent.attributes={ric_ObjectComponent_hspace, ric_ObjectComponent_height, ric_ObjectComponent_align, ric_ObjectComponent_vspace, ric_ObjectComponent_width, ric_ObjectComponent_border}
...
ric_Datepicker.attributes={ric_Datepicker_showMonthMenu, ric_Datepicker_numberMonthsToShow, ric_Datepicker_locale, ric_Datepicker_dateFormat, ric_Datepicker_showButtonClosePanel, ric_Datepicker_showYearMenu, ric_Datepicker_showWeekOfYear, ric_Datepicker_showButtonImage}
...
ric_MessageDialog.attributes={ric_MessageDialog_resizable, ric_MessageDialog_message, ric_MessageDialog_height, ric_MessageDialog_minHeightResize, ric_MessageDialog_autoOpen, ric_MessageDialog_maxHeightResize, ric_MessageDialog_title, ric_MessageDialog_maxWidthResize, ric_MessageDialog_width, ric_MessageDialog_minWidthResize, ric_MessageDialog_modal}
...
domain_model = DomainModel(
    name="ric",
    types={ric_IdentifiableComponent, ric_ClassifiableComponent, ric_EventComponent, ric_Event, ric_FormControl, IdentifiableComponent, ClassifiableComponent, EventComponent, ric_Label, ric_PhraseElement, ric_ValueConstraint, ric_NumberValueConstraint, ric_Form, ric_RequiredFieldConstraint, ric_ValidDateConstraint, ric_Button, FormControl, ric_Script, ric_TextArea, ric_Checkbox, ric_Radio, ric_Select, ric_SelectItem, ric_Document, ric_Fieldset, ric_BlockLevelComponent, ric_InlineComponent, ric_TextField, ric_InputFile, ric_ObjectComponent, ric_LineBreak, ric_RichWidget, ric_List, ric_Span, InlineComponent, ric_Heading, ric_RadioGroup, ric_CheckGroup, ric_Div, BlockLevelComponent, ric_Paragraph, ric_Link, ric_Image, ObjectComponent, ric_AccordionPanel, ric_Section, ric_TabbedPanel, RichWidget, ric_Tab, ric_MessageDialogButton, ric_Datepicker, TextField, ric_MessageDialog, ric_Portal, ric_HeaderRegion, ric_NavigationRegion, ric_ContextualNavigationRegion, ric_SearchRegion, ric_ContentRegion, ric_FooterRegion, ric_Logo, ric_FormControlConstraint, FormControlConstraint, ric_LinkGroup, ric_OrderedList, List, ric_ListItem, ric_UnorderedList, EventType, ScriptType, ButtonType, SubmitFormMethod, Align, HeadingLevel, PhraseElementType, ObjectAlign, DateFormat, Locale, MatchingOperator, LogicalOperator, Orientation, OrderedListType, UnorderedListType, Extension, FieldSetLegendAlign, MessageDialogEvent},
    associations={events0, label1, accompanyingPhrase2, valueConstraints4, numberConstraint6, triggerScript12, requiredFieldConstraint8, validDateConstraint10, items21, action14, fieldsets15, blockLevelComponents17, inlineComponents19, objectComponents32, lineBreaks33, richWidgets35, lists37, forms39, fieldsets42, events22, controls25, radioGroups28, checkGroups30, target54, blockLevelComponents46, inlineComponents48, inlineComponents52, inlineComponents57, blockLevelComponents60, objectComponents63, lineBreaks66, richWidgets69, lists72, forms75, sections78, inlineComponents79, tabs56, buttons100, blockLevelComponents82, objectComponents85, lineBreaks88, richWidgets91, lists94, forms97, headerRegion101, navigationRegion102, contextualNavigationRegion104, searchRegion106, contentRegion108, footerRegion110, logo112, subsiteNavigation114, inlineComponents117, lineBreaks120, objectComponents133, lineBreaks136, richWidgets139, lists142, forms145, forms148, documents151, inlineComponents154, blockLevelComponents157, objectComponents160, lineBreaks163, image123, linkGroups125, inlineComponents127, blockLevelComponents130, lineBreaks184, richWidgets187, listItemns190, listItemns191, radios193, richWidgets166, lists169, forms172, inlineComponents175, blockLevelComponents178, objectComponents181, linkGroups207, label195, checks198, label200, links203},
    generalizations={gen_ric_FormControl_IdentifiableComponent, gen_ric_FormControl_ClassifiableComponent, gen_ric_FormControl_EventComponent, gen_ric_Form_IdentifiableComponent, gen_ric_Form_ClassifiableComponent, gen_ric_Form_EventComponent, gen_ric_Button_FormControl, gen_ric_TextArea_FormControl, gen_ric_Checkbox_FormControl, gen_ric_Radio_FormControl, gen_ric_Select_FormControl, gen_ric_Label_IdentifiableComponent, gen_ric_Label_ClassifiableComponent, gen_ric_TextField_FormControl, gen_ric_InputFile_FormControl, gen_ric_Span_ClassifiableComponent, gen_ric_Span_IdentifiableComponent, gen_ric_Span_EventComponent, gen_ric_Span_InlineComponent, gen_ric_Heading_ClassifiableComponent, gen_ric_Heading_IdentifiableComponent, gen_ric_Heading_EventComponent, gen_ric_Heading_InlineComponent, gen_ric_Fieldset_EventComponent, gen_ric_Fieldset_IdentifiableComponent, gen_ric_Fieldset_ClassifiableComponent, gen_ric_Div_ClassifiableComponent, gen_ric_Div_IdentifiableComponent, gen_ric_Div_EventComponent, gen_ric_Div_BlockLevelComponent, gen_ric_Paragraph_ClassifiableComponent, gen_ric_Paragraph_IdentifiableComponent, gen_ric_Paragraph_InlineComponent, gen_ric_Paragraph_EventComponent, gen_ric_LineBreak_ClassifiableComponent, gen_ric_LineBreak_IdentifiableComponent, gen_ric_Link_ClassifiableComponent, gen_ric_Link_EventComponent, gen_ric_Link_IdentifiableComponent, gen_ric_Link_InlineComponent, gen_ric_Image_ClassifiableComponent, gen_ric_Image_EventComponent, gen_ric_Image_IdentifiableComponent, gen_ric_Image_ObjectComponent, gen_ric_PhraseElement_IdentifiableComponent, gen_ric_PhraseElement_ClassifiableComponent, gen_ric_PhraseElement_EventComponent, gen_ric_PhraseElement_InlineComponent, gen_ric_AccordionPanel_RichWidget, gen_ric_RichWidget_ClassifiableComponent, gen_ric_RichWidget_IdentifiableComponent, gen_ric_TabbedPanel_RichWidget, gen_ric_Datepicker_RichWidget, gen_ric_Datepicker_TextField, gen_ric_MessageDialog_RichWidget, gen_ric_NumberValueConstraint_FormControlConstraint, gen_ric_RequiredFieldConstraint_FormControlConstraint, gen_ric_ValidDateConstraint_FormControlConstraint, gen_ric_ValueConstraint_FormControlConstraint, gen_ric_Document_EventComponent, gen_ric_List_ClassifiableComponent, gen_ric_List_EventComponent, gen_ric_List_IdentifiableComponent, gen_ric_OrderedList_List, gen_ric_UnorderedList_List},
    metadata=None
)
