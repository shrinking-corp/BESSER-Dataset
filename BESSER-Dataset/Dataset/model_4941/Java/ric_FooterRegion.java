...
public class ric_FooterRegion  {
    ...
    public ric_FooterRegion(
        ArrayList<ric_LineBreak> ric_linebreaks,        ArrayList<ric_BlockLevelComponent> ric_blocklevelcomponents,        ArrayList<ric_RichWidget> ric_richwidgets,        ArrayList<ric_InlineComponent> ric_inlinecomponents,        ArrayList<ric_ObjectComponent> ric_objectcomponents    ) {
