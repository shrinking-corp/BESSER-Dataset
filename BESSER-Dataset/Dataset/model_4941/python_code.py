...
class ric_LinkGroup:
    ...
    def __init__(self, title: str, ric_LinkGroup: "ric_NavigationRegion" = None, ric_LinkGroup208: "ric_LinkGroup" = None, ric_LinkGroup206: set["ric_LinkGroup"] = None, ric_LinkGroup204: set["ric_Link"] = None):
        self.title = title
...
class ric_NavigationRegion:
    ...
    def __init__(self, orientation: str, ric_NavigationRegion116: "ric_HeaderRegion" = None, ric_NavigationRegion126: set["ric_LinkGroup"] = None, ric_NavigationRegion: "ric_Portal" = None):
...
class ric_Portal:
    ...
    def __init__(self, name: str, documentsExtension: str, ric_Portal105: "ric_ContextualNavigationRegion" = None, ric_Portal107: "ric_SearchRegion" = None, ric_Portal109: "ric_ContentRegion" = None, ric_Portal111: "ric_FooterRegion" = None, ric_Portal: "ric_HeaderRegion" = None, ric_Portal103: "ric_NavigationRegion" = None):
        self.name = name
...
class ric_Tab:
    ...
    def __init__(self, title: str, ric_Tab58: set["ric_InlineComponent"] = None, ric_Tab61: set["ric_BlockLevelComponent"] = None, ric_Tab64: set["ric_ObjectComponent"] = None, ric_Tab67: set["ric_LineBreak"] = None, ric_Tab70: set["ric_RichWidget"] = None, ric_Tab73: set["ric_List"] = None, ric_Tab76: set["ric_Form"] = None, ric_Tab: "ric_TabbedPanel" = None):
        self.title = title
...
class ric_MessageDialog(RichWidget):
    ...
    def __init__(self, autoOpen: bool, resizable: bool, height: int, minHeightResize: int, maxHeightResize: int, width: int, minWidthResize: int, maxWidthResize: int, title: str, message: str, modal: bool, ric_MessageDialog: set["ric_MessageDialogButton"] = None):
...
class ric_ObjectComponent(ABC):
    ...
    def __init__(self, align: str, width: int, height: int, border: int, hspace: int, vspace: int, ric_ObjectComponent: "ric_Div" = None, ric_ObjectComponent135: "ric_ContextualNavigationRegion" = None, ric_ObjectComponent162: "ric_Document" = None, ric_ObjectComponent65: "ric_Tab" = None, ric_ObjectComponent87: "ric_Section" = None, ric_ObjectComponent183: "ric_FooterRegion" = None):
        self.align = align
        self.width = width
        self.height = height
        self.border = border
...
class ric_InlineComponent(ABC):
    ...
    def __init__(self, text: str, ric_InlineComponent: "ric_Form" = None, ric_InlineComponent50: "ric_BlockLevelComponent" = None, ric_InlineComponent53: "ric_InlineComponent" = None, ric_InlineComponent51: set["ric_InlineComponent"] = None, ric_InlineComponent59: "ric_Tab" = None, ric_InlineComponent119: "ric_HeaderRegion" = None, ric_InlineComponent156: "ric_Document" = None, ric_InlineComponent129: "ric_ContextualNavigationRegion" = None, ric_InlineComponent81: "ric_Section" = None, ric_InlineComponent177: "ric_FooterRegion" = None):
        self.text = text
...
class ric_ValueConstraint(FormControlConstraint):
    ...
    def __init__(self, logicalOperator: str, matchingOperator: str, matchingValue: str, ric_ValueConstraint: "ric_FormControl" = None):
...
class IdentifiableComponent:
    ...
    pass
class ric_LineBreak(IdentifiableComponent, ClassifiableComponent):

    pass
class ric_Link(InlineComponent, IdentifiableComponent, EventComponent, ClassifiableComponent):
...
class ric_Label(IdentifiableComponent, ClassifiableComponent):

    def __init__(self, text: str, format: str, ric_Label23: set["ric_Event"] = None, ric_Label: "ric_FormControl" = None, ric_Label197: "ric_RadioGroup" = None, ric_Label202: "ric_CheckGroup" = None):
        self.text = text
        self.format = format
...
class ric_Paragraph(InlineComponent, IdentifiableComponent, EventComponent, ClassifiableComponent):
...
class ric_RichWidget(IdentifiableComponent, ClassifiableComponent):

    pass
class ric_Span(InlineComponent, IdentifiableComponent, EventComponent, ClassifiableComponent):
...
class ric_Form(IdentifiableComponent, EventComponent, ClassifiableComponent):

    def __init__(self, name: str, method: str, ric_Form: "ric_Document" = None, ric_Form16: set["ric_Fieldset"] = None, ric_Form18: set["ric_BlockLevelComponent"] = None, ric_Form20: set["ric_InlineComponent"] = None, ric_Form41: "ric_Div" = None, ric_Form147: "ric_ContextualNavigationRegion" = None, ric_Form150: "ric_SearchRegion" = None, ric_Form77: "ric_Tab" = None, ric_Form99: "ric_Section" = None, ric_Form174: "ric_Document" = None):
        self.name = name
        self.method = method
...
class ric_Heading(InlineComponent, IdentifiableComponent, EventComponent, ClassifiableComponent):
...
class ric_Image(ObjectComponent, IdentifiableComponent, EventComponent, ClassifiableComponent):
...
class ric_List(IdentifiableComponent, EventComponent, ClassifiableComponent):

    pass
class ric_PhraseElement(InlineComponent, IdentifiableComponent, EventComponent, ClassifiableComponent):
...
class ric_Div(ClassifiableComponent, IdentifiableComponent, EventComponent, BlockLevelComponent):
...
class ric_Fieldset(IdentifiableComponent, EventComponent, ClassifiableComponent):
...
class ric_FormControl(IdentifiableComponent, EventComponent, ClassifiableComponent):

    def __init__(self, name: str, value: str, ric_FormControl7: "ric_NumberValueConstraint" = None, ric_FormControl9: "ric_RequiredFieldConstraint" = None, ric_FormControl11: "ric_ValidDateConstraint" = None, ric_FormControl27: "ric_Fieldset" = None, ric_FormControl: "ric_Label" = None, ric_FormControl3: set["ric_PhraseElement"] = None, ric_FormControl5: set["ric_ValueConstraint"] = None):
        self.name = name
        self.value = value
...
class ric_Event:
    ...
    def __init__(self, type: str, ric_Event13: "ric_Script" = None, ric_Event24: "ric_Label" = None, ric_Event: "ric_EventComponent" = None):
        self.type = type
