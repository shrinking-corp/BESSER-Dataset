...
def test_simplepdl_ressourceset_is_not_abstract():
    assert not inspect.isabstract(simplepdl_RessourceSet)


def test_simplepdl_ressourceset_constructor_exists():
    assert callable(simplepdl_RessourceSet.__init__)


def test_simplepdl_ressourceset_constructor_args():
    sig = inspect.signature(simplepdl_RessourceSet.__init__)
    params = list(sig.parameters.keys())
    assert "name" in params, "Missing parameter 'name'"

def test_simplepdl_ressourceset_has_name():
    assert hasattr(simplepdl_RessourceSet, "name")
    descriptor = None
    for klass in simplepdl_RessourceSet.__mro__:
...
def test_simplepdl_ressourcelink_is_not_abstract():
    assert not inspect.isabstract(simplepdl_RessourceLink)


def test_simplepdl_ressourcelink_constructor_exists():
    assert callable(simplepdl_RessourceLink.__init__)


def test_simplepdl_ressourcelink_constructor_args():
    sig = inspect.signature(simplepdl_RessourceLink.__init__)
    params = list(sig.parameters.keys())
    assert "weight" in params, "Missing parameter 'weight'"

def test_simplepdl_ressourcelink_has_weight():
    assert hasattr(simplepdl_RessourceLink, "weight")
    descriptor = None
    for klass in simplepdl_RessourceLink.__mro__:
...
@given(instance=simplepdl_RessourceSet_strategy)
def test_simplepdl_ressourceset_name_setter(instance):
...
@given(instance=simplepdl_RessourceLink_strategy)
def test_simplepdl_ressourcelink_weight_setter(instance):
