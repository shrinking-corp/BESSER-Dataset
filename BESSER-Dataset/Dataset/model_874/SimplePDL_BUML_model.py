...
simplepdl_RessourceLink = Class(name="simplepdl_RessourceLink")
simplepdl_RessourceSet = Class(name="simplepdl_RessourceSet")
...
domain_model = DomainModel(
    name="simplepdl",
    types={simplepdl_Process, simplepdl_ProcessElement, simplepdl_WorkDefinition, ProcessElement, simplepdl_WorkSequence, simplepdl_Guidance, simplepdl_Ressource, simplepdl_RessourceLink, simplepdl_RessourceSet, WorkSequenceType},
    associations={processElements0, linksToPredecessors1, linksToSuccessors2, predecessor4, successor5, element7, ressource9, ressourceSet10, workDef12},
    generalizations={gen_simplepdl_WorkDefinition_ProcessElement, gen_simplepdl_WorkSequence_ProcessElement, gen_simplepdl_Guidance_ProcessElement, gen_simplepdl_Ressource_ProcessElement, gen_simplepdl_RessourceLink_ProcessElement, gen_simplepdl_RessourceSet_ProcessElement},
    metadata=None
)
