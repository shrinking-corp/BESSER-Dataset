...
Ant_Target.attributes={Ant_Target_description, Ant_Target_unless, Ant_Target_ifCondition, Ant_Target_name}
...
Ant_Mapper.attributes={Ant_Mapper_to, Ant_Mapper_classname, Ant_Mapper_classpathref, Ant_Mapper_classpath, Ant_Mapper_type, Ant_Mapper_from_}
...
Ant_InExcludes.attributes={Ant_InExcludes_name, Ant_InExcludes_ifCondition, Ant_InExcludes_unless}
...
Ant_Java.attributes={Ant_Java_classname, Ant_Java_fork, Ant_Java_jar}
...
Ant_FormatTstamp.attributes={Ant_FormatTstamp_locale, Ant_FormatTstamp_unit, Ant_FormatTstamp_pattern, Ant_FormatTstamp_property, Ant_FormatTstamp_offset}
...
Ant_Javac.attributes={Ant_Javac_srcdir, Ant_Javac_deprecation, Ant_Javac_fork, Ant_Javac_debug, Ant_Javac_optimize, Ant_Javac_destdir}
...
Ant_Javadoc.attributes={Ant_Javadoc_use, Ant_Javadoc_destdir, Ant_Javadoc_sourcepath, Ant_Javadoc_author, Ant_Javadoc_windowtitle, Ant_Javadoc_version, Ant_Javadoc_defaultexcludes, Ant_Javadoc_packagenames}
...
Ant_Jar.attributes={Ant_Jar_compress, Ant_Jar_jarfile, Ant_Jar_basedir, Ant_Jar_manifest, Ant_Jar_encoding}
...
Ant_Copy.attributes={Ant_Copy_tofile, Ant_Copy_includeEmptyDirs, Ant_Copy_presservelastmodified, Ant_Copy_todir, Ant_Copy_overwrite, Ant_Copy_filtering, Ant_Copy_flatten, Ant_Copy_file}
...
Ant_Delete.attributes={Ant_Delete_includes, Ant_Delete_verbose, Ant_Delete_failonerror, Ant_Delete_defaultexcludes, Ant_Delete_includesfile, Ant_Delete_file, Ant_Delete_excludesfile, Ant_Delete_excludes, Ant_Delete_includeEmptyDirs, Ant_Delete_quiet, Ant_Delete_dir}
...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={Ant_Project, Target, Path, Property_, TaskDef, Ant_Property, Ant_PropertyName, Ant_PropertyValue, PropertyName, Ant_PropertyLocation, Ant_PropertyFile, Ant_PropertyEnv, Ant_Target, Ant_Set, Task, Ant_Pattern, Ant_Basic, Pattern, Ant_Mapper, Basic, Ant_InExcludes, Ant_Includes, InExcludes, Ant_Excludes, Ant_IncludesFile, Ant_ExcludesFile, Ant_FileList, Ant_Filter, Ant_FiltersFile, Ant_PathElement, Ant_Task, Ant_PatternSet, Set, Ant_FileSet, PatternSet, Includes, Excludes, Ant_FilterSet, Filter, FiltersFile, Ant_Path, PathElement, FileSet, Ant_ClassPath, Ant_Tstamp, FormatTstamp, Ant_TaskDef, Ant_NewTask, Attribut, Ant_Attribut, Ant_PreDefinedTask, Ant_ExecutionTask, PreDefinedTask, Ant_Exec, ExecutionTask, Ant_Java, ClassPath, Ant_MiscellaneousTask, Ant_Echo, MiscellaneousTask, Ant_FormatTstamp, Ant_CompileTask, Ant_Javac, CompileTask, Ant_DocumentationTask, Ant_Javadoc, DocumentationTask, Ant_ArchiveTask, Ant_Jar, ArchiveTask, Ant_FileTask, Ant_Mkdir, FileTask, Ant_Copy, FilterSet, Mapper, Ant_Delete},
    associations={default0, path1, properties3, taskdef5, targets7, depends10, tasks12, fileset30, inexcludes13, patternset14, include15, exclude17, filter19, filtersfile20, path22, pathElement24, fileset26, pathElement28, format40, target33, taskName35, attributes37, classPath39, inExcludes41, classPath43, fileset46, filterset48, mapper50},
    generalizations={gen_Ant_PropertyName_Property, gen_Ant_PropertyValue_PropertyName, gen_Ant_PropertyLocation_PropertyName, gen_Ant_PropertyFile_Property, gen_Ant_PropertyEnv_Property, gen_Ant_Set_Pattern, gen_Ant_Basic_Pattern, gen_Ant_Mapper_Basic, gen_Ant_InExcludes_Basic, gen_Ant_Includes_InExcludes, gen_Ant_Excludes_InExcludes, gen_Ant_IncludesFile_InExcludes, gen_Ant_ExcludesFile_InExcludes, gen_Ant_FileList_Basic, gen_Ant_Filter_Basic, gen_Ant_FiltersFile_Basic, gen_Ant_PathElement_Basic, gen_Ant_PatternSet_Set, gen_Ant_FileSet_Set, gen_Ant_FilterSet_Set, gen_Ant_Path_Set, gen_Ant_ClassPath_Set, gen_Ant_Tstamp_MiscellaneousTask, gen_Ant_NewTask_Task, gen_Ant_PreDefinedTask_Task, gen_Ant_ExecutionTask_PreDefinedTask, gen_Ant_Exec_ExecutionTask, gen_Ant_Java_ExecutionTask, gen_Ant_MiscellaneousTask_PreDefinedTask, gen_Ant_Echo_MiscellaneousTask, gen_Ant_CompileTask_PreDefinedTask, gen_Ant_Javac_CompileTask, gen_Ant_DocumentationTask_PreDefinedTask, gen_Ant_Javadoc_DocumentationTask, gen_Ant_ArchiveTask_PreDefinedTask, gen_Ant_Jar_ArchiveTask, gen_Ant_FileTask_PreDefinedTask, gen_Ant_Mkdir_FileTask, gen_Ant_Copy_FileTask, gen_Ant_Delete_FileTask},
    metadata=None
)
