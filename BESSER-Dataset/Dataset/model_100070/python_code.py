...
class Ant_Javadoc(DocumentationTask):
    ...
    def __init__(self, defaultexcludes: str, author: str, sourcepath: str, destdir: str, packagenames: str, version: str, use: str, windowtitle: str):
...
class Ant_ClassPath(Set):
    ...
    def __init__(self, refid: str, Ant_ClassPath31: set["FileSet"] = None, Ant_ClassPath: set["PathElement"] = None):
        self.refid = refid
...
class Ant_Target:
    ...
    def __init__(self, description: str, unless: str, ifCondition: str, name: str, Ant_Target: set["Target"] = None, target: set["Task"] = None):
        self.description = description
        self.unless = unless
        self.ifCondition = ifCondition
        self.name = name
...
class Ant_Delete(FileTask):
    ...
    def __init__(self, failonerror: str, includeEmptyDirs: str, includes: str, file: str, dir: str, verbose: str, quiet: str, includesfile: str, excludes: str, excludesfile: str, defaultexcludes: str):
...
class Ant_Copy(FileTask):
    ...
    def __init__(self, file: str, presservelastmodified: str, tofile: str, todir: str, overwrite: str, filtering: str, flatten: str, includeEmptyDirs: str, Ant_Copy: "FileSet" = None, Ant_Copy49: "FilterSet" = None, Ant_Copy51: "Mapper" = None):
        self.file = file
