...
# Classes
gfsm_GInitialState = Class(name="gfsm_GInitialState")
InitialState = Class(name="InitialState")
gfsm_GFSM = Class(name="gfsm_GFSM")
FSM = Class(name="FSM")
gfsm_GTransition = Class(name="gfsm_GTransition")
Transition = Class(name="Transition")
gfsm_BooleanExpression = Class(name="gfsm_BooleanExpression")
gfsm_GState = Class(name="gfsm_GState")
State = Class(name="State")
gfsm_IntOperation = Class(name="gfsm_IntOperation")
gfsm_GFinalState = Class(name="gfsm_GFinalState")
...
domain_model = DomainModel(
    name="gfsm",
    types={gfsm_GInitialState, InitialState, gfsm_GFSM, FSM, gfsm_GTransition, Transition, gfsm_BooleanExpression, gfsm_GState, State, gfsm_IntOperation, gfsm_GFinalState, GState, FinalState},
    associations={guard0, inExpression1, outExpression2},
    generalizations={gen_gfsm_GInitialState_GState, gen_gfsm_GInitialState_InitialState, gen_gfsm_GFSM_FSM, gen_gfsm_GTransition_Transition, gen_gfsm_GState_State, gen_gfsm_GFinalState_GState, gen_gfsm_GFinalState_FinalState},
    metadata=None
)
