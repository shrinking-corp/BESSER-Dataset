...
# Classes
ddsMetamodel_DdsSubscriberListener = Class(name="ddsMetamodel_DdsSubscriberListener")
ddsMetamodel_DdsSubscriberQosProfile = Class(name="ddsMetamodel_DdsSubscriberQosProfile")
ddsMetamodel_DdsDataReaderListener = Class(name="ddsMetamodel_DdsDataReaderListener")
ddsMetamodel_DdsApplication = Class(name="ddsMetamodel_DdsApplication")
ddsMetamodel_DdsDomainParticipant = Class(name="ddsMetamodel_DdsDomainParticipant")
ddsMetamodel_DdsWaitSet = Class(name="ddsMetamodel_DdsWaitSet")
ddsMetamodel_DdsSubscriber = Class(name="ddsMetamodel_DdsSubscriber")
ddsMetamodel_DdsPublisher = Class(name="ddsMetamodel_DdsPublisher")
ddsMetamodel_DdsDomainParticipantQosProfile = Class(name="ddsMetamodel_DdsDomainParticipantQosProfile")
ddsMetamodel_DdsDomainParticipantListener = Class(name="ddsMetamodel_DdsDomainParticipantListener")
ddsMetamodel_DdsTopic = Class(name="ddsMetamodel_DdsTopic")
ddsMetamodel_DdsTopicListener = Class(name="ddsMetamodel_DdsTopicListener")
ddsMetamodel_DdsTopicQosProfile = Class(name="ddsMetamodel_DdsTopicQosProfile")
ddsMetamodel_DdsDataStructure = Class(name="ddsMetamodel_DdsDataStructure")
ddsMetamodel_DdsQosProfile = Class(name="ddsMetamodel_DdsQosProfile")
ddsMetamodel_DdsDataReader = Class(name="ddsMetamodel_DdsDataReader")
ddsMetamodel_DdsDataField = Class(name="ddsMetamodel_DdsDataField")
ddsMetamodel_DdsStructuredField = Class(name="ddsMetamodel_DdsStructuredField")
ddsMetamodel_DdsDataReaderQosProfile = Class(name="ddsMetamodel_DdsDataReaderQosProfile")
ddsMetamodel_DdsDataWriter = Class(name="ddsMetamodel_DdsDataWriter")
ddsMetamodel_DdsPublisherListener = Class(name="ddsMetamodel_DdsPublisherListener")
ddsMetamodel_DdsPublisherQosProfile = Class(name="ddsMetamodel_DdsPublisherQosProfile")
ddsMetamodel_DdsDataWriterListener = Class(name="ddsMetamodel_DdsDataWriterListener")
ddsMetamodel_DdsDataWriterQosProfile = Class(name="ddsMetamodel_DdsDataWriterQosProfile")
ddsMetamodel_DdsDataModule = Class(name="ddsMetamodel_DdsDataModule")
ddsMetamodel_DdsSystem = Class(name="ddsMetamodel_DdsSystem")
ddsMetamodel_DdsHistoryQos = Class(name="ddsMetamodel_DdsHistoryQos")
ddsMetamodel_DdsResourceLimits = Class(name="ddsMetamodel_DdsResourceLimits")
ddsMetamodel_DdsTransportPriorityQos = Class(name="ddsMetamodel_DdsTransportPriorityQos")
ddsMetamodel_DdsLifespan = Class(name="ddsMetamodel_DdsLifespan")
ddsMetamodel_DdsDeadlineQos = Class(name="ddsMetamodel_DdsDeadlineQos")
DdsQosProfile = Class(name="DdsQosProfile")
ddsMetamodel_DdsUserDataQos = Class(name="ddsMetamodel_DdsUserDataQos")
ddsMetamodel_DdsEntityFactoryQos = Class(name="ddsMetamodel_DdsEntityFactoryQos")
ddsMetamodel_DdsTopicDataQos = Class(name="ddsMetamodel_DdsTopicDataQos")
ddsMetamodel_DdsDurabilityQos = Class(name="ddsMetamodel_DdsDurabilityQos")
ddsMetamodel_DdsDurabilityServiceQos = Class(name="ddsMetamodel_DdsDurabilityServiceQos")
ddsMetamodel_DdsLatencyBudgetQos = Class(name="ddsMetamodel_DdsLatencyBudgetQos")
ddsMetamodel_DdsLivelinessQos = Class(name="ddsMetamodel_DdsLivelinessQos")
ddsMetamodel_DdsOwnershipQos = Class(name="ddsMetamodel_DdsOwnershipQos")
ddsMetamodel_DdsReliabilityQos = Class(name="ddsMetamodel_DdsReliabilityQos")
ddsMetamodel_DdsDestinationOrderQos = Class(name="ddsMetamodel_DdsDestinationOrderQos")
ddsMetamodel_DdsOwnershipStrengthQos = Class(name="ddsMetamodel_DdsOwnershipStrengthQos")
ddsMetamodel_DdsDuration = Class(name="ddsMetamodel_DdsDuration")
ddsMetamodel_DdsPresentationQos = Class(name="ddsMetamodel_DdsPresentationQos")
ddsMetamodel_DdsDataReaderLifecycleQos = Class(name="ddsMetamodel_DdsDataReaderLifecycleQos")
ddsMetamodel_DdsTimeBasedFilterQos = Class(name="ddsMetamodel_DdsTimeBasedFilterQos")
ddsMetamodel_DdsPartitionQos = Class(name="ddsMetamodel_DdsPartitionQos")
ddsMetamodel_DdsDataWriterLifecycleQos = Class(name="ddsMetamodel_DdsDataWriterLifecycleQos")
ddsMetamodel_DdsGroupDataQos = Class(name="ddsMetamodel_DdsGroupDataQos")
ddsMetamodel_DdsReadCondition = Class(name="ddsMetamodel_DdsReadCondition")
ddsMetamodel_DdsStatusCondition = Class(name="ddsMetamodel_DdsStatusCondition")
ddsMetamodel_GuardCondition = Class(name="ddsMetamodel_GuardCondition")
ddsMetamodel_DdsSubscriberStatusCondition = Class(name="ddsMetamodel_DdsSubscriberStatusCondition")
ddsMetamodel_DdsDataWriterStatusCondition = Class(name="ddsMetamodel_DdsDataWriterStatusCondition")
ddsMetamodel_DdsDomainParticipantStatusCondition = Class(name="ddsMetamodel_DdsDomainParticipantStatusCondition")
DdsStatusCondition = Class(name="DdsStatusCondition")
ddsMetamodel_DdsPublisherStatusCondition = Class(name="ddsMetamodel_DdsPublisherStatusCondition")
ddsMetamodel_DdsDataReaderStatusCondition = Class(name="ddsMetamodel_DdsDataReaderStatusCondition")
ddsMetamodel_DdsTopicStatusCondition = Class(name="ddsMetamodel_DdsTopicStatusCondition")
ddsMetamodel_QueryCondition = Class(name="ddsMetamodel_QueryCondition")
DdsReadCondition = Class(name="DdsReadCondition")
ddsMetamodel_DdsHost = Class(name="ddsMetamodel_DdsHost")
...
ddsMetamodel_DdsSubscriberListener.attributes={ddsMetamodel_DdsSubscriberListener_listenedStatus, ddsMetamodel_DdsSubscriberListener_name}
...
ddsMetamodel_DdsDataReaderListener.attributes={ddsMetamodel_DdsDataReaderListener_name, ddsMetamodel_DdsDataReaderListener_listenedStatus}
...
ddsMetamodel_DdsDomainParticipantListener.attributes={ddsMetamodel_DdsDomainParticipantListener_listenedStatus, ddsMetamodel_DdsDomainParticipantListener_name}
...
ddsMetamodel_DdsTopicListener.attributes={ddsMetamodel_DdsTopicListener_listenedStatus, ddsMetamodel_DdsTopicListener_name}
...
ddsMetamodel_DdsDataField.attributes={ddsMetamodel_DdsDataField_maxMultiplicity, ddsMetamodel_DdsDataField_isKey, ddsMetamodel_DdsDataField_fieldType, ddsMetamodel_DdsDataField_fieldName}
...
ddsMetamodel_DdsStructuredField.attributes={ddsMetamodel_DdsStructuredField_fieldName, ddsMetamodel_DdsStructuredField_maxMultiplicity, ddsMetamodel_DdsStructuredField_isKey}
...
ddsMetamodel_DdsHistoryQos.attributes={ddsMetamodel_DdsHistoryQos_kind, ddsMetamodel_DdsHistoryQos_depth}
...
ddsMetamodel_DdsResourceLimits.attributes={ddsMetamodel_DdsResourceLimits_max_samples_per_instances, ddsMetamodel_DdsResourceLimits_max_samples, ddsMetamodel_DdsResourceLimits_max_instances}
...
ddsMetamodel_DdsDurabilityServiceQos.attributes={ddsMetamodel_DdsDurabilityServiceQos_history_depth, ddsMetamodel_DdsDurabilityServiceQos_max_samples_per_instances, ddsMetamodel_DdsDurabilityServiceQos_history_kind, ddsMetamodel_DdsDurabilityServiceQos_max_samples, ddsMetamodel_DdsDurabilityServiceQos_max_instances}
...
ddsMetamodel_DdsPresentationQos.attributes={ddsMetamodel_DdsPresentationQos_coherent_access, ddsMetamodel_DdsPresentationQos_access_scope, ddsMetamodel_DdsPresentationQos_ordered_access}
...
ddsMetamodel_DdsDataReaderLifecycleQos.attributes={ddsMetamodel_DdsDataReaderLifecycleQos_autopurge_dispose_all, ddsMetamodel_DdsDataReaderLifecycleQos_enable_invalid_samples}
...
ddsMetamodel_QueryCondition.attributes={ddsMetamodel_QueryCondition_query, ddsMetamodel_QueryCondition_queryParameters}
...
domain_model = DomainModel(
    name="ddsMetamodel",
    types={ddsMetamodel_DdsSubscriberListener, ddsMetamodel_DdsSubscriberQosProfile, ddsMetamodel_DdsDataReaderListener, ddsMetamodel_DdsApplication, ddsMetamodel_DdsDomainParticipant, ddsMetamodel_DdsWaitSet, ddsMetamodel_DdsSubscriber, ddsMetamodel_DdsPublisher, ddsMetamodel_DdsDomainParticipantQosProfile, ddsMetamodel_DdsDomainParticipantListener, ddsMetamodel_DdsTopic, ddsMetamodel_DdsTopicListener, ddsMetamodel_DdsTopicQosProfile, ddsMetamodel_DdsDataStructure, ddsMetamodel_DdsQosProfile, ddsMetamodel_DdsDataReader, ddsMetamodel_DdsDataField, ddsMetamodel_DdsStructuredField, ddsMetamodel_DdsDataReaderQosProfile, ddsMetamodel_DdsDataWriter, ddsMetamodel_DdsPublisherListener, ddsMetamodel_DdsPublisherQosProfile, ddsMetamodel_DdsDataWriterListener, ddsMetamodel_DdsDataWriterQosProfile, ddsMetamodel_DdsDataModule, ddsMetamodel_DdsSystem, ddsMetamodel_DdsHistoryQos, ddsMetamodel_DdsResourceLimits, ddsMetamodel_DdsTransportPriorityQos, ddsMetamodel_DdsLifespan, ddsMetamodel_DdsDeadlineQos, DdsQosProfile, ddsMetamodel_DdsUserDataQos, ddsMetamodel_DdsEntityFactoryQos, ddsMetamodel_DdsTopicDataQos, ddsMetamodel_DdsDurabilityQos, ddsMetamodel_DdsDurabilityServiceQos, ddsMetamodel_DdsLatencyBudgetQos, ddsMetamodel_DdsLivelinessQos, ddsMetamodel_DdsOwnershipQos, ddsMetamodel_DdsReliabilityQos, ddsMetamodel_DdsDestinationOrderQos, ddsMetamodel_DdsOwnershipStrengthQos, ddsMetamodel_DdsDuration, ddsMetamodel_DdsPresentationQos, ddsMetamodel_DdsDataReaderLifecycleQos, ddsMetamodel_DdsTimeBasedFilterQos, ddsMetamodel_DdsPartitionQos, ddsMetamodel_DdsDataWriterLifecycleQos, ddsMetamodel_DdsGroupDataQos, ddsMetamodel_DdsReadCondition, ddsMetamodel_DdsStatusCondition, ddsMetamodel_GuardCondition, ddsMetamodel_DdsSubscriberStatusCondition, ddsMetamodel_DdsDataWriterStatusCondition, ddsMetamodel_DdsDomainParticipantStatusCondition, DdsStatusCondition, ddsMetamodel_DdsPublisherStatusCondition, ddsMetamodel_DdsDataReaderStatusCondition, ddsMetamodel_DdsTopicStatusCondition, ddsMetamodel_QueryCondition, DdsReadCondition, ddsMetamodel_DdsHost, OwnershipQosPolicyKind, LivelinessQosPolicyKind, DurabilityQosPolicyKind, HistoryQosPolicyKind, PresentationQosPolicyAccessScopeKind, ReliabilityQosPolicyKind, DestinationOrderQosPolicyKind, InvalidSampleVisibilityQosPolicy, DomainParticipantStatus, ViewStateKind, InstanceStateKind, SampleStateKind, SubscriberStatus, PublisherStatus, DataWriterStatus, DataReaderStatus, TopicStatus},
    associations={subscriberListener17, subscriberQosProfile19, readableTopic21, dataReaderListener23, domainParticipants0, waitset1, ddssubscriber3, ddspublisher5, ddsdomainparticipantqosprofile7, domainParticipantListener9, topicListener11, topicQosProfile12, ddsdatastructure14, ddsdatareader16, containingModule46, fields48, structuredFields50, dataReaderQosProfile25, containingSubscriber27, ddsdatawriter28, publisherListener30, publisherQosProfile32, publiableTopic34, dataWriterListener37, dataWriterQosProfile39, dataStructures41, innerModules43, containingSystem44, historyQos73, resourceLimitsQos75, transportPriorityQos77, lifespanQos79, containerDataModule51, userDataQos53, entityFactoryQos55, topicDataQos57, durabilityQos59, durabilityServiceQos61, latencyBudgetQos63, livelinessQos65, ownershipQos67, reliabilityQos69, destinationOrderQos71, deadlineQos81, service_cleanup_delay83, period85, duration88, autopurge_suspended_samples_delay102, autounregister_instance_delay104, autopurge_nowriters_samples_delay107, autopurge_disposed_samples_delay109, lease_duration91, minimum_separation94, max_blocking_time96, duration99, transportPriorityQos144, lifespanQos147, destinationOrderQos150, historyQos153, resourceLimitsQos156, groupDataQos112, entityFactoryQos114, presentationQos117, partitionQos119, userDataQos121, durabilityQos124, deadlineQos127, latencyBudgetQos130, ownershipQos133, ownershipStrength136, livelinessQos138, reliabilityQos141, dataWriterLifecycleQos159, groupDataQos162, entityFactoryQos165, presentationQos168, partitionQos171, userDataQos174, durabilityQos177, deadlineQos180, latencyBudgetQos183, livelinessQos186, ownershipQos189, timeBasedFilterQos192, reliabilityQos195, destinationOrderQos198, historyQos201, resourceLimitsQos204, dataReaderLifecycleQos207, dataStructure220, readConditions210, statusConditions212, guardConditions213, dataReader215, referencedType218, publisher225, subscriber227, containingWaitset222, domainParticipant223, dataWriter229, dataReader231, topic233, hosts235, qosProfiles236, dataModules238, topics240, applications243},
    generalizations={gen_ddsMetamodel_DdsDomainParticipantQosProfile_DdsQosProfile, gen_ddsMetamodel_DdsTopicQosProfile_DdsQosProfile, gen_ddsMetamodel_DdsPublisherQosProfile_DdsQosProfile, gen_ddsMetamodel_DdsDataWriterQosProfile_DdsQosProfile, gen_ddsMetamodel_DdsSubscriberQosProfile_DdsQosProfile, gen_ddsMetamodel_DdsDataReaderQosProfile_DdsQosProfile, gen_ddsMetamodel_DdsSubscriberStatusCondition_DdsStatusCondition, gen_ddsMetamodel_DdsDataWriterStatusCondition_DdsStatusCondition, gen_ddsMetamodel_DdsDomainParticipantStatusCondition_DdsStatusCondition, gen_ddsMetamodel_DdsPublisherStatusCondition_DdsStatusCondition, gen_ddsMetamodel_DdsDataReaderStatusCondition_DdsStatusCondition, gen_ddsMetamodel_DdsTopicStatusCondition_DdsStatusCondition, gen_ddsMetamodel_QueryCondition_DdsReadCondition},
    metadata=None
)
