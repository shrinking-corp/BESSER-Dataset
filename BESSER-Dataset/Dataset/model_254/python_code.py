...
class ecore_EAnnotation(EModelElement):
    ...
    def __init__(self, source: str, eAnnotations: "ecore_EModelElement" = None, ecore_EAnnotation4: set["ecore_EObject"] = None, ecore_EAnnotation6: set["ecore_EObject"] = None, EAnnotation: "ecore_EModelElement" = None, ecore_EAnnotation: set["ecore_EStringToStringMapEntry"] = None):
        self.source = source
