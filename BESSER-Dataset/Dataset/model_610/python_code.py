...
class mvc_View(Annotable):
    ...
    def __init__(self, name: str, mvc_View: "mvc_UIComponent" = None, mvc_View24: "mvc_MVCModel" = None, mvc_View49: "mvc_ControllerView" = None):
        self.name = name
...
class mvc_Entity(Annotable):
    ...
    def __init__(self, name: str, mvc_Entity4: set["mvc_Attribute"] = None, mvc_Entity: "mvc_Model" = None, mvc_Entity7: "mvc_Entity" = None, mvc_Entity5: set["mvc_Entity"] = None, mvc_Entity10: "mvc_Association" = None, mvc_Entity13: "mvc_Association" = None):
        self.name = name
...
class mvc_Action(Annotable):
    ...
    def __init__(self, name: str, mvc_Action39: "mvc_Event" = None, mvc_Action42: "mvc_Event" = None, mvc_Action45: set["mvc_Event"] = None, mvc_Action58: "mvc_EventAction" = None, mvc_Action: "mvc_Controller" = None):
        self.name = name
...
class mvc_Controller(Annotable):
    ...
    def __init__(self, name: str, mvc_Controller: "mvc_MVCModel" = None, mvc_Controller37: set["mvc_EventAction"] = None, mvc_Controller55: "mvc_Component" = None, mvc_Controller33: set["mvc_Action"] = None, mvc_Controller35: set["mvc_ControllerView"] = None):
        self.name = name
...
class mvc_UIComponent(Annotable):
    ...
    def __init__(self, layout: str, id: str, name: str, type: str, mvc_UIComponent: "mvc_View" = None, mvc_UIComponent19: set["mvc_Event"] = None, mvc_UIComponent17: "mvc_UIComponent" = None, mvc_UIComponent15: set["mvc_UIComponent"] = None):
        self.layout = layout
        self.id = id
        self.name = name
        self.type = type
