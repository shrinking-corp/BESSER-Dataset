...
mvc_UIComponent = Class(name="mvc_UIComponent")
...
mvc_Association.attributes={mvc_Association_containment, mvc_Association_upperBound, mvc_Association_lowerBound, mvc_Association_type, mvc_Association_name}
...
mvc_UIComponent.attributes={mvc_UIComponent_id, mvc_UIComponent_type, mvc_UIComponent_name, mvc_UIComponent_layout}
...
domain_model = DomainModel(
    name="mvc",
    types={mvc_Model, Annotable, mvc_Entity, mvc_Association, mvc_View, mvc_UIComponent, mvc_Attribute, mvc_Event, mvc_MVCModel, mvc_Controller, mvc_Component, mvc_Action, mvc_ControllerView, mvc_EventAction, AssociationType},
    associations={rootEntity0, associations1, extends6, source8, target11, rootComponent14, attributes3, events18, models20, views22, events25, controllers28, components30, childs16, eventActions36, preExecutionEvent38, postExecutionEvent41, triggerEvents44, view47, models50, controllers53, action56, events59, actions32, views34},
    generalizations={gen_mvc_Model_Annotable, gen_mvc_Entity_Annotable, gen_mvc_Attribute_Annotable, gen_mvc_Association_Annotable, gen_mvc_View_Annotable, gen_mvc_UIComponent_Annotable, gen_mvc_MVCModel_Annotable, gen_mvc_Controller_Annotable, gen_mvc_Event_Annotable, gen_mvc_Action_Annotable, gen_mvc_ControllerView_Annotable, gen_mvc_Component_Annotable, gen_mvc_EventAction_Annotable},
    metadata=None
)
