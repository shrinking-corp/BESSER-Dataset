...
# Classes
dsl_CompilationUnit = Class(name="dsl_CompilationUnit")
dsl_PackageDeclaration = Class(name="dsl_PackageDeclaration")
dsl_ImportDeclaration = Class(name="dsl_ImportDeclaration")
dsl_TypeDeclaration = Class(name="dsl_TypeDeclaration")
dsl_Name = Class(name="dsl_Name")
dsl_CommonModifier = Class(name="dsl_CommonModifier")
dsl_TypeBodyModifier = Class(name="dsl_TypeBodyModifier")
dsl_ClassOrInterfaceDeclaration = Class(name="dsl_ClassOrInterfaceDeclaration")
dsl_EnumDeclaration = Class(name="dsl_EnumDeclaration")
dsl_AnnotationTypeDeclaration = Class(name="dsl_AnnotationTypeDeclaration")
dsl_TypeParameters = Class(name="dsl_TypeParameters")
dsl_ExtendsList = Class(name="dsl_ExtendsList")
dsl_ImplementsList = Class(name="dsl_ImplementsList")
dsl_ClassOrInterfaceBody = Class(name="dsl_ClassOrInterfaceBody")
dsl_ClassOrInterfaceType = Class(name="dsl_ClassOrInterfaceType")
dsl_EnumBody = Class(name="dsl_EnumBody")
dsl_EnumConstant = Class(name="dsl_EnumConstant")
dsl_ClassOrInterfaceBodyDeclaration = Class(name="dsl_ClassOrInterfaceBodyDeclaration")
dsl_Arguments = Class(name="dsl_Arguments")
dsl_TypeParameter = Class(name="dsl_TypeParameter")
dsl_TypeBound = Class(name="dsl_TypeBound")
dsl_Initializer = Class(name="dsl_Initializer")
dsl_MethodOrCtorDeclaration = Class(name="dsl_MethodOrCtorDeclaration")
dsl_FieldDeclaration = Class(name="dsl_FieldDeclaration")
dsl_Type = Class(name="dsl_Type")
dsl_VariableInitializer = Class(name="dsl_VariableInitializer")
dsl_ArrayInitializer = Class(name="dsl_ArrayInitializer")
dsl_Expression = Class(name="dsl_Expression")
dsl_FormalParameters = Class(name="dsl_FormalParameters")
dsl_NameList = Class(name="dsl_NameList")
dsl_ExplicitConstructorInvocation = Class(name="dsl_ExplicitConstructorInvocation")
dsl_BlockStatement = Class(name="dsl_BlockStatement")
dsl_ResultType = Class(name="dsl_ResultType")
dsl_MethodDeclarator = Class(name="dsl_MethodDeclarator")
dsl_Block = Class(name="dsl_Block")
dsl_FormalParameter = Class(name="dsl_FormalParameter")
dsl_VariableDeclarator = Class(name="dsl_VariableDeclarator")
dsl_VariableDeclaratorId = Class(name="dsl_VariableDeclaratorId")
dsl_PrimaryExpression = Class(name="dsl_PrimaryExpression")
dsl_ReferenceType = Class(name="dsl_ReferenceType")
dsl_TypeArguments = Class(name="dsl_TypeArguments")
dsl_TypeArgument = Class(name="dsl_TypeArgument")
dsl_WildcardBounds = Class(name="dsl_WildcardBounds")
dsl_ConditionalExpression = Class(name="dsl_ConditionalExpression")
dsl_Statement = Class(name="dsl_Statement")
dsl_ConditionalOrExpression = Class(name="dsl_ConditionalOrExpression")
IfStatement = Class(name="IfStatement")
dsl_ConditionalAndExpression = Class(name="dsl_ConditionalAndExpression")
dsl_InclusiveOrExpression = Class(name="dsl_InclusiveOrExpression")
dsl_ExclusiveOrExpression = Class(name="dsl_ExclusiveOrExpression")
dsl_AndExpression = Class(name="dsl_AndExpression")
dsl_EqualityExpression = Class(name="dsl_EqualityExpression")
dsl_InstanceOfExpression = Class(name="dsl_InstanceOfExpression")
dsl_RelationalExpression = Class(name="dsl_RelationalExpression")
dsl_ShiftExpression = Class(name="dsl_ShiftExpression")
dsl_AdditiveExpression = Class(name="dsl_AdditiveExpression")
dsl_MultiplicativeExpression = Class(name="dsl_MultiplicativeExpression")
dsl_UnaryExpression = Class(name="dsl_UnaryExpression")
dsl_UnaryExpressionNotPlusMinus = Class(name="dsl_UnaryExpressionNotPlusMinus")
dsl_CastExpression = Class(name="dsl_CastExpression")
dsl_PostfixExpression = Class(name="dsl_PostfixExpression")
dsl_CastLookahead = Class(name="dsl_CastLookahead")
dsl_Literal = Class(name="dsl_Literal")
dsl_EObject = Class(name="dsl_EObject")
dsl_PreIncrementExpression = Class(name="dsl_PreIncrementExpression")
dsl_PreDecrementExpression = Class(name="dsl_PreDecrementExpression")
dsl_PrimaryPrefix = Class(name="dsl_PrimaryPrefix")
dsl_AllocationExpression = Class(name="dsl_AllocationExpression")
dsl_PrimarySuffix = Class(name="dsl_PrimarySuffix")
dsl_DecimalNumber = Class(name="dsl_DecimalNumber")
dsl_MemberSelector = Class(name="dsl_MemberSelector")
dsl_UnsignedIntLiteral = Class(name="dsl_UnsignedIntLiteral")
dsl_SignedIntLiteral = Class(name="dsl_SignedIntLiteral")
dsl_IntegerLiteral = Class(name="dsl_IntegerLiteral")
dsl_FloatLiteral = Class(name="dsl_FloatLiteral")
dsl_BooleanLiteral = Class(name="dsl_BooleanLiteral")
dsl_ArgumentList = Class(name="dsl_ArgumentList")
dsl_BaseLiteral = Class(name="dsl_BaseLiteral")
dsl_ArrayDimsAndInits = Class(name="dsl_ArrayDimsAndInits")
dsl_LabeledStatement = Class(name="dsl_LabeledStatement")
dsl_AssertStatement = Class(name="dsl_AssertStatement")
dsl_StatementExpression = Class(name="dsl_StatementExpression")
dsl_SwitchStatement = Class(name="dsl_SwitchStatement")
dsl_IfStatement = Class(name="dsl_IfStatement")
dsl_WhileStatement = Class(name="dsl_WhileStatement")
dsl_DoStatement = Class(name="dsl_DoStatement")
dsl_ForStatement = Class(name="dsl_ForStatement")
dsl_BreakStatement = Class(name="dsl_BreakStatement")
dsl_ContinueStatement = Class(name="dsl_ContinueStatement")
dsl_ReturnStatement = Class(name="dsl_ReturnStatement")
dsl_ThrowStatement = Class(name="dsl_ThrowStatement")
dsl_SynchronizedStatement = Class(name="dsl_SynchronizedStatement")
dsl_TryStatement = Class(name="dsl_TryStatement")
dsl_LocalVariableDeclaration = Class(name="dsl_LocalVariableDeclaration")
dsl_SwitchLabel = Class(name="dsl_SwitchLabel")
dsl_ForInit = Class(name="dsl_ForInit")
dsl_ForUpdate = Class(name="dsl_ForUpdate")
dsl_StatementExpressionList = Class(name="dsl_StatementExpressionList")
dsl_Annotation = Class(name="dsl_Annotation")
dsl_MemberValuePairs = Class(name="dsl_MemberValuePairs")
dsl_MemberValue = Class(name="dsl_MemberValue")
dsl_MemberValuePair = Class(name="dsl_MemberValuePair")
DefaultValue = Class(name="DefaultValue")
dsl_MemberValueArrayInitializer = Class(name="dsl_MemberValueArrayInitializer")
dsl_AnnotationTypeBody = Class(name="dsl_AnnotationTypeBody")
dsl_AnnotationTypeMemberDeclaration = Class(name="dsl_AnnotationTypeMemberDeclaration")
dsl_DefaultValue = Class(name="dsl_DefaultValue")
...
dsl_CommonModifier.attributes={dsl_CommonModifier_final, dsl_CommonModifier_visibility, dsl_CommonModifier_abstract, dsl_CommonModifier_static}
...
dsl_TypeBodyModifier.attributes={dsl_TypeBodyModifier_volatile, dsl_TypeBodyModifier_transient, dsl_TypeBodyModifier_strictfp, dsl_TypeBodyModifier_native, dsl_TypeBodyModifier_synchronized}
...
dsl_ExplicitConstructorInvocation.attributes={dsl_ExplicitConstructorInvocation_parent, dsl_ExplicitConstructorInvocation_self}
...
dsl_MethodDeclarator.attributes={dsl_MethodDeclarator_squareBrackets, dsl_MethodDeclarator_id}
...
dsl_WildcardBounds.attributes={dsl_WildcardBounds_ext, dsl_WildcardBounds_sup}
...
dsl_CastLookahead.attributes={dsl_CastLookahead_bitNegOp, dsl_CastLookahead_thisOp, dsl_CastLookahead_id, dsl_CastLookahead_negOp, dsl_CastLookahead_superOp, dsl_CastLookahead_openBracket, dsl_CastLookahead_primType, dsl_CastLookahead_newOp}
...
dsl_Literal.attributes={dsl_Literal_stringLit, dsl_Literal_nullLit, dsl_Literal_charLit}
...
dsl_PrimarySuffix.attributes={dsl_PrimarySuffix_id, dsl_PrimarySuffix_thisOp}
...
dsl_DecimalNumber.attributes={dsl_DecimalNumber_decDigits, dsl_DecimalNumber_decDigitsUnderscore}
...
dsl_BaseLiteral.attributes={dsl_BaseLiteral_hexDigitsUnderscore, dsl_BaseLiteral_decDigitsUnderscore, dsl_BaseLiteral_binDigitsUnderscore}
...
dsl_StatementExpression.attributes={dsl_StatementExpression_assignOp, dsl_StatementExpression_minOp, dsl_StatementExpression_plusOp}
...
domain_model = DomainModel(
    name="dsl",
    types={dsl_CompilationUnit, dsl_PackageDeclaration, dsl_ImportDeclaration, dsl_TypeDeclaration, dsl_Name, dsl_CommonModifier, dsl_TypeBodyModifier, dsl_ClassOrInterfaceDeclaration, dsl_EnumDeclaration, dsl_AnnotationTypeDeclaration, dsl_TypeParameters, dsl_ExtendsList, dsl_ImplementsList, dsl_ClassOrInterfaceBody, dsl_ClassOrInterfaceType, dsl_EnumBody, dsl_EnumConstant, dsl_ClassOrInterfaceBodyDeclaration, dsl_Arguments, dsl_TypeParameter, dsl_TypeBound, dsl_Initializer, dsl_MethodOrCtorDeclaration, dsl_FieldDeclaration, dsl_Type, dsl_VariableInitializer, dsl_ArrayInitializer, dsl_Expression, dsl_FormalParameters, dsl_NameList, dsl_ExplicitConstructorInvocation, dsl_BlockStatement, dsl_ResultType, dsl_MethodDeclarator, dsl_Block, dsl_FormalParameter, dsl_VariableDeclarator, dsl_VariableDeclaratorId, dsl_PrimaryExpression, dsl_ReferenceType, dsl_TypeArguments, dsl_TypeArgument, dsl_WildcardBounds, dsl_ConditionalExpression, dsl_Statement, dsl_ConditionalOrExpression, IfStatement, dsl_ConditionalAndExpression, dsl_InclusiveOrExpression, dsl_ExclusiveOrExpression, dsl_AndExpression, dsl_EqualityExpression, dsl_InstanceOfExpression, dsl_RelationalExpression, dsl_ShiftExpression, dsl_AdditiveExpression, dsl_MultiplicativeExpression, dsl_UnaryExpression, dsl_UnaryExpressionNotPlusMinus, dsl_CastExpression, dsl_PostfixExpression, dsl_CastLookahead, dsl_Literal, dsl_EObject, dsl_PreIncrementExpression, dsl_PreDecrementExpression, dsl_PrimaryPrefix, dsl_AllocationExpression, dsl_PrimarySuffix, dsl_DecimalNumber, dsl_MemberSelector, dsl_UnsignedIntLiteral, dsl_SignedIntLiteral, dsl_IntegerLiteral, dsl_FloatLiteral, dsl_BooleanLiteral, dsl_ArgumentList, dsl_BaseLiteral, dsl_ArrayDimsAndInits, dsl_LabeledStatement, dsl_AssertStatement, dsl_StatementExpression, dsl_SwitchStatement, dsl_IfStatement, dsl_WhileStatement, dsl_DoStatement, dsl_ForStatement, dsl_BreakStatement, dsl_ContinueStatement, dsl_ReturnStatement, dsl_ThrowStatement, dsl_SynchronizedStatement, dsl_TryStatement, dsl_LocalVariableDeclaration, dsl_SwitchLabel, dsl_ForInit, dsl_ForUpdate, dsl_StatementExpressionList, dsl_Annotation, dsl_MemberValuePairs, dsl_MemberValue, dsl_MemberValuePair, DefaultValue, dsl_MemberValueArrayInitializer, dsl_AnnotationTypeBody, dsl_AnnotationTypeMemberDeclaration, dsl_DefaultValue, Visibility},
    associations={packageDecl0, importDecls1, typeDecls3, name5, mod10, mod11, classInterfDecl14, enumDecl16, annotDecl18, typeParams20, exts22, impls24, body26, exts28, impls30, name7, impls36, body39, constants41, bodies43, args45, body47, typeParams50, type52, typeKind54, body57, init60, mods62, nestedClassEnumType65, enumDecl68, ctorOrMethod71, field73, type75, typeKind33, varDeclId79, varInit81, arrayInit83, expr85, varInit87, typeParams90, formalParams93, throwsList95, ctorInvoc97, statements99, resultType101, methodDecl103, block105, formalParams107, params110, varDecl77, varDeclId115, args118, expr121, block123, refType126, typeKind128, typeArgs131, typeArgs133, refType135, wildCard138, refType140, type143, type112, condExpr149, expr152, ifSt154, elseSt156, expr159, exprAlpha161, names146, expr167, expr169, expr171, expr173, expr175, expr177, expr179, type181, expr184, expr186, expr188, expr190, unaryExpr193, exprBeta164, unaryExpNeg199, expr201, expr204, unaryExpr207, castExpr210, postfixExpr212, indexerType214, castType216, literal219, expr221, castType224, expr227, suffixes229, preIncrExpr195, preDecrExpr197, args232, literal234, expr236, allocExpr239, resultType241, name244, allocExpr247, selector249, bracketExpr252, args255, decNum258, literal259, baseLiteral261, signedLiteral263, unsignedLiteral265, decNumAlpha268, decNumBeta270, intLit273, floatLit276, boolLit279, args281, arrayInits286, nonPrimType288, typeArgs291, args294, body297, expr300, arrayInit303, labeledSt306, assertSt308, block310, expr313, switchSt315, ifSt317, expr283, doSt321, forSt323, breakSt325, continueSt327, returnSt329, throwSt331, synchSt333, trySt335, exprAlpha337, exprBeta340, st343, blockSt346, localVarDecl349, whileSt319, typeDecl354, type357, varDecls360, preIncrExpr363, preDecrExpr366, primaryExpr369, expr372, expr375, switchLabel378, block380, expr383, expr386, st389, st392, st351, expr395, type398, expr401, forInit404, forExpr406, forUpdate409, st411, decl414, st417, expr419, list422, expr425, expr428, expr431, block434, block437, finalBlock443, name446, valuePairs448, value450, pairs452, value454, annot457, init460, condExpr462, values465, body468, decls470, mods472, type475, defaultVal478, typeDecl480, params440, annotDecl486, fieldDecl489, enumDecl483},
