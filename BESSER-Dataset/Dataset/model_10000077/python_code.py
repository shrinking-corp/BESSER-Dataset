...
class Product:
    ...
    def __init__(self, photoPath: str, id: int, name: str, description: str, price: int, offer12: set["Offer"] = None, category15: "Category" = None, store17: "Store" = None):
        self.photoPath = photoPath
        self.id = id
        self.name = name
...
class Store:
    ...
    def __init__(self, id: int, name: str, photoPath: str, address6: "Address" = None, seller9: "Seller" = None, product16: set["Product"] = None):
        self.id = id
        self.name = name
        self.photoPath = photoPath
...
class Position:
    ...
    def __init__(self, longitude: str, latitude: str, createdAt: str, id: int, buyer3: "Buyer" = None, address5: "Address" = None):
