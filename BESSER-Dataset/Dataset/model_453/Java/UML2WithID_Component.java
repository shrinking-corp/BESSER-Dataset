...
public class UML2WithID_Component extends Class {
    ...
    public UML2WithID_Component(
        boolean isIndirectlyInstantiated        ArrayList<UML2WithID_Interface> uml2withid_interfaces,        ArrayList<UML2WithID_PackageableElement> uml2withid_packageableelements,        ArrayList<UML2WithID_Interface> uml2withid_interfaces    ) {
        this.isIndirectlyInstantiated = isIndirectlyInstantiated;
