...
public class UML2WithID_Port extends Property {
    ...
    public UML2WithID_Port(
        boolean isBehavior,        boolean isService        ArrayList<UML2WithID_Port> uml2withid_ports,        ArrayList<UML2WithID_Interface> uml2withid_interfaces,        ArrayList<UML2WithID_Interface> uml2withid_interfaces    ) {
        this.isBehavior = isBehavior;
        this.isService = isService;
