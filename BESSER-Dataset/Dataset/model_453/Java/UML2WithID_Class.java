...
public class UML2WithID_Class extends BehavioredClassifier, EncapsulatedClassifier {
    ...
    public UML2WithID_Class(
        boolean isActive        ArrayList<UML2WithID_Class> uml2withid_classs,        ArrayList<UML2WithID_Reception> uml2withid_receptions,        ArrayList<UML2WithID_Operation> uml2withid_operations,        ArrayList<UML2WithID_Classifier> uml2withid_classifiers,        ArrayList<UML2WithID_Extension> uml2withid_extensions    ) {
        this.isActive = isActive;
