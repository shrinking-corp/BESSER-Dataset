...
# Classes
UML2WithID_Comment = Class(name="UML2WithID_Comment")
UML2WithID_MultiplicityElement = Class(name="UML2WithID_MultiplicityElement", is_abstract=True)
Element = Class(name="Element")
UML2WithID_ValueSpecification = Class(name="UML2WithID_ValueSpecification", is_abstract=True)
UML2WithID_Element = Class(name="UML2WithID_Element", is_abstract=True)
UML2WithID_OpaqueExpression = Class(name="UML2WithID_OpaqueExpression")
ValueSpecification = Class(name="ValueSpecification")
UML2WithID_Parameter = Class(name="UML2WithID_Parameter")
UML2WithID_Behavior = Class(name="UML2WithID_Behavior", is_abstract=True)
TypedElement = Class(name="TypedElement")
ParameterableElement = Class(name="ParameterableElement")
UML2WithID_Expression = Class(name="UML2WithID_Expression")
OpaqueExpression = Class(name="OpaqueExpression")
UML2WithID_NamedElement = Class(name="UML2WithID_NamedElement", is_abstract=True)
TemplateableElement = Class(name="TemplateableElement")
UML2WithID_Dependency = Class(name="UML2WithID_Dependency")
UML2WithID_StringExpression = Class(name="UML2WithID_StringExpression")
UML2WithID_Namespace = Class(name="UML2WithID_Namespace", is_abstract=True)
NamedElement = Class(name="NamedElement")
UML2WithID_Constraint = Class(name="UML2WithID_Constraint")
UML2WithID_PackageableElement = Class(name="UML2WithID_PackageableElement", is_abstract=True)
UML2WithID_ElementImport = Class(name="UML2WithID_ElementImport")
UML2WithID_PackageImport = Class(name="UML2WithID_PackageImport")
UML2WithID_Extension = Class(name="UML2WithID_Extension")
UML2WithID_Classifier = Class(name="UML2WithID_Classifier", is_abstract=True)
UML2WithID_Reception = Class(name="UML2WithID_Reception")
UML2WithID_Type = Class(name="UML2WithID_Type", is_abstract=True)
PackageableElement = Class(name="PackageableElement")
UML2WithID_Package = Class(name="UML2WithID_Package")
UML2WithID_Property = Class(name="UML2WithID_Property")
StructuralFeature = Class(name="StructuralFeature")
ConnectableElement = Class(name="ConnectableElement")
DeploymentTarget = Class(name="DeploymentTarget")
UML2WithID_DirectedRelationship = Class(name="UML2WithID_DirectedRelationship", is_abstract=True)
Relationship = Class(name="Relationship")
UML2WithID_Relationship = Class(name="UML2WithID_Relationship", is_abstract=True)
UML2WithID_Class = Class(name="UML2WithID_Class")
BehavioredClassifier = Class(name="BehavioredClassifier")
EncapsulatedClassifier = Class(name="EncapsulatedClassifier")
UML2WithID_Operation = Class(name="UML2WithID_Operation")
BehavioralFeature = Class(name="BehavioralFeature")
MultiplicityElement = Class(name="MultiplicityElement")
UML2WithID_Association = Class(name="UML2WithID_Association")
UML2WithID_DataType = Class(name="UML2WithID_DataType")
UML2WithID_TypedElement = Class(name="UML2WithID_TypedElement", is_abstract=True)
UML2WithID_EnumerationLiteral = Class(name="UML2WithID_EnumerationLiteral")
Classifier = Class(name="Classifier")
InstanceSpecification = Class(name="InstanceSpecification")
UML2WithID_PrimitiveType = Class(name="UML2WithID_PrimitiveType")
Type = Class(name="Type")
RedefinableElement = Class(name="RedefinableElement")
UML2WithID_ParameterSet = Class(name="UML2WithID_ParameterSet")
Namespace = Class(name="Namespace")
UML2WithID_PackageMerge = Class(name="UML2WithID_PackageMerge")
UML2WithID_ProfileApplication = Class(name="UML2WithID_ProfileApplication")
UML2WithID_Enumeration = Class(name="UML2WithID_Enumeration")
DataType = Class(name="DataType")
UML2WithID_CollaborationOccurrence = Class(name="UML2WithID_CollaborationOccurrence")
UML2WithID_Feature = Class(name="UML2WithID_Feature", is_abstract=True)
UML2WithID_Generalization = Class(name="UML2WithID_Generalization")
UML2WithID_Substitution = Class(name="UML2WithID_Substitution")
UML2WithID_GeneralizationSet = Class(name="UML2WithID_GeneralizationSet")
UML2WithID_UseCase = Class(name="UML2WithID_UseCase")
UML2WithID_LiteralUnlimitedNatural = Class(name="UML2WithID_LiteralUnlimitedNatural")
UML2WithID_BehavioralFeature = Class(name="UML2WithID_BehavioralFeature", is_abstract=True)
Feature = Class(name="Feature")
UML2WithID_LiteralBoolean = Class(name="UML2WithID_LiteralBoolean")
LiteralSpecification = Class(name="LiteralSpecification")
UML2WithID_LiteralSpecification = Class(name="UML2WithID_LiteralSpecification", is_abstract=True)
UML2WithID_LiteralString = Class(name="UML2WithID_LiteralString")
UML2WithID_LiteralNull = Class(name="UML2WithID_LiteralNull")
UML2WithID_LiteralInteger = Class(name="UML2WithID_LiteralInteger")
UML2WithID_InstanceValue = Class(name="UML2WithID_InstanceValue")
UML2WithID_RedefinableElement = Class(name="UML2WithID_RedefinableElement", is_abstract=True)
DirectedRelationship = Class(name="DirectedRelationship")
UML2WithID_StructuralFeature = Class(name="UML2WithID_StructuralFeature", is_abstract=True)
UML2WithID_InstanceSpecification = Class(name="UML2WithID_InstanceSpecification")
DeployedArtifact = Class(name="DeployedArtifact")
UML2WithID_Slot = Class(name="UML2WithID_Slot")
UML2WithID_Stereotype = Class(name="UML2WithID_Stereotype")
Class_ = Class(name="Class")
UML2WithID_Profile = Class(name="UML2WithID_Profile")
Package = Class(name="Package")
PackageImport = Class(name="PackageImport")
Association = Class(name="Association")
UML2WithID_ExtensionEnd = Class(name="UML2WithID_ExtensionEnd")
Property_ = Class(name="Property")
UML2WithID_BehavioredClassifier = Class(name="UML2WithID_BehavioredClassifier", is_abstract=True)
UML2WithID_ActivityEdge = Class(name="UML2WithID_ActivityEdge", is_abstract=True)
UML2WithID_ActivityGroup = Class(name="UML2WithID_ActivityGroup", is_abstract=True)
UML2WithID_ActivityNode = Class(name="UML2WithID_ActivityNode", is_abstract=True)
UML2WithID_Action = Class(name="UML2WithID_Action")
UML2WithID_StructuredActivityNode = Class(name="UML2WithID_StructuredActivityNode")
UML2WithID_Implementation = Class(name="UML2WithID_Implementation")
UML2WithID_Trigger = Class(name="UML2WithID_Trigger", is_abstract=True)
UML2WithID_StateMachine = Class(name="UML2WithID_StateMachine")
UML2WithID_Activity = Class(name="UML2WithID_Activity")
Behavior = Class(name="Behavior")
UML2WithID_Permission = Class(name="UML2WithID_Permission")
Dependency = Class(name="Dependency")
UML2WithID_Usage = Class(name="UML2WithID_Usage")
UML2WithID_Abstraction = Class(name="UML2WithID_Abstraction")
UML2WithID_Realization = Class(name="UML2WithID_Realization")
Abstraction = Class(name="Abstraction")
UML2WithID_Component = Class(name="UML2WithID_Component")
Realization = Class(name="Realization")
UML2WithID_Connector = Class(name="UML2WithID_Connector")
UML2WithID_AssociationClass = Class(name="UML2WithID_AssociationClass")
UML2WithID_InformationItem = Class(name="UML2WithID_InformationItem")
UML2WithID_StructuredClassifier = Class(name="UML2WithID_StructuredClassifier", is_abstract=True)
UML2WithID_InformationFlow = Class(name="UML2WithID_InformationFlow")
UML2WithID_Model = Class(name="UML2WithID_Model")
UML2WithID_ConnectorEnd = Class(name="UML2WithID_ConnectorEnd")
UML2WithID_ConnectableElement = Class(name="UML2WithID_ConnectableElement", is_abstract=True)
UML2WithID_ActivityPartition = Class(name="UML2WithID_ActivityPartition")
UML2WithID_InterruptibleActivityRegion = Class(name="UML2WithID_InterruptibleActivityRegion")
ExecutableNode = Class(name="ExecutableNode")
UML2WithID_OutputPin = Class(name="UML2WithID_OutputPin")
UML2WithID_InputPin = Class(name="UML2WithID_InputPin")
UML2WithID_ObjectNode = Class(name="UML2WithID_ObjectNode", is_abstract=True)
ActivityNode = Class(name="ActivityNode")
UML2WithID_DecisionNode = Class(name="UML2WithID_DecisionNode")
UML2WithID_MergeNode = Class(name="UML2WithID_MergeNode")
UML2WithID_ExecutableNode = Class(name="UML2WithID_ExecutableNode", is_abstract=True)
UML2WithID_ExceptionHandler = Class(name="UML2WithID_ExceptionHandler")
Pin = Class(name="Pin")
UML2WithID_Pin = Class(name="UML2WithID_Pin", is_abstract=True)
ObjectNode = Class(name="ObjectNode")
UML2WithID_ActivityParameterNode = Class(name="UML2WithID_ActivityParameterNode")
UML2WithID_ValuePin = Class(name="UML2WithID_ValuePin")
InputPin = Class(name="InputPin")
UML2WithID_Interface = Class(name="UML2WithID_Interface")
UML2WithID_State = Class(name="UML2WithID_State")
UML2WithID_ControlNode = Class(name="UML2WithID_ControlNode", is_abstract=True)
UML2WithID_ControlFlow = Class(name="UML2WithID_ControlFlow")
ActivityEdge = Class(name="ActivityEdge")
UML2WithID_ObjectFlow = Class(name="UML2WithID_ObjectFlow")
UML2WithID_InitialNode = Class(name="UML2WithID_InitialNode")
ControlNode = Class(name="ControlNode")
UML2WithID_FinalNode = Class(name="UML2WithID_FinalNode", is_abstract=True)
UML2WithID_ActivityFinalNode = Class(name="UML2WithID_ActivityFinalNode")
FinalNode = Class(name="FinalNode")
UML2WithID_Manifestation = Class(name="UML2WithID_Manifestation")
UML2WithID_Actor = Class(name="UML2WithID_Actor")
UML2WithID_Extend = Class(name="UML2WithID_Extend")
UML2WithID_ProtocolStateMachine = Class(name="UML2WithID_ProtocolStateMachine")
UML2WithID_Artifact = Class(name="UML2WithID_Artifact")
UML2WithID_Collaboration = Class(name="UML2WithID_Collaboration")
StructuredClassifier = Class(name="StructuredClassifier")
UML2WithID_Port = Class(name="UML2WithID_Port")
UML2WithID_ExtensionPoint = Class(name="UML2WithID_ExtensionPoint")
UML2WithID_Include = Class(name="UML2WithID_Include")
UML2WithID_Signal = Class(name="UML2WithID_Signal")
UML2WithID_SignalTrigger = Class(name="UML2WithID_SignalTrigger")
UML2WithID_TimeTrigger = Class(name="UML2WithID_TimeTrigger")
UML2WithID_EncapsulatedClassifier = Class(name="UML2WithID_EncapsulatedClassifier", is_abstract=True)
UML2WithID_CallTrigger = Class(name="UML2WithID_CallTrigger")
MessageTrigger = Class(name="MessageTrigger")
UML2WithID_MessageTrigger = Class(name="UML2WithID_MessageTrigger", is_abstract=True)
Trigger = Class(name="Trigger")
UML2WithID_ChangeTrigger = Class(name="UML2WithID_ChangeTrigger")
UML2WithID_ConditionalNode = Class(name="UML2WithID_ConditionalNode")
StructuredActivityNode = Class(name="StructuredActivityNode")
UML2WithID_Clause = Class(name="UML2WithID_Clause")
UML2WithID_AnyTrigger = Class(name="UML2WithID_AnyTrigger")
UML2WithID_Variable = Class(name="UML2WithID_Variable")
Action = Class(name="Action")
ActivityGroup = Class(name="ActivityGroup")
UML2WithID_Interaction = Class(name="UML2WithID_Interaction")
InteractionFragment = Class(name="InteractionFragment")
UML2WithID_Lifeline = Class(name="UML2WithID_Lifeline")
UML2WithID_Message = Class(name="UML2WithID_Message")
UML2WithID_InteractionFragment = Class(name="UML2WithID_InteractionFragment", is_abstract=True)
UML2WithID_LoopNode = Class(name="UML2WithID_LoopNode")
UML2WithID_PartDecomposition = Class(name="UML2WithID_PartDecomposition")
UML2WithID_MessageEnd = Class(name="UML2WithID_MessageEnd", is_abstract=True)
UML2WithID_Gate = Class(name="UML2WithID_Gate")
UML2WithID_GeneralOrdering = Class(name="UML2WithID_GeneralOrdering")
UML2WithID_InteractionOperand = Class(name="UML2WithID_InteractionOperand")
MessageEnd = Class(name="MessageEnd")
UML2WithID_ExecutionOccurrence = Class(name="UML2WithID_ExecutionOccurrence")
UML2WithID_EventOccurrence = Class(name="UML2WithID_EventOccurrence")
UML2WithID_ParameterableElement = Class(name="UML2WithID_ParameterableElement", is_abstract=True)
UML2WithID_TemplateBinding = Class(name="UML2WithID_TemplateBinding")
UML2WithID_StateInvariant = Class(name="UML2WithID_StateInvariant")
UML2WithID_Stop = Class(name="UML2WithID_Stop")
EventOccurrence = Class(name="EventOccurrence")
UML2WithID_TemplateSignature = Class(name="UML2WithID_TemplateSignature")
UML2WithID_TemplateParameter = Class(name="UML2WithID_TemplateParameter")
UML2WithID_TemplateableElement = Class(name="UML2WithID_TemplateableElement", is_abstract=True)
UML2WithID_OperationTemplateParameter = Class(name="UML2WithID_OperationTemplateParameter")
TemplateParameter = Class(name="TemplateParameter")
UML2WithID_ClassifierTemplateParameter = Class(name="UML2WithID_ClassifierTemplateParameter")
UML2WithID_ParameterableClassifier = Class(name="UML2WithID_ParameterableClassifier", is_abstract=True)
UML2WithID_TemplateParameterSubstitution = Class(name="UML2WithID_TemplateParameterSubstitution")
UML2WithID_ExpansionNode = Class(name="UML2WithID_ExpansionNode")
UML2WithID_ExpansionRegion = Class(name="UML2WithID_ExpansionRegion")
UML2WithID_RedefinableTemplateSignature = Class(name="UML2WithID_RedefinableTemplateSignature")
TemplateSignature = Class(name="TemplateSignature")
UML2WithID_TemplateableClassifier = Class(name="UML2WithID_TemplateableClassifier", is_abstract=True)
UML2WithID_ConnectableElementTemplateParameter = Class(name="UML2WithID_ConnectableElementTemplateParameter")
UML2WithID_ForkNode = Class(name="UML2WithID_ForkNode")
UML2WithID_JoinNode = Class(name="UML2WithID_JoinNode")
UML2WithID_FlowFinalNode = Class(name="UML2WithID_FlowFinalNode")
UML2WithID_CentralBufferNode = Class(name="UML2WithID_CentralBufferNode")
UML2WithID_InteractionOccurrence = Class(name="UML2WithID_InteractionOccurrence")
UML2WithID_CombinedFragment = Class(name="UML2WithID_CombinedFragment")
InteractionOccurrence = Class(name="InteractionOccurrence")
UML2WithID_InteractionConstraint = Class(name="UML2WithID_InteractionConstraint")
Constraint = Class(name="Constraint")
Vertex = Class(name="Vertex")
UML2WithID_Continuation = Class(name="UML2WithID_Continuation")
UML2WithID_Region = Class(name="UML2WithID_Region")
UML2WithID_Pseudostate = Class(name="UML2WithID_Pseudostate")
UML2WithID_Vertex = Class(name="UML2WithID_Vertex", is_abstract=True)
UML2WithID_Transition = Class(name="UML2WithID_Transition")
UML2WithID_ConnectionPointReference = Class(name="UML2WithID_ConnectionPointReference")
UML2WithID_CreateObjectAction = Class(name="UML2WithID_CreateObjectAction")
UML2WithID_DestroyObjectAction = Class(name="UML2WithID_DestroyObjectAction")
UML2WithID_TestIdentityAction = Class(name="UML2WithID_TestIdentityAction")
UML2WithID_ReadSelfAction = Class(name="UML2WithID_ReadSelfAction")
UML2WithID_FinalState = Class(name="UML2WithID_FinalState")
State = Class(name="State")
UML2WithID_LinkAction = Class(name="UML2WithID_LinkAction", is_abstract=True)
UML2WithID_LinkEndData = Class(name="UML2WithID_LinkEndData")
UML2WithID_QualifierValue = Class(name="UML2WithID_QualifierValue")
UML2WithID_StructuralFeatureAction = Class(name="UML2WithID_StructuralFeatureAction", is_abstract=True)
UML2WithID_ReadStructuralFeatureAction = Class(name="UML2WithID_ReadStructuralFeatureAction")
StructuralFeatureAction = Class(name="StructuralFeatureAction")
UML2WithID_WriteStructuralFeatureAction = Class(name="UML2WithID_WriteStructuralFeatureAction", is_abstract=True)
UML2WithID_ClearStructuralFeatureAction = Class(name="UML2WithID_ClearStructuralFeatureAction")
UML2WithID_RemoveStructuralFeatureValueAction = Class(name="UML2WithID_RemoveStructuralFeatureValueAction")
WriteStructuralFeatureAction = Class(name="WriteStructuralFeatureAction")
UML2WithID_AddStructuralFeatureValueAction = Class(name="UML2WithID_AddStructuralFeatureValueAction")
UML2WithID_ReadVariableAction = Class(name="UML2WithID_ReadVariableAction")
VariableAction = Class(name="VariableAction")
UML2WithID_WriteVariableAction = Class(name="UML2WithID_WriteVariableAction", is_abstract=True)
UML2WithID_ClearVariableAction = Class(name="UML2WithID_ClearVariableAction")
UML2WithID_AddVariableValueAction = Class(name="UML2WithID_AddVariableValueAction")
WriteVariableAction = Class(name="WriteVariableAction")
UML2WithID_ReadLinkAction = Class(name="UML2WithID_ReadLinkAction")
LinkAction = Class(name="LinkAction")
UML2WithID_LinkEndCreationData = Class(name="UML2WithID_LinkEndCreationData")
LinkEndData = Class(name="LinkEndData")
UML2WithID_CreateLinkAction = Class(name="UML2WithID_CreateLinkAction")
WriteLinkAction = Class(name="WriteLinkAction")
UML2WithID_WriteLinkAction = Class(name="UML2WithID_WriteLinkAction", is_abstract=True)
UML2WithID_DestroyLinkAction = Class(name="UML2WithID_DestroyLinkAction")
UML2WithID_ClearAssociationAction = Class(name="UML2WithID_ClearAssociationAction")
UML2WithID_VariableAction = Class(name="UML2WithID_VariableAction", is_abstract=True)
UML2WithID_InvocationAction = Class(name="UML2WithID_InvocationAction", is_abstract=True)
UML2WithID_SendSignalAction = Class(name="UML2WithID_SendSignalAction")
UML2WithID_RemoveVariableValueAction = Class(name="UML2WithID_RemoveVariableValueAction")
UML2WithID_ApplyFunctionAction = Class(name="UML2WithID_ApplyFunctionAction")
UML2WithID_PrimitiveFunction = Class(name="UML2WithID_PrimitiveFunction")
UML2WithID_CallAction = Class(name="UML2WithID_CallAction", is_abstract=True)
InvocationAction = Class(name="InvocationAction")
UML2WithID_Duration = Class(name="UML2WithID_Duration")
UML2WithID_TimeObservationAction = Class(name="UML2WithID_TimeObservationAction")
UML2WithID_DurationInterval = Class(name="UML2WithID_DurationInterval")
Interval = Class(name="Interval")
UML2WithID_Interval = Class(name="UML2WithID_Interval")
UML2WithID_TimeConstraint = Class(name="UML2WithID_TimeConstraint")
IntervalConstraint = Class(name="IntervalConstraint")
UML2WithID_IntervalConstraint = Class(name="UML2WithID_IntervalConstraint")
UML2WithID_BroadcastSignalAction = Class(name="UML2WithID_BroadcastSignalAction")
UML2WithID_TimeInterval = Class(name="UML2WithID_TimeInterval")
UML2WithID_DurationObservationAction = Class(name="UML2WithID_DurationObservationAction")
UML2WithID_SendObjectAction = Class(name="UML2WithID_SendObjectAction")
UML2WithID_DurationConstraint = Class(name="UML2WithID_DurationConstraint")
UML2WithID_CallOperationAction = Class(name="UML2WithID_CallOperationAction")
CallAction = Class(name="CallAction")
UML2WithID_CallBehaviorAction = Class(name="UML2WithID_CallBehaviorAction")
UML2WithID_TimeExpression = Class(name="UML2WithID_TimeExpression")
UML2WithID_DataStoreNode = Class(name="UML2WithID_DataStoreNode")
CentralBufferNode = Class(name="CentralBufferNode")
UML2WithID_Node = Class(name="UML2WithID_Node")
UML2WithID_Device = Class(name="UML2WithID_Device")
Node = Class(name="Node")
UML2WithID_Deployment = Class(name="UML2WithID_Deployment")
UML2WithID_DeployedArtifact = Class(name="UML2WithID_DeployedArtifact", is_abstract=True)
UML2WithID_DeploymentTarget = Class(name="UML2WithID_DeploymentTarget", is_abstract=True)
UML2WithID_DeploymentSpecification = Class(name="UML2WithID_DeploymentSpecification")
UML2WithID_ReadExtentAction = Class(name="UML2WithID_ReadExtentAction")
UML2WithID_ReclassifyObjectAction = Class(name="UML2WithID_ReclassifyObjectAction")
UML2WithID_ExecutionEnvironment = Class(name="UML2WithID_ExecutionEnvironment")
UML2WithID_CommunicationPath = Class(name="UML2WithID_CommunicationPath")
UML2WithID_ProtocolConformance = Class(name="UML2WithID_ProtocolConformance")
StateMachine = Class(name="StateMachine")
UML2WithID_ProtocolTransition = Class(name="UML2WithID_ProtocolTransition")
Transition = Class(name="Transition")
UML2WithID_ReadLinkObjectEndAction = Class(name="UML2WithID_ReadLinkObjectEndAction")
UML2WithID_ReadIsClassifiedObjectAction = Class(name="UML2WithID_ReadIsClassifiedObjectAction")
UML2WithID_StartOwnedBehaviorAction = Class(name="UML2WithID_StartOwnedBehaviorAction")
UML2WithID_ReplyAction = Class(name="UML2WithID_ReplyAction")
UML2WithID_RaiseExceptionAction = Class(name="UML2WithID_RaiseExceptionAction")
UML2WithID_ReadLinkObjectEndQualifierAction = Class(name="UML2WithID_ReadLinkObjectEndQualifierAction")
UML2WithID_CreateLinkObjectAction = Class(name="UML2WithID_CreateLinkObjectAction")
CreateLinkAction = Class(name="CreateLinkAction")
UML2WithID_AcceptEventAction = Class(name="UML2WithID_AcceptEventAction")
UML2WithID_AcceptCallAction = Class(name="UML2WithID_AcceptCallAction")
...
UML2WithID_MultiplicityElement.attributes={UML2WithID_MultiplicityElement_upper, UML2WithID_MultiplicityElement_lower, UML2WithID_MultiplicityElement_isUnique, UML2WithID_MultiplicityElement_isOrdered}
...
UML2WithID_OpaqueExpression.attributes={UML2WithID_OpaqueExpression_language, UML2WithID_OpaqueExpression_bodies}
...
UML2WithID_Parameter.attributes={UML2WithID_Parameter_direction, UML2WithID_Parameter_isStream, UML2WithID_Parameter_isException, UML2WithID_Parameter_effect, UML2WithID_Parameter_default}
...
UML2WithID_NamedElement.attributes={UML2WithID_NamedElement_visibility, UML2WithID_NamedElement_qualifiedName, UML2WithID_NamedElement_name}
...
UML2WithID_Property.attributes={UML2WithID_Property_isComposite, UML2WithID_Property_isDerived, UML2WithID_Property_default, UML2WithID_Property_aggregation, UML2WithID_Property_isDerivedUnion}
...
UML2WithID_BehavioralFeature.attributes={UML2WithID_BehavioralFeature_concurrency, UML2WithID_BehavioralFeature_isAbstract}
...
UML2WithID_Activity.attributes={UML2WithID_Activity_language, UML2WithID_Activity_isSingleExecution, UML2WithID_Activity_body, UML2WithID_Activity_isReadOnly}
...
UML2WithID_State.attributes={UML2WithID_State_isOrthogonal, UML2WithID_State_isComposite, UML2WithID_State_isSimple, UML2WithID_State_isSubmachineState}
...
domain_model = DomainModel(
    name="UML2WithID",
    types={UML2WithID_Comment, UML2WithID_MultiplicityElement, Element, UML2WithID_ValueSpecification, UML2WithID_Element, UML2WithID_OpaqueExpression, ValueSpecification, UML2WithID_Parameter, UML2WithID_Behavior, TypedElement, ParameterableElement, UML2WithID_Expression, OpaqueExpression, UML2WithID_NamedElement, TemplateableElement, UML2WithID_Dependency, UML2WithID_StringExpression, UML2WithID_Namespace, NamedElement, UML2WithID_Constraint, UML2WithID_PackageableElement, UML2WithID_ElementImport, UML2WithID_PackageImport, UML2WithID_Extension, UML2WithID_Classifier, UML2WithID_Reception, UML2WithID_Type, PackageableElement, UML2WithID_Package, UML2WithID_Property, StructuralFeature, ConnectableElement, DeploymentTarget, UML2WithID_DirectedRelationship, Relationship, UML2WithID_Relationship, UML2WithID_Class, BehavioredClassifier, EncapsulatedClassifier, UML2WithID_Operation, BehavioralFeature, MultiplicityElement, UML2WithID_Association, UML2WithID_DataType, UML2WithID_TypedElement, UML2WithID_EnumerationLiteral, Classifier, InstanceSpecification, UML2WithID_PrimitiveType, Type, RedefinableElement, UML2WithID_ParameterSet, Namespace, UML2WithID_PackageMerge, UML2WithID_ProfileApplication, UML2WithID_Enumeration, DataType, UML2WithID_CollaborationOccurrence, UML2WithID_Feature, UML2WithID_Generalization, UML2WithID_Substitution, UML2WithID_GeneralizationSet, UML2WithID_UseCase, UML2WithID_LiteralUnlimitedNatural, UML2WithID_BehavioralFeature, Feature, UML2WithID_LiteralBoolean, LiteralSpecification, UML2WithID_LiteralSpecification, UML2WithID_LiteralString, UML2WithID_LiteralNull, UML2WithID_LiteralInteger, UML2WithID_InstanceValue, UML2WithID_RedefinableElement, DirectedRelationship, UML2WithID_StructuralFeature, UML2WithID_InstanceSpecification, DeployedArtifact, UML2WithID_Slot, UML2WithID_Stereotype, Class_, UML2WithID_Profile, Package, PackageImport, Association, UML2WithID_ExtensionEnd, Property_, UML2WithID_BehavioredClassifier, UML2WithID_ActivityEdge, UML2WithID_ActivityGroup, UML2WithID_ActivityNode, UML2WithID_Action, UML2WithID_StructuredActivityNode, UML2WithID_Implementation, UML2WithID_Trigger, UML2WithID_StateMachine, UML2WithID_Activity, Behavior, UML2WithID_Permission, Dependency, UML2WithID_Usage, UML2WithID_Abstraction, UML2WithID_Realization, Abstraction, UML2WithID_Component, Realization, UML2WithID_Connector, UML2WithID_AssociationClass, UML2WithID_InformationItem, UML2WithID_StructuredClassifier, UML2WithID_InformationFlow, UML2WithID_Model, UML2WithID_ConnectorEnd, UML2WithID_ConnectableElement, UML2WithID_ActivityPartition, UML2WithID_InterruptibleActivityRegion, ExecutableNode, UML2WithID_OutputPin, UML2WithID_InputPin, UML2WithID_ObjectNode, ActivityNode, UML2WithID_DecisionNode, UML2WithID_MergeNode, UML2WithID_ExecutableNode, UML2WithID_ExceptionHandler, Pin, UML2WithID_Pin, ObjectNode, UML2WithID_ActivityParameterNode, UML2WithID_ValuePin, InputPin, UML2WithID_Interface, UML2WithID_State, UML2WithID_ControlNode, UML2WithID_ControlFlow, ActivityEdge, UML2WithID_ObjectFlow, UML2WithID_InitialNode, ControlNode, UML2WithID_FinalNode, UML2WithID_ActivityFinalNode, FinalNode, UML2WithID_Manifestation, UML2WithID_Actor, UML2WithID_Extend, UML2WithID_ProtocolStateMachine, UML2WithID_Artifact, UML2WithID_Collaboration, StructuredClassifier, UML2WithID_Port, UML2WithID_ExtensionPoint, UML2WithID_Include, UML2WithID_Signal, UML2WithID_SignalTrigger, UML2WithID_TimeTrigger, UML2WithID_EncapsulatedClassifier, UML2WithID_CallTrigger, MessageTrigger, UML2WithID_MessageTrigger, Trigger, UML2WithID_ChangeTrigger, UML2WithID_ConditionalNode, StructuredActivityNode, UML2WithID_Clause, UML2WithID_AnyTrigger, UML2WithID_Variable, Action, ActivityGroup, UML2WithID_Interaction, InteractionFragment, UML2WithID_Lifeline, UML2WithID_Message, UML2WithID_InteractionFragment, UML2WithID_LoopNode, UML2WithID_PartDecomposition, UML2WithID_MessageEnd, UML2WithID_Gate, UML2WithID_GeneralOrdering, UML2WithID_InteractionOperand, MessageEnd, UML2WithID_ExecutionOccurrence, UML2WithID_EventOccurrence, UML2WithID_ParameterableElement, UML2WithID_TemplateBinding, UML2WithID_StateInvariant, UML2WithID_Stop, EventOccurrence, UML2WithID_TemplateSignature, UML2WithID_TemplateParameter, UML2WithID_TemplateableElement, UML2WithID_OperationTemplateParameter, TemplateParameter, UML2WithID_ClassifierTemplateParameter, UML2WithID_ParameterableClassifier, UML2WithID_TemplateParameterSubstitution, UML2WithID_ExpansionNode, UML2WithID_ExpansionRegion, UML2WithID_RedefinableTemplateSignature, TemplateSignature, UML2WithID_TemplateableClassifier, UML2WithID_ConnectableElementTemplateParameter, UML2WithID_ForkNode, UML2WithID_JoinNode, UML2WithID_FlowFinalNode, UML2WithID_CentralBufferNode, UML2WithID_InteractionOccurrence, UML2WithID_CombinedFragment, InteractionOccurrence, UML2WithID_InteractionConstraint, Constraint, Vertex, UML2WithID_Continuation, UML2WithID_Region, UML2WithID_Pseudostate, UML2WithID_Vertex, UML2WithID_Transition, UML2WithID_ConnectionPointReference, UML2WithID_CreateObjectAction, UML2WithID_DestroyObjectAction, UML2WithID_TestIdentityAction, UML2WithID_ReadSelfAction, UML2WithID_FinalState, State, UML2WithID_LinkAction, UML2WithID_LinkEndData, UML2WithID_QualifierValue, UML2WithID_StructuralFeatureAction, UML2WithID_ReadStructuralFeatureAction, StructuralFeatureAction, UML2WithID_WriteStructuralFeatureAction, UML2WithID_ClearStructuralFeatureAction, UML2WithID_RemoveStructuralFeatureValueAction, WriteStructuralFeatureAction, UML2WithID_AddStructuralFeatureValueAction, UML2WithID_ReadVariableAction, VariableAction, UML2WithID_WriteVariableAction, UML2WithID_ClearVariableAction, UML2WithID_AddVariableValueAction, WriteVariableAction, UML2WithID_ReadLinkAction, LinkAction, UML2WithID_LinkEndCreationData, LinkEndData, UML2WithID_CreateLinkAction, WriteLinkAction, UML2WithID_WriteLinkAction, UML2WithID_DestroyLinkAction, UML2WithID_ClearAssociationAction, UML2WithID_VariableAction, UML2WithID_InvocationAction, UML2WithID_SendSignalAction, UML2WithID_RemoveVariableValueAction, UML2WithID_ApplyFunctionAction, UML2WithID_PrimitiveFunction, UML2WithID_CallAction, InvocationAction, UML2WithID_Duration, UML2WithID_TimeObservationAction, UML2WithID_DurationInterval, Interval, UML2WithID_Interval, UML2WithID_TimeConstraint, IntervalConstraint, UML2WithID_IntervalConstraint, UML2WithID_BroadcastSignalAction, UML2WithID_TimeInterval, UML2WithID_DurationObservationAction, UML2WithID_SendObjectAction, UML2WithID_DurationConstraint, UML2WithID_CallOperationAction, CallAction, UML2WithID_CallBehaviorAction, UML2WithID_TimeExpression, UML2WithID_DataStoreNode, CentralBufferNode, UML2WithID_Node, UML2WithID_Device, Node, UML2WithID_Deployment, UML2WithID_DeployedArtifact, UML2WithID_DeploymentTarget, UML2WithID_DeploymentSpecification, UML2WithID_ReadExtentAction, UML2WithID_ReclassifyObjectAction, UML2WithID_ExecutionEnvironment, UML2WithID_CommunicationPath, UML2WithID_ProtocolConformance, StateMachine, UML2WithID_ProtocolTransition, Transition, UML2WithID_ReadLinkObjectEndAction, UML2WithID_ReadIsClassifiedObjectAction, UML2WithID_StartOwnedBehaviorAction, UML2WithID_ReplyAction, UML2WithID_RaiseExceptionAction, UML2WithID_ReadLinkObjectEndQualifierAction, UML2WithID_CreateLinkObjectAction, CreateLinkAction, UML2WithID_AcceptEventAction, UML2WithID_AcceptCallAction, AcceptEventAction, Artifact, VisibilityKind, ParameterDirectionKind, AggregationKind, CallConcurrencyKind, MessageKind, MessageSort, ExpansionKind, InteractionOperator, TransitionKind, PseudostateKind, ParameterEffectKind, ObjectNodeOrderingKind, ConnectorKind},
    associations={owner3, ownedComment5, upperValue6, lowerValue7, ownedElement1, result20, behavior21, operand23, clientDependency10, nameExpression11, member12, ownedRule14, importedMember15, elementImport17, packageImport18, extension41, nestedClassifier42, ownedReception44, package46, annotatedElement25, bodyExpression28, source31, target33, relatedElement36, ownedOperation38, superClass40, qualifier66, associationEnd68, ownedParameter70, class_47, opposite50, owningAssociation52, redefinedProperty54, subsettedProperty57, datatype59, association60, defaultValue62, type85, operation86, defaultValue88, class_71, datatype72, precondition75, postcondition76, redefinedOperation80, bodyCondition82, ownedLiteral106, ownedAttribute107, ownedOperation109, enumeration112, parameterSet91, nestedPackage93, nestingPackage96, ownedType98, ownedMember99, packageMerge101, appliedProfile102, packageExtension104, useCase131, representation132, occurrence134, featuringClassifier137, context138, feature113, inheritedMember114, general118, generalization120, attribute121, redefinedClassifier125, substitution127, powertypeExtent128, ownedUseCase129, parameter148, formalParameter150, returnResult153, raisedException156, namespace141, specification142, constrainedElement145, instance171, redefinitionContext173, specific175, general177, method159, slot160, classifier161, specification163, owningInstance166, value167, definingFeature169, ownedEnd190, endType192, memberEnd194, mergingPackage196, mergedPackage198, generalizationSet179, importedElement182, importingNamespace184, importedPackage186, importingNamespace188, redefinedBehavior215, specification217, parameter218, formalParameter221, returnResult224, ownedStereotype201, metaclassReference202, metamodelReference205, importedProfile208, metaclass211, context213, edge243, group244, node245, action247, structuredNode248, precondition227, postcondition230, ownedParameterSet233, ownedBehavior235, classifierBehavior237, implementation239, ownedTrigger240, ownedStateMachine242, contract258, substitutingClassifier260, powertype262, generalization264, client250, supplier251, mapping253, abstraction255, realizingClassifier256, end279, type280, redefinedConnector283, end285, contract288, represented266, realization268, conveyed270, definingEnd273, role275, partWithPort276, inGroup306, guard307, redefinedElement311, inStructuredNode313, inPartition314, weight316, interrupts319, superGroup321, activityGroup_activity323, ownedAttribute291, part293, role296, ownedConnector298, activity301, source302, target304, inInterruptibleRegion341, output344, input346, context_348, localPrecondition351, localPostcondition354, upperBound357, outgoing325, incoming327, inGroup329, activity331, redefinedElement334, inStructuredNode336, inPartition338, decisionInput369, handler371, parameter372, value374, inState359, selection361, transformation364, selection366, nestedArtifact397, manifestation398, ownedOperation400, ownedAttribute403, utilizedElement406, extendedCase409, extension411, ownedAttribute376, ownedOperation378, redefinedInterface382, nestedClassifier384, ownedReception387, protocol390, contract392, implementingClassifier394, includingCase427, addition429, type431, roleBinding433, collaborationRole436, condition413, extensionLocation416, include418, extend419, extensionPoint421, subject422, useCase425, changeExpression454, port456, signal459, ownedAttribute461, signal464, required439, redefinedPort442, provided444, protocol447, ownedPort450, operation452, containedNode471, containedEdge473, clause476, when466, scope468, test505, variable470, result508, loopVariable511, bodyOutput514, loopVariableInput517, lifeline520, result477, message521, test480, body483, predecessorClause487, successorClause489, decider491, bodyOutput494, bodyPart497, setupPart499, decider502, interaction535, selector537, decomposedAs540, receiveEvent542, sendEvent543, connector545, interaction547, signature549, fragment523, formalGate524, covered525, generalOrdering527, enclosingInteraction528, enclosingOperand529, coveredBy531, represents533, sendMessage560, startExec562, finishExec563, toAfter565, toBefore566, start568, finish570, behavior572, argument552, before555, after556, receiveMessage558, signature584, parameteredElement587, ownedParameteredElement588, default590, ownedDefault592, templateBinding595, ownedTemplateSignature596, subExpression599, invariant574, parameter576, ownedParameter577, nestedSignature579, nestingSignature581, template583, formal613, templateBinding615, actual617, ownedActual620, owningExpression601, templateParameter603, owningParameter605, boundElement607, signature609, superPartition634, parameterSubstitution611, represents636, regionAsOutput638, joinSpec623, containedEdge625, containedNode627, subgroup631, handlerBody645, exceptionInput646, exceptionType649, refersTo652, actualGate654, regionAsInput639, outputElement641, inputElement642, protectedNode644, operand669, argument657, guard660, fragment661, minint663, maxint666, stateMachine684, state686, extendedRegion689, cfragmentGate671, submachine690, region674, connectionPoint675, extendedStateMachine677, stateMachine_redefinitionContext679, subvertex681, transition682, stateInvariant712, container715, outgoing717, incoming720, entry723, exit726, container729, source731, connection693, redefinedState696, deferrableTrigger698, region701, entry703, exit706, doActivity709, classifier748, result750, target753, first755, second757, result760, result763, target734, redefinedTransition738, trigger739, guard742, effect745, insertAt774, endData776, value777, end780, qualifier783, structuralFeature765, object767, result770, value772, variable794, result795, value797, result785, insertAt787, object789, association791, argument810, onPort812, target815, signal817, insertAt799, function801, argument802, result805, result808, event836, now838, min840, max842, signal820, duration845, target822, request824, operation827, target829, behavior832, event834, parameter851, condition853, interruptingEdge847, containedNode849, configuration867, deployment869, deployedElement870, nestedNode873, required856, provided858, realization861, ownedMember862, deployedArtifact865, location866, result886, classifier888, oldClassifier891, specificMachine874, generalMachine875, conformance877, postCondition878, referred880, preCondition883, qualifier909, value912, object915, end917, result920, newClassifier893, object896, classifier899, result901, object904, object907, replyToCall940, replyValue942, returnInformation945, object923, result925, qualifier928, result931, trigger933, result935, returnInformation938, exception948},
    generalizations={gen_UML2WithID_MultiplicityElement_Element, gen_UML2WithID_OpaqueExpression_ValueSpecification, gen_UML2WithID_ValueSpecification_TypedElement, gen_UML2WithID_ValueSpecification_ParameterableElement, gen_UML2WithID_Expression_OpaqueExpression, gen_UML2WithID_Comment_TemplateableElement, gen_UML2WithID_NamedElement_TemplateableElement, gen_UML2WithID_Namespace_NamedElement, gen_UML2WithID_Type_PackageableElement, gen_UML2WithID_Property_StructuralFeature, gen_UML2WithID_Property_ConnectableElement, gen_UML2WithID_Property_DeploymentTarget, gen_UML2WithID_DirectedRelationship_Relationship, gen_UML2WithID_Relationship_Element, gen_UML2WithID_Class_BehavioredClassifier, gen_UML2WithID_Class_EncapsulatedClassifier, gen_UML2WithID_Operation_BehavioralFeature, gen_UML2WithID_Operation_TypedElement, gen_UML2WithID_Operation_MultiplicityElement, gen_UML2WithID_Operation_ParameterableElement, gen_UML2WithID_Parameter_ConnectableElement, gen_UML2WithID_Parameter_TypedElement, gen_UML2WithID_Parameter_MultiplicityElement, gen_UML2WithID_TypedElement_NamedElement, gen_UML2WithID_DataType_Classifier, gen_UML2WithID_EnumerationLiteral_InstanceSpecification, gen_UML2WithID_PrimitiveType_DataType, gen_UML2WithID_Classifier_Namespace, gen_UML2WithID_Classifier_Type, gen_UML2WithID_Classifier_RedefinableElement, gen_UML2WithID_Package_Namespace, gen_UML2WithID_Package_PackageableElement, gen_UML2WithID_Enumeration_DataType, gen_UML2WithID_Feature_RedefinableElement, gen_UML2WithID_Constraint_PackageableElement, gen_UML2WithID_LiteralUnlimitedNatural_LiteralSpecification, gen_UML2WithID_BehavioralFeature_Namespace, gen_UML2WithID_BehavioralFeature_Feature, gen_UML2WithID_LiteralBoolean_LiteralSpecification, gen_UML2WithID_LiteralSpecification_ValueSpecification, gen_UML2WithID_LiteralString_LiteralSpecification, gen_UML2WithID_LiteralNull_LiteralSpecification, gen_UML2WithID_LiteralInteger_LiteralSpecification, gen_UML2WithID_InstanceValue_ValueSpecification, gen_UML2WithID_RedefinableElement_NamedElement, gen_UML2WithID_Generalization_DirectedRelationship, gen_UML2WithID_StructuralFeature_Feature, gen_UML2WithID_StructuralFeature_TypedElement, gen_UML2WithID_StructuralFeature_MultiplicityElement, gen_UML2WithID_InstanceSpecification_PackageableElement, gen_UML2WithID_InstanceSpecification_DeploymentTarget, gen_UML2WithID_InstanceSpecification_DeployedArtifact, gen_UML2WithID_Slot_Element, gen_UML2WithID_PackageMerge_DirectedRelationship, gen_UML2WithID_Stereotype_Class, gen_UML2WithID_Profile_Package, gen_UML2WithID_PackageableElement_NamedElement, gen_UML2WithID_PackageableElement_ParameterableElement, gen_UML2WithID_ElementImport_DirectedRelationship, gen_UML2WithID_PackageImport_DirectedRelationship, gen_UML2WithID_Association_Classifier, gen_UML2WithID_Association_Relationship, gen_UML2WithID_ProfileApplication_PackageImport, gen_UML2WithID_Extension_Association, gen_UML2WithID_ExtensionEnd_Property, gen_UML2WithID_Behavior_Class, gen_UML2WithID_BehavioredClassifier_Classifier, gen_UML2WithID_Activity_Behavior, gen_UML2WithID_GeneralizationSet_PackageableElement, gen_UML2WithID_Permission_Dependency, gen_UML2WithID_Dependency_PackageableElement, gen_UML2WithID_Dependency_DirectedRelationship, gen_UML2WithID_Usage_Dependency, gen_UML2WithID_Abstraction_Dependency, gen_UML2WithID_Realization_Abstraction, gen_UML2WithID_Substitution_Realization, gen_UML2WithID_ConnectableElement_NamedElement, gen_UML2WithID_ConnectableElement_ParameterableElement, gen_UML2WithID_Connector_Feature, gen_UML2WithID_AssociationClass_Class, gen_UML2WithID_AssociationClass_Association, gen_UML2WithID_InformationItem_Classifier, gen_UML2WithID_InformationFlow_PackageableElement, gen_UML2WithID_InformationFlow_DirectedRelationship, gen_UML2WithID_Model_Package, gen_UML2WithID_ConnectorEnd_MultiplicityElement, gen_UML2WithID_ActivityGroup_Element, gen_UML2WithID_StructuredClassifier_Classifier, gen_UML2WithID_ActivityEdge_RedefinableElement, gen_UML2WithID_Action_ExecutableNode, gen_UML2WithID_ObjectNode_ActivityNode, gen_UML2WithID_ObjectNode_TypedElement, gen_UML2WithID_ActivityNode_RedefinableElement, gen_UML2WithID_DecisionNode_ControlNode, gen_UML2WithID_MergeNode_ControlNode, gen_UML2WithID_ExecutableNode_ActivityNode, gen_UML2WithID_OutputPin_Pin, gen_UML2WithID_InputPin_Pin, gen_UML2WithID_Pin_ObjectNode, gen_UML2WithID_Pin_MultiplicityElement, gen_UML2WithID_ActivityParameterNode_ObjectNode, gen_UML2WithID_ValuePin_InputPin, gen_UML2WithID_Interface_Classifier, gen_UML2WithID_ControlNode_ActivityNode, gen_UML2WithID_ControlFlow_ActivityEdge, gen_UML2WithID_ObjectFlow_ActivityEdge, gen_UML2WithID_InitialNode_ControlNode, gen_UML2WithID_FinalNode_ControlNode, gen_UML2WithID_ActivityFinalNode_FinalNode, gen_UML2WithID_Manifestation_Abstraction, gen_UML2WithID_Actor_Classifier, gen_UML2WithID_Extend_NamedElement, gen_UML2WithID_Extend_DirectedRelationship, gen_UML2WithID_Implementation_Realization, gen_UML2WithID_Artifact_Classifier, gen_UML2WithID_Artifact_DeployedArtifact, gen_UML2WithID_Include_NamedElement, gen_UML2WithID_Include_DirectedRelationship, gen_UML2WithID_CollaborationOccurrence_NamedElement, gen_UML2WithID_Collaboration_BehavioredClassifier, gen_UML2WithID_Collaboration_StructuredClassifier, gen_UML2WithID_Port_Property, gen_UML2WithID_UseCase_BehavioredClassifier, gen_UML2WithID_ExtensionPoint_RedefinableElement, gen_UML2WithID_Trigger_NamedElement, gen_UML2WithID_Reception_BehavioralFeature, gen_UML2WithID_Signal_Classifier, gen_UML2WithID_SignalTrigger_MessageTrigger, gen_UML2WithID_TimeTrigger_Trigger, gen_UML2WithID_EncapsulatedClassifier_StructuredClassifier, gen_UML2WithID_CallTrigger_MessageTrigger, gen_UML2WithID_MessageTrigger_Trigger, gen_UML2WithID_ChangeTrigger_Trigger, gen_UML2WithID_ConditionalNode_StructuredActivityNode, gen_UML2WithID_AnyTrigger_MessageTrigger, gen_UML2WithID_Variable_ConnectableElement, gen_UML2WithID_Variable_TypedElement, gen_UML2WithID_Variable_MultiplicityElement, gen_UML2WithID_StructuredActivityNode_Action, gen_UML2WithID_StructuredActivityNode_Namespace, gen_UML2WithID_StructuredActivityNode_ActivityGroup, gen_UML2WithID_Interaction_Behavior, gen_UML2WithID_Interaction_InteractionFragment, gen_UML2WithID_Clause_Element, gen_UML2WithID_LoopNode_StructuredActivityNode, gen_UML2WithID_Message_NamedElement, gen_UML2WithID_InteractionFragment_NamedElement, gen_UML2WithID_Lifeline_NamedElement, gen_UML2WithID_EventOccurrence_InteractionFragment, gen_UML2WithID_EventOccurrence_MessageEnd, gen_UML2WithID_ExecutionOccurrence_InteractionFragment, gen_UML2WithID_GeneralOrdering_NamedElement, gen_UML2WithID_MessageEnd_NamedElement, gen_UML2WithID_TemplateableElement_Element, gen_UML2WithID_StringExpression_TemplateableElement, gen_UML2WithID_StateInvariant_InteractionFragment, gen_UML2WithID_Stop_EventOccurrence, gen_UML2WithID_TemplateSignature_Element, gen_UML2WithID_TemplateParameter_Element, gen_UML2WithID_OperationTemplateParameter_TemplateParameter, gen_UML2WithID_ClassifierTemplateParameter_TemplateParameter, gen_UML2WithID_ParameterableClassifier_Classifier, gen_UML2WithID_ParameterableElement_Element, gen_UML2WithID_TemplateBinding_DirectedRelationship, gen_UML2WithID_TemplateParameterSubstitution_Element, gen_UML2WithID_ExpansionNode_ObjectNode, gen_UML2WithID_RedefinableTemplateSignature_RedefinableElement, gen_UML2WithID_RedefinableTemplateSignature_TemplateSignature, gen_UML2WithID_TemplateableClassifier_Classifier, gen_UML2WithID_ConnectableElementTemplateParameter_TemplateParameter, gen_UML2WithID_ForkNode_ControlNode, gen_UML2WithID_JoinNode_ControlNode, gen_UML2WithID_FlowFinalNode_FinalNode, gen_UML2WithID_CentralBufferNode_ObjectNode, gen_UML2WithID_ActivityPartition_NamedElement, gen_UML2WithID_ActivityPartition_ActivityGroup, gen_UML2WithID_InteractionOccurrence_InteractionFragment, gen_UML2WithID_ExpansionRegion_StructuredActivityNode, gen_UML2WithID_ExceptionHandler_Element, gen_UML2WithID_CombinedFragment_InteractionFragment, gen_UML2WithID_Gate_MessageEnd, gen_UML2WithID_PartDecomposition_InteractionOccurrence, gen_UML2WithID_InteractionOperand_Namespace, gen_UML2WithID_InteractionOperand_InteractionFragment, gen_UML2WithID_InteractionConstraint_Constraint, gen_UML2WithID_Pseudostate_Vertex, gen_UML2WithID_State_Namespace, gen_UML2WithID_State_RedefinableElement, gen_UML2WithID_State_Vertex, gen_UML2WithID_Continuation_InteractionFragment, gen_UML2WithID_StateMachine_Behavior, gen_UML2WithID_Region_Namespace, gen_UML2WithID_Region_RedefinableElement, gen_UML2WithID_Vertex_NamedElement, gen_UML2WithID_ConnectionPointReference_Vertex, gen_UML2WithID_Transition_RedefinableElement, gen_UML2WithID_CreateObjectAction_Action, gen_UML2WithID_DestroyObjectAction_Action, gen_UML2WithID_TestIdentityAction_Action, gen_UML2WithID_ReadSelfAction_Action, gen_UML2WithID_FinalState_State, gen_UML2WithID_LinkAction_Action, gen_UML2WithID_LinkEndData_Element, gen_UML2WithID_StructuralFeatureAction_Action, gen_UML2WithID_ReadStructuralFeatureAction_StructuralFeatureAction, gen_UML2WithID_WriteStructuralFeatureAction_StructuralFeatureAction, gen_UML2WithID_ClearStructuralFeatureAction_StructuralFeatureAction, gen_UML2WithID_RemoveStructuralFeatureValueAction_WriteStructuralFeatureAction, gen_UML2WithID_AddStructuralFeatureValueAction_WriteStructuralFeatureAction, gen_UML2WithID_ReadVariableAction_VariableAction, gen_UML2WithID_WriteVariableAction_VariableAction, gen_UML2WithID_ClearVariableAction_VariableAction, gen_UML2WithID_AddVariableValueAction_WriteVariableAction, gen_UML2WithID_ReadLinkAction_LinkAction, gen_UML2WithID_LinkEndCreationData_LinkEndData, gen_UML2WithID_CreateLinkAction_WriteLinkAction, gen_UML2WithID_WriteLinkAction_LinkAction, gen_UML2WithID_DestroyLinkAction_WriteLinkAction, gen_UML2WithID_ClearAssociationAction_Action, gen_UML2WithID_VariableAction_Action, gen_UML2WithID_InvocationAction_Action, gen_UML2WithID_SendSignalAction_InvocationAction, gen_UML2WithID_RemoveVariableValueAction_WriteVariableAction, gen_UML2WithID_ApplyFunctionAction_Action, gen_UML2WithID_PrimitiveFunction_PackageableElement, gen_UML2WithID_CallAction_InvocationAction, gen_UML2WithID_Duration_ValueSpecification, gen_UML2WithID_TimeObservationAction_WriteStructuralFeatureAction, gen_UML2WithID_DurationInterval_Interval, gen_UML2WithID_Interval_ValueSpecification, gen_UML2WithID_TimeConstraint_IntervalConstraint, gen_UML2WithID_IntervalConstraint_Constraint, gen_UML2WithID_TimeInterval_Interval, gen_UML2WithID_BroadcastSignalAction_InvocationAction, gen_UML2WithID_DurationObservationAction_WriteStructuralFeatureAction, gen_UML2WithID_SendObjectAction_InvocationAction, gen_UML2WithID_CallOperationAction_CallAction, gen_UML2WithID_CallBehaviorAction_CallAction, gen_UML2WithID_TimeExpression_ValueSpecification, gen_UML2WithID_ParameterSet_NamedElement, gen_UML2WithID_Component_Class, gen_UML2WithID_DurationConstraint_IntervalConstraint, gen_UML2WithID_DataStoreNode_CentralBufferNode, gen_UML2WithID_InterruptibleActivityRegion_ActivityGroup, gen_UML2WithID_DeployedArtifact_NamedElement, gen_UML2WithID_DeploymentTarget_NamedElement, gen_UML2WithID_Node_Class, gen_UML2WithID_Node_DeploymentTarget, gen_UML2WithID_Device_Node, gen_UML2WithID_Deployment_Dependency, gen_UML2WithID_ReadExtentAction_Action, gen_UML2WithID_ReclassifyObjectAction_Action, gen_UML2WithID_ExecutionEnvironment_Node, gen_UML2WithID_CommunicationPath_Association, gen_UML2WithID_ProtocolConformance_DirectedRelationship, gen_UML2WithID_ProtocolStateMachine_StateMachine, gen_UML2WithID_ProtocolTransition_Transition, gen_UML2WithID_QualifierValue_Element, gen_UML2WithID_ReadLinkObjectEndAction_Action, gen_UML2WithID_ReadIsClassifiedObjectAction_Action, gen_UML2WithID_StartOwnedBehaviorAction_Action, gen_UML2WithID_ReplyAction_Action, gen_UML2WithID_RaiseExceptionAction_Action, gen_UML2WithID_ReadLinkObjectEndQualifierAction_Action, gen_UML2WithID_CreateLinkObjectAction_CreateLinkAction, gen_UML2WithID_AcceptEventAction_Action, gen_UML2WithID_AcceptCallAction_AcceptEventAction, gen_UML2WithID_DeploymentSpecification_Artifact},
    metadata=None
)
