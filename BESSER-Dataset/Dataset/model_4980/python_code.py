...
class cloudml_core_VMInstance(ExternalComponentInstance):
    ...
    def __init__(self, publicAddress: str, cloudml_core_VMInstance: set["VMPortInstance"] = None, ExternalComponentInstance: "cloudml_core_CloudMLModel" = None):
...
class cloudml_core_VM(ExternalComponent):
    ...
    def __init__(self, minRam: int, maxRam: int, minCores: int, maxCores: int, minStorage: int, maxStorage: int, os: str, is64os: bool, imageId: str, securityGroup: str, sshKey: str, privateKey: str, groupName: str, cloudml_core_VM: set["VMPort"] = None, ExternalComponent: "cloudml_core_CloudMLModel" = None):
        self.minRam = minRam
        self.maxRam = maxRam
...
class cloudml_core_ExternalComponentInstance(ComponentInstance):
    ...
    def __init__(self, ips: str, cloudml_core_ExternalComponentInstance: set["VMPortInstance"] = None, ComponentInstance68: "cloudml_core_PortInstance" = None, ComponentInstance: "cloudml_core_CloudMLModel" = None, ComponentInstance87: "cloudml_core_ExecutionPlatformInstance" = None):
        self.ips = ips
...
class cloudml_core_ExternalComponent(Component):
    ...
    def __init__(self, endPoint: str, login: str, passwd: str, location: str, serviceType: str, Region: str, cloudml_core_ExternalComponent: "Provider" = None, cloudml_core_ExternalComponent80: set["VMPort"] = None, Component59: "cloudml_core_ComponentInstance" = None, Component: "cloudml_core_CloudMLModel" = None, Component39: "cloudml_core_Port" = None, Component85: "cloudml_core_ExecutionPlatform" = None):
