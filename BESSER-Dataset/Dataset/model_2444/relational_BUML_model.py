...
# Classes
relationalmm_Named = Class(name="relationalmm_Named")
relationalmm_Table = Class(name="relationalmm_Table")
Named = Class(name="Named")
relationalmm_Column = Class(name="relationalmm_Column")
relationalmm_Type = Class(name="relationalmm_Type")
...
domain_model = DomainModel(
    ...
    associations={key1, type2, owner4, col0},
