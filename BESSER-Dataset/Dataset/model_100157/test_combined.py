...
def test_hyp_arrayexpression_is_not_abstract():
    assert not inspect.isabstract(ArrayExpression)


def test_hyp_arrayexpression_constructor_exists():
    assert callable(ArrayExpression.__init__)


def test_hyp_arrayexpression_constructor_args():
    sig = inspect.signature(ArrayExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_query_longarrayexpression_is_not_abstract():
    assert not inspect.isabstract(query_LongArrayExpression)


def test_hyp_query_longarrayexpression_constructor_exists():
    assert callable(query_LongArrayExpression.__init__)


def test_hyp_query_longarrayexpression_constructor_args():
...
def test_hyp_query_nullarrayexpression_is_not_abstract():
    assert not inspect.isabstract(query_NullArrayExpression)


def test_hyp_query_nullarrayexpression_constructor_exists():
    assert callable(query_NullArrayExpression.__init__)


def test_hyp_query_nullarrayexpression_constructor_args():
...
def test_hyp_query_datearrayexpression_is_not_abstract():
    assert not inspect.isabstract(query_DateArrayExpression)


def test_hyp_query_datearrayexpression_constructor_exists():
    assert callable(query_DateArrayExpression.__init__)


def test_hyp_query_datearrayexpression_constructor_args():
...
def test_hyp_query_booleanarrayexpression_is_not_abstract():
    assert not inspect.isabstract(query_BooleanArrayExpression)


def test_hyp_query_booleanarrayexpression_constructor_exists():
    assert callable(query_BooleanArrayExpression.__init__)


def test_hyp_query_booleanarrayexpression_constructor_args():
...
def test_hyp_query_stringarrayexpression_is_not_abstract():
    assert not inspect.isabstract(query_StringArrayExpression)


def test_hyp_query_stringarrayexpression_constructor_exists():
    assert callable(query_StringArrayExpression.__init__)


def test_hyp_query_stringarrayexpression_constructor_args():
...
def test_hyp_query_doublearrayexpression_is_not_abstract():
    assert not inspect.isabstract(query_DoubleArrayExpression)


def test_hyp_query_doublearrayexpression_constructor_exists():
    assert callable(query_DoubleArrayExpression.__init__)


def test_hyp_query_doublearrayexpression_constructor_args():
...
def test_hyp_query_arrayexpression_is_not_abstract():
    assert not inspect.isabstract(query_ArrayExpression)


def test_hyp_query_arrayexpression_constructor_exists():
    assert callable(query_ArrayExpression.__init__)


def test_hyp_query_arrayexpression_constructor_args():
...
def test_hyp_query_dateexpression_is_not_abstract():
    assert not inspect.isabstract(query_DateExpression)


def test_hyp_query_dateexpression_constructor_exists():
    assert callable(query_DateExpression.__init__)


def test_hyp_query_dateexpression_constructor_args():
...
def test_hyp_query_longexpression_is_not_abstract():
    assert not inspect.isabstract(query_LongExpression)


def test_hyp_query_longexpression_constructor_exists():
    assert callable(query_LongExpression.__init__)


def test_hyp_query_longexpression_constructor_args():
...
def test_hyp_query_booleanexpression_is_not_abstract():
    assert not inspect.isabstract(query_BooleanExpression)


def test_hyp_query_booleanexpression_constructor_exists():
    assert callable(query_BooleanExpression.__init__)


def test_hyp_query_booleanexpression_constructor_args():
...
def test_hyp_query_stringexpression_is_not_abstract():
    assert not inspect.isabstract(query_StringExpression)


def test_hyp_query_stringexpression_constructor_exists():
    assert callable(query_StringExpression.__init__)


def test_hyp_query_stringexpression_constructor_args():
...
def test_hyp_query_nullexpression_is_not_abstract():
    assert not inspect.isabstract(query_NullExpression)


def test_hyp_query_nullexpression_constructor_exists():
    assert callable(query_NullExpression.__init__)


def test_hyp_query_nullexpression_constructor_args():
...
def test_hyp_query_doubleexpression_is_not_abstract():
    assert not inspect.isabstract(query_DoubleExpression)


def test_hyp_query_doubleexpression_constructor_exists():
    assert callable(query_DoubleExpression.__init__)


def test_hyp_query_doubleexpression_constructor_args():
...
def test_hyp_query_replacablevalue_is_not_abstract():
    assert not inspect.isabstract(query_ReplacableValue)


def test_hyp_query_replacablevalue_constructor_exists():
    assert callable(query_ReplacableValue.__init__)


def test_hyp_query_replacablevalue_constructor_args():
...
def test_hyp_query_expression_is_not_abstract():
    assert not inspect.isabstract(query_Expression)


def test_hyp_query_expression_constructor_exists():
    assert callable(query_Expression.__init__)


def test_hyp_query_expression_constructor_args():
    sig = inspect.signature(query_Expression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_expressionwhereentry_is_not_abstract():
    assert not inspect.isabstract(ExpressionWhereEntry)


def test_hyp_expressionwhereentry_constructor_exists():
    assert callable(ExpressionWhereEntry.__init__)


def test_hyp_expressionwhereentry_constructor_args():
    sig = inspect.signature(ExpressionWhereEntry.__init__)
    params = list(sig.parameters.keys())



def test_hyp_query_multiexpressionwhereentry_is_not_abstract():
    assert not inspect.isabstract(query_MultiExpressionWhereEntry)


def test_hyp_query_multiexpressionwhereentry_constructor_exists():
    assert callable(query_MultiExpressionWhereEntry.__init__)


def test_hyp_query_multiexpressionwhereentry_constructor_args():
...
def test_hyp_query_singleexpressionwhereentry_is_not_abstract():
    assert not inspect.isabstract(query_SingleExpressionWhereEntry)


def test_hyp_query_singleexpressionwhereentry_constructor_exists():
    assert callable(query_SingleExpressionWhereEntry.__init__)


def test_hyp_query_singleexpressionwhereentry_constructor_args():
...
def test_hyp_whereentry_is_not_abstract():
    assert not inspect.isabstract(WhereEntry)


def test_hyp_whereentry_constructor_exists():
    assert callable(WhereEntry.__init__)


def test_hyp_whereentry_constructor_args():
    sig = inspect.signature(WhereEntry.__init__)
    params = list(sig.parameters.keys())



def test_hyp_query_andwhereentry_is_not_abstract():
    assert not inspect.isabstract(query_AndWhereEntry)


def test_hyp_query_andwhereentry_constructor_exists():
    assert callable(query_AndWhereEntry.__init__)


def test_hyp_query_andwhereentry_constructor_args():
    sig = inspect.signature(query_AndWhereEntry.__init__)
    params = list(sig.parameters.keys())



def test_hyp_query_orwhereentry_is_not_abstract():
    assert not inspect.isabstract(query_OrWhereEntry)


def test_hyp_query_orwhereentry_constructor_exists():
    assert callable(query_OrWhereEntry.__init__)


def test_hyp_query_orwhereentry_constructor_args():
    sig = inspect.signature(query_OrWhereEntry.__init__)
    params = list(sig.parameters.keys())



def test_hyp_query_expressionwhereentry_is_not_abstract():
    assert not inspect.isabstract(query_ExpressionWhereEntry)


def test_hyp_query_expressionwhereentry_constructor_exists():
    assert callable(query_ExpressionWhereEntry.__init__)


def test_hyp_query_expressionwhereentry_constructor_args():
...
def test_hyp_query_whereentry_is_not_abstract():
    assert not inspect.isabstract(query_WhereEntry)


def test_hyp_query_whereentry_constructor_exists():
    assert callable(query_WhereEntry.__init__)


def test_hyp_query_whereentry_constructor_args():
    sig = inspect.signature(query_WhereEntry.__init__)
    params = list(sig.parameters.keys())



def test_hyp_query_database_is_not_abstract():
    assert not inspect.isabstract(query_Database)


def test_hyp_query_database_constructor_exists():
    assert callable(query_Database.__init__)


def test_hyp_query_database_constructor_args():
...
def test_hyp_query_longarrayexpression_values_setter(instance):
...
def test_hyp_query_nullarrayexpression_values_setter(instance):
    original = instance.values
    instance.values = original
    assert instance.values == original
...
def test_hyp_query_datearrayexpression_values_setter(instance):
    original = instance.values
    instance.values = original
    assert instance.values == original
...
def test_hyp_query_booleanarrayexpression_values_setter(instance):
    original = instance.values
    instance.values = original
    assert instance.values == original
...
def test_hyp_query_stringarrayexpression_values_setter(instance):
    original = instance.values
    instance.values = original
    assert instance.values == original
...
def test_hyp_query_doublearrayexpression_values_setter(instance):
    original = instance.values
    instance.values = original
    assert instance.values == original
...
def test_hyp_query_dateexpression_value_setter(instance):
...
def test_hyp_query_longexpression_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_query_booleanexpression_true_setter(instance):
...
def test_hyp_query_stringexpression_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_query_nullexpression_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_query_doubleexpression_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_query_replacablevalue_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_query_multiexpressionwhereentry_operator_setter(instance):
...
def test_hyp_query_singleexpressionwhereentry_operator_setter(instance):
    original = instance.operator
    instance.operator = original
    assert instance.operator == original
...
def test_hyp_query_expressionwhereentry_name_setter(instance):
...
def test_hyp_query_database_dbName_setter(instance):
...
@given(instance=query_Database_strategy)
def test_hyp_query_database_url_setter(instance):
...
@given(instance=query_Database_strategy)
def test_hyp_query_database_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=query_Database_strategy)
def test_hyp_query_database_port_setter(instance):
...
def test_hyp_query_model_attrs_setter(instance):
