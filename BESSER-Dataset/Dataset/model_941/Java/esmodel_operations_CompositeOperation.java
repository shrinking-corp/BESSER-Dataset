...
public class esmodel_operations_CompositeOperation extends AbstractOperation {
    ...
    public esmodel_operations_CompositeOperation(
        String compositeDescription,        boolean reversed,        String compositeName    ) {
        super(
        );
    ...
    public esmodel_operations_CompositeOperation(
        String compositeDescription,        boolean reversed,        String compositeName        ArrayList<operations_AbstractOperation> operations_abstractoperations    ) {
        this.compositeDescription = compositeDescription;
        this.reversed = reversed;
        this.compositeName = compositeName;
