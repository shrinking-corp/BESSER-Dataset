...
domain_model = DomainModel(
    name="mindstorms",
    types={mindstorms_Action, mindstorms_Grab, Action, mindstorms_Release, mindstorms_Rotate, mindstorms_GoForward, mindstorms_Instruction, mindstorms_Choreography, Instruction},
    associations={instructions0},
    generalizations={gen_mindstorms_Action_Instruction, gen_mindstorms_Grab_Action, gen_mindstorms_Release_Action, gen_mindstorms_Rotate_Action, gen_mindstorms_GoForward_Action, gen_mindstorms_Choreography_Instruction},
    metadata=None
)
