...
# Classes
completeoclcs_ClassifierContextDeclCS = Class(name="completeoclcs_ClassifierContextDeclCS")
ContextDeclCS = Class(name="ContextDeclCS")
TemplateableElementCS = Class(name="TemplateableElementCS")
completeoclcs_DefCS = Class(name="completeoclcs_DefCS", is_abstract=True)
completeoclcs_ConstraintCS = Class(name="completeoclcs_ConstraintCS")
completeoclcs_Class = Class(name="completeoclcs_Class")
completeoclcs_CompleteOCLDocumentCS = Class(name="completeoclcs_CompleteOCLDocumentCS")
NamespaceCS = Class(name="NamespaceCS")
RootCS = Class(name="RootCS")
completeoclcs_ContextDeclCS = Class(name="completeoclcs_ContextDeclCS", is_abstract=True)
completeoclcs_PackageDeclarationCS = Class(name="completeoclcs_PackageDeclarationCS")
PathNameDeclCS = Class(name="PathNameDeclCS")
TypedElementCS = Class(name="TypedElementCS")
completeoclcs_ExpSpecificationCS = Class(name="completeoclcs_ExpSpecificationCS")
completeoclcs_FeatureContextDeclCS = Class(name="completeoclcs_FeatureContextDeclCS", is_abstract=True)
completeoclcs_TypedRefCS = Class(name="completeoclcs_TypedRefCS")
completeoclcs_OCLMessageArgCS = Class(name="completeoclcs_OCLMessageArgCS")
ExpCS = Class(name="ExpCS")
completeoclcs_OperationContextDeclCS = Class(name="completeoclcs_OperationContextDeclCS")
FeatureContextDeclCS = Class(name="FeatureContextDeclCS")
completeoclcs_VariableCS = Class(name="completeoclcs_VariableCS")
completeoclcs_Operation = Class(name="completeoclcs_Operation")
completeoclcs_Package = Class(name="completeoclcs_Package")
completeoclcs_PathNameDeclCS = Class(name="completeoclcs_PathNameDeclCS", is_abstract=True)
ModelElementCS = Class(name="ModelElementCS")
MorePivotable = Class(name="MorePivotable")
completeoclcs_PathNameCS = Class(name="completeoclcs_PathNameCS")
completeoclcs_PropertyContextDeclCS = Class(name="completeoclcs_PropertyContextDeclCS")
completeoclcs_Property = Class(name="completeoclcs_Property")
completeoclcs_DefOperationCS = Class(name="completeoclcs_DefOperationCS")
DefCS = Class(name="DefCS")
completeoclcs_ParameterCS = Class(name="completeoclcs_ParameterCS")
completeoclcs_DefPropertyCS = Class(name="completeoclcs_DefPropertyCS")
...
domain_model = DomainModel(
    name="completeoclcs",
    types={completeoclcs_ClassifierContextDeclCS, ContextDeclCS, TemplateableElementCS, completeoclcs_DefCS, completeoclcs_ConstraintCS, completeoclcs_Class, completeoclcs_CompleteOCLDocumentCS, NamespaceCS, RootCS, completeoclcs_ContextDeclCS, completeoclcs_PackageDeclarationCS, PathNameDeclCS, TypedElementCS, completeoclcs_ExpSpecificationCS, completeoclcs_FeatureContextDeclCS, completeoclcs_TypedRefCS, completeoclcs_OCLMessageArgCS, ExpCS, completeoclcs_OperationContextDeclCS, FeatureContextDeclCS, completeoclcs_VariableCS, completeoclcs_Operation, completeoclcs_Package, completeoclcs_PathNameDeclCS, ModelElementCS, MorePivotable, completeoclcs_PathNameCS, completeoclcs_PropertyContextDeclCS, completeoclcs_Property, completeoclcs_DefOperationCS, DefCS, completeoclcs_ParameterCS, completeoclcs_DefPropertyCS},
    associations={ownedDefinitions0, ownedInvariants1, referredClass2, ownedContexts4, ownedPackages5, ownedSpecification7, owningClassifierContextDecl8, ownedType10, ownedBodies11, ownedParameters13, ownedPostconditions16, ownedPreconditions19, ownedResult22, referredOperation24, ownedContexts26, ownedInvariants29, referredPackage32, ownedPathName34, ownedDefaultExpressions35, ownedDerivedInvariants37, ownedParameters9, referredProperty40},
    generalizations={gen_completeoclcs_ClassifierContextDeclCS_ContextDeclCS, gen_completeoclcs_ClassifierContextDeclCS_TemplateableElementCS, gen_completeoclcs_CompleteOCLDocumentCS_NamespaceCS, gen_completeoclcs_CompleteOCLDocumentCS_RootCS, gen_completeoclcs_ContextDeclCS_PathNameDeclCS, gen_completeoclcs_DefCS_TypedElementCS, gen_completeoclcs_DefPropertyCS_DefCS, gen_completeoclcs_FeatureContextDeclCS_ContextDeclCS, gen_completeoclcs_OCLMessageArgCS_ExpCS, gen_completeoclcs_OperationContextDeclCS_FeatureContextDeclCS, gen_completeoclcs_OperationContextDeclCS_TemplateableElementCS, gen_completeoclcs_PackageDeclarationCS_PathNameDeclCS, gen_completeoclcs_PathNameDeclCS_ModelElementCS, gen_completeoclcs_PathNameDeclCS_MorePivotable, gen_completeoclcs_PropertyContextDeclCS_FeatureContextDeclCS, gen_completeoclcs_DefOperationCS_DefCS, gen_completeoclcs_DefOperationCS_TemplateableElementCS},
    metadata=None
)
