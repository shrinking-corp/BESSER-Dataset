...
class NamespaceCS:
    ...
    pass
class completeoclcs_CompleteOCLDocumentCS(NamespaceCS, RootCS):
...
class TemplateableElementCS:
    ...
    pass
class completeoclcs_DefOperationCS(TemplateableElementCS, DefCS):
...
class completeoclcs_FeatureContextDeclCS(ContextDeclCS):
    ...
    pass
class completeoclcs_ClassifierContextDeclCS(TemplateableElementCS, ContextDeclCS):

    def __init__(self, selfName: str, owningClassifierContextDecl: set["completeoclcs_DefCS"] = None, completeoclcs_ClassifierContextDeclCS: set["completeoclcs_ConstraintCS"] = None, completeoclcs_ClassifierContextDeclCS3: "completeoclcs_Class" = None, ClassifierContextDeclCS: "completeoclcs_DefCS" = None):
