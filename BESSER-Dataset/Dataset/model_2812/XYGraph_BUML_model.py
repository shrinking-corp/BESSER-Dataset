...
# Classes
xygraph_XYGraphDescriptor = Class(name="xygraph_XYGraphDescriptor")
xygraph_ColorDescriptor = Class(name="xygraph_ColorDescriptor")
xygraph_AxisDescriptor = Class(name="xygraph_AxisDescriptor")
xygraph_TraceDescriptor = Class(name="xygraph_TraceDescriptor")
xygraph_FontDescriptor = Class(name="xygraph_FontDescriptor")
xygraph_EObject = Class(name="xygraph_EObject")
...
xygraph_XYGraphDescriptor.attributes={xygraph_XYGraphDescriptor_title, xygraph_XYGraphDescriptor_showLegend, xygraph_XYGraphDescriptor_showTitle, xygraph_XYGraphDescriptor_transparent, xygraph_XYGraphDescriptor_zoomType, xygraph_XYGraphDescriptor_showPlotAreaBorder}
...
xygraph_ColorDescriptor.attributes={xygraph_ColorDescriptor_g, xygraph_ColorDescriptor_r, xygraph_ColorDescriptor_b}
...
xygraph_AxisDescriptor.attributes={xygraph_AxisDescriptor_formatPattern, xygraph_AxisDescriptor_autoScale, xygraph_AxisDescriptor_primarySide, xygraph_AxisDescriptor_rangeUpper, xygraph_AxisDescriptor_logScale, xygraph_AxisDescriptor_orientation, xygraph_AxisDescriptor_showMinorGrid, xygraph_AxisDescriptor_showMajorGrid, xygraph_AxisDescriptor_zoomType, xygraph_AxisDescriptor_autoScaleThreshold, xygraph_AxisDescriptor_dashGridLine, xygraph_AxisDescriptor_minorTicksVisible, xygraph_AxisDescriptor_autoFormat, xygraph_AxisDescriptor_dateEnabled, xygraph_AxisDescriptor_title, xygraph_AxisDescriptor_rangeLower}
...
xygraph_TraceDescriptor.attributes={xygraph_TraceDescriptor_errorBarEnabled, xygraph_TraceDescriptor_yErrorBarType, xygraph_TraceDescriptor_antiAliasing, xygraph_TraceDescriptor_pointStyle, xygraph_TraceDescriptor_name, xygraph_TraceDescriptor_xErrorBarType, xygraph_TraceDescriptor_errorBarCapWidth, xygraph_TraceDescriptor_pointSize, xygraph_TraceDescriptor_baseLine, xygraph_TraceDescriptor_drawYErrorInArea, xygraph_TraceDescriptor_areaAlpha, xygraph_TraceDescriptor_traceType, xygraph_TraceDescriptor_lineWidth}
...
xygraph_FontDescriptor.attributes={xygraph_FontDescriptor_name, xygraph_FontDescriptor_style, xygraph_FontDescriptor_size}
...
domain_model = DomainModel(
    name="xygraph",
    types={xygraph_XYGraphDescriptor, xygraph_ColorDescriptor, xygraph_AxisDescriptor, xygraph_TraceDescriptor, xygraph_FontDescriptor, xygraph_EObject, ZoomType, LinearScale_Orientation, Trace_BaseLine, Trace_PointStyle, Trace_TraceType, Trace_ErrorBarType},
    associations={minorGridColor27, titleColor0, axisDescriptors1, traceDescriptors3, plotAreaBackgroundColor5, titleFont8, context10, dataSource12, visibleTraces15, backgroundColor18, foregroundColor21, majorGridColor24, titleFont30, font33, errorBarColor36, traceColor39, xAxis42, yAxis45, dataSource48},
    generalizations={},
    metadata=None
)
