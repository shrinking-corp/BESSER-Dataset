...
class eTJ_Extend:
    ...
    def __init__(self, name: str, description: str, inherit: bool, scenariospecific: bool, eTJ_Extend74: "eTJ_ExtendedTaskAttribute" = None, eTJ_Extend: "eTJ_ExtendResource" = None, eTJ_Extend70: "eTJ_ExtendedResourceAttribute" = None, eTJ_Extend72: "eTJ_ExtendTask" = None, eTJ_Extend293: "eTJ_ExtendedResourceAttributeColumn" = None):
        self.name = name
...
class eTJ_LogicalExpression:
    ...
    def __init__(self, op: str, eTJ_LogicalExpression76: "eTJ_Fail" = None, eTJ_LogicalExpression91: "eTJ_HideReport" = None, eTJ_LogicalExpression93: "eTJ_HideResource" = None, eTJ_LogicalExpression95: "eTJ_HideTask" = None, eTJ_LogicalExpression: "eTJ_CellColor" = None, eTJ_LogicalExpression58: "eTJ_CellText" = None, eTJ_LogicalExpression89: "eTJ_HAlign" = None, eTJ_LogicalExpression148: "eTJ_LogicalExpression" = None, eTJ_LogicalExpression146: "eTJ_LogicalExpression" = None, eTJ_LogicalExpression151: "eTJ_LogicalExpression" = None, eTJ_LogicalExpression149: "eTJ_LogicalExpression" = None, eTJ_LogicalExpression182: "eTJ_RollupResource" = None, eTJ_LogicalExpression184: "eTJ_RollupTask" = None, eTJ_LogicalExpression180: "eTJ_RollupAccount" = None, eTJ_LogicalExpression284: "eTJ_Warn" = None, eTJ_LogicalExpression277: "eTJ_ToolTip" = None):
        self.op = op
...
class StatusStatusSheetAttribute:
    ...
    pass
class eTJ_Details(StatusTimesheetAttribute, StatusStatusSheetAttribute):

    pass
class eTJ_Summary(StatusTimesheetAttribute, StatusStatusSheetAttribute):
...
class End:
    ...
    pass
class eTJ_MacroCall(End, Start, ExtDate):
...
class eTJ_Scenario(ProjectAttribute):
    ...
    def __init__(self, id: str, name: str, active: str, eTJ_Scenario: "eTJ_TaskAttribute" = None, eTJ_Scenario81: "eTJ_Function" = None, eTJ_Scenario187: "eTJ_Scenario" = None, eTJ_Scenario185: "eTJ_Scenario" = None, eTJ_Scenario189: "eTJ_ScenarioIcal" = None, eTJ_Scenario279: "eTJ_TrackingScenario" = None, eTJ_Scenario301: "eTJ_Criterion" = None, eTJ_Scenario191: "eTJ_Scenarios" = None, eTJ_Scenario337: "eTJ_LogicalFlagExpression" = None):
        self.id = id
        self.name = name
        self.active = active
...
class AccountReport:
    ...
    pass
class eTJ_Report(TaskReport, TextReport, ResourceReport, AccountReport):

    def __init__(self, id: str, name: str, eTJ_Report: set["eTJ_ReportAttribute"] = None, eTJ_Report172: "eTJ_ReportPrefix" = None, eTJ_Report231: "eTJ_SupplementReport" = None):
        self.id = id
        self.name = name
...
class CurrencyFormat:
    ...
    pass
class eTJ_RealFormat(NumberFormat, CurrencyFormat):

    def __init__(self, negativeSuffix: str, thousandsSeparator: str, fractionSeparator: str, fractionDigits: int, negativePrefix: str):
...
class Caption:
    ...
    pass
class eTJ_RichText(ListItem, Prolog, Left, Summary, Headline, Epilog, Right, Details, Header, Center, Caption, Footer):
...
class DailyMax:
    ...
    pass
class eTJ_Limit(MonthlyMax, WeeklyMax, DailyMin, MonthlyMin, Maximum, WeeklyMin, DailyMax, Minimum):
...
class GapDuration:
    ...
    pass
class eTJ_DurationQuantity(GapLength, GapDuration):

    def __init__(self, value: float, unit: str, eTJ_DurationQuantity104: "eTJ_Interval1" = None, eTJ_DurationQuantity113: "eTJ_Interval2" = None, eTJ_DurationQuantity122: "eTJ_Interval3" = None, eTJ_DurationQuantity144: "eTJ_Length" = None, eTJ_DurationQuantity131: "eTJ_Interval4" = None, eTJ_DurationQuantity: "eTJ_Duration" = None, eTJ_DurationQuantity65: "eTJ_Effort" = None, eTJ_DurationQuantity170: "eTJ_Remaining" = None, eTJ_DurationQuantity303: "eTJ_Limit" = None, eTJ_DurationQuantity329: "eTJ_ISODATE" = None):
        self.value = value
        self.unit = unit
...
class eTJ_Criterion:
    ...
    def __init__(self, columnId: str, direction: str, eTJ_Criterion300: "eTJ_Scenario" = None, eTJ_Criterion: "eTJ_Sort" = None):
...
class SortAccounts:
    ...
    pass
class eTJ_Sort(SortResources, SortAccounts, SortTasks, SortJournalEntries):
...
class eTJ_StatusTimesheetAttribute:
    ...
    pass
class eTJ_StatusTimesheet(TaskTimesheetAttribute, TimesheetAttribute):
...
class ReportAttribute:
    ...
    pass
class eTJ_HideTask(IcalReportAttribute, ExportAttribute, StatusSheetReportAttribute, NikuReportAttribute, ReportAttribute):
...
class eTJ_Timezone(ExportAttribute, ProjectAttribute, ReportAttribute):
...
class eTJ_End(IcalReportAttribute, StatusSheetReportAttribute, ExportAttribute, NikuReportAttribute, TimesheetReportAttribute, ColumnAttribute, NewTaskAttribute, TaskTimesheetAttribute, ReportAttribute):

    pass
class eTJ_TimeFormat(ProjectAttribute, ReportAttribute):
...
class eTJ_Start(IcalReportAttribute, StatusSheetReportAttribute, ExportAttribute, NikuReportAttribute, TimesheetReportAttribute, ColumnAttribute, ReportAttribute):
...
class eTJ_HideResource(IcalReportAttribute, ExportAttribute, StatusSheetReportAttribute, NikuReportAttribute, TimesheetReportAttribute, ReportAttribute):
...
class eTJ_Caption(ReportAttribute):
    ...
    pass
class eTJ_Period(IcalReportAttribute, ExportAttribute, StatusSheetReportAttribute, NikuReportAttribute, TimesheetReportAttribute, ColumnAttribute, ReportAttribute):
...
class eTJ_Center(ReportAttribute):
    ...
    pass
class eTJ_CurrencyFormat(ProjectAttribute, ReportAttribute):

    pass
class eTJ_Title(ColumnAttribute, ReportAttribute, NikuReportAttribute):
...
class eTJ_JournalEntry(ResourceAttribute, ProjectAttribute):
    ...
    def __init__(self, headline: str, eTJ_JournalEntry: "eTJ_ISODATE" = None, eTJ_JournalEntry135: "eTJ_Alert" = None, eTJ_JournalEntry137: "eTJ_Author" = None, eTJ_JournalEntry140: "eTJ_Details" = None, eTJ_JournalEntry142: "eTJ_Summary" = None):
...
class eTJ_Task(Property):
    ...
    def __init__(self, id: str, name: str, eTJ_Task: set["eTJ_TaskAttribute"] = None, eTJ_Task50: "eTJ_BookingResource" = None, eTJ_Task84: "eTJ_Function" = None, eTJ_Task265: "eTJ_TaskPrefix" = None, eTJ_Task267: "eTJ_TaskRoot" = None, eTJ_Task320: "eTJ_TaskDependency" = None, eTJ_Task241: "eTJ_SupplementTask" = None, eTJ_Task257: "eTJ_TaskStatusSheet" = None, eTJ_Task261: "eTJ_TaskTimesheet" = None):
        self.id = id
        self.name = name
...
class eTJ_Account(Property, AccountAttribute):
    ...
    def __init__(self, id: str, name: str, eTJ_Account8: "eTJ_AccountPrefix" = None, eTJ_Account10: "eTJ_AccountRoot" = None, eTJ_Account: set["eTJ_AccountAttribute"] = None, eTJ_Account39: "eTJ_Balance" = None, eTJ_Account42: "eTJ_Balance" = None, eTJ_Account291: "eTJ_AccountShare" = None, eTJ_Account226: "eTJ_SupplementAccount" = None):
        self.id = id
        self.name = name
...
class eTJ_Flags(StatusStatusSheetAttribute, StatusTimesheetAttribute, ResourceAttribute, Property, AccountAttribute, ReportAttribute):
...
class eTJ_Resource(ResourceAttribute, Property):

    def __init__(self, id: str, name: str, eTJ_Resource35: "eTJ_Alternative" = None, eTJ_Resource37: "eTJ_Author" = None, eTJ_Resource: set["eTJ_ResourceAttribute"] = None, eTJ_Resource28: "eTJ_AllocateResource" = None, eTJ_Resource156: "eTJ_Managers" = None, eTJ_Resource45: "eTJ_BookingTask" = None, eTJ_Resource87: "eTJ_Function" = None, eTJ_Resource174: "eTJ_ResourcePrefix" = None, eTJ_Resource176: "eTJ_ResourceRoot" = None, eTJ_Resource178: "eTJ_Responsible" = None, eTJ_Resource269: "eTJ_Timesheet" = None, eTJ_Resource236: "eTJ_SupplementResource" = None, eTJ_Resource218: "eTJ_StatusSheet" = None, eTJ_Resource314: "eTJ_LimitAttribute" = None):
        self.id = id
        self.name = name
...
class eTJ_Shift(Property):
    ...
    def __init__(self, timezone: str, id: str, name: str, replace: str, eTJ_Shift199: "eTJ_ShiftTimesheet" = None, eTJ_Shift203: "eTJ_ShiftsLimit" = None, eTJ_Shift: "eTJ_Vacation" = None, eTJ_Shift195: "eTJ_Shift" = None, eTJ_Shift193: "eTJ_Shift" = None, eTJ_Shift197: "eTJ_WorkingHours" = None, eTJ_Shift208: "eTJ_ShiftsAllocate" = None):
        self.timezone = timezone
        self.id = id
        self.name = name
...
class eTJ_CellColor(Property, ColumnAttribute):
    ...
    pass
class eTJ_SupplementResource(ResourceAttribute, Property):
...
class eTJ_TagFile(Property):
    ...
    def __init__(self, id: str, filename: str, eTJ_TagFile: "eTJ_HideResource" = None, eTJ_TagFile248: "eTJ_HideTask" = None, eTJ_TagFile251: "eTJ_RollupResource" = None, eTJ_TagFile254: "eTJ_RollupTask" = None):
        self.id = id
        self.filename = filename
...
class eTJ_TaskReport(Property, ReportAttribute):
    ...
    pass
class eTJ_Leaves(ResourceAttribute, Property):
