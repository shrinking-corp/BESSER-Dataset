...
class extlibrary_Book(_9M9ys29IEeGekPcBm25hwQ, _15LbQG60EeGkd4g88tZXfA):
    ...
    def __init__(self, category: str, subtitle: str, pages: int, extlibrary_Book: "extlibrary__15CRUW60EeGkd4g88tZXfA" = None):
...
class extlibrary_Person(_15OelG60EeGkd4g88tZXfA):
    ...
    def __init__(self, familyName: str, firstName: str):
