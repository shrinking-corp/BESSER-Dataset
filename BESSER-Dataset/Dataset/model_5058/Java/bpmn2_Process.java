...
public class bpmn2_Process extends CallableElement, FlowElementsContainer {
    ...
    public bpmn2_Process(
        String processType,        boolean isClosed,        boolean isExecutable        ArrayList<bpmn2_Process> bpmn2_processs,        ArrayList<bpmn2_CorrelationSubscription> bpmn2_correlationsubscriptions,        ArrayList<bpmn2_ResourceRole> bpmn2_resourceroles,        ArrayList<bpmn2_Artifact> bpmn2_artifacts    ) {
        this.processType = processType;
        this.isClosed = isClosed;
        this.isExecutable = isExecutable;
