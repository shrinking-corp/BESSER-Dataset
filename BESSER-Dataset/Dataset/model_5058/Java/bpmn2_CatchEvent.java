...
public class bpmn2_CatchEvent extends Event {
    ...
    public bpmn2_CatchEvent(
        boolean parallelMultiple        ArrayList<bpmn2_EventDefinition> bpmn2_eventdefinitions,        ArrayList<bpmn2_EventDefinition> bpmn2_eventdefinitions,        ArrayList<bpmn2_DataOutput> bpmn2_dataoutputs,        ArrayList<bpmn2_DataOutputAssociation> bpmn2_dataoutputassociations    ) {
        this.parallelMultiple = parallelMultiple;
