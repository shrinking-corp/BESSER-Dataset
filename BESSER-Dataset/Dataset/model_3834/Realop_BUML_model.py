...
# Classes
realop_IsRealised = Class(name="realop_IsRealised")
realop_Realop = Class(name="realop_Realop")
realop_Operator = Class(name="realop_Operator")
realop_Expression = Class(name="realop_Expression")
realop_OrExp = Class(name="realop_OrExp")
Expression = Class(name="Expression")
realop_AndExp = Class(name="realop_AndExp")
realop_XorExp = Class(name="realop_XorExp")
realop_NotExp = Class(name="realop_NotExp")
realop_IsPositive = Class(name="realop_IsPositive")
realop_IsNegative = Class(name="realop_IsNegative")
...
domain_model = DomainModel(
    name="realop",
    types={realop_IsRealised, realop_Realop, realop_Operator, realop_Expression, realop_OrExp, Expression, realop_AndExp, realop_XorExp, realop_NotExp, realop_IsPositive, realop_IsNegative},
