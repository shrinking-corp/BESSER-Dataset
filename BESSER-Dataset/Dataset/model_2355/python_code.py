...
class rdbmsMM_Column(RModelElement):
    ...
    def __init__(self, type: str, Column: "rdbmsMM_ForeignKey" = None, Column16: "rdbmsMM_Key" = None, column: "rdbmsMM_Table" = None, column2: set["rdbmsMM_Key"] = None, column4: set["rdbmsMM_ForeignKey"] = None, Column23: "rdbmsMM_Table" = None):
        self.type = type
        self.Column = Column
