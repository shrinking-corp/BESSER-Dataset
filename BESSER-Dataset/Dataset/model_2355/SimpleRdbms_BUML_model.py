...
# Classes
rdbmsMM_Column = Class(name="rdbmsMM_Column")
RModelElement = Class(name="RModelElement")
rdbmsMM_RModelElement = Class(name="rdbmsMM_RModelElement", is_abstract=True)
rdbmsMM_Table = Class(name="rdbmsMM_Table")
rdbmsMM_Key = Class(name="rdbmsMM_Key")
rdbmsMM_ForeignKey = Class(name="rdbmsMM_ForeignKey")
rdbmsMM_Schema = Class(name="rdbmsMM_Schema")
...
domain_model = DomainModel(
    name="rdbmsMM",
    types={rdbmsMM_Column, RModelElement, rdbmsMM_RModelElement, rdbmsMM_Table, rdbmsMM_Key, rdbmsMM_ForeignKey, rdbmsMM_Schema},
    associations={refersTo6, owner8, column10, owner12, column14, referedBy17, tables19, owner0, key1, foreignKey3, schema5, schema21, column22, key24, foreignKey27},
    generalizations={gen_rdbmsMM_Key_RModelElement, gen_rdbmsMM_Schema_RModelElement, gen_rdbmsMM_Table_RModelElement, gen_rdbmsMM_Column_RModelElement, gen_rdbmsMM_ForeignKey_RModelElement},
    metadata=None
)
