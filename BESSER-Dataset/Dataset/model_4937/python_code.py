...
class webapp_Link(NormalControl, Control):
...
class webapp_ListElement:
    ...
    def __init__(self, value: str, webapp_ListElement11: "webapp_RadioButton" = None, webapp_ListElement: "webapp_DropDownList" = None):
        self.value = value
