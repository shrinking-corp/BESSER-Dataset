...
# Classes
webapp_Page = Class(name="webapp_Page", is_abstract=True)
webapp_ListElement = Class(name="webapp_ListElement")
webapp_RadioButton = Class(name="webapp_RadioButton")
webapp_FormPage = Class(name="webapp_FormPage")
Page = Class(name="Page")
webapp_Control = Class(name="webapp_Control", is_abstract=True)
webapp_NormalPage = Class(name="webapp_NormalPage")
webapp_NormalControl = Class(name="webapp_NormalControl", is_abstract=True)
webapp_Label = Class(name="webapp_Label")
Control = Class(name="Control")
NormalControl = Class(name="NormalControl")
webapp_Link = Class(name="webapp_Link")
webapp_TextBox = Class(name="webapp_TextBox")
webapp_DropDownList = Class(name="webapp_DropDownList")
webapp_CheckBox = Class(name="webapp_CheckBox")
webapp_DynamicWebApp = Class(name="webapp_DynamicWebApp")
webapp_FormButton = Class(name="webapp_FormButton", is_abstract=True)
webapp_ResetButton = Class(name="webapp_ResetButton")
FormButton = Class(name="FormButton")
webapp_NormalButton = Class(name="webapp_NormalButton")
webapp_PasswordBox = Class(name="webapp_PasswordBox")
TextBox = Class(name="TextBox")
webapp_EmailBox = Class(name="webapp_EmailBox")
webapp_DateBox = Class(name="webapp_DateBox")
webapp_SubmitButton = Class(name="webapp_SubmitButton")
...
webapp_Page.attributes={webapp_Page_name, webapp_Page_default, webapp_Page_title}
...
webapp_TextBox.attributes={webapp_TextBox_text, webapp_TextBox_required, webapp_TextBox_size, webapp_TextBox_maxLength}
...
domain_model = DomainModel(
    name="webapp",
    types={webapp_Page, webapp_ListElement, webapp_RadioButton, webapp_FormPage, Page, webapp_Control, webapp_NormalPage, webapp_NormalControl, webapp_Label, Control, NormalControl, webapp_Link, webapp_TextBox, webapp_DropDownList, webapp_CheckBox, webapp_DynamicWebApp, webapp_FormButton, webapp_ResetButton, FormButton, webapp_NormalButton, webapp_PasswordBox, TextBox, webapp_EmailBox, webapp_DateBox, webapp_SubmitButton, DateFormat},
    associations={elements9, elements10, successTarget0, errorTarget1, controls4, controls6, destination7, pages12},
    generalizations={gen_webapp_RadioButton_Control, gen_webapp_FormPage_Page, gen_webapp_NormalPage_Page, gen_webapp_Label_Control, gen_webapp_Label_NormalControl, gen_webapp_Link_Control, gen_webapp_Link_NormalControl, gen_webapp_TextBox_Control, gen_webapp_DropDownList_Control, gen_webapp_CheckBox_Control, gen_webapp_NormalControl_Control, gen_webapp_FormButton_Control, gen_webapp_ResetButton_FormButton, gen_webapp_NormalButton_NormalControl, gen_webapp_PasswordBox_TextBox, gen_webapp_EmailBox_TextBox, gen_webapp_DateBox_TextBox, gen_webapp_SubmitButton_FormButton},
    metadata=None
)
