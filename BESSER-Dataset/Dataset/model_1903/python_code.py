...
class myDsl_JsMethodArgs:
    ...
    def __init__(self, name: str, myDsl_JsMethodArgs189: "myDsl_AxiosRequest" = None, myDsl_JsMethodArgs: "myDsl_JsMethod" = None):
        self.name = name
...
class myDsl_MethodBack:
    ...
    def __init__(self, name: str, myDsl_MethodBack100: "myDsl_NativeClass" = None, myDsl_MethodBack: "myDsl_AbstractClass" = None, myDsl_MethodBack81: "myDsl_GenericClass" = None, myDsl_MethodBack107: "myDsl_Eclass" = None, myDsl_MethodBack110: "myDsl_Eclass" = None):
        self.name = name
...
class myDsl_Attribute:
    ...
    def __init__(self, name: str, myDsl_Attribute97: "myDsl_NativeClass" = None, myDsl_Attribute102: "myDsl_Eclass" = None, myDsl_Attribute: "myDsl_AbstractClass" = None, myDsl_Attribute78: "myDsl_GenericClass" = None, myDsl_Attribute92: "myDsl_Einterface" = None):
        self.name = name
...
class myDsl_Eclass:
    ...
    def __init__(self, name: str, myDsl_Eclass: "myDsl_Attribute" = None, myDsl_Eclass105: "myDsl_Epackage" = None, myDsl_Eclass108: "myDsl_MethodBack" = None, myDsl_Eclass111: "myDsl_MethodBack" = None, myDsl_Eclass114: "myDsl_AbstractMethod" = None, myDsl_Eclass117: "myDsl_AbstractMethod" = None):
        self.name = name
...
class myDsl_JeeProject:
    ...
    def __init__(self, name: str, myDsl_JeeProject63: set["myDsl_Subproject"] = None, myDsl_JeeProject: "myDsl_JavaApp" = None):
        self.name = name
...
class myDsl_Component:
    ...
    def __init__(self, name: str, myDsl_Component: "myDsl_Architecture" = None, myDsl_Component49: set["myDsl_Layer"] = None):
        self.name = name
...
class myDsl_RouterComponent(UIComponent, AbstractFrontElement):
...
class myDsl_Directory(AbstractFrontElement):
    ...
    def __init__(self, purpose: str, name: str, myDsl_Directory: "myDsl_ReactApp" = None, myDsl_Directory161: "myDsl_File" = None, myDsl_Directory164: "myDsl_Directory" = None, myDsl_Directory162: "myDsl_Directory" = None, myDsl_Directory141: "myDsl_Functionality" = None, myDsl_Directory175: "myDsl_Action" = None, myDsl_Directory184: "myDsl_JsModule" = None):
...
class myDsl_Functionality(AbstractFrontElement):
    ...
    def __init__(self, name: str, myDsl_Functionality130: "myDsl_RouterComponent" = None, myDsl_Functionality132: "myDsl_Container" = None, myDsl_Functionality134: "myDsl_Visualizer" = None, myDsl_Functionality: "myDsl_ReactApp" = None, myDsl_Functionality136: "myDsl_State" = None, myDsl_Functionality138: "myDsl_ServiceFront" = None, myDsl_Functionality140: "myDsl_Directory" = None):
        self.name = name
...
class myDsl_ServiceFront(AbstractFrontElement):
    ...
    def __init__(self, name: str, method: str, myDsl_ServiceFront: "myDsl_Functionality" = None, myDsl_ServiceFront156: "myDsl_JsModule" = None, myDsl_ServiceFront159: set["myDsl_AxiosRequest"] = None):
        self.name = name
        self.method = method
...
class myDsl_Visualizer(UIComponent, AbstractFrontElement):
...
class myDsl_ActionDispatcher(AbstractFrontElement):
    ...
    def __init__(self, name: str, myDsl_ActionDispatcher177: "myDsl_ActionCreator" = None, myDsl_ActionDispatcher: "myDsl_Action" = None):
        self.name = name
...
class myDsl_ActionCreator(AbstractFrontElement):
    ...
    def __init__(self, name: str, type: str, myDsl_ActionCreator178: "myDsl_ActionDispatcher" = None, myDsl_ActionCreator: "myDsl_Action" = None):
        self.name = name
        self.type = type
...
class myDsl_State(AbstractFrontElement):
    ...
    def __init__(self, name: str, myDsl_State: "myDsl_Functionality" = None, myDsl_State166: "myDsl_Action" = None, myDsl_State168: "myDsl_Reducer" = None):
        self.name = name
...
class myDsl_Reducer(AbstractFrontElement):
    ...
    def __init__(self, name: str, myDsl_Reducer180: "myDsl_AbstractFrontElement" = None, myDsl_Reducer: "myDsl_State" = None):
        self.name = name
...
class myDsl_Action(AbstractFrontElement):
    ...
    def __init__(self, name: str, myDsl_Action174: "myDsl_Directory" = None, myDsl_Action: "myDsl_State" = None, myDsl_Action170: "myDsl_ActionCreator" = None, myDsl_Action172: "myDsl_ActionDispatcher" = None):
        self.name = name
...
class myDsl_EntityName:
    ...
    def __init__(self, name: str, myDsl_EntityName37: "myDsl_Operateson" = None, myDsl_EntityName40: "myDsl_RelationDom" = None, myDsl_EntityName: "myDsl_Operation" = None, myDsl_EntityName20: "myDsl_GeneralEntity" = None, myDsl_EntityName27: "myDsl_SpecialEntity" = None, myDsl_EntityName43: "myDsl_RelationDom" = None):
        self.name = name
...
class myDsl_Operation:
    ...
    def __init__(self, type: str, myDsl_Operation: "myDsl_Submodule" = None, myDsl_Operation18: set["myDsl_EntityName"] = None):
        self.type = type
