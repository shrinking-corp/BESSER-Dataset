...
# Classes
myDsl_RelationDom = Class(name="myDsl_RelationDom")
myDsl_Submodule = Class(name="myDsl_Submodule")
myDsl_System = Class(name="myDsl_System")
...
myDsl_Module = Class(name="myDsl_Module")
myDsl_Operation = Class(name="myDsl_Operation")
myDsl_EObject = Class(name="myDsl_EObject")
myDsl_EntityName = Class(name="myDsl_EntityName")
myDsl_GeneralEntity = Class(name="myDsl_GeneralEntity")
myDsl_Property = Class(name="myDsl_Property")
AbstractFrontElement = Class(name="AbstractFrontElement")
myDsl_SpecialEntity = Class(name="myDsl_SpecialEntity")
myDsl_Transaction = Class(name="myDsl_Transaction")
myDsl_Operateson = Class(name="myDsl_Operateson")
myDsl_Subproject = Class(name="myDsl_Subproject")
myDsl_Epackage = Class(name="myDsl_Epackage")
myDsl_Component = Class(name="myDsl_Component")
myDsl_RelationArch = Class(name="myDsl_RelationArch")
myDsl_Layer = Class(name="myDsl_Layer")
myDsl_LayerSegment = Class(name="myDsl_LayerSegment")
myDsl_LayerSegmentRelation = Class(name="myDsl_LayerSegmentRelation")
myDsl_SublayerSegment = Class(name="myDsl_SublayerSegment")
myDsl_JavaApp = Class(name="myDsl_JavaApp")
myDsl_ReactApp = Class(name="myDsl_ReactApp")
myDsl_JeeProject = Class(name="myDsl_JeeProject")
myDsl_Eclass = Class(name="myDsl_Eclass")
myDsl_Library = Class(name="myDsl_Library")
myDsl_Descriptor = Class(name="myDsl_Descriptor")
myDsl_AbstractClass = Class(name="myDsl_AbstractClass")
Eclass = Class(name="Eclass")
myDsl_Attribute = Class(name="myDsl_Attribute")
myDsl_MethodBack = Class(name="myDsl_MethodBack")
myDsl_Annotation = Class(name="myDsl_Annotation")
myDsl_AbstractMethod = Class(name="myDsl_AbstractMethod")
myDsl_GenericClass = Class(name="myDsl_GenericClass")
myDsl_Einterface = Class(name="myDsl_Einterface")
myDsl_NativeClass = Class(name="myDsl_NativeClass")
myDsl_RouterComponent = Class(name="myDsl_RouterComponent")
myDsl_Container = Class(name="myDsl_Container")
myDsl_Visualizer = Class(name="myDsl_Visualizer")
myDsl_AbstractFrontElement = Class(name="myDsl_AbstractFrontElement")
myDsl_Functionality = Class(name="myDsl_Functionality")
myDsl_Directory = Class(name="myDsl_Directory")
myDsl_JsModule = Class(name="myDsl_JsModule")
myDsl_File = Class(name="myDsl_File")
myDsl_State = Class(name="myDsl_State")
myDsl_ServiceFront = Class(name="myDsl_ServiceFront")
UIComponent = Class(name="UIComponent")
myDsl_UIComponent = Class(name="myDsl_UIComponent")
myDsl_JsMethod = Class(name="myDsl_JsMethod")
myDsl_AxiosRequest = Class(name="myDsl_AxiosRequest")
myDsl_JsMethodArgs = Class(name="myDsl_JsMethodArgs")
myDsl_Md = Class(name="myDsl_Md")
File = Class(name="File")
myDsl_Js = Class(name="myDsl_Js")
myDsl_Json = Class(name="myDsl_Json")
myDsl_Css = Class(name="myDsl_Css")
myDsl_Action = Class(name="myDsl_Action")
myDsl_Reducer = Class(name="myDsl_Reducer")
myDsl_ActionCreator = Class(name="myDsl_ActionCreator")
myDsl_ActionDispatcher = Class(name="myDsl_ActionDispatcher")
...
myDsl_RelationArch.attributes={myDsl_RelationArch_source, myDsl_RelationArch_name, myDsl_RelationArch_target}
...
myDsl_Descriptor.attributes={myDsl_Descriptor_path, myDsl_Descriptor_name}
...
myDsl_Directory.attributes={myDsl_Directory_purpose, myDsl_Directory_name}
...
myDsl_File.attributes={myDsl_File_type, myDsl_File_name}
...
myDsl_ServiceFront.attributes={myDsl_ServiceFront_name, myDsl_ServiceFront_method}
...
myDsl_AxiosRequest.attributes={myDsl_AxiosRequest_url, myDsl_AxiosRequest_name, myDsl_AxiosRequest_axiosRestMethod}
...
myDsl_ActionCreator.attributes={myDsl_ActionCreator_type, myDsl_ActionCreator_name}
...
domain_model = DomainModel(
    name="myDsl",
    types={myDsl_RelationDom, myDsl_Submodule, myDsl_System, myDsl_Domain, myDsl_Architecture, myDsl_Technology, myDsl_Type, myDsl_Module, myDsl_Operation, myDsl_EObject, myDsl_EntityName, myDsl_GeneralEntity, myDsl_Property, AbstractFrontElement, myDsl_SpecialEntity, myDsl_Transaction, myDsl_Operateson, myDsl_Subproject, myDsl_Epackage, myDsl_Component, myDsl_RelationArch, myDsl_Layer, myDsl_LayerSegment, myDsl_LayerSegmentRelation, myDsl_SublayerSegment, myDsl_JavaApp, myDsl_ReactApp, myDsl_JeeProject, myDsl_Eclass, myDsl_Library, myDsl_Descriptor, myDsl_AbstractClass, Eclass, myDsl_Attribute, myDsl_MethodBack, myDsl_Annotation, myDsl_AbstractMethod, myDsl_GenericClass, myDsl_Einterface, myDsl_NativeClass, myDsl_RouterComponent, myDsl_Container, myDsl_Visualizer, myDsl_AbstractFrontElement, myDsl_Functionality, myDsl_Directory, myDsl_JsModule, myDsl_File, myDsl_State, myDsl_ServiceFront, UIComponent, myDsl_UIComponent, myDsl_JsMethod, myDsl_AxiosRequest, myDsl_JsMethodArgs, myDsl_Md, File, myDsl_Js, myDsl_Json, myDsl_Css, myDsl_Action, myDsl_Reducer, myDsl_ActionCreator, myDsl_ActionDispatcher},
    associations={modules7, relations9, submodules11, dom0, arch1, tech3, types5, operateson35, source38, operations13, entities15, target17, name19, properties21, type23, name26, properties28, transactions31, operateson33, subproject62, target41, componentes44, relationArch46, layer48, layerSegments50, relations52, sublayerSegments54, java56, react58, jeeproject60, attribute96, methodClass98, epackage64, type101, library66, descriptor68, attribute70, methodClass71, annotation73, abstractMethod75, attribute77, methodClass79, annotation82, abs85, imp88, attribute90, abstractMethod93, route129, wrap131, render133, eclass103, arg106, type109, arg112, type115, annotation118, elements121, func123, dir125, mod127, file160, subdirectory163, state135, service137, type139, type142, route145, type147, type150, methods153, type155, requests158, arguments185, action165, reducer167, actionCreator169, actionDispatcher171, dir173, type176, type179, type182, data187},
    generalizations={gen_myDsl_Type_AbstractFrontElement, gen_myDsl_AbstractClass_Eclass, gen_myDsl_GenericClass_Eclass, gen_myDsl_NativeClass_Eclass, gen_myDsl_Functionality_AbstractFrontElement, gen_myDsl_Annotation_Eclass, gen_myDsl_ReactApp_AbstractFrontElement, gen_myDsl_File_AbstractFrontElement, gen_myDsl_RouterComponent_AbstractFrontElement, gen_myDsl_RouterComponent_UIComponent, gen_myDsl_Container_AbstractFrontElement, gen_myDsl_Visualizer_AbstractFrontElement, gen_myDsl_Visualizer_UIComponent, gen_myDsl_ServiceFront_AbstractFrontElement, gen_myDsl_Directory_AbstractFrontElement, gen_myDsl_AxiosRequest_AbstractFrontElement, gen_myDsl_Md_File, gen_myDsl_Js_File, gen_myDsl_Json_File, gen_myDsl_Css_File, gen_myDsl_State_AbstractFrontElement, gen_myDsl_Action_AbstractFrontElement, gen_myDsl_ActionCreator_AbstractFrontElement, gen_myDsl_ActionDispatcher_AbstractFrontElement, gen_myDsl_Reducer_AbstractFrontElement, gen_myDsl_JsModule_AbstractFrontElement},
    metadata=None
)
