...
# Classes
ORDB4ORA_ANSINumberType = Class(name="ORDB4ORA_ANSINumberType")
ORDB4ORA_ANSIType = Class(name="ORDB4ORA_ANSIType", is_abstract=True)
BasicDataType = Class(name="BasicDataType")
ORDB4ORA_AnyType = Class(name="ORDB4ORA_AnyType")
SuppliedType = Class(name="SuppliedType")
ORDB4ORA_Attribute = Class(name="ORDB4ORA_Attribute")
StructuralComponent = Class(name="StructuralComponent")
ORDB4ORA_StructuredType = Class(name="ORDB4ORA_StructuredType")
ORDB4ORA_BasicDataType = Class(name="ORDB4ORA_BasicDataType", is_abstract=True)
Datatype = Class(name="Datatype")
ORDB4ORA_Model = Class(name="ORDB4ORA_Model")
ORDB4ORA_Datatype = Class(name="ORDB4ORA_Datatype", is_abstract=True)
ORDB4ORA_Table = Class(name="ORDB4ORA_Table")
ORDB4ORA_Operation = Class(name="ORDB4ORA_Operation", is_abstract=True)
ORDB4ORA_Package = Class(name="ORDB4ORA_Package")
ORDB4ORA_ANSICharacterType = Class(name="ORDB4ORA_ANSICharacterType")
ANSIType = Class(name="ANSIType")
ORDB4ORA_BuiltInType = Class(name="ORDB4ORA_BuiltInType", is_abstract=True)
ORDB4ORA_CharacterFeature = Class(name="ORDB4ORA_CharacterFeature")
Feature = Class(name="Feature")
ORDB4ORA_Check = Class(name="ORDB4ORA_Check")
Restriction = Class(name="Restriction")
ORDB4ORA_Column = Class(name="ORDB4ORA_Column")
ORDB4ORA_DatetimeFeature = Class(name="ORDB4ORA_DatetimeFeature")
ORDB4ORA_BuiltInCharacterType = Class(name="ORDB4ORA_BuiltInCharacterType")
BuiltInType = Class(name="BuiltInType")
ORDB4ORA_BuiltInNumberType = Class(name="ORDB4ORA_BuiltInNumberType")
ORDB4ORA_LOBType = Class(name="ORDB4ORA_LOBType")
ORDB4ORA_LongAndRawType = Class(name="ORDB4ORA_LongAndRawType")
ORDB4ORA_MediaType = Class(name="ORDB4ORA_MediaType")
ORDB4ORA_Method = Class(name="ORDB4ORA_Method")
ORDB4ORA_DatetimeType = Class(name="ORDB4ORA_DatetimeType")
ORDB4ORA_Feature = Class(name="ORDB4ORA_Feature", is_abstract=True)
ORDB4ORA_ForeignKey = Class(name="ORDB4ORA_ForeignKey")
ORDB4ORA_Function = Class(name="ORDB4ORA_Function")
Operation = Class(name="Operation")
ORDB4ORA_IntervalFeature = Class(name="ORDB4ORA_IntervalFeature")
ORDB4ORA_Parameter = Class(name="ORDB4ORA_Parameter")
ORDB4ORA_MethodParameter = Class(name="ORDB4ORA_MethodParameter")
Parameter_ = Class(name="Parameter")
ORDB4ORA_NestedTableType = Class(name="ORDB4ORA_NestedTableType")
ORDB4ORA_NotNull = Class(name="ORDB4ORA_NotNull")
ORDB4ORA_NumberFeature = Class(name="ORDB4ORA_NumberFeature")
ORDB4ORA_OperationParameter = Class(name="ORDB4ORA_OperationParameter")
ORDB4ORA_RowFeature = Class(name="ORDB4ORA_RowFeature")
ORDB4ORA_SpacialType = Class(name="ORDB4ORA_SpacialType")
ORDB4ORA_StoredNestedTable = Class(name="ORDB4ORA_StoredNestedTable")
ORDB4ORA_TypedTable = Class(name="ORDB4ORA_TypedTable")
ORDB4ORA_PrimaryKey = Class(name="ORDB4ORA_PrimaryKey")
ORDB4ORA_Procedure = Class(name="ORDB4ORA_Procedure")
ORDB4ORA_ROWIDType = Class(name="ORDB4ORA_ROWIDType")
ORDB4ORA_RawFeature = Class(name="ORDB4ORA_RawFeature")
ORDB4ORA_ReferenceType = Class(name="ORDB4ORA_ReferenceType")
ORDB4ORA_Restriction = Class(name="ORDB4ORA_Restriction", is_abstract=True)
ORDB4ORA_StructuralComponent = Class(name="ORDB4ORA_StructuralComponent")
ORDB4ORA_SuppliedType = Class(name="ORDB4ORA_SuppliedType", is_abstract=True)
ORDB4ORA_Unique = Class(name="ORDB4ORA_Unique")
ORDB4ORA_Varray = Class(name="ORDB4ORA_Varray")
ORDB4ORA_XMLType = Class(name="ORDB4ORA_XMLType")
ORDB4ORA_DerivedTable = Class(name="ORDB4ORA_DerivedTable")
ORDB4ORA_Trigger = Class(name="ORDB4ORA_Trigger")
ORDB4ORA_View = Class(name="ORDB4ORA_View")
...
ORDB4ORA_StructuredType.attributes={ORDB4ORA_StructuredType_Name, ORDB4ORA_StructuredType_is_final, ORDB4ORA_StructuredType_is_instantiable}
...
ORDB4ORA_BuiltInCharacterType.attributes={ORDB4ORA_BuiltInCharacterType_Descriptor, ORDB4ORA_BuiltInCharacterType_Size_Def, ORDB4ORA_BuiltInCharacterType_Size_Max, ORDB4ORA_BuiltInCharacterType_Size_Min, ORDB4ORA_BuiltInCharacterType_Semantic}
...
ORDB4ORA_BuiltInNumberType.attributes={ORDB4ORA_BuiltInNumberType_Scale_Max, ORDB4ORA_BuiltInNumberType_Precision_Mn, ORDB4ORA_BuiltInNumberType_Precision_Max, ORDB4ORA_BuiltInNumberType_Scale_Min, ORDB4ORA_BuiltInNumberType_Descriptor}
...
ORDB4ORA_DatetimeType.attributes={ORDB4ORA_DatetimeType_YearPrecision_Max, ORDB4ORA_DatetimeType_YearPrecision_Min, ORDB4ORA_DatetimeType_Descriptor, ORDB4ORA_DatetimeType_DayPrecision_Max, ORDB4ORA_DatetimeType_SecondPrecision_Min, ORDB4ORA_DatetimeType_DayPrecision_Def, ORDB4ORA_DatetimeType_YearPrecision_Def, ORDB4ORA_DatetimeType_SecondPrecision_Def, ORDB4ORA_DatetimeType_SecondPrecision_Max, ORDB4ORA_DatetimeType_DayPrecision_Min}
...
ORDB4ORA_ROWIDType.attributes={ORDB4ORA_ROWIDType_Descriptor, ORDB4ORA_ROWIDType_Size_Min, ORDB4ORA_ROWIDType_Size_Max}
...
ORDB4ORA_Restriction.attributes={ORDB4ORA_Restriction_NameColumns, ORDB4ORA_Restriction_Name}
...
domain_model = DomainModel(
    name="ORDB4ORA",
    types={ORDB4ORA_ANSINumberType, ORDB4ORA_ANSIType, BasicDataType, ORDB4ORA_AnyType, SuppliedType, ORDB4ORA_Attribute, StructuralComponent, ORDB4ORA_StructuredType, ORDB4ORA_BasicDataType, Datatype, ORDB4ORA_Model, ORDB4ORA_Datatype, ORDB4ORA_Table, ORDB4ORA_Operation, ORDB4ORA_Package, ORDB4ORA_ANSICharacterType, ANSIType, ORDB4ORA_BuiltInType, ORDB4ORA_CharacterFeature, Feature, ORDB4ORA_Check, Restriction, ORDB4ORA_Column, ORDB4ORA_DatetimeFeature, ORDB4ORA_BuiltInCharacterType, BuiltInType, ORDB4ORA_BuiltInNumberType, ORDB4ORA_LOBType, ORDB4ORA_LongAndRawType, ORDB4ORA_MediaType, ORDB4ORA_Method, ORDB4ORA_DatetimeType, ORDB4ORA_Feature, ORDB4ORA_ForeignKey, ORDB4ORA_Function, Operation, ORDB4ORA_IntervalFeature, ORDB4ORA_Parameter, ORDB4ORA_MethodParameter, Parameter_, ORDB4ORA_NestedTableType, ORDB4ORA_NotNull, ORDB4ORA_NumberFeature, ORDB4ORA_OperationParameter, ORDB4ORA_RowFeature, ORDB4ORA_SpacialType, ORDB4ORA_StoredNestedTable, ORDB4ORA_TypedTable, ORDB4ORA_PrimaryKey, ORDB4ORA_Procedure, ORDB4ORA_ROWIDType, ORDB4ORA_RawFeature, ORDB4ORA_ReferenceType, ORDB4ORA_Restriction, ORDB4ORA_StructuralComponent, ORDB4ORA_SuppliedType, ORDB4ORA_Unique, ORDB4ORA_Varray, ORDB4ORA_XMLType, ORDB4ORA_DerivedTable, ORDB4ORA_Trigger, ORDB4ORA_View, Table, DerivedTable, ANSINumberTypes, ANSICharacterTypes, BuiltNumberTypes, CharacterFeatures, BuiltInCharacterSemantics, BuiltInCharacterTypes, BuiltInDatetimeTypes, BuiltInLOBType, BuiltInLongAndRawTypes, BuiltInROWIDType, IntervalFeatures, DatetimeFeatures, NumberFeatures, ONDELETEActions, RowFeatures, ParameterMode, RawFeatures, SuppliedSpacialTypes, SuppliedXMLTypes, SuppliedAnyTypes, SuppliedMediaTypes, TriggerActionTime, TriggerEvent},
    associations={structured7, datatype0, table1, operation3, package5, table8, model10, override14, structured15, reference11, Return12, model26, package29, operation31, operations33, model35, Type38, parameters17, returnType19, method22, Type23, operationParameters25, attribute44, typed45, Type46, Type40, attributes41, table42, features48, restrictions50, attribute51, method52, supertype56, typed58, storedNested75, structured76, Type79, restriction61, columns63, model65, triggers68, views70, updateColumns71, table73, tables81, components83},
    generalizations={gen_ORDB4ORA_ANSINumberType_ANSIType, gen_ORDB4ORA_ANSIType_BasicDataType, gen_ORDB4ORA_AnyType_SuppliedType, gen_ORDB4ORA_Attribute_StructuralComponent, gen_ORDB4ORA_ANSICharacterType_ANSIType, gen_ORDB4ORA_BuiltInType_BasicDataType, gen_ORDB4ORA_CharacterFeature_Feature, gen_ORDB4ORA_Check_Restriction, gen_ORDB4ORA_Column_StructuralComponent, gen_ORDB4ORA_BasicDataType_Datatype, gen_ORDB4ORA_DatetimeFeature_Feature, gen_ORDB4ORA_BuiltInCharacterType_BuiltInType, gen_ORDB4ORA_BuiltInNumberType_BuiltInType, gen_ORDB4ORA_LOBType_BuiltInType, gen_ORDB4ORA_LongAndRawType_BuiltInType, gen_ORDB4ORA_MediaType_SuppliedType, gen_ORDB4ORA_DatetimeType_BuiltInType, gen_ORDB4ORA_ForeignKey_Restriction, gen_ORDB4ORA_Function_Operation, gen_ORDB4ORA_IntervalFeature_Feature, gen_ORDB4ORA_OperationParameter_Parameter, gen_ORDB4ORA_MethodParameter_Parameter, gen_ORDB4ORA_NestedTableType_Datatype, gen_ORDB4ORA_NotNull_Restriction, gen_ORDB4ORA_NumberFeature_Feature, gen_ORDB4ORA_RowFeature_Feature, gen_ORDB4ORA_SpacialType_SuppliedType, gen_ORDB4ORA_PrimaryKey_Restriction, gen_ORDB4ORA_Procedure_Operation, gen_ORDB4ORA_ROWIDType_BuiltInType, gen_ORDB4ORA_RawFeature_Feature, gen_ORDB4ORA_ReferenceType_Datatype, gen_ORDB4ORA_SuppliedType_BasicDataType, gen_ORDB4ORA_StructuredType_Datatype, gen_ORDB4ORA_Unique_Restriction, gen_ORDB4ORA_Varray_Datatype, gen_ORDB4ORA_XMLType_SuppliedType, gen_ORDB4ORA_DerivedTable_Table, gen_ORDB4ORA_TypedTable_Table, gen_ORDB4ORA_View_DerivedTable},
    metadata=None
)
