...
def test_ordb4ora_restriction_has_NameColumns():
    assert hasattr(ORDB4ORA_Restriction, "NameColumns")
    descriptor = None
    for klass in ORDB4ORA_Restriction.__mro__:
        if "NameColumns" in klass.__dict__:
            descriptor = klass.__dict__["NameColumns"]
            break
    assert isinstance(descriptor, property)

def test_ordb4ora_restriction_has_Name():
    assert hasattr(ORDB4ORA_Restriction, "Name")
    descriptor = None
    for klass in ORDB4ORA_Restriction.__mro__:
        if "Name" in klass.__dict__:
            descriptor = klass.__dict__["Name"]
...
@given(instance=ORDB4ORA_Restriction_strategy)
def test_ordb4ora_restriction_NameColumns_setter(instance):
...
@given(instance=ORDB4ORA_Restriction_strategy)
def test_ordb4ora_restriction_Name_setter(instance):
    original = instance.Name
    instance.Name = original
    assert instance.Name == original
