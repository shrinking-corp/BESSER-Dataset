...
class CarRental2_Car:
    ...
    def __init__(self, id: int, Car17: "CarRental2_Rental" = None, Car21: "CarRental2_CarGroup" = None, Fleet_Car: "CarRental2_Branch" = None, Classification_Car: "CarRental2_CarGroup" = None, Assignment_Car: "CarRental2_Rental" = None, Car: "CarRental2_Branch" = None, toCar: set["CarRental2_TernaryRelationMaintenance"] = None, Car46: "CarRental2_TernaryRelationMaintenance" = None):
        self.id = id
        self.Car17 = Car17
        self.Car21 = Car21
...
class CarRental2_Branch:
    ...
    def __init__(self, location: int, Branch13: "CarRental2_Rental" = None, Branch19: "CarRental2_CarGroup" = None, Management_Branch_role_managedBranch: "CarRental2_Employee" = None, Branch31: "CarRental2_Car" = None, Branch: "CarRental2_Employee" = None, Branch3: "CarRental2_Employee" = None, Employment_Branch_role_employer: set["CarRental2_Employee"] = None, Fleet_Branch: set["CarRental2_Car"] = None, Offers_Branch: set["CarRental2_CarGroup"] = None, Provider_Branch: set["CarRental2_Rental"] = None):
        self.location = location
...
class CarRental2_Rental:
    ...
    def __init__(self, fromDate: int, untilDate: int, Booking_Rental: "CarRental2_Customer" = None, Provider_Rental: "CarRental2_Branch" = None, Reservation_Rental: "CarRental2_CarGroup" = None, Assignment_Rental: "CarRental2_Car" = None, Rental23: "CarRental2_CarGroup" = None, Rental35: "CarRental2_Car" = None, Rental: "CarRental2_Customer" = None, Rental10: "CarRental2_Branch" = None):
...
class CarRental2_Employee(Person):
    ...
    def __init__(self, salary: int, Employee: "CarRental2_Branch" = None, Management_Employee_role_manager: "CarRental2_Branch" = None, Employment_Employee_role_employee: "CarRental2_Branch" = None, Employee6: "CarRental2_Branch" = None):
        self.salary = salary
    ...
    def raiseSalary(self, CarRental2_amount) :
        # TODO: Implement raiseSalary method
        pass

class CarRental2_Customer(Person):

    def __init__(self, address: int, Customer: "CarRental2_Rental" = None, Booking_Customer: set["CarRental2_Rental"] = None):
...
class CarRental2_Person(ABC):
    ...
    def fullname(self, CarRental2_prefix) :
