...
def test_carrental2_ternaryrelationmaintenance_is_not_abstract():
    assert not inspect.isabstract(CarRental2_TernaryRelationMaintenance)


def test_carrental2_ternaryrelationmaintenance_constructor_exists():
    assert callable(CarRental2_TernaryRelationMaintenance.__init__)


def test_carrental2_ternaryrelationmaintenance_constructor_args():
