...
def test_hyp_jtlmm_imperativeocl_collectorexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_CollectorExp)


def test_hyp_jtlmm_imperativeocl_collectorexp_constructor_exists():
    assert callable(JTLMM_imperativeocl_CollectorExp.__init__)


def test_hyp_jtlmm_imperativeocl_collectorexp_constructor_args():
    sig = inspect.signature(JTLMM_imperativeocl_CollectorExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_imperativeocl_forexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_ForExp)


def test_hyp_jtlmm_imperativeocl_forexp_constructor_exists():
    assert callable(JTLMM_imperativeocl_ForExp.__init__)


def test_hyp_jtlmm_imperativeocl_forexp_constructor_args():
    sig = inspect.signature(JTLMM_imperativeocl_ForExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_imperativeocl_imperativeiterateexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_ImperativeIterateExp)


def test_hyp_jtlmm_imperativeocl_imperativeiterateexp_constructor_exists():
    assert callable(JTLMM_imperativeocl_ImperativeIterateExp.__init__)


def test_hyp_jtlmm_imperativeocl_imperativeiterateexp_constructor_args():
...
def test_hyp_jtlmm_imperativeocl_imperativeloopexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_ImperativeLoopExp)


def test_hyp_jtlmm_imperativeocl_imperativeloopexp_constructor_exists():
    assert callable(JTLMM_imperativeocl_ImperativeLoopExp.__init__)


def test_hyp_jtlmm_imperativeocl_imperativeloopexp_constructor_args():
...
def test_hyp_jtlmm_imperativeocl_unlinkexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_UnlinkExp)


def test_hyp_jtlmm_imperativeocl_unlinkexp_constructor_exists():
    assert callable(JTLMM_imperativeocl_UnlinkExp.__init__)


def test_hyp_jtlmm_imperativeocl_unlinkexp_constructor_args():
    sig = inspect.signature(JTLMM_imperativeocl_UnlinkExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_imperativeocl_blockexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_BlockExp)


def test_hyp_jtlmm_imperativeocl_blockexp_constructor_exists():
    assert callable(JTLMM_imperativeocl_BlockExp.__init__)


def test_hyp_jtlmm_imperativeocl_blockexp_constructor_args():
    sig = inspect.signature(JTLMM_imperativeocl_BlockExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_imperativeocl_continueexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_ContinueExp)


def test_hyp_jtlmm_imperativeocl_continueexp_constructor_exists():
    assert callable(JTLMM_imperativeocl_ContinueExp.__init__)


def test_hyp_jtlmm_imperativeocl_continueexp_constructor_args():
    sig = inspect.signature(JTLMM_imperativeocl_ContinueExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_imperativeocl_instantiationexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_InstantiationExp)


def test_hyp_jtlmm_imperativeocl_instantiationexp_constructor_exists():
    assert callable(JTLMM_imperativeocl_InstantiationExp.__init__)


def test_hyp_jtlmm_imperativeocl_instantiationexp_constructor_args():
    sig = inspect.signature(JTLMM_imperativeocl_InstantiationExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_imperativeocl_logexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_LogExp)


def test_hyp_jtlmm_imperativeocl_logexp_constructor_exists():
    assert callable(JTLMM_imperativeocl_LogExp.__init__)


def test_hyp_jtlmm_imperativeocl_logexp_constructor_args():
...
def test_hyp_jtlmm_imperativeocl_tupleexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_TupleExp)


def test_hyp_jtlmm_imperativeocl_tupleexp_constructor_exists():
    assert callable(JTLMM_imperativeocl_TupleExp.__init__)


def test_hyp_jtlmm_imperativeocl_tupleexp_constructor_args():
    sig = inspect.signature(JTLMM_imperativeocl_TupleExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_imperativeocl_unpackexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_UnpackExp)


def test_hyp_jtlmm_imperativeocl_unpackexp_constructor_exists():
    assert callable(JTLMM_imperativeocl_UnpackExp.__init__)


def test_hyp_jtlmm_imperativeocl_unpackexp_constructor_args():
    sig = inspect.signature(JTLMM_imperativeocl_UnpackExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_imperativeocl_whileexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_WhileExp)


def test_hyp_jtlmm_imperativeocl_whileexp_constructor_exists():
    assert callable(JTLMM_imperativeocl_WhileExp.__init__)


def test_hyp_jtlmm_imperativeocl_whileexp_constructor_args():
    sig = inspect.signature(JTLMM_imperativeocl_WhileExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_imperativeocl_computeexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_ComputeExp)


def test_hyp_jtlmm_imperativeocl_computeexp_constructor_exists():
    assert callable(JTLMM_imperativeocl_ComputeExp.__init__)


def test_hyp_jtlmm_imperativeocl_computeexp_constructor_args():
    sig = inspect.signature(JTLMM_imperativeocl_ComputeExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_imperativeocl_breakexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_BreakExp)


def test_hyp_jtlmm_imperativeocl_breakexp_constructor_exists():
    assert callable(JTLMM_imperativeocl_BreakExp.__init__)


def test_hyp_jtlmm_imperativeocl_breakexp_constructor_args():
    sig = inspect.signature(JTLMM_imperativeocl_BreakExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_imperativeocl_altexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_AltExp)


def test_hyp_jtlmm_imperativeocl_altexp_constructor_exists():
    assert callable(JTLMM_imperativeocl_AltExp.__init__)


def test_hyp_jtlmm_imperativeocl_altexp_constructor_args():
    sig = inspect.signature(JTLMM_imperativeocl_AltExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_imperativeocl_variableinitexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_VariableInitExp)


def test_hyp_jtlmm_imperativeocl_variableinitexp_constructor_exists():
    assert callable(JTLMM_imperativeocl_VariableInitExp.__init__)


def test_hyp_jtlmm_imperativeocl_variableinitexp_constructor_args():
...
def test_hyp_jtlmm_imperativeocl_raiseexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_RaiseExp)


def test_hyp_jtlmm_imperativeocl_raiseexp_constructor_exists():
    assert callable(JTLMM_imperativeocl_RaiseExp.__init__)


def test_hyp_jtlmm_imperativeocl_raiseexp_constructor_args():
    sig = inspect.signature(JTLMM_imperativeocl_RaiseExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_imperativeocl_tryexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_TryExp)


def test_hyp_jtlmm_imperativeocl_tryexp_constructor_exists():
    assert callable(JTLMM_imperativeocl_TryExp.__init__)


def test_hyp_jtlmm_imperativeocl_tryexp_constructor_args():
    sig = inspect.signature(JTLMM_imperativeocl_TryExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_imperativeocl_returnexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_ReturnExp)


def test_hyp_jtlmm_imperativeocl_returnexp_constructor_exists():
    assert callable(JTLMM_imperativeocl_ReturnExp.__init__)


def test_hyp_jtlmm_imperativeocl_returnexp_constructor_args():
    sig = inspect.signature(JTLMM_imperativeocl_ReturnExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_imperativeocl_assertexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_AssertExp)


def test_hyp_jtlmm_imperativeocl_assertexp_constructor_exists():
    assert callable(JTLMM_imperativeocl_AssertExp.__init__)


def test_hyp_jtlmm_imperativeocl_assertexp_constructor_args():
...
def test_hyp_jtlmm_imperativeocl_assignexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_AssignExp)


def test_hyp_jtlmm_imperativeocl_assignexp_constructor_exists():
    assert callable(JTLMM_imperativeocl_AssignExp.__init__)


def test_hyp_jtlmm_imperativeocl_assignexp_constructor_args():
...
def test_hyp_jtlmm_imperativeocl_dictionarytype_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_DictionaryType)


def test_hyp_jtlmm_imperativeocl_dictionarytype_constructor_exists():
    assert callable(JTLMM_imperativeocl_DictionaryType.__init__)


def test_hyp_jtlmm_imperativeocl_dictionarytype_constructor_args():
    sig = inspect.signature(JTLMM_imperativeocl_DictionaryType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_imperativeocl_listtype_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_ListType)


def test_hyp_jtlmm_imperativeocl_listtype_constructor_exists():
    assert callable(JTLMM_imperativeocl_ListType.__init__)


def test_hyp_jtlmm_imperativeocl_listtype_constructor_args():
    sig = inspect.signature(JTLMM_imperativeocl_ListType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_essentialocl_bagtype_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_BagType)


def test_hyp_jtlmm_essentialocl_bagtype_constructor_exists():
    assert callable(JTLMM_essentialocl_BagType.__init__)


def test_hyp_jtlmm_essentialocl_bagtype_constructor_args():
...
def test_hyp_jtlmm_essentialocl_featurepropertycall_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_FeaturePropertyCall)


def test_hyp_jtlmm_essentialocl_featurepropertycall_constructor_exists():
    assert callable(JTLMM_essentialocl_FeaturePropertyCall.__init__)


def test_hyp_jtlmm_essentialocl_featurepropertycall_constructor_args():
    sig = inspect.signature(JTLMM_essentialocl_FeaturePropertyCall.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_essentialocl_opaqueexpression_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_OpaqueExpression)


def test_hyp_jtlmm_essentialocl_opaqueexpression_constructor_exists():
    assert callable(JTLMM_essentialocl_OpaqueExpression.__init__)


def test_hyp_jtlmm_essentialocl_opaqueexpression_constructor_args():
...
def test_hyp_jtlmm_essentialocl_settype_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_SetType)


def test_hyp_jtlmm_essentialocl_settype_constructor_exists():
    assert callable(JTLMM_essentialocl_SetType.__init__)


def test_hyp_jtlmm_essentialocl_settype_constructor_args():
    sig = inspect.signature(JTLMM_essentialocl_SetType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_essentialocl_sequencetype_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_SequenceType)


def test_hyp_jtlmm_essentialocl_sequencetype_constructor_exists():
    assert callable(JTLMM_essentialocl_SequenceType.__init__)


def test_hyp_jtlmm_essentialocl_sequencetype_constructor_args():
    sig = inspect.signature(JTLMM_essentialocl_SequenceType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_essentialocl_orderedsettype_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_OrderedSetType)


def test_hyp_jtlmm_essentialocl_orderedsettype_constructor_exists():
    assert callable(JTLMM_essentialocl_OrderedSetType.__init__)


def test_hyp_jtlmm_essentialocl_orderedsettype_constructor_args():
...
def test_hyp_jtlmm_essentialocl_expressioninocl_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_ExpressionInOcl)


def test_hyp_jtlmm_essentialocl_expressioninocl_constructor_exists():
    assert callable(JTLMM_essentialocl_ExpressionInOcl.__init__)


def test_hyp_jtlmm_essentialocl_expressioninocl_constructor_args():
...
def test_hyp_jtlmm_essentialocl_collectionitem_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_CollectionItem)


def test_hyp_jtlmm_essentialocl_collectionitem_constructor_exists():
    assert callable(JTLMM_essentialocl_CollectionItem.__init__)


def test_hyp_jtlmm_essentialocl_collectionitem_constructor_args():
    sig = inspect.signature(JTLMM_essentialocl_CollectionItem.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_essentialocl_collectionrange_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_CollectionRange)


def test_hyp_jtlmm_essentialocl_collectionrange_constructor_exists():
    assert callable(JTLMM_essentialocl_CollectionRange.__init__)


def test_hyp_jtlmm_essentialocl_collectionrange_constructor_args():
...
def test_hyp_jtlmm_essentialocl_collectionliteralexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_CollectionLiteralExp)


def test_hyp_jtlmm_essentialocl_collectionliteralexp_constructor_exists():
    assert callable(JTLMM_essentialocl_CollectionLiteralExp.__init__)


def test_hyp_jtlmm_essentialocl_collectionliteralexp_constructor_args():
...
def test_hyp_jtlmm_essentialocl_nullliteralexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_NullLiteralExp)


def test_hyp_jtlmm_essentialocl_nullliteralexp_constructor_exists():
    assert callable(JTLMM_essentialocl_NullLiteralExp.__init__)


def test_hyp_jtlmm_essentialocl_nullliteralexp_constructor_args():
    sig = inspect.signature(JTLMM_essentialocl_NullLiteralExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_imperativeocl_dictliteralexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_DictLiteralExp)


def test_hyp_jtlmm_imperativeocl_dictliteralexp_constructor_exists():
    assert callable(JTLMM_imperativeocl_DictLiteralExp.__init__)


def test_hyp_jtlmm_imperativeocl_dictliteralexp_constructor_args():
    sig = inspect.signature(JTLMM_imperativeocl_DictLiteralExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_template_templateexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_template_TemplateExp)


def test_hyp_jtlmm_template_templateexp_constructor_exists():
    assert callable(JTLMM_template_TemplateExp.__init__)


def test_hyp_jtlmm_template_templateexp_constructor_args():
    sig = inspect.signature(JTLMM_template_TemplateExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_essentialocl_invalidliteralexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_InvalidLiteralExp)


def test_hyp_jtlmm_essentialocl_invalidliteralexp_constructor_exists():
    assert callable(JTLMM_essentialocl_InvalidLiteralExp.__init__)


def test_hyp_jtlmm_essentialocl_invalidliteralexp_constructor_args():
    sig = inspect.signature(JTLMM_essentialocl_InvalidLiteralExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_essentialocl_tupleliteralexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_TupleLiteralExp)


def test_hyp_jtlmm_essentialocl_tupleliteralexp_constructor_exists():
    assert callable(JTLMM_essentialocl_TupleLiteralExp.__init__)


def test_hyp_jtlmm_essentialocl_tupleliteralexp_constructor_args():
    sig = inspect.signature(JTLMM_essentialocl_TupleLiteralExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_essentialocl_enumliteralexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_EnumLiteralExp)


def test_hyp_jtlmm_essentialocl_enumliteralexp_constructor_exists():
    assert callable(JTLMM_essentialocl_EnumLiteralExp.__init__)


def test_hyp_jtlmm_essentialocl_enumliteralexp_constructor_args():
    sig = inspect.signature(JTLMM_essentialocl_EnumLiteralExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_imperativeocl_anonymoustupleliteralexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_AnonymousTupleLiteralExp)


def test_hyp_jtlmm_imperativeocl_anonymoustupleliteralexp_constructor_exists():
    assert callable(JTLMM_imperativeocl_AnonymousTupleLiteralExp.__init__)


def test_hyp_jtlmm_imperativeocl_anonymoustupleliteralexp_constructor_args():
    sig = inspect.signature(JTLMM_imperativeocl_AnonymousTupleLiteralExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_essentialocl_primitiveliteralexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_PrimitiveLiteralExp)


def test_hyp_jtlmm_essentialocl_primitiveliteralexp_constructor_exists():
    assert callable(JTLMM_essentialocl_PrimitiveLiteralExp.__init__)


def test_hyp_jtlmm_essentialocl_primitiveliteralexp_constructor_args():
...
def test_hyp_jtlmm_essentialocl_iterateexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_IterateExp)


def test_hyp_jtlmm_essentialocl_iterateexp_constructor_exists():
    assert callable(JTLMM_essentialocl_IterateExp.__init__)


def test_hyp_jtlmm_essentialocl_iterateexp_constructor_args():
    sig = inspect.signature(JTLMM_essentialocl_IterateExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_essentialocl_iteratorexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_IteratorExp)


def test_hyp_jtlmm_essentialocl_iteratorexp_constructor_exists():
    assert callable(JTLMM_essentialocl_IteratorExp.__init__)


def test_hyp_jtlmm_essentialocl_iteratorexp_constructor_args():
...
def test_hyp_jtlmm_imperativeocl_switchexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_SwitchExp)


def test_hyp_jtlmm_imperativeocl_switchexp_constructor_exists():
    assert callable(JTLMM_imperativeocl_SwitchExp.__init__)


def test_hyp_jtlmm_imperativeocl_switchexp_constructor_args():
    sig = inspect.signature(JTLMM_imperativeocl_SwitchExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_essentialocl_loopexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_LoopExp)


def test_hyp_jtlmm_essentialocl_loopexp_constructor_exists():
    assert callable(JTLMM_essentialocl_LoopExp.__init__)


def test_hyp_jtlmm_essentialocl_loopexp_constructor_args():
...
def test_hyp_jtlmm_emof_element_is_not_abstract():
    assert not inspect.isabstract(JTLMM_emof_Element)


def test_hyp_jtlmm_emof_element_constructor_exists():
    assert callable(JTLMM_emof_Element.__init__)


def test_hyp_jtlmm_emof_element_constructor_args():
...
def test_hyp_jtlmm_imperativeocl_anonymoustupletype_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_AnonymousTupleType)


def test_hyp_jtlmm_imperativeocl_anonymoustupletype_constructor_exists():
    assert callable(JTLMM_imperativeocl_AnonymousTupleType.__init__)


def test_hyp_jtlmm_imperativeocl_anonymoustupletype_constructor_args():
    sig = inspect.signature(JTLMM_imperativeocl_AnonymousTupleType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_imperativeocl_typedef_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_Typedef)


def test_hyp_jtlmm_imperativeocl_typedef_constructor_exists():
    assert callable(JTLMM_imperativeocl_Typedef.__init__)


def test_hyp_jtlmm_imperativeocl_typedef_constructor_args():
...
def test_hyp_jtlmm_essentialocl_invalidtype_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_InvalidType)


def test_hyp_jtlmm_essentialocl_invalidtype_constructor_exists():
    assert callable(JTLMM_essentialocl_InvalidType.__init__)


def test_hyp_jtlmm_essentialocl_invalidtype_constructor_args():
    sig = inspect.signature(JTLMM_essentialocl_InvalidType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_essentialocl_voidtype_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_VoidType)


def test_hyp_jtlmm_essentialocl_voidtype_constructor_exists():
    assert callable(JTLMM_essentialocl_VoidType.__init__)


def test_hyp_jtlmm_essentialocl_voidtype_constructor_args():
    sig = inspect.signature(JTLMM_essentialocl_VoidType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_emof_datatype_is_not_abstract():
    assert not inspect.isabstract(JTLMM_emof_DataType)


def test_hyp_jtlmm_emof_datatype_constructor_exists():
    assert callable(JTLMM_emof_DataType.__init__)


def test_hyp_jtlmm_emof_datatype_constructor_args():
    sig = inspect.signature(JTLMM_emof_DataType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_imperativeocl_templateparametertype_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_TemplateParameterType)


def test_hyp_jtlmm_imperativeocl_templateparametertype_constructor_exists():
    assert callable(JTLMM_imperativeocl_TemplateParameterType.__init__)


def test_hyp_jtlmm_imperativeocl_templateparametertype_constructor_args():
...
def test_hyp_jtlmm_emof_class_is_not_abstract():
    assert not inspect.isabstract(JTLMM_emof_Class)


def test_hyp_jtlmm_emof_class_constructor_exists():
    assert callable(JTLMM_emof_Class.__init__)


def test_hyp_jtlmm_emof_class_constructor_args():
...
def test_hyp_jtlmm_essentialocl_operationcallexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_OperationCallExp)


def test_hyp_jtlmm_essentialocl_operationcallexp_constructor_exists():
    assert callable(JTLMM_essentialocl_OperationCallExp.__init__)


def test_hyp_jtlmm_essentialocl_operationcallexp_constructor_args():
    sig = inspect.signature(JTLMM_essentialocl_OperationCallExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_essentialocl_propertycallexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_PropertyCallExp)


def test_hyp_jtlmm_essentialocl_propertycallexp_constructor_exists():
    assert callable(JTLMM_essentialocl_PropertyCallExp.__init__)


def test_hyp_jtlmm_essentialocl_propertycallexp_constructor_args():
...
def test_hyp_jtlmm_essentialocl_stringliteralexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_StringLiteralExp)


def test_hyp_jtlmm_essentialocl_stringliteralexp_constructor_exists():
    assert callable(JTLMM_essentialocl_StringLiteralExp.__init__)


def test_hyp_jtlmm_essentialocl_stringliteralexp_constructor_args():
...
def test_hyp_jtlmm_essentialocl_numericliteralexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_NumericLiteralExp)


def test_hyp_jtlmm_essentialocl_numericliteralexp_constructor_exists():
    assert callable(JTLMM_essentialocl_NumericLiteralExp.__init__)


def test_hyp_jtlmm_essentialocl_numericliteralexp_constructor_args():
    sig = inspect.signature(JTLMM_essentialocl_NumericLiteralExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_essentialocl_booleanliteralexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_BooleanLiteralExp)


def test_hyp_jtlmm_essentialocl_booleanliteralexp_constructor_exists():
    assert callable(JTLMM_essentialocl_BooleanLiteralExp.__init__)


def test_hyp_jtlmm_essentialocl_booleanliteralexp_constructor_args():
...
def test_hyp_jtlmm_essentialocl_callexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_CallExp)


def test_hyp_jtlmm_essentialocl_callexp_constructor_exists():
    assert callable(JTLMM_essentialocl_CallExp.__init__)


def test_hyp_jtlmm_essentialocl_callexp_constructor_args():
    sig = inspect.signature(JTLMM_essentialocl_CallExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_essentialocl_literalexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_LiteralExp)


def test_hyp_jtlmm_essentialocl_literalexp_constructor_exists():
    assert callable(JTLMM_essentialocl_LiteralExp.__init__)


def test_hyp_jtlmm_essentialocl_literalexp_constructor_args():
    sig = inspect.signature(JTLMM_essentialocl_LiteralExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_essentialocl_letexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_LetExp)


def test_hyp_jtlmm_essentialocl_letexp_constructor_exists():
    assert callable(JTLMM_essentialocl_LetExp.__init__)


def test_hyp_jtlmm_essentialocl_letexp_constructor_args():
    sig = inspect.signature(JTLMM_essentialocl_LetExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_imperativeocl_imperativeexpression_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_ImperativeExpression)


def test_hyp_jtlmm_imperativeocl_imperativeexpression_constructor_exists():
    assert callable(JTLMM_imperativeocl_ImperativeExpression.__init__)


def test_hyp_jtlmm_imperativeocl_imperativeexpression_constructor_args():
    sig = inspect.signature(JTLMM_imperativeocl_ImperativeExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_essentialocl_variableexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_VariableExp)


def test_hyp_jtlmm_essentialocl_variableexp_constructor_exists():
    assert callable(JTLMM_essentialocl_VariableExp.__init__)


def test_hyp_jtlmm_essentialocl_variableexp_constructor_args():
    sig = inspect.signature(JTLMM_essentialocl_VariableExp.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_essentialocl_typeexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_TypeExp)


def test_hyp_jtlmm_essentialocl_typeexp_constructor_exists():
    assert callable(JTLMM_essentialocl_TypeExp.__init__)


def test_hyp_jtlmm_essentialocl_typeexp_constructor_args():
...
def test_hyp_jtlmm_template_objecttemplateexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_template_ObjectTemplateExp)


def test_hyp_jtlmm_template_objecttemplateexp_constructor_exists():
    assert callable(JTLMM_template_ObjectTemplateExp.__init__)


def test_hyp_jtlmm_template_objecttemplateexp_constructor_args():
...
def test_hyp_jtlmm_template_collectiontemplateexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_template_CollectionTemplateExp)


def test_hyp_jtlmm_template_collectiontemplateexp_constructor_exists():
    assert callable(JTLMM_template_CollectionTemplateExp.__init__)


def test_hyp_jtlmm_template_collectiontemplateexp_constructor_args():
...
def test_hyp_jtlmm_essentialocl_ifexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_IfExp)


def test_hyp_jtlmm_essentialocl_ifexp_constructor_exists():
    assert callable(JTLMM_essentialocl_IfExp.__init__)


def test_hyp_jtlmm_essentialocl_ifexp_constructor_args():
...
def test_hyp_jtlmm_essentialocl_integerliteralexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_IntegerLiteralExp)


def test_hyp_jtlmm_essentialocl_integerliteralexp_constructor_exists():
    assert callable(JTLMM_essentialocl_IntegerLiteralExp.__init__)


def test_hyp_jtlmm_essentialocl_integerliteralexp_constructor_args():
...
def test_hyp_jtlmm_essentialocl_realliteralexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_RealLiteralExp)


def test_hyp_jtlmm_essentialocl_realliteralexp_constructor_exists():
    assert callable(JTLMM_essentialocl_RealLiteralExp.__init__)


def test_hyp_jtlmm_essentialocl_realliteralexp_constructor_args():
...
def test_hyp_jtlmm_essentialocl_unlimitednaturalexp_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_UnlimitedNaturalExp)


def test_hyp_jtlmm_essentialocl_unlimitednaturalexp_constructor_exists():
    assert callable(JTLMM_essentialocl_UnlimitedNaturalExp.__init__)


def test_hyp_jtlmm_essentialocl_unlimitednaturalexp_constructor_args():
...
def test_hyp_jtlmm_essentialocl_variable_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_Variable)


def test_hyp_jtlmm_essentialocl_variable_constructor_exists():
    assert callable(JTLMM_essentialocl_Variable.__init__)


def test_hyp_jtlmm_essentialocl_variable_constructor_args():
    sig = inspect.signature(JTLMM_essentialocl_Variable.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_essentialocl_collectionliteralpart_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_CollectionLiteralPart)


def test_hyp_jtlmm_essentialocl_collectionliteralpart_constructor_exists():
    assert callable(JTLMM_essentialocl_CollectionLiteralPart.__init__)


def test_hyp_jtlmm_essentialocl_collectionliteralpart_constructor_args():
    sig = inspect.signature(JTLMM_essentialocl_CollectionLiteralPart.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_essentialocl_tupleliteralpart_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_TupleLiteralPart)


def test_hyp_jtlmm_essentialocl_tupleliteralpart_constructor_exists():
    assert callable(JTLMM_essentialocl_TupleLiteralPart.__init__)


def test_hyp_jtlmm_essentialocl_tupleliteralpart_constructor_args():
    sig = inspect.signature(JTLMM_essentialocl_TupleLiteralPart.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_essentialocl_oclexpression_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_OclExpression)


def test_hyp_jtlmm_essentialocl_oclexpression_constructor_exists():
    assert callable(JTLMM_essentialocl_OclExpression.__init__)


def test_hyp_jtlmm_essentialocl_oclexpression_constructor_args():
...
def test_hyp_jtlmm_essentialocl_tupletype_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_TupleType)


def test_hyp_jtlmm_essentialocl_tupletype_constructor_exists():
    assert callable(JTLMM_essentialocl_TupleType.__init__)


def test_hyp_jtlmm_essentialocl_tupletype_constructor_args():
    sig = inspect.signature(JTLMM_essentialocl_TupleType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_essentialocl_anytype_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_AnyType)


def test_hyp_jtlmm_essentialocl_anytype_constructor_exists():
    assert callable(JTLMM_essentialocl_AnyType.__init__)


def test_hyp_jtlmm_essentialocl_anytype_constructor_args():
    sig = inspect.signature(JTLMM_essentialocl_AnyType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_jtl_transformation_is_not_abstract():
    assert not inspect.isabstract(JTLMM_JTL_Transformation)


def test_hyp_jtlmm_jtl_transformation_constructor_exists():
    assert callable(JTLMM_JTL_Transformation.__init__)


def test_hyp_jtlmm_jtl_transformation_constructor_args():
...
def test_hyp_jtlmm_emof_uriextent_is_not_abstract():
    assert not inspect.isabstract(JTLMM_emof_URIExtent)


def test_hyp_jtlmm_emof_uriextent_constructor_exists():
    assert callable(JTLMM_emof_URIExtent.__init__)


def test_hyp_jtlmm_emof_uriextent_constructor_args():
...
def test_hyp_jtlmm_jtl_model_is_not_abstract():
    assert not inspect.isabstract(JTLMM_JTL_Model)


def test_hyp_jtlmm_jtl_model_constructor_exists():
    assert callable(JTLMM_JTL_Model.__init__)


def test_hyp_jtlmm_jtl_model_constructor_args():
...
def test_hyp_jtlmm_emof_type_is_not_abstract():
    assert not inspect.isabstract(JTLMM_emof_Type)


def test_hyp_jtlmm_emof_type_constructor_exists():
    assert callable(JTLMM_emof_Type.__init__)


def test_hyp_jtlmm_emof_type_constructor_args():
    sig = inspect.signature(JTLMM_emof_Type.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_jtl_relation_is_not_abstract():
    assert not inspect.isabstract(JTLMM_JTL_Relation)


def test_hyp_jtlmm_jtl_relation_constructor_exists():
    assert callable(JTLMM_JTL_Relation.__init__)


def test_hyp_jtlmm_jtl_relation_constructor_args():
...
def test_hyp_jtlmm_emof_typedelement_is_not_abstract():
    assert not inspect.isabstract(JTLMM_emof_TypedElement)


def test_hyp_jtlmm_emof_typedelement_constructor_exists():
    assert callable(JTLMM_emof_TypedElement.__init__)


def test_hyp_jtlmm_emof_typedelement_constructor_args():
...
def test_hyp_jtlmm_jtl_domain_is_not_abstract():
    assert not inspect.isabstract(JTLMM_JTL_Domain)


def test_hyp_jtlmm_jtl_domain_constructor_exists():
    assert callable(JTLMM_JTL_Domain.__init__)


def test_hyp_jtlmm_jtl_domain_constructor_args():
...
def test_hyp_jtlmm_emof_package_is_not_abstract():
    assert not inspect.isabstract(JTLMM_emof_Package)


def test_hyp_jtlmm_emof_package_constructor_exists():
    assert callable(JTLMM_emof_Package.__init__)


def test_hyp_jtlmm_emof_package_constructor_args():
...
def test_hyp_jtlmm_emof_multiplicityelement_is_not_abstract():
    assert not inspect.isabstract(JTLMM_emof_MultiplicityElement)


def test_hyp_jtlmm_emof_multiplicityelement_constructor_exists():
    assert callable(JTLMM_emof_MultiplicityElement.__init__)


def test_hyp_jtlmm_emof_multiplicityelement_constructor_args():
...
def test_hyp_jtlmm_emof_operation_is_not_abstract():
    assert not inspect.isabstract(JTLMM_emof_Operation)


def test_hyp_jtlmm_emof_operation_constructor_exists():
    assert callable(JTLMM_emof_Operation.__init__)


def test_hyp_jtlmm_emof_operation_constructor_args():
    sig = inspect.signature(JTLMM_emof_Operation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_emof_object_is_not_abstract():
    assert not inspect.isabstract(JTLMM_emof_Object)


def test_hyp_jtlmm_emof_object_constructor_exists():
    assert callable(JTLMM_emof_Object.__init__)


def test_hyp_jtlmm_emof_object_constructor_args():
    sig = inspect.signature(JTLMM_emof_Object.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_emof_extent_is_not_abstract():
    assert not inspect.isabstract(JTLMM_emof_Extent)


def test_hyp_jtlmm_emof_extent_constructor_exists():
    assert callable(JTLMM_emof_Extent.__init__)


def test_hyp_jtlmm_emof_extent_constructor_args():
...
def test_hyp_jtlmm_emof_primitivetype_is_not_abstract():
    assert not inspect.isabstract(JTLMM_emof_PrimitiveType)


def test_hyp_jtlmm_emof_primitivetype_constructor_exists():
    assert callable(JTLMM_emof_PrimitiveType.__init__)


def test_hyp_jtlmm_emof_primitivetype_constructor_args():
    sig = inspect.signature(JTLMM_emof_PrimitiveType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_essentialocl_collectiontype_is_not_abstract():
    assert not inspect.isabstract(JTLMM_essentialocl_CollectionType)


def test_hyp_jtlmm_essentialocl_collectiontype_constructor_exists():
    assert callable(JTLMM_essentialocl_CollectionType.__init__)


def test_hyp_jtlmm_essentialocl_collectiontype_constructor_args():
    sig = inspect.signature(JTLMM_essentialocl_CollectionType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_emof_enumeration_is_not_abstract():
    assert not inspect.isabstract(JTLMM_emof_Enumeration)


def test_hyp_jtlmm_emof_enumeration_constructor_exists():
    assert callable(JTLMM_emof_Enumeration.__init__)


def test_hyp_jtlmm_emof_enumeration_constructor_args():
    sig = inspect.signature(JTLMM_emof_Enumeration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_emof_property_is_not_abstract():
    assert not inspect.isabstract(JTLMM_emof_Property)


def test_hyp_jtlmm_emof_property_constructor_exists():
    assert callable(JTLMM_emof_Property.__init__)


def test_hyp_jtlmm_emof_property_constructor_args():
...
def test_hyp_jtlmm_emof_enumerationliteral_is_not_abstract():
    assert not inspect.isabstract(JTLMM_emof_EnumerationLiteral)


def test_hyp_jtlmm_emof_enumerationliteral_constructor_exists():
    assert callable(JTLMM_emof_EnumerationLiteral.__init__)


def test_hyp_jtlmm_emof_enumerationliteral_constructor_args():
    sig = inspect.signature(JTLMM_emof_EnumerationLiteral.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_emof_parameter_is_not_abstract():
    assert not inspect.isabstract(JTLMM_emof_Parameter)


def test_hyp_jtlmm_emof_parameter_constructor_exists():
    assert callable(JTLMM_emof_Parameter.__init__)


def test_hyp_jtlmm_emof_parameter_constructor_args():
...
def test_hyp_jtlmm_emof_namedelement_is_not_abstract():
    assert not inspect.isabstract(JTLMM_emof_NamedElement)


def test_hyp_jtlmm_emof_namedelement_constructor_exists():
    assert callable(JTLMM_emof_NamedElement.__init__)


def test_hyp_jtlmm_emof_namedelement_constructor_args():
...
def test_hyp_jtlmm_imperativeocl_anonymoustupleliteralpart_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_AnonymousTupleLiteralPart)


def test_hyp_jtlmm_imperativeocl_anonymoustupleliteralpart_constructor_exists():
    assert callable(JTLMM_imperativeocl_AnonymousTupleLiteralPart.__init__)


def test_hyp_jtlmm_imperativeocl_anonymoustupleliteralpart_constructor_args():
    sig = inspect.signature(JTLMM_imperativeocl_AnonymousTupleLiteralPart.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_emof_comment_is_not_abstract():
    assert not inspect.isabstract(JTLMM_emof_Comment)


def test_hyp_jtlmm_emof_comment_constructor_exists():
    assert callable(JTLMM_emof_Comment.__init__)


def test_hyp_jtlmm_emof_comment_constructor_args():
    sig = inspect.signature(JTLMM_emof_Comment.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_jtl_predicate_is_not_abstract():
    assert not inspect.isabstract(JTLMM_JTL_Predicate)


def test_hyp_jtlmm_jtl_predicate_constructor_exists():
    assert callable(JTLMM_JTL_Predicate.__init__)


def test_hyp_jtlmm_jtl_predicate_constructor_args():
    sig = inspect.signature(JTLMM_JTL_Predicate.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_imperativeocl_dictliteralpart_is_not_abstract():
    assert not inspect.isabstract(JTLMM_imperativeocl_DictLiteralPart)


def test_hyp_jtlmm_imperativeocl_dictliteralpart_constructor_exists():
    assert callable(JTLMM_imperativeocl_DictLiteralPart.__init__)


def test_hyp_jtlmm_imperativeocl_dictliteralpart_constructor_args():
    sig = inspect.signature(JTLMM_imperativeocl_DictLiteralPart.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_template_propertytemplateitem_is_not_abstract():
    assert not inspect.isabstract(JTLMM_template_PropertyTemplateItem)


def test_hyp_jtlmm_template_propertytemplateitem_constructor_exists():
    assert callable(JTLMM_template_PropertyTemplateItem.__init__)


def test_hyp_jtlmm_template_propertytemplateitem_constructor_args():
    sig = inspect.signature(JTLMM_template_PropertyTemplateItem.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_jtl_pattern_is_not_abstract():
    assert not inspect.isabstract(JTLMM_JTL_Pattern)


def test_hyp_jtlmm_jtl_pattern_constructor_exists():
    assert callable(JTLMM_JTL_Pattern.__init__)


def test_hyp_jtlmm_jtl_pattern_constructor_args():
    sig = inspect.signature(JTLMM_JTL_Pattern.__init__)
    params = list(sig.parameters.keys())



def test_hyp_jtlmm_emof_tag_is_not_abstract():
    assert not inspect.isabstract(JTLMM_emof_Tag)


def test_hyp_jtlmm_emof_tag_constructor_exists():
    assert callable(JTLMM_emof_Tag.__init__)


def test_hyp_jtlmm_emof_tag_constructor_args():
...
def test_hyp_jtlmm_imperativeocl_logexp_level_setter(instance):
...
@given(instance=JTLMM_imperativeocl_LogExp_strategy)
def test_hyp_jtlmm_imperativeocl_logexp_text_setter(instance):
...
def test_hyp_jtlmm_imperativeocl_variableinitexp_withResult_setter(instance):
...
def test_hyp_jtlmm_imperativeocl_assertexp_severity_setter(instance):
...
def test_hyp_jtlmm_imperativeocl_assignexp_isReset_setter(instance):
...
def test_hyp_jtlmm_essentialocl_collectionliteralexp_kind_setter(instance):
...
def test_hyp_jtlmm_imperativeocl_templateparametertype_specification_setter(instance):
...
def test_hyp_jtlmm_emof_class_isAbstract_setter(instance):
...
def test_hyp_jtlmm_essentialocl_stringliteralexp_stringSymbol_setter(instance):
...
def test_hyp_jtlmm_essentialocl_booleanliteralexp_booleanSymbol_setter(instance):
...
def test_hyp_jtlmm_template_objecttemplateexp_referredClass_setter(instance):
...
def test_hyp_jtlmm_template_collectiontemplateexp_kind_setter(instance):
    original = instance.kind
    instance.kind = original
    assert instance.kind == original
...
def test_hyp_jtlmm_essentialocl_integerliteralexp_integerSymbol_setter(instance):
...
def test_hyp_jtlmm_essentialocl_realliteralexp_realSymbol_setter(instance):
...
def test_hyp_jtlmm_essentialocl_unlimitednaturalexp_symbol_setter(instance):
...
def test_hyp_jtlmm_jtl_model_usedPackage_setter(instance):
...
def test_hyp_jtlmm_jtl_relation_isTopLevel_setter(instance):
...
def test_hyp_jtlmm_emof_typedelement_type_setter(instance):
...
def test_hyp_jtlmm_jtl_domain_isEnforceable_setter(instance):
...
@given(instance=JTLMM_JTL_Domain_strategy)
def test_hyp_jtlmm_jtl_domain_isCheckable_setter(instance):
...
def test_hyp_jtlmm_emof_package_uri_setter(instance):
...
def test_hyp_jtlmm_emof_multiplicityelement_lower_setter(instance):
...
@given(instance=JTLMM_emof_MultiplicityElement_strategy)
def test_hyp_jtlmm_emof_multiplicityelement_upper_setter(instance):
...
@given(instance=JTLMM_emof_MultiplicityElement_strategy)
def test_hyp_jtlmm_emof_multiplicityelement_isUnique_setter(instance):
...
@given(instance=JTLMM_emof_MultiplicityElement_strategy)
def test_hyp_jtlmm_emof_multiplicityelement_isOrdered_setter(instance):
...
def test_hyp_jtlmm_emof_property_isId_setter(instance):
...
@given(instance=JTLMM_emof_Property_strategy)
def test_hyp_jtlmm_emof_property_isComposite_setter(instance):
...
@given(instance=JTLMM_emof_Property_strategy)
def test_hyp_jtlmm_emof_property_isDerived_setter(instance):
...
@given(instance=JTLMM_emof_Property_strategy)
def test_hyp_jtlmm_emof_property_default_setter(instance):
...
@given(instance=JTLMM_emof_Property_strategy)
def test_hyp_jtlmm_emof_property_isReadOnly_setter(instance):
...
def test_hyp_jtlmm_emof_namedelement_name_setter(instance):
...
def test_hyp_jtlmm_emof_tag_value_setter(instance):
...
@given(instance=JTLMM_emof_Tag_strategy)
def test_hyp_jtlmm_emof_tag_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
