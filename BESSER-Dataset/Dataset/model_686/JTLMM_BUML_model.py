...
# Classes
JTLMM_emof_Class = Class(name="JTLMM_emof_Class")
Type = Class(name="Type")
Property_ = Class(name="Property")
Operation = Class(name="Operation")
Class_ = Class(name="Class")
JTLMM_emof_DataType = Class(name="JTLMM_emof_DataType", is_abstract=True)
JTLMM_emof_Element = Class(name="JTLMM_emof_Element", is_abstract=True)
Object = Class(name="Object")
Tag = Class(name="Tag")
Comment = Class(name="Comment")
JTLMM_emof_Tag = Class(name="JTLMM_emof_Tag")
Element = Class(name="Element")
JTLMM_emof_Parameter = Class(name="JTLMM_emof_Parameter")
JTLMM_emof_EnumerationLiteral = Class(name="JTLMM_emof_EnumerationLiteral")
Enumeration_ = Class(name="Enumeration")
JTLMM_emof_Property = Class(name="JTLMM_emof_Property")
JTLMM_emof_Enumeration = Class(name="JTLMM_emof_Enumeration")
DataType = Class(name="DataType")
EnumerationLiteral = Class(name="EnumerationLiteral")
JTLMM_emof_NamedElement = Class(name="JTLMM_emof_NamedElement", is_abstract=True)
JTLMM_emof_Extent = Class(name="JTLMM_emof_Extent")
JTLMM_emof_Object = Class(name="JTLMM_emof_Object")
JTLMM_emof_Operation = Class(name="JTLMM_emof_Operation")
emof_MultiplicityElement = Class(name="emof_MultiplicityElement")
emof_TypedElement = Class(name="emof_TypedElement")
Parameter_ = Class(name="Parameter")
JTLMM_emof_MultiplicityElement = Class(name="JTLMM_emof_MultiplicityElement", is_abstract=True)
JTLMM_emof_Package = Class(name="JTLMM_emof_Package")
NamedElement = Class(name="NamedElement")
Package = Class(name="Package")
JTLMM_emof_Type = Class(name="JTLMM_emof_Type", is_abstract=True)
Variable = Class(name="Variable")
JTLMM_JTL_Domain = Class(name="JTLMM_JTL_Domain")
JTLMM_JTL_Model = Class(name="JTLMM_JTL_Model")
JTLMM_JTL_Pattern = Class(name="JTLMM_JTL_Pattern")
JTLMM_emof_TypedElement = Class(name="JTLMM_emof_TypedElement", is_abstract=True)
JTLMM_emof_PrimitiveType = Class(name="JTLMM_emof_PrimitiveType")
JTLMM_emof_URIExtent = Class(name="JTLMM_emof_URIExtent")
Extent = Class(name="Extent")
JTLMM_emof_Comment = Class(name="JTLMM_emof_Comment")
JTLMM_JTL_Transformation = Class(name="JTLMM_JTL_Transformation")
emof_Class = Class(name="emof_Class")
emof_Package = Class(name="emof_Package")
Model = Class(name="Model")
Relation = Class(name="Relation")
JTLMM_JTL_Relation = Class(name="JTLMM_JTL_Relation")
Transformation = Class(name="Transformation")
Domain = Class(name="Domain")
Pattern = Class(name="Pattern")
JTLMM_essentialocl_OclExpression = Class(name="JTLMM_essentialocl_OclExpression", is_abstract=True)
TypedElement = Class(name="TypedElement")
TryExp = Class(name="TryExp")
JTLMM_essentialocl_UnlimitedNaturalExp = Class(name="JTLMM_essentialocl_UnlimitedNaturalExp")
NumericLiteralExp = Class(name="NumericLiteralExp")
JTLMM_essentialocl_IfExp = Class(name="JTLMM_essentialocl_IfExp")
Predicate = Class(name="Predicate")
TemplateExp = Class(name="TemplateExp")
JTLMM_JTL_Predicate = Class(name="JTLMM_JTL_Predicate")
OclExpression = Class(name="OclExpression")
JTLMM_essentialocl_BooleanLiteralExp = Class(name="JTLMM_essentialocl_BooleanLiteralExp")
PrimitiveLiteralExp = Class(name="PrimitiveLiteralExp")
JTLMM_essentialocl_CallExp = Class(name="JTLMM_essentialocl_CallExp", is_abstract=True)
JTLMM_essentialocl_PropertyCallExp = Class(name="JTLMM_essentialocl_PropertyCallExp")
FeaturePropertyCall = Class(name="FeaturePropertyCall")
JTLMM_essentialocl_VariableExp = Class(name="JTLMM_essentialocl_VariableExp")
JTLMM_essentialocl_TypeExp = Class(name="JTLMM_essentialocl_TypeExp")
JTLMM_essentialocl_LoopExp = Class(name="JTLMM_essentialocl_LoopExp", is_abstract=True)
essentialocl_CallExp = Class(name="essentialocl_CallExp")
essentialocl_OclExpression = Class(name="essentialocl_OclExpression")
JTLMM_essentialocl_IteratorExp = Class(name="JTLMM_essentialocl_IteratorExp")
LoopExp = Class(name="LoopExp")
JTLMM_essentialocl_LetExp = Class(name="JTLMM_essentialocl_LetExp")
JTLMM_essentialocl_StringLiteralExp = Class(name="JTLMM_essentialocl_StringLiteralExp")
JTLMM_essentialocl_IntegerLiteralExp = Class(name="JTLMM_essentialocl_IntegerLiteralExp")
JTLMM_essentialocl_OperationCallExp = Class(name="JTLMM_essentialocl_OperationCallExp")
JTLMM_essentialocl_Variable = Class(name="JTLMM_essentialocl_Variable")
LetExp = Class(name="LetExp")
ComputeExp = Class(name="ComputeExp")
JTLMM_essentialocl_PrimitiveLiteralExp = Class(name="JTLMM_essentialocl_PrimitiveLiteralExp", is_abstract=True)
LiteralExp = Class(name="LiteralExp")
JTLMM_essentialocl_NumericLiteralExp = Class(name="JTLMM_essentialocl_NumericLiteralExp", is_abstract=True)
JTLMM_essentialocl_CollectionLiteralExp = Class(name="JTLMM_essentialocl_CollectionLiteralExp")
CollectionLiteralPart = Class(name="CollectionLiteralPart")
JTLMM_essentialocl_CollectionLiteralPart = Class(name="JTLMM_essentialocl_CollectionLiteralPart", is_abstract=True)
CollectionLiteralExp = Class(name="CollectionLiteralExp")
JTLMM_essentialocl_CollectionItem = Class(name="JTLMM_essentialocl_CollectionItem")
JTLMM_essentialocl_CollectionRange = Class(name="JTLMM_essentialocl_CollectionRange")
JTLMM_essentialocl_TupleLiteralExp = Class(name="JTLMM_essentialocl_TupleLiteralExp")
TupleLiteralPart = Class(name="TupleLiteralPart")
JTLMM_essentialocl_NullLiteralExp = Class(name="JTLMM_essentialocl_NullLiteralExp")
JTLMM_essentialocl_ExpressionInOcl = Class(name="JTLMM_essentialocl_ExpressionInOcl")
OpaqueExpression = Class(name="OpaqueExpression")
JTLMM_essentialocl_RealLiteralExp = Class(name="JTLMM_essentialocl_RealLiteralExp")
JTLMM_essentialocl_LiteralExp = Class(name="JTLMM_essentialocl_LiteralExp", is_abstract=True)
JTLMM_essentialocl_IterateExp = Class(name="JTLMM_essentialocl_IterateExp")
JTLMM_essentialocl_EnumLiteralExp = Class(name="JTLMM_essentialocl_EnumLiteralExp")
JTLMM_essentialocl_InvalidType = Class(name="JTLMM_essentialocl_InvalidType")
JTLMM_essentialocl_OrderedSetType = Class(name="JTLMM_essentialocl_OrderedSetType")
JTLMM_essentialocl_SequenceType = Class(name="JTLMM_essentialocl_SequenceType")
JTLMM_essentialocl_SetType = Class(name="JTLMM_essentialocl_SetType")
JTLMM_essentialocl_TupleType = Class(name="JTLMM_essentialocl_TupleType")
emof_DataType = Class(name="emof_DataType")
JTLMM_essentialocl_VoidType = Class(name="JTLMM_essentialocl_VoidType")
JTLMM_essentialocl_AnyType = Class(name="JTLMM_essentialocl_AnyType")
emof_Type = Class(name="emof_Type")
JTLMM_template_TemplateExp = Class(name="JTLMM_template_TemplateExp", is_abstract=True)
JTLMM_template_ObjectTemplateExp = Class(name="JTLMM_template_ObjectTemplateExp")
PropertyTemplateItem = Class(name="PropertyTemplateItem")
AssignExp = Class(name="AssignExp")
JTLMM_template_CollectionTemplateExp = Class(name="JTLMM_template_CollectionTemplateExp")
JTLMM_essentialocl_OpaqueExpression = Class(name="JTLMM_essentialocl_OpaqueExpression")
JTLMM_essentialocl_InvalidLiteralExp = Class(name="JTLMM_essentialocl_InvalidLiteralExp")
JTLMM_essentialocl_FeaturePropertyCall = Class(name="JTLMM_essentialocl_FeaturePropertyCall", is_abstract=True)
CallExp = Class(name="CallExp")
JTLMM_essentialocl_TupleLiteralPart = Class(name="JTLMM_essentialocl_TupleLiteralPart")
TupleLiteralExp = Class(name="TupleLiteralExp")
JTLMM_essentialocl_BagType = Class(name="JTLMM_essentialocl_BagType")
CollectionType = Class(name="CollectionType")
JTLMM_essentialocl_CollectionType = Class(name="JTLMM_essentialocl_CollectionType", is_abstract=True)
JTLMM_imperativeocl_AssignExp = Class(name="JTLMM_imperativeocl_AssignExp")
ImperativeExpression = Class(name="ImperativeExpression")
JTLMM_imperativeocl_BlockExp = Class(name="JTLMM_imperativeocl_BlockExp")
JTLMM_imperativeocl_SwitchExp = Class(name="JTLMM_imperativeocl_SwitchExp")
imperativeocl_ImperativeExpression = Class(name="imperativeocl_ImperativeExpression")
AltExp = Class(name="AltExp")
JTLMM_imperativeocl_VariableInitExp = Class(name="JTLMM_imperativeocl_VariableInitExp")
JTLMM_imperativeocl_WhileExp = Class(name="JTLMM_imperativeocl_WhileExp")
JTLMM_template_PropertyTemplateItem = Class(name="JTLMM_template_PropertyTemplateItem")
ObjectTemplateExp = Class(name="ObjectTemplateExp")
JTLMM_imperativeocl_ImperativeIterateExp = Class(name="JTLMM_imperativeocl_ImperativeIterateExp")
ImperativeLoopExp = Class(name="ImperativeLoopExp")
JTLMM_imperativeocl_UnlinkExp = Class(name="JTLMM_imperativeocl_UnlinkExp")
JTLMM_imperativeocl_ReturnExp = Class(name="JTLMM_imperativeocl_ReturnExp")
JTLMM_imperativeocl_BreakExp = Class(name="JTLMM_imperativeocl_BreakExp")
JTLMM_imperativeocl_TryExp = Class(name="JTLMM_imperativeocl_TryExp")
JTLMM_imperativeocl_RaiseExp = Class(name="JTLMM_imperativeocl_RaiseExp")
JTLMM_imperativeocl_ContinueExp = Class(name="JTLMM_imperativeocl_ContinueExp")
JTLMM_imperativeocl_ForExp = Class(name="JTLMM_imperativeocl_ForExp")
JTLMM_imperativeocl_TupleExp = Class(name="JTLMM_imperativeocl_TupleExp")
JTLMM_imperativeocl_ComputeExp = Class(name="JTLMM_imperativeocl_ComputeExp")
JTLMM_imperativeocl_AltExp = Class(name="JTLMM_imperativeocl_AltExp")
JTLMM_imperativeocl_DictionaryType = Class(name="JTLMM_imperativeocl_DictionaryType")
JTLMM_imperativeocl_DictLiteralExp = Class(name="JTLMM_imperativeocl_DictLiteralExp")
DictLiteralPart = Class(name="DictLiteralPart")
JTLMM_imperativeocl_DictLiteralPart = Class(name="JTLMM_imperativeocl_DictLiteralPart")
JTLMM_imperativeocl_TemplateParameterType = Class(name="JTLMM_imperativeocl_TemplateParameterType")
JTLMM_imperativeocl_LogExp = Class(name="JTLMM_imperativeocl_LogExp")
JTLMM_imperativeocl_Typedef = Class(name="JTLMM_imperativeocl_Typedef")
JTLMM_imperativeocl_InstantiationExp = Class(name="JTLMM_imperativeocl_InstantiationExp")
JTLMM_imperativeocl_ImperativeLoopExp = Class(name="JTLMM_imperativeocl_ImperativeLoopExp", is_abstract=True)
essentialocl_LoopExp = Class(name="essentialocl_LoopExp")
JTLMM_imperativeocl_CollectorExp = Class(name="JTLMM_imperativeocl_CollectorExp")
JTLMM_imperativeocl_ImperativeExpression = Class(name="JTLMM_imperativeocl_ImperativeExpression", is_abstract=True)
JTLMM_imperativeocl_UnpackExp = Class(name="JTLMM_imperativeocl_UnpackExp")
JTLMM_imperativeocl_AnonymousTupleType = Class(name="JTLMM_imperativeocl_AnonymousTupleType")
JTLMM_imperativeocl_AnonymousTupleLiteralExp = Class(name="JTLMM_imperativeocl_AnonymousTupleLiteralExp")
AnonymousTupleLiteralPart = Class(name="AnonymousTupleLiteralPart")
JTLMM_imperativeocl_AnonymousTupleLiteralPart = Class(name="JTLMM_imperativeocl_AnonymousTupleLiteralPart")
JTLMM_imperativeocl_AssertExp = Class(name="JTLMM_imperativeocl_AssertExp")
LogExp = Class(name="LogExp")
JTLMM_imperativeocl_ListType = Class(name="JTLMM_imperativeocl_ListType")
...
JTLMM_emof_Property.attributes={JTLMM_emof_Property_isDerived, JTLMM_emof_Property_isId, JTLMM_emof_Property_isComposite, JTLMM_emof_Property_default, JTLMM_emof_Property_isReadOnly}
...
JTLMM_emof_MultiplicityElement.attributes={JTLMM_emof_MultiplicityElement_isUnique, JTLMM_emof_MultiplicityElement_isOrdered, JTLMM_emof_MultiplicityElement_lower, JTLMM_emof_MultiplicityElement_upper}
...
ownedAttribute0: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="Property", type=JTLMM_emof_Class, multiplicity=Multiplicity(1, 1)),
...
ownedOperation1: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="Operation", type=JTLMM_emof_Class, multiplicity=Multiplicity(1, 1)),
...
superClass2: BinaryAssociation = BinaryAssociation(
    name="superClass2",
    ends={
        Property(name="Class3", type=JTLMM_emof_Class, multiplicity=Multiplicity(1, 1)),
...
tag4: BinaryAssociation = BinaryAssociation(
    name="tag4",
    ends={
        Property(name="Tag", type=JTLMM_emof_Element, multiplicity=Multiplicity(1, 1)),
...
element6: BinaryAssociation = BinaryAssociation(
    name="element6",
    ends={
        Property(name="Element", type=JTLMM_emof_Tag, multiplicity=Multiplicity(1, 1)),
...
package15: BinaryAssociation = BinaryAssociation(
    name="package15",
    ends={
        Property(name="Package16", type=JTLMM_emof_Type, multiplicity=Multiplicity(1, 1)),
...
operation17: BinaryAssociation = BinaryAssociation(
    name="operation17",
    ends={
        Property(name="Operation18", type=JTLMM_emof_Parameter, multiplicity=Multiplicity(1, 1)),
...
enumeration19: BinaryAssociation = BinaryAssociation(
    name="enumeration19",
    ends={
        Property(name="Enumeration", type=JTLMM_emof_EnumerationLiteral, multiplicity=Multiplicity(1, 1)),
...
Class20: BinaryAssociation = BinaryAssociation(
    name="Class20",
    ends={
        Property(name="Class21", type=JTLMM_emof_Property, multiplicity=Multiplicity(1, 1)),
...
opposite22: BinaryAssociation = BinaryAssociation(
    name="opposite22",
    ends={
        Property(name="Property23", type=JTLMM_emof_Property, multiplicity=Multiplicity(1, 1)),
...
ownedLiteral7: BinaryAssociation = BinaryAssociation(
    name="ownedLiteral7",
    ends={
        Property(name="EnumerationLiteral", type=JTLMM_emof_Enumeration, multiplicity=Multiplicity(1, 1)),
...
class_8: BinaryAssociation = BinaryAssociation(
    name="class_8",
    ends={
        Property(name="Class9", type=JTLMM_emof_Operation, multiplicity=Multiplicity(1, 1)),
...
ownedParameter10: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="Parameter", type=JTLMM_emof_Operation, multiplicity=Multiplicity(1, 1)),
...
ownedType12: BinaryAssociation = BinaryAssociation(
    name="ownedType12",
    ends={
        Property(name="Type13", type=JTLMM_emof_Package, multiplicity=Multiplicity(1, 1)),
...
relation35: BinaryAssociation = BinaryAssociation(
    name="relation35",
    ends={
        Property(name="Relation36", type=JTLMM_JTL_Domain, multiplicity=Multiplicity(1, 1)),
        Property(name="domain", type=Relation, multiplicity=Multiplicity(1, 1))
    }
)
pattern37: BinaryAssociation = BinaryAssociation(
    name="pattern37",
    ends={
        Property(name="Pattern38", type=JTLMM_JTL_Domain, multiplicity=Multiplicity(1, 1)),
...
model39: BinaryAssociation = BinaryAssociation(
    name="model39",
    ends={
        Property(name="Model41", type=JTLMM_JTL_Domain, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_JTL_Domain40", type=Model, multiplicity=Multiplicity(1, 1))
    }
)
rootVariable42: BinaryAssociation = BinaryAssociation(
    name="rootVariable42",
    ends={
        Property(name="Variable44", type=JTLMM_JTL_Domain, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_JTL_Domain43", type=Variable, multiplicity=Multiplicity(1, 1))
    }
)
transformation45: BinaryAssociation = BinaryAssociation(
    name="transformation45",
    ends={
        Property(name="Transformation46", type=JTLMM_JTL_Model, multiplicity=Multiplicity(1, 1)),
        Property(name="modelParameter", type=Transformation, multiplicity=Multiplicity(1, 1))
    }
)
dependsOn47: BinaryAssociation = BinaryAssociation(
    name="dependsOn47",
    ends={
        Property(name="Model48", type=JTLMM_JTL_Model, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_JTL_Model", type=Model, multiplicity=Multiplicity(0, 9999))
    }
)
whereOwner49: BinaryAssociation = BinaryAssociation(
    name="whereOwner49",
    ends={
        Property(name="Relation50", type=JTLMM_JTL_Pattern, multiplicity=Multiplicity(1, 1)),
...
modelParameter25: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="Model", type=JTLMM_JTL_Transformation, multiplicity=Multiplicity(1, 1)),
...
relation26: BinaryAssociation = BinaryAssociation(
    name="relation26",
    ends={
        Property(name="Relation", type=JTLMM_JTL_Transformation, multiplicity=Multiplicity(1, 1)),
...
transformation28: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="Transformation", type=JTLMM_JTL_Relation, multiplicity=Multiplicity(1, 1)),
...
domain29: BinaryAssociation = BinaryAssociation(
    name="domain29",
    ends={
        Property(name="Domain", type=JTLMM_JTL_Relation, multiplicity=Multiplicity(1, 1)),
...
where31: BinaryAssociation = BinaryAssociation(
    name="where31",
    ends={
        Property(name="Pattern", type=JTLMM_JTL_Relation, multiplicity=Multiplicity(1, 1)),
...
when32: BinaryAssociation = BinaryAssociation(
    name="when32",
    ends={
        Property(name="Pattern33", type=JTLMM_JTL_Relation, multiplicity=Multiplicity(1, 1)),
...
source64: BinaryAssociation = BinaryAssociation(
    name="source64",
    ends={
        Property(name="OclExpression65", type=JTLMM_essentialocl_CallExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_essentialocl_CallExp", type=OclExpression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
tryBodyOwner66: BinaryAssociation = BinaryAssociation(
    name="tryBodyOwner66",
    ends={
        Property(name="TryExp", type=JTLMM_essentialocl_OclExpression, multiplicity=Multiplicity(1, 1)),
...
condition67: BinaryAssociation = BinaryAssociation(
    name="condition67",
    ends={
        Property(name="OclExpression68", type=JTLMM_essentialocl_IfExp, multiplicity=Multiplicity(1, 1)),
...
thenExpression69: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="OclExpression71", type=JTLMM_essentialocl_IfExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_essentialocl_IfExp70", type=OclExpression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
whenOwner51: BinaryAssociation = BinaryAssociation(
    name="whenOwner51",
    ends={
        Property(name="Relation52", type=JTLMM_JTL_Pattern, multiplicity=Multiplicity(1, 1)),
...
elseExpression72: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="OclExpression74", type=JTLMM_essentialocl_IfExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_essentialocl_IfExp73", type=OclExpression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
predicate53: BinaryAssociation = BinaryAssociation(
    name="predicate53",
    ends={
        Property(name="Predicate", type=JTLMM_JTL_Pattern, multiplicity=Multiplicity(1, 1)),
        Property(name="pattern", type=Predicate, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
bindsTo54: BinaryAssociation = BinaryAssociation(
    name="bindsTo54",
    ends={
        Property(name="Variable55", type=JTLMM_JTL_Pattern, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_JTL_Pattern", type=Variable, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
templateExpression56: BinaryAssociation = BinaryAssociation(
    name="templateExpression56",
    ends={
        Property(name="TemplateExp", type=JTLMM_JTL_Pattern, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_JTL_Pattern57", type=TemplateExp, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
domain58: BinaryAssociation = BinaryAssociation(
    name="domain58",
    ends={
        Property(name="Domain60", type=JTLMM_JTL_Pattern, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_JTL_Pattern59", type=Domain, multiplicity=Multiplicity(1, 1))
    }
)
pattern61: BinaryAssociation = BinaryAssociation(
    name="pattern61",
    ends={
        Property(name="Pattern62", type=JTLMM_JTL_Predicate, multiplicity=Multiplicity(1, 1)),
        Property(name="predicate", type=Pattern, multiplicity=Multiplicity(1, 1))
    }
)
conditionExpression63: BinaryAssociation = BinaryAssociation(
    name="conditionExpression63",
    ends={
...
referredProperty87: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="Property88", type=JTLMM_essentialocl_PropertyCallExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_essentialocl_PropertyCallExp", type=Property_, multiplicity=Multiplicity(0, 1))
    }
)
referredVariable89: BinaryAssociation = BinaryAssociation(
    name="referredVariable89",
    ends={
        Property(name="Variable90", type=JTLMM_essentialocl_VariableExp, multiplicity=Multiplicity(1, 1)),
...
referredType91: BinaryAssociation = BinaryAssociation(
    name="referredType91",
    ends={
        Property(name="Type92", type=JTLMM_essentialocl_TypeExp, multiplicity=Multiplicity(1, 1)),
...
body93: BinaryAssociation = BinaryAssociation(
    name="body93",
    ends={
        Property(name="OclExpression94", type=JTLMM_essentialocl_LoopExp, multiplicity=Multiplicity(1, 1)),
...
iterator95: BinaryAssociation = BinaryAssociation(
    name="iterator95",
    ends={
        Property(name="Variable97", type=JTLMM_essentialocl_LoopExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_essentialocl_LoopExp96", type=Variable, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
in_75: BinaryAssociation = BinaryAssociation(
    name="in_75",
    ends={
        Property(name="OclExpression76", type=JTLMM_essentialocl_LetExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_essentialocl_LetExp", type=OclExpression, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
variable77: BinaryAssociation = BinaryAssociation(
    name="variable77",
    ends={
        Property(name="Variable78", type=JTLMM_essentialocl_LetExp, multiplicity=Multiplicity(1, 1)),
...
initExpression79: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="OclExpression80", type=JTLMM_essentialocl_Variable, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_essentialocl_Variable", type=OclExpression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
LetExp81: BinaryAssociation = BinaryAssociation(
    name="LetExp81",
    ends={
        Property(name="LetExp82", type=JTLMM_essentialocl_Variable, multiplicity=Multiplicity(1, 1)),
        Property(name="variable", type=LetExp, multiplicity=Multiplicity(0, 1))
    }
)
bindParameter83: BinaryAssociation = BinaryAssociation(
    name="bindParameter83",
    ends={
        Property(name="Parameter85", type=JTLMM_essentialocl_Variable, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_essentialocl_Variable84", type=Parameter_, multiplicity=Multiplicity(0, 1))
    }
)
computeOwner86: BinaryAssociation = BinaryAssociation(
    name="computeOwner86",
    ends={
        Property(name="ComputeExp", type=JTLMM_essentialocl_Variable, multiplicity=Multiplicity(1, 1)),
...
result103: BinaryAssociation = BinaryAssociation(
    name="result103",
    ends={
        Property(name="Variable104", type=JTLMM_essentialocl_IterateExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_essentialocl_IterateExp", type=Variable, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
part105: BinaryAssociation = BinaryAssociation(
    name="part105",
    ends={
        Property(name="CollectionLiteralPart", type=JTLMM_essentialocl_CollectionLiteralExp, multiplicity=Multiplicity(1, 1)),
        Property(name="CollectionLiteralExp", type=CollectionLiteralPart, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
CollectionLiteralExp106: BinaryAssociation = BinaryAssociation(
    name="CollectionLiteralExp106",
    ends={
        Property(name="CollectionLiteralExp107", type=JTLMM_essentialocl_CollectionLiteralPart, multiplicity=Multiplicity(1, 1)),
        Property(name="part", type=CollectionLiteralExp, multiplicity=Multiplicity(1, 1))
    }
)
item108: BinaryAssociation = BinaryAssociation(
    name="item108",
    ends={
        Property(name="OclExpression109", type=JTLMM_essentialocl_CollectionItem, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_essentialocl_CollectionItem", type=OclExpression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
first110: BinaryAssociation = BinaryAssociation(
    name="first110",
    ends={
        Property(name="OclExpression111", type=JTLMM_essentialocl_CollectionRange, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_essentialocl_CollectionRange", type=OclExpression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
last112: BinaryAssociation = BinaryAssociation(
    name="last112",
    ends={
        Property(name="OclExpression114", type=JTLMM_essentialocl_CollectionRange, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_essentialocl_CollectionRange113", type=OclExpression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
part115: BinaryAssociation = BinaryAssociation(
    name="part115",
    ends={
        Property(name="TupleLiteralPart", type=JTLMM_essentialocl_TupleLiteralExp, multiplicity=Multiplicity(1, 1)),
        Property(name="TupleLiteralExp", type=TupleLiteralPart, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
bodyExpression116: BinaryAssociation = BinaryAssociation(
    name="bodyExpression116",
    ends={
        Property(name="OclExpression117", type=JTLMM_essentialocl_ExpressionInOcl, multiplicity=Multiplicity(1, 1)),
...
context118: BinaryAssociation = BinaryAssociation(
    name="context118",
    ends={
        Property(name="Variable120", type=JTLMM_essentialocl_ExpressionInOcl, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_essentialocl_ExpressionInOcl119", type=Variable, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
argument98: BinaryAssociation = BinaryAssociation(
    name="argument98",
    ends={
        Property(name="OclExpression99", type=JTLMM_essentialocl_OperationCallExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_essentialocl_OperationCallExp", type=OclExpression, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
referredOperation100: BinaryAssociation = BinaryAssociation(
    name="referredOperation100",
    ends={
        Property(name="Operation102", type=JTLMM_essentialocl_OperationCallExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_essentialocl_OperationCallExp101", type=Operation, multiplicity=Multiplicity(0, 1))
    }
)
referredEnumLiteral132: BinaryAssociation = BinaryAssociation(
    name="referredEnumLiteral132",
    ends={
        Property(name="EnumerationLiteral133", type=JTLMM_essentialocl_EnumLiteralExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_essentialocl_EnumLiteralExp", type=EnumerationLiteral, multiplicity=Multiplicity(0, 1))
    }
)
bindsTo134: BinaryAssociation = BinaryAssociation(
    name="bindsTo134",
    ends={
        Property(name="Variable135", type=JTLMM_template_TemplateExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_template_TemplateExp", type=Variable, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
where136: BinaryAssociation = BinaryAssociation(
    name="where136",
    ends={
        Property(name="OclExpression138", type=JTLMM_template_TemplateExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_template_TemplateExp137", type=OclExpression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
part139: BinaryAssociation = BinaryAssociation(
    name="part139",
    ends={
        Property(name="PropertyTemplateItem", type=JTLMM_template_ObjectTemplateExp, multiplicity=Multiplicity(1, 1)),
        Property(name="objContainer", type=PropertyTemplateItem, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
inside140: BinaryAssociation = BinaryAssociation(
    name="inside140",
    ends={
...
part141: BinaryAssociation = BinaryAssociation(
    name="part141",
    ends={
        Property(name="OclExpression142", type=JTLMM_template_CollectionTemplateExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_template_CollectionTemplateExp", type=OclExpression, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
referredCollectionType143: BinaryAssociation = BinaryAssociation(
    name="referredCollectionType143",
    ends={
        Property(name="CollectionType", type=JTLMM_template_CollectionTemplateExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_template_CollectionTemplateExp144", type=CollectionType, multiplicity=Multiplicity(0, 1))
    }
)
match145: BinaryAssociation = BinaryAssociation(
    name="match145",
    ends={
        Property(name="OclExpression147", type=JTLMM_template_CollectionTemplateExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_template_CollectionTemplateExp146", type=OclExpression, multiplicity=Multiplicity(0, 1))
    }
)
resultVariable121: BinaryAssociation = BinaryAssociation(
    name="resultVariable121",
    ends={
        Property(name="Variable123", type=JTLMM_essentialocl_ExpressionInOcl, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_essentialocl_ExpressionInOcl122", type=Variable, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
parameterVariable124: BinaryAssociation = BinaryAssociation(
    name="parameterVariable124",
    ends={
        Property(name="Variable126", type=JTLMM_essentialocl_ExpressionInOcl, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_essentialocl_ExpressionInOcl125", type=Variable, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
TupleLiteralExp127: BinaryAssociation = BinaryAssociation(
    name="TupleLiteralExp127",
    ends={
        Property(name="TupleLiteralExp129", type=JTLMM_essentialocl_TupleLiteralPart, multiplicity=Multiplicity(1, 1)),
        Property(name="part128", type=TupleLiteralExp, multiplicity=Multiplicity(0, 1))
    }
)
elementType130: BinaryAssociation = BinaryAssociation(
    name="elementType130",
    ends={
        Property(name="Type131", type=JTLMM_essentialocl_CollectionType, multiplicity=Multiplicity(1, 1)),
...
target155: BinaryAssociation = BinaryAssociation(
    name="target155",
    ends={
        Property(name="Variable156", type=JTLMM_imperativeocl_ImperativeIterateExp, multiplicity=Multiplicity(1, 1)),
...
value157: BinaryAssociation = BinaryAssociation(
    name="value157",
    ends={
        Property(name="OclExpression158", type=JTLMM_imperativeocl_AssignExp, multiplicity=Multiplicity(1, 1)),
...
left159: BinaryAssociation = BinaryAssociation(
    name="left159",
    ends={
        Property(name="OclExpression161", type=JTLMM_imperativeocl_AssignExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_imperativeocl_AssignExp160", type=OclExpression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
defaultValue162: BinaryAssociation = BinaryAssociation(
    name="defaultValue162",
    ends={
        Property(name="OclExpression164", type=JTLMM_imperativeocl_AssignExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_imperativeocl_AssignExp163", type=OclExpression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
body165: BinaryAssociation = BinaryAssociation(
    name="body165",
    ends={
        Property(name="OclExpression166", type=JTLMM_imperativeocl_BlockExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_imperativeocl_BlockExp", type=OclExpression, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
alternativePart167: BinaryAssociation = BinaryAssociation(
    name="alternativePart167",
    ends={
...
elsePart168: BinaryAssociation = BinaryAssociation(
    name="elsePart168",
    ends={
        Property(name="OclExpression170", type=JTLMM_imperativeocl_SwitchExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_imperativeocl_SwitchExp169", type=OclExpression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
referredVariable171: BinaryAssociation = BinaryAssociation(
    name="referredVariable171",
    ends={
        Property(name="Variable172", type=JTLMM_imperativeocl_VariableInitExp, multiplicity=Multiplicity(1, 1)),
...
condition173: BinaryAssociation = BinaryAssociation(
    name="condition173",
    ends={
        Property(name="OclExpression174", type=JTLMM_imperativeocl_WhileExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_imperativeocl_WhileExp", type=OclExpression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
body175: BinaryAssociation = BinaryAssociation(
    name="body175",
    ends={
        Property(name="OclExpression177", type=JTLMM_imperativeocl_WhileExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_imperativeocl_WhileExp176", type=OclExpression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
objContainer148: BinaryAssociation = BinaryAssociation(
    name="objContainer148",
    ends={
        Property(name="ObjectTemplateExp", type=JTLMM_template_PropertyTemplateItem, multiplicity=Multiplicity(1, 1)),
        Property(name="part149", type=ObjectTemplateExp, multiplicity=Multiplicity(1, 1))
    }
)
value150: BinaryAssociation = BinaryAssociation(
    name="value150",
    ends={
        Property(name="OclExpression151", type=JTLMM_template_PropertyTemplateItem, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_template_PropertyTemplateItem", type=OclExpression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
referredProperty152: BinaryAssociation = BinaryAssociation(
    name="referredProperty152",
    ends={
        Property(name="Property154", type=JTLMM_template_PropertyTemplateItem, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_template_PropertyTemplateItem153", type=Property_, multiplicity=Multiplicity(1, 1))
    }
)
target187: BinaryAssociation = BinaryAssociation(
    name="target187",
    ends={
        Property(name="OclExpression188", type=JTLMM_imperativeocl_UnlinkExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_imperativeocl_UnlinkExp", type=OclExpression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
item189: BinaryAssociation = BinaryAssociation(
    name="item189",
    ends={
        Property(name="OclExpression191", type=JTLMM_imperativeocl_UnlinkExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_imperativeocl_UnlinkExp190", type=OclExpression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
value192: BinaryAssociation = BinaryAssociation(
    name="value192",
    ends={
        Property(name="OclExpression193", type=JTLMM_imperativeocl_ReturnExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_imperativeocl_ReturnExp", type=OclExpression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
tryBody194: BinaryAssociation = BinaryAssociation(
    name="tryBody194",
    ends={
        Property(name="OclExpression195", type=JTLMM_imperativeocl_TryExp, multiplicity=Multiplicity(1, 1)),
        Property(name="tryBodyOwner", type=OclExpression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
exception196: BinaryAssociation = BinaryAssociation(
    name="exception196",
    ends={
        Property(name="Type197", type=JTLMM_imperativeocl_TryExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_imperativeocl_TryExp", type=Type, multiplicity=Multiplicity(0, 9999))
    }
)
exceptBody198: BinaryAssociation = BinaryAssociation(
    name="exceptBody198",
    ends={
        Property(name="OclExpression200", type=JTLMM_imperativeocl_TryExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_imperativeocl_TryExp199", type=OclExpression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
exception201: BinaryAssociation = BinaryAssociation(
    name="exception201",
    ends={
        Property(name="Type202", type=JTLMM_imperativeocl_RaiseExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_imperativeocl_RaiseExp", type=Type, multiplicity=Multiplicity(1, 1))
    }
)
element203: BinaryAssociation = BinaryAssociation(
    name="element203",
    ends={
        Property(name="OclExpression204", type=JTLMM_imperativeocl_TupleExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_imperativeocl_TupleExp", type=OclExpression, multiplicity=Multiplicity(1, 9999), is_composite=True)
    }
)
returnedElement178: BinaryAssociation = BinaryAssociation(
    name="returnedElement178",
    ends={
        Property(name="Variable179", type=JTLMM_imperativeocl_ComputeExp, multiplicity=Multiplicity(1, 1)),
...
body180: BinaryAssociation = BinaryAssociation(
    name="body180",
    ends={
        Property(name="OclExpression181", type=JTLMM_imperativeocl_ComputeExp, multiplicity=Multiplicity(1, 1)),
...
condition182: BinaryAssociation = BinaryAssociation(
    name="condition182",
    ends={
        Property(name="OclExpression183", type=JTLMM_imperativeocl_AltExp, multiplicity=Multiplicity(1, 1)),
...
body184: BinaryAssociation = BinaryAssociation(
    name="body184",
    ends={
        Property(name="OclExpression186", type=JTLMM_imperativeocl_AltExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_imperativeocl_AltExp185", type=OclExpression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
argument215: BinaryAssociation = BinaryAssociation(
    name="argument215",
    ends={
        Property(name="OclExpression217", type=JTLMM_imperativeocl_InstantiationExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_imperativeocl_InstantiationExp216", type=OclExpression, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
keyType218: BinaryAssociation = BinaryAssociation(
    name="keyType218",
    ends={
        Property(name="Type219", type=JTLMM_imperativeocl_DictionaryType, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_imperativeocl_DictionaryType", type=Type, multiplicity=Multiplicity(0, 1))
    }
)
part220: BinaryAssociation = BinaryAssociation(
    name="part220",
    ends={
...
key221: BinaryAssociation = BinaryAssociation(
    name="key221",
    ends={
        Property(name="OclExpression222", type=JTLMM_imperativeocl_DictLiteralPart, multiplicity=Multiplicity(1, 1)),
...
value223: BinaryAssociation = BinaryAssociation(
    name="value223",
    ends={
        Property(name="OclExpression225", type=JTLMM_imperativeocl_DictLiteralPart, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_imperativeocl_DictLiteralPart224", type=OclExpression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
condition226: BinaryAssociation = BinaryAssociation(
    name="condition226",
    ends={
        Property(name="OclExpression227", type=JTLMM_imperativeocl_LogExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_imperativeocl_LogExp", type=OclExpression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
element228: BinaryAssociation = BinaryAssociation(
    name="element228",
    ends={
        Property(name="Element230", type=JTLMM_imperativeocl_LogExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_imperativeocl_LogExp229", type=Element, multiplicity=Multiplicity(0, 1))
    }
)
base205: BinaryAssociation = BinaryAssociation(
    name="base205",
    ends={
        Property(name="Type206", type=JTLMM_imperativeocl_Typedef, multiplicity=Multiplicity(1, 1)),
...
condition207: BinaryAssociation = BinaryAssociation(
    name="condition207",
    ends={
        Property(name="OclExpression209", type=JTLMM_imperativeocl_Typedef, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_imperativeocl_Typedef208", type=OclExpression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
instantiatedClass210: BinaryAssociation = BinaryAssociation(
    name="instantiatedClass210",
    ends={
        Property(name="Class211", type=JTLMM_imperativeocl_InstantiationExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_imperativeocl_InstantiationExp", type=Class_, multiplicity=Multiplicity(1, 1))
    }
)
extent212: BinaryAssociation = BinaryAssociation(
    name="extent212",
    ends={
        Property(name="Variable214", type=JTLMM_imperativeocl_InstantiationExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_imperativeocl_InstantiationExp213", type=Variable, multiplicity=Multiplicity(0, 1))
    }
)
condition235: BinaryAssociation = BinaryAssociation(
    name="condition235",
    ends={
        Property(name="OclExpression236", type=JTLMM_imperativeocl_ImperativeLoopExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_imperativeocl_ImperativeLoopExp", type=OclExpression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
target237: BinaryAssociation = BinaryAssociation(
    name="target237",
    ends={
        Property(name="Variable238", type=JTLMM_imperativeocl_CollectorExp, multiplicity=Multiplicity(1, 1)),
...
variable239: BinaryAssociation = BinaryAssociation(
    name="variable239",
    ends={
        Property(name="Variable240", type=JTLMM_imperativeocl_UnpackExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_imperativeocl_UnpackExp", type=Variable, multiplicity=Multiplicity(1, 9999), is_composite=True)
    }
)
elementType241: BinaryAssociation = BinaryAssociation(
    name="elementType241",
    ends={
        Property(name="Type242", type=JTLMM_imperativeocl_AnonymousTupleType, multiplicity=Multiplicity(1, 1)),
...
value244: BinaryAssociation = BinaryAssociation(
    name="value244",
    ends={
        Property(name="OclExpression245", type=JTLMM_imperativeocl_AnonymousTupleLiteralPart, multiplicity=Multiplicity(1, 1)),
...
log231: BinaryAssociation = BinaryAssociation(
    name="log231",
    ends={
...
assertion232: BinaryAssociation = BinaryAssociation(
    name="assertion232",
    ends={
        Property(name="OclExpression234", type=JTLMM_imperativeocl_AssertExp, multiplicity=Multiplicity(1, 1)),
        Property(name="JTLMM_imperativeocl_AssertExp233", type=OclExpression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
...
domain_model = DomainModel(
    name="JTLMM",
    types={JTLMM_emof_Class, Type, Property_, Operation, Class_, JTLMM_emof_DataType, JTLMM_emof_Element, Object, Tag, Comment, JTLMM_emof_Tag, Element, JTLMM_emof_Parameter, JTLMM_emof_EnumerationLiteral, Enumeration_, JTLMM_emof_Property, JTLMM_emof_Enumeration, DataType, EnumerationLiteral, JTLMM_emof_NamedElement, JTLMM_emof_Extent, JTLMM_emof_Object, JTLMM_emof_Operation, emof_MultiplicityElement, emof_TypedElement, Parameter_, JTLMM_emof_MultiplicityElement, JTLMM_emof_Package, NamedElement, Package, JTLMM_emof_Type, Variable, JTLMM_JTL_Domain, JTLMM_JTL_Model, JTLMM_JTL_Pattern, JTLMM_emof_TypedElement, JTLMM_emof_PrimitiveType, JTLMM_emof_URIExtent, Extent, JTLMM_emof_Comment, JTLMM_JTL_Transformation, emof_Class, emof_Package, Model, Relation, JTLMM_JTL_Relation, Transformation, Domain, Pattern, JTLMM_essentialocl_OclExpression, TypedElement, TryExp, JTLMM_essentialocl_UnlimitedNaturalExp, NumericLiteralExp, JTLMM_essentialocl_IfExp, Predicate, TemplateExp, JTLMM_JTL_Predicate, OclExpression, JTLMM_essentialocl_BooleanLiteralExp, PrimitiveLiteralExp, JTLMM_essentialocl_CallExp, JTLMM_essentialocl_PropertyCallExp, FeaturePropertyCall, JTLMM_essentialocl_VariableExp, JTLMM_essentialocl_TypeExp, JTLMM_essentialocl_LoopExp, essentialocl_CallExp, essentialocl_OclExpression, JTLMM_essentialocl_IteratorExp, LoopExp, JTLMM_essentialocl_LetExp, JTLMM_essentialocl_StringLiteralExp, JTLMM_essentialocl_IntegerLiteralExp, JTLMM_essentialocl_OperationCallExp, JTLMM_essentialocl_Variable, LetExp, ComputeExp, JTLMM_essentialocl_PrimitiveLiteralExp, LiteralExp, JTLMM_essentialocl_NumericLiteralExp, JTLMM_essentialocl_CollectionLiteralExp, CollectionLiteralPart, JTLMM_essentialocl_CollectionLiteralPart, CollectionLiteralExp, JTLMM_essentialocl_CollectionItem, JTLMM_essentialocl_CollectionRange, JTLMM_essentialocl_TupleLiteralExp, TupleLiteralPart, JTLMM_essentialocl_NullLiteralExp, JTLMM_essentialocl_ExpressionInOcl, OpaqueExpression, JTLMM_essentialocl_RealLiteralExp, JTLMM_essentialocl_LiteralExp, JTLMM_essentialocl_IterateExp, JTLMM_essentialocl_EnumLiteralExp, JTLMM_essentialocl_InvalidType, JTLMM_essentialocl_OrderedSetType, JTLMM_essentialocl_SequenceType, JTLMM_essentialocl_SetType, JTLMM_essentialocl_TupleType, emof_DataType, JTLMM_essentialocl_VoidType, JTLMM_essentialocl_AnyType, emof_Type, JTLMM_template_TemplateExp, JTLMM_template_ObjectTemplateExp, PropertyTemplateItem, AssignExp, JTLMM_template_CollectionTemplateExp, JTLMM_essentialocl_OpaqueExpression, JTLMM_essentialocl_InvalidLiteralExp, JTLMM_essentialocl_FeaturePropertyCall, CallExp, JTLMM_essentialocl_TupleLiteralPart, TupleLiteralExp, JTLMM_essentialocl_BagType, CollectionType, JTLMM_essentialocl_CollectionType, JTLMM_imperativeocl_AssignExp, ImperativeExpression, JTLMM_imperativeocl_BlockExp, JTLMM_imperativeocl_SwitchExp, imperativeocl_ImperativeExpression, AltExp, JTLMM_imperativeocl_VariableInitExp, JTLMM_imperativeocl_WhileExp, JTLMM_template_PropertyTemplateItem, ObjectTemplateExp, JTLMM_imperativeocl_ImperativeIterateExp, ImperativeLoopExp, JTLMM_imperativeocl_UnlinkExp, JTLMM_imperativeocl_ReturnExp, JTLMM_imperativeocl_BreakExp, JTLMM_imperativeocl_TryExp, JTLMM_imperativeocl_RaiseExp, JTLMM_imperativeocl_ContinueExp, JTLMM_imperativeocl_ForExp, JTLMM_imperativeocl_TupleExp, JTLMM_imperativeocl_ComputeExp, JTLMM_imperativeocl_AltExp, JTLMM_imperativeocl_DictionaryType, JTLMM_imperativeocl_DictLiteralExp, DictLiteralPart, JTLMM_imperativeocl_DictLiteralPart, JTLMM_imperativeocl_TemplateParameterType, JTLMM_imperativeocl_LogExp, JTLMM_imperativeocl_Typedef, JTLMM_imperativeocl_InstantiationExp, JTLMM_imperativeocl_ImperativeLoopExp, essentialocl_LoopExp, JTLMM_imperativeocl_CollectorExp, JTLMM_imperativeocl_ImperativeExpression, JTLMM_imperativeocl_UnpackExp, JTLMM_imperativeocl_AnonymousTupleType, JTLMM_imperativeocl_AnonymousTupleLiteralExp, AnonymousTupleLiteralPart, JTLMM_imperativeocl_AnonymousTupleLiteralPart, JTLMM_imperativeocl_AssertExp, LogExp, JTLMM_imperativeocl_ListType, CollectionKind, SeverityKind},
    associations={ownedAttribute0, ownedOperation1, superClass2, tag4, ownedComment5, element6, package15, operation17, enumeration19, Class20, opposite22, ownedLiteral7, class_8, ownedParameter10, raisedException11, ownedType12, nestedPackage14, variable34, relation35, pattern37, model39, rootVariable42, transformation45, dependsOn47, whereOwner49, annotatedElement24, modelParameter25, relation26, transformation28, domain29, where31, when32, source64, tryBodyOwner66, condition67, thenExpression69, whenOwner51, elseExpression72, predicate53, bindsTo54, templateExpression56, domain58, pattern61, conditionExpression63, referredProperty87, referredVariable89, referredType91, body93, iterator95, in_75, variable77, initExpression79, LetExp81, bindParameter83, computeOwner86, result103, part105, CollectionLiteralExp106, item108, first110, last112, part115, bodyExpression116, context118, argument98, referredOperation100, referredEnumLiteral132, bindsTo134, where136, part139, inside140, part141, referredCollectionType143, match145, resultVariable121, parameterVariable124, TupleLiteralExp127, elementType130, target155, value157, left159, defaultValue162, body165, alternativePart167, elsePart168, referredVariable171, condition173, body175, objContainer148, value150, referredProperty152, target187, item189, value192, tryBody194, exception196, exceptBody198, exception201, element203, returnedElement178, body180, condition182, body184, argument215, keyType218, part220, key221, value223, condition226, element228, base205, condition207, instantiatedClass210, extent212, condition235, target237, variable239, elementType241, part243, value244, log231, assertion232},
    generalizations={gen_JTLMM_emof_Class_Type, gen_JTLMM_emof_DataType_Type, gen_JTLMM_emof_Element_Object, gen_JTLMM_emof_Tag_Element, gen_JTLMM_emof_Type_NamedElement, gen_JTLMM_emof_Parameter_emof_MultiplicityElement, gen_JTLMM_emof_Parameter_emof_TypedElement, gen_JTLMM_emof_EnumerationLiteral_NamedElement, gen_JTLMM_emof_Property_emof_MultiplicityElement, gen_JTLMM_emof_Property_emof_TypedElement, gen_JTLMM_emof_Enumeration_DataType, gen_JTLMM_emof_NamedElement_Element, gen_JTLMM_emof_Extent_Object, gen_JTLMM_emof_Operation_emof_MultiplicityElement, gen_JTLMM_emof_Operation_emof_TypedElement, gen_JTLMM_emof_Package_NamedElement, gen_JTLMM_JTL_Domain_NamedElement, gen_JTLMM_JTL_Model_NamedElement, gen_JTLMM_JTL_Pattern_Element, gen_JTLMM_emof_TypedElement_NamedElement, gen_JTLMM_emof_PrimitiveType_DataType, gen_JTLMM_emof_URIExtent_Extent, gen_JTLMM_emof_Comment_Element, gen_JTLMM_JTL_Transformation_emof_Class, gen_JTLMM_JTL_Transformation_emof_Package, gen_JTLMM_JTL_Relation_NamedElement, gen_JTLMM_essentialocl_OclExpression_TypedElement, gen_JTLMM_essentialocl_UnlimitedNaturalExp_NumericLiteralExp, gen_JTLMM_essentialocl_IfExp_OclExpression, gen_JTLMM_JTL_Predicate_Element, gen_JTLMM_essentialocl_BooleanLiteralExp_PrimitiveLiteralExp, gen_JTLMM_essentialocl_CallExp_OclExpression, gen_JTLMM_essentialocl_PropertyCallExp_FeaturePropertyCall, gen_JTLMM_essentialocl_VariableExp_OclExpression, gen_JTLMM_essentialocl_TypeExp_OclExpression, gen_JTLMM_essentialocl_LoopExp_essentialocl_CallExp, gen_JTLMM_essentialocl_LoopExp_essentialocl_OclExpression, gen_JTLMM_essentialocl_IteratorExp_LoopExp, gen_JTLMM_essentialocl_LetExp_OclExpression, gen_JTLMM_essentialocl_StringLiteralExp_PrimitiveLiteralExp, gen_JTLMM_essentialocl_IntegerLiteralExp_NumericLiteralExp, gen_JTLMM_essentialocl_Variable_TypedElement, gen_JTLMM_essentialocl_PrimitiveLiteralExp_LiteralExp, gen_JTLMM_essentialocl_NumericLiteralExp_PrimitiveLiteralExp, gen_JTLMM_essentialocl_CollectionLiteralExp_LiteralExp, gen_JTLMM_essentialocl_CollectionLiteralPart_TypedElement, gen_JTLMM_essentialocl_CollectionItem_CollectionLiteralPart, gen_JTLMM_essentialocl_CollectionRange_CollectionLiteralPart, gen_JTLMM_essentialocl_TupleLiteralExp_LiteralExp, gen_JTLMM_essentialocl_NullLiteralExp_LiteralExp, gen_JTLMM_essentialocl_ExpressionInOcl_OpaqueExpression, gen_JTLMM_essentialocl_OperationCallExp_FeaturePropertyCall, gen_JTLMM_essentialocl_RealLiteralExp_NumericLiteralExp, gen_JTLMM_essentialocl_LiteralExp_OclExpression, gen_JTLMM_essentialocl_IterateExp_LoopExp, gen_JTLMM_essentialocl_EnumLiteralExp_LiteralExp, gen_JTLMM_essentialocl_InvalidType_Type, gen_JTLMM_essentialocl_OrderedSetType_CollectionType, gen_JTLMM_essentialocl_SequenceType_CollectionType, gen_JTLMM_essentialocl_SetType_CollectionType, gen_JTLMM_essentialocl_TupleType_emof_Class, gen_JTLMM_essentialocl_TupleType_emof_DataType, gen_JTLMM_essentialocl_VoidType_Type, gen_JTLMM_essentialocl_AnyType_emof_Class, gen_JTLMM_essentialocl_AnyType_emof_Type, gen_JTLMM_template_TemplateExp_LiteralExp, gen_JTLMM_template_ObjectTemplateExp_TemplateExp, gen_JTLMM_template_CollectionTemplateExp_TemplateExp, gen_JTLMM_essentialocl_InvalidLiteralExp_LiteralExp, gen_JTLMM_essentialocl_FeaturePropertyCall_CallExp, gen_JTLMM_essentialocl_TupleLiteralPart_TypedElement, gen_JTLMM_essentialocl_BagType_CollectionType, gen_JTLMM_essentialocl_CollectionType_DataType, gen_JTLMM_imperativeocl_AssignExp_ImperativeExpression, gen_JTLMM_imperativeocl_BlockExp_ImperativeExpression, gen_JTLMM_imperativeocl_SwitchExp_essentialocl_CallExp, gen_JTLMM_imperativeocl_SwitchExp_imperativeocl_ImperativeExpression, gen_JTLMM_imperativeocl_VariableInitExp_ImperativeExpression, gen_JTLMM_imperativeocl_WhileExp_ImperativeExpression, gen_JTLMM_template_PropertyTemplateItem_Element, gen_JTLMM_imperativeocl_ImperativeIterateExp_ImperativeLoopExp, gen_JTLMM_imperativeocl_UnlinkExp_ImperativeExpression, gen_JTLMM_imperativeocl_ReturnExp_ImperativeExpression, gen_JTLMM_imperativeocl_BreakExp_ImperativeExpression, gen_JTLMM_imperativeocl_TryExp_ImperativeExpression, gen_JTLMM_imperativeocl_RaiseExp_ImperativeExpression, gen_JTLMM_imperativeocl_ContinueExp_ImperativeExpression, gen_JTLMM_imperativeocl_ForExp_ImperativeLoopExp, gen_JTLMM_imperativeocl_TupleExp_ImperativeExpression, gen_JTLMM_imperativeocl_ComputeExp_ImperativeExpression, gen_JTLMM_imperativeocl_AltExp_ImperativeExpression, gen_JTLMM_imperativeocl_DictionaryType_CollectionType, gen_JTLMM_imperativeocl_DictLiteralExp_LiteralExp, gen_JTLMM_imperativeocl_DictLiteralPart_Element, gen_JTLMM_imperativeocl_TemplateParameterType_Type, gen_JTLMM_imperativeocl_LogExp_ImperativeExpression, gen_JTLMM_imperativeocl_Typedef_Class, gen_JTLMM_imperativeocl_InstantiationExp_ImperativeExpression, gen_JTLMM_imperativeocl_ImperativeLoopExp_essentialocl_LoopExp, gen_JTLMM_imperativeocl_ImperativeLoopExp_imperativeocl_ImperativeExpression, gen_JTLMM_imperativeocl_CollectorExp_ImperativeLoopExp, gen_JTLMM_imperativeocl_ImperativeExpression_OclExpression, gen_JTLMM_imperativeocl_UnpackExp_ImperativeExpression, gen_JTLMM_imperativeocl_AnonymousTupleType_Class, gen_JTLMM_imperativeocl_AnonymousTupleLiteralExp_LiteralExp, gen_JTLMM_imperativeocl_AnonymousTupleLiteralPart_Element, gen_JTLMM_imperativeocl_AssertExp_ImperativeExpression, gen_JTLMM_imperativeocl_ListType_CollectionType},
    metadata=None
)
