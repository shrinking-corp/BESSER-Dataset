...
def test_notation_routingstyle_has_roundedBendpointsRadius():
    assert hasattr(notation_RoutingStyle, "roundedBendpointsRadius")
    descriptor = None
    for klass in notation_RoutingStyle.__mro__:
...
@given(instance=notation_RoutingStyle_strategy)
def test_notation_routingstyle_roundedBendpointsRadius_setter(instance):
