...
public class Class_Diagram_for_Propsed_System_Employee  {
    ...
    public Class_Diagram_for_Propsed_System_Employee(
        String id,        int shift,        int mobile,        int empid,        int leavegroup,        int depid,        int user_id,        int post,        int usergroup    ) {
        this.id = id;
        this.shift = shift;
        this.mobile = mobile;
        this.empid = empid;
    ...
    public Class_Diagram_for_Propsed_System_Employee(
        String id,        int shift,        int mobile,        int empid,        int leavegroup,        int depid,        int user_id,        int post,        int usergroup        ArrayList<Class_Diagram_for_Propsed_System_Attendance> class_diagram_for_propsed_system_attendances,        ArrayList<Class_Diagram_for_Propsed_System_Deductions> class_diagram_for_propsed_system_deductionss    ) {
        this.id = id;
        this.shift = shift;
        this.mobile = mobile;
        this.empid = empid;
