...
class Class_Diagram_for_Propsed_System_ETF:
    ...
    def __init__(self, id: int, precentage: str, effectivedate: date):
        self.id = id
...
class Class_Diagram_for_Propsed_System_Messages:
    ...
    def __init__(self, id: int, reciever: int, sender: int, message: str, read_recipt: str, Employee_Messages_189: "Class_Diagram_for_Propsed_System_Employee" = None):
        self.id = id
...
class Class_Diagram_for_Propsed_System_Advances:
    ...
    def __init__(self, id: int, empid: int, amount: str, installments: int, remain: int, Employee_Advances_1103: "Class_Diagram_for_Propsed_System_Employee" = None):
        self.id = id
        self.empid = empid
        self.amount = amount
...
class Class_Diagram_for_Propsed_System_Users:
    ...
    def __init__(self, id: int, firstname: str, lastname: str, email: str, password: str, Users_Employee_074: "Class_Diagram_for_Propsed_System_Employee" = None):
        self.id = id
...
class Class_Diagram_for_Propsed_System_User_groups:
    ...
    def __init__(self, id: int, user_group: str, Employee_User_groups_199: set["Class_Diagram_for_Propsed_System_Employee"] = None, User_groups_User_Permissions_0100: "Class_Diagram_for_Propsed_System_User_Permissions" = None):
        self.id = id
    ...
    @user_group.setter
    def user_group(self, user_group: str):
...
class Class_Diagram_for_Propsed_System_Leave_Taken:
    ...
    def __init__(self, id: int, empid: int, leavetype: int, start_date: str, enddate: str, status: int, Employee_Leave_Taken_183: "Class_Diagram_for_Propsed_System_Employee" = None):
        self.id = id
        self.empid = empid
...
class Class_Diagram_for_Propsed_System_Event:
    ...
    def __init__(self, date: str, id: int, eventname: str, type: int):
        self.date = date
        self.id = id
...
class Class_Diagram_for_Propsed_System_EPF:
    ...
    def __init__(self, id: int, precentage: int, effectve_date: str):
        self.id = id
        self.precentage = precentage
    ...
    def effectve_date(self, effectve_date: str):
...
class Class_Diagram_for_Propsed_System_EmployeeSalary:
    ...
    def __init__(self, id: str, emp_id: str, basic_salary: str, allowances: bool, deductions: bool, Employee_EmployeeSalary_185: "Class_Diagram_for_Propsed_System_Employee" = None):
        self.id = id
        self.emp_id = emp_id
    ...
    @allowances.setter
    def allowances(self, allowances: bool):
    ...
    @deductions.setter
    def deductions(self, deductions: bool):
...
class Class_Diagram_for_Propsed_System_EmployeeParoll:
    ...
    def __init__(self, id: int, empid: int, basicslaray: str, lateamount: str, otamount: str, dotamount: str, epf: str, etf: str, Employee_EmployeeParoll_197: set["Class_Diagram_for_Propsed_System_Employee"] = None):
        self.id = id
        self.empid = empid
        self.basicslaray = basicslaray
        self.lateamount = lateamount
    ...
    @basicslaray.setter
    def basicslaray(self, basicslaray: str):
        self.__basicslaray = basicslaray

    @property
    def lateamount(self):
        return self.__lateamount
    @lateamount.setter
    def lateamount(self, lateamount: str):
        self.__lateamount = lateamount
    ...
    @property
    def dotamount(self):
        return self.__dotamount
    @dotamount.setter
    def dotamount(self, dotamount: str):
        self.__dotamount = dotamount
    ...
    @otamount.setter
    def otamount(self, otamount: str):
...
class Class_Diagram_for_Propsed_System_Employee:
    ...
    def __init__(self, id: str, empid: int, depid: int, post: int, shift: int, usergroup: int, leavegroup: int, mobile: int, user_id: int, Employee_Shifts_080: "Class_Diagram_for_Propsed_System_Shifts" = None, Employee_Leave_Taken_082: set["Class_Diagram_for_Propsed_System_Leave_Taken"] = None, Employee_EmployeeSalary_084: set["Class_Diagram_for_Propsed_System_EmployeeSalary"] = None, Allowance_Employee_187: "Class_Diagram_for_Propsed_System_Allowance" = None, Employee_Messages_088: set["Class_Diagram_for_Propsed_System_Messages"] = None, Employee_LeaveProfiles_090: "Class_Diagram_for_Propsed_System_LeaveProfiles" = None, Users_Employee_175: "Class_Diagram_for_Propsed_System_Users" = None, Attendance_Employee_177: set["Class_Diagram_for_Propsed_System_Attendance"] = None, Employee_OT_Requests_078: set["Class_Diagram_for_Propsed_System_OT_Requests"] = None, Employee_Posts_092: "Class_Diagram_for_Propsed_System_Posts" = None, Departments_Employee_195: "Class_Diagram_for_Propsed_System_Departments" = None, Employee_EmployeeParoll_096: set["Class_Diagram_for_Propsed_System_EmployeeParoll"] = None, Employee_User_groups_098: "Class_Diagram_for_Propsed_System_User_groups" = None, Employee_Advances_0102: set["Class_Diagram_for_Propsed_System_Advances"] = None, Employee_Deductions_0104: set["Class_Diagram_for_Propsed_System_Deductions"] = None):
        self.id = id
        self.empid = empid
        self.depid = depid
        self.post = post
...
class Class_Diagram_for_Propsed_System_Posts:
    ...
    def __init__(self, id: int, name: str, department_id: int, Employee_Posts_193: "Class_Diagram_for_Propsed_System_Employee" = None):
        self.id = id
        self.name = name
    ...
    def department_id(self, department_id: int):
...
class Class_Diagram_for_Propsed_System_Shifts:
    ...
    def __init__(self, id: int, shiftaname: str, starttime: str, endtime: str, Employee_Shifts_181: set["Class_Diagram_for_Propsed_System_Employee"] = None):
        self.id = id
...
class Class_Diagram_for_Propsed_System_Deductions:
    ...
    def __init__(self, amount: str, empid: int, id: int, Employee_Deductions_1105: "Class_Diagram_for_Propsed_System_Employee" = None):
        self.amount = amount
        self.empid = empid
        self.id = id
...
class Class_Diagram_for_Propsed_System_AllowanceTypes:
    ...
    def __init__(self, id: int, type: int, date_added: str):
        self.id = id
        self.type = type
