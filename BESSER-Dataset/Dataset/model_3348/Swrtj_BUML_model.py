...
# Classes
swrtj_File = Class(name="swrtj_File")
swrtj_Import = Class(name="swrtj_Import")
swrtj_Constructor = Class(name="swrtj_Constructor")
swrtj_Program = Class(name="swrtj_Program")
swrtj_Block = Class(name="swrtj_Block")
swrtj_BaseRecord = Class(name="swrtj_BaseRecord")
swrtj_RecordOperation = Class(name="swrtj_RecordOperation")
swrtj_AnonimousRecord = Class(name="swrtj_AnonimousRecord")
BaseRecord = Class(name="BaseRecord")
swrtj_Field = Class(name="swrtj_Field")
swrtj_RecordName = Class(name="swrtj_RecordName")
swrtj_NestedRecordExpression = Class(name="swrtj_NestedRecordExpression")
swrtj_Element = Class(name="swrtj_Element")
swrtj_Interface = Class(name="swrtj_Interface")
Element = Class(name="Element")
swrtj_Method = Class(name="swrtj_Method")
swrtj_Record = Class(name="swrtj_Record")
swrtj_RecordExpression = Class(name="swrtj_RecordExpression")
swrtj_Trait = Class(name="swrtj_Trait")
swrtj_TraitExpression = Class(name="swrtj_TraitExpression")
swrtj_Class = Class(name="swrtj_Class")
swrtj_MethodName = Class(name="swrtj_MethodName")
swrtj_Parameter = Class(name="swrtj_Parameter")
swrtj_ReturnStatement = Class(name="swrtj_ReturnStatement")
swrtj_GenericExpression = Class(name="swrtj_GenericExpression")
swrtj_Statement = Class(name="swrtj_Statement")
swrtj_ExpressionStatement = Class(name="swrtj_ExpressionStatement")
Statement = Class(name="Statement")
swrtj_BaseTrait = Class(name="swrtj_BaseTrait")
swrtj_TraitOperation = Class(name="swrtj_TraitOperation")
swrtj_AnonimousTrait = Class(name="swrtj_AnonimousTrait")
BaseTrait = Class(name="BaseTrait")
swrtj_TraitElement = Class(name="swrtj_TraitElement")
swrtj_TraitName = Class(name="swrtj_TraitName")
swrtj_NestedTraitExpression = Class(name="swrtj_NestedTraitExpression")
TraitElement = Class(name="TraitElement")
swrtj_Type = Class(name="swrtj_Type")
swrtj_FieldName = Class(name="swrtj_FieldName")
swrtj_CompareOperator = Class(name="swrtj_CompareOperator")
swrtj_NestedBooleanExpression = Class(name="swrtj_NestedBooleanExpression")
swrtj_DottedExpression = Class(name="swrtj_DottedExpression")
swrtj_Start = Class(name="swrtj_Start")
swrtj_Message = Class(name="swrtj_Message")
swrtj_Null = Class(name="swrtj_Null")
Start = Class(name="Start")
swrtj_Input = Class(name="swrtj_Input")
swrtj_Args = Class(name="swrtj_Args")
swrtj_Output = Class(name="swrtj_Output")
swrtj_BooleanConstant = Class(name="swrtj_BooleanConstant")
swrtj_Number = Class(name="swrtj_Number")
swrtj_IfThenElseStatement = Class(name="swrtj_IfThenElseStatement")
swrtj_WhileStatement = Class(name="swrtj_WhileStatement")
swrtj_BooleanOperator = Class(name="swrtj_BooleanOperator")
swrtj_AtomicBooleanExpression = Class(name="swrtj_AtomicBooleanExpression")
swrtj_SimpleComparation = Class(name="swrtj_SimpleComparation")
AtomicBooleanExpression = Class(name="AtomicBooleanExpression")
swrtj_FieldAccess = Class(name="swrtj_FieldAccess")
swrtj_ParameterAssignment = Class(name="swrtj_ParameterAssignment")
swrtj_RecordExclude = Class(name="swrtj_RecordExclude")
RecordOperation = Class(name="RecordOperation")
swrtj_RecordRename = Class(name="swrtj_RecordRename")
swrtj_TraitExclude = Class(name="swrtj_TraitExclude")
TraitOperation = Class(name="TraitOperation")
swrtj_TraitAlias = Class(name="swrtj_TraitAlias")
swrtj_TraitMethodRename = Class(name="swrtj_TraitMethodRename")
swrtj_StringConstant = Class(name="swrtj_StringConstant")
swrtj_This = Class(name="swrtj_This")
swrtj_ParameterReference = Class(name="swrtj_ParameterReference")
swrtj_ConstructorInvocation = Class(name="swrtj_ConstructorInvocation")
swrtj_Cast = Class(name="swrtj_Cast")
swrtj_NestedExpression = Class(name="swrtj_NestedExpression")
swrtj_MethodInvocation = Class(name="swrtj_MethodInvocation")
Message = Class(name="Message")
swrtj_FormalParameter = Class(name="swrtj_FormalParameter")
Parameter_ = Class(name="Parameter")
swrtj_BooleanExpression = Class(name="swrtj_BooleanExpression")
GenericExpression = Class(name="GenericExpression")
swrtj_LocalParameter = Class(name="swrtj_LocalParameter")
swrtj_Expression = Class(name="swrtj_Expression")
swrtj_TraitFieldRename = Class(name="swrtj_TraitFieldRename")
swrtj_FieldDeclaration = Class(name="swrtj_FieldDeclaration")
Field = Class(name="Field")
swrtj_RequiredField = Class(name="swrtj_RequiredField")
swrtj_RequiredMethod = Class(name="swrtj_RequiredMethod")
Method_ = Class(name="Method")
swrtj_ProvidedMethod = Class(name="swrtj_ProvidedMethod")
...
swrtj_Element.attributes={swrtj_Element_name, swrtj_Element_construct}
...
domain_model = DomainModel(
    name="swrtj",
    types={swrtj_File, swrtj_Import, swrtj_Constructor, swrtj_Program, swrtj_Block, swrtj_BaseRecord, swrtj_RecordOperation, swrtj_AnonimousRecord, BaseRecord, swrtj_Field, swrtj_RecordName, swrtj_NestedRecordExpression, swrtj_Element, swrtj_Interface, Element, swrtj_Method, swrtj_Record, swrtj_RecordExpression, swrtj_Trait, swrtj_TraitExpression, swrtj_Class, swrtj_MethodName, swrtj_Parameter, swrtj_ReturnStatement, swrtj_GenericExpression, swrtj_Statement, swrtj_ExpressionStatement, Statement, swrtj_BaseTrait, swrtj_TraitOperation, swrtj_AnonimousTrait, BaseTrait, swrtj_TraitElement, swrtj_TraitName, swrtj_NestedTraitExpression, TraitElement, swrtj_Type, swrtj_FieldName, swrtj_CompareOperator, swrtj_NestedBooleanExpression, swrtj_DottedExpression, swrtj_Start, swrtj_Message, swrtj_Null, Start, swrtj_Input, swrtj_Args, swrtj_Output, swrtj_BooleanConstant, swrtj_Number, swrtj_IfThenElseStatement, swrtj_WhileStatement, swrtj_BooleanOperator, swrtj_AtomicBooleanExpression, swrtj_SimpleComparation, AtomicBooleanExpression, swrtj_FieldAccess, swrtj_ParameterAssignment, swrtj_RecordExclude, RecordOperation, swrtj_RecordRename, swrtj_TraitExclude, TraitOperation, swrtj_TraitAlias, swrtj_TraitMethodRename, swrtj_StringConstant, swrtj_This, swrtj_ParameterReference, swrtj_ConstructorInvocation, swrtj_Cast, swrtj_NestedExpression, swrtj_MethodInvocation, Message, swrtj_FormalParameter, Parameter_, swrtj_BooleanExpression, GenericExpression, swrtj_LocalParameter, swrtj_Expression, swrtj_TraitFieldRename, swrtj_FieldDeclaration, Field, swrtj_RequiredField, swrtj_RequiredMethod, Method_, swrtj_ProvidedMethod},
    associations={importList0, implementsList9, recordExpression11, traitExpression14, constructorList17, block19, recordList20, operationList22, declarationList24, record25, expression27, elementList1, extendsList4, requiredMethodList5, expression7, expression8, methodRef45, parameterList47, parameterList49, block52, expression55, type56, interfaceType59, parameterList62, statementList65, traitList29, operationList31, definitionList33, trait34, expression36, type38, fieldRef40, returnType42, compare84, rightExpression86, nestedExpression89, start91, receiver93, message95, value97, expression67, condiction69, trueBranch71, falseBranch74, condiction77, whileBlock79, leftExpression82, method114, argumentList116, field119, parameter121, value123, field126, originalField128, newField130, method133, originalMethod135, newMethod137, parameter100, classRef102, argumentList104, type107, start109, expression112, returnStatement152, atomicList155, booleanOperatorList156, value158, termList160, originalMethod140, newMethod142, originalField145, newField147, block150},
    generalizations={gen_swrtj_Class_Element, gen_swrtj_Program_Element, gen_swrtj_AnonimousRecord_BaseRecord, gen_swrtj_RecordName_BaseRecord, gen_swrtj_NestedRecordExpression_BaseRecord, gen_swrtj_Interface_Element, gen_swrtj_Record_Element, gen_swrtj_Trait_Element, gen_swrtj_ExpressionStatement_Statement, gen_swrtj_AnonimousTrait_BaseTrait, gen_swrtj_TraitName_BaseTrait, gen_swrtj_NestedTraitExpression_BaseTrait, gen_swrtj_Field_TraitElement, gen_swrtj_Method_TraitElement, gen_swrtj_NestedBooleanExpression_AtomicBooleanExpression, gen_swrtj_Null_Start, gen_swrtj_Input_Start, gen_swrtj_Args_Start, gen_swrtj_Output_Start, gen_swrtj_BooleanConstant_Start, gen_swrtj_Number_Start, gen_swrtj_IfThenElseStatement_Statement, gen_swrtj_WhileStatement_Statement, gen_swrtj_SimpleComparation_AtomicBooleanExpression, gen_swrtj_FieldAccess_Message, gen_swrtj_ParameterAssignment_Start, gen_swrtj_RecordExclude_RecordOperation, gen_swrtj_RecordRename_RecordOperation, gen_swrtj_TraitExclude_TraitOperation, gen_swrtj_TraitAlias_TraitOperation, gen_swrtj_TraitMethodRename_TraitOperation, gen_swrtj_StringConstant_Start, gen_swrtj_This_Start, gen_swrtj_ParameterReference_Start, gen_swrtj_ConstructorInvocation_Start, gen_swrtj_Cast_Start, gen_swrtj_NestedExpression_Start, gen_swrtj_MethodInvocation_Message, gen_swrtj_FormalParameter_Parameter, gen_swrtj_BooleanExpression_GenericExpression, gen_swrtj_LocalParameter_Parameter, gen_swrtj_Expression_GenericExpression, gen_swrtj_TraitFieldRename_TraitOperation, gen_swrtj_FieldDeclaration_Field, gen_swrtj_RequiredField_Field, gen_swrtj_RequiredMethod_Method, gen_swrtj_ProvidedMethod_Method},
    metadata=None
)
