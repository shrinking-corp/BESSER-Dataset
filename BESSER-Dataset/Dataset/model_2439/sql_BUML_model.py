...
domain_model = DomainModel(
    name="Sql",
    types={Sql_NamedElement, Sql_Database, NamedElement, Sql_Table, Sql_Column},
    associations={column1, table0},
    generalizations={gen_Sql_Database_NamedElement, gen_Sql_Column_NamedElement, gen_Sql_Table_NamedElement},
    metadata=None
)
