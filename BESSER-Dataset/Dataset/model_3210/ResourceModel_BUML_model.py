...
# Classes
rm_ResourceModel = Class(name="rm_ResourceModel")
rm_Device = Class(name="rm_Device")
rm_Memory = Class(name="rm_Memory")
rm_MemoryCellReference = Class(name="rm_MemoryCellReference")
rm_VariableReference = Class(name="rm_VariableReference")
...
rm_MemoryCellReference.attributes={rm_MemoryCellReference_startCellIndex, rm_MemoryCellReference_endCellIndex}
