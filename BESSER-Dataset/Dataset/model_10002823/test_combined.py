...
def test_hyp_toit_is_not_abstract():
    assert not inspect.isabstract(Toit)


def test_hyp_toit_constructor_exists():
    assert callable(Toit.__init__)


def test_hyp_toit_constructor_args():
...
def test_hyp_interieur_is_not_abstract():
    assert not inspect.isabstract(Interieur)


def test_hyp_interieur_constructor_exists():
    assert callable(Interieur.__init__)


def test_hyp_interieur_constructor_args():
...
def test_hyp_joueur_has_positionBandit():
...
def test_hyp_joueur_has_attribute():
...
def test_hyp_wagon_has_ListedesButin__():
...
def test_hyp_wagon_has_listeDesBandit():
...
def test_hyp_modeltraint_has_nombreWagon():
...
def test_hyp_modeltraint_has_nombreJoueur():
...
def test_hyp_toit_IntNumereoWagon_setter(instance):
...
def test_hyp_interieur_InnumeroWagon_setter(instance):
...
def test_hyp_position_numeroWagon_setter(instance):
...
@given(instance=Joueur_strategy)
def test_hyp_joueur_positionBandit_setter(instance):
...
@given(instance=Joueur_strategy)
def test_hyp_joueur_attribute_setter(instance):
...
@given(instance=Wagon_strategy)
def test_hyp_wagon_ListedesButin___setter(instance):
...
@given(instance=Wagon_strategy)
def test_hyp_wagon_listeDesBandit_setter(instance):
...
@given(instance=ModelTraint_strategy)
def test_hyp_modeltraint_nombreWagon_setter(instance):
...
@given(instance=ModelTraint_strategy)
def test_hyp_modeltraint_nombreJoueur_setter(instance):
