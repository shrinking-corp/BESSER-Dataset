...
class introduction_Y:
    ...
    def __init__(self, id: str, test: int, introduction_Y7: "introduction_con" = None, introduction_Y: "introduction_A" = None):
        self.id = id
        self.test = test
...
class introduction_A:
    ...
    def __init__(self, id: str, introduction_A4: "introduction_con" = None, introduction_A2: set["introduction_Y"] = None, introduction_A: "introduction_X" = None):
        self.id = id
