...
# Classes
mydsl_A = Class(name="mydsl_A")
W = Class(name="W")
mydsl_B = Class(name="mydsl_B")
mydsl_C = Class(name="mydsl_C")
mydsl_L = Class(name="mydsl_L")
mydsl_D = Class(name="mydsl_D")
mydsl_W = Class(name="mydsl_W")
