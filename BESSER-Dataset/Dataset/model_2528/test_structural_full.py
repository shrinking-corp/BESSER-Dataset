...
def test_target_G_isa_F():
    instance = target_G()
    assert isinstance(instance, F)


def test_target_H_isa_F():
    instance = target_H()
    assert isinstance(instance, F)
...
target_E_strategy = st.builds(target_E)
...
target_F_strategy = st.builds(target_F)
...
target_G_strategy = st.builds(target_G)
...
target_H_strategy = st.builds(target_H)
