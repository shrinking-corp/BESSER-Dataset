...
class profile_NullValueSetConstraint:
    ...
    def __init__(self, identifier: str, name: str, version: str, binding: str, profile_NullValueSetConstraint: "profile_ValueSetVersion" = None, profile_NullValueSetConstraint58: "profile_Property" = None):
...
class profile_ValueSetContextBinding:
    ...
    def __init__(self, effectiveDate: str, profile_ValueSetContextBinding: "profile_ConceptDomain" = None, profile_ValueSetContextBinding41: "profile_ValueSetVersion" = None, profile_ValueSetContextBinding44: "profile_UsageContext" = None, profile_ValueSetContextBinding46: "profile_Class" = None):
...
class profile_CodeSystemVersion:
    ...
    def __init__(self, version: str, fullName: str, source: str, url: str, effectiveDate: str, releaseDate: str, status: str, statusDate: str, identifier: str, profile_CodeSystemVersion23: "profile_Enumeration" = None, profile_CodeSystemVersion: "profile_CodeSystemConstraint" = None, profile_CodeSystemVersion35: "profile_ValueSetCode" = None, profile_CodeSystemVersion30: "profile_ValueSetVersion" = None):
        self.version = version
    ...
    def setEnumerationName(self, profile_name):
        # TODO: Implement setEnumerationName method
        pass

    def getEnumerationQualifiedName(self) :
...
class profile_ValueSetVersion:
    ...
    def __init__(self, identifier: str, version: str, fullName: str, source: str, url: str, definition: str, effectiveDate: str, expirationDate: str, releaseDate: str, revisionDate: str, status: str, statusDate: str, type: str, binding: str, profile_ValueSetVersion: "profile_ValueSetConstraint" = None, profile_ValueSetVersion32: "profile_Enumeration" = None, profile_ValueSetVersion29: "profile_CodeSystemVersion" = None, profile_ValueSetVersion56: "profile_NullValueSetConstraint" = None, profile_ValueSetVersion42: "profile_ValueSetContextBinding" = None):
        self.identifier = identifier
        self.version = version
        self.fullName = fullName
        self.source = source
...
class profile_UsageContext:
    ...
    def __init__(self, identifier: str, status: str, statusDate: str, profile_UsageContext: "profile_ValueSetContextBinding" = None, profile_UsageContext49: "profile_Class" = None):
        self.identifier = identifier
        self.status = status
        self.statusDate = statusDate
