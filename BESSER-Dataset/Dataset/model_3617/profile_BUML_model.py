...
# Classes
profile_ConceptDomainConstraint = Class(name="profile_ConceptDomainConstraint")
profile_ConceptDomain = Class(name="profile_ConceptDomain")
profile_Property = Class(name="profile_Property")
profile_CD = Class(name="profile_CD")
profile_CR = Class(name="profile_CR")
profile_Enumeration = Class(name="profile_Enumeration")
profile_ValueSetConstraint = Class(name="profile_ValueSetConstraint")
profile_ValueSetVersion = Class(name="profile_ValueSetVersion")
profile_Class = Class(name="profile_Class")
profile_CodeSystemConstraint = Class(name="profile_CodeSystemConstraint")
profile_CodeSystemVersion = Class(name="profile_CodeSystemVersion")
profile_ValueSetCode = Class(name="profile_ValueSetCode")
profile_EnumerationLiteral = Class(name="profile_EnumerationLiteral")
profile_ValueSetContextBinding = Class(name="profile_ValueSetContextBinding")
profile_ContextToValueSet = Class(name="profile_ContextToValueSet")
profile_NullValueSetConstraint = Class(name="profile_NullValueSetConstraint")
profile_Context = Class(name="profile_Context")
profile_UsageContext = Class(name="profile_UsageContext")
profile_ValueSetConstraints = Class(name="profile_ValueSetConstraints")
profile_CodedType = Class(name="profile_CodedType")
profile_Classifier = Class(name="profile_Classifier")
...
profile_ConceptDomainConstraint.attributes={profile_ConceptDomainConstraint_identifier, profile_ConceptDomainConstraint_name}
...
profile_ConceptDomain.attributes={profile_ConceptDomain_statusDate, profile_ConceptDomain_identifier, profile_ConceptDomain_fullName, profile_ConceptDomain_status}
...
profile_CD.attributes={profile_CD_code, profile_CD_codeSystemVersion, profile_CD_codeSystemName, profile_CD_displayName, profile_CD_codeSystem}
...
profile_ValueSetConstraint.attributes={profile_ValueSetConstraint_guidance, profile_ValueSetConstraint_identifier, profile_ValueSetConstraint_extensibility, profile_ValueSetConstraint_name, profile_ValueSetConstraint_version, profile_ValueSetConstraint_uri, profile_ValueSetConstraint_binding}
...
profile_ValueSetVersion_m_setEnumerationName: Method = Method(name="setEnumerationName", parameters={Parameter(name='profile_name', type=StringType)})
...
profile_ValueSetVersion.attributes={profile_ValueSetVersion_source, profile_ValueSetVersion_version, profile_ValueSetVersion_type, profile_ValueSetVersion_binding, profile_ValueSetVersion_revisionDate, profile_ValueSetVersion_status, profile_ValueSetVersion_releaseDate, profile_ValueSetVersion_expirationDate, profile_ValueSetVersion_effectiveDate, profile_ValueSetVersion_definition, profile_ValueSetVersion_statusDate, profile_ValueSetVersion_url, profile_ValueSetVersion_identifier, profile_ValueSetVersion_fullName}
profile_ValueSetVersion.methods={profile_ValueSetVersion_m_getEnumerationName, profile_ValueSetVersion_m_setEnumerationName, profile_ValueSetVersion_m_getEnumerationQualifiedName}
...
profile_CodeSystemConstraint.attributes={profile_CodeSystemConstraint_displayName, profile_CodeSystemConstraint_name, profile_CodeSystemConstraint_identifier, profile_CodeSystemConstraint_code, profile_CodeSystemConstraint_version, profile_CodeSystemConstraint_binding}
...
profile_CodeSystemVersion_m_setEnumerationName: Method = Method(name="setEnumerationName", parameters={Parameter(name='profile_name', type=StringType)})
...
profile_CodeSystemVersion.attributes={profile_CodeSystemVersion_status, profile_CodeSystemVersion_source, profile_CodeSystemVersion_url, profile_CodeSystemVersion_effectiveDate, profile_CodeSystemVersion_statusDate, profile_CodeSystemVersion_fullName, profile_CodeSystemVersion_version, profile_CodeSystemVersion_identifier, profile_CodeSystemVersion_releaseDate}
profile_CodeSystemVersion.methods={profile_CodeSystemVersion_m_getEnumerationQualifiedName, profile_CodeSystemVersion_m_getEnumerationName, profile_CodeSystemVersion_m_setEnumerationName}
...
profile_ValueSetCode.attributes={profile_ValueSetCode_conceptName, profile_ValueSetCode_usageNote}
...
profile_NullValueSetConstraint.attributes={profile_NullValueSetConstraint_binding, profile_NullValueSetConstraint_identifier, profile_NullValueSetConstraint_version, profile_NullValueSetConstraint_name}
...
profile_UsageContext.attributes={profile_UsageContext_status, profile_UsageContext_statusDate, profile_UsageContext_identifier}
...
domain_model = DomainModel(
    name="profile",
    types={profile_ConceptDomainConstraint, profile_ConceptDomain, profile_Property, profile_CD, profile_CR, profile_Enumeration, profile_ValueSetConstraint, profile_ValueSetVersion, profile_Class, profile_CodeSystemConstraint, profile_CodeSystemVersion, profile_ValueSetCode, profile_EnumerationLiteral, profile_ValueSetContextBinding, profile_ContextToValueSet, profile_NullValueSetConstraint, profile_Context, profile_UsageContext, profile_ValueSetConstraints, profile_CodedType, profile_Classifier, BindingKind, ValueSetType, StatusKind, Extensibility, Guidance, ValueSetBinding},
    associations={reference10, base_Property11, qualifier0, translation2, name4, value7, base_Enumeration22, reference24, base_Property25, base_Class13, reference15, qualifier16, base_Property19, base_Enumeration31, codeSystem34, base_EnumerationLiteral36, conceptDomain38, base_Property51, constraints53, codeSystem28, reference55, base_Property57, valueSet40, usageContext43, base_Class45, base_Class48, base_Enumeration60, base_Classifier62},
    generalizations={},
    metadata=None
)
