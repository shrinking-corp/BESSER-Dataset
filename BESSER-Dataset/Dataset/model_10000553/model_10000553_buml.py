...
Booking.attributes={Booking_booking_id, Booking_email_id, Booking_startTime, Booking_customer_name, Booking_reservedTables, Booking_contact_no, Booking_endTime, Booking_date}
...
Food.attributes={Food_served, Food_food_id, Food_prepared, Food_price, Food_name}
...
domain_model = DomainModel(
    name="_438fc9b6_e437_4de9_b7d6_607427e3c0a0",
    types={ReservationManagementSystem, Booking, Table, Report, Order, Food, Staff, Waiter, Chef, StaffUI, CustomerUI},
    associations={Staff_StaffUI, Staff_ReservationManagementSystem, CustomerUI_ReservationManagementSystem, ReservationManagementSystem_Booking, Table_Booking, Order_Food, ReservationManagementSystem_Report, Table_Order},
    generalizations={},
    metadata=None
)
