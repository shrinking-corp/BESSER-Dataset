...
class form_Page:
    ...
    def __init__(self, title: str, Page: "form_Page" = None, previousPage: "form_Page" = None, form_Page: "form_Form" = None, form_Page3: "form_Form" = None, form_Page6: "form_Page" = None, form_Page4: set["form_Page"] = None, form_Page9: "form_Page" = None, form_Page7: set["form_Page"] = None, page: set["form_PageElement"] = None, Page15: "form_Page" = None, nextPage: "form_Page" = None, Page24: "form_VisibilityCondition" = None, page17: set["form_VisibilityCondition"] = None, Page19: "form_PageElement" = None):
        self.title = title
        self.Page = Page
...
class form_PageElement(ABC):
    ...
    def __init__(self, elementId: str, PageElement: "form_Page" = None, form_PageElement: "form_VisibilityCondition" = None, elements: "form_Page" = None):
