...
# Classes
form_PageElement = Class(name="form_PageElement", is_abstract=True)
form_Form = Class(name="form_Form")
form_Page = Class(name="form_Page")
form_Heading = Class(name="form_Heading")
Text = Class(name="Text")
form_Paragraph = Class(name="form_Paragraph")
form_List = Class(name="form_List")
form_VisibilityCondition = Class(name="form_VisibilityCondition", is_abstract=True)
form_InputField = Class(name="form_InputField", is_abstract=True)
PageElement = Class(name="PageElement")
form_TextField = Class(name="form_TextField")
InputField = Class(name="InputField")
form_SelectionField = Class(name="form_SelectionField")
form_SelectionItem = Class(name="form_SelectionItem")
form_TextArea = Class(name="form_TextArea")
form_Text = Class(name="form_Text", is_abstract=True)
form_ListItem = Class(name="form_ListItem")
form_SelectionCondition = Class(name="form_SelectionCondition")
...
form_SelectionItem.attributes={form_SelectionItem_label, form_SelectionItem_selected}
...
domain_model = DomainModel(
    name="form",
    types={form_PageElement, form_Form, form_Page, form_Heading, Text, form_Paragraph, form_List, form_VisibilityCondition, form_InputField, PageElement, form_TextField, InputField, form_SelectionField, form_SelectionItem, form_TextArea, form_Text, form_ListItem, form_SelectionCondition, VisibilityCondition, SelectionFieldType},
    associations={nextPage11, pages0, welcomePage1, allPreviousPages5, allNextPages8, elements12, previousPage14, visibilityConditions16, page18, items20, field21, items22, page23, concernsElements25, item26},
    generalizations={gen_form_Heading_Text, gen_form_Paragraph_Text, gen_form_List_PageElement, gen_form_InputField_PageElement, gen_form_TextField_InputField, gen_form_SelectionField_InputField, gen_form_TextArea_InputField, gen_form_Text_PageElement, gen_form_SelectionCondition_VisibilityCondition},
    metadata=None
)
