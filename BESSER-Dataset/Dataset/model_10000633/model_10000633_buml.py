...
Property_.attributes={Property__location, Property__property_id, Property__address, Property__property_type}
...
Requirement.attributes={Requirement_requirement_location, Requirement_user_id, Requirement_requirement_type, Requirement_req_description}
...
domain_model = DomainModel(
    name="_4de75bca_da8d_4ead_af42_371956062abf",
    types={Property_, User, Reg_User, Unreg_User, Advertiser, Buyer, Seller, Administrator, Payment, Requirement, Request, Management, Advertiesment, Interface_Interface},
