...
class account_AccountType(Enum):
    pass
class transactions_TransactionType(Enum):
    pass
...
class transactions_TransferTransaction:
...
class transactions_WithdrawTransaction:

    pass


class transactions_DepositTransaction:

    pass


class transactions_Transaction:

    def __init__(self, id: int, type: transactions_TransactionType, transactionTime: date, amount: float, account3: "account_Account" = None):
        self.id = id
        self.type = type
    ...
    def type(self):
        return self.__type
    @type.setter
    def type(self, type: transactions_TransactionType):
        self.__type = type
    ...
    def account3(self, value):
        ...
        old_value = getattr(self, f"_transactions_Transaction__account3", None)
...
class account_Account:
    ...
    def __init__(self, accountNo: str, type: account_AccountType, balance: float, customer0: "mypackage_Customer" = None, transactions2: set["transactions_Transaction"] = None):
