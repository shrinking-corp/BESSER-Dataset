...
public class mypackage_Customer  {
    ...
    public mypackage_Customer(
        String name,        LocalDate dateOfBirth,        String emailAddress,        String phoneNumber,        String address    ) {
        this.name = name;
    ...
    public mypackage_Customer(
        String name,        LocalDate dateOfBirth,        String emailAddress,        String phoneNumber,        String address        ArrayList<account_Account> account_accounts    ) {
        this.name = name;
        this.dateOfBirth = dateOfBirth;
        this.emailAddress = emailAddress;
        this.phoneNumber = phoneNumber;
