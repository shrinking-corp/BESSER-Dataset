...
class MavenMaven_Delete(FileTask):
    ...
    def __init__(self, dir: str, verbose: str, quiet: str, failonerror: str, includeEmptyDirs: str, includes: str, includesfile: str, excludes: str, excludesfile: str, defaultexcludes: str, file: str):
        self.dir = dir
...
class MavenMaven_Path(Set):
    ...
    def __init__(self, id: str, refid: str, MavenMaven_Path: "Path" = None, MavenMaven_Path36: set["PathElement"] = None, MavenMaven_Path38: set["FileSet"] = None):
        self.id = id
        self.refid = refid
