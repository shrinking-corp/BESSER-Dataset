...
public class MavenMaven_Javac extends CompileTask {
    ...
    public MavenMaven_Javac(
        String debug,        String destdir,        String deprecation,        String optimize,        String srcdir,        String fork    ) {
        super(
        );
        this.debug = debug;
    ...
    public MavenMaven_Javac(
        String debug,        String destdir,        String deprecation,        String optimize,        String srcdir,        String fork        ArrayList<InExcludes> inexcludess    ) {
        this.debug = debug;
        this.destdir = destdir;
        this.deprecation = deprecation;
        this.optimize = optimize;
