...
MavenMaven_Mapper.attributes={MavenMaven_Mapper_to, MavenMaven_Mapper_classpath, MavenMaven_Mapper_type, MavenMaven_Mapper_classname, MavenMaven_Mapper_classpathref, MavenMaven_Mapper_from_}
...
MavenMaven_PreDefinedTask.attributes={MavenMaven_PreDefinedTask_id, MavenMaven_PreDefinedTask_taskname, MavenMaven_PreDefinedTask_description}
...
MavenMaven_Java.attributes={MavenMaven_Java_classname, MavenMaven_Java_fork, MavenMaven_Java_jar}
...
MavenMaven_Echo.attributes={MavenMaven_Echo_append, MavenMaven_Echo_message, MavenMaven_Echo_file}
...
MavenMaven_FormatTstamp.attributes={MavenMaven_FormatTstamp_offset, MavenMaven_FormatTstamp_unit, MavenMaven_FormatTstamp_property, MavenMaven_FormatTstamp_pattern, MavenMaven_FormatTstamp_locale}
...
MavenMaven_Javac.attributes={MavenMaven_Javac_deprecation, MavenMaven_Javac_optimize, MavenMaven_Javac_srcdir, MavenMaven_Javac_fork, MavenMaven_Javac_destdir, MavenMaven_Javac_debug}
...
MavenMaven_Javadoc.attributes={MavenMaven_Javadoc_packagenames, MavenMaven_Javadoc_version, MavenMaven_Javadoc_use, MavenMaven_Javadoc_destdir, MavenMaven_Javadoc_sourcepath, MavenMaven_Javadoc_windowtitle, MavenMaven_Javadoc_defaultexcludes, MavenMaven_Javadoc_author}
...
MavenMaven_Jar.attributes={MavenMaven_Jar_jarfile, MavenMaven_Jar_manifest, MavenMaven_Jar_encoding, MavenMaven_Jar_compress, MavenMaven_Jar_basedir}
...
MavenMaven_Copy.attributes={MavenMaven_Copy_overwrite, MavenMaven_Copy_flatten, MavenMaven_Copy_includeEmptyDirs, MavenMaven_Copy_tofile, MavenMaven_Copy_filtering, MavenMaven_Copy_presservelastmodified, MavenMaven_Copy_file, MavenMaven_Copy_todir}
...
MavenMaven_Delete.attributes={MavenMaven_Delete_failonerror, MavenMaven_Delete_excludes, MavenMaven_Delete_dir, MavenMaven_Delete_defaultexcludes, MavenMaven_Delete_includesfile, MavenMaven_Delete_quiet, MavenMaven_Delete_includes, MavenMaven_Delete_file, MavenMaven_Delete_includeEmptyDirs, MavenMaven_Delete_verbose, MavenMaven_Delete_excludesfile}
...
contentsGoal14: BinaryAssociation = BinaryAssociation(
    name="contentsGoal14",
    ends={
        Property(name="ContentsGoal", type=MavenMaven_AbstractGoal, multiplicity=Multiplicity(1, 1)),
...
attainGoal15: BinaryAssociation = BinaryAssociation(
    name="attainGoal15",
    ends={
        Property(name="Goal16", type=MavenMaven_AttainGoal, multiplicity=Multiplicity(1, 1)),
...
centralGoal17: BinaryAssociation = BinaryAssociation(
    name="centralGoal17",
    ends={
        Property(name="Goal18", type=MavenMaven_PreGoal, multiplicity=Multiplicity(1, 1)),
...
centralGoal19: BinaryAssociation = BinaryAssociation(
    name="centralGoal19",
    ends={
        Property(name="Goal20", type=MavenMaven_PostGoal, multiplicity=Multiplicity(1, 1)),
        Property(name="postGoal", type=Goal, multiplicity=Multiplicity(1, 1))
    }
)
preGoal21: BinaryAssociation = BinaryAssociation(
    name="preGoal21",
    ends={
...
postGoal22: BinaryAssociation = BinaryAssociation(
    name="postGoal22",
    ends={
        Property(name="PostGoal", type=MavenMaven_Goal, multiplicity=Multiplicity(1, 1)),
        Property(name="centralGoal23", type=PostGoal, multiplicity=Multiplicity(0, 1))
    }
)
inexcludes24: BinaryAssociation = BinaryAssociation(
    name="inexcludes24",
    ends={
...
patternset25: BinaryAssociation = BinaryAssociation(
    name="patternset25",
    ends={
...
include26: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="MavenMaven_FileSet27", type=Includes, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
exclude28: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="MavenMaven_FileSet29", type=Excludes, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
path33: BinaryAssociation = BinaryAssociation(
    name="path33",
    ends={
        Property(name="Path34", type=MavenMaven_Path, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_Path", type=Path, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
pathElement35: BinaryAssociation = BinaryAssociation(
    name="pathElement35",
    ends={
        Property(name="PathElement", type=MavenMaven_Path, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_Path36", type=PathElement, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
fileset37: BinaryAssociation = BinaryAssociation(
    name="fileset37",
    ends={
        Property(name="FileSet", type=MavenMaven_Path, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_Path38", type=FileSet, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
pathElement39: BinaryAssociation = BinaryAssociation(
    name="pathElement39",
    ends={
        Property(name="PathElement40", type=MavenMaven_ClassPath, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_ClassPath", type=PathElement, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
fileset41: BinaryAssociation = BinaryAssociation(
    name="fileset41",
    ends={
        Property(name="FileSet43", type=MavenMaven_ClassPath, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_ClassPath42", type=FileSet, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
taskName44: BinaryAssociation = BinaryAssociation(
    name="taskName44",
    ends={
        Property(name="AntTaskDef45", type=MavenMaven_NewTask, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_NewTask", type=AntTaskDef, multiplicity=Multiplicity(1, 1))
    }
)
attributes46: BinaryAssociation = BinaryAssociation(
    name="attributes46",
    ends={
        Property(name="Attribut", type=MavenMaven_NewTask, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_NewTask47", type=Attribut, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
filtersfile31: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="MavenMaven_FilterSet32", type=FiltersFile, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
classPath48: BinaryAssociation = BinaryAssociation(
    name="classPath48",
    ends={
...
format49: BinaryAssociation = BinaryAssociation(
    name="format49",
    ends={
...
fileset55: BinaryAssociation = BinaryAssociation(
    name="fileset55",
    ends={
        Property(name="FileSet56", type=MavenMaven_Copy, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_Copy", type=FileSet, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
inExcludes50: BinaryAssociation = BinaryAssociation(
    name="inExcludes50",
    ends={
        Property(name="InExcludes51", type=MavenMaven_Javac, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_Javac", type=InExcludes, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
classPath52: BinaryAssociation = BinaryAssociation(
    name="classPath52",
    ends={
        Property(name="ClassPath54", type=MavenMaven_Javac, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_Javac53", type=ClassPath, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
filterset57: BinaryAssociation = BinaryAssociation(
    name="filterset57",
    ends={
        Property(name="FilterSet", type=MavenMaven_Copy, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_Copy58", type=FilterSet, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
mapper59: BinaryAssociation = BinaryAssociation(
    name="mapper59",
    ends={
        Property(name="Mapper", type=MavenMaven_Copy, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_Copy60", type=Mapper, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
...
domain_model = DomainModel(
    name="MavenMaven",
    types={Path, AntProperty, AntTaskDef, PrePostGoal, MavenMaven_Xmlns, MavenMaven_AntProperty, ContentsGoal, MavenMaven_AntPropertyName, MavenMaven_AntPropertyValue, AntPropertyName, MavenMaven_AntPropertyLocation, MavenMaven_AntPropertyFile, MavenMaven_AntPropertyEnv, MavenMaven_Project, Xmlns, Goal, MavenMaven_ContentsGoal, MavenMaven_AttainGoal, MavenMaven_PrePostGoal, AbstractGoal, MavenMaven_PreGoal, MavenMaven_PostGoal, MavenMaven_Goal, PreGoal, PostGoal, MavenMaven_Pattern, MavenMaven_Basic, Pattern, MavenMaven_Mapper, Basic, MavenMaven_JellyCommand, MavenMaven_JellySet, JellyCommand, MavenMaven_AbstractGoal, MavenMaven_IncludesFile, MavenMaven_ExcludesFile, MavenMaven_FileList, MavenMaven_Filter, MavenMaven_FiltersFile, MavenMaven_PathElement, MavenMaven_Set, MavenMaven_PatternSet, Set, MavenMaven_FileSet, PatternSet, Includes, Excludes, MavenMaven_FilterSet, MavenMaven_InExcludes, MavenMaven_Includes, InExcludes, MavenMaven_Excludes, PathElement, FileSet, MavenMaven_ClassPath, MavenMaven_Task, MavenMaven_AntTaskDef, MavenMaven_NewTask, Task, Attribut, MavenMaven_Attribut, MavenMaven_PreDefinedTask, Filter, FiltersFile, MavenMaven_Path, MavenMaven_Java, ClassPath, MavenMaven_MiscellaneousTask, MavenMaven_Echo, MiscellaneousTask, MavenMaven_Tstamp, FormatTstamp, MavenMaven_FormatTstamp, MavenMaven_CompileTask, MavenMaven_Javac, CompileTask, MavenMaven_ExecutionTask, PreDefinedTask, MavenMaven_Exec, ExecutionTask, MavenMaven_Javadoc, DocumentationTask, MavenMaven_ArchiveTask, MavenMaven_Jar, ArchiveTask, MavenMaven_FileTask, MavenMaven_Mkdir, FileTask, MavenMaven_Copy, MavenMaven_DocumentationTask, FilterSet, Mapper, MavenMaven_Delete},
    associations={path3, properties5, taskdefs7, prePostGoals9, goals11, xmlns0, default1, contentsGoal14, attainGoal15, centralGoal17, centralGoal19, preGoal21, postGoal22, inexcludes24, patternset25, include26, exclude28, path33, pathElement35, fileset37, pathElement39, fileset41, taskName44, attributes46, filter30, filtersfile31, classPath48, format49, fileset55, inExcludes50, classPath52, filterset57, mapper59},
    generalizations={gen_MavenMaven_AntProperty_ContentsGoal, gen_MavenMaven_AntPropertyName_AntProperty, gen_MavenMaven_AntPropertyValue_AntPropertyName, gen_MavenMaven_AntPropertyLocation_AntPropertyName, gen_MavenMaven_AntPropertyFile_AntProperty, gen_MavenMaven_AntPropertyEnv_AntProperty, gen_MavenMaven_AttainGoal_ContentsGoal, gen_MavenMaven_PrePostGoal_AbstractGoal, gen_MavenMaven_PreGoal_PrePostGoal, gen_MavenMaven_PostGoal_PrePostGoal, gen_MavenMaven_Goal_AbstractGoal, gen_MavenMaven_Basic_Pattern, gen_MavenMaven_Mapper_Basic, gen_MavenMaven_JellyCommand_ContentsGoal, gen_MavenMaven_JellySet_JellyCommand, gen_MavenMaven_IncludesFile_InExcludes, gen_MavenMaven_ExcludesFile_InExcludes, gen_MavenMaven_FileList_Basic, gen_MavenMaven_Filter_Basic, gen_MavenMaven_FiltersFile_Basic, gen_MavenMaven_PathElement_Basic, gen_MavenMaven_Set_Pattern, gen_MavenMaven_PatternSet_Set, gen_MavenMaven_FileSet_Set, gen_MavenMaven_FilterSet_Set, gen_MavenMaven_InExcludes_Basic, gen_MavenMaven_Includes_InExcludes, gen_MavenMaven_Excludes_InExcludes, gen_MavenMaven_Path_Set, gen_MavenMaven_ClassPath_Set, gen_MavenMaven_Task_ContentsGoal, gen_MavenMaven_AntTaskDef_ContentsGoal, gen_MavenMaven_NewTask_Task, gen_MavenMaven_PreDefinedTask_Task, gen_MavenMaven_Java_ExecutionTask, gen_MavenMaven_MiscellaneousTask_PreDefinedTask, gen_MavenMaven_Echo_MiscellaneousTask, gen_MavenMaven_Tstamp_MiscellaneousTask, gen_MavenMaven_CompileTask_PreDefinedTask, gen_MavenMaven_Javac_CompileTask, gen_MavenMaven_ExecutionTask_PreDefinedTask, gen_MavenMaven_Exec_ExecutionTask, gen_MavenMaven_Javadoc_DocumentationTask, gen_MavenMaven_ArchiveTask_PreDefinedTask, gen_MavenMaven_Jar_ArchiveTask, gen_MavenMaven_FileTask_PreDefinedTask, gen_MavenMaven_Mkdir_FileTask, gen_MavenMaven_Copy_FileTask, gen_MavenMaven_DocumentationTask_PreDefinedTask, gen_MavenMaven_Delete_FileTask},
    metadata=None
)
