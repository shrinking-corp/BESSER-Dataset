...
# Classes
smalluml_SchemaUML = Class(name="smalluml_SchemaUML")
smalluml_Generalisation = Class(name="smalluml_Generalisation")
smalluml_SmallClass = Class(name="smalluml_SmallClass")
...
smalluml_Methode.attributes={smalluml_Methode_returnType, smalluml_Methode_name}
...
domain_model = DomainModel(
    ...
    associations={gene0, c1, ass3, listeAttribute5, listeMethode7, source9, cible12, source15, listeAttribute21, listeRole24, classDedie26, cible18},
    generalizations={},
    metadata=None
)
