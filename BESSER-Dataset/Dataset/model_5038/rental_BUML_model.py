...
rental_RentalAgency_m_book: Method = Method(name="book", parameters={Parameter(name='rental_customer', type=StringType), Parameter(name='rental_to', type=StringType), Parameter(name='rental_from_', type=StringType), Parameter(name='rental_rentedObject', type=StringType)}, type=StringType)
rental_RentalAgency_m_isAvailable: Method = Method(name="isAvailable", parameters={Parameter(name='rental_to', type=StringType), Parameter(name='rental_from_', type=StringType), Parameter(name='rental_rentedObject', type=StringType)}, type=BooleanType)
...
rental_Address.attributes={rental_Address_city, rental_Address_number, rental_Address_streetType, rental_Address_zipCode, rental_Address_streetName}
...
rental_RentalObject.attributes={rental_RentalObject_name, rental_RentalObject_available, rental_RentalObject_ID}
...
rental_Customer.attributes={rental_Customer_firstName, rental_Customer_name}
...
domain_model = DomainModel(
    ...
    associations={address0, objectsToRent1, customers2, rentals4, address6, licenses8, parentAgency9, customer14, rentedObject16, parentAgency10, owner12, parentAgency18},
    generalizations={},
    metadata=None
)
