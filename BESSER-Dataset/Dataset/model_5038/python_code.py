...
class rental_Customer:
    ...
    def __init__(self, firstName: str, name: str, Customer: "rental_RentalAgency" = None, rental_Customer: "rental_Address" = None, owner: set["rental_License"] = None, customers: "rental_RentalAgency" = None, rental_Customer15: "rental_Rental" = None, Customer13: "rental_License" = None):
...
class rental_RentalObject:
    ...
    def __init__(self, ID: str, name: str, available: bool, RentalObject: "rental_RentalAgency" = None, rental_RentalObject: "rental_Rental" = None, objectsToRent: "rental_RentalAgency" = None):
        self.ID = ID
        self.name = name
