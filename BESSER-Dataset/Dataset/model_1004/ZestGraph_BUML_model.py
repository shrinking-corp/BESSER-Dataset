...
# Classes
ZestGraph_NamedElement = Class(name="ZestGraph_NamedElement")
ZestGraph_ZestGraph = Class(name="ZestGraph_ZestGraph")
NamedElement = Class(name="NamedElement")
ZestGraph_GraphItem = Class(name="ZestGraph_GraphItem", is_abstract=True)
ZestGraph_GraphContainer = Class(name="ZestGraph_GraphContainer")
ZestGraph_GraphNode = Class(name="ZestGraph_GraphNode")
GraphItem = Class(name="GraphItem")
ZestGraph_GraphConnection = Class(name="ZestGraph_GraphConnection")
...
ZestGraph_GraphNode.attributes={ZestGraph_GraphNode_nodeStyle, ZestGraph_GraphNode_backColor, ZestGraph_GraphNode_width, ZestGraph_GraphNode_height, ZestGraph_GraphNode_shape}
...
ZestGraph_GraphConnection.attributes={ZestGraph_GraphConnection_lineWidth, ZestGraph_GraphConnection_color, ZestGraph_GraphConnection_lineStyle}
...
domain_model = DomainModel(
    name="ZestGraph",
    types={ZestGraph_NamedElement, ZestGraph_ZestGraph, NamedElement, ZestGraph_GraphItem, ZestGraph_GraphContainer, ZestGraph_GraphNode, GraphItem, ZestGraph_GraphConnection},
    associations={items0, containers1, nodes2, graph4, outgoing5, ingoing6, sourceNode8, targetNode9},
    generalizations={gen_ZestGraph_ZestGraph_NamedElement, gen_ZestGraph_GraphContainer_NamedElement, gen_ZestGraph_GraphNode_GraphItem, gen_ZestGraph_GraphConnection_GraphItem},
    metadata=None
)
