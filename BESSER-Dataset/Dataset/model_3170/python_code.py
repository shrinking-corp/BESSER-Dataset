...
class traceabilitymodel_Block:
    ...
    def __init__(self, ID: str, startPos: str, endPos: str, protectedBlock: bool, startLine: str, startColumn: str, endColumn: str, endLine: str, traceabilitymodel_Block: set["traceabilitymodel_TraceableSegment"] = None, traceabilitymodel_Block19: "traceabilitymodel_File" = None):
        self.ID = ID
...
class traceabilitymodel_Trace:
    ...
    def __init__(self, sourceOperationID: str, sourceOperationName: str, specificationName: str, traceabilitymodel_Trace8: "traceabilitymodel_TraceModel" = None, traceabilitymodel_Trace: "traceabilitymodel_TraceableSegment" = None, traceabilitymodel_Trace3: "traceabilitymodel_ModelElementRef" = None):
...
class traceabilitymodel_ModelElementRef:
    ...
    def __init__(self, ID: str, name: str, featureRef: str, uri: str, traceabilitymodel_ModelElementRef: "traceabilitymodel_MetaModel" = None, traceabilitymodel_ModelElementRef4: "traceabilitymodel_Trace" = None, traceabilitymodel_ModelElementRef13: "traceabilitymodel_TraceModel" = None):
        self.ID = ID
        self.name = name
