...
# Classes
traceabilitymodel_TraceModel = Class(name="traceabilitymodel_TraceModel")
traceabilitymodel_File = Class(name="traceabilitymodel_File")
traceabilitymodel_ModelElementRef = Class(name="traceabilitymodel_ModelElementRef")
traceabilitymodel_MetaModel = Class(name="traceabilitymodel_MetaModel")
traceabilitymodel_Trace = Class(name="traceabilitymodel_Trace")
traceabilitymodel_TraceableSegment = Class(name="traceabilitymodel_TraceableSegment")
traceabilitymodel_Block = Class(name="traceabilitymodel_Block")
...
traceabilitymodel_File.attributes={traceabilitymodel_File_URI, traceabilitymodel_File_ID, traceabilitymodel_File_name}
...
traceabilitymodel_ModelElementRef.attributes={traceabilitymodel_ModelElementRef_featureRef, traceabilitymodel_ModelElementRef_name, traceabilitymodel_ModelElementRef_ID, traceabilitymodel_ModelElementRef_uri}
...
traceabilitymodel_Trace.attributes={traceabilitymodel_Trace_sourceOperationID, traceabilitymodel_Trace_specificationName, traceabilitymodel_Trace_sourceOperationName}
...
traceabilitymodel_TraceableSegment.attributes={traceabilitymodel_TraceableSegment_endColumn, traceabilitymodel_TraceableSegment_startLine, traceabilitymodel_TraceableSegment_endPos, traceabilitymodel_TraceableSegment_endLine, traceabilitymodel_TraceableSegment_startColumn, traceabilitymodel_TraceableSegment_startPos}
...
traceabilitymodel_Block.attributes={traceabilitymodel_Block_ID, traceabilitymodel_Block_endLine, traceabilitymodel_Block_startColumn, traceabilitymodel_Block_endColumn, traceabilitymodel_Block_protectedBlock, traceabilitymodel_Block_startPos, traceabilitymodel_Block_endPos, traceabilitymodel_Block_startLine}
...
domain_model = DomainModel(
    ...
    types={traceabilitymodel_TraceModel, traceabilitymodel_File, traceabilitymodel_ModelElementRef, traceabilitymodel_MetaModel, traceabilitymodel_Trace, traceabilitymodel_TraceableSegment, traceabilitymodel_Block},
    associations={trace7, files9, metaModel0, segment1, originatinElement2, traceablesegment5, modelElementRefs11, metaModels14, blocks17},
    generalizations={},
    metadata=None
)
