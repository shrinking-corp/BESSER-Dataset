...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={SimpleClass_Classifier, SimpleClass_Class, Classifier, Class_, Attribute, SimpleClass_PrimitiveDataType, SimpleClass_Association, SimpleClass_Attribute, SimpleClass_NonReferencedClass},
    associations={parent0, attrs1, src2, dest4, type7, class_8},
