...
# Classes
EtlSimpleTrace_Trace = Class(name="EtlSimpleTrace_Trace")
EtlSimpleTrace_TraceLink = Class(name="EtlSimpleTrace_TraceLink")
EtlSimpleTrace_EObject = Class(name="EtlSimpleTrace_EObject")
