...
domain_model = DomainModel(
    name="relational",
    types={relational_DataBase, relational_Schema, relational_Table, relational_PrimaryKey, Field, relational_ForeignKey, relational_Column, relational_Field, Type},
    associations={schemas0, tables1, reference5, fields3},
