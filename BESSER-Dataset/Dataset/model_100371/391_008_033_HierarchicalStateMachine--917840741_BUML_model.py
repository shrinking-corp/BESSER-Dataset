...
HSM_StateBase.attributes={HSM_StateBase_marked, HSM_StateBase_defaultTransition}
...
HSM_StateDateRelation.attributes={HSM_StateDateRelation_value, HSM_StateDateRelation_color}
...
HSM_Transition.attributes={HSM_Transition_isSync, HSM_Transition_action, HSM_Transition_trigger, HSM_Transition_guard}
...
HSM_StateDataRelation.attributes={HSM_StateDataRelation_value, HSM_StateDataRelation_color}
...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={HSM_MgaObject, DataVar, AssociationDataStateBase, HSM_DataVar, StateBase, HSM_StateBase, MgaObject, AssociationStateState, HSM_StateDateRelation, OrState, HSM_Transition, HSM_OrState, CompoundState, State, Init, HSM_RootFolder, RootFolder, HSM_AndState, HSM_CompoundState, AndState, StateDataRelation, Transition, HSM_StateDataRelation, HSM_PrimitiveState, HSM_Init, PrimitiveState, HSM_State, HSM_AssociationStateState, HSM_AssociationDataStateBase},
    associations={associationStateStatesrc1, data3, associationDataStateBase4, stateBase6, associationStateStatedst0, orState11, associationStateState13, orState7, associationDataStateBase8, rootFolder19, state21, init23, rootFolders16, orState17, compoundState34, andState36, dataVar25, stateDataRelation28, transition30, compoundState32, orState42, orState44, associationDataStateBase146, orState37, orState40, stateDataRelation55, dataVar57, stateBase59, transition49, dstTransition51, srcTransition53},
    generalizations={gen_HSM_DataVar_MgaObject, gen_HSM_StateBase_MgaObject, gen_HSM_StateDateRelation_MgaObject, gen_HSM_Transition_MgaObject, gen_HSM_OrState_CompoundState, gen_HSM_AndState_CompoundState, gen_HSM_CompoundState_StateBase, gen_HSM_StateDataRelation_PrimitiveState, gen_HSM_PrimitiveState_StateBase, gen_HSM_Init_PrimitiveState, gen_HSM_State_PrimitiveState},
    metadata=None
)
