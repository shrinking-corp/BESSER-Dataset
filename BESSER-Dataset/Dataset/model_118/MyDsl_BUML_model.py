...
# Classes
javaDsl_ClassBodyDeclaration = Class(name="javaDsl_ClassBodyDeclaration")
javaDsl_Head = Class(name="javaDsl_Head")
javaDsl_CompilationUnit = Class(name="javaDsl_CompilationUnit")
javaDsl_PackageStatement = Class(name="javaDsl_PackageStatement")
javaDsl_ImportStatement = Class(name="javaDsl_ImportStatement")
javaDsl_TypeDeclaration = Class(name="javaDsl_TypeDeclaration")
javaDsl_EObject = Class(name="javaDsl_EObject")
javaDsl_ClassDeclaration = Class(name="javaDsl_ClassDeclaration")
javaDsl_Interfaces = Class(name="javaDsl_Interfaces")
javaDsl_ClassBody = Class(name="javaDsl_ClassBody")
javaDsl_VariableInitializer = Class(name="javaDsl_VariableInitializer")
javaDsl_Expression = Class(name="javaDsl_Expression")
javaDsl_ClassMemberDeclaration = Class(name="javaDsl_ClassMemberDeclaration")
javaDsl_FieldDeclaration = Class(name="javaDsl_FieldDeclaration")
javaDsl_MethodDeclaration = Class(name="javaDsl_MethodDeclaration")
javaDsl_StaticInitializer = Class(name="javaDsl_StaticInitializer")
ClassBodyDeclaration = Class(name="ClassBodyDeclaration")
javaDsl_Block = Class(name="javaDsl_Block")
javaDsl_ConstructorDeclaration = Class(name="javaDsl_ConstructorDeclaration")
javaDsl_ConstructorDeclarator = Class(name="javaDsl_ConstructorDeclarator")
javaDsl_Exceptions = Class(name="javaDsl_Exceptions")
javaDsl_ConstructorBody = Class(name="javaDsl_ConstructorBody")
javaDsl_FormalParameter = Class(name="javaDsl_FormalParameter")
javaDsl_Type = Class(name="javaDsl_Type")
javaDsl_ExplicitConstructorInvocation = Class(name="javaDsl_ExplicitConstructorInvocation")
javaDsl_BlockStatement = Class(name="javaDsl_BlockStatement")
javaDsl_ArgumentList = Class(name="javaDsl_ArgumentList")
javaDsl_VariableDeclarator = Class(name="javaDsl_VariableDeclarator")
javaDsl_MethodHeader = Class(name="javaDsl_MethodHeader")
javaDsl_ResultType = Class(name="javaDsl_ResultType")
javaDsl_MethodDeclarator = Class(name="javaDsl_MethodDeclarator")
javaDsl_InterfaceDeclaration = Class(name="javaDsl_InterfaceDeclaration")
javaDsl_ExtendsInterfaces = Class(name="javaDsl_ExtendsInterfaces")
javaDsl_InterfaceBody = Class(name="javaDsl_InterfaceBody")
javaDsl_InterfaceMemberDeclaration = Class(name="javaDsl_InterfaceMemberDeclaration")
javaDsl_ConstantDeclaration = Class(name="javaDsl_ConstantDeclaration")
InterfaceMemberDeclaration = Class(name="InterfaceMemberDeclaration")
javaDsl_AbstractMethodDeclaration = Class(name="javaDsl_AbstractMethodDeclaration")
javaDsl_ArrayInitializer = Class(name="javaDsl_ArrayInitializer")
VariableInitializer = Class(name="VariableInitializer")
Statement = Class(name="Statement")
javaDsl_LocalVariableDeclaration = Class(name="javaDsl_LocalVariableDeclaration")
BlockStatement = Class(name="BlockStatement")
javaDsl_Statement = Class(name="javaDsl_Statement")
javaDsl_LabeledStatement = Class(name="javaDsl_LabeledStatement")
javaDsl_StatementExpression = Class(name="javaDsl_StatementExpression")
javaDsl_IfStatement = Class(name="javaDsl_IfStatement")
javaDsl_SwitchStatement = Class(name="javaDsl_SwitchStatement")
javaDsl_ConstantExpression = Class(name="javaDsl_ConstantExpression")
javaDsl_WhileStatement = Class(name="javaDsl_WhileStatement")
javaDsl_DoStatement = Class(name="javaDsl_DoStatement")
javaDsl_ForStatement = Class(name="javaDsl_ForStatement")
javaDsl_ForInit = Class(name="javaDsl_ForInit")
javaDsl_ForUpdate = Class(name="javaDsl_ForUpdate")
javaDsl_InclusiveOrExpression = Class(name="javaDsl_InclusiveOrExpression")
javaDsl_BreakStatement = Class(name="javaDsl_BreakStatement")
javaDsl_ContinueStatement = Class(name="javaDsl_ContinueStatement")
javaDsl_ReturnStatement = Class(name="javaDsl_ReturnStatement")
javaDsl_ThrowsStatement = Class(name="javaDsl_ThrowsStatement")
javaDsl_SynchronizedStatement = Class(name="javaDsl_SynchronizedStatement")
javaDsl_TryStatement = Class(name="javaDsl_TryStatement")
ConstantExpression = Class(name="ConstantExpression")
PrimaryNoNewArray = Class(name="PrimaryNoNewArray")
javaDsl_AssignmentExpression = Class(name="javaDsl_AssignmentExpression")
Expression = Class(name="Expression")
javaDsl_Assignment = Class(name="javaDsl_Assignment")
StatementExpression = Class(name="StatementExpression")
AssignmentExpression = Class(name="AssignmentExpression")
javaDsl_LeftHandSide = Class(name="javaDsl_LeftHandSide")
javaDsl_ConditionalExpression = Class(name="javaDsl_ConditionalExpression")
javaDsl_ConditionalOrExpression = Class(name="javaDsl_ConditionalOrExpression")
javaDsl_ConditionalAndExpression = Class(name="javaDsl_ConditionalAndExpression")
javaDsl_ExclusiveOrExpression = Class(name="javaDsl_ExclusiveOrExpression")
javaDsl_AndExpression = Class(name="javaDsl_AndExpression")
javaDsl_EqualityExpression = Class(name="javaDsl_EqualityExpression")
javaDsl_RelationalExpression = Class(name="javaDsl_RelationalExpression")
javaDsl_ShiftExpression = Class(name="javaDsl_ShiftExpression")
javaDsl_AdditiveExpression = Class(name="javaDsl_AdditiveExpression")
javaDsl_MultiplicativeExpression = Class(name="javaDsl_MultiplicativeExpression")
javaDsl_NoArrayExpression = Class(name="javaDsl_NoArrayExpression")
javaDsl_CastExpression = Class(name="javaDsl_CastExpression")
NoArrayExpressionWithoutMinus = Class(name="NoArrayExpressionWithoutMinus")
javaDsl_PreDecrementExpression = Class(name="javaDsl_PreDecrementExpression")
NoArrayExpression = Class(name="NoArrayExpression")
javaDsl_PreIncrementExpression = Class(name="javaDsl_PreIncrementExpression")
javaDsl_NoArrayExpressionWithoutMinus = Class(name="javaDsl_NoArrayExpressionWithoutMinus")
javaDsl_PostfixExpression = Class(name="javaDsl_PostfixExpression")
javaDsl_Primary = Class(name="javaDsl_Primary")
javaDsl_MethodInvocation = Class(name="javaDsl_MethodInvocation")
javaDsl_FieldAccess = Class(name="javaDsl_FieldAccess")
LeftHandSide = Class(name="LeftHandSide")
javaDsl_ArrayExpression = Class(name="javaDsl_ArrayExpression")
javaDsl_PrimaryNoNewArray = Class(name="javaDsl_PrimaryNoNewArray")
Primary = Class(name="Primary")
javaDsl_ClassInstanceCreationExpression = Class(name="javaDsl_ClassInstanceCreationExpression")
javaDsl_PrimaryNewArray = Class(name="javaDsl_PrimaryNewArray")
javaDsl_ArrayCreationExpression = Class(name="javaDsl_ArrayCreationExpression")
javaDsl_ArrayAccess = Class(name="javaDsl_ArrayAccess")
...
javaDsl_ImportStatement.attributes={javaDsl_ImportStatement_object, javaDsl_ImportStatement_package}
...
javaDsl_Interfaces.attributes={javaDsl_Interfaces_interfaces, javaDsl_Interfaces_keyword}
...
javaDsl_InterfaceDeclaration.attributes={javaDsl_InterfaceDeclaration_modifiers, javaDsl_InterfaceDeclaration_name}
...
javaDsl_RelationalExpression.attributes={javaDsl_RelationalExpression_operators, javaDsl_RelationalExpression_classes}
...
javaDsl_PrimaryNoNewArray.attributes={javaDsl_PrimaryNoNewArray_literal, javaDsl_PrimaryNoNewArray_keyword, javaDsl_PrimaryNoNewArray_reference, javaDsl_PrimaryNoNewArray_method}
...
javaDsl_ArrayCreationExpression.attributes={javaDsl_ArrayCreationExpression_layers, javaDsl_ArrayCreationExpression_type}
...
else_94: BinaryAssociation = BinaryAssociation(
    name="else_94",
    ends={
...
else_150: BinaryAssociation = BinaryAssociation(
    name="else_150",
    ends={
...
class_188: BinaryAssociation = BinaryAssociation(
    name="class_188",
    ends={
...
domain_model = DomainModel(
    name="javaDsl",
    types={javaDsl_ClassBodyDeclaration, javaDsl_Head, javaDsl_CompilationUnit, javaDsl_PackageStatement, javaDsl_ImportStatement, javaDsl_TypeDeclaration, javaDsl_EObject, javaDsl_ClassDeclaration, javaDsl_Interfaces, javaDsl_ClassBody, javaDsl_VariableInitializer, javaDsl_Expression, javaDsl_ClassMemberDeclaration, javaDsl_FieldDeclaration, javaDsl_MethodDeclaration, javaDsl_StaticInitializer, ClassBodyDeclaration, javaDsl_Block, javaDsl_ConstructorDeclaration, javaDsl_ConstructorDeclarator, javaDsl_Exceptions, javaDsl_ConstructorBody, javaDsl_FormalParameter, javaDsl_Type, javaDsl_ExplicitConstructorInvocation, javaDsl_BlockStatement, javaDsl_ArgumentList, javaDsl_VariableDeclarator, javaDsl_MethodHeader, javaDsl_ResultType, javaDsl_MethodDeclarator, javaDsl_InterfaceDeclaration, javaDsl_ExtendsInterfaces, javaDsl_InterfaceBody, javaDsl_InterfaceMemberDeclaration, javaDsl_ConstantDeclaration, InterfaceMemberDeclaration, javaDsl_AbstractMethodDeclaration, javaDsl_ArrayInitializer, VariableInitializer, Statement, javaDsl_LocalVariableDeclaration, BlockStatement, javaDsl_Statement, javaDsl_LabeledStatement, javaDsl_StatementExpression, javaDsl_IfStatement, javaDsl_SwitchStatement, javaDsl_ConstantExpression, javaDsl_WhileStatement, javaDsl_DoStatement, javaDsl_ForStatement, javaDsl_ForInit, javaDsl_ForUpdate, javaDsl_InclusiveOrExpression, javaDsl_BreakStatement, javaDsl_ContinueStatement, javaDsl_ReturnStatement, javaDsl_ThrowsStatement, javaDsl_SynchronizedStatement, javaDsl_TryStatement, ConstantExpression, PrimaryNoNewArray, javaDsl_AssignmentExpression, Expression, javaDsl_Assignment, StatementExpression, AssignmentExpression, javaDsl_LeftHandSide, javaDsl_ConditionalExpression, javaDsl_ConditionalOrExpression, javaDsl_ConditionalAndExpression, javaDsl_ExclusiveOrExpression, javaDsl_AndExpression, javaDsl_EqualityExpression, javaDsl_RelationalExpression, javaDsl_ShiftExpression, javaDsl_AdditiveExpression, javaDsl_MultiplicativeExpression, javaDsl_NoArrayExpression, javaDsl_CastExpression, NoArrayExpressionWithoutMinus, javaDsl_PreDecrementExpression, NoArrayExpression, javaDsl_PreIncrementExpression, javaDsl_NoArrayExpressionWithoutMinus, javaDsl_PostfixExpression, javaDsl_Primary, javaDsl_MethodInvocation, javaDsl_FieldAccess, LeftHandSide, javaDsl_ArrayExpression, javaDsl_PrimaryNoNewArray, Primary, javaDsl_ClassInstanceCreationExpression, javaDsl_PrimaryNewArray, javaDsl_ArrayCreationExpression, javaDsl_ArrayAccess},
    associations={program0, package1, imports3, typeDeclarations5, name7, implements9, body10, value41, exp43, declarations12, member14, field16, method18, code20, header21, throws22, body24, params26, type28, invocation30, declarations32, args34, type36, variables39, values81, signature45, body47, returnType50, header52, throws54, type57, params60, extends63, body64, declarations66, type68, constant70, returnType73, header75, throws78, expressions119, declarations83, type86, variables88, statement91, then92, else_94, expression97, constants99, statements101, statement104, statement106, initExpr108, updateExpr109, statement111, expressions114, localVariable116, operands154, expression122, expression124, expression126, body128, tryBody131, params133, catchesBody136, finallyBody139, object142, value143, condition145, then146, else_150, operands152, args176, object178, operands156, operands158, operands160, operands162, operands164, operands166, operands168, operands170, operand173, object175, object181, args183, dimensions186, class_188, array189, args190, declarations193, dimensions196, index199, array202, field204},
    generalizations={gen_javaDsl_StaticInitializer_ClassBodyDeclaration, gen_javaDsl_ConstructorDeclaration_ClassBodyDeclaration, gen_javaDsl_ConstantDeclaration_InterfaceMemberDeclaration, gen_javaDsl_AbstractMethodDeclaration_InterfaceMemberDeclaration, gen_javaDsl_ArrayInitializer_VariableInitializer, gen_javaDsl_Block_Statement, gen_javaDsl_LocalVariableDeclaration_BlockStatement, gen_javaDsl_Statement_BlockStatement, gen_javaDsl_LabeledStatement_Statement, gen_javaDsl_StatementExpression_Statement, gen_javaDsl_IfStatement_Statement, gen_javaDsl_SwitchStatement_Statement, gen_javaDsl_WhileStatement_Statement, gen_javaDsl_DoStatement_Statement, gen_javaDsl_ForStatement_Statement, gen_javaDsl_BreakStatement_Statement, gen_javaDsl_ContinueStatement_Statement, gen_javaDsl_ReturnStatement_Statement, gen_javaDsl_ThrowsStatement_Statement, gen_javaDsl_SynchronizedStatement_Statement, gen_javaDsl_TryStatement_Statement, gen_javaDsl_Expression_ConstantExpression, gen_javaDsl_Expression_PrimaryNoNewArray, gen_javaDsl_AssignmentExpression_Expression, gen_javaDsl_Assignment_StatementExpression, gen_javaDsl_Assignment_AssignmentExpression, gen_javaDsl_ConditionalExpression_AssignmentExpression, gen_javaDsl_CastExpression_NoArrayExpressionWithoutMinus, gen_javaDsl_PreDecrementExpression_StatementExpression, gen_javaDsl_PreDecrementExpression_NoArrayExpression, gen_javaDsl_PreIncrementExpression_StatementExpression, gen_javaDsl_PreIncrementExpression_NoArrayExpression, gen_javaDsl_NoArrayExpressionWithoutMinus_NoArrayExpression, gen_javaDsl_PostfixExpression_StatementExpression, gen_javaDsl_PostfixExpression_NoArrayExpressionWithoutMinus, gen_javaDsl_MethodInvocation_StatementExpression, gen_javaDsl_FieldAccess_LeftHandSide, gen_javaDsl_PrimaryNoNewArray_Primary, gen_javaDsl_PrimaryNewArray_Primary, gen_javaDsl_ClassInstanceCreationExpression_StatementExpression, gen_javaDsl_ArrayAccess_LeftHandSide},
    metadata=None
)
