...
class forms_Form:
    ...
    def __init__(self, description: str, name: str, title: str, forms_Form51: "forms_RelationshipPageElement" = None, forms_Form34: "forms_Entity" = None, form: set["forms_Page"] = None, forms_Form: "forms_FormModel" = None, forms_Form32: "forms_FormModel" = None, Form: "forms_Page" = None):
...
class forms_Condition(ABC):
    ...
    def __init__(self, conditionID: str, type: str, conditions: "forms_Page" = None, conditions59: "forms_PageElement" = None, conditions62: "forms_CompositeCondition" = None, Condition66: "forms_CompositeCondition" = None, Condition: "forms_Page" = None, Condition42: "forms_PageElement" = None):
...
class forms_PageElement(ABC):
    ...
    def __init__(self, label: str, elementID: str, pageElements: "forms_Page" = None, PageElement60: "forms_Condition" = None, PageElement: "forms_Page" = None, pageElement: set["forms_Condition"] = None):
        self.label = label
...
class forms_Page:
    ...
    def __init__(self, title: str, Page44: "forms_PageElement" = None, Page57: "forms_Condition" = None, Page: "forms_Form" = None, page: set["forms_PageElement"] = None, page39: set["forms_Condition"] = None, pages: "forms_Form" = None):
        self.title = title
        self.Page44 = Page44
        self.Page57 = Page57
        self.Page = Page
...
class forms_Relationship:
    ...
    def __init__(self, name: str, lowerBound: str, upperBound: str, forms_Relationship48: "forms_RelationshipPageElement" = None, Relationship: "forms_Entity" = None, relationships: "forms_Entity" = None, forms_Relationship: "forms_Entity" = None, forms_Relationship25: "forms_Relationship" = None, forms_Relationship23: "forms_Relationship" = None):
        self.name = name
...
class forms_Attribute:
    ...
    def __init__(self, mandatory: bool, type: str, name: str, forms_Attribute46: "forms_AttributePageElement" = None, forms_Attribute54: "forms_Column" = None, forms_Attribute14: "forms_EnumerationType" = None, attributes: "forms_Entity" = None, forms_Attribute: "forms_Entity" = None, Attribute: "forms_Entity" = None):
...
class forms_EnumerationType:
    ...
    def __init__(self, name: str, forms_EnumerationType15: "forms_Attribute" = None, forms_EnumerationType: "forms_EntityModel" = None, forms_EnumerationType18: set["forms_EnumerationLiteral"] = None):
        self.name = name
...
class forms_Entity:
    ...
    def __init__(self, name: str, Entity: "forms_Attribute" = None, forms_Entity: "forms_EntityModel" = None, forms_Entity4: "forms_Attribute" = None, forms_Entity7: "forms_Entity" = None, forms_Entity5: "forms_Entity" = None, forms_Entity10: "forms_Entity" = None, forms_Entity8: set["forms_Entity"] = None, entity: set["forms_Attribute"] = None, source: set["forms_Relationship"] = None, forms_Entity35: "forms_Form" = None, Entity20: "forms_Relationship" = None, forms_Entity22: "forms_Relationship" = None):
        self.name = name
        self.Entity = Entity
