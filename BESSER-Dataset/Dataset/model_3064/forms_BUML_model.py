...
# Classes
forms_EntityModel = Class(name="forms_EntityModel")
forms_Entity = Class(name="forms_Entity")
forms_EnumerationType = Class(name="forms_EnumerationType")
...
forms_EnumerationLiteral = Class(name="forms_EnumerationLiteral")
forms_FormModel = Class(name="forms_FormModel")
forms_Form = Class(name="forms_Form")
forms_SelectionAttributePageElement = Class(name="forms_SelectionAttributePageElement")
forms_DateSelectionAttributePageElement = Class(name="forms_DateSelectionAttributePageElement")
forms_TimeSelectionAttributePageElement = Class(name="forms_TimeSelectionAttributePageElement")
...
forms_TextFieldAttributePageElement = Class(name="forms_TextFieldAttributePageElement")
AttributePageElement = Class(name="AttributePageElement")
forms_TextareaAttributePageElement = Class(name="forms_TextareaAttributePageElement")
...
forms_Attribute.attributes={forms_Attribute_mandatory, forms_Attribute_type, forms_Attribute_name}
...
forms_Relationship.attributes={forms_Relationship_lowerBound, forms_Relationship_upperBound, forms_Relationship_name}
...
forms_Form.attributes={forms_Form_description, forms_Form_title, forms_Form_name}
...
domain_model = DomainModel(
    name="forms",
    types={forms_EntityModel, forms_Entity, forms_EnumerationType, forms_Attribute, forms_Relationship, forms_Page, forms_PageElement, forms_Condition, forms_EnumerationLiteral, forms_FormModel, forms_Form, forms_SelectionAttributePageElement, forms_DateSelectionAttributePageElement, forms_TimeSelectionAttributePageElement, forms_AttributePageElement, PageElement, forms_RelationshipPageElement, forms_TextFieldAttributePageElement, AttributePageElement, forms_TextareaAttributePageElement, forms_AttributeValueCondition, Condition, forms_ListRelationshipPageElement, RelationshipPageElement, forms_TableRelationshipPageElement, forms_Column, forms_CompositeCondition, AttributeType, ConditionType, CompositeConditionOperator},
    associations={enumerationType13, entity16, entities0, enumerations1, id3, superType6, superTypes9, attributes11, relationships12, entity33, pages36, pageElements37, literals17, source19, target21, opposite24, entityModel26, forms28, welcomeForm30, conditions38, form40, conditions41, page43, attribute45, relationship47, editingForm49, trigger63, columns52, attribute53, table55, page56, pageElement58, parentCondtion61, conditions65},
    generalizations={gen_forms_TextareaAttributePageElement_AttributePageElement, gen_forms_SelectionAttributePageElement_AttributePageElement, gen_forms_DateSelectionAttributePageElement_AttributePageElement, gen_forms_TimeSelectionAttributePageElement_AttributePageElement, gen_forms_AttributePageElement_PageElement, gen_forms_RelationshipPageElement_PageElement, gen_forms_TextFieldAttributePageElement_AttributePageElement, gen_forms_AttributeValueCondition_Condition, gen_forms_ListRelationshipPageElement_RelationshipPageElement, gen_forms_TableRelationshipPageElement_RelationshipPageElement, gen_forms_CompositeCondition_Condition},
    metadata=None
)
