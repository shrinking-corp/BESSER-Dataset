...
# Classes
Legolang_Robot_OrderRobot = Class(name="Legolang_Robot_OrderRobot")
Expr = Class(name="Expr")
Legolang_Robot_move = Class(name="Legolang_Robot_move")
OrderRobot = Class(name="OrderRobot")
Legolang_Robot_bip = Class(name="Legolang_Robot_bip")
Legolang_Robot_turn = Class(name="Legolang_Robot_turn")
Legolang_Robot_stopEngine = Class(name="Legolang_Robot_stopEngine")
Legolang_Robot_display = Class(name="Legolang_Robot_display")
Legolang_Robot_turnAngle = Class(name="Legolang_Robot_turnAngle")
Legolang_Robot_obstacle = Class(name="Legolang_Robot_obstacle")
Legolang_Robot_hasTurned = Class(name="Legolang_Robot_hasTurned")
Legolang_controlflow_tantqueue = Class(name="Legolang_controlflow_tantqueue")
ExprBool = Class(name="ExprBool")
Legolang_controlflow_si = Class(name="Legolang_controlflow_si")
Legolang_controlflow_Expr = Class(name="Legolang_controlflow_Expr")
tantqueue = Class(name="tantqueue")
Legolang_controlflow_operator = Class(name="Legolang_controlflow_operator")
Legolang_controlflow_opUnaire = Class(name="Legolang_controlflow_opUnaire")
controlflow_operator = Class(name="controlflow_operator")
controlflow_ExprBool = Class(name="controlflow_ExprBool")
Legolang_controlflow_opBinaire = Class(name="Legolang_controlflow_opBinaire")
operator = Class(name="operator")
opBinaire = Class(name="opBinaire")
Legolang_controlflow_not = Class(name="Legolang_controlflow_not")
opUnaire = Class(name="opUnaire")
Legolang_controlflow_and = Class(name="Legolang_controlflow_and")
Legolang_controlflow_ExprBool = Class(name="Legolang_controlflow_ExprBool")
Legolang_controlflow_Program = Class(name="Legolang_controlflow_Program")
...
domain_model = DomainModel(
    name="Legolang",
    types={Legolang_Robot_OrderRobot, Expr, Legolang_Robot_move, OrderRobot, Legolang_Robot_bip, Legolang_Robot_turn, Legolang_Robot_stopEngine, Legolang_Robot_display, Legolang_Robot_turnAngle, Legolang_Robot_obstacle, Legolang_Robot_hasTurned, Legolang_controlflow_tantqueue, ExprBool, Legolang_controlflow_si, Legolang_controlflow_Expr, tantqueue, Legolang_controlflow_operator, Legolang_controlflow_opUnaire, controlflow_operator, controlflow_ExprBool, Legolang_controlflow_opBinaire, operator, opBinaire, Legolang_controlflow_not, opUnaire, Legolang_controlflow_and, Legolang_controlflow_ExprBool, Legolang_controlflow_Program},
    associations={EReference00, instrTTque1, Cdt3, cdt5, instrSi7, EReference010, fonction11, EReference013, LeftSon14, RightSon17, EReference220, EReferenc022},
    generalizations={gen_Legolang_Robot_move_OrderRobot, gen_Legolang_Robot_bip_OrderRobot, gen_Legolang_Robot_turn_OrderRobot, gen_Legolang_Robot_stopEngine_OrderRobot, gen_Legolang_Robot_display_OrderRobot, gen_Legolang_Robot_turnAngle_OrderRobot, gen_Legolang_Robot_obstacle_OrderRobot, gen_Legolang_Robot_hasTurned_OrderRobot, gen_Legolang_controlflow_tantqueue_Expr, gen_Legolang_controlflow_si_Expr, gen_Legolang_controlflow_opUnaire_controlflow_operator, gen_Legolang_controlflow_opUnaire_controlflow_ExprBool, gen_Legolang_controlflow_opBinaire_operator, gen_Legolang_controlflow_not_opUnaire, gen_Legolang_controlflow_and_opBinaire, gen_Legolang_controlflow_ExprBool_Expr},
    metadata=None
)
