...
class services_ServiceProfile:
    ...
    def __init__(self, name: str, services_ServiceProfile39: "services_ServiceUser" = None, services_ServiceProfile: set["services_NetXResource"] = None):
        self.name = name
...
class services_ServiceForecast:
    ...
    def __init__(self, name: str, revision: str, services_ServiceForecast: "services_Service" = None, services_ServiceForecast20: "services_DateTimeRange" = None, services_ServiceForecast24: set["services_ResourceForecast"] = None, services_ServiceForecast22: set["services_ServiceForecastUsers"] = None):
        self.name = name
        self.revision = revision
...
class services_Service:
    ...
    def __init__(self, serviceCategory: str, serviceClass: str, serviceName: str, serviceDescription: str, services_Service6: "services_Service" = None, services_Service4: set["services_Service"] = None, services_Service8: set["services_ServiceForecast"] = None, services_Service10: set["services_ServiceMonitor"] = None, services_Service: set["services_CIID"] = None, services_Service14: "services_ServiceDistribution" = None, services_Service12: set["services_ServiceUser"] = None):
...
class services_RFSService(Service):
    ...
    def __init__(self, functionalCategory: str, services_RFSService2: set["services_Tolerance"] = None, services_RFSService: set["services_Node"] = None):
