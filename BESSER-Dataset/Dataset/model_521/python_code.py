...
class Families_Family(uncertainty_ModelElement, uncertainty_aFamily):
    ...
    def __init__(self, name: str, Families_Family: "aFamilyMember" = None, Families_Family3: "aFamilyMember" = None, Families_Family6: set["aFamilyMember"] = None, Families_Family9: set["aFamilyMember"] = None, Families_Family12: "aFamilyRegister" = None):
        self.name = name
