...
# Classes
Families_FamilyRegister = Class(name="Families_FamilyRegister")
uncertainty_ModelElement = Class(name="uncertainty_ModelElement")
uncertainty_aFamilyRegister = Class(name="uncertainty_aFamilyRegister")
aFamily = Class(name="aFamily")
Families_FamilyMember = Class(name="Families_FamilyMember")
uncertainty_aFamilyMember = Class(name="uncertainty_aFamilyMember")
Families_uncertainty_ModelElement = Class(name="Families_uncertainty_ModelElement", is_abstract=True)
ModelElement = Class(name="ModelElement")
Families_uncertainty_UData = Class(name="Families_uncertainty_UData", is_abstract=True)
Families_uncertainty_uFamilyRegister = Class(name="Families_uncertainty_uFamilyRegister")
Families_Family = Class(name="Families_Family")
uncertainty_aFamily = Class(name="uncertainty_aFamily")
aFamilyMember = Class(name="aFamilyMember")
aFamilyRegister = Class(name="aFamilyRegister")
Families_uncertainty_aFamily = Class(name="Families_uncertainty_aFamily", is_abstract=True)
Families_uncertainty_uFamilyMember = Class(name="Families_uncertainty_uFamilyMember")
uncertainty_Families_FamilyMember = Class(name="uncertainty_Families_FamilyMember")
uFamilyMember = Class(name="uFamilyMember")
Families_uncertainty_aFamilyMember = Class(name="Families_uncertainty_aFamilyMember", is_abstract=True)
uncertainty_UData = Class(name="uncertainty_UData")
uncertainty_Families_FamilyRegister = Class(name="uncertainty_Families_FamilyRegister")
uFamilyRegister = Class(name="uFamilyRegister")
Families_uncertainty_aFamilyRegister = Class(name="Families_uncertainty_aFamilyRegister", is_abstract=True)
Families_uncertainty_uFamily = Class(name="Families_uncertainty_uFamily")
uncertainty_Families_Family = Class(name="uncertainty_Families_Family")
...
domain_model = DomainModel(
    name="Families",
    types={Families_FamilyRegister, uncertainty_ModelElement, uncertainty_aFamilyRegister, aFamily, Families_FamilyMember, uncertainty_aFamilyMember, Families_uncertainty_ModelElement, ModelElement, Families_uncertainty_UData, Families_uncertainty_uFamilyRegister, Families_Family, uncertainty_aFamily, aFamilyMember, aFamilyRegister, Families_uncertainty_aFamily, Families_uncertainty_uFamilyMember, uncertainty_Families_FamilyMember, uFamilyMember, Families_uncertainty_aFamilyMember, uncertainty_UData, uncertainty_Families_FamilyRegister, uFamilyRegister, Families_uncertainty_aFamilyRegister, Families_uncertainty_uFamily, uncertainty_Families_Family, uFamily, OperatorType},
    associations={fatherInverse13, motherInverse15, sonsInverse18, daughtersInverse21, include24, exclude25, families0, father1, mother2, sons5, daughters8, familiesInverse11, uleft40, uright41, upoint44, uleft28, uright29, upoint32, uleft34, uright35, upoint38},
    generalizations={gen_Families_FamilyRegister_uncertainty_ModelElement, gen_Families_FamilyRegister_uncertainty_aFamilyRegister, gen_Families_FamilyMember_uncertainty_ModelElement, gen_Families_FamilyMember_uncertainty_aFamilyMember, gen_Families_uncertainty_uFamilyRegister_uncertainty_aFamilyRegister, gen_Families_Family_uncertainty_ModelElement, gen_Families_Family_uncertainty_aFamily, gen_Families_uncertainty_uFamilyMember_uncertainty_aFamilyMember, gen_Families_uncertainty_uFamilyMember_uncertainty_UData, gen_Families_uncertainty_uFamilyRegister_uncertainty_UData, gen_Families_uncertainty_uFamily_uncertainty_aFamily, gen_Families_uncertainty_uFamily_uncertainty_UData},
    metadata=None
)
