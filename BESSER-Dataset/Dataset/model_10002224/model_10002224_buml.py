...
User.attributes={User_id, User_password, User_attribute, User_firstname, User_username, User_lastname}
...
Basket.attributes={Basket_id, Basket_updatedAt}
...
Position.attributes={Position_createdAt, Position_longitude, Position_latitude, Position_id}
...
Address.attributes={Address_country, Address_city, Address_id, Address_street, Address_zipCode}
...
Store.attributes={Store_photoPath, Store_name, Store_id}
...
Order.attributes={Order_amount, Order_createdAt, Order_id}
...
Product.attributes={Product_price, Product_id, Product_description, Product_photoPath, Product_name}
...
Offer.attributes={Offer_discount, Offer_id, Offer_beginDate, Offer_endDate}
...
Category.attributes={Category_id, Category_name, Category_photoPath}
