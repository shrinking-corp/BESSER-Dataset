...
# Classes
gyro_Child = Class(name="gyro_Child")
gyro_Sibling = Class(name="gyro_Sibling")
gyro_Behavior = Class(name="gyro_Behavior", is_abstract=True)
gyro_GyroSpecification = Class(name="gyro_GyroSpecification")
gyro_Node = Class(name="gyro_Node", is_abstract=True)
gyro_Action = Class(name="gyro_Action", is_abstract=True)
gyro_Condition = Class(name="gyro_Condition", is_abstract=True)
Action = Class(name="Action")
gyro_Distance = Class(name="gyro_Distance")
Condition = Class(name="Condition")
gyro_Bumpers = Class(name="gyro_Bumpers")
gyro_Waiting = Class(name="gyro_Waiting")
gyro_Actuate = Class(name="gyro_Actuate", is_abstract=True)
gyro_Motor = Class(name="gyro_Motor")
Actuate = Class(name="Actuate")
gyro_Servo = Class(name="gyro_Servo")
gyro_LED = Class(name="gyro_LED")
Node = Class(name="Node")
gyro_Priority = Class(name="gyro_Priority")
Behavior = Class(name="Behavior")
gyro_Parallel = Class(name="gyro_Parallel")
gyro_Sequential = Class(name="gyro_Sequential")
gyro_StatusChange = Class(name="gyro_StatusChange")
...
gyro_Servo.attributes={gyro_Servo_maximalPosition, gyro_Servo_step, gyro_Servo_minimalPosition}
...
gyro_StatusChange.attributes={gyro_StatusChange_changeSuccess, gyro_StatusChange_changeFailure, gyro_StatusChange_changeRunning}
...
domain_model = DomainModel(
    name="gyro",
    types={gyro_Child, gyro_Sibling, gyro_Behavior, gyro_GyroSpecification, gyro_Node, gyro_Action, gyro_Condition, Action, gyro_Distance, Condition, gyro_Bumpers, gyro_Waiting, gyro_Actuate, gyro_Motor, Actuate, gyro_Servo, gyro_LED, Node, gyro_Priority, Behavior, gyro_Parallel, gyro_Sequential, gyro_StatusChange, LightStatus, SuccessState, FailureState, RunningState, DistanceKind, BumperKind},
    associations={nodes0, child1, next3, source5, target7, source10, target13},
    generalizations={gen_gyro_Action_Node, gen_gyro_Condition_Action, gen_gyro_Distance_Condition, gen_gyro_Bumpers_Condition, gen_gyro_Waiting_Condition, gen_gyro_Actuate_Action, gen_gyro_Motor_Actuate, gen_gyro_Servo_Actuate, gen_gyro_LED_Actuate, gen_gyro_Behavior_Node, gen_gyro_Priority_Behavior, gen_gyro_Parallel_Behavior, gen_gyro_Sequential_Behavior, gen_gyro_StatusChange_Behavior},
    metadata=None
)
