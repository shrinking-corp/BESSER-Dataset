...
# Classes
my_BType = Class(name="my_BType")
my_Model = Class(name="my_Model")
my_Entity = Class(name="my_Entity")
my_AType = Class(name="my_AType")
...
domain_model = DomainModel(
    name="my",
    types={my_BType, my_Model, my_Entity, my_AType, Entity},
