...
# Classes
ActivitiesProv_Activity = Class(name="ActivitiesProv_Activity")
ActivitiesProv_ActivityNode = Class(name="ActivitiesProv_ActivityNode", is_abstract=True)
ActivitiesProv_ActivityGroup = Class(name="ActivitiesProv_ActivityGroup", is_abstract=True)
ActivitiesProv_ObjectNode = Class(name="ActivitiesProv_ObjectNode", is_abstract=True)
ActivityNode = Class(name="ActivityNode")
ActivitiesProv_ActivityParameterNode = Class(name="ActivitiesProv_ActivityParameterNode")
ObjectNode = Class(name="ObjectNode")
ActivitiesProv_ControlNode = Class(name="ActivitiesProv_ControlNode", is_abstract=True)
ActivitiesProv_ActivityFinalNode = Class(name="ActivitiesProv_ActivityFinalNode")
ControlNode = Class(name="ControlNode")
FinalNode = Class(name="FinalNode")
ActivitiesProv_InitialNode = Class(name="ActivitiesProv_InitialNode")
ActivitiesProv_ActivityEdge = Class(name="ActivitiesProv_ActivityEdge", is_abstract=True)
ActivitiesProv_ActivityPartition = Class(name="ActivitiesProv_ActivityPartition")
ActivitiesProv_StructuredActivityNode = Class(name="ActivitiesProv_StructuredActivityNode")
ActivitiesProv_InterruptibleActivityRegion = Class(name="ActivitiesProv_InterruptibleActivityRegion")
ActivitiesProv_ForkNode = Class(name="ActivitiesProv_ForkNode")
ActivitiesProv_JoinNode = Class(name="ActivitiesProv_JoinNode")
ActivitiesProv_MergeNode = Class(name="ActivitiesProv_MergeNode")
ActivitiesProv_DecisionNode = Class(name="ActivitiesProv_DecisionNode")
ActivityGroup = Class(name="ActivityGroup")
ActivitiesProv_ControlFlow = Class(name="ActivitiesProv_ControlFlow")
ActivityEdge = Class(name="ActivityEdge")
ActivitiesProv_ObjectFlow = Class(name="ActivitiesProv_ObjectFlow")
ActivitiesProv_CentralBufferNode = Class(name="ActivitiesProv_CentralBufferNode")
ActivitiesProv_FinalNode = Class(name="ActivitiesProv_FinalNode", is_abstract=True)
ActivitiesProv_FlowFinalNode = Class(name="ActivitiesProv_FlowFinalNode")
ActivitiesProv_ConditionalNode = Class(name="ActivitiesProv_ConditionalNode")
ActivitiesProv_Clause = Class(name="ActivitiesProv_Clause")
ActivitiesProv_DataStoreNode = Class(name="ActivitiesProv_DataStoreNode")
CentralBufferNode = Class(name="CentralBufferNode")
ActivitiesProv_ParameterSet = Class(name="ActivitiesProv_ParameterSet")
ExecutableNode = Class(name="ExecutableNode")
ActivitiesProv_ExecutableNode = Class(name="ActivitiesProv_ExecutableNode")
ActivitiesProv_ExceptionHandler = Class(name="ActivitiesProv_ExceptionHandler")
ActivitiesProv_LoopNode = Class(name="ActivitiesProv_LoopNode")
StructuredActivityNode = Class(name="StructuredActivityNode")
ActivitiesProv_SequenceNode = Class(name="ActivitiesProv_SequenceNode")
ActivitiesProv_ExpansionRegion = Class(name="ActivitiesProv_ExpansionRegion")
ActivitiesProv_ExpansionNode = Class(name="ActivitiesProv_ExpansionNode")
...
ActivitiesProv_Activity.attributes={ActivitiesProv_Activity_isReadOnly, ActivitiesProv_Activity_isSingleExecution}
...
domain_model = DomainModel(
    name="ActivitiesProv",
    types={ActivitiesProv_Activity, ActivitiesProv_ActivityNode, ActivitiesProv_ActivityGroup, ActivitiesProv_ObjectNode, ActivityNode, ActivitiesProv_ActivityParameterNode, ObjectNode, ActivitiesProv_ControlNode, ActivitiesProv_ActivityFinalNode, ControlNode, FinalNode, ActivitiesProv_InitialNode, ActivitiesProv_ActivityEdge, ActivitiesProv_ActivityPartition, ActivitiesProv_StructuredActivityNode, ActivitiesProv_InterruptibleActivityRegion, ActivitiesProv_ForkNode, ActivitiesProv_JoinNode, ActivitiesProv_MergeNode, ActivitiesProv_DecisionNode, ActivityGroup, ActivitiesProv_ControlFlow, ActivityEdge, ActivitiesProv_ObjectFlow, ActivitiesProv_CentralBufferNode, ActivitiesProv_FinalNode, ActivitiesProv_FlowFinalNode, ActivitiesProv_ConditionalNode, ActivitiesProv_Clause, ActivitiesProv_DataStoreNode, CentralBufferNode, ActivitiesProv_ParameterSet, ExecutableNode, ActivitiesProv_ExecutableNode, ActivitiesProv_ExceptionHandler, ActivitiesProv_LoopNode, StructuredActivityNode, ActivitiesProv_SequenceNode, ActivitiesProv_ExpansionRegion, ActivitiesProv_ExpansionNode},
    associations={node0, group1, inActivity35, containedNode38, containedEdge41, edge3, partition5, structuredNode7, inGroup9, redefinedNode13, incoming15, outgoing18, inPartition21, inInterruptibleRegion24, inStructuredNode26, subgroup30, superGroup33, decisionInputFlow65, edge66, subpartition70, superPartition73, target44, source47, redefinedEdge51, inGroup53, inPartition56, interrupts59, inStructuredNode62, setupPart94, bodyPart96, test99, clause102, node75, interruptingEdge78, node81, activity84, node87, edge90, handler93, regionAsInput129, regionAsOutput132, test103, body106, predecessorClause110, sucessorClause113, executableNode115, handlerBody117, protectedNode120, exceptionInput123, inputElement125, outputElement126},
    generalizations={gen_ActivitiesProv_ObjectNode_ActivityNode, gen_ActivitiesProv_ActivityParameterNode_ObjectNode, gen_ActivitiesProv_ControlNode_ActivityNode, gen_ActivitiesProv_ActivityFinalNode_ControlNode, gen_ActivitiesProv_ActivityFinalNode_FinalNode, gen_ActivitiesProv_InitialNode_ControlNode, gen_ActivitiesProv_ForkNode_ControlNode, gen_ActivitiesProv_JoinNode_ControlNode, gen_ActivitiesProv_MergeNode_ControlNode, gen_ActivitiesProv_DecisionNode_ControlNode, gen_ActivitiesProv_ActivityPartition_ActivityGroup, gen_ActivitiesProv_ControlFlow_ActivityEdge, gen_ActivitiesProv_ObjectFlow_ActivityEdge, gen_ActivitiesProv_CentralBufferNode_ObjectNode, gen_ActivitiesProv_FinalNode_ControlNode, gen_ActivitiesProv_FlowFinalNode_FinalNode, gen_ActivitiesProv_ConditionalNode_StructuredActivityNode, gen_ActivitiesProv_DataStoreNode_CentralBufferNode, gen_ActivitiesProv_InterruptibleActivityRegion_ActivityGroup, gen_ActivitiesProv_StructuredActivityNode_ExecutableNode, gen_ActivitiesProv_StructuredActivityNode_ActivityGroup, gen_ActivitiesProv_ExecutableNode_ActivityNode, gen_ActivitiesProv_LoopNode_StructuredActivityNode, gen_ActivitiesProv_SequenceNode_StructuredActivityNode, gen_ActivitiesProv_ExpansionRegion_StructuredActivityNode, gen_ActivitiesProv_ExpansionNode_ObjectNode},
    metadata=None
)
