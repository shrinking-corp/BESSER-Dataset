...
class ActivitiesProv_LoopNode(StructuredActivityNode):
    ...
    def __init__(self, isTestedFirst: bool, ActivitiesProv_LoopNode: set["ActivitiesProv_ExecutableNode"] = None, ActivitiesProv_LoopNode97: set["ActivitiesProv_ExecutableNode"] = None, ActivitiesProv_LoopNode100: set["ActivitiesProv_ExecutableNode"] = None):
...
class ActivitiesProv_ForkNode(ControlNode):
    ...
    pass
class ActivitiesProv_ActivityFinalNode(ControlNode, FinalNode):
...
class ActivitiesProv_Activity:
    ...
    def __init__(self, isReadOnly: bool, isSingleExecution: bool, ActivitiesProv_Activity: set["ActivitiesProv_ActivityNode"] = None, ActivitiesProv_Activity2: set["ActivitiesProv_ActivityGroup"] = None, ActivitiesProv_Activity37: "ActivitiesProv_ActivityGroup" = None, ActivitiesProv_Activity4: set["ActivitiesProv_ActivityEdge"] = None, ActivitiesProv_Activity6: set["ActivitiesProv_ActivityPartition"] = None, ActivitiesProv_Activity8: set["ActivitiesProv_StructuredActivityNode"] = None, ActivitiesProv_Activity86: "ActivitiesProv_StructuredActivityNode" = None):
