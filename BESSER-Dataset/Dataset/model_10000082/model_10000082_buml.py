...
Employee.attributes={Employee_password, Employee_employeeId, Employee_noOfLeaves, Employee_employeeName, Employee_managerId, Employee_leavesTaken, Employee_jobLevel}
...
LeaveApplication.attributes={LeaveApplication_status, LeaveApplication_toDate, LeaveApplication_employeeId, LeaveApplication_fromDate, LeaveApplication_applicationId, LeaveApplication_approverComments, LeaveApplication_reason}
...
domain_model = DomainModel(
    name="_0be2219f_a7a1_426b_9c12_f1ac0ac17d03",
    ...
    associations={User_Query_Eligibility, User_Query_Leave_Balance, User_Query_Leave_History, Employee_Apply_Leave, Employee_Leave_Request_Status, Employee_Approver_Jobs, Admin_CreateUser, Admin_Update_Calendar, Application_SendNotification, Credit_Leaves_Application, Application_AutoApproval, Application_GenerateSummary, User_Login},
    generalizations={},
    metadata=None
)
