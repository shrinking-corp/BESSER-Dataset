...
public class Online_Shopping_System_Product  {
    ...
    public Online_Shopping_System_Product(
        String ID,        String Supplier,        String Name    ) {
        this.ID = ID;
    ...
    public Online_Shopping_System_Product(
        String ID,        String Supplier,        String Name        ArrayList<Online_Shopping_System_Line_item> online_shopping_system_line_items    ) {
        this.ID = ID;
        this.Supplier = Supplier;
        this.Name = Name;
