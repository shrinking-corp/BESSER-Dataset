...
class Online_Shopping_System_Order:
    ...
    def __init__(self, status: str, total: str, Number: str, ordered: str, shipped: str, Ship_to: str, account9: "Online_Shopping_System_Account" = None, line_item12: set["Online_Shopping_System_Line_item"] = None):
        self.status = status
        self.total = total
        self.Number = Number
