...
in_30: BinaryAssociation = BinaryAssociation(
    name="in_30",
    ends={
...
domain_model = DomainModel(
    name="EssentialOCL",
    types={EssentialOCL_BooleanLiteralExp, PrimitiveLiteralExp, EssentialOCL_CallExp, OclExpression, EssentialOCL_CollectionItem, CollectionLiteralPart, EssentialOCL_AnyType, EssentialOCL_CollectionType, EssentialOCL_BagType, CollectionType, EssentialOCL_EnumLiteralExp, EssentialOCL_ExpressionInOcl, Variable, EssentialOCL_CollectionLiteralExp, LiteralExp, EssentialOCL_CollectionLiteralPart, CollectionLiteralExp, EssentialOCL_CollectionRange, EssentialOCL_IntegerLiteralExp, NumericLiteralExp, EssentialOCL_InvalidLiteralExp, EssentialOCL_InvalidType, EssentialOCL_IterateExp, LoopExp, EssentialOCL_IteratorExp, EssentialOCL_LetExp, EssentialOCL_FeatureCallExp, CallExp, EssentialOCL_IfExp, EssentialOCL_OrderedSetType, EssentialOCL_PrimitiveLiteralExp, EssentialOCL_PropertyCallExp, NavigationCallExp, EssentialOCL_RealLiteralExp, EssentialOCL_SequenceType, EssentialOCL_SetType, EssentialOCL_StringLiteralExp, EssentialOCL_TemplateParameterType, EssentialOCL_LiteralExp, EssentialOCL_LoopExp, EssentialOCL_NavigationCallExp, FeatureCallExp, EssentialOCL_NullLiteralExp, EssentialOCL_NumericLiteralExp, EssentialOCL_OclExpression, EssentialOCL_OperationCallExp, EssentialOCL_TupleLiteralPart, TupleLiteralExp, EssentialOCL_TupleType, EssentialOCL_TypeExp, EssentialOCL_TupleLiteralExp, TupleLiteralPart, EssentialOCL_VoidType, EssentialOCL_UnlimitedNaturalExp, EssentialOCL_Variable, LetExp, EssentialOCL_VariableExp, CollectionKind},
    associations={source0, item1, bodyExpression10, contextVariable12, part3, collectionLiteralExp4, first5, last7, result28, in_30, variable32, parameterVariable14, resultVariable17, condition20, elseExpression22, thenExpression25, body35, iterator37, argument40, tupleLiteralExp43, value44, part42, initExpression47, letExp49, referredVariable51},
    generalizations={gen_EssentialOCL_BooleanLiteralExp_PrimitiveLiteralExp, gen_EssentialOCL_CallExp_OclExpression, gen_EssentialOCL_CollectionItem_CollectionLiteralPart, gen_EssentialOCL_BagType_CollectionType, gen_EssentialOCL_EnumLiteralExp_LiteralExp, gen_EssentialOCL_CollectionLiteralExp_LiteralExp, gen_EssentialOCL_CollectionRange_CollectionLiteralPart, gen_EssentialOCL_IntegerLiteralExp_NumericLiteralExp, gen_EssentialOCL_InvalidLiteralExp_LiteralExp, gen_EssentialOCL_IterateExp_LoopExp, gen_EssentialOCL_IteratorExp_LoopExp, gen_EssentialOCL_LetExp_OclExpression, gen_EssentialOCL_FeatureCallExp_CallExp, gen_EssentialOCL_IfExp_OclExpression, gen_EssentialOCL_OrderedSetType_CollectionType, gen_EssentialOCL_PrimitiveLiteralExp_LiteralExp, gen_EssentialOCL_PropertyCallExp_NavigationCallExp, gen_EssentialOCL_RealLiteralExp_NumericLiteralExp, gen_EssentialOCL_SequenceType_CollectionType, gen_EssentialOCL_SetType_CollectionType, gen_EssentialOCL_StringLiteralExp_PrimitiveLiteralExp, gen_EssentialOCL_LiteralExp_OclExpression, gen_EssentialOCL_LoopExp_CallExp, gen_EssentialOCL_LoopExp_OclExpression, gen_EssentialOCL_NavigationCallExp_FeatureCallExp, gen_EssentialOCL_NullLiteralExp_LiteralExp, gen_EssentialOCL_NumericLiteralExp_PrimitiveLiteralExp, gen_EssentialOCL_OperationCallExp_FeatureCallExp, gen_EssentialOCL_TypeExp_OclExpression, gen_EssentialOCL_TupleLiteralExp_LiteralExp, gen_EssentialOCL_UnlimitedNaturalExp_NumericLiteralExp, gen_EssentialOCL_VariableExp_OclExpression},
    metadata=None
)
