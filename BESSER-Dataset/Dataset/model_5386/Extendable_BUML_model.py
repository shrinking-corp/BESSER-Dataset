...
# Classes
p_append = Class(name="p_append")
p_ThisClassWasFirst = Class(name="p_ThisClassWasFirst")
p_ThisClassWasMiddle = Class(name="p_ThisClassWasMiddle")
p_ThisClassWasLast = Class(name="p_ThisClassWasLast")
