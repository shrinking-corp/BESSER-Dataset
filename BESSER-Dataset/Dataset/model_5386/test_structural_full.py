...
p_ThisClassWasFirst_strategy = st.builds(p_ThisClassWasFirst)
...
p_ThisClassWasLast_strategy = st.builds(p_ThisClassWasLast)
...
p_ThisClassWasMiddle_strategy = st.builds(p_ThisClassWasMiddle)
...
p_append_strategy = st.builds(p_append)
