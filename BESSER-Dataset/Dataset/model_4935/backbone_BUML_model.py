...
# Classes
backbone_Application = Class(name="backbone_Application")
NamedElement = Class(name="NamedElement")
backbone_Model = Class(name="backbone_Model")
backbone_Collection = Class(name="backbone_Collection")
backbone_Router = Class(name="backbone_Router")
backbone_View = Class(name="backbone_View")
backbone_NamedElement = Class(name="backbone_NamedElement", is_abstract=True)
backbone_Attribute = Class(name="backbone_Attribute")
backbone_Parameter = Class(name="backbone_Parameter")
backbone_RouterMapping = Class(name="backbone_RouterMapping")
backbone_Reference = Class(name="backbone_Reference")
backbone_Operation = Class(name="backbone_Operation")
...
domain_model = DomainModel(
    name="backbone",
    types={backbone_Application, NamedElement, backbone_Model, backbone_Collection, backbone_Router, backbone_View, backbone_NamedElement, backbone_Attribute, backbone_Parameter, backbone_RouterMapping, backbone_Reference, backbone_Operation, CardinalityKind},
    associations={models0, collections1, router3, views5, attributes7, type13, parameters16, model18, application20, mappings22, application23, view25, operations27, application30, references8, operations10, application12},
    generalizations={gen_backbone_Application_NamedElement, gen_backbone_Model_NamedElement, gen_backbone_Operation_NamedElement, gen_backbone_Parameter_NamedElement, gen_backbone_Collection_NamedElement, gen_backbone_Router_NamedElement, gen_backbone_View_NamedElement, gen_backbone_Attribute_NamedElement, gen_backbone_Reference_NamedElement},
    metadata=None
)
