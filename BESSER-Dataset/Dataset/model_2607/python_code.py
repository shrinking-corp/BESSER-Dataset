...
class Company_Project:
    ...
    def __init__(self, budget: int, name: str, Company_Project13: "Company_Category" = None, Company_Project: "Company_Person" = None, Company_Project7: "Company_Company" = None):
        self.budget = budget
        self.name = name
