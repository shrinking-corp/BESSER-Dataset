...
# Classes
emfrelations_ConceptA1 = Class(name="emfrelations_ConceptA1")
emfrelations_ConceptB1 = Class(name="emfrelations_ConceptB1")
emfrelations_ConceptA2 = Class(name="emfrelations_ConceptA2")
emfrelations_ConceptB2 = Class(name="emfrelations_ConceptB2")
emfrelations_ConceptA3 = Class(name="emfrelations_ConceptA3")
emfrelations_ConceptB3 = Class(name="emfrelations_ConceptB3")
emfrelations_ConceptA4 = Class(name="emfrelations_ConceptA4")
emfrelations_ConceptB4 = Class(name="emfrelations_ConceptB4")
emfrelations_ConceptA0 = Class(name="emfrelations_ConceptA0")
emfrelations_ConceptB0 = Class(name="emfrelations_ConceptB0")
emfrelations_ConceptA5 = Class(name="emfrelations_ConceptA5")
emfrelations_ConceptB5 = Class(name="emfrelations_ConceptB5")
emfrelations_ConceptA8 = Class(name="emfrelations_ConceptA8")
emfrelations_ConceptB8 = Class(name="emfrelations_ConceptB8")
emfrelations_ConceptA9 = Class(name="emfrelations_ConceptA9")
emfrelations_ConceptB9 = Class(name="emfrelations_ConceptB9")
emfrelations_ConceptA10 = Class(name="emfrelations_ConceptA10")
emfrelations_ConceptB10 = Class(name="emfrelations_ConceptB10")
emfrelations_ConceptA11 = Class(name="emfrelations_ConceptA11")
emfrelations_ConceptB11 = Class(name="emfrelations_ConceptB11")
...
domain_model = DomainModel(
    name="emfrelations",
    types={emfrelations_ConceptA1, emfrelations_ConceptB1, emfrelations_ConceptA2, emfrelations_ConceptB2, emfrelations_ConceptA3, emfrelations_ConceptB3, emfrelations_ConceptA4, emfrelations_ConceptB4, emfrelations_ConceptA0, emfrelations_ConceptB0, emfrelations_ConceptA5, emfrelations_ConceptB5, emfrelations_ConceptA8, emfrelations_ConceptB8, emfrelations_ConceptA9, emfrelations_ConceptB9, emfrelations_ConceptA10, emfrelations_ConceptB10, emfrelations_ConceptA11, emfrelations_ConceptB11},
    associations={conceptb12, concepta13, conceptb24, concepta25, conceptb36, concepta37, conceptb00, concepta01, conceptb48, concepta49, conceptb510, concepta511, conceptb812, conceptb913, conceptb1014, conceptb1115},
    generalizations={},
    metadata=None
)
