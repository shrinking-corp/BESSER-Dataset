...
# Classes
DiagonosticModel_TestSpecification = Class(name="DiagonosticModel_TestSpecification")
DiagonosticModel_TestGroup = Class(name="DiagonosticModel_TestGroup")
DiagonosticModel_CAPLTestCase = Class(name="DiagonosticModel_CAPLTestCase")
DiagonosticModel_Variant = Class(name="DiagonosticModel_Variant")
DiagonosticModel_ImportArtifact = Class(name="DiagonosticModel_ImportArtifact")
DiagonosticModel_TestCase = Class(name="DiagonosticModel_TestCase")
DiagonosticModel_ExternalReference = Class(name="DiagonosticModel_ExternalReference")
DiagonosticModel_TestStep = Class(name="DiagonosticModel_TestStep", is_abstract=True)
DiagonosticModel_TracebilityArtifact = Class(name="DiagonosticModel_TracebilityArtifact")
DiagonosticModel_SignalType = Class(name="DiagonosticModel_SignalType")
DiagonosticModel_WaitAction = Class(name="DiagonosticModel_WaitAction")
Action = Class(name="Action")
DiagonosticModel_CheckAction = Class(name="DiagonosticModel_CheckAction")
DiagonosticModel_SetAction = Class(name="DiagonosticModel_SetAction")
DiagonosticModel_DiagnosticService = Class(name="DiagonosticModel_DiagnosticService")
DiagonosticModel_DiagnosticRequest = Class(name="DiagonosticModel_DiagnosticRequest")
DiagonosticModel_DiagnosticResponse = Class(name="DiagonosticModel_DiagnosticResponse")
DiagonosticModel_CAPLParam = Class(name="DiagonosticModel_CAPLParam")
DiagonosticModel_CAPLTestStep = Class(name="DiagonosticModel_CAPLTestStep")
DiagonosticModel_DiagnosticParam = Class(name="DiagonosticModel_DiagnosticParam")
DiagonosticModel_DiagnosticParamValueType = Class(name="DiagonosticModel_DiagnosticParamValueType", is_abstract=True)
DiagonosticModel_Action = Class(name="DiagonosticModel_Action", is_abstract=True)
TestStep = Class(name="TestStep")
DiagonosticModel_BlockAction = Class(name="DiagonosticModel_BlockAction")
DiagonosticModel_ForLoop = Class(name="DiagonosticModel_ForLoop")
BlockAction = Class(name="BlockAction")
DiagonosticModel_WhileLoop = Class(name="DiagonosticModel_WhileLoop")
DiagonosticModel_Var = Class(name="DiagonosticModel_Var")
DiagnosticParamValueType = Class(name="DiagnosticParamValueType")
DiagonosticModel_OneOf = Class(name="DiagonosticModel_OneOf")
DiagonosticModel_Range = Class(name="DiagonosticModel_Range")
...
DiagonosticModel_TestSpecification.attributes={DiagonosticModel_TestSpecification_version, DiagonosticModel_TestSpecification_functionVersion, DiagonosticModel_TestSpecification_author, DiagonosticModel_TestSpecification_description, DiagonosticModel_TestSpecification_functionName, DiagonosticModel_TestSpecification_name}
...
DiagonosticModel_TestCase.attributes={DiagonosticModel_TestCase_skip, DiagonosticModel_TestCase_executionStatus, DiagonosticModel_TestCase_id, DiagonosticModel_TestCase_requirementID, DiagonosticModel_TestCase_description, DiagonosticModel_TestCase_name}
...
DiagonosticModel_ExternalReference.attributes={DiagonosticModel_ExternalReference_type, DiagonosticModel_ExternalReference_title, DiagonosticModel_ExternalReference_url, DiagonosticModel_ExternalReference_owner}
...
DiagonosticModel_SignalType.attributes={DiagonosticModel_SignalType_creationMode, DiagonosticModel_SignalType_MessageName, DiagonosticModel_SignalType_namespace, DiagonosticModel_SignalType_lookupValues, DiagonosticModel_SignalType_node, DiagonosticModel_SignalType_name, DiagonosticModel_SignalType_type}
...
DiagonosticModel_DiagnosticService.attributes={DiagonosticModel_DiagnosticService_service, DiagonosticModel_DiagnosticService_result, DiagonosticModel_DiagnosticService_ecu}
...
DiagonosticModel_CAPLParam.attributes={DiagonosticModel_CAPLParam_type, DiagonosticModel_CAPLParam_value, DiagonosticModel_CAPLParam_name}
...
DiagonosticModel_Action.attributes={DiagonosticModel_Action_wait, DiagonosticModel_Action_valueTo, DiagonosticModel_Action_value}
...
DiagonosticModel_ForLoop.attributes={DiagonosticModel_ForLoop_loopVar, DiagonosticModel_ForLoop_stopValue, DiagonosticModel_ForLoop_startValue}
...
DiagonosticModel_WhileLoop.attributes={DiagonosticModel_WhileLoop_value, DiagonosticModel_WhileLoop_valueTo, DiagonosticModel_WhileLoop_operator}
...
DiagonosticModel_Range_from_: Property = Property(name="from_", type=IntegerType)
DiagonosticModel_Range_to: Property = Property(name="to", type=IntegerType)
DiagonosticModel_Range.attributes={DiagonosticModel_Range_from_, DiagonosticModel_Range_to}
...
domain_model = DomainModel(
    ...
    types={DiagonosticModel_TestSpecification, DiagonosticModel_TestGroup, DiagonosticModel_CAPLTestCase, DiagonosticModel_Variant, DiagonosticModel_ImportArtifact, DiagonosticModel_TestCase, DiagonosticModel_ExternalReference, DiagonosticModel_TestStep, DiagonosticModel_TracebilityArtifact, DiagonosticModel_SignalType, DiagonosticModel_WaitAction, Action, DiagonosticModel_CheckAction, DiagonosticModel_SetAction, DiagonosticModel_DiagnosticService, DiagonosticModel_DiagnosticRequest, DiagonosticModel_DiagnosticResponse, DiagonosticModel_CAPLParam, DiagonosticModel_CAPLTestStep, DiagonosticModel_DiagnosticParam, DiagonosticModel_DiagnosticParamValueType, DiagonosticModel_Action, TestStep, DiagonosticModel_BlockAction, DiagonosticModel_ForLoop, BlockAction, DiagonosticModel_WhileLoop, DiagonosticModel_Var, DiagnosticParamValueType, DiagonosticModel_OneOf, DiagonosticModel_Range, OperatorTypeEnum, SignalTypeEnum, ExecutionStatueTypeEnum, CreationModeEnum, TraceabilityArtifactEnum},
    associations={testGroups0, variants3, importArtifacts5, testCases7, externalreference9, testGroups12, capltestcases14, testSteps17, variants19, preConditions22, postConditions25, capltestcases1, externalreference28, traceabilityArtifacts31, nextStep34, key36, diagrequest38, diagresponse39, parameters41, parameters43, signalType45, diagparam48, diagparam50, valueTypes53, testSteps55},
    generalizations={gen_DiagonosticModel_WaitAction_Action, gen_DiagonosticModel_CheckAction_Action, gen_DiagonosticModel_SetAction_Action, gen_DiagonosticModel_DiagnosticService_Action, gen_DiagonosticModel_CAPLTestStep_Action, gen_DiagonosticModel_Action_TestStep, gen_DiagonosticModel_BlockAction_TestStep, gen_DiagonosticModel_ForLoop_BlockAction, gen_DiagonosticModel_WhileLoop_BlockAction, gen_DiagonosticModel_Var_DiagnosticParamValueType, gen_DiagonosticModel_OneOf_DiagnosticParamValueType, gen_DiagonosticModel_Range_DiagnosticParamValueType},
    metadata=None
)
