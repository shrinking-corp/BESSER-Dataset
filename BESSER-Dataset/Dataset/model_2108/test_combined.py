...
def test_hyp_diagnosticparamvaluetype_is_not_abstract():
    assert not inspect.isabstract(DiagnosticParamValueType)


def test_hyp_diagnosticparamvaluetype_constructor_exists():
    assert callable(DiagnosticParamValueType.__init__)


def test_hyp_diagnosticparamvaluetype_constructor_args():
    sig = inspect.signature(DiagnosticParamValueType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_diagonosticmodel_oneof_is_not_abstract():
    assert not inspect.isabstract(DiagonosticModel_OneOf)


def test_hyp_diagonosticmodel_oneof_constructor_exists():
    assert callable(DiagonosticModel_OneOf.__init__)


def test_hyp_diagonosticmodel_oneof_constructor_args():
...
def test_hyp_diagonosticmodel_range_is_not_abstract():
    assert not inspect.isabstract(DiagonosticModel_Range)


def test_hyp_diagonosticmodel_range_constructor_exists():
    assert callable(DiagonosticModel_Range.__init__)


def test_hyp_diagonosticmodel_range_constructor_args():
...
def test_hyp_diagonosticmodel_var_is_not_abstract():
    assert not inspect.isabstract(DiagonosticModel_Var)


def test_hyp_diagonosticmodel_var_constructor_exists():
    assert callable(DiagonosticModel_Var.__init__)


def test_hyp_diagonosticmodel_var_constructor_args():
...
def test_hyp_blockaction_is_not_abstract():
    assert not inspect.isabstract(BlockAction)


def test_hyp_blockaction_constructor_exists():
    assert callable(BlockAction.__init__)


def test_hyp_blockaction_constructor_args():
    sig = inspect.signature(BlockAction.__init__)
    params = list(sig.parameters.keys())



def test_hyp_diagonosticmodel_whileloop_is_not_abstract():
    assert not inspect.isabstract(DiagonosticModel_WhileLoop)


def test_hyp_diagonosticmodel_whileloop_constructor_exists():
    assert callable(DiagonosticModel_WhileLoop.__init__)


def test_hyp_diagonosticmodel_whileloop_constructor_args():
...
def test_hyp_diagonosticmodel_forloop_is_not_abstract():
    assert not inspect.isabstract(DiagonosticModel_ForLoop)


def test_hyp_diagonosticmodel_forloop_constructor_exists():
    assert callable(DiagonosticModel_ForLoop.__init__)


def test_hyp_diagonosticmodel_forloop_constructor_args():
...
def test_hyp_diagonosticmodel_blockaction_is_not_abstract():
    assert not inspect.isabstract(DiagonosticModel_BlockAction)


def test_hyp_diagonosticmodel_blockaction_constructor_exists():
    assert callable(DiagonosticModel_BlockAction.__init__)


def test_hyp_diagonosticmodel_blockaction_constructor_args():
    sig = inspect.signature(DiagonosticModel_BlockAction.__init__)
    params = list(sig.parameters.keys())



def test_hyp_diagonosticmodel_action_is_not_abstract():
    assert not inspect.isabstract(DiagonosticModel_Action)


def test_hyp_diagonosticmodel_action_constructor_exists():
    assert callable(DiagonosticModel_Action.__init__)


def test_hyp_diagonosticmodel_action_constructor_args():
...
def test_hyp_diagonosticmodel_diagnosticparamvaluetype_is_not_abstract():
    assert not inspect.isabstract(DiagonosticModel_DiagnosticParamValueType)


def test_hyp_diagonosticmodel_diagnosticparamvaluetype_constructor_exists():
    assert callable(DiagonosticModel_DiagnosticParamValueType.__init__)


def test_hyp_diagonosticmodel_diagnosticparamvaluetype_constructor_args():
    sig = inspect.signature(DiagonosticModel_DiagnosticParamValueType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_diagonosticmodel_diagnosticparam_is_not_abstract():
    assert not inspect.isabstract(DiagonosticModel_DiagnosticParam)


def test_hyp_diagonosticmodel_diagnosticparam_constructor_exists():
    assert callable(DiagonosticModel_DiagnosticParam.__init__)


def test_hyp_diagonosticmodel_diagnosticparam_constructor_args():
...
def test_hyp_diagonosticmodel_caplparam_is_not_abstract():
    assert not inspect.isabstract(DiagonosticModel_CAPLParam)


def test_hyp_diagonosticmodel_caplparam_constructor_exists():
    assert callable(DiagonosticModel_CAPLParam.__init__)


def test_hyp_diagonosticmodel_caplparam_constructor_args():
...
def test_hyp_diagonosticmodel_diagnosticresponse_is_not_abstract():
    assert not inspect.isabstract(DiagonosticModel_DiagnosticResponse)


def test_hyp_diagonosticmodel_diagnosticresponse_constructor_exists():
    assert callable(DiagonosticModel_DiagnosticResponse.__init__)


def test_hyp_diagonosticmodel_diagnosticresponse_constructor_args():
...
def test_hyp_diagonosticmodel_diagnosticrequest_is_not_abstract():
    assert not inspect.isabstract(DiagonosticModel_DiagnosticRequest)


def test_hyp_diagonosticmodel_diagnosticrequest_constructor_exists():
    assert callable(DiagonosticModel_DiagnosticRequest.__init__)


def test_hyp_diagonosticmodel_diagnosticrequest_constructor_args():
...
def test_hyp_diagonosticmodel_checkaction_is_not_abstract():
    assert not inspect.isabstract(DiagonosticModel_CheckAction)


def test_hyp_diagonosticmodel_checkaction_constructor_exists():
    assert callable(DiagonosticModel_CheckAction.__init__)


def test_hyp_diagonosticmodel_checkaction_constructor_args():
...
def test_hyp_diagonosticmodel_caplteststep_is_not_abstract():
    assert not inspect.isabstract(DiagonosticModel_CAPLTestStep)


def test_hyp_diagonosticmodel_caplteststep_constructor_exists():
    assert callable(DiagonosticModel_CAPLTestStep.__init__)


def test_hyp_diagonosticmodel_caplteststep_constructor_args():
    sig = inspect.signature(DiagonosticModel_CAPLTestStep.__init__)
    params = list(sig.parameters.keys())



def test_hyp_diagonosticmodel_setaction_is_not_abstract():
    assert not inspect.isabstract(DiagonosticModel_SetAction)


def test_hyp_diagonosticmodel_setaction_constructor_exists():
    assert callable(DiagonosticModel_SetAction.__init__)


def test_hyp_diagonosticmodel_setaction_constructor_args():
    sig = inspect.signature(DiagonosticModel_SetAction.__init__)
    params = list(sig.parameters.keys())



def test_hyp_diagonosticmodel_diagnosticservice_is_not_abstract():
    assert not inspect.isabstract(DiagonosticModel_DiagnosticService)


def test_hyp_diagonosticmodel_diagnosticservice_constructor_exists():
    assert callable(DiagonosticModel_DiagnosticService.__init__)


def test_hyp_diagonosticmodel_diagnosticservice_constructor_args():
...
def test_hyp_diagonosticmodel_waitaction_is_not_abstract():
    assert not inspect.isabstract(DiagonosticModel_WaitAction)


def test_hyp_diagonosticmodel_waitaction_constructor_exists():
    assert callable(DiagonosticModel_WaitAction.__init__)


def test_hyp_diagonosticmodel_waitaction_constructor_args():
    sig = inspect.signature(DiagonosticModel_WaitAction.__init__)
    params = list(sig.parameters.keys())



def test_hyp_diagonosticmodel_signaltype_is_not_abstract():
    assert not inspect.isabstract(DiagonosticModel_SignalType)


def test_hyp_diagonosticmodel_signaltype_constructor_exists():
    assert callable(DiagonosticModel_SignalType.__init__)


def test_hyp_diagonosticmodel_signaltype_constructor_args():
...
def test_hyp_diagonosticmodel_tracebilityartifact_is_not_abstract():
    assert not inspect.isabstract(DiagonosticModel_TracebilityArtifact)


def test_hyp_diagonosticmodel_tracebilityartifact_constructor_exists():
    assert callable(DiagonosticModel_TracebilityArtifact.__init__)


def test_hyp_diagonosticmodel_tracebilityartifact_constructor_args():
...
def test_hyp_diagonosticmodel_teststep_is_not_abstract():
    assert not inspect.isabstract(DiagonosticModel_TestStep)


def test_hyp_diagonosticmodel_teststep_constructor_exists():
    assert callable(DiagonosticModel_TestStep.__init__)


def test_hyp_diagonosticmodel_teststep_constructor_args():
...
def test_hyp_diagonosticmodel_externalreference_is_not_abstract():
    assert not inspect.isabstract(DiagonosticModel_ExternalReference)


def test_hyp_diagonosticmodel_externalreference_constructor_exists():
    assert callable(DiagonosticModel_ExternalReference.__init__)


def test_hyp_diagonosticmodel_externalreference_constructor_args():
...
def test_hyp_diagonosticmodel_testcase_is_not_abstract():
    assert not inspect.isabstract(DiagonosticModel_TestCase)


def test_hyp_diagonosticmodel_testcase_constructor_exists():
    assert callable(DiagonosticModel_TestCase.__init__)


def test_hyp_diagonosticmodel_testcase_constructor_args():
...
def test_hyp_diagonosticmodel_importartifact_is_not_abstract():
    assert not inspect.isabstract(DiagonosticModel_ImportArtifact)


def test_hyp_diagonosticmodel_importartifact_constructor_exists():
    assert callable(DiagonosticModel_ImportArtifact.__init__)


def test_hyp_diagonosticmodel_importartifact_constructor_args():
...
def test_hyp_diagonosticmodel_variant_is_not_abstract():
    assert not inspect.isabstract(DiagonosticModel_Variant)


def test_hyp_diagonosticmodel_variant_constructor_exists():
    assert callable(DiagonosticModel_Variant.__init__)


def test_hyp_diagonosticmodel_variant_constructor_args():
...
def test_hyp_diagonosticmodel_capltestcase_is_not_abstract():
    assert not inspect.isabstract(DiagonosticModel_CAPLTestCase)


def test_hyp_diagonosticmodel_capltestcase_constructor_exists():
    assert callable(DiagonosticModel_CAPLTestCase.__init__)


def test_hyp_diagonosticmodel_capltestcase_constructor_args():
...
def test_hyp_diagonosticmodel_testgroup_is_not_abstract():
    assert not inspect.isabstract(DiagonosticModel_TestGroup)


def test_hyp_diagonosticmodel_testgroup_constructor_exists():
    assert callable(DiagonosticModel_TestGroup.__init__)


def test_hyp_diagonosticmodel_testgroup_constructor_args():
...
def test_hyp_diagonosticmodel_testspecification_is_not_abstract():
    assert not inspect.isabstract(DiagonosticModel_TestSpecification)


def test_hyp_diagonosticmodel_testspecification_constructor_exists():
    assert callable(DiagonosticModel_TestSpecification.__init__)


def test_hyp_diagonosticmodel_testspecification_constructor_args():
...
def test_hyp_signaltypeenum_exists():
    # Check that the Enumeration exists
    assert SignalTypeEnum is not None

def test_hyp_signaltypeenum_has_all_literals():
...
def test_hyp_executionstatuetypeenum_exists():
    # Check that the Enumeration exists
    assert ExecutionStatueTypeEnum is not None

def test_hyp_executionstatuetypeenum_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_creationmodeenum_exists():
    # Check that the Enumeration exists
    assert CreationModeEnum is not None

def test_hyp_creationmodeenum_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_operatortypeenum_exists():
    # Check that the Enumeration exists
    assert OperatorTypeEnum is not None

def test_hyp_operatortypeenum_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_traceabilityartifactenum_exists():
    # Check that the Enumeration exists
    assert TraceabilityArtifactEnum is not None

def test_hyp_traceabilityartifactenum_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_diagonosticmodel_oneof_values_setter(instance):
...
def test_hyp_diagonosticmodel_range_from__setter(instance):
...
@given(instance=DiagonosticModel_Range_strategy)
def test_hyp_diagonosticmodel_range_to_setter(instance):
...
def test_hyp_diagonosticmodel_var_name_setter(instance):
...
def test_hyp_diagonosticmodel_whileloop_value_setter(instance):
...
@given(instance=DiagonosticModel_WhileLoop_strategy)
def test_hyp_diagonosticmodel_whileloop_operator_setter(instance):
...
@given(instance=DiagonosticModel_WhileLoop_strategy)
def test_hyp_diagonosticmodel_whileloop_valueTo_setter(instance):
...
def test_hyp_diagonosticmodel_forloop_stopValue_setter(instance):
...
@given(instance=DiagonosticModel_ForLoop_strategy)
def test_hyp_diagonosticmodel_forloop_loopVar_setter(instance):
...
@given(instance=DiagonosticModel_ForLoop_strategy)
def test_hyp_diagonosticmodel_forloop_startValue_setter(instance):
...
def test_hyp_diagonosticmodel_action_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
@given(instance=DiagonosticModel_Action_strategy)
def test_hyp_diagonosticmodel_action_valueTo_setter(instance):
    original = instance.valueTo
    instance.valueTo = original
    assert instance.valueTo == original
...
@given(instance=DiagonosticModel_Action_strategy)
def test_hyp_diagonosticmodel_action_wait_setter(instance):
...
def test_hyp_diagonosticmodel_diagnosticparam_qualifier_setter(instance):
...
@given(instance=DiagonosticModel_DiagnosticParam_strategy)
def test_hyp_diagonosticmodel_diagnosticparam_copyToVar_setter(instance):
...
def test_hyp_diagonosticmodel_caplparam_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=DiagonosticModel_CAPLParam_strategy)
def test_hyp_diagonosticmodel_caplparam_type_setter(instance):
...
@given(instance=DiagonosticModel_CAPLParam_strategy)
def test_hyp_diagonosticmodel_caplparam_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_diagonosticmodel_diagnosticresponse_primitive_setter(instance):
...
def test_hyp_diagonosticmodel_checkaction_operator_setter(instance):
    original = instance.operator
    instance.operator = original
    assert instance.operator == original
...
def test_hyp_diagonosticmodel_diagnosticservice_service_setter(instance):
...
@given(instance=DiagonosticModel_DiagnosticService_strategy)
def test_hyp_diagonosticmodel_diagnosticservice_ecu_setter(instance):
...
@given(instance=DiagonosticModel_DiagnosticService_strategy)
def test_hyp_diagonosticmodel_diagnosticservice_result_setter(instance):
...
def test_hyp_diagonosticmodel_signaltype_lookupValues_setter(instance):
...
@given(instance=DiagonosticModel_SignalType_strategy)
def test_hyp_diagonosticmodel_signaltype_node_setter(instance):
...
@given(instance=DiagonosticModel_SignalType_strategy)
def test_hyp_diagonosticmodel_signaltype_namespace_setter(instance):
...
@given(instance=DiagonosticModel_SignalType_strategy)
def test_hyp_diagonosticmodel_signaltype_MessageName_setter(instance):
...
@given(instance=DiagonosticModel_SignalType_strategy)
def test_hyp_diagonosticmodel_signaltype_creationMode_setter(instance):
...
@given(instance=DiagonosticModel_SignalType_strategy)
def test_hyp_diagonosticmodel_signaltype_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=DiagonosticModel_SignalType_strategy)
def test_hyp_diagonosticmodel_signaltype_type_setter(instance):
    original = instance.type
    instance.type = original
    assert instance.type == original
...
def test_hyp_diagonosticmodel_tracebilityartifact_url_setter(instance):
...
@given(instance=DiagonosticModel_TracebilityArtifact_strategy)
def test_hyp_diagonosticmodel_tracebilityartifact_type_setter(instance):
    original = instance.type
    instance.type = original
    assert instance.type == original
...
def test_hyp_diagonosticmodel_teststep_title_setter(instance):
...
def test_hyp_diagonosticmodel_externalreference_title_setter(instance):
    original = instance.title
    instance.title = original
    assert instance.title == original
...
@given(instance=DiagonosticModel_ExternalReference_strategy)
def test_hyp_diagonosticmodel_externalreference_type_setter(instance):
    original = instance.type
    instance.type = original
    assert instance.type == original
...
@given(instance=DiagonosticModel_ExternalReference_strategy)
def test_hyp_diagonosticmodel_externalreference_owner_setter(instance):
...
@given(instance=DiagonosticModel_ExternalReference_strategy)
def test_hyp_diagonosticmodel_externalreference_url_setter(instance):
    original = instance.url
    instance.url = original
    assert instance.url == original
...
def test_hyp_diagonosticmodel_testcase_description_setter(instance):
...
@given(instance=DiagonosticModel_TestCase_strategy)
def test_hyp_diagonosticmodel_testcase_id_setter(instance):
...
@given(instance=DiagonosticModel_TestCase_strategy)
def test_hyp_diagonosticmodel_testcase_skip_setter(instance):
...
@given(instance=DiagonosticModel_TestCase_strategy)
def test_hyp_diagonosticmodel_testcase_requirementID_setter(instance):
...
@given(instance=DiagonosticModel_TestCase_strategy)
def test_hyp_diagonosticmodel_testcase_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=DiagonosticModel_TestCase_strategy)
def test_hyp_diagonosticmodel_testcase_executionStatus_setter(instance):
...
def test_hyp_diagonosticmodel_importartifact_path_setter(instance):
...
def test_hyp_diagonosticmodel_variant_description_setter(instance):
    original = instance.description
    instance.description = original
    assert instance.description == original
...
@given(instance=DiagonosticModel_Variant_strategy)
def test_hyp_diagonosticmodel_variant_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_diagonosticmodel_capltestcase_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_diagonosticmodel_testgroup_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=DiagonosticModel_TestGroup_strategy)
def test_hyp_diagonosticmodel_testgroup_description_setter(instance):
    original = instance.description
    instance.description = original
    assert instance.description == original
...
def test_hyp_diagonosticmodel_testspecification_functionVersion_setter(instance):
...
@given(instance=DiagonosticModel_TestSpecification_strategy)
def test_hyp_diagonosticmodel_testspecification_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=DiagonosticModel_TestSpecification_strategy)
def test_hyp_diagonosticmodel_testspecification_functionName_setter(instance):
...
@given(instance=DiagonosticModel_TestSpecification_strategy)
def test_hyp_diagonosticmodel_testspecification_author_setter(instance):
...
@given(instance=DiagonosticModel_TestSpecification_strategy)
def test_hyp_diagonosticmodel_testspecification_description_setter(instance):
    original = instance.description
    instance.description = original
    assert instance.description == original
...
@given(instance=DiagonosticModel_TestSpecification_strategy)
def test_hyp_diagonosticmodel_testspecification_version_setter(instance):
