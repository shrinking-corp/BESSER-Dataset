...
class DiagonosticModel_DiagnosticParam:
    ...
    def __init__(self, qualifier: str, copyToVar: str, DiagonosticModel_DiagnosticParam: "DiagonosticModel_DiagnosticRequest" = None, DiagonosticModel_DiagnosticParam52: "DiagonosticModel_DiagnosticResponse" = None, DiagonosticModel_DiagnosticParam54: "DiagonosticModel_DiagnosticParamValueType" = None):
...
class DiagonosticModel_DiagnosticService(Action):
    ...
    def __init__(self, ecu: str, service: str, result: str, DiagonosticModel_DiagnosticService: "DiagonosticModel_DiagnosticRequest" = None, DiagonosticModel_DiagnosticService40: "DiagonosticModel_DiagnosticResponse" = None):
        self.ecu = ecu
...
class DiagonosticModel_TestStep(ABC):
    ...
    def __init__(self, title: str, DiagonosticModel_TestStep: "DiagonosticModel_TestCase" = None, DiagonosticModel_TestStep24: "DiagonosticModel_TestCase" = None, DiagonosticModel_TestStep27: "DiagonosticModel_TestCase" = None, DiagonosticModel_TestStep35: "DiagonosticModel_TestStep" = None, DiagonosticModel_TestStep33: "DiagonosticModel_TestStep" = None, DiagonosticModel_TestStep37: "DiagonosticModel_SignalType" = None, DiagonosticModel_TestStep56: "DiagonosticModel_BlockAction" = None):
        self.title = title
...
class DiagonosticModel_TestCase:
    ...
    def __init__(self, name: str, id: str, description: str, skip: bool, requirementID: str, executionStatus: str, DiagonosticModel_TestCase: "DiagonosticModel_TestGroup" = None, DiagonosticModel_TestCase18: set["DiagonosticModel_TestStep"] = None, DiagonosticModel_TestCase20: set["DiagonosticModel_Variant"] = None, DiagonosticModel_TestCase23: set["DiagonosticModel_TestStep"] = None, DiagonosticModel_TestCase26: set["DiagonosticModel_TestStep"] = None, DiagonosticModel_TestCase29: "DiagonosticModel_ExternalReference" = None, DiagonosticModel_TestCase32: set["DiagonosticModel_TracebilityArtifact"] = None):
        self.name = name
        self.id = id
...
class DiagonosticModel_TestSpecification:
    ...
    def __init__(self, name: str, version: str, description: str, functionName: str, functionVersion: str, author: str, DiagonosticModel_TestSpecification: set["DiagonosticModel_TestGroup"] = None, DiagonosticModel_TestSpecification4: set["DiagonosticModel_Variant"] = None, DiagonosticModel_TestSpecification6: set["DiagonosticModel_ImportArtifact"] = None, DiagonosticModel_TestSpecification2: set["DiagonosticModel_CAPLTestCase"] = None):
        self.name = name
