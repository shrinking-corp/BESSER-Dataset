...
petrinet_PetriNetElement = Class(name="petrinet_PetriNetElement", is_abstract=True)
...
petrinet_Arc.attributes={petrinet_Arc_readOnly, petrinet_Arc_multiplicity}
...
domain_model = DomainModel(
    name="petrinet",
    types={petrinet_PetriNet, petrinet_PetriNetElement, petrinet_Node, PetriNetElement, petrinet_Arc, petrinet_Transition, petrinet_Place, Node},
    associations={petriNetElements0, petriNet1, linksToSuccessor2, linksToPredecessor3, predecessor5, successor6},
    generalizations={gen_petrinet_Node_PetriNetElement, gen_petrinet_Transition_Node, gen_petrinet_Arc_PetriNetElement, gen_petrinet_Place_Node},
    metadata=None
)
