...
class stext_LogicalRelationExpression(Expression):
    ...
    def __init__(self, operator: str, stext_LogicalRelationExpression67: "stext_Expression" = None, stext_LogicalRelationExpression: "stext_Expression" = None):
...
class stext_TimeEventSpec(EventSpec):
    ...
    def __init__(self, unit: str, type: str, stext_TimeEventSpec: "stext_Expression" = None):
        self.unit = unit
        self.type = type
