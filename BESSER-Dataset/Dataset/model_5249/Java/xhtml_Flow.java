...
public class xhtml_Flow  {
    ...
    public xhtml_Flow(
        String group,        String mixed        ArrayList<xhtml_HrType> xhtml_hrtypes,        ArrayList<xhtml_BType> xhtml_btypes,        ArrayList<xhtml_UType> xhtml_utypes,        ArrayList<xhtml_BrType> xhtml_brtypes,        ArrayList<xhtml_AcronymType> xhtml_acronymtypes,        ArrayList<xhtml_TableType> xhtml_tabletypes,        ArrayList<xhtml_VarType> xhtml_vartypes,        ArrayList<xhtml_CodeType> xhtml_codetypes,        ArrayList<xhtml_PreType> xhtml_pretypes,        ArrayList<xhtml_SpanType> xhtml_spantypes,        ArrayList<xhtml_H3Type> xhtml_h3types,        ArrayList<xhtml_H1Type> xhtml_h1types,        ArrayList<xhtml_OlType> xhtml_oltypes,        ArrayList<xhtml_BlockquoteType> xhtml_blockquotetypes,        ArrayList<xhtml_BigType> xhtml_bigtypes,        ArrayList<xhtml_SubType> xhtml_subtypes,        ArrayList<xhtml_InsType> xhtml_instypes,        ArrayList<xhtml_QType> xhtml_qtypes,        ArrayList<xhtml_H6Type> xhtml_h6types,        ArrayList<xhtml_ObjectType> xhtml_objecttypes,        ArrayList<xhtml_StrongType> xhtml_strongtypes,        ArrayList<xhtml_AddressType> xhtml_addresstypes,        ArrayList<xhtml_DivType> xhtml_divtypes,        ArrayList<xhtml_UlType> xhtml_ultypes,        ArrayList<xhtml_H2Type> xhtml_h2types,        ArrayList<xhtml_StrikeType> xhtml_striketypes,        ArrayList<xhtml_AType> xhtml_atypes,        ArrayList<xhtml_SupType> xhtml_suptypes,        ArrayList<xhtml_SampType> xhtml_samptypes,        ArrayList<xhtml_CiteType> xhtml_citetypes,        ArrayList<xhtml_DlType> xhtml_dltypes,        ArrayList<xhtml_ImgType> xhtml_imgtypes,        ArrayList<xhtml_DfnType> xhtml_dfntypes,        ArrayList<xhtml_IType> xhtml_itypes,        ArrayList<xhtml_PType> xhtml_ptypes,        ArrayList<xhtml_DelType> xhtml_deltypes,        ArrayList<xhtml_AbbrType> xhtml_abbrtypes,        ArrayList<xhtml_KbdType> xhtml_kbdtypes,        ArrayList<xhtml_H4Type> xhtml_h4types,        ArrayList<xhtml_H5Type> xhtml_h5types,        ArrayList<xhtml_TtType> xhtml_tttypes,        ArrayList<xhtml_EmType> xhtml_emtypes,        ArrayList<xhtml_SmallType> xhtml_smalltypes    ) {
        this.group = group;
        this.mixed = mixed;
