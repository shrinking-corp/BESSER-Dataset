...
public class xhtml_DocumentRoot  {
    ...
    private List<xhtml_CaptionType> xhtml_captiontypes;
    ...
    private List<xhtml_ColType> xhtml_coltypes;
    ...
    private List<xhtml_ColgroupType> xhtml_colgrouptypes;
    ...
    private List<xhtml_BodyType> xhtml_bodytypes;
    ...
    public xhtml_DocumentRoot(
        ...
        this.xhtml_captiontypes = new ArrayList<>();
        ...
        this.xhtml_coltypes = new ArrayList<>();
    ...
    public xhtml_DocumentRoot(
        String mixed        ArrayList<xhtml_TdType> xhtml_tdtypes,        ArrayList<xhtml_BType> xhtml_btypes,        ArrayList<xhtml_KbdType> xhtml_kbdtypes,        ArrayList<xhtml_H1Type> xhtml_h1types,        ArrayList<xhtml_AbbrType> xhtml_abbrtypes,        ArrayList<xhtml_AcronymType> xhtml_acronymtypes,        ArrayList<xhtml_AType> xhtml_atypes,        ArrayList<xhtml_DdType> xhtml_ddtypes,        ArrayList<xhtml_LiType> xhtml_litypes,        ArrayList<xhtml_H5Type> xhtml_h5types,        ArrayList<xhtml_H2Type> xhtml_h2types,        ArrayList<xhtml_UType> xhtml_utypes,        ArrayList<xhtml_CaptionType> xhtml_captiontypes,        ArrayList<xhtml_ObjectType> xhtml_objecttypes,        ArrayList<xhtml_ThType> xhtml_thtypes,        ArrayList<xhtml_BrType> xhtml_brtypes,        ArrayList<xhtml_SubType> xhtml_subtypes,        ArrayList<xhtml_DelType> xhtml_deltypes,        ArrayList<xhtml_H6Type> xhtml_h6types,        ArrayList<xhtml_SpanType> xhtml_spantypes,        ArrayList<xhtml_VarType> xhtml_vartypes,        ArrayList<xhtml_DivType> xhtml_divtypes,        ArrayList<xhtml_TtType> xhtml_tttypes,        ArrayList<xhtml_QType> xhtml_qtypes,        ArrayList<xhtml_ColType> xhtml_coltypes,        ArrayList<xhtml_SupType> xhtml_suptypes,        ArrayList<xhtml_AddressType> xhtml_addresstypes,        ArrayList<xhtml_CodeType> xhtml_codetypes,        ArrayList<xhtml_DfnType> xhtml_dfntypes,        ArrayList<xhtml_H3Type> xhtml_h3types,        ArrayList<xhtml_SampType> xhtml_samptypes,        ArrayList<xhtml_UlType> xhtml_ultypes,        ArrayList<xhtml_DlType> xhtml_dltypes,        ArrayList<xhtml_EmType> xhtml_emtypes,        ArrayList<xhtml_TableType> xhtml_tabletypes,        ArrayList<xhtml_DtType> xhtml_dttypes,        ArrayList<xhtml_ColgroupType> xhtml_colgrouptypes,        ArrayList<xhtml_HrType> xhtml_hrtypes,        ArrayList<xhtml_IType> xhtml_itypes,        ArrayList<xhtml_OlType> xhtml_oltypes,        ArrayList<xhtml_BodyType> xhtml_bodytypes,        ArrayList<xhtml_PType> xhtml_ptypes,        ArrayList<xhtml_CiteType> xhtml_citetypes,        ArrayList<xhtml_ImgType> xhtml_imgtypes,        ArrayList<xhtml_BigType> xhtml_bigtypes,        ArrayList<xhtml_StrongType> xhtml_strongtypes,        ArrayList<xhtml_InsType> xhtml_instypes,        ArrayList<xhtml_BlockquoteType> xhtml_blockquotetypes,        ArrayList<xhtml_StrikeType> xhtml_striketypes,        ArrayList<xhtml_SmallType> xhtml_smalltypes,        ArrayList<xhtml_PreType> xhtml_pretypes,        ArrayList<xhtml_H4Type> xhtml_h4types    ) {
        this.mixed = mixed;
        ...
        this.xhtml_captiontypes = xhtml_captiontypes;
        ...
        this.xhtml_coltypes = xhtml_coltypes;
    ...
    public List<xhtml_CaptionType> getXhtml_captiontypes() {
        return xhtml_captiontypes;
    }

    public void addXhtml_captiontype(Xhtml_captiontype xhtml_captiontype) {
        this.xhtml_captiontypes.add(xhtml_captiontype);
    }
    ...
    public List<xhtml_ColType> getXhtml_coltypes() {
        return xhtml_coltypes;
    }

    public void addXhtml_coltype(Xhtml_coltype xhtml_coltype) {
        this.xhtml_coltypes.add(xhtml_coltype);
    }
    ...
    public List<xhtml_ColgroupType> getXhtml_colgrouptypes() {
        return xhtml_colgrouptypes;
    }

    public void addXhtml_colgrouptype(Xhtml_colgrouptype xhtml_colgrouptype) {
        this.xhtml_colgrouptypes.add(xhtml_colgrouptype);
    }
    ...
    public List<xhtml_BodyType> getXhtml_bodytypes() {
        return xhtml_bodytypes;
    }

    public void addXhtml_bodytype(Xhtml_bodytype xhtml_bodytype) {
        this.xhtml_bodytypes.add(xhtml_bodytype);
    }
