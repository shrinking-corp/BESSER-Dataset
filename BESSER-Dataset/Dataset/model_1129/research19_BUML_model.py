...
# Classes
research19_Phase = Class(name="research19_Phase")
research19_Researcher = Class(name="research19_Researcher")
research19_Write = Class(name="research19_Write")
research19_Review = Class(name="research19_Review")
research19_Paper = Class(name="research19_Paper")
research19_PublicationProcess = Class(name="research19_PublicationProcess")
Named = Class(name="Named")
research19_ReviewNote = Class(name="research19_ReviewNote")
Labelled = Class(name="Labelled")
research19_Skill = Class(name="research19_Skill")
research19_Position = Class(name="research19_Position")
research19_Collaboration = Class(name="research19_Collaboration")
research19_Paragraph = Class(name="research19_Paragraph")
research19_Progress = Class(name="research19_Progress")
research19_PaperKeyword = Class(name="research19_PaperKeyword")
research19_State = Class(name="research19_State")
Counted = Class(name="Counted")
research19_PublicationSystem = Class(name="research19_PublicationSystem")
research19_PublicationStatus = Class(name="research19_PublicationStatus")
research19_Named = Class(name="research19_Named", is_abstract=True)
research19_Counted = Class(name="research19_Counted", is_abstract=True)
research19_Labelled = Class(name="research19_Labelled", is_abstract=True)
research19_PublicationStructure = Class(name="research19_PublicationStructure")
research19_KnowledgeManager = Class(name="research19_KnowledgeManager")
research19_StateMachineVariable = Class(name="research19_StateMachineVariable")
research19_Keyword = Class(name="research19_Keyword")
research19_StateMachineObject = Class(name="research19_StateMachineObject", is_abstract=True)
research19_Transition = Class(name="research19_Transition")
StateMachineObject = Class(name="StateMachineObject")
research19_Action = Class(name="research19_Action")
...
research19_PublicationProcess.attributes={research19_PublicationProcess_maxTime, research19_PublicationProcess_minTime}
...
research19_State.attributes={research19_State_id, research19_State_name, research19_State_kind}
...
domain_model = DomainModel(
    name="research19",
    types={research19_Phase, research19_Researcher, research19_Write, research19_Review, research19_Paper, research19_PublicationProcess, Named, research19_ReviewNote, Labelled, research19_Skill, research19_Position, research19_Collaboration, research19_Paragraph, research19_Progress, research19_PaperKeyword, research19_State, Counted, research19_PublicationSystem, research19_PublicationStatus, research19_Named, research19_Counted, research19_Labelled, research19_PublicationStructure, research19_KnowledgeManager, research19_StateMachineVariable, research19_Keyword, research19_StateMachineObject, research19_Transition, StateMachineObject, research19_Action, StateType},
    associations={phases0, writes1, reviews2, reviews21, process23, paper25, res_papers4, skills5, res_position7, collaborations9, paragraphs11, progress12, authors13, keywords14, citedBy17, state19, processView40, structuralView42, positions45, behaviorView48, paragraph27, reviewNote30, researchers33, papers35, knowledgeMan38, keyword58, col_paper61, machineVariables64, pubStates66, parent51, kpapers53, allkeywords55, next83, t_actions69, source70, target73, transitions76, s_actions79},
    generalizations={gen_research19_PublicationProcess_Named, gen_research19_ReviewNote_Named, gen_research19_Progress_Labelled, gen_research19_Paper_Named, gen_research19_Paragraph_Counted, gen_research19_Paragraph_Named, gen_research19_PublicationSystem_Named, gen_research19_Write_Labelled, gen_research19_Review_Labelled, gen_research19_PublicationStructure_Named, gen_research19_Position_Named, gen_research19_Keyword_Named, gen_research19_KnowledgeManager_Named, gen_research19_Transition_StateMachineObject, gen_research19_State_StateMachineObject},
    metadata=None
)
