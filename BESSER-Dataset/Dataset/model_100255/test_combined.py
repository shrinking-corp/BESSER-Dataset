...
def test_hyp_htmlprofile_is_not_abstract():
    assert not inspect.isabstract(HtmlProfile)


def test_hyp_htmlprofile_constructor_exists():
    assert callable(HtmlProfile.__init__)


def test_hyp_htmlprofile_constructor_args():
    sig = inspect.signature(HtmlProfile.__init__)
    params = list(sig.parameters.keys())



def test_hyp_wikigen_article_is_not_abstract():
    assert not inspect.isabstract(wikigen_Article)


def test_hyp_wikigen_article_constructor_exists():
    assert callable(wikigen_Article.__init__)


def test_hyp_wikigen_article_constructor_args():
...
def test_hyp_wikigen_document_is_not_abstract():
    assert not inspect.isabstract(wikigen_Document)


def test_hyp_wikigen_document_constructor_exists():
    assert callable(wikigen_Document.__init__)


def test_hyp_wikigen_document_constructor_args():
    sig = inspect.signature(wikigen_Document.__init__)
    params = list(sig.parameters.keys())



def test_hyp_wikigen_htmlprofile_is_not_abstract():
    assert not inspect.isabstract(wikigen_HtmlProfile)


def test_hyp_wikigen_htmlprofile_constructor_exists():
    assert callable(wikigen_HtmlProfile.__init__)


def test_hyp_wikigen_htmlprofile_constructor_args():
    sig = inspect.signature(wikigen_HtmlProfile.__init__)
    params = list(sig.parameters.keys())



def test_hyp_wikigen_genhtmldocument_is_not_abstract():
    assert not inspect.isabstract(wikigen_GenHtmlDocument)


def test_hyp_wikigen_genhtmldocument_constructor_exists():
    assert callable(wikigen_GenHtmlDocument.__init__)


def test_hyp_wikigen_genhtmldocument_constructor_args():
...
def test_hyp_wikigen_genlatexdocument_is_not_abstract():
    assert not inspect.isabstract(wikigen_GenLatexDocument)


def test_hyp_wikigen_genlatexdocument_constructor_exists():
    assert callable(wikigen_GenLatexDocument.__init__)


def test_hyp_wikigen_genlatexdocument_constructor_args():
...
def test_hyp_wikigen_container_is_not_abstract():
    assert not inspect.isabstract(wikigen_Container)


def test_hyp_wikigen_container_constructor_exists():
    assert callable(wikigen_Container.__init__)


def test_hyp_wikigen_container_constructor_args():
...
def test_hyp_wikigen_article_nbColumns_setter(instance):
...
@given(instance=wikigen_Article_strategy)
def test_hyp_wikigen_article_generateTOC_setter(instance):
...
def test_hyp_wikigen_genhtmldocument_filename_setter(instance):
...
def test_hyp_wikigen_genlatexdocument_filename_setter(instance):
    original = instance.filename
    instance.filename = original
    assert instance.filename == original
...
@given(instance=wikigen_GenLatexDocument_strategy)
def test_hyp_wikigen_genlatexdocument_authors_setter(instance):
...
@given(instance=wikigen_GenLatexDocument_strategy)
def test_hyp_wikigen_genlatexdocument_title_setter(instance):
