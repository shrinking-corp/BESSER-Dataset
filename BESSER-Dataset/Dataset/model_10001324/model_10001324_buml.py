...
Administrator.attributes={Administrator_adminID, Administrator_email, Administrator_name}
...
Book.attributes={Book_description, Book_bookID, Book_author, Book_price, Book_category, Book_title}
