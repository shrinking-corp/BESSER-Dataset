...
class Book:
    ...
    def __init__(self, bookID: int, title: str, category: Customer, price: int, description: str, author: str, administrator23: "Administrator" = None, administrator25: "Administrator" = None, category29: set["Category"] = None, customer35: "Customer" = None, customer39: "Customer" = None):
        self.bookID = bookID
        self.title = title
