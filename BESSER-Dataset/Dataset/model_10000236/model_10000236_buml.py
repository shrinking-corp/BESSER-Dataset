...
Users.attributes={Users_UserLevel, Users_UserName, Users_UserID}
...
Order.attributes={Order_Date, Order_UserID, Order_Total, Order_OrderID, Order_DicountLvl}
...
OrderItem.attributes={OrderItem_Completed, OrderItem_RemaningTime, OrderItem_ItemName}
...
Bookings.attributes={Bookings_Phone, Bookings_Time, Bookings_Date, Bookings_BookingID, Bookings_People, Bookings_CustomerName, Bookings_TableNo}
...
ViewOrder_OrderItem: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="orderItem6", type=OrderItem, multiplicity=Multiplicity(1, 9999)),
...
OrderItem_Order: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="orderItem9", type=OrderItem, multiplicity=Multiplicity(1, 9999))
    }
)
...
domain_model = DomainModel(
    name="_1e072ab6_6174_4406_92dc_fd7c75808f23",
    types={Users, Table, Order, Membership_Card, ViewOrder, OrderItem, Bookings, BookedTables},
    associations={Membership_Card_Order, Order_Table, Table_Bookings, ViewOrder_OrderItem, OrderItem_Order, Order_Users, BookedTables_Table},
    generalizations={},
    metadata=None
)
