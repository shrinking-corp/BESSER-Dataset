...
domain_model = DomainModel(
    name="ioT",
    types={ioT_System, ioT_EObject, ioT_SensorType, ioT_SensorTypes, ioT_ServerType, ioT_ServerTypes, ioT_Server, ioT_Ip, ioT_Portnumber, ioT_DestinationType, ioT_Sensor, ioT_DestinationTypes, ioT_SensorGroup, ioT_SensorGetMethod, ioT_Method, ioT_DeviceType, ioT_DeviceTypes, ioT_Device, ioT_Destination, ioT_FetchData, ioT_FetchDataExpression, ioT_Time, ioT_FetchDataCondition},
    associations={system0, type11, devices13, types16, type17, ip19, port21, types1, type2, sensors4, method6, type7, types10, types23, type24, filter26, destination28, conExp31, duration34},
    generalizations={},
    metadata=None
)
