...
# Classes
fault_tree_Gate = Class(name="fault_tree_Gate", is_abstract=True)
IDBase = Class(name="IDBase")
fault_tree_Hazard = Class(name="fault_tree_Hazard")
Event = Class(name="Event")
fault_tree_IntermediateEvent = Class(name="fault_tree_IntermediateEvent")
fault_tree_FailureType = Class(name="fault_tree_FailureType")
fault_tree_Event = Class(name="fault_tree_Event", is_abstract=True)
fault_tree_FaultTree = Class(name="fault_tree_FaultTree")
fault_tree_FailureInstance = Class(name="fault_tree_FailureInstance")
fault_tree_ErrorInstance = Class(name="fault_tree_ErrorInstance")
fault_tree_BasicEvent = Class(name="fault_tree_BasicEvent")
fault_tree_UndevelopedEvent = Class(name="fault_tree_UndevelopedEvent")
fault_tree_ErrorType = Class(name="fault_tree_ErrorType")
fault_tree_OR = Class(name="fault_tree_OR")
Gate = Class(name="Gate")
fault_tree_AND = Class(name="fault_tree_AND")
fault_tree_XOR = Class(name="fault_tree_XOR")
fault_tree_PriorAND = Class(name="fault_tree_PriorAND")
fault_tree_Inhibit = Class(name="fault_tree_Inhibit")
...
fault_tree_Event.attributes={fault_tree_Event_name, fault_tree_Event_description}
...
domain_model = DomainModel(
    name="fault_tree",
    types={fault_tree_Gate, IDBase, fault_tree_Hazard, Event, fault_tree_IntermediateEvent, fault_tree_FailureType, fault_tree_Event, fault_tree_FaultTree, fault_tree_FailureInstance, fault_tree_ErrorInstance, fault_tree_BasicEvent, fault_tree_UndevelopedEvent, fault_tree_ErrorType, fault_tree_OR, Gate, fault_tree_AND, fault_tree_XOR, fault_tree_PriorAND, fault_tree_Inhibit},
    associations={inEvent0, instance22, root24, inputGates2, inputEvents3, outputGate5, outputEvent7, root9, inputGate10, outputGate11, root13, instance15, inEvent17, outEvent19, type45, root47, type26, root27, previousFailure30, previousError31, event33, instance35, outEvent36, error38, root41, error43, hazard49, gate51, event53, failure_instance56, failure_type59, error_instance62, error_type65},
    generalizations={gen_fault_tree_Gate_IDBase, gen_fault_tree_Hazard_Event, gen_fault_tree_FailureType_IDBase, gen_fault_tree_Event_IDBase, gen_fault_tree_IntermediateEvent_Event, gen_fault_tree_FailureInstance_IDBase, gen_fault_tree_BasicEvent_Event, gen_fault_tree_UndevelopedEvent_Event, gen_fault_tree_ErrorType_IDBase, gen_fault_tree_ErrorInstance_IDBase, gen_fault_tree_OR_Gate, gen_fault_tree_AND_Gate, gen_fault_tree_XOR_Gate, gen_fault_tree_PriorAND_Gate, gen_fault_tree_Inhibit_Gate, gen_fault_tree_FaultTree_IDBase},
    metadata=None
)
