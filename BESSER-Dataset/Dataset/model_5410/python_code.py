...
class fault_tree_BasicEvent(Event):
    ...
    def __init__(self, probability: float, error: set["fault_tree_ErrorInstance"] = None, fault_tree_BasicEvent: "fault_tree_IntermediateEvent" = None, BasicEvent: "fault_tree_ErrorInstance" = None):
...
class fault_tree_FailureInstance(IDBase):
    ...
    def __init__(self, name: str, FailureInstance23: "fault_tree_FailureType" = None, FailureInstance: "fault_tree_IntermediateEvent" = None, failure_instance: "fault_tree_FaultTree" = None, fault_tree_FailureInstance: "fault_tree_FailureInstance" = None, fault_tree_FailureInstance29: "fault_tree_FailureInstance" = None, fault_tree_FailureInstance32: "fault_tree_ErrorInstance" = None, instance34: "fault_tree_IntermediateEvent" = None, FailureInstance58: "fault_tree_FaultTree" = None, instance: "fault_tree_FailureType" = None):
        self.name = name
...
class fault_tree_ErrorInstance(IDBase):
    ...
    def __init__(self, name: str, error46: "fault_tree_ErrorType" = None, fault_tree_ErrorInstance: "fault_tree_FailureInstance" = None, ErrorInstance: "fault_tree_BasicEvent" = None, ErrorInstance40: "fault_tree_ErrorType" = None, instance44: "fault_tree_BasicEvent" = None, ErrorInstance64: "fault_tree_FaultTree" = None, error_instance: "fault_tree_FaultTree" = None):
        self.name = name
...
class fault_tree_Event(IDBase):
    ...
    def __init__(self, description: str, name: str, Event: "fault_tree_Gate" = None, Event8: "fault_tree_Gate" = None, outputEvent: "fault_tree_Gate" = None, inputEvents: "fault_tree_Gate" = None, event: "fault_tree_FaultTree" = None, fault_tree_Event: "fault_tree_IntermediateEvent" = None, fault_tree_Event21: "fault_tree_IntermediateEvent" = None, Event55: "fault_tree_FaultTree" = None):
...
class fault_tree_ErrorType(IDBase):
    ...
    def __init__(self, name: str, ErrorType: "fault_tree_ErrorInstance" = None, type39: set["fault_tree_ErrorInstance"] = None, error_type: "fault_tree_FaultTree" = None, ErrorType67: "fault_tree_FaultTree" = None):
        self.name = name
...
class fault_tree_FailureType(IDBase):
    ...
    def __init__(self, name: str, type: set["fault_tree_FailureInstance"] = None, failure_type: "fault_tree_FaultTree" = None, FailureType61: "fault_tree_FaultTree" = None, FailureType: "fault_tree_FailureInstance" = None):
        self.name = name
