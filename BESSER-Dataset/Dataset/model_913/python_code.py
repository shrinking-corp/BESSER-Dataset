...
class PetriNet_Noeud(PetriElement):
    ...
    def __init__(self, name: str, successor: set["PetriNet_Arc"] = None, Noeud: "PetriNet_Arc" = None, Noeud2: "PetriNet_Arc" = None, predecessor: set["PetriNet_Arc"] = None):
        self.name = name
...
class PetriNet_Arc(PetriElement):
    ...
    def __init__(self, isReadArc: bool, poids: int, Arc: "PetriNet_Noeud" = None, linksToPredecessors: "PetriNet_Noeud" = None, LinksToSuccessors: "PetriNet_Noeud" = None, Arc9: "PetriNet_Noeud" = None):
