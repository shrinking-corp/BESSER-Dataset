...
domain_model = DomainModel(
    name="relational",
    types={relational_Field, relational_DataBase, relational_Schema, relational_Table, relational_PrimaryKey, Field, relational_ForeignKey, relational_Column, Type},
