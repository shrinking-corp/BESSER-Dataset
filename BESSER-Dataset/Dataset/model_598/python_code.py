...
class presentation_Viewer(ABC):
    ...
    def __init__(self, mixed: str, group: str, presentation_Viewer: set["presentation_EObject"] = None, presentation_Viewer300: set["presentation_Control"] = None, presentation_Viewer298: set["presentation_ISelection"] = None):
        self.mixed = mixed
        self.group = group
...
class presentation_TitleAreaDialog(TrayDialog):
    ...
    def __init__(self, group3: str, errorMessage: str, message: str, title: str, titleImage: str, presentation_TitleAreaDialog: set["presentation_RGB"] = None):
        self.group3 = group3
...
class presentation_Shell(Decorations):
    ...
    def __init__(self, group5: str, alpha: str, fullScreen: str, imeInputMode: str, minimumSize: str, presentation_Shell: "presentation_Shell" = None, presentation_Shell194: set["presentation_Shell"] = None, presentation_Shell261: "presentation_ToolTip" = None):
        self.group5 = group5
        self.alpha = alpha
...
class presentation_ObjectDataProvider(AbstractDataProvider):
    ...
    def __init__(self, group1: str, methodName: str, presentation_ObjectDataProvider180: set["presentation_EObject"] = None, presentation_ObjectDataProvider183: set["presentation_List"] = None, presentation_ObjectDataProvider: set["presentation_Class"] = None):
        self.group1 = group1
...
class presentation_GridData:
    ...
    def __init__(self, horizontalSpan: str, minimumHeight: str, minimumWidth: str, verticalAlignment: str, verticalIndent: str, verticalSpan: str, mixed: str, exclude: str, grabExcessHorizontalSpace: str, grabExcessVerticalSpace: str, heightHint: str, horizontalAlignment: str, horizontalIndent: str, widthHint: str):
...
class presentation_FormLayout(Layout):
    ...
    def __init__(self, marginBottom: str, marginHeight: str, marginLeft: str, marginRight: str, marginTop: str, marginWidth: str, spacing: str):
...
class presentation_GridLayout(Layout):
    ...
    def __init__(self, horizontalSpacing: str, makeColumnsEqualWidth: str, marginBottom: str, marginHeight: str, marginLeft: str, marginRight: str, marginTop: str, marginWidth: str, numColumns: str, verticalSpacing: str):
...
class presentation_RowLayout(Layout):
    ...
    def __init__(self, center: str, fill: str, justify: str, marginBottom: str, marginHeight: str, marginLeft: str, marginRight: str, marginTop: str, marginWidth: str, pack: str, spacing: str, type: str, wrap: str):
        self.center = center
        self.fill = fill
...
class presentation_DocumentRoot:
    ...
    def __init__(self, mixed: str, presentation_DocumentRoot: set["presentation_EStringToStringMapEntry"] = None, presentation_DocumentRoot125: set["presentation_EStringToStringMapEntry"] = None, presentation_DocumentRoot128: set["presentation_Composite"] = None, presentation_DocumentRoot131: set["presentation_Window"] = None):
        self.mixed = mixed
...
class presentation_MenuItem(Item):
    ...
    def __init__(self, accelerator: str, enabled: str, selection: str, group: str, presentation_MenuItem: "presentation_Menu" = None, presentation_MenuItem159: "presentation_Menu" = None, presentation_MenuItem162: "presentation_Menu" = None, presentation_MenuItem170: set["presentation_Menu"] = None, presentation_MenuItem173: set["presentation_ICommand"] = None, presentation_MenuItem176: set["presentation_Menu"] = None):
...
class presentation_CTabItem(Item):
    ...
    def __init__(self, bounds: str, disabledImage: str, group: str, font: str, showClose: str, toolTipText: str, presentation_CTabItem: "presentation_CTabFolder" = None, presentation_CTabItem104: "presentation_CTabFolder" = None, presentation_CTabItem109: set["presentation_CTabFolder"] = None, presentation_CTabItem112: set["presentation_Control"] = None):
        self.bounds = bounds
...
class presentation_TableColumn(Item):
    ...
    def __init__(self, group: str, alignment: str, moveable: str, resizable: str, toolTipText: str, width: str, presentation_TableColumn: "presentation_Table" = None, presentation_TableColumn224: "presentation_Table" = None, presentation_TableColumn232: set["presentation_Element"] = None, presentation_TableColumn234: set["presentation_Table"] = None, presentation_TableColumn250: "presentation_TableViewerColumn" = None):
        self.group = group
        self.alignment = alignment
        self.moveable = moveable
        self.resizable = resizable
...
class presentation_ToolItem(Item):
    ...
    def __init__(self, group: str, bounds: str, disabledImage: str, enabled: str, hotImage: str, selection: str, toolTipText: str, width: str, presentation_ToolItem: "presentation_ToolBar" = None, presentation_ToolItem255: set["presentation_Control"] = None, presentation_ToolItem258: set["presentation_ToolBar"] = None):
        self.group = group
        self.bounds = bounds
        self.disabledImage = disabledImage
        self.enabled = enabled
...
class presentation_TabItem(Item):
    ...
    def __init__(self, group: str, toolTipText: str, bounds: str, presentation_TabItem: "presentation_TabFolder" = None, presentation_TabItem214: "presentation_TabFolder" = None, presentation_TabItem216: set["presentation_TabFolder"] = None, presentation_TabItem219: set["presentation_Control"] = None):
        self.group = group
        self.toolTipText = toolTipText
        self.bounds = bounds
...
class presentation_TreeItem(Item):
    ...
    def __init__(self, texts: str, checked: str, expanded: str, grayed: str, handle: str, itemCount: str, group: str, presentation_TreeItem277: "presentation_Tree" = None, presentation_TreeItem280: "presentation_Tree" = None, presentation_TreeItem289: "presentation_TreeItem" = None, presentation_TreeItem287: set["presentation_TreeItem"] = None, presentation_TreeItem291: set["presentation_Tree"] = None, presentation_TreeItem286: "presentation_TreeItem" = None, presentation_TreeItem284: set["presentation_TreeItem"] = None, presentation_TreeItem: "presentation_Tree" = None, presentation_TreeItem274: "presentation_Tree" = None):
        self.texts = texts
...
class presentation_CoolItem(Item):
    ...
    def __init__(self, preferredSize: str, size: str, group: str, bounds: str, minimumSize: str, presentation_CoolItem: "presentation_CoolBar" = None, presentation_CoolItem88: set["presentation_CoolBar"] = None, presentation_CoolItem91: set["presentation_Control"] = None):
...
class presentation_ControlEditor:
    ...
    def __init__(self, verticalAlignment: str, mixed: str, group: str, grabHorizontal: str, grabVertical: str, horizontalAlignment: str, minimumHeight: str, minimumWidth: str, presentation_ControlEditor: set["presentation_Control"] = None):
        self.verticalAlignment = verticalAlignment
        self.mixed = mixed
        self.group = group
...
class presentation_ContentViewer(Viewer):
    ...
    def __init__(self, group1: str, presentation_ContentViewer73: set["presentation_IBaseLabelProvider"] = None, presentation_ContentViewer: set["presentation_IContentProvider"] = None):
        self.group1 = group1
...
class presentation_List(Scrollable):
    ...
    def __init__(self, group2: str, items: str, selection: str, selectionIndices: str, topIndex: str, presentation_List184: "presentation_ObjectDataProvider" = None, presentation_List: "presentation_ListViewer" = None):
        self.group2 = group2
        self.items = items
        self.selection = selection
...
class presentation_Text(Scrollable):
    ...
    def __init__(self, caretLocation: str, doubleClickEnabled: str, echoChar: str, editable: str, lineDelimiter: str, message: str, orientation: str, tabs: str, text: str, textLimit: str, topIndex: str, selection: str, selectionText: str):
...
class presentation_ComboBoxViewerCellEditor(AbstractComboBoxCellEditor):
    ...
    def __init__(self, group1: str, presentation_ComboBoxViewerCellEditor61: set["presentation_IBaseLabelProvider"] = None, presentation_ComboBoxViewerCellEditor63: set["presentation_ComboViewer"] = None, presentation_ComboBoxViewerCellEditor: set["presentation_EObject"] = None, presentation_ComboBoxViewerCellEditor59: set["presentation_IStructuredContentProvider"] = None):
        self.group1 = group1
...
class presentation_IBaseLabelProvider(ABC):
    ...
    def __init__(self, mixed: str, presentation_IBaseLabelProvider74: "presentation_ContentViewer" = None, presentation_IBaseLabelProvider: "presentation_ComboBoxViewerCellEditor" = None):
        self.mixed = mixed
...
class presentation_Decorations(Canvas):
    ...
    def __init__(self, image: str, maximized: str, minimized: str, text: str, group4: str, images: str, presentation_Decorations: set["presentation_Button"] = None, presentation_Decorations117: set["presentation_Menu"] = None, presentation_Decorations168: "presentation_Menu" = None):
        self.image = image
...
class presentation_StyledText(Canvas):
    ...
    def __init__(self, group4: str, ranges: str, selectionRanges: str, alignment: str, bidiColoring: str, editable: str, horizontalIndex: str, horizontalPixel: str, indent: str, justify: str, lineDelimiter: str, lineSpacing: str, orientation: str, selection: str, selectionBackground: str, selectionForeground: str, selectionText: str, tabs: str, text: str, textLimit: str, blockSelection: str, caretOffset: str, doubleClickEnabled: str, topIndex: str, topPixel: str, wordWrap: str, presentation_StyledText: set["presentation_StyleRange"] = None, presentation_StyledText207: set["presentation_StyleRange"] = None, presentation_StyledText210: set["presentation_StyledTextContent"] = None):
        self.group4 = group4
        self.ranges = ranges
...
class presentation_CheckboxTableViewer(TableViewer):
    ...
    def __init__(self, group5: str, allChecked: str, allGrayed: str, presentation_CheckboxTableViewer: set["presentation_EObject"] = None, presentation_CheckboxTableViewer35: set["presentation_ICheckStateProvider"] = None, presentation_CheckboxTableViewer37: set["presentation_EObject"] = None):
        self.group5 = group5
        self.allChecked = allChecked
...
class presentation_TableItem(Item):
    ...
    def __init__(self, group: str, texts: str, checked: str, grayed: str, imageIndent: str, presentation_TableItem: "presentation_Cell" = None, presentation_TableItem227: "presentation_Table" = None, presentation_TableItem230: "presentation_Table" = None, presentation_TableItem237: "presentation_TableEditor" = None, presentation_TableItem239: set["presentation_Collection"] = None, presentation_TableItem241: set["presentation_Table"] = None, presentation_TableItem244: set["presentation_Collection"] = None):
        self.group = group
        self.texts = texts
        self.checked = checked
        self.grayed = grayed
...
class presentation_Control(Widget):
    ...
    def __init__(self, group: str, enabled: str, font: str, foreground: str, handle: str, location: str, redraw: str, background: str, backgroundImage: str, bounds: str, capture: str, dragDetect: str, size: str, toolTipText: str, visible: str, presentation_Control65: "presentation_Composite" = None, presentation_Control68: "presentation_Composite" = None, presentation_Control76: set["presentation_Menu"] = None, presentation_Control78: set["presentation_Cursor"] = None, presentation_Control80: set["presentation_EObject"] = None, presentation_Control83: set["presentation_Accessible"] = None, presentation_Control85: "presentation_ControlEditor" = None, presentation_Control: "presentation_CellEditor" = None, presentation_Control186: "presentation_SashForm" = None, presentation_Control197: "presentation_StackLayout" = None, presentation_Control92: "presentation_CoolItem" = None, presentation_Control98: "presentation_CTabFolder" = None, presentation_Control113: "presentation_CTabItem" = None, presentation_Control120: "presentation_Dialog" = None, presentation_Control140: "presentation_FormAttachment" = None, presentation_Control138: "presentation_ExpandItem" = None, presentation_Control301: "presentation_Viewer" = None, presentation_Control220: "presentation_TabItem" = None, presentation_Control256: "presentation_ToolItem" = None):
        self.group = group
        self.enabled = enabled
        self.font = font
...
class presentation_Menu(Widget):
    ...
    def __init__(self, group: str, enabled: str, handle: str, visible: str, presentation_Menu: "presentation_Control" = None, presentation_Menu118: "presentation_Decorations" = None, presentation_Menu156: set["presentation_MenuItem"] = None, presentation_Menu158: set["presentation_MenuItem"] = None, presentation_Menu161: set["presentation_MenuItem"] = None, presentation_Menu165: "presentation_Menu" = None, presentation_Menu163: set["presentation_Menu"] = None, presentation_Menu167: set["presentation_Decorations"] = None, presentation_Menu171: "presentation_MenuItem" = None, presentation_Menu177: "presentation_MenuItem" = None):
        self.group = group
        self.enabled = enabled
        self.handle = handle
        self.visible = visible
...
class presentation_Caret(Widget):
    ...
    def __init__(self, image: str, location: str, size: str, visible: str, group: str, bounds: str, font: str, presentation_Caret: "presentation_Canvas" = None, presentation_Caret21: set["presentation_Canvas"] = None):
        self.image = image
        self.location = location
        self.size = size
        self.visible = visible
...
class presentation_IME(Widget):
    ...
    def __init__(self, group: str, ranges: str, compositionOffset: str, text: str, presentation_IME: "presentation_Canvas" = None, presentation_IME153: set["presentation_TextStyle"] = None):
        self.group = group
        self.ranges = ranges
...
class presentation_Slider(Control):
    ...
    def __init__(self, increment: str, pageIncrement: str, selection: str, thumb: str, maximum: str, minimum: str):
        self.increment = increment
        self.pageIncrement = pageIncrement
        self.selection = selection
        self.thumb = thumb
...
class presentation_Button(Control):
    ...
    def __init__(self, alignment: str, grayed: str, image: str, selection: str, group1: str, text: str, presentation_Button: set["presentation_ICommand"] = None, presentation_Button115: "presentation_Decorations" = None):
        self.alignment = alignment
        self.grayed = grayed
        self.image = image
        self.selection = selection
...
class presentation_Widget(ABC):
    ...
    def __init__(self, setDataEvent: str, showEvent: str, style: str, traverseEvent: str, verifyEvent: str, mouseUpEvent: str, mixed: str, activateEvent: str, armEvent: str, dataContext: str, deactivateEvent: str, defaultSelectionEvent: str, deiconifyEvent: str, disposeEvent: str, dragDetectEvent: str, eraseItemEvent: str, expandEvent: str, focusInEvent: str, focusOutEvent: str, hardKeyDownEvent: str, hardKeyUpEvent: str, helpEvent: str, closeEvent: str, hideEvent: str, collapseEvent: str, imeCompositionEvent: str, keyDownEvent: str, keyUpEvent: str, measureItemEvent: str, menuDetectEvent: str, modifyEvent: str, mouseDoubleClickEvent: str, mouseDownEvent: str, mouseEnterEvent: str, mouseExitEvent: str, mouseHoverEvent: str, mouseMoveEvent: str, iconifyEvent: str, mouseWheelEvent: str, moveEvent: str, paintEvent: str, paintItemEvent: str, resizeEvent: str, selectionEvent: str, presentation_Widget: "presentation_Binding" = None):
    ...
    @property
    def defaultSelectionEvent(self):
...
class presentation_Binding:
    ...
    def __init__(self, path: str, xPath: str, mixed: str, group: str, elementName: str, presentation_Binding: set["presentation_EObject"] = None, presentation_Binding10: set["presentation_EObject"] = None, presentation_Binding13: set["presentation_Widget"] = None):
        self.path = path
        self.xPath = xPath
        self.mixed = mixed
        self.group = group
...
class presentation_CoolBar(Composite):
    ...
    def __init__(self, group3: str, itemOrder: str, wrapIndices: str, itemSizes: str, locked: str, presentation_CoolBar: set["presentation_CoolItem"] = None, presentation_CoolBar89: "presentation_CoolItem" = None):
        self.group3 = group3
...
class presentation_Combo(Composite):
    ...
    def __init__(self, group3: str, items: str, listVisible: str, orientation: str, selection: str, text: str, textLimit: str, visibleItemCount: str):
        self.group3 = group3
        self.items = items
...
class presentation_CTabFolder(Composite):
    ...
    def __init__(self, group3: str, maximized: str, maximizeVisible: str, mINTABWIDTH: str, minimized: str, minimizeVisible: str, minimumCharacters: str, borderVisible: str, marginHeight: str, marginWidth: str, mRUVisible: str, selectionBackground: str, selectionForeground: str, simple: str, single: str, tabHeight: str, tabPosition: str, unselectedCloseVisible: str, unselectedImageVisible: str, presentation_CTabFolder: set["presentation_RGB"] = None, presentation_CTabFolder95: set["presentation_CTabItem"] = None, presentation_CTabFolder97: set["presentation_Control"] = None, presentation_CTabFolder100: set["presentation_RGB"] = None, presentation_CTabFolder103: set["presentation_CTabItem"] = None, presentation_CTabFolder106: set["presentation_RGB"] = None, presentation_CTabFolder110: "presentation_CTabItem" = None):
        self.group3 = group3
        self.maximized = maximized
    ...
    @property
    def unselectedCloseVisible(self):
    ...
    @property
    def unselectedImageVisible(self):
...
class presentation_Tree(Composite):
    ...
    def __init__(self, group3: str, columnOrder: str, headerVisible: str, itemCount: str, linesVisible: str, sortDirection: str, presentation_Tree276: set["presentation_TreeItem"] = None, presentation_Tree279: set["presentation_TreeItem"] = None, presentation_Tree292: "presentation_TreeItem" = None, presentation_Tree294: "presentation_TreeViewer" = None, presentation_Tree: set["presentation_TreeColumn"] = None, presentation_Tree268: set["presentation_TreeItem"] = None, presentation_Tree270: set["presentation_TreeColumn"] = None, presentation_Tree273: set["presentation_TreeItem"] = None, presentation_Tree283: "presentation_TreeColumn" = None):
        self.group3 = group3
        self.columnOrder = columnOrder
        self.headerVisible = headerVisible
        self.itemCount = itemCount
...
class presentation_SashForm(Composite):
    ...
    def __init__(self, group3: str, weights: str, orientation: str, sASHWIDTH: str, sashWidth1: str, presentation_SashForm: set["presentation_Control"] = None):
        self.group3 = group3
...
class presentation_ExpandBar(Composite):
    ...
    def __init__(self, spacing: str, group3: str, presentation_ExpandBar: set["presentation_ExpandItem"] = None, presentation_ExpandBar135: "presentation_ExpandItem" = None):
        self.spacing = spacing
        self.group3 = group3
...
class presentation_AbstractTreeViewer(ColumnViewer):
    ...
    def __init__(self, group4: str, autoExpandLevel: str, presentation_AbstractTreeViewer3: set["presentation_EObject"] = None, presentation_AbstractTreeViewer: set["presentation_TreePath"] = None, presentation_AbstractTreeViewer5: set["presentation_EObject"] = None):
        self.group4 = group4
...
class presentation_AbstractDataProvider(ABC):
    ...
    def __init__(self, mixed: str, group: str, key: str, presentation_AbstractDataProvider: set["presentation_IBindingContext"] = None):
        self.mixed = mixed
        self.group = group
        self.key = key
