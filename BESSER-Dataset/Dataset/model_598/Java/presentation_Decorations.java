...
public class presentation_Decorations extends Canvas {
    ...
    public presentation_Decorations(
        String images,        String group4,        String maximized,        String image,        String text,        String minimized    ) {
        super(
        );
        this.images = images;
        this.group4 = group4;
    ...
    public presentation_Decorations(
        String images,        String group4,        String maximized,        String image,        String text,        String minimized        ArrayList<presentation_Menu> presentation_menus,        ArrayList<presentation_Button> presentation_buttons    ) {
        this.images = images;
        this.group4 = group4;
        this.maximized = maximized;
        this.image = image;
