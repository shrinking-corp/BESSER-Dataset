...
class vml_Node(DiagramElement):
    ...
    def __init__(self, title: str, icone: str, vml_Node: "vml_EdgeStyle" = None, vml_Node31: "vml_EdgeStyle" = None, Node: "vml_Edge" = None, Node57: "vml_Edge" = None, vml_Node47: "vml_Graph" = None, source: set["vml_Edge"] = None, target: set["vml_Edge"] = None):
        self.title = title
        self.icone = icone
...
class vml_Edge(DiagramElement):
    ...
    def __init__(self, relation: str, outgoing: "vml_Node" = None, incoming: "vml_Node" = None, vml_Edge: "vml_Graph" = None, Edge: "vml_Node" = None, Edge54: "vml_Node" = None):
...
class vml_Graph(Diagram):
    ...
    def __init__(self, ID: str, title: str, vml_Graph: set["vml_Node"] = None, vml_Graph49: set["vml_Edge"] = None, vml_Graph51: "vml_GraphStyle" = None):
        self.ID = ID
        self.title = title
...
class vml_Table:
    ...
    def __init__(self, tableTitle: str, vml_Table: "vml_Model" = None, vml_Table42: "vml_DiagramElement" = None, vml_Table4: set["vml_Column"] = None, vml_Table6: set["vml_Row"] = None):
...
class vml_Color:
    ...
    def __init__(self, red: int, green: int, blue: int, name: str, vml_Color27: "vml_NodeStyle" = None, vml_Color34: "vml_EdgeStyle" = None, vml_Color37: "vml_EdgeStyle" = None, vml_Color: "vml_NodeStyle" = None, vml_Color18: "vml_NodeStyle" = None, vml_Color21: "vml_NodeStyle" = None, vml_Color24: "vml_NodeStyle" = None):
        self.red = red
        self.green = green
        self.blue = blue
        self.name = name
...
class vml_EdgeStyle(GraphStyle):
    ...
    def __init__(self, directed: bool, lineStyle: str, lineWidth: int, weight: float, vml_EdgeStyle: "vml_Node" = None, vml_EdgeStyle30: "vml_Node" = None, vml_EdgeStyle33: "vml_Color" = None, vml_EdgeStyle36: "vml_Color" = None):
