...
# Classes
vml_Column = Class(name="vml_Column")
vml_Row = Class(name="vml_Row")
vml_Cell = Class(name="vml_Cell")
vml_Style = Class(name="vml_Style")
vml_GraphStyle = Class(name="vml_GraphStyle")
Style = Class(name="Style")
vml_NodeStyle = Class(name="vml_NodeStyle")
GraphStyle = Class(name="GraphStyle")
vml_Color = Class(name="vml_Color")
vml_Model = Class(name="vml_Model")
vml_Diagram = Class(name="vml_Diagram", is_abstract=True)
vml_Table = Class(name="vml_Table")
vml_ChartWithAxisStyle = Class(name="vml_ChartWithAxisStyle")
vml_ChartWithoutAxisStyle = Class(name="vml_ChartWithoutAxisStyle")
vml_DiagramElement = Class(name="vml_DiagramElement", is_abstract=True)
vml_Pie = Class(name="vml_Pie")
Diagram = Class(name="Diagram")
vml_Slice = Class(name="vml_Slice")
DiagramElement = Class(name="DiagramElement")
vml_Graph = Class(name="vml_Graph")
vml_EdgeStyle = Class(name="vml_EdgeStyle")
vml_Node = Class(name="vml_Node")
vml_Chart = Class(name="vml_Chart", is_abstract=True)
vml_ChartElement = Class(name="vml_ChartElement")
vml_BarChart = Class(name="vml_BarChart")
Chart = Class(name="Chart")
vml_Bar = Class(name="vml_Bar")
ChartElement = Class(name="ChartElement")
vml_StackBarChart = Class(name="vml_StackBarChart")
vml_StackBars = Class(name="vml_StackBars")
vml_Category = Class(name="vml_Category")
vml_Edge = Class(name="vml_Edge")
vml_LineChart = Class(name="vml_LineChart")
vml_Point = Class(name="vml_Point")
vml_Scatter = Class(name="vml_Scatter")
...
vml_NodeStyle.attributes={vml_NodeStyle_padding, vml_NodeStyle_borderWidth}
...
vml_Color.attributes={vml_Color_name, vml_Color_green, vml_Color_blue, vml_Color_red}
...
vml_EdgeStyle.attributes={vml_EdgeStyle_directed, vml_EdgeStyle_weight, vml_EdgeStyle_lineWidth, vml_EdgeStyle_lineStyle}
...
vml_Chart.attributes={vml_Chart_title, vml_Chart_yTitle, vml_Chart_ID, vml_Chart_xTitle}
...
vml_ChartElement.attributes={vml_ChartElement_ID, vml_ChartElement_yValue, vml_ChartElement_xValue}
...
domain_model = DomainModel(
    name="vml",
    types={vml_Column, vml_Row, vml_Cell, vml_Style, vml_GraphStyle, Style, vml_NodeStyle, GraphStyle, vml_Color, vml_Model, vml_Diagram, vml_Table, vml_ChartWithAxisStyle, vml_ChartWithoutAxisStyle, vml_DiagramElement, vml_Pie, Diagram, vml_Slice, DiagramElement, vml_Graph, vml_EdgeStyle, vml_Node, vml_Chart, vml_ChartElement, vml_BarChart, Chart, vml_Bar, ChartElement, vml_StackBarChart, vml_StackBars, vml_Category, vml_Edge, vml_LineChart, vml_Point, vml_Scatter, LineStyle},
    associations={columns3, rows5, cells7, col9, digrams13, backgroundColor15, foregroundColor16, highlightColor19, borderColor22, diagrams0, tables1, diagrams38, table40, slices43, style44, borderHighlightColor25, source28, target29, lineColor32, highlightColor35, source55, target56, style58, bars59, stackBar60, categories61, nodes46, category63, bars66, edges48, style50, outgoing52, incoming53, points69, points70},
    generalizations={gen_vml_GraphStyle_Style, gen_vml_NodeStyle_GraphStyle, gen_vml_ChartWithAxisStyle_Style, gen_vml_ChartWithoutAxisStyle_Style, gen_vml_Pie_Diagram, gen_vml_Slice_DiagramElement, gen_vml_Graph_Diagram, gen_vml_EdgeStyle_GraphStyle, gen_vml_Edge_DiagramElement, gen_vml_Chart_Diagram, gen_vml_ChartElement_DiagramElement, gen_vml_BarChart_Chart, gen_vml_Bar_ChartElement, gen_vml_StackBarChart_Chart, gen_vml_StackBars_ChartElement, gen_vml_LineChart_Chart, gen_vml_Node_DiagramElement, gen_vml_Point_ChartElement, gen_vml_Scatter_Chart},
    metadata=None
)
