...
forms_entityModeling_Entity = Class(name="forms_entityModeling_Entity")
forms_EFML_model = Class(name="forms_EFML_model")
Entity = Class(name="Entity")
Enumeration_ = Class(name="Enumeration")
forms_entityModeling_Literal = Class(name="forms_entityModeling_Literal")
Attribute = Class(name="Attribute")
Relationship = Class(name="Relationship")
forms_entityModeling_Attribute = Class(name="forms_entityModeling_Attribute")
forms_entityModeling_Enumeration = Class(name="forms_entityModeling_Enumeration")
Literal = Class(name="Literal")
forms_entityModeling_Relationship = Class(name="forms_entityModeling_Relationship")
forms_entityModeling_Textfield = Class(name="forms_entityModeling_Textfield")
AttributePageElement = Class(name="AttributePageElement")
forms_entityModeling_Textarea = Class(name="forms_entityModeling_Textarea")
forms_entityModeling_SelectionField = Class(name="forms_entityModeling_SelectionField")
forms_entityModeling_Form = Class(name="forms_entityModeling_Form")
Page = Class(name="Page")
forms_entityModeling_Page = Class(name="forms_entityModeling_Page")
PageElement = Class(name="PageElement")
Condition = Class(name="Condition")
forms_entityModeling_PageElement = Class(name="forms_entityModeling_PageElement", is_abstract=True)
forms_entityModeling_AttributePageElement = Class(name="forms_entityModeling_AttributePageElement", is_abstract=True)
forms_entityModeling_RelationshipPageElement = Class(name="forms_entityModeling_RelationshipPageElement", is_abstract=True)
forms_entityModeling_DateSelectionField = Class(name="forms_entityModeling_DateSelectionField")
forms_entityModeling_TimeSelectionField = Class(name="forms_entityModeling_TimeSelectionField")
forms_entityModeling_List = Class(name="forms_entityModeling_List")
RelationshipPageElement = Class(name="RelationshipPageElement")
forms_entityModeling_Table = Class(name="forms_entityModeling_Table")
Column = Class(name="Column")
forms_entityModeling_Column = Class(name="forms_entityModeling_Column")
forms_entityModeling_Condition = Class(name="forms_entityModeling_Condition", is_abstract=True)
forms_entityModeling_AttributeValueCondition = Class(name="forms_entityModeling_AttributeValueCondition")
forms_entityModeling_CompositeCondition = Class(name="forms_entityModeling_CompositeCondition")
...
forms_entityModeling_Relationship.attributes={forms_entityModeling_Relationship_lowerBound, forms_entityModeling_Relationship_upperBound, forms_entityModeling_Relationship_name}
...
forms_entityModeling_Form.attributes={forms_entityModeling_Form_name, forms_entityModeling_Form_description, forms_entityModeling_Form_title}
...
forms_entityModeling_PageElement.attributes={forms_entityModeling_PageElement_elementID, forms_entityModeling_PageElement_label}
...
domain_model = DomainModel(
    name="forms",
    types={Form, forms_entityModeling_Entity, forms_EFML_model, Entity, Enumeration_, forms_entityModeling_Literal, Attribute, Relationship, forms_entityModeling_Attribute, forms_entityModeling_Enumeration, Literal, forms_entityModeling_Relationship, forms_entityModeling_Textfield, AttributePageElement, forms_entityModeling_Textarea, forms_entityModeling_SelectionField, forms_entityModeling_Form, Page, forms_entityModeling_Page, PageElement, Condition, forms_entityModeling_PageElement, forms_entityModeling_AttributePageElement, forms_entityModeling_RelationshipPageElement, forms_entityModeling_DateSelectionField, forms_entityModeling_TimeSelectionField, forms_entityModeling_List, RelationshipPageElement, forms_entityModeling_Table, Column, forms_entityModeling_Column, forms_entityModeling_Condition, forms_entityModeling_AttributeValueCondition, forms_entityModeling_CompositeCondition, AttributeType, ConditionType, BooleanOperators},
    associations={welcomeForm3, forms5, entities0, enumerations1, id8, attributes9, superType12, relationships15, enumerationType17, literals19, target20, opposite22, relationshipToEnterValues36, editingForm38, entity25, pages27, pageElements29, condition30, condition32, attributeToEnterValues34, alreadyEnteredEntity41, Columns43, attribute44, value46, composedConditions48},
    generalizations={gen_forms_entityModeling_Textfield_AttributePageElement, gen_forms_entityModeling_Textarea_AttributePageElement, gen_forms_entityModeling_SelectionField_AttributePageElement, gen_forms_entityModeling_AttributePageElement_PageElement, gen_forms_entityModeling_RelationshipPageElement_PageElement, gen_forms_entityModeling_DateSelectionField_AttributePageElement, gen_forms_entityModeling_TimeSelectionField_AttributePageElement, gen_forms_entityModeling_List_RelationshipPageElement, gen_forms_entityModeling_Table_RelationshipPageElement, gen_forms_entityModeling_AttributeValueCondition_Condition, gen_forms_entityModeling_CompositeCondition_Condition},
    metadata=None
)
