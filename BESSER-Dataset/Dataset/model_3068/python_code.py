...
class forms_entityModeling_CompositeCondition(Condition):
    ...
    def __init__(self, booleanOperator: str, forms_entityModeling_CompositeCondition: set["Condition"] = None, Condition49: "forms_entityModeling_CompositeCondition" = None, Condition33: "forms_entityModeling_PageElement" = None, Condition: "forms_entityModeling_Page" = None):
...
class forms_entityModeling_AttributePageElement(PageElement):
    ...
    def __init__(self, valueOfAttribute: str, forms_entityModeling_AttributePageElement: "Attribute" = None, PageElement: "forms_entityModeling_Page" = None):
...
class forms_entityModeling_Relationship:
    ...
    def __init__(self, lowerBound: int, upperBound: int, name: str, forms_entityModeling_Relationship: "Entity" = None, forms_entityModeling_Relationship23: "Relationship" = None):
...
class forms_entityModeling_Attribute:
    ...
    def __init__(self, name: str, mandatory: bool, type: str, forms_entityModeling_Attribute: "Enumeration" = None):
        self.name = name
