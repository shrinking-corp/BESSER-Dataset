...
# Classes
imports_DocumentRoot = Class(name="imports_DocumentRoot")
imports_EStringToStringMapEntry = Class(name="imports_EStringToStringMapEntry")
imports_BookType = Class(name="imports_BookType")
imports_RootElementType = Class(name="imports_RootElementType")
...
domain_model = DomainModel(
    name="imports",
    types={imports_DocumentRoot, imports_EStringToStringMapEntry, imports_BookType, imports_RootElementType},
    associations={xMLNSPrefixMap0, xSISchemaLocation1, rootElement4, book6},
    generalizations={},
    metadata=None
)
