...
class imports_BookType:
    ...
    def __init__(self, title: str, author: str, isbn: str, imports_BookType: "imports_RootElementType" = None):
        self.title = title
        self.author = author
        self.isbn = isbn
...
class imports_DocumentRoot:
    ...
    def __init__(self, mixed: str, imports_DocumentRoot: set["imports_EStringToStringMapEntry"] = None, imports_DocumentRoot2: set["imports_EStringToStringMapEntry"] = None, imports_DocumentRoot5: set["imports_RootElementType"] = None):
        self.mixed = mixed
