...
# Classes
device_Types = Class(name="device_Types")
device_Device = Class(name="device_Device")
device_Fonctionnalite = Class(name="device_Fonctionnalite")
device_Parametre = Class(name="device_Parametre")
device_EJavaObject = Class(name="device_EJavaObject")
device_Capture = Class(name="device_Capture")
Fonctionnalite = Class(name="Fonctionnalite")
device_Action = Class(name="device_Action")
device_Object = Class(name="device_Object")
...
return_7: BinaryAssociation = BinaryAssociation(
    name="return_7",
    ends={
...
domain_model = DomainModel(
    ...
    associations={type5, Types0, refFonction1, ListeParametres3, return_7},
