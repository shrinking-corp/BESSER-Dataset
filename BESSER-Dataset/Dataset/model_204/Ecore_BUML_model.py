...
ecore_EStructuralFeature.attributes={ecore_EStructuralFeature_volatile, ecore_EStructuralFeature_changeable, ecore_EStructuralFeature_transient, ecore_EStructuralFeature_unsettable, ecore_EStructuralFeature_derived, ecore_EStructuralFeature_defaultValueLiteral, ecore_EStructuralFeature_defaultValue}
...
domain_model = DomainModel(
    name="ecore",
    types={ecore_EAttribute, EStructuralFeature, ecore_EModelElement, ecore_EObject, ecore_EClass, EClassifier, ecore_EOperation, ecore_EReference, ecore_EStructuralFeature, ecore_EDataType, ecore_EAnnotation, EModelElement, ecore_EStringToStringMapEntry, ecore_EGenericType, ecore_EClassifier, ENamedElement, ecore_EPackage, ecore_ETypeParameter, ecore_EEnumLiteral, ecore_EFactory, EObject, ecore_ENamedElement, ecore_EEnum, EDataType, ETypedElement, ecore_EParameter, ecore_ETypedElement},
    associations={details1, eModelElement2, contents3, references5, eSuperTypes9, eOperations10, eAllAttributes11, eAllReferences14, eReferences16, eAttributes19, eAllContainments22, eAllOperations25, eAllStructuralFeatures27, eAttributeType0, eIDAttribute32, eStructuralFeatures35, eGenericSuperTypes37, eAllGenericSuperTypes39, ePackage42, eTypeParameters43, eAllSuperTypes30, eLiterals44, eEnum45, ePackage46, eAnnotations48, eContainingClass49, eTypeParameters50, eParameters53, eExceptions54, eGenericExceptions57, eOperation69, eOpposite72, eReferenceType74, eKeys77, eContainingClass80, eFactoryInstance60, eClassifiers61, eSubpackages64, eSuperPackage67, eGenericType84, eType82, eUpperBound88, eTypeArguments91, eRawType93, eLowerBound97, eTypeParameter99, eClassifier102, eBounds105},
    generalizations={gen_ecore_EAttribute_EStructuralFeature, gen_ecore_EClass_EClassifier, gen_ecore_EAnnotation_EModelElement, gen_ecore_EClassifier_ENamedElement, gen_ecore_EEnumLiteral_ENamedElement, gen_ecore_EFactory_EModelElement, gen_ecore_EModelElement_EObject, gen_ecore_ENamedElement_EModelElement, gen_ecore_EDataType_EClassifier, gen_ecore_EEnum_EDataType, gen_ecore_EOperation_ETypedElement, gen_ecore_EPackage_ENamedElement, gen_ecore_EParameter_ETypedElement, gen_ecore_EReference_EStructuralFeature, gen_ecore_EStructuralFeature_ETypedElement, gen_ecore_ETypedElement_ENamedElement, gen_ecore_EGenericType_EObject, gen_ecore_ETypeParameter_ENamedElement},
    metadata=None
)
