...
def test_hyp_familytree_member_is_not_abstract():
    assert not inspect.isabstract(familytree_Member)


def test_hyp_familytree_member_constructor_exists():
    assert callable(familytree_Member.__init__)


def test_hyp_familytree_member_constructor_args():
...
def test_hyp_familytree_member_age_setter(instance):
...
@given(instance=familytree_Member_strategy)
def test_hyp_familytree_member_name_setter(instance):
