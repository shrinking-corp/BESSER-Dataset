...
public class cst_Template extends Block, ModuleElement {
    ...
    public cst_Template(
        ArrayList<cst_Variable> cst_variables,        ArrayList<cst_TemplateOverridesValue> cst_templateoverridesvalues    ) {
