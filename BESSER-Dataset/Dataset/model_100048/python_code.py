...
class research2_Review(Labelled):
    ...
    def __init__(self, date: date, research2_Review26: "research2_ReviewNote" = None, research2_Review: "research2_Researcher" = None):
        self.date = date
...
class research2_Researcher:
    ...
    def __init__(self, name: str, forName: str, research2_Researcher29: "research2_PublicationStructure" = None, research2_Researcher: set["research2_Write"] = None, research2_Researcher3: set["research2_Review"] = None, authors: set["research2_Paper"] = None, research2_Researcher6: set["research2_Skill"] = None, research2_Researcher8: "research2_Position" = None, Researcher: "research2_Paper" = None):
        self.name = name
...
class research2_ReviewNote(Named):
    ...
    def __init__(self, content: str, research2_ReviewNote27: "research2_Review" = None, research2_ReviewNote: "research2_Paragraph" = None):
...
class research2_Position(Named):
    ...
    def __init__(self, description: str, research2_Position42: "research2_PublicationSystem" = None, research2_Position45: "research2_Position" = None, research2_Position43: "research2_Position" = None, research2_Position: "research2_Researcher" = None):
        self.description = description
...
class research2_Keyword(Named):
    ...
    def __init__(self, description: str, keywords: set["research2_Paper"] = None, research2_Keyword: "research2_KnowledgeManager" = None, Keyword: "research2_Paper" = None):
        self.description = description
...
class research2_PublicationProcess(Named):
    ...
    def __init__(self, minTime: int, maxTime: int, research2_PublicationProcess: set["research2_Phase"] = None, research2_PublicationProcess36: "research2_PublicationSystem" = None, research2_PublicationProcess19: "research2_Progress" = None):
