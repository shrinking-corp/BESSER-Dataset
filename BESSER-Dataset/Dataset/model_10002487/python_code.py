...
class Department:
    ...
    def __init__(self, course: Course, students__: Student, teachers__: Teacher, hod: HOD, student4: set["Student"] = None, employee6: set["Employee_Interface"] = None, course0: "Course" = None, access_Information19: "Access_Information" = None):
        self.course = course
