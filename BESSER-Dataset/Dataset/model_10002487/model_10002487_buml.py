...
domain_model = DomainModel(
    name="b935d27c_e8fd_46b3_96f8_cad84a68c252",
    ...
    associations={Course_Subject, Department_Student, Department_Employee, Student_Access_Information, Employee_Access_Information, Admin_Student, Admin_Employee, Department_Course, Access_Information_Attendance, Access_Information_Department},
    generalizations={},
    metadata=None
)
