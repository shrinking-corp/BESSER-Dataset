...
class adlrecur_Interface(ABC):
    ...
    def __init__(self, name: str, signature: str, adlrecur_Interface6: "adlrecur_Binding" = None, adlrecur_Interface9: "adlrecur_Binding" = None, adlrecur_Interface: set["adlrecur_Binding"] = None):
        self.name = name
