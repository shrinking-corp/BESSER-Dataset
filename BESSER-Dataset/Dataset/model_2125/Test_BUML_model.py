...
# Classes
test_AddressModel = Class(name="test_AddressModel")
test_TestModel = Class(name="test_TestModel")
test_ConfigurationModel = Class(name="test_ConfigurationModel")
...
test_AddressModel.attributes={test_AddressModel_street, test_AddressModel_validTo, test_AddressModel_zipCode, test_AddressModel_differentPostAddress, test_AddressModel_validFrom, test_AddressModel_houseNumber}
...
test_TestModel.attributes={test_TestModel_childCount, test_TestModel_gender, test_TestModel_name, test_TestModel_overdrawAccount, test_TestModel_accountBalance, test_TestModel_isSelectable, test_TestModel_birthDate, test_TestModel_age}
...
domain_model = DomainModel(
    name="test",
    types={test_AddressModel, test_TestModel, test_ConfigurationModel, Gender},
