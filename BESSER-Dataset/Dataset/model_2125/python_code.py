...
class test_TestModel:
    ...
    def __init__(self, isSelectable: str, gender: str, name: str, birthDate: date, overdrawAccount: str, childCount: str, age: int, accountBalance: str, test_TestModel: "test_AddressModel" = None, test_TestModel2: "test_ConfigurationModel" = None, test_TestModel5: "test_ConfigurationModel" = None):
