...
class tdt4250_Course:
    ...
    def __init__(self, ID: int, credit: int, name: str, tdt4250_Course4: set["tdt4250__bDYekCdxEeKsSJflfBDxuw"] = None, tdt4250_Course: set["tdt4250__bDNfcCdxEeKsSJflfBDxuw"] = None, tdt4250_Course2: set["tdt4250__bDTmECdxEeKsSJflfBDxuw"] = None):
        self.ID = ID
        self.credit = credit
        self.name = name
...
class tdt4250_Assignment:
    ...
    def __init__(self, ID: int, name: str, content: str, mandatory: bool, tdt4250_Assignment: set["tdt4250__bDSX8CdxEeKsSJflfBDxuw"] = None):
        self.ID = ID
        self.name = name
        self.content = content
