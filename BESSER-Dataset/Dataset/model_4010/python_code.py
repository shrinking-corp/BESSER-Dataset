...
class class_Association:
    ...
    def __init__(self, id: str, class_Association: "class_ClassDiagram" = None, class_Association9: "class_Clazz" = None, class_Association12: "class_Clazz" = None):
        self.id = id
...
class class_Clazz:
    ...
    def __init__(self, id: str, class_Clazz: "class_ClassDiagram" = None, class_Clazz4: set["class_Attribute"] = None, class_Clazz7: "class_Clazz" = None, class_Clazz5: "class_Clazz" = None, class_Clazz10: "class_Association" = None, class_Clazz13: "class_Association" = None):
        self.id = id
