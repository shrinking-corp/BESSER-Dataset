...
# Classes
class_ClassDiagram = Class(name="class_ClassDiagram")
class_Clazz = Class(name="class_Clazz")
class_Association = Class(name="class_Association")
...
domain_model = DomainModel(
    ...
    associations={classes0, associations1, attribute3, super6, source8, target11},
    generalizations={},
    metadata=None
)
