...
class PetriNets_Place:
    ...
    def __init__(self, name: str, capacity: int, numberOfTokens: int, PetriNets_Place18: "PetriNets_OutputArc" = None, PetriNets_Place: "PetriNets_PetriNet" = None, PetriNets_Place9: "PetriNets_InputArc" = None):
        self.name = name
...
class PetriNets_OutputArc:
    ...
    def __init__(self, weight: int, PetriNets_OutputArc14: "PetriNets_Transition" = None, PetriNets_OutputArc17: "PetriNets_Place" = None, PetriNets_OutputArc: "PetriNets_PetriNet" = None):
        self.weight = weight
...
class PetriNets_InputArc:
    ...
    def __init__(self, weight: int, PetriNets_InputArc11: "PetriNets_Transition" = None, PetriNets_InputArc: "PetriNets_PetriNet" = None, PetriNets_InputArc8: "PetriNets_Place" = None):
        self.weight = weight
...
class PetriNets_Transition:
    ...
    def __init__(self, name: str, PetriNets_Transition12: "PetriNets_InputArc" = None, PetriNets_Transition15: "PetriNets_OutputArc" = None, PetriNets_Transition: "PetriNets_PetriNet" = None):
        self.name = name
