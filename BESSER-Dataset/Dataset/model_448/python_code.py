...
class UML2WithID_Profile(Package, Element):
    ...
    pass
class UML2WithID_Operation(BehavioralFeature, Element, ParameterableElement, TypedElement, MultiplicityElement):
...
class UML2WithID_Expression(OpaqueExpression, Element):
    ...
    pass
class UML2WithID_State(RedefinableElement, Namespace, Vertex, Element):
...
class UML2WithID_LiteralUnlimitedNatural(LiteralSpecification, Element):
    ...
    pass
class UML2WithID_ActivityPartition(ActivityGroup, NamedElement, Element):
...
class UML2WithID_DestroyLinkAction(WriteLinkAction, Element):
    ...
    pass
class UML2WithID_Classifier(Type, RedefinableElement, Namespace, Element):
...
class UML2WithID_CallAction(InvocationAction, Element):
    ...
    pass
class UML2WithID_Extend(DirectedRelationship, NamedElement, Element):
...
class UML2WithID_TimeExpression(ValueSpecification, Element):
    ...
    pass
class UML2WithID_StructuralFeature(TypedElement, MultiplicityElement, Feature, Element):
...
class UML2WithID_Substitution(Realization, Element):
    ...
    pass
class UML2WithID_Property(ConnectableElement, StructuralFeature, Element, DeploymentTarget):
