...
class typesystem_UnitProduct(ABC):
    ...
    def getFactor(self, typesystem_symbol) :
...
class typesystem_Unit:
    ...
    def __init__(self, scale: int, wildcard: bool, typesystem_Unit10: "typesystem_UnitNumerator" = None, typesystem_Unit12: "typesystem_UnitDenominator" = None, typesystem_Unit15: "typesystem_NumericLiteral" = None, typesystem_Unit: "typesystem_NumericType" = None):
        self.scale = scale
    ...
    def isEquivalentTo(self, typesystem_ignoreScale, typesystem_other) :
        # TODO: Implement isEquivalentTo method
        pass

    def evaluate(self, typesystem_operator, typesystem_n) :
...
class typesystem_ArrayType(DataType):
    ...
    def __init__(self, dimensionality: int, dimensional: bool, multidimensional: bool, typesystem_ArrayType3: "typesystem_DataType" = None, typesystem_ArrayType6: set["typesystem_ArrayDimension"] = None, typesystem_ArrayType: "typesystem_DataType" = None):
...
class typesystem_DataType(ABC):
    ...
    def __init__(self, typesystem_DataType4: "typesystem_ArrayType" = None, typesystem_DataType: "typesystem_ArrayType" = None):
    ...
    def isAssignableFrom(self, typesystem_other) :
    ...
    def isEquivalentTo(self, typesystem_other) :
        # TODO: Implement isEquivalentTo method
        pass
