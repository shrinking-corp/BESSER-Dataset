...
# Classes
typesystem_DataType = Class(name="typesystem_DataType", is_abstract=True)
typesystem_InvalidDataType = Class(name="typesystem_InvalidDataType")
DataType = Class(name="DataType")
typesystem_AnyDataType = Class(name="typesystem_AnyDataType")
typesystem_UnitType = Class(name="typesystem_UnitType")
typesystem_PrimitiveType = Class(name="typesystem_PrimitiveType")
typesystem_NumericType = Class(name="typesystem_NumericType")
PrimitiveType = Class(name="PrimitiveType")
typesystem_Unit = Class(name="typesystem_Unit")
typesystem_RealType = Class(name="typesystem_RealType")
NumericType = Class(name="NumericType")
typesystem_IntegerType = Class(name="typesystem_IntegerType")
typesystem_ComplexType = Class(name="typesystem_ComplexType")
typesystem_GaussianType = Class(name="typesystem_GaussianType")
typesystem_BooleanType = Class(name="typesystem_BooleanType")
typesystem_StringType = Class(name="typesystem_StringType")
typesystem_ArrayType = Class(name="typesystem_ArrayType")
typesystem_ArrayDimension = Class(name="typesystem_ArrayDimension")
typesystem_TensorType = Class(name="typesystem_TensorType")
ArrayType = Class(name="ArrayType")
typesystem_BooleanLiteral = Class(name="typesystem_BooleanLiteral")
typesystem_Expression = Class(name="typesystem_Expression")
typesystem_UnitNumerator = Class(name="typesystem_UnitNumerator")
typesystem_UnitDenominator = Class(name="typesystem_UnitDenominator")
typesystem_UnitProduct = Class(name="typesystem_UnitProduct", is_abstract=True)
typesystem_UnitFactor = Class(name="typesystem_UnitFactor")
UnitProduct = Class(name="UnitProduct")
typesystem_Literal = Class(name="typesystem_Literal")
Expression = Class(name="Expression")
typesystem_NumericLiteral = Class(name="typesystem_NumericLiteral")
Literal = Class(name="Literal")
typesystem_RealLiteral = Class(name="typesystem_RealLiteral")
NumericLiteral = Class(name="NumericLiteral")
typesystem_IntegerLiteral = Class(name="typesystem_IntegerLiteral")
typesystem_StringLiteral = Class(name="typesystem_StringLiteral")

# typesystem_DataType class attributes and methods
typesystem_DataType_m_evaluate: Method = Method(name="evaluate", parameters={Parameter(name='typesystem_other', type=StringType), Parameter(name='typesystem_operator', type=StringType)}, type=StringType)
typesystem_DataType_m_evaluate: Method = Method(name="evaluate", parameters={Parameter(name='typesystem_operator', type=StringType), Parameter(name='typesystem_n', type=StringType)}, type=StringType)
typesystem_DataType_m_isAssignableFrom: Method = Method(name="isAssignableFrom", parameters={Parameter(name='typesystem_other', type=StringType)}, type=BooleanType)
typesystem_DataType_m_isEquivalentTo: Method = Method(name="isEquivalentTo", parameters={Parameter(name='typesystem_other', type=StringType)}, type=BooleanType)
typesystem_DataType.methods={typesystem_DataType_m_evaluate, typesystem_DataType_m_evaluate, typesystem_DataType_m_isEquivalentTo, typesystem_DataType_m_isAssignableFrom}
...
typesystem_Unit_m_evaluate: Method = Method(name="evaluate", parameters={Parameter(name='typesystem_other', type=StringType), Parameter(name='typesystem_operator', type=StringType)}, type=StringType)
typesystem_Unit_m_evaluate: Method = Method(name="evaluate", parameters={Parameter(name='typesystem_operator', type=StringType), Parameter(name='typesystem_n', type=StringType)}, type=StringType)
typesystem_Unit_m_isEquivalentTo: Method = Method(name="isEquivalentTo", parameters={Parameter(name='typesystem_other', type=StringType), Parameter(name='typesystem_ignoreScale', type=StringType)}, type=BooleanType)
typesystem_Unit.attributes={typesystem_Unit_scale, typesystem_Unit_wildcard}
typesystem_Unit.methods={typesystem_Unit_m_evaluate, typesystem_Unit_m_getNormalized, typesystem_Unit_m_evaluate, typesystem_Unit_m_isEquivalentTo}
...
typesystem_ArrayType.attributes={typesystem_ArrayType_multidimensional, typesystem_ArrayType_dimensional, typesystem_ArrayType_dimensionality}
...
typesystem_UnitProduct_m_getFactor: Method = Method(name="getFactor", parameters={Parameter(name='typesystem_symbol', type=StringType)}, type=StringType)
...
domain_model = DomainModel(
    name="typesystem",
    types={typesystem_DataType, typesystem_InvalidDataType, DataType, typesystem_AnyDataType, typesystem_UnitType, typesystem_PrimitiveType, typesystem_NumericType, PrimitiveType, typesystem_Unit, typesystem_RealType, NumericType, typesystem_IntegerType, typesystem_ComplexType, typesystem_GaussianType, typesystem_BooleanType, typesystem_StringType, typesystem_ArrayType, typesystem_ArrayDimension, typesystem_TensorType, ArrayType, typesystem_BooleanLiteral, typesystem_Expression, typesystem_UnitNumerator, typesystem_UnitDenominator, typesystem_UnitProduct, typesystem_UnitFactor, UnitProduct, typesystem_Literal, Expression, typesystem_NumericLiteral, Literal, typesystem_RealLiteral, NumericLiteral, typesystem_IntegerLiteral, typesystem_StringLiteral, OperatorKind},
    associations={unit0, elementType1, definedElementType2, dimensions5, size7, numerator9, denominator11, factors13, unit14},
    generalizations={gen_typesystem_InvalidDataType_DataType, gen_typesystem_AnyDataType_DataType, gen_typesystem_UnitType_DataType, gen_typesystem_PrimitiveType_DataType, gen_typesystem_NumericType_PrimitiveType, gen_typesystem_RealType_NumericType, gen_typesystem_IntegerType_NumericType, gen_typesystem_ComplexType_NumericType, gen_typesystem_GaussianType_NumericType, gen_typesystem_BooleanType_PrimitiveType, gen_typesystem_StringType_PrimitiveType, gen_typesystem_ArrayType_DataType, gen_typesystem_TensorType_ArrayType, gen_typesystem_UnitNumerator_UnitProduct, gen_typesystem_UnitDenominator_UnitProduct, gen_typesystem_Literal_Expression, gen_typesystem_NumericLiteral_Literal, gen_typesystem_RealLiteral_NumericLiteral, gen_typesystem_IntegerLiteral_NumericLiteral, gen_typesystem_BooleanLiteral_Literal, gen_typesystem_StringLiteral_Literal},
    metadata=None
)
