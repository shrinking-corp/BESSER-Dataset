...
# Classes
zhu_Transitions = Class(name="zhu_Transitions")
zhu_StateMachine = Class(name="zhu_StateMachine")
zhu_TopRegion = Class(name="zhu_TopRegion")
zhu_States = Class(name="zhu_States")
zhu_Region = Class(name="zhu_Region")
zhu_Transition = Class(name="zhu_Transition")
zhu_State = Class(name="zhu_State")
zhu_Triggers = Class(name="zhu_Triggers")
zhu_StatesSeparated = Class(name="zhu_StatesSeparated")
zhu_TriggersSeparated = Class(name="zhu_TriggersSeparated")
...
zhu_TriggersSeparated.attributes={zhu_TriggersSeparated_followingTriggers, zhu_TriggersSeparated_firstTrigger}
...
domain_model = DomainModel(
    name="zhu",
    types={zhu_Transitions, zhu_StateMachine, zhu_TopRegion, zhu_States, zhu_Region, zhu_Transition, zhu_State, zhu_Triggers, zhu_StatesSeparated, zhu_TriggersSeparated},
    associations={transitions5, states7, regions11, transitions13, region0, states1, regions3, firstTransition16, followingTransitions18, source21, target23, triggers26, states28, firstState30, followingStates33, triggers36},
    generalizations={},
    metadata=None
)
