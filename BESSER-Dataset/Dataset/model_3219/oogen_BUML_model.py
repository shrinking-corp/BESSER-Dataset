...
# Classes
oogen_OOClass = Class(name="oogen_OOClass")
oogen_OOEnumeration = Class(name="oogen_OOEnumeration")
oogen_OOPackage = Class(name="oogen_OOPackage")
OOVariable = Class(name="OOVariable")
OOCommentOwner = Class(name="OOCommentOwner")
oogen_OOMember = Class(name="oogen_OOMember")
oogen_OOMethod = Class(name="oogen_OOMethod")
oogen_OOConstructor = Class(name="oogen_OOConstructor")
oogen_OOVariable = Class(name="oogen_OOVariable")
OOStatement = Class(name="OOStatement")
oogen_OOType = Class(name="oogen_OOType")
oogen_OOExpression = Class(name="oogen_OOExpression")
oogen_OOStatement = Class(name="oogen_OOStatement")
oogen_OOAdditionExpression = Class(name="oogen_OOAdditionExpression")
OOTwoOperandAssignableExpression = Class(name="OOTwoOperandAssignableExpression")
oogen_OOSubtractionExpression = Class(name="oogen_OOSubtractionExpression")
oogen_OOModel = Class(name="oogen_OOModel")
oogen_OOReturn = Class(name="oogen_OOReturn")
oogen_OOArithmeticExpression = Class(name="oogen_OOArithmeticExpression")
OOExpression = Class(name="OOExpression")
oogen_OOIndexing = Class(name="oogen_OOIndexing")
oogen_OOAssignmentExpression = Class(name="oogen_OOAssignmentExpression")
oogen_OOTwoOperandArithmeticExpression = Class(name="oogen_OOTwoOperandArithmeticExpression")
OOArithmeticExpression = Class(name="OOArithmeticExpression")
oogen_OOWhile = Class(name="oogen_OOWhile")
oogen_OODivisionExpression = Class(name="oogen_OODivisionExpression")
oogen_OODoWhile = Class(name="oogen_OODoWhile")
oogen_OOIntegerDivisionExpression = Class(name="oogen_OOIntegerDivisionExpression")
oogen_OOEmptyStatement = Class(name="oogen_OOEmptyStatement")
oogen_OOMultiplicationExpression = Class(name="oogen_OOMultiplicationExpression")
oogen_OOPowerExpression = Class(name="oogen_OOPowerExpression")
OOTwoOperandArithmeticExpression = Class(name="OOTwoOperandArithmeticExpression")
oogen_OORootExpression = Class(name="oogen_OORootExpression")
oogen_OOBitwiseOrExpression = Class(name="oogen_OOBitwiseOrExpression")
oogen_OOBitwiseXorExpression = Class(name="oogen_OOBitwiseXorExpression")
oogen_OOBitwiseAndExpression = Class(name="oogen_OOBitwiseAndExpression")
oogen_OOLogicalExpression = Class(name="oogen_OOLogicalExpression")
oogen_OOAndExpression = Class(name="oogen_OOAndExpression")
OOTwoOperandLogicalExpression = Class(name="OOTwoOperandLogicalExpression")
oogen_OOOrExpression = Class(name="oogen_OOOrExpression")
oogen_OOXorExpression = Class(name="oogen_OOXorExpression")
oogen_OONotExpression = Class(name="oogen_OONotExpression")
OOOneOperandLogicalExpression = Class(name="OOOneOperandLogicalExpression")
oogen_OOTwoOperandLogicalExpression = Class(name="oogen_OOTwoOperandLogicalExpression")
OOLogicalExpression = Class(name="OOLogicalExpression")
oogen_OOOneOperandLogicalExpression = Class(name="oogen_OOOneOperandLogicalExpression")
oogen_OODoubleLiteral = Class(name="oogen_OODoubleLiteral")
oogen_OOFloatLiteral = Class(name="oogen_OOFloatLiteral")
oogen_OOIntegerLiteral = Class(name="oogen_OOIntegerLiteral")
oogen_OOLongLiteral = Class(name="oogen_OOLongLiteral")
oogen_OOIf = Class(name="oogen_OOIf")
OOConditionalStatement = Class(name="OOConditionalStatement")
oogen_OOFor = Class(name="oogen_OOFor")
oogen_OOConditionalStatement = Class(name="oogen_OOConditionalStatement")
OOCompoundStatement = Class(name="OOCompoundStatement")
oogen_OOGreaterThanExpression = Class(name="oogen_OOGreaterThanExpression")
oogen_OOLessThanExpression = Class(name="oogen_OOLessThanExpression")
oogen_OONotEqualsExpression = Class(name="oogen_OONotEqualsExpression")
oogen_OOGreaterEqualsExpression = Class(name="oogen_OOGreaterEqualsExpression")
oogen_OOLessEqualsExpression = Class(name="oogen_OOLessEqualsExpression")
oogen_OOCompoundStatement = Class(name="oogen_OOCompoundStatement")
oogen_OOForEach = Class(name="oogen_OOForEach")
oogen_OOBitWiseLeftShift = Class(name="oogen_OOBitWiseLeftShift")
oogen_OOBitWiseRightShift = Class(name="oogen_OOBitWiseRightShift")
oogen_OOBitWiseComplement = Class(name="oogen_OOBitWiseComplement")
OOOneOperandArithmeticExpression = Class(name="OOOneOperandArithmeticExpression")
oogen_OOLanguageSpecificExpression = Class(name="oogen_OOLanguageSpecificExpression")
oogen_OOLanguageSpecificSnippet = Class(name="oogen_OOLanguageSpecificSnippet")
oogen_OOTypeCast = Class(name="oogen_OOTypeCast")
oogen_OOBoolLiteral = Class(name="oogen_OOBoolLiteral")
oogen_OONewClass = Class(name="oogen_OONewClass")
oogen_OOEqualsExpression = Class(name="oogen_OOEqualsExpression")
OOComparatorExpression = Class(name="OOComparatorExpression")
oogen_OOComparatorExpression = Class(name="oogen_OOComparatorExpression")
oogen_OOLogicalLiteral = Class(name="oogen_OOLogicalLiteral")
oogen_OOSwitch = Class(name="oogen_OOSwitch")
oogen_OOCase = Class(name="oogen_OOCase")
oogen_OODefault = Class(name="oogen_OODefault")
oogen_OOBreak = Class(name="oogen_OOBreak")
oogen_OOTwoOperandAssignableExpression = Class(name="oogen_OOTwoOperandAssignableExpression")
oogen_OOModuloExpression = Class(name="oogen_OOModuloExpression")
oogen_OOContinue = Class(name="oogen_OOContinue")
oogen_OOVariableDeclarationList = Class(name="oogen_OOVariableDeclarationList")
oogen_OOOneOperandArithmeticExpression = Class(name="oogen_OOOneOperandArithmeticExpression")
oogen_OOBracketedExpression = Class(name="oogen_OOBracketedExpression")
oogen_OOPostfixIncrementExpression = Class(name="oogen_OOPostfixIncrementExpression")
oogen_OOPrefixIncrementExpression = Class(name="oogen_OOPrefixIncrementExpression")
oogen_OOPostfixDecrementExpression = Class(name="oogen_OOPostfixDecrementExpression")
oogen_OOPrefixDecrementExpression = Class(name="oogen_OOPrefixDecrementExpression")
oogen_OOPlusExpression = Class(name="oogen_OOPlusExpression")
oogen_OOMinusExpression = Class(name="oogen_OOMinusExpression")
oogen_OOTernaryOperator = Class(name="oogen_OOTernaryOperator")
oogen_OOFieldReferenceExpression = Class(name="oogen_OOFieldReferenceExpression")
oogen_OOVariableReferenceExpression = Class(name="oogen_OOVariableReferenceExpression")
oogen_OOInitializerList = Class(name="oogen_OOInitializerList")
oogen_OOThisLiteral = Class(name="oogen_OOThisLiteral")
oogen_OONullLiteral = Class(name="oogen_OONullLiteral")
oogen_OOFunctionCallExpression = Class(name="oogen_OOFunctionCallExpression")
oogen_OOStringLiteral = Class(name="oogen_OOStringLiteral")
oogen_OONewArray = Class(name="oogen_OONewArray")
oogen_OOComment = Class(name="oogen_OOComment")
oogen_OOCommentOwner = Class(name="oogen_OOCommentOwner")
oogen_OOEmptyExpression = Class(name="oogen_OOEmptyExpression")
...
oogen_OOClass.attributes={oogen_OOClass_languages, oogen_OOClass_keep, oogen_OOClass_name}
...
oogen_OOEnumeration.attributes={oogen_OOEnumeration_options, oogen_OOEnumeration_name}
...
oogen_OOMember.attributes={oogen_OOMember_static, oogen_OOMember_languages, oogen_OOMember_visibility}
...
oogen_OOMethod.attributes={oogen_OOMethod_static, oogen_OOMethod_visibility, oogen_OOMethod_name, oogen_OOMethod_languages}
...
oogen_OOType.attributes={oogen_OOType_arrayDimensions, oogen_OOType_collectionType, oogen_OOType_numberOfIndirections, oogen_OOType_baseType}
...
oogen_OOLanguageSpecificSnippet.attributes={oogen_OOLanguageSpecificSnippet_code, oogen_OOLanguageSpecificSnippet_lang}
...
domain_model = DomainModel(
    name="oogen",
    types={oogen_OOClass, oogen_OOEnumeration, oogen_OOPackage, OOVariable, OOCommentOwner, oogen_OOMember, oogen_OOMethod, oogen_OOConstructor, oogen_OOVariable, OOStatement, oogen_OOType, oogen_OOExpression, oogen_OOStatement, oogen_OOAdditionExpression, OOTwoOperandAssignableExpression, oogen_OOSubtractionExpression, oogen_OOModel, oogen_OOReturn, oogen_OOArithmeticExpression, OOExpression, oogen_OOIndexing, oogen_OOAssignmentExpression, oogen_OOTwoOperandArithmeticExpression, OOArithmeticExpression, oogen_OOWhile, oogen_OODivisionExpression, oogen_OODoWhile, oogen_OOIntegerDivisionExpression, oogen_OOEmptyStatement, oogen_OOMultiplicationExpression, oogen_OOPowerExpression, OOTwoOperandArithmeticExpression, oogen_OORootExpression, oogen_OOBitwiseOrExpression, oogen_OOBitwiseXorExpression, oogen_OOBitwiseAndExpression, oogen_OOLogicalExpression, oogen_OOAndExpression, OOTwoOperandLogicalExpression, oogen_OOOrExpression, oogen_OOXorExpression, oogen_OONotExpression, OOOneOperandLogicalExpression, oogen_OOTwoOperandLogicalExpression, OOLogicalExpression, oogen_OOOneOperandLogicalExpression, oogen_OODoubleLiteral, oogen_OOFloatLiteral, oogen_OOIntegerLiteral, oogen_OOLongLiteral, oogen_OOIf, OOConditionalStatement, oogen_OOFor, oogen_OOConditionalStatement, OOCompoundStatement, oogen_OOGreaterThanExpression, oogen_OOLessThanExpression, oogen_OONotEqualsExpression, oogen_OOGreaterEqualsExpression, oogen_OOLessEqualsExpression, oogen_OOCompoundStatement, oogen_OOForEach, oogen_OOBitWiseLeftShift, oogen_OOBitWiseRightShift, oogen_OOBitWiseComplement, OOOneOperandArithmeticExpression, oogen_OOLanguageSpecificExpression, oogen_OOLanguageSpecificSnippet, oogen_OOTypeCast, oogen_OOBoolLiteral, oogen_OONewClass, oogen_OOEqualsExpression, OOComparatorExpression, oogen_OOComparatorExpression, oogen_OOLogicalLiteral, oogen_OOSwitch, oogen_OOCase, oogen_OODefault, oogen_OOBreak, oogen_OOTwoOperandAssignableExpression, oogen_OOModuloExpression, oogen_OOContinue, oogen_OOVariableDeclarationList, oogen_OOOneOperandArithmeticExpression, oogen_OOBracketedExpression, oogen_OOPostfixIncrementExpression, oogen_OOPrefixIncrementExpression, oogen_OOPostfixDecrementExpression, oogen_OOPrefixDecrementExpression, oogen_OOPlusExpression, oogen_OOMinusExpression, oogen_OOTernaryOperator, oogen_OOFieldReferenceExpression, oogen_OOVariableReferenceExpression, oogen_OOInitializerList, oogen_OOThisLiteral, oogen_OONullLiteral, oogen_OOFunctionCallExpression, oogen_OOStringLiteral, oogen_OONewArray, oogen_OOComment, oogen_OOCommentOwner, oogen_OOEmptyExpression, OOBaseType, OOVisibility, OOCollectionType, OOLanguage},
    associations={classes0, enums1, members2, package3, methods4, constructors6, statements26, type8, initializerExpression9, classType11, arraySizeExpressions14, enumType17, parameters20, returnType23, oopackage28, packages30, globalVariables33, globalFunctions36, returnedExpresssion39, indexExpression41, collectionExpression43, leftSide46, rightSide48, rightSide51, condition73, leftSide53, leftSide56, rightSide58, operand61, elseStatements63, elseIf66, initStatement68, incrementExpression70, traversedVariable75, loopVariable77, bodyStatements80, snippets83, type84, expression86, constructorParameterExpressions89, leftSide91, rightSide93, condition111, positiveBranch113, bodyStatements96, controllerExpression98, caseStatements100, defaultStatement102, expression104, variableDeclarations107, operand109, beforeComments141, afterComments142, negativeBranch116, fieldOwner119, variable121, initializerExpressions123, argumentExpressions125, ownerExpression127, parameters130, statements133, arrayType136, initializerList138, package145},
    generalizations={gen_oogen_OOMember_OOVariable, gen_oogen_OOClass_OOCommentOwner, gen_oogen_OOVariable_OOStatement, gen_oogen_OOMethod_OOCommentOwner, gen_oogen_OOAdditionExpression_OOTwoOperandAssignableExpression, gen_oogen_OOSubtractionExpression_OOTwoOperandAssignableExpression, gen_oogen_OOStatement_OOCommentOwner, gen_oogen_OOExpression_OOStatement, gen_oogen_OOReturn_OOStatement, gen_oogen_OOArithmeticExpression_OOExpression, gen_oogen_OOIndexing_OOExpression, gen_oogen_OOAssignmentExpression_OOExpression, gen_oogen_OOTwoOperandArithmeticExpression_OOArithmeticExpression, gen_oogen_OOWhile_OOConditionalStatement, gen_oogen_OODivisionExpression_OOTwoOperandAssignableExpression, gen_oogen_OODoWhile_OOConditionalStatement, gen_oogen_OOIntegerDivisionExpression_OOTwoOperandAssignableExpression, gen_oogen_OOEmptyStatement_OOStatement, gen_oogen_OOMultiplicationExpression_OOTwoOperandAssignableExpression, gen_oogen_OOPowerExpression_OOTwoOperandArithmeticExpression, gen_oogen_OORootExpression_OOTwoOperandArithmeticExpression, gen_oogen_OOBitwiseOrExpression_OOTwoOperandAssignableExpression, gen_oogen_OOBitwiseXorExpression_OOTwoOperandAssignableExpression, gen_oogen_OOBitwiseAndExpression_OOTwoOperandAssignableExpression, gen_oogen_OOLogicalExpression_OOExpression, gen_oogen_OOAndExpression_OOTwoOperandLogicalExpression, gen_oogen_OOOrExpression_OOTwoOperandLogicalExpression, gen_oogen_OOXorExpression_OOTwoOperandLogicalExpression, gen_oogen_OONotExpression_OOOneOperandLogicalExpression, gen_oogen_OOTwoOperandLogicalExpression_OOLogicalExpression, gen_oogen_OOOneOperandLogicalExpression_OOLogicalExpression, gen_oogen_OODoubleLiteral_OOArithmeticExpression, gen_oogen_OOFloatLiteral_OOArithmeticExpression, gen_oogen_OOIntegerLiteral_OOArithmeticExpression, gen_oogen_OOLongLiteral_OOArithmeticExpression, gen_oogen_OOIf_OOConditionalStatement, gen_oogen_OOFor_OOConditionalStatement, gen_oogen_OOConditionalStatement_OOStatement, gen_oogen_OOConditionalStatement_OOCompoundStatement, gen_oogen_OOGreaterThanExpression_OOComparatorExpression, gen_oogen_OOLessThanExpression_OOComparatorExpression, gen_oogen_OONotEqualsExpression_OOComparatorExpression, gen_oogen_OOGreaterEqualsExpression_OOComparatorExpression, gen_oogen_OOLessEqualsExpression_OOComparatorExpression, gen_oogen_OOCompoundStatement_OOStatement, gen_oogen_OOForEach_OOStatement, gen_oogen_OOBitWiseLeftShift_OOTwoOperandAssignableExpression, gen_oogen_OOBitWiseRightShift_OOTwoOperandAssignableExpression, gen_oogen_OOBitWiseComplement_OOOneOperandArithmeticExpression, gen_oogen_OOLanguageSpecificExpression_OOExpression, gen_oogen_OOLanguageSpecificExpression_OOLogicalExpression, gen_oogen_OOTypeCast_OOExpression, gen_oogen_OOBoolLiteral_OOExpression, gen_oogen_OONewClass_OOExpression, gen_oogen_OOEqualsExpression_OOComparatorExpression, gen_oogen_OOComparatorExpression_OOLogicalExpression, gen_oogen_OOLogicalLiteral_OOLogicalExpression, gen_oogen_OOSwitch_OOStatement, gen_oogen_OOCase_OOCompoundStatement, gen_oogen_OOBreak_OOStatement, gen_oogen_OODefault_OOCompoundStatement, gen_oogen_OOTwoOperandAssignableExpression_OOTwoOperandArithmeticExpression, gen_oogen_OOModuloExpression_OOTwoOperandAssignableExpression, gen_oogen_OOContinue_OOStatement, gen_oogen_OOVariableDeclarationList_OOStatement, gen_oogen_OOOneOperandArithmeticExpression_OOArithmeticExpression, gen_oogen_OOBracketedExpression_OOOneOperandArithmeticExpression, gen_oogen_OOPostfixIncrementExpression_OOOneOperandArithmeticExpression, gen_oogen_OOPrefixIncrementExpression_OOOneOperandArithmeticExpression, gen_oogen_OOPostfixDecrementExpression_OOOneOperandArithmeticExpression, gen_oogen_OOPrefixDecrementExpression_OOOneOperandArithmeticExpression, gen_oogen_OOPlusExpression_OOOneOperandArithmeticExpression, gen_oogen_OOMinusExpression_OOOneOperandArithmeticExpression, gen_oogen_OOTernaryOperator_OOLogicalExpression, gen_oogen_OOEnumeration_OOCommentOwner, gen_oogen_OOFieldReferenceExpression_OOExpression, gen_oogen_OOVariableReferenceExpression_OOExpression, gen_oogen_OOInitializerList_OOExpression, gen_oogen_OOThisLiteral_OOExpression, gen_oogen_OONullLiteral_OOExpression, gen_oogen_OOFunctionCallExpression_OOExpression, gen_oogen_OOStringLiteral_OOExpression, gen_oogen_OONewArray_OOExpression, gen_oogen_OOEmptyExpression_OOExpression},
    metadata=None
)
