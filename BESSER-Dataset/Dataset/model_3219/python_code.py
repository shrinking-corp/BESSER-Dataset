...
class oogen_OOAssignmentExpression(OOExpression):
    ...
    pass
class oogen_OOLanguageSpecificExpression(OOLogicalExpression, OOExpression):
...
class oogen_OOVariable(OOStatement):
    ...
    def __init__(self, name: str, transient: bool, oogen_OOVariable108: "oogen_OOVariableDeclarationList" = None, oogen_OOVariable: "oogen_OOType" = None, oogen_OOVariable10: "oogen_OOExpression" = None, oogen_OOVariable22: "oogen_OOMethod" = None, oogen_OOVariable35: "oogen_OOModel" = None, oogen_OOVariable76: "oogen_OOForEach" = None, oogen_OOVariable79: "oogen_OOForEach" = None, oogen_OOVariable122: "oogen_OOVariableReferenceExpression" = None, oogen_OOVariable132: "oogen_OOConstructor" = None):
        self.name = name
...
class oogen_OOMethod(OOCommentOwner):
    ...
    def __init__(self, visibility: str, name: str, static: bool, languages: str, oogen_OOMethod: "oogen_OOClass" = None, oogen_OOMethod27: set["oogen_OOStatement"] = None, oogen_OOMethod21: set["oogen_OOVariable"] = None, oogen_OOMethod24: "oogen_OOType" = None, oogen_OOMethod38: "oogen_OOModel" = None):
        self.visibility = visibility
        self.name = name
        self.static = static
