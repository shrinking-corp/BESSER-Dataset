...
# Classes
graphdom_Graph = Class(name="graphdom_Graph")
graphdom_Node = Class(name="graphdom_Node")
graphdom_Edge = Class(name="graphdom_Edge")

# graphdom_Graph class attributes and methods
graphdom_Graph_graphName: Property = Property(name="graphName", type=StringType)
graphdom_Graph_m_findNodeById: Method = Method(name="findNodeById", parameters={Parameter(name='graphdom_id', type=StringType)}, type=StringType)
graphdom_Graph_m_unmarkAllNodes: Method = Method(name="unmarkAllNodes", parameters={})
graphdom_Graph_m_removeNode: Method = Method(name="removeNode", parameters={Parameter(name='graphdom_node', type=StringType)})
...
graphdom_Graph.methods={graphdom_Graph_m_getNextNodeId, graphdom_Graph_m_unmarkAllNodes, graphdom_Graph_m_isDominated, graphdom_Graph_m_findNodeById, graphdom_Graph_m_isIndependentlyDominated, graphdom_Graph_m_isConnectedDomination, graphdom_Graph_m_checkNodesDomination, graphdom_Graph_m_getDominatingSet, graphdom_Graph_m_removeNode, graphdom_Graph_m_isTotallyDominated}
...
graphdom_Node.attributes={graphdom_Node_dominated, graphdom_Node_guid, graphdom_Node_dominating, graphdom_Node_color, graphdom_Node_yCoord, graphdom_Node_nodeName, graphdom_Node_xCoord, graphdom_Node_grade}
...
graphdom_Edge.attributes={graphdom_Edge_guid, graphdom_Edge_marked, graphdom_Edge_weight}
