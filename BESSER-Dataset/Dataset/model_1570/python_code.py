...
class graphdom_Edge:
    ...
    def __init__(self, marked: bool, guid: str, weight: int, graphdom_Edge: "graphdom_Graph" = None, Edge: "graphdom_Node" = None, connectedEdges: set["graphdom_Node"] = None):
        self.marked = marked
        self.guid = guid
        self.weight = weight
...
class graphdom_Node:
    ...
    def __init__(self, color: str, dominating: bool, grade: str, guid: str, xCoord: int, yCoord: int, dominated: bool, nodeName: str, graphdom_Node: "graphdom_Graph" = None, connectedNodes: set["graphdom_Edge"] = None, Node: "graphdom_Edge" = None):
        self.color = color
...
class graphdom_Graph:
    ...
    def removeNode(self, graphdom_node):
        # TODO: Implement removeNode method
        pass

    def isConnectedDomination(self) :
        # TODO: Implement isConnectedDomination method
        pass

    def isTotallyDominated(self) :
    ...
    def isIndependentlyDominated(self) :
        # TODO: Implement isIndependentlyDominated method
        pass

    def findNodeById(self, graphdom_id) :
