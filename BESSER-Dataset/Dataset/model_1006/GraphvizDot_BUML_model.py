...
domain_model = DomainModel(
    name="dot",
    types={dot_GraphvizModel, dot_Graph, dot_NodeStatement, dot_Node, dot_Port, dot_EdgeStatement, dot_EdgeTarget, dot_Subgraph, dot_AttributeStatement, dot_Statement, dot_Attribute, Statement, EdgeOperator, GraphType, AttributeType},
    associations={node3, attributes4, port6, sourceNode8, edgeTargets10, attributes12, targetSubgraph15, targetnode17, attributes20, statements22, graphs0, statements1},
    generalizations={gen_dot_NodeStatement_Statement, gen_dot_EdgeStatement_Statement, gen_dot_AttributeStatement_Statement, gen_dot_Subgraph_Statement, gen_dot_Attribute_Statement},
    metadata=None
)
