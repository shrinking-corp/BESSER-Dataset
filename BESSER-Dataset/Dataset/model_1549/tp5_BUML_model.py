...
# Classes
tp5_Researcher = Class(name="tp5_Researcher")
tp5_Paper = Class(name="tp5_Paper")
tp5_PublicationStructure = Class(name="tp5_PublicationStructure")
tp5_Skill = Class(name="tp5_Skill")
tp5_Position = Class(name="tp5_Position")
tp5_Collaboration = Class(name="tp5_Collaboration")
tp5_Paragraph = Class(name="tp5_Paragraph")
...
tp5_Researcher.attributes={tp5_Researcher_forName, tp5_Researcher_name}
...
tp5_Paragraph.attributes={tp5_Paragraph_name, tp5_Paragraph_id, tp5_Paragraph_content}
...
domain_model = DomainModel(
    name="tp5",
    types={tp5_Researcher, tp5_Paper, tp5_PublicationStructure, tp5_Skill, tp5_Position, tp5_Collaboration, tp5_Paragraph},
    associations={res_papers0, researchers11, papers13, positions16, parent20, skills1, res_position2, collaborations4, paragraphs6, authors7, citedBy9, col_paper22},
    generalizations={},
    metadata=None
)
