...
class tp5_Researcher:
    ...
    def __init__(self, name: str, forName: str, authors: set["tp5_Paper"] = None, tp5_Researcher12: "tp5_PublicationStructure" = None, tp5_Researcher: set["tp5_Skill"] = None, tp5_Researcher3: "tp5_Position" = None, tp5_Researcher5: set["tp5_Collaboration"] = None, Researcher: "tp5_Paper" = None):
        self.name = name
