...
def test_exampleclassrun_is_not_abstract():
    assert not inspect.isabstract(ExampleClassRun)


def test_exampleclassrun_constructor_exists():
    assert callable(ExampleClassRun.__init__)


def test_exampleclassrun_constructor_args():
    sig = inspect.signature(ExampleClassRun.__init__)
    params = list(sig.parameters.keys())



def test_coreinterfacevalid_interface_is_not_abstract():
    assert not inspect.isabstract(CoreInterfaceValid_Interface)


def test_coreinterfacevalid_interface_constructor_exists():
    assert callable(CoreInterfaceValid_Interface.__init__)


def test_coreinterfacevalid_interface_constructor_args():
    sig = inspect.signature(CoreInterfaceValid_Interface.__init__)
    params = list(sig.parameters.keys())
...
ExampleClassRun_strategy = st.builds(
    ExampleClassRun,
)
CoreInterfaceValid_Interface_strategy = st.builds(
    CoreInterfaceValid_Interface,
)
...
@given(instance=ExampleClassRun_strategy)
@settings(max_examples=50)
def test_exampleclassrun_instantiation(instance):
    assert isinstance(instance, ExampleClassRun)

@given(instance=CoreInterfaceValid_Interface_strategy)
@settings(max_examples=50)
def test_coreinterfacevalid_interface_instantiation(instance):
    assert isinstance(instance, CoreInterfaceValid_Interface)
