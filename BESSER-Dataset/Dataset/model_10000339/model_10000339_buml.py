...
CoreInterfaceValid_Interface = Class(name="CoreInterfaceValid_Interface")
ExampleClassRun = Class(name="ExampleClassRun")
...
# CoreInterfaceValid_Interface class attributes and methods

# ExampleClassRun class attributes and methods
...
domain_model = DomainModel(
    name="_2aa488d0_6a6e_4354_a507_db1c90c3a385",
    types={ClassD, ClassE, ClassF, ClassG, ClassJ, ClassH, ClassK, ClassL, ClassM, ClassN, ClassP, InterfaceO_Interface, ClassQ, ClassR, ClassS, ClassT, ClassU, ClassV, CoreInterfaceValid_Interface, ExampleClassRun},
