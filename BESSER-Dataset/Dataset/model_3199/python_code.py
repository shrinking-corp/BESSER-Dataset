...
class plsql_type_IndirectType(Type):
    ...
    def __init__(self, identifier: str, rowtype: bool, type: bool, range: int, Type: "plsql_type_TypedElement" = None):
...
class plsql_type_Datatype(Type):
    ...
    def __init__(self, name: str, range: int, Type: "plsql_type_TypedElement" = None):
        self.name = name
        self.range = range
...
class plsql_condition_BooleanCondition(SQLCondition):
    ...
    def __init__(self, type: str, plsql_condition_BooleanCondition98: "SQLCondition" = None, plsql_condition_BooleanCondition: "SQLCondition" = None, SQLCondition99: "plsql_condition_BooleanCondition" = None, SQLCondition101: "plsql_condition_NotCondition" = None, SQLCondition: "plsql_statement_SelectStatement" = None, SQLCondition50: "plsql_statement_UpdateStatement" = None, SQLCondition96: "plsql_condition_BooleanCondition" = None):
        self.type = type
...
class plsql_statement_SelectStatement(ModifySQLStatement):
    ...
    def __init__(self, distinct: bool, unique: bool, all: bool, selectList: str, bulk: bool, collect: bool, from_: str, isCount: bool, plsql_statement_SelectStatement: set["VarRefExpression"] = None, plsql_statement_SelectStatement41: "SQLCondition" = None, plsql_statement_SelectStatement43: set["Expression"] = None):
...
class plsql_expression_FormsVarRef(VarRefExpression):
    ...
    def __init__(self, reference: str, VarRefExpression39: "plsql_statement_SelectStatement" = None, VarRefExpression: "plsql_statement_FetchStatement" = None):
...
class plsql_statement_RaiseStatement(Statement):
    ...
    def __init__(self, exception: str, Statement14: "plsql_statement_LoopStatement" = None, Statement127: "plsql_declaration_FunctionDeclaration" = None, Statement137: "plsql_declaration_Package" = None, Statement12: "plsql_statement_IfStatement" = None, Statement: "plsql_statement_IfStatement" = None, Statement119: "plsql_declaration_ProcedureDeclaration" = None, Statement54: "plsql_statement_ExceptionSection" = None, Statement24: "plsql_statement_BlockStatement" = None):
...
class plsql_declaration_TriggerBlock(statement_BlockStatement, declaration_NamedElement):
    ...
    pass
class plsql_declaration_Argument(declaration_NamedElement, type_TypedElement):

    def __init__(self, in_: bool, out: bool, default: bool, plsql_declaration_Argument: "Expression" = None):
        self.in_ = in_
        self.out = out
        self.default = default
...
class statement_Statement:
    ...
    pass
class plsql_statement_FunctionCallStatement(declaration_NamedElement, statement_Statement, expression_Expression):

    pass
class plsql_statement_GotoStatement(declaration_NamedElement, statement_Statement):
...
class plsql_expression_ArithmeticExpression(Expression):
    ...
    def __init__(self, type: str, plsql_expression_ArithmeticExpression: "Expression" = None, plsql_expression_ArithmeticExpression90: "Expression" = None, Expression91: "plsql_expression_ArithmeticExpression" = None, Expression132: "plsql_declaration_Argument" = None, Expression3: "plsql_statement_AssignmentStatement" = None, Expression68: "plsql_expression_InRangeExpression" = None, Expression103: "plsql_condition_ConditionComparison" = None, Expression76: "plsql_expression_LikeExpression" = None, Expression73: "plsql_expression_LikeExpression" = None, Expression84: "plsql_expression_PropertyAccess" = None, Expression93: "plsql_expression_ConcatString" = None, Expression86: "plsql_expression_FunctionCallParameter" = None, Expression88: "plsql_expression_ArithmeticExpression" = None, Expression: "plsql_statement_AssignmentStatement" = None, Expression5: "plsql_statement_IfStatement" = None, Expression44: "plsql_statement_SelectStatement" = None, Expression61: "plsql_expression_NotExpression" = None, Expression37: "plsql_statement_OpenStatement" = None, Expression52: "plsql_statement_UpdatePair" = None, Expression65: "plsql_expression_InRangeExpression" = None, Expression71: "plsql_expression_InRangeExpression" = None, Expression46: "plsql_statement_InsertStatement" = None, Expression18: "plsql_statement_ForStatement" = None, Expression59: "plsql_expression_BooleanExpression" = None, Expression63: "plsql_expression_IsNullExpression" = None, Expression106: "plsql_condition_ConditionComparison" = None, Expression56: "plsql_expression_BooleanExpression" = None, Expression20: "plsql_statement_ReturnStatement" = None, Expression108: "plsql_declaration_VariableDeclaration" = None):
        self.type = type
...
class plsql_expression_PropertyAccess(Expression):
    ...
    def __init__(self, propertyName: str, plsql_expression_PropertyAccess: "Expression" = None, Expression91: "plsql_expression_ArithmeticExpression" = None, Expression132: "plsql_declaration_Argument" = None, Expression3: "plsql_statement_AssignmentStatement" = None, Expression68: "plsql_expression_InRangeExpression" = None, Expression103: "plsql_condition_ConditionComparison" = None, Expression76: "plsql_expression_LikeExpression" = None, Expression73: "plsql_expression_LikeExpression" = None, Expression84: "plsql_expression_PropertyAccess" = None, Expression93: "plsql_expression_ConcatString" = None, Expression86: "plsql_expression_FunctionCallParameter" = None, Expression88: "plsql_expression_ArithmeticExpression" = None, Expression: "plsql_statement_AssignmentStatement" = None, Expression5: "plsql_statement_IfStatement" = None, Expression44: "plsql_statement_SelectStatement" = None, Expression61: "plsql_expression_NotExpression" = None, Expression37: "plsql_statement_OpenStatement" = None, Expression52: "plsql_statement_UpdatePair" = None, Expression65: "plsql_expression_InRangeExpression" = None, Expression71: "plsql_expression_InRangeExpression" = None, Expression46: "plsql_statement_InsertStatement" = None, Expression18: "plsql_statement_ForStatement" = None, Expression59: "plsql_expression_BooleanExpression" = None, Expression63: "plsql_expression_IsNullExpression" = None, Expression106: "plsql_condition_ConditionComparison" = None, Expression56: "plsql_expression_BooleanExpression" = None, Expression20: "plsql_statement_ReturnStatement" = None, Expression108: "plsql_declaration_VariableDeclaration" = None):
...
class plsql_expression_LiteralExpression(Expression):
    ...
    def __init__(self, type: str, value: str, Expression91: "plsql_expression_ArithmeticExpression" = None, Expression132: "plsql_declaration_Argument" = None, Expression3: "plsql_statement_AssignmentStatement" = None, Expression68: "plsql_expression_InRangeExpression" = None, Expression103: "plsql_condition_ConditionComparison" = None, Expression76: "plsql_expression_LikeExpression" = None, Expression73: "plsql_expression_LikeExpression" = None, Expression84: "plsql_expression_PropertyAccess" = None, Expression93: "plsql_expression_ConcatString" = None, Expression86: "plsql_expression_FunctionCallParameter" = None, Expression88: "plsql_expression_ArithmeticExpression" = None, Expression: "plsql_statement_AssignmentStatement" = None, Expression5: "plsql_statement_IfStatement" = None, Expression44: "plsql_statement_SelectStatement" = None, Expression61: "plsql_expression_NotExpression" = None, Expression37: "plsql_statement_OpenStatement" = None, Expression52: "plsql_statement_UpdatePair" = None, Expression65: "plsql_expression_InRangeExpression" = None, Expression71: "plsql_expression_InRangeExpression" = None, Expression46: "plsql_statement_InsertStatement" = None, Expression18: "plsql_statement_ForStatement" = None, Expression59: "plsql_expression_BooleanExpression" = None, Expression63: "plsql_expression_IsNullExpression" = None, Expression106: "plsql_condition_ConditionComparison" = None, Expression56: "plsql_expression_BooleanExpression" = None, Expression20: "plsql_statement_ReturnStatement" = None, Expression108: "plsql_declaration_VariableDeclaration" = None):
        self.type = type
        self.value = value
