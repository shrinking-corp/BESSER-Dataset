...
plsql_statement_ExitStatement = Class(name="plsql_statement_ExitStatement")
plsql_statement_GotoStatement = Class(name="plsql_statement_GotoStatement")
statement_Statement = Class(name="statement_Statement")
declaration_NamedElement = Class(name="declaration_NamedElement")
plsql_statement_CaseStatement = Class(name="plsql_statement_CaseStatement")
plsql_statement_IfStatement = Class(name="plsql_statement_IfStatement")
IfStatement = Class(name="IfStatement")
plsql_statement_LoopStatement = Class(name="plsql_statement_LoopStatement")
plsql_statement_Statement = Class(name="plsql_statement_Statement", is_abstract=True)
plsql_statement_AssignmentStatement = Class(name="plsql_statement_AssignmentStatement")
Statement = Class(name="Statement")
plsql_statement_FunctionCallStatement = Class(name="plsql_statement_FunctionCallStatement")
expression_Expression = Class(name="expression_Expression")
FunctionCallParameter = Class(name="FunctionCallParameter")
plsql_statement_SQLStatement = Class(name="plsql_statement_SQLStatement")
plsql_statement_ControlSQLStatement = Class(name="plsql_statement_ControlSQLStatement")
SQLStatement = Class(name="SQLStatement")
plsql_statement_CloseStatement = Class(name="plsql_statement_CloseStatement")
ControlSQLStatement = Class(name="ControlSQLStatement")
CursorDeclaration = Class(name="CursorDeclaration")
plsql_statement_CommitStatement = Class(name="plsql_statement_CommitStatement")
plsql_statement_FetchStatement = Class(name="plsql_statement_FetchStatement")
VarRefExpression = Class(name="VarRefExpression")
plsql_statement_ForStatement = Class(name="plsql_statement_ForStatement")
LoopStatement = Class(name="LoopStatement")
VariableDeclaration = Class(name="VariableDeclaration")
plsql_statement_NullStatement = Class(name="plsql_statement_NullStatement")
plsql_statement_RaiseStatement = Class(name="plsql_statement_RaiseStatement")
plsql_statement_ReturnStatement = Class(name="plsql_statement_ReturnStatement")
plsql_statement_BlockStatement = Class(name="plsql_statement_BlockStatement")
Declaration = Class(name="Declaration")
ExceptionSection = Class(name="ExceptionSection")
plsql_statement_LockTableStatement = Class(name="plsql_statement_LockTableStatement")
plsql_statement_OpenStatement = Class(name="plsql_statement_OpenStatement")
plsql_statement_RollbackStatement = Class(name="plsql_statement_RollbackStatement")
plsql_statement_SavepointStatement = Class(name="plsql_statement_SavepointStatement")
plsql_statement_ModifySQLStatement = Class(name="plsql_statement_ModifySQLStatement")
plsql_statement_SelectStatement = Class(name="plsql_statement_SelectStatement")
ModifySQLStatement = Class(name="ModifySQLStatement")
SQLCondition = Class(name="SQLCondition")
plsql_statement_InsertStatement = Class(name="plsql_statement_InsertStatement")
plsql_expression_Expression = Class(name="plsql_expression_Expression", is_abstract=True)
plsql_expression_BooleanExpression = Class(name="plsql_expression_BooleanExpression")
condition_SQLCondition = Class(name="condition_SQLCondition")
plsql_expression_NotExpression = Class(name="plsql_expression_NotExpression")
plsql_expression_IsNullExpression = Class(name="plsql_expression_IsNullExpression")
plsql_expression_InRangeExpression = Class(name="plsql_expression_InRangeExpression")
plsql_statement_UpdateStatement = Class(name="plsql_statement_UpdateStatement")
UpdatePair = Class(name="UpdatePair")
plsql_statement_UpdatePair = Class(name="plsql_statement_UpdatePair")
plsql_statement_DeleteStatement = Class(name="plsql_statement_DeleteStatement")
plsql_statement_SetTransactionStatement = Class(name="plsql_statement_SetTransactionStatement")
plsql_statement_ExceptionSection = Class(name="plsql_statement_ExceptionSection")
plsql_expression_SQLCursor = Class(name="plsql_expression_SQLCursor")
plsql_expression_PropertyAccess = Class(name="plsql_expression_PropertyAccess")
plsql_expression_StringOperation = Class(name="plsql_expression_StringOperation")
plsql_expression_LikeExpression = Class(name="plsql_expression_LikeExpression")
plsql_expression_FoundExpression = Class(name="plsql_expression_FoundExpression")
plsql_expression_VarRefExpression = Class(name="plsql_expression_VarRefExpression", is_abstract=True)
plsql_expression_FormsVarRef = Class(name="plsql_expression_FormsVarRef")
plsql_expression_SQLVariable = Class(name="plsql_expression_SQLVariable")
plsql_expression_ConcatString = Class(name="plsql_expression_ConcatString")
StringOperation = Class(name="StringOperation")
plsql_type_Type = Class(name="plsql_type_Type")
plsql_type_Datatype = Class(name="plsql_type_Datatype")
Type = Class(name="Type")
plsql_expression_LiteralExpression = Class(name="plsql_expression_LiteralExpression")
plsql_expression_FunctionCallParameter = Class(name="plsql_expression_FunctionCallParameter")
NamedElement = Class(name="NamedElement")
plsql_expression_ArithmeticExpression = Class(name="plsql_expression_ArithmeticExpression")
plsql_condition_NotCondition = Class(name="plsql_condition_NotCondition")
plsql_condition_ConditionComparison = Class(name="plsql_condition_ConditionComparison")
plsql_declaration_VariableDeclaration = Class(name="plsql_declaration_VariableDeclaration")
declaration_Declaration = Class(name="declaration_Declaration")
type_TypedElement = Class(name="type_TypedElement")
plsql_declaration_CursorDeclaration = Class(name="plsql_declaration_CursorDeclaration")
Argument = Class(name="Argument")
plsql_type_IndirectType = Class(name="plsql_type_IndirectType")
plsql_type_GenericType = Class(name="plsql_type_GenericType")
plsql_type_TypedElement = Class(name="plsql_type_TypedElement", is_abstract=True)
plsql_condition_SQLCondition = Class(name="plsql_condition_SQLCondition", is_abstract=True)
plsql_condition_BooleanCondition = Class(name="plsql_condition_BooleanCondition")
plsql_declaration_Argument = Class(name="plsql_declaration_Argument")
plsql_declaration_Package = Class(name="plsql_declaration_Package")
plsql_declaration_TriggerBlock = Class(name="plsql_declaration_TriggerBlock")
statement_BlockStatement = Class(name="statement_BlockStatement")
plsql_declaration_PLSQLDefinition = Class(name="plsql_declaration_PLSQLDefinition")
SelectStatement = Class(name="SelectStatement")
plsql_declaration_Declaration = Class(name="plsql_declaration_Declaration", is_abstract=True)
plsql_declaration_ProcedureDeclaration = Class(name="plsql_declaration_ProcedureDeclaration")
plsql_declaration_FunctionDeclaration = Class(name="plsql_declaration_FunctionDeclaration")
TriggerBlock = Class(name="TriggerBlock")
plsql_declaration_NamedElement = Class(name="plsql_declaration_NamedElement", is_abstract=True)
...
plsql_statement_SelectStatement_from_: Property = Property(name="from_", type=StringType)
plsql_statement_SelectStatement_isCount: Property = Property(name="isCount", type=BooleanType)
plsql_statement_SelectStatement.attributes={plsql_statement_SelectStatement_distinct, plsql_statement_SelectStatement_unique, plsql_statement_SelectStatement_bulk, plsql_statement_SelectStatement_all, plsql_statement_SelectStatement_collect, plsql_statement_SelectStatement_from_, plsql_statement_SelectStatement_selectList, plsql_statement_SelectStatement_isCount}
...
plsql_declaration_VariableDeclaration.attributes={plsql_declaration_VariableDeclaration_default, plsql_declaration_VariableDeclaration_constant, plsql_declaration_VariableDeclaration_notnull}
...
plsql_type_IndirectType.attributes={plsql_type_IndirectType_range, plsql_type_IndirectType_rowtype, plsql_type_IndirectType_identifier, plsql_type_IndirectType_type}
...
plsql_declaration_Argument_in_: Property = Property(name="in_", type=BooleanType)
...
plsql_declaration_Argument.attributes={plsql_declaration_Argument_in_, plsql_declaration_Argument_out, plsql_declaration_Argument_default}
...
domain_model = DomainModel(
    name="plsql",
    types={Expression, plsql_statement_ExitStatement, plsql_statement_GotoStatement, statement_Statement, declaration_NamedElement, plsql_statement_CaseStatement, plsql_statement_IfStatement, IfStatement, plsql_statement_LoopStatement, plsql_statement_Statement, plsql_statement_AssignmentStatement, Statement, plsql_statement_FunctionCallStatement, expression_Expression, FunctionCallParameter, plsql_statement_SQLStatement, plsql_statement_ControlSQLStatement, SQLStatement, plsql_statement_CloseStatement, ControlSQLStatement, CursorDeclaration, plsql_statement_CommitStatement, plsql_statement_FetchStatement, VarRefExpression, plsql_statement_ForStatement, LoopStatement, VariableDeclaration, plsql_statement_NullStatement, plsql_statement_RaiseStatement, plsql_statement_ReturnStatement, plsql_statement_BlockStatement, Declaration, ExceptionSection, plsql_statement_LockTableStatement, plsql_statement_OpenStatement, plsql_statement_RollbackStatement, plsql_statement_SavepointStatement, plsql_statement_ModifySQLStatement, plsql_statement_SelectStatement, ModifySQLStatement, SQLCondition, plsql_statement_InsertStatement, plsql_expression_Expression, plsql_expression_BooleanExpression, condition_SQLCondition, plsql_expression_NotExpression, plsql_expression_IsNullExpression, plsql_expression_InRangeExpression, plsql_statement_UpdateStatement, UpdatePair, plsql_statement_UpdatePair, plsql_statement_DeleteStatement, plsql_statement_SetTransactionStatement, plsql_statement_ExceptionSection, plsql_expression_SQLCursor, plsql_expression_PropertyAccess, plsql_expression_StringOperation, plsql_expression_LikeExpression, plsql_expression_FoundExpression, plsql_expression_VarRefExpression, plsql_expression_FormsVarRef, plsql_expression_SQLVariable, plsql_expression_ConcatString, StringOperation, plsql_type_Type, plsql_type_Datatype, Type, plsql_expression_LiteralExpression, plsql_expression_FunctionCallParameter, NamedElement, plsql_expression_ArithmeticExpression, plsql_condition_NotCondition, plsql_condition_ConditionComparison, plsql_declaration_VariableDeclaration, declaration_Declaration, type_TypedElement, plsql_declaration_CursorDeclaration, Argument, plsql_type_IndirectType, plsql_type_GenericType, plsql_type_TypedElement, plsql_condition_SQLCondition, plsql_condition_BooleanCondition, plsql_declaration_Argument, plsql_declaration_Package, plsql_declaration_TriggerBlock, statement_BlockStatement, plsql_declaration_PLSQLDefinition, SelectStatement, plsql_declaration_Declaration, plsql_declaration_ProcedureDeclaration, plsql_declaration_FunctionDeclaration, TriggerBlock, plsql_declaration_NamedElement, BooleanOperatorType, ArithmeticOperatorType, LiteralExpressionType, BasicTypes},
    associations={expression0, receptor1, condition4, ifStatements6, elsif8, elseStatements10, parameters27, cursor28, cursor29, into31, statements13, index15, param16, expression19, declarations21, statements22, exceptionSections25, cursor33, exprs35, into38, where40, orderBy42, expr155, expr257, expr60, expr62, expr64, lower66, upper69, values45, pairs47, where48, expression51, statements53, reference81, expr83, expr172, expr274, cursor77, reference79, exprs92, expr85, expr187, expr289, expr297, expr100, expr1102, expr2104, assign107, type94, expr195, statements125, exceptionSection128, assign131, declarations133, statements135, arguments109, select110, arguments112, declarations114, statements117, arguments120, declarations122, triggers138},
    generalizations={gen_plsql_statement_ExitStatement_Statement, gen_plsql_statement_GotoStatement_statement_Statement, gen_plsql_statement_GotoStatement_declaration_NamedElement, gen_plsql_statement_CaseStatement_Statement, gen_plsql_statement_IfStatement_Statement, gen_plsql_statement_LoopStatement_Statement, gen_plsql_statement_AssignmentStatement_Statement, gen_plsql_statement_FunctionCallStatement_statement_Statement, gen_plsql_statement_FunctionCallStatement_declaration_NamedElement, gen_plsql_statement_FunctionCallStatement_expression_Expression, gen_plsql_statement_SQLStatement_Statement, gen_plsql_statement_ControlSQLStatement_SQLStatement, gen_plsql_statement_CloseStatement_ControlSQLStatement, gen_plsql_statement_CommitStatement_ControlSQLStatement, gen_plsql_statement_FetchStatement_ControlSQLStatement, gen_plsql_statement_ForStatement_LoopStatement, gen_plsql_statement_NullStatement_Statement, gen_plsql_statement_RaiseStatement_Statement, gen_plsql_statement_ReturnStatement_Statement, gen_plsql_statement_BlockStatement_Statement, gen_plsql_statement_LockTableStatement_ControlSQLStatement, gen_plsql_statement_OpenStatement_ControlSQLStatement, gen_plsql_statement_RollbackStatement_ControlSQLStatement, gen_plsql_statement_SavepointStatement_ControlSQLStatement, gen_plsql_statement_ModifySQLStatement_SQLStatement, gen_plsql_statement_SelectStatement_ModifySQLStatement, gen_plsql_statement_InsertStatement_ModifySQLStatement, gen_plsql_expression_BooleanExpression_expression_Expression, gen_plsql_expression_BooleanExpression_condition_SQLCondition, gen_plsql_expression_NotExpression_Expression, gen_plsql_expression_IsNullExpression_Expression, gen_plsql_expression_InRangeExpression_Expression, gen_plsql_statement_UpdateStatement_ModifySQLStatement, gen_plsql_statement_DeleteStatement_ModifySQLStatement, gen_plsql_statement_SetTransactionStatement_ModifySQLStatement, gen_plsql_expression_SQLCursor_VarRefExpression, gen_plsql_expression_PropertyAccess_Expression, gen_plsql_expression_StringOperation_Expression, gen_plsql_expression_LikeExpression_Expression, gen_plsql_expression_FoundExpression_Expression, gen_plsql_expression_VarRefExpression_Expression, gen_plsql_expression_FormsVarRef_VarRefExpression, gen_plsql_expression_SQLVariable_VarRefExpression, gen_plsql_expression_ConcatString_StringOperation, gen_plsql_type_Datatype_Type, gen_plsql_expression_LiteralExpression_Expression, gen_plsql_expression_FunctionCallParameter_NamedElement, gen_plsql_expression_ArithmeticExpression_Expression, gen_plsql_condition_NotCondition_SQLCondition, gen_plsql_condition_ConditionComparison_SQLCondition, gen_plsql_declaration_VariableDeclaration_declaration_Declaration, gen_plsql_declaration_VariableDeclaration_type_TypedElement, gen_plsql_declaration_CursorDeclaration_Declaration, gen_plsql_type_IndirectType_Type, gen_plsql_type_GenericType_Type, gen_plsql_condition_BooleanCondition_SQLCondition, gen_plsql_declaration_Argument_declaration_NamedElement, gen_plsql_declaration_Argument_type_TypedElement, gen_plsql_declaration_Package_NamedElement, gen_plsql_declaration_TriggerBlock_declaration_NamedElement, gen_plsql_declaration_TriggerBlock_statement_BlockStatement, gen_plsql_declaration_Declaration_NamedElement, gen_plsql_declaration_ProcedureDeclaration_Declaration, gen_plsql_declaration_FunctionDeclaration_type_TypedElement, gen_plsql_declaration_FunctionDeclaration_declaration_Declaration},
    metadata=None
)
