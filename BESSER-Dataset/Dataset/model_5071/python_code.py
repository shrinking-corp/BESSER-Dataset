...
class accounting_JournalStatement:
    ...
    def __init__(self, amount: str, description: str, date: str, accounting_JournalStatement: "accounting_JournalGroup" = None, accounting_JournalStatement18: "accounting_Account" = None, accounting_JournalStatement21: "accounting_Account" = None, accounting_JournalStatement24: "accounting_Vat" = None):
        self.amount = amount
...
class accounting_Accounting:
    ...
    def __init__(self, name: str, accounting_Accounting8: "accounting_Report" = None, accounting_Accounting: set["accounting_AccountGroup"] = None, accounting_Accounting4: set["accounting_Vat"] = None, accounting_Accounting6: "accounting_BalanceAccount" = None, accounting_Accounting10: set["accounting_JournalGroup"] = None):
        self.name = name
