...
# Classes
Freemind_ArrowlinkType = Class(name="Freemind_ArrowlinkType")
Freemind_DocumentRoot = Class(name="Freemind_DocumentRoot")
Freemind_EStringToStringMapEntry = Class(name="Freemind_EStringToStringMapEntry")
Freemind_CloudType = Class(name="Freemind_CloudType")
Freemind_MapType = Class(name="Freemind_MapType")
Freemind_NodeType = Class(name="Freemind_NodeType")
Freemind_ParametersType = Class(name="Freemind_ParametersType")
Freemind_EdgeType = Class(name="Freemind_EdgeType")
Freemind_FontType = Class(name="Freemind_FontType")
Freemind_HookType = Class(name="Freemind_HookType")
Freemind_IconType = Class(name="Freemind_IconType")
Freemind_TextType = Class(name="Freemind_TextType")
...
Freemind_ArrowlinkType.attributes={Freemind_ArrowlinkType_Id, Freemind_ArrowlinkType_StartArrow, Freemind_ArrowlinkType_EndArrow, Freemind_ArrowlinkType_EndInclination, Freemind_ArrowlinkType_Color, Freemind_ArrowlinkType_StartInclination, Freemind_ArrowlinkType_Destination}
...
Freemind_NodeType.attributes={Freemind_NodeType_Vshift, Freemind_NodeType_group, Freemind_NodeType_Id, Freemind_NodeType_Style, Freemind_NodeType_EncryptedContent, Freemind_NodeType_Position, Freemind_NodeType_Text, Freemind_NodeType_Created, Freemind_NodeType_Color, Freemind_NodeType_Link, Freemind_NodeType_Hgap, Freemind_NodeType_Vgap, Freemind_NodeType_BackgroundColor, Freemind_NodeType_Folded, Freemind_NodeType_Modified}
...
Freemind_FontType.attributes={Freemind_FontType_Bold, Freemind_FontType_Name, Freemind_FontType_Italic, Freemind_FontType_Size}
...
domain_model = DomainModel(
    name="Freemind",
    types={Freemind_ArrowlinkType, Freemind_DocumentRoot, Freemind_EStringToStringMapEntry, Freemind_CloudType, Freemind_MapType, Freemind_NodeType, Freemind_ParametersType, Freemind_EdgeType, Freemind_FontType, Freemind_HookType, Freemind_IconType, Freemind_TextType, BOLDType, FOLDEDType, ITALICType, POSITIONType},
    associations={xMLNSPrefixMap0, xSISchemaLocation1, map16, node18, parameters20, arrowlink4, cloud6, edge8, font10, hook12, icon14, parameters24, text27, text22, arrowlink33, cloud36, edge39, node30, font42, hook45, icon48, node52},
    generalizations={},
    metadata=None
)
