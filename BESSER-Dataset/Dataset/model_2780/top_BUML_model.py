...
# Classes
top_Expr = Class(name="top_Expr")
top_B = Class(name="top_B")
AChild = Class(name="AChild")
top_BChild = Class(name="top_BChild", is_abstract=True)
top_C = Class(name="top_C")
BChild = Class(name="BChild")
top_CChild = Class(name="top_CChild", is_abstract=True)
top_D = Class(name="top_D")
CChild = Class(name="CChild")
top_DChild = Class(name="top_DChild", is_abstract=True)
top_E = Class(name="top_E")
DChild = Class(name="DChild")
top_EChild = Class(name="top_EChild", is_abstract=True)
top_F = Class(name="top_F")
EChild = Class(name="EChild")
top_FChild = Class(name="top_FChild", is_abstract=True)
top_G = Class(name="top_G")
FChild = Class(name="FChild")
top_GChild = Class(name="top_GChild", is_abstract=True)
top_ExprChild = Class(name="top_ExprChild", is_abstract=True)
top_A = Class(name="top_A")
ExprChild = Class(name="ExprChild")
top_AChild = Class(name="top_AChild", is_abstract=True)
top_K = Class(name="top_K")
JChild = Class(name="JChild")
top_KChild = Class(name="top_KChild", is_abstract=True)
top_L = Class(name="top_L")
KChild = Class(name="KChild")
top_LChild = Class(name="top_LChild", is_abstract=True)
top_M = Class(name="top_M")
LChild = Class(name="LChild")
top_MChild = Class(name="top_MChild", is_abstract=True)
top_N = Class(name="top_N")
MChild = Class(name="MChild")
top_NChild = Class(name="top_NChild", is_abstract=True)
top_O = Class(name="top_O")
NChild = Class(name="NChild")
top_OChild = Class(name="top_OChild", is_abstract=True)
top_P = Class(name="top_P")
OChild = Class(name="OChild")
top_PChild = Class(name="top_PChild", is_abstract=True)
top_H = Class(name="top_H")
GChild = Class(name="GChild")
top_HChild = Class(name="top_HChild", is_abstract=True)
top_I = Class(name="top_I")
HChild = Class(name="HChild")
top_IChild = Class(name="top_IChild", is_abstract=True)
top_J = Class(name="top_J")
IChild = Class(name="IChild")
top_JChild = Class(name="top_JChild", is_abstract=True)
top_S = Class(name="top_S")
RChild = Class(name="RChild")
top_SChild = Class(name="top_SChild", is_abstract=True)
top_T = Class(name="top_T")
SChild = Class(name="SChild")
top_TChild = Class(name="top_TChild", is_abstract=True)
top_U = Class(name="top_U")
TChild = Class(name="TChild")
top_UChild = Class(name="top_UChild", is_abstract=True)
top_Q = Class(name="top_Q")
PChild = Class(name="PChild")
top_QChild = Class(name="top_QChild", is_abstract=True)
top_R = Class(name="top_R")
QChild = Class(name="QChild")
top_RChild = Class(name="top_RChild", is_abstract=True)
top_XChild = Class(name="top_XChild", is_abstract=True)
top_Y = Class(name="top_Y")
XChild = Class(name="XChild")
top_YChild = Class(name="top_YChild", is_abstract=True)
top_Z = Class(name="top_Z")
YChild = Class(name="YChild")
top_ZChild = Class(name="top_ZChild", is_abstract=True)
top_IntegerLiteral = Class(name="top_IntegerLiteral")
ZChild = Class(name="ZChild")
top_V = Class(name="top_V")
UChild = Class(name="UChild")
top_VChild = Class(name="top_VChild", is_abstract=True)
top_W = Class(name="top_W")
VChild = Class(name="VChild")
top_WChild = Class(name="top_WChild", is_abstract=True)
top_X = Class(name="top_X")
...
domain_model = DomainModel(
    name="top",
    types={top_Expr, top_B, AChild, top_BChild, top_C, BChild, top_CChild, top_D, CChild, top_DChild, top_E, DChild, top_EChild, top_F, EChild, top_FChild, top_G, FChild, top_GChild, top_ExprChild, top_A, ExprChild, top_AChild, top_K, JChild, top_KChild, top_L, KChild, top_LChild, top_M, LChild, top_MChild, top_N, MChild, top_NChild, top_O, NChild, top_OChild, top_P, OChild, top_PChild, top_H, GChild, top_HChild, top_I, HChild, top_IChild, top_J, IChild, top_JChild, top_S, RChild, top_SChild, top_T, SChild, top_TChild, top_U, TChild, top_UChild, top_Q, PChild, top_QChild, top_R, QChild, top_RChild, top_XChild, top_Y, XChild, top_YChild, top_Z, YChild, top_ZChild, top_IntegerLiteral, ZChild, top_V, UChild, top_VChild, top_W, VChild, top_WChild, top_X, WChild},
    associations={child2, child3, child4, child5, child6, child7, child0, child1, child11, child12, child13, child14, child15, child16, child8, child9, child10, child18, child19, child20, child21, child17, child24, child25, child26, child22, child23},
    generalizations={gen_top_B_AChild, gen_top_BChild_AChild, gen_top_C_BChild, gen_top_CChild_BChild, gen_top_D_CChild, gen_top_DChild_CChild, gen_top_E_DChild, gen_top_EChild_DChild, gen_top_F_EChild, gen_top_FChild_EChild, gen_top_G_FChild, gen_top_A_ExprChild, gen_top_AChild_ExprChild, gen_top_JChild_IChild, gen_top_K_JChild, gen_top_KChild_JChild, gen_top_L_KChild, gen_top_LChild_KChild, gen_top_M_LChild, gen_top_MChild_LChild, gen_top_N_MChild, gen_top_NChild_MChild, gen_top_O_NChild, gen_top_OChild_NChild, gen_top_P_OChild, gen_top_GChild_FChild, gen_top_H_GChild, gen_top_HChild_GChild, gen_top_I_HChild, gen_top_IChild_HChild, gen_top_J_IChild, gen_top_RChild_QChild, gen_top_S_RChild, gen_top_SChild_RChild, gen_top_T_SChild, gen_top_TChild_SChild, gen_top_U_TChild, gen_top_PChild_OChild, gen_top_Q_PChild, gen_top_QChild_PChild, gen_top_R_QChild, gen_top_XChild_WChild, gen_top_Y_XChild, gen_top_YChild_XChild, gen_top_Z_YChild, gen_top_ZChild_YChild, gen_top_IntegerLiteral_ZChild, gen_top_UChild_TChild, gen_top_V_UChild, gen_top_VChild_UChild, gen_top_W_VChild, gen_top_WChild_VChild, gen_top_X_WChild},
    metadata=None
)
