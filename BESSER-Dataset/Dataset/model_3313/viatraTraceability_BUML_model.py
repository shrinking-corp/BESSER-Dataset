...
# Classes
viatraTraceability_DepToGSPN = Class(name="viatraTraceability_DepToGSPN")
viatraTraceability_PetriNet = Class(name="viatraTraceability_PetriNet")
viatraTraceability_DepModel = Class(name="viatraTraceability_DepModel")
viatraTraceability_DepToGSPNTrace = Class(name="viatraTraceability_DepToGSPNTrace")
viatraTraceability_AbstractElement = Class(name="viatraTraceability_AbstractElement")
viatraTraceability_Identification = Class(name="viatraTraceability_Identification")
