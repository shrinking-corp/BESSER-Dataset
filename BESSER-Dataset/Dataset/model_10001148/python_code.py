...
class Bill:
    ...
    def __init__(self, billno: str, patientname: str, amount: float, receptionist13: "Receptionist" = None, pat9: "Patient" = None):
        self.billno = billno
...
class Patient:
    ...
    def __init__(self, id: int, name: str, telno: int, address: str, age: int, sex: str, roomno: int, doctors1: set["Doctor"] = None, room4: "Room" = None, receptionist10: "Receptionist" = None, bill8: "Bill" = None):
        self.id = id
        self.name = name
        self.telno = telno
