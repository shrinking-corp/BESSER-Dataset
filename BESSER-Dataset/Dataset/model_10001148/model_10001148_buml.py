...
Doctor.attributes={Doctor_phno, Doctor_department, Doctor_specialization, Doctor_name, Doctor_docid, Doctor_address}
...
Patient.attributes={Patient_address, Patient_roomno, Patient_sex, Patient_id, Patient_name, Patient_age, Patient_telno}
...
Person.attributes={Person_id, Person_name, Person_type}
...
domain_model = DomainModel(
    name="_8b0bd543_8270_4c9b_8306_6deee6ca9a88",
    types={Doctor, Department, Patient, Room, Receptionist, Person, Bill, Staff, Nurse},
    associations={Doctor_Patient, Doctor_Department, Patient_Room, receptions, manages, Room_Staff, Patient_Bill},
    generalizations={},
    metadata=None
)
