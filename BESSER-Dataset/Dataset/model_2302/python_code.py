...
class PersonList_WorkingPosition:
    ...
    def __init__(self, description: str, WorkingPosition: "PersonList_Person" = None, position: "PersonList_WorkPlace" = None, works12: "PersonList_Person" = None, WorkingPosition7: "PersonList_WorkPlace" = None):
...
class PersonList_Person(ABC):
    ...
    def __init__(self, name: str, Person: "PersonList_List" = None, members: "PersonList_List" = None, persons: "PersonList_WorkingPosition" = None, persons5: "PersonList_LivingPlace" = None, Person13: "PersonList_WorkingPosition" = None, Person9: "PersonList_LivingPlace" = None):
        self.name = name
        self.Person = Person
