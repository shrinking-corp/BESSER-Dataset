...
# Classes
PersonList_List = Class(name="PersonList_List")
PersonList_Person = Class(name="PersonList_Person", is_abstract=True)
PersonList_Place = Class(name="PersonList_Place", is_abstract=True)
PersonList_WorkingPosition = Class(name="PersonList_WorkingPosition")
PersonList_LivingPlace = Class(name="PersonList_LivingPlace")
PersonList_WorkPlace = Class(name="PersonList_WorkPlace")
Place = Class(name="Place")
PersonList_Male = Class(name="PersonList_Male")
Person = Class(name="Person")
PersonList_Female = Class(name="PersonList_Female")
...
domain_model = DomainModel(
    name="PersonList",
    types={PersonList_List, PersonList_Person, PersonList_Place, PersonList_WorkingPosition, PersonList_LivingPlace, PersonList_WorkPlace, Place, PersonList_Male, Person, PersonList_Female, Gender},
    associations={members0, places1, list2, works3, home4, works10, persons11, position6, persons8},
    generalizations={gen_PersonList_WorkPlace_Place, gen_PersonList_Male_Person, gen_PersonList_Female_Person, gen_PersonList_LivingPlace_Place},
    metadata=None
)
