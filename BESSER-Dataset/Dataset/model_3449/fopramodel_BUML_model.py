...
# Classes
fopramodel_FoPra = Class(name="fopramodel_FoPra")
fopramodel_FoPraManagementSystem = Class(name="fopramodel_FoPraManagementSystem")
fopramodel_Person = Class(name="fopramodel_Person", is_abstract=True)
Person = Class(name="Person")
fopramodel_Professor = Class(name="fopramodel_Professor")
fopramodel_Student = Class(name="fopramodel_Student")
fopramodel_ResearchGroup = Class(name="fopramodel_ResearchGroup")
fopramodel_Associate = Class(name="fopramodel_Associate")
fopramodel_ExternalAdvisor = Class(name="fopramodel_ExternalAdvisor")
fopramodel_Auxiliary = Class(name="fopramodel_Auxiliary")
...
fopramodel_FoPra.attributes={fopramodel_FoPra_title, fopramodel_FoPra_description, fopramodel_FoPra_end, fopramodel_FoPra_start, fopramodel_FoPra_status, fopramodel_FoPra_maxNumberOfStudents}
...
fopramodel_Student.attributes={fopramodel_Student_matrikel, fopramodel_Student_course}
...
domain_model = DomainModel(
    name="fopramodel",
    types={fopramodel_FoPra, fopramodel_FoPraManagementSystem, fopramodel_Person, Person, fopramodel_Professor, fopramodel_Student, fopramodel_ResearchGroup, fopramodel_Associate, fopramodel_ExternalAdvisor, fopramodel_Auxiliary, Course, Status, AuxiliaryKind},
    associations={fopras9, persons10, auxiliaries12, fopras14, rg15, students0, rg1, supervisor3, advisor5, auxiliaries7, fopras30, fopras17, professor19, associate21, rg24, fopras26, fopras28},
