...
def test_hyp_fopramodel_auxiliary_is_not_abstract():
    assert not inspect.isabstract(fopramodel_Auxiliary)


def test_hyp_fopramodel_auxiliary_constructor_exists():
    assert callable(fopramodel_Auxiliary.__init__)


def test_hyp_fopramodel_auxiliary_constructor_args():
...
def test_hyp_fopramodel_researchgroup_is_not_abstract():
    assert not inspect.isabstract(fopramodel_ResearchGroup)


def test_hyp_fopramodel_researchgroup_constructor_exists():
    assert callable(fopramodel_ResearchGroup.__init__)


def test_hyp_fopramodel_researchgroup_constructor_args():
...
def test_hyp_fopramodel_externaladvisor_is_not_abstract():
    assert not inspect.isabstract(fopramodel_ExternalAdvisor)


def test_hyp_fopramodel_externaladvisor_constructor_exists():
    assert callable(fopramodel_ExternalAdvisor.__init__)


def test_hyp_fopramodel_externaladvisor_constructor_args():
...
def test_hyp_fopramodel_associate_is_not_abstract():
    assert not inspect.isabstract(fopramodel_Associate)


def test_hyp_fopramodel_associate_constructor_exists():
    assert callable(fopramodel_Associate.__init__)


def test_hyp_fopramodel_associate_constructor_args():
    sig = inspect.signature(fopramodel_Associate.__init__)
    params = list(sig.parameters.keys())



def test_hyp_fopramodel_student_is_not_abstract():
    assert not inspect.isabstract(fopramodel_Student)


def test_hyp_fopramodel_student_constructor_exists():
    assert callable(fopramodel_Student.__init__)


def test_hyp_fopramodel_student_constructor_args():
...
def test_hyp_fopramodel_professor_is_not_abstract():
    assert not inspect.isabstract(fopramodel_Professor)


def test_hyp_fopramodel_professor_constructor_exists():
    assert callable(fopramodel_Professor.__init__)


def test_hyp_fopramodel_professor_constructor_args():
    sig = inspect.signature(fopramodel_Professor.__init__)
    params = list(sig.parameters.keys())



def test_hyp_fopramodel_person_is_not_abstract():
    assert not inspect.isabstract(fopramodel_Person)


def test_hyp_fopramodel_person_constructor_exists():
    assert callable(fopramodel_Person.__init__)


def test_hyp_fopramodel_person_constructor_args():
...
def test_hyp_fopramodel_fopramanagementsystem_is_not_abstract():
    assert not inspect.isabstract(fopramodel_FoPraManagementSystem)


def test_hyp_fopramodel_fopramanagementsystem_constructor_exists():
    assert callable(fopramodel_FoPraManagementSystem.__init__)


def test_hyp_fopramodel_fopramanagementsystem_constructor_args():
    sig = inspect.signature(fopramodel_FoPraManagementSystem.__init__)
    params = list(sig.parameters.keys())



def test_hyp_fopramodel_fopra_is_not_abstract():
    assert not inspect.isabstract(fopramodel_FoPra)


def test_hyp_fopramodel_fopra_constructor_exists():
    assert callable(fopramodel_FoPra.__init__)


def test_hyp_fopramodel_fopra_constructor_args():
...
def test_hyp_course_exists():
    # Check that the Enumeration exists
    assert Course is not None

def test_hyp_course_has_all_literals():
...
def test_hyp_auxiliarykind_exists():
    # Check that the Enumeration exists
    assert AuxiliaryKind is not None

def test_hyp_auxiliarykind_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_fopramodel_auxiliary_description_setter(instance):
...
@given(instance=fopramodel_Auxiliary_strategy)
def test_hyp_fopramodel_auxiliary_kind_setter(instance):
...
def test_hyp_fopramodel_researchgroup_name_setter(instance):
...
def test_hyp_fopramodel_externaladvisor_information_setter(instance):
...
def test_hyp_fopramodel_student_matrikel_setter(instance):
...
@given(instance=fopramodel_Student_strategy)
def test_hyp_fopramodel_student_course_setter(instance):
...
def test_hyp_fopramodel_person_lastname_setter(instance):
...
@given(instance=fopramodel_Person_strategy)
def test_hyp_fopramodel_person_forename_setter(instance):
...
def test_hyp_fopramodel_fopra_maxNumberOfStudents_setter(instance):
...
@given(instance=fopramodel_FoPra_strategy)
def test_hyp_fopramodel_fopra_status_setter(instance):
...
@given(instance=fopramodel_FoPra_strategy)
def test_hyp_fopramodel_fopra_description_setter(instance):
    original = instance.description
    instance.description = original
    assert instance.description == original
...
@given(instance=fopramodel_FoPra_strategy)
def test_hyp_fopramodel_fopra_start_setter(instance):
...
@given(instance=fopramodel_FoPra_strategy)
def test_hyp_fopramodel_fopra_end_setter(instance):
...
@given(instance=fopramodel_FoPra_strategy)
def test_hyp_fopramodel_fopra_title_setter(instance):
