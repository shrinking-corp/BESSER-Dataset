...
class fopramodel_Auxiliary:
    ...
    def __init__(self, kind: str, description: str, fopramodel_Auxiliary: "fopramodel_FoPraManagementSystem" = None, Auxiliary: "fopramodel_FoPra" = None, auxiliaries: set["fopramodel_FoPra"] = None):
        self.kind = kind
...
class fopramodel_ResearchGroup:
    ...
    def __init__(self, name: str, rg22: set["fopramodel_Associate"] = None, ResearchGroup25: "fopramodel_Associate" = None, ResearchGroup16: "fopramodel_Professor" = None, ResearchGroup: "fopramodel_FoPra" = None, rg: set["fopramodel_FoPra"] = None, rg20: "fopramodel_Professor" = None):
        self.name = name
...
class fopramodel_Student(Person):
    ...
    def __init__(self, matrikel: str, course: str, students: set["fopramodel_FoPra"] = None, Student: "fopramodel_FoPra" = None):
...
class fopramodel_FoPra:
    ...
    def __init__(self, title: str, description: str, status: str, maxNumberOfStudents: int, start: date, end: date, fopramodel_FoPra: "fopramodel_FoPraManagementSystem" = None, FoPra: "fopramodel_Student" = None, fopras: set["fopramodel_Student"] = None, fopras2: "fopramodel_ResearchGroup" = None, fopras4: "fopramodel_Associate" = None, fopras6: set["fopramodel_ExternalAdvisor"] = None, fopras8: set["fopramodel_Auxiliary"] = None, FoPra31: "fopramodel_Auxiliary" = None, FoPra18: "fopramodel_ResearchGroup" = None, FoPra27: "fopramodel_Associate" = None, FoPra29: "fopramodel_ExternalAdvisor" = None):
        self.title = title
        self.description = description
        self.status = status
