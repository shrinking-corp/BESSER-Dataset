...
# Classes
manypov2_A = Class(name="manypov2_A")
Named = Class(name="Named")
manypov2_F = Class(name="manypov2_F")
manypov2_JK = Class(name="manypov2_JK")
manypov2_B = Class(name="manypov2_B")
manypov2_E = Class(name="manypov2_E")
manypov2_J = Class(name="manypov2_J")
manypov2_K = Class(name="manypov2_K")
manypov2_C = Class(name="manypov2_C")
manypov2_Named = Class(name="manypov2_Named")
manypov2_M = Class(name="manypov2_M")
manypov2_N = Class(name="manypov2_N")
...
domain_model = DomainModel(
    name="manypov2",
    types={manypov2_A, Named, manypov2_F, manypov2_JK, manypov2_B, manypov2_E, manypov2_J, manypov2_K, manypov2_C, manypov2_Named, manypov2_M, manypov2_N},
    associations={efs9, abs0, aes1, ajs3, aks5, bcs7, jks11, kms13, kns15, jkk17, mns20},
    generalizations={gen_manypov2_A_Named, gen_manypov2_E_Named, gen_manypov2_F_Named, gen_manypov2_J_Named, gen_manypov2_B_Named, gen_manypov2_C_Named, gen_manypov2_K_Named, gen_manypov2_JK_Named, gen_manypov2_M_Named, gen_manypov2_N_Named},
    metadata=None
)
