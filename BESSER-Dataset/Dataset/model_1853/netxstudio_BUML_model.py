...
domain_model = DomainModel(
    name="netxstudio",
    types={netxstudio_Library, netxstudio_Network, netxstudio_Equipment, netxstudio_Metric, netxstudio_Parameter, netxstudio_Protocol, netxstudio_Company, netxstudio_Tolerance, netxstudio_Function, netxstudio_Room, netxstudio_Country, netxstudio_Site, netxstudio_Unit, netxstudio_RFSService, netxstudio_Meta, netxstudio_Expression, netxstudio_User},
    associations={networks0, equipments3, metrics5, parameters7, protocols9, companies11, tolerances13, functions1, users17, rooms19, countries21, sites23, units25, services27, versions29, expressions15},
    generalizations={},
    metadata=None
)
