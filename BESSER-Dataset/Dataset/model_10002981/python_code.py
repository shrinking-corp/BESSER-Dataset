...
class Table:
    ...
    def __init__(self, numSeats: int, table_id: str, avaliable: bool, Table_Booking_08: "Booking" = None):
...
class Booking:
    ...
    def __init__(self, booking_id: int, date: date, startTime: str, endTime: str, reservedTables: str, customer_name: str, contact_no: int, email_id: str, ReservationManagementSystem_Booking_17: "ReservationManagementSystem" = None, reservedBy9: set["Table"] = None):
    ...
    def reservedBy9(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Booking__reservedBy9", None)
...
class ReservationManagementSystem:
    ...
    def __init__(self, bookings: str, interacts3: set["Staff"] = None, interacts5: set["CustomerUI"] = None, booking6: set["Booking"] = None):
