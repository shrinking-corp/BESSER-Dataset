...
# Classes
k2_X = Class(name="k2_X")
k2_C = Class(name="k2_C", is_abstract=True)
k2_P = Class(name="k2_P")
k2_A = Class(name="k2_A")
B = Class(name="B")
k2_B = Class(name="k2_B")
C = Class(name="C")
k2_I = Class(name="k2_I")
G = Class(name="G")
k2_G = Class(name="k2_G", is_abstract=True)
k2_M = Class(name="k2_M")
k2_N = Class(name="k2_N")
M = Class(name="M")
k2_J = Class(name="k2_J")
A = Class(name="A")
N = Class(name="N")
k2_Q = Class(name="k2_Q")
P = Class(name="P")
...
is_3: BinaryAssociation = BinaryAssociation(
    name="is_3",
    ends={
...
domain_model = DomainModel(
    name="k2",
    types={k2_X, k2_C, k2_P, k2_A, B, k2_B, C, k2_I, G, k2_G, k2_M, k2_N, M, k2_J, A, N, k2_Q, P},
    associations={cs0, ps1, is_3, cs4, a6},
    generalizations={gen_k2_B_C, gen_k2_A_B, gen_k2_C_G, gen_k2_M_G, gen_k2_N_M, gen_k2_J_A, gen_k2_P_N, gen_k2_Q_P, gen_k2_I_G},
    metadata=None
)
