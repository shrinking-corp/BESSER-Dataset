...
def test_hyp_entities_entity_constructor_args():
    ...
    assert "name_id" in params, "Missing parameter 'name_id'"
...
def test_hyp_entities_entity_name_id_setter(instance):
    original = instance.name_id
    instance.name_id = original
    assert instance.name_id == original
...
def test_entities_Entity_name_id_value_roundtrip():
    instance = entities_Entity(name_id="sample_text")
    assert instance.name_id == "sample_text"
    instance.name_id = "sample_text_2"
    assert instance.name_id == "sample_text_2"
...
def test_assoc_attributes4_link_reassign_clear():
    a = entities_Entity(name_id="sample_text")
...
def test_assoc_superType2_link_reassign_clear():
    a = entities_Entity(name_id="sample_text")
    b1 = entities_Entity(name_id="sample_text")
    b2 = entities_Entity(name_id="sample_text_2")
...
entities_Entity_strategy = st.builds(entities_Entity, name_id=safe_text)
@given(instance=entities_Entity_strategy)
@settings(max_examples=25)
