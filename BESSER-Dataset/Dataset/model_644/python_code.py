...
class reservationsystem_GeneralFlight:
    ...
    def __init__(self, flightNo: str, departureTime: str, arrivalTime: str, reservationsystem_GeneralFlight: "reservationsystem_Airport" = None, reservationsystem_GeneralFlight17: "reservationsystem_Airport" = None, GeneralFlight: "reservationsystem_SpecificFlight" = None, generalFlight: set["reservationsystem_SpecificFlight"] = None):
...
class reservationsystem_Seat:
    ...
    def __init__(self, no: str, type: int, isExit: bool, Seat31: "reservationsystem_Plane" = None, seats: "reservationsystem_Plane" = None, seats37: "reservationsystem_Booking" = None, Seat: "reservationsystem_Booking" = None):
        self.no = no
        self.type = type
        self.isExit = isExit
        self.Seat31 = Seat31
...
class reservationsystem_Booking:
    ...
    def __init__(self, bookNo: str, bookingStatus: int, baggageInfo: str, Booking26: "reservationsystem_SpecificFlight" = None, Booking38: "reservationsystem_Seat" = None, reservationsystem_Booking: "reservationsystem_Passenger" = None, Booking: "reservationsystem_Passenger" = None, reservationsystem_Booking7: set["reservationsystem_PaymentInfo"] = None, booking: set["reservationsystem_Passenger"] = None, booking10: set["reservationsystem_SpecificFlight"] = None, book: set["reservationsystem_Seat"] = None):
        self.bookNo = bookNo
...
class reservationsystem_SpecificFlight:
    ...
    def __init__(self, id: int, date: date, realDepTime: date, realArriTime: date, status: int, specificFlight: "reservationsystem_GeneralFlight" = None, specificFlight21: "reservationsystem_Plane" = None, specificFlight23: set["reservationsystem_Crew"] = None, specificFlight25: set["reservationsystem_Booking"] = None, SpecificFlight28: "reservationsystem_Plane" = None, SpecificFlight14: "reservationsystem_GeneralFlight" = None, SpecificFlight: "reservationsystem_Crew" = None, SpecificFlight11: "reservationsystem_Booking" = None):
        self.id = id
        self.date = date
    ...
    def assignAttd(self, reservationsystem_personId):
        # TODO: Implement assignAttd method
        pass

    def assignPilot(self, reservationsystem_personId):
...
class reservationsystem_Crew(Person):
    ...
    def __init__(self, employeeId: str, Crew: "reservationsystem_SpecificFlight" = None, reservationsystem_Crew: "reservationsystem_Crew" = None, reservationsystem_Crew1: "reservationsystem_Crew" = None, crew: set["reservationsystem_SpecificFlight"] = None):
