...
# Classes
reservationsystem_Person = Class(name="reservationsystem_Person", is_abstract=True)
reservationsystem_User = Class(name="reservationsystem_User")
reservationsystem_Crew = Class(name="reservationsystem_Crew", is_abstract=True)
Person = Class(name="Person")
reservationsystem_SpecificFlight = Class(name="reservationsystem_SpecificFlight")
reservationsystem_Passenger = Class(name="reservationsystem_Passenger")
reservationsystem_Booking = Class(name="reservationsystem_Booking")
reservationsystem_Pilot = Class(name="reservationsystem_Pilot")
Crew = Class(name="Crew")
reservationsystem_Attendant = Class(name="reservationsystem_Attendant")
reservationsystem_PaymentInfo = Class(name="reservationsystem_PaymentInfo")
reservationsystem_Seat = Class(name="reservationsystem_Seat")
reservationsystem_GeneralFlight = Class(name="reservationsystem_GeneralFlight")
reservationsystem_Airport = Class(name="reservationsystem_Airport")
reservationsystem_Plane = Class(name="reservationsystem_Plane")
reservationsystem_City = Class(name="reservationsystem_City")
...
reservationsystem_Person.attributes={reservationsystem_Person_id, reservationsystem_Person_passportId, reservationsystem_Person_citizenship, reservationsystem_Person_email, reservationsystem_Person_gender, reservationsystem_Person_name, reservationsystem_Person_middleName, reservationsystem_Person_addr, reservationsystem_Person_residence, reservationsystem_Person_birthDate, reservationsystem_Person_phone, reservationsystem_Person_FamilyName}
...
reservationsystem_SpecificFlight_m_assignPilot: Method = Method(name="assignPilot", parameters={Parameter(name='reservationsystem_personId', type=StringType)})
reservationsystem_SpecificFlight_m_assignAttd: Method = Method(name="assignAttd", parameters={Parameter(name='reservationsystem_personId', type=StringType)})
reservationsystem_SpecificFlight.attributes={reservationsystem_SpecificFlight_id, reservationsystem_SpecificFlight_status, reservationsystem_SpecificFlight_date, reservationsystem_SpecificFlight_realArriTime, reservationsystem_SpecificFlight_realDepTime}
...
reservationsystem_Passenger.attributes={reservationsystem_Passenger_foodPref, reservationsystem_Passenger_specialNeeds}
...
reservationsystem_Booking.attributes={reservationsystem_Booking_bookNo, reservationsystem_Booking_baggageInfo, reservationsystem_Booking_bookingStatus}
...
reservationsystem_PaymentInfo.attributes={reservationsystem_PaymentInfo_cardNo, reservationsystem_PaymentInfo_payTime, reservationsystem_PaymentInfo_createTime, reservationsystem_PaymentInfo_cardAddr, reservationsystem_PaymentInfo_status, reservationsystem_PaymentInfo_type, reservationsystem_PaymentInfo_id, reservationsystem_PaymentInfo_cardOwner}
...
reservationsystem_Seat.attributes={reservationsystem_Seat_isExit, reservationsystem_Seat_type, reservationsystem_Seat_no}
...
reservationsystem_GeneralFlight.attributes={reservationsystem_GeneralFlight_departureTime, reservationsystem_GeneralFlight_arrivalTime, reservationsystem_GeneralFlight_flightNo}
...
reservationsystem_Airport.attributes={reservationsystem_Airport_id, reservationsystem_Airport_name, reservationsystem_Airport_abbr}
...
reservationsystem_Plane.attributes={reservationsystem_Plane_crewNum, reservationsystem_Plane_model, reservationsystem_Plane_id, reservationsystem_Plane_capacity}
...
domain_model = DomainModel(
    ...
    types={reservationsystem_Person, reservationsystem_User, reservationsystem_Crew, Person, reservationsystem_SpecificFlight, reservationsystem_Passenger, reservationsystem_Booking, reservationsystem_Pilot, Crew, reservationsystem_Attendant, reservationsystem_PaymentInfo, reservationsystem_Seat, reservationsystem_GeneralFlight, reservationsystem_Airport, reservationsystem_Plane, reservationsystem_City, Booking},
    associations={belongsTo0, Leader2, specificFlight3, passenger4, booking5, paymentInfo6, passenger8, specificFlight9, seats12, from_15, to16, generalFlight19, plane20, crew22, booking24, specificFlight27, seats29, city32, specificFlight13, airport33, plane34, book36},
    generalizations={gen_reservationsystem_Crew_Person, gen_reservationsystem_Passenger_Person, gen_reservationsystem_Pilot_Crew, gen_reservationsystem_Attendant_Crew, gen_reservationsystem_PaymentInfo_Booking},
    metadata=None
)
