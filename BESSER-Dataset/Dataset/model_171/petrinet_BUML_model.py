...
petrinet_PlaceTransitionArc = Class(name="petrinet_PlaceTransitionArc")
Arc = Class(name="Arc")
petrinet_TransitionPlaceArc = Class(name="petrinet_TransitionPlaceArc")
...
petrinet_Place.attributes={petrinet_Place_tokens, petrinet_Place_capacity}
...
domain_model = DomainModel(
    name="petrinet",
    types={petrinet_Place, Node, petrinet_Transition, petrinet_PetriNet, petrinet_Arc, petrinet_Node, petrinet_PlaceTransitionArc, Arc, petrinet_TransitionPlaceArc},
    associations={tpToPlace5, places8, transitions10, inputArcs13, outputArcs16, arcs19, nodes21, ptFromPlace0, ptToTransition1, tpFromTransition3},
