...
def test_petrinet_transitionplacearc_is_not_abstract():
    assert not inspect.isabstract(petrinet_TransitionPlaceArc)


def test_petrinet_transitionplacearc_constructor_exists():
    assert callable(petrinet_TransitionPlaceArc.__init__)


def test_petrinet_transitionplacearc_constructor_args():
    sig = inspect.signature(petrinet_TransitionPlaceArc.__init__)
    params = list(sig.parameters.keys())



def test_petrinet_placetransitionarc_is_not_abstract():
    assert not inspect.isabstract(petrinet_PlaceTransitionArc)


def test_petrinet_placetransitionarc_constructor_exists():
    assert callable(petrinet_PlaceTransitionArc.__init__)


def test_petrinet_placetransitionarc_constructor_args():
