...
class petrinet_Place(Node):
    ...
    def __init__(self, tokens: int, capacity: int, petrinet_Place7: "petrinet_TransitionPlaceArc" = None, petrinet_Place9: "petrinet_PetriNet" = None, petrinet_Place: "petrinet_PlaceTransitionArc" = None):
        self.tokens = tokens
