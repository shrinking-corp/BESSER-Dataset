...
class simplegraph2graph_Node2Node(Element2Element):
    ...
    def __init__(self, label: str, simplegraph2graph_Node2Node16: "simplegraph2graph_Node" = None, simplegraph2graph_Node2Node18: "simplegraph2graph_Node" = None, simplegraph2graph_Node2Node: "simplegraph2graph_Edge2Edge" = None, simplegraph2graph_Node2Node14: "simplegraph2graph_Edge2Edge" = None):
        self.label = label
