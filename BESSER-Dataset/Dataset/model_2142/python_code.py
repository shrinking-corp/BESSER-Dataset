...
class WT_Subsystem:
    ...
    def __init__(self, name: str, WT_Subsystem3: "WT_Subsystem" = None, WT_Subsystem1: set["WT_Subsystem"] = None, WT_Subsystem5: set["WT_Architecture"] = None, WT_Subsystem7: set["WT_ControlSubsystem"] = None, WT_Subsystem: "WT_WTComponents" = None):
        self.name = name
...
class WT_Component:
    ...
    def __init__(self, label: str, WT_Component23: set["WT_Port"] = None, WT_Component25: set["WT_StateMachine"] = None, WT_Component: "WT_Architecture" = None):
        self.label = label
