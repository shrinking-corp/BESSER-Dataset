...
Employee.attributes={Employee_managerId, Employee_leavesTaken, Employee_employeeName, Employee_noOfLeaves, Employee_employeeId, Employee_jobLevel, Employee_password}
...
LeaveApplication.attributes={LeaveApplication_toDate, LeaveApplication_approverComments, LeaveApplication_fromDate, LeaveApplication_applicationId, LeaveApplication_employeeId, LeaveApplication_reason, LeaveApplication_status}
...
domain_model = DomainModel(
    name="_143d59b8_726a_4c70_b0f8_3ead3d62884c",
    ...
    associations={Credit_Leaves_Application, Application_AutoApproval, Application_GenerateSummary, User_Login, User_Query_Eligibility, User_Query_Leave_Balance, User_Query_Leave_History, Employee_Apply_Leave, Employee_Leave_Request_Status, Employee_Approver_Jobs, Admin_CreateUser, Admin_Update_Calendar, Application_SendNotification},
    generalizations={},
    metadata=None
)
