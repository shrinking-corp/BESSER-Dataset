...
roverml_Component = Class(name="roverml_Component", is_abstract=True)
roverml_TriggeredTransition = Class(name="roverml_TriggeredTransition", is_abstract=True)
...
roverml_SingleQuantity = Class(name="roverml_SingleQuantity", is_abstract=True)
Quantity = Class(name="Quantity")
SingleQuantity = Class(name="SingleQuantity")
Actuator = Class(name="Actuator")
roverml_Sensor = Class(name="roverml_Sensor", is_abstract=True)
...
roverml_Actuator = Class(name="roverml_Actuator", is_abstract=True)
roverml_RoverSystem = Class(name="roverml_RoverSystem")
roverml_CompassTrigger = Class(name="roverml_CompassTrigger")
roverml_Quantity = Class(name="roverml_Quantity", is_abstract=True)
...
domain_model = DomainModel(
    name="roverml",
    types={roverml_Block, roverml_Rover, roverml_Command, roverml_Transition, roverml_NamedElement, roverml_RoverProgram, NamedElement, roverml_SetLightColor, roverml_Light, roverml_Rotate, roverml_Angle, roverml_Wait, roverml_Time, roverml_Repeat, Block, roverml_Move, Command, roverml_Velocity, roverml_Length, roverml_Component, roverml_TriggeredTransition, Transition, roverml_GPS, roverml_DistanceSensor, roverml_Compass, roverml_SingleQuantity, Quantity, SingleQuantity, Actuator, roverml_Sensor, Component, roverml_Motor, roverml_Terminate, roverml_DistanceSensorTrigger, roverml_GpsTrigger, roverml_Actuator, roverml_RoverSystem, roverml_CompassTrigger, roverml_Quantity, roverml_Position, Color, AngleUnit, TimeUnit, ComparisonOperator, VelocityUnit, LengthUnit},
    associations={block0, rover1, incoming3, lights10, angle11, duration12, outgoing4, speed7, distance8, components13, commands15, transitions18, source21, target24, roverPrograms29, rovers27, x32, y34},
    generalizations={gen_roverml_Command_NamedElement, gen_roverml_RoverProgram_NamedElement, gen_roverml_SetLightColor_Command, gen_roverml_Rotate_Command, gen_roverml_Wait_Command, gen_roverml_Repeat_Command, gen_roverml_Repeat_Block, gen_roverml_Move_Command, gen_roverml_Rover_NamedElement, gen_roverml_TriggeredTransition_Transition, gen_roverml_Transition_NamedElement, gen_roverml_SingleQuantity_Quantity, gen_roverml_Time_SingleQuantity, gen_roverml_Angle_SingleQuantity, gen_roverml_Velocity_SingleQuantity, gen_roverml_Light_Actuator, gen_roverml_Sensor_Component, gen_roverml_Motor_Actuator, gen_roverml_Terminate_Command, gen_roverml_Component_NamedElement, gen_roverml_Length_SingleQuantity, gen_roverml_Actuator_Component, gen_roverml_Position_Quantity},
    metadata=None
)
