...
# Classes
statemachine_ConstantRef = Class(name="statemachine_ConstantRef")
Value = Class(name="Value")
statemachine_IntLiteral = Class(name="statemachine_IntLiteral")
...
statemachine_Constant = Class(name="statemachine_Constant")
statemachine_State = Class(name="statemachine_State")
statemachine_Guard = Class(name="statemachine_Guard")
statemachine_ValueGuard = Class(name="statemachine_ValueGuard")
Guard = Class(name="Guard")
statemachine_Value = Class(name="statemachine_Value")
statemachine_RangeGuard = Class(name="statemachine_RangeGuard")
statemachine_Transition = Class(name="statemachine_Transition")
statemachine_Thing = Class(name="statemachine_Thing")
...
statemachine_State.attributes={statemachine_State_name, statemachine_State_description}
...
domain_model = DomainModel(
    name="statemachine",
    types={statemachine_ConstantRef, Value, statemachine_IntLiteral, statemachine_Statemachine, statemachine_Event, statemachine_Command, statemachine_Constant, statemachine_State, statemachine_Guard, statemachine_ValueGuard, Guard, statemachine_Value, statemachine_RangeGuard, statemachine_Transition, statemachine_Thing},
    associations={constant18, guard20, events0, resetEvents1, commands4, constants6, states8, guard10, cond12, min13, max15, value23, actions26, transitions29, things31, event33, guard36, state39, guard42},
    generalizations={gen_statemachine_ConstantRef_Value, gen_statemachine_IntLiteral_Value, gen_statemachine_ValueGuard_Guard, gen_statemachine_RangeGuard_Guard},
    metadata=None
)
