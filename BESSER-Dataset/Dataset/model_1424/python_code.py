...
class statemachine_Constant:
    ...
    def __init__(self, name: str, statemachine_Constant19: "statemachine_ConstantRef" = None, statemachine_Constant: "statemachine_Statemachine" = None, statemachine_Constant24: "statemachine_Value" = None):
        self.name = name
...
class statemachine_Command:
    ...
    def __init__(self, name: str, code: int, statemachine_Command21: "statemachine_Guard" = None, statemachine_Command: "statemachine_Statemachine" = None, statemachine_Command28: "statemachine_State" = None):
        self.name = name
        self.code = code
