...
# Classes
yyg_Base = Class(name="yyg_Base")
NamedElement = Class(name="NamedElement")
yyg_Boz = Class(name="yyg_Boz")
yyg_Foo = Class(name="yyg_Foo")
yyg_Output = Class(name="yyg_Output")
yyg_Baz = Class(name="yyg_Baz", is_abstract=True)
yyg_NamedElement = Class(name="yyg_NamedElement", is_abstract=True)
yyg_Alias = Class(name="yyg_Alias")
yyg_Bar = Class(name="yyg_Bar")
yyg_Rel = Class(name="yyg_Rel")
yyg_Zing = Class(name="yyg_Zing")
yyg_Bouz = Class(name="yyg_Bouz")
Baz = Class(name="Baz")
yyg_Boul = Class(name="yyg_Boul")
...
domain_model = DomainModel(
    name="yyg",
    types={yyg_Base, NamedElement, yyg_Boz, yyg_Foo, yyg_Output, yyg_Baz, yyg_NamedElement, yyg_Alias, yyg_Bar, yyg_Rel, yyg_Zing, yyg_Bouz, Baz, yyg_Boul},
    associations={fromThing11, relations0, foos1, ouputs2, baze4, aliases6, bars7, rels9, toElement12, subRelations15, output17, src20, trg23, azing26, zings28},
