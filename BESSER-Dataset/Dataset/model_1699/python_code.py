...
class yyg_NamedElement(ABC):
    ...
    def __init__(self, name: str, yyg_NamedElement: set["yyg_Alias"] = None, yyg_NamedElement8: set["yyg_Bar"] = None, yyg_NamedElement10: set["yyg_Rel"] = None, yyg_NamedElement13: "yyg_Boz" = None, yyg_NamedElement22: "yyg_Rel" = None):
        self.name = name
...
class yyg_Boz(NamedElement):
    ...
    def __init__(self, since: str, relations: "yyg_Base" = None, Boz: "yyg_Base" = None, yyg_Boz: "yyg_NamedElement" = None, yyg_Boz16: "yyg_Boz" = None, yyg_Boz14: set["yyg_Boz"] = None, yyg_Boz25: "yyg_Rel" = None):
        self.since = since
...
class yyg_Base(NamedElement):
    ...
    def __init__(self, id: int, Base: "yyg_Boz" = None, fromThing: set["yyg_Boz"] = None, yyg_Base: set["yyg_Foo"] = None, yyg_Base3: set["yyg_Output"] = None, yyg_Base5: set["yyg_Baz"] = None):
        self.id = id
        self.Base = Base
