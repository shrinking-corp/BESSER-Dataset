...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={SimpleClass_Attribute, SimpleClass_Classifier, SimpleClass_Class, Classifier, Class_, Attribute, SimpleClass_PrimitiveDataType, SimpleClass_Association},
    associations={src3, dest5, parent0, attrs1, type8, class_9},
