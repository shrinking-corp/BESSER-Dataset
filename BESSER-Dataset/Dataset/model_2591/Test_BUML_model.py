...
root_subpackage1_B = Class(name="root_subpackage1_B")
root_subsubpackage1_D = Class(name="root_subsubpackage1_D")
root_subpackage2_C = Class(name="root_subpackage2_C")
