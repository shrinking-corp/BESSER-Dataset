...
root_subpackage1_B_strategy = st.builds(root_subpackage1_B)
...
root_subpackage2_C_strategy = st.builds(root_subpackage2_C)
...
root_subsubpackage1_D_strategy = st.builds(root_subsubpackage1_D)
