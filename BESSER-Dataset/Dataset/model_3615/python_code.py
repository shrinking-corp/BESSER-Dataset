...
class r1_CodeSystemDef(Element):
    ...
    def __init__(self, name: str, version: str, accessLevel: str, id: str):
        self.name = name
        self.version = version
        self.accessLevel = accessLevel
        self.id = id
...
class r1_Interval(Expression):
    ...
    def __init__(self, highClosed: str, lowClosed: str, r1_Interval102: "r1_Expression" = None, r1_Interval105: "r1_Expression" = None, r1_Interval: "r1_Expression" = None, r1_Interval99: "r1_Expression" = None):
...
class r1_Retrieve(Expression):
    ...
    def __init__(self, codeProperty: str, dataType: str, dateHighProperty: str, dateLowProperty: str, dateProperty: str, idProperty: str, scope: str, templateId: str, r1_Retrieve: "r1_Expression" = None, r1_Retrieve161: "r1_Expression" = None):
