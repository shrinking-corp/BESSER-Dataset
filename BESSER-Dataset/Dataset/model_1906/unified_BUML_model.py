...
# Classes
UnifiedMetamodel__Ejb = Class(name="UnifiedMetamodel__Ejb")
Layer = Class(name="Layer")
UnifiedMetamodel__LayerSegment = Class(name="UnifiedMetamodel__LayerSegment")
UnifiedMetamodel__SubLayerSegment = Class(name="UnifiedMetamodel__SubLayerSegment")
UnifiedMetamodel__Layer = Class(name="UnifiedMetamodel__Layer")
UnifiedMetamodel__RestEntity = Class(name="UnifiedMetamodel__RestEntity")
UnifiedMetamodel__Facade = Class(name="UnifiedMetamodel__Facade")
UnifiedMetamodel__War = Class(name="UnifiedMetamodel__War")
UnifiedMetamodel__Component = Class(name="UnifiedMetamodel__Component")
UnifiedMetamodel__RelationArch = Class(name="UnifiedMetamodel__RelationArch")
UnifiedMetamodel__Dto = Class(name="UnifiedMetamodel__Dto")
LayerSegment = Class(name="LayerSegment")
UnifiedMetamodel__Store = Class(name="UnifiedMetamodel__Store")
UnifiedMetamodel__UI = Class(name="UnifiedMetamodel__UI")
UnifiedMetamodel__Containers = Class(name="UnifiedMetamodel__Containers")
UnifiedMetamodel__Pojo = Class(name="UnifiedMetamodel__Pojo")
UnifiedMetamodel__Services = Class(name="UnifiedMetamodel__Services")
UnifiedMetamodel__Metamodel = Class(name="UnifiedMetamodel__Metamodel")
UnifiedMetamodel__DomainMetamodel = Class(name="UnifiedMetamodel__DomainMetamodel")
UnifiedMetamodel__TechnologyMetamodel = Class(name="UnifiedMetamodel__TechnologyMetamodel")
UnifiedMetamodel__Read = Class(name="UnifiedMetamodel__Read")
Operations = Class(name="Operations")
UnifiedMetamodel__Create = Class(name="UnifiedMetamodel__Create")
UnifiedMetamodel__Sale = Class(name="UnifiedMetamodel__Sale")
Transaction = Class(name="Transaction")
UnifiedMetamodel__Exchange = Class(name="UnifiedMetamodel__Exchange")
UnifiedMetamodel__Composition = Class(name="UnifiedMetamodel__Composition")
RelationDom = Class(name="RelationDom")
UnifiedMetamodel__Operations = Class(name="UnifiedMetamodel__Operations")
UnifiedMetamodel__Entity = Class(name="UnifiedMetamodel__Entity")
UnifiedMetamodel__ArquitectureMetamodel = Class(name="UnifiedMetamodel__ArquitectureMetamodel")
UnifiedMetamodel__Module = Class(name="UnifiedMetamodel__Module")
UnifiedMetamodel__Submodule = Class(name="UnifiedMetamodel__Submodule")
UnifiedMetamodel__GeneralEntity = Class(name="UnifiedMetamodel__GeneralEntity")
UnifiedMetamodel__Property = Class(name="UnifiedMetamodel__Property")
UnifiedMetamodel__RelationDom = Class(name="UnifiedMetamodel__RelationDom")
UnifiedMetamodel__ActionDispatcher = Class(name="UnifiedMetamodel__ActionDispatcher")
UnifiedMetamodel__ActionCreator = Class(name="UnifiedMetamodel__ActionCreator")
UnifiedMetamodel__Router = Class(name="UnifiedMetamodel__Router")
ModuleFront = Class(name="ModuleFront")
UnifiedMetamodel__JSON = Class(name="UnifiedMetamodel__JSON")
File = Class(name="File")
UnifiedMetamodel__MD = Class(name="UnifiedMetamodel__MD")
UnifiedMetamodel__CSS = Class(name="UnifiedMetamodel__CSS")
UnifiedMetamodel__APICall = Class(name="UnifiedMetamodel__APICall")
UnifiedMetamodel__Directory = Class(name="UnifiedMetamodel__Directory")
UnifiedMetamodel__File = Class(name="UnifiedMetamodel__File")
UnifiedMetamodel__SpecialEntity = Class(name="UnifiedMetamodel__SpecialEntity")
Entity = Class(name="Entity")
UnifiedMetamodel__Transaction = Class(name="UnifiedMetamodel__Transaction")
UnifiedMetamodel__UIFront = Class(name="UnifiedMetamodel__UIFront")
ComponentFront = Class(name="ComponentFront")
UnifiedMetamodel__Visualizer = Class(name="UnifiedMetamodel__Visualizer")
UIFront = Class(name="UIFront")
UnifiedMetamodel__Design = Class(name="UnifiedMetamodel__Design")
UnifiedMetamodel__RouterComponent = Class(name="UnifiedMetamodel__RouterComponent")
UnifiedMetamodel__Container = Class(name="UnifiedMetamodel__Container")
UnifiedMetamodel__ServicesFront = Class(name="UnifiedMetamodel__ServicesFront")
UnifiedMetamodel__Functionality = Class(name="UnifiedMetamodel__Functionality")
UnifiedMetamodel__ComponentFront = Class(name="UnifiedMetamodel__ComponentFront")
UnifiedMetamodel__JS = Class(name="UnifiedMetamodel__JS")
UnifiedMetamodel__Redux = Class(name="UnifiedMetamodel__Redux")
UnifiedMetamodel__State = Class(name="UnifiedMetamodel__State")
UnifiedMetamodel__Action = Class(name="UnifiedMetamodel__Action")
UnifiedMetamodel__Reducer = Class(name="UnifiedMetamodel__Reducer")
UnifiedMetamodel__ModuleFront = Class(name="UnifiedMetamodel__ModuleFront")
UnifiedMetamodel__JavaApp = Class(name="UnifiedMetamodel__JavaApp")
UnifiedMetamodel__JEE_Project = Class(name="UnifiedMetamodel__JEE_Project")
UnifiedMetamodel__ReactApp = Class(name="UnifiedMetamodel__ReactApp")
UnifiedMetamodel__Library = Class(name="UnifiedMetamodel__Library")
UnifiedMetamodel__Annotation = Class(name="UnifiedMetamodel__Annotation")
UnifiedMetamodel__Attribute = Class(name="UnifiedMetamodel__Attribute")
UnifiedMetamodel__EClass = Class(name="UnifiedMetamodel__EClass")
UnifiedMetamodel__GenericClass = Class(name="UnifiedMetamodel__GenericClass")
UnifiedMetamodel__AbstractClass = Class(name="UnifiedMetamodel__AbstractClass")
UnifiedMetamodel__MethodBack = Class(name="UnifiedMetamodel__MethodBack")
UnifiedMetamodel__Epackage = Class(name="UnifiedMetamodel__Epackage")
UnifiedMetamodel__Subproject = Class(name="UnifiedMetamodel__Subproject")
UnifiedMetamodel__NativeClass = Class(name="UnifiedMetamodel__NativeClass")
EClass = Class(name="EClass")
UnifiedMetamodel__EInterface = Class(name="UnifiedMetamodel__EInterface")
UnifiedMetamodel__AbstractMethod = Class(name="UnifiedMetamodel__AbstractMethod")
UnifiedMetamodel__Descriptor = Class(name="UnifiedMetamodel__Descriptor")
UnifiedMetamodel__JavaScript = Class(name="UnifiedMetamodel__JavaScript")
UnifiedMetamodel__Util = Class(name="UnifiedMetamodel__Util")
UnifiedMetamodel__Reducers = Class(name="UnifiedMetamodel__Reducers")
SubLayerSegment = Class(name="SubLayerSegment")
UnifiedMetamodel__Actions = Class(name="UnifiedMetamodel__Actions")
UnifiedMetamodel__Back = Class(name="UnifiedMetamodel__Back")
Component = Class(name="Component")
UnifiedMetamodel__Front = Class(name="UnifiedMetamodel__Front")
UnifiedMetamodel__React = Class(name="UnifiedMetamodel__React")
...
UnifiedMetamodel__Property.attributes={UnifiedMetamodel__Property_type, UnifiedMetamodel__Property_name}
...
UnifiedMetamodel__Directory.attributes={UnifiedMetamodel__Directory_name, UnifiedMetamodel__Directory_purpose, UnifiedMetamodel__Directory_isRoot}
...
UnifiedMetamodel__Library.attributes={UnifiedMetamodel__Library_isNative, UnifiedMetamodel__Library_name}
...
return_134: BinaryAssociation = BinaryAssociation(
    name="return_134",
    ends={
...
class_143: BinaryAssociation = BinaryAssociation(
    name="class_143",
    ends={
...
return_165: BinaryAssociation = BinaryAssociation(
    name="return_165",
    ends={
...
domain_model = DomainModel(
    ...
    types={UnifiedMetamodel__Ejb, Layer, UnifiedMetamodel__LayerSegment, UnifiedMetamodel__SubLayerSegment, UnifiedMetamodel__Layer, UnifiedMetamodel__RestEntity, UnifiedMetamodel__Facade, UnifiedMetamodel__War, UnifiedMetamodel__Component, UnifiedMetamodel__RelationArch, UnifiedMetamodel__Dto, LayerSegment, UnifiedMetamodel__Store, UnifiedMetamodel__UI, UnifiedMetamodel__Containers, UnifiedMetamodel__Pojo, UnifiedMetamodel__Services, UnifiedMetamodel__Metamodel, UnifiedMetamodel__DomainMetamodel, UnifiedMetamodel__TechnologyMetamodel, UnifiedMetamodel__Read, Operations, UnifiedMetamodel__Create, UnifiedMetamodel__Sale, Transaction, UnifiedMetamodel__Exchange, UnifiedMetamodel__Composition, RelationDom, UnifiedMetamodel__Operations, UnifiedMetamodel__Entity, UnifiedMetamodel__ArquitectureMetamodel, UnifiedMetamodel__Module, UnifiedMetamodel__Submodule, UnifiedMetamodel__GeneralEntity, UnifiedMetamodel__Property, UnifiedMetamodel__RelationDom, UnifiedMetamodel__ActionDispatcher, UnifiedMetamodel__ActionCreator, UnifiedMetamodel__Router, ModuleFront, UnifiedMetamodel__JSON, File, UnifiedMetamodel__MD, UnifiedMetamodel__CSS, UnifiedMetamodel__APICall, UnifiedMetamodel__Directory, UnifiedMetamodel__File, UnifiedMetamodel__SpecialEntity, Entity, UnifiedMetamodel__Transaction, UnifiedMetamodel__UIFront, ComponentFront, UnifiedMetamodel__Visualizer, UIFront, UnifiedMetamodel__Design, UnifiedMetamodel__RouterComponent, UnifiedMetamodel__Container, UnifiedMetamodel__ServicesFront, UnifiedMetamodel__Functionality, UnifiedMetamodel__ComponentFront, UnifiedMetamodel__JS, UnifiedMetamodel__Redux, UnifiedMetamodel__State, UnifiedMetamodel__Action, UnifiedMetamodel__Reducer, UnifiedMetamodel__ModuleFront, UnifiedMetamodel__JavaApp, UnifiedMetamodel__JEE_Project, UnifiedMetamodel__ReactApp, UnifiedMetamodel__Library, UnifiedMetamodel__Annotation, UnifiedMetamodel__Attribute, UnifiedMetamodel__EClass, UnifiedMetamodel__GenericClass, UnifiedMetamodel__AbstractClass, UnifiedMetamodel__MethodBack, UnifiedMetamodel__Epackage, UnifiedMetamodel__Subproject, UnifiedMetamodel__NativeClass, EClass, UnifiedMetamodel__EInterface, UnifiedMetamodel__AbstractMethod, UnifiedMetamodel__Descriptor, UnifiedMetamodel__JavaScript, UnifiedMetamodel__Util, UnifiedMetamodel__Reducers, SubLayerSegment, UnifiedMetamodel__Actions, UnifiedMetamodel__Back, Component, UnifiedMetamodel__Front, UnifiedMetamodel__React},
    associations={allowToUse1, layerSegments4, layers6, source8, target10, sublayersegment2, relations15, arquitecturemetamodel18, domainmetamodel20, technologymetamodel22, operates_on24, submodule25, components13, property27, source29, target31, operates_on34, operations36, entity39, module42, relationdom45, use48, directories50, files51, transaction26, routes58, dispatches59, maps61, use64, isOrganizedIn66, components69, state70, services73, IsOrganizedBy76, actiondispatcher79, actioncreator82, actionDirectory85, action53, reducer54, use56, directories93, use96, inWithin99, catches102, reducerDirectory105, isPresentIn108, techback111, techfront113, jee_project116, functionalities88, abstractmethod120, modules90, nativeclass121, annotation122, annotation124, type126, implement128, extends130, annotation132, return_134, arguments137, abstractmethod140, class_143, attribute145, subproject118, descriptor154, descriptor156, package159, library162, return_165, arguments168, method148, annotation151},
    generalizations={gen_UnifiedMetamodel__Ejb_Layer, gen_UnifiedMetamodel__RestEntity_LayerSegment, gen_UnifiedMetamodel__Facade_LayerSegment, gen_UnifiedMetamodel__War_Layer, gen_UnifiedMetamodel__Dto_LayerSegment, gen_UnifiedMetamodel__Store_LayerSegment, gen_UnifiedMetamodel__UI_LayerSegment, gen_UnifiedMetamodel__Containers_LayerSegment, gen_UnifiedMetamodel__Pojo_LayerSegment, gen_UnifiedMetamodel__Services_LayerSegment, gen_UnifiedMetamodel__Read_Operations, gen_UnifiedMetamodel__Create_Operations, gen_UnifiedMetamodel__Sale_Transaction, gen_UnifiedMetamodel__Exchange_Transaction, gen_UnifiedMetamodel__Composition_RelationDom, gen_UnifiedMetamodel__GeneralEntity_Entity, gen_UnifiedMetamodel__Router_ModuleFront, gen_UnifiedMetamodel__JSON_File, gen_UnifiedMetamodel__MD_File, gen_UnifiedMetamodel__CSS_File, gen_UnifiedMetamodel__APICall_ModuleFront, gen_UnifiedMetamodel__SpecialEntity_Entity, gen_UnifiedMetamodel__UIFront_ComponentFront, gen_UnifiedMetamodel__Visualizer_UIFront, gen_UnifiedMetamodel__Design_ModuleFront, gen_UnifiedMetamodel__RouterComponent_UIFront, gen_UnifiedMetamodel__Container_ComponentFront, gen_UnifiedMetamodel__JS_File, gen_UnifiedMetamodel__Redux_ModuleFront, gen_UnifiedMetamodel__GenericClass_EClass, gen_UnifiedMetamodel__AbstractClass_EClass, gen_UnifiedMetamodel__NativeClass_EClass, gen_UnifiedMetamodel__JavaScript_Layer, gen_UnifiedMetamodel__Util_LayerSegment, gen_UnifiedMetamodel__Reducers_SubLayerSegment, gen_UnifiedMetamodel__Actions_SubLayerSegment, gen_UnifiedMetamodel__Back_Component, gen_UnifiedMetamodel__Front_Component, gen_UnifiedMetamodel__React_ModuleFront, gen_UnifiedMetamodel__Annotation_EClass},
    metadata=None
)
