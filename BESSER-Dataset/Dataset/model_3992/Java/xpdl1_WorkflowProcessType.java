...
public class xpdl1_WorkflowProcessType  {
    ...
    private xpdl1_WorkflowProcessesType xpdl1_workflowprocessestype;
    ...
    public xpdl1_WorkflowProcessType(
        String accessLevel,        String id,        String name    ) {
    ...
    public xpdl1_WorkflowProcessesType getXpdl1_workflowprocessestype() {
        return xpdl1_workflowprocessestype;
    }

    public void setXpdl1_workflowprocessestype(xpdl1_WorkflowProcessesType xpdl1_workflowprocessestype) {
        this.xpdl1_workflowprocessestype = xpdl1_workflowprocessestype;
    }
