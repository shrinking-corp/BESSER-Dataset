...
class extlibrary_Library(Addressable):
    ...
    def __init__(self, name: str, people: str, extlibrary_Library5: set["extlibrary_Borrower"] = None, extlibrary_Library7: set["extlibrary_Item"] = None, extlibrary_Library9: set["extlibrary_Book"] = None, Library: "extlibrary_Library" = None, parentBranch: set["extlibrary_Library"] = None, Library14: "extlibrary_Library" = None, branches: "extlibrary_Library" = None, extlibrary_Library: set["extlibrary_Writer"] = None, extlibrary_Library3: set["extlibrary_Employee"] = None):
        self.name = name
        self.people = people
...
class extlibrary_Writer(Person):
    ...
    def __init__(self, name: str, author: set["extlibrary_Book"] = None, extlibrary_Writer20: "extlibrary_BookOnTape" = None, Writer: "extlibrary_Book" = None, extlibrary_Writer: "extlibrary_Library" = None):
        self.name = name
...
class extlibrary_Book(CirculatingItem):
    ...
    def __init__(self, pages: int, category: str, title: str, extlibrary_Book: "extlibrary_Library" = None, Book: "extlibrary_Writer" = None, books: "extlibrary_Writer" = None):
        self.pages = pages
