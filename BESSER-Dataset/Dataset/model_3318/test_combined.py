...
def test_hyp_traceability_trace_objects_setter(instance):
...
@given(instance=traceability_Trace_strategy)
def test_hyp_traceability_trace_id_setter(instance):
...
def test_hyp_traceability_traceability_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
