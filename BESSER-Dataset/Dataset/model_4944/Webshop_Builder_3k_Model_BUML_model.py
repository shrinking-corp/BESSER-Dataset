...
# Classes
webshop_builder_3k_model_Page = Class(name="webshop_builder_3k_model_Page")
webshop_builder_3k_model_Component = Class(name="webshop_builder_3k_model_Component", is_abstract=True)
webshop_builder_3k_model_Reuse_component = Class(name="webshop_builder_3k_model_Reuse_component")
webshop_builder_3k_model_Style = Class(name="webshop_builder_3k_model_Style")
webshop_builder_3k_model_Picture = Class(name="webshop_builder_3k_model_Picture")
Component = Class(name="Component")
webshop_builder_3k_model_Text_field = Class(name="webshop_builder_3k_model_Text_field")
webshop_builder_3k_model_User_input_field = Class(name="webshop_builder_3k_model_User_input_field")
webshop_builder_3k_model_Knowledge_base = Class(name="webshop_builder_3k_model_Knowledge_base")
webshop_builder_3k_model_Item_to_KB_link = Class(name="webshop_builder_3k_model_Item_to_KB_link")
webshop_builder_3k_model_Item = Class(name="webshop_builder_3k_model_Item")
webshop_builder_3k_model_Checkbox = Class(name="webshop_builder_3k_model_Checkbox")
User_input_field = Class(name="User_input_field")
webshop_builder_3k_model_Branding = Class(name="webshop_builder_3k_model_Branding")
webshop_builder_3k_model_Reuses_component_link = Class(name="webshop_builder_3k_model_Reuses_component_link")
webshop_builder_3k_model_Login_widget = Class(name="webshop_builder_3k_model_Login_widget")
webshop_builder_3k_model_Slideshow = Class(name="webshop_builder_3k_model_Slideshow")
webshop_builder_3k_model_Social_button = Class(name="webshop_builder_3k_model_Social_button")
webshop_builder_3k_model_Newsletter_subscription_widget = Class(name="webshop_builder_3k_model_Newsletter_subscription_widget")
webshop_builder_3k_model_Shopping_cart_button = Class(name="webshop_builder_3k_model_Shopping_cart_button")
webshop_builder_3k_model_Search_widget = Class(name="webshop_builder_3k_model_Search_widget")
webshop_builder_3k_model_Menu = Class(name="webshop_builder_3k_model_Menu")
webshop_builder_3k_model_Component_group = Class(name="webshop_builder_3k_model_Component_group")
webshop_builder_3k_model_Result_list = Class(name="webshop_builder_3k_model_Result_list")
webshop_builder_3k_model_Radio_button = Class(name="webshop_builder_3k_model_Radio_button")
webshop_builder_3k_model_Text_input_field = Class(name="webshop_builder_3k_model_Text_input_field")
webshop_builder_3k_model_Webshop_builder_3k = Class(name="webshop_builder_3k_model_Webshop_builder_3k")
webshop_builder_3k_model_Border = Class(name="webshop_builder_3k_model_Border")
webshop_builder_3k_model_Source_code = Class(name="webshop_builder_3k_model_Source_code")
webshop_builder_3k_model_Navigation_button = Class(name="webshop_builder_3k_model_Navigation_button")
webshop_builder_3k_model_Navigation_to_Page_link = Class(name="webshop_builder_3k_model_Navigation_to_Page_link")
...
webshop_builder_3k_model_Page.attributes={webshop_builder_3k_model_Page_title, webshop_builder_3k_model_Page_width, webshop_builder_3k_model_Page_canvas_color, webshop_builder_3k_model_Page_height}
...
webshop_builder_3k_model_Component.attributes={webshop_builder_3k_model_Component_yposition, webshop_builder_3k_model_Component_alignment, webshop_builder_3k_model_Component_width, webshop_builder_3k_model_Component_xposition, webshop_builder_3k_model_Component_name, webshop_builder_3k_model_Component_height}
...
webshop_builder_3k_model_Picture.attributes={webshop_builder_3k_model_Picture_source, webshop_builder_3k_model_Picture_title, webshop_builder_3k_model_Picture_alternative_text}
...
webshop_builder_3k_model_Result_list.attributes={webshop_builder_3k_model_Result_list_number_of_items_per_page, webshop_builder_3k_model_Result_list_distance_between_items}
...
domain_model = DomainModel(
    ...
    types={webshop_builder_3k_model_Page, webshop_builder_3k_model_Component, webshop_builder_3k_model_Reuse_component, webshop_builder_3k_model_Style, webshop_builder_3k_model_Picture, Component, webshop_builder_3k_model_Text_field, webshop_builder_3k_model_User_input_field, webshop_builder_3k_model_Knowledge_base, webshop_builder_3k_model_Item_to_KB_link, webshop_builder_3k_model_Item, webshop_builder_3k_model_Checkbox, User_input_field, webshop_builder_3k_model_Branding, webshop_builder_3k_model_Reuses_component_link, webshop_builder_3k_model_Login_widget, webshop_builder_3k_model_Slideshow, webshop_builder_3k_model_Social_button, webshop_builder_3k_model_Newsletter_subscription_widget, webshop_builder_3k_model_Shopping_cart_button, webshop_builder_3k_model_Search_widget, webshop_builder_3k_model_Menu, webshop_builder_3k_model_Component_group, webshop_builder_3k_model_Result_list, webshop_builder_3k_model_Radio_button, webshop_builder_3k_model_Text_input_field, webshop_builder_3k_model_Webshop_builder_3k, webshop_builder_3k_model_Border, webshop_builder_3k_model_Source_code, webshop_builder_3k_model_Navigation_button, webshop_builder_3k_model_Navigation_to_Page_link, Alignment},
    associations={components0, reuse_components1, style3, item9, knowledge_base10, company_name11, link5, style6, knowledge_bases22, index_page25, item_details_page28, item_picture31, text_fields33, kb_link36, company_logo12, source14, target15, pages17, free_components19, Source45, target47, border49, result_template37, link39, picture40, text42},
    generalizations={gen_webshop_builder_3k_model_Picture_Component, gen_webshop_builder_3k_model_Text_field_Component, gen_webshop_builder_3k_model_Checkbox_User_input_field, gen_webshop_builder_3k_model_Branding_Component, gen_webshop_builder_3k_model_Item_Component, gen_webshop_builder_3k_model_Result_list_Component, gen_webshop_builder_3k_model_Radio_button_User_input_field, gen_webshop_builder_3k_model_Text_input_field_User_input_field, gen_webshop_builder_3k_model_Navigation_button_Component},
    metadata=None
)
