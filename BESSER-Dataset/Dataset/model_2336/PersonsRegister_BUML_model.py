...
# Classes
PersonsRegister_PersonsRegister = Class(name="PersonsRegister_PersonsRegister")
PersonsRegister_Person = Class(name="PersonsRegister_Person")
...
PersonsRegister_Person.attributes={PersonsRegister_Person_lastName, PersonsRegister_Person_firstName, PersonsRegister_Person_identity}
