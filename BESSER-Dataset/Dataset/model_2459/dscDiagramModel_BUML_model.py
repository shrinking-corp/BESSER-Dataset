...
# Classes
dscDiagramModel_DSCDiagram = Class(name="dscDiagramModel_DSCDiagram")
GenericDiagram = Class(name="GenericDiagram")
Container = Class(name="Container")
dscDiagramModel_AnchorNoteToItem = Class(name="dscDiagramModel_AnchorNoteToItem")
Relationship = Class(name="Relationship")
dscDiagramModel_Transition = Class(name="dscDiagramModel_Transition")
dscDiagramModel_StartPoint = Class(name="dscDiagramModel_StartPoint")
Classifier = Class(name="Classifier")
dscDiagramModel_DSCState = Class(name="dscDiagramModel_DSCState")
dscDiagramModel_ShallowHistory = Class(name="dscDiagramModel_ShallowHistory")
dscDiagramModel_DeepHistory = Class(name="dscDiagramModel_DeepHistory")
...
dscDiagramModel_DSCDiagram.attributes={dscDiagramModel_DSCDiagram_guardFile, dscDiagramModel_DSCDiagram_actionFile, dscDiagramModel_DSCDiagram_eventFile, dscDiagramModel_DSCDiagram_diagramVariables, dscDiagramModel_DSCDiagram_functionFile}
...
dscDiagramModel_Transition.attributes={dscDiagramModel_Transition_showTransitionID, dscDiagramModel_Transition_eventID, dscDiagramModel_Transition_showProperties, dscDiagramModel_Transition_triggeredByEvent, dscDiagramModel_Transition_actionID, dscDiagramModel_Transition_transitionID, dscDiagramModel_Transition_guardID}
...
domain_model = DomainModel(
    ...
    types={dscDiagramModel_DSCDiagram, GenericDiagram, Container, dscDiagramModel_AnchorNoteToItem, Relationship, dscDiagramModel_Transition, dscDiagramModel_StartPoint, Classifier, dscDiagramModel_DSCState, dscDiagramModel_ShallowHistory, dscDiagramModel_DeepHistory},
    associations={startPoint5, shallowHistory6, deepHistory8, compositeState0, compositeState1, compositeState3},
    generalizations={gen_dscDiagramModel_DSCDiagram_GenericDiagram, gen_dscDiagramModel_DSCState_Container, gen_dscDiagramModel_AnchorNoteToItem_Relationship, gen_dscDiagramModel_Transition_Relationship, gen_dscDiagramModel_StartPoint_Classifier, gen_dscDiagramModel_ShallowHistory_Classifier, gen_dscDiagramModel_DeepHistory_Classifier},
    metadata=None
)
