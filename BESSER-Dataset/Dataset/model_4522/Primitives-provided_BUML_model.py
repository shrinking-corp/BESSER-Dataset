...
# Classes
PrimitivesProv_Primitive = Class(name="PrimitivesProv_Primitive", is_abstract=True)
Instruction = Class(name="Instruction")
PrimitivesProv_Forward = Class(name="PrimitivesProv_Forward")
Primitive = Class(name="Primitive")
PrimitivesProv_Back = Class(name="PrimitivesProv_Back")
PrimitivesProv_Left = Class(name="PrimitivesProv_Left")
PrimitivesProv_Right = Class(name="PrimitivesProv_Right")
PrimitivesProv_LogoProgram = Class(name="PrimitivesProv_LogoProgram")
PrimitivesProv_Instruction = Class(name="PrimitivesProv_Instruction", is_abstract=True)
...
PrimitivesProv_Instruction_m_evalInstruction: Method = Method(name="evalInstruction", parameters={Parameter(name='PrimitivesProv_context', type=StringType)})
