...
# Classes
shr5Management_ManagedCharacter = Class(name="shr5Management_ManagedCharacter", is_abstract=True)
shr5Management_AbstraktPersona = Class(name="shr5Management_AbstraktPersona")
shr5Management_Changes = Class(name="shr5Management_Changes", is_abstract=True)
shr5Management_AbstraktGegenstand = Class(name="shr5Management_AbstraktGegenstand")
shr5Management_Vertrag = Class(name="shr5Management_Vertrag")
shr5Management_Connection = Class(name="shr5Management_Connection")
shr5Management_Fahrzeug = Class(name="shr5Management_Fahrzeug")
shr5Management_Lifestyle = Class(name="shr5Management_Lifestyle")
shr5Management_Sprachfertigkeit = Class(name="shr5Management_Sprachfertigkeit")
shr5Management_CharacterGeneratorSystem = Class(name="shr5Management_CharacterGeneratorSystem", is_abstract=True)
Beschreibbar = Class(name="Beschreibbar")
Quelle = Class(name="Quelle")
shr5Management_GeneratorStateToEStringMapEntry = Class(name="shr5Management_GeneratorStateToEStringMapEntry")
shr5Management_CharacterAdvancementSystem = Class(name="shr5Management_CharacterAdvancementSystem")
shr5Management_QuellenConstrain = Class(name="shr5Management_QuellenConstrain")
shr5Management_PrioritySystem = Class(name="shr5Management_PrioritySystem", is_abstract=True)
CharacterGeneratorSystem = Class(name="CharacterGeneratorSystem")
shr5Management_PriorityCategorie = Class(name="shr5Management_PriorityCategorie", is_abstract=True)
shr5Management_NonPlayerCharacter = Class(name="shr5Management_NonPlayerCharacter")
ManagedCharacter = Class(name="ManagedCharacter")
shr5Management_KarmaGaint = Class(name="shr5Management_KarmaGaint")
Changes = Class(name="Changes")
shr5Management_FreeStyle = Class(name="shr5Management_FreeStyle")
shr5Management_Shr5System = Class(name="shr5Management_Shr5System")
PrioritySystem = Class(name="PrioritySystem")
shr5Management_LifestyleToStartMoney = Class(name="shr5Management_LifestyleToStartMoney")
shr5Management_EClass = Class(name="shr5Management_EClass")
shr5Management_MetaType = Class(name="shr5Management_MetaType")
PriorityCategorie = Class(name="PriorityCategorie")
shr5Management_Spezies = Class(name="shr5Management_Spezies")
shr5Management_Attributes = Class(name="shr5Management_Attributes")
shr5Management_Skill = Class(name="shr5Management_Skill")
shr5Management_Resourcen = Class(name="shr5Management_Resourcen")
shr5Management_SpecialType = Class(name="shr5Management_SpecialType", is_abstract=True)
shr5Management_Fertigkeit = Class(name="shr5Management_Fertigkeit")
shr5Management_FertigkeitsGruppe = Class(name="shr5Management_FertigkeitsGruppe")
shr5Management_Technomancer = Class(name="shr5Management_Technomancer")
SpecialType = Class(name="SpecialType")
shr5Management_Spellcaster = Class(name="shr5Management_Spellcaster")
Adept = Class(name="Adept")
shr5Management_Adept = Class(name="shr5Management_Adept")
shr5Management_CharacterGenerator = Class(name="shr5Management_CharacterGenerator", is_abstract=True)
shr5Management_CharacterGroup = Class(name="shr5Management_CharacterGroup")
shr5Management_FreeStyleGenerator = Class(name="shr5Management_FreeStyleGenerator")
shr5Management_Shr5Generator = Class(name="shr5Management_Shr5Generator")
shr5Management_AttributeChange = Class(name="shr5Management_AttributeChange")
PersonaValueChange = Class(name="PersonaValueChange")
shr5Management_EAttribute = Class(name="shr5Management_EAttribute")
shr5Management_PlayerCharacter = Class(name="shr5Management_PlayerCharacter")
shr5Management_CharacterDiary = Class(name="shr5Management_CharacterDiary")
shr5Management_Mudan = Class(name="shr5Management_Mudan")
shr5Management_PersonaChange = Class(name="shr5Management_PersonaChange")
shr5Management_Erlernbar = Class(name="shr5Management_Erlernbar")
shr5Management_Advancement = Class(name="shr5Management_Advancement", is_abstract=True)
shr5Management_IncreaseCharacterPart = Class(name="shr5Management_IncreaseCharacterPart")
shr5Management_GruntGroup = Class(name="shr5Management_GruntGroup")
shr5Management_GruntMembers = Class(name="shr5Management_GruntMembers")
shr5Management_PlayerManagement = Class(name="shr5Management_PlayerManagement")
shr5Management_PersonaValueChange = Class(name="shr5Management_PersonaValueChange", is_abstract=True)
shr5Management_GamemasterManagement = Class(name="shr5Management_GamemasterManagement")
PlayerManagement = Class(name="PlayerManagement")
shr5Management_Shr5RuleGenerator = Class(name="shr5Management_Shr5RuleGenerator", is_abstract=True)
shr5Management_SourceBook = Class(name="shr5Management_SourceBook")
shr5Management_KarmaGenerator = Class(name="shr5Management_KarmaGenerator", is_abstract=True)
shr5Management_Quelle = Class(name="shr5Management_Quelle")
shr5Management_Pack = Class(name="shr5Management_Pack")
GeldWert = Class(name="GeldWert")
shr5Management_DiaryEntry = Class(name="shr5Management_DiaryEntry")
shr5Management_ContractPayment = Class(name="shr5Management_ContractPayment")
DiaryEntry = Class(name="DiaryEntry")
shr5Management_CharacterChange = Class(name="shr5Management_CharacterChange")
shr5Management_SumToTenGenerator = Class(name="shr5Management_SumToTenGenerator")
Shr5Generator = Class(name="Shr5Generator")
shr5Management_LifeModulesGenerator = Class(name="shr5Management_LifeModulesGenerator")
shr5Management_LifeModule = Class(name="shr5Management_LifeModule")
shr5Management_LifeModulesSystem = Class(name="shr5Management_LifeModulesSystem")
Shr5System = Class(name="Shr5System")
shr5Management_ModuleChange = Class(name="shr5Management_ModuleChange", is_abstract=True)
shr5Management_ModuleSkillChange = Class(name="shr5Management_ModuleSkillChange")
shr5Management_ModuleTeachableChange = Class(name="shr5Management_ModuleTeachableChange")
shr5Management_ModuleAttributeChange = Class(name="shr5Management_ModuleAttributeChange")
shr5Management_ModuleFeatureChange = Class(name="shr5Management_ModuleFeatureChange")
ModuleChange = Class(name="ModuleChange")
shr5Management_EReference = Class(name="shr5Management_EReference")
shr5Management_EObject = Class(name="shr5Management_EObject")
shr5Management_ModuleSkillGroupChange = Class(name="shr5Management_ModuleSkillGroupChange")
shr5Management_ModuleTypeChange = Class(name="shr5Management_ModuleTypeChange", is_abstract=True)
shr5Management_Shr5KarmaGenerator = Class(name="shr5Management_Shr5KarmaGenerator")
shr5Management_TrainingRate = Class(name="shr5Management_TrainingRate")
RangeTableEntry = Class(name="RangeTableEntry")
shr5Management_RangeTableEntry = Class(name="shr5Management_RangeTableEntry", is_abstract=True)
shr5Management_RangeTable = Class(name="shr5Management_RangeTable", is_abstract=True)
shr5Management_TrainingsTime = Class(name="shr5Management_TrainingsTime")
CharacterChange = Class(name="CharacterChange")
shr5Management_TrainingRange = Class(name="shr5Management_TrainingRange")
shr5Management_PersonaMartialArtChange = Class(name="shr5Management_PersonaMartialArtChange")
PersonaChange = Class(name="PersonaChange")
shr5Management_MartialartStyle = Class(name="shr5Management_MartialartStyle")
shr5Management_MartialartTechnique = Class(name="shr5Management_MartialartTechnique")
...
shr5Management_ManagedCharacter.attributes={shr5Management_ManagedCharacter_sex, shr5Management_ManagedCharacter_weight, shr5Management_ManagedCharacter_streetCred, shr5Management_ManagedCharacter_karmaGaint, shr5Management_ManagedCharacter_notoriety, shr5Management_ManagedCharacter_height, shr5Management_ManagedCharacter_publicAwareness, shr5Management_ManagedCharacter_notorietyBasic, shr5Management_ManagedCharacter_dateofbirth, shr5Management_ManagedCharacter_currentKarma}
...
shr5Management_Changes.attributes={shr5Management_Changes_dateApplied, shr5Management_Changes_changeApplied, shr5Management_Changes_karmaCost, shr5Management_Changes_date}
...
shr5Management_Connection.attributes={shr5Management_Connection_influence, shr5Management_Connection_loyality}
...
shr5Management_GeneratorStateToEStringMapEntry.attributes={shr5Management_GeneratorStateToEStringMapEntry_value, shr5Management_GeneratorStateToEStringMapEntry_key}
...
shr5Management_PriorityCategorie.attributes={shr5Management_PriorityCategorie_categorieName, shr5Management_PriorityCategorie_cost}
...
shr5Management_Shr5System.attributes={shr5Management_Shr5System_skillMax, shr5Management_Shr5System_charismaToConnectionFactor, shr5Management_Shr5System_knowlegeSkillFactor, shr5Management_Shr5System_maxResourceToKeep, shr5Management_Shr5System_karmaToResourceFactor, shr5Management_Shr5System_maxKarmaToResources, shr5Management_Shr5System_maxKarmaToKeep, shr5Management_Shr5System_karmaToConnectionFactor, shr5Management_Shr5System_numberOfSpecalism, shr5Management_Shr5System_maxMartialArtStyles, shr5Management_Shr5System_boundSprititServiceCost, shr5Management_Shr5System_maxConnectionRating, shr5Management_Shr5System_numberOfMaxAttributes, shr5Management_Shr5System_sumToTenValue, shr5Management_Shr5System_karmaToMagicFactor, shr5Management_Shr5System_freeMartialArtTechniques}
...
shr5Management_MetaType_m_calcSpecialPointsSpend: Method = Method(name="calcSpecialPointsSpend", parameters={Parameter(name='shr5Management_context', type=StringType)}, type=IntegerType)
...
shr5Management_Attributes_m_calcAttributesSpend: Method = Method(name="calcAttributesSpend", parameters={Parameter(name='shr5Management_context', type=StringType)}, type=IntegerType)
...
shr5Management_Skill_m_calcSkillSpend: Method = Method(name="calcSkillSpend", parameters={Parameter(name='shr5Management_context', type=StringType)}, type=IntegerType)
shr5Management_Skill_m_calcGroupSpend: Method = Method(name="calcGroupSpend", parameters={Parameter(name='shr5Management_context', type=StringType)}, type=IntegerType)
shr5Management_Skill_m_calcKnowledgeSkillSpend: Method = Method(name="calcKnowledgeSkillSpend", parameters={Parameter(name='shr5Management_context', type=StringType)}, type=IntegerType)
shr5Management_Skill_m_calcKnowledgeSkillPoints: Method = Method(name="calcKnowledgeSkillPoints", parameters={Parameter(name='shr5Management_context', type=StringType)}, type=IntegerType)
shr5Management_Skill.attributes={shr5Management_Skill_groupPoints, shr5Management_Skill_skillPoints}
shr5Management_Skill.methods={shr5Management_Skill_m_calcKnowledgeSkillSpend, shr5Management_Skill_m_calcKnowledgeSkillPoints, shr5Management_Skill_m_calcSkillSpend, shr5Management_Skill_m_calcGroupSpend}
...
shr5Management_Resourcen_m_calcResourceSpend: Method = Method(name="calcResourceSpend", parameters={Parameter(name='shr5Management_context', type=StringType)}, type=IntegerType)
...
shr5Management_SpecialType_m_calcSkillsSpend: Method = Method(name="calcSkillsSpend", parameters={Parameter(name='shr5Management_context', type=StringType)}, type=IntegerType)
...
shr5Management_Technomancer_m_calcComplexFormsSpend: Method = Method(name="calcComplexFormsSpend", parameters={Parameter(name='shr5Management_context', type=StringType)}, type=IntegerType)
shr5Management_Technomancer.attributes={shr5Management_Technomancer_complexForms, shr5Management_Technomancer_resonanz}
...
shr5Management_Spellcaster_m_calcSpellPointsSpend: Method = Method(name="calcSpellPointsSpend", parameters={Parameter(name='shr5Management_context', type=StringType)}, type=IntegerType)
...
shr5Management_Adept_m_calcPowerPointsSpend: Method = Method(name="calcPowerPointsSpend", parameters={Parameter(name='shr5Management_context', type=StringType)}, type=IntegerType)
...
shr5Management_CharacterGenerator.attributes={shr5Management_CharacterGenerator_currentInstruction, shr5Management_CharacterGenerator_characterName, shr5Management_CharacterGenerator_state}
...
shr5Management_Shr5Generator_m_hasNotMoreMaxAttributes: Method = Method(name="hasNotMoreMaxAttributes", parameters={Parameter(name='shr5Management_context', type=StringType), Parameter(name='shr5Management_diagnostics', type=StringType)}, type=BooleanType)
shr5Management_Shr5Generator_m_hasSpendAllAttributesPoints: Method = Method(name="hasSpendAllAttributesPoints", parameters={Parameter(name='shr5Management_diagnostics', type=StringType), Parameter(name='shr5Management_context', type=StringType)}, type=BooleanType)
shr5Management_Shr5Generator_m_hasSpendAllSkillPoints: Method = Method(name="hasSpendAllSkillPoints", parameters={Parameter(name='shr5Management_diagnostics', type=StringType), Parameter(name='shr5Management_context', type=StringType)}, type=BooleanType)
shr5Management_Shr5Generator_m_hasSpendAllSpecialPoints: Method = Method(name="hasSpendAllSpecialPoints", parameters={Parameter(name='shr5Management_context', type=StringType), Parameter(name='shr5Management_diagnostics', type=StringType)}, type=BooleanType)
shr5Management_Shr5Generator_m_hasSpendAllSpecialTypePoints: Method = Method(name="hasSpendAllSpecialTypePoints", parameters={Parameter(name='shr5Management_context', type=StringType), Parameter(name='shr5Management_diagnostics', type=StringType)}, type=BooleanType)
shr5Management_Shr5Generator_m_hasCategoryOnlyOnce: Method = Method(name="hasCategoryOnlyOnce", parameters={Parameter(name='shr5Management_context', type=StringType), Parameter(name='shr5Management_diagnostics', type=StringType)}, type=BooleanType)
shr5Management_Shr5Generator_m_hasSpendAllResourcePoints: Method = Method(name="hasSpendAllResourcePoints", parameters={Parameter(name='shr5Management_diagnostics', type=StringType), Parameter(name='shr5Management_context', type=StringType)}, type=BooleanType)
shr5Management_Shr5Generator_m_hasSpendAllMagicSkillsPoints: Method = Method(name="hasSpendAllMagicSkillsPoints", parameters={Parameter(name='shr5Management_context', type=StringType), Parameter(name='shr5Management_diagnostics', type=StringType)}, type=BooleanType)
shr5Management_Shr5Generator_m_hasSpendAllMagicPoints: Method = Method(name="hasSpendAllMagicPoints", parameters={Parameter(name='shr5Management_diagnostics', type=StringType), Parameter(name='shr5Management_context', type=StringType)}, type=BooleanType)
shr5Management_Shr5Generator_m_hasSpendAllConnectionPoints: Method = Method(name="hasSpendAllConnectionPoints", parameters={Parameter(name='shr5Management_diagnostics', type=StringType), Parameter(name='shr5Management_context', type=StringType)}, type=BooleanType)
shr5Management_Shr5Generator_m_hasSpendAllGroupPoints: Method = Method(name="hasSpendAllGroupPoints", parameters={Parameter(name='shr5Management_context', type=StringType), Parameter(name='shr5Management_diagnostics', type=StringType)}, type=BooleanType)
shr5Management_Shr5Generator_m_hasSpendAllKnowlegeSkillPoints: Method = Method(name="hasSpendAllKnowlegeSkillPoints", parameters={Parameter(name='shr5Management_context', type=StringType), Parameter(name='shr5Management_diagnostics', type=StringType)}, type=BooleanType)
shr5Management_Shr5Generator_m_hasSpendAllKarmaPoints: Method = Method(name="hasSpendAllKarmaPoints", parameters={Parameter(name='shr5Management_context', type=StringType), Parameter(name='shr5Management_diagnostics', type=StringType)}, type=BooleanType)
shr5Management_Shr5Generator_m_hasSpendAllSpellPoints: Method = Method(name="hasSpendAllSpellPoints", parameters={Parameter(name='shr5Management_context', type=StringType), Parameter(name='shr5Management_diagnostics', type=StringType)}, type=BooleanType)
shr5Management_Shr5Generator_m_hasSpendAllPowerPoints: Method = Method(name="hasSpendAllPowerPoints", parameters={Parameter(name='shr5Management_diagnostics', type=StringType), Parameter(name='shr5Management_context', type=StringType)}, type=BooleanType)
shr5Management_Shr5Generator.attributes={shr5Management_Shr5Generator_groupPointSpend, shr5Management_Shr5Generator_specialPointSpend, shr5Management_Shr5Generator_attributeSpend, shr5Management_Shr5Generator_knownlegePointSpend, shr5Management_Shr5Generator_karmaToResource, shr5Management_Shr5Generator_spellPointSpend, shr5Management_Shr5Generator_startResources, shr5Management_Shr5Generator_karmaSpend, shr5Management_Shr5Generator_resourceSpend, shr5Management_Shr5Generator_connectionSpend, shr5Management_Shr5Generator_skillPointSpend, shr5Management_Shr5Generator_startKarma}
shr5Management_Shr5Generator.methods={shr5Management_Shr5Generator_m_hasSpendAllSpellPoints, shr5Management_Shr5Generator_m_hasSpendAllKarmaPoints, shr5Management_Shr5Generator_m_hasCategoryOnlyOnce, shr5Management_Shr5Generator_m_hasSpendAllSpecialTypePoints, shr5Management_Shr5Generator_m_hasNotMoreMaxAttributes, shr5Management_Shr5Generator_m_hasSpendAllMagicSkillsPoints, shr5Management_Shr5Generator_m_hasSpendAllMagicPoints, shr5Management_Shr5Generator_m_hasSpendAllKnowlegeSkillPoints, shr5Management_Shr5Generator_m_hasSpendAllResourcePoints, shr5Management_Shr5Generator_m_hasSpendAllSpecialPoints, shr5Management_Shr5Generator_m_hasSpendAllConnectionPoints, shr5Management_Shr5Generator_m_hasSpendAllAttributesPoints, shr5Management_Shr5Generator_m_hasSpendAllPowerPoints, shr5Management_Shr5Generator_m_hasSpendAllGroupPoints, shr5Management_Shr5Generator_m_hasSpendAllSkillPoints}
...
shr5Management_PersonaValueChange_from_: Property = Property(name="from_", type=IntegerType)
shr5Management_PersonaValueChange_to: Property = Property(name="to", type=IntegerType)
shr5Management_PersonaValueChange.attributes={shr5Management_PersonaValueChange_to, shr5Management_PersonaValueChange_from_}
...
shr5Management_Shr5RuleGenerator_m_hasSpendAllPoints: Method = Method(name="hasSpendAllPoints", parameters={Parameter(name='shr5Management_context', type=StringType), Parameter(name='shr5Management_diagnostics', type=StringType)}, type=BooleanType)
shr5Management_Shr5RuleGenerator_m_hasNotMoreMaxAttributes: Method = Method(name="hasNotMoreMaxAttributes", parameters={Parameter(name='shr5Management_diagnostics', type=StringType), Parameter(name='shr5Management_context', type=StringType)}, type=BooleanType)
shr5Management_Shr5RuleGenerator_m_hasNoSkillsOverMax: Method = Method(name="hasNoSkillsOverMax", parameters={Parameter(name='shr5Management_diagnostics', type=StringType), Parameter(name='shr5Management_context', type=StringType)}, type=BooleanType)
shr5Management_Shr5RuleGenerator_m_hasNotMoreSpecalism: Method = Method(name="hasNotMoreSpecalism", parameters={Parameter(name='shr5Management_context', type=StringType), Parameter(name='shr5Management_diagnostics', type=StringType)}, type=BooleanType)
shr5Management_Shr5RuleGenerator_m_hasNoAttributesOverSpeciesAtt: Method = Method(name="hasNoAttributesOverSpeciesAtt", parameters={Parameter(name='shr5Management_context', type=StringType), Parameter(name='shr5Management_diagnostics', type=StringType)}, type=BooleanType)
shr5Management_Shr5RuleGenerator_m_hasLifestyleChoosen: Method = Method(name="hasLifestyleChoosen", parameters={Parameter(name='shr5Management_context', type=StringType), Parameter(name='shr5Management_diagnostics', type=StringType)}, type=BooleanType)
shr5Management_Shr5RuleGenerator_m_hasOnlyAllowedSources: Method = Method(name="hasOnlyAllowedSources", parameters={Parameter(name='shr5Management_diagnostics', type=StringType), Parameter(name='shr5Management_context', type=StringType)}, type=BooleanType)
shr5Management_Shr5RuleGenerator_m_hasKiPowerOverLimit: Method = Method(name="hasKiPowerOverLimit", parameters={Parameter(name='shr5Management_context', type=StringType), Parameter(name='shr5Management_diagnostics', type=StringType)}, type=BooleanType)
shr5Management_Shr5RuleGenerator_m_hasBasicViolations: Method = Method(name="hasBasicViolations", parameters={Parameter(name='shr5Management_context', type=StringType), Parameter(name='shr5Management_diagnostics', type=StringType)}, type=BooleanType)
shr5Management_Shr5RuleGenerator_m_hasNoConstrainVoilation: Method = Method(name="hasNoConstrainVoilation", parameters={Parameter(name='shr5Management_context', type=StringType), Parameter(name='shr5Management_diagnostics', type=StringType)}, type=BooleanType)
shr5Management_Shr5RuleGenerator.methods={shr5Management_Shr5RuleGenerator_m_hasKiPowerOverLimit, shr5Management_Shr5RuleGenerator_m_hasOnlyAllowedSources, shr5Management_Shr5RuleGenerator_m_hasBasicViolations, shr5Management_Shr5RuleGenerator_m_hasNoSkillsOverMax, shr5Management_Shr5RuleGenerator_m_hasLifestyleChoosen, shr5Management_Shr5RuleGenerator_m_hasSpendAllPoints, shr5Management_Shr5RuleGenerator_m_hasNoAttributesOverSpeciesAtt, shr5Management_Shr5RuleGenerator_m_hasNoConstrainVoilation, shr5Management_Shr5RuleGenerator_m_hasNotMoreMaxAttributes, shr5Management_Shr5RuleGenerator_m_hasNotMoreSpecalism}
...
shr5Management_KarmaGenerator_m_hasSpendAllKarmaPoints: Method = Method(name="hasSpendAllKarmaPoints", parameters={Parameter(name='shr5Management_context', type=StringType), Parameter(name='shr5Management_diagnostics', type=StringType)}, type=BooleanType)
shr5Management_KarmaGenerator_m_hasSpendAllResources: Method = Method(name="hasSpendAllResources", parameters={Parameter(name='shr5Management_diagnostics', type=StringType), Parameter(name='shr5Management_context', type=StringType)}, type=BooleanType)
shr5Management_KarmaGenerator.attributes={shr5Management_KarmaGenerator_karmaSpend, shr5Management_KarmaGenerator_resourceSpend, shr5Management_KarmaGenerator_choiseKarmaCost, shr5Management_KarmaGenerator_startResources, shr5Management_KarmaGenerator_startKarma, shr5Management_KarmaGenerator_karmaToResource}
...
shr5Management_SumToTenGenerator_m_hasSumToTen: Method = Method(name="hasSumToTen", parameters={Parameter(name='shr5Management_context', type=StringType), Parameter(name='shr5Management_diagnostics', type=StringType)}, type=BooleanType)
...
shr5Management_LifeModule.attributes={shr5Management_LifeModule_moduleType, shr5Management_LifeModule_time, shr5Management_LifeModule_karmaCost}
...
shr5Management_TrainingRate.attributes={shr5Management_TrainingRate_factor, shr5Management_TrainingRate_timeUnit}

# RangeTableEntry class attributes and methods

# shr5Management_RangeTableEntry class attributes and methods
shr5Management_RangeTableEntry_from_: Property = Property(name="from_", type=IntegerType)
shr5Management_RangeTableEntry_to: Property = Property(name="to", type=IntegerType)
shr5Management_RangeTableEntry.attributes={shr5Management_RangeTableEntry_to, shr5Management_RangeTableEntry_from_}
...
shr5Management_TrainingsTime_m_hasValidRange: Method = Method(name="hasValidRange", parameters={Parameter(name='shr5Management_diagnostics', type=StringType), Parameter(name='shr5Management_context', type=StringType)}, type=BooleanType)
shr5Management_TrainingsTime.attributes={shr5Management_TrainingsTime_daysTrained, shr5Management_TrainingsTime_trainingComplete, shr5Management_TrainingsTime_daysRemains}
...
domain_model = DomainModel(
    name="shr5Management",
    types={shr5Management_ManagedCharacter, shr5Management_AbstraktPersona, shr5Management_Changes, shr5Management_AbstraktGegenstand, shr5Management_Vertrag, shr5Management_Connection, shr5Management_Fahrzeug, shr5Management_Lifestyle, shr5Management_Sprachfertigkeit, shr5Management_CharacterGeneratorSystem, Beschreibbar, Quelle, shr5Management_GeneratorStateToEStringMapEntry, shr5Management_CharacterAdvancementSystem, shr5Management_QuellenConstrain, shr5Management_PrioritySystem, CharacterGeneratorSystem, shr5Management_PriorityCategorie, shr5Management_NonPlayerCharacter, ManagedCharacter, shr5Management_KarmaGaint, Changes, shr5Management_FreeStyle, shr5Management_Shr5System, PrioritySystem, shr5Management_LifestyleToStartMoney, shr5Management_EClass, shr5Management_MetaType, PriorityCategorie, shr5Management_Spezies, shr5Management_Attributes, shr5Management_Skill, shr5Management_Resourcen, shr5Management_SpecialType, shr5Management_Fertigkeit, shr5Management_FertigkeitsGruppe, shr5Management_Technomancer, SpecialType, shr5Management_Spellcaster, Adept, shr5Management_Adept, shr5Management_CharacterGenerator, shr5Management_CharacterGroup, shr5Management_FreeStyleGenerator, shr5Management_Shr5Generator, shr5Management_AttributeChange, PersonaValueChange, shr5Management_EAttribute, shr5Management_PlayerCharacter, shr5Management_CharacterDiary, shr5Management_Mudan, shr5Management_PersonaChange, shr5Management_Erlernbar, shr5Management_Advancement, shr5Management_IncreaseCharacterPart, shr5Management_GruntGroup, shr5Management_GruntMembers, shr5Management_PlayerManagement, shr5Management_PersonaValueChange, shr5Management_GamemasterManagement, PlayerManagement, shr5Management_Shr5RuleGenerator, shr5Management_SourceBook, shr5Management_KarmaGenerator, shr5Management_Quelle, shr5Management_Pack, GeldWert, shr5Management_DiaryEntry, shr5Management_ContractPayment, DiaryEntry, shr5Management_CharacterChange, shr5Management_SumToTenGenerator, Shr5Generator, shr5Management_LifeModulesGenerator, shr5Management_LifeModule, shr5Management_LifeModulesSystem, Shr5System, shr5Management_ModuleChange, shr5Management_ModuleSkillChange, shr5Management_ModuleTeachableChange, shr5Management_ModuleAttributeChange, shr5Management_ModuleFeatureChange, ModuleChange, shr5Management_EReference, shr5Management_EObject, shr5Management_ModuleSkillGroupChange, shr5Management_ModuleTypeChange, shr5Management_Shr5KarmaGenerator, shr5Management_TrainingRate, RangeTableEntry, shr5Management_RangeTableEntry, shr5Management_RangeTable, shr5Management_TrainingsTime, CharacterChange, shr5Management_TrainingRange, shr5Management_PersonaMartialArtChange, PersonaChange, shr5Management_MartialartStyle, shr5Management_MartialartTechnique, GeneratorState, Sex, QuellenConstrainType, LifeModuleType},
    associations={persona0, changes1, inventar2, contracts4, connections6, vehicels8, choosenLifestyle10, nativeLanguage12, instructions14, lifestyleToStartMoney15, characterAdvancements17, additionalConstrains19, priorities21, character22, applicableGenerators23, choosableTypes24, selectableTypes25, selectableSkills27, selectableSkillGroups29, character31, selectedGroup33, freestyleGenerator34, selectedPersona35, selectedSpecies38, selectedType41, skills45, attribute47, metaType49, magic52, resourcen44, attibute55, diary56, members57, character60, changeable63, type64, lifeStyles66, members69, leader70, nsc73, entries78, grunts80, characterAdvancements82, groups75, allowedSources84, metaType85, characterConcept87, source90, targets92, items95, entries97, contractToPay99, change101, nationality102, formativeYears103, teenYears106, furtherEducation109, realLife112, modules115, characterChanges117, skill119, teachable121, attribute123, feature125, value126, skillGroup128, training130, style131, technique132, trainingTime134},
    generalizations={gen_shr5Management_CharacterGeneratorSystem_Beschreibbar, gen_shr5Management_CharacterGeneratorSystem_Quelle, gen_shr5Management_PrioritySystem_CharacterGeneratorSystem, gen_shr5Management_NonPlayerCharacter_ManagedCharacter, gen_shr5Management_KarmaGaint_Changes, gen_shr5Management_FreeStyle_CharacterGeneratorSystem, gen_shr5Management_Shr5System_PrioritySystem, gen_shr5Management_MetaType_PriorityCategorie, gen_shr5Management_Attributes_PriorityCategorie, gen_shr5Management_Skill_PriorityCategorie, gen_shr5Management_Resourcen_PriorityCategorie, gen_shr5Management_SpecialType_PriorityCategorie, gen_shr5Management_Technomancer_SpecialType, gen_shr5Management_Spellcaster_Adept, gen_shr5Management_Adept_SpecialType, gen_shr5Management_AttributeChange_PersonaValueChange, gen_shr5Management_PlayerCharacter_ManagedCharacter, gen_shr5Management_Mudan_SpecialType, gen_shr5Management_CharacterGroup_Beschreibbar, gen_shr5Management_PersonaChange_PersonaValueChange, gen_shr5Management_GruntGroup_Beschreibbar, gen_shr5Management_PlayerManagement_Beschreibbar, gen_shr5Management_PersonaValueChange_Changes, gen_shr5Management_GamemasterManagement_PlayerManagement, gen_shr5Management_CharacterAdvancementSystem_Beschreibbar, gen_shr5Management_Pack_Beschreibbar, gen_shr5Management_Pack_Quelle, gen_shr5Management_Pack_GeldWert, gen_shr5Management_ContractPayment_DiaryEntry, gen_shr5Management_CharacterChange_DiaryEntry, gen_shr5Management_SumToTenGenerator_Shr5Generator, gen_shr5Management_LifeModulesSystem_Shr5System, gen_shr5Management_LifeModule_Beschreibbar, gen_shr5Management_LifeModule_Quelle, gen_shr5Management_ModuleFeatureChange_ModuleChange, gen_shr5Management_ModuleTypeChange_ModuleChange, gen_shr5Management_TrainingRate_RangeTableEntry, gen_shr5Management_TrainingsTime_CharacterChange, gen_shr5Management_PersonaMartialArtChange_PersonaChange},
    metadata=None
)
