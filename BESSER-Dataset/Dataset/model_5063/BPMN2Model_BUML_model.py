...
# Classes
BPMN2Model_DocumentRoot = Class(name="BPMN2Model_DocumentRoot")
BPMNBase = Class(name="BPMNBase")
BPMN2Model_EStringToStringMapEntry = Class(name="BPMN2Model_EStringToStringMapEntry")
BPMN2Model_Activity = Class(name="BPMN2Model_Activity")
BPMN2Model_Artifact = Class(name="BPMN2Model_Artifact")
BPMN2Model_Assignment = Class(name="BPMN2Model_Assignment")
BPMN2Model_Association = Class(name="BPMN2Model_Association")
BPMN2Model_Auditing = Class(name="BPMN2Model_Auditing")
BPMN2Model_BaseElement = Class(name="BPMN2Model_BaseElement")
BPMN2Model_BoundaryEvent = Class(name="BPMN2Model_BoundaryEvent")
BPMN2Model_BusinessRuleTask = Class(name="BPMN2Model_BusinessRuleTask")
BPMN2Model_CallableElement = Class(name="BPMN2Model_CallableElement")
BPMN2Model_CallActivity = Class(name="BPMN2Model_CallActivity")
BPMN2Model_CallChoreography = Class(name="BPMN2Model_CallChoreography")
BPMN2Model_CallConversation = Class(name="BPMN2Model_CallConversation")
BPMN2Model_ConversationNode = Class(name="BPMN2Model_ConversationNode")
BPMN2Model_CancelEventDefinition = Class(name="BPMN2Model_CancelEventDefinition")
BPMN2Model_AdHocSubProcess = Class(name="BPMN2Model_AdHocSubProcess")
BPMN2Model_FlowElement = Class(name="BPMN2Model_FlowElement", is_abstract=True)
BPMN2Model_CatchEvent = Class(name="BPMN2Model_CatchEvent", is_abstract=True)
BPMN2Model_Category = Class(name="BPMN2Model_Category")
BPMN2Model_CategoryValue = Class(name="BPMN2Model_CategoryValue")
BPMN2Model_Choreography = Class(name="BPMN2Model_Choreography")
BPMN2Model_Collaboration = Class(name="BPMN2Model_Collaboration")
BPMN2Model_ChoreographyActivity = Class(name="BPMN2Model_ChoreographyActivity", is_abstract=True)
BPMN2Model_ChoreographyTask = Class(name="BPMN2Model_ChoreographyTask")
BPMN2Model_CompensateEventDefinition = Class(name="BPMN2Model_CompensateEventDefinition")
BPMN2Model_ComplexBehaviorDefinition = Class(name="BPMN2Model_ComplexBehaviorDefinition")
BPMN2Model_ComplexGateway = Class(name="BPMN2Model_ComplexGateway")
BPMN2Model_ConditionalEventDefinition = Class(name="BPMN2Model_ConditionalEventDefinition")
BPMN2Model_EventDefinition = Class(name="BPMN2Model_EventDefinition")
BPMN2Model_RootElement = Class(name="BPMN2Model_RootElement")
BPMN2Model_ConversationLink = Class(name="BPMN2Model_ConversationLink")
BPMN2Model_CorrelationKey = Class(name="BPMN2Model_CorrelationKey")
BPMN2Model_CorrelationProperty = Class(name="BPMN2Model_CorrelationProperty")
BPMN2Model_CorrelationPropertyBinding = Class(name="BPMN2Model_CorrelationPropertyBinding")
BPMN2Model_CorrelationPropertyRetrievalExpression = Class(name="BPMN2Model_CorrelationPropertyRetrievalExpression")
BPMN2Model_CorrelationSubscription = Class(name="BPMN2Model_CorrelationSubscription")
BPMN2Model_DataAssociation = Class(name="BPMN2Model_DataAssociation")
BPMN2Model_DataInput = Class(name="BPMN2Model_DataInput")
BPMN2Model_DataInputAssociation = Class(name="BPMN2Model_DataInputAssociation")
BPMN2Model_DataObject = Class(name="BPMN2Model_DataObject")
BPMN2Model_DataObjectReference = Class(name="BPMN2Model_DataObjectReference")
BPMN2Model_DataOutput = Class(name="BPMN2Model_DataOutput")
BPMN2Model_Conversation = Class(name="BPMN2Model_Conversation")
BPMN2Model_ConversationAssociation = Class(name="BPMN2Model_ConversationAssociation")
BPMN2Model_DataState = Class(name="BPMN2Model_DataState")
BPMN2Model_DataStore = Class(name="BPMN2Model_DataStore")
BPMN2Model_DataStoreReference = Class(name="BPMN2Model_DataStoreReference")
BPMN2Model_Definitions = Class(name="BPMN2Model_Definitions")
BPMN2Model_Documentation = Class(name="BPMN2Model_Documentation")
BPMN2Model_EndEvent = Class(name="BPMN2Model_EndEvent")
BPMN2Model_EndPoint = Class(name="BPMN2Model_EndPoint")
BPMN2Model_Error = Class(name="BPMN2Model_Error")
BPMN2Model_ErrorEventDefinition = Class(name="BPMN2Model_ErrorEventDefinition")
BPMN2Model_Escalation = Class(name="BPMN2Model_Escalation")
BPMN2Model_EscalationEventDefinition = Class(name="BPMN2Model_EscalationEventDefinition")
BPMN2Model_Event = Class(name="BPMN2Model_Event", is_abstract=True)
BPMN2Model_EventBasedGateway = Class(name="BPMN2Model_EventBasedGateway")
BPMN2Model_DataOutputAssociation = Class(name="BPMN2Model_DataOutputAssociation")
BPMN2Model_Expression = Class(name="BPMN2Model_Expression")
BPMN2Model_Extension = Class(name="BPMN2Model_Extension")
BPMN2Model_ExtensionAttributeValue = Class(name="BPMN2Model_ExtensionAttributeValue")
BPMN2Model_FlowNode = Class(name="BPMN2Model_FlowNode", is_abstract=True)
BPMN2Model_FormalExpression = Class(name="BPMN2Model_FormalExpression")
BPMN2Model_Gateway = Class(name="BPMN2Model_Gateway", is_abstract=True)
BPMN2Model_GlobalBusinessRuleTask = Class(name="BPMN2Model_GlobalBusinessRuleTask")
BPMN2Model_GlobalChoreographyTask = Class(name="BPMN2Model_GlobalChoreographyTask")
BPMN2Model_GlobalConversation = Class(name="BPMN2Model_GlobalConversation")
BPMN2Model_GlobalManualTask = Class(name="BPMN2Model_GlobalManualTask")
BPMN2Model_ExclusiveGateway = Class(name="BPMN2Model_ExclusiveGateway")
BPMN2Model_GlobalUserTask = Class(name="BPMN2Model_GlobalUserTask")
BPMN2Model_Group = Class(name="BPMN2Model_Group")
BPMN2Model_HumanPerformer = Class(name="BPMN2Model_HumanPerformer")
BPMN2Model_Performer = Class(name="BPMN2Model_Performer")
BPMN2Model_ResourceRole = Class(name="BPMN2Model_ResourceRole")
BPMN2Model_ImplicitThrowEvent = Class(name="BPMN2Model_ImplicitThrowEvent")
BPMN2Model_Import = Class(name="BPMN2Model_Import")
BPMN2Model_InclusiveGateway = Class(name="BPMN2Model_InclusiveGateway")
BPMN2Model_InputSet = Class(name="BPMN2Model_InputSet")
BPMN2Model_Interface = Class(name="BPMN2Model_Interface")
BPMN2Model_GlobalScriptTask = Class(name="BPMN2Model_GlobalScriptTask")
BPMN2Model_GlobalTask = Class(name="BPMN2Model_GlobalTask")
BPMN2Model_IntermediateThrowEvent = Class(name="BPMN2Model_IntermediateThrowEvent")
BPMN2Model_InputOutputBinding = Class(name="BPMN2Model_InputOutputBinding")
BPMN2Model_InputOutputSpecification = Class(name="BPMN2Model_InputOutputSpecification")
BPMN2Model_ItemDefinition = Class(name="BPMN2Model_ItemDefinition")
BPMN2Model_Lane = Class(name="BPMN2Model_Lane")
BPMN2Model_LaneSet = Class(name="BPMN2Model_LaneSet")
BPMN2Model_LinkEventDefinition = Class(name="BPMN2Model_LinkEventDefinition")
BPMN2Model_LoopCharacteristics = Class(name="BPMN2Model_LoopCharacteristics", is_abstract=True)
BPMN2Model_ManualTask = Class(name="BPMN2Model_ManualTask")
BPMN2Model_Message = Class(name="BPMN2Model_Message")
BPMN2Model_IntermediateCatchEvent = Class(name="BPMN2Model_IntermediateCatchEvent")
BPMN2Model_MessageFlow = Class(name="BPMN2Model_MessageFlow")
BPMN2Model_MessageFlowAssociation = Class(name="BPMN2Model_MessageFlowAssociation")
BPMN2Model_Monitoring = Class(name="BPMN2Model_Monitoring")
BPMN2Model_MultiInstanceLoopCharacteristics = Class(name="BPMN2Model_MultiInstanceLoopCharacteristics")
BPMN2Model_Operation = Class(name="BPMN2Model_Operation")
BPMN2Model_OutputSet = Class(name="BPMN2Model_OutputSet")
BPMN2Model_ParallelGateway = Class(name="BPMN2Model_ParallelGateway")
BPMN2Model_Participant = Class(name="BPMN2Model_Participant")
BPMN2Model_ParticipantAssociation = Class(name="BPMN2Model_ParticipantAssociation")
BPMN2Model_MessageEventDefinition = Class(name="BPMN2Model_MessageEventDefinition")
BPMN2Model_PartnerEntity = Class(name="BPMN2Model_PartnerEntity")
BPMN2Model_PartnerRole = Class(name="BPMN2Model_PartnerRole")
BPMN2Model_PotentialOwner = Class(name="BPMN2Model_PotentialOwner")
BPMN2Model_Process = Class(name="BPMN2Model_Process")
BPMN2Model_Property = Class(name="BPMN2Model_Property")
BPMN2Model_ParticipantMultiplicity = Class(name="BPMN2Model_ParticipantMultiplicity")
BPMN2Model_ReceiveTask = Class(name="BPMN2Model_ReceiveTask")
BPMN2Model_Relationship = Class(name="BPMN2Model_Relationship")
BPMN2Model_Rendering = Class(name="BPMN2Model_Rendering")
BPMN2Model_Resource = Class(name="BPMN2Model_Resource")
BPMN2Model_ResourceAssignmentExpression = Class(name="BPMN2Model_ResourceAssignmentExpression")
BPMN2Model_ResourceParameter = Class(name="BPMN2Model_ResourceParameter")
BPMN2Model_ResourceParameterBinding = Class(name="BPMN2Model_ResourceParameterBinding")
BPMN2Model_ScriptTask = Class(name="BPMN2Model_ScriptTask")
BPMN2Model_SendTask = Class(name="BPMN2Model_SendTask")
BPMN2Model_SequenceFlow = Class(name="BPMN2Model_SequenceFlow")
BPMN2Model_ServiceTask = Class(name="BPMN2Model_ServiceTask")
BPMN2Model_Signal = Class(name="BPMN2Model_Signal")
BPMN2Model_SignalEventDefinition = Class(name="BPMN2Model_SignalEventDefinition")
BPMN2Model_StandardLoopCharacteristics = Class(name="BPMN2Model_StandardLoopCharacteristics")
BPMN2Model_EObject = Class(name="BPMN2Model_EObject")
BPMN2Model_SubChoreography = Class(name="BPMN2Model_SubChoreography")
BPMN2Model_SubConversation = Class(name="BPMN2Model_SubConversation")
BPMN2Model_SubProcess = Class(name="BPMN2Model_SubProcess")
BPMN2Model_Task = Class(name="BPMN2Model_Task")
BPMN2Model_TerminateEventDefinition = Class(name="BPMN2Model_TerminateEventDefinition")
BPMN2Model_TextAnnotation = Class(name="BPMN2Model_TextAnnotation")
BPMN2Model_StartEvent = Class(name="BPMN2Model_StartEvent")
BPMN2Model_TimerEventDefinition = Class(name="BPMN2Model_TimerEventDefinition")
BPMN2Model_Transaction = Class(name="BPMN2Model_Transaction")
BPMN2Model_UserTask = Class(name="BPMN2Model_UserTask")
FlowNode = Class(name="FlowNode")
BPMN2Model_ThrowEvent = Class(name="BPMN2Model_ThrowEvent", is_abstract=True)
SubProcess = Class(name="SubProcess")
BaseElement = Class(name="BaseElement")
Artifact = Class(name="Artifact")
BPMN2Model_ExtensionDefinition = Class(name="BPMN2Model_ExtensionDefinition")
...
BPMN2Model_InteractionNode = Class(name="BPMN2Model_InteractionNode")
InteractionNode = Class(name="InteractionNode")
BPMN2Model_ItemAwareElement = Class(name="BPMN2Model_ItemAwareElement")
...
BPMN2Model_ExtensionAttributeDefinition = Class(name="BPMN2Model_ExtensionAttributeDefinition")
BPMN2Model_FlowElementsContainer = Class(name="BPMN2Model_FlowElementsContainer", is_abstract=True)
...
BPMN2Model_BPMNBase = Class(name="BPMN2Model_BPMNBase", is_abstract=True)
...
BPMN2Model_Activity.attributes={BPMN2Model_Activity_startQuantity, BPMN2Model_Activity_isForCompensation, BPMN2Model_Activity_completionQuantity}
...
BPMN2Model_AdHocSubProcess.attributes={BPMN2Model_AdHocSubProcess_cancelRemainingInstances, BPMN2Model_AdHocSubProcess_ordering}
...
BPMN2Model_Definitions.attributes={BPMN2Model_Definitions_exporter, BPMN2Model_Definitions_targetNamespace, BPMN2Model_Definitions_expressionLanguage, BPMN2Model_Definitions_name, BPMN2Model_Definitions_exporterVersion, BPMN2Model_Definitions_typeLanguage}
...
BPMN2Model_Documentation.attributes={BPMN2Model_Documentation_text, BPMN2Model_Documentation_mixed, BPMN2Model_Documentation_textFormat}
...
BPMN2Model_Error.attributes={BPMN2Model_Error_name, BPMN2Model_Error_errorCode}
...
BPMN2Model_EventBasedGateway.attributes={BPMN2Model_EventBasedGateway_eventGatewayType, BPMN2Model_EventBasedGateway_instantiate}
...
BPMN2Model_Extension.attributes={BPMN2Model_Extension_xsdDefinition, BPMN2Model_Extension_mustUnderstand}
...
BPMN2Model_FormalExpression.attributes={BPMN2Model_FormalExpression_body, BPMN2Model_FormalExpression_language, BPMN2Model_FormalExpression_mixed}
...
BPMN2Model_ItemDefinition.attributes={BPMN2Model_ItemDefinition_itemKind, BPMN2Model_ItemDefinition_isCollection}
...
BPMN2Model_Process.attributes={BPMN2Model_Process_isClosed, BPMN2Model_Process_processType, BPMN2Model_Process_isExecutable}
...
BPMN2Model_ParticipantMultiplicity.attributes={BPMN2Model_ParticipantMultiplicity_minimum, BPMN2Model_ParticipantMultiplicity_maximum}
...
BPMN2Model_ReceiveTask.attributes={BPMN2Model_ReceiveTask_implementation, BPMN2Model_ReceiveTask_instantiate}
...
BPMN2Model_ScriptTask.attributes={BPMN2Model_ScriptTask_scriptFormat, BPMN2Model_ScriptTask_script}
...
BPMN2Model_TextAnnotation.attributes={BPMN2Model_TextAnnotation_textFormat, BPMN2Model_TextAnnotation_text}
...
BPMN2Model_ExtensionAttributeDefinition.attributes={BPMN2Model_ExtensionAttributeDefinition_isReference, BPMN2Model_ExtensionAttributeDefinition_name, BPMN2Model_ExtensionAttributeDefinition_type}
...
from_301: BinaryAssociation = BinaryAssociation(
    name="from_301",
    ends={
...
import_624: BinaryAssociation = BinaryAssociation(
    name="import_624",
    ends={
...
domain_model = DomainModel(
    name="BPMN2Model",
    types={BPMN2Model_DocumentRoot, BPMNBase, BPMN2Model_EStringToStringMapEntry, BPMN2Model_Activity, BPMN2Model_Artifact, BPMN2Model_Assignment, BPMN2Model_Association, BPMN2Model_Auditing, BPMN2Model_BaseElement, BPMN2Model_BoundaryEvent, BPMN2Model_BusinessRuleTask, BPMN2Model_CallableElement, BPMN2Model_CallActivity, BPMN2Model_CallChoreography, BPMN2Model_CallConversation, BPMN2Model_ConversationNode, BPMN2Model_CancelEventDefinition, BPMN2Model_AdHocSubProcess, BPMN2Model_FlowElement, BPMN2Model_CatchEvent, BPMN2Model_Category, BPMN2Model_CategoryValue, BPMN2Model_Choreography, BPMN2Model_Collaboration, BPMN2Model_ChoreographyActivity, BPMN2Model_ChoreographyTask, BPMN2Model_CompensateEventDefinition, BPMN2Model_ComplexBehaviorDefinition, BPMN2Model_ComplexGateway, BPMN2Model_ConditionalEventDefinition, BPMN2Model_EventDefinition, BPMN2Model_RootElement, BPMN2Model_ConversationLink, BPMN2Model_CorrelationKey, BPMN2Model_CorrelationProperty, BPMN2Model_CorrelationPropertyBinding, BPMN2Model_CorrelationPropertyRetrievalExpression, BPMN2Model_CorrelationSubscription, BPMN2Model_DataAssociation, BPMN2Model_DataInput, BPMN2Model_DataInputAssociation, BPMN2Model_DataObject, BPMN2Model_DataObjectReference, BPMN2Model_DataOutput, BPMN2Model_Conversation, BPMN2Model_ConversationAssociation, BPMN2Model_DataState, BPMN2Model_DataStore, BPMN2Model_DataStoreReference, BPMN2Model_Definitions, BPMN2Model_Documentation, BPMN2Model_EndEvent, BPMN2Model_EndPoint, BPMN2Model_Error, BPMN2Model_ErrorEventDefinition, BPMN2Model_Escalation, BPMN2Model_EscalationEventDefinition, BPMN2Model_Event, BPMN2Model_EventBasedGateway, BPMN2Model_DataOutputAssociation, BPMN2Model_Expression, BPMN2Model_Extension, BPMN2Model_ExtensionAttributeValue, BPMN2Model_FlowNode, BPMN2Model_FormalExpression, BPMN2Model_Gateway, BPMN2Model_GlobalBusinessRuleTask, BPMN2Model_GlobalChoreographyTask, BPMN2Model_GlobalConversation, BPMN2Model_GlobalManualTask, BPMN2Model_ExclusiveGateway, BPMN2Model_GlobalUserTask, BPMN2Model_Group, BPMN2Model_HumanPerformer, BPMN2Model_Performer, BPMN2Model_ResourceRole, BPMN2Model_ImplicitThrowEvent, BPMN2Model_Import, BPMN2Model_InclusiveGateway, BPMN2Model_InputSet, BPMN2Model_Interface, BPMN2Model_GlobalScriptTask, BPMN2Model_GlobalTask, BPMN2Model_IntermediateThrowEvent, BPMN2Model_InputOutputBinding, BPMN2Model_InputOutputSpecification, BPMN2Model_ItemDefinition, BPMN2Model_Lane, BPMN2Model_LaneSet, BPMN2Model_LinkEventDefinition, BPMN2Model_LoopCharacteristics, BPMN2Model_ManualTask, BPMN2Model_Message, BPMN2Model_IntermediateCatchEvent, BPMN2Model_MessageFlow, BPMN2Model_MessageFlowAssociation, BPMN2Model_Monitoring, BPMN2Model_MultiInstanceLoopCharacteristics, BPMN2Model_Operation, BPMN2Model_OutputSet, BPMN2Model_ParallelGateway, BPMN2Model_Participant, BPMN2Model_ParticipantAssociation, BPMN2Model_MessageEventDefinition, BPMN2Model_PartnerEntity, BPMN2Model_PartnerRole, BPMN2Model_PotentialOwner, BPMN2Model_Process, BPMN2Model_Property, BPMN2Model_ParticipantMultiplicity, BPMN2Model_ReceiveTask, BPMN2Model_Relationship, BPMN2Model_Rendering, BPMN2Model_Resource, BPMN2Model_ResourceAssignmentExpression, BPMN2Model_ResourceParameter, BPMN2Model_ResourceParameterBinding, BPMN2Model_ScriptTask, BPMN2Model_SendTask, BPMN2Model_SequenceFlow, BPMN2Model_ServiceTask, BPMN2Model_Signal, BPMN2Model_SignalEventDefinition, BPMN2Model_StandardLoopCharacteristics, BPMN2Model_EObject, BPMN2Model_SubChoreography, BPMN2Model_SubConversation, BPMN2Model_SubProcess, BPMN2Model_Task, BPMN2Model_TerminateEventDefinition, BPMN2Model_TextAnnotation, BPMN2Model_StartEvent, BPMN2Model_TimerEventDefinition, BPMN2Model_Transaction, BPMN2Model_UserTask, FlowNode, BPMN2Model_ThrowEvent, SubProcess, BaseElement, Artifact, BPMN2Model_ExtensionDefinition, CatchEvent, Task, Activity, ChoreographyActivity, ConversationNode, RootElement, EventDefinition, Event, Collaboration, FlowElementsContainer, Gateway, BPMN2Model_InteractionNode, InteractionNode, BPMN2Model_ItemAwareElement, ItemAwareElement, DataAssociation, FlowElement, ThrowEvent, BPMN2Model_ExtensionAttributeDefinition, BPMN2Model_FlowElementsContainer, Expression, GlobalTask, Choreography, CallableElement, Performer, LoopCharacteristics, ResourceRole, HumanPerformer, BPMN2Model_BPMNBase, EObject, AdHocOrdering, AssociationDirection, ChoreographyLoopType, EventBasedGatewayType, GatewayDirection, ItemKind, MultiInstanceBehavior, ProcessType, RelationshipDirection},
    associations={xMLNSPrefixMap0, xSISchemaLocation1, activity4, flowElement8, artifact10, assignment12, association14, auditing16, baseElement18, baseElementWithMixedContent20, boundaryEvent23, businessRuleTask25, callableElement27, callActivity29, callChoreography31, callConversation33, conversationNode35, cancelEventDefinition37, adHocSubProcess6, rootElement41, catchEvent43, category45, categoryValue47, choreography49, collaboration51, choreographyActivity53, choreographyTask55, compensateEventDefinition57, complexBehaviorDefinition59, complexGateway61, conditionalEventDefinition63, eventDefinition39, conversationAssociation67, conversationLink69, correlationKey71, correlationProperty73, correlationPropertyBinding75, correlationPropertyRetrievalExpression77, correlationSubscription79, dataAssociation81, dataInput83, dataInputAssociation85, dataObject87, dataObjectReference89, conversation65, dataState95, dataStore97, dataStoreReference99, definitions101, documentation103, endEvent105, endPoint107, error109, errorEventDefinition111, escalation113, escalationEventDefinition115, event117, eventBasedGateway119, dataOutput91, dataOutputAssociation93, expression123, extension125, extensionElements127, flowNode129, formalExpression131, gateway133, globalBusinessRuleTask135, globalChoreographyTask137, globalConversation139, globalManualTask141, exclusiveGateway121, globalTask145, globalUserTask147, group149, humanPerformer151, performer153, resourceRole155, implicitThrowEvent157, import_159, inclusiveGateway161, inputSet163, globalScriptTask143, intermediateThrowEvent169, ioBinding171, ioSpecification173, itemDefinition175, lane177, laneSet179, linkEventDefinition181, loopCharacteristics183, manualTask185, message187, interface165, intermediateCatchEvent167, messageFlow191, messageFlowAssociation193, monitoring195, multiInstanceLoopCharacteristics197, operation199, outputSet201, parallelGateway203, participant205, participantAssociation207, messageEventDefinition189, participantMultiplicity209, partnerEntity211, partnerRole213, potentialOwner215, process217, property219, receiveTask221, relationship223, rendering225, resource227, resourceAssignmentExpression229, resourceParameter231, resourceParameterBinding233, script235, scriptTask237, sendTask239, sequenceFlow241, serviceTask243, signal245, signalEventDefinition247, standardLoopCharacteristics249, subChoreography253, subConversation255, subProcess257, task259, terminateEventDefinition261, text263, textAnnotation266, startEvent251, timerEventDefinition270, transaction272, userTask274, ioSpecification276, boundaryEventRefs279, properties280, dataInputAssociations283, dataOutputAssociations286, resources289, loopCharacteristics292, default295, throwEvent268, completionCondition298, from_301, to304, sourceRef307, targetRef310, extensionValues313, documentation316, extensionDefinitions319, calledElementRef322, participantAssociations325, calledChoreographyRef328, participantAssociations331, calledCollaborationRef334, supportedInterfaceRefs337, ioSpecification340, ioBinding343, dataOutputs346, dataOutputAssociation349, outputSet352, eventDefinitions355, attachedToRef321, categoryValue361, categorizedFlowElements364, participantRefs367, correlationKeys370, initiatingParticipantRef373, messageFlowRef376, participants379, eventDefinitionRefs358, conversations388, conversationAssociations391, participantAssociations394, messageFlowAssociations397, correlationKeys400, choreographyRef403, conversationLinks406, activityRef409, condition412, event415, activationCondition418, messageFlows382, artifacts385, condition424, innerConversationNodeRef427, outerConversationNodeRef430, sourceRef433, targetRef435, participantRefs438, messageFlowRefs441, correlationKeys444, correlationPropertyRef447, correlationPropertyRetrievalExpression450, type453, default421, correlationPropertyRef459, messagePath462, messageRef465, correlationPropertyBinding468, correlationKeyRef471, sourceRef474, targetRef476, transformation479, assignment482, dataPath456, inputSetWithOptional485, inputSetWithWhileExecuting486, inputSetRefs488, dataObjectRef490, outputSetWithOptional493, outputSetWithWhileExecuting494, outputSetRefs496, dataStoreRef498, imports501, extensions504, rootElements507, relationships510, structureRef513, errorRef516, structureRef519, properties525, default528, definition531, extensionDefinition534, valueRef535, extensionAttributeDefinition538, escalationRef522, auditing541, monitoring544, categoryValueRef547, laneSets550, flowElements552, incoming555, lanes556, outgoing557, evaluatesToTypeRef559, extensionAttributeDefinitions540, initiatingParticipantRef562, resources565, renderings568, categoryValueRef571, default574, inputDataRef577, operationRef580, outputDataRef583, dataInputs586, dataOutputs589, inputSets592, outputSets595, dataInputRefs598, optionalInputRefs599, whileExecutingInputRefs601, outputSetRefs603, incomingConversationLinks606, outgoingConversationLinks609, operations612, implementationRef615, dataState618, itemSubjectRef621, structureRef627, partitionElement630, flowNodeRefs633, childLaneSet634, partitionElementRef637, lanes640, source644, target646, itemRef648, import_624, messageRef654, messageRef657, sourceRef660, targetRef663, innerMessageFlowRef666, outerMessageFlowRef669, loopCardinality672, loopDataInputRef675, loopDataOutputRef678, inputDataItem681, operationRef651, complexBehaviorDefinition687, completionCondition690, noneBehaviorEventRef693, oneBehaviorEventRef696, inMessageRef699, outMessageRef702, errorRefs705, implementationRef708, dataOutputRefs711, optionalOutputRefs712, whileExecutingOutputRefs714, inputSetRefs716, outputDataItem684, interfaceRefs719, endPointRefs722, participantMultiplicity725, processRef728, innerParticipantRef731, outerParticipantRef734, participantRef737, participantRef740, properties749, artifacts752, resources755, correlationSubscriptions758, supports762, auditing743, monitoring746, messageRef767, operationRef770, sources773, targets776, resourceParameters779, expression782, definitionalCollaborationRef764, expression788, parameterRef791, resourceRef794, resourceParameterBindings797, resourceAssignmentExpression800, messageRef803, operationRef806, conditionExpression809, sourceRef812, targetRef814, type785, structureRef819, signalRef822, loopCondition825, loopMaximum828, artifacts831, conversationNodes834, artifacts837, operationRef816, inputSet846, eventDefinitions849, eventDefinitionRefs852, timeDate855, timeDuration858, timeCycle861, renderings864, dataInputs840, dataInputAssociation843},
    generalizations={gen_BPMN2Model_DocumentRoot_BPMNBase, gen_BPMN2Model_Activity_FlowNode, gen_BPMN2Model_AdHocSubProcess_SubProcess, gen_BPMN2Model_Artifact_BaseElement, gen_BPMN2Model_Assignment_BaseElement, gen_BPMN2Model_Association_Artifact, gen_BPMN2Model_Auditing_BaseElement, gen_BPMN2Model_BaseElement_BPMNBase, gen_BPMN2Model_BoundaryEvent_CatchEvent, gen_BPMN2Model_BusinessRuleTask_Task, gen_BPMN2Model_CallActivity_Activity, gen_BPMN2Model_CallChoreography_ChoreographyActivity, gen_BPMN2Model_CallConversation_ConversationNode, gen_BPMN2Model_CallableElement_RootElement, gen_BPMN2Model_CancelEventDefinition_EventDefinition, gen_BPMN2Model_CatchEvent_Event, gen_BPMN2Model_Category_RootElement, gen_BPMN2Model_CategoryValue_BaseElement, gen_BPMN2Model_Choreography_Collaboration, gen_BPMN2Model_Choreography_FlowElementsContainer, gen_BPMN2Model_ChoreographyActivity_FlowNode, gen_BPMN2Model_ChoreographyTask_ChoreographyActivity, gen_BPMN2Model_Collaboration_RootElement, gen_BPMN2Model_CompensateEventDefinition_EventDefinition, gen_BPMN2Model_ComplexBehaviorDefinition_BaseElement, gen_BPMN2Model_ComplexGateway_Gateway, gen_BPMN2Model_Conversation_ConversationNode, gen_BPMN2Model_ConversationAssociation_BaseElement, gen_BPMN2Model_ConversationLink_BaseElement, gen_BPMN2Model_ConversationNode_BaseElement, gen_BPMN2Model_ConversationNode_InteractionNode, gen_BPMN2Model_CorrelationKey_BaseElement, gen_BPMN2Model_CorrelationProperty_RootElement, gen_BPMN2Model_ConditionalEventDefinition_EventDefinition, gen_BPMN2Model_CorrelationPropertyRetrievalExpression_BaseElement, gen_BPMN2Model_CorrelationSubscription_BaseElement, gen_BPMN2Model_DataAssociation_BaseElement, gen_BPMN2Model_CorrelationPropertyBinding_BaseElement, gen_BPMN2Model_DataInput_ItemAwareElement, gen_BPMN2Model_DataInputAssociation_DataAssociation, gen_BPMN2Model_DataObject_FlowElement, gen_BPMN2Model_DataObject_ItemAwareElement, gen_BPMN2Model_DataObjectReference_FlowElement, gen_BPMN2Model_DataObjectReference_ItemAwareElement, gen_BPMN2Model_DataOutput_ItemAwareElement, gen_BPMN2Model_DataOutputAssociation_DataAssociation, gen_BPMN2Model_DataState_BaseElement, gen_BPMN2Model_DataStoreReference_FlowElement, gen_BPMN2Model_DataStoreReference_ItemAwareElement, gen_BPMN2Model_Definitions_BaseElement, gen_BPMN2Model_Documentation_BaseElement, gen_BPMN2Model_EndEvent_ThrowEvent, gen_BPMN2Model_EndPoint_RootElement, gen_BPMN2Model_Error_RootElement, gen_BPMN2Model_ErrorEventDefinition_EventDefinition, gen_BPMN2Model_Escalation_BPMNBase, gen_BPMN2Model_DataStore_ItemAwareElement, gen_BPMN2Model_DataStore_RootElement, gen_BPMN2Model_Event_FlowNode, gen_BPMN2Model_Event_InteractionNode, gen_BPMN2Model_EventBasedGateway_Gateway, gen_BPMN2Model_EventDefinition_RootElement, gen_BPMN2Model_ExclusiveGateway_Gateway, gen_BPMN2Model_Expression_BaseElement, gen_BPMN2Model_Extension_BPMNBase, gen_BPMN2Model_ExtensionAttributeDefinition_BPMNBase, gen_BPMN2Model_ExtensionAttributeValue_BPMNBase, gen_BPMN2Model_ExtensionDefinition_BPMNBase, gen_BPMN2Model_EscalationEventDefinition_EventDefinition, gen_BPMN2Model_FlowElement_BaseElement, gen_BPMN2Model_FlowElementsContainer_BaseElement, gen_BPMN2Model_FlowNode_FlowElement, gen_BPMN2Model_FormalExpression_Expression, gen_BPMN2Model_Gateway_FlowNode, gen_BPMN2Model_GlobalBusinessRuleTask_GlobalTask, gen_BPMN2Model_GlobalChoreographyTask_Choreography, gen_BPMN2Model_GlobalConversation_Collaboration, gen_BPMN2Model_GlobalManualTask_GlobalTask, gen_BPMN2Model_GlobalScriptTask_GlobalTask, gen_BPMN2Model_GlobalTask_CallableElement, gen_BPMN2Model_GlobalUserTask_GlobalTask, gen_BPMN2Model_Group_Artifact, gen_BPMN2Model_Import_BPMNBase, gen_BPMN2Model_InclusiveGateway_Gateway, gen_BPMN2Model_InputOutputBinding_BPMNBase, gen_BPMN2Model_InputOutputSpecification_BaseElement, gen_BPMN2Model_InputSet_BaseElement, gen_BPMN2Model_HumanPerformer_Performer, gen_BPMN2Model_ImplicitThrowEvent_ThrowEvent, gen_BPMN2Model_InteractionNode_BPMNBase, gen_BPMN2Model_Interface_RootElement, gen_BPMN2Model_IntermediateCatchEvent_CatchEvent, gen_BPMN2Model_IntermediateThrowEvent_ThrowEvent, gen_BPMN2Model_ItemAwareElement_BaseElement, gen_BPMN2Model_ItemDefinition_RootElement, gen_BPMN2Model_Lane_BaseElement, gen_BPMN2Model_LaneSet_BaseElement, gen_BPMN2Model_LinkEventDefinition_EventDefinition, gen_BPMN2Model_LoopCharacteristics_BaseElement, gen_BPMN2Model_ManualTask_Task, gen_BPMN2Model_Message_RootElement, gen_BPMN2Model_MessageFlow_BaseElement, gen_BPMN2Model_MessageFlowAssociation_BaseElement, gen_BPMN2Model_Monitoring_BaseElement, gen_BPMN2Model_MultiInstanceLoopCharacteristics_LoopCharacteristics, gen_BPMN2Model_MessageEventDefinition_EventDefinition, gen_BPMN2Model_Operation_BaseElement, gen_BPMN2Model_OutputSet_BaseElement, gen_BPMN2Model_Participant_BaseElement, gen_BPMN2Model_Participant_InteractionNode, gen_BPMN2Model_ParticipantAssociation_BaseElement, gen_BPMN2Model_ParticipantMultiplicity_BPMNBase, gen_BPMN2Model_PartnerEntity_RootElement, gen_BPMN2Model_PartnerRole_RootElement, gen_BPMN2Model_Performer_ResourceRole, gen_BPMN2Model_PotentialOwner_HumanPerformer, gen_BPMN2Model_Process_CallableElement, gen_BPMN2Model_Process_FlowElementsContainer, gen_BPMN2Model_ParallelGateway_Gateway, gen_BPMN2Model_Property_ItemAwareElement, gen_BPMN2Model_ReceiveTask_Task, gen_BPMN2Model_Relationship_BaseElement, gen_BPMN2Model_Rendering_BaseElement, gen_BPMN2Model_Resource_RootElement, gen_BPMN2Model_ResourceAssignmentExpression_BPMNBase, gen_BPMN2Model_ResourceParameter_BaseElement, gen_BPMN2Model_ResourceParameterBinding_BPMNBase, gen_BPMN2Model_ResourceRole_BaseElement, gen_BPMN2Model_RootElement_BaseElement, gen_BPMN2Model_ScriptTask_Task, gen_BPMN2Model_SendTask_Task, gen_BPMN2Model_SequenceFlow_FlowElement, gen_BPMN2Model_ServiceTask_Task, gen_BPMN2Model_Signal_RootElement, gen_BPMN2Model_SignalEventDefinition_EventDefinition, gen_BPMN2Model_StandardLoopCharacteristics_LoopCharacteristics, gen_BPMN2Model_StartEvent_CatchEvent, gen_BPMN2Model_SubChoreography_ChoreographyActivity, gen_BPMN2Model_SubChoreography_FlowElementsContainer, gen_BPMN2Model_SubConversation_ConversationNode, gen_BPMN2Model_SubProcess_Activity, gen_BPMN2Model_SubProcess_FlowElementsContainer, gen_BPMN2Model_Task_Activity, gen_BPMN2Model_Task_InteractionNode, gen_BPMN2Model_TerminateEventDefinition_EventDefinition, gen_BPMN2Model_TextAnnotation_Artifact, gen_BPMN2Model_ThrowEvent_Event, gen_BPMN2Model_TimerEventDefinition_EventDefinition, gen_BPMN2Model_Transaction_SubProcess, gen_BPMN2Model_UserTask_Task, gen_BPMN2Model_BPMNBase_EObject},
    metadata=None
)
