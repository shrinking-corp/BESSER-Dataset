...
def test_hyp_dot_strictidentifiable_is_not_abstract():
    assert not inspect.isabstract(dot_StrictIdentifiable)


def test_hyp_dot_strictidentifiable_constructor_exists():
    assert callable(dot_StrictIdentifiable.__init__)


def test_hyp_dot_strictidentifiable_constructor_args():
...
def test_hyp_dot_commentable_is_not_abstract():
    assert not inspect.isabstract(dot_Commentable)


def test_hyp_dot_commentable_constructor_exists():
    assert callable(dot_Commentable.__init__)


def test_hyp_dot_commentable_constructor_args():
...
def test_hyp_dot_attributable_is_not_abstract():
    assert not inspect.isabstract(dot_Attributable)


def test_hyp_dot_attributable_constructor_exists():
    assert callable(dot_Attributable.__init__)


def test_hyp_dot_attributable_constructor_args():
...
def test_hyp_dot_connectable_is_not_abstract():
    assert not inspect.isabstract(dot_Connectable)


def test_hyp_dot_connectable_constructor_exists():
    assert callable(dot_Connectable.__init__)


def test_hyp_dot_connectable_constructor_args():
...
def test_hyp_dot_attributelist_is_not_abstract():
    assert not inspect.isabstract(dot_AttributeList)


def test_hyp_dot_attributelist_constructor_exists():
    assert callable(dot_AttributeList.__init__)


def test_hyp_dot_attributelist_constructor_args():
...
def test_hyp_dot_target_is_not_abstract():
    assert not inspect.isabstract(dot_Target)


def test_hyp_dot_target_constructor_exists():
    assert callable(dot_Target.__init__)


def test_hyp_dot_target_constructor_args():
...
def test_hyp_dot_nodeid_is_not_abstract():
    assert not inspect.isabstract(dot_NodeID)


def test_hyp_dot_nodeid_constructor_exists():
    assert callable(dot_NodeID.__init__)


def test_hyp_dot_nodeid_constructor_args():
    sig = inspect.signature(dot_NodeID.__init__)
    params = list(sig.parameters.keys())



def test_hyp_dot_alist_is_not_abstract():
    assert not inspect.isabstract(dot_AList)


def test_hyp_dot_alist_constructor_exists():
    assert callable(dot_AList.__init__)


def test_hyp_dot_alist_constructor_args():
    sig = inspect.signature(dot_AList.__init__)
    params = list(sig.parameters.keys())



def test_hyp_dot_statementlist_is_not_abstract():
    assert not inspect.isabstract(dot_StatementList)


def test_hyp_dot_statementlist_constructor_exists():
    assert callable(dot_StatementList.__init__)


def test_hyp_dot_statementlist_constructor_args():
...
def test_hyp_dot_abstractgraph_is_not_abstract():
    assert not inspect.isabstract(dot_AbstractGraph)


def test_hyp_dot_abstractgraph_constructor_exists():
    assert callable(dot_AbstractGraph.__init__)


def test_hyp_dot_abstractgraph_constructor_args():
...
def test_hyp_dot_assignmentstatement_is_not_abstract():
    assert not inspect.isabstract(dot_AssignmentStatement)


def test_hyp_dot_assignmentstatement_constructor_exists():
    assert callable(dot_AssignmentStatement.__init__)


def test_hyp_dot_assignmentstatement_constructor_args():
...
def test_hyp_dot_strictidentifiable_id_setter(instance):
...
def test_hyp_dot_commentable_comments_setter(instance):
...
def test_hyp_dot_target_operation_setter(instance):
...
def test_hyp_dot_subgraph_type_setter(instance):
    original = instance.type
    instance.type = original
    assert instance.type == original
...
def test_hyp_dot_port_compass_setter(instance):
...
def test_hyp_dot_attributestatement_context_setter(instance):
...
def test_hyp_dot_assignmentstatement_left_setter(instance):
...
@given(instance=dot_AssignmentStatement_strategy)
def test_hyp_dot_assignmentstatement_right_setter(instance):
...
@given(instance=dot_Attribute_strategy)
def test_hyp_dot_attribute_key_setter(instance):
