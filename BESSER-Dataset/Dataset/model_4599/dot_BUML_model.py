...
# Classes
dot_Attribute = Class(name="dot_Attribute")
dot_AssignmentStatement = Class(name="dot_AssignmentStatement")
Statement = Class(name="Statement")
dot_AbstractGraph = Class(name="dot_AbstractGraph", is_abstract=True)
Identifiable = Class(name="Identifiable")
dot_StatementList = Class(name="dot_StatementList")
dot_AList = Class(name="dot_AList")
Commentable = Class(name="Commentable")
dot_Connectable = Class(name="dot_Connectable", is_abstract=True)
dot_EdgeStatement = Class(name="dot_EdgeStatement")
dot_Target = Class(name="dot_Target")
dot_Graph = Class(name="dot_Graph")
AbstractGraph = Class(name="AbstractGraph")
dot_Attributable = Class(name="dot_Attributable", is_abstract=True)
dot_AttributeList = Class(name="dot_AttributeList")
dot_AttributeStatement = Class(name="dot_AttributeStatement")
Attributable = Class(name="Attributable")
dot_Commentable = Class(name="dot_Commentable", is_abstract=True)
dot_Identifiable = Class(name="dot_Identifiable", is_abstract=True)
dot_NodeStatement = Class(name="dot_NodeStatement")
Attribute = Class(name="Attribute")
dot_NodeID = Class(name="dot_NodeID")
Connectable = Class(name="Connectable")
StrictIdentifiable = Class(name="StrictIdentifiable")
dot_Port = Class(name="dot_Port")
dot_Statement = Class(name="dot_Statement", is_abstract=True)
dot_StrictIdentifiable = Class(name="dot_StrictIdentifiable", is_abstract=True)
...
dot_AssignmentStatement.attributes={dot_AssignmentStatement_right, dot_AssignmentStatement_left}
...
domain_model = DomainModel(
    name="dot",
    types={dot_Attribute, dot_AssignmentStatement, Statement, dot_AbstractGraph, Identifiable, dot_StatementList, dot_AList, Commentable, dot_Connectable, dot_EdgeStatement, dot_Target, dot_Graph, AbstractGraph, dot_Attributable, dot_AttributeList, dot_AttributeStatement, Attributable, dot_Commentable, dot_Identifiable, dot_NodeStatement, Attribute, dot_NodeID, Connectable, StrictIdentifiable, dot_Port, dot_Statement, dot_StrictIdentifiable, dot_Subgraph, Compass},
    associations={attribute1, tail3, statements0, source12, target13, attributes5, list6, next10, next_target24, target26, node_id15, port16, statement18, tail21},
    generalizations={gen_dot_AssignmentStatement_Statement, gen_dot_AssignmentStatement_Commentable, gen_dot_AbstractGraph_Identifiable, gen_dot_AList_Commentable, gen_dot_EdgeStatement_Statement, gen_dot_EdgeStatement_Attributable, gen_dot_EdgeStatement_Commentable, gen_dot_Graph_AbstractGraph, gen_dot_Graph_Commentable, gen_dot_Attribute_Commentable, gen_dot_AttributeList_Commentable, gen_dot_AttributeStatement_Statement, gen_dot_AttributeStatement_Commentable, gen_dot_AttributeStatement_Attributable, gen_dot_Subgraph_Commentable, gen_dot_Target_Commentable, gen_dot_NodeStatement_Statement, gen_dot_NodeStatement_Attributable, gen_dot_NodeStatement_Attribute, gen_dot_NodeID_Connectable, gen_dot_NodeID_StrictIdentifiable, gen_dot_NodeID_Commentable, gen_dot_Port_Identifiable, gen_dot_Port_Commentable, gen_dot_StatementList_Commentable, gen_dot_Subgraph_AbstractGraph, gen_dot_Subgraph_Connectable},
    metadata=None
)
