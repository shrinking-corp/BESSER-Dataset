...
class rdbmsMM_Table:
    ...
    def __init__(self, name: str, table: "rdbmsMM_Schema" = None, owner: set["rdbmsMM_Column"] = None, owner6: "rdbmsMM_Key" = None, Table: "rdbmsMM_Schema" = None, Table30: "rdbmsMM_ForeignKey" = None, owner8: set["rdbmsMM_ForeignKey"] = None, Table11: "rdbmsMM_Column" = None, Table19: "rdbmsMM_Key" = None):
        self.name = name
        self.table = table
...
class rdbmsMM_Schema:
    ...
    def __init__(self, name: str, schema2: set["rdbmsMM_ForeignKey"] = None, Schema: "rdbmsMM_Table" = None, schema: set["rdbmsMM_Table"] = None, rdbmsMM_Schema: "rdbmsMM_dummy" = None, Schema26: "rdbmsMM_ForeignKey" = None):
        self.name = name
...
class rdbmsMM_Key:
    ...
    def __init__(self, name: str, Key: "rdbmsMM_Table" = None, Key14: "rdbmsMM_Column" = None, hasKey: "rdbmsMM_Table" = None, hasKey21: set["rdbmsMM_Column"] = None, refersTo: set["rdbmsMM_ForeignKey"] = None, Key28: "rdbmsMM_ForeignKey" = None):
        self.name = name
        self.Key = Key
        self.Key14 = Key14
        self.hasKey = hasKey
...
class rdbmsMM_Column:
    ...
    def __init__(self, name: str, type: str, Column: "rdbmsMM_Table" = None, Column33: "rdbmsMM_ForeignKey" = None, column: "rdbmsMM_Table" = None, column13: set["rdbmsMM_Key"] = None, column16: set["rdbmsMM_ForeignKey"] = None, Column22: "rdbmsMM_Key" = None):
        self.name = name
        self.type = type
        self.Column = Column
...
class rdbmsMM_ForeignKey:
    ...
    def __init__(self, name: str, ForeignKey: "rdbmsMM_Schema" = None, hasForeignKey: "rdbmsMM_Table" = None, hasForeignKey32: set["rdbmsMM_Column"] = None, ForeignKey9: "rdbmsMM_Table" = None, ForeignKey17: "rdbmsMM_Column" = None, ForeignKey24: "rdbmsMM_Key" = None, foreignKey: "rdbmsMM_Schema" = None, referredBy: "rdbmsMM_Key" = None):
        self.name = name
