...
statemachine_StateMachine_m_addState: Method = Method(name="addState", parameters={Parameter(name='statemachine_initial', type=StringType), Parameter(name='statemachine_terminal', type=StringType)}, type=StringType)
...
statemachine_StateMachine_m_deltaFrom: Method = Method(name="deltaFrom", parameters={Parameter(name='statemachine_from_', type=StringType), Parameter(name='statemachine_to', type=StringType)})
statemachine_StateMachine_m_deltaMinusOne: Method = Method(name="deltaMinusOne", parameters={Parameter(name='statemachine_label', type=StringType), Parameter(name='statemachine_state', type=StringType)})
...
statemachine_StateMachine_m_delta: Method = Method(name="delta", parameters={Parameter(name='statemachine_label', type=StringType), Parameter(name='statemachine_state', type=StringType)})
...
statemachine_StateMachine_m_steps: Method = Method(name="steps", parameters={Parameter(name='statemachine_word', type=StringType), Parameter(name='statemachine_s', type=StringType)})
...
statemachine_StateMachine_m_step: Method = Method(name="step", parameters={Parameter(name='statemachine_s', type=StringType), Parameter(name='statemachine_o', type=StringType)})
...
statemachine_StateMachine.methods={statemachine_StateMachine_m_addState, statemachine_StateMachine_m_accessibleStates, statemachine_StateMachine_m_accept, statemachine_StateMachine_m_steps, statemachine_StateMachine_m_delta, statemachine_StateMachine_m_coAccessibleStates, statemachine_StateMachine_m_deltaFrom, statemachine_StateMachine_m_initials, statemachine_StateMachine_m_step, statemachine_StateMachine_m_terminals, statemachine_StateMachine_m_accessibleStates, statemachine_StateMachine_m_alphabet, statemachine_StateMachine_m_delta, statemachine_StateMachine_m_accessibleStates, statemachine_StateMachine_m_deltaMinusOne, statemachine_StateMachine_m_addTransition, statemachine_StateMachine_m_deltaMinusOne, statemachine_StateMachine_m_accessibleAndCoAccessibleStates, statemachine_StateMachine_m_delta, statemachine_StateMachine_m_steps, statemachine_StateMachine_m_coAccessibleStates}
...
domain_model = DomainModel(
    name="statemachine",
    types={statemachine_StateMachine, statemachine_State, statemachine_Set, statemachine_Transition},
    associations={states0, start3, end6, delta1},
    generalizations={},
    metadata=None
)
