...
public class java__Model  {
    ...
    public java__Model(
        String name        ArrayList<java__UnresolvedItem> java__unresolveditems,        ArrayList<java__ClassFile> java__classfiles,        ArrayList<java__Archive> java__archives,        ArrayList<java__Package> java__packages,        ArrayList<java__Type> java__types,        ArrayList<java__CompilationUnit> java__compilationunits    ) {
        this.name = name;
