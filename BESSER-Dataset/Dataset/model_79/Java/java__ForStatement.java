...
public class java__ForStatement extends Statement {
    ...
    public java__ForStatement(
        ArrayList<java__Expression> java__expressions,        ArrayList<java__Expression> java__expressions    ) {
