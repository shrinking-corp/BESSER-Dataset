...
def test_assistantmvc_observable_has_question():
    assert hasattr(AssistantMVC_Observable, "question")
    descriptor = None
    for klass in AssistantMVC_Observable.__mro__:
...
@given(instance=AssistantMVC_Observable_strategy)
def test_assistantmvc_observable_question_setter(instance):
