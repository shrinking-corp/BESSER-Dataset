...
# Classes
Java5_ImportDeclaration = Class(name="Java5_ImportDeclaration")
Java5_PackageDeclaration = Class(name="Java5_PackageDeclaration")
Java5_NamedElementRef = Class(name="Java5_NamedElementRef")
Java5_Annotation = Class(name="Java5_Annotation")
Expression = Class(name="Expression")
Java5_AnnotationMemberValuePair = Class(name="Java5_AnnotationMemberValuePair")
NamedElement = Class(name="NamedElement")
Java5_Expression = Class(name="Java5_Expression", is_abstract=True)
Java5_AnnotationTypeDeclaration = Class(name="Java5_AnnotationTypeDeclaration")
AbstractTypeDeclaration = Class(name="AbstractTypeDeclaration")
Java5_AnnotationTypeMemberDeclaration = Class(name="Java5_AnnotationTypeMemberDeclaration")
Java5_AnonymousClassDeclaration = Class(name="Java5_AnonymousClassDeclaration")
ASTNode = Class(name="ASTNode")
Java5_AbstractTypeDeclaration = Class(name="Java5_AbstractTypeDeclaration", is_abstract=True)
BodyDeclaration = Class(name="BodyDeclaration")
Java5_ArrayType = Class(name="Java5_ArrayType")
OrphanType = Class(name="OrphanType")
Java5_BodyDeclaration = Class(name="Java5_BodyDeclaration", is_abstract=True)
Java5_AssertStatement = Class(name="Java5_AssertStatement")
Statement = Class(name="Statement")
Java5_Assignment = Class(name="Java5_Assignment")
Java5_ASTNode = Class(name="Java5_ASTNode", is_abstract=True)
Java5_Block = Class(name="Java5_Block")
Java5_Statement = Class(name="Java5_Statement", is_abstract=True)
Java5_Modifier = Class(name="Java5_Modifier")
Java5_ClassInstanceCreation = Class(name="Java5_ClassInstanceCreation")
Java5_BooleanLiteral = Class(name="Java5_BooleanLiteral")
Java5_ArrayAccess = Class(name="Java5_ArrayAccess")
Java5_ArrayCreation = Class(name="Java5_ArrayCreation")
Java5_ArrayInitializer = Class(name="Java5_ArrayInitializer")
Java5_ArrayLengthAccess = Class(name="Java5_ArrayLengthAccess")
Java5_CharacterLiteral = Class(name="Java5_CharacterLiteral")
Java5_ClassDeclaration = Class(name="Java5_ClassDeclaration")
TypeDeclaration = Class(name="TypeDeclaration")
Java5_CompilationUnit = Class(name="Java5_CompilationUnit")
Java5_ConditionalExpression = Class(name="Java5_ConditionalExpression")
Java5_BreakStatement = Class(name="Java5_BreakStatement")
Java5_CastExpression = Class(name="Java5_CastExpression")
Java5_CatchClause = Class(name="Java5_CatchClause")
Java5_SingleVariableDeclaration = Class(name="Java5_SingleVariableDeclaration")
Java5_ContinueStatement = Class(name="Java5_ContinueStatement")
Java5_DoStatement = Class(name="Java5_DoStatement")
Java5_EmptyStatement = Class(name="Java5_EmptyStatement")
Java5_EnumDeclaration = Class(name="Java5_EnumDeclaration")
Java5_EnumConstantDeclaration = Class(name="Java5_EnumConstantDeclaration")
Java5_EnhancedForStatement = Class(name="Java5_EnhancedForStatement")
Java5_ConstructorInvocation = Class(name="Java5_ConstructorInvocation")
Java5_FieldDeclaration = Class(name="Java5_FieldDeclaration")
Java5_VariableDeclarationFragment = Class(name="Java5_VariableDeclarationFragment")
Java5_ForStatement = Class(name="Java5_ForStatement")
Java5_IfStatement = Class(name="Java5_IfStatement")
Java5_InfixExpression = Class(name="Java5_InfixExpression")
Java5_ExpressionStatement = Class(name="Java5_ExpressionStatement")
Java5_FieldAccess = Class(name="Java5_FieldAccess")
Java5_Initializer = Class(name="Java5_Initializer")
Java5_InstanceofExpression = Class(name="Java5_InstanceofExpression")
Java5_InterfaceDeclaration = Class(name="Java5_InterfaceDeclaration")
Java5_LabeledStatement = Class(name="Java5_LabeledStatement")
Java5_TypeParameter = Class(name="Java5_TypeParameter")
Java5_MethodInvocation = Class(name="Java5_MethodInvocation")
Java5_MethodRef = Class(name="Java5_MethodRef")
Java5_MethodRefParameter = Class(name="Java5_MethodRefParameter")
Java5_Model = Class(name="Java5_Model")
Java5_MemberRef = Class(name="Java5_MemberRef")
Java5_MethodDeclaration = Class(name="Java5_MethodDeclaration")
Java5_VariableDeclarationStatement = Class(name="Java5_VariableDeclarationStatement")
Java5_VariableDeclarationExpression = Class(name="Java5_VariableDeclarationExpression")
Java5_NamedElement = Class(name="Java5_NamedElement", is_abstract=True)
Java5_NullLiteral = Class(name="Java5_NullLiteral")
Java5_NumberLiteral = Class(name="Java5_NumberLiteral")
Java5_ParameterizedType = Class(name="Java5_ParameterizedType")
Java5_OrphanType = Class(name="Java5_OrphanType")
Java5_UnresolvedItem = Class(name="Java5_UnresolvedItem")
Java5_PrefixExpression = Class(name="Java5_PrefixExpression")
Java5_PrimitiveType = Class(name="Java5_PrimitiveType")
Java5_PrimitiveTypeBoolean = Class(name="Java5_PrimitiveTypeBoolean")
PrimitiveType = Class(name="PrimitiveType")
Java5_PrimitiveTypeByte = Class(name="Java5_PrimitiveTypeByte")
Java5_PrimitiveTypeChar = Class(name="Java5_PrimitiveTypeChar")
Java5_PrimitiveTypeDouble = Class(name="Java5_PrimitiveTypeDouble")
Java5_PrimitiveTypeShort = Class(name="Java5_PrimitiveTypeShort")
Java5_PrimitiveTypeFloat = Class(name="Java5_PrimitiveTypeFloat")
Java5_PrimitiveTypeInt = Class(name="Java5_PrimitiveTypeInt")
Java5_PrimitiveTypeLong = Class(name="Java5_PrimitiveTypeLong")
Java5_PrimitiveTypeVoid = Class(name="Java5_PrimitiveTypeVoid")
Java5_ReturnStatement = Class(name="Java5_ReturnStatement")
VariableDeclaration = Class(name="VariableDeclaration")
Java5_ParenthesizedExpression = Class(name="Java5_ParenthesizedExpression")
Java5_PostfixExpression = Class(name="Java5_PostfixExpression")
Java5_SuperFieldAccess = Class(name="Java5_SuperFieldAccess")
Java5_SuperMethodInvocation = Class(name="Java5_SuperMethodInvocation")
Java5_SwitchCase = Class(name="Java5_SwitchCase")
Java5_SwitchStatement = Class(name="Java5_SwitchStatement")
Java5_SynchronizedStatement = Class(name="Java5_SynchronizedStatement")
Java5_StringLiteral = Class(name="Java5_StringLiteral")
Java5_SuperConstructorInvocation = Class(name="Java5_SuperConstructorInvocation")
Java5_ThrowStatement = Class(name="Java5_ThrowStatement")
Java5_TypeDeclaration = Class(name="Java5_TypeDeclaration", is_abstract=True)
Java5_TypeDeclarationStatement = Class(name="Java5_TypeDeclarationStatement")
Java5_TypeLiteral = Class(name="Java5_TypeLiteral")
Java5_TryStatement = Class(name="Java5_TryStatement")
Java5_TagElement = Class(name="Java5_TagElement")
Java5_TextElement = Class(name="Java5_TextElement")
Java5_ThisExpression = Class(name="Java5_ThisExpression")
Java5_WhileStatement = Class(name="Java5_WhileStatement")
Java5_VariableDeclaration = Class(name="Java5_VariableDeclaration", is_abstract=True)
Java5_WildCardType = Class(name="Java5_WildCardType")
...
Java5_ArrayType.attributes={Java5_ArrayType_dimensions, Java5_ArrayType_originalName}
...
Java5_Modifier.attributes={Java5_Modifier_visibility, Java5_Modifier_strictfp, Java5_Modifier_native, Java5_Modifier_inheritance, Java5_Modifier_transient, Java5_Modifier_synchronized, Java5_Modifier_volatile, Java5_Modifier_static}
...
Java5_CharacterLiteral.attributes={Java5_CharacterLiteral_escapedValue, Java5_CharacterLiteral_value}
...
Java5_MethodDeclaration.attributes={Java5_MethodDeclaration_constructor, Java5_MethodDeclaration_varargs, Java5_MethodDeclaration_extraArrayDimensions}
...
Java5_NamedElement.attributes={Java5_NamedElement_proxy, Java5_NamedElement_name}
...
finally_312: BinaryAssociation = BinaryAssociation(
    name="finally_312",
    ends={
...
domain_model = DomainModel(
    name="Java5",
    types={Java5_ImportDeclaration, Java5_PackageDeclaration, Java5_NamedElementRef, Java5_Annotation, Expression, Java5_AnnotationMemberValuePair, NamedElement, Java5_Expression, Java5_AnnotationTypeDeclaration, AbstractTypeDeclaration, Java5_AnnotationTypeMemberDeclaration, Java5_AnonymousClassDeclaration, ASTNode, Java5_AbstractTypeDeclaration, BodyDeclaration, Java5_ArrayType, OrphanType, Java5_BodyDeclaration, Java5_AssertStatement, Statement, Java5_Assignment, Java5_ASTNode, Java5_Block, Java5_Statement, Java5_Modifier, Java5_ClassInstanceCreation, Java5_BooleanLiteral, Java5_ArrayAccess, Java5_ArrayCreation, Java5_ArrayInitializer, Java5_ArrayLengthAccess, Java5_CharacterLiteral, Java5_ClassDeclaration, TypeDeclaration, Java5_CompilationUnit, Java5_ConditionalExpression, Java5_BreakStatement, Java5_CastExpression, Java5_CatchClause, Java5_SingleVariableDeclaration, Java5_ContinueStatement, Java5_DoStatement, Java5_EmptyStatement, Java5_EnumDeclaration, Java5_EnumConstantDeclaration, Java5_EnhancedForStatement, Java5_ConstructorInvocation, Java5_FieldDeclaration, Java5_VariableDeclarationFragment, Java5_ForStatement, Java5_IfStatement, Java5_InfixExpression, Java5_ExpressionStatement, Java5_FieldAccess, Java5_Initializer, Java5_InstanceofExpression, Java5_InterfaceDeclaration, Java5_LabeledStatement, Java5_TypeParameter, Java5_MethodInvocation, Java5_MethodRef, Java5_MethodRefParameter, Java5_Model, Java5_MemberRef, Java5_MethodDeclaration, Java5_VariableDeclarationStatement, Java5_VariableDeclarationExpression, Java5_NamedElement, Java5_NullLiteral, Java5_NumberLiteral, Java5_ParameterizedType, Java5_OrphanType, Java5_UnresolvedItem, Java5_PrefixExpression, Java5_PrimitiveType, Java5_PrimitiveTypeBoolean, PrimitiveType, Java5_PrimitiveTypeByte, Java5_PrimitiveTypeChar, Java5_PrimitiveTypeDouble, Java5_PrimitiveTypeShort, Java5_PrimitiveTypeFloat, Java5_PrimitiveTypeInt, Java5_PrimitiveTypeLong, Java5_PrimitiveTypeVoid, Java5_ReturnStatement, VariableDeclaration, Java5_ParenthesizedExpression, Java5_PostfixExpression, Java5_SuperFieldAccess, Java5_SuperMethodInvocation, Java5_SwitchCase, Java5_SwitchStatement, Java5_SynchronizedStatement, Java5_StringLiteral, Java5_SuperConstructorInvocation, Java5_ThrowStatement, Java5_TypeDeclaration, Java5_TypeDeclarationStatement, Java5_TypeLiteral, Java5_TryStatement, Java5_TagElement, Java5_TextElement, Java5_ThisExpression, Java5_WhileStatement, Java5_VariableDeclaration, Java5_WildCardType, InheritanceKind, VisibilityKind},
    associations={imports1, package2, superInterfaces3, type5, values7, member9, value12, default14, type16, array37, bodyDeclarations0, elementType39, message41, expression43, leftHandSide46, rightHandSide48, statements51, abstractTypeDeclaration52, annotations53, anonymousClassDeclarationOwner55, modifiers57, bodyDeclarations19, classInstanceCreation21, array22, index24, dimensions27, initializer29, type31, expressions34, superClass69, anonymousClassDeclaration71, arguments73, expression75, method78, type81, imports84, package86, types88, elseExpression91, expression93, label59, expression61, type63, exception66, body67, method101, label104, expression106, body108, enumConstants111, anonymousClassDeclaration112, arguments114, body117, thenExpression96, arguments99, field126, expression128, type131, fragments133, expression134, updaters136, initializers139, body142, expression145, thenStatement147, elseStatement150, importedElement153, rightOperand156, expression119, parameter122, expression124, body164, rightOperand166, leftOperand168, leftOperand158, extendedOperands161, typeParameters186, redefinedMethodDeclaration189, redefinitions191, parameters193, method195, arguments197, expression200, method203, qualifier205, parameters208, type210, body171, ownedElements213, member173, qualifier175, body178, thrownExceptions180, returnType183, BodyDeclaration222, SingleVariableDeclaration224, VariableDeclarationStatement227, VariableDeclarationExpression229, qualifier232, element234, ownedElements236, ownedPackages239, type241, orphanTypes215, unresolvedItems217, compilationUnits219, operand250, expression252, modifiers254, type257, typeArguments243, expression246, method268, operand248, field271, qualifier273, arguments276, method278, qualifier281, expression284, expression286, statements288, methodDeclaration259, body291, catchClause261, enhancedForStatement262, expression263, arguments265, expression299, typeParameters301, declaration303, type305, bounds307, body310, finally_312, expression293, fragments296, fieldDeclaration327, qualifier297, variableDeclarationStatement328, variableDeclarationExpression331, type334, fragments336, modifiers338, expression341, catchClauses315, initializer318, type320, fragments322, modifiers324, body343, bound346},
    generalizations={gen_Java5_Annotation_Expression, gen_Java5_AnnotationMemberValuePair_NamedElement, gen_Java5_AnnotationTypeDeclaration_AbstractTypeDeclaration, gen_Java5_AnnotationTypeMemberDeclaration_BodyDeclaration, gen_Java5_AnonymousClassDeclaration_ASTNode, gen_Java5_AbstractTypeDeclaration_BodyDeclaration, gen_Java5_ArrayType_OrphanType, gen_Java5_AssertStatement_Statement, gen_Java5_Assignment_Expression, gen_Java5_Block_Statement, gen_Java5_BodyDeclaration_NamedElement, gen_Java5_BooleanLiteral_Expression, gen_Java5_ArrayAccess_Expression, gen_Java5_ArrayCreation_Expression, gen_Java5_ArrayInitializer_Expression, gen_Java5_ArrayLengthAccess_Expression, gen_Java5_CharacterLiteral_Expression, gen_Java5_ClassDeclaration_TypeDeclaration, gen_Java5_ClassInstanceCreation_Expression, gen_Java5_CompilationUnit_NamedElement, gen_Java5_ConditionalExpression_Expression, gen_Java5_BreakStatement_Statement, gen_Java5_CastExpression_Expression, gen_Java5_CatchClause_Statement, gen_Java5_ContinueStatement_Statement, gen_Java5_DoStatement_Statement, gen_Java5_EmptyStatement_Statement, gen_Java5_EnumDeclaration_AbstractTypeDeclaration, gen_Java5_EnumConstantDeclaration_BodyDeclaration, gen_Java5_EnhancedForStatement_Statement, gen_Java5_ConstructorInvocation_Statement, gen_Java5_FieldDeclaration_BodyDeclaration, gen_Java5_ForStatement_Statement, gen_Java5_IfStatement_Statement, gen_Java5_ImportDeclaration_ASTNode, gen_Java5_InfixExpression_Expression, gen_Java5_Expression_ASTNode, gen_Java5_ExpressionStatement_Statement, gen_Java5_FieldAccess_Expression, gen_Java5_Initializer_BodyDeclaration, gen_Java5_InstanceofExpression_Expression, gen_Java5_InterfaceDeclaration_TypeDeclaration, gen_Java5_LabeledStatement_NamedElement, gen_Java5_LabeledStatement_Statement, gen_Java5_MethodInvocation_Expression, gen_Java5_MethodRef_ASTNode, gen_Java5_MethodRefParameter_ASTNode, gen_Java5_MemberRef_ASTNode, gen_Java5_MethodDeclaration_BodyDeclaration, gen_Java5_NamedElement_ASTNode, gen_Java5_NamedElementRef_Expression, gen_Java5_NullLiteral_Expression, gen_Java5_NumberLiteral_Expression, gen_Java5_OrphanType_NamedElement, gen_Java5_PackageDeclaration_NamedElement, gen_Java5_ParameterizedType_OrphanType, gen_Java5_Modifier_ASTNode, gen_Java5_PrefixExpression_Expression, gen_Java5_PrimitiveType_OrphanType, gen_Java5_PrimitiveTypeBoolean_PrimitiveType, gen_Java5_PrimitiveTypeByte_PrimitiveType, gen_Java5_PrimitiveTypeChar_PrimitiveType, gen_Java5_PrimitiveTypeDouble_PrimitiveType, gen_Java5_PrimitiveTypeShort_PrimitiveType, gen_Java5_PrimitiveTypeFloat_PrimitiveType, gen_Java5_PrimitiveTypeInt_PrimitiveType, gen_Java5_PrimitiveTypeLong_PrimitiveType, gen_Java5_PrimitiveTypeVoid_PrimitiveType, gen_Java5_ReturnStatement_Statement, gen_Java5_SingleVariableDeclaration_VariableDeclaration, gen_Java5_ParenthesizedExpression_Expression, gen_Java5_PostfixExpression_Expression, gen_Java5_SuperFieldAccess_Expression, gen_Java5_SuperMethodInvocation_Expression, gen_Java5_SwitchCase_Statement, gen_Java5_SwitchStatement_Statement, gen_Java5_SynchronizedStatement_Statement, gen_Java5_Statement_ASTNode, gen_Java5_StringLiteral_Expression, gen_Java5_SuperConstructorInvocation_Statement, gen_Java5_ThrowStatement_Statement, gen_Java5_TypeDeclaration_AbstractTypeDeclaration, gen_Java5_TypeDeclarationStatement_Statement, gen_Java5_TypeLiteral_Expression, gen_Java5_TypeParameter_NamedElement, gen_Java5_TryStatement_Statement, gen_Java5_TagElement_ASTNode, gen_Java5_TextElement_ASTNode, gen_Java5_VariableDeclarationFragment_VariableDeclaration, gen_Java5_ThisExpression_Expression, gen_Java5_VariableDeclarationStatement_Statement, gen_Java5_WhileStatement_Statement, gen_Java5_UnresolvedItem_NamedElement, gen_Java5_VariableDeclaration_NamedElement, gen_Java5_VariableDeclarationExpression_Expression, gen_Java5_WildCardType_OrphanType},
    metadata=None
)
