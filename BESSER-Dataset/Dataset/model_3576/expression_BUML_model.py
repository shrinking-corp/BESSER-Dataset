...
# Classes
expression_Expression = Class(name="expression_Expression", is_abstract=True)
expression_EObject = Class(name="expression_EObject")
expression_Literal = Class(name="expression_Literal", is_abstract=True)
...
expression_PredicateComparisonOperator = Class(name="expression_PredicateComparisonOperator")
expression_TimeLiteral = Class(name="expression_TimeLiteral")
expression_Variable = Class(name="expression_Variable", is_abstract=True)
expression_Predicate = Class(name="expression_Predicate", is_abstract=True)
expression_PredicateInOperator = Class(name="expression_PredicateInOperator")
expression_PredicateBooleanOperator = Class(name="expression_PredicateBooleanOperator")
Predicate = Class(name="Predicate")
expression_PredicateIsOperator = Class(name="expression_PredicateIsOperator")
expression_PredicateEqualityOperator = Class(name="expression_PredicateEqualityOperator")
expression_PredicateLikeOperator = Class(name="expression_PredicateLikeOperator")
expression_PredicateIsEmpty = Class(name="expression_PredicateIsEmpty")
expression_PredicateIsNull = Class(name="expression_PredicateIsNull")
...
domain_model = DomainModel(
    name="expression",
    types={expression_Expression, expression_EObject, expression_Literal, Expression, expression_NullLiteral, Literal, expression_BooleanLiteral, expression_IntegerLiteral, expression_StringLiteral, expression_PredicateComparisonOperator, expression_TimeLiteral, expression_Variable, expression_Predicate, expression_PredicateInOperator, expression_PredicateBooleanOperator, Predicate, expression_PredicateIsOperator, expression_PredicateEqualityOperator, expression_PredicateLikeOperator, expression_PredicateIsEmpty, expression_PredicateIsNull, ComparisionOperator, BooleanOperator},
    associations={rootContainer0, right4, left7, right9, left12, expressions1, right14, left17, left2, right19, left22, right24, feature27, feature28},
    generalizations={gen_expression_Literal_Expression, gen_expression_NullLiteral_Literal, gen_expression_BooleanLiteral_Literal, gen_expression_IntegerLiteral_Literal, gen_expression_StringLiteral_Literal, gen_expression_PredicateComparisonOperator_Predicate, gen_expression_TimeLiteral_Literal, gen_expression_Variable_Expression, gen_expression_Predicate_Expression, gen_expression_PredicateInOperator_Predicate, gen_expression_PredicateBooleanOperator_Predicate, gen_expression_PredicateIsOperator_Predicate, gen_expression_PredicateEqualityOperator_Predicate, gen_expression_PredicateLikeOperator_Predicate, gen_expression_PredicateIsEmpty_Predicate, gen_expression_PredicateIsNull_Predicate},
    metadata=None
)
