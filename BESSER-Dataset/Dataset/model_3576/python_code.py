...
class expression_Expression(ABC):
    ...
    def __init__(self, suffixes: str, expression_Expression26: "expression_PredicateLikeOperator" = None, expression_Expression: "expression_EObject" = None, expression_Expression6: "expression_PredicateEqualityOperator" = None, expression_Expression8: "expression_PredicateComparisonOperator" = None, expression_Expression11: "expression_PredicateComparisonOperator" = None, expression_Expression13: "expression_PredicateInOperator" = None, expression_Expression16: "expression_PredicateInOperator" = None, expression_Expression18: "expression_PredicateIsOperator" = None, expression_Expression3: "expression_PredicateEqualityOperator" = None, expression_Expression21: "expression_PredicateIsOperator" = None, expression_Expression23: "expression_PredicateLikeOperator" = None):
