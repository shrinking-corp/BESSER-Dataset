...
# Classes
dSLPolicies_StopCondition = Class(name="dSLPolicies_StopCondition")
dSLPolicies_GraphElement = Class(name="dSLPolicies_GraphElement")
dSLPolicies_Model = Class(name="dSLPolicies_Model")
dSLPolicies_GraphPolicies = Class(name="dSLPolicies_GraphPolicies")
dSLPolicies_Policies = Class(name="dSLPolicies_Policies")
dSLPolicies_Severity = Class(name="dSLPolicies_Severity")
dSLPolicies_PathGeneratorStopCondition = Class(name="dSLPolicies_PathGeneratorStopCondition")
dSLPolicies_AlgorithmType = Class(name="dSLPolicies_AlgorithmType")
...
dSLPolicies_StopCondition.attributes={dSLPolicies_StopCondition_value, dSLPolicies_StopCondition_pathtype, dSLPolicies_StopCondition_percentage}
...
domain_model = DomainModel(
    name="dSLPolicies",
    types={dSLPolicies_StopCondition, dSLPolicies_GraphElement, dSLPolicies_Model, dSLPolicies_GraphPolicies, dSLPolicies_Policies, dSLPolicies_Severity, dSLPolicies_PathGeneratorStopCondition, dSLPolicies_AlgorithmType},
    associations={stopCondition9, stopConditionype11, graphelement14, graphPolicies0, policies1, pathgenerator3, severity5, algorithmType7},
    generalizations={},
    metadata=None
)
