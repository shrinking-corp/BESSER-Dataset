...
class dSLPolicies_StopCondition:
    ...
    def __init__(self, pathtype: str, value: int, percentage: str, dSLPolicies_StopCondition: "dSLPolicies_PathGeneratorStopCondition" = None, dSLPolicies_StopCondition13: "dSLPolicies_PathGeneratorStopCondition" = None, dSLPolicies_StopCondition15: "dSLPolicies_GraphElement" = None):
