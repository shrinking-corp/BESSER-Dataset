...
# Classes
emapvselistentry_NewEClass5 = Class(name="emapvselistentry_NewEClass5")
emapvselistentry_NewEClass1 = Class(name="emapvselistentry_NewEClass1")
emapvselistentry_NewEClass2 = Class(name="emapvselistentry_NewEClass2")
emapvselistentry_NewEClass3 = Class(name="emapvselistentry_NewEClass3")
emapvselistentry_NewEClass4 = Class(name="emapvselistentry_NewEClass4")
...
domain_model = DomainModel(
    ...
    types={emapvselistentry_NewEClass5, emapvselistentry_NewEClass1, emapvselistentry_NewEClass2, emapvselistentry_NewEClass3, emapvselistentry_NewEClass4},
    associations={neweclass55, neweclass20, neweclass31, neweclass43},
    generalizations={},
    metadata=None
)
