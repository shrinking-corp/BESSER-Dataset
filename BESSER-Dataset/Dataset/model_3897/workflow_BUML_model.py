...
# Classes
workflow_Recipe = Class(name="workflow_Recipe")
workflow_Statement = Class(name="workflow_Statement", is_abstract=True)
workflow_Parameter = Class(name="workflow_Parameter", is_abstract=True)
workflow_Condition = Class(name="workflow_Condition")
Statement = Class(name="Statement")
workflow_Program = Class(name="workflow_Program")
workflow_SimpleCommand = Class(name="workflow_SimpleCommand")
workflow_InputParameter = Class(name="workflow_InputParameter")
Parameter_ = Class(name="Parameter")
workflow_OutputParameter = Class(name="workflow_OutputParameter")
workflow_ForEach = Class(name="workflow_ForEach")
...
workflow_Program.attributes={workflow_Program_exec_order, workflow_Program_name_exec, workflow_Program_description}
...
workflow_ForEach.attributes={workflow_ForEach_sequence, workflow_ForEach_element}
...
domain_model = DomainModel(
    name="workflow",
    types={workflow_Recipe, workflow_Statement, workflow_Parameter, workflow_Condition, Statement, workflow_Program, workflow_SimpleCommand, workflow_InputParameter, Parameter_, workflow_OutputParameter, workflow_ForEach, workflow_Workflow},
    associations={recipes0, commands1, then_branch3, else_branch5, parameters8, programs9, link_to_outputparameter11, link_to_inputparameter12, statements15},
    generalizations={gen_workflow_Condition_Statement, gen_workflow_SimpleCommand_Statement, gen_workflow_InputParameter_Parameter, gen_workflow_OutputParameter_Parameter, gen_workflow_ForEach_Statement},
    metadata=None
)
