...
class morel_BooleanImpliesExpChild(Expression):
    ...
    pass
class morel_LetExp(Expression, ImperativeExp):
...
class ObjectVariable:
    ...
    pass
class morel_ObjectVariableWithInit(VariableWithInit, ObjectVariable):
...
class morel_Unit(ABC):
    ...
    def __init__(self, morel_Unit41: set["morel_EDataType"] = None, morel_Unit: set["morel_TypedModel"] = None):
    ...
    def getTypedModel(self, morel_name) :
...
class Executable:
    ...
    pass
class morel_RuleElement(Executable, NamedElement):
...
class morel_EPackage:
    ...
    pass
class morel_Query(Pattern, Executable, NamedElement):
