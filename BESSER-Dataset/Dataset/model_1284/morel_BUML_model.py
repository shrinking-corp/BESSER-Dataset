...
# Classes
morel_NamedElement = Class(name="morel_NamedElement", is_abstract=True)
morel_Section = Class(name="morel_Section", is_abstract=True)
morel_Pattern = Class(name="morel_Pattern")
Section = Class(name="Section")
morel_ObjectVariable = Class(name="morel_ObjectVariable")
morel_LinkConstraint = Class(name="morel_LinkConstraint", is_abstract=True)
morel_SimpleLinkConstraint = Class(name="morel_SimpleLinkConstraint")
LinkConstraint = Class(name="LinkConstraint")
morel_Expression = Class(name="morel_Expression", is_abstract=True)
morel_EReference = Class(name="morel_EReference")
morel_EnclosureLinkConstraint = Class(name="morel_EnclosureLinkConstraint")
morel_PathConstraint = Class(name="morel_PathConstraint")
morel_Statement = Class(name="morel_Statement", is_abstract=True)
morel_AdditionalConstraint = Class(name="morel_AdditionalConstraint", is_abstract=True)
morel_Clause = Class(name="morel_Clause")
morel_Variable = Class(name="morel_Variable", is_abstract=True)
NamedElement = Class(name="NamedElement")
Variable = Class(name="Variable")
morel_EClass = Class(name="morel_EClass")
morel_TypedModel = Class(name="morel_TypedModel")
morel_PrimitiveVariable = Class(name="morel_PrimitiveVariable")
morel_EDataType = Class(name="morel_EDataType")
morel_AtomicExp = Class(name="morel_AtomicExp", is_abstract=True)
UnaryExpChild = Class(name="UnaryExpChild")
morel_CallPathExp = Class(name="morel_CallPathExp", is_abstract=True)
morel_LiteralExp = Class(name="morel_LiteralExp", is_abstract=True)
AtomicExp = Class(name="AtomicExp")
morel_StringLiteralExp = Class(name="morel_StringLiteralExp")
LiteralExp = Class(name="LiteralExp")
morel_IntegerLiteralExp = Class(name="morel_IntegerLiteralExp")
morel_RealLiteralExp = Class(name="morel_RealLiteralExp")
morel_BooleanLiteralExp = Class(name="morel_BooleanLiteralExp")
morel_UndefinedLiteralExp = Class(name="morel_UndefinedLiteralExp")
morel_CollectionLiteralExp = Class(name="morel_CollectionLiteralExp")
morel_QueryModel = Class(name="morel_QueryModel")
Unit = Class(name="Unit")
morel_Query = Class(name="morel_Query")
morel_EPackage = Class(name="morel_EPackage")
Pattern = Class(name="Pattern")
Executable = Class(name="Executable")
morel_Unit = Class(name="morel_Unit", is_abstract=True)
morel_NestedExp = Class(name="morel_NestedExp")
morel_FeaturePathExp = Class(name="morel_FeaturePathExp")
CallPathExp = Class(name="CallPathExp")
morel_OperationPathExp = Class(name="morel_OperationPathExp")
morel_EnumLiteralExp = Class(name="morel_EnumLiteralExp")
morel_EEnum = Class(name="morel_EEnum")
morel_EEnumLiteral = Class(name="morel_EEnumLiteral")
morel_TypeLiteralExp = Class(name="morel_TypeLiteralExp")
morel_EClassifier = Class(name="morel_EClassifier")
morel_VariableExp = Class(name="morel_VariableExp")
morel_PredefinedVariableExp = Class(name="morel_PredefinedVariableExp")
morel_ObjectVariableWithInit = Class(name="morel_ObjectVariableWithInit")
ObjectVariable = Class(name="ObjectVariable")
VariableWithInit = Class(name="VariableWithInit")
morel_PrimitiveVariableWithInit = Class(name="morel_PrimitiveVariableWithInit")
PrimitiveVariable = Class(name="PrimitiveVariable")
morel_ConditionExp = Class(name="morel_ConditionExp")
morel_BooleanImpliesExp = Class(name="morel_BooleanImpliesExp")
morel_LoopPathExp = Class(name="morel_LoopPathExp", is_abstract=True)
morel_IteratorPathExp = Class(name="morel_IteratorPathExp")
LoopPathExp = Class(name="LoopPathExp")
morel_LetExp = Class(name="morel_LetExp")
Expression = Class(name="Expression")
ImperativeExp = Class(name="ImperativeExp")
morel_VariableWithInit = Class(name="morel_VariableWithInit", is_abstract=True)
morel_AdditiveExp = Class(name="morel_AdditiveExp")
RelationalExpChild = Class(name="RelationalExpChild")
morel_AdditiveExpChild = Class(name="morel_AdditiveExpChild", is_abstract=True)
morel_MultiplicativeExp = Class(name="morel_MultiplicativeExp")
AdditiveExpChild = Class(name="AdditiveExpChild")
morel_MultiplicativeExpChild = Class(name="morel_MultiplicativeExpChild", is_abstract=True)
morel_BooleanImpliesExpChild = Class(name="morel_BooleanImpliesExpChild", is_abstract=True)
morel_UnaryExp = Class(name="morel_UnaryExp")
MultiplicativeExpChild = Class(name="MultiplicativeExpChild")
morel_BooleanOrExp = Class(name="morel_BooleanOrExp")
BooleanImpliesExpChild = Class(name="BooleanImpliesExpChild")
morel_BooleanOrExpChild = Class(name="morel_BooleanOrExpChild", is_abstract=True)
morel_BooleanAndExp = Class(name="morel_BooleanAndExp")
BooleanOrExpChild = Class(name="BooleanOrExpChild")
morel_BooleanAndExpChild = Class(name="morel_BooleanAndExpChild", is_abstract=True)
morel_RelationalExp = Class(name="morel_RelationalExp")
BooleanAndExpChild = Class(name="BooleanAndExpChild")
morel_RelationalExpChild = Class(name="morel_RelationalExpChild", is_abstract=True)
morel_IfStatement = Class(name="morel_IfStatement")
ImperativeStatement = Class(name="ImperativeStatement")
morel_ImperativeStatement = Class(name="morel_ImperativeStatement", is_abstract=True)
morel_ForStatement = Class(name="morel_ForStatement")
morel_BlockStatement = Class(name="morel_BlockStatement")
morel_UnaryExpChild = Class(name="morel_UnaryExpChild", is_abstract=True)
morel_CollectionType = Class(name="morel_CollectionType", is_abstract=True)
EDataType = Class(name="EDataType")
morel_OrderedSetType = Class(name="morel_OrderedSetType")
CollectionType = Class(name="CollectionType")
morel_SequenceType = Class(name="morel_SequenceType")
morel_SetType = Class(name="morel_SetType")
morel_BagType = Class(name="morel_BagType")
morel_ImperativeExp = Class(name="morel_ImperativeExp", is_abstract=True)
morel_BindExp = Class(name="morel_BindExp")
morel_PredefinedBindExp = Class(name="morel_PredefinedBindExp")
morel_DeclarativeStatement = Class(name="morel_DeclarativeStatement")
Statement = Class(name="Statement")
morel_TransformationModel = Class(name="morel_TransformationModel")
morel_RuleElement = Class(name="morel_RuleElement", is_abstract=True)
morel_Rule = Class(name="morel_Rule")
RuleElement = Class(name="RuleElement")
morel_RuleGroup = Class(name="morel_RuleGroup")
morel_MultiValueConstraint = Class(name="morel_MultiValueConstraint")
PrimitiveConstraint = Class(name="PrimitiveConstraint")
morel_EAttribute = Class(name="morel_EAttribute")
morel_ValueRangeConstraint = Class(name="morel_ValueRangeConstraint")
morel_ReflectiveVariableExp = Class(name="morel_ReflectiveVariableExp")
morel_ArrayLiteralExp = Class(name="morel_ArrayLiteralExp")
morel_Executable = Class(name="morel_Executable", is_abstract=True)
morel_OrderConstraint = Class(name="morel_OrderConstraint")
AdditionalConstraint = Class(name="AdditionalConstraint")
morel_AllDifferentConstraint = Class(name="morel_AllDifferentConstraint")
morel_PrimitiveConstraint = Class(name="morel_PrimitiveConstraint", is_abstract=True)
...
morel_Unit_m_getTypedModel: Method = Method(name="getTypedModel", parameters={Parameter(name='morel_name', type=StringType)}, type=StringType)
...
morel_OperationPathExp.attributes={morel_OperationPathExp_separator, morel_OperationPathExp_operation}
...
morel_RuleGroup.attributes={morel_RuleGroup_order, morel_RuleGroup_scopeSize, morel_RuleGroup_maxIteration, morel_RuleGroup_scope, morel_RuleGroup_repetition, morel_RuleGroup_iteration}
...
morel_Executable.attributes={morel_Executable_active, morel_Executable_parameters}
...
domain_model = DomainModel(
    name="morel",
    types={morel_NamedElement, morel_Section, morel_Pattern, Section, morel_ObjectVariable, morel_LinkConstraint, morel_SimpleLinkConstraint, LinkConstraint, morel_Expression, morel_EReference, morel_EnclosureLinkConstraint, morel_PathConstraint, morel_Statement, morel_AdditionalConstraint, morel_Clause, morel_Variable, NamedElement, Variable, morel_EClass, morel_TypedModel, morel_PrimitiveVariable, morel_EDataType, morel_AtomicExp, UnaryExpChild, morel_CallPathExp, morel_LiteralExp, AtomicExp, morel_StringLiteralExp, LiteralExp, morel_IntegerLiteralExp, morel_RealLiteralExp, morel_BooleanLiteralExp, morel_UndefinedLiteralExp, morel_CollectionLiteralExp, morel_QueryModel, Unit, morel_Query, morel_EPackage, Pattern, Executable, morel_Unit, morel_NestedExp, morel_FeaturePathExp, CallPathExp, morel_OperationPathExp, morel_EnumLiteralExp, morel_EEnum, morel_EEnumLiteral, morel_TypeLiteralExp, morel_EClassifier, morel_VariableExp, morel_PredefinedVariableExp, morel_ObjectVariableWithInit, ObjectVariable, VariableWithInit, morel_PrimitiveVariableWithInit, PrimitiveVariable, morel_ConditionExp, morel_BooleanImpliesExp, morel_LoopPathExp, morel_IteratorPathExp, LoopPathExp, morel_LetExp, Expression, ImperativeExp, morel_VariableWithInit, morel_AdditiveExp, RelationalExpChild, morel_AdditiveExpChild, morel_MultiplicativeExp, AdditiveExpChild, morel_MultiplicativeExpChild, morel_BooleanImpliesExpChild, morel_UnaryExp, MultiplicativeExpChild, morel_BooleanOrExp, BooleanImpliesExpChild, morel_BooleanOrExpChild, morel_BooleanAndExp, BooleanOrExpChild, morel_BooleanAndExpChild, morel_RelationalExp, BooleanAndExpChild, morel_RelationalExpChild, morel_IfStatement, ImperativeStatement, morel_ImperativeStatement, morel_ForStatement, morel_BlockStatement, morel_UnaryExpChild, morel_CollectionType, EDataType, morel_OrderedSetType, CollectionType, morel_SequenceType, morel_SetType, morel_BagType, morel_ImperativeExp, morel_BindExp, morel_PredefinedBindExp, morel_DeclarativeStatement, Statement, morel_TransformationModel, morel_RuleElement, morel_Rule, RuleElement, morel_RuleGroup, morel_MultiValueConstraint, PrimitiveConstraint, morel_EAttribute, morel_ValueRangeConstraint, morel_ReflectiveVariableExp, morel_ArrayLiteralExp, morel_Executable, morel_OrderConstraint, AdditionalConstraint, morel_AllDifferentConstraint, morel_PrimitiveConstraint, SectionType, TypedModelAction, PredefinedVariable, UndefinedLiteral, OperationSeparator, IteratorType, RelationalOperator, AdditiveOperator, MultiplicativeOperator, BooleanOperator, UnaryOperator, OrderType, IterationType, RepetitionType, ScopeType},
    associations={variables0, linkConstraints1, id20, reference21, forward23, types25, pathVariable28, references29, types32, statements3, additionalConstraints5, statements7, type9, model11, type13, source14, target17, dataTypes40, path43, literals44, queries35, package36, models38, expression52, next55, enumType46, enumSymbol47, value49, referredVariable50, inExp68, initExp71, condition74, thenBranch75, elseBranch78, parameters57, firstVar59, secondVar61, bodyExp64, variables67, children92, children93, left81, right83, children86, children87, left88, right89, source102, valueExp103, condition106, thenStatement108, elseStatement110, iterator113, terminationExp115, stepExp118, bodyStatement121, statements124, child94, elementType95, source97, valueExp99, expression131, rules126, patterns127, rules129, object152, attribute154, expression156, variable133, elements135, primitiveVariables137, variables139, base142, references144, types147, variable150},
    generalizations={gen_morel_Pattern_Section, gen_morel_SimpleLinkConstraint_LinkConstraint, gen_morel_EnclosureLinkConstraint_LinkConstraint, gen_morel_PathConstraint_LinkConstraint, gen_morel_Clause_Section, gen_morel_Variable_NamedElement, gen_morel_ObjectVariable_Variable, gen_morel_PrimitiveVariable_Variable, gen_morel_AtomicExp_UnaryExpChild, gen_morel_LiteralExp_AtomicExp, gen_morel_StringLiteralExp_LiteralExp, gen_morel_IntegerLiteralExp_LiteralExp, gen_morel_RealLiteralExp_LiteralExp, gen_morel_BooleanLiteralExp_LiteralExp, gen_morel_UndefinedLiteralExp_LiteralExp, gen_morel_CollectionLiteralExp_LiteralExp, gen_morel_QueryModel_Unit, gen_morel_TypedModel_NamedElement, gen_morel_Query_Pattern, gen_morel_Query_NamedElement, gen_morel_Query_Executable, gen_morel_NestedExp_AtomicExp, gen_morel_FeaturePathExp_CallPathExp, gen_morel_OperationPathExp_CallPathExp, gen_morel_EnumLiteralExp_LiteralExp, gen_morel_TypeLiteralExp_LiteralExp, gen_morel_VariableExp_AtomicExp, gen_morel_PredefinedVariableExp_AtomicExp, gen_morel_VariableWithInit_Variable, gen_morel_ObjectVariableWithInit_ObjectVariable, gen_morel_ObjectVariableWithInit_VariableWithInit, gen_morel_PrimitiveVariableWithInit_PrimitiveVariable, gen_morel_PrimitiveVariableWithInit_VariableWithInit, gen_morel_ConditionExp_Expression, gen_morel_BooleanImpliesExp_Expression, gen_morel_LoopPathExp_CallPathExp, gen_morel_IteratorPathExp_LoopPathExp, gen_morel_LetExp_Expression, gen_morel_LetExp_ImperativeExp, gen_morel_RelationalExpChild_BooleanAndExpChild, gen_morel_AdditiveExp_RelationalExpChild, gen_morel_AdditiveExpChild_RelationalExpChild, gen_morel_MultiplicativeExp_AdditiveExpChild, gen_morel_MultiplicativeExpChild_AdditiveExpChild, gen_morel_UnaryExp_MultiplicativeExpChild, gen_morel_BooleanImpliesExpChild_Expression, gen_morel_BooleanOrExp_BooleanImpliesExpChild, gen_morel_BooleanOrExpChild_BooleanImpliesExpChild, gen_morel_BooleanAndExp_BooleanOrExpChild, gen_morel_BooleanAndExpChild_BooleanOrExpChild, gen_morel_RelationalExp_BooleanAndExpChild, gen_morel_IfStatement_ImperativeStatement, gen_morel_ForStatement_ImperativeStatement, gen_morel_BlockStatement_ImperativeStatement, gen_morel_UnaryExpChild_MultiplicativeExpChild, gen_morel_CollectionType_EDataType, gen_morel_OrderedSetType_CollectionType, gen_morel_SequenceType_CollectionType, gen_morel_SetType_CollectionType, gen_morel_BagType_CollectionType, gen_morel_ImperativeExp_Expression, gen_morel_BindExp_ImperativeExp, gen_morel_PredefinedBindExp_ImperativeExp, gen_morel_DeclarativeStatement_Statement, gen_morel_ImperativeStatement_Statement, gen_morel_TransformationModel_Unit, gen_morel_TransformationModel_NamedElement, gen_morel_RuleElement_NamedElement, gen_morel_RuleElement_Executable, gen_morel_Rule_RuleElement, gen_morel_RuleGroup_RuleElement, gen_morel_MultiValueConstraint_PrimitiveConstraint, gen_morel_ValueRangeConstraint_PrimitiveConstraint, gen_morel_ReflectiveVariableExp_Expression, gen_morel_ArrayLiteralExp_LiteralExp, gen_morel_OrderConstraint_AdditionalConstraint, gen_morel_AllDifferentConstraint_AdditionalConstraint},
    metadata=None
)
