...
# Relationships
Class_Class4: BinaryAssociation = BinaryAssociation(
    name="Class_Class4",
    ends={
...
A_Class3: BinaryAssociation = BinaryAssociation(
    name="A_Class3",
    ends={
...
domain_model = DomainModel(
    name="_6Wg6QDcwEeiQp6eXyhUzBA",
    types={R, Z, B, A, Y, C, C2, C3},
    associations={Class_Class4, A_Class3, B_C},
    generalizations={},
    metadata=None
)
