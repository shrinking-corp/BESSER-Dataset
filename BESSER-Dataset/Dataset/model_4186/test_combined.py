...
def test_assoc_ref2_link_reassign_clear():
    ...
    _safe_set(a, 'myDsl_Greeting1', b1)
    assert _is_linked(a, 'myDsl_Greeting1', b1)
    if hasattr(b1, 'myDsl_Greeting3'):
        assert _is_linked(b1, 'myDsl_Greeting3', a)
    _safe_set(a, 'myDsl_Greeting1', b2)
    assert _is_linked(a, 'myDsl_Greeting1', b2)
    if hasattr(b1, 'myDsl_Greeting3'):
        assert not _is_linked(b1, 'myDsl_Greeting3', a)
    if hasattr(b2, 'myDsl_Greeting3'):
        assert _is_linked(b2, 'myDsl_Greeting3', a)
    _safe_set(a, 'myDsl_Greeting1', None)
    assert not _is_linked(a, 'myDsl_Greeting1', b2)
    if hasattr(b2, 'myDsl_Greeting3'):
        assert not _is_linked(b2, 'myDsl_Greeting3', a)
