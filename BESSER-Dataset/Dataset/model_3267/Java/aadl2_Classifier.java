...
public class aadl2_Classifier extends Namespace, Type {
    ...
    public aadl2_Classifier(
        String noProperties,        String noPrototypes,        String noAnnexes    ) {
        super(
        );
    ...
    public aadl2_Classifier(
        String noProperties,        String noPrototypes,        String noAnnexes        ArrayList<aadl2_NamedElement> aadl2_namedelements,        ArrayList<aadl2_ClassifierFeature> aadl2_classifierfeatures,        ArrayList<aadl2_Classifier> aadl2_classifiers,        ArrayList<aadl2_PrototypeBinding> aadl2_prototypebindings    ) {
        this.noProperties = noProperties;
        this.noPrototypes = noPrototypes;
        this.noAnnexes = noAnnexes;
