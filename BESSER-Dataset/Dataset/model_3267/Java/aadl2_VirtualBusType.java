...
public class aadl2_VirtualBusType extends VirtualBusClassifier, ComponentType {
    ...
    public aadl2_VirtualBusType(
        ArrayList<aadl2_BusAccess> aadl2_busaccesss,        ArrayList<aadl2_DataPort> aadl2_dataports,        ArrayList<aadl2_EventPort> aadl2_eventports,        ArrayList<aadl2_EventDataPort> aadl2_eventdataports    ) {
