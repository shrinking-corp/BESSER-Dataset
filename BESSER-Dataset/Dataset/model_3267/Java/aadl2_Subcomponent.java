...
public class aadl2_Subcomponent extends ModalElement, StructuralFeature, Context, FlowElement, ArrayableElement {
    ...
    public aadl2_Subcomponent(
        String allModes        ArrayList<aadl2_PrototypeBinding> aadl2_prototypebindings,        ArrayList<aadl2_ModeBinding> aadl2_modebindings,        ArrayList<aadl2_ComponentImplementationReference> aadl2_componentimplementationreferences    ) {
        this.allModes = allModes;
