...
public class aadl2_DeviceImplementation extends ComponentImplementation, DeviceClassifier {
    ...
    public aadl2_DeviceImplementation(
        ArrayList<aadl2_BusSubcomponent> aadl2_bussubcomponents,        ArrayList<aadl2_DataSubcomponent> aadl2_datasubcomponents,        ArrayList<aadl2_VirtualBusSubcomponent> aadl2_virtualbussubcomponents    ) {
