...
public class aadl2_ComponentType extends ComponentClassifier {
    ...
    public aadl2_ComponentType(
        String noFeatures        ArrayList<aadl2_FeatureGroup> aadl2_featuregroups,        ArrayList<aadl2_FlowSpecification> aadl2_flowspecifications,        ArrayList<aadl2_AbstractFeature> aadl2_abstractfeatures,        ArrayList<aadl2_Feature> aadl2_features    ) {
        this.noFeatures = noFeatures;
