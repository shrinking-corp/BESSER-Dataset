...
public class aadl2_BusType extends BusClassifier, ComponentType {
    ...
    public aadl2_BusType(
        ArrayList<aadl2_EventDataPort> aadl2_eventdataports,        ArrayList<aadl2_BusAccess> aadl2_busaccesss,        ArrayList<aadl2_EventPort> aadl2_eventports,        ArrayList<aadl2_DataPort> aadl2_dataports    ) {
