...
public class aadl2_MemoryType extends ComponentType, MemoryClassifier {
    ...
    public aadl2_MemoryType(
        ArrayList<aadl2_EventPort> aadl2_eventports,        ArrayList<aadl2_BusAccess> aadl2_busaccesss,        ArrayList<aadl2_EventDataPort> aadl2_eventdataports,        ArrayList<aadl2_DataPort> aadl2_dataports    ) {
