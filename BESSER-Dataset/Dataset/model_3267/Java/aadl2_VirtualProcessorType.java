...
public class aadl2_VirtualProcessorType extends ComponentType, VirtualProcessorClassifier {
    ...
    public aadl2_VirtualProcessorType(
        ArrayList<aadl2_EventDataPort> aadl2_eventdataports,        ArrayList<aadl2_DataPort> aadl2_dataports,        ArrayList<aadl2_BusAccess> aadl2_busaccesss,        ArrayList<aadl2_SubprogramGroupAccess> aadl2_subprogramgroupaccesss,        ArrayList<aadl2_SubprogramAccess> aadl2_subprogramaccesss,        ArrayList<aadl2_EventPort> aadl2_eventports    ) {
