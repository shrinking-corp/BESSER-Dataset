...
class aadl2_ComponentClassifier(FeatureClassifier, SubcomponentType, Classifier):
    ...
    def __init__(self, derivedModes: str, noFlows: str, noModes: str, aadl2_ComponentClassifier142: set["aadl2_ModeTransition"] = None, aadl2_ComponentClassifier: set["aadl2_Mode"] = None, aadl2_ComponentClassifier265: "aadl2_FeaturePrototype" = None, aadl2_ComponentClassifier180: "aadl2_ComponentPrototype" = None, aadl2_ComponentClassifier287: "aadl2_Subcomponent" = None, aadl2_ComponentClassifier403: "aadl2_AccessSpecification" = None, aadl2_ComponentClassifier408: "aadl2_PortSpecification" = None):
...
class aadl2_ComponentImplementation(ComponentClassifier):
    ...
    def __init__(self, noSubcomponents: str, noConnections: str, noCalls: str, aadl2_ComponentImplementation132: set["aadl2_EventSource"] = None, aadl2_ComponentImplementation134: set["aadl2_EventDataSource"] = None, aadl2_ComponentImplementation136: set["aadl2_PortProxy"] = None, aadl2_ComponentImplementation138: set["aadl2_SubprogramProxy"] = None, aadl2_ComponentImplementation108: set["aadl2_Connection"] = None, aadl2_ComponentImplementation110: "aadl2_ImplementationExtension" = None, aadl2_ComponentImplementation: "aadl2_ComponentImplementationReference" = None, aadl2_ComponentImplementation99: "aadl2_ComponentType" = None, aadl2_ComponentImplementation101: set["aadl2_Subcomponent"] = None, aadl2_ComponentImplementation104: "aadl2_ComponentImplementation" = None, aadl2_ComponentImplementation102: "aadl2_ComponentImplementation" = None, aadl2_ComponentImplementation106: set["aadl2_FlowImplementation"] = None, aadl2_ComponentImplementation124: set["aadl2_FeatureConnection"] = None, aadl2_ComponentImplementation126: set["aadl2_FeatureGroupConnection"] = None, aadl2_ComponentImplementation112: "aadl2_Realization" = None, aadl2_ComponentImplementation114: set["aadl2_EndToEndFlow"] = None, aadl2_ComponentImplementation116: set["aadl2_AbstractSubcomponent"] = None, aadl2_ComponentImplementation118: set["aadl2_AccessConnection"] = None, aadl2_ComponentImplementation120: set["aadl2_ParameterConnection"] = None, aadl2_ComponentImplementation122: set["aadl2_PortConnection"] = None, aadl2_ComponentImplementation128: set["aadl2_ProcessorFeature"] = None, aadl2_ComponentImplementation130: set["aadl2_InternalFeature"] = None, aadl2_ComponentImplementation328: "aadl2_ImplementationExtension" = None):
...
class aadl2_Mode(ModeFeature):
    ...
    def __init__(self, initial: str, derived: str, aadl2_Mode: "aadl2_ModalElement" = None, aadl2_Mode145: "aadl2_ModeTransition" = None, aadl2_Mode148: "aadl2_ModeTransition" = None, aadl2_Mode140: "aadl2_ComponentClassifier" = None, aadl2_Mode290: "aadl2_ModeBinding" = None, aadl2_Mode293: "aadl2_ModeBinding" = None):
...
class VirtualProcessorSubcomponentType:
    ...
    pass
class aadl2_VirtualProcessorClassifier(VirtualProcessor, VirtualProcessorSubcomponentType, ComponentClassifier):

    pass
class aadl2_VirtualProcessorPrototype(VirtualProcessor, VirtualProcessorSubcomponentType, ComponentPrototype):
...
class ThreadSubcomponentType:
    ...
    pass
class aadl2_ThreadPrototype(Thread, ThreadSubcomponentType, ComponentPrototype):
...
class aadl2_MemoryClassifier(MemorySubcomponentType, ComponentClassifier, Memory):
    ...
    pass
class aadl2_MemoryPrototype(MemorySubcomponentType, ComponentPrototype, Memory):
...
class aadl2_PackageSection(Namespace):
    ...
    def __init__(self, noAnnexes: str, noProperties: str, aadl2_PackageSection362: set["aadl2_FeatureGroupTypeRename"] = None, aadl2_PackageSection364: set["aadl2_AnnexLibrary"] = None, aadl2_PackageSection367: set["aadl2_ModelUnit"] = None, aadl2_PackageSection: set["aadl2_PackageRename"] = None, aadl2_PackageSection357: set["aadl2_ComponentTypeRename"] = None, aadl2_PackageSection359: set["aadl2_Classifier"] = None):
...
class Data:
    ...
    pass
class aadl2_DataPrototype(DataSubcomponentType, ComponentPrototype, Data):

    pass
class aadl2_DataClassifier(DataSubcomponentType, ComponentClassifier, Data):
...
class Abstract:
    ...
    pass
class aadl2_AbstractPrototype(MemorySubcomponentType, SubprogramSubcomponentType, ThreadGroupSubcomponentType, DataSubcomponentType, AbstractSubcomponentType, VirtualProcessorSubcomponentType, Abstract, BusSubcomponentType, ProcessorSubcomponentType, SystemSubcomponentType, ThreadSubcomponentType, ProcessSubcomponentType, SubprogramGroupSubcomponentType, VirtualBusSubcomponentType, ComponentPrototype, DeviceSubcomponentType):

    pass
class aadl2_AbstractClassifier(MemorySubcomponentType, SubprogramSubcomponentType, ThreadGroupSubcomponentType, DataSubcomponentType, AbstractSubcomponentType, VirtualProcessorSubcomponentType, BusSubcomponentType, Abstract, ProcessorSubcomponentType, SystemSubcomponentType, ThreadSubcomponentType, ProcessSubcomponentType, ComponentClassifier, SubprogramGroupSubcomponentType, VirtualBusSubcomponentType, DeviceSubcomponentType):
...
class AccessConnectionEnd:
    ...
    pass
class aadl2_DataSubcomponent(Subcomponent, PortConnectionEnd, Data, ParameterConnectionEnd, AccessConnectionEnd):
...
class aadl2_SubprogramGroupAccess(CallContext, Access):
    ...
    pass
class aadl2_SubprogramGroupSubcomponent(Subcomponent, CallContext, SubprogramGroup, AccessConnectionEnd):

    pass
class aadl2_SubprogramType(SubprogramClassifier, CallContext, ComponentType):
...
class FlowElement:
    ...
    pass
class aadl2_DataAccess(FlowElement, PortConnectionEnd, Access, ParameterConnectionEnd):
...
class aadl2_Subcomponent(ModalElement, StructuralFeature, Context, FlowElement, ArrayableElement):
...
class FeatureConnectionEnd:
    ...
    pass
class aadl2_PortProxy(ProcessorFeature, TriggerPort, PortConnectionEnd, FeatureConnectionEnd):
...
class aadl2_Feature(ArrayableElement, StructuralFeature, FeatureConnectionEnd):
    ...
    pass
class aadl2_InternalFeature(TriggerPort, PortConnectionEnd, StructuralFeature, FeatureConnectionEnd):
...
class aadl2_AbstractFeature(TriggerPort, DirectedFeature):
    ...
    pass
class aadl2_FeatureGroup(CallContext, Context, DirectedFeature, FeatureGroupConnectionEnd):
...
class aadl2_TypeExtension(Generalization_):
    ...
    pass
class aadl2_FlowSpecification(FlowFeature, FlowElement, ModalPath):
...
class aadl2_Classifier(Namespace, Type):
    ...
    def __init__(self, noAnnexes: str, noProperties: str, noPrototypes: str, Classifier: "aadl2_ClassifierFeature" = None, aadl2_Classifier51: "aadl2_Generalization_" = None, Classifier53: "aadl2_Generalization_" = None, aadl2_Classifier66: "aadl2_RefinableElement" = None, aadl2_Classifier: "aadl2_PropertyAssociation" = None, aadl2_Classifier19: "aadl2_Property" = None, featuringClassifier: set["aadl2_ClassifierFeature"] = None, aadl2_Classifier32: set["aadl2_NamedElement"] = None, specific: set["aadl2_Generalization_"] = None, aadl2_Classifier37: "aadl2_Classifier" = None, aadl2_Classifier35: set["aadl2_Classifier"] = None, aadl2_Classifier39: set["aadl2_AnnexSubclause"] = None, aadl2_Classifier41: set["aadl2_Prototype"] = None, aadl2_Classifier43: set["aadl2_PrototypeBinding"] = None, aadl2_Classifier177: "aadl2_Feature" = None, aadl2_Classifier360: "aadl2_PackageSection" = None, aadl2_Classifier826: "aadl2_ClassifierValue" = None):
        self.noAnnexes = noAnnexes
        self.noProperties = noProperties
...
class aadl2_NamedElement(Element):
    ...
    def __init__(self, name: str, qualifiedName: str, aadl2_NamedElement48: "aadl2_Namespace" = None, aadl2_NamedElement82: "aadl2_ContainmentPathElement" = None, aadl2_NamedElement: set["aadl2_PropertyAssociation"] = None, aadl2_NamedElement45: "aadl2_Namespace" = None, aadl2_NamedElement33: "aadl2_Classifier" = None):
        self.name = name
...
class aadl2_Element(ABC):
    ...
    def __init__(self, aadl2_Element55: "aadl2_DirectedRelationship" = None, aadl2_Element58: "aadl2_DirectedRelationship" = None, aadl2_Element: "aadl2_Element" = None, aadl2_Element0: set["aadl2_Element"] = None, aadl2_Element3: set["aadl2_Comment"] = None, aadl2_Element60: "aadl2_Relationship" = None):
...
class aadl2_PackageRename(NamedElement):
    ...
    def __init__(self, renameAll: str, aadl2_PackageRename369: "aadl2_AadlPackage" = None, aadl2_PackageRename: "aadl2_PackageSection" = None):
