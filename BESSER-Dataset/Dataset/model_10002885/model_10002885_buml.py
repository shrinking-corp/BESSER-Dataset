...
Customer.attributes={Customer_type, Customer_royalty}
...
Payment.attributes={Payment_ID, Payment_amount__, Payment_discountamount, Payment_Imtiaz, Payment_list, Payment_finalamount, Payment_quantity, Payment_totalamount}
...
Product.attributes={Product_price, Product_type, Product_ID, Product_Name, Product_qty, Product_attribute, Product_amount, Product_blgl}
...
Inventory.attributes={Inventory_list, Inventory_SuperMarket}
...
domain_model = DomainModel(
    name="e65305c2_a92b_4c68_91cf_b2cbf57a3c77",
    types={Customer, Payment, Product, Inventory},
    associations={Customer_Payment, Inventory_Product, Product_Customer, Product_Payment},
    generalizations={},
    metadata=None
)
