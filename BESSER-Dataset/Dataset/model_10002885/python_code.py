...
class Inventory:
    ...
    def __init__(self, SuperMarket: str, list: str, product2: set["Product"] = None):
...
class Payment:
    ...
    def __init__(self, Imtiaz: str, quantity: int, ID: int, list: str, totalamount: str, finalamount: str, discountamount: str, amount__: str, customer1: "Customer" = None, product7: "Product" = None):
        self.Imtiaz = Imtiaz
