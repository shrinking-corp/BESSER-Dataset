...
class fsm_State(NamedElement):
    ...
    def __init__(self, fsm_State: "fsm_StateMachine" = None, fsm_State6: "fsm_StateMachine" = None, ownedStates: "fsm_StateMachine" = None, source: set["fsm_Transition"] = None, target: set["fsm_Transition"] = None, State12: "fsm_Transition" = None, State14: "fsm_Transition" = None, State: "fsm_StateMachine" = None):
...
class fsm_StateMachine(NamedElement):
    ...
    def __init__(self, unprocessedString: str, consummedString: str, producedString: str, fsm_StateMachine: "fsm_State" = None, fsm_StateMachine3: set["fsm_Transition"] = None, fsm_StateMachine5: "fsm_State" = None, StateMachine: "fsm_State" = None, owningFSM: set["fsm_State"] = None):
