...
domain_model = DomainModel(
    name="fsm",
    types={fsm_StateMachine, NamedElement, fsm_Transition, fsm_State, fsm_NamedElement},
    associations={initialState1, ownedTransitions2, currentState4, owningFSM7, outgoingTransitions8, incomingTransitions9, source11, target13, ownedStates0},
