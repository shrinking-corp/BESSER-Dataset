...
class Account:
    ...
    def __init__(self, billingAddress: str, open: date, closed: date, isClosed: bool, order4: set["Order"] = None, customer11: "Customer" = None, cart16: "ShoppinCart" = None, payment0: set["Payment"] = None):
...
class Payment:
    ...
    def __init__(self, paidDate: date, total: float, details: str, order2: "Order" = None, account1: "Account" = None):
