...
entities_AttributeType.attributes={entities_AttributeType_lenght, entities_AttributeType_array}
...
domain_model = DomainModel(
    name="entities",
    types={entities_AttributeType, entities_ElementType, entities_BasicType, ElementType, entities_EntityType, entities_Model, entities_Entity, entities_Attribute},
    associations={attributes4, type6, elementType8, entities0, superType2, entity10},
