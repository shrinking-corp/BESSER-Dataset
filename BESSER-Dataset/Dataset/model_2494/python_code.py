...
class basicFsmEnv_Trans:
    ...
    def __init__(self, event: str, basicFsmEnv_Trans: "basicFsmEnv_Machine" = None, Trans: "basicFsmEnv_State" = None, Trans5: "basicFsmEnv_State" = None, in_: "basicFsmEnv_State" = None, out: "basicFsmEnv_State" = None, basicFsmEnv_Trans12: "basicFsmEnv_Guard" = None, basicFsmEnv_Trans14: "basicFsmEnv_Action" = None):
        self.event = event
    ...
    def in_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_basicFsmEnv_Trans__in_", None)
        self.__in_ = value
