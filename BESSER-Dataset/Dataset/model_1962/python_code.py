...
class sourceanalysator_Hyperlink:
    ...
    def __init__(self, url: str, sourceanalysator_Hyperlink: "sourceanalysator_Library" = None, Hyperlink: "sourceanalysator_Source" = None, hyperlink: set["sourceanalysator_Source"] = None):
        self.url = url
