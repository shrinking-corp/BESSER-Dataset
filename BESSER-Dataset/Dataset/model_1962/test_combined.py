...
def test_hyp_sourceanalysator_library_is_not_abstract():
    assert not inspect.isabstract(sourceanalysator_Library)


def test_hyp_sourceanalysator_library_constructor_exists():
    assert callable(sourceanalysator_Library.__init__)


def test_hyp_sourceanalysator_library_constructor_args():
    sig = inspect.signature(sourceanalysator_Library.__init__)
    params = list(sig.parameters.keys())



def test_hyp_sourceanalysator_hyperlink_is_not_abstract():
    assert not inspect.isabstract(sourceanalysator_Hyperlink)


def test_hyp_sourceanalysator_hyperlink_constructor_exists():
    assert callable(sourceanalysator_Hyperlink.__init__)


def test_hyp_sourceanalysator_hyperlink_constructor_args():
...
def test_hyp_sourceanalysator_article_is_not_abstract():
    assert not inspect.isabstract(sourceanalysator_Article)


def test_hyp_sourceanalysator_article_constructor_exists():
    assert callable(sourceanalysator_Article.__init__)


def test_hyp_sourceanalysator_article_constructor_args():
...
def test_hyp_sourceanalysator_source_is_not_abstract():
    assert not inspect.isabstract(sourceanalysator_Source)


def test_hyp_sourceanalysator_source_constructor_exists():
    assert callable(sourceanalysator_Source.__init__)


def test_hyp_sourceanalysator_source_constructor_args():
    sig = inspect.signature(sourceanalysator_Source.__init__)
    params = list(sig.parameters.keys())



def test_hyp_sourceanalysator_generalsource_is_not_abstract():
    assert not inspect.isabstract(sourceanalysator_GeneralSource)


def test_hyp_sourceanalysator_generalsource_constructor_exists():
    assert callable(sourceanalysator_GeneralSource.__init__)


def test_hyp_sourceanalysator_generalsource_constructor_args():
...
def test_hyp_sourceanalysator_hyperlink_url_setter(instance):
...
def test_hyp_sourceanalysator_article_localFile_setter(instance):
...
@given(instance=sourceanalysator_Article_strategy)
def test_hyp_sourceanalysator_article_title_setter(instance):
...
def test_hyp_sourceanalysator_generalsource_dontCount_setter(instance):
...
@given(instance=sourceanalysator_GeneralSource_strategy)
def test_hyp_sourceanalysator_generalsource_aliases_setter(instance):
...
@given(instance=sourceanalysator_GeneralSource_strategy)
def test_hyp_sourceanalysator_generalsource_name_setter(instance):
