...
# Classes
sourceanalysator_GeneralSource = Class(name="sourceanalysator_GeneralSource")
sourceanalysator_Source = Class(name="sourceanalysator_Source")
sourceanalysator_Article = Class(name="sourceanalysator_Article")
sourceanalysator_Hyperlink = Class(name="sourceanalysator_Hyperlink")
sourceanalysator_Library = Class(name="sourceanalysator_Library")
...
sourceanalysator_GeneralSource.attributes={sourceanalysator_GeneralSource_name, sourceanalysator_GeneralSource_dontCount, sourceanalysator_GeneralSource_aliases}
...
sourceanalysator_Article.attributes={sourceanalysator_Article_localFile, sourceanalysator_Article_title}
...
domain_model = DomainModel(
    ...
    associations={sources0, generalSource1, article2, hyperlink4, generalSources6, articles7, sources11, sources13, hyperlinks9},
    generalizations={},
    metadata=None
)
