...
domain_model = DomainModel(
    name="PetriNet",
    types={PetriNet_Arc, PetriNet_Element, PetriNet_PetriNet, Element, Place, Transition, Arc, PetriNet_Place, TransToPlaceArc, PlaceToTransArc, PetriNet_Transition, PetriNet_PlaceToTransArc, PetriNet_TransToPlaceArc},
