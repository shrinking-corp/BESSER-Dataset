...
domain_model = DomainModel(
    name="training",
    types={training_Session, training_Training, training_TrainingOrganization, Person, training_Trainee, training_Trainer, training_Person},
    associations={training0, people5, sessions7, training10, canBeProvidedBy13, canProvide14, trainer1, Trainees3},
