...
class MovingObject:
    ...
    pass
class surveillance_UnidentifiedObject(MovingObject, ProbableElement):
...
class surveillance_MovingObject(ABC):
    ...
    def move(self, surveillance_seconds):
        # TODO: Implement move method
        pass

class surveillance_GunShot(ProbableElement):

    def __init__(self, angle: float, hitsTarget: bool, GunShot: "surveillance_Coordinate" = None, shot: "surveillance_Coordinate" = None, shot10: "surveillance_Drone" = None, shot12: "surveillance_UnidentifiedObject" = None, GunShot4: "surveillance_Drone" = None, GunShot6: "surveillance_UnidentifiedObject" = None):
        self.angle = angle
...
class surveillance_Coordinate:
    ...
    def __init__(self, x: float, y: float, currentPosition: "surveillance_MovingObject" = None, Coordinate: "surveillance_MovingObject" = None, shootingPosition: "surveillance_GunShot" = None, Coordinate8: "surveillance_GunShot" = None):
        self.x = x
        self.y = y
    ...
    def distance(self, surveillance_other) :
