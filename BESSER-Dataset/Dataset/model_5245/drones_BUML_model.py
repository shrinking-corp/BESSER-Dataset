...
# Classes
surveillance_Coordinate = Class(name="surveillance_Coordinate")
surveillance_GunShot = Class(name="surveillance_GunShot")
surveillance_MovingObject = Class(name="surveillance_MovingObject", is_abstract=True)
surveillance_Clock = Class(name="surveillance_Clock")
surveillance_Drone = Class(name="surveillance_Drone")
MovingObject = Class(name="MovingObject")
surveillance_UnidentifiedObject = Class(name="surveillance_UnidentifiedObject")
ProbableElement = Class(name="ProbableElement")
surveillance_ProbableElement = Class(name="surveillance_ProbableElement", is_abstract=True)
...
surveillance_Coordinate_m_distance: Method = Method(name="distance", parameters={Parameter(name='surveillance_other', type=StringType)}, type=FloatType)
surveillance_Coordinate.attributes={surveillance_Coordinate_x, surveillance_Coordinate_y}
...
surveillance_GunShot.attributes={surveillance_GunShot_angle, surveillance_GunShot_hitsTarget}
...
surveillance_MovingObject_m_move: Method = Method(name="move", parameters={Parameter(name='surveillance_seconds', type=StringType)})
...
domain_model = DomainModel(
    name="surveillance",
    types={surveillance_Coordinate, surveillance_GunShot, surveillance_MovingObject, surveillance_Clock, surveillance_Drone, MovingObject, surveillance_UnidentifiedObject, ProbableElement, surveillance_ProbableElement},
    associations={object1, currentPosition2, shot0, shootingPosition7, drone9, target11, shot3, shot5},
