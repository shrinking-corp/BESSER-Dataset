...
public class ecore_EClassifier extends ENamedElement {
    ...
    public ecore_EClassifier(
        String instanceClassName,        String instanceTypeName,        String defaultValue,        String instanceClass    ) {
        super(
        );
    ...
    public ecore_EClassifier(
        String instanceClassName,        String instanceTypeName,        String defaultValue,        String instanceClass        ArrayList<ecore_ETypeParameter> ecore_etypeparameters    ) {
        this.instanceClassName = instanceClassName;
        this.instanceTypeName = instanceTypeName;
        this.defaultValue = defaultValue;
        this.instanceClass = instanceClass;
