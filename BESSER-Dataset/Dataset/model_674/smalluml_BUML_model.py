...
smalluml_Property = Class(name="smalluml_Property")
NamedElement = Class(name="NamedElement")
smalluml_Type = Class(name="smalluml_Type")
smalluml_NamedElement = Class(name="smalluml_NamedElement", is_abstract=True)
smalluml_TypeReal = Class(name="smalluml_TypeReal")
smalluml_TypeInteger = Class(name="smalluml_TypeInteger")
smalluml_TypeUnlimitedNatural = Class(name="smalluml_TypeUnlimitedNatural")
smalluml_TypeBoolean = Class(name="smalluml_TypeBoolean")
smalluml_Root = Class(name="smalluml_Root")
smalluml_TypeString = Class(name="smalluml_TypeString")
...
domain_model = DomainModel(
    name="smalluml",
    types={smalluml_Class, Type, smalluml_Operation, smalluml_Property, NamedElement, smalluml_Type, smalluml_NamedElement, smalluml_TypeReal, smalluml_TypeInteger, smalluml_TypeUnlimitedNatural, smalluml_TypeBoolean, smalluml_Root, smalluml_TypeString},
    associations={ownedOperations0, superClass2, ownedProperties4, resultType6, params8, type11, elements14, primitiveTypes16},
    generalizations={gen_smalluml_Class_Type, gen_smalluml_Operation_NamedElement, gen_smalluml_Property_NamedElement, gen_smalluml_TypeReal_Type, gen_smalluml_TypeInteger_Type, gen_smalluml_TypeUnlimitedNatural_Type, gen_smalluml_TypeBoolean_Type, gen_smalluml_Type_NamedElement, gen_smalluml_TypeString_Type},
    metadata=None
)
