...
class efsm_Variable:
    ...
    def __init__(self, name: str, type: str, class_: str, efsm_Variable: "efsm_Input" = None):
        self.name = name
        self.type = type
        self.class_ = class_
...
class efsm_Event:
    ...
    def __init__(self, name: str, return_: str, class_: str, efsm_Event: "efsm_Transition" = None, efsm_Event19: set["efsm_Param"] = None):
        self.name = name
