...
efsm_Input = Class(name="efsm_Input")
efsm_Event = Class(name="efsm_Event")
...
efsm_Param = Class(name="efsm_Param")
efsm_Variable = Class(name="efsm_Variable")
...
efsm_Transition.attributes={efsm_Transition_action, efsm_Transition_guard, efsm_Transition_name, efsm_Transition_output}
...
efsm_Event_return_: Property = Property(name="return_", type=StringType)
efsm_Event_class_: Property = Property(name="class_", type=StringType)
efsm_Event.attributes={efsm_Event_return_, efsm_Event_name, efsm_Event_class_}
...
efsm_Param.attributes={efsm_Param_argType, efsm_Param_argName}
...
efsm_Variable_class_: Property = Property(name="class_", type=StringType)
efsm_Variable.attributes={efsm_Variable_class_, efsm_Variable_name, efsm_Variable_type}
...
domain_model = DomainModel(
    name="efsm",
    types={efsm_EFSM, efsm_Transition, efsm_InitialState, efsm_AbstractState, efsm_Input, efsm_Event, AbstractState, efsm_State, efsm_ContextVariable, efsm_Param, efsm_Variable},
    associations={transitions0, initialstate1, source7, target9, input12, event14, states3, contextVariables5, args18, variables16},
