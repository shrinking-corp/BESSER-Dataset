...
def test_hyp_commands_labelcommand_is_not_abstract():
    assert not inspect.isabstract(Commands_LabelCommand)


def test_hyp_commands_labelcommand_constructor_exists():
    assert callable(Commands_LabelCommand.__init__)


def test_hyp_commands_labelcommand_constructor_args():
    sig = inspect.signature(Commands_LabelCommand.__init__)
    params = list(sig.parameters.keys())



def test_hyp_sequencer_is_not_abstract():
    assert not inspect.isabstract(Sequencer)


def test_hyp_sequencer_constructor_exists():
    assert callable(Sequencer.__init__)


def test_hyp_sequencer_constructor_args():
    sig = inspect.signature(Sequencer.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_sequencers_break_is_not_abstract():
    assert not inspect.isabstract(C_Sequencers_Break)


def test_hyp_c_sequencers_break_constructor_exists():
    assert callable(C_Sequencers_Break.__init__)


def test_hyp_c_sequencers_break_constructor_args():
    sig = inspect.signature(C_Sequencers_Break.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_sequencers_goto_is_not_abstract():
    assert not inspect.isabstract(C_Sequencers_Goto)


def test_hyp_c_sequencers_goto_constructor_exists():
    assert callable(C_Sequencers_Goto.__init__)


def test_hyp_c_sequencers_goto_constructor_args():
...
def test_hyp_c_expressions_floatliteral_is_not_abstract():
    assert not inspect.isabstract(C_Expressions_FloatLiteral)


def test_hyp_c_expressions_floatliteral_constructor_exists():
    assert callable(C_Expressions_FloatLiteral.__init__)


def test_hyp_c_expressions_floatliteral_constructor_args():
...
def test_hyp_c_expressions_doubleliteral_is_not_abstract():
    assert not inspect.isabstract(C_Expressions_DoubleLiteral)


def test_hyp_c_expressions_doubleliteral_constructor_exists():
    assert callable(C_Expressions_DoubleLiteral.__init__)


def test_hyp_c_expressions_doubleliteral_constructor_args():
...
def test_hyp_c_expressions_shortliteral_is_not_abstract():
    assert not inspect.isabstract(C_Expressions_ShortLiteral)


def test_hyp_c_expressions_shortliteral_constructor_exists():
    assert callable(C_Expressions_ShortLiteral.__init__)


def test_hyp_c_expressions_shortliteral_constructor_args():
...
def test_hyp_c_expressions_stringliteral_is_not_abstract():
    assert not inspect.isabstract(C_Expressions_StringLiteral)


def test_hyp_c_expressions_stringliteral_constructor_exists():
    assert callable(C_Expressions_StringLiteral.__init__)


def test_hyp_c_expressions_stringliteral_constructor_args():
...
def test_hyp_c_expressions_intliteral_is_not_abstract():
    assert not inspect.isabstract(C_Expressions_IntLiteral)


def test_hyp_c_expressions_intliteral_constructor_exists():
    assert callable(C_Expressions_IntLiteral.__init__)


def test_hyp_c_expressions_intliteral_constructor_args():
...
def test_hyp_c_expressions_charliteral_is_not_abstract():
    assert not inspect.isabstract(C_Expressions_CharLiteral)


def test_hyp_c_expressions_charliteral_constructor_exists():
    assert callable(C_Expressions_CharLiteral.__init__)


def test_hyp_c_expressions_charliteral_constructor_args():
...
def test_hyp_c_expressions_simplelogicexpression_is_not_abstract():
    assert not inspect.isabstract(C_Expressions_SimpleLogicExpression)


def test_hyp_c_expressions_simplelogicexpression_constructor_exists():
    assert callable(C_Expressions_SimpleLogicExpression.__init__)


def test_hyp_c_expressions_simplelogicexpression_constructor_args():
...
def test_hyp_c_expressions_displacementlogicexpression_is_not_abstract():
    assert not inspect.isabstract(C_Expressions_DisplacementLogicExpression)


def test_hyp_c_expressions_displacementlogicexpression_constructor_exists():
    assert callable(C_Expressions_DisplacementLogicExpression.__init__)


def test_hyp_c_expressions_displacementlogicexpression_constructor_args():
...
def test_hyp_c_expressions_composedconditionalexpression_is_not_abstract():
    assert not inspect.isabstract(C_Expressions_ComposedConditionalExpression)


def test_hyp_c_expressions_composedconditionalexpression_constructor_exists():
    assert callable(C_Expressions_ComposedConditionalExpression.__init__)


def test_hyp_c_expressions_composedconditionalexpression_constructor_args():
...
def test_hyp_c_expressions_binaryarithmeticexpression_is_not_abstract():
    assert not inspect.isabstract(C_Expressions_BinaryArithmeticExpression)


def test_hyp_c_expressions_binaryarithmeticexpression_constructor_exists():
    assert callable(C_Expressions_BinaryArithmeticExpression.__init__)


def test_hyp_c_expressions_binaryarithmeticexpression_constructor_args():
...
def test_hyp_c_expressions_unaryarithmeticexpression_is_not_abstract():
    assert not inspect.isabstract(C_Expressions_UnaryArithmeticExpression)


def test_hyp_c_expressions_unaryarithmeticexpression_constructor_exists():
    assert callable(C_Expressions_UnaryArithmeticExpression.__init__)


def test_hyp_c_expressions_unaryarithmeticexpression_constructor_args():
...
def test_hyp_declarations_prototypefunctiondeclaration_is_not_abstract():
    assert not inspect.isabstract(Declarations_PrototypeFunctionDeclaration)


def test_hyp_declarations_prototypefunctiondeclaration_constructor_exists():
    assert callable(Declarations_PrototypeFunctionDeclaration.__init__)


def test_hyp_declarations_prototypefunctiondeclaration_constructor_args():
...
def test_hyp_c_expressions_pointervariableaccess_is_not_abstract():
    assert not inspect.isabstract(C_Expressions_PointerVariableAccess)


def test_hyp_c_expressions_pointervariableaccess_constructor_exists():
    assert callable(C_Expressions_PointerVariableAccess.__init__)


def test_hyp_c_expressions_pointervariableaccess_constructor_args():
...
def test_hyp_declarations_constantdeclaration_is_not_abstract():
    assert not inspect.isabstract(Declarations_ConstantDeclaration)


def test_hyp_declarations_constantdeclaration_constructor_exists():
    assert callable(Declarations_ConstantDeclaration.__init__)


def test_hyp_declarations_constantdeclaration_constructor_args():
...
def test_hyp_c_expressions_arrayaccess_is_not_abstract():
    assert not inspect.isabstract(C_Expressions_ArrayAccess)


def test_hyp_c_expressions_arrayaccess_constructor_exists():
    assert callable(C_Expressions_ArrayAccess.__init__)


def test_hyp_c_expressions_arrayaccess_constructor_args():
    sig = inspect.signature(C_Expressions_ArrayAccess.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_expressions_variableaccess_is_not_abstract():
    assert not inspect.isabstract(C_Expressions_VariableAccess)


def test_hyp_c_expressions_variableaccess_constructor_exists():
    assert callable(C_Expressions_VariableAccess.__init__)


def test_hyp_c_expressions_variableaccess_constructor_args():
    sig = inspect.signature(C_Expressions_VariableAccess.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_expressions_prototypeaccess_is_not_abstract():
    assert not inspect.isabstract(C_Expressions_PrototypeAccess)


def test_hyp_c_expressions_prototypeaccess_constructor_exists():
    assert callable(C_Expressions_PrototypeAccess.__init__)


def test_hyp_c_expressions_prototypeaccess_constructor_args():
    sig = inspect.signature(C_Expressions_PrototypeAccess.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_expressions_constantaccess_is_not_abstract():
    assert not inspect.isabstract(C_Expressions_ConstantAccess)


def test_hyp_c_expressions_constantaccess_constructor_exists():
    assert callable(C_Expressions_ConstantAccess.__init__)


def test_hyp_c_expressions_constantaccess_constructor_args():
    sig = inspect.signature(C_Expressions_ConstantAccess.__init__)
    params = list(sig.parameters.keys())



def test_hyp_iterativecommand_is_not_abstract():
    assert not inspect.isabstract(IterativeCommand)


def test_hyp_iterativecommand_constructor_exists():
    assert callable(IterativeCommand.__init__)


def test_hyp_iterativecommand_constructor_args():
    sig = inspect.signature(IterativeCommand.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_commands_forcommand_is_not_abstract():
    assert not inspect.isabstract(C_Commands_ForCommand)


def test_hyp_c_commands_forcommand_constructor_exists():
    assert callable(C_Commands_ForCommand.__init__)


def test_hyp_c_commands_forcommand_constructor_args():
    sig = inspect.signature(C_Commands_ForCommand.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_commands_defaultoption_is_not_abstract():
    assert not inspect.isabstract(C_Commands_DefaultOption)


def test_hyp_c_commands_defaultoption_constructor_exists():
    assert callable(C_Commands_DefaultOption.__init__)


def test_hyp_c_commands_defaultoption_constructor_args():
    sig = inspect.signature(C_Commands_DefaultOption.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_commands_caseoption_is_not_abstract():
    assert not inspect.isabstract(C_Commands_CaseOption)


def test_hyp_c_commands_caseoption_constructor_exists():
    assert callable(C_Commands_CaseOption.__init__)


def test_hyp_c_commands_caseoption_constructor_args():
    sig = inspect.signature(C_Commands_CaseOption.__init__)
    params = list(sig.parameters.keys())



def test_hyp_commands_defaultoption_is_not_abstract():
    assert not inspect.isabstract(Commands_DefaultOption)


def test_hyp_commands_defaultoption_constructor_exists():
    assert callable(Commands_DefaultOption.__init__)


def test_hyp_commands_defaultoption_constructor_args():
    sig = inspect.signature(Commands_DefaultOption.__init__)
    params = list(sig.parameters.keys())



def test_hyp_commands_caseoption_is_not_abstract():
    assert not inspect.isabstract(Commands_CaseOption)


def test_hyp_commands_caseoption_constructor_exists():
    assert callable(Commands_CaseOption.__init__)


def test_hyp_commands_caseoption_constructor_args():
    sig = inspect.signature(Commands_CaseOption.__init__)
    params = list(sig.parameters.keys())



def test_hyp_expressions_variableaccess_is_not_abstract():
    assert not inspect.isabstract(Expressions_VariableAccess)


def test_hyp_expressions_variableaccess_constructor_exists():
    assert callable(Expressions_VariableAccess.__init__)


def test_hyp_expressions_variableaccess_constructor_args():
...
def test_hyp_decisioncommand_is_not_abstract():
    assert not inspect.isabstract(DecisionCommand)


def test_hyp_decisioncommand_constructor_exists():
    assert callable(DecisionCommand.__init__)


def test_hyp_decisioncommand_constructor_args():
    sig = inspect.signature(DecisionCommand.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_commands_switchcommand_is_not_abstract():
    assert not inspect.isabstract(C_Commands_SwitchCommand)


def test_hyp_c_commands_switchcommand_constructor_exists():
    assert callable(C_Commands_SwitchCommand.__init__)


def test_hyp_c_commands_switchcommand_constructor_args():
    sig = inspect.signature(C_Commands_SwitchCommand.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_commands_ifcommand_is_not_abstract():
    assert not inspect.isabstract(C_Commands_IfCommand)


def test_hyp_c_commands_ifcommand_constructor_exists():
    assert callable(C_Commands_IfCommand.__init__)


def test_hyp_c_commands_ifcommand_constructor_args():
...
def test_hyp_c_expressions_logicexpression_is_not_abstract():
    assert not inspect.isabstract(C_Expressions_LogicExpression)


def test_hyp_c_expressions_logicexpression_constructor_exists():
    assert callable(C_Expressions_LogicExpression.__init__)


def test_hyp_c_expressions_logicexpression_constructor_args():
    sig = inspect.signature(C_Expressions_LogicExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_expressions_arithmeticexpression_is_not_abstract():
    assert not inspect.isabstract(C_Expressions_ArithmeticExpression)


def test_hyp_c_expressions_arithmeticexpression_constructor_exists():
    assert callable(C_Expressions_ArithmeticExpression.__init__)


def test_hyp_c_expressions_arithmeticexpression_constructor_args():
    sig = inspect.signature(C_Expressions_ArithmeticExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_expressions_literal_is_not_abstract():
    assert not inspect.isabstract(C_Expressions_Literal)


def test_hyp_c_expressions_literal_constructor_exists():
    assert callable(C_Expressions_Literal.__init__)


def test_hyp_c_expressions_literal_constructor_args():
    sig = inspect.signature(C_Expressions_Literal.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_expressions_conditionalexpression_is_not_abstract():
    assert not inspect.isabstract(C_Expressions_ConditionalExpression)


def test_hyp_c_expressions_conditionalexpression_constructor_exists():
    assert callable(C_Expressions_ConditionalExpression.__init__)


def test_hyp_c_expressions_conditionalexpression_constructor_args():
...
def test_hyp_c_expressions_constantexpression_is_not_abstract():
    assert not inspect.isabstract(C_Expressions_ConstantExpression)


def test_hyp_c_expressions_constantexpression_constructor_exists():
    assert callable(C_Expressions_ConstantExpression.__init__)


def test_hyp_c_expressions_constantexpression_constructor_args():
    sig = inspect.signature(C_Expressions_ConstantExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_expressions_castexpression_is_not_abstract():
    assert not inspect.isabstract(C_Expressions_CastExpression)


def test_hyp_c_expressions_castexpression_constructor_exists():
    assert callable(C_Expressions_CastExpression.__init__)


def test_hyp_c_expressions_castexpression_constructor_args():
    sig = inspect.signature(C_Expressions_CastExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_expressions_construction_is_not_abstract():
    assert not inspect.isabstract(C_Expressions_Construction)


def test_hyp_c_expressions_construction_constructor_exists():
    assert callable(C_Expressions_Construction.__init__)


def test_hyp_c_expressions_construction_constructor_args():
    sig = inspect.signature(C_Expressions_Construction.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_expressions_expression_is_not_abstract():
    assert not inspect.isabstract(C_Expressions_Expression)


def test_hyp_c_expressions_expression_constructor_exists():
    assert callable(C_Expressions_Expression.__init__)


def test_hyp_c_expressions_expression_constructor_args():
    sig = inspect.signature(C_Expressions_Expression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_commands_whilecommand_is_not_abstract():
    assert not inspect.isabstract(C_Commands_WhileCommand)


def test_hyp_c_commands_whilecommand_constructor_exists():
    assert callable(C_Commands_WhileCommand.__init__)


def test_hyp_c_commands_whilecommand_constructor_args():
    sig = inspect.signature(C_Commands_WhileCommand.__init__)
    params = list(sig.parameters.keys())



def test_hyp_blockedelement_is_not_abstract():
    assert not inspect.isabstract(BlockedElement)


def test_hyp_blockedelement_constructor_exists():
    assert callable(BlockedElement.__init__)


def test_hyp_blockedelement_constructor_args():
    sig = inspect.signature(BlockedElement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_sequencers_sequencer_is_not_abstract():
    assert not inspect.isabstract(C_Sequencers_Sequencer)


def test_hyp_c_sequencers_sequencer_constructor_exists():
    assert callable(C_Sequencers_Sequencer.__init__)


def test_hyp_c_sequencers_sequencer_constructor_args():
    sig = inspect.signature(C_Sequencers_Sequencer.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_commands_command_is_not_abstract():
    assert not inspect.isabstract(C_Commands_Command)


def test_hyp_c_commands_command_constructor_exists():
    assert callable(C_Commands_Command.__init__)


def test_hyp_c_commands_command_constructor_args():
    sig = inspect.signature(C_Commands_Command.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_compilationdirectivedeclarations_endif_is_not_abstract():
    assert not inspect.isabstract(C_CompilationDirectiveDeclarations_Endif)


def test_hyp_c_compilationdirectivedeclarations_endif_constructor_exists():
    assert callable(C_CompilationDirectiveDeclarations_Endif.__init__)


def test_hyp_c_compilationdirectivedeclarations_endif_constructor_args():
    sig = inspect.signature(C_CompilationDirectiveDeclarations_Endif.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ifdirective_is_not_abstract():
    assert not inspect.isabstract(IfDirective)


def test_hyp_ifdirective_constructor_exists():
    assert callable(IfDirective.__init__)


def test_hyp_ifdirective_constructor_args():
    sig = inspect.signature(IfDirective.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_compilationdirectivedeclarations_elif_is_not_abstract():
    assert not inspect.isabstract(C_CompilationDirectiveDeclarations_Elif)


def test_hyp_c_compilationdirectivedeclarations_elif_constructor_exists():
    assert callable(C_CompilationDirectiveDeclarations_Elif.__init__)


def test_hyp_c_compilationdirectivedeclarations_elif_constructor_args():
    sig = inspect.signature(C_CompilationDirectiveDeclarations_Elif.__init__)
    params = list(sig.parameters.keys())



def test_hyp_expressions_constantexpression_is_not_abstract():
    assert not inspect.isabstract(Expressions_ConstantExpression)


def test_hyp_expressions_constantexpression_constructor_exists():
    assert callable(Expressions_ConstantExpression.__init__)


def test_hyp_expressions_constantexpression_constructor_args():
    sig = inspect.signature(Expressions_ConstantExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_complexdirectivedeclaration_is_not_abstract():
    assert not inspect.isabstract(ComplexDirectiveDeclaration)


def test_hyp_complexdirectivedeclaration_constructor_exists():
    assert callable(ComplexDirectiveDeclaration.__init__)


def test_hyp_complexdirectivedeclaration_constructor_args():
    sig = inspect.signature(ComplexDirectiveDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_compilationdirectivedeclarations_ifdirective_is_not_abstract():
    assert not inspect.isabstract(C_CompilationDirectiveDeclarations_IfDirective)


def test_hyp_c_compilationdirectivedeclarations_ifdirective_constructor_exists():
    assert callable(C_CompilationDirectiveDeclarations_IfDirective.__init__)


def test_hyp_c_compilationdirectivedeclarations_ifdirective_constructor_args():
    sig = inspect.signature(C_CompilationDirectiveDeclarations_IfDirective.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_compilationdirectivedeclarations_elsedirective_is_not_abstract():
    assert not inspect.isabstract(C_CompilationDirectiveDeclarations_ElseDirective)


def test_hyp_c_compilationdirectivedeclarations_elsedirective_constructor_exists():
    assert callable(C_CompilationDirectiveDeclarations_ElseDirective.__init__)


def test_hyp_c_compilationdirectivedeclarations_elsedirective_constructor_args():
    sig = inspect.signature(C_CompilationDirectiveDeclarations_ElseDirective.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_compilationdirectivedeclarations_ifndef_is_not_abstract():
    assert not inspect.isabstract(C_CompilationDirectiveDeclarations_Ifndef)


def test_hyp_c_compilationdirectivedeclarations_ifndef_constructor_exists():
    assert callable(C_CompilationDirectiveDeclarations_Ifndef.__init__)


def test_hyp_c_compilationdirectivedeclarations_ifndef_constructor_args():
    sig = inspect.signature(C_CompilationDirectiveDeclarations_Ifndef.__init__)
    params = list(sig.parameters.keys())



def test_hyp_compilationdirectivedeclarations_endif_is_not_abstract():
    assert not inspect.isabstract(CompilationDirectiveDeclarations_Endif)


def test_hyp_compilationdirectivedeclarations_endif_constructor_exists():
    assert callable(CompilationDirectiveDeclarations_Endif.__init__)


def test_hyp_compilationdirectivedeclarations_endif_constructor_args():
    sig = inspect.signature(CompilationDirectiveDeclarations_Endif.__init__)
    params = list(sig.parameters.keys())



def test_hyp_compilationdirectivedeclarations_complexdirectivedeclaration_is_not_abstract():
    assert not inspect.isabstract(CompilationDirectiveDeclarations_ComplexDirectiveDeclaration)


def test_hyp_compilationdirectivedeclarations_complexdirectivedeclaration_constructor_exists():
    assert callable(CompilationDirectiveDeclarations_ComplexDirectiveDeclaration.__init__)


def test_hyp_compilationdirectivedeclarations_complexdirectivedeclaration_constructor_args():
    sig = inspect.signature(CompilationDirectiveDeclarations_ComplexDirectiveDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_simpledirectivedeclaration_is_not_abstract():
    assert not inspect.isabstract(SimpleDirectiveDeclaration)


def test_hyp_simpledirectivedeclaration_constructor_exists():
    assert callable(SimpleDirectiveDeclaration.__init__)


def test_hyp_simpledirectivedeclaration_constructor_args():
    sig = inspect.signature(SimpleDirectiveDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_compilationdirectivedeclarations_include_is_not_abstract():
    assert not inspect.isabstract(C_CompilationDirectiveDeclarations_Include)


def test_hyp_c_compilationdirectivedeclarations_include_constructor_exists():
    assert callable(C_CompilationDirectiveDeclarations_Include.__init__)


def test_hyp_c_compilationdirectivedeclarations_include_constructor_args():
    sig = inspect.signature(C_CompilationDirectiveDeclarations_Include.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_compilationdirectivedeclarations_define_is_not_abstract():
    assert not inspect.isabstract(C_CompilationDirectiveDeclarations_Define)


def test_hyp_c_compilationdirectivedeclarations_define_constructor_exists():
    assert callable(C_CompilationDirectiveDeclarations_Define.__init__)


def test_hyp_c_compilationdirectivedeclarations_define_constructor_args():
...
def test_hyp_compilationdirectivedeclaration_is_not_abstract():
    assert not inspect.isabstract(CompilationDirectiveDeclaration)


def test_hyp_compilationdirectivedeclaration_constructor_exists():
    assert callable(CompilationDirectiveDeclaration.__init__)


def test_hyp_compilationdirectivedeclaration_constructor_args():
    sig = inspect.signature(CompilationDirectiveDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_compilationdirectivedeclarations_complexdirectivedeclaration_is_not_abstract():
    assert not inspect.isabstract(C_CompilationDirectiveDeclarations_ComplexDirectiveDeclaration)


def test_hyp_c_compilationdirectivedeclarations_complexdirectivedeclaration_constructor_exists():
    assert callable(C_CompilationDirectiveDeclarations_ComplexDirectiveDeclaration.__init__)


def test_hyp_c_compilationdirectivedeclarations_complexdirectivedeclaration_constructor_args():
    sig = inspect.signature(C_CompilationDirectiveDeclarations_ComplexDirectiveDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_compilationdirectivedeclarations_compilationdirectivedeclaration_is_not_abstract():
    assert not inspect.isabstract(C_CompilationDirectiveDeclarations_CompilationDirectiveDeclaration)


def test_hyp_c_compilationdirectivedeclarations_compilationdirectivedeclaration_constructor_exists():
    assert callable(C_CompilationDirectiveDeclarations_CompilationDirectiveDeclaration.__init__)


def test_hyp_c_compilationdirectivedeclarations_compilationdirectivedeclaration_constructor_args():
    sig = inspect.signature(C_CompilationDirectiveDeclarations_CompilationDirectiveDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_declarations_simplevariabledeclaration_is_not_abstract():
    assert not inspect.isabstract(Declarations_SimpleVariableDeclaration)


def test_hyp_declarations_simplevariabledeclaration_constructor_exists():
    assert callable(Declarations_SimpleVariableDeclaration.__init__)


def test_hyp_declarations_simplevariabledeclaration_constructor_args():
    sig = inspect.signature(Declarations_SimpleVariableDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_flowcontrolcommand_is_not_abstract():
    assert not inspect.isabstract(FlowControlCommand)


def test_hyp_flowcontrolcommand_constructor_exists():
    assert callable(FlowControlCommand.__init__)


def test_hyp_flowcontrolcommand_constructor_args():
    sig = inspect.signature(FlowControlCommand.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_commands_returncommand_is_not_abstract():
    assert not inspect.isabstract(C_Commands_ReturnCommand)


def test_hyp_c_commands_returncommand_constructor_exists():
    assert callable(C_Commands_ReturnCommand.__init__)


def test_hyp_c_commands_returncommand_constructor_args():
    sig = inspect.signature(C_Commands_ReturnCommand.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_commands_decisioncommand_is_not_abstract():
    assert not inspect.isabstract(C_Commands_DecisionCommand)


def test_hyp_c_commands_decisioncommand_constructor_exists():
    assert callable(C_Commands_DecisionCommand.__init__)


def test_hyp_c_commands_decisioncommand_constructor_args():
    sig = inspect.signature(C_Commands_DecisionCommand.__init__)
    params = list(sig.parameters.keys())



def test_hyp_expressions_access_is_not_abstract():
    assert not inspect.isabstract(Expressions_Access)


def test_hyp_expressions_access_constructor_exists():
    assert callable(Expressions_Access.__init__)


def test_hyp_expressions_access_constructor_args():
...
def test_hyp_c_commands_flowcontrolcommand_is_not_abstract():
    assert not inspect.isabstract(C_Commands_FlowControlCommand)


def test_hyp_c_commands_flowcontrolcommand_constructor_exists():
    assert callable(C_Commands_FlowControlCommand.__init__)


def test_hyp_c_commands_flowcontrolcommand_constructor_args():
    sig = inspect.signature(C_Commands_FlowControlCommand.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_commands_iterativecommand_is_not_abstract():
    assert not inspect.isabstract(C_Commands_IterativeCommand)


def test_hyp_c_commands_iterativecommand_constructor_exists():
    assert callable(C_Commands_IterativeCommand.__init__)


def test_hyp_c_commands_iterativecommand_constructor_args():
    sig = inspect.signature(C_Commands_IterativeCommand.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_commands_expressioncommand_is_not_abstract():
    assert not inspect.isabstract(C_Commands_ExpressionCommand)


def test_hyp_c_commands_expressioncommand_constructor_exists():
    assert callable(C_Commands_ExpressionCommand.__init__)


def test_hyp_c_commands_expressioncommand_constructor_args():
    sig = inspect.signature(C_Commands_ExpressionCommand.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_commands_assignment_is_not_abstract():
    assert not inspect.isabstract(C_Commands_Assignment)


def test_hyp_c_commands_assignment_constructor_exists():
    assert callable(C_Commands_Assignment.__init__)


def test_hyp_c_commands_assignment_constructor_args():
    sig = inspect.signature(C_Commands_Assignment.__init__)
    params = list(sig.parameters.keys())



def test_hyp_commands_command_is_not_abstract():
    assert not inspect.isabstract(Commands_Command)


def test_hyp_commands_command_constructor_exists():
    assert callable(Commands_Command.__init__)


def test_hyp_commands_command_constructor_args():
    sig = inspect.signature(Commands_Command.__init__)
    params = list(sig.parameters.keys())



def test_hyp_declarations_fragmentvariabledeclaration_is_not_abstract():
    assert not inspect.isabstract(Declarations_FragmentVariableDeclaration)


def test_hyp_declarations_fragmentvariabledeclaration_constructor_exists():
    assert callable(Declarations_FragmentVariableDeclaration.__init__)


def test_hyp_declarations_fragmentvariabledeclaration_constructor_args():
    sig = inspect.signature(Declarations_FragmentVariableDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_declarations_variabledeclaration_is_not_abstract():
    assert not inspect.isabstract(Declarations_VariableDeclaration)


def test_hyp_declarations_variabledeclaration_constructor_exists():
    assert callable(Declarations_VariableDeclaration.__init__)


def test_hyp_declarations_variabledeclaration_constructor_args():
...
def test_hyp_c_declarations_prototypefunctiondeclaration_is_not_abstract():
    assert not inspect.isabstract(C_Declarations_PrototypeFunctionDeclaration)


def test_hyp_c_declarations_prototypefunctiondeclaration_constructor_exists():
    assert callable(C_Declarations_PrototypeFunctionDeclaration.__init__)


def test_hyp_c_declarations_prototypefunctiondeclaration_constructor_args():
...
def test_hyp_c_declarations_variabledeclaration_is_not_abstract():
    assert not inspect.isabstract(C_Declarations_VariableDeclaration)


def test_hyp_c_declarations_variabledeclaration_constructor_exists():
    assert callable(C_Declarations_VariableDeclaration.__init__)


def test_hyp_c_declarations_variabledeclaration_constructor_args():
...
def test_hyp_c_declarations_constantdeclaration_is_not_abstract():
    assert not inspect.isabstract(C_Declarations_ConstantDeclaration)


def test_hyp_c_declarations_constantdeclaration_constructor_exists():
    assert callable(C_Declarations_ConstantDeclaration.__init__)


def test_hyp_c_declarations_constantdeclaration_constructor_args():
    sig = inspect.signature(C_Declarations_ConstantDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_main_function_is_not_abstract():
    assert not inspect.isabstract(Main_Function)


def test_hyp_main_function_constructor_exists():
    assert callable(Main_Function.__init__)


def test_hyp_main_function_constructor_args():
    sig = inspect.signature(Main_Function.__init__)
    params = list(sig.parameters.keys())



def test_hyp_compilationdirectivedeclarations_compilationdirectivedeclaration_is_not_abstract():
    assert not inspect.isabstract(CompilationDirectiveDeclarations_CompilationDirectiveDeclaration)


def test_hyp_compilationdirectivedeclarations_compilationdirectivedeclaration_constructor_exists():
    assert callable(CompilationDirectiveDeclarations_CompilationDirectiveDeclaration.__init__)


def test_hyp_compilationdirectivedeclarations_compilationdirectivedeclaration_constructor_args():
    sig = inspect.signature(CompilationDirectiveDeclarations_CompilationDirectiveDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_expressions_construction_is_not_abstract():
    assert not inspect.isabstract(Expressions_Construction)


def test_hyp_expressions_construction_constructor_exists():
    assert callable(Expressions_Construction.__init__)


def test_hyp_expressions_construction_constructor_args():
    sig = inspect.signature(Expressions_Construction.__init__)
    params = list(sig.parameters.keys())



def test_hyp_declarations_compositevariabledeclaration_is_not_abstract():
    assert not inspect.isabstract(Declarations_CompositeVariableDeclaration)


def test_hyp_declarations_compositevariabledeclaration_constructor_exists():
    assert callable(Declarations_CompositeVariableDeclaration.__init__)


def test_hyp_declarations_compositevariabledeclaration_constructor_args():
...
def test_hyp_compositevariabledeclaration_is_not_abstract():
    assert not inspect.isabstract(CompositeVariableDeclaration)


def test_hyp_compositevariabledeclaration_constructor_exists():
    assert callable(CompositeVariableDeclaration.__init__)


def test_hyp_compositevariabledeclaration_constructor_args():
    sig = inspect.signature(CompositeVariableDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_declarations_structdeclaration_is_not_abstract():
    assert not inspect.isabstract(C_Declarations_StructDeclaration)


def test_hyp_c_declarations_structdeclaration_constructor_exists():
    assert callable(C_Declarations_StructDeclaration.__init__)


def test_hyp_c_declarations_structdeclaration_constructor_args():
    sig = inspect.signature(C_Declarations_StructDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_declarations_typedefdeclaration_is_not_abstract():
    assert not inspect.isabstract(C_Declarations_TypeDefDeclaration)


def test_hyp_c_declarations_typedefdeclaration_constructor_exists():
    assert callable(C_Declarations_TypeDefDeclaration.__init__)


def test_hyp_c_declarations_typedefdeclaration_constructor_args():
    sig = inspect.signature(C_Declarations_TypeDefDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_declarations_enumdeclaration_is_not_abstract():
    assert not inspect.isabstract(C_Declarations_EnumDeclaration)


def test_hyp_c_declarations_enumdeclaration_constructor_exists():
    assert callable(C_Declarations_EnumDeclaration.__init__)


def test_hyp_c_declarations_enumdeclaration_constructor_args():
...
def test_hyp_c_declarations_compositevariabledeclaration_is_not_abstract():
    assert not inspect.isabstract(C_Declarations_CompositeVariableDeclaration)


def test_hyp_c_declarations_compositevariabledeclaration_constructor_exists():
    assert callable(C_Declarations_CompositeVariableDeclaration.__init__)


def test_hyp_c_declarations_compositevariabledeclaration_constructor_args():
    sig = inspect.signature(C_Declarations_CompositeVariableDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_main_element_is_not_abstract():
    assert not inspect.isabstract(Main_Element)


def test_hyp_main_element_constructor_exists():
    assert callable(Main_Element.__init__)


def test_hyp_main_element_constructor_args():
...
def test_hyp_c_main_c_unit_is_not_abstract():
    assert not inspect.isabstract(C_Main_C_Unit)


def test_hyp_c_main_c_unit_constructor_exists():
    assert callable(C_Main_C_Unit.__init__)


def test_hyp_c_main_c_unit_constructor_args():
    sig = inspect.signature(C_Main_C_Unit.__init__)
    params = list(sig.parameters.keys())



def test_hyp_main_comment_is_not_abstract():
    assert not inspect.isabstract(Main_Comment)


def test_hyp_main_comment_constructor_exists():
    assert callable(Main_Comment.__init__)


def test_hyp_main_comment_constructor_args():
...
def test_hyp_c_declarations_declaration_is_not_abstract():
    assert not inspect.isabstract(C_Declarations_Declaration)


def test_hyp_c_declarations_declaration_constructor_exists():
    assert callable(C_Declarations_Declaration.__init__)


def test_hyp_c_declarations_declaration_constructor_args():
...
def test_hyp_c_main_comment_is_not_abstract():
    assert not inspect.isabstract(C_Main_Comment)


def test_hyp_c_main_comment_constructor_exists():
    assert callable(C_Main_Comment.__init__)


def test_hyp_c_main_comment_constructor_args():
    sig = inspect.signature(C_Main_Comment.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_main_element_is_not_abstract():
    assert not inspect.isabstract(C_Main_Element)


def test_hyp_c_main_element_constructor_exists():
    assert callable(C_Main_Element.__init__)


def test_hyp_c_main_element_constructor_args():
    sig = inspect.signature(C_Main_Element.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_main_unit_is_not_abstract():
    assert not inspect.isabstract(C_Main_Unit)


def test_hyp_c_main_unit_constructor_exists():
    assert callable(C_Main_Unit.__init__)


def test_hyp_c_main_unit_constructor_args():
    sig = inspect.signature(C_Main_Unit.__init__)
    params = list(sig.parameters.keys())



def test_hyp_main_unit_is_not_abstract():
    assert not inspect.isabstract(Main_Unit)


def test_hyp_main_unit_constructor_exists():
    assert callable(Main_Unit.__init__)


def test_hyp_main_unit_constructor_args():
    sig = inspect.signature(Main_Unit.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_main_program_is_not_abstract():
    assert not inspect.isabstract(C_Main_Program)


def test_hyp_c_main_program_constructor_exists():
    assert callable(C_Main_Program.__init__)


def test_hyp_c_main_program_constructor_args():
...
def test_hyp_main_block_is_not_abstract():
    assert not inspect.isabstract(Main_Block)


def test_hyp_main_block_constructor_exists():
    assert callable(Main_Block.__init__)


def test_hyp_main_block_constructor_args():
    sig = inspect.signature(Main_Block.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_abstractions_blockedelement_is_not_abstract():
    assert not inspect.isabstract(C_Abstractions_BlockedElement)


def test_hyp_c_abstractions_blockedelement_constructor_exists():
    assert callable(C_Abstractions_BlockedElement.__init__)


def test_hyp_c_abstractions_blockedelement_constructor_args():
    sig = inspect.signature(C_Abstractions_BlockedElement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_abstractions_namedelement_is_not_abstract():
    assert not inspect.isabstract(C_Abstractions_NamedElement)


def test_hyp_c_abstractions_namedelement_constructor_exists():
    assert callable(C_Abstractions_NamedElement.__init__)


def test_hyp_c_abstractions_namedelement_constructor_args():
...
def test_hyp_abstractions_namedelement_is_not_abstract():
    assert not inspect.isabstract(Abstractions_NamedElement)


def test_hyp_abstractions_namedelement_constructor_exists():
    assert callable(Abstractions_NamedElement.__init__)


def test_hyp_abstractions_namedelement_constructor_args():
    sig = inspect.signature(Abstractions_NamedElement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_expressions_atomicconditionalexpression_is_not_abstract():
    assert not inspect.isabstract(C_Expressions_AtomicConditionalExpression)


def test_hyp_c_expressions_atomicconditionalexpression_constructor_exists():
    assert callable(C_Expressions_AtomicConditionalExpression.__init__)


def test_hyp_c_expressions_atomicconditionalexpression_constructor_args():
    sig = inspect.signature(C_Expressions_AtomicConditionalExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_expressions_functioncall_is_not_abstract():
    assert not inspect.isabstract(C_Expressions_FunctionCall)


def test_hyp_c_expressions_functioncall_constructor_exists():
    assert callable(C_Expressions_FunctionCall.__init__)


def test_hyp_c_expressions_functioncall_constructor_args():
    sig = inspect.signature(C_Expressions_FunctionCall.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_compilationdirectivedeclarations_ifdef_is_not_abstract():
    assert not inspect.isabstract(C_CompilationDirectiveDeclarations_Ifdef)


def test_hyp_c_compilationdirectivedeclarations_ifdef_constructor_exists():
    assert callable(C_CompilationDirectiveDeclarations_Ifdef.__init__)


def test_hyp_c_compilationdirectivedeclarations_ifdef_constructor_args():
    sig = inspect.signature(C_CompilationDirectiveDeclarations_Ifdef.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_declarations_fragmentvariabledeclaration_is_not_abstract():
    assert not inspect.isabstract(C_Declarations_FragmentVariableDeclaration)


def test_hyp_c_declarations_fragmentvariabledeclaration_constructor_exists():
    assert callable(C_Declarations_FragmentVariableDeclaration.__init__)


def test_hyp_c_declarations_fragmentvariabledeclaration_constructor_args():
    sig = inspect.signature(C_Declarations_FragmentVariableDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_commands_labelcommand_is_not_abstract():
    assert not inspect.isabstract(C_Commands_LabelCommand)


def test_hyp_c_commands_labelcommand_constructor_exists():
    assert callable(C_Commands_LabelCommand.__init__)


def test_hyp_c_commands_labelcommand_constructor_args():
    sig = inspect.signature(C_Commands_LabelCommand.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_expressions_access_is_not_abstract():
    assert not inspect.isabstract(C_Expressions_Access)


def test_hyp_c_expressions_access_constructor_exists():
    assert callable(C_Expressions_Access.__init__)


def test_hyp_c_expressions_access_constructor_args():
    sig = inspect.signature(C_Expressions_Access.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_compilationdirectivedeclarations_simpledirectivedeclaration_is_not_abstract():
    assert not inspect.isabstract(C_CompilationDirectiveDeclarations_SimpleDirectiveDeclaration)


def test_hyp_c_compilationdirectivedeclarations_simpledirectivedeclaration_constructor_exists():
    assert callable(C_CompilationDirectiveDeclarations_SimpleDirectiveDeclaration.__init__)


def test_hyp_c_compilationdirectivedeclarations_simpledirectivedeclaration_constructor_args():
...
def test_hyp_c_types_fromheader_is_not_abstract():
    assert not inspect.isabstract(C_Types_FromHeader)


def test_hyp_c_types_fromheader_constructor_exists():
    assert callable(C_Types_FromHeader.__init__)


def test_hyp_c_types_fromheader_constructor_args():
    sig = inspect.signature(C_Types_FromHeader.__init__)
    params = list(sig.parameters.keys())



def test_hyp_compositetype_is_not_abstract():
    assert not inspect.isabstract(CompositeType)


def test_hyp_compositetype_constructor_exists():
    assert callable(CompositeType.__init__)


def test_hyp_compositetype_constructor_args():
    sig = inspect.signature(CompositeType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_types_enum_is_not_abstract():
    assert not inspect.isabstract(C_Types_Enum)


def test_hyp_c_types_enum_constructor_exists():
    assert callable(C_Types_Enum.__init__)


def test_hyp_c_types_enum_constructor_args():
    sig = inspect.signature(C_Types_Enum.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_types_struct_is_not_abstract():
    assert not inspect.isabstract(C_Types_Struct)


def test_hyp_c_types_struct_constructor_exists():
    assert callable(C_Types_Struct.__init__)


def test_hyp_c_types_struct_constructor_args():
    sig = inspect.signature(C_Types_Struct.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_types_array_is_not_abstract():
    assert not inspect.isabstract(C_Types_Array)


def test_hyp_c_types_array_constructor_exists():
    assert callable(C_Types_Array.__init__)


def test_hyp_c_types_array_constructor_args():
    sig = inspect.signature(C_Types_Array.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_types_typedef_is_not_abstract():
    assert not inspect.isabstract(C_Types_Typedef)


def test_hyp_c_types_typedef_constructor_exists():
    assert callable(C_Types_Typedef.__init__)


def test_hyp_c_types_typedef_constructor_args():
...
def test_hyp_c_types_int_is_not_abstract():
    assert not inspect.isabstract(C_Types_Int)


def test_hyp_c_types_int_constructor_exists():
    assert callable(C_Types_Int.__init__)


def test_hyp_c_types_int_constructor_args():
...
def test_hyp_c_types_float_is_not_abstract():
    assert not inspect.isabstract(C_Types_Float)


def test_hyp_c_types_float_constructor_exists():
    assert callable(C_Types_Float.__init__)


def test_hyp_c_types_float_constructor_args():
    sig = inspect.signature(C_Types_Float.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_types_void_is_not_abstract():
    assert not inspect.isabstract(C_Types_Void)


def test_hyp_c_types_void_constructor_exists():
    assert callable(C_Types_Void.__init__)


def test_hyp_c_types_void_constructor_args():
    sig = inspect.signature(C_Types_Void.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_types_double_is_not_abstract():
    assert not inspect.isabstract(C_Types_Double)


def test_hyp_c_types_double_constructor_exists():
    assert callable(C_Types_Double.__init__)


def test_hyp_c_types_double_constructor_args():
    sig = inspect.signature(C_Types_Double.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_types_short_is_not_abstract():
    assert not inspect.isabstract(C_Types_Short)


def test_hyp_c_types_short_constructor_exists():
    assert callable(C_Types_Short.__init__)


def test_hyp_c_types_short_constructor_args():
    sig = inspect.signature(C_Types_Short.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_types_char_is_not_abstract():
    assert not inspect.isabstract(C_Types_Char)


def test_hyp_c_types_char_constructor_exists():
    assert callable(C_Types_Char.__init__)


def test_hyp_c_types_char_constructor_args():
    sig = inspect.signature(C_Types_Char.__init__)
    params = list(sig.parameters.keys())



def test_hyp_abstractions_blockedelement_is_not_abstract():
    assert not inspect.isabstract(Abstractions_BlockedElement)


def test_hyp_abstractions_blockedelement_constructor_exists():
    assert callable(Abstractions_BlockedElement.__init__)


def test_hyp_abstractions_blockedelement_constructor_args():
    sig = inspect.signature(Abstractions_BlockedElement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_declarations_arraydeclaration_is_not_abstract():
    assert not inspect.isabstract(C_Declarations_ArrayDeclaration)


def test_hyp_c_declarations_arraydeclaration_constructor_exists():
    assert callable(C_Declarations_ArrayDeclaration.__init__)


def test_hyp_c_declarations_arraydeclaration_constructor_args():
...
def test_hyp_c_declarations_simplevariabledeclaration_is_not_abstract():
    assert not inspect.isabstract(C_Declarations_SimpleVariableDeclaration)


def test_hyp_c_declarations_simplevariabledeclaration_constructor_exists():
    assert callable(C_Declarations_SimpleVariableDeclaration.__init__)


def test_hyp_c_declarations_simplevariabledeclaration_constructor_args():
    sig = inspect.signature(C_Declarations_SimpleVariableDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_main_block_is_not_abstract():
    assert not inspect.isabstract(C_Main_Block)


def test_hyp_c_main_block_constructor_exists():
    assert callable(C_Main_Block.__init__)


def test_hyp_c_main_block_constructor_args():
...
def test_hyp_c_main_declarationsblock_is_not_abstract():
    assert not inspect.isabstract(C_Main_DeclarationsBlock)


def test_hyp_c_main_declarationsblock_constructor_exists():
    assert callable(C_Main_DeclarationsBlock.__init__)


def test_hyp_c_main_declarationsblock_constructor_args():
    sig = inspect.signature(C_Main_DeclarationsBlock.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_main_functionsblock_is_not_abstract():
    assert not inspect.isabstract(C_Main_FunctionsBlock)


def test_hyp_c_main_functionsblock_constructor_exists():
    assert callable(C_Main_FunctionsBlock.__init__)


def test_hyp_c_main_functionsblock_constructor_args():
    sig = inspect.signature(C_Main_FunctionsBlock.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_main_function_is_not_abstract():
    assert not inspect.isabstract(C_Main_Function)


def test_hyp_c_main_function_constructor_exists():
    assert callable(C_Main_Function.__init__)


def test_hyp_c_main_function_constructor_args():
...
def test_hyp_main_declarationsblock_is_not_abstract():
    assert not inspect.isabstract(Main_DeclarationsBlock)


def test_hyp_main_declarationsblock_constructor_exists():
    assert callable(Main_DeclarationsBlock.__init__)


def test_hyp_main_declarationsblock_constructor_args():
    sig = inspect.signature(Main_DeclarationsBlock.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_main_h_unit_is_not_abstract():
    assert not inspect.isabstract(C_Main_H_Unit)


def test_hyp_c_main_h_unit_constructor_exists():
    assert callable(C_Main_H_Unit.__init__)


def test_hyp_c_main_h_unit_constructor_args():
...
def test_hyp_c_types_compositetype_is_not_abstract():
    assert not inspect.isabstract(C_Types_CompositeType)


def test_hyp_c_types_compositetype_constructor_exists():
    assert callable(C_Types_CompositeType.__init__)


def test_hyp_c_types_compositetype_constructor_args():
    sig = inspect.signature(C_Types_CompositeType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_types_primitivetype_is_not_abstract():
    assert not inspect.isabstract(C_Types_PrimitiveType)


def test_hyp_c_types_primitivetype_constructor_exists():
    assert callable(C_Types_PrimitiveType.__init__)


def test_hyp_c_types_primitivetype_constructor_args():
    sig = inspect.signature(C_Types_PrimitiveType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_c_types_type_is_not_abstract():
    assert not inspect.isabstract(C_Types_Type)


def test_hyp_c_types_type_constructor_exists():
    assert callable(C_Types_Type.__init__)


def test_hyp_c_types_type_constructor_args():
...
def test_hyp_displacementlogicoperatorkind_exists():
    # Check that the Enumeration exists
    assert DisplacementLogicOperatorKind is not None

def test_hyp_displacementlogicoperatorkind_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_relationaloperatorkind_exists():
    # Check that the Enumeration exists
    assert RelationalOperatorKind is not None

def test_hyp_relationaloperatorkind_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_relationalconectorkind_exists():
    # Check that the Enumeration exists
    assert RelationalConectorKind is not None

def test_hyp_relationalconectorkind_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_functionmodifierkind_exists():
    # Check that the Enumeration exists
    assert FunctionModifierKind is not None

def test_hyp_functionmodifierkind_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_simplelogicoperatorkind_exists():
    # Check that the Enumeration exists
    assert SimpleLogicOperatorKind is not None

def test_hyp_simplelogicoperatorkind_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_c_expressions_floatliteral_value_setter(instance):
...
def test_hyp_c_expressions_doubleliteral_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_c_expressions_shortliteral_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_c_expressions_stringliteral_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_c_expressions_intliteral_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_c_expressions_charliteral_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_c_expressions_simplelogicexpression_operator_setter(instance):
...
def test_hyp_c_expressions_displacementlogicexpression_operator_setter(instance):
    original = instance.operator
    instance.operator = original
    assert instance.operator == original
...
def test_hyp_c_expressions_composedconditionalexpression_operator_setter(instance):
    original = instance.operator
    instance.operator = original
    assert instance.operator == original
...
def test_hyp_c_expressions_binaryarithmeticexpression_operator_setter(instance):
    original = instance.operator
    instance.operator = original
    assert instance.operator == original
...
def test_hyp_c_expressions_unaryarithmeticexpression_operator_setter(instance):
    original = instance.operator
    instance.operator = original
    assert instance.operator == original
...
def test_hyp_c_expressions_conditionalexpression_conector_setter(instance):
...
def test_hyp_c_compilationdirectivedeclarations_define_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_c_declarations_prototypefunctiondeclaration_isAPointer_setter(instance):
...
@given(instance=C_Declarations_PrototypeFunctionDeclaration_strategy)
def test_hyp_c_declarations_prototypefunctiondeclaration_functionModifier_setter(instance):
...
def test_hyp_c_declarations_variabledeclaration_numberOfPointers_setter(instance):
...
@given(instance=C_Declarations_VariableDeclaration_strategy)
def test_hyp_c_declarations_variabledeclaration_isAPointer_setter(instance):
    original = instance.isAPointer
    instance.isAPointer = original
    assert instance.isAPointer == original
...
def test_hyp_c_declarations_declaration_modifier_setter(instance):
...
def test_hyp_c_main_program_description_setter(instance):
...
def test_hyp_c_abstractions_namedelement_name_setter(instance):
...
def test_hyp_c_declarations_arraydeclaration_dimensions_setter(instance):
...
def test_hyp_c_main_function_functionModifier_setter(instance):
    original = instance.functionModifier
    instance.functionModifier = original
    assert instance.functionModifier == original
...
@given(instance=C_Main_Function_strategy)
def test_hyp_c_main_function_modifier_setter(instance):
    original = instance.modifier
    instance.modifier = original
    assert instance.modifier == original
