...
class C_Declarations_PrototypeFunctionDeclaration(Declaration):
    ...
    def __init__(self, functionModifier: str, isAPointer: str, C_Declarations_PrototypeFunctionDeclaration: set["Declarations_VariableDeclaration"] = None, C_Declarations_PrototypeFunctionDeclaration30: "Types_Type" = None):
...
class C_CompilationDirectiveDeclarations_Ifdef(Abstractions_NamedElement, CompilationDirectiveDeclarations_ComplexDirectiveDeclaration):
    ...
    pass
class C_Commands_LabelCommand(Commands_Command, Abstractions_NamedElement):

    pass
class C_Expressions_AtomicConditionalExpression(Abstractions_NamedElement, Expressions_ConditionalExpression):

    pass
class C_Expressions_FunctionCall(Abstractions_NamedElement, Expressions_Expression):

    pass
class C_CompilationDirectiveDeclarations_SimpleDirectiveDeclaration(CompilationDirectiveDeclarations_CompilationDirectiveDeclaration, Abstractions_NamedElement):
...
class Types_Type:
    ...
    pass
class C_Types_FromHeader(Types_Type, Abstractions_NamedElement):
...
class Types_PrimitiveType:
    ...
    pass
class C_Types_Int(Types_PrimitiveType, Types_Array):
...
class C_Declarations_ArrayDeclaration(Abstractions_BlockedElement, Declarations_CompositeVariableDeclaration):
    ...
    def __init__(self, dimensions: str, C_Declarations_ArrayDeclaration: "Expressions_Construction" = None, C_Declarations_ArrayDeclaration35: "Types_Type" = None, Abstractions_BlockedElement: "C_Main_Block" = None):
...
class C_Main_Function(Element):
    ...
    def __init__(self, modifier: str, functionModifier: str, C_Main_Function7: "Main_Block" = None, C_Main_Function10: set["Declarations_Declaration"] = None, C_Main_Function: "Types_Type" = None):
        self.modifier = modifier
        self.functionModifier = functionModifier
