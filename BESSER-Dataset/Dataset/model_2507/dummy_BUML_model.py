...
# Classes
dummy_C = Class(name="dummy_C")
dummy_F = Class(name="dummy_F")
E = Class(name="E")
dummy_G = Class(name="dummy_G")
dummy_A = Class(name="dummy_A")
dummy_B = Class(name="dummy_B")
dummy_D = Class(name="dummy_D")
dummy_E = Class(name="dummy_E", is_abstract=True)
...
dummy_A.attributes={dummy_A_x, dummy_A_en}
...
dummy_B.attributes={dummy_B_y, dummy_B_z}
...
dummy_D.attributes={dummy_D_l, dummy_D_name, dummy_D_m}
...
domain_model = DomainModel(
    name="dummy",
    types={dummy_C, dummy_F, E, dummy_G, dummy_A, dummy_B, dummy_D, dummy_E, EnumExample},
    associations={c5, b0, ds1, e3},
