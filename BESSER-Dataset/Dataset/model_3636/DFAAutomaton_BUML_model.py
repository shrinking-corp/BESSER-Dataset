...
DFAAutomaton_CompositeState = Class(name="DFAAutomaton_CompositeState")
...
DFAAutomaton_State.attributes={DFAAutomaton_State_name, DFAAutomaton_State_isFinal, DFAAutomaton_State_isInitial}
...
domain_model = DomainModel(
    ...
    associations={states0, transitions1, alphabet3, from_6, to9, symbol10, incoming5},
