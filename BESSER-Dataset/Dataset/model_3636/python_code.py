...
class DFAAutomaton_State:
    ...
    def __init__(self, name: str, isInitial: bool, isFinal: bool, DFAAutomaton_State: "DFAAutomaton_Automaton" = None, DFAAutomaton_State8: "DFAAutomaton_Transition" = None, State: "DFAAutomaton_Transition" = None, to: set["DFAAutomaton_Transition"] = None):
        self.name = name
