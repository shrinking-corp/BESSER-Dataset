...
class StateMachine_Transition:
    ...
    def __init__(self, action: str, trigger: str, id: int, name: str, StateMachine_Transition2: "StateMachine_State" = None, StateMachine_Transition5: "StateMachine_State" = None, StateMachine_Transition: "StateMachine_State" = None, StateMachine_Transition11: "StateMachine_WashingMachine" = None):
        self.action = action
