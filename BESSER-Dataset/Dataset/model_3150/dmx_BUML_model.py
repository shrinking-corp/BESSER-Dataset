...
# Classes
dmx_DmxBaseTypeSet = Class(name="dmx_DmxBaseTypeSet")
dmx_DmxModel = Class(name="dmx_DmxModel")
DModel = Class(name="DModel")
ITypeContainer = Class(name="ITypeContainer")
dmx_DmxFilter = Class(name="dmx_DmxFilter")
dmx_DmxTest = Class(name="dmx_DmxTest")
INavigableMemberContainer = Class(name="INavigableMemberContainer")
dmx_DmxTestContext = Class(name="dmx_DmxTestContext")
dmx_DExpression = Class(name="dmx_DExpression")
DContext = Class(name="DContext")
dmx_DmxAssignment = Class(name="dmx_DmxAssignment")
DExpression = Class(name="DExpression")
dmx_DNavigableMember = Class(name="dmx_DNavigableMember")
dmx_DmxPredicateWithCorrelationVariable = Class(name="dmx_DmxPredicateWithCorrelationVariable")
dmx_DmxArchetype = Class(name="dmx_DmxArchetype")
DPrimitive = Class(name="DPrimitive")
DNavigableMember = Class(name="DNavigableMember")
dmx_DmxFilterParameter = Class(name="dmx_DmxFilterParameter")
dmx_DmxFilterTypeDescriptor = Class(name="dmx_DmxFilterTypeDescriptor")
dmx_DmxCorrelationVariable = Class(name="dmx_DmxCorrelationVariable")
dmx_DmxMemberNavigation = Class(name="dmx_DmxMemberNavigation")
dmx_DmxCallArguments = Class(name="dmx_DmxCallArguments")
dmx_DmxFunctionCall = Class(name="dmx_DmxFunctionCall")
dmx_DmxBinaryOperation = Class(name="dmx_DmxBinaryOperation")
dmx_DmxListExpression = Class(name="dmx_DmxListExpression")
dmx_DmxStaticReference = Class(name="dmx_DmxStaticReference")
dmx_IStaticReferenceTarget = Class(name="dmx_IStaticReferenceTarget")
dmx_DmxInstanceOfExpression = Class(name="dmx_DmxInstanceOfExpression")
dmx_DType = Class(name="dmx_DType")
dmx_DmxUnaryOperation = Class(name="dmx_DmxUnaryOperation")
dmx_DmxCastExpression = Class(name="dmx_DmxCastExpression")
dmx_DmxDecimalLiteral = Class(name="dmx_DmxDecimalLiteral")
dmx_DmxDateLiteral = Class(name="dmx_DmxDateLiteral")
dmx_DmxUrlLiteral = Class(name="dmx_DmxUrlLiteral")
dmx_DmxUndefinedLiteral = Class(name="dmx_DmxUndefinedLiteral")
dmx_DmxContextReference = Class(name="dmx_DmxContextReference")
dmx_DNamedElement = Class(name="dmx_DNamedElement")
dmx_DmxIfExpression = Class(name="dmx_DmxIfExpression")
dmx_DmxBooleanLiteral = Class(name="dmx_DmxBooleanLiteral")
dmx_DmxStringLiteral = Class(name="dmx_DmxStringLiteral")
dmx_DmxNaturalLiteral = Class(name="dmx_DmxNaturalLiteral")
dmx_DmxComplexObject = Class(name="dmx_DmxComplexObject")
dmx_DComplexType = Class(name="dmx_DComplexType")
dmx_DmxField = Class(name="dmx_DmxField")
dmx_DFeature = Class(name="dmx_DFeature")
dmx_DmxEntity = Class(name="dmx_DmxEntity")
DmxComplexObject = Class(name="DmxComplexObject")
dmx_DmxDetail = Class(name="dmx_DmxDetail")
...
dmx_DmxFilterTypeDescriptor_m_isCompatible: Method = Method(name="isCompatible", parameters={Parameter(name='dmx_collection', type=StringType), Parameter(name='dmx_type', type=StringType)}, type=BooleanType)
dmx_DmxFilterTypeDescriptor_m_isCompatible: Method = Method(name="isCompatible", parameters={Parameter(name='dmx_type', type=StringType)}, type=BooleanType)
dmx_DmxFilterTypeDescriptor.attributes={dmx_DmxFilterTypeDescriptor_single, dmx_DmxFilterTypeDescriptor_multiTyped, dmx_DmxFilterTypeDescriptor_collection}
...
dmx_DmxStaticReference.attributes={dmx_DmxStaticReference_plural, dmx_DmxStaticReference_displayName}
...
dmx_DmxUrlLiteral.attributes={dmx_DmxUrlLiteral_display, dmx_DmxUrlLiteral_value}
...
if_71: BinaryAssociation = BinaryAssociation(
    name="if_71",
    ends={
...
else_76: BinaryAssociation = BinaryAssociation(
    name="else_76",
    ends={
...
domain_model = DomainModel(
    name="dmx",
    types={dmx_DmxBaseTypeSet, dmx_DmxModel, DModel, ITypeContainer, dmx_DmxFilter, dmx_DmxTest, INavigableMemberContainer, dmx_DmxTestContext, dmx_DExpression, DContext, dmx_DmxAssignment, DExpression, dmx_DNavigableMember, dmx_DmxPredicateWithCorrelationVariable, dmx_DmxArchetype, DPrimitive, DNavigableMember, dmx_DmxFilterParameter, dmx_DmxFilterTypeDescriptor, dmx_DmxCorrelationVariable, dmx_DmxMemberNavigation, dmx_DmxCallArguments, dmx_DmxFunctionCall, dmx_DmxBinaryOperation, dmx_DmxListExpression, dmx_DmxStaticReference, dmx_IStaticReferenceTarget, dmx_DmxInstanceOfExpression, dmx_DType, dmx_DmxUnaryOperation, dmx_DmxCastExpression, dmx_DmxDecimalLiteral, dmx_DmxDateLiteral, dmx_DmxUrlLiteral, dmx_DmxUndefinedLiteral, dmx_DmxContextReference, dmx_DNamedElement, dmx_DmxIfExpression, dmx_DmxBooleanLiteral, dmx_DmxStringLiteral, dmx_DmxNaturalLiteral, dmx_DmxComplexObject, dmx_DComplexType, dmx_DmxField, dmx_DFeature, dmx_DmxEntity, DmxComplexObject, dmx_DmxDetail, DmxBaseType, DmxBinaryOperator, DmxUnaryOperator},
    associations={filters0, tests1, context3, expr5, value7, typeDesc19, precedingNavigationSegment22, assignToMember24, value26, parameters10, typeDesc12, withTypeSet14, multiple16, leftOperand48, rightOperand50, correlationVariable29, predicate30, member33, precedingNavigationSegment35, callArguments38, arguments40, function43, callArguments45, type61, elements64, target66, member67, expression53, type55, operand57, target59, target70, if_71, then73, else_76, type79, fields80, feature82, value84},
    generalizations={gen_dmx_DmxModel_DModel, gen_dmx_DmxModel_ITypeContainer, gen_dmx_DmxTest_INavigableMemberContainer, gen_dmx_DmxTestContext_DContext, gen_dmx_DmxAssignment_DExpression, gen_dmx_DmxPredicateWithCorrelationVariable_DExpression, gen_dmx_DmxArchetype_DPrimitive, gen_dmx_DmxFilter_DNavigableMember, gen_dmx_DmxPredicateWithCorrelationVariable_INavigableMemberContainer, gen_dmx_DmxCorrelationVariable_DNavigableMember, gen_dmx_DmxMemberNavigation_DExpression, gen_dmx_DmxFunctionCall_DExpression, gen_dmx_DmxBinaryOperation_DExpression, gen_dmx_DmxListExpression_DExpression, gen_dmx_DmxStaticReference_DExpression, gen_dmx_DmxInstanceOfExpression_DExpression, gen_dmx_DmxUnaryOperation_DExpression, gen_dmx_DmxCastExpression_DExpression, gen_dmx_DmxDecimalLiteral_DExpression, gen_dmx_DmxDateLiteral_DExpression, gen_dmx_DmxUrlLiteral_DExpression, gen_dmx_DmxUndefinedLiteral_DExpression, gen_dmx_DmxContextReference_DExpression, gen_dmx_DmxIfExpression_DExpression, gen_dmx_DmxBooleanLiteral_DExpression, gen_dmx_DmxStringLiteral_DExpression, gen_dmx_DmxNaturalLiteral_DExpression, gen_dmx_DmxComplexObject_INavigableMemberContainer, gen_dmx_DmxComplexObject_DExpression, gen_dmx_DmxField_DNavigableMember, gen_dmx_DmxEntity_DmxComplexObject, gen_dmx_DmxDetail_DmxComplexObject},
    metadata=None
)
