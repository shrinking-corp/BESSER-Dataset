...
class dmx_DmxFilterTypeDescriptor:
    ...
    def __init__(self, single: str, collection: bool, multiTyped: bool, dmx_DmxFilterTypeDescriptor21: "dmx_DmxFilterParameter" = None, dmx_DmxFilterTypeDescriptor: "dmx_DmxFilter" = None, dmx_DmxFilterTypeDescriptor17: "dmx_DmxBaseTypeSet" = None):
        self.single = single
    ...
    def isCompatible(self, dmx_type) :
        # TODO: Implement isCompatible method
        pass

class dmx_DmxFilterParameter:

    def __init__(self, name: str, dmx_DmxFilterParameter20: "dmx_DmxFilterTypeDescriptor" = None, dmx_DmxFilterParameter: "dmx_DmxFilter" = None):
        self.name = name
...
class dmx_DmxStaticReference(DExpression):
    ...
    def __init__(self, displayName: str, plural: bool, dmx_DmxStaticReference: "dmx_IStaticReferenceTarget" = None, dmx_DmxStaticReference68: "dmx_DNavigableMember" = None):
...
class INavigableMemberContainer:
    ...
    pass
class dmx_DmxComplexObject(DExpression, INavigableMemberContainer):

    pass
class dmx_DmxPredicateWithCorrelationVariable(DExpression, INavigableMemberContainer):
