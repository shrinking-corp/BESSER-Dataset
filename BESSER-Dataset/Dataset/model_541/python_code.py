...
class family_Mother:
    ...
    def __init__(self, Name: str, Age: int, family_Mother6: "family_FatherInLove" = None, family_Mother: "family_Father" = None):
        self.Name = Name
        self.Age = Age
...
class family_FatherInLove:
    ...
    def __init__(self, Name: str, Age: int, family_FatherInLove: "family_Mother" = None):
        self.Name = Name
        self.Age = Age
...
class family_Father:
    ...
    def __init__(self, Name: str, Age: int, family_Father2: "family_Son" = None, family_Father4: "family_Daughter" = None, family_Father8: "family_Family" = None, family_Father: "family_Mother" = None):
        self.Name = Name
        self.Age = Age
