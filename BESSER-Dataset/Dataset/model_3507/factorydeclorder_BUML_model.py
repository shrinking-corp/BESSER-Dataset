...
# Classes
factorydeclorder_C = Class(name="factorydeclorder_C")
B = Class(name="B")
A = Class(name="A")
factorydeclorder_A = Class(name="factorydeclorder_A")
D = Class(name="D")
factorydeclorder_B = Class(name="factorydeclorder_B")
factorydeclorder_D = Class(name="factorydeclorder_D")
