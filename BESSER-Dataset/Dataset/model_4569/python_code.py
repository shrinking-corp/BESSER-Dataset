...
class iotdsl_Delay:
    ...
    def __init__(self, unit: str, time: int, iotdsl_Delay: "iotdsl_WithinExpression" = None):
        self.unit = unit
        self.time = time
...
class iotdsl_CommunicationPath:
    ...
    def __init__(self, protocol: str, iotdsl_CommunicationPath19: "iotdsl_NodeInstance" = None, iotdsl_CommunicationPath: "iotdsl_Configuration" = None, iotdsl_CommunicationPath16: "iotdsl_NodeInstance" = None):
...
class iotdsl_NodeInstance:
    ...
    def __init__(self, name: str, iotdsl_NodeInstance20: "iotdsl_CommunicationPath" = None, iotdsl_NodeInstance: "iotdsl_Configuration" = None, iotdsl_NodeInstance27: "iotdsl_EventOccurrence" = None, iotdsl_NodeInstance13: "iotdsl_Type" = None, iotdsl_NodeInstance17: "iotdsl_CommunicationPath" = None, iotdsl_NodeInstance37: "iotdsl_Reaction" = None):
        self.name = name
