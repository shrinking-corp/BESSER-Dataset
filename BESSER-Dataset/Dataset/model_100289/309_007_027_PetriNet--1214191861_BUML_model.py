...
domain_model = DomainModel(
    name="PetriNet",
    types={PetriNet_Node, PetriNet_Arc, PetriNet_PetriNet, PetriNet_Place, PetriNet_Transition, Node, ArcKind},
    associations={nodes0, arcs1, outgoings4, incomings6, net3, net12, target8, source10},
