...
public class aadl2_SubprogramType extends CallContext, ComponentType, SubprogramClassifier {
    ...
    public aadl2_SubprogramType(
        ArrayList<aadl2_DataAccess> aadl2_dataaccesss,        ArrayList<aadl2_SubprogramAccess> aadl2_subprogramaccesss,        ArrayList<aadl2_Parameter> aadl2_parameters,        ArrayList<aadl2_EventDataPort> aadl2_eventdataports    ) {
