...
public class aadl2_ComponentImplementation extends ComponentClassifier {
    ...
    public aadl2_ComponentImplementation(
        String noConnections,        String noSubcomponents,        String noCalls        ArrayList<aadl2_InternalFeature> aadl2_internalfeatures,        ArrayList<aadl2_Subcomponent> aadl2_subcomponents,        ArrayList<aadl2_SubprogramProxy> aadl2_subprogramproxys,        ArrayList<aadl2_ProcessorFeature> aadl2_processorfeatures,        ArrayList<aadl2_FlowImplementation> aadl2_flowimplementations,        ArrayList<aadl2_EndToEndFlow> aadl2_endtoendflows,        ArrayList<aadl2_Connection> aadl2_connections    ) {
        this.noConnections = noConnections;
        this.noSubcomponents = noSubcomponents;
        this.noCalls = noCalls;
