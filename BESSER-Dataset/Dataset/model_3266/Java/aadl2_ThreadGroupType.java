...
public class aadl2_ThreadGroupType extends ComponentType, ThreadGroupClassifier {
    ...
    public aadl2_ThreadGroupType(
        ArrayList<aadl2_DataPort> aadl2_dataports,        ArrayList<aadl2_EventPort> aadl2_eventports,        ArrayList<aadl2_EventDataPort> aadl2_eventdataports,        ArrayList<aadl2_SubprogramGroupAccess> aadl2_subprogramgroupaccesss,        ArrayList<aadl2_DataAccess> aadl2_dataaccesss,        ArrayList<aadl2_SubprogramAccess> aadl2_subprogramaccesss    ) {
