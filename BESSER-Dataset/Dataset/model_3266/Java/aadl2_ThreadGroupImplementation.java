...
public class aadl2_ThreadGroupImplementation extends ThreadGroupClassifier, ComponentImplementation {
    ...
    public aadl2_ThreadGroupImplementation(
        ArrayList<aadl2_DataSubcomponent> aadl2_datasubcomponents,        ArrayList<aadl2_ThreadSubcomponent> aadl2_threadsubcomponents,        ArrayList<aadl2_SubprogramGroupSubcomponent> aadl2_subprogramgroupsubcomponents,        ArrayList<aadl2_SubprogramSubcomponent> aadl2_subprogramsubcomponents,        ArrayList<aadl2_ThreadGroupSubcomponent> aadl2_threadgroupsubcomponents    ) {
