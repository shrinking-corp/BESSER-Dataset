...
public class aadl2_PropertySet extends ModelUnit, Namespace {
    ...
    public aadl2_PropertySet(
        ArrayList<aadl2_ModelUnit> aadl2_modelunits,        ArrayList<aadl2_PropertyConstant> aadl2_propertyconstants,        ArrayList<aadl2_Property> aadl2_propertys,        ArrayList<aadl2_PropertyType> aadl2_propertytypes    ) {
