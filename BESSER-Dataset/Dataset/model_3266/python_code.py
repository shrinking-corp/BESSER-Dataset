...
class aadl2_UnitLiteral(EnumerationLiteral):
    ...
    def __init__(self, aadl2_UnitLiteral818: "aadl2_UnitLiteral" = None, aadl2_UnitLiteral820: "aadl2_UnitLiteral" = None, aadl2_UnitLiteral822: "aadl2_NumberValue" = None, aadl2_UnitLiteral: "aadl2_NumberValue" = None):
    ...
    def getAbsoluteFactor(self, aadl2_target) :
...
class aadl2_NumberValue(PropertyValue):
    ...
    def getScaledValue(self, aadl2_target) :
...
class ThreadSubcomponentType:
    ...
    pass
class aadl2_ThreadPrototype(ThreadSubcomponentType, ComponentPrototype, Thread):
...
class ProcessSubcomponentType:
    ...
    pass
class aadl2_ProcessPrototype(ProcessSubcomponentType, ComponentPrototype, Process):

    pass
class ProcessorSubcomponentType:

    pass
class aadl2_ProcessorPrototype(Processor, ComponentPrototype, ProcessorSubcomponentType):
...
class DeviceSubcomponentType:
    ...
    pass
class aadl2_DevicePrototype(Device, ComponentPrototype, DeviceSubcomponentType):

    pass
class BusSubcomponentType:

    pass
class aadl2_BusPrototype(Bus, ComponentPrototype, BusSubcomponentType):
...
class aadl2_BehavioredImplementation(ComponentImplementation):
    ...
    def __init__(self, aadl2_BehavioredImplementation421: set["aadl2_SubprogramCallSequence"] = None, aadl2_BehavioredImplementation: set["aadl2_SubprogramCall"] = None):
...
class aadl2_PortSpecification(FeaturePrototypeActual):
    ...
    def __init__(self, direction: str, category: str, out: str, in_: str, aadl2_PortSpecification: "aadl2_ComponentClassifier" = None, aadl2_PortSpecification409: "aadl2_ComponentPrototype" = None):
...
class aadl2_FeaturePrototypeReference(FeaturePrototypeActual):
    ...
    def __init__(self, direction: str, in_: str, out: str, aadl2_FeaturePrototypeReference: "aadl2_FeaturePrototype" = None):
        self.direction = direction
        self.in_ = in_
        self.out = out
...
class Subprogram:
    ...
    pass
class aadl2_SubprogramPrototype(Subprogram, SubprogramSubcomponentType, ComponentPrototype):
...
class Data:
    ...
    pass
class aadl2_DataPrototype(Data, ComponentPrototype, DataSubcomponentType):

    pass
class Abstract:

    pass
class aadl2_AbstractPrototype(SubprogramGroupSubcomponentType, VirtualProcessorSubcomponentType, ComponentPrototype, BusSubcomponentType, ProcessorSubcomponentType, ProcessSubcomponentType, DataSubcomponentType, MemorySubcomponentType, VirtualBusSubcomponentType, ThreadGroupSubcomponentType, AbstractSubcomponentType, SystemSubcomponentType, Abstract, ThreadSubcomponentType, SubprogramSubcomponentType, DeviceSubcomponentType):
...
class aadl2_FeaturePrototype(Prototype):
    ...
    def __init__(self, direction: str, in_: str, out: str, aadl2_FeaturePrototype263: "aadl2_ComponentClassifier" = None, aadl2_FeaturePrototype: "aadl2_AbstractFeature" = None, aadl2_FeaturePrototype412: "aadl2_FeaturePrototypeReference" = None):
        self.direction = direction
        self.in_ = in_
        self.out = out
...
class aadl2_ComponentPrototypeActual(ArrayableElement):
    ...
    def __init__(self, category: str, aadl2_ComponentPrototypeActual388: set["aadl2_PrototypeBinding"] = None, aadl2_ComponentPrototypeActual391: "aadl2_SubcomponentType" = None, aadl2_ComponentPrototypeActual: "aadl2_ComponentPrototypeBinding" = None):
        self.category = category
...
class aadl2_SystemSubcomponentType(SubcomponentType):
    ...
    pass
class aadl2_BusSubcomponentType(SubcomponentType, BusFeatureClassifier, AbstractFeatureClassifier):

    pass
class aadl2_SubprogramGroupSubcomponentType(SubcomponentType, AbstractFeatureClassifier):

    pass
class aadl2_ProcessorSubcomponentType(SubcomponentType):

    pass
class aadl2_VirtualBusSubcomponentType(SubcomponentType, BusFeatureClassifier, AbstractFeatureClassifier):

    pass
class aadl2_SubprogramSubcomponentType(SubcomponentType, AbstractFeatureClassifier):

    pass
class aadl2_DataSubcomponentType(SubcomponentType, AbstractFeatureClassifier):
...
class aadl2_ThreadSubcomponentType(SubcomponentType):
    ...
    pass
class aadl2_AbstractSubcomponentType(SubcomponentType, AbstractFeatureClassifier):
...
class aadl2_PortProxy(FeatureConnectionEnd, TriggerPort, PortConnectionEnd, ProcessorFeature):

    def __init__(self, direction: str, in_: str, out: str, aadl2_PortProxy: "aadl2_ComponentImplementation" = None, aadl2_PortProxy346: "aadl2_DataClassifier" = None):
        self.direction = direction
        self.in_ = in_
        self.out = out
...
class aadl2_VirtualBusClassifier(VirtualBusSubcomponentType, VirtualBus, ComponentClassifier):
    ...
    pass
class aadl2_ProcessorClassifier(Processor, ComponentClassifier, ProcessorSubcomponentType):

    pass
class aadl2_SystemClassifier(ComponentClassifier, System, SystemSubcomponentType):

    pass
class aadl2_MemoryClassifier(MemorySubcomponentType, Memory, ComponentClassifier):

    pass
class aadl2_BusClassifier(Bus, ComponentClassifier, BusSubcomponentType):

    pass
class aadl2_ThreadClassifier(ThreadSubcomponentType, ComponentClassifier, Thread):

    pass
class aadl2_SubprogramClassifier(Subprogram, SubprogramSubcomponentType, ComponentClassifier):

    pass
class aadl2_DeviceClassifier(Device, ComponentClassifier, DeviceSubcomponentType):

    pass
class aadl2_SubprogramGroupClassifier(SubprogramGroupSubcomponentType, ComponentClassifier, SubprogramGroup):

    pass
class aadl2_ThreadGroupClassifier(ThreadGroupSubcomponentType, ComponentClassifier, ThreadGroup):

    pass
class aadl2_ProcessClassifier(ComponentClassifier, ProcessSubcomponentType, Process):

    pass
class aadl2_DataClassifier(Data, ComponentClassifier, DataSubcomponentType):

    pass
class aadl2_AbstractClassifier(SubprogramGroupSubcomponentType, VirtualProcessorSubcomponentType, BusSubcomponentType, ProcessorSubcomponentType, ProcessSubcomponentType, DataSubcomponentType, AbstractSubcomponentType, VirtualBusSubcomponentType, MemorySubcomponentType, ThreadGroupSubcomponentType, ComponentClassifier, SystemSubcomponentType, Abstract, ThreadSubcomponentType, SubprogramSubcomponentType, DeviceSubcomponentType):
...
class aadl2_ComponentImplementation(ComponentClassifier):
    ...
    def __init__(self, noSubcomponents: str, noConnections: str, noCalls: str, aadl2_ComponentImplementation: "aadl2_ComponentImplementationReference" = None, aadl2_ComponentImplementation99: "aadl2_ComponentType" = None, aadl2_ComponentImplementation101: set["aadl2_Subcomponent"] = None, aadl2_ComponentImplementation104: "aadl2_ComponentImplementation" = None, aadl2_ComponentImplementation102: "aadl2_ComponentImplementation" = None, aadl2_ComponentImplementation116: set["aadl2_AbstractSubcomponent"] = None, aadl2_ComponentImplementation118: set["aadl2_AccessConnection"] = None, aadl2_ComponentImplementation120: set["aadl2_ParameterConnection"] = None, aadl2_ComponentImplementation122: set["aadl2_PortConnection"] = None, aadl2_ComponentImplementation124: set["aadl2_FeatureConnection"] = None, aadl2_ComponentImplementation106: set["aadl2_FlowImplementation"] = None, aadl2_ComponentImplementation108: set["aadl2_Connection"] = None, aadl2_ComponentImplementation110: "aadl2_ImplementationExtension" = None, aadl2_ComponentImplementation112: "aadl2_Realization" = None, aadl2_ComponentImplementation114: set["aadl2_EndToEndFlow"] = None, aadl2_ComponentImplementation132: set["aadl2_EventSource"] = None, aadl2_ComponentImplementation134: set["aadl2_EventDataSource"] = None, aadl2_ComponentImplementation136: set["aadl2_PortProxy"] = None, aadl2_ComponentImplementation138: set["aadl2_SubprogramProxy"] = None, aadl2_ComponentImplementation126: set["aadl2_FeatureGroupConnection"] = None, aadl2_ComponentImplementation128: set["aadl2_ProcessorFeature"] = None, aadl2_ComponentImplementation130: set["aadl2_InternalFeature"] = None, aadl2_ComponentImplementation327: "aadl2_ImplementationExtension" = None):
...
class CalledSubprogram:
    ...
    pass
class aadl2_SubprogramProxy(AccessConnectionEnd, CalledSubprogram, ProcessorFeature):
...
class aadl2_Feature(FeatureConnectionEnd, StructuralFeature, ArrayableElement):
    ...
    pass
class aadl2_InternalFeature(TriggerPort, StructuralFeature, PortConnectionEnd, FeatureConnectionEnd):

    def __init__(self, direction: str, in_: str, out: str, aadl2_InternalFeature: "aadl2_ComponentImplementation" = None):
        self.direction = direction
        self.in_ = in_
        self.out = out
...
class aadl2_Mode(ModeFeature):
    ...
    def __init__(self, initial: str, derived: str, aadl2_Mode: "aadl2_ModalElement" = None, aadl2_Mode145: "aadl2_ModeTransition" = None, aadl2_Mode148: "aadl2_ModeTransition" = None, aadl2_Mode140: "aadl2_ComponentClassifier" = None, aadl2_Mode289: "aadl2_ModeBinding" = None, aadl2_Mode292: "aadl2_ModeBinding" = None):
...
class aadl2_ModalPath(ModalElement):
    ...
    def getAllInModeTransitions(self) :
        # TODO: Implement getAllInModeTransitions method
        pass

    def getInModeTransitions(self) :
...
class aadl2_PackageSection(Namespace):
    ...
    def __init__(self, noAnnexes: str, noProperties: str, aadl2_PackageSection356: set["aadl2_ComponentTypeRename"] = None, aadl2_PackageSection358: set["aadl2_Classifier"] = None, aadl2_PackageSection361: set["aadl2_FeatureGroupTypeRename"] = None, aadl2_PackageSection363: set["aadl2_AnnexLibrary"] = None, aadl2_PackageSection366: set["aadl2_ModelUnit"] = None, aadl2_PackageSection: set["aadl2_PackageRename"] = None):
...
class aadl2_Classifier(Namespace, Type):
    ...
    def __init__(self, noAnnexes: str, noProperties: str, noPrototypes: str, aadl2_Classifier19: "aadl2_Property" = None, aadl2_Classifier: "aadl2_PropertyAssociation" = None, featuringClassifier: set["aadl2_ClassifierFeature"] = None, aadl2_Classifier32: set["aadl2_NamedElement"] = None, Classifier: "aadl2_ClassifierFeature" = None, specific: set["aadl2_Generalization_"] = None, aadl2_Classifier37: "aadl2_Classifier" = None, aadl2_Classifier35: set["aadl2_Classifier"] = None, aadl2_Classifier39: set["aadl2_AnnexSubclause"] = None, aadl2_Classifier41: set["aadl2_Prototype"] = None, aadl2_Classifier43: set["aadl2_PrototypeBinding"] = None, aadl2_Classifier51: "aadl2_Generalization_" = None, Classifier53: "aadl2_Generalization_" = None, aadl2_Classifier66: "aadl2_RefinableElement" = None, aadl2_Classifier177: "aadl2_Feature" = None, aadl2_Classifier359: "aadl2_PackageSection" = None, aadl2_Classifier825: "aadl2_ClassifierValue" = None):
        self.noAnnexes = noAnnexes
        self.noProperties = noProperties
...
class aadl2_Type(NamedElement):
    ...
    pass
class aadl2_Property(AbstractNamedValue, BasicProperty):

    def __init__(self, emptyListDefault: str, inherit: str, aadl2_Property: "aadl2_PropertyAssociation" = None, aadl2_Property18: set["aadl2_Classifier"] = None, aadl2_Property21: set["aadl2_PropertyOwner"] = None, aadl2_Property14: "aadl2_PropertyExpression" = None, aadl2_Property16: set["aadl2_MetaclassReference"] = None, aadl2_Property845: "aadl2_PropertySet" = None):
...
class aadl2_NamedElement(Element):
    ...
    def __init__(self, qualifiedName: str, name: str, aadl2_NamedElement: set["aadl2_PropertyAssociation"] = None, aadl2_NamedElement33: "aadl2_Classifier" = None, aadl2_NamedElement45: "aadl2_Namespace" = None, aadl2_NamedElement48: "aadl2_Namespace" = None, aadl2_NamedElement82: "aadl2_ContainmentPathElement" = None):
    ...
    def getPropertyValues(self, aadl2_propertyName, aadl2_propertySetName) :
...
class aadl2_DirectedFeature(Feature):
    ...
    def __init__(self, direction: str, in_: str, out: str):
        self.direction = direction
        self.in_ = in_
        self.out = out
...
class CallContext:
    ...
    pass
class aadl2_AbstractType(CallContext, ComponentType, AbstractClassifier):

    pass
class aadl2_DataType(CallContext, ComponentType, DataClassifier):

    pass
class aadl2_SubprogramGroupSubcomponent(Subcomponent, AccessConnectionEnd, CallContext, SubprogramGroup):
...
class Context:
    ...
    pass
class aadl2_SubprogramAccess(Context, Access, CalledSubprogram):

    pass
class aadl2_SubprogramCall(BehavioralFeature, Context):

    pass
class aadl2_EventDataPort(Context, Port, ParameterConnectionEnd):

    pass
class aadl2_DataPort(Context, Port, ParameterConnectionEnd):
...
class aadl2_Parameter(Context, ParameterConnectionEnd, DirectedFeature):
...
class FlowElement:
    ...
    pass
class aadl2_Subcomponent(Context, StructuralFeature, ArrayableElement, ModalElement, FlowElement):

    def __init__(self, allModes: str, aadl2_Subcomponent: "aadl2_ComponentImplementation" = None, aadl2_Subcomponent279: set["aadl2_ComponentImplementationReference"] = None, aadl2_Subcomponent283: "aadl2_Subcomponent" = None, aadl2_Subcomponent281: "aadl2_Subcomponent" = None, aadl2_Subcomponent285: "aadl2_ComponentClassifier" = None, aadl2_Subcomponent269: "aadl2_SubcomponentType" = None, aadl2_Subcomponent271: set["aadl2_PrototypeBinding"] = None, aadl2_Subcomponent274: "aadl2_ComponentPrototype" = None, aadl2_Subcomponent277: set["aadl2_ModeBinding"] = None):
...
class aadl2_FlowImplementation(ClassifierFeature, Flow, ModalPath):

    def __init__(self, kind: str, aadl2_FlowImplementation: "aadl2_ComponentImplementation" = None, aadl2_FlowImplementation302: "aadl2_FlowEnd" = None, aadl2_FlowImplementation294: "aadl2_FlowSpecification" = None, aadl2_FlowImplementation297: set["aadl2_FlowSegment"] = None, aadl2_FlowImplementation299: "aadl2_FlowEnd" = None):
        self.kind = kind
...
class aadl2_FlowSpecification(FlowElement, FlowFeature, ModalPath):
    ...
    def __init__(self, kind: str, aadl2_FlowSpecification: "aadl2_ComponentType" = None, aadl2_FlowSpecification185: "aadl2_FlowEnd" = None, aadl2_FlowSpecification187: "aadl2_FlowEnd" = None, aadl2_FlowSpecification183: "aadl2_FlowSpecification" = None, aadl2_FlowSpecification181: "aadl2_FlowSpecification" = None, aadl2_FlowSpecification295: "aadl2_FlowImplementation" = None):
        self.kind = kind
