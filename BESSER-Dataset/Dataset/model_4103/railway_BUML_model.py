...
domain_model = DomainModel(
    name="railway",
    types={railway_RailwayElement, railway_RailwayContainer, railway_Route, railway_Region, RailwayElement, railway_Sensor, railway_TrackElement, railway_SwitchPosition, railway_Segment, TrackElement, railway_Switch, railway_Semaphore, Position, Signal},
    associations={routes0, regions1, sensors3, elements5, follows7, exit13, monitors16, monitoredBy17, connectsTo19, semaphores21, positions23, route25, target26, requires8, entry11},
