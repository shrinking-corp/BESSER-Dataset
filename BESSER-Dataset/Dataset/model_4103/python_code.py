...
class railway_Semaphore(RailwayElement):
    ...
    def __init__(self, signal: str, railway_Semaphore15: "railway_Route" = None, railway_Semaphore22: "railway_Segment" = None, railway_Semaphore: "railway_Route" = None):
        self.signal = signal
...
class railway_Route(RailwayElement):
    ...
    def __init__(self, active: bool, route: set["railway_SwitchPosition"] = None, railway_Route14: "railway_Semaphore" = None, Route: "railway_SwitchPosition" = None, railway_Route9: set["railway_Sensor"] = None, railway_Route12: "railway_Semaphore" = None, railway_Route: "railway_RailwayContainer" = None):
        self.active = active
