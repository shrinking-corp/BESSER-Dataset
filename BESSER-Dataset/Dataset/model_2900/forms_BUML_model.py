...
forms_Type = Class(name="forms_Type", is_abstract=True)
NamedElement = Class(name="NamedElement")
forms_DataType = Class(name="forms_DataType")
Type = Class(name="Type")
forms_Entity = Class(name="forms_Entity")
forms_Feature = Class(name="forms_Feature")
...
domain_model = DomainModel(
    name="forms",
    types={forms_NamedElement, forms_Type, NamedElement, forms_DataType, Type, forms_Entity, forms_Feature, forms_EntityModel, FeatureKind},
    associations={features0, types1, type2},
    generalizations={gen_forms_Type_NamedElement, gen_forms_DataType_Type, gen_forms_Entity_Type, gen_forms_Feature_NamedElement},
    metadata=None
)
