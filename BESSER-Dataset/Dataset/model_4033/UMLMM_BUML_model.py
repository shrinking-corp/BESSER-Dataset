...
# Classes
UMLMM_Package = Class(name="UMLMM_Package")
...
UMLMM_PackageableElement = Class(name="UMLMM_PackageableElement", is_abstract=True)
UMLMM_Interface = Class(name="UMLMM_Interface")
Classifier = Class(name="Classifier")
UMLMM_Model = Class(name="UMLMM_Model")
Package = Class(name="Package")
UMLMM_Class = Class(name="UMLMM_Class")
EncapsulatedClassifier = Class(name="EncapsulatedClassifier")
BehavioredClassifier = Class(name="BehavioredClassifier")
UMLMM_Operation = Class(name="UMLMM_Operation")
UMLMM_Generalization = Class(name="UMLMM_Generalization")
DirectedRelationship = Class(name="DirectedRelationship")
UMLMM_Classifier = Class(name="UMLMM_Classifier", is_abstract=True)
UMLMM_BehavioredClassifier = Class(name="UMLMM_BehavioredClassifier", is_abstract=True)
UMLMM_InterfaceRealization = Class(name="UMLMM_InterfaceRealization")
Realization = Class(name="Realization")
NamedElement = Class(name="NamedElement")
ParameterableElement = Class(name="ParameterableElement")
UMLMM_NamedElement = Class(name="UMLMM_NamedElement", is_abstract=True)
Element = Class(name="Element")
BehavioralFeature = Class(name="BehavioralFeature")
UMLMM_Element = Class(name="UMLMM_Element", is_abstract=True)
EModelElement = Class(name="EModelElement")
UMLMM_EModelElement = Class(name="UMLMM_EModelElement", is_abstract=True)
UMLMM_ParameterableElement = Class(name="UMLMM_ParameterableElement", is_abstract=True)
UMLMM_Namespace = Class(name="UMLMM_Namespace", is_abstract=True)
UMLMM_TemplateableElement = Class(name="UMLMM_TemplateableElement", is_abstract=True)
UMLMM_RedefinableElement = Class(name="UMLMM_RedefinableElement", is_abstract=True)
UMLMM_Type = Class(name="UMLMM_Type", is_abstract=True)
UMLMM_BehavioralFeature = Class(name="UMLMM_BehavioralFeature", is_abstract=True)
Feature = Class(name="Feature")
UMLMM_Feature = Class(name="UMLMM_Feature", is_abstract=True)
UMLMM_Realization = Class(name="UMLMM_Realization")
Abstraction = Class(name="Abstraction")
UMLMM_Abstraction = Class(name="UMLMM_Abstraction")
Dependency = Class(name="Dependency")
UMLMM_Dependency = Class(name="UMLMM_Dependency")
UMLMM_DirectedRelationship = Class(name="UMLMM_DirectedRelationship", is_abstract=True)
Relationship = Class(name="Relationship")
UMLMM_Relationship = Class(name="UMLMM_Relationship", is_abstract=True)
UMLMM_StructuralFeature = Class(name="UMLMM_StructuralFeature", is_abstract=True)
TypedElement = Class(name="TypedElement")
MultiplicityElement = Class(name="MultiplicityElement")
UMLMM_TypedElement = Class(name="UMLMM_TypedElement", is_abstract=True)
UMLMM_MultiplicityElement = Class(name="UMLMM_MultiplicityElement", is_abstract=True)
UMLMM_ConnectableElement = Class(name="UMLMM_ConnectableElement", is_abstract=True)
UMLMM_DeploymentTarget = Class(name="UMLMM_DeploymentTarget", is_abstract=True)
UMLMM_StructuredClassifier = Class(name="UMLMM_StructuredClassifier", is_abstract=True)
UMLMM_Property = Class(name="UMLMM_Property")
...
UMLMM_EncapsulatedClassifier = Class(name="UMLMM_EncapsulatedClassifier", is_abstract=True)
...
domain_model = DomainModel(
    name="UMLMM",
    types={UMLMM_Package, Namespace, PackageableElement, TemplateableElement, UMLMM_PackageableElement, UMLMM_Interface, Classifier, UMLMM_Model, Package, UMLMM_Class, EncapsulatedClassifier, BehavioredClassifier, UMLMM_Operation, UMLMM_Generalization, DirectedRelationship, UMLMM_Classifier, UMLMM_BehavioredClassifier, UMLMM_InterfaceRealization, Realization, NamedElement, ParameterableElement, UMLMM_NamedElement, Element, BehavioralFeature, UMLMM_Element, EModelElement, UMLMM_EModelElement, UMLMM_ParameterableElement, UMLMM_Namespace, UMLMM_TemplateableElement, UMLMM_RedefinableElement, UMLMM_Type, UMLMM_BehavioralFeature, Feature, UMLMM_Feature, UMLMM_Realization, Abstraction, UMLMM_Abstraction, Dependency, UMLMM_Dependency, UMLMM_DirectedRelationship, Relationship, UMLMM_Relationship, UMLMM_StructuralFeature, TypedElement, MultiplicityElement, UMLMM_TypedElement, UMLMM_MultiplicityElement, UMLMM_ConnectableElement, UMLMM_DeploymentTarget, UMLMM_StructuredClassifier, UMLMM_Property, StructuralFeature, ConnectableElement, DeploymentTarget, RedefinableElement, Type, UMLMM_EncapsulatedClassifier, StructuredClassifier},
    associations={packagedElement0, ownedOperation1, general2, interfaceRealization7, ownedAttribute3, generalization4},
    generalizations={gen_UMLMM_Package_Namespace, gen_UMLMM_Package_PackageableElement, gen_UMLMM_Package_TemplateableElement, gen_UMLMM_Interface_Classifier, gen_UMLMM_Model_Package, gen_UMLMM_Class_EncapsulatedClassifier, gen_UMLMM_Class_BehavioredClassifier, gen_UMLMM_Generalization_DirectedRelationship, gen_UMLMM_BehavioredClassifier_Classifier, gen_UMLMM_InterfaceRealization_Realization, gen_UMLMM_PackageableElement_NamedElement, gen_UMLMM_PackageableElement_ParameterableElement, gen_UMLMM_NamedElement_Element, gen_UMLMM_Operation_BehavioralFeature, gen_UMLMM_Operation_ParameterableElement, gen_UMLMM_Operation_TemplateableElement, gen_UMLMM_Element_EModelElement, gen_UMLMM_ParameterableElement_Element, gen_UMLMM_Namespace_NamedElement, gen_UMLMM_TemplateableElement_Element, gen_UMLMM_RedefinableElement_NamedElement, gen_UMLMM_Type_PackageableElement, gen_UMLMM_BehavioralFeature_Namespace, gen_UMLMM_BehavioralFeature_Feature, gen_UMLMM_Feature_RedefinableElement, gen_UMLMM_Realization_Abstraction, gen_UMLMM_Abstraction_Dependency, gen_UMLMM_Dependency_PackageableElement, gen_UMLMM_Dependency_DirectedRelationship, gen_UMLMM_DirectedRelationship_Relationship, gen_UMLMM_Relationship_Element, gen_UMLMM_StructuralFeature_Feature, gen_UMLMM_StructuralFeature_TypedElement, gen_UMLMM_StructuralFeature_MultiplicityElement, gen_UMLMM_TypedElement_NamedElement, gen_UMLMM_MultiplicityElement_Element, gen_UMLMM_ConnectableElement_TypedElement, gen_UMLMM_ConnectableElement_ParameterableElement, gen_UMLMM_StructuredClassifier_Classifier, gen_UMLMM_Property_StructuralFeature, gen_UMLMM_Property_ConnectableElement, gen_UMLMM_Property_DeploymentTarget, gen_UMLMM_Classifier_Namespace, gen_UMLMM_Classifier_RedefinableElement, gen_UMLMM_Classifier_Type, gen_UMLMM_Classifier_TemplateableElement, gen_UMLMM_DeploymentTarget_NamedElement, gen_UMLMM_EncapsulatedClassifier_StructuredClassifier},
    metadata=None
)
