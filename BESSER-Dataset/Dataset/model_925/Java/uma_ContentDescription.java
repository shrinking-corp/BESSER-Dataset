...
public class uma_ContentDescription extends MethodUnit {
    ...
    public uma_ContentDescription(
        String mainDescription,        String keyConsiderations,        String externalId,        String longPresentationName    ) {
        super(
        );
    ...
    public uma_ContentDescription(
        String mainDescription,        String keyConsiderations,        String externalId,        String longPresentationName        ArrayList<uma_Section> uma_sections    ) {
        this.mainDescription = mainDescription;
        this.keyConsiderations = keyConsiderations;
        this.externalId = externalId;
        this.longPresentationName = longPresentationName;
