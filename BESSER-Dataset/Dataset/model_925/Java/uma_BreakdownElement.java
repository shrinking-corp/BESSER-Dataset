...
public class uma_BreakdownElement extends ProcessElement {
    ...
    public uma_BreakdownElement(
        String isPlanned,        String prefix,        String hasMultipleOccurrences,        String isOptional    ) {
        super(
        );
    ...
    public uma_BreakdownElement(
        String isPlanned,        String prefix,        String hasMultipleOccurrences,        String isOptional        ArrayList<uma_ReusableAsset> uma_reusableassets,        ArrayList<uma_Example> uma_examples,        ArrayList<uma_ToolMentor> uma_toolmentors,        ArrayList<uma_Template> uma_templates,        ArrayList<uma_Report> uma_reports,        ArrayList<uma_EstimationConsiderations> uma_estimationconsiderationss,        ArrayList<uma_Concept> uma_concepts,        ArrayList<uma_Checklist> uma_checklists,        ArrayList<uma_Guideline> uma_guidelines,        ArrayList<uma_SupportingMaterial> uma_supportingmaterials    ) {
        this.isPlanned = isPlanned;
        this.prefix = prefix;
        this.hasMultipleOccurrences = hasMultipleOccurrences;
        this.isOptional = isOptional;
