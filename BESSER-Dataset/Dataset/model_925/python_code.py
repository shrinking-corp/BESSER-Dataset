...
class uma_Constraint(MethodElement):
    ...
    def __init__(self, body: str, uma_Constraint50: "uma_WorkDefinition" = None, uma_Constraint53: "uma_WorkDefinition" = None, uma_Constraint: "uma_MethodElement" = None):
        self.body = body
...
class uma_DiagramElement(MethodElement):
    ...
    def __init__(self, isVisible: str, contained: "uma_GraphElement" = None, referenced: set["uma_Reference"] = None, uma_DiagramElement: set["uma_Property"] = None, DiagramElement: "uma_GraphElement" = None, DiagramElement290: "uma_Reference" = None):
...
class uma_MethodPlugin(MethodUnit, Package):
    ...
    def __init__(self, userChangeable: str, supporting: bool, uma_MethodPlugin246: set["uma_MethodPackage"] = None, uma_MethodPlugin250: "uma_MethodPlugin" = None, uma_MethodPlugin248: set["uma_MethodPlugin"] = None, uma_MethodPlugin: "uma_MethodConfiguration" = None, uma_MethodPlugin323: "uma_MethodLibrary" = None):
...
class uma_MethodPackage(Package, MethodElement):
    ...
    def __init__(self, global_: str, uma_MethodPackage156: "uma_MethodPackage" = None, uma_MethodPackage154: set["uma_MethodPackage"] = None, uma_MethodPackage: "uma_MethodPackage" = None, uma_MethodPackage152: set["uma_MethodPackage"] = None, uma_MethodPackage247: "uma_MethodPlugin" = None, uma_MethodPackage229: "uma_MethodConfiguration" = None):
...
class uma_WorkProductDescriptor(Descriptor):
    ...
    def __init__(self, activityEntryState: str, activityExitState: str, uma_WorkProductDescriptor: "uma_Milestone" = None, uma_WorkProductDescriptor161: "uma_WorkProduct" = None, uma_WorkProductDescriptor182: "uma_RoleDescriptor" = None, uma_WorkProductDescriptor185: "uma_RoleDescriptor" = None, uma_WorkProductDescriptor196: "uma_TaskDescriptor" = None, WorkProductDescriptor: "uma_WorkProductDescriptor" = None, impacts: set["uma_WorkProductDescriptor"] = None, WorkProductDescriptor167: "uma_WorkProductDescriptor" = None, impactedBy: set["uma_WorkProductDescriptor"] = None, uma_WorkProductDescriptor170: "uma_WorkProductDescriptor" = None, uma_WorkProductDescriptor168: set["uma_WorkProductDescriptor"] = None, uma_WorkProductDescriptor199: "uma_TaskDescriptor" = None, uma_WorkProductDescriptor202: "uma_TaskDescriptor" = None, uma_WorkProductDescriptor205: "uma_TaskDescriptor" = None, uma_WorkProductDescriptor312: "uma_ProcessComponentInterface" = None):
...
class uma_BreakdownElement(ProcessElement):
    ...
    def __init__(self, prefix: str, isPlanned: str, hasMultipleOccurrences: str, isOptional: str, uma_BreakdownElement124: set["uma_ReusableAsset"] = None, uma_BreakdownElement127: set["uma_SupportingMaterial"] = None, uma_BreakdownElement130: set["uma_Template"] = None, uma_BreakdownElement: "uma_BreakdownElement" = None, uma_BreakdownElement103: "uma_BreakdownElement" = None, uma_BreakdownElement107: "uma_BreakdownElement" = None, uma_BreakdownElement105: "uma_BreakdownElement" = None, uma_BreakdownElement133: set["uma_Report"] = None, uma_BreakdownElement136: set["uma_EstimationConsiderations"] = None, uma_BreakdownElement139: set["uma_ToolMentor"] = None, BreakdownElement: "uma_Activity" = None, uma_BreakdownElement109: "uma_PlanningData" = None, breakdownElements: "uma_Activity" = None, uma_BreakdownElement112: set["uma_Checklist"] = None, uma_BreakdownElement115: set["uma_Concept"] = None, uma_BreakdownElement118: set["uma_Example"] = None, uma_BreakdownElement121: set["uma_Guideline"] = None):
        self.prefix = prefix
...
class uma_PracticeDescription(ContentDescription):
    ...
    def __init__(self, problem: str, background: str, goals: str, application: str, levelsOfAdoption: str, additionalInfo: str):
...
class VariabilityElement:
    ...
    pass
class uma_Activity(WorkBreakdownElement, WorkDefinition, VariabilityElement, FulfillableElement):
