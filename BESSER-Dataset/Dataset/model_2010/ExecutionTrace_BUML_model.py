...
# Classes
trace_ExecutionContext = Class(name="trace_ExecutionContext")
TraceElement = Class(name="TraceElement")
trace_ModuleElement = Class(name="trace_ModuleElement")
trace_Trace = Class(name="trace_Trace")
trace_Property = Class(name="trace_Property")
trace_ModelElement = Class(name="trace_ModelElement")
...
trace_ExecutionContext.attributes={trace_ExecutionContext_modelsIds, trace_ExecutionContext_scriptId}
...
# Relationships
for_0: BinaryAssociation = BinaryAssociation(
    name="for_0",
    ends={
...
executionContexts4: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="for_", type=trace_ExecutionContext, multiplicity=Multiplicity(0, 9999))
    }
)
...
domain_model = DomainModel(
    name="trace",
    types={trace_ExecutionContext, TraceElement, trace_ModuleElement, trace_Trace, trace_Property, trace_ModelElement, trace_TraceElement},
    associations={for_0, executionContexts4, traces5, executionContext7, traces9, reaches12, accesses15, executionContext17, traces19, owns21, contains1, involves2, modelElement23, traces25},
    generalizations={gen_trace_ExecutionContext_TraceElement, gen_trace_Trace_TraceElement, gen_trace_ModelElement_TraceElement, gen_trace_Property_TraceElement, gen_trace_ModuleElement_TraceElement},
    metadata=None
)
