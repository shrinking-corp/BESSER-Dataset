...
class trace_ExecutionContext(TraceElement):
    ...
    def __init__(self, scriptId: str, modelsIds: str, executionContexts: set["trace_ModuleElement"] = None, ExecutionContext: "trace_ModuleElement" = None, ExecutionContext8: "trace_Trace" = None, ExecutionContext18: "trace_ModelElement" = None, executionContext: set["trace_Trace"] = None, executionContext3: set["trace_ModelElement"] = None):
    ...
    def ExecutionContext(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "for_"):
                opp_val = getattr(old_value, "for_", None)
                if isinstance(opp_val, set):
                    opp_val.discard(self)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "for_"):
                opp_val = getattr(value, "for_", None)
                if opp_val is None:
                    setattr(value, "for_", set([self]))
...
class trace_ModuleElement(TraceElement):
    ...
    def __init__(self, module_id: str, ModuleElement: "trace_ExecutionContext" = None, for_: set["trace_ExecutionContext"] = None, traces: set["trace_Trace"] = None, ModuleElement11: "trace_Trace" = None):
        self.module_id = module_id
        self.ModuleElement = ModuleElement
        self.for_ = for_ if for_ is not None else set()
    ...
    def for_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_trace_ModuleElement__for_", None)
        self.__for_ = value if value is not None else set()
...
class trace_ModelElement(TraceElement):
    ...
    def __init__(self, element_id: str, ModelElement14: "trace_Trace" = None, involves: set["trace_ExecutionContext"] = None, reaches: set["trace_Trace"] = None, modelElement: set["trace_Property"] = None, ModelElement: "trace_ExecutionContext" = None, ModelElement24: "trace_Property" = None):
