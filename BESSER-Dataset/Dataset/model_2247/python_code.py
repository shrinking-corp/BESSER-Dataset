...
class courses_ExaminationPanel:
    ...
    def __init__(self, date: str, time: str, room: str, courses_ExaminationPanel36: "courses_ExaminationArrangement" = None, courses_ExaminationPanel49: set["courses_EvaluationForm"] = None, courses_ExaminationPanel: "courses_CourseInstance" = None):
        self.date = date
        self.time = time
        self.room = room
...
class courses_ContactInfo:
    ...
    def __init__(self, department: str, phone: str, courses_ContactInfo38: "courses_Person" = None, courses_ContactInfo41: set["courses_Person"] = None, courses_ContactInfo: "courses_CourseInstance" = None):
...
class courses_CourseHour:
    ...
    def __init__(self, day: str, startHour: str, endHour: str, type: str, room: str, courses_CourseHour46: set["courses_StudyProgram"] = None, courses_CourseHour: "courses_Timetable" = None):
        self.day = day
...
class courses_Person:
    ...
    def __init__(self, name: str, Credits: float, student: set["courses_Course"] = None, student57: "courses_StudyProgram" = None, Person53: "courses_StudyProgram" = None, courses_Person7: "courses_University" = None, Person: "courses_Course" = None, courses_Person: "courses_University" = None, courses_Person39: "courses_ContactInfo" = None, courses_Person42: "courses_ContactInfo" = None):
        self.name = name
    ...
    def SignUpExam(self, courses_course):
        # TODO: Implement SignUpExam method
        pass

    def CancelExam(self, courses_course):
        # TODO: Implement CancelExam method
        pass

    def PassingExam(self, courses_course):
        # TODO: Implement PassingExam method
        pass

class courses_Course:

    def __init__(self, code: str, name: str, credit: float, courses_Course31: "courses_CourseInstance" = None, Course55: "courses_Person" = None, courses_Course61: "courses_CreditsReduction" = None, Course: "courses_StudyProgram" = None, courses_Course9: set["courses_CourseInstance"] = None, courses: set["courses_StudyProgram"] = None, course: set["courses_Person"] = None, courses_Course: "courses_University" = None, courses_Course28: "courses_CourseInstance" = None):
        self.code = code
        self.name = name
        self.credit = credit
...
class courses_University:
    ...
    def __init__(self, name: str, courses_University4: set["courses_StudyProgram"] = None, courses_University6: set["courses_Person"] = None, courses_University: set["courses_Course"] = None, courses_University2: set["courses_Person"] = None):
        self.name = name
    ...
    def StaffInscription(self, courses_name):
        # TODO: Implement StaffInscription method
        pass

    def StudentInscription(self, courses_name):
...
class courses_ExaminationArrangement:
    ...
    def __init__(self, type: str, grade: str, courses_ExaminationArrangement35: set["courses_ExaminationPanel"] = None, courses_ExaminationArrangement: "courses_Content" = None):
        self.type = type
        self.grade = grade
...
class courses_StudyProgram:
    ...
    def __init__(self, code: str, courses_StudyProgram: "courses_University" = None, StudyProgram58: "courses_Person" = None, courses_StudyProgram47: "courses_CourseHour" = None, studyProgram: set["courses_Course"] = None, studyProgram52: set["courses_Person"] = None, StudyProgram: "courses_Course" = None):
        self.code = code
