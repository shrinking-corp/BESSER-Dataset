...
# Classes
courses_StudyProgram = Class(name="courses_StudyProgram")
courses_CourseInstance = Class(name="courses_CourseInstance")
courses_Content = Class(name="courses_Content")
courses_ExaminationArrangement = Class(name="courses_ExaminationArrangement")
courses_Paragraph = Class(name="courses_Paragraph")
courses_University = Class(name="courses_University")
courses_Course = Class(name="courses_Course")
courses_Person = Class(name="courses_Person")
courses_EvaluationForm = Class(name="courses_EvaluationForm")
courses_CourseHour = Class(name="courses_CourseHour")
courses_ContactInfo = Class(name="courses_ContactInfo")
courses_Coursework = Class(name="courses_Coursework")
courses_Timetable = Class(name="courses_Timetable")
courses_ExaminationPanel = Class(name="courses_ExaminationPanel")
courses_CreditsReduction = Class(name="courses_CreditsReduction")
...
courses_Paragraph.attributes={courses_Paragraph_description, courses_Paragraph_name}

# courses_University class attributes and methods
courses_University_name: Property = Property(name="name", type=StringType)
courses_University_m_StudentInscription: Method = Method(name="StudentInscription", parameters={Parameter(name='courses_name', type=StringType)})
courses_University_m_StaffInscription: Method = Method(name="StaffInscription", parameters={Parameter(name='courses_name', type=StringType)})
courses_University.attributes={courses_University_name}
courses_University.methods={courses_University_m_StudentInscription, courses_University_m_StaffInscription}
...
courses_Course.attributes={courses_Course_name, courses_Course_credit, courses_Course_code}
...
courses_Person_m_CancelExam: Method = Method(name="CancelExam", parameters={Parameter(name='courses_course', type=StringType)})
courses_Person_m_PassingExam: Method = Method(name="PassingExam", parameters={Parameter(name='courses_course', type=StringType)})
courses_Person_m_SignUpExam: Method = Method(name="SignUpExam", parameters={Parameter(name='courses_course', type=StringType)})
courses_Person.attributes={courses_Person_name, courses_Person_Credits}
courses_Person.methods={courses_Person_m_PassingExam, courses_Person_m_CancelExam, courses_Person_m_SignUpExam}
...
courses_EvaluationForm.attributes={courses_EvaluationForm_weighting, courses_EvaluationForm_type, courses_EvaluationForm_examAids, courses_EvaluationForm_duration}
...
courses_CourseHour.attributes={courses_CourseHour_room, courses_CourseHour_startHour, courses_CourseHour_type, courses_CourseHour_endHour, courses_CourseHour_day}
...
courses_Coursework.attributes={courses_Coursework_location, courses_Coursework_numSpecHour, courses_Coursework_instructionLanguage, courses_Coursework_numLectHour, courses_Coursework_termNumber, courses_Coursework_teachingSemester, courses_Coursework_numLabHour}
...
domain_model = DomainModel(
    name="courses",
    types={courses_StudyProgram, courses_CourseInstance, courses_Content, courses_ExaminationArrangement, courses_Paragraph, courses_University, courses_Course, courses_Person, courses_EvaluationForm, courses_CourseHour, courses_ContactInfo, courses_Coursework, courses_Timetable, courses_ExaminationPanel, courses_CreditsReduction, Day, HourStart, TeachingLanguage, Location, Department, HourEnd, Semester},
    associations={studyProgram3, students5, listCourseInstance8, studyProgram10, student11, examArrangement12, paragraph13, course0, staff1, courseCoordinator37, staff40, listCourseHour43, contactInfo15, courseContent17, coursework20, timetable22, examination24, courseRequired26, courseRecommended29, creditsReduction32, evaluationForms34, course54, studyProgram56, course59, plannedFor45, evaluationForm48, courses50, student51},
    generalizations={},
    metadata=None
)
