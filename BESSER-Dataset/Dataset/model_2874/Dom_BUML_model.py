...
# Classes
dom_Program = Class(name="dom_Program")
DomElement = Class(name="DomElement")
dom_Import = Class(name="dom_Import")
dom_OperationDefinition = Class(name="dom_OperationDefinition")
dom_Block = Class(name="dom_Block")
dom_NameExpression = Class(name="dom_NameExpression")
dom_ModelDeclarationStatement = Class(name="dom_ModelDeclarationStatement")
dom_StringExpression = Class(name="dom_StringExpression")
...
dom_DomElement = Class(name="dom_DomElement", is_abstract=True)
dom_EqualsOperatorExpression = Class(name="dom_EqualsOperatorExpression")
dom_FeatureCallExpression = Class(name="dom_FeatureCallExpression", is_abstract=True)
dom_GreaterThanOperatorExpression = Class(name="dom_GreaterThanOperatorExpression")
dom_GreaterThanOrEqualToOperatorExpression = Class(name="dom_GreaterThanOrEqualToOperatorExpression")
dom_ImpliesOperatorExpression = Class(name="dom_ImpliesOperatorExpression")
dom_IntegerExpression = Class(name="dom_IntegerExpression")
dom_LessThanOperatorExpression = Class(name="dom_LessThanOperatorExpression")
dom_LessThanOrEqualToOperatorExpression = Class(name="dom_LessThanOrEqualToOperatorExpression")
dom_MethodCallExpression = Class(name="dom_MethodCallExpression")
FeatureCallExpression = Class(name="FeatureCallExpression")
dom_MinusOperatorExpression = Class(name="dom_MinusOperatorExpression")
dom_MultiplyOperatorExpression = Class(name="dom_MultiplyOperatorExpression")
dom_OperatorExpression = Class(name="dom_OperatorExpression", is_abstract=True)
Expression = Class(name="Expression")
dom_BinaryOperatorExpression = Class(name="dom_BinaryOperatorExpression", is_abstract=True)
OperatorExpression = Class(name="OperatorExpression")
dom_AndOperatorExpression = Class(name="dom_AndOperatorExpression")
BinaryOperatorExpression = Class(name="BinaryOperatorExpression")
dom_LiteralExpression = Class(name="dom_LiteralExpression", is_abstract=True)
dom_BooleanExpression = Class(name="dom_BooleanExpression")
PrimitiveExpression = Class(name="PrimitiveExpression")
dom_DivideOperatorExpression = Class(name="dom_DivideOperatorExpression")
dom_EnumerationLiteralExpression = Class(name="dom_EnumerationLiteralExpression")
dom_XorOperatorExpression = Class(name="dom_XorOperatorExpression")
dom_AnnotationBlock = Class(name="dom_AnnotationBlock")
dom_FormalParameterExpression = Class(name="dom_FormalParameterExpression")
dom_AssignmentStatement = Class(name="dom_AssignmentStatement")
Statement = Class(name="Statement")
dom_BreakStatement = Class(name="dom_BreakStatement")
dom_BreakAllStatement = Class(name="dom_BreakAllStatement")
dom_UnaryOperatorExpression = Class(name="dom_UnaryOperatorExpression", is_abstract=True)
dom_ContinueStatement = Class(name="dom_ContinueStatement")
dom_DeleteStatement = Class(name="dom_DeleteStatement")
dom_NegativeOperatorExpression = Class(name="dom_NegativeOperatorExpression")
UnaryOperatorExpression = Class(name="UnaryOperatorExpression")
dom_NotEqualsOperatorExpression = Class(name="dom_NotEqualsOperatorExpression")
dom_NotOperatorExpression = Class(name="dom_NotOperatorExpression")
dom_OrOperatorExpression = Class(name="dom_OrOperatorExpression")
dom_PlusOperatorExpression = Class(name="dom_PlusOperatorExpression")
dom_PropertyCallExpression = Class(name="dom_PropertyCallExpression")
dom_RealExpression = Class(name="dom_RealExpression")
...
dom_SwitchCaseExpressionStatement = Class(name="dom_SwitchCaseExpressionStatement")
dom_SwitchCaseDefaultStatement = Class(name="dom_SwitchCaseDefaultStatement")
dom_SwitchCaseStatement = Class(name="dom_SwitchCaseStatement", is_abstract=True)
...
dom_PrimitiveExpression = Class(name="dom_PrimitiveExpression", is_abstract=True)
LiteralExpression = Class(name="LiteralExpression")
dom_CollectionExpression = Class(name="dom_CollectionExpression", is_abstract=True)
dom_CollectionInitValue = Class(name="dom_CollectionInitValue", is_abstract=True)
dom_SetExpression = Class(name="dom_SetExpression")
CollectionExpression = Class(name="CollectionExpression")
dom_BagExpression = Class(name="dom_BagExpression")
dom_SequenceExpression = Class(name="dom_SequenceExpression")
dom_OrderedSetExpression = Class(name="dom_OrderedSetExpression")
dom_MapExpression = Class(name="dom_MapExpression")
dom_KeyValue = Class(name="dom_KeyValue")
dom_AnyType = Class(name="dom_AnyType")
Type = Class(name="Type")
dom_CollectionType = Class(name="dom_CollectionType", is_abstract=True)
dom_PrimitiveType = Class(name="dom_PrimitiveType", is_abstract=True)
dom_BooleanType = Class(name="dom_BooleanType")
PrimitiveType = Class(name="PrimitiveType")
dom_IntegerType = Class(name="dom_IntegerType")
dom_RealType = Class(name="dom_RealType")
dom_StringType = Class(name="dom_StringType")
dom_SetType = Class(name="dom_SetType")
CollectionType = Class(name="CollectionType")
dom_BagType = Class(name="dom_BagType")
dom_SequenceType = Class(name="dom_SequenceType")
dom_OrderedSetType = Class(name="dom_OrderedSetType")
dom_MapType = Class(name="dom_MapType")
dom_Annotation = Class(name="dom_Annotation", is_abstract=True)
dom_ExecutableAnnotation = Class(name="dom_ExecutableAnnotation")
dom_ModelDeclarationParameter = Class(name="dom_ModelDeclarationParameter")
dom_FOLMethodCallExpression = Class(name="dom_FOLMethodCallExpression")
dom_ExpressionStatement = Class(name="dom_ExpressionStatement")
SwitchCaseStatement = Class(name="SwitchCaseStatement")
dom_ModelElementTypeExpression = Class(name="dom_ModelElementTypeExpression")
dom_ShortModelDeclarationExpression = Class(name="dom_ShortModelDeclarationExpression")
dom_NativeType = Class(name="dom_NativeType")
dom_ModelExpression = Class(name="dom_ModelExpression")
dom_ThrowStatement = Class(name="dom_ThrowStatement")
dom_AbortStatement = Class(name="dom_AbortStatement")
dom_TransactionStatement = Class(name="dom_TransactionStatement")
Annotation = Class(name="Annotation")
dom_SimpleAnnotation = Class(name="dom_SimpleAnnotation")
dom_SpecialNameExpression = Class(name="dom_SpecialNameExpression")
NameExpression = Class(name="NameExpression")
dom_ModelElementType = Class(name="dom_ModelElementType")
dom_SpecialAssignmentStatement = Class(name="dom_SpecialAssignmentStatement")
AssignmentStatement = Class(name="AssignmentStatement")
dom_ExprList = Class(name="dom_ExprList")
CollectionInitValue = Class(name="CollectionInitValue")
dom_ExpRange = Class(name="dom_ExpRange")
dom_NewExpression = Class(name="dom_NewExpression")
...
domain_model = DomainModel(
    name="dom",
    types={dom_Program, DomElement, dom_Import, dom_OperationDefinition, dom_Block, dom_NameExpression, dom_ModelDeclarationStatement, dom_StringExpression, dom_Statement, dom_Expression, dom_Type, dom_DomElement, dom_EqualsOperatorExpression, dom_FeatureCallExpression, dom_GreaterThanOperatorExpression, dom_GreaterThanOrEqualToOperatorExpression, dom_ImpliesOperatorExpression, dom_IntegerExpression, dom_LessThanOperatorExpression, dom_LessThanOrEqualToOperatorExpression, dom_MethodCallExpression, FeatureCallExpression, dom_MinusOperatorExpression, dom_MultiplyOperatorExpression, dom_OperatorExpression, Expression, dom_BinaryOperatorExpression, OperatorExpression, dom_AndOperatorExpression, BinaryOperatorExpression, dom_LiteralExpression, dom_BooleanExpression, PrimitiveExpression, dom_DivideOperatorExpression, dom_EnumerationLiteralExpression, dom_XorOperatorExpression, dom_AnnotationBlock, dom_FormalParameterExpression, dom_AssignmentStatement, Statement, dom_BreakStatement, dom_BreakAllStatement, dom_UnaryOperatorExpression, dom_ContinueStatement, dom_DeleteStatement, dom_NegativeOperatorExpression, UnaryOperatorExpression, dom_NotEqualsOperatorExpression, dom_NotOperatorExpression, dom_OrOperatorExpression, dom_PlusOperatorExpression, dom_PropertyCallExpression, dom_RealExpression, dom_VariableDeclarationExpression, dom_ReturnStatement, dom_SwitchStatement, dom_SwitchCaseExpressionStatement, dom_SwitchCaseDefaultStatement, dom_SwitchCaseStatement, dom_WhileStatement, dom_ForStatement, dom_IfStatement, dom_PrimitiveExpression, LiteralExpression, dom_CollectionExpression, dom_CollectionInitValue, dom_SetExpression, CollectionExpression, dom_BagExpression, dom_SequenceExpression, dom_OrderedSetExpression, dom_MapExpression, dom_KeyValue, dom_AnyType, Type, dom_CollectionType, dom_PrimitiveType, dom_BooleanType, PrimitiveType, dom_IntegerType, dom_RealType, dom_StringType, dom_SetType, CollectionType, dom_BagType, dom_SequenceType, dom_OrderedSetType, dom_MapType, dom_Annotation, dom_ExecutableAnnotation, dom_ModelDeclarationParameter, dom_FOLMethodCallExpression, dom_ExpressionStatement, SwitchCaseStatement, dom_ModelElementTypeExpression, dom_ShortModelDeclarationExpression, dom_NativeType, dom_ModelExpression, dom_ThrowStatement, dom_AbortStatement, dom_TransactionStatement, Annotation, dom_SimpleAnnotation, dom_SpecialNameExpression, NameExpression, dom_ModelElementType, dom_SpecialAssignmentStatement, AssignmentStatement, dom_ExprList, CollectionInitValue, dom_ExpRange, dom_NewExpression},
    associations={imports2, operations3, block5, name7, modelDeclarations9, imported11, resolvedType13, model26, container1, target29, isArrow31, arguments33, method35, statements14, lhs16, rhs18, enumeration21, literal23, name45, create47, parameters50, contextType53, returnType56, annotationBlock59, body61, name64, parameters67, lhs69, rhs71, expr38, property40, extended42, elseBody89, returned92, expression94, cases96, default98, body100, condition102, body104, name107, alias110, driver113, deleted74, iterator76, iterated78, body81, condition84, ifBody86, parameterList131, contentType132, keyValues135, name136, parameters116, iterators118, conditions120, method123, expression126, expression128, expression148, nativeExpression149, simpleAnnotations151, executableAnnotations154, name157, value160, thrown163, body165, names167, name170, expression138, values140, key142, value145, parameters180, model182, element185, resolvedModelDeclaration188, expressions173, start175, end177},
    generalizations={gen_dom_Program_DomElement, gen_dom_Import_DomElement, gen_dom_Statement_DomElement, gen_dom_Expression_DomElement, gen_dom_Block_DomElement, gen_dom_EqualsOperatorExpression_BinaryOperatorExpression, gen_dom_FeatureCallExpression_Expression, gen_dom_GreaterThanOperatorExpression_BinaryOperatorExpression, gen_dom_GreaterThanOrEqualToOperatorExpression_BinaryOperatorExpression, gen_dom_ImpliesOperatorExpression_BinaryOperatorExpression, gen_dom_IntegerExpression_PrimitiveExpression, gen_dom_LessThanOperatorExpression_BinaryOperatorExpression, gen_dom_LessThanOrEqualToOperatorExpression_BinaryOperatorExpression, gen_dom_MethodCallExpression_FeatureCallExpression, gen_dom_MinusOperatorExpression_BinaryOperatorExpression, gen_dom_MultiplyOperatorExpression_BinaryOperatorExpression, gen_dom_NameExpression_Expression, gen_dom_OperatorExpression_Expression, gen_dom_BinaryOperatorExpression_OperatorExpression, gen_dom_AndOperatorExpression_BinaryOperatorExpression, gen_dom_LiteralExpression_Expression, gen_dom_BooleanExpression_PrimitiveExpression, gen_dom_DivideOperatorExpression_BinaryOperatorExpression, gen_dom_EnumerationLiteralExpression_Expression, gen_dom_XorOperatorExpression_BinaryOperatorExpression, gen_dom_OperationDefinition_DomElement, gen_dom_AssignmentStatement_Statement, gen_dom_BreakStatement_Statement, gen_dom_BreakAllStatement_Statement, gen_dom_UnaryOperatorExpression_OperatorExpression, gen_dom_ContinueStatement_Statement, gen_dom_DeleteStatement_Statement, gen_dom_NegativeOperatorExpression_UnaryOperatorExpression, gen_dom_NotEqualsOperatorExpression_BinaryOperatorExpression, gen_dom_NotOperatorExpression_UnaryOperatorExpression, gen_dom_OrOperatorExpression_BinaryOperatorExpression, gen_dom_PlusOperatorExpression_BinaryOperatorExpression, gen_dom_PropertyCallExpression_FeatureCallExpression, gen_dom_RealExpression_PrimitiveExpression, gen_dom_StringExpression_PrimitiveExpression, gen_dom_VariableDeclarationExpression_Expression, gen_dom_ReturnStatement_Statement, gen_dom_SwitchStatement_Statement, gen_dom_SwitchCaseStatement_Statement, gen_dom_WhileStatement_Statement, gen_dom_ModelDeclarationStatement_Statement, gen_dom_ForStatement_Statement, gen_dom_IfStatement_Statement, gen_dom_PrimitiveExpression_LiteralExpression, gen_dom_CollectionExpression_LiteralExpression, gen_dom_SetExpression_CollectionExpression, gen_dom_BagExpression_CollectionExpression, gen_dom_SequenceExpression_CollectionExpression, gen_dom_OrderedSetExpression_CollectionExpression, gen_dom_MapExpression_LiteralExpression, gen_dom_Type_DomElement, gen_dom_AnyType_Type, gen_dom_CollectionType_Type, gen_dom_PrimitiveType_Type, gen_dom_BooleanType_PrimitiveType, gen_dom_IntegerType_PrimitiveType, gen_dom_RealType_PrimitiveType, gen_dom_StringType_PrimitiveType, gen_dom_SetType_CollectionType, gen_dom_BagType_CollectionType, gen_dom_SequenceType_CollectionType, gen_dom_OrderedSetType_CollectionType, gen_dom_MapType_Type, gen_dom_Annotation_DomElement, gen_dom_FOLMethodCallExpression_FeatureCallExpression, gen_dom_ExpressionStatement_Statement, gen_dom_SwitchCaseDefaultStatement_SwitchCaseStatement, gen_dom_SwitchCaseExpressionStatement_SwitchCaseStatement, gen_dom_NativeType_Type, gen_dom_ModelExpression_NameExpression, gen_dom_AnnotationBlock_DomElement, gen_dom_ModelDeclarationParameter_DomElement, gen_dom_ThrowStatement_Statement, gen_dom_AbortStatement_Statement, gen_dom_TransactionStatement_Statement, gen_dom_FormalParameterExpression_Expression, gen_dom_ExecutableAnnotation_Annotation, gen_dom_SimpleAnnotation_Annotation, gen_dom_KeyValue_DomElement, gen_dom_SpecialNameExpression_NameExpression, gen_dom_ModelElementType_Type, gen_dom_ModelElementTypeExpression_Expression, gen_dom_SpecialAssignmentStatement_AssignmentStatement, gen_dom_CollectionInitValue_DomElement, gen_dom_ExprList_CollectionInitValue, gen_dom_ExpRange_CollectionInitValue, gen_dom_NewExpression_Expression},
    metadata=None
)
