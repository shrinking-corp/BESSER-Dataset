...
# Classes
error3_NamedElement = Class(name="error3_NamedElement", is_abstract=True)
error3_Required = Class(name="error3_Required")
error3_Binding = Class(name="error3_Binding")
error3_Provided = Class(name="error3_Provided")
error3_World = Class(name="error3_World")
error3_Thing = Class(name="error3_Thing")
NamedElement = Class(name="NamedElement")
error3_RelatedTo = Class(name="error3_RelatedTo")
error3_Level2 = Class(name="error3_Level2")
AbstractComponent = Class(name="AbstractComponent")
error3_NestedComponent = Class(name="error3_NestedComponent")
error3_AbstractComponent = Class(name="error3_AbstractComponent")
error3_RecursiveComponen = Class(name="error3_RecursiveComponen")
error3_Bazbar = Class(name="error3_Bazbar")
...
domain_model = DomainModel(
    name="error3",
    types={error3_NamedElement, error3_Required, error3_Binding, error3_Provided, error3_World, error3_Thing, NamedElement, error3_RelatedTo, error3_Level2, AbstractComponent, error3_NestedComponent, error3_AbstractComponent, error3_RecursiveComponen, error3_Bazbar},
    associations={fromThing2, toThing3, bindings5, src6, trg9, things0, relations1, requiredInterfaces11, providedInterfaces13, levels216, levels117, bazbars19, components22},
    generalizations={gen_error3_RelatedTo_NamedElement, gen_error3_Thing_NamedElement, gen_error3_Level2_AbstractComponent, gen_error3_NestedComponent_AbstractComponent, gen_error3_RecursiveComponen_AbstractComponent},
    metadata=None
)
