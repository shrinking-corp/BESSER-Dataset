...
class error3_RelatedTo(NamedElement):
    ...
    def __init__(self, since: str, relations: "error3_Thing" = None, error3_RelatedTo: "error3_Thing" = None, RelatedTo: "error3_Thing" = None):
        self.since = since
...
class error3_Thing(NamedElement):
    ...
    def __init__(self, id: int, Thing: "error3_RelatedTo" = None, error3_Thing4: "error3_RelatedTo" = None, error3_Thing: "error3_World" = None, fromThing: set["error3_RelatedTo"] = None):
        self.id = id
        self.Thing = Thing
