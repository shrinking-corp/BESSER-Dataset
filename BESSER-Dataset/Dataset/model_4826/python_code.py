...
class model_ArchimateConcept(Documentable, ArchimateModelObject, Cloneable, Properties):
    ...
    pass
class model_Folder(Documentable, FolderContainer, Properties, ArchimateModelObject):
...
class DiagramModelContainer:
    ...
    pass
class model_DiagramModelArchimateObject(DiagramModelObject, DiagramModelContainer, DiagramModelArchimateComponent, TextPosition):
...
class model_SketchModelSticky(DiagramModelObject, DiagramModelContainer, TextPosition, TextContent, Properties):
    ...
    pass
class model_DiagramModelGroup(Documentable, DiagramModelContainer, Properties, DiagramModelObject):

    pass
class model_DiagramModelObject(Connectable, TextAlignment, FontAttribute, LineObject):
