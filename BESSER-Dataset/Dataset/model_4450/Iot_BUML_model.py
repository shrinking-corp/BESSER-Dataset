...
# Classes
iot_IotSystem = Class(name="iot_IotSystem")
iot_IotSystemSpec = Class(name="iot_IotSystemSpec")
iot_BrokerSpec = Class(name="iot_BrokerSpec")
iot_Message = Class(name="iot_Message")
iot_Event = Class(name="iot_Event")
Message = Class(name="Message")
iot_Dispatch = Class(name="iot_Dispatch")
iot_Request = Class(name="iot_Request")
...
iot_Message.attributes={iot_Message_name, iot_Message_msg}
