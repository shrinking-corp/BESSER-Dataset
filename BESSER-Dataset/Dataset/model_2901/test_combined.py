...
def test_hyp_ube_entitymodel_is_not_abstract():
    assert not inspect.isabstract(ube_EntityModel)


def test_hyp_ube_entitymodel_constructor_exists():
    assert callable(ube_EntityModel.__init__)


def test_hyp_ube_entitymodel_constructor_args():
...
def test_hyp_ube_entity_is_not_abstract():
    assert not inspect.isabstract(ube_Entity)


def test_hyp_ube_entity_constructor_exists():
    assert callable(ube_Entity.__init__)


def test_hyp_ube_entity_constructor_args():
...
def test_hyp_ube_datatype_is_not_abstract():
    assert not inspect.isabstract(ube_DataType)


def test_hyp_ube_datatype_constructor_exists():
    assert callable(ube_DataType.__init__)


def test_hyp_ube_datatype_constructor_args():
...
def test_hyp_ube_feature_is_not_abstract():
    assert not inspect.isabstract(ube_Feature)


def test_hyp_ube_feature_constructor_exists():
    assert callable(ube_Feature.__init__)


def test_hyp_ube_feature_constructor_args():
...
def test_hyp_ube_type_is_not_abstract():
    assert not inspect.isabstract(ube_Type)


def test_hyp_ube_type_constructor_exists():
    assert callable(ube_Type.__init__)


def test_hyp_ube_type_constructor_args():
    sig = inspect.signature(ube_Type.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ube_namedelement_is_not_abstract():
    assert not inspect.isabstract(ube_NamedElement)


def test_hyp_ube_namedelement_constructor_exists():
    assert callable(ube_NamedElement.__init__)


def test_hyp_ube_namedelement_constructor_args():
...
def test_hyp_ube_entity_abstract_setter(instance):
...
def test_hyp_ube_feature_kind_setter(instance):
...
def test_hyp_ube_namedelement_name_setter(instance):
