...
# Classes
ube_NamedElement = Class(name="ube_NamedElement", is_abstract=True)
ube_Type = Class(name="ube_Type", is_abstract=True)
NamedElement = Class(name="NamedElement")
ube_DataType = Class(name="ube_DataType")
Type = Class(name="Type")
ube_Entity = Class(name="ube_Entity")
ube_Feature = Class(name="ube_Feature")
ube_EntityModel = Class(name="ube_EntityModel")
