...
class Yahtzee_Turn1:
    ...
    def __init__(self, Dice: str, display53: "Yahtzee_Display1" = None, scoring57: "Yahtzee_Scoring1" = None):
        self.Dice = Dice
...
class Yahtzee_Players:
    ...
    def __init__(self, Name: str, Score: str, game7: "Yahtzee_Game" = None, scoring9: "Yahtzee_Scoring" = None, turn5: "Yahtzee_Turn" = None):
        self.Name = Name
        self.Score = Score
        self.game7 = game7
...
class Yahtzee_Game:
    ...
    def __init__(self, Player: Class, CompPlayer: Class1, First: int, Again: bool, players6: "Yahtzee_Players" = None, turn3: "Yahtzee_Turn" = None):
        self.Player = Player
