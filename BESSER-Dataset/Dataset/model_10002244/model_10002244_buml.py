...
Yahtzee_Game.attributes={Yahtzee_Game_Player, Yahtzee_Game_Again, Yahtzee_Game_First, Yahtzee_Game_CompPlayer}
...
Yahtzee_Display.attributes={Yahtzee_Display_PanelScorecard, Yahtzee_Display_PanelChoices, Yahtzee_Display_PanelNames, Yahtzee_Display_PanelPrimary, Yahtzee_Display_PanelGameName}
...
Yahtzee_Players.attributes={Yahtzee_Players_Score, Yahtzee_Players_Name}
...
Yahtzee_Display1.attributes={Yahtzee_Display1_Player, Yahtzee_Display1_Jpanel, Yahtzee_Display1_Temp, Yahtzee_Display1_Jlabel, Yahtzee_Display1_JButton, Yahtzee_Display1_JTextField, Yahtzee_Display1_JRadioButton, Yahtzee_Display1_Computer, Yahtzee_Display1_JScrollPanel, Yahtzee_Display1_JImageIcon, Yahtzee_Display1_Temp1, Yahtzee_Display1_JFrame}
...
Yahtzee_Players1.attributes={Yahtzee_Players1_compScore, Yahtzee_Players1_playerScore}
...
domain_model = DomainModel(
    name="_z1FjUAksEeqB3a4sRh_tuQ",
    types={Yahtzee_Game, Yahtzee_Turn, Yahtzee_Scoring, Yahtzee_Display, Yahtzee_Players, Class_, Class1, Scoring, Turn, Players, Yahtzee_Component, Player_Actor, Yahtzee_Display1, Yahtzee_Turn1, Yahtzee_Scoring1, Yahtzee_Players1, Display, Computer_Turn_external, Roll_Dice_external, Score_Roll_external, Next_Turn_external, Announce_Winner_external, Play_Again_external, Get_Player_Name_external, Get_Instructions_external, Roll_First_external, Game_Start_external},
    associations={Scoring_Turn, Turn_Game, Turn_Players, Game_Players, Scoring_Players, Game_Start_Computer_Turn, Game_Start_UseCase, Roll_Dice_Score_Roll, Computer_Turn_Next_Turn, Roll_Dice_Next_Turn, Next_Turn_Announce_Winner, Announce_Winner_Play_Again, Roll_First_Play_Again, Player_Get_Instructions, Player_Get_Player_Name, Player_Roll_First, Player_Game_Start, Player_Roll_Dice, Player_Play_Again, Player_Score_Roll, Display_Players, Display_Turn, Display_Scoring, Scoring_Turn1, Scoring_Display, Turn_Scoring, Scoring_Players1, Get_Instructions_Get_Player_Name, Get_Player_Name_Roll_First, Roll_First_Game_Start},
    generalizations={},
    metadata=None
)
