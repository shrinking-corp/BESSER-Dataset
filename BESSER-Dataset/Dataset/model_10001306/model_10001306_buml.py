...
Vue_VueGrille.attributes={Vue_VueGrille_update, Vue_VueGrille_modele, Vue_VueGrille_TAILLE}
...
Vue_CVue.attributes={Vue_CVue_commande, Vue_CVue_frame, Vue_CVue_grille}
...
Modele_Cellule.attributes={Modele_Cellule_x, Modele_Cellule_etat, Modele_Cellule_modele, Modele_Cellule_prochaineEtat, Modele_Cellule_y}
...
Modele_Joueur.attributes={Modele_Joueur_vivant, Modele_Joueur_cles, Modele_Joueur_y, Modele_Joueur_x, Modele_Joueur_artefacts}
...
Modele_Participants.attributes={Modele_Participants_attribute, Modele_Participants_NOMBRE}
...
domain_model = DomainModel(
    name="_9fc64adf_1336_443f_9286_80149c713d5e",
    ...
    associations={VueCommande_CModele, CModele_Cellule, CModele_Controleur, Participants_Joueur, VueGrille_CVue, VueGrille_CModele, CVue_VueCommande},
    generalizations={},
    metadata=None
)
