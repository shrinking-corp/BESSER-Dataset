...
class Modele_CModele:
    ...
    def __init__(self, hauteur: int, largeur: int, attribute: Modele_Cellule, VueCommande_CModele_17: set["Vue_VueCommande"] = None, Cellule8: set["Modele_Cellule"] = None, CModele_Controleur_010: set["Controleur_Controleur"] = None, VueGrille_CModele_13: set["Vue_VueGrille"] = None):
...
class Vue_VueCommande:
    ...
    def __init__(self, modele: Modele_CModele, VueCommande_CModele_06: "Modele_CModele" = None, CVue_VueCommande_15: set["Vue_CVue"] = None):
        self.modele = modele
