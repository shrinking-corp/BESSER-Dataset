...
class statemachine_StateAttribute:
    ...
    def __init__(self, type: str, value: str, statemachine_StateAttribute: "statemachine_StateAttribute" = None, statemachine_StateAttribute8: set["statemachine_StateAttribute"] = None, statemachine_StateAttribute13: "statemachine_StateChange" = None, statemachine_StateAttribute20: "statemachine_AttributeCondition" = None):
        self.type = type
        self.value = value
...
class statemachine_ConditionalState(AbstractState):
    ...
    @property
    def conditionsOrganization(self):
