...
# Classes
statemachine_ConditionalTransition = Class(name="statemachine_ConditionalTransition")
statemachine_Statemachine = Class(name="statemachine_Statemachine")
Named = Class(name="Named")
statemachine_AbstractState = Class(name="statemachine_AbstractState", is_abstract=True)
statemachine_Named = Class(name="statemachine_Named")
statemachine_AbstractTransition = Class(name="statemachine_AbstractTransition", is_abstract=True)
statemachine_StateChange = Class(name="statemachine_StateChange")
...
statemachine_StateValue = Class(name="statemachine_StateValue")
statemachine_StateAttribute = Class(name="statemachine_StateAttribute")
statemachine_ConditionalState = Class(name="statemachine_ConditionalState")
statemachine_AbstractCondition = Class(name="statemachine_AbstractCondition")
statemachine_FieldCondition = Class(name="statemachine_FieldCondition")
AbstractCondition = Class(name="AbstractCondition")
statemachine_AttributeCondition = Class(name="statemachine_AttributeCondition")
...
statemachine_Statemachine.attributes={statemachine_Statemachine_associatedAttribute, statemachine_Statemachine_associatedTree}
...
domain_model = DomainModel(
    name="statemachine",
    types={statemachine_ConditionalTransition, statemachine_Statemachine, Named, statemachine_AbstractState, statemachine_Named, statemachine_AbstractTransition, statemachine_StateChange, statemachine_InitialState, AbstractState, statemachine_FinalState, statemachine_State, statemachine_Transition, AbstractTransition, statemachine_StateValue, statemachine_StateAttribute, statemachine_ConditionalState, statemachine_AbstractCondition, statemachine_FieldCondition, AbstractCondition, statemachine_AttributeCondition, StateValueType, StateAttributeType},
    associations={states0, transitions1, state3, stateChange6, stateAttributeQuery9, condition10, stateAttribute11, stateValue14, stateValue16, stateAttribute19},
    generalizations={gen_statemachine_ConditionalTransition_AbstractTransition, gen_statemachine_Statemachine_Named, gen_statemachine_AbstractState_Named, gen_statemachine_AbstractTransition_Named, gen_statemachine_InitialState_AbstractState, gen_statemachine_FinalState_AbstractState, gen_statemachine_State_AbstractState, gen_statemachine_Transition_AbstractTransition, gen_statemachine_ConditionalState_AbstractState, gen_statemachine_FieldCondition_AbstractCondition, gen_statemachine_AttributeCondition_AbstractCondition},
    metadata=None
)
