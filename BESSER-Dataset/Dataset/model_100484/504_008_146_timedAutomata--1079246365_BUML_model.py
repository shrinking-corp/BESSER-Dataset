...
# Classes
timedAutomata_bnf_Synchronisation = Class(name="timedAutomata_bnf_Synchronisation", is_abstract=True)
Position = Class(name="Position")
expressions_Expression = Class(name="expressions_Expression")
timedAutomata_base_Commentable = Class(name="timedAutomata_base_Commentable", is_abstract=True)
timedAutomata_base_Identifyable = Class(name="timedAutomata_base_Identifyable")
timedAutomata_base_Nameable = Class(name="timedAutomata_base_Nameable")
timedAutomata_bnf_Identifier = Class(name="timedAutomata_bnf_Identifier")
timedAutomata_bnf_SendSynchronisation = Class(name="timedAutomata_bnf_SendSynchronisation")
Synchronisation = Class(name="Synchronisation")
timedAutomata_bnf_ReceiveSynchronisation = Class(name="timedAutomata_bnf_ReceiveSynchronisation")
timedAutomata_expressions_ArrayVariableExpression = Class(name="timedAutomata_expressions_ArrayVariableExpression")
timedAutomata_expressions_IncDecExpression = Class(name="timedAutomata_expressions_IncDecExpression")
timedAutomata_expressions_Expression = Class(name="timedAutomata_expressions_Expression", is_abstract=True)
Commentable = Class(name="Commentable")
timedAutomata_expressions_ConstantExpression = Class(name="timedAutomata_expressions_ConstantExpression")
Expression = Class(name="Expression")
timedAutomata_expressions_VariableExpression = Class(name="timedAutomata_expressions_VariableExpression")
Identifier = Class(name="Identifier")
timedAutomata_expressions_UnaryExpression = Class(name="timedAutomata_expressions_UnaryExpression")
timedAutomata_expressions_GroupingExpression = Class(name="timedAutomata_expressions_GroupingExpression")
timedAutomata_expressions_BinaryExpression = Class(name="timedAutomata_expressions_BinaryExpression")
timedAutomata_expressions_AssignmentExpression = Class(name="timedAutomata_expressions_AssignmentExpression")
timedAutomata_expressions_PointExpression = Class(name="timedAutomata_expressions_PointExpression")
timedAutomata_expressions_ForallExpression = Class(name="timedAutomata_expressions_ForallExpression")
timedAutomata_expressions_SimpleIfExpression = Class(name="timedAutomata_expressions_SimpleIfExpression")
timedAutomata_expressions_IdentifierExpression = Class(name="timedAutomata_expressions_IdentifierExpression")
timedAutomata_expressions_WithArgumentsExpression = Class(name="timedAutomata_expressions_WithArgumentsExpression")
timedAutomata_expressions_Selection = Class(name="timedAutomata_expressions_Selection")
timedAutomata_declarations_Declaration = Class(name="timedAutomata_declarations_Declaration", is_abstract=True)
timedAutomata_declarations_VariableDeclaration = Class(name="timedAutomata_declarations_VariableDeclaration")
Declaration = Class(name="Declaration")
types_Type = Class(name="types_Type")
timedAutomata_expressions_ExistsExpression = Class(name="timedAutomata_expressions_ExistsExpression")
timedAutomata_expressions_FixedExpression = Class(name="timedAutomata_expressions_FixedExpression")
timedAutomata_declarations_FunctionDeclaration = Class(name="timedAutomata_declarations_FunctionDeclaration")
declarations_TAParameter = Class(name="declarations_TAParameter")
declarations_Block = Class(name="declarations_Block")
declarations_VariableIdentifier = Class(name="declarations_VariableIdentifier")
timedAutomata_declarations_VariableIdentifier = Class(name="timedAutomata_declarations_VariableIdentifier")
declarations_ArrayDeclarationType = Class(name="declarations_ArrayDeclarationType")
declarations_Initialiser = Class(name="declarations_Initialiser")
timedAutomata_declarations_TypeDeclaration = Class(name="timedAutomata_declarations_TypeDeclaration")
declarations_ArrayDeclaration = Class(name="declarations_ArrayDeclaration")
timedAutomata_declarations_ArrayExpressionType = Class(name="timedAutomata_declarations_ArrayExpressionType")
ArrayDeclarationType = Class(name="ArrayDeclarationType")
timedAutomata_declarations_ArrayTypeType = Class(name="timedAutomata_declarations_ArrayTypeType")
timedAutomata_declarations_Initialiser = Class(name="timedAutomata_declarations_Initialiser", is_abstract=True)
timedAutomata_declarations_ExpressionInitialiser = Class(name="timedAutomata_declarations_ExpressionInitialiser")
timedAutomata_declarations_ChannelPriorityDeclaration = Class(name="timedAutomata_declarations_ChannelPriorityDeclaration")
declarations_ChannelPriority = Class(name="declarations_ChannelPriority")
timedAutomata_declarations_FieldDeclaration = Class(name="timedAutomata_declarations_FieldDeclaration")
timedAutomata_declarations_ArrayDeclaration = Class(name="timedAutomata_declarations_ArrayDeclaration")
timedAutomata_declarations_ArrayDeclarationType = Class(name="timedAutomata_declarations_ArrayDeclarationType")
timedAutomata_declarations_Block = Class(name="timedAutomata_declarations_Block")
declarations_Declaration = Class(name="declarations_Declaration")
declarations_Statement = Class(name="declarations_Statement")
timedAutomata_declarations_Statement = Class(name="timedAutomata_declarations_Statement", is_abstract=True)
timedAutomata_declarations_BlockStatement = Class(name="timedAutomata_declarations_BlockStatement")
Initialiser = Class(name="Initialiser")
timedAutomata_declarations_ArrayInitialiser = Class(name="timedAutomata_declarations_ArrayInitialiser")
timedAutomata_declarations_TAParameter = Class(name="timedAutomata_declarations_TAParameter", is_abstract=True)
timedAutomata_declarations_CallByValueParameter = Class(name="timedAutomata_declarations_CallByValueParameter")
TAParameter = Class(name="TAParameter")
timedAutomata_declarations_CallByReferenceParameter = Class(name="timedAutomata_declarations_CallByReferenceParameter")
timedAutomata_declarations_WhileLoopStatement = Class(name="timedAutomata_declarations_WhileLoopStatement")
timedAutomata_declarations_ExpressionStatement = Class(name="timedAutomata_declarations_ExpressionStatement")
Statement = Class(name="Statement")
timedAutomata_declarations_ForLoopStatement = Class(name="timedAutomata_declarations_ForLoopStatement")
timedAutomata_declarations_IterationStatement = Class(name="timedAutomata_declarations_IterationStatement")
timedAutomata_declarations_ReturnStatement = Class(name="timedAutomata_declarations_ReturnStatement")
timedAutomata_declarations_ChannelPriority = Class(name="timedAutomata_declarations_ChannelPriority", is_abstract=True)
timedAutomata_declarations_DefaultChannelPriority = Class(name="timedAutomata_declarations_DefaultChannelPriority")
ChannelPriority = Class(name="ChannelPriority")
timedAutomata_declarations_SimpleChannelPriority = Class(name="timedAutomata_declarations_SimpleChannelPriority")
timedAutomata_declarations_DoWhileLoopStatement = Class(name="timedAutomata_declarations_DoWhileLoopStatement")
timedAutomata_declarations_IfStatement = Class(name="timedAutomata_declarations_IfStatement")
timedAutomata_declarations_ExpressionChannelExpression = Class(name="timedAutomata_declarations_ExpressionChannelExpression")
timedAutomata_types_Type = Class(name="timedAutomata_types_Type", is_abstract=True)
declarations_ChannelExpression = Class(name="declarations_ChannelExpression")
timedAutomata_declarations_ComplexChannelPriority = Class(name="timedAutomata_declarations_ComplexChannelPriority")
timedAutomata_declarations_ChannelExpression = Class(name="timedAutomata_declarations_ChannelExpression", is_abstract=True)
timedAutomata_declarations_IdentifierChannelExpression = Class(name="timedAutomata_declarations_IdentifierChannelExpression")
ChannelExpression = Class(name="ChannelExpression")
timedAutomata_types_Scalar = Class(name="timedAutomata_types_Scalar")
timedAutomata_types_IdentifierType = Class(name="timedAutomata_types_IdentifierType")
Type = Class(name="Type")
timedAutomata_types_SimpleType = Class(name="timedAutomata_types_SimpleType")
timedAutomata_types_IntegerRange = Class(name="timedAutomata_types_IntegerRange")
timedAutomata_core_Project = Class(name="timedAutomata_core_Project")
TAElement = Class(name="TAElement")
timedAutomata_types_Struct = Class(name="timedAutomata_types_Struct")
declarations_FieldDeclaration = Class(name="declarations_FieldDeclaration")
core_timedAutomata_Parameter = Class(name="core_timedAutomata_Parameter")
Edge = Class(name="Edge")
timedAutomata_core_Edge = Class(name="timedAutomata_core_Edge")
Template = Class(name="Template")
SystemDefinition = Class(name="SystemDefinition")
timedAutomata_core_Template = Class(name="timedAutomata_core_Template")
core_TAElement = Class(name="core_TAElement")
base_Nameable = Class(name="base_Nameable")
base_Identifyable = Class(name="base_Identifyable")
Location = Class(name="Location")
Updates = Class(name="Updates")
core_timedAutomata_Nail = Class(name="core_timedAutomata_Nail")
Guards = Class(name="Guards")
Selections = Class(name="Selections")
core_timedAutomata_Label = Class(name="core_timedAutomata_Label")
timedAutomata_core_SystemDefinition = Class(name="timedAutomata_core_SystemDefinition")
TemplateInstantiation = Class(name="TemplateInstantiation")
System = Class(name="System")
timedAutomata_core_TAElement = Class(name="timedAutomata_core_TAElement", is_abstract=True)
base_Commentable = Class(name="base_Commentable")
timedAutomata_core_Location = Class(name="timedAutomata_core_Location")
timedAutomata_core_TemplateInstantiation = Class(name="timedAutomata_core_TemplateInstantiation")
timedAutomata_core_System = Class(name="timedAutomata_core_System", is_abstract=True)
timedAutomata_core_SimpleSystem = Class(name="timedAutomata_core_SimpleSystem")
timedAutomata_core_ComplexSystem = Class(name="timedAutomata_core_ComplexSystem")
timedAutomata_core_Updates = Class(name="timedAutomata_core_Updates")
timedAutomata_core_Guards = Class(name="timedAutomata_core_Guards")
timedAutomata_core_Selections = Class(name="timedAutomata_core_Selections")
expressions_Selection = Class(name="expressions_Selection")
...
if_23: BinaryAssociation = BinaryAssociation(
    name="if_23",
    ends={
...
else_28: BinaryAssociation = BinaryAssociation(
    name="else_28",
    ends={
...
else_146: BinaryAssociation = BinaryAssociation(
    name="else_146",
    ends={
...
if_143: BinaryAssociation = BinaryAssociation(
    name="if_143",
    ends={
...
domain_model = DomainModel(
    name="timedAutomata",
    types={timedAutomata_bnf_Synchronisation, Position, expressions_Expression, timedAutomata_base_Commentable, timedAutomata_base_Identifyable, timedAutomata_base_Nameable, timedAutomata_bnf_Identifier, timedAutomata_bnf_SendSynchronisation, Synchronisation, timedAutomata_bnf_ReceiveSynchronisation, timedAutomata_expressions_ArrayVariableExpression, timedAutomata_expressions_IncDecExpression, timedAutomata_expressions_Expression, Commentable, timedAutomata_expressions_ConstantExpression, Expression, timedAutomata_expressions_VariableExpression, Identifier, timedAutomata_expressions_UnaryExpression, timedAutomata_expressions_GroupingExpression, timedAutomata_expressions_BinaryExpression, timedAutomata_expressions_AssignmentExpression, timedAutomata_expressions_PointExpression, timedAutomata_expressions_ForallExpression, timedAutomata_expressions_SimpleIfExpression, timedAutomata_expressions_IdentifierExpression, timedAutomata_expressions_WithArgumentsExpression, timedAutomata_expressions_Selection, timedAutomata_declarations_Declaration, timedAutomata_declarations_VariableDeclaration, Declaration, types_Type, timedAutomata_expressions_ExistsExpression, timedAutomata_expressions_FixedExpression, timedAutomata_declarations_FunctionDeclaration, declarations_TAParameter, declarations_Block, declarations_VariableIdentifier, timedAutomata_declarations_VariableIdentifier, declarations_ArrayDeclarationType, declarations_Initialiser, timedAutomata_declarations_TypeDeclaration, declarations_ArrayDeclaration, timedAutomata_declarations_ArrayExpressionType, ArrayDeclarationType, timedAutomata_declarations_ArrayTypeType, timedAutomata_declarations_Initialiser, timedAutomata_declarations_ExpressionInitialiser, timedAutomata_declarations_ChannelPriorityDeclaration, declarations_ChannelPriority, timedAutomata_declarations_FieldDeclaration, timedAutomata_declarations_ArrayDeclaration, timedAutomata_declarations_ArrayDeclarationType, timedAutomata_declarations_Block, declarations_Declaration, declarations_Statement, timedAutomata_declarations_Statement, timedAutomata_declarations_BlockStatement, Initialiser, timedAutomata_declarations_ArrayInitialiser, timedAutomata_declarations_TAParameter, timedAutomata_declarations_CallByValueParameter, TAParameter, timedAutomata_declarations_CallByReferenceParameter, timedAutomata_declarations_WhileLoopStatement, timedAutomata_declarations_ExpressionStatement, Statement, timedAutomata_declarations_ForLoopStatement, timedAutomata_declarations_IterationStatement, timedAutomata_declarations_ReturnStatement, timedAutomata_declarations_ChannelPriority, timedAutomata_declarations_DefaultChannelPriority, ChannelPriority, timedAutomata_declarations_SimpleChannelPriority, timedAutomata_declarations_DoWhileLoopStatement, timedAutomata_declarations_IfStatement, timedAutomata_declarations_ExpressionChannelExpression, timedAutomata_types_Type, declarations_ChannelExpression, timedAutomata_declarations_ComplexChannelPriority, timedAutomata_declarations_ChannelExpression, timedAutomata_declarations_IdentifierChannelExpression, ChannelExpression, timedAutomata_types_Scalar, timedAutomata_types_IdentifierType, Type, timedAutomata_types_SimpleType, timedAutomata_types_IntegerRange, timedAutomata_core_Project, TAElement, timedAutomata_types_Struct, declarations_FieldDeclaration, core_timedAutomata_Parameter, Edge, timedAutomata_core_Edge, Template, SystemDefinition, timedAutomata_core_Template, core_TAElement, base_Nameable, base_Identifyable, Location, Updates, core_timedAutomata_Nail, Guards, Selections, core_timedAutomata_Label, timedAutomata_core_SystemDefinition, TemplateInstantiation, System, timedAutomata_core_TAElement, base_Commentable, timedAutomata_core_Location, timedAutomata_core_TemplateInstantiation, timedAutomata_core_System, timedAutomata_core_SimpleSystem, timedAutomata_core_ComplexSystem, timedAutomata_core_Updates, timedAutomata_core_Guards, timedAutomata_core_Selections, expressions_Selection, BinaryOperator, AssignOperator, FixedExpressionType, UnaryOperator, PriorityOperator, TypePrefix, TypeId},
    associations={expression0, expression2, position4, identifier1, leftSide16, rightSide18, expression21, expression7, expression9, left11, right13, arguments35, expression38, identifier40, if_23, then25, else_28, identifier31, expression33, identifier58, identifier43, type45, expression47, identifier50, type52, expression55, type74, identifier76, parameters79, type60, variableIdentifiers62, identifier64, arrayDeclarationTypes66, initialiser68, type70, arrayDeclarations72, expression94, type96, block81, channelPriority83, type84, arrayDeclarations86, identifier89, types91, declarations107, statements108, expression98, initialisers100, type102, arrayDeclaration104, identifier123, type125, statement128, condition131, expression110, initExpression112, loopConditionExpression114, terminalExpression117, statement120, else_146, expression149, statement133, statement136, condition138, condition141, if_143, channelExpression159, expression161, channelExpression151, leftSideChannelExpression152, rightSideChannelExpression154, identifier157, secondIndex168, scalar171, identifier164, firstIndex166, fieldDeclarations173, taParameters184, locations186, edges189, globalDeclarations174, templates176, systemDeclaration178, declarations180, initial182, updates202, nails204, source191, target193, guards196, synchronisation198, selections200, label208, templateInstantiations210, invariant206, rightSideSystem217, processIdentifier220, systems211, Identifier213, leftSideSystem215, selections231, expressions232, conditions234, processParameters222, templateIdentifier225, templateArguments228},
    generalizations={gen_timedAutomata_bnf_Synchronisation_Position, gen_timedAutomata_bnf_SendSynchronisation_Synchronisation, gen_timedAutomata_bnf_ReceiveSynchronisation_Synchronisation, gen_timedAutomata_expressions_ArrayVariableExpression_Expression, gen_timedAutomata_expressions_IncDecExpression_Expression, gen_timedAutomata_expressions_Expression_Commentable, gen_timedAutomata_expressions_ConstantExpression_Expression, gen_timedAutomata_expressions_VariableExpression_Expression, gen_timedAutomata_expressions_UnaryExpression_Expression, gen_timedAutomata_expressions_GroupingExpression_Expression, gen_timedAutomata_expressions_BinaryExpression_Expression, gen_timedAutomata_expressions_AssignmentExpression_Expression, gen_timedAutomata_expressions_PointExpression_Expression, gen_timedAutomata_expressions_ForallExpression_Expression, gen_timedAutomata_expressions_SimpleIfExpression_Expression, gen_timedAutomata_expressions_IdentifierExpression_Expression, gen_timedAutomata_expressions_WithArgumentsExpression_Expression, gen_timedAutomata_declarations_Declaration_Commentable, gen_timedAutomata_declarations_VariableDeclaration_Declaration, gen_timedAutomata_expressions_ExistsExpression_Expression, gen_timedAutomata_expressions_FixedExpression_Expression, gen_timedAutomata_declarations_FunctionDeclaration_Declaration, gen_timedAutomata_declarations_TypeDeclaration_Declaration, gen_timedAutomata_declarations_ArrayExpressionType_ArrayDeclarationType, gen_timedAutomata_declarations_ArrayTypeType_ArrayDeclarationType, gen_timedAutomata_declarations_ChannelPriorityDeclaration_Declaration, gen_timedAutomata_declarations_CallByReferenceParameter_TAParameter, gen_timedAutomata_declarations_BlockStatement_declarations_Statement, gen_timedAutomata_declarations_BlockStatement_declarations_Block, gen_timedAutomata_declarations_ExpressionInitialiser_Initialiser, gen_timedAutomata_declarations_ArrayInitialiser_Initialiser, gen_timedAutomata_declarations_CallByValueParameter_TAParameter, gen_timedAutomata_declarations_WhileLoopStatement_Statement, gen_timedAutomata_declarations_ExpressionStatement_Statement, gen_timedAutomata_declarations_ForLoopStatement_Statement, gen_timedAutomata_declarations_IterationStatement_Statement, gen_timedAutomata_declarations_ReturnStatement_Statement, gen_timedAutomata_declarations_DefaultChannelPriority_ChannelPriority, gen_timedAutomata_declarations_SimpleChannelPriority_ChannelPriority, gen_timedAutomata_declarations_DoWhileLoopStatement_Statement, gen_timedAutomata_declarations_IfStatement_Statement, gen_timedAutomata_declarations_ExpressionChannelExpression_ChannelExpression, gen_timedAutomata_declarations_ComplexChannelPriority_ChannelPriority, gen_timedAutomata_declarations_IdentifierChannelExpression_ChannelExpression, gen_timedAutomata_types_Scalar_Type, gen_timedAutomata_types_IdentifierType_Type, gen_timedAutomata_types_SimpleType_Type, gen_timedAutomata_types_IntegerRange_Type, gen_timedAutomata_core_Project_TAElement, gen_timedAutomata_types_Struct_Type, gen_timedAutomata_core_Edge_core_TAElement, gen_timedAutomata_core_Edge_Position, gen_timedAutomata_core_Template_core_TAElement, gen_timedAutomata_core_Template_base_Nameable, gen_timedAutomata_core_Template_base_Identifyable, gen_timedAutomata_core_TAElement_base_Commentable, gen_timedAutomata_core_TAElement_base_Nameable, gen_timedAutomata_core_Location_core_TAElement, gen_timedAutomata_core_Location_Position, gen_timedAutomata_core_SimpleSystem_System, gen_timedAutomata_core_ComplexSystem_System, gen_timedAutomata_core_Updates_Position, gen_timedAutomata_core_Guards_Position, gen_timedAutomata_core_Selections_Position},
    metadata=None
)
