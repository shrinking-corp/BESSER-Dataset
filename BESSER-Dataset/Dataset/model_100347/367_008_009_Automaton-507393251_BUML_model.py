...
automaton_ParameterBinding.attributes={automaton_ParameterBinding_symbolicName, automaton_ParameterBinding_value}
...
domain_model = DomainModel(
    name="automaton",
    types={automaton_InternalModel, automaton_Automaton, automaton_TimedZone, automaton_Event, automaton_EventToken, automaton_State, automaton_InitState, automaton_FinalState, automaton_TrapState, automaton_ParameterTable, State, automaton_Transition, automaton_TypedTransition, Transition, automaton_Guard, automaton_Parameter, automaton_NegativeTransition, TypedTransition, automaton_EpsilonTransition, automaton_EventPattern, automaton_Within, TimedZone, automaton_HoldsFor, automaton_ParameterBinding, EventContext},
    associations={eventTokens10, automata0, latestEvent1, enabledForTheLatestEvent3, eventTokensInModel6, states8, currentState21, timedZones13, initialState15, finalStates17, trapState19, recordedEvents22, lastProcessed25, outTransitions33, timedZones28, parameterTable31, eventTokens35, lastProcessedEvent36, inStateOf39, outStateOf40, inTransitions32, postState44, guards46, parameters47, preState42, inState51, outState53, eventType49, transition50, transition55, parameterBindings57, eventToken58, parameterTable61},
