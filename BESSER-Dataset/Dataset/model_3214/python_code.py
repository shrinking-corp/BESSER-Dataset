...
class types_Member:
    ...
    pass
class gast_functions_Delegate(functions_Function, types_GASTType, types_Member):
...
class gast_types_GASTClass(types_GASTType, types_Member):
    ...
    def __init__(self, linesOfComments: int, local: bool, primitive: bool, interface: bool, anonymous: bool, inner: bool, surroundingClass184: set["Delegate"] = None, surroundingClass: set["TypeAlias"] = None, surroundingClass187: set["Constructor"] = None, surroundingClass189: set["Destructor"] = None, surroundingClass191: set["Field"] = None, surroundingClass193: set["Method"] = None, localClasses: "Function" = None, classes: "Package" = None, gast_types_GASTClass: set["GASTClass"] = None, surroundingClass201: set["GASTClass"] = None, gast_types_GASTClass215: set["Function"] = None, gast_types_GASTClass218: set["Property"] = None, gast_types_GASTClass220: set["Access"] = None, gast_types_GASTClass223: set["GASTClass"] = None, innerClasses: "GASTClass" = None, gast_types_GASTClass206: set["InheritanceTypeAccess"] = None, gast_types_GASTClass208: "Field" = None, gastClass: set["GASTClass"] = None, friendClasses: "GASTClass" = None):
...
class gast_annotations_Comment(annotations_ModelAnnotation, core_SourceEntity):
    ...
    def __init__(self, formal: bool, todo: bool, todoCount: int, texts: str):
        self.formal = formal
        self.todo = todo
...
class gast_accesses_VariableAccess(Access):
    ...
    def __init__(self, write: bool, gast_accesses_VariableAccess: "Variable" = None, Access: "gast_core_Package" = None, Access296: "gast_functions_Function" = None, Access77: "gast_core_Root" = None, Access221: "gast_types_GASTClass" = None):
        self.write = write
...
class gast_core_File(NamedModelElement):
    ...
    def __init__(self, sourceFile: bool, assemblyFile: bool, linesOfCode: int, size: str, fullQualifiedPath: str, fileSystemPath: str, gast_core_File: "Root" = None, gast_core_File121: set["GASTType"] = None, gast_core_File124: set["GASTType"] = None, gast_core_File142: set["File"] = None, gast_core_File127: set["GlobalVariable"] = None, gast_core_File130: set["GlobalFunction"] = None, gast_core_File133: set["GlobalFunction"] = None, gast_core_File136: set["GlobalVariable"] = None, gast_core_File139: set["Package"] = None, files: "Directory" = None):
...
class gast_core_Directory(NamedModelElement):
    ...
    def __init__(self, fullQualifiedPath: str, fileSystemPath: str, directory: set["File"] = None, directories: "BasePath" = None, parentDirectory: set["Directory"] = None, subDirectory: "Directory" = None):
        self.fullQualifiedPath = fullQualifiedPath
        self.fileSystemPath = fileSystemPath
...
class gast_core_Root(ModelElement):
    ...
    def __init__(self, linesOfComments: int, linesOfCode: int, gast_core_Root79: set["GASTClass"] = None, gast_core_Root: set["Access"] = None, gast_core_Root82: set["GASTClass"] = None, gast_core_Root85: set["GASTClass"] = None, gast_core_Root88: set["GASTClass"] = None, gast_core_Root91: set["ModelElement"] = None, gast_core_Root93: set["GlobalVariable"] = None, root: set["Package"] = None, root98: set["Clone"] = None, gast_core_Root100: set["StructuralAbstraction"] = None, gast_core_Root102: set["GASTType"] = None, gast_core_Root104: set["ModelElement"] = None, root107: set["BasePath"] = None, root109: set["GlobalFunction"] = None, ModelElement105: "gast_core_Root" = None, ModelElement263: "gast_accesses_Access" = None, ModelElement: "gast_core_Root" = None):
        self.linesOfComments = linesOfComments
        self.linesOfCode = linesOfCode
...
class gast_core_NamedModelElement(ModelElement):
    ...
    def __init__(self, simpleName: str, ModelElement105: "gast_core_Root" = None, ModelElement263: "gast_accesses_Access" = None, ModelElement: "gast_core_Root" = None):
...
class gast_core_BasePath(ModelElement):
    ...
    def __init__(self, path: str, basePaths: "Root" = None, basePath: set["Directory"] = None, ModelElement105: "gast_core_Root" = None, ModelElement263: "gast_accesses_Access" = None, ModelElement: "gast_core_Root" = None):
        self.path = path
...
class gast_statements_JumpStatement(Statement):
    ...
    def __init__(self, kind: str, gast_statements_JumpStatement: "GASTExpression" = None, Statement291: "gast_functions_Function" = None, Statement21: "gast_statements_Branch" = None, Statement235: "gast_accesses_BaseAccess" = None, Statement33: "gast_statements_LoopStatement" = None, Statement15: "gast_statements_BlockStatement" = None, Statement160: "gast_annotations_CloneInstance" = None, Statement233: "gast_accesses_BaseAccess" = None, Statement: "gast_statements_Statement" = None):
        self.kind = kind
...
class gast_statements_LoopStatement(Statement):
    ...
    def __init__(self, kind: str, gast_statements_LoopStatement: "GASTExpression" = None, gast_statements_LoopStatement27: "GASTExpression" = None, gast_statements_LoopStatement30: "GASTExpression" = None, loopstatement: "Statement" = None, Statement291: "gast_functions_Function" = None, Statement21: "gast_statements_Branch" = None, Statement235: "gast_accesses_BaseAccess" = None, Statement33: "gast_statements_LoopStatement" = None, Statement15: "gast_statements_BlockStatement" = None, Statement160: "gast_annotations_CloneInstance" = None, Statement233: "gast_accesses_BaseAccess" = None, Statement: "gast_statements_Statement" = None):
        self.kind = kind
...
class gast_functions_GlobalFunction(Function):
    ...
    def __init__(self, kind: str, globalFunctions: "Package" = None, globalFunctions280: "Root" = None, Function256: "gast_accesses_FunctionAccess" = None, Function195: "gast_types_GASTClass" = None, Function312: "gast_variables_LocalVariable" = None, Function241: "gast_accesses_BaseAccess" = None, Function: "gast_statements_BlockStatement" = None, Function216: "gast_types_GASTClass" = None, Function248: "gast_accesses_DelegateAccess" = None, Function268: "gast_functions_Delegate" = None, Function304: "gast_variables_FormalParameter" = None, Function245: "gast_accesses_DeclarationTypeAccess" = None):
        self.kind = kind
