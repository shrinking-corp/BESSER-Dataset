...
domain_model = DomainModel(
    name="units",
    types={units_BaseUnit, units_UnitRepository, units_UnitMultiplication, Unit, units_UnitPower, units_UnitLiteral, units_UnitCarryingElement, units_Unit},
    associations={units1, units2, unit4, baseUnit6, unit0},
