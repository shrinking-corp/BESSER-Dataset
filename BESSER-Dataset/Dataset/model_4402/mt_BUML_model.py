...
# Classes
mt_Resource = Class(name="mt_Resource", is_abstract=True)
mt_core_ASTNode = Class(name="mt_core_ASTNode", is_abstract=True)
mt_core_Template = Class(name="mt_core_Template")
Resource = Class(name="Resource")
core_mt_Resource = Class(name="core_mt_Resource")
Script = Class(name="Script")
mt_core_Script = Class(name="mt_core_Script")
ASTNode = Class(name="ASTNode")
mt_ResourceSet = Class(name="mt_ResourceSet")
Method_ = Class(name="Method")
mt_core_Method = Class(name="mt_core_Method")
Parameter_ = Class(name="Parameter")
mt_core_Parameter = Class(name="mt_core_Parameter")
mt_expressions_Expression = Class(name="mt_expressions_Expression", is_abstract=True)
mt_expressions_CallSet = Class(name="mt_expressions_CallSet")
Call = Class(name="Call")
mt_expressions_Call = Class(name="mt_expressions_Call")
ScriptDescriptor = Class(name="ScriptDescriptor")
Statement = Class(name="Statement")
mt_core_ScriptDescriptor = Class(name="mt_core_ScriptDescriptor")
FilePath = Class(name="FilePath")
Expression = Class(name="Expression")
mt_core_FilePath = Class(name="mt_core_FilePath")
mt_core_Metamodel = Class(name="mt_core_Metamodel")
mt_core_Service = Class(name="mt_core_Service")
mt_expressions_IntegerLiteral = Class(name="mt_expressions_IntegerLiteral")
mt_expressions_DoubleLiteral = Class(name="mt_expressions_DoubleLiteral")
mt_expressions_BooleanLiteral = Class(name="mt_expressions_BooleanLiteral")
mt_expressions_NullLiteral = Class(name="mt_expressions_NullLiteral")
mt_statements_Statement = Class(name="mt_statements_Statement", is_abstract=True)
mt_statements_Comment = Class(name="mt_statements_Comment")
mt_statements_If = Class(name="mt_statements_If")
mt_expressions_Not = Class(name="mt_expressions_Not")
mt_expressions_Operator = Class(name="mt_expressions_Operator")
mt_expressions_Parenthesis = Class(name="mt_expressions_Parenthesis")
mt_expressions_Literal = Class(name="mt_expressions_Literal", is_abstract=True)
mt_expressions_StringLiteral = Class(name="mt_expressions_StringLiteral")
Literal = Class(name="Literal")
If = Class(name="If")
mt_statements_For = Class(name="mt_statements_For")
mt_statements_Feature = Class(name="mt_statements_Feature")
mt_statements_Text = Class(name="mt_statements_Text")
...
mt_core_Template.attributes={mt_core_Template_beginTag, mt_core_Template_endTag}
...
mt_core_Method_return_: Property = Property(name="return_", type=StringType)
mt_core_Method.attributes={mt_core_Method_name, mt_core_Method_return_}
...
mt_expressions_Call.attributes={mt_expressions_Call_prefix, mt_expressions_Call_name}
...
domain_model = DomainModel(
    name="mt",
    types={mt_Resource, mt_core_ASTNode, mt_core_Template, Resource, core_mt_Resource, Script, mt_core_Script, ASTNode, mt_ResourceSet, Method_, mt_core_Method, Parameter_, mt_core_Parameter, mt_expressions_Expression, mt_expressions_CallSet, Call, mt_expressions_Call, ScriptDescriptor, Statement, mt_core_ScriptDescriptor, FilePath, Expression, mt_core_FilePath, mt_core_Metamodel, mt_core_Service, mt_expressions_IntegerLiteral, mt_expressions_DoubleLiteral, mt_expressions_BooleanLiteral, mt_expressions_NullLiteral, mt_statements_Statement, mt_statements_Comment, mt_statements_If, mt_expressions_Not, mt_expressions_Operator, mt_expressions_Parenthesis, mt_expressions_Literal, mt_expressions_StringLiteral, Literal, If, mt_statements_For, mt_statements_Feature, mt_statements_Text},
    associations={resources0, imports1, scripts2, methods12, parameters13, calls14, arguments15, descriptor4, statements5, file7, post8, statements10, condition26, thenStatements28, elseStatements31, filter17, expression20, operands22, expression24, elseIf34, iterator36, statements38, expression41},
    generalizations={gen_mt_core_Template_Resource, gen_mt_core_Script_ASTNode, gen_mt_expressions_Expression_ASTNode, gen_mt_expressions_CallSet_Expression, gen_mt_expressions_Call_ASTNode, gen_mt_core_ScriptDescriptor_ASTNode, gen_mt_core_FilePath_ASTNode, gen_mt_core_Metamodel_Resource, gen_mt_core_Service_Resource, gen_mt_expressions_IntegerLiteral_Literal, gen_mt_expressions_DoubleLiteral_Literal, gen_mt_expressions_BooleanLiteral_Literal, gen_mt_expressions_NullLiteral_Literal, gen_mt_statements_Statement_ASTNode, gen_mt_statements_Comment_Statement, gen_mt_statements_If_Statement, gen_mt_expressions_Not_Expression, gen_mt_expressions_Operator_Expression, gen_mt_expressions_Parenthesis_Expression, gen_mt_expressions_Literal_Expression, gen_mt_expressions_StringLiteral_Literal, gen_mt_statements_For_Statement, gen_mt_statements_Feature_Statement, gen_mt_statements_Text_Statement},
    metadata=None
)
