...
# Classes
behaviour_BehaviourContainer = Class(name="behaviour_BehaviourContainer")
behaviour_DynamicRobot = Class(name="behaviour_DynamicRobot")
behaviour_TaskExecution = Class(name="behaviour_TaskExecution")
behaviour_TaskRequirement = Class(name="behaviour_TaskRequirement")
behaviour_BehaviouralPropertyKeyContainer = Class(name="behaviour_BehaviouralPropertyKeyContainer")
behaviour_Message = Class(name="behaviour_Message")
NamedElement = Class(name="NamedElement")
behaviour_Property = Class(name="behaviour_Property")
behaviour_AreaObject = Class(name="behaviour_AreaObject")
behaviour_MeasureValue = Class(name="behaviour_MeasureValue")
behaviour_CommunicationAction = Class(name="behaviour_CommunicationAction", is_abstract=True)
Action = Class(name="Action")
behaviour_UnicastCommunication = Class(name="behaviour_UnicastCommunication")
CommunicationAction = Class(name="CommunicationAction")
behaviour_MulticastCommunication = Class(name="behaviour_MulticastCommunication")
behaviour_BroadcastCommunication = Class(name="behaviour_BroadcastCommunication")
behaviour_MessageRepository = Class(name="behaviour_MessageRepository")
behaviour_Action = Class(name="behaviour_Action")
behaviour_Task = Class(name="behaviour_Task")
behaviour_RobotCollaboration = Class(name="behaviour_RobotCollaboration")
behaviour_DetectedObject = Class(name="behaviour_DetectedObject")
behaviour_Robot = Class(name="behaviour_Robot")
behaviour_Capability = Class(name="behaviour_Capability")
behaviour_CapabilityProperties = Class(name="behaviour_CapabilityProperties")
behaviour_TaskDescriptor = Class(name="behaviour_TaskDescriptor")
...
behaviour_Message.attributes={behaviour_Message_timestamp, behaviour_Message_needResponse}
...
domain_model = DomainModel(
    name="behaviour",
    types={behaviour_BehaviourContainer, behaviour_DynamicRobot, behaviour_TaskExecution, behaviour_TaskRequirement, behaviour_BehaviouralPropertyKeyContainer, behaviour_Message, NamedElement, behaviour_Property, behaviour_AreaObject, behaviour_MeasureValue, behaviour_CommunicationAction, Action, behaviour_UnicastCommunication, CommunicationAction, behaviour_MulticastCommunication, behaviour_BroadcastCommunication, behaviour_MessageRepository, behaviour_Action, behaviour_Task, behaviour_RobotCollaboration, behaviour_DetectedObject, behaviour_Robot, behaviour_Capability, behaviour_CapabilityProperties, behaviour_TaskDescriptor, PropertyKeyContainer, RobotStatus, TaskExecutionStatus},
    associations={dynamicRobots0, taskExecutions1, taskRequirements3, behaviourKeysContainer5, involvedTaskExecutions7, properties9, referredObjects11, TTL13, follows16, message18, task45, targets22, targets24, robot26, receivedMessages27, sendedMessages29, properties32, currentTaskExecution34, currentTask37, executors39, executionTime42, target20, requirement48, collaborator49, availabilityRange51, properties54, object57, robot59, detectedObjects61, collaborations64, messageRepository67, actions68, executedTasks71, taskExecution74, prerequisite75, properties78, requiredCapabilities81, capabilityProperties83, descriptor85, task87},
    generalizations={gen_behaviour_Message_NamedElement, gen_behaviour_CommunicationAction_Action, gen_behaviour_UnicastCommunication_CommunicationAction, gen_behaviour_MulticastCommunication_CommunicationAction, gen_behaviour_BroadcastCommunication_CommunicationAction, gen_behaviour_MessageRepository_NamedElement, gen_behaviour_Action_NamedElement, gen_behaviour_TaskExecution_NamedElement, gen_behaviour_DynamicRobot_NamedElement, gen_behaviour_TaskRequirement_NamedElement, gen_behaviour_BehaviouralPropertyKeyContainer_PropertyKeyContainer},
    metadata=None
)
