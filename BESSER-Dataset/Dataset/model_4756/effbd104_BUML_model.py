...
effbd104_Function = Class(name="effbd104_Function")
effbd104_Start = Class(name="effbd104_Start")
effbd104_Final = Class(name="effbd104_Final")
effbd104_Loop = Class(name="effbd104_Loop")
Port = Class(name="Port")
effbd104_Port = Class(name="effbd104_Port", is_abstract=True)
effbd104_Sequence = Class(name="effbd104_Sequence", is_abstract=True)
effbd104_Flow = Class(name="effbd104_Flow")
effbd104_Item = Class(name="effbd104_Item")
effbd104_OutputPort = Class(name="effbd104_OutputPort")
effbd104_InputPort = Class(name="effbd104_InputPort")
effbd104_Description = Class(name="effbd104_Description")
effbd104_Token = Class(name="effbd104_Token")
effbd104_ProcessNode = Class(name="effbd104_ProcessNode", is_abstract=True)
effbd104_SequenceNode = Class(name="effbd104_SequenceNode", is_abstract=True)
effbd104_And = Class(name="effbd104_And")
Sequence = Class(name="Sequence")
effbd104_Or = Class(name="effbd104_Or")
effbd104_Iteration = Class(name="effbd104_Iteration")
effbd104_LoopExit = Class(name="effbd104_LoopExit")
...
domain_model = DomainModel(
    name="effbd104",
    types={SequenceNode, ProcessNode, effbd104_Function, effbd104_Start, effbd104_Final, effbd104_Loop, Port, effbd104_Port, effbd104_Sequence, effbd104_Flow, effbd104_Item, effbd104_OutputPort, effbd104_InputPort, effbd104_Description, effbd104_Token, effbd104_ProcessNode, effbd104_SequenceNode, effbd104_And, Sequence, effbd104_Or, effbd104_Iteration, effbd104_LoopExit, FunctionDomain},
    associations={decompositions1, sequenceNodes2, flows4, outputPorts6, inputPorts8, descriptions10, inputflowEdge16, items19, tokens12, controlFlowEdge15, outputflowEdge21},
    generalizations={gen_effbd104_Function_SequenceNode, gen_effbd104_Function_ProcessNode, gen_effbd104_Start_Sequence, gen_effbd104_Final_Sequence, gen_effbd104_Loop_Sequence, gen_effbd104_InputPort_Port, gen_effbd104_Flow_ProcessNode, gen_effbd104_Sequence_SequenceNode, gen_effbd104_And_Sequence, gen_effbd104_Or_Sequence, gen_effbd104_Iteration_Sequence, gen_effbd104_OutputPort_Port, gen_effbd104_LoopExit_Sequence},
    metadata=None
)
