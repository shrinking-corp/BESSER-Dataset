...
class employee_PhoneNumber:
    ...
    def __init__(self, areaCode: str, number: str, type: str, phoneNumbers: "employee_Employee" = None, PhoneNumber: "employee_Employee" = None):
...
class employee_Degree:
    ...
    def __init__(self, name: str, employee_Degree27: "employee_Employee" = None, employee_Degree: "employee_Directory" = None):
        self.name = name
...
class employee_Employee:
    ...
    def __init__(self, firstName: str, lastName: str, gender: str, salary: float, responsibilities: str, Employee: "employee_PhoneNumber" = None, employee_Employee: "employee_Directory" = None, owner: set["employee_PhoneNumber"] = None, employee_Employee26: set["employee_Degree"] = None, employee_Employee29: set["employee_Project"] = None, employee_Employee32: set["employee_EmailAddress"] = None, employee_Employee9: "employee_Project" = None, employee_Employee12: "employee_EmploymentPeriod" = None, employee_Employee14: "employee_Address" = None, employee_Employee16: "employee_JobTitle" = None, Employee20: "employee_Employee" = None, managedEmployees: "employee_Employee" = None, Employee23: "employee_Employee" = None, manager: set["employee_Employee"] = None):
...
class employee_Project(ABC):
    ...
    def __init__(self, name: str, description: str, employee_Project: "employee_Directory" = None, employee_Project30: "employee_Employee" = None, employee_Project8: "employee_Employee" = None):
        self.name = name
...
class employee_Directory:
    ...
    def __init__(self, name: str, employee_Directory: set["employee_Project"] = None, employee_Directory2: set["employee_Employee"] = None, employee_Directory4: set["employee_JobTitle"] = None, employee_Directory6: set["employee_Degree"] = None):
        self.name = name
