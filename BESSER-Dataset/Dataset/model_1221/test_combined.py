...
def test_hyp_ecore_ocl_ereference_is_not_abstract():
    assert not inspect.isabstract(ecore_ocl_EReference)


def test_hyp_ecore_ocl_ereference_constructor_exists():
    assert callable(ecore_ocl_EReference.__init__)


def test_hyp_ecore_ocl_ereference_constructor_args():
...
def test_hyp_ocl_ecore_oppositepropertycallexp_is_not_abstract():
    assert not inspect.isabstract(ocl_ecore_OppositePropertyCallExp)


def test_hyp_ocl_ecore_oppositepropertycallexp_constructor_exists():
    assert callable(ocl_ecore_OppositePropertyCallExp.__init__)


def test_hyp_ocl_ecore_oppositepropertycallexp_constructor_args():
