...
mindstorms_Choregraphy = Class(name="mindstorms_Choregraphy")
Flow = Class(name="Flow")
mindstorms_Reuse = Class(name="mindstorms_Reuse")
...
mindstorms_ConditionalFlow = Class(name="mindstorms_ConditionalFlow", is_abstract=True)
...
mindstorms_UltrasonicSensor.attributes={mindstorms_UltrasonicSensor_value, mindstorms_UltrasonicSensor_operator}
...
domain_model = DomainModel(
    name="mindstorms",
    types={mindstorms_Instruction, mindstorms_Flow, Instruction, mindstorms_Choregraphy, Flow, mindstorms_Reuse, mindstorms_Condition, mindstorms_Sensor, Condition, mindstorms_If, ConditionalFlow, mindstorms_While, mindstorms_GoForward, Action, mindstorms_GoBackward, mindstorms_Rotate, mindstorms_GoTo, mindstorms_ReturnToBase, mindstorms_Grab, mindstorms_Release, mindstorms_Delay, mindstorms_TouchSensor, Sensor, mindstorms_Action, mindstorms_ConditionalFlow, mindstorms_UltrasonicSensor, mindstorms_ColorSensor, Color, OperatorKind},
    associations={next1, previous3, first5, instructions6, condition10, elsif12, choregraphy9},
    generalizations={gen_mindstorms_Flow_Instruction, gen_mindstorms_Choregraphy_Flow, gen_mindstorms_Reuse_Instruction, gen_mindstorms_Sensor_Condition, gen_mindstorms_If_ConditionalFlow, gen_mindstorms_While_ConditionalFlow, gen_mindstorms_GoForward_Action, gen_mindstorms_GoBackward_Action, gen_mindstorms_Rotate_Action, gen_mindstorms_GoTo_Action, gen_mindstorms_ReturnToBase_Action, gen_mindstorms_Grab_Action, gen_mindstorms_Release_Action, gen_mindstorms_Delay_Action, gen_mindstorms_TouchSensor_Sensor, gen_mindstorms_Action_Instruction, gen_mindstorms_ConditionalFlow_Flow, gen_mindstorms_UltrasonicSensor_Sensor, gen_mindstorms_ColorSensor_Sensor},
    metadata=None
)
