...
# Classes
studyplan_Program = Class(name="studyplan_Program")
studyplan_Semester = Class(name="studyplan_Semester")
studyplan_Specialization = Class(name="studyplan_Specialization")
studyplan_Department = Class(name="studyplan_Department")
studyplan_SemesterCourse = Class(name="studyplan_SemesterCourse")
...
studyplan_Semester.attributes={studyplan_Semester_season, studyplan_Semester_year, studyplan_Semester_name}
...
domain_model = DomainModel(
    name="studyplan",
    types={studyplan_Program, studyplan_Semester, studyplan_Specialization, studyplan_Department, studyplan_SemesterCourse, studyplan_Course, CourseStatus, Season},
    associations={semesters0, specializations1, department3, courses4, semesters6, specializations10, department12, course14, courses16, programs17},
    generalizations={},
    metadata=None
)
