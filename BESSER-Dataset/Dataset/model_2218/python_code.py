...
class studyplan_Department:
    ...
    def __init__(self, name: str, department18: set["studyplan_Program"] = None, Department: "studyplan_Program" = None, Department13: "studyplan_Course" = None, department: set["studyplan_Course"] = None):
        self.name = name
...
class studyplan_Program:
    ...
    def __init__(self, code: str, name: str, Program: "studyplan_Department" = None, studyplan_Program: set["studyplan_Semester"] = None, studyplan_Program2: set["studyplan_Specialization"] = None, programs: "studyplan_Department" = None):
        self.code = code
        self.name = name
