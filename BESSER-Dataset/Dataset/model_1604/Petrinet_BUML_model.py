...
# Classes
PetrinetDSL_Petrinet = Class(name="PetrinetDSL_Petrinet")
PetrinetDSL_Node = Class(name="PetrinetDSL_Node")
Petrinet = Class(name="Petrinet")
PetrinetDSL_Edge = Class(name="PetrinetDSL_Edge")
PetrinetDSL_Token = Class(name="PetrinetDSL_Token")
Node = Class(name="Node")
PetrinetDSL_Transition = Class(name="PetrinetDSL_Transition")
PetrinetDSL_Place = Class(name="PetrinetDSL_Place")
PetrinetDSL_PTEdge = Class(name="PetrinetDSL_PTEdge")
Edge = Class(name="Edge")
PetrinetDSL_TPEdge = Class(name="PetrinetDSL_TPEdge")
...
PetrinetDSL_Petrinet.attributes={PetrinetDSL_Petrinet_name, PetrinetDSL_Petrinet_description}
...
domain_model = DomainModel(
    name="PetrinetDSL",
    types={PetrinetDSL_Petrinet, PetrinetDSL_Node, Petrinet, PetrinetDSL_Edge, PetrinetDSL_Token, Node, PetrinetDSL_Transition, PetrinetDSL_Place, PetrinetDSL_PTEdge, Edge, PetrinetDSL_TPEdge},
    associations={mapelements1, tokens2, fromPlace3, toTransition5, fromTransition7, toPlace9},
    generalizations={gen_PetrinetDSL_Node_Petrinet, gen_PetrinetDSL_Edge_Petrinet, gen_PetrinetDSL_Token_Node, gen_PetrinetDSL_Transition_Node, gen_PetrinetDSL_Place_Node, gen_PetrinetDSL_PTEdge_Edge, gen_PetrinetDSL_TPEdge_Edge},
    metadata=None
)
