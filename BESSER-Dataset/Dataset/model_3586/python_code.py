...
class TypeA_ObjectS(ObjectR):
    ...
    def __init__(self, nameS: str, ObjectR: "TypeA_ListElement" = None):
        self.nameS = nameS
...
class TypeA_ObjectY(ObjectX):
    ...
    def __init__(self, nameY: str, ObjectX: "TypeA_ListElement" = None):
        self.nameY = nameY
...
class TypeA_D(AA):
    ...
    def __init__(self, nameD: str, AA: "TypeA_ListElement" = None, AA3: "TypeA_ListElement" = None):
        self.nameD = nameD
...
class TypeA_B(AA):
    ...
    def __init__(self, nameB: str, AA: "TypeA_ListElement" = None, AA3: "TypeA_ListElement" = None):
        self.nameB = nameB
