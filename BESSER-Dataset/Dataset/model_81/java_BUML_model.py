...
# Classes
java__SingleVariableDeclaration = Class(name="java__SingleVariableDeclaration")
java__TypeAccess = Class(name="java__TypeAccess")
java__TypeParameter = Class(name="java__TypeParameter")
java__MethodRef = Class(name="java__MethodRef")
java__AbstractMethodInvocation = Class(name="java__AbstractMethodInvocation", is_abstract=True)
ASTNode = Class(name="ASTNode")
java__Expression = Class(name="java__Expression", is_abstract=True)
java__AbstractTypeDeclaration = Class(name="java__AbstractTypeDeclaration", is_abstract=True)
java__AbstractMethodDeclaration = Class(name="java__AbstractMethodDeclaration", is_abstract=True)
BodyDeclaration = Class(name="BodyDeclaration")
java__Block = Class(name="java__Block")
java__VariableDeclarationFragment = Class(name="java__VariableDeclarationFragment")
java__Annotation = Class(name="java__Annotation")
java__AnnotationMemberValuePair = Class(name="java__AnnotationMemberValuePair")
java__Archive = Class(name="java__Archive")
NamedElement = Class(name="NamedElement")
java__ClassFile = Class(name="java__ClassFile")
java__Manifest = Class(name="java__Manifest")
Type = Class(name="Type")
java__BodyDeclaration = Class(name="java__BodyDeclaration", is_abstract=True)
java__Comment = Class(name="java__Comment", is_abstract=True)
java__Package = Class(name="java__Package")
java__AbstractTypeQualifiedExpression = Class(name="java__AbstractTypeQualifiedExpression", is_abstract=True)
Expression = Class(name="Expression")
java__AbstractVariablesContainer = Class(name="java__AbstractVariablesContainer", is_abstract=True)
java__CompilationUnit = Class(name="java__CompilationUnit")
java__AnnotationTypeMemberDeclaration = Class(name="java__AnnotationTypeMemberDeclaration")
java__AnnotationTypeDeclaration = Class(name="java__AnnotationTypeDeclaration")
AbstractTypeDeclaration = Class(name="AbstractTypeDeclaration")
java__AnonymousClassDeclaration = Class(name="java__AnonymousClassDeclaration")
java__AssertStatement = Class(name="java__AssertStatement")
Statement = Class(name="Statement")
java__ASTNode = Class(name="java__ASTNode", is_abstract=True)
java__ArrayLengthAccess = Class(name="java__ArrayLengthAccess")
java__ArrayType = Class(name="java__ArrayType")
java__Assignment = Class(name="java__Assignment")
java__ClassInstanceCreation = Class(name="java__ClassInstanceCreation")
java__ArrayAccess = Class(name="java__ArrayAccess")
java__ArrayCreation = Class(name="java__ArrayCreation")
java__ArrayInitializer = Class(name="java__ArrayInitializer")
java__Modifier = Class(name="java__Modifier")
java__BooleanLiteral = Class(name="java__BooleanLiteral")
java__BlockComment = Class(name="java__BlockComment")
Comment = Class(name="Comment")
java__Statement = Class(name="java__Statement", is_abstract=True)
java__BreakStatement = Class(name="java__BreakStatement")
java__LabeledStatement = Class(name="java__LabeledStatement")
java__CastExpression = Class(name="java__CastExpression")
java__CatchClause = Class(name="java__CatchClause")
java__ConstructorDeclaration = Class(name="java__ConstructorDeclaration")
AbstractMethodDeclaration = Class(name="AbstractMethodDeclaration")
java__ConditionalExpression = Class(name="java__ConditionalExpression")
java__ConstructorInvocation = Class(name="java__ConstructorInvocation")
java__ClassDeclaration = Class(name="java__ClassDeclaration")
TypeDeclaration = Class(name="TypeDeclaration")
java__CharacterLiteral = Class(name="java__CharacterLiteral")
AbstractMethodInvocation = Class(name="AbstractMethodInvocation")
java__EnhancedForStatement = Class(name="java__EnhancedForStatement")
java__EnumConstantDeclaration = Class(name="java__EnumConstantDeclaration")
VariableDeclaration = Class(name="VariableDeclaration")
java__EnumDeclaration = Class(name="java__EnumDeclaration")
java__ExpressionStatement = Class(name="java__ExpressionStatement")
java__FieldAccess = Class(name="java__FieldAccess")
java__SingleVariableAccess = Class(name="java__SingleVariableAccess")
java__ImportDeclaration = Class(name="java__ImportDeclaration")
java__ContinueStatement = Class(name="java__ContinueStatement")
java__DoStatement = Class(name="java__DoStatement")
java__EmptyStatement = Class(name="java__EmptyStatement")
java__NamedElement = Class(name="java__NamedElement", is_abstract=True)
java__InfixExpression = Class(name="java__InfixExpression")
java__FieldDeclaration = Class(name="java__FieldDeclaration")
AbstractVariablesContainer = Class(name="AbstractVariablesContainer")
java__ForStatement = Class(name="java__ForStatement")
java__IfStatement = Class(name="java__IfStatement")
java__InterfaceDeclaration = Class(name="java__InterfaceDeclaration")
java__Javadoc = Class(name="java__Javadoc")
java__TagElement = Class(name="java__TagElement")
java__LineComment = Class(name="java__LineComment")
java__ManifestAttribute = Class(name="java__ManifestAttribute")
java__ManifestEntry = Class(name="java__ManifestEntry")
java__Initializer = Class(name="java__Initializer")
java__InstanceofExpression = Class(name="java__InstanceofExpression")
java__MethodRefParameter = Class(name="java__MethodRefParameter")
java__Model = Class(name="java__Model")
java__Type = Class(name="java__Type", is_abstract=True)
java__UnresolvedItem = Class(name="java__UnresolvedItem")
java__MemberRef = Class(name="java__MemberRef")
java__MethodDeclaration = Class(name="java__MethodDeclaration")
java__MethodInvocation = Class(name="java__MethodInvocation")
java__VariableDeclarationStatement = Class(name="java__VariableDeclarationStatement")
java__VariableDeclarationExpression = Class(name="java__VariableDeclarationExpression")
java__NamespaceAccess = Class(name="java__NamespaceAccess", is_abstract=True)
java__NumberLiteral = Class(name="java__NumberLiteral")
java__NullLiteral = Class(name="java__NullLiteral")
java__ParameterizedType = Class(name="java__ParameterizedType")
java__ParenthesizedExpression = Class(name="java__ParenthesizedExpression")
java__PostfixExpression = Class(name="java__PostfixExpression")
java__PrefixExpression = Class(name="java__PrefixExpression")
java__PackageAccess = Class(name="java__PackageAccess")
NamespaceAccess = Class(name="NamespaceAccess")
java__PrimitiveTypeFloat = Class(name="java__PrimitiveTypeFloat")
java__PrimitiveTypeInt = Class(name="java__PrimitiveTypeInt")
java__PrimitiveTypeLong = Class(name="java__PrimitiveTypeLong")
java__PrimitiveTypeVoid = Class(name="java__PrimitiveTypeVoid")
java__ReturnStatement = Class(name="java__ReturnStatement")
java__VariableDeclaration = Class(name="java__VariableDeclaration", is_abstract=True)
java__PrimitiveType = Class(name="java__PrimitiveType")
java__PrimitiveTypeBoolean = Class(name="java__PrimitiveTypeBoolean")
PrimitiveType = Class(name="PrimitiveType")
java__PrimitiveTypeByte = Class(name="java__PrimitiveTypeByte")
java__PrimitiveTypeChar = Class(name="java__PrimitiveTypeChar")
java__PrimitiveTypeDouble = Class(name="java__PrimitiveTypeDouble")
java__PrimitiveTypeShort = Class(name="java__PrimitiveTypeShort")
java__SuperFieldAccess = Class(name="java__SuperFieldAccess")
AbstractTypeQualifiedExpression = Class(name="AbstractTypeQualifiedExpression")
java__SuperMethodInvocation = Class(name="java__SuperMethodInvocation")
java__SwitchCase = Class(name="java__SwitchCase")
java__SwitchStatement = Class(name="java__SwitchStatement")
java__SynchronizedStatement = Class(name="java__SynchronizedStatement")
java__StringLiteral = Class(name="java__StringLiteral")
java__SuperConstructorInvocation = Class(name="java__SuperConstructorInvocation")
java__TypeDeclaration = Class(name="java__TypeDeclaration", is_abstract=True)
java__TypeDeclarationStatement = Class(name="java__TypeDeclarationStatement")
java__TextElement = Class(name="java__TextElement")
java__ThisExpression = Class(name="java__ThisExpression")
java__ThrowStatement = Class(name="java__ThrowStatement")
java__TryStatement = Class(name="java__TryStatement")
java__UnresolvedAnnotationDeclaration = Class(name="java__UnresolvedAnnotationDeclaration")
AnnotationTypeDeclaration = Class(name="AnnotationTypeDeclaration")
UnresolvedItem = Class(name="UnresolvedItem")
java__UnresolvedAnnotationTypeMemberDeclaration = Class(name="java__UnresolvedAnnotationTypeMemberDeclaration")
AnnotationTypeMemberDeclaration = Class(name="AnnotationTypeMemberDeclaration")
java__UnresolvedClassDeclaration = Class(name="java__UnresolvedClassDeclaration")
ClassDeclaration = Class(name="ClassDeclaration")
java__UnresolvedEnumDeclaration = Class(name="java__UnresolvedEnumDeclaration")
EnumDeclaration = Class(name="EnumDeclaration")
java__UnresolvedInterfaceDeclaration = Class(name="java__UnresolvedInterfaceDeclaration")
InterfaceDeclaration = Class(name="InterfaceDeclaration")
java__UnresolvedLabeledStatement = Class(name="java__UnresolvedLabeledStatement")
LabeledStatement = Class(name="LabeledStatement")
java__UnresolvedMethodDeclaration = Class(name="java__UnresolvedMethodDeclaration")
MethodDeclaration = Class(name="MethodDeclaration")
java__UnresolvedSingleVariableDeclaration = Class(name="java__UnresolvedSingleVariableDeclaration")
SingleVariableDeclaration = Class(name="SingleVariableDeclaration")
java__UnresolvedType = Class(name="java__UnresolvedType")
java__UnresolvedTypeDeclaration = Class(name="java__UnresolvedTypeDeclaration")
java__UnresolvedVariableDeclarationFragment = Class(name="java__UnresolvedVariableDeclarationFragment")
VariableDeclarationFragment = Class(name="VariableDeclarationFragment")
java__TypeLiteral = Class(name="java__TypeLiteral")
java__UnresolvedItemAccess = Class(name="java__UnresolvedItemAccess")
java__WildCardType = Class(name="java__WildCardType")
java__WhileStatement = Class(name="java__WhileStatement")
java__QueryCollection = Class(name="java__QueryCollection")
...
java__Comment.attributes={java__Comment_prefixOfParent, java__Comment_enclosedByParent, java__Comment_content}
...
java__Modifier.attributes={java__Modifier_native, java__Modifier_transient, java__Modifier_volatile, java__Modifier_static, java__Modifier_strictfp, java__Modifier_synchronized, java__Modifier_inheritance, java__Modifier_visibility}
...
java__QueryCollection_m_textElementInJavadoc: Method = Method(name="textElementInJavadoc", parameters={Parameter(name='java__self_', type=StringType)}, type=ASTNode)
java__QueryCollection_m_emptyTextElementInJavadoc: Method = Method(name="emptyTextElementInJavadoc", parameters={Parameter(name='java__self_', type=StringType)}, type=ASTNode)
java__QueryCollection.methods={java__QueryCollection_m_emptyTextElementInJavadoc, java__QueryCollection_m_grabats09, java__QueryCollection_m_invisibleMethods, java__QueryCollection_m_thrownExceptions, java__QueryCollection_m_textElementInJavadoc}
...
domain_model = DomainModel(
    name="java_",
    types={java__SingleVariableDeclaration, java__TypeAccess, java__TypeParameter, java__MethodRef, java__AbstractMethodInvocation, ASTNode, java__Expression, java__AbstractTypeDeclaration, java__AbstractMethodDeclaration, BodyDeclaration, java__Block, java__VariableDeclarationFragment, java__Annotation, java__AnnotationMemberValuePair, java__Archive, NamedElement, java__ClassFile, java__Manifest, Type, java__BodyDeclaration, java__Comment, java__Package, java__AbstractTypeQualifiedExpression, Expression, java__AbstractVariablesContainer, java__CompilationUnit, java__AnnotationTypeMemberDeclaration, java__AnnotationTypeDeclaration, AbstractTypeDeclaration, java__AnonymousClassDeclaration, java__AssertStatement, Statement, java__ASTNode, java__ArrayLengthAccess, java__ArrayType, java__Assignment, java__ClassInstanceCreation, java__ArrayAccess, java__ArrayCreation, java__ArrayInitializer, java__Modifier, java__BooleanLiteral, java__BlockComment, Comment, java__Statement, java__BreakStatement, java__LabeledStatement, java__CastExpression, java__CatchClause, java__ConstructorDeclaration, AbstractMethodDeclaration, java__ConditionalExpression, java__ConstructorInvocation, java__ClassDeclaration, TypeDeclaration, java__CharacterLiteral, AbstractMethodInvocation, java__EnhancedForStatement, java__EnumConstantDeclaration, VariableDeclaration, java__EnumDeclaration, java__ExpressionStatement, java__FieldAccess, java__SingleVariableAccess, java__ImportDeclaration, java__ContinueStatement, java__DoStatement, java__EmptyStatement, java__NamedElement, java__InfixExpression, java__FieldDeclaration, AbstractVariablesContainer, java__ForStatement, java__IfStatement, java__InterfaceDeclaration, java__Javadoc, java__TagElement, java__LineComment, java__ManifestAttribute, java__ManifestEntry, java__Initializer, java__InstanceofExpression, java__MethodRefParameter, java__Model, java__Type, java__UnresolvedItem, java__MemberRef, java__MethodDeclaration, java__MethodInvocation, java__VariableDeclarationStatement, java__VariableDeclarationExpression, java__NamespaceAccess, java__NumberLiteral, java__NullLiteral, java__ParameterizedType, java__ParenthesizedExpression, java__PostfixExpression, java__PrefixExpression, java__PackageAccess, NamespaceAccess, java__PrimitiveTypeFloat, java__PrimitiveTypeInt, java__PrimitiveTypeLong, java__PrimitiveTypeVoid, java__ReturnStatement, java__VariableDeclaration, java__PrimitiveType, java__PrimitiveTypeBoolean, PrimitiveType, java__PrimitiveTypeByte, java__PrimitiveTypeChar, java__PrimitiveTypeDouble, java__PrimitiveTypeShort, java__SuperFieldAccess, AbstractTypeQualifiedExpression, java__SuperMethodInvocation, java__SwitchCase, java__SwitchStatement, java__SynchronizedStatement, java__StringLiteral, java__SuperConstructorInvocation, java__TypeDeclaration, java__TypeDeclarationStatement, java__TextElement, java__ThisExpression, java__ThrowStatement, java__TryStatement, java__UnresolvedAnnotationDeclaration, AnnotationTypeDeclaration, UnresolvedItem, java__UnresolvedAnnotationTypeMemberDeclaration, AnnotationTypeMemberDeclaration, java__UnresolvedClassDeclaration, ClassDeclaration, java__UnresolvedEnumDeclaration, EnumDeclaration, java__UnresolvedInterfaceDeclaration, InterfaceDeclaration, java__UnresolvedLabeledStatement, LabeledStatement, java__UnresolvedMethodDeclaration, MethodDeclaration, java__UnresolvedSingleVariableDeclaration, SingleVariableDeclaration, java__UnresolvedType, java__UnresolvedTypeDeclaration, java__UnresolvedVariableDeclarationFragment, VariableDeclarationFragment, java__TypeLiteral, java__UnresolvedItemAccess, java__WildCardType, java__WhileStatement, java__QueryCollection, AssignmentKind, InfixExpressionKind, InheritanceKind, PostfixExpressionKind, PrefixExpressionKind, VisibilityKind},
    associations={parameters1, thrownExceptions2, typeParameters4, usagesInDocComments6, usages7, method9, arguments10, typeArguments11, body0, type25, fragments27, type28, values30, classFiles32, manifest33, bodyDeclarations14, commentsBeforeBody15, commentsAfterBody16, package19, superInterfaces20, qualifier23, originalCompilationUnit42, originalClassFile44, member47, value49, default52, type54, usages57, message35, expression37, comments40, expressions73, array76, elementType78, leftHandSide80, rightHandSide82, bodyDeclarations58, classInstanceCreation60, array61, index63, dimensions66, initializer68, type70, modifier90, statements91, label93, expression94, type96, abstractTypeDeclaration85, annotations86, type115, anonymousClassDeclarationOwner88, elseExpression118, expression120, thenExpression123, superClass126, commentList128, exception99, body101, type103, attachedSource106, package109, anonymousClassDeclaration111, expression113, body146, expression148, parameter151, anonymousClassDeclaration153, arguments154, enumConstants157, expression159, imports131, package133, types136, label139, expression141, body143, thenStatement178, elseStatement181, importedElement184, rightOperand185, leftOperand187, extendedOperands190, field161, expression162, expression165, updaters167, initializers170, body173, expression176, tags200, body201, usagesInBreakStatements203, usagesInContinueStatements204, mainAttributes206, entryAttributes208, body193, rightOperand195, leftOperand197, method226, qualifier228, parameters230, type232, ownedElements235, orphanTypes237, unresolvedItems238, compilationUnits240, attributes210, member213, qualifier214, returnType217, redefinedMethodDeclaration220, redefinitions222, expression224, singleVariableDeclaration251, variableDeclarationStatement254, variableDeclarationExpression256, usagesInImports258, classFiles243, ownedElements259, archives246, model261, bodyDeclaration249, type276, typeArguments278, expression281, operand283, ownedPackages264, package268, usagesInPackageAccess270, package272, qualifier275, expression287, variable289, qualifier290, modifier293, type295, annotations297, methodDeclaration300, operand285, expression304, field306, expression308, expression310, statements312, body315, expression317, catchClause302, enhancedForStatement303, body325, finally_327, catchClauses330, usagesInTypeAccess333, type334, qualifier335, typeParameters337, declaration339, fragments320, expression323, qualifier348, initializer351, usageInVariableAccess353, type341, bounds343, element346, modifier359, annotations361, bound363, expression365, body367, modifier354, annotations356, variablesContainer358},
    generalizations={gen_java__AbstractMethodInvocation_ASTNode, gen_java__AbstractTypeDeclaration_BodyDeclaration, gen_java__AbstractMethodDeclaration_BodyDeclaration, gen_java__Annotation_Expression, gen_java__Archive_NamedElement, gen_java__AbstractTypeDeclaration_Type, gen_java__AbstractTypeQualifiedExpression_Expression, gen_java__AbstractVariablesContainer_ASTNode, gen_java__AnnotationMemberValuePair_NamedElement, gen_java__AnnotationTypeDeclaration_AbstractTypeDeclaration, gen_java__AnnotationTypeMemberDeclaration_BodyDeclaration, gen_java__AnonymousClassDeclaration_ASTNode, gen_java__AssertStatement_Statement, gen_java__ArrayInitializer_Expression, gen_java__ArrayLengthAccess_Expression, gen_java__ArrayType_Type, gen_java__Assignment_Expression, gen_java__ArrayAccess_Expression, gen_java__ArrayCreation_Expression, gen_java__BooleanLiteral_Expression, gen_java__BlockComment_Comment, gen_java__Block_Statement, gen_java__BreakStatement_Statement, gen_java__CastExpression_Expression, gen_java__CatchClause_Statement, gen_java__BodyDeclaration_NamedElement, gen_java__ConstructorDeclaration_AbstractMethodDeclaration, gen_java__ConditionalExpression_Expression, gen_java__ConstructorInvocation_Statement, gen_java__ConstructorInvocation_AbstractMethodInvocation, gen_java__ClassDeclaration_TypeDeclaration, gen_java__Comment_ASTNode, gen_java__CompilationUnit_NamedElement, gen_java__CharacterLiteral_Expression, gen_java__ClassFile_NamedElement, gen_java__ClassInstanceCreation_Expression, gen_java__ClassInstanceCreation_AbstractMethodInvocation, gen_java__EnhancedForStatement_Statement, gen_java__EnumConstantDeclaration_BodyDeclaration, gen_java__EnumConstantDeclaration_VariableDeclaration, gen_java__EnumDeclaration_AbstractTypeDeclaration, gen_java__Expression_ASTNode, gen_java__ExpressionStatement_Statement, gen_java__FieldAccess_Expression, gen_java__ContinueStatement_Statement, gen_java__DoStatement_Statement, gen_java__EmptyStatement_Statement, gen_java__ImportDeclaration_ASTNode, gen_java__InfixExpression_Expression, gen_java__FieldDeclaration_BodyDeclaration, gen_java__FieldDeclaration_AbstractVariablesContainer, gen_java__ForStatement_Statement, gen_java__IfStatement_Statement, gen_java__InterfaceDeclaration_TypeDeclaration, gen_java__Javadoc_Comment, gen_java__LabeledStatement_NamedElement, gen_java__LabeledStatement_Statement, gen_java__LineComment_Comment, gen_java__Initializer_BodyDeclaration, gen_java__InstanceofExpression_Expression, gen_java__MethodRef_ASTNode, gen_java__MethodRefParameter_ASTNode, gen_java__MemberRef_ASTNode, gen_java__MethodDeclaration_AbstractMethodDeclaration, gen_java__MethodInvocation_Expression, gen_java__MethodInvocation_AbstractMethodInvocation, gen_java__NamedElement_ASTNode, gen_java__NamespaceAccess_ASTNode, gen_java__NumberLiteral_Expression, gen_java__NullLiteral_Expression, gen_java__Package_NamedElement, gen_java__Modifier_ASTNode, gen_java__ParameterizedType_Type, gen_java__ParenthesizedExpression_Expression, gen_java__PostfixExpression_Expression, gen_java__PrefixExpression_Expression, gen_java__PackageAccess_NamespaceAccess, gen_java__PrimitiveTypeFloat_PrimitiveType, gen_java__PrimitiveTypeInt_PrimitiveType, gen_java__PrimitiveTypeLong_PrimitiveType, gen_java__PrimitiveTypeVoid_PrimitiveType, gen_java__ReturnStatement_Statement, gen_java__SingleVariableAccess_Expression, gen_java__SingleVariableDeclaration_VariableDeclaration, gen_java__PrimitiveType_Type, gen_java__PrimitiveTypeBoolean_PrimitiveType, gen_java__PrimitiveTypeByte_PrimitiveType, gen_java__PrimitiveTypeChar_PrimitiveType, gen_java__PrimitiveTypeDouble_PrimitiveType, gen_java__PrimitiveTypeShort_PrimitiveType, gen_java__SuperFieldAccess_AbstractTypeQualifiedExpression, gen_java__SuperMethodInvocation_AbstractTypeQualifiedExpression, gen_java__SuperMethodInvocation_AbstractMethodInvocation, gen_java__SwitchCase_Statement, gen_java__SwitchStatement_Statement, gen_java__SynchronizedStatement_Statement, gen_java__Statement_ASTNode, gen_java__StringLiteral_Expression, gen_java__SuperConstructorInvocation_Statement, gen_java__SuperConstructorInvocation_AbstractMethodInvocation, gen_java__TryStatement_Statement, gen_java__Type_NamedElement, gen_java__TypeAccess_Expression, gen_java__TypeAccess_NamespaceAccess, gen_java__TypeDeclaration_AbstractTypeDeclaration, gen_java__TypeDeclarationStatement_Statement, gen_java__TagElement_ASTNode, gen_java__TextElement_ASTNode, gen_java__ThisExpression_AbstractTypeQualifiedExpression, gen_java__ThrowStatement_Statement, gen_java__UnresolvedAnnotationDeclaration_AnnotationTypeDeclaration, gen_java__UnresolvedAnnotationDeclaration_UnresolvedItem, gen_java__UnresolvedAnnotationTypeMemberDeclaration_AnnotationTypeMemberDeclaration, gen_java__UnresolvedAnnotationTypeMemberDeclaration_UnresolvedItem, gen_java__UnresolvedClassDeclaration_ClassDeclaration, gen_java__UnresolvedClassDeclaration_UnresolvedItem, gen_java__UnresolvedEnumDeclaration_EnumDeclaration, gen_java__UnresolvedEnumDeclaration_UnresolvedItem, gen_java__UnresolvedInterfaceDeclaration_InterfaceDeclaration, gen_java__UnresolvedInterfaceDeclaration_UnresolvedItem, gen_java__UnresolvedLabeledStatement_LabeledStatement, gen_java__UnresolvedLabeledStatement_UnresolvedItem, gen_java__UnresolvedMethodDeclaration_MethodDeclaration, gen_java__UnresolvedMethodDeclaration_UnresolvedItem, gen_java__UnresolvedSingleVariableDeclaration_SingleVariableDeclaration, gen_java__UnresolvedSingleVariableDeclaration_UnresolvedItem, gen_java__UnresolvedType_Type, gen_java__UnresolvedType_UnresolvedItem, gen_java__UnresolvedTypeDeclaration_AbstractTypeDeclaration, gen_java__UnresolvedTypeDeclaration_UnresolvedItem, gen_java__UnresolvedVariableDeclarationFragment_VariableDeclarationFragment, gen_java__UnresolvedVariableDeclarationFragment_UnresolvedItem, gen_java__VariableDeclaration_NamedElement, gen_java__VariableDeclarationExpression_Expression, gen_java__TypeLiteral_Expression, gen_java__TypeParameter_Type, gen_java__UnresolvedItem_NamedElement, gen_java__UnresolvedItemAccess_Expression, gen_java__UnresolvedItemAccess_NamespaceAccess, gen_java__WildCardType_Type, gen_java__WhileStatement_Statement, gen_java__VariableDeclarationExpression_AbstractVariablesContainer, gen_java__VariableDeclarationFragment_VariableDeclaration, gen_java__VariableDeclarationStatement_Statement, gen_java__VariableDeclarationStatement_AbstractVariablesContainer},
    metadata=None
)
