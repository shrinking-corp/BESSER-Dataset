...
class java__QueryCollection:
    ...
    def __init__(self):
        ...
        pass
    def thrownExceptions(self) :
        # TODO: Implement thrownExceptions method
        pass

    def textElementInJavadoc(self, java__self_) :
    ...
    def emptyTextElementInJavadoc(self, java__self_) :
        # TODO: Implement emptyTextElementInJavadoc method
        pass

    def invisibleMethods(self) :
...
class java__CompilationUnit(NamedElement):
    ...
    def __init__(self, originalFilePath: str, java__CompilationUnit: "java__ASTNode" = None, java__CompilationUnit129: set["java__Comment"] = None, java__CompilationUnit108: "java__ClassFile" = None, java__CompilationUnit132: set["java__ImportDeclaration"] = None, java__CompilationUnit242: "java__Model" = None, java__CompilationUnit134: "java__Package" = None, java__CompilationUnit137: set["java__AbstractTypeDeclaration"] = None):
...
class java__VariableDeclaration(NamedElement):
    ...
    def __init__(self, extraArrayDimensions: int, java__VariableDeclaration: "java__Expression" = None, variable: set["java__SingleVariableAccess"] = None, VariableDeclaration: "java__SingleVariableAccess" = None):
...
class java__Comment(ASTNode):
    ...
    def __init__(self, content: str, enclosedByParent: bool, prefixOfParent: bool, java__Comment41: "java__ASTNode" = None, java__Comment: "java__AbstractTypeDeclaration" = None, java__Comment18: "java__AbstractTypeDeclaration" = None, java__Comment130: "java__CompilationUnit" = None):
...
class java__VariableDeclarationExpression(Expression, AbstractVariablesContainer):
...
class java__NamedElement(ASTNode):
    ...
    def __init__(self, name: str, proxy: bool, java__NamedElement: "java__MemberRef" = None, importedElement: set["java__ImportDeclaration"] = None, NamedElement: "java__ImportDeclaration" = None):
        self.name = name
        self.proxy = proxy
...
class java__ImportDeclaration(ASTNode):
    ...
    def __init__(self, static: bool, java__ImportDeclaration: "java__CompilationUnit" = None, ImportDeclaration: "java__NamedElement" = None, usagesInImports: "java__NamedElement" = None):
        self.static = static
