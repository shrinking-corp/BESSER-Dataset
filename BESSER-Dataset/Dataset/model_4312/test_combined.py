...
def test_hyp_metric_container_artifact_setter(instance):
...
def test_metric_Container_artifact_value_roundtrip():
    instance = metric_Container(artifact="sample_text")
...
def test_assoc_metrics0_link_reassign_clear():
    ...
    b1 = metric_Container(artifact="sample_text")
    b2 = metric_Container(artifact="sample_text_2")
...
metric_Container_strategy = st.builds(metric_Container, artifact=safe_text)
@given(instance=metric_Container_strategy)
@settings(max_examples=25)
