...
# Classes
metric_AggregatedRealMetric = Class(name="metric_AggregatedRealMetric")
metric_Container = Class(name="metric_Container")
metric_Metric = Class(name="metric_Metric", is_abstract=True)
metric_AggregatedIntegerMetric = Class(name="metric_AggregatedIntegerMetric")
Metric = Class(name="Metric")
metric_SimpleMetric = Class(name="metric_SimpleMetric")
...
metric_AggregatedRealMetric.attributes={metric_AggregatedRealMetric_maximum, metric_AggregatedRealMetric_standardDeviation, metric_AggregatedRealMetric_average, metric_AggregatedRealMetric_minimum, metric_AggregatedRealMetric_median}
...
metric_Metric.attributes={metric_Metric_name, metric_Metric_code, metric_Metric_description}
...
metric_AggregatedIntegerMetric.attributes={metric_AggregatedIntegerMetric_maximum, metric_AggregatedIntegerMetric_average, metric_AggregatedIntegerMetric_median, metric_AggregatedIntegerMetric_minimum, metric_AggregatedIntegerMetric_standardDeviation}
...
domain_model = DomainModel(
    name="metric",
    types={metric_AggregatedRealMetric, metric_Container, metric_Metric, metric_AggregatedIntegerMetric, Metric, metric_SimpleMetric},
    associations={metrics0},
    generalizations={gen_metric_AggregatedRealMetric_Metric, gen_metric_AggregatedIntegerMetric_Metric, gen_metric_SimpleMetric_Metric},
    metadata=None
)
