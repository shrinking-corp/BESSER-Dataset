...
library_Content = Class(name="library_Content")
library_Text = Class(name="library_Text")
library_Image = Class(name="library_Image")
...
library_Chapter.attributes={library_Chapter_name, library_Chapter_pages}
...
domain_model = DomainModel(
    name="library",
    types={library_Library, library_Book, library_Chapter, library_Content, library_Text, library_Image},
    associations={books0, chapters1, content3, text5, images7},
    generalizations={},
    metadata=None
)
