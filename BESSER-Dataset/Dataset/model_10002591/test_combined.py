...
def test_hyp_electricity_debtor_is_not_abstract():
    assert not inspect.isabstract(Electricity_Debtor)


def test_hyp_electricity_debtor_constructor_exists():
    assert callable(Electricity_Debtor.__init__)


def test_hyp_electricity_debtor_constructor_args():
...
Electricity_Debtor_strategy = st.builds(Electricity_Debtor)
