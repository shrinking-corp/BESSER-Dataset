...
class fsm_Transition(NamedElement):
    ...
    def __init__(self, initialTime: int, finalTime: int, Transition: "fsm_StateMachine" = None, Transition4: "fsm_State" = None, Transition6: "fsm_State" = None, incoming: "fsm_State" = None, outgoing: "fsm_State" = None, fsm_Transition: "fsm_Trigger" = None, transitions: "fsm_StateMachine" = None):
...
class fsm_State(NamedElement):
    ...
    def __init__(self, initialTime: int, finalTime: int, source: set["fsm_Transition"] = None, target: set["fsm_Transition"] = None, states: "fsm_StateMachine" = None, State9: "fsm_Transition" = None, State11: "fsm_Transition" = None, State: "fsm_StateMachine" = None):
        self.initialTime = initialTime
        self.finalTime = finalTime
