...
core_COREStrategy = Class(name="core_COREStrategy", is_abstract=True)
...
core_COREMapping = Class(name="core_COREMapping")
...
core_COREFeature_m_addFeature: Method = Method(name="addFeature", parameters={Parameter(name='core_association', type=StringType), Parameter(name='core_child_name', type=StringType)})
...
core_COREFeature_m_changeLink: Method = Method(name="changeLink", parameters={Parameter(name='core_new_association', type=StringType)})
core_COREFeature_m_changeParent: Method = Method(name="changeParent", parameters={Parameter(name='core_feature', type=StringType), Parameter(name='core_new_association', type=StringType)})
core_COREFeature_m_requires: Method = Method(name="requires", parameters={Parameter(name='core_feature', type=StringType)})
core_COREFeature_m_excludes: Method = Method(name="excludes", parameters={Parameter(name='core_feature', type=StringType)})
core_COREFeature_m_removeConstraint: Method = Method(name="removeConstraint", parameters={Parameter(name='core_feature', type=StringType)})
core_COREFeature_m_addRealizedBy: Method = Method(name="addRealizedBy", parameters={Parameter(name='core_model', type=StringType)})
core_COREFeature.methods={core_COREFeature_m_addFeature, core_COREFeature_m_excludes, core_COREFeature_m_addRealizedBy, core_COREFeature_m_rename, core_COREFeature_m_requires, core_COREFeature_m_removeConstraint, core_COREFeature_m_delete, core_COREFeature_m_changeParent, core_COREFeature_m_changeLink}
...
domain_model = DomainModel(
    name="core",
    types={core_COREModel, CORENamedElement, core_COREReuse, core_COREModelElement, core_COREFeature, core_COREImpactModel, COREModel, core_COREConcern, core_COREInterface, COREModelElement, core_COREStrategy, core_COREConfiguration, core_COREBinding, CORECompositionSpecification, core_COREMapping, core_CORECompositionSpecification, core_CORENamedElement, core_COREImpactModelElement, core_COREPattern, core_COREFeatureModel, COREFeatureRelationshipType},
    associations={reuses0, modelElements1, realizes3, models4, interface6, realizedBy8, strategies9, configurations10, coreMappings12, source13, mappedTo15, mappedFrom18, configurations21, selectable24, customizable27, usable30, impacted33, reusedConcern35, compositions38, selected41, reusedConcern44, selected47},
