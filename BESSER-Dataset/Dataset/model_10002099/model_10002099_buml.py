...
domain_model = DomainModel(
    name="_oKuVMPwLEemPd5ZtCQMxVQ",
    types={JObject, JMember, JBool, JNum, JStr, JNull, JArray, JValue_Interface, State_Interface, Wait, Protraction, Retraction, Contexte, JValueVisitor_Interface, JValueJSONPrintVisitor, T},
