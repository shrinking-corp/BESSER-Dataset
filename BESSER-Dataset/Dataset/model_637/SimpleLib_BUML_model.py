...
# Classes
lib_Library = Class(name="lib_Library")
lib_Book = Class(name="lib_Book")
lib_Address = Class(name="lib_Address")
lib_Person = Class(name="lib_Person")
lib_Cafeteria = Class(name="lib_Cafeteria")
...
domain_model = DomainModel(
    name="lib",
    types={lib_Library, lib_Book, lib_Address, lib_Person, lib_Cafeteria},
    associations={library7, books0, address1, writers3, cafeteria4, library6},
    generalizations={},
    metadata=None
)
