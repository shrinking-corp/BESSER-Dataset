...
class lib_Library:
    ...
    def __init__(self, name: str, Library8: "lib_Cafeteria" = None, lib_Library: set["lib_Book"] = None, lib_Library2: "lib_Address" = None, library: set["lib_Person"] = None, library5: "lib_Cafeteria" = None, Library: "lib_Person" = None):
        self.name = name
