...
Library_Management_System_Patron.attributes={Library_Management_System_Patron_Magazines, Library_Management_System_Patron_SpecialStatus, Library_Management_System_Patron_Status, Library_Management_System_Patron_OtherResources, Library_Management_System_Patron_Books}
...
domain_model = DomainModel(
    name="b3f903ab_05ca_4bbb_8dbe_ed62310d853c",
    ...
    associations={Librarian_1_year_check_out, Librarian_Check_in___Return, Librarian_Check_out, Librarian_Requested, Faculty_Check_out, Faculty_Requested, Faculty_Reserve, Faculty_Reference, Librarian_Issue_fines, Librarian_Manage_Magazines, Librarian_Reshelving_books, Librarian_Ordering_new_resources, Librarian_Assist_patrons_in_research, Librarian_Connect_to_holding_of_other_libraries, Librarian_Books, Patron_Student, Patron_Faculty, Patron_Librarian, Librarian_Reserve, Librarian_Reference, Student_Check_in___Return, Student_Check_out, Student_Requested, Student_Reserve, Student_Reference, Faculty_Check_in___Return},
    generalizations={},
    metadata=None
)
