...
# Classes
ptn103_AbstractNode = Class(name="ptn103_AbstractNode", is_abstract=True)
ptn103_AbstractTransition = Class(name="ptn103_AbstractTransition", is_abstract=True)
ptn103_Token = Class(name="ptn103_Token")
ptn103_Place = Class(name="ptn103_Place")
AbstractNode = Class(name="AbstractNode")
ptn103_Transition = Class(name="ptn103_Transition")
...
domain_model = DomainModel(
    ...
    associations={nodes2, transitions4, tokens6, subnets1, places8},
    generalizations={gen_ptn103_Place_AbstractNode, gen_ptn103_AbstractTransition_AbstractNode, gen_ptn103_Transition_AbstractTransition},
    metadata=None
)
