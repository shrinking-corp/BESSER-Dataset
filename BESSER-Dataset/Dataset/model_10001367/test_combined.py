...
def test_hyp_contactformulier_is_not_abstract():
    assert not inspect.isabstract(Contactformulier)


def test_hyp_contactformulier_constructor_exists():
    assert callable(Contactformulier.__init__)


def test_hyp_contactformulier_constructor_args():
...
def test_hyp_afbeelding_is_not_abstract():
    assert not inspect.isabstract(Afbeelding)


def test_hyp_afbeelding_constructor_exists():
    assert callable(Afbeelding.__init__)


def test_hyp_afbeelding_constructor_args():
...
def test_hyp_categorie_is_not_abstract():
    assert not inspect.isabstract(Categorie)


def test_hyp_categorie_constructor_exists():
    assert callable(Categorie.__init__)


def test_hyp_categorie_constructor_args():
    sig = inspect.signature(Categorie.__init__)
    params = list(sig.parameters.keys())



def test_hyp_adres_is_not_abstract():
    assert not inspect.isabstract(Adres)


def test_hyp_adres_constructor_exists():
    assert callable(Adres.__init__)


def test_hyp_adres_constructor_args():
...
def test_hyp_nieuwsbericht_is_not_abstract():
    assert not inspect.isabstract(Nieuwsbericht)


def test_hyp_nieuwsbericht_constructor_exists():
    assert callable(Nieuwsbericht.__init__)


def test_hyp_nieuwsbericht_constructor_args():
...
def test_hyp_bestelregel_is_not_abstract():
    assert not inspect.isabstract(Bestelregel)


def test_hyp_bestelregel_constructor_exists():
    assert callable(Bestelregel.__init__)


def test_hyp_bestelregel_constructor_args():
...
def test_hyp_factuur_is_not_abstract():
    assert not inspect.isabstract(Factuur)


def test_hyp_factuur_constructor_exists():
    assert callable(Factuur.__init__)


def test_hyp_factuur_constructor_args():
...
def test_hyp_hoofdbeheerder_is_not_abstract():
    assert not inspect.isabstract(Hoofdbeheerder)


def test_hyp_hoofdbeheerder_constructor_exists():
    assert callable(Hoofdbeheerder.__init__)


def test_hyp_hoofdbeheerder_constructor_args():
    sig = inspect.signature(Hoofdbeheerder.__init__)
    params = list(sig.parameters.keys())



def test_hyp_beheerder_is_not_abstract():
    assert not inspect.isabstract(Beheerder)


def test_hyp_beheerder_constructor_exists():
    assert callable(Beheerder.__init__)


def test_hyp_beheerder_constructor_args():
...
def test_hyp_klant_is_not_abstract():
    assert not inspect.isabstract(Klant)


def test_hyp_klant_constructor_exists():
    assert callable(Klant.__init__)


def test_hyp_klant_constructor_args():
...
def test_hyp_persoon_is_not_abstract():
    assert not inspect.isabstract(Persoon)


def test_hyp_persoon_constructor_exists():
    assert callable(Persoon.__init__)


def test_hyp_persoon_constructor_args():
...
def test_hyp_contactformulier_tekst_setter(instance):
...
def test_hyp_afbeelding_locatie_setter(instance):
...
@given(instance=Afbeelding_strategy)
def test_hyp_afbeelding_naam_setter(instance):
...
@given(instance=Afbeelding_strategy)
def test_hyp_afbeelding_datum_setter(instance):
...
def test_hyp_adres_straatnaam_setter(instance):
...
@given(instance=Adres_strategy)
def test_hyp_adres_bijvoegsel_setter(instance):
...
@given(instance=Adres_strategy)
def test_hyp_adres_postcode_setter(instance):
...
@given(instance=Adres_strategy)
def test_hyp_adres_huisnummer_setter(instance):
...
@given(instance=Adres_strategy)
def test_hyp_adres_stad_setter(instance):
...
def test_hyp_nieuwsbericht_titel_setter(instance):
...
@given(instance=Nieuwsbericht_strategy)
def test_hyp_nieuwsbericht_tekst_setter(instance):
    original = instance.tekst
    instance.tekst = original
    assert instance.tekst == original
...
def test_hyp_product_prijs_setter(instance):
...
@given(instance=Product_strategy)
def test_hyp_product_naam_setter(instance):
    original = instance.naam
    instance.naam = original
    assert instance.naam == original
...
@given(instance=Product_strategy)
def test_hyp_product_beschrijving_setter(instance):
...
@given(instance=Product_strategy)
def test_hyp_product_voorraad_setter(instance):
...
@given(instance=Product_strategy)
def test_hyp_product_actief_setter(instance):
...
def test_hyp_bestelregel_aantal_setter(instance):
...
def test_hyp_factuur_datum_setter(instance):
    original = instance.datum
    instance.datum = original
    assert instance.datum == original
...
@given(instance=Factuur_strategy)
def test_hyp_factuur_btw_setter(instance):
...
@given(instance=Factuur_strategy)
def test_hyp_factuur_status_setter(instance):
...
def test_hyp_beheerder_rechten_setter(instance):
...
def test_hyp_klant_geboortedatum_setter(instance):
...
@given(instance=Klant_strategy)
def test_hyp_klant_telefoonnummer_setter(instance):
...
def test_hyp_persoon_achternaam_setter(instance):
...
@given(instance=Persoon_strategy)
def test_hyp_persoon_wachtwoord_setter(instance):
...
@given(instance=Persoon_strategy)
def test_hyp_persoon_e_mail_setter(instance):
...
@given(instance=Persoon_strategy)
def test_hyp_persoon_tussenvoegsel_setter(instance):
...
@given(instance=Persoon_strategy)
def test_hyp_persoon_voornaam_setter(instance):
