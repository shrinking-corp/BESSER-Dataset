...
def test_hyp_petrinet_net_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_petrinet_Net_name_value_roundtrip():
    instance = petrinet_Net(name="sample_text")
...
def test_assoc_places0_link_reassign_clear():
    ...
    b1 = petrinet_Net(name="sample_text")
    b2 = petrinet_Net(name="sample_text_2")
...
petrinet_Net_strategy = st.builds(petrinet_Net, name=safe_text)
@given(instance=petrinet_Net_strategy)
