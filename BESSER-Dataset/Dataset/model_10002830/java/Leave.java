...
public class Leave  {
    ...
    public Leave(
        String Leave_Status,        String Leave_Title,        LocalDate Leave_StartDate,        int Leave_NoOfDays,        LocalDate Leave_ApplyDate,        LocalDate Leave_EndDate,        String Leave_detail,        int Emp_Id,        int leave_id    ) {
