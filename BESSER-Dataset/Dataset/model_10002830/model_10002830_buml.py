...
Employee.attributes={Employee_Emp_Id, Employee_Emp_Email, Employee_Emp_Address, Employee_Emp_Position, Employee_Emp_ContactNo, Employee_Emp_Date_Of_Joint, Employee_Emp_NIC, Employee_Emp_Name, Employee_Emp_DOB, Employee_Emp_Department, Employee_Emp_Salary}
...
Salary.attributes={Salary_Emp_Id, Salary_OverTime, Salary_Sly_Netgross, Salary_Sly_Increment, Salary_Sly_Decrement, Salary_Sly_Basic}
...
Leave.attributes={Leave_Emp_Id, Leave_Leave_Title, Leave_Leave_StartDate, Leave_Leave_EndDate, Leave_leave_id, Leave_Leave_NoOfDays, Leave_Leave_ApplyDate, Leave_Leave_detail, Leave_Leave_Status}
...
domain_model = DomainModel(
    name="e009b5b9_451c_4775_bcb3_aa3dac13c302",
