...
# Classes
feature_FeatureDependency = Class(name="feature_FeatureDependency", is_abstract=True)
feature_FeatureModel = Class(name="feature_FeatureModel")
HybridDimension = Class(name="HybridDimension")
feature_RootRelationship = Class(name="feature_RootRelationship")
feature_Feature = Class(name="feature_Feature")
HybridElement = Class(name="HybridElement")
UUIDElement = Class(name="UUIDElement")
feature_Option = Class(name="feature_Option")
feature_DisplayName = Class(name="feature_DisplayName")
feature_ChildRelationship = Class(name="feature_ChildRelationship")
feature_FeatureGroup = Class(name="feature_FeatureGroup", is_abstract=True)
feature_GroupMembership = Class(name="feature_GroupMembership")
feature_Mandatory = Class(name="feature_Mandatory")
feature_Elimination = Class(name="feature_Elimination")
feature_Invariant = Class(name="feature_Invariant")
feature_OrFeatureGroup = Class(name="feature_OrFeatureGroup")
FeatureGroup = Class(name="FeatureGroup")
feature_XorFeatureGroup = Class(name="feature_XorFeatureGroup")
feature_FeatureRequirement = Class(name="feature_FeatureRequirement")
FeatureDependency = Class(name="FeatureDependency")
feature_FeatureExclusion = Class(name="feature_FeatureExclusion")
feature_DefaultBinding = Class(name="feature_DefaultBinding")
feature_Preference = Class(name="feature_Preference")
...
domain_model = DomainModel(
    name="feature",
    types={feature_FeatureDependency, feature_FeatureModel, HybridDimension, feature_RootRelationship, feature_Feature, HybridElement, UUIDElement, feature_Option, feature_DisplayName, feature_ChildRelationship, feature_FeatureGroup, feature_GroupMembership, feature_Mandatory, feature_Elimination, feature_Invariant, feature_OrFeatureGroup, FeatureGroup, feature_XorFeatureGroup, feature_FeatureRequirement, FeatureDependency, feature_FeatureExclusion, feature_DefaultBinding, feature_Preference},
    associations={incomingDependencies10, roots0, features1, featureModel2, featureOption3, names4, children5, parents6, groups8, groupedBy9, targetFeature37, outgoingDependencies11, mandatory13, eliminations15, incomingRoots17, allChildFeatures20, feature22, groupedFeatures24, groupInvariant26, parentFeature27, groupedFeature29, group31, dependencyInvariant33, sourceFeature35, rootInvariant39, rootDefault42, feature44, parent46, child48, parentInvariant50, parentPreference52, feature54, feature56, eliminationInvariant58, eliminationDefault60},
    generalizations={gen_feature_FeatureModel_HybridDimension, gen_feature_Feature_HybridElement, gen_feature_Feature_UUIDElement, gen_feature_DisplayName_HybridElement, gen_feature_FeatureGroup_HybridElement, gen_feature_FeatureGroup_UUIDElement, gen_feature_GroupMembership_HybridElement, gen_feature_OrFeatureGroup_FeatureGroup, gen_feature_XorFeatureGroup_FeatureGroup, gen_feature_FeatureDependency_HybridElement, gen_feature_FeatureDependency_UUIDElement, gen_feature_FeatureRequirement_FeatureDependency, gen_feature_FeatureExclusion_FeatureDependency, gen_feature_RootRelationship_HybridElement, gen_feature_ChildRelationship_HybridElement, gen_feature_Mandatory_HybridElement, gen_feature_Elimination_HybridElement},
    metadata=None
)
