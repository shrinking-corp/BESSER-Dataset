...
class feature_Elimination(HybridElement):
    ...
    def __init__(self, defaultSelection: str, Elimination: "feature_Feature" = None, eliminations: "feature_Feature" = None, feature_Elimination: "feature_Invariant" = None, feature_Elimination61: "feature_DefaultBinding" = None):
...
class feature_Feature(HybridElement, UUIDElement):
    ...
    def __init__(self, transitiveEliminationState: str, targetFeature: set["feature_FeatureDependency"] = None, Feature: "feature_FeatureModel" = None, features: "feature_FeatureModel" = None, feature_Feature: "feature_Option" = None, feature: set["feature_DisplayName"] = None, parent: set["feature_ChildRelationship"] = None, child: set["feature_ChildRelationship"] = None, parentFeature: set["feature_FeatureGroup"] = None, groupedFeature: set["feature_GroupMembership"] = None, Feature38: "feature_FeatureDependency" = None, sourceFeature: set["feature_FeatureDependency"] = None, feature14: "feature_Mandatory" = None, feature16: set["feature_Elimination"] = None, feature18: set["feature_RootRelationship"] = None, feature_Feature21: "feature_Feature" = None, feature_Feature19: set["feature_Feature"] = None, Feature23: "feature_DisplayName" = None, Feature28: "feature_FeatureGroup" = None, Feature30: "feature_GroupMembership" = None, Feature36: "feature_FeatureDependency" = None, Feature45: "feature_RootRelationship" = None, Feature47: "feature_ChildRelationship" = None, Feature49: "feature_ChildRelationship" = None, Feature55: "feature_Mandatory" = None, Feature57: "feature_Elimination" = None):
        ...
        pass
    @property
    def transitiveEliminationState(self):
