...
class VHDLModel_Block(ABC):
    ...
    def __init__(self, name: str, VHDLModel_Block: set["VHDLModel_InputPort"] = None, VHDLModel_Block12: "VHDLModel_CompositeBlock" = None, VHDLModel_Block23: "VHDLModel_Port" = None):
        self.name = name
