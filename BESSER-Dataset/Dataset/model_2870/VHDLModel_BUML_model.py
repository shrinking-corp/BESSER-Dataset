...
# Classes
VHDLModel_NotGate = Class(name="VHDLModel_NotGate")
VHDLModel_AndGate = Class(name="VHDLModel_AndGate")
BinaryGate = Class(name="BinaryGate")
VHDLModel_BinaryGate = Class(name="VHDLModel_BinaryGate", is_abstract=True)
Block = Class(name="Block")
VHDLModel_InputPort = Class(name="VHDLModel_InputPort")
VHDLModel_OutputPort = Class(name="VHDLModel_OutputPort")
VHDLModel_Block = Class(name="VHDLModel_Block", is_abstract=True)
VHDLModel_BlockRef = Class(name="VHDLModel_BlockRef")
ComplexBlock = Class(name="ComplexBlock")
VHDLModel_CompositeBlock = Class(name="VHDLModel_CompositeBlock")
VHDLModel_ComplexBlock = Class(name="VHDLModel_ComplexBlock", is_abstract=True)
VHDLModel_Port = Class(name="VHDLModel_Port", is_abstract=True)
Port = Class(name="Port")
VHDLModel_OrGate = Class(name="VHDLModel_OrGate")
VHDLModel_Signal = Class(name="VHDLModel_Signal")
VHDLModel_VHDLSpecification = Class(name="VHDLModel_VHDLSpecification")
...
VHDLModel_Port.attributes={VHDLModel_Port_high, VHDLModel_Port_name}
...
domain_model = DomainModel(
    name="VHDLModel",
    types={VHDLModel_NotGate, VHDLModel_AndGate, BinaryGate, VHDLModel_BinaryGate, Block, VHDLModel_InputPort, VHDLModel_OutputPort, VHDLModel_Block, VHDLModel_BlockRef, ComplexBlock, VHDLModel_CompositeBlock, VHDLModel_ComplexBlock, VHDLModel_Port, Port, VHDLModel_OrGate, VHDLModel_Signal, VHDLModel_VHDLSpecification},
    associations={outputport13, inputport20, inputport11, outputport4, inputs6, block8, ports9, blocks10, inputport15, src19, block21, blocks24},
    generalizations={gen_VHDLModel_NotGate_Block, gen_VHDLModel_AndGate_BinaryGate, gen_VHDLModel_BinaryGate_Block, gen_VHDLModel_BlockRef_ComplexBlock, gen_VHDLModel_ComplexBlock_Block, gen_VHDLModel_CompositeBlock_ComplexBlock, gen_VHDLModel_InputPort_Port, gen_VHDLModel_OrGate_BinaryGate, gen_VHDLModel_OutputPort_Port, gen_VHDLModel_Signal_Port},
    metadata=None
)
