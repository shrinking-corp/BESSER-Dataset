...
def test_model_command_has_message():
    assert hasattr(model_Command, "message")
    descriptor = None
    for klass in model_Command.__mro__:
...
def test_model_ozobot_has_xposition():
    assert hasattr(model_Ozobot, "xposition")
    descriptor = None
    for klass in model_Ozobot.__mro__:
        if "xposition" in klass.__dict__:
            descriptor = klass.__dict__["xposition"]
            break
    assert isinstance(descriptor, property)

def test_model_ozobot_has_orientation():
    assert hasattr(model_Ozobot, "orientation")
    descriptor = None
    for klass in model_Ozobot.__mro__:
...
def test_model_ozobot_has_yposition():
    assert hasattr(model_Ozobot, "yposition")
    descriptor = None
    for klass in model_Ozobot.__mro__:
...
@given(instance=model_Command_strategy)
def test_model_command_message_setter(instance):
...
@given(instance=model_Ozobot_strategy)
def test_model_ozobot_xposition_setter(instance):
...
@given(instance=model_Ozobot_strategy)
def test_model_ozobot_orientation_setter(instance):
...
@given(instance=model_Ozobot_strategy)
def test_model_ozobot_yposition_setter(instance):
