...
model_OzobotProgram = Class(name="model_OzobotProgram")
NamedElement = Class(name="NamedElement")
model_Block = Class(name="model_Block")
model_Command = Class(name="model_Command", is_abstract=True)
model_Transition = Class(name="model_Transition")
model_Move = Class(name="model_Move")
Command = Class(name="Command")
model_Light = Class(name="model_Light")
model_Rotate = Class(name="model_Rotate")
model_Wait = Class(name="model_Wait")
model_Repeat = Class(name="model_Repeat")
model_Ozobot = Class(name="model_Ozobot")
...
model_Rotate.attributes={model_Rotate_angle, model_Rotate_velocity, model_Rotate_direction}
...
model_Ozobot.attributes={model_Ozobot_xposition, model_Ozobot_orientation, model_Ozobot_yposition}
...
incoming7: BinaryAssociation = BinaryAssociation(
    name="incoming7",
    ends={
        Property(name="Transition8", type=model_Command, multiplicity=Multiplicity(1, 1)),
...
block9: BinaryAssociation = BinaryAssociation(
    name="block9",
    ends={
        Property(name="model_Block10", type=model_Repeat, multiplicity=Multiplicity(1, 1)),
        Property(name="model_Repeat", type=model_Block, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
programs11: BinaryAssociation = BinaryAssociation(
    name="programs11",
    ends={
        Property(name="model_OzobotProgram12", type=model_Ozobot, multiplicity=Multiplicity(1, 1)),
        Property(name="model_Ozobot", type=model_OzobotProgram, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
commands13: BinaryAssociation = BinaryAssociation(
    name="commands13",
    ends={
        Property(name="model_Command15", type=model_Block, multiplicity=Multiplicity(1, 1)),
        Property(name="model_Block14", type=model_Command, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
transitions16: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="model_Block17", type=model_Transition, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
target19: BinaryAssociation = BinaryAssociation(
    name="target19",
    ends={
        Property(name="Command20", type=model_Transition, multiplicity=Multiplicity(1, 1)),
...
domain_model = DomainModel(
    ...
    associations={block0, current1, currentCommand3, outgoing6, incoming7, block9, programs11, commands13, transitions16, source18, target19},
