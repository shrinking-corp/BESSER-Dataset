...
DBLP_Record.attributes={DBLP_Record_key, DBLP_Record_ee, DBLP_Record_mdate, DBLP_Record_url}
...
DBLP_Article.attributes={DBLP_Article_volume, DBLP_Article_month, DBLP_Article_number, DBLP_Article_fromPage, DBLP_Article_title, DBLP_Article_year, DBLP_Article_toPage}
...
DBLP_Book.attributes={DBLP_Book_edition, DBLP_Book_series, DBLP_Book_title, DBLP_Book_year, DBLP_Book_month, DBLP_Book_volume, DBLP_Book_isbn}
...
DBLP_InCollection.attributes={DBLP_InCollection_toPage, DBLP_InCollection_month, DBLP_InCollection_fromPage, DBLP_InCollection_bookTitle, DBLP_InCollection_title, DBLP_InCollection_year}
...
DBLP_InProceedings.attributes={DBLP_InProceedings_fromPage, DBLP_InProceedings_toPage, DBLP_InProceedings_year, DBLP_InProceedings_title, DBLP_InProceedings_bootitle, DBLP_InProceedings_month}
...
DBLP_Proceedings.attributes={DBLP_Proceedings_month, DBLP_Proceedings_title, DBLP_Proceedings_isbn, DBLP_Proceedings_year}
...
DBLP_Www.attributes={DBLP_Www_month, DBLP_Www_title, DBLP_Www_year}
...
domain_model = DomainModel(
    name="DBLP",
    types={DBLP_Record, DBLP_Author, DBLP_Article, Record, DBLP_Journal, DBLP_Book, DBLP_Publisher, DBLP_InCollection, DBLP_Editor, DBLP_Organization, DBLP_InProceedings, DBLP_MastersThesis, DBLP_School, DBLP_Proceedings, DBLP_PhDThesis, DBLP_Www},
    associations={authors0, journal1, articles3, publisher4, editors5, sponsoredBy6, publisher8, records2, editors11, organization13, publisher16, school19, editors20, publisher22, sponsoredBy25, school28, editors30},
