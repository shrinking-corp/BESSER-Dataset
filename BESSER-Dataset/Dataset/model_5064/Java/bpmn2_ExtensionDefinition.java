...
public class bpmn2_ExtensionDefinition  {
    ...
    private bpmn2_Extension bpmn2_extension;
    ...
    public bpmn2_Extension getBpmn2_extension() {
        return bpmn2_extension;
    }

    public void setBpmn2_extension(bpmn2_Extension bpmn2_extension) {
        this.bpmn2_extension = bpmn2_extension;
    }
