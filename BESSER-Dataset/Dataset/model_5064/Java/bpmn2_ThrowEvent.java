...
public class bpmn2_ThrowEvent extends Event {
    ...
    public bpmn2_ThrowEvent(
        ArrayList<bpmn2_EventDefinition> bpmn2_eventdefinitions,        ArrayList<bpmn2_DataInputAssociation> bpmn2_datainputassociations,        ArrayList<bpmn2_DataInput> bpmn2_datainputs,        ArrayList<bpmn2_EventDefinition> bpmn2_eventdefinitions    ) {
