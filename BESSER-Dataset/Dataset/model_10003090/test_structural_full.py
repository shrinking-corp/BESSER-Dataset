...
def test_Profile_Name_value_roundtrip():
    instance = Profile(Name="sample_text", password="sample_text", user_Name="sample_text")
...
def test_assoc_Profile_Attendance_link_reassign_clear():
    a = Profile(Name="sample_text", password="sample_text", user_Name="sample_text")
...
Profile_strategy = st.builds(Profile, Name=safe_text, password=safe_text, user_Name=safe_text)
