...
class Normal_user:
    ...
    def __init__(self, password: str, userID: int, userName: str, calender_Event4: set["Calender_Event"] = None, payment216: "Payment" = None):
        self.password = password
        self.userID = userID
        self.userName = userName
...
class Profile:
    ...
    def __init__(self, Name: str, user_Name: str, password: str, Track_Attendance8: "Attendance" = None):
        self.Name = Name
