...
expansionmodel_InducedRepresentation = Class(name="expansionmodel_InducedRepresentation")
expansionmodel_AbstractRepresentation = Class(name="expansionmodel_AbstractRepresentation", is_abstract=True)
expansionmodel_RepresentationKind = Class(name="expansionmodel_RepresentationKind")
expansionmodel_Representation = Class(name="expansionmodel_Representation")
expansionmodel_GraphicalElementLibrary = Class(name="expansionmodel_GraphicalElementLibrary")
expansionmodel_UseContext = Class(name="expansionmodel_UseContext")
expansionmodel_GMFT_BasedRepresentation = Class(name="expansionmodel_GMFT_BasedRepresentation")
Representation = Class(name="Representation")
expansionmodel_DiagramExpansion = Class(name="expansionmodel_DiagramExpansion")
...
expansionmodel_AbstractRepresentation_m_validate: Method = Method(name="validate", parameters={Parameter(name='expansionmodel_diagnostic', type=StringType), Parameter(name='expansionmodel_context', type=StringType)}, type=BooleanType)
expansionmodel_AbstractRepresentation.attributes={expansionmodel_AbstractRepresentation_viewFactory, expansionmodel_AbstractRepresentation_name, expansionmodel_AbstractRepresentation_editPartQualifiedName}
...
expansionmodel_RepresentationKind.attributes={expansionmodel_RepresentationKind_viewFactory, expansionmodel_RepresentationKind_name, expansionmodel_RepresentationKind_editPartQualifiedName}
...
domain_model = DomainModel(
    name="expansionmodel",
    types={AbstractRepresentation, expansionmodel_InducedRepresentation, expansionmodel_AbstractRepresentation, expansionmodel_RepresentationKind, expansionmodel_Representation, expansionmodel_GraphicalElementLibrary, expansionmodel_UseContext, expansionmodel_GMFT_BasedRepresentation, Representation, expansionmodel_DiagramExpansion},
    ...
    generalizations={gen_expansionmodel_Representation_AbstractRepresentation, gen_expansionmodel_GMFT_BasedRepresentation_Representation, gen_expansionmodel_InducedRepresentation_AbstractRepresentation},
    metadata=None
)
