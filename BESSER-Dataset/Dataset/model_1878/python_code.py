...
class expansionmodel_RepresentationKind:
    ...
    @property
    def editPartQualifiedName(self):
...
class expansionmodel_AbstractRepresentation(ABC):
    ...
    def validate(self, expansionmodel_context, expansionmodel_diagnostic) :
...
class expansionmodel_Representation(AbstractRepresentation):
    ...
    def __init__(self, graphicalElementType: str, expansionmodel_Representation1: set["expansionmodel_Representation"] = None, expansionmodel_Representation7: "expansionmodel_InducedRepresentation" = None, expansionmodel_Representation14: "expansionmodel_UseContext" = None, expansionmodel_Representation: set["expansionmodel_InducedRepresentation"] = None, expansionmodel_Representation3: "expansionmodel_Representation" = None):
...
class expansionmodel_InducedRepresentation(AbstractRepresentation):
    ...
    def __init__(self, hint: str, expansionmodel_InducedRepresentation6: set["expansionmodel_Representation"] = None, expansionmodel_InducedRepresentation: "expansionmodel_Representation" = None):
        self.hint = hint
