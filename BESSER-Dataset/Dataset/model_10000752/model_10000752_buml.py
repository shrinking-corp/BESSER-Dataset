...
Order.attributes={Order_number, Order_status, Order_ordered, Order_shipTo, Order_total, Order_shipped}
...
domain_model = DomainModel(
    name="_5c5c2aab_8864_4f9d_b088_c40445c6aa52",
    types={Customer, Payment, ShoppingCart, Account, WebUser, Order, LineItem, Product, UserState, OrderStatus},
    associations={Account_Payment, WebUser_ShoppingCart, Account_Order, Payment_Order, WebUser_Customer, Customer_Account, Account_ShoppingCart, ShoppingCart_LineItem, Product_LineItem, Order_LineItem},
    generalizations={},
    metadata=None
)
