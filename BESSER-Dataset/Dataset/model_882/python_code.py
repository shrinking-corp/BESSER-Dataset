...
class simplepdl_WorkDefinition(ProcessElement):
    ...
    def __init__(self, name: str, WorkDefinition: "simplepdl_WorkSequence" = None, WorkDefinition7: "simplepdl_WorkSequence" = None, WorkDefinition12: "simplepdl_Allocation" = None, successor: set["simplepdl_WorkSequence"] = None, predecessor: set["simplepdl_WorkSequence"] = None, workdefinition: set["simplepdl_Allocation"] = None):
        self.name = name
...
class simplepdl_Allocation(ProcessElement):
    ...
    def __init__(self, count: int, simplepdl_Allocation: "simplepdl_Ressource" = None, allocation: "simplepdl_WorkDefinition" = None, Allocation: "simplepdl_WorkDefinition" = None):
        self.count = count
