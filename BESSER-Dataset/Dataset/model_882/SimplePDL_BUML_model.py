...
domain_model = DomainModel(
    name="simplepdl",
    types={simplepdl_WorkSequence, simplepdl_Allocation, simplepdl_Guidance, simplepdl_Process, simplepdl_ProcessElement, simplepdl_WorkDefinition, ProcessElement, simplepdl_Ressource, WorkSequenceType},
    associations={linksToPredecessors1, linksToSuccessors2, allocation4, predecessor5, successor6, processElements0, elements8, ressource10, workdefinition11},
    generalizations={gen_simplepdl_WorkSequence_ProcessElement, gen_simplepdl_Guidance_ProcessElement, gen_simplepdl_WorkDefinition_ProcessElement, gen_simplepdl_Ressource_ProcessElement, gen_simplepdl_Allocation_ProcessElement},
    metadata=None
)
