...
pn_NetElement = Class(name="pn_NetElement", is_abstract=True)
...
domain_model = DomainModel(
    name="pn",
    types={pn_Net, NamedElement, pn_NetElement, pn_Transition, NetElement, pn_Place, pn_NamedElement},
    associations={elements0, net1, trgT2P2, srcP2T3, trgP2T5, srcT2P6},
    generalizations={gen_pn_Net_NamedElement, gen_pn_NetElement_NamedElement, gen_pn_Transition_NetElement, gen_pn_Place_NetElement, gen_pn_Place_NamedElement},
    metadata=None
)
