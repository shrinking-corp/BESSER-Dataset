...
class rdb_Table:
    ...
    def __init__(self, name: str, constraints: str, logicalName: str, comment: str, table: set["rdb_Column"] = None, tables: "rdb_DB" = None, target: set["rdb_Relation"] = None, source: set["rdb_Relation"] = None, rdb_Table: "rdb_UserComment" = None, Table11: "rdb_Column" = None, Table: "rdb_DB" = None, rdb_Table19: "rdb_View" = None, Table13: "rdb_Relation" = None, Table15: "rdb_Relation" = None):
        self.name = name
...
class rdb_DB(ERDInfo):
    ...
    def __init__(self, comment: str, dbType: str, key: str, url: str, id: str, sid: str, db2: set["rdb_Relation"] = None, DB: "rdb_Table" = None, db: set["rdb_Table"] = None, DB17: "rdb_Relation" = None):
        self.comment = comment
        self.dbType = dbType
        self.key = key
        self.url = url
