...
rdb_Relation.attributes={rdb_Relation_bendpoint, rdb_Relation_constraint_name, rdb_Relation_target_kind, rdb_Relation_comment, rdb_Relation_referenced_column_name, rdb_Relation_source_kind, rdb_Relation_column_name}
...
rdb_Column.attributes={rdb_Column_extra, rdb_Column_field, rdb_Column_key, rdb_Column_logicalField, rdb_Column_default, rdb_Column_type, rdb_Column_comment, rdb_Column_null}
...
rdb_DB.attributes={rdb_DB_comment, rdb_DB_url, rdb_DB_key, rdb_DB_sid, rdb_DB_dbType, rdb_DB_id}
...
domain_model = DomainModel(
    name="rdb",
    types={rdb_Relation, rdb_Column, rdb_UserComment, rdb_DB, ERDInfo, rdb_Table, rdb_View, Table, rdb_ERDInfo, RelationKind},
    associations={references1, columns3, db4, incomingLinks5, outgoingLinks7, UserCommentReference9, table10, tables0, tableName18, source12, target14, db16},
