...
# Classes
Fragmentos_Aplicacion = Class(name="Fragmentos_Aplicacion")
Fragmentos_Fichero = Class(name="Fragmentos_Fichero")
Fragmentos_Fragmento = Class(name="Fragmentos_Fragmento")
...
Fragmentos_Fragmento.attributes={Fragmentos_Fragmento_posCaracter, Fragmentos_Fragmento_texto, Fragmentos_Fragmento_numLinea}
...
domain_model = DomainModel(
    name="Fragmentos",
    types={Fragmentos_Aplicacion, Fragmentos_Fichero, Fragmentos_Fragmento},
