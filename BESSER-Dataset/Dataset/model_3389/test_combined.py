...
def test_hyp_fragmentos_fragmento_is_not_abstract():
    assert not inspect.isabstract(Fragmentos_Fragmento)


def test_hyp_fragmentos_fragmento_constructor_exists():
    assert callable(Fragmentos_Fragmento.__init__)


def test_hyp_fragmentos_fragmento_constructor_args():
...
def test_hyp_fragmentos_fichero_is_not_abstract():
    assert not inspect.isabstract(Fragmentos_Fichero)


def test_hyp_fragmentos_fichero_constructor_exists():
    assert callable(Fragmentos_Fichero.__init__)


def test_hyp_fragmentos_fichero_constructor_args():
...
def test_hyp_fragmentos_aplicacion_is_not_abstract():
    assert not inspect.isabstract(Fragmentos_Aplicacion)


def test_hyp_fragmentos_aplicacion_constructor_exists():
    assert callable(Fragmentos_Aplicacion.__init__)


def test_hyp_fragmentos_aplicacion_constructor_args():
...
def test_hyp_fragmentos_fragmento_posCaracter_setter(instance):
...
@given(instance=Fragmentos_Fragmento_strategy)
def test_hyp_fragmentos_fragmento_texto_setter(instance):
...
@given(instance=Fragmentos_Fragmento_strategy)
def test_hyp_fragmentos_fragmento_numLinea_setter(instance):
...
def test_hyp_fragmentos_fichero_nombre_setter(instance):
