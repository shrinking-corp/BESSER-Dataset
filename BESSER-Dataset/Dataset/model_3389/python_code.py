...
class Fragmentos_Fichero:
    ...
    def __init__(self, nombre: str, Fragmentos_Fichero: "Fragmentos_Aplicacion" = None, Fragmentos_Fichero2: set["Fragmentos_Fragmento"] = None, Fragmentos_Fichero4: set["Fragmentos_Fragmento"] = None):
        self.nombre = nombre
