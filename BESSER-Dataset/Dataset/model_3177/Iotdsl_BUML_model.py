...
iotdsl_State = Class(name="iotdsl_State")
iotdsl_Event = Class(name="iotdsl_Event")
iotdsl_Transition = Class(name="iotdsl_Transition")
iotdsl_Action = Class(name="iotdsl_Action")
iotdsl_Variable = Class(name="iotdsl_Variable")
Action = Class(name="Action")
iotdsl_Expression = Class(name="iotdsl_Expression")
iotdsl_IfStatement = Class(name="iotdsl_IfStatement")
iotdsl_Iot = Class(name="iotdsl_Iot")
iotdsl_Device = Class(name="iotdsl_Device")
iotdsl_Equality = Class(name="iotdsl_Equality")
iotdsl_Comparison = Class(name="iotdsl_Comparison")
iotdsl_Plus = Class(name="iotdsl_Plus")
iotdsl_Minus = Class(name="iotdsl_Minus")
iotdsl_MulOrDiv = Class(name="iotdsl_MulOrDiv")
iotdsl_Not = Class(name="iotdsl_Not")
Expression = Class(name="Expression")
iotdsl_IfBlock = Class(name="iotdsl_IfBlock")
iotdsl_Or = Class(name="iotdsl_Or")
iotdsl_And = Class(name="iotdsl_And")
...
iotdsl_VariableRef = Class(name="iotdsl_VariableRef")
...
domain_model = DomainModel(
    name="iotdsl",
    types={iotdsl_Attribute, iotdsl_State, iotdsl_Event, iotdsl_Transition, iotdsl_Action, iotdsl_Variable, Action, iotdsl_Expression, iotdsl_IfStatement, iotdsl_Iot, iotdsl_Device, iotdsl_Equality, iotdsl_Comparison, iotdsl_Plus, iotdsl_Minus, iotdsl_MulOrDiv, iotdsl_Not, Expression, iotdsl_IfBlock, iotdsl_Or, iotdsl_And, iotdsl_IntConstant, iotdsl_StringConstant, iotdsl_BoolConstant, iotdsl_VariableRef},
    associations={attributes4, states6, events8, transitions10, elements12, event14, state17, expression20, devices0, superType2, left41, right43, left46, right48, left51, right53, left56, right58, left61, right63, expression21, thenBlock23, elseBlock25, statements28, left31, right33, left36, right38, expression66, variable68},
    generalizations={gen_iotdsl_Variable_Action, gen_iotdsl_Expression_Action, gen_iotdsl_Equality_Expression, gen_iotdsl_Comparison_Expression, gen_iotdsl_Plus_Expression, gen_iotdsl_Minus_Expression, gen_iotdsl_MulOrDiv_Expression, gen_iotdsl_IfStatement_Expression, gen_iotdsl_Or_Expression, gen_iotdsl_And_Expression, gen_iotdsl_Not_Expression, gen_iotdsl_IntConstant_Expression, gen_iotdsl_StringConstant_Expression, gen_iotdsl_BoolConstant_Expression, gen_iotdsl_VariableRef_Expression},
    metadata=None
)
