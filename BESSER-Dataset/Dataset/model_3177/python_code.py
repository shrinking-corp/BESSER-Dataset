...
class iotdsl_Comparison(Expression):
    ...
    def __init__(self, op: str, iotdsl_Comparison49: "iotdsl_Expression" = None, iotdsl_Comparison: "iotdsl_Expression" = None):
        self.op = op
...
class iotdsl_Equality(Expression):
    ...
    def __init__(self, op: str, iotdsl_Equality: "iotdsl_Expression" = None, iotdsl_Equality44: "iotdsl_Expression" = None):
        self.op = op
...
class iotdsl_Device:
    ...
    def __init__(self, name: str, iotdsl_Device5: "iotdsl_Attribute" = None, iotdsl_Device7: set["iotdsl_State"] = None, iotdsl_Device9: set["iotdsl_Event"] = None, iotdsl_Device11: set["iotdsl_Transition"] = None, iotdsl_Device: "iotdsl_Iot" = None, iotdsl_Device3: "iotdsl_Device" = None, iotdsl_Device1: "iotdsl_Device" = None):
        self.name = name
...
class iotdsl_Variable(Action):
    ...
    def __init__(self, name: str, iotdsl_Variable69: "iotdsl_VariableRef" = None, iotdsl_Variable: "iotdsl_Expression" = None):
        self.name = name
...
class iotdsl_State:
    ...
    def __init__(self, name: str, iotdsl_State: "iotdsl_Device" = None, iotdsl_State13: set["iotdsl_Action"] = None, iotdsl_State19: "iotdsl_Transition" = None):
        self.name = name
