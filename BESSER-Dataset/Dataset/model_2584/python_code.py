...
class atomic_AToken(ANode):
    ...
    def __init__(self, text: str, AToken7: "atomic_AToken" = None, previous: "atomic_AToken" = None, AToken10: "atomic_AToken" = None, next: "atomic_AToken" = None, tokens: "atomic_AGraph" = None, AToken: "atomic_AGraph" = None):
        self.text = text
...
class atomic_AGraph:
    ...
    def __init__(self, corpus: str, graph2: set["atomic_AStructured"] = None, graph4: set["atomic_AEdge"] = None, AGraph: "atomic_AToken" = None, AGraph14: "atomic_AStructured" = None, AGraph16: "atomic_AEdge" = None, atomic_AGraph: "atomic_ATargetEdge" = None, graph: set["atomic_AToken"] = None):
        self.corpus = corpus
