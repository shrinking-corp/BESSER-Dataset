...
# _____ class attributes and methods
______ownerName: Property = Property(name="ownerName", type=StringType)
______balance: Property = Property(name="balance", type=FloatType)
_____.attributes={______balance, ______ownerName}
...
ClassA.attributes={ClassA_protectedAttribute, ClassA_publicAttribute, ClassA_packageAttribute, ClassA_privateAttribute}
...
domain_model = DomainModel(
    name="b275cf39_3d69_4122_ab0e_de6898c983bd",
    types={ClassH, ClassK, ClassL, ClassM, ClassN, ClassP, InterfaceO_Interface, ClassQ, ClassR, ClassS, ClassT, ClassU, ClassV, _____, ClassA, ClassB, ClassC, ClassD, ClassE, ClassF, ClassG, ClassJ},
