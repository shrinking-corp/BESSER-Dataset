...
fsm_System = Class(name="fsm_System")
...
fsm_FSM.attributes={fsm_FSM_underProcessTrigger, fsm_FSM_name, fsm_FSM_consummedString}
...
fsm_Buffer.attributes={fsm_Buffer_initialValue, fsm_Buffer_name, fsm_Buffer_currentValues}
...
domain_model = DomainModel(
    name="fsm",
    types={fsm_FSM, fsm_State, fsm_Transition, fsm_System, fsm_Buffer},
    associations={ownedStates0, ownedTransitions1, tgt19, src21, fsm23, ownedFsms25, ownedBuffers27, inputBuffer3, outputBuffer4, initialState6, currentState7, incoming10, outgoing12, fsm14, outgoingFSM15, incomingFSM17},
    generalizations={},
    metadata=None
)
