...
Middle_Tier_Actor = Class(name="Middle_Tier_Actor")
Class_ = Class(name="Class")
JLGCurrentUserRestResource = Class(name="JLGCurrentUserRestResource")
JLGProfileFormHandler = Class(name="JLGProfileFormHandler")
postCreateUser_Interface = Class(name="postCreateUser_Interface")
SiteCoreServiceManager = Class(name="SiteCoreServiceManager")
...
# Middle_Tier_Actor class attributes and methods

# Class class attributes and methods

# JLGCurrentUserRestResource class attributes and methods
JLGCurrentUserRestResource_visitorId: Property = Property(name="visitorId", type=StringType)
JLGCurrentUserRestResource_formURL: Property = Property(name="formURL", type=StringType)
JLGCurrentUserRestResource.attributes={JLGCurrentUserRestResource_formURL, JLGCurrentUserRestResource_visitorId}

# JLGProfileFormHandler class attributes and methods

# postCreateUser_Interface class attributes and methods

# SiteCoreServiceManager class attributes and methods
...
domain_model = DomainModel(
    name="_hAzqIDAqEeqqcaoAsxFIeg",
    types={ShoppingCartExample_Customer, Client_Actor, Middle_Tier_Actor, Class_, JLGCurrentUserRestResource, JLGProfileFormHandler, postCreateUser_Interface, SiteCoreServiceManager, ShoppingCartExample_ShoppingCart, ShoppingCartExample_Order, ShoppingCartExample_LineItem, ShoppingCartExample_Account},
