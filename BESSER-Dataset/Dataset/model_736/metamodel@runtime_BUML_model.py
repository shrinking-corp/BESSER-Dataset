...
art_type_DictionaryDefaultValue.attributes={art_type_DictionaryDefaultValue_value, art_type_DictionaryDefaultValue_key}
...
superComponent13: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="CompositeInstance14", type=art_instance_ComponentInstance, multiplicity=Multiplicity(1, 1)),
...
operation47: BinaryAssociation = BinaryAssociation(
    name="operation47",
    ends={
...
input48: BinaryAssociation = BinaryAssociation(
    name="input48",
    ends={
...
output49: BinaryAssociation = BinaryAssociation(
    name="output49",
    ends={
        Property(name="Parameter51", type=art_type_Operation, multiplicity=Multiplicity(1, 1)),
        Property(name="art_type_Operation50", type=Parameter_, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
service52: BinaryAssociation = BinaryAssociation(
    name="service52",
    ends={
        Property(name="Service53", type=art_type_AbstractPort, multiplicity=Multiplicity(1, 1)),
        Property(name="art_type_AbstractPort", type=Service, multiplicity=Multiplicity(1, 1))
    }
)
ids54: BinaryAssociation = BinaryAssociation(
    name="ids54",
    ends={
...
valueType55: BinaryAssociation = BinaryAssociation(
    name="valueType55",
    ends={
...
implem45: BinaryAssociation = BinaryAssociation(
    name="implem45",
    ends={
        Property(name="TypeImplementation", type=art_type_ComponentType, multiplicity=Multiplicity(1, 1)),
        Property(name="art_type_ComponentType46", type=TypeImplementation, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
types59: BinaryAssociation = BinaryAssociation(
    name="types59",
    ends={
        Property(name="ComponentType60", type=art_group_TypeGroup, multiplicity=Multiplicity(1, 1)),
        Property(name="groups", type=ComponentType, multiplicity=Multiplicity(0, 9999))
    }
)
subGroups61: BinaryAssociation = BinaryAssociation(
    name="subGroups61",
    ends={
        Property(name="TypeGroup62", type=art_group_TypeGroup, multiplicity=Multiplicity(1, 1)),
        Property(name="art_group_TypeGroup", type=TypeGroup, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
instances63: BinaryAssociation = BinaryAssociation(
    name="instances63",
    ends={
        Property(name="ComponentInstance65", type=art_group_InstanceGroup, multiplicity=Multiplicity(1, 1)),
        Property(name="groups64", type=ComponentInstance, multiplicity=Multiplicity(0, 9999))
    }
)
subGroups66: BinaryAssociation = BinaryAssociation(
    name="subGroups66",
    ends={
        Property(name="InstanceGroup67", type=art_group_InstanceGroup, multiplicity=Multiplicity(1, 1)),
        Property(name="art_group_InstanceGroup", type=InstanceGroup, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
keys56: BinaryAssociation = BinaryAssociation(
    name="keys56",
    ends={
        Property(name="DictionaryDefaultValue58", type=art_type_Dictionary, multiplicity=Multiplicity(1, 1)),
        Property(name="art_type_Dictionary57", type=DictionaryDefaultValue, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
domain_model = DomainModel(
    name="art",
    types={art_ModelElement, NamedElement, art_System, ModelElement, CompositeInstance, Service, ComponentType, art_DataType, Group, art_TypedElement, art_CardinalityElement, art_instance_ComponentInstance, AttributeInstance, TransmissionBinding, ComponentImplementation, InstanceGroup, art_NamedElement, art_instance_Binding, art_instance_TransmissionBinding, Binding, AbstractPort, art_instance_DelegationBinding, art_instance_AttributeInstance, art_instance_ValuedAttribute, BasicAttribute, art_instance_DictionaryValuedAttribute, Entry, Dictionary, art_instance_Entry, art_instance_DefaultEntry, DictionaryDefaultValue, art_instance_OtherEntry, art_type_ComponentType, Attribute, art_instance_PrimitiveInstance, ComponentInstance, art_instance_CompositeInstance, DelegationBinding, art_type_Service, Operation, art_type_Operation, Parameter_, art_type_Parameter, TypedElement, art_type_FunctionalService, art_type_ControlService, art_type_AbstractPort, art_type_Port, CardinalityElement, type_AbstractPort, art_type_PortCollection, PortId, art_type_PortId, art_type_Attribute, art_type_BasicAttribute, art_type_Dictionary, type_art_DataType, TypeGroup, TypeImplementation, art_type_PrimitiveType, art_type_CompositeType, art_implem_TypeImplementation, art_implem_OSGiType, art_group_Group, art_group_TypeGroup, art_group_InstanceGroup, art_type_DictionaryDefaultValue, art_implem_ComponentImplementation, art_implem_FractalComponent, art_implem_OSGiComponent, InstanceState, PortRole},
    associations={root0, services1, types3, dataTypes5, groups7, type9, type11, superComponent13, attribute15, binding17, implem19, serverInstance24, client26, server27, source30, exported32, attribute35, entries36, attribute37, key39, port40, groups21, subComponent22, delegation23, operation47, input48, output49, service52, ids54, valueType55, attribute42, groups44, implem45, types59, subGroups61, instances63, subGroups66, keys56},
    generalizations={gen_art_ModelElement_NamedElement, gen_art_System_ModelElement, gen_art_DataType_ModelElement, gen_art_TypedElement_ModelElement, gen_art_CardinalityElement_ModelElement, gen_art_instance_ComponentInstance_ModelElement, gen_art_instance_TransmissionBinding_Binding, gen_art_instance_DelegationBinding_Binding, gen_art_instance_ValuedAttribute_AttributeInstance, gen_art_instance_DictionaryValuedAttribute_AttributeInstance, gen_art_instance_DefaultEntry_Entry, gen_art_instance_OtherEntry_Entry, gen_art_type_ComponentType_ModelElement, gen_art_instance_PrimitiveInstance_ComponentInstance, gen_art_instance_CompositeInstance_ComponentInstance, gen_art_type_CompositeType_ComponentType, gen_art_type_Service_ModelElement, gen_art_type_Operation_ModelElement, gen_art_type_Parameter_TypedElement, gen_art_type_FunctionalService_Service, gen_art_type_ControlService_Service, gen_art_type_AbstractPort_NamedElement, gen_art_type_Port_CardinalityElement, gen_art_type_Port_type_AbstractPort, gen_art_type_PortCollection_AbstractPort, gen_art_type_PortId_NamedElement, gen_art_type_Attribute_TypedElement, gen_art_type_BasicAttribute_Attribute, gen_art_type_Dictionary_Attribute, gen_art_type_PrimitiveType_ComponentType, gen_art_implem_OSGiType_TypeImplementation, gen_art_group_Group_NamedElement, gen_art_group_TypeGroup_Group, gen_art_group_InstanceGroup_Group, gen_art_implem_FractalComponent_ComponentImplementation, gen_art_implem_OSGiComponent_ComponentImplementation},
    metadata=None
)
