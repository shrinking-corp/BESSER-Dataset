...
# Classes
syswbeff1065ok_InputPort = Class(name="syswbeff1065ok_InputPort")
syswbeff1065ok_Description = Class(name="syswbeff1065ok_Description")
syswbeff1065ok_Token = Class(name="syswbeff1065ok_Token")
syswbeff1065ok_Function = Class(name="syswbeff1065ok_Function")
SequenceNode = Class(name="SequenceNode")
ProcessNode = Class(name="ProcessNode")
syswbeff1065ok_Sequence = Class(name="syswbeff1065ok_Sequence", is_abstract=True)
syswbeff1065ok_Flow = Class(name="syswbeff1065ok_Flow")
syswbeff1065ok_OutputPort = Class(name="syswbeff1065ok_OutputPort")
syswbeff1065ok_Final = Class(name="syswbeff1065ok_Final")
syswbeff1065ok_Loop = Class(name="syswbeff1065ok_Loop")
syswbeff1065ok_FunctionProperty = Class(name="syswbeff1065ok_FunctionProperty")
syswbeff1065ok_Component = Class(name="syswbeff1065ok_Component")
syswbeff1065ok_SequenceNode = Class(name="syswbeff1065ok_SequenceNode", is_abstract=True)
syswbeff1065ok_And = Class(name="syswbeff1065ok_And")
Sequence = Class(name="Sequence")
syswbeff1065ok_Or = Class(name="syswbeff1065ok_Or")
syswbeff1065ok_Start = Class(name="syswbeff1065ok_Start")
Port = Class(name="Port")
syswbeff1065ok_Port = Class(name="syswbeff1065ok_Port", is_abstract=True)
syswbeff1065ok_Item = Class(name="syswbeff1065ok_Item")
syswbeff1065ok_ProcessNode = Class(name="syswbeff1065ok_ProcessNode", is_abstract=True)
syswbeff1065ok_LoopExit = Class(name="syswbeff1065ok_LoopExit")
syswbeff1065ok_Iteration = Class(name="syswbeff1065ok_Iteration")
syswbeff1065ok_AssociatedTo = Class(name="syswbeff1065ok_AssociatedTo")
syswbeff1065ok_Thing = Class(name="syswbeff1065ok_Thing")
syswbeff1065ok_Thoughts = Class(name="syswbeff1065ok_Thoughts")
syswbeff1065ok_System = Class(name="syswbeff1065ok_System")
syswbeff1065ok_PatternCatalog = Class(name="syswbeff1065ok_PatternCatalog")
syswbeff1065ok_Workbench = Class(name="syswbeff1065ok_Workbench")
...
domain_model = DomainModel(
    name="syswbeff1065ok",
    types={syswbeff1065ok_InputPort, syswbeff1065ok_Description, syswbeff1065ok_Token, syswbeff1065ok_Function, SequenceNode, ProcessNode, syswbeff1065ok_Sequence, syswbeff1065ok_Flow, syswbeff1065ok_OutputPort, syswbeff1065ok_Final, syswbeff1065ok_Loop, syswbeff1065ok_FunctionProperty, syswbeff1065ok_Component, syswbeff1065ok_SequenceNode, syswbeff1065ok_And, Sequence, syswbeff1065ok_Or, syswbeff1065ok_Start, Port, syswbeff1065ok_Port, syswbeff1065ok_Item, syswbeff1065ok_ProcessNode, syswbeff1065ok_LoopExit, syswbeff1065ok_Iteration, syswbeff1065ok_AssociatedTo, syswbeff1065ok_Thing, syswbeff1065ok_Thoughts, syswbeff1065ok_System, syswbeff1065ok_PatternCatalog, syswbeff1065ok_Workbench, FunctionDomain},
    associations={inputPorts8, descriptions10, tokens12, decompositions1, sequenceNodes2, flows4, outputPorts6, property14, associations17, allocatedTo19, controlFlowEdge22, outputflowEdge28, inputflowEdge23, items26, relatedTo38, parent41, fromThing31, toThing32, relations35, thoughts61, systemView64, functionProperties67, catalog70, decompositions44, associations47, performs49, functionalArchitecture52, physicalArchitecture54, patterns57, things59},
    generalizations={gen_syswbeff1065ok_Function_SequenceNode, gen_syswbeff1065ok_Function_ProcessNode, gen_syswbeff1065ok_Final_Sequence, gen_syswbeff1065ok_Loop_Sequence, gen_syswbeff1065ok_Sequence_SequenceNode, gen_syswbeff1065ok_And_Sequence, gen_syswbeff1065ok_Or_Sequence, gen_syswbeff1065ok_Start_Sequence, gen_syswbeff1065ok_InputPort_Port, gen_syswbeff1065ok_Flow_ProcessNode, gen_syswbeff1065ok_OutputPort_Port, gen_syswbeff1065ok_LoopExit_Sequence, gen_syswbeff1065ok_Iteration_Sequence},
    metadata=None
)
