...
class syswbeff1065ok_PatternCatalog:
    ...
    def __init__(self, id: str, syswbeff1065ok_PatternCatalog72: "syswbeff1065ok_Workbench" = None, syswbeff1065ok_PatternCatalog: set["syswbeff1065ok_Function"] = None):
        self.id = id
...
class syswbeff1065ok_System:
    ...
    def __init__(self, id: str, syswbeff1065ok_System66: "syswbeff1065ok_Workbench" = None, syswbeff1065ok_System: "syswbeff1065ok_Function" = None, syswbeff1065ok_System55: "syswbeff1065ok_Component" = None):
        self.id = id
...
class syswbeff1065ok_Thoughts:
    ...
    def __init__(self, id: str, syswbeff1065ok_Thoughts63: "syswbeff1065ok_Workbench" = None, syswbeff1065ok_Thoughts: set["syswbeff1065ok_Thing"] = None):
        self.id = id
...
class syswbeff1065ok_Thing:
    ...
    def __init__(self, id: int, syswbeff1065ok_Thing34: "syswbeff1065ok_AssociatedTo" = None, syswbeff1065ok_Thing36: set["syswbeff1065ok_AssociatedTo"] = None, syswbeff1065ok_Thing60: "syswbeff1065ok_Workbench" = None, syswbeff1065ok_Thing39: "syswbeff1065ok_Thoughts" = None, syswbeff1065ok_Thing: "syswbeff1065ok_AssociatedTo" = None):
        self.id = id
...
class syswbeff1065ok_AssociatedTo:
    ...
    def __init__(self, since: str, syswbeff1065ok_AssociatedTo33: "syswbeff1065ok_Thing" = None, syswbeff1065ok_AssociatedTo37: "syswbeff1065ok_Thing" = None, syswbeff1065ok_AssociatedTo: "syswbeff1065ok_Thing" = None):
        self.since = since
...
class syswbeff1065ok_SequenceNode(ABC):
    ...
    def __init__(self, name: str, tMin: int, tMax: int, syswbeff1065ok_SequenceNode: "syswbeff1065ok_SequenceNode" = None, syswbeff1065ok_SequenceNode21: set["syswbeff1065ok_SequenceNode"] = None):
        self.name = name
        self.tMin = tMin
        self.tMax = tMax
...
class syswbeff1065ok_Component:
    ...
    def __init__(self, name: str, syswbeff1065ok_Component45: "syswbeff1065ok_Component" = None, syswbeff1065ok_Component43: set["syswbeff1065ok_Component"] = None, syswbeff1065ok_Component48: "syswbeff1065ok_Component" = None, syswbeff1065ok_Component46: set["syswbeff1065ok_Component"] = None, syswbeff1065ok_Component50: set["syswbeff1065ok_Function"] = None, syswbeff1065ok_Component56: "syswbeff1065ok_System" = None, syswbeff1065ok_Component: "syswbeff1065ok_Function" = None):
        self.name = name
...
class syswbeff1065ok_FunctionProperty:
    ...
    def __init__(self, description: str, syswbeff1065ok_FunctionProperty69: "syswbeff1065ok_Workbench" = None, syswbeff1065ok_FunctionProperty: "syswbeff1065ok_Function" = None, syswbeff1065ok_FunctionProperty42: "syswbeff1065ok_FunctionProperty" = None, syswbeff1065ok_FunctionProperty40: "syswbeff1065ok_FunctionProperty" = None):
...
class syswbeff1065ok_Function(ProcessNode, SequenceNode):
    ...
    def __init__(self, domain: str, syswbeff1065ok_Function9: set["syswbeff1065ok_InputPort"] = None, syswbeff1065ok_Function51: "syswbeff1065ok_Component" = None, syswbeff1065ok_Function53: "syswbeff1065ok_System" = None, syswbeff1065ok_Function58: "syswbeff1065ok_PatternCatalog" = None, syswbeff1065ok_Function11: set["syswbeff1065ok_Description"] = None, syswbeff1065ok_Function13: set["syswbeff1065ok_Token"] = None, syswbeff1065ok_Function: "syswbeff1065ok_Function" = None, syswbeff1065ok_Function0: set["syswbeff1065ok_Function"] = None, syswbeff1065ok_Function3: set["syswbeff1065ok_Sequence"] = None, syswbeff1065ok_Function5: set["syswbeff1065ok_Flow"] = None, syswbeff1065ok_Function7: set["syswbeff1065ok_OutputPort"] = None, syswbeff1065ok_Function15: set["syswbeff1065ok_FunctionProperty"] = None, syswbeff1065ok_Function18: "syswbeff1065ok_Function" = None, syswbeff1065ok_Function16: "syswbeff1065ok_Function" = None, syswbeff1065ok_Function20: "syswbeff1065ok_Component" = None):
        self.domain = domain
