...
class statemachine_State(Vertex):
    ...
    def __init__(self, name: str, statemachine_State16: "statemachine_Region" = None, statemachine_State: "statemachine_ComplexState" = None):
        self.name = name
...
class statemachine_Statemachine(Region):
    ...
    def __init__(self, name: str, statemachine_Statemachine13: set["statemachine_Action"] = None, statemachine_Statemachine: set["statemachine_Transition"] = None):
        self.name = name
...
class statemachine_ComplexState(State):
    ...
    def __init__(self, statemachine_ComplexState3: "statemachine_Region" = None, statemachine_ComplexState: "statemachine_State" = None):
