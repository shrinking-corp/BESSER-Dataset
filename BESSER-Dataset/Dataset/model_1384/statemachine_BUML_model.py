...
domain_model = DomainModel(
    name="statemachine",
    types={statemachine_Vertex, statemachine_Transition, statemachine_Pseudostate, State, statemachine_Region, statemachine_Statemachine, Region, statemachine_State, Vertex, statemachine_ComplexState, statemachine_LabeledTransition, Transition, statemachine_Action, PseudostateKind},
    associations={outgoings0, region2, source4, target7, transitions10, super1, action19, actions12, states14, initial17},
    generalizations={gen_statemachine_Pseudostate_Vertex, gen_statemachine_ComplexState_State, gen_statemachine_Statemachine_Region, gen_statemachine_State_Vertex, gen_statemachine_LabeledTransition_Transition},
    metadata=None
)
