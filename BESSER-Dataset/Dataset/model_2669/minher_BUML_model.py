...
# Classes
minher_Named = Class(name="minher_Named", is_abstract=True)
minher_A = Class(name="minher_A")
minher_B = Class(name="minher_B")
Named = Class(name="Named")
minher_G = Class(name="minher_G")
minher_C = Class(name="minher_C")
minher_E = Class(name="minher_E")
B = Class(name="B")
...
domain_model = DomainModel(
    name="minher",
    types={minher_Named, minher_A, minher_B, Named, minher_G, minher_C, minher_E, B},
    associations={bs0, gs1, cs3},
    generalizations={gen_minher_G_Named, gen_minher_C_Named, gen_minher_B_Named, gen_minher_E_B},
    metadata=None
)
