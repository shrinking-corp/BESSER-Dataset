...
# Classes
organizationchart_Function = Class(name="organizationchart_Function")
organizationchart_Organization = Class(name="organizationchart_Organization")
organizationchart_Employee = Class(name="organizationchart_Employee")
organizationchart_OrganizationalStructure = Class(name="organizationchart_OrganizationalStructure")
organizationchart_Location = Class(name="organizationchart_Location")
...
organizationchart_Employee.attributes={organizationchart_Employee_trigraph, organizationchart_Employee_title, organizationchart_Employee_firstname, organizationchart_Employee_lastname}
...
domain_model = DomainModel(
    ...
    types={organizationchart_Function, organizationchart_Organization, organizationchart_Employee, organizationchart_OrganizationalStructure, organizationchart_Location, StructureType},
    associations={performs8, leads9, employees12, structures13, locations15, employees17, subStructures20, owns22, manager24, employees26, manages1, belongsTo2, location3, manager6, isPerformedBy28},
    generalizations={},
    metadata=None
)
