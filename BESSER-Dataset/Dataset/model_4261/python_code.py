...
class organizationchart_Location:
    ...
    def __init__(self, name: str, organizationchart_Location: "organizationchart_Organization" = None, Location: "organizationchart_Employee" = None, location: set["organizationchart_Employee"] = None):
        self.name = name
...
class organizationchart_OrganizationalStructure:
    ...
    def __init__(self, name: str, type: str, OrganizationalStructure11: "organizationchart_Employee" = None, organizationchart_OrganizationalStructure: "organizationchart_Organization" = None, belongsTo: set["organizationchart_Employee"] = None, organizationchart_OrganizationalStructure21: "organizationchart_OrganizationalStructure" = None, organizationchart_OrganizationalStructure19: set["organizationchart_OrganizationalStructure"] = None, organizationchart_OrganizationalStructure23: set["organizationchart_Function"] = None, OrganizationalStructure: "organizationchart_Employee" = None, leads: "organizationchart_Employee" = None):
        self.name = name
        self.type = type
...
class organizationchart_Employee:
    ...
    def __init__(self, firstname: str, lastname: str, title: str, trigraph: str, isPerformedBy: set["organizationchart_Function"] = None, manager10: set["organizationchart_OrganizationalStructure"] = None, organizationchart_Employee: "organizationchart_Organization" = None, Employee18: "organizationchart_OrganizationalStructure" = None, employees: "organizationchart_OrganizationalStructure" = None, Employee25: "organizationchart_OrganizationalStructure" = None, employees4: "organizationchart_Location" = None, Employee7: "organizationchart_Employee" = None, manages: "organizationchart_Employee" = None, Employee29: "organizationchart_Function" = None, Employee27: "organizationchart_Location" = None, Employee: "organizationchart_Employee" = None, manager: set["organizationchart_Employee"] = None):
...
class organizationchart_Function:
    ...
    def __init__(self, name: str, Function: "organizationchart_Employee" = None, organizationchart_Function: "organizationchart_OrganizationalStructure" = None, performs: set["organizationchart_Employee"] = None):
        self.name = name
