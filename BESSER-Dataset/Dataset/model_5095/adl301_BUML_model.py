...
# Classes
adl301_AbstractComponent = Class(name="adl301_AbstractComponent", is_abstract=True)
adl301_Content = Class(name="adl301_Content")
adl301_Attributes = Class(name="adl301_Attributes")
adl301_Attribute = Class(name="adl301_Attribute")
adl301_Required = Class(name="adl301_Required")
adl301_Provided = Class(name="adl301_Provided")
adl301_Interface = Class(name="adl301_Interface", is_abstract=True)
NamedElement = Class(name="NamedElement")
adl301_Binding = Class(name="adl301_Binding")
adl301_Item = Class(name="adl301_Item")
Type = Class(name="Type")
adl301_Component = Class(name="adl301_Component")
AbstractComponent = Class(name="AbstractComponent")
adl301_NamedElement = Class(name="adl301_NamedElement", is_abstract=True)
adl301_Type = Class(name="adl301_Type", is_abstract=True)
...
adl301_Content_class_: Property = Property(name="class_", type=StringType)
adl301_Content_language: Property = Property(name="language", type=StringType)
adl301_Content.attributes={adl301_Content_class_, adl301_Content_language}
...
domain_model = DomainModel(
    name="adl301",
    types={adl301_AbstractComponent, adl301_Content, adl301_Attributes, adl301_Attribute, adl301_Required, adl301_Provided, adl301_Interface, NamedElement, adl301_Binding, adl301_Item, Type, adl301_Component, AbstractComponent, adl301_NamedElement, adl301_Type, Interface},
    ...
    generalizations={gen_adl301_Binding_NamedElement, gen_adl301_Interface_NamedElement, gen_adl301_Item_NamedElement, gen_adl301_Required_Type, gen_adl301_Provided_Type, gen_adl301_Component_AbstractComponent, gen_adl301_Component_NamedElement, gen_adl301_Type_Interface},
    metadata=None
)
