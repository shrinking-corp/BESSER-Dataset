...
class Library_CirculatingItem(Item, Lendable):
...
class Library_Writer(Person):
    ...
    def __init__(self, name: str, Writer: "Library_Book" = None, Library_Writer: "Library_Library" = None, Library_Writer20: "Library_BookOnTape" = None, author: set["Library_Book"] = None):
        self.name = name
        self.Writer = Writer
