...
domain_model = DomainModel(
    name="Library",
    types={Library_Writer, Library_Library, Addressable, Library_Employee, Library_Borrower, Library_Item, Person, Library_Book, CirculatingItem, Library_Lendable, Library_CirculatingItem, Item, Lendable, Library_Periodical, Library_AudioVisualItem, Library_BookOnTape, AudioVisualItem, Library_Person, Library_VideoCassette, Library_Addressable, BookCategory},
    associations={author0, writers1, employees2, borrowers4, stock6, books8, branches11, parentBranch13, borrowers16, reader17, author18, cast21, borrowed23, manager25, books15},
    generalizations={gen_Library_Library_Addressable, gen_Library_Writer_Person, gen_Library_Book_CirculatingItem, gen_Library_CirculatingItem_Item, gen_Library_CirculatingItem_Lendable, gen_Library_Periodical_Item, gen_Library_AudioVisualItem_CirculatingItem, gen_Library_BookOnTape_AudioVisualItem, gen_Library_VideoCassette_AudioVisualItem, gen_Library_Borrower_Person, gen_Library_Person_Addressable, gen_Library_Employee_Person},
    metadata=None
)
