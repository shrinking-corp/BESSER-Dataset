...
def test_hyp_library_videocassette_is_not_abstract():
    assert not inspect.isabstract(Library_VideoCassette)


def test_hyp_library_videocassette_constructor_exists():
    assert callable(Library_VideoCassette.__init__)


def test_hyp_library_videocassette_constructor_args():
    sig = inspect.signature(Library_VideoCassette.__init__)
    params = list(sig.parameters.keys())



def test_hyp_library_bookontape_is_not_abstract():
    assert not inspect.isabstract(Library_BookOnTape)


def test_hyp_library_bookontape_constructor_exists():
    assert callable(Library_BookOnTape.__init__)


def test_hyp_library_bookontape_constructor_args():
    sig = inspect.signature(Library_BookOnTape.__init__)
    params = list(sig.parameters.keys())



def test_hyp_library_audiovisualitem_is_not_abstract():
    assert not inspect.isabstract(Library_AudioVisualItem)


def test_hyp_library_audiovisualitem_constructor_exists():
    assert callable(Library_AudioVisualItem.__init__)


def test_hyp_library_audiovisualitem_constructor_args():
...
def test_hyp_library_periodical_is_not_abstract():
    assert not inspect.isabstract(Library_Periodical)


def test_hyp_library_periodical_constructor_exists():
    assert callable(Library_Periodical.__init__)


def test_hyp_library_periodical_constructor_args():
...
@given(instance=Library_Library_strategy)
def test_hyp_library_library_people_setter(instance):
...
def test_hyp_library_audiovisualitem_title_setter(instance):
    original = instance.title
    instance.title = original
    assert instance.title == original
...
@given(instance=Library_AudioVisualItem_strategy)
def test_hyp_library_audiovisualitem_minutesLength_setter(instance):
...
@given(instance=Library_AudioVisualItem_strategy)
def test_hyp_library_audiovisualitem_damaged_setter(instance):
...
def test_hyp_library_periodical_issuesPerYear_setter(instance):
...
@given(instance=Library_Periodical_strategy)
def test_hyp_library_periodical_title_setter(instance):
    original = instance.title
    instance.title = original
    assert instance.title == original
