...
class tree_Node:
    ...
    def __init__(self, name: str, Node: "tree_Node" = None, children: "tree_Node" = None, Node4: "tree_Node" = None, parent: set["tree_Node"] = None, node: "tree_Data" = None, tree_Node: "tree_Node" = None, tree_Node6: set["tree_Node"] = None, Node9: "tree_Data" = None):
        self.name = name
        self.Node = Node
