...
def test_hyp_families_famelem_is_not_abstract():
    assert not inspect.isabstract(Families_FamElem)


def test_hyp_families_famelem_constructor_exists():
    assert callable(Families_FamElem.__init__)


def test_hyp_families_famelem_constructor_args():
...
def test_hyp_famelem_is_not_abstract():
    assert not inspect.isabstract(FamElem)


def test_hyp_famelem_constructor_exists():
    assert callable(FamElem.__init__)


def test_hyp_famelem_constructor_args():
...
def test_Families_Family_isa_FamElem():
    instance = Families_Family(lastName="sample_text")
    assert isinstance(instance, FamElem)


def test_Families_Member_isa_FamElem():
    instance = Families_Member(firstName="sample_text")
    assert isinstance(instance, FamElem)
...
FamElem_strategy = st.builds(FamElem)
...
Families_FamElem_strategy = st.builds(Families_FamElem)
