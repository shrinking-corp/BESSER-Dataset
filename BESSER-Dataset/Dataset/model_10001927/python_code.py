...
class Account:
    ...
    def __init__(self, Address: str, Test_attr: int, customer8: "Customer" = None, customer11: "Customer" = None, order19: "Order" = None, order21: "Order" = None, order22: "Order" = None):
    ...
    @property
    def Test_attr(self):
        return self.__Test_attr
    @Test_attr.setter
    def Test_attr(self, Test_attr: int):
        self.__Test_attr = Test_attr
...
class Customer:
    ...
    def __init__(self, Name: str, Customer_ID: int, products0: set["Products"] = None, order2: set["Order"] = None, shopping_Cart4: "Shopping_Cart" = None, payment6: "Payment" = None, account9: "Account" = None, account10: "Account" = None):
        self.Name = Name
