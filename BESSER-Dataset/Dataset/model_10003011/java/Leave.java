...
public class Leave  {
    ...
    public Leave(
        LocalDate Leave_ApplyDate,        int Leave_NoOfDays,        int leave_id,        String Leave_Status,        int Emp_Id,        String Leave_Title,        LocalDate Leave_StartDate,        String Leave_detail,        LocalDate Leave_EndDate    ) {
