...
public class smm_DimensionalMeasure extends Measure {
    ...
    public smm_DimensionalMeasure(
        String unit        ArrayList<smm_Base2MeasureRelationship> smm_base2measurerelationships,        ArrayList<smm_BaseMeasureRelationship> smm_basemeasurerelationships,        ArrayList<smm_RescaleMeasureRelationship> smm_rescalemeasurerelationships,        ArrayList<smm_Base1MeasureRelationship> smm_base1measurerelationships,        ArrayList<smm_RankingMeasureRelationship> smm_rankingmeasurerelationships    ) {
        this.unit = unit;
