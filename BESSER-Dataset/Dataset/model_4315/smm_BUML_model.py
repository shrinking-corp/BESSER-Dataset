...
smm_MofElement = Class(name="smm_MofElement")
...
smm_Measure.attributes={smm_Measure_measureLabelFormat, smm_Measure_visible, smm_Measure_measurementLabelFormat}
...
smm_RankingInterval.attributes={smm_RankingInterval_minimumOpen, smm_RankingInterval_symbol, smm_RankingInterval_maximumEndpoint, smm_RankingInterval_maximumOpen, smm_RankingInterval_minimumEndpoint}
...
baseMeasure2To19: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_20", type=smm_Base2MeasureRelationship, multiplicity=Multiplicity(1, 1))
    }
)
baseMeasurement1To21: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_22", type=smm_Base1MeasurementRelationship, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
baseMeasurement2To23: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_24", type=smm_Base2MeasurementRelationship, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
from_25: BinaryAssociation = BinaryAssociation(
    name="from_25",
    ends={
...
baseMeasureTo30: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_31", type=smm_BaseMeasureRelationship, multiplicity=Multiplicity(1, 9999))
    }
)
baseMeasurementTo32: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_33", type=smm_BaseMeasurementRelationship, multiplicity=Multiplicity(0, 9999))
    }
)
...
rescaleTo42: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_43", type=smm_RescaleMeasureRelationship, multiplicity=Multiplicity(0, 9999))
    }
)
...
rescaleTo55: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_56", type=smm_RescaleMeasurementRelationship, multiplicity=Multiplicity(0, 9999))
    }
)
...
from_62: BinaryAssociation = BinaryAssociation(
    name="from_62",
    ends={
...
from_65: BinaryAssociation = BinaryAssociation(
    name="from_65",
    ends={
...
rankingTo70: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_71", type=smm_RankingMeasurementRelationship, multiplicity=Multiplicity(0, 1))
    }
)
...
refinementTo78: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_79", type=smm_RefinementMeasureRelationship, multiplicity=Multiplicity(0, 9999))
    }
)
equivalentTo83: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_84", type=smm_EquivalentMeasureRelationship, multiplicity=Multiplicity(0, 9999))
    }
)
...
recursiveTo88: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_89", type=smm_RecursiveMeasureRelationship, multiplicity=Multiplicity(0, 1))
    }
)
...
rankingTo161: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_162", type=smm_RankingMeasureRelationship, multiplicity=Multiplicity(0, 1))
    }
)
from_186: BinaryAssociation = BinaryAssociation(
    name="from_186",
    ends={
...
from_164: BinaryAssociation = BinaryAssociation(
    name="from_164",
    ends={
...
from_172: BinaryAssociation = BinaryAssociation(
    name="from_172",
    ends={
...
from_176: BinaryAssociation = BinaryAssociation(
    name="from_176",
    ends={
...
from_182: BinaryAssociation = BinaryAssociation(
    name="from_182",
    ends={
...
from_196: BinaryAssociation = BinaryAssociation(
    name="from_196",
    ends={
...
from_203: BinaryAssociation = BinaryAssociation(
    name="from_203",
    ends={
...
domain_model = DomainModel(
    name="smm",
    types={smm_BaseMeasureRelationship, smm_AbstractMeasureElement, SmmElement, smm_Annotation, smm_Argument, smm_Attribute, smm_Base1MeasureRelationship, MeasureRelationship, smm_BinaryMeasure, smm_DimensionalMeasure, smm_Base1MeasurementRelationship, MeasurementRelationship, smm_BinaryMeasurement, smm_DimensionalMeasurement, smm_Base2MeasureRelationship, smm_Base2MeasurementRelationship, smm_Counting, DirectMeasure, smm_CollectiveMeasure, smm_BaseMeasurementRelationship, smm_CollectiveMeasurement, DimensionalMeasure, DimensionalMeasurement, smm_CategoryRelationship, SmmRelationship, smm_MeasureCategory, smm_Characteristic, AbstractMeasureElement, smm_Count, DirectMeasurement, Measure, smm_RescaleMeasureRelationship, smm_RankingMeasureRelationship, Measurement, smm_RescaleMeasurementRelationship, smm_RankingMeasurementRelationship, smm_DirectMeasure, smm_Operation, smm_DirectMeasurement, smm_EquivalentMeasureRelationship, smm_Measure, smm_EquivalentMeasurementRelationship, smm_Measurement, smm_Grade, smm_Scope, smm_RefinementMeasureRelationship, smm_RecursiveMeasureRelationship, smm_MeasureRelationship, smm_MeasureLibrary, smm_Observation, smm_MofElement, smm_RefinementMeasurementRelationship, smm_RecursiveMeasurementRelationship, smm_MeasurementRelationship, smm_NamedMeasure, smm_NamedMeasurement, smm_OCLOperation, smm_ObservationScope, smm_ObservedMeasure, smm_SmmElement, smm_SmmRelationship, smm_Ranking, smm_RankingInterval, smm_RatioMeasure, BinaryMeasure, smm_RatioMeasurement, BinaryMeasurement, smm_RescaledMeasure, smm_RescaledMeasurement, smm_SmmModel, Accumulator},
    associations={from_0, to1, from_2, to3, from_4, to6, from_8, to10, from_12, to13, from_15, to16, baseMeasure1To18, baseMeasure2To19, baseMeasurement1To21, baseMeasurement2To23, from_25, to26, parent29, baseMeasureTo30, baseMeasurementTo32, to67, baseMeasureFrom34, baseMeasure1From36, baseMeasure2From39, rescaleTo42, rankingFrom44, baseMeasurementFrom46, baseMeasurement1From49, baseMeasurement2From52, rescaleTo55, rankingFrom57, operation59, mapping60, from_62, to63, from_65, refinementFrom80, rankingTo70, category73, trait74, scope76, refinementTo78, equivalentTo83, equivalentFrom85, recursiveTo88, recursiveFrom90, measureRelationships93, defaultQuery95, inbound98, outbound101, category105, categoryElement108, categoryMeasure110, measureElements113, categoryRelationships115, measurandQuery118, measurand121, refinementTo122, refinementFrom124, equivalentTo127, equivalentFrom129, recursiveTo132, recursiveFrom134, measurementRelationships137, inbound139, outbound142, scopes145, observedMeasures146, requestedMeasures148, measurementRelations150, arguments152, measure154, measurements157, interval160, rankingTo161, from_186, from_164, to165, from_167, to169, from_172, to174, from_176, to179, from_182, to184, observations216, to189, rescaleFrom192, to195, from_196, rescaleFrom198, to201, from_203, recognizer206, breakCondition209, attributes212, annotations214, librairies218},
    generalizations={gen_smm_BaseMeasureRelationship_MeasureRelationship, gen_smm_AbstractMeasureElement_SmmElement, gen_smm_Annotation_SmmElement, gen_smm_Argument_SmmElement, gen_smm_Attribute_SmmElement, gen_smm_Base1MeasureRelationship_MeasureRelationship, gen_smm_Base1MeasurementRelationship_MeasurementRelationship, gen_smm_Base2MeasureRelationship_MeasureRelationship, gen_smm_Base2MeasurementRelationship_MeasurementRelationship, gen_smm_Counting_DirectMeasure, gen_smm_BaseMeasurementRelationship_MeasurementRelationship, gen_smm_BinaryMeasure_DimensionalMeasure, gen_smm_BinaryMeasurement_DimensionalMeasurement, gen_smm_CategoryRelationship_SmmRelationship, gen_smm_Characteristic_AbstractMeasureElement, gen_smm_CollectiveMeasure_DimensionalMeasure, gen_smm_CollectiveMeasurement_DimensionalMeasurement, gen_smm_Count_DirectMeasurement, gen_smm_DimensionalMeasure_Measure, gen_smm_DimensionalMeasurement_Measurement, gen_smm_DirectMeasure_DimensionalMeasure, gen_smm_DirectMeasurement_DimensionalMeasurement, gen_smm_EquivalentMeasureRelationship_MeasureRelationship, gen_smm_EquivalentMeasurementRelationship_MeasurementRelationship, gen_smm_Grade_Measurement, gen_smm_Measure_AbstractMeasureElement, gen_smm_MeasureCategory_AbstractMeasureElement, gen_smm_MeasureLibrary_SmmElement, gen_smm_Observation_SmmElement, gen_smm_MeasureRelationship_SmmRelationship, gen_smm_Measurement_SmmElement, gen_smm_MeasurementRelationship_SmmRelationship, gen_smm_NamedMeasure_DimensionalMeasure, gen_smm_NamedMeasurement_DimensionalMeasurement, gen_smm_OCLOperation_AbstractMeasureElement, gen_smm_ObservationScope_SmmElement, gen_smm_ObservedMeasure_SmmRelationship, gen_smm_Operation_AbstractMeasureElement, gen_smm_Ranking_Measure, gen_smm_RankingInterval_SmmElement, gen_smm_RankingMeasureRelationship_MeasureRelationship, gen_smm_RankingMeasurementRelationship_MeasurementRelationship, gen_smm_RatioMeasure_BinaryMeasure, gen_smm_RatioMeasurement_BinaryMeasurement, gen_smm_RecursiveMeasureRelationship_MeasureRelationship, gen_smm_RecursiveMeasurementRelationship_MeasurementRelationship, gen_smm_RefinementMeasureRelationship_MeasureRelationship, gen_smm_RefinementMeasurementRelationship_MeasurementRelationship, gen_smm_RescaledMeasure_DimensionalMeasure, gen_smm_RescaleMeasureRelationship_MeasureRelationship, gen_smm_RescaledMeasurement_DimensionalMeasurement, gen_smm_RescaleMeasurementRelationship_MeasurementRelationship, gen_smm_Scope_AbstractMeasureElement, gen_smm_SmmModel_SmmElement, gen_smm_SmmRelationship_SmmElement},
    metadata=None
)
