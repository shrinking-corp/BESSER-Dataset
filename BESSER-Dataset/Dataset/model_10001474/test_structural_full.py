...
def test_C_attC1_value_roundtrip():
    instance = C(attC1="sample_text", attC2="sample_text")
    assert instance.attC1 == "sample_text"
    instance.attC1 = "sample_text_2"
    assert instance.attC1 == "sample_text_2"


def test_C_attC2_value_roundtrip():
    instance = C(attC1="sample_text", attC2="sample_text")
    assert instance.attC2 == "sample_text"
    instance.attC2 = "sample_text_2"
    assert instance.attC2 == "sample_text_2"


def test_assoc_AB_link_reassign_clear():
...
def test_assoc_BC_link_reassign_clear():
    a = C(attC1="sample_text", attC2="sample_text")
...
def test_assoc_RA_link_reassign_clear():
...
C_strategy = st.builds(C, attC1=safe_text, attC2=safe_text)
