...
def test_assoc_contents1_link_reassign_clear():
    ...
    if hasattr(b1, 'ecore_EAnnotation2'):
        assert _is_linked(b1, 'ecore_EAnnotation2', a)
    _safe_set(a, 'ecore_EObject', b2)
    assert _is_linked(a, 'ecore_EObject', b2)
    if hasattr(b1, 'ecore_EAnnotation2'):
        assert not _is_linked(b1, 'ecore_EAnnotation2', a)
    if hasattr(b2, 'ecore_EAnnotation2'):
        assert _is_linked(b2, 'ecore_EAnnotation2', a)
    _safe_set(a, 'ecore_EObject', None)
    assert not _is_linked(a, 'ecore_EObject', b2)
    if hasattr(b2, 'ecore_EAnnotation2'):
        assert not _is_linked(b2, 'ecore_EAnnotation2', a)
...
def test_assoc_eAllAttributes12_link_reassign_clear():
...
def test_assoc_eAllGenericSuperTypes17_link_reassign_clear():
    a = ecore_EClass(abstract=True, interface=True)
    b1 = ecore_EGenericType()
    b2 = ecore_EGenericType()
    _safe_set(a, 'ecore_EClass18', {b1})
    assert _is_linked(a, 'ecore_EClass18', b1)
    if hasattr(b1, 'ecore_EGenericType19'):
        assert _is_linked(b1, 'ecore_EGenericType19', a)
    _safe_set(a, 'ecore_EClass18', {b2})
    assert _is_linked(a, 'ecore_EClass18', b2)
    if hasattr(b1, 'ecore_EGenericType19'):
        assert not _is_linked(b1, 'ecore_EGenericType19', a)
    if hasattr(b2, 'ecore_EGenericType19'):
        assert _is_linked(b2, 'ecore_EGenericType19', a)
    _safe_set(a, 'ecore_EClass18', set())
    assert not _is_linked(a, 'ecore_EClass18', b2)
    if hasattr(b2, 'ecore_EGenericType19'):
        assert not _is_linked(b2, 'ecore_EGenericType19', a)


def test_assoc_eAllOperations20_link_reassign_clear():
    a = ecore_EOperation()
    b1 = ecore_EClass(abstract=True, interface=True)
    b2 = ecore_EClass(abstract=False, interface=False)
...
def test_assoc_eAllReferences22_link_reassign_clear():
    a = ecore_EReference(container=True, containment=True, resolveProxies=True)
    b1 = ecore_EClass(abstract=True, interface=True)
    b2 = ecore_EClass(abstract=False, interface=False)
...
def test_assoc_eAnnotations66_link_reassign_clear():
...
def test_assoc_eAttributeType7_link_reassign_clear():
...
def test_assoc_eAttributes30_link_reassign_clear():
    a = ecore_EClass(abstract=True, interface=True)
    b1 = ecore_EAttribute(iD=True)
    b2 = ecore_EAttribute(iD=False)
...
def test_assoc_eClassifier57_link_reassign_clear():
    ...
    b1 = ecore_EGenericType()
    b2 = ecore_EGenericType()
    _safe_set(a, 'ecore_EClassifier59', b1)
    assert _is_linked(a, 'ecore_EClassifier59', b1)
    if hasattr(b1, 'ecore_EGenericType58'):
        assert _is_linked(b1, 'ecore_EGenericType58', a)
    _safe_set(a, 'ecore_EClassifier59', b2)
    assert _is_linked(a, 'ecore_EClassifier59', b2)
    if hasattr(b1, 'ecore_EGenericType58'):
        assert not _is_linked(b1, 'ecore_EGenericType58', a)
    if hasattr(b2, 'ecore_EGenericType58'):
        assert _is_linked(b2, 'ecore_EGenericType58', a)
    _safe_set(a, 'ecore_EClassifier59', None)
    assert not _is_linked(a, 'ecore_EClassifier59', b2)
    if hasattr(b2, 'ecore_EGenericType58'):
        assert not _is_linked(b2, 'ecore_EGenericType58', a)


def test_assoc_eClassifiers78_link_reassign_clear():
...
def test_assoc_eExceptions74_link_reassign_clear():
    a = ecore_EOperation()
    b1 = ecore_EClassifier(defaultValue="sample_text", instanceClass="sample_text", instanceClassName="sample_text", instanceTypeName="sample_text")
    b2 = ecore_EClassifier(defaultValue="sample_text_2", instanceClass="sample_text_2", instanceClassName="sample_text_2", instanceTypeName="sample_text_2")
    _safe_set(a, 'ecore_EOperation75', {b1})
    assert _is_linked(a, 'ecore_EOperation75', b1)
    if hasattr(b1, 'ecore_EClassifier76'):
        assert _is_linked(b1, 'ecore_EClassifier76', a)
    _safe_set(a, 'ecore_EOperation75', {b2})
    assert _is_linked(a, 'ecore_EOperation75', b2)
    if hasattr(b1, 'ecore_EClassifier76'):
    ...
    _safe_set(a, 'ecore_EOperation75', set())
    assert not _is_linked(a, 'ecore_EOperation75', b2)
    if hasattr(b2, 'ecore_EClassifier76'):
        assert not _is_linked(b2, 'ecore_EClassifier76', a)


def test_assoc_eFactoryInstance82_link_reassign_clear():
    a = ecore_EPackage(nsPrefix="sample_text", nsURI="sample_text")
    b1 = ecore_EFactory()
    b2 = ecore_EFactory()
    _safe_set(a, 'ePackage83', b1)
    assert _is_linked(a, 'ePackage83', b1)
    if hasattr(b1, 'EFactory'):
        assert _is_linked(b1, 'EFactory', a)
    _safe_set(a, 'ePackage83', b2)
    assert _is_linked(a, 'ePackage83', b2)
    if hasattr(b1, 'EFactory'):
        assert not _is_linked(b1, 'EFactory', a)
    if hasattr(b2, 'EFactory'):
        assert _is_linked(b2, 'EFactory', a)
    _safe_set(a, 'ePackage83', None)
    assert not _is_linked(a, 'ePackage83', b2)
    if hasattr(b2, 'EFactory'):
        assert not _is_linked(b2, 'EFactory', a)


def test_assoc_eGenericExceptions71_link_reassign_clear():
    a = ecore_EOperation()
    b1 = ecore_EGenericType()
    b2 = ecore_EGenericType()
    _safe_set(a, 'ecore_EOperation72', {b1})
    assert _is_linked(a, 'ecore_EOperation72', b1)
    if hasattr(b1, 'ecore_EGenericType73'):
        assert _is_linked(b1, 'ecore_EGenericType73', a)
    _safe_set(a, 'ecore_EOperation72', {b2})
    assert _is_linked(a, 'ecore_EOperation72', b2)
    if hasattr(b1, 'ecore_EGenericType73'):
    ...
    _safe_set(a, 'ecore_EOperation72', set())
    assert not _is_linked(a, 'ecore_EOperation72', b2)
    if hasattr(b2, 'ecore_EGenericType73'):
        assert not _is_linked(b2, 'ecore_EGenericType73', a)


def test_assoc_eGenericSuperTypes11_link_reassign_clear():
    a = ecore_EClass(abstract=True, interface=True)
    b1 = ecore_EGenericType()
    b2 = ecore_EGenericType()
...
def test_assoc_eGenericType100_link_reassign_clear():
    ...
    if hasattr(b1, 'ecore_EGenericType101'):
        assert _is_linked(b1, 'ecore_EGenericType101', a)
    _safe_set(a, 'ecore_ETypedElement', b2)
    assert _is_linked(a, 'ecore_ETypedElement', b2)
    if hasattr(b1, 'ecore_EGenericType101'):
        assert not _is_linked(b1, 'ecore_EGenericType101', a)
    if hasattr(b2, 'ecore_EGenericType101'):
        assert _is_linked(b2, 'ecore_EGenericType101', a)
    _safe_set(a, 'ecore_ETypedElement', None)
    assert not _is_linked(a, 'ecore_ETypedElement', b2)
    if hasattr(b2, 'ecore_EGenericType101'):
        assert not _is_linked(b2, 'ecore_EGenericType101', a)
...
def test_assoc_eKeys89_link_reassign_clear():
    a = ecore_EReference(container=True, containment=True, resolveProxies=True)
    b1 = ecore_EAttribute(iD=True)
    b2 = ecore_EAttribute(iD=False)
    _safe_set(a, 'ecore_EReference90', {b1})
    assert _is_linked(a, 'ecore_EReference90', b1)
    if hasattr(b1, 'ecore_EAttribute91'):
        assert _is_linked(b1, 'ecore_EAttribute91', a)
    _safe_set(a, 'ecore_EReference90', {b2})
    assert _is_linked(a, 'ecore_EReference90', b2)
    if hasattr(b1, 'ecore_EAttribute91'):
        assert not _is_linked(b1, 'ecore_EAttribute91', a)
    if hasattr(b2, 'ecore_EAttribute91'):
        assert _is_linked(b2, 'ecore_EAttribute91', a)
    _safe_set(a, 'ecore_EReference90', set())
    assert not _is_linked(a, 'ecore_EReference90', b2)
    if hasattr(b2, 'ecore_EAttribute91'):
        assert not _is_linked(b2, 'ecore_EAttribute91', a)
...
def test_assoc_eModelElement6_link_reassign_clear():
    a = ecore_EModelElement()
    b1 = ecore_EAnnotation(source="sample_text")
    b2 = ecore_EAnnotation(source="sample_text_2")
    _safe_set(a, 'EModelElement', b1)
...
def test_assoc_eOperation87_link_reassign_clear():
    a = ecore_EOperation()
    b1 = ecore_EParameter()
    b2 = ecore_EParameter()
    _safe_set(a, 'EOperation88', b1)
    assert _is_linked(a, 'EOperation88', b1)
    if hasattr(b1, 'eParameters'):
        assert _is_linked(b1, 'eParameters', a)
    _safe_set(a, 'EOperation88', b2)
    assert _is_linked(a, 'EOperation88', b2)
    if hasattr(b1, 'eParameters'):
        assert not _is_linked(b1, 'eParameters', a)
    if hasattr(b2, 'eParameters'):
        assert _is_linked(b2, 'eParameters', a)
    _safe_set(a, 'EOperation88', None)
    assert not _is_linked(a, 'EOperation88', b2)
    if hasattr(b2, 'eParameters'):
...
def test_assoc_eOpposite93_link_reassign_clear():
    a = ecore_EReference(container=True, containment=True, resolveProxies=True)
    ...
    _safe_set(a, 'ecore_EReference92', b1)
    assert _is_linked(a, 'ecore_EReference92', b1)
    if hasattr(b1, 'ecore_EReference94'):
        assert _is_linked(b1, 'ecore_EReference94', a)
    _safe_set(a, 'ecore_EReference92', b2)
    assert _is_linked(a, 'ecore_EReference92', b2)
    if hasattr(b1, 'ecore_EReference94'):
        assert not _is_linked(b1, 'ecore_EReference94', a)
    if hasattr(b2, 'ecore_EReference94'):
        assert _is_linked(b2, 'ecore_EReference94', a)
    _safe_set(a, 'ecore_EReference92', None)
    assert not _is_linked(a, 'ecore_EReference92', b2)
    if hasattr(b2, 'ecore_EReference94'):
        assert not _is_linked(b2, 'ecore_EReference94', a)
...
def test_assoc_eParameters70_link_reassign_clear():
    a = ecore_EOperation()
    b1 = ecore_EParameter()
    b2 = ecore_EParameter()
    _safe_set(a, 'eOperation', {b1})
...
def test_assoc_eRawType60_link_reassign_clear():
    a = ecore_EClassifier(defaultValue="sample_text", instanceClass="sample_text", instanceClassName="sample_text", instanceTypeName="sample_text")
    b1 = ecore_EGenericType()
    b2 = ecore_EGenericType()
    _safe_set(a, 'ecore_EClassifier62', b1)
    assert _is_linked(a, 'ecore_EClassifier62', b1)
    if hasattr(b1, 'ecore_EGenericType61'):
        assert _is_linked(b1, 'ecore_EGenericType61', a)
    _safe_set(a, 'ecore_EClassifier62', b2)
    assert _is_linked(a, 'ecore_EClassifier62', b2)
    if hasattr(b1, 'ecore_EGenericType61'):
        assert not _is_linked(b1, 'ecore_EGenericType61', a)
    if hasattr(b2, 'ecore_EGenericType61'):
        assert _is_linked(b2, 'ecore_EGenericType61', a)
    _safe_set(a, 'ecore_EClassifier62', None)
    assert not _is_linked(a, 'ecore_EClassifier62', b2)
    if hasattr(b2, 'ecore_EGenericType61'):
        assert not _is_linked(b2, 'ecore_EGenericType61', a)


def test_assoc_eReferenceType95_link_reassign_clear():
    a = ecore_EReference(container=True, containment=True, resolveProxies=True)
    b1 = ecore_EClass(abstract=True, interface=True)
    b2 = ecore_EClass(abstract=False, interface=False)
    _safe_set(a, 'ecore_EReference96', b1)
    assert _is_linked(a, 'ecore_EReference96', b1)
    if hasattr(b1, 'ecore_EClass97'):
        assert _is_linked(b1, 'ecore_EClass97', a)
    _safe_set(a, 'ecore_EReference96', b2)
    assert _is_linked(a, 'ecore_EReference96', b2)
    if hasattr(b1, 'ecore_EClass97'):
        assert not _is_linked(b1, 'ecore_EClass97', a)
    if hasattr(b2, 'ecore_EClass97'):
        assert _is_linked(b2, 'ecore_EClass97', a)
    _safe_set(a, 'ecore_EReference96', None)
    assert not _is_linked(a, 'ecore_EReference96', b2)
    if hasattr(b2, 'ecore_EClass97'):
        assert not _is_linked(b2, 'ecore_EClass97', a)


def test_assoc_eReferences36_link_reassign_clear():
    a = ecore_EReference(container=True, containment=True, resolveProxies=True)
    b1 = ecore_EClass(abstract=True, interface=True)
    b2 = ecore_EClass(abstract=False, interface=False)
    _safe_set(a, 'ecore_EReference38', b1)
    assert _is_linked(a, 'ecore_EReference38', b1)
    if hasattr(b1, 'ecore_EClass37'):
        assert _is_linked(b1, 'ecore_EClass37', a)
    _safe_set(a, 'ecore_EReference38', b2)
    assert _is_linked(a, 'ecore_EReference38', b2)
    if hasattr(b1, 'ecore_EClass37'):
        assert not _is_linked(b1, 'ecore_EClass37', a)
    if hasattr(b2, 'ecore_EClass37'):
        assert _is_linked(b2, 'ecore_EClass37', a)
    _safe_set(a, 'ecore_EReference38', None)
    assert not _is_linked(a, 'ecore_EReference38', b2)
    if hasattr(b2, 'ecore_EClass37'):
        assert not _is_linked(b2, 'ecore_EClass37', a)


def test_assoc_eStructuralFeatures9_link_reassign_clear():
    a = ecore_EStructuralFeature(changeable=True, defaultValue="sample_text", defaultValueLiteral="sample_text", derived=True, transient=True, unsettable=True, volatile=True)
    b1 = ecore_EClass(abstract=True, interface=True)
    b2 = ecore_EClass(abstract=False, interface=False)
    _safe_set(a, 'EStructuralFeature', b1)
    assert _is_linked(a, 'EStructuralFeature', b1)
    if hasattr(b1, 'eContainingClass10'):
        assert _is_linked(b1, 'eContainingClass10', a)
    _safe_set(a, 'EStructuralFeature', b2)
    assert _is_linked(a, 'EStructuralFeature', b2)
    if hasattr(b1, 'eContainingClass10'):
        assert not _is_linked(b1, 'eContainingClass10', a)
    if hasattr(b2, 'eContainingClass10'):
        assert _is_linked(b2, 'eContainingClass10', a)
    _safe_set(a, 'EStructuralFeature', None)
    assert not _is_linked(a, 'EStructuralFeature', b2)
    if hasattr(b2, 'eContainingClass10'):
        assert not _is_linked(b2, 'eContainingClass10', a)


def test_assoc_eSubpackages80_link_reassign_clear():
    a = ecore_EPackage(nsPrefix="sample_text", nsURI="sample_text")
    b1 = ecore_EPackage(nsPrefix="sample_text", nsURI="sample_text")
    b2 = ecore_EPackage(nsPrefix="sample_text_2", nsURI="sample_text_2")
    _safe_set(a, 'EPackage81', b1)
    assert _is_linked(a, 'EPackage81', b1)
    if hasattr(b1, 'eSuperPackage'):
        assert _is_linked(b1, 'eSuperPackage', a)
    _safe_set(a, 'EPackage81', b2)
    assert _is_linked(a, 'EPackage81', b2)
    if hasattr(b1, 'eSuperPackage'):
        assert not _is_linked(b1, 'eSuperPackage', a)
    if hasattr(b2, 'eSuperPackage'):
        assert _is_linked(b2, 'eSuperPackage', a)
    _safe_set(a, 'EPackage81', None)
    assert not _is_linked(a, 'EPackage81', b2)
    if hasattr(b2, 'eSuperPackage'):
        assert not _is_linked(b2, 'eSuperPackage', a)


def test_assoc_eSuperPackage85_link_reassign_clear():
    a = ecore_EPackage(nsPrefix="sample_text", nsURI="sample_text")
    b1 = ecore_EPackage(nsPrefix="sample_text", nsURI="sample_text")
    b2 = ecore_EPackage(nsPrefix="sample_text_2", nsURI="sample_text_2")
    _safe_set(a, 'EPackage86', b1)
    assert _is_linked(a, 'EPackage86', b1)
    if hasattr(b1, 'eSubpackages'):
        assert _is_linked(b1, 'eSubpackages', a)
    _safe_set(a, 'EPackage86', b2)
    assert _is_linked(a, 'EPackage86', b2)
    if hasattr(b1, 'eSubpackages'):
        assert not _is_linked(b1, 'eSubpackages', a)
    if hasattr(b2, 'eSubpackages'):
        assert _is_linked(b2, 'eSubpackages', a)
    _safe_set(a, 'EPackage86', None)
    assert not _is_linked(a, 'EPackage86', b2)
    if hasattr(b2, 'eSubpackages'):
        assert not _is_linked(b2, 'eSubpackages', a)


def test_assoc_eSuperTypes40_link_reassign_clear():
    a = ecore_EClass(abstract=True, interface=True)
    b1 = ecore_EClass(abstract=True, interface=True)
    b2 = ecore_EClass(abstract=False, interface=False)
    _safe_set(a, 'ecore_EClass39', {b1})
    assert _is_linked(a, 'ecore_EClass39', b1)
    if hasattr(b1, 'ecore_EClass41'):
        assert _is_linked(b1, 'ecore_EClass41', a)
    _safe_set(a, 'ecore_EClass39', {b2})
    assert _is_linked(a, 'ecore_EClass39', b2)
    if hasattr(b1, 'ecore_EClass41'):
        assert not _is_linked(b1, 'ecore_EClass41', a)
    if hasattr(b2, 'ecore_EClass41'):
        assert _is_linked(b2, 'ecore_EClass41', a)
    _safe_set(a, 'ecore_EClass39', set())
    assert not _is_linked(a, 'ecore_EClass39', b2)
    if hasattr(b2, 'ecore_EClass41'):
        assert not _is_linked(b2, 'ecore_EClass41', a)


def test_assoc_eType102_link_reassign_clear():
    a = ecore_ETypedElement(lowerBound=7, many=True, ordered=True, required=True, unique=True, upperBound=7)
    b1 = ecore_EClassifier(defaultValue="sample_text", instanceClass="sample_text", instanceClassName="sample_text", instanceTypeName="sample_text")
    b2 = ecore_EClassifier(defaultValue="sample_text_2", instanceClass="sample_text_2", instanceClassName="sample_text_2", instanceTypeName="sample_text_2")
    _safe_set(a, 'ecore_ETypedElement103', b1)
    assert _is_linked(a, 'ecore_ETypedElement103', b1)
    if hasattr(b1, 'ecore_EClassifier104'):
        assert _is_linked(b1, 'ecore_EClassifier104', a)
    _safe_set(a, 'ecore_ETypedElement103', b2)
    assert _is_linked(a, 'ecore_ETypedElement103', b2)
    if hasattr(b1, 'ecore_EClassifier104'):
    ...
    _safe_set(a, 'ecore_ETypedElement103', None)
    assert not _is_linked(a, 'ecore_ETypedElement103', b2)
    if hasattr(b2, 'ecore_EClassifier104'):
...
def test_assoc_eTypeParameters67_link_reassign_clear():
    a = ecore_EOperation()
    b1 = ecore_ETypeParameter()
    b2 = ecore_ETypeParameter()
    _safe_set(a, 'ecore_EOperation68', {b1})
    assert _is_linked(a, 'ecore_EOperation68', b1)
    if hasattr(b1, 'ecore_ETypeParameter69'):
        assert _is_linked(b1, 'ecore_ETypeParameter69', a)
    _safe_set(a, 'ecore_EOperation68', {b2})
    assert _is_linked(a, 'ecore_EOperation68', b2)
    if hasattr(b1, 'ecore_ETypeParameter69'):
        assert not _is_linked(b1, 'ecore_ETypeParameter69', a)
    if hasattr(b2, 'ecore_ETypeParameter69'):
        assert _is_linked(b2, 'ecore_ETypeParameter69', a)
    _safe_set(a, 'ecore_EOperation68', set())
    assert not _is_linked(a, 'ecore_EOperation68', b2)
    if hasattr(b2, 'ecore_ETypeParameter69'):
        assert not _is_linked(b2, 'ecore_ETypeParameter69', a)
