...
# Classes
adl_Binding = Class(name="adl_Binding")
Type = Class(name="Type")
adl_AbstractComponent = Class(name="adl_AbstractComponent", is_abstract=True)
adl_Component = Class(name="adl_Component")
AbstractComponent = Class(name="AbstractComponent")
adl_Required = Class(name="adl_Required")
adl_Provided = Class(name="adl_Provided")
adl_Interface = Class(name="adl_Interface", is_abstract=True)
NamedElement = Class(name="NamedElement")
adl_NamedElement = Class(name="adl_NamedElement", is_abstract=True)
adl_Type = Class(name="adl_Type", is_abstract=True)
...
domain_model = DomainModel(
    name="adl",
    types={adl_Binding, Type, adl_AbstractComponent, adl_Component, AbstractComponent, adl_Required, adl_Provided, adl_Interface, NamedElement, adl_NamedElement, adl_Type, Interface},
    associations={bindings3, from_4, to7, requiredInterfaces0, providedInterfaces1, subComponents11},
    generalizations={gen_adl_Binding_NamedElement, gen_adl_Required_Type, gen_adl_Provided_Type, gen_adl_Component_AbstractComponent, gen_adl_Component_NamedElement, gen_adl_Interface_NamedElement, gen_adl_Type_Interface},
    metadata=None
)
