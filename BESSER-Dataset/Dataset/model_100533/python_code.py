...
class UseCaseDSL_UseCase:
    ...
    def __init__(self, description: str, name: str, postcondition: str, preConditions: str, UseCaseDSL_UseCase: "UseCaseDSL_LocalAlternative" = None, UseCaseDSL_UseCase10: "UseCaseDSL_PackageDeclaration" = None, UseCaseDSL_UseCase26: "UseCaseDSL_UseCase" = None, UseCaseDSL_UseCase24: "UseCaseDSL_UseCase" = None, UseCaseDSL_UseCase28: set["UseCaseDSL_Flow"] = None, UseCaseDSL_UseCase20: "UseCaseDSL_Step" = None):
        self.description = description
        self.name = name
...
class UseCaseDSL_Step(ABC):
    ...
    def __init__(self, label: str, name: str, UseCaseDSL_Step: "UseCaseDSL_Flow" = None, UseCaseDSL_Step23: "UseCaseDSL_StepAlternative" = None, UseCaseDSL_Step17: "UseCaseDSL_Step" = None, UseCaseDSL_Step15: "UseCaseDSL_Step" = None, UseCaseDSL_Step19: "UseCaseDSL_UseCase" = None):
        self.label = label
        self.name = name
...
class UseCaseDSL_NormalStep(Step):
    ...
    def __init__(self, customStepType: str, UseCaseDSL_NormalStep7: "UseCaseDSL_Actor" = None, UseCaseDSL_NormalStep: set["UseCaseDSL_StepAlternative"] = None):
