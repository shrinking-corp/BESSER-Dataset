...
class Order:
    ...
    def __init__(self, Restaurant: Restaurant, ItemList: MenuItem, Customer: Customer, OrderController_Order_119: set["OrderController"] = None, Order_MenuItem_010: set["MenuItem"] = None, Order_Restaurant_012: "Restaurant" = None, Order_Customer_014: "Customer" = None):
        self.Restaurant = Restaurant
...
class Restaurant:
    ...
    def __init__(self, Name: str, Address: str, PostCode: int, Menu: MenuItem, RestaurantManager_Restaurant_117: set["RestaurantController"] = None, Restaurant_MenuItem_08: set["MenuItem"] = None, Order_Restaurant_113: set["Order"] = None):
        self.Name = Name
        self.Address = Address
        self.PostCode = PostCode
        self.Menu = Menu
