...
class plsql_condition_BooleanCondition(SQLCondition):
    ...
    def __init__(self, type: str, plsql_condition_BooleanCondition98: "SQLCondition" = None, plsql_condition_BooleanCondition: "SQLCondition" = None, SQLCondition: "plsql_statement_SelectStatement" = None, SQLCondition101: "plsql_condition_NotCondition" = None, SQLCondition50: "plsql_statement_UpdateStatement" = None, SQLCondition99: "plsql_condition_BooleanCondition" = None, SQLCondition96: "plsql_condition_BooleanCondition" = None):
        self.type = type
...
class plsql_statement_SelectStatement(ModifySQLStatement):
    ...
    def __init__(self, selectList: str, bulk: bool, collect: bool, from_: str, isCount: bool, distinct: bool, unique: bool, all: bool, plsql_statement_SelectStatement: set["VarRefExpression"] = None, plsql_statement_SelectStatement41: "SQLCondition" = None, plsql_statement_SelectStatement43: set["Expression"] = None):
...
class plsql_expression_ArithmeticExpression(Expression):
    ...
    def __init__(self, type: str, plsql_expression_ArithmeticExpression: "Expression" = None, plsql_expression_ArithmeticExpression90: "Expression" = None, Expression52: "plsql_statement_UpdatePair" = None, Expression106: "plsql_condition_ConditionComparison" = None, Expression73: "plsql_expression_LikeExpression" = None, Expression88: "plsql_expression_ArithmeticExpression" = None, Expression3: "plsql_statement_AssignmentStatement" = None, Expression86: "plsql_expression_FunctionCallParameter" = None, Expression84: "plsql_expression_PropertyAccess" = None, Expression46: "plsql_statement_InsertStatement" = None, Expression103: "plsql_condition_ConditionComparison" = None, Expression37: "plsql_statement_OpenStatement" = None, Expression56: "plsql_expression_BooleanExpression" = None, Expression71: "plsql_expression_InRangeExpression" = None, Expression91: "plsql_expression_ArithmeticExpression" = None, Expression18: "plsql_statement_ForStatement" = None, Expression63: "plsql_expression_IsNullExpression" = None, Expression132: "plsql_declaration_Argument" = None, Expression61: "plsql_expression_NotExpression" = None, Expression: "plsql_statement_AssignmentStatement" = None, Expression68: "plsql_expression_InRangeExpression" = None, Expression20: "plsql_statement_ReturnStatement" = None, Expression108: "plsql_declaration_VariableDeclaration" = None, Expression65: "plsql_expression_InRangeExpression" = None, Expression5: "plsql_statement_IfStatement" = None, Expression59: "plsql_expression_BooleanExpression" = None, Expression76: "plsql_expression_LikeExpression" = None, Expression44: "plsql_statement_SelectStatement" = None, Expression93: "plsql_expression_ConcatString" = None):
        self.type = type
...
class plsql_expression_PropertyAccess(Expression):
    ...
    def __init__(self, propertyName: str, plsql_expression_PropertyAccess: "Expression" = None, Expression52: "plsql_statement_UpdatePair" = None, Expression106: "plsql_condition_ConditionComparison" = None, Expression73: "plsql_expression_LikeExpression" = None, Expression88: "plsql_expression_ArithmeticExpression" = None, Expression3: "plsql_statement_AssignmentStatement" = None, Expression86: "plsql_expression_FunctionCallParameter" = None, Expression84: "plsql_expression_PropertyAccess" = None, Expression46: "plsql_statement_InsertStatement" = None, Expression103: "plsql_condition_ConditionComparison" = None, Expression37: "plsql_statement_OpenStatement" = None, Expression56: "plsql_expression_BooleanExpression" = None, Expression71: "plsql_expression_InRangeExpression" = None, Expression91: "plsql_expression_ArithmeticExpression" = None, Expression18: "plsql_statement_ForStatement" = None, Expression63: "plsql_expression_IsNullExpression" = None, Expression132: "plsql_declaration_Argument" = None, Expression61: "plsql_expression_NotExpression" = None, Expression: "plsql_statement_AssignmentStatement" = None, Expression68: "plsql_expression_InRangeExpression" = None, Expression20: "plsql_statement_ReturnStatement" = None, Expression108: "plsql_declaration_VariableDeclaration" = None, Expression65: "plsql_expression_InRangeExpression" = None, Expression5: "plsql_statement_IfStatement" = None, Expression59: "plsql_expression_BooleanExpression" = None, Expression76: "plsql_expression_LikeExpression" = None, Expression44: "plsql_statement_SelectStatement" = None, Expression93: "plsql_expression_ConcatString" = None):
...
class plsql_statement_RaiseStatement(Statement):
    ...
    def __init__(self, exception: str, Statement54: "plsql_statement_ExceptionSection" = None, Statement137: "plsql_declaration_Package" = None, Statement119: "plsql_declaration_ProcedureDeclaration" = None, Statement: "plsql_statement_IfStatement" = None, Statement12: "plsql_statement_IfStatement" = None, Statement24: "plsql_statement_BlockStatement" = None, Statement127: "plsql_declaration_FunctionDeclaration" = None, Statement14: "plsql_statement_LoopStatement" = None):
