...
activitydiagram_Activity.methods={activitydiagram_Activity_m_finish, activitydiagram_Activity_m_getVariable, activitydiagram_Activity_m_getIntegerVariableValue, activitydiagram_Activity_m_getBooleanVariableValue, activitydiagram_Activity_m_initialize, activitydiagram_Activity_m_initializeModel, activitydiagram_Activity_m_getVariableValue, activitydiagram_Activity_m_reset, activitydiagram_Activity_m_execute}
...
activitydiagram_ActivityNode.methods={activitydiagram_ActivityNode_m_addTokens, activitydiagram_ActivityNode_m_removeToken, activitydiagram_ActivityNode_m_terminate, activitydiagram_ActivityNode_m_execute}
...
activitydiagram_ActivityEdge.methods={activitydiagram_ActivityEdge_m_takeOfferedTokens, activitydiagram_ActivityEdge_m_clearOffer, activitydiagram_ActivityEdge_m_sendOffer, activitydiagram_ActivityEdge_m_evaluateGuard, activitydiagram_ActivityEdge_m_transferTokens}
...
domain_model = DomainModel(
    ...
    types={activitydiagram_Activity, NamedElement, activitydiagram_ActivityNode, activitydiagram_ActivityEdge, activitydiagram_Variable, activitydiagram_Signal, activitydiagram_Trace, activitydiagram_Context, activitydiagram_Offer, activitydiagram_ControlFlow, ActivityEdge, activitydiagram_BooleanVariable, activitydiagram_ControlNode, ActivityNode, activitydiagram_ExecutableNode, activitydiagram_Action, ExecutableNode, activitydiagram_OpaqueAction, Action, activitydiagram_Expression, activitydiagram_NamedElement, activitydiagram_InitialNode, ControlNode, activitydiagram_FinalNode, activitydiagram_Token, activitydiagram_DecisionNode, activitydiagram_Value, activitydiagram_IntegerVariable, Variable, activitydiagram_BooleanValue, Value, activitydiagram_IntegerValue, activitydiagram_ActivityFinalNode, FinalNode, activitydiagram_ForkNode, activitydiagram_JoinNode, activitydiagram_MergeNode, activitydiagram_BooleanExpression, activitydiagram_IntegerCalculationExpression, IntegerExpression, activitydiagram_IntegerComparisonExpression, activitydiagram_BooleanUnaryExpression, BooleanExpression, activitydiagram_BooleanBinaryExpression, activitydiagram_IntegerExpression, Expression, activitydiagram_SendSignalAction, activitydiagram_AcceptEventAction, activitydiagram_SignalEvent, Signal, activitydiagram_ControlToken, Token, activitydiagram_ForkedToken, activitydiagram_InputValue, activitydiagram_Input, IntegerCalculationOperator, IntegerComparisonOperator, BooleanUnaryOperator, BooleanBinaryOperator},
    associations={nodes0, edges1, locals2, inputs4, signals7, trace9, context11, outgoing13, source18, target20, offers22, guard24, expressions25, incoming14, activity16, heldTokens17, initialValue26, currentValue28, assignee35, assignee37, assignee39, operand41, operand143, operand245, operand231, operand132, signal55, trigger57, holder58, offeredTokens61, executedNodes64, baseToken67, output69, value48, variable50, inputValues53, activity72, parent76, node78},
    generalizations={gen_activitydiagram_Activity_NamedElement, gen_activitydiagram_ActivityNode_NamedElement, gen_activitydiagram_ControlFlow_ActivityEdge, gen_activitydiagram_ControlNode_ActivityNode, gen_activitydiagram_ExecutableNode_ActivityNode, gen_activitydiagram_Action_ExecutableNode, gen_activitydiagram_OpaqueAction_Action, gen_activitydiagram_InitialNode_ControlNode, gen_activitydiagram_ActivityEdge_NamedElement, gen_activitydiagram_DecisionNode_ControlNode, gen_activitydiagram_IntegerVariable_Variable, gen_activitydiagram_BooleanVariable_Variable, gen_activitydiagram_BooleanValue_Value, gen_activitydiagram_IntegerValue_Value, gen_activitydiagram_FinalNode_ControlNode, gen_activitydiagram_ActivityFinalNode_FinalNode, gen_activitydiagram_ForkNode_ControlNode, gen_activitydiagram_JoinNode_ControlNode, gen_activitydiagram_MergeNode_ControlNode, gen_activitydiagram_BooleanExpression_Expression, gen_activitydiagram_IntegerCalculationExpression_IntegerExpression, gen_activitydiagram_IntegerComparisonExpression_IntegerExpression, gen_activitydiagram_BooleanUnaryExpression_BooleanExpression, gen_activitydiagram_BooleanBinaryExpression_BooleanExpression, gen_activitydiagram_IntegerExpression_Expression, gen_activitydiagram_SendSignalAction_Action, gen_activitydiagram_AcceptEventAction_Action, gen_activitydiagram_Signal_NamedElement, gen_activitydiagram_SignalEvent_Signal, gen_activitydiagram_ControlToken_Token, gen_activitydiagram_ForkedToken_Token},
    metadata=None
)
