...
domain_model = DomainModel(
    name="QVTOperational",
    types={QVTOperational_ConstructorBody, OperationBody, QVTOperational_ContextualProperty, Property_, Class_, OclExpression, QVTOperational_EntryOperation, QVTOperational_Helper, QVTOperational_ImperativeCallExp, OperationCallExp, ImperativeExpression, QVTOperational_ImperativeOperation, Operation, VarParameter, QVTOperational_Constructor, ImperativeOperation, QVTOperational_MappingCallExp, ImperativeCallExp, QVTOperational_MappingOperation, MappingOperation, Relation, QVTOperational_Library, Module, ModelParameter, QVTOperational_MappingBody, RelationDomain, QVTOperational_ModelParameter, OperationalTransformation, QVTOperational_ModelType, Package, QVTOperational_Module, EntryOperation, ModuleImport, QVTOperational_MappingParameter, QVTOperational_ObjectExp, InstantiationExp, ConstructorBody, QVTOperational_OperationBody, QVTOperational_OperationalTransformation, Tag, Variable, ModelType, QVTOperational_ModuleImport, Element, QVTOperational_ResolveInExp, ResolveExp, QVTOperational_VarParameter, Parameter_, RelationalTransformation, QVTOperational_ResolveExp, CallExp, DirectionKind, ImportKind},
    associations={context0, initExpression1, overridden3, body5, context6, endSection13, initSection15, disjunct18, inherited19, merged22, overridden8, result10, extent33, referredDomain34, module36, additionalCondition37, metamodel39, configProperty41, entry43, moduleImport45, refinedRelation25, when27, where30, binding53, importedModule55, module57, body60, referredObject61, content64, operation66, variable69, intermediateClass72, intermediateProperty74, ownedTag47, ownedVariable49, usedModelType51, condition84, target86, inMapping89, ctxOwner91, resOwner93, modelParameter77, refined79, relation81},
    generalizations={gen_QVTOperational_ConstructorBody_OperationBody, gen_QVTOperational_ContextualProperty_Property, gen_QVTOperational_EntryOperation_ImperativeOperation, gen_QVTOperational_Helper_ImperativeOperation, gen_QVTOperational_ImperativeCallExp_OperationCallExp, gen_QVTOperational_ImperativeCallExp_ImperativeExpression, gen_QVTOperational_ImperativeOperation_Operation, gen_QVTOperational_Constructor_ImperativeOperation, gen_QVTOperational_MappingCallExp_ImperativeCallExp, gen_QVTOperational_MappingOperation_ImperativeOperation, gen_QVTOperational_Library_Module, gen_QVTOperational_MappingBody_OperationBody, gen_QVTOperational_ModelParameter_VarParameter, gen_QVTOperational_ModelType_Class, gen_QVTOperational_Module_Class, gen_QVTOperational_Module_Package, gen_QVTOperational_MappingParameter_VarParameter, gen_QVTOperational_ObjectExp_InstantiationExp, gen_QVTOperational_OperationBody_Element, gen_QVTOperational_OperationalTransformation_Module, gen_QVTOperational_ModuleImport_Element, gen_QVTOperational_ResolveInExp_ResolveExp, gen_QVTOperational_VarParameter_Variable, gen_QVTOperational_VarParameter_Parameter, gen_QVTOperational_ResolveExp_CallExp, gen_QVTOperational_ResolveExp_ImperativeExpression},
    metadata=None
)
