...
class Routing_Settings:
    ...
    def __init__(self, Routing_Priority: int, Routing_Model: Routing_Model, Push_Time_Out: str):
        self.Routing_Priority = Routing_Priority
        self.Routing_Model = Routing_Model
        self.Push_Time_Out = Push_Time_Out
        
        pass
    @property
    def Routing_Priority(self):
        return self.__Routing_Priority
    @Routing_Priority.setter
    def Routing_Priority(self, Routing_Priority: int):
        self.__Routing_Priority = Routing_Priority

    @property
    def Push_Time_Out(self):
        return self.__Push_Time_Out
    @Push_Time_Out.setter
    def Push_Time_Out(self, Push_Time_Out: str):
        self.__Push_Time_Out = Push_Time_Out

    @property
    def Routing_Model(self):
        return self.__Routing_Model
    @Routing_Model.setter
    def Routing_Model(self, Routing_Model: Routing_Model):
        self.__Routing_Model = Routing_Model



class Routing_Configuration_Settings:

    def __init__(self, Name: str, Overflow_Assignee: str):
        self.Name = Name
        self.Overflow_Assignee = Overflow_Assignee
    ...
    @property
    def Overflow_Assignee(self):
        return self.__Overflow_Assignee
    @Overflow_Assignee.setter
    def Overflow_Assignee(self, Overflow_Assignee: str):
        self.__Overflow_Assignee = Overflow_Assignee



class Custom_SalesForce_Object:

    def __init__(self, Owner: str, service_Channel7: "Service_Channel" = None):
        self.Owner = Owner
        self.service_Channel7 = service_Channel7
    ...
    @property
    def service_Channel7(self):
        return self.__service_Channel7
    @service_Channel7.setter
    def service_Channel7(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Custom_SalesForce_Object__service_Channel7", None)
        self.__service_Channel7 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "salesForce_Object6"):
                opp_val = getattr(old_value, "salesForce_Object6", None)
                if opp_val == self:
                    setattr(old_value, "salesForce_Object6", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "salesForce_Object6"):
                opp_val = getattr(value, "salesForce_Object6", None)
                setattr(value, "salesForce_Object6", self)
...
class Service_Channel:
    ...
    def __init__(self, Name: str, salesForce_Object6: "Custom_SalesForce_Object" = None):
        self.Name = Name
        self.salesForce_Object6 = salesForce_Object6
    ...
    @property
    def salesForce_Object6(self):
        return self.__salesForce_Object6
    @salesForce_Object6.setter
    def salesForce_Object6(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Service_Channel__salesForce_Object6", None)
        self.__salesForce_Object6 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "service_Channel7"):
                opp_val = getattr(old_value, "service_Channel7", None)
                if opp_val == self:
                    setattr(old_value, "service_Channel7", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "service_Channel7"):
                opp_val = getattr(value, "service_Channel7", None)
                setattr(value, "service_Channel7", self)
