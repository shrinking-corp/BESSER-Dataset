...
Routing_Model: Enumeration = Enumeration(
    name="Routing_Model",
    literals={
...
Service_Channel = Class(name="Service_Channel")
Appraisal = Class(name="Appraisal")
Custom_SalesForce_Object = Class(name="Custom_SalesForce_Object")
Routing_Configuration_Settings = Class(name="Routing_Configuration_Settings")
Routing_Settings = Class(name="Routing_Settings")
...
Customer.attributes={Customer_phoneNumber, Customer_dateOfBirth, Customer_emailAddress, Customer_address, Customer_name}
...
Login.attributes={Login_securityQuestion, Login_securityAnswer, Login_lastLoginTime, Login_password, Login_username}
...
transaction_Transaction.attributes={transaction_Transaction_transactionTime, transaction_Transaction_id, transaction_Transaction_type, transaction_Transaction_amount}
...
account_Account.attributes={account_Account_accountNo, account_Account_balance, account_Account_type}

# Service_Channel class attributes and methods
Service_Channel_Name: Property = Property(name="Name", type=StringType)
Service_Channel.attributes={Service_Channel_Name}

# Appraisal class attributes and methods
Appraisal_Col1: Property = Property(name="Col1", type=StringType)
Appraisal_Col2: Property = Property(name="Col2", type=StringType)
Appraisal.attributes={Appraisal_Col1, Appraisal_Col2}

# Custom_SalesForce_Object class attributes and methods
Custom_SalesForce_Object_Owner: Property = Property(name="Owner", type=StringType)
Custom_SalesForce_Object.attributes={Custom_SalesForce_Object_Owner}

# Routing_Configuration_Settings class attributes and methods
Routing_Configuration_Settings_Name: Property = Property(name="Name", type=StringType)
Routing_Configuration_Settings_Overflow_Assignee: Property = Property(name="Overflow_Assignee", type=StringType)
Routing_Configuration_Settings.attributes={Routing_Configuration_Settings_Name, Routing_Configuration_Settings_Overflow_Assignee}

# Routing_Settings class attributes and methods
Routing_Settings_Routing_Priority: Property = Property(name="Routing_Priority", type=IntegerType)
Routing_Settings_Routing_Model: Property = Property(name="Routing_Model", type=Routing_Model)
Routing_Settings_Push_Time_Out: Property = Property(name="Push_Time_Out", type=StringType)
Routing_Settings.attributes={Routing_Settings_Routing_Priority, Routing_Settings_Routing_Model, Routing_Settings_Push_Time_Out}
...
Service_Channel_SalesForce_Object: BinaryAssociation = BinaryAssociation(
    name="Service_Channel_SalesForce_Object",
    ends={
        Property(name="salesForce_Object6", type=Custom_SalesForce_Object, multiplicity=Multiplicity(0, 1)),
        Property(name="service_Channel7", type=Service_Channel, multiplicity=Multiplicity(0, 1))
    }
)

# Domain Model
domain_model = DomainModel(
    name="_3cf6602d_4b92_4e4d_99a7_050507fec6d9",
    types={Customer, Login, transaction_Transaction, transaction_DepositTransaction, transaction_WithdrawTransaction, transaction_TransferTransaction, account_SavingsAccount, account_CertificatesOfDepositAccount, account_CheckingAccount, account_Account, Service_Channel, Appraisal, Custom_SalesForce_Object, Routing_Configuration_Settings, Routing_Settings, transaction_TransactionType, account_AccountType, Routing_Model},
    associations={association2, Account_Transaction, Customer_Login, Service_Channel_SalesForce_Object},
    generalizations={},
    metadata=None
)
