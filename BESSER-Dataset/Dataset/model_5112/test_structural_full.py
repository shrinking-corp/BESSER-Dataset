...
def test_overloads_SubClass_isa_SuperClass():
    instance = overloads_SubClass()
...
overloads_SubClass_strategy = st.builds(overloads_SubClass)
...
overloads_SuperClass_strategy = st.builds(overloads_SuperClass)
