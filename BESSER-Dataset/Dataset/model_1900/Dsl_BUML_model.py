...
# Classes
dsl_System = Class(name="dsl_System")
dsl_Domain = Class(name="dsl_Domain")
dsl_Architecture = Class(name="dsl_Architecture")
dsl_Technology = Class(name="dsl_Technology")
dsl_Type = Class(name="dsl_Type")
dsl_Module = Class(name="dsl_Module")
dsl_RelationDom = Class(name="dsl_RelationDom")
dsl_Submodule = Class(name="dsl_Submodule")
dsl_Operation = Class(name="dsl_Operation")
dsl_EObject = Class(name="dsl_EObject")
dsl_EntityName = Class(name="dsl_EntityName")
dsl_GeneralEntity = Class(name="dsl_GeneralEntity")
dsl_Property = Class(name="dsl_Property")
AbstractFrontElement = Class(name="AbstractFrontElement")
dsl_SpecialEntity = Class(name="dsl_SpecialEntity")
dsl_Transaction = Class(name="dsl_Transaction")
dsl_Operateson = Class(name="dsl_Operateson")
dsl_Component = Class(name="dsl_Component")
dsl_RelationArch = Class(name="dsl_RelationArch")
dsl_Layer = Class(name="dsl_Layer")
dsl_LayerSegment = Class(name="dsl_LayerSegment")
dsl_LayerSegmentRelation = Class(name="dsl_LayerSegmentRelation")
dsl_SublayerSegment = Class(name="dsl_SublayerSegment")
dsl_JavaApp = Class(name="dsl_JavaApp")
dsl_ReactApp = Class(name="dsl_ReactApp")
dsl_JeeProject = Class(name="dsl_JeeProject")
dsl_Subproject = Class(name="dsl_Subproject")
dsl_Epackage = Class(name="dsl_Epackage")
dsl_Library = Class(name="dsl_Library")
dsl_Descriptor = Class(name="dsl_Descriptor")
dsl_AbstractClass = Class(name="dsl_AbstractClass")
Eclass = Class(name="Eclass")
dsl_Attribute = Class(name="dsl_Attribute")
dsl_MethodBack = Class(name="dsl_MethodBack")
dsl_Annotation = Class(name="dsl_Annotation")
dsl_AbstractMethod = Class(name="dsl_AbstractMethod")
dsl_GenericClass = Class(name="dsl_GenericClass")
dsl_Einterface = Class(name="dsl_Einterface")
dsl_NativeClass = Class(name="dsl_NativeClass")
dsl_Eclass = Class(name="dsl_Eclass")
dsl_AbstractFrontElement = Class(name="dsl_AbstractFrontElement")
dsl_Functionality = Class(name="dsl_Functionality")
dsl_Directory = Class(name="dsl_Directory")
dsl_JsModule = Class(name="dsl_JsModule")
dsl_RouterComponent = Class(name="dsl_RouterComponent")
dsl_Container = Class(name="dsl_Container")
dsl_Visualizer = Class(name="dsl_Visualizer")
dsl_State = Class(name="dsl_State")
dsl_ServiceFront = Class(name="dsl_ServiceFront")
UIComponent = Class(name="UIComponent")
dsl_UIComponent = Class(name="dsl_UIComponent")
dsl_File = Class(name="dsl_File")
dsl_Md = Class(name="dsl_Md")
File = Class(name="File")
dsl_Js = Class(name="dsl_Js")
dsl_Json = Class(name="dsl_Json")
dsl_Css = Class(name="dsl_Css")
dsl_Action = Class(name="dsl_Action")
dsl_Reducer = Class(name="dsl_Reducer")
dsl_ActionCreator = Class(name="dsl_ActionCreator")
dsl_ActionDispatcher = Class(name="dsl_ActionDispatcher")
...
dsl_Library.attributes={dsl_Library_name, dsl_Library_isNative}
...
dsl_File.attributes={dsl_File_type, dsl_File_name}
...
dsl_ActionCreator.attributes={dsl_ActionCreator_type, dsl_ActionCreator_name}
...
domain_model = DomainModel(
    name="dsl",
    types={dsl_System, dsl_Domain, dsl_Architecture, dsl_Technology, dsl_Type, dsl_Module, dsl_RelationDom, dsl_Submodule, dsl_Operation, dsl_EObject, dsl_EntityName, dsl_GeneralEntity, dsl_Property, AbstractFrontElement, dsl_SpecialEntity, dsl_Transaction, dsl_Operateson, dsl_Component, dsl_RelationArch, dsl_Layer, dsl_LayerSegment, dsl_LayerSegmentRelation, dsl_SublayerSegment, dsl_JavaApp, dsl_ReactApp, dsl_JeeProject, dsl_Subproject, dsl_Epackage, dsl_Library, dsl_Descriptor, dsl_AbstractClass, Eclass, dsl_Attribute, dsl_MethodBack, dsl_Annotation, dsl_AbstractMethod, dsl_GenericClass, dsl_Einterface, dsl_NativeClass, dsl_Eclass, dsl_AbstractFrontElement, dsl_Functionality, dsl_Directory, dsl_JsModule, dsl_RouterComponent, dsl_Container, dsl_Visualizer, dsl_State, dsl_ServiceFront, UIComponent, dsl_UIComponent, dsl_File, dsl_Md, File, dsl_Js, dsl_Json, dsl_Css, dsl_Action, dsl_Reducer, dsl_ActionCreator, dsl_ActionDispatcher},
    associations={dom0, arch1, tech3, types5, modules7, relations9, submodules11, operations13, entities15, target17, name19, properties21, type23, name26, properties28, transactions31, operateson33, operateson35, source38, target41, componentes44, relationArch46, layer48, layerSegments50, relations52, sublayerSegments54, java56, react58, jeeproject60, subproject62, epackage64, library66, descriptor68, attribute70, methodClass71, annotation73, abstractMethod75, attribute77, methodClass79, annotation82, abs85, imp88, attribute90, abstractMethod93, attribute96, methodClass98, type101, eclass103, arg106, type109, arg112, type115, elements121, func123, dir125, mod127, route129, wrap131, render133, state135, service137, type139, type142, route145, type147, type150, type153, file156, subdirectory159, annotation118, action161, reducer163, actionCreator165, actionDispatcher167, dir169, type172, type175, type178},
    generalizations={gen_dsl_Type_AbstractFrontElement, gen_dsl_AbstractClass_Eclass, gen_dsl_GenericClass_Eclass, gen_dsl_NativeClass_Eclass, gen_dsl_Annotation_Eclass, gen_dsl_ReactApp_AbstractFrontElement, gen_dsl_Functionality_AbstractFrontElement, gen_dsl_RouterComponent_AbstractFrontElement, gen_dsl_RouterComponent_UIComponent, gen_dsl_Container_AbstractFrontElement, gen_dsl_Visualizer_AbstractFrontElement, gen_dsl_Visualizer_UIComponent, gen_dsl_ServiceFront_AbstractFrontElement, gen_dsl_Directory_AbstractFrontElement, gen_dsl_File_AbstractFrontElement, gen_dsl_Md_File, gen_dsl_Js_File, gen_dsl_Json_File, gen_dsl_Css_File, gen_dsl_State_AbstractFrontElement, gen_dsl_Action_AbstractFrontElement, gen_dsl_ActionCreator_AbstractFrontElement, gen_dsl_ActionDispatcher_AbstractFrontElement, gen_dsl_Reducer_AbstractFrontElement, gen_dsl_JsModule_AbstractFrontElement},
    metadata=None
)
