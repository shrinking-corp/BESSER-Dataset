...
class dsl_Eclass:
    ...
    def __init__(self, name: str, dsl_Eclass: "dsl_Attribute" = None, dsl_Eclass105: "dsl_Epackage" = None, dsl_Eclass108: "dsl_MethodBack" = None, dsl_Eclass111: "dsl_MethodBack" = None, dsl_Eclass114: "dsl_AbstractMethod" = None, dsl_Eclass117: "dsl_AbstractMethod" = None):
        self.name = name
...
class dsl_Einterface:
    ...
    def __init__(self, name: str, dsl_Einterface: "dsl_GenericClass" = None, dsl_Einterface91: set["dsl_Attribute"] = None, dsl_Einterface94: set["dsl_AbstractMethod"] = None):
        self.name = name
...
class dsl_MethodBack:
    ...
    def __init__(self, name: str, dsl_MethodBack: "dsl_AbstractClass" = None, dsl_MethodBack81: "dsl_GenericClass" = None, dsl_MethodBack100: "dsl_NativeClass" = None, dsl_MethodBack107: "dsl_Eclass" = None, dsl_MethodBack110: "dsl_Eclass" = None):
        self.name = name
...
class dsl_Attribute:
    ...
    def __init__(self, name: str, dsl_Attribute: "dsl_AbstractClass" = None, dsl_Attribute78: "dsl_GenericClass" = None, dsl_Attribute92: "dsl_Einterface" = None, dsl_Attribute97: "dsl_NativeClass" = None, dsl_Attribute102: "dsl_Eclass" = None):
        self.name = name
...
class dsl_Annotation(Eclass):
    ...
    def __init__(self, propertie: str, dsl_Annotation: "dsl_AbstractClass" = None, dsl_Annotation84: "dsl_GenericClass" = None, dsl_Annotation120: "dsl_Library" = None):
...
class dsl_Subproject:
    ...
    def __init__(self, name: str, dsl_Subproject: "dsl_JeeProject" = None, dsl_Subproject65: set["dsl_Epackage"] = None, dsl_Subproject67: set["dsl_Library"] = None, dsl_Subproject69: set["dsl_Descriptor"] = None):
        self.name = name
...
class dsl_Layer:
    ...
    def __init__(self, name: str, dsl_Layer: "dsl_Component" = None, dsl_Layer51: set["dsl_LayerSegment"] = None):
        self.name = name
...
class dsl_State(AbstractFrontElement):
    ...
    def __init__(self, name: str, dsl_State: "dsl_Functionality" = None, dsl_State162: "dsl_Action" = None, dsl_State164: "dsl_Reducer" = None):
        self.name = name
...
class dsl_Functionality(AbstractFrontElement):
    ...
    def __init__(self, name: str, dsl_Functionality: "dsl_ReactApp" = None, dsl_Functionality130: "dsl_RouterComponent" = None, dsl_Functionality132: "dsl_Container" = None, dsl_Functionality134: "dsl_Visualizer" = None, dsl_Functionality136: "dsl_State" = None, dsl_Functionality138: "dsl_ServiceFront" = None, dsl_Functionality140: "dsl_Directory" = None):
        self.name = name
...
class dsl_Action(AbstractFrontElement):
    ...
    def __init__(self, name: str, dsl_Action: "dsl_State" = None, dsl_Action166: "dsl_ActionCreator" = None, dsl_Action168: "dsl_ActionDispatcher" = None, dsl_Action170: "dsl_Directory" = None):
        self.name = name
...
class dsl_RouterComponent(AbstractFrontElement, UIComponent):
    ...
    def __init__(self, name: str, dsl_RouterComponent: "dsl_Functionality" = None, dsl_RouterComponent146: "dsl_UIComponent" = None, dsl_RouterComponent143: "dsl_AbstractFrontElement" = None):
        self.name = name
...
class dsl_Directory(AbstractFrontElement):
    ...
    def __init__(self, name: str, purpose: str, dsl_Directory: "dsl_ReactApp" = None, dsl_Directory157: "dsl_File" = None, dsl_Directory160: "dsl_Directory" = None, dsl_Directory158: "dsl_Directory" = None, dsl_Directory171: "dsl_Action" = None, dsl_Directory180: "dsl_JsModule" = None, dsl_Directory141: "dsl_Functionality" = None):
        self.name = name
...
class dsl_ServiceFront(AbstractFrontElement):
    ...
    def __init__(self, name: str, method: str, dsl_ServiceFront154: "dsl_JsModule" = None, dsl_ServiceFront: "dsl_Functionality" = None):
        self.name = name
        self.method = method
...
class dsl_EntityName:
    ...
    def __init__(self, name: str, dsl_EntityName: "dsl_Operation" = None, dsl_EntityName20: "dsl_GeneralEntity" = None, dsl_EntityName37: "dsl_Operateson" = None, dsl_EntityName40: "dsl_RelationDom" = None, dsl_EntityName43: "dsl_RelationDom" = None, dsl_EntityName27: "dsl_SpecialEntity" = None):
        self.name = name
...
class dsl_Module:
    ...
    def __init__(self, name: str, dsl_Module: "dsl_Domain" = None, dsl_Module12: set["dsl_Submodule"] = None):
        self.name = name
