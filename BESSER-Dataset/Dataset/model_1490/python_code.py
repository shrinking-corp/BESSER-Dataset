...
class extendedPetriNets_OutputArc:
    ...
    def __init__(self, weight: int, extendedPetriNets_OutputArc14: "extendedPetriNets_Transition" = None, extendedPetriNets_OutputArc17: "extendedPetriNets_GenericPlace" = None, extendedPetriNets_OutputArc: "extendedPetriNets_PetriNet" = None):
        self.weight = weight
...
class extendedPetriNets_Transition:
    ...
    def __init__(self, name: str, label: str, extendedPetriNets_Transition15: "extendedPetriNets_OutputArc" = None, extendedPetriNets_Transition: "extendedPetriNets_PetriNet" = None, extendedPetriNets_Transition9: "extendedPetriNets_InputArc" = None):
        self.name = name
        self.label = label
