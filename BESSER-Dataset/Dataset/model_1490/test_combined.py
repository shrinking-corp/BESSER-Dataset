...
@given(instance=extendedPetriNets_Transition_strategy)
def test_hyp_extendedpetrinets_transition_label_setter(instance):
...
def test_extendedPetriNets_Transition_label_value_roundtrip():
    instance = extendedPetriNets_Transition(label="sample_text", name="sample_text")
...
def test_assoc_InputArcToTransition7_link_reassign_clear():
    a = extendedPetriNets_Transition(label="sample_text", name="sample_text")
...
extendedPetriNets_Transition_strategy = st.builds(extendedPetriNets_Transition, label=safe_text, name=safe_text)
@given(instance=extendedPetriNets_Transition_strategy)
@settings(max_examples=25)
