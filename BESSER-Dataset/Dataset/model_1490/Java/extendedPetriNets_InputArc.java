...
public class extendedPetriNets_InputArc  {
    ...
    private extendedPetriNets_GenericPlace extendedpetrinets_genericplace;
    ...
    public extendedPetriNets_InputArc(
        int weight    ) {
        this.weight = weight;
    }
    ...
    public extendedPetriNets_GenericPlace getExtendedpetrinets_genericplace() {
        return extendedpetrinets_genericplace;
    }

    public void setExtendedpetrinets_genericplace(extendedPetriNets_GenericPlace extendedpetrinets_genericplace) {
        this.extendedpetrinets_genericplace = extendedpetrinets_genericplace;
    }
