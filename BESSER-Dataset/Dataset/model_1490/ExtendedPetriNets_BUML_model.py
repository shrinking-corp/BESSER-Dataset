...
domain_model = DomainModel(
    ...
    types={extendedPetriNets_PetriNet, extendedPetriNets_GenericPlace, extendedPetriNets_OutputPort, GenericPlace, extendedPetriNets_InputPort, extendedPetriNets_Place, extendedPetriNets_Transition, extendedPetriNets_InputArc, extendedPetriNets_OutputArc},
    associations={containsGenericPlaces0, OutputArcFromTransition13, OutputArcToPlace16, containsTransitions1, containsInputArcs3, containsOutputArcs5, InputArcToTransition7, InputArcFromPlace10},
