...
Problem.attributes={Problem_Type, Problem_Content, Problem_Id}
...
Client.attributes={Client_Id, Client_Loyalty_card, Client_Name, Client_Bookings}
...
Booking.attributes={Booking_Id, Booking_Destination, Booking_Tickets, Booking_Time, Booking_Luggage, Booking_Origin}
...
Ticket.attributes={Ticket_Clients, Ticket_Seat, Ticket_Id, Ticket_Booking_Class}
...
Flight.attributes={Flight_Origin, Flight_Time, Flight_Max_Passangers, Flight_Company, Flight_Id, Flight_Destination}
