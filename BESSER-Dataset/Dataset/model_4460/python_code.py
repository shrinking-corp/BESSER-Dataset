...
class arduinoml_SimpleCondition(Condition):
    ...
    def __init__(self, value: str, comparator: str, arduinoml_SimpleCondition25: "arduinoml_MultipleCondition" = None, arduinoml_SimpleCondition: "arduinoml_Sensor" = None):
        self.value = value
...
class arduinoml_Action(NamedElement):
    ...
    def __init__(self, value: str, arduinoml_Action: "arduinoml_State" = None, arduinoml_Action22: "arduinoml_Actuator" = None):
        self.value = value
