...
arduinoml_MultipleCondition = Class(name="arduinoml_MultipleCondition")
arduinoml_SimpleCondition = Class(name="arduinoml_SimpleCondition")
...
arduinoml_SimpleCondition.attributes={arduinoml_SimpleCondition_comparator, arduinoml_SimpleCondition_value}
...
domain_model = DomainModel(
    name="arduinoml",
    types={arduinoml_Sensor, Brick, arduinoml_Actuator, arduinoml_Action, arduinoml_NamedElement, arduinoml_App, NamedElement, arduinoml_Brick, arduinoml_State, arduinoml_Condition, arduinoml_Transition, arduinoml_MultipleCondition, arduinoml_SimpleCondition, Condition, BrickType, OPERATOR, COMPARATOR},
    associations={next7, condition10, previous13, actions16, transitions18, actuator21, bricks0, states1, conditions3, transitions5, conditions24, sensor23},
    generalizations={gen_arduinoml_Brick_NamedElement, gen_arduinoml_Sensor_Brick, gen_arduinoml_Actuator_Brick, gen_arduinoml_State_NamedElement, gen_arduinoml_Condition_NamedElement, gen_arduinoml_Action_NamedElement, gen_arduinoml_App_NamedElement, gen_arduinoml_MultipleCondition_Condition, gen_arduinoml_SimpleCondition_Condition},
    metadata=None
)
