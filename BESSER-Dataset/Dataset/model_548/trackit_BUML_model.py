...
# Classes
trackit_IssueTracker = Class(name="trackit_IssueTracker")
trackit_Team = Class(name="trackit_Team")
trackit_Version = Class(name="trackit_Version")
trackit_Product = Class(name="trackit_Product")
trackit_Issue = Class(name="trackit_Issue")
trackit_Member = Class(name="trackit_Member")
trackit_Identifiable = Class(name="trackit_Identifiable", is_abstract=True)
Identifiable = Class(name="Identifiable")
trackit_Comment = Class(name="trackit_Comment")
...
trackit_Version.attributes={trackit_Version_status, trackit_Version_name}
...
trackit_Issue.attributes={trackit_Issue_issueType, trackit_Issue_dateCreated, trackit_Issue_status, trackit_Issue_title, trackit_Issue_description}
...
trackit_Member.attributes={trackit_Member_fullName, trackit_Member_firstName, trackit_Member_lastName}
...
trackit_Comment.attributes={trackit_Comment_dateCreated, trackit_Comment_text}
...
domain_model = DomainModel(
    name="trackit",
    types={trackit_IssueTracker, trackit_Team, trackit_Version, trackit_Product, trackit_Issue, trackit_Member, trackit_Identifiable, Identifiable, trackit_Comment, VersionStatus, IssueStatus, IssueType},
    associations={teams0, version15, products1, issues3, members5, issuesCreated7, comments8, issuesAssigned10, members12, assignedTo26, comments28, duplicateOf31, product17, issues20, author22, blockers24, dependencies34, versionsAffected36, blocking38, issue40, author42, parent46, replies49},
    generalizations={gen_trackit_Product_Identifiable, gen_trackit_Version_Identifiable, gen_trackit_Member_Identifiable, gen_trackit_Team_Identifiable, gen_trackit_Issue_Identifiable, gen_trackit_Comment_Identifiable},
    metadata=None
)
