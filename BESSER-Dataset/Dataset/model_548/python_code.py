...
class trackit_Comment(Identifiable):
    ...
    def __init__(self, text: str, dateCreated: str, comments43: "trackit_Member" = None, Comment47: "trackit_Comment" = None, replies: "trackit_Comment" = None, Comment50: "trackit_Comment" = None, parent: set["trackit_Comment"] = None, Comment: "trackit_Member" = None, Comment29: "trackit_Issue" = None, comments: "trackit_Issue" = None):
        self.text = text
...
class trackit_Member(Identifiable):
    ...
    def __init__(self, firstName: str, lastName: str, fullName: str, trackit_Member: "trackit_IssueTracker" = None, author: set["trackit_Issue"] = None, Member44: "trackit_Comment" = None, author9: set["trackit_Comment"] = None, assignedTo: set["trackit_Issue"] = None, trackit_Member14: "trackit_Team" = None, Member27: "trackit_Issue" = None, Member: "trackit_Issue" = None):
...
class trackit_Product(Identifiable):
    ...
    def __init__(self, name: str, trackit_Product16: set["trackit_Version"] = None, trackit_Product: "trackit_IssueTracker" = None, trackit_Product19: "trackit_Version" = None):
        self.name = name
