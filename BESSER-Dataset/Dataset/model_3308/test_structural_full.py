...
def test_experimental_PerculationDiseaseModel_isa_StochasticSEIRDiseaseModel():
    instance = experimental_PerculationDiseaseModel()
...
StochasticSEIRDiseaseModel_strategy = st.builds(StochasticSEIRDiseaseModel)
...
experimental_PerculationDiseaseModel_strategy = st.builds(experimental_PerculationDiseaseModel)
