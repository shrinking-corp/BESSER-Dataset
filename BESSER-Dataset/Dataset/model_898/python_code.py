...
class SimplePDL_WorkDefinition(ProcessElement):
    ...
    def __init__(self, name: str, minTime: int, maxTime: int, parent: set["SimplePDL_ProcessElement"] = None, successor: set["SimplePDL_WorkSequence"] = None, predecessor: set["SimplePDL_WorkSequence"] = None, workDefinition: set["SimplePDL_Resource"] = None, WorkDefinition: "SimplePDL_WorkSequence" = None, WorkDefinition10: "SimplePDL_WorkSequence" = None, WorkDefinition15: "SimplePDL_ProcessElement" = None, WorkDefinition17: "SimplePDL_Resource" = None):
        self.name = name
