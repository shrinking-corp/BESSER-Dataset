...
SimplePDL_ProcessElement = Class(name="SimplePDL_ProcessElement")
...
SimplePDL_ResourceType = Class(name="SimplePDL_ResourceType")
...
SimplePDL_Process.attributes={SimplePDL_Process_maxTime, SimplePDL_Process_minTime, SimplePDL_Process_name}
...
SimplePDL_WorkDefinition.attributes={SimplePDL_WorkDefinition_minTime, SimplePDL_WorkDefinition_name, SimplePDL_WorkDefinition_maxTime}
...
domain_model = DomainModel(
    name="SimplePDL",
    types={SimplePDL_Process, SimplePDL_ProcessElement, SimplePDL_Guidance, SimplePDL_WorkDefinition, ProcessElement, SimplePDL_WorkSequence, SimplePDL_Resource, SimplePDL_ResourceType, WorkSequenceType},
    associations={child7, processElements0, guidanceGFX1, linksToPredecessors3, linksToSuccessors4, neededResources6, predecessor8, successor9, guides11, parent14, workDefinition16, type18},
    generalizations={gen_SimplePDL_WorkSequence_ProcessElement, gen_SimplePDL_WorkDefinition_ProcessElement, gen_SimplePDL_ResourceType_ProcessElement, gen_SimplePDL_Resource_ProcessElement},
    metadata=None
)
