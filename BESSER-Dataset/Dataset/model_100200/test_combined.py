...
def test_hyp_model_expression_expression_is_not_abstract():
    assert not inspect.isabstract(model_expression_Expression)


def test_hyp_model_expression_expression_constructor_exists():
    assert callable(model_expression_Expression.__init__)


def test_hyp_model_expression_expression_constructor_args():
    sig = inspect.signature(model_expression_Expression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trigger_model_database_is_not_abstract():
    assert not inspect.isabstract(trigger_model_Database)


def test_hyp_trigger_model_database_constructor_exists():
    assert callable(trigger_model_Database.__init__)


def test_hyp_trigger_model_database_constructor_args():
    sig = inspect.signature(trigger_model_Database.__init__)
    params = list(sig.parameters.keys())



def test_hyp_index_model_database_is_not_abstract():
    assert not inspect.isabstract(index_model_Database)


def test_hyp_index_model_database_constructor_exists():
    assert callable(index_model_Database.__init__)


def test_hyp_index_model_database_constructor_args():
    sig = inspect.signature(index_model_Database.__init__)
    params = list(sig.parameters.keys())



def test_hyp_model_index_index_is_not_abstract():
    assert not inspect.isabstract(model_index_Index)


def test_hyp_model_index_index_constructor_exists():
    assert callable(model_index_Index.__init__)


def test_hyp_model_index_index_constructor_args():
    sig = inspect.signature(model_index_Index.__init__)
    params = list(sig.parameters.keys())



def test_hyp_view_model_database_is_not_abstract():
    assert not inspect.isabstract(view_model_Database)


def test_hyp_view_model_database_constructor_exists():
    assert callable(view_model_Database.__init__)


def test_hyp_view_model_database_constructor_args():
    sig = inspect.signature(view_model_Database.__init__)
    params = list(sig.parameters.keys())



def test_hyp_model_column_defaultexpressionvaluecolumnconstraint_is_not_abstract():
    assert not inspect.isabstract(model_column_DefaultExpressionValueColumnConstraint)


def test_hyp_model_column_defaultexpressionvaluecolumnconstraint_constructor_exists():
    assert callable(model_column_DefaultExpressionValueColumnConstraint.__init__)


def test_hyp_model_column_defaultexpressionvaluecolumnconstraint_constructor_args():
    sig = inspect.signature(model_column_DefaultExpressionValueColumnConstraint.__init__)
    params = list(sig.parameters.keys())



def test_hyp_model_column_defaultrealvaluecolumnconstraint_is_not_abstract():
    assert not inspect.isabstract(model_column_DefaultRealValueColumnConstraint)


def test_hyp_model_column_defaultrealvaluecolumnconstraint_constructor_exists():
    assert callable(model_column_DefaultRealValueColumnConstraint.__init__)


def test_hyp_model_column_defaultrealvaluecolumnconstraint_constructor_args():
    sig = inspect.signature(model_column_DefaultRealValueColumnConstraint.__init__)
    params = list(sig.parameters.keys())



def test_hyp_model_column_defaultintegervaluecolumnconstraint_is_not_abstract():
    assert not inspect.isabstract(model_column_DefaultIntegerValueColumnConstraint)


def test_hyp_model_column_defaultintegervaluecolumnconstraint_constructor_exists():
    assert callable(model_column_DefaultIntegerValueColumnConstraint.__init__)


def test_hyp_model_column_defaultintegervaluecolumnconstraint_constructor_args():
    sig = inspect.signature(model_column_DefaultIntegerValueColumnConstraint.__init__)
    params = list(sig.parameters.keys())



def test_hyp_model_column_defaultstringvaluecolumnconstraint_is_not_abstract():
    assert not inspect.isabstract(model_column_DefaultStringValueColumnConstraint)


def test_hyp_model_column_defaultstringvaluecolumnconstraint_constructor_exists():
    assert callable(model_column_DefaultStringValueColumnConstraint.__init__)


def test_hyp_model_column_defaultstringvaluecolumnconstraint_constructor_args():
    sig = inspect.signature(model_column_DefaultStringValueColumnConstraint.__init__)
    params = list(sig.parameters.keys())



def test_hyp_model_column_columnconstraint_is_not_abstract():
    assert not inspect.isabstract(model_column_ColumnConstraint)


def test_hyp_model_column_columnconstraint_constructor_exists():
    assert callable(model_column_ColumnConstraint.__init__)


def test_hyp_model_column_columnconstraint_constructor_args():
...
def test_hyp_model_column_indexedcolumn_is_not_abstract():
    assert not inspect.isabstract(model_column_IndexedColumn)


def test_hyp_model_column_indexedcolumn_constructor_exists():
    assert callable(model_column_IndexedColumn.__init__)


def test_hyp_model_column_indexedcolumn_constructor_args():
...
def test_hyp_model_column_uniquecolumnconstraint_is_not_abstract():
    assert not inspect.isabstract(model_column_UniqueColumnConstraint)


def test_hyp_model_column_uniquecolumnconstraint_constructor_exists():
    assert callable(model_column_UniqueColumnConstraint.__init__)


def test_hyp_model_column_uniquecolumnconstraint_constructor_args():
    sig = inspect.signature(model_column_UniqueColumnConstraint.__init__)
    params = list(sig.parameters.keys())



def test_hyp_model_column_primarykeycolumnconstraint_is_not_abstract():
    assert not inspect.isabstract(model_column_PrimaryKeyColumnConstraint)


def test_hyp_model_column_primarykeycolumnconstraint_constructor_exists():
    assert callable(model_column_PrimaryKeyColumnConstraint.__init__)


def test_hyp_model_column_primarykeycolumnconstraint_constructor_args():
    sig = inspect.signature(model_column_PrimaryKeyColumnConstraint.__init__)
    params = list(sig.parameters.keys())



def test_hyp_model_column_notnullcolumnconstraint_is_not_abstract():
    assert not inspect.isabstract(model_column_NotNullColumnConstraint)


def test_hyp_model_column_notnullcolumnconstraint_constructor_exists():
    assert callable(model_column_NotNullColumnConstraint.__init__)


def test_hyp_model_column_notnullcolumnconstraint_constructor_args():
    sig = inspect.signature(model_column_NotNullColumnConstraint.__init__)
    params = list(sig.parameters.keys())



def test_hyp_model_column_defaultvaluecolumnconstraint_is_not_abstract():
    assert not inspect.isabstract(model_column_DefaultValueColumnConstraint)


def test_hyp_model_column_defaultvaluecolumnconstraint_constructor_exists():
    assert callable(model_column_DefaultValueColumnConstraint.__init__)


def test_hyp_model_column_defaultvaluecolumnconstraint_constructor_args():
    sig = inspect.signature(model_column_DefaultValueColumnConstraint.__init__)
    params = list(sig.parameters.keys())



def test_hyp_model_column_checkcolumnconstraint_is_not_abstract():
    assert not inspect.isabstract(model_column_CheckColumnConstraint)


def test_hyp_model_column_checkcolumnconstraint_constructor_exists():
    assert callable(model_column_CheckColumnConstraint.__init__)


def test_hyp_model_column_checkcolumnconstraint_constructor_args():
    sig = inspect.signature(model_column_CheckColumnConstraint.__init__)
    params = list(sig.parameters.keys())



def test_hyp_model_column_foreignkeycolumnconstraint_is_not_abstract():
    assert not inspect.isabstract(model_column_ForeignKeyColumnConstraint)


def test_hyp_model_column_foreignkeycolumnconstraint_constructor_exists():
    assert callable(model_column_ForeignKeyColumnConstraint.__init__)


def test_hyp_model_column_foreignkeycolumnconstraint_constructor_args():
...
def test_hyp_model_table_tableconstraint_is_not_abstract():
    assert not inspect.isabstract(model_table_TableConstraint)


def test_hyp_model_table_tableconstraint_constructor_exists():
    assert callable(model_table_TableConstraint.__init__)


def test_hyp_model_table_tableconstraint_constructor_args():
...
def test_hyp_model_table_uniquetableconstraint_is_not_abstract():
    assert not inspect.isabstract(model_table_UniqueTableConstraint)


def test_hyp_model_table_uniquetableconstraint_constructor_exists():
    assert callable(model_table_UniqueTableConstraint.__init__)


def test_hyp_model_table_uniquetableconstraint_constructor_args():
    sig = inspect.signature(model_table_UniqueTableConstraint.__init__)
    params = list(sig.parameters.keys())



def test_hyp_model_table_foreignkeytableconstraint_is_not_abstract():
    assert not inspect.isabstract(model_table_ForeignKeyTableConstraint)


def test_hyp_model_table_foreignkeytableconstraint_constructor_exists():
    assert callable(model_table_ForeignKeyTableConstraint.__init__)


def test_hyp_model_table_foreignkeytableconstraint_constructor_args():
    sig = inspect.signature(model_table_ForeignKeyTableConstraint.__init__)
    params = list(sig.parameters.keys())



def test_hyp_model_table_checktableconstraint_is_not_abstract():
    assert not inspect.isabstract(model_table_CheckTableConstraint)


def test_hyp_model_table_checktableconstraint_constructor_exists():
    assert callable(model_table_CheckTableConstraint.__init__)


def test_hyp_model_table_checktableconstraint_constructor_args():
    sig = inspect.signature(model_table_CheckTableConstraint.__init__)
    params = list(sig.parameters.keys())



def test_hyp_model_table_primarykeytableconstraint_is_not_abstract():
    assert not inspect.isabstract(model_table_PrimaryKeyTableConstraint)


def test_hyp_model_table_primarykeytableconstraint_constructor_exists():
    assert callable(model_table_PrimaryKeyTableConstraint.__init__)


def test_hyp_model_table_primarykeytableconstraint_constructor_args():
...
def test_hyp_table_model_database_is_not_abstract():
    assert not inspect.isabstract(table_model_Database)


def test_hyp_table_model_database_constructor_exists():
    assert callable(table_model_Database.__init__)


def test_hyp_table_model_database_constructor_args():
    sig = inspect.signature(table_model_Database.__init__)
    params = list(sig.parameters.keys())



def test_hyp_stringtocolumnmappingentrymap_is_not_abstract():
    assert not inspect.isabstract(StringToColumnMappingEntryMap)


def test_hyp_stringtocolumnmappingentrymap_constructor_exists():
    assert callable(StringToColumnMappingEntryMap.__init__)


def test_hyp_stringtocolumnmappingentrymap_constructor_args():
    sig = inspect.signature(StringToColumnMappingEntryMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_model_common_columnmapping_is_not_abstract():
    assert not inspect.isabstract(model_common_ColumnMapping)


def test_hyp_model_common_columnmapping_constructor_exists():
    assert callable(model_common_ColumnMapping.__init__)


def test_hyp_model_common_columnmapping_constructor_args():
    sig = inspect.signature(model_common_ColumnMapping.__init__)
    params = list(sig.parameters.keys())



def test_hyp_stringtotablemappingentrymap_is_not_abstract():
    assert not inspect.isabstract(StringToTableMappingEntryMap)


def test_hyp_stringtotablemappingentrymap_constructor_exists():
    assert callable(StringToTableMappingEntryMap.__init__)


def test_hyp_stringtotablemappingentrymap_constructor_args():
    sig = inspect.signature(StringToTableMappingEntryMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_model_common_tablemapping_is_not_abstract():
    assert not inspect.isabstract(model_common_TableMapping)


def test_hyp_model_common_tablemapping_constructor_exists():
    assert callable(model_common_TableMapping.__init__)


def test_hyp_model_common_tablemapping_constructor_args():
    sig = inspect.signature(model_common_TableMapping.__init__)
    params = list(sig.parameters.keys())



def test_hyp_model_common_stringtocolumnmappingentrymap_is_not_abstract():
    assert not inspect.isabstract(model_common_StringToColumnMappingEntryMap)


def test_hyp_model_common_stringtocolumnmappingentrymap_constructor_exists():
    assert callable(model_common_StringToColumnMappingEntryMap.__init__)


def test_hyp_model_common_stringtocolumnmappingentrymap_constructor_args():
...
def test_hyp_model_common_stringtotablemappingentrymap_is_not_abstract():
    assert not inspect.isabstract(model_common_StringToTableMappingEntryMap)


def test_hyp_model_common_stringtotablemappingentrymap_constructor_exists():
    assert callable(model_common_StringToTableMappingEntryMap.__init__)


def test_hyp_model_common_stringtotablemappingentrymap_constructor_args():
...
def test_hyp_model_common_mappingentry_is_not_abstract():
    assert not inspect.isabstract(model_common_MappingEntry)


def test_hyp_model_common_mappingentry_constructor_exists():
    assert callable(model_common_MappingEntry.__init__)


def test_hyp_model_common_mappingentry_constructor_args():
...
def test_hyp_model_common_nameprovider_is_not_abstract():
    assert not inspect.isabstract(model_common_NameProvider)


def test_hyp_model_common_nameprovider_constructor_exists():
    assert callable(model_common_NameProvider.__init__)


def test_hyp_model_common_nameprovider_constructor_args():
...
def test_hyp_nameprovider_is_not_abstract():
    assert not inspect.isabstract(NameProvider)


def test_hyp_nameprovider_constructor_exists():
    assert callable(NameProvider.__init__)


def test_hyp_nameprovider_constructor_args():
    sig = inspect.signature(NameProvider.__init__)
    params = list(sig.parameters.keys())



def test_hyp_model_trigger_trigger_is_not_abstract():
    assert not inspect.isabstract(model_trigger_Trigger)


def test_hyp_model_trigger_trigger_constructor_exists():
    assert callable(model_trigger_Trigger.__init__)


def test_hyp_model_trigger_trigger_constructor_args():
    sig = inspect.signature(model_trigger_Trigger.__init__)
    params = list(sig.parameters.keys())



def test_hyp_model_column_column_is_not_abstract():
    assert not inspect.isabstract(model_column_Column)


def test_hyp_model_column_column_constructor_exists():
    assert callable(model_column_Column.__init__)


def test_hyp_model_column_column_constructor_args():
...
def test_hyp_model_table_table_is_not_abstract():
    assert not inspect.isabstract(model_table_Table)


def test_hyp_model_table_table_constructor_exists():
    assert callable(model_table_Table.__init__)


def test_hyp_model_table_table_constructor_args():
    sig = inspect.signature(model_table_Table.__init__)
    params = list(sig.parameters.keys())



def test_hyp_model_view_view_is_not_abstract():
    assert not inspect.isabstract(model_view_View)


def test_hyp_model_view_view_constructor_exists():
    assert callable(model_view_View.__init__)


def test_hyp_model_view_view_constructor_args():
...
def test_hyp_model_databaseversions_is_not_abstract():
    assert not inspect.isabstract(model_DatabaseVersions)


def test_hyp_model_databaseversions_constructor_exists():
    assert callable(model_DatabaseVersions.__init__)


def test_hyp_model_databaseversions_constructor_args():
...
def test_hyp_model_databaseversion_is_not_abstract():
    assert not inspect.isabstract(model_DatabaseVersion)


def test_hyp_model_databaseversion_constructor_exists():
    assert callable(model_DatabaseVersion.__init__)


def test_hyp_model_databaseversion_constructor_args():
...
def test_hyp_model_column_columnconstraint_name_setter(instance):
...
def test_hyp_model_table_tableconstraint_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_model_common_columnmapping_put_changes_state(instance):
...
@given(instance=model_common_ColumnMapping_strategy)
@settings(max_examples=30)
def test_hyp_model_common_columnmapping_entries_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
        instance.entries()
...
@settings(max_examples=30)
def test_hyp_model_common_tablemapping_put_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
        instance.put(
...
@given(instance=model_common_TableMapping_strategy)
@settings(max_examples=30)
def test_hyp_model_common_tablemapping_entries_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
        instance.entries()
...
def test_hyp_model_common_stringtocolumnmappingentrymap_key_setter(instance):
...
def test_hyp_model_common_stringtotablemappingentrymap_key_setter(instance):
    original = instance.key
    instance.key = original
    assert instance.key == original
...
def test_hyp_model_common_mappingentry_previous_setter(instance):
...
@given(instance=model_common_MappingEntry_strategy)
def test_hyp_model_common_mappingentry_current_setter(instance):
...
def test_hyp_model_common_nameprovider_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_model_column_column_type_setter(instance):
...
def test_hyp_model_databaseversions_packageName_setter(instance):
...
@given(instance=model_DatabaseVersions_strategy)
def test_hyp_model_databaseversions_fileName_setter(instance):
...
@given(instance=model_DatabaseVersions_strategy)
@settings(max_examples=30)
def test_hyp_model_databaseversions_createversion_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
...
def test_model_column_ForeignKeyColumnConstraint_isa_ColumnConstraint():
    instance = model_column_ForeignKeyColumnConstraint()
    assert isinstance(instance, ColumnConstraint)
...
model_column_ForeignKeyColumnConstraint_strategy = st.builds(model_column_ForeignKeyColumnConstraint)
