...
# Classes
Data_Type = Class(name="Data_Type", is_abstract=True)
Data_Attribute = Class(name="Data_Attribute")
Data_Entity = Class(name="Data_Entity")
Type = Class(name="Type")
Data_Model = Class(name="Data_Model")
Data_PrimitiveType = Class(name="Data_PrimitiveType")
...
domain_model = DomainModel(
    name="Data",
    types={Data_Type, Data_Attribute, Data_Entity, Type, Data_Model, Data_PrimitiveType},
