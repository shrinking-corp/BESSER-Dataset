...
class fsa_State:
    ...
    def __init__(self, name: str, accepting: bool, fsa_State: "fsa_FSA" = None, fromState: set["fsa_Transition"] = None, toState: set["fsa_Transition"] = None, State: "fsa_Transition" = None, State11: "fsa_Transition" = None, fsa_State5: "fsa_FSA" = None):
        self.name = name
