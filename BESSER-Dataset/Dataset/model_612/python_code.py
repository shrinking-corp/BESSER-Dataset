...
class PHPMVC_extPHP_Button(HTMLElement):
    ...
    def __init__(self, disabled: bool, type: str, content: str, HTMLElement: "PHPMVC_extPHP_HTMLElement" = None):
...
class PHPMVC_extPHP_Image(HTMLElement):
    ...
    def __init__(self, source: str, HTMLElement: "PHPMVC_extPHP_HTMLElement" = None):
        self.source = source
...
class PHPMVC_extPHP_Form(HTMLElement):
    ...
    def __init__(self, action: str, method: str, target: str, HTMLElement: "PHPMVC_extPHP_HTMLElement" = None):
        self.action = action
        self.method = method
        self.target = target
...
class PHPMVC_extPHP_Anchor(HTMLElement):
    ...
    def __init__(self, target: str, hypRef: str, content: str, HTMLElement: "PHPMVC_extPHP_HTMLElement" = None):
        self.target = target
        self.hypRef = hypRef
        self.content = content
...
class PHPMVC_extPHP_Input(HTMLElement):
    ...
    def __init__(self, type: str, value: str, HTMLElement: "PHPMVC_extPHP_HTMLElement" = None):
        self.type = type
        self.value = value
...
class PHPMVC_extPHP_Text(HTMLElement):
    ...
    def __init__(self, language: str, content: str, HTMLElement: "PHPMVC_extPHP_HTMLElement" = None):
...
class PHPMVC_extPHP_HTMLElement(ViewComponent):
    ...
    def __init__(self, tagName: str, isPairedTag: bool, isEmpty: bool, PHPMVC_extPHP_HTMLElement: set["HTMLElement"] = None, ViewComponent: "PHPMVC_coreMVC_View" = None):
...
class PHPMVC_coreMVC_Identifier(Attribute):
    ...
    def __init__(self, isAutoincremental: bool, Attribute: "PHPMVC_coreMVC_MVCClass" = None, Attribute19: "PHPMVC_coreMVC_Method" = None, Attribute16: "PHPMVC_coreMVC_Method" = None):
        self.isAutoincremental = isAutoincremental
        
        pass
    @property
    def isAutoincremental(self):
