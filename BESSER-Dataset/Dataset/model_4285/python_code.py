...
class pokerleague_Competition(DescribedEntity):
    ...
    def __init__(self, defaultTournamentAnnouncementLead: int, startDate: date, endDate: date, minimalAttendance: int, defaultBuyIn: int, defaultMinPlayers: int, defaultMaxPlayers: int, competition: set["pokerleague_Tournament"] = None, pokerleague_Competition8: set["pokerleague_Player"] = None, Competition: "pokerleague_Tournament" = None, pokerleague_Competition: "pokerleague_PrizeMoneyRuleSet" = None):
