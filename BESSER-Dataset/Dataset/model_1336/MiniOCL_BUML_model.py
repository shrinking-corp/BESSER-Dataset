...
domain_model = DomainModel(
    name="miniOCL",
    types={miniOCL_RootCS, miniOCL_PackageCS, miniOCL_ConstraintCS, miniOCL_ClassCS, miniOCL_ParameterCS, miniOCL_ExpCS, miniOCL_InvariantCS, miniOCL_LogicExpCS, ExpCS, miniOCL_CallExpCS, LogicExpCS, miniOCL_NameExpCS, miniOCL_PrimaryExpCS, CallExpCS, PrimaryExpCS, miniOCL_PathNameCS, miniOCL_PropertyCS, miniOCL_OperationCS, miniOCL_LiteralExpCS, miniOCL_IntLiteralExpCS, LiteralExpCS, miniOCL_StringLiteralExpCS, miniOCL_BooleanLiteralExpCS, miniOCL_PathElementCS, miniOCL_RoundedBracketClauseCS, miniOCL_BooleanExpCS, BooleanLiteralExpCS},
    associations={packages0, contraints1, packages4, classes6, typeRef14, params17, resultRef19, body22, typeRef24, typeRef27, invariants30, exp32, left36, right37, source40, nameExp42, extends8, properties10, operations12, args52, expName44, roundedBrackets47, callExp49, path55},
    generalizations={gen_miniOCL_LogicExpCS_ExpCS, gen_miniOCL_CallExpCS_LogicExpCS, gen_miniOCL_PrimaryExpCS_CallExpCS, gen_miniOCL_NameExpCS_PrimaryExpCS, gen_miniOCL_LiteralExpCS_PrimaryExpCS, gen_miniOCL_IntLiteralExpCS_LiteralExpCS, gen_miniOCL_StringLiteralExpCS_LiteralExpCS, gen_miniOCL_BooleanLiteralExpCS_LiteralExpCS, gen_miniOCL_BooleanExpCS_BooleanLiteralExpCS},
    metadata=None
)
