...
class miniOCL_OperationCS:
    ...
    def __init__(self, name: str, miniOCL_OperationCS18: set["miniOCL_ParameterCS"] = None, miniOCL_OperationCS20: "miniOCL_PathNameCS" = None, miniOCL_OperationCS23: "miniOCL_ExpCS" = None, miniOCL_OperationCS: "miniOCL_ClassCS" = None):
        self.name = name
...
class miniOCL_PropertyCS:
    ...
    def __init__(self, name: str, miniOCL_PropertyCS15: "miniOCL_PathNameCS" = None, miniOCL_PropertyCS: "miniOCL_ClassCS" = None):
        self.name = name
