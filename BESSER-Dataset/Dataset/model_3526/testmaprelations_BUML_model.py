...
# Classes
testmaprelations_MapCA1ToCB1MapEntry = Class(name="testmaprelations_MapCA1ToCB1MapEntry")
testmaprelations_CA1 = Class(name="testmaprelations_CA1")
testmaprelations_CB1 = Class(name="testmaprelations_CB1")
testmaprelations_CA2 = Class(name="testmaprelations_CA2")
testmaprelations_MapCA2ToCB2MapEntry = Class(name="testmaprelations_MapCA2ToCB2MapEntry")
testmaprelations_CB2 = Class(name="testmaprelations_CB2")
testmaprelations_MapCA0ToCB0MapEntry = Class(name="testmaprelations_MapCA0ToCB0MapEntry")
testmaprelations_CA0 = Class(name="testmaprelations_CA0")
testmaprelations_CB0 = Class(name="testmaprelations_CB0")
testmaprelations_CA5 = Class(name="testmaprelations_CA5")
testmaprelations_MapCA5ToCB5MapEntry = Class(name="testmaprelations_MapCA5ToCB5MapEntry")
testmaprelations_CB5 = Class(name="testmaprelations_CB5")
testmaprelations_MapCA6ToCB6MapEntry = Class(name="testmaprelations_MapCA6ToCB6MapEntry")
testmaprelations_CA6 = Class(name="testmaprelations_CA6")
testmaprelations_CB6 = Class(name="testmaprelations_CB6")
testmaprelations_CA7 = Class(name="testmaprelations_CA7")
testmaprelations_MapCA7ToCB7MapEntry = Class(name="testmaprelations_MapCA7ToCB7MapEntry")
testmaprelations_CB7 = Class(name="testmaprelations_CB7")
testmaprelations_CB3 = Class(name="testmaprelations_CB3")
testmaprelations_MapCA3ToCB3MapEntry = Class(name="testmaprelations_MapCA3ToCB3MapEntry")
testmaprelations_CA3 = Class(name="testmaprelations_CA3")
testmaprelations_CA4 = Class(name="testmaprelations_CA4")
testmaprelations_MapCA4ToCB4MapEntry = Class(name="testmaprelations_MapCA4ToCB4MapEntry")
testmaprelations_CB4 = Class(name="testmaprelations_CB4")
testmaprelations_CA8 = Class(name="testmaprelations_CA8")
testmaprelations_MapCA8ToCB8MapEntry = Class(name="testmaprelations_MapCA8ToCB8MapEntry")
testmaprelations_CB8 = Class(name="testmaprelations_CB8")
testmaprelations_MapCA9ToCB9MapEntry = Class(name="testmaprelations_MapCA9ToCB9MapEntry")
testmaprelations_CA9 = Class(name="testmaprelations_CA9")
testmaprelations_CB9 = Class(name="testmaprelations_CB9")
...
domain_model = DomainModel(
    ...
    types={testmaprelations_MapCA1ToCB1MapEntry, testmaprelations_CA1, testmaprelations_CB1, testmaprelations_CA2, testmaprelations_MapCA2ToCB2MapEntry, testmaprelations_CB2, testmaprelations_MapCA0ToCB0MapEntry, testmaprelations_CA0, testmaprelations_CB0, testmaprelations_CA5, testmaprelations_MapCA5ToCB5MapEntry, testmaprelations_CB5, testmaprelations_MapCA6ToCB6MapEntry, testmaprelations_CA6, testmaprelations_CB6, testmaprelations_CA7, testmaprelations_MapCA7ToCB7MapEntry, testmaprelations_CB7, testmaprelations_CB3, testmaprelations_MapCA3ToCB3MapEntry, testmaprelations_CA3, testmaprelations_CA4, testmaprelations_MapCA4ToCB4MapEntry, testmaprelations_CB4, testmaprelations_CA8, testmaprelations_MapCA8ToCB8MapEntry, testmaprelations_CB8, testmaprelations_MapCA9ToCB9MapEntry, testmaprelations_CA9, testmaprelations_CB9},
    associations={mapca0tocb0mapentry3, mapca0tocb0mapentry4, key6, value8, mapca0tocb0mapentry10, mapca0tocb0mapentry12, mapca0tocb0mapentry15, mapca0tocb0mapentry17, key0, value1, mapca0tocb0mapentry42, mapca0tocb0mapentry44, key47, value49, key51, value52, key54, value55, key20, value22, mapca0tocb0mapentry24, mapca0tocb0mapentry26, key29, value31, mapca0tocb0mapentry33, key35, value37, mapca0tocb0mapentry39, key57, value58, key60, value61},
    generalizations={},
    metadata=None
)
