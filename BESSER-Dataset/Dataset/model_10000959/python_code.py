...
class Function:
    ...
    def __init__(self, removedCard: int, Score: int, players28: "Players" = None, playerCPU10: "PlayerCPU_external" = None, playerUser12: "PlayerUser_external" = None, card14: "Card_Interface" = None, deck17: "Deck" = None):
...
class Deck:
    ...
    def __init__(self, topcard: int, draw__: str, shuffle__: str, deck__: Deck, isEmpty__: bool, wAR0: "WAR" = None, card2: "Card_Interface" = None, function16: "Function" = None):
...
class PlayerUser_external:

    pass


class PlayerCPU_external:
