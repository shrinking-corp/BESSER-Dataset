...
def test_playeruser_external_is_not_abstract():
    assert not inspect.isabstract(PlayerUser_external)


def test_playeruser_external_constructor_exists():
    assert callable(PlayerUser_external.__init__)


def test_playeruser_external_constructor_args():
    sig = inspect.signature(PlayerUser_external.__init__)
    params = list(sig.parameters.keys())



def test_playercpu_external_is_not_abstract():
    assert not inspect.isabstract(PlayerCPU_external)


def test_playercpu_external_constructor_exists():
    assert callable(PlayerCPU_external.__init__)


def test_playercpu_external_constructor_args():
