...
class ER_Key:
    ...
    def __init__(self, name: str, hasKey: "ER_Table" = None, Key: "ER_Table" = None, ER_Key32: "ER_ForeignKey" = None, ER_Key: set["ER_Column"] = None, ER_Key14: set["ER_ForeignKey"] = None, ER_Key19: "ER_Column" = None):
        self.name = name
        self.hasKey = hasKey
        self.Key = Key
...
class ER_Column:
    ...
    def __init__(self, name: str, type: str, Column: "ER_Table" = None, Column29: "ER_ForeignKey" = None, ER_Column: "ER_Key" = None, column: "ER_Table" = None, ER_Column18: set["ER_Key"] = None, column21: set["ER_ForeignKey"] = None):
        self.name = name
        self.type = type
        self.Column = Column
...
class ER_ForeignKey:
    ...
    def __init__(self, name: str, ForeignKey: "ER_Schema" = None, ForeignKey9: "ER_Table" = None, hasForeignKey: "ER_Table" = None, hasForeignKey28: set["ER_Column"] = None, ER_ForeignKey31: set["ER_Key"] = None, ER_ForeignKey: "ER_Key" = None, ForeignKey22: "ER_Column" = None, foreignKey: "ER_Schema" = None):
        self.name = name
...
class ER_Table:
    ...
    def __init__(self, name: str, table: "ER_Schema" = None, owner6: set["ER_Column"] = None, owner8: set["ER_ForeignKey"] = None, Table11: "ER_Key" = None, owner: "ER_Key" = None, Table26: "ER_ForeignKey" = None, Table16: "ER_Column" = None, Table: "ER_Schema" = None):
        self.name = name
        self.table = table
...
class ER_Schema:
    ...
    def __init__(self, name: str, schema2: set["ER_ForeignKey"] = None, Schema: "ER_Table" = None, Schema24: "ER_ForeignKey" = None, schema: set["ER_Table"] = None):
        self.name = name
