...
# Classes
ER_Schema = Class(name="ER_Schema")
ER_Table = Class(name="ER_Table")
ER_ForeignKey = Class(name="ER_ForeignKey")
ER_Column = Class(name="ER_Column")
ER_Key = Class(name="ER_Key")
...
domain_model = DomainModel(
    name="ER",
    types={ER_Schema, ER_Table, ER_ForeignKey, ER_Column, ER_Key},
    associations={table0, foreignKey1, schema3, column5, hasForeignKey7, owner10, hasKey4, owner25, column27, refersTo30, column12, referedBy13, owner15, hasKey17, hasForeignKey20, schema23},
    generalizations={},
    metadata=None
)
