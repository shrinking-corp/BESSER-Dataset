...
class forms_Condition(ABC):
    ...
    def __init__(self, type: str, conditionID: str, forms_Condition33: "forms_CompositeCondition" = None, forms_Condition28: "forms_PageElement" = None, forms_Condition: "forms_Page" = None):
        self.type = type
...
class forms_PageElement(ABC):
    ...
    def __init__(self, label: str, elementID: str, forms_PageElement27: "forms_Condition" = None, forms_PageElement: "forms_Page" = None):
        self.label = label
...
class forms_Page:
    ...
    def __init__(self, title: str, forms_Page25: "forms_Condition" = None, forms_Page: "forms_Form" = None, forms_Page23: set["forms_PageElement"] = None):
        self.title = title
...
class forms_Relationship(Feature):
    ...
    def __init__(self, upperBound: int, lowerBound: int, forms_Relationship37: "forms_RelationshipPageElement" = None, forms_Relationship: "forms_Entity" = None, forms_Relationship12: "forms_Relationship" = None, forms_Relationship10: "forms_Relationship" = None):
...
class forms_Attribute(Feature):
    ...
    def __init__(self, type: str, mandatory: bool, forms_Attribute35: "forms_AttributePageElement" = None, forms_Attribute: "forms_Entity" = None, forms_Attribute7: "forms_Enumeration" = None, forms_Attribute31: "forms_AttributeValueCondition" = None):
        self.type = type
