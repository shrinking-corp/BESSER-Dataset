...
forms_Feature = Class(name="forms_Feature", is_abstract=True)
forms_EntityModel = Class(name="forms_EntityModel")
forms_EntityModelElement = Class(name="forms_EntityModelElement", is_abstract=True)
forms_NamedElement = Class(name="forms_NamedElement", is_abstract=True)
...
forms_Form.attributes={forms_Form_welcomeForm, forms_Form_description, forms_Form_title}
...
domain_model = DomainModel(
    name="forms",
    types={forms_Attribute, Feature, forms_Enumeration, forms_Entity, EntityModelElement, NamedElement, forms_Feature, forms_EntityModel, forms_EntityModelElement, forms_NamedElement, forms_FormModel, forms_Form, forms_Relationship, forms_Literal, forms_TextField, AttributePageElement, forms_TextArea, forms_SelectionField, forms_List, forms_Page, forms_PageElement, forms_Condition, forms_AttributePageElement, PageElement, forms_RelationshipPageElement, RelationshipPageElement, forms_Table, forms_Column, forms_AttributeValueCondition, Condition, forms_CompositeCondition, forms_DateSelectionField, forms_TimeSelectionField, AttributeType, CompositeConditionType, ConditionType},
    associations={id1, superType4, enumeration6, features0, entityModelElements15, forms16, target8, opposite11, literals13, condition26, entity17, pages20, pageElements22, condition24, composedConditions32, attribute34, relationship36, columns29, attribute30, editingForm38},
    generalizations={gen_forms_Attribute_Feature, gen_forms_Entity_EntityModelElement, gen_forms_Entity_NamedElement, gen_forms_Literal_NamedElement, gen_forms_Form_NamedElement, gen_forms_Relationship_Feature, gen_forms_Enumeration_EntityModelElement, gen_forms_Enumeration_NamedElement, gen_forms_TextField_AttributePageElement, gen_forms_TextArea_AttributePageElement, gen_forms_SelectionField_AttributePageElement, gen_forms_Feature_NamedElement, gen_forms_AttributePageElement_PageElement, gen_forms_RelationshipPageElement_PageElement, gen_forms_List_RelationshipPageElement, gen_forms_Table_RelationshipPageElement, gen_forms_Column_AttributePageElement, gen_forms_AttributeValueCondition_Condition, gen_forms_CompositeCondition_Condition, gen_forms_DateSelectionField_AttributePageElement, gen_forms_TimeSelectionField_AttributePageElement},
    metadata=None
)
