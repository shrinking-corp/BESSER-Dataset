...
else_37: BinaryAssociation = BinaryAssociation(
    name="else_37",
    ends={
...
domain_model = DomainModel(
    name="simplejava",
    types={simplejava_SimpleJava, simplejava_PackageDeclaration, simplejava_Import, simplejava_ClassDeclaration, simplejava_Parameter, simplejava_Method, simplejava_Type, simplejava_MethodBlock, Statement, simplejava_Statement, simplejava_SimpleStatement, simplejava_SimpleVariableDeclaration, SimpleStatement, simplejava_VariableDeclaration, SimpleVariableDeclaration, simplejava_GenericExpression, simplejava_Assignment, simplejava_IfStatement, simplejava_ReturnStatement, simplejava_MethodCall, GenericExpression, simplejava_ConstantExpression, simplejava_NullExpression, ConstantExpression, simplejava_IntegerExpression, simplejava_BooleanExpression, simplejava_StringExpression, simplejava_UnaryExpression, simplejava_ParanthesisOrBinaryExpression, simplejava_ForStatement, simplejava_ForInStatement, simplejava_WhileStatement, simplejava_VariableExpression},
    associations={package0, imports1, clazz3, attribute5, method7, type9, typeRef11, returnType14, parameter17, content20, statements22, parameter24, expression26, parameter28, expression30, body60, expression63, object65, method67, parameter70, source73, condition33, then34, else_37, init40, condition41, continuation44, body47, subparameter50, expression52, body55, condition58, variable75, source77, argument80},
    generalizations={gen_simplejava_MethodBlock_Statement, gen_simplejava_SimpleVariableDeclaration_SimpleStatement, gen_simplejava_VariableDeclaration_Statement, gen_simplejava_VariableDeclaration_SimpleVariableDeclaration, gen_simplejava_Assignment_SimpleStatement, gen_simplejava_Assignment_Statement, gen_simplejava_IfStatement_Statement, gen_simplejava_ReturnStatement_Statement, gen_simplejava_MethodCall_Statement, gen_simplejava_MethodCall_GenericExpression, gen_simplejava_ConstantExpression_GenericExpression, gen_simplejava_NullExpression_ConstantExpression, gen_simplejava_IntegerExpression_ConstantExpression, gen_simplejava_BooleanExpression_ConstantExpression, gen_simplejava_StringExpression_ConstantExpression, gen_simplejava_UnaryExpression_GenericExpression, gen_simplejava_ForStatement_Statement, gen_simplejava_ForInStatement_Statement, gen_simplejava_WhileStatement_Statement, gen_simplejava_VariableExpression_GenericExpression, gen_simplejava_ParanthesisOrBinaryExpression_GenericExpression},
    metadata=None
)
