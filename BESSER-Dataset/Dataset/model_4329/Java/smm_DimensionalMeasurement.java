...
public class smm_DimensionalMeasurement extends Measurement {
    ...
    public smm_DimensionalMeasurement(
        float value        ArrayList<smm_GradeMeasurementRelationship> smm_grademeasurementrelationships,        ArrayList<smm_Base1MeasurementRelationship> smm_base1measurementrelationships,        ArrayList<smm_BaseNMeasurementRelationship> smm_basenmeasurementrelationships,        ArrayList<smm_Base2MeasurementRelationship> smm_base2measurementrelationships,        ArrayList<smm_RankingMeasurementRelationship> smm_rankingmeasurementrelationships    ) {
        this.value = value;
