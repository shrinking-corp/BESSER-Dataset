...
public class smm_DimensionalMeasure extends Measure {
    ...
    public smm_DimensionalMeasure(
        String formula        ArrayList<smm_Base1MeasureRelationship> smm_base1measurerelationships,        ArrayList<smm_Base2MeasureRelationship> smm_base2measurerelationships,        ArrayList<smm_BaseNMeasureRelationship> smm_basenmeasurerelationships,        ArrayList<smm_GradeMeasureRelationship> smm_grademeasurerelationships,        ArrayList<smm_RankingMeasureRelationship> smm_rankingmeasurerelationships    ) {
        this.formula = formula;
