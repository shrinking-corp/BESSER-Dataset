...
def test_hyp_cascadenotall_library_is_not_abstract():
    assert not inspect.isabstract(cascadenotall_Library)


def test_hyp_cascadenotall_library_constructor_exists():
    assert callable(cascadenotall_Library.__init__)


def test_hyp_cascadenotall_library_constructor_args():
...
def test_hyp_cascadenotall_book_is_not_abstract():
    assert not inspect.isabstract(cascadenotall_Book)


def test_hyp_cascadenotall_book_constructor_exists():
    assert callable(cascadenotall_Book.__init__)


def test_hyp_cascadenotall_book_constructor_args():
...
def test_hyp_cascadenotall_writer_is_not_abstract():
    assert not inspect.isabstract(cascadenotall_Writer)


def test_hyp_cascadenotall_writer_constructor_exists():
    assert callable(cascadenotall_Writer.__init__)


def test_hyp_cascadenotall_writer_constructor_args():
...
def test_hyp_cascadenotall_library_name_setter(instance):
...
def test_hyp_cascadenotall_book_category_setter(instance):
...
@given(instance=cascadenotall_Book_strategy)
def test_hyp_cascadenotall_book_title_setter(instance):
...
@given(instance=cascadenotall_Book_strategy)
def test_hyp_cascadenotall_book_pages_setter(instance):
...
def test_hyp_cascadenotall_writer_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
