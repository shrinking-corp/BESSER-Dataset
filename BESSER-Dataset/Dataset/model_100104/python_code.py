...
class tp5_Paper:
    ...
    def __init__(self, name: str, Paper: "tp5_Researcher" = None, tp5_Paper: set["tp5_Paragraph"] = None, res_papers: set["tp5_Researcher"] = None, tp5_Paper10: "tp5_Paper" = None, tp5_Paper8: "tp5_Paper" = None, tp5_Paper24: "tp5_Collaboration" = None, tp5_Paper15: "tp5_PublicationStructure" = None):
        self.name = name
        self.Paper = Paper
