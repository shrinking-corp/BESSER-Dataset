...
domain_model = DomainModel(
    name="tp5",
    types={tp5_Paper, tp5_Skill, tp5_Position, tp5_Collaboration, tp5_Paragraph, tp5_Researcher, tp5_PublicationStructure},
    associations={res_papers0, skills1, res_position2, collaborations4, paragraphs6, authors7, citedBy9, positions16, parent20, col_paper22, researchers11, papers13},
    generalizations={},
    metadata=None
)
