...
Task.attributes={Task_Task_Detail, Task_Name, Task_Deadline, Task_Task_Name}
...
New_Employee.attributes={New_Employee_Position, New_Employee_Place_of_Birth, New_Employee_Working_Since, New_Employee_Name, New_Employee_Date_of_Birth, New_Employee_Division}
...
Survey.attributes={Survey_Question, Survey_Name, Survey_Score}
...
Performance.attributes={Performance_Target, Performance_Name, Performance_Punctuality, Performance_Coordination}
...
Assessment.attributes={Assessment_Total_Score, Assessment_Name, Assessment_Type_of_Assessment}
...
Assessment__Self_Assessment.attributes={Assessment__Self_Assessment_Question, Assessment__Self_Assessment_Score, Assessment__Self_Assessment_Name}
...
Applicant.attributes={Applicant_Applied_Position, Applicant_Last_Name, Applicant_Email, Applicant_Date_of_Birth, Applicant_First_Name, Applicant_Address, Applicant_Phone, Applicant_Password}
...
Admin.attributes={Admin_qualification, Admin_name, Admin_address}
...
Registration.attributes={Registration_Address, Registration_Date, Registration_Email, Registration_Name, Registration_Position_Type, Registration_Skills___Requirement, Registration_Phone, Registration_Applied_Position}
...
Position.attributes={Position_positionID, Position_jobID, Position_positionName, Position_divisionName}
...
Attendance.attributes={Attendance_Date___Time, Attendance_Details, Attendance_Position, Attendance_Name}
...
Requirement.attributes={Requirement_Photo, Requirement_ID_Card, Requirement_Diploma, Requirement_Transcript, Requirement_Curriculum_Vitae}
...
domain_model = DomainModel(
    name="_62008f1b_0b9f_438d_a2db_5d52557b0d5d",
    types={Task, New_Employee, Survey, Performance, Assessment, Assessment__Self_Assessment, Applicant, Admin, Registration, Position, Login, Attendance, Requirement},
