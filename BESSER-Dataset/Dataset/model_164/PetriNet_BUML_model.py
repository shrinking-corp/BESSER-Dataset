...
domain_model = DomainModel(
    name="PetriNet",
    types={PetriNet_Token, PetriNet_InputArc, PetriNet_OutputArc, PetriNet_Transition, PetriNet_Place, Identifiable, PetriNet_Net},
    associations={token0, inputArc1, outputArc3, inputArc5, outputArc7, place10, transition13, place16, transition19, place22, token24, inputArc27, outputArc30},
    generalizations={gen_PetriNet_Transition_Identifiable, gen_PetriNet_Place_Identifiable, gen_PetriNet_InputArc_Identifiable, gen_PetriNet_OutputArc_Identifiable, gen_PetriNet_Token_Identifiable, gen_PetriNet_Net_Identifiable},
    metadata=None
)
