...
class PetriNet_Place(Identifiable):
    ...
    def __init__(self, name: str, PetriNet_Place: set["PetriNet_Token"] = None, PetriNet_Place2: set["PetriNet_InputArc"] = None, PetriNet_Place4: set["PetriNet_OutputArc"] = None, PetriNet_Place12: "PetriNet_InputArc" = None, PetriNet_Place18: "PetriNet_OutputArc" = None, PetriNet_Place23: "PetriNet_Net" = None):
        self.name = name
