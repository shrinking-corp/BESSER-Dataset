...
public class PetriNet_Transition extends Identifiable {
    ...
    public PetriNet_Transition(
        String name        ArrayList<PetriNet_InputArc> petrinet_inputarcs,        ArrayList<PetriNet_OutputArc> petrinet_outputarcs    ) {
        this.name = name;
