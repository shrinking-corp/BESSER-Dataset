...
# Classes
AddBindingTarget_Type1 = Class(name="AddBindingTarget_Type1")
AddBindingTarget_Type2 = Class(name="AddBindingTarget_Type2")
AddBindingTarget_Type3 = Class(name="AddBindingTarget_Type3")
