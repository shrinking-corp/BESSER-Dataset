...
class Account:
    ...
    def customer0(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Account__customer0", None)
...
class mypackage_Customer:
    ...
    def __init__(self, lastname: str, dateOfBirth: date, address: str, phoneNumber: str, emailAddress: str, name: str, account1: set["Account"] = None, login4: "mypackage_Login" = None):
...
class transaction_Transaction:
    ...
    def __init__(self, id: int, type: transaction_TransactionType, transactionTime: date, amount: float, account3: "Account" = None):
        self.id = id
        self.type = type
