...
root_container_border_node_1_strategy = st.builds(root_container_border_node_1)
...
root_container_border_node_2_strategy = st.builds(root_container_border_node_2)
...
root_container_border_node_3_strategy = st.builds(root_container_border_node_3)
