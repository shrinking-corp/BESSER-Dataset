...
# Classes
statemachine103_StateMachineVariable = Class(name="statemachine103_StateMachineVariable")
statemachine103_StateMachine = Class(name="statemachine103_StateMachine")
statemachine103_StateMachineObject = Class(name="statemachine103_StateMachineObject", is_abstract=True)
statemachine103_NormalState = Class(name="statemachine103_NormalState")
State = Class(name="State")
statemachine103_Transition = Class(name="statemachine103_Transition")
StateMachineObject = Class(name="StateMachineObject")
statemachine103_State = Class(name="statemachine103_State", is_abstract=True)
statemachine103_Action = Class(name="statemachine103_Action")
statemachine103_InitialState = Class(name="statemachine103_InitialState")
statemachine103_FinalState = Class(name="statemachine103_FinalState")
...
statemachine103_StateMachineVariable.attributes={statemachine103_StateMachineVariable_type, statemachine103_StateMachineVariable_name}
...
domain_model = DomainModel(
    ...
    types={statemachine103_StateMachineVariable, statemachine103_StateMachine, statemachine103_StateMachineObject, statemachine103_NormalState, State, statemachine103_Transition, StateMachineObject, statemachine103_State, statemachine103_Action, statemachine103_InitialState, statemachine103_FinalState},
    associations={machineVariables1, machineObjects0, next10, source3, target4, t_actions7, s_actions12},
    generalizations={gen_statemachine103_NormalState_State, gen_statemachine103_Transition_StateMachineObject, gen_statemachine103_State_StateMachineObject, gen_statemachine103_InitialState_State, gen_statemachine103_FinalState_State},
    metadata=None
)
