...
class statemachine103_StateMachine:
    ...
    def __init__(self, label: str, statemachine103_StateMachine2: set["statemachine103_StateMachineVariable"] = None, statemachine103_StateMachine: set["statemachine103_StateMachineObject"] = None):
        self.label = label
