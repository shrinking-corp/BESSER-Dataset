...
domain_model = DomainModel(
    name="inheritance",
    types={inheritance_Subclass3, inheritance_Sub2Subclass, Subclass2, inheritance_Superclass, inheritance_Subclass1, Superclass, inheritance_Subclass2, inheritance_Sub1Subclass, Subclass1},
    associations={},
    generalizations={gen_inheritance_Subclass3_Superclass, gen_inheritance_Sub2Subclass_Subclass2, gen_inheritance_Subclass1_Superclass, gen_inheritance_Subclass2_Superclass, gen_inheritance_Sub1Subclass_Subclass1},
    metadata=None
)
