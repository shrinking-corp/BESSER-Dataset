...
class dbl_Clazz(Classifier, ClassSimilar):
    ...
    def __init__(self, active: bool, dbl_Clazz69: "dbl_Constructor" = None, dbl_Clazz71: set["dbl_Expression"] = None, dbl_Clazz78: "dbl_ClassAugment" = None, dbl_Clazz: "dbl_ClassSimilar" = None):
        self.active = active
...
class dbl_Variable(ModifierExtensionsContainer, Statement, AbstractVariable):

    def __init__(self, control: bool, clazz: bool, dbl_Variable: "dbl_Module" = None, dbl_Variable46: "dbl_ClassSimilar" = None, dbl_Variable30: "dbl_Annotation" = None, dbl_Variable86: "dbl_Expression" = None, dbl_Variable138: "dbl_ForEachStatement" = None):
...
class dbl_ExtensionDefinition(NamedElement):
    ...
    pass
class dbl_Procedure(NamedElement, CodeBlock, AnnotatableElement, TypedElement):

    def __init__(self, clazz: bool, dbl_Procedure81: "dbl_Interface" = None, dbl_Procedure: "dbl_Module" = None, dbl_Procedure49: "dbl_ClassSimilar" = None, dbl_Procedure27: set["dbl_Parameter"] = None):
        self.clazz = clazz
...
class dbl_AbstractVariable(NamedElement, TypedElement):
    ...
    pass
class dbl_Classifier(Type, NamedElement, ReferableRhsType):

    pass
class dbl_Module(NamedElement, EmbeddableExtensionsContainer):
...
class dbl_Pattern(NamedElement):
    ...
    def __init__(self, top: bool, dbl_Pattern: "dbl_ReferencePropertyType" = None, dbl_Pattern272: "dbl_IncludePattern" = None, dbl_Pattern252: "dbl_IdResolution" = None, dbl_Pattern254: "dbl_Parameter" = None, dbl_Pattern257: "dbl_CodeBlock" = None):
        self.top = top
...
class dbl_RhsExpression(ABC):
    ...
    def __init__(self, dbl_RhsExpression192: "dbl_SequenceExpr" = None, dbl_RhsExpression194: "dbl_OptionalExpr" = None, dbl_RhsExpression196: "dbl_RuntimeExpr" = None, dbl_RhsExpression198: "dbl_AtLeastOneExpr" = None, dbl_RhsExpression200: "dbl_ArbitraryExpr" = None, dbl_RhsExpression202: "dbl_AlternativeExpr" = None, dbl_RhsExpression: "dbl_TsRule" = None, dbl_RhsExpression205: "dbl_AlternativeExpr" = None):
...
class dbl_TsRule(ReferableRhsType, NamedElement):
    ...
    def __init__(self, metaClassName: str, dbl_TsRule209: "dbl_RuleExpr" = None, dbl_TsRule: "dbl_TextualSyntaxDef" = None, dbl_TsRule185: "dbl_RhsExpression" = None):
...
class Extension:
    ...
    pass
class dbl_NamedExtension(NamedElement, Extension):
