...
class tdt4250_Course:
    ...
    def __init__(self, code: str, name: str, study_points: float, level: str, semester: str, tdt4250_Course: "tdt4250_StudyProgram" = None, tdt4250_Course7: "tdt4250_Student" = None, tdt4250_Course9: "tdt4250_CourseGroup" = None, tdt4250_Course12: "tdt4250_CourseGroup" = None):
        self.code = code
        self.name = name
...
class tdt4250_Student:
    ...
    def __init__(self, studentID: int, current_semester: int, tdt4250_Student: "tdt4250_StudyProgram" = None, tdt4250_Student6: set["tdt4250_Course"] = None, tdt4250_Student18: "tdt4250_Specialisation" = None):
