...
class ra_MandatoryCourse:
    ...
    def __init__(self, mandatory: bool, credit: float, ra_MandatoryCourse: "ra_StudyPlan" = None, MandatoryCourse24: "ra_Semester" = None, mandatoryCourse: "ra_Semester" = None, mandatoryCourse27: "ra_Course" = None, MandatoryCourse: "ra_Course" = None):
...
class ra_Specialization:
    ...
    def __init__(self, name: str, ra_Specialization12: "ra_StudyPlan" = None, ra_Specialization18: set["ra_Semester"] = None, ra_Specialization: "ra_Department" = None):
        self.name = name
...
class ra_Course:
    ...
    def __init__(self, name: str, code: str, ra_Course22: "ra_Semester" = None, Course: "ra_MandatoryCourse" = None, ra_Course: "ra_Department" = None, course: "ra_MandatoryCourse" = None):
        self.name = name
        self.code = code
...
class ra_Semester:
    ...
    def __init__(self, semesterNumber: int, totalPoints: float, ra_Semester: "ra_StudyPlan" = None, ra_Semester19: "ra_Specialization" = None, ra_Semester21: set["ra_Course"] = None, semester: set["ra_MandatoryCourse"] = None, Semester: "ra_MandatoryCourse" = None):
