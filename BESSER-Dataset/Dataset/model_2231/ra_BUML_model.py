...
# Classes
ra_Department = Class(name="ra_Department")
ra_Programme = Class(name="ra_Programme")
ra_Semester = Class(name="ra_Semester")
ra_Course = Class(name="ra_Course")
ra_StudyPlan = Class(name="ra_StudyPlan")
ra_Specialization = Class(name="ra_Specialization")
ra_MandatoryCourse = Class(name="ra_MandatoryCourse")
...
ra_Semester.attributes={ra_Semester_semesterNumber, ra_Semester_totalPoints}
...
ra_Course.attributes={ra_Course_name, ra_Course_code}
...
ra_MandatoryCourse.attributes={ra_MandatoryCourse_credit, ra_MandatoryCourse_mandatory}
...
domain_model = DomainModel(
    name="ra",
    types={ra_Department, ra_Programme, ra_Semester, ra_Course, ra_StudyPlan, ra_Specialization, ra_MandatoryCourse, programmeCode},
    associations={spesialization10, semester13, mandatoryCourse15, semester17, courseSlot20, mandatoryCourse23, semester25, course26, programme0, course1, studyPlan3, spesialization5, mandatoryCourse7, studyPlan8, programme9},
    generalizations={},
    metadata=None
)
