...
build_IRequiredCapability.attributes={build_IRequiredCapability_filter, build_IRequiredCapability_range, build_IRequiredCapability_name, build_IRequiredCapability_namespace}
...
build_ICapability.attributes={build_ICapability_name, build_ICapability_namespace, build_ICapability_version}
...
build_IBuildUnit.attributes={build_IBuildUnit_circularityAllowed, build_IBuildUnit_instanceLocation, build_IBuildUnit_filter}
...
build_IRequirement.attributes={build_IRequirement_filter, build_IRequirement_alias, build_IRequirement_contributor, build_IRequirement_excludePattern, build_IRequirement_includePattern, build_IRequirement_memberName}
...
build_StringProperties.attributes={build_StringProperties_value, build_StringProperties_key, build_StringProperties_immutable}
...
build_context_ResolutionOptions.attributes={build_context_ResolutionOptions_excludeParts, build_context_ResolutionOptions_revision, build_context_ResolutionOptions_branchTagPath, build_context_ResolutionOptions_prune, build_context_ResolutionOptions_filterGroups, build_context_ResolutionOptions_resolverFilter, build_context_ResolutionOptions_overlayPath, build_context_ResolutionOptions_source, build_context_ResolutionOptions_mutable, build_context_ResolutionOptions_includeParts, build_context_ResolutionOptions_timestamp}
...
build_context_ImportOptions.attributes={build_context_ImportOptions_expand, build_context_ImportOptions_resourcePath, build_context_ImportOptions_conflictResolution, build_context_ImportOptions_unpack, build_context_ImportOptions_suffix, build_context_ImportOptions_location}
...
build_command_IUnitRequest.attributes={build_command_IUnitRequest_name, build_command_IUnitRequest_nameSpace, build_command_IUnitRequest_range}
...
domain_model = DomainModel(
    name="build",
    types={build_IBuildPart, build_IRequiredCapability, build_ICapability, build_IBuildUnit, ICapability, PropertyScope, IGenericUnit, build_IProvidedCapability, build_PartCapability, build_IActionResult, build_IUpToDatePolicy, build_IClosure, IPrerequisites, IAdvise, build_IArtifactsPart, IBuildPart, build_IPathGroup, build_IActionPart, IClosurePart, build_PartRequirement, IRequirement, build_IProducedPart, build_IResultingParts, IActionResult, build_IPrerequisites, build_IRequirement, build_IPartGroup, build_StringProperties, build_PropertyScope, build_IGenericUnit, build_context_IBuildContext, IUnitRequest, IResolution, build_IClosurePart, IClosure, build_Requirement, build_ResultingPathGroup, ImportOptions, build_context_ResolutionOptions, build_context_ImportOptions, IMaterializer, context_build_IBuildUnit, IResolver, build_context_IResolution, context_build_IRequiredCapability, context_build_ICapability, MetaDataTranslatorFactoryExtension, ResolverExtension, build_runtime_UpToDateExtension, IHumanSelectable, runtime_build_IUpToDatePolicy, build_runtime_IHumanSelectable, IExtension, build_runtime_MaterializerExtension, build_runtime_MetaDataTranslatorFactoryExtension, IMetaDataTranslatorFactory, build_runtime_ResolverExtension, build_runtime_IExtension, build_resolver_IResolver, build_runtime_BuildRuntime, UpToDateExtension, MaterializerExtension, build_resolver_FirstChoice, ResolverGroup, build_resolver_BestChoice, build_resolver_IMetaDataTranslatorFactory, build_resolver_IMetaDataTranslator, build_resolver_IEFSBasedAccess, build_resolver_DefaultResolver, IMetaDataTranslator, build_resolver_WorspaceResolver, EFSResolver, build_resolver_EFSResolver, resolver_DefaultResolver, resolver_IEFSBasedAccess, build_resolver_P2Resolver, IExpr, build_resolver_IResourceMap, build_resolver_ILocation, build_resolver_ResolverGroup, build_properties_IExpr, build_properties_Literal, build_properties_IFunction, build_properties_PropertyRef, IFunction, build_properties_Format, build_properties_ToUpper, build_properties_toLower, build_properties_replace, Match, build_properties_Match, build_properties_Split, build_resolver_IResolutionContext, build_materializer_IMaterializer, build_materializer_FileSystemMaterializer, build_materializer_P2Materializer, build_materializer_WorkspaceMaterializer, command_build_PropertyScope, build_command_IAdvise, ContextNodeSelector, build_command_ImportCommand, BuildUnitCommand, build_command_PropertyAdvice, build_command_ContextNodeSelector, build_command_StringAdvice, build_command_VersionAdvice, build_command_VersionRangeAdvice, build_command_BooleanAdvice, build_command_UnsetAdvice, build_command_IUnitRequest, ResolutionOptions, build_command_BuildUnitCommand, build_command_AdviceGroup, build_filter_IFilter, build_filter_OSGiBasedFilter, build_filter_AndFilter, FilterGroup, build_filter_OrFilter, build_filter_FilterGroup, build_filter_RegexpFilter, SinglePropertyFilter, build_filter_SinglePropertyFilter, build_filter_SimplePatternFIlter, build_command_NewInstanceAdvice, AdviceGroup, build_command_InvokeCommand, build_command_FilterAdvice, IFilter, Disposition, ConflictResolution, SplitStyle, FilterAdviceOperation},
    associations={parts0, requiredCapabilities1, metaRequiredCapabilities2, allRequiredCapabilities5, providedCapabilities8, partCapabilities13, publishedCapabilities15, buildUnit16, selfCapability11, produces18, upToDatePolicy19, advice20, paths17, requiredPart22, producedBy23, paths24, producedBy26, requiredParts21, buildPart33, properties35, self36, requests38, producedParts27, requiredCapability29, subResolutions51, paths31, options54, materializer56, resolutions39, units41, advice43, resolver46, resolves48, resolution49, unitTypes60, resolvers62, instance64, instance65, instance67, instance68, upToDatePolicies57, materializers58, resolvers71, translator73, location70, operands74, matchers76, requests78, properties80, resolver82, advice85, selector88, properties89, options77, advice95, filters97, remove91, add92},
    generalizations={gen_build_IBuildUnit_ICapability, gen_build_IBuildUnit_PropertyScope, gen_build_IBuildUnit_IGenericUnit, gen_build_IClosure_IPrerequisites, gen_build_IClosure_PropertyScope, gen_build_IArtifactsPart_IBuildPart, gen_build_IActionPart_IClosurePart, gen_build_PartRequirement_IRequirement, gen_build_IProducedPart_IClosurePart, gen_build_IResultingParts_IActionResult, gen_build_IPrerequisites_IBuildPart, gen_build_IPartGroup_IClosurePart, gen_build_PartCapability_ICapability, gen_build_IClosurePart_IClosure, gen_build_IClosurePart_IBuildPart, gen_build_Requirement_IRequirement, gen_build_ResultingPathGroup_IActionResult, gen_build_runtime_UpToDateExtension_IHumanSelectable, gen_build_runtime_IHumanSelectable_IExtension, gen_build_runtime_MaterializerExtension_IHumanSelectable, gen_build_runtime_MetaDataTranslatorFactoryExtension_IExtension, gen_build_runtime_ResolverExtension_IHumanSelectable, gen_build_resolver_FirstChoice_ResolverGroup, gen_build_resolver_BestChoice_ResolverGroup, gen_build_resolver_DefaultResolver_IResolver, gen_build_resolver_WorspaceResolver_EFSResolver, gen_build_resolver_EFSResolver_resolver_DefaultResolver, gen_build_resolver_EFSResolver_resolver_IEFSBasedAccess, gen_build_resolver_P2Resolver_IResolver, gen_build_resolver_ResolverGroup_IResolver, gen_build_properties_Literal_IExpr, gen_build_properties_IFunction_IExpr, gen_build_properties_PropertyRef_IFunction, gen_build_properties_Format_IFunction, gen_build_properties_ToUpper_IFunction, gen_build_properties_toLower_IFunction, gen_build_properties_replace_IFunction, gen_build_properties_Split_IFunction, gen_build_materializer_FileSystemMaterializer_IMaterializer, gen_build_materializer_P2Materializer_IMaterializer, gen_build_materializer_WorkspaceMaterializer_IMaterializer, gen_build_command_ImportCommand_BuildUnitCommand, gen_build_command_PropertyAdvice_IAdvise, gen_build_command_StringAdvice_IAdvise, gen_build_command_VersionAdvice_IAdvise, gen_build_command_VersionRangeAdvice_IAdvise, gen_build_command_BooleanAdvice_IAdvise, gen_build_command_UnsetAdvice_IAdvise, gen_build_filter_OSGiBasedFilter_IFilter, gen_build_filter_AndFilter_FilterGroup, gen_build_filter_OrFilter_FilterGroup, gen_build_filter_FilterGroup_IFilter, gen_build_filter_RegexpFilter_SinglePropertyFilter, gen_build_filter_SinglePropertyFilter_IFilter, gen_build_filter_SimplePatternFIlter_SinglePropertyFilter, gen_build_command_NewInstanceAdvice_AdviceGroup, gen_build_command_InvokeCommand_BuildUnitCommand, gen_build_command_FilterAdvice_IAdvise},
    metadata=None
)
