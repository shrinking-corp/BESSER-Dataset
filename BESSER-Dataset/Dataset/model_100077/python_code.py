...
class build_filter_SinglePropertyFilter(IFilter):
    ...
    def __init__(self, property: str, IFilter98: "build_filter_FilterGroup" = None, IFilter94: "build_command_FilterAdvice" = None, IFilter: "build_command_FilterAdvice" = None):
...
class build_resolver_P2Resolver(IResolver):
    ...
    def __init__(self, IResolver72: "build_resolver_ResolverGroup" = None, IResolver84: "build_command_BuildUnitCommand" = None, IResolver69: "build_runtime_ResolverExtension" = None, IResolver: "build_context_IBuildContext" = None):
...
class build_command_BooleanAdvice(IAdvise):
    ...
    def __init__(self, value: bool, IAdvise45: "build_context_IBuildContext" = None, IAdvise87: "build_command_BuildUnitCommand" = None, IAdvise: "build_IClosure" = None, IAdvise96: "build_command_AdviceGroup" = None):
        self.value = value
...
class build_command_StringAdvice(IAdvise):
    ...
    def __init__(self, value: str, IAdvise45: "build_context_IBuildContext" = None, IAdvise87: "build_command_BuildUnitCommand" = None, IAdvise: "build_IClosure" = None, IAdvise96: "build_command_AdviceGroup" = None):
        self.value = value
...
class build_command_FilterAdvice(IAdvise):
    ...
    def __init__(self, filterOp: str, build_command_FilterAdvice: "IFilter" = None, build_command_FilterAdvice93: "IFilter" = None, IAdvise45: "build_context_IBuildContext" = None, IAdvise87: "build_command_BuildUnitCommand" = None, IAdvise: "build_IClosure" = None, IAdvise96: "build_command_AdviceGroup" = None):
...
class build_command_VersionRangeAdvice(IAdvise):
    ...
    def __init__(self, versionRange: str, IAdvise45: "build_context_IBuildContext" = None, IAdvise87: "build_command_BuildUnitCommand" = None, IAdvise: "build_IClosure" = None, IAdvise96: "build_command_AdviceGroup" = None):
...
class build_command_VersionAdvice(IAdvise):
    ...
    def __init__(self, version: str, IAdvise45: "build_context_IBuildContext" = None, IAdvise87: "build_command_BuildUnitCommand" = None, IAdvise: "build_IClosure" = None, IAdvise96: "build_command_AdviceGroup" = None):
...
class build_PartCapability(ICapability):
    ...
    pass
class build_IBuildUnit(IGenericUnit, PropertyScope, ICapability):

    def __init__(self, filter: str, circularityAllowed: bool, instanceLocation: str, build_IBuildUnit14: set["build_PartCapability"] = None, buildUnit: set["build_IBuildPart"] = None, build_IBuildUnit: set["build_IRequiredCapability"] = None, build_IBuildUnit3: set["build_IRequiredCapability"] = None, build_IBuildUnit6: set["build_IRequiredCapability"] = None, IBuildUnit: "build_IBuildPart" = None, build_IBuildUnit9: set["build_ICapability"] = None, build_IBuildUnit12: "build_IBuildUnit" = None, build_IBuildUnit10: "build_IBuildUnit" = None):
        self.filter = filter
