...
def test_hyp_build_filter_singlepropertyfilter_property_setter(instance):
...
def test_build_filter_SinglePropertyFilter_property_value_roundtrip():
    instance = build_filter_SinglePropertyFilter(property="sample_text")
...
build_filter_SinglePropertyFilter_strategy = st.builds(build_filter_SinglePropertyFilter, property=safe_text)
@given(instance=build_filter_SinglePropertyFilter_strategy)
@settings(max_examples=25)
