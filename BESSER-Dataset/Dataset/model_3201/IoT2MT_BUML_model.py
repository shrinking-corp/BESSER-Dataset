...
iot2_Environment = Class(name="iot2_Environment")
iot2_Offer = Class(name="iot2_Offer")
...
iot2_ForkedToken = Class(name="iot2_ForkedToken")
Token = Class(name="Token")
iot2_Input = Class(name="iot2_Input")
iot2_Token = Class(name="iot2_Token")
iot2_Context = Class(name="iot2_Context")
iot2_Trace = Class(name="iot2_Trace")
iot2_ControlToken = Class(name="iot2_ControlToken")
...
iot2_ActivityNode_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_ActivityNode_m_sendOffers: Method = Method(name="sendOffers", parameters={Parameter(name='iot2_tokens', type=StringType)})
iot2_ActivityNode_m_takeOfferdTokens: Method = Method(name="takeOfferdTokens", parameters={}, type=StringType)
iot2_ActivityNode_m_addTokens: Method = Method(name="addTokens", parameters={Parameter(name='iot2_tokens', type=StringType)})
iot2_ActivityNode_m_hasOffers: Method = Method(name="hasOffers", parameters={})
iot2_ActivityNode_m_removeToken: Method = Method(name="removeToken", parameters={Parameter(name='iot2_token', type=StringType)})
iot2_ActivityNode.attributes={iot2_ActivityNode_running}
iot2_ActivityNode.methods={iot2_ActivityNode_m_terminate, iot2_ActivityNode_m_sendOffers, iot2_ActivityNode_m_isReady, iot2_ActivityNode_m_hasOffers, iot2_ActivityNode_m_execute, iot2_ActivityNode_m_addTokens, iot2_ActivityNode_m_takeOfferdTokens, iot2_ActivityNode_m_removeToken}

# iot2_ActivityEdge class attributes and methods
iot2_ActivityEdge_m_sendOffer: Method = Method(name="sendOffer", parameters={Parameter(name='iot2_tokens', type=StringType)})
...
iot2_ActivityEdge.methods={iot2_ActivityEdge_m_sendOffer, iot2_ActivityEdge_m_takeOfferedTokens, iot2_ActivityEdge_m_hasOffer}

# iot2_Variable class attributes and methods
iot2_Variable_name: Property = Property(name="name", type=StringType)
iot2_Variable_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
iot2_Variable_m_init: Method = Method(name="init", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Activity_m_getBooleanVariableValue: Method = Method(name="getBooleanVariableValue", parameters={Parameter(name='iot2_variableName', type=StringType)})
iot2_Activity_m_getVariableValue: Method = Method(name="getVariableValue", parameters={Parameter(name='iot2_variableName', type=StringType)}, type=StringType)
iot2_Activity_m_getVariable: Method = Method(name="getVariable", parameters={Parameter(name='iot2_variableName', type=StringType)}, type=StringType)
iot2_Activity_m_writeTrace: Method = Method(name="writeTrace", parameters={})
iot2_Activity_m_main: Method = Method(name="main", parameters={Parameter(name='iot2_value', type=StringType)})
iot2_Activity_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Activity_m_getIntegerVariableValue: Method = Method(name="getIntegerVariableValue", parameters={Parameter(name='iot2_variableName', type=StringType)})
iot2_Activity.methods={iot2_Activity_m_main, iot2_Activity_m_reset, iot2_Activity_m_getVariableValue, iot2_Activity_m_writeToFile, iot2_Activity_m_getIntegerVariableValue, iot2_Activity_m_getVariable, iot2_Activity_m_getBooleanVariableValue, iot2_Activity_m_writeTrace, iot2_Activity_m_printTrace, iot2_Activity_m_execute}
...
iot2_OperationDef_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Block_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Contained.attributes={iot2_Contained_absoluteName, iot2_Contained_version, iot2_Contained_repositoryId}

# iot2_Container class attributes and methods

# iot2_Chunk class attributes and methods
iot2_Chunk_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_NamedElement_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
iot2_NamedElement.attributes={iot2_NamedElement_identifier, iot2_NamedElement_name}
...
iot2_Statement_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
iot2_Statement.methods={iot2_Statement_m_execute}

# iot2_LastStatement class attributes and methods
iot2_LastStatement_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
iot2_LastStatement.methods={iot2_LastStatement_m_execute}

# iot2_LastStatement_Return class attributes and methods
iot2_LastStatement_Return_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Field_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Expression_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Statement_If_Then_Else_ElseIfPart_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Statement_Block_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
iot2_Statement_Block.methods={iot2_Statement_Block_m_execute}

# Statement class attributes and methods

# iot2_Statement_While class attributes and methods
iot2_Statement_While_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
iot2_Statement_While.methods={iot2_Statement_While_m_execute}

# iot2_Statement_Repeat class attributes and methods
iot2_Statement_Repeat_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
iot2_Statement_Repeat.methods={iot2_Statement_Repeat_m_execute}

# iot2_Statement_If_Then_Else class attributes and methods
iot2_Statement_If_Then_Else_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Function_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Statement_LocalFunction_Declaration_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Statement_For_Numeric_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Statement_For_Generic_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Statement_GlobalFunction_Declaration_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Expression_Number_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Expression_VarArgs_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Expression_String_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Expression_Function_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Statement_Local_Variable_Declaration_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Statement_FunctioncallOrAssignment_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Expression_Nil_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
iot2_Expression_Nil.methods={iot2_Expression_Nil_m_execute}

# Expression class attributes and methods

# iot2_Expression_True class attributes and methods
iot2_Expression_True_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
iot2_Expression_True.methods={iot2_Expression_True_m_execute}

# iot2_Expression_False class attributes and methods
iot2_Expression_False_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
iot2_Expression_False.methods={iot2_Expression_False_m_execute}

# iot2_Functioncall_Arguments class attributes and methods
iot2_Functioncall_Arguments_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Expression_TableConstructor_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Statement_CallMemberFunction_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Statement_CallFunction_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Field_AddEntryToTable_Brackets_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Field_AddEntryToTable_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Field_AppendEntryToTable_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_LastStatement_ReturnWithValue_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Statement_Assignment_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
iot2_Statement_Assignment.methods={iot2_Statement_Assignment_m_execute}

# iot2_Expression_Larger class attributes and methods
iot2_Expression_Larger_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
iot2_Expression_Larger.methods={iot2_Expression_Larger_m_execute}

# iot2_Expression_Larger_Equal class attributes and methods
iot2_Expression_Larger_Equal_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Expression_Or_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
iot2_Expression_Or.methods={iot2_Expression_Or_m_execute}

# iot2_Expression_And class attributes and methods
iot2_Expression_And_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
iot2_Expression_And.methods={iot2_Expression_And_m_execute}

# iot2_Expression_Equal class attributes and methods
iot2_Expression_Equal_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
iot2_Expression_Equal.methods={iot2_Expression_Equal_m_execute}

# iot2_Expression_Not_Equal class attributes and methods
iot2_Expression_Not_Equal_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Expression_Smaller_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Expression_Smaller_Equal_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Expression_Multiplication_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Expression_Division_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Expression_Concatenation_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Expression_Plus_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
iot2_Expression_Plus.methods={iot2_Expression_Plus_m_execute}

# iot2_Expression_Minus class attributes and methods
iot2_Expression_Minus_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
iot2_Expression_Minus.methods={iot2_Expression_Minus_m_execute}

# iot2_Expression_Invert class attributes and methods
iot2_Expression_Invert_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Expression_Exponentiation_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Expression_Modulo_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
iot2_Expression_Modulo.methods={iot2_Expression_Modulo_m_execute}

# iot2_Expression_Negate class attributes and methods
iot2_Expression_Negate_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
iot2_Expression_Negate.methods={iot2_Expression_Negate_m_execute}

# iot2_Expression_Length class attributes and methods
iot2_Expression_Length_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
iot2_Expression_Length.methods={iot2_Expression_Length_m_execute}

# iot2_Expression_AccessArray class attributes and methods
iot2_Expression_AccessArray_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Expression_AccessMember_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Expression_CallMemberFunction_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Expression_CallFunction_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Expression_VariableName_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Environment_m_putAllVariables: Method = Method(name="putAllVariables", parameters={Parameter(name='iot2_v', type=StringType)})
iot2_Environment_m_putAllFunctions: Method = Method(name="putAllFunctions", parameters={Parameter(name='iot2_f', type=StringType)})
iot2_Environment_m_pushAllValues: Method = Method(name="pushAllValues", parameters={Parameter(name='iot2_v', type=StringType)})
...
iot2_Environment_m_getVariable: Method = Method(name="getVariable", parameters={Parameter(name='iot2_s', type=StringType)}, type=StringType)
iot2_Environment_m_pushValue: Method = Method(name="pushValue", parameters={Parameter(name='iot2_o', type=StringType)})
iot2_Environment_m_popValue: Method = Method(name="popValue", parameters={}, type=StringType)
iot2_Environment_m_putFunction: Method = Method(name="putFunction", parameters={Parameter(name='iot2_f', type=StringType), Parameter(name='iot2_s', type=StringType)})
iot2_Environment_m_getFunction: Method = Method(name="getFunction", parameters={Parameter(name='iot2_s', type=StringType)}, type=StringType)
iot2_Environment_m_putVariable: Method = Method(name="putVariable", parameters={Parameter(name='iot2_s', type=StringType), Parameter(name='iot2_o', type=StringType)})
iot2_Environment.methods={iot2_Environment_m_putFunction, iot2_Environment_m_putAllFunctions, iot2_Environment_m_putAllVariables, iot2_Environment_m_getValues, iot2_Environment_m_getFunctions, iot2_Environment_m_pushAllValues, iot2_Environment_m_getVariables, iot2_Environment_m_popValue, iot2_Environment_m_getFunction, iot2_Environment_m_pushValue, iot2_Environment_m_getVariable, iot2_Environment_m_putVariable}
...
iot2_Offer.methods={iot2_Offer_m_removeWithdrawnTokens, iot2_Offer_m_hasTokens}
...
iot2_BooleanVariable_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_ActivityFinalNode_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_ForkNode_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
iot2_ForkNode.methods={iot2_ForkNode_m_execute}

# iot2_JoinNode class attributes and methods
iot2_JoinNode_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
iot2_JoinNode.methods={iot2_JoinNode_m_execute}

# iot2_MergeNode class attributes and methods
iot2_MergeNode_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_DecisionNode_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
iot2_DecisionNode_m_sendOffers: Method = Method(name="sendOffers", parameters={Parameter(name='iot2_tokens', type=StringType)})
...
iot2_OpaqueAction_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
iot2_OpaqueAction_m_getValueAsString: Method = Method(name="getValueAsString", parameters={Parameter(name='iot2_v', type=StringType)})
iot2_OpaqueAction.methods={iot2_OpaqueAction_m_getValueAsString, iot2_OpaqueAction_m_execute}

# Action class attributes and methods

# iot2_InitialNode class attributes and methods
iot2_InitialNode_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_IntegerVariable_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_BooleanBinaryExpression_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_IntegerCalculationExpression_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_IntegerComparisonExpression_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_BooleanUnaryExpression_m_execute: Method = Method(name="execute", parameters={Parameter(name='iot2_c', type=StringType)})
...
iot2_Token_m_transfer: Method = Method(name="transfer", parameters={Parameter(name='iot2_holder', type=StringType)}, type=StringType)
...
iot2_Token.methods={iot2_Token_m_withdraw, iot2_Token_m_transfer, iot2_Token_m_isWithdrawn}
...
parent215: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="iot2_Environment214", type=iot2_Environment, multiplicity=Multiplicity(0, 1))
    }
)
source220: BinaryAssociation = BinaryAssociation(
    name="source220",
    ends={
...
target222: BinaryAssociation = BinaryAssociation(
    name="target222",
    ends={
        Property(name="ActivityNode223", type=iot2_ActivityEdge, multiplicity=Multiplicity(1, 1)),
        Property(name="incoming", type=iot2_ActivityNode, multiplicity=Multiplicity(1, 1))
    }
)
offers224: BinaryAssociation = BinaryAssociation(
    name="offers224",
    ends={
        Property(name="iot2_Offer", type=iot2_ActivityEdge, multiplicity=Multiplicity(1, 1)),
        Property(name="iot2_ActivityEdge225", type=iot2_Offer, multiplicity=Multiplicity(0, 9999))
    }
)
outgoing216: BinaryAssociation = BinaryAssociation(
    name="outgoing216",
    ends={
...
incoming217: BinaryAssociation = BinaryAssociation(
    name="incoming217",
    ends={
        Property(name="ActivityEdge218", type=iot2_ActivityNode, multiplicity=Multiplicity(1, 1)),
        Property(name="target", type=iot2_ActivityEdge, multiplicity=Multiplicity(0, 9999))
    }
)
activity219: BinaryAssociation = BinaryAssociation(
    name="activity219",
    ends={
...
guard226: BinaryAssociation = BinaryAssociation(
    name="guard226",
    ends={
...
expressions227: BinaryAssociation = BinaryAssociation(
    name="expressions227",
    ends={
        Property(name="iot2_Expression228", type=iot2_OpaqueAction, multiplicity=Multiplicity(1, 1)),
        Property(name="iot2_OpaqueAction", type=iot2_Expression, multiplicity=Multiplicity(0, 9999))
    }
)
service229: BinaryAssociation = BinaryAssociation(
    name="service229",
    ends={
        Property(name="iot2_OperationDef231", type=iot2_OpaqueAction, multiplicity=Multiplicity(1, 1)),
        Property(name="iot2_OpaqueAction230", type=iot2_OperationDef, multiplicity=Multiplicity(0, 1))
    }
)
operand2237: BinaryAssociation = BinaryAssociation(
    name="operand2237",
    ends={
...
operand1238: BinaryAssociation = BinaryAssociation(
    name="operand1238",
    ends={
        Property(name="iot2_IntegerVariable240", type=iot2_IntegerExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="iot2_IntegerExpression239", type=iot2_IntegerVariable, multiplicity=Multiplicity(0, 1))
    }
)
assignee241: BinaryAssociation = BinaryAssociation(
    name="assignee241",
    ends={
        Property(name="iot2_BooleanVariable242", type=iot2_BooleanExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="iot2_BooleanExpression", type=iot2_BooleanVariable, multiplicity=Multiplicity(1, 1))
    }
)
initialValue232: BinaryAssociation = BinaryAssociation(
    name="initialValue232",
    ends={
        Property(name="iot2_Value", type=iot2_Variable, multiplicity=Multiplicity(1, 1)),
        Property(name="iot2_Variable233", type=iot2_Value, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
currentValue234: BinaryAssociation = BinaryAssociation(
    name="currentValue234",
    ends={
        Property(name="iot2_Value236", type=iot2_Variable, multiplicity=Multiplicity(1, 1)),
        Property(name="iot2_Variable235", type=iot2_Value, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
operand247: BinaryAssociation = BinaryAssociation(
    name="operand247",
    ends={
        Property(name="iot2_BooleanVariable248", type=iot2_BooleanUnaryExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="iot2_BooleanUnaryExpression", type=iot2_BooleanVariable, multiplicity=Multiplicity(1, 1))
    }
)
operand1249: BinaryAssociation = BinaryAssociation(
    name="operand1249",
    ends={
        Property(name="iot2_BooleanVariable250", type=iot2_BooleanBinaryExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="iot2_BooleanBinaryExpression", type=iot2_BooleanVariable, multiplicity=Multiplicity(1, 1))
    }
)
operand2251: BinaryAssociation = BinaryAssociation(
    name="operand2251",
    ends={
        Property(name="iot2_BooleanVariable253", type=iot2_BooleanBinaryExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="iot2_BooleanBinaryExpression252", type=iot2_BooleanVariable, multiplicity=Multiplicity(1, 1))
    }
)
assignee243: BinaryAssociation = BinaryAssociation(
    name="assignee243",
    ends={
        Property(name="iot2_IntegerVariable244", type=iot2_IntegerCalculationExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="iot2_IntegerCalculationExpression", type=iot2_IntegerVariable, multiplicity=Multiplicity(1, 1))
    }
)
assignee245: BinaryAssociation = BinaryAssociation(
    name="assignee245",
    ends={
        Property(name="iot2_BooleanVariable246", type=iot2_IntegerComparisonExpression, multiplicity=Multiplicity(1, 1)),
        Property(name="iot2_IntegerComparisonExpression", type=iot2_BooleanVariable, multiplicity=Multiplicity(1, 1))
    }
)
parent270: BinaryAssociation = BinaryAssociation(
    name="parent270",
    ends={
        Property(name="iot2_Context271", type=iot2_Context, multiplicity=Multiplicity(1, 1)),
        Property(name="iot2_Context269", type=iot2_Context, multiplicity=Multiplicity(0, 1))
    }
)
inputValues272: BinaryAssociation = BinaryAssociation(
    name="inputValues272",
    ends={
        Property(name="iot2_InputValue274", type=iot2_Context, multiplicity=Multiplicity(1, 1)),
        Property(name="iot2_Context273", type=iot2_InputValue, multiplicity=Multiplicity(0, 9999))
    }
)
node275: BinaryAssociation = BinaryAssociation(
    name="node275",
    ends={
        Property(name="iot2_JoinNode", type=iot2_Context, multiplicity=Multiplicity(1, 1)),
        Property(name="iot2_Context276", type=iot2_JoinNode, multiplicity=Multiplicity(0, 1))
    }
)
executedNodes277: BinaryAssociation = BinaryAssociation(
    name="executedNodes277",
    ends={
        Property(name="iot2_ActivityNode279", type=iot2_Trace, multiplicity=Multiplicity(1, 1)),
        Property(name="iot2_Trace278", type=iot2_ActivityNode, multiplicity=Multiplicity(0, 9999))
    }
)
baseToken280: BinaryAssociation = BinaryAssociation(
    name="baseToken280",
    ends={
        Property(name="iot2_Token281", type=iot2_ForkedToken, multiplicity=Multiplicity(1, 1)),
        Property(name="iot2_ForkedToken", type=iot2_Token, multiplicity=Multiplicity(0, 1))
    }
)
value254: BinaryAssociation = BinaryAssociation(
    name="value254",
    ends={
        Property(name="iot2_Value255", type=iot2_InputValue, multiplicity=Multiplicity(1, 1)),
...
variable256: BinaryAssociation = BinaryAssociation(
    name="variable256",
    ends={
        Property(name="iot2_Variable258", type=iot2_InputValue, multiplicity=Multiplicity(1, 1)),
        Property(name="iot2_InputValue257", type=iot2_Variable, multiplicity=Multiplicity(1, 1))
    }
)
inputValues259: BinaryAssociation = BinaryAssociation(
    name="inputValues259",
    ends={
        Property(name="iot2_InputValue260", type=iot2_Input, multiplicity=Multiplicity(1, 1)),
        Property(name="iot2_Input", type=iot2_InputValue, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
offeredTokens261: BinaryAssociation = BinaryAssociation(
    name="offeredTokens261",
    ends={
        Property(name="iot2_Token", type=iot2_Offer, multiplicity=Multiplicity(1, 1)),
        Property(name="iot2_Offer262", type=iot2_Token, multiplicity=Multiplicity(0, 9999))
    }
)
holder263: BinaryAssociation = BinaryAssociation(
    name="holder263",
    ends={
        Property(name="iot2_ActivityNode", type=iot2_Token, multiplicity=Multiplicity(1, 1)),
        Property(name="iot2_Token264", type=iot2_ActivityNode, multiplicity=Multiplicity(0, 1))
    }
)
output265: BinaryAssociation = BinaryAssociation(
    name="output265",
    ends={
...
activity266: BinaryAssociation = BinaryAssociation(
    name="activity266",
    ends={
        Property(name="iot2_Activity268", type=iot2_Context, multiplicity=Multiplicity(1, 1)),
        Property(name="iot2_Context267", type=iot2_Activity, multiplicity=Multiplicity(0, 1))
    }
)
...
domain_model = DomainModel(
    name="iot2",
    types={iot2_System, iot2_HWComponent, iot2_Board, iot2_Sketch, iot2_ActivityNode, iot2_ActivityEdge, iot2_Variable, Contained, Typed, iot2_Activity, iot2_OperationDef, iot2_Sensor, HWComponent, iot2_Actuator, NamedElement, iot2_Typed, iot2_IDLType, iot2_TypedefDef, iot2_ParameterDef, iot2_ExceptionDef, iot2_Block, iot2_Contained, iot2_Container, iot2_Chunk, iot2_NamedElement, Chunk, iot2_Statement, iot2_LastStatement, iot2_LastStatement_Return, LastStatement, IDLType, iot2_LastStatement_Break, iot2_Field, iot2_Expression, iot2_PrimitiveDef, iot2_Statement_If_Then_Else_ElseIfPart, iot2_Statement_Block, Statement, iot2_Statement_While, iot2_Statement_Repeat, iot2_Statement_If_Then_Else, iot2_Function, iot2_Statement_LocalFunction_Declaration, iot2_Statement_For_Numeric, iot2_Statement_For_Generic, iot2_Statement_GlobalFunction_Declaration, iot2_Expression_Number, iot2_Expression_VarArgs, iot2_Expression_String, iot2_Expression_Function, iot2_Statement_Local_Variable_Declaration, iot2_Statement_FunctioncallOrAssignment, Statement_FunctioncallOrAssignment, iot2_Expression_Nil, Expression, iot2_Expression_True, iot2_Expression_False, iot2_Functioncall_Arguments, iot2_Expression_TableConstructor, iot2_Statement_CallMemberFunction, iot2_Statement_CallFunction, iot2_Field_AddEntryToTable_Brackets, Field, iot2_Field_AddEntryToTable, iot2_Field_AppendEntryToTable, iot2_LastStatement_ReturnWithValue, LastStatement_Return, iot2_Statement_Assignment, iot2_Expression_Larger, iot2_Expression_Larger_Equal, iot2_Expression_Or, iot2_Expression_And, iot2_Expression_Equal, iot2_Expression_Not_Equal, iot2_Expression_Smaller, iot2_Expression_Smaller_Equal, iot2_Expression_Multiplication, iot2_Expression_Division, iot2_Expression_Concatenation, iot2_Expression_Plus, iot2_Expression_Minus, iot2_Expression_Invert, iot2_Expression_Exponentiation, iot2_Expression_Modulo, iot2_Expression_Negate, iot2_Expression_Length, iot2_Expression_AccessArray, iot2_Expression_AccessMember, iot2_Expression_CallMemberFunction, iot2_Expression_CallFunction, iot2_Expression_VariableName, iot2_Environment, iot2_Offer, iot2_ControlFlow, ActivityEdge, iot2_BooleanVariable, iot2_ActivityFinalNode, FinalNode, iot2_ForkNode, iot2_JoinNode, iot2_MergeNode, iot2_DecisionNode, iot2_ControlNode, ActivityNode, iot2_ExecutableNode, iot2_Action, ExecutableNode, iot2_OpaqueAction, Action, iot2_InitialNode, ControlNode, iot2_FinalNode, iot2_BooleanValue, Value, iot2_IntegerValue, iot2_IntegerExpression, iot2_BooleanExpression, iot2_Value, iot2_IntegerVariable, Variable, iot2_BooleanBinaryExpression, iot2_InputValue, iot2_IntegerCalculationExpression, IntegerExpression, iot2_IntegerComparisonExpression, iot2_BooleanUnaryExpression, BooleanExpression, iot2_ForkedToken, Token, iot2_Input, iot2_Token, iot2_Context, iot2_Trace, iot2_ControlToken, BoardType, ParameterMode, PrimitiveKind, BooleanUnaryOperator, BooleanBinaryOperator, IntegerCalculationOperator, IntegerComparisonOperator},
    associations={components0, boards1, sketch3, nodes12, edges13, locals15, inputs17, components5, activity8, services10, contains27, containedType28, sharedType29, parameters20, canRaise22, lua24, definedIn26, statements35, returnValue37, members31, value33, ifExpression51, ifBlock53, elseIf56, elseBlock58, block39, expression41, block43, block46, expression48, function83, elseifExpression61, elseifBlock64, startExpr67, untilExpr69, stepExpr72, block75, expressions78, block80, function84, initialValue86, body92, arguments95, function88, fields90, object106, arguments108, indexExpression97, returnValues99, variable101, values103, left126, right128, left131, right133, object111, arguments113, left116, right118, left121, right123, left146, right148, left151, left136, right138, left141, right143, left166, right168, left171, right173, right153, left156, right158, left161, right163, exp188, exp190, left176, right178, left181, right183, exp186, array207, index209, object212, left192, right194, object197, arguments199, object202, arguments204, parent215, source220, target222, offers224, outgoing216, incoming217, activity219, guard226, expressions227, service229, operand2237, operand1238, assignee241, initialValue232, currentValue234, operand247, operand1249, operand2251, assignee243, assignee245, parent270, inputValues272, node275, executedNodes277, baseToken280, value254, variable256, inputValues259, offeredTokens261, holder263, output265, activity266},
    generalizations={gen_iot2_OperationDef_Contained, gen_iot2_OperationDef_Typed, gen_iot2_Sensor_HWComponent, gen_iot2_Actuator_HWComponent, gen_iot2_Activity_NamedElement, gen_iot2_Container_Contained, gen_iot2_Contained_NamedElement, gen_iot2_Block_Chunk, gen_iot2_LastStatement_Return_LastStatement, gen_iot2_TypedefDef_IDLType, gen_iot2_TypedefDef_Contained, gen_iot2_LastStatement_Break_LastStatement, gen_iot2_ParameterDef_Typed, gen_iot2_ExceptionDef_Contained, gen_iot2_Field_Typed, gen_iot2_PrimitiveDef_IDLType, gen_iot2_Statement_Block_Statement, gen_iot2_Statement_While_Statement, gen_iot2_Statement_Repeat_Statement, gen_iot2_Statement_If_Then_Else_Statement, gen_iot2_Statement_LocalFunction_Declaration_Statement, gen_iot2_Statement_For_Numeric_Statement, gen_iot2_Statement_For_Generic_Statement, gen_iot2_Statement_GlobalFunction_Declaration_Statement, gen_iot2_Expression_Number_Expression, gen_iot2_Expression_VarArgs_Expression, gen_iot2_Expression_String_Expression, gen_iot2_Expression_Function_Expression, gen_iot2_Statement_Local_Variable_Declaration_Statement, gen_iot2_Statement_FunctioncallOrAssignment_Statement, gen_iot2_Expression_Statement_FunctioncallOrAssignment, gen_iot2_Expression_Nil_Expression, gen_iot2_Expression_True_Expression, gen_iot2_Expression_False_Expression, gen_iot2_Expression_TableConstructor_Expression, gen_iot2_Statement_CallMemberFunction_Statement_FunctioncallOrAssignment, gen_iot2_Statement_CallFunction_Statement_FunctioncallOrAssignment, gen_iot2_Field_AddEntryToTable_Brackets_Field, gen_iot2_Field_AddEntryToTable_Field, gen_iot2_Field_AppendEntryToTable_Field, gen_iot2_LastStatement_ReturnWithValue_LastStatement_Return, gen_iot2_Statement_Assignment_Statement_FunctioncallOrAssignment, gen_iot2_Expression_Larger_Expression, gen_iot2_Expression_Larger_Equal_Expression, gen_iot2_Expression_Or_Expression, gen_iot2_Expression_And_Expression, gen_iot2_Expression_Equal_Expression, gen_iot2_Expression_Not_Equal_Expression, gen_iot2_Expression_Smaller_Expression, gen_iot2_Expression_Smaller_Equal_Expression, gen_iot2_Expression_Multiplication_Expression, gen_iot2_Expression_Division_Expression, gen_iot2_Expression_Concatenation_Expression, gen_iot2_Expression_Plus_Expression, gen_iot2_Expression_Minus_Expression, gen_iot2_Expression_Invert_Expression, gen_iot2_Expression_Exponentiation_Expression, gen_iot2_Expression_Modulo_Expression, gen_iot2_Expression_Negate_Expression, gen_iot2_Expression_Length_Expression, gen_iot2_Expression_AccessArray_Expression, gen_iot2_Expression_AccessMember_Expression, gen_iot2_Expression_CallMemberFunction_Expression, gen_iot2_Expression_CallFunction_Expression, gen_iot2_Expression_VariableName_Expression, gen_iot2_ActivityEdge_NamedElement, gen_iot2_ControlFlow_ActivityEdge, gen_iot2_ActivityNode_NamedElement, gen_iot2_ActivityFinalNode_FinalNode, gen_iot2_ForkNode_ControlNode, gen_iot2_JoinNode_ControlNode, gen_iot2_MergeNode_ControlNode, gen_iot2_DecisionNode_ControlNode, gen_iot2_ControlNode_ActivityNode, gen_iot2_ExecutableNode_ActivityNode, gen_iot2_Action_ExecutableNode, gen_iot2_OpaqueAction_Action, gen_iot2_InitialNode_ControlNode, gen_iot2_FinalNode_ControlNode, gen_iot2_BooleanValue_Value, gen_iot2_IntegerValue_Value, gen_iot2_IntegerExpression_Expression, gen_iot2_BooleanExpression_Expression, gen_iot2_IntegerVariable_Variable, gen_iot2_BooleanVariable_Variable, gen_iot2_BooleanBinaryExpression_BooleanExpression, gen_iot2_IntegerCalculationExpression_IntegerExpression, gen_iot2_IntegerComparisonExpression_IntegerExpression, gen_iot2_BooleanUnaryExpression_BooleanExpression, gen_iot2_ForkedToken_Token, gen_iot2_ControlToken_Token},
    metadata=None
)
