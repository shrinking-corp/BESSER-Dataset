...
# Classes
ValidationModel_TestContainer = Class(name="ValidationModel_TestContainer")
ValidationModel_UnitTest = Class(name="ValidationModel_UnitTest")
...
domain_model = DomainModel(
    ...
    types={ValidationModel_TestContainer, ValidationModel_UnitTest},
    associations={tests0},
    generalizations={},
    metadata=None
)
