...
trace_Log = Class(name="trace_Log")
trace_Exception = Class(name="trace_Exception")
...
trace_Log.attributes={trace_Log_timestamp, trace_Log_level, trace_Log_source, trace_Log_message}
