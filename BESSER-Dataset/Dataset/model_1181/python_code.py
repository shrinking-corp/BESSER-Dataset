...
class gbind_dsl_BaseHelper:
    ...
    def __init__(self, feature: str, gbind_dsl_BaseHelper: "OclExpression" = None, gbind_dsl_BaseHelper220: "OclType" = None, helpers: "BindingModel" = None):
...
class gbind_dsl_BindingModel:
    ...
    def __init__(self, name: str, gbind_dsl_BindingModel162: set["VirtualMetaclass"] = None, gbind_dsl_BindingModel164: "MetamodelDeclaration" = None, gbind_dsl_BindingModel166: "MetamodelDeclaration" = None, gbind_dsl_BindingModel169: "BindingOptions" = None, gbind_dsl_BindingModel: set["ConceptMetaclass"] = None, gbind_dsl_BindingModel160: set["ConcreteMetaclass"] = None, model_: set["ConceptBinding"] = None, model_157: set["BaseHelper"] = None):
        self.name = name
        ...
        self.gbind_dsl_BindingModel166 = gbind_dsl_BindingModel166
    ...
    def gbind_dsl_BindingModel166(self, value):
        ...
        self.__gbind_dsl_BindingModel166 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "MetamodelDeclaration167"):
                opp_val = getattr(old_value, "MetamodelDeclaration167", None)
                if opp_val == self:
                    setattr(old_value, "MetamodelDeclaration167", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "MetamodelDeclaration167"):
                opp_val = getattr(value, "MetamodelDeclaration167", None)
                setattr(value, "MetamodelDeclaration167", self)
...
class gbind_simpleocl_OclMetamodel(OclModel):
    ...
    def __init__(self, uri: str, metamodel: set["OclInstanceModel"] = None, OclModel121: "gbind_simpleocl_OclModelElement" = None, OclModel: "gbind_simpleocl_OclModelElementExp" = None):
        self.uri = uri
...
class gbind_simpleocl_OperatorCallExp(OclExpression):
    ...
    def __init__(self, operationName: str, gbind_simpleocl_OperatorCallExp: "OclExpression" = None, appliedOperator: "OclExpression" = None, OclExpression141: "gbind_simpleocl_Attribute" = None, OclExpression37: "gbind_simpleocl_MapElement" = None, OclExpression72: "gbind_simpleocl_IfExp" = None, OclExpression: "gbind_simpleocl_CollectionExp" = None, OclExpression68: "gbind_simpleocl_LetExp" = None, OclExpression197: "gbind_dsl_VirtualMetaclass" = None, OclExpression60: "gbind_simpleocl_LoopExp" = None, OclExpression52: "gbind_simpleocl_OperatorCallExp" = None, OclExpression74: "gbind_simpleocl_IfExp" = None, OclExpression34: "gbind_simpleocl_MapElement" = None, OclExpression46: "gbind_simpleocl_PropertyCallExp" = None, OclExpression43: "gbind_simpleocl_StaticOperationCall" = None, OclExpression58: "gbind_simpleocl_BraceExp" = None, OclExpression216: "gbind_dsl_OclFeatureBinding" = None, OclExpression179: "gbind_dsl_ClassBinding" = None, OclExpression54: "gbind_simpleocl_OperatorCallExp" = None, OclExpression149: "gbind_simpleocl_Operation" = None, OclExpression56: "gbind_simpleocl_LambdaCallExp" = None, OclExpression50: "gbind_simpleocl_OperationCall" = None, OclExpression70: "gbind_simpleocl_IfExp" = None, OclExpression91: "gbind_simpleocl_OclType" = None, OclExpression81: "gbind_simpleocl_LocalVariable" = None, OclExpression218: "gbind_dsl_BaseHelper" = None):
        self.operationName = operationName
...
class gbind_simpleocl_EnumLiteralExp(OclExpression):
    ...
    def __init__(self, name: str, OclExpression141: "gbind_simpleocl_Attribute" = None, OclExpression37: "gbind_simpleocl_MapElement" = None, OclExpression72: "gbind_simpleocl_IfExp" = None, OclExpression: "gbind_simpleocl_CollectionExp" = None, OclExpression68: "gbind_simpleocl_LetExp" = None, OclExpression197: "gbind_dsl_VirtualMetaclass" = None, OclExpression60: "gbind_simpleocl_LoopExp" = None, OclExpression52: "gbind_simpleocl_OperatorCallExp" = None, OclExpression74: "gbind_simpleocl_IfExp" = None, OclExpression34: "gbind_simpleocl_MapElement" = None, OclExpression46: "gbind_simpleocl_PropertyCallExp" = None, OclExpression43: "gbind_simpleocl_StaticOperationCall" = None, OclExpression58: "gbind_simpleocl_BraceExp" = None, OclExpression216: "gbind_dsl_OclFeatureBinding" = None, OclExpression179: "gbind_dsl_ClassBinding" = None, OclExpression54: "gbind_simpleocl_OperatorCallExp" = None, OclExpression149: "gbind_simpleocl_Operation" = None, OclExpression56: "gbind_simpleocl_LambdaCallExp" = None, OclExpression50: "gbind_simpleocl_OperationCall" = None, OclExpression70: "gbind_simpleocl_IfExp" = None, OclExpression91: "gbind_simpleocl_OclType" = None, OclExpression81: "gbind_simpleocl_LocalVariable" = None, OclExpression218: "gbind_dsl_BaseHelper" = None):
        self.name = name
...
class gbind_dsl_MetamodelDeclaration(OclMetamodel):
    ...
    def __init__(self, metamodelURI: str, OclMetamodel: "gbind_simpleocl_Module" = None, OclMetamodel154: "gbind_simpleocl_OclInstanceModel" = None):
...
class gbind_simpleocl_OclType(LocatedElement):
    ...
    def __init__(self, name: str, context_: "OclContextDefinition" = None, type: "OclExpression" = None, returnType: "Operation" = None, valueType: "MapType" = None, type96: "Attribute" = None, type104: "VariableDeclaration" = None, returnType107: "LambdaType" = None, argumentTypes: "LambdaType" = None, source111: "StaticPropertyCallExp" = None, keyType: "MapType" = None, elementType: "CollectionType" = None, type102: "TupleTypeAttribute" = None):
        self.name = name
