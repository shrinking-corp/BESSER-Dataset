...
def test_assoc_parentState8_link_reassign_clear():
...
def test_assoc_stateMachine14_link_reassign_clear():
    ...
    if hasattr(b1, 'StateMachine15'):
        assert _is_linked(b1, 'StateMachine15', a)
    _safe_set(a, 'transitions', b2)
    assert _is_linked(a, 'transitions', b2)
    if hasattr(b1, 'StateMachine15'):
        assert not _is_linked(b1, 'StateMachine15', a)
    if hasattr(b2, 'StateMachine15'):
        assert _is_linked(b2, 'StateMachine15', a)
    _safe_set(a, 'transitions', None)
    assert not _is_linked(a, 'transitions', b2)
    if hasattr(b2, 'StateMachine15'):
        assert not _is_linked(b2, 'StateMachine15', a)
...
def test_assoc_states18_link_reassign_clear():
    ...
    if hasattr(b1, 'fsm_Region19'):
        assert _is_linked(b1, 'fsm_Region19', a)
    _safe_set(a, 'fsm_State20', b2)
    assert _is_linked(a, 'fsm_State20', b2)
    if hasattr(b1, 'fsm_Region19'):
        assert not _is_linked(b1, 'fsm_Region19', a)
    if hasattr(b2, 'fsm_Region19'):
        assert _is_linked(b2, 'fsm_Region19', a)
    _safe_set(a, 'fsm_State20', None)
    assert not _is_linked(a, 'fsm_State20', b2)
    if hasattr(b2, 'fsm_Region19'):
        assert not _is_linked(b2, 'fsm_Region19', a)
