...
# Classes
td1_Process = Class(name="td1_Process")
td1_State = Class(name="td1_State")
td1_Transition = Class(name="td1_Transition")
td1_Variable = Class(name="td1_Variable")
td1_Port = Class(name="td1_Port")
td1_Trigger = Class(name="td1_Trigger")
td1_Guard = Class(name="td1_Guard")
td1_Action = Class(name="td1_Action")
td1_DataType = Class(name="td1_DataType")
td1_Component = Class(name="td1_Component")
td1_Program = Class(name="td1_Program")
...
td1_Process.attributes={td1_Process_VarSize, td1_Process_StateSize, td1_Process_Name}
...
td1_Variable.attributes={td1_Variable_Name, td1_Variable_initVal}
...
td1_Trigger.attributes={td1_Trigger_ArgSize, td1_Trigger_codeFiacre, td1_Trigger_Body, td1_Trigger_Name}
...
td1_Guard.attributes={td1_Guard_codeFiacre, td1_Guard_Body, td1_Guard_Name}
...
td1_Action.attributes={td1_Action_Body, td1_Action_Name, td1_Action_codeFiacre}
...
td1_Component.attributes={td1_Component_Name, td1_Component_VarSize, td1_Component_ProcessSize}
...
td1_Program.attributes={td1_Program_Name, td1_Program_ComponentSize}
...
domain_model = DomainModel(
    name="td1",
    types={td1_Process, td1_State, td1_Transition, td1_Variable, td1_Port, td1_Trigger, td1_Guard, td1_Action, td1_DataType, td1_Component, td1_Program},
    associations={inTransitions1, process3, outTransitions0, instances29, variables31, ports33, transitions4, variables5, states6, initState8, outPorts9, alluniqueTriggers11, source13, target15, guard17, trigger19, action22, datatype24, processes25, components27, components36, variable38, processes41, datatypes44, arguments47, components50},
    generalizations={},
    metadata=None
)
