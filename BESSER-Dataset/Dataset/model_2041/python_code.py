...
class tp1_State:
    ...
    def __init__(self, name: str, tp1_State: "tp1_StateMachine" = None, from_: "tp1_Transition" = None, to: "tp1_Transition" = None, State: "tp1_Transition" = None, State8: "tp1_Transition" = None):
        self.name = name
    ...
    def from_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_tp1_State__from_", None)
        self.__from_ = value
