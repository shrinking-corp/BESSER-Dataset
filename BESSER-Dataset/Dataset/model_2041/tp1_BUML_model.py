...
# Classes
tp1_StateMachine = Class(name="tp1_StateMachine")
tp1_Transition = Class(name="tp1_Transition")
tp1_State = Class(name="tp1_State")
...
outcoming3: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_", type=tp1_Transition, multiplicity=Multiplicity(0, 1))
    }
)
...
domain_model = DomainModel(
    name="tp1",
    types={tp1_StateMachine, tp1_Transition, tp1_State},
    associations={transition0, state1, outcoming3, incoming4, from_6, to7},
    generalizations={},
    metadata=None
)
