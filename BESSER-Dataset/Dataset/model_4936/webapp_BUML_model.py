...
# Classes
webapp_ServerPage = Class(name="webapp_ServerPage")
webapp_DataStructure = Class(name="webapp_DataStructure")
webapp_DataSourceManager = Class(name="webapp_DataSourceManager")
webapp_Named = Class(name="webapp_Named", is_abstract=True)
webapp_WebApp = Class(name="webapp_WebApp")
Named = Class(name="Named")
webapp_ClientPage = Class(name="webapp_ClientPage")
webapp_Attribute = Class(name="webapp_Attribute")
webapp_UIElement = Class(name="webapp_UIElement")
webapp_Form = Class(name="webapp_Form")
UIElement = Class(name="UIElement")
webapp_ImageViewer = Class(name="webapp_ImageViewer")
...
webapp_ServerPage.methods={webapp_ServerPage_m_request, webapp_ServerPage_m_response}
...
domain_model = DomainModel(
    name="webapp",
    types={webapp_ServerPage, webapp_DataStructure, webapp_DataSourceManager, webapp_Named, webapp_WebApp, Named, webapp_ClientPage, webapp_Attribute, webapp_UIElement, webapp_Form, UIElement, webapp_ImageViewer, webapp_TextArea, webapp_Table, UIElementType},
    associations={serverPages1, entities3, contentProviders5, clientPages0, connectsTo22, content24, generates7, getContents8, manages9, managedBy10, parentOf11, linkedTo12, providesContent14, attributeOf16, linkedBy18, composedOf20},
    generalizations={gen_webapp_WebApp_Named, gen_webapp_UIElement_Named, gen_webapp_ServerPage_Named, gen_webapp_DataStructure_Named, gen_webapp_DataSourceManager_Named, gen_webapp_Attribute_Named, gen_webapp_ClientPage_Named, gen_webapp_Form_UIElement, gen_webapp_ImageViewer_UIElement, gen_webapp_TextArea_UIElement, gen_webapp_Table_UIElement},
    metadata=None
)
