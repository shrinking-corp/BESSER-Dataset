...
class webapp_UIElement(Named):
    ...
    def __init__(self, type: str, webapp_UIElement25: "webapp_DataStructure" = None, webapp_UIElement: "webapp_ClientPage" = None):
        self.type = type
...
class webapp_ServerPage(Named):
    ...
    def __init__(self, webapp_ServerPage: "webapp_WebApp" = None, ServerPage23: "webapp_ClientPage" = None, connectsTo: "webapp_ClientPage" = None, providesContent: set["webapp_DataSourceManager"] = None, managedBy: set["webapp_DataStructure"] = None, ServerPage: "webapp_DataStructure" = None, ServerPage15: "webapp_DataSourceManager" = None):
