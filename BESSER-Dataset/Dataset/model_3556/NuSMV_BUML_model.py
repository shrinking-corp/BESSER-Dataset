...
# Classes
nuSMV_NuSmvModel = Class(name="nuSMV_NuSmvModel")
nuSMV_Module = Class(name="nuSMV_Module")
nuSMV_FormalParameter = Class(name="nuSMV_FormalParameter")
nuSMV_ModuleElement = Class(name="nuSMV_ModuleElement")
nuSMV_VariableDeclaration = Class(name="nuSMV_VariableDeclaration")
ModuleElement = Class(name="ModuleElement")
nuSMV_VarBody = Class(name="nuSMV_VarBody")
nuSMV_IVariableDeclaration = Class(name="nuSMV_IVariableDeclaration")
nuSMV_FrozenVariableDeclaration = Class(name="nuSMV_FrozenVariableDeclaration")
nuSMV_Type = Class(name="nuSMV_Type")
nuSMV_DefineDeclaration = Class(name="nuSMV_DefineDeclaration")
nuSMV_DefineBody = Class(name="nuSMV_DefineBody")
nuSMV_SimpleExpression = Class(name="nuSMV_SimpleExpression")
nuSMV_ConstantsDeclaration = Class(name="nuSMV_ConstantsDeclaration")
nuSMV_AssignConstraintElement = Class(name="nuSMV_AssignConstraintElement")
nuSMV_AssignBody = Class(name="nuSMV_AssignBody")
nuSMV_EObject = Class(name="nuSMV_EObject")
nuSMV_VarBodyAssign = Class(name="nuSMV_VarBodyAssign")
AssignBody = Class(name="AssignBody")
nuSMV_InitBody = Class(name="nuSMV_InitBody")
nuSMV_NextBody = Class(name="nuSMV_NextBody")
nuSMV_NextExpression = Class(name="nuSMV_NextExpression")
nuSMV_TransConstraint = Class(name="nuSMV_TransConstraint")
nuSMV_InitConstraint = Class(name="nuSMV_InitConstraint")
nuSMV_FairnessConstraint = Class(name="nuSMV_FairnessConstraint")
nuSMV_FairnessExpression = Class(name="nuSMV_FairnessExpression")
FairnessConstraint = Class(name="FairnessConstraint")
nuSMV_JusticeExpression = Class(name="nuSMV_JusticeExpression")
nuSMV_CompassionExpression = Class(name="nuSMV_CompassionExpression")
nuSMV_CtlSpecification = Class(name="nuSMV_CtlSpecification")
nuSMV_CTLExpression = Class(name="nuSMV_CTLExpression")
nuSMV_InvarSpecification = Class(name="nuSMV_InvarSpecification")
nuSMV_IsaDeclaration = Class(name="nuSMV_IsaDeclaration")
nuSMV_LtlSpecification = Class(name="nuSMV_LtlSpecification")
nuSMV_LTLExpression = Class(name="nuSMV_LTLExpression")
nuSMV_InvarConstraint = Class(name="nuSMV_InvarConstraint")
Type = Class(name="Type")
nuSMV_ModuleType = Class(name="nuSMV_ModuleType")
nuSMV_Val = Class(name="nuSMV_Val")
nuSMV_CaseSimpleExpression = Class(name="nuSMV_CaseSimpleExpression")
SimpleExpression = Class(name="SimpleExpression")
nuSMV_CaseSimpleAssignementExpression = Class(name="nuSMV_CaseSimpleAssignementExpression")
nuSMV_RangeExpression = Class(name="nuSMV_RangeExpression")
nuSMV_RTCTLExpression = Class(name="nuSMV_RTCTLExpression")
nuSMV_ComputeSpecification = Class(name="nuSMV_ComputeSpecification")
nuSMV_SimpleType = Class(name="nuSMV_SimpleType")
nuSMV_BooleanType = Class(name="nuSMV_BooleanType")
SimpleType = Class(name="SimpleType")
nuSMV_WordType = Class(name="nuSMV_WordType")
nuSMV_UnsignedWordType = Class(name="nuSMV_UnsignedWordType")
nuSMV_SignedWordType = Class(name="nuSMV_SignedWordType")
nuSMV_EnumType = Class(name="nuSMV_EnumType")
nuSMV_IntervalType = Class(name="nuSMV_IntervalType")
nuSMV_ArrayType = Class(name="nuSMV_ArrayType")
nuSMV_AsyncrProcessType = Class(name="nuSMV_AsyncrProcessType")
ModuleType = Class(name="ModuleType")
nuSMV_SyncrProcessType = Class(name="nuSMV_SyncrProcessType")
nuSMV_BinaryExpression = Class(name="nuSMV_BinaryExpression")
nuSMV_Not = Class(name="nuSMV_Not")
nuSMV_ParsExpression = Class(name="nuSMV_ParsExpression")
nuSMV_UnaryExpression = Class(name="nuSMV_UnaryExpression")
nuSMV_ValueExpression = Class(name="nuSMV_ValueExpression")
nuSMV_Var = Class(name="nuSMV_Var")
nuSMV_SetElementExpression = Class(name="nuSMV_SetElementExpression")
nuSMV_SetValueParameter = Class(name="nuSMV_SetValueParameter")
nuSMV_SetExpression = Class(name="nuSMV_SetExpression")
nuSMV_WordExpression = Class(name="nuSMV_WordExpression")
nuSMV_IntervalExpression = Class(name="nuSMV_IntervalExpression")
nuSMV_UntilCTLexpression = Class(name="nuSMV_UntilCTLexpression")
nuSMV_UnaryFunctionExpression = Class(name="nuSMV_UnaryFunctionExpression")
nuSMV_SingleRTCTLExpression = Class(name="nuSMV_SingleRTCTLExpression")
RTCTLExpression = Class(name="RTCTLExpression")
nuSMV_UnaryRTCTLExpression = Class(name="nuSMV_UnaryRTCTLExpression")
...
nuSMV_CtlSpecification.attributes={nuSMV_CtlSpecification_specKeyWord, nuSMV_CtlSpecification_name, nuSMV_CtlSpecification_semicolon, nuSMV_CtlSpecification_nameKeyWord}
...
nuSMV_InvarSpecification.attributes={nuSMV_InvarSpecification_semicolon, nuSMV_InvarSpecification_name}
...
nuSMV_LtlSpecification.attributes={nuSMV_LtlSpecification_name, nuSMV_LtlSpecification_semicolon, nuSMV_LtlSpecification_nameId}
...
nuSMV_RangeExpression.attributes={nuSMV_RangeExpression_lower, nuSMV_RangeExpression_upper}
...
nuSMV_ArrayType.attributes={nuSMV_ArrayType_lowerBound, nuSMV_ArrayType_upperBound}
...
nuSMV_BinaryExpression.attributes={nuSMV_BinaryExpression_op, nuSMV_BinaryExpression_operator}
...
nuSMV_IntervalExpression.attributes={nuSMV_IntervalExpression_lowerBound, nuSMV_IntervalExpression_upperBound}
...
domain_model = DomainModel(
    name="nuSMV",
    types={nuSMV_NuSmvModel, nuSMV_Module, nuSMV_FormalParameter, nuSMV_ModuleElement, nuSMV_VariableDeclaration, ModuleElement, nuSMV_VarBody, nuSMV_IVariableDeclaration, nuSMV_FrozenVariableDeclaration, nuSMV_Type, nuSMV_DefineDeclaration, nuSMV_DefineBody, nuSMV_SimpleExpression, nuSMV_ConstantsDeclaration, nuSMV_AssignConstraintElement, nuSMV_AssignBody, nuSMV_EObject, nuSMV_VarBodyAssign, AssignBody, nuSMV_InitBody, nuSMV_NextBody, nuSMV_NextExpression, nuSMV_TransConstraint, nuSMV_InitConstraint, nuSMV_FairnessConstraint, nuSMV_FairnessExpression, FairnessConstraint, nuSMV_JusticeExpression, nuSMV_CompassionExpression, nuSMV_CtlSpecification, nuSMV_CTLExpression, nuSMV_InvarSpecification, nuSMV_IsaDeclaration, nuSMV_LtlSpecification, nuSMV_LTLExpression, nuSMV_InvarConstraint, Type, nuSMV_ModuleType, nuSMV_Val, nuSMV_CaseSimpleExpression, SimpleExpression, nuSMV_CaseSimpleAssignementExpression, nuSMV_RangeExpression, nuSMV_RTCTLExpression, nuSMV_ComputeSpecification, nuSMV_SimpleType, nuSMV_BooleanType, SimpleType, nuSMV_WordType, nuSMV_UnsignedWordType, nuSMV_SignedWordType, nuSMV_EnumType, nuSMV_IntervalType, nuSMV_ArrayType, nuSMV_AsyncrProcessType, ModuleType, nuSMV_SyncrProcessType, nuSMV_BinaryExpression, nuSMV_Not, nuSMV_ParsExpression, nuSMV_UnaryExpression, nuSMV_ValueExpression, nuSMV_Var, nuSMV_SetElementExpression, nuSMV_SetValueParameter, nuSMV_SetExpression, nuSMV_WordExpression, nuSMV_IntervalExpression, nuSMV_UntilCTLexpression, nuSMV_UnaryFunctionExpression, nuSMV_SingleRTCTLExpression, RTCTLExpression, nuSMV_UnaryRTCTLExpression, operators},
    associations={modules0, params1, moduleElement3, vars5, vars6, vars8, type10, defineBodies12, assignment13, bodies15, var16, dotted18, assignment21, initial23, next25, transExpression26, initExpression28, invarExpression30, fairnessExpr32, justiceExpr34, firstExpr36, secondExpr38, ctlExpression41, invarSpec42, ltlExpression44, module45, params47, par50, simpleExpression53, branches56, case57, assignment60, simpleExpression63, simpleExpression66, first69, second70, val73, type74, left75, right77, exp80, simpleExpression82, simpleExpression84, value86, dotted88, val91, valparam93, setElement95, arg97, arg99, ctlExpression101, range103, rctl104},
    generalizations={gen_nuSMV_VariableDeclaration_ModuleElement, gen_nuSMV_IVariableDeclaration_ModuleElement, gen_nuSMV_FrozenVariableDeclaration_ModuleElement, gen_nuSMV_DefineDeclaration_ModuleElement, gen_nuSMV_ConstantsDeclaration_ModuleElement, gen_nuSMV_AssignConstraintElement_ModuleElement, gen_nuSMV_VarBodyAssign_AssignBody, gen_nuSMV_InitBody_AssignBody, gen_nuSMV_NextBody_AssignBody, gen_nuSMV_TransConstraint_ModuleElement, gen_nuSMV_InitConstraint_ModuleElement, gen_nuSMV_InvarConstraint_ModuleElement, gen_nuSMV_FairnessConstraint_ModuleElement, gen_nuSMV_FairnessExpression_FairnessConstraint, gen_nuSMV_JusticeExpression_FairnessConstraint, gen_nuSMV_CompassionExpression_FairnessConstraint, gen_nuSMV_CtlSpecification_ModuleElement, gen_nuSMV_InvarSpecification_ModuleElement, gen_nuSMV_IsaDeclaration_ModuleElement, gen_nuSMV_LtlSpecification_ModuleElement, gen_nuSMV_SimpleType_Type, gen_nuSMV_ModuleType_Type, gen_nuSMV_CaseSimpleExpression_SimpleExpression, gen_nuSMV_ComputeSpecification_ModuleElement, gen_nuSMV_BooleanType_SimpleType, gen_nuSMV_WordType_SimpleType, gen_nuSMV_UnsignedWordType_SimpleType, gen_nuSMV_SignedWordType_SimpleType, gen_nuSMV_EnumType_SimpleType, gen_nuSMV_IntervalType_SimpleType, gen_nuSMV_ArrayType_SimpleType, gen_nuSMV_AsyncrProcessType_ModuleType, gen_nuSMV_SyncrProcessType_ModuleType, gen_nuSMV_BinaryExpression_SimpleExpression, gen_nuSMV_Not_SimpleExpression, gen_nuSMV_ParsExpression_SimpleExpression, gen_nuSMV_UnaryExpression_SimpleExpression, gen_nuSMV_ValueExpression_SimpleExpression, gen_nuSMV_Var_SimpleExpression, gen_nuSMV_SetElementExpression_SimpleExpression, gen_nuSMV_SetValueParameter_SimpleExpression, gen_nuSMV_SetExpression_SimpleExpression, gen_nuSMV_WordExpression_SimpleExpression, gen_nuSMV_IntervalExpression_SimpleExpression, gen_nuSMV_UntilCTLexpression_SimpleExpression, gen_nuSMV_SingleRTCTLExpression_RTCTLExpression, gen_nuSMV_UnaryRTCTLExpression_RTCTLExpression, gen_nuSMV_UnaryFunctionExpression_SimpleExpression},
    metadata=None
)
