...
class WT_Subsystem:
    ...
    def __init__(self, name: str, WT_Subsystem: "WT_WTComponents" = None, WT_Subsystem3: "WT_Subsystem" = None, WT_Subsystem1: set["WT_Subsystem"] = None, WT_Subsystem7: set["WT_ControlSubsystem"] = None, WT_Subsystem5: set["WT_Architecture"] = None):
        self.name = name
