...
domain_model = DomainModel(
    name="WT",
    types={WT_WTComponents, WT_Subsystem, WT_ControlSubsystem, WT_Component, WT_StateMachine, WT_Vertex, WT_Edge, DocumentElt, WT_Architecture, WT_InitialState, Vertex, WT_SimpleState, WT_Port, WT_InPort, Port, WT_OutPort, WT_DocumentElt},
    associations={subsystems0, subsystems2, beh6, elements8, states10, states12, transitions14, outgoing16, incoming17, ensembles4, target20, ports22, states24, source19},
