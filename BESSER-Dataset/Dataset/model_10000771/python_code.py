...
class Hand:
    ...
    def __init__(self, total: int, cards: Card, dealer23: "Dealer" = None, player25: "Player" = None, card26: set["Card"] = None):
        self.total = total
        self.cards = cards
...
class PlayerView:
    ...
    def __init__(self, cardTotal: JLabel, busted: JLabel, moneyBox: JLabel, status: JLabel, player: BasePlayer, cardLabels: JLabel, gameView10: "GameView" = None, basePlayer19: "BasePlayer" = None):
