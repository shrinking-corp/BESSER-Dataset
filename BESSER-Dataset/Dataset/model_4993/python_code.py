...
class avm_Resource:
    ...
    def __init__(self, Name: str, Path: str, Hash: str, ID: str, Notes: str, XPosition: str, YPosition: str, avm_Resource: "avm_Component" = None, avm_Resource19: "avm_DomainModel_" = None, avm_Resource68: "avm_DataSource" = None, avm_Resource74: "avm_Design" = None, avm_Resource99: "avm_Container" = None, avm_Resource105: "avm_Container" = None):
        self.Name = Name
        self.Path = Path
        self.Hash = Hash
        self.ID = ID
...
class avm_Value(ValueNode):
    ...
    def __init__(self, DimensionType: str, DataType: str, Dimensions: str, Unit: str, avm_Value: "avm_ValueExpressionType" = None, avm_Value22: set["avm_DataSource"] = None, avm_Value54: "avm_DomainModelMetric" = None, avm_Value56: "avm_PrimitiveProperty" = None, avm_Value147: "avm_TestBenchValueBase" = None, avm_Value115: "avm_ComponentPrimitivePropertyInstance" = None):
...
class avm_Property(ABC):
    ...
    def __init__(self, Name: str, OnDataSheet: str, Notes: str, Definition: str, ID: str, XPosition: str, YPosition: str, avm_Property: "avm_Component" = None, avm_Property80: "avm_Container" = None, avm_Property29: "avm_Connector" = None):
        self.Name = Name
...
class avm_adamsCar_FileReference:
    ...
    def __init__(self, FilePath: str, ID: str, Name: str, avm_adamsCar_FileReference: set["Parameter"] = None, avm_adamsCar_FileReference307: set["FileReference"] = None):
...
class avm_eda_RelativeLayoutConstraint(PcbLayoutConstraint):
    ...
    def __init__(self, XOffset: str, YOffset: str, RelativeLayer: str, RelativeRotation: str, avm_eda_RelativeLayoutConstraint: set["eda_avm_ComponentInstance"] = None, avm_eda_RelativeLayoutConstraint270: "eda_avm_ComponentInstance" = None, avm_eda_RelativeLayoutConstraint273: set["eda_avm_Container"] = None):
...
class avm_modelica_SolverSettings(Settings):
    ...
    def __init__(self, Tolerance: str, Solver: str, JobManagerToolSelection: str, StartTime: str, StopTime: str, IntervalMethod: str, NumberOfIntervals: str, IntervalLength: str, ToolSpecificAnnotations: str):
...
class avm_schematic_Pin(DomainModelPort):
    ...
    def __init__(self, EDASymbolLocationY: str, EDASymbolRotation: str, SPICEPortNumber: str, EDAGate: str, EDASymbolLocationX: str):
...
class avm_cad_CADModel(DomainModel_):
    ...
    def __init__(self, Format: str, avm_cad_CADModel177: set["Metric"] = None, avm_cad_CADModel: set["Datum"] = None, avm_cad_CADModel174: set["Parameter"] = None):
        self.Format = Format
...
class avm_manufacturing_ManufacturingModel(DomainModel_):
    ...
    pass
class avm_adamsCar_AdamsCarModel(DomainModel_):
...
class avm_InterpreterTask(WorkflowTaskBase):
    ...
    def __init__(self, Parameters: str, COMName: str):
...
class avm_TestBench:
    ...
    def __init__(self, Name: str, avm_TestBench: "avm_TopLevelSystemUnderTest" = None, avm_TestBench131: set["avm_Parameter"] = None, avm_TestBench133: set["avm_Metric"] = None, avm_TestBench135: set["avm_TestInjectionPoint"] = None, avm_TestBench137: set["avm_ComponentInstance"] = None, avm_TestBench140: "avm_Workflow" = None, avm_TestBench142: set["avm_Settings"] = None, avm_TestBench144: set["avm_DomainModel_"] = None):
        self.Name = Name
...
class avm_Container(ABC):
    ...
    def __init__(self, XPosition: str, Name: str, YPosition: str, ID: str, Description: str, Classifications: str, avm_Container: "avm_Design" = None, avm_Container96: set["avm_ContainerFeature"] = None, avm_Container77: "avm_Container" = None, avm_Container75: set["avm_Container"] = None, avm_Container79: set["avm_Property"] = None, avm_Container82: set["avm_ComponentInstance"] = None, avm_Container84: set["avm_Port"] = None, avm_Container87: set["avm_Connector"] = None, avm_Container90: set["avm_assemblyDetail"] = None, avm_Container93: set["avm_Formula"] = None, avm_Container98: set["avm_Resource"] = None, avm_Container101: set["avm_DomainModel_"] = None, avm_Container104: set["avm_Resource"] = None):
        self.XPosition = XPosition
        self.Name = Name
        self.YPosition = YPosition
        self.ID = ID
...
class avm_Port(PortMapTarget):
    ...
    def __init__(self, Notes: str, XPosition: str, Definition: str, YPosition: str, Name: str, avm_Port: "avm_Component" = None, avm_Port85: "avm_Container" = None, avm_Port26: "avm_Connector" = None):
        self.Notes = Notes
        self.XPosition = XPosition
        self.Definition = Definition
        self.YPosition = YPosition
...
class avm_Connector(ConnectorCompositionTarget):
    ...
    def __init__(self, Definition: str, Name: str, Notes: str, XPosition: str, YPosition: str, avm_Connector: "avm_Component" = None, avm_Connector31: set["avm_assemblyDetail"] = None, avm_Connector34: "avm_Connector" = None, avm_Connector32: set["avm_Connector"] = None, avm_Connector88: "avm_Container" = None, avm_Connector25: set["avm_Port"] = None, avm_Connector28: set["avm_Property"] = None, avm_Connector36: set["avm_ConnectorFeature"] = None):
        self.Definition = Definition
        self.Name = Name
        self.Notes = Notes
        self.XPosition = XPosition
