...
domain_model = DomainModel(
    name="QVTOperational",
    types={QVTOperational_Constructor, ImperativeOperation, QVTOperational_ConstructorBody, OperationBody, QVTOperational_ContextualProperty, QVTOperational_EntryOperation, QVTOperational_ImperativeCallExp, QVTOperational_ImperativeOperation, VarParameter, QVTOperational_Library, QVTOperational_Helper, QVTOperational_MappingCallExp, ImperativeCallExp, QVTOperational_MappingOperation, MappingOperation, Module, QVTOperational_MappingBody, QVTOperational_MappingParameter, ModelParameter, QVTOperational_ModelParameter, QVTOperational_ModelType, QVTOperational_Module, ModuleImport, ModelType, QVTOperational_ModuleImport, EntryOperation, ConstructorBody, QVTOperational_OperationBody, QVTOperational_OperationalTransformation, QVTOperational_ObjectExp, QVTOperational_ResolveExp, QVTOperational_ResolveInExp, ResolveExp, QVTOperational_VarParameter, DirectionKind, ImportKind},
    associations={body0, context1, overridden3, result5, disjunct8, inherited9, merged12, extent15, moduleImport17, usedModelType19, binding21, importedModule23, entry16, body28, operation29, module25, inMapping33, ctxOwner35, resOwner37, modelParameter31},
    generalizations={gen_QVTOperational_Constructor_ImperativeOperation, gen_QVTOperational_ConstructorBody_OperationBody, gen_QVTOperational_EntryOperation_ImperativeOperation, gen_QVTOperational_Helper_ImperativeOperation, gen_QVTOperational_MappingCallExp_ImperativeCallExp, gen_QVTOperational_MappingOperation_ImperativeOperation, gen_QVTOperational_Library_Module, gen_QVTOperational_MappingBody_OperationBody, gen_QVTOperational_MappingParameter_VarParameter, gen_QVTOperational_ModelParameter_VarParameter, gen_QVTOperational_OperationalTransformation_Module, gen_QVTOperational_ResolveInExp_ResolveExp},
    metadata=None
)
