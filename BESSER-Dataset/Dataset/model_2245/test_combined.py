...
def test_hyp_prosjekt_institute_is_not_abstract():
    assert not inspect.isabstract(prosjekt_Institute)


def test_hyp_prosjekt_institute_constructor_exists():
    assert callable(prosjekt_Institute.__init__)


def test_hyp_prosjekt_institute_constructor_args():
...
def test_hyp_prosjekt_coursecoordinator_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_prosjekt_course_avgGrade_setter(instance):
...
def test_hyp_prosjekt_institute_shortName_setter(instance):
...
@given(instance=prosjekt_Institute_strategy)
def test_hyp_prosjekt_institute_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
