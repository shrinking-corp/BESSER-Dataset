...
class prosjekt_CourseCoordinator:
    ...
    def __init__(self, name: str, CourseCoordinator8: "prosjekt_Course" = None, CourseCoordinator: "prosjekt_Institute" = None, courseCoordinator: "prosjekt_Course" = None, courseCoordinator14: "prosjekt_Institute" = None):
        self.name = name
...
class prosjekt_Course:
    ...
    def __init__(self, name: str, code: str, avgGrade: int, studyPoints: float, course7: set["prosjekt_CourseCoordinator"] = None, Course: "prosjekt_Institute" = None, course: "prosjekt_Institute" = None, course5: "prosjekt_Semester" = None, Course10: "prosjekt_Semester" = None, Course12: "prosjekt_CourseCoordinator" = None):
        self.name = name
        self.code = code
