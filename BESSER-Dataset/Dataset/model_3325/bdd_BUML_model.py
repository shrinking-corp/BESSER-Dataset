...
sample_Variable = Class(name="sample_Variable")
sample_Annotation = Class(name="sample_Annotation")
sample_Story = Class(name="sample_Story")
sample_Register = Class(name="sample_Register")
...
sample_Variable.attributes={sample_Variable_Name, sample_Variable_Value, sample_Variable_Type}
...
sample_Story.attributes={sample_Story_Role, sample_Story_Feature, sample_Story_Benefit, sample_Story_Title}
...
domain_model = DomainModel(
    name="sample",
    types={sample_Scenario, sample_When, sample_Given, sample_Then, sample_Sentence, sample_Variable, sample_Annotation, sample_Story, sample_Register},
    associations={scenarios0, when1, given3, then5, sentences7, sentences9, sentences12, variables15, annotation17, stories19},
    generalizations={},
    metadata=None
)
