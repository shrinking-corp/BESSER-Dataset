...
Customer.attributes={Customer_id, Customer_phoneno, Customer_name, Customer_address, Customer_mailid}
...
Feedback.attributes={Feedback_phoneno, Feedback_customername, Feedback_id}
...
domain_model = DomainModel(
    name="_6b766039_5dac_45b0_9490_96062bac853b",
    ...
    associations={CUSTOMER_VISITS_THE_WEBSITE, CUSTOMER_SELECTS_THE_ITEMS_SERVICE, CUSTOMER_ADDS_ITEMS_SERVICE_TO_CART, CUSTOMER_SELECTS_THE_MODE_OF_PAYMENT, CUSTOMER_PAYS_THE_BILL, CUSTOMER_SUPPORT_AND_FEEDBACK, SELECTS_THE_MODE_OF_PAYMENT_ADMINISTRATOR, PAYS_THE_BILL_ADMINISTRATOR, DELIVERS_THE_PRODUCT_ADMINISTRATOR, MAINTAINS_THE_PRODUCTS_SERVICES_ADMINISTRATOR, SUPPORT_AND_FEEDBACK_ADMINISTRATOR, ORDER_PRODUCT, Customer_Customercare, Warehouse_Shipment, Product_Warehouse, CREATES_THE_WEBSITE_WEB_DEVELOPER},
    generalizations={},
    metadata=None
)
