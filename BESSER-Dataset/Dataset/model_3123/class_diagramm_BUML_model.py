...
class_diagramm_RefAssociation = Class(name="class_diagramm_RefAssociation", is_abstract=True)
class_diagramm_Package = Class(name="class_diagramm_Package")
class_diagramm_RefAttribute = Class(name="class_diagramm_RefAttribute", is_abstract=True)
class_diagramm_RefMethod = Class(name="class_diagramm_RefMethod", is_abstract=True)
class_diagramm_RefClass = Class(name="class_diagramm_RefClass", is_abstract=True)
class_diagramm_DataType = Class(name="class_diagramm_DataType")
RefDataType = Class(name="RefDataType")
class_diagramm_Method = Class(name="class_diagramm_Method")
RefMethod = Class(name="RefMethod")
class_diagramm_RefParameter = Class(name="class_diagramm_RefParameter", is_abstract=True)
class_diagramm_RefDataType = Class(name="class_diagramm_RefDataType", is_abstract=True)
class_diagramm_Attribute = Class(name="class_diagramm_Attribute")
RefAttribute = Class(name="RefAttribute")
class_diagramm_Parameter = Class(name="class_diagramm_Parameter")
RefParameter = Class(name="RefParameter")
class_diagramm_Class = Class(name="class_diagramm_Class")
RefClass = Class(name="RefClass")
class_diagramm_Association = Class(name="class_diagramm_Association")
RefAssociation = Class(name="RefAssociation")
class_diagramm_RefPackage = Class(name="class_diagramm_RefPackage", is_abstract=True)
...
class_diagramm_Class.attributes={class_diagramm_Class_name, class_diagramm_Class_modifier}
...
class_diagramm_Association.attributes={class_diagramm_Association_maxCardinality, class_diagramm_Association_isAggregation, class_diagramm_Association_minCardinality, class_diagramm_Association_name}
...
return_3: BinaryAssociation = BinaryAssociation(
    name="return_3",
    ends={
...
domain_model = DomainModel(
    name="class_diagramm",
    types={RefPackage, class_diagramm_RefAssociation, class_diagramm_Package, class_diagramm_RefAttribute, class_diagramm_RefMethod, class_diagramm_RefClass, class_diagramm_DataType, RefDataType, class_diagramm_Method, RefMethod, class_diagramm_RefParameter, class_diagramm_RefDataType, class_diagramm_Attribute, RefAttribute, class_diagramm_Parameter, RefParameter, class_diagramm_Class, RefClass, class_diagramm_Association, RefAssociation, class_diagramm_RefPackage, ModifierType},
    associations={associations0, parent19, attributes21, methods23, classes1, return_3, parameters5, primitive_return7, type9, primitive_type11, type14, primitive_type16, source25, target27},
    generalizations={gen_class_diagramm_Package_RefPackage, gen_class_diagramm_DataType_RefDataType, gen_class_diagramm_Method_RefMethod, gen_class_diagramm_Attribute_RefAttribute, gen_class_diagramm_Parameter_RefParameter, gen_class_diagramm_Class_RefClass, gen_class_diagramm_Association_RefAssociation},
    metadata=None
)
