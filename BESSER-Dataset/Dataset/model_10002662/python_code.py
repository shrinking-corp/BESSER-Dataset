...
class ADMIN:
    ...
    def __init__(self, id: str, password: str, sTUDENT45: set["STUDENT"] = None, pARENT47: set["PARENT"] = None, fACULTY43: set["FACULTY"] = None):
        self.id = id
...
class STUDENT:
    ...
    def __init__(self, id: str, password: str, aDMIN44: "ADMIN" = None, fACULTY41: set["FACULTY"] = None):
        self.id = id
        self.password = password
