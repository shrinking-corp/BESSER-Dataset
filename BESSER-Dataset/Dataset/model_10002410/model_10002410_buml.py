...
Food.attributes={Food_price, Food_prepared, Food_type, Food_name, Food_description, Food_food_Id, Food_served}
...
Booking.attributes={Booking_reservedTables, Booking_contact, Booking_date, Booking_name, Booking_type, Booking_booking_Id}
...
Table.attributes={Table_specialRequest, Table_table_Id, Table_occupied, Table_numSeats, Table_order}
...
domain_model = DomainModel(
    name="b056eefc_45d9_42ca_8f32_382fdfa3c61e",
    types={Order, Food, Manager, Waiter, Chef, Staff, RMS, Report, Booking, Table},
