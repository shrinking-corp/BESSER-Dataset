...
# Classes
aGES_Domainmodel = Class(name="aGES_Domainmodel")
aGES_AbstractElement = Class(name="aGES_AbstractElement")
aGES_PackageDeclaration = Class(name="aGES_PackageDeclaration")
AbstractElement = Class(name="AbstractElement")
aGES_Import = Class(name="aGES_Import")
aGES_Type = Class(name="aGES_Type")
aGES_DataType = Class(name="aGES_DataType")
Type = Class(name="Type")
aGES_Entity = Class(name="aGES_Entity")
aGES_Feature = Class(name="aGES_Feature")
...
domain_model = DomainModel(
    name="aGES",
    types={aGES_Domainmodel, aGES_AbstractElement, aGES_PackageDeclaration, AbstractElement, aGES_Import, aGES_Type, aGES_DataType, Type, aGES_Entity, aGES_Feature},
