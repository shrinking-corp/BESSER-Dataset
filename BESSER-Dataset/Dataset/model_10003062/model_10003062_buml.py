...
Customer.attributes={Customer_name, Customer_phoneNumber, Customer_dateOfBirth, Customer_address, Customer_emailAddress}
...
Login.attributes={Login_password, Login_securityAnswer, Login_lastLoginTime, Login_securityQuestion, Login_username}
...
domain_model = DomainModel(
    name="fa3121a8_1ddc_466a_9286_82bcbfafbf01",
    types={Customer, Login, transaction_Transaction, transaction_DepositTransaction, transaction_WithdrawTransaction, transaction_TransferTransaction, account_SavingsAccount, account_CertificatesOfDepositAccount, account_CheckingAccount, account_Account, account_AccountType, transaction_TransactionType},
