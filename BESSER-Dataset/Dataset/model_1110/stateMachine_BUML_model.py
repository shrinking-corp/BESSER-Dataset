...
stateMachine_State.attributes={stateMachine_State_name, stateMachine_State_status}
...
stateMachine_Transition.attributes={stateMachine_Transition_action, stateMachine_Transition_trigger, stateMachine_Transition_name}
...
from_9: BinaryAssociation = BinaryAssociation(
    name="from_9",
    ends={
...
domain_model = DomainModel(
    ...
    associations={state0, transition1, initialState3, Outgoing6, incoming7, from_9, target10},
    generalizations={},
    metadata=None
)
