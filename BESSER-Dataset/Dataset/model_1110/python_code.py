...
class stateMachine_State:
    ...
    def __init__(self, name: str, status: bool, stateMachine_State: "stateMachine_StateMachine" = None, stateMachine_State5: "stateMachine_StateMachine" = None, from_: set["stateMachine_Transition"] = None, target: set["stateMachine_Transition"] = None, State: "stateMachine_Transition" = None, State11: "stateMachine_Transition" = None):
        self.name = name
        self.status = status
    ...
    def from_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_stateMachine_State__from_", None)
