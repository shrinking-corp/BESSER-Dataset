...
DDL_CreatePk = Class(name="DDL_CreatePk")
DDL_CreateFk = Class(name="DDL_CreateFk")
DDL_CreateTable = Class(name="DDL_CreateTable")
DDL_CreateCommentTable = Class(name="DDL_CreateCommentTable")
DDL_CreateCommentColumn = Class(name="DDL_CreateCommentColumn")
DDL_DDLDefinition = Class(name="DDL_DDLDefinition")
DDL_CreateCk = Class(name="DDL_CreateCk")
DDL_CreateColumn = Class(name="DDL_CreateColumn")
DDL_CreateDatabase = Class(name="DDL_CreateDatabase")
...
DDL_CreatePk.attributes={DDL_CreatePk_columnName, DDL_CreatePk_namePk}
...
DDL_CreateFk.attributes={DDL_CreateFk_columnReference, DDL_CreateFk_columnName, DDL_CreateFk_nameFk}
...
DDL_CreateCommentColumn.attributes={DDL_CreateCommentColumn_columnName, DDL_CreateCommentColumn_tableName, DDL_CreateCommentColumn_columnComment}
...
DDL_CreateCk.attributes={DDL_CreateCk_nameCk, DDL_CreateCk_valuesCk, DDL_CreateCk_nameColumn}
...
DDL_CreateColumn.attributes={DDL_CreateColumn_columnType, DDL_CreateColumn_columnName, DDL_CreateColumn_commentColumn, DDL_CreateColumn_columnNull}
...
domain_model = DomainModel(
    name="DDL",
    types={DDL_Statement, DDL_DataDefinition, Statement, DDL_CreatePk, DDL_CreateFk, DDL_CreateTable, DDL_CreateCommentTable, DDL_CreateCommentColumn, DDL_DDLDefinition, DDL_CreateCk, DDL_CreateColumn, DDL_CreateDatabase, DataDefinition},
    associations={references0, columns1, columnsPk3, columnsFk5, checks8, statements10},
    generalizations={gen_DDL_DataDefinition_Statement, gen_DDL_CreateTable_DataDefinition, gen_DDL_CreateCommentTable_DataDefinition, gen_DDL_CreateCommentColumn_DataDefinition, gen_DDL_CreateDatabase_DataDefinition},
    metadata=None
)
