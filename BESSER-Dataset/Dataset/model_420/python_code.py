...
class UML2_Class(BehavioredClassifier, EncapsulatedClassifier):
    ...
    def __init__(self, isActive: bool, UML2_Class22: set["UML2_Reception"] = None, UML2_Class: set["UML2_Classifier"] = None):
