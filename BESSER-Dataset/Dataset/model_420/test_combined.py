...
def test_assoc_association48_link_reassign_clear():
...
def test_assoc_classifier41_link_reassign_clear():
...
def test_assoc_classifier70_link_reassign_clear():
    a = UML2_Classifier(isAbstract=True)
    b1 = UML2_InstanceSpecification()
    b2 = UML2_InstanceSpecification()
    _safe_set(a, 'UML2_Classifier72', b1)
    assert _is_linked(a, 'UML2_Classifier72', b1)
    if hasattr(b1, 'UML2_InstanceSpecification71'):
        assert _is_linked(b1, 'UML2_InstanceSpecification71', a)
    _safe_set(a, 'UML2_Classifier72', b2)
    assert _is_linked(a, 'UML2_Classifier72', b2)
    if hasattr(b1, 'UML2_InstanceSpecification71'):
        assert not _is_linked(b1, 'UML2_InstanceSpecification71', a)
    if hasattr(b2, 'UML2_InstanceSpecification71'):
        assert _is_linked(b2, 'UML2_InstanceSpecification71', a)
    _safe_set(a, 'UML2_Classifier72', None)
    assert not _is_linked(a, 'UML2_Classifier72', b2)
    if hasattr(b2, 'UML2_InstanceSpecification71'):
        assert not _is_linked(b2, 'UML2_InstanceSpecification71', a)
...
def test_assoc_definingFeature12_link_reassign_clear():
...
def test_assoc_end8_link_reassign_clear():
    ...
    if hasattr(b1, 'UML2_LinkEndData9'):
        assert _is_linked(b1, 'UML2_LinkEndData9', a)
    _safe_set(a, 'UML2_Property', b2)
    assert _is_linked(a, 'UML2_Property', b2)
    if hasattr(b1, 'UML2_LinkEndData9'):
        assert not _is_linked(b1, 'UML2_LinkEndData9', a)
    if hasattr(b2, 'UML2_LinkEndData9'):
        assert _is_linked(b2, 'UML2_LinkEndData9', a)
    _safe_set(a, 'UML2_Property', None)
    assert not _is_linked(a, 'UML2_Property', b2)
    if hasattr(b2, 'UML2_LinkEndData9'):
        assert not _is_linked(b2, 'UML2_LinkEndData9', a)


def test_assoc_feature1_link_reassign_clear():
...
def test_assoc_featuringClassifier62_link_reassign_clear():
    a = UML2_Feature(isStatic=True)
    b1 = UML2_Classifier(isAbstract=True)
    b2 = UML2_Classifier(isAbstract=False)
    _safe_set(a, 'UML2_Feature63', {b1})
    assert _is_linked(a, 'UML2_Feature63', b1)
    if hasattr(b1, 'UML2_Classifier64'):
        assert _is_linked(b1, 'UML2_Classifier64', a)
    _safe_set(a, 'UML2_Feature63', {b2})
    assert _is_linked(a, 'UML2_Feature63', b2)
    if hasattr(b1, 'UML2_Classifier64'):
        assert not _is_linked(b1, 'UML2_Classifier64', a)
    if hasattr(b2, 'UML2_Classifier64'):
        assert _is_linked(b2, 'UML2_Classifier64', a)
    _safe_set(a, 'UML2_Feature63', set())
    assert not _is_linked(a, 'UML2_Feature63', b2)
    if hasattr(b2, 'UML2_Classifier64'):
        assert not _is_linked(b2, 'UML2_Classifier64', a)


def test_assoc_general54_link_reassign_clear():
    a = UML2_Classifier(isAbstract=True)
    b1 = UML2_Generalization()
    b2 = UML2_Generalization()
    _safe_set(a, 'UML2_Classifier56', b1)
    assert _is_linked(a, 'UML2_Classifier56', b1)
    if hasattr(b1, 'UML2_Generalization55'):
        assert _is_linked(b1, 'UML2_Generalization55', a)
    _safe_set(a, 'UML2_Classifier56', b2)
    assert _is_linked(a, 'UML2_Classifier56', b2)
    if hasattr(b1, 'UML2_Generalization55'):
        assert not _is_linked(b1, 'UML2_Generalization55', a)
    if hasattr(b2, 'UML2_Generalization55'):
        assert _is_linked(b2, 'UML2_Generalization55', a)
    _safe_set(a, 'UML2_Classifier56', None)
    assert not _is_linked(a, 'UML2_Classifier56', b2)
    if hasattr(b2, 'UML2_Generalization55'):
        assert not _is_linked(b2, 'UML2_Generalization55', a)


def test_assoc_generalization5_link_reassign_clear():
    a = UML2_Classifier(isAbstract=True)
    b1 = UML2_Generalization()
    b2 = UML2_Generalization()
...
def test_assoc_inheritedMember3_link_reassign_clear():
    ...
    if hasattr(b1, 'UML2_Classifier4'):
        assert _is_linked(b1, 'UML2_Classifier4', a)
    _safe_set(a, 'UML2_NamedElement', b2)
    assert _is_linked(a, 'UML2_NamedElement', b2)
    if hasattr(b1, 'UML2_Classifier4'):
        assert not _is_linked(b1, 'UML2_Classifier4', a)
    if hasattr(b2, 'UML2_Classifier4'):
        assert _is_linked(b2, 'UML2_Classifier4', a)
    _safe_set(a, 'UML2_NamedElement', None)
    assert not _is_linked(a, 'UML2_NamedElement', b2)
    if hasattr(b2, 'UML2_Classifier4'):
        assert not _is_linked(b2, 'UML2_Classifier4', a)


def test_assoc_member15_link_reassign_clear():
    a = UML2_NamedElement(name="sample_text", visibility="sample_text")
    b1 = UML2_Namespace()
    b2 = UML2_Namespace()
    _safe_set(a, 'UML2_NamedElement16', b1)
    assert _is_linked(a, 'UML2_NamedElement16', b1)
    if hasattr(b1, 'UML2_Namespace'):
        assert _is_linked(b1, 'UML2_Namespace', a)
    _safe_set(a, 'UML2_NamedElement16', b2)
    assert _is_linked(a, 'UML2_NamedElement16', b2)
    if hasattr(b1, 'UML2_Namespace'):
        assert not _is_linked(b1, 'UML2_Namespace', a)
    if hasattr(b2, 'UML2_Namespace'):
        assert _is_linked(b2, 'UML2_Namespace', a)
    _safe_set(a, 'UML2_NamedElement16', None)
    assert not _is_linked(a, 'UML2_NamedElement16', b2)
    if hasattr(b2, 'UML2_Namespace'):
        assert not _is_linked(b2, 'UML2_Namespace', a)


def test_assoc_memberEnd35_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b1 = UML2_Association()
    b2 = UML2_Association()
    _safe_set(a, 'UML2_Property37', b1)
    assert _is_linked(a, 'UML2_Property37', b1)
    if hasattr(b1, 'UML2_Association36'):
        assert _is_linked(b1, 'UML2_Association36', a)
    _safe_set(a, 'UML2_Property37', b2)
    assert _is_linked(a, 'UML2_Property37', b2)
    if hasattr(b1, 'UML2_Association36'):
        assert not _is_linked(b1, 'UML2_Association36', a)
    if hasattr(b2, 'UML2_Association36'):
        assert _is_linked(b2, 'UML2_Association36', a)
    _safe_set(a, 'UML2_Property37', None)
    assert not _is_linked(a, 'UML2_Property37', b2)
    if hasattr(b2, 'UML2_Association36'):
        assert not _is_linked(b2, 'UML2_Association36', a)
...
def test_assoc_ownedEnd33_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b1 = UML2_Association()
    b2 = UML2_Association()
...
def test_assoc_qualifier52_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    ...
    if hasattr(b1, 'UML2_Property53'):
        assert _is_linked(b1, 'UML2_Property53', a)
    _safe_set(a, 'UML2_Property51', {b2})
    assert _is_linked(a, 'UML2_Property51', b2)
    if hasattr(b1, 'UML2_Property53'):
        assert not _is_linked(b1, 'UML2_Property53', a)
    if hasattr(b2, 'UML2_Property53'):
        assert _is_linked(b2, 'UML2_Property53', a)
    _safe_set(a, 'UML2_Property51', set())
    assert not _is_linked(a, 'UML2_Property51', b2)
    if hasattr(b2, 'UML2_Property53'):
        assert not _is_linked(b2, 'UML2_Property53', a)


def test_assoc_structuralFeature17_link_reassign_clear():
    a = UML2_StructuralFeature(isReadOnly=True)
    b1 = UML2_StructuralFeatureAction()
    b2 = UML2_StructuralFeatureAction()
    _safe_set(a, 'UML2_StructuralFeature18', b1)
    assert _is_linked(a, 'UML2_StructuralFeature18', b1)
    if hasattr(b1, 'UML2_StructuralFeatureAction'):
        assert _is_linked(b1, 'UML2_StructuralFeatureAction', a)
    _safe_set(a, 'UML2_StructuralFeature18', b2)
    assert _is_linked(a, 'UML2_StructuralFeature18', b2)
    if hasattr(b1, 'UML2_StructuralFeatureAction'):
    ...
    _safe_set(a, 'UML2_StructuralFeature18', None)
    assert not _is_linked(a, 'UML2_StructuralFeature18', b2)
    if hasattr(b2, 'UML2_StructuralFeatureAction'):
        assert not _is_linked(b2, 'UML2_StructuralFeatureAction', a)


def test_assoc_subsettedProperty46_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b1 = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b2 = UML2_Property(aggregation="sample_text_2", isComposite=False, isDerived=False, isDerivedUnion=False)
    _safe_set(a, 'UML2_Property45', {b1})
    assert _is_linked(a, 'UML2_Property45', b1)
    if hasattr(b1, 'UML2_Property47'):
        assert _is_linked(b1, 'UML2_Property47', a)
    _safe_set(a, 'UML2_Property45', {b2})
    assert _is_linked(a, 'UML2_Property45', b2)
    if hasattr(b1, 'UML2_Property47'):
        assert not _is_linked(b1, 'UML2_Property47', a)
    if hasattr(b2, 'UML2_Property47'):
        assert _is_linked(b2, 'UML2_Property47', a)
    _safe_set(a, 'UML2_Property45', set())
    assert not _is_linked(a, 'UML2_Property45', b2)
    if hasattr(b2, 'UML2_Property47'):
        assert not _is_linked(b2, 'UML2_Property47', a)
