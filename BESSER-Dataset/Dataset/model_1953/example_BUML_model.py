...
# Classes
mode_MediaLibrary = Class(name="mode_MediaLibrary")
mode_Device = Class(name="mode_Device")
mode_User = Class(name="mode_User")
mode_MediaCollection = Class(name="mode_MediaCollection")
mode_MediaArtifact = Class(name="mode_MediaArtifact", is_abstract=True)
mode_Video = Class(name="mode_Video")
MediaArtifact = Class(name="MediaArtifact")
mode_Music = Class(name="mode_Music")
mode_AudioBook = Class(name="mode_AudioBook")
mode_EBook = Class(name="mode_EBook")
...
mode_MediaArtifact.attributes={mode_MediaArtifact_identifier, mode_MediaArtifact_name, mode_MediaArtifact_source}
...
domain_model = DomainModel(
    name="mode",
    types={mode_MediaLibrary, mode_Device, mode_User, mode_MediaCollection, mode_MediaArtifact, mode_Video, MediaArtifact, mode_Music, mode_AudioBook, mode_EBook, MediaSourceType, DeviceType},
    associations={devices0, users1, collections3, ownedCollections5, mediaArtifacts6, collection9, synchronisedCollections11, synchronisedDevices7, ownedUser8},
