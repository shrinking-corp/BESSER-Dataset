...
class mode_MediaCollection:
    ...
    def __init__(self, name: str, MediaCollection: "mode_User" = None, collection: set["mode_MediaArtifact"] = None, MediaCollection10: "mode_MediaArtifact" = None, MediaCollection12: "mode_Device" = None, mode_MediaCollection: "mode_MediaLibrary" = None, synchronisedCollections: set["mode_Device"] = None, ownedCollections: "mode_User" = None):
        self.name = name
...
class mode_User:
    ...
    def __init__(self, name: str, ownedUser: set["mode_MediaCollection"] = None, mode_User: "mode_MediaLibrary" = None, User: "mode_MediaCollection" = None):
        self.name = name
...
class mode_Device:
    ...
    def __init__(self, name: str, type: str, synchronisedDevices: set["mode_MediaCollection"] = None, mode_Device: "mode_MediaLibrary" = None, Device: "mode_MediaCollection" = None):
        self.name = name
        self.type = type
