...
class ReactiveElement:
    ...
    pass
class sgraph_State(ExpressionElement, RegularState, ScopedElement, ReactiveElement):

    def __init__(self, orthogonal: bool, substatechartId: str, submachine: bool, simple: bool, composite: bool, leaf: bool, sgraph_State: set["sgraph_Region"] = None, sgraph_State28: "sgraph_Statechart" = None):
...
class sgraph_Declaration(NamedElement):
    ...
    pass
class sgraph_Statechart(ExpressionElement, NamedElement, ScopedElement, ReactiveElement):
