...
VehicleType: Enumeration = Enumeration(
    name="VehicleType",
    literals={
...
Parking_Space_Occupied: Property = Property(name="Occupied", type=BooleanType)
Parking_Space.attributes={Parking_Space_Floor_Number, Parking_Space_Space_Number, Parking_Space_Occupied, Parking_Space_Space_Type}
...
domain_model = DomainModel(
    name="_16dcb2dd_c63c_4430_996d_87a7d51e2cfc",
    types={Parking_Space, Vehicle_Interface, Car, Truck, Motorbike, Parking_Level, Class_, Regular_Space, Boolean_external, Parking_Space_Type, Enumeration_, Enumeration2, VehicleType},
    associations={Floor_Parking_Spaces, Parking_Space_Vehicle},
    generalizations={},
    metadata=None
)
