...
def test_assoc_association76_link_reassign_clear():
    ...
    b1 = UML2_Association()
    b2 = UML2_Association()
    _safe_set(a, 'UML2_Property77', b1)
    assert _is_linked(a, 'UML2_Property77', b1)
    if hasattr(b1, 'UML2_Association78'):
        assert _is_linked(b1, 'UML2_Association78', a)
    _safe_set(a, 'UML2_Property77', b2)
    assert _is_linked(a, 'UML2_Property77', b2)
    if hasattr(b1, 'UML2_Association78'):
        assert not _is_linked(b1, 'UML2_Association78', a)
    if hasattr(b2, 'UML2_Association78'):
        assert _is_linked(b2, 'UML2_Association78', a)
    _safe_set(a, 'UML2_Property77', None)
    assert not _is_linked(a, 'UML2_Property77', b2)
    if hasattr(b2, 'UML2_Association78'):
        assert not _is_linked(b2, 'UML2_Association78', a)


def test_assoc_bodyCondition70_link_reassign_clear():
    a = UML2_Operation(isQuery=True)
    b1 = UML2_Constraint()
    b2 = UML2_Constraint()
    _safe_set(a, 'UML2_Operation71', b1)
    assert _is_linked(a, 'UML2_Operation71', b1)
    if hasattr(b1, 'UML2_Constraint72'):
        assert _is_linked(b1, 'UML2_Constraint72', a)
    _safe_set(a, 'UML2_Operation71', b2)
    assert _is_linked(a, 'UML2_Operation71', b2)
    if hasattr(b1, 'UML2_Constraint72'):
        assert not _is_linked(b1, 'UML2_Constraint72', a)
    if hasattr(b2, 'UML2_Constraint72'):
        assert _is_linked(b2, 'UML2_Constraint72', a)
    _safe_set(a, 'UML2_Operation71', None)
    assert not _is_linked(a, 'UML2_Operation71', b2)
    if hasattr(b2, 'UML2_Constraint72'):
        assert not _is_linked(b2, 'UML2_Constraint72', a)


def test_assoc_classifier52_link_reassign_clear():
    a = UML2_Classifier(isAbstract=True)
    b1 = UML2_InstanceSpecification()
    b2 = UML2_InstanceSpecification()
    _safe_set(a, 'UML2_Classifier54', b1)
    assert _is_linked(a, 'UML2_Classifier54', b1)
    if hasattr(b1, 'UML2_InstanceSpecification53'):
        assert _is_linked(b1, 'UML2_InstanceSpecification53', a)
    _safe_set(a, 'UML2_Classifier54', b2)
    assert _is_linked(a, 'UML2_Classifier54', b2)
    if hasattr(b1, 'UML2_InstanceSpecification53'):
        assert not _is_linked(b1, 'UML2_InstanceSpecification53', a)
    if hasattr(b2, 'UML2_InstanceSpecification53'):
        assert _is_linked(b2, 'UML2_InstanceSpecification53', a)
    _safe_set(a, 'UML2_Classifier54', None)
    assert not _is_linked(a, 'UML2_Classifier54', b2)
    if hasattr(b2, 'UML2_InstanceSpecification53'):
        assert not _is_linked(b2, 'UML2_InstanceSpecification53', a)


def test_assoc_classifier9_link_reassign_clear():
    a = UML2_Classifier(isAbstract=True)
    b1 = UML2_CreateObjectAction()
    b2 = UML2_CreateObjectAction()
    _safe_set(a, 'UML2_Classifier10', b1)
    assert _is_linked(a, 'UML2_Classifier10', b1)
    if hasattr(b1, 'UML2_CreateObjectAction'):
        assert _is_linked(b1, 'UML2_CreateObjectAction', a)
    _safe_set(a, 'UML2_Classifier10', b2)
    assert _is_linked(a, 'UML2_Classifier10', b2)
    if hasattr(b1, 'UML2_CreateObjectAction'):
    ...
    _safe_set(a, 'UML2_Classifier10', None)
    assert not _is_linked(a, 'UML2_Classifier10', b2)
    if hasattr(b2, 'UML2_CreateObjectAction'):
        assert not _is_linked(b2, 'UML2_CreateObjectAction', a)


def test_assoc_context_0_link_reassign_clear():
    a = UML2_Classifier(isAbstract=True)
    b1 = UML2_Action()
    b2 = UML2_Action()
...
def test_assoc_definingFeature1_link_reassign_clear():
...
def test_assoc_end28_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b1 = UML2_LinkEndData()
    b2 = UML2_LinkEndData()
    _safe_set(a, 'UML2_Property', b1)
    assert _is_linked(a, 'UML2_Property', b1)
    if hasattr(b1, 'UML2_LinkEndData29'):
        assert _is_linked(b1, 'UML2_LinkEndData29', a)
    _safe_set(a, 'UML2_Property', b2)
    assert _is_linked(a, 'UML2_Property', b2)
    if hasattr(b1, 'UML2_LinkEndData29'):
        assert not _is_linked(b1, 'UML2_LinkEndData29', a)
    if hasattr(b2, 'UML2_LinkEndData29'):
        assert _is_linked(b2, 'UML2_LinkEndData29', a)
    _safe_set(a, 'UML2_Property', None)
    assert not _is_linked(a, 'UML2_Property', b2)
    if hasattr(b2, 'UML2_LinkEndData29'):
        assert not _is_linked(b2, 'UML2_LinkEndData29', a)
...
def test_assoc_feature14_link_reassign_clear():
    ...
    if hasattr(b1, 'UML2_Classifier15'):
        assert _is_linked(b1, 'UML2_Classifier15', a)
    _safe_set(a, 'UML2_Feature', b2)
    assert _is_linked(a, 'UML2_Feature', b2)
    if hasattr(b1, 'UML2_Classifier15'):
        assert not _is_linked(b1, 'UML2_Classifier15', a)
    if hasattr(b2, 'UML2_Classifier15'):
        assert _is_linked(b2, 'UML2_Classifier15', a)
    _safe_set(a, 'UML2_Feature', None)
    assert not _is_linked(a, 'UML2_Feature', b2)
    if hasattr(b2, 'UML2_Classifier15'):
        assert not _is_linked(b2, 'UML2_Classifier15', a)


def test_assoc_featuringClassifier56_link_reassign_clear():
    a = UML2_Feature(isStatic=True)
    b1 = UML2_Classifier(isAbstract=True)
    b2 = UML2_Classifier(isAbstract=False)
    _safe_set(a, 'UML2_Feature57', {b1})
    assert _is_linked(a, 'UML2_Feature57', b1)
    if hasattr(b1, 'UML2_Classifier58'):
        assert _is_linked(b1, 'UML2_Classifier58', a)
    _safe_set(a, 'UML2_Feature57', {b2})
    assert _is_linked(a, 'UML2_Feature57', b2)
    if hasattr(b1, 'UML2_Classifier58'):
        assert not _is_linked(b1, 'UML2_Classifier58', a)
    if hasattr(b2, 'UML2_Classifier58'):
        assert _is_linked(b2, 'UML2_Classifier58', a)
    _safe_set(a, 'UML2_Feature57', set())
    assert not _is_linked(a, 'UML2_Feature57', b2)
    if hasattr(b2, 'UML2_Classifier58'):
        assert not _is_linked(b2, 'UML2_Classifier58', a)
...
def test_assoc_general59_link_reassign_clear():
    ...
    _safe_set(a, 'UML2_Classifier61', b1)
    assert _is_linked(a, 'UML2_Classifier61', b1)
    if hasattr(b1, 'UML2_Generalization60'):
        assert _is_linked(b1, 'UML2_Generalization60', a)
    _safe_set(a, 'UML2_Classifier61', b2)
    assert _is_linked(a, 'UML2_Classifier61', b2)
    if hasattr(b1, 'UML2_Generalization60'):
        assert not _is_linked(b1, 'UML2_Generalization60', a)
    if hasattr(b2, 'UML2_Generalization60'):
        assert _is_linked(b2, 'UML2_Generalization60', a)
    _safe_set(a, 'UML2_Classifier61', None)
    assert not _is_linked(a, 'UML2_Classifier61', b2)
    if hasattr(b2, 'UML2_Generalization60'):
        assert not _is_linked(b2, 'UML2_Generalization60', a)
...
def test_assoc_generalization19_link_reassign_clear():
    ...
    if hasattr(b1, 'UML2_Generalization21'):
        assert _is_linked(b1, 'UML2_Generalization21', a)
    _safe_set(a, 'UML2_Classifier20', {b2})
    assert _is_linked(a, 'UML2_Classifier20', b2)
    if hasattr(b1, 'UML2_Generalization21'):
        assert not _is_linked(b1, 'UML2_Generalization21', a)
    if hasattr(b2, 'UML2_Generalization21'):
        assert _is_linked(b2, 'UML2_Generalization21', a)
    _safe_set(a, 'UML2_Classifier20', set())
    assert not _is_linked(a, 'UML2_Classifier20', b2)
    if hasattr(b2, 'UML2_Generalization21'):
        assert not _is_linked(b2, 'UML2_Generalization21', a)
...
def test_assoc_inheritedMember16_link_reassign_clear():
    ...
    b1 = UML2_Classifier(isAbstract=True)
    b2 = UML2_Classifier(isAbstract=False)
    _safe_set(a, 'UML2_NamedElement18', b1)
    assert _is_linked(a, 'UML2_NamedElement18', b1)
    if hasattr(b1, 'UML2_Classifier17'):
        assert _is_linked(b1, 'UML2_Classifier17', a)
    _safe_set(a, 'UML2_NamedElement18', b2)
    assert _is_linked(a, 'UML2_NamedElement18', b2)
    if hasattr(b1, 'UML2_Classifier17'):
        assert not _is_linked(b1, 'UML2_Classifier17', a)
    if hasattr(b2, 'UML2_Classifier17'):
        assert _is_linked(b2, 'UML2_Classifier17', a)
    _safe_set(a, 'UML2_NamedElement18', None)
    assert not _is_linked(a, 'UML2_NamedElement18', b2)
    if hasattr(b2, 'UML2_Classifier17'):
        assert not _is_linked(b2, 'UML2_Classifier17', a)


def test_assoc_member4_link_reassign_clear():
    a = UML2_NamedElement(name="sample_text", visibility="sample_text")
    b1 = UML2_Namespace()
    b2 = UML2_Namespace()
...
def test_assoc_memberEnd34_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b1 = UML2_Association()
    b2 = UML2_Association()
    _safe_set(a, 'UML2_Property36', b1)
    assert _is_linked(a, 'UML2_Property36', b1)
    if hasattr(b1, 'UML2_Association35'):
        assert _is_linked(b1, 'UML2_Association35', a)
    _safe_set(a, 'UML2_Property36', b2)
    assert _is_linked(a, 'UML2_Property36', b2)
    if hasattr(b1, 'UML2_Association35'):
        assert not _is_linked(b1, 'UML2_Association35', a)
    if hasattr(b2, 'UML2_Association35'):
        assert _is_linked(b2, 'UML2_Association35', a)
    _safe_set(a, 'UML2_Property36', None)
    assert not _is_linked(a, 'UML2_Property36', b2)
    if hasattr(b2, 'UML2_Association35'):
        assert not _is_linked(b2, 'UML2_Association35', a)


def test_assoc_nestedClassifier5_link_reassign_clear():
    a = UML2_Classifier(isAbstract=True)
    b1 = UML2_Class(isActive=True)
    b2 = UML2_Class(isActive=False)
    _safe_set(a, 'UML2_Classifier6', b1)
    assert _is_linked(a, 'UML2_Classifier6', b1)
    if hasattr(b1, 'UML2_Class'):
        assert _is_linked(b1, 'UML2_Class', a)
    _safe_set(a, 'UML2_Classifier6', b2)
    assert _is_linked(a, 'UML2_Classifier6', b2)
    if hasattr(b1, 'UML2_Class'):
        assert not _is_linked(b1, 'UML2_Class', a)
    if hasattr(b2, 'UML2_Class'):
        assert _is_linked(b2, 'UML2_Class', a)
    _safe_set(a, 'UML2_Classifier6', None)
    assert not _is_linked(a, 'UML2_Classifier6', b2)
    if hasattr(b2, 'UML2_Class'):
...
def test_assoc_ownedEnd32_link_reassign_clear():
    ...
    b1 = UML2_Association()
    b2 = UML2_Association()
    _safe_set(a, 'UML2_Property33', b1)
    assert _is_linked(a, 'UML2_Property33', b1)
    if hasattr(b1, 'UML2_Association'):
        assert _is_linked(b1, 'UML2_Association', a)
    _safe_set(a, 'UML2_Property33', b2)
    assert _is_linked(a, 'UML2_Property33', b2)
    if hasattr(b1, 'UML2_Association'):
        assert not _is_linked(b1, 'UML2_Association', a)
    if hasattr(b2, 'UML2_Association'):
        assert _is_linked(b2, 'UML2_Association', a)
    _safe_set(a, 'UML2_Property33', None)
    assert not _is_linked(a, 'UML2_Property33', b2)
    if hasattr(b2, 'UML2_Association'):
...
def test_assoc_ownedReception7_link_reassign_clear():
    a = UML2_Class(isActive=True)
    b1 = UML2_Reception()
    b2 = UML2_Reception()
    _safe_set(a, 'UML2_Class8', {b1})
    assert _is_linked(a, 'UML2_Class8', b1)
    if hasattr(b1, 'UML2_Reception'):
        assert _is_linked(b1, 'UML2_Reception', a)
    _safe_set(a, 'UML2_Class8', {b2})
    assert _is_linked(a, 'UML2_Class8', b2)
    if hasattr(b1, 'UML2_Reception'):
        assert not _is_linked(b1, 'UML2_Reception', a)
    if hasattr(b2, 'UML2_Reception'):
        assert _is_linked(b2, 'UML2_Reception', a)
    _safe_set(a, 'UML2_Class8', set())
    assert not _is_linked(a, 'UML2_Class8', b2)
    if hasattr(b2, 'UML2_Reception'):
        assert not _is_linked(b2, 'UML2_Reception', a)


def test_assoc_qualifier37_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b1 = UML2_QualifierValue()
    b2 = UML2_QualifierValue()
    _safe_set(a, 'UML2_Property39', b1)
    assert _is_linked(a, 'UML2_Property39', b1)
    if hasattr(b1, 'UML2_QualifierValue38'):
        assert _is_linked(b1, 'UML2_QualifierValue38', a)
    _safe_set(a, 'UML2_Property39', b2)
    assert _is_linked(a, 'UML2_Property39', b2)
    if hasattr(b1, 'UML2_QualifierValue38'):
        assert not _is_linked(b1, 'UML2_QualifierValue38', a)
    if hasattr(b2, 'UML2_QualifierValue38'):
        assert _is_linked(b2, 'UML2_QualifierValue38', a)
    _safe_set(a, 'UML2_Property39', None)
    assert not _is_linked(a, 'UML2_Property39', b2)
    if hasattr(b2, 'UML2_QualifierValue38'):
        assert not _is_linked(b2, 'UML2_QualifierValue38', a)


def test_assoc_qualifier80_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    ...
    _safe_set(a, 'UML2_Property79', {b1})
    assert _is_linked(a, 'UML2_Property79', b1)
    if hasattr(b1, 'UML2_Property81'):
        assert _is_linked(b1, 'UML2_Property81', a)
    _safe_set(a, 'UML2_Property79', {b2})
    assert _is_linked(a, 'UML2_Property79', b2)
    if hasattr(b1, 'UML2_Property81'):
        assert not _is_linked(b1, 'UML2_Property81', a)
    if hasattr(b2, 'UML2_Property81'):
        assert _is_linked(b2, 'UML2_Property81', a)
    _safe_set(a, 'UML2_Property79', set())
    assert not _is_linked(a, 'UML2_Property79', b2)
    if hasattr(b2, 'UML2_Property81'):
        assert not _is_linked(b2, 'UML2_Property81', a)


def test_assoc_structuralFeature43_link_reassign_clear():
    a = UML2_StructuralFeature(isReadOnly=True)
    b1 = UML2_StructuralFeatureAction()
    b2 = UML2_StructuralFeatureAction()
    _safe_set(a, 'UML2_StructuralFeature44', b1)
    assert _is_linked(a, 'UML2_StructuralFeature44', b1)
    if hasattr(b1, 'UML2_StructuralFeatureAction'):
        assert _is_linked(b1, 'UML2_StructuralFeatureAction', a)
    _safe_set(a, 'UML2_StructuralFeature44', b2)
    assert _is_linked(a, 'UML2_StructuralFeature44', b2)
    if hasattr(b1, 'UML2_StructuralFeatureAction'):
    ...
    _safe_set(a, 'UML2_StructuralFeature44', None)
    assert not _is_linked(a, 'UML2_StructuralFeature44', b2)
    if hasattr(b2, 'UML2_StructuralFeatureAction'):
        assert not _is_linked(b2, 'UML2_StructuralFeatureAction', a)


def test_assoc_subsettedProperty74_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b1 = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b2 = UML2_Property(aggregation="sample_text_2", isComposite=False, isDerived=False, isDerivedUnion=False)
    _safe_set(a, 'UML2_Property73', {b1})
    assert _is_linked(a, 'UML2_Property73', b1)
    if hasattr(b1, 'UML2_Property75'):
        assert _is_linked(b1, 'UML2_Property75', a)
    _safe_set(a, 'UML2_Property73', {b2})
    assert _is_linked(a, 'UML2_Property73', b2)
    if hasattr(b1, 'UML2_Property75'):
        assert not _is_linked(b1, 'UML2_Property75', a)
    if hasattr(b2, 'UML2_Property75'):
        assert _is_linked(b2, 'UML2_Property75', a)
    _safe_set(a, 'UML2_Property73', set())
    assert not _is_linked(a, 'UML2_Property73', b2)
    if hasattr(b2, 'UML2_Property75'):
        assert not _is_linked(b2, 'UML2_Property75', a)
