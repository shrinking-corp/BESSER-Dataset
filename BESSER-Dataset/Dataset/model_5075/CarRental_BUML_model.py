...
CarRental_Person.attributes={CarRental_Person_age, CarRental_Person_lastname, CarRental_Person_isMarried, CarRental_Person_firstname}
...
domain_model = DomainModel(
    name="CarRental",
    types={CarRental_Customer, Person, CarRental_Person, CarRental_Rental, CarRental_Employee, CarRental_Branch, CarRental_Car, CarRental_CarGroup, CarRental_ServiceDepot, CarRental_Check, CarGroupKind},
    associations={carGroup23, rental0, managedBranch1, employer2, manager5, employee8, car11, carGroup12, rental14, car17, customer19, branch21, branch26, car28, rental31, higher35, lower38, branch40, carGroup42, rental45},
