...
class fm_Feature:
    ...
    def __init__(self, cloneable: bool, id: str, name: str, description: str, comment: str, lower: int, upper: int, root: bool, orphan: bool, optional: bool, mandatory: bool, fm_Feature7: "fm_EObject" = None, fm_Feature3: "fm_FeatureModel" = None, Feature: "fm_Feature" = None, features: "fm_Feature" = None, features11: "fm_Group" = None, Feature22: "fm_Group" = None, feature: set["fm_Attribute"] = None, Feature24: "fm_Group" = None, parent: set["fm_Group"] = None, fm_Feature19: "fm_FeatureModel" = None, Feature26: "fm_Attribute" = None, Feature15: "fm_Feature" = None, parentFeature: set["fm_Feature"] = None, fm_Feature: "fm_FeatureModel" = None):
...
class fm_Attribute:
    ...
    def __init__(self, id: str, name: str, type: str, description: str, comment: str, qualityAttribute: bool, resourceAttribute: bool, defaultValue: str, minRangeValue: str, maxRangeValue: str, weight: str, minimize: bool, objectiveFunctionAggregator: str, alert: bool, Attribute: "fm_Feature" = None, attributes: "fm_Feature" = None):
        self.id = id
        self.name = name
        self.type = type
        self.description = description
    ...
    @property
    def objectiveFunctionAggregator(self):
...
class fm_Group:
    ...
    def __init__(self, description: str, comment: str, xor: bool, or_: bool, lower: int, upper: int, Group: "fm_Feature" = None, groups: "fm_Feature" = None, parentGroup: set["fm_Feature"] = None, Group17: "fm_Feature" = None):
        self.description = description
        self.comment = comment
        self.xor = xor
        self.or_ = or_
