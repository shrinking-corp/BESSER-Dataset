...
fm_Group_or_: Property = Property(name="or_", type=BooleanType)
fm_Group_lower: Property = Property(name="lower", type=IntegerType)
fm_Group_upper: Property = Property(name="upper", type=IntegerType)
fm_Group.attributes={fm_Group_xor, fm_Group_or_, fm_Group_description, fm_Group_comment, fm_Group_upper, fm_Group_lower}
...
fm_Attribute.attributes={fm_Attribute_minimize, fm_Attribute_alert, fm_Attribute_maxRangeValue, fm_Attribute_id, fm_Attribute_name, fm_Attribute_description, fm_Attribute_weight, fm_Attribute_minRangeValue, fm_Attribute_type, fm_Attribute_qualityAttribute, fm_Attribute_defaultValue, fm_Attribute_comment, fm_Attribute_objectiveFunctionAggregator, fm_Attribute_resourceAttribute}
...
fm_FeatureModel_m_getFeaturesById: Method = Method(name="getFeaturesById", parameters={Parameter(name='fm_id', type=StringType)})
fm_FeatureModel.attributes={fm_FeatureModel_name, fm_FeatureModel_version, fm_FeatureModel_comment, fm_FeatureModel_description}
...
fm_Feature.attributes={fm_Feature_mandatory, fm_Feature_description, fm_Feature_upper, fm_Feature_optional, fm_Feature_cloneable, fm_Feature_comment, fm_Feature_orphan, fm_Feature_lower, fm_Feature_id, fm_Feature_root, fm_Feature_name}
...
fm_Constraint.attributes={fm_Constraint_language, fm_Constraint_comment, fm_Constraint_value, fm_Constraint_description}
...
domain_model = DomainModel(
    name="fm",
    types={fm_EObject, fm_Group, fm_Attribute, fm_FeatureModel, fm_Feature, fm_Constraint, AttributeType, ObjectiveFunctionType},
    associations={parent6, parentFeature9, parentGroup10, attributes12, features14, root0, orphans1, constraints4, parent21, features23, groups16, featureModel18, feature25, featureModel27},
    generalizations={},
    metadata=None
)
