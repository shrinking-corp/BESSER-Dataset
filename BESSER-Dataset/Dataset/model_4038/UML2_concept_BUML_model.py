...
domain_model = DomainModel(
    name="uml",
    types={uml_Parameter, TypedElement, uml_Model, Package, uml_Feature, NamedElement, uml_Package, PackageableElement, uml_PackageableElement, uml_Property, Feature, uml_NamedElement, uml_Dependency, uml_Class, Classifier, uml_Classifier, uml_Operation, uml_Behavior, Type, Class_, uml_TypedElement, uml_Type, VisibilityKind},
    associations={packagedElement0, supplier1, nestedClassifier2, ownedOperation3, generalizationGeneral5, ownedAttribute8, method10, ownedParameter12, type14},
    generalizations={gen_uml_Parameter_TypedElement, gen_uml_Model_Package, gen_uml_Feature_NamedElement, gen_uml_Package_PackageableElement, gen_uml_Package_NamedElement, gen_uml_PackageableElement_NamedElement, gen_uml_Property_Feature, gen_uml_Property_TypedElement, gen_uml_Property_NamedElement, gen_uml_Dependency_PackageableElement, gen_uml_Class_Classifier, gen_uml_Operation_Feature, gen_uml_Operation_NamedElement, gen_uml_Classifier_Type, gen_uml_Classifier_NamedElement, gen_uml_Behavior_Class, gen_uml_TypedElement_NamedElement, gen_uml_Type_PackageableElement},
    metadata=None
)
