...
class uml_PackageableElement(NamedElement):
    ...
    pass
class uml_Package(PackageableElement, NamedElement):

    pass
class uml_Classifier(Type, NamedElement):

    pass
class uml_TypedElement(NamedElement):

    pass
class uml_Operation(Feature, NamedElement):
...
class TypedElement:
    ...
    pass
class uml_Property(TypedElement, Feature, NamedElement):
