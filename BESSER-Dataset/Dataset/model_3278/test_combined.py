...
def test_hyp_data_variable_is_not_abstract():
    assert not inspect.isabstract(data_Variable)


def test_hyp_data_variable_constructor_exists():
    assert callable(data_Variable.__init__)


def test_hyp_data_variable_constructor_args():
...
def test_hyp_data_variables_is_not_abstract():
    assert not inspect.isabstract(data_Variables)


def test_hyp_data_variables_constructor_exists():
    assert callable(data_Variables.__init__)


def test_hyp_data_variables_constructor_args():
...
def test_hyp_data_variable_id_setter(instance):
