...
altarica_Type = Class(name="altarica_Type")
altarica_BaseType = Class(name="altarica_BaseType")
Type = Class(name="Type")
altarica_NamedType = Class(name="altarica_NamedType")
altarica_Declaration = Class(name="altarica_Declaration")
altarica_LabeledTransition = Class(name="altarica_LabeledTransition")
altarica_NameRef = Class(name="altarica_NameRef")
altarica_TransitionExpression = Class(name="altarica_TransitionExpression")
altarica_Instruction = Class(name="altarica_Instruction")
...
altarica_ARBoolean = Class(name="altarica_ARBoolean")
Expression = Class(name="Expression")
altarica_ARString = Class(name="altarica_ARString")
altarica_Model = Class(name="altarica_Model")
altarica_Error = Class(name="altarica_Error")
altarica_AbstractDeclaration = Class(name="altarica_AbstractDeclaration")
altarica_NamedElement = Class(name="altarica_NamedElement")
AbstractDeclaration = Class(name="AbstractDeclaration")
altarica_Domain = Class(name="altarica_Domain")
NamedElement = Class(name="NamedElement")
altarica_SymbolicConstant = Class(name="altarica_SymbolicConstant")
altarica_Node = Class(name="altarica_Node")
altarica_Variable = Class(name="altarica_Variable")
altarica_Attribute = Class(name="altarica_Attribute")
altarica_Event = Class(name="altarica_Event")
altarica_Parameter = Class(name="altarica_Parameter")
altarica_ARNumber = Class(name="altarica_ARNumber")
altarica_Observer = Class(name="altarica_Observer")
altarica_SwitchExpression = Class(name="altarica_SwitchExpression")
altarica_Transition = Class(name="altarica_Transition")
altarica_Skip = Class(name="altarica_Skip")
Instruction = Class(name="Instruction")
altarica_Assignment = Class(name="altarica_Assignment")
altarica_Block = Class(name="altarica_Block")
altarica_Conditional = Class(name="altarica_Conditional")
altarica_LogicalOr = Class(name="altarica_LogicalOr")
altarica_LogicalAnd = Class(name="altarica_LogicalAnd")
altarica_Equal = Class(name="altarica_Equal")
altarica_TransitionAnd = Class(name="altarica_TransitionAnd")
TransitionExpression = Class(name="TransitionExpression")
altarica_TransitionOr = Class(name="altarica_TransitionOr")
altarica_Not = Class(name="altarica_Not")
altarica_Minus = Class(name="altarica_Minus")
altarica_FunctionCall = Class(name="altarica_FunctionCall")
...
altarica_Error.attributes={altarica_Error_message, altarica_Error_severity}
...
else_8: BinaryAssociation = BinaryAssociation(
    name="else_8",
    ends={
...
domain_model = DomainModel(
    name="altarica",
    types={Declaration, altarica_Type, altarica_BaseType, Type, altarica_NamedType, altarica_Declaration, altarica_LabeledTransition, altarica_NameRef, altarica_TransitionExpression, altarica_Instruction, altarica_CaseExpression, altarica_EObject, altarica_Expression, altarica_ARBoolean, Expression, altarica_ARString, altarica_Model, altarica_Error, altarica_AbstractDeclaration, altarica_NamedElement, AbstractDeclaration, altarica_Domain, NamedElement, altarica_SymbolicConstant, altarica_Node, altarica_Variable, altarica_Attribute, altarica_Event, altarica_Parameter, altarica_ARNumber, altarica_Observer, altarica_SwitchExpression, altarica_Transition, altarica_Skip, Instruction, altarica_Assignment, altarica_Block, altarica_Conditional, altarica_LogicalOr, altarica_LogicalAnd, altarica_Equal, altarica_TransitionAnd, TransitionExpression, altarica_TransitionOr, altarica_Not, altarica_Minus, altarica_FunctionCall, altarica_Addition, altarica_Multiplication, BaseTypeEnum, Severity},
    associations={ref3, event4, expression5, cases7, else_8, errors0, declarations1, case23, constants26, declarations28, transitions29, assertions32, type35, attributes36, value39, attributes41, type43, value45, variable10, nested14, cases16, default18, condition20, guard63, action65, variable68, value70, instructions73, condition75, then77, left80, right82, left85, right87, left90, type48, value50, left53, right55, left58, right60, right102, expression105, expression107, parameters109, right92, left95, right97, left100},
    generalizations={gen_altarica_NamedElement_Declaration, gen_altarica_BaseType_Type, gen_altarica_NamedType_Type, gen_altarica_ARBoolean_Expression, gen_altarica_ARString_Expression, gen_altarica_NamedElement_AbstractDeclaration, gen_altarica_Domain_NamedElement, gen_altarica_SymbolicConstant_NamedElement, gen_altarica_Node_NamedElement, gen_altarica_Variable_NamedElement, gen_altarica_Attribute_NamedElement, gen_altarica_Event_NamedElement, gen_altarica_Parameter_NamedElement, gen_altarica_ARNumber_Expression, gen_altarica_Observer_NamedElement, gen_altarica_NameRef_Expression, gen_altarica_SwitchExpression_Expression, gen_altarica_Transition_TransitionExpression, gen_altarica_Skip_Instruction, gen_altarica_Assignment_Instruction, gen_altarica_Block_Instruction, gen_altarica_Conditional_Instruction, gen_altarica_LogicalOr_Expression, gen_altarica_LogicalAnd_Expression, gen_altarica_Equal_Expression, gen_altarica_TransitionAnd_TransitionExpression, gen_altarica_TransitionOr_TransitionExpression, gen_altarica_Not_Expression, gen_altarica_Minus_Expression, gen_altarica_FunctionCall_Expression, gen_altarica_Addition_Expression, gen_altarica_Multiplication_Expression},
    metadata=None
)
