...
class sfc_Sfc_Elements:
    ...
    pass
class iec61131_sfc_Step(sfc_Step_Types, sfc_Sfc_Elements):
...
class pous_Function_Body:
    ...
    pass
class iec61131_fbd_Function_Block_Diagram(pous_Function_Block_Body, pous_Function_Body):

    pass
class iec61131_st_Statement_List(pous_Function_Block_Body, pous_Function_Body):

    pass
class iec61131_ld_Ladder_Diagram(pous_Function_Block_Body, pous_Function_Body):

    pass
class iec61131_pous_Other_Language(pous_Function_Block_Body, pous_Function_Body):
...
class types_Simple_Specification:
    ...
    pass
class iec61131_types_Elementary_Type_Name(interfaces_Simple_Specification_Func, types_Non_Generic_Type_Name, types_Simple_Specification):

    pass
class iec61131_types_Simple_Type_Name(interfaces_Simple_Specification_Func, types_Single_Element_Type_Name, types_Simple_Specification):

    pass
class iec61131_types_Generic_Type_Name(types_Data_Type_Name, pous_Function_Return_Value, types_Simple_Specification):

    pass
class Blocks:

    pass
class iec61131_pous_Derived_Function_Block_Name(pous_Function_Block_Type_Name, Blocks):

    pass
class iec61131_pous_Derived_Function_Name(pous_Function_Name, Blocks):
...
class iec61131_interfaces_Global_Var_Declarations(Library_Element_Declaration):
    ...
    def __init__(self, retain: bool, constant: bool, iec61131_interfaces_Global_Var_Declarations: set["Global_Var_Decl"] = None):
        self.retain = retain
...
class iec61131_interfaces_Located_Var_Declarations(Program_Vars):
    ...
    def __init__(self, constant: bool, retain: bool, iec61131_interfaces_Located_Var_Declarations: set["Located_Var_Decl"] = None, Program_Vars: "iec61131_pous_Program_Declaration" = None):
        self.constant = constant
        self.retain = retain
...
class Il_Instruction:
    ...
    pass
class iec61131_il_Instruction_List(pous_Function_Block_Body, pous_Function_Body):
...
class iec61131_interfaces_Io_Var_Declaration(pous_Function_Block_Vars, pous_Program_Vars, pous_Function_Vars, interfaces_Interface):
...
class interfaces_Var1_Specification:
    ...
    pass
class iec61131_interfaces_Subrange_Spec_Init(interfaces_Var1_Specification, interfaces_Var1_Specification_Func, interfaces_Located_Var_Spec_Init, pous_Structure_Elements):

    pass
class iec61131_interfaces_Enumerated_Spec_Init(interfaces_Var1_Specification, interfaces_Var1_Specification_Func, interfaces_Located_Var_Spec_Init, pous_Structure_Elements):

    pass
class iec61131_interfaces_Simple_Spec_Init(interfaces_Var1_Specification, interfaces_Located_Var_Spec_Init, pous_Structure_Elements):
...
class iec61131_interfaces_Edge_Declaration(Input_Declaration):
    ...
    def __init__(self, edge: str, iec61131_interfaces_Edge_Declaration: "Var1_List" = None, iec61131_interfaces_Edge_Declaration59: "Bool_Type_Name" = None, Input_Declaration: "iec61131_interfaces_Input_Declarations" = None):
        self.edge = edge
...
class operators_Arithmetic_Name:
    ...
    pass
class iec61131_operators_Divide_Name(operators_Arithmetic_Name, operators_Divide_Operator):
...
class operators_Addition_Operator:
    ...
    pass
class iec61131_operators_Addition_Symbol(operators_Addition_Operator, operators_Add_Operator):
...
class operators_Comparison_Name:
    ...
    pass
class iec61131_operators_LessEqual_Name(operators_Comparison_Name, operators_LessEqual_Operator):

    pass
class iec61131_operators_Less_Name(operators_Less_Operator, operators_Comparison_Name):

    pass
class iec61131_operators_Unequal_Name(operators_Unequal_Operator, operators_Comparison_Name):

    pass
class iec61131_operators_GreaterEqual_Name(operators_GreaterEqual_Operator, operators_Comparison_Name):

    pass
class iec61131_operators_Greater_Name(operators_Greater_Operator, operators_Comparison_Name):

    pass
class operators_Equal_Operator:

    pass
class iec61131_operators_Equal_Name(operators_Equal_Operator, operators_Comparison_Name):
...
class iec61131_operators_Substraction_Symbol(operators_Unary_Operator, operators_Add_Operator, operators_Substraction_Operator):
    ...
    pass
class iec61131_operators_Not_Operator(il_Il_Simple_Operator, operators_Unary_Operator):
...
class operators_Operator:
    ...
    pass
class iec61131_operators_Xor_Operator(operators_Operator, il_Il_Expr_Operator):

    pass
class iec61131_operators_Or_Operator(operators_Operator, il_Il_Expr_Operator):

    pass
class iec61131_operators_And_Operator(operators_Operator, il_Il_Expr_Operator):
...
class iec61131_literals_Fixed_Point(Fixed_Point_Literal):
    ...
    def __init__(self, valuePre: str, valuePost: str, Fixed_Point_Literal: "iec61131_literals_Interval" = None):
...
class literals_Time_Literal:
    ...
    pass
class iec61131_literals_Duration(literals_Time_Literal, sfc_Action_Time):
...
class iec61131_interfaces_Subrange(Case_List_Element):
    ...
    def __init__(self, delimiter: str, iec61131_interfaces_Subrange: set["Range"] = None, Case_List_Element: "iec61131_st_Case_List" = None):
...
class interfaces_External_Specification:
    ...
    pass
class iec61131_types_Structure_Type_Name(interfaces_External_Specification, interfaces_Var_Spec, types_Derived_Type_Name):

    pass
class iec61131_interfaces_Array_Specification(interfaces_External_Specification, interfaces_Var_Spec):

    pass
class interfaces_Specification:

    pass
class iec61131_interfaces_Enumerated_Specification(interfaces_External_Specification, interfaces_Var_Spec, interfaces_Specification):

    pass
class iec61131_interfaces_Subrange_Specification(interfaces_External_Specification, interfaces_Var_Spec, interfaces_Specification):
...
class interfaces_Temp_Var_Decl:
    ...
    pass
class iec61131_interfaces_String_Var_Declaration(interfaces_Temp_Var_Decl, interfaces_Var2_Init_Decl):
...
class pous_Structure_Specification:
    ...
    pass
class iec61131_interfaces_Initialized_Structure(interfaces_Located_Var_Spec_Init, pous_Structure_Specification, pous_Structure_Elements):
...
class Array_Initialization:
    ...
    pass
class iec61131_interfaces_Array_Spec_Init(interfaces_Located_Var_Spec_Init, pous_Structure_Elements):
...
class literals_Integer:
    ...
    pass
class iec61131_literals_Binary_Integer(literals_BSInteger, literals_Integer):

    pass
class iec61131_literals_Unsigned_Integer(interfaces_Range, literals_BSInteger, st_Case_List_Element, literals_Integer, literals_Fixed_Point_Literal):

    pass
class iec61131_literals_Octal_Integer(literals_BSInteger, literals_Integer):

    pass
class iec61131_literals_Hex_Integer(literals_BSInteger, literals_Integer):

    pass
class iec61131_literals_Signed_Integer(interfaces_Range, st_Case_List_Element, literals_Integer):
...
class configurations_Data_Source:
    ...
    pass
class iec61131_variables_Direct_Variable(configurations_Data_Sink, configurations_Prog_Data_Source, variables_Variable, configurations_Data_Source):
...
class iec61131_configurations_Global_Var_Reference(configurations_Data_Sink, configurations_Prog_Data_Source, configurations_Data_Source):

    pass
class iec61131_literals_Constant(configurations_Prog_Data_Source, il_Il_Operand, configurations_Data_Source):

    pass
class iec61131_literals_Boolean_Literal(Constant):

    def __init__(self, value: str, Constant: "iec61131_interfaces_InitElement_Constant" = None, Constant201: "iec61131_interfaces_Var_Name_Decl" = None, Constant209: "iec61131_interfaces_Simple_Spec_Init_Func" = None, Constant555: "iec61131_st_Expression_Constant" = None):
        self.value = value
...
class iec61131_sfc_Step_Name(NamedElement):
    ...
    pass
class iec61131_variables_Variable_Name(variables_Symbolic_Variable, Output_Reference, NamedElement, Input_Reference):
...
class iec61131_st_Statement(Commentable):
    ...
    pass
class iec61131_pous_Function_Block_Type_Name(interfaces_External_Specification, Library_Element_Name, Commentable, types_Simple_Specification):
...
class iec61131_configurations_Program_Configuration(Commentable):
    ...
    def __init__(self, retain: bool, iec61131_configurations_Program_Configuration: "Program_Name" = None, iec61131_configurations_Program_Configuration312: "Task_Name" = None, iec61131_configurations_Program_Configuration315: "Program_Type_Name" = None, iec61131_configurations_Program_Configuration318: "Prog_Conf_Elements" = None):
        self.retain = retain
...
class iec61131_interfaces_Interface(Commentable):
    ...
    pass
class iec61131_variables_Variable(Commentable, il_Il_Operand):
