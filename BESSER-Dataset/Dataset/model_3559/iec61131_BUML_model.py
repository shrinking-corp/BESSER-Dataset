...
# Classes
iec61131_IEC61131 = Class(name="iec61131_IEC61131")
iec61131_Library_Element_Declaration = Class(name="iec61131_Library_Element_Declaration", is_abstract=True)
iec61131_Library_Element_Name = Class(name="iec61131_Library_Element_Name", is_abstract=True)
Commentable = Class(name="Commentable")
NamedElement = Class(name="NamedElement")
iec61131_Commentable = Class(name="iec61131_Commentable", is_abstract=True)
iec61131_NamedElement = Class(name="iec61131_NamedElement", is_abstract=True)
Integer_Type_Name = Class(name="Integer_Type_Name")
iec61131_literals_Real_Literal = Class(name="iec61131_literals_Real_Literal")
Real_Type_Name = Class(name="Real_Type_Name")
Fixed_Point = Class(name="Fixed_Point")
iec61131_literals_Boolean_Literal = Class(name="iec61131_literals_Boolean_Literal")
iec61131_literals_Constant = Class(name="iec61131_literals_Constant", is_abstract=True)
configurations_Data_Source = Class(name="configurations_Data_Source")
configurations_Prog_Data_Source = Class(name="configurations_Prog_Data_Source")
il_Il_Operand = Class(name="il_Il_Operand")
iec61131_literals_Signed_Integer = Class(name="iec61131_literals_Signed_Integer")
literals_Integer = Class(name="literals_Integer")
st_Case_List_Element = Class(name="st_Case_List_Element")
interfaces_Range = Class(name="interfaces_Range")
iec61131_literals_Binary_Integer = Class(name="iec61131_literals_Binary_Integer")
literals_BSInteger = Class(name="literals_BSInteger")
iec61131_literals_Octal_Integer = Class(name="iec61131_literals_Octal_Integer")
iec61131_literals_Hex_Integer = Class(name="iec61131_literals_Hex_Integer")
iec61131_literals_Duration = Class(name="iec61131_literals_Duration")
literals_Time_Literal = Class(name="literals_Time_Literal")
sfc_Action_Time = Class(name="sfc_Action_Time")
Interval = Class(name="Interval")
Duration_Type_Name = Class(name="Duration_Type_Name")
Substraction_Operator = Class(name="Substraction_Operator")
iec61131_literals_Time_Of_Day = Class(name="iec61131_literals_Time_Of_Day")
Time_Literal = Class(name="Time_Literal")
Daytime = Class(name="Daytime")
TOD_Type_Name = Class(name="TOD_Type_Name")
iec61131_literals_Numeric_Literal = Class(name="iec61131_literals_Numeric_Literal", is_abstract=True)
Constant = Class(name="Constant")
iec61131_literals_Character_String = Class(name="iec61131_literals_Character_String", is_abstract=True)
iec61131_literals_Time_Literal = Class(name="iec61131_literals_Time_Literal", is_abstract=True)
iec61131_literals_Bit_String_Literal = Class(name="iec61131_literals_Bit_String_Literal")
BSInteger = Class(name="BSInteger")
Bit_String_Type_Name = Class(name="Bit_String_Type_Name")
iec61131_literals_Integer_Literal = Class(name="iec61131_literals_Integer_Literal")
Numeric_Literal = Class(name="Numeric_Literal")
Integer = Class(name="Integer")
iec61131_literals_Unsigned_Integer = Class(name="iec61131_literals_Unsigned_Integer")
literals_Fixed_Point_Literal = Class(name="literals_Fixed_Point_Literal")
iec61131_literals_Interval = Class(name="iec61131_literals_Interval", is_abstract=True)
Fixed_Point_Literal = Class(name="Fixed_Point_Literal")
iec61131_literals_Days = Class(name="iec61131_literals_Days")
Unsigned_Integer = Class(name="Unsigned_Integer")
Hours = Class(name="Hours")
iec61131_literals_Hours = Class(name="iec61131_literals_Hours")
Minutes = Class(name="Minutes")
iec61131_literals_Minutes = Class(name="iec61131_literals_Minutes")
Seconds = Class(name="Seconds")
iec61131_literals_Seconds = Class(name="iec61131_literals_Seconds")
Milliseconds = Class(name="Milliseconds")
iec61131_literals_Milliseconds = Class(name="iec61131_literals_Milliseconds")
iec61131_literals_Single_Byte_Character_String = Class(name="iec61131_literals_Single_Byte_Character_String")
Character_String = Class(name="Character_String")
Single_Byte_Character_Representation = Class(name="Single_Byte_Character_Representation")
iec61131_literals_Date = Class(name="iec61131_literals_Date")
Date_Type_Name = Class(name="Date_Type_Name")
Date_Literal = Class(name="Date_Literal")
iec61131_literals_Date_And_Time = Class(name="iec61131_literals_Date_And_Time")
DT_Type_Name = Class(name="DT_Type_Name")
iec61131_literals_Common_Character_Representation = Class(name="iec61131_literals_Common_Character_Representation")
iec61131_literals_Single_Byte_Character_Representation = Class(name="iec61131_literals_Single_Byte_Character_Representation")
Common_Character_Representation = Class(name="Common_Character_Representation")
iec61131_literals_Double_Byte_Character_Representation = Class(name="iec61131_literals_Double_Byte_Character_Representation")
iec61131_literals_Fixed_Point = Class(name="iec61131_literals_Fixed_Point")
iec61131_operators_Operator = Class(name="iec61131_operators_Operator", is_abstract=True)
iec61131_operators_Add_Operator = Class(name="iec61131_operators_Add_Operator", is_abstract=True)
Operator = Class(name="Operator")
iec61131_operators_Unary_Operator = Class(name="iec61131_operators_Unary_Operator", is_abstract=True)
iec61131_operators_Addition_Operator = Class(name="iec61131_operators_Addition_Operator", is_abstract=True)
iec61131_operators_Substraction_Operator = Class(name="iec61131_operators_Substraction_Operator", is_abstract=True)
iec61131_operators_Assignment_Operator = Class(name="iec61131_operators_Assignment_Operator", is_abstract=True)
iec61131_operators_Comparison_Operator = Class(name="iec61131_operators_Comparison_Operator", is_abstract=True)
iec61131_operators_Multiply_Operator = Class(name="iec61131_operators_Multiply_Operator", is_abstract=True)
Dot_Operator = Class(name="Dot_Operator")
iec61131_operators_Equal_Operator = Class(name="iec61131_operators_Equal_Operator", is_abstract=True)
EquUequ_Operator = Class(name="EquUequ_Operator")
iec61131_operators_And_Operator = Class(name="iec61131_operators_And_Operator", is_abstract=True)
operators_Operator = Class(name="operators_Operator")
il_Il_Expr_Operator = Class(name="il_Il_Expr_Operator")
iec61131_operators_Or_Operator = Class(name="iec61131_operators_Or_Operator")
iec61131_operators_Xor_Operator = Class(name="iec61131_operators_Xor_Operator")
iec61131_operators_Not_Operator = Class(name="iec61131_operators_Not_Operator")
operators_Unary_Operator = Class(name="operators_Unary_Operator")
il_Il_Simple_Operator = Class(name="il_Il_Simple_Operator")
iec61131_operators_Power_Operator = Class(name="iec61131_operators_Power_Operator", is_abstract=True)
iec61131_operators_Modulo_Operator = Class(name="iec61131_operators_Modulo_Operator")
operators_Dot_Operator = Class(name="operators_Dot_Operator")
iec61131_operators_Divide_Operator = Class(name="iec61131_operators_Divide_Operator", is_abstract=True)
iec61131_literals_Double_Byte_Character_String = Class(name="iec61131_literals_Double_Byte_Character_String")
Double_Byte_Character_Representation = Class(name="Double_Byte_Character_Representation")
iec61131_literals_Fixed_Point_Literal = Class(name="iec61131_literals_Fixed_Point_Literal", is_abstract=True)
iec61131_literals_Daytime = Class(name="iec61131_literals_Daytime")
iec61131_literals_Date_Literal = Class(name="iec61131_literals_Date_Literal")
iec61131_literals_BSInteger = Class(name="iec61131_literals_BSInteger", is_abstract=True)
iec61131_literals_Integer = Class(name="iec61131_literals_Integer", is_abstract=True)
iec61131_operators_Divide_Symbol = Class(name="iec61131_operators_Divide_Symbol")
Divide_Operator = Class(name="Divide_Operator")
iec61131_operators_Power_Symbol = Class(name="iec61131_operators_Power_Symbol")
Power_Operator = Class(name="Power_Operator")
iec61131_operators_Power_Name = Class(name="iec61131_operators_Power_Name")
iec61131_operators_Assignment_Symbol = Class(name="iec61131_operators_Assignment_Symbol")
Assignment_Operator = Class(name="Assignment_Operator")
iec61131_operators_Assignment_Name = Class(name="iec61131_operators_Assignment_Name")
iec61131_operators_And_Symbol = Class(name="iec61131_operators_And_Symbol")
And_Operator = Class(name="And_Operator")
iec61131_operators_And_Name = Class(name="iec61131_operators_And_Name")
iec61131_operators_Equal_Name = Class(name="iec61131_operators_Equal_Name")
operators_Equal_Operator = Class(name="operators_Equal_Operator")
operators_Comparison_Name = Class(name="operators_Comparison_Name")
iec61131_operators_Equal_Symbol = Class(name="iec61131_operators_Equal_Symbol")
Equal_Operator = Class(name="Equal_Operator")
iec61131_operators_Unequal_Name = Class(name="iec61131_operators_Unequal_Name")
operators_Unequal_Operator = Class(name="operators_Unequal_Operator")
iec61131_operators_Unequal_Symbol = Class(name="iec61131_operators_Unequal_Symbol")
Unequal_Operator = Class(name="Unequal_Operator")
iec61131_operators_Less_Name = Class(name="iec61131_operators_Less_Name")
operators_Less_Operator = Class(name="operators_Less_Operator")
iec61131_operators_Less_Symbol = Class(name="iec61131_operators_Less_Symbol")
Less_Operator = Class(name="Less_Operator")
iec61131_operators_LessEqual_Name = Class(name="iec61131_operators_LessEqual_Name")
operators_LessEqual_Operator = Class(name="operators_LessEqual_Operator")
iec61131_operators_LessEqual_Symbol = Class(name="iec61131_operators_LessEqual_Symbol")
LessEqual_Operator = Class(name="LessEqual_Operator")
iec61131_operators_Greater_Name = Class(name="iec61131_operators_Greater_Name")
operators_Greater_Operator = Class(name="operators_Greater_Operator")
iec61131_operators_Greater_Symbol = Class(name="iec61131_operators_Greater_Symbol")
Greater_Operator = Class(name="Greater_Operator")
iec61131_operators_GreaterEqual_Name = Class(name="iec61131_operators_GreaterEqual_Name")
operators_GreaterEqual_Operator = Class(name="operators_GreaterEqual_Operator")
iec61131_operators_GreaterEqual_Symbol = Class(name="iec61131_operators_GreaterEqual_Symbol")
GreaterEqual_Operator = Class(name="GreaterEqual_Operator")
iec61131_operators_Substraction_Name = Class(name="iec61131_operators_Substraction_Name")
operators_Substraction_Operator = Class(name="operators_Substraction_Operator")
iec61131_operators_Substraction_Symbol = Class(name="iec61131_operators_Substraction_Symbol")
iec61131_operators_EquUequ_Operator = Class(name="iec61131_operators_EquUequ_Operator", is_abstract=True)
iec61131_operators_Comparison_Name = Class(name="iec61131_operators_Comparison_Name", is_abstract=True)
Il_Expr_Operator = Class(name="Il_Expr_Operator")
iec61131_operators_Arithmetic_Name = Class(name="iec61131_operators_Arithmetic_Name", is_abstract=True)
iec61131_operators_Less_Operator = Class(name="iec61131_operators_Less_Operator", is_abstract=True)
Comparison_Operator = Class(name="Comparison_Operator")
iec61131_operators_Greater_Operator = Class(name="iec61131_operators_Greater_Operator", is_abstract=True)
iec61131_operators_GreaterEqual_Operator = Class(name="iec61131_operators_GreaterEqual_Operator", is_abstract=True)
iec61131_operators_LessEqual_Operator = Class(name="iec61131_operators_LessEqual_Operator", is_abstract=True)
iec61131_operators_Unequal_Operator = Class(name="iec61131_operators_Unequal_Operator", is_abstract=True)
iec61131_operators_Addition_Name = Class(name="iec61131_operators_Addition_Name")
operators_Addition_Operator = Class(name="operators_Addition_Operator")
operators_Arithmetic_Name = Class(name="operators_Arithmetic_Name")
iec61131_operators_Addition_Symbol = Class(name="iec61131_operators_Addition_Symbol")
operators_Add_Operator = Class(name="operators_Add_Operator")
iec61131_operators_Dot_Operator = Class(name="iec61131_operators_Dot_Operator", is_abstract=True)
iec61131_operators_Multiply_Name = Class(name="iec61131_operators_Multiply_Name")
operators_Multiply_Operator = Class(name="operators_Multiply_Operator")
iec61131_operators_Multiply_Symbol = Class(name="iec61131_operators_Multiply_Symbol")
Multiply_Operator = Class(name="Multiply_Operator")
iec61131_operators_Divide_Name = Class(name="iec61131_operators_Divide_Name")
operators_Divide_Operator = Class(name="operators_Divide_Operator")
iec61131_interfaces_Edge_Declaration = Class(name="iec61131_interfaces_Edge_Declaration")
Bool_Type_Name = Class(name="Bool_Type_Name")
iec61131_interfaces_Var1_Specification = Class(name="iec61131_interfaces_Var1_Specification", is_abstract=True)
Assignment_Symbol = Class(name="Assignment_Symbol")
iec61131_interfaces_Simple_Spec_Init = Class(name="iec61131_interfaces_Simple_Spec_Init", is_abstract=True)
interfaces_Var1_Specification = Class(name="interfaces_Var1_Specification")
interfaces_Located_Var_Spec_Init = Class(name="interfaces_Located_Var_Spec_Init")
pous_Structure_Elements = Class(name="pous_Structure_Elements")
Simple_Specification = Class(name="Simple_Specification")
iec61131_interfaces_Subrange_Spec_Init = Class(name="iec61131_interfaces_Subrange_Spec_Init")
interfaces_Var1_Specification_Func = Class(name="interfaces_Var1_Specification_Func")
Subrange_Specification = Class(name="Subrange_Specification")
Signed_Integer = Class(name="Signed_Integer")
iec61131_interfaces_Enumerated_Spec_Init = Class(name="iec61131_interfaces_Enumerated_Spec_Init")
Enumerated_Specification = Class(name="Enumerated_Specification")
Enumerated_Value = Class(name="Enumerated_Value")
iec61131_interfaces_Array_Var_Init_Decl = Class(name="iec61131_interfaces_Array_Var_Init_Decl")
Var2_Init_Decl = Class(name="Var2_Init_Decl")
Array_Spec_Init = Class(name="Array_Spec_Init")
iec61131_interfaces_Structured_Var_Init_Decl = Class(name="iec61131_interfaces_Structured_Var_Init_Decl")
Initialized_Structure = Class(name="Initialized_Structure")
iec61131_interfaces_Io_Var_Declaration = Class(name="iec61131_interfaces_Io_Var_Declaration", is_abstract=True)
interfaces_Interface = Class(name="interfaces_Interface")
pous_Function_Block_Vars = Class(name="pous_Function_Block_Vars")
pous_Program_Vars = Class(name="pous_Program_Vars")
pous_Function_Vars = Class(name="pous_Function_Vars")
iec61131_interfaces_Input_Declarations = Class(name="iec61131_interfaces_Input_Declarations")
Io_Var_Declaration = Class(name="Io_Var_Declaration")
Input_Declaration = Class(name="Input_Declaration")
iec61131_interfaces_Var_Init_Decl = Class(name="iec61131_interfaces_Var_Init_Decl", is_abstract=True)
Var1_List = Class(name="Var1_List")
iec61131_interfaces_Var1_Init_Decl = Class(name="iec61131_interfaces_Var1_Init_Decl")
Var_Init_Decl = Class(name="Var_Init_Decl")
Var1_Specification = Class(name="Var1_Specification")
iec61131_interfaces_Input_Output_Declarations = Class(name="iec61131_interfaces_Input_Output_Declarations")
Var_Declaration = Class(name="Var_Declaration")
iec61131_interfaces_Array_Spec_Init = Class(name="iec61131_interfaces_Array_Spec_Init")
Array_Initialization = Class(name="Array_Initialization")
Array_Specification = Class(name="Array_Specification")
iec61131_interfaces_Initialized_Structure = Class(name="iec61131_interfaces_Initialized_Structure")
pous_Structure_Specification = Class(name="pous_Structure_Specification")
Structure_Type_Name = Class(name="Structure_Type_Name")
iec61131_interfaces_Var_Declaration = Class(name="iec61131_interfaces_Var_Declaration", is_abstract=True)
iec61131_interfaces_Temp_Var_Decl = Class(name="iec61131_interfaces_Temp_Var_Decl", is_abstract=True)
iec61131_interfaces_Structure_Initialization = Class(name="iec61131_interfaces_Structure_Initialization")
Structure_Element_Initialization = Class(name="Structure_Element_Initialization")
iec61131_interfaces_Structure_Element_Initialization = Class(name="iec61131_interfaces_Structure_Element_Initialization")
Structure_Element_Name = Class(name="Structure_Element_Name")
Initial_Element = Class(name="Initial_Element")
iec61131_interfaces_Structure_Element_Name = Class(name="iec61131_interfaces_Structure_Element_Name")
iec61131_interfaces_Enumerated_Value = Class(name="iec61131_interfaces_Enumerated_Value")
Enumerated_Type_Name = Class(name="Enumerated_Type_Name")
iec61131_interfaces_Fb_Name_Decl = Class(name="iec61131_interfaces_Fb_Name_Decl")
Temp_Var_Declaration = Class(name="Temp_Var_Declaration")
Structure_Initialization = Class(name="Structure_Initialization")
Function_Block_Type_Name = Class(name="Function_Block_Type_Name")
iec61131_interfaces_String_Var_Declaration = Class(name="iec61131_interfaces_String_Var_Declaration", is_abstract=True)
interfaces_Temp_Var_Decl = Class(name="interfaces_Temp_Var_Decl")
interfaces_Var2_Init_Decl = Class(name="interfaces_Var2_Init_Decl")
iec61131_interfaces_Output_Declarations = Class(name="iec61131_interfaces_Output_Declarations")
iec61131_interfaces_Subrange_Specification = Class(name="iec61131_interfaces_Subrange_Specification", is_abstract=True)
interfaces_Specification = Class(name="interfaces_Specification")
interfaces_External_Specification = Class(name="interfaces_External_Specification")
interfaces_Var_Spec = Class(name="interfaces_Var_Spec")
iec61131_interfaces_Enumerated_Specification = Class(name="iec61131_interfaces_Enumerated_Specification", is_abstract=True)
iec61131_interfaces_Array_Specification = Class(name="iec61131_interfaces_Array_Specification", is_abstract=True)
iec61131_interfaces_Array_Initial_Elements = Class(name="iec61131_interfaces_Array_Initial_Elements", is_abstract=True)
iec61131_interfaces_Subrange = Class(name="iec61131_interfaces_Subrange")
Case_List_Element = Class(name="Case_List_Element")
Range = Class(name="Range")
iec61131_interfaces_Single_Byte_String_Var_Declaration = Class(name="iec61131_interfaces_Single_Byte_String_Var_Declaration")
String_Var_Declaration = Class(name="String_Var_Declaration")
Single_Byte_String_Spec = Class(name="Single_Byte_String_Spec")
iec61131_interfaces_Double_Byte_String_Var_Declaration = Class(name="iec61131_interfaces_Double_Byte_String_Var_Declaration")
Double_Byte_String_Spec = Class(name="Double_Byte_String_Spec")
iec61131_interfaces_Single_Byte_String_Spec = Class(name="iec61131_interfaces_Single_Byte_String_Spec")
Located_Var_Spec_Init = Class(name="Located_Var_Spec_Init")
Single_Byte_Character_String = Class(name="Single_Byte_Character_String")
Single_BString = Class(name="Single_BString")
iec61131_interfaces_Double_Byte_String_Spec = Class(name="iec61131_interfaces_Double_Byte_String_Spec")
Double_Byte_Character_String = Class(name="Double_Byte_Character_String")
Double_BString = Class(name="Double_BString")
iec61131_interfaces_Var1_List = Class(name="iec61131_interfaces_Var1_List")
iec61131_interfaces_Array_Initialization = Class(name="iec61131_interfaces_Array_Initialization")
Array_Initial_Elements = Class(name="Array_Initial_Elements")
iec61131_interfaces_Var1_Declaration = Class(name="iec61131_interfaces_Var1_Declaration")
Specification = Class(name="Specification")
iec61131_interfaces_Array_Var_Declaration = Class(name="iec61131_interfaces_Array_Var_Declaration")
iec61131_interfaces_Structured_Var_Declaration = Class(name="iec61131_interfaces_Structured_Var_Declaration")
iec61131_interfaces_Specification = Class(name="iec61131_interfaces_Specification", is_abstract=True)
iec61131_interfaces_Global_Var_Name = Class(name="iec61131_interfaces_Global_Var_Name")
Library_Element_Name = Class(name="Library_Element_Name")
iec61131_interfaces_Global_Var_List = Class(name="iec61131_interfaces_Global_Var_List")
Global_Var_Spec = Class(name="Global_Var_Spec")
iec61131_interfaces_Temp_Var_Decls = Class(name="iec61131_interfaces_Temp_Var_Decls")
Temp_Var_Decl = Class(name="Temp_Var_Decl")
iec61131_interfaces_Var_Declarations = Class(name="iec61131_interfaces_Var_Declarations")
iec61131_interfaces_Incompl_Located_Var_Declarations = Class(name="iec61131_interfaces_Incompl_Located_Var_Declarations")
Incompl_Located_Var_Decl = Class(name="Incompl_Located_Var_Decl")
iec61131_interfaces_RNV_Declarations = Class(name="iec61131_interfaces_RNV_Declarations", is_abstract=True)
iec61131_interfaces_Incompl_Located_Var_Decl = Class(name="iec61131_interfaces_Incompl_Located_Var_Decl")
Incompl_Location = Class(name="Incompl_Location")
Var_Spec = Class(name="Var_Spec")
iec61131_interfaces_Incompl_Location = Class(name="iec61131_interfaces_Incompl_Location")
iec61131_interfaces_Var_Spec = Class(name="iec61131_interfaces_Var_Spec", is_abstract=True)
iec61131_interfaces_External_Specification = Class(name="iec61131_interfaces_External_Specification", is_abstract=True)
iec61131_interfaces_Located_Var_Spec_Init = Class(name="iec61131_interfaces_Located_Var_Spec_Init", is_abstract=True)
iec61131_interfaces_Location = Class(name="iec61131_interfaces_Location")
Direct_Variable = Class(name="Direct_Variable")
iec61131_interfaces_Located_Var_Decl = Class(name="iec61131_interfaces_Located_Var_Decl")
Location = Class(name="Location")
Variable_Name = Class(name="Variable_Name")
iec61131_interfaces_Other_Var_Declaration = Class(name="iec61131_interfaces_Other_Var_Declaration", is_abstract=True)
iec61131_interfaces_External_Var_Declarations = Class(name="iec61131_interfaces_External_Var_Declarations")
Other_Var_Declaration = Class(name="Other_Var_Declaration")
External_Declaration = Class(name="External_Declaration")
iec61131_interfaces_Retentive_Var_Declarations = Class(name="iec61131_interfaces_Retentive_Var_Declarations")
RNV_Declarations = Class(name="RNV_Declarations")
iec61131_interfaces_Interface = Class(name="iec61131_interfaces_Interface", is_abstract=True)
iec61131_interfaces_Non_Retentive_Var_Declarations = Class(name="iec61131_interfaces_Non_Retentive_Var_Declarations")
iec61131_interfaces_External_Declaration = Class(name="iec61131_interfaces_External_Declaration")
Global_Var_Name = Class(name="Global_Var_Name")
External_Specification = Class(name="External_Specification")
iec61131_interfaces_Global_Var_Decl = Class(name="iec61131_interfaces_Global_Var_Decl")
iec61131_interfaces_Global_Var_Spec = Class(name="iec61131_interfaces_Global_Var_Spec", is_abstract=True)
iec61131_interfaces_Global_Var_Location = Class(name="iec61131_interfaces_Global_Var_Location")
iec61131_interfaces_Input_Declaration = Class(name="iec61131_interfaces_Input_Declaration", is_abstract=True)
iec61131_interfaces_Range = Class(name="iec61131_interfaces_Range", is_abstract=True)
iec61131_interfaces_Byte_String = Class(name="iec61131_interfaces_Byte_String", is_abstract=True)
iec61131_interfaces_Single_BString = Class(name="iec61131_interfaces_Single_BString")
Byte_String = Class(name="Byte_String")
Single_Byte_String_Type_Name = Class(name="Single_Byte_String_Type_Name")
iec61131_interfaces_Double_BString = Class(name="iec61131_interfaces_Double_BString")
Double_Byte_String_Type_Name = Class(name="Double_Byte_String_Type_Name")
iec61131_interfaces_Subrange_Specification1 = Class(name="iec61131_interfaces_Subrange_Specification1")
Subrange = Class(name="Subrange")
iec61131_interfaces_Subrange_Specification2 = Class(name="iec61131_interfaces_Subrange_Specification2")
Subrange_Type_Name = Class(name="Subrange_Type_Name")
iec61131_interfaces_Enumerated_Specification1 = Class(name="iec61131_interfaces_Enumerated_Specification1")
iec61131_interfaces_Enumerated_Specification2 = Class(name="iec61131_interfaces_Enumerated_Specification2")
iec61131_interfaces_Located_Var_Declarations = Class(name="iec61131_interfaces_Located_Var_Declarations")
Program_Vars = Class(name="Program_Vars")
Located_Var_Decl = Class(name="Located_Var_Decl")
iec61131_interfaces_Global_Var_Declarations = Class(name="iec61131_interfaces_Global_Var_Declarations")
Library_Element_Declaration = Class(name="Library_Element_Declaration")
Global_Var_Decl = Class(name="Global_Var_Decl")
iec61131_interfaces_Array_Specification2 = Class(name="iec61131_interfaces_Array_Specification2")
Non_Generic_Type_Name = Class(name="Non_Generic_Type_Name")
iec61131_interfaces_Array_Initial_Elements1 = Class(name="iec61131_interfaces_Array_Initial_Elements1")
iec61131_interfaces_Array_Initial_Elements2 = Class(name="iec61131_interfaces_Array_Initial_Elements2")
iec61131_interfaces_Initial_Element = Class(name="iec61131_interfaces_Initial_Element", is_abstract=True)
iec61131_interfaces_InitElement_Constant = Class(name="iec61131_interfaces_InitElement_Constant")
iec61131_interfaces_InitElement_EnumValue = Class(name="iec61131_interfaces_InitElement_EnumValue")
iec61131_interfaces_Array_Specification1 = Class(name="iec61131_interfaces_Array_Specification1")
Array_Type_Name = Class(name="Array_Type_Name")
iec61131_interfaces_Var2_Init_Decl = Class(name="iec61131_interfaces_Var2_Init_Decl", is_abstract=True)
iec61131_interfaces_Function_Var_Decl = Class(name="iec61131_interfaces_Function_Var_Decl")
iec61131_interfaces_Var_Name_Decl = Class(name="iec61131_interfaces_Var_Name_Decl")
Simple_Spec_Init = Class(name="Simple_Spec_Init")
iec61131_interfaces_Var_Init_Decl_Func = Class(name="iec61131_interfaces_Var_Init_Decl_Func")
Var1_Specification_Func = Class(name="Var1_Specification_Func")
iec61131_interfaces_Simple_Spec_Init_Func = Class(name="iec61131_interfaces_Simple_Spec_Init_Func")
Simple_Specification_Func = Class(name="Simple_Specification_Func")
iec61131_interfaces_Simple_Specification_Func = Class(name="iec61131_interfaces_Simple_Specification_Func", is_abstract=True)
iec61131_interfaces_Var1_Specification_Func = Class(name="iec61131_interfaces_Var1_Specification_Func", is_abstract=True)
iec61131_interfaces_InitElement_Structure = Class(name="iec61131_interfaces_InitElement_Structure")
iec61131_interfaces_Temp_Var_Declaration = Class(name="iec61131_interfaces_Temp_Var_Declaration", is_abstract=True)
iec61131_interfaces_InitElement_Array = Class(name="iec61131_interfaces_InitElement_Array")
Function_Block_Body = Class(name="Function_Block_Body")
iec61131_pous_Program_Type_Name = Class(name="iec61131_pous_Program_Type_Name")
Blocks = Class(name="Blocks")
iec61131_pous_Function_Block_Type_Name = Class(name="iec61131_pous_Function_Block_Type_Name", is_abstract=True)
types_Simple_Specification = Class(name="types_Simple_Specification")
iec61131_pous_Derived_Function_Block_Name = Class(name="iec61131_pous_Derived_Function_Block_Name")
pous_Function_Block_Type_Name = Class(name="pous_Function_Block_Type_Name")
iec61131_pous_Function_Block_Declaration = Class(name="iec61131_pous_Function_Block_Declaration")
Derived_Function_Block_Name = Class(name="Derived_Function_Block_Name")
Function_Block_Vars = Class(name="Function_Block_Vars")
iec61131_pous_Function_Declaration = Class(name="iec61131_pous_Function_Declaration")
Derived_Function_Name = Class(name="Derived_Function_Name")
Function_Return_Value = Class(name="Function_Return_Value")
iec61131_pous_Program_Declaration = Class(name="iec61131_pous_Program_Declaration")
Program_Type_Name = Class(name="Program_Type_Name")
iec61131_pous_Function_Block_Body = Class(name="iec61131_pous_Function_Block_Body", is_abstract=True)
iec61131_pous_Program_Access_Decl = Class(name="iec61131_pous_Program_Access_Decl")
Access_Name = Class(name="Access_Name")
Symbolic_Variable = Class(name="Symbolic_Variable")
iec61131_pous_Access_Name = Class(name="iec61131_pous_Access_Name")
iec61131_pous_Function_Name = Class(name="iec61131_pous_Function_Name", is_abstract=True)
iec61131_pous_Data_Type_Declaration = Class(name="iec61131_pous_Data_Type_Declaration")
Type_Declaration = Class(name="Type_Declaration")
iec61131_pous_Type_Declaration = Class(name="iec61131_pous_Type_Declaration", is_abstract=True)
iec61131_pous_Single_Element_Type_Declaration = Class(name="iec61131_pous_Single_Element_Type_Declaration", is_abstract=True)
iec61131_pous_Array_Type_Declaration = Class(name="iec61131_pous_Array_Type_Declaration")
iec61131_pous_Structure_Type_Declaration = Class(name="iec61131_pous_Structure_Type_Declaration")
Structure_Specification = Class(name="Structure_Specification")
iec61131_pous_String_Type_Declaration = Class(name="iec61131_pous_String_Type_Declaration")
String_Type_Name = Class(name="String_Type_Name")
Byte_String_Type_Name = Class(name="Byte_String_Type_Name")
Function_Vars = Class(name="Function_Vars")
Function_Body = Class(name="Function_Body")
iec61131_pous_Derived_Function_Name = Class(name="iec61131_pous_Derived_Function_Name")
pous_Function_Name = Class(name="pous_Function_Name")
iec61131_pous_Function_Return_Value = Class(name="iec61131_pous_Function_Return_Value", is_abstract=True)
iec61131_pous_Function_Body = Class(name="iec61131_pous_Function_Body", is_abstract=True)
iec61131_pous_Other_Language = Class(name="iec61131_pous_Other_Language")
pous_Function_Body = Class(name="pous_Function_Body")
pous_Function_Block_Body = Class(name="pous_Function_Block_Body")
Subrange_Spec_Init = Class(name="Subrange_Spec_Init")
iec61131_pous_Enumerated_Type_Declaration = Class(name="iec61131_pous_Enumerated_Type_Declaration")
Enumerated_Spec_Init = Class(name="Enumerated_Spec_Init")
iec61131_pous_Structure_Specification = Class(name="iec61131_pous_Structure_Specification", is_abstract=True)
iec61131_pous_Structure_Declaration = Class(name="iec61131_pous_Structure_Declaration")
Structure_Element_Declaration = Class(name="Structure_Element_Declaration")
iec61131_pous_Structure_Element_Declaration = Class(name="iec61131_pous_Structure_Element_Declaration")
Structure_Elements = Class(name="Structure_Elements")
iec61131_pous_Structure_Elements = Class(name="iec61131_pous_Structure_Elements", is_abstract=True)
iec61131_pous_Program_Vars = Class(name="iec61131_pous_Program_Vars", is_abstract=True)
iec61131_pous_Function_Vars = Class(name="iec61131_pous_Function_Vars", is_abstract=True)
iec61131_pous_Function_Block_Vars = Class(name="iec61131_pous_Function_Block_Vars", is_abstract=True)
iec61131_pous_Program_Access_Decls = Class(name="iec61131_pous_Program_Access_Decls")
Program_Access_Decl = Class(name="Program_Access_Decl")
iec61131_pous_Library = Class(name="iec61131_pous_Library")
Program_Declaration = Class(name="Program_Declaration")
Function_Declaration = Class(name="Function_Declaration")
Function_Block_Declaration = Class(name="Function_Block_Declaration")
iec61131_configurations_Configuration_Name = Class(name="iec61131_configurations_Configuration_Name")
iec61131_pous_Simple_Type_Declaration = Class(name="iec61131_pous_Simple_Type_Declaration")
Single_Element_Type_Declaration = Class(name="Single_Element_Type_Declaration")
Simple_Type_Name = Class(name="Simple_Type_Name")
iec61131_pous_Subrange_Type_Declaration = Class(name="iec61131_pous_Subrange_Type_Declaration")
iec61131_configurations_Resource_Name = Class(name="iec61131_configurations_Resource_Name")
iec61131_configurations_Resource_Declaration = Class(name="iec61131_configurations_Resource_Declaration")
Resource_Name = Class(name="Resource_Name")
Resource_Type_Name = Class(name="Resource_Type_Name")
iec61131_configurations_Single_Resource_Declaration = Class(name="iec61131_configurations_Single_Resource_Declaration")
Task_Configuration = Class(name="Task_Configuration")
Program_Configuration = Class(name="Program_Configuration")
iec61131_configurations_Task_Configuration = Class(name="iec61131_configurations_Task_Configuration")
Task_Name = Class(name="Task_Name")
Priority = Class(name="Priority")
Single = Class(name="Single")
iec61131_configurations_Program_Configuration = Class(name="iec61131_configurations_Program_Configuration")
Program_Name = Class(name="Program_Name")
Prog_Conf_Elements = Class(name="Prog_Conf_Elements")
iec61131_configurations_Resource_Type_Name = Class(name="iec61131_configurations_Resource_Type_Name")
iec61131_configurations_Configuration_Declaration = Class(name="iec61131_configurations_Configuration_Declaration")
Configuration_Name = Class(name="Configuration_Name")
Single_Resource_Declaration = Class(name="Single_Resource_Declaration")
Global_Var_Declarations = Class(name="Global_Var_Declarations")
Instance_Specific_Initializations = Class(name="Instance_Specific_Initializations")
Access_Declarations = Class(name="Access_Declarations")
Resource_Declaration = Class(name="Resource_Declaration")
iec61131_configurations_Access_Declarations = Class(name="iec61131_configurations_Access_Declarations")
Access_Declaration = Class(name="Access_Declaration")
iec61131_configurations_Access_Declaration = Class(name="iec61131_configurations_Access_Declaration")
Access_Path = Class(name="Access_Path")
iec61131_configurations_Access_Name = Class(name="iec61131_configurations_Access_Name")
iec61131_configurations_Access_Path = Class(name="iec61131_configurations_Access_Path", is_abstract=True)
iec61131_configurations_Direct_Path = Class(name="iec61131_configurations_Direct_Path")
iec61131_configurations_Symbolic_Path = Class(name="iec61131_configurations_Symbolic_Path")
iec61131_configurations_Program_Name = Class(name="iec61131_configurations_Program_Name")
iec61131_configurations_Task_Name = Class(name="iec61131_configurations_Task_Name")
iec61131_configurations_Task_Initialization = Class(name="iec61131_configurations_Task_Initialization", is_abstract=True)
iec61131_configurations_Instance_Specific_Initializations = Class(name="iec61131_configurations_Instance_Specific_Initializations")
Instance_Specific_Init = Class(name="Instance_Specific_Init")
iec61131_configurations_Data_Source = Class(name="iec61131_configurations_Data_Source", is_abstract=True)
iec61131_configurations_Global_Var_Reference = Class(name="iec61131_configurations_Global_Var_Reference")
configurations_Data_Sink = Class(name="configurations_Data_Sink")
iec61131_configurations_Program_Output_Reference = Class(name="iec61131_configurations_Program_Output_Reference")
Data_Source = Class(name="Data_Source")
iec61131_configurations_Prog_Sink = Class(name="iec61131_configurations_Prog_Sink")
Prog_Cnxn = Class(name="Prog_Cnxn")
Data_Sink = Class(name="Data_Sink")
iec61131_configurations_Prog_Source = Class(name="iec61131_configurations_Prog_Source")
Prog_Data_Source = Class(name="Prog_Data_Source")
iec61131_configurations_Data_Sink = Class(name="iec61131_configurations_Data_Sink", is_abstract=True)
iec61131_configurations_Instance_Specific_Init = Class(name="iec61131_configurations_Instance_Specific_Init", is_abstract=True)
iec61131_configurations_Instance_Spec1 = Class(name="iec61131_configurations_Instance_Spec1")
iec61131_configurations_Instance_Spec2 = Class(name="iec61131_configurations_Instance_Spec2")
iec61131_configurations_Single = Class(name="iec61131_configurations_Single")
Task_Initialization = Class(name="Task_Initialization")
iec61131_configurations_Prog_Conf_Elements = Class(name="iec61131_configurations_Prog_Conf_Elements")
Prog_Conf_Element = Class(name="Prog_Conf_Element")
iec61131_configurations_Prog_Conf_Element = Class(name="iec61131_configurations_Prog_Conf_Element", is_abstract=True)
iec61131_configurations_Fb_Task = Class(name="iec61131_configurations_Fb_Task")
iec61131_configurations_Prog_Cnxn = Class(name="iec61131_configurations_Prog_Cnxn", is_abstract=True)
iec61131_configurations_Prog_Data_Source = Class(name="iec61131_configurations_Prog_Data_Source", is_abstract=True)
iec61131_st_Expression = Class(name="iec61131_st_Expression")
Expression_Types = Class(name="Expression_Types")
Or_Operator = Class(name="Or_Operator")
iec61131_st_Statement = Class(name="iec61131_st_Statement", is_abstract=True)
iec61131_st_Assignment_Statement = Class(name="iec61131_st_Assignment_Statement")
Expression_Variable = Class(name="Expression_Variable")
iec61131_st_Subprogram_Control_Statement = Class(name="iec61131_st_Subprogram_Control_Statement", is_abstract=True)
iec61131_st_Selection_Statement = Class(name="iec61131_st_Selection_Statement", is_abstract=True)
iec61131_st_Iteration_Statement = Class(name="iec61131_st_Iteration_Statement", is_abstract=True)
iec61131_st_Return_Statement = Class(name="iec61131_st_Return_Statement")
Subprogram_Control_Statement = Class(name="Subprogram_Control_Statement")
iec61131_st_Fb_Invocation = Class(name="iec61131_st_Fb_Invocation")
Param_Assignment = Class(name="Param_Assignment")
iec61131_st_Param_Assignment = Class(name="iec61131_st_Param_Assignment", is_abstract=True)
iec61131_st_Param_Type1 = Class(name="iec61131_st_Param_Type1")
iec61131_configurations_Interval = Class(name="iec61131_configurations_Interval")
iec61131_configurations_Priority = Class(name="iec61131_configurations_Priority")
iec61131_st_Statement_List = Class(name="iec61131_st_Statement_List")
Statement = Class(name="Statement")
Else_If_Statement = Class(name="Else_If_Statement")
Else_Statement = Class(name="Else_Statement")
iec61131_st_Case_Statement = Class(name="iec61131_st_Case_Statement")
Case_Element = Class(name="Case_Element")
iec61131_st_Else_If_Statement = Class(name="iec61131_st_Else_If_Statement")
iec61131_st_Else_Statement = Class(name="iec61131_st_Else_Statement")
iec61131_st_Case_Element = Class(name="iec61131_st_Case_Element")
Case_List = Class(name="Case_List")
iec61131_st_Case_List = Class(name="iec61131_st_Case_List")
iec61131_st_Case_List_Element = Class(name="iec61131_st_Case_List_Element", is_abstract=True)
iec61131_st_For_Statement = Class(name="iec61131_st_For_Statement")
Iteration_Statement = Class(name="Iteration_Statement")
Control_Variable = Class(name="Control_Variable")
For_List = Class(name="For_List")
iec61131_st_Param_Type2 = Class(name="iec61131_st_Param_Type2")
Variable = Class(name="Variable")
Not_Operator = Class(name="Not_Operator")
iec61131_st_If_Statement = Class(name="iec61131_st_If_Statement")
Selection_Statement = Class(name="Selection_Statement")
Statement_List = Class(name="Statement_List")
iec61131_st_Exit_Statement = Class(name="iec61131_st_Exit_Statement")
iec61131_st_Control_Variable = Class(name="iec61131_st_Control_Variable")
iec61131_st_For_List = Class(name="iec61131_st_For_List")
iec61131_st_Xor_Expression = Class(name="iec61131_st_Xor_Expression")
Xor_Operator = Class(name="Xor_Operator")
iec61131_st_And_Expression = Class(name="iec61131_st_And_Expression")
iec61131_st_Comparison = Class(name="iec61131_st_Comparison")
iec61131_st_While_Statement = Class(name="iec61131_st_While_Statement")
iec61131_st_Repeat_Statement = Class(name="iec61131_st_Repeat_Statement")
iec61131_st_Add_Expression = Class(name="iec61131_st_Add_Expression")
Add_Operator = Class(name="Add_Operator")
iec61131_st_Term_Expression = Class(name="iec61131_st_Term_Expression")
iec61131_st_Equ_Expression = Class(name="iec61131_st_Equ_Expression")
iec61131_st_Primary_Expression = Class(name="iec61131_st_Primary_Expression", is_abstract=True)
iec61131_st_Bracket_Expression = Class(name="iec61131_st_Bracket_Expression")
Primary_Expression = Class(name="Primary_Expression")
iec61131_st_Call_Expression = Class(name="iec61131_st_Call_Expression")
Function_Name = Class(name="Function_Name")
iec61131_st_Expression_Types = Class(name="iec61131_st_Expression_Types", is_abstract=True)
iec61131_st_Expression_Variable = Class(name="iec61131_st_Expression_Variable")
Array_Variable = Class(name="Array_Variable")
Structured_Variable = Class(name="Structured_Variable")
iec61131_st_Expression_Constant = Class(name="iec61131_st_Expression_Constant")
iec61131_st_Expression_EnumValue = Class(name="iec61131_st_Expression_EnumValue")
iec61131_st_Power_Expression = Class(name="iec61131_st_Power_Expression")
Power_Symbol = Class(name="Power_Symbol")
iec61131_st_Unary_Expression = Class(name="iec61131_st_Unary_Expression")
Unary_Operator = Class(name="Unary_Operator")
iec61131_il_Simple_Instr_List = Class(name="iec61131_il_Simple_Instr_List")
Il_Simple_Instruction = Class(name="Il_Simple_Instruction")
iec61131_il_Il_Instruction = Class(name="iec61131_il_Il_Instruction")
Label = Class(name="Label")
Il_Operations = Class(name="Il_Operations")
iec61131_il_Label = Class(name="iec61131_il_Label")
iec61131_il_Il_Simple_Operation = Class(name="iec61131_il_Il_Simple_Operation", is_abstract=True)
il_Il_Operations = Class(name="il_Il_Operations")
il_Simple_Instr = Class(name="il_Simple_Instr")
iec61131_il_Il_Expression = Class(name="iec61131_il_Il_Expression")
Il_Operand = Class(name="Il_Operand")
Simple_Instr_List = Class(name="Simple_Instr_List")
iec61131_il_Il_Jump_Operation = Class(name="iec61131_il_Il_Jump_Operation")
Il_Jump_Operator = Class(name="Il_Jump_Operator")
iec61131_il_Il_Fb_Call = Class(name="iec61131_il_Il_Fb_Call")
Il_Call_Operator = Class(name="Il_Call_Operator")
Operands = Class(name="Operands")
iec61131_st_Expression_Variable_Type = Class(name="iec61131_st_Expression_Variable_Type")
iec61131_il_Instruction_List = Class(name="iec61131_il_Instruction_List")
Il_Instruction = Class(name="Il_Instruction")
iec61131_il_Simple_Operation1 = Class(name="iec61131_il_Simple_Operation1")
Il_Simple_Operation = Class(name="Il_Simple_Operation")
Il_Simple_Operator = Class(name="Il_Simple_Operator")
iec61131_il_Simple_Operation2 = Class(name="iec61131_il_Simple_Operation2")
Il_Operand_List = Class(name="Il_Operand_List")
iec61131_il_Il_Expr_Operator = Class(name="iec61131_il_Il_Expr_Operator")
iec61131_il_Il_Jump_Operator = Class(name="iec61131_il_Il_Jump_Operator")
iec61131_il_Il_Call_Operator = Class(name="iec61131_il_Il_Call_Operator")
iec61131_il_Il_Param_List = Class(name="iec61131_il_Il_Param_List")
Il_Param_Instruction = Class(name="Il_Param_Instruction")
Il_Param_Last_Instruction = Class(name="Il_Param_Last_Instruction")
iec61131_il_Operand1 = Class(name="iec61131_il_Operand1")
iec61131_il_Operand2 = Class(name="iec61131_il_Operand2")
iec61131_il_Operands = Class(name="iec61131_il_Operands", is_abstract=True)
iec61131_il_Il_Simple_Instruction = Class(name="iec61131_il_Il_Simple_Instruction")
Simple_Instr = Class(name="Simple_Instr")
iec61131_il_Simple_Instr = Class(name="iec61131_il_Simple_Instr", is_abstract=True)
iec61131_il_Il_Param_Instruction = Class(name="iec61131_il_Il_Param_Instruction")
Param_Instruction = Class(name="Param_Instruction")
iec61131_il_Il_Param_Last_Instruction = Class(name="iec61131_il_Il_Param_Last_Instruction")
iec61131_il_Il_Param_Assignment = Class(name="iec61131_il_Il_Param_Assignment")
Param_Assignments = Class(name="Param_Assignments")
Il_Assign_Operator = Class(name="Il_Assign_Operator")
iec61131_il_Il_Formal_Funct_Call = Class(name="iec61131_il_Il_Formal_Funct_Call")
Il_Param_List = Class(name="Il_Param_List")
iec61131_il_Il_Return_Operator = Class(name="iec61131_il_Il_Return_Operator")
iec61131_il_Il_Operations = Class(name="iec61131_il_Il_Operations", is_abstract=True)
iec61131_il_Il_Simple_Operator = Class(name="iec61131_il_Il_Simple_Operator")
iec61131_il_Il_Operand = Class(name="iec61131_il_Il_Operand", is_abstract=True)
iec61131_il_Il_Operand_List = Class(name="iec61131_il_Il_Operand_List")
Il_Assign_Out_Operator = Class(name="Il_Assign_Out_Operator")
iec61131_il_Param_Assignments = Class(name="iec61131_il_Param_Assignments", is_abstract=True)
iec61131_il_Param_Instruction = Class(name="iec61131_il_Param_Instruction", is_abstract=True)
iec61131_il_Il_Assign_Operator = Class(name="iec61131_il_Il_Assign_Operator")
Assignment_Name = Class(name="Assignment_Name")
iec61131_il_Param_Assignment2 = Class(name="iec61131_il_Param_Assignment2")
iec61131_il_Param_Assignment = Class(name="iec61131_il_Param_Assignment", is_abstract=True)
iec61131_il_Il_Assign_Out_Operator = Class(name="iec61131_il_Il_Assign_Out_Operator")
iec61131_sfc_Sequential_Function_Chart = Class(name="iec61131_sfc_Sequential_Function_Chart")
Sfc_Network = Class(name="Sfc_Network")
iec61131_sfc_Sfc_Network = Class(name="iec61131_sfc_Sfc_Network")
iec61131_il_Il_Param_Out_Assignment = Class(name="iec61131_il_Il_Param_Out_Assignment")
Transition_Condition = Class(name="Transition_Condition")
iec61131_sfc_Action = Class(name="iec61131_sfc_Action")
Action_Name = Class(name="Action_Name")
iec61131_sfc_Sfc_Elements = Class(name="iec61131_sfc_Sfc_Elements", is_abstract=True)
iec61131_sfc_Step_Name = Class(name="iec61131_sfc_Step_Name")
iec61131_sfc_Action_Association = Class(name="iec61131_sfc_Action_Association")
Action_Qualifier = Class(name="Action_Qualifier")
iec61131_sfc_Step_Types = Class(name="iec61131_sfc_Step_Types", is_abstract=True)
Action_Association = Class(name="Action_Association")
Step_Name = Class(name="Step_Name")
iec61131_sfc_Action_Name = Class(name="iec61131_sfc_Action_Name")
iec61131_sfc_Action_Qualifier = Class(name="iec61131_sfc_Action_Qualifier")
Timed_Qualifier = Class(name="Timed_Qualifier")
Action_Time = Class(name="Action_Time")
iec61131_sfc_Timed_Qualifier = Class(name="iec61131_sfc_Timed_Qualifier")
Initial_Step = Class(name="Initial_Step")
Sfc_Elements = Class(name="Sfc_Elements")
iec61131_sfc_Initial_Step = Class(name="iec61131_sfc_Initial_Step")
Step_Types = Class(name="Step_Types")
iec61131_sfc_Step = Class(name="iec61131_sfc_Step")
sfc_Sfc_Elements = Class(name="sfc_Sfc_Elements")
sfc_Step_Types = Class(name="sfc_Step_Types")
iec61131_sfc_Transition = Class(name="iec61131_sfc_Transition")
Transition_Name = Class(name="Transition_Name")
Steps = Class(name="Steps")
Cond2_Condition = Class(name="Cond2_Condition")
iec61131_sfc_Transition_Cond1 = Class(name="iec61131_sfc_Transition_Cond1")
iec61131_sfc_Transition_Cond3 = Class(name="iec61131_sfc_Transition_Cond3")
iec61131_sfc_Cond2_Condition = Class(name="iec61131_sfc_Cond2_Condition", is_abstract=True)
iec61131_sfc_ActionTime2 = Class(name="iec61131_sfc_ActionTime2")
iec61131_variables_Symbolic_Variable = Class(name="iec61131_variables_Symbolic_Variable", is_abstract=True)
iec61131_variables_Multi_Element_Variable = Class(name="iec61131_variables_Multi_Element_Variable", is_abstract=True)
iec61131_variables_Array_Variable = Class(name="iec61131_variables_Array_Variable")
Multi_Element_Variable = Class(name="Multi_Element_Variable")
Subscript_List = Class(name="Subscript_List")
iec61131_variables_Structured_Variable = Class(name="iec61131_variables_Structured_Variable")
iec61131_variables_Direct_Variable = Class(name="iec61131_variables_Direct_Variable")
variables_Variable = Class(name="variables_Variable")
iec61131_sfc_Action_Time = Class(name="iec61131_sfc_Action_Time", is_abstract=True)
iec61131_sfc_Transition_Name = Class(name="iec61131_sfc_Transition_Name")
iec61131_sfc_Steps = Class(name="iec61131_sfc_Steps", is_abstract=True)
iec61131_sfc_Transition_Condition = Class(name="iec61131_sfc_Transition_Condition", is_abstract=True)
iec61131_sfc_Steps1 = Class(name="iec61131_sfc_Steps1")
iec61131_sfc_Steps2 = Class(name="iec61131_sfc_Steps2")
iec61131_sfc_Transition_Cond2 = Class(name="iec61131_sfc_Transition_Cond2")
Fbd_Network = Class(name="Fbd_Network")
iec61131_fbd_Fbd_Network = Class(name="iec61131_fbd_Fbd_Network")
iec61131_types_TypeLib = Class(name="iec61131_types_TypeLib")
Data_Type_Name = Class(name="Data_Type_Name")
iec61131_types_Numeric_Type_Name = Class(name="iec61131_types_Numeric_Type_Name", is_abstract=True)
Elementary_Type_Name = Class(name="Elementary_Type_Name")
iec61131_types_Integer_Type_Name = Class(name="iec61131_types_Integer_Type_Name", is_abstract=True)
Numeric_Type_Name = Class(name="Numeric_Type_Name")
iec61131_types_Real_Type_Name = Class(name="iec61131_types_Real_Type_Name")
iec61131_types_Signed_Integer_Type_Name = Class(name="iec61131_types_Signed_Integer_Type_Name")
iec61131_types_Unsigned_Integer_Type_Name = Class(name="iec61131_types_Unsigned_Integer_Type_Name")
iec61131_types_Elementary_Type_Name = Class(name="iec61131_types_Elementary_Type_Name", is_abstract=True)
types_Non_Generic_Type_Name = Class(name="types_Non_Generic_Type_Name")
interfaces_Simple_Specification_Func = Class(name="interfaces_Simple_Specification_Func")
iec61131_types_Date_Type_Name = Class(name="iec61131_types_Date_Type_Name")
iec61131_types_Bit_String_Type_Name = Class(name="iec61131_types_Bit_String_Type_Name")
iec61131_types_Non_Generic_Type_Name = Class(name="iec61131_types_Non_Generic_Type_Name", is_abstract=True)
types_Data_Type_Name = Class(name="types_Data_Type_Name")
pous_Function_Return_Value = Class(name="pous_Function_Return_Value")
iec61131_types_Derived_Type_Name = Class(name="iec61131_types_Derived_Type_Name", is_abstract=True)
iec61131_types_Generic_Type_Name = Class(name="iec61131_types_Generic_Type_Name")
iec61131_types_Data_Type_Name = Class(name="iec61131_types_Data_Type_Name", is_abstract=True)
iec61131_types_Bool_Type_Name = Class(name="iec61131_types_Bool_Type_Name")
iec61131_types_DT_Type_Name = Class(name="iec61131_types_DT_Type_Name")
iec61131_types_TOD_Type_Name = Class(name="iec61131_types_TOD_Type_Name")
iec61131_variables_Variable = Class(name="iec61131_variables_Variable", is_abstract=True)
iec61131_variables_Variable_Name = Class(name="iec61131_variables_Variable_Name")
variables_Symbolic_Variable = Class(name="variables_Symbolic_Variable")
Output_Reference = Class(name="Output_Reference")
Input_Reference = Class(name="Input_Reference")
iec61131_variables_Subscript_List = Class(name="iec61131_variables_Subscript_List")
iec61131_ld_Ladder_Diagram = Class(name="iec61131_ld_Ladder_Diagram")
iec61131_types_Simple_Specification = Class(name="iec61131_types_Simple_Specification", is_abstract=True)
iec61131_ld_Rung = Class(name="iec61131_ld_Rung")
iec61131_fbd_Function_Block_Diagram = Class(name="iec61131_fbd_Function_Block_Diagram")
iec61131_types_Duration_Type_Name = Class(name="iec61131_types_Duration_Type_Name")
iec61131_types_Single_Element_Type_Name = Class(name="iec61131_types_Single_Element_Type_Name", is_abstract=True)
Derived_Type_Name = Class(name="Derived_Type_Name")
iec61131_types_Array_Type_Name = Class(name="iec61131_types_Array_Type_Name")
iec61131_types_Structure_Type_Name = Class(name="iec61131_types_Structure_Type_Name")
types_Derived_Type_Name = Class(name="types_Derived_Type_Name")
iec61131_types_String_Type_Name = Class(name="iec61131_types_String_Type_Name")
iec61131_types_Simple_Type_Name = Class(name="iec61131_types_Simple_Type_Name")
types_Single_Element_Type_Name = Class(name="types_Single_Element_Type_Name")
iec61131_types_Subrange_Type_Name = Class(name="iec61131_types_Subrange_Type_Name")
Single_Element_Type_Name = Class(name="Single_Element_Type_Name")
iec61131_types_Enumerated_Type_Name = Class(name="iec61131_types_Enumerated_Type_Name")
iec61131_types_Single_Byte_String_Type_Name = Class(name="iec61131_types_Single_Byte_String_Type_Name")
iec61131_types_Double_Byte_String_Type_Name = Class(name="iec61131_types_Double_Byte_String_Type_Name")
iec61131_types_Byte_String_Type_Name = Class(name="iec61131_types_Byte_String_Type_Name", is_abstract=True)
...
iec61131_literals_Daytime.attributes={iec61131_literals_Daytime_hour, iec61131_literals_Daytime_minute}
...
iec61131_interfaces_Located_Var_Declarations.attributes={iec61131_interfaces_Located_Var_Declarations_retain, iec61131_interfaces_Located_Var_Declarations_constant}
...
iec61131_interfaces_Global_Var_Declarations.attributes={iec61131_interfaces_Global_Var_Declarations_constant, iec61131_interfaces_Global_Var_Declarations_retain}
...
or_402: BinaryAssociation = BinaryAssociation(
    name="or_402",
    ends={
...
else_438: BinaryAssociation = BinaryAssociation(
    name="else_438",
    ends={
...
else_440: BinaryAssociation = BinaryAssociation(
    name="else_440",
    ends={
...
not_430: BinaryAssociation = BinaryAssociation(
    name="not_430",
    ends={
...
and_495: BinaryAssociation = BinaryAssociation(
    name="and_495",
    ends={
...
not_617: BinaryAssociation = BinaryAssociation(
    name="not_617",
    ends={
...
domain_model = DomainModel(
    name="iec61131",
    types={iec61131_IEC61131, iec61131_Library_Element_Declaration, iec61131_Library_Element_Name, Commentable, NamedElement, iec61131_Commentable, iec61131_NamedElement, Integer_Type_Name, iec61131_literals_Real_Literal, Real_Type_Name, Fixed_Point, iec61131_literals_Boolean_Literal, iec61131_literals_Constant, configurations_Data_Source, configurations_Prog_Data_Source, il_Il_Operand, iec61131_literals_Signed_Integer, literals_Integer, st_Case_List_Element, interfaces_Range, iec61131_literals_Binary_Integer, literals_BSInteger, iec61131_literals_Octal_Integer, iec61131_literals_Hex_Integer, iec61131_literals_Duration, literals_Time_Literal, sfc_Action_Time, Interval, Duration_Type_Name, Substraction_Operator, iec61131_literals_Time_Of_Day, Time_Literal, Daytime, TOD_Type_Name, iec61131_literals_Numeric_Literal, Constant, iec61131_literals_Character_String, iec61131_literals_Time_Literal, iec61131_literals_Bit_String_Literal, BSInteger, Bit_String_Type_Name, iec61131_literals_Integer_Literal, Numeric_Literal, Integer, iec61131_literals_Unsigned_Integer, literals_Fixed_Point_Literal, iec61131_literals_Interval, Fixed_Point_Literal, iec61131_literals_Days, Unsigned_Integer, Hours, iec61131_literals_Hours, Minutes, iec61131_literals_Minutes, Seconds, iec61131_literals_Seconds, Milliseconds, iec61131_literals_Milliseconds, iec61131_literals_Single_Byte_Character_String, Character_String, Single_Byte_Character_Representation, iec61131_literals_Date, Date_Type_Name, Date_Literal, iec61131_literals_Date_And_Time, DT_Type_Name, iec61131_literals_Common_Character_Representation, iec61131_literals_Single_Byte_Character_Representation, Common_Character_Representation, iec61131_literals_Double_Byte_Character_Representation, iec61131_literals_Fixed_Point, iec61131_operators_Operator, iec61131_operators_Add_Operator, Operator, iec61131_operators_Unary_Operator, iec61131_operators_Addition_Operator, iec61131_operators_Substraction_Operator, iec61131_operators_Assignment_Operator, iec61131_operators_Comparison_Operator, iec61131_operators_Multiply_Operator, Dot_Operator, iec61131_operators_Equal_Operator, EquUequ_Operator, iec61131_operators_And_Operator, operators_Operator, il_Il_Expr_Operator, iec61131_operators_Or_Operator, iec61131_operators_Xor_Operator, iec61131_operators_Not_Operator, operators_Unary_Operator, il_Il_Simple_Operator, iec61131_operators_Power_Operator, iec61131_operators_Modulo_Operator, operators_Dot_Operator, iec61131_operators_Divide_Operator, iec61131_literals_Double_Byte_Character_String, Double_Byte_Character_Representation, iec61131_literals_Fixed_Point_Literal, iec61131_literals_Daytime, iec61131_literals_Date_Literal, iec61131_literals_BSInteger, iec61131_literals_Integer, iec61131_operators_Divide_Symbol, Divide_Operator, iec61131_operators_Power_Symbol, Power_Operator, iec61131_operators_Power_Name, iec61131_operators_Assignment_Symbol, Assignment_Operator, iec61131_operators_Assignment_Name, iec61131_operators_And_Symbol, And_Operator, iec61131_operators_And_Name, iec61131_operators_Equal_Name, operators_Equal_Operator, operators_Comparison_Name, iec61131_operators_Equal_Symbol, Equal_Operator, iec61131_operators_Unequal_Name, operators_Unequal_Operator, iec61131_operators_Unequal_Symbol, Unequal_Operator, iec61131_operators_Less_Name, operators_Less_Operator, iec61131_operators_Less_Symbol, Less_Operator, iec61131_operators_LessEqual_Name, operators_LessEqual_Operator, iec61131_operators_LessEqual_Symbol, LessEqual_Operator, iec61131_operators_Greater_Name, operators_Greater_Operator, iec61131_operators_Greater_Symbol, Greater_Operator, iec61131_operators_GreaterEqual_Name, operators_GreaterEqual_Operator, iec61131_operators_GreaterEqual_Symbol, GreaterEqual_Operator, iec61131_operators_Substraction_Name, operators_Substraction_Operator, iec61131_operators_Substraction_Symbol, iec61131_operators_EquUequ_Operator, iec61131_operators_Comparison_Name, Il_Expr_Operator, iec61131_operators_Arithmetic_Name, iec61131_operators_Less_Operator, Comparison_Operator, iec61131_operators_Greater_Operator, iec61131_operators_GreaterEqual_Operator, iec61131_operators_LessEqual_Operator, iec61131_operators_Unequal_Operator, iec61131_operators_Addition_Name, operators_Addition_Operator, operators_Arithmetic_Name, iec61131_operators_Addition_Symbol, operators_Add_Operator, iec61131_operators_Dot_Operator, iec61131_operators_Multiply_Name, operators_Multiply_Operator, iec61131_operators_Multiply_Symbol, Multiply_Operator, iec61131_operators_Divide_Name, operators_Divide_Operator, iec61131_interfaces_Edge_Declaration, Bool_Type_Name, iec61131_interfaces_Var1_Specification, Assignment_Symbol, iec61131_interfaces_Simple_Spec_Init, interfaces_Var1_Specification, interfaces_Located_Var_Spec_Init, pous_Structure_Elements, Simple_Specification, iec61131_interfaces_Subrange_Spec_Init, interfaces_Var1_Specification_Func, Subrange_Specification, Signed_Integer, iec61131_interfaces_Enumerated_Spec_Init, Enumerated_Specification, Enumerated_Value, iec61131_interfaces_Array_Var_Init_Decl, Var2_Init_Decl, Array_Spec_Init, iec61131_interfaces_Structured_Var_Init_Decl, Initialized_Structure, iec61131_interfaces_Io_Var_Declaration, interfaces_Interface, pous_Function_Block_Vars, pous_Program_Vars, pous_Function_Vars, iec61131_interfaces_Input_Declarations, Io_Var_Declaration, Input_Declaration, iec61131_interfaces_Var_Init_Decl, Var1_List, iec61131_interfaces_Var1_Init_Decl, Var_Init_Decl, Var1_Specification, iec61131_interfaces_Input_Output_Declarations, Var_Declaration, iec61131_interfaces_Array_Spec_Init, Array_Initialization, Array_Specification, iec61131_interfaces_Initialized_Structure, pous_Structure_Specification, Structure_Type_Name, iec61131_interfaces_Var_Declaration, iec61131_interfaces_Temp_Var_Decl, iec61131_interfaces_Structure_Initialization, Structure_Element_Initialization, iec61131_interfaces_Structure_Element_Initialization, Structure_Element_Name, Initial_Element, iec61131_interfaces_Structure_Element_Name, iec61131_interfaces_Enumerated_Value, Enumerated_Type_Name, iec61131_interfaces_Fb_Name_Decl, Temp_Var_Declaration, Structure_Initialization, Function_Block_Type_Name, iec61131_interfaces_String_Var_Declaration, interfaces_Temp_Var_Decl, interfaces_Var2_Init_Decl, iec61131_interfaces_Output_Declarations, iec61131_interfaces_Subrange_Specification, interfaces_Specification, interfaces_External_Specification, interfaces_Var_Spec, iec61131_interfaces_Enumerated_Specification, iec61131_interfaces_Array_Specification, iec61131_interfaces_Array_Initial_Elements, iec61131_interfaces_Subrange, Case_List_Element, Range, iec61131_interfaces_Single_Byte_String_Var_Declaration, String_Var_Declaration, Single_Byte_String_Spec, iec61131_interfaces_Double_Byte_String_Var_Declaration, Double_Byte_String_Spec, iec61131_interfaces_Single_Byte_String_Spec, Located_Var_Spec_Init, Single_Byte_Character_String, Single_BString, iec61131_interfaces_Double_Byte_String_Spec, Double_Byte_Character_String, Double_BString, iec61131_interfaces_Var1_List, iec61131_interfaces_Array_Initialization, Array_Initial_Elements, iec61131_interfaces_Var1_Declaration, Specification, iec61131_interfaces_Array_Var_Declaration, iec61131_interfaces_Structured_Var_Declaration, iec61131_interfaces_Specification, iec61131_interfaces_Global_Var_Name, Library_Element_Name, iec61131_interfaces_Global_Var_List, Global_Var_Spec, iec61131_interfaces_Temp_Var_Decls, Temp_Var_Decl, iec61131_interfaces_Var_Declarations, iec61131_interfaces_Incompl_Located_Var_Declarations, Incompl_Located_Var_Decl, iec61131_interfaces_RNV_Declarations, iec61131_interfaces_Incompl_Located_Var_Decl, Incompl_Location, Var_Spec, iec61131_interfaces_Incompl_Location, iec61131_interfaces_Var_Spec, iec61131_interfaces_External_Specification, iec61131_interfaces_Located_Var_Spec_Init, iec61131_interfaces_Location, Direct_Variable, iec61131_interfaces_Located_Var_Decl, Location, Variable_Name, iec61131_interfaces_Other_Var_Declaration, iec61131_interfaces_External_Var_Declarations, Other_Var_Declaration, External_Declaration, iec61131_interfaces_Retentive_Var_Declarations, RNV_Declarations, iec61131_interfaces_Interface, iec61131_interfaces_Non_Retentive_Var_Declarations, iec61131_interfaces_External_Declaration, Global_Var_Name, External_Specification, iec61131_interfaces_Global_Var_Decl, iec61131_interfaces_Global_Var_Spec, iec61131_interfaces_Global_Var_Location, iec61131_interfaces_Input_Declaration, iec61131_interfaces_Range, iec61131_interfaces_Byte_String, iec61131_interfaces_Single_BString, Byte_String, Single_Byte_String_Type_Name, iec61131_interfaces_Double_BString, Double_Byte_String_Type_Name, iec61131_interfaces_Subrange_Specification1, Subrange, iec61131_interfaces_Subrange_Specification2, Subrange_Type_Name, iec61131_interfaces_Enumerated_Specification1, iec61131_interfaces_Enumerated_Specification2, iec61131_interfaces_Located_Var_Declarations, Program_Vars, Located_Var_Decl, iec61131_interfaces_Global_Var_Declarations, Library_Element_Declaration, Global_Var_Decl, iec61131_interfaces_Array_Specification2, Non_Generic_Type_Name, iec61131_interfaces_Array_Initial_Elements1, iec61131_interfaces_Array_Initial_Elements2, iec61131_interfaces_Initial_Element, iec61131_interfaces_InitElement_Constant, iec61131_interfaces_InitElement_EnumValue, iec61131_interfaces_Array_Specification1, Array_Type_Name, iec61131_interfaces_Var2_Init_Decl, iec61131_interfaces_Function_Var_Decl, iec61131_interfaces_Var_Name_Decl, Simple_Spec_Init, iec61131_interfaces_Var_Init_Decl_Func, Var1_Specification_Func, iec61131_interfaces_Simple_Spec_Init_Func, Simple_Specification_Func, iec61131_interfaces_Simple_Specification_Func, iec61131_interfaces_Var1_Specification_Func, iec61131_interfaces_InitElement_Structure, iec61131_interfaces_Temp_Var_Declaration, iec61131_interfaces_InitElement_Array, Function_Block_Body, iec61131_pous_Program_Type_Name, Blocks, iec61131_pous_Function_Block_Type_Name, types_Simple_Specification, iec61131_pous_Derived_Function_Block_Name, pous_Function_Block_Type_Name, iec61131_pous_Function_Block_Declaration, Derived_Function_Block_Name, Function_Block_Vars, iec61131_pous_Function_Declaration, Derived_Function_Name, Function_Return_Value, iec61131_pous_Program_Declaration, Program_Type_Name, iec61131_pous_Function_Block_Body, iec61131_pous_Program_Access_Decl, Access_Name, Symbolic_Variable, iec61131_pous_Access_Name, iec61131_pous_Function_Name, iec61131_pous_Data_Type_Declaration, Type_Declaration, iec61131_pous_Type_Declaration, iec61131_pous_Single_Element_Type_Declaration, iec61131_pous_Array_Type_Declaration, iec61131_pous_Structure_Type_Declaration, Structure_Specification, iec61131_pous_String_Type_Declaration, String_Type_Name, Byte_String_Type_Name, Function_Vars, Function_Body, iec61131_pous_Derived_Function_Name, pous_Function_Name, iec61131_pous_Function_Return_Value, iec61131_pous_Function_Body, iec61131_pous_Other_Language, pous_Function_Body, pous_Function_Block_Body, Subrange_Spec_Init, iec61131_pous_Enumerated_Type_Declaration, Enumerated_Spec_Init, iec61131_pous_Structure_Specification, iec61131_pous_Structure_Declaration, Structure_Element_Declaration, iec61131_pous_Structure_Element_Declaration, Structure_Elements, iec61131_pous_Structure_Elements, iec61131_pous_Program_Vars, iec61131_pous_Function_Vars, iec61131_pous_Function_Block_Vars, iec61131_pous_Program_Access_Decls, Program_Access_Decl, iec61131_pous_Library, Program_Declaration, Function_Declaration, Function_Block_Declaration, iec61131_configurations_Configuration_Name, iec61131_pous_Simple_Type_Declaration, Single_Element_Type_Declaration, Simple_Type_Name, iec61131_pous_Subrange_Type_Declaration, iec61131_configurations_Resource_Name, iec61131_configurations_Resource_Declaration, Resource_Name, Resource_Type_Name, iec61131_configurations_Single_Resource_Declaration, Task_Configuration, Program_Configuration, iec61131_configurations_Task_Configuration, Task_Name, Priority, Single, iec61131_configurations_Program_Configuration, Program_Name, Prog_Conf_Elements, iec61131_configurations_Resource_Type_Name, iec61131_configurations_Configuration_Declaration, Configuration_Name, Single_Resource_Declaration, Global_Var_Declarations, Instance_Specific_Initializations, Access_Declarations, Resource_Declaration, iec61131_configurations_Access_Declarations, Access_Declaration, iec61131_configurations_Access_Declaration, Access_Path, iec61131_configurations_Access_Name, iec61131_configurations_Access_Path, iec61131_configurations_Direct_Path, iec61131_configurations_Symbolic_Path, iec61131_configurations_Program_Name, iec61131_configurations_Task_Name, iec61131_configurations_Task_Initialization, iec61131_configurations_Instance_Specific_Initializations, Instance_Specific_Init, iec61131_configurations_Data_Source, iec61131_configurations_Global_Var_Reference, configurations_Data_Sink, iec61131_configurations_Program_Output_Reference, Data_Source, iec61131_configurations_Prog_Sink, Prog_Cnxn, Data_Sink, iec61131_configurations_Prog_Source, Prog_Data_Source, iec61131_configurations_Data_Sink, iec61131_configurations_Instance_Specific_Init, iec61131_configurations_Instance_Spec1, iec61131_configurations_Instance_Spec2, iec61131_configurations_Single, Task_Initialization, iec61131_configurations_Prog_Conf_Elements, Prog_Conf_Element, iec61131_configurations_Prog_Conf_Element, iec61131_configurations_Fb_Task, iec61131_configurations_Prog_Cnxn, iec61131_configurations_Prog_Data_Source, iec61131_st_Expression, Expression_Types, Or_Operator, iec61131_st_Statement, iec61131_st_Assignment_Statement, Expression_Variable, iec61131_st_Subprogram_Control_Statement, iec61131_st_Selection_Statement, iec61131_st_Iteration_Statement, iec61131_st_Return_Statement, Subprogram_Control_Statement, iec61131_st_Fb_Invocation, Param_Assignment, iec61131_st_Param_Assignment, iec61131_st_Param_Type1, iec61131_configurations_Interval, iec61131_configurations_Priority, iec61131_st_Statement_List, Statement, Else_If_Statement, Else_Statement, iec61131_st_Case_Statement, Case_Element, iec61131_st_Else_If_Statement, iec61131_st_Else_Statement, iec61131_st_Case_Element, Case_List, iec61131_st_Case_List, iec61131_st_Case_List_Element, iec61131_st_For_Statement, Iteration_Statement, Control_Variable, For_List, iec61131_st_Param_Type2, Variable, Not_Operator, iec61131_st_If_Statement, Selection_Statement, Statement_List, iec61131_st_Exit_Statement, iec61131_st_Control_Variable, iec61131_st_For_List, iec61131_st_Xor_Expression, Xor_Operator, iec61131_st_And_Expression, iec61131_st_Comparison, iec61131_st_While_Statement, iec61131_st_Repeat_Statement, iec61131_st_Add_Expression, Add_Operator, iec61131_st_Term_Expression, iec61131_st_Equ_Expression, iec61131_st_Primary_Expression, iec61131_st_Bracket_Expression, Primary_Expression, iec61131_st_Call_Expression, Function_Name, iec61131_st_Expression_Types, iec61131_st_Expression_Variable, Array_Variable, Structured_Variable, iec61131_st_Expression_Constant, iec61131_st_Expression_EnumValue, iec61131_st_Power_Expression, Power_Symbol, iec61131_st_Unary_Expression, Unary_Operator, iec61131_il_Simple_Instr_List, Il_Simple_Instruction, iec61131_il_Il_Instruction, Label, Il_Operations, iec61131_il_Label, iec61131_il_Il_Simple_Operation, il_Il_Operations, il_Simple_Instr, iec61131_il_Il_Expression, Il_Operand, Simple_Instr_List, iec61131_il_Il_Jump_Operation, Il_Jump_Operator, iec61131_il_Il_Fb_Call, Il_Call_Operator, Operands, iec61131_st_Expression_Variable_Type, iec61131_il_Instruction_List, Il_Instruction, iec61131_il_Simple_Operation1, Il_Simple_Operation, Il_Simple_Operator, iec61131_il_Simple_Operation2, Il_Operand_List, iec61131_il_Il_Expr_Operator, iec61131_il_Il_Jump_Operator, iec61131_il_Il_Call_Operator, iec61131_il_Il_Param_List, Il_Param_Instruction, Il_Param_Last_Instruction, iec61131_il_Operand1, iec61131_il_Operand2, iec61131_il_Operands, iec61131_il_Il_Simple_Instruction, Simple_Instr, iec61131_il_Simple_Instr, iec61131_il_Il_Param_Instruction, Param_Instruction, iec61131_il_Il_Param_Last_Instruction, iec61131_il_Il_Param_Assignment, Param_Assignments, Il_Assign_Operator, iec61131_il_Il_Formal_Funct_Call, Il_Param_List, iec61131_il_Il_Return_Operator, iec61131_il_Il_Operations, iec61131_il_Il_Simple_Operator, iec61131_il_Il_Operand, iec61131_il_Il_Operand_List, Il_Assign_Out_Operator, iec61131_il_Param_Assignments, iec61131_il_Param_Instruction, iec61131_il_Il_Assign_Operator, Assignment_Name, iec61131_il_Param_Assignment2, iec61131_il_Param_Assignment, iec61131_il_Il_Assign_Out_Operator, iec61131_sfc_Sequential_Function_Chart, Sfc_Network, iec61131_sfc_Sfc_Network, iec61131_il_Il_Param_Out_Assignment, Transition_Condition, iec61131_sfc_Action, Action_Name, iec61131_sfc_Sfc_Elements, iec61131_sfc_Step_Name, iec61131_sfc_Action_Association, Action_Qualifier, iec61131_sfc_Step_Types, Action_Association, Step_Name, iec61131_sfc_Action_Name, iec61131_sfc_Action_Qualifier, Timed_Qualifier, Action_Time, iec61131_sfc_Timed_Qualifier, Initial_Step, Sfc_Elements, iec61131_sfc_Initial_Step, Step_Types, iec61131_sfc_Step, sfc_Sfc_Elements, sfc_Step_Types, iec61131_sfc_Transition, Transition_Name, Steps, Cond2_Condition, iec61131_sfc_Transition_Cond1, iec61131_sfc_Transition_Cond3, iec61131_sfc_Cond2_Condition, iec61131_sfc_ActionTime2, iec61131_variables_Symbolic_Variable, iec61131_variables_Multi_Element_Variable, iec61131_variables_Array_Variable, Multi_Element_Variable, Subscript_List, iec61131_variables_Structured_Variable, iec61131_variables_Direct_Variable, variables_Variable, iec61131_sfc_Action_Time, iec61131_sfc_Transition_Name, iec61131_sfc_Steps, iec61131_sfc_Transition_Condition, iec61131_sfc_Steps1, iec61131_sfc_Steps2, iec61131_sfc_Transition_Cond2, Fbd_Network, iec61131_fbd_Fbd_Network, iec61131_types_TypeLib, Data_Type_Name, iec61131_types_Numeric_Type_Name, Elementary_Type_Name, iec61131_types_Integer_Type_Name, Numeric_Type_Name, iec61131_types_Real_Type_Name, iec61131_types_Signed_Integer_Type_Name, iec61131_types_Unsigned_Integer_Type_Name, iec61131_types_Elementary_Type_Name, types_Non_Generic_Type_Name, interfaces_Simple_Specification_Func, iec61131_types_Date_Type_Name, iec61131_types_Bit_String_Type_Name, iec61131_types_Non_Generic_Type_Name, types_Data_Type_Name, pous_Function_Return_Value, iec61131_types_Derived_Type_Name, iec61131_types_Generic_Type_Name, iec61131_types_Data_Type_Name, iec61131_types_Bool_Type_Name, iec61131_types_DT_Type_Name, iec61131_types_TOD_Type_Name, iec61131_variables_Variable, iec61131_variables_Variable_Name, variables_Symbolic_Variable, Output_Reference, Input_Reference, iec61131_variables_Subscript_List, iec61131_ld_Ladder_Diagram, iec61131_types_Simple_Specification, iec61131_ld_Rung, iec61131_fbd_Function_Block_Diagram, iec61131_types_Duration_Type_Name, iec61131_types_Single_Element_Type_Name, Derived_Type_Name, iec61131_types_Array_Type_Name, iec61131_types_Structure_Type_Name, types_Derived_Type_Name, iec61131_types_String_Type_Name, iec61131_types_Simple_Type_Name, types_Single_Element_Type_Name, iec61131_types_Subrange_Type_Name, Single_Element_Type_Name, iec61131_types_Enumerated_Type_Name, iec61131_types_Single_Byte_String_Type_Name, iec61131_types_Double_Byte_String_Type_Name, iec61131_types_Byte_String_Type_Name, Edge, Direction},
    associations={library_element_declaration0, library_element_name1, integer_type_name7, real_type_name9, fixed_point10, interval12, duration_type_name13, substraction15, daytime17, tod_type_name18, integer3, bit_string_type4, integer6, daytime27, fixed_point30, integer31, hours32, minutes34, integer35, seconds38, integer39, milliseconds42, integer43, single_byte_character_representation46, date_type_name20, date_literal21, dt_type_name23, date_literal24, common_character_representation50, common_character_representation51, double_byte_character_representation47, second48, var_list56, bool_type_name58, assignment60, simple_specification61, subrange_specification62, signed_integer63, enumerated_specification65, enumerated_value66, array_spec_init68, initialized_structure69, input_declaration53, var_list54, specification55, var_declaration77, assignment78, array_initialization80, array_specification82, assignment84, structure_initialization86, structure_type_name89, structure_element_initialization91, structure_element_name92, assignment93, structure_element_init96, enumerated_type_name98, structure_initialization70, function_block_type_name71, assignment73, var_init_decl76, integer105, single_byte_string_spec106, double_byte_string_spec107, single_byte_character_string108, assignment109, single_string112, double_byte_character_string114, assignment115, double_string118, array_initial_elements99, specification100, array_specification101, structure_type_name103, specification123, global_var_name125, temp_var_decl127, incompl_located_var_decl128, var_init_decl129, variable_name131, incompl_location133, var_spec135, direct_variable137, location138, variable_name120, external_declaration121, global_var_name122, global_var_spec146, located_var_spec_init147, location150, global_var_name152, integer155, single_byte_string_type_name157, double_byte_string_type_name158, integer_type_name159, subrange161, subrange_type_name163, enumerated_value164, variable_name139, located_var_spec_init142, located_var_decl144, global_var_decl145, array_type_name168, non_generic_type_name169, subrange170, array_initial_element173, integer175, array_initial_element177, constant180, enum_value181, enumerated_type_name166, array191, array_left193, array_right196, var2_init_decl199, constant200, structure_initialization202, specification205, simple_specification206, constant207, var_list210, structure183, structure_left185, structure_right188, function_block_body215, derived_function_block_name217, function_block_body218, function_block_var_declarations221, derived_function_name223, program_type_name212, program_var_declarations213, access_name230, non_generic_type_name231, symbolic_variable234, type_declaration236, array_type_name237, array_spec_init239, structure_type_name242, structure_specification244, string_type_name246, byte_string_type_name247, assignment249, function_return_value224, function_var_declarations226, function_body228, subrange_spec_init262, enumerated_type_name264, enumerated_spec_init266, structure_element_declaration268, structure_element_name269, structure_element271, program_access_decl273, programs274, functions275, function_blocks277, character_string252, integer254, simple_type_name257, simple_spec_init258, subrange_type_name260, resource_declaration288, resource_name290, resource_type_name291, single_resource_declaration293, global_var_declarations296, task_configuration299, program_configuration300, task_name302, task_initialization_priority303, task_initialization_single305, task_initialization_interval307, program_name310, task_name311, program_type_name314, configuration_name279, single_resource_declaration280, global_var_declarations282, instance_specific_initializations284, access_declarations286, symbolic_variable328, program_name330, access_declaration333, access_name334, access_path336, non_generic_type_name338, resource_name341, direct_variable343, program_name345, fb_name347, symbolic_variable350, prog_conf_elements317, instance_specific_init319, structure_element_name320, global_var_name322, resource_name325, data_sink363, prog_data_source364, assignment365, resource_name368, program_name370, fb_name373, location376, variable_name378, located_var_spec_init381, function_block_type_name384, structure_initialization386, fb_name_spec389, assignment392, assignment353, prog_conf_element355, task_name356, fb_name358, symbolic_variable361, expression_left401, or_402, expression_right404, assignment407, expression409, variable412, fb_name414, param_assignment416, expression418, assignment420, data_source395, data_source396, integer398, statement400, statement_list434, else_if436, else_438, else_440, expression442, case_element445, expression447, statement_list449, statement_list452, case_list454, statement_list455, case_list_element458, control_variable459, for_list460, variable_name423, variable_name426, variable428, not_430, expression432, expression473, statement_list475, expression478, to_expression480, by_expression483, xor_expression_left486, xor488, xor_expression_right490, and_expression_left493, and_495, and_expression_right497, statement_list462, assignment465, expression468, statement_list470, equ_expression_left507, equ_expression_right509, comparison_operator512, add_expression_left514, add_expression_right516, add_operator519, term_expression_left521, term_expression_right523, multiply_operator526, comparison_expression_left500, comparison_expression_right502, equ_operator505, unary_operator535, unary_expression536, expression539, param_assignment541, function_name543, variable545, direct_variable547, array_variable550, structured_variable552, constant554, power528, power_expression_left529, power_expression_right532, il_simple_instruction561, label562, il_operation563, il_expr_operator565, il_operand566, simple_instr_list568, label570, il_jump_operator572, il_call_operator574, fb_name575, operands578, enum_value556, expression_variable558, il_instruction560, il_simple_operator586, il_operand587, function_name590, il_operand_list592, il_param_instruction594, il_param_last_instruction595, il_param_list597, il_operand_list599, simple_inst601, function_name580, il_param_list582, il_operand584, il_assign_out_operator608, param_assignment610, variable_name611, assignment613, simple_instr_list615, not_617, variable_name619, sfc_network622, il_assign_operator602, param_assignment603, variable606, transition_condition632, integer634, action_name637, function_block_body638, action_name641, action_qualifier643, indicator_name645, action_association648, step_name649, timed_qualifier651, action_time652, initial_step623, sfc_elements624, transition_name626, assignment627, steps630, condition658, simple_instr_list659, expression661, assignment663, time_variable666, subscripted_variable668, subscript_list670, record_variable672, field_selector674, step_name654, step_name656, fbd_network679, types680, subscript677},
    generalizations={gen_iec61131_Library_Element_Declaration_Commentable, gen_iec61131_Library_Element_Name_NamedElement, gen_iec61131_literals_Real_Literal_Numeric_Literal, gen_iec61131_literals_Boolean_Literal_Constant, gen_iec61131_literals_Constant_configurations_Data_Source, gen_iec61131_literals_Constant_configurations_Prog_Data_Source, gen_iec61131_literals_Constant_il_Il_Operand, gen_iec61131_literals_Signed_Integer_literals_Integer, gen_iec61131_literals_Signed_Integer_st_Case_List_Element, gen_iec61131_literals_Signed_Integer_interfaces_Range, gen_iec61131_literals_Binary_Integer_literals_Integer, gen_iec61131_literals_Binary_Integer_literals_BSInteger, gen_iec61131_literals_Octal_Integer_literals_Integer, gen_iec61131_literals_Octal_Integer_literals_BSInteger, gen_iec61131_literals_Hex_Integer_literals_Integer, gen_iec61131_literals_Hex_Integer_literals_BSInteger, gen_iec61131_literals_Duration_literals_Time_Literal, gen_iec61131_literals_Duration_sfc_Action_Time, gen_iec61131_literals_Time_Of_Day_Time_Literal, gen_iec61131_literals_Numeric_Literal_Constant, gen_iec61131_literals_Character_String_Constant, gen_iec61131_literals_Time_Literal_Constant, gen_iec61131_literals_Bit_String_Literal_Constant, gen_iec61131_literals_Integer_Literal_Numeric_Literal, gen_iec61131_literals_Unsigned_Integer_st_Case_List_Element, gen_iec61131_literals_Unsigned_Integer_interfaces_Range, gen_iec61131_literals_Unsigned_Integer_literals_Integer, gen_iec61131_literals_Unsigned_Integer_literals_BSInteger, gen_iec61131_literals_Unsigned_Integer_literals_Fixed_Point_Literal, gen_iec61131_literals_Days_Interval, gen_iec61131_literals_Hours_Interval, gen_iec61131_literals_Minutes_Interval, gen_iec61131_literals_Seconds_Interval, gen_iec61131_literals_Milliseconds_Interval, gen_iec61131_literals_Single_Byte_Character_String_Character_String, gen_iec61131_literals_Date_Time_Literal, gen_iec61131_literals_Date_And_Time_Time_Literal, gen_iec61131_literals_Fixed_Point_Fixed_Point_Literal, gen_iec61131_operators_Add_Operator_Operator, gen_iec61131_operators_Unary_Operator_Operator, gen_iec61131_operators_Assignment_Operator_Operator, gen_iec61131_operators_Comparison_Operator_Operator, gen_iec61131_operators_Multiply_Operator_Dot_Operator, gen_iec61131_operators_Equal_Operator_EquUequ_Operator, gen_iec61131_operators_And_Operator_operators_Operator, gen_iec61131_operators_And_Operator_il_Il_Expr_Operator, gen_iec61131_operators_Or_Operator_operators_Operator, gen_iec61131_operators_Or_Operator_il_Il_Expr_Operator, gen_iec61131_operators_Xor_Operator_operators_Operator, gen_iec61131_operators_Xor_Operator_il_Il_Expr_Operator, gen_iec61131_operators_Not_Operator_operators_Unary_Operator, gen_iec61131_operators_Not_Operator_il_Il_Simple_Operator, gen_iec61131_operators_Power_Operator_Operator, gen_iec61131_operators_Modulo_Operator_il_Il_Expr_Operator, gen_iec61131_operators_Modulo_Operator_operators_Dot_Operator, gen_iec61131_operators_Divide_Operator_Dot_Operator, gen_iec61131_literals_Double_Byte_Character_String_Character_String, gen_iec61131_operators_Divide_Symbol_Divide_Operator, gen_iec61131_operators_Power_Symbol_Power_Operator, gen_iec61131_operators_Power_Name_Power_Operator, gen_iec61131_operators_Assignment_Symbol_Assignment_Operator, gen_iec61131_operators_Assignment_Name_Assignment_Operator, gen_iec61131_operators_And_Symbol_And_Operator, gen_iec61131_operators_And_Name_And_Operator, gen_iec61131_operators_Equal_Name_operators_Equal_Operator, gen_iec61131_operators_Equal_Name_operators_Comparison_Name, gen_iec61131_operators_Equal_Symbol_Equal_Operator, gen_iec61131_operators_Unequal_Name_operators_Unequal_Operator, gen_iec61131_operators_Unequal_Name_operators_Comparison_Name, gen_iec61131_operators_Unequal_Symbol_Unequal_Operator, gen_iec61131_operators_Less_Name_operators_Less_Operator, gen_iec61131_operators_Less_Name_operators_Comparison_Name, gen_iec61131_operators_Less_Symbol_Less_Operator, gen_iec61131_operators_LessEqual_Name_operators_LessEqual_Operator, gen_iec61131_operators_LessEqual_Name_operators_Comparison_Name, gen_iec61131_operators_LessEqual_Symbol_LessEqual_Operator, gen_iec61131_operators_Greater_Name_operators_Greater_Operator, gen_iec61131_operators_Greater_Name_operators_Comparison_Name, gen_iec61131_operators_Greater_Symbol_Greater_Operator, gen_iec61131_operators_GreaterEqual_Name_operators_GreaterEqual_Operator, gen_iec61131_operators_GreaterEqual_Name_operators_Comparison_Name, gen_iec61131_operators_GreaterEqual_Symbol_GreaterEqual_Operator, gen_iec61131_operators_Substraction_Name_operators_Substraction_Operator, gen_iec61131_operators_Substraction_Name_operators_Arithmetic_Name, gen_iec61131_operators_Substraction_Symbol_operators_Substraction_Operator, gen_iec61131_operators_Substraction_Symbol_operators_Unary_Operator, gen_iec61131_operators_Substraction_Symbol_operators_Add_Operator, gen_iec61131_operators_EquUequ_Operator_Operator, gen_iec61131_operators_Comparison_Name_Il_Expr_Operator, gen_iec61131_operators_Arithmetic_Name_Il_Expr_Operator, gen_iec61131_operators_Less_Operator_Comparison_Operator, gen_iec61131_operators_Greater_Operator_Comparison_Operator, gen_iec61131_operators_GreaterEqual_Operator_Comparison_Operator, gen_iec61131_operators_LessEqual_Operator_Comparison_Operator, gen_iec61131_operators_Unequal_Operator_EquUequ_Operator, gen_iec61131_operators_Addition_Name_operators_Addition_Operator, gen_iec61131_operators_Addition_Name_operators_Arithmetic_Name, gen_iec61131_operators_Addition_Symbol_operators_Addition_Operator, gen_iec61131_operators_Addition_Symbol_operators_Add_Operator, gen_iec61131_operators_Dot_Operator_Operator, gen_iec61131_operators_Multiply_Name_operators_Multiply_Operator, gen_iec61131_operators_Multiply_Name_operators_Arithmetic_Name, gen_iec61131_operators_Multiply_Symbol_Multiply_Operator, gen_iec61131_operators_Divide_Name_operators_Divide_Operator, gen_iec61131_operators_Divide_Name_operators_Arithmetic_Name, gen_iec61131_interfaces_Edge_Declaration_Input_Declaration, gen_iec61131_interfaces_Simple_Spec_Init_interfaces_Var1_Specification, gen_iec61131_interfaces_Simple_Spec_Init_interfaces_Located_Var_Spec_Init, gen_iec61131_interfaces_Simple_Spec_Init_pous_Structure_Elements, gen_iec61131_interfaces_Subrange_Spec_Init_interfaces_Var1_Specification, gen_iec61131_interfaces_Subrange_Spec_Init_interfaces_Located_Var_Spec_Init, gen_iec61131_interfaces_Subrange_Spec_Init_pous_Structure_Elements, gen_iec61131_interfaces_Subrange_Spec_Init_interfaces_Var1_Specification_Func, gen_iec61131_interfaces_Enumerated_Spec_Init_interfaces_Var1_Specification, gen_iec61131_interfaces_Enumerated_Spec_Init_interfaces_Located_Var_Spec_Init, gen_iec61131_interfaces_Enumerated_Spec_Init_pous_Structure_Elements, gen_iec61131_interfaces_Enumerated_Spec_Init_interfaces_Var1_Specification_Func, gen_iec61131_interfaces_Array_Var_Init_Decl_Var2_Init_Decl, gen_iec61131_interfaces_Structured_Var_Init_Decl_Var2_Init_Decl, gen_iec61131_interfaces_Io_Var_Declaration_interfaces_Interface, gen_iec61131_interfaces_Io_Var_Declaration_pous_Function_Block_Vars, gen_iec61131_interfaces_Io_Var_Declaration_pous_Program_Vars, gen_iec61131_interfaces_Io_Var_Declaration_pous_Function_Vars, gen_iec61131_interfaces_Input_Declarations_Io_Var_Declaration, gen_iec61131_interfaces_Var_Init_Decl_Input_Declaration, gen_iec61131_interfaces_Var1_Init_Decl_Var_Init_Decl, gen_iec61131_interfaces_Input_Output_Declarations_Io_Var_Declaration, gen_iec61131_interfaces_Array_Spec_Init_interfaces_Located_Var_Spec_Init, gen_iec61131_interfaces_Array_Spec_Init_pous_Structure_Elements, gen_iec61131_interfaces_Initialized_Structure_interfaces_Located_Var_Spec_Init, gen_iec61131_interfaces_Initialized_Structure_pous_Structure_Specification, gen_iec61131_interfaces_Initialized_Structure_pous_Structure_Elements, gen_iec61131_interfaces_Temp_Var_Decl_Var_Declaration, gen_iec61131_interfaces_Enumerated_Value_st_Case_List_Element, gen_iec61131_interfaces_Enumerated_Value_configurations_Prog_Data_Source, gen_iec61131_interfaces_Enumerated_Value_il_Il_Operand, gen_iec61131_interfaces_Fb_Name_Decl_Temp_Var_Declaration, gen_iec61131_interfaces_String_Var_Declaration_interfaces_Temp_Var_Decl, gen_iec61131_interfaces_String_Var_Declaration_interfaces_Var2_Init_Decl, gen_iec61131_interfaces_Output_Declarations_Io_Var_Declaration, gen_iec61131_interfaces_Subrange_Specification_interfaces_Specification, gen_iec61131_interfaces_Subrange_Specification_interfaces_External_Specification, gen_iec61131_interfaces_Subrange_Specification_interfaces_Var_Spec, gen_iec61131_interfaces_Enumerated_Specification_interfaces_Specification, gen_iec61131_interfaces_Enumerated_Specification_interfaces_External_Specification, gen_iec61131_interfaces_Enumerated_Specification_interfaces_Var_Spec, gen_iec61131_interfaces_Array_Specification_interfaces_External_Specification, gen_iec61131_interfaces_Array_Specification_interfaces_Var_Spec, gen_iec61131_interfaces_Subrange_Case_List_Element, gen_iec61131_interfaces_Single_Byte_String_Var_Declaration_String_Var_Declaration, gen_iec61131_interfaces_Double_Byte_String_Var_Declaration_String_Var_Declaration, gen_iec61131_interfaces_Single_Byte_String_Spec_Located_Var_Spec_Init, gen_iec61131_interfaces_Double_Byte_String_Spec_Located_Var_Spec_Init, gen_iec61131_interfaces_Var1_Declaration_Temp_Var_Declaration, gen_iec61131_interfaces_Array_Var_Declaration_Temp_Var_Declaration, gen_iec61131_interfaces_Structured_Var_Declaration_Temp_Var_Declaration, gen_iec61131_interfaces_Global_Var_Name_Library_Element_Name, gen_iec61131_interfaces_Global_Var_Name_Commentable, gen_iec61131_interfaces_Global_Var_List_Global_Var_Spec, gen_iec61131_interfaces_Temp_Var_Decls_Other_Var_Declaration, gen_iec61131_interfaces_Var_Declarations_RNV_Declarations, gen_iec61131_interfaces_Incompl_Located_Var_Declarations_Other_Var_Declaration, gen_iec61131_interfaces_RNV_Declarations_Other_Var_Declaration, gen_iec61131_interfaces_Other_Var_Declaration_interfaces_Interface, gen_iec61131_interfaces_Other_Var_Declaration_pous_Function_Block_Vars, gen_iec61131_interfaces_Other_Var_Declaration_pous_Program_Vars, gen_iec61131_interfaces_External_Var_Declarations_Other_Var_Declaration, gen_iec61131_interfaces_Retentive_Var_Declarations_RNV_Declarations, gen_iec61131_interfaces_Interface_Commentable, gen_iec61131_interfaces_Non_Retentive_Var_Declarations_RNV_Declarations, gen_iec61131_interfaces_Global_Var_Decl_Commentable, gen_iec61131_interfaces_Global_Var_Location_Global_Var_Spec, gen_iec61131_interfaces_Byte_String_Var_Spec, gen_iec61131_interfaces_Single_BString_Byte_String, gen_iec61131_interfaces_Double_BString_Byte_String, gen_iec61131_interfaces_Subrange_Specification1_Subrange_Specification, gen_iec61131_interfaces_Subrange_Specification2_Subrange_Specification, gen_iec61131_interfaces_Enumerated_Specification1_Enumerated_Specification, gen_iec61131_interfaces_Enumerated_Specification2_Enumerated_Specification, gen_iec61131_interfaces_Located_Var_Declarations_Program_Vars, gen_iec61131_interfaces_Global_Var_Declarations_Library_Element_Declaration, gen_iec61131_interfaces_Array_Specification2_Array_Specification, gen_iec61131_interfaces_Array_Initial_Elements1_Array_Initial_Elements, gen_iec61131_interfaces_Array_Initial_Elements2_Array_Initial_Elements, gen_iec61131_interfaces_InitElement_Constant_Initial_Element, gen_iec61131_interfaces_InitElement_EnumValue_Initial_Element, gen_iec61131_interfaces_Array_Specification1_Array_Specification, gen_iec61131_interfaces_Var2_Init_Decl_Var_Init_Decl, gen_iec61131_interfaces_Function_Var_Decl_pous_Function_Vars, gen_iec61131_interfaces_Function_Var_Decl_interfaces_Interface, gen_iec61131_interfaces_Var_Name_Decl_Simple_Spec_Init, gen_iec61131_interfaces_Var_Init_Decl_Func_Var2_Init_Decl, gen_iec61131_interfaces_Simple_Spec_Init_Func_Var1_Specification_Func, gen_iec61131_interfaces_Var1_Specification_Func_Var1_Specification, gen_iec61131_interfaces_InitElement_Structure_Initial_Element, gen_iec61131_interfaces_Temp_Var_Declaration_Temp_Var_Decl, gen_iec61131_interfaces_InitElement_Array_Initial_Element, gen_iec61131_pous_Program_Type_Name_Library_Element_Name, gen_iec61131_pous_Program_Type_Name_Blocks, gen_iec61131_pous_Function_Block_Type_Name_Library_Element_Name, gen_iec61131_pous_Function_Block_Type_Name_interfaces_External_Specification, gen_iec61131_pous_Function_Block_Type_Name_Commentable, gen_iec61131_pous_Function_Block_Type_Name_types_Simple_Specification, gen_iec61131_pous_Derived_Function_Block_Name_pous_Function_Block_Type_Name, gen_iec61131_pous_Derived_Function_Block_Name_Blocks, gen_iec61131_pous_Function_Block_Declaration_Library_Element_Declaration, gen_iec61131_pous_Function_Declaration_Library_Element_Declaration, gen_iec61131_pous_Program_Declaration_Library_Element_Declaration, gen_iec61131_pous_Function_Name_Library_Element_Name, gen_iec61131_pous_Data_Type_Declaration_Library_Element_Declaration, gen_iec61131_pous_Single_Element_Type_Declaration_Type_Declaration, gen_iec61131_pous_Array_Type_Declaration_Type_Declaration, gen_iec61131_pous_Structure_Type_Declaration_Type_Declaration, gen_iec61131_pous_String_Type_Declaration_Type_Declaration, gen_iec61131_pous_Derived_Function_Name_pous_Function_Name, gen_iec61131_pous_Derived_Function_Name_Blocks, gen_iec61131_pous_Other_Language_pous_Function_Body, gen_iec61131_pous_Other_Language_pous_Function_Block_Body, gen_iec61131_pous_Enumerated_Type_Declaration_Single_Element_Type_Declaration, gen_iec61131_pous_Structure_Declaration_Structure_Specification, gen_iec61131_pous_Program_Access_Decls_Program_Vars, gen_iec61131_configurations_Configuration_Name_Library_Element_Name, gen_iec61131_pous_Simple_Type_Declaration_Single_Element_Type_Declaration, gen_iec61131_pous_Subrange_Type_Declaration_Single_Element_Type_Declaration, gen_iec61131_configurations_Resource_Declaration_Library_Element_Declaration, gen_iec61131_configurations_Program_Configuration_Commentable, gen_iec61131_configurations_Resource_Type_Name_Library_Element_Name, gen_iec61131_configurations_Configuration_Declaration_Library_Element_Declaration, gen_iec61131_configurations_Direct_Path_Access_Path, gen_iec61131_configurations_Symbolic_Path_Access_Path, gen_iec61131_configurations_Global_Var_Reference_configurations_Data_Source, gen_iec61131_configurations_Global_Var_Reference_configurations_Data_Sink, gen_iec61131_configurations_Global_Var_Reference_configurations_Prog_Data_Source, gen_iec61131_configurations_Program_Output_Reference_Data_Source, gen_iec61131_configurations_Prog_Sink_Prog_Cnxn, gen_iec61131_configurations_Prog_Source_Prog_Cnxn, gen_iec61131_configurations_Instance_Spec1_Instance_Specific_Init, gen_iec61131_configurations_Instance_Spec2_Instance_Specific_Init, gen_iec61131_configurations_Fb_Task_Prog_Conf_Element, gen_iec61131_configurations_Prog_Cnxn_Prog_Conf_Element, gen_iec61131_st_Expression_Expression_Types, gen_iec61131_st_Statement_Commentable, gen_iec61131_st_Assignment_Statement_Statement, gen_iec61131_st_Subprogram_Control_Statement_Statement, gen_iec61131_st_Selection_Statement_Statement, gen_iec61131_st_Iteration_Statement_Statement, gen_iec61131_st_Return_Statement_Subprogram_Control_Statement, gen_iec61131_st_Fb_Invocation_Subprogram_Control_Statement, gen_iec61131_st_Param_Assignment_Commentable, gen_iec61131_st_Param_Type1_Param_Assignment, gen_iec61131_configurations_Single_Task_Initialization, gen_iec61131_configurations_Interval_Task_Initialization, gen_iec61131_configurations_Priority_Task_Initialization, gen_iec61131_st_Statement_List_pous_Function_Body, gen_iec61131_st_Statement_List_pous_Function_Block_Body, gen_iec61131_st_Case_Statement_Selection_Statement, gen_iec61131_st_For_Statement_Iteration_Statement, gen_iec61131_st_Param_Type2_Param_Assignment, gen_iec61131_st_If_Statement_Selection_Statement, gen_iec61131_st_Exit_Statement_Iteration_Statement, gen_iec61131_st_Xor_Expression_Expression_Types, gen_iec61131_st_And_Expression_Expression_Types, gen_iec61131_st_Comparison_Expression_Types, gen_iec61131_st_While_Statement_Iteration_Statement, gen_iec61131_st_Repeat_Statement_Iteration_Statement, gen_iec61131_st_Add_Expression_Expression_Types, gen_iec61131_st_Term_Expression_Expression_Types, gen_iec61131_st_Equ_Expression_Expression_Types, gen_iec61131_st_Primary_Expression_Expression_Types, gen_iec61131_st_Bracket_Expression_Primary_Expression, gen_iec61131_st_Call_Expression_Primary_Expression, gen_iec61131_st_Expression_Types_Commentable, gen_iec61131_st_Expression_Variable_Commentable, gen_iec61131_st_Expression_Constant_Primary_Expression, gen_iec61131_st_Expression_EnumValue_Primary_Expression, gen_iec61131_st_Power_Expression_Expression_Types, gen_iec61131_st_Unary_Expression_Expression_Types, gen_iec61131_il_Il_Simple_Operation_il_Il_Operations, gen_iec61131_il_Il_Simple_Operation_il_Simple_Instr, gen_iec61131_il_Il_Expression_il_Il_Operations, gen_iec61131_il_Il_Expression_il_Simple_Instr, gen_iec61131_il_Il_Jump_Operation_Il_Operations, gen_iec61131_il_Il_Fb_Call_Il_Operations, gen_iec61131_st_Expression_Variable_Type_Primary_Expression, gen_iec61131_il_Instruction_List_pous_Function_Body, gen_iec61131_il_Instruction_List_pous_Function_Block_Body, gen_iec61131_il_Simple_Operation1_Il_Simple_Operation, gen_iec61131_il_Simple_Operation2_Il_Simple_Operation, gen_iec61131_il_Il_Expr_Operator_Il_Simple_Operator, gen_iec61131_il_Operand1_Operands, gen_iec61131_il_Operand2_Operands, gen_iec61131_il_Il_Param_Instruction_Param_Instruction, gen_iec61131_il_Il_Param_Last_Instruction_Param_Instruction, gen_iec61131_il_Il_Param_Assignment_Param_Assignments, gen_iec61131_il_Il_Formal_Funct_Call_il_Il_Operations, gen_iec61131_il_Il_Formal_Funct_Call_il_Simple_Instr, gen_iec61131_il_Il_Return_Operator_Il_Operations, gen_iec61131_il_Il_Operand_Param_Assignment, gen_iec61131_il_Param_Assignment2_Param_Assignment, gen_iec61131_sfc_Sequential_Function_Chart_Function_Block_Body, gen_iec61131_il_Il_Param_Out_Assignment_Param_Assignments, gen_iec61131_sfc_Action_Sfc_Elements, gen_iec61131_sfc_Step_Name_NamedElement, gen_iec61131_sfc_Initial_Step_Step_Types, gen_iec61131_sfc_Step_sfc_Sfc_Elements, gen_iec61131_sfc_Step_sfc_Step_Types, gen_iec61131_sfc_Transition_Sfc_Elements, gen_iec61131_sfc_Transition_Cond1_Transition_Condition, gen_iec61131_sfc_Transition_Cond3_Transition_Condition, gen_iec61131_sfc_ActionTime2_Action_Time, gen_iec61131_variables_Symbolic_Variable_Variable, gen_iec61131_variables_Multi_Element_Variable_Symbolic_Variable, gen_iec61131_variables_Array_Variable_Multi_Element_Variable, gen_iec61131_variables_Structured_Variable_Multi_Element_Variable, gen_iec61131_variables_Direct_Variable_variables_Variable, gen_iec61131_variables_Direct_Variable_configurations_Data_Source, gen_iec61131_variables_Direct_Variable_configurations_Data_Sink, gen_iec61131_variables_Direct_Variable_configurations_Prog_Data_Source, gen_iec61131_sfc_Steps1_Steps, gen_iec61131_sfc_Steps2_Steps, gen_iec61131_sfc_Transition_Cond2_Transition_Condition, gen_iec61131_fbd_Function_Block_Diagram_pous_Function_Body, gen_iec61131_fbd_Function_Block_Diagram_pous_Function_Block_Body, gen_iec61131_fbd_Fbd_Network_Cond2_Condition, gen_iec61131_types_Numeric_Type_Name_Elementary_Type_Name, gen_iec61131_types_Integer_Type_Name_Numeric_Type_Name, gen_iec61131_types_Real_Type_Name_Numeric_Type_Name, gen_iec61131_types_Signed_Integer_Type_Name_Integer_Type_Name, gen_iec61131_types_Unsigned_Integer_Type_Name_Integer_Type_Name, gen_iec61131_types_Elementary_Type_Name_types_Non_Generic_Type_Name, gen_iec61131_types_Elementary_Type_Name_types_Simple_Specification, gen_iec61131_types_Elementary_Type_Name_interfaces_Simple_Specification_Func, gen_iec61131_types_Date_Type_Name_Elementary_Type_Name, gen_iec61131_types_Bit_String_Type_Name_Elementary_Type_Name, gen_iec61131_types_Non_Generic_Type_Name_types_Data_Type_Name, gen_iec61131_types_Non_Generic_Type_Name_pous_Function_Return_Value, gen_iec61131_types_Derived_Type_Name_Non_Generic_Type_Name, gen_iec61131_types_Generic_Type_Name_types_Data_Type_Name, gen_iec61131_types_Generic_Type_Name_pous_Function_Return_Value, gen_iec61131_types_Generic_Type_Name_types_Simple_Specification, gen_iec61131_types_Data_Type_Name_Library_Element_Name, gen_iec61131_types_Bool_Type_Name_Bit_String_Type_Name, gen_iec61131_types_DT_Type_Name_Date_Type_Name, gen_iec61131_types_TOD_Type_Name_Date_Type_Name, gen_iec61131_variables_Variable_il_Il_Operand, gen_iec61131_variables_Variable_Commentable, gen_iec61131_variables_Variable_Name_variables_Symbolic_Variable, gen_iec61131_variables_Variable_Name_NamedElement, gen_iec61131_variables_Variable_Name_Output_Reference, gen_iec61131_variables_Variable_Name_Input_Reference, gen_iec61131_ld_Ladder_Diagram_pous_Function_Body, gen_iec61131_ld_Ladder_Diagram_pous_Function_Block_Body, gen_iec61131_types_Simple_Specification_Data_Type_Name, gen_iec61131_ld_Rung_Cond2_Condition, gen_iec61131_types_Duration_Type_Name_Elementary_Type_Name, gen_iec61131_types_Single_Element_Type_Name_Derived_Type_Name, gen_iec61131_types_Array_Type_Name_Derived_Type_Name, gen_iec61131_types_Structure_Type_Name_types_Derived_Type_Name, gen_iec61131_types_Structure_Type_Name_interfaces_External_Specification, gen_iec61131_types_Structure_Type_Name_interfaces_Var_Spec, gen_iec61131_types_String_Type_Name_Derived_Type_Name, gen_iec61131_types_Simple_Type_Name_types_Single_Element_Type_Name, gen_iec61131_types_Simple_Type_Name_types_Simple_Specification, gen_iec61131_types_Simple_Type_Name_interfaces_Simple_Specification_Func, gen_iec61131_types_Subrange_Type_Name_Single_Element_Type_Name, gen_iec61131_types_Enumerated_Type_Name_Single_Element_Type_Name, gen_iec61131_types_Single_Byte_String_Type_Name_Byte_String_Type_Name, gen_iec61131_types_Double_Byte_String_Type_Name_Byte_String_Type_Name, gen_iec61131_types_Byte_String_Type_Name_Elementary_Type_Name},
    metadata=None
)
