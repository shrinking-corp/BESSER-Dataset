...
public class Requirement  {
    ...
    public Requirement(
        String requirement_type,        String req_description,        String user_id,        String requirement_location    ) {
    ...
    public Requirement(
        String requirement_type,        String req_description,        String user_id,        String requirement_location        ArrayList<Reg_User> reg_users    ) {
        this.requirement_type = requirement_type;
        this.req_description = req_description;
        this.user_id = user_id;
        this.requirement_location = requirement_location;
