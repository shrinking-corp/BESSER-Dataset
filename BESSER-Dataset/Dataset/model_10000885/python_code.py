...
class account_Account:
    ...
    def __init__(self, accountNo: str, type: account_AccountType, balance: float, transactions2: set["transaction_Transaction"] = None, customer0: "Customer" = None):
...
class Customer:
    ...
    def __init__(self, name: str, dateOfBirth: date, address: str, phoneNumber: str, emailAddress: str, login4: "Login" = None, a1: set["account_Account"] = None):
        self.name = name
