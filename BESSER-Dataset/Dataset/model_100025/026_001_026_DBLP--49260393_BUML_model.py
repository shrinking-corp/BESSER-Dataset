...
DBLP_Record.attributes={DBLP_Record_mdate, DBLP_Record_key, DBLP_Record_ee, DBLP_Record_url}
...
DBLP_Article.attributes={DBLP_Article_fromPage, DBLP_Article_title, DBLP_Article_year, DBLP_Article_month, DBLP_Article_volume, DBLP_Article_number, DBLP_Article_toPage}
...
DBLP_Book.attributes={DBLP_Book_volume, DBLP_Book_year, DBLP_Book_series, DBLP_Book_month, DBLP_Book_isbn, DBLP_Book_title, DBLP_Book_edition}
...
DBLP_InCollection.attributes={DBLP_InCollection_toPage, DBLP_InCollection_year, DBLP_InCollection_title, DBLP_InCollection_month, DBLP_InCollection_bookTitle, DBLP_InCollection_fromPage}
...
DBLP_InProceedings.attributes={DBLP_InProceedings_toPage, DBLP_InProceedings_month, DBLP_InProceedings_fromPage, DBLP_InProceedings_year, DBLP_InProceedings_bootitle, DBLP_InProceedings_title}
...
DBLP_Www.attributes={DBLP_Www_year, DBLP_Www_month, DBLP_Www_title}
...
domain_model = DomainModel(
    name="DBLP",
    types={DBLP_Record, DBLP_Article, DBLP_Author, DBLP_Journal, Record, DBLP_Book, DBLP_Publisher, DBLP_Editor, DBLP_Organization, DBLP_InCollection, DBLP_InProceedings, DBLP_MastersThesis, DBLP_School, DBLP_Proceedings, DBLP_PhDThesis, DBLP_Www},
    associations={authors0, journal1, records2, articles3, publisher4, editors5, sponsoredBy6, publisher8, editors11, organization13, publisher16, school19, editors20, publisher22, school28, sponsoredBy25, editors30},
