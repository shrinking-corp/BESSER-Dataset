...
class DBLP_Article(Record):
    ...
    def __init__(self, volume: str, month: str, title: str, fromPage: int, toPage: int, number: int, year: int, articles: "DBLP_Journal" = None, Article: "DBLP_Journal" = None):
        self.volume = volume
        self.month = month
        self.title = title
        self.fromPage = fromPage
...
class DBLP_Record(ABC):
    ...
    def __init__(self, mdate: str, url: str, key: str, ee: str, records: set["DBLP_Author"] = None, Record: "DBLP_Author" = None):
        self.mdate = mdate
        self.url = url
        self.key = key
        self.ee = ee
