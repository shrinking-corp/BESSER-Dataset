...
db_DocumentRoot.attributes={db_DocumentRoot_mixed, db_DocumentRoot_specialFeatures, db_DocumentRoot_language}
...
db_MovieType.attributes={db_MovieType_summary, db_MovieType_actors, db_MovieType_criticsReviewGroup, db_MovieType_iD, db_MovieType_title, db_MovieType_director, db_MovieType_genre, db_MovieType_any}
...
domain_model = DomainModel(
    name="db",
    types={db_CustomerReviewType, CriticsReviewType, db_DocumentRoot, db_EStringToStringMapEntry, db_CriticsReviewType, db_MovieDBType, db_CustomerType, db_MovieType, GenreTypes},
    associations={xMLNSPrefixMap0, movieDB10, xSISchemaLocation1, checkedOutBy4, criticsReview6, customerReview8, criticsReview14, movie12, checkedOutBy17},
