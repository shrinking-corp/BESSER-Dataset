...
# Classes
sADL_SadlAnnotation = Class(name="sADL_SadlAnnotation")
sADL_SadlImport = Class(name="sADL_SadlImport")
sADL_SadlModelElement = Class(name="sADL_SadlModelElement")
sADL_EquationStatement = Class(name="sADL_EquationStatement")
...
sADL_SadlModel = Class(name="sADL_SadlModel")
sADL_EObject = Class(name="sADL_EObject")
sADL_SadlInstance = Class(name="sADL_SadlInstance")
SadlStatement = Class(name="SadlStatement")
sADL_SadlValueList = Class(name="sADL_SadlValueList")
SadlExplicitValueLiteral = Class(name="SadlExplicitValueLiteral")
Expression = Class(name="Expression")
sADL_ExternalEquationStatement = Class(name="sADL_ExternalEquationStatement")
sADL_AbstractSadlEquation = Class(name="sADL_AbstractSadlEquation")
sADL_SadlResource = Class(name="sADL_SadlResource")
sADL_SadlParameterDeclaration = Class(name="sADL_SadlParameterDeclaration")
sADL_SadlTypeReference = Class(name="sADL_SadlTypeReference")
sADL_SadlStatement = Class(name="sADL_SadlStatement")
sADL_SadlPropertyCondition = Class(name="sADL_SadlPropertyCondition")
SadlTypeReference = Class(name="SadlTypeReference")
sADL_SadlCondition = Class(name="sADL_SadlCondition")
sADL_SadlPropertyInitializer = Class(name="sADL_SadlPropertyInitializer")
sADL_SadlProperty = Class(name="sADL_SadlProperty")
sADL_SadlPropertyRestriction = Class(name="sADL_SadlPropertyRestriction")
sADL_SadlDataTypeFacet = Class(name="sADL_SadlDataTypeFacet")
sADL_PrintStatement = Class(name="sADL_PrintStatement")
sADL_ExplainStatement = Class(name="sADL_ExplainStatement")
sADL_StartWriteStatement = Class(name="sADL_StartWriteStatement")
sADL_EndWriteStatement = Class(name="sADL_EndWriteStatement")
sADL_ReadStatement = Class(name="sADL_ReadStatement")
SadlPropertyRestriction = Class(name="SadlPropertyRestriction")
sADL_SadlAllValuesCondition = Class(name="sADL_SadlAllValuesCondition")
SadlCondition = Class(name="SadlCondition")
sADL_SadlHasValueCondition = Class(name="sADL_SadlHasValueCondition")
sADL_SadlCardinalityCondition = Class(name="sADL_SadlCardinalityCondition")
sADL_SadlExplicitValue = Class(name="sADL_SadlExplicitValue")
sADL_SadlExplicitValueLiteral = Class(name="sADL_SadlExplicitValueLiteral")
SadlExplicitValue = Class(name="SadlExplicitValue")
sADL_ExpressionScope = Class(name="sADL_ExpressionScope")
sADL_NamedStructureAnnotation = Class(name="sADL_NamedStructureAnnotation")
sADL_SadlSameAs = Class(name="sADL_SadlSameAs")
sADL_SadlDifferentFrom = Class(name="sADL_SadlDifferentFrom")
sADL_SadlDisjointClasses = Class(name="sADL_SadlDisjointClasses")
...
sADL_SadlClassOrPropertyDeclaration = Class(name="sADL_SadlClassOrPropertyDeclaration")
sADL_SadlTypeAssociation = Class(name="sADL_SadlTypeAssociation")
sADL_SadlRangeRestriction = Class(name="sADL_SadlRangeRestriction")
sADL_SadlIsInverseOf = Class(name="sADL_SadlIsInverseOf")
sADL_SadlNecessaryAndSufficient = Class(name="sADL_SadlNecessaryAndSufficient")
sADL_SadlNestedInstance = Class(name="sADL_SadlNestedInstance")
SadlInstance = Class(name="SadlInstance")
sADL_SadlUnionType = Class(name="sADL_SadlUnionType")
sADL_SadlIntersectionType = Class(name="sADL_SadlIntersectionType")
sADL_SadlSimpleTypeReference = Class(name="sADL_SadlSimpleTypeReference")
sADL_SadlPrimitiveDataType = Class(name="sADL_SadlPrimitiveDataType")
sADL_ExpressionStatement = Class(name="sADL_ExpressionStatement")
ExpressionScope = Class(name="ExpressionScope")
sADL_RuleStatement = Class(name="sADL_RuleStatement")
sADL_QueryStatement = Class(name="sADL_QueryStatement")
sADL_SadlIsTransitive = Class(name="sADL_SadlIsTransitive")
sADL_SadlIsSymmetrical = Class(name="sADL_SadlIsSymmetrical")
sADL_SadlIsAnnotation = Class(name="sADL_SadlIsAnnotation")
sADL_SadlDefaultValue = Class(name="sADL_SadlDefaultValue")
sADL_SadlIsFunctional = Class(name="sADL_SadlIsFunctional")
sADL_SadlMustBeOneOf = Class(name="sADL_SadlMustBeOneOf")
sADL_SadlCanOnlyBeOneOf = Class(name="sADL_SadlCanOnlyBeOneOf")
sADL_SadlUnaryExpression = Class(name="sADL_SadlUnaryExpression")
sADL_SadlNumberLiteral = Class(name="sADL_SadlNumberLiteral")
sADL_SadlStringLiteral = Class(name="sADL_SadlStringLiteral")
sADL_SadlBooleanLiteral = Class(name="sADL_SadlBooleanLiteral")
sADL_SadlConstantLiteral = Class(name="sADL_SadlConstantLiteral")
sADL_Sublist = Class(name="sADL_Sublist")
sADL_BinaryOperation = Class(name="sADL_BinaryOperation")
sADL_ConstructExpression = Class(name="sADL_ConstructExpression")
sADL_AskExpression = Class(name="sADL_AskExpression")
sADL_TestStatement = Class(name="sADL_TestStatement")
sADL_SelectExpression = Class(name="sADL_SelectExpression")
sADL_UnaryExpression = Class(name="sADL_UnaryExpression")
sADL_Declaration = Class(name="sADL_Declaration")
sADL_PropOfSubject = Class(name="sADL_PropOfSubject")
sADL_StringLiteral = Class(name="sADL_StringLiteral")
sADL_SubjHasProp = Class(name="sADL_SubjHasProp")
sADL_ElementInList = Class(name="sADL_ElementInList")
sADL_UnitExpression = Class(name="sADL_UnitExpression")
sADL_NumberLiteral = Class(name="sADL_NumberLiteral")
sADL_BooleanLiteral = Class(name="sADL_BooleanLiteral")
sADL_Constant = Class(name="sADL_Constant")
sADL_Name = Class(name="sADL_Name")
...
sADL_SadlAnnotation.attributes={sADL_SadlAnnotation_type, sADL_SadlAnnotation_contents}
...
sADL_SadlModel.attributes={sADL_SadlModel_baseUri, sADL_SadlModel_alias, sADL_SadlModel_version}
...
sADL_SadlParameterDeclaration.attributes={sADL_SadlParameterDeclaration_unknown, sADL_SadlParameterDeclaration_ellipsis}
...
sADL_SadlDataTypeFacet.attributes={sADL_SadlDataTypeFacet_min, sADL_SadlDataTypeFacet_minlen, sADL_SadlDataTypeFacet_maxInclusive, sADL_SadlDataTypeFacet_len, sADL_SadlDataTypeFacet_regex, sADL_SadlDataTypeFacet_maxlen, sADL_SadlDataTypeFacet_max, sADL_SadlDataTypeFacet_minInclusive, sADL_SadlDataTypeFacet_values}
...
sADL_SadlPrimitiveDataType.attributes={sADL_SadlPrimitiveDataType_primitiveType, sADL_SadlPrimitiveDataType_list}
...
sADL_SelectExpression.attributes={sADL_SelectExpression_orderby, sADL_SelectExpression_distinct}
...
sADL_Declaration.attributes={sADL_Declaration_maxlen, sADL_Declaration_len, sADL_Declaration_ordinal, sADL_Declaration_article}
...
sADL_ElementInList.attributes={sADL_ElementInList_before, sADL_ElementInList_after}
...
from_54: BinaryAssociation = BinaryAssociation(
    name="from_54",
    ends={
...
domain_model = DomainModel(
    name="sADL",
    types={sADL_SadlAnnotation, sADL_SadlImport, sADL_SadlModelElement, sADL_EquationStatement, SadlModelElement, AbstractSadlEquation, sADL_Expression, sADL_SadlModel, sADL_EObject, sADL_SadlInstance, SadlStatement, sADL_SadlValueList, SadlExplicitValueLiteral, Expression, sADL_ExternalEquationStatement, sADL_AbstractSadlEquation, sADL_SadlResource, sADL_SadlParameterDeclaration, sADL_SadlTypeReference, sADL_SadlStatement, sADL_SadlPropertyCondition, SadlTypeReference, sADL_SadlCondition, sADL_SadlPropertyInitializer, sADL_SadlProperty, sADL_SadlPropertyRestriction, sADL_SadlDataTypeFacet, sADL_PrintStatement, sADL_ExplainStatement, sADL_StartWriteStatement, sADL_EndWriteStatement, sADL_ReadStatement, SadlPropertyRestriction, sADL_SadlAllValuesCondition, SadlCondition, sADL_SadlHasValueCondition, sADL_SadlCardinalityCondition, sADL_SadlExplicitValue, sADL_SadlExplicitValueLiteral, SadlExplicitValue, sADL_ExpressionScope, sADL_NamedStructureAnnotation, sADL_SadlSameAs, sADL_SadlDifferentFrom, sADL_SadlDisjointClasses, sADL_OrderElement, sADL_ValueTable, sADL_ValueRow, sADL_SadlClassOrPropertyDeclaration, sADL_SadlTypeAssociation, sADL_SadlRangeRestriction, sADL_SadlIsInverseOf, sADL_SadlNecessaryAndSufficient, sADL_SadlNestedInstance, SadlInstance, sADL_SadlUnionType, sADL_SadlIntersectionType, sADL_SadlSimpleTypeReference, sADL_SadlPrimitiveDataType, sADL_ExpressionStatement, ExpressionScope, sADL_RuleStatement, sADL_QueryStatement, sADL_SadlIsTransitive, sADL_SadlIsSymmetrical, sADL_SadlIsAnnotation, sADL_SadlDefaultValue, sADL_SadlIsFunctional, sADL_SadlMustBeOneOf, sADL_SadlCanOnlyBeOneOf, sADL_SadlUnaryExpression, sADL_SadlNumberLiteral, sADL_SadlStringLiteral, sADL_SadlBooleanLiteral, sADL_SadlConstantLiteral, sADL_Sublist, sADL_BinaryOperation, sADL_ConstructExpression, sADL_AskExpression, sADL_TestStatement, sADL_SelectExpression, sADL_UnaryExpression, sADL_Declaration, sADL_PropOfSubject, sADL_StringLiteral, sADL_SubjHasProp, sADL_ElementInList, sADL_UnitExpression, sADL_NumberLiteral, sADL_BooleanLiteral, sADL_Constant, sADL_Name, SadlResource, SadlDataType},
    associations={annotations0, imports1, elements3, importedResource5, body8, value26, type28, nameOrRef31, type33, listInitializer36, propertyInitializers38, instance41, name45, annotations47, name9, parameter10, returnType12, type14, name17, property20, cond22, property24, nameOrRef50, restrictions52, from_54, to57, property60, nameDeclarations63, type79, contents81, expr84, rulename86, type66, facet68, restriction70, type72, facet74, explicitValues77, nameOrRef115, sameAs117, nameOrRef120, notTheSameAs122, types125, orderBy89, valueTable92, row93, rows95, explicitValues98, classOrProperty101, superElement103, facet106, describedBy109, domain153, restrictions112, range155, facet157, otherProperty160, classes128, types130, subject133, object135, propConditions138, left141, right143, left146, right148, type151, expr169, name171, annotations173, ifs176, thens179, name182, annotations184, defValue162, values164, values166, value168, orderList210, list213, where215, left218, expr187, subj190, pred192, obj195, whereExpression198, whereExpression201, tests203, selectFrom205, whereExpression207, expr240, type242, arglist244, right220, left223, right225, left228, prop230, right233, element236, left238, arglist247},
    generalizations={gen_sADL_EquationStatement_SadlModelElement, gen_sADL_EquationStatement_AbstractSadlEquation, gen_sADL_SadlInstance_SadlStatement, gen_sADL_SadlResource_SadlStatement, gen_sADL_SadlResource_SadlExplicitValueLiteral, gen_sADL_SadlResource_Expression, gen_sADL_ExternalEquationStatement_SadlModelElement, gen_sADL_ExternalEquationStatement_AbstractSadlEquation, gen_sADL_SadlStatement_SadlModelElement, gen_sADL_SadlPropertyCondition_SadlTypeReference, gen_sADL_SadlProperty_SadlStatement, gen_sADL_SadlTypeReference_SadlStatement, gen_sADL_PrintStatement_SadlModelElement, gen_sADL_ExplainStatement_SadlModelElement, gen_sADL_StartWriteStatement_SadlModelElement, gen_sADL_EndWriteStatement_SadlModelElement, gen_sADL_ReadStatement_SadlModelElement, gen_sADL_SadlCondition_SadlPropertyRestriction, gen_sADL_SadlAllValuesCondition_SadlCondition, gen_sADL_SadlHasValueCondition_SadlCondition, gen_sADL_SadlCardinalityCondition_SadlCondition, gen_sADL_SadlExplicitValueLiteral_SadlExplicitValue, gen_sADL_SadlValueList_SadlExplicitValueLiteral, gen_sADL_ExpressionScope_SadlModelElement, gen_sADL_SadlSameAs_SadlStatement, gen_sADL_SadlDifferentFrom_SadlStatement, gen_sADL_SadlDisjointClasses_SadlStatement, gen_sADL_ValueTable_Expression, gen_sADL_SadlClassOrPropertyDeclaration_SadlStatement, gen_sADL_SadlTypeAssociation_SadlPropertyRestriction, gen_sADL_SadlRangeRestriction_SadlPropertyRestriction, gen_sADL_SadlIsInverseOf_SadlPropertyRestriction, gen_sADL_SadlNecessaryAndSufficient_SadlStatement, gen_sADL_SadlNestedInstance_SadlInstance, gen_sADL_SadlUnionType_SadlTypeReference, gen_sADL_SadlIntersectionType_SadlTypeReference, gen_sADL_SadlSimpleTypeReference_SadlTypeReference, gen_sADL_SadlPrimitiveDataType_SadlTypeReference, gen_sADL_ExpressionStatement_ExpressionScope, gen_sADL_RuleStatement_ExpressionScope, gen_sADL_QueryStatement_ExpressionScope, gen_sADL_SadlIsTransitive_SadlPropertyRestriction, gen_sADL_SadlIsSymmetrical_SadlPropertyRestriction, gen_sADL_SadlIsAnnotation_SadlPropertyRestriction, gen_sADL_SadlDefaultValue_SadlPropertyRestriction, gen_sADL_SadlIsFunctional_SadlPropertyRestriction, gen_sADL_SadlMustBeOneOf_SadlPropertyRestriction, gen_sADL_SadlCanOnlyBeOneOf_SadlPropertyRestriction, gen_sADL_SadlUnaryExpression_SadlExplicitValue, gen_sADL_SadlNumberLiteral_SadlExplicitValueLiteral, gen_sADL_SadlStringLiteral_SadlExplicitValueLiteral, gen_sADL_SadlBooleanLiteral_SadlExplicitValueLiteral, gen_sADL_SadlConstantLiteral_SadlExplicitValueLiteral, gen_sADL_Sublist_Expression, gen_sADL_BinaryOperation_Expression, gen_sADL_ConstructExpression_Expression, gen_sADL_AskExpression_Expression, gen_sADL_TestStatement_ExpressionScope, gen_sADL_SelectExpression_Expression, gen_sADL_UnaryExpression_Expression, gen_sADL_Declaration_Expression, gen_sADL_PropOfSubject_Expression, gen_sADL_StringLiteral_Expression, gen_sADL_SubjHasProp_Expression, gen_sADL_ElementInList_Expression, gen_sADL_UnitExpression_Expression, gen_sADL_NumberLiteral_Expression, gen_sADL_BooleanLiteral_Expression, gen_sADL_Constant_Expression, gen_sADL_Name_SadlResource},
    metadata=None
)
