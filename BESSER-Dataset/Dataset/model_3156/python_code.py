...
class sADL_QueryStatement(ExpressionScope):
    ...
    def __init__(self, start: str, sADL_QueryStatement188: "sADL_Expression" = None, sADL_QueryStatement: "sADL_SadlResource" = None, sADL_QueryStatement185: set["sADL_NamedStructureAnnotation"] = None):
        self.start = start
...
class sADL_OrderElement:
    ...
    def __init__(self, desc: bool, sADL_OrderElement212: "sADL_SelectExpression" = None, sADL_OrderElement: "sADL_SadlResource" = None):
        self.desc = desc
...
class sADL_SadlCardinalityCondition(SadlCondition):
    ...
    def __init__(self, operator: str, cardinality: str, sADL_SadlCardinalityCondition: "sADL_SadlTypeReference" = None, sADL_SadlCardinalityCondition75: "sADL_SadlDataTypeFacet" = None):
        self.operator = operator
...
class sADL_SadlParameterDeclaration:
    ...
    def __init__(self, ellipsis: str, unknown: str, sADL_SadlParameterDeclaration: "sADL_AbstractSadlEquation" = None, sADL_SadlParameterDeclaration15: "sADL_SadlTypeReference" = None, sADL_SadlParameterDeclaration18: "sADL_SadlResource" = None):
...
class sADL_Declaration(Expression):
    ...
    def __init__(self, article: str, ordinal: str, len: str, maxlen: str, sADL_Declaration: "sADL_SadlTypeReference" = None, sADL_Declaration245: set["sADL_Expression"] = None):
        self.article = article
...
class sADL_SubjHasProp(Expression):
    ...
    def __init__(self, comma: bool, sADL_SubjHasProp: "sADL_Expression" = None, sADL_SubjHasProp231: "sADL_SadlResource" = None, sADL_SubjHasProp234: "sADL_Expression" = None):
        self.comma = comma
...
class sADL_SelectExpression(Expression):
    ...
    def __init__(self, orderby: str, distinct: bool, sADL_SelectExpression211: set["sADL_OrderElement"] = None, sADL_SelectExpression: set["sADL_SadlResource"] = None, sADL_SelectExpression208: "sADL_Expression" = None):
...
class sADL_SadlProperty(SadlStatement):
    ...
    def __init__(self, primaryDeclaration: bool, sADL_SadlProperty: "sADL_SadlResource" = None, sADL_SadlProperty53: set["sADL_SadlPropertyRestriction"] = None, sADL_SadlProperty55: "sADL_SadlTypeReference" = None, sADL_SadlProperty58: "sADL_SadlTypeReference" = None, sADL_SadlProperty61: "sADL_SadlResource" = None, sADL_SadlProperty64: set["sADL_SadlResource"] = None, sADL_SadlProperty111: "sADL_SadlClassOrPropertyDeclaration" = None):
...
class sADL_SadlDifferentFrom(SadlStatement):
    ...
    def __init__(self, complement: bool, sADL_SadlDifferentFrom: "sADL_SadlResource" = None, sADL_SadlDifferentFrom123: "sADL_SadlTypeReference" = None, sADL_SadlDifferentFrom126: set["sADL_SadlClassOrPropertyDeclaration"] = None):
...
class sADL_SadlResource(SadlExplicitValueLiteral, Expression, SadlStatement):
...
class sADL_SadlModel:
    ...
    def __init__(self, alias: str, version: str, baseUri: str, sADL_SadlModel: set["sADL_SadlAnnotation"] = None, sADL_SadlModel2: set["sADL_SadlImport"] = None, sADL_SadlModel4: set["sADL_SadlModelElement"] = None, sADL_SadlModel7: "sADL_SadlImport" = None):
        self.alias = alias
