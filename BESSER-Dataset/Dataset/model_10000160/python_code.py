...
class New_Employee:
    ...
    def __init__(self, Name: str, Position: str, Division: str, Date_of_Birth: str, Place_of_Birth: str, Working_Since: str, task15: "Task" = None, attendance16: "Attendance" = None, registration11: "Registration" = None, applicant13: "Applicant" = None):
        self.Name = Name
...
class Attendance:
    ...
    def __init__(self, Name: str, Date___Time: str, Position: str, Details: str, new_Employee17: "New_Employee" = None, assessment20: "Assessment" = None):
        self.Name = Name
...
class Registration:
    ...
    def __init__(self, Date: str, Name: str, Address: str, Phone: str, Email: str, Applied_Position: str, Position_Type: str, Skills___Requirement: str, requirement19: "Requirement" = None, applicant5: "Applicant" = None, admin7: "Admin" = None, new_Employee10: "New_Employee" = None):
        self.Date = Date
        self.Name = Name
