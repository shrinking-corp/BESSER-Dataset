...
Applicant.attributes={Applicant_Phone, Applicant_Address, Applicant_First_Name, Applicant_Applied_Position, Applicant_Date_of_Birth, Applicant_Email, Applicant_Password, Applicant_Last_Name}
...
Admin.attributes={Admin_name, Admin_qualification, Admin_address}
...
Registration.attributes={Registration_Date, Registration_Position_Type, Registration_Phone, Registration_Name, Registration_Address, Registration_Applied_Position, Registration_Skills___Requirement, Registration_Email}
...
Position.attributes={Position_positionName, Position_divisionName, Position_jobID, Position_positionID}
...
Login.attributes={Login_userid, Login_password}
...
Attendance.attributes={Attendance_Date___Time, Attendance_Details, Attendance_Name, Attendance_Position}
...
Requirement.attributes={Requirement_Photo, Requirement_Diploma, Requirement_ID_Card, Requirement_Curriculum_Vitae, Requirement_Transcript}
...
Task.attributes={Task_Deadline, Task_Task_Detail, Task_Name, Task_Task_Name}
...
New_Employee.attributes={New_Employee_Name, New_Employee_Position, New_Employee_Place_of_Birth, New_Employee_Division, New_Employee_Date_of_Birth, New_Employee_Working_Since}
...
Survey.attributes={Survey_Score, Survey_Name, Survey_Question}
...
Assessment.attributes={Assessment_Name, Assessment_Type_of_Assessment, Assessment_Total_Score}
...
Assessment__Self_Assessment.attributes={Assessment__Self_Assessment_Name, Assessment__Self_Assessment_Question, Assessment__Self_Assessment_Score}
...
domain_model = DomainModel(
    name="_140c8d89_5dad_4e09_a4b0_6ff6c0b4dd28",
