...
target6: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="in_", type=petrinet_Node, multiplicity=Multiplicity(0, 1))
    }
)
...
domain_model = DomainModel(
    name="petrinet",
    types={petrinet_Transition, Node, petrinet_petrinet, petrinet_Arc, petrinet_Node, petrinet_Token, petrinet_Place},
    associations={arcs0, nodes1, place3, source4, target6, petrinet8, in_10, out12, petrinet14, tokens16},
