...
class petrinet_Node(ABC):
    ...
    def __init__(self, name: str, Node: "petrinet_petrinet" = None, Node5: "petrinet_Arc" = None, Node7: "petrinet_Arc" = None, target: set["petrinet_Arc"] = None, source: set["petrinet_Arc"] = None, nodes: "petrinet_petrinet" = None):
        self.name = name
        self.Node = Node
        self.Node5 = Node5
        self.Node7 = Node7
