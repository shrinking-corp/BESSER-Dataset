...
# Classes
sadl_Model = Class(name="sadl_Model")
sadl_ModelName = Class(name="sadl_ModelName")
sadl_Import = Class(name="sadl_Import")
sadl_ModelElement = Class(name="sadl_ModelElement")
sadl_ContentList = Class(name="sadl_ContentList")
sadl_ResourceName = Class(name="sadl_ResourceName")
sadl_ResourceList = Class(name="sadl_ResourceList")
sadl_LiteralList = Class(name="sadl_LiteralList")
sadl_LiteralValue = Class(name="sadl_LiteralValue")
sadl_ResourceByName = Class(name="sadl_ResourceByName")
ResourceIdentifier = Class(name="ResourceIdentifier")
sadl_ExistingResourceList = Class(name="sadl_ExistingResourceList")
sadl_ResourceIdentifier = Class(name="sadl_ResourceIdentifier")
sadl_ResourceBySetOp = Class(name="sadl_ResourceBySetOp")
sadl_ResourceByRestriction = Class(name="sadl_ResourceByRestriction")
sadl_Condition = Class(name="sadl_Condition")
sadl_Statement = Class(name="sadl_Statement")
ModelElement = Class(name="ModelElement")
sadl_EnumeratedInstances = Class(name="sadl_EnumeratedInstances")
sadl_AddlClassInfo = Class(name="sadl_AddlClassInfo")
sadl_Range = Class(name="sadl_Range")
sadl_RangeType = Class(name="sadl_RangeType")
sadl_UnionResource = Class(name="sadl_UnionResource")
ResourceBySetOp = Class(name="ResourceBySetOp")
sadl_IntersectionResource = Class(name="sadl_IntersectionResource")
sadl_UserDefinedDataType = Class(name="sadl_UserDefinedDataType")
sadl_ClassDeclaration = Class(name="sadl_ClassDeclaration")
Statement = Class(name="Statement")
sadl_DataTypeRestriction = Class(name="sadl_DataTypeRestriction")
sadl_Facets = Class(name="sadl_Facets")
sadl_EquivalentConcepts = Class(name="sadl_EquivalentConcepts")
sadl_ComplementOfClass = Class(name="sadl_ComplementOfClass")
sadl_AllValuesFrom = Class(name="sadl_AllValuesFrom")
sadl_PropertyOfClass = Class(name="sadl_PropertyOfClass")
sadl_AllValuesCondition = Class(name="sadl_AllValuesCondition")
sadl_SomeValuesFrom = Class(name="sadl_SomeValuesFrom")
sadl_SomeValuesCondition = Class(name="sadl_SomeValuesCondition")
sadl_HasValue = Class(name="sadl_HasValue")
sadl_HasValueCondition = Class(name="sadl_HasValueCondition")
sadl_Cardinality = Class(name="sadl_Cardinality")
sadl_DisjointClasses = Class(name="sadl_DisjointClasses")
sadl_MinCardinality = Class(name="sadl_MinCardinality")
sadl_MinCardCondition = Class(name="sadl_MinCardCondition")
sadl_MaxCardinality = Class(name="sadl_MaxCardinality")
sadl_MaxCardCondition = Class(name="sadl_MaxCardCondition")
sadl_CardCondition = Class(name="sadl_CardCondition")
Condition = Class(name="Condition")
sadl_EnumeratedAllValuesFrom = Class(name="sadl_EnumeratedAllValuesFrom")
sadl_EObject = Class(name="sadl_EObject")
sadl_EnumeratedAllAndSomeValuesFrom = Class(name="sadl_EnumeratedAllAndSomeValuesFrom")
sadl_DefaultValue = Class(name="sadl_DefaultValue")
sadl_ExplicitValue = Class(name="sadl_ExplicitValue")
sadl_NecessaryAndSufficient = Class(name="sadl_NecessaryAndSufficient")
sadl_TypedBNode = Class(name="sadl_TypedBNode")
sadl_PropertyDeclaration = Class(name="sadl_PropertyDeclaration")
sadl_AdditionalPropertyInfo = Class(name="sadl_AdditionalPropertyInfo")
sadl_IsInverseOf = Class(name="sadl_IsInverseOf")
sadl_FunctionalProperty = Class(name="sadl_FunctionalProperty")
sadl_InverseFunctionalProperty = Class(name="sadl_InverseFunctionalProperty")
sadl_SymmetricalProperty = Class(name="sadl_SymmetricalProperty")
sadl_TransitiveProperty = Class(name="sadl_TransitiveProperty")
sadl_InverseProperty = Class(name="sadl_InverseProperty")
sadl_PropValPartialTriple = Class(name="sadl_PropValPartialTriple")
sadl_InstanceDifferentFrom = Class(name="sadl_InstanceDifferentFrom")
sadl_InstancesAllDifferent = Class(name="sadl_InstancesAllDifferent")
sadl_ExistingInstanceAttribution = Class(name="sadl_ExistingInstanceAttribution")
sadl_OfPatternReturningValues = Class(name="sadl_OfPatternReturningValues")
sadl_InstanceDeclarationStatement = Class(name="sadl_InstanceDeclarationStatement")
sadl_InstanceDeclaration = Class(name="sadl_InstanceDeclaration")
...
sadl_TypeDeclaration = Class(name="sadl_TypeDeclaration")
sadl_OfPhrase = Class(name="sadl_OfPhrase")
sadl_WithChain = Class(name="sadl_WithChain")
sadl_WithPhrase = Class(name="sadl_WithPhrase")
sadl_EmbeddedInstanceDeclaration = Class(name="sadl_EmbeddedInstanceDeclaration")
sadl_MergedTriples = Class(name="sadl_MergedTriples")
GraphPattern = Class(name="GraphPattern")
sadl_VariableList = Class(name="sadl_VariableList")
sadl_Object = Class(name="sadl_Object")
sadl_ElementSet = Class(name="sadl_ElementSet")
sadl_Query = Class(name="sadl_Query")
sadl_Expression = Class(name="sadl_Expression")
sadl_Test = Class(name="sadl_Test")
sadl_Expr = Class(name="sadl_Expr")
sadl_Display = Class(name="sadl_Display")
sadl_Explanation = Class(name="sadl_Explanation")
sadl_SelectExpression = Class(name="sadl_SelectExpression")
Expression = Class(name="Expression")
sadl_OrderList = Class(name="sadl_OrderList")
sadl_ConstructExpression = Class(name="sadl_ConstructExpression")
sadl_Rule = Class(name="sadl_Rule")
sadl_OrderElement = Class(name="sadl_OrderElement")
sadl_GraphPattern = Class(name="sadl_GraphPattern")
sadl_IntervalValue = Class(name="sadl_IntervalValue")
sadl_ValueTable = Class(name="sadl_ValueTable")
sadl_PropOfSubj = Class(name="sadl_PropOfSubj")
sadl_SubjProp = Class(name="sadl_SubjProp")
sadl_InstAttrSPV = Class(name="sadl_InstAttrSPV")
sadl_AskQueryExpression = Class(name="sadl_AskQueryExpression")
sadl_SubTypeOf = Class(name="sadl_SubTypeOf")
sadl_ExistentialNegation = Class(name="sadl_ExistentialNegation")
sadl_ValueRow = Class(name="sadl_ValueRow")
sadl_JunctionExpression = Class(name="sadl_JunctionExpression")
sadl_InstAttrPSV = Class(name="sadl_InstAttrPSV")
sadl_BinaryOpExpression = Class(name="sadl_BinaryOpExpression")
sadl_UnaryOpExpression = Class(name="sadl_UnaryOpExpression")
...
sadl_ModelName.attributes={sadl_ModelName_alias, sadl_ModelName_baseUri, sadl_ModelName_annType, sadl_ModelName_version}
...
sadl_LiteralValue.attributes={sadl_LiteralValue_literalNumber, sadl_LiteralValue_literalString, sadl_LiteralValue_literalBoolean}
...
sadl_Range.attributes={sadl_Range_list, sadl_Range_single, sadl_Range_lists}
...
sadl_DataTypeRestriction.attributes={sadl_DataTypeRestriction_basetypes, sadl_DataTypeRestriction_basetype}
...
sadl_Facets.attributes={sadl_Facets_len, sadl_Facets_minexin, sadl_Facets_maxexin, sadl_Facets_minlen, sadl_Facets_maxlen, sadl_Facets_max, sadl_Facets_min, sadl_Facets_regex, sadl_Facets_values}
...
sadl_ExplicitValue.attributes={sadl_ExplicitValue_term, sadl_ExplicitValue_valueList}
...
sadl_SelectExpression.attributes={sadl_SelectExpression_allVars, sadl_SelectExpression_orderby, sadl_SelectExpression_distinct}
...
domain_model = DomainModel(
    name="sadl",
    types={sadl_Model, sadl_ModelName, sadl_Import, sadl_ModelElement, sadl_ContentList, sadl_ResourceName, sadl_ResourceList, sadl_LiteralList, sadl_LiteralValue, sadl_ResourceByName, ResourceIdentifier, sadl_ExistingResourceList, sadl_ResourceIdentifier, sadl_ResourceBySetOp, sadl_ResourceByRestriction, sadl_Condition, sadl_Statement, ModelElement, sadl_EnumeratedInstances, sadl_AddlClassInfo, sadl_Range, sadl_RangeType, sadl_UnionResource, ResourceBySetOp, sadl_IntersectionResource, sadl_UserDefinedDataType, sadl_ClassDeclaration, Statement, sadl_DataTypeRestriction, sadl_Facets, sadl_EquivalentConcepts, sadl_ComplementOfClass, sadl_AllValuesFrom, sadl_PropertyOfClass, sadl_AllValuesCondition, sadl_SomeValuesFrom, sadl_SomeValuesCondition, sadl_HasValue, sadl_HasValueCondition, sadl_Cardinality, sadl_DisjointClasses, sadl_MinCardinality, sadl_MinCardCondition, sadl_MaxCardinality, sadl_MaxCardCondition, sadl_CardCondition, Condition, sadl_EnumeratedAllValuesFrom, sadl_EObject, sadl_EnumeratedAllAndSomeValuesFrom, sadl_DefaultValue, sadl_ExplicitValue, sadl_NecessaryAndSufficient, sadl_TypedBNode, sadl_PropertyDeclaration, sadl_AdditionalPropertyInfo, sadl_IsInverseOf, sadl_FunctionalProperty, sadl_InverseFunctionalProperty, sadl_SymmetricalProperty, sadl_TransitiveProperty, sadl_InverseProperty, sadl_PropValPartialTriple, sadl_InstanceDifferentFrom, sadl_InstancesAllDifferent, sadl_ExistingInstanceAttribution, sadl_OfPatternReturningValues, sadl_InstanceDeclarationStatement, sadl_InstanceDeclaration, InstanceDeclarationStatement, EmbeddedInstanceDeclaration, sadl_TypeDeclaration, sadl_OfPhrase, sadl_WithChain, sadl_WithPhrase, sadl_EmbeddedInstanceDeclaration, sadl_MergedTriples, GraphPattern, sadl_VariableList, sadl_Object, sadl_ElementSet, sadl_Query, sadl_Expression, sadl_Test, sadl_Expr, sadl_Display, sadl_Explanation, sadl_SelectExpression, Expression, sadl_OrderList, sadl_ConstructExpression, sadl_Rule, sadl_OrderElement, sadl_GraphPattern, sadl_IntervalValue, sadl_ValueTable, sadl_PropOfSubj, sadl_SubjProp, sadl_InstAttrSPV, sadl_AskQueryExpression, sadl_SubTypeOf, sadl_ExistentialNegation, sadl_ValueRow, sadl_JunctionExpression, sadl_InstAttrPSV, sadl_BinaryOpExpression, sadl_UnaryOpExpression, DataType},
    associations={modelName0, imports1, elements3, annContent5, annContent7, names9, literals11, name12, names14, annContent15, names17, annContent20, propName22, cond25, mustBeOneOf29, describedBy31, classList33, classIdentifier36, instanceList39, propertyByName42, propertyName45, range48, restriction50, type53, classIdentifier55, userDefinedDataType58, className27, restriction60, facets62, class164, class266, class169, class271, classes74, class177, class279, restricted82, cond83, className85, propertyName88, restricted91, cond93, className95, propertyName98, restricted101, cond103, className105, propertyName108, restricted111, className115, propertyName118, restricted121, cond123, className125, propertyName128, restricted131, cond133, propertyName141, className144, cond113, restriction147, restricted150, enumeration152, restricted154, enumeration156, defValueClass159, defValue161, restriction163, restriction166, className135, propertyName138, classQualifier172, classQualifier175, superClass178, subClass179, propertyName182, cond185, propertyName188, superPropName190, addlPropInfo193, domain195, rangeResource198, annotationProperty201, classQualifier169, isInvOf213, propertyName215, propertyName217, propertyName219, propertyName221, propertyName1223, invOf225, propertyName2228, classIdentifier231, domain204, cond207, range210, typeDecl234, addlInfoItems235, className237, instanceName240, instName243, type246, instName1249, instName2251, instances254, subj256, addlInfoItems258, pOfS261, obj263, val266, propertyName268, objectValue271, objectValueBNode274, ofphrs277, subject279, type282, wps285, propertyName286, value289, ops292, pivot294, wcs297, propertyName300, names303, givens305, ifs306, thens309, expr312, expr313, expr315, expr317, elements319, varList322, orderList324, subj326, pred328, obj331, orderList334, name336, expr340, args343, gp345, ivalue347, value349, valueTable352, ofPhr354, subj356, subj359, hwPhr361, subj364, props366, vals369, prop372, val374, subclass377, superclass379, varList382, quantified384, expr387, instName390, litValue393, row396, rows398, explicitValues401, left404, right406, left409, right411},
    generalizations={gen_sadl_ResourceByName_ResourceIdentifier, gen_sadl_ResourceBySetOp_ResourceIdentifier, gen_sadl_ResourceByRestriction_ResourceIdentifier, gen_sadl_Statement_ModelElement, gen_sadl_UnionResource_ResourceBySetOp, gen_sadl_IntersectionResource_ResourceBySetOp, gen_sadl_UserDefinedDataType_Statement, gen_sadl_ClassDeclaration_Statement, gen_sadl_EquivalentConcepts_Statement, gen_sadl_ComplementOfClass_Statement, gen_sadl_AllValuesFrom_Statement, gen_sadl_SomeValuesFrom_Statement, gen_sadl_HasValue_Statement, gen_sadl_Cardinality_Statement, gen_sadl_DisjointClasses_Statement, gen_sadl_MinCardinality_Statement, gen_sadl_MaxCardinality_Statement, gen_sadl_AllValuesCondition_Condition, gen_sadl_EnumeratedAllValuesFrom_Statement, gen_sadl_EnumeratedAllAndSomeValuesFrom_Statement, gen_sadl_DefaultValue_Statement, gen_sadl_SomeValuesCondition_Condition, gen_sadl_HasValueCondition_Condition, gen_sadl_MinCardCondition_Condition, gen_sadl_CardCondition_Condition, gen_sadl_NecessaryAndSufficient_Statement, gen_sadl_PropertyDeclaration_Statement, gen_sadl_MaxCardCondition_Condition, gen_sadl_FunctionalProperty_Statement, gen_sadl_InverseFunctionalProperty_Statement, gen_sadl_SymmetricalProperty_Statement, gen_sadl_TransitiveProperty_Statement, gen_sadl_InverseProperty_Statement, gen_sadl_InstanceDifferentFrom_Statement, gen_sadl_InstancesAllDifferent_Statement, gen_sadl_ExistingInstanceAttribution_Statement, gen_sadl_InstanceDeclarationStatement_Statement, gen_sadl_InstanceDeclaration_InstanceDeclarationStatement, gen_sadl_InstanceDeclaration_EmbeddedInstanceDeclaration, gen_sadl_MergedTriples_GraphPattern, gen_sadl_Query_ModelElement, gen_sadl_Test_ModelElement, gen_sadl_Expr_ModelElement, gen_sadl_Display_ModelElement, gen_sadl_Explanation_ModelElement, gen_sadl_SelectExpression_Expression, gen_sadl_ConstructExpression_Expression, gen_sadl_Rule_ModelElement, gen_sadl_PropOfSubj_GraphPattern, gen_sadl_SubjProp_GraphPattern, gen_sadl_InstAttrSPV_GraphPattern, gen_sadl_AskQueryExpression_Expression, gen_sadl_SubTypeOf_GraphPattern, gen_sadl_ExistentialNegation_GraphPattern, gen_sadl_JunctionExpression_Expression, gen_sadl_InstAttrPSV_GraphPattern, gen_sadl_BinaryOpExpression_Expression, gen_sadl_UnaryOpExpression_Expression},
    metadata=None
)
