...
# Classes
aspectualacme_Root = Class(name="aspectualacme_Root")
aspectualacme_Import = Class(name="aspectualacme_Import")
aspectualacme_BasicElement = Class(name="aspectualacme_BasicElement", is_abstract=True)
aspectualacme_Element = Class(name="aspectualacme_Element")
aspectualacme_Property = Class(name="aspectualacme_Property")
aspectualacme_Representation = Class(name="aspectualacme_Representation")
aspectualacme_attachableElement = Class(name="aspectualacme_attachableElement", is_abstract=True)
Element = Class(name="Element")
aspectualacme_Armani = Class(name="aspectualacme_Armani")
aspectualacme_Family = Class(name="aspectualacme_Family")
BasicElement = Class(name="BasicElement")
aspectualacme_Connector = Class(name="aspectualacme_Connector")
aspectualacme_Attachment = Class(name="aspectualacme_Attachment")
aspectualacme_WildCard = Class(name="aspectualacme_WildCard")
aspectualacme_ComponentType = Class(name="aspectualacme_ComponentType")
aspectualacme_PortType = Class(name="aspectualacme_PortType")
aspectualacme_ConnectorType = Class(name="aspectualacme_ConnectorType")
aspectualacme_RoleType = Class(name="aspectualacme_RoleType")
aspectualacme_PropertyType = Class(name="aspectualacme_PropertyType")
TypeDefinition = Class(name="TypeDefinition")
aspectualacme_Port = Class(name="aspectualacme_Port")
aspectualacme_Role = Class(name="aspectualacme_Role")
aspectualacme_Glue = Class(name="aspectualacme_Glue")
aspectualacme_Component = Class(name="aspectualacme_Component")
aspectualacme_System = Class(name="aspectualacme_System")
attachableElement = Class(name="attachableElement")
BindableElement = Class(name="BindableElement")
aspectualacme_BaseRole = Class(name="aspectualacme_BaseRole")
Role = Class(name="Role")
aspectualacme_CrosscuttingRole = Class(name="aspectualacme_CrosscuttingRole")
aspectualacme_Binding = Class(name="aspectualacme_Binding")
aspectualacme_BindableElement = Class(name="aspectualacme_BindableElement")
aspectualacme_TypeDefinition = Class(name="aspectualacme_TypeDefinition")
aspectualacme_ArmaniDesignRuleExpression = Class(name="aspectualacme_ArmaniDesignRuleExpression", is_abstract=True)
aspectualacme_ArmaniExpression = Class(name="aspectualacme_ArmaniExpression")
aspectualacme_ArmaniFunctionCall = Class(name="aspectualacme_ArmaniFunctionCall")
ArmaniPrimitiveExpression = Class(name="ArmaniPrimitiveExpression")
aspectualacme_ArmaniPrimitiveExpression = Class(name="aspectualacme_ArmaniPrimitiveExpression")
aspectualacme_ArmaniConstant = Class(name="aspectualacme_ArmaniConstant")
ArmaniUnaryExpression = Class(name="ArmaniUnaryExpression")
aspectualacme_ArmaniUnaryExpression = Class(name="aspectualacme_ArmaniUnaryExpression")
ArmaniExpression = Class(name="ArmaniExpression")
aspectualacme_ArmaniMultiplicativeExpression = Class(name="aspectualacme_ArmaniMultiplicativeExpression")
aspectualacme_ArmaniAdditiveExpression = Class(name="aspectualacme_ArmaniAdditiveExpression")
aspectualacme_ArmaniRelationalExpression = Class(name="aspectualacme_ArmaniRelationalExpression")
aspectualacme_ArmaniEqualityExpression = Class(name="aspectualacme_ArmaniEqualityExpression")
aspectualacme_ArmaniIffExpression = Class(name="aspectualacme_ArmaniIffExpression")
aspectualacme_ArmaniImpliesExpression = Class(name="aspectualacme_ArmaniImpliesExpression")
aspectualacme_ArmaniSetExpression = Class(name="aspectualacme_ArmaniSetExpression")
aspectualacme_ArmaniVariable = Class(name="aspectualacme_ArmaniVariable")
aspectualacme_ArmaniBooleanExpression = Class(name="aspectualacme_ArmaniBooleanExpression")
ArmaniDesignRuleExpression = Class(name="ArmaniDesignRuleExpression")
aspectualacme_ArmaniQuantifiedExpression = Class(name="aspectualacme_ArmaniQuantifiedExpression")
aspectualacme_ArmaniOrExpression = Class(name="aspectualacme_ArmaniOrExpression")
...
aspectualacme_Property.attributes={aspectualacme_Property_name, aspectualacme_Property_value}
...
aspectualacme_PropertyType.attributes={aspectualacme_PropertyType_values, aspectualacme_PropertyType_type}
...
aspectualacme_ArmaniSetExpression.attributes={aspectualacme_ArmaniSetExpression_reference, aspectualacme_ArmaniSetExpression_referenceType}
...
aspectualacme_ArmaniVariable.attributes={aspectualacme_ArmaniVariable_id, aspectualacme_ArmaniVariable_basicType}
...
domain_model = DomainModel(
    name="aspectualacme",
    types={aspectualacme_Root, aspectualacme_Import, aspectualacme_BasicElement, aspectualacme_Element, aspectualacme_Property, aspectualacme_Representation, aspectualacme_attachableElement, Element, aspectualacme_Armani, aspectualacme_Family, BasicElement, aspectualacme_Connector, aspectualacme_Attachment, aspectualacme_WildCard, aspectualacme_ComponentType, aspectualacme_PortType, aspectualacme_ConnectorType, aspectualacme_RoleType, aspectualacme_PropertyType, TypeDefinition, aspectualacme_Port, aspectualacme_Role, aspectualacme_Glue, aspectualacme_Component, aspectualacme_System, attachableElement, BindableElement, aspectualacme_BaseRole, Role, aspectualacme_CrosscuttingRole, aspectualacme_Binding, aspectualacme_BindableElement, aspectualacme_TypeDefinition, aspectualacme_ArmaniDesignRuleExpression, aspectualacme_ArmaniExpression, aspectualacme_ArmaniFunctionCall, ArmaniPrimitiveExpression, aspectualacme_ArmaniPrimitiveExpression, aspectualacme_ArmaniConstant, ArmaniUnaryExpression, aspectualacme_ArmaniUnaryExpression, ArmaniExpression, aspectualacme_ArmaniMultiplicativeExpression, aspectualacme_ArmaniAdditiveExpression, aspectualacme_ArmaniRelationalExpression, aspectualacme_ArmaniEqualityExpression, aspectualacme_ArmaniIffExpression, aspectualacme_ArmaniImpliesExpression, aspectualacme_ArmaniSetExpression, aspectualacme_ArmaniVariable, aspectualacme_ArmaniBooleanExpression, ArmaniDesignRuleExpression, aspectualacme_ArmaniQuantifiedExpression, aspectualacme_ArmaniOrExpression, GlueType, ArmaniSetTypes, ArmaniTypes, ArmaniQuantifier},
    associations={imports0, elements1, property3, representations4, armani5, parentFamily7, connectors9, attachments12, wildcard14, ctypes16, ptypes18, cntypes20, rtypes22, prtypes24, properties26, port28, parentType30, parentFamily31, parentType33, parentFamily34, parentType37, parentFamily38, parentType41, role42, components10, parentFamily47, connectors49, properties51, attachments54, wildCard57, components59, parentRepresentation62, effective_type64, port67, type70, parentSystem72, parentFamily73, effective_type76, role79, glue82, type83, glue43, parentFamily45, parentFamily87, effective_type90, Connector93, ConnectorT95, roleType98, effective_type100, type103, type105, portType107, Component109, ComponentT111, effective_type114, type117, parentSystem119, parentFamily121, baseAttach124, parentSystem85, connector130, firstElement132, secondElement133, parentSystem136, parentFamily138, property141, firstPort143, secondPort145, representation148, system150, bindings152, element153, designRule154, parameters156, crosscuttingAttach127, setValues157, designRule158, unaryExpression162, expressions163, expressions165, expressions167, expressions169, expressions171, expressions173, expressions175, userType177, expressions178, variable180, setExpression182, designRule185},
    generalizations={gen_aspectualacme_attachableElement_Element, gen_aspectualacme_BasicElement_Element, gen_aspectualacme_Family_BasicElement, gen_aspectualacme_ComponentType_TypeDefinition, gen_aspectualacme_RoleType_TypeDefinition, gen_aspectualacme_PortType_TypeDefinition, gen_aspectualacme_ConnectorType_TypeDefinition, gen_aspectualacme_PropertyType_TypeDefinition, gen_aspectualacme_System_BasicElement, gen_aspectualacme_Component_Element, gen_aspectualacme_Connector_Element, gen_aspectualacme_Role_attachableElement, gen_aspectualacme_Role_BindableElement, gen_aspectualacme_BaseRole_Role, gen_aspectualacme_CrosscuttingRole_Role, gen_aspectualacme_Port_attachableElement, gen_aspectualacme_Port_BindableElement, gen_aspectualacme_WildCard_attachableElement, gen_aspectualacme_BindableElement_Element, gen_aspectualacme_TypeDefinition_Element, gen_aspectualacme_ArmaniFunctionCall_ArmaniPrimitiveExpression, gen_aspectualacme_ArmaniConstant_ArmaniPrimitiveExpression, gen_aspectualacme_ArmaniPrimitiveExpression_ArmaniUnaryExpression, gen_aspectualacme_ArmaniUnaryExpression_ArmaniExpression, gen_aspectualacme_ArmaniMultiplicativeExpression_ArmaniExpression, gen_aspectualacme_ArmaniAdditiveExpression_ArmaniExpression, gen_aspectualacme_ArmaniRelationalExpression_ArmaniExpression, gen_aspectualacme_ArmaniEqualityExpression_ArmaniExpression, gen_aspectualacme_ArmaniIffExpression_ArmaniExpression, gen_aspectualacme_ArmaniImpliesExpression_ArmaniExpression, gen_aspectualacme_ArmaniSetExpression_ArmaniPrimitiveExpression, gen_aspectualacme_ArmaniVariable_ArmaniExpression, gen_aspectualacme_ArmaniBooleanExpression_ArmaniDesignRuleExpression, gen_aspectualacme_ArmaniQuantifiedExpression_ArmaniDesignRuleExpression, gen_aspectualacme_ArmaniDesignRuleExpression_ArmaniExpression, gen_aspectualacme_ArmaniOrExpression_ArmaniExpression},
    metadata=None
)
