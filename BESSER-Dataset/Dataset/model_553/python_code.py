...
class aspectualacme_ArmaniVariable(ArmaniExpression):
    ...
    def __init__(self, id: str, basicType: str, aspectualacme_ArmaniVariable: "aspectualacme_TypeDefinition" = None, aspectualacme_ArmaniVariable181: "aspectualacme_ArmaniQuantifiedExpression" = None):
        self.id = id
...
class aspectualacme_ArmaniRelationalExpression(ArmaniExpression):
    ...
    def __init__(self, operators: str, aspectualacme_ArmaniRelationalExpression: set["aspectualacme_ArmaniAdditiveExpression"] = None, aspectualacme_ArmaniRelationalExpression170: "aspectualacme_ArmaniEqualityExpression" = None):
        self.operators = operators
...
class aspectualacme_ArmaniOrExpression(ArmaniExpression):
    ...
    def __init__(self, operators: str, aspectualacme_ArmaniOrExpression: set["aspectualacme_ArmaniImpliesExpression"] = None, aspectualacme_ArmaniOrExpression179: "aspectualacme_ArmaniBooleanExpression" = None):
        self.operators = operators
...
class aspectualacme_ArmaniSetExpression(ArmaniPrimitiveExpression):
    ...
    def __init__(self, referenceType: str, reference: str, aspectualacme_ArmaniSetExpression: set["aspectualacme_ArmaniConstant"] = None, aspectualacme_ArmaniSetExpression184: "aspectualacme_ArmaniQuantifiedExpression" = None):
...
class aspectualacme_Glue:
    ...
    def __init__(self, glueType: str, Glue: "aspectualacme_Connector" = None, aspectualacme_Glue: "aspectualacme_ConnectorType" = None, aspectualacme_Glue128: "aspectualacme_CrosscuttingRole" = None, aspectualacme_Glue125: "aspectualacme_BaseRole" = None, glue: "aspectualacme_Connector" = None):
...
class aspectualacme_Role(BindableElement, attachableElement):

    pass
class aspectualacme_Port(BindableElement, attachableElement):
...
class aspectualacme_PropertyType(TypeDefinition):
    ...
    def __init__(self, type: str, values: str, prtypes: "aspectualacme_Family" = None, PropertyType: "aspectualacme_Family" = None, aspectualacme_PropertyType: "aspectualacme_Property" = None):
        self.type = type
        self.values = values
...
class aspectualacme_WildCard(attachableElement):
    ...
    def __init__(self, expression: str, aspectualacme_WildCard58: "aspectualacme_System" = None, aspectualacme_WildCard: "aspectualacme_Family" = None):
...
class aspectualacme_Representation:
    ...
    def __init__(self, name: str, Representation63: "aspectualacme_System" = None, Representation: "aspectualacme_Element" = None, Representation149: "aspectualacme_Binding" = None, parentRepresentation: "aspectualacme_System" = None, representation: set["aspectualacme_Binding"] = None, representations: "aspectualacme_Element" = None):
        self.name = name
...
class aspectualacme_Property:
    ...
    def __init__(self, name: str, value: str, Property53: "aspectualacme_System" = None, aspectualacme_Property: "aspectualacme_Element" = None, Property: "aspectualacme_Family" = None, aspectualacme_Property142: "aspectualacme_Binding" = None, aspectualacme_Property118: set["aspectualacme_PropertyType"] = None, properties: "aspectualacme_System" = None, properties122: "aspectualacme_Family" = None):
        self.name = name
        self.value = value
