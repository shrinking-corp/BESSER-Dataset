...
# Classes
autopl_Automaton = Class(name="autopl_Automaton")
autopl_Alphabet = Class(name="autopl_Alphabet")
autopl_Symbol = Class(name="autopl_Symbol")
autopl_State = Class(name="autopl_State")
autopl_Transition = Class(name="autopl_Transition")
autopl_HierarchicalState = Class(name="autopl_HierarchicalState")
...
autopl_State.attributes={autopl_State_isInitial, autopl_State_name, autopl_State_isFinal}
autopl_State.methods={autopl_State_m_adjacent, autopl_State_m_outTrans, autopl_State_m_inTrans}
...
domain_model = DomainModel(
    name="autopl",
    types={autopl_Automaton, autopl_Alphabet, autopl_Symbol, autopl_State, autopl_Transition, autopl_HierarchicalState, State, AcceptanceKind},
    associations={symbols13, inputAlphabet0, outputAlphabet1, stackAlphabet4, initialStackSymbol7, states9, transitions11, input16, output19, stackCheck22, stackPush25, from_28, to31, states34, transitions36},
