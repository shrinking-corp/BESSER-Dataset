...
entity_Reference = Class(name="entity_Reference")
entity_Attribute = Class(name="entity_Attribute")
entity_Datatype = Class(name="entity_Datatype")
entity_NamedElement = Class(name="entity_NamedElement", is_abstract=True)
entity_Namespace = Class(name="entity_Namespace")
NamedElement = Class(name="NamedElement")
entity_Type = Class(name="entity_Type")
...
domain_model = DomainModel(
    name="entity",
    types={entity_Entity, Type, entity_Reference, entity_Attribute, entity_Datatype, entity_NamedElement, entity_Namespace, NamedElement, entity_Type},
