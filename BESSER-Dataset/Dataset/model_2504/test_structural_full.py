...
def test_test2_test2sub1_D2_isa_D():
    instance = test2_test2sub1_D2()
...
test2_test2sub1_D_strategy = st.builds(test2_test2sub1_D)
...
test2_test2sub1_D2_strategy = st.builds(test2_test2sub1_D2)
...
test2_test2sub2_E_strategy = st.builds(test2_test2sub2_E)
