...
# Classes
test2_A = Class(name="test2_A")
test2_B = Class(name="test2_B")
test2_C = Class(name="test2_C")
B = Class(name="B")
test2_test2sub1_D = Class(name="test2_test2sub1_D")
test2_test2sub1_D2 = Class(name="test2_test2sub1_D2")
D = Class(name="D")
test2_test2sub2_E = Class(name="test2_test2sub2_E")
...
domain_model = DomainModel(
    name="test2",
    types={test2_A, test2_B, test2_C, B, test2_test2sub1_D, test2_test2sub1_D2, D, test2_test2sub2_E},
    associations={refToB0},
    generalizations={gen_test2_C_B, gen_test2_test2sub1_D2_D},
    metadata=None
)
