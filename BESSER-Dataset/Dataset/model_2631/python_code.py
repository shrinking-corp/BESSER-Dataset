...
class diagram_filter_MappingFilter(Filter):
    ...
    def __init__(self, viewConditionExpression: str, semanticConditionExpression: str, diagram_filter_MappingFilter: set["DiagramElementMapping"] = None):
    ...
    def diagram_filter_MappingFilter(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "DiagramElementMapping496"):
                    opp_val = getattr(item, "DiagramElementMapping496", None)
                    
                    if opp_val == self:
                        setattr(item, "DiagramElementMapping496", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "DiagramElementMapping496"):
                    ...
                    setattr(item, "DiagramElementMapping496", self)
...
class diagram_filter_VariableFilter(Filter):
    ...
    def diagram_filter_VariableFilter(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "filter_FilterVariable499"):
                    opp_val = getattr(item, "filter_FilterVariable499", None)
                    
                    if opp_val == self:
                        setattr(item, "filter_FilterVariable499", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "filter_FilterVariable499"):
                    ...
                    setattr(item, "filter_FilterVariable499", self)
                    

    def setFilterContext(self, diagram_variables):
...
class diagram_filter_Filter(ABC):
    ...
    def isVisible(self, diagram_element) :
...
class diagram_tool_Navigation(ContainerModelOperation):
    ...
    def diagram_tool_Navigation(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "DiagramDescription476"):
                opp_val = getattr(old_value, "DiagramDescription476", None)
                if opp_val == self:
                    setattr(old_value, "DiagramDescription476", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "DiagramDescription476"):
                opp_val = getattr(value, "DiagramDescription476", None)
                setattr(value, "DiagramDescription476", self)
...
class diagram_tool_CreateView(ContainerModelOperation):
    ...
    def diagram_tool_CreateView(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "DiagramElementMapping474"):
                opp_val = getattr(old_value, "DiagramElementMapping474", None)
                if opp_val == self:
                    setattr(old_value, "DiagramElementMapping474", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "DiagramElementMapping474"):
                opp_val = getattr(value, "DiagramElementMapping474", None)
                setattr(value, "DiagramElementMapping474", self)
...
class diagram_tool_BehaviorTool(AbstractToolDescription):
    ...
    def diagram_tool_BehaviorTool(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tool_InitialOperation472"):
                opp_val = getattr(old_value, "tool_InitialOperation472", None)
                if opp_val == self:
                    setattr(old_value, "tool_InitialOperation472", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tool_InitialOperation472"):
                opp_val = getattr(value, "tool_InitialOperation472", None)
                setattr(value, "tool_InitialOperation472", self)
...
class diagram_tool_ReconnectEdgeDescription(MappingBasedToolDescription):
    ...
    def __init__(self, reconnectionKind: str, diagram_tool_ReconnectEdgeDescription: "tool_SourceEdgeCreationVariable" = None, diagram_tool_ReconnectEdgeDescription451: "tool_TargetEdgeCreationVariable" = None, diagram_tool_ReconnectEdgeDescription454: "tool_SourceEdgeViewCreationVariable" = None, diagram_tool_ReconnectEdgeDescription457: "tool_TargetEdgeViewCreationVariable" = None, diagram_tool_ReconnectEdgeDescription460: "tool_ElementSelectVariable" = None, diagram_tool_ReconnectEdgeDescription465: "tool_ElementSelectVariable" = None, diagram_tool_ReconnectEdgeDescription462: "tool_InitialOperation" = None):
        self.reconnectionKind = reconnectionKind
        self.diagram_tool_ReconnectEdgeDescription = diagram_tool_ReconnectEdgeDescription
        self.diagram_tool_ReconnectEdgeDescription451 = diagram_tool_ReconnectEdgeDescription451
        self.diagram_tool_ReconnectEdgeDescription454 = diagram_tool_ReconnectEdgeDescription454
        self.diagram_tool_ReconnectEdgeDescription457 = diagram_tool_ReconnectEdgeDescription457
        self.diagram_tool_ReconnectEdgeDescription460 = diagram_tool_ReconnectEdgeDescription460
        self.diagram_tool_ReconnectEdgeDescription465 = diagram_tool_ReconnectEdgeDescription465
        self.diagram_tool_ReconnectEdgeDescription462 = diagram_tool_ReconnectEdgeDescription462
    ...
    @property
    def diagram_tool_ReconnectEdgeDescription457(self):
        return self.__diagram_tool_ReconnectEdgeDescription457

    @diagram_tool_ReconnectEdgeDescription457.setter
    def diagram_tool_ReconnectEdgeDescription457(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_diagram_tool_ReconnectEdgeDescription__diagram_tool_ReconnectEdgeDescription457", None)
        self.__diagram_tool_ReconnectEdgeDescription457 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tool_TargetEdgeViewCreationVariable458"):
                opp_val = getattr(old_value, "tool_TargetEdgeViewCreationVariable458", None)
                if opp_val == self:
                    setattr(old_value, "tool_TargetEdgeViewCreationVariable458", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tool_TargetEdgeViewCreationVariable458"):
                opp_val = getattr(value, "tool_TargetEdgeViewCreationVariable458", None)
                setattr(value, "tool_TargetEdgeViewCreationVariable458", self)

    @property
    def diagram_tool_ReconnectEdgeDescription454(self):
        return self.__diagram_tool_ReconnectEdgeDescription454

    @diagram_tool_ReconnectEdgeDescription454.setter
    def diagram_tool_ReconnectEdgeDescription454(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_diagram_tool_ReconnectEdgeDescription__diagram_tool_ReconnectEdgeDescription454", None)
        self.__diagram_tool_ReconnectEdgeDescription454 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tool_SourceEdgeViewCreationVariable455"):
                opp_val = getattr(old_value, "tool_SourceEdgeViewCreationVariable455", None)
                if opp_val == self:
                    setattr(old_value, "tool_SourceEdgeViewCreationVariable455", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tool_SourceEdgeViewCreationVariable455"):
                opp_val = getattr(value, "tool_SourceEdgeViewCreationVariable455", None)
                setattr(value, "tool_SourceEdgeViewCreationVariable455", self)

    @property
    def diagram_tool_ReconnectEdgeDescription451(self):
        return self.__diagram_tool_ReconnectEdgeDescription451

    @diagram_tool_ReconnectEdgeDescription451.setter
    def diagram_tool_ReconnectEdgeDescription451(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_diagram_tool_ReconnectEdgeDescription__diagram_tool_ReconnectEdgeDescription451", None)
        self.__diagram_tool_ReconnectEdgeDescription451 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tool_TargetEdgeCreationVariable452"):
                opp_val = getattr(old_value, "tool_TargetEdgeCreationVariable452", None)
                if opp_val == self:
                    setattr(old_value, "tool_TargetEdgeCreationVariable452", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tool_TargetEdgeCreationVariable452"):
                opp_val = getattr(value, "tool_TargetEdgeCreationVariable452", None)
                setattr(value, "tool_TargetEdgeCreationVariable452", self)

    @property
    def diagram_tool_ReconnectEdgeDescription465(self):
        return self.__diagram_tool_ReconnectEdgeDescription465

    @diagram_tool_ReconnectEdgeDescription465.setter
    def diagram_tool_ReconnectEdgeDescription465(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_diagram_tool_ReconnectEdgeDescription__diagram_tool_ReconnectEdgeDescription465", None)
        self.__diagram_tool_ReconnectEdgeDescription465 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tool_ElementSelectVariable466"):
                opp_val = getattr(old_value, "tool_ElementSelectVariable466", None)
                if opp_val == self:
                    setattr(old_value, "tool_ElementSelectVariable466", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tool_ElementSelectVariable466"):
                opp_val = getattr(value, "tool_ElementSelectVariable466", None)
                setattr(value, "tool_ElementSelectVariable466", self)
    ...
    def diagram_tool_ReconnectEdgeDescription(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tool_SourceEdgeCreationVariable449"):
                opp_val = getattr(old_value, "tool_SourceEdgeCreationVariable449", None)
                if opp_val == self:
                    setattr(old_value, "tool_SourceEdgeCreationVariable449", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tool_SourceEdgeCreationVariable449"):
                opp_val = getattr(value, "tool_SourceEdgeCreationVariable449", None)
                setattr(value, "tool_SourceEdgeCreationVariable449", self)

    @property
    def diagram_tool_ReconnectEdgeDescription462(self):
        return self.__diagram_tool_ReconnectEdgeDescription462

    @diagram_tool_ReconnectEdgeDescription462.setter
    def diagram_tool_ReconnectEdgeDescription462(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_diagram_tool_ReconnectEdgeDescription__diagram_tool_ReconnectEdgeDescription462", None)
        self.__diagram_tool_ReconnectEdgeDescription462 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tool_InitialOperation463"):
                opp_val = getattr(old_value, "tool_InitialOperation463", None)
                if opp_val == self:
                    setattr(old_value, "tool_InitialOperation463", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tool_InitialOperation463"):
                opp_val = getattr(value, "tool_InitialOperation463", None)
                setattr(value, "tool_InitialOperation463", self)

    @property
    def diagram_tool_ReconnectEdgeDescription460(self):
        return self.__diagram_tool_ReconnectEdgeDescription460

    @diagram_tool_ReconnectEdgeDescription460.setter
    def diagram_tool_ReconnectEdgeDescription460(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_diagram_tool_ReconnectEdgeDescription__diagram_tool_ReconnectEdgeDescription460", None)
        self.__diagram_tool_ReconnectEdgeDescription460 = value
...
class diagram_tool_EdgeCreationDescription(MappingBasedToolDescription):
    ...
    def getBestMapping(self, diagram_source, diagram_target, diagram_createdElements) :
        # TODO: Implement getBestMapping method
        pass

class diagram_tool_ContainerCreationDescription(MappingBasedToolDescription):

    def __init__(self, iconPath: str, diagram_tool_ContainerCreationDescription418: "tool_ContainerViewVariable" = None, diagram_tool_ContainerCreationDescription421: "tool_InitialNodeCreationOperation" = None, diagram_tool_ContainerCreationDescription424: set["AbstractNodeMapping"] = None, diagram_tool_ContainerCreationDescription: set["ContainerMapping"] = None, diagram_tool_ContainerCreationDescription415: "tool_NodeCreationVariable" = None):
        self.iconPath = iconPath
...
class diagram_tool_ContainerDropDescription(MappingBasedToolDescription):
    ...
    def __init__(self, dragSource: str, moveEdges: bool, diagram_tool_ContainerDropDescription484: "tool_DropContainerVariable" = None, diagram_tool_ContainerDropDescription486: "tool_DropContainerVariable" = None, diagram_tool_ContainerDropDescription489: "tool_ElementDropVariable" = None, diagram_tool_ContainerDropDescription491: "tool_ContainerViewVariable" = None, diagram_tool_ContainerDropDescription494: "tool_InitialContainerDropOperation" = None, diagram_tool_ContainerDropDescription: set["DiagramElementMapping"] = None):
        self.dragSource = dragSource
        self.moveEdges = moveEdges
        self.diagram_tool_ContainerDropDescription484 = diagram_tool_ContainerDropDescription484
        self.diagram_tool_ContainerDropDescription486 = diagram_tool_ContainerDropDescription486
        self.diagram_tool_ContainerDropDescription489 = diagram_tool_ContainerDropDescription489
        self.diagram_tool_ContainerDropDescription491 = diagram_tool_ContainerDropDescription491
        self.diagram_tool_ContainerDropDescription494 = diagram_tool_ContainerDropDescription494
    ...
    @property
    def diagram_tool_ContainerDropDescription491(self):
        return self.__diagram_tool_ContainerDropDescription491

    @diagram_tool_ContainerDropDescription491.setter
    def diagram_tool_ContainerDropDescription491(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_diagram_tool_ContainerDropDescription__diagram_tool_ContainerDropDescription491", None)
        self.__diagram_tool_ContainerDropDescription491 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tool_ContainerViewVariable492"):
                opp_val = getattr(old_value, "tool_ContainerViewVariable492", None)
                if opp_val == self:
                    setattr(old_value, "tool_ContainerViewVariable492", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tool_ContainerViewVariable492"):
                opp_val = getattr(value, "tool_ContainerViewVariable492", None)
                setattr(value, "tool_ContainerViewVariable492", self)

    @property
    def diagram_tool_ContainerDropDescription494(self):
        return self.__diagram_tool_ContainerDropDescription494

    @diagram_tool_ContainerDropDescription494.setter
    def diagram_tool_ContainerDropDescription494(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_diagram_tool_ContainerDropDescription__diagram_tool_ContainerDropDescription494", None)
        self.__diagram_tool_ContainerDropDescription494 = value
    ...
    @property
    def diagram_tool_ContainerDropDescription484(self):
        return self.__diagram_tool_ContainerDropDescription484

    @diagram_tool_ContainerDropDescription484.setter
    def diagram_tool_ContainerDropDescription484(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_diagram_tool_ContainerDropDescription__diagram_tool_ContainerDropDescription484", None)
        self.__diagram_tool_ContainerDropDescription484 = value
    ...
    def diagram_tool_ContainerDropDescription(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "DiagramElementMapping482"):
                    opp_val = getattr(item, "DiagramElementMapping482", None)
                    
                    if opp_val == self:
                        setattr(item, "DiagramElementMapping482", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "DiagramElementMapping482"):
                    ...
                    setattr(item, "DiagramElementMapping482", self)
                    

    @property
    def diagram_tool_ContainerDropDescription486(self):
        return self.__diagram_tool_ContainerDropDescription486

    @diagram_tool_ContainerDropDescription486.setter
    def diagram_tool_ContainerDropDescription486(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_diagram_tool_ContainerDropDescription__diagram_tool_ContainerDropDescription486", None)
        self.__diagram_tool_ContainerDropDescription486 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tool_DropContainerVariable487"):
                opp_val = getattr(old_value, "tool_DropContainerVariable487", None)
                if opp_val == self:
                    setattr(old_value, "tool_DropContainerVariable487", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tool_DropContainerVariable487"):
                opp_val = getattr(value, "tool_DropContainerVariable487", None)
                setattr(value, "tool_DropContainerVariable487", self)

    @property
    def diagram_tool_ContainerDropDescription489(self):
        return self.__diagram_tool_ContainerDropDescription489

    @diagram_tool_ContainerDropDescription489.setter
    def diagram_tool_ContainerDropDescription489(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_diagram_tool_ContainerDropDescription__diagram_tool_ContainerDropDescription489", None)
        self.__diagram_tool_ContainerDropDescription489 = value
    ...
    def getBestMapping(self, diagram_droppedElement, diagram_targetContainer) :
        # TODO: Implement getBestMapping method
        pass
...
class diagram_tool_DirectEditLabel(MappingBasedToolDescription):
    ...
    def __init__(self, inputLabelExpression: str, diagram_tool_DirectEditLabel: "tool_EditMaskVariables" = None, diagram_tool_DirectEditLabel469: "tool_InitialOperation" = None):
        self.inputLabelExpression = inputLabelExpression
        self.diagram_tool_DirectEditLabel = diagram_tool_DirectEditLabel
        self.diagram_tool_DirectEditLabel469 = diagram_tool_DirectEditLabel469
    ...
    @property
    def diagram_tool_DirectEditLabel469(self):
        return self.__diagram_tool_DirectEditLabel469

    @diagram_tool_DirectEditLabel469.setter
    def diagram_tool_DirectEditLabel469(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_diagram_tool_DirectEditLabel__diagram_tool_DirectEditLabel469", None)
        self.__diagram_tool_DirectEditLabel469 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "tool_InitialOperation470"):
                opp_val = getattr(old_value, "tool_InitialOperation470", None)
                if opp_val == self:
                    setattr(old_value, "tool_InitialOperation470", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "tool_InitialOperation470"):
                opp_val = getattr(value, "tool_InitialOperation470", None)
                setattr(value, "tool_InitialOperation470", self)
...
class diagram_tool_NodeCreationDescription(MappingBasedToolDescription):
    ...
    def __init__(self, iconPath: str, diagram_tool_NodeCreationDescription: set["NodeMapping"] = None, diagram_tool_NodeCreationDescription386: "tool_NodeCreationVariable" = None, diagram_tool_NodeCreationDescription388: "tool_ContainerViewVariable" = None, diagram_tool_NodeCreationDescription390: "tool_InitialNodeCreationOperation" = None, diagram_tool_NodeCreationDescription392: set["AbstractNodeMapping"] = None):
        self.iconPath = iconPath
...
class style_BorderedStyleDescription:
    ...
    pass
class diagram_style_ContainerStyleDescription(style_BorderedStyleDescription, style_TooltipStyleDescription, style_RoundedCornerStyleDescription, style_LabelStyleDescription):
...
class diagram_style_EdgeStyleDescription(StyleDescription):
    ...
    def __init__(self, lineStyle: str, sourceArrow: str, routingStyle: str, foldingStyle: str, targetArrow: str, sizeComputationExpression: str, diagram_style_EdgeStyleDescription: "ColorDescription" = None, diagram_style_EdgeStyleDescription361: "style_BeginLabelStyleDescription" = None, diagram_style_EdgeStyleDescription363: "style_CenterLabelStyleDescription" = None, diagram_style_EdgeStyleDescription365: "style_EndLabelStyleDescription" = None):
...
class diagram_description_IEdgeMapping(ABC):
    ...
    def __init__(self):
        ...
        pass
    def getBestStyle(self, diagram_modelElement, diagram_containerVariable, diagram_viewVariable) :
...
class diagram_description_OrderedTreeLayout(Layout):
    ...
    def __init__(self, childrenExpression: str, diagram_description_OrderedTreeLayout: set["AbstractNodeMapping"] = None, Layout: "diagram_description_DiagramDescription" = None):
...
class diagram_description_CompositeLayout(Layout):
    ...
    def __init__(self, padding: int, direction: str, Layout: "diagram_description_DiagramDescription" = None):
...
class diagram_description_DiagramDescription(description_PasteTargetDescription, description_RepresentationDescription, description_DragAndDropTargetDescription):
    ...
    def __init__(self, domainClass: str, preconditionExpression: str, rootExpression: str, enablePopupBars: bool, diagram_description_DiagramDescription174: set["NodeMapping"] = None, diagram_description_DiagramDescription177: set["ContainerMapping"] = None, diagram_description_DiagramDescription180: "validation_ValidationSet" = None, diagram_description_DiagramDescription182: "concern_ConcernSet" = None, diagram_description_DiagramDescription: set["filter_FilterDescription"] = None, diagram_description_DiagramDescription172: set["EdgeMapping"] = None, diagram_description_DiagramDescription184: set["tool_AbstractToolDescription"] = None, diagram_description_DiagramDescription186: "concern_ConcernDescription" = None, diagram_description_DiagramDescription189: "tool_RepresentationCreationDescription" = None, diagram_description_DiagramDescription191: "Layout" = None, diagram_description_DiagramDescription193: "tool_InitialOperation" = None, diagram_description_DiagramDescription195: "Layer" = None, diagram_description_DiagramDescription198: set["AdditionalLayer"] = None, diagram_description_DiagramDescription200: set["Layer"] = None, diagram_description_DiagramDescription203: set["tool_AbstractToolDescription"] = None, diagram_description_DiagramDescription206: set["NodeMapping"] = None, diagram_description_DiagramDescription209: set["EdgeMapping"] = None, diagram_description_DiagramDescription212: set["EdgeMappingImport"] = None, diagram_description_DiagramDescription214: set["ContainerMapping"] = None, diagram_description_DiagramDescription217: set["DiagramElementMapping"] = None, diagram_description_DiagramDescription220: "tool_ToolSection" = None, diagram_description_DiagramDescription222: set["tool_AbstractToolDescription"] = None):
        self.domainClass = domainClass
...
class style_StyleDescription:
    ...
    pass
class diagram_style_NodeStyleDescription(style_LabelStyleDescription, style_TooltipStyleDescription, style_BorderedStyleDescription, style_StyleDescription):

    def __init__(self, sizeComputationExpression: str, labelPosition: str, hideLabelByDefault: bool, resizeKind: str, style_StyleDescription: "diagram_ComputedStyleDescriptionRegistry" = None, style_StyleDescription168: "diagram_ContainerVariable2StyleDescription" = None):
        self.sizeComputationExpression = sizeComputationExpression
...
class diagram_CenterLabelStyle(BasicLabelStyle):
    ...
    def setDescription(self, diagram_description):
...
class diagram_GaugeSection(Customizable):
    ...
    def __init__(self, min: str, max: str, value: str, label: str, diagram_GaugeSection: "diagram_RGBValues" = None, diagram_GaugeSection104: "diagram_RGBValues" = None, diagram_GaugeSection134: "diagram_GaugeCompositeStyle" = None):
        self.min = min
        self.max = max
        self.value = value
        self.label = label
...
class diagram_Ellipse(NodeStyle):
    ...
    def __init__(self, horizontalDiameter: str, verticalDiameter: str, diagram_Ellipse: "diagram_RGBValues" = None):
...
class diagram_EdgeStyle(Style):
    ...
    def __init__(self, lineStyle: str, sourceArrow: str, targetArrow: str, foldingStyle: str, size: str, routingStyle: str, diagram_EdgeStyle: "diagram_DEdge" = None, diagram_EdgeStyle130: "diagram_CenterLabelStyle" = None, diagram_EdgeStyle132: "diagram_EndLabelStyle" = None, diagram_EdgeStyle125: "diagram_RGBValues" = None, diagram_EdgeStyle128: "diagram_BeginLabelStyle" = None):
        self.lineStyle = lineStyle
        self.sourceArrow = sourceArrow
        self.targetArrow = targetArrow
        self.foldingStyle = foldingStyle
...
class ContainerMapping:
    ...
    pass
class diagram_ContainerStyle(Style, LabelStyle, BorderedStyle):
...
class diagram_Style:
    ...
    pass
class diagram_NodeStyle(Style, LabelStyle, BorderedStyle):
...
class diagram_description_AdditionalLayer(Layer):
    ...
    def __init__(self, activeByDefault: bool, optional: bool, Layer196: "diagram_description_DiagramDescription" = None, Layer201: "diagram_description_DiagramDescription" = None, Layer34: "diagram_DDiagramElement" = None, Layer: "diagram_DDiagram" = None):
...
class diagram_DEdge(EdgeTarget, DDiagramElement):
    ...
    def __init__(self, size: str, routingStyle: str, isFold: bool, isMockEdge: bool, arrangeConstraints: str, beginLabel: str, endLabel: str, diagram_DEdge: "diagram_DDiagram" = None, diagram_DEdge89: "diagram_EdgeStyle" = None, outgoingEdges: "diagram_EdgeTarget" = None, incomingEdges: "diagram_EdgeTarget" = None, diagram_DEdge94: "IEdgeMapping" = None, diagram_DEdge96: "diagram_Style" = None, diagram_DEdge99: set["diagram_EdgeTarget"] = None, DEdge: "diagram_EdgeTarget" = None, DEdge123: "diagram_EdgeTarget" = None):
        self.size = size
        self.routingStyle = routingStyle
        self.isFold = isFold
...
class diagram_DDiagramElementContainer(AbstractDNode, DContainer, EdgeTarget, DragAndDropTarget):

    def __init__(self, width: str, height: str, diagram_DDiagramElementContainer58: "diagram_DDiagramElementContainer" = None, diagram_DDiagramElementContainer56: set["diagram_DDiagramElementContainer"] = None, diagram_DDiagramElementContainer60: set["diagram_DDiagramElement"] = None, diagram_DDiagramElementContainer: "diagram_DDiagram" = None, diagram_DDiagramElementContainer54: set["diagram_DNode"] = None, diagram_DDiagramElementContainer63: "diagram_ContainerStyle" = None, diagram_DDiagramElementContainer65: "diagram_Style" = None, diagram_DDiagramElementContainer68: "ContainerMapping" = None, diagram_DDiagramElementContainer70: set["ContainerMapping"] = None):
        self.width = width
        self.height = height
    ...
    def getNodesFromMapping(self, diagram_mapping) :
        # TODO: Implement getNodesFromMapping method
        pass

    def getContainersFromMapping(self, diagram_mapping) :
...
class diagram_concern_ConcernDescription(description_DocumentedElement, description_IdentifiedElement):
    ...
    pass
class diagram_description_Layer(description_EndUserDocumentedElement, description_DocumentedElement, description_IdentifiedElement):

    def __init__(self, icon: str, diagram_description_Layer314: set["tool_AbstractToolDescription"] = None, diagram_description_Layer: set["NodeMapping"] = None, diagram_description_Layer302: set["EdgeMapping"] = None, diagram_description_Layer305: set["EdgeMappingImport"] = None, diagram_description_Layer308: set["ContainerMapping"] = None, diagram_description_Layer311: set["DiagramElementMapping"] = None, diagram_description_Layer317: set["tool_ToolSection"] = None, diagram_description_Layer320: set["tool_AbstractToolDescription"] = None, diagram_description_Layer323: "DecorationDescriptionsSet" = None, diagram_description_Layer325: set["EdgeMapping"] = None, diagram_description_Layer328: "Customization" = None):
        self.icon = icon
...
class DRepresentation:
    ...
    pass
class diagram_DDiagram(description_DocumentedElement, DragAndDropTarget, DValidable, DRepresentation, DContainer):

    def __init__(self, synchronized: bool, isInLayoutingMode: bool, headerHeight: int, diagram_DDiagram: set["diagram_DDiagramElement"] = None, diagram_DDiagram2: set["diagram_DDiagramElement"] = None, diagram_DDiagram5: "DiagramDescription" = None, diagram_DDiagram7: set["diagram_DEdge"] = None, diagram_DDiagram9: set["diagram_DNode"] = None, diagram_DDiagram11: set["diagram_DNodeListElement"] = None, diagram_DDiagram13: set["diagram_DDiagramElementContainer"] = None, diagram_DDiagram15: "concern_ConcernDescription" = None, diagram_DDiagram17: set["filter_FilterDescription"] = None, diagram_DDiagram19: set["filter_FilterDescription"] = None, diagram_DDiagram22: set["validation_ValidationRule"] = None, diagram_DDiagram24: set["tool_BehaviorTool"] = None, diagram_DDiagram26: "diagram_FilterVariableHistory" = None, diagram_DDiagram28: set["Layer"] = None, diagram_DDiagram30: set["diagram_DDiagramElement"] = None):
    ...
    def getEdgesFromMapping(self, diagram_mapping) :
...
class diagram_style_ShapeContainerStyleDescription(style_ContainerStyleDescription, style_SizeComputationContainerStyleDescription):
    ...
    def __init__(self, shape: str, diagram_style_ShapeContainerStyleDescription: "ColorDescription" = None, style_ContainerStyleDescription294: "diagram_description_ConditionalContainerStyleDescription" = None, style_ContainerStyleDescription: "diagram_description_ContainerMapping" = None):
        self.shape = shape
...
class diagram_style_WorkspaceImageDescription(style_ContainerStyleDescription, style_NodeStyleDescription):
    ...
    def __init__(self, workspacePath: str, style_NodeStyleDescription: "diagram_description_NodeMapping" = None, style_NodeStyleDescription290: "diagram_description_ConditionalNodeStyleDescription" = None, style_ContainerStyleDescription294: "diagram_description_ConditionalContainerStyleDescription" = None, style_ContainerStyleDescription: "diagram_description_ContainerMapping" = None):
        self.workspacePath = workspacePath
...
class diagram_description_ContainerMapping(description_AbstractNodeMapping, description_DragAndDropTargetDescription):
    ...
    def getBestStyle(self, diagram_modelElement, diagram_viewVariable, diagram_containerVariable) :
        # TODO: Implement getBestStyle method
        pass
...
class diagram_description_NodeMapping(description_AbstractNodeMapping, description_DragAndDropTargetDescription):
    ...
    def updateListElement(self, diagram_listElement):
        # TODO: Implement updateListElement method
        pass

    def getNodesCandidates(self, diagram_container, diagram_semanticOrigin, diagram_containerView) :
        # TODO: Implement getNodesCandidates method
        pass

    def updateNode(self, diagram_node):
        # TODO: Implement updateNode method
        pass

    def createNode(self, diagram_viewPoint, diagram_container, diagram_modelElement) :
...
class description_DiagramElementMapping:
    ...
    pass
class diagram_description_EdgeMapping(description_IEdgeMapping, description_DiagramElementMapping, description_DocumentedElement):

    def __init__(self, targetFinderExpression: str, sourceFinderExpression: str, targetExpression: str, domainClass: str, useDomainElement: bool, pathExpression: str, diagram_description_EdgeMapping274: set["DiagramElementMapping"] = None, diagram_description_EdgeMapping277: "style_EdgeStyleDescription" = None, diagram_description_EdgeMapping279: set["ConditionalEdgeStyleDescription"] = None, diagram_description_EdgeMapping: set["DiagramElementMapping"] = None, diagram_description_EdgeMapping281: set["tool_ReconnectEdgeDescription"] = None, diagram_description_EdgeMapping283: set["AbstractNodeMapping"] = None):
    ...
    def updateEdge(self, diagram_viewEdge):
        # TODO: Implement updateEdge method
        pass

    def getEdgeSourceCandidates(self, diagram_viewPoint, diagram_semanticOrigin) :
        # TODO: Implement getEdgeSourceCandidates method
        pass

    def getBestStyle(self, diagram_containerVariable, diagram_viewVariable, diagram_modelElement) :
        # TODO: Implement getBestStyle method
        pass

    def getEdgeTargetCandidates(self, diagram_containerView, diagram_container, diagram_semanticOrigin) :
        # TODO: Implement getEdgeTargetCandidates method
        pass

    def createEdge(self, diagram_source, diagram_container, diagram_target, diagram_semanticTarget) :
...
class diagram_description_AbstractNodeMapping(description_DiagramElementMapping, description_DocumentedElement):
    ...
    def findDNodeFromEObject(self, diagram_eObject) :
        # TODO: Implement findDNodeFromEObject method
        pass

    def addDoneNode(self, diagram_node):
...
class diagram_description_DiagramElementMapping(description_PasteTargetDescription, description_RepresentationElementMapping):
    ...
    def mappings(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_diagram_description_DiagramElementMapping__mappings", None)
    ...
    def isFrom(self, diagram_element) :
        # TODO: Implement isFrom method
        pass

    def checkPrecondition(self, diagram_container, diagram_containerView, diagram_modelElement) :
