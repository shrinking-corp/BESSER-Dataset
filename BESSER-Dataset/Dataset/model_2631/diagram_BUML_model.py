...
diagram_RGBValues = Class(name="diagram_RGBValues")
...
diagram_FilterVariableValue = Class(name="diagram_FilterVariableValue")
...
diagram_DiagramElementMapping2ModelElement = Class(name="diagram_DiagramElementMapping2ModelElement")
concern_ConcernSet = Class(name="concern_ConcernSet")
diagram_ModelElement2ViewVariable = Class(name="diagram_ModelElement2ViewVariable")
diagram_ViewVariable2ContainerVariable = Class(name="diagram_ViewVariable2ContainerVariable")
diagram_ContainerVariable2StyleDescription = Class(name="diagram_ContainerVariable2StyleDescription")
...
diagram_filter_FilterVariable = Class(name="diagram_filter_FilterVariable")
...
diagram_DEdge.attributes={diagram_DEdge_endLabel, diagram_DEdge_routingStyle, diagram_DEdge_isMockEdge, diagram_DEdge_size, diagram_DEdge_arrangeConstraints, diagram_DEdge_beginLabel, diagram_DEdge_isFold}
...
diagram_AbsoluteBoundsFilter.attributes={diagram_AbsoluteBoundsFilter_y, diagram_AbsoluteBoundsFilter_width, diagram_AbsoluteBoundsFilter_x, diagram_AbsoluteBoundsFilter_height}
...
diagram_NodeStyle.attributes={diagram_NodeStyle_labelPosition, diagram_NodeStyle_hideLabelByDefault}
...
diagram_EdgeStyle.attributes={diagram_EdgeStyle_size, diagram_EdgeStyle_routingStyle, diagram_EdgeStyle_targetArrow, diagram_EdgeStyle_lineStyle, diagram_EdgeStyle_sourceArrow, diagram_EdgeStyle_foldingStyle}
...
diagram_GaugeSection.attributes={diagram_GaugeSection_label, diagram_GaugeSection_max, diagram_GaugeSection_value, diagram_GaugeSection_min}
...
diagram_description_DiagramElementMapping_m_checkPrecondition: Method = Method(name="checkPrecondition", parameters={Parameter(name='diagram_modelElement', type=StringType), Parameter(name='diagram_containerView', type=StringType), Parameter(name='diagram_container', type=StringType)}, type=BooleanType)
...
diagram_description_DiagramElementMapping.attributes={diagram_description_DiagramElementMapping_semanticCandidatesExpression, diagram_description_DiagramElementMapping_synchronizationLock, diagram_description_DiagramElementMapping_semanticElements, diagram_description_DiagramElementMapping_preconditionExpression, diagram_description_DiagramElementMapping_createElements}
...
diagram_description_AbstractNodeMapping.methods={diagram_description_AbstractNodeMapping_m_findDNodeFromEObject, diagram_description_AbstractNodeMapping_m_clearDNodesDone, diagram_description_AbstractNodeMapping_m_addDoneNode, diagram_description_AbstractNodeMapping_m_getAllBorderedNodeMappings}
...
diagram_description_NodeMapping_m_createNode: Method = Method(name="createNode", parameters={Parameter(name='diagram_container', type=StringType), Parameter(name='diagram_modelElement', type=StringType), Parameter(name='diagram_viewPoint', type=StringType)}, type=StringType)
...
diagram_description_NodeMapping_m_getNodesCandidates: Method = Method(name="getNodesCandidates", parameters={Parameter(name='diagram_container', type=StringType), Parameter(name='diagram_semanticOrigin', type=StringType)}, type=StringType)
diagram_description_NodeMapping_m_getNodesCandidates: Method = Method(name="getNodesCandidates", parameters={Parameter(name='diagram_semanticOrigin', type=StringType), Parameter(name='diagram_container', type=StringType), Parameter(name='diagram_containerView', type=StringType)}, type=StringType)
diagram_description_NodeMapping.methods={diagram_description_NodeMapping_m_getNodesCandidates, diagram_description_NodeMapping_m_updateListElement, diagram_description_NodeMapping_m_updateNode, diagram_description_NodeMapping_m_createNode, diagram_description_NodeMapping_m_getNodesCandidates}
...
diagram_description_ContainerMapping_m_getBestStyle: Method = Method(name="getBestStyle", parameters={Parameter(name='diagram_containerVariable', type=StringType), Parameter(name='diagram_viewVariable', type=StringType), Parameter(name='diagram_modelElement', type=StringType)}, type=ContainerStyle)
...
diagram_description_EdgeMapping_m_createEdge: Method = Method(name="createEdge", parameters={Parameter(name='diagram_source', type=StringType), Parameter(name='diagram_target', type=StringType), Parameter(name='diagram_semanticTarget', type=StringType)}, type=StringType)
diagram_description_EdgeMapping_m_createEdge: Method = Method(name="createEdge", parameters={Parameter(name='diagram_target', type=StringType), Parameter(name='diagram_source', type=StringType), Parameter(name='diagram_container', type=StringType), Parameter(name='diagram_semanticTarget', type=StringType)}, type=StringType)
diagram_description_EdgeMapping_m_getBestStyle: Method = Method(name="getBestStyle", parameters={Parameter(name='diagram_modelElement', type=StringType), Parameter(name='diagram_viewVariable', type=StringType), Parameter(name='diagram_containerVariable', type=StringType)}, type=EdgeStyle)
...
diagram_description_EdgeMapping_m_getEdgeSourceCandidates: Method = Method(name="getEdgeSourceCandidates", parameters={Parameter(name='diagram_semanticOrigin', type=StringType), Parameter(name='diagram_viewPoint', type=StringType)}, type=StringType)
diagram_description_EdgeMapping_m_getEdgeTargetCandidates: Method = Method(name="getEdgeTargetCandidates", parameters={Parameter(name='diagram_container', type=StringType), Parameter(name='diagram_semanticOrigin', type=StringType), Parameter(name='diagram_containerView', type=StringType)}, type=StringType)
diagram_description_EdgeMapping.attributes={diagram_description_EdgeMapping_sourceFinderExpression, diagram_description_EdgeMapping_pathExpression, diagram_description_EdgeMapping_domainClass, diagram_description_EdgeMapping_targetFinderExpression, diagram_description_EdgeMapping_useDomainElement, diagram_description_EdgeMapping_targetExpression}
diagram_description_EdgeMapping.methods={diagram_description_EdgeMapping_m_createEdge, diagram_description_EdgeMapping_m_getEdgeTargetCandidates, diagram_description_EdgeMapping_m_createEdge, diagram_description_EdgeMapping_m_getEdgeTargetCandidates, diagram_description_EdgeMapping_m_getEdgeSourceCandidates, diagram_description_EdgeMapping_m_updateEdge, diagram_description_EdgeMapping_m_getBestStyle}
...
diagram_style_NodeStyleDescription.attributes={diagram_style_NodeStyleDescription_labelPosition, diagram_style_NodeStyleDescription_sizeComputationExpression, diagram_style_NodeStyleDescription_hideLabelByDefault, diagram_style_NodeStyleDescription_resizeKind}
...
diagram_style_GaugeSectionDescription.attributes={diagram_style_GaugeSectionDescription_maxValueExpression, diagram_style_GaugeSectionDescription_valueExpression, diagram_style_GaugeSectionDescription_minValueExpression, diagram_style_GaugeSectionDescription_label}
...
diagram_style_EdgeStyleDescription.attributes={diagram_style_EdgeStyleDescription_lineStyle, diagram_style_EdgeStyleDescription_targetArrow, diagram_style_EdgeStyleDescription_routingStyle, diagram_style_EdgeStyleDescription_sourceArrow, diagram_style_EdgeStyleDescription_sizeComputationExpression, diagram_style_EdgeStyleDescription_foldingStyle}
...
diagram_tool_EdgeCreationDescription_m_getBestMapping: Method = Method(name="getBestMapping", parameters={Parameter(name='diagram_target', type=StringType), Parameter(name='diagram_source', type=StringType), Parameter(name='diagram_createdElements', type=StringType)}, type=StringType)
...
diagram_filter_VariableFilter_m_setFilterContext: Method = Method(name="setFilterContext", parameters={Parameter(name='diagram_variables', type=StringType)})
...
mappings438: BinaryAssociation = BinaryAssociation(
    name="mappings438",
    ends={
        Property(name="DiagramElementMapping439", type=diagram_tool_DoubleClickDescription, multiplicity=Multiplicity(1, 1)),
...
parameters447: BinaryAssociation = BinaryAssociation(
    name="parameters447",
    ends={
...
source448: BinaryAssociation = BinaryAssociation(
    name="source448",
    ends={
        Property(name="tool_SourceEdgeCreationVariable449", type=diagram_tool_ReconnectEdgeDescription, multiplicity=Multiplicity(1, 1)),
...
target450: BinaryAssociation = BinaryAssociation(
    name="target450",
    ends={
        Property(name="tool_TargetEdgeCreationVariable452", type=diagram_tool_ReconnectEdgeDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ReconnectEdgeDescription451", type=tool_TargetEdgeCreationVariable, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
sourceView453: BinaryAssociation = BinaryAssociation(
    name="sourceView453",
    ends={
        Property(name="tool_SourceEdgeViewCreationVariable455", type=diagram_tool_ReconnectEdgeDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ReconnectEdgeDescription454", type=tool_SourceEdgeViewCreationVariable, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
targetView456: BinaryAssociation = BinaryAssociation(
    name="targetView456",
    ends={
        Property(name="tool_TargetEdgeViewCreationVariable458", type=diagram_tool_ReconnectEdgeDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ReconnectEdgeDescription457", type=tool_TargetEdgeViewCreationVariable, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
element459: BinaryAssociation = BinaryAssociation(
    name="element459",
    ends={
        Property(name="tool_ElementSelectVariable", type=diagram_tool_ReconnectEdgeDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ReconnectEdgeDescription460", type=tool_ElementSelectVariable, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
element440: BinaryAssociation = BinaryAssociation(
    name="element440",
    ends={
...
elementView441: BinaryAssociation = BinaryAssociation(
    name="elementView441",
    ends={
        Property(name="tool_ElementDoubleClickVariable443", type=diagram_tool_DoubleClickDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_DoubleClickDescription442", type=tool_ElementDoubleClickVariable, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
initialOperation444: BinaryAssociation = BinaryAssociation(
    name="initialOperation444",
    ends={
        Property(name="tool_InitialOperation446", type=diagram_tool_DoubleClickDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_DoubleClickDescription445", type=tool_InitialOperation, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
edgeView464: BinaryAssociation = BinaryAssociation(
    name="edgeView464",
    ends={
        Property(name="tool_ElementSelectVariable466", type=diagram_tool_ReconnectEdgeDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ReconnectEdgeDescription465", type=tool_ElementSelectVariable, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
mask467: BinaryAssociation = BinaryAssociation(
    name="mask467",
    ends={
...
initialOperation468: BinaryAssociation = BinaryAssociation(
    name="initialOperation468",
    ends={
        Property(name="tool_InitialOperation470", type=diagram_tool_DirectEditLabel, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_DirectEditLabel469", type=tool_InitialOperation, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
initialOperation461: BinaryAssociation = BinaryAssociation(
    name="initialOperation461",
    ends={
        Property(name="tool_InitialOperation463", type=diagram_tool_ReconnectEdgeDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ReconnectEdgeDescription462", type=tool_InitialOperation, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
mapping473: BinaryAssociation = BinaryAssociation(
    name="mapping473",
    ends={
        Property(name="DiagramElementMapping474", type=diagram_tool_CreateView, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_CreateView", type=DiagramElementMapping, multiplicity=Multiplicity(1, 1))
    }
)
diagramDescription475: BinaryAssociation = BinaryAssociation(
    name="diagramDescription475",
    ends={
        Property(name="DiagramDescription476", type=diagram_tool_Navigation, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_Navigation", type=DiagramDescription, multiplicity=Multiplicity(1, 1))
    }
)
diagramDescription477: BinaryAssociation = BinaryAssociation(
    name="diagramDescription477",
    ends={
        Property(name="DiagramDescription478", type=diagram_tool_DiagramCreationDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_DiagramCreationDescription", type=DiagramDescription, multiplicity=Multiplicity(1, 1))
    }
)
diagramDescription479: BinaryAssociation = BinaryAssociation(
    name="diagramDescription479",
    ends={
        Property(name="DiagramDescription480", type=diagram_tool_DiagramNavigationDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_DiagramNavigationDescription", type=DiagramDescription, multiplicity=Multiplicity(1, 1))
    }
)
initialOperation471: BinaryAssociation = BinaryAssociation(
    name="initialOperation471",
    ends={
        Property(name="tool_InitialOperation472", type=diagram_tool_BehaviorTool, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_BehaviorTool", type=tool_InitialOperation, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
oldContainer483: BinaryAssociation = BinaryAssociation(
    name="oldContainer483",
    ends={
        Property(name="tool_DropContainerVariable", type=diagram_tool_ContainerDropDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ContainerDropDescription484", type=tool_DropContainerVariable, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
newContainer485: BinaryAssociation = BinaryAssociation(
    name="newContainer485",
    ends={
        Property(name="tool_DropContainerVariable487", type=diagram_tool_ContainerDropDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ContainerDropDescription486", type=tool_DropContainerVariable, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
element488: BinaryAssociation = BinaryAssociation(
    name="element488",
    ends={
        Property(name="tool_ElementDropVariable", type=diagram_tool_ContainerDropDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ContainerDropDescription489", type=tool_ElementDropVariable, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
newViewContainer490: BinaryAssociation = BinaryAssociation(
    name="newViewContainer490",
    ends={
        Property(name="tool_ContainerViewVariable492", type=diagram_tool_ContainerDropDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ContainerDropDescription491", type=tool_ContainerViewVariable, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
initialOperation493: BinaryAssociation = BinaryAssociation(
    name="initialOperation493",
    ends={
        ...
        Property(name="diagram_tool_ContainerDropDescription494", type=tool_InitialContainerDropOperation, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
mappings481: BinaryAssociation = BinaryAssociation(
    name="mappings481",
    ends={
        Property(name="DiagramElementMapping482", type=diagram_tool_ContainerDropDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_tool_ContainerDropDescription", type=DiagramElementMapping, multiplicity=Multiplicity(0, 9999))
    }
)
filters497: BinaryAssociation = BinaryAssociation(
    name="filters497",
    ends={
...
ownedVariables498: BinaryAssociation = BinaryAssociation(
    name="ownedVariables498",
    ends={
        Property(name="filter_FilterVariable499", type=diagram_filter_VariableFilter, multiplicity=Multiplicity(1, 1)),
...
ownedConcernDescriptions500: BinaryAssociation = BinaryAssociation(
    name="ownedConcernDescriptions500",
    ends={
        Property(name="concern_ConcernDescription501", type=diagram_concern_ConcernSet, multiplicity=Multiplicity(1, 1)),
...
mappings495: BinaryAssociation = BinaryAssociation(
    name="mappings495",
    ends={
        Property(name="DiagramElementMapping496", type=diagram_filter_MappingFilter, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_filter_MappingFilter", type=DiagramElementMapping, multiplicity=Multiplicity(0, 9999))
    }
)
filters502: BinaryAssociation = BinaryAssociation(
    name="filters502",
    ends={
        Property(name="filter_FilterDescription503", type=diagram_concern_ConcernDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_concern_ConcernDescription", type=filter_FilterDescription, multiplicity=Multiplicity(0, 9999))
    }
)
rules504: BinaryAssociation = BinaryAssociation(
    name="rules504",
    ends={
        Property(name="validation_ValidationRule506", type=diagram_concern_ConcernDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_concern_ConcernDescription505", type=validation_ValidationRule, multiplicity=Multiplicity(0, 9999))
    }
)
behaviors507: BinaryAssociation = BinaryAssociation(
    name="behaviors507",
    ends={
        Property(name="tool_BehaviorTool509", type=diagram_concern_ConcernDescription, multiplicity=Multiplicity(1, 1)),
        Property(name="diagram_concern_ConcernDescription508", type=tool_BehaviorTool, multiplicity=Multiplicity(0, 9999))
    }
)
...
domain_model = DomainModel(
    name="diagram",
    types={diagram_DDiagram, DRepresentation, description_DocumentedElement, DragAndDropTarget, DValidable, DContainer, diagram_DDiagramElement, DiagramDescription, diagram_DEdge, diagram_DNode, diagram_DNodeListElement, diagram_DDiagramElementContainer, concern_ConcernDescription, filter_FilterDescription, validation_ValidationRule, tool_BehaviorTool, diagram_FilterVariableHistory, Layer, diagram_DSemanticDiagram, DDiagram, DSemanticDecorator, DRepresentationElement, DNavigable, diagram_Decoration, DiagramElementMapping, diagram_GraphicalFilter, diagram_HideFilter, GraphicalFilter, diagram_HideLabelFilter, diagram_FoldingPointFilter, diagram_FoldingFilter, diagram_AppliedCompositeFilters, filter_CompositeFilterDescription, diagram_AbsoluteBoundsFilter, diagram_AbstractDNode, DDiagramElement, AbstractDNode, EdgeTarget, diagram_NodeStyle, diagram_Style, NodeMapping, diagram_DNodeList, diagram_ContainerStyle, ContainerMapping, diagram_DNodeContainer, DDiagramElementContainer, diagram_EdgeStyle, diagram_EdgeTarget, IEdgeMapping, LabelStyle, Style, BorderedStyle, diagram_Dot, NodeStyle, diagram_RGBValues, diagram_GaugeSection, Customizable, diagram_FlatContainerStyle, ContainerStyle, diagram_BundledImage, diagram_ShapeContainerStyle, diagram_Square, diagram_Ellipse, diagram_Lozenge, diagram_EndLabelStyle, diagram_WorkspaceImage, diagram_CustomStyle, diagram_BeginLabelStyle, diagram_CenterLabelStyle, diagram_Note, diagram_GaugeCompositeStyle, diagram_BorderedStyle, diagram_FilterVariableValue, filter_FilterVariable, diagram_EObject, diagram_CollapseFilter, diagram_IndirectlyCollapseFilter, CollapseFilter, BasicLabelStyle, diagram_BracketEdgeStyle, EdgeStyle, diagram_ComputedStyleDescriptionRegistry, style_StyleDescription, diagram_DiagramElementMapping2ModelElement, concern_ConcernSet, diagram_ModelElement2ViewVariable, diagram_ViewVariable2ContainerVariable, diagram_ContainerVariable2StyleDescription, diagram_DragAndDropTarget, diagram_description_DiagramDescription, description_DragAndDropTargetDescription, description_RepresentationDescription, description_PasteTargetDescription, EdgeMapping, validation_ValidationSet, tool_AbstractToolDescription, tool_RepresentationCreationDescription, Layout, tool_InitialOperation, AdditionalLayer, EdgeMappingImport, tool_ToolSection, diagram_description_DiagramImportDescription, description_RepresentationImportDescription, description_DiagramDescription, diagram_description_DiagramExtensionDescription, RepresentationExtensionDescription, diagram_description_DiagramElementMapping, description_RepresentationElementMapping, tool_DeleteElementDescription, tool_DirectEditLabel, tool_DoubleClickDescription, diagram_description_AbstractNodeMapping, description_DiagramElementMapping, diagram_description_NodeMapping, description_AbstractNodeMapping, style_NodeStyleDescription, ConditionalNodeStyleDescription, diagram_description_ContainerMapping, style_ContainerStyleDescription, ConditionalContainerStyleDescription, diagram_description_NodeMappingImport, description_NodeMapping, description_AbstractMappingImport, diagram_description_ContainerMappingImport, description_ContainerMapping, diagram_description_EdgeMapping, description_IEdgeMapping, style_EdgeStyleDescription, ConditionalEdgeStyleDescription, tool_ReconnectEdgeDescription, AbstractNodeMapping, diagram_description_IEdgeMapping, diagram_description_EdgeMappingImport, description_IdentifiedElement, diagram_description_ConditionalNodeStyleDescription, ConditionalStyleDescription, diagram_description_ConditionalEdgeStyleDescription, diagram_description_ConditionalContainerStyleDescription, diagram_description_Layout, DocumentedElement, diagram_description_OrderedTreeLayout, diagram_description_CompositeLayout, diagram_description_MappingBasedDecoration, DecorationDescription, diagram_description_Layer, description_EndUserDocumentedElement, diagram_style_CustomStyleDescription, NodeStyleDescription, DecorationDescriptionsSet, Customization, diagram_description_AdditionalLayer, diagram_description_DragAndDropTargetDescription, tool_ContainerDropDescription, diagram_style_BorderedStyleDescription, StyleDescription, ColorDescription, diagram_style_NodeStyleDescription, style_BorderedStyleDescription, style_LabelStyleDescription, style_TooltipStyleDescription, diagram_style_SquareDescription, diagram_style_LozengeNodeDescription, diagram_style_EllipseNodeDescription, diagram_style_GaugeCompositeStyleDescription, style_GaugeSectionDescription, diagram_style_GaugeSectionDescription, diagram_style_SizeComputationContainerStyleDescription, diagram_style_BundledImageDescription, diagram_style_NoteDescription, diagram_style_DotDescription, diagram_style_FlatContainerStyleDescription, style_SizeComputationContainerStyleDescription, style_LabelBorderStyleDescription, diagram_style_ShapeContainerStyleDescription, diagram_style_WorkspaceImageDescription, diagram_style_EdgeStyleDescription, diagram_style_RoundedCornerStyleDescription, diagram_style_ContainerStyleDescription, style_RoundedCornerStyleDescription, style_BeginLabelStyleDescription, style_CenterLabelStyleDescription, style_EndLabelStyleDescription, diagram_style_BeginLabelStyleDescription, BasicLabelStyleDescription, diagram_style_CenterLabelStyleDescription, diagram_style_EndLabelStyleDescription, diagram_style_BracketEdgeStyleDescription, EdgeStyleDescription, diagram_tool_ToolSection, tool_ToolEntry, tool_PopupMenu, diagram_tool_ToolGroupExtension, tool_ToolGroup, diagram_tool_NodeCreationDescription, MappingBasedToolDescription, tool_NodeCreationVariable, tool_ContainerViewVariable, tool_InitialNodeCreationOperation, tool_ToolGroupExtension, diagram_tool_ToolGroup, ToolEntry, tool_SourceEdgeCreationVariable, tool_TargetEdgeCreationVariable, tool_SourceEdgeViewCreationVariable, tool_TargetEdgeViewCreationVariable, tool_InitEdgeCreationOperation, diagram_tool_EdgeCreationDescription, diagram_tool_DeleteElementDescription, tool_ElementDeleteVariable, tool_DeleteHook, diagram_tool_DoubleClickDescription, diagram_tool_ContainerCreationDescription, tool_DeleteHookParameter, diagram_tool_DeleteHookParameter, diagram_tool_ReconnectEdgeDescription, tool_ElementSelectVariable, tool_ElementDoubleClickVariable, diagram_tool_DeleteHook, diagram_tool_RequestDescription, AbstractToolDescription, diagram_tool_DirectEditLabel, tool_EditMaskVariables, diagram_tool_BehaviorTool, diagram_tool_NodeCreationVariable, diagram_tool_CreateView, ContainerModelOperation, diagram_tool_CreateEdgeView, CreateView, diagram_tool_Navigation, diagram_tool_DiagramCreationDescription, RepresentationCreationDescription, diagram_tool_DiagramNavigationDescription, RepresentationNavigationDescription, diagram_tool_ContainerDropDescription, diagram_tool_SourceEdgeCreationVariable, tool_AbstractVariable, tool_VariableContainer, diagram_tool_SourceEdgeViewCreationVariable, diagram_tool_TargetEdgeCreationVariable, diagram_tool_TargetEdgeViewCreationVariable, diagram_tool_ElementDoubleClickVariable, tool_DropContainerVariable, tool_ElementDropVariable, tool_InitialContainerDropOperation, diagram_filter_FilterDescription, diagram_filter_Filter, diagram_filter_CompositeFilterDescription, FilterDescription, filter_Filter, diagram_filter_VariableFilter, diagram_filter_FilterVariable, SelectionDescription, diagram_concern_ConcernSet, diagram_concern_ConcernDescription, diagram_filter_MappingFilter, Filter, ContainerLayout, LabelPosition, ContainerShape, BackgroundStyle, BundledImageShape, LineStyle, EdgeArrows, EdgeRouting, AlignmentKind, ResizeKind, ArrangeConstraint, FoldingStyle, LayoutDirection, ReconnectionKind, FilterKind},
    associations={ownedDiagramElements0, diagramElements1, description4, edges6, nodes8, nodeListElements10, containers12, currentConcern14, activatedFilters16, allFilters18, activatedRules21, activateBehaviors23, filterVariableHistory25, activatedLayers27, hiddenElements29, parentLayers32, decorations35, diagramElementMapping37, graphicalFilters39, compositeFilterDescriptions41, ownedBorderedNodes42, ownedStyle44, originalStyle46, actualMapping48, candidatesMapping50, nodes53, containers57, elements59, ownedStyle62, originalStyle64, actualMapping67, candidatesMapping69, ownedDiagramElements72, ownedElements74, ownedStyle76, originalStyle79, actualMapping82, candidatesMapping85, ownedStyle88, sourceNode90, targetNode91, actualMapping93, originalStyle95, path98, backgroundColor100, backgroundColor101, foregroundColor103, backgroundColor106, foregroundColor108, backgroundColor111, color113, color115, color117, centerLabelStyle129, endLabelStyle131, color119, outgoingEdges121, incomingEdges122, strokeColor124, beginLabelStyle127, borderColor135, sections133, key148, color137, ownedValues139, variableDefinition141, modelElement143, computedStyleDescriptions145, cache146, concerns181, value151, key153, value156, key158, value161, key163, value166, filters169, allEdgeMappings171, allNodeMappings173, allContainerMappings176, validationSet179, allTools183, defaultConcern185, init188, layout190, diagramInitialisation192, defaultLayer194, additionalLayers197, allLayers199, allActivatedTools202, nodeMappings205, edgeMappings208, edgeMappingImports211, containerMappings213, reusedMappings216, toolSection219, reusedTools221, importedDiagram224, layers226, validationSet228, concerns231, deletionDescription234, labelDirectEdit235, doubleClickDescription237, borderedNodeMappings238, reusedBorderedNodeMappings240, style243, conditionnalStyles244, subNodeMappings246, allNodeMappings248, reusedNodeMappings251, subContainerMappings254, reusedContainerMappings257, allContainerMappings260, style263, conditionnalStyles265, importedMapping267, importedMapping269, sourceMapping271, targetMapping273, style276, conditionnalStyles278, reconnections280, pathNodeMapping282, importedMapping284, conditionnalStyles286, style289, style291, style293, allTools313, nodeMapping295, mappings297, nodeMappings299, edgeMappings301, edgeMappingImports304, containerMappings307, reusedMappings310, toolSections316, reusedTools319, decorationDescriptionsSet322, allEdgeMappings324, customization327, dropDescriptions329, borderColor330, color331, color333, color335, backgroundColor341, sections343, backgroundColor344, foregroundColor346, color337, color339, backgroundColor349, foregroundColor351, labelBorderStyle354, backgroundColor356, strokeColor358, beginLabelStyleDescription360, centerLabelStyleDescription362, endLabelStyleDescription364, ownedTools366, subSections367, popupMenus370, tools377, group379, tools380, nodeMappings383, variable385, viewVariable387, initialOperation389, extraMappings391, reusedTools372, groupExtensions375, edgeMappings394, sourceVariable396, targetVariable398, sourceViewVariable400, targetViewVariable402, initialOperation404, extraSourceMappings406, extraTargetMappings409, viewVariable417, initialOperation420, extraMappings423, element426, elementView427, containerView430, initialOperation433, hook436, mappings438, containerMappings412, variable414, parameters447, source448, target450, sourceView453, targetView456, element459, element440, elementView441, initialOperation444, edgeView464, mask467, initialOperation468, initialOperation461, mapping473, diagramDescription475, diagramDescription477, diagramDescription479, initialOperation471, oldContainer483, newContainer485, element488, newViewContainer490, initialOperation493, mappings481, filters497, ownedVariables498, ownedConcernDescriptions500, mappings495, filters502, rules504, behaviors507},
    generalizations={gen_diagram_DDiagram_DRepresentation, gen_diagram_DDiagram_description_DocumentedElement, gen_diagram_DDiagram_DragAndDropTarget, gen_diagram_DDiagram_DValidable, gen_diagram_DDiagram_DContainer, gen_diagram_DSemanticDiagram_DDiagram, gen_diagram_DSemanticDiagram_DSemanticDecorator, gen_diagram_DDiagramElement_DRepresentationElement, gen_diagram_DDiagramElement_DValidable, gen_diagram_DDiagramElement_DNavigable, gen_diagram_HideFilter_GraphicalFilter, gen_diagram_HideLabelFilter_GraphicalFilter, gen_diagram_FoldingPointFilter_GraphicalFilter, gen_diagram_FoldingFilter_GraphicalFilter, gen_diagram_AppliedCompositeFilters_GraphicalFilter, gen_diagram_AbsoluteBoundsFilter_GraphicalFilter, gen_diagram_AbstractDNode_DDiagramElement, gen_diagram_DNode_AbstractDNode, gen_diagram_DNode_EdgeTarget, gen_diagram_DNode_DragAndDropTarget, gen_diagram_DDiagramElementContainer_AbstractDNode, gen_diagram_DDiagramElementContainer_EdgeTarget, gen_diagram_DDiagramElementContainer_DragAndDropTarget, gen_diagram_DDiagramElementContainer_DContainer, gen_diagram_DNodeContainer_DDiagramElementContainer, gen_diagram_DNodeList_DDiagramElementContainer, gen_diagram_DNodeListElement_AbstractDNode, gen_diagram_DEdge_DDiagramElement, gen_diagram_DEdge_EdgeTarget, gen_diagram_NodeStyle_LabelStyle, gen_diagram_NodeStyle_Style, gen_diagram_NodeStyle_BorderedStyle, gen_diagram_Dot_NodeStyle, gen_diagram_GaugeSection_Customizable, gen_diagram_ContainerStyle_LabelStyle, gen_diagram_ContainerStyle_Style, gen_diagram_ContainerStyle_BorderedStyle, gen_diagram_FlatContainerStyle_ContainerStyle, gen_diagram_BundledImage_NodeStyle, gen_diagram_ShapeContainerStyle_ContainerStyle, gen_diagram_Square_NodeStyle, gen_diagram_Ellipse_NodeStyle, gen_diagram_Lozenge_NodeStyle, gen_diagram_WorkspaceImage_NodeStyle, gen_diagram_WorkspaceImage_ContainerStyle, gen_diagram_CustomStyle_NodeStyle, gen_diagram_EdgeStyle_Style, gen_diagram_Note_NodeStyle, gen_diagram_GaugeCompositeStyle_NodeStyle, gen_diagram_BorderedStyle_Style, gen_diagram_CollapseFilter_GraphicalFilter, gen_diagram_IndirectlyCollapseFilter_CollapseFilter, gen_diagram_BeginLabelStyle_BasicLabelStyle, gen_diagram_CenterLabelStyle_BasicLabelStyle, gen_diagram_EndLabelStyle_BasicLabelStyle, gen_diagram_BracketEdgeStyle_EdgeStyle, gen_diagram_description_DiagramDescription_description_DragAndDropTargetDescription, gen_diagram_description_DiagramDescription_description_RepresentationDescription, gen_diagram_description_DiagramDescription_description_PasteTargetDescription, gen_diagram_description_DiagramImportDescription_description_RepresentationImportDescription, gen_diagram_description_DiagramImportDescription_description_DiagramDescription, gen_diagram_description_DiagramExtensionDescription_RepresentationExtensionDescription, gen_diagram_description_DiagramElementMapping_description_RepresentationElementMapping, gen_diagram_description_DiagramElementMapping_description_PasteTargetDescription, gen_diagram_description_AbstractNodeMapping_description_DiagramElementMapping, gen_diagram_description_AbstractNodeMapping_description_DocumentedElement, gen_diagram_description_ContainerMapping_description_AbstractNodeMapping, gen_diagram_description_ContainerMapping_description_DragAndDropTargetDescription, gen_diagram_description_NodeMapping_description_AbstractNodeMapping, gen_diagram_description_NodeMapping_description_DragAndDropTargetDescription, gen_diagram_description_NodeMappingImport_description_NodeMapping, gen_diagram_description_NodeMappingImport_description_AbstractMappingImport, gen_diagram_description_ContainerMappingImport_description_ContainerMapping, gen_diagram_description_ContainerMappingImport_description_AbstractMappingImport, gen_diagram_description_EdgeMapping_description_DiagramElementMapping, gen_diagram_description_EdgeMapping_description_DocumentedElement, gen_diagram_description_EdgeMapping_description_IEdgeMapping, gen_diagram_description_EdgeMappingImport_description_DocumentedElement, gen_diagram_description_EdgeMappingImport_description_IEdgeMapping, gen_diagram_description_EdgeMappingImport_description_IdentifiedElement, gen_diagram_description_ConditionalNodeStyleDescription_ConditionalStyleDescription, gen_diagram_description_ConditionalEdgeStyleDescription_ConditionalStyleDescription, gen_diagram_description_ConditionalContainerStyleDescription_ConditionalStyleDescription, gen_diagram_description_Layout_DocumentedElement, gen_diagram_description_OrderedTreeLayout_Layout, gen_diagram_description_CompositeLayout_Layout, gen_diagram_description_MappingBasedDecoration_DecorationDescription, gen_diagram_description_Layer_description_DocumentedElement, gen_diagram_description_Layer_description_EndUserDocumentedElement, gen_diagram_description_Layer_description_IdentifiedElement, gen_diagram_style_CustomStyleDescription_NodeStyleDescription, gen_diagram_description_AdditionalLayer_Layer, gen_diagram_style_BorderedStyleDescription_StyleDescription, gen_diagram_style_NodeStyleDescription_style_StyleDescription, gen_diagram_style_NodeStyleDescription_style_BorderedStyleDescription, gen_diagram_style_NodeStyleDescription_style_LabelStyleDescription, gen_diagram_style_NodeStyleDescription_style_TooltipStyleDescription, gen_diagram_style_SquareDescription_NodeStyleDescription, gen_diagram_style_LozengeNodeDescription_NodeStyleDescription, gen_diagram_style_EllipseNodeDescription_NodeStyleDescription, gen_diagram_style_DotDescription_NodeStyleDescription, gen_diagram_style_GaugeCompositeStyleDescription_NodeStyleDescription, gen_diagram_style_BundledImageDescription_NodeStyleDescription, gen_diagram_style_NoteDescription_NodeStyleDescription, gen_diagram_style_FlatContainerStyleDescription_style_ContainerStyleDescription, gen_diagram_style_FlatContainerStyleDescription_style_SizeComputationContainerStyleDescription, gen_diagram_style_ShapeContainerStyleDescription_style_ContainerStyleDescription, gen_diagram_style_ShapeContainerStyleDescription_style_SizeComputationContainerStyleDescription, gen_diagram_style_WorkspaceImageDescription_style_NodeStyleDescription, gen_diagram_style_WorkspaceImageDescription_style_ContainerStyleDescription, gen_diagram_style_EdgeStyleDescription_StyleDescription, gen_diagram_style_RoundedCornerStyleDescription_StyleDescription, gen_diagram_style_ContainerStyleDescription_style_RoundedCornerStyleDescription, gen_diagram_style_ContainerStyleDescription_style_BorderedStyleDescription, gen_diagram_style_ContainerStyleDescription_style_LabelStyleDescription, gen_diagram_style_ContainerStyleDescription_style_TooltipStyleDescription, gen_diagram_style_BeginLabelStyleDescription_BasicLabelStyleDescription, gen_diagram_style_CenterLabelStyleDescription_BasicLabelStyleDescription, gen_diagram_style_EndLabelStyleDescription_BasicLabelStyleDescription, gen_diagram_style_BracketEdgeStyleDescription_EdgeStyleDescription, gen_diagram_tool_ToolSection_description_DocumentedElement, gen_diagram_tool_ToolSection_description_IdentifiedElement, gen_diagram_tool_NodeCreationDescription_MappingBasedToolDescription, gen_diagram_tool_ToolGroup_ToolEntry, gen_diagram_tool_EdgeCreationDescription_MappingBasedToolDescription, gen_diagram_tool_DeleteElementDescription_MappingBasedToolDescription, gen_diagram_tool_DoubleClickDescription_MappingBasedToolDescription, gen_diagram_tool_ContainerCreationDescription_MappingBasedToolDescription, gen_diagram_tool_ReconnectEdgeDescription_MappingBasedToolDescription, gen_diagram_tool_RequestDescription_AbstractToolDescription, gen_diagram_tool_DirectEditLabel_MappingBasedToolDescription, gen_diagram_tool_BehaviorTool_AbstractToolDescription, gen_diagram_tool_ElementDoubleClickVariable_tool_VariableContainer, gen_diagram_tool_NodeCreationVariable_tool_AbstractVariable, gen_diagram_tool_NodeCreationVariable_tool_VariableContainer, gen_diagram_tool_CreateView_ContainerModelOperation, gen_diagram_tool_CreateEdgeView_CreateView, gen_diagram_tool_Navigation_ContainerModelOperation, gen_diagram_tool_DiagramCreationDescription_RepresentationCreationDescription, gen_diagram_tool_DiagramNavigationDescription_RepresentationNavigationDescription, gen_diagram_tool_ContainerDropDescription_MappingBasedToolDescription, gen_diagram_tool_SourceEdgeCreationVariable_tool_AbstractVariable, gen_diagram_tool_SourceEdgeCreationVariable_tool_VariableContainer, gen_diagram_tool_SourceEdgeViewCreationVariable_tool_AbstractVariable, gen_diagram_tool_SourceEdgeViewCreationVariable_tool_VariableContainer, gen_diagram_tool_TargetEdgeCreationVariable_tool_AbstractVariable, gen_diagram_tool_TargetEdgeCreationVariable_tool_VariableContainer, gen_diagram_tool_TargetEdgeViewCreationVariable_tool_AbstractVariable, gen_diagram_tool_TargetEdgeViewCreationVariable_tool_VariableContainer, gen_diagram_tool_ElementDoubleClickVariable_tool_AbstractVariable, gen_diagram_filter_FilterDescription_description_DocumentedElement, gen_diagram_filter_FilterDescription_description_IdentifiedElement, gen_diagram_filter_CompositeFilterDescription_FilterDescription, gen_diagram_filter_VariableFilter_Filter, gen_diagram_filter_FilterVariable_SelectionDescription, gen_diagram_concern_ConcernSet_DocumentedElement, gen_diagram_concern_ConcernDescription_description_DocumentedElement, gen_diagram_concern_ConcernDescription_description_IdentifiedElement, gen_diagram_filter_MappingFilter_Filter},
    metadata=None
)
