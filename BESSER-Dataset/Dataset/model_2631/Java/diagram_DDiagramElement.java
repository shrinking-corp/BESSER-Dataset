...
public class diagram_DDiagramElement extends DValidable, DNavigable, DRepresentationElement {
    ...
    public diagram_DDiagramElement(
        boolean visible,        String tooltipText    ) {
        super(
        );
