...
class dbl_Variable(ModifierExtensionsContainer, AbstractVariable, Statement):
    ...
    def __init__(self, control: bool, clazz: bool, dbl_Variable86: "dbl_Expression" = None, dbl_Variable: "dbl_Module" = None, dbl_Variable30: "dbl_Annotation" = None, dbl_Variable46: "dbl_ClassSimilar" = None, dbl_Variable138: "dbl_ForEachStatement" = None):
...
class dbl_Procedure(NamedElement, TypedElement, AnnotatableElement, CodeBlock):
    ...
    def __init__(self, clazz: bool, dbl_Procedure49: "dbl_ClassSimilar" = None, dbl_Procedure81: "dbl_Interface" = None, dbl_Procedure: "dbl_Module" = None, dbl_Procedure27: set["dbl_Parameter"] = None):
        self.clazz = clazz
...
class dbl_Pattern(NamedElement):
    ...
    def __init__(self, top: bool, dbl_Pattern252: "dbl_IdResolution" = None, dbl_Pattern254: "dbl_Parameter" = None, dbl_Pattern272: "dbl_IncludePattern" = None, dbl_Pattern257: "dbl_CodeBlock" = None, dbl_Pattern: "dbl_ReferencePropertyType" = None):
        self.top = top
