...
# Classes
metrics_RuleSetMetrics = Class(name="metrics_RuleSetMetrics")
metrics_RuleMetrics = Class(name="metrics_RuleMetrics")
metrics_Rule = Class(name="metrics_Rule")
...
metrics_RuleSetMetrics_m_findRuleMetrics: Method = Method(name="findRuleMetrics", parameters={Parameter(name='metrics_rule', type=StringType)}, type=StringType)
metrics_RuleSetMetrics_m_createPresentationString: Method = Method(name="createPresentationString", parameters={}, type=StringType)
metrics_RuleSetMetrics.attributes={metrics_RuleSetMetrics_totalNumberOfAttributes, metrics_RuleSetMetrics_numberOfRules, metrics_RuleSetMetrics_totalNumberOfNodes, metrics_RuleSetMetrics_totalNumberOfEdges}
metrics_RuleSetMetrics.methods={metrics_RuleSetMetrics_m_findRuleMetrics, metrics_RuleSetMetrics_m_createPresentationString}
...
metrics_RuleMetrics.attributes={metrics_RuleMetrics_numberOfNodes, metrics_RuleMetrics_numberOfEdges, metrics_RuleMetrics_numberOfAttributes}
