...
def test_hyp_research23_action_is_not_abstract():
    assert not inspect.isabstract(research23_Action)


def test_hyp_research23_action_constructor_exists():
    assert callable(research23_Action.__init__)


def test_hyp_research23_action_constructor_args():
...
def test_hyp_research23_transition_is_not_abstract():
    assert not inspect.isabstract(research23_Transition)


def test_hyp_research23_transition_constructor_exists():
    assert callable(research23_Transition.__init__)


def test_hyp_research23_transition_constructor_args():
...
def test_hyp_research23_statemachineobject_is_not_abstract():
    assert not inspect.isabstract(research23_StateMachineObject)


def test_hyp_research23_statemachineobject_constructor_exists():
    assert callable(research23_StateMachineObject.__init__)


def test_hyp_research23_statemachineobject_constructor_args():
...
def test_hyp_research23_statemachinevariable_is_not_abstract():
    assert not inspect.isabstract(research23_StateMachineVariable)


def test_hyp_research23_statemachinevariable_constructor_exists():
    assert callable(research23_StateMachineVariable.__init__)


def test_hyp_research23_statemachinevariable_constructor_args():
    sig = inspect.signature(research23_StateMachineVariable.__init__)
    params = list(sig.parameters.keys())



def test_hyp_research23_publicationstatus_is_not_abstract():
    assert not inspect.isabstract(research23_PublicationStatus)


def test_hyp_research23_publicationstatus_constructor_exists():
    assert callable(research23_PublicationStatus.__init__)


def test_hyp_research23_publicationstatus_constructor_args():
...
def test_hyp_research23_labelled_is_not_abstract():
    assert not inspect.isabstract(research23_Labelled)


def test_hyp_research23_labelled_constructor_exists():
    assert callable(research23_Labelled.__init__)


def test_hyp_research23_labelled_constructor_args():
...
def test_hyp_research23_counted_is_not_abstract():
    assert not inspect.isabstract(research23_Counted)


def test_hyp_research23_counted_constructor_exists():
    assert callable(research23_Counted.__init__)


def test_hyp_research23_counted_constructor_args():
...
def test_hyp_research23_named_is_not_abstract():
    assert not inspect.isabstract(research23_Named)


def test_hyp_research23_named_constructor_exists():
    assert callable(research23_Named.__init__)


def test_hyp_research23_named_constructor_args():
...
def test_hyp_research23_state_is_not_abstract():
    assert not inspect.isabstract(research23_State)


def test_hyp_research23_state_constructor_exists():
    assert callable(research23_State.__init__)


def test_hyp_research23_state_constructor_args():
...
def test_hyp_research23_progress_is_not_abstract():
    assert not inspect.isabstract(research23_Progress)


def test_hyp_research23_progress_constructor_exists():
    assert callable(research23_Progress.__init__)


def test_hyp_research23_progress_constructor_args():
...
def test_hyp_research23_collaboration_is_not_abstract():
    assert not inspect.isabstract(research23_Collaboration)


def test_hyp_research23_collaboration_constructor_exists():
    assert callable(research23_Collaboration.__init__)


def test_hyp_research23_collaboration_constructor_args():
...
def test_hyp_research23_paperkeyword_is_not_abstract():
    assert not inspect.isabstract(research23_PaperKeyword)


def test_hyp_research23_paperkeyword_constructor_exists():
    assert callable(research23_PaperKeyword.__init__)


def test_hyp_research23_paperkeyword_constructor_args():
...
def test_hyp_research23_skill_is_not_abstract():
    assert not inspect.isabstract(research23_Skill)


def test_hyp_research23_skill_constructor_exists():
    assert callable(research23_Skill.__init__)


def test_hyp_research23_skill_constructor_args():
...
def test_hyp_research23_review_is_not_abstract():
    assert not inspect.isabstract(research23_Review)


def test_hyp_research23_review_constructor_exists():
    assert callable(research23_Review.__init__)


def test_hyp_research23_review_constructor_args():
...
def test_hyp_research23_write_is_not_abstract():
    assert not inspect.isabstract(research23_Write)


def test_hyp_research23_write_constructor_exists():
    assert callable(research23_Write.__init__)


def test_hyp_research23_write_constructor_args():
...
def test_hyp_research23_researcher_is_not_abstract():
    assert not inspect.isabstract(research23_Researcher)


def test_hyp_research23_researcher_constructor_exists():
    assert callable(research23_Researcher.__init__)


def test_hyp_research23_researcher_constructor_args():
...
def test_hyp_research23_phase_is_not_abstract():
    assert not inspect.isabstract(research23_Phase)


def test_hyp_research23_phase_constructor_exists():
    assert callable(research23_Phase.__init__)


def test_hyp_research23_phase_constructor_args():
...
def test_hyp_research23_paper_is_not_abstract():
    assert not inspect.isabstract(research23_Paper)


def test_hyp_research23_paper_constructor_exists():
    assert callable(research23_Paper.__init__)


def test_hyp_research23_paper_constructor_args():
    sig = inspect.signature(research23_Paper.__init__)
    params = list(sig.parameters.keys())



def test_hyp_research23_keyword_is_not_abstract():
    assert not inspect.isabstract(research23_Keyword)


def test_hyp_research23_keyword_constructor_exists():
    assert callable(research23_Keyword.__init__)


def test_hyp_research23_keyword_constructor_args():
...
def test_hyp_research23_paragraph_is_not_abstract():
    assert not inspect.isabstract(research23_Paragraph)


def test_hyp_research23_paragraph_constructor_exists():
    assert callable(research23_Paragraph.__init__)


def test_hyp_research23_paragraph_constructor_args():
...
def test_hyp_research23_position_is_not_abstract():
    assert not inspect.isabstract(research23_Position)


def test_hyp_research23_position_constructor_exists():
    assert callable(research23_Position.__init__)


def test_hyp_research23_position_constructor_args():
...
def test_hyp_research23_knowledgemanager_is_not_abstract():
    assert not inspect.isabstract(research23_KnowledgeManager)


def test_hyp_research23_knowledgemanager_constructor_exists():
    assert callable(research23_KnowledgeManager.__init__)


def test_hyp_research23_knowledgemanager_constructor_args():
    sig = inspect.signature(research23_KnowledgeManager.__init__)
    params = list(sig.parameters.keys())



def test_hyp_research23_publicationsystem_is_not_abstract():
    assert not inspect.isabstract(research23_PublicationSystem)


def test_hyp_research23_publicationsystem_constructor_exists():
    assert callable(research23_PublicationSystem.__init__)


def test_hyp_research23_publicationsystem_constructor_args():
    sig = inspect.signature(research23_PublicationSystem.__init__)
    params = list(sig.parameters.keys())



def test_hyp_research23_reviewnote_is_not_abstract():
    assert not inspect.isabstract(research23_ReviewNote)


def test_hyp_research23_reviewnote_constructor_exists():
    assert callable(research23_ReviewNote.__init__)


def test_hyp_research23_reviewnote_constructor_args():
...
def test_hyp_research23_publicationstructure_is_not_abstract():
    assert not inspect.isabstract(research23_PublicationStructure)


def test_hyp_research23_publicationstructure_constructor_exists():
    assert callable(research23_PublicationStructure.__init__)


def test_hyp_research23_publicationstructure_constructor_args():
    sig = inspect.signature(research23_PublicationStructure.__init__)
    params = list(sig.parameters.keys())



def test_hyp_research23_publicationprocess_is_not_abstract():
    assert not inspect.isabstract(research23_PublicationProcess)


def test_hyp_research23_publicationprocess_constructor_exists():
    assert callable(research23_PublicationProcess.__init__)


def test_hyp_research23_publicationprocess_constructor_args():
...
def test_hyp_research23_action_actionStatement_setter(instance):
...
@given(instance=research23_Action_strategy)
def test_hyp_research23_action_actionLabel_setter(instance):
...
def test_hyp_research23_transition_guardLabel_setter(instance):
...
@given(instance=research23_Transition_strategy)
def test_hyp_research23_transition_guardExpression_setter(instance):
...
def test_hyp_research23_statemachineobject_label_setter(instance):
...
def test_hyp_research23_publicationstatus_label_setter(instance):
    original = instance.label
    instance.label = original
    assert instance.label == original
...
def test_hyp_research23_labelled_lname_setter(instance):
...
def test_hyp_research23_counted_id_setter(instance):
...
def test_hyp_research23_named_name_setter(instance):
...
def test_hyp_research23_state_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
@given(instance=research23_State_strategy)
def test_hyp_research23_state_kind_setter(instance):
...
@given(instance=research23_State_strategy)
def test_hyp_research23_state_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_research23_progress_percent_setter(instance):
...
def test_hyp_research23_collaboration_ratio_setter(instance):
...
def test_hyp_research23_paperkeyword_weight_setter(instance):
...
def test_hyp_research23_skill_description_setter(instance):
...
def test_hyp_research23_review_date_setter(instance):
...
def test_hyp_research23_write_timeSpent_setter(instance):
...
def test_hyp_research23_researcher_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=research23_Researcher_strategy)
def test_hyp_research23_researcher_forName_setter(instance):
...
def test_hyp_research23_phase_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_research23_keyword_word_setter(instance):
...
def test_hyp_research23_paragraph_content_setter(instance):
...
def test_hyp_research23_position_description_setter(instance):
    original = instance.description
    instance.description = original
    assert instance.description == original
...
def test_hyp_research23_reviewnote_content_setter(instance):
    original = instance.content
    instance.content = original
    assert instance.content == original
...
def test_hyp_research23_publicationprocess_minTime_setter(instance):
...
@given(instance=research23_PublicationProcess_strategy)
def test_hyp_research23_publicationprocess_maxTime_setter(instance):
