...
class netModel_HeaderBlock(HttpMethodBlock, ClientBlock):
...
class netModel_SimpleMember:
    ...
    def __init__(self, name: str, netModel_SimpleMember22: "netModel_IntrinsicType" = None, netModel_SimpleMember: "netModel_SimpleMemberAssignment" = None):
        self.name = name
...
class netModel_ParamsBlock(HttpMethodBlock, ClientBlock):
