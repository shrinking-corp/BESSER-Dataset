...
domain_model = DomainModel(
    name="PetriNetModel",
    types={PetriNetModel_ArcTP, PetriNetModel_Place, PetriNetModel_PetriNet, PetriNetModel_Transition, PetriNetModel_ArcPT},
    associations={arcTP3, place5, preArc7, transition0, arcPT1, postArc10, transition13, place16, place19, transition22, preArc25, postArc28},
    generalizations={},
    metadata=None
)
