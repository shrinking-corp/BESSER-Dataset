...
class VisualInterface_GridContainer(Container):
    ...
    def __init__(self, marginWidth: int, marginHeight: int, columns: int, equalWidth: bool, horizontalSpacing: int, verticalSpacing: int, VisualInterface_GridContainer: set["VisualInterface_GridChild"] = None):
...
class VisualInterface_Position:
    ...
    def __init__(self, x: float, y: float, VisualInterface_Position18: "VisualInterface_Line" = None, VisualInterface_Position: "VisualInterface_XYChild" = None):
        self.x = x
        self.y = y
...
class VisualInterface_Figure(Primitive):
    ...
    def __init__(self, backgroundColor: str, onClick: str, onDoubleClick: str, visible: bool, border: str, opaque: str, toolTip: str, foregroundColor: str, VisualInterface_Figure: "VisualInterface_Dimension" = None, VisualInterface_Figure22: "VisualInterface_Cursor" = None):
...
class VisualInterface_Dimension:
    ...
    def __init__(self, width: float, height: float, VisualInterface_Dimension: "VisualInterface_Symbol" = None, VisualInterface_Dimension20: "VisualInterface_Figure" = None, VisualInterface_Dimension14: "VisualInterface_XYChild" = None):
        self.width = width
        self.height = height
...
class VisualInterface_Symbol:
    ...
    def __init__(self, backgroundColor: str, onInit: str, onDispose: str, onUpdate: str, scriptModules: str, VisualInterface_Symbol6: "VisualInterface_Dimension" = None, VisualInterface_Symbol8: set["VisualInterface_Connection"] = None, VisualInterface_Symbol: "VisualInterface_Primitive" = None, VisualInterface_Symbol2: set["VisualInterface_StringToStringMap"] = None, VisualInterface_Symbol4: "VisualInterface_Cursor" = None):
        self.backgroundColor = backgroundColor
        self.onInit = onInit
