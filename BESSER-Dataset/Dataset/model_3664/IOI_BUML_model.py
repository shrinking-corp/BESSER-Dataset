...
# Classes
iOI_Model = Class(name="iOI_Model")
iOI_Company = Class(name="iOI_Company")
iOI_Employee = Class(name="iOI_Employee")
Employee = Class(name="Employee")
iOI_Position = Class(name="iOI_Position")
iOI_Department = Class(name="iOI_Department")
iOI_Manager = Class(name="iOI_Manager")
...
domain_model = DomainModel(
    name="iOI",
    types={iOI_Model, iOI_Company, iOI_Employee, Employee, iOI_Position, iOI_Department, iOI_Manager},
    associations={companies0, works_on1, positions2, departments5, manager7, employees9, sub_department13},
