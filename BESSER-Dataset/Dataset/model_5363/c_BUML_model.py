...
# Classes
c_Foo = Class(name="c_Foo")
AbstractClass = Class(name="AbstractClass")
c_Bar = Class(name="c_Bar")
Foo = Class(name="Foo")
c_AbstractClass = Class(name="c_AbstractClass", is_abstract=True)
...
domain_model = DomainModel(
    name="c",
    types={c_Foo, AbstractClass, c_Bar, Foo, c_AbstractClass},
