...
statemachine_State.attributes={statemachine_State_initial, statemachine_State_name, statemachine_State_final, statemachine_State_id}
...
domain_model = DomainModel(
    name="statemachine",
    types={statemachine_Statemachine, statemachine_State, statemachine_Transition, statemachine_Expression, statemachine_SetCommand, Command, statemachine_Command, statemachine_VerbatimExpression, Expression, statemachine_StatePropertyExpression, statemachine_ExecuteCommand, statemachine_PrintCommand},
    associations={states0, sourceState5, targetState8, event11, transitions1, actions3, value17, value13, arguments15, state19},
    generalizations={gen_statemachine_VerbatimExpression_Expression, gen_statemachine_StatePropertyExpression_Expression, gen_statemachine_SetCommand_Command, gen_statemachine_ExecuteCommand_Command, gen_statemachine_PrintCommand_Command},
    metadata=None
)
