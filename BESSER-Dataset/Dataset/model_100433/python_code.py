...
class statemachine_StatePropertyExpression(Expression):
    ...
    def __init__(self, property1: str, statemachine_StatePropertyExpression: "statemachine_State" = None):
...
class statemachine_State:
    ...
    def __init__(self, initial: bool, final: bool, id: str, name: str, statemachine_State: "statemachine_Statemachine" = None, statemachine_State7: "statemachine_Transition" = None, statemachine_State10: "statemachine_Transition" = None, statemachine_State4: set["statemachine_Command"] = None, statemachine_State20: "statemachine_StatePropertyExpression" = None):
