...
def test_hyp_simplestatechart_variable_is_not_abstract():
    assert not inspect.isabstract(simplestatechart_Variable)


def test_hyp_simplestatechart_variable_constructor_exists():
    assert callable(simplestatechart_Variable.__init__)


def test_hyp_simplestatechart_variable_constructor_args():
...
def test_hyp_simplestatechart_state_is_not_abstract():
    assert not inspect.isabstract(simplestatechart_State)


def test_hyp_simplestatechart_state_constructor_exists():
    assert callable(simplestatechart_State.__init__)


def test_hyp_simplestatechart_state_constructor_args():
...
def test_hyp_simplestatechart_transition_is_not_abstract():
    assert not inspect.isabstract(simplestatechart_Transition)


def test_hyp_simplestatechart_transition_constructor_exists():
    assert callable(simplestatechart_Transition.__init__)


def test_hyp_simplestatechart_transition_constructor_args():
...
def test_hyp_simplestatechart_thing_is_not_abstract():
    assert not inspect.isabstract(simplestatechart_Thing)


def test_hyp_simplestatechart_thing_constructor_exists():
    assert callable(simplestatechart_Thing.__init__)


def test_hyp_simplestatechart_thing_constructor_args():
...
def test_hyp_simplestatechart_namedelement_is_not_abstract():
    assert not inspect.isabstract(simplestatechart_NamedElement)


def test_hyp_simplestatechart_namedelement_constructor_exists():
    assert callable(simplestatechart_NamedElement.__init__)


def test_hyp_simplestatechart_namedelement_constructor_args():
...
def test_hyp_simplestatechart_relatedto_is_not_abstract():
    assert not inspect.isabstract(simplestatechart_RelatedTo)


def test_hyp_simplestatechart_relatedto_constructor_exists():
    assert callable(simplestatechart_RelatedTo.__init__)


def test_hyp_simplestatechart_relatedto_constructor_args():
...
def test_hyp_simplestatechart_variable_type_setter(instance):
...
@given(instance=simplestatechart_Variable_strategy)
def test_hyp_simplestatechart_variable_value_setter(instance):
...
def test_hyp_simplestatechart_state_label_setter(instance):
...
@given(instance=simplestatechart_State_strategy)
def test_hyp_simplestatechart_state_type_setter(instance):
    original = instance.type
    instance.type = original
    assert instance.type == original
...
@given(instance=simplestatechart_State_strategy)
def test_hyp_simplestatechart_state_activity_setter(instance):
...
def test_hyp_simplestatechart_transition_expression_setter(instance):
...
def test_hyp_simplestatechart_thing_id_setter(instance):
...
def test_hyp_simplestatechart_namedelement_name_setter(instance):
...
def test_hyp_simplestatechart_relatedto_since_setter(instance):
