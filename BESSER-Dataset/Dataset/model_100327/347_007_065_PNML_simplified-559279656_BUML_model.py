...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={PNML_LocatedElement, PNML_IdedElement, LocatedElement, PNML_URI, PNML_PNMLDocument, URI, NetElement, PNML_LabeledElement, Label, PNML_Label, LabeledElement, PNML_Name, PNML_NetElement, IdedElement, PNMLDocument, NetContent, Name, PNML_NetContent, PNML_Transition, PNML_NetContentElement, PNML_Arc, NetContentElement, PNML_Place},
    associations={xmlns0, nets1, net8, name10, labels12, labeledElement13, net14, netContent16, type2, document4, contents5, name6, source19, target20},
    generalizations={gen_PNML_IdedElement_LocatedElement, gen_PNML_URI_LocatedElement, gen_PNML_PNMLDocument_LocatedElement, gen_PNML_LabeledElement_LocatedElement, gen_PNML_Label_LocatedElement, gen_PNML_Name_LabeledElement, gen_PNML_NetElement_IdedElement, gen_PNML_NetContent_LocatedElement, gen_PNML_Transition_NetContentElement, gen_PNML_NetContentElement_NetContent, gen_PNML_NetContentElement_IdedElement, gen_PNML_Arc_NetContent, gen_PNML_Arc_IdedElement, gen_PNML_Place_NetContentElement},
    metadata=None
)
