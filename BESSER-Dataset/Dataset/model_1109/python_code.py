...
class oclstates_Statemachine:
    ...
    def __init__(self, initial: bool, name: str, value: int, oclstates_Statemachine: "oclstates_Module" = None, oclstates_Statemachine2: set["oclstates_Event"] = None, oclstates_Statemachine4: set["oclstates_State"] = None, oclstates_Statemachine9: "oclstates_State" = None, oclstates_Statemachine11: "oclstates_CompoundState" = None):
        self.initial = initial
        self.name = name
        self.value = value
