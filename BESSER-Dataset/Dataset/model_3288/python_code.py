...
class Etunit_TestsuitesType:
    ...
    def __init__(self, name: str, tests: str, time: str, disabled: str, errors: str, failures: str, Etunit_TestsuitesType: "Etunit_DocumentRoot" = None, Etunit_TestsuitesType33: set["Etunit_TestsuiteType"] = None):
        self.name = name
        self.tests = tests
        self.time = time
...
class Etunit_TestsuiteType:
    ...
    def __init__(self, errors: str, failures: str, hostname: str, id: str, name: str, package: str, skipped: str, systemOut: str, systemErr: str, disabled: str, tests: str, time: str, timestamp: str, Etunit_TestsuiteType: "Etunit_DocumentRoot" = None, Etunit_TestsuiteType34: "Etunit_TestsuitesType" = None, Etunit_TestsuiteType36: "Etunit_PropertiesType" = None, Etunit_TestsuiteType39: set["Etunit_TestcaseType"] = None):
        self.errors = errors
        self.failures = failures
...
class Etunit_TestcaseType:
    ...
    def __init__(self, classname: str, name: str, status: str, time: str, systemOut: str, systemErr: str, assertions: str, Etunit_TestcaseType: "Etunit_DocumentRoot" = None, Etunit_TestcaseType24: "Etunit_SkippedType" = None, Etunit_TestcaseType27: set["Etunit_ErrorType"] = None, Etunit_TestcaseType30: set["Etunit_FailureType"] = None, Etunit_TestcaseType40: "Etunit_TestsuiteType" = None):
...
class Etunit_DocumentRoot:
    ...
    def __init__(self, mixed: str, systemErr: str, systemOut: str, Etunit_DocumentRoot2: set["Etunit_EStringToStringMapEntry"] = None, Etunit_DocumentRoot5: set["Etunit_ErrorType"] = None, Etunit_DocumentRoot7: set["Etunit_FailureType"] = None, Etunit_DocumentRoot9: set["Etunit_PropertiesType"] = None, Etunit_DocumentRoot: set["Etunit_EStringToStringMapEntry"] = None, Etunit_DocumentRoot15: set["Etunit_TestcaseType"] = None, Etunit_DocumentRoot17: set["Etunit_TestsuiteType"] = None, Etunit_DocumentRoot11: set["Etunit_PropertyType"] = None, Etunit_DocumentRoot13: set["Etunit_SkippedType"] = None, Etunit_DocumentRoot19: set["Etunit_TestsuitesType"] = None):
        self.mixed = mixed
        self.systemErr = systemErr
        self.systemOut = systemOut
...
class Etunit_ErrorType:
    ...
    def __init__(self, type: str, mixed: str, message: str, Etunit_ErrorType: "Etunit_DocumentRoot" = None, Etunit_ErrorType28: "Etunit_TestcaseType" = None):
        self.type = type
        self.mixed = mixed
        self.message = message
