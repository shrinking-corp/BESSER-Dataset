...
domain_model = DomainModel(
    name="Example",
    types={Example_Son, Example_Daughter, Example_Pet, Example_Member, Member, Example_Dog, Pet, Example_Cat, Example_RaceDog, Example_Family, Example_Parent, Dog, Example_HuntingDog},
    associations={sons1, daughters3, pets5, family6, family7, family9, parents0},
