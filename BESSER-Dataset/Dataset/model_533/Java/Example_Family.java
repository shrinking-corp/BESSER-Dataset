...
public class Example_Family  {
    ...
    public Example_Family(
        String address        ArrayList<Example_Parent> example_parents,        ArrayList<Example_Son> example_sons,        ArrayList<Example_Daughter> example_daughters,        ArrayList<Example_Pet> example_pets    ) {
        this.address = address;
