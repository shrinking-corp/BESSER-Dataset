...
# Classes
ck2gfx_Model = Class(name="ck2gfx_Model")
ck2gfx_EObject = Class(name="ck2gfx_EObject")
ck2gfx_Color = Class(name="ck2gfx_Color")
ck2gfx_ColorRatio = Class(name="ck2gfx_ColorRatio")
ck2gfx_Coordinates = Class(name="ck2gfx_Coordinates")
ck2gfx_AnimatedSpriteType = Class(name="ck2gfx_AnimatedSpriteType")
ck2gfx_CorneredTileSpriteType = Class(name="ck2gfx_CorneredTileSpriteType")
ck2gfx_ProgressbarType = Class(name="ck2gfx_ProgressbarType")
ck2gfx_SpriteTypes = Class(name="ck2gfx_SpriteTypes")
ck2gfx_SpriteType = Class(name="ck2gfx_SpriteType")
ck2gfx_MaskedShieldType = Class(name="ck2gfx_MaskedShieldType")
ck2gfx_LineChartType = Class(name="ck2gfx_LineChartType")
ck2gfx_CoatOfArmsType = Class(name="ck2gfx_CoatOfArmsType")
ck2gfx_CoatOfArmsLayer = Class(name="ck2gfx_CoatOfArmsLayer")
ck2gfx_ObjectTypes = Class(name="ck2gfx_ObjectTypes")
ck2gfx_PortraitType = Class(name="ck2gfx_PortraitType")
ck2gfx_Pdxmesh = Class(name="ck2gfx_Pdxmesh")
ck2gfx_ArrowType = Class(name="ck2gfx_ArrowType")
ck2gfx_BitmapFonts = Class(name="ck2gfx_BitmapFonts")
ck2gfx_BitmapFont = Class(name="ck2gfx_BitmapFont")
ck2gfx_ColorCode = Class(name="ck2gfx_ColorCode")
ck2gfx_EMFXActorType = Class(name="ck2gfx_EMFXActorType")
ck2gfx_Animation = Class(name="ck2gfx_Animation")
...
ck2gfx_Color.attributes={ck2gfx_Color_r, ck2gfx_Color_g, ck2gfx_Color_b}
...
ck2gfx_ColorRatio.attributes={ck2gfx_ColorRatio_b, ck2gfx_ColorRatio_g, ck2gfx_ColorRatio_r}
...
ck2gfx_AnimatedSpriteType.attributes={ck2gfx_AnimatedSpriteType_playOnShow, ck2gfx_AnimatedSpriteType_looping, ck2gfx_AnimatedSpriteType_noOfFrames, ck2gfx_AnimatedSpriteType_animationRateFps, ck2gfx_AnimatedSpriteType_texturefile, ck2gfx_AnimatedSpriteType_name}
...
ck2gfx_CorneredTileSpriteType.attributes={ck2gfx_CorneredTileSpriteType_texturefile, ck2gfx_CorneredTileSpriteType_loadType, ck2gfx_CorneredTileSpriteType_noRefCount, ck2gfx_CorneredTileSpriteType_allwaysTransparent, ck2gfx_CorneredTileSpriteType_name, ck2gfx_CorneredTileSpriteType_tilingCenter}
...
ck2gfx_ProgressbarType.attributes={ck2gfx_ProgressbarType_effectFile, ck2gfx_ProgressbarType_textureFile1, ck2gfx_ProgressbarType_loadType, ck2gfx_ProgressbarType_textureFile2, ck2gfx_ProgressbarType_horizontal, ck2gfx_ProgressbarType_maxValue, ck2gfx_ProgressbarType_noRefCount, ck2gfx_ProgressbarType_name, ck2gfx_ProgressbarType_allwaysTransparent}
...
ck2gfx_SpriteType.attributes={ck2gfx_SpriteType_name, ck2gfx_SpriteType_loadType, ck2gfx_SpriteType_noRefCount, ck2gfx_SpriteType_effectFile, ck2gfx_SpriteType_allwaysTransparent, ck2gfx_SpriteType_clickSound, ck2gfx_SpriteType_textureFile, ck2gfx_SpriteType_transparenceCheck, ck2gfx_SpriteType_noOfFrames, ck2gfx_SpriteType_canBeLowres}
...
ck2gfx_MaskedShieldType.attributes={ck2gfx_MaskedShieldType_allwaysTransparent, ck2gfx_MaskedShieldType_clickSound, ck2gfx_MaskedShieldType_name, ck2gfx_MaskedShieldType_textureFile1, ck2gfx_MaskedShieldType_textureFile2, ck2gfx_MaskedShieldType_effectFile}
...
ck2gfx_CoatOfArmsType.attributes={ck2gfx_CoatOfArmsType_sealOverlay, ck2gfx_CoatOfArmsType_effect, ck2gfx_CoatOfArmsType_name, ck2gfx_CoatOfArmsType_frame, ck2gfx_CoatOfArmsType_mask}
...
ck2gfx_CoatOfArmsLayer.attributes={ck2gfx_CoatOfArmsLayer_scale, ck2gfx_CoatOfArmsLayer_mask}
...
ck2gfx_PortraitType.attributes={ck2gfx_PortraitType_effectFile, ck2gfx_PortraitType_eyeColorIndex, ck2gfx_PortraitType_layers, ck2gfx_PortraitType_hairColorIndex, ck2gfx_PortraitType_headgearThatHidesHair, ck2gfx_PortraitType_name}
...
ck2gfx_Pdxmesh.attributes={ck2gfx_Pdxmesh_cullDistance, ck2gfx_Pdxmesh_scaleOnCullDistance, ck2gfx_Pdxmesh_actorFile, ck2gfx_Pdxmesh_name, ck2gfx_Pdxmesh_scale}
...
ck2gfx_ArrowType.attributes={ck2gfx_ArrowType_endAt, ck2gfx_ArrowType_name, ck2gfx_ArrowType_height, ck2gfx_ArrowType_effect, ck2gfx_ArrowType_heading, ck2gfx_ArrowType_type, ck2gfx_ArrowType_textureFile, ck2gfx_ArrowType_size, ck2gfx_ArrowType_bodyTexture}
...
ck2gfx_BitmapFont.attributes={ck2gfx_BitmapFont_name, ck2gfx_BitmapFont_effect, ck2gfx_BitmapFont_color, ck2gfx_BitmapFont_fontName}
...
ck2gfx_EMFXActorType.attributes={ck2gfx_EMFXActorType_attack, ck2gfx_EMFXActorType_scaleOnCullDistance, ck2gfx_EMFXActorType_cullDistance, ck2gfx_EMFXActorType_move, ck2gfx_EMFXActorType_scale, ck2gfx_EMFXActorType_name, ck2gfx_EMFXActorType_idle, ck2gfx_EMFXActorType_actorFile, ck2gfx_EMFXActorType_useAnimation}
...
ck2gfx_Animation.attributes={ck2gfx_Animation_file, ck2gfx_Animation_defaultAnimationTime, ck2gfx_Animation_name}
...
domain_model = DomainModel(
    name="ck2gfx",
    types={ck2gfx_Model, ck2gfx_EObject, ck2gfx_Color, ck2gfx_ColorRatio, ck2gfx_Coordinates, ck2gfx_AnimatedSpriteType, ck2gfx_CorneredTileSpriteType, ck2gfx_ProgressbarType, ck2gfx_SpriteTypes, ck2gfx_SpriteType, ck2gfx_MaskedShieldType, ck2gfx_LineChartType, ck2gfx_CoatOfArmsType, ck2gfx_CoatOfArmsLayer, ck2gfx_ObjectTypes, ck2gfx_PortraitType, ck2gfx_Pdxmesh, ck2gfx_ArrowType, ck2gfx_BitmapFonts, ck2gfx_BitmapFont, ck2gfx_ColorCode, ck2gfx_EMFXActorType, ck2gfx_Animation},
    associations={types0, size3, borderSize4, color7, types1, hairColor14, eyeColor15, size18, layers20, center21, types24, color28, size11, color27, color229, types32, colorcodes33, value35, animation26},
    generalizations={},
    metadata=None
)
