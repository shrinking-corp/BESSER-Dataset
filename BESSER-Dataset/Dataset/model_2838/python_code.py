...
class ck2gfx_Animation:
    ...
    def __init__(self, file: str, defaultAnimationTime: float, name: str, ck2gfx_Animation: "ck2gfx_EMFXActorType" = None):
        self.file = file
...
class ck2gfx_EMFXActorType:
    ...
    def __init__(self, name: str, actorFile: str, idle: str, move: str, attack: str, scale: float, useAnimation: bool, cullDistance: float, scaleOnCullDistance: bool, ck2gfx_EMFXActorType: "ck2gfx_Animation" = None):
        self.name = name
...
class ck2gfx_ColorCode:
    ...
    def __init__(self, key: str, ck2gfx_ColorCode: "ck2gfx_BitmapFont" = None, ck2gfx_ColorCode36: "ck2gfx_Color" = None):
        self.key = key
...
class ck2gfx_ArrowType:
    ...
    def __init__(self, name: str, size: float, textureFile: str, bodyTexture: str, endAt: float, height: float, type: int, heading: float, effect: str, ck2gfx_ArrowType: "ck2gfx_ColorRatio" = None, ck2gfx_ArrowType30: "ck2gfx_ColorRatio" = None):
        self.name = name
        self.size = size
...
class ck2gfx_Pdxmesh:
    ...
    def __init__(self, scaleOnCullDistance: bool, name: str, actorFile: str, scale: float, cullDistance: float):
        self.scaleOnCullDistance = scaleOnCullDistance
        self.name = name
        self.actorFile = actorFile
        self.scale = scale
...
class ck2gfx_PortraitType:
    ...
    @property
    def headgearThatHidesHair(self):
...
class ck2gfx_LineChartType:
    ...
    def __init__(self, name: str, lineWidth: int, ck2gfx_LineChartType: "ck2gfx_Coordinates" = None):
        self.name = name
...
class ck2gfx_SpriteType:
    ...
    def __init__(self, transparenceCheck: bool, canBeLowres: bool, clickSound: str, name: str, textureFile: str, noOfFrames: int, loadType: str, allwaysTransparent: bool, noRefCount: bool, effectFile: str):
...
class ck2gfx_ProgressbarType:
    ...
    def __init__(self, name: str, textureFile1: str, textureFile2: str, horizontal: bool, effectFile: str, allwaysTransparent: bool, maxValue: float, loadType: str, noRefCount: bool, ck2gfx_ProgressbarType: "ck2gfx_ColorRatio" = None, ck2gfx_ProgressbarType9: "ck2gfx_ColorRatio" = None, ck2gfx_ProgressbarType12: "ck2gfx_Coordinates" = None):
        self.name = name
        self.textureFile1 = textureFile1
        self.textureFile2 = textureFile2
...
class ck2gfx_CorneredTileSpriteType:
    ...
    def __init__(self, name: str, texturefile: str, allwaysTransparent: bool, noRefCount: bool, loadType: str, tilingCenter: bool, ck2gfx_CorneredTileSpriteType: "ck2gfx_Coordinates" = None, ck2gfx_CorneredTileSpriteType5: "ck2gfx_Coordinates" = None):
        self.name = name
        self.texturefile = texturefile
        self.allwaysTransparent = allwaysTransparent
        self.noRefCount = noRefCount
...
class ck2gfx_Coordinates:
    ...
    def __init__(self, x: float, y: float, ck2gfx_Coordinates: "ck2gfx_CorneredTileSpriteType" = None, ck2gfx_Coordinates6: "ck2gfx_CorneredTileSpriteType" = None, ck2gfx_Coordinates19: "ck2gfx_LineChartType" = None, ck2gfx_Coordinates23: "ck2gfx_CoatOfArmsLayer" = None, ck2gfx_Coordinates13: "ck2gfx_ProgressbarType" = None):
        self.x = x
        self.y = y
