...
# Classes
music_Artist = Class(name="music_Artist")
music_Work = Class(name="music_Work")
music_MusicLibrary = Class(name="music_MusicLibrary")
...
music_Work.attributes={music_Work_mediaTypes, music_Work_whenMade, music_Work_name, music_Work_notes}
...
domain_model = DomainModel(
    ...
    associations={works0, artists1, performer2},
    generalizations={},
    metadata=None
)
