...
class Sides:
    ...
    def __init__(self, isVegetarian: bool, name: str, price: float, order11: "Order" = None, mealDeal15: set["MealDeal"] = None):
        self.isVegetarian = isVegetarian
        self.name = name
        self.price = price
...
class Pizza:
    ...
    def __init__(self, price: float, isVegetarian: bool, base0: "Base" = None, order3: "Order" = None, toppings6: set["Toppings"] = None, mealDeal17: set["MealDeal"] = None):
        self.price = price
        self.isVegetarian = isVegetarian
        self.base0 = base0
        self.order3 = order3
...
class Order:
    ...
    def __init__(self, orderID: int, date: str, time: int, orderNotes: str, creditCardDetails: str, pizza2: set["Pizza"] = None, GPS_Location4: "GPSLocation" = None, customer8: "Customer" = None, sides10: set["Sides"] = None, address20: "Address" = None, mealDeal18: set["MealDeal"] = None):
