...
Book_Summary = Class(name="Book_Summary")
...
Book_Summary.attributes={Book_Summary_nbWords, Book_Summary_content}
...
domain_model = DomainModel(
    name="Book",
    types={Book_Library, Book_Book, Book_Chapter, Book_Summary},
    associations={books3, chapters0, digest1},
    generalizations={},
    metadata=None
)
