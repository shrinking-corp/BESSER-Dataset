...
# Classes
z2fsm_Region = Class(name="z2fsm_Region")
z2fsm_AbstractState = Class(name="z2fsm_AbstractState", is_abstract=True)
z2fsm_State = Class(name="z2fsm_State")
AbstractState = Class(name="AbstractState")
z2fsm_Foo = Class(name="z2fsm_Foo")
...
domain_model = DomainModel(
    name="z2fsm",
    types={z2fsm_Region, z2fsm_AbstractState, z2fsm_State, AbstractState, z2fsm_Foo},
