...
activitydiagram_ActivityEdge.methods={activitydiagram_ActivityEdge_m_takeOfferedTokens, activitydiagram_ActivityEdge_m_sendOffer, activitydiagram_ActivityEdge_m_hasOffer}
...
activitydiagram_Activity.methods={activitydiagram_Activity_m_getBooleanVariableValue, activitydiagram_Activity_m_initializeModel, activitydiagram_Activity_m_getIntegerVariableValue, activitydiagram_Activity_m_getVariable, activitydiagram_Activity_m_main, activitydiagram_Activity_m_getVariableValue, activitydiagram_Activity_m_reset, activitydiagram_Activity_m_execute}
...
activitydiagram_ActivityNode.methods={activitydiagram_ActivityNode_m_addTokens, activitydiagram_ActivityNode_m_execute, activitydiagram_ActivityNode_m_terminate, activitydiagram_ActivityNode_m_takeOfferdTokens, activitydiagram_ActivityNode_m_removeToken1, activitydiagram_ActivityNode_m_sendOffers, activitydiagram_ActivityNode_m_isReady, activitydiagram_ActivityNode_m_hasOffers}
...
activitydiagram_IntegerVariable.methods={activitydiagram_IntegerVariable_m_print, activitydiagram_IntegerVariable_m_init, activitydiagram_IntegerVariable_m_execute}
...
domain_model = DomainModel(
    ...
    types={activitydiagram_ActivityEdge, activitydiagram_Variable, activitydiagram_Trace, activitydiagram_Activity, NamedElement, activitydiagram_ActivityNode, activitydiagram_Offer, activitydiagram_ControlFlow, ActivityEdge, activitydiagram_BooleanVariable, activitydiagram_ControlNode, ActivityNode, activitydiagram_ExecutableNode, activitydiagram_Action, activitydiagram_Token, activitydiagram_Value, activitydiagram_IntegerVariable, Variable, ExecutableNode, activitydiagram_OpaqueAction, Action, activitydiagram_Expression, activitydiagram_NamedElement, activitydiagram_InitialNode, ControlNode, activitydiagram_FinalNode, activitydiagram_ActivityFinalNode, FinalNode, activitydiagram_ForkNode, activitydiagram_JoinNode, activitydiagram_MergeNode, activitydiagram_DecisionNode, activitydiagram_BooleanUnaryExpression, BooleanExpression, activitydiagram_BooleanValue, Value, activitydiagram_IntegerValue, activitydiagram_IntegerExpression, Expression, activitydiagram_BooleanExpression, activitydiagram_IntegerCalculationExpression, IntegerExpression, activitydiagram_IntegerComparisonExpression, activitydiagram_BooleanBinaryExpression, activitydiagram_ControlToken, Token, activitydiagram_ForkedToken, activitydiagram_InputValue, activitydiagram_Input, IntegerCalculationOperator, IntegerComparisonOperator, BooleanUnaryOperator, BooleanBinaryOperator},
    associations={nodes0, edges1, locals2, inputs4, trace7, source14, target16, offers18, guard20, outgoing9, incoming10, activity12, heldTokens13, initialValue22, currentValue24, expressions21, assignee35, operand37, operand227, operand128, assignee31, assignee33, operand139, operand241, baseToken54, offeredTokens44, executedNodes56, variable47, value49, inputValues52},
    generalizations={gen_activitydiagram_ActivityNode_NamedElement, gen_activitydiagram_Activity_NamedElement, gen_activitydiagram_ControlFlow_ActivityEdge, gen_activitydiagram_ControlNode_ActivityNode, gen_activitydiagram_ExecutableNode_ActivityNode, gen_activitydiagram_ActivityEdge_NamedElement, gen_activitydiagram_IntegerVariable_Variable, gen_activitydiagram_Action_ExecutableNode, gen_activitydiagram_OpaqueAction_Action, gen_activitydiagram_InitialNode_ControlNode, gen_activitydiagram_FinalNode_ControlNode, gen_activitydiagram_ActivityFinalNode_FinalNode, gen_activitydiagram_ForkNode_ControlNode, gen_activitydiagram_JoinNode_ControlNode, gen_activitydiagram_MergeNode_ControlNode, gen_activitydiagram_DecisionNode_ControlNode, gen_activitydiagram_BooleanUnaryExpression_BooleanExpression, gen_activitydiagram_BooleanVariable_Variable, gen_activitydiagram_BooleanValue_Value, gen_activitydiagram_IntegerValue_Value, gen_activitydiagram_IntegerExpression_Expression, gen_activitydiagram_BooleanExpression_Expression, gen_activitydiagram_IntegerCalculationExpression_IntegerExpression, gen_activitydiagram_IntegerComparisonExpression_IntegerExpression, gen_activitydiagram_BooleanBinaryExpression_BooleanExpression, gen_activitydiagram_ControlToken_Token, gen_activitydiagram_ForkedToken_Token},
    metadata=None
)
