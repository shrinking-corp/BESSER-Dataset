...
class fsmWithMethods_FExpression(Referentiable):
    ...
    def __init__(self, name: str, fsmWithMethods_FExpression: "fsmWithMethods_Fsm" = None, fsmWithMethods_FExpression16: "fsmWithMethods_Transition" = None, fsmWithMethods_FExpression19: "fsmWithMethods_Transition" = None, fsmWithMethods_FExpression4: "fsmWithMethods_Method" = None, fsmWithMethods_FExpression7: "fsmWithMethods_Method" = None, fsmWithMethods_FExpression13: "fsmWithMethods_Transition" = None):
        self.name = name
...
class fsmWithMethods_Fsm:
    ...
    def __init__(self, name: str, fsmWithMethods_Fsm: "fsmWithMethods_State" = None, fsmWithMethods_Fsm2: set["fsmWithMethods_FExpression"] = None):
        self.name = name
