...
class Orders:
    ...
    def __init__(self, OrderId: int, dateCreated: str, Date: str, customerName: str, CustomerId: str, ShippingId: str, status: str, customer5: "Client" = None, shipping_Info6: "Shipping_Info" = None, order_Details8: "Order_Details" = None):
        self.OrderId = OrderId
...
class Shopping_Cart:
    ...
    def __init__(self, CartId: int, productId: int, Quantity: int, dateAdded: int, customer3: "Client" = None):
        self.CartId = CartId
        self.productId = productId
        self.Quantity = Quantity
...
class User:
    ...
    def __init__(self, User_Id: str, Password: str, loginStatus: str, customer1: "Client" = None, administrator14: "Administrator" = None):
...
class Client:
    ...
    def orders4(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Client__orders4", None)
    ...
    def shopping_Cart2(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Client__shopping_Cart2", None)
    ...
    def user0(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Client__user0", None)
        self.__user0 = value
