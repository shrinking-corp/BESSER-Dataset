...
# Classes
imperativeoclcs_AssertExpCS = Class(name="imperativeoclcs_AssertExpCS")
StatementCS = Class(name="StatementCS")
imperativeoclcs_ExpCS = Class(name="imperativeoclcs_ExpCS")
imperativeoclcs_LogExpCS = Class(name="imperativeoclcs_LogExpCS")
imperativeoclcs_AssignStatementCS = Class(name="imperativeoclcs_AssignStatementCS")
imperativeoclcs_BlockExpCS = Class(name="imperativeoclcs_BlockExpCS")
CallExpCS = Class(name="CallExpCS")
imperativeoclcs_InstantiationExpCS = Class(name="imperativeoclcs_InstantiationExpCS")
imperativeoclcs_TypeCS = Class(name="imperativeoclcs_TypeCS")
imperativeoclcs_DoExpCS = Class(name="imperativeoclcs_DoExpCS")
imperativeoclcs_ExceptCS = Class(name="imperativeoclcs_ExceptCS")
imperativeoclcs_Type = Class(name="imperativeoclcs_Type")
imperativeoclcs_ExpressionBlockCS = Class(name="imperativeoclcs_ExpressionBlockCS")
imperativeoclcs_ExpressionStatementCS = Class(name="imperativeoclcs_ExpressionStatementCS")
imperativeoclcs_ForExpCS = Class(name="imperativeoclcs_ForExpCS")
imperativeoclcs_ListTypeCS = Class(name="imperativeoclcs_ListTypeCS")
imperativeoclcs_DictLiteralExpCS = Class(name="imperativeoclcs_DictLiteralExpCS")
ExpCS = Class(name="ExpCS")
imperativeoclcs_DictLiteralPartCS = Class(name="imperativeoclcs_DictLiteralPartCS")
ElementCS = Class(name="ElementCS")
imperativeoclcs_PrimitiveLiteralExpCS = Class(name="imperativeoclcs_PrimitiveLiteralExpCS")
imperativeoclcs_DictTypeCS = Class(name="imperativeoclcs_DictTypeCS")
TypedRefCS = Class(name="TypedRefCS")
imperativeoclcs_TypedRefCS = Class(name="imperativeoclcs_TypedRefCS")
imperativeoclcs_ComputeExpCS = Class(name="imperativeoclcs_ComputeExpCS")
ExpressionBlockCS = Class(name="ExpressionBlockCS")
imperativeoclcs_VariableCS = Class(name="imperativeoclcs_VariableCS")
imperativeoclcs_ImperativeIterateExpCS = Class(name="imperativeoclcs_ImperativeIterateExpCS")
ImperativeLoopExpCS = Class(name="ImperativeLoopExpCS")
imperativeoclcs_ImperativeLoopExpCS = Class(name="imperativeoclcs_ImperativeLoopExpCS")
imperativeoclcs_SwitchExpCS = Class(name="imperativeoclcs_SwitchExpCS")
imperativeoclcs_TryExpCS = Class(name="imperativeoclcs_TryExpCS")
imperativeoclcs_VariableInitializationCS = Class(name="imperativeoclcs_VariableInitializationCS")
imperativeoclcs_WhileExpCS = Class(name="imperativeoclcs_WhileExpCS")
imperativeoclcs_ListLiteralExpCS = Class(name="imperativeoclcs_ListLiteralExpCS")
imperativeoclcs_CollectionLiteralPartCS = Class(name="imperativeoclcs_CollectionLiteralPartCS")
imperativeoclcs_QuitExpCS = Class(name="imperativeoclcs_QuitExpCS")
imperativeoclcs_RaiseExpCS = Class(name="imperativeoclcs_RaiseExpCS")
imperativeoclcs_ReturnExpCS = Class(name="imperativeoclcs_ReturnExpCS")
imperativeoclcs_StatementCS = Class(name="imperativeoclcs_StatementCS", is_abstract=True)
imperativeoclcs_SwitchAltCS = Class(name="imperativeoclcs_SwitchAltCS")
...
except_31: BinaryAssociation = BinaryAssociation(
    name="except_31",
    ends={
...
domain_model = DomainModel(
    ...
    types={imperativeoclcs_AssertExpCS, StatementCS, imperativeoclcs_ExpCS, imperativeoclcs_LogExpCS, imperativeoclcs_AssignStatementCS, imperativeoclcs_BlockExpCS, CallExpCS, imperativeoclcs_InstantiationExpCS, imperativeoclcs_TypeCS, imperativeoclcs_DoExpCS, imperativeoclcs_ExceptCS, imperativeoclcs_Type, imperativeoclcs_ExpressionBlockCS, imperativeoclcs_ExpressionStatementCS, imperativeoclcs_ForExpCS, imperativeoclcs_ListTypeCS, imperativeoclcs_DictLiteralExpCS, ExpCS, imperativeoclcs_DictLiteralPartCS, ElementCS, imperativeoclcs_PrimitiveLiteralExpCS, imperativeoclcs_DictTypeCS, TypedRefCS, imperativeoclcs_TypedRefCS, imperativeoclcs_ComputeExpCS, ExpressionBlockCS, imperativeoclcs_VariableCS, imperativeoclcs_ImperativeIterateExpCS, ImperativeLoopExpCS, imperativeoclcs_ImperativeLoopExpCS, imperativeoclcs_SwitchExpCS, imperativeoclcs_TryExpCS, imperativeoclcs_VariableInitializationCS, imperativeoclcs_WhileExpCS, imperativeoclcs_ListLiteralExpCS, imperativeoclcs_CollectionLiteralPartCS, imperativeoclcs_QuitExpCS, imperativeoclcs_RaiseExpCS, imperativeoclcs_ReturnExpCS, imperativeoclcs_StatementCS, imperativeoclcs_SwitchAltCS},
    associations={assertion0, log1, lValueCS3, oclExpressionCS5, expressions8, condition23, typeSpecCS25, arguments26, condition29, except_31, body32, body35, oclExpressionCS37, type39, ownedParts10, key11, value13, keyType16, valueType17, returnedElement20, target21, alternativePart54, elsePart56, catch59, oclExpressionCS61, typeCS63, condition66, resultVar68, ownedParts41, condition42, value45, value47, condition49, body51},
    generalizations={gen_imperativeoclcs_AssertExpCS_StatementCS, gen_imperativeoclcs_AssignStatementCS_StatementCS, gen_imperativeoclcs_BlockExpCS_StatementCS, gen_imperativeoclcs_ImperativeLoopExpCS_CallExpCS, gen_imperativeoclcs_ImperativeLoopExpCS_StatementCS, gen_imperativeoclcs_InstantiationExpCS_StatementCS, gen_imperativeoclcs_DoExpCS_ExpressionBlockCS, gen_imperativeoclcs_ExceptCS_ElementCS, gen_imperativeoclcs_ExpressionBlockCS_ExpCS, gen_imperativeoclcs_ExpressionStatementCS_StatementCS, gen_imperativeoclcs_ForExpCS_ImperativeLoopExpCS, gen_imperativeoclcs_ListTypeCS_TypedRefCS, gen_imperativeoclcs_DictLiteralExpCS_ExpCS, gen_imperativeoclcs_DictLiteralPartCS_ElementCS, gen_imperativeoclcs_DictTypeCS_TypedRefCS, gen_imperativeoclcs_ComputeExpCS_ExpressionBlockCS, gen_imperativeoclcs_ImperativeIterateExpCS_ImperativeLoopExpCS, gen_imperativeoclcs_SwitchExpCS_StatementCS, gen_imperativeoclcs_TryExpCS_ExpressionBlockCS, gen_imperativeoclcs_VariableInitializationCS_StatementCS, gen_imperativeoclcs_WhileExpCS_ExpressionBlockCS, gen_imperativeoclcs_ListLiteralExpCS_ExpCS, gen_imperativeoclcs_LogExpCS_CallExpCS, gen_imperativeoclcs_QuitExpCS_StatementCS, gen_imperativeoclcs_RaiseExpCS_StatementCS, gen_imperativeoclcs_ReturnExpCS_ExpCS, gen_imperativeoclcs_StatementCS_ExpCS, gen_imperativeoclcs_SwitchAltCS_StatementCS},
    metadata=None
)
