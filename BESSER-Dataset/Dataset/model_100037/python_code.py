...
class publication2014b_Progress(Labelled):
    ...
    def __init__(self, percent: int, time: int, publication2014b_Progress: "publication2014b_PublicationProcess" = None, progress: "publication2014b_Paper" = None, Progress: "publication2014b_Paper" = None):
...
class publication2014b_PublicationPhase:
    ...
    def __init__(self, name: str, minTime: int, maxTime: int, publication2014b_PublicationPhase4: set["publication2014b_Sequence"] = None, phaseParticipation: set["publication2014b_Researcher"] = None, publication2014b_PublicationPhase7: set["publication2014b_Rule"] = None, publication2014b_PublicationPhase: "publication2014b_PublicationProcess" = None, PublicationPhase: "publication2014b_Researcher" = None, publication2014b_PublicationPhase11: "publication2014b_Sequence" = None, publication2014b_PublicationPhase14: "publication2014b_Sequence" = None):
        self.name = name
...
class publication2014b_Paragraph(Counted, Named):
    ...
    def __init__(self, content: str, publication2014b_Paragraph: "publication2014b_Paper" = None, publication2014b_Paragraph32: "publication2014b_Write" = None, publication2014b_Paragraph25: set["publication2014b_ReviewNote"] = None):
...
class publication2014b_ReviewNote(Named):
    ...
    def __init__(self, content: str, publication2014b_ReviewNote35: "publication2014b_Review" = None, publication2014b_ReviewNote: "publication2014b_Paragraph" = None):
        self.content = content
...
class publication2014b_PublicationProcess(Named):
    ...
    def __init__(self, minTime: int, maxTime: int, publication2014b_PublicationProcess42: "publication2014b_PublicationSystem" = None, publication2014b_PublicationProcess2: set["publication2014b_Rule"] = None, publication2014b_PublicationProcess: set["publication2014b_PublicationPhase"] = None, publication2014b_PublicationProcess27: "publication2014b_Progress" = None):
        self.minTime = minTime
        self.maxTime = maxTime
