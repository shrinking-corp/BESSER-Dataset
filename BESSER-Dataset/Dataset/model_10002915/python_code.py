...
class WebUser:
    ...
    def __init__(self, login: str, password: str, state: UserState, customer4: "Customer" = None, shoppingCart2: "ShoppingCart" = None):
        self.login = login
...
class Account:
    ...
    def __init__(self, billingAddress: str, open: date, closed: date, isClosed: bool, customer7: "Customer" = None, cart8: "ShoppingCart" = None, order16: set["Order"] = None, p0: set["Payment"] = None):
