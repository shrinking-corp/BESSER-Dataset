...
# Classes
DML_InsertsStatements = Class(name="DML_InsertsStatements")
DML_InsertInto = Class(name="DML_InsertInto")
DML_Registry = Class(name="DML_Registry")
DML_Column = Class(name="DML_Column")
DML_Value = Class(name="DML_Value")
