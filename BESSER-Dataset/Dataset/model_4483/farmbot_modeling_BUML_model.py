...
# Classes
farmbot_modeling_Farmbot = Class(name="farmbot_modeling_Farmbot")
farmbot_modeling_FindHome = Class(name="farmbot_modeling_FindHome")
farmbot_modeling_Sequence = Class(name="farmbot_modeling_Sequence")
Instruction = Class(name="Instruction")
farmbot_modeling_SequenceInstruction = Class(name="farmbot_modeling_SequenceInstruction", is_abstract=True)
farmbot_modeling_Instruction = Class(name="farmbot_modeling_Instruction", is_abstract=True)
farmbot_modeling_SequenceCommand = Class(name="farmbot_modeling_SequenceCommand", is_abstract=True)
Command = Class(name="Command")
SequenceInstruction = Class(name="SequenceInstruction")
farmbot_modeling_Move = Class(name="farmbot_modeling_Move", is_abstract=True)
SequenceCommand = Class(name="SequenceCommand")
farmbot_modeling_TurnOnDigital = Class(name="farmbot_modeling_TurnOnDigital")
farmbot_modeling_TurnOff = Class(name="farmbot_modeling_TurnOff")
farmbot_modeling_MoveRelative = Class(name="farmbot_modeling_MoveRelative")
Move = Class(name="Move")
farmbot_modeling_SendMessage = Class(name="farmbot_modeling_SendMessage")
farmbot_modeling_If = Class(name="farmbot_modeling_If")
farmbot_modeling_BooleanExpression = Class(name="farmbot_modeling_BooleanExpression", is_abstract=True)
farmbot_modeling_ExecuteSequence = Class(name="farmbot_modeling_ExecuteSequence")
farmbot_modeling_MoveAbsolute = Class(name="farmbot_modeling_MoveAbsolute")
farmbot_modeling_Wait = Class(name="farmbot_modeling_Wait")
farmbot_modeling_Schedule = Class(name="farmbot_modeling_Schedule")
farmbot_modeling_RunFarmware = Class(name="farmbot_modeling_RunFarmware")
farmbot_modeling_TakePhoto = Class(name="farmbot_modeling_TakePhoto")
farmbot_modeling_IsEqualTo = Class(name="farmbot_modeling_IsEqualTo")
BooleanExpression = Class(name="BooleanExpression")
farmbot_modeling_IsNotEqualTo = Class(name="farmbot_modeling_IsNotEqualTo")
farmbot_modeling_IsGreaterThan = Class(name="farmbot_modeling_IsGreaterThan")
farmbot_modeling_IsLowerThan = Class(name="farmbot_modeling_IsLowerThan")
farmbot_modeling_Command = Class(name="farmbot_modeling_Command", is_abstract=True)
farmbot_modeling_ListSequences = Class(name="farmbot_modeling_ListSequences")
farmbot_modeling_ListScheduledEvents = Class(name="farmbot_modeling_ListScheduledEvents")
farmbot_modeling_TurnOnAnalog = Class(name="farmbot_modeling_TurnOnAnalog")
...
farmbot_modeling_Move.attributes={farmbot_modeling_Move_y, farmbot_modeling_Move_z, farmbot_modeling_Move_speed, farmbot_modeling_Move_x}
...
farmbot_modeling_BooleanExpression.attributes={farmbot_modeling_BooleanExpression_value, farmbot_modeling_BooleanExpression_axe, farmbot_modeling_BooleanExpression_pinNumber}
...
farmbot_modeling_Schedule.attributes={farmbot_modeling_Schedule_startDate, farmbot_modeling_Schedule_repeatUnit, farmbot_modeling_Schedule_startTime, farmbot_modeling_Schedule_sequence, farmbot_modeling_Schedule_endTime, farmbot_modeling_Schedule_endDate, farmbot_modeling_Schedule_repeat}
...
else_5: BinaryAssociation = BinaryAssociation(
    name="else_5",
    ends={
...
domain_model = DomainModel(
    ...
    types={farmbot_modeling_Farmbot, farmbot_modeling_FindHome, farmbot_modeling_Sequence, Instruction, farmbot_modeling_SequenceInstruction, farmbot_modeling_Instruction, farmbot_modeling_SequenceCommand, Command, SequenceInstruction, farmbot_modeling_Move, SequenceCommand, farmbot_modeling_TurnOnDigital, farmbot_modeling_TurnOff, farmbot_modeling_MoveRelative, Move, farmbot_modeling_SendMessage, farmbot_modeling_If, farmbot_modeling_BooleanExpression, farmbot_modeling_ExecuteSequence, farmbot_modeling_MoveAbsolute, farmbot_modeling_Wait, farmbot_modeling_Schedule, farmbot_modeling_RunFarmware, farmbot_modeling_TakePhoto, farmbot_modeling_IsEqualTo, BooleanExpression, farmbot_modeling_IsNotEqualTo, farmbot_modeling_IsGreaterThan, farmbot_modeling_IsLowerThan, farmbot_modeling_Command, farmbot_modeling_ListSequences, farmbot_modeling_ListScheduledEvents, farmbot_modeling_TurnOnAnalog},
    associations={sequenceInstructions1, instructions0, booleanExpression2, then3, else_5},
    generalizations={gen_farmbot_modeling_FindHome_SequenceCommand, gen_farmbot_modeling_Sequence_Instruction, gen_farmbot_modeling_SequenceCommand_Command, gen_farmbot_modeling_SequenceCommand_SequenceInstruction, gen_farmbot_modeling_Move_SequenceCommand, gen_farmbot_modeling_TurnOnDigital_SequenceCommand, gen_farmbot_modeling_TurnOff_SequenceCommand, gen_farmbot_modeling_MoveRelative_Move, gen_farmbot_modeling_SendMessage_SequenceCommand, gen_farmbot_modeling_If_SequenceInstruction, gen_farmbot_modeling_MoveAbsolute_Move, gen_farmbot_modeling_ExecuteSequence_SequenceCommand, gen_farmbot_modeling_Wait_SequenceCommand, gen_farmbot_modeling_Schedule_Command, gen_farmbot_modeling_RunFarmware_SequenceCommand, gen_farmbot_modeling_TakePhoto_SequenceCommand, gen_farmbot_modeling_SequenceInstruction_Instruction, gen_farmbot_modeling_IsEqualTo_BooleanExpression, gen_farmbot_modeling_IsNotEqualTo_BooleanExpression, gen_farmbot_modeling_IsGreaterThan_BooleanExpression, gen_farmbot_modeling_IsLowerThan_BooleanExpression, gen_farmbot_modeling_Command_Instruction, gen_farmbot_modeling_ListSequences_Command, gen_farmbot_modeling_ListScheduledEvents_Command, gen_farmbot_modeling_TurnOnAnalog_SequenceCommand},
    metadata=None
)
