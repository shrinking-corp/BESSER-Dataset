...
class Behavior:
    ...
    pass
class behaviour_ActivityDiagramBehavior(Behavior, ExecutableNode):
...
class behaviour_VariableClass(Expression):
    ...
    def __init__(self, variableName: str, behaviour_VariableClass2: "behaviour_FunctionCallExpression" = None, behaviour_VariableClass: "behaviour_Type" = None):
