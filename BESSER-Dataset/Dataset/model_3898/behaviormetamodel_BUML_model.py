...
# Classes
behaviour_Expression = Class(name="behaviour_Expression", is_abstract=True)
behaviour_VariableClass = Class(name="behaviour_VariableClass", is_abstract=True)
Expression = Class(name="Expression")
behaviour_FunctionCallExpression = Class(name="behaviour_FunctionCallExpression")
behaviour_Function = Class(name="behaviour_Function")
behaviour_ConstantExpression = Class(name="behaviour_ConstantExpression")
behaviour_IntConstantExpression = Class(name="behaviour_IntConstantExpression")
ConstantExpression = Class(name="ConstantExpression")
behaviour_StringConstantExpression = Class(name="behaviour_StringConstantExpression")
behaviour_FloatConstantExpression = Class(name="behaviour_FloatConstantExpression")
behaviour_PrimitiveExpression = Class(name="behaviour_PrimitiveExpression")
behaviour_EntityPrimive = Class(name="behaviour_EntityPrimive")
PrimitiveExpression = Class(name="PrimitiveExpression")
behaviour_LocationPrimitive = Class(name="behaviour_LocationPrimitive")
behaviour_LocationSetPrimitive = Class(name="behaviour_LocationSetPrimitive")
behaviour_EntitySetPrimitive = Class(name="behaviour_EntitySetPrimitive")
behaviour_Type = Class(name="behaviour_Type")
behaviour_AttributeClass = Class(name="behaviour_AttributeClass")
VariableClass = Class(name="VariableClass")
behaviour_ParameterClass = Class(name="behaviour_ParameterClass")
behaviour_LocationExpression = Class(name="behaviour_LocationExpression", is_abstract=True)
behaviour_Duration = Class(name="behaviour_Duration", is_abstract=True)
behaviour_EquationBehaviour = Class(name="behaviour_EquationBehaviour")
Behavior = Class(name="Behavior")
behaviour_Equation = Class(name="behaviour_Equation")
behaviour_ActivityDiagramBehavior = Class(name="behaviour_ActivityDiagramBehavior")
ExecutableNode = Class(name="ExecutableNode")
behaviour_Start = Class(name="behaviour_Start")
behaviour_End = Class(name="behaviour_End")
behaviour_Edge = Class(name="behaviour_Edge", is_abstract=True)
behaviour_Node = Class(name="behaviour_Node", is_abstract=True)
behaviour_AnonymousFunction = Class(name="behaviour_AnonymousFunction")
Function = Class(name="Function")
behaviour_NamedFunction = Class(name="behaviour_NamedFunction")
behaviour_BooleanPrimitive = Class(name="behaviour_BooleanPrimitive")
behaviour_EntityClass = Class(name="behaviour_EntityClass")
behaviour_Behavior = Class(name="behaviour_Behavior", is_abstract=True)
behaviour_OccupationBooleanFunction = Class(name="behaviour_OccupationBooleanFunction")
behaviour_LogicBooleanFunction = Class(name="behaviour_LogicBooleanFunction")
behaviour_ControlNode = Class(name="behaviour_ControlNode", is_abstract=True)
Node = Class(name="Node")
behaviour_ExecutableNode = Class(name="behaviour_ExecutableNode", is_abstract=True)
behaviour_TimeExpression = Class(name="behaviour_TimeExpression", is_abstract=True)
ControlNode = Class(name="ControlNode")
behaviour_Decision = Class(name="behaviour_Decision")
behaviour_Join = Class(name="behaviour_Join")
behaviour_Fork = Class(name="behaviour_Fork")
behaviour_Merge = Class(name="behaviour_Merge")
behaviour_PrimitiveActivity = Class(name="behaviour_PrimitiveActivity", is_abstract=True)
behaviour_Move = Class(name="behaviour_Move")
PrimitiveActivity = Class(name="PrimitiveActivity")
behaviour_Die = Class(name="behaviour_Die")
behaviour_Reproduce = Class(name="behaviour_Reproduce")
behaviour_Add = Class(name="behaviour_Add")
behaviour_Remove = Class(name="behaviour_Remove")
behaviour_UnconditionedEdge = Class(name="behaviour_UnconditionedEdge")
Edge = Class(name="Edge")
behaviour_UnaryStringFunction = Class(name="behaviour_UnaryStringFunction")
UnaryFunction = Class(name="UnaryFunction")
behaviour_UnaryLocationFunction = Class(name="behaviour_UnaryLocationFunction")
behaviour_BinaryBooleanFunction = Class(name="behaviour_BinaryBooleanFunction", is_abstract=True)
BinaryFunction = Class(name="BinaryFunction")
behaviour_BinaryArithmeticFunction = Class(name="behaviour_BinaryArithmeticFunction")
behaviour_UnaryNumericFunction = Class(name="behaviour_UnaryNumericFunction")
behaviour_ComparisonBooleanFunction = Class(name="behaviour_ComparisonBooleanFunction")
BinaryBooleanFunction = Class(name="BinaryBooleanFunction")
behaviour_NameLocationExpression = Class(name="behaviour_NameLocationExpression")
LocationExpression = Class(name="LocationExpression")
behaviour_CoordinateLocationExpression = Class(name="behaviour_CoordinateLocationExpression")
behaviour_While = Class(name="behaviour_While")
TimeExpression = Class(name="TimeExpression")
behaviour_TrueEdge = Class(name="behaviour_TrueEdge")
behaviour_FalseEdge = Class(name="behaviour_FalseEdge")
behaviour_UnaryEntityFunction = Class(name="behaviour_UnaryEntityFunction")
behaviour_NumericPrimitive = Class(name="behaviour_NumericPrimitive")
behaviour_MonthDuration = Class(name="behaviour_MonthDuration")
Duration = Class(name="Duration")
behaviour_BinaryFunction = Class(name="behaviour_BinaryFunction")
NamedFunction = Class(name="NamedFunction")
behaviour_UnaryFunction = Class(name="behaviour_UnaryFunction")
behaviour_BinaryLocationFunction = Class(name="behaviour_BinaryLocationFunction")
...
behaviour_Behavior.attributes={behaviour_Behavior_behaviorName, behaviour_Behavior_frequency}
...
from_48: BinaryAssociation = BinaryAssociation(
    name="from_48",
    ends={
...
domain_model = DomainModel(
    name="behaviour",
    types={behaviour_Expression, behaviour_VariableClass, Expression, behaviour_FunctionCallExpression, behaviour_Function, behaviour_ConstantExpression, behaviour_IntConstantExpression, ConstantExpression, behaviour_StringConstantExpression, behaviour_FloatConstantExpression, behaviour_PrimitiveExpression, behaviour_EntityPrimive, PrimitiveExpression, behaviour_LocationPrimitive, behaviour_LocationSetPrimitive, behaviour_EntitySetPrimitive, behaviour_Type, behaviour_AttributeClass, VariableClass, behaviour_ParameterClass, behaviour_LocationExpression, behaviour_Duration, behaviour_EquationBehaviour, Behavior, behaviour_Equation, behaviour_ActivityDiagramBehavior, ExecutableNode, behaviour_Start, behaviour_End, behaviour_Edge, behaviour_Node, behaviour_AnonymousFunction, Function, behaviour_NamedFunction, behaviour_BooleanPrimitive, behaviour_EntityClass, behaviour_Behavior, behaviour_OccupationBooleanFunction, behaviour_LogicBooleanFunction, behaviour_ControlNode, Node, behaviour_ExecutableNode, behaviour_TimeExpression, ControlNode, behaviour_Decision, behaviour_Join, behaviour_Fork, behaviour_Merge, behaviour_PrimitiveActivity, behaviour_Move, PrimitiveActivity, behaviour_Die, behaviour_Reproduce, behaviour_Add, behaviour_Remove, behaviour_UnconditionedEdge, Edge, behaviour_UnaryStringFunction, UnaryFunction, behaviour_UnaryLocationFunction, behaviour_BinaryBooleanFunction, BinaryFunction, behaviour_BinaryArithmeticFunction, behaviour_UnaryNumericFunction, behaviour_ComparisonBooleanFunction, BinaryBooleanFunction, behaviour_NameLocationExpression, LocationExpression, behaviour_CoordinateLocationExpression, behaviour_While, TimeExpression, behaviour_TrueEdge, behaviour_FalseEdge, behaviour_UnaryEntityFunction, behaviour_NumericPrimitive, behaviour_MonthDuration, Duration, behaviour_BinaryFunction, NamedFunction, behaviour_UnaryFunction, behaviour_BinaryLocationFunction, TypeEnum, LocationSetPrimiveEnum, LocationPrimiveEnum, EntitySetPrimiveEnum, EntityPrimitiveEnum, UnaryNumericFunctionEnum, ComparisonBooleanFunctionEnum, OccupationBooleanFunctionEnum, UnaryStringFunctionEnum, UnaryLocationFunctionEnum, LogicBooleanFunctionEnum, DurationTypeEnum, WeekDaysEnum, MonthsEnum, BooleanPrimitiveEnum, UnaryEntityFunctionEnum, ArithmeticFunctionEnum, UnaryLocationEnum},
    associations={arguments1, function3, domaine5, codomaine8, type0, attribute12, startTime14, endTime16, parameters19, equation21, start22, end23, edge25, node27, left29, right32, behaviour11, source34, target37, expression40, expression42, expression44, to46, from_48},
    generalizations={gen_behaviour_FunctionCallExpression_Expression, gen_behaviour_ConstantExpression_Expression, gen_behaviour_IntConstantExpression_ConstantExpression, gen_behaviour_StringConstantExpression_ConstantExpression, gen_behaviour_FloatConstantExpression_ConstantExpression, gen_behaviour_PrimitiveExpression_Expression, gen_behaviour_EntityPrimive_PrimitiveExpression, gen_behaviour_LocationPrimitive_PrimitiveExpression, gen_behaviour_LocationSetPrimitive_PrimitiveExpression, gen_behaviour_EntitySetPrimitive_PrimitiveExpression, gen_behaviour_VariableClass_Expression, gen_behaviour_AttributeClass_VariableClass, gen_behaviour_ParameterClass_VariableClass, gen_behaviour_LocationExpression_Expression, gen_behaviour_EquationBehaviour_Behavior, gen_behaviour_ActivityDiagramBehavior_Behavior, gen_behaviour_ActivityDiagramBehavior_ExecutableNode, gen_behaviour_AnonymousFunction_Function, gen_behaviour_NamedFunction_Function, gen_behaviour_BooleanPrimitive_PrimitiveExpression, gen_behaviour_OccupationBooleanFunction_BinaryBooleanFunction, gen_behaviour_LogicBooleanFunction_BinaryBooleanFunction, gen_behaviour_ControlNode_Node, gen_behaviour_ExecutableNode_Node, gen_behaviour_TimeExpression_ControlNode, gen_behaviour_Decision_ControlNode, gen_behaviour_Join_ControlNode, gen_behaviour_Start_ControlNode, gen_behaviour_End_ControlNode, gen_behaviour_Fork_ControlNode, gen_behaviour_Merge_ControlNode, gen_behaviour_PrimitiveActivity_ExecutableNode, gen_behaviour_Move_PrimitiveActivity, gen_behaviour_Die_PrimitiveActivity, gen_behaviour_Reproduce_PrimitiveActivity, gen_behaviour_Add_PrimitiveActivity, gen_behaviour_Remove_PrimitiveActivity, gen_behaviour_UnconditionedEdge_Edge, gen_behaviour_UnaryStringFunction_UnaryFunction, gen_behaviour_UnaryLocationFunction_UnaryFunction, gen_behaviour_BinaryBooleanFunction_BinaryFunction, gen_behaviour_BinaryArithmeticFunction_BinaryFunction, gen_behaviour_UnaryNumericFunction_UnaryFunction, gen_behaviour_ComparisonBooleanFunction_BinaryBooleanFunction, gen_behaviour_NameLocationExpression_LocationExpression, gen_behaviour_CoordinateLocationExpression_LocationExpression, gen_behaviour_While_TimeExpression, gen_behaviour_TrueEdge_Edge, gen_behaviour_FalseEdge_Edge, gen_behaviour_UnaryEntityFunction_UnaryFunction, gen_behaviour_MonthDuration_Duration, gen_behaviour_BinaryFunction_NamedFunction, gen_behaviour_UnaryFunction_NamedFunction, gen_behaviour_BinaryLocationFunction_BinaryFunction},
    metadata=None
)
