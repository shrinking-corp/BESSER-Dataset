...
expressions_ComparisonOperator = Class(name="expressions_ComparisonOperator")
expressions_ComparisonOperand = Class(name="expressions_ComparisonOperand")
expressions_GE = Class(name="expressions_GE")
ComparisonOperator = Class(name="ComparisonOperator")
expressions_G = Class(name="expressions_G")
expressions_LE = Class(name="expressions_LE")
expressions_L = Class(name="expressions_L")
expressions_E = Class(name="expressions_E")
expressions_D = Class(name="expressions_D")
expressions_Quantity = Class(name="expressions_Quantity")
ComparisonOperand = Class(name="ComparisonOperand")
expressions_Function = Class(name="expressions_Function")
expressions_Count = Class(name="expressions_Count")
Function = Class(name="Function")
expressions_QuantifyOperator = Class(name="expressions_QuantifyOperator")
...
domain_model = DomainModel(
    name="expressions",
    types={expressions_Expression, expressions_BinaryOperator, Expression, expressions_UnaryOperator, expressions_Implies, BinaryOperator, expressions_Or, expressions_Feature, expressions_All, QuantifyOperator, expressions_Number, expressions_Any, expressions_ComparisonOperator, expressions_ComparisonOperand, expressions_GE, ComparisonOperator, expressions_G, expressions_LE, expressions_L, expressions_E, expressions_D, expressions_Quantity, ComparisonOperand, expressions_Function, expressions_Count, Function, expressions_QuantifyOperator, expressions_And, expressions_Neg, UnaryOperator, expressions_Model},
    associations={op10, op21, op4, op18, op29, op12, op13, constraints6},
    generalizations={gen_expressions_BinaryOperator_Expression, gen_expressions_UnaryOperator_Expression, gen_expressions_Implies_BinaryOperator, gen_expressions_Or_BinaryOperator, gen_expressions_Feature_Expression, gen_expressions_All_QuantifyOperator, gen_expressions_Number_QuantifyOperator, gen_expressions_Any_QuantifyOperator, gen_expressions_ComparisonOperator_Expression, gen_expressions_GE_ComparisonOperator, gen_expressions_G_ComparisonOperator, gen_expressions_LE_ComparisonOperator, gen_expressions_L_ComparisonOperator, gen_expressions_E_ComparisonOperator, gen_expressions_D_ComparisonOperator, gen_expressions_ComparisonOperand_Expression, gen_expressions_Quantity_ComparisonOperand, gen_expressions_Function_ComparisonOperand, gen_expressions_Count_Function, gen_expressions_QuantifyOperator_Expression, gen_expressions_And_BinaryOperator, gen_expressions_Neg_UnaryOperator},
    metadata=None
)
