...
class dSL_Distance:
    ...
    def __init__(self, value: int, dSL_Distance: "dSL_Condition" = None, dSL_Distance16: "dSL_Action" = None):
        self.value = value
...
class dSL_Condition:
    ...
    def __init__(self, not_: bool, allLakes: bool, collision: bool, atLake: bool, isProbed: bool, dSL_Condition: "dSL_ConditionList" = None, dSL_Condition9: "dSL_Condition" = None, dSL_Condition7: "dSL_Condition" = None, dSL_Condition11: "dSL_Distance" = None):
        self.not_ = not_
...
class dSL_Action:
    ...
    def __init__(self, showLakes: bool, driveDirection: bool, direction: str, driveDistance: bool, steer: bool, probeLake: bool, blinkLights: bool, dSL_Action: "dSL_ActionList" = None, dSL_Action15: "dSL_Distance" = None, dSL_Action18: "dSL_Angle" = None):
