...
class aggregator_p2view_InstallableUnits:
    ...
    def __init__(self, aggregator_p2view_InstallableUnits81: "Products" = None, aggregator_p2view_InstallableUnits83: "Bundles" = None, aggregator_p2view_InstallableUnits85: "Fragments" = None, aggregator_p2view_InstallableUnits87: "Miscellaneous" = None, aggregator_p2view_InstallableUnits: "Categories" = None, aggregator_p2view_InstallableUnits79: "Features" = None):
...
class aggregator_p2_IAdaptable(ABC):
    ...
    def __init__(self):
        ...
        pass
    def getAdapter(self, aggregator_adapter) :
...
class aggregator_p2_IRepository(IAdaptable):
    ...
    def setProperty(self, aggregator_value, aggregator_key) :
...
class aggregator_p2_IMetadataRepository(p2_IRepository, p2_IQueryable):
    ...
    def addReference(self, aggregator_options, aggregator_type, aggregator_nickname, aggregator_location):
        # TODO: Implement addReference method
        pass

    def removeInstallableUnits(self, aggregator_monitor, aggregator_query) :
        # TODO: Implement removeInstallableUnits method
        pass

    def addInstallableUnits(self, aggregator_installableUnits):
...
class aggregator_p2_IQueryable(ABC):
    ...
    def __init__(self):
        ...
        pass
    def query(self, aggregator_query, aggregator_collector, aggregator_progress) :
...
class aggregator_p2_IUpdateDescriptor(ABC):
    ...
    def isUpdateOf(self, aggregator_iu) :
...
class aggregator_p2_IRequiredCapability(ABC):
    ...
    def __init__(self, name: str, namespace: str, range: str, negation: bool, selectorList: str, multiple: bool, optional: bool, greedy: bool, filter: str):
        self.name = name
    ...
    def setSelectors(self, aggregator_selectors):
    ...
    def satisfiedBy(self, aggregator_capability) :
...
class aggregator_p2_IProvidedCapability(ABC):
    ...
    def satisfies(self, aggregator_requirement) :
...
class aggregator_p2_InstallableUnit(IInstallableUnit):
    ...
    def compareTo(self, aggregator_other) :
...
class aggregator_p2_ITouchpointData(ABC):
    ...
    def __init__(self):
        ...
        pass
    def getInstruction(self, aggregator_instructionKey) :
...
class aggregator_p2_IInstallableUnit(ABC):
    ...
    def getMetaRequiredCapabilities(self) :
        # TODO: Implement getMetaRequiredCapabilities method
        pass

    def getRequiredCapabilities(self) :
        # TODO: Implement getRequiredCapabilities method
        pass

    def getProperty(self, aggregator_key) :
    ...
    def satisfies(self, aggregator_candidate) :
        # TODO: Implement satisfies method
        pass
...
class StatusProvider:
    ...
    pass
class aggregator_InstallableUnitReference(InfosProvider, StatusProvider):
    ...
    def getInstallableUnit(self, aggregator_forceResolve) :
        # TODO: Implement getInstallableUnit method
        pass

class aggregator_MavenMapping(InfosProvider, StatusProvider):

    def __init__(self, namePattern: str, groupId: str, artifactId: str, aggregator_MavenMapping29: "aggregator_Contribution" = None, aggregator_MavenMapping: "aggregator_Aggregator" = None):
...
class aggregator_CustomCategory(InfosProvider, StatusProvider):
    ...
    def __init__(self, identifier: str, label: str, description: str, CustomCategory: "aggregator_Feature" = None, categories: set["aggregator_Feature"] = None, aggregator_CustomCategory: "aggregator_Aggregator" = None):
...
class aggregator_MetadataRepositoryReference(InfosProvider, StatusProvider, EnabledStatusProvider):
    ...
    def __init__(self, location: str, nature: str, aggregator_MetadataRepositoryReference39: "MetadataRepository" = None, aggregator_MetadataRepositoryReference: "aggregator_Aggregator" = None):
        self.location = location
        self.nature = nature
    ...
    def getMetadataRepository(self, aggregator_forceResolve) :
...
class aggregator_MappedRepository(DescriptionProvider, MetadataRepositoryReference):
    ...
    def __init__(self, mirrorArtifacts: bool, categoryPrefix: str, aggregator_MappedRepository23: "aggregator_Contribution" = None, aggregator_MappedRepository18: set["aggregator_Category"] = None, aggregator_MappedRepository20: set["aggregator_MapRule"] = None, aggregator_MappedRepository: set["aggregator_Product"] = None, aggregator_MappedRepository14: set["aggregator_Bundle"] = None, aggregator_MappedRepository16: set["aggregator_Feature"] = None):
...
class aggregator_Aggregator(DescriptionProvider, InfosProvider, StatusProvider):
    ...
    def getValidationRepositories(self, aggregator_enabledOnly) :
        # TODO: Implement getValidationRepositories method
        pass

    def getContributions(self, aggregator_enabledOnly) :
        # TODO: Implement getContributions method
        pass

class aggregator_Contact:

    def __init__(self, name: str, email: str, aggregator_Contact26: "aggregator_Contribution" = None, contacts: "aggregator_Aggregator" = None, aggregator_Contact: "aggregator_Aggregator" = None, Contact: "aggregator_Aggregator" = None):
        self.name = name
        self.email = email
...
class aggregator_Contribution(DescriptionProvider, InfosProvider, StatusProvider, EnabledStatusProvider):

    def __init__(self, label: str, aggregator_Contribution22: set["aggregator_MappedRepository"] = None, aggregator_Contribution25: set["aggregator_Contact"] = None, aggregator_Contribution28: set["aggregator_MavenMapping"] = None, aggregator_Contribution: "aggregator_Aggregator" = None):
        self.label = label
...
class aggregator_Configuration(EnabledStatusProvider):
    ...
    def __init__(self, operatingSystem: str, windowSystem: str, architecture: str, aggregator_Configuration33: "aggregator_MappedUnit" = None, aggregator_Configuration37: "aggregator_ValidConfigurationsRule" = None, aggregator_Configuration: "aggregator_Aggregator" = None):
