...
def test_hyp_decisiontree_property_is_not_abstract():
    assert not inspect.isabstract(DecisionTree_Property)


def test_hyp_decisiontree_property_constructor_exists():
    assert callable(DecisionTree_Property.__init__)


def test_hyp_decisiontree_property_constructor_args():
    sig = inspect.signature(DecisionTree_Property.__init__)
    params = list(sig.parameters.keys())



def test_hyp_decisiontree_decisiontrees_is_not_abstract():
    assert not inspect.isabstract(DecisionTree_DecisionTrees)


def test_hyp_decisiontree_decisiontrees_constructor_exists():
    assert callable(DecisionTree_DecisionTrees.__init__)


def test_hyp_decisiontree_decisiontrees_constructor_args():
...
def test_hyp_decisiontree_entitytype_is_not_abstract():
    assert not inspect.isabstract(DecisionTree_EntityType)


def test_hyp_decisiontree_entitytype_constructor_exists():
    assert callable(DecisionTree_EntityType.__init__)


def test_hyp_decisiontree_entitytype_constructor_args():
    sig = inspect.signature(DecisionTree_EntityType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_decisiontree_decisiontreeforentity_is_not_abstract():
    assert not inspect.isabstract(DecisionTree_DecisionTreeForEntity)


def test_hyp_decisiontree_decisiontreeforentity_constructor_exists():
    assert callable(DecisionTree_DecisionTreeForEntity.__init__)


def test_hyp_decisiontree_decisiontreeforentity_constructor_args():
    sig = inspect.signature(DecisionTree_DecisionTreeForEntity.__init__)
    params = list(sig.parameters.keys())



def test_hyp_decisiontree_propertyspec2_is_not_abstract():
    assert not inspect.isabstract(DecisionTree_PropertySpec2)


def test_hyp_decisiontree_propertyspec2_constructor_exists():
    assert callable(DecisionTree_PropertySpec2.__init__)


def test_hyp_decisiontree_propertyspec2_constructor_args():
...
def test_hyp_decisiontree_structuralvariation_is_not_abstract():
    assert not inspect.isabstract(DecisionTree_StructuralVariation)


def test_hyp_decisiontree_structuralvariation_constructor_exists():
    assert callable(DecisionTree_StructuralVariation.__init__)


def test_hyp_decisiontree_structuralvariation_constructor_args():
    sig = inspect.signature(DecisionTree_StructuralVariation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_decisiontreenode_is_not_abstract():
    assert not inspect.isabstract(DecisionTreeNode)


def test_hyp_decisiontreenode_constructor_exists():
    assert callable(DecisionTreeNode.__init__)


def test_hyp_decisiontreenode_constructor_args():
    sig = inspect.signature(DecisionTreeNode.__init__)
    params = list(sig.parameters.keys())



def test_hyp_decisiontree_intermediatenode_is_not_abstract():
    assert not inspect.isabstract(DecisionTree_IntermediateNode)


def test_hyp_decisiontree_intermediatenode_constructor_exists():
    assert callable(DecisionTree_IntermediateNode.__init__)


def test_hyp_decisiontree_intermediatenode_constructor_args():
    sig = inspect.signature(DecisionTree_IntermediateNode.__init__)
    params = list(sig.parameters.keys())



def test_hyp_decisiontree_leafnode_is_not_abstract():
    assert not inspect.isabstract(DecisionTree_LeafNode)


def test_hyp_decisiontree_leafnode_constructor_exists():
    assert callable(DecisionTree_LeafNode.__init__)


def test_hyp_decisiontree_leafnode_constructor_args():
    sig = inspect.signature(DecisionTree_LeafNode.__init__)
    params = list(sig.parameters.keys())



def test_hyp_decisiontree_decisiontreenode_is_not_abstract():
    assert not inspect.isabstract(DecisionTree_DecisionTreeNode)


def test_hyp_decisiontree_decisiontreenode_constructor_exists():
    assert callable(DecisionTree_DecisionTreeNode.__init__)


def test_hyp_decisiontree_decisiontreenode_constructor_args():
...
def test_hyp_decisiontree_decisiontrees_name_setter(instance):
...
def test_hyp_decisiontree_propertyspec2_needsTypeCheck_setter(instance):
