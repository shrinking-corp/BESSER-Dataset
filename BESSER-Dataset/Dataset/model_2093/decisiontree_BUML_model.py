...
# Classes
DecisionTree_DecisionTreeNode = Class(name="DecisionTree_DecisionTreeNode", is_abstract=True)
DecisionTree_LeafNode = Class(name="DecisionTree_LeafNode")
DecisionTreeNode = Class(name="DecisionTreeNode")
DecisionTree_StructuralVariation = Class(name="DecisionTree_StructuralVariation")
DecisionTree_IntermediateNode = Class(name="DecisionTree_IntermediateNode")
DecisionTree_PropertySpec2 = Class(name="DecisionTree_PropertySpec2")
DecisionTree_DecisionTreeForEntity = Class(name="DecisionTree_DecisionTreeForEntity")
DecisionTree_EntityType = Class(name="DecisionTree_EntityType")
DecisionTree_DecisionTrees = Class(name="DecisionTree_DecisionTrees")
DecisionTree_Property = Class(name="DecisionTree_Property")
