...
domain_model = DomainModel(
    name="types",
    types={types_TypedElement, types_Package, NamedElement, types_PackageMember, types_Type, PackageMember, types_TypeConstraint, types_Feature, TypedElement, types_ComplexType, types_Operation, Feature, types_Parameter, types_Property, types_Event, types_EnumerationType, PrimitiveType, types_Enumerator, types_PrimitiveType, Type, ParameterizedType, types_TypeParameter, types_ParameterizedType},
    associations={owningOperation4, member0, constraint1, owningType2, parameters3, type5, typeArguments7, enumerator10, baseType12, features13, superTypes15, owningEnumeration16, bound17, parameter19},
