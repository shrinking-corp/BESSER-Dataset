...
statemachine_Transition.attributes={statemachine_Transition_sourceLabel, statemachine_Transition_actionStatement, statemachine_Transition_targetLabel, statemachine_Transition_guardExpression, statemachine_Transition_actionLabel, statemachine_Transition_label, statemachine_Transition_guardLabel}
...
domain_model = DomainModel(
    name="statemachine",
    types={statemachine_Declaration, statemachine_StateMachine, statemachine_StateMachineVariable, statemachine_Transition, Declaration, statemachine_State, statemachine_Action, statemachine_NormalState, State, statemachine_InitialState, statemachine_FinalState},
