...
class company_Company:
    ...
    def __init__(self, name: str, eotmDelta: str, Company: "company_Division" = None, company: "company_Division" = None, company_Company: "company_Employee" = None):
        self.name = name
...
class company_Employee:
    ...
    def __init__(self, name: str, age: str, salary: str, director: "company_Division" = None, company_Employee: "company_Employee" = None, company_Employee4: "company_Employee" = None, company_Employee7: "company_Student" = None, Employee: "company_Department" = None, Employee10: "company_Department" = None, Employee22: "company_Division" = None, company_Employee25: "company_Division" = None, company_Employee18: "company_Department" = None, company_Employee30: "company_Company" = None, employee: "company_Department" = None, boss: "company_Department" = None):
        self.name = name
        self.age = age
        self.salary = salary
...
class company_Division:
    ...
    def __init__(self, name: str, budget: str, numberEmployeesOfTheMonth: str, Division: "company_Employee" = None, company_Division: set["company_Department"] = None, directed: "company_Employee" = None, company_Division24: set["company_Employee"] = None, division: "company_Company" = None, Division28: "company_Company" = None):
        self.name = name
        self.budget = budget
    ...
    @property
    def numberEmployeesOfTheMonth(self):
...
class company_Department:
    ...
    def __init__(self, name: str, maxJuniors: str, budget: str, biggestNumberOfStudentsOrFreelancers: str, employer: set["company_Employee"] = None, managed: "company_Employee" = None, company_Department20: "company_Division" = None, Department13: "company_Department" = None, parentDepartment: set["company_Department"] = None, Department16: "company_Department" = None, subDepartment: "company_Department" = None, company_Department: set["company_Employee"] = None, Department: "company_Employee" = None, Department2: "company_Employee" = None):
        self.name = name
    ...
    @property
    def biggestNumberOfStudentsOrFreelancers(self):
