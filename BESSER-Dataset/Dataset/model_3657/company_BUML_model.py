...
# Classes
company_Department = Class(name="company_Department")
company_Division = Class(name="company_Division")
company_Student = Class(name="company_Student")
company_Employee = Class(name="company_Employee")
company_Freelance = Class(name="company_Freelance")
...
company_Department.attributes={company_Department_maxJuniors, company_Department_biggestNumberOfStudentsOrFreelancers, company_Department_name, company_Department_budget}
...
company_Division.attributes={company_Division_budget, company_Division_numberEmployeesOfTheMonth, company_Division_name}
...
company_Employee.attributes={company_Employee_salary, company_Employee_name, company_Employee_age}
...
domain_model = DomainModel(
    name="company",
    types={company_Department, company_Division, company_Student, company_Employee, company_Freelance, Employee, company_Company},
    associations={employer0, managed1, directed3, secretary5, intern6, employee8, boss9, department19, director21, employeesOfTheMonth23, company26, subDepartment12, parentDepartment15, employeeOfTheMonth17, division27, divisionDirector29},
