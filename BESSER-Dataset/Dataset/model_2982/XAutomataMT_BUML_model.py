...
automata_Guard = Class(name="automata_Guard")
...
automata_Automaton_m_initializeModel: Method = Method(name="initializeModel", parameters={Parameter(name='automata_args', type=StringType)})
automata_Automaton_m_main: Method = Method(name="main", parameters={})
automata_Automaton.methods={automata_Automaton_m_assignInitialValues, automata_Automaton_m_main, automata_Automaton_m_determineInitialState, automata_Automaton_m_initializeModel}
...
automata_StringVariable.attributes={automata_StringVariable_initialValue, automata_StringVariable_value}
...
automata_NumberVariable.attributes={automata_NumberVariable_value, automata_NumberVariable_initialValue}
...
domain_model = DomainModel(
    name="automata",
    types={automata_Automaton, automata_State, automata_Transition, automata_Variable, automata_Guard, automata_Action, automata_StringVariable, Variable, automata_NumberVariable, automata_BooleanVariable, automata_BooleanGuard, Guard, automata_StringGuard, automata_NumberGuard, automata_StringAction, automata_BooleanAction, Action, automata_NumberAction, BooleanOperator, StringOperator, NumberOperator},
    associations={states0, transitions1, variables3, source5, target8, guard11, action13, source15, source16, source17, target20, target22, target18},
    generalizations={gen_automata_StringVariable_Variable, gen_automata_NumberVariable_Variable, gen_automata_BooleanVariable_Variable, gen_automata_BooleanGuard_Guard, gen_automata_StringGuard_Guard, gen_automata_NumberGuard_Guard, gen_automata_BooleanAction_Action, gen_automata_StringAction_Action, gen_automata_NumberAction_Action},
    metadata=None
)
