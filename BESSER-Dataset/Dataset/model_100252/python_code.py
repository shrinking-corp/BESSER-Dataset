...
class Styling_Icon:
    ...
    def Styling_Icon(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "Styling_CaseStyle13"):
                opp_val = getattr(old_value, "Styling_CaseStyle13", None)
                if opp_val == self:
                    setattr(old_value, "Styling_CaseStyle13", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "Styling_CaseStyle13"):
                opp_val = getattr(value, "Styling_CaseStyle13", None)
                setattr(value, "Styling_CaseStyle13", self)
...
class Styling_Pattern(ABC):
    ...
    def Styling_Pattern(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "Styling_Segment8"):
                opp_val = getattr(old_value, "Styling_Segment8", None)
                if opp_val == self:
                    setattr(old_value, "Styling_Segment8", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "Styling_Segment8"):
                opp_val = getattr(value, "Styling_Segment8", None)
                setattr(value, "Styling_Segment8", self)
...
class Styling_Segment:
    ...
    def __init__(self, Styling_Segment: "Styling_Style" = None, Styling_Segment8: "Styling_Pattern" = None, Styling_Segment11: "Styling_CaseStyle" = None):
        self.Styling_Segment = Styling_Segment
        self.Styling_Segment8 = Styling_Segment8
        self.Styling_Segment11 = Styling_Segment11
        
        pass
    @property
    def Styling_Segment11(self):
        return self.__Styling_Segment11

    @Styling_Segment11.setter
    def Styling_Segment11(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Styling_Segment__Styling_Segment11", None)
        self.__Styling_Segment11 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "Styling_CaseStyle10"):
                opp_val = getattr(old_value, "Styling_CaseStyle10", None)
                if isinstance(opp_val, set):
                    opp_val.discard(self)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "Styling_CaseStyle10"):
                opp_val = getattr(value, "Styling_CaseStyle10", None)
                if opp_val is None:
                    setattr(value, "Styling_CaseStyle10", set([self]))
                elif isinstance(opp_val, set):
                    opp_val.add(self)
    ...
    @property
    def Styling_Segment8(self):
        return self.__Styling_Segment8

    @Styling_Segment8.setter
    def Styling_Segment8(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Styling_Segment__Styling_Segment8", None)
        self.__Styling_Segment8 = value
...
class Styling_CaseStyle(ABC):
    ...
    def __init__(self, Styling_CaseStyle10: set["Styling_Segment"] = None, Styling_CaseStyle13: "Styling_Icon" = None, Styling_CaseStyle: "Styling_StylingModel" = None):
        self.Styling_CaseStyle10 = Styling_CaseStyle10 if Styling_CaseStyle10 is not None else set()
        self.Styling_CaseStyle13 = Styling_CaseStyle13
        self.Styling_CaseStyle = Styling_CaseStyle
        
        pass
    @property
    def Styling_CaseStyle10(self):
        return self.__Styling_CaseStyle10

    @Styling_CaseStyle10.setter
    def Styling_CaseStyle10(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Styling_CaseStyle__Styling_CaseStyle10", None)
        self.__Styling_CaseStyle10 = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "Styling_Segment11"):
                    opp_val = getattr(item, "Styling_Segment11", None)
                    
                    if opp_val == self:
                        setattr(item, "Styling_Segment11", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "Styling_Segment11"):
                    ...
                    setattr(item, "Styling_Segment11", self)
                    

    @property
    def Styling_CaseStyle13(self):
        return self.__Styling_CaseStyle13

    @Styling_CaseStyle13.setter
    def Styling_CaseStyle13(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Styling_CaseStyle__Styling_CaseStyle13", None)
        self.__Styling_CaseStyle13 = value
...
class Styling_StylingModel:
    ...
    def __init__(self, modeName: str, Styling_StylingModel2: "Styling_Default" = None, Styling_StylingModel4: "Styling_Basic" = None, Styling_StylingModel15: "Styling_Styling" = None, Styling_StylingModel: set["Styling_CaseStyle"] = None):
        self.modeName = modeName
        self.Styling_StylingModel2 = Styling_StylingModel2
        self.Styling_StylingModel4 = Styling_StylingModel4
        self.Styling_StylingModel15 = Styling_StylingModel15
    ...
    @property
    def Styling_StylingModel15(self):
        return self.__Styling_StylingModel15

    @Styling_StylingModel15.setter
    def Styling_StylingModel15(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Styling_StylingModel__Styling_StylingModel15", None)
        self.__Styling_StylingModel15 = value
    ...
    @property
    def Styling_StylingModel4(self):
        return self.__Styling_StylingModel4

    @Styling_StylingModel4.setter
    def Styling_StylingModel4(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Styling_StylingModel__Styling_StylingModel4", None)
        self.__Styling_StylingModel4 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "Styling_Basic"):
                opp_val = getattr(old_value, "Styling_Basic", None)
                if opp_val == self:
                    setattr(old_value, "Styling_Basic", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "Styling_Basic"):
                opp_val = getattr(value, "Styling_Basic", None)
                setattr(value, "Styling_Basic", self)
