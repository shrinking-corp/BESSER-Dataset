...
PetriNets_InputArc = Class(name="PetriNets_InputArc")
PetriNets_OutputArc = Class(name="PetriNets_OutputArc")
...
PetriNets_Place.attributes={PetriNets_Place_numberOfTokens, PetriNets_Place_name, PetriNets_Place_capacity}
...
domain_model = DomainModel(
    ...
    associations={InputArcFromPlace7, InputArcToTransition10, containsPlaces0, containsTransitions1, containsInputArcs3, containsOutputArcs5, OutputArcFromTransition13, OutputArcToPlace16},
    generalizations={},
    metadata=None
)
