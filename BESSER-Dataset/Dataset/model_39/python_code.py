...
class PetriNets_Transition:
    ...
    def __init__(self, name: str, PetriNets_Transition: "PetriNets_PetriNet" = None, PetriNets_Transition15: "PetriNets_OutputArc" = None, PetriNets_Transition12: "PetriNets_InputArc" = None):
        self.name = name
...
class PetriNets_PetriNet:
    ...
    def __init__(self, name: str, PetriNets_PetriNet2: set["PetriNets_Transition"] = None, PetriNets_PetriNet4: set["PetriNets_InputArc"] = None, PetriNets_PetriNet6: set["PetriNets_OutputArc"] = None, PetriNets_PetriNet: set["PetriNets_Place"] = None):
        self.name = name
...
class PetriNets_Place:
    ...
    def __init__(self, name: str, capacity: int, numberOfTokens: int, PetriNets_Place18: "PetriNets_OutputArc" = None, PetriNets_Place9: "PetriNets_InputArc" = None, PetriNets_Place: "PetriNets_PetriNet" = None):
        self.name = name
