...
# Classes
in_RootContainer = Class(name="in_RootContainer")
in_RootIn = Class(name="in_RootIn", is_abstract=True)
in_A = Class(name="in_A")
RootIn = Class(name="RootIn")
in_B = Class(name="in_B")
...
domain_model = DomainModel(
    ...
    associations={refB0, refA1, elements4},
