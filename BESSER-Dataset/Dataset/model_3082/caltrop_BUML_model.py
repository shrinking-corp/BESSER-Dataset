...
caltrop_EventPattern.attributes={caltrop_EventPattern_name, caltrop_EventPattern_qualifier, caltrop_EventPattern__property, caltrop_EventPattern_variables}
...
domain_model = DomainModel(
    name="caltrop",
    types={caltrop_Schedule, caltrop_ActorParameter, Parameter_, caltrop_TypedInputPort, AbstractTypedIOPort, caltrop_TypedOutputPort, Variable, caltrop_FireAction, ReAction, caltrop_InputPattern, OutputAction, caltrop_CaltropActorImpl, caltrop_StateVariable, caltrop_ReAction, caltrop_OutputAction, caltrop_FunctionDeclaration, caltrop_ActionPattern, PortPattern, ActionPattern, caltrop_ExpressionChannelSelector, ChannelSelector, caltrop_KeywordChannelSelector, NamedObj, caltrop_XExpression, caltrop_OutputPattern, caltrop_PortPattern, caltrop_ChannelSelector, caltrop_Port, caltrop_EventAction, caltrop_EventPattern, JvmTypedObj, caltrop_JvmTypedObj, caltrop_JvmTypeReference, caltrop_State, caltrop_Transition, caltrop_ConversionRelation, Relation, ChannelSelectorKeyword},
    associations={functions5, schedule7, inputPatterns9, declarations0, actions1, initActions3, valueExpressions32, keyExpressions35, guardExpression10, outputPatterns12, bodyExpression14, updateExpression17, delayExpression20, repeatExpression23, channels25, portRef27, guardExpression29, source49, target51, eventPatterns53, varRef54, timeExpression57, parameters37, bodyExpression39, throwables42, initial44, states46, transitions47, schedule48, guardExpression60, conversionExpression63, guardExpression65},
    generalizations={gen_caltrop_ActorParameter_Parameter, gen_caltrop_TypedInputPort_AbstractTypedIOPort, gen_caltrop_TypedOutputPort_AbstractTypedIOPort, gen_caltrop_StateVariable_Variable, gen_caltrop_FireAction_ReAction, gen_caltrop_ReAction_OutputAction, gen_caltrop_InputPattern_PortPattern, gen_caltrop_InputPattern_ActionPattern, gen_caltrop_OutputPattern_PortPattern, gen_caltrop_ExpressionChannelSelector_ChannelSelector, gen_caltrop_KeywordChannelSelector_ChannelSelector, gen_caltrop_OutputAction_NamedObj, gen_caltrop_EventAction_ReAction, gen_caltrop_EventPattern_ActionPattern, gen_caltrop_FunctionDeclaration_JvmTypedObj, gen_caltrop_State_NamedObj, gen_caltrop_ConversionRelation_Relation},
    metadata=None
)
