...
class caltrop_Transition:
    ...
    def __init__(self, tags: str, transitions: "caltrop_State" = None, caltrop_Transition: "caltrop_State" = None, Transition: "caltrop_State" = None):
        self.tags = tags
...
class caltrop_EventPattern(ActionPattern):
    ...
    def __init__(self, name: str, qualifier: str, variables: str, _property: bool, caltrop_EventPattern: "caltrop_EventAction" = None, caltrop_EventPattern55: "caltrop_StateVariable" = None, caltrop_EventPattern58: "caltrop_XExpression" = None, caltrop_EventPattern61: "caltrop_XExpression" = None):
        self.name = name
...
class caltrop_ReAction(OutputAction):
    ...
    pass
class caltrop_InputPattern(ActionPattern, PortPattern):
