...
# Classes
lab1_StateMachine = Class(name="lab1_StateMachine")
lab1_State = Class(name="lab1_State")
lab1_Transition = Class(name="lab1_Transition")
...
outgoing2: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_", type=lab1_Transition, multiplicity=Multiplicity(0, 9999))
    }
)
...
domain_model = DomainModel(
    ...
    associations={from_6, to8, states0, transitions1, outgoing2, incoming3, fsm5},
    generalizations={},
    metadata=None
)
