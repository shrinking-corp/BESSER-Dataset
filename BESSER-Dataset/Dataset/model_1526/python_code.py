...
class lab1_Transition:
    ...
    def __init__(self, name: str, outgoing: "lab1_State" = None, incoming: "lab1_State" = None, lab1_Transition: "lab1_StateMachine" = None, Transition: "lab1_State" = None, Transition4: "lab1_State" = None):
        self.name = name
...
class lab1_State:
    ...
    def __init__(self, name: str, init: bool, State7: "lab1_Transition" = None, State9: "lab1_Transition" = None, State: "lab1_StateMachine" = None, from_: set["lab1_Transition"] = None, to: set["lab1_Transition"] = None, states: "lab1_StateMachine" = None):
        self.name = name
        self.init = init
        self.State7 = State7
        self.State9 = State9
    ...
    def from_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_lab1_State__from_", None)
