...
domain_model = DomainModel(
    name="petriNet",
    types={petriNet_LocatedElement, petriNet_NamedElement, LocatedElement, petriNet_TransitionToPlace, petriNet_PlaceToTransition, petriNet_Transition, petriNet_PetriNet, NamedElement, petriNet_Element, petriNet_Arc, petriNet_Place, Element, Arc},
    associations={incomingArc4, outgoingArc5, incomingArc6, outgoingArc9, elements0, arcs1, net3, net12, from_14, to15, from_16, to19},
    generalizations={gen_petriNet_NamedElement_LocatedElement, gen_petriNet_Transition_Element, gen_petriNet_Arc_NamedElement, gen_petriNet_PetriNet_NamedElement, gen_petriNet_Element_NamedElement, gen_petriNet_Place_Element, gen_petriNet_PlaceToTransition_Arc, gen_petriNet_TransitionToPlace_Arc},
    metadata=None
)
