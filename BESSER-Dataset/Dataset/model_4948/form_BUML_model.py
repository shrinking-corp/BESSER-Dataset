...
# Classes
form_Formulario = Class(name="form_Formulario")
form_Element = Class(name="form_Element", is_abstract=True)
form_Orden = Class(name="form_Orden")
form_Label = Class(name="form_Label")
Element = Class(name="Element")
form_Editable = Class(name="form_Editable")
form_Input = Class(name="form_Input")
Editable = Class(name="Editable")
form_SelectionList = Class(name="form_SelectionList")
form_option = Class(name="form_option")
...
form_Label_for_: Property = Property(name="for_", type=StringType)
form_Label.attributes={form_Label_content, form_Label_for_}
...
form_Input.attributes={form_Input_checked, form_Input_type, form_Input_value}
...
domain_model = DomainModel(
    name="form",
    types={form_Formulario, form_Element, form_Orden, form_Label, Element, form_Editable, form_Input, Editable, form_SelectionList, form_option, form_textArea},
    associations={hasElement0, orden1, hasLabel3, origen5, destino6, salientes8, entrantes9, hasOption4},
    generalizations={gen_form_Label_Element, gen_form_Editable_Element, gen_form_Input_Editable, gen_form_SelectionList_Editable, gen_form_textArea_Editable},
    metadata=None
)
