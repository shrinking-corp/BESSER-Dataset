...
# Classes
person_DocumentRoot = Class(name="person_DocumentRoot")
person_EStringToStringMapEntry = Class(name="person_EStringToStringMapEntry")
person_CompanyType = Class(name="person_CompanyType")
person_PersonType = Class(name="person_PersonType")
...
person_PersonType.attributes={person_PersonType_country, person_PersonType_name, person_PersonType_email, person_PersonType_age}
...
domain_model = DomainModel(
    name="person",
    types={person_DocumentRoot, person_EStringToStringMapEntry, person_CompanyType, person_PersonType},
    associations={xMLNSPrefixMap1, xSISchemaLocation2, company5, person0},
    generalizations={},
    metadata=None
)
