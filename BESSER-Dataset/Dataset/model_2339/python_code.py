...
class person_PersonType:
    ...
    def __init__(self, age: str, country: str, email: str, name: str, person_PersonType: "person_CompanyType" = None):
        self.age = age
...
class person_DocumentRoot:
    ...
    def __init__(self, mixed: str, person_DocumentRoot: set["person_EStringToStringMapEntry"] = None, person_DocumentRoot3: set["person_EStringToStringMapEntry"] = None, person_DocumentRoot6: set["person_CompanyType"] = None):
        self.mixed = mixed
