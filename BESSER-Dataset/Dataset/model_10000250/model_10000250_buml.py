...
Connect4_Server = Class(name="Connect4_Server")
Connect4_Client = Class(name="Connect4_Client")
...
Connect4_Player.attributes={Connect4_Player_tokenColor, Connect4_Player_name, Connect4_Player_wins, Connect4_Player_roundWon, Connect4_Player_currentPlayer}
...
Connect4_Token.attributes={Connect4_Token_color, Connect4_Token_xValue, Connect4_Token_isEmpty, Connect4_Token_yValue}
...
Connect4_CirclePanel.attributes={Connect4_CirclePanel_color, Connect4_CirclePanel_colorIndex}
...
Connect4_connect.attributes={Connect4_connect_label1, Connect4_connect_y, Connect4_connect_label5, Connect4_connect_FRAME_WIDTH, Connect4_connect_label3, Connect4_connect_FRAME_HEIGHT, Connect4_connect_x, Connect4_connect_label4, Connect4_connect_panel, Connect4_connect_columnSize, Connect4_connect_rowSize, Connect4_connect_label2}

# Connect4_Server class attributes and methods

# Connect4_Client class attributes and methods
...
Server_Board: BinaryAssociation = BinaryAssociation(
    name="Server_Board",
    ends={
        Property(name="board8", type=Connect4_Board, multiplicity=Multiplicity(0, 1)),
        Property(name="server9", type=Connect4_Server, multiplicity=Multiplicity(0, 1))
    }
)
Server_Client: BinaryAssociation = BinaryAssociation(
    name="Server_Client",
    ends={
        Property(name="client10", type=Connect4_Client, multiplicity=Multiplicity(0, 1)),
        Property(name="server11", type=Connect4_Server, multiplicity=Multiplicity(0, 1))
    }
)
...
domain_model = DomainModel(
    name="_1f67eb6d_8c73_45c4_8f06_7bb7062331b6",
    types={Connect4_Player, Connect4_Token, Connect4_Board, Connect4_CirclePanel, Connect4_connect, Connect4_Server, Connect4_Client},
    associations={CirclePanel_connect, Board_connect, Server_Board, Server_Client, Board_Token, Board_Player},
    generalizations={},
    metadata=None
)
