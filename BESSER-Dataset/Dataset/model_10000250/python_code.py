...
class Connect4_Board:
    ...
    def __init__(self, maxRows: int, maxColumns: int, gameBoard: str, connect6: "Connect4_connect" = None, server9: "Connect4_Server" = None, token0: set["Connect4_Token"] = None, player2: set["Connect4_Player"] = None):
    ...
    @property
    def server9(self):
        return self.__server9
    @server9.setter
    def server9(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Connect4_Board__server9", None)
        self.__server9 = value
