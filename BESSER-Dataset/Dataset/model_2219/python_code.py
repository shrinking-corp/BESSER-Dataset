...
class studyplan_Program:
    ...
    def __init__(self, name: str, code: str, programs: "studyplan_Department" = None, Program: "studyplan_Department" = None, studyplan_Program: set["studyplan_Semester"] = None, studyplan_Program2: set["studyplan_Specialization"] = None):
        self.name = name
        self.code = code
...
class studyplan_Specialization:
    ...
    def __init__(self, name: str, studyplan_Specialization7: set["studyplan_Semester"] = None, studyplan_Specialization11: "studyplan_Specialization" = None, studyplan_Specialization9: set["studyplan_Specialization"] = None, studyplan_Specialization: "studyplan_Program" = None):
        self.name = name
...
class studyplan_Semester:
    ...
    def __init__(self, name: str, season: str, year: int, studyplan_Semester5: set["studyplan_SemesterCourse"] = None, studyplan_Semester8: "studyplan_Specialization" = None, studyplan_Semester: "studyplan_Program" = None):
        self.name = name
        self.season = season
        self.year = year
