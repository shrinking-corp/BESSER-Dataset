...
def test_maintains_the_products_information_usecase_is_not_abstract():
    assert not inspect.isabstract(MAINTAINS_THE_PRODUCTS_INFORMATION_UseCase)


def test_maintains_the_products_information_usecase_constructor_exists():
    assert callable(MAINTAINS_THE_PRODUCTS_INFORMATION_UseCase.__init__)


def test_maintains_the_products_information_usecase_constructor_args():
...
def test_adds_items_to_cart_usecase_is_not_abstract():
    assert not inspect.isabstract(ADDS_ITEMS_TO_CART_UseCase)


def test_adds_items_to_cart_usecase_constructor_exists():
    assert callable(ADDS_ITEMS_TO_CART_UseCase.__init__)


def test_adds_items_to_cart_usecase_constructor_args():
    sig = inspect.signature(ADDS_ITEMS_TO_CART_UseCase.__init__)
    params = list(sig.parameters.keys())



def test_selects_views_the_items_information_usecase_is_not_abstract():
    assert not inspect.isabstract(SELECTS_VIEWS_THE_ITEMS_INFORMATION_UseCase)


def test_selects_views_the_items_information_usecase_constructor_exists():
    assert callable(SELECTS_VIEWS_THE_ITEMS_INFORMATION_UseCase.__init__)


def test_selects_views_the_items_information_usecase_constructor_args():
