...
SELECTS_VIEWS_THE_ITEMS_INFORMATION_UseCase = Class(name="SELECTS_VIEWS_THE_ITEMS_INFORMATION_UseCase")
ADDS_ITEMS_TO_CART_UseCase = Class(name="ADDS_ITEMS_TO_CART_UseCase")
...
MAINTAINS_THE_PRODUCTS_INFORMATION_UseCase = Class(name="MAINTAINS_THE_PRODUCTS_INFORMATION_UseCase")
...
# SELECTS_VIEWS_THE_ITEMS_INFORMATION_UseCase class attributes and methods

# ADDS_ITEMS_TO_CART_UseCase class attributes and methods
...
# MAINTAINS_THE_PRODUCTS_INFORMATION_UseCase class attributes and methods
...
Customer.attributes={Customer_id, Customer_phoneno, Customer_name, Customer_mailid, Customer_address}
...
Warehouse.attributes={Warehouse_location, Warehouse_database}
...
Feedback.attributes={Feedback_customername, Feedback_phoneno, Feedback_id}
...
Cancelorder.attributes={Cancelorder_item, Cancelorder_quantity}
...
MAINTAINS_THE_PRODUCTS_SERVICES_ADMINISTRATOR: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="mAINTAINS_THE_PRODUCTS_SERVICES21", type=MAINTAINS_THE_PRODUCTS_INFORMATION_UseCase, multiplicity=Multiplicity(0, 1))
    }
)
...
CUSTOMER_SELECTS_THE_ITEMS_SERVICE: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="sELECTS_THE_ITEMS_SERVICE4", type=SELECTS_VIEWS_THE_ITEMS_INFORMATION_UseCase, multiplicity=Multiplicity(0, 1)),
...
CUSTOMER_ADDS_ITEMS_SERVICE_TO_CART: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="aDDS_ITEMS_SERVICE_TO_CART6", type=ADDS_ITEMS_TO_CART_UseCase, multiplicity=Multiplicity(0, 1)),
...
domain_model = DomainModel(
    name="_83a9fd01_849d_4cda_82c1_80c22f9c455d",
    types={CUSTOMER_Actor, VISITS_THE_WEBSITE_UseCase, CREATES_THE_WEBSITE_UseCase, SELECTS_VIEWS_THE_ITEMS_INFORMATION_UseCase, ADDS_ITEMS_TO_CART_UseCase, SELECTS_THE_MODE_OF_PAYMENT_UseCase, PAYS_THE_BILL_UseCase, DELIVERS_THE_PRODUCT_UseCase, SUPPORT_AND_FEEDBACK_UseCase, WEB_DEVELOPER_Actor, ADMINISTRATOR_Actor, MAINTAINS_THE_PRODUCTS_INFORMATION_UseCase, Customer, Order, Product, Warehouse, Transaction, Shipment, Customercare, Feedback, Cancelorder},
    associations={CREATES_THE_WEBSITE_WEB_DEVELOPER, CUSTOMER_VISITS_THE_WEBSITE, CUSTOMER_SUPPORT_AND_FEEDBACK, SELECTS_THE_MODE_OF_PAYMENT_ADMINISTRATOR, PAYS_THE_BILL_ADMINISTRATOR, DELIVERS_THE_PRODUCT_ADMINISTRATOR, MAINTAINS_THE_PRODUCTS_SERVICES_ADMINISTRATOR, SUPPORT_AND_FEEDBACK_ADMINISTRATOR, ORDER_PRODUCT, Customer_Customercare, Warehouse_Shipment, Product_Warehouse, CUSTOMER_SELECTS_THE_ITEMS_SERVICE, CUSTOMER_ADDS_ITEMS_SERVICE_TO_CART, CUSTOMER_SELECTS_THE_MODE_OF_PAYMENT, CUSTOMER_PAYS_THE_BILL},
    generalizations={},
    metadata=None
)
