...
families_FamilyModel = Class(name="families_FamilyModel")
...
families_Family.attributes={families_Family_street, families_Family_town, families_Family_lastName}
...
domain_model = DomainModel(
    name="families",
    types={families_Family, families_Member, families_FamilyModel},
    associations={father0, mother1, sons3, daughters5, model7, familyFather8, familyMother9, familySon11, familyDaughter13, model15, families17, members19},
    generalizations={},
    metadata=None
)
