...
class families_Member:
    ...
    def __init__(self, firstName: str, age: int, Member4: "families_Family" = None, Member6: "families_Family" = None, Member: "families_Family" = None, Member2: "families_Family" = None, father: "families_Family" = None, mother: "families_Family" = None, sons: "families_Family" = None, daughters: "families_Family" = None, members: "families_FamilyModel" = None, Member21: "families_FamilyModel" = None):
...
class families_Family:
    ...
    def __init__(self, lastName: str, street: str, town: str, familySon: set["families_Member"] = None, familyDaughter: set["families_Member"] = None, families: "families_FamilyModel" = None, familyFather: "families_Member" = None, familyMother: "families_Member" = None, Family: "families_Member" = None, Family10: "families_Member" = None, Family12: "families_Member" = None, Family14: "families_Member" = None, Family18: "families_FamilyModel" = None):
