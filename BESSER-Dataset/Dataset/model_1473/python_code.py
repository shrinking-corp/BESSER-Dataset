...
class GraphConstraint_Formula(NestedGraphCondition):
    ...
    def __init__(self, op: str, formula: set["GraphConstraint_NestedGraphCondition"] = None, Formula: "GraphConstraint_NestedGraphCondition" = None):
        self.op = op
...
class GraphConstraint_NestedGraphConstraint:
    ...
    def __init__(self, name: str, NestedGraphConstraint: "GraphConstraint_NestedGraphCondition" = None, GraphConstraint_NestedGraphConstraint: "GraphConstraint_EPackage" = None, gc: "GraphConstraint_NestedGraphCondition" = None, GraphConstraint_NestedGraphConstraint6: "GraphConstraint_Graph" = None):
        self.name = name
