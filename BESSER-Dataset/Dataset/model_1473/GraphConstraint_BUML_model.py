...
domain_model = DomainModel(
    ...
    types={GraphConstraint_Graph, GraphConstraint_Edge, GraphConstraint_Node, GraphConstraint_GraphElement, GraphConstraint_NestedGraphConstraint, GraphConstraint_EPackage, GraphConstraint_NestedGraphCondition, GraphConstraint_EReference, GraphConstraint_EAttribute, GraphConstraint_Mapping, GraphConstraint_ElementMapping, GraphConstraint_QuantifiedGraphCondition, NestedGraphCondition, GraphElement, GraphConstraint_Attribute, GraphConstraint_EClass, GraphConstraint_Variable, GraphConstraint_EDataType, GraphConstraint_True, GraphConstraint_Formula, Quantifier, Operator},
    associations={edges0, nodes1, import_3, condition4, tgt15, type18, type20, from_22, to24, mappings27, origin29, image31, codomain34, emptyDomain5, attributes8, type10, src12, args47, type49, formula50, restriction36, restrictionMapping39, codomainMapping42, nested45, qgc51, gc52, domain53, vars55},
    generalizations={gen_GraphConstraint_Attribute_GraphElement, gen_GraphConstraint_QuantifiedGraphCondition_NestedGraphCondition, gen_GraphConstraint_Node_GraphElement, gen_GraphConstraint_Edge_GraphElement, gen_GraphConstraint_True_NestedGraphCondition, gen_GraphConstraint_Formula_NestedGraphCondition},
    metadata=None
)
