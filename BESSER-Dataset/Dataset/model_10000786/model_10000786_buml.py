...
Student_publicAttribute: Property = Property(name="publicAttribute", type=FloatType)
Student_privateAttribute: Property = Property(name="privateAttribute", type=IntegerType)
Student_protectedAttribute: Property = Property(name="protectedAttribute", type=StringType)
Student_packageAttribute: Property = Property(name="packageAttribute", type=StringType)
Student.attributes={Student_publicAttribute, Student_protectedAttribute, Student_privateAttribute, Student_packageAttribute}

# Courses class attributes and methods

# Department class attributes and methods
Department_publicAttribute: Property = Property(name="publicAttribute", type=FloatType)
Department_privateAttribute: Property = Property(name="privateAttribute", type=IntegerType)
Department_protectedAttribute: Property = Property(name="protectedAttribute", type=StringType)
Department_packageAttribute: Property = Property(name="packageAttribute", type=StringType)
Department.attributes={Department_packageAttribute, Department_publicAttribute, Department_privateAttribute, Department_protectedAttribute}
...
domain_model = DomainModel(
    name="_608979dd_5689_4edc_b2eb_e156861cc830",
    types={BankAccount, Student, Courses, Department, ClassD, ClassE, ClassF, ClassG, ClassJ, ClassH, ClassK, ClassL, ClassM, ClassN, ClassP, InterfaceO_Interface, ClassQ, ClassR, ClassS, ClassT, ClassU, ClassV},
