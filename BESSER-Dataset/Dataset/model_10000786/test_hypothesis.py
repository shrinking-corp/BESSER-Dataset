...
def test_department_has_publicAttribute():
    assert hasattr(Department, "publicAttribute")
    descriptor = None
...
def test_department_has_privateAttribute():
    assert hasattr(Department, "privateAttribute")
    descriptor = None
    for klass in Department.__mro__:
...
def test_department_has_protectedAttribute():
    assert hasattr(Department, "protectedAttribute")
    descriptor = None
    for klass in Department.__mro__:
...
def test_department_has_packageAttribute():
    assert hasattr(Department, "packageAttribute")
    descriptor = None
    for klass in Department.__mro__:
...
def test_student_has_publicAttribute():
    assert hasattr(Student, "publicAttribute")
    descriptor = None
...
def test_student_has_packageAttribute():
    assert hasattr(Student, "packageAttribute")
    descriptor = None
    for klass in Student.__mro__:
        if "packageAttribute" in klass.__dict__:
            descriptor = klass.__dict__["packageAttribute"]
...
def test_student_has_privateAttribute():
    assert hasattr(Student, "privateAttribute")
    descriptor = None
    for klass in Student.__mro__:
        if "privateAttribute" in klass.__dict__:
            descriptor = klass.__dict__["privateAttribute"]
...
def test_student_has_protectedAttribute():
    assert hasattr(Student, "protectedAttribute")
    descriptor = None
    for klass in Student.__mro__:
        if "protectedAttribute" in klass.__dict__:
            descriptor = klass.__dict__["protectedAttribute"]
...
@given(instance=Department_strategy)
def test_department_publicAttribute_setter(instance):
...
@given(instance=Department_strategy)
def test_department_privateAttribute_setter(instance):
...
@given(instance=Department_strategy)
def test_department_protectedAttribute_setter(instance):
...
@given(instance=Department_strategy)
def test_department_packageAttribute_setter(instance):
...
@given(instance=Student_strategy)
def test_student_publicAttribute_setter(instance):
    original = instance.publicAttribute
    instance.publicAttribute = original
    assert instance.publicAttribute == original
...
@given(instance=Student_strategy)
def test_student_packageAttribute_setter(instance):
    original = instance.packageAttribute
    instance.packageAttribute = original
    assert instance.packageAttribute == original
...
@given(instance=Student_strategy)
def test_student_privateAttribute_setter(instance):
    original = instance.privateAttribute
    instance.privateAttribute = original
    assert instance.privateAttribute == original
...
@given(instance=Student_strategy)
def test_student_protectedAttribute_setter(instance):
    original = instance.protectedAttribute
    instance.protectedAttribute = original
    assert instance.protectedAttribute == original
