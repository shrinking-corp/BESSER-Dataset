...
Customer.attributes={Customer_address, Customer_name, Customer_ph_no}
...
Ticket.attributes={Ticket_dateofjourney, Ticket_flight_name, Ticket_flight_No, Ticket_destination, Ticket_source, Ticket_time}
...
domain_model = DomainModel(
    name="_2174ae04_dc51_427b_b997_d19875ef607c",
    types={Reservation_System_Actor, round_trip_or_one_way_UseCase, enter_airport_UseCase, UseCase_UseCase, Reservation_System_Actor1, round_trip_or_one_way__UseCase, enter_airport_UseCase1, enter_date_UseCase, enter_no__of_tickets_UseCase, search_flights_UseCase, select_flight_UseCase, confirm_purchase_UseCase, make_payment_UseCase, reserve_seats_UseCase, print_ticket_UseCase, customer_Actor, Common_fuctions, Customer, Agent, Booking_counter, Ticket},
