...
class mm3_Film:
    ...
    def __init__(self, name: str, mm3_Film10: "mm3_Member" = None, mm3_Film: "mm3_Library" = None):
        self.name = name
...
class mm3_Book:
    ...
    def __init__(self, name: str, mm3_Book7: "mm3_Member" = None, mm3_Book: "mm3_Library" = None):
        self.name = name
...
class mm3_Library:
    ...
    def __init__(self, name: str, mm3_Library: set["mm3_Member"] = None, mm3_Library2: set["mm3_Book"] = None, mm3_Library4: set["mm3_Film"] = None):
        self.name = name
