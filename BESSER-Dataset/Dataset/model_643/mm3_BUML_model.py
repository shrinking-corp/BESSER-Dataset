...
# Classes
mm3_Library = Class(name="mm3_Library")
mm3_Member = Class(name="mm3_Member")
mm3_Book = Class(name="mm3_Book")
mm3_Film = Class(name="mm3_Film")
...
domain_model = DomainModel(
    name="mm3",
    types={mm3_Library, mm3_Member, mm3_Book, mm3_Film},
    associations={members0, bookLoans5, filmLoans8, books1, films3},
    generalizations={},
    metadata=None
)
