...
def test_hyp_mm3_film_is_not_abstract():
    assert not inspect.isabstract(mm3_Film)


def test_hyp_mm3_film_constructor_exists():
    assert callable(mm3_Film.__init__)


def test_hyp_mm3_film_constructor_args():
...
def test_hyp_mm3_book_is_not_abstract():
    assert not inspect.isabstract(mm3_Book)


def test_hyp_mm3_book_constructor_exists():
    assert callable(mm3_Book.__init__)


def test_hyp_mm3_book_constructor_args():
...
def test_hyp_mm3_member_is_not_abstract():
    assert not inspect.isabstract(mm3_Member)


def test_hyp_mm3_member_constructor_exists():
    assert callable(mm3_Member.__init__)


def test_hyp_mm3_member_constructor_args():
...
def test_hyp_mm3_library_is_not_abstract():
    assert not inspect.isabstract(mm3_Library)


def test_hyp_mm3_library_constructor_exists():
    assert callable(mm3_Library.__init__)


def test_hyp_mm3_library_constructor_args():
...
def test_hyp_mm3_film_name_setter(instance):
...
def test_hyp_mm3_book_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_mm3_member_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_mm3_library_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
