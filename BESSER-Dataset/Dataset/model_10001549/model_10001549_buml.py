...
Documents.attributes={Documents_data, Documents_file, Documents_file_name, Documents_tab_counter}
...
domain_model = DomainModel(
    name="_F6W1wNxuEemQn9qHRgF9yg",
    types={Value, Null, String, Bool, Number, Array, Visitor, Json, Documents, Print, ArrPrint, Actor_Actor},
    associations={},
    generalizations={},
    metadata=None
)
