...
domain_model = DomainModel(
    name="petrinet",
    types={petrinet_Arc, petrinet_PetriNet, petrinet_Node, petrinet_Transition, Node, petrinet_Place, petrinet_Token},
    associations={arcs1, net3, source6, target9, net12, incoming15, nodes0, outgoing18, tokens21},
