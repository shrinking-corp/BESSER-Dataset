...
class petrinet_Node(ABC):
    ...
    def __init__(self, name: str, petrinet_Node8: "petrinet_Arc" = None, petrinet_Node11: "petrinet_Arc" = None, petrinet_Node13: "petrinet_PetriNet" = None, petrinet_Node16: set["petrinet_Arc"] = None, petrinet_Node: "petrinet_PetriNet" = None, petrinet_Node19: set["petrinet_Arc"] = None):
        self.name = name
...
class petrinet_PetriNet:
    ...
    def __init__(self, name: str, petrinet_PetriNet2: set["petrinet_Arc"] = None, petrinet_PetriNet5: "petrinet_Arc" = None, petrinet_PetriNet14: "petrinet_Node" = None, petrinet_PetriNet: set["petrinet_Node"] = None):
        self.name = name
