...
domain_model = DomainModel(
    name="model3",
    types={model3_Class1, Class2, model3_MetaRef, model3_EPackage, model3_EClass, model3_EReference, model3_NodeD, model3_Image, model3_File, model3_ClassWithIDAttribute, model3_subpackage_Class2, model3_Polygon, model3_PolygonWithDuplicates, model3_NodeA, model3_NodeB, model3_NodeC, subpackage_model3_Class1},
    associations={class20, ePackageRef1, eClassRef2, eReferenceRef4, children17, parent20, otherNodes24, oppositeNodes27, children30, parent33, otherNodes37, oppositeNode40, children7, otherNodes9, children12, parent14, class143},
    generalizations={},
    metadata=None
)
