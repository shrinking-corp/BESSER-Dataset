...
graph_DeploymentUnitType = Class(name="graph_DeploymentUnitType")
graph_DependencyGraph = Class(name="graph_DependencyGraph")
...
graph_Cause.attributes={graph_Cause_type, graph_Cause_name}
...
domain_model = DomainModel(
    name="graph",
    types={graph_Node, graph_Cause, graph_Dependency, graph_DeploymentUnitType, graph_DependencyGraph, graph_DocumentRoot, graph_EStringToStringMapEntry},
    associations={destination1, cause0, unit21, source3, node6, dependency8, origin11, xMLNSPrefixMap14, xSISchemaLocation15, dependencyGraph18, dependency23},
    generalizations={},
    metadata=None
)
