...
# Classes
blorqueScript_BSFile = Class(name="blorqueScript_BSFile")
blorqueScript_BSImport = Class(name="blorqueScript_BSImport")
blorqueScript_BSClass = Class(name="blorqueScript_BSClass")
blorqueScript_BSMember = Class(name="blorqueScript_BSMember")
BSSymbol = Class(name="BSSymbol")
blorqueScript_BSParameter = Class(name="blorqueScript_BSParameter")
blorqueScript_BSMethodBody = Class(name="blorqueScript_BSMethodBody")
BSBlock = Class(name="BSBlock")
blorqueScript_BSStatement = Class(name="blorqueScript_BSStatement")
blorqueScript_BSReturn = Class(name="blorqueScript_BSReturn")
BSStatement = Class(name="BSStatement")
blorqueScript_BSExpression = Class(name="blorqueScript_BSExpression")
blorqueScript_BSBreak = Class(name="blorqueScript_BSBreak")
blorqueScript_BSContinue = Class(name="blorqueScript_BSContinue")
blorqueScript_BSVariableDeclaration = Class(name="blorqueScript_BSVariableDeclaration")
blorqueScript_BSIfStatement = Class(name="blorqueScript_BSIfStatement")
blorqueScript_BSIfBlock = Class(name="blorqueScript_BSIfBlock")
blorqueScript_BSWhileLoop = Class(name="blorqueScript_BSWhileLoop")
blorqueScript_BSLoopBlock = Class(name="blorqueScript_BSLoopBlock")
blorqueScript_BSForLoop = Class(name="blorqueScript_BSForLoop")
blorqueScript_BSSwitchStatement = Class(name="blorqueScript_BSSwitchStatement")
blorqueScript_BSSwitchBlock = Class(name="blorqueScript_BSSwitchBlock")
blorqueScript_BSField = Class(name="blorqueScript_BSField")
BSMember = Class(name="BSMember")
blorqueScript_BSMethod = Class(name="blorqueScript_BSMethod")
blorqueScript_BSCase = Class(name="blorqueScript_BSCase")
blorqueScript_BSCaseBlock = Class(name="blorqueScript_BSCaseBlock")
blorqueScript_BSBlock = Class(name="blorqueScript_BSBlock")
blorqueScript_BSSymbol = Class(name="blorqueScript_BSSymbol")
blorqueScript_BSAssignmentExpression = Class(name="blorqueScript_BSAssignmentExpression")
BSExpression = Class(name="BSExpression")
blorqueScript_BSTernaryExpression = Class(name="blorqueScript_BSTernaryExpression")
blorqueScript_BSBooleanAndExpression = Class(name="blorqueScript_BSBooleanAndExpression")
blorqueScript_BSBitwiseOrExpression = Class(name="blorqueScript_BSBitwiseOrExpression")
blorqueScript_BSBitwiseXorExpression = Class(name="blorqueScript_BSBitwiseXorExpression")
blorqueScript_BSBitwiseAndExpression = Class(name="blorqueScript_BSBitwiseAndExpression")
blorqueScript_BSEqualityExpression = Class(name="blorqueScript_BSEqualityExpression")
blorqueScript_BSOrderedRelationExpression = Class(name="blorqueScript_BSOrderedRelationExpression")
blorqueScript_BSBitwiseShiftExpression = Class(name="blorqueScript_BSBitwiseShiftExpression")
blorqueScript_BSBooleanOrExpression = Class(name="blorqueScript_BSBooleanOrExpression")
blorqueScript_BSMulDivOrModExpression = Class(name="blorqueScript_BSMulDivOrModExpression")
blorqueScript_BSCastExpression = Class(name="blorqueScript_BSCastExpression")
blorqueScript_BSNewExpression = Class(name="blorqueScript_BSNewExpression")
blorqueScript_BSUnaryModifierExpression = Class(name="blorqueScript_BSUnaryModifierExpression")
blorqueScript_BSMemberSelectionExpression = Class(name="blorqueScript_BSMemberSelectionExpression")
blorqueScript_BSMethodInvokationExpression = Class(name="blorqueScript_BSMethodInvokationExpression")
blorqueScript_BSArrayAccessExpression = Class(name="blorqueScript_BSArrayAccessExpression")
blorqueScript_BSPlusMinusOrStringConcatExpression = Class(name="blorqueScript_BSPlusMinusOrStringConcatExpression")
blorqueScript_BSPostfixArithmeticExpression = Class(name="blorqueScript_BSPostfixArithmeticExpression")
blorqueScript_BSStringConstant = Class(name="blorqueScript_BSStringConstant")
blorqueScript_BSHexadecimalConstant = Class(name="blorqueScript_BSHexadecimalConstant")
blorqueScript_BSNumberConstant = Class(name="blorqueScript_BSNumberConstant")
blorqueScript_BSRealConstant = Class(name="blorqueScript_BSRealConstant")
blorqueScript_BSBooleanConstant = Class(name="blorqueScript_BSBooleanConstant")
blorqueScript_BSNullLiteral = Class(name="blorqueScript_BSNullLiteral")
blorqueScript_BSThisLiteral = Class(name="blorqueScript_BSThisLiteral")
blorqueScript_BSClientLiteral = Class(name="blorqueScript_BSClientLiteral")
blorqueScript_BSParentLiteral = Class(name="blorqueScript_BSParentLiteral")
blorqueScript_BSSymbolRef = Class(name="blorqueScript_BSSymbolRef")
blorqueScript_BSParentheticalExpression = Class(name="blorqueScript_BSParentheticalExpression")
...
blorqueScript_BSSymbol.attributes={blorqueScript_BSSymbol_name, blorqueScript_BSSymbol_pType}
...
domain_model = DomainModel(
    name="blorqueScript",
    types={blorqueScript_BSFile, blorqueScript_BSImport, blorqueScript_BSClass, blorqueScript_BSMember, BSSymbol, blorqueScript_BSParameter, blorqueScript_BSMethodBody, BSBlock, blorqueScript_BSStatement, blorqueScript_BSReturn, BSStatement, blorqueScript_BSExpression, blorqueScript_BSBreak, blorqueScript_BSContinue, blorqueScript_BSVariableDeclaration, blorqueScript_BSIfStatement, blorqueScript_BSIfBlock, blorqueScript_BSWhileLoop, blorqueScript_BSLoopBlock, blorqueScript_BSForLoop, blorqueScript_BSSwitchStatement, blorqueScript_BSSwitchBlock, blorqueScript_BSField, BSMember, blorqueScript_BSMethod, blorqueScript_BSCase, blorqueScript_BSCaseBlock, blorqueScript_BSBlock, blorqueScript_BSSymbol, blorqueScript_BSAssignmentExpression, BSExpression, blorqueScript_BSTernaryExpression, blorqueScript_BSBooleanAndExpression, blorqueScript_BSBitwiseOrExpression, blorqueScript_BSBitwiseXorExpression, blorqueScript_BSBitwiseAndExpression, blorqueScript_BSEqualityExpression, blorqueScript_BSOrderedRelationExpression, blorqueScript_BSBitwiseShiftExpression, blorqueScript_BSBooleanOrExpression, blorqueScript_BSMulDivOrModExpression, blorqueScript_BSCastExpression, blorqueScript_BSNewExpression, blorqueScript_BSUnaryModifierExpression, blorqueScript_BSMemberSelectionExpression, blorqueScript_BSMethodInvokationExpression, blorqueScript_BSArrayAccessExpression, blorqueScript_BSPlusMinusOrStringConcatExpression, blorqueScript_BSPostfixArithmeticExpression, blorqueScript_BSStringConstant, blorqueScript_BSHexadecimalConstant, blorqueScript_BSNumberConstant, blorqueScript_BSRealConstant, blorqueScript_BSBooleanConstant, blorqueScript_BSNullLiteral, blorqueScript_BSThisLiteral, blorqueScript_BSClientLiteral, blorqueScript_BSParentLiteral, blorqueScript_BSSymbolRef, blorqueScript_BSParentheticalExpression, BSPrimitiveType},
    associations={imports0, classes1, superclass4, members6, params8, body9, statements11, expression13, expression14, expression16, thenBlock18, elseBlock20, expression23, block25, left27, middle29, right32, block35, expression38, statements45, cases48, expression50, block53, statements55, rType58, left60, right62, left65, middle67, block40, left73, statements42, right75, left78, right80, left83, right85, left88, right90, left93, right95, left98, right100, left103, right105, left108, right110, right70, right115, left118, right120, castExpr123, rType125, args127, receiver130, receiver132, member134, receiver137, args139, left113, receiver147, left149, symbol150, expression152, receiver142, args144},
    generalizations={gen_blorqueScript_BSMember_BSSymbol, gen_blorqueScript_BSMethod_BSMember, gen_blorqueScript_BSParameter_BSSymbol, gen_blorqueScript_BSMethodBody_BSBlock, gen_blorqueScript_BSReturn_BSStatement, gen_blorqueScript_BSBreak_BSStatement, gen_blorqueScript_BSContinue_BSStatement, gen_blorqueScript_BSVariableDeclaration_BSStatement, gen_blorqueScript_BSVariableDeclaration_BSSymbol, gen_blorqueScript_BSIfStatement_BSStatement, gen_blorqueScript_BSWhileLoop_BSStatement, gen_blorqueScript_BSForLoop_BSStatement, gen_blorqueScript_BSSwitchStatement_BSStatement, gen_blorqueScript_BSField_BSMember, gen_blorqueScript_BSLoopBlock_BSBlock, gen_blorqueScript_BSSwitchBlock_BSBlock, gen_blorqueScript_BSCaseBlock_BSBlock, gen_blorqueScript_BSExpression_BSStatement, gen_blorqueScript_BSAssignmentExpression_BSExpression, gen_blorqueScript_BSTernaryExpression_BSExpression, gen_blorqueScript_BSIfBlock_BSBlock, gen_blorqueScript_BSBooleanAndExpression_BSExpression, gen_blorqueScript_BSBitwiseOrExpression_BSExpression, gen_blorqueScript_BSBitwiseXorExpression_BSExpression, gen_blorqueScript_BSBitwiseAndExpression_BSExpression, gen_blorqueScript_BSEqualityExpression_BSExpression, gen_blorqueScript_BSOrderedRelationExpression_BSExpression, gen_blorqueScript_BSBitwiseShiftExpression_BSExpression, gen_blorqueScript_BSBooleanOrExpression_BSExpression, gen_blorqueScript_BSMulDivOrModExpression_BSExpression, gen_blorqueScript_BSCastExpression_BSExpression, gen_blorqueScript_BSNewExpression_BSExpression, gen_blorqueScript_BSUnaryModifierExpression_BSExpression, gen_blorqueScript_BSMemberSelectionExpression_BSExpression, gen_blorqueScript_BSMethodInvokationExpression_BSExpression, gen_blorqueScript_BSArrayAccessExpression_BSExpression, gen_blorqueScript_BSPlusMinusOrStringConcatExpression_BSExpression, gen_blorqueScript_BSPostfixArithmeticExpression_BSExpression, gen_blorqueScript_BSStringConstant_BSExpression, gen_blorqueScript_BSHexadecimalConstant_BSExpression, gen_blorqueScript_BSNumberConstant_BSExpression, gen_blorqueScript_BSRealConstant_BSExpression, gen_blorqueScript_BSBooleanConstant_BSExpression, gen_blorqueScript_BSNullLiteral_BSExpression, gen_blorqueScript_BSThisLiteral_BSExpression, gen_blorqueScript_BSClientLiteral_BSExpression, gen_blorqueScript_BSParentLiteral_BSExpression, gen_blorqueScript_BSSymbolRef_BSExpression, gen_blorqueScript_BSParentheticalExpression_BSExpression},
    metadata=None
)
