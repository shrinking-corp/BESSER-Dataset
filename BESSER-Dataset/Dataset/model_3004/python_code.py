...
class blorqueScript_BSNewExpression(BSExpression):
    ...
    def __init__(self, isArray: bool, blorqueScript_BSNewExpression: "blorqueScript_BSClass" = None, blorqueScript_BSNewExpression128: set["blorqueScript_BSExpression"] = None):
        self.isArray = isArray
...
class blorqueScript_BSClass:
    ...
    def __init__(self, name: str, blorqueScript_BSClass: "blorqueScript_BSFile" = None, blorqueScript_BSClass5: "blorqueScript_BSClass" = None, blorqueScript_BSClass3: "blorqueScript_BSClass" = None, blorqueScript_BSClass7: set["blorqueScript_BSMember"] = None, blorqueScript_BSClass59: "blorqueScript_BSSymbol" = None, blorqueScript_BSClass126: "blorqueScript_BSNewExpression" = None):
        self.name = name
