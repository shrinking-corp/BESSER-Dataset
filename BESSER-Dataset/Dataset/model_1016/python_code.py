...
class fsm_StateMachine:
    ...
    def __init__(self, name: str, fsm_StateMachine: "fsm_Root" = None, stateMachine: set["fsm_Transition"] = None, stateMachine2: set["fsm_AbstractState"] = None, StateMachine: "fsm_Transition" = None, StateMachine9: "fsm_AbstractState" = None):
        self.name = name
