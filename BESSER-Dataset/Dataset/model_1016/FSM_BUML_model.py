...
# Classes
fsm_RegularState = Class(name="fsm_RegularState")
fsm_Root = Class(name="fsm_Root")
...
domain_model = DomainModel(
    name="fsm",
    types={fsm_RegularState, fsm_Root, fsm_StateMachine, fsm_Transition, fsm_AbstractState, fsm_CompositeState, fsm_InitialState, AbstractState},
    associations={states12, stateMachines14, transitions0, states1, stateMachine3, source4, target5, stateMachine8, compositeStates10},
    generalizations={gen_fsm_RegularState_AbstractState, gen_fsm_CompositeState_AbstractState, gen_fsm_InitialState_AbstractState},
    metadata=None
)
