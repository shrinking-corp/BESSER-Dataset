...
# Classes
bowlingTournament_League = Class(name="bowlingTournament_League")
bowlingTournament_Player = Class(name="bowlingTournament_Player")
bowlingTournament_Tournament = Class(name="bowlingTournament_Tournament")
bowlingTournament_Matchup = Class(name="bowlingTournament_Matchup")
bowlingTournament_Game = Class(name="bowlingTournament_Game")
...
bowlingTournament_Player.attributes={bowlingTournament_Player_name, bowlingTournament_Player_dateOfBirth, bowlingTournament_Player_isProfessional, bowlingTournament_Player_height}
...
domain_model = DomainModel(
    ...
    types={bowlingTournament_League, bowlingTournament_Player, bowlingTournament_Tournament, bowlingTournament_Matchup, bowlingTournament_Game, TournamentType},
    associations={player0, matchups1, league2, games5, player6, matchup8},
    generalizations={},
    metadata=None
)
