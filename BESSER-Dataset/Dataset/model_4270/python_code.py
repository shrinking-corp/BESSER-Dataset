...
class bowlingTournament_Player:
    ...
    def __init__(self, name: str, dateOfBirth: date, height: float, isProfessional: bool, bowlingTournament_Player: "bowlingTournament_League" = None, bowlingTournament_Player7: "bowlingTournament_Game" = None):
        self.name = name
