...
class OPLmetamodel_Declaration(ABC):
    ...
    def __init__(self, order: IntegerType, OPLmetamodel_Declaration: "OPLmetamodel_Model" = None):
        self.order = order
    ...
    @order.setter
    def order(self, order: IntegerType):
        self.__order = order
...
class DefinedType:
    ...
    pass
class OPLmetamodel_Record(DefinedType, ParameterDomain):
...
class OPLmetamodel_SetType(DefinedType, ParameterDomain):
...
class OPLmetamodel_NumericExpression(PrimitiveExpression):
    ...
    pass
class OPLmetamodel_EnumLiteral(PrimitiveExpression, PrimitiveType):

    pass
class OPLmetamodel_BooleanExpression(PrimitiveExpression):

    def __init__(self, body: str, OPLmetamodel_BooleanExpression77: "OPLmetamodel_IfExpression" = None, OPLmetamodel_BooleanExpression: "OPLmetamodel_IfConstraint" = None):
        self.body = body
...
class OPLmetamodel_FormalParameter:
    ...
    def __init__(self, isOrdered: bool, OPLmetamodel_FormalParameter: "OPLmetamodel_AggregateExp" = None, OPLmetamodel_FormalParameter5: "OPLmetamodel_AllExpression" = None, OPLmetamodel_FormalParameter48: "OPLmetamodel_ParameterDomain" = None, OPLmetamodel_FormalParameter50: set["OPLmetamodel_BindingRef"] = None, OPLmetamodel_FormalParameter52: "OPLmetamodel_Expression" = None, OPLmetamodel_FormalParameter57: "OPLmetamodel_ForAllConstraint" = None):
...
class OPLmetamodel_Reference(Expression):
    ...
    def __init__(self, name: str, OPLmetamodel_Reference128: "OPLmetamodel_PathDereference" = None, OPLmetamodel_Reference: "OPLmetamodel_Function" = None, OPLmetamodel_Reference159: "OPLmetamodel_Script" = None):
        self.name = name
...
class OPLmetamodel_AggregateExp(Expression):
    ...
    def __init__(self, op: str, OPLmetamodel_AggregateExp: set["OPLmetamodel_FormalParameter"] = None, OPLmetamodel_AggregateExp3: "OPLmetamodel_Expression" = None):
        self.op = op
...
class OPLmetamodel_DataDeclaration(Declaration):
    ...
    def __init__(self, isDecisionVar: bool, isDecisionExpr: bool, OPLmetamodel_DataDeclaration: "OPLmetamodel_DataRef" = None, OPLmetamodel_DataDeclaration35: "OPLmetamodel_AbstractType" = None, OPLmetamodel_DataDeclaration38: "OPLmetamodel_Initialization" = None, OPLmetamodel_DataDeclaration40: "OPLmetamodel_Expression" = None, OPLmetamodel_DataDeclaration97: "OPLmetamodel_Model" = None):
...
class OPLmetamodel_Objective(Declaration):
    ...
    def __init__(self, action: str, isLinearRelaxation: bool, OPLmetamodel_Objective125: "OPLmetamodel_Expression" = None, OPLmetamodel_Objective: "OPLmetamodel_Model" = None):
        self.action = action
...
class OPLmetamodel_Constraint(Declaration):
    ...
    def __init__(self, name: str, OPLmetamodel_Constraint30: "OPLmetamodel_Expression" = None, OPLmetamodel_Constraint: "OPLmetamodel_Assertion" = None, OPLmetamodel_Constraint113: "OPLmetamodel_Model" = None, OPLmetamodel_Constraint100: "OPLmetamodel_Model" = None, OPLmetamodel_Constraint60: "OPLmetamodel_ForAllConstraint" = None, OPLmetamodel_Constraint72: "OPLmetamodel_IfConstraint" = None, OPLmetamodel_Constraint75: "OPLmetamodel_IfConstraint" = None):
        self.name = name
