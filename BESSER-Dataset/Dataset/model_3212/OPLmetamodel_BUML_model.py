...
# Classes
OPLmetamodel_AbstractType = Class(name="OPLmetamodel_AbstractType", is_abstract=True)
OPLmetamodel_ActivityDeclaration = Class(name="OPLmetamodel_ActivityDeclaration")
Declaration = Class(name="Declaration")
OPLmetamodel_Number = Class(name="OPLmetamodel_Number")
OPLmetamodel_AggregateExp = Class(name="OPLmetamodel_AggregateExp")
Expression = Class(name="Expression")
OPLmetamodel_FormalParameter = Class(name="OPLmetamodel_FormalParameter")
OPLmetamodel_Expression = Class(name="OPLmetamodel_Expression", is_abstract=True)
OPLmetamodel_AllExpression = Class(name="OPLmetamodel_AllExpression")
OPLmetamodel_ArrayDereference = Class(name="OPLmetamodel_ArrayDereference")
PathExpression = Class(name="PathExpression")
OPLmetamodel_PathExpression = Class(name="OPLmetamodel_PathExpression", is_abstract=True)
OPLmetamodel_AbstractBinaryOperator = Class(name="OPLmetamodel_AbstractBinaryOperator", is_abstract=True)
OPLmetamodel_BinaryOperator = Class(name="OPLmetamodel_BinaryOperator")
AbstractBinaryOperator = Class(name="AbstractBinaryOperator")
OPLmetamodel_BindingRef = Class(name="OPLmetamodel_BindingRef")
Reference = Class(name="Reference")
OPLmetamodel_BlockExpression = Class(name="OPLmetamodel_BlockExpression")
OPLmetamodel_BooleanBlock = Class(name="OPLmetamodel_BooleanBlock")
OPLmetamodel_BooleanExpression = Class(name="OPLmetamodel_BooleanExpression")
PrimitiveExpression = Class(name="PrimitiveExpression")
OPLmetamodel_BooleanType = Class(name="OPLmetamodel_BooleanType")
PrimitiveType = Class(name="PrimitiveType")
OPLmetamodel_BuiltInFunction = Class(name="OPLmetamodel_BuiltInFunction")
Function = Class(name="Function")
OPLmetamodel_CollectionExpression = Class(name="OPLmetamodel_CollectionExpression")
OPLmetamodel_Comprehension = Class(name="OPLmetamodel_Comprehension")
CollectionExpression = Class(name="CollectionExpression")
OPLmetamodel_CumulativeFunction = Class(name="OPLmetamodel_CumulativeFunction")
OPLmetamodel_DataDeclaration = Class(name="OPLmetamodel_DataDeclaration")
OPLmetamodel_ArraySlotConstraint = Class(name="OPLmetamodel_ArraySlotConstraint")
OPLmetamodel_ArrayType = Class(name="OPLmetamodel_ArrayType")
DefinedType = Class(name="DefinedType")
OPLmetamodel_DataRef = Class(name="OPLmetamodel_DataRef")
OPLmetamodel_ArrayValue = Class(name="OPLmetamodel_ArrayValue")
OPLmetamodel_Assertion = Class(name="OPLmetamodel_Assertion")
OPLmetamodel_Constraint = Class(name="OPLmetamodel_Constraint")
OPLmetamodel_BinaryExpression = Class(name="OPLmetamodel_BinaryExpression")
OPLmetamodel_Declaration = Class(name="OPLmetamodel_Declaration", is_abstract=True)
OPLmetamodel_DeferredInit = Class(name="OPLmetamodel_DeferredInit")
OPLmetamodel_DefinedType = Class(name="OPLmetamodel_DefinedType", is_abstract=True)
AbstractType = Class(name="AbstractType")
OPLmetamodel_DisplayInstruction = Class(name="OPLmetamodel_DisplayInstruction")
OPLmetamodel_ParameterDeclaration = Class(name="OPLmetamodel_ParameterDeclaration")
OPLmetamodel_EnumerationType = Class(name="OPLmetamodel_EnumerationType")
SetType = Class(name="SetType")
OPLmetamodel_Initialization = Class(name="OPLmetamodel_Initialization", is_abstract=True)
OPLmetamodel_DataInitMethods = Class(name="OPLmetamodel_DataInitMethods", is_abstract=True)
OPLmetamodel_DataObject = Class(name="OPLmetamodel_DataObject")
Initialization = Class(name="Initialization")
RangeType = Class(name="RangeType")
OPLmetamodel_FloatType = Class(name="OPLmetamodel_FloatType")
NumericType = Class(name="NumericType")
OPLmetamodel_ParameterDomain = Class(name="OPLmetamodel_ParameterDomain", is_abstract=True)
OPLmetamodel_Extension = Class(name="OPLmetamodel_Extension")
OPLmetamodel_FloatExpression = Class(name="OPLmetamodel_FloatExpression")
NumericExpression = Class(name="NumericExpression")
OPLmetamodel_ForAllConstraint = Class(name="OPLmetamodel_ForAllConstraint")
Constraint = Class(name="Constraint")
OPLmetamodel_Function = Class(name="OPLmetamodel_Function", is_abstract=True)
OPLmetamodel_FunctionRef = Class(name="OPLmetamodel_FunctionRef")
OPLmetamodel_EnumLiteral = Class(name="OPLmetamodel_EnumLiteral")
OPLmetamodel_Entity = Class(name="OPLmetamodel_Entity")
OPLmetamodel_Error = Class(name="OPLmetamodel_Error")
OPLmetamodel_FloatRangeType = Class(name="OPLmetamodel_FloatRangeType")
FloatType = Class(name="FloatType")
OPLmetamodel_IfExpression = Class(name="OPLmetamodel_IfExpression")
OPLmetamodel_In = Class(name="OPLmetamodel_In")
OPLmetamodel_IntegerType = Class(name="OPLmetamodel_IntegerType")
OPLmetamodel_Interval = Class(name="OPLmetamodel_Interval")
OPLmetamodel_RangeType = Class(name="OPLmetamodel_RangeType", is_abstract=True)
OPLmetamodel_NumericType = Class(name="OPLmetamodel_NumericType")
OPLmetamodel_StepFunction = Class(name="OPLmetamodel_StepFunction")
OPLmetamodel_IntegerExpression = Class(name="OPLmetamodel_IntegerExpression")
OPLmetamodel_IntegerRangeType = Class(name="OPLmetamodel_IntegerRangeType")
IntegerType = Class(name="IntegerType")
OPLmetamodel_IndexValuePair = Class(name="OPLmetamodel_IndexValuePair")
OPLmetamodel_Reference = Class(name="OPLmetamodel_Reference", is_abstract=True)
OPLmetamodel_FunctionCall = Class(name="OPLmetamodel_FunctionCall")
OPLmetamodel_IfConstraint = Class(name="OPLmetamodel_IfConstraint")
OPLmetamodel_ScheduleInitialization = Class(name="OPLmetamodel_ScheduleInitialization")
OPLmetamodel_Script = Class(name="OPLmetamodel_Script")
OPLmetamodel_Setting = Class(name="OPLmetamodel_Setting")
OPLmetamodel_SearchProcedure = Class(name="OPLmetamodel_SearchProcedure")
OPLmetamodel_NumericExpression = Class(name="OPLmetamodel_NumericExpression", is_abstract=True)
OPLmetamodel_Operator = Class(name="OPLmetamodel_Operator")
OPLmetamodel_ParameterRef = Class(name="OPLmetamodel_ParameterRef")
OPLmetamodel_Model = Class(name="OPLmetamodel_Model")
OPLmetamodel_Objective = Class(name="OPLmetamodel_Objective")
OPLmetamodel_ResourceDeclaration = Class(name="OPLmetamodel_ResourceDeclaration")
OPLmetamodel_RangeExpression = Class(name="OPLmetamodel_RangeExpression")
OPLmetamodel_ReadFile = Class(name="OPLmetamodel_ReadFile")
OPLmetamodel_Record = Class(name="OPLmetamodel_Record")
ParameterDomain = Class(name="ParameterDomain")
OPLmetamodel_RecordField = Class(name="OPLmetamodel_RecordField")
OPLmetamodel_PathDereference = Class(name="OPLmetamodel_PathDereference", is_abstract=True)
OPLmetamodel_PiecewiseExpression = Class(name="OPLmetamodel_PiecewiseExpression")
OPLmetamodel_PiecewiseLinearFunction = Class(name="OPLmetamodel_PiecewiseLinearFunction")
OPLmetamodel_PositiveFloatType = Class(name="OPLmetamodel_PositiveFloatType")
OPLmetamodel_PrimitiveExpression = Class(name="OPLmetamodel_PrimitiveExpression", is_abstract=True)
OPLmetamodel_PrimitiveType = Class(name="OPLmetamodel_PrimitiveType", is_abstract=True)
OPLmetamodel_PositiveIntegerType = Class(name="OPLmetamodel_PositiveIntegerType")
OPLmetamodel_QueryUser = Class(name="OPLmetamodel_QueryUser")
DataInitMethods = Class(name="DataInitMethods")
OPLmetamodel_RelationalOperator = Class(name="OPLmetamodel_RelationalOperator")
OPLmetamodel_ScriptStatement = Class(name="OPLmetamodel_ScriptStatement", is_abstract=True)
OPLmetamodel_Sequence = Class(name="OPLmetamodel_Sequence")
OPLmetamodel_SetType = Class(name="OPLmetamodel_SetType")
OPLmetamodel_RecordValue = Class(name="OPLmetamodel_RecordValue")
OPLmetamodel_ReflectiveFunction = Class(name="OPLmetamodel_ReflectiveFunction")
BuiltInFunction = Class(name="BuiltInFunction")
OPLmetamodel_RelationalExpression = Class(name="OPLmetamodel_RelationalExpression")
BinaryExpression = Class(name="BinaryExpression")
BooleanExpression = Class(name="BooleanExpression")
OPLmetamodel_RelationalInit = Class(name="OPLmetamodel_RelationalInit")
OPLmetamodel_VariableBinding = Class(name="OPLmetamodel_VariableBinding")
OPLmetamodel_Writeln = Class(name="OPLmetamodel_Writeln")
ScriptStatement = Class(name="ScriptStatement")
OPLmetamodel_SetValue = Class(name="OPLmetamodel_SetValue")
OPLmetamodel_StateFunction = Class(name="OPLmetamodel_StateFunction")
PiecewiseLinearFunction = Class(name="PiecewiseLinearFunction")
OPLmetamodel_StringExpression = Class(name="OPLmetamodel_StringExpression")
OPLmetamodel_StringType = Class(name="OPLmetamodel_StringType")
OPLmetamodel_TupleBinding = Class(name="OPLmetamodel_TupleBinding")
OPLmetamodel_UnaryExpression = Class(name="OPLmetamodel_UnaryExpression")
...
OPLmetamodel_ActivityDeclaration.attributes={OPLmetamodel_ActivityDeclaration_earliestStartTime, OPLmetamodel_ActivityDeclaration_latestEndTime}
...
OPLmetamodel_Objective.attributes={OPLmetamodel_Objective_isLinearRelaxation, OPLmetamodel_Objective_action}
...
OPLmetamodel_Writeln.attributes={OPLmetamodel_Writeln_string, OPLmetamodel_Writeln_arg}
...
else_81: BinaryAssociation = BinaryAssociation(
    name="else_81",
    ends={
...
else_73: BinaryAssociation = BinaryAssociation(
    name="else_73",
    ends={
...
domain_model = DomainModel(
    name="OPLmetamodel",
    types={OPLmetamodel_AbstractType, OPLmetamodel_ActivityDeclaration, Declaration, OPLmetamodel_Number, OPLmetamodel_AggregateExp, Expression, OPLmetamodel_FormalParameter, OPLmetamodel_Expression, OPLmetamodel_AllExpression, OPLmetamodel_ArrayDereference, PathExpression, OPLmetamodel_PathExpression, OPLmetamodel_AbstractBinaryOperator, OPLmetamodel_BinaryOperator, AbstractBinaryOperator, OPLmetamodel_BindingRef, Reference, OPLmetamodel_BlockExpression, OPLmetamodel_BooleanBlock, OPLmetamodel_BooleanExpression, PrimitiveExpression, OPLmetamodel_BooleanType, PrimitiveType, OPLmetamodel_BuiltInFunction, Function, OPLmetamodel_CollectionExpression, OPLmetamodel_Comprehension, CollectionExpression, OPLmetamodel_CumulativeFunction, OPLmetamodel_DataDeclaration, OPLmetamodel_ArraySlotConstraint, OPLmetamodel_ArrayType, DefinedType, OPLmetamodel_DataRef, OPLmetamodel_ArrayValue, OPLmetamodel_Assertion, OPLmetamodel_Constraint, OPLmetamodel_BinaryExpression, OPLmetamodel_Declaration, OPLmetamodel_DeferredInit, OPLmetamodel_DefinedType, AbstractType, OPLmetamodel_DisplayInstruction, OPLmetamodel_ParameterDeclaration, OPLmetamodel_EnumerationType, SetType, OPLmetamodel_Initialization, OPLmetamodel_DataInitMethods, OPLmetamodel_DataObject, Initialization, RangeType, OPLmetamodel_FloatType, NumericType, OPLmetamodel_ParameterDomain, OPLmetamodel_Extension, OPLmetamodel_FloatExpression, NumericExpression, OPLmetamodel_ForAllConstraint, Constraint, OPLmetamodel_Function, OPLmetamodel_FunctionRef, OPLmetamodel_EnumLiteral, OPLmetamodel_Entity, OPLmetamodel_Error, OPLmetamodel_FloatRangeType, FloatType, OPLmetamodel_IfExpression, OPLmetamodel_In, OPLmetamodel_IntegerType, OPLmetamodel_Interval, OPLmetamodel_RangeType, OPLmetamodel_NumericType, OPLmetamodel_StepFunction, OPLmetamodel_IntegerExpression, OPLmetamodel_IntegerRangeType, IntegerType, OPLmetamodel_IndexValuePair, OPLmetamodel_Reference, OPLmetamodel_FunctionCall, OPLmetamodel_IfConstraint, OPLmetamodel_ScheduleInitialization, OPLmetamodel_Script, OPLmetamodel_Setting, OPLmetamodel_SearchProcedure, OPLmetamodel_NumericExpression, OPLmetamodel_Operator, OPLmetamodel_ParameterRef, OPLmetamodel_Model, OPLmetamodel_Objective, OPLmetamodel_ResourceDeclaration, OPLmetamodel_RangeExpression, OPLmetamodel_ReadFile, OPLmetamodel_Record, ParameterDomain, OPLmetamodel_RecordField, OPLmetamodel_PathDereference, OPLmetamodel_PiecewiseExpression, OPLmetamodel_PiecewiseLinearFunction, OPLmetamodel_PositiveFloatType, OPLmetamodel_PrimitiveExpression, OPLmetamodel_PrimitiveType, OPLmetamodel_PositiveIntegerType, OPLmetamodel_QueryUser, DataInitMethods, OPLmetamodel_RelationalOperator, OPLmetamodel_ScriptStatement, OPLmetamodel_Sequence, OPLmetamodel_SetType, OPLmetamodel_RecordValue, OPLmetamodel_ReflectiveFunction, BuiltInFunction, OPLmetamodel_RelationalExpression, BinaryExpression, BooleanExpression, OPLmetamodel_RelationalInit, OPLmetamodel_VariableBinding, OPLmetamodel_Writeln, ScriptStatement, OPLmetamodel_SetValue, OPLmetamodel_StateFunction, PiecewiseLinearFunction, OPLmetamodel_StringExpression, OPLmetamodel_StringType, OPLmetamodel_TupleBinding, OPLmetamodel_UnaryExpression, AggOp, BinaryOp, LogicalOp, MembershipOp, OptimizationMode, Quantifier, RelationalOp, SetOp, UnaryOp},
    associations={duration0, parameters1, body2, qualifiers4, body6, array9, op26, blocks28, exp29, index10, target13, baseType15, subscripts16, items18, exp20, lhs21, rhs23, exps42, parameters44, variable32, type34, value37, valueConstraint39, domain47, boundVars49, require51, exps54, qualifiers56, exps58, name61, redefinedBaseType46, test76, then78, else_81, bounds84, size85, intensity87, index89, body62, parameters65, args67, test69, then70, else_73, assertions111, scheduleInit114, scripts116, settings118, declarations120, search122, expression124, value91, types94, data95, constraints98, instruction101, functions103, activities106, resources109, lowerLimit132, upperLimit133, type136, upperBound139, lowerBound142, fields145, deref127, base129, sources153, relation155, id157, statements160, intervals162, types164, type146, fieldPairs149, bindingVar151, exp177, vars179, domain182, baseType167, elements169, items171, transitionMatrix173, vars175},
    generalizations={gen_OPLmetamodel_ActivityDeclaration_Declaration, gen_OPLmetamodel_AggregateExp_Expression, gen_OPLmetamodel_ArrayDereference_PathExpression, gen_OPLmetamodel_BinaryOperator_AbstractBinaryOperator, gen_OPLmetamodel_BindingRef_Reference, gen_OPLmetamodel_BlockExpression_Expression, gen_OPLmetamodel_BooleanExpression_PrimitiveExpression, gen_OPLmetamodel_BooleanType_PrimitiveType, gen_OPLmetamodel_BuiltInFunction_Function, gen_OPLmetamodel_CollectionExpression_Expression, gen_OPLmetamodel_Constraint_Declaration, gen_OPLmetamodel_Comprehension_CollectionExpression, gen_OPLmetamodel_CumulativeFunction_Function, gen_OPLmetamodel_DataDeclaration_Declaration, gen_OPLmetamodel_ArraySlotConstraint_Expression, gen_OPLmetamodel_ArrayType_DefinedType, gen_OPLmetamodel_ArrayValue_Expression, gen_OPLmetamodel_Assertion_Declaration, gen_OPLmetamodel_BinaryExpression_Expression, gen_OPLmetamodel_DefinedType_AbstractType, gen_OPLmetamodel_DefinedType_Declaration, gen_OPLmetamodel_EnumerationType_SetType, gen_OPLmetamodel_DataObject_Initialization, gen_OPLmetamodel_DataRef_Reference, gen_OPLmetamodel_FloatRangeType_RangeType, gen_OPLmetamodel_FloatType_NumericType, gen_OPLmetamodel_Extension_CollectionExpression, gen_OPLmetamodel_FloatExpression_NumericExpression, gen_OPLmetamodel_ForAllConstraint_Constraint, gen_OPLmetamodel_Function_Declaration, gen_OPLmetamodel_EnumLiteral_PrimitiveType, gen_OPLmetamodel_EnumLiteral_PrimitiveExpression, gen_OPLmetamodel_FloatRangeType_FloatType, gen_OPLmetamodel_IfExpression_Expression, gen_OPLmetamodel_IntegerType_NumericType, gen_OPLmetamodel_IntegerExpression_NumericExpression, gen_OPLmetamodel_IntegerRangeType_IntegerType, gen_OPLmetamodel_IntegerRangeType_RangeType, gen_OPLmetamodel_IndexValuePair_Expression, gen_OPLmetamodel_FunctionCall_PathExpression, gen_OPLmetamodel_IfConstraint_Constraint, gen_OPLmetamodel_NumericExpression_PrimitiveExpression, gen_OPLmetamodel_NumericType_PrimitiveType, gen_OPLmetamodel_Objective_Declaration, gen_OPLmetamodel_ParameterRef_Reference, gen_OPLmetamodel_RangeExpression_NumericExpression, gen_OPLmetamodel_RangeType_SetType, gen_OPLmetamodel_ReadFile_DataInitMethods, gen_OPLmetamodel_Record_ParameterDomain, gen_OPLmetamodel_Record_DefinedType, gen_OPLmetamodel_PathDereference_PathExpression, gen_OPLmetamodel_PathExpression_Expression, gen_OPLmetamodel_PiecewiseLinearFunction_Function, gen_OPLmetamodel_PositiveFloatType_FloatType, gen_OPLmetamodel_PrimitiveExpression_Expression, gen_OPLmetamodel_PrimitiveType_AbstractType, gen_OPLmetamodel_PositiveIntegerType_IntegerType, gen_OPLmetamodel_QueryUser_DataInitMethods, gen_OPLmetamodel_RelationalOperator_AbstractBinaryOperator, gen_OPLmetamodel_ResourceDeclaration_Declaration, gen_OPLmetamodel_ScheduleInitialization_Declaration, gen_OPLmetamodel_Script_Declaration, gen_OPLmetamodel_Setting_Declaration, gen_OPLmetamodel_SetType_DefinedType, gen_OPLmetamodel_SetType_ParameterDomain, gen_OPLmetamodel_RecordValue_Expression, gen_OPLmetamodel_Reference_Expression, gen_OPLmetamodel_ReflectiveFunction_BuiltInFunction, gen_OPLmetamodel_RelationalExpression_BinaryExpression, gen_OPLmetamodel_RelationalExpression_BooleanExpression, gen_OPLmetamodel_RelationalInit_Initialization, gen_OPLmetamodel_Writeln_ScriptStatement, gen_OPLmetamodel_SetValue_Expression, gen_OPLmetamodel_StateFunction_Function, gen_OPLmetamodel_StepFunction_PiecewiseLinearFunction, gen_OPLmetamodel_StringExpression_PrimitiveExpression, gen_OPLmetamodel_StringType_PrimitiveType, gen_OPLmetamodel_UnaryExpression_Expression},
    metadata=None
)
