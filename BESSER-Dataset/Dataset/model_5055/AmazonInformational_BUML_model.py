...
domain_model = DomainModel(
    ...
    types={amazoninformational_Shipment, amazoninformational_Invoice, amazoninformational_Package, amazoninformational_Order, amazoninformational_Product, amazoninformational_Payment},
    associations={products0, shipment1, invoice2, packages4, products6, order8, package9, order11, order13, payment15},
    generalizations={},
    metadata=None
)
