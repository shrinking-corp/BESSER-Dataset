...
Profile.attributes={Profile_address1, Profile_IDNum, Profile_zipcode, Profile_firstname, Profile_lastname, Profile_country, Profile_address2, Profile_IDType, Profile_city, Profile_state, Profile_email, Profile_phoneNumber, Profile_dateOfBirth, Profile_userID}
...
User.attributes={User_username, User_userRole, User_userID, User_lastLoginTime, User_password}
...
transaction_Transaction.attributes={transaction_Transaction_comment, transaction_Transaction_type, transaction_Transaction_time, transaction_Transaction_amount, transaction_Transaction_transactionID, transaction_Transaction_sourceAccountNum, transaction_Transaction_description, transaction_Transaction_destinationAccountNum}
...
transaction_ExternalAccount.attributes={transaction_ExternalAccount_accountNum, transaction_ExternalAccount_associatedAccount, transaction_ExternalAccount_routingNum}
...
transaction_Payee.attributes={transaction_Payee_country, transaction_Payee_state, transaction_Payee_email, transaction_Payee_city, transaction_Payee_accountNum, transaction_Payee_address1, transaction_Payee_name, transaction_Payee_address2, transaction_Payee_phoneNum, transaction_Payee_zipcode}
...
account_Account.attributes={account_Account_accountNum, account_Account_pin, account_Account_balance, account_Account_type, account_Account_userID}
...
domain_model = DomainModel(
    name="cefafd9b_c215_453a_9fcb_e0c0c1b386d2",
    types={Profile, User, transaction_Transaction, transaction_DepositTransaction, transaction_TransferTransaction, transaction_PaybillsTransaction, transaction_ExternalAccount, transaction_Payee, account_SavingsAccount, account_Account, transaction_TransactionType, account_AccountType, UserGroup},
