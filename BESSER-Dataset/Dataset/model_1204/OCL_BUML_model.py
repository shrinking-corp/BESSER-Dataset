...
utilities_PredefinedType = Class(name="utilities_PredefinedType")
...
utilities_TypedASTNode = Class(name="utilities_TypedASTNode")
types_ocl_EClassifier = Class(name="types_ocl_EClassifier")
...
types_ocl_EOperation = Class(name="types_ocl_EOperation")
types_ocl_EClass = Class(name="types_ocl_EClass")
ocl_types_OrderedSetType = Class(name="ocl_types_OrderedSetType")
ocl_types_PrimitiveBoolean = Class(name="ocl_types_PrimitiveBoolean")
PrimitiveType = Class(name="PrimitiveType")
ocl_types_PrimitiveInteger = Class(name="ocl_types_PrimitiveInteger")
PrimitiveReal = Class(name="PrimitiveReal")
ocl_types_PrimitiveReal = Class(name="ocl_types_PrimitiveReal")
ocl_types_PrimitiveString = Class(name="ocl_types_PrimitiveString")
ocl_types_PrimitiveType = Class(name="ocl_types_PrimitiveType", is_abstract=True)
...
expressions_ocl_EClass = Class(name="expressions_ocl_EClass")
...
expressions_OCLExpression = Class(name="expressions_OCLExpression")
utilities_CallingASTNode = Class(name="utilities_CallingASTNode")
...
ocl_expressions_CollectionLiteralPart = Class(name="ocl_expressions_CollectionLiteralPart")
...
expressions_ocl_EEnumLiteral = Class(name="expressions_ocl_EEnumLiteral")
...
ocl_expressions_LoopExp = Class(name="ocl_expressions_LoopExp")
...
expressions_ocl_EStructuralFeature = Class(name="expressions_ocl_EStructuralFeature")
...
uml_TypedElement = Class(name="uml_TypedElement")
utilities_Visitable = Class(name="utilities_Visitable")
utilities_ASTNode = Class(name="utilities_ASTNode")
ocl_expressions_OperationCallExp = Class(name="ocl_expressions_OperationCallExp")
expressions_ocl_EOperation = Class(name="expressions_ocl_EOperation")
...
expressions_ocl_EObject = Class(name="expressions_ocl_EObject")
...
expressions_ocl_EClassifier = Class(name="expressions_ocl_EClassifier")
...
expressions_ocl_EParameter = Class(name="expressions_ocl_EParameter")
ocl_expressions_VariableExp = Class(name="ocl_expressions_VariableExp")
ocl_uml_CallOperationAction = Class(name="ocl_uml_CallOperationAction")
uml_ocl_EOperation = Class(name="uml_ocl_EOperation")
ocl_uml_Constraint = Class(name="ocl_uml_Constraint")
ENamedElement = Class(name="ENamedElement")
uml_ocl_ENamedElement = Class(name="uml_ocl_ENamedElement")
ocl_uml_SendSignalAction = Class(name="ocl_uml_SendSignalAction")
uml_ocl_EClass = Class(name="uml_ocl_EClass")
ocl_uml_TypedElement = Class(name="ocl_uml_TypedElement", is_abstract=True)
uml_ocl_EClassifier = Class(name="uml_ocl_EClassifier")
...
ocl_utilities_Visitable = Class(name="ocl_utilities_Visitable")
ocl_query_Query = Class(name="ocl_query_Query")
...
ocl_uml_Constraint.attributes={ocl_uml_Constraint_instanceVarName, ocl_uml_Constraint_stereotype}
...
ocl_utilities_PredefinedType_m_getOperationNameFor: Method = Method(name="getOperationNameFor", parameters={Parameter(name='ocl_opcode', type=StringType)}, type=StringType)
ocl_utilities_PredefinedType_m_getOperationCodeFor: Method = Method(name="getOperationCodeFor", parameters={Parameter(name='ocl_operName', type=StringType)}, type=IntegerType)
ocl_utilities_PredefinedType_m_getResultTypeFor: Method = Method(name="getResultTypeFor", parameters={Parameter(name='ocl_ownerType', type=StringType), Parameter(name='ocl_args', type=StringType), Parameter(name='ocl_opcode', type=StringType)}, type=EClassifier)
ocl_utilities_PredefinedType_m_getRelationshipTo: Method = Method(name="getRelationshipTo", parameters={Parameter(name='ocl_type', type=StringType)}, type=IntegerType)
ocl_utilities_PredefinedType_m_getCommonSupertype: Method = Method(name="getCommonSupertype", parameters={Parameter(name='ocl_type', type=StringType)}, type=EClassifier)
ocl_utilities_PredefinedType.methods={ocl_utilities_PredefinedType_m_getCommonSupertype, ocl_utilities_PredefinedType_m_getOperations, ocl_utilities_PredefinedType_m_getRelationshipTo, ocl_utilities_PredefinedType_m_getOperationCodeFor, ocl_utilities_PredefinedType_m_getOperationNameFor, ocl_utilities_PredefinedType_m_getResultTypeFor}
...
ocl_utilities_Visitable_m_accept: Method = Method(name="accept", parameters={Parameter(name='ocl_v', type=StringType)}, type=StringType)
...
ocl_query_Query_m_evaluate: Method = Method(name="evaluate", parameters={Parameter(name='ocl_obj', type=StringType)}, type=StringType)
ocl_query_Query_m_evaluate: Method = Method(name="evaluate", parameters={}, type=StringType)
ocl_query_Query_m_check: Method = Method(name="check", parameters={Parameter(name='ocl_obj', type=StringType)}, type=BooleanType)
ocl_query_Query_m_evaluate: Method = Method(name="evaluate", parameters={Parameter(name='ocl_objects', type=StringType)}, type=StringType)
ocl_query_Query_m_check: Method = Method(name="check", parameters={Parameter(name='ocl_objects', type=StringType)}, type=BooleanType)
ocl_query_Query_m_select: Method = Method(name="select", parameters={Parameter(name='ocl_objects', type=StringType)}, type=StringType)
ocl_query_Query_m_reject: Method = Method(name="reject", parameters={Parameter(name='ocl_objects', type=StringType)}, type=StringType)
...
ocl_query_Query.methods={ocl_query_Query_m_reject, ocl_query_Query_m_evaluate, ocl_query_Query_m_evaluate, ocl_query_Query_m_check, ocl_query_Query_m_check, ocl_query_Query_m_resultType, ocl_query_Query_m_evaluate, ocl_query_Query_m_select, ocl_query_Query_m_queryText}
...
in_24: BinaryAssociation = BinaryAssociation(
    name="in_24",
    ends={
