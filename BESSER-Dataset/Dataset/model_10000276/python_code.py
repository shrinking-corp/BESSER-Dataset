...
class Calender_Event:
    ...
    def __init__(self, category: str, date: str, time: str, description: str, eventType: str, participantAmount: str, volunteer: Volunteer, nomarlUser: Normal_user, admin: Admin, Add_Edit_Vew7: set["SuperAdmin"] = None, Add_Edit_View1: set["Volunteer"] = None, Add_Edit_View3: set["Admin"] = None, Add_Edit_View5: "Normal_user" = None):
...
class Volunteer:
    ...
    def __init__(self, userID: int, userName: str, password: str, payment12: "Payment" = None, calender_Event0: set["Calender_Event"] = None):
        self.userID = userID
...
class Admin:
    ...
    def __init__(self, userID: int, userName: str, password: str, payment14: "Payment" = None, mail20: set["Mail"] = None, calender_Event2: set["Calender_Event"] = None):
        self.userID = userID
        self.userName = userName
        self.password = password
...
class Normal_user:
    ...
    def __init__(self, userID: int, userName: str, password: str, payment216: "Payment" = None, calender_Event4: set["Calender_Event"] = None):
        self.userID = userID
        self.userName = userName
        self.password = password
