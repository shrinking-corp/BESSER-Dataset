...
class trnetvisual_ExternalActionCall(Action):
    ...
    def __init__(self, id: str, qualifiedName: str, owner102: set["trnetvisual_ExternalActionCallParameter"] = None, ExternalActionCall: "trnetvisual_ExternalActionCallParameter" = None):
        self.id = id
        self.qualifiedName = qualifiedName
...
class trnetvisual_ExternalAttributeCalculationCall(AttributeCalculation):
    ...
    def __init__(self, id: str, qualifiedName: str, ExternalAttributeCalculationCall105: "trnetvisual_ExternalAttributeCalculationCallParameter" = None, owner: set["trnetvisual_ExternalAttributeCalculationCallParameter"] = None, ExternalAttributeCalculationCall: "trnetvisual_AttributePattern" = None, attributeExternalCalculationCall: "trnetvisual_AttributePattern" = None):
        self.id = id
        self.qualifiedName = qualifiedName
...
class trnetvisual_NodePattern(Parameter):
    ...
    def __init__(self, name: str, id: str, expectedNumberOfDistinctValues: float, target19: set["trnetvisual_Same"] = None, nodes: "trnetvisual_Pattern" = None, ownerNode: set["trnetvisual_AttributePattern"] = None, target24: set["trnetvisual_Keep"] = None, source26: set["trnetvisual_Keep"] = None, target29: set["trnetvisual_Different"] = None, source31: set["trnetvisual_Different"] = None, NodePattern: "trnetvisual_EdgePattern" = None, NodePattern39: "trnetvisual_Pattern" = None, target: set["trnetvisual_EdgePattern"] = None, source: set["trnetvisual_EdgePattern"] = None, source17: set["trnetvisual_Same"] = None, NodePattern57: "trnetvisual_AttributePattern" = None, NodePattern59: "trnetvisual_Keep" = None, NodePattern61: "trnetvisual_Keep" = None, NodePattern35: "trnetvisual_EdgePattern" = None, NodePattern48: "trnetvisual_Same" = None, NodePattern50: "trnetvisual_Same" = None, NodePattern52: "trnetvisual_Different" = None, NodePattern54: "trnetvisual_Different" = None):
        self.name = name
        self.id = id
        ...
        pass
    @property
    def expectedNumberOfDistinctValues(self):
...
class trnetvisual_AttributePattern(Parameter):
    ...
    def __init__(self, expectedNumberOfDistinctValues: float, name: str, AttributePattern: "trnetvisual_NodePattern" = None, attributes: "trnetvisual_NodePattern" = None, result: "trnetvisual_ExternalAttributeCalculationCall" = None, AttributePattern88: "trnetvisual_ExternalAttributeCalculationCall" = None):
        self.expectedNumberOfDistinctValues = expectedNumberOfDistinctValues
        self.name = name
...
class trnetvisual_EdgePattern:
    ...
    def __init__(self, name: str, outgoing: "trnetvisual_NodePattern" = None, EdgePattern42: "trnetvisual_Pattern" = None, EdgePattern: "trnetvisual_NodePattern" = None, EdgePattern15: "trnetvisual_NodePattern" = None, incoming: "trnetvisual_NodePattern" = None, edges: "trnetvisual_Pattern" = None):
        self.name = name
...
class trnetvisual_Operand(ABC):
    ...
    def __init__(self, index: int, Operand: "trnetvisual_Pattern" = None, trnetvisual_Operand: "trnetvisual_TrNetModel" = None, Operand63: "trnetvisual_Operator" = None, operands: "trnetvisual_Operator" = None, outgoingOperands: "trnetvisual_Pattern" = None):
        self.index = index
...
class trnetvisual_Operator(ABC):
    ...
    def __init__(self, id: str, trnetvisual_Operator: "trnetvisual_TrNetModel" = None, trnetvisual_Operator75: set["trnetvisual_Action"] = None, Operator: "trnetvisual_Result" = None, operator: set["trnetvisual_Operand"] = None, operator65: set["trnetvisual_Result"] = None, source68: set["trnetvisual_FlowRule"] = None, target70: set["trnetvisual_FlowRule"] = None, trnetvisual_Operator73: set["trnetvisual_ApplicationCondition"] = None, Operator84: "trnetvisual_FlowRule" = None, Operator86: "trnetvisual_FlowRule" = None, Operator80: "trnetvisual_Operand" = None):
        self.id = id
...
class trnetvisual_Pattern:
    ...
    def __init__(self, id: str, expected_size: float, Pattern: "trnetvisual_NodePattern" = None, pattern: set["trnetvisual_NodePattern"] = None, pattern41: set["trnetvisual_EdgePattern"] = None, pattern44: set["trnetvisual_Result"] = None, pattern46: set["trnetvisual_Operand"] = None, trnetvisual_Pattern: "trnetvisual_TrNetModel" = None, Pattern37: "trnetvisual_EdgePattern" = None, Pattern77: "trnetvisual_Result" = None, Pattern82: "trnetvisual_Operand" = None):
        self.id = id
...
class trnetvisual_TrNetModel:
    ...
    def __init__(self, id: str, trnetvisual_TrNetModel12: set["trnetvisual_Calculation"] = None, trnetvisual_TrNetModel: set["trnetvisual_Pattern"] = None, trnetvisual_TrNetModel2: set["trnetvisual_Operator"] = None, trnetvisual_TrNetModel4: set["trnetvisual_Restriction"] = None, trnetvisual_TrNetModel6: set["trnetvisual_Operand"] = None, trnetvisual_TrNetModel8: set["trnetvisual_Result"] = None, trnetvisual_TrNetModel10: set["trnetvisual_FlowRule"] = None):
        self.id = id
