...
def test_hyp_calculation_is_not_abstract():
    assert not inspect.isabstract(Calculation)


def test_hyp_calculation_constructor_exists():
    assert callable(Calculation.__init__)


def test_hyp_calculation_constructor_args():
    sig = inspect.signature(Calculation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trnetvisual_externalcalculationcall_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_ExternalCalculationCall)


def test_hyp_trnetvisual_externalcalculationcall_constructor_exists():
    assert callable(trnetvisual_ExternalCalculationCall.__init__)


def test_hyp_trnetvisual_externalcalculationcall_constructor_args():
...
def test_hyp_trnetvisual_parameterref_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_ParameterRef)


def test_hyp_trnetvisual_parameterref_constructor_exists():
    assert callable(trnetvisual_ParameterRef.__init__)


def test_hyp_trnetvisual_parameterref_constructor_args():
...
def test_hyp_applicationcondition_is_not_abstract():
    assert not inspect.isabstract(ApplicationCondition)


def test_hyp_applicationcondition_constructor_exists():
    assert callable(ApplicationCondition.__init__)


def test_hyp_applicationcondition_constructor_args():
    sig = inspect.signature(ApplicationCondition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trnetvisual_externalconditioncall_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_ExternalConditionCall)


def test_hyp_trnetvisual_externalconditioncall_constructor_exists():
    assert callable(trnetvisual_ExternalConditionCall.__init__)


def test_hyp_trnetvisual_externalconditioncall_constructor_args():
...
def test_hyp_trnetvisual_parameter_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_Parameter)


def test_hyp_trnetvisual_parameter_constructor_exists():
    assert callable(trnetvisual_Parameter.__init__)


def test_hyp_trnetvisual_parameter_constructor_args():
    sig = inspect.signature(trnetvisual_Parameter.__init__)
    params = list(sig.parameters.keys())



def test_hyp_parameterref_is_not_abstract():
    assert not inspect.isabstract(ParameterRef)


def test_hyp_parameterref_constructor_exists():
    assert callable(ParameterRef.__init__)


def test_hyp_parameterref_constructor_args():
    sig = inspect.signature(ParameterRef.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trnetvisual_externalattributecalculationcallparameter_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_ExternalAttributeCalculationCallParameter)


def test_hyp_trnetvisual_externalattributecalculationcallparameter_constructor_exists():
    assert callable(trnetvisual_ExternalAttributeCalculationCallParameter.__init__)


def test_hyp_trnetvisual_externalattributecalculationcallparameter_constructor_args():
    sig = inspect.signature(trnetvisual_ExternalAttributeCalculationCallParameter.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trnetvisual_externalconditioncallparameter_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_ExternalConditionCallParameter)


def test_hyp_trnetvisual_externalconditioncallparameter_constructor_exists():
    assert callable(trnetvisual_ExternalConditionCallParameter.__init__)


def test_hyp_trnetvisual_externalconditioncallparameter_constructor_args():
    sig = inspect.signature(trnetvisual_ExternalConditionCallParameter.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trnetvisual_externalcalculationcallparameter_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_ExternalCalculationCallParameter)


def test_hyp_trnetvisual_externalcalculationcallparameter_constructor_exists():
    assert callable(trnetvisual_ExternalCalculationCallParameter.__init__)


def test_hyp_trnetvisual_externalcalculationcallparameter_constructor_args():
    sig = inspect.signature(trnetvisual_ExternalCalculationCallParameter.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trnetvisual_externalactioncallparameter_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_ExternalActionCallParameter)


def test_hyp_trnetvisual_externalactioncallparameter_constructor_exists():
    assert callable(trnetvisual_ExternalActionCallParameter.__init__)


def test_hyp_trnetvisual_externalactioncallparameter_constructor_args():
...
def test_hyp_trnetvisual_externalactioncall_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_ExternalActionCall)


def test_hyp_trnetvisual_externalactioncall_constructor_exists():
    assert callable(trnetvisual_ExternalActionCall.__init__)


def test_hyp_trnetvisual_externalactioncall_constructor_args():
...
def test_hyp_trnetvisual_antioperand_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_AntiOperand)


def test_hyp_trnetvisual_antioperand_constructor_exists():
    assert callable(trnetvisual_AntiOperand.__init__)


def test_hyp_trnetvisual_antioperand_constructor_args():
    sig = inspect.signature(trnetvisual_AntiOperand.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trnetvisual_someoperand_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_SomeOperand)


def test_hyp_trnetvisual_someoperand_constructor_exists():
    assert callable(trnetvisual_SomeOperand.__init__)


def test_hyp_trnetvisual_someoperand_constructor_args():
...
def test_hyp_trnetvisual_optionaloperand_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_OptionalOperand)


def test_hyp_trnetvisual_optionaloperand_constructor_exists():
    assert callable(trnetvisual_OptionalOperand.__init__)


def test_hyp_trnetvisual_optionaloperand_constructor_args():
    sig = inspect.signature(trnetvisual_OptionalOperand.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trnetvisual_anyoperand_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_AnyOperand)


def test_hyp_trnetvisual_anyoperand_constructor_exists():
    assert callable(trnetvisual_AnyOperand.__init__)


def test_hyp_trnetvisual_anyoperand_constructor_args():
    sig = inspect.signature(trnetvisual_AnyOperand.__init__)
    params = list(sig.parameters.keys())



def test_hyp_attributecalculation_is_not_abstract():
    assert not inspect.isabstract(AttributeCalculation)


def test_hyp_attributecalculation_constructor_exists():
    assert callable(AttributeCalculation.__init__)


def test_hyp_attributecalculation_constructor_args():
    sig = inspect.signature(AttributeCalculation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_flowrule_is_not_abstract():
    assert not inspect.isabstract(FlowRule)


def test_hyp_flowrule_constructor_exists():
    assert callable(FlowRule.__init__)


def test_hyp_flowrule_constructor_args():
    sig = inspect.signature(FlowRule.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trnetvisual_nextderived_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_NextDerived)


def test_hyp_trnetvisual_nextderived_constructor_exists():
    assert callable(trnetvisual_NextDerived.__init__)


def test_hyp_trnetvisual_nextderived_constructor_args():
    sig = inspect.signature(trnetvisual_NextDerived.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trnetvisual_eventually_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_Eventually)


def test_hyp_trnetvisual_eventually_constructor_exists():
    assert callable(trnetvisual_Eventually.__init__)


def test_hyp_trnetvisual_eventually_constructor_args():
    sig = inspect.signature(trnetvisual_Eventually.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trnetvisual_next_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_Next)


def test_hyp_trnetvisual_next_constructor_exists():
    assert callable(trnetvisual_Next.__init__)


def test_hyp_trnetvisual_next_constructor_args():
    sig = inspect.signature(trnetvisual_Next.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trnetvisual_applicationcondition_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_ApplicationCondition)


def test_hyp_trnetvisual_applicationcondition_constructor_exists():
    assert callable(trnetvisual_ApplicationCondition.__init__)


def test_hyp_trnetvisual_applicationcondition_constructor_args():
...
def test_hyp_trnetvisual_external_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_External)


def test_hyp_trnetvisual_external_constructor_exists():
    assert callable(trnetvisual_External.__init__)


def test_hyp_trnetvisual_external_constructor_args():
    sig = inspect.signature(trnetvisual_External.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trnetvisual_combinator_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_Combinator)


def test_hyp_trnetvisual_combinator_constructor_exists():
    assert callable(trnetvisual_Combinator.__init__)


def test_hyp_trnetvisual_combinator_constructor_args():
...
def test_hyp_trnetvisual_someresult_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_SomeResult)


def test_hyp_trnetvisual_someresult_constructor_exists():
    assert callable(trnetvisual_SomeResult.__init__)


def test_hyp_trnetvisual_someresult_constructor_args():
...
def test_hyp_trnetvisual_anyresult_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_AnyResult)


def test_hyp_trnetvisual_anyresult_constructor_exists():
    assert callable(trnetvisual_AnyResult.__init__)


def test_hyp_trnetvisual_anyresult_constructor_args():
    sig = inspect.signature(trnetvisual_AnyResult.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trnetvisual_action_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_Action)


def test_hyp_trnetvisual_action_constructor_exists():
    assert callable(trnetvisual_Action.__init__)


def test_hyp_trnetvisual_action_constructor_args():
    sig = inspect.signature(trnetvisual_Action.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trnetvisual_externalattributecalculationcall_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_ExternalAttributeCalculationCall)


def test_hyp_trnetvisual_externalattributecalculationcall_constructor_exists():
    assert callable(trnetvisual_ExternalAttributeCalculationCall.__init__)


def test_hyp_trnetvisual_externalattributecalculationcall_constructor_args():
...
def test_hyp_nodepattern_is_not_abstract():
    assert not inspect.isabstract(NodePattern)


def test_hyp_nodepattern_constructor_exists():
    assert callable(NodePattern.__init__)


def test_hyp_nodepattern_constructor_args():
    sig = inspect.signature(NodePattern.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trnetvisual_optionalnode_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_OptionalNode)


def test_hyp_trnetvisual_optionalnode_constructor_exists():
    assert callable(trnetvisual_OptionalNode.__init__)


def test_hyp_trnetvisual_optionalnode_constructor_args():
    sig = inspect.signature(trnetvisual_OptionalNode.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trnetvisual_mandatorynode_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_MandatoryNode)


def test_hyp_trnetvisual_mandatorynode_constructor_exists():
    assert callable(trnetvisual_MandatoryNode.__init__)


def test_hyp_trnetvisual_mandatorynode_constructor_args():
...
def test_hyp_trnetvisual_attributecalculation_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_AttributeCalculation)


def test_hyp_trnetvisual_attributecalculation_constructor_exists():
    assert callable(trnetvisual_AttributeCalculation.__init__)


def test_hyp_trnetvisual_attributecalculation_constructor_args():
...
def test_hyp_trnetvisual_nodepattern_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_NodePattern)


def test_hyp_trnetvisual_nodepattern_constructor_exists():
    assert callable(trnetvisual_NodePattern.__init__)


def test_hyp_trnetvisual_nodepattern_constructor_args():
...
def test_hyp_trnetvisual_calculation_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_Calculation)


def test_hyp_trnetvisual_calculation_constructor_exists():
    assert callable(trnetvisual_Calculation.__init__)


def test_hyp_trnetvisual_calculation_constructor_args():
    sig = inspect.signature(trnetvisual_Calculation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trnetvisual_different_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_Different)


def test_hyp_trnetvisual_different_constructor_exists():
    assert callable(trnetvisual_Different.__init__)


def test_hyp_trnetvisual_different_constructor_args():
    sig = inspect.signature(trnetvisual_Different.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trnetvisual_keep_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_Keep)


def test_hyp_trnetvisual_keep_constructor_exists():
    assert callable(trnetvisual_Keep.__init__)


def test_hyp_trnetvisual_keep_constructor_args():
    sig = inspect.signature(trnetvisual_Keep.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trnetvisual_attributepattern_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_AttributePattern)


def test_hyp_trnetvisual_attributepattern_constructor_exists():
    assert callable(trnetvisual_AttributePattern.__init__)


def test_hyp_trnetvisual_attributepattern_constructor_args():
...
def test_hyp_trnetvisual_same_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_Same)


def test_hyp_trnetvisual_same_constructor_exists():
    assert callable(trnetvisual_Same.__init__)


def test_hyp_trnetvisual_same_constructor_args():
    sig = inspect.signature(trnetvisual_Same.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trnetvisual_edgepattern_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_EdgePattern)


def test_hyp_trnetvisual_edgepattern_constructor_exists():
    assert callable(trnetvisual_EdgePattern.__init__)


def test_hyp_trnetvisual_edgepattern_constructor_args():
...
def test_hyp_trnetvisual_flowrule_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_FlowRule)


def test_hyp_trnetvisual_flowrule_constructor_exists():
    assert callable(trnetvisual_FlowRule.__init__)


def test_hyp_trnetvisual_flowrule_constructor_args():
    sig = inspect.signature(trnetvisual_FlowRule.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trnetvisual_result_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_Result)


def test_hyp_trnetvisual_result_constructor_exists():
    assert callable(trnetvisual_Result.__init__)


def test_hyp_trnetvisual_result_constructor_args():
    sig = inspect.signature(trnetvisual_Result.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trnetvisual_operand_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_Operand)


def test_hyp_trnetvisual_operand_constructor_exists():
    assert callable(trnetvisual_Operand.__init__)


def test_hyp_trnetvisual_operand_constructor_args():
...
def test_hyp_trnetvisual_restriction_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_Restriction)


def test_hyp_trnetvisual_restriction_constructor_exists():
    assert callable(trnetvisual_Restriction.__init__)


def test_hyp_trnetvisual_restriction_constructor_args():
    sig = inspect.signature(trnetvisual_Restriction.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trnetvisual_operator_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_Operator)


def test_hyp_trnetvisual_operator_constructor_exists():
    assert callable(trnetvisual_Operator.__init__)


def test_hyp_trnetvisual_operator_constructor_args():
...
def test_hyp_trnetvisual_pattern_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_Pattern)


def test_hyp_trnetvisual_pattern_constructor_exists():
    assert callable(trnetvisual_Pattern.__init__)


def test_hyp_trnetvisual_pattern_constructor_args():
...
def test_hyp_trnetvisual_trnetmodel_is_not_abstract():
    assert not inspect.isabstract(trnetvisual_TrNetModel)


def test_hyp_trnetvisual_trnetmodel_constructor_exists():
    assert callable(trnetvisual_TrNetModel.__init__)


def test_hyp_trnetvisual_trnetmodel_constructor_args():
...
def test_hyp_trnetvisual_externalcalculationcall_id_setter(instance):
...
@given(instance=trnetvisual_ExternalCalculationCall_strategy)
def test_hyp_trnetvisual_externalcalculationcall_qualifiedName_setter(instance):
...
def test_hyp_trnetvisual_parameterref_index_setter(instance):
...
def test_hyp_trnetvisual_externalconditioncall_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
@given(instance=trnetvisual_ExternalConditionCall_strategy)
def test_hyp_trnetvisual_externalconditioncall_qualifiedName_setter(instance):
    original = instance.qualifiedName
    instance.qualifiedName = original
    assert instance.qualifiedName == original
...
def test_hyp_trnetvisual_externalactioncall_qualifiedName_setter(instance):
    original = instance.qualifiedName
    instance.qualifiedName = original
    assert instance.qualifiedName == original
...
@given(instance=trnetvisual_ExternalActionCall_strategy)
def test_hyp_trnetvisual_externalactioncall_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
def test_hyp_trnetvisual_someoperand_count_setter(instance):
...
def test_hyp_trnetvisual_someresult_count_setter(instance):
    original = instance.count
    instance.count = original
    assert instance.count == original
...
def test_hyp_trnetvisual_externalattributecalculationcall_qualifiedName_setter(instance):
    original = instance.qualifiedName
    instance.qualifiedName = original
    assert instance.qualifiedName == original
...
@given(instance=trnetvisual_ExternalAttributeCalculationCall_strategy)
def test_hyp_trnetvisual_externalattributecalculationcall_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
def test_hyp_trnetvisual_nodepattern_expectedNumberOfDistinctValues_setter(instance):
...
@given(instance=trnetvisual_NodePattern_strategy)
def test_hyp_trnetvisual_nodepattern_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
@given(instance=trnetvisual_NodePattern_strategy)
def test_hyp_trnetvisual_nodepattern_name_setter(instance):
...
def test_hyp_trnetvisual_attributepattern_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=trnetvisual_AttributePattern_strategy)
def test_hyp_trnetvisual_attributepattern_expectedNumberOfDistinctValues_setter(instance):
    original = instance.expectedNumberOfDistinctValues
    instance.expectedNumberOfDistinctValues = original
    assert instance.expectedNumberOfDistinctValues == original
...
def test_hyp_trnetvisual_edgepattern_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_trnetvisual_operand_index_setter(instance):
    original = instance.index
    instance.index = original
    assert instance.index == original
...
def test_hyp_trnetvisual_operator_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
def test_hyp_trnetvisual_pattern_expected_size_setter(instance):
...
@given(instance=trnetvisual_Pattern_strategy)
def test_hyp_trnetvisual_pattern_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
def test_hyp_trnetvisual_trnetmodel_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
