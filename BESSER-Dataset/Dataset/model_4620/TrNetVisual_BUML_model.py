...
# Classes
trnetvisual_TrNetModel = Class(name="trnetvisual_TrNetModel")
trnetvisual_Pattern = Class(name="trnetvisual_Pattern")
trnetvisual_Operator = Class(name="trnetvisual_Operator", is_abstract=True)
trnetvisual_Restriction = Class(name="trnetvisual_Restriction", is_abstract=True)
trnetvisual_Operand = Class(name="trnetvisual_Operand", is_abstract=True)
trnetvisual_Result = Class(name="trnetvisual_Result", is_abstract=True)
trnetvisual_FlowRule = Class(name="trnetvisual_FlowRule", is_abstract=True)
trnetvisual_EdgePattern = Class(name="trnetvisual_EdgePattern")
trnetvisual_Same = Class(name="trnetvisual_Same")
trnetvisual_AttributePattern = Class(name="trnetvisual_AttributePattern")
trnetvisual_Keep = Class(name="trnetvisual_Keep")
trnetvisual_Different = Class(name="trnetvisual_Different")
trnetvisual_Calculation = Class(name="trnetvisual_Calculation", is_abstract=True)
trnetvisual_NodePattern = Class(name="trnetvisual_NodePattern", is_abstract=True)
Parameter_ = Class(name="Parameter")
Restriction = Class(name="Restriction")
trnetvisual_MandatoryNode = Class(name="trnetvisual_MandatoryNode")
NodePattern = Class(name="NodePattern")
trnetvisual_ExternalAttributeCalculationCall = Class(name="trnetvisual_ExternalAttributeCalculationCall")
trnetvisual_Action = Class(name="trnetvisual_Action", is_abstract=True)
trnetvisual_AnyResult = Class(name="trnetvisual_AnyResult")
Result = Class(name="Result")
trnetvisual_SomeResult = Class(name="trnetvisual_SomeResult")
trnetvisual_OptionalNode = Class(name="trnetvisual_OptionalNode")
trnetvisual_Combinator = Class(name="trnetvisual_Combinator")
Operator = Class(name="Operator")
trnetvisual_External = Class(name="trnetvisual_External")
trnetvisual_ApplicationCondition = Class(name="trnetvisual_ApplicationCondition", is_abstract=True)
trnetvisual_Next = Class(name="trnetvisual_Next")
FlowRule = Class(name="FlowRule")
trnetvisual_Eventually = Class(name="trnetvisual_Eventually")
trnetvisual_NextDerived = Class(name="trnetvisual_NextDerived")
trnetvisual_AttributeCalculation = Class(name="trnetvisual_AttributeCalculation", is_abstract=True)
AttributeCalculation = Class(name="AttributeCalculation")
trnetvisual_AnyOperand = Class(name="trnetvisual_AnyOperand")
Operand = Class(name="Operand")
trnetvisual_SomeOperand = Class(name="trnetvisual_SomeOperand")
trnetvisual_AntiOperand = Class(name="trnetvisual_AntiOperand")
trnetvisual_OptionalOperand = Class(name="trnetvisual_OptionalOperand")
trnetvisual_ExternalActionCall = Class(name="trnetvisual_ExternalActionCall")
Action = Class(name="Action")
ParameterRef = Class(name="ParameterRef")
trnetvisual_ExternalAttributeCalculationCallParameter = Class(name="trnetvisual_ExternalAttributeCalculationCallParameter")
trnetvisual_Parameter = Class(name="trnetvisual_Parameter", is_abstract=True)
trnetvisual_ExternalConditionCallParameter = Class(name="trnetvisual_ExternalConditionCallParameter")
trnetvisual_ExternalActionCallParameter = Class(name="trnetvisual_ExternalActionCallParameter")
trnetvisual_ExternalCalculationCallParameter = Class(name="trnetvisual_ExternalCalculationCallParameter")
trnetvisual_ExternalConditionCall = Class(name="trnetvisual_ExternalConditionCall")
ApplicationCondition = Class(name="ApplicationCondition")
trnetvisual_ParameterRef = Class(name="trnetvisual_ParameterRef")
trnetvisual_ExternalCalculationCall = Class(name="trnetvisual_ExternalCalculationCall")
...
trnetvisual_AttributePattern.attributes={trnetvisual_AttributePattern_name, trnetvisual_AttributePattern_expectedNumberOfDistinctValues}
...
trnetvisual_ExternalConditionCall.attributes={trnetvisual_ExternalConditionCall_id, trnetvisual_ExternalConditionCall_qualifiedName}
...
domain_model = DomainModel(
    name="trnetvisual",
    types={trnetvisual_TrNetModel, trnetvisual_Pattern, trnetvisual_Operator, trnetvisual_Restriction, trnetvisual_Operand, trnetvisual_Result, trnetvisual_FlowRule, trnetvisual_EdgePattern, trnetvisual_Same, trnetvisual_AttributePattern, trnetvisual_Keep, trnetvisual_Different, trnetvisual_Calculation, trnetvisual_NodePattern, Parameter_, Restriction, trnetvisual_MandatoryNode, NodePattern, trnetvisual_ExternalAttributeCalculationCall, trnetvisual_Action, trnetvisual_AnyResult, Result, trnetvisual_SomeResult, trnetvisual_OptionalNode, trnetvisual_Combinator, Operator, trnetvisual_External, trnetvisual_ApplicationCondition, trnetvisual_Next, FlowRule, trnetvisual_Eventually, trnetvisual_NextDerived, trnetvisual_AttributeCalculation, AttributeCalculation, trnetvisual_AnyOperand, Operand, trnetvisual_SomeOperand, trnetvisual_AntiOperand, trnetvisual_OptionalOperand, trnetvisual_ExternalActionCall, Action, ParameterRef, trnetvisual_ExternalAttributeCalculationCallParameter, trnetvisual_Parameter, trnetvisual_ExternalConditionCallParameter, trnetvisual_ExternalActionCallParameter, trnetvisual_ExternalCalculationCallParameter, trnetvisual_ExternalConditionCall, ApplicationCondition, trnetvisual_ParameterRef, trnetvisual_ExternalCalculationCall, Calculation},
    associations={patterns0, operators1, restrictions3, operands5, results7, flowRules9, incoming13, outgoing14, sameOut16, sameIn18, pattern21, attributes22, keepIn23, keepOut25, differentIn28, differentOut30, source33, calculations11, nodes38, edges40, incomingResults43, outgoingOperands45, ownerNode56, source58, target60, target34, pattern36, source47, target49, source51, target53, attributeExternalCalculationCall55, actions74, pattern76, operator78, operands62, results64, flowOut67, flowIn69, conditions72, source83, target85, result87, operator79, pattern81, parameters98, parameters101, owner104, parameters89, externalAttributeCalculationCallRef90, externalConditionCallRef92, externalActionCallRef94, externalCalculationCallRef96, parameters115, owner118, parameter106, owner107, parameter109, owner111, parameter113, parameter120},
    generalizations={gen_trnetvisual_NodePattern_Parameter, gen_trnetvisual_Same_Restriction, gen_trnetvisual_Keep_Restriction, gen_trnetvisual_MandatoryNode_NodePattern, gen_trnetvisual_Different_Restriction, gen_trnetvisual_AttributePattern_Parameter, gen_trnetvisual_AnyResult_Result, gen_trnetvisual_SomeResult_Result, gen_trnetvisual_OptionalNode_NodePattern, gen_trnetvisual_Combinator_Operator, gen_trnetvisual_External_Operator, gen_trnetvisual_Next_FlowRule, gen_trnetvisual_Eventually_FlowRule, gen_trnetvisual_NextDerived_FlowRule, gen_trnetvisual_AttributeCalculation_Restriction, gen_trnetvisual_ExternalAttributeCalculationCall_AttributeCalculation, gen_trnetvisual_AnyOperand_Operand, gen_trnetvisual_SomeOperand_Operand, gen_trnetvisual_AntiOperand_Operand, gen_trnetvisual_OptionalOperand_Operand, gen_trnetvisual_ExternalActionCall_Action, gen_trnetvisual_ExternalAttributeCalculationCallParameter_ParameterRef, gen_trnetvisual_ExternalConditionCall_ApplicationCondition, gen_trnetvisual_Calculation_Parameter, gen_trnetvisual_ExternalCalculationCall_Calculation, gen_trnetvisual_ExternalCalculationCallParameter_ParameterRef, gen_trnetvisual_ExternalConditionCallParameter_ParameterRef, gen_trnetvisual_ExternalActionCallParameter_ParameterRef},
    metadata=None
)
