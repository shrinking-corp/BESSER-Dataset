...
class PlayerView:
    ...
    def __init__(self, player: BasePlayer, cardLabels: JLabel, cardTotal: JLabel, busted: JLabel, moneyBox: JLabel, status: JLabel, gameView10: "GameView" = None, basePlayer19: "BasePlayer" = None):
        self.player = player
