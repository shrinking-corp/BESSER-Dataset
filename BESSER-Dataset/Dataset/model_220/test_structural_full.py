...
def test_assoc_eExceptions74_link_reassign_clear():
    ...
    b1 = ecore_EOperation()
    b2 = ecore_EOperation()
    _safe_set(a, 'ecore_EClassifier76', b1)
    assert _is_linked(a, 'ecore_EClassifier76', b1)
    if hasattr(b1, 'ecore_EOperation75'):
        assert _is_linked(b1, 'ecore_EOperation75', a)
    _safe_set(a, 'ecore_EClassifier76', b2)
    assert _is_linked(a, 'ecore_EClassifier76', b2)
    if hasattr(b1, 'ecore_EOperation75'):
        assert not _is_linked(b1, 'ecore_EOperation75', a)
    if hasattr(b2, 'ecore_EOperation75'):
        assert _is_linked(b2, 'ecore_EOperation75', a)
    _safe_set(a, 'ecore_EClassifier76', None)
    assert not _is_linked(a, 'ecore_EClassifier76', b2)
    if hasattr(b2, 'ecore_EOperation75'):
        assert not _is_linked(b2, 'ecore_EOperation75', a)
