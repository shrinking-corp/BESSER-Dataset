...
ecore_EObject.methods={ecore_EObject_m_eSet, ecore_EObject_m_eGet, ecore_EObject_m_eCrossReferences, ecore_EObject_m_eGet, ecore_EObject_m_eContainmentFeature, ecore_EObject_m_eContainingFeature, ecore_EObject_m_eResource, ecore_EObject_m_eIsSet, ecore_EObject_m_eContainer, ecore_EObject_m_eContents, ecore_EObject_m_eClass, ecore_EObject_m_eIsProxy, ecore_EObject_m_eUnset, ecore_EObject_m_eAllContents}
...
ecore_EStructuralFeature.attributes={ecore_EStructuralFeature_transient, ecore_EStructuralFeature_changeable, ecore_EStructuralFeature_unsettable, ecore_EStructuralFeature_defaultValue, ecore_EStructuralFeature_volatile, ecore_EStructuralFeature_defaultValueLiteral, ecore_EStructuralFeature_derived}
...
ecore_ETypedElement.attributes={ecore_ETypedElement_lowerBound, ecore_ETypedElement_required, ecore_ETypedElement_upperBound, ecore_ETypedElement_ordered, ecore_ETypedElement_many, ecore_ETypedElement_unique}
...
domain_model = DomainModel(
    name="ecore",
    types={ecore_EAnnotation, EModelElement, ecore_EStringToStringMapEntry, ecore_EObject, ecore_EModelElement, ecore_EAttribute, EStructuralFeature, ecore_EDataType, ecore_EReference, ecore_EClass, EClassifier, ecore_EOperation, ecore_EStructuralFeature, ecore_EGenericType, ecore_EClassifier, ENamedElement, ecore_EPackage, ecore_ETypeParameter, ecore_EEnum, EDataType, EObject, ecore_EEnumLiteral, ecore_EFactory, ETypedElement, ecore_EParameter, ecore_ENamedElement, ecore_ETypedElement},
    associations={details0, contents1, references3, eModelElement6, eAttributeType7, eAllAttributes12, eAllContainments15, eAllGenericSuperTypes17, eOperations8, eStructuralFeatures9, eGenericSuperTypes11, eReferences36, eSuperTypes40, eAllOperations20, eAllReferences22, eAllStructuralFeatures25, eAllSuperTypes28, eAttributes30, eIDAttribute33, ePackage43, eTypeParameters42, ePackage46, eLiterals44, eEnum45, eUpperBound49, eTypeArguments52, eLowerBound55, eClassifier57, eRawType60, eTypeParameter63, eTypeParameters67, eAnnotations66, eSubpackages80, eFactoryInstance82, eSuperPackage85, eParameters70, eGenericExceptions71, eExceptions74, eContainingClass77, eClassifiers78, eOperation87, eKeys89, eOpposite93, eReferenceType95, eContainingClass98, eGenericType100, eType102, eBounds105},
