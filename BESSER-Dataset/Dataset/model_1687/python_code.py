...
class yye_Relation(NamedElement):
    ...
    def __init__(self, since: str, Relation: "yye_Base" = None, relations: "yye_Base" = None, yye_Relation: "yye_Base" = None, yye_Relation8: "yye_Relation" = None, yye_Relation6: set["yye_Relation"] = None):
        self.since = since
...
class yye_Base(NamedElement):
    ...
    def __init__(self, id: int, yye_Base: set["yye_Foo"] = None, fromThing: set["yye_Relation"] = None, Base: "yye_Relation" = None, yye_Base5: "yye_Relation" = None):
        self.id = id
