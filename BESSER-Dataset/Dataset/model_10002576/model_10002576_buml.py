...
domain_model = DomainModel(
    name="c268851b_8e5b_40d0_8378_67476aee1cd3",
    ...
    associations={Machine_Processor, Processor_Program, Cache_RAM, ExtensionBoard_Card, Vendor1Adapter_Vendor1Sound, Vendor2Adapter_Vendor2Sound, Machine_Memory, Processor_Memory, Program_Instruction, Machine_Card, AcceleratorCard_CPU},
    generalizations={},
    metadata=None
)
