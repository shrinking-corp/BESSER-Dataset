...
Employee.attributes={Employee_employeeName, Employee_managerId, Employee_noOfLeaves, Employee_leavesTaken, Employee_password, Employee_employeeId, Employee_jobLevel}
...
LeaveApplication.attributes={LeaveApplication_toDate, LeaveApplication_employeeId, LeaveApplication_applicationId, LeaveApplication_fromDate, LeaveApplication_status, LeaveApplication_reason, LeaveApplication_approverComments}
...
domain_model = DomainModel(
    name="_03e11db6_02a7_4926_84ea_8da9765f5e7e",
    ...
    associations={Employee_Apply_Leave, Employee_Leave_Request_Status, Employee_Approver_Jobs, Admin_CreateUser, Admin_Update_Calendar, Application_SendNotification, Credit_Leaves_Application, Application_AutoApproval, Application_GenerateSummary, User_Login, User_Query_Eligibility, User_Query_Leave_Balance, User_Query_Leave_History},
    generalizations={},
    metadata=None
)
