...
# Classes
exo1_Employee = Class(name="exo1_Employee")
exo1_Company = Class(name="exo1_Company")
exo1_Departement = Class(name="exo1_Departement")
exo1_Project = Class(name="exo1_Project")
...
domain_model = DomainModel(
    name="exo1",
    types={exo1_Employee, exo1_Company, exo1_Departement, exo1_Project},
    associations={employees1, departement2, employees3, projects6, departements8, employees11, projects0, projets12, departements14},
    generalizations={},
    metadata=None
)
