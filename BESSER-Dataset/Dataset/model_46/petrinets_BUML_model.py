...
# Classes
standardPetriNets_OutputArc = Class(name="standardPetriNets_OutputArc")
standardPetriNets_PetriNet = Class(name="standardPetriNets_PetriNet")
standardPetriNets_Place = Class(name="standardPetriNets_Place")
standardPetriNets_Transition = Class(name="standardPetriNets_Transition")
standardPetriNets_InputArc = Class(name="standardPetriNets_InputArc")
...
standardPetriNets_Place.attributes={standardPetriNets_Place_numOfTokens, standardPetriNets_Place_capacity, standardPetriNets_Place_name}
...
domain_model = DomainModel(
    ...
    types={standardPetriNets_OutputArc, standardPetriNets_PetriNet, standardPetriNets_Place, standardPetriNets_Transition, standardPetriNets_InputArc},
    associations={outputArcFromTransition3, outputArcToPlace5, inputArcFromPlace0, inputArcToTransition1, containsPlaces8, containsTransitions10, containsInputArcs13, containsOutputArcs16},
    generalizations={},
    metadata=None
)
