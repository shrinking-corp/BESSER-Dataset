...
public class Company_CompanyModel  {
    ...
    public Company_CompanyModel(
        ArrayList<Company_Topic> company_topics,        ArrayList<Company_Division> company_divisions,        ArrayList<Company_Category> company_categorys,        ArrayList<Company_Company> company_companys,        ArrayList<Company_Address> company_addresss    ) {
