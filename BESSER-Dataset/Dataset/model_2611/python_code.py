...
class Company_Topic:
    ...
    def __init__(self, id: str, Company_Topic: "Company_Project" = None, Topic: "Company_Category" = None, topics: "Company_Category" = None, Company_Topic22: "Company_CompanyModel" = None):
        self.id = id
...
class Company_Project(ABC):
    ...
    def __init__(self, name: str, Company_Project: "Company_Person" = None, Company_Project7: "Company_Company" = None, Company_Project13: "Company_Topic" = None):
        self.name = name
