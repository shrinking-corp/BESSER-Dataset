...
# Classes
lSGL_Enum = Class(name="lSGL_Enum")
Type = Class(name="Type")
lSGL_EnumItem = Class(name="lSGL_EnumItem")
lSGL_Entity = Class(name="lSGL_Entity")
lSGL_GeneratorAnnotation = Class(name="lSGL_GeneratorAnnotation")
lSGL_Attribute = Class(name="lSGL_Attribute")
lSGL_AttributeType = Class(name="lSGL_AttributeType")
lSGL_Model = Class(name="lSGL_Model")
lSGL_Generator = Class(name="lSGL_Generator")
lSGL_Type = Class(name="lSGL_Type")
lSGL_Projection = Class(name="lSGL_Projection")
lSGL_ConfigProperty = Class(name="lSGL_ConfigProperty")
lSGL_Config = Class(name="lSGL_Config")
lSGL_Annotation = Class(name="lSGL_Annotation")
lSGL_GeneratorConfig = Class(name="lSGL_GeneratorConfig")
...
lSGL_EnumItem.attributes={lSGL_EnumItem_name, lSGL_EnumItem_value}
...
lSGL_Attribute.attributes={lSGL_Attribute_isArray, lSGL_Attribute_name, lSGL_Attribute_isMap, lSGL_Attribute_isList}
...
lSGL_AttributeType.attributes={lSGL_AttributeType_typeName, lSGL_AttributeType_nullable}
...
lSGL_GeneratorConfig.attributes={lSGL_GeneratorConfig_cfgName, lSGL_GeneratorConfig_values}
...
domain_model = DomainModel(
    name="lSGL",
    types={lSGL_Enum, Type, lSGL_EnumItem, lSGL_Entity, lSGL_GeneratorAnnotation, lSGL_Attribute, lSGL_AttributeType, lSGL_Model, lSGL_Generator, lSGL_Type, lSGL_Projection, lSGL_ConfigProperty, lSGL_Config, lSGL_Annotation, lSGL_GeneratorConfig},
    associations={items12, generatorAnnotations13, superClass15, attributes17, type19, generators0, types1, projections3, properties5, configs7, properties9, generatorAnnotations37, entity40, attributes43, annotations21, key23, type26, generator29, configItem32, customConfig35},
