...
card_Deck_cardPack: Property = Property(name="cardPack", type=StringType)
card_Deck.attributes={card_Deck_cardPack}
...
deck_Deck.attributes={deck_Deck_stepCounter, deck_Deck_foundationIndex, deck_Deck_inputDestinationRow, deck_Deck_removeItemFromArrayIndex, deck_Deck_score}
...
entities_Rating.attributes={entities_Rating_game, entities_Rating_ratedon, entities_Rating_rating, entities_Rating_player}
...
entities_Score.attributes={entities_Score_points, entities_Score_game, entities_Score_player, entities_Score_playedOn}
...
services_CommentServiceJDBC.attributes={services_CommentServiceJDBC_SELECT_COMMENTS, services_CommentServiceJDBC_INSERT_COMMENT, services_CommentServiceJDBC_PASSWORD, services_CommentServiceJDBC_USER, services_CommentServiceJDBC_URL}
...
services_RatingServiceJDBC.attributes={services_RatingServiceJDBC_INSERT_RATING, services_RatingServiceJDBC_USER, services_RatingServiceJDBC_URL, services_RatingServiceJDBC_SELECT_AVERAGE_RATING, services_RatingServiceJDBC_SELECT_RATING, services_RatingServiceJDBC_PASSWORD}
...
services_ScoreServiceJDBC.attributes={services_ScoreServiceJDBC_USER, services_ScoreServiceJDBC_SELECT_SCORE, services_ScoreServiceJDBC_URL, services_ScoreServiceJDBC_INSERT_SCORE, services_ScoreServiceJDBC_PASSWORD}
...
CommentServiceJDBCTest.attributes={CommentServiceJDBCTest_PASS, CommentServiceJDBCTest_DELETE, CommentServiceJDBCTest_USER, CommentServiceJDBCTest_URL}
...
RatingServiceTest.attributes={RatingServiceTest_TEST_PLAYER, RatingServiceTest_GAME_NAME, RatingServiceTest_TEST_PLAYER_2, RatingServiceTest_TEST_PLAYER_3}
...
ScoreServiceJDBCTest.attributes={ScoreServiceJDBCTest_DELETE, ScoreServiceJDBCTest_USER, ScoreServiceJDBCTest_PASS, ScoreServiceJDBCTest_URL}
...
pack_Deck_Pack_16: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="pack7", type=card_Deck, multiplicity=Multiplicity(0, 1))
    }
)
