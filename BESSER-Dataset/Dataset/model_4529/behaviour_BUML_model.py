...
behaviour_Coordinate.attributes={behaviour_Coordinate_heading, behaviour_Coordinate_altitude, behaviour_Coordinate_longitude, behaviour_Coordinate_latitude}
...
behaviour_Circle.attributes={behaviour_Circle_radius, behaviour_Circle_clockwise, behaviour_Circle_altitude, behaviour_Circle_duration}
...
domain_model = DomainModel(
    name="behaviour",
    types={behaviour_Drone, behaviour_Coordinate, behaviour_Move, behaviour_MoveTransition, behaviour_Slot, behaviour_Action, behaviour_Start, Move, behaviour_NamedElement, behaviour_Behaviour, NamedElement, behaviour_Stop, behaviour_Choice, MoveTransition, behaviour_TakeOff, behaviour_Land, behaviour_GoTo, behaviour_CommunicationAction, Action, behaviour_Notify, CommunicationAction, behaviour_BroadcastNotify, Notify, behaviour_UnicastNotify, behaviour_MulticastNotify, behaviour_CheckNotification, behaviour_Hover, behaviour_HeadTo, behaviour_Circle, behaviour_Feedback, behaviour_DeviceAction, behaviour_Parameter, GoToStrategy, TravelMode},
    associations={drones0, home1, movements3, moveTransitions5, slots7, falseBranch9, preActions11, postActions13, targetPosition16, slot20, receiver22, receiver24, targetPosition18, waitFor29, from_32, to35, parameters38, slot26, parameters28},
    generalizations={gen_behaviour_Drone_NamedElement, gen_behaviour_Action_NamedElement, gen_behaviour_Start_Move, gen_behaviour_Behaviour_NamedElement, gen_behaviour_Stop_Move, gen_behaviour_Choice_MoveTransition, gen_behaviour_Move_NamedElement, gen_behaviour_TakeOff_Move, gen_behaviour_Land_Move, gen_behaviour_GoTo_Move, gen_behaviour_CommunicationAction_Action, gen_behaviour_Notify_CommunicationAction, gen_behaviour_BroadcastNotify_Notify, gen_behaviour_UnicastNotify_Notify, gen_behaviour_MulticastNotify_Notify, gen_behaviour_CheckNotification_CommunicationAction, gen_behaviour_Hover_Move, gen_behaviour_HeadTo_Move, gen_behaviour_Circle_Move, gen_behaviour_Feedback_CommunicationAction, gen_behaviour_Slot_NamedElement, gen_behaviour_DeviceAction_Action},
    metadata=None
)
