...
class behaviour_Circle(Move):
    ...
    def __init__(self, radius: float, altitude: float, clockwise: bool, duration: float, behaviour_Circle: "behaviour_Coordinate" = None):
        self.radius = radius
...
class behaviour_Coordinate:
    ...
    def __init__(self, latitude: float, longitude: float, altitude: float, heading: float, behaviour_Coordinate: "behaviour_Drone" = None, behaviour_Coordinate17: "behaviour_GoTo" = None, behaviour_Coordinate19: "behaviour_Circle" = None):
