...
employee_Employee_m_reportsTo: Method = Method(name="reportsTo", parameters={Parameter(name='employee_mgr', type=StringType)}, type=BooleanType)
...
employee_Employee.methods={employee_Employee_m_reportsTo, employee_Employee_m_allReports, employee_Employee_m_reportingChain}
...
domain_model = DomainModel(
    ...
    associations={employees0, departments1, department7, manager10, directReports13, company15, manager3, employees4, company6},
    generalizations={},
    metadata=None
)
