...
# Classes
ecorer_EAttribute = Class(name="ecorer_EAttribute")
EStructuralFeature = Class(name="EStructuralFeature")
ecorer_EDataType = Class(name="ecorer_EDataType")
ecorer_EOperation = Class(name="ecorer_EOperation")
ecorer_EReference = Class(name="ecorer_EReference")
ecorer_EAnnotation = Class(name="ecorer_EAnnotation")
EModelElement = Class(name="EModelElement")
ecorer_EStringToStringMapEntry = Class(name="ecorer_EStringToStringMapEntry")
ecorer_EModelElement = Class(name="ecorer_EModelElement", is_abstract=True)
ecorer_EObject = Class(name="ecorer_EObject")
ecorer_EClass = Class(name="ecorer_EClass")
EClassifier = Class(name="EClassifier")
ecorer_EClassifier = Class(name="ecorer_EClassifier", is_abstract=True)
ENamedElement = Class(name="ENamedElement")
ecorer_EPackage = Class(name="ecorer_EPackage")
ecorer_ETypeParameter = Class(name="ecorer_ETypeParameter")
ecorer_EEnum = Class(name="ecorer_EEnum")
EDataType = Class(name="EDataType")
ecorer_EStructuralFeature = Class(name="ecorer_EStructuralFeature", is_abstract=True)
ecorer_EGenericType = Class(name="ecorer_EGenericType")
ecorer_ENamedElement = Class(name="ecorer_ENamedElement", is_abstract=True)
ETypedElement = Class(name="ETypedElement")
ecorer_EParameter = Class(name="ecorer_EParameter")
ecorer_EEnumLiteral = Class(name="ecorer_EEnumLiteral")
ecorer_EFactory = Class(name="ecorer_EFactory")
ecorer_ETypedElement = Class(name="ecorer_ETypedElement", is_abstract=True)
...
ecorer_EOperation_m_isOverrideOf: Method = Method(name="isOverrideOf", parameters={Parameter(name='ecorer_someOperation', type=StringType)}, type=BooleanType)
ecorer_EOperation.methods={ecorer_EOperation_m_isOverrideOf, ecorer_EOperation_m_getOperationID}
...
ecorer_EReference.attributes={ecorer_EReference_container, ecorer_EReference_containment, ecorer_EReference_resolveProxies}
...
ecorer_EModelElement_m_getEAnnotation: Method = Method(name="getEAnnotation", parameters={Parameter(name='ecorer_source', type=StringType)}, type=StringType)
...
ecorer_EObject_m_eGet: Method = Method(name="eGet", parameters={Parameter(name='ecorer_feature', type=StringType)}, type=StringType)
ecorer_EObject_m_eGet: Method = Method(name="eGet", parameters={Parameter(name='ecorer_feature', type=StringType), Parameter(name='ecorer_resolve', type=StringType)}, type=StringType)
ecorer_EObject_m_eSet: Method = Method(name="eSet", parameters={Parameter(name='ecorer_feature', type=StringType), Parameter(name='ecorer_newValue', type=StringType)})
ecorer_EObject_m_eIsSet: Method = Method(name="eIsSet", parameters={Parameter(name='ecorer_feature', type=StringType)}, type=BooleanType)
ecorer_EObject_m_eUnset: Method = Method(name="eUnset", parameters={Parameter(name='ecorer_feature', type=StringType)})
ecorer_EObject_m_eInvoke: Method = Method(name="eInvoke", parameters={Parameter(name='ecorer_arguments', type=StringType), Parameter(name='ecorer_operation', type=StringType)}, type=StringType)
ecorer_EObject.methods={ecorer_EObject_m_eContainer, ecorer_EObject_m_eIsSet, ecorer_EObject_m_eContainmentFeature, ecorer_EObject_m_eCrossReferences, ecorer_EObject_m_eAllContents, ecorer_EObject_m_eClass, ecorer_EObject_m_eUnset, ecorer_EObject_m_eContents, ecorer_EObject_m_eSet, ecorer_EObject_m_eContainingFeature, ecorer_EObject_m_eResource, ecorer_EObject_m_eIsProxy, ecorer_EObject_m_eInvoke, ecorer_EObject_m_eGet, ecorer_EObject_m_eGet}
...
ecorer_EClass_m_getFeatureID: Method = Method(name="getFeatureID", parameters={Parameter(name='ecorer_feature', type=StringType)}, type=IntegerType)
ecorer_EClass_m_getEStructuralFeature: Method = Method(name="getEStructuralFeature", parameters={Parameter(name='ecorer_featureName', type=StringType)}, type=EStructuralFeature)
ecorer_EClass_m_getOperationCount: Method = Method(name="getOperationCount", parameters={}, type=IntegerType)
ecorer_EClass_m_getEOperation: Method = Method(name="getEOperation", parameters={Parameter(name='ecorer_operationID', type=StringType)}, type=StringType)
ecorer_EClass_m_getOperationID: Method = Method(name="getOperationID", parameters={Parameter(name='ecorer_operation', type=StringType)}, type=IntegerType)
ecorer_EClass_m_getOverride: Method = Method(name="getOverride", parameters={Parameter(name='ecorer_operation', type=StringType)}, type=StringType)
ecorer_EClass_m_isSuperTypeOf: Method = Method(name="isSuperTypeOf", parameters={Parameter(name='ecorer_someClass', type=StringType)}, type=BooleanType)
ecorer_EClass_m_getFeatureCount: Method = Method(name="getFeatureCount", parameters={}, type=IntegerType)
ecorer_EClass_m_getEStructuralFeature: Method = Method(name="getEStructuralFeature", parameters={Parameter(name='ecorer_featureID', type=StringType)}, type=EStructuralFeature)
ecorer_EClass.attributes={ecorer_EClass_interface, ecorer_EClass_abstract}
ecorer_EClass.methods={ecorer_EClass_m_getFeatureCount, ecorer_EClass_m_getOperationID, ecorer_EClass_m_getEOperation, ecorer_EClass_m_getEStructuralFeature, ecorer_EClass_m_getOverride, ecorer_EClass_m_getOperationCount, ecorer_EClass_m_isSuperTypeOf, ecorer_EClass_m_getFeatureID, ecorer_EClass_m_getEStructuralFeature}
...
ecorer_EClassifier_m_isInstance: Method = Method(name="isInstance", parameters={Parameter(name='ecorer_object', type=StringType)}, type=BooleanType)
ecorer_EClassifier_m_getClassifierID: Method = Method(name="getClassifierID", parameters={}, type=IntegerType)
ecorer_EClassifier.attributes={ecorer_EClassifier_defaultValue, ecorer_EClassifier_instanceClassName, ecorer_EClassifier_instanceClass, ecorer_EClassifier_instanceTypeName}
ecorer_EClassifier.methods={ecorer_EClassifier_m_isInstance, ecorer_EClassifier_m_getClassifierID}
...
ecorer_EPackage_m_getEClassifier: Method = Method(name="getEClassifier", parameters={Parameter(name='ecorer_name', type=StringType)}, type=EClassifier)
...
ecorer_EEnum_m_getEEnumLiteral: Method = Method(name="getEEnumLiteral", parameters={Parameter(name='ecorer_name', type=StringType)}, type=StringType)
ecorer_EEnum_m_getEEnumLiteral: Method = Method(name="getEEnumLiteral", parameters={Parameter(name='ecorer_value', type=StringType)}, type=StringType)
ecorer_EEnum_m_getEEnumLiteralByLiteral: Method = Method(name="getEEnumLiteralByLiteral", parameters={Parameter(name='ecorer_literal', type=StringType)}, type=StringType)
...
ecorer_EStructuralFeature.attributes={ecorer_EStructuralFeature_derived, ecorer_EStructuralFeature_volatile, ecorer_EStructuralFeature_transient, ecorer_EStructuralFeature_unsettable, ecorer_EStructuralFeature_defaultValueLiteral, ecorer_EStructuralFeature_defaultValue, ecorer_EStructuralFeature_changeable}
...
ecorer_EEnumLiteral.attributes={ecorer_EEnumLiteral_literal, ecorer_EEnumLiteral_instance, ecorer_EEnumLiteral_value}

# ecorer_EFactory class attributes and methods
ecorer_EFactory_m_create: Method = Method(name="create", parameters={Parameter(name='ecorer_eClass', type=StringType)}, type=StringType)
ecorer_EFactory_m_createFromString: Method = Method(name="createFromString", parameters={Parameter(name='ecorer_literalValue', type=StringType), Parameter(name='ecorer_eDataType', type=StringType)}, type=StringType)
ecorer_EFactory_m_convertToString: Method = Method(name="convertToString", parameters={Parameter(name='ecorer_instanceValue', type=StringType), Parameter(name='ecorer_eDataType', type=StringType)}, type=StringType)
ecorer_EFactory.methods={ecorer_EFactory_m_createFromString, ecorer_EFactory_m_create, ecorer_EFactory_m_convertToString}
...
ecorer_ETypedElement.attributes={ecorer_ETypedElement_lowerBound, ecorer_ETypedElement_many, ecorer_ETypedElement_ordered, ecorer_ETypedElement_upperBound, ecorer_ETypedElement_unique, ecorer_ETypedElement_required}
...
domain_model = DomainModel(
    name="ecorer",
    types={ecorer_EAttribute, EStructuralFeature, ecorer_EDataType, ecorer_EOperation, ecorer_EReference, ecorer_EAnnotation, EModelElement, ecorer_EStringToStringMapEntry, ecorer_EModelElement, ecorer_EObject, ecorer_EClass, EClassifier, ecorer_EClassifier, ENamedElement, ecorer_EPackage, ecorer_ETypeParameter, ecorer_EEnum, EDataType, ecorer_EStructuralFeature, ecorer_EGenericType, ecorer_ENamedElement, ETypedElement, ecorer_EParameter, ecorer_EEnumLiteral, ecorer_EFactory, ecorer_ETypedElement},
    associations={eSuperTypes9, eOperations10, eAllAttributes11, eAllReferences14, eReferences16, eAttributes19, eAttributeType0, details1, eModelElement2, contents3, references5, ePackage42, eTypeParameters43, eAllContainments22, eAllOperations25, eAllStructuralFeatures27, eAllSuperTypes30, eIDAttribute32, eStructuralFeatures35, eGenericSuperTypes37, eAllGenericSuperTypes39, eAnnotations48, eContainingClass49, eTypeParameters50, eParameters53, eExceptions54, eGenericExceptions57, eLiterals44, eEnum45, ePackage46, eFactoryInstance60, eClassifiers61, eSubpackages64, eSuperPackage67, eOperation69, eOpposite72, eType82, eGenericType84, eReferenceType74, eKeys77, eContainingClass80, eUpperBound88, eTypeArguments91, eRawType93, eLowerBound97, eTypeParameter99, eClassifier102, eBounds105},
    generalizations={gen_ecorer_EAttribute_EStructuralFeature, gen_ecorer_EAnnotation_EModelElement, gen_ecorer_EClass_EClassifier, gen_ecorer_EClassifier_ENamedElement, gen_ecorer_EDataType_EClassifier, gen_ecorer_EEnum_EDataType, gen_ecorer_ENamedElement_EModelElement, gen_ecorer_EOperation_ETypedElement, gen_ecorer_EEnumLiteral_ENamedElement, gen_ecorer_EFactory_EModelElement, gen_ecorer_EParameter_ETypedElement, gen_ecorer_EReference_EStructuralFeature, gen_ecorer_EPackage_ENamedElement, gen_ecorer_EStructuralFeature_ETypedElement, gen_ecorer_ETypedElement_ENamedElement, gen_ecorer_ETypeParameter_ENamedElement},
    metadata=None
)
