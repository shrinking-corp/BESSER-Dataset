...
library_Equipment.attributes={library_Equipment_redundancy, library_Equipment_equipmentName, library_Equipment_count, library_Equipment_position, library_Equipment_equipmentCode, library_Equipment_description, library_Equipment_state}
...
library_NetXResource.attributes={library_NetXResource_expressionName, library_NetXResource_shortName, library_NetXResource_longName, library_NetXResource_detailDisplay, library_NetXResource_summaryDisplay}
...
library_Parameter.attributes={library_Parameter_modifiable, library_Parameter_value, library_Parameter_name, library_Parameter_expressionName, library_Parameter_description}
...
library_ProductInfo.attributes={library_ProductInfo_productCode, library_ProductInfo_endOfSalesDate, library_ProductInfo_endOfSupportDate, library_ProductInfo_salesCode, library_ProductInfo_availableDate, library_ProductInfo_underDevelopmentDate}
...
domain_model = DomainModel(
    name="library",
    types={library_DiagramInfo, library_Equipment, library_Lifecycle, library_EquipmentRelationship, library_Expression, library_EquipmentGroup, library_NetXResource, library_Metric, library_Tolerance, library_Protocol, library_Parameter, library_MultiImage, library_EObject, library_Function, library_ServiceProfile, library_ExpressionResult, library_FunctionRelationship, library_Library, library_MetricSource, library_NodeType, library_Unit, library_Meta, library_MetricValueRange, library_Value, library_ProductInfo, library_Vendor, Company, LevelType, RedundancyType, StateType},
    associations={diagrams1, equipments4, lifecycle0, equipmentRelationshipRefs12, equipmentExpressionRefs14, capacityExpressionRef15, equipmentGroups6, equipmentResources8, equipmentMetricRefs10, allEquipments27, toleranceRefs17, protocolRefs19, parameterRefs21, allEquipmentResources23, icons29, equipmentGroupResources34, expressionRefs37, equipmentRefs39, diagrams31, allEquipmentResources45, allEquipments48, parameterRefs42, evaluationObject51, equipmentRefs53, functionRefs54, equipmentGroupRefs55, serviceProfileRefs56, diagrams58, icons60, functions64, functionRelationshipRefs72, functionExpressionRefs74, capacityExpressionRef76, toleranceRefs79, protocolRefs82, functionResources66, functionMetricRefs69, allFunctions92, parameterRefs85, allFunctionResources88, equipments98, metrics101, metricSources104, parameters106, functions94, nodeTypes96, tolerances109, expressions112, units115, version117, metricRef119, metricValueRanges122, capacityValues124, utilizationValues126, forecastCapacityValues129, forecastValues132, trendedValues135, unitRef138, functions141, equipments144, equipmentRef147, licensedFunctionRef149, nodeTypeRef152, icons155, products158},
