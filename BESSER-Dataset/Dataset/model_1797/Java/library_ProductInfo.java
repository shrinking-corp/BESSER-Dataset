...
public class library_ProductInfo  {
    ...
    public library_ProductInfo(
        String underDevelopmentDate,        String endOfSalesDate,        String salesCode,        String endOfSupportDate,        String productCode,        String availableDate    ) {
    ...
    public library_ProductInfo(
        String underDevelopmentDate,        String endOfSalesDate,        String salesCode,        String endOfSupportDate,        String productCode,        String availableDate        ArrayList<library_Equipment> library_equipments,        ArrayList<library_Function> library_functions,        ArrayList<library_NodeType> library_nodetypes    ) {
        this.underDevelopmentDate = underDevelopmentDate;
        this.endOfSalesDate = endOfSalesDate;
        this.salesCode = salesCode;
        this.endOfSupportDate = endOfSupportDate;
