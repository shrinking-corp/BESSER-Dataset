...
class JPA_Property:
    ...
    def __init__(self, name: str, comment: str, JPA_Property6: set["JPA_Anotation"] = None, JPA_Property9: "JPA_EntityPk" = None, JPA_Property: "JPA_Entity" = None):
        self.name = name
