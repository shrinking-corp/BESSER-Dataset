...
# Classes
JPA_EntityPk = Class(name="JPA_EntityPk")
Anotation = Class(name="Anotation")
JPA_Table = Class(name="JPA_Table")
JPA_Column = Class(name="JPA_Column")
JPA_OneToOne = Class(name="JPA_OneToOne")
JPA_PersistenceUnit = Class(name="JPA_PersistenceUnit")
JPA_Entity = Class(name="JPA_Entity")
JPA_Property = Class(name="JPA_Property")
JPA_Anotation = Class(name="JPA_Anotation")
JPA_OneToMany = Class(name="JPA_OneToMany")
JPA_ManyToOne = Class(name="JPA_ManyToOne")
JPA_ManyToMany = Class(name="JPA_ManyToMany")
...
JPA_Column.attributes={JPA_Column_fetch, JPA_Column_nullable, JPA_Column_type, JPA_Column_name}
...
JPA_OneToOne.attributes={JPA_OneToOne_name, JPA_OneToOne_referencedColumnName, JPA_OneToOne_updatable}
...
JPA_ManyToOne.attributes={JPA_ManyToOne_nullable, JPA_ManyToOne_joinColumn, JPA_ManyToOne_fetch}
...
JPA_ManyToMany.attributes={JPA_ManyToMany_joinColumn, JPA_ManyToMany_name, JPA_ManyToMany_inverseJoinColumn}
...
domain_model = DomainModel(
    name="JPA",
    types={JPA_EntityPk, Anotation, JPA_Table, JPA_Column, JPA_OneToOne, JPA_PersistenceUnit, JPA_Entity, JPA_Property, JPA_Anotation, JPA_OneToMany, JPA_ManyToOne, JPA_ManyToMany, Cascade, Fetch},
    associations={properties8, entities0, properties1, anotations3, anotations5},
