...
public class library_Library  {
    ...
    public library_Library(
        String name,        String protocols        ArrayList<library_Equipment> library_equipments,        ArrayList<library_Function> library_functions,        ArrayList<library_Unit> library_units,        ArrayList<library_Parameter> library_parameters,        ArrayList<library_NodeType> library_nodetypes,        ArrayList<library_Tolerance> library_tolerances,        ArrayList<library_Expression> library_expressions,        ArrayList<library_Metric> library_metrics    ) {
        this.name = name;
        this.protocols = protocols;
