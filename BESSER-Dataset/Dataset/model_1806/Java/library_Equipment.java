...
public class library_Equipment extends Component {
    ...
    public library_Equipment(
        String count,        String redundancy,        String position,        String state,        String equipmentCode    ) {
        super(
        );
        this.count = count;
    ...
    public library_Equipment(
        String count,        String redundancy,        String position,        String state,        String equipmentCode        ArrayList<library_EquipmentGroup> library_equipmentgroups,        ArrayList<library_Equipment> library_equipments    ) {
        this.count = count;
        this.redundancy = redundancy;
        this.position = position;
        this.state = state;
