...
class library_Library:
    ...
    def __init__(self, name: str, protocols: str, library_Library70: set["library_NodeType"] = None, library_Library72: set["library_Equipment"] = None, library_Library75: set["library_Metric"] = None, library_Library: set["library_Function"] = None, library_Library92: "library_Meta" = None, library_Library78: set["library_MetricSource"] = None, library_Library80: set["library_Parameter"] = None, library_Library83: set["library_Tolerance"] = None, library_Library86: set["library_Expression"] = None, library_Library89: set["library_Unit"] = None):
        self.name = name
...
class library_ExpressionResult(BaseExpressionResult):
    ...
    def __init__(self, targetIntervalHint: str, targetKindHint: str, targetRange: str, library_ExpressionResult: "library_BaseResource" = None, library_ExpressionResult59: set["library_Value"] = None):
...
class library_Equipment(Component):
    ...
    def __init__(self, count: str, state: str, equipmentCode: str, position: str, redundancy: str, library_Equipment119: "library_NodeType" = None, library_Equipment: "library_Equipment" = None, library_Equipment24: set["library_Equipment"] = None, library_Equipment27: set["library_EquipmentGroup"] = None, library_Equipment29: set["library_EquipmentRelationship"] = None, library_Equipment32: "library_Equipment" = None, library_Equipment30: set["library_Equipment"] = None, library_Equipment44: "library_EquipmentGroup" = None, library_Equipment53: "library_EquipmentGroup" = None, library_Equipment73: "library_Library" = None, library_Equipment121: "library_ProductInfo" = None):
        self.count = count
        self.state = state
...
class library_ProductInfo(Base):
    ...
    def __init__(self, availableDate: str, endOfSalesDate: str, endOfSupportDate: str, productCode: str, salesCode: str, underDevelopmentDate: str, library_ProductInfo123: set["library_Function"] = None, library_ProductInfo126: set["library_NodeType"] = None, library_ProductInfo: set["library_Equipment"] = None, library_ProductInfo154: "library_Vendor" = None):
...
class library_ReferenceRelationship(Base):
    ...
    def __init__(self, name: str, library_ReferenceRelationship145: "library_NodeType" = None, library_ReferenceRelationship: "library_ReferenceNetwork" = None, library_ReferenceRelationship139: "library_Protocol" = None, library_ReferenceRelationship142: "library_NodeType" = None):
        self.name = name
...
class library_EquipmentGroup(Base):
    ...
    def __init__(self, count: str, description: str, name: str, library_EquipmentGroup: "library_Equipment" = None, library_EquipmentGroup34: set["library_DiagramInfo"] = None, library_EquipmentGroup37: set["library_NetXResource"] = None, library_EquipmentGroup40: set["library_Expression"] = None, library_EquipmentGroup43: set["library_Equipment"] = None, library_EquipmentGroup46: set["library_Parameter"] = None, library_EquipmentGroup49: set["library_NetXResource"] = None, library_EquipmentGroup52: set["library_Equipment"] = None):
        self.count = count
        self.description = description
        self.name = name
...
class library_Component(Base):
    ...
    def __init__(self, description: str, duration: str, name: str, library_Component: "library_Lifecycle" = None, componentRef: set["library_NetXResource"] = None, library_Component4: set["library_ConfigAttribute"] = None, library_Component13: set["library_Tolerance"] = None, library_Component15: set["library_Protocol"] = None, library_Component17: set["library_Parameter"] = None, library_Component19: set["library_NetXResource"] = None, library_Component21: set["library_DiagramInfo"] = None, library_Component23: "library_MultiImage" = None, library_Component6: set["library_Metric"] = None, library_Component8: "library_Expression" = None, library_Component10: "library_Expression" = None, Component: "library_NetXResource" = None):
        self.description = description
...
class library_NodeType(Base):
    ...
    def __init__(self, leafNode: str, name: str, library_NodeType127: "library_ProductInfo" = None, library_NodeType118: set["library_Equipment"] = None, library_NodeType132: "library_ReferenceNetwork" = None, library_NodeType146: "library_ReferenceRelationship" = None, library_NodeType143: "library_ReferenceRelationship" = None, library_NodeType: "library_Library" = None, library_NodeType115: set["library_Function"] = None):
...
class library_Unit(Base):
    ...
    def __init__(self, code: str, description: str, name: str, library_Unit: "library_BaseResource" = None, library_Unit151: "library_MultiImage" = None, library_Unit90: "library_Library" = None):
        self.code = code
        self.description = description
        self.name = name
...
class library_BaseResource(Base):
    ...
    def __init__(self, detailDisplay: str, summaryDisplay: str, expressionName: str, longName: str, shortName: str, library_BaseResource: "library_Unit" = None, library_BaseResource57: "library_ExpressionResult" = None):
