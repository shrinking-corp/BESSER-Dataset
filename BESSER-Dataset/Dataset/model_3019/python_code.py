...
class JobContainer:
    ...
    pass
class ir_TimeLoopJob(JobContainer, TimeLoopCopyJob):

    pass
class ir_IrModule(JobContainer):

    def __init__(self, name: str, ir_IrModule: set["ir_Import"] = None, ir_IrModule6: set["ir_ItemType"] = None, ir_IrModule8: set["ir_Function"] = None, ir_IrModule10: set["ir_Connectivity"] = None, ir_IrModule12: set["ir_SimpleVariable"] = None, ir_IrModule14: set["ir_Variable"] = None, ir_IrModule16: "ir_ConnectivityVariable" = None, ir_IrModule18: "ir_ConnectivityVariable" = None, ir_IrModule21: "ir_SimpleVariable" = None, ir_IrModule24: "ir_SimpleVariable" = None, ir_IrModule27: set["ir_Job"] = None, ir_IrModule29: "ir_TimeLoop" = None, ir_IrModule31: "ir_PostProcessingInfo" = None):
        self.name = name
...
class ir_Variable(ArgOrVar):
    ...
    def __init__(self, persistenceName: str, const: bool, ir_Variable: "ir_IrModule" = None, ir_Variable34: "ir_PostProcessingInfo" = None, ir_Variable92: "ir_TimeLoopCopy" = None, ir_Variable95: "ir_TimeLoopCopy" = None, ir_Variable97: "ir_InstructionBlock" = None, ir_Variable102: "ir_VariableDefinition" = None, ir_Variable203: "ir_TimeLoopVariable" = None, ir_Variable206: "ir_TimeLoopVariable" = None, ir_Variable200: "ir_TimeLoopVariable" = None):
...
class ir_Function(IrAnnotable):
    ...
    def __init__(self, provider: str, name: str, ir_Function: "ir_IrModule" = None, ir_Function113: "ir_ReductionInstruction" = None, ir_Function67: "ir_BaseType" = None, ir_Function70: set["ir_SimpleVariable"] = None, ir_Function73: set["ir_Arg"] = None, ir_Function76: "ir_Instruction" = None, ir_Function171: "ir_FunctionCall" = None):
...
class ir_Job(IrAnnotable):
    ...
    def __init__(self, name: str, at: float, onCycle: bool, Job: "ir_JobContainer" = None, ir_Job: "ir_IrModule" = None, innerJobs: "ir_JobContainer" = None):
        self.name = name
        self.at = at
...
class ir_TimeLoop(IrAnnotable):
    ...
    def __init__(self, name: str, ir_TimeLoop47: set["ir_TimeLoopVariable"] = None, ir_TimeLoop: "ir_IrModule" = None, TimeLoop: "ir_TimeLoop" = None, outerTimeLoop: "ir_TimeLoop" = None, TimeLoop45: "ir_TimeLoop" = None, innerTimeLoop: "ir_TimeLoop" = None, ir_TimeLoop49: "ir_Expression" = None, ir_TimeLoop51: "ir_TimeLoopJob" = None, ir_TimeLoop89: "ir_TimeLoopCopyJob" = None, ir_TimeLoop53: "ir_SimpleVariable" = None):
        self.name = name
...
class ir_Connectivity(IrAnnotable):
    ...
    def __init__(self, indexEqualId: bool, name: str, multiple: bool, ir_Connectivity: "ir_IrModule" = None, ir_Connectivity78: set["ir_ItemType"] = None, ir_Connectivity81: "ir_ItemType" = None, ir_Connectivity209: "ir_ConnectivityCall" = None, ir_Connectivity194: "ir_ConnectivityType" = None):
