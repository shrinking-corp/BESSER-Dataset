...
# Classes
ir_IrAnnotable = Class(name="ir_IrAnnotable", is_abstract=True)
ir_IrAnnotation = Class(name="ir_IrAnnotation")
ir_EStringToStringMapEntry = Class(name="ir_EStringToStringMapEntry")
ir_JobContainer = Class(name="ir_JobContainer", is_abstract=True)
IrAnnotable = Class(name="IrAnnotable")
ir_Job = Class(name="ir_Job", is_abstract=True)
ir_Import = Class(name="ir_Import")
ir_ItemType = Class(name="ir_ItemType")
ir_Function = Class(name="ir_Function")
ir_Connectivity = Class(name="ir_Connectivity")
ir_SimpleVariable = Class(name="ir_SimpleVariable")
ir_Variable = Class(name="ir_Variable", is_abstract=True)
ir_ConnectivityVariable = Class(name="ir_ConnectivityVariable")
ir_TimeLoop = Class(name="ir_TimeLoop")
ir_PostProcessingInfo = Class(name="ir_PostProcessingInfo")
ir_TimeLoopVariable = Class(name="ir_TimeLoopVariable")
ir_IrModule = Class(name="ir_IrModule")
JobContainer = Class(name="JobContainer")
ir_Expression = Class(name="ir_Expression", is_abstract=True)
ir_TimeLoopJob = Class(name="ir_TimeLoopJob")
ir_ArgOrVar = Class(name="ir_ArgOrVar", is_abstract=True)
ir_Arg = Class(name="ir_Arg")
ArgOrVar = Class(name="ArgOrVar")
ir_BaseType = Class(name="ir_BaseType")
Variable = Class(name="Variable")
ir_ConnectivityType = Class(name="ir_ConnectivityType")
ir_ArgOrVarRef = Class(name="ir_ArgOrVarRef")
ir_Instruction = Class(name="ir_Instruction", is_abstract=True)
ir_Loop = Class(name="ir_Loop")
ir_InstructionJob = Class(name="ir_InstructionJob")
Job = Class(name="Job")
TimeLoopCopyJob = Class(name="TimeLoopCopyJob")
ir_TimeLoopCopyJob = Class(name="ir_TimeLoopCopyJob", is_abstract=True)
ir_TimeLoopCopy = Class(name="ir_TimeLoopCopy")
ir_BeforeTimeLoopJob = Class(name="ir_BeforeTimeLoopJob")
ir_AfterTimeLoopJob = Class(name="ir_AfterTimeLoopJob")
ir_InstructionBlock = Class(name="ir_InstructionBlock")
Instruction = Class(name="Instruction")
ir_VariableDefinition = Class(name="ir_VariableDefinition")
ir_Affectation = Class(name="ir_Affectation")
ir_IterableInstruction = Class(name="ir_IterableInstruction", is_abstract=True)
ir_IterationBlock = Class(name="ir_IterationBlock", is_abstract=True)
ir_ReductionInstruction = Class(name="ir_ReductionInstruction")
IterableInstruction = Class(name="IterableInstruction")
ir_IrType = Class(name="ir_IrType")
ir_ContractedIf = Class(name="ir_ContractedIf")
Expression = Class(name="Expression")
ir_ItemIndexDefinition = Class(name="ir_ItemIndexDefinition")
ir_ItemIndex = Class(name="ir_ItemIndex")
ir_ItemIndexValue = Class(name="ir_ItemIndexValue")
ir_ItemIdDefinition = Class(name="ir_ItemIdDefinition")
ir_ItemId = Class(name="ir_ItemId")
ir_ItemIdValue = Class(name="ir_ItemIdValue", is_abstract=True)
ir_SetDefinition = Class(name="ir_SetDefinition")
ir_ConnectivityCall = Class(name="ir_ConnectivityCall")
ir_If = Class(name="ir_If")
ir_Return = Class(name="ir_Return")
ir_Exit = Class(name="ir_Exit")
ir_Iterator = Class(name="ir_Iterator")
IterationBlock = Class(name="IterationBlock")
ir_Container = Class(name="ir_Container", is_abstract=True)
ir_Interval = Class(name="ir_Interval")
ir_Cardinality = Class(name="ir_Cardinality")
ir_BinaryExpression = Class(name="ir_BinaryExpression")
ir_UnaryExpression = Class(name="ir_UnaryExpression")
ir_Parenthesis = Class(name="ir_Parenthesis")
ir_IntConstant = Class(name="ir_IntConstant")
ir_RealConstant = Class(name="ir_RealConstant")
ir_BoolConstant = Class(name="ir_BoolConstant")
ir_MinConstant = Class(name="ir_MinConstant")
ir_MaxConstant = Class(name="ir_MaxConstant")
ir_FunctionCall = Class(name="ir_FunctionCall")
ir_BaseTypeConstant = Class(name="ir_BaseTypeConstant")
ir_VectorConstant = Class(name="ir_VectorConstant")
IrType = Class(name="IrType")
Container = Class(name="Container")
ir_SetRef = Class(name="ir_SetRef")
ir_ItemIdValueIterator = Class(name="ir_ItemIdValueIterator")
ItemIdValue = Class(name="ItemIdValue")
ir_ItemIdValueCall = Class(name="ir_ItemIdValueCall")
...
ir_Job.attributes={ir_Job_name, ir_Job_at, ir_Job_onCycle}
...
lambda_114: BinaryAssociation = BinaryAssociation(
    name="lambda_114",
    ends={
...
domain_model = DomainModel(
    name="ir",
    types={ir_IrAnnotable, ir_IrAnnotation, ir_EStringToStringMapEntry, ir_JobContainer, IrAnnotable, ir_Job, ir_Import, ir_ItemType, ir_Function, ir_Connectivity, ir_SimpleVariable, ir_Variable, ir_ConnectivityVariable, ir_TimeLoop, ir_PostProcessingInfo, ir_TimeLoopVariable, ir_IrModule, JobContainer, ir_Expression, ir_TimeLoopJob, ir_ArgOrVar, ir_Arg, ArgOrVar, ir_BaseType, Variable, ir_ConnectivityType, ir_ArgOrVarRef, ir_Instruction, ir_Loop, ir_InstructionJob, Job, TimeLoopCopyJob, ir_TimeLoopCopyJob, ir_TimeLoopCopy, ir_BeforeTimeLoopJob, ir_AfterTimeLoopJob, ir_InstructionBlock, Instruction, ir_VariableDefinition, ir_Affectation, ir_IterableInstruction, ir_IterationBlock, ir_ReductionInstruction, IterableInstruction, ir_IrType, ir_ContractedIf, Expression, ir_ItemIndexDefinition, ir_ItemIndex, ir_ItemIndexValue, ir_ItemIdDefinition, ir_ItemId, ir_ItemIdValue, ir_SetDefinition, ir_ConnectivityCall, ir_If, ir_Return, ir_Exit, ir_Iterator, IterationBlock, ir_Container, ir_Interval, ir_Cardinality, ir_BinaryExpression, ir_UnaryExpression, ir_Parenthesis, ir_IntConstant, ir_RealConstant, ir_BoolConstant, ir_MinConstant, ir_MaxConstant, ir_FunctionCall, ir_BaseTypeConstant, ir_VectorConstant, IrType, Container, ir_SetRef, ir_ItemIdValueIterator, ItemIdValue, ir_ItemIdValueCall, PrimitiveType},
    associations={annotations0, details1, innerJobs3, variables46, imports4, itemTypes5, functions7, connectivities9, options11, variables13, initNodeCoordVariable15, nodeCoordVariable17, timeVariable20, deltatVariable23, jobs26, mainTimeLoop28, postProcessingInfo30, postProcessedVariables32, periodVariable35, lastDumpVariable38, innerTimeLoop42, outerTimeLoop44, whileCondition48, associatedJob50, iterationCounter52, type55, type56, defaultValue59, type62, defaultValue64, returnType66, variables69, inArgs72, body75, inTypes77, returnType80, lambda_114, result117, jobContainer83, instruction84, copies86, timeLoop87, destination90, source93, variables96, instructions98, variable101, left103, right105, iterationBlock108, innerInstructions109, binaryFunction111, type151, body120, index122, value123, id125, value126, value128, condition129, thenInstruction131, elseInstruction134, expression137, index139, container141, counter143, index146, nbElems148, values177, container179, condition153, thenExpression155, elseExpression158, left161, right163, expression166, expression168, function170, args172, value175, target181, iterators183, indices186, sizes189, connectivities192, base195, init198, current201, next204, connectivity207, args210, target213, iterator215, call217, id219, container222},
    generalizations={gen_ir_JobContainer_IrAnnotable, gen_ir_IrModule_JobContainer, gen_ir_Import_IrAnnotable, gen_ir_PostProcessingInfo_IrAnnotable, gen_ir_TimeLoop_IrAnnotable, gen_ir_ArgOrVar_IrAnnotable, gen_ir_Arg_ArgOrVar, gen_ir_Variable_ArgOrVar, gen_ir_SimpleVariable_Variable, gen_ir_ConnectivityVariable_Variable, gen_ir_Function_IrAnnotable, gen_ir_Connectivity_IrAnnotable, gen_ir_Job_IrAnnotable, gen_ir_Loop_IterableInstruction, gen_ir_InstructionJob_Job, gen_ir_TimeLoopJob_TimeLoopCopyJob, gen_ir_TimeLoopJob_JobContainer, gen_ir_TimeLoopCopyJob_Job, gen_ir_BeforeTimeLoopJob_TimeLoopCopyJob, gen_ir_AfterTimeLoopJob_TimeLoopCopyJob, gen_ir_TimeLoopCopy_IrAnnotable, gen_ir_Instruction_IrAnnotable, gen_ir_InstructionBlock_Instruction, gen_ir_VariableDefinition_Instruction, gen_ir_Affectation_Instruction, gen_ir_IterableInstruction_Instruction, gen_ir_ReductionInstruction_IterableInstruction, gen_ir_Expression_IrAnnotable, gen_ir_ContractedIf_Expression, gen_ir_ItemIndexDefinition_Instruction, gen_ir_ItemIdDefinition_Instruction, gen_ir_SetDefinition_Instruction, gen_ir_If_Instruction, gen_ir_Return_Instruction, gen_ir_Exit_Instruction, gen_ir_IterationBlock_IrAnnotable, gen_ir_Iterator_IterationBlock, gen_ir_Interval_IterationBlock, gen_ir_Cardinality_Expression, gen_ir_BinaryExpression_Expression, gen_ir_UnaryExpression_Expression, gen_ir_Parenthesis_Expression, gen_ir_IntConstant_Expression, gen_ir_RealConstant_Expression, gen_ir_BoolConstant_Expression, gen_ir_MinConstant_Expression, gen_ir_MaxConstant_Expression, gen_ir_FunctionCall_Expression, gen_ir_BaseTypeConstant_Expression, gen_ir_VectorConstant_Expression, gen_ir_ItemId_IrAnnotable, gen_ir_ArgOrVarRef_Expression, gen_ir_ItemType_IrAnnotable, gen_ir_IrType_IrAnnotable, gen_ir_BaseType_IrType, gen_ir_ConnectivityType_IrType, gen_ir_TimeLoopVariable_IrAnnotable, gen_ir_Container_IrAnnotable, gen_ir_ConnectivityCall_Container, gen_ir_SetRef_Container, gen_ir_ItemIdValue_IrAnnotable, gen_ir_ItemIdValueIterator_ItemIdValue, gen_ir_ItemIdValueCall_ItemIdValue, gen_ir_ItemIndex_IrAnnotable, gen_ir_ItemIndexValue_IrAnnotable},
    metadata=None
)
