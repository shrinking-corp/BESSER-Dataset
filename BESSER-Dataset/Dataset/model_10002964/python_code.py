...
class Subject:
    ...
    def __init__(self, name: str, subjectType: str, subjectCategory: str, subjectID: str, subjectTest: str, course3: "Course" = None):
        self.name = name
        self.subjectType = subjectType
        self.subjectCategory = subjectCategory
        self.subjectID = subjectID
        self.subjectTest = subjectTest
    ...
    @subjectID.setter
    def subjectID(self, subjectID: str):
    ...
    @property
    def subjectCategory(self):
        return self.__subjectCategory
    @subjectCategory.setter
    def subjectCategory(self, subjectCategory: str):
        self.__subjectCategory = subjectCategory

    @property
    def subjectTest(self):
        return self.__subjectTest
    @subjectTest.setter
    def subjectTest(self, subjectTest: str):
        self.__subjectTest = subjectTest
...
class Course:
    ...
    def __init__(self, subjects__: Subject, courseDuration: str, CourseStartDate: date, CourseEndDate: date, courseName: str, department1: "Department" = None, subject2: set["Subject"] = None):
    ...
    @property
    def CourseEndDate(self):
        return self.__CourseEndDate
    @CourseEndDate.setter
    def CourseEndDate(self, CourseEndDate: date):
        self.__CourseEndDate = CourseEndDate

    @property
    def courseDuration(self):
        return self.__courseDuration
    @courseDuration.setter
    def courseDuration(self, courseDuration: str):
    ...
    def CourseStartDate(self, CourseStartDate: date):
        self.__CourseStartDate = CourseStartDate
...
class Department:
    ...
    def __init__(self, course: Course, students__: Student, teachers__: Teacher, courseID: str, CourseName: str, access_Information19: "Access_Information" = None, course0: "Course" = None, student4: set["Student"] = None, employee6: set["Employee_Interface"] = None):
        self.course = course
...
class Student:
    ...
    def __init__(self, firstName: str, ID: str, lastNAme: str, socialsecurity: str, middleNAme: str, faculty13: "Faculty" = None, department5: "Department" = None, Having_Attendance8: "Access_Information" = None):
        self.firstName = firstName
        self.ID = ID
        self.lastNAme = lastNAme
        self.socialsecurity = socialsecurity
        self.middleNAme = middleNAme
        self.faculty13 = faculty13
    ...
    @socialsecurity.setter
    def socialsecurity(self, socialsecurity: str):
    ...
    def faculty13(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Student__faculty13", None)
        self.__faculty13 = value
