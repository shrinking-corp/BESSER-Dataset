...
Book_Chapter = Class(name="Book_Chapter", is_abstract=True)
Book_Section = Class(name="Book_Section")
Chapter = Class(name="Chapter")
Book_Paragraph = Class(name="Book_Paragraph")
...
Book_Book.attributes={Book_Book_name, Book_Book_isbn, Book_Book_nbpages}
