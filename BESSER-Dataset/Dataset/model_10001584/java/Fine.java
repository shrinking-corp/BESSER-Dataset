...
public class Fine  {
    ...
    public Fine(
        String returned_date,        int fine_amount,        int book_id,        int member_id,        String borrowed_date    ) {
    ...
    public Fine(
        String returned_date,        int fine_amount,        int book_id,        int member_id,        String borrowed_date        ArrayList<Librarian> librarians    ) {
        this.returned_date = returned_date;
        this.fine_amount = fine_amount;
        this.book_id = book_id;
        this.member_id = member_id;
