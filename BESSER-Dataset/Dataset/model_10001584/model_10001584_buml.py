...
Books.attributes={Books_publisher, Books_book_qty, Books_author_name, Books_book_id, Books_ISBN_no, Books_title}
...
Member.attributes={Member_address, Member_member_id, Member_dob, Member_member_pwd, Member_cont_no, Member_lname, Member_fname, Member_gender}
...
Librarian.attributes={Librarian_member_pwd, Librarian_member_id, Librarian_lname, Librarian_cont_no, Librarian_address, Librarian_dob, Librarian_gender, Librarian_fname}
...
Fine.attributes={Fine_returned_date, Fine_book_id, Fine_borrowed_date, Fine_fine_amount, Fine_member_id}
...
Staff.attributes={Staff_position, Staff_Staff_ID, Staff_password, Staff_email, Staff_lname, Staff_fname, Staff_contact, Staff_username, Staff_gender, Staff_address}
...
domain_model = DomainModel(
    name="_HCxwUA_uEeeoBvzX9wJhsQ",
    types={Books, Member, Librarian, Fine, Borrowed, Reserved, Staff, admin, lecturer, Class_},
    associations={Books_Reserved, Reserved_Member, Librarian_Books, Librarian_Fine, Fine_Member, Member_Librarian, Registar_Staff2, Staff_Professor2, Books_Borrowed, Borrowed_Member},
    generalizations={},
    metadata=None
)
