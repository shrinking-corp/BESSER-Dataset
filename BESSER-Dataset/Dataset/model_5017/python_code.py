...
class ppo_USAddress:
    ...
    def __init__(self, name: str, street: str, city: str, state: str, zip: int, country: str, ppo_USAddress5: "ppo_PurchaseOrder" = None, ppo_USAddress: "ppo_PurchaseOrder" = None):
        self.name = name
        self.street = street
        self.city = city
        self.state = state
...
class ppo_PurchaseOrder:
    ...
    def __init__(self, comment: str, orderDate: date, ppo_PurchaseOrder: set["ppo_Item"] = None, ppo_PurchaseOrder4: "ppo_USAddress" = None, ppo_PurchaseOrder2: "ppo_USAddress" = None):
...
class ppo_Item:
    ...
    def __init__(self, quantity: int, uSPrice: int, comment: str, shipDate: date, partNum: str, productName: str, ppo_Item: "ppo_PurchaseOrder" = None):
