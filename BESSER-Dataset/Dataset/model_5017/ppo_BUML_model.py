...
ppo_Item.attributes={ppo_Item_quantity, ppo_Item_comment, ppo_Item_uSPrice, ppo_Item_productName, ppo_Item_partNum, ppo_Item_shipDate}
...
ppo_USAddress.attributes={ppo_USAddress_city, ppo_USAddress_street, ppo_USAddress_zip, ppo_USAddress_name, ppo_USAddress_state, ppo_USAddress_country}
...
domain_model = DomainModel(
    ...
    associations={items0, shipTo3, billTo1},
    generalizations={},
    metadata=None
)
