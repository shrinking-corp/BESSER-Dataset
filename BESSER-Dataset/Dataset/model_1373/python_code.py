...
class statemachine_Transition:
    ...
    def __init__(self, trigger: str, action: str, out: "statemachine_State" = None, in_: "statemachine_State" = None, statemachine_Transition: "statemachine_StateMachine" = None, Transition: "statemachine_State" = None, Transition5: "statemachine_State" = None):
    ...
    def in_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_statemachine_Transition__in_", None)
        self.__in_ = value
...
class statemachine_State:
    ...
    def __init__(self, name: str, State: "statemachine_Transition" = None, State8: "statemachine_Transition" = None, statemachine_State: "statemachine_StateMachine" = None, src: set["statemachine_Transition"] = None, dst: set["statemachine_Transition"] = None):
        self.name = name
        self.State = State
        self.State8 = State8
