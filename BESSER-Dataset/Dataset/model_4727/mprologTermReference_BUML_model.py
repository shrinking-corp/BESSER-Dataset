...
# Classes
mprologTermReference_Model = Class(name="mprologTermReference_Model")
mprologTermReference_Clause = Class(name="mprologTermReference_Clause")
mprologTermReference_Head = Class(name="mprologTermReference_Head")
mprologTermReference_Body = Class(name="mprologTermReference_Body")
mprologTermReference_Functor = Class(name="mprologTermReference_Functor")
mprologTermReference_Term = Class(name="mprologTermReference_Term", is_abstract=True)
mprologTermReference_Variable = Class(name="mprologTermReference_Variable")
Term = Class(name="Term")
mprologTermReference_List = Class(name="mprologTermReference_List")
mprologTermReference_InfixExpression = Class(name="mprologTermReference_InfixExpression")
mprologTermReference_Operator = Class(name="mprologTermReference_Operator")
mprologTermReference_TermReference = Class(name="mprologTermReference_TermReference", is_abstract=True)
mprologTermReference_FunctorReference = Class(name="mprologTermReference_FunctorReference")
TermReference = Class(name="TermReference")
mprologTermReference_VariableReference = Class(name="mprologTermReference_VariableReference")
mprologTermReference_Parenthesis = Class(name="mprologTermReference_Parenthesis")
mprologTermReference_QuotedAtom = Class(name="mprologTermReference_QuotedAtom")
...
domain_model = DomainModel(
    ...
    types={mprologTermReference_Model, mprologTermReference_Clause, mprologTermReference_Head, mprologTermReference_Body, mprologTermReference_Functor, mprologTermReference_Term, mprologTermReference_Variable, Term, mprologTermReference_List, mprologTermReference_InfixExpression, mprologTermReference_Operator, mprologTermReference_TermReference, mprologTermReference_FunctorReference, TermReference, mprologTermReference_VariableReference, mprologTermReference_Parenthesis, mprologTermReference_QuotedAtom},
    associations={ownedClause0, ownedHead1, ownedBody3, ownedFunctor5, nextTerm8, ownedTerm9, ownedHeadTerms15, ownedTailTerms17, leftTerm20, rightTerm22, ownedOperator25, idReference27, ownedTerm29, idReference32, ownedTerm33, ownedTerm12},
    generalizations={gen_mprologTermReference_Variable_Term, gen_mprologTermReference_List_Term, gen_mprologTermReference_InfixExpression_Term, gen_mprologTermReference_TermReference_Term, gen_mprologTermReference_FunctorReference_TermReference, gen_mprologTermReference_VariableReference_TermReference, gen_mprologTermReference_Parenthesis_Term, gen_mprologTermReference_Functor_Term, gen_mprologTermReference_QuotedAtom_Term},
    metadata=None
)
