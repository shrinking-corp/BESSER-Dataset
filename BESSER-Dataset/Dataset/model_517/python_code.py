...
class Families_Family:
    ...
    def __init__(self, lastname: str, families: "Families_Families" = None, family: set["Families_Member"] = None, Family4: "Families_Member" = None, Family: "Families_Families" = None):
