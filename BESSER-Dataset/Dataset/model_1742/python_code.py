...
class model_Actor:
    ...
    def __init__(self, id: int, name: str, actors: set["model_Movie"] = None, Actor: "model_Movie" = None):
        self.id = id
        self.name = name
...
class model_PrimaryObject:
    ...
    def __init__(self, id: int, name: str, unsettableAttribute: str, unsettableAttributeWithDefault: str, featureMapReferenceCollection: str, featureMapAttributeType1: str, featureMapAttributeType2: str, featureMapAttributeCollection: str, model_PrimaryObject30: set["model_TargetObject"] = None, model_PrimaryObject33: "model_TargetObject" = None, model_PrimaryObject36: set["model_TargetObject"] = None, model_PrimaryObject39: "model_TargetObject" = None, model_PrimaryObject42: set["model_TargetObject"] = None, model_PrimaryObject: "model_TargetObject" = None, model_PrimaryObject27: "model_TargetObject" = None, model_PrimaryObject45: set["model_TargetObject"] = None, model_PrimaryObject48: set["model_TargetObject"] = None):
        self.id = id
        self.name = name
...
class model_Location:
    ...
    def __init__(self, address: str, id: str, model_Location15: "model_Book" = None, model_Location: "model_Library" = None, model_Location18: "model_MappedLibrary" = None):
...
class model_Book:
    ...
    def __init__(self, title: str, tags: str, data: str, model_Book16: "model_Location" = None, Book: "model_Person" = None, books: set["model_Person"] = None, model_Book: "model_Library" = None, model_Book13: "model_Library" = None, model_Book21: "model_MappedLibrary" = None, model_Book24: "model_MappedLibrary" = None):
        self.title = title
        self.tags = tags
        self.data = data
