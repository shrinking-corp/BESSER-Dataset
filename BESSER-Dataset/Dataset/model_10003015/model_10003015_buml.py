...
domain_model = DomainModel(
    name="f572d6f9_ba61_4070_8ac1_4750c0b34927",
    types={Log_in__log_out_external, Tourist_management_system_Component, T, Tourist_Actor, Admin_Actor, Actor_Actor, Actor2_Actor, Log_in__Sign_up_external, Request_package_external, Give_description_external, View_package_external, Verification_external, Manage_questions_external, System_maintenance_external, Update_member_profile_external, Book_package_external},
    associations={Librarian_Issue_member_card, Member_Inquiry_for_membership, Member_Request_book, Member_Request_book_return, Member_Search_books, Librarian_Issue_book, Librarian_Return_book, Librarian_Update_member_profile, Librarian_Maintain_book_in_records, Member_Cancel_membership},
    generalizations={},
    metadata=None
)
