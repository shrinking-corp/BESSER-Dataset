...
class hlcorestructure_Fill:
    ...
    def __init__(self, gradientrotation: str, image: str, color: str, gradientcolor: str, Fill: "hlcorestructure_NodeGraphics" = None, Fill53: "hlcorestructure_AnnotationGraphics" = None, fill: "hlcorestructure_NodeGraphics" = None, fill63: "hlcorestructure_AnnotationGraphics" = None):
...
class hlcorestructure_ToolInfo:
    ...
    def __init__(self, tool: str, version: str, formattedXMLBuffer: str, toolInfoGrammarURI: str, ToolInfo: "hlcorestructure_PetriNet" = None, ToolInfo17: "hlcorestructure_PnObject" = None, toolspecifics31: "hlcorestructure_Label" = None, containerToolInfo: "hlcorestructure_AnyObject" = None, ToolInfo34: "hlcorestructure_Label" = None, toolspecifics: "hlcorestructure_PetriNet" = None, toolspecifics28: "hlcorestructure_PnObject" = None, ToolInfo107: "hlcorestructure_AnyObject" = None):
        self.tool = tool
...
class hlcorestructure_PnObject(ABC):
    ...
    def __init__(self, id: str, containerNamePnObject: "hlcorestructure_Name" = None, PnObject: "hlcorestructure_Page" = None, PnObject24: "hlcorestructure_Name" = None, containerPnObject: set["hlcorestructure_ToolInfo"] = None, objects: "hlcorestructure_Page" = None, PnObject29: "hlcorestructure_ToolInfo" = None):
        self.id = id
...
class hlcorestructure_PetriNet:
    ...
    def __init__(self, id: str, type: str, containerDeclarationPetriNet: set["hlcorestructure_Declaration"] = None, PetriNet9: "hlcorestructure_Page" = None, PetriNet: "hlcorestructure_PetriNetDoc" = None, containerPetriNet: set["hlcorestructure_Page"] = None, containerNamePetriNet: "hlcorestructure_Name" = None, containerPetriNet4: set["hlcorestructure_ToolInfo"] = None, nets: "hlcorestructure_PetriNetDoc" = None, PetriNet21: "hlcorestructure_Name" = None, PetriNet26: "hlcorestructure_ToolInfo" = None, PetriNet122: "hlcorestructure_Declaration" = None):
        self.id = id
        self.type = type
