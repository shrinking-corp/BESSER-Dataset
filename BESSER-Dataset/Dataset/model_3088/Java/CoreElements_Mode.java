...
public class CoreElements_Mode  {
    ...
    private MARTE_NFPs_NfpConstraint marte_nfps_nfpconstraint;
    ...
    public CoreElements_Mode(
    ) {
    }



    public MARTE_NFPs_NfpConstraint getMarte_nfps_nfpconstraint() {
        return marte_nfps_nfpconstraint;
    }

    public void setMarte_nfps_nfpconstraint(MARTE_NFPs_NfpConstraint marte_nfps_nfpconstraint) {
        this.marte_nfps_nfpconstraint = marte_nfps_nfpconstraint;
    }
