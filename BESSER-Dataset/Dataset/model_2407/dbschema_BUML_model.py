...
domain_model = DomainModel(
    name="dbschema",
    types={dbschema_AttributeColumn, Column, dbschema_ForeignKeyColumn, dbschema_NamedElement, dbschema_DBSchema, NamedElement, dbschema_Table, dbschema_Column, ColumnType},
    associations={referencedColumn3, tables0, columns1},
    generalizations={gen_dbschema_AttributeColumn_Column, gen_dbschema_ForeignKeyColumn_Column, gen_dbschema_DBSchema_NamedElement, gen_dbschema_Table_NamedElement, gen_dbschema_Column_NamedElement},
    metadata=None
)
