...
domain_model = DomainModel(
    name="b7cce4ec_cf43_434e_b060_e900079dfb4d",
    ...
    associations={Machine_Memory, Processor_Memory, AcceleratorCard_CPU, Program_Instruction, Machine_Processor, Processor_Program, Cache_RAM, ExtensionBoard_Card, Vendor1Adapter_Vendor1Sound, Vendor2Adapter_Vendor2Sound, Machine_Card},
    generalizations={},
    metadata=None
)
