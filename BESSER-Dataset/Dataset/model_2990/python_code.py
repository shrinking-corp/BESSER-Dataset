...
class wikidb119_page:
    ...
    def __init__(self, page_latest: str, page_is_redirect: int, page_title: str, page_len: str, page_touched: str, page_is_new: int, page_random: float, page_id: str, page_counter: str, page_namespace: str, page_restrictions: str):
...
class wikidb119_page_restrictions:
    ...
    def __init__(self, pr_level: str, pr_user: str, pr_type: str, pr_page: str, pr_expiry: str, pr_cascade: int, pr_id: str):
...
class wikidb119_uploadstash:
    ...
    def __init__(self, us_status: str, us_user: str, us_chunk_inx: str, us_orig_path: str, us_key: str, us_media_type: str, us_id: str, us_image_width: str, us_image_bits: int, us_image_height: str, us_path: str, us_sha1: str, us_timestamp: str, us_size: str, us_source_type: str, us_mime: str):
...
class wikidb119_oldimage:
    ...
    def __init__(self, oi_media_type: str, oi_deleted: int, oi_major_mime: str, oi_width: str, oi_sha1: str, oi_description: str, oi_size: str, oi_name: str, oi_timestamp: str, oi_minor_mime: str, oi_user_text: str, oi_archive_name: str, oi_height: str, oi_bits: str, oi_metadata: str, oi_user: str):
...
class wikidb119_ipblocks:
    ...
    def __init__(self, ipb_address: str, ipb_auto: int, ipb_create_account: int, ipb_anon_only: int, ipb_block_email: int, ipb_by_text: str, ipb_enable_autoblock: int, ipb_id: str, ipb_reason: str, ipb_timestamp: str, ipb_range_end: str, ipb_allow_usertalk: int, ipb_range_start: str, ipb_expiry: str, ipb_deleted: int, ipb_user: str, ipb_by: str):
...
class wikidb119_iwlinks:
    ...
    def __init__(self, iwl_from: str, iwl_prefix: str, iwl_title: str):
...
class wikidb119_categorylinks:
    ...
    def __init__(self, cl_to: str, cl_from: str, cl_sortkey: str, cl_timestamp: date, cl_type: str, cl_sortkey_prefix: str, cl_collation: str):
        self.cl_to = cl_to
