...
public class wikidb119_page  {
    ...
    public wikidb119_page(
        String page_len,        String page_restrictions,        String page_namespace,        int page_is_new,        float page_random,        String page_title,        String page_counter,        int page_is_redirect,        String page_id,        String page_latest,        String page_touched    ) {
