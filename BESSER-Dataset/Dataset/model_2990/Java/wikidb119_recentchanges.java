...
public class wikidb119_recentchanges  {
    ...
    public wikidb119_recentchanges(
        String rc_user,        String rc_moved_to_title,        String rc_this_oldid,        String rc_last_oldid,        String rc_params,        String rc_id,        String rc_user_text,        String rc_log_action,        String rc_cur_id,        String rc_title,        int rc_patrolled,        String rc_timestamp,        int rc_bot,        String rc_log_type,        String rc_old_len,        String rc_new_len,        String rc_logid,        String rc_cur_time,        int rc_new,        String rc_ip,        String rc_comment,        int rc_minor,        int rc_type,        int rc_deleted,        int rc_moved_to_ns,        String rc_namespace    ) {
