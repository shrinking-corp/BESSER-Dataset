...
Menu.attributes={Menu_mainCourse, Menu_specialCourse, Menu_starter, Menu_desert}
...
Drinks.attributes={Drinks_beer, Drinks_cocktail, Drinks_spirits, Drinks_softDrink, Drinks_wine}
