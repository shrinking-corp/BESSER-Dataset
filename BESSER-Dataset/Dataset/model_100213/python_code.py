...
class HTML_TR(TABLEElement):
    ...
    def __init__(self, align: str, valign: str, trs: "TABLE" = None, tr: set["TD"] = None):
        self.align = align
        self.valign = valign
        self.trs = trs
...
class HTML_IMG(BODYElement):
    ...
    def __init__(self, usemap: str, border: str, src: str, width: str, height: str, alt: str, align: str, vspace: str, hspace: str, ismap: str, BODYElement: "HTML_BODY" = None):
        self.usemap = usemap
        self.border = border
        self.src = src
        self.width = width
...
class HTML_EMBED(BODYElement):
    ...
    def __init__(self, height: str, align: str, vspace: str, hspace: str, border: str, src: str, width: str, BODYElement: "HTML_BODY" = None):
        self.height = height
        self.align = align
        self.vspace = vspace
        self.hspace = hspace
...
class HTML_BODY(HTMLElement):
    ...
    def __init__(self, link: str, alink: str, vlink: str, background: str, bgcolor: str, text: str, body: set["BODYElement"] = None, body13: "HTML" = None, HTMLElement: "HTML_HTMLElement" = None, HTMLElement5: "HTML_HTMLElement" = None):
        self.link = link
        self.alink = alink
        self.vlink = vlink
        self.background = background
