...
class notation_PropertiesSetStyle(NamedStyle):
    ...
    def createProperty(self, notation_propertyName, notation_instanceType, notation_initialValue) :
...
class notation_Guide:
    ...
    def __init__(self, position: int, notation_Guide35: "notation_GuideStyle" = None, notation_Guide37: set["notation_NodeEntry"] = None, notation_Guide: "notation_GuideStyle" = None):
...
class EObject:
    ...
    pass
class notation_ConnectorStyle(LineStyle, RoutingStyle, EObject):

    pass
class notation_DiagramStyle(PageStyle, EObject, GuideStyle, DescriptionStyle):

    pass
class notation_ShapeStyle(EObject, FontStyle, LineStyle, DescriptionStyle, FillStyle):
...
class notation_FontStyle(Style):
    ...
    def __init__(self, bold: bool, italic: bool, underline: bool, strikeThrough: bool, fontColor: int, fontName: str, fontHeight: int):
        self.bold = bold
        self.italic = italic
...
class notation_Bendpoints(ABC):
    ...
    pass
class notation_View(EModelElement, ecore_EClass):
...
class notation_Diagram(View):
    ...
    def __init__(self, name: str, measurementUnit: str, notation_Diagram57: "notation_DiagramLinkStyle" = None, notation_Diagram59: "notation_MultiDiagramLinkStyle" = None, notation_Diagram: "notation_View" = None, notation_Diagram27: set["notation_Edge"] = None, notation_Diagram30: set["notation_Edge"] = None):
        self.name = name
