...
# Classes
crom_l1_Attribute = Class(name="crom_l1_Attribute")
RelationTarget = Class(name="RelationTarget")
crom_l1_NamedElement = Class(name="crom_l1_NamedElement", is_abstract=True)
crom_l1_ModelElement = Class(name="crom_l1_ModelElement", is_abstract=True)
NamedElement = Class(name="NamedElement")
crom_l1_Model = Class(name="crom_l1_Model")
crom_l1_Relation = Class(name="crom_l1_Relation", is_abstract=True)
crom_l1_RigidType = Class(name="crom_l1_RigidType")
Type = Class(name="Type")
ModelElement = Class(name="ModelElement")
crom_l1_Group = Class(name="crom_l1_Group")
Model = Class(name="Model")
crom_l1_Parameter = Class(name="crom_l1_Parameter")
TypedElement = Class(name="TypedElement")
crom_l1_Operation = Class(name="crom_l1_Operation")
crom_l1_Type = Class(name="crom_l1_Type")
crom_l1_RoleGroupElement = Class(name="crom_l1_RoleGroupElement", is_abstract=True)
crom_l1_AbstractRoleRef = Class(name="crom_l1_AbstractRoleRef")
crom_l1_NaturalType = Class(name="crom_l1_NaturalType")
RigidType = Class(name="RigidType")
Player = Class(name="Player")
crom_l1_RoleType = Class(name="crom_l1_RoleType")
AbstractRole = Class(name="AbstractRole")
AntiRigidType = Class(name="AntiRigidType")
crom_l1_Fulfillment = Class(name="crom_l1_Fulfillment")
Relation = Class(name="Relation")
crom_l1_AbstractRole = Class(name="crom_l1_AbstractRole", is_abstract=True)
crom_l1_Player = Class(name="crom_l1_Player", is_abstract=True)
crom_l1_Inheritance = Class(name="crom_l1_Inheritance")
crom_l1_NaturalInheritance = Class(name="crom_l1_NaturalInheritance")
Inheritance = Class(name="Inheritance")
crom_l1_RelationTarget = Class(name="crom_l1_RelationTarget", is_abstract=True)
RoleGroupElement = Class(name="RoleGroupElement")
crom_l1_TypedElement = Class(name="crom_l1_TypedElement", is_abstract=True)
crom_l1_DataType = Class(name="crom_l1_DataType")
crom_l1_Constraint = Class(name="crom_l1_Constraint")
crom_l1_RoleGroup = Class(name="crom_l1_RoleGroup")
crom_l1_RoleProhibition = Class(name="crom_l1_RoleProhibition")
crom_l1_AntiRigidType = Class(name="crom_l1_AntiRigidType")
crom_l1_Part = Class(name="crom_l1_Part")
crom_l1_CompartmentType = Class(name="crom_l1_CompartmentType")
crom_l1_RoleConstraint = Class(name="crom_l1_RoleConstraint")
Constraint = Class(name="Constraint")
crom_l1_Test = Class(name="crom_l1_Test")
crom_l1_DataInheritance = Class(name="crom_l1_DataInheritance")
crom_l1_RoleImplication = Class(name="crom_l1_RoleImplication")
RoleConstraint = Class(name="RoleConstraint")
crom_l1_CompartmentInheritance = Class(name="crom_l1_CompartmentInheritance")
crom_l1_RoleEquivalence = Class(name="crom_l1_RoleEquivalence")
...
crom_l1_RoleGroup.attributes={crom_l1_RoleGroup_lower, crom_l1_RoleGroup_upper}
...
domain_model = DomainModel(
    name="crom_l1",
    types={crom_l1_Attribute, RelationTarget, crom_l1_NamedElement, crom_l1_ModelElement, NamedElement, crom_l1_Model, crom_l1_Relation, crom_l1_RigidType, Type, ModelElement, crom_l1_Group, Model, crom_l1_Parameter, TypedElement, crom_l1_Operation, crom_l1_Type, crom_l1_RoleGroupElement, crom_l1_AbstractRoleRef, crom_l1_NaturalType, RigidType, Player, crom_l1_RoleType, AbstractRole, AntiRigidType, crom_l1_Fulfillment, Relation, crom_l1_AbstractRole, crom_l1_Player, crom_l1_Inheritance, crom_l1_NaturalInheritance, Inheritance, crom_l1_RelationTarget, RoleGroupElement, crom_l1_TypedElement, crom_l1_DataType, crom_l1_Constraint, crom_l1_RoleGroup, crom_l1_RoleProhibition, crom_l1_AntiRigidType, crom_l1_Part, crom_l1_CompartmentType, crom_l1_RoleConstraint, Constraint, crom_l1_Test, crom_l1_DataInheritance, crom_l1_RoleImplication, RoleConstraint, crom_l1_CompartmentInheritance, crom_l1_RoleEquivalence},
    associations={owner4, owner5, elements0, relations1, params3, elements23, ref24, attributes7, operations8, filled10, filler11, super13, sub14, incoming17, outgoing19, type22, roles26, whole28, parts29, constraints30, contains32, super34, sub35, super38, sub40},
    generalizations={gen_crom_l1_Attribute_TypedElement, gen_crom_l1_Type_RelationTarget, gen_crom_l1_ModelElement_NamedElement, gen_crom_l1_RigidType_Type, gen_crom_l1_RigidType_ModelElement, gen_crom_l1_Group_ModelElement, gen_crom_l1_Group_Model, gen_crom_l1_Parameter_TypedElement, gen_crom_l1_Operation_TypedElement, gen_crom_l1_AbstractRoleRef_RoleGroupElement, gen_crom_l1_NaturalType_RigidType, gen_crom_l1_NaturalType_Player, gen_crom_l1_RoleType_AbstractRole, gen_crom_l1_RoleType_RelationTarget, gen_crom_l1_RoleType_AntiRigidType, gen_crom_l1_Fulfillment_Relation, gen_crom_l1_Inheritance_Relation, gen_crom_l1_NaturalInheritance_Inheritance, gen_crom_l1_RelationTarget_NamedElement, gen_crom_l1_AbstractRole_RoleGroupElement, gen_crom_l1_TypedElement_NamedElement, gen_crom_l1_DataType_RigidType, gen_crom_l1_RoleGroup_AbstractRole, gen_crom_l1_RoleGroup_RelationTarget, gen_crom_l1_RoleEquivalence_RoleConstraint, gen_crom_l1_RoleProhibition_RoleConstraint, gen_crom_l1_AntiRigidType_Type, gen_crom_l1_RoleConstraint_Constraint, gen_crom_l1_Test_Constraint, gen_crom_l1_CompartmentType_Player, gen_crom_l1_CompartmentType_RigidType, gen_crom_l1_DataInheritance_Inheritance, gen_crom_l1_RoleImplication_RoleConstraint, gen_crom_l1_CompartmentInheritance_Inheritance},
    metadata=None
)
