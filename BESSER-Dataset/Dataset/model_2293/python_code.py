...
class zlvp_LegendaTyp:
    ...
    def __init__(self, id: int, name: str, zlvp_LegendaTyp: "zlvp_Legenda" = None):
        self.id = id
        self.name = name
...
class zlvp_Legenda:
    ...
    def __init__(self, id: int, nachname: str, vorname: str, strasse: str, plz: str, ort: str, telNr: str, handyNr: str, faxNr: str, email: str, firma: str, bemerkung: str, zlvp_Legenda60: "zlvp_Lagerort" = None, zlvp_Legenda: "zlvp_Anrede" = None, zlvp_Legenda57: set["zlvp_LegendaTyp"] = None):
        self.id = id
...
class zlvp_ZeltDetailBezeichnung:
    ...
    def __init__(self, id: int, name: str, zlvp_ZeltDetailBezeichnung: "zlvp_ZeltDetail" = None):
        self.id = id
        self.name = name
...
class zlvp_Zelt:
    ...
    def __init__(self, id: int, name: str, zlvp_Zelt44: set["zlvp_ZeltDetail"] = None, zlvp_Zelt46: set["zlvp_Schaeden"] = None, zlvp_Zelt48: set["zlvp_Verleih"] = None, zlvp_Zelt50: set["zlvp_Lager"] = None, zlvp_Zelt: "zlvp_Lager" = None):
        self.id = id
        self.name = name
...
class zlvp_Essen:
    ...
    def __init__(self, id: int, datum: date, vormittag: str, nachmittag: str, nacht: str, zlvp_Essen: "zlvp_Lager" = None):
        self.id = id
        self.datum = datum
        self.vormittag = vormittag
        self.nachmittag = nachmittag
...
class zlvp_Jahr:
    ...
    def __init__(self, name: str, id: int, zlvp_Jahr: set["zlvp_Lager"] = None):
        self.name = name
        self.id = id
...
class zlvp_Gruppen:
    ...
    def __init__(self, id: int, name: str, spruch: str, zlvp_Gruppen22: "zlvp_Lager" = None, zlvp_Gruppen: "zlvp_Leiter" = None, zlvp_Gruppen14: "zlvp_Teilnehmer" = None, zlvp_Gruppen38: set["zlvp_Leiter"] = None, zlvp_Gruppen41: set["zlvp_Teilnehmer"] = None):
        self.id = id
        self.name = name
        self.spruch = spruch
...
class zlvp_Lager:
    ...
    def __init__(self, id: int, name: str, thema: str, ort: str, start: date, stop: date, zlvp_Lager: "zlvp_Stab" = None, zlvp_Lager19: "zlvp_Jahr" = None, zlvp_Lager21: set["zlvp_Gruppen"] = None, zlvp_Lager51: "zlvp_Zelt" = None, zlvp_Lager24: set["zlvp_Stab"] = None, zlvp_Lager27: set["zlvp_Essen"] = None, zlvp_Lager29: set["zlvp_Programm"] = None, zlvp_Lager31: set["zlvp_Zelt"] = None, zlvp_Lager33: set["zlvp_Person"] = None, zlvp_Lager36: "zlvp_Lagerort" = None, zlvp_Lager63: "zlvp_Lagerort" = None):
        self.id = id
        self.name = name
        self.thema = thema
        self.ort = ort
...
class zlvp_Stab:
    ...
    def __init__(self, id: int, zlvp_Stab: set["zlvp_Lager"] = None, zlvp_Stab5: "zlvp_Person" = None, zlvp_Stab8: "zlvp_Funktion" = None, zlvp_Stab25: "zlvp_Lager" = None):
        self.id = id
...
class zlvp_Person:
    ...
    def __init__(self, id: int, nachname: str, vorname: str, strasse: str, plz: str, ort: str, telNr: str, handyNr: str, email: str, gebDat: date, notTelNr: str, version: str, zlvp_Person2: "zlvp_Anrede" = None, zlvp_Person6: "zlvp_Stab" = None, zlvp_Person12: "zlvp_Leiter" = None, zlvp_Person17: "zlvp_Teilnehmer" = None, zlvp_Person: "zlvp_Geschlecht" = None, zlvp_Person34: "zlvp_Lager" = None):
        self.id = id
        self.nachname = nachname
        self.vorname = vorname
        self.strasse = strasse
