...
# Classes
zlvp_Geschlecht = Class(name="zlvp_Geschlecht")
zlvp_Person = Class(name="zlvp_Person")
zlvp_Anrede = Class(name="zlvp_Anrede")
zlvp_Stab = Class(name="zlvp_Stab")
zlvp_Lager = Class(name="zlvp_Lager")
zlvp_Funktion = Class(name="zlvp_Funktion")
zlvp_Leiter = Class(name="zlvp_Leiter")
zlvp_Gruppen = Class(name="zlvp_Gruppen")
zlvp_Teilnehmer = Class(name="zlvp_Teilnehmer")
zlvp_Jahr = Class(name="zlvp_Jahr")
zlvp_ZeltDetail = Class(name="zlvp_ZeltDetail")
zlvp_Schaeden = Class(name="zlvp_Schaeden")
zlvp_Verleih = Class(name="zlvp_Verleih")
zlvp_Essen = Class(name="zlvp_Essen")
zlvp_Programm = Class(name="zlvp_Programm")
zlvp_Zelt = Class(name="zlvp_Zelt")
zlvp_Lagerort = Class(name="zlvp_Lagerort")
zlvp_ZeltDetailBezeichnung = Class(name="zlvp_ZeltDetailBezeichnung")
zlvp_Legenda = Class(name="zlvp_Legenda")
zlvp_LegendaTyp = Class(name="zlvp_LegendaTyp")
...
zlvp_Person.attributes={zlvp_Person_version, zlvp_Person_gebDat, zlvp_Person_telNr, zlvp_Person_handyNr, zlvp_Person_strasse, zlvp_Person_ort, zlvp_Person_notTelNr, zlvp_Person_email, zlvp_Person_nachname, zlvp_Person_id, zlvp_Person_vorname, zlvp_Person_plz}
...
zlvp_Anrede.attributes={zlvp_Anrede_name, zlvp_Anrede_id}
...
zlvp_Lager.attributes={zlvp_Lager_stop, zlvp_Lager_name, zlvp_Lager_thema, zlvp_Lager_start, zlvp_Lager_id, zlvp_Lager_ort}
...
zlvp_Funktion.attributes={zlvp_Funktion_name, zlvp_Funktion_id}
...
zlvp_Gruppen.attributes={zlvp_Gruppen_spruch, zlvp_Gruppen_name, zlvp_Gruppen_id}
...
zlvp_Jahr.attributes={zlvp_Jahr_id, zlvp_Jahr_name}
...
zlvp_Schaeden.attributes={zlvp_Schaeden_id, zlvp_Schaeden_datum, zlvp_Schaeden_bezeichnung}
...
zlvp_Verleih.attributes={zlvp_Verleih_bemerkung, zlvp_Verleih_id, zlvp_Verleih_datum, zlvp_Verleih_person}
...
zlvp_Essen.attributes={zlvp_Essen_datum, zlvp_Essen_vormittag, zlvp_Essen_nachmittag, zlvp_Essen_nacht, zlvp_Essen_id}
...
zlvp_Programm.attributes={zlvp_Programm_vormittag, zlvp_Programm_id, zlvp_Programm_nacht, zlvp_Programm_datum, zlvp_Programm_nachmittag}
...
zlvp_Lagerort.attributes={zlvp_Lagerort_name, zlvp_Lagerort_id}
...
zlvp_ZeltDetailBezeichnung.attributes={zlvp_ZeltDetailBezeichnung_id, zlvp_ZeltDetailBezeichnung_name}
...
zlvp_Legenda.attributes={zlvp_Legenda_nachname, zlvp_Legenda_ort, zlvp_Legenda_vorname, zlvp_Legenda_bemerkung, zlvp_Legenda_email, zlvp_Legenda_plz, zlvp_Legenda_telNr, zlvp_Legenda_handyNr, zlvp_Legenda_firma, zlvp_Legenda_id, zlvp_Legenda_strasse, zlvp_Legenda_faxNr}
...
zlvp_LegendaTyp.attributes={zlvp_LegendaTyp_id, zlvp_LegendaTyp_name}
...
domain_model = DomainModel(
    name="zlvp",
    types={zlvp_Geschlecht, zlvp_Person, zlvp_Anrede, zlvp_Stab, zlvp_Lager, zlvp_Funktion, zlvp_Leiter, zlvp_Gruppen, zlvp_Teilnehmer, zlvp_Jahr, zlvp_ZeltDetail, zlvp_Schaeden, zlvp_Verleih, zlvp_Essen, zlvp_Programm, zlvp_Zelt, zlvp_Lagerort, zlvp_ZeltDetailBezeichnung, zlvp_Legenda, zlvp_LegendaTyp},
    associations={geschlecht0, anrede1, lager3, lager18, gruppen20, person4, funktion7, gruppen9, person10, gruppen13, person15, zeltDetail43, schaeden45, verleih47, Lager49, stab23, essen26, programm28, zelt30, materialwart32, lagerort35, leiter37, teilnehmer40, legenda58, lager61, zeltDetailBezeichnung52, anrede54, legendaTyp56},
    generalizations={},
    metadata=None
)
