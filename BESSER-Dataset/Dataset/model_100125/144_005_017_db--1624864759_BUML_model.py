...
domain_model = DomainModel(
    name="db",
    types={db_Table, DatabaseElement, db_Column, db_ForeignKey, db_NamedElement, db_Database, db_DatabaseElement, NamedElement},
    associations={database1, columns2, primaryKeys3, table4, parent5, contents0, child7},
    generalizations={gen_db_Table_DatabaseElement, gen_db_Column_DatabaseElement, gen_db_ForeignKey_DatabaseElement, gen_db_DatabaseElement_NamedElement},
    metadata=None
)
