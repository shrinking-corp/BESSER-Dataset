...
Employer.attributes={Employer_Address, Employer_Name}
...
domain_model = DomainModel(
    name="ddc0ee59_07e6_482e_b65b_d9eef3561ac1",
    ...
    associations={Administrator_Response_to_users, Employer_search_job, Employer_post_job, Employer_add_update_and_delete_job, Employer_Administrator, Administrator_Job_seeker, job_seeker_login, admin_login, Actor5_logout, Actor5_login, admin_logout, job_seeker_logout, Job_Seeker_login, Employer_login, Administrator_login, Job_Seeker_search_jobs, Job_Seeker_apply_for_job, Job_Seeker_post_resume, Administrator_Manage_database, Administrator_Update_categories},
    generalizations={},
    metadata=None
)
