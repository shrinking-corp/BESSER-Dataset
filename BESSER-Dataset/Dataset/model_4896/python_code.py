...
class EnabledStatusProvider:
    ...
    pass
class aggregator_MappedUnit(EnabledStatusProvider, IdentificationProvider, InstallableUnitRequest):
...
class aggregator_AvailableVersion:
    ...
    def __init__(self, versionMatch: str, version: str, filter: str, availableFrom: str, aggregator_AvailableVersion24: "aggregator_InstallableUnitRequest" = None, aggregator_AvailableVersion: "aggregator_AvailableVersionsHeader" = None):
...
class aggregator_Contact:
    ...
    def __init__(self, name: str, email: str, aggregator_Contact16: "aggregator_Contribution" = None, Contact: "aggregator_Aggregation" = None, aggregator_Contact: "aggregator_Aggregation" = None, contacts: "aggregator_Aggregation" = None):
        self.name = name
        self.email = email
...
class aggregator_Configuration(EnabledStatusProvider):
    ...
    def __init__(self, operatingSystem: str, windowSystem: str, architecture: str, aggregator_Configuration36: "aggregator_MappedUnit" = None, aggregator_Configuration49: "aggregator_ValidConfigurationsRule" = None, aggregator_Configuration: "aggregator_Aggregation" = None):
...
class aggregator_MappedRepository(DescriptionProvider, IdentificationProvider, MetadataRepositoryReference):
    ...
    def __init__(self, mirrorArtifacts: bool, categoryPrefix: str, aggregator_MappedRepository26: set["aggregator_Product"] = None, aggregator_MappedRepository28: set["aggregator_Bundle"] = None, aggregator_MappedRepository30: set["aggregator_Feature"] = None, aggregator_MappedRepository32: set["aggregator_Category"] = None, aggregator_MappedRepository34: set["aggregator_MapRule"] = None, aggregator_MappedRepository: "aggregator_Contribution" = None):
...
class aggregator_InstallableUnitRequest(DescriptionProvider, InfosProvider, StatusProvider):
    ...
    def __init__(self, name: str, versionRange: str, aggregator_InstallableUnitRequest: set["aggregator_AvailableVersion"] = None, installableUnitRequest: "aggregator_AvailableVersionsHeader" = None, InstallableUnitRequest: "aggregator_AvailableVersionsHeader" = None):
        self.name = name
...
class aggregator_MavenMapping(InfosProvider, StatusProvider):
    ...
    def __init__(self, namePattern: str, groupId: str, artifactId: str, aggregator_MavenMapping19: "aggregator_Contribution" = None, aggregator_MavenMapping: "aggregator_Aggregation" = None):
    ...
    def map(self, aggregator_installableUnitID) :
...
class aggregator_Contribution(EnabledStatusProvider, InfosProvider, StatusProvider, DescriptionProvider, IdentificationProvider):
...
class aggregator_ValidationSet(EnabledStatusProvider, InfosProvider, StatusProvider, DescriptionProvider, IdentificationProvider):

    def __init__(self, abstract: bool, extension: bool, label: str, aggregator_ValidationSet40: set["aggregator_Contribution"] = None, aggregator_ValidationSet43: set["aggregator_MetadataRepositoryReference"] = None, aggregator_ValidationSet47: "aggregator_ValidationSet" = None, aggregator_ValidationSet45: set["aggregator_ValidationSet"] = None, aggregator_ValidationSet: "aggregator_Aggregation" = None):
...
class aggregator_p2view_MetadataRepositoryStructuredView:
    ...
    def __init__(self, name: str, loaded: bool, location: str, aggregator_p2view_MetadataRepositoryStructuredView113: "p2view_aggregator_MetadataRepository" = None, aggregator_p2view_MetadataRepositoryStructuredView115: "RepositoryReferences" = None, aggregator_p2view_MetadataRepositoryStructuredView: "InstallableUnits" = None, aggregator_p2view_MetadataRepositoryStructuredView110: "Properties" = None):
        self.name = name
        self.loaded = loaded
        self.location = location
...
class aggregator_p2view_InstallableUnits:
    ...
    def __init__(self, aggregator_p2view_InstallableUnits79: "Features" = None, aggregator_p2view_InstallableUnits82: "Products" = None, aggregator_p2view_InstallableUnits85: "Bundles" = None, aggregator_p2view_InstallableUnits88: "Fragments" = None, aggregator_p2view_InstallableUnits91: "Miscellaneous" = None, aggregator_p2view_InstallableUnits: set["IUPresentation"] = None, aggregator_p2view_InstallableUnits76: "Categories" = None):
...
class aggregator_p2view_Category(IUPresentation):
    ...
    def __init__(self, aggregator_p2view_Category55: "Products" = None, aggregator_p2view_Category57: "Bundles" = None, aggregator_p2view_Category59: "Fragments" = None, aggregator_p2view_Category61: "IUDetails" = None, aggregator_p2view_Category: "Categories" = None, aggregator_p2view_Category53: "Features" = None, IUPresentation: "aggregator_p2view_InstallableUnits" = None):
