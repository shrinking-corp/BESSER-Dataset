...
# Classes
platoon_LeadVehicle = Class(name="platoon_LeadVehicle")
platoon_FollowVehicle = Class(name="platoon_FollowVehicle")
platoon_World = Class(name="platoon_World")
platoon_Platoon = Class(name="platoon_Platoon")
platoon_Route = Class(name="platoon_Route")
platoon_Constraints = Class(name="platoon_Constraints")
platoon_TurnLeft = Class(name="platoon_TurnLeft")
Turn = Class(name="Turn")
platoon_TurnRight = Class(name="platoon_TurnRight")
platoon_Constraint = Class(name="platoon_Constraint", is_abstract=True)
platoon_headway = Class(name="platoon_headway")
Constraint = Class(name="Constraint")
platoon_Vehicle = Class(name="platoon_Vehicle", is_abstract=True)
Vehicle = Class(name="Vehicle")
platoon_Step = Class(name="platoon_Step", is_abstract=True)
platoon_Forward = Class(name="platoon_Forward")
Step = Class(name="Step")
platoon_Turn = Class(name="platoon_Turn", is_abstract=True)
...
domain_model = DomainModel(
    name="platoon",
    types={platoon_LeadVehicle, platoon_FollowVehicle, platoon_World, platoon_Platoon, platoon_Route, platoon_Constraints, platoon_TurnLeft, Turn, platoon_TurnRight, platoon_Constraint, platoon_headway, Constraint, platoon_Vehicle, Vehicle, platoon_Step, platoon_Forward, Step, platoon_Turn},
    associations={leader5, followers7, platoon0, routes1, constraints3, route9, frontrunner12, steps14, list16},
    generalizations={gen_platoon_Turn_Step, gen_platoon_TurnLeft_Turn, gen_platoon_TurnRight_Turn, gen_platoon_headway_Constraint, gen_platoon_LeadVehicle_Vehicle, gen_platoon_FollowVehicle_Vehicle, gen_platoon_Forward_Step},
    metadata=None
)
