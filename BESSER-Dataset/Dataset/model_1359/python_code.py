...
class statemachine_Transition:
    ...
    def __init__(self, Id: int, statemachine_Transition: "statemachine_StateMachine" = None, statemachine_Transition9: "statemachine_State" = None, statemachine_Transition12: "statemachine_State" = None):
        self.Id = Id
...
class statemachine_State:
    ...
    def __init__(self, name: str, statemachine_State: "statemachine_StateMachine" = None, statemachine_State6: set["statemachine_Resource"] = None, statemachine_State10: "statemachine_Transition" = None, statemachine_State13: "statemachine_Transition" = None):
        self.name = name
