...
class statechart_Event(IDBase):
    ...
    def __init__(self, name: str, Event: "statechart_Transition" = None, trigger: "statechart_Transition" = None, statechart_Event: "statechart_State" = None):
        self.name = name
        self.Event = Event
...
class statechart_StateMachine(IDBase):
    ...
    def __init__(self, name: str, StateMachine: "statechart_StateMachineRoot" = None, statechart_StateMachine: "statechart_StateMachineRoot" = None, transSM_container: set["statechart_Transition"] = None, state_container: set["statechart_State"] = None, subStateMachines: "statechart_StateMachineRoot" = None, stateMachineCall: set["statechart_Action"] = None, statechart_StateMachine7: "statechart_State" = None, StateMachine9: "statechart_State" = None, StateMachine17: "statechart_Action" = None, StateMachine19: "statechart_Transition" = None):
        self.name = name
...
class statechart_Transition(IDBase):
    ...
    def __init__(self, description: str, Transition: "statechart_StateMachine" = None, Transition11: "statechart_State" = None, transitions: "statechart_StateMachine" = None, internalTransitions: "statechart_State" = None, evt_container: "statechart_Event" = None, gua_container: "statechart_Guard" = None, act_container: "statechart_TransitionAction" = None, outgoing: "statechart_StateVertex" = None, incoming: "statechart_StateVertex" = None, Transition30: "statechart_Event" = None, Transition32: "statechart_Guard" = None, Transition34: "statechart_TransitionAction" = None, Transition37: "statechart_StateVertex" = None, Transition39: "statechart_StateVertex" = None):
...
class statechart_StateVertex(IDBase, NameBase):
