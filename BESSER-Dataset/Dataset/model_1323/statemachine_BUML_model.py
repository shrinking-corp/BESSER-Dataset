...
# Classes
statechart_StateMachineRoot = Class(name="statechart_StateMachineRoot")
IDBase = Class(name="IDBase")
statechart_StateMachine = Class(name="statechart_StateMachine")
statechart_Transition = Class(name="statechart_Transition")
statechart_State = Class(name="statechart_State")
statechart_Action = Class(name="statechart_Action")
StateVertex = Class(name="StateVertex")
statechart_Guard = Class(name="statechart_Guard")
statechart_TransitionAction = Class(name="statechart_TransitionAction")
statechart_Event = Class(name="statechart_Event")
statechart_StateAction = Class(name="statechart_StateAction", is_abstract=True)
statechart_CompositeState = Class(name="statechart_CompositeState")
State = Class(name="State")
statechart_StateVertex = Class(name="statechart_StateVertex")
statechart_Label = Class(name="statechart_Label")
statechart_DO = Class(name="statechart_DO")
StateAction = Class(name="StateAction")
statechart_ENTRY = Class(name="statechart_ENTRY")
statechart_EXIT = Class(name="statechart_EXIT")
...
domain_model = DomainModel(
    name="statechart",
    types={statechart_StateMachineRoot, IDBase, statechart_StateMachine, statechart_Transition, statechart_State, statechart_Action, StateVertex, statechart_Guard, statechart_TransitionAction, statechart_Event, statechart_StateAction, statechart_CompositeState, State, statechart_StateVertex, statechart_Label, statechart_DO, StateAction, statechart_ENTRY, statechart_EXIT, Action, NameBase},
    associations={subStateMachines0, InitialStateMachine1, transitions2, top3, statemachine_container4, calledByAction5, InitialState6, state_container8, internalTransitions10, stateMachineCall16, transSM_container18, transS_container20, trigger22, guard23, action24, source25, target27, evt_container29, deferrableEvents12, actions14, subVertexes15, label40, action_container41, gua_container31, act_container33, sv_container35, outgoing36, incoming38},
    generalizations={gen_statechart_StateMachineRoot_IDBase, gen_statechart_StateMachine_IDBase, gen_statechart_State_StateVertex, gen_statechart_Transition_IDBase, gen_statechart_Event_IDBase, gen_statechart_Guard_IDBase, gen_statechart_CompositeState_State, gen_statechart_Action_IDBase, gen_statechart_StateAction_Action, gen_statechart_DO_StateAction, gen_statechart_ENTRY_StateAction, gen_statechart_EXIT_StateAction, gen_statechart_Label_IDBase, gen_statechart_TransitionAction_Action, gen_statechart_StateVertex_IDBase, gen_statechart_StateVertex_NameBase},
    metadata=None
)
