...
# Classes
library_OCLRoot = Class(name="library_OCLRoot")
library_OCLBoundType = Class(name="library_OCLBoundType")
OCLTypeValue = Class(name="OCLTypeValue")
library_OCLTypeDefinition = Class(name="library_OCLTypeDefinition")
library_OCLTypeBinding = Class(name="library_OCLTypeBinding")
library_OCLElement = Class(name="library_OCLElement")
library_OCLLibraryIteration = Class(name="library_OCLLibraryIteration")
OCLTypedElement = Class(name="OCLTypedElement")
library_OCLLibrary = Class(name="library_OCLLibrary")
OCLRoot = Class(name="OCLRoot")
OCLPackageParent = Class(name="OCLPackageParent")
library_OCLNamedElement = Class(name="library_OCLNamedElement")
OCLElement = Class(name="OCLElement")
library_OCLTypeParameter = Class(name="library_OCLTypeParameter")
library_OCLParameter = Class(name="library_OCLParameter")
library_OCLPackage = Class(name="library_OCLPackage")
library_OCLPackageParent = Class(name="library_OCLPackageParent")
OCLNamedElement = Class(name="OCLNamedElement")
library_OCLLibraryProperty = Class(name="library_OCLLibraryProperty")
library_OCLType = Class(name="library_OCLType")
library_OCLTypeValue = Class(name="library_OCLTypeValue")
OCLType = Class(name="OCLType")
library_OCLLibraryOperation = Class(name="library_OCLLibraryOperation")
library_OCLTypeReference = Class(name="library_OCLTypeReference")
library_OCLTypedElement = Class(name="library_OCLTypedElement")
...
library_OCLLibraryIteration_class_: Property = Property(name="class_", type=StringType)
library_OCLLibraryIteration.attributes={library_OCLLibraryIteration_class_, library_OCLLibraryIteration_iterators, library_OCLLibraryIteration_iterator}
...
library_OCLLibraryProperty_class_: Property = Property(name="class_", type=StringType)
library_OCLLibraryProperty.attributes={library_OCLLibraryProperty_isStatic, library_OCLLibraryProperty_class_}
...
library_OCLLibraryOperation_class_: Property = Property(name="class_", type=StringType)
library_OCLLibraryOperation.attributes={library_OCLLibraryOperation_isStatic, library_OCLLibraryOperation_class_}
...
domain_model = DomainModel(
    name="library",
    types={library_OCLRoot, library_OCLBoundType, OCLTypeValue, library_OCLTypeDefinition, library_OCLTypeBinding, library_OCLElement, library_OCLLibraryIteration, OCLTypedElement, library_OCLLibrary, OCLRoot, OCLPackageParent, library_OCLNamedElement, OCLElement, library_OCLTypeParameter, library_OCLParameter, library_OCLPackage, library_OCLPackageParent, OCLNamedElement, library_OCLLibraryProperty, library_OCLType, library_OCLTypeValue, OCLType, library_OCLLibraryOperation, library_OCLTypeReference, library_OCLTypedElement},
    associations={type0, typeBinding1, imports4, typeParameter5, parameter6, type8, package10, typeParameter12, typeParameter14, conformsTo17, iteration20, operation22, property25, type27, type29},
    generalizations={gen_library_OCLBoundType_OCLTypeValue, gen_library_OCLLibraryIteration_OCLTypedElement, gen_library_OCLLibrary_OCLRoot, gen_library_OCLLibrary_OCLPackageParent, gen_library_OCLNamedElement_OCLElement, gen_library_OCLPackage_OCLPackageParent, gen_library_OCLPackageParent_OCLNamedElement, gen_library_OCLParameter_OCLTypedElement, gen_library_OCLLibraryProperty_OCLTypedElement, gen_library_OCLType_OCLNamedElement, gen_library_OCLTypeBinding_OCLElement, gen_library_OCLTypeDefinition_OCLType, gen_library_OCLLibraryOperation_OCLTypedElement, gen_library_OCLTypedElement_OCLNamedElement, gen_library_OCLTypeParameter_OCLType, gen_library_OCLTypeReference_OCLTypeValue, gen_library_OCLTypeValue_OCLElement},
    metadata=None
)
