...
@given(instance=fsmSample_Transition_strategy)
def test_hyp_fsmsample_transition_name_setter(instance):
...
@given(instance=fsmSample_State_strategy)
def test_hyp_fsmsample_state_version_setter(instance):
...
def test_fsmSample_State_name_value_roundtrip():
    instance = fsmSample_State(name="sample_text", version="sample_text")
    assert instance.name == "sample_text"
    instance.name = "sample_text_2"
    assert instance.name == "sample_text_2"


def test_fsmSample_State_version_value_roundtrip():
    instance = fsmSample_State(name="sample_text", version="sample_text")
...
def test_fsmSample_Transition_input_value_roundtrip():
    instance = fsmSample_Transition(input="sample_text", name="sample_text", output="sample_text")
    assert instance.input == "sample_text"
    instance.input = "sample_text_2"
    assert instance.input == "sample_text_2"


def test_fsmSample_Transition_name_value_roundtrip():
    instance = fsmSample_Transition(input="sample_text", name="sample_text", output="sample_text")
    assert instance.name == "sample_text"
    instance.name = "sample_text_2"
    assert instance.name == "sample_text_2"
...
def test_assoc_action16_link_reassign_clear():
    a = fsmSample_Transition(input="sample_text", name="sample_text", output="sample_text")
...
def test_assoc_currentState5_link_reassign_clear():
    a = fsmSample_State(name="sample_text", version="sample_text")
...
def test_assoc_incomingTransition10_link_reassign_clear():
    a = fsmSample_Transition(input="sample_text", name="sample_text", output="sample_text")
    b1 = fsmSample_State(name="sample_text", version="sample_text")
    b2 = fsmSample_State(name="sample_text_2", version="sample_text_2")
...
fsmSample_State_strategy = st.builds(fsmSample_State, name=safe_text, version=safe_text)
@given(instance=fsmSample_State_strategy)
@settings(max_examples=25)
...
fsmSample_Transition_strategy = st.builds(fsmSample_Transition, input=safe_text, name=safe_text, output=safe_text)
@given(instance=fsmSample_Transition_strategy)
@settings(max_examples=25)
