...
# Classes
fsmSample_FSM = Class(name="fsmSample_FSM")
fsmSample_State = Class(name="fsmSample_State")
fsmSample_Action = Class(name="fsmSample_Action")
fsmSample_Transition = Class(name="fsmSample_Transition")
...
fsmSample_State_version: Property = Property(name="version", type=StringType)
fsmSample_State.attributes={fsmSample_State_version, fsmSample_State_name}
...
fsmSample_Transition_name: Property = Property(name="name", type=StringType)
fsmSample_Transition.attributes={fsmSample_Transition_name, fsmSample_Transition_output, fsmSample_Transition_input}
...
domain_model = DomainModel(
    name="fsmSample",
    types={fsmSample_FSM, fsmSample_State, fsmSample_Action, fsmSample_Transition},
    associations={ownedState0, initialState1, finalState2, currentState5, owningFSM8, target14, action16, outgoingTransition9, incomingTransition10, source12},
    generalizations={},
    metadata=None
)
