...
def test_fsmsample_transition_has_name():
    assert hasattr(fsmSample_Transition, "name")
    descriptor = None
    for klass in fsmSample_Transition.__mro__:
...
def test_fsmsample_state_has_version():
    assert hasattr(fsmSample_State, "version")
    descriptor = None
    for klass in fsmSample_State.__mro__:
...
@given(instance=fsmSample_Transition_strategy)
def test_fsmsample_transition_name_setter(instance):
...
@given(instance=fsmSample_State_strategy)
def test_fsmsample_state_version_setter(instance):
