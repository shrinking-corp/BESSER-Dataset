...
class fsmSample_Transition:
    ...
    def __init__(self, input: str, output: str, name: str, incomingTransition: "fsmSample_State" = None, fsmSample_Transition: "fsmSample_Action" = None, Transition: "fsmSample_State" = None, Transition11: "fsmSample_State" = None, outgoingTransition: "fsmSample_State" = None):
        self.input = input
        self.output = output
        self.name = name
...
class fsmSample_State:
    ...
    def __init__(self, name: str, version: str, State: "fsmSample_FSM" = None, fsmSample_State: "fsmSample_FSM" = None, fsmSample_State4: "fsmSample_FSM" = None, fsmSample_State7: "fsmSample_FSM" = None, ownedState: "fsmSample_FSM" = None, State15: "fsmSample_Transition" = None, source: set["fsmSample_Transition"] = None, target: set["fsmSample_Transition"] = None, State13: "fsmSample_Transition" = None):
        self.name = name
