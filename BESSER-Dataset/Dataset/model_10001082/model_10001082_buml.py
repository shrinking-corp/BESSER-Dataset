...
Menu.attributes={Menu_starter, Menu_desert, Menu_mainCourse, Menu_specialCourse}
...
Drinks.attributes={Drinks_cocktail, Drinks_softDrink, Drinks_wine, Drinks_spirits, Drinks_beer}
