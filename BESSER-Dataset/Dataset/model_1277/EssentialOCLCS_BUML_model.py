...
# Classes
essentialoclcs_AbstractNameExpCS = Class(name="essentialoclcs_AbstractNameExpCS", is_abstract=True)
ExpCS = Class(name="ExpCS")
essentialoclcs_CurlyBracketedClauseCS = Class(name="essentialoclcs_CurlyBracketedClauseCS")
essentialoclcs_PathNameCS = Class(name="essentialoclcs_PathNameCS")
essentialoclcs_RoundBracketedClauseCS = Class(name="essentialoclcs_RoundBracketedClauseCS")
essentialoclcs_SquareBracketedClauseCS = Class(name="essentialoclcs_SquareBracketedClauseCS")
essentialoclcs_Type = Class(name="essentialoclcs_Type")
essentialoclcs_AssociationClassCallExpCS = Class(name="essentialoclcs_AssociationClassCallExpCS", is_abstract=True)
CallExpCS = Class(name="CallExpCS")
essentialoclcs_AssociationClass = Class(name="essentialoclcs_AssociationClass")
essentialoclcs_BooleanLiteralExpCS = Class(name="essentialoclcs_BooleanLiteralExpCS")
PrimitiveLiteralExpCS = Class(name="PrimitiveLiteralExpCS")
essentialoclcs_CallExpCS = Class(name="essentialoclcs_CallExpCS", is_abstract=True)
AbstractNameExpCS = Class(name="AbstractNameExpCS")
ModelElementCS = Class(name="ModelElementCS")
essentialoclcs_CollectionPatternCS = Class(name="essentialoclcs_CollectionPatternCS")
TypedRefCS = Class(name="TypedRefCS")
essentialoclcs_PatternExpCS = Class(name="essentialoclcs_PatternExpCS")
Nameable = Class(name="Nameable")
essentialoclcs_TypedRefCS = Class(name="essentialoclcs_TypedRefCS")
essentialoclcs_ContextCS = Class(name="essentialoclcs_ContextCS")
NamedElementCS = Class(name="NamedElementCS")
RootCS = Class(name="RootCS")
ContextLessElementCS = Class(name="ContextLessElementCS")
essentialoclcs_ShadowPartCS = Class(name="essentialoclcs_ShadowPartCS")
essentialoclcs_ExpCS = Class(name="essentialoclcs_ExpCS")
essentialoclcs_CollectionLiteralExpCS = Class(name="essentialoclcs_CollectionLiteralExpCS")
LiteralExpCS = Class(name="LiteralExpCS")
essentialoclcs_CollectionLiteralPartCS = Class(name="essentialoclcs_CollectionLiteralPartCS")
essentialoclcs_CollectionTypeCS = Class(name="essentialoclcs_CollectionTypeCS")
essentialoclcs_Precedence = Class(name="essentialoclcs_Precedence")
essentialoclcs_ExpSpecificationCS = Class(name="essentialoclcs_ExpSpecificationCS")
SpecificationCS = Class(name="SpecificationCS")
essentialoclcs_IfExpCS = Class(name="essentialoclcs_IfExpCS")
essentialoclcs_IfThenExpCS = Class(name="essentialoclcs_IfThenExpCS")
essentialoclcs_InfixExpCS = Class(name="essentialoclcs_InfixExpCS")
OperatorExpCS = Class(name="OperatorExpCS")
essentialoclcs_InvalidLiteralExpCS = Class(name="essentialoclcs_InvalidLiteralExpCS")
essentialoclcs_IterateCallExpCS = Class(name="essentialoclcs_IterateCallExpCS", is_abstract=True)
IterationCallExpCS = Class(name="IterationCallExpCS")
essentialoclcs_VariableCS = Class(name="essentialoclcs_VariableCS")
essentialoclcs_IterationCallExpCS = Class(name="essentialoclcs_IterationCallExpCS", is_abstract=True)
essentialoclcs_OperatorExpCS = Class(name="essentialoclcs_OperatorExpCS", is_abstract=True)
essentialoclcs_LetVariableCS = Class(name="essentialoclcs_LetVariableCS")
VariableCS = Class(name="VariableCS")
essentialoclcs_LiteralExpCS = Class(name="essentialoclcs_LiteralExpCS")
essentialoclcs_MapLiteralExpCS = Class(name="essentialoclcs_MapLiteralExpCS")
essentialoclcs_MapLiteralPartCS = Class(name="essentialoclcs_MapLiteralPartCS")
essentialoclcs_MapTypeCS = Class(name="essentialoclcs_MapTypeCS")
essentialoclcs_NameExpCS = Class(name="essentialoclcs_NameExpCS")
...
essentialoclcs_NavigatingArgCS = Class(name="essentialoclcs_NavigatingArgCS")
essentialoclcs_Iteration = Class(name="essentialoclcs_Iteration")
essentialoclcs_LambdaLiteralExpCS = Class(name="essentialoclcs_LambdaLiteralExpCS")
essentialoclcs_LetExpCS = Class(name="essentialoclcs_LetExpCS")
essentialoclcs_NestedExpCS = Class(name="essentialoclcs_NestedExpCS")
essentialoclcs_NullLiteralExpCS = Class(name="essentialoclcs_NullLiteralExpCS")
essentialoclcs_NumberLiteralExpCS = Class(name="essentialoclcs_NumberLiteralExpCS")
essentialoclcs_OperationCallExpCS = Class(name="essentialoclcs_OperationCallExpCS", is_abstract=True)
essentialoclcs_Operation = Class(name="essentialoclcs_Operation")
essentialoclcs_TypeRefCS = Class(name="essentialoclcs_TypeRefCS")
essentialoclcs_PrefixExpCS = Class(name="essentialoclcs_PrefixExpCS")
essentialoclcs_PrimitiveLiteralExpCS = Class(name="essentialoclcs_PrimitiveLiteralExpCS")
essentialoclcs_PropertyCallExpCS = Class(name="essentialoclcs_PropertyCallExpCS", is_abstract=True)
essentialoclcs_Property = Class(name="essentialoclcs_Property")
essentialoclcs_SelfExpCS = Class(name="essentialoclcs_SelfExpCS")
essentialoclcs_ShadowExpCS = Class(name="essentialoclcs_ShadowExpCS", is_abstract=True)
essentialoclcs_StringLiteralExpCS = Class(name="essentialoclcs_StringLiteralExpCS")
essentialoclcs_TupleLiteralExpCS = Class(name="essentialoclcs_TupleLiteralExpCS")
essentialoclcs_TupleLiteralPartCS = Class(name="essentialoclcs_TupleLiteralPartCS")
essentialoclcs_TypeLiteralExpCS = Class(name="essentialoclcs_TypeLiteralExpCS")
essentialoclcs_UnlimitedNaturalLiteralExpCS = Class(name="essentialoclcs_UnlimitedNaturalLiteralExpCS")
essentialoclcs_VariableExpCS = Class(name="essentialoclcs_VariableExpCS", is_abstract=True)
essentialoclcs_Variable = Class(name="essentialoclcs_Variable")
essentialoclcs_TypeNameExpCS = Class(name="essentialoclcs_TypeNameExpCS")
...
essentialoclcs_ExpCS_m_isLocalLeftAncestorOf: Method = Method(name="isLocalLeftAncestorOf", parameters={Parameter(name='essentialoclcs_csExp', type=StringType)}, type=BooleanType)
essentialoclcs_ExpCS_m_isLocalRightAncestorOf: Method = Method(name="isLocalRightAncestorOf", parameters={Parameter(name='essentialoclcs_csExp', type=StringType)}, type=BooleanType)
essentialoclcs_ExpCS.attributes={essentialoclcs_ExpCS_hasError}
essentialoclcs_ExpCS.methods={essentialoclcs_ExpCS_m_isLocalLeftAncestorOf, essentialoclcs_ExpCS_m_isLocalRightAncestorOf}
...
domain_model = DomainModel(
    name="essentialoclcs",
    types={essentialoclcs_AbstractNameExpCS, ExpCS, essentialoclcs_CurlyBracketedClauseCS, essentialoclcs_PathNameCS, essentialoclcs_RoundBracketedClauseCS, essentialoclcs_SquareBracketedClauseCS, essentialoclcs_Type, essentialoclcs_AssociationClassCallExpCS, CallExpCS, essentialoclcs_AssociationClass, essentialoclcs_BooleanLiteralExpCS, PrimitiveLiteralExpCS, essentialoclcs_CallExpCS, AbstractNameExpCS, ModelElementCS, essentialoclcs_CollectionPatternCS, TypedRefCS, essentialoclcs_PatternExpCS, Nameable, essentialoclcs_TypedRefCS, essentialoclcs_ContextCS, NamedElementCS, RootCS, ContextLessElementCS, essentialoclcs_ShadowPartCS, essentialoclcs_ExpCS, essentialoclcs_CollectionLiteralExpCS, LiteralExpCS, essentialoclcs_CollectionLiteralPartCS, essentialoclcs_CollectionTypeCS, essentialoclcs_Precedence, essentialoclcs_ExpSpecificationCS, SpecificationCS, essentialoclcs_IfExpCS, essentialoclcs_IfThenExpCS, essentialoclcs_InfixExpCS, OperatorExpCS, essentialoclcs_InvalidLiteralExpCS, essentialoclcs_IterateCallExpCS, IterationCallExpCS, essentialoclcs_VariableCS, essentialoclcs_IterationCallExpCS, essentialoclcs_OperatorExpCS, essentialoclcs_LetVariableCS, VariableCS, essentialoclcs_LiteralExpCS, essentialoclcs_MapLiteralExpCS, essentialoclcs_MapLiteralPartCS, essentialoclcs_MapTypeCS, essentialoclcs_NameExpCS, AssociationClassCallExpCS, ShadowExpCS, IterateCallExpCS, OperationCallExpCS, PropertyCallExpCS, VariableExpCS, essentialoclcs_NavigatingArgCS, essentialoclcs_Iteration, essentialoclcs_LambdaLiteralExpCS, essentialoclcs_LetExpCS, essentialoclcs_NestedExpCS, essentialoclcs_NullLiteralExpCS, essentialoclcs_NumberLiteralExpCS, essentialoclcs_OperationCallExpCS, essentialoclcs_Operation, essentialoclcs_TypeRefCS, essentialoclcs_PrefixExpCS, essentialoclcs_PrimitiveLiteralExpCS, essentialoclcs_PropertyCallExpCS, essentialoclcs_Property, essentialoclcs_SelfExpCS, essentialoclcs_ShadowExpCS, essentialoclcs_StringLiteralExpCS, essentialoclcs_TupleLiteralExpCS, essentialoclcs_TupleLiteralPartCS, essentialoclcs_TypeLiteralExpCS, essentialoclcs_UnlimitedNaturalLiteralExpCS, essentialoclcs_VariableExpCS, essentialoclcs_Variable, essentialoclcs_TypeNameExpCS, NavigationRole},
    associations={ownedCurlyBracketedClause0, ownedPathName1, ownedRoundBracketedClause2, ownedSquareBracketedClauses4, sourceType6, sourceTypeValue8, referredAssociation11, ownedType17, ownedExpression19, ownedLastExpression22, ownedParts25, ownedPatternGuard26, ownedType29, ownedType32, ownedExpression34, ownedParts36, owningNameExp37, arguments12, source13, ownedParts16, localRightmostDescendant50, precedence52, ownedExpression54, ownedCondition56, ownedElseExpression58, ownedIfThenExpressions61, ownedThenExpression63, ownedCondition66, ownedThenExpression69, argument72, ownedLeft74, accumulators77, localLeft39, localLeftmostDescendant42, localParent44, localRight47, ownedInExpression84, ownedVariables86, ownedRoundBracketedClause87, owningLetExpression88, ownedParts89, ownedType90, ownedKey92, ownedValue95, ownedKeyType98, ownedValueType101, ownedInitExpression104, iterators78, referredIteration80, ownedExpressionCS82, ownedExpression114, referredOperation116, ownedRight117, source120, ownedPatternType123, referredProperty125, ownedArguments126, owningNameExp127, parts129, ownedNameExpression106, ownedType109, owningRoundBracketedClause112, referredProperty137, ownedTerms140, owningNameExp142, ownedParts144, ownedPathName145, ownedType147, element150, ownedCurlyBracketedClause153, ownedPathName155, ownedPatternGuard158, ownedInitExpression161, ownedType164, typeName130, ownedInitExpression132, owningCurlyBracketClause135, referredVariable167},
    generalizations={gen_essentialoclcs_AbstractNameExpCS_ExpCS, gen_essentialoclcs_AssociationClassCallExpCS_CallExpCS, gen_essentialoclcs_BooleanLiteralExpCS_PrimitiveLiteralExpCS, gen_essentialoclcs_CollectionLiteralPartCS_ModelElementCS, gen_essentialoclcs_CollectionPatternCS_TypedRefCS, gen_essentialoclcs_CollectionTypeCS_TypedRefCS, gen_essentialoclcs_CollectionTypeCS_Nameable, gen_essentialoclcs_ContextCS_NamedElementCS, gen_essentialoclcs_ContextCS_RootCS, gen_essentialoclcs_CurlyBracketedClauseCS_ContextLessElementCS, gen_essentialoclcs_ExpCS_ModelElementCS, gen_essentialoclcs_CallExpCS_AbstractNameExpCS, gen_essentialoclcs_CollectionLiteralExpCS_LiteralExpCS, gen_essentialoclcs_ExpSpecificationCS_SpecificationCS, gen_essentialoclcs_IfExpCS_ExpCS, gen_essentialoclcs_IfThenExpCS_ExpCS, gen_essentialoclcs_InfixExpCS_OperatorExpCS, gen_essentialoclcs_InvalidLiteralExpCS_PrimitiveLiteralExpCS, gen_essentialoclcs_IterateCallExpCS_IterationCallExpCS, gen_essentialoclcs_IterationCallExpCS_CallExpCS, gen_essentialoclcs_LetVariableCS_ExpCS, gen_essentialoclcs_LetVariableCS_VariableCS, gen_essentialoclcs_LiteralExpCS_ExpCS, gen_essentialoclcs_MapLiteralExpCS_LiteralExpCS, gen_essentialoclcs_MapLiteralPartCS_ModelElementCS, gen_essentialoclcs_MapTypeCS_TypedRefCS, gen_essentialoclcs_MapTypeCS_Nameable, gen_essentialoclcs_NameExpCS_AssociationClassCallExpCS, gen_essentialoclcs_NameExpCS_ShadowExpCS, gen_essentialoclcs_NameExpCS_IterateCallExpCS, gen_essentialoclcs_NameExpCS_IterationCallExpCS, gen_essentialoclcs_NameExpCS_OperationCallExpCS, gen_essentialoclcs_NameExpCS_PropertyCallExpCS, gen_essentialoclcs_NameExpCS_VariableExpCS, gen_essentialoclcs_NavigatingArgCS_ModelElementCS, gen_essentialoclcs_LambdaLiteralExpCS_LiteralExpCS, gen_essentialoclcs_LetExpCS_ExpCS, gen_essentialoclcs_NestedExpCS_ExpCS, gen_essentialoclcs_NullLiteralExpCS_PrimitiveLiteralExpCS, gen_essentialoclcs_NumberLiteralExpCS_PrimitiveLiteralExpCS, gen_essentialoclcs_OperationCallExpCS_CallExpCS, gen_essentialoclcs_OperatorExpCS_ExpCS, gen_essentialoclcs_OperatorExpCS_NamedElementCS, gen_essentialoclcs_PatternExpCS_ExpCS, gen_essentialoclcs_PrefixExpCS_OperatorExpCS, gen_essentialoclcs_PrimitiveLiteralExpCS_LiteralExpCS, gen_essentialoclcs_PropertyCallExpCS_CallExpCS, gen_essentialoclcs_RoundBracketedClauseCS_ContextLessElementCS, gen_essentialoclcs_SelfExpCS_ExpCS, gen_essentialoclcs_ShadowExpCS_AbstractNameExpCS, gen_essentialoclcs_SquareBracketedClauseCS_ContextLessElementCS, gen_essentialoclcs_StringLiteralExpCS_PrimitiveLiteralExpCS, gen_essentialoclcs_TupleLiteralExpCS_LiteralExpCS, gen_essentialoclcs_TupleLiteralPartCS_VariableCS, gen_essentialoclcs_TypeLiteralExpCS_LiteralExpCS, gen_essentialoclcs_TypeNameExpCS_TypedRefCS, gen_essentialoclcs_UnlimitedNaturalLiteralExpCS_PrimitiveLiteralExpCS, gen_essentialoclcs_VariableCS_NamedElementCS, gen_essentialoclcs_VariableExpCS_AbstractNameExpCS, gen_essentialoclcs_ShadowPartCS_ModelElementCS, gen_essentialoclcs_ShadowPartCS_Nameable},
    metadata=None
)
