...
domain_model = DomainModel(
    name="domainmodel",
    types={domainmodel_Domainmodel, domainmodel_AbstractElement, domainmodel_PackageDeclaration, AbstractElement, domainmodel_Import, domainmodel_Type, domainmodel_Feature, domainmodel_DataType, Type, domainmodel_Entity},
    associations={elements0, elements1, features5, type7, superType4},
