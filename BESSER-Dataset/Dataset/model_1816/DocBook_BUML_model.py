...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={DocBook_DocBook, DocBook_TitledElement, DocBook_Article, TitledElement, Sect1, DocBook_Section, Para, DocBook_Sect1, Section, Sect2, DocBook_Sect2, DocBook_Para, Book, DocBook_Book, Article},
    associations={sections_12, paras3, sections_24, books0, articles1},
