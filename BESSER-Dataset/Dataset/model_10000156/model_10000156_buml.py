...
Theme_Avatar: BinaryAssociation = BinaryAssociation(
    name="Theme_Avatar",
    ends={
        Property(name="avatar12", type=Avatar, multiplicity=Multiplicity(0, 1)),
        Property(name="theme13", type=Theme, multiplicity=Multiplicity(0, 1))
    }
)

# Domain Model
domain_model = DomainModel(
    name="_134daf0d_9063_4c11_bc31_18697a2c0c14",
    types={Deck, Theme, Avatar, Game, Player, Card, Suit, Kind},
    associations={Deck_Card, Deck_Theme, Player_Avatar, Game_Player, Game_Deck, Player_Card, Theme_Avatar},
    generalizations={},
    metadata=None
)
