...
class ilp_Expression(ABC):
    ...
    def __init__(self, comment: str, ilp_Expression13: "ilp_ObjectiveFunctionExpression" = None, ilp_Expression: "ilp_BinaryExpression" = None, ilp_Expression8: "ilp_BinaryExpression" = None):
