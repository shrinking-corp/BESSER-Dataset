...
class henshin_Edge(GraphElement):
    ...
    def __init__(self, index: str, indexConstant: str, Edge: "henshin_Graph" = None, Edge44: "henshin_Node" = None, Edge46: "henshin_Node" = None, outgoing: "henshin_Node" = None, incoming: "henshin_Node" = None, henshin_Edge: "henshin_EReference" = None, edges: "henshin_Graph" = None):
        self.index = index
...
class henshin_Rule(Unit):
    ...
    def createEdge(self, henshin_source, henshin_type, henshin_target) :
...
class henshin_Module(NamedElement):
    ...
    def __init__(self, superModule: set["henshin_Module"] = None, Module4: "henshin_Module" = None, subModules: "henshin_Module" = None, henshin_Module: set["henshin_EPackage"] = None, henshin_Module7: set["henshin_Unit"] = None, henshin_Module9: set["henshin_Graph"] = None, Module: "henshin_Module" = None):
