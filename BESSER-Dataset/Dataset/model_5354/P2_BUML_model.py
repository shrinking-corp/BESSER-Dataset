...
p2_ProfileDefinition = Class(name="p2_ProfileDefinition")
ModelElement = Class(name="ModelElement")
p2_Repository = Class(name="p2_Repository")
p2_Configuration = Class(name="p2_Configuration")
p2_RepositoryList = Class(name="p2_RepositoryList")
...
p2_Requirement_m_setVersionRange: Method = Method(name="setVersionRange", parameters={Parameter(name='p2_segment', type=StringType), Parameter(name='p2_version', type=StringType)})
p2_Requirement.attributes={p2_Requirement_namespace, p2_Requirement_type, p2_Requirement_iD, p2_Requirement_optional, p2_Requirement_filter, p2_Requirement_greedy, p2_Requirement_versionRange, p2_Requirement_name}
...
p2_ProfileDefinition_m_setRequirements: Method = Method(name="setRequirements", parameters={Parameter(name='p2_requirements', type=StringType)})
p2_ProfileDefinition_m_setRepositories: Method = Method(name="setRepositories", parameters={Parameter(name='p2_repositories', type=StringType)})
...
p2_Configuration.attributes={p2_Configuration_oS, p2_Configuration_arch, p2_Configuration_wS}
...
domain_model = DomainModel(
    name="p2",
    types={p2_Requirement, p2_ProfileDefinition, ModelElement, p2_Repository, p2_Configuration, p2_RepositoryList, RepositoryType, VersionSegment, RequirementType},
    associations={requirements0, repositories1, repositories3},
    generalizations={gen_p2_ProfileDefinition_ModelElement, gen_p2_Repository_ModelElement, gen_p2_Configuration_ModelElement, gen_p2_Requirement_ModelElement, gen_p2_RepositoryList_ModelElement},
    metadata=None
)
