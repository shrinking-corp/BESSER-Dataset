...
Library_Management_System_Patron.attributes={Library_Management_System_Patron_Status, Library_Management_System_Patron_OtherResources, Library_Management_System_Patron_Magazines, Library_Management_System_Patron_SpecialStatus, Library_Management_System_Patron_Books}
...
Library_Management_System_Faculty.attributes={Library_Management_System_Faculty_FacultyName, Library_Management_System_Faculty_FacultyId}
...
Faculty_Reference: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="reference30", type=Library_Managment_System_Reference_UseCase, multiplicity=Multiplicity(0, 1))
    }
)
Librarian_Issue_fines: BinaryAssociation = BinaryAssociation(
    name="Librarian_Issue_fines",
    ends={
        Property(name="issue_fines32", type=Library_Managment_System_Issue_fines_UseCase, multiplicity=Multiplicity(0, 1)),
...
Librarian_Manage_Magazines: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="manage_Magazines34", type=Library_Managment_System_Manage_Magazines_UseCase, multiplicity=Multiplicity(0, 1)),
...
Librarian_Reshelving_books: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="reshelving_books36", type=Library_Managment_System_Reshelving_books_UseCase, multiplicity=Multiplicity(0, 1)),
        Property(name="librarian37", type=Librarian_Actor, multiplicity=Multiplicity(0, 1))
    }
)
Librarian_Ordering_new_resources: BinaryAssociation = BinaryAssociation(
    name="Librarian_Ordering_new_resources",
    ends={
        Property(name="ordering_new_resources38", type=Library_Managment_System_Ordering_new_resources_UseCase, multiplicity=Multiplicity(0, 1)),
...
Librarian_Assist_patrons_in_research: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="assist_patrons_in_research40", type=Library_Managment_System_Assist_patrons_in_research_UseCase, multiplicity=Multiplicity(0, 1)),
        Property(name="librarian41", type=Librarian_Actor, multiplicity=Multiplicity(0, 1))
    }
)
Librarian_Connect_to_holding_of_other_libraries: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="connect_to_holding_of_other_libraries42", type=Library_Managment_System_Connect_to_holding_of_other_libraries_UseCase, multiplicity=Multiplicity(0, 1)),
        Property(name="librarian43", type=Librarian_Actor, multiplicity=Multiplicity(0, 1))
    }
)
...
Faculty_Check_in___Return: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="check_in___Return22", type=Library_Managment_System_Check_in___Return_UseCase, multiplicity=Multiplicity(0, 1)),
...
Faculty_Check_out: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="check_out24", type=Library_Managment_System_Check_out_UseCase, multiplicity=Multiplicity(0, 1)),
...
Faculty_Requested: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="requested26", type=Library_Managment_System_Requested_UseCase, multiplicity=Multiplicity(0, 1)),
