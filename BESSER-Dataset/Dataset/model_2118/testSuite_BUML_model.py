...
# Classes
testing_TestCase = Class(name="testing_TestCase")
testing_TestSuite = Class(name="testing_TestSuite")
testing_TestCoverage = Class(name="testing_TestCoverage")
testing_Adapter = Class(name="testing_Adapter")
testing_Transition = Class(name="testing_Transition")
...
testing_TestCase.attributes={testing_TestCase_input, testing_TestCase_output}
...
testing_Transition.attributes={testing_Transition_name, testing_Transition_type}
...
domain_model = DomainModel(
    name="testing",
    types={testing_TestCase, testing_TestSuite, testing_TestCoverage, testing_Adapter, testing_Transition},
    associations={testCoverages0, adapter1, transitions3, testCases5},
    generalizations={},
    metadata=None
)
