...
class PetriNetModel_Transition:
    ...
    def __init__(self, name: str, PetriNetModel_Transition8: set["PetriNetModel_ArcPT"] = None, PetriNetModel_Transition11: set["PetriNetModel_ArcTP"] = None, PetriNetModel_Transition15: "PetriNetModel_ArcPT" = None, PetriNetModel_Transition: "PetriNetModel_PetriNet" = None, PetriNetModel_Transition24: "PetriNetModel_ArcTP" = None):
        self.name = name
