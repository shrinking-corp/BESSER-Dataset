...
class fSM_EnumerationLiteral:
    ...
    def __init__(self, name: str, fSM_EnumerationLiteral17: "fSM_EnumerationType" = None, fSM_EnumerationLiteral: "fSM_State" = None):
        self.name = name
...
class fSM_EnumerationType:
    ...
    def __init__(self, name: str, fSM_EnumerationType16: set["fSM_EnumerationLiteral"] = None, fSM_EnumerationType: "fSM_Model" = None, fSM_EnumerationType5: "fSM_FSM" = None):
        self.name = name
