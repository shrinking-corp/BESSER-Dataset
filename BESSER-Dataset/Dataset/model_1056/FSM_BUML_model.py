...
fSM_EnumerationType = Class(name="fSM_EnumerationType")
fSM_FSM = Class(name="fSM_FSM")
fSM_State = Class(name="fSM_State")
fSM_EnumerationLiteral = Class(name="fSM_EnumerationLiteral")
...
domain_model = DomainModel(
    name="fSM",
    types={fSM_Transition, fSM_Model, fSM_EnumerationType, fSM_FSM, fSM_State, fSM_EnumerationLiteral},
    associations={outgoingTransition10, target12, literals15, types0, fsm1, type3, ownedState6, literal8},
    generalizations={},
    metadata=None
)
