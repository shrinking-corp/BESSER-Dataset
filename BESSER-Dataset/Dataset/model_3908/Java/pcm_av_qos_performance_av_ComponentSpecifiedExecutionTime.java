...
public class pcm_av_qos_performance_av_ComponentSpecifiedExecutionTime extends SpecifiedExecutionTime {
    ...
    public pcm_av_qos_performance_av_ComponentSpecifiedExecutionTime(
    ) {
        super(
        );
    }
