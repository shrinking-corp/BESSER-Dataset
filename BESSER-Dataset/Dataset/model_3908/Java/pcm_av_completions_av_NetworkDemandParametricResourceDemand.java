...
public class pcm_av_completions_av_NetworkDemandParametricResourceDemand extends ParametricResourceDemand {
    ...
    public pcm_av_completions_av_NetworkDemandParametricResourceDemand(
    ) {
        super(
        );
    }
