...
public class pcm_av_reliability_av_ResourceTimeoutFailureType extends SoftwareInducedFailureType {
    ...
    public pcm_av_reliability_av_ResourceTimeoutFailureType(
    ) {
        super(
        );
    }
