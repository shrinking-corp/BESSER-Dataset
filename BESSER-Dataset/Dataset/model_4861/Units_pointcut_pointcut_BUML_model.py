...
# Classes
units_pc_pc_UnitCarryingElement = Class(name="units_pc_pc_UnitCarryingElement")
units_pc_pc_UnitMultiplication = Class(name="units_pc_pc_UnitMultiplication")
Unit = Class(name="Unit")
units_pc_pc_UnitPower = Class(name="units_pc_pc_UnitPower")
units_pc_pc_UnitLiteral = Class(name="units_pc_pc_UnitLiteral")
units_pc_pc_PointcutPointcut = Class(name="units_pc_pc_PointcutPointcut")
units_pc_pc_EObject = Class(name="units_pc_pc_EObject")
units_pc_pc_Pointcut = Class(name="units_pc_pc_Pointcut")
units_pc_pc_Unit = Class(name="units_pc_pc_Unit")
units_pc_pc_BaseUnit = Class(name="units_pc_pc_BaseUnit")
units_pc_pc_UnitRepository = Class(name="units_pc_pc_UnitRepository")
...
domain_model = DomainModel(
    name="units_pc_pc",
    types={units_pc_pc_UnitCarryingElement, units_pc_pc_UnitMultiplication, Unit, units_pc_pc_UnitPower, units_pc_pc_UnitLiteral, units_pc_pc_PointcutPointcut, units_pc_pc_EObject, units_pc_pc_Pointcut, units_pc_pc_Unit, units_pc_pc_BaseUnit, units_pc_pc_UnitRepository},
    associations={units1, units2, unit4, baseUnit6, children8, children9, unit0},
