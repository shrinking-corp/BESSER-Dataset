...
# Classes
smalluml_Classe = Class(name="smalluml_Classe")
ElementDiagramme = Class(name="ElementDiagramme")
ElementNomme = Class(name="ElementNomme")
smalluml_Attribut = Class(name="smalluml_Attribut")
smalluml_Methode = Class(name="smalluml_Methode")
smalluml_Type = Class(name="smalluml_Type", is_abstract=True)
smalluml_Enumeration = Class(name="smalluml_Enumeration")
Type = Class(name="Type")
smalluml_TypeDonnee = Class(name="smalluml_TypeDonnee")
smalluml_Association = Class(name="smalluml_Association")
smalluml_Cardinalite = Class(name="smalluml_Cardinalite")
smalluml_Chaine = Class(name="smalluml_Chaine")
smalluml_Entier = Class(name="smalluml_Entier")
smalluml_Booleen = Class(name="smalluml_Booleen")
smalluml_Diagramme = Class(name="smalluml_Diagramme")
smalluml_ElementDiagramme = Class(name="smalluml_ElementDiagramme", is_abstract=True)
smalluml_ElementNomme = Class(name="smalluml_ElementNomme", is_abstract=True)
...
smalluml_Cardinalite.attributes={smalluml_Cardinalite_multipliciteInf, smalluml_Cardinalite_multipliciteSup}
...
domain_model = DomainModel(
    name="smalluml",
    types={smalluml_Classe, ElementDiagramme, ElementNomme, smalluml_Attribut, smalluml_Methode, smalluml_Type, smalluml_Enumeration, Type, smalluml_TypeDonnee, smalluml_Association, smalluml_Cardinalite, smalluml_Chaine, smalluml_Entier, smalluml_Booleen, smalluml_Diagramme, smalluml_ElementDiagramme, smalluml_ElementNomme},
    associations={attributs0, methodes1, sousClasses4, superClasse7, type9, typeDeRetour11, parametres14, attributs17, cardinalites19, classe20, elementsDiagramme23, classe24, association27, enumeration30, typeDonnee32},
    generalizations={gen_smalluml_Methode_ElementNomme, gen_smalluml_Classe_ElementDiagramme, gen_smalluml_Classe_ElementNomme, gen_smalluml_Attribut_ElementNomme, gen_smalluml_Enumeration_Type, gen_smalluml_Enumeration_ElementDiagramme, gen_smalluml_Enumeration_ElementNomme, gen_smalluml_TypeDonnee_Type, gen_smalluml_TypeDonnee_ElementDiagramme, gen_smalluml_TypeDonnee_ElementNomme, gen_smalluml_Association_ElementDiagramme, gen_smalluml_Association_ElementNomme, gen_smalluml_Cardinalite_ElementNomme, gen_smalluml_Chaine_Type, gen_smalluml_Entier_Type, gen_smalluml_Booleen_Type, gen_smalluml_Diagramme_ElementDiagramme, gen_smalluml_Diagramme_ElementNomme},
    metadata=None
)
