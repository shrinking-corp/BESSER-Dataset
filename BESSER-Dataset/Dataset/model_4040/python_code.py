...
class ElementDiagramme:
    ...
    pass
class smalluml_Enumeration(ElementNomme, ElementDiagramme, Type):
...
class smalluml_Diagramme(ElementNomme, ElementDiagramme):
    ...
    pass
class smalluml_TypeDonnee(ElementNomme, ElementDiagramme, Type):
