...
class tdt4250_Course:
    ...
    def __init__(self, code: str, name: str, study_points: float, level: str, tdt4250_Course: "tdt4250_StudyProgram" = None, tdt4250_Course7: "tdt4250_Student" = None, tdt4250_Course13: "tdt4250_Specialisation" = None, tdt4250_Course16: "tdt4250_Specialisation" = None):
        self.code = code
        self.name = name
...
class tdt4250_Specialisation:
    ...
    def __init__(self, name: str, tdt4250_Specialisation: "tdt4250_StudyProgram" = None, tdt4250_Specialisation9: set["tdt4250_Student"] = None, tdt4250_Specialisation12: set["tdt4250_Course"] = None, tdt4250_Specialisation15: set["tdt4250_Course"] = None):
        self.name = name
...
class tdt4250_Student:
    ...
    def __init__(self, studentID: int, current_semester: int, tdt4250_Student6: set["tdt4250_Course"] = None, tdt4250_Student10: "tdt4250_Specialisation" = None, tdt4250_Student: "tdt4250_StudyProgram" = None):
...
class tdt4250_StudyProgram:
    ...
    def __init__(self, name: str, number_of_semesters: int, tdt4250_StudyProgram2: set["tdt4250_Specialisation"] = None, tdt4250_StudyProgram4: set["tdt4250_Course"] = None, tdt4250_StudyProgram: set["tdt4250_Student"] = None):
        self.name = name
