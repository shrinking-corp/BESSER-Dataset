...
Order.attributes={Order_ordered, Order_total, Order_number, Order_status, Order_shipped, Order_shipTo}
...
domain_model = DomainModel(
    name="_3B5cANplEemJabg8b_IyNA",
    types={Customer, Payment, ShoppingCart, Account, WebUser, Order, LineItem, Product, Class_, Interface_Interface, UserState, OrderStatus},
