...
# Classes
etricegen_SystemInstance = Class(name="etricegen_SystemInstance")
etricegen_Root = Class(name="etricegen_Root")
etricegen_AbstractInstance = Class(name="etricegen_AbstractInstance", is_abstract=True)
InstanceBase = Class(name="InstanceBase")
etricegen_PortInstance = Class(name="etricegen_PortInstance")
etricegen_SubSystemInstance = Class(name="etricegen_SubSystemInstance")
etricegen_RoomModel = Class(name="etricegen_RoomModel")
etricegen_ExpandedActorClass = Class(name="etricegen_ExpandedActorClass")
etricegen_DataClass = Class(name="etricegen_DataClass")
etricegen_ProtocolClass = Class(name="etricegen_ProtocolClass")
etricegen_ActorClass = Class(name="etricegen_ActorClass")
etricegen_EnumerationType = Class(name="etricegen_EnumerationType")
etricegen_SubSystemClass = Class(name="etricegen_SubSystemClass")
etricegen_OptionalActorInstance = Class(name="etricegen_OptionalActorInstance")
etricegen_WiredStructureClass = Class(name="etricegen_WiredStructureClass", is_abstract=True)
etricegen_InstanceBase = Class(name="etricegen_InstanceBase", is_abstract=True)
etricegen_ActorInterfaceInstance = Class(name="etricegen_ActorInterfaceInstance")
AbstractInstance = Class(name="AbstractInstance")
etricegen_ServiceImplInstance = Class(name="etricegen_ServiceImplInstance")
etricegen_StructureInstance = Class(name="etricegen_StructureInstance")
etricegen_SAPInstance = Class(name="etricegen_SAPInstance")
etricegen_SPPInstance = Class(name="etricegen_SPPInstance")
etricegen_BindingInstance = Class(name="etricegen_BindingInstance")
etricegen_ConnectionInstance = Class(name="etricegen_ConnectionInstance")
etricegen_ActorInstance = Class(name="etricegen_ActorInstance")
etricegen_InterfaceItemInstance = Class(name="etricegen_InterfaceItemInstance")
etricegen_LogicalSystem = Class(name="etricegen_LogicalSystem")
StructureInstance = Class(name="StructureInstance")
etricegen_ServiceImplementation = Class(name="etricegen_ServiceImplementation")
InterfaceItemInstance = Class(name="InterfaceItemInstance")
etricegen_Port = Class(name="etricegen_Port")
etricegen_Binding = Class(name="etricegen_Binding")
etricegen_SAP = Class(name="etricegen_SAP")
etricegen_SPP = Class(name="etricegen_SPP")
etricegen_LayerConnection = Class(name="etricegen_LayerConnection")
etricegen_Wire = Class(name="etricegen_Wire")
etricegen_OpenBinding = Class(name="etricegen_OpenBinding")
etricegen_OpenServiceConnection = Class(name="etricegen_OpenServiceConnection")
etricegen_WiredActorClass = Class(name="etricegen_WiredActorClass")
WiredStructureClass = Class(name="WiredStructureClass")
etricegen_WiredSubSystemClass = Class(name="etricegen_WiredSubSystemClass")
etricegen_GraphContainer = Class(name="etricegen_GraphContainer")
...
etricegen_Root_m_getReferencedModels: Method = Method(name="getReferencedModels", parameters={Parameter(name='etricegen_cls', type=StringType)}, type=StringType)
etricegen_Root_m_getReferencedProtocolClasses: Method = Method(name="getReferencedProtocolClasses", parameters={Parameter(name='etricegen_cls', type=StringType)}, type=StringType)
etricegen_Root_m_getReferencedDataClasses: Method = Method(name="getReferencedDataClasses", parameters={Parameter(name='etricegen_cls', type=StringType)}, type=StringType)
etricegen_Root_m_getReferencedEnumClasses: Method = Method(name="getReferencedEnumClasses", parameters={Parameter(name='etricegen_cls', type=StringType)}, type=StringType)
etricegen_Root_m_getReferencedActorClasses: Method = Method(name="getReferencedActorClasses", parameters={Parameter(name='etricegen_cls', type=StringType)}, type=StringType)
etricegen_Root_m_getExpandedActorClass: Method = Method(name="getExpandedActorClass", parameters={Parameter(name='etricegen_ai', type=StringType)}, type=StringType)
etricegen_Root_m_getExpandedActorClass: Method = Method(name="getExpandedActorClass", parameters={Parameter(name='etricegen_ac', type=StringType)}, type=StringType)
etricegen_Root_m_getInstance: Method = Method(name="getInstance", parameters={Parameter(name='etricegen_path', type=StringType)}, type=StringType)
etricegen_Root_m_getSubClasses: Method = Method(name="getSubClasses", parameters={Parameter(name='etricegen_ac', type=StringType)}, type=StringType)
...
etricegen_Root.methods={etricegen_Root_m_getReferencedModels, etricegen_Root_m_getExpandedActorClass, etricegen_Root_m_getInstance, etricegen_Root_m_getExpandedActorClass, etricegen_Root_m_getReferencedEnumClasses, etricegen_Root_m_getReferencedActorClasses, etricegen_Root_m_getSubClasses, etricegen_Root_m_getReferencedDataClasses, etricegen_Root_m_computeSubClasses, etricegen_Root_m_getReferencedProtocolClasses}
...
etricegen_SubSystemInstance_m_getThreadId: Method = Method(name="getThreadId", parameters={Parameter(name='etricegen_instance', type=StringType)}, type=IntegerType)
...
etricegen_ExpandedActorClass_m_getInterfaceItemLocalId: Method = Method(name="getInterfaceItemLocalId", parameters={Parameter(name='etricegen_ifitem', type=StringType)}, type=IntegerType)
...
etricegen_InstanceBase.attributes={etricegen_InstanceBase_path, etricegen_InstanceBase_name, etricegen_InstanceBase_objId, etricegen_InstanceBase_nObjIDs, etricegen_InstanceBase_threadId}
...
etricegen_InterfaceItemInstance.methods={etricegen_InterfaceItemInstance_m_getInterfaceItem, etricegen_InterfaceItemInstance_m_isSimple, etricegen_InterfaceItemInstance_m_isReplicated, etricegen_InterfaceItemInstance_m_isRelay}
...
etricegen_Wire.attributes={etricegen_Wire_path1, etricegen_Wire_path2, etricegen_Wire_dataDriven}
...
domain_model = DomainModel(
    name="etricegen",
    types={etricegen_SystemInstance, etricegen_Root, etricegen_AbstractInstance, InstanceBase, etricegen_PortInstance, etricegen_SubSystemInstance, etricegen_RoomModel, etricegen_ExpandedActorClass, etricegen_DataClass, etricegen_ProtocolClass, etricegen_ActorClass, etricegen_EnumerationType, etricegen_SubSystemClass, etricegen_OptionalActorInstance, etricegen_WiredStructureClass, etricegen_InstanceBase, etricegen_ActorInterfaceInstance, AbstractInstance, etricegen_ServiceImplInstance, etricegen_StructureInstance, etricegen_SAPInstance, etricegen_SPPInstance, etricegen_BindingInstance, etricegen_ConnectionInstance, etricegen_ActorInstance, etricegen_InterfaceItemInstance, etricegen_LogicalSystem, StructureInstance, etricegen_ServiceImplementation, InterfaceItemInstance, etricegen_Port, etricegen_Binding, etricegen_SAP, etricegen_SPP, etricegen_LayerConnection, etricegen_Wire, etricegen_OpenBinding, etricegen_OpenServiceConnection, etricegen_WiredActorClass, WiredStructureClass, etricegen_WiredSubSystemClass, etricegen_GraphContainer, PortKind},
    associations={systemInstances0, ports30, ownSubSystemInstances1, subSystemInstances3, models6, importedModels8, xpActorClasses11, dataClasses13, protocolClasses15, actorClasses17, enumClasses19, subSystemClasses21, optionalInstances23, optionalActorClasses25, wiredInstances28, subSystemClass60, actorClass31, providedServices33, optionalInstances35, instances38, saps40, spps42, services44, bindings47, connections49, allContainedInstances51, orderedIfItemInstances53, instances55, logicalSystem58, outgoing89, svcImpl91, actorClass63, actorClass66, requiredServices69, protocol72, peers76, port78, bindings80, ports81, binding82, sap84, spp86, incoming88, fromAI93, fromSPP96, toSPP97, connection99, wires101, openBindings103, providedServices105, requiredServices107, port110, protocol113, actorClass116, subSystemClass118, actorClass120, graphContainer123},
    generalizations={gen_etricegen_AbstractInstance_InstanceBase, gen_etricegen_ActorInstance_StructureInstance, gen_etricegen_ActorInterfaceInstance_AbstractInstance, gen_etricegen_StructureInstance_AbstractInstance, gen_etricegen_SystemInstance_InstanceBase, gen_etricegen_SubSystemInstance_StructureInstance, gen_etricegen_ServiceImplInstance_InterfaceItemInstance, gen_etricegen_OptionalActorInstance_StructureInstance, gen_etricegen_InterfaceItemInstance_InstanceBase, gen_etricegen_PortInstance_InterfaceItemInstance, gen_etricegen_SAPInstance_InterfaceItemInstance, gen_etricegen_SPPInstance_InstanceBase, gen_etricegen_WiredActorClass_WiredStructureClass, gen_etricegen_WiredSubSystemClass_WiredStructureClass},
    metadata=None
)
