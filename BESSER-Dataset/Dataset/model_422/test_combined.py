...
def test_assoc_association59_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b1 = UML2_Association()
    b2 = UML2_Association()
    _safe_set(a, 'UML2_Property60', b1)
    assert _is_linked(a, 'UML2_Property60', b1)
    if hasattr(b1, 'UML2_Association61'):
        assert _is_linked(b1, 'UML2_Association61', a)
    _safe_set(a, 'UML2_Property60', b2)
    assert _is_linked(a, 'UML2_Property60', b2)
    if hasattr(b1, 'UML2_Association61'):
        assert not _is_linked(b1, 'UML2_Association61', a)
    if hasattr(b2, 'UML2_Association61'):
        assert _is_linked(b2, 'UML2_Association61', a)
    _safe_set(a, 'UML2_Property60', None)
    assert not _is_linked(a, 'UML2_Property60', b2)
    if hasattr(b2, 'UML2_Association61'):
        assert not _is_linked(b2, 'UML2_Association61', a)


def test_assoc_bodyCondition66_link_reassign_clear():
    a = UML2_Operation(isQuery=True)
    b1 = UML2_Constraint()
    b2 = UML2_Constraint()
    _safe_set(a, 'UML2_Operation67', b1)
    assert _is_linked(a, 'UML2_Operation67', b1)
    if hasattr(b1, 'UML2_Constraint68'):
        assert _is_linked(b1, 'UML2_Constraint68', a)
    _safe_set(a, 'UML2_Operation67', b2)
    assert _is_linked(a, 'UML2_Operation67', b2)
    if hasattr(b1, 'UML2_Constraint68'):
        assert not _is_linked(b1, 'UML2_Constraint68', a)
    if hasattr(b2, 'UML2_Constraint68'):
        assert _is_linked(b2, 'UML2_Constraint68', a)
    _safe_set(a, 'UML2_Operation67', None)
    assert not _is_linked(a, 'UML2_Operation67', b2)
    if hasattr(b2, 'UML2_Constraint68'):
        assert not _is_linked(b2, 'UML2_Constraint68', a)
...
def test_assoc_classifier11_link_reassign_clear():
    ...
    _safe_set(a, 'UML2_Classifier12', b1)
    assert _is_linked(a, 'UML2_Classifier12', b1)
    if hasattr(b1, 'UML2_CreateObjectAction'):
        assert _is_linked(b1, 'UML2_CreateObjectAction', a)
    _safe_set(a, 'UML2_Classifier12', b2)
    assert _is_linked(a, 'UML2_Classifier12', b2)
    if hasattr(b1, 'UML2_CreateObjectAction'):
    ...
    _safe_set(a, 'UML2_Classifier12', None)
    assert not _is_linked(a, 'UML2_Classifier12', b2)
    if hasattr(b2, 'UML2_CreateObjectAction'):
        assert not _is_linked(b2, 'UML2_CreateObjectAction', a)


def test_assoc_classifier20_link_reassign_clear():
    a = UML2_Classifier(isAbstract=True)
    b1 = UML2_InstanceSpecification()
    b2 = UML2_InstanceSpecification()
    _safe_set(a, 'UML2_Classifier22', b1)
    assert _is_linked(a, 'UML2_Classifier22', b1)
    if hasattr(b1, 'UML2_InstanceSpecification21'):
        assert _is_linked(b1, 'UML2_InstanceSpecification21', a)
    _safe_set(a, 'UML2_Classifier22', b2)
    assert _is_linked(a, 'UML2_Classifier22', b2)
    if hasattr(b1, 'UML2_InstanceSpecification21'):
        assert not _is_linked(b1, 'UML2_InstanceSpecification21', a)
    if hasattr(b2, 'UML2_InstanceSpecification21'):
        assert _is_linked(b2, 'UML2_InstanceSpecification21', a)
    _safe_set(a, 'UML2_Classifier22', None)
    assert not _is_linked(a, 'UML2_Classifier22', b2)
    if hasattr(b2, 'UML2_InstanceSpecification21'):
        assert not _is_linked(b2, 'UML2_InstanceSpecification21', a)


def test_assoc_context_15_link_reassign_clear():
    a = UML2_Classifier(isAbstract=True)
    b1 = UML2_Action()
    b2 = UML2_Action()
...
def test_assoc_definingFeature35_link_reassign_clear():
    a = UML2_StructuralFeature(isReadOnly=True)
    b1 = UML2_Slot()
    b2 = UML2_Slot()
    _safe_set(a, 'UML2_StructuralFeature37', b1)
    assert _is_linked(a, 'UML2_StructuralFeature37', b1)
    if hasattr(b1, 'UML2_Slot36'):
        assert _is_linked(b1, 'UML2_Slot36', a)
    _safe_set(a, 'UML2_StructuralFeature37', b2)
    assert _is_linked(a, 'UML2_StructuralFeature37', b2)
    if hasattr(b1, 'UML2_Slot36'):
        assert not _is_linked(b1, 'UML2_Slot36', a)
    if hasattr(b2, 'UML2_Slot36'):
        assert _is_linked(b2, 'UML2_Slot36', a)
    _safe_set(a, 'UML2_StructuralFeature37', None)
    assert not _is_linked(a, 'UML2_StructuralFeature37', b2)
    if hasattr(b2, 'UML2_Slot36'):
        assert not _is_linked(b2, 'UML2_Slot36', a)
...
def test_assoc_end2_link_reassign_clear():
    ...
    if hasattr(b1, 'UML2_LinkEndData3'):
        assert _is_linked(b1, 'UML2_LinkEndData3', a)
    _safe_set(a, 'UML2_Property', b2)
    assert _is_linked(a, 'UML2_Property', b2)
    if hasattr(b1, 'UML2_LinkEndData3'):
        assert not _is_linked(b1, 'UML2_LinkEndData3', a)
    if hasattr(b2, 'UML2_LinkEndData3'):
        assert _is_linked(b2, 'UML2_LinkEndData3', a)
    _safe_set(a, 'UML2_Property', None)
    assert not _is_linked(a, 'UML2_Property', b2)
    if hasattr(b2, 'UML2_LinkEndData3'):
        assert not _is_linked(b2, 'UML2_LinkEndData3', a)


def test_assoc_feature46_link_reassign_clear():
    a = UML2_Feature(isStatic=True)
    b1 = UML2_Classifier(isAbstract=True)
    b2 = UML2_Classifier(isAbstract=False)
    _safe_set(a, 'UML2_Feature48', b1)
    assert _is_linked(a, 'UML2_Feature48', b1)
    if hasattr(b1, 'UML2_Classifier47'):
        assert _is_linked(b1, 'UML2_Classifier47', a)
    _safe_set(a, 'UML2_Feature48', b2)
    assert _is_linked(a, 'UML2_Feature48', b2)
    if hasattr(b1, 'UML2_Classifier47'):
        assert not _is_linked(b1, 'UML2_Classifier47', a)
    if hasattr(b2, 'UML2_Classifier47'):
        assert _is_linked(b2, 'UML2_Classifier47', a)
    _safe_set(a, 'UML2_Feature48', None)
    assert not _is_linked(a, 'UML2_Feature48', b2)
    if hasattr(b2, 'UML2_Classifier47'):
        assert not _is_linked(b2, 'UML2_Classifier47', a)


def test_assoc_featuringClassifier7_link_reassign_clear():
    a = UML2_Feature(isStatic=True)
    b1 = UML2_Classifier(isAbstract=True)
    b2 = UML2_Classifier(isAbstract=False)
    _safe_set(a, 'UML2_Feature', {b1})
    assert _is_linked(a, 'UML2_Feature', b1)
    if hasattr(b1, 'UML2_Classifier8'):
        assert _is_linked(b1, 'UML2_Classifier8', a)
    _safe_set(a, 'UML2_Feature', {b2})
    assert _is_linked(a, 'UML2_Feature', b2)
    if hasattr(b1, 'UML2_Classifier8'):
        assert not _is_linked(b1, 'UML2_Classifier8', a)
    if hasattr(b2, 'UML2_Classifier8'):
        assert _is_linked(b2, 'UML2_Classifier8', a)
    _safe_set(a, 'UML2_Feature', set())
    assert not _is_linked(a, 'UML2_Feature', b2)
    if hasattr(b2, 'UML2_Classifier8'):
        assert not _is_linked(b2, 'UML2_Classifier8', a)
...
def test_assoc_generalization51_link_reassign_clear():
    a = UML2_Classifier(isAbstract=True)
    b1 = UML2_Generalization()
    b2 = UML2_Generalization()
    _safe_set(a, 'UML2_Classifier52', {b1})
    assert _is_linked(a, 'UML2_Classifier52', b1)
    if hasattr(b1, 'UML2_Generalization53'):
        assert _is_linked(b1, 'UML2_Generalization53', a)
    _safe_set(a, 'UML2_Classifier52', {b2})
    assert _is_linked(a, 'UML2_Classifier52', b2)
    if hasattr(b1, 'UML2_Generalization53'):
        assert not _is_linked(b1, 'UML2_Generalization53', a)
    if hasattr(b2, 'UML2_Generalization53'):
        assert _is_linked(b2, 'UML2_Generalization53', a)
    _safe_set(a, 'UML2_Classifier52', set())
    assert not _is_linked(a, 'UML2_Classifier52', b2)
    if hasattr(b2, 'UML2_Generalization53'):
        assert not _is_linked(b2, 'UML2_Generalization53', a)


def test_assoc_inheritedMember49_link_reassign_clear():
    ...
    if hasattr(b1, 'UML2_Classifier50'):
        assert _is_linked(b1, 'UML2_Classifier50', a)
    _safe_set(a, 'UML2_NamedElement', b2)
    assert _is_linked(a, 'UML2_NamedElement', b2)
    if hasattr(b1, 'UML2_Classifier50'):
        assert not _is_linked(b1, 'UML2_Classifier50', a)
    if hasattr(b2, 'UML2_Classifier50'):
        assert _is_linked(b2, 'UML2_Classifier50', a)
    _safe_set(a, 'UML2_NamedElement', None)
    assert not _is_linked(a, 'UML2_NamedElement', b2)
    if hasattr(b2, 'UML2_Classifier50'):
        assert not _is_linked(b2, 'UML2_Classifier50', a)


def test_assoc_member76_link_reassign_clear():
    a = UML2_NamedElement(name="sample_text", visibility="sample_text")
    b1 = UML2_Namespace()
    b2 = UML2_Namespace()
    _safe_set(a, 'UML2_NamedElement77', b1)
    assert _is_linked(a, 'UML2_NamedElement77', b1)
    if hasattr(b1, 'UML2_Namespace'):
        assert _is_linked(b1, 'UML2_Namespace', a)
    _safe_set(a, 'UML2_NamedElement77', b2)
    assert _is_linked(a, 'UML2_NamedElement77', b2)
    if hasattr(b1, 'UML2_Namespace'):
        assert not _is_linked(b1, 'UML2_Namespace', a)
    if hasattr(b2, 'UML2_Namespace'):
        assert _is_linked(b2, 'UML2_Namespace', a)
    _safe_set(a, 'UML2_NamedElement77', None)
    assert not _is_linked(a, 'UML2_NamedElement77', b2)
    if hasattr(b2, 'UML2_Namespace'):
        assert not _is_linked(b2, 'UML2_Namespace', a)


def test_assoc_memberEnd30_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b1 = UML2_Association()
    b2 = UML2_Association()
    _safe_set(a, 'UML2_Property32', b1)
    assert _is_linked(a, 'UML2_Property32', b1)
    if hasattr(b1, 'UML2_Association31'):
        assert _is_linked(b1, 'UML2_Association31', a)
    _safe_set(a, 'UML2_Property32', b2)
    assert _is_linked(a, 'UML2_Property32', b2)
    if hasattr(b1, 'UML2_Association31'):
        assert not _is_linked(b1, 'UML2_Association31', a)
    if hasattr(b2, 'UML2_Association31'):
        assert _is_linked(b2, 'UML2_Association31', a)
    _safe_set(a, 'UML2_Property32', None)
    assert not _is_linked(a, 'UML2_Property32', b2)
    if hasattr(b2, 'UML2_Association31'):
        assert not _is_linked(b2, 'UML2_Association31', a)


def test_assoc_nestedClassifier78_link_reassign_clear():
    a = UML2_Classifier(isAbstract=True)
    b1 = UML2_Class(isActive=True)
    b2 = UML2_Class(isActive=False)
    _safe_set(a, 'UML2_Classifier79', b1)
    assert _is_linked(a, 'UML2_Classifier79', b1)
    if hasattr(b1, 'UML2_Class'):
        assert _is_linked(b1, 'UML2_Class', a)
    _safe_set(a, 'UML2_Classifier79', b2)
    assert _is_linked(a, 'UML2_Classifier79', b2)
    if hasattr(b1, 'UML2_Class'):
        assert not _is_linked(b1, 'UML2_Class', a)
    if hasattr(b2, 'UML2_Class'):
        assert _is_linked(b2, 'UML2_Class', a)
    _safe_set(a, 'UML2_Classifier79', None)
    assert not _is_linked(a, 'UML2_Classifier79', b2)
    if hasattr(b2, 'UML2_Class'):
        assert not _is_linked(b2, 'UML2_Class', a)


def test_assoc_ownedEnd28_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b1 = UML2_Association()
    b2 = UML2_Association()
...
def test_assoc_ownedParameter65_link_reassign_clear():
...
def test_assoc_ownedReception80_link_reassign_clear():
    a = UML2_Class(isActive=True)
    b1 = UML2_Reception()
    b2 = UML2_Reception()
    _safe_set(a, 'UML2_Class81', {b1})
    assert _is_linked(a, 'UML2_Class81', b1)
    if hasattr(b1, 'UML2_Reception'):
        assert _is_linked(b1, 'UML2_Reception', a)
    _safe_set(a, 'UML2_Class81', {b2})
    assert _is_linked(a, 'UML2_Class81', b2)
    if hasattr(b1, 'UML2_Reception'):
        assert not _is_linked(b1, 'UML2_Reception', a)
    if hasattr(b2, 'UML2_Reception'):
        assert _is_linked(b2, 'UML2_Reception', a)
    _safe_set(a, 'UML2_Class81', set())
    assert not _is_linked(a, 'UML2_Class81', b2)
    if hasattr(b2, 'UML2_Reception'):
        assert not _is_linked(b2, 'UML2_Reception', a)


def test_assoc_qualifier38_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b1 = UML2_QualifierValue()
    b2 = UML2_QualifierValue()
    _safe_set(a, 'UML2_Property40', b1)
    assert _is_linked(a, 'UML2_Property40', b1)
    if hasattr(b1, 'UML2_QualifierValue39'):
        assert _is_linked(b1, 'UML2_QualifierValue39', a)
    _safe_set(a, 'UML2_Property40', b2)
    assert _is_linked(a, 'UML2_Property40', b2)
    if hasattr(b1, 'UML2_QualifierValue39'):
        assert not _is_linked(b1, 'UML2_QualifierValue39', a)
    if hasattr(b2, 'UML2_QualifierValue39'):
        assert _is_linked(b2, 'UML2_QualifierValue39', a)
    _safe_set(a, 'UML2_Property40', None)
    assert not _is_linked(a, 'UML2_Property40', b2)
    if hasattr(b2, 'UML2_QualifierValue39'):
        assert not _is_linked(b2, 'UML2_QualifierValue39', a)


def test_assoc_qualifier63_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    ...
    _safe_set(a, 'UML2_Property62', {b1})
    assert _is_linked(a, 'UML2_Property62', b1)
    if hasattr(b1, 'UML2_Property64'):
        assert _is_linked(b1, 'UML2_Property64', a)
    _safe_set(a, 'UML2_Property62', {b2})
    assert _is_linked(a, 'UML2_Property62', b2)
    if hasattr(b1, 'UML2_Property64'):
        assert not _is_linked(b1, 'UML2_Property64', a)
    if hasattr(b2, 'UML2_Property64'):
        assert _is_linked(b2, 'UML2_Property64', a)
    _safe_set(a, 'UML2_Property62', set())
    assert not _is_linked(a, 'UML2_Property62', b2)
    if hasattr(b2, 'UML2_Property64'):
        assert not _is_linked(b2, 'UML2_Property64', a)


def test_assoc_structuralFeature25_link_reassign_clear():
    a = UML2_StructuralFeature(isReadOnly=True)
