...
# Classes
urml_Model = Class(name="urml_Model")
urml_Capsule = Class(name="urml_Capsule")
urml_Protocol = Class(name="urml_Protocol")
urml_LocalVar = Class(name="urml_LocalVar")
Assignable = Class(name="Assignable")
urml_Attribute = Class(name="urml_Attribute")
urml_Expression = Class(name="urml_Expression")
urml_Signal = Class(name="urml_Signal")
urml_Operation = Class(name="urml_Operation")
urml_StateMachine = Class(name="urml_StateMachine")
urml_OperationCode = Class(name="urml_OperationCode")
urml_Port = Class(name="urml_Port")
urml_TimerPort = Class(name="urml_TimerPort")
urml_LogPort = Class(name="urml_LogPort")
urml_CapsuleInst = Class(name="urml_CapsuleInst")
urml_Connector = Class(name="urml_Connector")
urml_Trigger_in = Class(name="urml_Trigger_in")
urml_IncomingVariable = Class(name="urml_IncomingVariable")
Identifiable = Class(name="Identifiable")
urml_Trigger_out = Class(name="urml_Trigger_out")
urml_StatementOperation = Class(name="urml_StatementOperation")
urml_WhileLoopOperation = Class(name="urml_WhileLoopOperation")
StatementOperation = Class(name="StatementOperation")
urml_State_ = Class(name="urml_State_")
urml_Transition = Class(name="urml_Transition")
urml_ActionCode = Class(name="urml_ActionCode")
urml_InformTimer = Class(name="urml_InformTimer")
urml_NoOp = Class(name="urml_NoOp")
urml_Invoke = Class(name="urml_Invoke")
urml_Assignment = Class(name="urml_Assignment")
urml_Assignable = Class(name="urml_Assignable")
urml_WhileLoop = Class(name="urml_WhileLoop")
urml_IfStatementOperation = Class(name="urml_IfStatementOperation")
urml_ReturnStatement = Class(name="urml_ReturnStatement")
urml_Statement = Class(name="urml_Statement")
urml_Variable = Class(name="urml_Variable")
Statement = Class(name="Statement")
urml_SendTrigger = Class(name="urml_SendTrigger")
urml_NotBooleanExpression = Class(name="urml_NotBooleanExpression")
Expression = Class(name="Expression")
urml_Literal = Class(name="urml_Literal")
urml_IntLiteral = Class(name="urml_IntLiteral")
Literal = Class(name="Literal")
urml_Identifier = Class(name="urml_Identifier")
urml_Identifiable = Class(name="urml_Identifiable")
urml_FunctionCall = Class(name="urml_FunctionCall")
urml_BoolLiteral = Class(name="urml_BoolLiteral")
urml_IfStatement = Class(name="urml_IfStatement")
urml_LogStatement = Class(name="urml_LogStatement")
urml_StringExpression = Class(name="urml_StringExpression")
urml_LessThan = Class(name="urml_LessThan")
urml_GreaterThanOrEqual = Class(name="urml_GreaterThanOrEqual")
urml_GreaterThan = Class(name="urml_GreaterThan")
urml_Equal = Class(name="urml_Equal")
urml_ConcatenateExpression = Class(name="urml_ConcatenateExpression")
StringExpression = Class(name="StringExpression")
urml_ConditionalOrExpression = Class(name="urml_ConditionalOrExpression")
urml_ConditionalAndExpression = Class(name="urml_ConditionalAndExpression")
urml_LessThanOrEqual = Class(name="urml_LessThanOrEqual")
urml_Minus = Class(name="urml_Minus")
urml_Multiply = Class(name="urml_Multiply")
urml_Divide = Class(name="urml_Divide")
urml_Modulo = Class(name="urml_Modulo")
urml_NotEqual = Class(name="urml_NotEqual")
urml_Plus = Class(name="urml_Plus")
urml_UnaryExpression = Class(name="urml_UnaryExpression")
...
urml_Operation.attributes={urml_Operation_isBool, urml_Operation_isInt, urml_Operation_name, urml_Operation_isVoid}
...
urml_State_.attributes={urml_State__name, urml_State__final}
...
urml_Identifiable.attributes={urml_Identifiable_isBool, urml_Identifiable_isInt, urml_Identifiable_name}
...
from_83: BinaryAssociation = BinaryAssociation(
    name="from_83",
    ends={
...
domain_model = DomainModel(
    name="urml",
    types={urml_Model, urml_Capsule, urml_Protocol, urml_LocalVar, Assignable, urml_Attribute, urml_Expression, urml_Signal, urml_Operation, urml_StateMachine, urml_OperationCode, urml_Port, urml_TimerPort, urml_LogPort, urml_CapsuleInst, urml_Connector, urml_Trigger_in, urml_IncomingVariable, Identifiable, urml_Trigger_out, urml_StatementOperation, urml_WhileLoopOperation, StatementOperation, urml_State_, urml_Transition, urml_ActionCode, urml_InformTimer, urml_NoOp, urml_Invoke, urml_Assignment, urml_Assignable, urml_WhileLoop, urml_IfStatementOperation, urml_ReturnStatement, urml_Statement, urml_Variable, Statement, urml_SendTrigger, urml_NotBooleanExpression, Expression, urml_Literal, urml_IntLiteral, Literal, urml_Identifier, urml_Identifiable, urml_FunctionCall, urml_BoolLiteral, urml_IfStatement, urml_LogStatement, urml_StringExpression, urml_LessThan, urml_GreaterThanOrEqual, urml_GreaterThan, urml_Equal, urml_ConcatenateExpression, StringExpression, urml_ConditionalOrExpression, urml_ConditionalAndExpression, urml_LessThanOrEqual, urml_Minus, urml_Multiply, urml_Divide, urml_Modulo, urml_NotEqual, urml_Plus, urml_UnaryExpression},
    associations={capsules0, protocols1, defaultValue3, incomingMessages4, operations27, statemachines29, LocalVars31, operationCode34, protocol36, capsuleInst139, port142, capsuleInst245, port248, type51, outgoingMessages6, LocalVars9, interfacePorts11, internalPorts13, timerPorts16, logPorts18, attributes20, capsuleInsts23, connectors25, guard72, triggers75, timerPort77, action80, from_83, signal86, parameters89, to91, signal93, parameters96, statements99, condition101, statements103, states54, transitions56, entryCode58, exitCode60, substatemachine63, from_66, to69, triggers123, timerPort125, time127, operation130, parameters132, lvalue135, exp136, condition106, thenStatements108, elseStatements111, returnValue114, statements116, var118, exp120, expr156, exp159, id161, call162, params164, condition139, statements141, condition144, thenStatements146, elseStatements149, logPort152, left154, left182, rest184, left187, rest189, left192, rest194, left197, rest199, left167, rest169, left172, rest174, left177, rest179, left217, rest219, left222, rest224, left227, rest229, left232, left202, rest204, left207, rest209, left212, rest214, rest234, exp237},
    generalizations={gen_urml_LocalVar_Assignable, gen_urml_Attribute_Assignable, gen_urml_IncomingVariable_Identifiable, gen_urml_WhileLoopOperation_StatementOperation, gen_urml_SendTrigger_Statement, gen_urml_InformTimer_StatementOperation, gen_urml_InformTimer_Statement, gen_urml_NoOp_StatementOperation, gen_urml_NoOp_Statement, gen_urml_Invoke_StatementOperation, gen_urml_Invoke_Statement, gen_urml_Assignment_StatementOperation, gen_urml_Assignment_Statement, gen_urml_Assignable_Identifiable, gen_urml_WhileLoop_Statement, gen_urml_IfStatementOperation_StatementOperation, gen_urml_ReturnStatement_StatementOperation, gen_urml_Variable_StatementOperation, gen_urml_Variable_Statement, gen_urml_SendTrigger_StatementOperation, gen_urml_NotBooleanExpression_Expression, gen_urml_Literal_Expression, gen_urml_IntLiteral_Literal, gen_urml_Identifier_Expression, gen_urml_FunctionCall_Literal, gen_urml_BoolLiteral_Literal, gen_urml_IfStatement_Statement, gen_urml_LogStatement_StatementOperation, gen_urml_LogStatement_Statement, gen_urml_LessThan_Expression, gen_urml_GreaterThanOrEqual_Expression, gen_urml_GreaterThan_Expression, gen_urml_Equal_Expression, gen_urml_ConcatenateExpression_StringExpression, gen_urml_ConditionalOrExpression_Expression, gen_urml_ConditionalAndExpression_Expression, gen_urml_LessThanOrEqual_Expression, gen_urml_Minus_Expression, gen_urml_Multiply_Expression, gen_urml_Divide_Expression, gen_urml_Modulo_Expression, gen_urml_NotEqual_Expression, gen_urml_Plus_Expression, gen_urml_UnaryExpression_Expression},
    metadata=None
)
