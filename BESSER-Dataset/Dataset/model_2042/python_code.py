...
class urml_StringExpression:
    ...
    def __init__(self, str: str, urml_StringExpression157: "urml_Expression" = None, urml_StringExpression: "urml_LogStatement" = None, urml_StringExpression168: "urml_ConcatenateExpression" = None, urml_StringExpression171: "urml_ConcatenateExpression" = None):
        self.str = str
...
class urml_Transition:
    ...
    def __init__(self, universal: bool, name: str, init: bool, urml_Transition73: "urml_Expression" = None, urml_Transition76: set["urml_Trigger_in"] = None, urml_Transition78: "urml_TimerPort" = None, urml_Transition81: "urml_ActionCode" = None, urml_Transition: "urml_StateMachine" = None, urml_Transition67: "urml_State_" = None, urml_Transition70: "urml_State_" = None):
...
class urml_State_:
    ...
    def __init__(self, final: bool, name: str, urml_State_: "urml_StateMachine" = None, urml_State_59: "urml_ActionCode" = None, urml_State_61: "urml_ActionCode" = None, urml_State_64: "urml_StateMachine" = None, urml_State_68: "urml_Transition" = None, urml_State_71: "urml_Transition" = None):
        self.final = final
        self.name = name
...
class urml_IfStatementOperation(StatementOperation):
    ...
    pass
class urml_SendTrigger(StatementOperation, Statement):

    pass
class urml_NoOp(StatementOperation, Statement):

    pass
class urml_Invoke(StatementOperation, Statement):

    pass
class urml_LogStatement(StatementOperation, Statement):

    pass
class urml_Assignment(StatementOperation, Statement):

    pass
class urml_Variable(StatementOperation, Statement):
...
class urml_ReturnStatement(StatementOperation):
    ...
    pass
class urml_InformTimer(StatementOperation, Statement):
...
class urml_CapsuleInst:
    ...
    def __init__(self, name: str, urml_CapsuleInst41: "urml_Connector" = None, urml_CapsuleInst47: "urml_Connector" = None, urml_CapsuleInst52: "urml_Capsule" = None, urml_CapsuleInst: "urml_Capsule" = None):
        self.name = name
...
class urml_Port:
    ...
    def __init__(self, conjugated: bool, name: str, urml_Port37: "urml_Protocol" = None, urml_Port44: "urml_Connector" = None, urml_Port50: "urml_Connector" = None, urml_Port: "urml_Capsule" = None, urml_Port15: "urml_Capsule" = None, urml_Port85: "urml_Trigger_in" = None, urml_Port92: "urml_Trigger_out" = None):
...
class urml_Operation:
    ...
    def __init__(self, isBool: bool, isInt: bool, isVoid: bool, name: str, urml_Operation: "urml_Capsule" = None, urml_Operation32: set["urml_LocalVar"] = None, urml_Operation35: "urml_OperationCode" = None, urml_Operation163: "urml_FunctionCall" = None, urml_Operation131: "urml_Invoke" = None):
        self.isBool = isBool
        self.isInt = isInt
        self.isVoid = isVoid
        self.name = name
...
class urml_Protocol:
    ...
    def __init__(self, name: str, urml_Protocol5: set["urml_Signal"] = None, urml_Protocol38: "urml_Port" = None, urml_Protocol7: set["urml_Signal"] = None, urml_Protocol: "urml_Model" = None):
        self.name = name
...
class urml_Capsule:
    ...
    def __init__(self, root: bool, name: str, urml_Capsule28: set["urml_Operation"] = None, urml_Capsule30: set["urml_StateMachine"] = None, urml_Capsule53: "urml_CapsuleInst" = None, urml_Capsule12: set["urml_Port"] = None, urml_Capsule14: set["urml_Port"] = None, urml_Capsule17: set["urml_TimerPort"] = None, urml_Capsule19: set["urml_LogPort"] = None, urml_Capsule21: set["urml_Attribute"] = None, urml_Capsule24: set["urml_CapsuleInst"] = None, urml_Capsule26: set["urml_Connector"] = None, urml_Capsule: "urml_Model" = None):
        self.root = root
        self.name = name
