...
public class UnifiedMetamodel__Action  {
    ...
    public UnifiedMetamodel__Action(
        String name        ArrayList<UnifiedMetamodel__ActionCreator> unifiedmetamodel__actioncreators,        ArrayList<UnifiedMetamodel__ActionDispatcher> unifiedmetamodel__actiondispatchers    ) {
        this.name = name;
