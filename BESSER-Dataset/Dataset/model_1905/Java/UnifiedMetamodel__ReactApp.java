...
public class UnifiedMetamodel__ReactApp  {
    ...
    public UnifiedMetamodel__ReactApp(
        ArrayList<UnifiedMetamodel__Functionality> unifiedmetamodel__functionalitys,        ArrayList<UnifiedMetamodel__Directory> unifiedmetamodel__directorys,        ArrayList<UnifiedMetamodel__ModuleFront> unifiedmetamodel__modulefronts    ) {
