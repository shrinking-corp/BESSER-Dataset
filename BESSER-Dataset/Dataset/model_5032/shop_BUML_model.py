...
# Classes
shop_Product = Class(name="shop_Product")
shop_ProductCategory = Class(name="shop_ProductCategory")
shop_PriceCategory = Class(name="shop_PriceCategory")
shop_Customer = Class(name="shop_Customer")
shop_Order = Class(name="shop_Order")
shop_Transaction = Class(name="shop_Transaction")
...
shop_Product.attributes={shop_Product_number, shop_Product_description, shop_Product_name}
...
shop_Customer.attributes={shop_Customer_hotel, shop_Customer_address, shop_Customer_telephoneNr, shop_Customer_comments, shop_Customer_familyName, shop_Customer_surname}
...
shop_Transaction.attributes={shop_Transaction_endDate, shop_Transaction_paidDate, shop_Transaction_number, shop_Transaction_price, shop_Transaction_startDate}
...
domain_model = DomainModel(
    ...
    associations={productCategory0, priceCategory1, products2, subCategorys4, parent7, order11, product12, transactions9, customer10},
    generalizations={},
    metadata=None
)
