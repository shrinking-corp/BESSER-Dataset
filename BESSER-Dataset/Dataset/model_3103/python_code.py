...
class simpleUML_MM_Association:
    ...
    def __init__(self, name: str, simpleUML_MM_Association15: "simpleUML_MM_ClassModel" = None, simpleUML_MM_Association: "simpleUML_MM_Class" = None, simpleUML_MM_Association2: "simpleUML_MM_Class" = None):
        self.name = name
