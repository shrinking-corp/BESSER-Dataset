...
class optGrammar_MulDivMod(Expression):
    ...
    def __init__(self, multipliciativeOp: str, optGrammar_MulDivMod287: "optGrammar_Expression" = None, optGrammar_MulDivMod: "optGrammar_Expression" = None):
...
class optGrammar_Variable:
    ...
    def __init__(self, name: str, optGrammar_Variable: "optGrammar_ReturnParameterDeclaration" = None, optGrammar_Variable235: "optGrammar_VariableDeclarationExpression" = None, optGrammar_Variable212: "optGrammar_StandardVariableDeclaration" = None, optGrammar_Variable217: "optGrammar_VarVariableTypeDeclaration" = None):
        self.name = name
...
class optGrammar_Contract:
    ...
    def __init__(self, name: str, optGrammar_Contract26: "optGrammar_InheritanceSpecifier" = None, optGrammar_Contract12: set["optGrammar_DefinitionBody"] = None, optGrammar_Contract: "optGrammar_Model" = None, optGrammar_Contract10: set["optGrammar_InheritanceSpecifier"] = None, optGrammar_Contract162: "optGrammar_NewExpression" = None):
        self.name = name
...
class optGrammar_StateMutability:
    ...
    def __init__(self, type: str, optGrammar_StateMutability39: "optGrammar_FunctionDefinition" = None, optGrammar_StateMutability: "optGrammar_ConstructorDefinition" = None):
        self.type = type
...
class optGrammar_ConstructorDefinition(DefinitionBody):
    ...
    def __init__(self, name: str, optGrammar_ConstructorDefinition21: set["optGrammar_VisibilityLiteral"] = None, optGrammar_ConstructorDefinition23: "optGrammar_Body" = None, optGrammar_ConstructorDefinition: "optGrammar_ParameterList" = None, optGrammar_ConstructorDefinition15: set["optGrammar_StateMutability"] = None, optGrammar_ConstructorDefinition17: set["optGrammar_Const"] = None, optGrammar_ConstructorDefinition19: set["optGrammar_ModifierInvocation"] = None):
        self.name = name
...
class optGrammar_SecondOperators:
    ...
    def __init__(self, operator: str, optGrammar_SecondOperators170: "optGrammar_PrimaryArithmetic" = None, optGrammar_SecondOperators: "optGrammar_ArithmeticOperations" = None):
...
class SimpleStatement:
    ...
    pass
class optGrammar_ExpressionStatement(SimpleStatement, SimpleStatement2):
...
class optGrammar_StandardVariableDeclaration(SimpleStatement, SimpleStatement2):
...
class optGrammar_VarVariableTypeDeclaration(SimpleStatement, SimpleStatement2):
...
class optGrammar_VarVariableTupleVariableDeclaration(SimpleStatement, SimpleStatement2):

    def __init__(self, semicolon: bool, optGrammar_VarVariableTupleVariableDeclaration224: "optGrammar_Expression" = None, optGrammar_VarVariableTupleVariableDeclaration: "optGrammar_Tuple" = None):
        self.semicolon = semicolon
...
class optGrammar_StandardTypeWithoutQualifiedIdentifier(SimpleStatement, SimpleStatement2):
...
class StandardType:
    ...
    pass
class optGrammar_Mapping(StandardTypeWithoutQualifiedIdentifier, StandardType):

    pass
class optGrammar_QualifiedIdentifier(Expression, StandardType):
...
class optGrammar_NamedType(StandardTypeWithoutQualifiedIdentifier, StandardType):
