...
domain_model = DomainModel(
    name="fsm",
    types={fsm_StateMachine, NamedElement, fsm_State, fsm_Transition, fsm_Variable, fsm_Guard, fsm_Action, fsm_NamedElement, fsm_NumberGuard, Guard, fsm_EqualNumberGuard, NumberGuard, fsm_AssignValueAction, Action, fsm_LessThanNumberGuard, fsm_GreaterThanNumberGuard, fsm_IncreaseValueAction, fsm_DecreaseValueAction, fsm_NumberVariable, Variable},
    associations={ownedStates0, initialState1, ownedTransitions2, variables4, owningFSM6, outgoingTransitions7, incomingTransitions8, source10, target12, guard14, action16, source18, target19},
