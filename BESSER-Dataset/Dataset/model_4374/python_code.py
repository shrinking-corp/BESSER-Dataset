...
class hydraconstraints_SimpleFeature(BoolOperandChoices):
    ...
    def isSimpleFeature(self, hydraconstraints_context, hydraconstraints_diagnostics) :
...
class hydraconstraints_MultipleFeature(NumOperandChoices):
    ...
    def isMultipleFeature(self, hydraconstraints_diagnostics, hydraconstraints_context) :
...
class hydraconstraints_Operand(ABC):
    ...
    def __init__(self):
        ...
        pass
    def evaluate(self, hydraconstraints_modelDirection, hydraconstraints_featureContext) :
...
class hydraconstraints_Model:
    ...
    def featureModelExists(self, hydraconstraints_diagnostics, hydraconstraints_context) :
