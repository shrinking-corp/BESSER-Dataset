...
smallJava_BoolConstant = Class(name="smallJava_BoolConstant")
...
domain_model = DomainModel(
    name="smallJava",
    types={smallJava_SJMethod, smallJava_SJParameter, smallJava_SJBlock, SJSymbol, smallJava_SJStatement, smallJava_SJReturn, SJStatement, smallJava_SJExpression, smallJava_SJVariableDeclaration, smallJava_SJIfStatement, smallJava_SJSymbol, smallJava_SJNamedElement, smallJava_SJAssignment, SJExpression, smallJava_SJProgram, smallJava_SJClass, SJNamedElement, smallJava_SJMember, smallJava_SJField, SJMember, smallJava_SJMemberSelection, smallJava_SJThis, smallJava_SJNull, smallJava_BoolConstant, smallJava_SJSymbolRef, smallJava_SJNew},
    associations={params9, body10, statements12, expression14, expression15, expression17, thenBlock19, elseBlock22, type25, left27, classes0, superclass2, members4, type6, type42, right29, receiver32, member34, args37, symbol40},
    generalizations={gen_smallJava_SJMethod_SJMember, gen_smallJava_SJParameter_SJSymbol, gen_smallJava_SJReturn_SJStatement, gen_smallJava_SJVariableDeclaration_SJStatement, gen_smallJava_SJVariableDeclaration_SJSymbol, gen_smallJava_SJIfStatement_SJStatement, gen_smallJava_SJSymbol_SJNamedElement, gen_smallJava_SJExpression_SJStatement, gen_smallJava_SJAssignment_SJExpression, gen_smallJava_SJClass_SJNamedElement, gen_smallJava_SJMember_SJNamedElement, gen_smallJava_SJField_SJMember, gen_smallJava_SJNew_SJExpression, gen_smallJava_SJMemberSelection_SJExpression, gen_smallJava_SJThis_SJExpression, gen_smallJava_SJNull_SJExpression, gen_smallJava_BoolConstant_SJExpression, gen_smallJava_SJSymbolRef_SJExpression},
    metadata=None
)
