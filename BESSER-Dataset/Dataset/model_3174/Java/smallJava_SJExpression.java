...
public class smallJava_SJExpression extends SJStatement {
    ...
    private smallJava_SJMemberSelection smalljava_sjmemberselection;
    ...
    public smallJava_SJMemberSelection getSmalljava_sjmemberselection() {
        return smalljava_sjmemberselection;
    }

    public void setSmalljava_sjmemberselection(smallJava_SJMemberSelection smalljava_sjmemberselection) {
        this.smalljava_sjmemberselection = smalljava_sjmemberselection;
    }
    public smallJava_SJMemberSelection getSmalljava_sjmemberselection() {
        return smalljava_sjmemberselection;
    }
