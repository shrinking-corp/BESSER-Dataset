...
class study_Semester:
    ...
    def __init__(self, semesterNumber: int, fallOrSpring: str, study_Semester: "study_StudyPlan" = None, study_Semester11: "study_Specialization" = None, study_Semester13: set["study_CourseSlot"] = None):
...
class study_Programme:
    ...
    def __init__(self, name: str, programmeCode: str, study_Programme: "study_Department" = None, study_Programme4: set["study_StudyPlan"] = None):
        self.name = name
