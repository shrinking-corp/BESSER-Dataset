...
class carnot_PoolSymbol(ISymbolContainer, ISwimlaneSymbol):
    ...
    def __init__(self, boundaryVisible: str, PoolSymbol: "carnot_DiagramType" = None, PoolSymbol200: "carnot_LaneSymbol" = None, parentPool: set["carnot_LaneSymbol"] = None, poolSymbols: "carnot_DiagramType" = None, carnot_PoolSymbol: "carnot_ProcessDefinitionType" = None):
...
class carnot_EventConditionTypeType(IMetaType):
    ...
    def __init__(self, implementation: str, panelClass: str, processCondition: str, pullEventEmitterClass: str, rule: str, activityCondition: str, binderClass: str, type178: set["carnot_EventHandlerType"] = None, EventConditionTypeType: "carnot_EventHandlerType" = None, carnot_EventConditionTypeType: "carnot_ModelType" = None):
...
class carnot_DataTypeType(IMetaType):
    ...
    def __init__(self, accessPathEditor: str, evaluator: str, instanceClass: str, panelClass: str, readable: str, storageStrategy: str, validatorClass: str, valueCreator: str, writable: str, carnot_DataTypeType: "carnot_AccessPointType" = None, carnot_DataTypeType212: "carnot_ModelType" = None, DataTypeType: "carnot_DataType" = None, type166: set["carnot_DataType"] = None):
...
class carnot_IConnectionSymbol(IGraphicalObject):
    ...
    def __init__(self, routing: str, sourceAnchor: str, targetAnchor: str, carnot_IConnectionSymbol: set["carnot_Coordinates"] = None):
...
class carnot_TransitionType(IIdentifiableModelElement):
    ...
    def __init__(self, condition: str, forkOnTraversal: str, TransitionType: "carnot_ActivityType" = None, TransitionType106: "carnot_ActivityType" = None, carnot_TransitionType: "carnot_ProcessDefinitionType" = None, TransitionType344: "carnot_TransitionConnectionType" = None, carnot_TransitionType346: "carnot_XmlTextNode" = None, outTransitions349: "carnot_ActivityType" = None, inTransitions352: "carnot_ActivityType" = None, transition: set["carnot_TransitionConnectionType"] = None):
...
class carnot_ProcessDefinitionType(IEventHandlerOwner, IIdentifiableModelElement):
    ...
    def __init__(self, defaultPriority: str, ProcessDefinitionType: "carnot_ActivityType" = None, carnot_ProcessDefinitionType285: set["carnot_TransitionType"] = None, carnot_ProcessDefinitionType287: set["carnot_TriggerType"] = None, carnot_ProcessDefinitionType: "carnot_ModelType" = None, carnot_ProcessDefinitionType278: "carnot_PoolSymbol" = None, carnot_ProcessDefinitionType289: set["carnot_DataPathType"] = None, carnot_ProcessDefinitionType291: set["carnot_DiagramType"] = None, implementationProcess: set["carnot_ActivityType"] = None, carnot_ProcessDefinitionType282: set["carnot_ActivityType"] = None, process: set["carnot_ProcessSymbolType"] = None, carnot_ProcessDefinitionType297: "carnot_FormalParametersType" = None, carnot_ProcessDefinitionType299: "FormalParameterMappingsType" = None, carnot_ProcessDefinitionType301: "carnot_IdRef" = None, ProcessDefinitionType304: "carnot_ProcessSymbolType" = None):
...
class carnot_DataPathType(IIdentifiableModelElement):
    ...
    def __init__(self, descriptor: str, key: str, dataPath: str, direction: str, dataPaths: "carnot_DataType" = None, DataPathType: "carnot_DataType" = None, carnot_DataPathType: "carnot_ProcessDefinitionType" = None):
...
class carnot_ApplicationType(ITypedElement, IIdentifiableModelElement, IAccessPointOwner):
    ...
    def __init__(self, interactive: str, ApplicationType: "carnot_ActivityType" = None, applications: "carnot_ApplicationTypeType" = None, ApplicationType117: "carnot_ApplicationSymbolType" = None, carnot_ApplicationType: set["carnot_ContextType"] = None, application: set["carnot_ActivityType"] = None, application123: set["carnot_ApplicationSymbolType"] = None, ApplicationType126: "carnot_ApplicationTypeType" = None, carnot_ApplicationType228: "carnot_ModelType" = None):
...
class carnot_ActivityType(IEventHandlerOwner, IIdentifiableModelElement):
    ...
    def __init__(self, join: str, loopCondition: str, allowsAbortByPerformer: str, hibernateOnCreation: str, implementation: str, loopType: str, split: str, subProcessMode: str, ActivityType83: "carnot_ActivitySymbolType" = None, ActivityType: "carnot_IModelParticipant" = None, carnot_ActivityType: set["carnot_DataMappingType"] = None, executedActivities: "carnot_ApplicationType" = None, executingActivities: "carnot_ProcessDefinitionType" = None, performedActivities: "carnot_IModelParticipant" = None, carnot_ActivityType98: "carnot_IModelParticipant" = None, activity: set["carnot_ActivitySymbolType"] = None, startActivity: set["carnot_StartEventSymbol"] = None, to103: set["carnot_TransitionType"] = None, from_105: set["carnot_TransitionType"] = None, carnot_ActivityType108: "carnot_IdRef" = None, carnot_ActivityType110: set["carnot_Code"] = None, ActivityType121: "carnot_ApplicationType" = None, ActivityType294: "carnot_ProcessDefinitionType" = None, carnot_ActivityType283: "carnot_ProcessDefinitionType" = None, ActivityType329: "carnot_StartEventSymbol" = None, ActivityType350: "carnot_TransitionType" = None, ActivityType353: "carnot_TransitionType" = None):
        self.join = join
...
class carnot_DataType(ITypedElement, IIdentifiableModelElement):
    ...
    def __init__(self, predefined: str, DataType: "carnot_ConditionalPerformerType" = None, DataType144: "carnot_DataMappingType" = None, DataType146: "carnot_DataPathType" = None, data161: set["carnot_DataPathType"] = None, data163: set["carnot_ParameterMappingType"] = None, carnot_DataType: "carnot_ExternalReferenceType" = None, DataType148: "carnot_DataSymbolType" = None, data: set["carnot_DataMappingType"] = None, data153: "carnot_DataTypeType" = None, data155: set["carnot_DataSymbolType"] = None, data158: set["carnot_ConditionalPerformerType"] = None, DataType167: "carnot_DataTypeType" = None, carnot_DataType225: "carnot_ModelType" = None, DataType265: "carnot_ParameterMappingType" = None):
...
class carnot_DescriptionType:
    ...
    def __init__(self, mixed: str, carnot_DescriptionType: "carnot_IIdentifiableModelElement" = None, carnot_DescriptionType209: "carnot_ModelType" = None, carnot_DescriptionType136: "carnot_ContextType" = None, carnot_DescriptionType371: "carnot_ViewType" = None):
        self.mixed = mixed
...
class carnot_LinkTypeType(IMetaType, IExtensibleElement):
    ...
    def __init__(self, sourceClass: str, sourceCardinality: str, targetRole: str, targetClass: str, sourceRole: str, targetCardinality: str, lineStyle: str, lineColor: str, sourceSymbol: str, targetSymbol: str, showRoleNames: str, showLinkTypeName: str, LinkTypeType: "carnot_GenericLinkConnectionType" = None, linkType: set["carnot_GenericLinkConnectionType"] = None, carnot_LinkTypeType: "carnot_ModelType" = None):
...
class carnot_IGraphicalObject(IModelElement):
    ...
    def __init__(self, borderColor: str, fillColor: str, style: str, from_: set["carnot_RefersToConnectionType"] = None, to: set["carnot_RefersToConnectionType"] = None, IGraphicalObject: "carnot_RefersToConnectionType" = None, IGraphicalObject313: "carnot_RefersToConnectionType" = None):
...
class carnot_DiagramType(ISymbolContainer, IModelElement, IExtensibleElement):
    ...
    def __init__(self, name: str, orientation: str, mode: str, diagram: set["carnot_PoolSymbol"] = None, carnot_DiagramType: "carnot_ModelType" = None, DiagramType: "carnot_PoolSymbol" = None, carnot_DiagramType292: "carnot_ProcessDefinitionType" = None):
        self.name = name
        self.orientation = orientation
        self.mode = mode
...
class carnot_ContextType(ITypedElement, IAccessPointOwner, IModelElement, IExtensibleElement):
...
class carnot_AttributeType:
    ...
    def __init__(self, mixed: str, group: str, any: str, name: str, type: str, value: str, carnot_AttributeType: "carnot_IExtensibleElement" = None, AttributeType: "carnot_IdentifiableReference" = None, carnot_AttributeType128: "carnot_XmlTextNode" = None, attribute: "carnot_IdentifiableReference" = None):
        self.mixed = mixed
        self.group = group
        self.any = any
        self.name = name
    ...
    def setAttributeValue(self, carnot_value, carnot_type):
...
class carnot_Coordinates:
    ...
    def __init__(self, yPos: str, xPos: str, carnot_Coordinates: "carnot_IConnectionSymbol" = None):
        self.yPos = yPos
        self.xPos = xPos
