...
public class carnot_INodeSymbol extends IGraphicalObject {
    ...
    public carnot_INodeSymbol(
        String yPos,        String height,        String shape,        String width,        String xPos    ) {
        super(
        );
        this.yPos = yPos;
        this.height = height;
    ...
    public carnot_INodeSymbol(
        String yPos,        String height,        String shape,        String width,        String xPos        ArrayList<carnot_GenericLinkConnectionType> carnot_genericlinkconnectiontypes,        ArrayList<carnot_GenericLinkConnectionType> carnot_genericlinkconnectiontypes    ) {
        this.yPos = yPos;
        this.height = height;
        this.shape = shape;
        this.width = width;
