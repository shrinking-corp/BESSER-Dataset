...
public class carnot_IConnectionSymbol extends IGraphicalObject {
    ...
    public carnot_IConnectionSymbol(
        String targetAnchor,        String sourceAnchor,        String routing    ) {
        super(
        );
    ...
    public carnot_IConnectionSymbol(
        String targetAnchor,        String sourceAnchor,        String routing        ArrayList<carnot_Coordinates> carnot_coordinatess    ) {
        this.targetAnchor = targetAnchor;
        this.sourceAnchor = sourceAnchor;
        this.routing = routing;
