...
public class carnot_ApplicationType extends ITypedElement, IIdentifiableModelElement, IAccessPointOwner {
    ...
    public carnot_ApplicationType(
        String interactive        ArrayList<carnot_ContextType> carnot_contexttypes,        ArrayList<carnot_ApplicationSymbolType> carnot_applicationsymboltypes,        ArrayList<carnot_ActivityType> carnot_activitytypes    ) {
        this.interactive = interactive;
