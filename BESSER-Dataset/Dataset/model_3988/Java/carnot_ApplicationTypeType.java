...
public class carnot_ApplicationTypeType extends IMetaType {
    ...
    public carnot_ApplicationTypeType(
        String synchronous,        String accessPointProviderClass,        String panelClass,        String validatorClass,        String instanceClass    ) {
        super(
        );
    ...
    public carnot_ApplicationTypeType(
        String synchronous,        String accessPointProviderClass,        String panelClass,        String validatorClass,        String instanceClass        ArrayList<carnot_ApplicationType> carnot_applicationtypes    ) {
        this.synchronous = synchronous;
        this.accessPointProviderClass = accessPointProviderClass;
        this.panelClass = panelClass;
        this.validatorClass = validatorClass;
