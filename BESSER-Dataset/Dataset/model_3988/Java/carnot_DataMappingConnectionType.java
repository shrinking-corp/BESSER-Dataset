...
public class carnot_DataMappingConnectionType extends IConnectionSymbol {
    ...
    private carnot_DataSymbolType carnot_datasymboltype;
    ...
    public carnot_DataMappingConnectionType(
    ) {
        super(
        );
    }
    ...
    public carnot_DataSymbolType getCarnot_datasymboltype() {
        return carnot_datasymboltype;
    }

    public void setCarnot_datasymboltype(carnot_DataSymbolType carnot_datasymboltype) {
        this.carnot_datasymboltype = carnot_datasymboltype;
    }
    public carnot_DataSymbolType getCarnot_datasymboltype() {
        return carnot_datasymboltype;
    }
