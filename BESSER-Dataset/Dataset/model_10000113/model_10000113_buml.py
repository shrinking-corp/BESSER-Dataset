...
GameLauncher.attributes={GameLauncher_blackjack, GameLauncher_login}
...
Card.attributes={Card_name, Card_valueHard, Card_suit, Card_avatar, Card_rank, Card_Count, Card_valueSoft}
...
GameView.attributes={GameView_bet, GameView_standButton, GameView_hitButton, GameView_splitButton, GameView_showStrategy, GameView_dealButton, GameView_doubleButton}
...
Player.attributes={Player_money, Player_profile, Player_hand}
...
PlayerView.attributes={PlayerView_busted, PlayerView_cardLabels, PlayerView_player, PlayerView_moneyBox, PlayerView_status, PlayerView_cardTotal}
...
BlackjackGame.attributes={BlackjackGame_bet, BlackjackGame_dealer, BlackjackGame_player, BlackjackGame_deck}
...
domain_model = DomainModel(
    name="_0eb880c1_13c7_4df7_8235_f3c4a9a34a2d",
    types={Hand, Profile, GameLauncher, LoginView, Card, Strategy, JButton, GameView, BasePlayer, User_Actor, UseCase_UseCase, JLabel, Player, Dealer, PlayerView, BlackjackGame, Deck},
    associations={LoginView_Profile2, GameLauncher_LoginView, Profile_Blackjack, Blackjack_GameView, Blackjack_Strategy, PlayerView_GameView, Player_Blackjack, Dealer_Blackjack, Blackjack_Deck, BasePlayer_PlayerView, Player_Profile, Dealer_Hand, Player_Hand, Hand_Card, Deck_Card},
    generalizations={},
    metadata=None
)
