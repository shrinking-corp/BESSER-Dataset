...
class Deck:
    ...
    def __init__(self, cards: Card, card28: set["Card"] = None, blackjack17: "BlackjackGame" = None):
        self.cards = cards
...
class BlackjackGame:
    ...
    def __init__(self, deck: Deck, dealer: Dealer, player: Player, bet: int, profile5: "Profile" = None, gameView6: "GameView" = None, strategy8: "Strategy" = None, player13: "Player" = None, dealer15: "Dealer" = None, deck216: "Deck" = None):
        self.deck = deck
        self.dealer = dealer
        self.player = player
        self.bet = bet
...
class Dealer:
    ...
    def __init__(self, hand: Hand, cardTotalLimit: int, hand22: "Hand" = None, blackjack14: "BlackjackGame" = None):
        self.hand = hand
...
class Player:
    ...
    def __init__(self, hand: Hand, profile: Profile, money: int, hand24: set["Hand"] = None, blackjack12: "BlackjackGame" = None, profile220: "Profile" = None):
        self.hand = hand
...
class GameView:
    ...
    def __init__(self, bet: JLabel, dealButton: JButton, hitButton: JButton, standButton: JButton, splitButton: JButton, doubleButton: JButton, showStrategy: bool, blackjack7: "BlackjackGame" = None, playerView11: set["PlayerView"] = None):
        self.bet = bet
...
class Card:
    ...
    def __init__(self, name: str, avatar: str, valueSoft: str, valueHard: str, suit: str, rank: str, Count: int, hand27: "Hand" = None, deck29: "Deck" = None):
        self.name = name
        self.avatar = avatar
...
class Profile:
    ...
    def __init__(self, username: str, money: int, loginView1: "LoginView" = None, blackjack4: "BlackjackGame" = None, player21: "Player" = None):
