...
class RDBMS_Column:
    ...
    def __init__(self, type: str, name: str, RDBMS_Column: "RDBMS_Table" = None, RDBMS_Column7: "RDBMS_Table" = None, RDBMS_Column10: "RDBMS_ForeignKey" = None):
        self.type = type
        self.name = name
...
class RDBMS_Table:
    ...
    def __init__(self, name: str, is_local: bool, RDBMS_Table: "RDBMS_Schema" = None, RDBMS_Table2: set["RDBMS_Column"] = None, RDBMS_Table4: set["RDBMS_ForeignKey"] = None, RDBMS_Table6: set["RDBMS_Column"] = None, RDBMS_Table13: "RDBMS_ForeignKey" = None):
        self.name = name
