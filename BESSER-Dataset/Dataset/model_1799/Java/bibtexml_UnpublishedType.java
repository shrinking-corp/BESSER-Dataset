...
public class bibtexml_UnpublishedType  {
    ...
    public bibtexml_UnpublishedType(
        String month,        String note,        String key,        String title,        String doi,        String url,        String crossref,        String year,        String author    ) {
        this.month = month;
        this.note = note;
        this.key = key;
        this.title = title;
