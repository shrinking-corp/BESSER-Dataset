...
class bibtexml_DocumentRoot:
    ...
    def __init__(self, mixed: str, address: str, booktitle: str, chapter: str, annote: str, author: str, howpublished: str, crossref: str, doi: str, edition: str, editor: str, institution: str, journal: str, key: str, note: str, number: str, organization: str, pages: str, month: str, title: str, type: str, publisher: str, school: str, series: str, url: str, volume: str, year: str, bibtexml_DocumentRoot: set["bibtexml_EStringToStringMapEntry"] = None, bibtexml_DocumentRoot29: set["bibtexml_EStringToStringMapEntry"] = None, bibtexml_DocumentRoot41: set["bibtexml_ConferenceType"] = None, bibtexml_DocumentRoot32: set["bibtexml_ArticleType"] = None, bibtexml_DocumentRoot35: set["bibtexml_BookType"] = None, bibtexml_DocumentRoot38: set["bibtexml_BookletType"] = None, bibtexml_DocumentRoot46: set["bibtexml_FileType"] = None, bibtexml_DocumentRoot48: set["bibtexml_InbookType"] = None, bibtexml_DocumentRoot44: set["bibtexml_BibTeXMLEntryType"] = None, bibtexml_DocumentRoot51: set["bibtexml_IncollectionType"] = None, bibtexml_DocumentRoot54: set["bibtexml_InproceedingsType"] = None, bibtexml_DocumentRoot57: set["bibtexml_ManualType"] = None, bibtexml_DocumentRoot60: set["bibtexml_MastersthesisType"] = None, bibtexml_DocumentRoot63: set["bibtexml_MiscType"] = None, bibtexml_DocumentRoot72: set["bibtexml_TechreportType"] = None, bibtexml_DocumentRoot75: set["bibtexml_UnpublishedType"] = None, bibtexml_DocumentRoot66: set["bibtexml_PhdthesisType"] = None, bibtexml_DocumentRoot69: set["bibtexml_ProceedingsType"] = None):
        self.mixed = mixed
...
class bibtexml_InproceedingsType:
    ...
    def __init__(self, title: str, booktitle: str, author: str, address: str, month: str, organization: str, publisher: str, note: str, year: str, editor: str, volume: str, number: str, series: str, pages: str, key: str, crossref: str, doi: str, url: str, bibtexml_InproceedingsType: "bibtexml_BibTeXMLEntriesClass" = None, bibtexml_InproceedingsType55: "bibtexml_DocumentRoot" = None):
        self.title = title
        self.booktitle = booktitle
        self.author = author
        self.address = address
...
class bibtexml_ProceedingsType:
    ...
    def __init__(self, crossref: str, doi: str, url: str, month: str, organization: str, publisher: str, note: str, key: str, year: str, volume: str, number: str, series: str, address: str, editor: str, title: str, bibtexml_ProceedingsType: "bibtexml_BibTeXMLEntriesClass" = None, bibtexml_ProceedingsType70: "bibtexml_DocumentRoot" = None):
        self.crossref = crossref
        self.doi = doi
        self.url = url
        self.month = month
...
class bibtexml_IncollectionType:
    ...
    def __init__(self, author: str, title: str, booktitle: str, publisher: str, year: str, pages: str, address: str, edition: str, month: str, editor: str, volume: str, number: str, series: str, type: str, chapter: str, note: str, key: str, crossref: str, doi: str, url: str, bibtexml_IncollectionType: "bibtexml_BibTeXMLEntriesClass" = None, bibtexml_IncollectionType52: "bibtexml_DocumentRoot" = None):
        self.author = author
        self.title = title
        self.booktitle = booktitle
        self.publisher = publisher
...
class bibtexml_InbookType:
    ...
    def __init__(self, author: str, editor: str, title: str, chapter: str, series: str, type: str, address: str, edition: str, month: str, pages: str, pages1: str, publisher: str, year: str, volume: str, number: str, note: str, key: str, crossref: str, doi: str, url: str, bibtexml_InbookType: "bibtexml_BibTeXMLEntriesClass" = None, bibtexml_InbookType49: "bibtexml_DocumentRoot" = None):
        self.author = author
        self.editor = editor
        self.title = title
        self.chapter = chapter
...
class bibtexml_PhdthesisType:
    ...
    def __init__(self, author: str, month: str, note: str, key: str, crossref: str, title: str, school: str, year: str, type: str, address: str, doi: str, url: str, bibtexml_PhdthesisType: "bibtexml_BibTeXMLEntriesClass" = None, bibtexml_PhdthesisType67: "bibtexml_DocumentRoot" = None):
        self.author = author
        self.month = month
        self.note = note
        self.key = key
...
class bibtexml_MastersthesisType:
    ...
    def __init__(self, author: str, address: str, month: str, note: str, key: str, crossref: str, title: str, school: str, year: str, type: str, doi: str, url: str, bibtexml_MastersthesisType: "bibtexml_BibTeXMLEntriesClass" = None, bibtexml_MastersthesisType61: "bibtexml_DocumentRoot" = None):
        self.author = author
        self.address = address
        self.month = month
        self.note = note
...
class bibtexml_MiscType:
    ...
    def __init__(self, month: str, year: str, note: str, key: str, author: str, title: str, howpublished: str, crossref: str, doi: str, url: str, bibtexml_MiscType: "bibtexml_BibTeXMLEntriesClass" = None, bibtexml_MiscType64: "bibtexml_DocumentRoot" = None):
        self.month = month
        self.year = year
        self.note = note
        self.key = key
...
class bibtexml_UnpublishedType:
    ...
    def __init__(self, author: str, key: str, crossref: str, doi: str, url: str, title: str, note: str, month: str, year: str, bibtexml_UnpublishedType: "bibtexml_BibTeXMLEntriesClass" = None, bibtexml_UnpublishedType76: "bibtexml_DocumentRoot" = None):
        self.author = author
        self.key = key
        self.crossref = crossref
        self.doi = doi
...
class bibtexml_ConferenceType:
    ...
    def __init__(self, year: str, editor: str, author: str, title: str, booktitle: str, month: str, organization: str, publisher: str, volume: str, number: str, series: str, pages: str, address: str, note: str, key: str, crossref: str, doi: str, url: str, bibtexml_ConferenceType: "bibtexml_BibTeXMLEntriesClass" = None, bibtexml_ConferenceType42: "bibtexml_DocumentRoot" = None):
        self.year = year
        self.editor = editor
        self.author = author
        self.title = title
...
class bibtexml_BookType:
    ...
    def __init__(self, publisher: str, year: str, volume: str, author: str, editor: str, title: str, crossref: str, doi: str, url: str, number: str, series: str, address: str, edition: str, month: str, note: str, key: str, bibtexml_BookType: "bibtexml_BibTeXMLEntriesClass" = None, bibtexml_BookType36: "bibtexml_DocumentRoot" = None):
        self.publisher = publisher
        self.year = year
        self.volume = volume
        self.author = author
...
class bibtexml_TechreportType:
    ...
    def __init__(self, institution: str, year: str, type: str, number: str, author: str, title: str, crossref: str, doi: str, url: str, address: str, month: str, note: str, key: str, bibtexml_TechreportType: "bibtexml_BibTeXMLEntriesClass" = None, bibtexml_TechreportType73: "bibtexml_DocumentRoot" = None):
        self.institution = institution
        self.year = year
        self.type = type
        self.number = number
...
class bibtexml_ManualType:
    ...
    def __init__(self, title: str, organization: str, address: str, edition: str, month: str, author: str, crossref: str, doi: str, url: str, year: str, note: str, key: str, bibtexml_ManualType: "bibtexml_BibTeXMLEntriesClass" = None, bibtexml_ManualType58: "bibtexml_DocumentRoot" = None):
        self.title = title
        self.organization = organization
        self.address = address
        self.edition = edition
...
class bibtexml_BookletType:
    ...
    def __init__(self, month: str, year: str, note: str, author: str, title: str, howpublished: str, address: str, key: str, crossref: str, doi: str, url: str, bibtexml_BookletType: "bibtexml_BibTeXMLEntriesClass" = None, bibtexml_BookletType39: "bibtexml_DocumentRoot" = None):
        self.month = month
        self.year = year
        self.note = note
        self.author = author
...
class bibtexml_ArticleType:
    ...
    def __init__(self, year: str, volume: str, number: str, author: str, title: str, journal: str, pages: str, month: str, note: str, key: str, crossref: str, doi: str, url: str, bibtexml_ArticleType: "bibtexml_BibTeXMLEntriesClass" = None, bibtexml_ArticleType33: "bibtexml_DocumentRoot" = None):
        self.year = year
        self.volume = volume
        self.number = number
        self.author = author
