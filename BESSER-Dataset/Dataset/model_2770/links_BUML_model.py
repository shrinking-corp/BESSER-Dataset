...
# Classes
links_RootNodeB = Class(name="links_RootNodeB")
links_Root_BA_Element_Link = Class(name="links_Root_BA_Element_Link")
links_ChildNodeA = Class(name="links_ChildNodeA")
links_ChildNodeB = Class(name="links_ChildNodeB")
links_Root = Class(name="links_Root")
links_Child_AB_Element_Link = Class(name="links_Child_AB_Element_Link")
links_RootNodeA = Class(name="links_RootNodeA")
...
domain_model = DomainModel(
    name="links",
    types={links_RootNodeB, links_Root_BA_Element_Link, links_ChildNodeA, links_ChildNodeB, links_Root, links_Child_AB_Element_Link, links_RootNodeA},
    associations={rootNodeBs3, rootBALinks5, ChildrenNodeA7, ChildrenB9, Root_BA_Feature_Link11, Child_AB_Feature_Link14, source_A17, childABElementLinks0, rootNodeAs1, target_B20, b23, a26},
    generalizations={},
    metadata=None
)
