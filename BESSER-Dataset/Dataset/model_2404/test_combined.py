...
def test_hyp_sql2003_trigger_is_not_abstract():
    assert not inspect.isabstract(SQL2003_Trigger)


def test_hyp_sql2003_trigger_constructor_exists():
    assert callable(SQL2003_Trigger.__init__)


def test_hyp_sql2003_trigger_constructor_args():
...
def test_hyp_sql2003_typedtable_is_not_abstract():
    assert not inspect.isabstract(SQL2003_TypedTable)


def test_hyp_sql2003_typedtable_constructor_exists():
    assert callable(SQL2003_TypedTable.__init__)


def test_hyp_sql2003_typedtable_constructor_args():
    sig = inspect.signature(SQL2003_TypedTable.__init__)
    params = list(sig.parameters.keys())



def test_hyp_sql2003_view_is_not_abstract():
    assert not inspect.isabstract(SQL2003_View)


def test_hyp_sql2003_view_constructor_exists():
    assert callable(SQL2003_View.__init__)


def test_hyp_sql2003_view_constructor_args():
    sig = inspect.signature(SQL2003_View.__init__)
    params = list(sig.parameters.keys())



def test_hyp_sql2003_structuralcomponent_is_not_abstract():
    assert not inspect.isabstract(SQL2003_StructuralComponent)


def test_hyp_sql2003_structuralcomponent_constructor_exists():
    assert callable(SQL2003_StructuralComponent.__init__)


def test_hyp_sql2003_structuralcomponent_constructor_args():
...
def test_hyp_sql2003_restriction_is_not_abstract():
    assert not inspect.isabstract(SQL2003_Restriction)


def test_hyp_sql2003_restriction_constructor_exists():
    assert callable(SQL2003_Restriction.__init__)


def test_hyp_sql2003_restriction_constructor_args():
...
def test_hyp_sql2003_uniqueconstraint_is_not_abstract():
    assert not inspect.isabstract(SQL2003_UniqueConstraint)


def test_hyp_sql2003_uniqueconstraint_constructor_exists():
    assert callable(SQL2003_UniqueConstraint.__init__)


def test_hyp_sql2003_uniqueconstraint_constructor_args():
    sig = inspect.signature(SQL2003_UniqueConstraint.__init__)
    params = list(sig.parameters.keys())



def test_hyp_sql2003_tablecheckconstraint_is_not_abstract():
    assert not inspect.isabstract(SQL2003_TableCheckConstraint)


def test_hyp_sql2003_tablecheckconstraint_constructor_exists():
    assert callable(SQL2003_TableCheckConstraint.__init__)


def test_hyp_sql2003_tablecheckconstraint_constructor_args():
...
def test_hyp_sql2003_referentialconstraint_is_not_abstract():
    assert not inspect.isabstract(SQL2003_ReferentialConstraint)


def test_hyp_sql2003_referentialconstraint_constructor_exists():
    assert callable(SQL2003_ReferentialConstraint.__init__)


def test_hyp_sql2003_referentialconstraint_constructor_args():
...
def test_hyp_sql2003_primarykey_is_not_abstract():
    assert not inspect.isabstract(SQL2003_PrimaryKey)


def test_hyp_sql2003_primarykey_constructor_exists():
    assert callable(SQL2003_PrimaryKey.__init__)


def test_hyp_sql2003_primarykey_constructor_args():
    sig = inspect.signature(SQL2003_PrimaryKey.__init__)
    params = list(sig.parameters.keys())



def test_hyp_sql2003_parameter_is_not_abstract():
    assert not inspect.isabstract(SQL2003_Parameter)


def test_hyp_sql2003_parameter_constructor_exists():
    assert callable(SQL2003_Parameter.__init__)


def test_hyp_sql2003_parameter_constructor_args():
...
def test_hyp_sql2003_methodparameter_is_not_abstract():
    assert not inspect.isabstract(SQL2003_MethodParameter)


def test_hyp_sql2003_methodparameter_constructor_exists():
    assert callable(SQL2003_MethodParameter.__init__)


def test_hyp_sql2003_methodparameter_constructor_args():
...
def test_hyp_sql2003_notnull_is_not_abstract():
    assert not inspect.isabstract(SQL2003_NotNull)


def test_hyp_sql2003_notnull_constructor_exists():
    assert callable(SQL2003_NotNull.__init__)


def test_hyp_sql2003_notnull_constructor_args():
    sig = inspect.signature(SQL2003_NotNull.__init__)
    params = list(sig.parameters.keys())



def test_hyp_sql2003_method_is_not_abstract():
    assert not inspect.isabstract(SQL2003_Method)


def test_hyp_sql2003_method_constructor_exists():
    assert callable(SQL2003_Method.__init__)


def test_hyp_sql2003_method_constructor_args():
...
def test_hyp_sql2003_feature_is_not_abstract():
    assert not inspect.isabstract(SQL2003_Feature)


def test_hyp_sql2003_feature_constructor_exists():
    assert callable(SQL2003_Feature.__init__)


def test_hyp_sql2003_feature_constructor_args():
...
def test_hyp_sql2003_distincttype_is_not_abstract():
    assert not inspect.isabstract(SQL2003_DistinctType)


def test_hyp_sql2003_distincttype_constructor_exists():
    assert callable(SQL2003_DistinctType.__init__)


def test_hyp_sql2003_distincttype_constructor_args():
...
def test_hyp_sql2003_procedure_is_not_abstract():
    assert not inspect.isabstract(SQL2003_Procedure)


def test_hyp_sql2003_procedure_constructor_exists():
    assert callable(SQL2003_Procedure.__init__)


def test_hyp_sql2003_procedure_constructor_args():
    sig = inspect.signature(SQL2003_Procedure.__init__)
    params = list(sig.parameters.keys())



def test_hyp_sql2003_function_is_not_abstract():
    assert not inspect.isabstract(SQL2003_Function)


def test_hyp_sql2003_function_constructor_exists():
    assert callable(SQL2003_Function.__init__)


def test_hyp_sql2003_function_constructor_args():
...
def test_hyp_sql2003_predefinedtype_is_not_abstract():
    assert not inspect.isabstract(SQL2003_PredefinedType)


def test_hyp_sql2003_predefinedtype_constructor_exists():
    assert callable(SQL2003_PredefinedType.__init__)


def test_hyp_sql2003_predefinedtype_constructor_args():
    sig = inspect.signature(SQL2003_PredefinedType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_sql2003_userdefinedtype_is_not_abstract():
    assert not inspect.isabstract(SQL2003_UserDefinedType)


def test_hyp_sql2003_userdefinedtype_constructor_exists():
    assert callable(SQL2003_UserDefinedType.__init__)


def test_hyp_sql2003_userdefinedtype_constructor_args():
...
def test_hyp_sql2003_constructedtype_is_not_abstract():
    assert not inspect.isabstract(SQL2003_ConstructedType)


def test_hyp_sql2003_constructedtype_constructor_exists():
    assert callable(SQL2003_ConstructedType.__init__)


def test_hyp_sql2003_constructedtype_constructor_args():
...
def test_hyp_sql2003_tableconstraint_is_not_abstract():
    assert not inspect.isabstract(SQL2003_TableConstraint)


def test_hyp_sql2003_tableconstraint_constructor_exists():
    assert callable(SQL2003_TableConstraint.__init__)


def test_hyp_sql2003_tableconstraint_constructor_args():
...
def test_hyp_sql2003_columnconstraint_is_not_abstract():
    assert not inspect.isabstract(SQL2003_ColumnConstraint)


def test_hyp_sql2003_columnconstraint_constructor_exists():
    assert callable(SQL2003_ColumnConstraint.__init__)


def test_hyp_sql2003_columnconstraint_constructor_args():
    sig = inspect.signature(SQL2003_ColumnConstraint.__init__)
    params = list(sig.parameters.keys())



def test_hyp_sql2003_table_is_not_abstract():
    assert not inspect.isabstract(SQL2003_Table)


def test_hyp_sql2003_table_constructor_exists():
    assert callable(SQL2003_Table.__init__)


def test_hyp_sql2003_table_constructor_args():
...
def test_hyp_sql2003_datatype_is_not_abstract():
    assert not inspect.isabstract(SQL2003_DataType)


def test_hyp_sql2003_datatype_constructor_exists():
    assert callable(SQL2003_DataType.__init__)


def test_hyp_sql2003_datatype_constructor_args():
...
def test_hyp_sql2003_referencetype_is_not_abstract():
    assert not inspect.isabstract(SQL2003_ReferenceType)


def test_hyp_sql2003_referencetype_constructor_exists():
    assert callable(SQL2003_ReferenceType.__init__)


def test_hyp_sql2003_referencetype_constructor_args():
    sig = inspect.signature(SQL2003_ReferenceType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_sql2003_row_is_not_abstract():
    assert not inspect.isabstract(SQL2003_ROW)


def test_hyp_sql2003_row_constructor_exists():
    assert callable(SQL2003_ROW.__init__)


def test_hyp_sql2003_row_constructor_args():
    sig = inspect.signature(SQL2003_ROW.__init__)
    params = list(sig.parameters.keys())



def test_hyp_sql2003_collectiontype_is_not_abstract():
    assert not inspect.isabstract(SQL2003_CollectionType)


def test_hyp_sql2003_collectiontype_constructor_exists():
    assert callable(SQL2003_CollectionType.__init__)


def test_hyp_sql2003_collectiontype_constructor_args():
...
def test_hyp_sql2003_intervalfeature_is_not_abstract():
    assert not inspect.isabstract(SQL2003_IntervalFeature)


def test_hyp_sql2003_intervalfeature_constructor_exists():
    assert callable(SQL2003_IntervalFeature.__init__)


def test_hyp_sql2003_intervalfeature_constructor_args():
...
def test_hyp_sql2003_stringfeature_is_not_abstract():
    assert not inspect.isabstract(SQL2003_StringFeature)


def test_hyp_sql2003_stringfeature_constructor_exists():
    assert callable(SQL2003_StringFeature.__init__)


def test_hyp_sql2003_stringfeature_constructor_args():
...
def test_hyp_sql2003_numericfeature_is_not_abstract():
    assert not inspect.isabstract(SQL2003_NumericFeature)


def test_hyp_sql2003_numericfeature_constructor_exists():
    assert callable(SQL2003_NumericFeature.__init__)


def test_hyp_sql2003_numericfeature_constructor_args():
...
def test_hyp_sql2003_datetimefeature_is_not_abstract():
    assert not inspect.isabstract(SQL2003_DatetimeFeature)


def test_hyp_sql2003_datetimefeature_constructor_exists():
    assert callable(SQL2003_DatetimeFeature.__init__)


def test_hyp_sql2003_datetimefeature_constructor_args():
...
def test_hyp_sql2003_datetimetype_is_not_abstract():
    assert not inspect.isabstract(SQL2003_DatetimeType)


def test_hyp_sql2003_datetimetype_constructor_exists():
    assert callable(SQL2003_DatetimeType.__init__)


def test_hyp_sql2003_datetimetype_constructor_args():
...
def test_hyp_sql2003_xmltype_is_not_abstract():
    assert not inspect.isabstract(SQL2003_XMLType)


def test_hyp_sql2003_xmltype_constructor_exists():
    assert callable(SQL2003_XMLType.__init__)


def test_hyp_sql2003_xmltype_constructor_args():
...
def test_hyp_sql2003_numerictype_is_not_abstract():
    assert not inspect.isabstract(SQL2003_NumericType)


def test_hyp_sql2003_numerictype_constructor_exists():
    assert callable(SQL2003_NumericType.__init__)


def test_hyp_sql2003_numerictype_constructor_args():
...
def test_hyp_sql2003_intervaltype_is_not_abstract():
    assert not inspect.isabstract(SQL2003_IntervalType)


def test_hyp_sql2003_intervaltype_constructor_exists():
    assert callable(SQL2003_IntervalType.__init__)


def test_hyp_sql2003_intervaltype_constructor_args():
...
def test_hyp_sql2003_binarystringtype_is_not_abstract():
    assert not inspect.isabstract(SQL2003_BinaryStringType)


def test_hyp_sql2003_binarystringtype_constructor_exists():
    assert callable(SQL2003_BinaryStringType.__init__)


def test_hyp_sql2003_binarystringtype_constructor_args():
...
def test_hyp_sql2003_parameterwithmode_is_not_abstract():
    assert not inspect.isabstract(SQL2003_ParameterWithMode)


def test_hyp_sql2003_parameterwithmode_constructor_exists():
    assert callable(SQL2003_ParameterWithMode.__init__)


def test_hyp_sql2003_parameterwithmode_constructor_args():
...
def test_hyp_sql2003_schema_is_not_abstract():
    assert not inspect.isabstract(SQL2003_Schema)


def test_hyp_sql2003_schema_constructor_exists():
    assert callable(SQL2003_Schema.__init__)


def test_hyp_sql2003_schema_constructor_args():
...
def test_hyp_sql2003_behaviouralcomponent_is_not_abstract():
    assert not inspect.isabstract(SQL2003_BehaviouralComponent)


def test_hyp_sql2003_behaviouralcomponent_constructor_exists():
    assert callable(SQL2003_BehaviouralComponent.__init__)


def test_hyp_sql2003_behaviouralcomponent_constructor_args():
...
def test_hyp_sql2003_derivedtable_is_not_abstract():
    assert not inspect.isabstract(SQL2003_DerivedTable)


def test_hyp_sql2003_derivedtable_constructor_exists():
    assert callable(SQL2003_DerivedTable.__init__)


def test_hyp_sql2003_derivedtable_constructor_args():
...
def test_hyp_sql2003_basetable_is_not_abstract():
    assert not inspect.isabstract(SQL2003_BaseTable)


def test_hyp_sql2003_basetable_constructor_exists():
    assert callable(SQL2003_BaseTable.__init__)


def test_hyp_sql2003_basetable_constructor_args():
    sig = inspect.signature(SQL2003_BaseTable.__init__)
    params = list(sig.parameters.keys())



def test_hyp_sql2003_structuredtype_is_not_abstract():
    assert not inspect.isabstract(SQL2003_StructuredType)


def test_hyp_sql2003_structuredtype_constructor_exists():
    assert callable(SQL2003_StructuredType.__init__)


def test_hyp_sql2003_structuredtype_constructor_args():
...
def test_hyp_sql2003_column_is_not_abstract():
    assert not inspect.isabstract(SQL2003_Column)


def test_hyp_sql2003_column_constructor_exists():
    assert callable(SQL2003_Column.__init__)


def test_hyp_sql2003_column_constructor_args():
...
def test_hyp_sql2003_field_is_not_abstract():
    assert not inspect.isabstract(SQL2003_Field)


def test_hyp_sql2003_field_constructor_exists():
    assert callable(SQL2003_Field.__init__)


def test_hyp_sql2003_field_constructor_args():
    sig = inspect.signature(SQL2003_Field.__init__)
    params = list(sig.parameters.keys())



def test_hyp_sql2003_attribute_is_not_abstract():
    assert not inspect.isabstract(SQL2003_Attribute)


def test_hyp_sql2003_attribute_constructor_exists():
    assert callable(SQL2003_Attribute.__init__)


def test_hyp_sql2003_attribute_constructor_args():
...
def test_hyp_sql2003_multiset_is_not_abstract():
    assert not inspect.isabstract(SQL2003_MULTISET)


def test_hyp_sql2003_multiset_constructor_exists():
    assert callable(SQL2003_MULTISET.__init__)


def test_hyp_sql2003_multiset_constructor_args():
    sig = inspect.signature(SQL2003_MULTISET.__init__)
    params = list(sig.parameters.keys())



def test_hyp_sql2003_array_is_not_abstract():
    assert not inspect.isabstract(SQL2003_ARRAY)


def test_hyp_sql2003_array_constructor_exists():
    assert callable(SQL2003_ARRAY.__init__)


def test_hyp_sql2003_array_constructor_args():
...
def test_hyp_sql2003_characterstringtype_is_not_abstract():
    assert not inspect.isabstract(SQL2003_CharacterStringType)


def test_hyp_sql2003_characterstringtype_constructor_exists():
    assert callable(SQL2003_CharacterStringType.__init__)


def test_hyp_sql2003_characterstringtype_constructor_args():
...
def test_hyp_sql2003_booleantype_is_not_abstract():
    assert not inspect.isabstract(SQL2003_BooleanType)


def test_hyp_sql2003_booleantype_constructor_exists():
    assert callable(SQL2003_BooleanType.__init__)


def test_hyp_sql2003_booleantype_constructor_args():
...
def test_hyp_sql2003_trigger_event_setter(instance):
...
@given(instance=SQL2003_Trigger_strategy)
def test_hyp_sql2003_trigger_actionTime_setter(instance):
...
@given(instance=SQL2003_Trigger_strategy)
def test_hyp_sql2003_trigger_name_setter(instance):
...
@given(instance=SQL2003_Trigger_strategy)
def test_hyp_sql2003_trigger_triggeredAction_setter(instance):
...
def test_hyp_sql2003_structuralcomponent_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_sql2003_restriction_NameColumns_setter(instance):
...
def test_hyp_sql2003_tablecheckconstraint_expression_setter(instance):
...
def test_hyp_sql2003_referentialconstraint_match_setter(instance):
...
@given(instance=SQL2003_ReferentialConstraint_strategy)
def test_hyp_sql2003_referentialconstraint_delete_action_setter(instance):
...
@given(instance=SQL2003_ReferentialConstraint_strategy)
def test_hyp_sql2003_referentialconstraint_update_action_setter(instance):
...
def test_hyp_sql2003_parameter_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_sql2003_method_body_setter(instance):
...
@given(instance=SQL2003_Method_strategy)
def test_hyp_sql2003_method_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_sql2003_userdefinedtype_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_sql2003_constructedtype_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_sql2003_tableconstraint_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_sql2003_table_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_sql2003_intervalfeature_value_setter(instance):
...
@given(instance=SQL2003_IntervalFeature_strategy)
def test_hyp_sql2003_intervalfeature_key_setter(instance):
...
def test_hyp_sql2003_stringfeature_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
@given(instance=SQL2003_StringFeature_strategy)
def test_hyp_sql2003_stringfeature_key_setter(instance):
    original = instance.key
    instance.key = original
    assert instance.key == original
...
def test_hyp_sql2003_numericfeature_key_setter(instance):
    original = instance.key
    instance.key = original
    assert instance.key == original
...
@given(instance=SQL2003_NumericFeature_strategy)
def test_hyp_sql2003_numericfeature_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_sql2003_datetimefeature_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
@given(instance=SQL2003_DatetimeFeature_strategy)
def test_hyp_sql2003_datetimefeature_key_setter(instance):
    original = instance.key
    instance.key = original
    assert instance.key == original
...
def test_hyp_sql2003_datetimetype_descriptor_setter(instance):
...
def test_hyp_sql2003_xmltype_descriptor_setter(instance):
    original = instance.descriptor
    instance.descriptor = original
    assert instance.descriptor == original
...
def test_hyp_sql2003_numerictype_descriptor_setter(instance):
    original = instance.descriptor
    instance.descriptor = original
    assert instance.descriptor == original
...
def test_hyp_sql2003_intervaltype_descriptor_setter(instance):
    original = instance.descriptor
    instance.descriptor = original
    assert instance.descriptor == original
...
def test_hyp_sql2003_binarystringtype_descriptor_setter(instance):
    original = instance.descriptor
    instance.descriptor = original
    assert instance.descriptor == original
...
@given(instance=SQL2003_BinaryStringType_strategy)
def test_hyp_sql2003_binarystringtype_length_def_setter(instance):
...
def test_hyp_sql2003_parameterwithmode_mode_setter(instance):
...
def test_hyp_sql2003_schema_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_sql2003_behaviouralcomponent_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=SQL2003_BehaviouralComponent_strategy)
def test_hyp_sql2003_behaviouralcomponent_body_setter(instance):
    original = instance.body
    instance.body = original
    assert instance.body == original
...
def test_hyp_sql2003_derivedtable_query_expression_setter(instance):
...
def test_hyp_sql2003_structuredtype_is_final_setter(instance):
...
@given(instance=SQL2003_StructuredType_strategy)
def test_hyp_sql2003_structuredtype_is_instantiable_setter(instance):
...
def test_hyp_sql2003_column_default_setter(instance):
...
def test_hyp_sql2003_attribute_default_setter(instance):
    original = instance.default
    instance.default = original
    assert instance.default == original
...
def test_hyp_sql2003_array_num_elements_setter(instance):
...
def test_hyp_sql2003_characterstringtype_descriptor_setter(instance):
    original = instance.descriptor
    instance.descriptor = original
    assert instance.descriptor == original
...
@given(instance=SQL2003_CharacterStringType_strategy)
def test_hyp_sql2003_characterstringtype_length_def_setter(instance):
    original = instance.length_def
    instance.length_def = original
    assert instance.length_def == original
...
def test_hyp_sql2003_booleantype_descriptor_setter(instance):
    original = instance.descriptor
    instance.descriptor = original
    assert instance.descriptor == original
...
def test_SQL2003_Restriction_NameColumns_value_roundtrip():
    instance = SQL2003_Restriction(NameColumns="sample_text")
    assert instance.NameColumns == "sample_text"
    instance.NameColumns = "sample_text_2"
    assert instance.NameColumns == "sample_text_2"
...
def test_assoc_columns39_link_reassign_clear():
    ...
    b1 = SQL2003_Restriction(NameColumns="sample_text")
    b2 = SQL2003_Restriction(NameColumns="sample_text_2")
...
SQL2003_Restriction_strategy = st.builds(SQL2003_Restriction, NameColumns=safe_text)
@given(instance=SQL2003_Restriction_strategy)
@settings(max_examples=25)
