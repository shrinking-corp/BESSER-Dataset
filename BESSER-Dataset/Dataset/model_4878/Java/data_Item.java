...
public class data_Item  {
    ...
    public data_Item(
        LocalDate created,        String uri,        String ident,        String stringValue,        LocalDate lastModified    ) {
    ...
    public data_Item(
        LocalDate created,        String uri,        String ident,        String stringValue,        LocalDate lastModified        ArrayList<data_Item> data_items,        ArrayList<data_MetaTag> data_metatags,        ArrayList<data_Identifier> data_identifiers    ) {
        this.created = created;
        this.uri = uri;
        this.ident = ident;
        this.stringValue = stringValue;
