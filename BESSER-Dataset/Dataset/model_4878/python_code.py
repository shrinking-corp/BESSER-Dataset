...
class data_Person(InformationObject):
    ...
    def __init__(self, lastname: str, firstname: str, dateOfBirth: date, title: str, leader: set["data_Organisation"] = None, participants: set["data_Organisation"] = None, author: set["data_Content"] = None, contributors: set["data_Content"] = None, data_Person: "data_Person" = None, data_Person6: set["data_Person"] = None, ranker: set["data_Ranking"] = None, Person30: "data_Content" = None, Person65: "data_Organisation" = None, Person67: "data_Organisation" = None, Person74: "data_Ranking" = None, Person: "data_Content" = None):
...
class data_InformationObject(Item):
    ...
    def __init__(self, name: str, tagged: set["data_Tag"] = None, data_InformationObject: set["data_Image"] = None, rankedInformationObject: set["data_StarRanking"] = None, informationObjects: set["data_MetaInformation"] = None, InformationObject: "data_Category" = None, InformationObject58: "data_Category" = None, InformationObject60: "data_Tag" = None, InformationObject79: "data_ViewRanking" = None, InformationObject77: "data_StarRanking" = None, rankedInformationObject14: set["data_ThumbRanking"] = None, rankedInformationObject16: set["data_ViewRanking"] = None, from_: set["data_Connection"] = None, to: set["data_Connection"] = None, data_InformationObject21: set["data_Binary"] = None, mainCategorized: "data_Category" = None, categorized: set["data_Category"] = None, InformationObject89: "data_MetaInformation" = None, InformationObject85: "data_Connection" = None, InformationObject87: "data_Connection" = None, InformationObject81: "data_ThumbRanking" = None):
        self.name = name
...
class data_IndoorLocation(MetaInformation):
    ...
    def __init__(self, name: str, IndoorLocation: "data_Location" = None, IndoorLocation97: "data_IndoorLocation" = None, parentIndoorLocation: set["data_IndoorLocation"] = None, indoorLocations: "data_Location" = None, IndoorLocation94: "data_IndoorLocation" = None, indoorLocations93: "data_IndoorLocation" = None):
        self.name = name
...
class data_WebSite(MetaInformation):
    ...
    def __init__(self, title: str, adress: str):
        self.title = title
        self.adress = adress
