...
entities_Import = Class(name="entities_Import")
...
entities_Reference = Class(name="entities_Reference")
...
domain_model = DomainModel(
    ...
    associations={imports0, elements1, extends4, properties5, type8, type7},
