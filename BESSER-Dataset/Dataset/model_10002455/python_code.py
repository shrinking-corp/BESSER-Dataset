...
class Patient:
    ...
    def __init__(self, age: int, sex: str, roomno: int, id: int, name: str, telno: int, address: str, doctors1: set["Doctor"] = None, room4: "Room" = None, bill8: "Bill" = None, receptionist10: "Receptionist" = None):
        self.age = age
        self.sex = sex
        self.roomno = roomno
        self.id = id
