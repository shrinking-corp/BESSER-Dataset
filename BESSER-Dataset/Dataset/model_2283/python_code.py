...
class University_Course:
    ...
    def __init__(self, name: str, courseNumber: int, courseType: str, University_Course: "University_Student" = None, University_Course2: "University_Professor" = None, University_Course5: "University_Course" = None, University_Course3: set["University_Course"] = None, University_Course7: set["University_Exam"] = None, University_Course9: "University_UniversityManagementSystem" = None):
        self.name = name
