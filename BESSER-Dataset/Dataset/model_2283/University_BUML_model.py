...
University_Exam = Class(name="University_Exam")
University_UniversityManagementSystem = Class(name="University_UniversityManagementSystem")
...
University_Person.attributes={University_Person_email, University_Person_name}
...
domain_model = DomainModel(
    name="University",
    types={University_Student, Person, University_Course, University_Person, University_Professor, University_Exam, University_UniversityManagementSystem, CourseType},
    associations={attends0, lectures1, mandatoryFor4, exam6, course8, person10},
