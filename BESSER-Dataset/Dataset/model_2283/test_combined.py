...
def test_hyp_university_universitymanagementsystem_is_not_abstract():
    assert not inspect.isabstract(University_UniversityManagementSystem)


def test_hyp_university_universitymanagementsystem_constructor_exists():
    assert callable(University_UniversityManagementSystem.__init__)


def test_hyp_university_universitymanagementsystem_constructor_args():
    sig = inspect.signature(University_UniversityManagementSystem.__init__)
    params = list(sig.parameters.keys())



def test_hyp_university_exam_is_not_abstract():
    assert not inspect.isabstract(University_Exam)


def test_hyp_university_exam_constructor_exists():
    assert callable(University_Exam.__init__)


def test_hyp_university_exam_constructor_args():
...
def test_hyp_university_person_is_not_abstract():
    assert not inspect.isabstract(University_Person)


def test_hyp_university_person_constructor_exists():
    assert callable(University_Person.__init__)


def test_hyp_university_person_constructor_args():
...
def test_hyp_university_exam_examID_setter(instance):
...
def test_hyp_university_person_name_setter(instance):
...
@given(instance=University_Person_strategy)
def test_hyp_university_person_email_setter(instance):
...
@given(instance=University_Course_strategy)
def test_hyp_university_course_courseNumber_setter(instance):
...
@given(instance=University_Course_strategy)
def test_hyp_university_course_courseType_setter(instance):
...
def test_hyp_university_professor_employeeNumber_setter(instance):
...
def test_hyp_university_student_matriculationNumber_setter(instance):
