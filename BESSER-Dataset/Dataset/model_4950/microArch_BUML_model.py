...
micro_Service.attributes={micro_Service_port, micro_Service_shortname, micro_Service_fullname, micro_Service_description}
...
micro_Attribute.attributes={micro_Attribute_isId, micro_Attribute_isGenerated, micro_Attribute_isMany, micro_Attribute_name}
...
domain_model = DomainModel(
    name="micro",
    types={micro_MicroserviceArchitecture, NamedElement, micro_Service, micro_Model, micro_Attribute, micro_AggregateService, Service, micro_Operation, micro_API, micro_ViewService, micro_Event, micro_Saga, micro_NamedElement, micro_Command, micro_Info, micro_Step, micro_Data, micro_ReferenceAttribute, Attribute, micro_PrimitiveTypeAttribute, CRUDOperation, CommandType, AttributePrimitiveValue},
    associations={services0, attributes1, aggregateService2, operation3, api4, models5, replicateServices7, publish9, Saga10, model12, aggregateService14, events16, commands17, infos19, replyInfo21, api22, api23, dto25, api28, commands30, Steps32, Data35, model37, type39, ModelToView41},
