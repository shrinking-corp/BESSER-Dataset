...
class Families_Family:
    ...
    def __init__(self, lastName: str, familyMother: "Families_Mother" = None, familySon: set["Families_Son"] = None, familyDaughter: set["Families_Daughter"] = None, Family8: "Families_Son" = None, Family10: "Families_Daughter" = None, Family: "Families_Father" = None, Family6: "Families_Mother" = None, familyFather: "Families_Father" = None):
