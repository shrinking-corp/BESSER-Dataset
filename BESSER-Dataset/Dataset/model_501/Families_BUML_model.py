...
Families_Father = Class(name="Families_Father")
Families_Mother = Class(name="Families_Mother")
Families_Son = Class(name="Families_Son")
Families_Daughter = Class(name="Families_Daughter")
...
domain_model = DomainModel(
    name="Families",
    types={Member, Families_Family, Families_Father, Families_Mother, Families_Son, Families_Daughter, Families_Member},
    associations={familyFather4, familyMother5, father0, mother1, sons2, daughters3, familySon7, familyDaughter9},
