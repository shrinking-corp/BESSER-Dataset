...
Employee.attributes={Employee_Emp_Position, Employee_Emp_Address, Employee_Emp_Id, Employee_Emp_NIC, Employee_Emp_Department, Employee_Emp_Date_Of_Joint, Employee_Emp_Name, Employee_Emp_Salary, Employee_Emp_ContactNo, Employee_Emp_Email, Employee_Emp_DOB}
...
Salary.attributes={Salary_Sly_Increment, Salary_Sly_Basic, Salary_OverTime, Salary_Sly_Netgross, Salary_Sly_Decrement, Salary_Emp_Id}
...
Leave.attributes={Leave_Leave_Title, Leave_Leave_Status, Leave_Leave_ApplyDate, Leave_leave_id, Leave_Emp_Id, Leave_Leave_EndDate, Leave_Leave_StartDate, Leave_Leave_detail, Leave_Leave_NoOfDays}
...
Attendance.attributes={Attendance_Emp_id, Attendance_AttendTime, Attendance_Attend_date, Attendance_Leaving_Time}
...
domain_model = DomainModel(
    name="_1f6f7705_07d3_45a9_b5da_46401710179f",
