...
public class Leave  {
    ...
    public Leave(
        String Leave_Status,        LocalDate Leave_ApplyDate,        LocalDate Leave_StartDate,        int leave_id,        String Leave_Title,        int Leave_NoOfDays,        LocalDate Leave_EndDate,        int Emp_Id,        String Leave_detail    ) {
