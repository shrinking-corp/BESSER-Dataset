...
domain_model = DomainModel(
    name="uml",
    types={uml_Association, NamedElement, uml_Class, uml_Attribute, uml_NamedElement, uml_UMLSpecification},
    associations={src0, dst1, parent5, associations14, attrs7, type9, classes12},
