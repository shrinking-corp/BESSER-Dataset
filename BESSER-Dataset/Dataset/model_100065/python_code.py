...
class aggregator_p2view_MetadataRepositoryStructuredView:
    ...
    def __init__(self, loaded: bool, location: str, name: str, aggregator_p2view_MetadataRepositoryStructuredView110: "Properties" = None, aggregator_p2view_MetadataRepositoryStructuredView113: "p2view_aggregator_MetadataRepository" = None, aggregator_p2view_MetadataRepositoryStructuredView115: "RepositoryReferences" = None, aggregator_p2view_MetadataRepositoryStructuredView: "InstallableUnits" = None):
        self.loaded = loaded
...
class aggregator_Configuration(EnabledStatusProvider):
    ...
    def __init__(self, windowSystem: str, architecture: str, operatingSystem: str, aggregator_Configuration: "aggregator_Aggregation" = None, aggregator_Configuration36: "aggregator_MappedUnit" = None, aggregator_Configuration49: "aggregator_ValidConfigurationsRule" = None):
...
class aggregator_Contribution(StatusProvider, EnabledStatusProvider, IdentificationProvider, InfosProvider, DescriptionProvider):
