...
domain_model = DomainModel(
    name="crom_l1",
    types={crom_l1_NamedElement, crom_l1_ModelElement, NamedElement, crom_l1_Model, crom_l1_Relation, crom_l1_RigidType, crom_l1_AbstractRole, crom_l1_Player, crom_l1_Inheritance, crom_l1_NaturalInheritance, Inheritance, crom_l1_RelationTarget, Type, ModelElement, crom_l1_Group, Model, crom_l1_Parameter, TypedElement, crom_l1_Operation, crom_l1_Type, crom_l1_Attribute, RelationTarget, crom_l1_NaturalType, RigidType, Player, crom_l1_RoleType, AbstractRole, crom_l1_Fulfillment, Relation, crom_l1_TypedElement},
    associations={elements0, relations1, filled10, filler11, super13, sub14, incoming17, params3, owner4, owner5, attributes7, operations8, outgoing19, type22},
    generalizations={gen_crom_l1_ModelElement_NamedElement, gen_crom_l1_Fulfillment_Relation, gen_crom_l1_Inheritance_Relation, gen_crom_l1_NaturalInheritance_Inheritance, gen_crom_l1_RelationTarget_NamedElement, gen_crom_l1_RigidType_Type, gen_crom_l1_RigidType_ModelElement, gen_crom_l1_Group_ModelElement, gen_crom_l1_Group_Model, gen_crom_l1_Parameter_TypedElement, gen_crom_l1_Operation_TypedElement, gen_crom_l1_Attribute_TypedElement, gen_crom_l1_Type_RelationTarget, gen_crom_l1_NaturalType_RigidType, gen_crom_l1_NaturalType_Player, gen_crom_l1_RoleType_AbstractRole, gen_crom_l1_RoleType_RelationTarget, gen_crom_l1_TypedElement_NamedElement},
    metadata=None
)
