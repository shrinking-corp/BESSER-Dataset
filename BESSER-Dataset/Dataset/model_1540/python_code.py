...
class tp4_Researcher:
    ...
    def __init__(self, name: str, forName: str, Researcher: "tp4_Paper" = None, tp4_Researcher: set["tp4_Write"] = None, tp4_Researcher3: set["tp4_Review"] = None, authors: set["tp4_Paper"] = None, tp4_Researcher6: set["tp4_Skill"] = None, tp4_Researcher8: "tp4_Position" = None, tp4_Researcher27: "tp4_PublicationStructure" = None):
        self.name = name
...
class tp4_PublicationProcess(Named):
    ...
    def __init__(self, minTime: int, maxTime: int, tp4_PublicationProcess32: "tp4_PublicationSystem" = None, tp4_PublicationProcess17: "tp4_Progress" = None, tp4_PublicationProcess: set["tp4_Phases"] = None):
...
class tp4_Keyword(Named):
    ...
    def __init__(self, description: str, tp4_Keyword41: "tp4_PublicationSystem" = None, tp4_Keyword: "tp4_Paper" = None):
        self.description = description
