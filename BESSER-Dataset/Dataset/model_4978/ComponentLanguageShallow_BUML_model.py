...
# Classes
ComponentLanguageShallow_Component = Class(name="ComponentLanguageShallow_Component")
ComponentLanguageShallow_Port = Class(name="ComponentLanguageShallow_Port", is_abstract=True)
ComponentLanguageShallow_Connector = Class(name="ComponentLanguageShallow_Connector")
ComponentLanguageShallow_InPort = Class(name="ComponentLanguageShallow_InPort")
Port = Class(name="Port")
ComponentLanguageShallow_OutPort = Class(name="ComponentLanguageShallow_OutPort")
