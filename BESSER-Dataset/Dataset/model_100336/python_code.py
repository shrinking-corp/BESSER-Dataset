...
class ptnetLoLA_Node:
    ...
    def __init__(self, name: str, type: str, target: set["ptnetLoLA_Arc"] = None, source: set["ptnetLoLA_Arc"] = None, Node: "ptnetLoLA_Arc" = None, Node23: "ptnetLoLA_Arc" = None, ptnetLoLA_Node: "ptnetLoLA_Annotation" = None):
        self.name = name
        self.type = type
...
class ptnetLoLA_Place(Node):
    ...
    def __init__(self, token: int, finalMarking: int, ptnetLoLA_Place20: "ptnetLoLA_PlaceReference" = None, ptnetLoLA_Place: "ptnetLoLA_PtNet" = None):
        self.token = token
