...
ptnetLoLA_TransitionExt.attributes={ptnetLoLA_TransitionExt_probability, ptnetLoLA_TransitionExt_confidentiality, ptnetLoLA_TransitionExt_maxTime, ptnetLoLA_TransitionExt_minTime, ptnetLoLA_TransitionExt_cost}
...
domain_model = DomainModel(
    name="ptnetLoLA",
    types={ptnetLoLA_PtNet, ptnetLoLA_Transition, ptnetLoLA_Marking, ptnetLoLA_Place, Node, ptnetLoLA_Node, ptnetLoLA_Annotation, ptnetLoLA_Arc, ptnetLoLA_RefMarkedPlace, ptnetLoLA_PlaceReference, PlaceReference, ptnetLoLA_PlaceExt, Place, ptnetLoLA_ArcToPlace, Arc, ptnetLoLA_ArcToTransition, ptnetLoLA_TransitionExt, Transition, ptnetLoLA_ArcToPlaceExt, ArcToPlace, ptnetLoLA_ArcToTransitionExt, ArcToTransition, NodeType, Confidentiality},
    associations={places0, transitions1, annotation12, incoming14, outgoing15, initialMarking3, annotation5, arcs7, finalMarking9, source21, target22, places17, place19},
    generalizations={gen_ptnetLoLA_Place_Node, gen_ptnetLoLA_Transition_Node, gen_ptnetLoLA_RefMarkedPlace_PlaceReference, gen_ptnetLoLA_PlaceExt_Place, gen_ptnetLoLA_ArcToPlace_Arc, gen_ptnetLoLA_ArcToTransition_Arc, gen_ptnetLoLA_TransitionExt_Transition, gen_ptnetLoLA_ArcToPlaceExt_ArcToPlace, gen_ptnetLoLA_ArcToTransitionExt_ArcToTransition},
    metadata=None
)
