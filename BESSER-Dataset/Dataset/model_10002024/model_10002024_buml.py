...
domain_model = DomainModel(
    name="_k2qgkNrnEemQn9qHRgF9yg",
    types={post_attendance_external, student_Actor, faculty_Actor, _Component, parent_Actor, admin_Actor, FACULTY, STUDENT, PARENT, ADMIN, take_attendance_call_external, generate_class_wise_attendance_report_external, answer_attendance_call_external, view_subject_wise_attendance_external, view_cumiliative_attendance_external, login_external, logout_external, send_attendance_sms_external, recieve_attendance_sms_external, modify_list_of_students_external},
    associations={faculty_generate_class_wise_attendance_report, faculty_post_attendance, faculty_give_attendance, student_answer_attendance_call, student_view_subject_wise_attendance, student_view_cumiliative_attendance, student_login, student_logout, faculty_login, faculty_logout, admin_login, admin_logout, parent_view_subject_wise_attendance, faculty_send_attendance_sms, parent_recieve_attendance_sms, faculty_view_cumiliative_attendance, parent_view_cumiliative_attendance, parent_login, parent_logout, admin_modify_list_of_students, FACULTY_STUDENT, FACULTY_ADMIN, STUDENT_ADMIN, PARENT_ADMIN},
    generalizations={},
    metadata=None
)
