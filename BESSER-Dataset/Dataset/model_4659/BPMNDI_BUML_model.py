...
di_BPMNDiagram.attributes={di_BPMNDiagram_location, di_BPMNDiagram_featureModel, di_BPMNDiagram_phase, di_BPMNDiagram_version}
...
di_BPMNShape.attributes={di_BPMNShape_isExpanded, di_BPMNShape_isMarkerVisible, di_BPMNShape_participantBandKind, di_BPMNShape_isMessageVisible, di_BPMNShape_isHorizontal}
...
domain_model = DomainModel(
    name="di",
    types={di_DocumentRoot, di_EStringToStringMapEntry, di_BPMNLabel, di_BPMNDiagram, di_BPMNEdge, di_BPMNShape, di_DiagramElement, Diagram, di_BPMNLabelStyle, di_BPMNPlane, LabeledEdge, di_BaseElement, Label, Style, di_Font, Plane, LabeledShape, MessageVisibleKind, ParticipantBandKind},
    associations={xMLNSPrefixMap0, bPMNLabel8, xSISchemaLocation1, bPMNDiagram4, bPMNEdge6, bPMNShape14, sourceElement27, bPMNLabelStyle10, plane16, labelStyle19, bPMNPlane12, label22, bpmnElement25, label40, bpmnElement43, targetElement29, labelStyle32, font35, bpmnElement37, choreographyActivityShape47},
