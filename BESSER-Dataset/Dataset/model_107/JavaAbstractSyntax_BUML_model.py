...
# Classes
JavaAbstractSyntax_AST = Class(name="JavaAbstractSyntax_AST")
ASTNode = Class(name="ASTNode")
JavaAbstractSyntax_ASTNode = Class(name="JavaAbstractSyntax_ASTNode", is_abstract=True)
JavaAbstractSyntax_AnonymousClassDeclaration = Class(name="JavaAbstractSyntax_AnonymousClassDeclaration")
BodyDeclaration = Class(name="BodyDeclaration")
JavaAbstractSyntax_BodyDeclaration = Class(name="JavaAbstractSyntax_BodyDeclaration", is_abstract=True)
ExtendedModifier = Class(name="ExtendedModifier")
Javadoc = Class(name="Javadoc")
JavaAbstractSyntax_CatchClause = Class(name="JavaAbstractSyntax_CatchClause")
...
JavaAbstractSyntax_Expression = Class(name="JavaAbstractSyntax_Expression", is_abstract=True)
JavaAbstractSyntax_ImportDeclaration = Class(name="JavaAbstractSyntax_ImportDeclaration")
Name = Class(name="Name")
JavaAbstractSyntax_MemberRef = Class(name="JavaAbstractSyntax_MemberRef")
SimpleName = Class(name="SimpleName")
JavaAbstractSyntax_MemberValuePair = Class(name="JavaAbstractSyntax_MemberValuePair")
Expression = Class(name="Expression")
JavaAbstractSyntax_MethodRef = Class(name="JavaAbstractSyntax_MethodRef")
MethodRefParameter = Class(name="MethodRefParameter")
JavaAbstractSyntax_MethodRefParameter = Class(name="JavaAbstractSyntax_MethodRefParameter")
SingleVariableDeclaration = Class(name="SingleVariableDeclaration")
JavaAbstractSyntax_Comment = Class(name="JavaAbstractSyntax_Comment", is_abstract=True)
JavaAbstractSyntax_CompilationUnit = Class(name="JavaAbstractSyntax_CompilationUnit")
Comment = Class(name="Comment")
JavaAbstractSyntax_PackageDeclaration = Class(name="JavaAbstractSyntax_PackageDeclaration")
Annotation = Class(name="Annotation")
JavaAbstractSyntax_Statement = Class(name="JavaAbstractSyntax_Statement", is_abstract=True)
JavaAbstractSyntax_TagElement = Class(name="JavaAbstractSyntax_TagElement")
JavaAbstractSyntax_TextElement = Class(name="JavaAbstractSyntax_TextElement")
JavaAbstractSyntax_Type = Class(name="JavaAbstractSyntax_Type", is_abstract=True)
JavaAbstractSyntax_TypeParameter = Class(name="JavaAbstractSyntax_TypeParameter")
JavaAbstractSyntax_VariableDeclaration = Class(name="JavaAbstractSyntax_VariableDeclaration", is_abstract=True)
Type = Class(name="Type")
JavaAbstractSyntax_ExtendedModifier = Class(name="JavaAbstractSyntax_ExtendedModifier", is_abstract=True)
JavaAbstractSyntax_Modifier = Class(name="JavaAbstractSyntax_Modifier")
JavaAbstractSyntax_AnnotationTypeMemberDeclaration = Class(name="JavaAbstractSyntax_AnnotationTypeMemberDeclaration")
JavaAbstractSyntax_EnumConstantDeclaration = Class(name="JavaAbstractSyntax_EnumConstantDeclaration")
AnonymousClassDeclaration = Class(name="AnonymousClassDeclaration")
JavaAbstractSyntax_FieldDeclaration = Class(name="JavaAbstractSyntax_FieldDeclaration")
VariableDeclarationFragment = Class(name="VariableDeclarationFragment")
JavaAbstractSyntax_Initializer = Class(name="JavaAbstractSyntax_Initializer")
JavaAbstractSyntax_MethodDeclaration = Class(name="JavaAbstractSyntax_MethodDeclaration")
JavaAbstractSyntax_AbstractTypeDeclaration = Class(name="JavaAbstractSyntax_AbstractTypeDeclaration", is_abstract=True)
JavaAbstractSyntax_AnnotationTypeDeclaration = Class(name="JavaAbstractSyntax_AnnotationTypeDeclaration")
JavaAbstractSyntax_EnumDeclaration = Class(name="JavaAbstractSyntax_EnumDeclaration")
EnumConstantDeclaration = Class(name="EnumConstantDeclaration")
JavaAbstractSyntax_TypeDeclaration = Class(name="JavaAbstractSyntax_TypeDeclaration")
JavaAbstractSyntax_BlockComment = Class(name="JavaAbstractSyntax_BlockComment")
JavaAbstractSyntax_Javadoc = Class(name="JavaAbstractSyntax_Javadoc")
TagElement = Class(name="TagElement")
JavaAbstractSyntax_LineComment = Class(name="JavaAbstractSyntax_LineComment")
JavaAbstractSyntax_Annotation = Class(name="JavaAbstractSyntax_Annotation", is_abstract=True)
JavaAbstractSyntax_ArrayAccess = Class(name="JavaAbstractSyntax_ArrayAccess")
JavaAbstractSyntax_ArrayCreation = Class(name="JavaAbstractSyntax_ArrayCreation")
ArrayInitializer = Class(name="ArrayInitializer")
ArrayType = Class(name="ArrayType")
TypeParameter = Class(name="TypeParameter")
JavaAbstractSyntax_BooleanLiteral = Class(name="JavaAbstractSyntax_BooleanLiteral")
JavaAbstractSyntax_CastExpression = Class(name="JavaAbstractSyntax_CastExpression")
JavaAbstractSyntax_CharacterLiteral = Class(name="JavaAbstractSyntax_CharacterLiteral")
JavaAbstractSyntax_ClassInstanceCreation = Class(name="JavaAbstractSyntax_ClassInstanceCreation")
JavaAbstractSyntax_ArrayInitializer = Class(name="JavaAbstractSyntax_ArrayInitializer")
JavaAbstractSyntax_Assignment = Class(name="JavaAbstractSyntax_Assignment")
JavaAbstractSyntax_FieldAccess = Class(name="JavaAbstractSyntax_FieldAccess")
JavaAbstractSyntax_InfixExpression = Class(name="JavaAbstractSyntax_InfixExpression")
JavaAbstractSyntax_InstanceofExpression = Class(name="JavaAbstractSyntax_InstanceofExpression")
JavaAbstractSyntax_ConditionalExpression = Class(name="JavaAbstractSyntax_ConditionalExpression")
JavaAbstractSyntax_Name = Class(name="JavaAbstractSyntax_Name", is_abstract=True)
JavaAbstractSyntax_NullLiteral = Class(name="JavaAbstractSyntax_NullLiteral")
JavaAbstractSyntax_NumberLiteral = Class(name="JavaAbstractSyntax_NumberLiteral")
JavaAbstractSyntax_ParenthesizedExpression = Class(name="JavaAbstractSyntax_ParenthesizedExpression")
JavaAbstractSyntax_PostfixExpression = Class(name="JavaAbstractSyntax_PostfixExpression")
JavaAbstractSyntax_PrefixExpression = Class(name="JavaAbstractSyntax_PrefixExpression")
JavaAbstractSyntax_MethodInvocation = Class(name="JavaAbstractSyntax_MethodInvocation")
JavaAbstractSyntax_StringLiteral = Class(name="JavaAbstractSyntax_StringLiteral")
JavaAbstractSyntax_SuperFieldAccess = Class(name="JavaAbstractSyntax_SuperFieldAccess")
JavaAbstractSyntax_SuperMethodInvocation = Class(name="JavaAbstractSyntax_SuperMethodInvocation")
JavaAbstractSyntax_ThisExpression = Class(name="JavaAbstractSyntax_ThisExpression")
JavaAbstractSyntax_AssertStatement = Class(name="JavaAbstractSyntax_AssertStatement")
Statement = Class(name="Statement")
JavaAbstractSyntax_Block = Class(name="JavaAbstractSyntax_Block")
JavaAbstractSyntax_TypeLiteral = Class(name="JavaAbstractSyntax_TypeLiteral")
JavaAbstractSyntax_VariableDeclarationExpression = Class(name="JavaAbstractSyntax_VariableDeclarationExpression")
JavaAbstractSyntax_ContinueStatement = Class(name="JavaAbstractSyntax_ContinueStatement")
JavaAbstractSyntax_DoStatement = Class(name="JavaAbstractSyntax_DoStatement")
JavaAbstractSyntax_EmptyStatement = Class(name="JavaAbstractSyntax_EmptyStatement")
JavaAbstractSyntax_EnhancedForStatement = Class(name="JavaAbstractSyntax_EnhancedForStatement")
JavaAbstractSyntax_ExpressionStatement = Class(name="JavaAbstractSyntax_ExpressionStatement")
JavaAbstractSyntax_BreakStatement = Class(name="JavaAbstractSyntax_BreakStatement")
JavaAbstractSyntax_ConstructorInvocation = Class(name="JavaAbstractSyntax_ConstructorInvocation")
JavaAbstractSyntax_IfStatement = Class(name="JavaAbstractSyntax_IfStatement")
JavaAbstractSyntax_LabeledStatement = Class(name="JavaAbstractSyntax_LabeledStatement")
JavaAbstractSyntax_ForStatement = Class(name="JavaAbstractSyntax_ForStatement")
JavaAbstractSyntax_SwitchCase = Class(name="JavaAbstractSyntax_SwitchCase")
JavaAbstractSyntax_SwitchStatement = Class(name="JavaAbstractSyntax_SwitchStatement")
JavaAbstractSyntax_SynchronizedStatement = Class(name="JavaAbstractSyntax_SynchronizedStatement")
JavaAbstractSyntax_ReturnStatement = Class(name="JavaAbstractSyntax_ReturnStatement")
JavaAbstractSyntax_SuperConstructorInvocation = Class(name="JavaAbstractSyntax_SuperConstructorInvocation")
JavaAbstractSyntax_TryStatement = Class(name="JavaAbstractSyntax_TryStatement")
CatchClause = Class(name="CatchClause")
JavaAbstractSyntax_TypeDeclarationStatement = Class(name="JavaAbstractSyntax_TypeDeclarationStatement")
JavaAbstractSyntax_VariableDeclarationStatement = Class(name="JavaAbstractSyntax_VariableDeclarationStatement")
JavaAbstractSyntax_WhileStatement = Class(name="JavaAbstractSyntax_WhileStatement")
JavaAbstractSyntax_ThrowStatement = Class(name="JavaAbstractSyntax_ThrowStatement")
JavaAbstractSyntax_ParameterizedType = Class(name="JavaAbstractSyntax_ParameterizedType")
JavaAbstractSyntax_PrimitiveType = Class(name="JavaAbstractSyntax_PrimitiveType")
JavaAbstractSyntax_QualifiedType = Class(name="JavaAbstractSyntax_QualifiedType")
JavaAbstractSyntax_SimpleType = Class(name="JavaAbstractSyntax_SimpleType")
JavaAbstractSyntax_WildcardType = Class(name="JavaAbstractSyntax_WildcardType")
JavaAbstractSyntax_SingleVariableDeclaration = Class(name="JavaAbstractSyntax_SingleVariableDeclaration")
VariableDeclaration = Class(name="VariableDeclaration")
JavaAbstractSyntax_ArrayType = Class(name="JavaAbstractSyntax_ArrayType")
JavaAbstractSyntax_SimpleName = Class(name="JavaAbstractSyntax_SimpleName")
JavaAbstractSyntax_MarkerAnnotation = Class(name="JavaAbstractSyntax_MarkerAnnotation")
JavaAbstractSyntax_NormalAnnotation = Class(name="JavaAbstractSyntax_NormalAnnotation")
MemberValuePair = Class(name="MemberValuePair")
JavaAbstractSyntax_SingleMemberAnnotation = Class(name="JavaAbstractSyntax_SingleMemberAnnotation")
JavaAbstractSyntax_VariableDeclarationFragment = Class(name="JavaAbstractSyntax_VariableDeclarationFragment")
JavaAbstractSyntax_QualifiedName = Class(name="JavaAbstractSyntax_QualifiedName")
...
JavaAbstractSyntax_TagElement.attributes={JavaAbstractSyntax_TagElement_tagName, JavaAbstractSyntax_TagElement_nested}
...
JavaAbstractSyntax_Modifier.attributes={JavaAbstractSyntax_Modifier_abstract, JavaAbstractSyntax_Modifier_volatile, JavaAbstractSyntax_Modifier_protected, JavaAbstractSyntax_Modifier_transient, JavaAbstractSyntax_Modifier_strictfp, JavaAbstractSyntax_Modifier_none, JavaAbstractSyntax_Modifier_private, JavaAbstractSyntax_Modifier_final, JavaAbstractSyntax_Modifier_native, JavaAbstractSyntax_Modifier_synchronized, JavaAbstractSyntax_Modifier_public, JavaAbstractSyntax_Modifier_static}
...
JavaAbstractSyntax_MethodDeclaration.attributes={JavaAbstractSyntax_MethodDeclaration_constructor, JavaAbstractSyntax_MethodDeclaration_extraDimensions, JavaAbstractSyntax_MethodDeclaration_varargs}
...
finally_303: BinaryAssociation = BinaryAssociation(
    name="finally_303",
    ends={
...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={JavaAbstractSyntax_AST, ASTNode, JavaAbstractSyntax_ASTNode, JavaAbstractSyntax_AnonymousClassDeclaration, BodyDeclaration, JavaAbstractSyntax_BodyDeclaration, ExtendedModifier, Javadoc, JavaAbstractSyntax_CatchClause, Block, PackageDeclaration, ImportDeclaration, AbstractTypeDeclaration, JavaAbstractSyntax_Expression, JavaAbstractSyntax_ImportDeclaration, Name, JavaAbstractSyntax_MemberRef, SimpleName, JavaAbstractSyntax_MemberValuePair, Expression, JavaAbstractSyntax_MethodRef, MethodRefParameter, JavaAbstractSyntax_MethodRefParameter, SingleVariableDeclaration, JavaAbstractSyntax_Comment, JavaAbstractSyntax_CompilationUnit, Comment, JavaAbstractSyntax_PackageDeclaration, Annotation, JavaAbstractSyntax_Statement, JavaAbstractSyntax_TagElement, JavaAbstractSyntax_TextElement, JavaAbstractSyntax_Type, JavaAbstractSyntax_TypeParameter, JavaAbstractSyntax_VariableDeclaration, Type, JavaAbstractSyntax_ExtendedModifier, JavaAbstractSyntax_Modifier, JavaAbstractSyntax_AnnotationTypeMemberDeclaration, JavaAbstractSyntax_EnumConstantDeclaration, AnonymousClassDeclaration, JavaAbstractSyntax_FieldDeclaration, VariableDeclarationFragment, JavaAbstractSyntax_Initializer, JavaAbstractSyntax_MethodDeclaration, JavaAbstractSyntax_AbstractTypeDeclaration, JavaAbstractSyntax_AnnotationTypeDeclaration, JavaAbstractSyntax_EnumDeclaration, EnumConstantDeclaration, JavaAbstractSyntax_TypeDeclaration, JavaAbstractSyntax_BlockComment, JavaAbstractSyntax_Javadoc, TagElement, JavaAbstractSyntax_LineComment, JavaAbstractSyntax_Annotation, JavaAbstractSyntax_ArrayAccess, JavaAbstractSyntax_ArrayCreation, ArrayInitializer, ArrayType, TypeParameter, JavaAbstractSyntax_BooleanLiteral, JavaAbstractSyntax_CastExpression, JavaAbstractSyntax_CharacterLiteral, JavaAbstractSyntax_ClassInstanceCreation, JavaAbstractSyntax_ArrayInitializer, JavaAbstractSyntax_Assignment, JavaAbstractSyntax_FieldAccess, JavaAbstractSyntax_InfixExpression, JavaAbstractSyntax_InstanceofExpression, JavaAbstractSyntax_ConditionalExpression, JavaAbstractSyntax_Name, JavaAbstractSyntax_NullLiteral, JavaAbstractSyntax_NumberLiteral, JavaAbstractSyntax_ParenthesizedExpression, JavaAbstractSyntax_PostfixExpression, JavaAbstractSyntax_PrefixExpression, JavaAbstractSyntax_MethodInvocation, JavaAbstractSyntax_StringLiteral, JavaAbstractSyntax_SuperFieldAccess, JavaAbstractSyntax_SuperMethodInvocation, JavaAbstractSyntax_ThisExpression, JavaAbstractSyntax_AssertStatement, Statement, JavaAbstractSyntax_Block, JavaAbstractSyntax_TypeLiteral, JavaAbstractSyntax_VariableDeclarationExpression, JavaAbstractSyntax_ContinueStatement, JavaAbstractSyntax_DoStatement, JavaAbstractSyntax_EmptyStatement, JavaAbstractSyntax_EnhancedForStatement, JavaAbstractSyntax_ExpressionStatement, JavaAbstractSyntax_BreakStatement, JavaAbstractSyntax_ConstructorInvocation, JavaAbstractSyntax_IfStatement, JavaAbstractSyntax_LabeledStatement, JavaAbstractSyntax_ForStatement, JavaAbstractSyntax_SwitchCase, JavaAbstractSyntax_SwitchStatement, JavaAbstractSyntax_SynchronizedStatement, JavaAbstractSyntax_ReturnStatement, JavaAbstractSyntax_SuperConstructorInvocation, JavaAbstractSyntax_TryStatement, CatchClause, JavaAbstractSyntax_TypeDeclarationStatement, JavaAbstractSyntax_VariableDeclarationStatement, JavaAbstractSyntax_WhileStatement, JavaAbstractSyntax_ThrowStatement, JavaAbstractSyntax_ParameterizedType, JavaAbstractSyntax_PrimitiveType, JavaAbstractSyntax_QualifiedType, JavaAbstractSyntax_SimpleType, JavaAbstractSyntax_WildcardType, JavaAbstractSyntax_SingleVariableDeclaration, VariableDeclaration, JavaAbstractSyntax_ArrayType, JavaAbstractSyntax_SimpleName, JavaAbstractSyntax_MarkerAnnotation, JavaAbstractSyntax_NormalAnnotation, MemberValuePair, JavaAbstractSyntax_SingleMemberAnnotation, JavaAbstractSyntax_VariableDeclarationFragment, JavaAbstractSyntax_QualifiedName, AssignementOperatorKind, InfixExpressionOperatorKind, PostfixExpresssionOperatorKind, PrefixExpresssionOperatorKind},
    associations={root0, bodyDeclarations1, modifiers2, javadoc3, body5, package11, imports13, types15, name17, name18, qualifier19, name22, value24, name26, qualifier28, parameters31, exception6, alternateRoot8, comments10, annotations37, javadoc38, name41, fragments44, name46, typeBounds48, name33, type35, name58, default61, name63, type66, arguments69, anonymousClassDeclaration71, name73, fragments76, type77, body80, body82, name84, returnType87, initializer51, name53, bodyDeclarations56, superInterfaceTypes98, enumConstants100, superclassType102, superInterfaceTypes104, typeParameters107, tags110, typeName111, array113, index115, dimensions118, initializer120, type122, parameters90, thrownExceptions93, typeParameters96, expression131, type133, arguments136, anonymousClassDeclaration138, expression141, type144, typeArguments147, expressions124, leftHandSide126, rightHandSide128, expression158, name160, extendedOperands163, leftOperand165, rightOperand168, elseExpression150, expression152, thenExpression155, expression178, name181, typeArguments184, expression187, operand189, leftOperand171, rightOperand173, arguments176, name193, qualifier195, arguments198, name200, qualifier203, typeArguments206, qualifier209, operand191, modifiers215, type218, expression221, message223, statements226, type211, typeArguments231, fragments213, label234, body236, expression238, body241, expression243, parameter246, label227, arguments229, initializers256, updaters259, elseStatement262, expression264, thenStatement267, body270, label272, expression249, body251, expression253, expression279, typeArguments282, expression285, expression287, statements289, body292, expression275, arguments277, catchClauses299, body300, finally_303, declaration306, fragments308, modifiers310, type313, body316, expression318, expression294, expression297, type326, typeArguments328, name331, qualifier333, name336, bound338, type340, componentType321, elementType323, qualifier347, values350, value351, modifiers342, name345},
    generalizations={gen_JavaAbstractSyntax_AnonymousClassDeclaration_ASTNode, gen_JavaAbstractSyntax_BodyDeclaration_ASTNode, gen_JavaAbstractSyntax_CatchClause_ASTNode, gen_JavaAbstractSyntax_Expression_ASTNode, gen_JavaAbstractSyntax_ImportDeclaration_ASTNode, gen_JavaAbstractSyntax_MemberRef_ASTNode, gen_JavaAbstractSyntax_MemberValuePair_ASTNode, gen_JavaAbstractSyntax_MethodRef_ASTNode, gen_JavaAbstractSyntax_MethodRefParameter_ASTNode, gen_JavaAbstractSyntax_Comment_ASTNode, gen_JavaAbstractSyntax_CompilationUnit_ASTNode, gen_JavaAbstractSyntax_PackageDeclaration_ASTNode, gen_JavaAbstractSyntax_Statement_ASTNode, gen_JavaAbstractSyntax_TagElement_ASTNode, gen_JavaAbstractSyntax_TextElement_ASTNode, gen_JavaAbstractSyntax_Type_ASTNode, gen_JavaAbstractSyntax_TypeParameter_ASTNode, gen_JavaAbstractSyntax_VariableDeclaration_ASTNode, gen_JavaAbstractSyntax_Modifier_ASTNode, gen_JavaAbstractSyntax_Modifier_ExtendedModifier, gen_JavaAbstractSyntax_AnnotationTypeMemberDeclaration_BodyDeclaration, gen_JavaAbstractSyntax_EnumConstantDeclaration_BodyDeclaration, gen_JavaAbstractSyntax_FieldDeclaration_BodyDeclaration, gen_JavaAbstractSyntax_Initializer_BodyDeclaration, gen_JavaAbstractSyntax_MethodDeclaration_BodyDeclaration, gen_JavaAbstractSyntax_AbstractTypeDeclaration_BodyDeclaration, gen_JavaAbstractSyntax_AnnotationTypeDeclaration_AbstractTypeDeclaration, gen_JavaAbstractSyntax_EnumDeclaration_AbstractTypeDeclaration, gen_JavaAbstractSyntax_TypeDeclaration_AbstractTypeDeclaration, gen_JavaAbstractSyntax_BlockComment_Comment, gen_JavaAbstractSyntax_Javadoc_Comment, gen_JavaAbstractSyntax_LineComment_Comment, gen_JavaAbstractSyntax_Annotation_Expression, gen_JavaAbstractSyntax_Annotation_ExtendedModifier, gen_JavaAbstractSyntax_ArrayAccess_Expression, gen_JavaAbstractSyntax_ArrayCreation_Expression, gen_JavaAbstractSyntax_BooleanLiteral_Expression, gen_JavaAbstractSyntax_CastExpression_Expression, gen_JavaAbstractSyntax_CharacterLiteral_Expression, gen_JavaAbstractSyntax_ClassInstanceCreation_Expression, gen_JavaAbstractSyntax_ArrayInitializer_Expression, gen_JavaAbstractSyntax_Assignment_Expression, gen_JavaAbstractSyntax_FieldAccess_Expression, gen_JavaAbstractSyntax_InfixExpression_Expression, gen_JavaAbstractSyntax_ConditionalExpression_Expression, gen_JavaAbstractSyntax_Name_Expression, gen_JavaAbstractSyntax_NullLiteral_Expression, gen_JavaAbstractSyntax_NumberLiteral_Expression, gen_JavaAbstractSyntax_ParenthesizedExpression_Expression, gen_JavaAbstractSyntax_PostfixExpression_Expression, gen_JavaAbstractSyntax_PrefixExpression_Expression, gen_JavaAbstractSyntax_InstanceofExpression_Expression, gen_JavaAbstractSyntax_MethodInvocation_Expression, gen_JavaAbstractSyntax_StringLiteral_Expression, gen_JavaAbstractSyntax_SuperFieldAccess_Expression, gen_JavaAbstractSyntax_SuperMethodInvocation_Expression, gen_JavaAbstractSyntax_ThisExpression_Expression, gen_JavaAbstractSyntax_AssertStatement_Statement, gen_JavaAbstractSyntax_Block_Statement, gen_JavaAbstractSyntax_TypeLiteral_Expression, gen_JavaAbstractSyntax_VariableDeclarationExpression_Expression, gen_JavaAbstractSyntax_ContinueStatement_Statement, gen_JavaAbstractSyntax_DoStatement_Statement, gen_JavaAbstractSyntax_EmptyStatement_Statement, gen_JavaAbstractSyntax_EnhancedForStatement_Statement, gen_JavaAbstractSyntax_ExpressionStatement_Statement, gen_JavaAbstractSyntax_BreakStatement_Statement, gen_JavaAbstractSyntax_ConstructorInvocation_Statement, gen_JavaAbstractSyntax_IfStatement_Statement, gen_JavaAbstractSyntax_LabeledStatement_Statement, gen_JavaAbstractSyntax_ForStatement_Statement, gen_JavaAbstractSyntax_SwitchCase_Statement, gen_JavaAbstractSyntax_SwitchStatement_Statement, gen_JavaAbstractSyntax_SynchronizedStatement_Statement, gen_JavaAbstractSyntax_ReturnStatement_Statement, gen_JavaAbstractSyntax_SuperConstructorInvocation_Statement, gen_JavaAbstractSyntax_TryStatement_Statement, gen_JavaAbstractSyntax_TypeDeclarationStatement_Statement, gen_JavaAbstractSyntax_VariableDeclarationStatement_Statement, gen_JavaAbstractSyntax_WhileStatement_Statement, gen_JavaAbstractSyntax_ThrowStatement_Statement, gen_JavaAbstractSyntax_ParameterizedType_Type, gen_JavaAbstractSyntax_PrimitiveType_Type, gen_JavaAbstractSyntax_QualifiedType_Type, gen_JavaAbstractSyntax_SimpleType_Type, gen_JavaAbstractSyntax_WildcardType_Type, gen_JavaAbstractSyntax_SingleVariableDeclaration_VariableDeclaration, gen_JavaAbstractSyntax_ArrayType_Type, gen_JavaAbstractSyntax_SimpleName_Name, gen_JavaAbstractSyntax_MarkerAnnotation_Annotation, gen_JavaAbstractSyntax_NormalAnnotation_Annotation, gen_JavaAbstractSyntax_SingleMemberAnnotation_Annotation, gen_JavaAbstractSyntax_VariableDeclarationFragment_VariableDeclaration, gen_JavaAbstractSyntax_QualifiedName_Name},
    metadata=None
)
