...
# Classes
Books_System = Class(name="Books_System")
Books_Book = Class(name="Books_Book")
Books_Author = Class(name="Books_Author")
Books_Chapter = Class(name="Books_Chapter")
...
domain_model = DomainModel(
    name="Books",
    types={Books_System, Books_Book, Books_Author, Books_Chapter},
    associations={books0, authors1, chaps3, auths4, itsbook5, mybs6},
    generalizations={},
    metadata=None
)
