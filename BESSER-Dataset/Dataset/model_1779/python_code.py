...
class Books_Author:
    ...
    def __init__(self, name: str, Books_Author: "Books_System" = None, Author: "Books_Book" = None, auths: set["Books_Book"] = None):
        self.name = name
...
class Books_Book:
    ...
    def __init__(self, title: str, collecName: str, Books_Book: "Books_System" = None, itsbook: set["Books_Chapter"] = None, mybs: set["Books_Author"] = None, Book: "Books_Chapter" = None, Book7: "Books_Author" = None):
        self.title = title
