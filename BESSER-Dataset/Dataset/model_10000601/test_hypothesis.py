...
def test_microcontroller_has_sendData__():
    assert hasattr(Microcontroller, "sendData__")
    descriptor = None
    for klass in Microcontroller.__mro__:
        if "sendData__" in klass.__dict__:
            descriptor = klass.__dict__["sendData__"]
            break
...
def test_households_has_Light():
    assert hasattr(HouseHolds, "Light")
    descriptor = None
    for klass in HouseHolds.__mro__:
        if "Light" in klass.__dict__:
            descriptor = klass.__dict__["Light"]
            break
    assert isinstance(descriptor, property)

def test_households_has_Computer():
    assert hasattr(HouseHolds, "Computer")
    descriptor = None
    for klass in HouseHolds.__mro__:
...
def test_households_has_Fan():
    assert hasattr(HouseHolds, "Fan")
    descriptor = None
    for klass in HouseHolds.__mro__:
        if "Fan" in klass.__dict__:
            descriptor = klass.__dict__["Fan"]
            break
    assert isinstance(descriptor, property)
...
def test_light_sensor_has_DetectLight__():
    assert hasattr(Light_Sensor, "DetectLight__")
    descriptor = None
    for klass in Light_Sensor.__mro__:
        if "DetectLight__" in klass.__dict__:
            descriptor = klass.__dict__["DetectLight__"]
            break
    assert isinstance(descriptor, property)
...
@given(instance=Microcontroller_strategy)
def test_microcontroller_sendData___setter(instance):
...
@given(instance=HouseHolds_strategy)
def test_households_Light_setter(instance):
...
@given(instance=HouseHolds_strategy)
def test_households_Computer_setter(instance):
...
@given(instance=HouseHolds_strategy)
def test_households_Fan_setter(instance):
...
@given(instance=Light_Sensor_strategy)
def test_light_sensor_DetectLight___setter(instance):
