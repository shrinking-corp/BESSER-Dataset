...
# Classes
essentialocl_types_SequenceType = Class(name="essentialocl_types_SequenceType")
essentialocl_types_SetType = Class(name="essentialocl_types_SetType")
essentialocl_types_BagType = Class(name="essentialocl_types_BagType")
CollectionType = Class(name="CollectionType")
essentialocl_types_TupleType = Class(name="essentialocl_types_TupleType")
Type = Class(name="Type")
OclLibrary = Class(name="OclLibrary")
essentialocl_types_CollectionType = Class(name="essentialocl_types_CollectionType")
types_essentialocl_Type = Class(name="types_essentialocl_Type")
essentialocl_types_InvalidType = Class(name="essentialocl_types_InvalidType")
essentialocl_types_OrderedSetType = Class(name="essentialocl_types_OrderedSetType")
essentialocl_types_VoidType = Class(name="essentialocl_types_VoidType")
essentialocl_types_TypeType = Class(name="essentialocl_types_TypeType")
essentialocl_types_OclLibrary = Class(name="essentialocl_types_OclLibrary")
types_essentialocl_PrimitiveType = Class(name="types_essentialocl_PrimitiveType")
...
essentialocl_types_AnyType = Class(name="essentialocl_types_AnyType")
essentialocl_expressions_VariableExp = Class(name="essentialocl_expressions_VariableExp")
OclExpression = Class(name="OclExpression")
Variable = Class(name="Variable")
essentialocl_expressions_Variable = Class(name="essentialocl_expressions_Variable")
TypedElement = Class(name="TypedElement")
NamedElement = Class(name="NamedElement")
expressions_essentialocl_Parameter = Class(name="expressions_essentialocl_Parameter")
essentialocl_expressions_UnlimitedNaturalExp = Class(name="essentialocl_expressions_UnlimitedNaturalExp")
NumericLiteralExp = Class(name="NumericLiteralExp")
essentialocl_expressions_TypeLiteralExp = Class(name="essentialocl_expressions_TypeLiteralExp")
LiteralExp = Class(name="LiteralExp")
expressions_essentialocl_Type = Class(name="expressions_essentialocl_Type")
essentialocl_expressions_TupleLiteralPart = Class(name="essentialocl_expressions_TupleLiteralPart")
expressions_essentialocl_Property = Class(name="expressions_essentialocl_Property")
essentialocl_expressions_TupleLiteralExp = Class(name="essentialocl_expressions_TupleLiteralExp")
TupleLiteralPart = Class(name="TupleLiteralPart")
essentialocl_expressions_StringLiteralExp = Class(name="essentialocl_expressions_StringLiteralExp")
PrimitiveLiteralExp = Class(name="PrimitiveLiteralExp")
essentialocl_expressions_RealLiteralExp = Class(name="essentialocl_expressions_RealLiteralExp")
essentialocl_expressions_PropertyCallExp = Class(name="essentialocl_expressions_PropertyCallExp")
FeatureCallExp = Class(name="FeatureCallExp")
essentialocl_expressions_BooleanLiteralExp = Class(name="essentialocl_expressions_BooleanLiteralExp")
essentialocl_expressions_PrimitiveLiteralExp = Class(name="essentialocl_expressions_PrimitiveLiteralExp", is_abstract=True)
essentialocl_expressions_OperationCallExp = Class(name="essentialocl_expressions_OperationCallExp")
expressions_essentialocl_Operation = Class(name="expressions_essentialocl_Operation")
essentialocl_expressions_OclExpression = Class(name="essentialocl_expressions_OclExpression", is_abstract=True)
essentialocl_expressions_NumericLiteralExp = Class(name="essentialocl_expressions_NumericLiteralExp", is_abstract=True)
essentialocl_expressions_UndefinedLiteralExp = Class(name="essentialocl_expressions_UndefinedLiteralExp")
essentialocl_expressions_LoopExp = Class(name="essentialocl_expressions_LoopExp", is_abstract=True)
CallExp = Class(name="CallExp")
essentialocl_expressions_LiteralExp = Class(name="essentialocl_expressions_LiteralExp", is_abstract=True)
essentialocl_expressions_LetExp = Class(name="essentialocl_expressions_LetExp")
essentialocl_expressions_IteratorExp = Class(name="essentialocl_expressions_IteratorExp")
LoopExp = Class(name="LoopExp")
essentialocl_expressions_IterateExp = Class(name="essentialocl_expressions_IterateExp")
essentialocl_expressions_InvalidLiteralExp = Class(name="essentialocl_expressions_InvalidLiteralExp")
essentialocl_expressions_IntegerLiteralExp = Class(name="essentialocl_expressions_IntegerLiteralExp")
essentialocl_expressions_IfExp = Class(name="essentialocl_expressions_IfExp")
essentialocl_expressions_FeatureCallExp = Class(name="essentialocl_expressions_FeatureCallExp", is_abstract=True)
essentialocl_expressions_CallExp = Class(name="essentialocl_expressions_CallExp", is_abstract=True)
essentialocl_expressions_CollectionItem = Class(name="essentialocl_expressions_CollectionItem")
CollectionLiteralPart = Class(name="CollectionLiteralPart")
essentialocl_expressions_CollectionLiteralExp = Class(name="essentialocl_expressions_CollectionLiteralExp")
essentialocl_expressions_CollectionLiteralPart = Class(name="essentialocl_expressions_CollectionLiteralPart", is_abstract=True)
essentialocl_expressions_CollectionRange = Class(name="essentialocl_expressions_CollectionRange")
essentialocl_expressions_EnumLiteralExp = Class(name="essentialocl_expressions_EnumLiteralExp")
expressions_essentialocl_EnumerationLiteral = Class(name="expressions_essentialocl_EnumerationLiteral")
essentialocl_expressions_ExpressionInOcl = Class(name="essentialocl_expressions_ExpressionInOcl")
...
essentialocl_types_OclLibrary_m_makeTupleType: Method = Method(name="makeTupleType", parameters={Parameter(name='essentialocl_atts', type=StringType)}, type=StringType)
essentialocl_types_OclLibrary_m_getCollectionType: Method = Method(name="getCollectionType", parameters={Parameter(name='essentialocl_elementType', type=StringType)}, type=StringType)
essentialocl_types_OclLibrary_m_getSequenceType: Method = Method(name="getSequenceType", parameters={Parameter(name='essentialocl_elementType', type=StringType)}, type=StringType)
essentialocl_types_OclLibrary_m_getBagType: Method = Method(name="getBagType", parameters={Parameter(name='essentialocl_elementType', type=StringType)}, type=StringType)
essentialocl_types_OclLibrary_m_getSetType: Method = Method(name="getSetType", parameters={Parameter(name='essentialocl_elementType', type=StringType)}, type=StringType)
essentialocl_types_OclLibrary_m_getOrderedSetType: Method = Method(name="getOrderedSetType", parameters={Parameter(name='essentialocl_elementType', type=StringType)}, type=StringType)
essentialocl_types_OclLibrary_m_getTypeType: Method = Method(name="getTypeType", parameters={Parameter(name='essentialocl_representedType', type=StringType)}, type=StringType)
essentialocl_types_OclLibrary.methods={essentialocl_types_OclLibrary_m_makeTupleType, essentialocl_types_OclLibrary_m_getOrderedSetType, essentialocl_types_OclLibrary_m_getTypeType, essentialocl_types_OclLibrary_m_getSetType, essentialocl_types_OclLibrary_m_getCollectionType, essentialocl_types_OclLibrary_m_getBagType, essentialocl_types_OclLibrary_m_getSequenceType}
...
oclLibrary5: BinaryAssociation = BinaryAssociation(
    name="oclLibrary5",
    ends={
        Property(name="OclLibrary6", type=essentialocl_types_InvalidType, multiplicity=Multiplicity(1, 1)),
        Property(name="oclInvalid", type=OclLibrary, multiplicity=Multiplicity(1, 1))
    }
)
oclLibrary7: BinaryAssociation = BinaryAssociation(
    name="oclLibrary7",
    ends={
        Property(name="OclLibrary8", type=essentialocl_types_VoidType, multiplicity=Multiplicity(1, 1)),
        Property(name="oclVoid", type=OclLibrary, multiplicity=Multiplicity(1, 1))
    }
)
representedType9: BinaryAssociation = BinaryAssociation(
    name="representedType9",
    ends={
        Property(name="types_essentialocl_Type10", type=essentialocl_types_TypeType, multiplicity=Multiplicity(1, 1)),
        Property(name="essentialocl_types_TypeType", type=types_essentialocl_Type, multiplicity=Multiplicity(0, 1))
    }
)
oclBoolean11: BinaryAssociation = BinaryAssociation(
    name="oclBoolean11",
    ends={
...
oclString12: BinaryAssociation = BinaryAssociation(
    name="oclString12",
    ends={
        Property(name="types_essentialocl_PrimitiveType14", type=essentialocl_types_OclLibrary, multiplicity=Multiplicity(1, 1)),
        Property(name="essentialocl_types_OclLibrary13", type=types_essentialocl_PrimitiveType, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
oclInteger15: BinaryAssociation = BinaryAssociation(
    name="oclInteger15",
    ends={
        Property(name="types_essentialocl_PrimitiveType17", type=essentialocl_types_OclLibrary, multiplicity=Multiplicity(1, 1)),
        Property(name="essentialocl_types_OclLibrary16", type=types_essentialocl_PrimitiveType, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
oclReal18: BinaryAssociation = BinaryAssociation(
    name="oclReal18",
    ends={
        Property(name="types_essentialocl_PrimitiveType20", type=essentialocl_types_OclLibrary, multiplicity=Multiplicity(1, 1)),
        Property(name="essentialocl_types_OclLibrary19", type=types_essentialocl_PrimitiveType, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
oclAny21: BinaryAssociation = BinaryAssociation(
    name="oclAny21",
    ends={
        Property(name="AnyType", type=essentialocl_types_OclLibrary, multiplicity=Multiplicity(1, 1)),
        Property(name="essentialocl_types_OclLibrary22", type=AnyType, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
oclVoid23: BinaryAssociation = BinaryAssociation(
    name="oclVoid23",
    ends={
        Property(name="VoidType", type=essentialocl_types_OclLibrary, multiplicity=Multiplicity(1, 1)),
        Property(name="oclLibrary", type=VoidType, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
oclInvalid24: BinaryAssociation = BinaryAssociation(
    name="oclInvalid24",
    ends={
        Property(name="InvalidType", type=essentialocl_types_OclLibrary, multiplicity=Multiplicity(1, 1)),
        Property(name="oclLibrary25", type=InvalidType, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
oclType26: BinaryAssociation = BinaryAssociation(
    name="oclType26",
    ends={
        Property(name="TypeType", type=essentialocl_types_OclLibrary, multiplicity=Multiplicity(1, 1)),
        Property(name="essentialocl_types_OclLibrary27", type=TypeType, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
oclCollection28: BinaryAssociation = BinaryAssociation(
    name="oclCollection28",
    ends={
        Property(name="CollectionType", type=essentialocl_types_OclLibrary, multiplicity=Multiplicity(1, 1)),
        Property(name="essentialocl_types_OclLibrary29", type=CollectionType, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
oclSequence30: BinaryAssociation = BinaryAssociation(
    name="oclSequence30",
    ends={
        Property(name="SequenceType", type=essentialocl_types_OclLibrary, multiplicity=Multiplicity(1, 1)),
        Property(name="essentialocl_types_OclLibrary31", type=SequenceType, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
oclBag32: BinaryAssociation = BinaryAssociation(
    name="oclBag32",
    ends={
        Property(name="BagType", type=essentialocl_types_OclLibrary, multiplicity=Multiplicity(1, 1)),
        Property(name="essentialocl_types_OclLibrary33", type=BagType, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
qualifier52: BinaryAssociation = BinaryAssociation(
    name="qualifier52",
    ends={
        Property(name="OclExpression54", type=essentialocl_expressions_PropertyCallExp, multiplicity=Multiplicity(1, 1)),
        Property(name="essentialocl_expressions_PropertyCallExp53", type=OclExpression, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
oclSet34: BinaryAssociation = BinaryAssociation(
    name="oclSet34",
    ends={
        Property(name="SetType", type=essentialocl_types_OclLibrary, multiplicity=Multiplicity(1, 1)),
        Property(name="essentialocl_types_OclLibrary35", type=SetType, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
oclOrderedSet36: BinaryAssociation = BinaryAssociation(
    name="oclOrderedSet36",
    ends={
        Property(name="OrderedSetType", type=essentialocl_types_OclLibrary, multiplicity=Multiplicity(1, 1)),
        Property(name="essentialocl_types_OclLibrary37", type=OrderedSetType, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
oclTuple38: BinaryAssociation = BinaryAssociation(
    name="oclTuple38",
    ends={
        Property(name="TupleType", type=essentialocl_types_OclLibrary, multiplicity=Multiplicity(1, 1)),
        Property(name="essentialocl_types_OclLibrary39", type=TupleType, multiplicity=Multiplicity(1, 9999), is_composite=True)
    }
)
referredVariable40: BinaryAssociation = BinaryAssociation(
    name="referredVariable40",
    ends={
...
representedParameter41: BinaryAssociation = BinaryAssociation(
    name="representedParameter41",
    ends={
...
initExpression42: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="essentialocl_expressions_Variable43", type=OclExpression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
referredType44: BinaryAssociation = BinaryAssociation(
    name="referredType44",
    ends={
...
value46: BinaryAssociation = BinaryAssociation(
    name="value46",
    ends={
        Property(name="OclExpression48", type=essentialocl_expressions_TupleLiteralPart, multiplicity=Multiplicity(1, 1)),
        Property(name="essentialocl_expressions_TupleLiteralPart47", type=OclExpression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
...
referredProperty50: BinaryAssociation = BinaryAssociation(
    name="referredProperty50",
    ends={
        Property(name="expressions_essentialocl_Property51", type=essentialocl_expressions_PropertyCallExp, multiplicity=Multiplicity(1, 1)),
...
argument55: BinaryAssociation = BinaryAssociation(
    name="argument55",
    ends={
        Property(name="OclExpression56", type=essentialocl_expressions_OperationCallExp, multiplicity=Multiplicity(1, 1)),
...
referredOperation57: BinaryAssociation = BinaryAssociation(
    name="referredOperation57",
    ends={
        ...
        Property(name="essentialocl_expressions_OperationCallExp58", type=expressions_essentialocl_Operation, multiplicity=Multiplicity(0, 1))
    }
)
oclLibrary59: BinaryAssociation = BinaryAssociation(
    name="oclLibrary59",
    ends={
        Property(name="OclLibrary60", type=essentialocl_expressions_OclExpression, multiplicity=Multiplicity(1, 1)),
...
body61: BinaryAssociation = BinaryAssociation(
    name="body61",
    ends={
        Property(name="OclExpression62", type=essentialocl_expressions_LoopExp, multiplicity=Multiplicity(1, 1)),
        Property(name="essentialocl_expressions_LoopExp", type=OclExpression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
iterator63: BinaryAssociation = BinaryAssociation(
    name="iterator63",
    ends={
        Property(name="Variable65", type=essentialocl_expressions_LoopExp, multiplicity=Multiplicity(1, 1)),
        Property(name="essentialocl_expressions_LoopExp64", type=Variable, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
in_66: BinaryAssociation = BinaryAssociation(
    name="in_66",
    ends={
        Property(name="OclExpression67", type=essentialocl_expressions_LetExp, multiplicity=Multiplicity(1, 1)),
...
variable68: BinaryAssociation = BinaryAssociation(
    name="variable68",
    ends={
        Property(name="Variable70", type=essentialocl_expressions_LetExp, multiplicity=Multiplicity(1, 1)),
        Property(name="essentialocl_expressions_LetExp69", type=Variable, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
result71: BinaryAssociation = BinaryAssociation(
    name="result71",
    ends={
        Property(name="Variable72", type=essentialocl_expressions_IterateExp, multiplicity=Multiplicity(1, 1)),
...
condition73: BinaryAssociation = BinaryAssociation(
    name="condition73",
    ends={
        Property(name="OclExpression74", type=essentialocl_expressions_IfExp, multiplicity=Multiplicity(1, 1)),
...
thenExpression75: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="OclExpression77", type=essentialocl_expressions_IfExp, multiplicity=Multiplicity(1, 1)),
        Property(name="essentialocl_expressions_IfExp76", type=OclExpression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
elseExpression78: BinaryAssociation = BinaryAssociation(
    name="elseExpression78",
    ends={
        Property(name="OclExpression80", type=essentialocl_expressions_IfExp, multiplicity=Multiplicity(1, 1)),
        Property(name="essentialocl_expressions_IfExp79", type=OclExpression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
sourceType81: BinaryAssociation = BinaryAssociation(
    name="sourceType81",
    ends={
        Property(name="expressions_essentialocl_Type82", type=essentialocl_expressions_FeatureCallExp, multiplicity=Multiplicity(1, 1)),
...
source83: BinaryAssociation = BinaryAssociation(
    name="source83",
    ends={
        Property(name="OclExpression84", type=essentialocl_expressions_CallExp, multiplicity=Multiplicity(1, 1)),
        Property(name="essentialocl_expressions_CallExp", type=OclExpression, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
item85: BinaryAssociation = BinaryAssociation(
    name="item85",
    ends={
        Property(name="OclExpression86", type=essentialocl_expressions_CollectionItem, multiplicity=Multiplicity(1, 1)),
        Property(name="essentialocl_expressions_CollectionItem", type=OclExpression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
part87: BinaryAssociation = BinaryAssociation(
    name="part87",
    ends={
...
elementType88: BinaryAssociation = BinaryAssociation(
    name="elementType88",
    ends={
        Property(name="expressions_essentialocl_Type90", type=essentialocl_expressions_CollectionLiteralExp, multiplicity=Multiplicity(1, 1)),
        Property(name="essentialocl_expressions_CollectionLiteralExp89", type=expressions_essentialocl_Type, multiplicity=Multiplicity(0, 1))
    }
)
first91: BinaryAssociation = BinaryAssociation(
    name="first91",
    ends={
        Property(name="OclExpression92", type=essentialocl_expressions_CollectionRange, multiplicity=Multiplicity(1, 1)),
...
last93: BinaryAssociation = BinaryAssociation(
    name="last93",
    ends={
        Property(name="OclExpression95", type=essentialocl_expressions_CollectionRange, multiplicity=Multiplicity(1, 1)),
        Property(name="essentialocl_expressions_CollectionRange94", type=OclExpression, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
referredEnumLiteral96: BinaryAssociation = BinaryAssociation(
    name="referredEnumLiteral96",
    ends={
...
bodyExpression97: BinaryAssociation = BinaryAssociation(
    name="bodyExpression97",
    ends={
        Property(name="OclExpression98", type=essentialocl_expressions_ExpressionInOcl, multiplicity=Multiplicity(1, 1)),
...
context99: BinaryAssociation = BinaryAssociation(
    name="context99",
    ends={
        Property(name="Variable101", type=essentialocl_expressions_ExpressionInOcl, multiplicity=Multiplicity(1, 1)),
        Property(name="essentialocl_expressions_ExpressionInOcl100", type=Variable, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
result102: BinaryAssociation = BinaryAssociation(
    name="result102",
    ends={
        Property(name="Variable104", type=essentialocl_expressions_ExpressionInOcl, multiplicity=Multiplicity(1, 1)),
        Property(name="essentialocl_expressions_ExpressionInOcl103", type=Variable, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
parameter105: BinaryAssociation = BinaryAssociation(
    name="parameter105",
    ends={
        Property(name="Variable107", type=essentialocl_expressions_ExpressionInOcl, multiplicity=Multiplicity(1, 1)),
        Property(name="essentialocl_expressions_ExpressionInOcl106", type=Variable, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
domain_model = DomainModel(
    name="essentialocl",
    types={essentialocl_types_SequenceType, essentialocl_types_SetType, essentialocl_types_BagType, CollectionType, essentialocl_types_TupleType, Type, OclLibrary, essentialocl_types_CollectionType, types_essentialocl_Type, essentialocl_types_InvalidType, essentialocl_types_OrderedSetType, essentialocl_types_VoidType, essentialocl_types_TypeType, essentialocl_types_OclLibrary, types_essentialocl_PrimitiveType, AnyType, VoidType, InvalidType, TypeType, SequenceType, BagType, SetType, OrderedSetType, TupleType, essentialocl_types_AnyType, essentialocl_expressions_VariableExp, OclExpression, Variable, essentialocl_expressions_Variable, TypedElement, NamedElement, expressions_essentialocl_Parameter, essentialocl_expressions_UnlimitedNaturalExp, NumericLiteralExp, essentialocl_expressions_TypeLiteralExp, LiteralExp, expressions_essentialocl_Type, essentialocl_expressions_TupleLiteralPart, expressions_essentialocl_Property, essentialocl_expressions_TupleLiteralExp, TupleLiteralPart, essentialocl_expressions_StringLiteralExp, PrimitiveLiteralExp, essentialocl_expressions_RealLiteralExp, essentialocl_expressions_PropertyCallExp, FeatureCallExp, essentialocl_expressions_BooleanLiteralExp, essentialocl_expressions_PrimitiveLiteralExp, essentialocl_expressions_OperationCallExp, expressions_essentialocl_Operation, essentialocl_expressions_OclExpression, essentialocl_expressions_NumericLiteralExp, essentialocl_expressions_UndefinedLiteralExp, essentialocl_expressions_LoopExp, CallExp, essentialocl_expressions_LiteralExp, essentialocl_expressions_LetExp, essentialocl_expressions_IteratorExp, LoopExp, essentialocl_expressions_IterateExp, essentialocl_expressions_InvalidLiteralExp, essentialocl_expressions_IntegerLiteralExp, essentialocl_expressions_IfExp, essentialocl_expressions_FeatureCallExp, essentialocl_expressions_CallExp, essentialocl_expressions_CollectionItem, CollectionLiteralPart, essentialocl_expressions_CollectionLiteralExp, essentialocl_expressions_CollectionLiteralPart, essentialocl_expressions_CollectionRange, essentialocl_expressions_EnumLiteralExp, expressions_essentialocl_EnumerationLiteral, essentialocl_expressions_ExpressionInOcl, Expression, CollectionKind},
    associations={oclLibrary0, elementType1, oclLibrary2, oclLibrary5, oclLibrary7, representedType9, oclBoolean11, oclString12, oclInteger15, oclReal18, oclAny21, oclVoid23, oclInvalid24, oclType26, oclCollection28, oclSequence30, oclBag32, qualifier52, oclSet34, oclOrderedSet36, oclTuple38, referredVariable40, representedParameter41, initExpression42, referredType44, property45, value46, part49, referredProperty50, argument55, referredOperation57, oclLibrary59, body61, iterator63, in_66, variable68, result71, condition73, thenExpression75, elseExpression78, sourceType81, source83, item85, part87, elementType88, first91, last93, referredEnumLiteral96, bodyExpression97, context99, result102, parameter105},
    generalizations={gen_essentialocl_types_SequenceType_CollectionType, gen_essentialocl_types_SetType_CollectionType, gen_essentialocl_types_BagType_CollectionType, gen_essentialocl_types_TupleType_Type, gen_essentialocl_types_CollectionType_Type, gen_essentialocl_types_InvalidType_Type, gen_essentialocl_types_OrderedSetType_CollectionType, gen_essentialocl_types_VoidType_Type, gen_essentialocl_types_TypeType_Type, gen_essentialocl_types_AnyType_Type, gen_essentialocl_expressions_VariableExp_OclExpression, gen_essentialocl_expressions_Variable_TypedElement, gen_essentialocl_expressions_Variable_NamedElement, gen_essentialocl_expressions_UnlimitedNaturalExp_NumericLiteralExp, gen_essentialocl_expressions_TypeLiteralExp_LiteralExp, gen_essentialocl_expressions_TupleLiteralPart_TypedElement, gen_essentialocl_expressions_TupleLiteralExp_LiteralExp, gen_essentialocl_expressions_StringLiteralExp_PrimitiveLiteralExp, gen_essentialocl_expressions_RealLiteralExp_NumericLiteralExp, gen_essentialocl_expressions_PropertyCallExp_FeatureCallExp, gen_essentialocl_expressions_BooleanLiteralExp_PrimitiveLiteralExp, gen_essentialocl_expressions_PrimitiveLiteralExp_LiteralExp, gen_essentialocl_expressions_OperationCallExp_FeatureCallExp, gen_essentialocl_expressions_OclExpression_TypedElement, gen_essentialocl_expressions_OclExpression_NamedElement, gen_essentialocl_expressions_NumericLiteralExp_PrimitiveLiteralExp, gen_essentialocl_expressions_UndefinedLiteralExp_LiteralExp, gen_essentialocl_expressions_LoopExp_CallExp, gen_essentialocl_expressions_LiteralExp_OclExpression, gen_essentialocl_expressions_LetExp_OclExpression, gen_essentialocl_expressions_IteratorExp_LoopExp, gen_essentialocl_expressions_IterateExp_LoopExp, gen_essentialocl_expressions_InvalidLiteralExp_LiteralExp, gen_essentialocl_expressions_IntegerLiteralExp_NumericLiteralExp, gen_essentialocl_expressions_IfExp_OclExpression, gen_essentialocl_expressions_FeatureCallExp_CallExp, gen_essentialocl_expressions_CallExp_OclExpression, gen_essentialocl_expressions_CollectionItem_CollectionLiteralPart, gen_essentialocl_expressions_CollectionLiteralExp_LiteralExp, gen_essentialocl_expressions_CollectionLiteralPart_TypedElement, gen_essentialocl_expressions_CollectionRange_CollectionLiteralPart, gen_essentialocl_expressions_EnumLiteralExp_LiteralExp, gen_essentialocl_expressions_ExpressionInOcl_Expression},
    metadata=None
)
