...
class familyTree_Person(ABC):
    ...
    def __init__(self, name: str, lastName: str, children: "familyTree_Male" = None, children3: "familyTree_Female" = None, leaves: "familyTree_FamilyTree" = None, Person8: "familyTree_Male" = None, Person: "familyTree_FamilyTree" = None, Person12: "familyTree_Female" = None):
        self.name = name
