...
# Classes
familyTree_Male = Class(name="familyTree_Male")
familyTree_Female = Class(name="familyTree_Female")
...
domain_model = DomainModel(
    name="familyTree",
    types={familyTree_Male, familyTree_Female, Person, familyTree_FamilyTree, familyTree_Person},
    associations={father1, mother2, tree4, wife5, children7, husband9, leaves0, children11},
