...
class Order:
    ...
    def __init__(self, Restaurant: Restaurant, ItemList: MenuItem, Customer: Customer, Order_Restaurant_012: "Restaurant" = None, Order_Customer_014: "Customer" = None, Order_MenuItem_010: set["MenuItem"] = None, OrderController_Order_119: set["OrderController"] = None):
        self.Restaurant = Restaurant
...
class Food:
    ...
    def __init__(self, Price: int, Calories: int, Vegetarian: bool, FoodPackage_Food_17: set["FoodPackage"] = None, FoodItem_Food_15: set["FoodItem"] = None):
        self.Price = Price
...
class FoodItem:
    ...
    def __init__(self, Food: Food, MenuItem_FoodItem_11: set["MenuItem"] = None, FoodItem_Food_04: "Food" = None):
        self.Food = Food
...
class FoodPackage:
    ...
    def __init__(self, FoodList: Food, FoodPackage_Food_06: set["Food"] = None, MenuItem_FoodPackage_13: set["MenuItem"] = None):
...
class MenuItem:
    ...
    def __init__(self, Description: str, Restaurant_MenuItem_19: set["Restaurant"] = None, Order_MenuItem_111: set["Order"] = None, MenuItem_FoodItem_00: set["FoodItem"] = None, MenuItem_FoodPackage_02: set["FoodPackage"] = None):
...
class Restaurant:
    ...
    def __init__(self, Name: str, Address: str, PostCode: int, Menu: MenuItem, Order_Restaurant_113: set["Order"] = None, RestaurantManager_Restaurant_117: set["RestaurantController"] = None, Restaurant_MenuItem_08: set["MenuItem"] = None):
        self.Name = Name
        self.Address = Address
        self.PostCode = PostCode
        self.Menu = Menu
