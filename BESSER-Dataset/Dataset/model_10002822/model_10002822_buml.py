...
Customer.attributes={Customer_FullName, Customer_Address, Customer_CreditCard, Customer_Cellphone, Customer_PostCode}
...
domain_model = DomainModel(
    name="deed1332_5343_4b02_aab8_7f2e36a85b45",
    types={Restaurant, MenuItem, FoodPackage, FoodItem, Food, Order, Customer, RestaurantController, OrderController},
    associations={FoodPackage_Food, Restaurant_MenuItem, Order_MenuItem, Order_Restaurant, Order_Customer, RestaurantManager_Restaurant, OrderController_Order, MenuItem_FoodItem, MenuItem_FoodPackage, FoodItem_Food},
    generalizations={},
    metadata=None
)
