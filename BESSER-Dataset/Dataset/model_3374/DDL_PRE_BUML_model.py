...
# Classes
DDL_Statement = Class(name="DDL_Statement")
DDL_DataDefinition = Class(name="DDL_DataDefinition")
Statement = Class(name="Statement")
DDL_DataType = Class(name="DDL_DataType")
DDL_Type = Class(name="DDL_Type")
DDL_Column = Class(name="DDL_Column")
DDL_Database = Class(name="DDL_Database")
DataDefinition = Class(name="DataDefinition")
DDL_CommentTable = Class(name="DDL_CommentTable")
DDL_CommentColumn = Class(name="DDL_CommentColumn")
DDL_DDLDefinition = Class(name="DDL_DDLDefinition")
DDL_Pk = Class(name="DDL_Pk")
DDL_Fk = Class(name="DDL_Fk")
DDL_Table = Class(name="DDL_Table")
DDL_Ck = Class(name="DDL_Ck")
DDL_ValuesCk = Class(name="DDL_ValuesCk")
DDL_Character = Class(name="DDL_Character")
Characters = Class(name="Characters")
DDL_CharacterVarying = Class(name="DDL_CharacterVarying")
DDL_Char = Class(name="DDL_Char")
DDL_VarChar = Class(name="DDL_VarChar")
DDL_VarChar2 = Class(name="DDL_VarChar2")
DDL_NVarChar2 = Class(name="DDL_NVarChar2")
DDL_NChar = Class(name="DDL_NChar")
DDL_CharVarying = Class(name="DDL_CharVarying")
DDL_NationalChar = Class(name="DDL_NationalChar")
DDL_NationalCharVarying = Class(name="DDL_NationalCharVarying")
DDL_NationalCharacter = Class(name="DDL_NationalCharacter")
DDL_NationalCharacterVarying = Class(name="DDL_NationalCharacterVarying")
DDL_NCharVarying = Class(name="DDL_NCharVarying")
DDL_Clob = Class(name="DDL_Clob")
DDL_NClob = Class(name="DDL_NClob")
DDL_Bits = Class(name="DDL_Bits")
DDL_Bit = Class(name="DDL_Bit")
Bits = Class(name="Bits")
DDL_BitVarying = Class(name="DDL_BitVarying")
Bit = Class(name="Bit")
DDL_Times = Class(name="DDL_Times")
DDL_Date = Class(name="DDL_Date")
Times = Class(name="Times")
DDL_Exacto = Class(name="DDL_Exacto")
Type = Class(name="Type")
DDL_Integer = Class(name="DDL_Integer")
Exacto = Class(name="Exacto")
DDL_SmallInteger = Class(name="DDL_SmallInteger")
DDL_Int = Class(name="DDL_Int")
DDL_SmallInt = Class(name="DDL_SmallInt")
DDL_Number = Class(name="DDL_Number")
DDL_Numeric = Class(name="DDL_Numeric")
DDL_Decimal = Class(name="DDL_Decimal")
DDL_Aproximado = Class(name="DDL_Aproximado")
DDL_Real = Class(name="DDL_Real")
Aproximado = Class(name="Aproximado")
DDL_DoublePrecision = Class(name="DDL_DoublePrecision")
DDL_Float = Class(name="DDL_Float")
DDL_Long = Class(name="DDL_Long")
DDL_LongRaw = Class(name="DDL_LongRaw")
DDL_Characters = Class(name="DDL_Characters")
DDL_Time = Class(name="DDL_Time")
DDL_Timestamp = Class(name="DDL_Timestamp")
DDL_Intervals = Class(name="DDL_Intervals")
DDL_YearMonth = Class(name="DDL_YearMonth")
Intervals = Class(name="Intervals")
DDL_DayTime = Class(name="DDL_DayTime")
DDL_Binaries = Class(name="DDL_Binaries")
DDL_BinaryDouble = Class(name="DDL_BinaryDouble")
Binaries = Class(name="Binaries")
DDL_BinaryFloat = Class(name="DDL_BinaryFloat")
DDL_BFile = Class(name="DDL_BFile")
DDL_Blob = Class(name="DDL_Blob")
...
DDL_Column.attributes={DDL_Column_columnNull, DDL_Column_columnName, DDL_Column_commentColumn}
...
DDL_CommentColumn.attributes={DDL_CommentColumn_tableName, DDL_CommentColumn_columnName, DDL_CommentColumn_columnComment}
...
DDL_Pk.attributes={DDL_Pk_columnName, DDL_Pk_namePk}
...
DDL_Fk.attributes={DDL_Fk_columnName, DDL_Fk_nameFk, DDL_Fk_status, DDL_Fk_columnReference}
...
DDL_Table.attributes={DDL_Table_tableName, DDL_Table_commentTable}
...
DDL_ValuesCk.attributes={DDL_ValuesCk_value, DDL_ValuesCk_comparator, DDL_ValuesCk_logConjuntion, DDL_ValuesCk_columnName}
...
DDL_Number.attributes={DDL_Number_scale, DDL_Number_precision}
...
domain_model = DomainModel(
    name="DDL",
    types={DDL_Statement, DDL_DataDefinition, Statement, DDL_DataType, DDL_Type, DDL_Column, DDL_Database, DataDefinition, DDL_CommentTable, DDL_CommentColumn, DDL_DDLDefinition, DDL_Pk, DDL_Fk, DDL_Table, DDL_Ck, DDL_ValuesCk, DDL_Character, Characters, DDL_CharacterVarying, DDL_Char, DDL_VarChar, DDL_VarChar2, DDL_NVarChar2, DDL_NChar, DDL_CharVarying, DDL_NationalChar, DDL_NationalCharVarying, DDL_NationalCharacter, DDL_NationalCharacterVarying, DDL_NCharVarying, DDL_Clob, DDL_NClob, DDL_Bits, DDL_Bit, Bits, DDL_BitVarying, Bit, DDL_Times, DDL_Date, Times, DDL_Exacto, Type, DDL_Integer, Exacto, DDL_SmallInteger, DDL_Int, DDL_SmallInt, DDL_Number, DDL_Numeric, DDL_Decimal, DDL_Aproximado, DDL_Real, Aproximado, DDL_DoublePrecision, DDL_Float, DDL_Long, DDL_LongRaw, DDL_Characters, DDL_Time, DDL_Timestamp, DDL_Intervals, DDL_YearMonth, Intervals, DDL_DayTime, DDL_Binaries, DDL_BinaryDouble, Binaries, DDL_BinaryFloat, DDL_BFile, DDL_Blob},
    associations={columnType7, columns9, columnsPk12, columnsFk14, checks17, types0, statements1, dataType2, references5, valuesCk6},
    generalizations={gen_DDL_DataDefinition_Statement, gen_DDL_Database_DataDefinition, gen_DDL_Table_DataDefinition, gen_DDL_CommentTable_DataDefinition, gen_DDL_CommentColumn_DataDefinition, gen_DDL_Character_Characters, gen_DDL_CharacterVarying_Characters, gen_DDL_Char_Characters, gen_DDL_VarChar_Characters, gen_DDL_VarChar2_Characters, gen_DDL_NVarChar2_Characters, gen_DDL_NChar_Characters, gen_DDL_CharVarying_Characters, gen_DDL_NationalChar_Characters, gen_DDL_NationalCharVarying_Characters, gen_DDL_NationalCharacter_Characters, gen_DDL_NationalCharacterVarying_Characters, gen_DDL_NCharVarying_Characters, gen_DDL_Clob_Characters, gen_DDL_NClob_Characters, gen_DDL_Bits_Type, gen_DDL_Bit_Bits, gen_DDL_BitVarying_Bit, gen_DDL_Times_Type, gen_DDL_Date_Times, gen_DDL_Exacto_Type, gen_DDL_Integer_Exacto, gen_DDL_SmallInteger_Exacto, gen_DDL_Int_Exacto, gen_DDL_SmallInt_Exacto, gen_DDL_Number_Exacto, gen_DDL_Numeric_Exacto, gen_DDL_Decimal_Exacto, gen_DDL_Aproximado_Type, gen_DDL_Real_Aproximado, gen_DDL_DoublePrecision_Aproximado, gen_DDL_Float_Aproximado, gen_DDL_Long_Aproximado, gen_DDL_LongRaw_Aproximado, gen_DDL_Characters_Type, gen_DDL_Time_Times, gen_DDL_Timestamp_Times, gen_DDL_Intervals_Type, gen_DDL_YearMonth_Intervals, gen_DDL_DayTime_Intervals, gen_DDL_Binaries_Type, gen_DDL_BinaryDouble_Binaries, gen_DDL_BinaryFloat_Binaries, gen_DDL_BFile_Binaries, gen_DDL_Blob_Binaries},
    metadata=None
)
