...
sgraph_State.attributes={sgraph_State_substatechartId, sgraph_State_orthogonal, sgraph_State_subchart, sgraph_State_simple, sgraph_State_composite, sgraph_State_leaf}
...
domain_model = DomainModel(
    name="sgraph",
    types={sgraph_Pseudostate, Vertex, sgraph_Vertex, NamedElement, sgraph_Region, sgraph_CompositeElement, SpecificationElement, Reaction, DocumentedElement, sgraph_Transition, Pseudostate, sgraph_Statechart, ReactiveElement, ScopedElement, CompositeElement, sgraph_Import, sgraph_Entry, sgraph_FinalState, RegularState, sgraph_Variable, Declaration, sgraph_Event, sgraph_Choice, sgraph_Trigger, sgraph_Effect, sgraph_ReactionProperty, sgraph_Exit, sgraph_ReactiveElement, sgraph_Reaction, sgraph_ScopedElement, sgraph_Synchronization, sgraph_State, sgraph_SpecificationElement, sgraph_Declaration, sgraph_Scope, sgraph_RegularState, sgraph_ImportDeclaration, EntryKind, ChoiceKind},
    associations={vertices4, composite5, target6, parentRegion0, incomingTransitions1, outgoingTransitions2, imports10, source8, localReactions12, trigger15, effect17, properties19, reactions11, events22, variables24, scopes26, declarations21, regions30, substatechart28, declaration32},
    generalizations={gen_sgraph_Pseudostate_Vertex, gen_sgraph_Vertex_NamedElement, gen_sgraph_Region_NamedElement, gen_sgraph_Transition_SpecificationElement, gen_sgraph_Transition_Reaction, gen_sgraph_Transition_DocumentedElement, gen_sgraph_Choice_Pseudostate, gen_sgraph_Statechart_SpecificationElement, gen_sgraph_Statechart_ReactiveElement, gen_sgraph_Statechart_ScopedElement, gen_sgraph_Statechart_CompositeElement, gen_sgraph_Statechart_NamedElement, gen_sgraph_Statechart_DocumentedElement, gen_sgraph_Entry_Pseudostate, gen_sgraph_FinalState_RegularState, gen_sgraph_Variable_Declaration, gen_sgraph_Event_Declaration, gen_sgraph_Exit_Pseudostate, gen_sgraph_Synchronization_Pseudostate, gen_sgraph_Declaration_NamedElement, gen_sgraph_RegularState_Vertex, gen_sgraph_State_SpecificationElement, gen_sgraph_State_ReactiveElement, gen_sgraph_State_ScopedElement, gen_sgraph_State_RegularState, gen_sgraph_State_CompositeElement, gen_sgraph_State_DocumentedElement, gen_sgraph_ImportDeclaration_Declaration},
    metadata=None
)
