...
class fc_AttributeValue(ABC):
    ...
    def __init__(self, id: str, name: str, description: str, comment: str, values: "fc_Selection" = None, fc_AttributeValue: "fc_Attribute" = None, AttributeValue: "fc_Selection" = None):
        self.id = id
        self.name = name
...
class fc_Selection:
    ...
    def __init__(self, id: str, name: str, description: str, comment: str, root: bool, present: bool, enabled: bool, fc_Selection13: "fc_FeatureConfiguration" = None, fc_Selection16: "fc_Feature" = None, Selection18: "fc_AttributeValue" = None, fc_Selection: "fc_FeatureConfiguration" = None, Selection: "fc_Selection" = None, selections: "fc_Selection" = None, selection: set["fc_AttributeValue"] = None, Selection11: "fc_Selection" = None, parent: set["fc_Selection"] = None):
        self.id = id
        self.name = name
        self.description = description
        self.comment = comment
...
class fc_FeatureConfiguration:
    ...
    def __init__(self, name: str, version: str, description: str, comment: str, fc_FeatureConfiguration14: "fc_Selection" = None, fc_FeatureConfiguration: "fc_FeatureModel" = None, fc_FeatureConfiguration2: "fc_FeatureModel" = None, fc_FeatureConfiguration5: "fc_Selection" = None):
        self.name = name
    ...
    def getSelectionsById(self, fc_id):
