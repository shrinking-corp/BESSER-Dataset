...
# Classes
fc_FeatureConfiguration = Class(name="fc_FeatureConfiguration")
fc_FeatureModel = Class(name="fc_FeatureModel")
fc_Selection = Class(name="fc_Selection")
fc_AttributeValue = Class(name="fc_AttributeValue", is_abstract=True)
fc_Feature = Class(name="fc_Feature")
fc_Attribute = Class(name="fc_Attribute")
fc_BooleanValue = Class(name="fc_BooleanValue")
AttributeValue = Class(name="AttributeValue")
fc_IntegerValue = Class(name="fc_IntegerValue")
fc_DoubleValue = Class(name="fc_DoubleValue")
fc_StringValue = Class(name="fc_StringValue")
...
fc_FeatureConfiguration_m_getSelectionsById: Method = Method(name="getSelectionsById", parameters={Parameter(name='fc_id', type=StringType)})
...
fc_Selection.attributes={fc_Selection_name, fc_Selection_id, fc_Selection_present, fc_Selection_description, fc_Selection_enabled, fc_Selection_root, fc_Selection_comment}
...
fc_AttributeValue.attributes={fc_AttributeValue_description, fc_AttributeValue_comment, fc_AttributeValue_id, fc_AttributeValue_name}
...
domain_model = DomainModel(
    name="fc",
    types={fc_FeatureConfiguration, fc_FeatureModel, fc_Selection, fc_AttributeValue, fc_Feature, fc_Attribute, fc_BooleanValue, AttributeValue, fc_IntegerValue, fc_DoubleValue, fc_StringValue},
    associations={featureModel0, featureModelCopy1, root4, parent7, values8, selections10, featureConfiguration12, feature15, selection17, attribute19},
    generalizations={gen_fc_BooleanValue_AttributeValue, gen_fc_IntegerValue_AttributeValue, gen_fc_DoubleValue_AttributeValue, gen_fc_StringValue_AttributeValue},
    metadata=None
)
