...
platoon_Command = Class(name="platoon_Command")
...
platoon_Constraint = Class(name="platoon_Constraint")
...
domain_model = DomainModel(
    name="platoon",
    types={platoon_Vehicle, Vehicle, platoon_Platoon, platoon_LeadingVehicle, platoon_FollowVehicle, platoon_Route, platoon_Command, platoon_Constraints, platoon_ForwardCommand, Command, platoon_TurnCommand, platoon_HeadwayConstraint, Constraint, platoon_Constraint, platoon_World},
    associations={commands3, LV0, FV1, platoon9, route11, constraints14, constraints16, follows4, route6},
