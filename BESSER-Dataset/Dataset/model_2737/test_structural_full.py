...
AbcToNothing_A_strategy = st.builds(AbcToNothing_A)
...
AbcToNothing_C_strategy = st.builds(AbcToNothing_C)
...
AbcToNothing_classB_strategy = st.builds(AbcToNothing_classB)
