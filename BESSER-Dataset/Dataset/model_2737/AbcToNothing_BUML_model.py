...
# Classes
AbcToNothing_A = Class(name="AbcToNothing_A")
AbcToNothing_classB = Class(name="AbcToNothing_classB")
AbcToNothing_C = Class(name="AbcToNothing_C")
...
domain_model = DomainModel(
    name="AbcToNothing",
    types={AbcToNothing_A, AbcToNothing_classB, AbcToNothing_C},
