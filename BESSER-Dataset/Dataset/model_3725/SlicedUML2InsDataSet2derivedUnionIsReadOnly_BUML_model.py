...
domain_model = DomainModel(
    name="UML2",
    types={UML2_Property, StructuralFeature, UML2_StructuralFeature, UML2_ExtensionEnd, Property_, UML2_Port},
    associations={},
    generalizations={gen_UML2_Property_StructuralFeature, gen_UML2_ExtensionEnd_Property, gen_UML2_Port_Property},
    metadata=None
)
