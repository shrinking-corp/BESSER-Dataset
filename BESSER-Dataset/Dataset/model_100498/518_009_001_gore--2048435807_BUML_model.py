...
gore_DefinableRequirement.methods={gore_DefinableRequirement_m_checkState, gore_DefinableRequirement_m_end, gore_DefinableRequirement_m_start, gore_DefinableRequirement_m_success, gore_DefinableRequirement_m_fail}
...
gore_Requirement.methods={gore_Requirement_m_findGoalModel, gore_Requirement_m_getChildrenStateCount, gore_Requirement_m_replaceWith}
...
gore_PerformativeRequirement.methods={gore_PerformativeRequirement_m_cancel, gore_PerformativeRequirement_m_checkState}
...
gore_GoalModel.methods={gore_GoalModel_m_filterRelations, gore_GoalModel_m_filterRelations, gore_GoalModel_m_filterRelations, gore_GoalModel_m_getId, gore_GoalModel_m_filterRelations}
...
gore_Parameter_m_increment: Method = Method(name="increment", parameters={Parameter(name='gore_relation', type=StringType), Parameter(name='gore_value', type=StringType)})
gore_Parameter.attributes={gore_Parameter_metric, gore_Parameter_type, gore_Parameter_unit, gore_Parameter_value}
gore_Parameter.methods={gore_Parameter_m_withinBoundsOf, gore_Parameter_m_incrementableIn, gore_Parameter_m_addedTo, gore_Parameter_m_subtractedFrom, gore_Parameter_m_increment, gore_Parameter_m_fewerThan, gore_Parameter_m_createCopy, gore_Parameter_m_multipliedBy, gore_Parameter_m_greaterThan, gore_Parameter_m_equalTo}
...
gore_DifferentialRelation.attributes={gore_DifferentialRelation_lowerBound, gore_DifferentialRelation_upperBound, gore_DifferentialRelation_operator, gore_DifferentialRelation_value}
...
relations27: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="gore_GoalModel", type=gore_DifferentialRelation, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
...
domain_model = DomainModel(
    name="gore",
    types={gore_DefinableRequirement, Requirement, gore_Requirement, OclAny, gore_AwReq, gore_Softgoal, gore_QualityConstraint, gore_PerformativeRequirement, DefinableRequirement, gore_DomainAssumption, gore_Goal, PerformativeRequirement, gore_GoalModel, gore_Task, gore_Parameter, gore_DifferentialRelation, gore_Actor, gore_Configuration, DefinableRequirementState, DifferentialRelationOperator, MonitorableMethod, AggregationLevel, ParameterMetric, ParameterType, RefinementType},
    associations={parent3, children1, softgoal6, otherTargets7, target8, constraints5, goalModel11, parameters14, goalModel15, indicator18, parameter20, goalModel12, rootGoal22, actors23, configuration25, relations27, configuration29},
    generalizations={gen_gore_DefinableRequirement_Requirement, gen_gore_Requirement_OclAny, gen_gore_QualityConstraint_DefinableRequirement, gen_gore_AwReq_DefinableRequirement, gen_gore_Softgoal_Requirement, gen_gore_PerformativeRequirement_DefinableRequirement, gen_gore_DomainAssumption_DefinableRequirement, gen_gore_Goal_PerformativeRequirement, gen_gore_Task_PerformativeRequirement},
    metadata=None
)
