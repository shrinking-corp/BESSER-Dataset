...
class petrinetv3_Transition:
    ...
    def __init__(self, clock: int, name: str, tmin: int, tmax: int, Transition: "petrinetv3_Net" = None, petrinetv3_Transition: set["petrinetv3_Place"] = None, petrinetv3_Transition5: set["petrinetv3_Place"] = None, transitions: "petrinetv3_Net" = None):
        self.clock = clock
        self.name = name
        self.tmin = tmin
        self.tmax = tmax
...
class petrinetv3_Place:
    ...
    def __init__(self, name: str, initialTokens: int, petrinetv3_Place: "petrinetv3_Net" = None, petrinetv3_Place3: "petrinetv3_Transition" = None, petrinetv3_Place6: "petrinetv3_Transition" = None, petrinetv3_Place9: set["petrinetv3_Token"] = None):
        self.name = name
