...
# Classes
petrinetv3_Net = Class(name="petrinetv3_Net")
petrinetv3_Place = Class(name="petrinetv3_Place")
petrinetv3_Transition = Class(name="petrinetv3_Transition")
petrinetv3_Token = Class(name="petrinetv3_Token")
...
petrinetv3_Transition.attributes={petrinetv3_Transition_name, petrinetv3_Transition_clock, petrinetv3_Transition_tmin, petrinetv3_Transition_tmax}
...
domain_model = DomainModel(
    ...
    associations={places0, transitions1, input2, output4, parentNet7, tokens8},
    generalizations={},
    metadata=None
)
