...
employee_Employee.attributes={employee_Employee_name, employee_Employee_empID, employee_Employee_isManager}
...
domain_model = DomainModel(
    ...
    associations={department7, employees0, departments1, manager3, employees4, company6, manager10, directReports13, company15},
    generalizations={},
    metadata=None
)
