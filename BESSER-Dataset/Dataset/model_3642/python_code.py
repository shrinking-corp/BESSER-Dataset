...
class employee_Department:
    ...
    def __init__(self, deptID: int, name: str, Department8: "employee_Employee" = None, Department: "employee_Company" = None, employee_Department: "employee_Employee" = None, department: set["employee_Employee"] = None, departments: "employee_Company" = None):
        self.deptID = deptID
        self.name = name
