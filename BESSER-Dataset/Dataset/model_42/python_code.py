...
class adaptiveSystem_Condition(Node):
    ...
    def __init__(self, token: int, marked: bool, maximal: bool, minimal: bool, adaptiveSystem_Condition14: "adaptiveSystem_AdaptiveProcess" = None, adaptiveSystem_Condition: "adaptiveSystem_PreNet" = None, postConditions: set["adaptiveSystem_Event"] = None, preConditions: set["adaptiveSystem_Event"] = None, destination: set["adaptiveSystem_ArcToCondition"] = None, source: set["adaptiveSystem_ArcToEvent"] = None, Condition: "adaptiveSystem_Event" = None, Condition22: "adaptiveSystem_Event" = None, Condition30: "adaptiveSystem_ArcToEvent" = None, Condition38: "adaptiveSystem_ArcToCondition" = None):
        self.token = token
        self.marked = marked
...
class adaptiveSystem_Node(ABC):
    ...
    def __init__(self, name: str, abstract: bool, temp: str, disabledByAntiOclet: bool, disabledByConflict: bool, adaptiveSystem_Node: "adaptiveSystem_OccurrenceNet" = None):
        self.name = name
...
class adaptiveSystem_AdaptiveSystem:
    ...
    def __init__(self, setWellformednessToOclets: bool, adaptiveSystem_AdaptiveSystem: set["adaptiveSystem_Oclet"] = None, adaptiveSystem_AdaptiveSystem2: "adaptiveSystem_AdaptiveProcess" = None):
        ...
        pass
    @property
    def setWellformednessToOclets(self):
