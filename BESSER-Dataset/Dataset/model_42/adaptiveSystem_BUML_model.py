...
# Classes
adaptiveSystem_AdaptiveSystem = Class(name="adaptiveSystem_AdaptiveSystem")
adaptiveSystem_Oclet = Class(name="adaptiveSystem_Oclet")
adaptiveSystem_AdaptiveProcess = Class(name="adaptiveSystem_AdaptiveProcess")
adaptiveSystem_PreNet = Class(name="adaptiveSystem_PreNet")
adaptiveSystem_DoNet = Class(name="adaptiveSystem_DoNet")
adaptiveSystem_OccurrenceNet = Class(name="adaptiveSystem_OccurrenceNet", is_abstract=True)
adaptiveSystem_Node = Class(name="adaptiveSystem_Node", is_abstract=True)
adaptiveSystem_Arc = Class(name="adaptiveSystem_Arc")
OccurrenceNet = Class(name="OccurrenceNet")
adaptiveSystem_Condition = Class(name="adaptiveSystem_Condition")
Node = Class(name="Node")
adaptiveSystem_Event = Class(name="adaptiveSystem_Event")
adaptiveSystem_ArcToCondition = Class(name="adaptiveSystem_ArcToCondition")
adaptiveSystem_ArcToEvent = Class(name="adaptiveSystem_ArcToEvent")
Arc = Class(name="Arc")
...
adaptiveSystem_Oclet.attributes={adaptiveSystem_Oclet_quantor, adaptiveSystem_Oclet_name, adaptiveSystem_Oclet_orientation, adaptiveSystem_Oclet_wellFormed}
...
adaptiveSystem_Node.attributes={adaptiveSystem_Node_disabledByConflict, adaptiveSystem_Node_temp, adaptiveSystem_Node_disabledByAntiOclet, adaptiveSystem_Node_abstract, adaptiveSystem_Node_name}
...
adaptiveSystem_Condition.attributes={adaptiveSystem_Condition_marked, adaptiveSystem_Condition_maximal, adaptiveSystem_Condition_minimal, adaptiveSystem_Condition_token}
...
domain_model = DomainModel(
    name="adaptiveSystem",
    types={adaptiveSystem_AdaptiveSystem, adaptiveSystem_Oclet, adaptiveSystem_AdaptiveProcess, adaptiveSystem_PreNet, adaptiveSystem_DoNet, adaptiveSystem_OccurrenceNet, adaptiveSystem_Node, adaptiveSystem_Arc, OccurrenceNet, adaptiveSystem_Condition, Node, adaptiveSystem_Event, adaptiveSystem_ArcToCondition, adaptiveSystem_ArcToEvent, Arc, Orientation, Quantor, Temp},
    associations={markedConditions12, oclets0, adaptiveProcess1, preNet3, doNet5, nodes7, arcs8, markedConditions10, preEvents15, postEvents16, incoming18, outgoing19, preConditions20, postConditions21, incoming23, outgoing26, source29, destination31, source33, destination36},
    generalizations={gen_adaptiveSystem_DoNet_OccurrenceNet, gen_adaptiveSystem_PreNet_OccurrenceNet, gen_adaptiveSystem_AdaptiveProcess_OccurrenceNet, gen_adaptiveSystem_Condition_Node, gen_adaptiveSystem_Event_Node, gen_adaptiveSystem_ArcToEvent_Arc, gen_adaptiveSystem_ArcToCondition_Arc},
    metadata=None
)
