...
def test_dz_aklm_is_not_abstract():
    assert not inspect.isabstract(dz_aklm)


def test_dz_aklm_constructor_exists():
    assert callable(dz_aklm.__init__)


def test_dz_aklm_constructor_args():
    sig = inspect.signature(dz_aklm.__init__)
    params = list(sig.parameters.keys())



def test_cxw_is_not_abstract():
    assert not inspect.isabstract(cxw)


def test_cxw_constructor_exists():
    assert callable(cxw.__init__)


def test_cxw_constructor_args():
