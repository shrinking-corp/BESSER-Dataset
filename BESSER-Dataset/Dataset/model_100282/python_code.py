...
class tokentypes_TokenType:
    ...
    pass
class highlevelnets_tokentypes_TokenTypeElementNet(tokentypes_TokenType, common_IDiagramHolder):

    def __init__(self, type10: set["ElementNetMarked"] = None, highlevelnets_tokentypes_TokenTypeElementNet: "HighLevelPetriNet" = None, type14: set["TokenNet"] = None):
...
class highlevelnets_npndiagrams_NPNSymbolArcSN(IEntityIdentifiable):
    ...
    def __init__(self, bendpoints: str, arcs142: "NPNDiagramNetSystem" = None, highlevelnets_npndiagrams_NPNSymbolArcSN: "Arc" = None):
        self.bendpoints = bendpoints
        self.arcs142 = arcs142
    ...
    def highlevelnets_npndiagrams_NPNSymbolArcSN(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "Arc145"):
                opp_val = getattr(old_value, "Arc145", None)
                if opp_val == self:
                    setattr(old_value, "Arc145", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "Arc145"):
                opp_val = getattr(value, "Arc145", None)
                setattr(value, "Arc145", self)

    @property
    def arcs142(self):
        return self.__arcs142

    @arcs142.setter
    def arcs142(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_highlevelnets_npndiagrams_NPNSymbolArcSN__arcs142", None)
        self.__arcs142 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "NPNDiagramNetSystem143"):
                opp_val = getattr(old_value, "NPNDiagramNetSystem143", None)
                if opp_val == self:
                    setattr(old_value, "NPNDiagramNetSystem143", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "NPNDiagramNetSystem143"):
                opp_val = getattr(value, "NPNDiagramNetSystem143", None)
                setattr(value, "NPNDiagramNetSystem143", self)

class highlevelnets_npndiagrams_NPNSymbolNodeSN(IEntityIdentifiable):

    def __init__(self, constraints: str, highlevelnets_npndiagrams_NPNSymbolNodeSN: "Node" = None, nodes137: "NPNDiagramNetSystem" = None):
        self.constraints = constraints
        self.highlevelnets_npndiagrams_NPNSymbolNodeSN = highlevelnets_npndiagrams_NPNSymbolNodeSN
        self.nodes137 = nodes137
    ...
    @property
    def nodes137(self):
        return self.__nodes137

    @nodes137.setter
    def nodes137(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_highlevelnets_npndiagrams_NPNSymbolNodeSN__nodes137", None)
        self.__nodes137 = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "NPNDiagramNetSystem138"):
                opp_val = getattr(old_value, "NPNDiagramNetSystem138", None)
                if opp_val == self:
                    setattr(old_value, "NPNDiagramNetSystem138", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "NPNDiagramNetSystem138"):
                opp_val = getattr(value, "NPNDiagramNetSystem138", None)
                setattr(value, "NPNDiagramNetSystem138", self)
    ...
    def highlevelnets_npndiagrams_NPNSymbolNodeSN(self, value):
        ...
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "Node140"):
                opp_val = getattr(old_value, "Node140", None)
                if opp_val == self:
                    setattr(old_value, "Node140", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "Node140"):
                opp_val = getattr(value, "Node140", None)
                setattr(value, "Node140", self)
