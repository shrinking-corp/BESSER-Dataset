...
domain_model = DomainModel(
    name="ecore",
    types={FSM, ecore_ENamedElement, ecore_FSM, ecore_State, ecore_Transition, ecore_EClass},
    associations={source11, target13, myFSMs15, ownedState0, initialState1, finalState2, owningFSM5, outgoingTransition6, incomingTransition7, myClasses9},
