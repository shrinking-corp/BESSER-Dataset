...
class ecore_State:
    ...
    def __init__(self, name: str, State12: "ecore_Transition" = None, State14: "ecore_Transition" = None, State: "ecore_FSM" = None, ecore_State: "ecore_FSM" = None, ecore_State4: "ecore_FSM" = None, ownedState: "ecore_FSM" = None, source: set["ecore_Transition"] = None, target: set["ecore_Transition"] = None, ecore_State10: set["ecore_EClass"] = None):
        self.name = name
