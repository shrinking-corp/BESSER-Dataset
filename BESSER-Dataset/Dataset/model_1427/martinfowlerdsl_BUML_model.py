...
domain_model = DomainModel(
    ...
    types={martinfowlerdsl_AbstractEvent, martinfowlerdsl_Command, martinfowlerdsl_Transition, AbstractEvent, martinfowlerdsl_Event, martinfowlerdsl_StateMachine, martinfowlerdsl_State},
