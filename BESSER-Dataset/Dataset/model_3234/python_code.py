...
class ecdarText_ETLocation:
    ...
    def __init__(self, urgent: bool, universal: bool, name: str, ecdarText_ETLocation68: set["ecdarText_ETEdge"] = None, ecdarText_ETLocation: "ecdarText_ETSpecificationBody" = None, ecdarText_ETLocation57: "ecdarText_ETSpecificationBody" = None, ecdarText_ETLocation65: set["ecdarText_ETExpression"] = None, ecdarText_ETLocation78: "ecdarText_ETEdge" = None):
        self.urgent = urgent
...
class ecdarText_ETParameter:
    ...
    def __init__(self, name: str, ioType: str, ecdarText_ETParameter: "ecdarText_ETSpecificationTemplate" = None, ecdarText_ETParameter59: "ecdarText_ETType" = None, ecdarText_ETParameter62: set["ecdarText_ETArrayDeclaration"] = None):
        self.name = name
        self.ioType = ioType
...
class ecdarText_ETVariableID:
    ...
    def __init__(self, ioType: str, name: str, ecdarText_ETVariableID16: set["ecdarText_ETArrayDeclaration"] = None, ecdarText_ETVariableID19: "ecdarText_ETInitialiser" = None, ecdarText_ETVariableID: "ecdarText_ETVariableDeclaration" = None):
        self.ioType = ioType
        self.name = name
