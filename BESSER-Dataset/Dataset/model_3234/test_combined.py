...
def test_hyp_ecdartext_eobject_is_not_abstract():
    assert not inspect.isabstract(ecdarText_EObject)


def test_hyp_ecdartext_eobject_constructor_exists():
    assert callable(ecdarText_EObject.__init__)


def test_hyp_ecdartext_eobject_constructor_args():
    sig = inspect.signature(ecdarText_EObject.__init__)
    params = list(sig.parameters.keys())



def test_hyp_etexpression_is_not_abstract():
    assert not inspect.isabstract(ETExpression)


def test_hyp_etexpression_constructor_exists():
    assert callable(ETExpression.__init__)


def test_hyp_etexpression_constructor_args():
    sig = inspect.signature(ETExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etarrayexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETArrayExpression)


def test_hyp_ecdartext_etarrayexpression_constructor_exists():
    assert callable(ecdarText_ETArrayExpression.__init__)


def test_hyp_ecdartext_etarrayexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETArrayExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etdivideexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETDivideExpression)


def test_hyp_ecdartext_etdivideexpression_constructor_exists():
    assert callable(ecdarText_ETDivideExpression.__init__)


def test_hyp_ecdartext_etdivideexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETDivideExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etimplyexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETImplyExpression)


def test_hyp_ecdartext_etimplyexpression_constructor_exists():
    assert callable(ecdarText_ETImplyExpression.__init__)


def test_hyp_ecdartext_etimplyexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETImplyExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etpreincrementexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETPreIncrementExpression)


def test_hyp_ecdartext_etpreincrementexpression_constructor_exists():
    assert callable(ecdarText_ETPreIncrementExpression.__init__)


def test_hyp_ecdartext_etpreincrementexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETPreIncrementExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etsubtractexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETSubtractExpression)


def test_hyp_ecdartext_etsubtractexpression_constructor_exists():
    assert callable(ecdarText_ETSubtractExpression.__init__)


def test_hyp_ecdartext_etsubtractexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETSubtractExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etmultiplicationassignmentexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETMultiplicationAssignmentExpression)


def test_hyp_ecdartext_etmultiplicationassignmentexpression_constructor_exists():
    assert callable(ecdarText_ETMultiplicationAssignmentExpression.__init__)


def test_hyp_ecdartext_etmultiplicationassignmentexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETMultiplicationAssignmentExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etminexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETMinExpression)


def test_hyp_ecdartext_etminexpression_constructor_exists():
    assert callable(ecdarText_ETMinExpression.__init__)


def test_hyp_ecdartext_etminexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETMinExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etpostdecrementexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETPostDecrementExpression)


def test_hyp_ecdartext_etpostdecrementexpression_constructor_exists():
    assert callable(ecdarText_ETPostDecrementExpression.__init__)


def test_hyp_ecdartext_etpostdecrementexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETPostDecrementExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etlogicnotexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETLogicNotExpression)


def test_hyp_ecdartext_etlogicnotexpression_constructor_exists():
    assert callable(ecdarText_ETLogicNotExpression.__init__)


def test_hyp_ecdartext_etlogicnotexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETLogicNotExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etlogicorexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETLogicOrExpression)


def test_hyp_ecdartext_etlogicorexpression_constructor_exists():
    assert callable(ecdarText_ETLogicOrExpression.__init__)


def test_hyp_ecdartext_etlogicorexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETLogicOrExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etdivisionassignmentexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETDivisionAssignmentExpression)


def test_hyp_ecdartext_etdivisionassignmentexpression_constructor_exists():
    assert callable(ecdarText_ETDivisionAssignmentExpression.__init__)


def test_hyp_ecdartext_etdivisionassignmentexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETDivisionAssignmentExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etlessequalexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETLessEqualExpression)


def test_hyp_ecdartext_etlessequalexpression_constructor_exists():
    assert callable(ecdarText_ETLessEqualExpression.__init__)


def test_hyp_ecdartext_etlessequalexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETLessEqualExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etbooleanliteral_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETBooleanLiteral)


def test_hyp_ecdartext_etbooleanliteral_constructor_exists():
    assert callable(ecdarText_ETBooleanLiteral.__init__)


def test_hyp_ecdartext_etbooleanliteral_constructor_args():
...
def test_hyp_ecdartext_etpostincrementexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETPostIncrementExpression)


def test_hyp_ecdartext_etpostincrementexpression_constructor_exists():
    assert callable(ecdarText_ETPostIncrementExpression.__init__)


def test_hyp_ecdartext_etpostincrementexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETPostIncrementExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etbitxorassignmentexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETBitXORAssignmentExpression)


def test_hyp_ecdartext_etbitxorassignmentexpression_constructor_exists():
    assert callable(ecdarText_ETBitXORAssignmentExpression.__init__)


def test_hyp_ecdartext_etbitxorassignmentexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETBitXORAssignmentExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etexistsexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETExistsExpression)


def test_hyp_ecdartext_etexistsexpression_constructor_exists():
    assert callable(ecdarText_ETExistsExpression.__init__)


def test_hyp_ecdartext_etexistsexpression_constructor_args():
...
def test_hyp_ecdartext_etmultiplyexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETMultiplyExpression)


def test_hyp_ecdartext_etmultiplyexpression_constructor_exists():
    assert callable(ecdarText_ETMultiplyExpression.__init__)


def test_hyp_ecdartext_etmultiplyexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETMultiplyExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etmaxexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETMaxExpression)


def test_hyp_ecdartext_etmaxexpression_constructor_exists():
    assert callable(ecdarText_ETMaxExpression.__init__)


def test_hyp_ecdartext_etmaxexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETMaxExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etbitleftassignmentexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETBitLeftAssignmentExpression)


def test_hyp_ecdartext_etbitleftassignmentexpression_constructor_exists():
    assert callable(ecdarText_ETBitLeftAssignmentExpression.__init__)


def test_hyp_ecdartext_etbitleftassignmentexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETBitLeftAssignmentExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etbitandassignmentexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETBitAndAssignmentExpression)


def test_hyp_ecdartext_etbitandassignmentexpression_constructor_exists():
    assert callable(ecdarText_ETBitAndAssignmentExpression.__init__)


def test_hyp_ecdartext_etbitandassignmentexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETBitAndAssignmentExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etnumberliteral_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETNumberLiteral)


def test_hyp_ecdartext_etnumberliteral_constructor_exists():
    assert callable(ecdarText_ETNumberLiteral.__init__)


def test_hyp_ecdartext_etnumberliteral_constructor_args():
...
def test_hyp_ecdartext_etmoduloassignmentexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETModuloAssignmentExpression)


def test_hyp_ecdartext_etmoduloassignmentexpression_constructor_exists():
    assert callable(ecdarText_ETModuloAssignmentExpression.__init__)


def test_hyp_ecdartext_etmoduloassignmentexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETModuloAssignmentExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etassignmentexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETAssignmentExpression)


def test_hyp_ecdartext_etassignmentexpression_constructor_exists():
    assert callable(ecdarText_ETAssignmentExpression.__init__)


def test_hyp_ecdartext_etassignmentexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETAssignmentExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etreference_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETReference)


def test_hyp_ecdartext_etreference_constructor_exists():
    assert callable(ecdarText_ETReference.__init__)


def test_hyp_ecdartext_etreference_constructor_args():
    sig = inspect.signature(ecdarText_ETReference.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etlessexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETLessExpression)


def test_hyp_ecdartext_etlessexpression_constructor_exists():
    assert callable(ecdarText_ETLessExpression.__init__)


def test_hyp_ecdartext_etlessexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETLessExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etminusexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETMinusExpression)


def test_hyp_ecdartext_etminusexpression_constructor_exists():
    assert callable(ecdarText_ETMinusExpression.__init__)


def test_hyp_ecdartext_etminusexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETMinusExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etbitandexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETBitAndExpression)


def test_hyp_ecdartext_etbitandexpression_constructor_exists():
    assert callable(ecdarText_ETBitAndExpression.__init__)


def test_hyp_ecdartext_etbitandexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETBitAndExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etgreaterequalexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETGreaterEqualExpression)


def test_hyp_ecdartext_etgreaterequalexpression_constructor_exists():
    assert callable(ecdarText_ETGreaterEqualExpression.__init__)


def test_hyp_ecdartext_etgreaterequalexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETGreaterEqualExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etstructexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETStructExpression)


def test_hyp_ecdartext_etstructexpression_constructor_exists():
    assert callable(ecdarText_ETStructExpression.__init__)


def test_hyp_ecdartext_etstructexpression_constructor_args():
...
def test_hyp_ecdartext_etgreaterexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETGreaterExpression)


def test_hyp_ecdartext_etgreaterexpression_constructor_exists():
    assert callable(ecdarText_ETGreaterExpression.__init__)


def test_hyp_ecdartext_etgreaterexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETGreaterExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etsubtractionassignmentexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETSubtractionAssignmentExpression)


def test_hyp_ecdartext_etsubtractionassignmentexpression_constructor_exists():
    assert callable(ecdarText_ETSubtractionAssignmentExpression.__init__)


def test_hyp_ecdartext_etsubtractionassignmentexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETSubtractionAssignmentExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etunequalexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETUnequalExpression)


def test_hyp_ecdartext_etunequalexpression_constructor_exists():
    assert callable(ecdarText_ETUnequalExpression.__init__)


def test_hyp_ecdartext_etunequalexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETUnequalExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etbitrightexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETBitRightExpression)


def test_hyp_ecdartext_etbitrightexpression_constructor_exists():
    assert callable(ecdarText_ETBitRightExpression.__init__)


def test_hyp_ecdartext_etbitrightexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETBitRightExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etbitleftexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETBitLeftExpression)


def test_hyp_ecdartext_etbitleftexpression_constructor_exists():
    assert callable(ecdarText_ETBitLeftExpression.__init__)


def test_hyp_ecdartext_etbitleftexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETBitLeftExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etbitxorexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETBitXORExpression)


def test_hyp_ecdartext_etbitxorexpression_constructor_exists():
    assert callable(ecdarText_ETBitXORExpression.__init__)


def test_hyp_ecdartext_etbitxorexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETBitXORExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etconditionalexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETConditionalExpression)


def test_hyp_ecdartext_etconditionalexpression_constructor_exists():
    assert callable(ecdarText_ETConditionalExpression.__init__)


def test_hyp_ecdartext_etconditionalexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETConditionalExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etbitorassignmentexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETBitOrAssignmentExpression)


def test_hyp_ecdartext_etbitorassignmentexpression_constructor_exists():
    assert callable(ecdarText_ETBitOrAssignmentExpression.__init__)


def test_hyp_ecdartext_etbitorassignmentexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETBitOrAssignmentExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etlogicandexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETLogicAndExpression)


def test_hyp_ecdartext_etlogicandexpression_constructor_exists():
    assert callable(ecdarText_ETLogicAndExpression.__init__)


def test_hyp_ecdartext_etlogicandexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETLogicAndExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etpredecrementexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETPreDecrementExpression)


def test_hyp_ecdartext_etpredecrementexpression_constructor_exists():
    assert callable(ecdarText_ETPreDecrementExpression.__init__)


def test_hyp_ecdartext_etpredecrementexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETPreDecrementExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etmoduloexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETModuloExpression)


def test_hyp_ecdartext_etmoduloexpression_constructor_exists():
    assert callable(ecdarText_ETModuloExpression.__init__)


def test_hyp_ecdartext_etmoduloexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETModuloExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etaddexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETAddExpression)


def test_hyp_ecdartext_etaddexpression_constructor_exists():
    assert callable(ecdarText_ETAddExpression.__init__)


def test_hyp_ecdartext_etaddexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETAddExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etbitrightassignmentexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETBitRightAssignmentExpression)


def test_hyp_ecdartext_etbitrightassignmentexpression_constructor_exists():
    assert callable(ecdarText_ETBitRightAssignmentExpression.__init__)


def test_hyp_ecdartext_etbitrightassignmentexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETBitRightAssignmentExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etequalexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETEqualExpression)


def test_hyp_ecdartext_etequalexpression_constructor_exists():
    assert callable(ecdarText_ETEqualExpression.__init__)


def test_hyp_ecdartext_etequalexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETEqualExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etbitorexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETBitOrExpression)


def test_hyp_ecdartext_etbitorexpression_constructor_exists():
    assert callable(ecdarText_ETBitOrExpression.__init__)


def test_hyp_ecdartext_etbitorexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETBitOrExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etforallexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETForallExpression)


def test_hyp_ecdartext_etforallexpression_constructor_exists():
    assert callable(ecdarText_ETForallExpression.__init__)


def test_hyp_ecdartext_etforallexpression_constructor_args():
...
def test_hyp_ecdartext_etadditionassignmentexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETAdditionAssignmentExpression)


def test_hyp_ecdartext_etadditionassignmentexpression_constructor_exists():
    assert callable(ecdarText_ETAdditionAssignmentExpression.__init__)


def test_hyp_ecdartext_etadditionassignmentexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETAdditionAssignmentExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_etspecificationexpression_is_not_abstract():
    assert not inspect.isabstract(ETSpecificationExpression)


def test_hyp_etspecificationexpression_constructor_exists():
    assert callable(ETSpecificationExpression.__init__)


def test_hyp_etspecificationexpression_constructor_args():
    sig = inspect.signature(ETSpecificationExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etspecificationcompositionexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETSpecificationCompositionExpression)


def test_hyp_ecdartext_etspecificationcompositionexpression_constructor_exists():
    assert callable(ecdarText_ETSpecificationCompositionExpression.__init__)


def test_hyp_ecdartext_etspecificationcompositionexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETSpecificationCompositionExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etspecificationreference_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETSpecificationReference)


def test_hyp_ecdartext_etspecificationreference_constructor_exists():
    assert callable(ecdarText_ETSpecificationReference.__init__)


def test_hyp_ecdartext_etspecificationreference_constructor_args():
    sig = inspect.signature(ecdarText_ETSpecificationReference.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etspecificationconjunctionexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETSpecificationConjunctionExpression)


def test_hyp_ecdartext_etspecificationconjunctionexpression_constructor_exists():
    assert callable(ecdarText_ETSpecificationConjunctionExpression.__init__)


def test_hyp_ecdartext_etspecificationconjunctionexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETSpecificationConjunctionExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etspecificationdisjunctionexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETSpecificationDisjunctionExpression)


def test_hyp_ecdartext_etspecificationdisjunctionexpression_constructor_exists():
    assert callable(ecdarText_ETSpecificationDisjunctionExpression.__init__)


def test_hyp_ecdartext_etspecificationdisjunctionexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETSpecificationDisjunctionExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etspecificationinstantiation_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETSpecificationInstantiation)


def test_hyp_ecdartext_etspecificationinstantiation_constructor_exists():
    assert callable(ecdarText_ETSpecificationInstantiation.__init__)


def test_hyp_ecdartext_etspecificationinstantiation_constructor_args():
    sig = inspect.signature(ecdarText_ETSpecificationInstantiation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etedge_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETEdge)


def test_hyp_ecdartext_etedge_constructor_exists():
    assert callable(ecdarText_ETEdge.__init__)


def test_hyp_ecdartext_etedge_constructor_args():
...
def test_hyp_ecdartext_etlocation_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETLocation)


def test_hyp_ecdartext_etlocation_constructor_exists():
    assert callable(ecdarText_ETLocation.__init__)


def test_hyp_ecdartext_etlocation_constructor_args():
...
def test_hyp_ecdartext_etparameter_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETParameter)


def test_hyp_ecdartext_etparameter_constructor_exists():
    assert callable(ecdarText_ETParameter.__init__)


def test_hyp_ecdartext_etparameter_constructor_args():
...
def test_hyp_etspecificationdefinition_is_not_abstract():
    assert not inspect.isabstract(ETSpecificationDefinition)


def test_hyp_etspecificationdefinition_constructor_exists():
    assert callable(ETSpecificationDefinition.__init__)


def test_hyp_etspecificationdefinition_constructor_args():
    sig = inspect.signature(ETSpecificationDefinition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etspecificationtemplate_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETSpecificationTemplate)


def test_hyp_ecdartext_etspecificationtemplate_constructor_exists():
    assert callable(ecdarText_ETSpecificationTemplate.__init__)


def test_hyp_ecdartext_etspecificationtemplate_constructor_args():
    sig = inspect.signature(ecdarText_ETSpecificationTemplate.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etspecificationbody_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETSpecificationBody)


def test_hyp_ecdartext_etspecificationbody_constructor_exists():
    assert callable(ecdarText_ETSpecificationBody.__init__)


def test_hyp_ecdartext_etspecificationbody_constructor_args():
    sig = inspect.signature(ecdarText_ETSpecificationBody.__init__)
    params = list(sig.parameters.keys())



def test_hyp_etspecification_is_not_abstract():
    assert not inspect.isabstract(ETSpecification)


def test_hyp_etspecification_constructor_exists():
    assert callable(ETSpecification.__init__)


def test_hyp_etspecification_constructor_args():
    sig = inspect.signature(ETSpecification.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etspecificationdefinition_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETSpecificationDefinition)


def test_hyp_ecdartext_etspecificationdefinition_constructor_exists():
    assert callable(ecdarText_ETSpecificationDefinition.__init__)


def test_hyp_ecdartext_etspecificationdefinition_constructor_args():
    sig = inspect.signature(ecdarText_ETSpecificationDefinition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etspecificationbinding_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETSpecificationBinding)


def test_hyp_ecdartext_etspecificationbinding_constructor_exists():
    assert callable(ecdarText_ETSpecificationBinding.__init__)


def test_hyp_ecdartext_etspecificationbinding_constructor_args():
    sig = inspect.signature(ecdarText_ETSpecificationBinding.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etspecificationexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETSpecificationExpression)


def test_hyp_ecdartext_etspecificationexpression_constructor_exists():
    assert callable(ecdarText_ETSpecificationExpression.__init__)


def test_hyp_ecdartext_etspecificationexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETSpecificationExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etio_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETIO)


def test_hyp_ecdartext_etio_constructor_exists():
    assert callable(ecdarText_ETIO.__init__)


def test_hyp_ecdartext_etio_constructor_args():
...
def test_hyp_ecdartext_etselect_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETSelect)


def test_hyp_ecdartext_etselect_constructor_exists():
    assert callable(ecdarText_ETSelect.__init__)


def test_hyp_ecdartext_etselect_constructor_args():
...
def test_hyp_ecdartext_etfielddeclaration_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETFieldDeclaration)


def test_hyp_ecdartext_etfielddeclaration_constructor_exists():
    assert callable(ecdarText_ETFieldDeclaration.__init__)


def test_hyp_ecdartext_etfielddeclaration_constructor_args():
    sig = inspect.signature(ecdarText_ETFieldDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_etactiontype_is_not_abstract():
    assert not inspect.isabstract(ETActionType)


def test_hyp_etactiontype_constructor_exists():
    assert callable(ETActionType.__init__)


def test_hyp_etactiontype_constructor_args():
    sig = inspect.signature(ETActionType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etoutputtype_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETOutputType)


def test_hyp_ecdartext_etoutputtype_constructor_exists():
    assert callable(ecdarText_ETOutputType.__init__)


def test_hyp_ecdartext_etoutputtype_constructor_args():
    sig = inspect.signature(ecdarText_ETOutputType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etinputtype_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETInputType)


def test_hyp_ecdartext_etinputtype_constructor_exists():
    assert callable(ecdarText_ETInputType.__init__)


def test_hyp_ecdartext_etinputtype_constructor_args():
    sig = inspect.signature(ecdarText_ETInputType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ettypeidentifier_is_not_abstract():
    assert not inspect.isabstract(ETTypeIdentifier)


def test_hyp_ettypeidentifier_constructor_exists():
    assert callable(ETTypeIdentifier.__init__)


def test_hyp_ettypeidentifier_constructor_args():
    sig = inspect.signature(ETTypeIdentifier.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etclocktype_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETClockType)


def test_hyp_ecdartext_etclocktype_constructor_exists():
    assert callable(ecdarText_ETClockType.__init__)


def test_hyp_ecdartext_etclocktype_constructor_args():
    sig = inspect.signature(ecdarText_ETClockType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_ettypereference_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETTypeReference)


def test_hyp_ecdartext_ettypereference_constructor_exists():
    assert callable(ecdarText_ETTypeReference.__init__)


def test_hyp_ecdartext_ettypereference_constructor_args():
    sig = inspect.signature(ecdarText_ETTypeReference.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etstructtype_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETStructType)


def test_hyp_ecdartext_etstructtype_constructor_exists():
    assert callable(ecdarText_ETStructType.__init__)


def test_hyp_ecdartext_etstructtype_constructor_args():
    sig = inspect.signature(ecdarText_ETStructType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etactiontype_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETActionType)


def test_hyp_ecdartext_etactiontype_constructor_exists():
    assert callable(ecdarText_ETActionType.__init__)


def test_hyp_ecdartext_etactiontype_constructor_args():
    sig = inspect.signature(ecdarText_ETActionType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etscalartype_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETScalarType)


def test_hyp_ecdartext_etscalartype_constructor_exists():
    assert callable(ecdarText_ETScalarType.__init__)


def test_hyp_ecdartext_etscalartype_constructor_args():
    sig = inspect.signature(ecdarText_ETScalarType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etbooleantype_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETBooleanType)


def test_hyp_ecdartext_etbooleantype_constructor_exists():
    assert callable(ecdarText_ETBooleanType.__init__)


def test_hyp_ecdartext_etbooleantype_constructor_args():
    sig = inspect.signature(ecdarText_ETBooleanType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etintegertype_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETIntegerType)


def test_hyp_ecdartext_etintegertype_constructor_exists():
    assert callable(ecdarText_ETIntegerType.__init__)


def test_hyp_ecdartext_etintegertype_constructor_args():
    sig = inspect.signature(ecdarText_ETIntegerType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_ettypeid_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETTypeID)


def test_hyp_ecdartext_ettypeid_constructor_exists():
    assert callable(ecdarText_ETTypeID.__init__)


def test_hyp_ecdartext_ettypeid_constructor_args():
...
def test_hyp_etinitialiser_is_not_abstract():
    assert not inspect.isabstract(ETInitialiser)


def test_hyp_etinitialiser_constructor_exists():
    assert callable(ETInitialiser.__init__)


def test_hyp_etinitialiser_constructor_args():
    sig = inspect.signature(ETInitialiser.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etmultiinitialiser_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETMultiInitialiser)


def test_hyp_ecdartext_etmultiinitialiser_constructor_exists():
    assert callable(ecdarText_ETMultiInitialiser.__init__)


def test_hyp_ecdartext_etmultiinitialiser_constructor_args():
    sig = inspect.signature(ecdarText_ETMultiInitialiser.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etsingleinitialiser_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETSingleInitialiser)


def test_hyp_ecdartext_etsingleinitialiser_constructor_exists():
    assert callable(ecdarText_ETSingleInitialiser.__init__)


def test_hyp_ecdartext_etsingleinitialiser_constructor_args():
    sig = inspect.signature(ecdarText_ETSingleInitialiser.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etfieldid_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETFieldID)


def test_hyp_ecdartext_etfieldid_constructor_exists():
    assert callable(ecdarText_ETFieldID.__init__)


def test_hyp_ecdartext_etfieldid_constructor_args():
...
def test_hyp_ecdartext_etvariableid_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETVariableID)


def test_hyp_ecdartext_etvariableid_constructor_exists():
    assert callable(ecdarText_ETVariableID.__init__)


def test_hyp_ecdartext_etvariableid_constructor_args():
...
def test_hyp_etdeclaration_is_not_abstract():
    assert not inspect.isabstract(ETDeclaration)


def test_hyp_etdeclaration_constructor_exists():
    assert callable(ETDeclaration.__init__)


def test_hyp_etdeclaration_constructor_args():
    sig = inspect.signature(ETDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_ettypedeclaration_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETTypeDeclaration)


def test_hyp_ecdartext_ettypedeclaration_constructor_exists():
    assert callable(ecdarText_ETTypeDeclaration.__init__)


def test_hyp_ecdartext_ettypedeclaration_constructor_args():
    sig = inspect.signature(ecdarText_ETTypeDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etvariabledeclaration_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETVariableDeclaration)


def test_hyp_ecdartext_etvariabledeclaration_constructor_exists():
    assert callable(ecdarText_ETVariableDeclaration.__init__)


def test_hyp_ecdartext_etvariabledeclaration_constructor_args():
    sig = inspect.signature(ecdarText_ETVariableDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_ettypeidentifier_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETTypeIdentifier)


def test_hyp_ecdartext_ettypeidentifier_constructor_exists():
    assert callable(ecdarText_ETTypeIdentifier.__init__)


def test_hyp_ecdartext_ettypeidentifier_constructor_args():
    sig = inspect.signature(ecdarText_ETTypeIdentifier.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_ettypemodifiers_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETTypeModifiers)


def test_hyp_ecdartext_ettypemodifiers_constructor_exists():
    assert callable(ecdarText_ETTypeModifiers.__init__)


def test_hyp_ecdartext_ettypemodifiers_constructor_args():
...
def test_hyp_ecdartext_ettype_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETType)


def test_hyp_ecdartext_ettype_constructor_exists():
    assert callable(ecdarText_ETType.__init__)


def test_hyp_ecdartext_ettype_constructor_args():
    sig = inspect.signature(ecdarText_ETType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etdeclaration_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETDeclaration)


def test_hyp_ecdartext_etdeclaration_constructor_exists():
    assert callable(ecdarText_ETDeclaration.__init__)


def test_hyp_ecdartext_etdeclaration_constructor_args():
    sig = inspect.signature(ecdarText_ETDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etexpression_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETExpression)


def test_hyp_ecdartext_etexpression_constructor_exists():
    assert callable(ecdarText_ETExpression.__init__)


def test_hyp_ecdartext_etexpression_constructor_args():
    sig = inspect.signature(ecdarText_ETExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etarraydeclaration_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETArrayDeclaration)


def test_hyp_ecdartext_etarraydeclaration_constructor_exists():
    assert callable(ecdarText_ETArrayDeclaration.__init__)


def test_hyp_ecdartext_etarraydeclaration_constructor_args():
    sig = inspect.signature(ecdarText_ETArrayDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etspecification_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETSpecification)


def test_hyp_ecdartext_etspecification_constructor_exists():
    assert callable(ecdarText_ETSpecification.__init__)


def test_hyp_ecdartext_etspecification_constructor_args():
...
def test_hyp_ecdartext_etdeclarations_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETDeclarations)


def test_hyp_ecdartext_etdeclarations_constructor_exists():
    assert callable(ecdarText_ETDeclarations.__init__)


def test_hyp_ecdartext_etdeclarations_constructor_args():
    sig = inspect.signature(ecdarText_ETDeclarations.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etimport_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETImport)


def test_hyp_ecdartext_etimport_constructor_exists():
    assert callable(ecdarText_ETImport.__init__)


def test_hyp_ecdartext_etimport_constructor_args():
...
def test_hyp_ecdartext_etfile_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETFile)


def test_hyp_ecdartext_etfile_constructor_exists():
    assert callable(ecdarText_ETFile.__init__)


def test_hyp_ecdartext_etfile_constructor_args():
    sig = inspect.signature(ecdarText_ETFile.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ecdartext_etinitialiser_is_not_abstract():
    assert not inspect.isabstract(ecdarText_ETInitialiser)


def test_hyp_ecdartext_etinitialiser_constructor_exists():
    assert callable(ecdarText_ETInitialiser.__init__)


def test_hyp_ecdartext_etinitialiser_constructor_args():
    sig = inspect.signature(ecdarText_ETInitialiser.__init__)
    params = list(sig.parameters.keys())

def test_hyp_etiotype_exists():
    # Check that the Enumeration exists
    assert ETIOType is not None

def test_hyp_etiotype_has_all_literals():
...
def test_hyp_ecdartext_etbooleanliteral_value_setter(instance):
...
def test_hyp_ecdartext_etexistsexpression_name_setter(instance):
...
def test_hyp_ecdartext_etnumberliteral_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_ecdartext_etstructexpression_right_setter(instance):
...
def test_hyp_ecdartext_etforallexpression_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_ecdartext_etedge_controllable_setter(instance):
...
def test_hyp_ecdartext_etlocation_urgent_setter(instance):
...
@given(instance=ecdarText_ETLocation_strategy)
def test_hyp_ecdartext_etlocation_universal_setter(instance):
...
@given(instance=ecdarText_ETLocation_strategy)
def test_hyp_ecdartext_etlocation_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_ecdartext_etparameter_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=ecdarText_ETParameter_strategy)
def test_hyp_ecdartext_etparameter_ioType_setter(instance):
...
def test_hyp_ecdartext_etio_type_setter(instance):
...
def test_hyp_ecdartext_etselect_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_ecdartext_ettypeid_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_ecdartext_etfieldid_ioType_setter(instance):
    original = instance.ioType
    instance.ioType = original
    assert instance.ioType == original
...
@given(instance=ecdarText_ETFieldID_strategy)
def test_hyp_ecdartext_etfieldid_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_ecdartext_etvariableid_ioType_setter(instance):
    original = instance.ioType
    instance.ioType = original
    assert instance.ioType == original
...
@given(instance=ecdarText_ETVariableID_strategy)
def test_hyp_ecdartext_etvariableid_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_ecdartext_ettypemodifiers_urgent_setter(instance):
    original = instance.urgent
    instance.urgent = original
    assert instance.urgent == original
...
@given(instance=ecdarText_ETTypeModifiers_strategy)
def test_hyp_ecdartext_ettypemodifiers_meta_setter(instance):
...
@given(instance=ecdarText_ETTypeModifiers_strategy)
def test_hyp_ecdartext_ettypemodifiers_const_setter(instance):
...
def test_hyp_ecdartext_etspecification_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_ecdartext_etimport_importedNamespace_setter(instance):
