...
class classDiagram_Function(ModelingConcept):
    ...
    def __init__(self, accessModifier: str, isStatic: bool, isAbstract: bool, body: str, classDiagram_Function14: "classDiagram_Classifier" = None, classDiagram_Function17: set["classDiagram_Attribute"] = None, classDiagram_Function: "classDiagram_Class" = None):
        self.accessModifier = accessModifier
        self.isStatic = isStatic
        self.isAbstract = isAbstract
        self.body = body
