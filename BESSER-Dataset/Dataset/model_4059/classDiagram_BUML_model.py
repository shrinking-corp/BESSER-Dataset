...
classDiagram_Function = Class(name="classDiagram_Function")
...
classDiagram_Class.attributes={classDiagram_Class_isStatic, classDiagram_Class_isAbstract, classDiagram_Class_accessModifier}
...
classDiagram_Function.attributes={classDiagram_Function_body, classDiagram_Function_isAbstract, classDiagram_Function_accessModifier, classDiagram_Function_isStatic}
...
domain_model = DomainModel(
    name="classDiagram",
    types={classDiagram_ClassModel, classDiagram_Package, classDiagram_ModelingConcept, ModelingConcept, classDiagram_Class, Classifier, classDiagram_Attribute, classDiagram_Classifier, classDiagram_Type, classDiagram_Function, AccessModifier},
    associations={packages0, elements1, fields3, type11, returnType13, parameters16, supertypes5, subtypes7, methods9},
