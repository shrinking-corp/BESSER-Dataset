...
def test_hyp_classdiagram_function_is_not_abstract():
    assert not inspect.isabstract(classDiagram_Function)


def test_hyp_classdiagram_function_constructor_exists():
    assert callable(classDiagram_Function.__init__)


def test_hyp_classdiagram_function_constructor_args():
...
def test_hyp_classdiagram_function_accessModifier_setter(instance):
    original = instance.accessModifier
    instance.accessModifier = original
    assert instance.accessModifier == original
...
@given(instance=classDiagram_Function_strategy)
def test_hyp_classdiagram_function_body_setter(instance):
...
@given(instance=classDiagram_Function_strategy)
def test_hyp_classdiagram_function_isAbstract_setter(instance):
    original = instance.isAbstract
    instance.isAbstract = original
    assert instance.isAbstract == original
...
@given(instance=classDiagram_Function_strategy)
def test_hyp_classdiagram_function_isStatic_setter(instance):
    original = instance.isStatic
    instance.isStatic = original
    assert instance.isStatic == original
