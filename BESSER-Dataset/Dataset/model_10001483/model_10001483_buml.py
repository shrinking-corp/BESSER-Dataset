...
App_User_Actor = Class(name="App_User_Actor")
Admin_____________backend__Actor = Class(name="Admin_____________backend__Actor")
Apply_for_Job_UseCase = Class(name="Apply_for_Job_UseCase")
Manage_database_UseCase = Class(name="Manage_database_UseCase")
Security_UseCase = Class(name="Security_UseCase")
Set_Profile_UseCase = Class(name="Set_Profile_UseCase")
...
Add__Update_and_Delete_job_UseCase = Class(name="Add__Update_and_Delete_job_UseCase")
User = Class(name="User")
Employer = Class(name="Employer")
Administrator = Class(name="Administrator")
JobSeeker = Class(name="JobSeeker")
Admin_login__firebase__UseCase = Class(name="Admin_login__firebase__UseCase")
Support_Services_UseCase = Class(name="Support_Services_UseCase")
Login_UseCase = Class(name="Login_UseCase")
...
# App_User_Actor class attributes and methods

# Admin_____________backend__Actor class attributes and methods

# Apply_for_Job_UseCase class attributes and methods

# Manage_database_UseCase class attributes and methods

# Security_UseCase class attributes and methods

# Set_Profile_UseCase class attributes and methods
...
# Add__Update_and_Delete_job_UseCase class attributes and methods
...
Administrator.attributes={Administrator_Name, Administrator_Address, Administrator_Company}
...
JobSeeker.attributes={JobSeeker_Name, JobSeeker_Experience, JobSeeker_Qualification}

# Admin_login__firebase__UseCase class attributes and methods

# Support_Services_UseCase class attributes and methods
...
Job_Seeker_login: BinaryAssociation = BinaryAssociation(
    name="Job_Seeker_login",
    ends={
        Property(name="login12", type=Login_UseCase, multiplicity=Multiplicity(0, 1)),
        Property(name="job_Seeker13", type=App_User_Actor, multiplicity=Multiplicity(0, 1))
    }
)
Job_Seeker_search_jobs: BinaryAssociation = BinaryAssociation(
    name="Job_Seeker_search_jobs",
    ends={
        Property(name="search_jobs14", type=Search_Jobs_UseCase, multiplicity=Multiplicity(0, 1)),
        Property(name="job_Seeker15", type=App_User_Actor, multiplicity=Multiplicity(0, 1))
    }
)
Administrator_Job_seeker: BinaryAssociation = BinaryAssociation(
    name="Administrator_Job_seeker",
    ends={
        Property(name="jobseeker34", type=JobSeeker, multiplicity=Multiplicity(0, 1)),
        Property(name="administrator35", type=Administrator, multiplicity=Multiplicity(0, 1))
    }
)
Administrator__backend__Admin_login__firebase_: BinaryAssociation = BinaryAssociation(
    name="Administrator__backend__Admin_login__firebase_",
    ends={
        Property(name="administrator__backend_36", type=Admin_____________backend__Actor, multiplicity=Multiplicity(0, 1)),
        Property(name="admin_login__firebase_37", type=Admin_login__firebase__UseCase, multiplicity=Multiplicity(0, 1))
    }
)
App_User_Support_Services: BinaryAssociation = BinaryAssociation(
    name="App_User_Support_Services",
    ends={
        Property(name="app_User38", type=App_User_Actor, multiplicity=Multiplicity(0, 1)),
        Property(name="support_Services39", type=Support_Services_UseCase, multiplicity=Multiplicity(0, 1))
    }
)
Administrator__backend__Add__Update_and_Delete_job: BinaryAssociation = BinaryAssociation(
    name="Administrator__backend__Add__Update_and_Delete_job",
    ends={
        Property(name="administrator__backend_40", type=Admin_____________backend__Actor, multiplicity=Multiplicity(0, 1)),
        Property(name="add__Update_and_Delete_job41", type=Add__Update_and_Delete_job_UseCase, multiplicity=Multiplicity(0, 1))
    }
)
Job_Seeker_apply_for_job: BinaryAssociation = BinaryAssociation(
    name="Job_Seeker_apply_for_job",
    ends={
        Property(name="apply_for_job16", type=Apply_for_Job_UseCase, multiplicity=Multiplicity(0, 1)),
        Property(name="job_Seeker17", type=App_User_Actor, multiplicity=Multiplicity(0, 1))
    }
)
Job_Seeker_post_resume: BinaryAssociation = BinaryAssociation(
    name="Job_Seeker_post_resume",
    ends={
        Property(name="post_resume18", type=Set_Profile_UseCase, multiplicity=Multiplicity(0, 1)),
        Property(name="job_Seeker19", type=App_User_Actor, multiplicity=Multiplicity(0, 1))
    }
)
Administrator_Manage_database: BinaryAssociation = BinaryAssociation(
    name="Administrator_Manage_database",
    ends={
        Property(name="manage_database20", type=Manage_database_UseCase, multiplicity=Multiplicity(0, 1)),
        Property(name="administrator21", type=Admin_____________backend__Actor, multiplicity=Multiplicity(0, 1))
    }
)
Administrator_Update_categories: BinaryAssociation = BinaryAssociation(
    name="Administrator_Update_categories",
    ends={
        Property(name="update_categories22", type=Support_Services_UseCase, multiplicity=Multiplicity(0, 1)),
        Property(name="administrator23", type=Admin_____________backend__Actor, multiplicity=Multiplicity(0, 1))
    }
)
Administrator_Response_to_users: BinaryAssociation = BinaryAssociation(
    name="Administrator_Response_to_users",
    ends={
        Property(name="response_to_users24", type=Security_UseCase, multiplicity=Multiplicity(0, 1)),
        Property(name="administrator25", type=Admin_____________backend__Actor, multiplicity=Multiplicity(0, 1))
    }
)
Employer_search_job: BinaryAssociation = BinaryAssociation(
    name="Employer_search_job",
    ends={
        Property(name="search_job26", type=Signup_UseCase, multiplicity=Multiplicity(0, 1)),
        Property(name="employer27", type=App_User_Actor, multiplicity=Multiplicity(0, 1))
    }
)
Employer_post_job: BinaryAssociation = BinaryAssociation(
    name="Employer_post_job",
    ends={
        Property(name="post_job28", type=Post_Job_UseCase, multiplicity=Multiplicity(0, 1)),
        Property(name="employer29", type=App_User_Actor, multiplicity=Multiplicity(0, 1))
    }
)
Employer_add_update_and_delete_job: BinaryAssociation = BinaryAssociation(
    name="Employer_add_update_and_delete_job",
    ends={
        Property(name="add_update_and_delete_job30", type=Add__Update_and_Delete_job_UseCase, multiplicity=Multiplicity(0, 1)),
        Property(name="employer31", type=App_User_Actor, multiplicity=Multiplicity(0, 1))
    }
)
Employer_Administrator: BinaryAssociation = BinaryAssociation(
    name="Employer_Administrator",
    ends={
        Property(name="administrator32", type=Administrator, multiplicity=Multiplicity(0, 1)),
        Property(name="employer33", type=Employer, multiplicity=Multiplicity(0, 1))
    }
)

# Domain Model
domain_model = DomainModel(
    name="_A4MwwICAEeqjCeBtMxTJVQ",
    types={employer_Actor, job_seeker_Actor, log_in_UseCase, list_of_jobs_available_UseCase, seeking_for_job_UseCase, educational_qualification_UseCase, UseCase_UseCase, Actor_Actor, admin_Actor, Actor2_Actor, Actor3_Actor, login_UseCase, job_offer_UseCase, MyClass, admin_Actor1, job_seeker_Actor1, Actor4_Actor, admin_Actor2, job_seeker_Actor2, employer_Actor1, login_UseCase1, job_offers_UseCase, educational_qualification_UseCase1, list_of_jobs_related_to_graduation_UseCase, job_vacancies_UseCase, logout_UseCase, App_User_Actor, Admin_____________backend__Actor, Apply_for_Job_UseCase, Manage_database_UseCase, Security_UseCase, Set_Profile_UseCase, Search_Jobs_UseCase, Signup_UseCase, Post_Job_UseCase, Add__Update_and_Delete_job_UseCase, User, Employer, Administrator, JobSeeker, Admin_login__firebase__UseCase, Support_Services_UseCase, Login_UseCase, Administrator_Actor},
    associations={job_seeker_login, admin_login, Actor5_logout, Actor5_login, admin_logout, job_seeker_logout, Job_Seeker_login, Job_Seeker_search_jobs, Administrator_Job_seeker, Administrator__backend__Admin_login__firebase_, App_User_Support_Services, Administrator__backend__Add__Update_and_Delete_job, Job_Seeker_apply_for_job, Job_Seeker_post_resume, Administrator_Manage_database, Administrator_Update_categories, Administrator_Response_to_users, Employer_search_job, Employer_post_job, Employer_add_update_and_delete_job, Employer_Administrator},
    generalizations={},
    metadata=None
)
