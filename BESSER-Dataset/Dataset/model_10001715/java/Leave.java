...
public class Leave  {
    ...
    public Leave(
        String Leave_Title,        int Emp_Id,        int Leave_NoOfDays,        LocalDate Leave_EndDate,        LocalDate Leave_StartDate,        int leave_id,        LocalDate Leave_ApplyDate,        String Leave_Status,        String Leave_detail    ) {
