...
class Order:
    ...
    def __init__(self, Order_ID: int, customer3: "Customer" = None, payment15: "Payment" = None, account18: "Account" = None, account20: "Account" = None, account23: "Account" = None):
...
class Payment:
    ...
    def __init__(self, Payment_ID: int, Date: int, customer7: "Customer" = None, order14: "Order" = None):
...
class Shopping_Cart:
    ...
    def __init__(self, Date: int, customer5: set["Customer"] = None, items16: set["Items"] = None):
        self.Date = Date
    ...
    def customer5(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "add_to_Cart4"):
                    opp_val = getattr(item, "add_to_Cart4", None)
                    
                    if opp_val == self:
                        setattr(item, "add_to_Cart4", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "add_to_Cart4"):
                    ...
                    setattr(item, "add_to_Cart4", self)
...
class Products:
    ...
    def __init__(self, Product_ID: int, customer1: set["Customer"] = None, warehouse13: set["Warehouse"] = None):
...
class Customer:
    ...
    def __init__(self, Name: str, Customer_ID: int, products0: set["Products"] = None, order2: set["Order"] = None, add_to_Cart4: "Shopping_Cart" = None, payment6: "Payment" = None, account9: "Account" = None, account10: "Account" = None):
        self.Name = Name
        self.Customer_ID = Customer_ID
        self.products0 = products0 if products0 is not None else set()
        self.order2 = order2 if order2 is not None else set()
        self.add_to_Cart4 = add_to_Cart4
    ...
    def add_to_Cart4(self):
        return self.__add_to_Cart4
    @add_to_Cart4.setter
    def add_to_Cart4(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Customer__add_to_Cart4", None)
        self.__add_to_Cart4 = value
