...
petrinet_Edge = Class(name="petrinet_Edge", is_abstract=True)
petrinet_PetriNet = Class(name="petrinet_PetriNet")
NamedElement = Class(name="NamedElement")
petrinet_InputEdge = Class(name="petrinet_InputEdge")
Edge = Class(name="Edge")
petrinet_OutputEdge = Class(name="petrinet_OutputEdge")
petrinet_InhibitorEdge = Class(name="petrinet_InhibitorEdge")
petrinet_ReadEdge = Class(name="petrinet_ReadEdge")
...
domain_model = DomainModel(
    name="petrinet",
    types={petrinet_Place, petrinet_Transition, petrinet_Edge, petrinet_PetriNet, NamedElement, petrinet_InputEdge, Edge, petrinet_OutputEdge, petrinet_InhibitorEdge, petrinet_ReadEdge, petrinet_NamedElement},
    associations={places0, transitions1, edges3, edges5, edges6, place8, transition9},
    generalizations={gen_petrinet_Place_NamedElement, gen_petrinet_PetriNet_NamedElement, gen_petrinet_Transition_NamedElement, gen_petrinet_Edge_NamedElement, gen_petrinet_InputEdge_Edge, gen_petrinet_OutputEdge_Edge, gen_petrinet_InhibitorEdge_Edge, gen_petrinet_ReadEdge_Edge},
    metadata=None
)
