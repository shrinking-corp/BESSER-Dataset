...
class cpsml_ProbTransition(Transition):
    ...
    def __init__(self, probability: float, outgoingProbTransitions: "cpsml_State" = None, incomingProbTransitions: "cpsml_State" = None, cpsml_ProbTransition: "cpsml_System" = None, ProbTransition: "cpsml_State" = None, ProbTransition29: "cpsml_State" = None):
...
class cpsml_ODE:
    ...
    def __init__(self, name: str, cpsml_ODE59: "cpsml_Function" = None, cpsml_ODE61: "cpsml_Condition" = None, cpsml_ODE63: "cpsml_Interval" = None, cpsml_ODE: "cpsml_System" = None, cpsml_ODE23: "cpsml_State" = None, cpsml_ODE41: "cpsml_State" = None):
        self.name = name
...
class cpsml_Transition(ABC):
    ...
    def __init__(self, name: str, event: str, guard: str, action: str, cpsml_Transition49: "cpsml_Variable" = None, cpsml_Transition: "cpsml_System" = None, cpsml_Transition38: "cpsml_State" = None):
        self.name = name
        self.event = event
        self.guard = guard
        self.action = action
...
class cpsml_State:
    ...
    def __init__(self, name: bool, cpsml_State43: set["cpsml_Variable"] = None, State: "cpsml_ComTransition" = None, State53: "cpsml_ComTransition" = None, State55: "cpsml_ProbTransition" = None, State57: "cpsml_ProbTransition" = None, cpsml_State: "cpsml_System" = None, cpsml_State10: "cpsml_System" = None, cpsml_State15: "cpsml_System" = None, cpsml_State18: "cpsml_System" = None, cpsml_State46: "cpsml_Variable" = None, cpsml_State22: "cpsml_ODE" = None, csrc: set["cpsml_ComTransition"] = None, ctgt: set["cpsml_ComTransition"] = None, psrc: set["cpsml_ProbTransition"] = None, ptgt: set["cpsml_ProbTransition"] = None, cpsml_State32: "cpsml_State" = None, cpsml_State30: set["cpsml_State"] = None, cpsml_State35: "cpsml_State" = None, cpsml_State33: "cpsml_State" = None, cpsml_State37: set["cpsml_Transition"] = None, cpsml_State40: set["cpsml_ODE"] = None):
        self.name = name
...
class cpsml_System:
    ...
    def __init__(self, name: str, ran: str, sub: int, y0label: int, cpsml_System: set["cpsml_Variable"] = None, cpsml_System2: "cpsml_Variable" = None, cpsml_System5: set["cpsml_State"] = None, cpsml_System7: set["cpsml_Transition"] = None, cpsml_System9: "cpsml_State" = None, cpsml_System12: set["cpsml_ODE"] = None, cpsml_System14: "cpsml_State" = None, cpsml_System17: "cpsml_State" = None, cpsml_System20: "cpsml_ProbTransition" = None):
        self.name = name
        self.ran = ran
        self.sub = sub
...
class cpsml_Variable:
    ...
    def __init__(self, Globalnv: float, value: float, cpsml_Variable44: "cpsml_State" = None, cpsml_Variable50: "cpsml_Transition" = None, cpsml_Variable: "cpsml_System" = None, cpsml_Variable3: "cpsml_System" = None, cpsml_Variable47: "cpsml_State" = None):
