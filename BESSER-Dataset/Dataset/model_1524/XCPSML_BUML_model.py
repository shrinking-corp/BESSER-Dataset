...
cpsml_System.attributes={cpsml_System_sub, cpsml_System_y0label, cpsml_System_name, cpsml_System_ran}
cpsml_System.methods={cpsml_System_m_RealizeInitializeModel, cpsml_System_m_main, cpsml_System_m_dojump, cpsml_System_m_callscilab}
...
cpsml_Transition.attributes={cpsml_Transition_action, cpsml_Transition_guard, cpsml_Transition_event, cpsml_Transition_name}
...
cpsml_Interval.attributes={cpsml_Interval_name, cpsml_Interval_right, cpsml_Interval_left, cpsml_Interval_subinterval}
...
domain_model = DomainModel(
    name="cpsml",
    types={cpsml_Variable, cpsml_System, cpsml_State, cpsml_Transition, cpsml_ODE, cpsml_ProbTransition, cpsml_ComTransition, cpsml_IndeVariable, cpsml_DeVariable, Transition, cpsml_Function, cpsml_Condition, cpsml_Interval, cpsml_Fright},
    associations={ownedvariables0, relatedvariable1, ownedStates4, ownedTransitions6, initialState8, ownedodes11, currentState13, fatherState16, ptok19, subrelatedvariable45, slaveode21, outgoingComTransitions24, incomingComTransitions25, outgoingProbTransitions27, incomingProbTransitions28, subStates31, initialsubstate34, subtransitions36, subodes39, subrelatedvariables42, indevariable64, relatedvariable248, csrc51, ctgt52, psrc54, ptgt56, function58, condition60, interval62, devariable66, fright68},
