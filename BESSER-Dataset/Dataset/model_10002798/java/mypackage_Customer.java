...
public class mypackage_Customer  {
    ...
    public mypackage_Customer(
        String emailAddress,        LocalDate dateOfBirth,        String name,        String address,        String phoneNumber    ) {
    ...
    public mypackage_Customer(
        String emailAddress,        LocalDate dateOfBirth,        String name,        String address,        String phoneNumber        ArrayList<account_Account> account_accounts    ) {
        this.emailAddress = emailAddress;
        this.dateOfBirth = dateOfBirth;
        this.name = name;
        this.address = address;
