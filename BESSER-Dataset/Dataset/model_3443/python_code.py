...
class epdemo_Teacher:
    ...
    def __init__(self, Id: str, Name: str, epdemo_Teacher: "epdemo_School" = None, epdemo_Teacher7: "epdemo_Clazz" = None):
        self.Id = Id
        self.Name = Name
...
class epdemo_Student:
    ...
    def __init__(self, Id: str, Name: str, epdemo_Student: "epdemo_School" = None, epdemo_Student10: "epdemo_Clazz" = None):
        self.Id = Id
        self.Name = Name
...
class epdemo_Clazz:
    ...
    def __init__(self, Id: str, Name: str, epdemo_Clazz: "epdemo_School" = None, epdemo_Clazz6: set["epdemo_Teacher"] = None, epdemo_Clazz9: set["epdemo_Student"] = None):
        self.Id = Id
        self.Name = Name
