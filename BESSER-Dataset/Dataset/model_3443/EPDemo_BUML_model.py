...
# Classes
epdemo_School = Class(name="epdemo_School")
epdemo_Clazz = Class(name="epdemo_Clazz")
epdemo_Student = Class(name="epdemo_Student")
epdemo_Teacher = Class(name="epdemo_Teacher")
...
epdemo_School.attributes={epdemo_School_Id, epdemo_School_Name}
...
epdemo_Student.attributes={epdemo_Student_Id, epdemo_Student_Name}
...
epdemo_Teacher.attributes={epdemo_Teacher_Id, epdemo_Teacher_Name}
...
domain_model = DomainModel(
    ...
    associations={Clazzes0, students1, teachers3, teachers5, students8},
    generalizations={},
    metadata=None
)
