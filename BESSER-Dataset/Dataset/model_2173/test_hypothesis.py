...
def test_typegraphbasic_tparameter_is_not_abstract():
    assert not inspect.isabstract(TypeGraphBasic_TParameter)


def test_typegraphbasic_tparameter_constructor_exists():
    assert callable(TypeGraphBasic_TParameter.__init__)


def test_typegraphbasic_tparameter_constructor_args():
    sig = inspect.signature(TypeGraphBasic_TParameter.__init__)
    params = list(sig.parameters.keys())



def test_typegraphbasic_tparameterlist_is_not_abstract():
    assert not inspect.isabstract(TypeGraphBasic_TParameterList)


def test_typegraphbasic_tparameterlist_constructor_exists():
    assert callable(TypeGraphBasic_TParameterList.__init__)


def test_typegraphbasic_tparameterlist_constructor_args():
