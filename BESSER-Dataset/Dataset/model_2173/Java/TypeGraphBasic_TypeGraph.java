...
public class TypeGraphBasic_TypeGraph  {
    ...
    public TypeGraphBasic_TypeGraph(
        String tName        ArrayList<TypeGraphBasic_TMethod> typegraphbasic_tmethods,        ArrayList<TypeGraphBasic_TPackage> typegraphbasic_tpackages,        ArrayList<TypeGraphBasic_TField> typegraphbasic_tfields,        ArrayList<TypeGraphBasic_TClass> typegraphbasic_tclasss    ) {
        this.tName = tName;
