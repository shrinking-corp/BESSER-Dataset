...
class wheel_State:
    ...
    def __init__(self, name: str, wheel_State: "wheel_WheelSM" = None, wheel_State3: "wheel_WheelSM" = None, State: "wheel_WheelSM" = None, wheel_State6: "wheel_Transition" = None, Source: "wheel_Transition" = None, ownedState: "wheel_WheelSM" = None, wheel_State11: "wheel_Transition" = None, State13: "wheel_Transition" = None):
        self.name = name
