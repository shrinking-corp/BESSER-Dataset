...
# Classes
wheel_WheelSM = Class(name="wheel_WheelSM")
wheel_State = Class(name="wheel_State")
wheel_Transition = Class(name="wheel_Transition")
...
domain_model = DomainModel(
    ...
    associations={initialState0, finalState1, ownedState4, incomingTransition5, outgoingTransition7, owningFSM8, target9, Source12},
    generalizations={},
    metadata=None
)
