...
class fUML_CompleteStructuredActivities_StructuredActivityNode(Action):
    ...
    def __init__(self, mustIsolate: bool, inStructuredNode180: set["IntermediateActivities_ActivityEdge"] = None, inStructuredNode: set["IntermediateActivities_ActivityNode"] = None, fUML_CompleteStructuredActivities_StructuredActivityNode: set["BasicActions_OutputPin"] = None, fUML_CompleteStructuredActivities_StructuredActivityNode185: set["BasicActions_InputPin"] = None):
