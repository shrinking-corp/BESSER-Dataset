...
public class fUML_Kernel_Class extends BehavioredClassifier {
    ...
    public fUML_Kernel_Class(
        boolean active        ArrayList<Kernel_Operation> kernel_operations,        ArrayList<Kernel_Classifier> kernel_classifiers,        ArrayList<Kernel_Class> kernel_classs,        ArrayList<Kernel_Property> kernel_propertys    ) {
        this.active = active;
