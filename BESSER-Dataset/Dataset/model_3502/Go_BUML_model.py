...
# Classes
go_Init = Class(name="go_Init")
go_GoDecl = Class(name="go_GoDecl")
go_BOOLEAN_VALUE = Class(name="go_BOOLEAN_VALUE")
go_VarDecl = Class(name="go_VarDecl")
go_IDList = Class(name="go_IDList")
go_IGUAL = Class(name="go_IGUAL")
go_PONTOSIGUAL = Class(name="go_PONTOSIGUAL")
go_VarCall = Class(name="go_VarCall")
go_FunctionCall = Class(name="go_FunctionCall")
go_FunctionType = Class(name="go_FunctionType")
go_EXPRESSAOLINHA = Class(name="go_EXPRESSAOLINHA")
go_ForDecl = Class(name="go_ForDecl")
go_ForClause = Class(name="go_ForClause")
go_RangeDecl = Class(name="go_RangeDecl")
go_EXPRESSAO = Class(name="go_EXPRESSAO")
go_COMPARISON = Class(name="go_COMPARISON")
go_InitStmt = Class(name="go_InitStmt")
go_Condition = Class(name="go_Condition")
go_PostStmt = Class(name="go_PostStmt")
go_ARIT_EXPR = Class(name="go_ARIT_EXPR")
go_TIPO = Class(name="go_TIPO")
go_Types = Class(name="go_Types")
go_Assignment = Class(name="go_Assignment")
go_SignatureDel = Class(name="go_SignatureDel")
go_Var = Class(name="go_Var")
go_ArrayType = Class(name="go_ArrayType")
go_BINARY_EXP = Class(name="go_BINARY_EXP")
go_LITERAIS_BASICOS = Class(name="go_LITERAIS_BASICOS")
go_Const = Class(name="go_Const")
go_LiteraisList = Class(name="go_LiteraisList")
go_EObject = Class(name="go_EObject")
go_ArrayValue = Class(name="go_ArrayValue")
go_Chamada = Class(name="go_Chamada")
...
go_PARAMETERS_LIST = Class(name="go_PARAMETERS_LIST")
go_IfCondition = Class(name="go_IfCondition")
ElseIfCondition = Class(name="ElseIfCondition")
go_BOOL_OP = Class(name="go_BOOL_OP")
go_PARAMETER = Class(name="go_PARAMETER")
go_BasicType = Class(name="go_BasicType")
...
go_BOOLEAN_VALUE.attributes={go_BOOLEAN_VALUE_verdadeiro, go_BOOLEAN_VALUE_falso}
...
go_IDList.attributes={go_IDList_idList, go_IDList_vir}
...
go_COMPARISON.attributes={go_COMPARISON_maiorigualque, go_COMPARISON_menorque, go_COMPARISON_maiorque, go_COMPARISON_menorigualque, go_COMPARISON_igual}
...
go_ARIT_EXPR.attributes={go_ARIT_EXPR_num, go_ARIT_EXPR_atr, go_ARIT_EXPR_op, go_ARIT_EXPR_num2, go_ARIT_EXPR_num1}
...
go_BasicType.attributes={go_BasicType_string, go_BasicType_int, go_BasicType_float, go_BasicType_boolean}
...
for_89: BinaryAssociation = BinaryAssociation(
    name="for_89",
    ends={
...
if_99: BinaryAssociation = BinaryAssociation(
    name="if_99",
    ends={
...
if_181: BinaryAssociation = BinaryAssociation(
    name="if_181",
    ends={
...
else_186: BinaryAssociation = BinaryAssociation(
    name="else_186",
    ends={
...
domain_model = DomainModel(
    name="go",
    types={go_Init, go_GoDecl, go_BOOLEAN_VALUE, go_VarDecl, go_IDList, go_IGUAL, go_PONTOSIGUAL, go_VarCall, go_FunctionCall, go_FunctionType, go_EXPRESSAOLINHA, go_ForDecl, go_ForClause, go_RangeDecl, go_EXPRESSAO, go_COMPARISON, go_InitStmt, go_Condition, go_PostStmt, go_ARIT_EXPR, go_TIPO, go_Types, go_Assignment, go_SignatureDel, go_Var, go_ArrayType, go_BINARY_EXP, go_LITERAIS_BASICOS, go_Const, go_LiteraisList, go_EObject, go_ArrayValue, go_Chamada, go_IfStmt, go_ReturnStmt, go_Signature, go_BLOCK, go_Parameters, go_PARAMETERS_LIST, go_IfCondition, ElseIfCondition, go_BOOL_OP, go_PARAMETER, go_BasicType, go_ElseIfCondition, go_ElseCondition},
    associations={elements0, var1, range8, comandos10, idList13, igual15, op17, variavel19, func21, func3, expressao5, clause7, expr134, comparador36, expr238, list42, init23, condition25, post27, varDecl29, art32, tipoDecl57, type59, igual61, dois63, expressao66, signature44, atribuicao46, pront49, array52, expressao54, exp73, explinha77, declFunction79, binary_exp82, basic84, assignment86, for_89, variavel69, constante71, func103, idVar106, lit109, lit111, arrayValue92, variaveis94, cham97, if_99, basic101, assinatura126, bloco128, params130, retorno132, params135, cond137, booleano113, basic115, varCal118, func121, bool124, params150, basico152, tipo155, basic158, array160, then139, then142, listaDeComandos144, retorno147, params166, cham169, var1172, var2175, basic163, var178, if_181, elseif184, else_186},
