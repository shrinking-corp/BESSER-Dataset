...
class go_SignatureDel:
    ...
    def __init__(self, id: str, go_SignatureDel60: "go_Types" = None, go_SignatureDel: "go_VarDecl" = None, go_SignatureDel58: "go_TIPO" = None):
        self.id = id
...
class go_ARIT_EXPR:
    ...
    def __init__(self, num1: str, op: str, num2: str, num: str, atr: str, go_ARIT_EXPR: "go_PostStmt" = None, go_ARIT_EXPR173: "go_VarCall" = None, go_ARIT_EXPR176: "go_VarCall" = None, go_ARIT_EXPR179: "go_VarCall" = None):
        self.num1 = num1
        self.op = op
        self.num2 = num2
        self.num = num
...
class go_FunctionCall:
    ...
    def __init__(self, id: str, go_FunctionCall: "go_RangeDecl" = None, go_FunctionCall123: "go_BINARY_EXP" = None, go_FunctionCall105: "go_ReturnStmt" = None, go_FunctionCall167: "go_PARAMETERS_LIST" = None):
        self.id = id
...
class go_PONTOSIGUAL:
    ...
    def __init__(self, op: str, go_PONTOSIGUAL65: "go_Assignment" = None, go_PONTOSIGUAL51: "go_VarDecl" = None, go_PONTOSIGUAL: "go_RangeDecl" = None):
        self.op = op
...
class go_IGUAL:
    ...
    def __init__(self, igual: str, go_IGUAL62: "go_Assignment" = None, go_IGUAL48: "go_VarDecl" = None, go_IGUAL: "go_RangeDecl" = None):
        self.igual = igual
...
class go_PARAMETER:
    ...
    def __init__(self, id: str, go_PARAMETER: "go_PARAMETERS_LIST" = None, go_PARAMETER153: "go_LITERAIS_BASICOS" = None, go_PARAMETER156: "go_Types" = None):
        self.id = id
...
class go_LITERAIS_BASICOS:
    ...
    def __init__(self, numero: str, string: str, go_LITERAIS_BASICOS: "go_EXPRESSAO" = None, go_LITERAIS_BASICOS102: "go_ReturnStmt" = None, go_LITERAIS_BASICOS114: "go_BOOLEAN_VALUE" = None, go_LITERAIS_BASICOS117: "go_BINARY_EXP" = None, go_LITERAIS_BASICOS154: "go_PARAMETER" = None):
        self.numero = numero
        self.string = string
...
class go_BINARY_EXP:
    ...
    def __init__(self, arit: str, go_BINARY_EXP122: set["go_FunctionCall"] = None, go_BINARY_EXP: "go_EXPRESSAO" = None, go_BINARY_EXP116: set["go_LITERAIS_BASICOS"] = None, go_BINARY_EXP119: set["go_VarCall"] = None, go_BINARY_EXP125: "go_BOOL_OP" = None):
        self.arit = arit
