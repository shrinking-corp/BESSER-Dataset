...
fsm_Event = Class(name="fsm_Event")
fsm_Action = Class(name="fsm_Action")
fsm_Guard = Class(name="fsm_Guard")
fsm_Message = Class(name="fsm_Message")
fsm_StringToStringMap = Class(name="fsm_StringToStringMap")
...
fsm_FSM.attributes={fsm_FSM_groupId, fsm_FSM_isServer, fsm_FSM_name}
...
fsm_StringToStringMap.attributes={fsm_StringToStringMap_value, fsm_StringToStringMap_key}
...
domain_model = DomainModel(
    name="fsm",
    types={fsm_FSM, fsm_State, fsm_Event, fsm_Action, fsm_Guard, fsm_Message, fsm_StringToStringMap, fsm_Transition},
    associations={ownedStates0, initialState1, finalState2, ownedEvents5, onExitedActions22, expectedMessage25, source28, actions30, guard32, event35, target38, ownedActions7, ownedGuards9, ownedMessages11, dataTypes13, owningFSM15, outgoingTransitions16, incomingTransitions17, onEnteredActions19, event40, data43, enumsDef46},
    generalizations={},
    metadata=None
)
