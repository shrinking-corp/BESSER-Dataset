...
def test_hyp_fsm_stringtostringmap_is_not_abstract():
    assert not inspect.isabstract(fsm_StringToStringMap)


def test_hyp_fsm_stringtostringmap_constructor_exists():
    assert callable(fsm_StringToStringMap.__init__)


def test_hyp_fsm_stringtostringmap_constructor_args():
...
def test_hyp_fsm_message_is_not_abstract():
    assert not inspect.isabstract(fsm_Message)


def test_hyp_fsm_message_constructor_exists():
    assert callable(fsm_Message.__init__)


def test_hyp_fsm_message_constructor_args():
...
def test_hyp_fsm_event_is_not_abstract():
    assert not inspect.isabstract(fsm_Event)


def test_hyp_fsm_event_constructor_exists():
    assert callable(fsm_Event.__init__)


def test_hyp_fsm_event_constructor_args():
...
@given(instance=fsm_Transition_strategy)
def test_hyp_fsm_transition_InverseGuard_setter(instance):
...
def test_hyp_fsm_stringtostringmap_value_setter(instance):
...
@given(instance=fsm_StringToStringMap_strategy)
def test_hyp_fsm_stringtostringmap_key_setter(instance):
...
def test_hyp_fsm_message_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_fsm_guard_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_fsm_action_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_fsm_event_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=fsm_FSM_strategy)
def test_hyp_fsm_fsm_groupId_setter(instance):
...
@given(instance=fsm_FSM_strategy)
def test_hyp_fsm_fsm_isServer_setter(instance):
