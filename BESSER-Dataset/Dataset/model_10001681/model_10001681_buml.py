...
Articulo2.attributes={Articulo2_Descripci_n, Articulo2_Nombre, Articulo2_Precio}
...
Cliente.attributes={Cliente_Nombre, Cliente_Email, Cliente_Apellido, Cliente_Direccion}
...
Consulta.attributes={Consulta_Producto, Consulta_Fecha}
...
Detalle.attributes={Detalle_Precio, Detalle_Cantidad, Detalle_Producto}
...
Producto.attributes={Producto_Stock, Producto_Precio, Producto_Modo_de_venta}
...
Ventas.attributes={Ventas_Monto, Ventas_Cantidad, Ventas_Producto, Ventas_Fecha}
...
Caja.attributes={Caja_Arqueo, Caja_Dinero_Inicio, Caja_Fecha}
...
Cliente1.attributes={Cliente1_Email, Cliente1_DNI, Cliente1_Apellido, Cliente1_Telefono, Cliente1_Fecha_de_Nac, Cliente1_Nombre}
...
Asistencia.attributes={Asistencia_Ingreso, Asistencia_Sucursal}
...
Clase.attributes={Clase_Nombre, Clase_Asistencia}
...
Articulo_Consulta: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="articulo35", type=Articulo2, multiplicity=Multiplicity(1, 9999))
    }
)
...
Cliente_Pedido: BinaryAssociation = BinaryAssociation(
    name="Cliente_Pedido",
    ends={
        Property(name="pedido38", type=Pedido, multiplicity=Multiplicity(0, 1)),
        Property(name="cliente39", type=Cliente, multiplicity=Multiplicity(1, 1))
    }
)
Cliente_Envio2: BinaryAssociation = BinaryAssociation(
    name="Cliente_Envio2",
    ends={
        Property(name="envio40", type=Envio, multiplicity=Multiplicity(1, 1)),
        Property(name="cliente41", type=Cliente, multiplicity=Multiplicity(1, 1))
    }
)
Pedido_Detalle: BinaryAssociation = BinaryAssociation(
    name="Pedido_Detalle",
    ends={
        Property(name="detalle42", type=Detalle, multiplicity=Multiplicity(1, 9999)),
        Property(name="pedido43", type=Pedido, multiplicity=Multiplicity(1, 1))
    }
)
Cliente_Consulta: BinaryAssociation = BinaryAssociation(
    name="Cliente_Consulta",
    ends={
        Property(name="consulta44", type=Consulta, multiplicity=Multiplicity(1, 1)),
        Property(name="cliente45", type=Cliente, multiplicity=Multiplicity(1, 1))
    }
)
Pedido_Envio: BinaryAssociation = BinaryAssociation(
    name="Pedido_Envio",
    ends={
        Property(name="envio46", type=Envio, multiplicity=Multiplicity(1, 1)),
        Property(name="pedido47", type=Pedido, multiplicity=Multiplicity(1, 1))
    }
)
Producto_Jornada: BinaryAssociation = BinaryAssociation(
    name="Producto_Jornada",
    ends={
        Property(name="jornada48", type=Jornada, multiplicity=Multiplicity(1, 9999)),
        Property(name="producto49", type=Producto, multiplicity=Multiplicity(0, 9999))
    }
)
Jornada_Supervisor: BinaryAssociation = BinaryAssociation(
    name="Jornada_Supervisor",
    ends={
        Property(name="supervisor50", type=Supervisor, multiplicity=Multiplicity(1, 1)),
        Property(name="jornada51", type=Jornada, multiplicity=Multiplicity(1, 9999))
    }
)
Supervisor_Caja: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="supervisor53", type=Supervisor, multiplicity=Multiplicity(1, 1))
    }
)
Ventas_Caja: BinaryAssociation = BinaryAssociation(
    name="Ventas_Caja",
    ends={
        Property(name="caja54", type=Caja, multiplicity=Multiplicity(1, 1)),
        Property(name="ventas55", type=Ventas, multiplicity=Multiplicity(1, 9999))
    }
)
Producto_Ventas: BinaryAssociation = BinaryAssociation(
    name="Producto_Ventas",
    ends={
        Property(name="ventas56", type=Ventas, multiplicity=Multiplicity(0, 9999)),
        Property(name="producto57", type=Producto, multiplicity=Multiplicity(0, 9999))
    }
)
Jornada_Caja: BinaryAssociation = BinaryAssociation(
    name="Jornada_Caja",
    ends={
        Property(name="caja58", type=Caja, multiplicity=Multiplicity(0, 1)),
        Property(name="jornada59", type=Jornada, multiplicity=Multiplicity(1, 9999))
    }
)
Articulo_Envio: BinaryAssociation = BinaryAssociation(
    name="Articulo_Envio",
    ends={
        Property(name="envio60", type=Envio, multiplicity=Multiplicity(0, 1)),
        Property(name="articulo61", type=Articulo2, multiplicity=Multiplicity(1, 9999))
    }
)
Cliente_Asistencia: BinaryAssociation = BinaryAssociation(
    name="Cliente_Asistencia",
    ends={
        Property(name="asistencia62", type=Asistencia, multiplicity=Multiplicity(1, 1)),
        Property(name="cliente63", type=Cliente1, multiplicity=Multiplicity(1, 9999))
    }
)
...
Inscribir_a_una_clase_Cliente: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="cliente20", type=Cliente_Actor, multiplicity=Multiplicity(0, 1)),
...
Asistencia_Instructor: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="instructor64", type=Instructor, multiplicity=Multiplicity(1, 1)),
...
Asistencia_Clase: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="clase66", type=Clase, multiplicity=Multiplicity(1, 9999)),
        Property(name="asistencia67", type=Asistencia, multiplicity=Multiplicity(1, 1))
    }
)

# Domain Model
domain_model = DomainModel(
    name="_OJOFYNZfEemWXYASHrbj8g",
    ...
    associations={Vendedor_Responder_consultas, Registrar_inicio_de_caja_Supervisor, Registrar_cierre_de_caja_Supervisor, Listar_stock_Supervisor, Vender_producto_Vendedor, Cliente_Envio, Articulo_Consulta, Articulo_Cliente, Cliente_Pedido, Cliente_Envio2, Pedido_Detalle, Cliente_Consulta, Pedido_Envio, Producto_Jornada, Jornada_Supervisor, Supervisor_Caja, Ventas_Caja, Producto_Ventas, Jornada_Caja, Articulo_Envio, Cliente_Asistencia, Vendedor_Publicar_producto, Vendedor_Enviar_producto, Consultar_producto_Comprador, Realizar_consulta_Comprador, Realizar_pedido_Comprador, Instructor_Registrar_datos_de_clientes, Registrar_datos_de_la_clase_a_la_que_asistir__el_cliente_Instructor, Renovar_inscripci_n_Cliente, Consultar_asistencia_historica_Cliente, Inscribir_a_una_clase_Cliente, Registrar_datos_del_producto_Supervisor, Asistencia_Instructor, Asistencia_Clase},
    generalizations={},
    metadata=None
)
