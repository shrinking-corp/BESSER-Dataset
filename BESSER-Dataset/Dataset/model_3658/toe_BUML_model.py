...
domain_model = DomainModel(
    name="toe",
    types={toe_Employee, AllBase, toe_Project, toe_Department, toe_Contribution, toe_Manager, Employee, toe_AllHolder, toe_AllBase},
    associations={all0, projects1, department2, contributions3, leads4, managedDepartment6, lead23, contributions25, employee8, project9, subDepartments13, employees15, parentDepartment18, manager20, projectTeam21},
