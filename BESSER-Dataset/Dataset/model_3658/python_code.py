...
class toe_Project(AllBase):
    ...
    def __init__(self, name: str, departmentWide: bool, Project: "toe_Employee" = None, Project5: "toe_Manager" = None, leads: "toe_Manager" = None, project: set["toe_Contribution"] = None, Project11: "toe_Contribution" = None, projects: set["toe_Employee"] = None):
        self.name = name
