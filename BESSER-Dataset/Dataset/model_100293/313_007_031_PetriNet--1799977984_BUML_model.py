...
petriNet_GenericPlace = Class(name="petriNet_GenericPlace", is_abstract=True)
petriNet_Transition = Class(name="petriNet_Transition")
petriNet_InputArc = Class(name="petriNet_InputArc")
petriNet_Resource = Class(name="petriNet_Resource")
...
domain_model = DomainModel(
    name="petriNet",
    types={petriNet_Place, GenericPlace, petriNet_OutputArc, petriNet_PetriNet, petriNet_GenericPlace, petriNet_Transition, petriNet_InputArc, petriNet_Resource},
    associations={containsInputArcs3, containsOutputArcs5, containsGenericPlaces0, containsTransitions1, InputArcFromPlace7, InputArcToTransition10, OutputArcFromTransition13, OutputArcToPlace16},
