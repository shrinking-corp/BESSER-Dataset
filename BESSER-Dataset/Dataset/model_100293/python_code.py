...
class petriNet_GenericPlace(ABC):
    ...
    def __init__(self, name: str, numberOfTokens: int, petriNet_GenericPlace: "petriNet_PetriNet" = None, petriNet_GenericPlace9: "petriNet_InputArc" = None, petriNet_GenericPlace18: "petriNet_OutputArc" = None):
        self.name = name
...
class petriNet_PetriNet:
    ...
    def __init__(self, name: str, petriNet_PetriNet4: set["petriNet_InputArc"] = None, petriNet_PetriNet6: set["petriNet_OutputArc"] = None, petriNet_PetriNet: set["petriNet_GenericPlace"] = None, petriNet_PetriNet2: set["petriNet_Transition"] = None):
        self.name = name
