...
def test_assoc_assoc__R_J8U5UFEeqqGZh46IEtXQ_link_reassign_clear():
    a = Online_pizza_ordering(Ingredients="sample_text", Price=3.14, pizza_type="sample_text")
    b1 = Admin()
    b2 = Admin()
...
def test_assoc_assoc__R_J8ZJUFEeqqGZh46IEtXQ_link_reassign_clear():
...
def test_assoc_assoc__R_J8g5UFEeqqGZh46IEtXQ_link_reassign_clear():
    a = Online_pizza_ordering(Ingredients="sample_text", Price=3.14, pizza_type="sample_text")
