...
class petrinet_Place(NamedElement):
    ...
    def __init__(self, tokens: int, petrinet_Place: "petrinet_Net" = None, petrinet_Place5: "petrinet_Net" = None, petrinet_Place7: "petrinet_Transition" = None, petrinet_Place11: "petrinet_Transition" = None, petrinet_Place14: "petrinet_Transition" = None):
        self.tokens = tokens
