...
domain_model = DomainModel(
    name="petrinet",
    types={petrinet_NamedElement, petrinet_Net, NamedElement, petrinet_Place, petrinet_Transition},
    associations={places0, transitions1, first3, to6, input9, output12},
    generalizations={gen_petrinet_Net_NamedElement, gen_petrinet_Place_NamedElement, gen_petrinet_Transition_NamedElement},
    metadata=None
)
