...
database_Table.attributes={database_Table_name, database_Table_is_local}
...
database_Column.attributes={database_Column_type, database_Column_name}
...
domain_model = DomainModel(
    name="database",
    types={database_Table, database_Column, database_ForeignKey, database_Schema},
    associations={tables0, cols1, fkeys3, pkey5, cols8, references11},
    generalizations={},
    metadata=None
)
