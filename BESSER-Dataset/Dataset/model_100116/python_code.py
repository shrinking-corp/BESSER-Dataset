...
class database_Table:
    ...
    def __init__(self, name: str, is_local: bool, database_Table: "database_Schema" = None, database_Table2: set["database_Column"] = None, database_Table4: set["database_ForeignKey"] = None, database_Table6: set["database_Column"] = None, database_Table13: "database_ForeignKey" = None):
        self.name = name
