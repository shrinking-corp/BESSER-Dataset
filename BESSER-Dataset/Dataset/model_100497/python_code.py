...
class zhu_State:
    ...
    def __init__(self, name: str, zhu_State: "zhu_Transition" = None, zhu_State25: "zhu_Transition" = None, zhu_State35: "zhu_StatesSeparated" = None, zhu_State32: "zhu_StatesSeparated" = None):
        self.name = name
...
class zhu_Region:
    ...
    def __init__(self, name: str, zhu_Region12: "zhu_Region" = None, zhu_Region10: set["zhu_Region"] = None, zhu_Region14: "zhu_Transitions" = None, zhu_Region: "zhu_TopRegion" = None, zhu_Region8: "zhu_States" = None):
        self.name = name
