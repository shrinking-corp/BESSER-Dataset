...
zhu_Transition.attributes={zhu_Transition_guard, zhu_Transition_behaviour}
...
domain_model = DomainModel(
    name="zhu",
    types={zhu_StateMachine, zhu_TopRegion, zhu_States, zhu_Region, zhu_Transition, zhu_State, zhu_Triggers, zhu_Transitions, zhu_TriggersSeparated, zhu_StatesSeparated},
    associations={region0, states1, regions11, transitions13, firstTransition16, followingTransitions18, source21, target23, triggers26, regions3, transitions5, states7, followingStates33, triggers36, states28, firstState30},
    generalizations={},
    metadata=None
)
