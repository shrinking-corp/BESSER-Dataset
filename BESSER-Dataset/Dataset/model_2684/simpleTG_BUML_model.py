...
# Classes
simpleTG_B = Class(name="simpleTG_B")
simpleTG_C = Class(name="simpleTG_C")
simpleTG_Container = Class(name="simpleTG_Container")
simpleTG_A = Class(name="simpleTG_A")
...
domain_model = DomainModel(
    name="simpleTG",
    types={simpleTG_B, simpleTG_C, simpleTG_Container, simpleTG_A},
    associations={bs1, cs3, b5, as_0},
    generalizations={},
    metadata=None
)
