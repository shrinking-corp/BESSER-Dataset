...
simpleTG_A_strategy = st.builds(simpleTG_A)
...
simpleTG_B_strategy = st.builds(simpleTG_B)
...
simpleTG_C_strategy = st.builds(simpleTG_C)
...
simpleTG_Container_strategy = st.builds(simpleTG_Container)
