...
# Classes
mathDSL_Math = Class(name="mathDSL_Math")
mathDSL_Expression = Class(name="mathDSL_Expression")
mathDSL_Multi = Class(name="mathDSL_Multi")
mathDSL_Div = Class(name="mathDSL_Div")
mathDSL_NumberLiteral = Class(name="mathDSL_NumberLiteral")
mathDSL_Plus = Class(name="mathDSL_Plus")
Expression = Class(name="Expression")
mathDSL_Minus = Class(name="mathDSL_Minus")
...
domain_model = DomainModel(
    name="mathDSL",
    types={mathDSL_Math, mathDSL_Expression, mathDSL_Multi, mathDSL_Div, mathDSL_NumberLiteral, mathDSL_Plus, Expression, mathDSL_Minus},
    associations={expression0, left11, right13, left16, right18, left1, right3, left6, right8},
    generalizations={gen_mathDSL_Multi_Expression, gen_mathDSL_Div_Expression, gen_mathDSL_NumberLiteral_Expression, gen_mathDSL_Plus_Expression, gen_mathDSL_Minus_Expression},
    metadata=None
)
