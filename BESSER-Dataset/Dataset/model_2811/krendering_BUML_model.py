...
krendering_KAction.attributes={krendering_KAction_trigger, krendering_KAction_altPressed, krendering_KAction_shiftPressed, krendering_KAction_ctrlCmdPressed, krendering_KAction_actionId}
...
krendering_KPosition_m_setPositions: Method = Method(name="setPositions", parameters={Parameter(name='krendering_y', type=StringType), Parameter(name='krendering_x', type=StringType)}, type=StringType)
...
krendering_KImage.attributes={krendering_KImage_imagePath, krendering_KImage_imageObject, krendering_KImage_bundleName}
...
krendering_KDecoratorPlacementData.attributes={krendering_KDecoratorPlacementData_rotateWithLine, krendering_KDecoratorPlacementData_height, krendering_KDecoratorPlacementData_yOffset, krendering_KDecoratorPlacementData_width, krendering_KDecoratorPlacementData_absolute, krendering_KDecoratorPlacementData_xOffset, krendering_KDecoratorPlacementData_relative}
...
krendering_KArc.attributes={krendering_KArc_arcType, krendering_KArc_arcAngle, krendering_KArc_startAngle}
...
krendering_KGridPlacementData.attributes={krendering_KGridPlacementData_flexibleWidth, krendering_KGridPlacementData_minCellWidth, krendering_KGridPlacementData_flexibleHeight, krendering_KGridPlacementData_minCellHeight}
...
krendering_KCustomRendering.attributes={krendering_KCustomRendering_figureObject, krendering_KCustomRendering_bundleName, krendering_KCustomRendering_className}
...
krendering_KColor.attributes={krendering_KColor_red, krendering_KColor_blue, krendering_KColor_green}
...
krendering_KXPosition_m_setPosition: Method = Method(name="setPosition", parameters={Parameter(name='krendering_absolute', type=StringType), Parameter(name='krendering_relative', type=StringType)})
krendering_KXPosition.attributes={krendering_KXPosition_relative, krendering_KXPosition_absolute}
krendering_KXPosition.methods={krendering_KXPosition_m_setPosition, krendering_KXPosition_m_equals}
...
krendering_KLineStyle.attributes={krendering_KLineStyle_dashOffset, krendering_KLineStyle_lineStyle, krendering_KLineStyle_dashPattern}
...
krendering_KColoring_m_setColor: Method = Method(name="setColor", parameters={Parameter(name='krendering_blue', type=StringType), Parameter(name='krendering_red', type=StringType), Parameter(name='krendering_green', type=StringType)})
...
krendering_KColoring_m_setColor: Method = Method(name="setColor", parameters={Parameter(name='krendering_red', type=StringType), Parameter(name='krendering_alpha', type=StringType), Parameter(name='krendering_green', type=StringType), Parameter(name='krendering_blue', type=StringType)})
krendering_KColoring_m_setColor: Method = Method(name="setColor", parameters={Parameter(name='krendering_color', type=StringType), Parameter(name='krendering_alpha', type=StringType)})
...
krendering_KColoring_m_setTargetColor: Method = Method(name="setTargetColor", parameters={Parameter(name='krendering_red', type=StringType), Parameter(name='krendering_green', type=StringType), Parameter(name='krendering_blue', type=StringType)})
...
krendering_KColoring_m_setTargetColor: Method = Method(name="setTargetColor", parameters={Parameter(name='krendering_green', type=StringType), Parameter(name='krendering_red', type=StringType), Parameter(name='krendering_alpha', type=StringType), Parameter(name='krendering_blue', type=StringType)})
...
krendering_KColoring_m_setColors: Method = Method(name="setColors", parameters={Parameter(name='krendering_angle', type=StringType), Parameter(name='krendering_targetColor', type=StringType), Parameter(name='krendering_color', type=StringType)})
krendering_KColoring_m_setTargetColorCopyOf: Method = Method(name="setTargetColorCopyOf", parameters={Parameter(name='krendering_targetAlpha', type=StringType), Parameter(name='krendering_targetColor', type=StringType)})
...
krendering_KColoring_m_setColors: Method = Method(name="setColors", parameters={Parameter(name='krendering_angle', type=StringType), Parameter(name='krendering_targetColor', type=StringType), Parameter(name='krendering_color', type=StringType)})
krendering_KColoring_m_setColors: Method = Method(name="setColors", parameters={Parameter(name='krendering_color', type=StringType), Parameter(name='krendering_alpha', type=StringType), Parameter(name='krendering_targetAlpha', type=StringType), Parameter(name='krendering_targetColor', type=StringType)})
krendering_KColoring_m_setColors: Method = Method(name="setColors", parameters={Parameter(name='krendering_alpha', type=StringType), Parameter(name='krendering_targetColor', type=StringType), Parameter(name='krendering_color', type=StringType), Parameter(name='krendering_targetAlpha', type=StringType)})
krendering_KColoring_m_setColors: Method = Method(name="setColors", parameters={Parameter(name='krendering_alpha', type=StringType), Parameter(name='krendering_color', type=StringType), Parameter(name='krendering_angle', type=StringType), Parameter(name='krendering_targetColor', type=StringType), Parameter(name='krendering_targetAlpha', type=StringType)})
krendering_KColoring_m_setColorsCopiesOf: Method = Method(name="setColorsCopiesOf", parameters={Parameter(name='krendering_targetAlpha', type=StringType), Parameter(name='krendering_alpha', type=StringType), Parameter(name='krendering_color', type=StringType), Parameter(name='krendering_targetColor', type=StringType)})
...
krendering_KColoring_m_setColorsCopiesOf: Method = Method(name="setColorsCopiesOf", parameters={Parameter(name='krendering_color', type=StringType), Parameter(name='krendering_angle', type=StringType), Parameter(name='krendering_targetColor', type=StringType)})
...
krendering_KColoring.attributes={krendering_KColoring_targetAlpha, krendering_KColoring_gradientAngle, krendering_KColoring_alpha}
krendering_KColoring.methods={krendering_KColoring_m_setColors, krendering_KColoring_m_setColor, krendering_KColoring_m_setColor2, krendering_KColoring_m_setColorsCopiesOf, krendering_KColoring_m_setColor, krendering_KColoring_m_setColorsCopiesOf, krendering_KColoring_m_setColorsCopiesOf, krendering_KColoring_m_setColors, krendering_KColoring_m_setColorCopiedFrom, krendering_KColoring_m_setColors, krendering_KColoring_m_setColorsCopiesOf, krendering_KColoring_m_setColorAndAlphaCopiedFrom, krendering_KColoring_m_setColor, krendering_KColoring_m_setTargetColorCopiedFrom, krendering_KColoring_m_setColorsCopiedFrom, krendering_KColoring_m_setColor, krendering_KColoring_m_setGradientAngle2, krendering_KColoring_m_equals, krendering_KColoring_m_setTargetColor2, krendering_KColoring_m_setTargetColorCopyOf, krendering_KColoring_m_setColorCopyOf, krendering_KColoring_m_setColors, krendering_KColoring_m_setTargetColor, krendering_KColoring_m_setTargetColor, krendering_KColoring_m_setTargetColorAndAlphaCopiedFrom, krendering_KColoring_m_setTargetColorCopyOf, krendering_KColoring_m_setTargetColor2, krendering_KColoring_m_setColor2, krendering_KColoring_m_setColors, krendering_KColoring_m_setColors, krendering_KColoring_m_setTargetColor, krendering_KColoring_m_setTargetColor, krendering_KColoring_m_setColorsAlphasGradientAngleCopiedFrom, krendering_KColoring_m_setColors, krendering_KColoring_m_setColors, krendering_KColoring_m_setColorCopyOf}
...
domain_model = DomainModel(
    name="krendering",
    types={krendering_KRendering, KGraphData, KStyleHolder, krendering_KContainerRendering, krendering_KPlacementData, krendering_KAction, krendering_KEllipse, KContainerRendering, krendering_KRectangle, krendering_KPosition, krendering_KPolyline, krendering_KPolygon, KPolyline, krendering_KImage, krendering_KDecoratorPlacementData, KPlacementData, krendering_KRoundedRectangle, krendering_KPlacement, krendering_KArc, krendering_KStyle, EMapPropertyHolder, krendering_KRenderingLibrary, KRendering, krendering_KGridPlacement, KPlacement, krendering_KGridPlacementData, KAreaPlacementData, krendering_KStyleHolder, krendering_KRenderingRef, krendering_KChildArea, krendering_KText, krendering_KAreaPlacementData, krendering_KCustomRendering, krendering_KColor, krendering_KVerticalAlignment, krendering_KHorizontalAlignment, krendering_KXPosition, krendering_KLineWidth, KStyle, krendering_KLineStyle, krendering_KTopPosition, krendering_KBottomPosition, krendering_KSpline, krendering_KForeground, krendering_KColoring, krendering_KYPosition, krendering_KLeftPosition, krendering_KRightPosition, krendering_KBackground, krendering_KFontBold, krendering_KFontItalic, krendering_KRoundedBendsPolyline, krendering_KRotation, krendering_KLineCap, krendering_KFontName, krendering_KFontSize, krendering_KPointPlacementData, krendering_KTextUnderline, krendering_KInvisibility, krendering_KShadow, krendering_KStyleRef, krendering_KTextStrikeout, krendering_KLineJoin, LineStyle, HorizontalAlignment, VerticalAlignment, LineCap, Trigger, ModifierState, Underline, Arc, LineJoin},
    associations={parent0, placementData1, actions2, points4, junctionPointRendering5, clipShape8, children10, childPlacement11, topLeft15, bottomRight17, renderings12, rendering13, topLeft20, bottomRight22, targetColor26, color25, rotationAnchor29, styles33, referencePoint31, color37, color35, styleHolder39, color41},
    generalizations={gen_krendering_KRendering_KGraphData, gen_krendering_KRendering_KStyleHolder, gen_krendering_KEllipse_KContainerRendering, gen_krendering_KRectangle_KContainerRendering, gen_krendering_KPolyline_KContainerRendering, gen_krendering_KPolygon_KPolyline, gen_krendering_KImage_KContainerRendering, gen_krendering_KDecoratorPlacementData_KPlacementData, gen_krendering_KRoundedRectangle_KContainerRendering, gen_krendering_KArc_KContainerRendering, gen_krendering_KStyle_EMapPropertyHolder, gen_krendering_KRenderingLibrary_KGraphData, gen_krendering_KContainerRendering_KRendering, gen_krendering_KGridPlacement_KPlacement, gen_krendering_KGridPlacementData_KAreaPlacementData, gen_krendering_KRenderingRef_KRendering, gen_krendering_KChildArea_KRendering, gen_krendering_KText_KRendering, gen_krendering_KAreaPlacementData_KPlacementData, gen_krendering_KCustomRendering_KContainerRendering, gen_krendering_KVerticalAlignment_KStyle, gen_krendering_KHorizontalAlignment_KStyle, gen_krendering_KLineWidth_KStyle, gen_krendering_KLineStyle_KStyle, gen_krendering_KSpline_KPolyline, gen_krendering_KColoring_KStyle, gen_krendering_KFontBold_KStyle, gen_krendering_KFontItalic_KStyle, gen_krendering_KRoundedBendsPolyline_KPolyline, gen_krendering_KRotation_KStyle, gen_krendering_KLineCap_KStyle, gen_krendering_KFontName_KStyle, gen_krendering_KFontSize_KStyle, gen_krendering_KPointPlacementData_KPlacementData, gen_krendering_KTextUnderline_KStyle, gen_krendering_KInvisibility_KStyle, gen_krendering_KShadow_KStyle, gen_krendering_KStyleRef_KStyle, gen_krendering_KTextStrikeout_KStyle, gen_krendering_KLineJoin_KStyle},
    metadata=None
)
