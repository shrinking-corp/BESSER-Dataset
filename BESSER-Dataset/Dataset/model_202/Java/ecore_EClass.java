...
public class ecore_EClass extends EClassifier {
    ...
    public ecore_EClass(
        boolean interface,        boolean abstract        ArrayList<ecore_EGenericType> ecore_egenerictypes,        ArrayList<ecore_EGenericType> ecore_egenerictypes,        ArrayList<ecore_EClass> ecore_eclasss,        ArrayList<ecore_EClass> ecore_eclasss    ) {
        this.interface = interface;
        this.abstract = abstract;
