...
ecore_EStructuralFeature.attributes={ecore_EStructuralFeature_unsettable, ecore_EStructuralFeature_volatile, ecore_EStructuralFeature_changeable, ecore_EStructuralFeature_transient, ecore_EStructuralFeature_defaultValueLiteral, ecore_EStructuralFeature_defaultValue, ecore_EStructuralFeature_derived}
...
ecore_ETypedElement.attributes={ecore_ETypedElement_many, ecore_ETypedElement_required, ecore_ETypedElement_ordered, ecore_ETypedElement_unique, ecore_ETypedElement_lowerBound, ecore_ETypedElement_upperBound}
...
ecore_EObject.methods={ecore_EObject_m_eGet, ecore_EObject_m_eSet, ecore_EObject_m_eIsProxy, ecore_EObject_m_eResource, ecore_EObject_m_eContainingFeature, ecore_EObject_m_eIsSet, ecore_EObject_m_eAllContents, ecore_EObject_m_eContents, ecore_EObject_m_eGet, ecore_EObject_m_eUnset, ecore_EObject_m_eCrossReferences, ecore_EObject_m_eContainmentFeature, ecore_EObject_m_eContainer, ecore_EObject_m_eClass}
...
domain_model = DomainModel(
    name="ecore",
    types={ecore_EAttribute, EStructuralFeature, ecore_EDataType, ecore_EStructuralFeature, ETypedElement, ecore_EClass, ecore_ETypedElement, ENamedElement, ecore_EClassifier, ecore_EGenericType, ecore_ENamedElement, EModelElement, ecore_EModelElement, EObject, ecore_EAnnotation, ecore_EObject, EClassifier, ecore_EOperation, ecore_EReference, ecore_EPackage, ecore_ETypeParameter, ecore_EFactory, ecore_EParameter, ecore_EStringToStringMapEntry, ecore_EEnum, EDataType, ecore_EEnumLiteral},
    associations={eAttributeType0, eContainingClass1, eType2, eGenericType3, eAnnotations5, eSuperTypes7, eOperations8, eAllAttributes9, eAllReferences12, eReferences14, eAttributes17, eAllContainments20, eAllOperations23, eAllStructuralFeatures25, eAllSuperTypes28, eidAttribute30, eStructuralFeatures33, eGenericSuperTypes35, eAllGenericSuperTypes38, ePackage41, eTypeParameters42, eFactoryInstance44, eSubpackages46, eSuperPackage49, eClassifiers51, ePackage53, eUpperBound59, eTypeArguments62, eRawType64, eLowerBound68, eTypeParameter70, eClassifier73, eTypeParameters76, eParameters79, eExceptions80, eGenericExceptions83, eContainingClass86, eOperation88, eOpposite91, eReferenceType93, eBounds55, eKeys96, details99, contents100, references102, eModelElement105, eLiterals106, eEnum107},
    generalizations={gen_ecore_EAttribute_EStructuralFeature, gen_ecore_EStructuralFeature_ETypedElement, gen_ecore_ETypedElement_ENamedElement, gen_ecore_ENamedElement_EModelElement, gen_ecore_EModelElement_EObject, gen_ecore_EClass_EClassifier, gen_ecore_EClassifier_ENamedElement, gen_ecore_EPackage_ENamedElement, gen_ecore_EFactory_EModelElement, gen_ecore_EDataType_EClassifier, gen_ecore_ETypeParameter_ENamedElement, gen_ecore_EGenericType_EObject, gen_ecore_EOperation_ETypedElement, gen_ecore_EParameter_ETypedElement, gen_ecore_EReference_EStructuralFeature, gen_ecore_EAnnotation_EModelElement, gen_ecore_EEnum_EDataType, gen_ecore_EEnumLiteral_ENamedElement},
    metadata=None
)
