...
Doctor.attributes={Doctor_department, Doctor_docid, Doctor_name, Doctor_address, Doctor_specialization, Doctor_phno}
...
Department.attributes={Department_name, Department_id, Department_doctorid}
...
Patient.attributes={Patient_id, Patient_telno, Patient_name, Patient_age, Patient_sex, Patient_roomno, Patient_address}
...
domain_model = DomainModel(
    name="fb94dc29_5b21_48ba_9086_2a8a4f6de23f",
    types={Receptionist, Person, Bill, Staff, Nurse, Doctor, Department, Patient, Room},
