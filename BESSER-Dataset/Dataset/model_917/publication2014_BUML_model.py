...
# Classes
publication2014_PublicationProcess = Class(name="publication2014_PublicationProcess")
Named = Class(name="Named")
publication2014_PublicationPhase = Class(name="publication2014_PublicationPhase")
publication2014_Rule = Class(name="publication2014_Rule")
publication2014_Sequence = Class(name="publication2014_Sequence")
publication2014_Researcher = Class(name="publication2014_Researcher")
publication2014_PlaceHolderPP = Class(name="publication2014_PlaceHolderPP")
publication2014_Review = Class(name="publication2014_Review")
publication2014_Paper = Class(name="publication2014_Paper")
publication2014_PlaceHolderRs = Class(name="publication2014_PlaceHolderRs")
publication2014_Paragraph = Class(name="publication2014_Paragraph")
publication2014_Progress = Class(name="publication2014_Progress")
Counted = Class(name="Counted")
publication2014_ReviewNote = Class(name="publication2014_ReviewNote")
publication2014_PlaceHolderRn = Class(name="publication2014_PlaceHolderRn")
Labelled = Class(name="Labelled")
publication2014_PlaceHolderRule = Class(name="publication2014_PlaceHolderRule")
publication2014_Write = Class(name="publication2014_Write")
publication2014_PublicationSystem = Class(name="publication2014_PublicationSystem")
publication2014_Named = Class(name="publication2014_Named", is_abstract=True)
publication2014_Counted = Class(name="publication2014_Counted", is_abstract=True)
publication2014_Labelled = Class(name="publication2014_Labelled", is_abstract=True)
PlaceHolder = Class(name="PlaceHolder")
publication2014_PlaceHolder = Class(name="publication2014_PlaceHolder", is_abstract=True)
publication2014_PublicationStructure = Class(name="publication2014_PublicationStructure")
...
publication2014_PublicationProcess.attributes={publication2014_PublicationProcess_maxTime, publication2014_PublicationProcess_minTime}
...
publication2014_PublicationPhase.attributes={publication2014_PublicationPhase_name, publication2014_PublicationPhase_maxTime, publication2014_PublicationPhase_minTime}
...
publication2014_Researcher.attributes={publication2014_Researcher_name, publication2014_Researcher_position, publication2014_Researcher_forName}
...
publication2014_Progress.attributes={publication2014_Progress_time, publication2014_Progress_percent}
...
domain_model = DomainModel(
    ...
    types={publication2014_PublicationProcess, Named, publication2014_PublicationPhase, publication2014_Rule, publication2014_Sequence, publication2014_Researcher, publication2014_PlaceHolderPP, publication2014_Review, publication2014_Paper, publication2014_PlaceHolderRs, publication2014_Paragraph, publication2014_Progress, Counted, publication2014_ReviewNote, publication2014_PlaceHolderRn, Labelled, publication2014_PlaceHolderRule, publication2014_Write, publication2014_PublicationSystem, publication2014_Named, publication2014_Counted, publication2014_Labelled, PlaceHolder, publication2014_PlaceHolder, publication2014_PublicationStructure, SequenceType},
    associations={phases0, publicationRules1, linksToSuccessors3, neededPerson5, rules6, placeholder9, successor11, predecessor14, writes20, reviews21, papers23, placeholder24, paragraphs26, progress27, authors28, reviews30, placeholder32, process34, paper36, placeholder17, phaseParticipation19, papers46, processView49, structuralView51, paragraph38, reviewNote41, researchers44},
    generalizations={gen_publication2014_PublicationProcess_Named, gen_publication2014_Paper_Named, gen_publication2014_Paragraph_Counted, gen_publication2014_Paragraph_Named, gen_publication2014_ReviewNote_Named, gen_publication2014_Progress_Labelled, gen_publication2014_PlaceHolderRs_PlaceHolder, gen_publication2014_PlaceHolderRule_PlaceHolder, gen_publication2014_PlaceHolderRn_PlaceHolder, gen_publication2014_PlaceHolderPP_PlaceHolder, gen_publication2014_Write_Labelled, gen_publication2014_Review_Labelled, gen_publication2014_PublicationStructure_Named},
    metadata=None
)
