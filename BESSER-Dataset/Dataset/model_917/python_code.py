...
class publication2014_Researcher:
    ...
    def __init__(self, name: str, forName: str, position: str, Researcher: "publication2014_PublicationPhase" = None, publication2014_Researcher: set["publication2014_Write"] = None, publication2014_Researcher22: set["publication2014_Review"] = None, authors: set["publication2014_Paper"] = None, publication2014_Researcher25: "publication2014_PlaceHolderRs" = None, publication2014_Researcher45: "publication2014_PublicationStructure" = None, Researcher29: "publication2014_Paper" = None, neededPerson: set["publication2014_PublicationPhase"] = None):
        self.name = name
...
class publication2014_Rule:
    ...
    def __init__(self, text: str, key: str, publication2014_Rule: "publication2014_PublicationProcess" = None, publication2014_Rule8: "publication2014_PublicationPhase" = None, publication2014_Rule18: "publication2014_PlaceHolderRule" = None):
        self.text = text
        self.key = key
...
class publication2014_PublicationPhase:
    ...
    def __init__(self, name: str, minTime: int, maxTime: int, publication2014_PublicationPhase: "publication2014_PublicationProcess" = None, publication2014_PublicationPhase4: set["publication2014_Sequence"] = None, phaseParticipation: set["publication2014_Researcher"] = None, publication2014_PublicationPhase7: set["publication2014_Rule"] = None, publication2014_PublicationPhase10: "publication2014_PlaceHolderPP" = None, publication2014_PublicationPhase13: "publication2014_Sequence" = None, publication2014_PublicationPhase16: "publication2014_Sequence" = None, PublicationPhase: "publication2014_Researcher" = None):
        self.name = name
...
class publication2014_ReviewNote(Named):
    ...
    def __init__(self, content: str, publication2014_ReviewNote43: "publication2014_Review" = None, publication2014_ReviewNote: "publication2014_Paragraph" = None, publication2014_ReviewNote33: "publication2014_PlaceHolderRn" = None):
...
class publication2014_Paragraph(Counted, Named):
    ...
    def __init__(self, content: str, publication2014_Paragraph: "publication2014_Paper" = None, publication2014_Paragraph40: "publication2014_Write" = None, publication2014_Paragraph31: set["publication2014_ReviewNote"] = None):
        self.content = content
