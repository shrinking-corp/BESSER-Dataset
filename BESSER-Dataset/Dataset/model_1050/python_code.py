...
class fsm_Transition:
    ...
    def __init__(self, event: str, fsm_Transition10: "fsm_State" = None, fsm_Transition13: "fsm_State" = None, fsm_Transition: "fsm_Machine" = None):
        self.event = event
...
class fsm_State:
    ...
    def __init__(self, name: str, initial: bool, final: bool, fsm_State11: "fsm_Transition" = None, fsm_State14: "fsm_Transition" = None, fsm_State: "fsm_Machine" = None):
        self.name = name
