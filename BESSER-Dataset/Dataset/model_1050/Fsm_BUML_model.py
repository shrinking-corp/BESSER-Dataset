...
fsm_Language = Class(name="fsm_Language")
fsm_Machine = Class(name="fsm_Machine")
...
fsm_Constraint.attributes={fsm_Constraint_name, fsm_Constraint_true}
...
fsm_State.attributes={fsm_State_name, fsm_State_final, fsm_State_initial}
...
domain_model = DomainModel(
    ...
    associations={from_9, to12, constraints0, languages1, machine3, states5, transitions7},
    generalizations={},
    metadata=None
)
