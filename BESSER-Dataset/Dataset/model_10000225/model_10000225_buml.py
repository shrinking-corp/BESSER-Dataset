...
Order.attributes={Order_total, Order_status, Order_number, Order_shipped, Order_ordered, Order_shipTo}
...
domain_model = DomainModel(
    name="_1c287c96_97b7_4234_bb05_871e65b55b5f",
    types={Customer, Payment, ShoppingCart, Account, WebUser, Order, LineItem, Product, UserState, OrderStatus},
    associations={Customer_Account, Account_ShoppingCart, ShoppingCart_LineItem, Product_LineItem, Order_LineItem, Account_Order, Payment_Order, Account_Payment, WebUser_ShoppingCart, WebUser_Customer},
    generalizations={},
    metadata=None
)
