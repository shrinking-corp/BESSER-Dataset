...
# Classes
Arch_Application = Class(name="Arch_Application")
Arch_FrontEnd = Class(name="Arch_FrontEnd")
Arch_BackEnd = Class(name="Arch_BackEnd")
Arch_View = Class(name="Arch_View")
Arch_Controller = Class(name="Arch_Controller")
Arch_Service = Class(name="Arch_Service")
Arch_Logic = Class(name="Arch_Logic")
Arch_Entity = Class(name="Arch_Entity")
Arch_GraphicControl = Class(name="Arch_GraphicControl", is_abstract=True)
Arch_Method = Class(name="Arch_Method")
Arch_Attribute = Class(name="Arch_Attribute")
Arch_Parameter = Class(name="Arch_Parameter")
Arch_Label = Class(name="Arch_Label")
GraphicControl = Class(name="GraphicControl")
Arch_TextBox = Class(name="Arch_TextBox")
Arch_Div = Class(name="Arch_Div")
Arch_Event = Class(name="Arch_Event")
Arch_DropDownList = Class(name="Arch_DropDownList")
...
domain_model = DomainModel(
    name="Arch",
    types={Arch_Application, Arch_FrontEnd, Arch_BackEnd, Arch_View, Arch_Controller, Arch_Service, Arch_Logic, Arch_Entity, Arch_GraphicControl, Arch_Method, Arch_Attribute, Arch_Parameter, Arch_Label, GraphicControl, Arch_TextBox, Arch_Div, Arch_Event, Arch_DropDownList},
    associations={frontend0, backend1, views3, controllers5, services7, logics9, entities11, graphicControls13, controllers15, methods23, methods25, attributes28, methods30, parameters33, events35, graphicControls38, views18, events21},
