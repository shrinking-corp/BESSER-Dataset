...
class Arch_Event:
    ...
    def __init__(self, name: str, Arch_Event37: "Arch_GraphicControl" = None, Arch_Event: "Arch_Controller" = None):
        self.name = name
...
class Arch_Method:
    ...
    def __init__(self, name: str, returntype: str, Arch_Method: "Arch_Service" = None, Arch_Method27: "Arch_Logic" = None, Arch_Method32: "Arch_Entity" = None, Arch_Method34: set["Arch_Parameter"] = None):
        self.name = name
...
class Arch_View:
    ...
    def __init__(self, name: str, Arch_View: "Arch_FrontEnd" = None, Arch_View14: set["Arch_GraphicControl"] = None, Arch_View16: set["Arch_Controller"] = None, Arch_View20: "Arch_Controller" = None):
        self.name = name
