...
class aggregator_p2view_IUPresentation(ABC):
    ...
    def __init__(self, version: str, name: str, label: str, description: str, type: str, id: str, aggregator_p2view_IUPresentation: "InstallableUnit" = None):
...
class aggregator_p2_IRepository(IAdaptable):
    ...
    def __init__(self, name: str, type: str, version: str, location: str, description: str, provider: str, modifiable: bool):
        self.name = name
        self.type = type
        self.version = version
        self.location = location
...
class aggregator_p2_IMetadataRepository(p2_IRepository, p2_IQueryable):
    ...
    def addReference(self, aggregator_nickname, aggregator_options, aggregator_location, aggregator_type):
...
class aggregator_p2_IQueryable(ABC):
    ...
    def __init__(self):
        ...
        pass
    def query(self, aggregator_collector, aggregator_query, aggregator_progress) :
...
class aggregator_p2_IUpdateDescriptor(ABC):
    ...
    def __init__(self, range: str, description: str, severity: int, id: str):
        self.range = range
        self.description = description
...
class aggregator_Configuration(EnabledStatusProvider):
    ...
    def __init__(self, operatingSystem: str, windowSystem: str, architecture: str, aggregator_Configuration33: "aggregator_MappedUnit" = None, aggregator_Configuration: "aggregator_Aggregator" = None, aggregator_Configuration36: "aggregator_ValidConfigurationsRule" = None):
...
class aggregator_MappedRepository(DescriptionProvider, MetadataRepositoryReference):
    ...
    def __init__(self, mirrorArtifacts: bool, categoryPrefix: str, aggregator_MappedRepository16: set["aggregator_Feature"] = None, aggregator_MappedRepository18: set["aggregator_Category"] = None, aggregator_MappedRepository20: set["aggregator_MapRule"] = None, aggregator_MappedRepository23: "aggregator_Contribution" = None, aggregator_MappedRepository: set["aggregator_Product"] = None, aggregator_MappedRepository14: set["aggregator_Bundle"] = None):
...
class aggregator_MapRule(DescriptionProvider, InstallableUnitRequest):
    ...
    pass
class aggregator_Contribution(StatusProvider, DescriptionProvider, InfosProvider, EnabledStatusProvider):

    def __init__(self, label: str, aggregator_Contribution22: set["aggregator_MappedRepository"] = None, aggregator_Contribution28: set["aggregator_MavenMapping"] = None, aggregator_Contribution: "aggregator_Aggregator" = None, aggregator_Contribution25: set["aggregator_Contact"] = None):
        self.label = label
...
class aggregator_Aggregator(StatusProvider, DescriptionProvider, InfosProvider):
    ...
    def __init__(self, label: str, buildRoot: str, packedStrategy: str, sendmail: bool, type: str, mavenResult: bool, Aggregator: "aggregator_Contact" = None, aggregator_Aggregator9: set["aggregator_MetadataRepositoryReference"] = None, aggregator_Aggregator: set["aggregator_Configuration"] = None, aggregator_Aggregator2: set["aggregator_Contribution"] = None, aggregator_Aggregator4: "aggregator_Contact" = None, aggregator: set["aggregator_Contact"] = None, aggregator_Aggregator7: set["aggregator_CustomCategory"] = None, aggregator_Aggregator11: set["aggregator_MavenMapping"] = None):
        self.label = label
