...
# Classes
publication105_Researcher = Class(name="publication105_Researcher")
publication105_Write = Class(name="publication105_Write")
publication105_Review = Class(name="publication105_Review")
publication105_Paper = Class(name="publication105_Paper")
publication105_Skill = Class(name="publication105_Skill")
publication105_Position = Class(name="publication105_Position")
publication105_Collaboration = Class(name="publication105_Collaboration")
Named = Class(name="Named")
publication105_Paragraph = Class(name="publication105_Paragraph")
Counted = Class(name="Counted")
publication105_ReviewNote = Class(name="publication105_ReviewNote")
publication105_PublicationStructure = Class(name="publication105_PublicationStructure")
publication105_Named = Class(name="publication105_Named", is_abstract=True)
publication105_Counted = Class(name="publication105_Counted", is_abstract=True)
publication105_Labelled = Class(name="publication105_Labelled", is_abstract=True)
...
publication105_Researcher.attributes={publication105_Researcher_forName, publication105_Researcher_name}
...
domain_model = DomainModel(
    name="publication105",
    types={publication105_Researcher, publication105_Write, publication105_Review, publication105_Paper, publication105_Skill, publication105_Position, publication105_Collaboration, Named, publication105_Paragraph, Counted, publication105_ReviewNote, publication105_PublicationStructure, publication105_Named, publication105_Counted, publication105_Labelled, Labelled},
    associations={writes0, reviews1, res_papers3, skills4, res_position6, collaborations8, paragraphs10, authors11, citedBy13, reviews15, paragraph17, reviewNote20, researchers23, papers25, positions28, parent32, col_paper34},
    generalizations={gen_publication105_Paper_Named, gen_publication105_Paragraph_Counted, gen_publication105_Paragraph_Named, gen_publication105_ReviewNote_Named, gen_publication105_Review_Labelled, gen_publication105_PublicationStructure_Named, gen_publication105_Position_Named, gen_publication105_Write_Labelled},
    metadata=None
)
