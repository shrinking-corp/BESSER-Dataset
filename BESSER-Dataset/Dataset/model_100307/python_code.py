...
class PetriNets_OutputArc:
    ...
    def __init__(self, weight: int, PetriNets_OutputArc17: "PetriNets_Place" = None, PetriNets_OutputArc: "PetriNets_PetriNet" = None, PetriNets_OutputArc14: "PetriNets_Transition" = None):
        self.weight = weight
...
class PetriNets_Place:
    ...
    def __init__(self, name: str, capacity: int, numberOfTokens: int, PetriNets_Place: "PetriNets_PetriNet" = None, PetriNets_Place18: "PetriNets_OutputArc" = None, PetriNets_Place9: "PetriNets_InputArc" = None):
        self.name = name
