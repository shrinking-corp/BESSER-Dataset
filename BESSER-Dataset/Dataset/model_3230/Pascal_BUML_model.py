...
pascal_program_heading_block = Class(name="pascal_program_heading_block")
...
pascal_var_ = Class(name="pascal_var_")
...
pascal_any_number = Class(name="pascal_any_number")
...
pascal_dynamic_array_type = Class(name="pascal_dynamic_array_type")
...
pascal_variable_identifier_list = Class(name="pascal_variable_identifier_list")
pascal_variable_section = Class(name="pascal_variable_section")
pascal_tag_field = Class(name="pascal_tag_field")
pascal_variant = Class(name="pascal_variant")
pascal_abstraction_heading = Class(name="pascal_abstraction_heading")
pascal_abstraction_declaration = Class(name="pascal_abstraction_declaration")
...
abstraction_declaration = Class(name="abstraction_declaration")
...
pascal_factor.attributes={pascal_factor_nil, pascal_factor_string, pascal_factor_boolean}
...
pascal_constant.attributes={pascal_constant_name, pascal_constant_nil, pascal_constant_string, pascal_constant_boolLiteral, pascal_constant_opterator}
...
not_74: BinaryAssociation = BinaryAssociation(
    name="not_74",
    ends={
...
domain_model = DomainModel(
    name="pascal",
    types={pascal_program, pascal_program_heading_block, pascal_block, pascal_identifier_list, pascal_label_declaration_part, pascal_constant_definition_part, pascal_type_definition_part, pascal_variable_declaration_part, pascal_procedure_and_function_declaration_part, pascal_statement_part, pascal_statement_sequence, pascal_statement, pascal_label, pascal_pascal, pascal_assignment_statement, pascal_function_designator, pascal_goto_statement, pascal_variable, pascal_expression, pascal_var_, pascal_expression_list, pascal_simple_expression, pascal_EObject, pascal_simple_statement, pascal_structured_statement, pascal_number, pascal_set, pascal_any_number, pascal_compound_statement, pascal_repetitive_statement, pascal_conditional_statement, pascal_with_statement, pascal_term, pascal_factor, pascal_if_statement, pascal_case_statement, pascal_case_limb, pascal_case_label_list, pascal_while_statement, pascal_repeat_statement, pascal_for_statement, pascal_constant_definition, pascal_type_definition, pascal_type, pascal_simple_type, pascal_structured_type, pascal_pointer_type, pascal_subrange_type, pascal_constant, pascal_unpacked_structured_type, pascal_array_type, pascal_dynamic_array_type, pascal_record_type, pascal_set_type, pascal_file_type, pascal_index_type, pascal_field_list, pascal_enumerated_type, pascal_variable_identifier_list, pascal_variable_section, pascal_tag_field, pascal_variant, pascal_abstraction_heading, pascal_abstraction_declaration, pascal_fixed_part, pascal_variant_part, pascal_record_section, pascal_formal_parameter_list, pascal_formal_parameter_section, pascal_value_parameter_section, pascal_variable_parameter_section, pascal_parameter_type, pascal_conformant_array_schema, pascal_packed_conformant_array_schema, pascal_unpacked_conformant_array_schema, pascal_bound_specification, abstraction_declaration},
    associations={program0, heading1, block3, identifiers5, label7, constant9, type11, variable13, abstraction15, statement17, sequence19, statements21, label23, assignment29, function31, goto33, variable35, expression37, variable39, expressions41, array44, variable47, pointer50, expressions52, expressions55, terms57, simple25, structured27, variable60, number63, set65, function67, expression70, not_74, number76, expressions78, expressions81, compound84, repetitive86, conditional88, withStmt90, sequence92, factors59, expression101, statement104, sequence107, expression110, assignment113, expression116, statement119, ifStmt122, caseStmt124, expression126, ifStatement129, elseStatement132, expression135, cases138, cases140, whileStmt95, repeatStmt97, forStmt99, number147, variables150, statement153, label156, labels159, consts162, const164, types167, type169, simple171, structured173, pointer175, subrange177, statement142, constants145, finalConst184, const187, identifiers190, type193, array195, dynamic197, record199, set201, file203, indexes205, type207, type210, type213, fields216, enumerated179, initialConst181, identifiers224, type225, identifiers228, type231, tag234, variants236, labels238, fields241, type244, type247, type250, sections253, procedures256, functions258, fixed218, heading260, variants220, block263, sections222, parameters266, parameters268, value270, variable272, procedure274, function277, identifiers280, type283, array285, packed287, unpacked289, bound291, bounds293, type296, identifiers299, type302},
