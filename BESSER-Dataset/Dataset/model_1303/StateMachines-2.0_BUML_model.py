...
StateMachines_ConnectionPointReference = Class(name="StateMachines_ConnectionPointReference")
...
domain_model = DomainModel(
    name="StateMachines",
    types={StateMachines_StateMachine, StateMachines_Region, StateMachines_ConnectionPointReference, StateMachines_FinalState, State, StateMachines_Vertex, StateMachines_Transition, StateMachines_Trigger, StateMachines_Pseudostate, Vertex, StateMachines_State, StateMachines_Behavior, PseudoStateKind, TransitionKind},
    associations={region0, connection25, deferrableTrigger27, submachine30, entry33, exit36, subvertex1, transition3, outgoing5, incoming8, trigger11, region13, connectionPoint15, entry17, exit19, doActivity22},
    generalizations={gen_StateMachines_ConnectionPointReference_Vertex, gen_StateMachines_FinalState_State, gen_StateMachines_Pseudostate_Vertex, gen_StateMachines_State_Vertex},
    metadata=None
)
