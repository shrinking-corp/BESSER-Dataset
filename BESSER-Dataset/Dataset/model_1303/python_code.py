...
class StateMachines_Pseudostate(Vertex):
    ...
    def __init__(self, kind: str, StateMachines_Pseudostate35: "StateMachines_ConnectionPointReference" = None, StateMachines_Pseudostate38: "StateMachines_ConnectionPointReference" = None, StateMachines_Pseudostate: "StateMachines_State" = None):
        self.kind = kind
...
class StateMachines_Transition:
    ...
    def __init__(self, kind: str, StateMachines_Transition: "StateMachines_Region" = None, StateMachines_Transition7: "StateMachines_Vertex" = None, StateMachines_Transition10: "StateMachines_Vertex" = None, StateMachines_Transition12: set["StateMachines_Trigger"] = None):
        self.kind = kind
