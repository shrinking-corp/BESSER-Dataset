...
Student_noOfLeaves: Property = Property(name="noOfLeaves", type=IntegerType)
Student_leavesTaken: Property = Property(name="leavesTaken", type=StringType)
Student.attributes={Student_studentName, Student_leavesTaken, Student_noOfLeaves, Student_studentId, Student_password}
...
LeaveApplication.attributes={LeaveApplication_studentId, LeaveApplication_fromDate, LeaveApplication_status, LeaveApplication_applicationId, LeaveApplication_toDate, LeaveApplication_reason}
...
LoginAction_student: Property = Property(name="student", type=Employee_Actor)
...
domain_model = DomainModel(
    name="_9115c2da_506e_4c37_98e1_3826d6662581",
    types={Withdraw_Application_UseCase, Approver_Jobs_UseCase, Approve_RejectRequests_UseCase, Cancel_Leaves_UseCase, Admin_Actor, CreateUser_UseCase, Update_Calendar_UseCase, Application_Actor, SendNotification_UseCase, Credit_Leaves_UseCase, AutoApproval_UseCase, GenerateSummary_UseCase, Student, Query, LeaveHistoryQuery, LeaveApplication, Request, ApplyLeaveRequest, WithdrawLeaveRequest, CancelLeaveRequest, LeaveStatusQuery, ApproveOrRejectStatus, LoginAction, CreateUserAction, UpdateCalendar, ApplicationUtils, Login_UseCase, Employee_Actor, Change_Password_UseCase, Query_Eligibility_UseCase, Query_Leave_Balance_UseCase, Query_Leave_History_UseCase, Apply_Leave_UseCase, Leave_Request_Status_UseCase, LeaveStatus},
