...
def test_loginaction_has_student():
...
def test_student_has_noOfLeaves():
    assert hasattr(Student, "noOfLeaves")
    descriptor = None
    for klass in Student.__mro__:
...
@given(instance=LoginAction_strategy)
def test_loginaction_student_setter(instance):
...
@given(instance=Student_strategy)
def test_student_noOfLeaves_setter(instance):
