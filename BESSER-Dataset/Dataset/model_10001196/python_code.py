...
class LoginAction:
    ...
    def __init__(self, student: Employee_Actor):
    ...
    @student.setter
    def student(self, student: Employee_Actor):
...
class LeaveApplication:
    ...
    def __init__(self, applicationId: str, fromDate: date, toDate: date, reason: str, studentId: str, status: str):
...
class Student:
    ...
    def __init__(self, studentId: str, studentName: str, password: str, noOfLeaves: int, leavesTaken: str):
        self.studentId = studentId
