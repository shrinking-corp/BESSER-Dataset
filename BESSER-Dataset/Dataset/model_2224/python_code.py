...
class oving1APD_Slot:
    ...
    def __init__(self, name: str, slot: "oving1APD_Course" = None, Slot: "oving1APD_Course" = None, Slot14: "oving1APD_Semester" = None, slot32: "oving1APD_Semester" = None):
        self.name = name
        self.slot = slot
        self.Slot = Slot
        self.Slot14 = Slot14
...
class oving1APD_Course:
    ...
    def __init__(self, name: str, credit: float, code: str, level: int, Course25: "oving1APD_Specialization" = None, Course30: "oving1APD_Slot" = None, hasCourse: "oving1APD_Semester" = None, course: "oving1APD_Specialization" = None, course11: "oving1APD_Slot" = None, Course: "oving1APD_Semester" = None):
        self.name = name
        self.credit = credit
        self.code = code
        self.level = level
...
class oving1APD_Semester:
    ...
    def __init__(self, number: int, semester16: "oving1APD_StudyProgram" = None, semester19: "oving1APD_Specialization" = None, Semester22: "oving1APD_Specialization" = None, Semester: "oving1APD_StudyProgram" = None, Semester7: "oving1APD_Course" = None, courseInSemester: set["oving1APD_Course"] = None, semester: "oving1APD_Slot" = None, Semester33: "oving1APD_Slot" = None):
        self.number = number
...
class oving1APD_Specialization:
    ...
    def __init__(self, name: str, Specialization20: "oving1APD_Semester" = None, specialization: "oving1APD_Semester" = None, specialization24: "oving1APD_Course" = None, specialization27: "oving1APD_StudyProgram" = None, Specialization: "oving1APD_StudyProgram" = None, Specialization9: "oving1APD_Course" = None):
        self.name = name
...
class oving1APD_StudyProgram:
    ...
    def __init__(self, name: str, shortName: str, StudyProgram: "oving1APD_Department" = None, StudyProgram17: "oving1APD_Semester" = None, StudyProgram28: "oving1APD_Specialization" = None, studyProgram: "oving1APD_Specialization" = None, studyProgram3: "oving1APD_Semester" = None, studyProgram5: "oving1APD_Department" = None):
        self.name = name
