...
oving1APD_Course.attributes={oving1APD_Course_code, oving1APD_Course_name, oving1APD_Course_credit, oving1APD_Course_level}
...
domain_model = DomainModel(
    name="oving1APD",
    types={oving1APD_Department, oving1APD_StudyProgram, oving1APD_Specialization, oving1APD_Semester, oving1APD_Course, oving1APD_Slot, CourseStatus},
    associations={studyProgram0, studyProgram15, specialization18, semester21, course23, studyProgram26, course29, specialization1, semester2, department4, courseInSemester6, specialization8, slot10, hasCourse12, slot13, semester31},
    generalizations={},
    metadata=None
)
