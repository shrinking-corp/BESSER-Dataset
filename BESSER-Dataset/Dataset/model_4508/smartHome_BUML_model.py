...
# Classes
smartHome_Sensor = Class(name="smartHome_Sensor")
...
smartHome_Condition = Class(name="smartHome_Condition")
...
smartHome_SensorValue = Class(name="smartHome_SensorValue")
...
smartHome_Sensor.attributes={smartHome_Sensor_name, smartHome_Sensor_dataFile, smartHome_Sensor_value}
...
smartHome_Duration.attributes={smartHome_Duration_value, smartHome_Duration_unit}
...
domain_model = DomainModel(
    name="smartHome",
    types={smartHome_Sensor, smartHome_SensorType, smartHome_SmartHome, smartHome_Rule, smartHome_Condition, smartHome_Event, smartHome_Duration, smartHome_Location, smartHome_SensorValue, Operator, DurationUnit},
    associations={sensors1, locations3, sensorTypes5, rules8, conditions10, event12, duration14, sensor16, sensorType0},
    generalizations={},
    metadata=None
)
