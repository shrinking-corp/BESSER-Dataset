...
class smartHome_Sensor:
    ...
    def __init__(self, dataFile: str, name: str, value: int, smartHome_Sensor2: "smartHome_Location" = None, smartHome_Sensor18: "smartHome_Condition" = None, smartHome_Sensor: "smartHome_SensorType" = None):
