...
public class Leave  {
    ...
    public Leave(
        LocalDate Leave_StartDate,        LocalDate Leave_ApplyDate,        String Leave_Title,        int leave_id,        String Leave_Status,        String Leave_detail,        int Leave_NoOfDays,        LocalDate Leave_EndDate,        int Emp_Id    ) {
