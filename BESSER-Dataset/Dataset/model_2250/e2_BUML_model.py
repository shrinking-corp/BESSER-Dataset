...
e2_Assingnment.attributes={e2_Assingnment_Type, e2_Assingnment_Content, e2_Assingnment_StartDate, e2_Assingnment_Title, e2_Assingnment_Deadline, e2_Assingnment_isMandatory}
...
e2_Course.attributes={e2_Course_ID, e2_Course_Name, e2_Course_Credit}
...
domain_model = DomainModel(
    name="e2",
    types={e2_LectureContent, e2_Person, e2_AssignmentSubmission, e2_Assingnment, e2_Course, e2_Group, e2_Lecture, e2_University},
    associations={Content0, Submitted1, Students2, Lecturerer4, Assingments7, Lectures9, StudentGroups12, Persons29, Courses31, LectureAssignment34, TeachingAssistant14, GroupMember17, Submitted20, assignment23, AssesedBy26},
    generalizations={},
    metadata=None
)
