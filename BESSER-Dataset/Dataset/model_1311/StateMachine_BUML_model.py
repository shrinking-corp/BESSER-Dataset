...
# Classes
ex_stateMachine_StateMachine = Class(name="ex_stateMachine_StateMachine")
InitState = Class(name="InitState")
State = Class(name="State")
Transition = Class(name="Transition")
ex_stateMachine_Transition = Class(name="ex_stateMachine_Transition")
OutputState = Class(name="OutputState")
InputState = Class(name="InputState")
ex_stateMachine_State = Class(name="ex_stateMachine_State", is_abstract=True)
ex_stateMachine_InputState = Class(name="ex_stateMachine_InputState", is_abstract=True)
ex_stateMachine_OutputState = Class(name="ex_stateMachine_OutputState", is_abstract=True)
ex_stateMachine_InitState = Class(name="ex_stateMachine_InitState")
ex_stateMachine_TerminalState = Class(name="ex_stateMachine_TerminalState")
ex_stateMachine_StandardState = Class(name="ex_stateMachine_StandardState")
stateMachine_InputState = Class(name="stateMachine_InputState")
stateMachine_OutputState = Class(name="stateMachine_OutputState")
...
domain_model = DomainModel(
    name="ex",
    types={ex_stateMachine_StateMachine, InitState, State, Transition, ex_stateMachine_Transition, OutputState, InputState, ex_stateMachine_State, ex_stateMachine_InputState, ex_stateMachine_OutputState, ex_stateMachine_InitState, ex_stateMachine_TerminalState, ex_stateMachine_StandardState, stateMachine_InputState, stateMachine_OutputState},
    associations={initState0, states1, transitions3, source5, target6, ingoingTransitions8, outgoingTransitions10},
    generalizations={gen_ex_stateMachine_InputState_State, gen_ex_stateMachine_OutputState_State, gen_ex_stateMachine_InitState_OutputState, gen_ex_stateMachine_TerminalState_InputState, gen_ex_stateMachine_StandardState_stateMachine_InputState, gen_ex_stateMachine_StandardState_stateMachine_OutputState},
    metadata=None
)
