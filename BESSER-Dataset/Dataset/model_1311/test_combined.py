...
def test_hyp_statemachine_outputstate_is_not_abstract():
    assert not inspect.isabstract(stateMachine_OutputState)


def test_hyp_statemachine_outputstate_constructor_exists():
    assert callable(stateMachine_OutputState.__init__)


def test_hyp_statemachine_outputstate_constructor_args():
    sig = inspect.signature(stateMachine_OutputState.__init__)
    params = list(sig.parameters.keys())



def test_hyp_statemachine_inputstate_is_not_abstract():
    assert not inspect.isabstract(stateMachine_InputState)


def test_hyp_statemachine_inputstate_constructor_exists():
    assert callable(stateMachine_InputState.__init__)


def test_hyp_statemachine_inputstate_constructor_args():
    sig = inspect.signature(stateMachine_InputState.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ex_statemachine_standardstate_is_not_abstract():
    assert not inspect.isabstract(ex_stateMachine_StandardState)


def test_hyp_ex_statemachine_standardstate_constructor_exists():
    assert callable(ex_stateMachine_StandardState.__init__)


def test_hyp_ex_statemachine_standardstate_constructor_args():
    sig = inspect.signature(ex_stateMachine_StandardState.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ex_statemachine_state_is_not_abstract():
    assert not inspect.isabstract(ex_stateMachine_State)


def test_hyp_ex_statemachine_state_constructor_exists():
    assert callable(ex_stateMachine_State.__init__)


def test_hyp_ex_statemachine_state_constructor_args():
...
def test_hyp_inputstate_is_not_abstract():
    assert not inspect.isabstract(InputState)


def test_hyp_inputstate_constructor_exists():
    assert callable(InputState.__init__)


def test_hyp_inputstate_constructor_args():
    sig = inspect.signature(InputState.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ex_statemachine_terminalstate_is_not_abstract():
    assert not inspect.isabstract(ex_stateMachine_TerminalState)


def test_hyp_ex_statemachine_terminalstate_constructor_exists():
    assert callable(ex_stateMachine_TerminalState.__init__)


def test_hyp_ex_statemachine_terminalstate_constructor_args():
    sig = inspect.signature(ex_stateMachine_TerminalState.__init__)
    params = list(sig.parameters.keys())



def test_hyp_outputstate_is_not_abstract():
    assert not inspect.isabstract(OutputState)


def test_hyp_outputstate_constructor_exists():
    assert callable(OutputState.__init__)


def test_hyp_outputstate_constructor_args():
    sig = inspect.signature(OutputState.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ex_statemachine_initstate_is_not_abstract():
    assert not inspect.isabstract(ex_stateMachine_InitState)


def test_hyp_ex_statemachine_initstate_constructor_exists():
    assert callable(ex_stateMachine_InitState.__init__)


def test_hyp_ex_statemachine_initstate_constructor_args():
    sig = inspect.signature(ex_stateMachine_InitState.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ex_statemachine_transition_is_not_abstract():
    assert not inspect.isabstract(ex_stateMachine_Transition)


def test_hyp_ex_statemachine_transition_constructor_exists():
    assert callable(ex_stateMachine_Transition.__init__)


def test_hyp_ex_statemachine_transition_constructor_args():
...
def test_hyp_ex_statemachine_inputstate_is_not_abstract():
    assert not inspect.isabstract(ex_stateMachine_InputState)


def test_hyp_ex_statemachine_inputstate_constructor_exists():
    assert callable(ex_stateMachine_InputState.__init__)


def test_hyp_ex_statemachine_inputstate_constructor_args():
    sig = inspect.signature(ex_stateMachine_InputState.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ex_statemachine_outputstate_is_not_abstract():
    assert not inspect.isabstract(ex_stateMachine_OutputState)


def test_hyp_ex_statemachine_outputstate_constructor_exists():
    assert callable(ex_stateMachine_OutputState.__init__)


def test_hyp_ex_statemachine_outputstate_constructor_args():
    sig = inspect.signature(ex_stateMachine_OutputState.__init__)
    params = list(sig.parameters.keys())



def test_hyp_initstate_is_not_abstract():
    assert not inspect.isabstract(InitState)


def test_hyp_initstate_constructor_exists():
    assert callable(InitState.__init__)


def test_hyp_initstate_constructor_args():
    sig = inspect.signature(InitState.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ex_statemachine_statemachine_is_not_abstract():
    assert not inspect.isabstract(ex_stateMachine_StateMachine)


def test_hyp_ex_statemachine_statemachine_constructor_exists():
    assert callable(ex_stateMachine_StateMachine.__init__)


def test_hyp_ex_statemachine_statemachine_constructor_args():
...
def test_hyp_ex_statemachine_state_name_setter(instance):
