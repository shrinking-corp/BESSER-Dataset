...
class gmfgraph_GridLayoutData(LayoutData):
    ...
    def __init__(self, horizontalSpan: int, horizontalIndent: int, grabExcessHorizontalSpace: bool, grabExcessVerticalSpace: bool, verticalAlignment: str, horizontalAlignment: str, verticalSpan: int, gmfgraph_GridLayoutData: "gmfgraph_Dimension" = None):
