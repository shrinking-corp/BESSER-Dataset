...
public class gmfgraph_Shape extends RealFigure {
    ...
    public gmfgraph_Shape(
        int lineWidth,        boolean xorOutline,        boolean xorFill,        boolean outline,        boolean fill,        String lineKind    ) {
        super(
        );
    ...
    public gmfgraph_Shape(
        int lineWidth,        boolean xorOutline,        boolean xorFill,        boolean outline,        boolean fill,        String lineKind        ArrayList<gmfgraph_Figure> gmfgraph_figures    ) {
        this.lineWidth = lineWidth;
        this.xorOutline = xorOutline;
        this.xorFill = xorFill;
        this.outline = outline;
