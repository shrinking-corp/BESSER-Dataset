...
gmfgraph_Shape.attributes={gmfgraph_Shape_outline, gmfgraph_Shape_xorOutline, gmfgraph_Shape_fill, gmfgraph_Shape_xorFill, gmfgraph_Shape_lineWidth, gmfgraph_Shape_lineKind}
...
gmfgraph_GridLayoutData.attributes={gmfgraph_GridLayoutData_grabExcessVerticalSpace, gmfgraph_GridLayoutData_verticalAlignment, gmfgraph_GridLayoutData_verticalSpan, gmfgraph_GridLayoutData_horizontalAlignment, gmfgraph_GridLayoutData_horizontalSpan, gmfgraph_GridLayoutData_horizontalIndent, gmfgraph_GridLayoutData_grabExcessHorizontalSpace}
...
gmfgraph_FlowLayout.attributes={gmfgraph_FlowLayout_forceSingleLine, gmfgraph_FlowLayout_minorSpacing, gmfgraph_FlowLayout_vertical, gmfgraph_FlowLayout_majorAlignment, gmfgraph_FlowLayout_majorSpacing, gmfgraph_FlowLayout_minorAlignment, gmfgraph_FlowLayout_matchMinorSize}
...
gmfgraph_SVGFigure.attributes={gmfgraph_SVGFigure_noCanvasHeight, gmfgraph_SVGFigure_noCanvasWidth, gmfgraph_SVGFigure_documentURI}
...
gmfgraph_SVGProperty.attributes={gmfgraph_SVGProperty_type, gmfgraph_SVGProperty_setter, gmfgraph_SVGProperty_attribute, gmfgraph_SVGProperty_callSuper, gmfgraph_SVGProperty_query, gmfgraph_SVGProperty_getter}
...
gmfgraph_Rectangle2D.attributes={gmfgraph_Rectangle2D_x, gmfgraph_Rectangle2D_y, gmfgraph_Rectangle2D_width, gmfgraph_Rectangle2D_height}
...
domain_model = DomainModel(
    name="gmfgraph",
    types={gmfgraph_FigureGallery, gmfgraph_Node, gmfgraph_Canvas, Identity, gmfgraph_VisualFacet, gmfgraph_AbstractNode, DiagramElement, gmfgraph_Connection, gmfgraph_Compartment, gmfgraph_DiagramLabel, gmfgraph_RealFigure, gmfgraph_FigureDescriptor, gmfgraph_Border, gmfgraph_Layout, gmfgraph_Identity, gmfgraph_DiagramElement, AbstractNode, gmfgraph_ChildAccess, Node, gmfgraph_LabelOffsetFacet, gmfgraph_DefaultSizeFacet, gmfgraph_Dimension, gmfgraph_Figure, Layoutable, gmfgraph_Color, gmfgraph_Font, gmfgraph_GeneralFacet, VisualFacet, gmfgraph_AlignmentFacet, gmfgraph_GradientFacet, AbstractFigure, gmfgraph_FigureRef, gmfgraph_Insets, gmfgraph_Point, gmfgraph_AbstractFigure, Figure, gmfgraph_Shape, gmfgraph_ConnectionFigure, RealFigure, gmfgraph_DecorationFigure, gmfgraph_LabeledContainer, gmfgraph_Rectangle, Shape, gmfgraph_RoundedRectangle, gmfgraph_Ellipse, gmfgraph_Polyline, gmfgraph_Polygon, Polyline, gmfgraph_ScalablePolygon, Polygon, gmfgraph_PolylineConnection, ConnectionFigure, gmfgraph_Label, gmfgraph_FigureAccessor, gmfgraph_CustomFigure, CustomClass, gmfgraph_CustomDecoration, CustomFigure, gmfgraph_CustomConnection, gmfgraph_RGBColor, Color, gmfgraph_PolylineDecoration, DecorationFigure, gmfgraph_PolygonDecoration, gmfgraph_CustomClass, gmfgraph_CustomAttribute, gmfgraph_BasicFont, Font, gmfgraph_BorderRef, Border, gmfgraph_ConstantColor, gmfgraph_CustomBorder, gmfgraph_LayoutData, gmfgraph_Layoutable, gmfgraph_LineBorder, gmfgraph_MarginBorder, gmfgraph_CompoundBorder, gmfgraph_BorderLayoutData, gmfgraph_LayoutRef, Layout, gmfgraph_CustomLayoutData, LayoutData, gmfgraph_CustomLayout, gmfgraph_GridLayoutData, gmfgraph_BorderLayout, gmfgraph_FlowLayout, gmfgraph_XYLayout, gmfgraph_XYLayoutData, gmfgraph_StackLayout, gmfgraph_SVGFigure, gmfgraph_SVGProperty, gmfgraph_Rectangle2D, gmfgraph_GridLayout, FontStyle, ColorConstants, Direction, LineKind, Alignment, SVGPropertyType},
    associations={figures0, facets19, nodes1, connections3, compartments5, labels7, figures9, descriptors11, borders13, layouts15, figure17, contentPane21, accessor23, accessor26, container29, defaultSize32, descriptor33, foregroundColor35, backgroundColor37, maximumSize40, minimumSize43, preferredSize46, font49, actualFigure61, accessors64, owner65, figure66, children69, insets51, border53, location56, size58, figure72, template76, sourceDecoration78, resolvedChildren74, typedFigure83, customChildren85, targetDecoration79, attributes82, outer93, inner95, owner98, actual87, color89, insets91, sizeHint99, layoutData101, layout103, actual105, spacing112, topLeft114, size116, properties119, areaOfInterest120, margins107, spacing109},
    generalizations={gen_gmfgraph_Canvas_Identity, gen_gmfgraph_AbstractNode_DiagramElement, gen_gmfgraph_FigureGallery_Identity, gen_gmfgraph_DiagramElement_Identity, gen_gmfgraph_Node_AbstractNode, gen_gmfgraph_Connection_DiagramElement, gen_gmfgraph_Compartment_DiagramElement, gen_gmfgraph_DiagramLabel_Node, gen_gmfgraph_LabelOffsetFacet_VisualFacet, gen_gmfgraph_DefaultSizeFacet_VisualFacet, gen_gmfgraph_Figure_Layoutable, gen_gmfgraph_GeneralFacet_VisualFacet, gen_gmfgraph_AlignmentFacet_VisualFacet, gen_gmfgraph_GradientFacet_VisualFacet, gen_gmfgraph_FigureDescriptor_Identity, gen_gmfgraph_RealFigure_AbstractFigure, gen_gmfgraph_FigureRef_AbstractFigure, gen_gmfgraph_AbstractFigure_Figure, gen_gmfgraph_Shape_RealFigure, gen_gmfgraph_ConnectionFigure_RealFigure, gen_gmfgraph_DecorationFigure_RealFigure, gen_gmfgraph_LabeledContainer_RealFigure, gen_gmfgraph_Rectangle_Shape, gen_gmfgraph_RoundedRectangle_Shape, gen_gmfgraph_Ellipse_Shape, gen_gmfgraph_Polyline_Shape, gen_gmfgraph_Polygon_Polyline, gen_gmfgraph_ScalablePolygon_Polygon, gen_gmfgraph_PolylineConnection_Polyline, gen_gmfgraph_PolylineConnection_ConnectionFigure, gen_gmfgraph_Label_RealFigure, gen_gmfgraph_CustomFigure_RealFigure, gen_gmfgraph_CustomFigure_CustomClass, gen_gmfgraph_CustomDecoration_CustomFigure, gen_gmfgraph_CustomDecoration_DecorationFigure, gen_gmfgraph_CustomConnection_CustomFigure, gen_gmfgraph_CustomConnection_ConnectionFigure, gen_gmfgraph_RGBColor_Color, gen_gmfgraph_PolylineDecoration_Polyline, gen_gmfgraph_PolylineDecoration_DecorationFigure, gen_gmfgraph_PolygonDecoration_Polygon, gen_gmfgraph_PolygonDecoration_DecorationFigure, gen_gmfgraph_BasicFont_Font, gen_gmfgraph_BorderRef_Border, gen_gmfgraph_ConstantColor_Color, gen_gmfgraph_CustomBorder_Border, gen_gmfgraph_CustomBorder_CustomClass, gen_gmfgraph_LineBorder_Border, gen_gmfgraph_MarginBorder_Border, gen_gmfgraph_CompoundBorder_Border, gen_gmfgraph_BorderLayoutData_LayoutData, gen_gmfgraph_LayoutRef_Layout, gen_gmfgraph_CustomLayoutData_LayoutData, gen_gmfgraph_CustomLayoutData_CustomClass, gen_gmfgraph_CustomLayout_Layout, gen_gmfgraph_GridLayoutData_LayoutData, gen_gmfgraph_BorderLayout_Layout, gen_gmfgraph_FlowLayout_Layout, gen_gmfgraph_XYLayout_Layout, gen_gmfgraph_XYLayoutData_LayoutData, gen_gmfgraph_StackLayout_Layout, gen_gmfgraph_SVGFigure_RealFigure, gen_gmfgraph_CustomLayout_CustomClass, gen_gmfgraph_GridLayout_Layout},
    metadata=None
)
