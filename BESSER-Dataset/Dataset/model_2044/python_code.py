...
class room_LogicalThread:
    ...
    def __init__(self, name: str, room_LogicalThread: "room_SubSystemClass" = None, room_LogicalThread139: set["room_ActorInstancePath"] = None):
        self.name = name
...
class room_TrPoint(StateGraphNode):
    ...
    def __init__(self, name: str, room_TrPoint198: "room_TrPointTerminal" = None, room_TrPoint200: "room_SubStateTrPointTerminal" = None, room_TrPoint: "room_StateGraph" = None):
        self.name = name
...
class room_Transition(StateGraphItem):
    ...
    def __init__(self, name: str, room_Transition: "room_StateGraph" = None, room_Transition186: "room_TransitionTerminal" = None, room_Transition188: "room_DetailCode" = None):
        self.name = name
...
class room_ActorContainerRef:
    ...
    def __init__(self, name: str, room_ActorContainerRef155: "room_RefSAPoint" = None, room_ActorContainerRef160: "room_SPPoint" = None, room_ActorContainerRef: "room_BindingEndPoint" = None):
        self.name = name
...
class room_InterfaceItem:
    ...
    def __init__(self, name: str, room_InterfaceItem215: "room_MessageFromIf" = None, room_InterfaceItem: "room_ProtocolClass" = None):
        self.name = name
...
class room_Port(InterfaceItem):
    ...
    def __init__(self, conjugated: bool, multiplicity: int, room_Port: "room_ActorClass" = None, room_Port105: "room_ActorClass" = None, room_Port124: "room_ExternalPort" = None, room_Port135: "room_SubSystemClass" = None, room_Port149: "room_BindingEndPoint" = None):
...
class room_Type:
    ...
    def __init__(self, prim: str, room_Type20: "room_DataClass" = None, room_Type34: "room_Attribute" = None, room_Type: "room_TypedID" = None):
        self.prim = prim
...
class room_Message:
    ...
    def __init__(self, name: str, room_Message: "room_ProtocolClass" = None, room_Message56: "room_ProtocolClass" = None, room_Message212: "room_MessageFromIf" = None, room_Message80: "room_MessageHandler" = None, room_Message88: "room_SemanticsRule" = None, room_Message65: set["room_TypedID"] = None):
        self.name = name
...
class room_DetailCode:
    ...
    def __init__(self, commands: str, room_DetailCode: "room_Operation" = None, room_DetailCode48: "room_ProtocolClass" = None, room_DetailCode51: "room_ProtocolClass" = None, room_DetailCode69: "room_PortClass" = None, room_DetailCode168: "room_State" = None, room_DetailCode171: "room_State" = None, room_DetailCode189: "room_Transition" = None, room_DetailCode194: "room_CPBranchTransition" = None, room_DetailCode218: "room_Guard" = None, room_DetailCode83: "room_MessageHandler" = None, room_DetailCode99: "room_ActorClass" = None, room_DetailCode102: "room_ActorClass" = None):
...
class room_Operation:
    ...
    def __init__(self, name: str, room_Operation: "room_DataClass" = None, room_Operation36: set["room_FreeTypedID"] = None, room_Operation39: "room_FreeType" = None, room_Operation42: "room_DetailCode" = None, room_Operation75: "room_PortClass" = None, room_Operation117: "room_ActorClass" = None):
        self.name = name
...
class room_Attribute:
    ...
    def __init__(self, name: str, size: int, room_Attribute: "room_DataClass" = None, room_Attribute33: "room_Type" = None, room_Attribute72: "room_PortClass" = None, room_Attribute114: "room_ActorClass" = None):
        self.name = name
        self.size = size
...
class room_ActorClass(ActorContainerClass):
    ...
    def __init__(self, abstract: bool, room_ActorClass: "room_RoomModel" = None, room_ActorClass166: "room_ActorRef" = None, room_ActorClass94: "room_ActorClass" = None, room_ActorClass92: "room_ActorClass" = None, room_ActorClass96: set["room_Port"] = None, room_ActorClass98: "room_DetailCode" = None, room_ActorClass101: "room_DetailCode" = None, room_ActorClass104: set["room_Port"] = None, room_ActorClass107: set["room_ExternalPort"] = None, room_ActorClass109: set["room_ServiceImplementation"] = None, room_ActorClass111: set["room_SAPRef"] = None, room_ActorClass113: set["room_Attribute"] = None, room_ActorClass119: "room_StateGraph" = None, room_ActorClass116: set["room_Operation"] = None):
...
class room_RoomModel:
    ...
    def __init__(self, name: str, room_RoomModel: set["room_Import"] = None, room_RoomModel2: set["room_DataClass"] = None, room_RoomModel4: set["room_ProtocolClass"] = None, room_RoomModel6: set["room_ActorClass"] = None, room_RoomModel8: set["room_SubSystemClass"] = None, room_RoomModel10: set["room_LogicalSystem"] = None):
        self.name = name
