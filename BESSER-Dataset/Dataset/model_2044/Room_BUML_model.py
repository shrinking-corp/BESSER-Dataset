...
room_FreeTypedID = Class(name="room_FreeTypedID")
room_FreeType = Class(name="room_FreeType")
...
room_TypedID = Class(name="room_TypedID")
room_Type = Class(name="room_Type")
room_MessageHandler = Class(name="room_MessageHandler")
room_SemanticsRule = Class(name="room_SemanticsRule")
room_SemanticsInRule = Class(name="room_SemanticsInRule")
SemanticsRule = Class(name="SemanticsRule")
room_SemanticsOutRule = Class(name="room_SemanticsOutRule")
...
room_BaseState = Class(name="room_BaseState")
...
room_FreeType.attributes={room_FreeType_prim, room_FreeType_type}
...
from_150: BinaryAssociation = BinaryAssociation(
    name="from_150",
    ends={
...
from_190: BinaryAssociation = BinaryAssociation(
    name="from_190",
    ends={
...
from_213: BinaryAssociation = BinaryAssociation(
    name="from_213",
    ends={
...
domain_model = DomainModel(
    name="room",
    types={room_RoomModel, room_Import, room_DataClass, room_ProtocolClass, room_ActorClass, room_SubSystemClass, room_LogicalSystem, room_RoomClass, room_StructureClass, RoomClass, room_Binding, room_LayerConnection, room_ActorContainerClass, StructureClass, room_SPPRef, room_ActorRef, room_FreeTypedID, room_FreeType, room_Attribute, room_Operation, room_DetailCode, room_Message, room_PortClass, room_ProtocolSemantics, room_TypedID, room_Type, room_MessageHandler, room_SemanticsRule, room_SemanticsInRule, SemanticsRule, room_SemanticsOutRule, ActorContainerClass, room_Port, room_ExternalPort, room_ServiceImplementation, room_SAPRef, room_StateGraph, room_InterfaceItem, InterfaceItem, room_SubSystemRef, room_ActorContainerRef, ActorContainerRef, room_ActorInstancePath, room_BindingEndPoint, room_SAPoint, room_SPPoint, room_RefSAPoint, SAPoint, room_RelaySAPoint, room_StateGraphNode, StateGraphItem, room_StateGraphItem, room_State, StateGraphNode, room_LogicalThread, room_Transition, room_BaseState, State, room_RefinedState, room_TransitionPoint, TrPoint, room_EntryPoint, room_ExitPoint, room_TransitionTerminal, room_NonInitialTransition, Transition, room_InitialTransition, room_ContinuationTransition, NonInitialTransition, room_TriggeredTransition, room_Trigger, room_CPBranchTransition, room_StateTerminal, TransitionTerminal, room_TrPointTerminal, room_SubStateTrPointTerminal, room_TrPoint, room_ChoicePoint, room_MessageFromIf, room_Guard, room_ChoicepointTerminal, PrimitiveType},
    associations={imports0, dataClasses1, protocolClasses3, actorClasses5, subSystemClasses7, systems9, bindings11, connections12, ifSPPs14, actorRefs15, type18, type19, base23, imports25, attributes28, operations30, type32, arguments35, returntype38, detailCode41, base44, userCode146, userCode249, incomingMessages52, outgoingMessages54, regular57, conjugate59, semantics62, type17, userCode67, attributes70, operations73, msgHandlers76, msg78, detailCode81, rules84, msg86, followUps90, base93, ifPorts95, userCode197, userCode2100, intPorts103, extPorts106, serviceImplementations108, strSAPs110, attributes112, arguments64, stateMachine118, protocol120, ifport122, spp125, subSystems128, type130, relayPorts133, operations115, threads136, instances138, endpoint1140, endpoint2142, actorRef145, port147, from_150, to152, ref154, relay156, ref158, service161, type164, entryCode167, exitCode169, subgraph172, states175, chPoints180, transitions182, base184, to185, action187, from_190, triggers192, condition193, state195, trPoint197, trPoint199, state201, trPoints178, msgFromIfPairs206, guard208, message210, from_213, guard216, cp204},
    generalizations={gen_room_StructureClass_RoomClass, gen_room_ActorContainerClass_StructureClass, gen_room_DataClass_RoomClass, gen_room_ProtocolClass_RoomClass, gen_room_SemanticsInRule_SemanticsRule, gen_room_SemanticsOutRule_SemanticsRule, gen_room_ActorClass_ActorContainerClass, gen_room_Port_InterfaceItem, gen_room_SAPRef_InterfaceItem, gen_room_SPPRef_InterfaceItem, gen_room_LogicalSystem_StructureClass, gen_room_SubSystemRef_ActorContainerRef, gen_room_SubSystemClass_ActorContainerClass, gen_room_RefSAPoint_SAPoint, gen_room_RelaySAPoint_SAPoint, gen_room_ActorRef_ActorContainerRef, gen_room_StateGraphNode_StateGraphItem, gen_room_State_StateGraphNode, gen_room_BaseState_State, gen_room_RefinedState_State, gen_room_TrPoint_StateGraphNode, gen_room_TransitionPoint_TrPoint, gen_room_EntryPoint_TrPoint, gen_room_ExitPoint_TrPoint, gen_room_ChoicePoint_StateGraphNode, gen_room_Transition_StateGraphItem, gen_room_NonInitialTransition_Transition, gen_room_InitialTransition_Transition, gen_room_ContinuationTransition_NonInitialTransition, gen_room_TriggeredTransition_NonInitialTransition, gen_room_CPBranchTransition_NonInitialTransition, gen_room_StateTerminal_TransitionTerminal, gen_room_TrPointTerminal_TransitionTerminal, gen_room_SubStateTrPointTerminal_TransitionTerminal, gen_room_ChoicepointTerminal_TransitionTerminal},
    metadata=None
)
