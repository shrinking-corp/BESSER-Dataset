...
User.attributes={User_User_Id, User_User_contact, User_User_Name, User_User_Email, User_User_Address, User_User_DOB}
...
Salary.attributes={Salary_Sly_Increment, Salary_Sly_Basic, Salary_Sly_Netgross, Salary_OverTime, Salary_Sly_Decrement, Salary_Emp_Id}
...
L__Leave.attributes={L__Leave_Leave_EndDate, L__Leave_leave_id, L__Leave_Leave_detail, L__Leave_Emp_Id, L__Leave_Leave_StartDate, L__Leave_Leave_NoOfDays, L__Leave_Leave_Title, L__Leave_Leave_ApplyDate, L__Leave_Leave_Status}
...
Attendance.attributes={Attendance_Attend_date, Attendance_AttendTime, Attendance_Leaving_Time, Attendance_Emp_id}
...
Employee.attributes={Employee_Emp_Position, Employee_Emp_Name, Employee_Emp_NIC, Employee_Emp_DOB, Employee_Emp_Date_Of_Joint, Employee_Emp_Address, Employee_Emp_Id, Employee_Emp_Salary, Employee_Emp_Email, Employee_Emp_ContactNo, Employee_Emp_Department}
...
domain_model = DomainModel(
    name="cf1ed78f_4538_4367_815d_1e9829036328",
    types={User, Salary, Admin, L__Leave, Attendance, Login, T, Employee_Management_System_Component, Authentication_UseCase, Salary_Management_UseCase, Administrator_Actor, Employee_Actor, Employee, _10000, _10_7_1992, Login_external, Logout_external},
