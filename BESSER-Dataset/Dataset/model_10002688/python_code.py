...
class L__Leave:
    ...
    def __init__(self, Emp_Id: str, Leave_Title: str, Leave_detail: str, Leave_ApplyDate: str, Leave_StartDate: str, Leave_EndDate: str, Leave_NoOfDays: str, Leave_Status: str, leave_id: str, Employee_Leave_11: "User" = None):
        self.Emp_Id = Emp_Id
