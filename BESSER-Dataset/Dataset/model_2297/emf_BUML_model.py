...
# Classes
emf_Action = Class(name="emf_Action")
emf_State = Class(name="emf_State")
emf_StateMachine = Class(name="emf_StateMachine")
emf_TransitionToStateMapEntry = Class(name="emf_TransitionToStateMapEntry")
emf_Transition = Class(name="emf_Transition")
...
emf_State.attributes={emf_State_type, emf_State_name}
...
domain_model = DomainModel(
    name="emf",
    types={emf_Action, emf_State, emf_StateMachine, emf_TransitionToStateMapEntry, emf_Transition, StateType},
    associations={nestedStateMachines0, states1, transitionToSourceState4, targetState6, key8, value11},
    generalizations={},
    metadata=None
)
