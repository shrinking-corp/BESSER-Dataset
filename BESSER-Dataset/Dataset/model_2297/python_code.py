...
class emf_State:
    ...
    def __init__(self, type: str, name: str, emf_State: set["emf_StateMachine"] = None, emf_State3: "emf_StateMachine" = None, emf_State7: "emf_Transition" = None, emf_State13: "emf_TransitionToStateMapEntry" = None):
        self.type = type
        self.name = name
