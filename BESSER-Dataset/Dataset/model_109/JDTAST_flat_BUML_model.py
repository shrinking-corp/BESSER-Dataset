...
# Classes
JDTAST_IClassFile = Class(name="JDTAST_IClassFile")
JDTAST_ICompilationUnit = Class(name="JDTAST_ICompilationUnit")
JDTAST_ITypeRoot = Class(name="JDTAST_ITypeRoot", is_abstract=True)
ISourceReference = Class(name="ISourceReference")
ITypeRoot = Class(name="ITypeRoot")
JDTAST_IType = Class(name="JDTAST_IType")
JDTAST_IImportDeclaration = Class(name="JDTAST_IImportDeclaration")
JDTAST_IJavaElement = Class(name="JDTAST_IJavaElement", is_abstract=True)
JDTAST_PhysicalElement = Class(name="JDTAST_PhysicalElement", is_abstract=True)
JDTAST_IJavaModel = Class(name="JDTAST_IJavaModel")
PhysicalElement = Class(name="PhysicalElement")
JDTAST_IJavaProject = Class(name="JDTAST_IJavaProject")
JDTAST_IPackageFragmentRoot = Class(name="JDTAST_IPackageFragmentRoot", is_abstract=True)
IJavaElement = Class(name="IJavaElement")
JDTAST_IPackageFragment = Class(name="JDTAST_IPackageFragment")
JDTAST_BinaryPackageFragmentRoot = Class(name="JDTAST_BinaryPackageFragmentRoot")
IPackageFragmentRoot = Class(name="IPackageFragmentRoot")
JDTAST_SourcePackageFragmentRoot = Class(name="JDTAST_SourcePackageFragmentRoot")
JDTAST_ITypeParameter = Class(name="JDTAST_ITypeParameter")
JDTAST_CompilationUnit = Class(name="JDTAST_CompilationUnit")
JDTAST_ISourceReference = Class(name="JDTAST_ISourceReference", is_abstract=True)
JDTAST_ISourceRange = Class(name="JDTAST_ISourceRange")
JDTAST_IMember = Class(name="JDTAST_IMember", is_abstract=True)
IMember = Class(name="IMember")
JDTAST_IInitializer = Class(name="JDTAST_IInitializer")
JDTAST_IField = Class(name="JDTAST_IField")
JDTAST_IMethod = Class(name="JDTAST_IMethod")
JDTAST_AnonymousClassDeclaration = Class(name="JDTAST_AnonymousClassDeclaration")
ASTNode = Class(name="ASTNode")
JDTAST_BodyDeclaration = Class(name="JDTAST_BodyDeclaration", is_abstract=True)
JDTAST_ExtendedModifier = Class(name="JDTAST_ExtendedModifier", is_abstract=True)
JDTAST_Javadoc = Class(name="JDTAST_Javadoc")
JDTAST_CatchClause = Class(name="JDTAST_CatchClause")
JDTAST_Parameter = Class(name="JDTAST_Parameter")
JDTAST_AST = Class(name="JDTAST_AST")
JDTAST_ASTNode = Class(name="JDTAST_ASTNode", is_abstract=True)
JDTAST_Block = Class(name="JDTAST_Block")
JDTAST_SingleVariableDeclaration = Class(name="JDTAST_SingleVariableDeclaration")
JDTAST_Comment = Class(name="JDTAST_Comment", is_abstract=True)
JDTAST_PackageDeclaration = Class(name="JDTAST_PackageDeclaration")
JDTAST_ImportDeclaration = Class(name="JDTAST_ImportDeclaration")
JDTAST_AbstractTypeDeclaration = Class(name="JDTAST_AbstractTypeDeclaration", is_abstract=True)
JDTAST_Expression = Class(name="JDTAST_Expression", is_abstract=True)
JDTAST_Name = Class(name="JDTAST_Name", is_abstract=True)
JDTAST_MemberRef = Class(name="JDTAST_MemberRef")
JDTAST_Modifier = Class(name="JDTAST_Modifier")
ExtendedModifier = Class(name="ExtendedModifier")
JDTAST_SimpleName = Class(name="JDTAST_SimpleName")
JDTAST_MemberValuePair = Class(name="JDTAST_MemberValuePair")
JDTAST_MethodRef = Class(name="JDTAST_MethodRef")
JDTAST_MethodRefParameter = Class(name="JDTAST_MethodRefParameter")
JDTAST_Type = Class(name="JDTAST_Type", is_abstract=True)
BodyDeclaration = Class(name="BodyDeclaration")
JDTAST_Annotation = Class(name="JDTAST_Annotation", is_abstract=True)
JDTAST_Statement = Class(name="JDTAST_Statement", is_abstract=True)
JDTAST_TagElement = Class(name="JDTAST_TagElement")
JDTAST_TextElement = Class(name="JDTAST_TextElement")
JDTAST_TypeParameter = Class(name="JDTAST_TypeParameter")
JDTAST_VariableDeclaration = Class(name="JDTAST_VariableDeclaration", is_abstract=True)
JDTAST_AnnotationTypeMemberDeclaration = Class(name="JDTAST_AnnotationTypeMemberDeclaration")
JDTAST_EnumConstantDeclaration = Class(name="JDTAST_EnumConstantDeclaration")
JDTAST_FieldDeclaration = Class(name="JDTAST_FieldDeclaration")
JDTAST_VariableDeclarationFragment = Class(name="JDTAST_VariableDeclarationFragment")
JDTAST_Initializer = Class(name="JDTAST_Initializer")
JDTAST_MethodDeclaration = Class(name="JDTAST_MethodDeclaration")
JDTAST_ArrayCreation = Class(name="JDTAST_ArrayCreation")
JDTAST_ArrayInitializer = Class(name="JDTAST_ArrayInitializer")
JDTAST_ArrayType = Class(name="JDTAST_ArrayType")
JDTAST_AnnotationTypeDeclaration = Class(name="JDTAST_AnnotationTypeDeclaration")
AbstractTypeDeclaration = Class(name="AbstractTypeDeclaration")
JDTAST_EnumDeclaration = Class(name="JDTAST_EnumDeclaration")
JDTAST_TypeDeclaration = Class(name="JDTAST_TypeDeclaration")
JDTAST_BlockComment = Class(name="JDTAST_BlockComment")
Comment = Class(name="Comment")
JDTAST_LineComment = Class(name="JDTAST_LineComment")
Expression = Class(name="Expression")
JDTAST_ArrayAccess = Class(name="JDTAST_ArrayAccess")
JDTAST_Assignment = Class(name="JDTAST_Assignment")
JDTAST_BooleanLiteral = Class(name="JDTAST_BooleanLiteral")
JDTAST_CastExpression = Class(name="JDTAST_CastExpression")
JDTAST_CharacterLiteral = Class(name="JDTAST_CharacterLiteral")
JDTAST_ClassInstanceCreation = Class(name="JDTAST_ClassInstanceCreation")
JDTAST_InstanceofExpression = Class(name="JDTAST_InstanceofExpression")
JDTAST_ConditionalExpression = Class(name="JDTAST_ConditionalExpression")
JDTAST_FieldAccess = Class(name="JDTAST_FieldAccess")
JDTAST_InfixExpression = Class(name="JDTAST_InfixExpression")
JDTAST_PrefixExpression = Class(name="JDTAST_PrefixExpression")
JDTAST_MethodInvocation = Class(name="JDTAST_MethodInvocation")
JDTAST_NullLiteral = Class(name="JDTAST_NullLiteral")
JDTAST_NumberLiteral = Class(name="JDTAST_NumberLiteral")
JDTAST_ParenthesizedExpression = Class(name="JDTAST_ParenthesizedExpression")
JDTAST_PostfixExpression = Class(name="JDTAST_PostfixExpression")
JDTAST_AssertStatement = Class(name="JDTAST_AssertStatement")
Statement = Class(name="Statement")
JDTAST_StringLiteral = Class(name="JDTAST_StringLiteral")
JDTAST_SuperFieldAccess = Class(name="JDTAST_SuperFieldAccess")
JDTAST_SuperMethodInvocation = Class(name="JDTAST_SuperMethodInvocation")
JDTAST_ThisExpression = Class(name="JDTAST_ThisExpression")
JDTAST_TypeLiteral = Class(name="JDTAST_TypeLiteral")
JDTAST_VariableDeclarationExpression = Class(name="JDTAST_VariableDeclarationExpression")
JDTAST_ForStatement = Class(name="JDTAST_ForStatement")
JDTAST_BreakStatement = Class(name="JDTAST_BreakStatement")
JDTAST_ConstructorInvocation = Class(name="JDTAST_ConstructorInvocation")
JDTAST_ContinueStatement = Class(name="JDTAST_ContinueStatement")
JDTAST_DoStatement = Class(name="JDTAST_DoStatement")
JDTAST_EmptyStatement = Class(name="JDTAST_EmptyStatement")
JDTAST_EnhancedForStatement = Class(name="JDTAST_EnhancedForStatement")
JDTAST_ExpressionStatement = Class(name="JDTAST_ExpressionStatement")
JDTAST_SwitchCase = Class(name="JDTAST_SwitchCase")
JDTAST_SwitchStatement = Class(name="JDTAST_SwitchStatement")
JDTAST_IfStatement = Class(name="JDTAST_IfStatement")
JDTAST_LabeledStatement = Class(name="JDTAST_LabeledStatement")
JDTAST_ReturnStatement = Class(name="JDTAST_ReturnStatement")
JDTAST_SuperConstructorInvocation = Class(name="JDTAST_SuperConstructorInvocation")
JDTAST_WhileStatement = Class(name="JDTAST_WhileStatement")
JDTAST_SynchronizedStatement = Class(name="JDTAST_SynchronizedStatement")
JDTAST_ThrowStatement = Class(name="JDTAST_ThrowStatement")
JDTAST_TryStatement = Class(name="JDTAST_TryStatement")
JDTAST_TypeDeclarationStatement = Class(name="JDTAST_TypeDeclarationStatement")
JDTAST_VariableDeclarationStatement = Class(name="JDTAST_VariableDeclarationStatement")
JDTAST_PrimitiveType = Class(name="JDTAST_PrimitiveType")
JDTAST_QualifiedType = Class(name="JDTAST_QualifiedType")
Type = Class(name="Type")
JDTAST_ParameterizedType = Class(name="JDTAST_ParameterizedType")
JDTAST_MarkerAnnotation = Class(name="JDTAST_MarkerAnnotation")
Annotation = Class(name="Annotation")
JDTAST_NormalAnnotation = Class(name="JDTAST_NormalAnnotation")
JDTAST_SingleMemberAnnotation = Class(name="JDTAST_SingleMemberAnnotation")
JDTAST_SimpleType = Class(name="JDTAST_SimpleType")
JDTAST_WildcardType = Class(name="JDTAST_WildcardType")
VariableDeclaration = Class(name="VariableDeclaration")
JDTAST_QualifiedName = Class(name="JDTAST_QualifiedName")
...
JDTAST_IField.attributes={JDTAST_IField_isVolatile, JDTAST_IField_isEnumConstant, JDTAST_IField_typeSignature, JDTAST_IField_isTransient, JDTAST_IField_constant}
...
JDTAST_IMethod.attributes={JDTAST_IMethod_isConstructor, JDTAST_IMethod_returnType, JDTAST_IMethod_exceptionTypes, JDTAST_IMethod_isMainMethod}
...
JDTAST_ImportDeclaration.attributes={JDTAST_ImportDeclaration_static, JDTAST_ImportDeclaration_onDemand}
...
JDTAST_AbstractTypeDeclaration.attributes={JDTAST_AbstractTypeDeclaration_localTypeDeclaration, JDTAST_AbstractTypeDeclaration_packageMemberTypeDeclaration, JDTAST_AbstractTypeDeclaration_memberTypeDeclaration}
...
JDTAST_Modifier.attributes={JDTAST_Modifier_strictfp, JDTAST_Modifier_private, JDTAST_Modifier_abstract, JDTAST_Modifier_static, JDTAST_Modifier_native, JDTAST_Modifier_protected, JDTAST_Modifier_none, JDTAST_Modifier_transient, JDTAST_Modifier_final, JDTAST_Modifier_volatile, JDTAST_Modifier_synchronized, JDTAST_Modifier_public}
...
JDTAST_TagElement.attributes={JDTAST_TagElement_tagName, JDTAST_TagElement_nested}
...
JDTAST_MethodDeclaration.attributes={JDTAST_MethodDeclaration_extraDimensions, JDTAST_MethodDeclaration_varargs, JDTAST_MethodDeclaration_constructor}
...
JDTAST_CharacterLiteral.attributes={JDTAST_CharacterLiteral_escapedValue, JDTAST_CharacterLiteral_charValue}
...
finally_382: BinaryAssociation = BinaryAssociation(
    name="finally_382",
    ends={
...
domain_model = DomainModel(
    name="JDTAST",
    types={JDTAST_IClassFile, JDTAST_ICompilationUnit, JDTAST_ITypeRoot, ISourceReference, ITypeRoot, JDTAST_IType, JDTAST_IImportDeclaration, JDTAST_IJavaElement, JDTAST_PhysicalElement, JDTAST_IJavaModel, PhysicalElement, JDTAST_IJavaProject, JDTAST_IPackageFragmentRoot, IJavaElement, JDTAST_IPackageFragment, JDTAST_BinaryPackageFragmentRoot, IPackageFragmentRoot, JDTAST_SourcePackageFragmentRoot, JDTAST_ITypeParameter, JDTAST_CompilationUnit, JDTAST_ISourceReference, JDTAST_ISourceRange, JDTAST_IMember, IMember, JDTAST_IInitializer, JDTAST_IField, JDTAST_IMethod, JDTAST_AnonymousClassDeclaration, ASTNode, JDTAST_BodyDeclaration, JDTAST_ExtendedModifier, JDTAST_Javadoc, JDTAST_CatchClause, JDTAST_Parameter, JDTAST_AST, JDTAST_ASTNode, JDTAST_Block, JDTAST_SingleVariableDeclaration, JDTAST_Comment, JDTAST_PackageDeclaration, JDTAST_ImportDeclaration, JDTAST_AbstractTypeDeclaration, JDTAST_Expression, JDTAST_Name, JDTAST_MemberRef, JDTAST_Modifier, ExtendedModifier, JDTAST_SimpleName, JDTAST_MemberValuePair, JDTAST_MethodRef, JDTAST_MethodRefParameter, JDTAST_Type, BodyDeclaration, JDTAST_Annotation, JDTAST_Statement, JDTAST_TagElement, JDTAST_TextElement, JDTAST_TypeParameter, JDTAST_VariableDeclaration, JDTAST_AnnotationTypeMemberDeclaration, JDTAST_EnumConstantDeclaration, JDTAST_FieldDeclaration, JDTAST_VariableDeclarationFragment, JDTAST_Initializer, JDTAST_MethodDeclaration, JDTAST_ArrayCreation, JDTAST_ArrayInitializer, JDTAST_ArrayType, JDTAST_AnnotationTypeDeclaration, AbstractTypeDeclaration, JDTAST_EnumDeclaration, JDTAST_TypeDeclaration, JDTAST_BlockComment, Comment, JDTAST_LineComment, Expression, JDTAST_ArrayAccess, JDTAST_Assignment, JDTAST_BooleanLiteral, JDTAST_CastExpression, JDTAST_CharacterLiteral, JDTAST_ClassInstanceCreation, JDTAST_InstanceofExpression, JDTAST_ConditionalExpression, JDTAST_FieldAccess, JDTAST_InfixExpression, JDTAST_PrefixExpression, JDTAST_MethodInvocation, JDTAST_NullLiteral, JDTAST_NumberLiteral, JDTAST_ParenthesizedExpression, JDTAST_PostfixExpression, JDTAST_AssertStatement, Statement, JDTAST_StringLiteral, JDTAST_SuperFieldAccess, JDTAST_SuperMethodInvocation, JDTAST_ThisExpression, JDTAST_TypeLiteral, JDTAST_VariableDeclarationExpression, JDTAST_ForStatement, JDTAST_BreakStatement, JDTAST_ConstructorInvocation, JDTAST_ContinueStatement, JDTAST_DoStatement, JDTAST_EmptyStatement, JDTAST_EnhancedForStatement, JDTAST_ExpressionStatement, JDTAST_SwitchCase, JDTAST_SwitchStatement, JDTAST_IfStatement, JDTAST_LabeledStatement, JDTAST_ReturnStatement, JDTAST_SuperConstructorInvocation, JDTAST_WhileStatement, JDTAST_SynchronizedStatement, JDTAST_ThrowStatement, JDTAST_TryStatement, JDTAST_TypeDeclarationStatement, JDTAST_VariableDeclarationStatement, JDTAST_PrimitiveType, JDTAST_QualifiedType, Type, JDTAST_ParameterizedType, JDTAST_MarkerAnnotation, Annotation, JDTAST_NormalAnnotation, JDTAST_SingleMemberAnnotation, JDTAST_SimpleType, JDTAST_WildcardType, VariableDeclaration, JDTAST_QualifiedName, Name, Modifiers, AssignmentOperatorKind, InfixExpressionOperatorKind, PostfixExpressionOperatorKind, PrefixExpressionOperatorKind},
    associations={classFiles14, compilationUnits15, allType17, imports19, javaProjects0, externalPackageFragmentRoots1, packageFragmentRoots3, externalPackageFragmentRoots6, requiredProjects10, packageFragments12, packageFragmentRoot13, types45, typeParameters47, types21, primary25, ast27, type29, sourceRange32, javadocRange33, nameRange35, initializers38, fields40, methods42, bodyDeclarations52, modifiers53, javadoc55, parameters49, compilationUnits51, body57, exception58, alternateRoot60, comments62, package65, imports67, types69, typeBinding71, name73, name75, qualifier76, name79, value81, name84, qualifier86, parameters89, name91, type94, initializer114, name116, bodyDeclarations119, name122, annotations96, javadoc98, name101, binding104, fragments107, name109, typeBounds111, returnType152, parameters155, thrownExceptions158, default125, name127, type130, arguments133, anonymousClassDeclaration135, name138, fragments141, type142, body145, body147, name149, index188, dimensions191, initializer193, type195, typeParameters161, binding164, superInterfaceTypes167, enumConstants169, superclassType172, superInterfaceTypes174, typeParameters177, tags180, typeName183, array186, anonymousClassDeclaration212, expression215, type218, typeArguments221, expressions197, leftHandSide200, rightHandSide202, expression205, type207, arguments210, leftOperand245, elseExpression224, expression226, thenExpression229, expression232, name234, extendedOperands237, leftOperand239, rightOperand242, operand268, rightOperand247, arguments250, expression252, name255, typeArguments258, methodBinding261, expression264, operand266, modifiers292, type295, expression298, message300, name270, qualifier272, arguments275, name277, qualifier280, typeArguments283, qualifier286, type288, fragments290, body329, expression331, initializers334, statements303, label305, arguments307, typeArguments309, label312, body314, expression316, body319, expression321, parameter324, expression327, expression363, updaters337, elseStatement340, expression342, thenStatement345, body348, label350, expression353, arguments355, expression357, typeArguments360, modifiers389, type392, body395, expression397, expression365, statements367, body370, expression372, expression375, catchClauses377, body379, finally_382, declaration385, fragments387, type406, typeArguments408, componentType400, elementType403, values431, value433, name411, qualifier413, name416, bound418, type420, modifiers423, name426, qualifier428},
    generalizations={gen_JDTAST_ITypeRoot_IJavaElement, gen_JDTAST_ITypeRoot_ISourceReference, gen_JDTAST_ITypeRoot_PhysicalElement, gen_JDTAST_ICompilationUnit_ITypeRoot, gen_JDTAST_IJavaModel_PhysicalElement, gen_JDTAST_IJavaProject_IJavaElement, gen_JDTAST_IJavaProject_PhysicalElement, gen_JDTAST_IPackageFragmentRoot_IJavaElement, gen_JDTAST_IPackageFragmentRoot_PhysicalElement, gen_JDTAST_BinaryPackageFragmentRoot_IPackageFragmentRoot, gen_JDTAST_SourcePackageFragmentRoot_IPackageFragmentRoot, gen_JDTAST_IPackageFragment_IJavaElement, gen_JDTAST_IPackageFragment_PhysicalElement, gen_JDTAST_ITypeParameter_IJavaElement, gen_JDTAST_ITypeParameter_ISourceReference, gen_JDTAST_IInitializer_IMember, gen_JDTAST_IField_IMember, gen_JDTAST_IClassFile_ITypeRoot, gen_JDTAST_IImportDeclaration_IJavaElement, gen_JDTAST_IImportDeclaration_ISourceReference, gen_JDTAST_IMember_IJavaElement, gen_JDTAST_IMember_ISourceReference, gen_JDTAST_IType_IMember, gen_JDTAST_AnonymousClassDeclaration_ASTNode, gen_JDTAST_BodyDeclaration_ASTNode, gen_JDTAST_CatchClause_ASTNode, gen_JDTAST_IMethod_IMember, gen_JDTAST_Comment_ASTNode, gen_JDTAST_CompilationUnit_ASTNode, gen_JDTAST_Expression_ASTNode, gen_JDTAST_ImportDeclaration_ASTNode, gen_JDTAST_MemberRef_ASTNode, gen_JDTAST_Modifier_ASTNode, gen_JDTAST_Modifier_ExtendedModifier, gen_JDTAST_MemberValuePair_ASTNode, gen_JDTAST_MethodRef_ASTNode, gen_JDTAST_MethodRefParameter_ASTNode, gen_JDTAST_AbstractTypeDeclaration_BodyDeclaration, gen_JDTAST_PackageDeclaration_ASTNode, gen_JDTAST_Statement_ASTNode, gen_JDTAST_TagElement_ASTNode, gen_JDTAST_TextElement_ASTNode, gen_JDTAST_Type_ASTNode, gen_JDTAST_TypeParameter_ASTNode, gen_JDTAST_VariableDeclaration_ASTNode, gen_JDTAST_AnnotationTypeMemberDeclaration_BodyDeclaration, gen_JDTAST_EnumConstantDeclaration_BodyDeclaration, gen_JDTAST_FieldDeclaration_BodyDeclaration, gen_JDTAST_Initializer_BodyDeclaration, gen_JDTAST_MethodDeclaration_BodyDeclaration, gen_JDTAST_ArrayCreation_Expression, gen_JDTAST_ArrayInitializer_Expression, gen_JDTAST_AnnotationTypeDeclaration_AbstractTypeDeclaration, gen_JDTAST_EnumDeclaration_AbstractTypeDeclaration, gen_JDTAST_TypeDeclaration_AbstractTypeDeclaration, gen_JDTAST_BlockComment_Comment, gen_JDTAST_Javadoc_Comment, gen_JDTAST_LineComment_Comment, gen_JDTAST_Annotation_Expression, gen_JDTAST_Annotation_ExtendedModifier, gen_JDTAST_ArrayAccess_Expression, gen_JDTAST_Assignment_Expression, gen_JDTAST_BooleanLiteral_Expression, gen_JDTAST_CastExpression_Expression, gen_JDTAST_CharacterLiteral_Expression, gen_JDTAST_ClassInstanceCreation_Expression, gen_JDTAST_InstanceofExpression_Expression, gen_JDTAST_ConditionalExpression_Expression, gen_JDTAST_FieldAccess_Expression, gen_JDTAST_InfixExpression_Expression, gen_JDTAST_PrefixExpression_Expression, gen_JDTAST_MethodInvocation_Expression, gen_JDTAST_Name_Expression, gen_JDTAST_NullLiteral_Expression, gen_JDTAST_NumberLiteral_Expression, gen_JDTAST_ParenthesizedExpression_Expression, gen_JDTAST_PostfixExpression_Expression, gen_JDTAST_AssertStatement_Statement, gen_JDTAST_Block_Statement, gen_JDTAST_StringLiteral_Expression, gen_JDTAST_SuperFieldAccess_Expression, gen_JDTAST_SuperMethodInvocation_Expression, gen_JDTAST_ThisExpression_Expression, gen_JDTAST_TypeLiteral_Expression, gen_JDTAST_VariableDeclarationExpression_Expression, gen_JDTAST_ForStatement_Statement, gen_JDTAST_BreakStatement_Statement, gen_JDTAST_ConstructorInvocation_Statement, gen_JDTAST_ContinueStatement_Statement, gen_JDTAST_DoStatement_Statement, gen_JDTAST_EmptyStatement_Statement, gen_JDTAST_EnhancedForStatement_Statement, gen_JDTAST_ExpressionStatement_Statement, gen_JDTAST_SwitchCase_Statement, gen_JDTAST_SwitchStatement_Statement, gen_JDTAST_IfStatement_Statement, gen_JDTAST_LabeledStatement_Statement, gen_JDTAST_ReturnStatement_Statement, gen_JDTAST_SuperConstructorInvocation_Statement, gen_JDTAST_WhileStatement_Statement, gen_JDTAST_SynchronizedStatement_Statement, gen_JDTAST_ThrowStatement_Statement, gen_JDTAST_TryStatement_Statement, gen_JDTAST_TypeDeclarationStatement_Statement, gen_JDTAST_VariableDeclarationStatement_Statement, gen_JDTAST_PrimitiveType_Type, gen_JDTAST_QualifiedType_Type, gen_JDTAST_ArrayType_Type, gen_JDTAST_ParameterizedType_Type, gen_JDTAST_MarkerAnnotation_Annotation, gen_JDTAST_NormalAnnotation_Annotation, gen_JDTAST_SingleMemberAnnotation_Annotation, gen_JDTAST_SimpleType_Type, gen_JDTAST_WildcardType_Type, gen_JDTAST_SingleVariableDeclaration_VariableDeclaration, gen_JDTAST_VariableDeclarationFragment_VariableDeclaration, gen_JDTAST_QualifiedName_Name, gen_JDTAST_SimpleName_Name},
    metadata=None
)
