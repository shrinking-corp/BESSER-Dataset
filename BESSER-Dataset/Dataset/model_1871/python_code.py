...
class datatypes_DataType(ABC):
    ...
    def __init__(self, name: str, types: "datatypes_TypesLibrary" = None, DataType: "datatypes_TypesLibrary" = None, datatypes_DataType: "datatypes_VectorType" = None, datatypes_DataType8: "datatypes_Field" = None):
        self.name = name
        self.types = types
...
class datatypes_TypesLibrary:
    ...
    def __init__(self, name: str, TypesLibrary: "datatypes_DataType" = None, typesLibrary: set["datatypes_DataType"] = None, datatypes_TypesLibrary: "datatypes_TypesLibrary" = None, datatypes_TypesLibrary1: set["datatypes_TypesLibrary"] = None):
        self.name = name
