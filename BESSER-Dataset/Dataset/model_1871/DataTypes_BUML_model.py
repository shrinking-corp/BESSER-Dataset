...
domain_model = DomainModel(
    name="datatypes",
    types={datatypes_SimpleType, DataType, datatypes_ComplexType, datatypes_TypesLibrary, datatypes_DataType, datatypes_RosIDLReference, IDLReference, datatypes_VectorType, ComplexType, datatypes_CustomType, datatypes_Field, datatypes_IDLReference},
    associations={typesLibrary3, types0, includes2, template4, fields5, type6},
