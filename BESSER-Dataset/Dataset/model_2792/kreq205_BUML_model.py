...
# Classes
kreq205_Rrrr = Class(name="kreq205_Rrrr")
kreq205_Tttt = Class(name="kreq205_Tttt")
kreq205_Cccc = Class(name="kreq205_Cccc")
kreq205_Bbbb = Class(name="kreq205_Bbbb")
kreq205_Ffff = Class(name="kreq205_Ffff")
kreq205_Rqs = Class(name="kreq205_Rqs")
SObject = Class(name="SObject")
kreq205_Llll = Class(name="kreq205_Llll")
kreq205_SObject = Class(name="kreq205_SObject", is_abstract=True)
...
kreq205_Rqs.attributes={kreq205_Rqs_a, kreq205_Rqs_d2}
...
kreq205_SObject.attributes={kreq205_SObject_name, kreq205_SObject_id}
...
domain_model = DomainModel(
    name="kreq205",
    types={kreq205_Rrrr, kreq205_Tttt, kreq205_Cccc, kreq205_Bbbb, kreq205_Ffff, kreq205_Rqs, SObject, kreq205_Llll, kreq205_SObject},
    associations={rs0, ts1, rts10, ccs3, fs5, rqs7, rqs9, dmof24, subFs27, alto29, dReqt12, subRqs15, specs17, refine19, spc21, isBy22, ls43, satisfy31, specifiedBy34, pfrmis36, subCs39, impf41, source45, target48},
    generalizations={gen_kreq205_Rqs_SObject, gen_kreq205_Tttt_SObject},
    metadata=None
)
