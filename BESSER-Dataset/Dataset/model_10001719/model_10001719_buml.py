...
Users.attributes={Users_user_address1, Users_user_mail, Users_last_name, Users_user_addr_state, Users_first_name, Users_user_addr_city, Users_user_phone_no, Users_user_address, Users_user_role}
...
Hotel.attributes={Hotel_website, Hotel_street, Hotel_phoneNumber, Hotel_city, Hotel_name, Hotel_zip, Hotel_coordinates}
...
Room.attributes={Room_room_name, Room_room_size_interior, Room_room_no_bedroom, Room_room_id, Room_room_rent_night, Room_room_no_bathroom}
...
Service.attributes={Service_basePrice, Service_description, Service_name}
