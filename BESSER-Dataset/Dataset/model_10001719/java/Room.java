...
public class Room  {
    ...
    public Room(
        int room_no_bathroom,        int room_no_bedroom,        String room_name,        int room_size_interior,        float room_rent_night,        int room_id    ) {
    ...
    public Room(
        int room_no_bathroom,        int room_no_bedroom,        String room_name,        int room_size_interior,        float room_rent_night,        int room_id        ArrayList<Users> userss    ) {
        this.room_no_bathroom = room_no_bathroom;
        this.room_no_bedroom = room_no_bedroom;
        this.room_name = room_name;
        this.room_size_interior = room_size_interior;
