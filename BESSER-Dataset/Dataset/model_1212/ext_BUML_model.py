...
domain_model = DomainModel(
    name="atlext",
    types={atlext_ATL_Binding, atlext_ATL_LocatedElement, RuleResolutionInfo, ATL_atlext_EObject, StringToStringMap, atlext_ATL_StringToStringMap, atlext_ATL_MatchedRule, atlext_ATL_OutPatternElement, atlext_ATL_Callable, PropertyCallExp, CallableParameter, atlext_ATL_CallableParameter, ATL_atlext_Type, VariableDeclaration, atlext_ATL_ContextHelper, atlext_ATL_Helper, atlext_OCL_ResolveTempResolution, OutPatternElement, atlext_OCL_JavaBody, OclExpression, atlext_OCL_GetAppliedStereotypesBody, JavaBody, atlext_OCL2_SelectByKind, CollectionOperationCallExp, atlext_ATL_RuleResolutionInfo, MatchedRule, atlext_OCL_TypedElement, OCL_atlext_Type, atlext_OCL_VariableDeclaration, TypedElement, atlext_OCL_OclExpression, atlext_OCL_PropertyCallExp, OCL_atlext_EObject, Callable, ContextHelper, atlext_OCL_OperationCallExp, ResolveTempResolution, atlext_OCL_CollectionOperationCallExp, RuleResolutionStatus},
    associations={inferredReturnType13, staticReturnType15, writtenFeature18, leftType20, problems0, annotations1, calledBy3, callableParameters4, staticType6, paramDeclaration7, contextType9, polymorphicCalledBy11, element45, resolvedBy23, rule25, allInvolvedRules26, inferredType29, staticType30, noCastedType32, usedFeature34, subtypeFeatures35, receptorType38, staticResolver41, dynamicResolvers43, resolveTempResolvedBy44},
    generalizations={gen_atlext_OCL_ResolveTempResolution_RuleResolutionInfo, gen_atlext_OCL_JavaBody_OclExpression, gen_atlext_OCL_GetAppliedStereotypesBody_JavaBody, gen_atlext_OCL2_SelectByKind_CollectionOperationCallExp, gen_atlext_OCL_VariableDeclaration_TypedElement, gen_atlext_OCL_OclExpression_TypedElement},
    metadata=None
)
