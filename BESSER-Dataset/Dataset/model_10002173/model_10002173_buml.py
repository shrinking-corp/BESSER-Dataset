...
Direccion.attributes={Direccion_pais, Direccion_ciudad, Direccion_codigo, Direccion_nombre}
...
Telefono.attributes={Telefono_prefijo, Telefono_numero, Telefono_codigo}
