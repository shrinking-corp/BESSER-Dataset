...
# Classes
model_Quantity = Class(name="model_Quantity", is_abstract=True)
model_Unit = Class(name="model_Unit", is_abstract=True)
model_QuantityValue = Class(name="model_QuantityValue")
model_Length = Class(name="model_Length")
BaseQuantity = Class(name="BaseQuantity")
model_Angle = Class(name="model_Angle")
model_Dimension = Class(name="model_Dimension", is_abstract=True)
model_ConversionFactor = Class(name="model_ConversionFactor", is_abstract=True)
model_ThermodynamicTemperature = Class(name="model_ThermodynamicTemperature")
model_AmountOfSubstance = Class(name="model_AmountOfSubstance")
model_LuminousIntensity = Class(name="model_LuminousIntensity")
model_LengthUnit = Class(name="model_LengthUnit")
BaseQuantityUnit = Class(name="BaseQuantityUnit")
model_Mass = Class(name="model_Mass")
model_Time = Class(name="model_Time")
model_ElectricCurrent = Class(name="model_ElectricCurrent")
model_AngleUnit = Class(name="model_AngleUnit")
model_SystemOfUnits = Class(name="model_SystemOfUnits")
model_LengthDimension = Class(name="model_LengthDimension")
Dimension = Class(name="Dimension")
model_MassUnit = Class(name="model_MassUnit")
model_TimeUnit = Class(name="model_TimeUnit")
model_ElectricCurrentUnit = Class(name="model_ElectricCurrentUnit")
model_ThermodynamicTemperatureUnit = Class(name="model_ThermodynamicTemperatureUnit")
model_AmountOfSubstanceUnit = Class(name="model_AmountOfSubstanceUnit")
model_LuminousIntensityUnit = Class(name="model_LuminousIntensityUnit")
model_DataStorageCapacity = Class(name="model_DataStorageCapacity")
model_Entropy = Class(name="model_Entropy")
model_TrafficIntensity = Class(name="model_TrafficIntensity")
model_Level = Class(name="model_Level")
model_MassDimension = Class(name="model_MassDimension")
model_TimeDimension = Class(name="model_TimeDimension")
model_ElectricCurrentDimension = Class(name="model_ElectricCurrentDimension")
model_ThermodynamicTemperatureDimension = Class(name="model_ThermodynamicTemperatureDimension")
model_AmountOfSubstanceDimension = Class(name="model_AmountOfSubstanceDimension")
model_LuminousIntensityDimension = Class(name="model_LuminousIntensityDimension")
model_AngleDimension = Class(name="model_AngleDimension")
model_MeasurementUncertainty = Class(name="model_MeasurementUncertainty")
model_MeasurementUncertaintyInformation = Class(name="model_MeasurementUncertaintyInformation", is_abstract=True)
model_ElectricCurrentConversionFactor = Class(name="model_ElectricCurrentConversionFactor")
model_ThermodynamicTemperatureConversionFactor = Class(name="model_ThermodynamicTemperatureConversionFactor")
model_AmountOfSubstanceConversionFactor = Class(name="model_AmountOfSubstanceConversionFactor")
model_LuminousIntensityConversionFactor = Class(name="model_LuminousIntensityConversionFactor")
model_AngleConversionFactor = Class(name="model_AngleConversionFactor")
model_DataStorageCapacityConversionFactor = Class(name="model_DataStorageCapacityConversionFactor")
model_EntropyConversionFactor = Class(name="model_EntropyConversionFactor")
model_TrafficIntensityConversionFactor = Class(name="model_TrafficIntensityConversionFactor")
model_LevelConversionFactor = Class(name="model_LevelConversionFactor")
model_NormalDistribution = Class(name="model_NormalDistribution")
MeasurementUncertaintyInformation = Class(name="MeasurementUncertaintyInformation")
model_DataStorageCapacityUnit = Class(name="model_DataStorageCapacityUnit")
model_EntropyUnit = Class(name="model_EntropyUnit")
model_TrafficIntensityUnit = Class(name="model_TrafficIntensityUnit")
model_LevelUnit = Class(name="model_LevelUnit")
model_DataStorageCapacityDimension = Class(name="model_DataStorageCapacityDimension")
model_EntropyDimension = Class(name="model_EntropyDimension")
model_TrafficIntensityDimension = Class(name="model_TrafficIntensityDimension")
model_LevelDimension = Class(name="model_LevelDimension")
model_LengthConversionFactor = Class(name="model_LengthConversionFactor")
ConversionFactor = Class(name="ConversionFactor")
model_MassConversionFactor = Class(name="model_MassConversionFactor")
model_TimeConversionFactor = Class(name="model_TimeConversionFactor")
model_DerivedQuantityUnit = Class(name="model_DerivedQuantityUnit", is_abstract=True)
model_Interval = Class(name="model_Interval")
model_Sampling = Class(name="model_Sampling")
model_Sample = Class(name="model_Sample")
model_BaseQuantity = Class(name="model_BaseQuantity", is_abstract=True)
Quantity = Class(name="Quantity")
model_DerivedQuantity = Class(name="model_DerivedQuantity", is_abstract=True)
model_BaseQuantityUnit = Class(name="model_BaseQuantityUnit", is_abstract=True)
...
model_Unit.attributes={model_Unit_isDerivedUnit, model_Unit_symbol, model_Unit_isIntervalScaled, model_Unit_name, model_Unit_isCoherentDerivedUnit, model_Unit_isBaseUnit, model_Unit_isRatioScaled}
...
model_ConversionFactor.attributes={model_ConversionFactor_multiplicator, model_ConversionFactor_offset}
...
domain_model = DomainModel(
    name="model",
    types={model_Quantity, model_Unit, model_QuantityValue, model_Length, BaseQuantity, model_Angle, model_Dimension, model_ConversionFactor, model_ThermodynamicTemperature, model_AmountOfSubstance, model_LuminousIntensity, model_LengthUnit, BaseQuantityUnit, model_Mass, model_Time, model_ElectricCurrent, model_AngleUnit, model_SystemOfUnits, model_LengthDimension, Dimension, model_MassUnit, model_TimeUnit, model_ElectricCurrentUnit, model_ThermodynamicTemperatureUnit, model_AmountOfSubstanceUnit, model_LuminousIntensityUnit, model_DataStorageCapacity, model_Entropy, model_TrafficIntensity, model_Level, model_MassDimension, model_TimeDimension, model_ElectricCurrentDimension, model_ThermodynamicTemperatureDimension, model_AmountOfSubstanceDimension, model_LuminousIntensityDimension, model_AngleDimension, model_MeasurementUncertainty, model_MeasurementUncertaintyInformation, model_ElectricCurrentConversionFactor, model_ThermodynamicTemperatureConversionFactor, model_AmountOfSubstanceConversionFactor, model_LuminousIntensityConversionFactor, model_AngleConversionFactor, model_DataStorageCapacityConversionFactor, model_EntropyConversionFactor, model_TrafficIntensityConversionFactor, model_LevelConversionFactor, model_NormalDistribution, MeasurementUncertaintyInformation, model_DataStorageCapacityUnit, model_EntropyUnit, model_TrafficIntensityUnit, model_LevelUnit, model_DataStorageCapacityDimension, model_EntropyDimension, model_TrafficIntensityDimension, model_LevelDimension, model_LengthConversionFactor, ConversionFactor, model_MassConversionFactor, model_TimeConversionFactor, model_DerivedQuantityUnit, model_Interval, model_Sampling, model_Sample, model_BaseQuantity, Quantity, model_DerivedQuantity, model_BaseQuantityUnit, Unit},
    ...
    generalizations={gen_model_Length_BaseQuantity, gen_model_Angle_BaseQuantity, gen_model_ElectricCurrent_BaseQuantity, gen_model_ThermodynamicTemperature_BaseQuantity, gen_model_AmountOfSubstance_BaseQuantity, gen_model_LuminousIntensity_BaseQuantity, gen_model_LengthUnit_BaseQuantityUnit, gen_model_Mass_BaseQuantity, gen_model_Time_BaseQuantity, gen_model_AngleUnit_BaseQuantityUnit, gen_model_LengthDimension_Dimension, gen_model_MassUnit_BaseQuantityUnit, gen_model_TimeUnit_BaseQuantityUnit, gen_model_ElectricCurrentUnit_BaseQuantityUnit, gen_model_ThermodynamicTemperatureUnit_BaseQuantityUnit, gen_model_AmountOfSubstanceUnit_BaseQuantityUnit, gen_model_LuminousIntensityUnit_BaseQuantityUnit, gen_model_DataStorageCapacity_BaseQuantity, gen_model_Entropy_BaseQuantity, gen_model_TrafficIntensity_BaseQuantity, gen_model_Level_BaseQuantity, gen_model_MassDimension_Dimension, gen_model_TimeDimension_Dimension, gen_model_ElectricCurrentDimension_Dimension, gen_model_ThermodynamicTemperatureDimension_Dimension, gen_model_AmountOfSubstanceDimension_Dimension, gen_model_LuminousIntensityDimension_Dimension, gen_model_AngleDimension_Dimension, gen_model_TimeConversionFactor_ConversionFactor, gen_model_ElectricCurrentConversionFactor_ConversionFactor, gen_model_ThermodynamicTemperatureConversionFactor_ConversionFactor, gen_model_AmountOfSubstanceConversionFactor_ConversionFactor, gen_model_LuminousIntensityConversionFactor_ConversionFactor, gen_model_AngleConversionFactor_ConversionFactor, gen_model_DataStorageCapacityConversionFactor_ConversionFactor, gen_model_EntropyConversionFactor_ConversionFactor, gen_model_TrafficIntensityConversionFactor_ConversionFactor, gen_model_LevelConversionFactor_ConversionFactor, gen_model_NormalDistribution_MeasurementUncertaintyInformation, gen_model_DataStorageCapacityUnit_BaseQuantityUnit, gen_model_EntropyUnit_BaseQuantityUnit, gen_model_TrafficIntensityUnit_BaseQuantityUnit, gen_model_LevelUnit_BaseQuantityUnit, gen_model_DataStorageCapacityDimension_Dimension, gen_model_EntropyDimension_Dimension, gen_model_TrafficIntensityDimension_Dimension, gen_model_LevelDimension_Dimension, gen_model_LengthConversionFactor_ConversionFactor, gen_model_MassConversionFactor_ConversionFactor, gen_model_DerivedQuantityUnit_Unit, gen_model_Interval_MeasurementUncertaintyInformation, gen_model_Sampling_MeasurementUncertaintyInformation, gen_model_BaseQuantity_Quantity, gen_model_DerivedQuantity_Quantity, gen_model_BaseQuantityUnit_Unit},
    metadata=None
)
