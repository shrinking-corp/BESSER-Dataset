...
class PetriNet_Arc:
    ...
    def __init__(self, weight: int, kind: str, Arc5: "PetriNet_Node" = None, Arc7: "PetriNet_Node" = None, Arc: "PetriNet_PetriNet" = None, incomings: "PetriNet_Node" = None, outgoings: "PetriNet_Node" = None, arcs: "PetriNet_PetriNet" = None):
        self.weight = weight
        self.kind = kind
        self.Arc5 = Arc5
        self.Arc7 = Arc7
