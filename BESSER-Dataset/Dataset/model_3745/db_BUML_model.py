...
db_DBDriver.attributes={db_DBDriver_guideUrl, db_DBDriver_defaultPort, db_DBDriver_urlRegexPattern, db_DBDriver_websiteUrl, db_DBDriver_jars, db_DBDriver_default, db_DBDriver_exampleUrl, db_DBDriver_pooling, db_DBDriver_driverClassName}
...
db_DBConnection.attributes={db_DBConnection_minPoolSize, db_DBConnection_maxIdleTime, db_DBConnection_user, db_DBConnection_acquireIncrement, db_DBConnection_properties, db_DBConnection_maxPoolSize, db_DBConnection_transactionMode, db_DBConnection_loginTimeout, db_DBConnection_url, db_DBConnection_password}
...
db_SafiResultSet.attributes={db_SafiResultSet_holdabilityMode, db_SafiResultSet_scrollable, db_SafiResultSet_scrollMode, db_SafiResultSet_readOnly, db_SafiResultSet_useCache}
...
db_DBResource.attributes={db_DBResource_name, db_DBResource_lastModified, db_DBResource_id, db_DBResource_lastUpdated}
...
db_Variable.attributes={db_Variable_type, db_Variable_name, db_Variable_scope, db_Variable_defaultValue}
...
db_config_ServerResource.attributes={db_config_ServerResource_name, db_config_ServerResource_lastModified, db_config_ServerResource_description, db_config_ServerResource_id, db_config_ServerResource_lastUpdated}
...
db_config_SafiServer.attributes={db_config_SafiServer_managementPort, db_config_SafiServer_dbPort, db_config_SafiServer_running, db_config_SafiServer_bindIP, db_config_SafiServer_debug}
...
db_config_Prompt.attributes={db_config_Prompt_system, db_config_Prompt_extension}
...
db_config_SFTPInfo.attributes={db_config_SFTPInfo_sftpPort, db_config_SFTPInfo_sftpUser, db_config_SFTPInfo_sftpPassword}
...
db_config_TelephonySubsystem.attributes={db_config_TelephonySubsystem_visibleSafiServerIP, db_config_TelephonySubsystem_running, db_config_TelephonySubsystem_versionId, db_config_TelephonySubsystem_private, db_config_TelephonySubsystem_hostname, db_config_TelephonySubsystem_enabled, db_config_TelephonySubsystem_platformId, db_config_TelephonySubsystem_managerPassword, db_config_TelephonySubsystem_managerName, db_config_TelephonySubsystem_managerPort, db_config_TelephonySubsystem_promptDirectory}
...
domain_model = DomainModel(
    name="db",
    types={db_DBDriver, db_Query, db_SafiDriverManager, db_DBConnection, DBResource, db_QueryParameter, db_SafiResultSet, db_DBResource, db_Variable, db_config_ServerResource, config_User, db_config_SafiServer, ServerResource, db_config_Role, config_Entitlement, config_Role, db_config_Saflet, config_SafletProject, db_config_SafletProject, config_Saflet, config_Prompt, db_config_Prompt, db_config_SFTPInfo, db_config_Entitlement, db_config_User, config_SafiServer, db_config_TelephonySubsystem, QueryType, RSHoldabilityMode, RSScrollMode, SQLDataType, TransactionMode, VariableScope, VariableType, SynchMode},
    associations={driver0, queries1, connections2, parameters4, connection5, resultSets7, query9, driverManager3, drivers11, query13, createdBy15, modifiedBy16, user19, users21, entitlements24, roles25, project26, saflets27, prompts28, project30, safiServer32},
    generalizations={gen_db_DBDriver_DBResource, gen_db_DBConnection_DBResource, gen_db_Query_DBResource, gen_db_QueryParameter_DBResource, gen_db_SafiDriverManager_DBResource, gen_db_SafiResultSet_DBResource, gen_db_config_SafiServer_ServerResource, gen_db_config_Role_ServerResource, gen_db_config_Saflet_ServerResource, gen_db_config_SafletProject_ServerResource, gen_db_config_Prompt_ServerResource, gen_db_config_Entitlement_ServerResource, gen_db_config_User_ServerResource, gen_db_config_TelephonySubsystem_ServerResource},
    metadata=None
)
