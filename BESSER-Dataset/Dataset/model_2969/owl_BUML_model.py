...
# Classes
owl_OWLOntology = Class(name="owl_OWLOntology")
Ontology = Class(name="Ontology")
owl_RDFSLiteral = Class(name="owl_RDFSLiteral")
owl_OWLOntologyProperty = Class(name="owl_OWLOntologyProperty")
RDFProperty = Class(name="RDFProperty")
owl_OWLClass = Class(name="owl_OWLClass")
RDFSClass = Class(name="RDFSClass")
owl_IntersectionClass = Class(name="owl_IntersectionClass")
owl_UnionClass = Class(name="owl_UnionClass")
owl_ComplementClass = Class(name="owl_ComplementClass")
owl_OWLRestriction = Class(name="owl_OWLRestriction", is_abstract=True)
OWLClass = Class(name="OWLClass")
owl_RDFProperty = Class(name="owl_RDFProperty")
owl_OWLObjectProperty = Class(name="owl_OWLObjectProperty")
Property_ = Class(name="Property")
owl_Property = Class(name="owl_Property")
owl_Individual = Class(name="owl_Individual")
RDFSResource = Class(name="RDFSResource")
owl_OWLAllDifferent = Class(name="owl_OWLAllDifferent")
owl_DatatypeSlot = Class(name="owl_DatatypeSlot")
owl_ObjectSlot = Class(name="owl_ObjectSlot")
owl_OWLDataRange = Class(name="owl_OWLDataRange")
owl_OWLAnnotationProperty = Class(name="owl_OWLAnnotationProperty")
owl_OWLDatatypeProperty = Class(name="owl_OWLDatatypeProperty")
owl_EnumeratedClass = Class(name="owl_EnumeratedClass")
owl_HasValueRestriction = Class(name="owl_HasValueRestriction")
OWLRestriction = Class(name="OWLRestriction")
owl_RDFSResource = Class(name="owl_RDFSResource")
owl_AllValuesFromRestriction = Class(name="owl_AllValuesFromRestriction")
owl_RDFSClass = Class(name="owl_RDFSClass")
owl_SomeValuesFromRestriction = Class(name="owl_SomeValuesFromRestriction")
owl_CardinalityRestriction = Class(name="owl_CardinalityRestriction")
owl_MaxCardinalityRestriction = Class(name="owl_MaxCardinalityRestriction")
owl_MinCardinalityRestriction = Class(name="owl_MinCardinalityRestriction")
...
owl_OWLObjectProperty.attributes={owl_OWLObjectProperty_symmetric, owl_OWLObjectProperty_inverseFunctional, owl_OWLObjectProperty_transitive}
...
owl_Property.attributes={owl_Property_functional, owl_Property_deprecated}
...
domain_model = DomainModel(
    name="owl",
    types={owl_OWLOntology, Ontology, owl_RDFSLiteral, owl_OWLOntologyProperty, RDFProperty, owl_OWLClass, RDFSClass, owl_IntersectionClass, owl_UnionClass, owl_ComplementClass, owl_OWLRestriction, OWLClass, owl_RDFProperty, owl_OWLObjectProperty, Property_, owl_Property, owl_Individual, RDFSResource, owl_OWLAllDifferent, owl_DatatypeSlot, owl_ObjectSlot, owl_OWLDataRange, owl_OWLAnnotationProperty, owl_OWLDatatypeProperty, owl_EnumeratedClass, owl_HasValueRestriction, OWLRestriction, owl_RDFSResource, owl_AllValuesFromRestriction, owl_RDFSClass, owl_SomeValuesFromRestriction, owl_CardinalityRestriction, owl_MaxCardinalityRestriction, owl_MinCardinalityRestriction},
    associations={OWLBackwardCompatibleWith1, OWLImports3, OWLIncompatibleWith6, OWLPriorVersion9, OWLVersionInfo11, invOWLEquivalentClass14, OWLEquivalentClass16, OWLDisjointWith19, invOWLDisjointWith22, refByIntersectionClass24, refByUnionClass25, invOWLComplementOf26, OWLOnProperty27, OWLInverseOf29, invOWLInverseOf31, OWLEquivalentProperty34, invOWLEquivalentProperty36, OWLDifferentFrom39, invOWLDifferentFrom41, refByOWLDistinctMembers43, OWLSameAs45, invOWLSameAs48, datatypeSlot50, objectSlot52, OWLDistinctMembers54, OWLOneOf56, Individual58, content60, property62, Individual63, content65, property66, OWLOneOf68, OWLIntersectionOf70, OWLUnionOf72, OWLHasValue74, OWLAllValuesFrom75, OWLSomeValuesFrom76, OWLCardinality78, OWLMaxCardinality80, OWLMinCardinality82, OWLComplementOf84},
    generalizations={gen_owl_OWLOntology_Ontology, gen_owl_OWLOntologyProperty_RDFProperty, gen_owl_OWLClass_RDFSClass, gen_owl_OWLRestriction_OWLClass, gen_owl_OWLObjectProperty_Property, gen_owl_Property_RDFProperty, gen_owl_Individual_RDFSResource, gen_owl_OWLAllDifferent_RDFSResource, gen_owl_OWLDataRange_RDFSClass, gen_owl_OWLAnnotationProperty_RDFProperty, gen_owl_EnumeratedClass_OWLClass, gen_owl_IntersectionClass_OWLClass, gen_owl_UnionClass_OWLClass, gen_owl_HasValueRestriction_OWLRestriction, gen_owl_AllValuesFromRestriction_OWLRestriction, gen_owl_SomeValuesFromRestriction_OWLRestriction, gen_owl_CardinalityRestriction_OWLRestriction, gen_owl_MaxCardinalityRestriction_OWLRestriction, gen_owl_MinCardinalityRestriction_OWLRestriction, gen_owl_ComplementClass_OWLClass, gen_owl_OWLDatatypeProperty_Property},
    metadata=None
)
