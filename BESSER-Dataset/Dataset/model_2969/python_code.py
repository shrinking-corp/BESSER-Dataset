...
class owl_OWLObjectProperty(Property):
    ...
    def __init__(self, inverseFunctional: str, symmetric: str, transitive: str, owl_OWLObjectProperty: "owl_ObjectSlot" = None, OWLObjectProperty: "owl_OWLObjectProperty" = None, invOWLInverseOf: "owl_OWLObjectProperty" = None, OWLObjectProperty32: "owl_OWLObjectProperty" = None, OWLInverseOf: set["owl_OWLObjectProperty"] = None):
...
class owl_OWLClass(RDFSClass):
    ...
    def __init__(self, deprecated: str, OWLClass: "owl_OWLClass" = None, OWLEquivalentClass: set["owl_OWLClass"] = None, OWLClass17: "owl_OWLClass" = None, invOWLEquivalentClass: set["owl_OWLClass"] = None, OWLClass20: "owl_OWLClass" = None, invOWLDisjointWith: set["owl_OWLClass"] = None, OWLClass23: "owl_OWLClass" = None, OWLDisjointWith: set["owl_OWLClass"] = None, OWLIntersectionOf: set["owl_IntersectionClass"] = None, OWLUnionOf: set["owl_UnionClass"] = None, OWLComplementOf: set["owl_ComplementClass"] = None, OWLClass71: "owl_IntersectionClass" = None, OWLClass73: "owl_UnionClass" = None, OWLClass85: "owl_ComplementClass" = None):
...
class owl_Property(RDFProperty):
    ...
    def __init__(self, deprecated: str, functional: str, Property: "owl_Property" = None, invOWLEquivalentProperty: set["owl_Property"] = None, Property37: "owl_Property" = None, OWLEquivalentProperty: set["owl_Property"] = None):
        self.deprecated = deprecated
