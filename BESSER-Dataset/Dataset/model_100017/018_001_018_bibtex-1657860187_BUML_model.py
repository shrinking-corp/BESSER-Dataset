...
# Classes
bibtex_EditorField = Class(name="bibtex_EditorField")
bibtex_TitleField = Class(name="bibtex_TitleField")
bibtex_Person = Class(name="bibtex_Person", is_abstract=True)
bibtex_Author = Class(name="bibtex_Author")
Person = Class(name="Person")
bibtex_Editor = Class(name="bibtex_Editor")
bibtex_StringValue = Class(name="bibtex_StringValue", is_abstract=True)
bibtex_YearValue = Class(name="bibtex_YearValue", is_abstract=True)
bibtex_IntValue = Class(name="bibtex_IntValue", is_abstract=True)
bibtex_Page = Class(name="bibtex_Page")
IntValue = Class(name="IntValue")
bibtex_Field = Class(name="bibtex_Field", is_abstract=True)
bibtex_AuthorField = Class(name="bibtex_AuthorField")
Field = Class(name="Field")
StringValue = Class(name="StringValue")
bibtex_BookTitleField = Class(name="bibtex_BookTitleField")
bibtex_NumberField = Class(name="bibtex_NumberField")
bibtex_YearField = Class(name="bibtex_YearField")
YearValue = Class(name="YearValue")
bibtex_BibtexKeyField = Class(name="bibtex_BibtexKeyField")
bibtex_Keyword = Class(name="bibtex_Keyword")
bibtex_KeywordField = Class(name="bibtex_KeywordField")
bibtex_AbstractField = Class(name="bibtex_AbstractField")
bibtex_JournalField = Class(name="bibtex_JournalField")
bibtex_VolumeField = Class(name="bibtex_VolumeField")
bibtex_PageField = Class(name="bibtex_PageField")
bibtex_SeriesField = Class(name="bibtex_SeriesField")
bibtex_AddressField = Class(name="bibtex_AddressField")
bibtex_MonthField = Class(name="bibtex_MonthField")
bibtex_OrganizationField = Class(name="bibtex_OrganizationField")
bibtex_NoteField = Class(name="bibtex_NoteField")
bibtex_PublisherField = Class(name="bibtex_PublisherField")
bibtex_PartField = Class(name="bibtex_PartField")
bibtex_EidField = Class(name="bibtex_EidField")
bibtex_UrlField = Class(name="bibtex_UrlField")
bibtex_ReviewField = Class(name="bibtex_ReviewField")
bibtex_Entry = Class(name="bibtex_Entry", is_abstract=True)
bibtex_InProceedingsEntry = Class(name="bibtex_InProceedingsEntry")
Entry = Class(name="Entry")
bibtex_ArticleEntry = Class(name="bibtex_ArticleEntry")
bibtex_Bibliography = Class(name="bibtex_Bibliography")
...
bibtex_Entry.methods={bibtex_Entry_m_getFields, bibtex_Entry_m_getGeneralFields}
...
domain_model = DomainModel(
    name="bibtex",
    types={bibtex_EditorField, bibtex_TitleField, bibtex_Person, bibtex_Author, Person, bibtex_Editor, bibtex_StringValue, bibtex_YearValue, bibtex_IntValue, bibtex_Page, IntValue, bibtex_Field, bibtex_AuthorField, Field, StringValue, bibtex_BookTitleField, bibtex_NumberField, bibtex_YearField, YearValue, bibtex_BibtexKeyField, bibtex_Keyword, bibtex_KeywordField, bibtex_AbstractField, bibtex_JournalField, bibtex_VolumeField, bibtex_PageField, bibtex_SeriesField, bibtex_AddressField, bibtex_MonthField, bibtex_OrganizationField, bibtex_NoteField, bibtex_PublisherField, bibtex_PartField, bibtex_EidField, bibtex_UrlField, bibtex_ReviewField, bibtex_Entry, bibtex_InProceedingsEntry, Entry, bibtex_ArticleEntry, bibtex_Bibliography},
    associations={authors0, editors1, keywords6, fromPage2, toPage3, bookTitle21, year23, editor25, bibtexKey7, abstract8, url10, keyword12, review15, author17, title19, year52, journal55, pages28, volume31, number33, series35, address37, month39, organization41, note43, publisher45, author47, title49, pages57, volume60, number63, month66, note69, part72, eid74, entries76},
    generalizations={gen_bibtex_EditorField_Field, gen_bibtex_Author_Person, gen_bibtex_Editor_Person, gen_bibtex_Page_IntValue, gen_bibtex_AuthorField_Field, gen_bibtex_TitleField_Field, gen_bibtex_TitleField_StringValue, gen_bibtex_BookTitleField_Field, gen_bibtex_BookTitleField_StringValue, gen_bibtex_NumberField_IntValue, gen_bibtex_NumberField_Field, gen_bibtex_YearField_Field, gen_bibtex_YearField_YearValue, gen_bibtex_BibtexKeyField_Field, gen_bibtex_BibtexKeyField_StringValue, gen_bibtex_Keyword_StringValue, gen_bibtex_KeywordField_Field, gen_bibtex_AbstractField_StringValue, gen_bibtex_JournalField_Field, gen_bibtex_JournalField_StringValue, gen_bibtex_VolumeField_Field, gen_bibtex_VolumeField_IntValue, gen_bibtex_PageField_Field, gen_bibtex_SeriesField_StringValue, gen_bibtex_SeriesField_Field, gen_bibtex_AddressField_Field, gen_bibtex_AddressField_StringValue, gen_bibtex_MonthField_Field, gen_bibtex_MonthField_StringValue, gen_bibtex_OrganizationField_Field, gen_bibtex_OrganizationField_StringValue, gen_bibtex_NoteField_Field, gen_bibtex_NoteField_StringValue, gen_bibtex_PublisherField_Field, gen_bibtex_PublisherField_StringValue, gen_bibtex_PartField_IntValue, gen_bibtex_PartField_Field, gen_bibtex_EidField_Field, gen_bibtex_EidField_StringValue, gen_bibtex_UrlField_StringValue, gen_bibtex_UrlField_Field, gen_bibtex_AbstractField_Field, gen_bibtex_ReviewField_StringValue, gen_bibtex_ReviewField_Field, gen_bibtex_InProceedingsEntry_Entry, gen_bibtex_ArticleEntry_Entry},
    metadata=None
)
