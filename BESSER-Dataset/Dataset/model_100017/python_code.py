...
class bibtex_ArticleEntry(Entry):
    ...
    def __init__(self, bibtex_ArticleEntry73: "bibtex_PartField" = None, bibtex_ArticleEntry75: "bibtex_EidField" = None, bibtex_ArticleEntry53: "bibtex_YearField" = None, bibtex_ArticleEntry56: "bibtex_JournalField" = None, bibtex_ArticleEntry: "bibtex_AuthorField" = None, bibtex_ArticleEntry50: "bibtex_TitleField" = None, bibtex_ArticleEntry58: "bibtex_PageField" = None, bibtex_ArticleEntry61: "bibtex_VolumeField" = None, bibtex_ArticleEntry64: "bibtex_NumberField" = None, bibtex_ArticleEntry67: "bibtex_MonthField" = None, bibtex_ArticleEntry70: "bibtex_NoteField" = None):
...
class bibtex_InProceedingsEntry(Entry):
    ...
    def __init__(self, bibtex_InProceedingsEntry22: "bibtex_BookTitleField" = None, bibtex_InProceedingsEntry24: "bibtex_YearField" = None, bibtex_InProceedingsEntry26: "bibtex_EditorField" = None, bibtex_InProceedingsEntry: "bibtex_AuthorField" = None, bibtex_InProceedingsEntry20: "bibtex_TitleField" = None, bibtex_InProceedingsEntry29: "bibtex_PageField" = None, bibtex_InProceedingsEntry32: "bibtex_VolumeField" = None, bibtex_InProceedingsEntry34: "bibtex_NumberField" = None, bibtex_InProceedingsEntry36: "bibtex_SeriesField" = None, bibtex_InProceedingsEntry38: "bibtex_AddressField" = None, bibtex_InProceedingsEntry40: "bibtex_MonthField" = None, bibtex_InProceedingsEntry42: "bibtex_OrganizationField" = None, bibtex_InProceedingsEntry44: "bibtex_NoteField" = None, bibtex_InProceedingsEntry46: "bibtex_PublisherField" = None):
...
class bibtex_Entry(ABC):
    ...
    def __init__(self, bibtex_Entry77: "bibtex_Bibliography" = None, bibtex_Entry: "bibtex_BibtexKeyField" = None, bibtex_Entry9: "bibtex_AbstractField" = None, bibtex_Entry11: "bibtex_UrlField" = None, bibtex_Entry13: "bibtex_KeywordField" = None, bibtex_Entry16: "bibtex_ReviewField" = None):
...
class Field:
    ...
    pass
class bibtex_SeriesField(StringValue, Field):

    pass
class bibtex_AddressField(StringValue, Field):

    pass
class bibtex_BookTitleField(StringValue, Field):

    pass
class bibtex_ReviewField(StringValue, Field):

    pass
class bibtex_JournalField(StringValue, Field):

    pass
class bibtex_UrlField(StringValue, Field):

    pass
class bibtex_EidField(StringValue, Field):

    pass
class bibtex_NoteField(StringValue, Field):

    pass
class bibtex_OrganizationField(StringValue, Field):

    pass
class bibtex_KeywordField(Field):

    pass
class bibtex_PublisherField(StringValue, Field):

    pass
class bibtex_BibtexKeyField(StringValue, Field):

    pass
class bibtex_YearField(YearValue, Field):

    pass
class bibtex_PageField(Field):

    pass
class bibtex_MonthField(StringValue, Field):

    pass
class bibtex_AbstractField(StringValue, Field):
...
class IntValue:
    ...
    pass
class bibtex_PartField(IntValue, Field):

    pass
class bibtex_NumberField(IntValue, Field):

    pass
class bibtex_VolumeField(IntValue, Field):
...
class bibtex_TitleField(StringValue, Field):
