...
class TypeGraphTrace_MethodSignatureTrace:
    ...
    def __init__(self, signatureString: str, TypeGraphTrace_MethodSignatureTrace6: "TypeGraphTrace_TMethodSignature" = None, TypeGraphTrace_MethodSignatureTrace: "TypeGraphTrace_Trace" = None):
