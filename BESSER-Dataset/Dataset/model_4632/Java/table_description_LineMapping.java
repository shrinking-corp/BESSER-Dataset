...
public class table_description_LineMapping extends description_StyleUpdater, description_TableMapping {
    ...
    public table_description_LineMapping(
        String headerLabelExpression,        String semanticCandidatesExpression,        String domainClass        ArrayList<LineMapping> linemappings,        ArrayList<LineMapping> linemappings,        ArrayList<LineMapping> linemappings,        ArrayList<LineMapping> linemappings,        ArrayList<CreateLineTool> createlinetools    ) {
        this.headerLabelExpression = headerLabelExpression;
        this.semanticCandidatesExpression = semanticCandidatesExpression;
        this.domainClass = domainClass;
