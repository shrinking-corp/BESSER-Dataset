...
# Classes
model1_Supplier = Class(name="model1_Supplier")
model1_Customer = Class(name="model1_Customer")
model1_PurchaseOrder = Class(name="model1_PurchaseOrder")
model1_SalesOrder = Class(name="model1_SalesOrder")
model1_ProductToOrder = Class(name="model1_ProductToOrder")
model1_Order = Class(name="model1_Order", is_abstract=True)
model1_Address = Class(name="model1_Address")
model1_Company = Class(name="model1_Company")
Address = Class(name="Address")
model1_Category = Class(name="model1_Category")
model1_OrderDetail = Class(name="model1_OrderDetail")
model1_Product1 = Class(name="model1_Product1")
Order = Class(name="Order")
model1_OrderAddress = Class(name="model1_OrderAddress")
...
model1_Address.attributes={model1_Address_street, model1_Address_city, model1_Address_name}
...
model1_Product1.attributes={model1_Product1_name, model1_Product1_otherVATs, model1_Product1_vat, model1_Product1_description}
...
domain_model = DomainModel(
    name="model1",
    types={model1_Supplier, model1_Customer, model1_PurchaseOrder, model1_SalesOrder, model1_ProductToOrder, model1_Order, model1_Address, model1_Company, Address, model1_Category, model1_OrderDetail, model1_Product1, Order, model1_OrderAddress, OrderDetail, VAT},
    associations={categories0, suppliers1, customers3, purchaseOrders5, salesOrders7, purchaseOrders9, salesOrders10, orderByProduct11, customer21, purchaseOrders22, categories26, products28, orderDetails13, order14, product15, supplier17, salesOrders18, key32, value35, orderDetails30},
    generalizations={gen_model1_Supplier_Address, gen_model1_Customer_Address, gen_model1_Company_Address, gen_model1_PurchaseOrder_Order, gen_model1_SalesOrder_Order, gen_model1_OrderAddress_Address, gen_model1_OrderAddress_Order, gen_model1_OrderAddress_OrderDetail},
    metadata=None
)
