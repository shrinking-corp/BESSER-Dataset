...
class model1_Product1:
    ...
    def __init__(self, name: str, vat: str, otherVATs: str, description: str, model1_Product1: "model1_Category" = None, Product1: "model1_OrderDetail" = None, model1_Product134: "model1_ProductToOrder" = None, product: set["model1_OrderDetail"] = None):
        self.name = name
        self.vat = vat
...
class model1_OrderDetail:
    ...
    def __init__(self, price: float, OrderDetail: "model1_Order" = None, orderDetails: "model1_Order" = None, orderDetails16: "model1_Product1" = None, OrderDetail31: "model1_Product1" = None):
        self.price = price
...
class model1_SalesOrder(Order):
    ...
    def __init__(self, id: int, model1_SalesOrder: "model1_Company" = None, SalesOrder: "model1_Customer" = None, salesOrders: "model1_Customer" = None, salesOrders23: set["model1_PurchaseOrder"] = None, SalesOrder20: "model1_PurchaseOrder" = None, model1_SalesOrder37: "model1_ProductToOrder" = None):
        self.id = id
...
class model1_PurchaseOrder(Order):
    ...
    def __init__(self, date: date, model1_PurchaseOrder: "model1_Company" = None, PurchaseOrder: "model1_Supplier" = None, PurchaseOrder24: "model1_SalesOrder" = None, purchaseOrders: "model1_Supplier" = None, purchaseOrders19: set["model1_SalesOrder"] = None):
        self.date = date
