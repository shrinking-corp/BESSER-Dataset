...
statesmodel_ActivityNodeExecution_strategy = st.builds(statesmodel_ActivityNodeExecution)
...
statesmodel_State_strategy = st.builds(statesmodel_State)
...
statesmodel_StatesModel_strategy = st.builds(statesmodel_StatesModel)
...
statesmodel_Transition_strategy = st.builds(statesmodel_Transition)
...
statesmodel_ValueSnapshot_strategy = st.builds(statesmodel_ValueSnapshot)
