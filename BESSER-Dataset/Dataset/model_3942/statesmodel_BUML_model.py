...
# Classes
statesmodel_StatesModel = Class(name="statesmodel_StatesModel")
statesmodel_State = Class(name="statesmodel_State")
statesmodel_Transition = Class(name="statesmodel_Transition")
statesmodel_ValueSnapshot = Class(name="statesmodel_ValueSnapshot")
statesmodel_ActivityNodeExecution = Class(name="statesmodel_ActivityNodeExecution")
