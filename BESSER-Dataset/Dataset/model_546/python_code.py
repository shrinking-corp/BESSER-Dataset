...
class geneology_Family:
    ...
    def __init__(self, name: str, Family: "geneology_Geneology" = None, family: set["geneology_Member"] = None, families: "geneology_Geneology" = None, Family4: "geneology_Member" = None):
        self.name = name
        self.Family = Family
