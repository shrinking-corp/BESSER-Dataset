...
class drn_Context:
    ...
    def __init__(self, name: str, where: str, drn_Context19: set["drn_Limit"] = None, drn_Context: "drn_Model" = None):
        self.name = name
        self.where = where
...
class drn_With:
    ...
    def __init__(self, name: str, drn_With54: set["drn_RefDevice"] = None, drn_With: "drn_Expression" = None):
        self.name = name
...
class drn_Assignement:
    ...
    def __init__(self, name: str, drn_Assignement17: "drn_Library" = None, drn_Assignement21: set["drn_Expression"] = None, drn_Assignement31: "drn_RefPart" = None, drn_Assignement36: "drn_RefPartLib" = None, drn_Assignement: "drn_Model" = None):
        self.name = name
...
class drn_Configuration(Root):
    ...
    def __init__(self, name: str, drn_Configuration10: set["drn_TypeGeneric"] = None, drn_Configuration12: set["drn_Device"] = None, drn_Configuration14: "drn_ConnectionType" = None, drn_Configuration: "drn_Model" = None):
        self.name = name
...
class drn_Library(Root):
    ...
    def __init__(self, name: str, drn_Library16: set["drn_Assignement"] = None, drn_Library33: "drn_RefPartLib" = None, drn_Library: "drn_Model" = None):
        self.name = name
