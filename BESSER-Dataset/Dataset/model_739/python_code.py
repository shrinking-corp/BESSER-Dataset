...
class RefOntoUML_OpaqueExpression(ValueSpecification):
    ...
    def language_body_size(self, RefOntoUML_diagnostics, RefOntoUML_context) :
...
class RefOntoUML_Property(StructuralFeature):
    ...
    def __init__(self, isDerived: str, isDerivedUnion: str, default: str, aggregation: str, isComposite: str, ownedAttribute: "RefOntoUML_Class" = None, ownedAttribute103: "RefOntoUML_DataType" = None, RefOntoUML_Property106: "RefOntoUML_Property" = None, RefOntoUML_Property104: set["RefOntoUML_Property"] = None, RefOntoUML_Property109: "RefOntoUML_ValueSpecification" = None, RefOntoUML_Property113: "RefOntoUML_Property" = None, RefOntoUML_Property111: "RefOntoUML_Property" = None, RefOntoUML_Property116: "RefOntoUML_Property" = None, RefOntoUML_Property114: set["RefOntoUML_Property"] = None, memberEnd: "RefOntoUML_Association" = None, ownedEnd: "RefOntoUML_Association" = None, Property125: "RefOntoUML_Class" = None, Property127: "RefOntoUML_DataType" = None, Property60: "RefOntoUML_Association" = None, RefOntoUML_Property: "RefOntoUML_Association" = None, Property: "RefOntoUML_Association" = None, RefOntoUML_Property78: "RefOntoUML_Classifier" = None):
    ...
    def derived_union_is_read_only(self, RefOntoUML_context, RefOntoUML_diagnostics) :
    ...
    def navigable_readonly(self, RefOntoUML_diagnostics, RefOntoUML_context) :
...
class RefOntoUML_DataType(Classifier):
    ...
    def createOwnedOperation(self, RefOntoUML_parameterNames, RefOntoUML_returnType, RefOntoUML_name, RefOntoUML_parameterTypes):
        # TODO: Implement createOwnedOperation method
        pass

    def createOwnedAttribute(self, RefOntoUML_lower, RefOntoUML_type, RefOntoUML_name, RefOntoUML_upper) :
...
class RefOntoUML_Class(Classifier):
    ...
    def createOwnedOperation(self, RefOntoUML_name, RefOntoUML_parameterNames, RefOntoUML_returnType, RefOntoUML_parameterTypes):
        # TODO: Implement createOwnedOperation method
        pass
...
class RefOntoUML_Generalization(DirectedRelationship):
    ...
    def __init__(self, isSubstitutable: str, generalization89: "RefOntoUML_Classifier" = None, Generalization93: "RefOntoUML_GeneralizationSet" = None, Generalization: "RefOntoUML_Classifier" = None, RefOntoUML_Generalization: "RefOntoUML_Classifier" = None, generalization: set["RefOntoUML_GeneralizationSet"] = None):
...
class RefOntoUML_ElementImport(DirectedRelationship):
    ...
    def visibility_public_or_private(self, RefOntoUML_diagnostics, RefOntoUML_context) :
        # TODO: Implement visibility_public_or_private method
        pass

    def imported_element_is_public(self, RefOntoUML_context, RefOntoUML_diagnostics) :
...
class RefOntoUML_StringExpression(Expression):
    ...
    def subexpressions(self, RefOntoUML_context, RefOntoUML_diagnostics) :
        # TODO: Implement subexpressions method
        pass

    def operands(self, RefOntoUML_diagnostics, RefOntoUML_context) :
...
class RefOntoUML_Association(Relationship, Classifier):
    ...
    def __init__(self, isDerived: str, Association118: "RefOntoUML_Property" = None, Association: "RefOntoUML_Property" = None, association: set["RefOntoUML_Property"] = None, RefOntoUML_Association: set["RefOntoUML_Type"] = None, RefOntoUML_Association64: set["RefOntoUML_Property"] = None, owningAssociation: set["RefOntoUML_Property"] = None):
        self.isDerived = isDerived
    ...
    def specialized_end_types(self, RefOntoUML_context, RefOntoUML_diagnostics) :
...
class RefOntoUML_GeneralizationSet(PackageableElement):
    ...
    def __init__(self, isCovering: str, isDisjoint: str, powertypeExtent: "RefOntoUML_Classifier" = None, generalizationSet: set["RefOntoUML_Generalization"] = None, GeneralizationSet: "RefOntoUML_Classifier" = None, GeneralizationSet87: "RefOntoUML_Generalization" = None):
...
class RefOntoUML_Constraintx(PackageableElement):
    ...
    def value_specification_boolean(self, RefOntoUML_diagnostics, RefOntoUML_context) :
...
class RefOntoUML_Type(PackageableElement):
    ...
    def __init__(self, RefOntoUML_Type: "RefOntoUML_TypedElement" = None, ownedType: "RefOntoUML_Package" = None, Type: "RefOntoUML_Package" = None, RefOntoUML_Type62: "RefOntoUML_Association" = None):
    ...
    def createAssociation(self, RefOntoUML_end2Aggregation, RefOntoUML_end1Name, RefOntoUML_end1Upper, RefOntoUML_end1Type, RefOntoUML_end1IsNavigable, RefOntoUML_end2IsNavigable, RefOntoUML_end1Lower, RefOntoUML_end2Name, RefOntoUML_end2Lower, RefOntoUML_end1Aggregation, RefOntoUML_end2Upper) :
...
class RefOntoUML_Classifier(RedefinableElement, Namespace, Type):
    ...
    def __init__(self, isAbstract: str, Classifier: "RefOntoUML_Generalization" = None, Classifier91: "RefOntoUML_GeneralizationSet" = None, Classifier95: "RefOntoUML_Feature" = None, RefOntoUML_Classifier120: "RefOntoUML_Class" = None, specific: set["RefOntoUML_Generalization"] = None, powertype: set["RefOntoUML_GeneralizationSet"] = None, featuringClassifier: set["RefOntoUML_Feature"] = None, RefOntoUML_Classifier: set["RefOntoUML_NamedElement"] = None, RefOntoUML_Classifier72: "RefOntoUML_Classifier" = None, RefOntoUML_Classifier70: set["RefOntoUML_Classifier"] = None, RefOntoUML_Classifier75: "RefOntoUML_Classifier" = None, RefOntoUML_Classifier73: set["RefOntoUML_Classifier"] = None, RefOntoUML_Classifier83: "RefOntoUML_RedefinableElement" = None, RefOntoUML_Classifier77: set["RefOntoUML_Property"] = None, RefOntoUML_Classifier85: "RefOntoUML_Generalization" = None, RefOntoUML_Classifier142: "RefOntoUML_InstanceSpecification" = None):
...
class RefOntoUML_Package(Namespace, PackageableElement):
    ...
    def __init__(self, RefOntoUML_Package46: "RefOntoUML_PackageImport" = None, Package57: "RefOntoUML_Type" = None, package: set["RefOntoUML_Type"] = None, receivingPackage: set["RefOntoUML_PackageMerge"] = None, RefOntoUML_Package: set["RefOntoUML_PackageableElement"] = None, Package: "RefOntoUML_Package" = None, nestingPackage: set["RefOntoUML_Package"] = None, Package16: "RefOntoUML_Package" = None, nestedPackage: "RefOntoUML_Package" = None, RefOntoUML_Package136: "RefOntoUML_PackageMerge" = None, Package138: "RefOntoUML_PackageMerge" = None):
    ...
    def getAppliedProfile(self, RefOntoUML_qualifiedName):
...
class RefOntoUML_Element(EModelElement):
    ...
    def __init__(self, RefOntoUML_Element27: "RefOntoUML_DirectedRelationship" = None, RefOntoUML_Element29: "RefOntoUML_Relationship" = None, RefOntoUML_Element50: "RefOntoUML_Constraintx" = None, RefOntoUML_Element: "RefOntoUML_Comment" = None, Element5: "RefOntoUML_Element" = None, ownedElement: "RefOntoUML_Element" = None, RefOntoUML_Element7: set["RefOntoUML_Comment"] = None, Element: "RefOntoUML_Element" = None, owner: set["RefOntoUML_Element"] = None, RefOntoUML_Element24: "RefOntoUML_DirectedRelationship" = None):
    ...
    def has_owner(self, RefOntoUML_context, RefOntoUML_diagnostics) :
...
class RefOntoUML_NamedElement(Element):
    ...
    def __init__(self, name: str, visibility: str, qualifiedName: str, ownedMember: "RefOntoUML_Namespace" = None, RefOntoUML_NamedElement: "RefOntoUML_StringExpression" = None, RefOntoUML_NamedElement21: "RefOntoUML_Dependency" = None, NamedElement40: "RefOntoUML_Namespace" = None, RefOntoUML_NamedElement35: "RefOntoUML_Namespace" = None, client: set["RefOntoUML_Dependency"] = None, NamedElement: "RefOntoUML_Dependency" = None, RefOntoUML_NamedElement69: "RefOntoUML_Classifier" = None):
        self.name = name
        self.visibility = visibility
    ...
    def visibility_needs_ownership(self, RefOntoUML_context, RefOntoUML_diagnostics) :
