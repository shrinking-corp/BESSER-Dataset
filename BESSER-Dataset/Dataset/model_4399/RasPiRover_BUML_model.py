...
raspirover_RoverProgram_m_bindVar: Method = Method(name="bindVar", parameters={Parameter(name='raspirover_n', type=StringType), Parameter(name='raspirover_v', type=StringType)})
...
domain_model = DomainModel(
    name="raspirover",
    types={raspirover_RasPiBoard, raspirover_NamedElement, Board, raspirover_DigitalPin, raspirover_AnalogPin, raspirover_Board, NamedElement, raspirover_Project, raspirover_RoverProgram, raspirover_Block, raspirover_Sketch, raspirover_Instruction, Pin, raspirover_ArduinoDigitalModule, ArduinoModule, raspirover_ArduinoModule, Module, raspirover_Module, raspirover_ArduinoAnalogModule, raspirover_Pin, raspirover_Param, raspirover_Statement, raspirover_VarAssignment, Statement, raspirover_RclBlock, raspirover_RoverValue, raspirover_Conditional, raspirover_RoverExpression, raspirover_Loop, raspirover_Query, raspirover_TemperatureQuery, Query, NumberValue, raspirover_HumidityQuery, StringValue, raspirover_StringExpression, raspirover_ObstacleQuery, BooleanValue, raspirover_NumericExpression, RoverExpression, raspirover_NumberValue, raspirover_MessageQuery, raspirover_Quantity, raspirover_StringValue, raspirover_BooleanExpression, raspirover_BooleanValue, RoverValue, raspirover_BackwardAction, raspirover_Action, raspirover_BackwardMinAction, raspirover_ForwardAction, Action, raspirover_ForwardMinAction, raspirover_TurnAction, raspirover_TurnDegAction, raspirover_LogAction, raspirover_StopAction, raspirover_VarRef, raspirover_SendAction, raspirover_Unit, raspirover_LengthUnit, Unit, raspirover_Centimeter, MetricSystemUnit, LengthUnit, raspirover_Meter, raspirover_Foot, ImperialSystemUnit, raspirover_Millimeter, raspirover_Inch, raspirover_Yard, raspirover_MetricSystemUnit, raspirover_ImperialSystemUnit, raspirover_AngleUnit, raspirover_Radian, AngleUnit, raspirover_Gradian, raspirover_Degree, raspirover_Turn, raspirover_Length, Quantity, raspirover_Angle, raspirover_LengthScalarDivide, raspirover_LengthEquals, raspirover_LengthDistinct, raspirover_QuantityOperation, raspirover_LengthOperation, QuantityOperation, raspirover_LengthAdd, LengthOperation, QuantityHomogenousOperation, raspirover_LengthSubtract, raspirover_LengthScalarMultiply, QuantityScalarOperation, raspirover_AngleScalarMultiply, raspirover_AngleScalarDivide, raspirover_LengthSmaller, raspirover_LengthGreater, raspirover_AngleOperation, raspirover_AngleAdd, AngleOperation, raspirover_AngleSubtract, raspirover_QuantityScalarOperation, raspirover_AngleEquals, raspirover_AngleDistinct, raspirover_AngleSmaller, raspirover_AngleGreater, raspirover_QuantityArithmeticOperation, raspirover_QuantityComparisonOperation, raspirover_QuantityHomogenousOperation, StringOperator, NumericOperator, BooleanOperator},
    associations={digitalPins0, analogPins1, project3, program7, project8, block10, boards4, board11, sketches5, instructions13, module15, module17, params19, enclosing23, block21, value24, expr25, condTrue26, condFalse29, expr32, block34, stmts37, lhs38, rhs39, lhs42, rhs43, lhs46, rhs47, quantity50, distance53, associatedPin52, distance55, degrees57, unit59, rhs63, lhs66, lhs61},
    generalizations={gen_raspirover_RasPiBoard_Board, gen_raspirover_Board_NamedElement, gen_raspirover_Sketch_NamedElement, gen_raspirover_DigitalPin_Pin, gen_raspirover_ArduinoDigitalModule_ArduinoModule, gen_raspirover_ArduinoModule_Module, gen_raspirover_Module_NamedElement, gen_raspirover_AnalogPin_Pin, gen_raspirover_ArduinoAnalogModule_ArduinoModule, gen_raspirover_Pin_NamedElement, gen_raspirover_VarAssignment_Statement, gen_raspirover_Conditional_Statement, gen_raspirover_RclBlock_Statement, gen_raspirover_Loop_Statement, gen_raspirover_TemperatureQuery_Query, gen_raspirover_TemperatureQuery_NumberValue, gen_raspirover_HumidityQuery_Query, gen_raspirover_HumidityQuery_NumberValue, gen_raspirover_MessageQuery_StringValue, gen_raspirover_StringExpression_RoverExpression, gen_raspirover_ObstacleQuery_Query, gen_raspirover_ObstacleQuery_BooleanValue, gen_raspirover_NumericExpression_RoverExpression, gen_raspirover_MessageQuery_Query, gen_raspirover_BooleanExpression_RoverExpression, gen_raspirover_NumberValue_RoverValue, gen_raspirover_StringValue_RoverValue, gen_raspirover_BooleanValue_RoverValue, gen_raspirover_BackwardAction_Action, gen_raspirover_Action_Statement, gen_raspirover_BackwardMinAction_Action, gen_raspirover_ForwardAction_Action, gen_raspirover_ForwardMinAction_Action, gen_raspirover_TurnAction_Action, gen_raspirover_TurnDegAction_Action, gen_raspirover_LogAction_Action, gen_raspirover_StopAction_Action, gen_raspirover_VarRef_BooleanValue, gen_raspirover_VarRef_NumberValue, gen_raspirover_VarRef_StringValue, gen_raspirover_VarRef_Statement, gen_raspirover_SendAction_Action, gen_raspirover_LengthUnit_Unit, gen_raspirover_Centimeter_MetricSystemUnit, gen_raspirover_Centimeter_LengthUnit, gen_raspirover_Meter_MetricSystemUnit, gen_raspirover_Meter_LengthUnit, gen_raspirover_Foot_ImperialSystemUnit, gen_raspirover_Foot_LengthUnit, gen_raspirover_Millimeter_MetricSystemUnit, gen_raspirover_Millimeter_LengthUnit, gen_raspirover_Inch_ImperialSystemUnit, gen_raspirover_Inch_LengthUnit, gen_raspirover_Yard_ImperialSystemUnit, gen_raspirover_Yard_LengthUnit, gen_raspirover_MetricSystemUnit_Unit, gen_raspirover_ImperialSystemUnit_Unit, gen_raspirover_AngleUnit_Unit, gen_raspirover_Radian_AngleUnit, gen_raspirover_Gradian_AngleUnit, gen_raspirover_Degree_AngleUnit, gen_raspirover_Turn_AngleUnit, gen_raspirover_Length_Quantity, gen_raspirover_Angle_Quantity, gen_raspirover_LengthScalarDivide_LengthOperation, gen_raspirover_LengthScalarDivide_QuantityScalarOperation, gen_raspirover_LengthEquals_LengthOperation, gen_raspirover_LengthEquals_QuantityHomogenousOperation, gen_raspirover_LengthDistinct_LengthOperation, gen_raspirover_LengthOperation_QuantityOperation, gen_raspirover_LengthAdd_LengthOperation, gen_raspirover_LengthAdd_QuantityHomogenousOperation, gen_raspirover_LengthSubtract_LengthOperation, gen_raspirover_LengthSubtract_QuantityHomogenousOperation, gen_raspirover_LengthScalarMultiply_LengthOperation, gen_raspirover_LengthScalarMultiply_QuantityScalarOperation, gen_raspirover_AngleScalarMultiply_AngleOperation, gen_raspirover_AngleScalarMultiply_QuantityScalarOperation, gen_raspirover_AngleScalarDivide_AngleOperation, gen_raspirover_AngleScalarDivide_QuantityScalarOperation, gen_raspirover_LengthDistinct_QuantityHomogenousOperation, gen_raspirover_LengthSmaller_LengthOperation, gen_raspirover_LengthSmaller_QuantityHomogenousOperation, gen_raspirover_LengthGreater_LengthOperation, gen_raspirover_LengthGreater_QuantityHomogenousOperation, gen_raspirover_AngleOperation_QuantityOperation, gen_raspirover_AngleAdd_AngleOperation, gen_raspirover_AngleAdd_QuantityHomogenousOperation, gen_raspirover_AngleSubtract_AngleOperation, gen_raspirover_AngleSubtract_QuantityHomogenousOperation, gen_raspirover_QuantityScalarOperation_QuantityOperation, gen_raspirover_AngleEquals_AngleOperation, gen_raspirover_AngleEquals_QuantityHomogenousOperation, gen_raspirover_AngleDistinct_AngleOperation, gen_raspirover_AngleDistinct_QuantityHomogenousOperation, gen_raspirover_AngleSmaller_AngleOperation, gen_raspirover_AngleSmaller_QuantityHomogenousOperation, gen_raspirover_AngleGreater_AngleOperation, gen_raspirover_AngleGreater_QuantityHomogenousOperation, gen_raspirover_QuantityArithmeticOperation_QuantityOperation, gen_raspirover_QuantityComparisonOperation_QuantityOperation, gen_raspirover_QuantityHomogenousOperation_QuantityOperation},
    metadata=None
)
