...
def test_model_attachment_FileAttachment_fileHash_value_roundtrip():
    instance = model_attachment_FileAttachment(fileHash="sample_text", fileID="sample_text", fileName="sample_text", fileSize="sample_text")
...
model_attachment_FileAttachment_strategy = st.builds(model_attachment_FileAttachment, fileHash=safe_text, fileID=safe_text, fileName=safe_text, fileSize=safe_text)
@given(instance=model_attachment_FileAttachment_strategy)
@settings(max_examples=25)
