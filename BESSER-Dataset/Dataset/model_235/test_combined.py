...
def test_hyp_ecore_memoclass_is_not_abstract():
    assert not inspect.isabstract(ecore_MemoClass)


def test_hyp_ecore_memoclass_constructor_exists():
    assert callable(ecore_MemoClass.__init__)


def test_hyp_ecore_memoclass_constructor_args():
    sig = inspect.signature(ecore_MemoClass.__init__)
    params = list(sig.parameters.keys())
...
ecore_MemoClass_strategy = st.builds(
    ecore_MemoClass,
    instance=
        safe_text
)
...
@given(instance=ecore_MemoClass_strategy)
def test_hyp_ecore_memoclass_instance_setter(instance):
...
def test_ecore_MemoClass_instance_value_roundtrip():
    instance = ecore_MemoClass(instance="sample_text")
    assert instance.instance == "sample_text"
    instance.instance = "sample_text_2"
    assert instance.instance == "sample_text_2"


def test_ecore_MemoClass_isa_EClass():
    instance = ecore_MemoClass(instance="sample_text")
...
ecore_MemoClass_strategy = st.builds(ecore_MemoClass, instance=safe_text)
@given(instance=ecore_MemoClass_strategy)
@settings(max_examples=25)
def test_ecore_MemoClass_instantiation(instance):
    assert isinstance(instance, ecore_MemoClass)
