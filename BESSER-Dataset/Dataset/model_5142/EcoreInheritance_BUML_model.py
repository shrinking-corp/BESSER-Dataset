...
# Classes
mytest_MyRoot = Class(name="mytest_MyRoot")
mytest_A = Class(name="mytest_A")
EModelElement = Class(name="EModelElement")
mytest_B = Class(name="mytest_B")
...
domain_model = DomainModel(
    name="mytest",
    types={mytest_MyRoot, mytest_A, EModelElement, mytest_B},
    associations={a1, aContainer2, bContainer3, b0},
