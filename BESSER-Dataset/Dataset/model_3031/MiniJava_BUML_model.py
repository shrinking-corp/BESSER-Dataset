...
miniJava_MainClass = Class(name="miniJava_MainClass")
miniJava_Class = Class(name="miniJava_Class")
miniJava_Identifier = Class(name="miniJava_Identifier")
miniJava_Statement = Class(name="miniJava_Statement")
miniJava_VariableDeclaration = Class(name="miniJava_VariableDeclaration")
miniJava_MethodDeclaration = Class(name="miniJava_MethodDeclaration")
miniJava_AbstactType = Class(name="miniJava_AbstactType")
miniJava_AbstractExpression = Class(name="miniJava_AbstractExpression")
miniJava_IntegerArrayType = Class(name="miniJava_IntegerArrayType")
AbstactType = Class(name="AbstactType")
miniJava_BooleanType = Class(name="miniJava_BooleanType")
miniJava_IntegerType = Class(name="miniJava_IntegerType")
miniJava_ClassifierType = Class(name="miniJava_ClassifierType")
miniJava_BlockStatement = Class(name="miniJava_BlockStatement")
Statement = Class(name="Statement")
miniJava_IfStatement = Class(name="miniJava_IfStatement")
miniJava_WhileLoop = Class(name="miniJava_WhileLoop")
miniJava_PrintLine = Class(name="miniJava_PrintLine")
...
miniJava_LessThen = Class(name="miniJava_LessThen")
miniJava_Plus = Class(name="miniJava_Plus")
miniJava_Minus = Class(name="miniJava_Minus")
miniJava_Multiply = Class(name="miniJava_Multiply")
miniJava_ArrayAccess = Class(name="miniJava_ArrayAccess")
miniJava_LengthOf = Class(name="miniJava_LengthOf")
miniJava_ArrayAssignment = Class(name="miniJava_ArrayAssignment")
miniJava_IntLiteral = Class(name="miniJava_IntLiteral")
miniJava_Boolean = Class(name="miniJava_Boolean")
miniJava_ClassifierReference = Class(name="miniJava_ClassifierReference")
miniJava_ThisReference = Class(name="miniJava_ThisReference")
miniJava_IntegerArrayConstruction = Class(name="miniJava_IntegerArrayConstruction")
miniJava_ClassConstruction = Class(name="miniJava_ClassConstruction")
miniJava_Negation = Class(name="miniJava_Negation")
miniJava_BlockExpression = Class(name="miniJava_BlockExpression")
miniJava_FunctionCall = Class(name="miniJava_FunctionCall")
...
class_118: BinaryAssociation = BinaryAssociation(
    name="class_118",
    ends={
...
not_120: BinaryAssociation = BinaryAssociation(
    name="not_120",
    ends={
...
domain_model = DomainModel(
    name="miniJava",
    types={miniJava_Program, miniJava_MainClass, miniJava_Class, miniJava_Identifier, miniJava_Statement, miniJava_VariableDeclaration, miniJava_MethodDeclaration, miniJava_AbstactType, miniJava_AbstractExpression, miniJava_IntegerArrayType, AbstactType, miniJava_BooleanType, miniJava_IntegerType, miniJava_ClassifierType, miniJava_BlockStatement, Statement, miniJava_IfStatement, miniJava_WhileLoop, miniJava_PrintLine, miniJava_Assignment, miniJava_And, AbstractExpression, miniJava_LessThen, miniJava_Plus, miniJava_Minus, miniJava_Multiply, miniJava_ArrayAccess, miniJava_LengthOf, miniJava_ArrayAssignment, miniJava_IntLiteral, miniJava_Boolean, miniJava_ClassifierReference, miniJava_ThisReference, miniJava_IntegerArrayConstruction, miniJava_ClassConstruction, miniJava_Negation, miniJava_BlockExpression, miniJava_FunctionCall},
    associations={mainClass0, classes1, name3, commandLineArguments5, statements8, name10, superClass13, variables16, methods18, type20, variables34, statements37, returnStatement40, name42, statements44, condition46, then48, else_51, condition54, do56, print59, name22, returnType25, name28, arguments31, value71, left74, right76, left79, right81, left84, right86, left89, right91, left94, right96, array99, index101, value104, identifier61, value63, identifier66, index68, referenceTo114, sizeExpression116, class_118, not_120, resultSubExpression122, on106, function108, arguments111},
    generalizations={gen_miniJava_IntegerArrayType_AbstactType, gen_miniJava_BooleanType_AbstactType, gen_miniJava_IntegerType_AbstactType, gen_miniJava_ClassifierType_AbstactType, gen_miniJava_BlockStatement_Statement, gen_miniJava_IfStatement_Statement, gen_miniJava_WhileLoop_Statement, gen_miniJava_PrintLine_Statement, gen_miniJava_Assignment_Statement, gen_miniJava_And_AbstractExpression, gen_miniJava_LessThen_AbstractExpression, gen_miniJava_Plus_AbstractExpression, gen_miniJava_Minus_AbstractExpression, gen_miniJava_Multiply_AbstractExpression, gen_miniJava_ArrayAccess_AbstractExpression, gen_miniJava_LengthOf_AbstractExpression, gen_miniJava_ArrayAssignment_Statement, gen_miniJava_IntLiteral_AbstractExpression, gen_miniJava_Boolean_AbstractExpression, gen_miniJava_ClassifierReference_AbstractExpression, gen_miniJava_ThisReference_AbstractExpression, gen_miniJava_IntegerArrayConstruction_AbstractExpression, gen_miniJava_ClassConstruction_AbstractExpression, gen_miniJava_Negation_AbstractExpression, gen_miniJava_BlockExpression_AbstractExpression, gen_miniJava_FunctionCall_AbstractExpression},
    metadata=None
)
