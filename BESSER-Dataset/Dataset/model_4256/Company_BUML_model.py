...
Company_Person.attributes={Company_Person_fullName, Company_Person_position}
...
domain_model = DomainModel(
    name="Company",
    types={Company_Person, Company_Project, Company_ServiceLine, Company_Company, Company_Address, Company_Division, Company_Category, Company_European, Project, Company_National, Company_Topic, Company_CompanyModel, Company_Unit, Division, type},
