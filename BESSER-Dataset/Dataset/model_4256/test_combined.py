...
def test_Company_Person_fullName_value_roundtrip():
    instance = Company_Person(fullName="sample_text", position="sample_text")
...
def test_assoc_assignedTo0_link_reassign_clear():
    ...
    b1 = Company_Person(fullName="sample_text", position="sample_text")
    b2 = Company_Person(fullName="sample_text_2", position="sample_text_2")
...
def test_assoc_employed1_link_reassign_clear():
    a = Company_Person(fullName="sample_text", position="sample_text")
...
Company_Person_strategy = st.builds(Company_Person, fullName=safe_text, position=safe_text)
@given(instance=Company_Person_strategy)
@settings(max_examples=25)
