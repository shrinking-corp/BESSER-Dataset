...
# Classes
source_PrimitiveDataType = Class(name="source_PrimitiveDataType")
source_ClassDiagram = Class(name="source_ClassDiagram")
source_Class = Class(name="source_Class")
source_Attribute = Class(name="source_Attribute")
source_Association = Class(name="source_Association")
...
class_14: BinaryAssociation = BinaryAssociation(
    name="class_14",
    ends={
...
domain_model = DomainModel(
    name="source",
    types={source_PrimitiveDataType, source_ClassDiagram, source_Class, source_Attribute, source_Association},
    associations={src4, dest6, type9, ptype12, class_14, ass16, ptypes19, parent1, attrs2},
    generalizations={},
    metadata=None
)
