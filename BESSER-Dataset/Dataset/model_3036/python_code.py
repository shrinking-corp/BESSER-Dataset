...
class basicfsm_Trans:
    ...
    def __init__(self, event: str, basicfsm_Trans: "basicfsm_Machine" = None, Trans: "basicfsm_State" = None, Trans5: "basicfsm_State" = None, out: "basicfsm_State" = None, in_: "basicfsm_State" = None, basicfsm_Trans10: "basicfsm_Guard" = None, basicfsm_Trans12: "basicfsm_Action" = None):
        self.event = event
...
class basicfsm_State:
    ...
    def __init__(self, name: str, basicfsm_State: "basicfsm_Machine" = None, tgt: set["basicfsm_Trans"] = None, src: set["basicfsm_Trans"] = None, State: "basicfsm_Trans" = None, State8: "basicfsm_Trans" = None):
        self.name = name
