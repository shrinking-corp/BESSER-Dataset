...
tgt7: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="in_", type=basicfsm_State, multiplicity=Multiplicity(1, 1))
    }
)
...
domain_model = DomainModel(
    name="basicfsm",
    types={basicfsm_InitialState, State, basicfsm_Machine, basicfsm_State, basicfsm_Trans, basicfsm_Guard, basicfsm_Action},
    associations={states0, trans1, in_3, out4, src6, tgt7, guard9, action11},
