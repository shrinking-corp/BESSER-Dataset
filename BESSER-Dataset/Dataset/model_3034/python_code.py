...
class myfsm_State:
    ...
    def __init__(self, name: str, myfsm_State: "myfsm_Machine" = None, myfsm_State3: "myfsm_Machine" = None, myfsm_State5: set["myfsm_Trans"] = None, myfsm_State8: "myfsm_Trans" = None):
        self.name = name
