...
# Classes
myfsm_Machine = Class(name="myfsm_Machine")
myfsm_State = Class(name="myfsm_State")
myfsm_Trans = Class(name="myfsm_Trans")
...
domain_model = DomainModel(
    name="myfsm",
    types={myfsm_Machine, myfsm_State, myfsm_Trans},
    associations={states0, initial1, transitions4, target6},
    generalizations={},
    metadata=None
)
