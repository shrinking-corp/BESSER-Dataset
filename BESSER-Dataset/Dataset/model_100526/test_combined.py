...
def test_hyp_usecasedsl_multiplicityelement_c_is_not_abstract():
    assert not inspect.isabstract(UsecaseDSL_MultiplicityElement_c)


def test_hyp_usecasedsl_multiplicityelement_c_constructor_exists():
    assert callable(UsecaseDSL_MultiplicityElement_c.__init__)


def test_hyp_usecasedsl_multiplicityelement_c_constructor_args():
...
def test_hyp_usecasedsl_classifier_is_not_abstract():
    assert not inspect.isabstract(UsecaseDSL_Classifier)


def test_hyp_usecasedsl_classifier_constructor_exists():
    assert callable(UsecaseDSL_Classifier.__init__)


def test_hyp_usecasedsl_classifier_constructor_args():
...
def test_hyp_usecasedsl_extend_c_is_not_abstract():
    assert not inspect.isabstract(UsecaseDSL_Extend_c)


def test_hyp_usecasedsl_extend_c_constructor_exists():
    assert callable(UsecaseDSL_Extend_c.__init__)


def test_hyp_usecasedsl_extend_c_constructor_args():
...
def test_hyp_usecasedsl_extensionpoint_is_not_abstract():
    assert not inspect.isabstract(UsecaseDSL_ExtensionPoint)


def test_hyp_usecasedsl_extensionpoint_constructor_exists():
    assert callable(UsecaseDSL_ExtensionPoint.__init__)


def test_hyp_usecasedsl_extensionpoint_constructor_args():
    sig = inspect.signature(UsecaseDSL_ExtensionPoint.__init__)
    params = list(sig.parameters.keys())



def test_hyp_usecasedsl_include_is_not_abstract():
    assert not inspect.isabstract(UsecaseDSL_Include)


def test_hyp_usecasedsl_include_constructor_exists():
    assert callable(UsecaseDSL_Include.__init__)


def test_hyp_usecasedsl_include_constructor_args():
    sig = inspect.signature(UsecaseDSL_Include.__init__)
    params = list(sig.parameters.keys())



def test_hyp_usecasedsl_namespace_is_not_abstract():
    assert not inspect.isabstract(UsecaseDSL_Namespace)


def test_hyp_usecasedsl_namespace_constructor_exists():
    assert callable(UsecaseDSL_Namespace.__init__)


def test_hyp_usecasedsl_namespace_constructor_args():
    sig = inspect.signature(UsecaseDSL_Namespace.__init__)
    params = list(sig.parameters.keys())



def test_hyp_usecasedsl_namedelement_is_not_abstract():
    assert not inspect.isabstract(UsecaseDSL_NamedElement)


def test_hyp_usecasedsl_namedelement_constructor_exists():
    assert callable(UsecaseDSL_NamedElement.__init__)


def test_hyp_usecasedsl_namedelement_constructor_args():
...
def test_hyp_multiplicityelement_c_is_not_abstract():
    assert not inspect.isabstract(MultiplicityElement_c)


def test_hyp_multiplicityelement_c_constructor_exists():
    assert callable(MultiplicityElement_c.__init__)


def test_hyp_multiplicityelement_c_constructor_args():
...
def test_hyp_usecasedsl_system_c_is_not_abstract():
    assert not inspect.isabstract(UsecaseDSL_System_c)


def test_hyp_usecasedsl_system_c_constructor_exists():
    assert callable(UsecaseDSL_System_c.__init__)


def test_hyp_usecasedsl_system_c_constructor_args():
...
def test_hyp_usecasedsl_usecasediagram_c_is_not_abstract():
    assert not inspect.isabstract(UsecaseDSL_UseCaseDiagram_c)


def test_hyp_usecasedsl_usecasediagram_c_constructor_exists():
    assert callable(UsecaseDSL_UseCaseDiagram_c.__init__)


def test_hyp_usecasedsl_usecasediagram_c_constructor_args():
...
def test_hyp_usecasedsl_association_c_is_not_abstract():
    assert not inspect.isabstract(UsecaseDSL_Association_c)


def test_hyp_usecasedsl_association_c_constructor_exists():
    assert callable(UsecaseDSL_Association_c.__init__)


def test_hyp_usecasedsl_association_c_constructor_args():
    sig = inspect.signature(UsecaseDSL_Association_c.__init__)
    params = list(sig.parameters.keys())



def test_hyp_usecasedsl_directedrelationship_is_not_abstract():
    assert not inspect.isabstract(UsecaseDSL_DirectedRelationship)


def test_hyp_usecasedsl_directedrelationship_constructor_exists():
    assert callable(UsecaseDSL_DirectedRelationship.__init__)


def test_hyp_usecasedsl_directedrelationship_constructor_args():
    sig = inspect.signature(UsecaseDSL_DirectedRelationship.__init__)
    params = list(sig.parameters.keys())



def test_hyp_usecasedsl_relationship_is_not_abstract():
    assert not inspect.isabstract(UsecaseDSL_Relationship)


def test_hyp_usecasedsl_relationship_constructor_exists():
    assert callable(UsecaseDSL_Relationship.__init__)


def test_hyp_usecasedsl_relationship_constructor_args():
    sig = inspect.signature(UsecaseDSL_Relationship.__init__)
    params = list(sig.parameters.keys())



def test_hyp_usecasedsl_generalization_is_not_abstract():
    assert not inspect.isabstract(UsecaseDSL_Generalization)


def test_hyp_usecasedsl_generalization_constructor_exists():
    assert callable(UsecaseDSL_Generalization.__init__)


def test_hyp_usecasedsl_generalization_constructor_args():
...
def test_hyp_usecasedsl_multiplicityelement_c_sourceLower_setter(instance):
...
@given(instance=UsecaseDSL_MultiplicityElement_c_strategy)
def test_hyp_usecasedsl_multiplicityelement_c_targetLower_setter(instance):
...
@given(instance=UsecaseDSL_MultiplicityElement_c_strategy)
def test_hyp_usecasedsl_multiplicityelement_c_targetUpper_setter(instance):
...
@given(instance=UsecaseDSL_MultiplicityElement_c_strategy)
def test_hyp_usecasedsl_multiplicityelement_c_sourceUpper_setter(instance):
...
def test_hyp_usecasedsl_extend_c_Expression_setter(instance):
...
def test_hyp_usecasedsl_namedelement_name_setter(instance):
