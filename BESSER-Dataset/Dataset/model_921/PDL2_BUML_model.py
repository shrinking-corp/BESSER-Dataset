...
# Classes
pDL2_WorkDefinition = Class(name="pDL2_WorkDefinition")
ProcessElement = Class(name="ProcessElement")
pDL2_EObject = Class(name="pDL2_EObject")
pDL2_DependanceStart = Class(name="pDL2_DependanceStart")
pDL2_WorkSequenceKindStart = Class(name="pDL2_WorkSequenceKindStart")
pDL2_DependanceFinish = Class(name="pDL2_DependanceFinish")
pDL2_WorkSequenceKindFinish = Class(name="pDL2_WorkSequenceKindFinish")
pDL2_Process = Class(name="pDL2_Process")
pDL2_ProcessElement = Class(name="pDL2_ProcessElement")
pDL2_Guidance = Class(name="pDL2_Guidance")
...
domain_model = DomainModel(
    name="pDL2",
    types={pDL2_WorkDefinition, ProcessElement, pDL2_EObject, pDL2_DependanceStart, pDL2_WorkSequenceKindStart, pDL2_DependanceFinish, pDL2_WorkSequenceKindFinish, pDL2_Process, pDL2_ProcessElement, pDL2_Guidance},
    associations={processElements0, linksToPredecessors1, predecessor2, link4, predecessor6, link8},
