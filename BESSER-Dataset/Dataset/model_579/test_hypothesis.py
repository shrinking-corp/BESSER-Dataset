...
def test_assistantmvc_multiple_is_not_abstract():
    assert not inspect.isabstract(AssistantMVC_Multiple)


def test_assistantmvc_multiple_constructor_exists():
    assert callable(AssistantMVC_Multiple.__init__)


def test_assistantmvc_multiple_constructor_args():
...
def test_assistantmvc_multiple_has_selectionWay():
    assert hasattr(AssistantMVC_Multiple, "selectionWay")
    descriptor = None
    for klass in AssistantMVC_Multiple.__mro__:
        if "selectionWay" in klass.__dict__:
            descriptor = klass.__dict__["selectionWay"]
            break
    assert isinstance(descriptor, property)

def test_assistantmvc_multiple_has_numberOfChoices():
    assert hasattr(AssistantMVC_Multiple, "numberOfChoices")
    descriptor = None
    for klass in AssistantMVC_Multiple.__mro__:
...
@given(instance=AssistantMVC_Multiple_strategy)
def test_assistantmvc_multiple_selectionWay_setter(instance):
...
@given(instance=AssistantMVC_Multiple_strategy)
def test_assistantmvc_multiple_numberOfChoices_setter(instance):
