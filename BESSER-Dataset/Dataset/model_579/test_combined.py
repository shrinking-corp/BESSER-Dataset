...
def test_hyp_assistantmvc_multiple_is_not_abstract():
    assert not inspect.isabstract(AssistantMVC_Multiple)


def test_hyp_assistantmvc_multiple_constructor_exists():
    assert callable(AssistantMVC_Multiple.__init__)


def test_hyp_assistantmvc_multiple_constructor_args():
    sig = inspect.signature(AssistantMVC_Multiple.__init__)
    params = list(sig.parameters.keys())
...
AssistantMVC_Multiple_strategy = st.builds(
    AssistantMVC_Multiple,
    selectionWay=
        safe_text,
    numberOfChoices=
...
@given(instance=AssistantMVC_Multiple_strategy)
def test_hyp_assistantmvc_multiple_selectionWay_setter(instance):
...
@given(instance=AssistantMVC_Multiple_strategy)
def test_hyp_assistantmvc_multiple_numberOfChoices_setter(instance):
...
def test_AssistantMVC_Multiple_numberOfChoices_value_roundtrip():
    instance = AssistantMVC_Multiple(numberOfChoices=7, selectionWay="sample_text")
    assert instance.numberOfChoices == 7
    instance.numberOfChoices = 13
    assert instance.numberOfChoices == 13


def test_AssistantMVC_Multiple_selectionWay_value_roundtrip():
    instance = AssistantMVC_Multiple(numberOfChoices=7, selectionWay="sample_text")
...
def test_AssistantMVC_MultipleChoice_optional_value_roundtrip():
    instance = AssistantMVC_MultipleChoice(optional=True)
...
def test_AssistantMVC_MultipleChoice_isa_Multiple():
    instance = AssistantMVC_MultipleChoice(optional=True)
    assert isinstance(instance, Multiple)


def test_AssistantMVC_MultipleChoiceController_isa_Multiple():
    instance = AssistantMVC_MultipleChoiceController()
    assert isinstance(instance, Multiple)


def test_AssistantMVC_MultipleChoiceView_isa_Multiple():
    instance = AssistantMVC_MultipleChoiceView()
    assert isinstance(instance, Multiple)
...
def test_AssistantMVC_Multiple_isa_Observable():
    instance = AssistantMVC_Multiple(numberOfChoices=7, selectionWay="sample_text")
    assert isinstance(instance, Observable)
...
AssistantMVC_Multiple_strategy = st.builds(AssistantMVC_Multiple, numberOfChoices=st.integers(), selectionWay=safe_text)
@given(instance=AssistantMVC_Multiple_strategy)
@settings(max_examples=25)
def test_AssistantMVC_Multiple_instantiation(instance):
    assert isinstance(instance, AssistantMVC_Multiple)


AssistantMVC_MultipleChoice_strategy = st.builds(AssistantMVC_MultipleChoice, optional=st.booleans())
@given(instance=AssistantMVC_MultipleChoice_strategy)
@settings(max_examples=25)
