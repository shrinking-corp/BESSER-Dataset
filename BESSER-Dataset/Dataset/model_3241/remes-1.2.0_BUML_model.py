...
# Classes
remes_RemesDiagram = Class(name="remes_RemesDiagram")
remes_Mode = Class(name="remes_Mode", is_abstract=True)
remes_ControlPath = Class(name="remes_ControlPath", is_abstract=True)
remes_EntryPoint = Class(name="remes_EntryPoint")
remes_ExitPoint = Class(name="remes_ExitPoint")
ControlPath = Class(name="ControlPath")
remes_Constant = Class(name="remes_Constant")
remes_CompositeMode = Class(name="remes_CompositeMode")
Mode = Class(name="Mode")
remes_SubMode = Class(name="remes_SubMode")
remes_ConditionalConnector = Class(name="remes_ConditionalConnector")
remes_InitPoint = Class(name="remes_InitPoint")
remes_CompositeEntryPoint = Class(name="remes_CompositeEntryPoint")
remes_CompositeExitPoint = Class(name="remes_CompositeExitPoint")
remes_WritePoint = Class(name="remes_WritePoint")
remes_Variable = Class(name="remes_Variable")
remes_Resource = Class(name="remes_Resource")
remes_Point = Class(name="remes_Point", is_abstract=True)
Point = Class(name="Point")
remes_InitEdge = Class(name="remes_InitEdge")
remes_Edge = Class(name="remes_Edge")
...
remes_Referable = Class(name="remes_Referable", is_abstract=True)
Referable = Class(name="Referable")
ResourceRoot = Class(name="ResourceRoot")
remes_WriteEdge = Class(name="remes_WriteEdge")
...
remes_Mode_m_findVariableByName: Method = Method(name="findVariableByName", parameters={Parameter(name='remes_name', type=StringType)}, type=StringType)
remes_Mode_m_findResourceByName: Method = Method(name="findResourceByName", parameters={Parameter(name='remes_name', type=StringType)}, type=StringType)
remes_Mode_m_findConstantByName: Method = Method(name="findConstantByName", parameters={Parameter(name='remes_name', type=StringType)}, type=StringType)
...
remes_Constant_global_: Property = Property(name="global_", type=BooleanType)
remes_Constant.attributes={remes_Constant_global_, remes_Constant_type, remes_Constant_value}
...
remes_Variable_global_: Property = Property(name="global_", type=BooleanType)
...
remes_Variable.attributes={remes_Variable_type, remes_Variable_readable, remes_Variable_vectorSize, remes_Variable_value, remes_Variable_writable, remes_Variable_global_}
...
domain_model = DomainModel(
    name="remes",
    types={remes_RemesDiagram, remes_Mode, remes_ControlPath, remes_EntryPoint, remes_ExitPoint, ControlPath, remes_Constant, remes_CompositeMode, Mode, remes_SubMode, remes_ConditionalConnector, remes_InitPoint, remes_CompositeEntryPoint, remes_CompositeExitPoint, remes_WritePoint, remes_Variable, remes_Resource, remes_Point, Point, remes_InitEdge, remes_Edge, ExitPoint, EntryPoint, ActionRoot, LogicalRoot, remes_Referable, Referable, ResourceRoot, remes_WriteEdge, PrimitiveTypes, ResourceTypes},
    associations={modes0, entryPoint1, exitPoint2, resources5, constants7, subModes9, conditionalConnectors10, initPoint12, compositeEntryPoint14, compositeExitPoint15, writePoint17, parent19, variables4, initEdge23, container24, entryEdges26, container27, exitEdges28, container31, composite33, composite35, parsedActionGuard37, connectFrom39, connectTo41, parsedInvariant20, parent21, scope51, scope52, parsedExpression54, scope55, connectTo57, connectFrom59, parsedActionBody43, connectFrom45, connectTo47, parsedInitialization48, container60, writeEdges62},
    generalizations={gen_remes_Mode_ControlPath, gen_remes_CompositeMode_Mode, gen_remes_SubMode_Mode, gen_remes_InitPoint_Point, gen_remes_EntryPoint_Point, gen_remes_ExitPoint_Point, gen_remes_CompositeEntryPoint_ExitPoint, gen_remes_CompositeExitPoint_EntryPoint, gen_remes_ConditionalConnector_ControlPath, gen_remes_Variable_Referable, gen_remes_Resource_Referable, gen_remes_Constant_Referable, gen_remes_WritePoint_Point},
    metadata=None
)
