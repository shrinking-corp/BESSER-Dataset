...
class remes_InitEdge:
    ...
    def __init__(self, initialization: str, initEdge: "remes_InitPoint" = None, remes_InitEdge: "remes_EntryPoint" = None, InitEdge: "remes_InitPoint" = None, remes_InitEdge49: "ActionRoot" = None):
...
class remes_Mode(ControlPath):
    ...
    def __init__(self, initialization: str, remes_Mode: "remes_RemesDiagram" = None, scope6: set["remes_Resource"] = None, scope8: set["remes_Constant"] = None, scope: set["remes_Variable"] = None, Mode: "remes_Variable" = None, Mode53: "remes_Resource" = None, Mode56: "remes_Constant" = None):
        self.initialization = initialization
