...
class trace_ParameterValue:
    ...
    def __init__(self, DirectionKind: str, trace_ParameterValue68: set["trace_Value"] = None, trace_ParameterValue87: "trace_ParameterList" = None, trace_ParameterValue: "trace_Trace" = None):
