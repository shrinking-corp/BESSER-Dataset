...
# Classes
trace_StepPattern = Class(name="trace_StepPattern")
trace_ObjectState = Class(name="trace_ObjectState", is_abstract=True)
trace_RepeatingStep = Class(name="trace_RepeatingStep")
trace_Step = Class(name="trace_Step", is_abstract=True)
trace_ParameterValue = Class(name="trace_ParameterValue")
trace_ParameterList = Class(name="trace_ParameterList", is_abstract=True)
trace_LiteralValue = Class(name="trace_LiteralValue", is_abstract=True)
Value = Class(name="Value")
trace_RefValue = Class(name="trace_RefValue")
trace_EObject = Class(name="trace_EObject")
trace_Value = Class(name="trace_Value", is_abstract=True)
trace_TransientObject = Class(name="trace_TransientObject", is_abstract=True)
trace_Trace = Class(name="trace_Trace")
trace_State = Class(name="trace_State")
trace_StepType = Class(name="trace_StepType")
trace_PatternOcurrence = Class(name="trace_PatternOcurrence")
trace_PatternOccurrenceStepData = Class(name="trace_PatternOccurrenceStepData")
trace_StepSpec = Class(name="trace_StepSpec", is_abstract=True)
trace_TransientObjectState = Class(name="trace_TransientObjectState")
trace_NormalStep = Class(name="trace_NormalStep")
Step = Class(name="Step")
StepSpec = Class(name="StepSpec")
trace_LiteralString = Class(name="trace_LiteralString")
LiteralValue = Class(name="LiteralValue")
trace_LiteralBoolean = Class(name="trace_LiteralBoolean")
trace_LiteralInteger = Class(name="trace_LiteralInteger")
trace_LiteralFloat = Class(name="trace_LiteralFloat")
trace_StaticTransientObject = Class(name="trace_StaticTransientObject")
TransientObject = Class(name="TransientObject")
trace_DynamicTransientObject = Class(name="trace_DynamicTransientObject")
trace_EClass = Class(name="trace_EClass")
trace_CompositParameterList = Class(name="trace_CompositParameterList")
ParameterList = Class(name="ParameterList")
trace_LeafParameterList = Class(name="trace_LeafParameterList")
trace_EStructuralFeature = Class(name="trace_EStructuralFeature")
trace_LeafObjectState = Class(name="trace_LeafObjectState")
ObjectState = Class(name="ObjectState")
trace_CompositeObjectState = Class(name="trace_CompositeObjectState")
...
domain_model = DomainModel(
    name="trace",
    types={trace_StepPattern, trace_ObjectState, trace_RepeatingStep, trace_Step, trace_ParameterValue, trace_ParameterList, trace_LiteralValue, Value, trace_RefValue, trace_EObject, trace_Value, trace_TransientObject, trace_Trace, trace_State, trace_StepType, trace_PatternOcurrence, trace_PatternOccurrenceStepData, trace_StepSpec, trace_TransientObjectState, trace_NormalStep, Step, StepSpec, trace_LiteralString, LiteralValue, trace_LiteralBoolean, trace_LiteralInteger, trace_LiteralFloat, trace_StaticTransientObject, TransientObject, trace_DynamicTransientObject, trace_EClass, trace_CompositParameterList, ParameterList, trace_LeafParameterList, trace_EStructuralFeature, trace_LeafObjectState, ObjectState, trace_CompositeObjectState, ParamterKindEnum},
    associations={steppattern5, value7, objectstate9, repeatingstep11, step13, parameterValues15, parameterlist17, value19, originalobject22, newobjects23, deletedobjects26, state0, transientobject1, steptype3, parent38, parameterlist39, pattern42, stepdata44, repeatingstep46, states49, step52, parameterlists55, basestate30, transientObjectsStates32, children34, state35, values67, transientobject70, objectstate73, steptype58, children61, parent64, originalObject80, type82, parameterlist83, parametervalue85, estructuralfeature76, objectstates78},
    generalizations={gen_trace_LiteralValue_Value, gen_trace_RefValue_Value, gen_trace_PatternOcurrence_Step, gen_trace_NormalStep_Step, gen_trace_NormalStep_StepSpec, gen_trace_LiteralString_LiteralValue, gen_trace_LiteralBoolean_LiteralValue, gen_trace_LiteralInteger_LiteralValue, gen_trace_LiteralFloat_LiteralValue, gen_trace_RepeatingStep_StepSpec, gen_trace_StaticTransientObject_TransientObject, gen_trace_DynamicTransientObject_TransientObject, gen_trace_CompositParameterList_ParameterList, gen_trace_LeafParameterList_ParameterList, gen_trace_LeafObjectState_ObjectState, gen_trace_CompositeObjectState_ObjectState},
    metadata=None
)
