...
domain_model = DomainModel(
    name="persons",
    types={persons_Community, persons_Person, persons_TownHall, persons_NamedElement, persons_Facility, persons_SpecialFacility, Facility, persons_OrdinaryFacility, persons_Association, persons_Man, Person, persons_Woman, NamedElement, persons_Committee, persons_District},
    associations={persons0, townHalls1, facilities12, members14, associations3, workers5, committee8, districts10},
    generalizations={gen_persons_Committee_NamedElement, gen_persons_District_NamedElement, gen_persons_Facility_NamedElement, gen_persons_SpecialFacility_Facility, gen_persons_OrdinaryFacility_Facility, gen_persons_Man_Person, gen_persons_Woman_Person, gen_persons_TownHall_NamedElement, gen_persons_Association_NamedElement},
    metadata=None
)
