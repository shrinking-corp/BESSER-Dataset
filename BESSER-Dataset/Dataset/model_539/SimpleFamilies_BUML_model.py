...
# Classes
SimpleFamilies_FamilyRegister = Class(name="SimpleFamilies_FamilyRegister")
SimpleFamilies_Family = Class(name="SimpleFamilies_Family")
SimpleFamilies_FamilyMember = Class(name="SimpleFamilies_FamilyMember")
...
domain_model = DomainModel(
    ...
    associations={families0, father1, mother3, sons6, daughters9},
    generalizations={},
    metadata=None
)
