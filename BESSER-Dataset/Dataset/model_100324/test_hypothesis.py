...
def test_importnode_is_not_abstract():
    assert not inspect.isabstract(ImportNode)


def test_importnode_constructor_exists():
    assert callable(ImportNode.__init__)


def test_importnode_constructor_args():
    sig = inspect.signature(ImportNode.__init__)
    params = list(sig.parameters.keys())



def test_ncname_is_not_abstract():
    assert not inspect.isabstract(NCName)


def test_ncname_constructor_exists():
    assert callable(NCName.__init__)


def test_ncname_constructor_args():
