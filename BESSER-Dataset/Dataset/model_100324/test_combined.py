...
def test_hyp_pnml_pagegraphics_is_not_abstract():
    assert not inspect.isabstract(PNML_PageGraphics)


def test_hyp_pnml_pagegraphics_constructor_exists():
    assert callable(PNML_PageGraphics.__init__)


def test_hyp_pnml_pagegraphics_constructor_args():
...
def test_hyp_pnml_importnode_is_not_abstract():
    assert not inspect.isabstract(PNML_ImportNode)


def test_hyp_pnml_importnode_constructor_exists():
    assert callable(PNML_ImportNode.__init__)


def test_hyp_pnml_importnode_constructor_args():
    sig = inspect.signature(PNML_ImportNode.__init__)
    params = list(sig.parameters.keys())



def test_hyp_importnode_is_not_abstract():
    assert not inspect.isabstract(ImportNode)


def test_hyp_importnode_constructor_exists():
    assert callable(ImportNode.__init__)


def test_hyp_importnode_constructor_args():
    sig = inspect.signature(ImportNode.__init__)
    params = list(sig.parameters.keys())



def test_hyp_ncname_is_not_abstract():
    assert not inspect.isabstract(NCName)


def test_hyp_ncname_constructor_exists():
    assert callable(NCName.__init__)


def test_hyp_ncname_constructor_args():
    sig = inspect.signature(NCName.__init__)
    params = list(sig.parameters.keys())
...
def test_hyp_pagegraphics_is_not_abstract():
    assert not inspect.isabstract(PageGraphics)


def test_hyp_pagegraphics_constructor_exists():
    assert callable(PageGraphics.__init__)


def test_hyp_pagegraphics_constructor_args():
...
def test_hyp_pnml_reference_is_not_abstract():
    assert not inspect.isabstract(PNML_Reference)


def test_hyp_pnml_reference_constructor_exists():
    assert callable(PNML_Reference.__init__)


def test_hyp_pnml_reference_constructor_args():
    sig = inspect.signature(PNML_Reference.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pnml_interface_is_not_abstract():
    assert not inspect.isabstract(PNML_Interface)


def test_hyp_pnml_interface_constructor_exists():
    assert callable(PNML_Interface.__init__)


def test_hyp_pnml_interface_constructor_args():
...
def test_hyp_pnml_referencetransition_is_not_abstract():
    assert not inspect.isabstract(PNML_ReferenceTransition)


def test_hyp_pnml_referencetransition_constructor_exists():
    assert callable(PNML_ReferenceTransition.__init__)


def test_hyp_pnml_referencetransition_constructor_args():
    sig = inspect.signature(PNML_ReferenceTransition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pnml_referenceplace_is_not_abstract():
    assert not inspect.isabstract(PNML_ReferencePlace)


def test_hyp_pnml_referenceplace_constructor_exists():
    assert callable(PNML_ReferencePlace.__init__)


def test_hyp_pnml_referenceplace_constructor_args():
...
def test_hyp_pnml_page_is_not_abstract():
    assert not inspect.isabstract(PNML_Page)


def test_hyp_pnml_page_constructor_exists():
    assert callable(PNML_Page.__init__)


def test_hyp_pnml_page_constructor_args():
    sig = inspect.signature(PNML_Page.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pnml_instance_is_not_abstract():
    assert not inspect.isabstract(PNML_Instance)


def test_hyp_pnml_instance_constructor_exists():
    assert callable(PNML_Instance.__init__)


def test_hyp_pnml_instance_constructor_args():
...
def test_hyp_pnml_module_is_not_abstract():
    assert not inspect.isabstract(PNML_Module)


def test_hyp_pnml_module_constructor_exists():
    assert callable(PNML_Module.__init__)


def test_hyp_pnml_module_constructor_args():
...
def test_hyp_pnml_ncname_is_not_abstract():
    assert not inspect.isabstract(PNML_NCName)


def test_hyp_pnml_ncname_constructor_exists():
    assert callable(PNML_NCName.__init__)


def test_hyp_pnml_ncname_constructor_args():
...
def test_hyp_pnml_ncname_value_setter(instance):
