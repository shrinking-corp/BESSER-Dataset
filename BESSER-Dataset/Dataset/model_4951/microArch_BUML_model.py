...
micro_Service.attributes={micro_Service_fullname, micro_Service_description, micro_Service_shortname, micro_Service_port}
...
domain_model = DomainModel(
    name="micro",
    types={micro_Service, micro_Model, micro_Attribute, micro_ModelEvent, micro_MicroserviceArchitecture, NamedElement, micro_AggregateService, Service, micro_ViewService, micro_Event, micro_Saga, micro_NamedElement, micro_Command, micro_Operation, micro_API, micro_Step, micro_Data, micro_Info, micro_PrimitiveTypeAttribute, micro_ReferenceAttribute, Attribute, CRUDOperation, CommandType, AttributePrimitiveValue},
    associations={services0, models1, attributes3, aggregateService6, model4, replicateServices17, publish19, Saga20, model22, aggregateService25, events27, commands28, modelEvents7, operation8, api10, handleModelEvents11, models14, api33, api34, dto36, api39, commands41, Steps43, Data46, infos30, replyInfo32, ModelToView51, model48, type49},
    generalizations={gen_micro_Service_NamedElement, gen_micro_Model_NamedElement, gen_micro_ModelEvent_NamedElement, gen_micro_MicroserviceArchitecture_NamedElement, gen_micro_AggregateService_Service, gen_micro_ViewService_Service, gen_micro_Operation_NamedElement, gen_micro_API_NamedElement, gen_micro_Event_NamedElement, gen_micro_Info_NamedElement, gen_micro_Step_NamedElement, gen_micro_Saga_NamedElement, gen_micro_Data_NamedElement, gen_micro_Command_NamedElement, gen_micro_PrimitiveTypeAttribute_Attribute, gen_micro_ReferenceAttribute_Attribute},
    metadata=None
)
