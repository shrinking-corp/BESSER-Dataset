...
class micro_Operation(NamedElement):
    ...
    def __init__(self, operationType: str, isMethodController: bool, micro_Operation21: "micro_Saga" = None, micro_Operation23: "micro_Model" = None, operation: "micro_AggregateService" = None, Operation: "micro_AggregateService" = None, micro_Operation: "micro_Event" = None):
...
class micro_Command(NamedElement):
    ...
    def __init__(self, commandType: str, isReplyInfoMany: bool, Command: "micro_API" = None, commands: "micro_API" = None, micro_Command42: "micro_Step" = None, micro_Command: "micro_Info" = None):
...
class micro_AggregateService(Service):
    ...
    def __init__(self, AggregateService26: "micro_Operation" = None, aggregateService: set["micro_ModelEvent"] = None, aggregateService9: set["micro_Operation"] = None, micro_AggregateService: "micro_API" = None, micro_AggregateService12: set["micro_ModelEvent"] = None, micro_AggregateService15: set["micro_Model"] = None, AggregateService: "micro_ModelEvent" = None, micro_AggregateService18: "micro_ViewService" = None):
    ...
    def ReferenceModelsIncluded(self) :
