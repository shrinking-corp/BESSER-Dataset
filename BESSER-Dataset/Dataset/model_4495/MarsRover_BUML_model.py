...
# Classes
marsRover_Robot = Class(name="marsRover_Robot")
marsRover_after_action = Class(name="marsRover_after_action")
marsRover_detect_rocks = Class(name="marsRover_detect_rocks")
marsRover_push_obstacles = Class(name="marsRover_push_obstacles")
marsRover_indication = Class(name="marsRover_indication")
marsRover_mission = Class(name="marsRover_mission")
marsRover_EObject = Class(name="marsRover_EObject")
marsRover_avoid_obstacles = Class(name="marsRover_avoid_obstacles")
marsRover_ultra = Class(name="marsRover_ultra")
marsRover_bumpers = Class(name="marsRover_bumpers")
marsRover_detect_lakes = Class(name="marsRover_detect_lakes")
marsRover_avoid_lakes = Class(name="marsRover_avoid_lakes")
marsRover_sound = Class(name="marsRover_sound")
marsRover_message = Class(name="marsRover_message")
marsRover_color_indication = Class(name="marsRover_color_indication")
marsRover_park = Class(name="marsRover_park")
...
marsRover_Robot.attributes={marsRover_Robot_special_speed, marsRover_Robot_name, marsRover_Robot_slave_address, marsRover_Robot_drive_speed}
...
marsRover_detect_rocks.attributes={marsRover_detect_rocks_name, marsRover_detect_rocks_number_of_rocks}
...
marsRover_ultra.attributes={marsRover_ultra_distance, marsRover_ultra_name}
...
marsRover_detect_lakes.attributes={marsRover_detect_lakes_name, marsRover_detect_lakes_lakes_colors, marsRover_detect_lakes_number_of_lakes}
...
marsRover_sound.attributes={marsRover_sound_duration, marsRover_sound_name, marsRover_sound_frequency}
...
marsRover_message.attributes={marsRover_message_msg, marsRover_message_name}
...
domain_model = DomainModel(
    name="marsRover",
    types={marsRover_Robot, marsRover_after_action, marsRover_detect_rocks, marsRover_push_obstacles, marsRover_indication, marsRover_mission, marsRover_EObject, marsRover_avoid_obstacles, marsRover_ultra, marsRover_bumpers, marsRover_detect_lakes, marsRover_avoid_lakes, marsRover_sound, marsRover_message, marsRover_color_indication, marsRover_park, Color, LED_Color},
    associations={after_examinating5, after_examinating6, indicate8, missions0, type1, sensors3, type10},
    generalizations={},
    metadata=None
)
