...
# Classes
Triangles_Container = Class(name="Triangles_Container")
Triangles_A_Class = Class(name="Triangles_A_Class")
Triangles_D_Class = Class(name="Triangles_D_Class")
Triangles_E_Class = Class(name="Triangles_E_Class")
AbstractClass = Class(name="AbstractClass")
Triangles_AbstractClass = Class(name="Triangles_AbstractClass", is_abstract=True)
Triangles_B_Class = Class(name="Triangles_B_Class")
Triangles_C_Class = Class(name="Triangles_C_Class")
...
Triangles_AbstractClass.attributes={Triangles_AbstractClass_id, Triangles_AbstractClass_name, Triangles_AbstractClass_flag}
...
domain_model = DomainModel(
    name="Triangles",
    types={Triangles_Container, Triangles_A_Class, Triangles_D_Class, Triangles_E_Class, AbstractClass, Triangles_AbstractClass, Triangles_B_Class, Triangles_C_Class},
    associations={a0, d5, e7, b9, c10, a12, c13, a16, b18, b21, a24, b1, c3},
