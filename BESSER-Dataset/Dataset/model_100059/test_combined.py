...
def test_hyp_itm_issue_is_not_abstract():
    assert not inspect.isabstract(itm_Issue)


def test_hyp_itm_issue_constructor_exists():
    assert callable(itm_Issue.__init__)


def test_hyp_itm_issue_constructor_args():
...
def test_hyp_itm_issuedependency_is_not_abstract():
    assert not inspect.isabstract(itm_IssueDependency)


def test_hyp_itm_issuedependency_constructor_exists():
    assert callable(itm_IssueDependency.__init__)


def test_hyp_itm_issuedependency_constructor_args():
...
def test_hyp_itm_issuetrackingdatabase_is_not_abstract():
    assert not inspect.isabstract(itm_IssueTrackingDatabase)


def test_hyp_itm_issuetrackingdatabase_constructor_exists():
    assert callable(itm_IssueTrackingDatabase.__init__)


def test_hyp_itm_issuetrackingdatabase_constructor_args():
    sig = inspect.signature(itm_IssueTrackingDatabase.__init__)
    params = list(sig.parameters.keys())



def test_hyp_itm_member_is_not_abstract():
    assert not inspect.isabstract(itm_Member)


def test_hyp_itm_member_constructor_exists():
    assert callable(itm_Member.__init__)


def test_hyp_itm_member_constructor_args():
    sig = inspect.signature(itm_Member.__init__)
    params = list(sig.parameters.keys())



def test_hyp_itm_issuecategory_is_not_abstract():
    assert not inspect.isabstract(itm_IssueCategory)


def test_hyp_itm_issuecategory_constructor_exists():
    assert callable(itm_IssueCategory.__init__)


def test_hyp_itm_issuecategory_constructor_args():
...
def test_hyp_itm_version_is_not_abstract():
    assert not inspect.isabstract(itm_Version)


def test_hyp_itm_version_constructor_exists():
    assert callable(itm_Version.__init__)


def test_hyp_itm_version_constructor_args():
...
def test_hyp_itm_user_is_not_abstract():
    assert not inspect.isabstract(itm_User)


def test_hyp_itm_user_constructor_exists():
    assert callable(itm_User.__init__)


def test_hyp_itm_user_constructor_args():
...
def test_hyp_itm_role_is_not_abstract():
    assert not inspect.isabstract(itm_Role)


def test_hyp_itm_role_constructor_exists():
    assert callable(itm_Role.__init__)


def test_hyp_itm_role_constructor_args():
...
def test_hyp_itm_tracker_is_not_abstract():
    assert not inspect.isabstract(itm_Tracker)


def test_hyp_itm_tracker_constructor_exists():
    assert callable(itm_Tracker.__init__)


def test_hyp_itm_tracker_constructor_args():
...
def test_hyp_itm_project_is_not_abstract():
    assert not inspect.isabstract(itm_Project)


def test_hyp_itm_project_constructor_exists():
    assert callable(itm_Project.__init__)


def test_hyp_itm_project_constructor_args():
...
def test_hyp_issuepriority_exists():
    # Check that the Enumeration exists
    assert IssuePriority is not None

def test_hyp_issuepriority_has_all_literals():
...
def test_hyp_dependencytype_exists():
    # Check that the Enumeration exists
    assert DependencyType is not None

def test_hyp_dependencytype_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_itm_issue_description_setter(instance):
...
@given(instance=itm_Issue_strategy)
def test_hyp_itm_issue_doneRatio_setter(instance):
...
@given(instance=itm_Issue_strategy)
def test_hyp_itm_issue_completedDate_setter(instance):
...
@given(instance=itm_Issue_strategy)
def test_hyp_itm_issue_estimatedHours_setter(instance):
...
@given(instance=itm_Issue_strategy)
def test_hyp_itm_issue_elapsedHours_setter(instance):
...
@given(instance=itm_Issue_strategy)
def test_hyp_itm_issue_priority_setter(instance):
...
@given(instance=itm_Issue_strategy)
def test_hyp_itm_issue_dueDate_setter(instance):
...
@given(instance=itm_Issue_strategy)
def test_hyp_itm_issue_status_setter(instance):
...
@given(instance=itm_Issue_strategy)
def test_hyp_itm_issue_name_setter(instance):
...
def test_hyp_itm_issuedependency_type_setter(instance):
...
def test_hyp_itm_issuecategory_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_itm_version_status_setter(instance):
    original = instance.status
    instance.status = original
    assert instance.status == original
...
@given(instance=itm_Version_strategy)
def test_hyp_itm_version_description_setter(instance):
    original = instance.description
    instance.description = original
    assert instance.description == original
...
@given(instance=itm_Version_strategy)
def test_hyp_itm_version_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=itm_Version_strategy)
def test_hyp_itm_version_completedDate_setter(instance):
    original = instance.completedDate
    instance.completedDate = original
    assert instance.completedDate == original
...
def test_hyp_itm_user_login_setter(instance):
...
@given(instance=itm_User_strategy)
def test_hyp_itm_user_language_setter(instance):
...
def test_hyp_itm_role_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=itm_Role_strategy)
def test_hyp_itm_role_permissions_setter(instance):
...
def test_hyp_itm_tracker_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_itm_project_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=itm_Project_strategy)
def test_hyp_itm_project_description_setter(instance):
    original = instance.description
    instance.description = original
    assert instance.description == original
