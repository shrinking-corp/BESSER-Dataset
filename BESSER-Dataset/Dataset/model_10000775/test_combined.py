...
def test_hyp_shoppincart_is_not_abstract():
    assert not inspect.isabstract(ShoppinCart)


def test_hyp_shoppincart_constructor_exists():
    assert callable(ShoppinCart.__init__)


def test_hyp_shoppincart_constructor_args():
...
def test_hyp_shoppincart_creationDate_setter(instance):
...
@given(instance=MyClass_strategy)
def test_hyp_myclass_attribute6_setter(instance):
...
@given(instance=MyClass_strategy)
def test_hyp_myclass_attribute7_setter(instance):
...
@given(instance=MyClass_strategy)
def test_hyp_myclass_attribute5_setter(instance):
...
def test_hyp_product_attribute3_setter(instance):
    original = instance.attribute3
    instance.attribute3 = original
    assert instance.attribute3 == original
...
@given(instance=Product_strategy)
def test_hyp_product_attribute2_setter(instance):
    original = instance.attribute2
    instance.attribute2 = original
    assert instance.attribute2 == original
...
@given(instance=Product_strategy)
def test_hyp_product_attribute4_setter(instance):
    original = instance.attribute4
    instance.attribute4 = original
    assert instance.attribute4 == original
...
@given(instance=Product_strategy)
def test_hyp_product_attribute8_setter(instance):
...
def test_MyClass_attribute_value_roundtrip():
    instance = MyClass(attribute="sample_text", attribute2="sample_text", attribute3="sample_text", attribute4="sample_text", attribute5="sample_text", attribute6="sample_text", attribute7="sample_text")
...
def test_MyClass_attribute5_value_roundtrip():
    instance = MyClass(attribute="sample_text", attribute2="sample_text", attribute3="sample_text", attribute4="sample_text", attribute5="sample_text", attribute6="sample_text", attribute7="sample_text")
...
def test_MyClass_attribute6_value_roundtrip():
    instance = MyClass(attribute="sample_text", attribute2="sample_text", attribute3="sample_text", attribute4="sample_text", attribute5="sample_text", attribute6="sample_text", attribute7="sample_text")
...
def test_MyClass_attribute7_value_roundtrip():
    instance = MyClass(attribute="sample_text", attribute2="sample_text", attribute3="sample_text", attribute4="sample_text", attribute5="sample_text", attribute6="sample_text", attribute7="sample_text")
...
def test_Product_attribute_value_roundtrip():
    instance = Product(attribute="sample_text", attribute2="sample_text", attribute3="sample_text", attribute4="sample_text", attribute5="sample_text", attribute6="sample_text", attribute7="sample_text", attribute8="sample_text", description="sample_text", name="sample_text")
    assert instance.attribute == "sample_text"
    instance.attribute = "sample_text_2"
    assert instance.attribute == "sample_text_2"


def test_Product_attribute2_value_roundtrip():
    instance = Product(attribute="sample_text", attribute2="sample_text", attribute3="sample_text", attribute4="sample_text", attribute5="sample_text", attribute6="sample_text", attribute7="sample_text", attribute8="sample_text", description="sample_text", name="sample_text")
    assert instance.attribute2 == "sample_text"
    instance.attribute2 = "sample_text_2"
    assert instance.attribute2 == "sample_text_2"
...
def test_Product_attribute3_value_roundtrip():
    instance = Product(attribute="sample_text", attribute2="sample_text", attribute3="sample_text", attribute4="sample_text", attribute5="sample_text", attribute6="sample_text", attribute7="sample_text", attribute8="sample_text", description="sample_text", name="sample_text")
    assert instance.attribute3 == "sample_text"
    instance.attribute3 = "sample_text_2"
    assert instance.attribute3 == "sample_text_2"
...
def test_Product_attribute4_value_roundtrip():
    instance = Product(attribute="sample_text", attribute2="sample_text", attribute3="sample_text", attribute4="sample_text", attribute5="sample_text", attribute6="sample_text", attribute7="sample_text", attribute8="sample_text", description="sample_text", name="sample_text")
    assert instance.attribute4 == "sample_text"
    instance.attribute4 = "sample_text_2"
    assert instance.attribute4 == "sample_text_2"
...
def test_Product_attribute8_value_roundtrip():
    instance = Product(attribute="sample_text", attribute2="sample_text", attribute3="sample_text", attribute4="sample_text", attribute5="sample_text", attribute6="sample_text", attribute7="sample_text", attribute8="sample_text", description="sample_text", name="sample_text")
...
def test_ShoppinCart_creationDate_value_roundtrip():
    instance = ShoppinCart(creationDate=date(2024, 1, 1))
...
def test_assoc_Account_Payment_link_reassign_clear():
    ...
    _safe_set(a, 'account1', b1)
    assert _is_linked(a, 'account1', b1)
    if hasattr(b1, 'payment0'):
        assert _is_linked(b1, 'payment0', a)
    _safe_set(a, 'account1', b2)
    assert _is_linked(a, 'account1', b2)
    if hasattr(b1, 'payment0'):
        assert not _is_linked(b1, 'payment0', a)
    if hasattr(b2, 'payment0'):
        assert _is_linked(b2, 'payment0', a)
    _safe_set(a, 'account1', None)
    assert not _is_linked(a, 'account1', b2)
    if hasattr(b2, 'payment0'):
        assert not _is_linked(b2, 'payment0', a)


def test_assoc_Account_ShoppinCart_link_reassign_clear():
    a = ShoppinCart(creationDate=date(2024, 1, 1))
    b1 = Account(billingAddress="sample_text", closed=date(2024, 1, 1), isClosed=True, open=date(2024, 1, 1))
    b2 = Account(billingAddress="sample_text_2", closed=date(2025, 6, 15), isClosed=False, open=date(2025, 6, 15))
    _safe_set(a, 'account17', b1)
    assert _is_linked(a, 'account17', b1)
    if hasattr(b1, 'cart16'):
        assert _is_linked(b1, 'cart16', a)
    _safe_set(a, 'account17', b2)
    assert _is_linked(a, 'account17', b2)
    if hasattr(b1, 'cart16'):
        assert not _is_linked(b1, 'cart16', a)
    if hasattr(b2, 'cart16'):
        assert _is_linked(b2, 'cart16', a)
    _safe_set(a, 'account17', None)
    assert not _is_linked(a, 'account17', b2)
    if hasattr(b2, 'cart16'):
        assert not _is_linked(b2, 'cart16', a)
...
def test_assoc_Customer_Account_link_reassign_clear():
    ...
    b1 = Account(billingAddress="sample_text", closed=date(2024, 1, 1), isClosed=True, open=date(2024, 1, 1))
    b2 = Account(billingAddress="sample_text_2", closed=date(2025, 6, 15), isClosed=False, open=date(2025, 6, 15))
    _safe_set(a, 'acc10', b1)
    assert _is_linked(a, 'acc10', b1)
    if hasattr(b1, 'customer11'):
        assert _is_linked(b1, 'customer11', a)
    _safe_set(a, 'acc10', b2)
    assert _is_linked(a, 'acc10', b2)
    if hasattr(b1, 'customer11'):
        assert not _is_linked(b1, 'customer11', a)
    if hasattr(b2, 'customer11'):
        assert _is_linked(b2, 'customer11', a)
    _safe_set(a, 'acc10', None)
    assert not _is_linked(a, 'acc10', b2)
    if hasattr(b2, 'customer11'):
        assert not _is_linked(b2, 'customer11', a)


def test_assoc_Product_LineItem_link_reassign_clear():
    a = Product(attribute="sample_text", attribute2="sample_text", attribute3="sample_text", attribute4="sample_text", attribute5="sample_text", attribute6="sample_text", attribute7="sample_text", attribute8="sample_text", description="sample_text", name="sample_text")
...
def test_assoc_ShoppinCart_LineItem_link_reassign_clear():
    a = ShoppinCart(creationDate=date(2024, 1, 1))
    b1 = LineItem(price=3.14, quantity=7)
    b2 = LineItem(price=9.99, quantity=13)
    _safe_set(a, 'items18', {b1})
    assert _is_linked(a, 'items18', b1)
    if hasattr(b1, 'sc19'):
        assert _is_linked(b1, 'sc19', a)
    _safe_set(a, 'items18', {b2})
    assert _is_linked(a, 'items18', b2)
    if hasattr(b1, 'sc19'):
        assert not _is_linked(b1, 'sc19', a)
    if hasattr(b2, 'sc19'):
        assert _is_linked(b2, 'sc19', a)
    _safe_set(a, 'items18', set())
    assert not _is_linked(a, 'items18', b2)
    if hasattr(b2, 'sc19'):
        assert not _is_linked(b2, 'sc19', a)
...
MyClass_strategy = st.builds(MyClass, attribute=safe_text, attribute2=safe_text, attribute3=safe_text, attribute4=safe_text, attribute5=safe_text, attribute6=safe_text, attribute7=safe_text)
@given(instance=MyClass_strategy)
@settings(max_examples=25)
...
Product_strategy = st.builds(Product, attribute=safe_text, attribute2=safe_text, attribute3=safe_text, attribute4=safe_text, attribute5=safe_text, attribute6=safe_text, attribute7=safe_text, attribute8=safe_text, description=safe_text, name=safe_text)
@given(instance=Product_strategy)
@settings(max_examples=25)
...
ShoppinCart_strategy = st.builds(ShoppinCart, creationDate=st.dates())
@given(instance=ShoppinCart_strategy)
@settings(max_examples=25)
