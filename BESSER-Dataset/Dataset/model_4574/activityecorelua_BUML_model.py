...
# Classes
activityecorelua_EAttribute = Class(name="activityecorelua_EAttribute")
EStructuralFeature = Class(name="EStructuralFeature")
activityecorelua_EDataType = Class(name="activityecorelua_EDataType")
activityecorelua_EAnnotation = Class(name="activityecorelua_EAnnotation")
EModelElement = Class(name="EModelElement")
activityecorelua_EStringToStringMapEntry = Class(name="activityecorelua_EStringToStringMapEntry")
activityecorelua_EModelElement = Class(name="activityecorelua_EModelElement", is_abstract=True)
activityecorelua_EObject = Class(name="activityecorelua_EObject")
activityecorelua_EClass = Class(name="activityecorelua_EClass")
EClassifier = Class(name="EClassifier")
activityecorelua_EStructuralFeature = Class(name="activityecorelua_EStructuralFeature", is_abstract=True)
activityecorelua_EOperation = Class(name="activityecorelua_EOperation")
activityecorelua_EReference = Class(name="activityecorelua_EReference")
activityecorelua_EGenericType = Class(name="activityecorelua_EGenericType")
activityecorelua_EClassifier = Class(name="activityecorelua_EClassifier", is_abstract=True)
ENamedElement = Class(name="ENamedElement")
activityecorelua_EEnum = Class(name="activityecorelua_EEnum")
EDataType = Class(name="EDataType")
activityecorelua_EEnumLiteral = Class(name="activityecorelua_EEnumLiteral")
activityecorelua_EPackage = Class(name="activityecorelua_EPackage")
activityecorelua_ETypeParameter = Class(name="activityecorelua_ETypeParameter")
activityecorelua_ENamedElement = Class(name="activityecorelua_ENamedElement", is_abstract=True)
activityecorelua_EFactory = Class(name="activityecorelua_EFactory")
activityecorelua_EParameter = Class(name="activityecorelua_EParameter")
activityecorelua_Activity = Class(name="activityecorelua_Activity")
ETypedElement = Class(name="ETypedElement")
activityecorelua_ETypedElement = Class(name="activityecorelua_ETypedElement", is_abstract=True)
NamedElement = Class(name="NamedElement")
activityecorelua_ActivityNode = Class(name="activityecorelua_ActivityNode", is_abstract=True)
activityecorelua_ActivityEdge = Class(name="activityecorelua_ActivityEdge", is_abstract=True)
activityecorelua_Variable = Class(name="activityecorelua_Variable", is_abstract=True)
activityecorelua_NamedElement = Class(name="activityecorelua_NamedElement", is_abstract=True)
activityecorelua_InitialNode = Class(name="activityecorelua_InitialNode")
ControlNode = Class(name="ControlNode")
activityecorelua_FinalNode = Class(name="activityecorelua_FinalNode", is_abstract=True)
activityecorelua_ActivityFinalNode = Class(name="activityecorelua_ActivityFinalNode")
FinalNode = Class(name="FinalNode")
activityecorelua_ForkNode = Class(name="activityecorelua_ForkNode")
activityecorelua_ControlFlow = Class(name="activityecorelua_ControlFlow")
ActivityEdge = Class(name="ActivityEdge")
activityecorelua_BooleanVariable = Class(name="activityecorelua_BooleanVariable")
activityecorelua_ControlNode = Class(name="activityecorelua_ControlNode", is_abstract=True)
ActivityNode = Class(name="ActivityNode")
activityecorelua_ExecutableNode = Class(name="activityecorelua_ExecutableNode", is_abstract=True)
activityecorelua_Action = Class(name="activityecorelua_Action", is_abstract=True)
ExecutableNode = Class(name="ExecutableNode")
activityecorelua_OpaqueAction = Class(name="activityecorelua_OpaqueAction")
Action = Class(name="Action")
activityecorelua_Expression = Class(name="activityecorelua_Expression")
activityecorelua_JoinNode = Class(name="activityecorelua_JoinNode")
activityecorelua_BooleanValue = Class(name="activityecorelua_BooleanValue")
Value = Class(name="Value")
activityecorelua_IntegerValue = Class(name="activityecorelua_IntegerValue")
activityecorelua_InputValue = Class(name="activityecorelua_InputValue")
activityecorelua_Input = Class(name="activityecorelua_Input")
activityecorelua_MergeNode = Class(name="activityecorelua_MergeNode")
activityecorelua_DecisionNode = Class(name="activityecorelua_DecisionNode")
activityecorelua_Value = Class(name="activityecorelua_Value", is_abstract=True)
activityecorelua_IntegerVariable = Class(name="activityecorelua_IntegerVariable")
Variable = Class(name="Variable")
activityecorelua_Statement_Block = Class(name="activityecorelua_Statement_Block")
Statement = Class(name="Statement")
activityecorelua_Statement_While = Class(name="activityecorelua_Statement_While")
activityecorelua_Statement_Repeat = Class(name="activityecorelua_Statement_Repeat")
activityecorelua_Statement_If_Then_Else = Class(name="activityecorelua_Statement_If_Then_Else")
activityecorelua_Chunk = Class(name="activityecorelua_Chunk")
activityecorelua_Block = Class(name="activityecorelua_Block")
Chunk = Class(name="Chunk")
activityecorelua_Statement = Class(name="activityecorelua_Statement")
activityecorelua_LastStatement = Class(name="activityecorelua_LastStatement")
activityecorelua_LastStatement_Return = Class(name="activityecorelua_LastStatement_Return")
LastStatement = Class(name="LastStatement")
activityecorelua_LastStatement_Break = Class(name="activityecorelua_LastStatement_Break")
activityecorelua_Statement_For_Generic = Class(name="activityecorelua_Statement_For_Generic")
activityecorelua_Statement_GlobalFunction_Declaration = Class(name="activityecorelua_Statement_GlobalFunction_Declaration")
activityecorelua_Function = Class(name="activityecorelua_Function")
activityecorelua_Statement_LocalFunction_Declaration = Class(name="activityecorelua_Statement_LocalFunction_Declaration")
activityecorelua_Statement_If_Then_Else_ElseIfPart = Class(name="activityecorelua_Statement_If_Then_Else_ElseIfPart")
activityecorelua_Statement_Local_Variable_Declaration = Class(name="activityecorelua_Statement_Local_Variable_Declaration")
activityecorelua_Statement_FunctioncallOrAssignment = Class(name="activityecorelua_Statement_FunctioncallOrAssignment")
Statement_FunctioncallOrAssignment = Class(name="Statement_FunctioncallOrAssignment")
activityecorelua_Statement_For_Numeric = Class(name="activityecorelua_Statement_For_Numeric")
activityecorelua_Expression_Nil = Class(name="activityecorelua_Expression_Nil")
Expression = Class(name="Expression")
activityecorelua_Expression_True = Class(name="activityecorelua_Expression_True")
activityecorelua_Expression_False = Class(name="activityecorelua_Expression_False")
activityecorelua_Expression_Number = Class(name="activityecorelua_Expression_Number")
activityecorelua_Expression_Function = Class(name="activityecorelua_Expression_Function")
activityecorelua_Expression_TableConstructor = Class(name="activityecorelua_Expression_TableConstructor")
activityecorelua_Field = Class(name="activityecorelua_Field")
activityecorelua_Functioncall_Arguments = Class(name="activityecorelua_Functioncall_Arguments")
activityecorelua_Field_AddEntryToTable_Brackets = Class(name="activityecorelua_Field_AddEntryToTable_Brackets")
Field = Class(name="Field")
activityecorelua_Field_AddEntryToTable = Class(name="activityecorelua_Field_AddEntryToTable")
activityecorelua_Field_AppendEntryToTable = Class(name="activityecorelua_Field_AppendEntryToTable")
activityecorelua_LastStatement_ReturnWithValue = Class(name="activityecorelua_LastStatement_ReturnWithValue")
LastStatement_Return = Class(name="LastStatement_Return")
activityecorelua_Statement_Assignment = Class(name="activityecorelua_Statement_Assignment")
activityecorelua_Expression_VarArgs = Class(name="activityecorelua_Expression_VarArgs")
activityecorelua_Expression_String = Class(name="activityecorelua_Expression_String")
activityecorelua_Statement_CallMemberFunction = Class(name="activityecorelua_Statement_CallMemberFunction")
activityecorelua_Statement_CallFunction = Class(name="activityecorelua_Statement_CallFunction")
activityecorelua_Expression_Or = Class(name="activityecorelua_Expression_Or")
activityecorelua_Expression_And = Class(name="activityecorelua_Expression_And")
activityecorelua_Expression_Larger = Class(name="activityecorelua_Expression_Larger")
activityecorelua_Expression_Larger_Equal = Class(name="activityecorelua_Expression_Larger_Equal")
activityecorelua_Expression_Smaller = Class(name="activityecorelua_Expression_Smaller")
activityecorelua_Expression_Smaller_Equal = Class(name="activityecorelua_Expression_Smaller_Equal")
activityecorelua_Expression_Equal = Class(name="activityecorelua_Expression_Equal")
activityecorelua_Expression_Not_Equal = Class(name="activityecorelua_Expression_Not_Equal")
activityecorelua_Expression_Concatenation = Class(name="activityecorelua_Expression_Concatenation")
activityecorelua_Expression_Plus = Class(name="activityecorelua_Expression_Plus")
activityecorelua_Expression_Minus = Class(name="activityecorelua_Expression_Minus")
activityecorelua_Expression_Multiplication = Class(name="activityecorelua_Expression_Multiplication")
activityecorelua_Expression_Division = Class(name="activityecorelua_Expression_Division")
activityecorelua_Expression_Modulo = Class(name="activityecorelua_Expression_Modulo")
activityecorelua_Expression_Negate = Class(name="activityecorelua_Expression_Negate")
activityecorelua_Expression_Length = Class(name="activityecorelua_Expression_Length")
activityecorelua_Expression_Invert = Class(name="activityecorelua_Expression_Invert")
activityecorelua_Expression_Exponentiation = Class(name="activityecorelua_Expression_Exponentiation")
activityecorelua_Expression_CallMemberFunction = Class(name="activityecorelua_Expression_CallMemberFunction")
activityecorelua_Expression_CallFunction = Class(name="activityecorelua_Expression_CallFunction")
activityecorelua_Expression_AccessArray = Class(name="activityecorelua_Expression_AccessArray")
activityecorelua_Expression_AccessMember = Class(name="activityecorelua_Expression_AccessMember")
activityecorelua_Expression_VariableName = Class(name="activityecorelua_Expression_VariableName")
...
activityecorelua_EStringToStringMapEntry.attributes={activityecorelua_EStringToStringMapEntry_value, activityecorelua_EStringToStringMapEntry_key}

# activityecorelua_EModelElement class attributes and methods
activityecorelua_EModelElement_m_getEAnnotation: Method = Method(name="getEAnnotation", parameters={Parameter(name='activityecorelua_source', type=StringType)}, type=StringType)
...
activityecorelua_EClass_m_isSuperTypeOf: Method = Method(name="isSuperTypeOf", parameters={Parameter(name='activityecorelua_someClass', type=StringType)}, type=BooleanType)
activityecorelua_EClass_m_getFeatureCount: Method = Method(name="getFeatureCount", parameters={}, type=IntegerType)
activityecorelua_EClass_m_getEStructuralFeature: Method = Method(name="getEStructuralFeature", parameters={Parameter(name='activityecorelua_featureID', type=StringType)}, type=EStructuralFeature)
activityecorelua_EClass_m_getFeatureID: Method = Method(name="getFeatureID", parameters={Parameter(name='activityecorelua_feature', type=StringType)}, type=IntegerType)
activityecorelua_EClass_m_getEStructuralFeature: Method = Method(name="getEStructuralFeature", parameters={Parameter(name='activityecorelua_featureName', type=StringType)}, type=EStructuralFeature)
activityecorelua_EClass_m_getOperationCount: Method = Method(name="getOperationCount", parameters={}, type=IntegerType)
activityecorelua_EClass_m_getEOperation: Method = Method(name="getEOperation", parameters={Parameter(name='activityecorelua_operationID', type=StringType)}, type=StringType)
activityecorelua_EClass_m_getOperationID: Method = Method(name="getOperationID", parameters={Parameter(name='activityecorelua_operation', type=StringType)}, type=IntegerType)
activityecorelua_EClass_m_getOverride: Method = Method(name="getOverride", parameters={Parameter(name='activityecorelua_operation', type=StringType)}, type=StringType)
activityecorelua_EClass.attributes={activityecorelua_EClass_abstract, activityecorelua_EClass_interface}
activityecorelua_EClass.methods={activityecorelua_EClass_m_getOperationID, activityecorelua_EClass_m_getFeatureID, activityecorelua_EClass_m_getEStructuralFeature, activityecorelua_EClass_m_getEStructuralFeature, activityecorelua_EClass_m_getEOperation, activityecorelua_EClass_m_getFeatureCount, activityecorelua_EClass_m_getOperationCount, activityecorelua_EClass_m_getOverride, activityecorelua_EClass_m_isSuperTypeOf}
...
activityecorelua_EStructuralFeature.attributes={activityecorelua_EStructuralFeature_changeable, activityecorelua_EStructuralFeature_volatile, activityecorelua_EStructuralFeature_unsettable, activityecorelua_EStructuralFeature_defaultValue, activityecorelua_EStructuralFeature_defaultValueLiteral, activityecorelua_EStructuralFeature_derived, activityecorelua_EStructuralFeature_transient}
...
activityecorelua_EOperation_m_isOverrideOf: Method = Method(name="isOverrideOf", parameters={Parameter(name='activityecorelua_someOperation', type=StringType)}, type=BooleanType)
...
activityecorelua_EClassifier_m_isInstance: Method = Method(name="isInstance", parameters={Parameter(name='activityecorelua_object', type=StringType)}, type=BooleanType)
activityecorelua_EClassifier_m_getClassifierID: Method = Method(name="getClassifierID", parameters={}, type=IntegerType)
activityecorelua_EClassifier.attributes={activityecorelua_EClassifier_defaultValue, activityecorelua_EClassifier_instanceClass, activityecorelua_EClassifier_instanceClassName, activityecorelua_EClassifier_instanceTypeName}
activityecorelua_EClassifier.methods={activityecorelua_EClassifier_m_getClassifierID, activityecorelua_EClassifier_m_isInstance}

# ENamedElement class attributes and methods

# activityecorelua_EEnum class attributes and methods
activityecorelua_EEnum_m_getEEnumLiteral: Method = Method(name="getEEnumLiteral", parameters={Parameter(name='activityecorelua_name', type=StringType)}, type=StringType)
activityecorelua_EEnum_m_getEEnumLiteral: Method = Method(name="getEEnumLiteral", parameters={Parameter(name='activityecorelua_value', type=StringType)}, type=StringType)
activityecorelua_EEnum_m_getEEnumLiteralByLiteral: Method = Method(name="getEEnumLiteralByLiteral", parameters={Parameter(name='activityecorelua_literal', type=StringType)}, type=StringType)
activityecorelua_EEnum.methods={activityecorelua_EEnum_m_getEEnumLiteral, activityecorelua_EEnum_m_getEEnumLiteralByLiteral, activityecorelua_EEnum_m_getEEnumLiteral}
...
activityecorelua_EEnumLiteral.attributes={activityecorelua_EEnumLiteral_literal, activityecorelua_EEnumLiteral_value, activityecorelua_EEnumLiteral_instance}
...
activityecorelua_EPackage_m_getEClassifier: Method = Method(name="getEClassifier", parameters={Parameter(name='activityecorelua_name', type=StringType)}, type=EClassifier)
activityecorelua_EPackage.attributes={activityecorelua_EPackage_nsURI, activityecorelua_EPackage_nsPrefix}
...
activityecorelua_EFactory_m_convertToString: Method = Method(name="convertToString", parameters={Parameter(name='activityecorelua_instanceValue', type=StringType), Parameter(name='activityecorelua_eDataType', type=StringType)}, type=StringType)
activityecorelua_EFactory_m_create: Method = Method(name="create", parameters={Parameter(name='activityecorelua_eClass', type=StringType)}, type=StringType)
activityecorelua_EFactory_m_createFromString: Method = Method(name="createFromString", parameters={Parameter(name='activityecorelua_literalValue', type=StringType), Parameter(name='activityecorelua_eDataType', type=StringType)}, type=StringType)
activityecorelua_EFactory.methods={activityecorelua_EFactory_m_createFromString, activityecorelua_EFactory_m_create, activityecorelua_EFactory_m_convertToString}
...
activityecorelua_ETypedElement.attributes={activityecorelua_ETypedElement_upperBound, activityecorelua_ETypedElement_lowerBound, activityecorelua_ETypedElement_required, activityecorelua_ETypedElement_unique, activityecorelua_ETypedElement_ordered, activityecorelua_ETypedElement_many}
...
activityecorelua_Statement_GlobalFunction_Declaration.attributes={activityecorelua_Statement_GlobalFunction_Declaration_functionName, activityecorelua_Statement_GlobalFunction_Declaration_prefix}
...
domain_model = DomainModel(
    ...
    types={activityecorelua_EAttribute, EStructuralFeature, activityecorelua_EDataType, activityecorelua_EAnnotation, EModelElement, activityecorelua_EStringToStringMapEntry, activityecorelua_EModelElement, activityecorelua_EObject, activityecorelua_EClass, EClassifier, activityecorelua_EStructuralFeature, activityecorelua_EOperation, activityecorelua_EReference, activityecorelua_EGenericType, activityecorelua_EClassifier, ENamedElement, activityecorelua_EEnum, EDataType, activityecorelua_EEnumLiteral, activityecorelua_EPackage, activityecorelua_ETypeParameter, activityecorelua_ENamedElement, activityecorelua_EFactory, activityecorelua_EParameter, activityecorelua_Activity, ETypedElement, activityecorelua_ETypedElement, NamedElement, activityecorelua_ActivityNode, activityecorelua_ActivityEdge, activityecorelua_Variable, activityecorelua_NamedElement, activityecorelua_InitialNode, ControlNode, activityecorelua_FinalNode, activityecorelua_ActivityFinalNode, FinalNode, activityecorelua_ForkNode, activityecorelua_ControlFlow, ActivityEdge, activityecorelua_BooleanVariable, activityecorelua_ControlNode, ActivityNode, activityecorelua_ExecutableNode, activityecorelua_Action, ExecutableNode, activityecorelua_OpaqueAction, Action, activityecorelua_Expression, activityecorelua_JoinNode, activityecorelua_BooleanValue, Value, activityecorelua_IntegerValue, activityecorelua_InputValue, activityecorelua_Input, activityecorelua_MergeNode, activityecorelua_DecisionNode, activityecorelua_Value, activityecorelua_IntegerVariable, Variable, activityecorelua_Statement_Block, Statement, activityecorelua_Statement_While, activityecorelua_Statement_Repeat, activityecorelua_Statement_If_Then_Else, activityecorelua_Chunk, activityecorelua_Block, Chunk, activityecorelua_Statement, activityecorelua_LastStatement, activityecorelua_LastStatement_Return, LastStatement, activityecorelua_LastStatement_Break, activityecorelua_Statement_For_Generic, activityecorelua_Statement_GlobalFunction_Declaration, activityecorelua_Function, activityecorelua_Statement_LocalFunction_Declaration, activityecorelua_Statement_If_Then_Else_ElseIfPart, activityecorelua_Statement_Local_Variable_Declaration, activityecorelua_Statement_FunctioncallOrAssignment, Statement_FunctioncallOrAssignment, activityecorelua_Statement_For_Numeric, activityecorelua_Expression_Nil, Expression, activityecorelua_Expression_True, activityecorelua_Expression_False, activityecorelua_Expression_Number, activityecorelua_Expression_Function, activityecorelua_Expression_TableConstructor, activityecorelua_Field, activityecorelua_Functioncall_Arguments, activityecorelua_Field_AddEntryToTable_Brackets, Field, activityecorelua_Field_AddEntryToTable, activityecorelua_Field_AppendEntryToTable, activityecorelua_LastStatement_ReturnWithValue, LastStatement_Return, activityecorelua_Statement_Assignment, activityecorelua_Expression_VarArgs, activityecorelua_Expression_String, activityecorelua_Statement_CallMemberFunction, activityecorelua_Statement_CallFunction, activityecorelua_Expression_Or, activityecorelua_Expression_And, activityecorelua_Expression_Larger, activityecorelua_Expression_Larger_Equal, activityecorelua_Expression_Smaller, activityecorelua_Expression_Smaller_Equal, activityecorelua_Expression_Equal, activityecorelua_Expression_Not_Equal, activityecorelua_Expression_Concatenation, activityecorelua_Expression_Plus, activityecorelua_Expression_Minus, activityecorelua_Expression_Multiplication, activityecorelua_Expression_Division, activityecorelua_Expression_Modulo, activityecorelua_Expression_Negate, activityecorelua_Expression_Length, activityecorelua_Expression_Invert, activityecorelua_Expression_Exponentiation, activityecorelua_Expression_CallMemberFunction, activityecorelua_Expression_CallFunction, activityecorelua_Expression_AccessArray, activityecorelua_Expression_AccessMember, activityecorelua_Expression_VariableName},
    associations={eSuperTypes9, eAttributeType0, details1, eModelElement2, contents3, references5, eAttributes19, eAllContainments22, eAllOperations25, eAllStructuralFeatures27, eAllSuperTypes30, eIDAttribute32, eStructuralFeatures35, eOperations10, eAllAttributes11, eAllReferences14, eReferences16, eGenericSuperTypes37, eAllGenericSuperTypes39, eLiterals44, ePackage42, eTypeParameters43, ePackage46, eAnnotations48, eEnum45, eTypeParameters50, eParameters53, activity54, eExceptions56, eContainingClass49, eFactoryInstance62, eClassifiers63, eSubpackages66, eSuperPackage69, eGenericExceptions59, eOpposite74, eReferenceType76, eKeys79, eOperation71, eContainingClass82, eType84, eGenericType86, eUpperBound90, eTypeParameter101, eClassifier104, eBounds107, nodes110, eTypeArguments93, eRawType95, eLowerBound99, incoming119, activity121, source122, target124, edges111, locals113, inputs115, outgoing118, guard126, expressions127, value133, variable135, initialValue128, currentValue130, block143, expression145, block147, block150, expression152, ifExpression155, inputValues138, statements140, returnValue141, block179, expressions182, block184, function187, ifBlock157, function188, elseIf160, elseBlock162, initialValue190, elseifExpression165, elseifBlock168, startExpr171, untilExpr173, stepExpr176, function192, fields194, body195, arguments198, value200, indexExpression203, returnValues205, values209, object212, arguments214, object217, arguments219, left222, right224, left227, right229, left232, right234, variable207, right239, left242, right244, left247, right249, left252, right254, left257, right259, left262, left237, right264, left267, right269, left272, right274, left277, right279, left282, right284, left287, exp292, exp294, exp296, left298, right300, object303, arguments305, object308, right289, array313, index315, object318, arguments310},
    generalizations={gen_activityecorelua_EAttribute_EStructuralFeature, gen_activityecorelua_EAnnotation_EModelElement, gen_activityecorelua_EClass_EClassifier, gen_activityecorelua_EClassifier_ENamedElement, gen_activityecorelua_EEnum_EDataType, gen_activityecorelua_EEnumLiteral_ENamedElement, gen_activityecorelua_EDataType_EClassifier, gen_activityecorelua_ENamedElement_EModelElement, gen_activityecorelua_EFactory_EModelElement, gen_activityecorelua_EOperation_ETypedElement, gen_activityecorelua_EPackage_ENamedElement, gen_activityecorelua_EStructuralFeature_ETypedElement, gen_activityecorelua_EParameter_ETypedElement, gen_activityecorelua_EReference_EStructuralFeature, gen_activityecorelua_ETypedElement_ENamedElement, gen_activityecorelua_ETypeParameter_ENamedElement, gen_activityecorelua_Activity_NamedElement, gen_activityecorelua_ActivityEdge_NamedElement, gen_activityecorelua_ActivityNode_NamedElement, gen_activityecorelua_InitialNode_ControlNode, gen_activityecorelua_FinalNode_ControlNode, gen_activityecorelua_ActivityFinalNode_FinalNode, gen_activityecorelua_ForkNode_ControlNode, gen_activityecorelua_ControlFlow_ActivityEdge, gen_activityecorelua_ControlNode_ActivityNode, gen_activityecorelua_ExecutableNode_ActivityNode, gen_activityecorelua_Action_ExecutableNode, gen_activityecorelua_OpaqueAction_Action, gen_activityecorelua_JoinNode_ControlNode, gen_activityecorelua_BooleanValue_Value, gen_activityecorelua_IntegerValue_Value, gen_activityecorelua_MergeNode_ControlNode, gen_activityecorelua_DecisionNode_ControlNode, gen_activityecorelua_IntegerVariable_Variable, gen_activityecorelua_BooleanVariable_Variable, gen_activityecorelua_Statement_Block_Statement, gen_activityecorelua_Statement_While_Statement, gen_activityecorelua_Statement_Repeat_Statement, gen_activityecorelua_Statement_If_Then_Else_Statement, gen_activityecorelua_Block_Chunk, gen_activityecorelua_LastStatement_Return_LastStatement, gen_activityecorelua_LastStatement_Break_LastStatement, gen_activityecorelua_Statement_For_Generic_Statement, gen_activityecorelua_Statement_GlobalFunction_Declaration_Statement, gen_activityecorelua_Statement_LocalFunction_Declaration_Statement, gen_activityecorelua_Statement_Local_Variable_Declaration_Statement, gen_activityecorelua_Statement_FunctioncallOrAssignment_Statement, gen_activityecorelua_Expression_Statement_FunctioncallOrAssignment, gen_activityecorelua_Statement_For_Numeric_Statement, gen_activityecorelua_Expression_Nil_Expression, gen_activityecorelua_Expression_True_Expression, gen_activityecorelua_Expression_False_Expression, gen_activityecorelua_Expression_Number_Expression, gen_activityecorelua_Expression_Function_Expression, gen_activityecorelua_Expression_TableConstructor_Expression, gen_activityecorelua_Field_AddEntryToTable_Brackets_Field, gen_activityecorelua_Field_AddEntryToTable_Field, gen_activityecorelua_Field_AppendEntryToTable_Field, gen_activityecorelua_LastStatement_ReturnWithValue_LastStatement_Return, gen_activityecorelua_Statement_Assignment_Statement_FunctioncallOrAssignment, gen_activityecorelua_Expression_VarArgs_Expression, gen_activityecorelua_Expression_String_Expression, gen_activityecorelua_Statement_CallMemberFunction_Statement_FunctioncallOrAssignment, gen_activityecorelua_Statement_CallFunction_Statement_FunctioncallOrAssignment, gen_activityecorelua_Expression_Or_Expression, gen_activityecorelua_Expression_And_Expression, gen_activityecorelua_Expression_Larger_Expression, gen_activityecorelua_Expression_Larger_Equal_Expression, gen_activityecorelua_Expression_Smaller_Expression, gen_activityecorelua_Expression_Smaller_Equal_Expression, gen_activityecorelua_Expression_Equal_Expression, gen_activityecorelua_Expression_Not_Equal_Expression, gen_activityecorelua_Expression_Concatenation_Expression, gen_activityecorelua_Expression_Plus_Expression, gen_activityecorelua_Expression_Minus_Expression, gen_activityecorelua_Expression_Multiplication_Expression, gen_activityecorelua_Expression_Division_Expression, gen_activityecorelua_Expression_Modulo_Expression, gen_activityecorelua_Expression_Negate_Expression, gen_activityecorelua_Expression_Length_Expression, gen_activityecorelua_Expression_Invert_Expression, gen_activityecorelua_Expression_Exponentiation_Expression, gen_activityecorelua_Expression_CallMemberFunction_Expression, gen_activityecorelua_Expression_CallFunction_Expression, gen_activityecorelua_Expression_AccessArray_Expression, gen_activityecorelua_Expression_AccessMember_Expression, gen_activityecorelua_Expression_VariableName_Expression},
    metadata=None
)
