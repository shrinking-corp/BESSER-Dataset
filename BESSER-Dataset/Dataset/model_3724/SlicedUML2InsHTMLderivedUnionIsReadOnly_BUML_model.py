...
domain_model = DomainModel(
    name="UML2",
    types={UML2_ExtensionEnd, Property_, UML2_Property, StructuralFeature, UML2_Port, UML2_StructuralFeature},
    associations={},
    generalizations={gen_UML2_ExtensionEnd_Property, gen_UML2_Property_StructuralFeature, gen_UML2_Port_Property},
    metadata=None
)
