...
types_FunctionType = Class(name="types_FunctionType")
types_MethodType = Class(name="types_MethodType")
FunctionType = Class(name="FunctionType")
types_EnumType = Class(name="types_EnumType")
types_EEnum = Class(name="types_EEnum")
...
domain_model = DomainModel(
    name="types",
    types={types_Type, types_DataType, Type, types_BooleanType, DataType, types_NumberType, types_IntegerType, RealType, types_RealType, NumberType, types_StringType, types_ObjectType, types_EClass, types_CollectionType, types_MapType, types_FunctionType, types_MethodType, FunctionType, types_EnumType, types_EEnum},
    associations={objectClass0, elementType1, keyType2, returnType7, parameterTypes9, objectType12, enumClass14, valueType4},
    generalizations={gen_types_DataType_Type, gen_types_BooleanType_DataType, gen_types_NumberType_DataType, gen_types_IntegerType_RealType, gen_types_RealType_NumberType, gen_types_StringType_DataType, gen_types_ObjectType_Type, gen_types_CollectionType_Type, gen_types_MapType_Type, gen_types_FunctionType_Type, gen_types_MethodType_FunctionType, gen_types_EnumType_Type},
    metadata=None
)
