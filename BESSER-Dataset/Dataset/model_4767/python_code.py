...
class types_FunctionType(Type):
    ...
    def __init__(self, optionalParameterCount: int, types_FunctionType: "types_Type" = None, types_FunctionType10: set["types_Type"] = None):
        ...
        pass
    @property
    def optionalParameterCount(self):
...
class types_Type:
    ...
    def __init__(self, inExtentDomain: bool, types_Type: "types_CollectionType" = None, types_Type3: "types_MapType" = None, types_Type8: "types_FunctionType" = None, types_Type11: "types_FunctionType" = None, types_Type13: "types_MethodType" = None, types_Type6: "types_MapType" = None):
