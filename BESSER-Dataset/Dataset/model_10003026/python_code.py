...
class Registration:
    ...
    def __init__(self, fname: str, lname: str, password: secret, userName: str, user9: "User" = None):
        self.fname = fname
        self.lname = lname
        self.password = password
        self.userName = userName
...
class Profile:
    ...
    def __init__(self, about: str, username: str, password: str, user1: "User" = None):
        self.about = about
        self.username = username
        self.password = password
        self.user1 = user1
