...
# Classes
aredsl_Node = Class(name="aredsl_Node")
aredsl_Edge = Class(name="aredsl_Edge")
aredsl_TrackerAction = Class(name="aredsl_TrackerAction", is_abstract=True)
aredsl_Editor = Class(name="aredsl_Editor")
aredsl_Layer = Class(name="aredsl_Layer")
aredsl_ToolSet = Class(name="aredsl_ToolSet")
aredsl_Model3DNodeStyle = Class(name="aredsl_Model3DNodeStyle")
NodeStyle = Class(name="NodeStyle")
aredsl_NodeStyle = Class(name="aredsl_NodeStyle", is_abstract=True)
aredsl_Label = Class(name="aredsl_Label")
aredsl_LabelStyle = Class(name="aredsl_LabelStyle")
aredsl_EdgeStyle = Class(name="aredsl_EdgeStyle")
aredsl_Image2DNodeStyle = Class(name="aredsl_Image2DNodeStyle")
aredsl_GeometricShapeNodeStyle = Class(name="aredsl_GeometricShapeNodeStyle")
aredsl_Tool = Class(name="aredsl_Tool")
aredsl_Behaviour = Class(name="aredsl_Behaviour", is_abstract=True)
aredsl_ChangeContextOperation = Class(name="aredsl_ChangeContextOperation")
aredsl_Action = Class(name="aredsl_Action", is_abstract=True)
aredsl_CreateInstanceOperation = Class(name="aredsl_CreateInstanceOperation")
DomainOperation = Class(name="DomainOperation")
aredsl_DomainOperation = Class(name="aredsl_DomainOperation", is_abstract=True)
Behaviour = Class(name="Behaviour")
aredsl_RemoveOperation = Class(name="aredsl_RemoveOperation")
aredsl_SetOperation = Class(name="aredsl_SetOperation")
aredsl_UnsetOperation = Class(name="aredsl_UnsetOperation")
aredsl_MentalAction = Class(name="aredsl_MentalAction")
aredsl_TactileAction = Class(name="aredsl_TactileAction")
aredsl_MarkerBasedTrackerAction = Class(name="aredsl_MarkerBasedTrackerAction")
TrackerAction = Class(name="TrackerAction")
aredsl_MarkerLessTrackerAction = Class(name="aredsl_MarkerLessTrackerAction")
aredsl_SensorBasedAction = Class(name="aredsl_SensorBasedAction")
Action = Class(name="Action")
aredsl_GestureAction = Class(name="aredsl_GestureAction")
aredsl_VoiceAction = Class(name="aredsl_VoiceAction")
aredsl_SupportOperation = Class(name="aredsl_SupportOperation", is_abstract=True)
aredsl_MoveElement = Class(name="aredsl_MoveElement")
SupportOperation = Class(name="SupportOperation")
aredsl_ShowSystemMenu = Class(name="aredsl_ShowSystemMenu")
aredsl_ArrangeElements = Class(name="aredsl_ArrangeElements")
aredsl_Exit = Class(name="aredsl_Exit")
...
aredsl_Node.attributes={aredsl_Node_description, aredsl_Node_contaimentKind, aredsl_Node_semantics, aredsl_Node_id}
...
aredsl_Edge.attributes={aredsl_Edge_originSemantics, aredsl_Edge_destinationSemantics, aredsl_Edge_description, aredsl_Edge_id}
...
aredsl_Editor.attributes={aredsl_Editor_name, aredsl_Editor_queryLanguageKind, aredsl_Editor_description, aredsl_Editor_fileExtension}
...
aredsl_Layer.attributes={aredsl_Layer_semantics, aredsl_Layer_description, aredsl_Layer_id}
...
aredsl_ToolSet.attributes={aredsl_ToolSet_description, aredsl_ToolSet_id}
...
aredsl_Label.attributes={aredsl_Label_semantics, aredsl_Label_id, aredsl_Label_description}
...
aredsl_LabelStyle.attributes={aredsl_LabelStyle_height, aredsl_LabelStyle_color, aredsl_LabelStyle_semanticCondition}
...
aredsl_EdgeStyle.attributes={aredsl_EdgeStyle_width, aredsl_EdgeStyle_kind, aredsl_EdgeStyle_semanticCondition, aredsl_EdgeStyle_color}
...
aredsl_GeometricShapeNodeStyle.attributes={aredsl_GeometricShapeNodeStyle_outline, aredsl_GeometricShapeNodeStyle_color, aredsl_GeometricShapeNodeStyle_kind}
...
aredsl_Tool.attributes={aredsl_Tool_precondition, aredsl_Tool_targetPrecondition, aredsl_Tool_id, aredsl_Tool_description}
...
aredsl_SetOperation.attributes={aredsl_SetOperation_constraint, aredsl_SetOperation_value, aredsl_SetOperation_feature}
...
domain_model = DomainModel(
    name="aredsl",
    types={aredsl_Node, aredsl_Edge, aredsl_TrackerAction, aredsl_Editor, aredsl_Layer, aredsl_ToolSet, aredsl_Model3DNodeStyle, NodeStyle, aredsl_NodeStyle, aredsl_Label, aredsl_LabelStyle, aredsl_EdgeStyle, aredsl_Image2DNodeStyle, aredsl_GeometricShapeNodeStyle, aredsl_Tool, aredsl_Behaviour, aredsl_ChangeContextOperation, aredsl_Action, aredsl_CreateInstanceOperation, DomainOperation, aredsl_DomainOperation, Behaviour, aredsl_RemoveOperation, aredsl_SetOperation, aredsl_UnsetOperation, aredsl_MentalAction, aredsl_TactileAction, aredsl_MarkerBasedTrackerAction, TrackerAction, aredsl_MarkerLessTrackerAction, aredsl_SensorBasedAction, Action, aredsl_GestureAction, aredsl_VoiceAction, aredsl_SupportOperation, aredsl_MoveElement, SupportOperation, aredsl_ShowSystemMenu, aredsl_ArrangeElements, aredsl_Exit, LineKind, ShapeKind, ContainmentKind, OutlineKind, IntegrityRestrictionKind, QueryLanguageKind},
    associations={nodes3, edges5, referenceAction7, layer0, toolsets1, nodestyles9, label11, contentNodes14, edgestyles18, middleLabel20, originNode23, labelstyles16, behaviours35, destinationNode26, originLabel29, destinationLabel32, tools38, actions36},
    generalizations={gen_aredsl_Model3DNodeStyle_NodeStyle, gen_aredsl_Image2DNodeStyle_NodeStyle, gen_aredsl_GeometricShapeNodeStyle_NodeStyle, gen_aredsl_ChangeContextOperation_DomainOperation, gen_aredsl_CreateInstanceOperation_DomainOperation, gen_aredsl_DomainOperation_Behaviour, gen_aredsl_RemoveOperation_DomainOperation, gen_aredsl_SetOperation_DomainOperation, gen_aredsl_UnsetOperation_DomainOperation, gen_aredsl_TrackerAction_Action, gen_aredsl_MentalAction_Action, gen_aredsl_TactileAction_Action, gen_aredsl_MarkerBasedTrackerAction_TrackerAction, gen_aredsl_MarkerLessTrackerAction_TrackerAction, gen_aredsl_SensorBasedAction_Action, gen_aredsl_GestureAction_Action, gen_aredsl_VoiceAction_Action, gen_aredsl_SupportOperation_Behaviour, gen_aredsl_MoveElement_SupportOperation, gen_aredsl_ShowSystemMenu_SupportOperation, gen_aredsl_ArrangeElements_SupportOperation, gen_aredsl_Exit_SupportOperation},
    metadata=None
)
