...
JPA_Column.attributes={JPA_Column_nullable, JPA_Column_type, JPA_Column_fetch, JPA_Column_name}
...
JPA_OneToMany.attributes={JPA_OneToMany_name, JPA_OneToMany_type, JPA_OneToMany_referencedEntityName}
...
JPA_ManyToOne.attributes={JPA_ManyToOne_referencedPropertyName, JPA_ManyToOne_referencedEntityName, JPA_ManyToOne_type, JPA_ManyToOne_name}
...
domain_model = DomainModel(
    name="JPA",
    types={JPA_EntityPk, Anotation, JPA_PersistenceUnit, JPA_Table, JPA_Entity, JPA_Column, JPA_Property, JPA_OneToOne, JPA_Anotation, JPA_OneToMany, JPA_ManyToOne, JPA_ManyToMany, Cascade, Fetch},
