...
class JPA_Property:
    ...
    def __init__(self, name: str, comment: str, JPA_Property9: "JPA_EntityPk" = None, JPA_Property: "JPA_Entity" = None, JPA_Property6: set["JPA_Anotation"] = None):
        self.name = name
...
class JPA_OneToOne(Anotation):
    ...
    @property
    def referencedPropertyName(self):
