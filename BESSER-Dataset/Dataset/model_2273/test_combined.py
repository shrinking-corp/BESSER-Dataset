...
def test_hyp_university_address_is_not_abstract():
    assert not inspect.isabstract(university_Address)


def test_hyp_university_address_constructor_exists():
    assert callable(university_Address.__init__)


def test_hyp_university_address_constructor_args():
...
def test_hyp_university_staff_is_not_abstract():
    assert not inspect.isabstract(university_Staff)


def test_hyp_university_staff_constructor_exists():
    assert callable(university_Staff.__init__)


def test_hyp_university_staff_constructor_args():
...
def test_hyp_university_assistant_is_not_abstract():
    assert not inspect.isabstract(university_Assistant)


def test_hyp_university_assistant_constructor_exists():
    assert callable(university_Assistant.__init__)


def test_hyp_university_assistant_constructor_args():
...
def test_hyp_university_staff_staff_setter(instance):
