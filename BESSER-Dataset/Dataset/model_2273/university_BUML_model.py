...
# Classes
university_Assistant = Class(name="university_Assistant")
Person = Class(name="Person")
university_CourseCatalog = Class(name="university_CourseCatalog")
university_Course = Class(name="university_Course")
university_Staff = Class(name="university_Staff")
university_Professor = Class(name="university_Professor")
university_Person = Class(name="university_Person", is_abstract=True)
university_Address = Class(name="university_Address")
...
university_Course.attributes={university_Course_id, university_Course_etcs, university_Course_name}
...
domain_model = DomainModel(
    name="university",
    types={university_Assistant, Person, university_CourseCatalog, university_Course, university_Staff, university_Professor, university_Person, university_Address},
    associations={assistants2, courses0, professors1, addresses4},
