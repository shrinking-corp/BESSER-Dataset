...
# Classes
ASPT_TraceModel = Class(name="ASPT_TraceModel")
ASPT_TraceLink = Class(name="ASPT_TraceLink")
ASPT_TraceElement = Class(name="ASPT_TraceElement")
TraceElement = Class(name="TraceElement")
ASPT_TraceNode = Class(name="ASPT_TraceNode")
ASPT_TraceProp = Class(name="ASPT_TraceProp")
ASPT_TraceEdge = Class(name="ASPT_TraceEdge")
ASPT_TraceNbNode = Class(name="ASPT_TraceNbNode")
TraceNode = Class(name="TraceNode")
ASPT_TraceNbProp = Class(name="ASPT_TraceNbProp")
TraceProp = Class(name="TraceProp")
ASPT_TraceNbEdge = Class(name="ASPT_TraceNbEdge")
...
ASPT_TraceModel.attributes={ASPT_TraceModel_ID, ASPT_TraceModel_MMS}
...
ASPT_TraceLink.attributes={ASPT_TraceLink_relation, ASPT_TraceLink_idrefx, ASPT_TraceLink_idref}
...
ASPT_TraceElement.attributes={ASPT_TraceElement_metamodel, ASPT_TraceElement_idx, ASPT_TraceElement_type, ASPT_TraceElement_id}
...
ASPT_TraceProp.attributes={ASPT_TraceProp_idp, ASPT_TraceProp_value, ASPT_TraceProp_idpx}
...
ASPT_TraceEdge.attributes={ASPT_TraceEdge_idt, ASPT_TraceEdge_idsx, ASPT_TraceEdge_ids, ASPT_TraceEdge_idtx}
...
domain_model = DomainModel(
    ...
    generalizations={gen_ASPT_TraceNode_TraceElement, gen_ASPT_TraceProp_TraceElement, gen_ASPT_TraceEdge_TraceElement, gen_ASPT_TraceNbNode_TraceNode, gen_ASPT_TraceNbProp_TraceProp, gen_ASPT_TraceNbEdge_TraceEdge, gen_ASPT_TraceLink_TraceElement},
    metadata=None
)
