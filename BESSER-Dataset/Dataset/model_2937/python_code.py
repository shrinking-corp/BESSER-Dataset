...
class test7_AttributeTypeElement:
    ...
    def __init__(self, dataType: str, name: str, test7_AttributeTypeElement: "test7_AttributeType" = None):
...
class test7_Feature:
    ...
    def __init__(self, name: str, test7_Feature20: set["test7_FeatureAttributeReference"] = None, test7_Feature: "test7_Model" = None, test7_Feature27: "test7_SelectionStateSC" = None, test7_Feature29: "test7_FiniteDomainSC" = None):
        self.name = name
...
class test7_FeatureAttribute:
    ...
    def __init__(self, name: str, test7_FeatureAttribute16: set["test7_FeatureAttributeElement"] = None, test7_FeatureAttribute18: "test7_FeatureAttributeReference" = None, test7_FeatureAttribute: "test7_Model" = None, test7_FeatureAttribute13: "test7_AttributeType" = None, test7_FeatureAttribute32: "test7_FiniteDomainSC" = None):
        self.name = name
...
class test7_AttributeType:
    ...
    def __init__(self, name: str, test7_AttributeType23: "test7_OptimizationSC" = None, test7_AttributeType: "test7_Model" = None, test7_AttributeType8: set["test7_AttributeTypeElement"] = None, test7_AttributeType11: "test7_AttributeType" = None, test7_AttributeType9: "test7_AttributeType" = None, test7_AttributeType14: "test7_FeatureAttribute" = None, test7_AttributeType25: "test7_HardLimitSC" = None):
        self.name = name
