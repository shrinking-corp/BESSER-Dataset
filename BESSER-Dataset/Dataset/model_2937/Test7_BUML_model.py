...
# Classes
test7_FeatureAttributeElement = Class(name="test7_FeatureAttributeElement")
test7_FeatureAttributeReference = Class(name="test7_FeatureAttributeReference")
test7_OptimizationSC = Class(name="test7_OptimizationSC")
SolutionConstraint = Class(name="SolutionConstraint")
test7_Model = Class(name="test7_Model")
test7_AttributeType = Class(name="test7_AttributeType")
test7_FeatureAttribute = Class(name="test7_FeatureAttribute")
test7_Feature = Class(name="test7_Feature")
test7_SolutionConstraint = Class(name="test7_SolutionConstraint")
test7_AttributeTypeElement = Class(name="test7_AttributeTypeElement")
test7_HardLimitSC = Class(name="test7_HardLimitSC")
test7_SelectionStateSC = Class(name="test7_SelectionStateSC")
test7_FiniteDomainSC = Class(name="test7_FiniteDomainSC")
test7_FiniteDomainSCValueReference = Class(name="test7_FiniteDomainSCValueReference")
...
test7_AttributeTypeElement.attributes={test7_AttributeTypeElement_name, test7_AttributeTypeElement_dataType}
...
test7_HardLimitSC.attributes={test7_HardLimitSC_value2, test7_HardLimitSC_op1, test7_HardLimitSC_op2, test7_HardLimitSC_value1}
...
domain_model = DomainModel(
    name="test7",
    types={test7_FeatureAttributeElement, test7_FeatureAttributeReference, test7_OptimizationSC, SolutionConstraint, test7_Model, test7_AttributeType, test7_FeatureAttribute, test7_Feature, test7_SolutionConstraint, test7_AttributeTypeElement, test7_HardLimitSC, test7_SelectionStateSC, test7_FiniteDomainSC, test7_FiniteDomainSCValueReference},
    associations={values15, name17, attributes19, attrType22, attributeTypes0, featureAttributes1, features3, solutionConstraints5, elements7, independentAttrType10, attrType12, attrType24, feature26, feature28, featureAttr30, values33},
