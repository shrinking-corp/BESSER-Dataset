...
class Room:
    ...
    def __init__(self, floor: int, door: int, capacity: str, price: float, customer5: set["Customer"] = None, hotel1: "Hotel" = None):
        self.floor = floor
        self.door = door
...
class Hotel:
    ...
    def __init__(self, street: str, city: str, zip: int, coordinates: int, name: str, phoneNumber: int, website: str, service3: set["Service"] = None, room0: set["Room"] = None):
        self.street = street
        self.city = city
        self.zip = zip
