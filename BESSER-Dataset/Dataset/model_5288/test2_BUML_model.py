...
# Classes
test2_Classe = Class(name="test2_Classe")
N = Class(name="N")
B = Class(name="B")
test2_N = Class(name="test2_N", is_abstract=True)
test2_test2_B = Class(name="test2_test2_B")
...
test2_test2_B.attributes={test2_test2_B_nb2, test2_test2_B_nb}
