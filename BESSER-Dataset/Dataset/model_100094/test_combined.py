...
def test_hyp_releng_promotion_is_not_abstract():
    assert not inspect.isabstract(releng_Promotion)


def test_hyp_releng_promotion_constructor_exists():
    assert callable(releng_Promotion.__init__)


def test_hyp_releng_promotion_constructor_args():
...
def test_hyp_releng_compositerepository_is_not_abstract():
    assert not inspect.isabstract(releng_CompositeRepository)


def test_hyp_releng_compositerepository_constructor_exists():
    assert callable(releng_CompositeRepository.__init__)


def test_hyp_releng_compositerepository_constructor_args():
    sig = inspect.signature(releng_CompositeRepository.__init__)
    params = list(sig.parameters.keys())



def test_hyp_releng_criterion_is_not_abstract():
    assert not inspect.isabstract(releng_Criterion)


def test_hyp_releng_criterion_constructor_exists():
    assert callable(releng_Criterion.__init__)


def test_hyp_releng_criterion_constructor_args():
...
def test_hyp_releng_repository_is_not_abstract():
    assert not inspect.isabstract(releng_Repository)


def test_hyp_releng_repository_constructor_exists():
    assert callable(releng_Repository.__init__)


def test_hyp_releng_repository_constructor_args():
...
def test_hyp_releng_buildjob_is_not_abstract():
    assert not inspect.isabstract(releng_BuildJob)


def test_hyp_releng_buildjob_constructor_exists():
    assert callable(releng_BuildJob.__init__)


def test_hyp_releng_buildjob_constructor_args():
...
def test_hyp_releng_server_is_not_abstract():
    assert not inspect.isabstract(releng_Server)


def test_hyp_releng_server_constructor_exists():
    assert callable(releng_Server.__init__)


def test_hyp_releng_server_constructor_args():
...
def test_hyp_releng_promotion_buildType_setter(instance):
...
def test_hyp_releng_criterion_description_setter(instance):
...
def test_hyp_releng_repository_location_setter(instance):
...
def test_hyp_releng_buildjob_sourceBranch_setter(instance):
...
@given(instance=releng_BuildJob_strategy)
def test_hyp_releng_buildjob_buckminsterComponent_setter(instance):
...
@given(instance=releng_BuildJob_strategy)
def test_hyp_releng_buildjob_name_setter(instance):
...
@given(instance=releng_BuildJob_strategy)
def test_hyp_releng_buildjob_types_setter(instance):
...
def test_hyp_releng_server_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
