...
class ardurobotml_Region:
    ...
    def __init__(self, name: str, ardurobotml_Region: set["ardurobotml_State"] = None, ardurobotml_Region45: "ardurobotml_RegionContainer" = None):
        self.name = name
...
class ardurobotml_SystemPropertyCondition(Condition):
    ...
    def __init__(self, expectedAttributeValue: bool):
        ...
        pass
    @property
    def expectedAttributeValue(self):
...
class ardurobotml_State(RegionContainer):
    ...
    def __init__(self, State28: "ardurobotml_Transition" = None, ardurobotml_State: "ardurobotml_TFSM" = None, ardurobotml_State17: "ardurobotml_TFSM" = None, State: "ardurobotml_TFSM" = None, source: set["ardurobotml_Transition"] = None, target: set["ardurobotml_Transition"] = None, ardurobotml_State23: set["ardurobotml_Action"] = None, ownedStates: "ardurobotml_TFSM" = None, State26: "ardurobotml_Transition" = None, ardurobotml_State43: "ardurobotml_Region" = None):
...
class ardurobotml_TFSM(RegionContainer):
    ...
    def __init__(self, ardurobotml_TFSM: "ardurobotml_TimedSystem" = None, ardurobotml_TFSM6: "ardurobotml_State" = None, ardurobotml_TFSM8: set["ardurobotml_FSMEvent"] = None, ardurobotml_TFSM11: "ardurobotml_FSMClock" = None, ardurobotml_TFSM14: set["ardurobotml_Transition"] = None, ardurobotml_TFSM16: "ardurobotml_State" = None, owningFSM: set["ardurobotml_State"] = None, TFSM: "ardurobotml_State" = None):
...
class ardurobotml_Transition(NamedElement):
    ...
    def __init__(self, incomingTransitions: "ardurobotml_State" = None, ardurobotml_Transition30: "ardurobotml_Guard" = None, ardurobotml_Transition32: set["ardurobotml_FSMEvent"] = None, ardurobotml_Transition: "ardurobotml_TFSM" = None, Transition: "ardurobotml_State" = None, Transition21: "ardurobotml_State" = None, outgoingTransitions: "ardurobotml_State" = None, ardurobotml_Transition40: "ardurobotml_FSMEvent" = None):
