...
Staff.attributes={Staff_jobType, Staff_name, Staff_contact, Staff_staff_Id}
...
Booking.attributes={Booking_date, Booking_reservedTables, Booking_name, Booking_contact, Booking_booking_Id, Booking_type}
...
Table.attributes={Table_specialRequest, Table_table_Id, Table_order, Table_occupied, Table_numSeats}
...
Food.attributes={Food_name, Food_price, Food_type, Food_served, Food_description, Food_prepared, Food_food_Id}
...
domain_model = DomainModel(
    name="d6260b77_2353_407e_97b2_86d100cf2f50",
    types={Staff, RMS, Report, Booking, Table, Order, Food, Manager, Waiter, Chef},
