...
class ulmDsl2_Context:
    ...
    def __init__(self, name: str, version: str, ulmDsl2_Context2: set["ulmDsl2_Attribute"] = None, ulmDsl2_Context4: set["ulmDsl2_Lookup"] = None, ulmDsl2_Context6: set["ulmDsl2_Entity"] = None, ulmDsl2_Context: "ulmDsl2_Model" = None):
        self.name = name
...
class ulmDsl2_Lookup:
    ...
    def __init__(self, name: str, ulmDsl2_Lookup: "ulmDsl2_Context" = None, ulmDsl2_Lookup27: "ulmDsl2_EObject" = None, ulmDsl2_Lookup23: "ulmDsl2_AttributeFeatureType" = None):
        self.name = name
