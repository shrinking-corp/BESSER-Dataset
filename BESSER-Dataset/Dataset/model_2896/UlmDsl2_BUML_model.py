...
# Classes
ulmDsl2_Attribute = Class(name="ulmDsl2_Attribute")
ulmDsl2_Lookup = Class(name="ulmDsl2_Lookup")
ulmDsl2_Entity = Class(name="ulmDsl2_Entity")
ulmDsl2_EObject = Class(name="ulmDsl2_EObject")
ulmDsl2_AttributeType = Class(name="ulmDsl2_AttributeType")
ulmDsl2_AttributeStringType = Class(name="ulmDsl2_AttributeStringType")
ulmDsl2_Model = Class(name="ulmDsl2_Model")
ulmDsl2_Context = Class(name="ulmDsl2_Context")
ulmDsl2_LookupInt = Class(name="ulmDsl2_LookupInt")
ulmDsl2_LookupIntValue = Class(name="ulmDsl2_LookupIntValue")
ulmDsl2_LookupString = Class(name="ulmDsl2_LookupString")
ulmDsl2_LookupStringValue = Class(name="ulmDsl2_LookupStringValue")
ulmDsl2_AttributeDecimalType = Class(name="ulmDsl2_AttributeDecimalType")
ulmDsl2_Feature = Class(name="ulmDsl2_Feature")
ulmDsl2_FeatureType = Class(name="ulmDsl2_FeatureType")
ulmDsl2_AttributeFeatureType = Class(name="ulmDsl2_AttributeFeatureType")
ulmDsl2_EntityFeatureType = Class(name="ulmDsl2_EntityFeatureType")
...
ulmDsl2_Entity.attributes={ulmDsl2_Entity_type, ulmDsl2_Entity_name, ulmDsl2_Entity_desc}
...
ulmDsl2_AttributeStringType.attributes={ulmDsl2_AttributeStringType_length, ulmDsl2_AttributeStringType_name, ulmDsl2_AttributeStringType_array}
...
ulmDsl2_Context.attributes={ulmDsl2_Context_name, ulmDsl2_Context_version}
...
ulmDsl2_LookupIntValue.attributes={ulmDsl2_LookupIntValue_description, ulmDsl2_LookupIntValue_value}
...
ulmDsl2_AttributeDecimalType.attributes={ulmDsl2_AttributeDecimalType_name, ulmDsl2_AttributeDecimalType_array, ulmDsl2_AttributeDecimalType_scale, ulmDsl2_AttributeDecimalType_precision}
...
ulmDsl2_Feature.attributes={ulmDsl2_Feature_mandatory, ulmDsl2_Feature_name, ulmDsl2_Feature_identifier}
...
ulmDsl2_EntityFeatureType.attributes={ulmDsl2_EntityFeatureType_array, ulmDsl2_EntityFeatureType_length}
...
domain_model = DomainModel(
    name="ulmDsl2",
    types={ulmDsl2_Attribute, ulmDsl2_Lookup, ulmDsl2_Entity, ulmDsl2_EObject, ulmDsl2_AttributeType, ulmDsl2_AttributeStringType, ulmDsl2_Model, ulmDsl2_Context, ulmDsl2_LookupInt, ulmDsl2_LookupIntValue, ulmDsl2_LookupString, ulmDsl2_LookupStringValue, ulmDsl2_AttributeDecimalType, ulmDsl2_Feature, ulmDsl2_FeatureType, ulmDsl2_AttributeFeatureType, ulmDsl2_EntityFeatureType},
    associations={attributes1, lookups3, entities5, type7, contexts0, type26, values29, values30, superType10, features12, type14, type16, attribute19, lookup21, entity24},
    generalizations={},
    metadata=None
)
