...
# Classes
iso20022_ModelEntity = Class(name="iso20022_ModelEntity", is_abstract=True)
iso20022_Address = Class(name="iso20022_Address")
ModelEntity = Class(name="ModelEntity")
iso20022_BroadcastList = Class(name="iso20022_BroadcastList")
iso20022_MessagingEndpoint = Class(name="iso20022_MessagingEndpoint")
iso20022_MessageTransportSystem = Class(name="iso20022_MessageTransportSystem")
iso20022_TransportMessage = Class(name="iso20022_TransportMessage")
iso20022_MessageInstance = Class(name="iso20022_MessageInstance")
iso20022_SyntaxMessageScheme = Class(name="iso20022_SyntaxMessageScheme")
iso20022_BusinessProcessCatalogue = Class(name="iso20022_BusinessProcessCatalogue")
iso20022_RepositoryConcept = Class(name="iso20022_RepositoryConcept", is_abstract=True)
TopLevelCatalogueEntry = Class(name="TopLevelCatalogueEntry")
iso20022_MessageDefinition = Class(name="iso20022_MessageDefinition")
iso20022_TopLevelCatalogueEntry = Class(name="iso20022_TopLevelCatalogueEntry", is_abstract=True)
RepositoryConcept = Class(name="RepositoryConcept")
iso20022_Constraint = Class(name="iso20022_Constraint")
iso20022_SemanticMarkup = Class(name="iso20022_SemanticMarkup")
iso20022_Doclet = Class(name="iso20022_Doclet")
iso20022_SemanticMarkupElement = Class(name="iso20022_SemanticMarkupElement")
iso20022_TopLevelDictionaryEntry = Class(name="iso20022_TopLevelDictionaryEntry", is_abstract=True)
iso20022_Repository = Class(name="iso20022_Repository")
iso20022_DataDictionary = Class(name="iso20022_DataDictionary")
iso20022_MessageSet = Class(name="iso20022_MessageSet")
iso20022_BusinessArea = Class(name="iso20022_BusinessArea")
RepositoryType = Class(name="RepositoryType")
iso20022_MessageTransmission = Class(name="iso20022_MessageTransmission")
iso20022_MessageDefinitionIdentifier = Class(name="iso20022_MessageDefinitionIdentifier")
iso20022_RepositoryType = Class(name="iso20022_RepositoryType", is_abstract=True)
iso20022_Xor = Class(name="iso20022_Xor")
iso20022_MessageBuildingBlock = Class(name="iso20022_MessageBuildingBlock")
iso20022_MessageChoreography = Class(name="iso20022_MessageChoreography")
iso20022_Syntax = Class(name="iso20022_Syntax")
iso20022_Encoding = Class(name="iso20022_Encoding")
iso20022_MessageElement = Class(name="iso20022_MessageElement", is_abstract=True)
MessageConcept = Class(name="MessageConcept")
iso20022_MessageComponent = Class(name="iso20022_MessageComponent")
MessageConstruct = Class(name="MessageConstruct")
iso20022_MessageConstruct = Class(name="iso20022_MessageConstruct", is_abstract=True)
Construct = Class(name="Construct")
iso20022_LogicalType = Class(name="iso20022_LogicalType", is_abstract=True)
iso20022_Construct = Class(name="iso20022_Construct", is_abstract=True)
MultiplicityEntity = Class(name="MultiplicityEntity")
iso20022_BusinessComponent = Class(name="iso20022_BusinessComponent")
iso20022_BusinessElement = Class(name="iso20022_BusinessElement", is_abstract=True)
iso20022_MessageElementContainer = Class(name="iso20022_MessageElementContainer", is_abstract=True)
iso20022_MessageConcept = Class(name="iso20022_MessageConcept", is_abstract=True)
...
iso20022_MultiplicityEntity = Class(name="iso20022_MultiplicityEntity", is_abstract=True)
iso20022_MessageComponentType = Class(name="iso20022_MessageComponentType", is_abstract=True)
iso20022_BusinessAssociationEnd = Class(name="iso20022_BusinessAssociationEnd")
iso20022_BusinessElementType = Class(name="iso20022_BusinessElementType", is_abstract=True)
LogicalType = Class(name="LogicalType")
iso20022_BusinessConcept = Class(name="iso20022_BusinessConcept", is_abstract=True)
iso20022_DataType = Class(name="iso20022_DataType", is_abstract=True)
BusinessElement = Class(name="BusinessElement")
MessageComponentType = Class(name="MessageComponentType")
iso20022_BusinessTransaction = Class(name="iso20022_BusinessTransaction")
iso20022_BusinessProcess = Class(name="iso20022_BusinessProcess")
iso20022_Participant = Class(name="iso20022_Participant")
MessageElementContainer = Class(name="MessageElementContainer")
iso20022_BusinessRole = Class(name="iso20022_BusinessRole")
iso20022_MessageTransportMode = Class(name="iso20022_MessageTransportMode")
iso20022_Receive = Class(name="iso20022_Receive")
iso20022_Send = Class(name="iso20022_Send")
iso20022_Conversation = Class(name="iso20022_Conversation")
iso20022_MessageAssociationEnd = Class(name="iso20022_MessageAssociationEnd")
MessageElement = Class(name="MessageElement")
iso20022_MessageAttribute = Class(name="iso20022_MessageAttribute")
iso20022_BusinessAttribute = Class(name="iso20022_BusinessAttribute")
iso20022_Text = Class(name="iso20022_Text")
String = Class(name="String")
iso20022_String = Class(name="iso20022_String")
DataType = Class(name="DataType")
iso20022_IdentifierSet = Class(name="iso20022_IdentifierSet")
iso20022_Indicator = Class(name="iso20022_Indicator")
Boolean = Class(name="Boolean")
iso20022_Boolean = Class(name="iso20022_Boolean")
iso20022_ExternalSchema = Class(name="iso20022_ExternalSchema")
iso20022_Quantity = Class(name="iso20022_Quantity")
iso20022_Rate = Class(name="iso20022_Rate")
Decimal = Class(name="Decimal")
iso20022_Decimal = Class(name="iso20022_Decimal")
iso20022_Amount = Class(name="iso20022_Amount")
iso20022_ChoiceComponent = Class(name="iso20022_ChoiceComponent")
iso20022_Code = Class(name="iso20022_Code")
iso20022_CodeSet = Class(name="iso20022_CodeSet")
iso20022_AbstractDateTimeConcept = Class(name="iso20022_AbstractDateTimeConcept", is_abstract=True)
iso20022_EndPointCategory = Class(name="iso20022_EndPointCategory")
iso20022_Binary = Class(name="iso20022_Binary")
iso20022_DateTime = Class(name="iso20022_DateTime")
iso20022_Day = Class(name="iso20022_Day")
iso20022_Duration = Class(name="iso20022_Duration")
iso20022_Month = Class(name="iso20022_Month")
iso20022_MonthDay = Class(name="iso20022_MonthDay")
iso20022_Time = Class(name="iso20022_Time")
iso20022_Year = Class(name="iso20022_Year")
iso20022_YearMonth = Class(name="iso20022_YearMonth")
iso20022_UserDefined = Class(name="iso20022_UserDefined")
iso20022_Date = Class(name="iso20022_Date")
AbstractDateTimeConcept = Class(name="AbstractDateTimeConcept")
iso20022_IndustryMessageSet = Class(name="iso20022_IndustryMessageSet")
iso20022_ConvergenceDocumentation = Class(name="iso20022_ConvergenceDocumentation")
iso20022_ISO15022MessageSet = Class(name="iso20022_ISO15022MessageSet")
IndustryMessageSet = Class(name="IndustryMessageSet")
iso20022_SchemaType = Class(name="iso20022_SchemaType")
...
iso20022_TransportMessage_m_sameMessageTransportSystem: Method = Method(name="sameMessageTransportSystem", parameters={Parameter(name='iso20022_context', type=StringType), Parameter(name='iso20022_diagnostics', type=StringType)}, type=BooleanType)
...
iso20022_BusinessProcessCatalogue_m_EntriesHaveUniqueName: Method = Method(name="EntriesHaveUniqueName", parameters={Parameter(name='iso20022_context', type=StringType), Parameter(name='iso20022_diagnostics', type=StringType)}, type=BooleanType)
...
iso20022_RepositoryConcept_m_RemovalDateRegistrationStatus: Method = Method(name="RemovalDateRegistrationStatus", parameters={Parameter(name='iso20022_context', type=StringType), Parameter(name='iso20022_diagnostics', type=StringType)}, type=BooleanType)
iso20022_RepositoryConcept_m_NameFirstLetterUppercase: Method = Method(name="NameFirstLetterUppercase", parameters={Parameter(name='iso20022_context', type=StringType), Parameter(name='iso20022_diagnostics', type=StringType)}, type=BooleanType)
iso20022_RepositoryConcept.attributes={iso20022_RepositoryConcept_removalDate, iso20022_RepositoryConcept_registrationStatus, iso20022_RepositoryConcept_definition, iso20022_RepositoryConcept_example, iso20022_RepositoryConcept_name}
iso20022_RepositoryConcept.methods={iso20022_RepositoryConcept_m_NameFirstLetterUppercase, iso20022_RepositoryConcept_m_RemovalDateRegistrationStatus}
...
iso20022_MessageDefinition_m_BusinessAreaNameMatch: Method = Method(name="BusinessAreaNameMatch", parameters={Parameter(name='iso20022_context', type=StringType), Parameter(name='iso20022_diagnostics', type=StringType)}, type=BooleanType)
iso20022_MessageDefinition.attributes={iso20022_MessageDefinition_xmlName, iso20022_MessageDefinition_rootElement, iso20022_MessageDefinition_xmlTag}
...
iso20022_DataDictionary_m_EntriesHaveUniqueName: Method = Method(name="EntriesHaveUniqueName", parameters={Parameter(name='iso20022_context', type=StringType), Parameter(name='iso20022_diagnostics', type=StringType)}, type=BooleanType)
...
iso20022_MessageSet_m_GeneratedSyntaxDerivation: Method = Method(name="GeneratedSyntaxDerivation", parameters={Parameter(name='iso20022_context', type=StringType), Parameter(name='iso20022_diagnostics', type=StringType)}, type=BooleanType)
...
iso20022_MessageDefinitionIdentifier.attributes={iso20022_MessageDefinitionIdentifier_flavour, iso20022_MessageDefinitionIdentifier_messageFunctionality, iso20022_MessageDefinitionIdentifier_version, iso20022_MessageDefinitionIdentifier_businessArea}
...
iso20022_MessageBuildingBlock_m_MessageBuildingBlockHasExactlyOneType: Method = Method(name="MessageBuildingBlockHasExactlyOneType", parameters={Parameter(name='iso20022_diagnostics', type=StringType), Parameter(name='iso20022_context', type=StringType)}, type=BooleanType)
...
iso20022_Syntax_m_GeneratedForDerivation: Method = Method(name="GeneratedForDerivation", parameters={Parameter(name='iso20022_context', type=StringType), Parameter(name='iso20022_diagnostics', type=StringType)}, type=BooleanType)
...
iso20022_MessageElement_m_NoMoreThanOneTrace: Method = Method(name="NoMoreThanOneTrace", parameters={Parameter(name='iso20022_context', type=StringType), Parameter(name='iso20022_diagnostics', type=StringType)}, type=BooleanType)
iso20022_MessageElement_m_CardinalityAlignment: Method = Method(name="CardinalityAlignment", parameters={Parameter(name='iso20022_diagnostics', type=StringType), Parameter(name='iso20022_context', type=StringType)}, type=BooleanType)
...
iso20022_BusinessComponent_m_BusinessElementsHaveUniqueNames: Method = Method(name="BusinessElementsHaveUniqueNames", parameters={Parameter(name='iso20022_diagnostics', type=StringType), Parameter(name='iso20022_context', type=StringType)}, type=BooleanType)
...
iso20022_MessageElementContainer_m_MessageElementsHaveUniqueNames: Method = Method(name="MessageElementsHaveUniqueNames", parameters={Parameter(name='iso20022_diagnostics', type=StringType), Parameter(name='iso20022_context', type=StringType)}, type=BooleanType)
iso20022_MessageElementContainer_m_technicalElement: Method = Method(name="technicalElement", parameters={Parameter(name='iso20022_context', type=StringType), Parameter(name='iso20022_diagnostics', type=StringType)}, type=BooleanType)
...
iso20022_BusinessAssociationEnd_m_AtMostOneAggregatedEnd: Method = Method(name="AtMostOneAggregatedEnd", parameters={Parameter(name='iso20022_context', type=StringType), Parameter(name='iso20022_diagnostics', type=StringType)}, type=BooleanType)
iso20022_BusinessAssociationEnd_m_ContextConsistentWithType: Method = Method(name="ContextConsistentWithType", parameters={Parameter(name='iso20022_context', type=StringType), Parameter(name='iso20022_diagnostics', type=StringType)}, type=BooleanType)
...
iso20022_BusinessTransaction_m_MessageTransmissionsHaveUniqueNames: Method = Method(name="MessageTransmissionsHaveUniqueNames", parameters={Parameter(name='iso20022_context', type=StringType), Parameter(name='iso20022_diagnostics', type=StringType)}, type=BooleanType)
iso20022_BusinessTransaction_m_ParticipantsHaveUniqueNames: Method = Method(name="ParticipantsHaveUniqueNames", parameters={Parameter(name='iso20022_diagnostics', type=StringType), Parameter(name='iso20022_context', type=StringType)}, type=BooleanType)
...
iso20022_MessageTransportMode.attributes={iso20022_MessageTransportMode_boundedCommunicationDelay, iso20022_MessageTransportMode_durability, iso20022_MessageTransportMode_messageValidationLevel, iso20022_MessageTransportMode_senderAsynchronicity, iso20022_MessageTransportMode_messageDeliveryWindow, iso20022_MessageTransportMode_messageDeliveryOrder, iso20022_MessageTransportMode_maximumClockVariation, iso20022_MessageTransportMode_messageValidationOnOff, iso20022_MessageTransportMode_messageValidationResults, iso20022_MessageTransportMode_receiverAsynchronicity, iso20022_MessageTransportMode_deliveryAssurance, iso20022_MessageTransportMode_messageCasting, iso20022_MessageTransportMode_maximumMessageSize, iso20022_MessageTransportMode_messageSendingWindow}
...
iso20022_MessageAttribute_m_MessageAttributeHasExactlyOneType: Method = Method(name="MessageAttributeHasExactlyOneType", parameters={Parameter(name='iso20022_diagnostics', type=StringType), Parameter(name='iso20022_context', type=StringType)}, type=BooleanType)
...
iso20022_BusinessAttribute_m_BusinessAttributeHasExactlyOneType: Method = Method(name="BusinessAttributeHasExactlyOneType", parameters={Parameter(name='iso20022_diagnostics', type=StringType), Parameter(name='iso20022_context', type=StringType)}, type=BooleanType)
iso20022_BusinessAttribute_m_NoDerivingCodeSetType: Method = Method(name="NoDerivingCodeSetType", parameters={Parameter(name='iso20022_context', type=StringType), Parameter(name='iso20022_diagnostics', type=StringType)}, type=BooleanType)
...
iso20022_String.attributes={iso20022_String_maxLength, iso20022_String_minLength, iso20022_String_length, iso20022_String_pattern}
...
iso20022_Decimal.attributes={iso20022_Decimal_minExclusive, iso20022_Decimal_minInclusive, iso20022_Decimal_maxInclusive, iso20022_Decimal_pattern, iso20022_Decimal_maxExclusive, iso20022_Decimal_fractionDigits, iso20022_Decimal_totalDigits}

# iso20022_Amount class attributes and methods

# iso20022_ChoiceComponent class attributes and methods
iso20022_ChoiceComponent_m_AtLeastOneProperty: Method = Method(name="AtLeastOneProperty", parameters={Parameter(name='iso20022_diagnostics', type=StringType), Parameter(name='iso20022_context', type=StringType)}, type=BooleanType)
...
iso20022_AbstractDateTimeConcept.attributes={iso20022_AbstractDateTimeConcept_minExclusive, iso20022_AbstractDateTimeConcept_minInclusive, iso20022_AbstractDateTimeConcept_maxExclusive, iso20022_AbstractDateTimeConcept_maxInclusive, iso20022_AbstractDateTimeConcept_pattern}
...
iso20022_UserDefined.attributes={iso20022_UserDefined_namespace, iso20022_UserDefined_processContents, iso20022_UserDefined_namespaceList}
...
domain_model = DomainModel(
    name="iso20022",
    types={iso20022_ModelEntity, iso20022_Address, ModelEntity, iso20022_BroadcastList, iso20022_MessagingEndpoint, iso20022_MessageTransportSystem, iso20022_TransportMessage, iso20022_MessageInstance, iso20022_SyntaxMessageScheme, iso20022_BusinessProcessCatalogue, iso20022_RepositoryConcept, TopLevelCatalogueEntry, iso20022_MessageDefinition, iso20022_TopLevelCatalogueEntry, RepositoryConcept, iso20022_Constraint, iso20022_SemanticMarkup, iso20022_Doclet, iso20022_SemanticMarkupElement, iso20022_TopLevelDictionaryEntry, iso20022_Repository, iso20022_DataDictionary, iso20022_MessageSet, iso20022_BusinessArea, RepositoryType, iso20022_MessageTransmission, iso20022_MessageDefinitionIdentifier, iso20022_RepositoryType, iso20022_Xor, iso20022_MessageBuildingBlock, iso20022_MessageChoreography, iso20022_Syntax, iso20022_Encoding, iso20022_MessageElement, MessageConcept, iso20022_MessageComponent, MessageConstruct, iso20022_MessageConstruct, Construct, iso20022_LogicalType, iso20022_Construct, MultiplicityEntity, iso20022_BusinessComponent, iso20022_BusinessElement, iso20022_MessageElementContainer, iso20022_MessageConcept, TopLevelDictionaryEntry, BusinessElementType, BusinessConcept, iso20022_MultiplicityEntity, iso20022_MessageComponentType, iso20022_BusinessAssociationEnd, iso20022_BusinessElementType, LogicalType, iso20022_BusinessConcept, iso20022_DataType, BusinessElement, MessageComponentType, iso20022_BusinessTransaction, iso20022_BusinessProcess, iso20022_Participant, MessageElementContainer, iso20022_BusinessRole, iso20022_MessageTransportMode, iso20022_Receive, iso20022_Send, iso20022_Conversation, iso20022_MessageAssociationEnd, MessageElement, iso20022_MessageAttribute, iso20022_BusinessAttribute, iso20022_Text, String, iso20022_String, DataType, iso20022_IdentifierSet, iso20022_Indicator, Boolean, iso20022_Boolean, iso20022_ExternalSchema, iso20022_Quantity, iso20022_Rate, Decimal, iso20022_Decimal, iso20022_Amount, iso20022_ChoiceComponent, iso20022_Code, iso20022_CodeSet, iso20022_AbstractDateTimeConcept, iso20022_EndPointCategory, iso20022_Binary, iso20022_DateTime, iso20022_Day, iso20022_Duration, iso20022_Month, iso20022_MonthDay, iso20022_Time, iso20022_Year, iso20022_YearMonth, iso20022_UserDefined, iso20022_Date, AbstractDateTimeConcept, iso20022_IndustryMessageSet, iso20022_ConvergenceDocumentation, iso20022_ISO15022MessageSet, IndustryMessageSet, iso20022_SchemaType, RegistrationStatus, Aggregation, DeliveryAssurance, Durability, MessageCasting, MessageDeliveryOrder, MessageValidationOnOff, MessageValidationResults, ReceiverAsynchronicity, SenderAsynchronicity, MessageValidationLevel, ProcessContent, Namespace, SchemaTypeKind, ISO20022Version},
    associations={nextVersions3, broadCastList0, transportSystem8, endpoint1, receivedMessage9, sentMessage10, location12, endpoint15, previousVersion5, address7, messageInstance19, receiver20, specification22, sender17, businessProcessCatalogue26, transportMessage23, messageDefinitionTrace25, constraint30, semanticMarkup27, doclet28, elements31, owner33, businessProcessCatalogue38, topLevelDictionaryEntry41, repository34, topLevelCatalogueEntry35, dataDictionary37, messageSet47, businessArea48, repository42, dataDictionary45, trace55, messageDefinitionIdentifier57, derivation59, xors50, messageBuildingBlock52, choreography53, messageDefinition62, possibleEncodings65, generatedSyntax60, validEncoding61, messageDefinition73, impactedElements75, generatedFor67, messageSet69, syntax71, messageComponent76, impactedMessageBuildingBlocks77, messageDefinition80, xmlMemberType87, businessComponentTrace83, businessElementTrace84, componentContext86, memberType88, derivationComponent97, associationDomain98, derivationElement99, subType90, superType93, element95, businessElementType102, elementContext103, derivation100, simpleType108, complexType110, messageBuildingBlock105, trace106, opposite113, type114, businessTransactionTrace120, messageDefinition122, businessProcessTrace124, messageElement116, participant125, xors118, subTransaction132, parentTransaction135, trace137, extender140, extended143, included146, includer149, businessRole151, businessProcessTrace152, transmission126, messageTransportMode129, businessTransaction159, receives161, sends163, businessRoleTrace165, messageTransmission168, receiver170, businessTransaction172, businessRoleTrace155, businessProcess157, receive179, sender182, messageTransmission184, derivation174, send177, businessTransaction186, type188, simpleType189, complexType191, complexType196, simpleType194, trace200, derivation204, code207, currencyIdentifierSet209, owner198, endPoints211},
    generalizations={gen_iso20022_Address_ModelEntity, gen_iso20022_MessagingEndpoint_ModelEntity, gen_iso20022_MessageTransportSystem_ModelEntity, gen_iso20022_BroadcastList_ModelEntity, gen_iso20022_MessageInstance_ModelEntity, gen_iso20022_TransportMessage_ModelEntity, gen_iso20022_RepositoryConcept_ModelEntity, gen_iso20022_SyntaxMessageScheme_TopLevelCatalogueEntry, gen_iso20022_TopLevelCatalogueEntry_RepositoryConcept, gen_iso20022_SemanticMarkup_ModelEntity, gen_iso20022_Doclet_ModelEntity, gen_iso20022_SemanticMarkupElement_ModelEntity, gen_iso20022_BusinessProcessCatalogue_ModelEntity, gen_iso20022_Constraint_RepositoryConcept, gen_iso20022_DataDictionary_ModelEntity, gen_iso20022_Repository_ModelEntity, gen_iso20022_TopLevelDictionaryEntry_RepositoryConcept, gen_iso20022_MessageDefinition_RepositoryType, gen_iso20022_RepositoryType_RepositoryConcept, gen_iso20022_Syntax_ModelEntity, gen_iso20022_MessageSet_TopLevelCatalogueEntry, gen_iso20022_BusinessArea_TopLevelCatalogueEntry, gen_iso20022_Xor_RepositoryConcept, gen_iso20022_Encoding_ModelEntity, gen_iso20022_MessageElement_MessageConcept, gen_iso20022_MessageElement_MessageConstruct, gen_iso20022_MessageConstruct_Construct, gen_iso20022_Construct_RepositoryConcept, gen_iso20022_Construct_MultiplicityEntity, gen_iso20022_LogicalType_RepositoryType, gen_iso20022_MessageConcept_ModelEntity, gen_iso20022_BusinessComponent_TopLevelDictionaryEntry, gen_iso20022_BusinessComponent_BusinessElementType, gen_iso20022_BusinessComponent_BusinessConcept, gen_iso20022_BusinessElementType_RepositoryType, gen_iso20022_MessageComponentType_TopLevelDictionaryEntry, gen_iso20022_MessageComponentType_LogicalType, gen_iso20022_MessageComponentType_MessageConcept, gen_iso20022_BusinessConcept_ModelEntity, gen_iso20022_BusinessElement_Construct, gen_iso20022_BusinessElement_BusinessConcept, gen_iso20022_DataType_TopLevelDictionaryEntry, gen_iso20022_DataType_BusinessElementType, gen_iso20022_DataType_LogicalType, gen_iso20022_BusinessAssociationEnd_BusinessElement, gen_iso20022_MessageBuildingBlock_MessageConstruct, gen_iso20022_MessageElementContainer_MessageComponentType, gen_iso20022_MessageChoreography_TopLevelCatalogueEntry, gen_iso20022_BusinessTransaction_TopLevelCatalogueEntry, gen_iso20022_MessageComponent_MessageElementContainer, gen_iso20022_BusinessProcess_TopLevelCatalogueEntry, gen_iso20022_Participant_RepositoryConcept, gen_iso20022_Participant_MultiplicityEntity, gen_iso20022_Receive_ModelEntity, gen_iso20022_MessageTransmission_RepositoryConcept, gen_iso20022_BusinessRole_RepositoryConcept, gen_iso20022_Send_ModelEntity, gen_iso20022_MessageTransportMode_TopLevelCatalogueEntry, gen_iso20022_MessageDefinitionIdentifier_ModelEntity, gen_iso20022_Conversation_ModelEntity, gen_iso20022_MessageAssociationEnd_MessageElement, gen_iso20022_MessageAttribute_MessageElement, gen_iso20022_BusinessAttribute_BusinessElement, gen_iso20022_Text_String, gen_iso20022_String_DataType, gen_iso20022_IdentifierSet_String, gen_iso20022_Indicator_Boolean, gen_iso20022_Boolean_DataType, gen_iso20022_Decimal_DataType, gen_iso20022_ExternalSchema_MessageComponentType, gen_iso20022_Quantity_Decimal, gen_iso20022_Rate_Decimal, gen_iso20022_CodeSet_String, gen_iso20022_Amount_Decimal, gen_iso20022_ChoiceComponent_MessageElementContainer, gen_iso20022_Code_RepositoryConcept, gen_iso20022_AbstractDateTimeConcept_DataType, gen_iso20022_EndPointCategory_TopLevelDictionaryEntry, gen_iso20022_Binary_DataType, gen_iso20022_DateTime_AbstractDateTimeConcept, gen_iso20022_Day_AbstractDateTimeConcept, gen_iso20022_Duration_AbstractDateTimeConcept, gen_iso20022_Month_AbstractDateTimeConcept, gen_iso20022_MonthDay_AbstractDateTimeConcept, gen_iso20022_Time_AbstractDateTimeConcept, gen_iso20022_Year_AbstractDateTimeConcept, gen_iso20022_YearMonth_AbstractDateTimeConcept, gen_iso20022_UserDefined_MessageComponentType, gen_iso20022_Date_AbstractDateTimeConcept, gen_iso20022_IndustryMessageSet_TopLevelCatalogueEntry, gen_iso20022_ConvergenceDocumentation_TopLevelCatalogueEntry, gen_iso20022_ISO15022MessageSet_IndustryMessageSet, gen_iso20022_SchemaType_DataType},
    metadata=None
)
