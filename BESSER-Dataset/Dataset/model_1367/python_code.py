...
class HSM_AbstractState(ABC):
    ...
    def __init__(self, name: str, HSM_AbstractState7: "HSM_Transition" = None, _states: "HSM_StateMachine" = None, AbstractState: "HSM_StateMachine" = None, _states11: "HSM_CompositeState" = None, AbstractState13: "HSM_CompositeState" = None, HSM_AbstractState: "HSM_Transition" = None):
        self.name = name
...
class HSM_Transition:
    ...
    def __init__(self, label: str, HSM_Transition: "HSM_AbstractState" = None, HSM_Transition6: "HSM_AbstractState" = None, Transition: "HSM_StateMachine" = None, _transitions: "HSM_StateMachine" = None):
        self.label = label
...
class HSM_StateMachine:
    ...
    def __init__(self, name: str, StateMachine9: "HSM_AbstractState" = None, stateMachine: set["HSM_Transition"] = None, stateMachine2: set["HSM_AbstractState"] = None, StateMachine: "HSM_Transition" = None):
        self.name = name
