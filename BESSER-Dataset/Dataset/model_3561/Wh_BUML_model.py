...
domain_model = DomainModel(
    name="wh",
    types={wh_Model, wh_Program, wh_EObject, wh_Nop, wh_Assign, wh_Vars, wh_Exprs, wh_While, wh_Expr, wh_For, wh_If, wh_Function, wh_Definition, wh_Input, wh_Commands, wh_Output, wh_Command, wh_LExpr, wh_ExprOr, wh_ExprNot, wh_Foreach, wh_ExprAnd, wh_ExprSimple, wh_ExprEq},
    associations={text0, command13, vars15, exprs16, cond18, commands19, cond22, commands24, cond27, functions1, definition3, inputs5, commands7, outputs9, command11, cons_exp48, list_exp49, hd_expr52, tl_expr55, expr_or58, expr_not60, if_commands29, else_commands32, cond35, ens37, commands40, expr43, expr_and46, expr_eq62, expr_left64, expr_right67, lexpr70, expr73, expr76},
    generalizations={},
    metadata=None
)
