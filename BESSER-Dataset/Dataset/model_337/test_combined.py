...
def test_assoc_author18_link_reassign_clear():
    ...
    _safe_set(a, 'extlibrary_Writer20', b1)
    assert _is_linked(a, 'extlibrary_Writer20', b1)
    if hasattr(b1, 'extlibrary_BookOnTape19'):
        assert _is_linked(b1, 'extlibrary_BookOnTape19', a)
    _safe_set(a, 'extlibrary_Writer20', b2)
    assert _is_linked(a, 'extlibrary_Writer20', b2)
    if hasattr(b1, 'extlibrary_BookOnTape19'):
        assert not _is_linked(b1, 'extlibrary_BookOnTape19', a)
    if hasattr(b2, 'extlibrary_BookOnTape19'):
        assert _is_linked(b2, 'extlibrary_BookOnTape19', a)
    _safe_set(a, 'extlibrary_Writer20', None)
    assert not _is_linked(a, 'extlibrary_Writer20', b2)
    if hasattr(b2, 'extlibrary_BookOnTape19'):
        assert not _is_linked(b2, 'extlibrary_BookOnTape19', a)
...
def test_assoc_cast21_link_reassign_clear():
    ...
    _safe_set(a, 'extlibrary_Person22', b1)
    assert _is_linked(a, 'extlibrary_Person22', b1)
    if hasattr(b1, 'extlibrary_VideoCassette'):
        assert _is_linked(b1, 'extlibrary_VideoCassette', a)
    _safe_set(a, 'extlibrary_Person22', b2)
    assert _is_linked(a, 'extlibrary_Person22', b2)
    if hasattr(b1, 'extlibrary_VideoCassette'):
    ...
    _safe_set(a, 'extlibrary_Person22', None)
    assert not _is_linked(a, 'extlibrary_Person22', b2)
    if hasattr(b2, 'extlibrary_VideoCassette'):
