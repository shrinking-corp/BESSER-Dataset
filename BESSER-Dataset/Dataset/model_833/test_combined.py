...
def test_tfsmextended_FSMEvent_isTriggered_value_roundtrip():
    instance = tfsmextended_FSMEvent(isTriggered="sample_text")
...
def test_assoc_generatedEvents21_link_reassign_clear():
    ...
    b1 = tfsmextended_FSMEvent(isTriggered="sample_text")
    b2 = tfsmextended_FSMEvent(isTriggered="sample_text_2")
...
def test_assoc_globalEvents36_link_reassign_clear():
    a = tfsmextended_FSMEvent(isTriggered="sample_text")
    b1 = tfsmextended_TimedSystem()
    b2 = tfsmextended_TimedSystem()
...
tfsmextended_FSMEvent_strategy = st.builds(tfsmextended_FSMEvent, isTriggered=safe_text)
@given(instance=tfsmextended_FSMEvent_strategy)
@settings(max_examples=25)
