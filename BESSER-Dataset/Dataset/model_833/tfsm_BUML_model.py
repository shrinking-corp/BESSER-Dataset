...
domain_model = DomainModel(
    name="tfsmextended",
    types={NamedElement, tfsmextended_State, tfsmextended_TFSM, tfsmextended_NamedElement, tfsmextended_FSMEvent, tfsmextended_FSMClock, tfsmextended_Transition, tfsmextended_Guard, tfsmextended_TemporalGuard, Guard, tfsmextended_EventGuard, tfsmextended_TimedSystem, tfsmextended_EvaluateGuard},
    ...
    generalizations={gen_tfsmextended_TFSM_NamedElement, gen_tfsmextended_Guard_NamedElement, gen_tfsmextended_State_NamedElement, gen_tfsmextended_Transition_NamedElement, gen_tfsmextended_TemporalGuard_Guard, gen_tfsmextended_EventGuard_Guard, gen_tfsmextended_FSMEvent_NamedElement, gen_tfsmextended_FSMClock_NamedElement, gen_tfsmextended_TimedSystem_NamedElement, gen_tfsmextended_EvaluateGuard_Guard},
    metadata=None
)
