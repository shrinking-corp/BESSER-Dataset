...
# Classes
whileLanguage_Nop = Class(name="whileLanguage_Nop")
whileLanguage_Command = Class(name="whileLanguage_Command")
whileLanguage_EObject = Class(name="whileLanguage_EObject")
whileLanguage_Foreach = Class(name="whileLanguage_Foreach")
whileLanguage_Program = Class(name="whileLanguage_Program")
whileLanguage_Function = Class(name="whileLanguage_Function")
whileLanguage_Definition = Class(name="whileLanguage_Definition")
whileLanguage_Read = Class(name="whileLanguage_Read")
whileLanguage_Commands = Class(name="whileLanguage_Commands")
whileLanguage_Write = Class(name="whileLanguage_Write")
whileLanguage_Affectation = Class(name="whileLanguage_Affectation")
whileLanguage_Expr = Class(name="whileLanguage_Expr")
whileLanguage_If = Class(name="whileLanguage_If")
whileLanguage_For = Class(name="whileLanguage_For")
whileLanguage_While = Class(name="whileLanguage_While")
whileLanguage_Lexpr = Class(name="whileLanguage_Lexpr")
...
domain_model = DomainModel(
    name="whileLanguage",
    types={whileLanguage_Nop, whileLanguage_Command, whileLanguage_EObject, whileLanguage_Foreach, whileLanguage_Program, whileLanguage_Function, whileLanguage_Definition, whileLanguage_Read, whileLanguage_Commands, whileLanguage_Write, whileLanguage_Affectation, whileLanguage_Expr, whileLanguage_If, whileLanguage_For, whileLanguage_While, whileLanguage_Lexpr},
    associations={commands10, command12, expr114, expr216, commands19, functions0, definition1, read3, commands5, write7, valeurs9, expr22, commands124, commands227, expr30, commands32, expr35, commands37, lexpr40, expr43, ex146, ex249, exprs51},
    generalizations={},
    metadata=None
)
