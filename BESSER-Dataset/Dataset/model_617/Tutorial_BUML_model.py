...
tutorial_Library_m_findBook: Method = Method(name="findBook", parameters={Parameter(name='tutorial_bookName', type=StringType)}, type=StringType)
...
domain_model = DomainModel(
    ...
    associations={books0, library4, loans5, library7, book9, member12, loans1, members2},
    generalizations={},
    metadata=None
)
