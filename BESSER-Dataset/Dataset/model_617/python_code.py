...
class tutorial_Member:
    ...
    def __init__(self, name: str, members: "tutorial_Library" = None, tutorial_Member: "tutorial_Loan" = None, Member: "tutorial_Library" = None):
        self.name = name
...
class tutorial_Loan:
    ...
    def __init__(self, date: date, tutorial_Loan6: "tutorial_Book" = None, tutorial_Loan10: "tutorial_Book" = None, tutorial_Loan13: "tutorial_Member" = None, tutorial_Loan: "tutorial_Library" = None):
        self.date = date
...
class tutorial_Library:
    ...
    def __init__(self, name: str, library: set["tutorial_Book"] = None, Library: "tutorial_Book" = None, Library8: "tutorial_Member" = None, tutorial_Library: set["tutorial_Loan"] = None, library3: set["tutorial_Member"] = None):
        self.name = name
    ...
    def findBook(self, tutorial_bookName) :
