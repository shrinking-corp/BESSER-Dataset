...
GameView.attributes={GameView_dealButton, GameView_showStrategy, GameView_bet, GameView_doubleButton, GameView_hitButton, GameView_splitButton, GameView_standButton}
...
PlayerView.attributes={PlayerView_status, PlayerView_moneyBox, PlayerView_cardTotal, PlayerView_busted, PlayerView_cardLabels, PlayerView_player}
...
Card.attributes={Card_valueHard, Card_avatar, Card_suit, Card_Count, Card_name, Card_rank, Card_valueSoft}
...
domain_model = DomainModel(
    name="b7b605d7_d1b4_4b6b_89eb_735bd167acba",
    ...
    associations={Blackjack_GameView, Blackjack_Strategy, PlayerView_GameView, Player_Blackjack, Dealer_Blackjack, Blackjack_Deck, BasePlayer_PlayerView, Player_Profile, Dealer_Hand, LoginView_Profile2, GameLauncher_LoginView, Profile_Blackjack, Player_Hand, Hand_Card, Deck_Card},
    generalizations={},
    metadata=None
)
