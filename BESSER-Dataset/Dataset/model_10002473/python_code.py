...
class BlackjackGame:
    ...
    def __init__(self, deck: Deck, dealer: Dealer, player: Player, bet: int, gameView6: "GameView" = None, strategy8: "Strategy" = None, player13: "Player" = None, dealer15: "Dealer" = None, deck216: "Deck" = None, profile5: "Profile" = None):
        self.deck = deck
        self.dealer = dealer
        self.player = player
        self.bet = bet
