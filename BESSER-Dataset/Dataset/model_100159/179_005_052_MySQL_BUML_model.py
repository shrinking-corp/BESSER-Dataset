...
MySQL_Column_null: Property = Property(name="null", type=StringType)
...
MySQL_Column.attributes={MySQL_Column_type, MySQL_Column_comment, MySQL_Column_null, MySQL_Column_isPrimaryKey, MySQL_Column_defaultValue}
...
domain_model = DomainModel(
    name="MySQL",
    types={MySQL_DataBase, NamedElement, Table, MySQL_Table, Column, DataBase, MySQL_NamedElement, MySQL_Column, MySQL_IntegerColumn, MySQL_EnumColumn, EnumSet, MySQL_EnumSet, EnumItem, MySQL_EnumItem},
    associations={tables0, columns1, database2, table3, enumSet5, enumItems6, enumSet7},
    generalizations={gen_MySQL_DataBase_NamedElement, gen_MySQL_Table_NamedElement, gen_MySQL_Column_NamedElement, gen_MySQL_IntegerColumn_Column, gen_MySQL_EnumColumn_Column, gen_MySQL_EnumItem_NamedElement},
    metadata=None
)
