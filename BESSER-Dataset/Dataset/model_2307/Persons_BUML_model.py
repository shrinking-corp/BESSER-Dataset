...
# Classes
Persons_PersonsModel = Class(name="Persons_PersonsModel")
Persons_Employee = Class(name="Persons_Employee")
...
persons1: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="model", type=Person, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
model0: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="persons", type=PersonsModel, multiplicity=Multiplicity(1, 1))
    }
)
...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={Persons_PersonsModel, Persons_Employee, Persons_Person, PersonsModel, Persons_Male, Person, Persons_Female},
    associations={persons1, model0},
    generalizations={gen_Persons_Employee_Person, gen_Persons_Male_Person, gen_Persons_Female_Person},
    metadata=None
)
