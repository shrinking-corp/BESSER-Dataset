...
# Classes
test_StringToTestElementMap = Class(name="test_StringToTestElementMap")
test_TestElement = Class(name="test_TestElement")
EObject = Class(name="EObject")
test_TestElementToTestElementMap = Class(name="test_TestElementToTestElementMap")
test_StringToStringMap = Class(name="test_StringToStringMap")
test_TestElementToStringMap = Class(name="test_TestElementToStringMap")
test_TestType = Class(name="test_TestType")
test_TypeWithFeatureMapNonContainment = Class(name="test_TypeWithFeatureMapNonContainment")
TestType = Class(name="TestType")
test_TypeWithFeatureMapContainment = Class(name="test_TypeWithFeatureMapContainment")
...
test_TestElement.attributes={test_TestElement_featureMapEntries, test_TestElement_strings, test_TestElement_description, test_TestElement_name}
...
domain_model = DomainModel(
    name="test",
    types={test_StringToTestElementMap, test_TestElement, EObject, test_TestElementToTestElementMap, test_StringToStringMap, test_TestElementToStringMap, test_TestType, test_TypeWithFeatureMapNonContainment, TestType, test_TypeWithFeatureMapContainment},
    associations={stringToElementMap25, nonContained_NTo128, references1, containedElements3, reference5, containedElement8, otherReference11, container14, srefContainer17, elementMap19, stringToStringMap21, elementToStringMap23, value60, key63, nonContained_1ToN31, nonContained_NToM34, nonContained_MToN37, containedElements240, container243, containedElements_NoOpposite46, containedElement_NoOpposite49, featureMapReferences152, featureMapReferences255, key57, value66, firstKey69, secondKey70, firstKeyContainment73, secondKeyContainment75},
    generalizations={gen_test_TestElement_EObject, gen_test_TypeWithFeatureMapNonContainment_TestType, gen_test_TypeWithFeatureMapContainment_TestType},
    metadata=None
)
