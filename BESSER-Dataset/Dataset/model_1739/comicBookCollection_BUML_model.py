...
# Classes
comicBookCollection_Series = Class(name="comicBookCollection_Series")
comicBookCollection_Book = Class(name="comicBookCollection_Book")
comicBookCollection_Person = Class(name="comicBookCollection_Person")
comicBookCollection_ComicBookCollection = Class(name="comicBookCollection_ComicBookCollection")
comicBookCollection_Publisher = Class(name="comicBookCollection_Publisher")
...
domain_model = DomainModel(
    ...
    types={comicBookCollection_Series, comicBookCollection_Book, comicBookCollection_Person, comicBookCollection_ComicBookCollection, comicBookCollection_Publisher},
