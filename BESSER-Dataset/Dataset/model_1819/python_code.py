...
class doc_builder_BookBuilder(Map):
    ...
    def __init__(self, title: str, version: str, license: str, copyrightMarker: str, doc_builder_BookBuilder: set["Author"] = None, doc_builder_BookBuilder22: set["builder_PropertyEntry"] = None, doc_builder_BookBuilder19: set["Copyright"] = None):
        self.title = title
...
class doc_fragment_PlainTextContent(Content):
    ...
    def __init__(self, value: str, Content: "doc_fragment_Container" = None, Content13: "doc_book_BookContainer" = None):
        self.value = value
