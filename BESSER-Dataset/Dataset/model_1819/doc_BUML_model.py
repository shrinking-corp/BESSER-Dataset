...
# Classes
doc_Test = Class(name="doc_Test")
doc_map_Map = Class(name="doc_map_Map")
MapContainer = Class(name="MapContainer")
ExtensionMappingEntry = Class(name="ExtensionMappingEntry")
doc_map_Import = Class(name="doc_map_Import", is_abstract=True)
MapElement = Class(name="MapElement")
doc_map_File = Class(name="doc_map_File")
Import = Class(name="Import")
doc_map_MapElement = Class(name="doc_map_MapElement", is_abstract=True)
doc_map_Feature = Class(name="doc_map_Feature")
NameRule = Class(name="NameRule")
doc_map_NameRule = Class(name="doc_map_NameRule", is_abstract=True)
doc_map_PatternRule = Class(name="doc_map_PatternRule", is_abstract=True)
doc_map_IncludePatternRule = Class(name="doc_map_IncludePatternRule")
PatternRule = Class(name="PatternRule")
doc_map_MapSection = Class(name="doc_map_MapSection")
map_MapContainer = Class(name="map_MapContainer")
map_MapElement = Class(name="map_MapElement")
doc_map_ExcludePatternRule = Class(name="doc_map_ExcludePatternRule")
doc_map_ResourceFactory = Class(name="doc_map_ResourceFactory")
doc_map_ExtensionMappingEntry = Class(name="doc_map_ExtensionMappingEntry")
ResourceFactory = Class(name="ResourceFactory")
doc_fragment_Fragment = Class(name="doc_fragment_Fragment")
Container = Class(name="Container")
doc_fragment_Section = Class(name="doc_fragment_Section", is_abstract=True)
doc_fragment_Container = Class(name="doc_fragment_Container", is_abstract=True)
Content = Class(name="Content")
Section = Class(name="Section")
doc_fragment_PlainTextContent = Class(name="doc_fragment_PlainTextContent")
doc_fragment_Content = Class(name="doc_fragment_Content", is_abstract=True)
doc_fragment_Author = Class(name="doc_fragment_Author")
doc_map_ContentGenerator = Class(name="doc_map_ContentGenerator", is_abstract=True)
fragment_Content = Class(name="fragment_Content")
doc_map_MapContainer = Class(name="doc_map_MapContainer", is_abstract=True)
doc_book_Book = Class(name="doc_book_Book")
BookContainer = Class(name="BookContainer")
Copyright = Class(name="Copyright")
doc_book_BookSection = Class(name="doc_book_BookSection")
doc_book_BookContainer = Class(name="doc_book_BookContainer", is_abstract=True)
BookSection = Class(name="BookSection")
doc_builder_BookBuilder = Class(name="doc_builder_BookBuilder")
Map = Class(name="Map")
doc_fragment_Copyright = Class(name="doc_fragment_Copyright")
Author = Class(name="Author")
builder_PropertyEntry = Class(name="builder_PropertyEntry")
doc_builder_PropertyEntry = Class(name="doc_builder_PropertyEntry")

# doc_Test class attributes and methods

# doc_map_Map class attributes and methods
doc_map_Map_m_visit: Method = Method(name="visit", parameters={Parameter(name='doc_visitor', type=StringType)})
...
doc_map_MapElement_m_visit: Method = Method(name="visit", parameters={Parameter(name='doc_visitor', type=StringType)})
...
doc_map_NameRule_m_checkRule: Method = Method(name="checkRule", parameters={Parameter(name='doc_name', type=StringType)}, type=StringType)
...
doc_map_IncludePatternRule_m_checkRule: Method = Method(name="checkRule", parameters={Parameter(name='doc_name', type=StringType)}, type=StringType)
...
doc_map_ExcludePatternRule_m_checkRule: Method = Method(name="checkRule", parameters={Parameter(name='doc_name', type=StringType)}, type=StringType)
...
doc_fragment_Author.attributes={doc_fragment_Author_ref, doc_fragment_Author_name, doc_fragment_Author_id}
...
doc_book_Book.attributes={doc_book_Book_copyrightText, doc_book_Book_title, doc_book_Book_copyrightMarker, doc_book_Book_version}
...
doc_book_BookSection.attributes={doc_book_BookSection_title, doc_book_BookSection_id, doc_book_BookSection_number, doc_book_BookSection_fullNumber}
...
doc_builder_BookBuilder.attributes={doc_builder_BookBuilder_license, doc_builder_BookBuilder_title, doc_builder_BookBuilder_version, doc_builder_BookBuilder_copyrightMarker}
...
domain_model = DomainModel(
    name="doc",
    types={doc_Test, doc_map_Map, MapContainer, ExtensionMappingEntry, doc_map_Import, MapElement, doc_map_File, Import, doc_map_MapElement, doc_map_Feature, NameRule, doc_map_NameRule, doc_map_PatternRule, doc_map_IncludePatternRule, PatternRule, doc_map_MapSection, map_MapContainer, map_MapElement, doc_map_ExcludePatternRule, doc_map_ResourceFactory, doc_map_ExtensionMappingEntry, ResourceFactory, doc_fragment_Fragment, Container, doc_fragment_Section, doc_fragment_Container, Content, Section, doc_fragment_PlainTextContent, doc_fragment_Content, doc_fragment_Author, doc_map_ContentGenerator, fragment_Content, doc_map_MapContainer, doc_book_Book, BookContainer, Copyright, doc_book_BookSection, doc_book_BookContainer, BookSection, doc_builder_BookBuilder, Map, doc_fragment_Copyright, Author, builder_PropertyEntry, doc_builder_PropertyEntry, NumberingStyle, RuleResult},
    associations={extensionMappings0, fileNameRules1, factory2, anyContent4, section5, elements3, author7, authors8, copyright10, content12, sections14, authors16, properties21, copyright18},
    generalizations={gen_doc_map_Map_MapContainer, gen_doc_map_Import_MapElement, gen_doc_map_File_Import, gen_doc_map_Feature_Import, gen_doc_map_PatternRule_NameRule, gen_doc_map_IncludePatternRule_PatternRule, gen_doc_map_MapSection_map_MapContainer, gen_doc_map_MapSection_map_MapElement, gen_doc_map_ExcludePatternRule_PatternRule, gen_doc_fragment_Fragment_Container, gen_doc_fragment_Section_Container, gen_doc_fragment_PlainTextContent_Content, gen_doc_map_ContentGenerator_map_MapElement, gen_doc_map_ContentGenerator_fragment_Content, gen_doc_book_Book_BookContainer, gen_doc_book_BookSection_BookContainer, gen_doc_builder_BookBuilder_Map},
    metadata=None
)
