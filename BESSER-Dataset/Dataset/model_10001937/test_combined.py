...
def test_hyp_attendance_system_actor_is_not_abstract():
    assert not inspect.isabstract(Attendance_system_Actor)


def test_hyp_attendance_system_actor_constructor_exists():
    assert callable(Attendance_system_Actor.__init__)


def test_hyp_attendance_system_actor_constructor_args():
...
Attendance_system_Actor_strategy = st.builds(Attendance_system_Actor)
