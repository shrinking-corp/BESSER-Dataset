...
class Account:
    ...
    def __init__(self, billingAddress: str, open: date, closed: date, isClosed: bool, p0: set["Payment"] = None, cart8: "ShoppingCart" = None, order16: set["Order"] = None, customer7: "Customer" = None):
