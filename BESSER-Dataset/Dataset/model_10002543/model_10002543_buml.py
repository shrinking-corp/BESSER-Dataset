...
Order.attributes={Order_total, Order_ordered, Order_shipped, Order_status, Order_number, Order_shipTo}
...
domain_model = DomainModel(
    name="bf7e99be_b762_4a2d_bc4b_a89462e4aae6",
    types={Customer, Payment, ShoppingCart, Account, WebUser, Order, LineItem, Product, UserState, OrderStatus},
    associations={Account_Payment, Account_ShoppingCart, ShoppingCart_LineItem, Product_LineItem, Order_LineItem, Account_Order, Payment_Order, WebUser_ShoppingCart, WebUser_Customer, Customer_Account},
    generalizations={},
    metadata=None
)
