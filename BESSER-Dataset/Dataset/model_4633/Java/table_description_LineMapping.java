...
public class table_description_LineMapping extends description_StyleUpdater, description_TableMapping {
    ...
    public table_description_LineMapping(
        String semanticCandidatesExpression,        String headerLabelExpression,        String domainClass    ) {
        super(
        );
    ...
    public table_description_LineMapping(
        String semanticCandidatesExpression,        String headerLabelExpression,        String domainClass        ArrayList<LineMapping> linemappings,        ArrayList<LineMapping> linemappings,        ArrayList<CreateLineTool> createlinetools,        ArrayList<LineMapping> linemappings,        ArrayList<LineMapping> linemappings    ) {
        this.semanticCandidatesExpression = semanticCandidatesExpression;
        this.headerLabelExpression = headerLabelExpression;
        this.domainClass = domainClass;
