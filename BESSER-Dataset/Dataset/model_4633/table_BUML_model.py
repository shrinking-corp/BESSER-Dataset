...
table_DTableElementStyle.attributes={table_DTableElementStyle_labelSize, table_DTableElementStyle_backgroundColor, table_DTableElementStyle_labelFormat, table_DTableElementStyle_defaultBackgroundStyle, table_DTableElementStyle_defaultForegroundStyle, table_DTableElementStyle_foregroundColor}
...
table_description_IntersectionMapping.attributes={table_description_IntersectionMapping_columnFinderExpression, table_description_IntersectionMapping_labelExpression, table_description_IntersectionMapping_useDomainClass, table_description_IntersectionMapping_lineFinderExpression, table_description_IntersectionMapping_domainClass, table_description_IntersectionMapping_semanticCandidatesExpression, table_description_IntersectionMapping_preconditionExpression}
