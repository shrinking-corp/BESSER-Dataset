...
javaMM_Modifier.attributes={javaMM_Modifier_synchronized, javaMM_Modifier_volatile, javaMM_Modifier_strictfp, javaMM_Modifier_native, javaMM_Modifier_inheritance, javaMM_Modifier_static, javaMM_Modifier_transient, javaMM_Modifier_visibility}
...
javaMM_MethodDeclaration.methods={javaMM_MethodDeclaration_m_isFinalize, javaMM_MethodDeclaration_m_isHashcode, javaMM_MethodDeclaration_m_isEquals, javaMM_MethodDeclaration_m_isToString, javaMM_MethodDeclaration_m_isCompareTo, javaMM_MethodDeclaration_m_isClone}
...
publicFieldsOnlyInPOJO: Constraint = Constraint(
    ...
    expression="context ClassDeclaration inv: self.getPublicFields->notEmpty() implies self.bodyDeclarations->select(bd | bd.oclIsKindOf(MethodDeclaration))->collect(bd | bd.oclAsType(MethodDeclaration))->select(md | (md.modifier = null or md.modifier._'static') and not (md.isEquals or md.isHashcode or md.isToStringor md.isFinalize or md.isClone or md.isCompareTo))->isEmpty()",
    language="OCL"
)
hashCodeAndEquals: Constraint = Constraint(
    name="hashCodeAndEquals",
    context=javaMM_ClassDeclaration,
    expression="context ClassDeclaration inv: let hasEq : Boolean = getMethods->exists(method | method.isEquals),hasHc : Boolean = getMethods->exists(method | method.isHashcode)in(hasEq implies hasHc) and(hasHc implies hasEq)",
    language="OCL"
)
noCovariantEquals: Constraint = Constraint(
    name="noCovariantEquals",
    context=javaMM_ClassDeclaration,
    expression="context ClassDeclaration inv: getMethods->exists(method |method.name = 'equals' andmethod.modifier <> null andmethod.modifier.visibility = VisibilityKind_public andmethod.returnType.type.oclIsTypeOf(PrimitiveTypeBoolean)) implies getMethods->exists(method | method.isEquals)",
    language="OCL"
)
noCovariantCompareTo: Constraint = Constraint(
    name="noCovariantCompareTo",
    context=javaMM_ClassDeclaration,
    expression="context ClassDeclaration inv: getMethods->exists(method |method.name = 'compareTo' andmethod.modifier <> null andmethod.modifier.visibility = VisibilityKind_public andmethod.returnType.type.oclIsTypeOf(PrimitiveTypeInt)) implies getMethods->exists(method | method.isCompareTo)",
    language="OCL"
)
equalsAndCompareTo: Constraint = Constraint(
    name="equalsAndCompareTo",
    context=javaMM_ClassDeclaration,
    expression="context ClassDeclaration inv: getMethods->exists(method | method.isCompareTo) implies getMethods->exists(method | method.isEquals)",
    language="OCL"
)
cloneInCloneable: Constraint = Constraint(
    name="cloneInCloneable",
    context=javaMM_ClassDeclaration,
    expression="context ClassDeclaration inv: self.implements('Cloneable') implies self.getMethods->exists(md | md.isClone)",
    language="OCL"
)
...
domain_model = DomainModel(
    name="javaMM",
    types={javaMM_AbstractMethodDeclaration, BodyDeclaration, javaMM_Expression, javaMM_AbstractTypeDeclaration, Type, javaMM_BodyDeclaration, javaMM_Comment, javaMM_Package, javaMM_Block, javaMM_SingleVariableDeclaration, javaMM_TypeAccess, javaMM_TypeParameter, javaMM_MethodRef, javaMM_AbstractMethodInvocation, ASTNode, javaMM_ASTNode, javaMM_CompilationUnit, javaMM_AnnotationTypeMemberDeclaration, javaMM_AnnotationTypeDeclaration, AbstractTypeDeclaration, javaMM_AbstractTypeQualifiedExpression, Expression, javaMM_AbstractVariablesContainer, javaMM_VariableDeclarationFragment, javaMM_Annotation, javaMM_AnnotationMemberValuePair, javaMM_Archive, NamedElement, javaMM_ClassFile, javaMM_Manifest, javaMM_AssertStatement, Statement, javaMM_ArrayLengthAccess, javaMM_ArrayType, javaMM_Assignment, javaMM_Modifier, javaMM_AnonymousClassDeclaration, javaMM_ClassInstanceCreation, javaMM_ArrayAccess, javaMM_ArrayCreation, javaMM_ArrayInitializer, javaMM_CatchClause, javaMM_CharacterLiteral, javaMM_BooleanLiteral, javaMM_BlockComment, Comment, javaMM_Statement, javaMM_BreakStatement, javaMM_LabeledStatement, javaMM_CastExpression, javaMM_ImportDeclaration, AbstractMethodInvocation, javaMM_ConstructorDeclaration, AbstractMethodDeclaration, javaMM_ConditionalExpression, javaMM_ConstructorInvocation, javaMM_ClassDeclaration, TypeDeclaration, javaMM_ContinueStatement, javaMM_DoStatement, javaMM_EnumConstantDeclaration, VariableDeclaration, javaMM_EnumDeclaration, javaMM_EmptyStatement, javaMM_EnhancedForStatement, javaMM_FieldDeclaration, AbstractVariablesContainer, javaMM_ForStatement, javaMM_ExpressionStatement, javaMM_FieldAccess, javaMM_IfStatement, javaMM_SingleVariableAccess, javaMM_NamedElement, javaMM_InfixExpression, javaMM_Initializer, javaMM_InstanceofExpression, javaMM_InterfaceDeclaration, javaMM_Javadoc, javaMM_TagElement, javaMM_LineComment, javaMM_ManifestAttribute, javaMM_ManifestEntry, javaMM_MemberRef, javaMM_MethodDeclaration, javaMM_MethodInvocation, javaMM_MethodRefParameter, javaMM_Model, javaMM_Type, javaMM_UnresolvedItem, javaMM_VariableDeclarationStatement, javaMM_VariableDeclarationExpression, javaMM_NamespaceAccess, javaMM_NumberLiteral, javaMM_NullLiteral, javaMM_PackageAccess, NamespaceAccess, javaMM_ParameterizedType, javaMM_ParenthesizedExpression, javaMM_PostfixExpression, javaMM_PrefixExpression, javaMM_PrimitiveType, javaMM_PrimitiveTypeBoolean, PrimitiveType, javaMM_PrimitiveTypeByte, javaMM_PrimitiveTypeChar, javaMM_PrimitiveTypeDouble, javaMM_PrimitiveTypeShort, javaMM_PrimitiveTypeFloat, javaMM_PrimitiveTypeInt, javaMM_PrimitiveTypeLong, javaMM_PrimitiveTypeVoid, javaMM_ReturnStatement, javaMM_VariableDeclaration, javaMM_StringLiteral, javaMM_SuperConstructorInvocation, javaMM_SuperFieldAccess, AbstractTypeQualifiedExpression, javaMM_SuperMethodInvocation, javaMM_SwitchCase, javaMM_SwitchStatement, javaMM_SynchronizedStatement, javaMM_TextElement, javaMM_ThisExpression, javaMM_ThrowStatement, javaMM_TryStatement, javaMM_TypeDeclaration, javaMM_TypeDeclarationStatement, javaMM_TypeLiteral, javaMM_UnresolvedItemAccess, javaMM_UnresolvedAnnotationDeclaration, AnnotationTypeDeclaration, UnresolvedItem, javaMM_UnresolvedAnnotationTypeMemberDeclaration, AnnotationTypeMemberDeclaration, javaMM_UnresolvedClassDeclaration, ClassDeclaration, javaMM_UnresolvedEnumDeclaration, EnumDeclaration, javaMM_UnresolvedInterfaceDeclaration, InterfaceDeclaration, javaMM_UnresolvedLabeledStatement, LabeledStatement, javaMM_UnresolvedMethodDeclaration, MethodDeclaration, javaMM_UnresolvedSingleVariableDeclaration, SingleVariableDeclaration, javaMM_UnresolvedType, javaMM_UnresolvedVariableDeclarationFragment, VariableDeclarationFragment, javaMM_UnresolvedTypeDeclaration, javaMM_WildCardType, javaMM_WhileStatement, AssignmentKind, InfixExpressionKind, InheritanceKind, PostfixExpressionKind, PrefixExpressionKind, VisibilityKind},
    associations={method9, arguments10, typeArguments11, bodyDeclarations14, commentsBeforeBody15, commentsAfterBody16, package19, superInterfaces20, body0, parameters1, thrownExceptions2, typeParameters4, usagesInDocComments6, usages7, message35, expression37, comments40, originalCompilationUnit42, originalClassFile44, member47, value49, default52, type54, usages57, qualifier23, type25, fragments27, type28, values30, classFiles32, manifest33, expressions73, array76, elementType78, leftHandSide80, rightHandSide82, abstractTypeDeclaration85, annotations86, anonymousClassDeclarationOwner88, bodyDeclarations58, classInstanceCreation60, array61, index63, dimensions66, initializer68, type70, type96, exception99, body101, type103, attachedSource106, modifier90, statements91, label93, expression94, superClass126, commentList128, imports131, package109, anonymousClassDeclaration111, expression113, type115, elseExpression118, expression120, thenExpression123, types136, label139, package133, parameter151, anonymousClassDeclaration153, arguments154, enumConstants157, expression141, body143, body146, expression148, expression162, expression165, updaters167, initializers170, expression159, body173, field161, expression176, thenStatement178, elseStatement181, importedElement184, rightOperand185, leftOperand187, extendedOperands190, body193, rightOperand195, leftOperand197, tags200, body201, usagesInBreakStatements203, usagesInContinueStatements204, mainAttributes206, entryAttributes208, attributes210, member213, qualifier214, returnType217, redefinedMethodDeclaration220, redefinitions222, expression224, qualifier228, parameters230, type232, ownedElements235, orphanTypes237, unresolvedItems238, compilationUnits240, classFiles243, archives246, bodyDeclaration249, method226, singleVariableDeclaration251, variableDeclarationStatement254, variableDeclarationExpression256, usagesInImports258, ownedElements259, model261, ownedPackages264, type276, package268, usagesInPackageAccess270, package272, qualifier275, modifier293, typeArguments278, expression281, operand283, operand285, expression287, variable289, qualifier290, type295, annotations297, methodDeclaration300, catchClause302, enhancedForStatement303, expression304, catchClauses330, field306, expression308, expression310, statements312, body315, expression317, fragments320, expression323, body325, finally_327, usagesInTypeAccess333, type334, qualifier335, typeParameters337, declaration339, type341, bounds343, element346, qualifier348, initializer351, usageInVariableAccess353, modifier354, annotations356, variablesContainer358, modifier359, annotations361, bound363, expression365, body367},
    constraints={notReservedWord, shouldStartWithUpperCase, shouldStartWithLowerCase, doesNotCallFinalize, doesNotCallExit, doesNotCallRunFinalizers, canBeLocal, localMethodIsUsed, parametersEffectivelyFinal, noRedundantAssignment, variableIsUsed, publicVariableIsFinal, publicVariableIsFinal1, exceptionIsUsed, doesNotCatchDubiousExceptions, emptyBlockIsDocumented, moreThan3Cases, noRedundantSuperCall, noDeadCode, noUselessControlFlow, publicFieldsOnlyInPOJO, hashCodeAndEquals, noCovariantEquals, noCovariantCompareTo, equalsAndCompareTo, cloneInCloneable, serialUIDInSerializableClass, noRedundantInterfaceImpl, comparatorImplementsSerializable, noObscuredVariables, noRedundantComparison, equalsNotOnLiterals, equalsNotOnStrings, hasStatements},
    generalizations={gen_javaMM_AbstractMethodDeclaration_BodyDeclaration, gen_javaMM_AbstractTypeDeclaration_BodyDeclaration, gen_javaMM_AbstractTypeDeclaration_Type, gen_javaMM_AbstractMethodInvocation_ASTNode, gen_javaMM_AnnotationMemberValuePair_NamedElement, gen_javaMM_AnnotationTypeDeclaration_AbstractTypeDeclaration, gen_javaMM_AnnotationTypeMemberDeclaration_BodyDeclaration, gen_javaMM_AbstractTypeQualifiedExpression_Expression, gen_javaMM_AbstractVariablesContainer_ASTNode, gen_javaMM_Annotation_Expression, gen_javaMM_Archive_NamedElement, gen_javaMM_AssertStatement_Statement, gen_javaMM_ArrayLengthAccess_Expression, gen_javaMM_ArrayType_Type, gen_javaMM_Assignment_Expression, gen_javaMM_BodyDeclaration_NamedElement, gen_javaMM_AnonymousClassDeclaration_ASTNode, gen_javaMM_ArrayAccess_Expression, gen_javaMM_ArrayCreation_Expression, gen_javaMM_ArrayInitializer_Expression, gen_javaMM_CatchClause_Statement, gen_javaMM_CharacterLiteral_Expression, gen_javaMM_ClassFile_NamedElement, gen_javaMM_BooleanLiteral_Expression, gen_javaMM_BlockComment_Comment, gen_javaMM_Block_Statement, gen_javaMM_BreakStatement_Statement, gen_javaMM_CastExpression_Expression, gen_javaMM_Comment_ASTNode, gen_javaMM_CompilationUnit_NamedElement, gen_javaMM_ClassInstanceCreation_Expression, gen_javaMM_ClassInstanceCreation_AbstractMethodInvocation, gen_javaMM_ConstructorDeclaration_AbstractMethodDeclaration, gen_javaMM_ConditionalExpression_Expression, gen_javaMM_ConstructorInvocation_Statement, gen_javaMM_ConstructorInvocation_AbstractMethodInvocation, gen_javaMM_ClassDeclaration_TypeDeclaration, gen_javaMM_ContinueStatement_Statement, gen_javaMM_DoStatement_Statement, gen_javaMM_EnumConstantDeclaration_BodyDeclaration, gen_javaMM_EnumConstantDeclaration_VariableDeclaration, gen_javaMM_EnumDeclaration_AbstractTypeDeclaration, gen_javaMM_EmptyStatement_Statement, gen_javaMM_EnhancedForStatement_Statement, gen_javaMM_FieldDeclaration_BodyDeclaration, gen_javaMM_FieldDeclaration_AbstractVariablesContainer, gen_javaMM_ForStatement_Statement, gen_javaMM_Expression_ASTNode, gen_javaMM_ExpressionStatement_Statement, gen_javaMM_FieldAccess_Expression, gen_javaMM_IfStatement_Statement, gen_javaMM_ImportDeclaration_ASTNode, gen_javaMM_InfixExpression_Expression, gen_javaMM_Initializer_BodyDeclaration, gen_javaMM_InstanceofExpression_Expression, gen_javaMM_InterfaceDeclaration_TypeDeclaration, gen_javaMM_Javadoc_Comment, gen_javaMM_LabeledStatement_NamedElement, gen_javaMM_LabeledStatement_Statement, gen_javaMM_LineComment_Comment, gen_javaMM_MemberRef_ASTNode, gen_javaMM_MethodDeclaration_AbstractMethodDeclaration, gen_javaMM_MethodInvocation_Expression, gen_javaMM_MethodInvocation_AbstractMethodInvocation, gen_javaMM_MethodRef_ASTNode, gen_javaMM_MethodRefParameter_ASTNode, gen_javaMM_Modifier_ASTNode, gen_javaMM_NamedElement_ASTNode, gen_javaMM_NamespaceAccess_ASTNode, gen_javaMM_NumberLiteral_Expression, gen_javaMM_NullLiteral_Expression, gen_javaMM_Package_NamedElement, gen_javaMM_PackageAccess_NamespaceAccess, gen_javaMM_ParameterizedType_Type, gen_javaMM_ParenthesizedExpression_Expression, gen_javaMM_PostfixExpression_Expression, gen_javaMM_PrefixExpression_Expression, gen_javaMM_PrimitiveType_Type, gen_javaMM_PrimitiveTypeBoolean_PrimitiveType, gen_javaMM_PrimitiveTypeByte_PrimitiveType, gen_javaMM_PrimitiveTypeChar_PrimitiveType, gen_javaMM_PrimitiveTypeDouble_PrimitiveType, gen_javaMM_PrimitiveTypeShort_PrimitiveType, gen_javaMM_PrimitiveTypeFloat_PrimitiveType, gen_javaMM_PrimitiveTypeInt_PrimitiveType, gen_javaMM_PrimitiveTypeLong_PrimitiveType, gen_javaMM_PrimitiveTypeVoid_PrimitiveType, gen_javaMM_ReturnStatement_Statement, gen_javaMM_SingleVariableAccess_Expression, gen_javaMM_SingleVariableDeclaration_VariableDeclaration, gen_javaMM_Statement_ASTNode, gen_javaMM_StringLiteral_Expression, gen_javaMM_SuperConstructorInvocation_Statement, gen_javaMM_SuperConstructorInvocation_AbstractMethodInvocation, gen_javaMM_SuperFieldAccess_AbstractTypeQualifiedExpression, gen_javaMM_SuperMethodInvocation_AbstractTypeQualifiedExpression, gen_javaMM_SuperMethodInvocation_AbstractMethodInvocation, gen_javaMM_SwitchCase_Statement, gen_javaMM_SwitchStatement_Statement, gen_javaMM_SynchronizedStatement_Statement, gen_javaMM_TagElement_ASTNode, gen_javaMM_TextElement_ASTNode, gen_javaMM_ThisExpression_AbstractTypeQualifiedExpression, gen_javaMM_ThrowStatement_Statement, gen_javaMM_TryStatement_Statement, gen_javaMM_Type_NamedElement, gen_javaMM_TypeAccess_Expression, gen_javaMM_TypeAccess_NamespaceAccess, gen_javaMM_TypeDeclaration_AbstractTypeDeclaration, gen_javaMM_TypeDeclarationStatement_Statement, gen_javaMM_TypeLiteral_Expression, gen_javaMM_TypeParameter_Type, gen_javaMM_UnresolvedItem_NamedElement, gen_javaMM_UnresolvedItemAccess_Expression, gen_javaMM_UnresolvedItemAccess_NamespaceAccess, gen_javaMM_UnresolvedAnnotationDeclaration_AnnotationTypeDeclaration, gen_javaMM_UnresolvedAnnotationDeclaration_UnresolvedItem, gen_javaMM_UnresolvedAnnotationTypeMemberDeclaration_AnnotationTypeMemberDeclaration, gen_javaMM_UnresolvedAnnotationTypeMemberDeclaration_UnresolvedItem, gen_javaMM_UnresolvedClassDeclaration_ClassDeclaration, gen_javaMM_UnresolvedClassDeclaration_UnresolvedItem, gen_javaMM_UnresolvedEnumDeclaration_EnumDeclaration, gen_javaMM_UnresolvedEnumDeclaration_UnresolvedItem, gen_javaMM_UnresolvedInterfaceDeclaration_InterfaceDeclaration, gen_javaMM_UnresolvedInterfaceDeclaration_UnresolvedItem, gen_javaMM_UnresolvedLabeledStatement_LabeledStatement, gen_javaMM_UnresolvedLabeledStatement_UnresolvedItem, gen_javaMM_UnresolvedMethodDeclaration_MethodDeclaration, gen_javaMM_UnresolvedMethodDeclaration_UnresolvedItem, gen_javaMM_UnresolvedSingleVariableDeclaration_SingleVariableDeclaration, gen_javaMM_UnresolvedSingleVariableDeclaration_UnresolvedItem, gen_javaMM_UnresolvedType_Type, gen_javaMM_UnresolvedTypeDeclaration_AbstractTypeDeclaration, gen_javaMM_UnresolvedTypeDeclaration_UnresolvedItem, gen_javaMM_UnresolvedVariableDeclarationFragment_VariableDeclarationFragment, gen_javaMM_UnresolvedVariableDeclarationFragment_UnresolvedItem, gen_javaMM_VariableDeclaration_NamedElement, gen_javaMM_VariableDeclarationExpression_Expression, gen_javaMM_VariableDeclarationExpression_AbstractVariablesContainer, gen_javaMM_VariableDeclarationFragment_VariableDeclaration, gen_javaMM_VariableDeclarationStatement_Statement, gen_javaMM_VariableDeclarationStatement_AbstractVariablesContainer, gen_javaMM_UnresolvedType_UnresolvedItem, gen_javaMM_WildCardType_Type, gen_javaMM_WhileStatement_Statement},
    metadata=None
)
