...
public class javaMM_TypeAccess extends Expression, NamespaceAccess {
    ...
    private javaMM_ParameterizedType javamm_parameterizedtype;
    ...
    private javaMM_TypeParameter javamm_typeparameter;
    ...
    private javaMM_WildCardType javamm_wildcardtype;




    private javaMM_ArrayType javamm_arraytype;
    ...
    public javaMM_ParameterizedType getJavamm_parameterizedtype() {
        return javamm_parameterizedtype;
    }

    public void setJavamm_parameterizedtype(javaMM_ParameterizedType javamm_parameterizedtype) {
        this.javamm_parameterizedtype = javamm_parameterizedtype;
    }
    ...
    public javaMM_TypeParameter getJavamm_typeparameter() {
        return javamm_typeparameter;
    }

    public void setJavamm_typeparameter(javaMM_TypeParameter javamm_typeparameter) {
        this.javamm_typeparameter = javamm_typeparameter;
    }
    public javaMM_ParameterizedType getJavamm_parameterizedtype() {
        return javamm_parameterizedtype;
    }
    ...
    public javaMM_WildCardType getJavamm_wildcardtype() {
        return javamm_wildcardtype;
    }

    public void setJavamm_wildcardtype(javaMM_WildCardType javamm_wildcardtype) {
        this.javamm_wildcardtype = javamm_wildcardtype;
    }
    public javaMM_ArrayType getJavamm_arraytype() {
        return javamm_arraytype;
    }

    public void setJavamm_arraytype(javaMM_ArrayType javamm_arraytype) {
        this.javamm_arraytype = javamm_arraytype;
    }
