...
VISITS_THE_APPLICATION_UseCase = Class(name="VISITS_THE_APPLICATION_UseCase")
CREATES_THE_APPLICATION_UseCase = Class(name="CREATES_THE_APPLICATION_UseCase")
...
REACT_NATIVE_DEVELOPER_Actor = Class(name="REACT_NATIVE_DEVELOPER_Actor")
...
Showroom = Class(name="Showroom")

# CUSTOMER_Actor class attributes and methods

# VISITS_THE_APPLICATION_UseCase class attributes and methods

# CREATES_THE_APPLICATION_UseCase class attributes and methods
...
# REACT_NATIVE_DEVELOPER_Actor class attributes and methods
...
Customer.attributes={Customer_name, Customer_address, Customer_mailid, Customer_phoneno, Customer_id}
...
Product.attributes={Product_name, Product_type, Product_id}
...
Transaction.attributes={Transaction_creditcard, Transaction_cashondelivery, Transaction_debitcard}
...
Feedback.attributes={Feedback_customername, Feedback_id, Feedback_phoneno}
...
Appointment_Time: Property = Property(name="Time", type=FloatType)
Appointment_Ap_ID: Property = Property(name="Ap_ID", type=StringType)
Appointment_Confirmation: Property = Property(name="Confirmation", type=BooleanType)
Appointment_E_ID: Property = Property(name="E_ID", type=StringType)
Appointment.attributes={Appointment_Ap_ID, Appointment_E_ID, Appointment_Time, Appointment_Confirmation}

# _unnamed class attributes and methods

# Showroom class attributes and methods
Showroom_Car_Make: Property = Property(name="Car_Make", type=StringType)
Showroom_Model: Property = Property(name="Model", type=StringType)
Showroom_Year: Property = Property(name="Year", type=IntegerType)
Showroom_Horsepower: Property = Property(name="Horsepower", type=IntegerType)
Showroom_Price_Range: Property = Property(name="Price_Range", type=StringType)
Showroom.attributes={Showroom_Year, Showroom_Price_Range, Showroom_Horsepower, Showroom_Model, Showroom_Car_Make}

# Relationships
CREATES_THE_WEBSITE_WEB_DEVELOPER: BinaryAssociation = BinaryAssociation(
    name="CREATES_THE_WEBSITE_WEB_DEVELOPER",
    ends={
        Property(name="wEB_DEVELOPER0", type=REACT_NATIVE_DEVELOPER_Actor, multiplicity=Multiplicity(0, 1)),
        Property(name="cREATES_THE_WEBSITE1", type=CREATES_THE_APPLICATION_UseCase, multiplicity=Multiplicity(0, 1))
    }
)
CUSTOMER_VISITS_THE_WEBSITE: BinaryAssociation = BinaryAssociation(
    name="CUSTOMER_VISITS_THE_WEBSITE",
    ends={
        Property(name="vISITS_THE_WEBSITE2", type=VISITS_THE_APPLICATION_UseCase, multiplicity=Multiplicity(0, 1)),
...
Customercare_Appointment: BinaryAssociation = BinaryAssociation(
    name="Customercare_Appointment",
    ends={
        Property(name="appointment32", type=Appointment, multiplicity=Multiplicity(0, 1)),
        Property(name="customercare33", type=Customercare, multiplicity=Multiplicity(0, 1))
    }
)
Showroom_Customer: BinaryAssociation = BinaryAssociation(
    name="Showroom_Customer",
    ends={
        Property(name="customer34", type=Customer, multiplicity=Multiplicity(0, 1)),
        Property(name="showroom35", type=Showroom, multiplicity=Multiplicity(0, 1))
    }
)
...
domain_model = DomainModel(
    name="_46UFYCb0EeqqcaoAsxFIeg",
    types={CUSTOMER_Actor, VISITS_THE_APPLICATION_UseCase, CREATES_THE_APPLICATION_UseCase, SELECTS_THE_ITEMS_SERVICE_UseCase, ADDS_ITEMS_SERVICE_TO_CART_UseCase, SELECTS_THE_MODE_OF_PAYMENT_UseCase, PAYS_THE_BILL_UseCase, DELIVERS_THE_PRODUCT_UseCase, SUPPORT_AND_FEEDBACK_UseCase, REACT_NATIVE_DEVELOPER_Actor, ADMINISTRATOR_Actor, MAINTAINS_THE_PRODUCTS_SERVICES_UseCase, Customer, Order, Product, Warehouse, Transaction, Shipment, Customercare, Feedback, Cancelorder, Appointment, _unnamed, Showroom},
    associations={CREATES_THE_WEBSITE_WEB_DEVELOPER, CUSTOMER_VISITS_THE_WEBSITE, CUSTOMER_SELECTS_THE_ITEMS_SERVICE, CUSTOMER_ADDS_ITEMS_SERVICE_TO_CART, CUSTOMER_SELECTS_THE_MODE_OF_PAYMENT, SELECTS_THE_MODE_OF_PAYMENT_ADMINISTRATOR, PAYS_THE_BILL_ADMINISTRATOR, DELIVERS_THE_PRODUCT_ADMINISTRATOR, MAINTAINS_THE_PRODUCTS_SERVICES_ADMINISTRATOR, SUPPORT_AND_FEEDBACK_ADMINISTRATOR, ORDER_PRODUCT, Customer_Customercare, Warehouse_Shipment, Product_Warehouse, Customercare_Appointment, Showroom_Customer, CUSTOMER_PAYS_THE_BILL, CUSTOMER_SUPPORT_AND_FEEDBACK},
    generalizations={},
    metadata=None
)
