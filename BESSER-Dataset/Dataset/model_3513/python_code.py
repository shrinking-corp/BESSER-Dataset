...
class testoperationbody_Main:
    ...
    def __init__(self, singlebool: bool, listint: int, testoperationbody_Main: set["testoperationbody_ConceptA"] = None, testoperationbody_Main2: "testoperationbody_ConceptA" = None, testoperationbody_Main5: set["testoperationbody_Parent"] = None):
