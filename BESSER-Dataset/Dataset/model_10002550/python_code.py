...
class view_item:
    ...
    def __init__(self, ticket_id_: str, login21: "Login" = None, userguest19: "Userguest" = None):
        self.ticket_id_ = ticket_id_
...
class Login:
    ...
    def __init__(self, password_: str, username_: str, view_item220: "view_item" = None, person11: "Person" = None):
