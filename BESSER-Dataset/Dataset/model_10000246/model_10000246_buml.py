...
Parking_Structure.attributes={Parking_Structure_Type, Parking_Structure_Address, Parking_Structure_City}
...
Parking_Space.attributes={Parking_Space_Floor_Number, Parking_Space_Space_Type, Parking_Space_Space_Number}
...
domain_model = DomainModel(
    name="_1f511a49_1a82_4ec2_b3dd_0e696d1043a7",
    types={Parking_Structure, Parking_Space, Vehicle_Interface, Car, Truck, Motorbike, Electric, Convertible, Parking_Level, Class_, Regular_Space, Handicapped_Space, Boolean_external, Parking_Space_Type, Enumeration_, Enumeration2, Structure_Type},
