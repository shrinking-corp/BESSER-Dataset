...
accounting_ClientDatabase = Class(name="accounting_ClientDatabase")
accounting_EmployeeDatabase = Class(name="accounting_EmployeeDatabase")
...
accounting_Order_m_validateUnitAmount: Method = Method(name="validateUnitAmount", parameters={Parameter(name='accounting_context', type=StringType), Parameter(name='accounting_diagnosticChain', type=StringType)}, type=BooleanType)
accounting_Order.attributes={accounting_Order_pricePerUnit, accounting_Order_id, accounting_Order_paymentOffset}
...
accounting_Invoice.attributes={accounting_Invoice_unitAmount, accounting_Invoice_state, accounting_Invoice_id, accounting_Invoice_invoiceDate}
...
domain_model = DomainModel(
    name="accounting",
    types={accounting_Order, accounting_Employee, accounting_NamedElement, accounting_Client, NamedElement, accounting_Project, accounting_Deliverable, accounting_Invoice, accounting_ClientDatabase, accounting_EmployeeDatabase, InvoiceState},
    associations={order4, advisor5, order6, projects8, client10, orders11, project0, deliverables1, invoices2, liason13, clients15, employees16},
