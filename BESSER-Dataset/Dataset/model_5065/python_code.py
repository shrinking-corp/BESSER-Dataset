...
class accounting_Invoice:
    ...
    def __init__(self, id: str, unitAmount: float, invoiceDate: date, state: str, accounting_Invoice: "accounting_Employee" = None, invoices: "accounting_Order" = None, Invoice: "accounting_Order" = None):
        self.id = id
...
class accounting_Deliverable:
    ...
    def __init__(self, unitAmount: float, dueDate: date, deliverables: "accounting_Order" = None, Deliverable: "accounting_Order" = None):
        self.unitAmount = unitAmount
...
class accounting_Order:
    ...
    def __init__(self, id: str, paymentOffset: int, pricePerUnit: float, Order: "accounting_Deliverable" = None, Order7: "accounting_Invoice" = None, Order12: "accounting_Project" = None, orders: "accounting_Project" = None, order: set["accounting_Deliverable"] = None, order3: set["accounting_Invoice"] = None):
        self.id = id
    ...
    def validateUnitAmount(self, accounting_context, accounting_diagnosticChain) :
