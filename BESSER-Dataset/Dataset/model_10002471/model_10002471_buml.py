...
Customer.attributes={Customer_emailAddress, Customer_dateOfBirth, Customer_phoneNumber, Customer_address, Customer_name}
...
Login.attributes={Login_lastLoginTime, Login_username, Login_password, Login_securityAnswer, Login_securityQuestion}
...
domain_model = DomainModel(
    name="b6fc7722_e381_4e13_8e00_7b29d2666f4a",
