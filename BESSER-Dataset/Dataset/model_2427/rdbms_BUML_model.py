...
rdbms_ForeignKey.attributes={rdbms_ForeignKey_deleteActionRHS, rdbms_ForeignKey_match, rdbms_ForeignKey_inverseReferentialIntegrityCon, rdbms_ForeignKey_updateActionRHS}
...
rdbms_Column.attributes={rdbms_Column_precision, rdbms_Column_default, rdbms_Column_length, rdbms_Column_nullable}
...
rdbms_UserDefinedDataType.attributes={rdbms_UserDefinedDataType_length, rdbms_UserDefinedDataType_defaultValue, rdbms_UserDefinedDataType_precision}
...
domain_model = DomainModel(
    name="rdbms",
    types={rdbms_ForeignKey, rdbms_PrimaryKeyCon, rdbms_UniqueCon, rdbms_Column, rdbms_CheckCon, rdbms_PKeyAndUnique, rdbms_DataType, rdbms_Database, ModelElement, rdbms_UserDefinedDataType, rdbms_Table, rdbms_SystemDataType, rdbms_Constraints, Constraints, DataType, rdbms_ModelElement, PKeyAndUnique, DeferredAct, ReferencingType, Action, DeferrableAct},
    associations={tableFKs5, tablePK6, tableUQ8, columns10, tableCHs12, columnInPKandUQ14, columnInFK16, columnDataType18, userDefinedDataTypes0, tables1, dataTypes3, rhsKey20, lhsAttr23, refersTo26, FKTable29, dataType33, PKandUQColumns30},
    generalizations={gen_rdbms_Table_ModelElement, gen_rdbms_Column_ModelElement, gen_rdbms_Database_ModelElement, gen_rdbms_Constraints_ModelElement, gen_rdbms_CheckCon_Constraints, gen_rdbms_PKeyAndUnique_Constraints, gen_rdbms_ForeignKey_Constraints, gen_rdbms_SystemDataType_DataType, gen_rdbms_UserDefinedDataType_DataType, gen_rdbms_DataType_ModelElement, gen_rdbms_PrimaryKeyCon_PKeyAndUnique, gen_rdbms_UniqueCon_PKeyAndUnique},
    metadata=None
)
