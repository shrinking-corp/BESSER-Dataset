...
class rdbms_ForeignKey(Constraints):
    ...
    def __init__(self, match: str, inverseReferentialIntegrityCon: bool, deleteActionRHS: str, updateActionRHS: str, tableFKs: "rdbms_Table" = None, ForeignKey: "rdbms_Table" = None, rdbms_ForeignKey: "rdbms_Column" = None, rdbms_ForeignKey21: "rdbms_PKeyAndUnique" = None, rdbms_ForeignKey24: set["rdbms_Column"] = None, rdbms_ForeignKey27: "rdbms_Table" = None):
        self.match = match
