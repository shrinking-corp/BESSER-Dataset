...
class sgraph_CompositeElement(ABC):
    ...
    pass
class sgraph_Transition(Reaction, SpecificationElement):

    def __init__(self, priority: int, incomingTransitions: "sgraph_Vertex" = None, outgoingTransitions: "sgraph_Vertex" = None, Transition: "sgraph_Vertex" = None, Transition3: "sgraph_Vertex" = None):
...
class RegularState:
    ...
    pass
class sgraph_State(ScopedElement, ReactiveElement, CompositeElement, RegularState, SpecificationElement):
...
class sgraph_Region(NamedElement):
    ...
    def __init__(self, priority: int, parentRegion: set["sgraph_Vertex"] = None, regions: "sgraph_CompositeElement" = None, Region27: "sgraph_CompositeElement" = None, Region: "sgraph_Vertex" = None):
        self.priority = priority
...
class sgraph_Declaration(NamedElement):
    ...
    pass
class sgraph_Statechart(NamedElement, ScopedElement, ReactiveElement, CompositeElement, SpecificationElement):
