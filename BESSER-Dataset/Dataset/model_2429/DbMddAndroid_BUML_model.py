...
# Classes
DbMddAndroid_DBScheme = Class(name="DbMddAndroid_DBScheme")
NamedElement = Class(name="NamedElement")
DbMddAndroid_Table = Class(name="DbMddAndroid_Table")
DbMddAndroid_Relation = Class(name="DbMddAndroid_Relation")
DbMddAndroid_Column = Class(name="DbMddAndroid_Column")
DbMddAndroid_NamedElement = Class(name="DbMddAndroid_NamedElement", is_abstract=True)
...
DbMddAndroid_Relation.attributes={DbMddAndroid_Relation_minTargetMultiplicity, DbMddAndroid_Relation_maxSourceMultiplicity, DbMddAndroid_Relation_minSourceMultiplicity, DbMddAndroid_Relation_maxTargetMultiplicity}
...
domain_model = DomainModel(
    ...
    associations={outRelation8, inRelation9, tables0, relations1, columns3, primaryKey5, source11, target12},
    generalizations={gen_DbMddAndroid_Column_NamedElement, gen_DbMddAndroid_DBScheme_NamedElement, gen_DbMddAndroid_Table_NamedElement},
    metadata=None
)
