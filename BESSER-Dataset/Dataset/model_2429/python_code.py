...
class DbMddAndroid_Relation:
    ...
    def __init__(self, minSourceMultiplicity: int, maxSourceMultiplicity: int, minTargetMultiplicity: int, maxTargetMultiplicity: int, Relation: "DbMddAndroid_Table" = None, Relation10: "DbMddAndroid_Table" = None, DbMddAndroid_Relation: "DbMddAndroid_DBScheme" = None, outRelation: "DbMddAndroid_Table" = None, inRelation: "DbMddAndroid_Table" = None):
        ...
        pass
    @property
    def minTargetMultiplicity(self):
    ...
    @property
    def minSourceMultiplicity(self):
    ...
    @property
    def maxSourceMultiplicity(self):
    ...
    @property
    def maxTargetMultiplicity(self):
