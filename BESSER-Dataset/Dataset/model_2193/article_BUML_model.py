...
# Classes
article_Documentation = Class(name="article_Documentation")
StructuralElement = Class(name="StructuralElement")
article_Context = Class(name="article_Context")
article_EmbeddableElement = Class(name="article_EmbeddableElement", is_abstract=True)
article_Article = Class(name="article_Article")
Chapter = Class(name="Chapter")
article_Chapter = Class(name="article_Chapter")
article_Section = Class(name="article_Section")
article_Snippet = Class(name="article_Snippet")
EmbeddableElement = Class(name="EmbeddableElement")
article_Callout = Class(name="article_Callout")
article_Formatter = Class(name="article_Formatter", is_abstract=True)
article_Description = Class(name="article_Description")
article_Diagram = Class(name="article_Diagram")
BodyElement = Class(name="BodyElement")
article_Factory = Class(name="article_Factory", is_abstract=True)
article_JavaElement = Class(name="article_JavaElement")
LinkTarget = Class(name="LinkTarget")
article_StructuralElement = Class(name="article_StructuralElement", is_abstract=True)
article_Plugin = Class(name="article_Plugin")
article_Category = Class(name="article_Category")
Body = Class(name="Body")
BodyElementContainer = Class(name="BodyElementContainer")
article_ExternalTarget = Class(name="article_ExternalTarget")
article_Identifiable = Class(name="article_Identifiable", is_abstract=True)
article_Body = Class(name="article_Body", is_abstract=True)
article_LinkTarget = Class(name="article_LinkTarget", is_abstract=True)
Identifiable = Class(name="Identifiable")
article_JavaPackage = Class(name="article_JavaPackage")
article_ExtensionPoint = Class(name="article_ExtensionPoint")
article_Javadoc = Class(name="article_Javadoc")
Category = Class(name="Category")
article_ExternalArticle = Class(name="article_ExternalArticle")
Article = Class(name="Article")
article_Schemadoc = Class(name="article_Schemadoc")
article_Toc = Class(name="article_Toc")
article_PluginResource = Class(name="article_PluginResource")
ExternalArticle = Class(name="ExternalArticle")
article_Excel = Class(name="article_Excel")
article_BodyElementContainer = Class(name="article_BodyElementContainer", is_abstract=True)
article_BodyElement = Class(name="article_BodyElement", is_abstract=True)
article_Text = Class(name="article_Text")
article_Link = Class(name="article_Link")
article_Embedding = Class(name="article_Embedding")
article_SourceCode = Class(name="article_SourceCode")
ExternalTarget = Class(name="ExternalTarget")
article_TreeNodeProperty = Class(name="article_TreeNodeProperty")
article_ImageFactory = Class(name="article_ImageFactory")
Factory = Class(name="Factory")
article_Key = Class(name="article_Key")
article_Selection = Class(name="article_Selection")
article_ImageFormatter = Class(name="article_ImageFormatter")
article_HtmlFormatter = Class(name="article_HtmlFormatter")
article_JavaFormatter = Class(name="article_JavaFormatter")
Formatter = Class(name="Formatter")
article_XmlFormatter = Class(name="article_XmlFormatter")
article_TreeFormatter = Class(name="article_TreeFormatter")
article_Image = Class(name="article_Image")
article_TreeNode = Class(name="article_TreeNode")
...
article_StructuralElement.attributes={article_StructuralElement_doc, article_StructuralElement_title}
...
article_LinkTarget_m_linkFrom: Method = Method(name="linkFrom", parameters={Parameter(name='article_source', type=StringType)}, type=StringType)
article_LinkTarget.attributes={article_LinkTarget_tooltip, article_LinkTarget_defaultLabel}
...
article_TreeNodeProperty.attributes={article_TreeNodeProperty_valueImage, article_TreeNodeProperty_value, article_TreeNodeProperty_key}
...
article_TreeFormatter.attributes={article_TreeFormatter_selected, article_TreeFormatter_expanded, article_TreeFormatter_file, article_TreeFormatter_expandTo}
...
article_TreeNode.attributes={article_TreeNode_image, article_TreeNode_label, article_TreeNode_xmi_ID}
...
domain_model = DomainModel(
    name="article",
    types={article_Documentation, StructuralElement, article_Context, article_EmbeddableElement, article_Article, Chapter, article_Chapter, article_Section, article_Snippet, EmbeddableElement, article_Callout, article_Formatter, article_Description, article_Diagram, BodyElement, article_Factory, article_JavaElement, LinkTarget, article_StructuralElement, article_Plugin, article_Category, Body, BodyElementContainer, article_ExternalTarget, article_Identifiable, article_Body, article_LinkTarget, Identifiable, article_JavaPackage, article_ExtensionPoint, article_Javadoc, Category, article_ExternalArticle, Article, article_Schemadoc, article_Toc, article_PluginResource, ExternalArticle, article_Excel, article_BodyElementContainer, article_BodyElement, article_Text, article_Link, article_Embedding, article_SourceCode, ExternalTarget, article_TreeNodeProperty, article_ImageFactory, Factory, article_Key, article_Selection, article_ImageFormatter, article_HtmlFormatter, article_JavaFormatter, Formatter, article_XmlFormatter, article_TreeFormatter, article_Image, article_TreeNode},
    associations={context0, embeddableElements1, dependencies3, article7, sections8, callouts9, formatter10, description12, children15, plugins4, documentations6, snippet21, documentation22, chapter24, category25, parent17, documentation19, packages30, extensionPoints31, plugin33, plugin34, snippet36, elements26, container27, target28, element29, children39, properties40, properties43, snippet45},
    generalizations={gen_article_Documentation_StructuralElement, gen_article_Category_Body, gen_article_Article_Chapter, gen_article_Chapter_Body, gen_article_Snippet_EmbeddableElement, gen_article_Diagram_BodyElement, gen_article_Factory_EmbeddableElement, gen_article_JavaElement_LinkTarget, gen_article_StructuralElement_LinkTarget, gen_article_Callout_BodyElementContainer, gen_article_EmbeddableElement_Identifiable, gen_article_ExternalTarget_LinkTarget, gen_article_Section_LinkTarget, gen_article_Section_BodyElementContainer, gen_article_Body_StructuralElement, gen_article_Body_BodyElementContainer, gen_article_LinkTarget_Identifiable, gen_article_SourceCode_ExternalTarget, gen_article_Javadoc_Category, gen_article_ExternalArticle_Article, gen_article_Schemadoc_Category, gen_article_Toc_BodyElement, gen_article_PluginResource_ExternalArticle, gen_article_Excel_BodyElement, gen_article_Text_BodyElement, gen_article_Link_BodyElement, gen_article_Embedding_BodyElement, gen_article_ImageFactory_Factory, gen_article_Key_BodyElement, gen_article_Selection_BodyElement, gen_article_ImageFormatter_Formatter, gen_article_Description_BodyElementContainer, gen_article_HtmlFormatter_Formatter, gen_article_JavaFormatter_Formatter, gen_article_XmlFormatter_Formatter, gen_article_TreeFormatter_Formatter, gen_article_Image_BodyElement},
    metadata=None
)
