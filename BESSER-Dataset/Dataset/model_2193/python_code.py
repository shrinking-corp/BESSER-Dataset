...
class article_TreeFormatter(Formatter):
    ...
    def __init__(self, file: str, expandTo: int, expanded: str, selected: str):
        self.file = file
...
class article_JavaPackage:
    ...
    def __init__(self, name: str, packages: "article_Plugin" = None, JavaPackage: "article_Plugin" = None):
        self.name = name
...
class article_LinkTarget(Identifiable):
    ...
    def __init__(self, tooltip: str, defaultLabel: str, article_LinkTarget: "article_Link" = None):
    ...
    def linkFrom(self, article_source) :
...
class article_Plugin:
    ...
    def __init__(self, name: str, label: str, article_Plugin: "article_Documentation" = None, Plugin35: "article_ExtensionPoint" = None, plugin: set["article_JavaPackage"] = None, plugin32: set["article_ExtensionPoint"] = None, Plugin: "article_JavaPackage" = None):
        self.name = name
        self.label = label
...
class article_StructuralElement(LinkTarget):
    ...
    def __init__(self, title: str, doc: str, StructuralElement: "article_StructuralElement" = None, parent: set["article_StructuralElement"] = None, StructuralElement18: "article_StructuralElement" = None, children: "article_StructuralElement" = None, article_StructuralElement: "article_Documentation" = None):
        self.title = title
        self.doc = doc
...
class article_Snippet(EmbeddableElement):
    ...
    def __init__(self, title: str, titleImage: str, snippet: set["article_Callout"] = None, snippet11: "article_Formatter" = None, snippet13: "article_Description" = None, Snippet: "article_Callout" = None, Snippet37: "article_Formatter" = None, Snippet46: "article_Description" = None):
        self.title = title
...
class article_Documentation(StructuralElement):
    ...
    def __init__(self, project: str, documentations: "article_Context" = None, documentation: set["article_EmbeddableElement"] = None, article_Documentation: "article_Documentation" = None, article_Documentation2: set["article_Documentation"] = None, article_Documentation5: set["article_Plugin"] = None, Documentation: "article_Context" = None, Documentation23: "article_EmbeddableElement" = None, article_Documentation20: "article_StructuralElement" = None):
        self.project = project
