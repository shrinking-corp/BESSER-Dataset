...
class Patient:
    ...
    def __init__(self, name: str, dateOfBirth: date, address: str, phoneNumber: str, emailAddress: str, GP_Address: str, login4: "Login" = None, a1: set["Medical_Record_NHS_Number"] = None):
        self.name = name
...
class Medical_Record_NHS_Number:
    ...
    def __init__(self, accountNo: str, type: Medical_Record_AccountType, balance: float, record_search2: set["transaction_Interface"] = None, Patient0: "Patient" = None):
