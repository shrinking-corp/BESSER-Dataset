...
def test_dispatchroot_B_isa_A():
    instance = dispatchroot_B()
...
dispatchroot_A_strategy = st.builds(dispatchroot_A)
...
dispatchroot_B_strategy = st.builds(dispatchroot_B)
...
dispatchroot_C_strategy = st.builds(dispatchroot_C)
