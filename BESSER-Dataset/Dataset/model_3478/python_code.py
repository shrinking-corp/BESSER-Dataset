...
class feature_Attribute:
    ...
    def __init__(self, name: str, value: str, attributes: "feature_Feature" = None, feature_Attribute: "feature_Domain" = None, Attribute: "feature_Feature" = None, feature_Attribute39: "feature_AttributeReference" = None):
        self.name = name
        self.value = value
...
class feature_Feature(Identifiable):
    ...
    def __init__(self, name: str, selected: str, Feature16: "feature_Group" = None, Feature20: "feature_Attribute" = None, feature: set["feature_Attribute"] = None, parentFeature: set["feature_Group"] = None, feature_Feature33: "feature_FeatureReference" = None, Feature23: "feature_Annotation" = None, feature_Feature: "feature_FeatureModel" = None, childFeatures: "feature_Group" = None, feature13: set["feature_Annotation"] = None, Feature: "feature_Group" = None):
        self.name = name
...
class feature_FeatureModel:
    ...
    def __init__(self, name: str, feature_FeatureModel7: set["feature_Constraint"] = None, FeatureModel: "feature_FeatureModel" = None, children: "feature_FeatureModel" = None, FeatureModel4: "feature_FeatureModel" = None, parent: set["feature_FeatureModel"] = None, feature_FeatureModel: "feature_Feature" = None):
        self.name = name
