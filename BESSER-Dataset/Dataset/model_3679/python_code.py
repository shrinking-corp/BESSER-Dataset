...
class company_Department:
    ...
    def __init__(self, number: int, company_Department2: "company_Employee" = None, company_Department5: "company_Company" = None, company_Department: set["company_Employee"] = None):
        self.number = number
...
class company_Employee:
    ...
    def __init__(self, name: str, company_Employee3: "company_Department" = None, company_Employee: "company_Department" = None):
        self.name = name
