...
class Payment:
    ...
    def __init__(self, ex_date: str, pay_amount: str, pay_id: int, pay_mode: str, card_no: str, reg_User14: set["Reg_User"] = None, property16: set["Property"] = None):
...
class Property:
    ...
    def __init__(self, property_id: str, property_type: str, address: str, location: str, user8: "Buyer" = None, management12: set["Management"] = None, payment17: "Payment" = None, owner4: "Seller" = None):
        self.property_id = property_id
