...
class DirectedGraph_Edge(GraphElement):
    ...
    def __init__(self, weight: str, outgoing: "DirectedGraph_Node" = None, incoming: "DirectedGraph_Node" = None, Edge: "DirectedGraph_Node" = None, Edge4: "DirectedGraph_Node" = None):
        self.weight = weight
...
class DirectedGraph_Node(GraphElement):
    ...
    def __init__(self, label: str, Node: "DirectedGraph_Edge" = None, Node7: "DirectedGraph_Edge" = None, source: set["DirectedGraph_Edge"] = None, target: set["DirectedGraph_Edge"] = None):
        self.label = label
        self.Node = Node
        self.Node7 = Node7
