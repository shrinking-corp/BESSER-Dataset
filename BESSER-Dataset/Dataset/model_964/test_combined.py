...
def test_DirectedGraph_Edge_weight_value_roundtrip():
    instance = DirectedGraph_Edge(weight="sample_text")
...
def test_assoc_incoming3_link_reassign_clear():
    ...
    b1 = DirectedGraph_Edge(weight="sample_text")
    b2 = DirectedGraph_Edge(weight="sample_text_2")
...
DirectedGraph_Edge_strategy = st.builds(DirectedGraph_Edge, weight=safe_text)
@given(instance=DirectedGraph_Edge_strategy)
