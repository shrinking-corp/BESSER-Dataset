...
# Classes
libraryExample_Library = Class(name="libraryExample_Library")
libraryExample_Book = Class(name="libraryExample_Book")
libraryExample_Writer = Class(name="libraryExample_Writer")
libraryExample_SchoolLibrary = Class(name="libraryExample_SchoolLibrary")
Library = Class(name="Library")
libraryExample_Asset = Class(name="libraryExample_Asset")
libraryExample_SchoolBook = Class(name="libraryExample_SchoolBook")
...
libraryExample_Book.attributes={libraryExample_Book_category, libraryExample_Book_pages, libraryExample_Book_title}
...
domain_model = DomainModel(
    name="libraryExample",
    types={libraryExample_Library, libraryExample_Book, libraryExample_Writer, libraryExample_SchoolLibrary, Library, libraryExample_Asset, libraryExample_SchoolBook, Book, Asset, BookCategory},
    associations={books0, writers1, writer3, books4},
