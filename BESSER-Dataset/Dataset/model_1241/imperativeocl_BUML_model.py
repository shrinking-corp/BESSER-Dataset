...
domain_model = DomainModel(
    name="imperativeocl",
    types={imperativeocl_AltExp, ImperativeExpression, imperativeocl_AssertExp, LogExp, imperativeocl_AssignExp, imperativeocl_BlockExp, DictLiteralPart, imperativeocl_DictLiteralPart, imperativeocl_DictionaryType, imperativeocl_ForExp, ImperativeLoopExp, imperativeocl_ImperativeExpression, imperativeocl_ImperativeIterateExp, imperativeocl_ImperativeLoopExp, imperativeocl_InstantiationExp, imperativeocl_BreakExp, imperativeocl_CatchExp, imperativeocl_ComputeExp, imperativeocl_ContinueExp, imperativeocl_DictLiteralExp, imperativeocl_RaiseExp, imperativeocl_ReturnExp, imperativeocl_SwitchExp, AltExp, imperativeocl_TemplateParameterType, imperativeocl_TryExp, CatchExp, imperativeocl_ListType, imperativeocl_LogExp, imperativeocl_OrderedTupleLiteralExp, OrderedTupleLiteralPart, imperativeocl_OrderedTupleLiteralPart, imperativeocl_OrderedTupleType, imperativeocl_WhileExp, imperativeocl_Typedef, imperativeocl_UnlinkExp, imperativeocl_UnpackExp, imperativeocl_VariableInitExp, SeverityKind},
    associations={log0, part1, alternativePart3, catchClause4, part2},
    generalizations={gen_imperativeocl_AltExp_ImperativeExpression, gen_imperativeocl_AssertExp_ImperativeExpression, gen_imperativeocl_AssignExp_ImperativeExpression, gen_imperativeocl_BlockExp_ImperativeExpression, gen_imperativeocl_ForExp_ImperativeLoopExp, gen_imperativeocl_ImperativeIterateExp_ImperativeLoopExp, gen_imperativeocl_InstantiationExp_ImperativeExpression, gen_imperativeocl_BreakExp_ImperativeExpression, gen_imperativeocl_CatchExp_ImperativeExpression, gen_imperativeocl_ComputeExp_ImperativeExpression, gen_imperativeocl_ContinueExp_ImperativeExpression, gen_imperativeocl_RaiseExp_ImperativeExpression, gen_imperativeocl_ReturnExp_ImperativeExpression, gen_imperativeocl_TryExp_ImperativeExpression, gen_imperativeocl_WhileExp_ImperativeExpression, gen_imperativeocl_UnlinkExp_ImperativeExpression, gen_imperativeocl_UnpackExp_ImperativeExpression, gen_imperativeocl_VariableInitExp_ImperativeExpression},
    metadata=None
)
