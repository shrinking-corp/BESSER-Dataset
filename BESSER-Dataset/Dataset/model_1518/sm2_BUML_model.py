...
# Classes
sm2_StateMachine = Class(name="sm2_StateMachine")
sm2_State = Class(name="sm2_State")
sm2_Transition = Class(name="sm2_Transition")
...
domain_model = DomainModel(
    name="sm2",
    types={sm2_StateMachine, sm2_State, sm2_Transition},
