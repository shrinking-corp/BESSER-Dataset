...
class sm2_Transition:
    ...
    def __init__(self, event: str, sm2_Transition: "sm2_StateMachine" = None, Transition: "sm2_State" = None, Transition7: "sm2_State" = None, outgoing: "sm2_State" = None, incoming: "sm2_State" = None):
        self.event = event
...
class sm2_State:
    ...
    def __init__(self, name: str, sm2_State: "sm2_StateMachine" = None, State: "sm2_StateMachine" = None, states: "sm2_StateMachine" = None, src: set["sm2_Transition"] = None, tgt: set["sm2_Transition"] = None, State9: "sm2_Transition" = None, State11: "sm2_Transition" = None):
        self.name = name
