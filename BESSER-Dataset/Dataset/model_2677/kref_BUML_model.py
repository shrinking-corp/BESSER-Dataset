...
# Classes
kref_A = Class(name="kref_A")
Named = Class(name="Named")
kref_B = Class(name="kref_B")
kref_K = Class(name="kref_K")
kref_C = Class(name="kref_C")
kref_G = Class(name="kref_G")
kref_Named = Class(name="kref_Named")
kref_E = Class(name="kref_E")
B = Class(name="B")
kref_F = Class(name="kref_F")
kref_J = Class(name="kref_J")
kref_H = Class(name="kref_H")
...
domain_model = DomainModel(
    name="kref",
    types={kref_A, Named, kref_B, kref_K, kref_C, kref_G, kref_Named, kref_E, B, kref_F, kref_J, kref_H},
    associations={bs0, ks1, cs3, gs5, fs7, js8, k10, hs13},
    generalizations={gen_kref_A_Named, gen_kref_B_Named, gen_kref_C_Named, gen_kref_E_Named, gen_kref_E_B, gen_kref_F_Named, gen_kref_G_Named, gen_kref_H_Named, gen_kref_J_Named, gen_kref_K_Named},
    metadata=None
)
