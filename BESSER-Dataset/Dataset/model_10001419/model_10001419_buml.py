...
Payment.attributes={Payment_Date, Payment_Payment_ID}
...
Account.attributes={Account_Address}
...
domain_model = DomainModel(
    name="_5_a5AB1AEeqPCsas7676rw",
    types={Customer, Products, Shopping_Cart, Payment, Order, Account, Warehouse, Items},
    associations={Account_Customer, Customer_Account, Warehouse_Products, Payment__Order, Shopping_Cart_Items, Order_Account, Order_Account2, Account_Order, Customer_Products, Customer_Order, Customer_Shopping_Cart, Customer_Payment},
    generalizations={},
    metadata=None
)
