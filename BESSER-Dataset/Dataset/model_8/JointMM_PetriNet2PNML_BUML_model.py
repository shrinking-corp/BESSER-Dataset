...
# Classes
jointPackage_PetriNet2PNML_JointMM = Class(name="jointPackage_PetriNet2PNML_JointMM")
jointPackage_PetriNet2PNML_SrcPetriNet = Class(name="jointPackage_PetriNet2PNML_SrcPetriNet")
jointPackage_PetriNet2PNML_TrgPNMLDocument = Class(name="jointPackage_PetriNet2PNML_TrgPNMLDocument")
jointPackage_PetriNet2PNML_SrcLocatedElement = Class(name="jointPackage_PetriNet2PNML_SrcLocatedElement", is_abstract=True)
jointPackage_PetriNet2PNML_SrcNamedElement = Class(name="jointPackage_PetriNet2PNML_SrcNamedElement", is_abstract=True)
SrcLocatedElement = Class(name="SrcLocatedElement")
SrcNamedElement = Class(name="SrcNamedElement")
jointPackage_PetriNet2PNML_SrcElement = Class(name="jointPackage_PetriNet2PNML_SrcElement", is_abstract=True)
jointPackage_PetriNet2PNML_SrcArc = Class(name="jointPackage_PetriNet2PNML_SrcArc", is_abstract=True)
jointPackage_PetriNet2PNML_SrcTransition = Class(name="jointPackage_PetriNet2PNML_SrcTransition")
SrcArc = Class(name="SrcArc")
TrgLocatedElement = Class(name="TrgLocatedElement")
jointPackage_PetriNet2PNML_TrgURI = Class(name="jointPackage_PetriNet2PNML_TrgURI")
jointPackage_PetriNet2PNML_SrcPlace = Class(name="jointPackage_PetriNet2PNML_SrcPlace")
SrcElement = Class(name="SrcElement")
jointPackage_PetriNet2PNML_SrcTransitionToPlace = Class(name="jointPackage_PetriNet2PNML_SrcTransitionToPlace")
jointPackage_PetriNet2PNML_SrcPlaceToTransition = Class(name="jointPackage_PetriNet2PNML_SrcPlaceToTransition")
TrgIdedElement = Class(name="TrgIdedElement")
jointPackage_PetriNet2PNML_TrgNetContent = Class(name="jointPackage_PetriNet2PNML_TrgNetContent", is_abstract=True)
jointPackage_PetriNet2PNML_TrgName = Class(name="jointPackage_PetriNet2PNML_TrgName")
jointPackage_PetriNet2PNML_TrgLabeledElement = Class(name="jointPackage_PetriNet2PNML_TrgLabeledElement", is_abstract=True)
jointPackage_PetriNet2PNML_TrgLabel = Class(name="jointPackage_PetriNet2PNML_TrgLabel")
TrgLabeledElement = Class(name="TrgLabeledElement")
jointPackage_PetriNet2PNML_TrgNetContentElement = Class(name="jointPackage_PetriNet2PNML_TrgNetContentElement", is_abstract=True)
TrgNetContent = Class(name="TrgNetContent")
jointPackage_PetriNet2PNML_TrgArc = Class(name="jointPackage_PetriNet2PNML_TrgArc")
jointPackage_PetriNet2PNML_TrgNetElement = Class(name="jointPackage_PetriNet2PNML_TrgNetElement")
jointPackage_PetriNet2PNML_TrgLocatedElement = Class(name="jointPackage_PetriNet2PNML_TrgLocatedElement", is_abstract=True)
jointPackage_PetriNet2PNML_TrgIdedElement = Class(name="jointPackage_PetriNet2PNML_TrgIdedElement", is_abstract=True)
jointPackage_PetriNet2PNML_TrgPlace = Class(name="jointPackage_PetriNet2PNML_TrgPlace")
TrgNetContentElement = Class(name="TrgNetContentElement")
jointPackage_PetriNet2PNML_TrgTransition = Class(name="jointPackage_PetriNet2PNML_TrgTransition")
...
outgoingArc12: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_13", type=jointPackage_PetriNet2PNML_SrcTransitionToPlace, multiplicity=Multiplicity(1, 9999))
    }
)
...
outgoingArc8: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_", type=jointPackage_PetriNet2PNML_SrcPlaceToTransition, multiplicity=Multiplicity(0, 9999))
    }
)
...
domain_model = DomainModel(
    ...
    types={jointPackage_PetriNet2PNML_JointMM, jointPackage_PetriNet2PNML_SrcPetriNet, jointPackage_PetriNet2PNML_TrgPNMLDocument, jointPackage_PetriNet2PNML_SrcLocatedElement, jointPackage_PetriNet2PNML_SrcNamedElement, SrcLocatedElement, SrcNamedElement, jointPackage_PetriNet2PNML_SrcElement, jointPackage_PetriNet2PNML_SrcArc, jointPackage_PetriNet2PNML_SrcTransition, SrcArc, TrgLocatedElement, jointPackage_PetriNet2PNML_TrgURI, jointPackage_PetriNet2PNML_SrcPlace, SrcElement, jointPackage_PetriNet2PNML_SrcTransitionToPlace, jointPackage_PetriNet2PNML_SrcPlaceToTransition, TrgIdedElement, jointPackage_PetriNet2PNML_TrgNetContent, jointPackage_PetriNet2PNML_TrgName, jointPackage_PetriNet2PNML_TrgLabeledElement, jointPackage_PetriNet2PNML_TrgLabel, TrgLabeledElement, jointPackage_PetriNet2PNML_TrgNetContentElement, TrgNetContent, jointPackage_PetriNet2PNML_TrgArc, jointPackage_PetriNet2PNML_TrgNetElement, jointPackage_PetriNet2PNML_TrgLocatedElement, jointPackage_PetriNet2PNML_TrgIdedElement, jointPackage_PetriNet2PNML_TrgPlace, TrgNetContentElement, jointPackage_PetriNet2PNML_TrgTransition},
    associations={sourceRoot0, targetRoot1, elements3, arcs4, net6, incomingArc9, outgoingArc12, net15, from_17, to18, from_19, to22, xmlns25, incomingArc7, outgoingArc8, type29, contents32, name34, name36, labels39, nets27, source40, target41},
    generalizations={gen_jointPackage_PetriNet2PNML_SrcNamedElement_SrcLocatedElement, gen_jointPackage_PetriNet2PNML_SrcPetriNet_SrcNamedElement, gen_jointPackage_PetriNet2PNML_SrcElement_SrcNamedElement, gen_jointPackage_PetriNet2PNML_SrcTransition_SrcElement, gen_jointPackage_PetriNet2PNML_SrcArc_SrcNamedElement, gen_jointPackage_PetriNet2PNML_SrcPlaceToTransition_SrcArc, gen_jointPackage_PetriNet2PNML_SrcTransitionToPlace_SrcArc, gen_jointPackage_PetriNet2PNML_TrgPNMLDocument_TrgLocatedElement, gen_jointPackage_PetriNet2PNML_SrcPlace_SrcElement, gen_jointPackage_PetriNet2PNML_TrgURI_TrgLocatedElement, gen_jointPackage_PetriNet2PNML_TrgNetElement_TrgIdedElement, gen_jointPackage_PetriNet2PNML_TrgNetContent_TrgLocatedElement, gen_jointPackage_PetriNet2PNML_TrgLabeledElement_TrgLocatedElement, gen_jointPackage_PetriNet2PNML_TrgLabel_TrgLocatedElement, gen_jointPackage_PetriNet2PNML_TrgName_TrgLabeledElement, gen_jointPackage_PetriNet2PNML_TrgNetContentElement_TrgNetContent, gen_jointPackage_PetriNet2PNML_TrgNetContentElement_TrgIdedElement, gen_jointPackage_PetriNet2PNML_TrgArc_TrgNetContent, gen_jointPackage_PetriNet2PNML_TrgArc_TrgIdedElement, gen_jointPackage_PetriNet2PNML_TrgIdedElement_TrgLocatedElement, gen_jointPackage_PetriNet2PNML_TrgPlace_TrgNetContentElement, gen_jointPackage_PetriNet2PNML_TrgTransition_TrgNetContentElement},
    metadata=None
)
