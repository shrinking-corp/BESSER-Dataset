...
# Classes
types_Model = Class(name="types_Model")
types_Import = Class(name="types_Import")
types_ComplexType = Class(name="types_ComplexType")
types_Type = Class(name="types_Type")
types_NamedType = Class(name="types_NamedType")
Type = Class(name="Type")
types_CollectionType = Class(name="types_CollectionType")
...
types_DeclarationTypeReference = Class(name="types_DeclarationTypeReference")
types_PrimitiveType = Class(name="types_PrimitiveType")
NamedType = Class(name="NamedType")
types_StringLiteral = Class(name="types_StringLiteral")
types_EnumerationType = Class(name="types_EnumerationType")
ComplexType = Class(name="ComplexType")
types_EnumerationLiteral = Class(name="types_EnumerationLiteral")
types_EntityType = Class(name="types_EntityType")
types_Property = Class(name="types_Property")
types_EntityRelationship = Class(name="types_EntityRelationship")
types_PropertyReference = Class(name="types_PropertyReference")
types_Literal = Class(name="types_Literal")
types_MappedByReference = Class(name="types_MappedByReference")
Literal = Class(name="Literal")
types_CharLiteral = Class(name="types_CharLiteral")
types_NumberLiteral = Class(name="types_NumberLiteral")
types_BooleanLiteral = Class(name="types_BooleanLiteral")
...
types_Property.attributes={types_Property_name, types_Property_storageModifier}
...
domain_model = DomainModel(
    name="types",
    types={types_Model, types_Import, types_ComplexType, types_Type, types_NamedType, Type, types_CollectionType, DeclarationTypeReference, types_TypeReference, types_MapType, types_DeclarationTypeReference, types_PrimitiveType, NamedType, types_StringLiteral, types_EnumerationType, ComplexType, types_EnumerationLiteral, types_EntityType, types_Property, types_EntityRelationship, types_PropertyReference, types_Literal, types_MappedByReference, Literal, types_CharLiteral, types_NumberLiteral, types_BooleanLiteral, TypeStorageModifier, EntityRelationshipKind, PropertyStorageModifier},
    associations={parent12, imports0, types1, reference3, reference4, mapType6, reference9, literals14, properties15, type16, relationship18, orderBy20, mapKey22, literal25, mappedBy27, base29, path33, reference35},
