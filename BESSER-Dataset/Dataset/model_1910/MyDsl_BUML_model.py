...
# Classes
myDsl_AppAccessFunctions = Class(name="myDsl_AppAccessFunctions")
myDsl_Model = Class(name="myDsl_Model")
myDsl_EObject = Class(name="myDsl_EObject")
myDsl_Domain = Class(name="myDsl_Domain")
myDsl_Entity = Class(name="myDsl_Entity")
myDsl_Entities = Class(name="myDsl_Entities")
myDsl_Photo = Class(name="myDsl_Photo")
myDsl_Album = Class(name="myDsl_Album")
myDsl_UserDomain = Class(name="myDsl_UserDomain")
myDsl_Functionality = Class(name="myDsl_Functionality")
myDsl_Functionalities = Class(name="myDsl_Functionalities")
myDsl_ProfileManagement = Class(name="myDsl_ProfileManagement")
myDsl_AppAccess = Class(name="myDsl_AppAccess")
myDsl_AlbumManagement = Class(name="myDsl_AlbumManagement")
myDsl_PhotoActions = Class(name="myDsl_PhotoActions")
myDsl_LandingActions = Class(name="myDsl_LandingActions")
myDsl_ProfileManagementFunctions = Class(name="myDsl_ProfileManagementFunctions")
myDsl_DataPersistenceSegments = Class(name="myDsl_DataPersistenceSegments")
myDsl_SegmentStructure = Class(name="myDsl_SegmentStructure")
myDsl_SegmentStructureContent = Class(name="myDsl_SegmentStructureContent")
myDsl_AlbumManagementFunctions = Class(name="myDsl_AlbumManagementFunctions")
myDsl_PhotoActionsFunctions = Class(name="myDsl_PhotoActionsFunctions")
myDsl_LandingFunctions = Class(name="myDsl_LandingFunctions")
myDsl_DomainConnection = Class(name="myDsl_DomainConnection")
myDsl_DomainRelations = Class(name="myDsl_DomainRelations")
myDsl_Architecture = Class(name="myDsl_Architecture")
myDsl_NTiers = Class(name="myDsl_NTiers")
myDsl_Layer = Class(name="myDsl_Layer")
myDsl_PresentationLayer = Class(name="myDsl_PresentationLayer")
myDsl_PresentationContent = Class(name="myDsl_PresentationContent")
myDsl_PresentationSegments = Class(name="myDsl_PresentationSegments")
myDsl_BusinessLogicLayer = Class(name="myDsl_BusinessLogicLayer")
myDsl_BusinessLogicContent = Class(name="myDsl_BusinessLogicContent")
myDsl_BusinessLogicSegments = Class(name="myDsl_BusinessLogicSegments")
myDsl_DataPersistenceLayer = Class(name="myDsl_DataPersistenceLayer")
myDsl_DataPersistenceContent = Class(name="myDsl_DataPersistenceContent")
myDsl_DirectoryContent = Class(name="myDsl_DirectoryContent")
myDsl_Directories = Class(name="myDsl_Directories")
myDsl_MultipleFile = Class(name="myDsl_MultipleFile")
myDsl_SingleFile = Class(name="myDsl_SingleFile")
myDsl_LayerRelations = Class(name="myDsl_LayerRelations")
myDsl_LayerSource = Class(name="myDsl_LayerSource")
myDsl_LayerTarget = Class(name="myDsl_LayerTarget")
myDsl_ArchitectureComponents = Class(name="myDsl_ArchitectureComponents")
myDsl_FrontEnd = Class(name="myDsl_FrontEnd")
myDsl_BackEnd = Class(name="myDsl_BackEnd")
myDsl_PersistenceDataComponent = Class(name="myDsl_PersistenceDataComponent")
myDsl_NTiersConnections = Class(name="myDsl_NTiersConnections")
myDsl_SingleDependencies = Class(name="myDsl_SingleDependencies")
myDsl_NTierTarget = Class(name="myDsl_NTierTarget")
myDsl_NTierSource = Class(name="myDsl_NTierSource")
myDsl_NTiersRelations = Class(name="myDsl_NTiersRelations")
myDsl_Technology = Class(name="myDsl_Technology")
myDsl_Technologies = Class(name="myDsl_Technologies")
myDsl_React = Class(name="myDsl_React")
myDsl_ReactModules = Class(name="myDsl_ReactModules")
myDsl_ReactSubModules = Class(name="myDsl_ReactSubModules")
myDsl_ReactConfiguration = Class(name="myDsl_ReactConfiguration")
myDsl_ReactDependencies = Class(name="myDsl_ReactDependencies")
myDsl_ReactConfigurations = Class(name="myDsl_ReactConfigurations")
myDsl_ReactDependenciesRules = Class(name="myDsl_ReactDependenciesRules")
myDsl_ReactDependenciesSubRules = Class(name="myDsl_ReactDependenciesSubRules")
myDsl_ReactFunctions = Class(name="myDsl_ReactFunctions")
myDsl_PackageName = Class(name="myDsl_PackageName")
myDsl_PackageVersion = Class(name="myDsl_PackageVersion")
myDsl_DOMConfigurations = Class(name="myDsl_DOMConfigurations")
myDsl_ReactComponents = Class(name="myDsl_ReactComponents")
myDsl_ComponentsLogic = Class(name="myDsl_ComponentsLogic")
myDsl_ComponentsUI = Class(name="myDsl_ComponentsUI")
myDsl_LogicContent = Class(name="myDsl_LogicContent")
myDsl_LogicStructure = Class(name="myDsl_LogicStructure")
myDsl_ComponentClass = Class(name="myDsl_ComponentClass")
myDsl_UIContent = Class(name="myDsl_UIContent")
myDsl_ReactConstructor = Class(name="myDsl_ReactConstructor")
myDsl_State = Class(name="myDsl_State")
myDsl_CoreFunctionsDeclaration = Class(name="myDsl_CoreFunctionsDeclaration")
myDsl_Props = Class(name="myDsl_Props")
myDsl_ReactCoreFunctions = Class(name="myDsl_ReactCoreFunctions")
myDsl_ReactActions = Class(name="myDsl_ReactActions")
myDsl_ReactActionsContent = Class(name="myDsl_ReactActionsContent")
myDsl_ReactServicesRelation = Class(name="myDsl_ReactServicesRelation")
myDsl_ReactServicesType = Class(name="myDsl_ReactServicesType")
myDsl_ReactLibraries = Class(name="myDsl_ReactLibraries")
myDsl_ReactLibrary = Class(name="myDsl_ReactLibrary")
myDsl_ReactInfo = Class(name="myDsl_ReactInfo")
myDsl_ReactInformation = Class(name="myDsl_ReactInformation")
myDsl_Spring = Class(name="myDsl_Spring")
myDsl_PostgreSQL = Class(name="myDsl_PostgreSQL")
myDsl_AmazonWebServices = Class(name="myDsl_AmazonWebServices")
...
myDsl_LayerRelations.attributes={myDsl_LayerRelations_name, myDsl_LayerRelations_layerelations}
...
myDsl_NTiersConnections.attributes={myDsl_NTiersConnections_ntierconnection, myDsl_NTiersConnections_name}
...
myDsl_DOMConfigurations.attributes={myDsl_DOMConfigurations_elements, myDsl_DOMConfigurations_name}
...
myDsl_Props.attributes={myDsl_Props_componentclass, myDsl_Props_name}
...
domain_model = DomainModel(
    name="myDsl",
    types={myDsl_AppAccessFunctions, myDsl_Model, myDsl_EObject, myDsl_Domain, myDsl_Entity, myDsl_Entities, myDsl_Photo, myDsl_Album, myDsl_UserDomain, myDsl_Functionality, myDsl_Functionalities, myDsl_ProfileManagement, myDsl_AppAccess, myDsl_AlbumManagement, myDsl_PhotoActions, myDsl_LandingActions, myDsl_ProfileManagementFunctions, myDsl_DataPersistenceSegments, myDsl_SegmentStructure, myDsl_SegmentStructureContent, myDsl_AlbumManagementFunctions, myDsl_PhotoActionsFunctions, myDsl_LandingFunctions, myDsl_DomainConnection, myDsl_DomainRelations, myDsl_Architecture, myDsl_NTiers, myDsl_Layer, myDsl_PresentationLayer, myDsl_PresentationContent, myDsl_PresentationSegments, myDsl_BusinessLogicLayer, myDsl_BusinessLogicContent, myDsl_BusinessLogicSegments, myDsl_DataPersistenceLayer, myDsl_DataPersistenceContent, myDsl_DirectoryContent, myDsl_Directories, myDsl_MultipleFile, myDsl_SingleFile, myDsl_LayerRelations, myDsl_LayerSource, myDsl_LayerTarget, myDsl_ArchitectureComponents, myDsl_FrontEnd, myDsl_BackEnd, myDsl_PersistenceDataComponent, myDsl_NTiersConnections, myDsl_SingleDependencies, myDsl_NTierTarget, myDsl_NTierSource, myDsl_NTiersRelations, myDsl_Technology, myDsl_Technologies, myDsl_React, myDsl_ReactModules, myDsl_ReactSubModules, myDsl_ReactConfiguration, myDsl_ReactDependencies, myDsl_ReactConfigurations, myDsl_ReactDependenciesRules, myDsl_ReactDependenciesSubRules, myDsl_ReactFunctions, myDsl_PackageName, myDsl_PackageVersion, myDsl_DOMConfigurations, myDsl_ReactComponents, myDsl_ComponentsLogic, myDsl_ComponentsUI, myDsl_LogicContent, myDsl_LogicStructure, myDsl_ComponentClass, myDsl_UIContent, myDsl_ReactConstructor, myDsl_State, myDsl_CoreFunctionsDeclaration, myDsl_Props, myDsl_ReactCoreFunctions, myDsl_ReactActions, myDsl_ReactActionsContent, myDsl_ReactServicesRelation, myDsl_ReactServicesType, myDsl_ReactLibraries, myDsl_ReactLibrary, myDsl_ReactInfo, myDsl_ReactInformation, myDsl_Spring, myDsl_PostgreSQL, myDsl_AmazonWebServices},
    associations={items18, items20, elements0, elements1, elements3, elements4, elements7, functions8, elements10, items12, resources14, aditionals16, elements45, elements47, items22, items24, items26, elements28, elements29, elements32, elements34, elements36, elements38, elements40, elements41, elements43, elements44, ntierorigin59, elements48, elements50, elements53, layerorigin54, layertarget55, archcomponent57, ntiertarget60, ntierconnection62, ntierconnection64, elements67, factors68, reacts71, reactmodules72, reactmodules74, dependencies77, configurations78, dependencies80, dependencies82, dependencies84, dependencies86, configurations89, componentslogic91, componentsui92, logiccomponents94, logiccomponents96, logiccomponents98, uicomponents100, uicontent102, componentclass105, componentclass108, componentclass110, reactactcontent112, reactrelcontent113, reactrelationcontent115, reactlibraries117, reactinformation118},
    generalizations={},
    metadata=None
)
