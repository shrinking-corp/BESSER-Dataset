...
class myDsl_ComponentsLogic:
    ...
    def __init__(self, name: str, myDsl_ComponentsLogic: "myDsl_ReactComponents" = None, myDsl_ComponentsLogic95: set["myDsl_LogicContent"] = None):
        self.name = name
...
class myDsl_LayerRelations:
    ...
    def __init__(self, layerelations: str, name: str, myDsl_LayerRelations: set["myDsl_LayerSource"] = None, myDsl_LayerRelations56: set["myDsl_LayerTarget"] = None):
        self.layerelations = layerelations
        self.name = name
...
class myDsl_DomainRelations:
    ...
    def __init__(self, name: str, myDsl_DomainRelations: "myDsl_DomainConnection" = None, myDsl_DomainRelations30: set["myDsl_EObject"] = None):
        self.name = name
...
class myDsl_SegmentStructureContent:
    ...
    def __init__(self, name: str, myDsl_SegmentStructureContent49: set["myDsl_DirectoryContent"] = None, myDsl_SegmentStructureContent: "myDsl_SegmentStructure" = None):
        self.name = name
