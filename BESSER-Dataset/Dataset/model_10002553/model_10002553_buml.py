...
mypackage_Login.attributes={mypackage_Login_securityQuestion, mypackage_Login_username, mypackage_Login_lastLoginTime, mypackage_Login_password, mypackage_Login_securityAnswer}
...
mypackage_Customer.attributes={mypackage_Customer_emailAddress, mypackage_Customer_phoneNumber, mypackage_Customer_address, mypackage_Customer_name, mypackage_Customer_dateOfBirth}
...
domain_model = DomainModel(
    name="c09f8f4b_2fe3_4916_aaaa_a1a0fbc4aba5",
    types={account_Account, mypackage_Login, mypackage_Customer, transaction_Transaction, transaction_DepositTransaction, transaction_WithdrawTransaction, transaction_TransferTransaction, account_SavingsAccount, account_CertificatesOfDepositAccount, account_CheckingAccount, transaction_TransactionType, account_AccountType},
