...
public class mypackage_Customer  {
    ...
    public mypackage_Customer(
        String name,        String phoneNumber,        String emailAddress,        String address,        LocalDate dateOfBirth    ) {
        this.name = name;
    ...
    public mypackage_Customer(
        String name,        String phoneNumber,        String emailAddress,        String address,        LocalDate dateOfBirth        ArrayList<account_Account> account_accounts    ) {
        this.name = name;
        this.phoneNumber = phoneNumber;
        this.emailAddress = emailAddress;
        this.address = address;
