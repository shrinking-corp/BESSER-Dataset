...
# Classes
trace_TraceLinkSet = Class(name="trace_TraceLinkSet")
trace_TargetElement = Class(name="trace_TargetElement")
trace_TracedRule = Class(name="trace_TracedRule")
trace_SourceElement = Class(name="trace_SourceElement")
trace_SourceElementList = Class(name="trace_SourceElementList")
trace_TraceLink = Class(name="trace_TraceLink")
trace_TraceProperty = Class(name="trace_TraceProperty")
trace_TraceElement = Class(name="trace_TraceElement", is_abstract=True)
...
trace_TraceLinkSet_m_getDefaultSourceElement: Method = Method(name="getDefaultSourceElement", parameters={Parameter(name='trace_sourceElement', type=StringType)}, type=StringType)
trace_TraceLinkSet_m_getDefaultSourceElements: Method = Method(name="getDefaultSourceElements", parameters={Parameter(name='trace_sourceElements', type=StringType)}, type=StringType)
trace_TraceLinkSet_m_getLinksByRule: Method = Method(name="getLinksByRule", parameters={Parameter(name='trace_create', type=StringType), Parameter(name='trace_rule', type=StringType)}, type=StringType)
trace_TraceLinkSet_m_clear: Method = Method(name="clear", parameters={})
trace_TraceLinkSet.methods={trace_TraceLinkSet_m_getDefaultSourceElements, trace_TraceLinkSet_m_clear, trace_TraceLinkSet_m_getLinksByRule, trace_TraceLinkSet_m_getDefaultSourceElement}
...
trace_TracedRule_m_getUniqueSourceElement: Method = Method(name="getUniqueSourceElement", parameters={Parameter(name='trace_sourceElement', type=StringType)}, type=StringType)
trace_TracedRule_m_getUniqueSourceElements: Method = Method(name="getUniqueSourceElements", parameters={Parameter(name='trace_sourceElements', type=StringType)}, type=StringType)
trace_TracedRule.attributes={trace_TracedRule_rule}
trace_TracedRule.methods={trace_TracedRule_m_getUniqueSourceElement, trace_TracedRule_m_getUniqueSourceElements}
...
trace_TraceLink_m_getSourceElement: Method = Method(name="getSourceElement", parameters={Parameter(name='trace_create', type=StringType), Parameter(name='trace_name', type=StringType)}, type=StringType)
trace_TraceLink_m_getTargetElement: Method = Method(name="getTargetElement", parameters={Parameter(name='trace_name', type=StringType)}, type=StringType)
...
trace_TraceProperty_m_resolveBinding: Method = Method(name="resolveBinding", parameters={Parameter(name='trace_traces', type=StringType)})
...
domain_model = DomainModel(
    name="trace",
    types={trace_TraceLinkSet, trace_TargetElement, trace_TracedRule, trace_SourceElement, trace_SourceElementList, trace_TraceLink, trace_TraceProperty, trace_TraceElement, trace_EObject, TraceElement},
    associations={uniqueSourceElements6, uniqueSourceElementLists8, sourceElements11, targetElements13, rule14, rules0, defaultSourceElements1, defaultSourceElementLists2, links4, linkSet5, sourceElements31, defaultFor32, uniqueFor34, resolvedFor36, resolvings37, properties16, object17, sourceOf18, mapsTo20, defaultFor22, uniqueFor24, targetOf26, mapsTo28, appliedAt40},
