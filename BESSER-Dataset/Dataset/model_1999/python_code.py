...
class trace_TraceProperty:
    ...
    def __init__(self, propertyName: str, resolved: bool, trace_TraceProperty: "trace_TargetElement" = None, trace_TraceProperty38: set["trace_EObject"] = None, TraceProperty: "trace_TraceLink" = None, properties: "trace_TraceLink" = None):
    ...
    def resolveBinding(self, trace_traces):
        # TODO: Implement resolveBinding method
        pass

class trace_TraceLink:

    def __init__(self, overridden: bool, sourceOf: set["trace_SourceElement"] = None, targetOf: set["trace_TargetElement"] = None, links: "trace_TracedRule" = None, TraceLink: "trace_TracedRule" = None, appliedAt: set["trace_TraceProperty"] = None, TraceLink19: "trace_SourceElement" = None, TraceLink27: "trace_TargetElement" = None, TraceLink41: "trace_TraceProperty" = None):
    ...
    def getSourceElement(self, trace_create, trace_name) :
        # TODO: Implement getSourceElement method
        pass

    def getTargetElement(self, trace_name) :
        # TODO: Implement getTargetElement method
        pass

class trace_SourceElementList:

    def __init__(self, SourceElementList10: "trace_TracedRule" = None, SourceElementList: "trace_TraceLinkSet" = None, trace_SourceElementList: set["trace_SourceElement"] = None, defaultSourceElementLists: "trace_TraceLinkSet" = None, uniqueSourceElementLists: "trace_TracedRule" = None):
...
class trace_SourceElement(TraceElement):
    ...
    def __init__(self, mapsToSelf: bool, SourceElement7: "trace_TracedRule" = None, SourceElement12: "trace_TraceLink" = None, SourceElement: "trace_TraceLinkSet" = None, trace_SourceElement: "trace_SourceElementList" = None, sourceElements: "trace_TraceLink" = None, mapsTo: set["trace_TargetElement"] = None, defaultSourceElements: "trace_TraceLinkSet" = None, uniqueSourceElements: "trace_TracedRule" = None, SourceElement30: "trace_TargetElement" = None):
...
class trace_TracedRule:
    ...
    def __init__(self, rule1: str, uniqueFor: set["trace_SourceElement"] = None, uniqueFor9: set["trace_SourceElementList"] = None, TracedRule15: "trace_TraceLink" = None, TracedRule: "trace_TraceLinkSet" = None, rule: set["trace_TraceLink"] = None, rules: "trace_TraceLinkSet" = None, TracedRule35: "trace_SourceElementList" = None, TracedRule25: "trace_SourceElement" = None):
        self.rule1 = rule1
    ...
    def getUniqueSourceElements(self, trace_sourceElements) :
        # TODO: Implement getUniqueSourceElements method
        pass

    def getUniqueSourceElement(self, trace_sourceElement) :
...
class trace_TraceLinkSet:
    ...
    def __init__(self, linkSet: set["trace_TracedRule"] = None, defaultFor: set["trace_SourceElement"] = None, defaultFor3: set["trace_SourceElementList"] = None, TraceLinkSet: "trace_TracedRule" = None, TraceLinkSet33: "trace_SourceElementList" = None, TraceLinkSet23: "trace_SourceElement" = None):
    ...
    def getLinksByRule(self, trace_create, trace_rule) :
    ...
    def getDefaultSourceElements(self, trace_sourceElements) :
        # TODO: Implement getDefaultSourceElements method
        pass

    def getDefaultSourceElement(self, trace_sourceElement) :
