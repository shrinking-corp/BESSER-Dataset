...
domain_model = DomainModel(
    name="_0ec1a7ba_fff4_4434_9952_2bb1f7bcc0b8",
    types={RAM, Machine, Program, Instruction, Memory_Interface, DeviceCard, Card, Sound, GenericSound, Vendor1Adapter, Vendor2Adapter, Vendor1Sound, Vendor2Sound, ExtensionBoard, FastCard, CPU, Processor, AcceleratorCard, Cache},
