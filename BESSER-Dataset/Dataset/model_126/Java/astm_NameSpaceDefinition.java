...
public class astm_NameSpaceDefinition extends DefinitionObject {
    ...
    private astm_NameSpaceType astm_namespacetype;
    ...
    public astm_NameSpaceType getAstm_namespacetype() {
        return astm_namespacetype;
    }

    public void setAstm_namespacetype(astm_NameSpaceType astm_namespacetype) {
        this.astm_namespacetype = astm_namespacetype;
    }
