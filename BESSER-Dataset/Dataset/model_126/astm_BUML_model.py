...
astm_DelphiInterfaceSection = Class(name="astm_DelphiInterfaceSection")
astm_DelphiImplementationSection = Class(name="astm_DelphiImplementationSection")
astm_NamedTypeReference = Class(name="astm_NamedTypeReference")
astm_DelphiBlockStatement = Class(name="astm_DelphiBlockStatement")
BlockStatement = Class(name="BlockStatement")
astm_DelphiUnit = Class(name="astm_DelphiUnit")
...
astm_DelphiFunctionCallExpression = Class(name="astm_DelphiFunctionCallExpression")
FunctionCallExpression = Class(name="FunctionCallExpression")
astm_DelphiWithStatement = Class(name="astm_DelphiWithStatement")
...
astm_IntegerLiteral = Class(name="astm_IntegerLiteral")
...
astm_Operator = Class(name="astm_Operator")
...
astm_SourceLocation.attributes={astm_SourceLocation_startColumn, astm_SourceLocation_endLine, astm_SourceLocation_endColumn, astm_SourceLocation_startLine}
...
domain_model = DomainModel(
    name="astm",
    types={astm_Name, astm_DelphiInterfaceSection, astm_DelphiImplementationSection, astm_NamedTypeReference, astm_DelphiBlockStatement, BlockStatement, astm_DelphiUnit, CompilationUnit, astm_SourceLocation, astm_Project, GASTMSemanticObject, astm_CompilationUnit, astm_GlobalScope, astm_Scope, astm_DefinitionObject, astm_DelphiFunctionCallExpression, FunctionCallExpression, astm_DelphiWithStatement, astm_GASTMObject, Visitable, astm_GASTMSourceObject, astm_GASTMSemanticObject, astm_OtherSyntaxObject, GASTMSyntaxObject, astm_StorageSpecification, astm_DataType, Type, astm_AccessKind, astm_UnaryOperator, Operator, astm_BinaryOperator, astm_ActualParameter, astm_SourceFile, GASTMSourceObject, astm_Definition, DeclarationOrDefinition, astm_TypeReference, astm_Declaration, astm_GASTMSyntaxObject, GASTMObject, astm_PreprocessorElement, astm_AnnotationExpression, OtherSyntaxObject, astm_ProgramScope, astm_DeclarationOrDefinition, DefinitionObject, astm_EntryDefinition, astm_DataDefinition, astm_Expression, astm_BitFieldDefinition, DataDefinition, astm_EnumLiteralDefinition, astm_TypeDefinition, astm_FunctionDeclaration, Declaration, astm_FormalParameterDeclaration, astm_FunctionMemberAttributes, astm_VariableDeclaration, astm_FunctionDefinition, Definition, astm_FormalParameterDefinition, astm_Statement, astm_FunctionScope, astm_VirtualSpecification, astm_NamedTypeDefinition, TypeDefinition, astm_NamedType, astm_AggregateTypeDefinition, astm_AggregateType, astm_NameSpaceDefinition, astm_NameSpaceType, astm_LabelDefinition, astm_Comment, astm_Type, astm_LabelType, astm_IncludeUnit, PreprocessorElement, astm_MacroCall, astm_MacroDefinition, astm_AggregateScope, astm_ArrayType, ConstructedType, astm_Dimension, astm_FunctionType, astm_FormalParameterType, astm_PrimitiveType, DataType, astm_ClassType, AggregateType, astm_DerivesFrom, astm_EnumType, astm_ConstructedType, astm_UnnamedTypeReference, astm_BlockStatement, TypeReference, astm_BlockScope, astm_DeleteStatement, Statement, astm_DeclarationOrDefinitionStatement, astm_ExpressionStatement, astm_JumpStatement, astm_BreakStatement, astm_LabelAccess, astm_ContinueStatement, astm_LabeledStatement, astm_SwitchStatement, astm_SwitchCase, astm_EmptyStatement, astm_IfStatement, astm_CaseBlock, SwitchCase, astm_ReturnStatement, astm_LoopStatement, astm_ForStatement, LoopStatement, astm_TryStatement, astm_CatchBlock, astm_NameReference, Expression, astm_TypesCatchBlock, CatchBlock, astm_VariableCatchBlock, astm_ArrayAccess, astm_ThrowStatement, astm_QualifiedIdentifierReference, NameReference, astm_IdentifierReference, astm_UnaryExpression, astm_TypeQualifiedIdentifierReference, astm_Literal, astm_BinaryExpression, astm_CastExpression, astm_OperatorAssign, BinaryOperator, astm_ConditionalExpression, astm_ActualParameterExpression, ActualParameter, astm_NewExpression, astm_RangeExpression, astm_FunctionCallExpression, Scope, astm_VariableDefinition, astm_FunctionMemberAttribute, astm_External, StorageSpecification, astm_FunctionPersistent, astm_FileLocal, astm_PerClassMember, astm_NoDef, astm_Virtual, VirtualSpecification, astm_PureVirtual, astm_NonVirtual, astm_ExceptionType, astm_RangeType, astm_Void, PrimitiveType, astm_StructureType, astm_UnionType, astm_Byte, astm_AnnotationType, astm_ShortInteger, astm_ByValueFormalParameterType, astm_Integer, FormalParameterType, astm_LongInteger, astm_ByReferenceFormalParameterType, astm_Float, astm_Public, AccessKind, astm_Double, astm_Protected, astm_LongDouble, astm_Private, astm_Character, astm_TerminateStatement, astm_String, astm_DefaultBlock, astm_Boolean, astm_WhileStatement, astm_WideCharacter, astm_DoWhileStatement, astm_CollectionType, astm_ForCheckBeforeStatement, ForStatement, astm_PointerType, astm_ForCheckAfterStatement, astm_ReferenceType, astm_AggregateExpression, astm_QualifiedOverPointer, QualifiedIdentifierReference, astm_Increment, astm_QualifiedOverData, astm_Decrement, astm_IntegerLiteral, astm_PostIncrement, astm_PostDecrement, Literal, astm_StringLiteral, astm_CharLiteral, astm_Add, astm_Subtract, astm_RealLiteral, astm_Multiply, astm_Divide, astm_BooleanLiteral, astm_Modulus, astm_BitLiteral, astm_Exponent, astm_UnaryPlus, UnaryOperator, astm_And, astm_Negate, astm_Not, astm_Or, astm_BitNot, astm_AddressOf, astm_Deref, astm_Equal, astm_NotEqual, astm_Greater, astm_NotGreater, astm_Less, astm_NotLess, astm_SpecificLessEqual, astm_SpecificGreaterEqual, astm_SpecificIn, astm_BitAnd, astm_BitOr, astm_SpecificLike, astm_BitXor, astm_SpecificConcatString, astm_BitLeftShift, astm_SpecificSelectStatement, astm_BitRightShift, astm_Visitable, astm_Assign, astm_Operator, astm_MissingActualParameter, astm_ByValueActualParameterExpression, ActualParameterExpression, astm_ByReferenceActualParameterExpression, astm_SpecificTriggerDefinition},
    associations={name0, interface1, implementation3, uses5, uses7, exports10, inSourceFile21, files22, outerScope23, definitionObject25, exports13, declarations15, applyTo17, withs19, identifierName45, definitionType47, defRef49, identifierName51, declarationType54, childScope28, locationInfo30, preProcessorElements32, annotations34, fragments36, opensScope39, storageSpecifiers41, accessKind42, formalParameters76, body78, initialValue81, bitFieldSize82, value84, name86, formalParameters57, functionMemberAttributes58, returnType60, returnType63, formalParameters65, body67, functionMemberAttributes69, opensScope72, virtualSpecifier74, labelName97, definitionType88, aggregateType89, nameSpace90, body92, nameSpaceType95, labelType99, file101, refersTo103, members108, opensScope111, ranks113, lowBound114, highBound117, returnType120, parameterTypes122, type124, body127, derivesFrom129, enumLiterals104, baseType106, statement157, subStatements160, type136, opensScope162, name138, type141, operand144, declOrDefn146, expression148, target150, target152, accessKind130, target153, label155, className133, switchExpression172, cases174, condition164, thenBody166, elseBody169, body176, caseExpressions179, returnValue181, condition183, body185, initBody188, iterationBody190, guardedStatement193, catchBlocks195, finalStatement197, expressionType209, body200, name212, exceptions203, refersTo214, exceptionVariable205, arrayName217, subscripts219, exception207, qualifiers222, expression233, operator236, member224, aggregateType226, member228, operand238, operator241, castType231, leftOperand243, rightOperand246, operator249, condition251, onTrueOperand253, calledFunction264, actualParams266, value268, newType270, actualParams272, name275, onFalseOperand256, fromExpression259, toExpression261, definition278, annotationType281, memberValues284, body287},
    generalizations={gen_astm_DelphiInterfaceSection_CompilationUnit, gen_astm_DelphiImplementationSection_CompilationUnit, gen_astm_DelphiBlockStatement_BlockStatement, gen_astm_DelphiUnit_CompilationUnit, gen_astm_SourceLocation_GASTMSourceObject, gen_astm_Project_GASTMSemanticObject, gen_astm_Scope_GASTMSemanticObject, gen_astm_DelphiFunctionCallExpression_FunctionCallExpression, gen_astm_DelphiWithStatement_BlockStatement, gen_astm_GASTMObject_Visitable, gen_astm_GASTMSourceObject_Visitable, gen_astm_GASTMSemanticObject_Visitable, gen_astm_OtherSyntaxObject_GASTMSyntaxObject, gen_astm_StorageSpecification_Visitable, gen_astm_DataType_Type, gen_astm_AccessKind_Visitable, gen_astm_UnaryOperator_Operator, gen_astm_BinaryOperator_Operator, gen_astm_ActualParameter_Visitable, gen_astm_SourceFile_GASTMSourceObject, gen_astm_Definition_DeclarationOrDefinition, gen_astm_Declaration_DeclarationOrDefinition, gen_astm_GASTMSyntaxObject_GASTMObject, gen_astm_CompilationUnit_OtherSyntaxObject, gen_astm_Name_OtherSyntaxObject, gen_astm_DeclarationOrDefinition_DefinitionObject, gen_astm_EntryDefinition_Definition, gen_astm_DataDefinition_Definition, gen_astm_BitFieldDefinition_DataDefinition, gen_astm_EnumLiteralDefinition_Definition, gen_astm_TypeDefinition_DefinitionObject, gen_astm_FunctionDeclaration_Declaration, gen_astm_VariableDeclaration_Declaration, gen_astm_FunctionDefinition_Definition, gen_astm_FunctionMemberAttributes_Visitable, gen_astm_NamedTypeDefinition_TypeDefinition, gen_astm_AggregateTypeDefinition_TypeDefinition, gen_astm_NameSpaceDefinition_DefinitionObject, gen_astm_LabelDefinition_DefinitionObject, gen_astm_MacroDefinition_PreprocessorElement, gen_astm_Comment_PreprocessorElement, gen_astm_Type_GASTMSyntaxObject, gen_astm_IncludeUnit_PreprocessorElement, gen_astm_MacroCall_PreprocessorElement, gen_astm_ArrayType_ConstructedType, gen_astm_Dimension_OtherSyntaxObject, gen_astm_FunctionType_Type, gen_astm_FormalParameterType_DataType, gen_astm_NamedType_DataType, gen_astm_PrimitiveType_DataType, gen_astm_ClassType_AggregateType, gen_astm_EnumType_DataType, gen_astm_DerivesFrom_OtherSyntaxObject, gen_astm_ConstructedType_DataType, gen_astm_AggregateType_DataType, gen_astm_BlockStatement_Statement, gen_astm_UnnamedTypeReference_TypeReference, gen_astm_NamedTypeReference_TypeReference, gen_astm_DeleteStatement_Statement, gen_astm_DeclarationOrDefinitionStatement_Statement, gen_astm_ExpressionStatement_Statement, gen_astm_JumpStatement_Statement, gen_astm_BreakStatement_Statement, gen_astm_ContinueStatement_Statement, gen_astm_LabeledStatement_Statement, gen_astm_SwitchStatement_Statement, gen_astm_EmptyStatement_Statement, gen_astm_IfStatement_Statement, gen_astm_SwitchCase_OtherSyntaxObject, gen_astm_CaseBlock_SwitchCase, gen_astm_ReturnStatement_Statement, gen_astm_LoopStatement_Statement, gen_astm_ForStatement_LoopStatement, gen_astm_TryStatement_Statement, gen_astm_CatchBlock_OtherSyntaxObject, gen_astm_NameReference_Expression, gen_astm_TypesCatchBlock_CatchBlock, gen_astm_VariableCatchBlock_CatchBlock, gen_astm_ArrayAccess_Expression, gen_astm_ThrowStatement_Statement, gen_astm_QualifiedIdentifierReference_NameReference, gen_astm_Expression_GASTMSyntaxObject, gen_astm_UnaryExpression_Expression, gen_astm_TypeQualifiedIdentifierReference_NameReference, gen_astm_Literal_Expression, gen_astm_BinaryExpression_Expression, gen_astm_CastExpression_Expression, gen_astm_OperatorAssign_BinaryOperator, gen_astm_ConditionalExpression_Expression, gen_astm_ActualParameterExpression_ActualParameter, gen_astm_NewExpression_Expression, gen_astm_LabelAccess_Expression, gen_astm_RangeExpression_Expression, gen_astm_FunctionCallExpression_Expression, gen_astm_AggregateScope_Scope, gen_astm_AnnotationExpression_Expression, gen_astm_BlockScope_Scope, gen_astm_IdentifierReference_NameReference, gen_astm_FormalParameterDefinition_DataDefinition, gen_astm_GlobalScope_Scope, gen_astm_VirtualSpecification_OtherSyntaxObject, gen_astm_PreprocessorElement_GASTMSyntaxObject, gen_astm_FormalParameterDeclaration_Declaration, gen_astm_DefinitionObject_GASTMSyntaxObject, gen_astm_VariableDefinition_DataDefinition, gen_astm_ProgramScope_Scope, gen_astm_FunctionMemberAttribute_OtherSyntaxObject, gen_astm_TypeReference_Type, gen_astm_External_StorageSpecification, gen_astm_Statement_GASTMSyntaxObject, gen_astm_FunctionPersistent_StorageSpecification, gen_astm_FunctionScope_Scope, gen_astm_FileLocal_StorageSpecification, gen_astm_NameSpaceType_Type, gen_astm_PerClassMember_StorageSpecification, gen_astm_LabelType_Type, gen_astm_NoDef_StorageSpecification, gen_astm_Virtual_VirtualSpecification, gen_astm_PureVirtual_VirtualSpecification, gen_astm_NonVirtual_VirtualSpecification, gen_astm_ExceptionType_DataType, gen_astm_RangeType_ConstructedType, gen_astm_Void_PrimitiveType, gen_astm_StructureType_AggregateType, gen_astm_Byte_PrimitiveType, gen_astm_UnionType_AggregateType, gen_astm_AnnotationType_AggregateType, gen_astm_ShortInteger_PrimitiveType, gen_astm_Integer_PrimitiveType, gen_astm_ByValueFormalParameterType_FormalParameterType, gen_astm_LongInteger_PrimitiveType, gen_astm_ByReferenceFormalParameterType_FormalParameterType, gen_astm_Float_PrimitiveType, gen_astm_Public_AccessKind, gen_astm_Double_PrimitiveType, gen_astm_Protected_AccessKind, gen_astm_LongDouble_PrimitiveType, gen_astm_Private_AccessKind, gen_astm_Character_PrimitiveType, gen_astm_TerminateStatement_Statement, gen_astm_String_PrimitiveType, gen_astm_DefaultBlock_SwitchCase, gen_astm_Boolean_PrimitiveType, gen_astm_WhileStatement_LoopStatement, gen_astm_WideCharacter_PrimitiveType, gen_astm_DoWhileStatement_LoopStatement, gen_astm_CollectionType_ConstructedType, gen_astm_ForCheckBeforeStatement_ForStatement, gen_astm_PointerType_ConstructedType, gen_astm_ForCheckAfterStatement_ForStatement, gen_astm_ReferenceType_ConstructedType, gen_astm_AggregateExpression_Expression, gen_astm_QualifiedOverPointer_QualifiedIdentifierReference, gen_astm_Increment_UnaryOperator, gen_astm_QualifiedOverData_QualifiedIdentifierReference, gen_astm_Decrement_UnaryOperator, gen_astm_PostIncrement_UnaryOperator, gen_astm_IntegerLiteral_Literal, gen_astm_StringLiteral_Literal, gen_astm_PostDecrement_UnaryOperator, gen_astm_Add_BinaryOperator, gen_astm_CharLiteral_Literal, gen_astm_Subtract_BinaryOperator, gen_astm_Multiply_BinaryOperator, gen_astm_RealLiteral_Literal, gen_astm_Divide_BinaryOperator, gen_astm_BooleanLiteral_Literal, gen_astm_Modulus_BinaryOperator, gen_astm_BitLiteral_Literal, gen_astm_Exponent_BinaryOperator, gen_astm_UnaryPlus_UnaryOperator, gen_astm_And_BinaryOperator, gen_astm_Negate_UnaryOperator, gen_astm_Not_UnaryOperator, gen_astm_BitNot_UnaryOperator, gen_astm_Or_BinaryOperator, gen_astm_AddressOf_UnaryOperator, gen_astm_Deref_UnaryOperator, gen_astm_Equal_BinaryOperator, gen_astm_NotEqual_BinaryOperator, gen_astm_Greater_BinaryOperator, gen_astm_NotGreater_BinaryOperator, gen_astm_Less_BinaryOperator, gen_astm_NotLess_BinaryOperator, gen_astm_SpecificLessEqual_BinaryOperator, gen_astm_SpecificGreaterEqual_BinaryOperator, gen_astm_SpecificIn_BinaryOperator, gen_astm_BitAnd_BinaryOperator, gen_astm_BitOr_BinaryOperator, gen_astm_SpecificLike_BinaryOperator, gen_astm_BitXor_BinaryOperator, gen_astm_SpecificConcatString_BinaryOperator, gen_astm_BitLeftShift_BinaryOperator, gen_astm_SpecificSelectStatement_Statement, gen_astm_BitRightShift_BinaryOperator, gen_astm_Assign_BinaryOperator, gen_astm_Operator_OtherSyntaxObject, gen_astm_MissingActualParameter_ActualParameter, gen_astm_ByValueActualParameterExpression_ActualParameterExpression, gen_astm_ByReferenceActualParameterExpression_ActualParameterExpression, gen_astm_SpecificTriggerDefinition_Definition},
    metadata=None
)
