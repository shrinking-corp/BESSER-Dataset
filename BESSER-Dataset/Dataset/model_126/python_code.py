...
class astm_DerivesFrom(OtherSyntaxObject):
    ...
    def __init__(self, isVirtual: bool, astm_DerivesFrom131: "astm_OtherSyntaxObject" = None, astm_DerivesFrom134: "astm_NamedType" = None, astm_DerivesFrom: "astm_ClassType" = None):
...
class astm_Type(GASTMSyntaxObject):
    ...
    def __init__(self, isConst: bool, isVolatile: bool, astm_Type204: "astm_TypesCatchBlock" = None, astm_Type: "astm_NamedType" = None, astm_Type137: "astm_UnnamedTypeReference" = None):
...
class astm_FunctionMemberAttributes(Visitable):
    ...
    def __init__(self, isFriend: bool, isInline: bool, isThisConst: bool, astm_FunctionMemberAttributes: "astm_FunctionDeclaration" = None, astm_FunctionMemberAttributes71: "astm_FunctionDefinition" = None, astm_FunctionMemberAttributes75: "astm_VirtualSpecification" = None):
...
class astm_CompilationUnit(OtherSyntaxObject):
    ...
    def __init__(self, language: str, astm_CompilationUnit: "astm_Project" = None, astm_CompilationUnit37: set["astm_DefinitionObject"] = None, astm_CompilationUnit40: "astm_ProgramScope" = None):
...
class astm_Name(OtherSyntaxObject):
    ...
    def __init__(self, nameString: str, astm_Name: "astm_DelphiUnit" = None, astm_Name46: "astm_Definition" = None, astm_Name53: "astm_Declaration" = None, astm_Name87: "astm_TypeDefinition" = None, astm_Name98: "astm_LabelDefinition" = None, astm_Name91: "astm_NameSpaceDefinition" = None, astm_Name140: "astm_NamedTypeReference" = None, astm_Name213: "astm_NameReference" = None, astm_Name277: "astm_LabelAccess" = None):
