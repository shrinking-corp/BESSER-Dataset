...
def test_hyp_astm_integerliteral_is_not_abstract():
    assert not inspect.isabstract(astm_IntegerLiteral)


def test_hyp_astm_integerliteral_constructor_exists():
    assert callable(astm_IntegerLiteral.__init__)


def test_hyp_astm_integerliteral_constructor_args():
...
def test_hyp_astm_operator_is_not_abstract():
    assert not inspect.isabstract(astm_Operator)


def test_hyp_astm_operator_constructor_exists():
    assert callable(astm_Operator.__init__)


def test_hyp_astm_operator_constructor_args():
...
def test_hyp_astm_delphifunctioncallexpression_is_not_abstract():
    assert not inspect.isabstract(astm_DelphiFunctionCallExpression)


def test_hyp_astm_delphifunctioncallexpression_constructor_exists():
    assert callable(astm_DelphiFunctionCallExpression.__init__)


def test_hyp_astm_delphifunctioncallexpression_constructor_args():
...
def test_hyp_astm_delphiunit_is_not_abstract():
    assert not inspect.isabstract(astm_DelphiUnit)


def test_hyp_astm_delphiunit_constructor_exists():
    assert callable(astm_DelphiUnit.__init__)


def test_hyp_astm_delphiunit_constructor_args():
...
def test_hyp_astm_delphiwithstatement_is_not_abstract():
    assert not inspect.isabstract(astm_DelphiWithStatement)


def test_hyp_astm_delphiwithstatement_constructor_exists():
    assert callable(astm_DelphiWithStatement.__init__)


def test_hyp_astm_delphiwithstatement_constructor_args():
    sig = inspect.signature(astm_DelphiWithStatement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_astm_delphiblockstatement_is_not_abstract():
    assert not inspect.isabstract(astm_DelphiBlockStatement)


def test_hyp_astm_delphiblockstatement_constructor_exists():
    assert callable(astm_DelphiBlockStatement.__init__)


def test_hyp_astm_delphiblockstatement_constructor_args():
...
def test_hyp_astm_delphiimplementationsection_is_not_abstract():
    assert not inspect.isabstract(astm_DelphiImplementationSection)


def test_hyp_astm_delphiimplementationsection_constructor_exists():
    assert callable(astm_DelphiImplementationSection.__init__)


def test_hyp_astm_delphiimplementationsection_constructor_args():
    sig = inspect.signature(astm_DelphiImplementationSection.__init__)
    params = list(sig.parameters.keys())



def test_hyp_astm_delphiinterfacesection_is_not_abstract():
    assert not inspect.isabstract(astm_DelphiInterfaceSection)


def test_hyp_astm_delphiinterfacesection_constructor_exists():
    assert callable(astm_DelphiInterfaceSection.__init__)


def test_hyp_astm_delphiinterfacesection_constructor_args():
...
def test_astm_DelphiBlockStatement_isa_BlockStatement():
    instance = astm_DelphiBlockStatement()
    assert isinstance(instance, BlockStatement)


def test_astm_DelphiWithStatement_isa_BlockStatement():
    instance = astm_DelphiWithStatement()
    assert isinstance(instance, BlockStatement)
...
def test_astm_DelphiImplementationSection_isa_CompilationUnit():
    instance = astm_DelphiImplementationSection()
    assert isinstance(instance, CompilationUnit)


def test_astm_DelphiInterfaceSection_isa_CompilationUnit():
    instance = astm_DelphiInterfaceSection()
    assert isinstance(instance, CompilationUnit)


def test_astm_DelphiUnit_isa_CompilationUnit():
    instance = astm_DelphiUnit()
    assert isinstance(instance, CompilationUnit)
...
def test_astm_DelphiFunctionCallExpression_isa_FunctionCallExpression():
    instance = astm_DelphiFunctionCallExpression()
...
def test_astm_OtherSyntaxObject_isa_GASTMSyntaxObject():
...
def test_astm_IntegerLiteral_isa_Literal():
    instance = astm_IntegerLiteral()
    assert isinstance(instance, Literal)
...
def test_astm_BinaryOperator_isa_Operator():
    instance = astm_BinaryOperator()
    assert isinstance(instance, Operator)


def test_astm_UnaryOperator_isa_Operator():
...
def test_astm_Operator_isa_OtherSyntaxObject():
    instance = astm_Operator()
    assert isinstance(instance, OtherSyntaxObject)
...
def test_astm_DataType_isa_Type():
...
def test_assoc_accessKind130_link_reassign_clear():
    a = astm_DerivesFrom(isVirtual=True)
    b1 = astm_OtherSyntaxObject()
    b2 = astm_OtherSyntaxObject()
    _safe_set(a, 'astm_DerivesFrom131', b1)
    assert _is_linked(a, 'astm_DerivesFrom131', b1)
    if hasattr(b1, 'astm_OtherSyntaxObject132'):
        assert _is_linked(b1, 'astm_OtherSyntaxObject132', a)
    _safe_set(a, 'astm_DerivesFrom131', b2)
    assert _is_linked(a, 'astm_DerivesFrom131', b2)
    if hasattr(b1, 'astm_OtherSyntaxObject132'):
        assert not _is_linked(b1, 'astm_OtherSyntaxObject132', a)
    if hasattr(b2, 'astm_OtherSyntaxObject132'):
        assert _is_linked(b2, 'astm_OtherSyntaxObject132', a)
    _safe_set(a, 'astm_DerivesFrom131', None)
    assert not _is_linked(a, 'astm_DerivesFrom131', b2)
    if hasattr(b2, 'astm_OtherSyntaxObject132'):
        assert not _is_linked(b2, 'astm_OtherSyntaxObject132', a)


def test_assoc_accessKind42_link_reassign_clear():
    a = astm_DeclarationOrDefinition(isRegister=True, linkageSpecifier="sample_text")
    b1 = astm_OtherSyntaxObject()
    b2 = astm_OtherSyntaxObject()
    _safe_set(a, 'astm_DeclarationOrDefinition43', b1)
    assert _is_linked(a, 'astm_DeclarationOrDefinition43', b1)
    if hasattr(b1, 'astm_OtherSyntaxObject44'):
        assert _is_linked(b1, 'astm_OtherSyntaxObject44', a)
    _safe_set(a, 'astm_DeclarationOrDefinition43', b2)
    assert _is_linked(a, 'astm_DeclarationOrDefinition43', b2)
    if hasattr(b1, 'astm_OtherSyntaxObject44'):
        assert not _is_linked(b1, 'astm_OtherSyntaxObject44', a)
    if hasattr(b2, 'astm_OtherSyntaxObject44'):
        assert _is_linked(b2, 'astm_OtherSyntaxObject44', a)
    _safe_set(a, 'astm_DeclarationOrDefinition43', None)
    assert not _is_linked(a, 'astm_DeclarationOrDefinition43', b2)
    if hasattr(b2, 'astm_OtherSyntaxObject44'):
        assert not _is_linked(b2, 'astm_OtherSyntaxObject44', a)


def test_assoc_body127_link_reassign_clear():
    a = astm_Type(isConst=True, isVolatile=True)
    b1 = astm_NamedType()
    b2 = astm_NamedType()
    _safe_set(a, 'astm_Type', b1)
    assert _is_linked(a, 'astm_Type', b1)
    if hasattr(b1, 'astm_NamedType128'):
        assert _is_linked(b1, 'astm_NamedType128', a)
    _safe_set(a, 'astm_Type', b2)
    assert _is_linked(a, 'astm_Type', b2)
    if hasattr(b1, 'astm_NamedType128'):
        assert not _is_linked(b1, 'astm_NamedType128', a)
    if hasattr(b2, 'astm_NamedType128'):
        assert _is_linked(b2, 'astm_NamedType128', a)
    _safe_set(a, 'astm_Type', None)
    assert not _is_linked(a, 'astm_Type', b2)
    if hasattr(b2, 'astm_NamedType128'):
        assert not _is_linked(b2, 'astm_NamedType128', a)


def test_assoc_className133_link_reassign_clear():
    a = astm_DerivesFrom(isVirtual=True)
    b1 = astm_NamedType()
    b2 = astm_NamedType()
    _safe_set(a, 'astm_DerivesFrom134', b1)
    assert _is_linked(a, 'astm_DerivesFrom134', b1)
    if hasattr(b1, 'astm_NamedType135'):
        assert _is_linked(b1, 'astm_NamedType135', a)
    _safe_set(a, 'astm_DerivesFrom134', b2)
    assert _is_linked(a, 'astm_DerivesFrom134', b2)
    if hasattr(b1, 'astm_NamedType135'):
        assert not _is_linked(b1, 'astm_NamedType135', a)
    if hasattr(b2, 'astm_NamedType135'):
        assert _is_linked(b2, 'astm_NamedType135', a)
    _safe_set(a, 'astm_DerivesFrom134', None)
    assert not _is_linked(a, 'astm_DerivesFrom134', b2)
    if hasattr(b2, 'astm_NamedType135'):
        assert not _is_linked(b2, 'astm_NamedType135', a)


def test_assoc_derivesFrom129_link_reassign_clear():
    a = astm_DerivesFrom(isVirtual=True)
    b1 = astm_ClassType()
    b2 = astm_ClassType()
...
def test_assoc_exceptionVariable205_link_reassign_clear():
    a = astm_DataDefinition(isMutable=True)
    b1 = astm_VariableCatchBlock()
    b2 = astm_VariableCatchBlock()
    _safe_set(a, 'astm_DataDefinition206', b1)
    assert _is_linked(a, 'astm_DataDefinition206', b1)
    if hasattr(b1, 'astm_VariableCatchBlock'):
        assert _is_linked(b1, 'astm_VariableCatchBlock', a)
    _safe_set(a, 'astm_DataDefinition206', b2)
    assert _is_linked(a, 'astm_DataDefinition206', b2)
    if hasattr(b1, 'astm_VariableCatchBlock'):
    ...
    _safe_set(a, 'astm_DataDefinition206', None)
    assert not _is_linked(a, 'astm_DataDefinition206', b2)
    if hasattr(b2, 'astm_VariableCatchBlock'):
        assert not _is_linked(b2, 'astm_VariableCatchBlock', a)


def test_assoc_exceptions203_link_reassign_clear():
    a = astm_Type(isConst=True, isVolatile=True)
    b1 = astm_TypesCatchBlock()
    b2 = astm_TypesCatchBlock()
    _safe_set(a, 'astm_Type204', b1)
    assert _is_linked(a, 'astm_Type204', b1)
    if hasattr(b1, 'astm_TypesCatchBlock'):
        assert _is_linked(b1, 'astm_TypesCatchBlock', a)
    _safe_set(a, 'astm_Type204', b2)
    assert _is_linked(a, 'astm_Type204', b2)
    if hasattr(b1, 'astm_TypesCatchBlock'):
    ...
    _safe_set(a, 'astm_Type204', None)
    assert not _is_linked(a, 'astm_Type204', b2)
    if hasattr(b2, 'astm_TypesCatchBlock'):
        assert not _is_linked(b2, 'astm_TypesCatchBlock', a)


def test_assoc_file101_link_reassign_clear():
    a = astm_SourceFile(pathName="sample_text")
    b1 = astm_IncludeUnit()
    b2 = astm_IncludeUnit()
    _safe_set(a, 'astm_SourceFile102', b1)
    assert _is_linked(a, 'astm_SourceFile102', b1)
    if hasattr(b1, 'astm_IncludeUnit'):
        assert _is_linked(b1, 'astm_IncludeUnit', a)
    _safe_set(a, 'astm_SourceFile102', b2)
    assert _is_linked(a, 'astm_SourceFile102', b2)
    if hasattr(b1, 'astm_IncludeUnit'):
        assert not _is_linked(b1, 'astm_IncludeUnit', a)
    if hasattr(b2, 'astm_IncludeUnit'):
        assert _is_linked(b2, 'astm_IncludeUnit', a)
    _safe_set(a, 'astm_SourceFile102', None)
    assert not _is_linked(a, 'astm_SourceFile102', b2)
    if hasattr(b2, 'astm_IncludeUnit'):
        assert not _is_linked(b2, 'astm_IncludeUnit', a)


def test_assoc_files22_link_reassign_clear():
...
def test_assoc_fragments36_link_reassign_clear():
    a = astm_CompilationUnit(language="sample_text")
    b1 = astm_DefinitionObject()
    b2 = astm_DefinitionObject()
    _safe_set(a, 'astm_CompilationUnit37', {b1})
    assert _is_linked(a, 'astm_CompilationUnit37', b1)
    if hasattr(b1, 'astm_DefinitionObject38'):
        assert _is_linked(b1, 'astm_DefinitionObject38', a)
    _safe_set(a, 'astm_CompilationUnit37', {b2})
    assert _is_linked(a, 'astm_CompilationUnit37', b2)
    if hasattr(b1, 'astm_DefinitionObject38'):
        assert not _is_linked(b1, 'astm_DefinitionObject38', a)
    if hasattr(b2, 'astm_DefinitionObject38'):
        assert _is_linked(b2, 'astm_DefinitionObject38', a)
    _safe_set(a, 'astm_CompilationUnit37', set())
    assert not _is_linked(a, 'astm_CompilationUnit37', b2)
    if hasattr(b2, 'astm_DefinitionObject38'):
        assert not _is_linked(b2, 'astm_DefinitionObject38', a)


def test_assoc_functionMemberAttributes58_link_reassign_clear():
    ...
    if hasattr(b1, 'astm_FunctionDeclaration59'):
        assert _is_linked(b1, 'astm_FunctionDeclaration59', a)
    _safe_set(a, 'astm_FunctionMemberAttributes', b2)
    assert _is_linked(a, 'astm_FunctionMemberAttributes', b2)
    if hasattr(b1, 'astm_FunctionDeclaration59'):
        assert not _is_linked(b1, 'astm_FunctionDeclaration59', a)
    if hasattr(b2, 'astm_FunctionDeclaration59'):
        assert _is_linked(b2, 'astm_FunctionDeclaration59', a)
    _safe_set(a, 'astm_FunctionMemberAttributes', None)
    assert not _is_linked(a, 'astm_FunctionMemberAttributes', b2)
    if hasattr(b2, 'astm_FunctionDeclaration59'):
        assert not _is_linked(b2, 'astm_FunctionDeclaration59', a)


def test_assoc_functionMemberAttributes69_link_reassign_clear():
    a = astm_FunctionMemberAttributes(isFriend=True, isInline=True, isThisConst=True)
    b1 = astm_FunctionDefinition()
    b2 = astm_FunctionDefinition()
    _safe_set(a, 'astm_FunctionMemberAttributes71', b1)
    assert _is_linked(a, 'astm_FunctionMemberAttributes71', b1)
    if hasattr(b1, 'astm_FunctionDefinition70'):
        assert _is_linked(b1, 'astm_FunctionDefinition70', a)
    _safe_set(a, 'astm_FunctionMemberAttributes71', b2)
    assert _is_linked(a, 'astm_FunctionMemberAttributes71', b2)
    if hasattr(b1, 'astm_FunctionDefinition70'):
        assert not _is_linked(b1, 'astm_FunctionDefinition70', a)
    if hasattr(b2, 'astm_FunctionDefinition70'):
        assert _is_linked(b2, 'astm_FunctionDefinition70', a)
    _safe_set(a, 'astm_FunctionMemberAttributes71', None)
    assert not _is_linked(a, 'astm_FunctionMemberAttributes71', b2)
    if hasattr(b2, 'astm_FunctionDefinition70'):
        assert not _is_linked(b2, 'astm_FunctionDefinition70', a)


def test_assoc_identifierName45_link_reassign_clear():
    a = astm_Name(nameString="sample_text")
    b1 = astm_Definition()
    b2 = astm_Definition()
    _safe_set(a, 'astm_Name46', b1)
    assert _is_linked(a, 'astm_Name46', b1)
    if hasattr(b1, 'astm_Definition'):
        assert _is_linked(b1, 'astm_Definition', a)
    _safe_set(a, 'astm_Name46', b2)
    assert _is_linked(a, 'astm_Name46', b2)
    if hasattr(b1, 'astm_Definition'):
        assert not _is_linked(b1, 'astm_Definition', a)
    if hasattr(b2, 'astm_Definition'):
        assert _is_linked(b2, 'astm_Definition', a)
    _safe_set(a, 'astm_Name46', None)
    assert not _is_linked(a, 'astm_Name46', b2)
    if hasattr(b2, 'astm_Definition'):
        assert not _is_linked(b2, 'astm_Definition', a)


def test_assoc_identifierName51_link_reassign_clear():
    a = astm_Name(nameString="sample_text")
    b1 = astm_Declaration()
    b2 = astm_Declaration()
    _safe_set(a, 'astm_Name53', b1)
    assert _is_linked(a, 'astm_Name53', b1)
    if hasattr(b1, 'astm_Declaration52'):
        assert _is_linked(b1, 'astm_Declaration52', a)
    _safe_set(a, 'astm_Name53', b2)
    assert _is_linked(a, 'astm_Name53', b2)
    if hasattr(b1, 'astm_Declaration52'):
        assert not _is_linked(b1, 'astm_Declaration52', a)
    if hasattr(b2, 'astm_Declaration52'):
        assert _is_linked(b2, 'astm_Declaration52', a)
    _safe_set(a, 'astm_Name53', None)
    assert not _is_linked(a, 'astm_Name53', b2)
    if hasattr(b2, 'astm_Declaration52'):
        assert not _is_linked(b2, 'astm_Declaration52', a)


def test_assoc_inSourceFile21_link_reassign_clear():
...
def test_assoc_initialValue81_link_reassign_clear():
    a = astm_DataDefinition(isMutable=True)
    b1 = astm_Expression()
    b2 = astm_Expression()
...
def test_assoc_labelName97_link_reassign_clear():
    a = astm_Name(nameString="sample_text")
    b1 = astm_LabelDefinition()
    b2 = astm_LabelDefinition()
    _safe_set(a, 'astm_Name98', b1)
    assert _is_linked(a, 'astm_Name98', b1)
    if hasattr(b1, 'astm_LabelDefinition'):
        assert _is_linked(b1, 'astm_LabelDefinition', a)
    _safe_set(a, 'astm_Name98', b2)
    assert _is_linked(a, 'astm_Name98', b2)
    if hasattr(b1, 'astm_LabelDefinition'):
    ...
    _safe_set(a, 'astm_Name98', None)
    assert not _is_linked(a, 'astm_Name98', b2)
    if hasattr(b2, 'astm_LabelDefinition'):
        assert not _is_linked(b2, 'astm_LabelDefinition', a)


def test_assoc_locationInfo30_link_reassign_clear():
    a = astm_SourceLocation(endColumn=7, endLine=7, startColumn=7, startLine=7)
    b1 = astm_GASTMSyntaxObject()
    b2 = astm_GASTMSyntaxObject()
    _safe_set(a, 'astm_SourceLocation31', b1)
    assert _is_linked(a, 'astm_SourceLocation31', b1)
    if hasattr(b1, 'astm_GASTMSyntaxObject'):
        assert _is_linked(b1, 'astm_GASTMSyntaxObject', a)
    _safe_set(a, 'astm_SourceLocation31', b2)
    assert _is_linked(a, 'astm_SourceLocation31', b2)
    if hasattr(b1, 'astm_GASTMSyntaxObject'):
    ...
    _safe_set(a, 'astm_SourceLocation31', None)
    assert not _is_linked(a, 'astm_SourceLocation31', b2)
    if hasattr(b2, 'astm_GASTMSyntaxObject'):
...
def test_assoc_name0_link_reassign_clear():
    ...
    if hasattr(b1, 'astm_DelphiUnit'):
        assert _is_linked(b1, 'astm_DelphiUnit', a)
    _safe_set(a, 'astm_Name', b2)
    assert _is_linked(a, 'astm_Name', b2)
    if hasattr(b1, 'astm_DelphiUnit'):
        assert not _is_linked(b1, 'astm_DelphiUnit', a)
    if hasattr(b2, 'astm_DelphiUnit'):
        assert _is_linked(b2, 'astm_DelphiUnit', a)
    _safe_set(a, 'astm_Name', None)
    assert not _is_linked(a, 'astm_Name', b2)
    if hasattr(b2, 'astm_DelphiUnit'):
        assert not _is_linked(b2, 'astm_DelphiUnit', a)
...
def test_assoc_name138_link_reassign_clear():
    ...
    _safe_set(a, 'astm_Name140', b1)
    assert _is_linked(a, 'astm_Name140', b1)
    if hasattr(b1, 'astm_NamedTypeReference139'):
        assert _is_linked(b1, 'astm_NamedTypeReference139', a)
    _safe_set(a, 'astm_Name140', b2)
    assert _is_linked(a, 'astm_Name140', b2)
    if hasattr(b1, 'astm_NamedTypeReference139'):
        assert not _is_linked(b1, 'astm_NamedTypeReference139', a)
    if hasattr(b2, 'astm_NamedTypeReference139'):
        assert _is_linked(b2, 'astm_NamedTypeReference139', a)
    _safe_set(a, 'astm_Name140', None)
    assert not _is_linked(a, 'astm_Name140', b2)
    if hasattr(b2, 'astm_NamedTypeReference139'):
        assert not _is_linked(b2, 'astm_NamedTypeReference139', a)


def test_assoc_name212_link_reassign_clear():
    a = astm_Name(nameString="sample_text")
    b1 = astm_NameReference()
    b2 = astm_NameReference()
    _safe_set(a, 'astm_Name213', b1)
    assert _is_linked(a, 'astm_Name213', b1)
    if hasattr(b1, 'astm_NameReference'):
        assert _is_linked(b1, 'astm_NameReference', a)
    _safe_set(a, 'astm_Name213', b2)
    assert _is_linked(a, 'astm_Name213', b2)
    if hasattr(b1, 'astm_NameReference'):
        assert not _is_linked(b1, 'astm_NameReference', a)
    if hasattr(b2, 'astm_NameReference'):
        assert _is_linked(b2, 'astm_NameReference', a)
    _safe_set(a, 'astm_Name213', None)
    assert not _is_linked(a, 'astm_Name213', b2)
    if hasattr(b2, 'astm_NameReference'):
        assert not _is_linked(b2, 'astm_NameReference', a)


def test_assoc_name275_link_reassign_clear():
    a = astm_Name(nameString="sample_text")
    b1 = astm_LabelAccess()
    b2 = astm_LabelAccess()
    _safe_set(a, 'astm_Name277', b1)
    assert _is_linked(a, 'astm_Name277', b1)
    if hasattr(b1, 'astm_LabelAccess276'):
        assert _is_linked(b1, 'astm_LabelAccess276', a)
    _safe_set(a, 'astm_Name277', b2)
    assert _is_linked(a, 'astm_Name277', b2)
    if hasattr(b1, 'astm_LabelAccess276'):
        assert not _is_linked(b1, 'astm_LabelAccess276', a)
    if hasattr(b2, 'astm_LabelAccess276'):
        assert _is_linked(b2, 'astm_LabelAccess276', a)
    _safe_set(a, 'astm_Name277', None)
    assert not _is_linked(a, 'astm_Name277', b2)
    if hasattr(b2, 'astm_LabelAccess276'):
        assert not _is_linked(b2, 'astm_LabelAccess276', a)


def test_assoc_name86_link_reassign_clear():
    a = astm_Name(nameString="sample_text")
    b1 = astm_TypeDefinition()
    b2 = astm_TypeDefinition()
    _safe_set(a, 'astm_Name87', b1)
    assert _is_linked(a, 'astm_Name87', b1)
    if hasattr(b1, 'astm_TypeDefinition'):
        assert _is_linked(b1, 'astm_TypeDefinition', a)
    _safe_set(a, 'astm_Name87', b2)
    assert _is_linked(a, 'astm_Name87', b2)
    if hasattr(b1, 'astm_TypeDefinition'):
    ...
    _safe_set(a, 'astm_Name87', None)
    assert not _is_linked(a, 'astm_Name87', b2)
    if hasattr(b2, 'astm_TypeDefinition'):
        assert not _is_linked(b2, 'astm_TypeDefinition', a)


def test_assoc_nameSpace90_link_reassign_clear():
    a = astm_Name(nameString="sample_text")
    b1 = astm_NameSpaceDefinition()
    b2 = astm_NameSpaceDefinition()
    _safe_set(a, 'astm_Name91', b1)
    assert _is_linked(a, 'astm_Name91', b1)
    if hasattr(b1, 'astm_NameSpaceDefinition'):
        assert _is_linked(b1, 'astm_NameSpaceDefinition', a)
    _safe_set(a, 'astm_Name91', b2)
    assert _is_linked(a, 'astm_Name91', b2)
    if hasattr(b1, 'astm_NameSpaceDefinition'):
    ...
    _safe_set(a, 'astm_Name91', None)
    assert not _is_linked(a, 'astm_Name91', b2)
    if hasattr(b2, 'astm_NameSpaceDefinition'):
        assert not _is_linked(b2, 'astm_NameSpaceDefinition', a)


def test_assoc_opensScope39_link_reassign_clear():
    a = astm_CompilationUnit(language="sample_text")
    b1 = astm_ProgramScope()
    b2 = astm_ProgramScope()
    _safe_set(a, 'astm_CompilationUnit40', b1)
    assert _is_linked(a, 'astm_CompilationUnit40', b1)
    if hasattr(b1, 'astm_ProgramScope'):
        assert _is_linked(b1, 'astm_ProgramScope', a)
    _safe_set(a, 'astm_CompilationUnit40', b2)
    assert _is_linked(a, 'astm_CompilationUnit40', b2)
    if hasattr(b1, 'astm_ProgramScope'):
        assert not _is_linked(b1, 'astm_ProgramScope', a)
    if hasattr(b2, 'astm_ProgramScope'):
        assert _is_linked(b2, 'astm_ProgramScope', a)
    _safe_set(a, 'astm_CompilationUnit40', None)
    assert not _is_linked(a, 'astm_CompilationUnit40', b2)
    if hasattr(b2, 'astm_ProgramScope'):
        assert not _is_linked(b2, 'astm_ProgramScope', a)


def test_assoc_refersTo103_link_reassign_clear():
...
def test_assoc_storageSpecifiers41_link_reassign_clear():
    a = astm_DeclarationOrDefinition(isRegister=True, linkageSpecifier="sample_text")
    b1 = astm_OtherSyntaxObject()
    b2 = astm_OtherSyntaxObject()
...
def test_assoc_type136_link_reassign_clear():
    ...
    _safe_set(a, 'astm_Type137', b1)
    assert _is_linked(a, 'astm_Type137', b1)
    if hasattr(b1, 'astm_UnnamedTypeReference'):
        assert _is_linked(b1, 'astm_UnnamedTypeReference', a)
    _safe_set(a, 'astm_Type137', b2)
    assert _is_linked(a, 'astm_Type137', b2)
    if hasattr(b1, 'astm_UnnamedTypeReference'):
    ...
    _safe_set(a, 'astm_Type137', None)
    assert not _is_linked(a, 'astm_Type137', b2)
    if hasattr(b2, 'astm_UnnamedTypeReference'):
        assert not _is_linked(b2, 'astm_UnnamedTypeReference', a)


def test_assoc_virtualSpecifier74_link_reassign_clear():
    a = astm_FunctionMemberAttributes(isFriend=True, isInline=True, isThisConst=True)
    b1 = astm_VirtualSpecification()
    b2 = astm_VirtualSpecification()
    _safe_set(a, 'astm_FunctionMemberAttributes75', b1)
    assert _is_linked(a, 'astm_FunctionMemberAttributes75', b1)
    if hasattr(b1, 'astm_VirtualSpecification'):
        assert _is_linked(b1, 'astm_VirtualSpecification', a)
    _safe_set(a, 'astm_FunctionMemberAttributes75', b2)
    assert _is_linked(a, 'astm_FunctionMemberAttributes75', b2)
    if hasattr(b1, 'astm_VirtualSpecification'):
    ...
    _safe_set(a, 'astm_FunctionMemberAttributes75', None)
    assert not _is_linked(a, 'astm_FunctionMemberAttributes75', b2)
    if hasattr(b2, 'astm_VirtualSpecification'):
...
astm_DelphiBlockStatement_strategy = st.builds(astm_DelphiBlockStatement)
...
astm_DelphiFunctionCallExpression_strategy = st.builds(astm_DelphiFunctionCallExpression)
...
astm_DelphiImplementationSection_strategy = st.builds(astm_DelphiImplementationSection)
...
astm_DelphiInterfaceSection_strategy = st.builds(astm_DelphiInterfaceSection)
...
astm_DelphiUnit_strategy = st.builds(astm_DelphiUnit)
...
astm_DelphiWithStatement_strategy = st.builds(astm_DelphiWithStatement)
...
astm_IntegerLiteral_strategy = st.builds(astm_IntegerLiteral)
...
astm_Operator_strategy = st.builds(astm_Operator)
