...
class workflow_WorkflowElement(ABC):
    ...
    def __init__(self, name: str, comment: str, x: int, y: int, width: int, height: int, workFlowElementId: str):
        self.name = name
...
class workflow_WorkflowNode(WorkflowElement):
    ...
    def __init__(self, isStart: bool, isFinish: bool, WorkflowNode: "workflow_Workflow" = None, WorkflowNode22: "workflow_OutputPort" = None, nodes: "workflow_Workflow" = None, node: set["workflow_OutputPort"] = None, node8: set["workflow_InputPort"] = None, WorkflowNode18: "workflow_InputPort" = None):
