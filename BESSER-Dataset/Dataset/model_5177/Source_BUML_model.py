...
# Classes
source_A = Class(name="source_A")
source_B = Class(name="source_B")
C = Class(name="C")
source_C = Class(name="source_C")
source_D = Class(name="source_D")
B = Class(name="B")
...
domain_model = DomainModel(
    name="source",
    types={source_A, source_B, C, source_C, source_D, B},
    associations={b0},
