...
def test_hyp_mrptrace_rdmelement_is_not_abstract():
    assert not inspect.isabstract(MRPTrace_RDMElement)


def test_hyp_mrptrace_rdmelement_constructor_exists():
    assert callable(MRPTrace_RDMElement.__init__)


def test_hyp_mrptrace_rdmelement_constructor_args():
    sig = inspect.signature(MRPTrace_RDMElement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mrptrace_namedelement_is_not_abstract():
    assert not inspect.isabstract(MRPTrace_NamedElement)


def test_hyp_mrptrace_namedelement_constructor_exists():
    assert callable(MRPTrace_NamedElement.__init__)


def test_hyp_mrptrace_namedelement_constructor_args():
...
def test_hyp_mrptrace_traceentry_is_not_abstract():
    assert not inspect.isabstract(MRPTrace_TraceEntry)


def test_hyp_mrptrace_traceentry_constructor_exists():
    assert callable(MRPTrace_TraceEntry.__init__)


def test_hyp_mrptrace_traceentry_constructor_args():
...
def test_hyp_mrptrace_event_is_not_abstract():
    assert not inspect.isabstract(MRPTrace_Event)


def test_hyp_mrptrace_event_constructor_exists():
    assert callable(MRPTrace_Event.__init__)


def test_hyp_mrptrace_event_constructor_args():
...
def test_hyp_mrptrace_trace_is_not_abstract():
    assert not inspect.isabstract(MRPTrace_Trace)


def test_hyp_mrptrace_trace_constructor_exists():
    assert callable(MRPTrace_Trace.__init__)


def test_hyp_mrptrace_trace_constructor_args():
...
def test_hyp_mrptrace_tracemodel_is_not_abstract():
    assert not inspect.isabstract(MRPTrace_TraceModel)


def test_hyp_mrptrace_tracemodel_constructor_exists():
    assert callable(MRPTrace_TraceModel.__init__)


def test_hyp_mrptrace_tracemodel_constructor_args():
...
def test_hyp_mrptrace_namedelement_name_setter(instance):
...
def test_hyp_mrptrace_traceentry_description_setter(instance):
...
def test_hyp_mrptrace_event_time_setter(instance):
...
def test_hyp_mrptrace_trace_granularity_setter(instance):
