...
# Classes
MRPTrace_TraceModel = Class(name="MRPTrace_TraceModel")
MRPTrace_Trace = Class(name="MRPTrace_Trace")
NamedElement = Class(name="NamedElement")
MRPTrace_TraceEntry = Class(name="MRPTrace_TraceEntry")
MRPTrace_Event = Class(name="MRPTrace_Event")
MRPTrace_NamedElement = Class(name="MRPTrace_NamedElement", is_abstract=True)
MRPTrace_RDMElement = Class(name="MRPTrace_RDMElement")
...
domain_model = DomainModel(
    name="MRPTrace",
    types={MRPTrace_TraceModel, MRPTrace_Trace, NamedElement, MRPTrace_TraceEntry, MRPTrace_Event, MRPTrace_NamedElement, MRPTrace_RDMElement, TimeUnit},
    associations={trace0, consistsOf1, nextEntry4, cause8, affectedRDMElements6},
