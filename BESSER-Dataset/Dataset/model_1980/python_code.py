...
class MRPTrace_TraceEntry:
    ...
    def __init__(self, description: str, MRPTrace_TraceEntry: "MRPTrace_Trace" = None, MRPTrace_TraceEntry5: "MRPTrace_TraceEntry" = None, MRPTrace_TraceEntry3: "MRPTrace_TraceEntry" = None, MRPTrace_TraceEntry9: "MRPTrace_Event" = None, MRPTrace_TraceEntry7: set["MRPTrace_RDMElement"] = None):
