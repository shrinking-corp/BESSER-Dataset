...
# Classes
Attribute_NodeIn = Class(name="Attribute_NodeIn")
Attribute_NodeOut = Class(name="Attribute_NodeOut")
Attribute_NodeInOut = Class(name="Attribute_NodeInOut")
Attribute_NodeVar = Class(name="Attribute_NodeVar")
