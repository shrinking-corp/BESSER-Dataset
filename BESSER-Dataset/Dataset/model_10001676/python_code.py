...
class User:
    ...
    def __init__(self, name: str, myprofile0: "Profile" = None, post2: set["Post"] = None, login4: "Login" = None, group6: set["Group"] = None, registeration8: "Sign_Up" = None, message10: set["Message"] = None, friends12: set["Friend"] = None, hashtag14: set["Hashtag"] = None, pages16: set["Page"] = None):
        self.name = name
...
class Sign_Up:
    ...
    def user9(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Sign_Up__user9", None)
        self.__user9 = value
