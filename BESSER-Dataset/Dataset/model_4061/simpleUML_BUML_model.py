...
simpleUML_Classifier = Class(name="simpleUML_Classifier")
simpleUML_DataType = Class(name="simpleUML_DataType")
simpleUML_NamedElement = Class(name="simpleUML_NamedElement")
...
domain_model = DomainModel(
    name="simpleUML",
    types={simpleUML_Class, Classifier, simpleUML_Attribute, simpleUML_Association, NamedElement, simpleUML_Classifier, simpleUML_DataType, simpleUML_NamedElement, simpleUML_Package},
    associations={superClasses1, attributes2, sourceAssociations4, navigableAssociationTargets5, type7, ownedElements10, owner12, source14, target15},
    generalizations={gen_simpleUML_Class_Classifier, gen_simpleUML_Attribute_NamedElement, gen_simpleUML_Classifier_NamedElement, gen_simpleUML_DataType_Classifier, gen_simpleUML_Package_Classifier, gen_simpleUML_Association_Classifier},
    metadata=None
)
