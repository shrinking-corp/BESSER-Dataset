...
def test_hyp_shoppingcart1_is_not_abstract():
    assert not inspect.isabstract(ShoppingCart1)


def test_hyp_shoppingcart1_constructor_exists():
    assert callable(ShoppingCart1.__init__)


def test_hyp_shoppingcart1_constructor_args():
...
def test_hyp_shoppingcart1_isClosed_setter(instance):
...
@given(instance=ShoppingCart1_strategy)
def test_hyp_shoppingcart1_totalPrice_setter(instance):
...
@given(instance=ShoppingCart1_strategy)
def test_hyp_shoppingcart1_itemCount_setter(instance):
...
@given(instance=ShoppingCart1_strategy)
def test_hyp_shoppingcart1_closed_setter(instance):
