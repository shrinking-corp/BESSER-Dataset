...
class Room:
    ...
    def __init__(self, roomno: int, location: str, patient5: set["Patient"] = None, staff6: set["Staff"] = None):
        self.roomno = roomno
...
class Patient:
    ...
    def __init__(self, id: int, name: str, telno: str, address: str, age: int, sex: str, roomno: int, doctors1: set["Doctor"] = None, room4: "Room" = None, bill8: "Bill" = None, receptionist10: "Receptionist" = None):
        self.id = id
        self.name = name
        self.telno = telno
...
class Doctor:
    ...
    def __init__(self, docid: int, name: str, department: str, specialization: str, phno: str, address: str, patients0: set["Patient"] = None, depmt2: "Department" = None):
        self.docid = docid
        self.name = name
