...
# Classes
dsl_Capture = Class(name="dsl_Capture")
Fonctionnalite = Class(name="Fonctionnalite")
dsl_Action = Class(name="dsl_Action")
dsl_Object = Class(name="dsl_Object")
EJavaObject = Class(name="EJavaObject")
dsl_Robot = Class(name="dsl_Robot")
dsl_IDevice = Class(name="dsl_IDevice")
dsl_Fonctionnalite = Class(name="dsl_Fonctionnalite")
dsl_Parametre = Class(name="dsl_Parametre")
dsl_Device = Class(name="dsl_Device")
dsl_EJavaObject = Class(name="dsl_EJavaObject")
...
dsl_IDevice.attributes={dsl_IDevice_name, dsl_IDevice_typeof}
...
domain_model = DomainModel(
    name="dsl",
    types={dsl_Capture, Fonctionnalite, dsl_Action, dsl_Object, EJavaObject, dsl_Robot, dsl_IDevice, dsl_Fonctionnalite, dsl_Parametre, dsl_Device, dsl_EJavaObject},
    associations={type4, return_6, instances0, ListeParametres1, refFonction2},
