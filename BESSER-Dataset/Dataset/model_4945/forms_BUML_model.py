...
# Classes
forms_Date = Class(name="forms_Date")
forms_Form = Class(name="forms_Form")
forms_Group = Class(name="forms_Group")
forms_Item = Class(name="forms_Item")
forms_ItemType = Class(name="forms_ItemType", is_abstract=True)
forms_Option = Class(name="forms_Option")
forms_FreeText = Class(name="forms_FreeText")
ItemType = Class(name="ItemType")
forms_Choice = Class(name="forms_Choice")
forms_Number = Class(name="forms_Number")
forms_Decision = Class(name="forms_Decision")
...
domain_model = DomainModel(
    name="forms",
    types={forms_Date, forms_Form, forms_Group, forms_Item, forms_ItemType, forms_Option, forms_FreeText, ItemType, forms_Choice, forms_Number, forms_Decision},
    associations={options4, groups0, itemType1, dependentOf2, items6, form8, options9},
    generalizations={gen_forms_Date_ItemType, gen_forms_FreeText_ItemType, gen_forms_Choice_ItemType, gen_forms_Number_ItemType, gen_forms_Decision_ItemType},
    metadata=None
)
