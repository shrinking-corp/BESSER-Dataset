...
# Classes
TestPackage_AbstractTestClass = Class(name="TestPackage_AbstractTestClass", is_abstract=True)
TestPackage_TestClass1 = Class(name="TestPackage_TestClass1")
AbstractTestClass = Class(name="AbstractTestClass")
TestPackage_TestClass2 = Class(name="TestPackage_TestClass2")
TestPackage_TestIndex = Class(name="TestPackage_TestIndex")
TestPackage_TestIndexEntry = Class(name="TestPackage_TestIndexEntry")
...
TestPackage_TestClass1_m_testOperation: Method = Method(name="testOperation", parameters={Parameter(name='TestPackage_testParameter', type=StringType)}, type=StringType)
