...
class mvc_UILayout(UIComponent):
    ...
    def __init__(self, orientation: str, columns: int, mvc_UILayout: "mvc_View" = None, mvc_UILayout57: set["mvc_UIComponent"] = None, mvc_UILayout59: set["mvc_View"] = None):
...
class mvc_MVCModel(Annotable):
    ...
    def __init__(self, version: str, name: str, mvc_MVCModel: set["mvc_Model"] = None, mvc_MVCModel18: set["mvc_View"] = None, mvc_MVCModel21: set["mvc_Event"] = None, mvc_MVCModel23: set["mvc_Controller"] = None, mvc_MVCModel25: set["mvc_Component"] = None):
...
class mvc_Action(Annotable):
    ...
    def __init__(self, name: str, mvc_Action: "mvc_Controller" = None, mvc_Action33: "mvc_Event" = None, mvc_Action52: "mvc_EventAction" = None, mvc_Action36: "mvc_Event" = None, mvc_Action39: set["mvc_Event"] = None):
        self.name = name
...
class mvc_Controller(Annotable):
    ...
    def __init__(self, name: str, mvc_Controller49: "mvc_Component" = None, mvc_Controller: "mvc_MVCModel" = None, mvc_Controller27: set["mvc_Action"] = None, mvc_Controller29: set["mvc_ControllerView"] = None, mvc_Controller31: set["mvc_EventAction"] = None):
        self.name = name
...
class mvc_Entity(Annotable):
    ...
    def __init__(self, name: str, mvc_Entity4: set["mvc_Attribute"] = None, mvc_Entity7: "mvc_Entity" = None, mvc_Entity5: set["mvc_Entity"] = None, mvc_Entity10: "mvc_Association" = None, mvc_Entity13: "mvc_Association" = None, mvc_Entity: "mvc_Model" = None):
        self.name = name
...
class mvc_Component(Annotable):
    ...
    def __init__(self, name: str, mvc_Component48: set["mvc_Controller"] = None, mvc_Component: "mvc_MVCModel" = None):
        self.name = name
...
class mvc_Event(Annotable):
    ...
    def __init__(self, name: str, mvc_Event: "mvc_MVCModel" = None, mvc_Event34: "mvc_Action" = None, mvc_Event55: "mvc_EventAction" = None, mvc_Event64: "mvc_UIActions" = None, mvc_Event37: "mvc_Action" = None, mvc_Event40: "mvc_Action" = None):
        self.name = name
...
class mvc_View(Annotable):
    ...
    def __init__(self, name: str, mvc_View: "mvc_UILayout" = None, mvc_View19: "mvc_MVCModel" = None, mvc_View43: "mvc_ControllerView" = None, mvc_View60: "mvc_UILayout" = None):
        self.name = name
...
class mvc_Model(Annotable):
    ...
    def __init__(self, name: str, mvc_Model2: set["mvc_Association"] = None, mvc_Model: "mvc_Entity" = None, mvc_Model16: "mvc_MVCModel" = None, mvc_Model46: "mvc_ControllerView" = None):
        self.name = name
