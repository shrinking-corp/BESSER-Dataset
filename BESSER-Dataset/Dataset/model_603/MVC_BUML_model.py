...
# Classes
mvc_Model = Class(name="mvc_Model")
Annotable = Class(name="Annotable")
mvc_Association = Class(name="mvc_Association")
mvc_Attribute = Class(name="mvc_Attribute")
mvc_View = Class(name="mvc_View")
mvc_UILayout = Class(name="mvc_UILayout")
mvc_UIComponent = Class(name="mvc_UIComponent", is_abstract=True)
mvc_Entity = Class(name="mvc_Entity")
mvc_Event = Class(name="mvc_Event")
mvc_Controller = Class(name="mvc_Controller")
mvc_Component = Class(name="mvc_Component")
mvc_Action = Class(name="mvc_Action")
mvc_ControllerView = Class(name="mvc_ControllerView")
mvc_EventAction = Class(name="mvc_EventAction")
mvc_MVCModel = Class(name="mvc_MVCModel")
UIComponent = Class(name="UIComponent")
mvc_UIInput = Class(name="mvc_UIInput")
mvc_UIActions = Class(name="mvc_UIActions")
...
mvc_Association.attributes={mvc_Association_containment, mvc_Association_upperBound, mvc_Association_lowerBound, mvc_Association_name, mvc_Association_type}
...
mvc_UILayout.attributes={mvc_UILayout_columns, mvc_UILayout_orientation}
...
domain_model = DomainModel(
    name="mvc",
    types={mvc_Model, Annotable, mvc_Association, mvc_Attribute, mvc_View, mvc_UILayout, mvc_UIComponent, mvc_Entity, mvc_Event, mvc_Controller, mvc_Component, mvc_Action, mvc_ControllerView, mvc_EventAction, mvc_MVCModel, UIComponent, mvc_UIInput, mvc_UIActions, AssociationType},
    associations={associations1, attributes3, extends6, source8, target11, rootComponent14, rootEntity0, models15, views17, events20, controllers22, components24, actions26, views28, eventActions30, preExecutionEvent32, view41, models44, controllers47, action50, events53, components56, importView58, value61, triggerEvent63, postExecutionEvent35, triggerEvents38},
    generalizations={gen_mvc_Model_Annotable, gen_mvc_Entity_Annotable, gen_mvc_Attribute_Annotable, gen_mvc_Association_Annotable, gen_mvc_View_Annotable, gen_mvc_UIComponent_Annotable, gen_mvc_Controller_Annotable, gen_mvc_Event_Annotable, gen_mvc_Action_Annotable, gen_mvc_MVCModel_Annotable, gen_mvc_Component_Annotable, gen_mvc_EventAction_Annotable, gen_mvc_UILayout_UIComponent, gen_mvc_UIInput_UIComponent, gen_mvc_UIActions_UIComponent, gen_mvc_ControllerView_Annotable},
    metadata=None
)
