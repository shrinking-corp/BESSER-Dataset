...
public class wikidb119_logging  {
    ...
    public wikidb119_logging(
        String log_page,        String log_type,        String log_title,        String log_user,        String log_user_text,        String log_id,        String log_timestamp,        int log_deleted,        String log_params,        String log_namespace,        String log_comment,        String log_action    ) {
