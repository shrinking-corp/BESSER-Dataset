...
public class wikidb119_revision  {
    ...
    public wikidb119_revision(
        String rev_page,        int rev_minor_edit,        String rev_user,        String rev_len,        String rev_sha1,        String rev_id,        String rev_user_text,        String rev_parent_id,        int rev_deleted,        String rev_timestamp,        String rev_text_id,        String rev_comment    ) {
