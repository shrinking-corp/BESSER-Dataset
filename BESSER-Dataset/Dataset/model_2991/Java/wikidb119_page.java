...
public class wikidb119_page  {
    ...
    public wikidb119_page(
        int page_is_new,        String page_latest,        String page_title,        String page_namespace,        float page_random,        String page_id,        String page_len,        int page_is_redirect,        String page_counter,        String page_touched,        String page_restrictions    ) {
