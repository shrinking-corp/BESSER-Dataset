...
class wikidb119_archive:
    ...
    def __init__(self, ar_parent_id: str, ar_user_text: str, ar_len: str, ar_comment: str, ar_minor_edit: int, ar_flags: str, ar_page_id: str, ar_text_id: str, ar_timestamp: str, ar_rev_id: str, ar_sha1: str, ar_user: str, ar_deleted: int, ar_namespace: str, ar_title: str, ar_text: str):
...
class wikidb119_ipblocks:
    ...
    def __init__(self, ipb_deleted: int, ipb_user: str, ipb_by: str, ipb_address: str, ipb_auto: int, ipb_create_account: int, ipb_anon_only: int, ipb_block_email: int, ipb_by_text: str, ipb_enable_autoblock: int, ipb_id: str, ipb_reason: str, ipb_timestamp: str, ipb_range_end: str, ipb_allow_usertalk: int, ipb_range_start: str, ipb_expiry: str):
...
class wikidb119_filearchive:
    ...
    def __init__(self, fa_storage_key: str, fa_bits: str, fa_id: str, fa_size: str, fa_user_text: str, fa_major_mime: str, fa_deleted_timestamp: str, fa_width: str, fa_height: str, fa_deleted: int, fa_metadata: str, fa_description: str, fa_deleted_reason: str, fa_archive_name: str, fa_name: str, fa_user: str, fa_timestamp: str, fa_deleted_user: str, fa_minor_mime: str, fa_storage_group: str, fa_media_type: str):
...
class wikidb119_objectcache:
    ...
    def __init__(self, value: str, keyname: str, exptime: date):
        self.value = value
...
class wikidb119_iwlinks:
    ...
    def __init__(self, iwl_title: str, iwl_prefix: str, iwl_from: str):
...
class wikidb119_uploadstash:
    ...
    def __init__(self, us_chunk_inx: str, us_orig_path: str, us_key: str, us_media_type: str, us_id: str, us_image_width: str, us_image_bits: int, us_image_height: str, us_path: str, us_sha1: str, us_timestamp: str, us_size: str, us_source_type: str, us_mime: str, us_user: str, us_status: str):
...
class wikidb119_querycachetwo:
    ...
    def __init__(self, qcc_title: str, qcc_type: str, qcc_namespacetwo: str, qcc_value: str, qcc_titletwo: str, qcc_namespace: str):
...
class wikidb119_user:
    ...
    def __init__(self, user_password: str, user_id: str, user_registration: str, user_editcount: str, user_email: str, user_newpassword: str, user_email_token: str, user_email_token_expires: str, user_name: str, user_token: str, user_real_name: str, user_touched: str, user_email_authenticated: str, user_newpass_time: str):
