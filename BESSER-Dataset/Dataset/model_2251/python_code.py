...
class e2_Course:
    ...
    def __init__(self, ID: str, Name: str, Credit: float, e2_Course5: set["e2_Person"] = None, e2_Course8: set["e2_Assingnment"] = None, e2_Course10: set["e2_Lecture"] = None, e2_Course13: set["e2_Group"] = None, e2_Course15: set["e2_Person"] = None, e2_Course: set["e2_Person"] = None, e2_Course33: "e2_University" = None):
        self.ID = ID
        self.Name = Name
        self.Credit = Credit
...
class e2_Assingnment:
    ...
    def __init__(self, Type: str, isMandatory: bool, Deadline: date, StartDate: date, Title: str, Content: str, e2_Assingnment: "e2_Course" = None, e2_Assingnment25: "e2_AssignmentSubmission" = None, e2_Assingnment36: "e2_LectureContent" = None):
        self.Type = Type
...
class e2_Person:
    ...
    def __init__(self, Name: str, e2_Person: set["e2_AssignmentSubmission"] = None, e2_Person6: "e2_Course" = None, e2_Person16: "e2_Course" = None, e2_Person19: "e2_Group" = None, e2_Person28: "e2_AssignmentSubmission" = None, e2_Person3: "e2_Course" = None, e2_Person30: "e2_University" = None):
        self.Name = Name
