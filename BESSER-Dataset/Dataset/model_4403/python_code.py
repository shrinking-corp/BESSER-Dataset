...
class featureModel_TypedValue:
    ...
    def __init__(self, integerValue: str, stringValue: str, floatValue: str, featureModel_TypedValue: "featureModel_Feature" = None, featureModel_TypedValue10: "featureModel_Feature" = None):
...
class featureModel_Feature(Node):
    ...
    def __init__(self, name: str, valueType: str, featureModel_Feature17: "featureModel_FeatureGroup" = None, featureModel_Feature: "featureModel_TypedValue" = None, featureModel_Feature2: set["featureModel_Node"] = None, featureModel_Feature5: "featureModel_Feature" = None, featureModel_Feature3: "featureModel_Feature" = None, featureModel_Feature8: "featureModel_Feature" = None, featureModel_Feature6: set["featureModel_Feature"] = None, featureModel_Feature11: "featureModel_TypedValue" = None, featureModel_Feature27: "featureModel_RelationFeature" = None, featureModel_Feature30: "featureModel_RelationFeature" = None):
        self.name = name
