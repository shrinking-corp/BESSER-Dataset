...
featureModel_TypedValue = Class(name="featureModel_TypedValue")
featureModel_Node = Class(name="featureModel_Node")
featureModel_Project = Class(name="featureModel_Project")
featureModel_Relation = Class(name="featureModel_Relation")
featureModel_FeatureGroup = Class(name="featureModel_FeatureGroup")
featureModel_RelationFG = Class(name="featureModel_RelationFG")
Relation = Class(name="Relation")
featureModel_RelationFeature = Class(name="featureModel_RelationFeature")
...
featureModel_TypedValue.attributes={featureModel_TypedValue_integerValue, featureModel_TypedValue_floatValue, featureModel_TypedValue_stringValue}
...
featureModel_Project.attributes={featureModel_Project_validatedTEF, featureModel_Project_validatedOCL, featureModel_Project_nameConstraintsFile, featureModel_Project_numberOfProducts, featureModel_Project_nameConfigFile}
...
featureModel_RelationFeature.attributes={featureModel_RelationFeature_lowerBound, featureModel_RelationFeature_upperBound, featureModel_RelationFeature_type}
...
domain_model = DomainModel(
    name="featureModel",
    types={featureModel_Feature, Node, featureModel_TypedValue, featureModel_Node, featureModel_Project, featureModel_Relation, featureModel_FeatureGroup, featureModel_RelationFG, Relation, featureModel_RelationFeature, FeatureType, FeatureGroupType, ValueType},
    associations={children16, father19, typedValue0, children1, references4, referenciated7, featureValue9, features12, relations14, source21, target23, source26, target28},
