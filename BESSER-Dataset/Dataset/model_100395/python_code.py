...
class SpecificationElement:
    ...
    pass
class sgraph_State(SpecificationElement, ScopedElement, ReactiveElement, RegularState, CompositeElement):
...
class sgraph_Transition(SpecificationElement, Reaction):

    def __init__(self, priority: int, incomingTransitions: "sgraph_Vertex" = None, Transition3: "sgraph_Vertex" = None, Transition: "sgraph_Vertex" = None, outgoingTransitions: "sgraph_Vertex" = None):
...
class sgraph_Declaration(NamedElement):
    ...
    pass
class sgraph_Statechart(SpecificationElement, ScopedElement, ReactiveElement, CompositeElement, NamedElement):

    pass
class sgraph_Region(NamedElement):

    def __init__(self, priority: int, Region27: "sgraph_CompositeElement" = None, parentRegion: set["sgraph_Vertex"] = None, regions: "sgraph_CompositeElement" = None, Region: "sgraph_Vertex" = None):
        self.priority = priority
