...
# Classes
myDsl_translation_unitR = Class(name="myDsl_translation_unitR")
...
myDsl_direct_declaratorR = Class(name="myDsl_direct_declaratorR")
...
init_declarator = Class(name="init_declarator")
struct_declarator = Class(name="struct_declarator")
...
myDsl_type_qualifier_listR = Class(name="myDsl_type_qualifier_listR")
myDsl_abstract_declarator = Class(name="myDsl_abstract_declarator")
myDsl_declaration = Class(name="myDsl_declaration")
myDsl_declaration_listR = Class(name="myDsl_declaration_listR")
myDsl_identifier_listR = Class(name="myDsl_identifier_listR")
myDsl_parameter_list = Class(name="myDsl_parameter_list")
parameter_type_list = Class(name="parameter_type_list")
myDsl_parameter_declaration = Class(name="myDsl_parameter_declaration")
myDsl_parameter_listR = Class(name="myDsl_parameter_listR")
...
compound_statement = Class(name="compound_statement")
myDsl_block_item = Class(name="myDsl_block_item")
myDsl_block_item_listR = Class(name="myDsl_block_item_listR")
myDsl_statement = Class(name="myDsl_statement")
block_item = Class(name="block_item")
myDsl_jump_statement = Class(name="myDsl_jump_statement")
parameter_declaration = Class(name="parameter_declaration")
...
myDsl_init_declarator_listR = Class(name="myDsl_init_declarator_listR")
myDsl_initializer = Class(name="myDsl_initializer")
conditional_expression = Class(name="conditional_expression")
myDsl_logical_and_expression = Class(name="myDsl_logical_and_expression")
myDsl_logical_or_expressionR = Class(name="myDsl_logical_or_expressionR")
myDsl_inclusive_or_expression = Class(name="myDsl_inclusive_or_expression")
jump_statement = Class(name="jump_statement")
expression_statement = Class(name="expression_statement")
primary_expression = Class(name="primary_expression")
myDsl_expressionR = Class(name="myDsl_expressionR")
myDsl_conditional_expression = Class(name="myDsl_conditional_expression")
assignment_expression = Class(name="assignment_expression")
constant_expression = Class(name="constant_expression")
myDsl_logical_or_expression = Class(name="myDsl_logical_or_expression")
myDsl_and_expression = Class(name="myDsl_and_expression")
myDsl_exclusive_or_expressionR = Class(name="myDsl_exclusive_or_expressionR")
myDsl_and_expressionR = Class(name="myDsl_and_expressionR")
myDsl_equality_expression = Class(name="myDsl_equality_expression")
myDsl_logical_and_expressionR = Class(name="myDsl_logical_and_expressionR")
myDsl_exclusive_or_expression = Class(name="myDsl_exclusive_or_expression")
myDsl_inclusive_or_expressionR = Class(name="myDsl_inclusive_or_expressionR")
myDsl_shift_expressionR = Class(name="myDsl_shift_expressionR")
myDsl_additive_expression = Class(name="myDsl_additive_expression")
shift_expression = Class(name="shift_expression")
myDsl_relational_expression = Class(name="myDsl_relational_expression")
myDsl_equality_expressionR = Class(name="myDsl_equality_expressionR")
myDsl_shift_expression = Class(name="myDsl_shift_expression")
myDsl_relational_expressionR = Class(name="myDsl_relational_expressionR")
...
myDsl_additive_expressionR = Class(name="myDsl_additive_expressionR")
myDsl_multiplicative_expressionR = Class(name="myDsl_multiplicative_expressionR")
myDsl_cast_expression = Class(name="myDsl_cast_expression")
myDsl_initializer_listR = Class(name="myDsl_initializer_listR")
myDsl_designator_list = Class(name="myDsl_designator_list")
cast_expression = Class(name="cast_expression")
...
myDsl_postfix_expressionR = Class(name="myDsl_postfix_expressionR")
...
static_assert_declaration = Class(name="static_assert_declaration")
atomic_type_specifier = Class(name="atomic_type_specifier")
designation = Class(name="designation")
myDsl_designator = Class(name="myDsl_designator")
myDsl_designator_listR = Class(name="myDsl_designator_listR")
myDsl_specifier_qualifier_list = Class(name="myDsl_specifier_qualifier_list")
type_name = Class(name="type_name")
struct_declaration = Class(name="struct_declaration")
myDsl_type_specifier = Class(name="myDsl_type_specifier")
myDsl_struct_declaration_listR = Class(name="myDsl_struct_declaration_listR")
...
myDsl_struct_declarator_listR = Class(name="myDsl_struct_declarator_listR")
...
myDsl_argument_expression_listR = Class(name="myDsl_argument_expression_listR")
abstract_declarator = Class(name="abstract_declarator")
myDsl_IDENTIFIER = Class(name="myDsl_IDENTIFIER")
...
declaration_specifiers = Class(name="declaration_specifiers")
myDsl_StringC = Class(name="myDsl_StringC")
direct_declarator = Class(name="direct_declarator")
identifier_list = Class(name="identifier_list")
identifier_listR = Class(name="identifier_listR")
labeled_statement = Class(name="labeled_statement")
struct_or_union_specifier = Class(name="struct_or_union_specifier")
postfix_expressionR = Class(name="postfix_expressionR")
...
domain_model = DomainModel(
    name="myDsl",
    types={myDsl_translation_unitR, myDsl_declaration_specifiers, myDsl_function_definition, external_declaration, myDsl_declarator, myDsl_declaration_list, myDsl_Model, myDsl_translation_unit, myDsl_external_declaration, declarator, myDsl_direct_declaratorR, myDsl_assignment_expression, myDsl_parameter_type_list, myDsl_identifier_list, myDsl_compound_statement, init_declarator, struct_declarator, myDsl_pointer, myDsl_direct_declarator, myDsl_type_qualifier_list, pointer, myDsl_type_qualifier_listR, myDsl_abstract_declarator, myDsl_declaration, myDsl_declaration_listR, myDsl_identifier_listR, myDsl_parameter_list, parameter_type_list, myDsl_parameter_declaration, myDsl_parameter_listR, myDsl_labeled_statement, myDsl_constant_expression, myDsl_iteration_statement, myDsl_expression, myDsl_expression_statement, statement, myDsl_block_item_list, compound_statement, myDsl_block_item, myDsl_block_item_listR, myDsl_statement, block_item, myDsl_jump_statement, parameter_declaration, myDsl_selection_statement, myDsl_init_declarator_list, myDsl_init_declarator, myDsl_init_declarator_listR, myDsl_initializer, conditional_expression, myDsl_logical_and_expression, myDsl_logical_or_expressionR, myDsl_inclusive_or_expression, jump_statement, expression_statement, primary_expression, myDsl_expressionR, myDsl_conditional_expression, assignment_expression, constant_expression, myDsl_logical_or_expression, myDsl_and_expression, myDsl_exclusive_or_expressionR, myDsl_and_expressionR, myDsl_equality_expression, myDsl_logical_and_expressionR, myDsl_exclusive_or_expression, myDsl_inclusive_or_expressionR, myDsl_shift_expressionR, myDsl_additive_expression, shift_expression, myDsl_relational_expression, myDsl_equality_expressionR, myDsl_shift_expression, myDsl_relational_expressionR, initializer, myDsl_unary_expression, myDsl_type_name, myDsl_multiplicative_expression, myDsl_additive_expressionR, myDsl_multiplicative_expressionR, myDsl_cast_expression, myDsl_initializer_listR, myDsl_designator_list, cast_expression, myDsl_postfix_expression, unary_expression, myDsl_primary_expression, myDsl_postfix_expressionR, myDsl_initializer_list, myDsl_designation, designator, static_assert_declaration, atomic_type_specifier, designation, myDsl_designator, myDsl_designator_listR, myDsl_specifier_qualifier_list, type_name, struct_declaration, myDsl_type_specifier, myDsl_struct_declaration_listR, myDsl_struct_declarator_list, myDsl_struct_declarator, myDsl_struct_declarator_listR, myDsl_struct_declaration_list, myDsl_struct_declaration, myDsl_static_assert_declaration, declaration, myDsl_struct_or_union_specifier, type_specifier, myDsl_argument_expression_listR, abstract_declarator, myDsl_IDENTIFIER, myDsl_atomic_type_specifier, myDsl_EObject, myDsl_argument_expression_list, declaration_specifiers, myDsl_StringC, direct_declarator, identifier_list, identifier_listR, labeled_statement, struct_or_union_specifier, postfix_expressionR},
    associations={Translation_unitR3, External_declaration5, rec9, Declaration_specifiers11, Declarator13, Declaration_list14, greetings0, External_declaration1, Direct_declaratorR26, rec29, Type_qualifier_list31, Assignment_expression34, Parameter_type_list36, Compound_statement16, Pointer18, dd20, Type_qualifier_listR22, rec24, Declarator152, Declaration_specifiers155, Abstract_declarator58, Declaration60, Declaration_listR62, Declaration64, Identifier_list38, Parameter_declaration40, Parameter_listR41, Parameter_declaration43, rec47, Declaration_specifiers249, Constant_expression79, Statement80, b82, Expression85, Statement86, Expression_statement89, rec68, Block_item70, Block_item_listR71, Block_item73, rec77, rec109, r1112, r2115, Expression117, Declaration91, Init_declarator_list94, Init_declarator96, Init_declarator_listR98, Declarator100, Initializer103, Init_declarator105, Expression134, Logical_and_expression137, Logical_or_expressionR139, Logical_and_expression141, rec145, Statement119, Assignment_expression122, ExpressionR125, Assignment_expression127, rec131, Logical_or_expression133, And_expression167, Exclusive_or_expressionR169, And_expression171, rec175, Equality_expression177, rec179, Inclusive_or_expression147, Logical_and_expressionR149, Inclusive_or_expression151, rec155, Exclusive_or_expression157, Inclusive_or_expressionR159, Exclusive_or_expression161, rec165, re199, Shift_expression201, rec205, Additive_expression207, rec209, Shift_expressionR211, Equality_expression181, And_expressionR184, Relational_expression187, Equality_expressionR189, Relational_expression191, rec195, Shift_expression197, Cast_expression228, Multiplicative_expressionR231, Unary_expression234, rec237, Type_name239, Multiplicative_expression214, Additive_expressionR216, Multiplicative_expression218, rec222, Cast_expression224, rec226, Initializer254, il257, ilr259, Designation262, Initializer265, rec269, rec242, ce244, Primary_expression247, Postfix_expressionR248, Initializer_list250, Designation252, rec278, Designator271, DesignatorR272, Designator274, rec288, Specifier_qualifier_list280, ad282, Type_specifier285, Struct_declaration293, Struct_declaration_listR294, Struct_declaration296, Struct_declarator290, Struct_declarator_listR291, Struct_declarator308, rec312, Declaratorx314, Constant_expression1317, rec300, Specifier_qualifier_listx302, Struct_declarator_list305, Argument_expression_listR334, Assignment_expression336, rec340, Type_qualifier_list342, Struct_declaration_list320, id322, Expression324, rec327, Argument_expression_list329, Assignment_expression331, ds356, rec346, dr348, il351, a353},
    generalizations={gen_myDsl_function_definition_external_declaration, gen_myDsl_direct_declarator_declarator, gen_myDsl_declarator_init_declarator, gen_myDsl_declarator_struct_declarator, gen_myDsl_type_qualifier_list_pointer, gen_myDsl_parameter_list_parameter_type_list, gen_myDsl_labeled_statement_statement, gen_myDsl_iteration_statement_statement, gen_myDsl_compound_statement_statement, gen_myDsl_block_item_list_compound_statement, gen_myDsl_statement_block_item, gen_myDsl_jump_statement_statement, gen_myDsl_declaration_specifiers_parameter_declaration, gen_myDsl_selection_statement_statement, gen_myDsl_declaration_external_declaration, gen_myDsl_declaration_block_item, gen_myDsl_logical_or_expression_conditional_expression, gen_myDsl_expression_statement_statement, gen_myDsl_expression_jump_statement, gen_myDsl_expression_expression_statement, gen_myDsl_expression_primary_expression, gen_myDsl_conditional_expression_assignment_expression, gen_myDsl_conditional_expression_constant_expression, gen_myDsl_additive_expression_shift_expression, gen_myDsl_assignment_expression_initializer, gen_myDsl_unary_expression_cast_expression, gen_myDsl_postfix_expression_unary_expression, gen_myDsl_initializer_list_initializer, gen_myDsl_constant_expression_designator, gen_myDsl_constant_expression_struct_declarator, gen_myDsl_constant_expression_static_assert_declaration, gen_myDsl_type_name_atomic_type_specifier, gen_myDsl_designator_list_designation, gen_myDsl_specifier_qualifier_list_type_name, gen_myDsl_specifier_qualifier_list_struct_declaration, gen_myDsl_static_assert_declaration_declaration, gen_myDsl_static_assert_declaration_struct_declaration, gen_myDsl_struct_or_union_specifier_type_specifier, gen_myDsl_pointer_abstract_declarator, gen_myDsl_atomic_type_specifier_type_specifier, gen_myDsl_type_specifier_declaration_specifiers, gen_myDsl_StringC_primary_expression, gen_myDsl_IDENTIFIER_direct_declarator, gen_myDsl_IDENTIFIER_identifier_list, gen_myDsl_IDENTIFIER_identifier_listR, gen_myDsl_IDENTIFIER_jump_statement, gen_myDsl_IDENTIFIER_labeled_statement, gen_myDsl_IDENTIFIER_designator, gen_myDsl_IDENTIFIER_struct_or_union_specifier, gen_myDsl_IDENTIFIER_postfix_expressionR, gen_myDsl_IDENTIFIER_primary_expression},
    metadata=None
)
