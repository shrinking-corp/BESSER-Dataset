...
class myDsl_expression_statement(statement):
    ...
    pass
class myDsl_expression(jump_statement, expression_statement, primary_expression):
...
class myDsl_type_qualifier_list(pointer):
    ...
    def __init__(self, Type_qualifier: str, myDsl_type_qualifier_list33: "myDsl_direct_declaratorR" = None, myDsl_type_qualifier_list: "myDsl_type_qualifier_listR" = None, myDsl_type_qualifier_list344: "myDsl_pointer" = None):
        self.Type_qualifier = Type_qualifier
...
class myDsl_declaration_list:
    ...
    pass
class myDsl_declarator(init_declarator, struct_declarator):

    pass
class external_declaration:

    pass
class myDsl_declaration(block_item, external_declaration):
...
class designator:
    ...
    pass
class myDsl_IDENTIFIER(direct_declarator, identifier_list, struct_or_union_specifier, postfix_expressionR, designator, labeled_statement, identifier_listR, jump_statement, primary_expression):

    def __init__(self, name: str, myDsl_IDENTIFIER: "myDsl_struct_or_union_specifier" = None, myDsl_IDENTIFIER349: "myDsl_direct_declaratorR" = None, myDsl_IDENTIFIER352: "myDsl_identifier_listR" = None, myDsl_IDENTIFIER354: "myDsl_statement" = None):
        self.name = name
...
class myDsl_constant_expression(struct_declarator, designator, static_assert_declaration):
