...
ATM__Transactions.attributes={ATM__Transactions_Transaction_id, ATM__Transactions_Amount, ATM__Transactions_Date, ATM__Transactions_Type, ATM__Transactions_Post_balance}
...
Customer.attributes={Customer_DOB, Customer_Pin, Customer_Card_num, Customer_Name}
...
domain_model = DomainModel(
    name="_GhlPkP8lEemrrdzmwAEMcA",
    types={ATM__Transactions, Current_Account, Savings_Account, BANK, Customer, Account, ATM},
