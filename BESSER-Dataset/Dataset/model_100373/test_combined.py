...
def test_hyp_mdaintermediatestatemachine_value_is_not_abstract():
    assert not inspect.isabstract(MDAIntermediateStateMachine_Value)


def test_hyp_mdaintermediatestatemachine_value_constructor_exists():
    assert callable(MDAIntermediateStateMachine_Value.__init__)


def test_hyp_mdaintermediatestatemachine_value_constructor_args():
...
def test_hyp_mdaintermediatestatemachine_transition_is_not_abstract():
    assert not inspect.isabstract(MDAIntermediateStateMachine_Transition)


def test_hyp_mdaintermediatestatemachine_transition_constructor_exists():
    assert callable(MDAIntermediateStateMachine_Transition.__init__)


def test_hyp_mdaintermediatestatemachine_transition_constructor_args():
    sig = inspect.signature(MDAIntermediateStateMachine_Transition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mdaintermediatestatemachine_messagesequence_is_not_abstract():
    assert not inspect.isabstract(MDAIntermediateStateMachine_MessageSequence)


def test_hyp_mdaintermediatestatemachine_messagesequence_constructor_exists():
    assert callable(MDAIntermediateStateMachine_MessageSequence.__init__)


def test_hyp_mdaintermediatestatemachine_messagesequence_constructor_args():
    sig = inspect.signature(MDAIntermediateStateMachine_MessageSequence.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mdaintermediatestatemachine_message_is_not_abstract():
    assert not inspect.isabstract(MDAIntermediateStateMachine_Message)


def test_hyp_mdaintermediatestatemachine_message_constructor_exists():
    assert callable(MDAIntermediateStateMachine_Message.__init__)


def test_hyp_mdaintermediatestatemachine_message_constructor_args():
    sig = inspect.signature(MDAIntermediateStateMachine_Message.__init__)
    params = list(sig.parameters.keys())



def test_hyp_mdaintermediatestatemachine_participant_is_not_abstract():
    assert not inspect.isabstract(MDAIntermediateStateMachine_Participant)


def test_hyp_mdaintermediatestatemachine_participant_constructor_exists():
    assert callable(MDAIntermediateStateMachine_Participant.__init__)


def test_hyp_mdaintermediatestatemachine_participant_constructor_args():
...
def test_hyp_mdaintermediatestatemachine_automaton_is_not_abstract():
    assert not inspect.isabstract(MDAIntermediateStateMachine_Automaton)


def test_hyp_mdaintermediatestatemachine_automaton_constructor_exists():
    assert callable(MDAIntermediateStateMachine_Automaton.__init__)


def test_hyp_mdaintermediatestatemachine_automaton_constructor_args():
...
def test_hyp_mdaintermediatestatemachine_state_is_not_abstract():
    assert not inspect.isabstract(MDAIntermediateStateMachine_State)


def test_hyp_mdaintermediatestatemachine_state_constructor_exists():
    assert callable(MDAIntermediateStateMachine_State.__init__)


def test_hyp_mdaintermediatestatemachine_state_constructor_args():
...
def test_hyp_mdaintermediatestatemachine_content_is_not_abstract():
    assert not inspect.isabstract(MDAIntermediateStateMachine_Content)


def test_hyp_mdaintermediatestatemachine_content_constructor_exists():
    assert callable(MDAIntermediateStateMachine_Content.__init__)


def test_hyp_mdaintermediatestatemachine_content_constructor_args():
...
def test_hyp_mdaintermediatestatemachine_operation_is_not_abstract():
    assert not inspect.isabstract(MDAIntermediateStateMachine_Operation)


def test_hyp_mdaintermediatestatemachine_operation_constructor_exists():
    assert callable(MDAIntermediateStateMachine_Operation.__init__)


def test_hyp_mdaintermediatestatemachine_operation_constructor_args():
...
def test_hyp_mdaintermediatestatemachine_value_value_setter(instance):
...
def test_hyp_mdaintermediatestatemachine_participant_name_setter(instance):
...
def test_hyp_mdaintermediatestatemachine_automaton_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_mdaintermediatestatemachine_state_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_mdaintermediatestatemachine_content_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_mdaintermediatestatemachine_operation_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
