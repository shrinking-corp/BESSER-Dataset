...
# Classes
stateMachine_StateTransition = Class(name="stateMachine_StateTransition")
AbstractMachineElement = Class(name="AbstractMachineElement")
stateMachine_AbstractStateElement = Class(name="stateMachine_AbstractStateElement", is_abstract=True)
stateMachine_StateMachine = Class(name="stateMachine_StateMachine")
stateMachine_AbstractMachineElement = Class(name="stateMachine_AbstractMachineElement", is_abstract=True)
...
domain_model = DomainModel(
    ...
    associations={from_0, to1, elements4},
