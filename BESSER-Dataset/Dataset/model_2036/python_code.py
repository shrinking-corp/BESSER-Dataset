...
class eMFProject_State:
    ...
    def __init__(self, name: str, eMFProject_State9: set["eMFProject_Command"] = None, eMFProject_State12: set["eMFProject_Transition"] = None, eMFProject_State18: "eMFProject_Transition" = None, eMFProject_State: "eMFProject_Statemachine" = None):
        self.name = name
...
class eMFProject_Command:
    ...
    def __init__(self, name: str, code: str, eMFProject_Command10: "eMFProject_State" = None, eMFProject_Command: "eMFProject_Statemachine" = None):
        self.name = name
        self.code = code
...
class eMFProject_Event:
    ...
    def __init__(self, name: str, code: str, eMFProject_Event15: "eMFProject_Transition" = None, eMFProject_Event: "eMFProject_Statemachine" = None, eMFProject_Event3: "eMFProject_Statemachine" = None):
        self.name = name
        self.code = code
