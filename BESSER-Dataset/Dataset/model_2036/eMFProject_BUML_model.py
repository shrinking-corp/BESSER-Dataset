...
# Classes
eMFProject_Statemachine = Class(name="eMFProject_Statemachine")
eMFProject_Transition = Class(name="eMFProject_Transition")
eMFProject_Event = Class(name="eMFProject_Event")
eMFProject_Command = Class(name="eMFProject_Command")
eMFProject_State = Class(name="eMFProject_State")
...
eMFProject_Event.attributes={eMFProject_Event_code, eMFProject_Event_name}
...
domain_model = DomainModel(
    name="eMFProject",
    types={eMFProject_Statemachine, eMFProject_Transition, eMFProject_Event, eMFProject_Command, eMFProject_State},
    associations={actions8, transitions11, event13, state16, events0, resetEvents1, commands4, states6},
    generalizations={},
    metadata=None
)
