...
class wh_Output:
    ...
    def __init__(self, variable: str, wh_Output19: "wh_Output" = None, wh_Output17: "wh_Output" = None, wh_Output: "wh_Definition" = None):
...
class wh_Commands:
    ...
    def __init__(self, command: str, wh_Commands22: "wh_Commands" = None, wh_Commands20: "wh_Commands" = None, wh_Commands: "wh_Definition" = None):
...
class wh_Input:
    ...
    def __init__(self, variable: str, wh_Input16: "wh_Input" = None, wh_Input14: "wh_Input" = None, wh_Input: "wh_Definition" = None):
        self.variable = variable
