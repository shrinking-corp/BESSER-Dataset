...
def test_hyp_typeb_nonreferencedclass2_is_not_abstract():
    assert not inspect.isabstract(typeB_NonReferencedClass2)


def test_hyp_typeb_nonreferencedclass2_constructor_exists():
    assert callable(typeB_NonReferencedClass2.__init__)


def test_hyp_typeb_nonreferencedclass2_constructor_args():
    sig = inspect.signature(typeB_NonReferencedClass2.__init__)
    params = list(sig.parameters.keys())



def test_hyp_typeb_nonreferencedclass_is_not_abstract():
    assert not inspect.isabstract(typeB_NonReferencedClass)


def test_hyp_typeb_nonreferencedclass_constructor_exists():
    assert callable(typeB_NonReferencedClass.__init__)


def test_hyp_typeb_nonreferencedclass_constructor_args():
...
def test_hyp_typeb_outportb_name_setter(instance):
...
def test_hyp_typeb_inportb_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
