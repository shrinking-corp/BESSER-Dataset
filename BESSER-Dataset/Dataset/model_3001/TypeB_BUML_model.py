...
# Classes
typeB_NonReferencedClass = Class(name="typeB_NonReferencedClass")
typeB_NonReferencedClass2 = Class(name="typeB_NonReferencedClass2")
typeB_OutType1 = Class(name="typeB_OutType1")
OutPortB = Class(name="OutPortB")
typeB_BlockB = Class(name="typeB_BlockB")
typeB_InPortB = Class(name="typeB_InPortB")
typeB_OutPortB = Class(name="typeB_OutPortB")
typeB_PortB = Class(name="typeB_PortB", is_abstract=True)
...
domain_model = DomainModel(
    name="typeB",
    types={typeB_NonReferencedClass, typeB_NonReferencedClass2, typeB_OutType1, OutPortB, typeB_BlockB, typeB_InPortB, typeB_OutPortB, typeB_PortB, PortB},
    associations={block3, inputPorts0, outputPorts1},
    generalizations={gen_typeB_OutType1_OutPortB, gen_typeB_InPortB_PortB, gen_typeB_OutPortB_PortB},
    metadata=None
)
