...
# Classes
fds_Column = Class(name="fds_Column")
fds_FunctionalDependency = Class(name="fds_FunctionalDependency")
fds_Restriction = Class(name="fds_Restriction", is_abstract=True)
fds_RestrictionColumn = Class(name="fds_RestrictionColumn")
fds_ForeignKey = Class(name="fds_ForeignKey")
Restriction = Class(name="Restriction")
fds_PrimaryKey = Class(name="fds_PrimaryKey")
fds_CandidateKey = Class(name="fds_CandidateKey")
CandidateKey = Class(name="CandidateKey")
fds_NamedElement = Class(name="fds_NamedElement", is_abstract=True)
fds_Database = Class(name="fds_Database")
NamedElement = Class(name="NamedElement")
fds_Table = Class(name="fds_Table")
...
domain_model = DomainModel(
    name="fds",
    types={fds_Column, fds_FunctionalDependency, fds_Restriction, fds_RestrictionColumn, fds_ForeignKey, Restriction, fds_PrimaryKey, fds_CandidateKey, CandidateKey, fds_NamedElement, fds_Database, NamedElement, fds_Table},
    ...
    generalizations={gen_fds_Table_NamedElement, gen_fds_Column_NamedElement, gen_fds_Restriction_NamedElement, gen_fds_ForeignKey_Restriction, gen_fds_CandidateKey_Restriction, gen_fds_PrimaryKey_CandidateKey, gen_fds_Database_NamedElement, gen_fds_RestrictionColumn_NamedElement},
    metadata=None
)
