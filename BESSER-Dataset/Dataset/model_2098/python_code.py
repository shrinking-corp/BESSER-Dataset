...
class tool_AbstractVariable:
    ...
    pass
class tree_description_TreeVariable(tool_AbstractVariable, tool_VariableContainer):
...
class tree_description_TreeItemContainerDropTool(tool_MappingBasedToolDescription, description_TreeItemTool):
    ...
    def __init__(self, dragSource: str, tree_description_TreeItemContainerDropTool: "tool_DropContainerVariable" = None, tree_description_TreeItemContainerDropTool56: "tool_DropContainerVariable" = None, tree_description_TreeItemContainerDropTool59: "tool_ElementDropVariable" = None, tree_description_TreeItemContainerDropTool62: "tool_ContainerViewVariable" = None, tree_description_TreeItemContainerDropTool65: "PrecedingSiblingsVariables" = None):
...
class tree_description_TreeItemDragTool(tool_MappingBasedToolDescription, description_TreeItemTool):
    ...
    def __init__(self, dragSourceType: str, tree_description_TreeItemDragTool: "tool_DropContainerVariable" = None, tree_description_TreeItemDragTool43: "tool_DropContainerVariable" = None, tree_description_TreeItemDragTool46: "tool_ElementDropVariable" = None, tree_description_TreeItemDragTool48: "tool_ContainerViewVariable" = None, tree_description_TreeItemDragTool50: set["TreeItemMappingContainer"] = None, tree_description_TreeItemDragTool52: "PrecedingSiblingsVariables" = None):
    ...
    def getBestTreeItemMapping(self) :
...
class DRepresentation:
    ...
    pass
class tree_DTree(DRepresentation, DTreeItemContainer, DTreeElementUpdater):
...
class tree_description_TreeDescription(description_RepresentationDescription, description_TreeItemMappingContainer):
    ...
    def __init__(self, preconditionExpression: str, domainClass: str, tree_description_TreeDescription: set["TreeItemCreationTool"] = None, tree_description_TreeDescription17: set["tool_RepresentationCreationDescription"] = None, tree_description_TreeDescription19: set["tool_RepresentationNavigationDescription"] = None):
...
class tree_DTreeElementSynchronizer:
    ...
    def __init__(self):
        ...
        pass
    def refresh(self, tree_DTreeItem):
...
class DTreeElement:
    ...
    pass
class tree_DTreeItem(DTreeItemContainer, DTreeElementUpdater, DTreeElement):
...
class tree_description_TreeItemMapping(description_TreeMapping, description_StyleUpdater, description_TreeItemUpdater, description_TreeItemMappingContainer):
    ...
    def mapping(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_tree_description_TreeItemMapping__mapping", None)
        self.__mapping = value
        
        # Remove self from old opposite end
        if old_value is not None:
            if hasattr(old_value, "TreeItemDeletionTool"):
                opp_val = getattr(old_value, "TreeItemDeletionTool", None)
                if opp_val == self:
                    setattr(old_value, "TreeItemDeletionTool", None)
                
        # Add self to new opposite end
        if value is not None:
            if hasattr(value, "TreeItemDeletionTool"):
                opp_val = getattr(value, "TreeItemDeletionTool", None)
                setattr(value, "TreeItemDeletionTool", self)
