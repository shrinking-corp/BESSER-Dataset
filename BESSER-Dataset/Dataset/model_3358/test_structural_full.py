...
def test_db2EntityDsl_EntityColumnMapper_isa_AbstractColumnMapper():
    instance = db2EntityDsl_EntityColumnMapper()
...
AbstractColumnMapper_strategy = st.builds(AbstractColumnMapper)
...
db2EntityDsl_Attribute_strategy = st.builds(db2EntityDsl_Attribute)
...
db2EntityDsl_EntityColumnMapper_strategy = st.builds(db2EntityDsl_EntityColumnMapper)
