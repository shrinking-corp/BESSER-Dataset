...
class sm_State:
    ...
    def __init__(self, name: str, sm_State10: set["sm_StateMachine"] = None, sm_State16: "sm_Transition" = None, sm_State19: "sm_Transition" = None, sm_State: "sm_StateMachine" = None, sm_State3: "sm_StateMachine" = None, sm_State6: "sm_StateMachine" = None):
        self.name = name
...
class sm_StateMachine:
    ...
    def __init__(self, name: str, sm_StateMachine5: set["sm_State"] = None, sm_StateMachine8: set["sm_Transition"] = None, sm_StateMachine11: "sm_State" = None, sm_StateMachine: "sm_State" = None, sm_StateMachine2: set["sm_State"] = None):
        self.name = name
