...
class customerDsl_Order:
    ...
    def __init__(self, name: str, channel: str, customerDsl_Order: "customerDsl_CustomerDb" = None, customerDsl_Order8: "customerDsl_Customer" = None, customerDsl_Order11: "customerDsl_Address" = None):
        self.name = name
...
class customerDsl_Customer:
    ...
    def __init__(self, name: str, fullName: str, customerDsl_Customer: "customerDsl_CustomerDb" = None, customerDsl_Customer6: set["customerDsl_Address"] = None, customerDsl_Customer9: "customerDsl_Order" = None):
        self.name = name
