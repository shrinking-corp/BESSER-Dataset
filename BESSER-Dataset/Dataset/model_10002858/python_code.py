...
class WebUser:
    ...
    def __init__(self, login: str, password: str, shoppingCart2: "ShoppingCart" = None, customer4: "Customer" = None):
        self.login = login
...
class Customer:
    ...
    def __init__(self, phone: str, email: str, webUser5: "WebUser" = None, account6: "Account" = None):
        self.phone = phone
        self.email = email
