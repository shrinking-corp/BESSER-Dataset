...
Customer.attributes={Customer_phone, Customer_email}
...
Account.attributes={Account_isClosed, Account_billingAddress, Account_open, Account_closed}
...
WebUser.attributes={WebUser_login, WebUser_password}
...
domain_model = DomainModel(
    name="e362af64_dd1d_4f8d_8b5d_ac9979784ad3",
    types={Customer, Payment, ShoppingCart, Account, WebUser, Order, LineItem, Product, UserState, OrderStatus},
    associations={ShoppingCart_LineItem, Product_LineItem, Order_LineItem, Account_Order, Payment_Order, Account_Payment, WebUser_ShoppingCart, WebUser_Customer, Customer_Account, Account_ShoppingCart},
    generalizations={},
    metadata=None
)
