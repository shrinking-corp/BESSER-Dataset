...
def test_hyp_ffddsff_is_not_abstract():
    assert not inspect.isabstract(ffddsff)


def test_hyp_ffddsff_constructor_exists():
    assert callable(ffddsff.__init__)


def test_hyp_ffddsff_constructor_args():
    sig = inspect.signature(ffddsff.__init__)
    params = list(sig.parameters.keys())
    assert "packageAttribute" in params, "Missing parameter 'packageAttribute'"
    assert "publicAttribute" in params, "Missing parameter 'publicAttribute'"
    assert "privateAttribute" in params, "Missing parameter 'privateAttribute'"
...
@given(instance=ffddsff_strategy)
def test_hyp_ffddsff_packageAttribute_setter(instance):
    original = instance.packageAttribute
    instance.packageAttribute = original
    assert instance.packageAttribute == original
...
@given(instance=ffddsff_strategy)
def test_hyp_ffddsff_publicAttribute_setter(instance):
    original = instance.publicAttribute
    instance.publicAttribute = original
    assert instance.publicAttribute == original
...
@given(instance=ffddsff_strategy)
def test_hyp_ffddsff_privateAttribute_setter(instance):
    original = instance.privateAttribute
    instance.privateAttribute = original
    assert instance.privateAttribute == original
...
@given(instance=ffddsff_strategy)
def test_hyp_ffddsff_attribute_setter(instance):
...
@given(instance=ffddsff_strategy)
def test_hyp_ffddsff_protectedAttribute_setter(instance):
    original = instance.protectedAttribute
    instance.protectedAttribute = original
    assert instance.protectedAttribute == original
...
def test_Login_UserId_value_roundtrip():
    instance = Login(UserId=7, UserName="sample_text")
...
def test_ffddsff_attribute_value_roundtrip():
    instance = ffddsff(attribute="sample_text", packageAttribute="sample_text", privateAttribute=7, protectedAttribute="sample_text", publicAttribute=3.14)
    assert instance.attribute == "sample_text"
    instance.attribute = "sample_text_2"
    assert instance.attribute == "sample_text_2"


def test_ffddsff_packageAttribute_value_roundtrip():
    instance = ffddsff(attribute="sample_text", packageAttribute="sample_text", privateAttribute=7, protectedAttribute="sample_text", publicAttribute=3.14)
    assert instance.packageAttribute == "sample_text"
    instance.packageAttribute = "sample_text_2"
    assert instance.packageAttribute == "sample_text_2"
...
def test_ffddsff_privateAttribute_value_roundtrip():
    instance = ffddsff(attribute="sample_text", packageAttribute="sample_text", privateAttribute=7, protectedAttribute="sample_text", publicAttribute=3.14)
    assert instance.privateAttribute == 7
    instance.privateAttribute = 13
    assert instance.privateAttribute == 13
...
def test_ffddsff_protectedAttribute_value_roundtrip():
    instance = ffddsff(attribute="sample_text", packageAttribute="sample_text", privateAttribute=7, protectedAttribute="sample_text", publicAttribute=3.14)
    assert instance.protectedAttribute == "sample_text"
    instance.protectedAttribute = "sample_text_2"
    assert instance.protectedAttribute == "sample_text_2"
...
def test_ffddsff_publicAttribute_value_roundtrip():
    instance = ffddsff(attribute="sample_text", packageAttribute="sample_text", privateAttribute=7, protectedAttribute="sample_text", publicAttribute=3.14)
    assert instance.publicAttribute == 3.14
    instance.publicAttribute = 9.99
    assert instance.publicAttribute == 9.99
...
Login_strategy = st.builds(Login, UserId=st.integers(), UserName=safe_text)
@given(instance=Login_strategy)
@settings(max_examples=25)
...
ffddsff_strategy = st.builds(ffddsff, attribute=safe_text, packageAttribute=safe_text, privateAttribute=st.integers(), protectedAttribute=safe_text, publicAttribute=st.floats(allow_nan=False, allow_infinity=False))
@given(instance=ffddsff_strategy)
@settings(max_examples=25)
def test_ffddsff_instantiation(instance):
    assert isinstance(instance, ffddsff)
