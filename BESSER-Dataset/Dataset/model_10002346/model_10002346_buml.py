...
Login_UserId: Property = Property(name="UserId", type=IntegerType)
Login_UserName: Property = Property(name="UserName", type=StringType)
Login.attributes={Login_UserName, Login_UserId}

# ffddsff class attributes and methods
ffddsff_publicAttribute: Property = Property(name="publicAttribute", type=FloatType)
ffddsff_privateAttribute: Property = Property(name="privateAttribute", type=IntegerType)
ffddsff_protectedAttribute: Property = Property(name="protectedAttribute", type=StringType)
ffddsff_packageAttribute: Property = Property(name="packageAttribute", type=StringType)
ffddsff_attribute: Property = Property(name="attribute", type=StringType)
ffddsff.attributes={ffddsff_publicAttribute, ffddsff_privateAttribute, ffddsff_protectedAttribute, ffddsff_packageAttribute, ffddsff_attribute}
...
ClassC.attributes={ClassC_publicAttribute, ClassC_packageAttribute, ClassC_protectedAttribute, ClassC_privateAttribute}
...
domain_model = DomainModel(
    name="aafb9283_8e7f_4172_967d_5ed6f80155fc",
    types={Login, ffddsff, ClassB, ClassC, ClassD, ClassE, ClassF, ClassG, ClassJ, ClassH, ClassK, ClassL, ClassM, ClassN, ClassP, InterfaceO_Interface, ClassQ, ClassR, ClassS, ClassT, ClassU, ClassV},
