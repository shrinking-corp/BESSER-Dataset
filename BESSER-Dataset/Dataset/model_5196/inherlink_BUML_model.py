...
# Classes
inherlink_X = Class(name="inherlink_X")
inherlink_N = Class(name="inherlink_N")
inherlink_R = Class(name="inherlink_R", is_abstract=True)
Named = Class(name="Named")
L = Class(name="L")
inherlink_Y = Class(name="inherlink_Y")
R = Class(name="R")
inherlink_P = Class(name="inherlink_P")
inherlink_C = Class(name="inherlink_C")
inherlink_K = Class(name="inherlink_K")
inherlink_M = Class(name="inherlink_M")
inherlink_G = Class(name="inherlink_G")
inherlink_T = Class(name="inherlink_T")
inherlink_W = Class(name="inherlink_W")
inherlink_Named = Class(name="inherlink_Named")
inherlink_L = Class(name="inherlink_L")
inherlink_A = Class(name="inherlink_A")
...
as_17: BinaryAssociation = BinaryAssociation(
    name="as_17",
    ends={
...
domain_model = DomainModel(
    name="inherlink",
    types={inherlink_X, inherlink_N, inherlink_R, Named, L, inherlink_Y, R, inherlink_P, inherlink_C, inherlink_K, inherlink_M, inherlink_G, inherlink_T, inherlink_W, inherlink_Named, inherlink_L, inherlink_A},
    associations={ms1, xs3, ns5, ps7, ks0, gs8, ts10, ws12, y14, as_17, r18, l20, gs23, ts26},
    generalizations={gen_inherlink_R_Named, gen_inherlink_X_L, gen_inherlink_Y_R, gen_inherlink_M_L, gen_inherlink_N_R, gen_inherlink_K_R, gen_inherlink_W_L, gen_inherlink_L_Named},
    metadata=None
)
