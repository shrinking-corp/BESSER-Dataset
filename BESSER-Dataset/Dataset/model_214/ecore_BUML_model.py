...
ecore_EClass.methods={ecore_EClass_m_getEStructuralFeature, ecore_EClass_m_getFeatureID, ecore_EClass_m_getEStructuralFeature, ecore_EClass_m_getFeatureCount, ecore_EClass_m_isSuperTypeOf}
...
ecore_EObject.methods={ecore_EObject_m_eResource, ecore_EObject_m_eSet, ecore_EObject_m_eUnset, ecore_EObject_m_eGet, ecore_EObject_m_eIsProxy, ecore_EObject_m_eIsSet, ecore_EObject_m_eContainmentFeature, ecore_EObject_m_eGet, ecore_EObject_m_eAllContents, ecore_EObject_m_eCrossReferences, ecore_EObject_m_eContainingFeature, ecore_EObject_m_eContainer, ecore_EObject_m_eContents, ecore_EObject_m_eClass}
...
ecore_EStructuralFeature.attributes={ecore_EStructuralFeature_transient, ecore_EStructuralFeature_defaultValue, ecore_EStructuralFeature_changeable, ecore_EStructuralFeature_derived, ecore_EStructuralFeature_volatile, ecore_EStructuralFeature_unsettable, ecore_EStructuralFeature_defaultValueLiteral}
...
ecore_ETypedElement.attributes={ecore_ETypedElement_required, ecore_ETypedElement_many, ecore_ETypedElement_unique, ecore_ETypedElement_lowerBound, ecore_ETypedElement_upperBound, ecore_ETypedElement_ordered}
...
domain_model = DomainModel(
    name="ecore",
    types={ecore_EClass, EClassifier, ecore_EAnnotation, EModelElement, ecore_EStringToStringMapEntry, ecore_EModelElement, ecore_EObject, ecore_EOperation, ecore_EAttribute, ecore_EStructuralFeature, ecore_EReference, ecore_EGenericType, ecore_EClassifier, ENamedElement, ecore_EPackage, ecore_ETypeParameter, ecore_ENamedElement, ecore_EFactory, ecore_EParameter, ecore_EDataType, EObject, ecore_EClassifier_Wildcard, ETypedElement, ecore_ETypedElement, EStructuralFeature, ecore_EStructuralFeature_Wildcard, ecore_EEnum, EDataType, ecore_EEnumLiteral},
    associations={details0, eModelElement1, contents2, references4, eIDAttribute32, eSuperTypes8, eOperations9, eAllAttributes10, eStructuralFeatures12, eAllReferences14, eReferences16, eAttributes19, eAllContainments22, eAllOperations25, eAllStructuralFeatures27, eAllSuperTypes30, eClassifiers49, eGenericSuperTypes35, eAllGenericSuperTypes37, ePackage40, eTypeParameters41, eFactoryInstance42, eSubpackages44, eSuperPackage47, eTypeParameters74, eParameters77, ePackage51, eBounds53, eUpperBound57, eTypeArguments60, eRawType62, eLowerBound66, eTypeParameter68, eClassifier71, eContainingClass94, eExceptions78, eGenericExceptions81, eContainingClass84, eType85, eGenericType87, eOperation90, eAttributeType92, eOpposite97, eReferenceType99, eKeys102, eLiterals105, eEnum106, eAnnotations107},
