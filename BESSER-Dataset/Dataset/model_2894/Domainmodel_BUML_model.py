...
domain_model = DomainModel(
    name="domainmodel",
    types={domainmodel_DomainModel, domainmodel_AbstractElement, domainmodel_Import, domainmodel_Type, domainmodel_DataType, Type, domainmodel_Entity, domainmodel_Feature, domainmodel_TypeRef, domainmodel_StructuralFeature, Feature, domainmodel_Attribute, StructuralFeature, domainmodel_Reference, domainmodel_Operation, domainmodel_Parameter, AbstractElement, domainmodel_PackageDeclaration, Visibility},
    associations={elements0, elements1, superType4, features5, type7, opposite10, params11, type12, referenced15},
    generalizations={gen_domainmodel_Type_AbstractElement, gen_domainmodel_DataType_Type, gen_domainmodel_Entity_Type, gen_domainmodel_StructuralFeature_Feature, gen_domainmodel_Attribute_StructuralFeature, gen_domainmodel_Reference_StructuralFeature, gen_domainmodel_Operation_Feature, gen_domainmodel_Import_AbstractElement, gen_domainmodel_PackageDeclaration_AbstractElement},
    metadata=None
)
