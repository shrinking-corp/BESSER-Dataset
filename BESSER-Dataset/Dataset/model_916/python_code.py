...
class publication2014c_Progress(Labelled):
    ...
    def __init__(self, percent: int, time: int, publication2014c_Progress: "publication2014c_PublicationProcess" = None, progress: "publication2014c_Paper" = None, Progress: "publication2014c_Paper" = None):
...
class publication2014c_Researcher:
    ...
    def __init__(self, name: str, forName: str, position: str, neededPerson: set["publication2014c_PublicationPhase"] = None, publication2014c_Researcher: set["publication2014c_Write"] = None, publication2014c_Researcher18: set["publication2014c_Review"] = None, authors: set["publication2014c_Paper"] = None, Researcher: "publication2014c_PublicationPhase" = None, publication2014c_Researcher37: "publication2014c_PublicationStructure" = None, Researcher23: "publication2014c_Paper" = None):
        self.name = name
...
class publication2014c_Sequence:
    ...
    def __init__(self, sequenceType: str, publication2014c_Sequence10: "publication2014c_PublicationPhase" = None, publication2014c_Sequence13: "publication2014c_PublicationPhase" = None, publication2014c_Sequence: "publication2014c_PublicationPhase" = None):
...
class publication2014c_PublicationPhase:
    ...
    def __init__(self, name: str, minTime: int, maxTime: int, publication2014c_PublicationPhase: "publication2014c_PublicationProcess" = None, publication2014c_PublicationPhase11: "publication2014c_Sequence" = None, publication2014c_PublicationPhase14: "publication2014c_Sequence" = None, PublicationPhase: "publication2014c_Researcher" = None, publication2014c_PublicationPhase4: set["publication2014c_Sequence"] = None, phaseParticipation: set["publication2014c_Researcher"] = None, publication2014c_PublicationPhase7: set["publication2014c_Rule"] = None):
        self.name = name
...
class publication2014c_Paragraph(Named, Counted):
