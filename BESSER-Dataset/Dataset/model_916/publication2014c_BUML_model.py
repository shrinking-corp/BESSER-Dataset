...
# Classes
publication2014c_PublicationProcess = Class(name="publication2014c_PublicationProcess")
Named = Class(name="Named")
publication2014c_PublicationPhase = Class(name="publication2014c_PublicationPhase")
publication2014c_Rule = Class(name="publication2014c_Rule")
publication2014c_Write = Class(name="publication2014c_Write")
publication2014c_Review = Class(name="publication2014c_Review")
publication2014c_Paper = Class(name="publication2014c_Paper")
publication2014c_Paragraph = Class(name="publication2014c_Paragraph")
publication2014c_Sequence = Class(name="publication2014c_Sequence")
publication2014c_Researcher = Class(name="publication2014c_Researcher")
Labelled = Class(name="Labelled")
publication2014c_PublicationStructure = Class(name="publication2014c_PublicationStructure")
publication2014c_Progress = Class(name="publication2014c_Progress")
Counted = Class(name="Counted")
publication2014c_ReviewNote = Class(name="publication2014c_ReviewNote")
publication2014c_PublicationSystem = Class(name="publication2014c_PublicationSystem")
publication2014c_Named = Class(name="publication2014c_Named", is_abstract=True)
publication2014c_Counted = Class(name="publication2014c_Counted", is_abstract=True)
publication2014c_Labelled = Class(name="publication2014c_Labelled", is_abstract=True)
...
publication2014c_PublicationPhase.attributes={publication2014c_PublicationPhase_maxTime, publication2014c_PublicationPhase_name, publication2014c_PublicationPhase_minTime}
...
publication2014c_Researcher.attributes={publication2014c_Researcher_position, publication2014c_Researcher_name, publication2014c_Researcher_forName}
...
publication2014c_Progress.attributes={publication2014c_Progress_percent, publication2014c_Progress_time}
...
domain_model = DomainModel(
    ...
    types={publication2014c_PublicationProcess, Named, publication2014c_PublicationPhase, publication2014c_Rule, publication2014c_Write, publication2014c_Review, publication2014c_Paper, publication2014c_Paragraph, publication2014c_Sequence, publication2014c_Researcher, Labelled, publication2014c_PublicationStructure, publication2014c_Progress, Counted, publication2014c_ReviewNote, publication2014c_PublicationSystem, publication2014c_Named, publication2014c_Counted, publication2014c_Labelled, SequenceType},
    associations={phases0, publicationRules1, successor9, predecessor12, phaseParticipation15, writes16, reviews17, papers19, linksToSuccessors3, neededPerson5, rules6, process26, paper28, paragraph30, reviewNote33, researchers36, papers38, paragraphs20, progress21, authors22, reviews24, processView41, structuralView43},
    generalizations={gen_publication2014c_PublicationProcess_Named, gen_publication2014c_Paper_Named, gen_publication2014c_ReviewNote_Named, gen_publication2014c_Progress_Labelled, gen_publication2014c_Write_Labelled, gen_publication2014c_Review_Labelled, gen_publication2014c_PublicationStructure_Named, gen_publication2014c_Paragraph_Counted, gen_publication2014c_Paragraph_Named},
    metadata=None
)
