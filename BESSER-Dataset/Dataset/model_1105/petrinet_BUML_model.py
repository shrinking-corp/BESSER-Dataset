...
domain_model = DomainModel(
    name="petrinet",
    types={petrinet_Transition, Node, petrinet_Place, petrinet_Petrinet, petrinet_Node, petrinet_Arc, petrinet_Token},
    associations={out4, source6, target7, nodes0, arcs1, in_3, tokens9},
