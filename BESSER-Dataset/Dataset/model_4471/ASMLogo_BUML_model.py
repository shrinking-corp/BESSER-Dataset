...
kmLogo_MethodeCall = Class(name="kmLogo_MethodeCall")
...
kmLogo_For = Class(name="kmLogo_For")
kmLogo_MethodeDeclaration = Class(name="kmLogo_MethodeDeclaration")
...
kmLogo_JavaProgram = Class(name="kmLogo_JavaProgram")
kmLogo_Main = Class(name="kmLogo_Main")
...
domain_model = DomainModel(
    name="kmLogo",
    types={kmLogo_Instruction, kmLogo_MethodeCall, Expression, kmLogo_BinaryExp, kmLogo_Constant, kmLogo_Block, kmLogo_If, ControlStructure, kmLogo_ControlStructure, kmLogo_For, kmLogo_MethodeDeclaration, kmLogo_Expression, Instruction, kmLogo_Plus, BinaryExp, kmLogo_Minus, kmLogo_Mult, kmLogo_Div, kmLogo_Equals, kmLogo_Greater, kmLogo_Lower, kmLogo_JavaProgram, kmLogo_Main, kmLogo_While, kmLogo_Parameter, kmLogo_ParameterCall},
    associations={lhs2, rhs4, instructions7, thenPart8, elsePart10, condition13, block15, methodedeclaration0, expression1, parameter19, main20, methodeDeclaration21, instruction23, instruction26, block17, parameter29, methodecall32},
    generalizations={gen_kmLogo_MethodeCall_Expression, gen_kmLogo_BinaryExp_Expression, gen_kmLogo_Constant_Expression, gen_kmLogo_Block_Instruction, gen_kmLogo_If_ControlStructure, gen_kmLogo_ControlStructure_Instruction, gen_kmLogo_For_ControlStructure, gen_kmLogo_Expression_Instruction, gen_kmLogo_Plus_BinaryExp, gen_kmLogo_Minus_BinaryExp, gen_kmLogo_Mult_BinaryExp, gen_kmLogo_Div_BinaryExp, gen_kmLogo_Equals_BinaryExp, gen_kmLogo_Greater_BinaryExp, gen_kmLogo_Lower_BinaryExp, gen_kmLogo_MethodeDeclaration_Instruction, gen_kmLogo_While_ControlStructure, gen_kmLogo_ParameterCall_Expression},
    metadata=None
)
