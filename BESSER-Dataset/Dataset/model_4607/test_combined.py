...
def test_hyp_gmfgraph_custompin_is_not_abstract():
    assert not inspect.isabstract(gmfgraph_CustomPin)


def test_hyp_gmfgraph_custompin_constructor_exists():
    assert callable(gmfgraph_CustomPin.__init__)


def test_hyp_gmfgraph_custompin_constructor_args():
...
def test_hyp_gmfgraph_visiblepin_is_not_abstract():
    assert not inspect.isabstract(gmfgraph_VisiblePin)


def test_hyp_gmfgraph_visiblepin_constructor_exists():
    assert callable(gmfgraph_VisiblePin.__init__)


def test_hyp_gmfgraph_visiblepin_constructor_args():
    sig = inspect.signature(gmfgraph_VisiblePin.__init__)
    params = list(sig.parameters.keys())



def test_hyp_gmfgraph_colorpin_is_not_abstract():
    assert not inspect.isabstract(gmfgraph_ColorPin)


def test_hyp_gmfgraph_colorpin_constructor_exists():
    assert callable(gmfgraph_ColorPin.__init__)


def test_hyp_gmfgraph_colorpin_constructor_args():
...
def test_hyp_gmfgraph_rectangle2d_is_not_abstract():
    assert not inspect.isabstract(gmfgraph_Rectangle2D)


def test_hyp_gmfgraph_rectangle2d_constructor_exists():
    assert callable(gmfgraph_Rectangle2D.__init__)


def test_hyp_gmfgraph_rectangle2d_constructor_args():
...
def test_hyp_gmfgraph_svgproperty_is_not_abstract():
    assert not inspect.isabstract(gmfgraph_SVGProperty)


def test_hyp_gmfgraph_svgproperty_constructor_exists():
    assert callable(gmfgraph_SVGProperty.__init__)


def test_hyp_gmfgraph_svgproperty_constructor_args():
...
def test_hyp_gmfgraph_centerlayout_is_not_abstract():
    assert not inspect.isabstract(gmfgraph_CenterLayout)


def test_hyp_gmfgraph_centerlayout_constructor_exists():
    assert callable(gmfgraph_CenterLayout.__init__)


def test_hyp_gmfgraph_centerlayout_constructor_args():
...
def test_hyp_gmfgraph_svgfigure_is_not_abstract():
    assert not inspect.isabstract(gmfgraph_SVGFigure)


def test_hyp_gmfgraph_svgfigure_constructor_exists():
    assert callable(gmfgraph_SVGFigure.__init__)


def test_hyp_gmfgraph_svgfigure_constructor_args():
...
def test_hyp_gmfgraph_invisiblerectangle_is_not_abstract():
    assert not inspect.isabstract(gmfgraph_InvisibleRectangle)


def test_hyp_gmfgraph_invisiblerectangle_constructor_exists():
    assert callable(gmfgraph_InvisibleRectangle.__init__)


def test_hyp_gmfgraph_invisiblerectangle_constructor_args():
...
def test_hyp_gmfgraph_verticallabel_is_not_abstract():
    assert not inspect.isabstract(gmfgraph_VerticalLabel)


def test_hyp_gmfgraph_verticallabel_constructor_exists():
    assert callable(gmfgraph_VerticalLabel.__init__)


def test_hyp_gmfgraph_verticallabel_constructor_args():
...
def test_hyp_pinowner_is_not_abstract():
    assert not inspect.isabstract(PinOwner)


def test_hyp_pinowner_constructor_exists():
    assert callable(PinOwner.__init__)


def test_hyp_pinowner_constructor_args():
...
def test_hyp_gmfgraph_pin_is_not_abstract():
    assert not inspect.isabstract(gmfgraph_Pin)


def test_hyp_gmfgraph_pin_constructor_exists():
    assert callable(gmfgraph_Pin.__init__)


def test_hyp_gmfgraph_pin_constructor_args():
...
def test_hyp_gmfgraph_custompin_customOperationName_setter(instance):
...
@given(instance=gmfgraph_CustomPin_strategy)
def test_hyp_gmfgraph_custompin_customOperationType_setter(instance):
...
def test_hyp_gmfgraph_colorpin_backgroundNotForeground_setter(instance):
...
def test_hyp_gmfgraph_rectangle2d_x_setter(instance):
    original = instance.x
    instance.x = original
...
@given(instance=gmfgraph_Rectangle2D_strategy)
def test_hyp_gmfgraph_rectangle2d_y_setter(instance):
    original = instance.y
    instance.y = original
...
@given(instance=gmfgraph_Rectangle2D_strategy)
def test_hyp_gmfgraph_rectangle2d_height_setter(instance):
...
@given(instance=gmfgraph_Rectangle2D_strategy)
def test_hyp_gmfgraph_rectangle2d_width_setter(instance):
...
def test_hyp_gmfgraph_svgproperty_query_setter(instance):
...
@given(instance=gmfgraph_SVGProperty_strategy)
def test_hyp_gmfgraph_svgproperty_type_setter(instance):
...
@given(instance=gmfgraph_SVGProperty_strategy)
def test_hyp_gmfgraph_svgproperty_setter_setter(instance):
...
@given(instance=gmfgraph_SVGProperty_strategy)
def test_hyp_gmfgraph_svgproperty_callSuper_setter(instance):
...
@given(instance=gmfgraph_SVGProperty_strategy)
def test_hyp_gmfgraph_svgproperty_getter_setter(instance):
...
@given(instance=gmfgraph_SVGProperty_strategy)
def test_hyp_gmfgraph_svgproperty_attribute_setter(instance):
...
def test_hyp_gmfgraph_svgfigure_documentURI_setter(instance):
...
@given(instance=gmfgraph_SVGFigure_strategy)
def test_hyp_gmfgraph_svgfigure_noCanvasWidth_setter(instance):
...
@given(instance=gmfgraph_SVGFigure_strategy)
def test_hyp_gmfgraph_svgfigure_noCanvasHeight_setter(instance):
...
def test_hyp_gmfgraph_verticallabel_text_setter(instance):
    original = instance.text
    instance.text = original
    assert instance.text == original
