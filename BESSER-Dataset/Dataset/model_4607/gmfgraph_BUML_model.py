...
# Classes
gmfgraph_Compartment = Class(name="gmfgraph_Compartment")
gmfgraph_DiagramLabel = Class(name="gmfgraph_DiagramLabel")
gmfgraph_RealFigure = Class(name="gmfgraph_RealFigure", is_abstract=True)
gmfgraph_FigureDescriptor = Class(name="gmfgraph_FigureDescriptor")
gmfgraph_Border = Class(name="gmfgraph_Border", is_abstract=True)
gmfgraph_Layout = Class(name="gmfgraph_Layout", is_abstract=True)
gmfgraph_Canvas = Class(name="gmfgraph_Canvas")
Identity = Class(name="Identity")
gmfgraph_FigureGallery = Class(name="gmfgraph_FigureGallery")
gmfgraph_Node = Class(name="gmfgraph_Node")
gmfgraph_Connection = Class(name="gmfgraph_Connection")
Node = Class(name="Node")
gmfgraph_GeneralFacet = Class(name="gmfgraph_GeneralFacet")
VisualFacet = Class(name="VisualFacet")
gmfgraph_Identity = Class(name="gmfgraph_Identity", is_abstract=True)
gmfgraph_DiagramElement = Class(name="gmfgraph_DiagramElement", is_abstract=True)
gmfgraph_VisualFacet = Class(name="gmfgraph_VisualFacet", is_abstract=True)
gmfgraph_AbstractNode = Class(name="gmfgraph_AbstractNode", is_abstract=True)
DiagramElement = Class(name="DiagramElement")
AbstractNode = Class(name="AbstractNode")
gmfgraph_ChildAccess = Class(name="gmfgraph_ChildAccess")
gmfgraph_Dimension = Class(name="gmfgraph_Dimension")
gmfgraph_AlignmentFacet = Class(name="gmfgraph_AlignmentFacet")
gmfgraph_GradientFacet = Class(name="gmfgraph_GradientFacet")
gmfgraph_LabelOffsetFacet = Class(name="gmfgraph_LabelOffsetFacet")
gmfgraph_DefaultSizeFacet = Class(name="gmfgraph_DefaultSizeFacet")
gmfgraph_Font = Class(name="gmfgraph_Font", is_abstract=True)
gmfgraph_Insets = Class(name="gmfgraph_Insets")
gmfgraph_Point = Class(name="gmfgraph_Point")
gmfgraph_AbstractFigure = Class(name="gmfgraph_AbstractFigure", is_abstract=True)
Figure = Class(name="Figure")
gmfgraph_Figure = Class(name="gmfgraph_Figure", is_abstract=True)
Layoutable = Class(name="Layoutable")
gmfgraph_Color = Class(name="gmfgraph_Color", is_abstract=True)
AbstractFigure = Class(name="AbstractFigure")
PinOwner = Class(name="PinOwner")
CustomAttributeOwner = Class(name="CustomAttributeOwner")
gmfgraph_FigureRef = Class(name="gmfgraph_FigureRef")
gmfgraph_VerticalLabel = Class(name="gmfgraph_VerticalLabel")
gmfgraph_Rectangle = Class(name="gmfgraph_Rectangle")
Shape = Class(name="Shape")
gmfgraph_InvisibleRectangle = Class(name="gmfgraph_InvisibleRectangle")
gmfgraph_RoundedRectangle = Class(name="gmfgraph_RoundedRectangle")
gmfgraph_Ellipse = Class(name="gmfgraph_Ellipse")
gmfgraph_ConnectionFigure = Class(name="gmfgraph_ConnectionFigure", is_abstract=True)
RealFigure = Class(name="RealFigure")
gmfgraph_DecorationFigure = Class(name="gmfgraph_DecorationFigure", is_abstract=True)
gmfgraph_Shape = Class(name="gmfgraph_Shape", is_abstract=True)
gmfgraph_Label = Class(name="gmfgraph_Label")
gmfgraph_LabeledContainer = Class(name="gmfgraph_LabeledContainer")
gmfgraph_PolylineDecoration = Class(name="gmfgraph_PolylineDecoration")
DecorationFigure = Class(name="DecorationFigure")
gmfgraph_PolygonDecoration = Class(name="gmfgraph_PolygonDecoration")
gmfgraph_CustomAttributeOwner = Class(name="gmfgraph_CustomAttributeOwner", is_abstract=True)
gmfgraph_CustomAttribute = Class(name="gmfgraph_CustomAttribute")
gmfgraph_CustomClass = Class(name="gmfgraph_CustomClass", is_abstract=True)
gmfgraph_Polyline = Class(name="gmfgraph_Polyline")
gmfgraph_Polygon = Class(name="gmfgraph_Polygon")
Polyline = Class(name="Polyline")
gmfgraph_ScalablePolygon = Class(name="gmfgraph_ScalablePolygon")
Polygon = Class(name="Polygon")
gmfgraph_PolylineConnection = Class(name="gmfgraph_PolylineConnection")
...
gmfgraph_CustomDecoration = Class(name="gmfgraph_CustomDecoration")
CustomFigure = Class(name="CustomFigure")
gmfgraph_FigureAccessor = Class(name="gmfgraph_FigureAccessor")
gmfgraph_ConstantColor = Class(name="gmfgraph_ConstantColor")
gmfgraph_CustomConnection = Class(name="gmfgraph_CustomConnection")
gmfgraph_RGBColor = Class(name="gmfgraph_RGBColor")
Color = Class(name="Color")
gmfgraph_BasicFont = Class(name="gmfgraph_BasicFont")
Font = Class(name="Font")
gmfgraph_BorderRef = Class(name="gmfgraph_BorderRef")
Border = Class(name="Border")
gmfgraph_CompoundBorder = Class(name="gmfgraph_CompoundBorder")
gmfgraph_LineBorder = Class(name="gmfgraph_LineBorder")
gmfgraph_MarginBorder = Class(name="gmfgraph_MarginBorder")
gmfgraph_LayoutData = Class(name="gmfgraph_LayoutData", is_abstract=True)
gmfgraph_Layoutable = Class(name="gmfgraph_Layoutable", is_abstract=True)
gmfgraph_CustomLayoutData = Class(name="gmfgraph_CustomLayoutData")
LayoutData = Class(name="LayoutData")
gmfgraph_GridLayoutData = Class(name="gmfgraph_GridLayoutData")
gmfgraph_CustomBorder = Class(name="gmfgraph_CustomBorder")
gmfgraph_LayoutRef = Class(name="gmfgraph_LayoutRef")
Layout = Class(name="Layout")
gmfgraph_CustomLayout = Class(name="gmfgraph_CustomLayout")
gmfgraph_GridLayout = Class(name="gmfgraph_GridLayout")
gmfgraph_BorderLayout = Class(name="gmfgraph_BorderLayout")
gmfgraph_BorderLayoutData = Class(name="gmfgraph_BorderLayoutData")
gmfgraph_StackLayout = Class(name="gmfgraph_StackLayout")
gmfgraph_CenterLayout = Class(name="gmfgraph_CenterLayout")
gmfgraph_SVGFigure = Class(name="gmfgraph_SVGFigure")
gmfgraph_SVGProperty = Class(name="gmfgraph_SVGProperty")
gmfgraph_Rectangle2D = Class(name="gmfgraph_Rectangle2D")
gmfgraph_FlowLayout = Class(name="gmfgraph_FlowLayout")
gmfgraph_XYLayout = Class(name="gmfgraph_XYLayout")
gmfgraph_XYLayoutData = Class(name="gmfgraph_XYLayoutData")
gmfgraph_ColorPin = Class(name="gmfgraph_ColorPin")
gmfgraph_VisiblePin = Class(name="gmfgraph_VisiblePin")
gmfgraph_PinOwner = Class(name="gmfgraph_PinOwner", is_abstract=True)
gmfgraph_Pin = Class(name="gmfgraph_Pin", is_abstract=True)
gmfgraph_CustomPin = Class(name="gmfgraph_CustomPin")
Pin = Class(name="Pin")
...
gmfgraph_Shape.attributes={gmfgraph_Shape_xorOutline, gmfgraph_Shape_lineWidth, gmfgraph_Shape_xorFill, gmfgraph_Shape_lineKind, gmfgraph_Shape_outline, gmfgraph_Shape_fill}
...
gmfgraph_CustomAttribute.attributes={gmfgraph_CustomAttribute_directAccess, gmfgraph_CustomAttribute_value, gmfgraph_CustomAttribute_multiStatementValue, gmfgraph_CustomAttribute_name}
...
gmfgraph_SVGProperty.attributes={gmfgraph_SVGProperty_setter, gmfgraph_SVGProperty_query, gmfgraph_SVGProperty_type, gmfgraph_SVGProperty_getter, gmfgraph_SVGProperty_attribute, gmfgraph_SVGProperty_callSuper}
...
gmfgraph_Rectangle2D.attributes={gmfgraph_Rectangle2D_x, gmfgraph_Rectangle2D_height, gmfgraph_Rectangle2D_y, gmfgraph_Rectangle2D_width}
...
gmfgraph_FlowLayout.attributes={gmfgraph_FlowLayout_forceSingleLine, gmfgraph_FlowLayout_vertical, gmfgraph_FlowLayout_majorAlignment, gmfgraph_FlowLayout_matchMinorSize, gmfgraph_FlowLayout_minorAlignment, gmfgraph_FlowLayout_majorSpacing, gmfgraph_FlowLayout_minorSpacing}
...
domain_model = DomainModel(
    name="gmfgraph",
    types={gmfgraph_Compartment, gmfgraph_DiagramLabel, gmfgraph_RealFigure, gmfgraph_FigureDescriptor, gmfgraph_Border, gmfgraph_Layout, gmfgraph_Canvas, Identity, gmfgraph_FigureGallery, gmfgraph_Node, gmfgraph_Connection, Node, gmfgraph_GeneralFacet, VisualFacet, gmfgraph_Identity, gmfgraph_DiagramElement, gmfgraph_VisualFacet, gmfgraph_AbstractNode, DiagramElement, AbstractNode, gmfgraph_ChildAccess, gmfgraph_Dimension, gmfgraph_AlignmentFacet, gmfgraph_GradientFacet, gmfgraph_LabelOffsetFacet, gmfgraph_DefaultSizeFacet, gmfgraph_Font, gmfgraph_Insets, gmfgraph_Point, gmfgraph_AbstractFigure, Figure, gmfgraph_Figure, Layoutable, gmfgraph_Color, AbstractFigure, PinOwner, CustomAttributeOwner, gmfgraph_FigureRef, gmfgraph_VerticalLabel, gmfgraph_Rectangle, Shape, gmfgraph_InvisibleRectangle, gmfgraph_RoundedRectangle, gmfgraph_Ellipse, gmfgraph_ConnectionFigure, RealFigure, gmfgraph_DecorationFigure, gmfgraph_Shape, gmfgraph_Label, gmfgraph_LabeledContainer, gmfgraph_PolylineDecoration, DecorationFigure, gmfgraph_PolygonDecoration, gmfgraph_CustomAttributeOwner, gmfgraph_CustomAttribute, gmfgraph_CustomClass, gmfgraph_Polyline, gmfgraph_Polygon, Polyline, gmfgraph_ScalablePolygon, Polygon, gmfgraph_PolylineConnection, ConnectionFigure, gmfgraph_CustomFigure, CustomClass, gmfgraph_CustomDecoration, CustomFigure, gmfgraph_FigureAccessor, gmfgraph_ConstantColor, gmfgraph_CustomConnection, gmfgraph_RGBColor, Color, gmfgraph_BasicFont, Font, gmfgraph_BorderRef, Border, gmfgraph_CompoundBorder, gmfgraph_LineBorder, gmfgraph_MarginBorder, gmfgraph_LayoutData, gmfgraph_Layoutable, gmfgraph_CustomLayoutData, LayoutData, gmfgraph_GridLayoutData, gmfgraph_CustomBorder, gmfgraph_LayoutRef, Layout, gmfgraph_CustomLayout, gmfgraph_GridLayout, gmfgraph_BorderLayout, gmfgraph_BorderLayoutData, gmfgraph_StackLayout, gmfgraph_CenterLayout, gmfgraph_SVGFigure, gmfgraph_SVGProperty, gmfgraph_Rectangle2D, gmfgraph_FlowLayout, gmfgraph_XYLayout, gmfgraph_XYLayoutData, gmfgraph_ColorPin, gmfgraph_VisiblePin, gmfgraph_PinOwner, gmfgraph_Pin, gmfgraph_CustomPin, Pin, ColorConstants, FontStyle, LineKind, Direction, Alignment, SVGPropertyType},
    associations={compartments5, labels7, figures9, descriptors11, borders13, layouts15, figures0, nodes1, connections3, contentPane21, accessor23, accessor26, container29, figure17, facets19, defaultSize32, preferredSize46, font49, insets51, border53, location56, size58, descriptor33, foregroundColor35, backgroundColor37, maximumSize40, minimumSize43, children69, figure72, actualFigure61, accessors64, owner65, figure66, resolvedChildren74, targetDecoration79, attributes82, template76, sourceDecoration78, typedFigure83, customChildren85, actual87, insets91, outer93, color89, owner98, inner95, layoutData101, layout103, actual105, margins107, spacing109, sizeHint99, topLeft114, size116, properties119, areaOfInterest120, spacing112, pins122},
    generalizations={gen_gmfgraph_FigureGallery_Identity, gen_gmfgraph_Canvas_Identity, gen_gmfgraph_Connection_DiagramElement, gen_gmfgraph_Compartment_DiagramElement, gen_gmfgraph_DiagramLabel_Node, gen_gmfgraph_GeneralFacet_VisualFacet, gen_gmfgraph_DiagramElement_Identity, gen_gmfgraph_AbstractNode_DiagramElement, gen_gmfgraph_Node_AbstractNode, gen_gmfgraph_AlignmentFacet_VisualFacet, gen_gmfgraph_GradientFacet_VisualFacet, gen_gmfgraph_LabelOffsetFacet_VisualFacet, gen_gmfgraph_DefaultSizeFacet_VisualFacet, gen_gmfgraph_AbstractFigure_Figure, gen_gmfgraph_FigureDescriptor_Identity, gen_gmfgraph_Figure_Layoutable, gen_gmfgraph_RealFigure_AbstractFigure, gen_gmfgraph_RealFigure_PinOwner, gen_gmfgraph_RealFigure_CustomAttributeOwner, gen_gmfgraph_FigureRef_AbstractFigure, gen_gmfgraph_VerticalLabel_RealFigure, gen_gmfgraph_Rectangle_Shape, gen_gmfgraph_InvisibleRectangle_RealFigure, gen_gmfgraph_RoundedRectangle_Shape, gen_gmfgraph_Ellipse_Shape, gen_gmfgraph_ConnectionFigure_RealFigure, gen_gmfgraph_DecorationFigure_RealFigure, gen_gmfgraph_Shape_RealFigure, gen_gmfgraph_Label_RealFigure, gen_gmfgraph_LabeledContainer_RealFigure, gen_gmfgraph_PolylineDecoration_Polyline, gen_gmfgraph_PolylineDecoration_DecorationFigure, gen_gmfgraph_PolygonDecoration_Polygon, gen_gmfgraph_PolygonDecoration_DecorationFigure, gen_gmfgraph_Polyline_Shape, gen_gmfgraph_Polygon_Polyline, gen_gmfgraph_ScalablePolygon_Polygon, gen_gmfgraph_PolylineConnection_Polyline, gen_gmfgraph_PolylineConnection_ConnectionFigure, gen_gmfgraph_CustomFigure_RealFigure, gen_gmfgraph_CustomFigure_CustomClass, gen_gmfgraph_CustomClass_CustomAttributeOwner, gen_gmfgraph_CustomDecoration_CustomFigure, gen_gmfgraph_CustomDecoration_DecorationFigure, gen_gmfgraph_ConstantColor_Color, gen_gmfgraph_CustomConnection_CustomFigure, gen_gmfgraph_CustomConnection_ConnectionFigure, gen_gmfgraph_RGBColor_Color, gen_gmfgraph_BasicFont_Font, gen_gmfgraph_MarginBorder_Border, gen_gmfgraph_BorderRef_Border, gen_gmfgraph_CompoundBorder_Border, gen_gmfgraph_LineBorder_Border, gen_gmfgraph_CustomLayoutData_LayoutData, gen_gmfgraph_CustomLayoutData_CustomClass, gen_gmfgraph_GridLayoutData_LayoutData, gen_gmfgraph_CustomBorder_Border, gen_gmfgraph_CustomBorder_CustomClass, gen_gmfgraph_LayoutRef_Layout, gen_gmfgraph_CustomLayout_Layout, gen_gmfgraph_CustomLayout_CustomClass, gen_gmfgraph_GridLayout_Layout, gen_gmfgraph_BorderLayoutData_LayoutData, gen_gmfgraph_StackLayout_Layout, gen_gmfgraph_CenterLayout_Layout, gen_gmfgraph_SVGFigure_RealFigure, gen_gmfgraph_BorderLayout_Layout, gen_gmfgraph_FlowLayout_Layout, gen_gmfgraph_XYLayout_Layout, gen_gmfgraph_XYLayoutData_LayoutData, gen_gmfgraph_ColorPin_Pin, gen_gmfgraph_VisiblePin_Pin, gen_gmfgraph_Pin_Identity, gen_gmfgraph_CustomPin_Pin},
    metadata=None
)
