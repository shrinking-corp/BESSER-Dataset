...
def test_gmfgraph_custompin_is_not_abstract():
    assert not inspect.isabstract(gmfgraph_CustomPin)


def test_gmfgraph_custompin_constructor_exists():
    assert callable(gmfgraph_CustomPin.__init__)


def test_gmfgraph_custompin_constructor_args():
    sig = inspect.signature(gmfgraph_CustomPin.__init__)
    params = list(sig.parameters.keys())
...
def test_gmfgraph_custompin_has_customOperationName():
    assert hasattr(gmfgraph_CustomPin, "customOperationName")
    descriptor = None
    for klass in gmfgraph_CustomPin.__mro__:
        if "customOperationName" in klass.__dict__:
            descriptor = klass.__dict__["customOperationName"]
            break
    assert isinstance(descriptor, property)

def test_gmfgraph_custompin_has_customOperationType():
    assert hasattr(gmfgraph_CustomPin, "customOperationType")
    descriptor = None
    for klass in gmfgraph_CustomPin.__mro__:
...
def test_gmfgraph_visiblepin_is_not_abstract():
    assert not inspect.isabstract(gmfgraph_VisiblePin)


def test_gmfgraph_visiblepin_constructor_exists():
    assert callable(gmfgraph_VisiblePin.__init__)


def test_gmfgraph_visiblepin_constructor_args():
    sig = inspect.signature(gmfgraph_VisiblePin.__init__)
    params = list(sig.parameters.keys())



def test_gmfgraph_colorpin_is_not_abstract():
    assert not inspect.isabstract(gmfgraph_ColorPin)


def test_gmfgraph_colorpin_constructor_exists():
    assert callable(gmfgraph_ColorPin.__init__)


def test_gmfgraph_colorpin_constructor_args():
    sig = inspect.signature(gmfgraph_ColorPin.__init__)
    params = list(sig.parameters.keys())
    assert "backgroundNotForeground" in params, "Missing parameter 'backgroundNotForeground'"

def test_gmfgraph_colorpin_has_backgroundNotForeground():
    assert hasattr(gmfgraph_ColorPin, "backgroundNotForeground")
    descriptor = None
    for klass in gmfgraph_ColorPin.__mro__:
...
def test_gmfgraph_rectangle2d_is_not_abstract():
    assert not inspect.isabstract(gmfgraph_Rectangle2D)


def test_gmfgraph_rectangle2d_constructor_exists():
    assert callable(gmfgraph_Rectangle2D.__init__)


def test_gmfgraph_rectangle2d_constructor_args():
    sig = inspect.signature(gmfgraph_Rectangle2D.__init__)
    params = list(sig.parameters.keys())
...
def test_gmfgraph_rectangle2d_has_x():
    assert hasattr(gmfgraph_Rectangle2D, "x")
    descriptor = None
    for klass in gmfgraph_Rectangle2D.__mro__:
        if "x" in klass.__dict__:
            descriptor = klass.__dict__["x"]
            break
    assert isinstance(descriptor, property)

def test_gmfgraph_rectangle2d_has_y():
    assert hasattr(gmfgraph_Rectangle2D, "y")
    descriptor = None
    for klass in gmfgraph_Rectangle2D.__mro__:
...
def test_gmfgraph_rectangle2d_has_height():
    assert hasattr(gmfgraph_Rectangle2D, "height")
    descriptor = None
    for klass in gmfgraph_Rectangle2D.__mro__:
...
def test_gmfgraph_rectangle2d_has_width():
    assert hasattr(gmfgraph_Rectangle2D, "width")
    descriptor = None
    for klass in gmfgraph_Rectangle2D.__mro__:
...
def test_gmfgraph_svgproperty_is_not_abstract():
    assert not inspect.isabstract(gmfgraph_SVGProperty)


def test_gmfgraph_svgproperty_constructor_exists():
    assert callable(gmfgraph_SVGProperty.__init__)


def test_gmfgraph_svgproperty_constructor_args():
    sig = inspect.signature(gmfgraph_SVGProperty.__init__)
    params = list(sig.parameters.keys())
...
def test_gmfgraph_svgproperty_has_query():
    assert hasattr(gmfgraph_SVGProperty, "query")
    descriptor = None
    for klass in gmfgraph_SVGProperty.__mro__:
        if "query" in klass.__dict__:
            descriptor = klass.__dict__["query"]
            break
    assert isinstance(descriptor, property)

def test_gmfgraph_svgproperty_has_type():
    assert hasattr(gmfgraph_SVGProperty, "type")
    descriptor = None
    for klass in gmfgraph_SVGProperty.__mro__:
...
def test_gmfgraph_svgproperty_has_setter():
    assert hasattr(gmfgraph_SVGProperty, "setter")
    descriptor = None
    for klass in gmfgraph_SVGProperty.__mro__:
...
def test_gmfgraph_svgproperty_has_callSuper():
    assert hasattr(gmfgraph_SVGProperty, "callSuper")
    descriptor = None
    for klass in gmfgraph_SVGProperty.__mro__:
...
def test_gmfgraph_svgproperty_has_getter():
    assert hasattr(gmfgraph_SVGProperty, "getter")
    descriptor = None
    for klass in gmfgraph_SVGProperty.__mro__:
...
def test_gmfgraph_svgproperty_has_attribute():
    assert hasattr(gmfgraph_SVGProperty, "attribute")
    descriptor = None
    for klass in gmfgraph_SVGProperty.__mro__:
...
def test_gmfgraph_centerlayout_is_not_abstract():
    assert not inspect.isabstract(gmfgraph_CenterLayout)


def test_gmfgraph_centerlayout_constructor_exists():
    assert callable(gmfgraph_CenterLayout.__init__)


def test_gmfgraph_centerlayout_constructor_args():
    sig = inspect.signature(gmfgraph_CenterLayout.__init__)
    params = list(sig.parameters.keys())
...
def test_gmfgraph_layoutref_is_not_abstract():
    assert not inspect.isabstract(gmfgraph_LayoutRef)


def test_gmfgraph_layoutref_constructor_exists():
    assert callable(gmfgraph_LayoutRef.__init__)


def test_gmfgraph_layoutref_constructor_args():
...
def test_gmfgraph_borderref_is_not_abstract():
    assert not inspect.isabstract(gmfgraph_BorderRef)


def test_gmfgraph_borderref_constructor_exists():
    assert callable(gmfgraph_BorderRef.__init__)


def test_gmfgraph_borderref_constructor_args():
...
def test_gmfgraph_svgfigure_is_not_abstract():
    assert not inspect.isabstract(gmfgraph_SVGFigure)


def test_gmfgraph_svgfigure_constructor_exists():
    assert callable(gmfgraph_SVGFigure.__init__)


def test_gmfgraph_svgfigure_constructor_args():
    sig = inspect.signature(gmfgraph_SVGFigure.__init__)
    params = list(sig.parameters.keys())
...
def test_gmfgraph_svgfigure_has_documentURI():
    assert hasattr(gmfgraph_SVGFigure, "documentURI")
    descriptor = None
    for klass in gmfgraph_SVGFigure.__mro__:
        if "documentURI" in klass.__dict__:
            descriptor = klass.__dict__["documentURI"]
            break
    assert isinstance(descriptor, property)

def test_gmfgraph_svgfigure_has_noCanvasWidth():
    assert hasattr(gmfgraph_SVGFigure, "noCanvasWidth")
    descriptor = None
    for klass in gmfgraph_SVGFigure.__mro__:
...
def test_gmfgraph_svgfigure_has_noCanvasHeight():
    assert hasattr(gmfgraph_SVGFigure, "noCanvasHeight")
    descriptor = None
    for klass in gmfgraph_SVGFigure.__mro__:
...
def test_gmfgraph_invisiblerectangle_is_not_abstract():
    assert not inspect.isabstract(gmfgraph_InvisibleRectangle)


def test_gmfgraph_invisiblerectangle_constructor_exists():
    assert callable(gmfgraph_InvisibleRectangle.__init__)


def test_gmfgraph_invisiblerectangle_constructor_args():
    sig = inspect.signature(gmfgraph_InvisibleRectangle.__init__)
    params = list(sig.parameters.keys())
...
def test_gmfgraph_verticallabel_is_not_abstract():
    assert not inspect.isabstract(gmfgraph_VerticalLabel)


def test_gmfgraph_verticallabel_constructor_exists():
    assert callable(gmfgraph_VerticalLabel.__init__)


def test_gmfgraph_verticallabel_constructor_args():
    sig = inspect.signature(gmfgraph_VerticalLabel.__init__)
    params = list(sig.parameters.keys())
    assert "text" in params, "Missing parameter 'text'"

def test_gmfgraph_verticallabel_has_text():
    assert hasattr(gmfgraph_VerticalLabel, "text")
    descriptor = None
    for klass in gmfgraph_VerticalLabel.__mro__:
        if "text" in klass.__dict__:
            descriptor = klass.__dict__["text"]
            break
    assert isinstance(descriptor, property)
...
def test_gmfgraph_childaccess_is_not_abstract():
    assert not inspect.isabstract(gmfgraph_ChildAccess)


def test_gmfgraph_childaccess_constructor_exists():
    assert callable(gmfgraph_ChildAccess.__init__)


def test_gmfgraph_childaccess_constructor_args():
    sig = inspect.signature(gmfgraph_ChildAccess.__init__)
    params = list(sig.parameters.keys())
    assert "accessor" in params, "Missing parameter 'accessor'"

def test_gmfgraph_childaccess_has_accessor():
    assert hasattr(gmfgraph_ChildAccess, "accessor")
    descriptor = None
    for klass in gmfgraph_ChildAccess.__mro__:
        if "accessor" in klass.__dict__:
            descriptor = klass.__dict__["accessor"]
            break
    assert isinstance(descriptor, property)
...
def test_gmfgraph_abstractnode_is_not_abstract():
    assert not inspect.isabstract(gmfgraph_AbstractNode)


def test_gmfgraph_abstractnode_constructor_exists():
    assert callable(gmfgraph_AbstractNode.__init__)


def test_gmfgraph_abstractnode_constructor_args():
...
def test_gmfgraph_pin_is_not_abstract():
    assert not inspect.isabstract(gmfgraph_Pin)


def test_gmfgraph_pin_constructor_exists():
    assert callable(gmfgraph_Pin.__init__)


def test_gmfgraph_pin_constructor_args():
    sig = inspect.signature(gmfgraph_Pin.__init__)
    params = list(sig.parameters.keys())
...
def test_gmfgraph_realfigure_has_name():
    assert hasattr(gmfgraph_RealFigure, "name")
    descriptor = None
    for klass in gmfgraph_RealFigure.__mro__:
        if "name" in klass.__dict__:
            descriptor = klass.__dict__["name"]
            break
    assert isinstance(descriptor, property)
...
def test_gmfgraph_diagramlabel_has_external():
    assert hasattr(gmfgraph_DiagramLabel, "external")
    descriptor = None
...
gmfgraph_CustomPin_strategy = st.builds(
    gmfgraph_CustomPin,
    customOperationName=
        safe_text,
    customOperationType=
...
gmfgraph_VisiblePin_strategy = st.builds(
    gmfgraph_VisiblePin,
)
gmfgraph_ColorPin_strategy = st.builds(
    gmfgraph_ColorPin,
    backgroundNotForeground=
        st.booleans()
)
gmfgraph_Rectangle2D_strategy = st.builds(
    gmfgraph_Rectangle2D,
    x=
...
gmfgraph_SVGProperty_strategy = st.builds(
    gmfgraph_SVGProperty,
    query=
        safe_text,
    type=
...
gmfgraph_CenterLayout_strategy = st.builds(
    gmfgraph_CenterLayout,
)
...
gmfgraph_SVGFigure_strategy = st.builds(
    gmfgraph_SVGFigure,
    documentURI=
        safe_text,
    noCanvasWidth=
...
gmfgraph_InvisibleRectangle_strategy = st.builds(
    gmfgraph_InvisibleRectangle,
)
...
gmfgraph_VerticalLabel_strategy = st.builds(
    gmfgraph_VerticalLabel,
    text=
        safe_text
)
...
gmfgraph_Pin_strategy = st.builds(
    gmfgraph_Pin,
)
...
@given(instance=gmfgraph_CustomPin_strategy)
def test_gmfgraph_custompin_customOperationName_setter(instance):
...
@given(instance=gmfgraph_CustomPin_strategy)
def test_gmfgraph_custompin_customOperationType_setter(instance):
...
@given(instance=gmfgraph_ColorPin_strategy)
def test_gmfgraph_colorpin_backgroundNotForeground_setter(instance):
...
@given(instance=gmfgraph_Rectangle2D_strategy)
def test_gmfgraph_rectangle2d_x_setter(instance):
    original = instance.x
    instance.x = original
...
@given(instance=gmfgraph_Rectangle2D_strategy)
def test_gmfgraph_rectangle2d_y_setter(instance):
    original = instance.y
    instance.y = original
...
@given(instance=gmfgraph_Rectangle2D_strategy)
def test_gmfgraph_rectangle2d_height_setter(instance):
...
@given(instance=gmfgraph_Rectangle2D_strategy)
def test_gmfgraph_rectangle2d_width_setter(instance):
...
@given(instance=gmfgraph_SVGProperty_strategy)
def test_gmfgraph_svgproperty_query_setter(instance):
...
@given(instance=gmfgraph_SVGProperty_strategy)
def test_gmfgraph_svgproperty_type_setter(instance):
...
@given(instance=gmfgraph_SVGProperty_strategy)
def test_gmfgraph_svgproperty_setter_setter(instance):
...
@given(instance=gmfgraph_SVGProperty_strategy)
def test_gmfgraph_svgproperty_callSuper_setter(instance):
...
@given(instance=gmfgraph_SVGProperty_strategy)
def test_gmfgraph_svgproperty_getter_setter(instance):
...
@given(instance=gmfgraph_SVGProperty_strategy)
def test_gmfgraph_svgproperty_attribute_setter(instance):
...
@given(instance=gmfgraph_SVGFigure_strategy)
def test_gmfgraph_svgfigure_documentURI_setter(instance):
...
@given(instance=gmfgraph_SVGFigure_strategy)
def test_gmfgraph_svgfigure_noCanvasWidth_setter(instance):
...
@given(instance=gmfgraph_SVGFigure_strategy)
def test_gmfgraph_svgfigure_noCanvasHeight_setter(instance):
...
@given(instance=gmfgraph_VerticalLabel_strategy)
def test_gmfgraph_verticallabel_text_setter(instance):
    original = instance.text
    instance.text = original
    assert instance.text == original
...
@given(instance=gmfgraph_ChildAccess_strategy)
def test_gmfgraph_childaccess_accessor_setter(instance):
    original = instance.accessor
    instance.accessor = original
    assert instance.accessor == original
...
@given(instance=gmfgraph_RealFigure_strategy)
def test_gmfgraph_realfigure_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=gmfgraph_DiagramLabel_strategy)
def test_gmfgraph_diagramlabel_external_setter(instance):
