...
class arduino_Expression(ABC):
    ...
    def __init__(self, arduino_Expression28: "arduino_Assignment" = None, arduino_Expression30: "arduino_UnaryExpression" = None, arduino_Expression: "arduino_BinaryExpression" = None, arduino_Expression20: "arduino_BinaryExpression" = None):
...
class arduino_Block:
    ...
    def __init__(self, arduino_Block35: set["arduino_Instruction"] = None, arduino_Block13: "arduino_Control" = None, arduino_Block: "arduino_Sketch" = None, arduino_Block26: "arduino_If" = None):
...
class arduino_Variable(NamedElement):
    ...
    def __init__(self, arduino_Variable32: "arduino_VariableDeclaration" = None, arduino_Variable: "arduino_VariableAssignment" = None):
