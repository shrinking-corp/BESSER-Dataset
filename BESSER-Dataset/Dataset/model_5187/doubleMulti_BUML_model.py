...
# Classes
doublemulti_A = Class(name="doublemulti_A")
doublemulti_B = Class(name="doublemulti_B")
doublemulti_C = Class(name="doublemulti_C")
A = Class(name="A")
B = Class(name="B")
doublemulti_D = Class(name="doublemulti_D")
