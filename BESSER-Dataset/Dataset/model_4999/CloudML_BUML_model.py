...
cloudml_core_Node.attributes={cloudml_core_Node_sshKey, cloudml_core_Node_OS, cloudml_core_Node_groupName, cloudml_core_Node_location, cloudml_core_Node_minRam, cloudml_core_Node_minDisk, cloudml_core_Node_securityGroup, cloudml_core_Node_imageID, cloudml_core_Node_is64os, cloudml_core_Node_minCore, cloudml_core_Node_privateKey}
...
cloudml_core_Resource.attributes={cloudml_core_Resource_retrievingResourceCommand, cloudml_core_Resource_deployingResourceCommand}
...
cloudml_core_Provider.attributes={cloudml_core_Provider_password, cloudml_core_Provider_login}
...
domain_model = DomainModel(
    name="cloudml",
    types={cloudml_core_CloudMLElement, cloudml_core_NamedElement, CloudMLElement, cloudml_core_Property, NamedElement, cloudml_core_WithProperties, Property_, ArtefactInstance, NodeInstance, cloudml_core_ArtefactPort, cloudml_core_Artefact, ArtefactPort, Resource, cloudml_core_NodePort, cloudml_core_Node, NodePort, cloudml_core_Resource, WithProperties, cloudml_core_Provider, cloudml_core_DeploymentModel, Artefact, Node, NodePortInstance, ArtefactPortInstance, cloudml_core_NodePortInstance, cloudml_core_NodeInstance, cloudml_core_Composite, Provider, cloudml_core_ArtefactPortInstance, cloudml_core_ArtefactInstance},
    associations={properties0, artefactInstances4, nodeInstances6, destination8, resource9, inputs11, outputs14, required17, provided20, provided23, artefactTypes1, nodeTypes2, type28, destination30, inputs32, outputs34, required37, provided40, type43, type45, provided47, cloudProvider24, type26, containedArtefacts50},
    generalizations={gen_cloudml_core_NamedElement_CloudMLElement, gen_cloudml_core_Property_NamedElement, gen_cloudml_core_WithProperties_NamedElement, gen_cloudml_core_ArtefactPort_WithProperties, gen_cloudml_core_Artefact_WithProperties, gen_cloudml_core_NodePort_WithProperties, gen_cloudml_core_Node_WithProperties, gen_cloudml_core_Resource_WithProperties, gen_cloudml_core_Provider_WithProperties, gen_cloudml_core_DeploymentModel_WithProperties, gen_cloudml_core_NodePortInstance_WithProperties, gen_cloudml_core_NodeInstance_WithProperties, gen_cloudml_core_Composite_NamedElement, gen_cloudml_core_ArtefactPortInstance_WithProperties, gen_cloudml_core_ArtefactInstance_WithProperties},
    metadata=None
)
