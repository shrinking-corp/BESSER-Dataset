...
class cloudml_core_Resource(WithProperties):
    ...
    def __init__(self, retrievingResourceCommand: str, deployingResourceCommand: str):
        ...
        pass
    @property
    def deployingResourceCommand(self):
    ...
    @property
    def retrievingResourceCommand(self):
...
class cloudml_core_Node(WithProperties):
    ...
    def __init__(self, minRam: int, minCore: int, minDisk: int, location: str, OS: str, sshKey: str, securityGroup: str, groupName: str, privateKey: str, imageID: str, is64os: bool, cloudml_core_Node25: "Provider" = None, cloudml_core_Node: set["NodePort"] = None):
        self.minRam = minRam
