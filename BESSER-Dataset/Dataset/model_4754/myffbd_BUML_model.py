...
# Classes
myffbd_Function = Class(name="myffbd_Function")
SequenceNode = Class(name="SequenceNode")
myffbd_Description = Class(name="myffbd_Description")
myffbd_Token = Class(name="myffbd_Token")
myffbd_PortType = Class(name="myffbd_PortType")
myffbd_And = Class(name="myffbd_And")
myffbd_Or = Class(name="myffbd_Or")
myffbd_Start = Class(name="myffbd_Start")
myffbd_Final = Class(name="myffbd_Final")
myffbd_SequenceNode = Class(name="myffbd_SequenceNode", is_abstract=True)
myffbd_OutputPort = Class(name="myffbd_OutputPort")
myffbd_InputPort = Class(name="myffbd_InputPort")
myffbd_LoopExit = Class(name="myffbd_LoopExit")
myffbd_Iteration = Class(name="myffbd_Iteration")
myffbd_Loop = Class(name="myffbd_Loop")
Port = Class(name="Port")
myffbd_Port = Class(name="myffbd_Port", is_abstract=True)
myffbd_Flow = Class(name="myffbd_Flow")
myffbd_Item = Class(name="myffbd_Item")
...
myffbd_Function.attributes={myffbd_Function_tMax, myffbd_Function_domain, myffbd_Function_tMin}
...
domain_model = DomainModel(
    name="myffbd",
    types={myffbd_Function, SequenceNode, myffbd_Description, myffbd_Token, myffbd_PortType, myffbd_And, myffbd_Or, myffbd_Start, myffbd_Final, myffbd_SequenceNode, myffbd_OutputPort, myffbd_InputPort, myffbd_LoopExit, myffbd_Iteration, myffbd_Loop, Port, myffbd_Port, myffbd_Flow, myffbd_Item, FunctionDomain},
    associations={inputPorts6, descriptions8, tokens10, portTypes12, controlFlowEdge15, decompositions1, sequenceNodes2, outputPorts4, src21, items24, trg26, flows17, type18},
    generalizations={gen_myffbd_Function_SequenceNode, gen_myffbd_And_SequenceNode, gen_myffbd_Or_SequenceNode, gen_myffbd_Start_SequenceNode, gen_myffbd_Final_SequenceNode, gen_myffbd_OutputPort_Port, gen_myffbd_LoopExit_SequenceNode, gen_myffbd_Iteration_SequenceNode, gen_myffbd_Loop_SequenceNode, gen_myffbd_InputPort_Port},
    metadata=None
)
