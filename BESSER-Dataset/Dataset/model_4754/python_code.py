...
class myffbd_Port(ABC):
    ...
    def __init__(self, id: str, myffbd_Port23: "myffbd_Flow" = None, myffbd_Port28: "myffbd_Flow" = None, myffbd_Port: set["myffbd_Flow"] = None, myffbd_Port19: "myffbd_PortType" = None):
        self.id = id
...
class myffbd_SequenceNode(ABC):
    ...
    def __init__(self, name: str, myffbd_SequenceNode16: "myffbd_SequenceNode" = None, myffbd_SequenceNode14: set["myffbd_SequenceNode"] = None, myffbd_SequenceNode: "myffbd_Function" = None):
        self.name = name
...
class myffbd_Function(SequenceNode):
    ...
    def __init__(self, domain: str, tMin: int, tMax: int, myffbd_Function7: set["myffbd_InputPort"] = None, myffbd_Function9: set["myffbd_Description"] = None, myffbd_Function11: set["myffbd_Token"] = None, myffbd_Function13: set["myffbd_PortType"] = None, myffbd_Function: "myffbd_Function" = None, myffbd_Function0: set["myffbd_Function"] = None, myffbd_Function3: set["myffbd_SequenceNode"] = None, myffbd_Function5: set["myffbd_OutputPort"] = None):
        self.domain = domain
        self.tMin = tMin
        self.tMax = tMax
