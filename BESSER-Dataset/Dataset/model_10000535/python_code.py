...
class Process:
    ...
    def __init__(self, processState: ProcessState, registers: str, name: str, memoryUseage: int, processTableModel19: "ProcessTableModel" = None, task_Manager25: "Task_Manager" = None, iO5: "Instruction_IO" = None, exit9: "Instruction_Exit" = None, page43: "Page" = None):
...
class Page:
    ...
    def __init__(self, owner: Process, attribute: str, free: bool, memory51: "Memory" = None, process42: "Process" = None):
        self.owner = owner
...
class Hard_Drive:
    ...
    def __init__(self, memory: str, request48: "Request" = None, operating_System41: "Operating_System" = None):
        self.memory = memory
...
class Memory:
    ...
    def __init__(self, memory: Memory__, table: Page__, page50: "Page" = None, operating_System35: "Operating_System" = None):
        self.memory = memory
        self.table = table
        self.page50 = page50
...
class Operating_System:
    ...
    def __init__(self, MEMORY_SIZE: int, PAGE_SIZE: int, NUMBER_OF_REGISTERS: int, INSTRUCTION_REGISTER: int, PROC_BASE_REGISTER: int, PROC_LIMIT_REGISTER: int, PROCESS_ID_REGISTER: int, PROC_BASE_POINTER: int, PROC_DATA_POINTER: int, QUANTUM: int, clock: Clock, cpu: CPU, dispatcher: Dispatcher, memory: Memory, scheduler: Scheduler, device: IO_Device, hardDrive: Hard_Drive, prompt: Prompt, taskManager: Task_Manager, processTableModel17: "ProcessTableModel" = None, prompt20: "Prompt" = None, task_Manager22: "Task_Manager" = None, main26: "Main" = None, clock28: "Clock" = None, cPU30: "CPU" = None, dispatcher32: "Dispatcher" = None, memory34: "Memory" = None, yield1: "Instruction_Yield" = None, iO3: "Instruction_IO" = None, exit7: "Instruction_Exit" = None, calculate11: "Instruction_Calculate" = None, out13: "Instruction_Out" = None, scheduler36: "Scheduler" = None, iO_Device38: "IO_Device" = None, hard_Drive40: "Hard_Drive" = None):
