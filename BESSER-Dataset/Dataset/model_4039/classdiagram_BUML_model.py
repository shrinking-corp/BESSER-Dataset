...
classdiagram_Operation = Class(name="classdiagram_Operation")
classdiagram_ClassDiagram = Class(name="classdiagram_ClassDiagram")
classdiagram_Class = Class(name="classdiagram_Class")
classdiagram_TypedElement = Class(name="classdiagram_TypedElement", is_abstract=True)
...
domain_model = DomainModel(
    name="classdiagram",
    types={classdiagram_Dependency, classdiagram_Association, NamedElement, classdiagram_Attribute, classdiagram_Operation, classdiagram_ClassDiagram, classdiagram_Class, classdiagram_TypedElement, TypedElement, classdiagram_NamedElement},
    associations={dependencies1, associations3, ownedAttributes5, ownedOperations6, dependenciesAsDependee8, dependenciesAsDepender9, nestedIn12, nested14, classes0, owner27, dependee29, depender31, type33, superclass17, subclasses20, associationsAsSource22, associationsAsTarget23, owner25, source35, target37},
    generalizations={gen_classdiagram_Class_NamedElement, gen_classdiagram_TypedElement_NamedElement, gen_classdiagram_Association_NamedElement, gen_classdiagram_Attribute_TypedElement, gen_classdiagram_Operation_TypedElement},
    metadata=None
)
