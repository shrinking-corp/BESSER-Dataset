...
class dXP_Course(Base):
    ...
    def __init__(self, title: str, courseCode: str, dXP_Course9: "dXP_AcademicSession" = None, dXP_Course: set["dXP_Class"] = None):
        self.title = title
...
class dXP_AcademicSession(Base):
    ...
    def __init__(self, title: str, startDate: str, endDate: str, schoolYear: str, type: str, dXP_AcademicSession: "dXP_OneRoster" = None, dXP_AcademicSession8: set["dXP_Course"] = None, dXP_AcademicSession11: set["dXP_User"] = None):
        self.title = title
