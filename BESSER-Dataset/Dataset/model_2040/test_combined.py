...
def test_hyp_idm_test_transition_is_not_abstract():
    assert not inspect.isabstract(iDM_Test_Transition)


def test_hyp_idm_test_transition_constructor_exists():
    assert callable(iDM_Test_Transition.__init__)


def test_hyp_idm_test_transition_constructor_args():
...
def test_hyp_idm_test_state_is_not_abstract():
    assert not inspect.isabstract(iDM_Test_State)


def test_hyp_idm_test_state_constructor_exists():
    assert callable(iDM_Test_State.__init__)


def test_hyp_idm_test_state_constructor_args():
...
def test_hyp_idm_test_statemachine_is_not_abstract():
    assert not inspect.isabstract(iDM_Test_StateMachine)


def test_hyp_idm_test_statemachine_constructor_exists():
    assert callable(iDM_Test_StateMachine.__init__)


def test_hyp_idm_test_statemachine_constructor_args():
...
def test_hyp_idm_test_transition_name_setter(instance):
...
def test_hyp_idm_test_state_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_idm_test_statemachine_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
