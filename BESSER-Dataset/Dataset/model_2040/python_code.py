...
class iDM_Test_Transition:
    ...
    def __init__(self, name: str, outgoing: "iDM_Test_State" = None, incomming: "iDM_Test_State" = None, Transition: "iDM_Test_State" = None, Transition8: "iDM_Test_State" = None, iDM_Test_Transition: "iDM_Test_StateMachine" = None):
        self.name = name
...
class iDM_Test_State:
    ...
    def __init__(self, name: str, State: "iDM_Test_Transition" = None, State11: "iDM_Test_Transition" = None, to: set["iDM_Test_Transition"] = None, from_: set["iDM_Test_Transition"] = None, iDM_Test_State: "iDM_Test_StateMachine" = None, iDM_Test_State5: "iDM_Test_StateMachine" = None):
        self.name = name
        self.State = State
    ...
    def from_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_iDM_Test_State__from_", None)
