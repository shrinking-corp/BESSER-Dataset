...
# Classes
mpupkb_Thing = Class(name="mpupkb_Thing")
NamedElement = Class(name="NamedElement")
mpupkb_Own = Class(name="mpupkb_Own")
mpupkb_NamedElement = Class(name="mpupkb_NamedElement", is_abstract=True)
mpupkb_Comment = Class(name="mpupkb_Comment")
...
mpupkb_Own.attributes={mpupkb_Own_since, mpupkb_Own_ownerName}
...
domain_model = DomainModel(
    name="mpupkb",
    types={mpupkb_Thing, NamedElement, mpupkb_Own, mpupkb_NamedElement, mpupkb_Comment},
    associations={ownership0, ownershi1, comment2, thing3},
    generalizations={gen_mpupkb_Thing_NamedElement, gen_mpupkb_Own_NamedElement},
    metadata=None
)
