...
def test_hyp_mpupkb_comment_is_not_abstract():
    assert not inspect.isabstract(mpupkb_Comment)


def test_hyp_mpupkb_comment_constructor_exists():
    assert callable(mpupkb_Comment.__init__)


def test_hyp_mpupkb_comment_constructor_args():
...
def test_hyp_mpupkb_namedelement_is_not_abstract():
    assert not inspect.isabstract(mpupkb_NamedElement)


def test_hyp_mpupkb_namedelement_constructor_exists():
    assert callable(mpupkb_NamedElement.__init__)


def test_hyp_mpupkb_namedelement_constructor_args():
...
def test_hyp_mpupkb_own_is_not_abstract():
    assert not inspect.isabstract(mpupkb_Own)


def test_hyp_mpupkb_own_constructor_exists():
    assert callable(mpupkb_Own.__init__)


def test_hyp_mpupkb_own_constructor_args():
...
def test_hyp_mpupkb_thing_is_not_abstract():
    assert not inspect.isabstract(mpupkb_Thing)


def test_hyp_mpupkb_thing_constructor_exists():
    assert callable(mpupkb_Thing.__init__)


def test_hyp_mpupkb_thing_constructor_args():
...
def test_hyp_mpupkb_comment_content_setter(instance):
...
def test_hyp_mpupkb_namedelement_name_setter(instance):
...
def test_hyp_mpupkb_own_ownerName_setter(instance):
...
@given(instance=mpupkb_Own_strategy)
def test_hyp_mpupkb_own_since_setter(instance):
...
def test_hyp_mpupkb_thing_id_setter(instance):
