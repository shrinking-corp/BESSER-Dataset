...
# Classes
types_IntegerType = Class(name="types_IntegerType")
types_StringType = Class(name="types_StringType")
types_FloatType = Class(name="types_FloatType")
types_TupleType = Class(name="types_TupleType")
types_TupleAttribute = Class(name="types_TupleAttribute")
types_MapType = Class(name="types_MapType")
types_RefType = Class(name="types_RefType")
types_Unknown = Class(name="types_Unknown")
types_Type = Class(name="types_Type", is_abstract=True)
types_OclUndefinedType = Class(name="types_OclUndefinedType")
Type = Class(name="Type")
types_PrimitiveType = Class(name="types_PrimitiveType", is_abstract=True)
types_BooleanType = Class(name="types_BooleanType")
PrimitiveType = Class(name="PrimitiveType")
types_Metaclass = Class(name="types_Metaclass")
types_ReflectiveType = Class(name="types_ReflectiveType", is_abstract=True)
types_UnionType = Class(name="types_UnionType")
types_ThisModuleType = Class(name="types_ThisModuleType")
types_ReflectiveClass = Class(name="types_ReflectiveClass")
ReflectiveType = Class(name="ReflectiveType")
types_CollectionType = Class(name="types_CollectionType", is_abstract=True)
types_SequenceType = Class(name="types_SequenceType")
CollectionType = Class(name="CollectionType")
types_BagType = Class(name="types_BagType")
types_SetType = Class(name="types_SetType")
types_OrderedSetType = Class(name="types_OrderedSetType")
RefType = Class(name="RefType")
types_EmptyCollectionType = Class(name="types_EmptyCollectionType")
types_TypeError = Class(name="types_TypeError")
types_EObject = Class(name="types_EObject")
types_UnresolvedTypeError = Class(name="types_UnresolvedTypeError")
TypeError = Class(name="TypeError")
Metaclass = Class(name="Metaclass")
types_UnknownFeature = Class(name="types_UnknownFeature")
EStructuralFeature = Class(name="EStructuralFeature")
types_EClass = Class(name="types_EClass")
types_EmptyCollection = Class(name="types_EmptyCollection")
types_EnumType = Class(name="types_EnumType")
types_MetaModel = Class(name="types_MetaModel")
...
types_Type.attributes={types_Type_metamodelRef, types_Type_multivalued, types_Type_mayBeUndefined}
...
domain_model = DomainModel(
    name="types",
    types={types_IntegerType, types_StringType, types_FloatType, types_TupleType, types_TupleAttribute, types_MapType, types_RefType, types_Unknown, types_Type, types_OclUndefinedType, Type, types_PrimitiveType, types_BooleanType, PrimitiveType, types_Metaclass, types_ReflectiveType, types_UnionType, types_ThisModuleType, types_ReflectiveClass, ReflectiveType, types_CollectionType, types_SequenceType, CollectionType, types_BagType, types_SetType, types_OrderedSetType, RefType, types_EmptyCollectionType, types_TypeError, types_EObject, types_UnresolvedTypeError, TypeError, Metaclass, types_UnknownFeature, EStructuralFeature, types_EClass, types_EmptyCollection, types_EnumType, types_MetaModel},
    associations={attributes3, keyType4, valueType6, type9, noCastedType1, kindOfTypes2, klass16, model19, possibleTypes21, containedType23, problem12, theContainingClass13, eenum14},
    generalizations={gen_types_IntegerType_PrimitiveType, gen_types_StringType_PrimitiveType, gen_types_FloatType_PrimitiveType, gen_types_TupleType_Type, gen_types_MapType_Type, gen_types_RefType_Type, gen_types_OclUndefinedType_Type, gen_types_PrimitiveType_Type, gen_types_BooleanType_PrimitiveType, gen_types_ReflectiveType_Type, gen_types_UnionType_Type, gen_types_ThisModuleType_Type, gen_types_ReflectiveClass_ReflectiveType, gen_types_CollectionType_Type, gen_types_SequenceType_CollectionType, gen_types_BagType_CollectionType, gen_types_SetType_CollectionType, gen_types_OrderedSetType_CollectionType, gen_types_Unknown_RefType, gen_types_EmptyCollectionType_Type, gen_types_TypeError_Type, gen_types_UnresolvedTypeError_TypeError, gen_types_UnresolvedTypeError_Metaclass, gen_types_UnknownFeature_EStructuralFeature, gen_types_EmptyCollection_Type, gen_types_EnumType_Type, gen_types_Metaclass_RefType},
    metadata=None
)
