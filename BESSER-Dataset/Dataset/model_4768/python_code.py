...
class types_Type(ABC):
    ...
    def __init__(self, multivalued: bool, metamodelRef: str, mayBeUndefined: bool, types_Type11: "types_TupleAttribute" = None, types_Type: "types_Type" = None, types_Type0: "types_Type" = None, types_Type22: "types_UnionType" = None, types_Type24: "types_CollectionType" = None, types_Type5: "types_MapType" = None, types_Type8: "types_MapType" = None):
...
class types_TupleAttribute:
    ...
    def __init__(self, name: str, types_TupleAttribute10: "types_Type" = None, types_TupleAttribute: "types_TupleType" = None):
        self.name = name
