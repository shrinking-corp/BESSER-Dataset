...
class exo1_Employee:
    ...
    def __init__(self, salary: str, name: str, employees: set["exo1_Project"] = None, employees9: set["exo1_Departement"] = None, exo1_Employee: "exo1_Company" = None, Employee: "exo1_Departement" = None, Employee5: "exo1_Project" = None):
        self.salary = salary
        self.name = name
...
class exo1_Project:
    ...
    def __init__(self, name: str, budget: int, exo1_Project: "exo1_Company" = None, Project: "exo1_Departement" = None, projects: "exo1_Departement" = None, projects4: set["exo1_Employee"] = None, Project7: "exo1_Employee" = None):
        self.name = name
        self.budget = budget
...
class exo1_Departement:
    ...
    def __init__(self, name: str, location: str, budget: int, Departement10: "exo1_Employee" = None, exo1_Departement: "exo1_Company" = None, departement: set["exo1_Project"] = None, departements: set["exo1_Employee"] = None, Departement: "exo1_Project" = None):
        self.name = name
