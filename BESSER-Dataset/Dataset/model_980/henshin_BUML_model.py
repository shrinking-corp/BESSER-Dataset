...
henshin_Module = Class(name="henshin_Module")
NamedElement = Class(name="NamedElement")
henshin_EPackage = Class(name="henshin_EPackage")
henshin_Unit = Class(name="henshin_Unit", is_abstract=True)
...
henshin_UnaryUnit = Class(name="henshin_UnaryUnit", is_abstract=True)
henshin_MultiUnit = Class(name="henshin_MultiUnit", is_abstract=True)
...
henshin_True = Class(name="henshin_True")
...
henshin_Rule_m_getMultiRulePath: Method = Method(name="getMultiRulePath", parameters={Parameter(name='henshin_multiRule', type=StringType)}, type=StringType)
...
henshin_Rule_m_getActionNodes: Method = Method(name="getActionNodes", parameters={Parameter(name='henshin_action', type=StringType)}, type=StringType)
henshin_Rule_m_getActionEdges: Method = Method(name="getActionEdges", parameters={Parameter(name='henshin_action', type=StringType)}, type=StringType)
...
henshin_Rule_m_createNode: Method = Method(name="createNode", parameters={Parameter(name='henshin_type', type=StringType)}, type=StringType)
henshin_Rule_m_createEdge: Method = Method(name="createEdge", parameters={Parameter(name='henshin_target', type=StringType), Parameter(name='henshin_source', type=StringType), Parameter(name='henshin_type', type=StringType)}, type=StringType)
henshin_Rule_m_canCreateEdge: Method = Method(name="canCreateEdge", parameters={Parameter(name='henshin_type', type=StringType), Parameter(name='henshin_target', type=StringType), Parameter(name='henshin_source', type=StringType)}, type=BooleanType)
henshin_Rule_m_removeEdge: Method = Method(name="removeEdge", parameters={Parameter(name='henshin_edge', type=StringType), Parameter(name='henshin_removeMapped', type=StringType)}, type=BooleanType)
henshin_Rule_m_removeNode: Method = Method(name="removeNode", parameters={Parameter(name='henshin_node', type=StringType), Parameter(name='henshin_removeMapped', type=StringType)}, type=BooleanType)
henshin_Rule_m_removeAttribute: Method = Method(name="removeAttribute", parameters={Parameter(name='henshin_attribute', type=StringType), Parameter(name='henshin_removeMapped', type=StringType)}, type=BooleanType)
henshin_Rule.attributes={henshin_Rule_checkDangling, henshin_Rule_injectiveMatching, henshin_Rule_injectiveMatchingPresenceCondition, henshin_Rule_featureModel}
henshin_Rule.methods={henshin_Rule_m_getActionNodes, henshin_Rule_m_removeEdge, henshin_Rule_m_getRootRule, henshin_Rule_m_getAllMappings, henshin_Rule_m_removeAttribute, henshin_Rule_m_getParameterNodes, henshin_Rule_m_createEdge, henshin_Rule_m_removeNode, henshin_Rule_m_canCreateEdge, henshin_Rule_m_getKernelRule, henshin_Rule_m_getMultiRule, henshin_Rule_m_createNode, henshin_Rule_m_getMultiRulePath, henshin_Rule_m_isMultiRule, henshin_Rule_m_getActionEdges, henshin_Rule_m_getAllMultiRules}

# Unit class attributes and methods

# henshin_Module class attributes and methods
henshin_Module_m_getUnit: Method = Method(name="getUnit", parameters={Parameter(name='henshin_name', type=StringType)}, type=StringType)
henshin_Module_m_getSubModule: Method = Method(name="getSubModule", parameters={Parameter(name='henshin_name', type=StringType)}, type=StringType)
...
henshin_Unit_m_getSubUnits: Method = Method(name="getSubUnits", parameters={Parameter(name='henshin_deep', type=StringType)}, type=StringType)
henshin_Unit_m_getParameter: Method = Method(name="getParameter", parameters={Parameter(name='henshin_parameter', type=StringType)}, type=StringType)
...
henshin_Graph_m_getNode: Method = Method(name="getNode", parameters={Parameter(name='henshin_name', type=StringType)}, type=StringType)
...
henshin_Graph_m_getPAC: Method = Method(name="getPAC", parameters={Parameter(name='henshin_name', type=StringType)}, type=StringType)
henshin_Graph_m_getNAC: Method = Method(name="getNAC", parameters={Parameter(name='henshin_name', type=StringType)}, type=StringType)
...
henshin_Graph_m_createPAC: Method = Method(name="createPAC", parameters={Parameter(name='henshin_name', type=StringType)}, type=StringType)
henshin_Graph_m_createNAC: Method = Method(name="createNAC", parameters={Parameter(name='henshin_name', type=StringType)}, type=StringType)
henshin_Graph_m_removeNode: Method = Method(name="removeNode", parameters={Parameter(name='henshin_node', type=StringType)}, type=BooleanType)
henshin_Graph_m_removeEdge: Method = Method(name="removeEdge", parameters={Parameter(name='henshin_edge', type=StringType)}, type=BooleanType)
henshin_Graph_m_removeNestedCondition: Method = Method(name="removeNestedCondition", parameters={Parameter(name='henshin_nestedCondition', type=StringType)}, type=BooleanType)
henshin_Graph.methods={henshin_Graph_m_getEdges, henshin_Graph_m_getNestedConditions, henshin_Graph_m_createNAC, henshin_Graph_m_getNAC, henshin_Graph_m_isNestedCondition, henshin_Graph_m_removeEdge, henshin_Graph_m_getRule, henshin_Graph_m_getPACs, henshin_Graph_m_getPAC, henshin_Graph_m_isRhs, henshin_Graph_m_getNodes, henshin_Graph_m_getNode, henshin_Graph_m_removeNode, henshin_Graph_m_removeNestedCondition, henshin_Graph_m_isLhs, henshin_Graph_m_createPAC, henshin_Graph_m_getNACs}
...
henshin_Node_m_getOutgoing: Method = Method(name="getOutgoing", parameters={Parameter(name='henshin_type', type=StringType), Parameter(name='henshin_target', type=StringType)}, type=StringType)
henshin_Node_m_getIncoming: Method = Method(name="getIncoming", parameters={Parameter(name='henshin_source', type=StringType), Parameter(name='henshin_type', type=StringType)}, type=StringType)
...
henshin_Node_m_getActionAttributes: Method = Method(name="getActionAttributes", parameters={Parameter(name='henshin_action', type=StringType)}, type=StringType)
henshin_Node_m_getActionNode: Method = Method(name="getActionNode", parameters={}, type=StringType)
henshin_Node.methods={henshin_Node_m_getOutgoing, henshin_Node_m_getIncoming, henshin_Node_m_getActionAttributes, henshin_Node_m_getOutgoing, henshin_Node_m_getIncoming, henshin_Node_m_getAttribute, henshin_Node_m_getAllEdges, henshin_Node_m_getActionNode}
...
henshin_Attribute.attributes={henshin_Attribute_value, henshin_Attribute_constant, henshin_Attribute_null}
...
henshin_NestedCondition.methods={henshin_NestedCondition_m_isNAC, henshin_NestedCondition_m_isPAC, henshin_NestedCondition_m_getHost}
...
domain_model = DomainModel(
    name="henshin",
    types={henshin_NamedElement, henshin_GraphElement, henshin_ParameterMapping, henshin_Rule, Unit, henshin_Module, NamedElement, henshin_EPackage, henshin_Unit, henshin_Graph, henshin_Parameter, henshin_AttributeCondition, henshin_Mapping, henshin_Node, henshin_Edge, henshin_Formula, GraphElement, henshin_EClassifier, henshin_EAttribute, henshin_EClass, henshin_Attribute, henshin_EReference, henshin_NestedCondition, Formula, henshin_UnaryUnit, henshin_MultiUnit, henshin_IndependentUnit, MultiUnit, henshin_SequentialUnit, henshin_ConditionalUnit, henshin_PriorityUnit, henshin_IteratedUnit, UnaryUnit, henshin_LoopUnit, henshin_UnaryFormula, henshin_BinaryFormula, henshin_And, BinaryFormula, henshin_Or, henshin_Xor, henshin_Not, UnaryFormula, henshin_True},
    associations={parameterMappings11, subModules1, superModule3, imports5, units6, instances8, parameters10, multiRules22, multiMappings24, lhs13, rhs15, attributeConditions18, mappings19, nodes35, edges36, formula38, unit27, type28, source29, target32, type54, node55, type40, attributes41, graph42, incoming43, outgoing45, source47, target49, type51, graph52, conclusion76, mappings78, rule57, origin58, image61, subUnit64, subUnits66, if_68, then70, else_73, child81, left83, right85},
    generalizations={gen_henshin_Rule_Unit, gen_henshin_Module_NamedElement, gen_henshin_Unit_NamedElement, gen_henshin_Parameter_NamedElement, gen_henshin_Node_NamedElement, gen_henshin_Node_GraphElement, gen_henshin_Graph_NamedElement, gen_henshin_Attribute_GraphElement, gen_henshin_Edge_GraphElement, gen_henshin_LoopUnit_UnaryUnit, gen_henshin_NestedCondition_Formula, gen_henshin_AttributeCondition_NamedElement, gen_henshin_UnaryUnit_Unit, gen_henshin_MultiUnit_Unit, gen_henshin_IndependentUnit_MultiUnit, gen_henshin_SequentialUnit_MultiUnit, gen_henshin_ConditionalUnit_Unit, gen_henshin_PriorityUnit_MultiUnit, gen_henshin_IteratedUnit_UnaryUnit, gen_henshin_UnaryFormula_Formula, gen_henshin_BinaryFormula_Formula, gen_henshin_And_BinaryFormula, gen_henshin_Or_BinaryFormula, gen_henshin_Xor_BinaryFormula, gen_henshin_Not_UnaryFormula, gen_henshin_True_Formula},
    metadata=None
)
