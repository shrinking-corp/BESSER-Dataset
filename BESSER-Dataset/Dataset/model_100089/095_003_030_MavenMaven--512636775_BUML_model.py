...
AntTaskDef = Class(name="AntTaskDef")
...
Xmlns = Class(name="Xmlns")
MavenMaven_JellyForEach = Class(name="MavenMaven_JellyForEach")
...
PreGoal = Class(name="PreGoal")
PostGoal = Class(name="PostGoal")
...
# AntTaskDef class attributes and methods
...
# Xmlns class attributes and methods

# MavenMaven_JellyForEach class attributes and methods
MavenMaven_JellyForEach_items: Property = Property(name="items", type=StringType)
MavenMaven_JellyForEach_var: Property = Property(name="var", type=StringType)
MavenMaven_JellyForEach_indexVar: Property = Property(name="indexVar", type=StringType)
MavenMaven_JellyForEach.attributes={MavenMaven_JellyForEach_indexVar, MavenMaven_JellyForEach_items, MavenMaven_JellyForEach_var}
...
MavenMaven_JellySet.attributes={MavenMaven_JellySet_value, MavenMaven_JellySet_var}
...
MavenMaven_Mapper.attributes={MavenMaven_Mapper_to, MavenMaven_Mapper_classpath, MavenMaven_Mapper_type, MavenMaven_Mapper_from_, MavenMaven_Mapper_classpathref, MavenMaven_Mapper_classname}
...
MavenMaven_InExcludes.attributes={MavenMaven_InExcludes_ifCondition, MavenMaven_InExcludes_unless, MavenMaven_InExcludes_name}
...
MavenMaven_FileList.attributes={MavenMaven_FileList_files, MavenMaven_FileList_dir}
...
# PreGoal class attributes and methods

# PostGoal class attributes and methods
...
MavenMaven_Filter.attributes={MavenMaven_Filter_token, MavenMaven_Filter_value}
...
MavenMaven_PathElement.attributes={MavenMaven_PathElement_path, MavenMaven_PathElement_location}
...
MavenMaven_Path.attributes={MavenMaven_Path_id, MavenMaven_Path_refid}
...
MavenMaven_Attribut.attributes={MavenMaven_Attribut_value, MavenMaven_Attribut_name}
...
MavenMaven_PreDefinedTask.attributes={MavenMaven_PreDefinedTask_description, MavenMaven_PreDefinedTask_id, MavenMaven_PreDefinedTask_taskname}
...
MavenMaven_AntTaskDef.attributes={MavenMaven_AntTaskDef_classname, MavenMaven_AntTaskDef_name}
...
MavenMaven_Exec.attributes={MavenMaven_Exec_dir, MavenMaven_Exec_executable}
...
MavenMaven_Java.attributes={MavenMaven_Java_classname, MavenMaven_Java_jar, MavenMaven_Java_fork}
...
MavenMaven_Javac.attributes={MavenMaven_Javac_debug, MavenMaven_Javac_destdir, MavenMaven_Javac_fork, MavenMaven_Javac_deprecation, MavenMaven_Javac_optimize, MavenMaven_Javac_srcdir}
...
MavenMaven_FormatTstamp.attributes={MavenMaven_FormatTstamp_offset, MavenMaven_FormatTstamp_property, MavenMaven_FormatTstamp_unit, MavenMaven_FormatTstamp_locale, MavenMaven_FormatTstamp_pattern}
...
MavenMaven_Jar.attributes={MavenMaven_Jar_jarfile, MavenMaven_Jar_basedir, MavenMaven_Jar_encoding, MavenMaven_Jar_compress, MavenMaven_Jar_manifest}
...
MavenMaven_Javadoc.attributes={MavenMaven_Javadoc_defaultexcludes, MavenMaven_Javadoc_version, MavenMaven_Javadoc_use, MavenMaven_Javadoc_windowtitle, MavenMaven_Javadoc_destdir, MavenMaven_Javadoc_author, MavenMaven_Javadoc_packagenames, MavenMaven_Javadoc_sourcepath}
...
MavenMaven_Delete.attributes={MavenMaven_Delete_defaultexcludes, MavenMaven_Delete_excludesfile, MavenMaven_Delete_includesfile, MavenMaven_Delete_dir, MavenMaven_Delete_file, MavenMaven_Delete_failonerror, MavenMaven_Delete_quiet, MavenMaven_Delete_excludes, MavenMaven_Delete_includeEmptyDirs, MavenMaven_Delete_includes, MavenMaven_Delete_verbose}
...
MavenMaven_Copy.attributes={MavenMaven_Copy_overwrite, MavenMaven_Copy_file, MavenMaven_Copy_todir, MavenMaven_Copy_presservelastmodified, MavenMaven_Copy_tofile, MavenMaven_Copy_includeEmptyDirs, MavenMaven_Copy_flatten, MavenMaven_Copy_filtering}

# Relationships
default1: BinaryAssociation = BinaryAssociation(
    name="default1",
    ends={
        Property(name="Goal", type=MavenMaven_Project, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_Project2", type=Goal, multiplicity=Multiplicity(0, 1))
    }
)
path3: BinaryAssociation = BinaryAssociation(
    name="path3",
    ends={
        Property(name="Path", type=MavenMaven_Project, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_Project4", type=Path, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
properties5: BinaryAssociation = BinaryAssociation(
    name="properties5",
    ends={
        Property(name="AntProperty", type=MavenMaven_Project, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_Project6", type=AntProperty, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
taskdefs7: BinaryAssociation = BinaryAssociation(
    name="taskdefs7",
    ends={
        Property(name="AntTaskDef", type=MavenMaven_Project, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_Project8", type=AntTaskDef, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
prePostGoals9: BinaryAssociation = BinaryAssociation(
    name="prePostGoals9",
    ends={
        Property(name="PrePostGoal", type=MavenMaven_Project, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_Project10", type=PrePostGoal, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
goals11: BinaryAssociation = BinaryAssociation(
    name="goals11",
    ends={
        Property(name="Goal13", type=MavenMaven_Project, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_Project12", type=Goal, multiplicity=Multiplicity(1, 9999), is_composite=True)
    }
)
xmlns0: BinaryAssociation = BinaryAssociation(
    name="xmlns0",
    ends={
        Property(name="Xmlns", type=MavenMaven_Project, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_Project", type=Xmlns, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
contents14: BinaryAssociation = BinaryAssociation(
    name="contents14",
    ends={
        Property(name="ContentsGoal", type=MavenMaven_JellyForEach, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_JellyForEach", type=ContentsGoal, multiplicity=Multiplicity(1, 1), is_composite=True)
    }
)
contentsGoal15: BinaryAssociation = BinaryAssociation(
    name="contentsGoal15",
    ends={
        Property(name="ContentsGoal16", type=MavenMaven_AbstractGoal, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_AbstractGoal", type=ContentsGoal, multiplicity=Multiplicity(1, 9999), is_composite=True)
    }
)
attainGoal17: BinaryAssociation = BinaryAssociation(
    name="attainGoal17",
    ends={
        Property(name="Goal18", type=MavenMaven_AttainGoal, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_AttainGoal", type=Goal, multiplicity=Multiplicity(1, 1))
    }
)
centralGoal19: BinaryAssociation = BinaryAssociation(
    name="centralGoal19",
    ends={
        Property(name="Goal20", type=MavenMaven_PreGoal, multiplicity=Multiplicity(1, 1)),
        Property(name="preGoal", type=Goal, multiplicity=Multiplicity(1, 1))
    }
)
centralGoal21: BinaryAssociation = BinaryAssociation(
    name="centralGoal21",
    ends={
        Property(name="Goal22", type=MavenMaven_PostGoal, multiplicity=Multiplicity(1, 1)),
        Property(name="postGoal", type=Goal, multiplicity=Multiplicity(1, 1))
    }
)
preGoal23: BinaryAssociation = BinaryAssociation(
    name="preGoal23",
    ends={
        Property(name="PreGoal", type=MavenMaven_Goal, multiplicity=Multiplicity(1, 1)),
        Property(name="centralGoal", type=PreGoal, multiplicity=Multiplicity(0, 1))
    }
)
postGoal24: BinaryAssociation = BinaryAssociation(
    name="postGoal24",
    ends={
        Property(name="PostGoal", type=MavenMaven_Goal, multiplicity=Multiplicity(1, 1)),
        Property(name="centralGoal25", type=PostGoal, multiplicity=Multiplicity(0, 1))
    }
)
inexcludes26: BinaryAssociation = BinaryAssociation(
    name="inexcludes26",
    ends={
        Property(name="InExcludes", type=MavenMaven_PatternSet, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_PatternSet", type=InExcludes, multiplicity=Multiplicity(1, 9999), is_composite=True)
    }
)
patternset27: BinaryAssociation = BinaryAssociation(
    name="patternset27",
    ends={
        Property(name="PatternSet", type=MavenMaven_FileSet, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_FileSet", type=PatternSet, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
include28: BinaryAssociation = BinaryAssociation(
    name="include28",
    ends={
        Property(name="Includes", type=MavenMaven_FileSet, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_FileSet29", type=Includes, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
exclude30: BinaryAssociation = BinaryAssociation(
    name="exclude30",
    ends={
        Property(name="Excludes", type=MavenMaven_FileSet, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_FileSet31", type=Excludes, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
path35: BinaryAssociation = BinaryAssociation(
    name="path35",
    ends={
        Property(name="Path36", type=MavenMaven_Path, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_Path", type=Path, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
pathElement37: BinaryAssociation = BinaryAssociation(
    name="pathElement37",
    ends={
        Property(name="PathElement", type=MavenMaven_Path, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_Path38", type=PathElement, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
fileset39: BinaryAssociation = BinaryAssociation(
    name="fileset39",
    ends={
        Property(name="FileSet", type=MavenMaven_Path, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_Path40", type=FileSet, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
pathElement41: BinaryAssociation = BinaryAssociation(
    name="pathElement41",
    ends={
        Property(name="PathElement42", type=MavenMaven_ClassPath, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_ClassPath", type=PathElement, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
fileset43: BinaryAssociation = BinaryAssociation(
    name="fileset43",
    ends={
        Property(name="FileSet45", type=MavenMaven_ClassPath, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_ClassPath44", type=FileSet, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
filter32: BinaryAssociation = BinaryAssociation(
    name="filter32",
    ends={
        Property(name="Filter", type=MavenMaven_FilterSet, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_FilterSet", type=Filter, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
filtersfile33: BinaryAssociation = BinaryAssociation(
    name="filtersfile33",
    ends={
        Property(name="FiltersFile", type=MavenMaven_FilterSet, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_FilterSet34", type=FiltersFile, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
taskName46: BinaryAssociation = BinaryAssociation(
    name="taskName46",
    ends={
        Property(name="AntTaskDef47", type=MavenMaven_NewTask, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_NewTask", type=AntTaskDef, multiplicity=Multiplicity(1, 1))
    }
)
attributes48: BinaryAssociation = BinaryAssociation(
    name="attributes48",
    ends={
        Property(name="Attribut", type=MavenMaven_NewTask, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_NewTask49", type=Attribut, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
classPath50: BinaryAssociation = BinaryAssociation(
    name="classPath50",
    ends={
        Property(name="ClassPath", type=MavenMaven_Java, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_Java", type=ClassPath, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
format51: BinaryAssociation = BinaryAssociation(
    name="format51",
    ends={
        Property(name="FormatTstamp", type=MavenMaven_Tstamp, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_Tstamp", type=FormatTstamp, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
inExcludes52: BinaryAssociation = BinaryAssociation(
    name="inExcludes52",
    ends={
        Property(name="InExcludes53", type=MavenMaven_Javac, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_Javac", type=InExcludes, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
classPath54: BinaryAssociation = BinaryAssociation(
    name="classPath54",
    ends={
        Property(name="ClassPath56", type=MavenMaven_Javac, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_Javac55", type=ClassPath, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
fileset57: BinaryAssociation = BinaryAssociation(
    name="fileset57",
    ends={
        Property(name="FileSet58", type=MavenMaven_Copy, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_Copy", type=FileSet, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
filterset59: BinaryAssociation = BinaryAssociation(
    name="filterset59",
    ends={
        Property(name="FilterSet", type=MavenMaven_Copy, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_Copy60", type=FilterSet, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
mapper61: BinaryAssociation = BinaryAssociation(
    name="mapper61",
    ends={
        Property(name="Mapper", type=MavenMaven_Copy, multiplicity=Multiplicity(1, 1)),
        Property(name="MavenMaven_Copy62", type=Mapper, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
...
gen_MavenMaven_JellyForEach_JellyCommand = Generalization(general=JellyCommand, specific=MavenMaven_JellyForEach)
...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={Path, AntProperty, AntTaskDef, PrePostGoal, MavenMaven_Xmlns, MavenMaven_AntProperty, ContentsGoal, MavenMaven_AntPropertyName, MavenMaven_AntPropertyValue, AntPropertyName, MavenMaven_Project, Xmlns, MavenMaven_JellyForEach, Goal, MavenMaven_AbstractGoal, MavenMaven_ContentsGoal, MavenMaven_AttainGoal, MavenMaven_PrePostGoal, AbstractGoal, MavenMaven_PreGoal, MavenMaven_AntPropertyLocation, MavenMaven_AntPropertyFile, MavenMaven_AntPropertyEnv, MavenMaven_JellyCommand, MavenMaven_JellySet, JellyCommand, MavenMaven_Basic, Pattern, MavenMaven_Mapper, Basic, MavenMaven_InExcludes, MavenMaven_Includes, InExcludes, MavenMaven_Excludes, MavenMaven_IncludesFile, MavenMaven_ExcludesFile, MavenMaven_FileList, MavenMaven_PostGoal, MavenMaven_Goal, PreGoal, PostGoal, MavenMaven_Pattern, MavenMaven_FileSet, PatternSet, Includes, Excludes, MavenMaven_FilterSet, MavenMaven_Filter, MavenMaven_FiltersFile, MavenMaven_PathElement, MavenMaven_Set, MavenMaven_PatternSet, Set, PathElement, FileSet, MavenMaven_ClassPath, Filter, FiltersFile, MavenMaven_Path, Task, Attribut, MavenMaven_Attribut, MavenMaven_PreDefinedTask, MavenMaven_ExecutionTask, PreDefinedTask, MavenMaven_Task, MavenMaven_AntTaskDef, MavenMaven_NewTask, ClassPath, MavenMaven_MiscellaneousTask, MavenMaven_Echo, MiscellaneousTask, MavenMaven_Tstamp, FormatTstamp, MavenMaven_Exec, ExecutionTask, MavenMaven_Java, MavenMaven_Javac, CompileTask, MavenMaven_DocumentationTask, MavenMaven_FormatTstamp, MavenMaven_CompileTask, MavenMaven_ArchiveTask, MavenMaven_Jar, ArchiveTask, MavenMaven_FileTask, MavenMaven_Javadoc, DocumentationTask, FilterSet, Mapper, MavenMaven_Delete, MavenMaven_Mkdir, FileTask, MavenMaven_Copy},
    associations={default1, path3, properties5, taskdefs7, prePostGoals9, goals11, xmlns0, contents14, contentsGoal15, attainGoal17, centralGoal19, centralGoal21, preGoal23, postGoal24, inexcludes26, patternset27, include28, exclude30, path35, pathElement37, fileset39, pathElement41, fileset43, filter32, filtersfile33, taskName46, attributes48, classPath50, format51, inExcludes52, classPath54, fileset57, filterset59, mapper61},
    generalizations={gen_MavenMaven_AntProperty_ContentsGoal, gen_MavenMaven_AntPropertyName_AntProperty, gen_MavenMaven_AntPropertyValue_AntPropertyName, gen_MavenMaven_JellyForEach_JellyCommand, gen_MavenMaven_AttainGoal_ContentsGoal, gen_MavenMaven_PrePostGoal_AbstractGoal, gen_MavenMaven_PreGoal_PrePostGoal, gen_MavenMaven_AntPropertyLocation_AntPropertyName, gen_MavenMaven_AntPropertyFile_AntProperty, gen_MavenMaven_AntPropertyEnv_AntProperty, gen_MavenMaven_JellyCommand_ContentsGoal, gen_MavenMaven_JellySet_JellyCommand, gen_MavenMaven_Basic_Pattern, gen_MavenMaven_Mapper_Basic, gen_MavenMaven_InExcludes_Basic, gen_MavenMaven_Includes_InExcludes, gen_MavenMaven_Excludes_InExcludes, gen_MavenMaven_IncludesFile_InExcludes, gen_MavenMaven_ExcludesFile_InExcludes, gen_MavenMaven_FileList_Basic, gen_MavenMaven_PostGoal_PrePostGoal, gen_MavenMaven_Goal_AbstractGoal, gen_MavenMaven_FileSet_Set, gen_MavenMaven_FilterSet_Set, gen_MavenMaven_Filter_Basic, gen_MavenMaven_FiltersFile_Basic, gen_MavenMaven_PathElement_Basic, gen_MavenMaven_Set_Pattern, gen_MavenMaven_PatternSet_Set, gen_MavenMaven_ClassPath_Set, gen_MavenMaven_Path_Set, gen_MavenMaven_NewTask_Task, gen_MavenMaven_PreDefinedTask_Task, gen_MavenMaven_Task_ContentsGoal, gen_MavenMaven_AntTaskDef_ContentsGoal, gen_MavenMaven_MiscellaneousTask_PreDefinedTask, gen_MavenMaven_Echo_MiscellaneousTask, gen_MavenMaven_Tstamp_MiscellaneousTask, gen_MavenMaven_ExecutionTask_PreDefinedTask, gen_MavenMaven_Exec_ExecutionTask, gen_MavenMaven_Java_ExecutionTask, gen_MavenMaven_CompileTask_PreDefinedTask, gen_MavenMaven_Javac_CompileTask, gen_MavenMaven_DocumentationTask_PreDefinedTask, gen_MavenMaven_ArchiveTask_PreDefinedTask, gen_MavenMaven_Jar_ArchiveTask, gen_MavenMaven_Javadoc_DocumentationTask, gen_MavenMaven_Delete_FileTask, gen_MavenMaven_FileTask_PreDefinedTask, gen_MavenMaven_Mkdir_FileTask, gen_MavenMaven_Copy_FileTask},
    metadata=None
)
