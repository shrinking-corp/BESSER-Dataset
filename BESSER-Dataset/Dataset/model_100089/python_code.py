...
class MavenMaven_Copy(FileTask):
    ...
    def __init__(self, tofile: str, todir: str, overwrite: str, filtering: str, flatten: str, includeEmptyDirs: str, file: str, presservelastmodified: str, MavenMaven_Copy: "FileSet" = None, MavenMaven_Copy60: "FilterSet" = None, MavenMaven_Copy62: "Mapper" = None):
        self.tofile = tofile
        self.todir = todir
...
class MavenMaven_Delete(FileTask):
    ...
    def __init__(self, includesfile: str, excludes: str, excludesfile: str, defaultexcludes: str, file: str, dir: str, verbose: str, quiet: str, failonerror: str, includeEmptyDirs: str, includes: str):
...
class MavenMaven_Javadoc(DocumentationTask):
    ...
    def __init__(self, author: str, version: str, use: str, windowtitle: str, sourcepath: str, destdir: str, packagenames: str, defaultexcludes: str):
        self.author = author
...
class MavenMaven_Javac(CompileTask):
    ...
    def __init__(self, srcdir: str, destdir: str, debug: str, fork: str, optimize: str, deprecation: str, MavenMaven_Javac: set["InExcludes"] = None, MavenMaven_Javac55: "ClassPath" = None):
        self.srcdir = srcdir
        self.destdir = destdir
        self.debug = debug
        self.fork = fork
...
class MavenMaven_Java(ExecutionTask):
    ...
    def __init__(self, jar: str, fork: str, classname: str, MavenMaven_Java: "ClassPath" = None):
        self.jar = jar
        self.fork = fork
...
class MavenMaven_ClassPath(Set):
    ...
    def __init__(self, refid: str, MavenMaven_ClassPath44: set["FileSet"] = None, MavenMaven_ClassPath: set["PathElement"] = None):
        self.refid = refid
...
class MavenMaven_FilterSet(Set):
    ...
    def __init__(self, starttoken: str, endtoken: str, MavenMaven_FilterSet: set["Filter"] = None, MavenMaven_FilterSet34: set["FiltersFile"] = None):
