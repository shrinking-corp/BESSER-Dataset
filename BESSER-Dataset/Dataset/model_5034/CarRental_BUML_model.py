...
# Classes
CarRentalModel_VipCustomer = Class(name="CarRentalModel_VipCustomer")
Customer = Class(name="Customer")
CarRentalModel_CarRental = Class(name="CarRentalModel_CarRental")
CarRentalModel_Customer = Class(name="CarRentalModel_Customer")
CarRentalModel_Agency = Class(name="CarRentalModel_Agency")
CarRentalModel_Craft = Class(name="CarRentalModel_Craft", is_abstract=True)
CarRentalModel_Order = Class(name="CarRentalModel_Order")
CarRentalModel_Motorcycle = Class(name="CarRentalModel_Motorcycle")
Craft = Class(name="Craft")
CarRentalModel_Automobile = Class(name="CarRentalModel_Automobile")
...
CarRentalModel_Customer.attributes={CarRentalModel_Customer_surname, CarRentalModel_Customer_identifier, CarRentalModel_Customer_lastname}
...
CarRentalModel_Craft.attributes={CarRentalModel_Craft_vin, CarRentalModel_Craft_charge, CarRentalModel_Craft_licenseNo}
...
CarRentalModel_Order.attributes={CarRentalModel_Order_orderDate, CarRentalModel_Order_price}
...
domain_model = DomainModel(
    name="CarRentalModel",
    types={CarRentalModel_VipCustomer, Customer, CarRentalModel_CarRental, CarRentalModel_Customer, CarRentalModel_Agency, CarRentalModel_Craft, CarRentalModel_Order, CarRentalModel_Motorcycle, Craft, CarRentalModel_Automobile},
    associations={craft9, customer10, rentBy11, customer0, agencies1, crafts3, mainAgency5, bestellungen8},
