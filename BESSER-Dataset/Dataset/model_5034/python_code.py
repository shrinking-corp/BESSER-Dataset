...
class CarRentalModel_Craft(ABC):
    ...
    def __init__(self, vin: int, charge: float, licenseNo: str, craft: set["CarRentalModel_Order"] = None, CarRentalModel_Craft: "CarRentalModel_CarRental" = None, Craft: "CarRentalModel_Order" = None):
        self.vin = vin
        self.charge = charge
