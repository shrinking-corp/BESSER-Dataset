...
# Classes
anol3l4_X = Class(name="anol3l4_X")
anol3l4_C = Class(name="anol3l4_C", is_abstract=True)
anol3l4_P = Class(name="anol3l4_P")
anol3l4_M = Class(name="anol3l4_M")
anol3l4_L1 = Class(name="anol3l4_L1")
anol3l4_N = Class(name="anol3l4_N")
M = Class(name="M")
anol3l4_J = Class(name="anol3l4_J")
A = Class(name="A")
N = Class(name="N")
anol3l4_K = Class(name="anol3l4_K")
anol3l4_Q = Class(name="anol3l4_Q")
P = Class(name="P")
anol3l4_Z = Class(name="anol3l4_Z")
anol3l4_Y = Class(name="anol3l4_Y")
anol3l4_W = Class(name="anol3l4_W")
anol3l4_A = Class(name="anol3l4_A")
B = Class(name="B")
anol3l4_B = Class(name="anol3l4_B")
C = Class(name="C")
anol3l4_I = Class(name="anol3l4_I")
G = Class(name="G")
anol3l4_G = Class(name="anol3l4_G", is_abstract=True)
anol3l4_L3 = Class(name="anol3l4_L3")
L1 = Class(name="L1")
anol3l4_L4 = Class(name="anol3l4_L4")
anol3l4_L2 = Class(name="anol3l4_L2")
J = Class(name="J")
...
anol3l4_L1.attributes={anol3l4_L1_id2, anol3l4_L1_id1}
...
anol3l4_Z.attributes={anol3l4_Z_z2, anol3l4_Z_z3, anol3l4_Z_z1}
...
anol3l4_L2.attributes={anol3l4_L2_l1, anol3l4_L2_l2}
...
is_9: BinaryAssociation = BinaryAssociation(
    name="is_9",
    ends={
...
domain_model = DomainModel(
    name="anol3l4",
    types={anol3l4_X, anol3l4_C, anol3l4_P, anol3l4_M, anol3l4_L1, anol3l4_N, M, anol3l4_J, A, N, anol3l4_K, anol3l4_Q, P, anol3l4_Z, anol3l4_Y, anol3l4_W, anol3l4_A, B, anol3l4_B, C, anol3l4_I, G, anol3l4_G, anol3l4_L3, L1, anol3l4_L4, anol3l4_L2, J},
    associations={xcs0, ps1, mcs10, ml112, a14, ks16, js18, zs3, ys5, w7, is_9, l2q27, l2k30, l3i33, l4z35, l2s20, l1c21, l1m24},
    generalizations={gen_anol3l4_M_G, gen_anol3l4_N_M, gen_anol3l4_J_A, gen_anol3l4_P_N, gen_anol3l4_Q_P, gen_anol3l4_A_B, gen_anol3l4_B_C, gen_anol3l4_C_G, gen_anol3l4_L3_L1, gen_anol3l4_L4_L1, gen_anol3l4_I_G, gen_anol3l4_K_J},
    metadata=None
)
