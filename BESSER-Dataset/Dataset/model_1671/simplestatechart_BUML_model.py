...
domain_model = DomainModel(
    ...
    types={simplestatechart_Thing, NamedElement, simplestatechart_RelatedTo, simplestatechart_NamedElement, simplestatechart_Variable, Thing, simplestatechart_Transition, simplestatechart_State},
    associations={relations0, fromThing1, toThing2, parentstate11, variables13, transitions15, source3, target4, substates8},
    generalizations={gen_simplestatechart_Thing_NamedElement, gen_simplestatechart_RelatedTo_NamedElement, gen_simplestatechart_Variable_Thing, gen_simplestatechart_Transition_NamedElement, gen_simplestatechart_State_NamedElement},
    metadata=None
)
