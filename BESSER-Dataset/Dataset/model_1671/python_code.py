...
class simplestatechart_State(NamedElement):
    ...
    def __init__(self, label: str, type: str, activity: str, simplestatechart_State12: "simplestatechart_State" = None, simplestatechart_State10: "simplestatechart_State" = None, simplestatechart_State14: set["simplestatechart_Variable"] = None, simplestatechart_State16: set["simplestatechart_Transition"] = None, simplestatechart_State: "simplestatechart_Transition" = None, simplestatechart_State6: "simplestatechart_Transition" = None, simplestatechart_State9: "simplestatechart_State" = None, simplestatechart_State7: set["simplestatechart_State"] = None):
        self.label = label
        self.type = type
...
class simplestatechart_Transition(NamedElement):
    ...
    def __init__(self, expression: str, simplestatechart_Transition17: "simplestatechart_State" = None, simplestatechart_Transition: "simplestatechart_State" = None, simplestatechart_Transition5: "simplestatechart_State" = None):
...
class simplestatechart_RelatedTo(NamedElement):
    ...
    def __init__(self, since: str, RelatedTo: "simplestatechart_Thing" = None, relations: "simplestatechart_Thing" = None, simplestatechart_RelatedTo: "simplestatechart_Thing" = None):
        self.since = since
...
class simplestatechart_Thing(NamedElement):
    ...
    def __init__(self, id: int, fromThing: set["simplestatechart_RelatedTo"] = None, Thing: "simplestatechart_RelatedTo" = None, simplestatechart_Thing: "simplestatechart_RelatedTo" = None):
        self.id = id
