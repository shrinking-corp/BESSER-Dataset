...
domain_model = DomainModel(
    name="core",
    types={core_COREModel, CORENamedElement, core_COREReuse, core_COREFeature, core_COREImpactModel, COREModel, core_COREConcern, core_COREInterface, COREModelElement, core_COREStrategy, core_COREConfiguration, core_COREBinding, CORECompositionSpecification, core_COREMapping, core_CORECompositionSpecification, core_CORENamedElement, core_COREModelElement, core_COREPattern, core_COREFeatureModel, core_COREImpactModelElement},
    associations={reuses0, realizes3, models4, interface6, realizedBy8, strategies9, configurations10, coreMappings12, source13, mappedTo15, mappedFrom18, configurations21, selectable24, customizable27, modelElements1, reusedConcern35, compositions38, selected41, reusedConcern44, selected47, usable30, impacted33},
