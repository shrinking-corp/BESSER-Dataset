...
public class core_COREInterface  {
    ...
    public core_COREInterface(
        ArrayList<core_COREModelElement> core_coremodelelements,        ArrayList<core_COREModelElement> core_coremodelelements,        ArrayList<core_COREFeature> core_corefeatures    ) {
