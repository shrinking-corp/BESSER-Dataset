...
class javaz_Field(JavaElement):
    ...
    def __init__(self, visibility: str, static: bool, transient: bool, volatile: bool, final: bool, type: str, javaz_Field: "javaz_JavaClass" = None):
        self.visibility = visibility
        self.static = static
