...
Applicant.attributes={Applicant_First_Name, Applicant_Phone, Applicant_Email, Applicant_Date_of_Birth, Applicant_Address, Applicant_Applied_Position, Applicant_Last_Name, Applicant_Password}
...
Registration.attributes={Registration_Email, Registration_Phone, Registration_Date, Registration_Applied_Position, Registration_Position_Type, Registration_Skills___Requirement, Registration_Name, Registration_Address}
...
Position.attributes={Position_divisionName, Position_positionID, Position_jobID, Position_positionName}
...
Requirement.attributes={Requirement_Photo, Requirement_Curriculum_Vitae, Requirement_Diploma, Requirement_ID_Card, Requirement_Transcript}
...
New_Employee.attributes={New_Employee_Place_of_Birth, New_Employee_Date_of_Birth, New_Employee_Position, New_Employee_Name, New_Employee_Division, New_Employee_Working_Since}
...
Performance.attributes={Performance_Punctuality, Performance_Name, Performance_Target, Performance_Coordination}
...
domain_model = DomainModel(
    name="dedd736b_04aa_4234_b3d9_08ae9bbdad9b",
