...
# Classes
fsmkerm_Transition = Class(name="fsmkerm_Transition")
fsmkerm_FSM = Class(name="fsmkerm_FSM")
fsmkerm_State = Class(name="fsmkerm_State")
fsmkerm_FSMException = Class(name="fsmkerm_FSMException")
fsmkerm_NonDeterminism = Class(name="fsmkerm_NonDeterminism")
FSMException = Class(name="FSMException")
fsmkerm_NoTransition = Class(name="fsmkerm_NoTransition")
fsmkerm_NoInitialStateException = Class(name="fsmkerm_NoInitialStateException")
...
fsmkerm_Transition.attributes={fsmkerm_Transition_output, fsmkerm_Transition_input}
...
fsmkerm_FSM.methods={fsmkerm_FSM_m_reset, fsmkerm_FSM_m_run}

# fsmkerm_State class attributes and methods
fsmkerm_State_name: Property = Property(name="name", type=StringType)
fsmkerm_State_m_step: Method = Method(name="step", parameters={Parameter(name='fsmkerm_c', type=StringType)})
...
domain_model = DomainModel(
    name="fsmkerm",
    types={fsmkerm_Transition, fsmkerm_FSM, fsmkerm_State, fsmkerm_FSMException, fsmkerm_NonDeterminism, FSMException, fsmkerm_NoTransition, fsmkerm_NoInitialStateException},
    associations={finalState5, ownedState0, initialState1, currentState2, transition8, fsmException10, owningFSM12, outgoingTransition13, incomingTransition14, source16, target18},
