...
class fsmkerm_State:
    ...
    def __init__(self, name: str, source: set["fsmkerm_Transition"] = None, target: set["fsmkerm_Transition"] = None, State17: "fsmkerm_Transition" = None, State19: "fsmkerm_Transition" = None, fsmkerm_State7: "fsmkerm_FSM" = None, State: "fsmkerm_FSM" = None, fsmkerm_State: "fsmkerm_FSM" = None, fsmkerm_State4: "fsmkerm_FSM" = None, ownedState: "fsmkerm_FSM" = None):
        self.name = name
    ...
    def step(self, fsmkerm_c):
        # TODO: Implement step method
        pass

class fsmkerm_FSM:

    def __init__(self, fsmkerm_FSM6: set["fsmkerm_State"] = None, owningFSM: set["fsmkerm_State"] = None, fsmkerm_FSM: "fsmkerm_State" = None, fsmkerm_FSM3: "fsmkerm_State" = None, fsmkerm_FSM9: set["fsmkerm_Transition"] = None, fsmkerm_FSM11: "fsmkerm_FSMException" = None, FSM: "fsmkerm_State" = None):
...
class fsmkerm_Transition:
    ...
    def __init__(self, output: str, input: str, Transition: "fsmkerm_State" = None, Transition15: "fsmkerm_State" = None, outgoingTransition: "fsmkerm_State" = None, incomingTransition: "fsmkerm_State" = None, fsmkerm_Transition: "fsmkerm_FSM" = None):
        self.output = output
        self.input = input
