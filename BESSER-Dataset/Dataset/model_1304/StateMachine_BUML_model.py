...
# Classes
SimplStateMachine_StateMachine = Class(name="SimplStateMachine_StateMachine")
CompositeState = Class(name="CompositeState")
SimplStateMachine_State = Class(name="SimplStateMachine_State")
SimplStateMachine_CompositeState = Class(name="SimplStateMachine_CompositeState")
SimplStateMachine_Operation = Class(name="SimplStateMachine_Operation")
State = Class(name="State")
SimplStateMachine_Transition = Class(name="SimplStateMachine_Transition")
SimplStateMachine_Event = Class(name="SimplStateMachine_Event")
SimplStateMachine_Variable = Class(name="SimplStateMachine_Variable", is_abstract=True)
SimplStateMachine_Expression = Class(name="SimplStateMachine_Expression")
SimplStateMachine_ExpressionElement = Class(name="SimplStateMachine_ExpressionElement", is_abstract=True)
ExpressionElement = Class(name="ExpressionElement")
SimplStateMachine_InitialState = Class(name="SimplStateMachine_InitialState")
SimplStateMachine_BooleanVariable = Class(name="SimplStateMachine_BooleanVariable")
Variable = Class(name="Variable")
SimplStateMachine_IntegerVariable = Class(name="SimplStateMachine_IntegerVariable")
SimplStateMachine_Assignment = Class(name="SimplStateMachine_Assignment")
SimplStateMachine_VariableReference = Class(name="SimplStateMachine_VariableReference")
SimplStateMachine_Data = Class(name="SimplStateMachine_Data", is_abstract=True)
SimplStateMachine_BooleanData = Class(name="SimplStateMachine_BooleanData")
Data = Class(name="Data")
SimplStateMachine_IntegerData = Class(name="SimplStateMachine_IntegerData")
...
domain_model = DomainModel(
    ...
    types={SimplStateMachine_StateMachine, CompositeState, SimplStateMachine_State, SimplStateMachine_CompositeState, SimplStateMachine_Operation, State, SimplStateMachine_Transition, SimplStateMachine_Event, SimplStateMachine_Variable, SimplStateMachine_Expression, SimplStateMachine_ExpressionElement, ExpressionElement, SimplStateMachine_InitialState, SimplStateMachine_BooleanVariable, Variable, SimplStateMachine_IntegerVariable, SimplStateMachine_Assignment, SimplStateMachine_VariableReference, SimplStateMachine_Data, SimplStateMachine_BooleanData, Data, SimplStateMachine_IntegerData, Operator},
    associations={container5, operation6, transitions0, events1, variables3, referencedState9, source12, target15, event18, guard21, left23, right25, states7, initialState8, value28, contents30, expression32, variable35, variable38},
    generalizations={gen_SimplStateMachine_StateMachine_CompositeState, gen_SimplStateMachine_CompositeState_State, gen_SimplStateMachine_Expression_ExpressionElement, gen_SimplStateMachine_BooleanVariable_Variable, gen_SimplStateMachine_IntegerVariable_Variable, gen_SimplStateMachine_VariableReference_ExpressionElement, gen_SimplStateMachine_Data_ExpressionElement, gen_SimplStateMachine_BooleanData_Data, gen_SimplStateMachine_IntegerData_Data},
    metadata=None
)
