...
class SimplStateMachine_State:
    ...
    def __init__(self, name: str, isActive: bool, SimplStateMachine_State: "SimplStateMachine_Operation" = None, SimplStateMachine_State11: "SimplStateMachine_InitialState" = None, SimplStateMachine_State14: "SimplStateMachine_Transition" = None, SimplStateMachine_State17: "SimplStateMachine_Transition" = None, State: "SimplStateMachine_CompositeState" = None, states: "SimplStateMachine_CompositeState" = None):
        self.name = name
