...
class minifsm_Transition:
    ...
    def __init__(self, event: str, minifsm_Transition: "minifsm_Machine" = None, Transition: "minifsm_State" = None, Transition5: "minifsm_State" = None, out: "minifsm_State" = None, in_: "minifsm_State" = None):
        self.event = event
    ...
    def in_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_minifsm_Transition__in_", None)
        self.__in_ = value
...
class minifsm_State:
    ...
    def __init__(self, name: str, minifsm_State: "minifsm_Machine" = None, src: set["minifsm_Transition"] = None, tgt: set["minifsm_Transition"] = None, State: "minifsm_Transition" = None, State8: "minifsm_Transition" = None):
        self.name = name
