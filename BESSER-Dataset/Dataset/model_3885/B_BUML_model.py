...
b_ConcreteVariables = Class(name="b_ConcreteVariables")
b_Invariant = Class(name="b_Invariant")
b_Initialisation = Class(name="b_Initialisation")
b_Assertions = Class(name="b_Assertions")
b_Sets = Class(name="b_Sets")
b_Implementation = Class(name="b_Implementation")
b_Imports = Class(name="b_Imports")
b_Values = Class(name="b_Values")
b_LocalOperations = Class(name="b_LocalOperations")
b_Abstraction = Class(name="b_Abstraction")
b_Sees = Class(name="b_Sees")
b_ConcreteConstants = Class(name="b_ConcreteConstants")
b_Definitions = Class(name="b_Definitions")
b_Properties = Class(name="b_Properties")
b_Operations = Class(name="b_Operations")
b_Machine = Class(name="b_Machine")
b_Type = Class(name="b_Type")
b_InitialisationExpr = Class(name="b_InitialisationExpr")
b_PropertyExpr = Class(name="b_PropertyExpr")
b_ValueExpr = Class(name="b_ValueExpr")
b_Variable = Class(name="b_Variable")
b_InvariantExpr = Class(name="b_InvariantExpr")
b_DefinitionCall = Class(name="b_DefinitionCall")
LogicalExpr = Class(name="LogicalExpr")
b_Arg = Class(name="b_Arg")
b_IntLiteral = Class(name="b_IntLiteral")
Condition = Class(name="Condition")
Arg = Class(name="Arg")
b_Set = Class(name="b_Set")
b_Range = Class(name="b_Range")
b_AssertionExpr = Class(name="b_AssertionExpr")
b_Definition = Class(name="b_Definition")
b_LogicalExpr = Class(name="b_LogicalExpr")
b_If = Class(name="b_If")
FinalExpr = Class(name="FinalExpr")
b_IfCond = Class(name="b_IfCond")
b_Condition = Class(name="b_Condition")
b_Pre = Class(name="b_Pre")
b_PreExpr = Class(name="b_PreExpr")
b_Operation = Class(name="b_Operation")
b_Body = Class(name="b_Body")
b_Expr = Class(name="b_Expr")
b_Skip = Class(name="b_Skip")
Body = Class(name="Body")
Expr = Class(name="Expr")
b_Statement = Class(name="b_Statement")
b_Case = Class(name="b_Case")
b_CaseExpr = Class(name="b_CaseExpr")
BeginBody = Class(name="BeginBody")
b_FinalExpr = Class(name="b_FinalExpr")
b_Call = Class(name="b_Call")
b_Var = Class(name="b_Var")
b_Seq = Class(name="b_Seq")
b_Begin = Class(name="b_Begin")
b_BeginBody = Class(name="b_BeginBody")
b_Assign = Class(name="b_Assign")
Statement = Class(name="Statement")
b_ReturnExpr = Class(name="b_ReturnExpr")
b_Return = Class(name="b_Return")
b_ReturnTypeExpr = Class(name="b_ReturnTypeExpr")
Return = Class(name="Return")
b_PropertyRange = Class(name="b_PropertyRange")
b_AndExpr = Class(name="b_AndExpr")
b_ImplyExpr = Class(name="b_ImplyExpr")
b_InequalityExpr = Class(name="b_InequalityExpr")
b_EqualExpr = Class(name="b_EqualExpr")
b_NegExpr = Class(name="b_NegExpr")
b_SimpleCall = Class(name="b_SimpleCall")
b_PrimitiveType = Class(name="b_PrimitiveType")
Type = Class(name="Type")
b_Ref = Class(name="b_Ref")
ReturnExpr = Class(name="ReturnExpr")
b_PropertyTyped = Class(name="b_PropertyTyped")
PropertyExpr = Class(name="PropertyExpr")
b_CondMinus = Class(name="b_CondMinus")
b_CondNeg = Class(name="b_CondNeg")
b_BoolLiteral = Class(name="b_BoolLiteral")
b_ReturnTuple = Class(name="b_ReturnTuple")
b_ReturnOr = Class(name="b_ReturnOr")
ReturnTypeExpr = Class(name="ReturnTypeExpr")
b_Neg = Class(name="b_Neg")
b_BoolTest = Class(name="b_BoolTest")
b_TypeConstraint = Class(name="b_TypeConstraint")
b_ConstantExpr = Class(name="b_ConstantExpr")
b_CondAnd = Class(name="b_CondAnd")
b_CondEq = Class(name="b_CondEq")
b_CondLessThan = Class(name="b_CondLessThan")
b_ArgMinus = Class(name="b_ArgMinus")
b_StringLiteral = Class(name="b_StringLiteral")
b_Program = Class(name="b_Program")
...
b_BoolLiteral.attributes={b_BoolLiteral_value, b_BoolLiteral_constant}
...
def_82: BinaryAssociation = BinaryAssociation(
    name="def_82",
    ends={
...
else_105: BinaryAssociation = BinaryAssociation(
    name="else_105",
    ends={
...
in_124: BinaryAssociation = BinaryAssociation(
    name="in_124",
    ends={
...
domain_model = DomainModel(
    name="b",
    types={Abstraction, b_ConcreteVariables, b_Invariant, b_Initialisation, b_Assertions, b_Sets, b_Implementation, b_Imports, b_Values, b_LocalOperations, b_Abstraction, b_Sees, b_ConcreteConstants, b_Definitions, b_Properties, b_Operations, b_Machine, b_Type, b_InitialisationExpr, b_PropertyExpr, b_ValueExpr, b_Variable, b_InvariantExpr, b_DefinitionCall, LogicalExpr, b_Arg, b_IntLiteral, Condition, Arg, b_Set, b_Range, b_AssertionExpr, b_Definition, b_LogicalExpr, b_If, FinalExpr, b_IfCond, b_Condition, b_Pre, b_PreExpr, b_Operation, b_Body, b_Expr, b_Skip, Body, Expr, b_Statement, b_Case, b_CaseExpr, BeginBody, b_FinalExpr, b_Call, b_Var, b_Seq, b_Begin, b_BeginBody, b_Assign, Statement, b_ReturnExpr, b_Return, b_ReturnTypeExpr, Return, b_PropertyRange, b_AndExpr, b_ImplyExpr, b_InequalityExpr, b_EqualExpr, b_NegExpr, b_SimpleCall, b_PrimitiveType, Type, b_Ref, ReturnExpr, b_PropertyTyped, PropertyExpr, b_CondMinus, b_CondNeg, b_BoolLiteral, b_ReturnTuple, b_ReturnOr, ReturnTypeExpr, b_Neg, b_BoolTest, b_TypeConstraint, b_ConstantExpr, b_CondAnd, b_CondEq, b_CondLessThan, b_ArgMinus, b_StringLiteral, b_Program, PrimitiveTypeEnum, InequalityOp, BoolLiteralEnum},
    associations={concreteVariables9, invariant10, initialisation12, assertions14, sets16, refine18, imports20, values22, localOperations24, sees0, concreteConstants1, definitions3, properties5, operations7, type47, exprs49, variable51, type54, exprs57, expr59, seens26, imports29, exprs32, constant34, variables36, constants39, exprs42, variable44, def_82, args84, exprs86, constant62, upperBound65, exprs67, constant69, type72, exprs75, args77, expr80, exprs104, else_105, condition107, then109, exprs112, expr113, var116, name88, elems91, operations94, outputs96, args99, body102, var136, cases138, test140, expr143, exprs146, rets149, op151, type119, vars122, in_124, expr126, var127, value129, var131, type133, range172, exprs174, left176, right178, left181, right183, left186, right188, args154, op157, args159, operations162, type165, var167, type170, left212, right214, expr217, vars219, value221, exprs224, expr191, expr193, var195, type197, exprs200, left202, right204, left207, right209, expr226, left228, right230, machines233, implementations235},
    generalizations={gen_b_Machine_Abstraction, gen_b_Implementation_Abstraction, gen_b_DefinitionCall_LogicalExpr, gen_b_IntLiteral_LogicalExpr, gen_b_IntLiteral_Condition, gen_b_IntLiteral_Arg, gen_b_If_Body, gen_b_If_Expr, gen_b_If_FinalExpr, gen_b_Pre_Body, gen_b_Skip_Body, gen_b_Skip_Expr, gen_b_Case_Expr, gen_b_Case_FinalExpr, gen_b_Seq_Body, gen_b_Seq_BeginBody, gen_b_FinalExpr_BeginBody, gen_b_Call_Expr, gen_b_Call_Statement, gen_b_Var_Body, gen_b_Var_Expr, gen_b_Var_FinalExpr, gen_b_Begin_Body, gen_b_Assign_Expr, gen_b_Assign_Statement, gen_b_Return_Expr, gen_b_Return_FinalExpr, gen_b_ReturnTypeExpr_Return, gen_b_PropertyRange_PropertyExpr, gen_b_AndExpr_LogicalExpr, gen_b_ImplyExpr_LogicalExpr, gen_b_InequalityExpr_LogicalExpr, gen_b_EqualExpr_LogicalExpr, gen_b_NegExpr_LogicalExpr, gen_b_PrimitiveType_Type, gen_b_Ref_Type, gen_b_Ref_LogicalExpr, gen_b_Ref_Condition, gen_b_Ref_ReturnExpr, gen_b_Ref_Arg, gen_b_PropertyTyped_PropertyExpr, gen_b_CondMinus_Condition, gen_b_CondNeg_Condition, gen_b_BoolLiteral_Condition, gen_b_BoolLiteral_ReturnExpr, gen_b_BoolLiteral_Arg, gen_b_ReturnTuple_Return, gen_b_ReturnOr_ReturnTypeExpr, gen_b_BoolTest_LogicalExpr, gen_b_BoolTest_ReturnExpr, gen_b_TypeConstraint_LogicalExpr, gen_b_ConstantExpr_LogicalExpr, gen_b_CondAnd_Condition, gen_b_CondEq_Condition, gen_b_CondLessThan_Condition, gen_b_Neg_ReturnExpr, gen_b_ArgMinus_Arg, gen_b_StringLiteral_Arg},
    metadata=None
)
