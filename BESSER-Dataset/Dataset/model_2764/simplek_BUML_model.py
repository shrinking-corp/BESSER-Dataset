...
# Classes
simplek_Base = Class(name="simplek_Base")
simplek_Content = Class(name="simplek_Content")
simplek_A = Class(name="simplek_A")
simplek_B = Class(name="simplek_B")
...
domain_model = DomainModel(
    ...
    associations={contents0, as_1, bs3},
    generalizations={},
    metadata=None
)
