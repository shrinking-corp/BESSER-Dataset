...
# Classes
edu_Program = Class(name="edu_Program")
ASTNode = Class(name="ASTNode")
edu_FunctionDeclaration = Class(name="edu_FunctionDeclaration")
edu_Block = Class(name="edu_Block")
edu_Axiom = Class(name="edu_Axiom")
edu_ASTNode = Class(name="edu_ASTNode", is_abstract=True)
edu_Addition = Class(name="edu_Addition")
BinaryExpression = Class(name="BinaryExpression")
edu_BinaryExpression = Class(name="edu_BinaryExpression", is_abstract=True)
Expression = Class(name="Expression")
edu_Expression = Class(name="edu_Expression", is_abstract=True)
edu_UnaryExpression = Class(name="edu_UnaryExpression", is_abstract=True)
edu_ArrayLiteral = Class(name="edu_ArrayLiteral")
Literal = Class(name="Literal")
edu_Literal = Class(name="edu_Literal", is_abstract=True)
edu_ArrayType = Class(name="edu_ArrayType")
Type = Class(name="Type")
edu_PrimitiveType = Class(name="edu_PrimitiveType", is_abstract=True)
edu_Type = Class(name="edu_Type", is_abstract=True)
edu_Assertion = Class(name="edu_Assertion")
Annotation = Class(name="Annotation")
edu_GuardAssertion = Class(name="edu_GuardAssertion")
Assertion = Class(name="Assertion")
edu_FunctionCallPreconditionAssertion = Class(name="edu_FunctionCallPreconditionAssertion")
GuardAssertion = Class(name="GuardAssertion")
edu_FunctionCall = Class(name="edu_FunctionCall")
edu_DivisorNotZeroAssertion = Class(name="edu_DivisorNotZeroAssertion")
edu_Annotation = Class(name="edu_Annotation", is_abstract=True)
Statement = Class(name="Statement")
edu_Assignment = Class(name="edu_Assignment")
edu_VariableReference = Class(name="edu_VariableReference")
edu_VariableDeclaration = Class(name="edu_VariableDeclaration")
edu_Disjunction = Class(name="edu_Disjunction")
edu_Assumption = Class(name="edu_Assumption")
edu_Statement = Class(name="edu_Statement", is_abstract=True)
edu_BooleanLiteral = Class(name="edu_BooleanLiteral")
edu_BooleanType = Class(name="edu_BooleanType")
PrimitiveType = Class(name="PrimitiveType")
edu_Conditional = Class(name="edu_Conditional")
edu_Conjunction = Class(name="edu_Conjunction")
edu_Division = Class(name="edu_Division")
edu_Equal = Class(name="edu_Equal")
edu_Equivalence = Class(name="edu_Equivalence")
edu_ExistsQuantifier = Class(name="edu_ExistsQuantifier")
QuantifiedExpression = Class(name="QuantifiedExpression")
edu_QuantifiedExpression = Class(name="edu_QuantifiedExpression", is_abstract=True)
edu_ForAllQuantifier = Class(name="edu_ForAllQuantifier")
edu_Precondition = Class(name="edu_Precondition")
edu_Postcondition = Class(name="edu_Postcondition")
FunctionAnnotation = Class(name="FunctionAnnotation")
edu_Greater = Class(name="edu_Greater")
edu_GreaterOrEqual = Class(name="edu_GreaterOrEqual")
edu_Implication = Class(name="edu_Implication")
edu_IntegerLiteral = Class(name="edu_IntegerLiteral")
edu_IntegerType = Class(name="edu_IntegerType")
edu_Invariant = Class(name="edu_Invariant")
edu_Less = Class(name="edu_Less")
edu_LessOrEqual = Class(name="edu_LessOrEqual")
edu_Loop = Class(name="edu_Loop")
edu_Minus = Class(name="edu_Minus")
Sign = Class(name="Sign")
edu_Sign = Class(name="edu_Sign", is_abstract=True)
UnaryExpression = Class(name="UnaryExpression")
edu_Modulus = Class(name="edu_Modulus")
edu_Multiplication = Class(name="edu_Multiplication")
edu_Negation = Class(name="edu_Negation")
edu_Plus = Class(name="edu_Plus")
edu_ReturnStatement = Class(name="edu_ReturnStatement")
edu_Subtraction = Class(name="edu_Subtraction")
edu_Unequal = Class(name="edu_Unequal")
SymbolReference = Class(name="SymbolReference")
edu_FunctionAnnotation = Class(name="edu_FunctionAnnotation", is_abstract=True)
edu_ReturnValueReference = Class(name="edu_ReturnValueReference")
edu_SymbolReference = Class(name="edu_SymbolReference")
edu_ExpressionEvaluation = Class(name="edu_ExpressionEvaluation")
edu_ArrayFunction = Class(name="edu_ArrayFunction")
edu_ArrayAccess = Class(name="edu_ArrayAccess")
edu_ExpressionToExpressionMap = Class(name="edu_ExpressionToExpressionMap")
edu_TernaryExpression = Class(name="edu_TernaryExpression")
edu_LetExpression = Class(name="edu_LetExpression")
edu_visitor_IASTNodeVisitor = Class(name="edu_visitor_IASTNodeVisitor", is_abstract=True)

# edu_Program class attributes and methods
edu_Program_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
...
edu_FunctionDeclaration_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
...
edu_Block_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_Block.methods={edu_Block_m_accept}

# edu_Axiom class attributes and methods
edu_Axiom_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_Axiom.methods={edu_Axiom_m_accept}

# edu_ASTNode class attributes and methods
edu_ASTNode_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_ASTNode.methods={edu_ASTNode_m_accept}

# edu_Addition class attributes and methods
edu_Addition_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
...
edu_BinaryExpression_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_BinaryExpression.methods={edu_BinaryExpression_m_accept}

# Expression class attributes and methods

# edu_Expression class attributes and methods
edu_Expression_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_Expression.methods={edu_Expression_m_accept}

# edu_UnaryExpression class attributes and methods
edu_UnaryExpression_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_UnaryExpression.methods={edu_UnaryExpression_m_accept}

# edu_ArrayLiteral class attributes and methods
edu_ArrayLiteral_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_ArrayLiteral.methods={edu_ArrayLiteral_m_accept}

# Literal class attributes and methods

# edu_Literal class attributes and methods
edu_Literal_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_Literal.methods={edu_Literal_m_accept}

# edu_ArrayType class attributes and methods
edu_ArrayType_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_ArrayType.methods={edu_ArrayType_m_accept}

# Type class attributes and methods

# edu_PrimitiveType class attributes and methods
edu_PrimitiveType_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_PrimitiveType.methods={edu_PrimitiveType_m_accept}

# edu_Type class attributes and methods
edu_Type_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_Type.methods={edu_Type_m_accept}

# edu_Assertion class attributes and methods
edu_Assertion_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
...
edu_GuardAssertion_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
...
edu_FunctionCallPreconditionAssertion_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
...
edu_FunctionCall_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_FunctionCall.methods={edu_FunctionCall_m_accept}

# edu_DivisorNotZeroAssertion class attributes and methods
edu_DivisorNotZeroAssertion_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_DivisorNotZeroAssertion.methods={edu_DivisorNotZeroAssertion_m_accept}

# edu_Annotation class attributes and methods
edu_Annotation_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_Annotation.methods={edu_Annotation_m_accept}

# Statement class attributes and methods

# edu_Assignment class attributes and methods
edu_Assignment_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_Assignment.methods={edu_Assignment_m_accept}

# edu_VariableReference class attributes and methods
edu_VariableReference_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
...
edu_VariableDeclaration_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
...
edu_Disjunction_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_Disjunction.methods={edu_Disjunction_m_accept}

# edu_Assumption class attributes and methods
edu_Assumption_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_Assumption.methods={edu_Assumption_m_accept}

# edu_Statement class attributes and methods
edu_Statement_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
...
edu_BooleanLiteral_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
...
edu_BooleanLiteral.methods={edu_BooleanLiteral_m_accept, edu_BooleanLiteral_m_getValue}

# edu_BooleanType class attributes and methods
edu_BooleanType_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
...
edu_Conditional_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_Conditional.methods={edu_Conditional_m_accept}

# edu_Conjunction class attributes and methods
edu_Conjunction_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_Conjunction.methods={edu_Conjunction_m_accept}

# edu_Division class attributes and methods
edu_Division_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_Division.methods={edu_Division_m_accept}

# edu_Equal class attributes and methods
edu_Equal_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_Equal.methods={edu_Equal_m_accept}

# edu_Equivalence class attributes and methods
edu_Equivalence_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_Equivalence.methods={edu_Equivalence_m_accept}

# edu_ExistsQuantifier class attributes and methods
edu_ExistsQuantifier_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
...
edu_QuantifiedExpression_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_QuantifiedExpression.methods={edu_QuantifiedExpression_m_accept}

# edu_ForAllQuantifier class attributes and methods
edu_ForAllQuantifier_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_ForAllQuantifier.methods={edu_ForAllQuantifier_m_accept}

# edu_Precondition class attributes and methods
edu_Precondition_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_Precondition.methods={edu_Precondition_m_accept}

# edu_Postcondition class attributes and methods
edu_Postcondition_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
...
edu_Greater_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_Greater.methods={edu_Greater_m_accept}

# edu_GreaterOrEqual class attributes and methods
edu_GreaterOrEqual_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_GreaterOrEqual.methods={edu_GreaterOrEqual_m_accept}

# edu_Implication class attributes and methods
edu_Implication_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
...
edu_IntegerLiteral_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
...
edu_IntegerType_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_IntegerType.methods={edu_IntegerType_m_accept}

# edu_Invariant class attributes and methods
edu_Invariant_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_Invariant.methods={edu_Invariant_m_accept}

# edu_Less class attributes and methods
edu_Less_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_Less.methods={edu_Less_m_accept}

# edu_LessOrEqual class attributes and methods
edu_LessOrEqual_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_LessOrEqual.methods={edu_LessOrEqual_m_accept}

# edu_Loop class attributes and methods
edu_Loop_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_Loop.methods={edu_Loop_m_accept}

# edu_Minus class attributes and methods
edu_Minus_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_Minus.methods={edu_Minus_m_accept}

# Sign class attributes and methods

# edu_Sign class attributes and methods
edu_Sign_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_Sign.methods={edu_Sign_m_accept}

# UnaryExpression class attributes and methods

# edu_Modulus class attributes and methods
edu_Modulus_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_Modulus.methods={edu_Modulus_m_accept}

# edu_Multiplication class attributes and methods
edu_Multiplication_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_Multiplication.methods={edu_Multiplication_m_accept}

# edu_Negation class attributes and methods
edu_Negation_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_Negation.methods={edu_Negation_m_accept}

# edu_Plus class attributes and methods
edu_Plus_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_Plus.methods={edu_Plus_m_accept}

# edu_ReturnStatement class attributes and methods
edu_ReturnStatement_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_ReturnStatement.methods={edu_ReturnStatement_m_accept}

# edu_Subtraction class attributes and methods
edu_Subtraction_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_Subtraction.methods={edu_Subtraction_m_accept}

# edu_Unequal class attributes and methods
edu_Unequal_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
...
edu_FunctionAnnotation_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_FunctionAnnotation.methods={edu_FunctionAnnotation_m_accept}

# edu_ReturnValueReference class attributes and methods
edu_ReturnValueReference_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_ReturnValueReference.methods={edu_ReturnValueReference_m_accept}

# edu_SymbolReference class attributes and methods
edu_SymbolReference_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
...
edu_ArrayFunction_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
edu_ArrayFunction.methods={edu_ArrayFunction_m_accept}

# edu_ArrayAccess class attributes and methods
edu_ArrayAccess_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
...
edu_TernaryExpression_m_accept: Method = Method(name="accept", parameters={Parameter(name='edu_visitor', type=StringType)})
...
edu_visitor_IASTNodeVisitor_m_visit: Method = Method(name="visit", parameters={Parameter(name='edu_node', type=StringType)})
edu_visitor_IASTNodeVisitor_m_visit: Method = Method(name="visit", parameters={Parameter(name='edu_node', type=StringType)})
edu_visitor_IASTNodeVisitor_m_visit: Method = Method(name="visit", parameters={Parameter(name='edu_node', type=StringType)})
edu_visitor_IASTNodeVisitor_m_visit: Method = Method(name="visit", parameters={Parameter(name='edu_node', type=StringType)})
edu_visitor_IASTNodeVisitor_m_visit: Method = Method(name="visit", parameters={Parameter(name='edu_node', type=StringType)})
...
domain_model = DomainModel(
    name="edu",
    types={edu_Program, ASTNode, edu_FunctionDeclaration, edu_Block, edu_Axiom, edu_ASTNode, edu_Addition, BinaryExpression, edu_BinaryExpression, Expression, edu_Expression, edu_UnaryExpression, edu_ArrayLiteral, Literal, edu_Literal, edu_ArrayType, Type, edu_PrimitiveType, edu_Type, edu_Assertion, Annotation, edu_GuardAssertion, Assertion, edu_FunctionCallPreconditionAssertion, GuardAssertion, edu_FunctionCall, edu_DivisorNotZeroAssertion, edu_Annotation, Statement, edu_Assignment, edu_VariableReference, edu_VariableDeclaration, edu_Disjunction, edu_Assumption, edu_Statement, edu_BooleanLiteral, edu_BooleanType, PrimitiveType, edu_Conditional, edu_Conjunction, edu_Division, edu_Equal, edu_Equivalence, edu_ExistsQuantifier, QuantifiedExpression, edu_QuantifiedExpression, edu_ForAllQuantifier, edu_Precondition, edu_Postcondition, FunctionAnnotation, edu_Greater, edu_GreaterOrEqual, edu_Implication, edu_IntegerLiteral, edu_IntegerType, edu_Invariant, edu_Less, edu_LessOrEqual, edu_Loop, edu_Minus, Sign, edu_Sign, UnaryExpression, edu_Modulus, edu_Multiplication, edu_Negation, edu_Plus, edu_ReturnStatement, edu_Subtraction, edu_Unequal, SymbolReference, edu_FunctionAnnotation, edu_ReturnValueReference, edu_SymbolReference, edu_ExpressionEvaluation, edu_ArrayFunction, edu_ArrayAccess, edu_ExpressionToExpressionMap, edu_TernaryExpression, edu_LetExpression, edu_visitor_IASTNodeVisitor},
    associations={functionDeclarations0, mainBlock1, axioms3, left5, right6, values11, baseType13, guardedNode14, operand9, guardedNode15, expression17, value19, variable21, initialValue24, statements27, condition29, trueBlock31, falseBlock34, type23, postconditions53, parameters55, parameter37, expression39, condition42, actuals45, function48, preconditions51, condition64, body58, returnType61, body66, invariants69, returnValue71, function73, variable76, function79, index81, expression83, chainedFunction85, index87, value90, index93, array95, key98, value100, whenTrue103, whenFalse105, condition108, parameters111, expression113},
    generalizations={gen_edu_Program_ASTNode, gen_edu_Addition_BinaryExpression, gen_edu_BinaryExpression_Expression, gen_edu_Expression_ASTNode, gen_edu_UnaryExpression_Expression, gen_edu_ArrayLiteral_Literal, gen_edu_Literal_Expression, gen_edu_ArrayType_Type, gen_edu_Type_ASTNode, gen_edu_PrimitiveType_Type, gen_edu_Assertion_Annotation, gen_edu_GuardAssertion_Assertion, gen_edu_FunctionCallPreconditionAssertion_GuardAssertion, gen_edu_DivisorNotZeroAssertion_GuardAssertion, gen_edu_Annotation_Statement, gen_edu_Assignment_Statement, gen_edu_VariableDeclaration_Statement, gen_edu_Disjunction_BinaryExpression, gen_edu_Assumption_Annotation, gen_edu_Axiom_Annotation, gen_edu_Block_Statement, gen_edu_BooleanLiteral_Literal, gen_edu_BooleanType_PrimitiveType, gen_edu_Conditional_Statement, gen_edu_Conjunction_BinaryExpression, gen_edu_Division_BinaryExpression, gen_edu_Equal_BinaryExpression, gen_edu_Equivalence_BinaryExpression, gen_edu_ExistsQuantifier_QuantifiedExpression, gen_edu_QuantifiedExpression_Expression, gen_edu_ForAllQuantifier_QuantifiedExpression, gen_edu_FunctionCall_Expression, gen_edu_FunctionDeclaration_ASTNode, gen_edu_Precondition_FunctionAnnotation, gen_edu_Postcondition_FunctionAnnotation, gen_edu_Greater_BinaryExpression, gen_edu_GreaterOrEqual_BinaryExpression, gen_edu_Implication_BinaryExpression, gen_edu_IntegerLiteral_Literal, gen_edu_IntegerType_PrimitiveType, gen_edu_Invariant_Annotation, gen_edu_Less_BinaryExpression, gen_edu_LessOrEqual_BinaryExpression, gen_edu_Loop_Statement, gen_edu_Minus_Sign, gen_edu_Sign_UnaryExpression, gen_edu_Modulus_BinaryExpression, gen_edu_Multiplication_BinaryExpression, gen_edu_Negation_UnaryExpression, gen_edu_Plus_Sign, gen_edu_ReturnStatement_Statement, gen_edu_Subtraction_BinaryExpression, gen_edu_Unequal_BinaryExpression, gen_edu_VariableReference_SymbolReference, gen_edu_FunctionAnnotation_Annotation, gen_edu_Statement_ASTNode, gen_edu_ReturnValueReference_SymbolReference, gen_edu_SymbolReference_Expression, gen_edu_ExpressionEvaluation_ASTNode, gen_edu_ArrayFunction_Literal, gen_edu_ArrayAccess_Expression, gen_edu_TernaryExpression_Expression, gen_edu_LetExpression_Expression},
    metadata=None
)
