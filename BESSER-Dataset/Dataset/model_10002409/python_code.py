...
class Customer:
    ...
    def __init__(self, FirstName: str, LastName: str, phoneNumber: int, Booking_Date: date, LeaveDate: date, room4: "Room" = None):
    ...
    @LeaveDate.setter
    def LeaveDate(self, LeaveDate: date):
    ...
    @Booking_Date.setter
    def Booking_Date(self, Booking_Date: date):
