...
# Classes
test_ClassC = Class(name="test_ClassC")
test_ClassB = Class(name="test_ClassB")
Itf1 = Class(name="Itf1")
ClassB = Class(name="ClassB")
test_Itf1 = Class(name="test_Itf1", is_abstract=True)
test_Itf2 = Class(name="test_Itf2", is_abstract=True)
test_Interface3 = Class(name="test_Interface3", is_abstract=True)
test_ClassD = Class(name="test_ClassD")
Interface3 = Class(name="Interface3")
Itf2 = Class(name="Itf2")
test_ClassE = Class(name="test_ClassE")
ClassC = Class(name="ClassC")
test_ClassF = Class(name="test_ClassF")
test_Interface4 = Class(name="test_Interface4", is_abstract=True)
test_ClassA = Class(name="test_ClassA")
...
domain_model = DomainModel(
    name="test",
    types={test_ClassC, test_ClassB, Itf1, ClassB, test_Itf1, test_Itf2, test_Interface3, test_ClassD, Interface3, Itf2, test_ClassE, ClassC, test_ClassF, test_Interface4, test_ClassA},
    associations={cfghdtgh2, a1},
    generalizations={gen_test_ClassB_Itf1, gen_test_ClassC_ClassB, gen_test_ClassD_Interface3, gen_test_ClassD_Itf1, gen_test_ClassD_Itf2, gen_test_ClassE_ClassC, gen_test_ClassE_Interface3},
    metadata=None
)
