...
# Classes
tp01_FSM = Class(name="tp01_FSM")
tp01_State = Class(name="tp01_State")
tp01_Transition = Class(name="tp01_Transition")
tp01_StartState = Class(name="tp01_StartState")
State = Class(name="State")
tp01_FinalState = Class(name="tp01_FinalState")
...
domain_model = DomainModel(
    name="tp01",
    types={tp01_FSM, tp01_State, tp01_Transition, tp01_StartState, State, tp01_FinalState},
