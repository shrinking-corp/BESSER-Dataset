...
class tp01_Transition:
    ...
    def __init__(self, name: str, tp01_Transition: "tp01_FSM" = None, tp01_Transition4: "tp01_State" = None, tp01_Transition7: "tp01_State" = None):
        self.name = name
...
class tp01_State:
    ...
    def __init__(self, name: str, tp01_State: "tp01_FSM" = None, tp01_State5: "tp01_Transition" = None, tp01_State8: "tp01_Transition" = None):
        self.name = name
