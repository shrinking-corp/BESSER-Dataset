...
class EVisibility:
    ...
    pass
class dcmddandroid_ClassElement(NamedElement, EVisibility):
...
class dcmddandroid_Association(ModelElement):
    ...
    def __init__(self, minMultiplicityTarget: int, rolSource: str, rolTarget: str, minMultiplicitySource: int, maxMultiplicitySource: int, maxMultiplicityTarget: int, Association: "dcmddandroid_AbstractClass" = None, Association6: "dcmddandroid_AbstractClass" = None, associationAsSource: "dcmddandroid_AbstractClass" = None, associationAsTarget: "dcmddandroid_AbstractClass" = None):
        ...
        pass
    @property
    def minMultiplicityTarget(self):
    ...
    @property
    def maxMultiplicitySource(self):
    ...
    @property
    def maxMultiplicityTarget(self):
    ...
    @property
    def minMultiplicitySource(self):
...
class dcmddandroid_AbstractClass(EVisibility, ModelElement):
    ...
    def __init__(self, isAbstract: bool, implements: set["dcmddandroid_Implements"] = None, dcmddandroid_AbstractClass: set["dcmddandroid_Attribute"] = None, dcmddandroid_AbstractClass3: set["dcmddandroid_Method"] = None, source: set["dcmddandroid_Association"] = None, target: set["dcmddandroid_Association"] = None, AbstractClass: "dcmddandroid_Association" = None, AbstractClass18: "dcmddandroid_Association" = None, AbstractClass23: "dcmddandroid_Implements" = None):
        self.isAbstract = isAbstract
