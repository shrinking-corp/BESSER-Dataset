...
public class java_Try_statement  {
    ...
    public java_Try_statement(
        String catchs,        String try_,        String finally_    ) {
        this.catchs = catchs;
        this.try_ = try_;
    ...
    public java_Try_statement(
        String catchs,        String try_,        String finally_        ArrayList<java_Statement> java_statements,        ArrayList<java_Parameter> java_parameters    ) {
        this.catchs = catchs;
        this.try_ = try_;
        this.finally_ = finally_;
