...
# Classes
java_Package_statement = Class(name="java_Package_statement")
java_Import_statement = Class(name="java_Import_statement")
java_Type_declaration = Class(name="java_Type_declaration")
java_EObject = Class(name="java_EObject")
java_Interface_declaration = Class(name="java_Interface_declaration")
java_Field_declaration = Class(name="java_Field_declaration")
java_Class_declaration = Class(name="java_Class_declaration")
java_Head = Class(name="java_Head")
java_Compilation_unit = Class(name="java_Compilation_unit")
java_Statement_block = Class(name="java_Statement_block")
java_Method_call = Class(name="java_Method_call")
Return_value = Class(name="Return_value")
java_Parameter_list_method_call = Class(name="java_Parameter_list_method_call")
java_Constructor_declaration = Class(name="java_Constructor_declaration")
java_Parameter = Class(name="java_Parameter")
java_Variable_declaration = Class(name="java_Variable_declaration")
java_Variable_declarator = Class(name="java_Variable_declarator")
java_Method_declaration = Class(name="java_Method_declaration")
java_Type = Class(name="java_Type")
java_Parameter_list = Class(name="java_Parameter_list")
java_Logical_Expression_NR = Class(name="java_Logical_Expression_NR")
java_Bit_Expression_NR = Class(name="java_Bit_Expression_NR")
java_Cast_Expression = Class(name="java_Cast_Expression")
java_Creating_Expression = Class(name="java_Creating_Expression")
java_Literal_Expression = Class(name="java_Literal_Expression")
java_Arg_List = Class(name="java_Arg_List")
java_Variable_initializer = Class(name="java_Variable_initializer")
java_Expression = Class(name="java_Expression")
java_Numeric_Expression_NR = Class(name="java_Numeric_Expression_NR")
java_Expression_aux = Class(name="java_Expression_aux")
java_Float_Literal = Class(name="java_Float_Literal")
java_Ampersand_Rule = Class(name="java_Ampersand_Rule")
java_Statement = Class(name="java_Statement")
java_Return_Statement = Class(name="java_Return_Statement")
java_If_Statement = Class(name="java_If_Statement")
java_Static_initializer = Class(name="java_Static_initializer")
java_Do_Statement = Class(name="java_Do_Statement")
java_While_Statement = Class(name="java_While_Statement")
java_For_Statement = Class(name="java_For_Statement")
java_Switch_Statement = Class(name="java_Switch_Statement")
java_Try_statement = Class(name="java_Try_statement")
java_Return_value = Class(name="java_Return_value")
...
java_Interface_declaration.attributes={java_Interface_declaration_extend, java_Interface_declaration_interfaceName, java_Interface_declaration_modifiers, java_Interface_declaration_extends}
...
java_Method_declaration.attributes={java_Method_declaration_modifiers, java_Method_declaration_name, java_Method_declaration_debug}
...
java_Creating_Expression.attributes={java_Creating_Expression_typeSpecifier, java_Creating_Expression_className}
...
java_Literal_Expression.attributes={java_Literal_Expression_char, java_Literal_Expression_exp, java_Literal_Expression_exp1, java_Literal_Expression_string}
...
java_Expression.attributes={java_Expression_null, java_Expression_this, java_Expression_super, java_Expression_name}
...
java_Expression_aux.attributes={java_Expression_aux_logicalSign, java_Expression_aux_testingSign, java_Expression_aux_name, java_Expression_aux_sgin, java_Expression_aux_bitSign, java_Expression_aux_numericSign, java_Expression_aux_stringSign}
...
java_Float_Literal.attributes={java_Float_Literal_decimalDigits2, java_Float_Literal_decimalDigits1, java_Float_Literal_exp}
...
java_Try_statement_finally_: Property = Property(name="finally_", type=StringType)
java_Try_statement_try_: Property = Property(name="try_", type=StringType)
java_Try_statement_catchs: Property = Property(name="catchs", type=StringType)
java_Try_statement.attributes={java_Try_statement_try_, java_Try_statement_catchs, java_Try_statement_finally_}
...
try_141: BinaryAssociation = BinaryAssociation(
    name="try_141",
    ends={
...
domain_model = DomainModel(
    name="java",
    types={java_Package_statement, java_Import_statement, java_Type_declaration, java_EObject, java_Interface_declaration, java_Field_declaration, java_Class_declaration, java_Head, java_Compilation_unit, java_Statement_block, java_Method_call, Return_value, java_Parameter_list_method_call, java_Constructor_declaration, java_Parameter, java_Variable_declaration, java_Variable_declarator, java_Method_declaration, java_Type, java_Parameter_list, java_Logical_Expression_NR, java_Bit_Expression_NR, java_Cast_Expression, java_Creating_Expression, java_Literal_Expression, java_Arg_List, java_Variable_initializer, java_Expression, java_Numeric_Expression_NR, java_Expression_aux, java_Float_Literal, java_Ampersand_Rule, java_Statement, java_Return_Statement, java_If_Statement, java_Static_initializer, java_Do_Statement, java_While_Statement, java_For_Statement, java_Switch_Statement, java_Try_statement, java_Return_value},
    associations={elements0, package1, imports3, type_declarations5, name7, fields9, statement18, parameter20, parameters21, statement23, parameter26, parameters28, type31, type34, name36, fields10, name12, type15, parameter16, aux53, logicalExpression55, bitExpression57, castExpression59, creatingExpression61, literalExpression63, argList65, aux68, expression270, expressionComma73, exp276, names38, initializer41, expression43, variableInitializer146, variableIniatializer249, numericExpression351, exp287, argList89, expression92, type95, expression98, expression101, expression104, exp179, ampersand82, expressionBit84, statements118, returnSmt120, variable122, expressionx125, ifStatement128, expression107, expressions110, expression113, name116, statement144, variableDeclarator146, sw_exp149, case_exp152, statements155, variable158, expression161, expression2164, expression3167, statement170, expression173, statement176, statement179, doStatement130, whileStatement132, forStatement134, switchStatement136, statementBlock138, try_141, parameters199, catchStatements202, finallyStatement205, expression182, expression185, statement188, elseStatement191, rv194, tryStatement196},
