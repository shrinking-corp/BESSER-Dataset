...
class publication2014c_PublicationPhase:
    ...
    def __init__(self, name: str, minTime: int, maxTime: int, publication2014c_PublicationPhase: "publication2014c_PublicationProcess" = None, publication2014c_PublicationPhase4: set["publication2014c_Sequence"] = None, PublicationPhase: "publication2014c_Researcher" = None, phaseParticipation: set["publication2014c_Researcher"] = None, publication2014c_PublicationPhase7: set["publication2014c_Rule"] = None, publication2014c_PublicationPhase11: "publication2014c_Sequence" = None, publication2014c_PublicationPhase14: "publication2014c_Sequence" = None):
        self.name = name
...
class publication2014c_ReviewNote(Named):
    ...
    def __init__(self, content: str, publication2014c_ReviewNote: "publication2014c_Paragraph" = None, publication2014c_ReviewNote35: "publication2014c_Review" = None):
...
class publication2014c_PublicationProcess(Named):
    ...
    def __init__(self, minTime: int, maxTime: int, publication2014c_PublicationProcess42: "publication2014c_PublicationSystem" = None, publication2014c_PublicationProcess: set["publication2014c_PublicationPhase"] = None, publication2014c_PublicationProcess2: set["publication2014c_Rule"] = None, publication2014c_PublicationProcess27: "publication2014c_Progress" = None):
        self.minTime = minTime
        self.maxTime = maxTime
