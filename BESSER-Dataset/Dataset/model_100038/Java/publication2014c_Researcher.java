...
public class publication2014c_Researcher  {
    ...
    public publication2014c_Researcher(
        String forName,        String position,        String name        ArrayList<publication2014c_Review> publication2014c_reviews,        ArrayList<publication2014c_Paper> publication2014c_papers,        ArrayList<publication2014c_PublicationPhase> publication2014c_publicationphases,        ArrayList<publication2014c_Write> publication2014c_writes    ) {
        this.forName = forName;
        this.position = position;
        this.name = name;
