...
class sQL_Table:
    ...
    def __init__(self, name: str, sQL_Table4: "sQL_primaryKey" = None, sQL_Table6: set["sQL_foreignKey"] = None, sQL_Table9: "sQL_foreignKey" = None, sQL_Table: "sQL_DataBase" = None, sQL_Table2: set["sQL_column"] = None):
        self.name = name
...
class sQL_foreignKey:
    ...
    def __init__(self, name: str, sQL_foreignKey: "sQL_Table" = None, sQL_foreignKey8: "sQL_Table" = None, sQL_foreignKey11: "sQL_column" = None):
        self.name = name
