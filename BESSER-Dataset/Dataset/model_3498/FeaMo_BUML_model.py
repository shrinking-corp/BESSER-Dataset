...
# Classes
feaMo_FeamoFeatureConfig = Class(name="feaMo_FeamoFeatureConfig")
feaMo_Model = Class(name="feaMo_Model")
feaMo_FeatureModel = Class(name="feaMo_FeatureModel")
feaMo_FeatureDetails = Class(name="feaMo_FeatureDetails")
feaMo_FeatureDef = Class(name="feaMo_FeatureDef")
feaMo_FeatureConstraint = Class(name="feaMo_FeatureConstraint")
feaMo_FeatureGroup = Class(name="feaMo_FeatureGroup")
feaMo_SimpleFeature = Class(name="feaMo_SimpleFeature")
feaMo_Feature = Class(name="feaMo_Feature")
feaMo_FeamoFSelector = Class(name="feaMo_FeamoFSelector")
...
or_16: BinaryAssociation = BinaryAssociation(
    name="or_16",
    ends={
...
domain_model = DomainModel(
    name="feaMo",
    types={feaMo_FeamoFeatureConfig, feaMo_Model, feaMo_FeatureModel, feaMo_FeatureDetails, feaMo_FeatureDef, feaMo_FeatureConstraint, feaMo_FeatureGroup, feaMo_SimpleFeature, feaMo_Feature, feaMo_FeamoFSelector},
    associations={featureModels0, configs1, alt13, or_16, details3, defs5, constraints7, groups9, simple11, feature130, mandatory19, optional21, feature24, details27, feature233, feature36, fm38, selected41},
    generalizations={},
    metadata=None
)
