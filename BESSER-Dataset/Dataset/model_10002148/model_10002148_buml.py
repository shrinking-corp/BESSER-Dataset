...
ClassA.attributes={ClassA_privateAttribute, ClassA_publicAttribute, ClassA_packageAttribute, ClassA_protectedAttribute}
...
ClassC.attributes={ClassC_publicAttribute, ClassC_protectedAttribute, ClassC_privateAttribute, ClassC_packageAttribute}
...
Class__asdasd: Property = Property(name="asdasd", type=StringType)
Class__qweqwe: Property = Property(name="qweqwe", type=StringType)
Class_.attributes={Class__qweqwe, Class__asdasd}
...
ClassC_ClassB: BinaryAssociation = BinaryAssociation(
    name="ClassC_ClassB",
    ends={
        Property(name="classB6", type=ClassB, multiplicity=Multiplicity(0, 1)),
        Property(name="classC7", type=ClassC, multiplicity=Multiplicity(0, 1))
    }
)

# Domain Model
domain_model = DomainModel(
    name="_rzJ_oGmfEeqH6JNbB4_uaw",
    types={T, T1, ClassA, ClassB, ClassC, ClassD, ClassE, ClassF, ClassG, ClassJ, ClassH, ClassK, ClassL, ClassM, ClassN, ClassP, InterfaceO_Interface, ClassQ, ClassR, ClassS, ClassT, ClassU, ClassV, Class_, BankAccount},
    associations={ClassD_ClassE, ClassD_ClassECopy, ClassD_ClassECopyCopy, ClassC_ClassB},
    generalizations={},
    metadata=None
)
