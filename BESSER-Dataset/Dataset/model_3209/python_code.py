...
class llp_MemoryReference:
    ...
    def __init__(self, address: str, llp_MemoryReference: "llp_IOInstruction" = None, llp_MemoryReference10: "llp_CommitInstruction" = None, llp_MemoryReference21: "llp_SynchronisationInstruction" = None):
...
class llp_Task:
    ...
    def __init__(self, name: str, llp_Task: "llp_LowLevelProgram" = None, llp_Task4: "llp_Block" = None, llp_Task12: "llp_SpawnInstruction" = None):
        self.name = name
