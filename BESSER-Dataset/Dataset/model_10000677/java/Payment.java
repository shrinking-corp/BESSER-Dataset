...
public class Payment  {
    ...
    public Payment(
        String card_no,        String ex_date,        String pay_amount,        String pay_mode,        int pay_id    ) {
    ...
    public Payment(
        String card_no,        String ex_date,        String pay_amount,        String pay_mode,        int pay_id        ArrayList<Reg_User> reg_users    ) {
        this.card_no = card_no;
        this.ex_date = ex_date;
        this.pay_amount = pay_amount;
        this.pay_mode = pay_mode;
