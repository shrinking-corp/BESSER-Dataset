...
sample_Variable.attributes={sample_Variable_Type, sample_Variable_Name}
...
domain_model = DomainModel(
    name="sample",
    types={sample_Story, sample_Scenario, sample_Variable, sample_Annotation, sample_Register, sample_When, sample_Given, sample_Then, sample_Sentence},
    associations={sentences9, scenarios0, sentences12, variables15, annotation17, stories19, when1, given3, then5, sentences7},
    generalizations={},
    metadata=None
)
