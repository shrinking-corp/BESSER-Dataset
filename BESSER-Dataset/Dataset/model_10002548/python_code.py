...
class Payment:
    ...
    def __init__(self, issuerName: str, expiryDate: str, amount: int, cardType: str, cardNumber: int, superAdmin11: set["SuperAdmin"] = None, volunteer13: set["Volunteer"] = None, admin15: set["Admin"] = None, normal_user17: set["Normal_user"] = None):
...
class Admin:
    ...
    def __init__(self, userName: str, password: str, userID: int, calender_Event2: set["Calender_Event"] = None, payment14: "Payment" = None, mail20: set["Mail"] = None):
        self.userName = userName
        self.password = password
        self.userID = userID
