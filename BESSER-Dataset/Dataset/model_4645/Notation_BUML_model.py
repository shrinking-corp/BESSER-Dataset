...
notation_CategorySeparator = Class(name="notation_CategorySeparator")
...
notation_ExpandableNode = Class(name="notation_ExpandableNode")
...
notation_CategorySeparator.attributes={notation_CategorySeparator_category, notation_CategorySeparator_newChildCodeSyncType, notation_CategorySeparator_newChildIcon}
...
notation_Diagram.attributes={notation_Diagram_showLocationForNewElementsDialog, notation_Diagram_locationForNewElements, notation_Diagram_name}
...
notation_ExpandableNode.attributes={notation_ExpandableNode_hasChildren, notation_ExpandableNode_template, notation_ExpandableNode_expanded}
...
domain_model = DomainModel(
    name="notation",
    types={notation_NotationElement, notation_Node, notation_EObject, notation_Edge, View, notation_Bounds, notation_CategorySeparator, Node, notation_Diagram, notation_View, NotationElement, notation_Note, notation_MindMapNode, notation_ExpandableNode, notation_LayoutConstraint, notation_Location, LayoutConstraint, Location},
