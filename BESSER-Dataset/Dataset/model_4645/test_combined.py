...
def test_hyp_notation_expandablenode_is_not_abstract():
    assert not inspect.isabstract(notation_ExpandableNode)


def test_hyp_notation_expandablenode_constructor_exists():
    assert callable(notation_ExpandableNode.__init__)


def test_hyp_notation_expandablenode_constructor_args():
...
def test_hyp_notation_categoryseparator_is_not_abstract():
    assert not inspect.isabstract(notation_CategorySeparator)


def test_hyp_notation_categoryseparator_constructor_exists():
    assert callable(notation_CategorySeparator.__init__)


def test_hyp_notation_categoryseparator_constructor_args():
...
def test_hyp_notation_expandablenode_template_setter(instance):
...
@given(instance=notation_ExpandableNode_strategy)
def test_hyp_notation_expandablenode_hasChildren_setter(instance):
...
@given(instance=notation_ExpandableNode_strategy)
def test_hyp_notation_expandablenode_expanded_setter(instance):
...
def test_hyp_notation_categoryseparator_category_setter(instance):
...
@given(instance=notation_CategorySeparator_strategy)
def test_hyp_notation_categoryseparator_newChildCodeSyncType_setter(instance):
...
@given(instance=notation_CategorySeparator_strategy)
def test_hyp_notation_categoryseparator_newChildIcon_setter(instance):
...
def test_hyp_notation_diagram_locationForNewElements_setter(instance):
...
@given(instance=notation_Diagram_strategy)
def test_hyp_notation_diagram_showLocationForNewElementsDialog_setter(instance):
...
def test_notation_CategorySeparator_category_value_roundtrip():
    instance = notation_CategorySeparator(category="sample_text", newChildCodeSyncType="sample_text", newChildIcon="sample_text")
    assert instance.category == "sample_text"
    instance.category = "sample_text_2"
    assert instance.category == "sample_text_2"


def test_notation_CategorySeparator_newChildCodeSyncType_value_roundtrip():
    instance = notation_CategorySeparator(category="sample_text", newChildCodeSyncType="sample_text", newChildIcon="sample_text")
    assert instance.newChildCodeSyncType == "sample_text"
    instance.newChildCodeSyncType = "sample_text_2"
    assert instance.newChildCodeSyncType == "sample_text_2"


def test_notation_CategorySeparator_newChildIcon_value_roundtrip():
    instance = notation_CategorySeparator(category="sample_text", newChildCodeSyncType="sample_text", newChildIcon="sample_text")
    assert instance.newChildIcon == "sample_text"
    instance.newChildIcon = "sample_text_2"
    assert instance.newChildIcon == "sample_text_2"


def test_notation_Diagram_locationForNewElements_value_roundtrip():
    instance = notation_Diagram(locationForNewElements="sample_text", name="sample_text", showLocationForNewElementsDialog=True)
    assert instance.locationForNewElements == "sample_text"
    instance.locationForNewElements = "sample_text_2"
    assert instance.locationForNewElements == "sample_text_2"
...
def test_notation_Diagram_showLocationForNewElementsDialog_value_roundtrip():
    instance = notation_Diagram(locationForNewElements="sample_text", name="sample_text", showLocationForNewElementsDialog=True)
    assert instance.showLocationForNewElementsDialog == True
    instance.showLocationForNewElementsDialog = False
    assert instance.showLocationForNewElementsDialog == False


def test_notation_ExpandableNode_expanded_value_roundtrip():
    instance = notation_ExpandableNode(expanded=True, hasChildren=True, template="sample_text")
    assert instance.expanded == True
    instance.expanded = False
    assert instance.expanded == False


def test_notation_ExpandableNode_hasChildren_value_roundtrip():
    instance = notation_ExpandableNode(expanded=True, hasChildren=True, template="sample_text")
...
def test_notation_ExpandableNode_template_value_roundtrip():
    instance = notation_ExpandableNode(expanded=True, hasChildren=True, template="sample_text")
...
def test_notation_CategorySeparator_isa_Node():
    instance = notation_CategorySeparator(category="sample_text", newChildCodeSyncType="sample_text", newChildIcon="sample_text")
    assert isinstance(instance, Node)


def test_notation_ExpandableNode_isa_Node():
    instance = notation_ExpandableNode(expanded=True, hasChildren=True, template="sample_text")
    assert isinstance(instance, Node)


def test_notation_MindMapNode_isa_Node():
    instance = notation_MindMapNode()
    assert isinstance(instance, Node)
...
def test_assoc_persistentEdges11_link_reassign_clear():
    a = notation_Diagram(locationForNewElements="sample_text", name="sample_text", showLocationForNewElementsDialog=True)
    b1 = notation_Edge()
    b2 = notation_Edge()
...
notation_CategorySeparator_strategy = st.builds(notation_CategorySeparator, category=safe_text, newChildCodeSyncType=safe_text, newChildIcon=safe_text)
@given(instance=notation_CategorySeparator_strategy)
@settings(max_examples=25)
...
notation_Diagram_strategy = st.builds(notation_Diagram, locationForNewElements=safe_text, name=safe_text, showLocationForNewElementsDialog=st.booleans())
@given(instance=notation_Diagram_strategy)
@settings(max_examples=25)
...
notation_ExpandableNode_strategy = st.builds(notation_ExpandableNode, expanded=st.booleans(), hasChildren=st.booleans(), template=safe_text)
@given(instance=notation_ExpandableNode_strategy)
@settings(max_examples=25)
...
notation_MindMapNode_strategy = st.builds(notation_MindMapNode)
