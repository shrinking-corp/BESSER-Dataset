...
def test_UML2_MultiplicityElement_isa_Element():
    instance = UML2_MultiplicityElement()
    assert isinstance(instance, Element)
...
UML2_MultiplicityElement_strategy = st.builds(UML2_MultiplicityElement)
...
UML2_NamedElement_strategy = st.builds(UML2_NamedElement)
