...
# Classes
attacktree_Node = Class(name="attacktree_Node")
attacktree_Vulnerability = Class(name="attacktree_Vulnerability")
attacktree_EObject = Class(name="attacktree_EObject")
attacktree_Model = Class(name="attacktree_Model")
...
attacktree_Node.attributes={attacktree_Node_domains, attacktree_Node_description, attacktree_Node_tags, attacktree_Node_name}
...
attacktree_Vulnerability.attributes={attacktree_Vulnerability_name, attacktree_Vulnerability_description, attacktree_Vulnerability_severity, attacktree_Vulnerability_type, attacktree_Vulnerability_tags}
