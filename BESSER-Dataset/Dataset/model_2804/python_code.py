...
class attacktree_Vulnerability:
    ...
    def __init__(self, type: str, tags: str, severity: int, name: str, description: str, attacktree_Vulnerability: "attacktree_Node" = None):
        self.type = type
        self.tags = tags
...
class attacktree_Node:
    ...
    def __init__(self, name: str, description: str, tags: str, domains: str, attacktree_Node3: "attacktree_Node" = None, attacktree_Node1: set["attacktree_Node"] = None, attacktree_Node5: "attacktree_EObject" = None, attacktree_Node7: "attacktree_Model" = None, attacktree_Node: set["attacktree_Vulnerability"] = None):
        self.name = name
        self.description = description
        self.tags = tags
