...
opf_Package.attributes={opf_Package_includeReferencedResources, opf_Package_uniqueIdentifier, opf_Package_generateTableOfContents, opf_Package_version, opf_Package_generateCoverHTML}
...
opf_Item.attributes={opf_Item_fallback_style, opf_Item_title, opf_Item_required_modules, opf_Item_noToc, opf_Item_href, opf_Item_required_namespace, opf_Item_file, opf_Item_fallback, opf_Item_generated, opf_Item_media_type, opf_Item_id, opf_Item_sourcePath}
...
opf_Reference.attributes={opf_Reference_type, opf_Reference_title, opf_Reference_href}
...
domain_model = DomainModel(
    name="opf",
    types={opf_Metadata, opf_Package, opf_Tours, opf_Manifest, opf_Spine, opf_Guide, opf_Creator, opf_Subject, opf_Title, opf_Publisher, opf_Description, opf_Format, opf_Contributor, opf_Date, opf_Type, opf_Relation, opf_Coverage, opf_Identifier, opf_Source, opf_Language, opf_Meta, opf_Rights, opf_Item, opf_Itemref, opf_Reference, Role, Type},
    associations={metadata0, tours7, manifest1, spine3, guide5, creators11, titles9, publishers17, subjects13, descriptions15, formats25, contributors19, dates21, types23, relations33, coverages35, identifiers27, sources29, languages31, rights37, metas39, items41, spineItems43, guideItems45},
    generalizations={},
    metadata=None
)
