...
class opf_Package:
    ...
    def __init__(self, version: str, uniqueIdentifier: str, generateCoverHTML: bool, generateTableOfContents: bool, includeReferencedResources: bool, opf_Package: "opf_Metadata" = None, opf_Package8: "opf_Tours" = None, opf_Package2: "opf_Manifest" = None, opf_Package4: "opf_Spine" = None, opf_Package6: "opf_Guide" = None):
...
class opf_Item:
    ...
    def __init__(self, id: str, href: str, media_type: str, fallback: str, fallback_style: str, file: str, noToc: bool, title: str, generated: bool, sourcePath: str, required_namespace: str, required_modules: str, opf_Item: "opf_Manifest" = None):
        self.id = id
        self.href = href
