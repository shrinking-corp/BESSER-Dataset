...
public class OclExpression  {
    ...
    private ocl_constraints_OclPrecondition ocl_constraints_oclprecondition;
    ...
    private ocl_constraints_OclInvariant ocl_constraints_oclinvariant;
    ...
    public ocl_constraints_OclPrecondition getOcl_constraints_oclprecondition() {
        return ocl_constraints_oclprecondition;
    }

    public void setOcl_constraints_oclprecondition(ocl_constraints_OclPrecondition ocl_constraints_oclprecondition) {
        this.ocl_constraints_oclprecondition = ocl_constraints_oclprecondition;
    }
    ...
    public ocl_constraints_OclInvariant getOcl_constraints_oclinvariant() {
        return ocl_constraints_oclinvariant;
    }

    public void setOcl_constraints_oclinvariant(ocl_constraints_OclInvariant ocl_constraints_oclinvariant) {
        this.ocl_constraints_oclinvariant = ocl_constraints_oclinvariant;
    }
    public OCL_MapElement getOcl_mapelement() {
        return ocl_mapelement;
    }
