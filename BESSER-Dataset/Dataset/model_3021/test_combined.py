...
def test_hyp_javali_equality_is_not_abstract():
    assert not inspect.isabstract(javali_Equality)


def test_hyp_javali_equality_constructor_exists():
    assert callable(javali_Equality.__init__)


def test_hyp_javali_equality_constructor_args():
...
def test_hyp_javali_relation_is_not_abstract():
    assert not inspect.isabstract(javali_Relation)


def test_hyp_javali_relation_constructor_exists():
    assert callable(javali_Relation.__init__)


def test_hyp_javali_relation_constructor_args():
...
def test_hyp_javali_addition_is_not_abstract():
    assert not inspect.isabstract(javali_Addition)


def test_hyp_javali_addition_constructor_exists():
    assert callable(javali_Addition.__init__)


def test_hyp_javali_addition_constructor_args():
...
def test_hyp_javali_multiplication_is_not_abstract():
    assert not inspect.isabstract(javali_Multiplication)


def test_hyp_javali_multiplication_constructor_exists():
    assert callable(javali_Multiplication.__init__)


def test_hyp_javali_multiplication_constructor_args():
...
def test_hyp_javali_and_is_not_abstract():
    assert not inspect.isabstract(javali_And)


def test_hyp_javali_and_constructor_exists():
    assert callable(javali_And.__init__)


def test_hyp_javali_and_constructor_args():
    sig = inspect.signature(javali_And.__init__)
    params = list(sig.parameters.keys())



def test_hyp_javali_xor_is_not_abstract():
    assert not inspect.isabstract(javali_Xor)


def test_hyp_javali_xor_constructor_exists():
    assert callable(javali_Xor.__init__)


def test_hyp_javali_xor_constructor_args():
    sig = inspect.signature(javali_Xor.__init__)
    params = list(sig.parameters.keys())



def test_hyp_javali_or_is_not_abstract():
    assert not inspect.isabstract(javali_Or)


def test_hyp_javali_or_constructor_exists():
    assert callable(javali_Or.__init__)


def test_hyp_javali_or_constructor_args():
    sig = inspect.signature(javali_Or.__init__)
    params = list(sig.parameters.keys())



def test_hyp_javali_newobject_is_not_abstract():
    assert not inspect.isabstract(javali_NewObject)


def test_hyp_javali_newobject_constructor_exists():
    assert callable(javali_NewObject.__init__)


def test_hyp_javali_newobject_constructor_args():
    sig = inspect.signature(javali_NewObject.__init__)
    params = list(sig.parameters.keys())



def test_hyp_javali_newarray_is_not_abstract():
    assert not inspect.isabstract(javali_NewArray)


def test_hyp_javali_newarray_constructor_exists():
    assert callable(javali_NewArray.__init__)


def test_hyp_javali_newarray_constructor_args():
    sig = inspect.signature(javali_NewArray.__init__)
    params = list(sig.parameters.keys())



def test_hyp_javali_null_is_not_abstract():
    assert not inspect.isabstract(javali_Null)


def test_hyp_javali_null_constructor_exists():
    assert callable(javali_Null.__init__)


def test_hyp_javali_null_constructor_args():
    sig = inspect.signature(javali_Null.__init__)
    params = list(sig.parameters.keys())



def test_hyp_javali_varexpression_is_not_abstract():
    assert not inspect.isabstract(javali_VarExpression)


def test_hyp_javali_varexpression_constructor_exists():
    assert callable(javali_VarExpression.__init__)


def test_hyp_javali_varexpression_constructor_args():
    sig = inspect.signature(javali_VarExpression.__init__)
    params = list(sig.parameters.keys())



def test_hyp_javali_procedure_is_not_abstract():
    assert not inspect.isabstract(javali_Procedure)


def test_hyp_javali_procedure_constructor_exists():
    assert callable(javali_Procedure.__init__)


def test_hyp_javali_procedure_constructor_args():
...
def test_hyp_javali_record_is_not_abstract():
    assert not inspect.isabstract(javali_Record)


def test_hyp_javali_record_constructor_exists():
    assert callable(javali_Record.__init__)


def test_hyp_javali_record_constructor_args():
    sig = inspect.signature(javali_Record.__init__)
    params = list(sig.parameters.keys())



def test_hyp_javali_constant_is_not_abstract():
    assert not inspect.isabstract(javali_Constant)


def test_hyp_javali_constant_constructor_exists():
    assert callable(javali_Constant.__init__)


def test_hyp_javali_constant_constructor_args():
...
def test_hyp_javali_module_is_not_abstract():
    assert not inspect.isabstract(javali_Module)


def test_hyp_javali_module_constructor_exists():
    assert callable(javali_Module.__init__)


def test_hyp_javali_module_constructor_args():
    sig = inspect.signature(javali_Module.__init__)
    params = list(sig.parameters.keys())



def test_hyp_javali_expression_is_not_abstract():
    assert not inspect.isabstract(javali_Expression)


def test_hyp_javali_expression_constructor_exists():
    assert callable(javali_Expression.__init__)


def test_hyp_javali_expression_constructor_args():
...
def test_hyp_javali_increment_is_not_abstract():
    assert not inspect.isabstract(javali_Increment)


def test_hyp_javali_increment_constructor_exists():
    assert callable(javali_Increment.__init__)


def test_hyp_javali_increment_constructor_args():
    sig = inspect.signature(javali_Increment.__init__)
    params = list(sig.parameters.keys())



def test_hyp_javali_for_is_not_abstract():
    assert not inspect.isabstract(javali_For)


def test_hyp_javali_for_constructor_exists():
    assert callable(javali_For.__init__)


def test_hyp_javali_for_constructor_args():
    sig = inspect.signature(javali_For.__init__)
    params = list(sig.parameters.keys())



def test_hyp_javali_ifelse_is_not_abstract():
    assert not inspect.isabstract(javali_IfElse)


def test_hyp_javali_ifelse_constructor_exists():
    assert callable(javali_IfElse.__init__)


def test_hyp_javali_ifelse_constructor_args():
    sig = inspect.signature(javali_IfElse.__init__)
    params = list(sig.parameters.keys())



def test_hyp_javali_decrement_is_not_abstract():
    assert not inspect.isabstract(javali_Decrement)


def test_hyp_javali_decrement_constructor_exists():
    assert callable(javali_Decrement.__init__)


def test_hyp_javali_decrement_constructor_args():
    sig = inspect.signature(javali_Decrement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_javali_dowhile_is_not_abstract():
    assert not inspect.isabstract(javali_DoWhile)


def test_hyp_javali_dowhile_constructor_exists():
    assert callable(javali_DoWhile.__init__)


def test_hyp_javali_dowhile_constructor_args():
    sig = inspect.signature(javali_DoWhile.__init__)
    params = list(sig.parameters.keys())



def test_hyp_javali_varassign_is_not_abstract():
    assert not inspect.isabstract(javali_VarAssign)


def test_hyp_javali_varassign_constructor_exists():
    assert callable(javali_VarAssign.__init__)


def test_hyp_javali_varassign_constructor_args():
    sig = inspect.signature(javali_VarAssign.__init__)
    params = list(sig.parameters.keys())



def test_hyp_javali_continue_is_not_abstract():
    assert not inspect.isabstract(javali_Continue)


def test_hyp_javali_continue_constructor_exists():
    assert callable(javali_Continue.__init__)


def test_hyp_javali_continue_constructor_args():
    sig = inspect.signature(javali_Continue.__init__)
    params = list(sig.parameters.keys())



def test_hyp_javali_proccall_is_not_abstract():
    assert not inspect.isabstract(javali_ProcCall)


def test_hyp_javali_proccall_constructor_exists():
    assert callable(javali_ProcCall.__init__)


def test_hyp_javali_proccall_constructor_args():
    sig = inspect.signature(javali_ProcCall.__init__)
    params = list(sig.parameters.keys())



def test_hyp_javali_while_is_not_abstract():
    assert not inspect.isabstract(javali_While)


def test_hyp_javali_while_constructor_exists():
    assert callable(javali_While.__init__)


def test_hyp_javali_while_constructor_args():
    sig = inspect.signature(javali_While.__init__)
    params = list(sig.parameters.keys())



def test_hyp_javali_break_is_not_abstract():
    assert not inspect.isabstract(javali_Break)


def test_hyp_javali_break_constructor_exists():
    assert callable(javali_Break.__init__)


def test_hyp_javali_break_constructor_args():
    sig = inspect.signature(javali_Break.__init__)
    params = list(sig.parameters.keys())



def test_hyp_javali_return_is_not_abstract():
    assert not inspect.isabstract(javali_Return)


def test_hyp_javali_return_constructor_exists():
    assert callable(javali_Return.__init__)


def test_hyp_javali_return_constructor_args():
    sig = inspect.signature(javali_Return.__init__)
    params = list(sig.parameters.keys())



def test_hyp_javali_statement_is_not_abstract():
    assert not inspect.isabstract(javali_Statement)


def test_hyp_javali_statement_constructor_exists():
    assert callable(javali_Statement.__init__)


def test_hyp_javali_statement_constructor_args():
    sig = inspect.signature(javali_Statement.__init__)
    params = list(sig.parameters.keys())



def test_hyp_javali_block_is_not_abstract():
    assert not inspect.isabstract(javali_Block)


def test_hyp_javali_block_constructor_exists():
    assert callable(javali_Block.__init__)


def test_hyp_javali_block_constructor_args():
    sig = inspect.signature(javali_Block.__init__)
    params = list(sig.parameters.keys())



def test_hyp_javali_vardeclaration_is_not_abstract():
    assert not inspect.isabstract(javali_VarDeclaration)


def test_hyp_javali_vardeclaration_constructor_exists():
    assert callable(javali_VarDeclaration.__init__)


def test_hyp_javali_vardeclaration_constructor_args():
    sig = inspect.signature(javali_VarDeclaration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_javali_literal_is_not_abstract():
    assert not inspect.isabstract(javali_Literal)


def test_hyp_javali_literal_constructor_exists():
    assert callable(javali_Literal.__init__)


def test_hyp_javali_literal_constructor_args():
...
def test_hyp_javali_identifier_is_not_abstract():
    assert not inspect.isabstract(javali_Identifier)


def test_hyp_javali_identifier_constructor_exists():
    assert callable(javali_Identifier.__init__)


def test_hyp_javali_identifier_constructor_args():
...
def test_hyp_javali_type_is_not_abstract():
    assert not inspect.isabstract(javali_Type)


def test_hyp_javali_type_constructor_exists():
    assert callable(javali_Type.__init__)


def test_hyp_javali_type_constructor_args():
...
def test_hyp_javali_equality_operator_setter(instance):
...
def test_hyp_javali_relation_operator_setter(instance):
    original = instance.operator
    instance.operator = original
    assert instance.operator == original
...
def test_hyp_javali_addition_operator_setter(instance):
    original = instance.operator
    instance.operator = original
    assert instance.operator == original
...
def test_hyp_javali_multiplication_operator_setter(instance):
    original = instance.operator
    instance.operator = original
    assert instance.operator == original
...
def test_hyp_javali_procedure_comment_setter(instance):
...
@given(instance=javali_Procedure_strategy)
def test_hyp_javali_procedure_void_setter(instance):
...
@given(instance=javali_Procedure_strategy)
def test_hyp_javali_procedure_static_setter(instance):
...
def test_hyp_javali_constant_static_setter(instance):
    original = instance.static
    instance.static = original
    assert instance.static == original
...
def test_hyp_javali_literal_value_setter(instance):
...
def test_hyp_javali_identifier_id_setter(instance):
...
def test_hyp_javali_type_arrayDims_setter(instance):
