...
# Classes
javali_Type = Class(name="javali_Type")
javali_Identifier = Class(name="javali_Identifier")
javali_Literal = Class(name="javali_Literal")
javali_VarDeclaration = Class(name="javali_VarDeclaration")
javali_Block = Class(name="javali_Block")
javali_Statement = Class(name="javali_Statement")
javali_Return = Class(name="javali_Return")
Statement = Class(name="Statement")
javali_Expression = Class(name="javali_Expression")
javali_Break = Class(name="javali_Break")
javali_Continue = Class(name="javali_Continue")
javali_Module = Class(name="javali_Module")
javali_Constant = Class(name="javali_Constant")
javali_Record = Class(name="javali_Record")
javali_Procedure = Class(name="javali_Procedure")
javali_IfElse = Class(name="javali_IfElse")
javali_While = Class(name="javali_While")
javali_For = Class(name="javali_For")
javali_DoWhile = Class(name="javali_DoWhile")
javali_Increment = Class(name="javali_Increment")
javali_Decrement = Class(name="javali_Decrement")
javali_VarAssign = Class(name="javali_VarAssign")
javali_VarExpression = Class(name="javali_VarExpression")
javali_Null = Class(name="javali_Null")
javali_ProcCall = Class(name="javali_ProcCall")
javali_NewArray = Class(name="javali_NewArray")
javali_NewObject = Class(name="javali_NewObject")
javali_Or = Class(name="javali_Or")
javali_Xor = Class(name="javali_Xor")
javali_And = Class(name="javali_And")
Expression = Class(name="Expression")
javali_Relation = Class(name="javali_Relation")
javali_Addition = Class(name="javali_Addition")
javali_Multiplication = Class(name="javali_Multiplication")
javali_Equality = Class(name="javali_Equality")
...
javali_Procedure.attributes={javali_Procedure_void, javali_Procedure_static, javali_Procedure_comment}
...
domain_model = DomainModel(
    name="javali",
    types={javali_Type, javali_Identifier, javali_Literal, javali_VarDeclaration, javali_Block, javali_Statement, javali_Return, Statement, javali_Expression, javali_Break, javali_Continue, javali_Module, javali_Constant, javali_Record, javali_Procedure, javali_IfElse, javali_While, javali_For, javali_DoWhile, javali_Increment, javali_Decrement, javali_VarAssign, javali_VarExpression, javali_Null, javali_ProcCall, javali_NewArray, javali_NewObject, javali_Or, javali_Xor, javali_And, Expression, javali_Relation, javali_Addition, javali_Multiplication, javali_Equality},
    associations={type5, id7, value9, id11, fields14, retType16, id19, params22, body25, statements27, exp29, constants0, records1, procedures3, exp40, guard43, selectionBlock45, alternativeBlock48, guard51, block53, initStatements56, guard58, progressStatements61, block64, block67, type30, guard69, id33, init36, id72, id74, var39, parts76, arrayIndexes79, id82, args84, id87, type90, arrayDims92, type95, left97, right99, left102, right104, left107, left112, right114, left117, right119, left122, right124, left127, right129, right109},
    generalizations={gen_javali_Return_Statement, gen_javali_Break_Statement, gen_javali_Continue_Statement, gen_javali_VarDeclaration_Statement, gen_javali_IfElse_Statement, gen_javali_While_Statement, gen_javali_For_Statement, gen_javali_DoWhile_Statement, gen_javali_Increment_Statement, gen_javali_Decrement_Statement, gen_javali_VarAssign_Statement, gen_javali_Null_Expression, gen_javali_VarExpression_Expression, gen_javali_ProcCall_Statement, gen_javali_ProcCall_Expression, gen_javali_NewArray_Expression, gen_javali_NewObject_Expression, gen_javali_Or_Expression, gen_javali_Xor_Expression, gen_javali_And_Expression, gen_javali_Literal_Expression, gen_javali_Relation_Expression, gen_javali_Addition_Expression, gen_javali_Multiplication_Expression, gen_javali_Equality_Expression},
    metadata=None
)
