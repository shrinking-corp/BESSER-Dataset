...
class Service:
    ...
    def __init__(self, type: ServiceType_Interface, arrivalDateTime: str, departureDateTime: str, serviceName: str, serviceId: int, serviceTypeFactory0: set["ServiceTypeFactory"] = None, route10: "Route" = None, trainStats13: "TrainStats" = None):
        self.type = type
