...
Service.attributes={Service_serviceId, Service_arrivalDateTime, Service_departureDateTime, Service_type, Service_serviceName}
...
TrainStats.attributes={TrainStats_humidityAvg, TrainStats_tempAvg, TrainStats_fuelAvg, TrainStats_trainService, TrainStats_passengerCount}
...
InterCity.attributes={InterCity_interCityTrain, InterCity_builder}
...
Coach.attributes={Coach_capacity, Coach_temprature, Coach_coachType, Coach_totalPassengers, Coach_humidity}
...
Route.attributes={Route_source, Route_stops, Route_destination, Route_routeId}
