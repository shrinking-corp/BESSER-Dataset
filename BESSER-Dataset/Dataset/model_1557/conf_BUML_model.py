...
domain_model = DomainModel(
    name="conf",
    types={conf_Laboratory, conf_System, conf_Admin, conf_Conference, conf_RevisionProcess, conf_Session, conf_Location, conf_ProgramComitee, conf_SteeringComitee, conf_Contribution, conf_Researcher, conf_Publication, Person, conf_Evaluation, conf_Chapter, conf_RevisionNote, conf_Person},
    associations={laboratories1, admin0, revisonNotes33, conferences3, revisionProcess5, location7, progcomit8, steercomit10, contributions12, locations14, sessions17, researchers20, publications22, evaluations24, writes26, reviews28, chapters30, scPerson36, pcPerson38, publication41, evPubli44},
