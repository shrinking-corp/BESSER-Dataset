...
class db_DocumentRoot:
    ...
    def __init__(self, language: str, specialFeatures: str, mixed: str, db_DocumentRoot: set["db_EStringToStringMapEntry"] = None, db_DocumentRoot2: set["db_EStringToStringMapEntry"] = None, db_DocumentRoot5: set["db_CustomerType"] = None, db_DocumentRoot7: set["db_CriticsReviewType"] = None, db_DocumentRoot9: set["db_CustomerReviewType"] = None, db_DocumentRoot11: set["db_MovieDBType"] = None):
