...
# Classes
db_CriticsReviewType = Class(name="db_CriticsReviewType")
db_CustomerReviewType = Class(name="db_CustomerReviewType")
CriticsReviewType = Class(name="CriticsReviewType")
db_CustomerType = Class(name="db_CustomerType")
db_MovieDBType = Class(name="db_MovieDBType")
db_DocumentRoot = Class(name="db_DocumentRoot")
db_EStringToStringMapEntry = Class(name="db_EStringToStringMapEntry")
db_MovieType = Class(name="db_MovieType")
...
db_DocumentRoot.attributes={db_DocumentRoot_mixed, db_DocumentRoot_language, db_DocumentRoot_specialFeatures}
...
db_MovieType.attributes={db_MovieType_iD, db_MovieType_genre, db_MovieType_title, db_MovieType_director, db_MovieType_criticsReviewGroup, db_MovieType_any, db_MovieType_actors, db_MovieType_summary}
...
domain_model = DomainModel(
    name="db",
    types={db_CriticsReviewType, db_CustomerReviewType, CriticsReviewType, db_CustomerType, db_MovieDBType, db_DocumentRoot, db_EStringToStringMapEntry, db_MovieType, GenreTypes},
    associations={xMLNSPrefixMap0, xSISchemaLocation1, checkedOutBy4, criticsReview6, customerReview8, movieDB10, movie12, checkedOutBy17, criticsReview14},
