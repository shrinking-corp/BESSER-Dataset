...
essentialoclcs_BinaryOperatorCS = Class(name="essentialoclcs_BinaryOperatorCS")
...
essentialoclcs_ConstructorExpCS = Class(name="essentialoclcs_ConstructorExpCS")
NamedExpCS = Class(name="NamedExpCS")
essentialoclcs_ConstructorPartCS = Class(name="essentialoclcs_ConstructorPartCS")
...
essentialoclcs_OperatorCS = Class(name="essentialoclcs_OperatorCS", is_abstract=True)
...
essentialoclcs_IndexExpCS = Class(name="essentialoclcs_IndexExpCS")
...
essentialoclcs_InvocationExpCS = Class(name="essentialoclcs_InvocationExpCS")
...
essentialoclcs_NamedExpCS = Class(name="essentialoclcs_NamedExpCS", is_abstract=True)
essentialoclcs_NavigationOperatorCS = Class(name="essentialoclcs_NavigationOperatorCS")
...
essentialoclcs_UnaryOperatorCS = Class(name="essentialoclcs_UnaryOperatorCS")
...
essentialoclcs_AbstractNameExpCS.methods={essentialoclcs_AbstractNameExpCS_m_getNameExp, essentialoclcs_AbstractNameExpCS_m_getNamedElement, essentialoclcs_AbstractNameExpCS_m_getPathName}
...
in_44: BinaryAssociation = BinaryAssociation(
    name="in_44",
    ends={
...
domain_model = DomainModel(
    name="essentialoclcs",
    types={essentialoclcs_AbstractNameExpCS, ExpCS, essentialoclcs_BinaryOperatorCS, OperatorCS, essentialoclcs_ExpCS, essentialoclcs_BooleanLiteralExpCS, PrimitiveLiteralExpCS, essentialoclcs_CollectionLiteralExpCS, LiteralExpCS, essentialoclcs_CollectionTypeCS, essentialoclcs_CollectionLiteralPartCS, ModelElementCS, TypedRefCS, Nameable, essentialoclcs_TypedRefCS, essentialoclcs_ConstructorExpCS, NamedExpCS, essentialoclcs_ConstructorPartCS, essentialoclcs_Property, essentialoclcs_ContextCS, NamedElementCS, RootCS, essentialoclcs_OperatorCS, essentialoclcs_ExpSpecificationCS, SpecificationCS, essentialoclcs_IfExpCS, essentialoclcs_IndexExpCS, essentialoclcs_InfixExpCS, essentialoclcs_InvalidLiteralExpCS, essentialoclcs_InvocationExpCS, essentialoclcs_NavigatingArgCS, essentialoclcs_LetExpCS, essentialoclcs_LetVariableCS, VariableCS, essentialoclcs_LiteralExpCS, essentialoclcs_NameExpCS, AbstractNameExpCS, essentialoclcs_PathNameCS, essentialoclcs_NamedExpCS, essentialoclcs_NavigationOperatorCS, BinaryOperatorCS, essentialoclcs_NestedExpCS, essentialoclcs_NullLiteralExpCS, essentialoclcs_NumberLiteralExpCS, essentialoclcs_PrefixExpCS, essentialoclcs_UnaryOperatorCS, essentialoclcs_PrimitiveLiteralExpCS, essentialoclcs_SelfExpCS, essentialoclcs_StringLiteralExpCS, essentialoclcs_TupleLiteralExpCS, essentialoclcs_TupleLiteralPartCS, essentialoclcs_TypeLiteralExpCS, essentialoclcs_TypeNameExpCS, essentialoclcs_Type, essentialoclcs_UnlimitedNaturalLiteralExpCS, essentialoclcs_VariableCS, NavigationRole},
    associations={argument0, ownedType1, ownedParts2, expressionCS4, lastExpressionCS7, ownedType10, ownedParts12, property13, initExpression15, ownedExpression18, parent20, ownedExpression22, condition24, thenExpression26, elseExpression29, firstIndexes32, secondIndexes34, ownedExpression37, ownedOperator39, argument42, variable43, in_44, letExpression46, pathName47, nameExp48, navigatingExp50, name51, ownedType53, init56, source59, source61, ownedOperator64, ownedExpression65, ownedParts68, ownedType69, pathName71, element73, ownedType75, initExpression77},
    generalizations={gen_essentialoclcs_AbstractNameExpCS_ExpCS, gen_essentialoclcs_BinaryOperatorCS_OperatorCS, gen_essentialoclcs_BooleanLiteralExpCS_PrimitiveLiteralExpCS, gen_essentialoclcs_CollectionLiteralExpCS_LiteralExpCS, gen_essentialoclcs_CollectionLiteralPartCS_ModelElementCS, gen_essentialoclcs_CollectionTypeCS_TypedRefCS, gen_essentialoclcs_CollectionTypeCS_Nameable, gen_essentialoclcs_ConstructorExpCS_NamedExpCS, gen_essentialoclcs_ConstructorPartCS_ModelElementCS, gen_essentialoclcs_ConstructorPartCS_Nameable, gen_essentialoclcs_ContextCS_NamedElementCS, gen_essentialoclcs_ContextCS_RootCS, gen_essentialoclcs_ExpCS_ModelElementCS, gen_essentialoclcs_ExpSpecificationCS_SpecificationCS, gen_essentialoclcs_IfExpCS_ExpCS, gen_essentialoclcs_IndexExpCS_NamedExpCS, gen_essentialoclcs_InfixExpCS_ExpCS, gen_essentialoclcs_InvalidLiteralExpCS_PrimitiveLiteralExpCS, gen_essentialoclcs_InvocationExpCS_NamedExpCS, gen_essentialoclcs_LetExpCS_ExpCS, gen_essentialoclcs_LetVariableCS_VariableCS, gen_essentialoclcs_LetVariableCS_ExpCS, gen_essentialoclcs_LiteralExpCS_ExpCS, gen_essentialoclcs_NameExpCS_AbstractNameExpCS, gen_essentialoclcs_NamedExpCS_AbstractNameExpCS, gen_essentialoclcs_NavigatingArgCS_ModelElementCS, gen_essentialoclcs_NavigationOperatorCS_BinaryOperatorCS, gen_essentialoclcs_NestedExpCS_ExpCS, gen_essentialoclcs_NullLiteralExpCS_PrimitiveLiteralExpCS, gen_essentialoclcs_NumberLiteralExpCS_PrimitiveLiteralExpCS, gen_essentialoclcs_OperatorCS_NamedElementCS, gen_essentialoclcs_OperatorCS_ExpCS, gen_essentialoclcs_PrefixExpCS_ExpCS, gen_essentialoclcs_PrimitiveLiteralExpCS_LiteralExpCS, gen_essentialoclcs_SelfExpCS_ExpCS, gen_essentialoclcs_StringLiteralExpCS_PrimitiveLiteralExpCS, gen_essentialoclcs_TupleLiteralExpCS_LiteralExpCS, gen_essentialoclcs_TupleLiteralPartCS_VariableCS, gen_essentialoclcs_TypeLiteralExpCS_LiteralExpCS, gen_essentialoclcs_TypeNameExpCS_TypedRefCS, gen_essentialoclcs_UnaryOperatorCS_OperatorCS, gen_essentialoclcs_UnlimitedNaturalLiteralExpCS_PrimitiveLiteralExpCS, gen_essentialoclcs_VariableCS_NamedElementCS},
    metadata=None
)
