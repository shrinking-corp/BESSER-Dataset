...
class essentialoclcs_VariableCS(NamedElementCS):
    ...
    pass
class essentialoclcs_ContextCS(RootCS, NamedElementCS):
...
class essentialoclcs_CollectionTypeCS(Nameable, TypedRefCS):
    ...
    def __init__(self, name: str, essentialoclcs_CollectionTypeCS11: "essentialoclcs_TypedRefCS" = None, essentialoclcs_CollectionTypeCS: "essentialoclcs_CollectionLiteralExpCS" = None):
        self.name = name
...
class essentialoclcs_PrefixExpCS(ExpCS):
    ...
    pass
class essentialoclcs_OperatorCS(ExpCS, NamedElementCS):
