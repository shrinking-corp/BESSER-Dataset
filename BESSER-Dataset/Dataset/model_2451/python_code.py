...
class region_RgTransition(Referenced):
    ...
    def __init__(self, message: str, effect: str, event: str, region_RgTransition: "region_RgInitialPseudostate" = None, region_RgTransition7: "region_RgState" = None, region_RgTransition9: "region_RgState" = None):
...
class region_RgState(Named):
    ...
    def __init__(self, entry: str, exit: str, isFinal: bool, region_RgState: "region_RgRegion" = None, region_RgState6: set["region_RgTransition"] = None, region_RgState10: "region_RgTransition" = None):
        self.entry = entry
        self.exit = exit
