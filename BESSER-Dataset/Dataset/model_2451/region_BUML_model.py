...
region_RgTransition = Class(name="region_RgTransition")
region_RgRegion = Class(name="region_RgRegion")
ModelRoot = Class(name="ModelRoot")
region_RgInitialPseudostate = Class(name="region_RgInitialPseudostate")
region_RgState = Class(name="region_RgState")
...
region_RgState.attributes={region_RgState_isFinal, region_RgState_entry, region_RgState_exit}
...
domain_model = DomainModel(
    name="region",
    types={Named, region_RgTransition, region_RgRegion, ModelRoot, region_RgInitialPseudostate, region_RgState, Referenced},
    associations={initialTransition3, initialPseudostate0, states1, transitions5, target8},
    generalizations={gen_region_RgInitialPseudostate_Named, gen_region_RgState_Named, gen_region_RgRegion_ModelRoot, gen_region_RgTransition_Referenced},
    metadata=None
)
