...
def test_hyp_referenced_is_not_abstract():
    assert not inspect.isabstract(Referenced)


def test_hyp_referenced_constructor_exists():
    assert callable(Referenced.__init__)


def test_hyp_referenced_constructor_args():
...
def test_hyp_region_rgregion_is_not_abstract():
    assert not inspect.isabstract(region_RgRegion)


def test_hyp_region_rgregion_constructor_exists():
    assert callable(region_RgRegion.__init__)


def test_hyp_region_rgregion_constructor_args():
...
def test_hyp_region_rgtransition_is_not_abstract():
    assert not inspect.isabstract(region_RgTransition)


def test_hyp_region_rgtransition_constructor_exists():
    assert callable(region_RgTransition.__init__)


def test_hyp_region_rgtransition_constructor_args():
...
def test_hyp_region_rgstate_is_not_abstract():
    assert not inspect.isabstract(region_RgState)


def test_hyp_region_rgstate_constructor_exists():
    assert callable(region_RgState.__init__)


def test_hyp_region_rgstate_constructor_args():
...
def test_hyp_region_rginitialpseudostate_is_not_abstract():
    assert not inspect.isabstract(region_RgInitialPseudostate)


def test_hyp_region_rginitialpseudostate_constructor_exists():
    assert callable(region_RgInitialPseudostate.__init__)


def test_hyp_region_rginitialpseudostate_constructor_args():
...
def test_hyp_region_rgregion_containerClass_setter(instance):
...
def test_hyp_region_rgtransition_message_setter(instance):
...
@given(instance=region_RgTransition_strategy)
def test_hyp_region_rgtransition_event_setter(instance):
...
@given(instance=region_RgTransition_strategy)
def test_hyp_region_rgtransition_effect_setter(instance):
...
def test_hyp_region_rgstate_entry_setter(instance):
...
@given(instance=region_RgState_strategy)
def test_hyp_region_rgstate_exit_setter(instance):
...
@given(instance=region_RgState_strategy)
def test_hyp_region_rgstate_isFinal_setter(instance):
