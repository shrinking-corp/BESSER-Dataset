...
class FCORE_AttributeConstraint:
    ...
    def __init__(self, equation: str, target54: "FCORE_AttributeConstraintConnection" = None, AttributeConstraint: "FCORE_AttributeConstraintConnection" = None, FCORE_AttributeConstraint: "FCORE_FeatureModel" = None):
...
class FCORE_Attribute:
    ...
    def __init__(self, name: str, value: int, min: int, max: int, attribute: set["FCORE_InfluenceAttribute"] = None, FCORE_Attribute33: "FCORE_Feature" = None, Attribute: "FCORE_InfluenceAttribute" = None, FCORE_Attribute: "FCORE_FeatureModel" = None):
        self.name = name
        self.value = value
        self.min = min
        self.max = max
...
class FCORE_FeatureGroup:
    ...
    def __init__(self, min: int, max: int, target47: "FCORE_FeatureToGroupConnection" = None, source50: set["FCORE_GroupToFeatureConnection"] = None, FeatureGroup: "FCORE_FeatureToGroupConnection" = None, FeatureGroup72: "FCORE_GroupToFeatureConnection" = None, FCORE_FeatureGroup: "FCORE_FeatureModel" = None):
        self.min = min
        self.max = max
...
class FCORE_SolitaryFeature(Feature):
    ...
    def __init__(self, min: int, max: int, target: "FCORE_SingleFeatureConnection" = None, SolitaryFeature: "FCORE_SingleFeatureConnection" = None, FCORE_SolitaryFeature: "FCORE_FeatureModel" = None):
        self.min = min
        self.max = max
        self.target = target
...
class FCORE_Feature(ABC):
    ...
    def __init__(self, name: str, selected: bool, source: set["FCORE_AttributeConstraintConnection"] = None, FCORE_Feature: set["FCORE_Attribute"] = None, featureStart: set["FCORE_FeatureConstraint"] = None, featureEnd: set["FCORE_FeatureConstraint"] = None, feature: set["FCORE_InfluenceFeature"] = None, source39: set["FCORE_SingleFeatureConnection"] = None, source41: set["FCORE_FeatureToGroupConnection"] = None, Feature66: "FCORE_SingleFeatureConnection" = None, Feature69: "FCORE_FeatureToGroupConnection" = None, Feature: "FCORE_FeatureConstraint" = None, Feature59: "FCORE_FeatureConstraint" = None, Feature62: "FCORE_InfluenceFeature" = None, Feature75: "FCORE_AttributeConstraintConnection" = None):
        self.name = name
