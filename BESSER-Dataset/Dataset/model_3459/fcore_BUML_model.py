...
# Classes
FCORE_MandatoryConnection = Class(name="FCORE_MandatoryConnection")
FCORE_OptionalConnection = Class(name="FCORE_OptionalConnection")
FCORE_FeatureToGroupConnection = Class(name="FCORE_FeatureToGroupConnection")
FCORE_GroupToFeatureConnection = Class(name="FCORE_GroupToFeatureConnection")
FCORE_AttributeConstraintConnection = Class(name="FCORE_AttributeConstraintConnection")
FCORE_Feature = Class(name="FCORE_Feature", is_abstract=True)
FCORE_FeatureModel = Class(name="FCORE_FeatureModel")
FCORE_RootFeature = Class(name="FCORE_RootFeature")
FCORE_GroupFeature = Class(name="FCORE_GroupFeature")
FCORE_SolitaryFeature = Class(name="FCORE_SolitaryFeature")
FCORE_FeatureGroup = Class(name="FCORE_FeatureGroup")
FCORE_Attribute = Class(name="FCORE_Attribute")
FCORE_AttributeConstraint = Class(name="FCORE_AttributeConstraint")
FCORE_RequiresFeatureConstraint = Class(name="FCORE_RequiresFeatureConstraint")
FCORE_ExcludesFeatureConstraint = Class(name="FCORE_ExcludesFeatureConstraint")
FCORE_Softgoal = Class(name="FCORE_Softgoal")
FCORE_InfluenceFeature = Class(name="FCORE_InfluenceFeature")
FCORE_InfluenceAttribute = Class(name="FCORE_InfluenceAttribute")
FCORE_FeatureConstraint = Class(name="FCORE_FeatureConstraint", is_abstract=True)
FCORE_SingleFeatureConnection = Class(name="FCORE_SingleFeatureConnection", is_abstract=True)
Feature = Class(name="Feature")
FCORE_CardinalityConnection = Class(name="FCORE_CardinalityConnection")
SingleFeatureConnection = Class(name="SingleFeatureConnection")
FCORE_Influence = Class(name="FCORE_Influence", is_abstract=True)
FCORE_Conncection = Class(name="FCORE_Conncection", is_abstract=True)
...
FCORE_Feature.attributes={FCORE_Feature_selected, FCORE_Feature_name}
...
FCORE_SolitaryFeature.attributes={FCORE_SolitaryFeature_min, FCORE_SolitaryFeature_max}
...
FCORE_Attribute.attributes={FCORE_Attribute_min, FCORE_Attribute_max, FCORE_Attribute_value, FCORE_Attribute_name}
...
FCORE_CardinalityConnection.attributes={FCORE_CardinalityConnection_min, FCORE_CardinalityConnection_max}
...
domain_model = DomainModel(
    name="FCORE",
    types={FCORE_MandatoryConnection, FCORE_OptionalConnection, FCORE_FeatureToGroupConnection, FCORE_GroupToFeatureConnection, FCORE_AttributeConstraintConnection, FCORE_Feature, FCORE_FeatureModel, FCORE_RootFeature, FCORE_GroupFeature, FCORE_SolitaryFeature, FCORE_FeatureGroup, FCORE_Attribute, FCORE_AttributeConstraint, FCORE_RequiresFeatureConstraint, FCORE_ExcludesFeatureConstraint, FCORE_Softgoal, FCORE_InfluenceFeature, FCORE_InfluenceAttribute, FCORE_FeatureConstraint, FCORE_SingleFeatureConnection, Feature, FCORE_CardinalityConnection, SingleFeatureConnection, FCORE_Influence, FCORE_Conncection, Conncection, FeatureConstraint, Influence},
    associations={mandatoryConnections21, optionalConnections23, featureToGroupConnections25, groupToFeatureConnections27, AttributeConstraintConnections29, rootFeature0, groupFeatures1, solitaryFeatures3, featureGroups5, attributes7, attributeConstraints9, requiresFeatureConstraints11, excludesFeatureConstraints13, softgoals15, featureInfluences17, attributeInfluences19, groupToFeatureConnection44, featureToGroupConnection46, groupToFeatureConnections49, influences52, attributeConstraints31, attributes32, featureConstraintsStarts34, featureConstraintsEnds35, influences37, outgoingSingleFeatureConnections38, featureToGroupConnections40, incomingSingleFeatureConnection42, source65, target67, source68, attributeConstraintConnection53, influence56, featureStart57, featureEnd58, softgoal60, feature61, attribute63, target70, source71, target73, source74, target76},
    generalizations={gen_FCORE_RootFeature_Feature, gen_FCORE_SolitaryFeature_Feature, gen_FCORE_GroupFeature_Feature, gen_FCORE_SingleFeatureConnection_Conncection, gen_FCORE_CardinalityConnection_SingleFeatureConnection, gen_FCORE_MandatoryConnection_SingleFeatureConnection, gen_FCORE_OptionalConnection_SingleFeatureConnection, gen_FCORE_FeatureToGroupConnection_Conncection, gen_FCORE_FeatureConstraint_Conncection, gen_FCORE_RequiresFeatureConstraint_FeatureConstraint, gen_FCORE_ExcludesFeatureConstraint_FeatureConstraint, gen_FCORE_Influence_Conncection, gen_FCORE_InfluenceFeature_Influence, gen_FCORE_InfluenceAttribute_Influence, gen_FCORE_GroupToFeatureConnection_Conncection, gen_FCORE_AttributeConstraintConnection_Conncection},
    metadata=None
)
