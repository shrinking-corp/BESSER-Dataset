...
class coCoMM_Config:
    ...
    def __init__(self, selected: bool, type: str, coCoMM_Config: "coCoMM_Project" = None, coCoMM_Config53: "coCoMM_Stakeholder" = None, coCoMM_Config56: set["coCoMM_Feature"] = None):
...
class coCoMM_AggregationFunction:
    ...
    def __init__(self, operation: str, coCoMM_AggregationFunction71: "coCoMM_AttributeType" = None, coCoMM_AggregationFunction: "coCoMM_HardLimitCC" = None, coCoMM_AggregationFunction43: "coCoMM_OptimizationCC" = None):
...
class coCoMM_AttributeType:
    ...
    def __init__(self, id: str, name: str, dataType: str, coCoMM_AttributeType: "coCoMM_FeatureAttribute" = None, coCoMM_AttributeType27: "coCoMM_CoCo" = None, coCoMM_AttributeType72: "coCoMM_AggregationFunction" = None, coCoMM_AttributeType74: "coCoMM_OptimizationSC" = None):
        self.id = id
        self.name = name
...
class coCoMM_FeatureModel:
    ...
    def __init__(self, name: str, isDomain: bool, id: str, coCoMM_FeatureModel: "coCoMM_Feature" = None, coCoMM_FeatureModel2: set["coCoMM_CrossTreeConstraint"] = None, coCoMM_FeatureModel7: "coCoMM_Feature" = None, coCoMM_FeatureModel18: "coCoMM_CoCo" = None, coCoMM_FeatureModel35: "coCoMM_SelectionStateCC" = None):
        self.name = name
