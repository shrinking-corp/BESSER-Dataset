...
# Classes
coCoMM_FeatureModel = Class(name="coCoMM_FeatureModel")
coCoMM_Feature = Class(name="coCoMM_Feature")
coCoMM_CrossTreeConstraint = Class(name="coCoMM_CrossTreeConstraint")
coCoMM_TreeConstraint = Class(name="coCoMM_TreeConstraint")
coCoMM_FeatureAttribute = Class(name="coCoMM_FeatureAttribute")
coCoMM_AttributeType = Class(name="coCoMM_AttributeType")
coCoMM_CTConstraintExpression = Class(name="coCoMM_CTConstraintExpression")
coCoMM_CoCo = Class(name="coCoMM_CoCo")
coCoMM_CrossModelConstraint = Class(name="coCoMM_CrossModelConstraint")
coCoMM_SolutionConstraint = Class(name="coCoMM_SolutionConstraint")
coCoMM_ConfigurationConstraint = Class(name="coCoMM_ConfigurationConstraint")
coCoMM_Project = Class(name="coCoMM_Project")
coCoMM_Stakeholder = Class(name="coCoMM_Stakeholder")
coCoMM_CMConstraintExpression = Class(name="coCoMM_CMConstraintExpression")
coCoMM_SelectionStateCC = Class(name="coCoMM_SelectionStateCC")
ConfigurationConstraint = Class(name="ConfigurationConstraint")
coCoMM_HardLimitCC = Class(name="coCoMM_HardLimitCC")
coCoMM_HardLimitCCExpression = Class(name="coCoMM_HardLimitCCExpression")
coCoMM_AggregationFunction = Class(name="coCoMM_AggregationFunction")
coCoMM_OptimizationCC = Class(name="coCoMM_OptimizationCC")
coCoMM_Config = Class(name="coCoMM_Config")
coCoMM_OptimizationSC = Class(name="coCoMM_OptimizationSC")
...
coCoMM_FeatureModel.attributes={coCoMM_FeatureModel_isDomain, coCoMM_FeatureModel_name, coCoMM_FeatureModel_id}
...
coCoMM_Feature.attributes={coCoMM_Feature_name, coCoMM_Feature_abstract, coCoMM_Feature_mandatory, coCoMM_Feature_id}
...
coCoMM_FeatureAttribute.attributes={coCoMM_FeatureAttribute_maxValue, coCoMM_FeatureAttribute_minValue, coCoMM_FeatureAttribute_defaultValue}
...
coCoMM_AttributeType.attributes={coCoMM_AttributeType_name, coCoMM_AttributeType_id, coCoMM_AttributeType_dataType}
...
coCoMM_CoCo.attributes={coCoMM_CoCo_configScenario, coCoMM_CoCo_id, coCoMM_CoCo_name}
...
coCoMM_ConfigurationConstraint.attributes={coCoMM_ConfigurationConstraint_name, coCoMM_ConfigurationConstraint_type, coCoMM_ConfigurationConstraint_id}
...
coCoMM_Project.attributes={coCoMM_Project_target, coCoMM_Project_date, coCoMM_Project_name}
...
coCoMM_HardLimitCCExpression.attributes={coCoMM_HardLimitCCExpression_op, coCoMM_HardLimitCCExpression_value}
...
domain_model = DomainModel(
    name="coCoMM",
    types={coCoMM_FeatureModel, coCoMM_Feature, coCoMM_CrossTreeConstraint, coCoMM_TreeConstraint, coCoMM_FeatureAttribute, coCoMM_AttributeType, coCoMM_CTConstraintExpression, coCoMM_CoCo, coCoMM_CrossModelConstraint, coCoMM_SolutionConstraint, coCoMM_ConfigurationConstraint, coCoMM_Project, coCoMM_Stakeholder, coCoMM_CMConstraintExpression, coCoMM_SelectionStateCC, ConfigurationConstraint, coCoMM_HardLimitCC, coCoMM_HardLimitCCExpression, coCoMM_AggregationFunction, coCoMM_OptimizationCC, coCoMM_Config, coCoMM_OptimizationSC, SolutionConstraint, TreeConstraintType, DataType, CTConstraintType, CCType, CMConstraintType, CCSelectionStateType, CCOptimizationOp, CCHardLimitOp, ConfigType, AggregationOp, SCType, OptimizationSCFunct},
    associations={root0, ctConstraints1, treeConstraints3, featureModel5, featureAttributes8, children10, attrType13, expressions15, featureModels17, cmConstraints19, solutionConstraints21, configConstraints23, attributeTypes25, project28, stakeholders30, expressions32, featureModel34, feature36, expressions39, function40, funtion42, configConstraints44, solutionConstraints47, configs50, stakeholder52, features55, features58, expressions62, features64, expressions68, attrType70, attrType73},
    generalizations={gen_coCoMM_SelectionStateCC_ConfigurationConstraint, gen_coCoMM_HardLimitCC_ConfigurationConstraint, gen_coCoMM_OptimizationCC_ConfigurationConstraint, gen_coCoMM_OptimizationSC_SolutionConstraint},
    metadata=None
)
