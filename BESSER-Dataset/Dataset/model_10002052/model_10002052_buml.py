...
Admin_staff = Class(name="Admin_staff")
...
Employee.attributes={Employee_Emp_Name, Employee_Emp_Position, Employee_Emp_DOB, Employee_Emp_Email, Employee_Emp_NIC, Employee_Emp_Address, Employee_Emp_Department, Employee_Emp_Id, Employee_Emp_ContactNo, Employee_Emp_Date_Of_Joint}

# Admin_staff class attributes and methods
Admin_staff_UserName: Property = Property(name="UserName", type=StringType)
Admin_staff_Password: Property = Property(name="Password", type=StringType)
Admin_staff_Authendication_Mood: Property = Property(name="Authendication_Mood", type=StringType)
Admin_staff.attributes={Admin_staff_Authendication_Mood, Admin_staff_UserName, Admin_staff_Password}
...
Leave.attributes={Leave_Leave_StartDate, Leave_Leave_EndDate, Leave_Leave_NoOfDays, Leave_Leave_Status, Leave_Leave_Title, Leave_Leave_detail, Leave_Emp_Id, Leave_leave_id, Leave_Leave_ApplyDate}
...
Attendance.attributes={Attendance_Emp_id, Attendance_Leaving_Time, Attendance_Attend_date, Attendance_AttendTime}
...
domain_model = DomainModel(
    name="_lUvj4HwuEeqXrfTaScKTQA",
    types={Employee, Admin_staff, Leave, Attendance, Login, Employee_Management_System_Component, Authentication_UseCase, Salary_Management_UseCase, Administrator_Actor, Employee_Actor, Login_external, Logout_external},
    associations={Employee_Leave, Employee_Attendance, Employee_Login, Employee_Logout},
    generalizations={},
    metadata=None
)
