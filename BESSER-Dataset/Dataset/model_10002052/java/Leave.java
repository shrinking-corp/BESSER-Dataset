...
public class Leave  {
    ...
    public Leave(
        int Emp_Id,        LocalDate Leave_ApplyDate,        int Leave_NoOfDays,        String Leave_Status,        LocalDate Leave_StartDate,        int leave_id,        LocalDate Leave_EndDate,        String Leave_detail,        String Leave_Title    ) {
        this.Emp_Id = Emp_Id;
