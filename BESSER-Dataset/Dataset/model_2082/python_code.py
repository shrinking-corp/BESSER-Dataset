...
class rsgf_mw_Middleware:
    ...
    def __init__(self, rsgf_mw_Middleware21: "VM" = None, rsgf_mw_Middleware: set["Process"] = None):
...
class rsgf_skeleton_Skeleton:
    ...
    def __init__(self, ID: str, rsgf_skeleton_Skeleton10: set["Root"] = None, rsgf_skeleton_Skeleton: "Tree" = None):
        self.ID = ID
...
class rsgf_tree_BasicNode(Node):
    ...
    def __init__(self, modelName: str, Node: "rsgf_bundle_Process" = None):
