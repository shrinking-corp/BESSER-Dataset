...
types_RangeConstraint = Class(name="types_RangeConstraint")
...
types_ParameterizedType = Class(name="types_ParameterizedType")
...
types_Property.attributes={types_Property_external, types_Property_readonly, types_Property_const}
...
import_4: BinaryAssociation = BinaryAssociation(
    name="import_4",
    ends={
...
domain_model = DomainModel(
    name="types",
    types={AnnotatableElement, types_TypedElement, types_TypeSpecifier, types_Package, NamedElement, types_PackageMember, types_Domain, types_Type, PackageMember, types_TypeConstraint, types_Declaration, TypedElement, types_Operation, Declaration, types_Parameter, types_Property, types_RangeConstraint, TypeConstraint, types_TypeAlias, types_Annotation, types_EObject, types_Event, types_EnumerationType, PrimitiveType, types_Enumerator, types_PrimitiveType, Type, types_ComplexType, ParameterizedType, types_TypeParameter, types_ParameterizedType, types_AnnotatableElement, types_ArrayTypeSpecifier, TypeSpecifier, Direction},
    associations={owningOperation8, type9, typeSpecifier11, type13, typeArguments17, member0, domain1, import_4, constraint6, parameters7, parameter29, properties31, targets32, enumerator19, baseType21, features22, superTypes24, owningEnumeration26, bound27, annotations34},
    generalizations={gen_types_Parameter_TypedElement, gen_types_Parameter_NamedElement, gen_types_Parameter_AnnotatableElement, gen_types_Package_NamedElement, gen_types_Type_PackageMember, gen_types_Declaration_TypedElement, gen_types_Declaration_NamedElement, gen_types_Declaration_PackageMember, gen_types_Operation_Declaration, gen_types_Property_Declaration, gen_types_PackageMember_NamedElement, gen_types_PackageMember_AnnotatableElement, gen_types_RangeConstraint_TypeConstraint, gen_types_TypeAlias_TypedElement, gen_types_TypeAlias_Type, gen_types_Annotation_PackageMember, gen_types_Event_Declaration, gen_types_EnumerationType_PrimitiveType, gen_types_PrimitiveType_Type, gen_types_ComplexType_ParameterizedType, gen_types_Enumerator_Declaration, gen_types_TypeParameter_Type, gen_types_ParameterizedType_Type, gen_types_ArrayTypeSpecifier_TypeSpecifier},
    metadata=None
)
