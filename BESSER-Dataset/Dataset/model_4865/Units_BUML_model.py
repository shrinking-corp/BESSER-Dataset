...
# Classes
units_UnitCarryingElement = Class(name="units_UnitCarryingElement", is_abstract=True)
units_Unit = Class(name="units_Unit", is_abstract=True)
units_BaseUnit = Class(name="units_BaseUnit")
Unit = Class(name="Unit")
units_UnitRepository = Class(name="units_UnitRepository")
units_UnitMultiplication = Class(name="units_UnitMultiplication")
units_UnitPower = Class(name="units_UnitPower")
units_UnitDivision = Class(name="units_UnitDivision")
...
domain_model = DomainModel(
    name="units",
    types={units_UnitCarryingElement, units_Unit, units_BaseUnit, Unit, units_UnitRepository, units_UnitMultiplication, units_UnitPower, units_UnitDivision, UnitNames},
    associations={unit0, units1, units2, unit4, dividend6, divisor8},
    generalizations={gen_units_BaseUnit_Unit, gen_units_UnitMultiplication_Unit, gen_units_UnitPower_Unit, gen_units_UnitDivision_Unit},
    metadata=None
)
