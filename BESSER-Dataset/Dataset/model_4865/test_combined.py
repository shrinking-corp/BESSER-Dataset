...
def test_hyp_units_unitdivision_is_not_abstract():
    assert not inspect.isabstract(units_UnitDivision)


def test_hyp_units_unitdivision_constructor_exists():
    assert callable(units_UnitDivision.__init__)


def test_hyp_units_unitdivision_constructor_args():
...
def test_hyp_unitnames_exists():
    # Check that the Enumeration exists
    assert UnitNames is not None

def test_hyp_unitnames_has_all_literals():
