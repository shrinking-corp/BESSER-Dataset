...
ecore_EObject.methods={ecore_EObject_m_eContents, ecore_EObject_m_eUnset, ecore_EObject_m_eIsProxy, ecore_EObject_m_eClass, ecore_EObject_m_eContainmentFeature, ecore_EObject_m_eContainer, ecore_EObject_m_eGet, ecore_EObject_m_eAllContents, ecore_EObject_m_eResource, ecore_EObject_m_eIsSet, ecore_EObject_m_eContainingFeature, ecore_EObject_m_eCrossReferences, ecore_EObject_m_eSet, ecore_EObject_m_eGet}
...
ecore_EClass.methods={ecore_EClass_m_getFeatureCount, ecore_EClass_m_getFeatureID, ecore_EClass_m_isSuperTypeOf, ecore_EClass_m_getEStructuralFeature, ecore_EClass_m_getEStructuralFeature}
...
ecore_EFactory_m_create: Method = Method(name="create", parameters={Parameter(name='ecore_eClass', type=StringType)}, type=EObject)
...
ecore_ETypedElement.attributes={ecore_ETypedElement_upperBound, ecore_ETypedElement_unique, ecore_ETypedElement_many, ecore_ETypedElement_lowerBound, ecore_ETypedElement_ordered, ecore_ETypedElement_required}
...
domain_model = DomainModel(
    name="ecore",
    types={ecore_EAnnotation, EModelElement, ecore_EStringToStringMapEntry, ecore_EObject, EObject, ecore_EClass, EClassifier, ecore_EModelElement, ecore_EOperation, ecore_EAttribute, ecore_EStructuralFeature, ecore_EReference, ecore_EPackage, ecore_ETypeParameter, ecore_ENamedElement, ecore_EFactory, ecore_EGenericType, ecore_EClassifier, ENamedElement, ecore_EDataType, ecore_EClassifier_Wildcard, ETypedElement, ecore_EParameter, ecore_ETypedElement, EStructuralFeature, ecore_EStructuralFeature_Wildcard, ecore_EEnum, EDataType, ecore_EEnumLiteral},
    associations={details1, contents2, references4, eAnnotations7, eModelElement0, eSuperTypes9, eOperations10, eAllAttributes11, eStructuralFeatures13, eAllReferences15, eReferences17, eAttributes20, eAllContainments23, eAllOperations26, eAllStructuralFeatures28, eAllSuperTypes31, ePackage41, eTypeParameters42, eFactoryInstance43, eSubpackages45, eIDAttribute33, eGenericSuperTypes36, eAllGenericSuperTypes38, ePackage52, eBounds54, eUpperBound58, eTypeArguments61, eSuperPackage48, eClassifiers50, eTypeParameters75, eParameters78, eExceptions79, eGenericExceptions82, eContainingClass85, eRawType63, eLowerBound67, eTypeParameter69, eClassifier72, eOperation91, eAttributeType93, eContainingClass95, eType86, eGenericType88, eLiterals106, eEnum107, eOpposite98, eReferenceType100, eKeys103},
    generalizations={gen_ecore_EModelElement_EObject, gen_ecore_EClass_EClassifier, gen_ecore_EAnnotation_EModelElement, gen_ecore_ENamedElement_EModelElement, gen_ecore_EPackage_ENamedElement, gen_ecore_EClassifier_ENamedElement, gen_ecore_EDataType_EClassifier, gen_ecore_ETypeParameter_ENamedElement, gen_ecore_EGenericType_EObject, gen_ecore_EFactory_EModelElement, gen_ecore_EOperation_ETypedElement, gen_ecore_ETypedElement_ENamedElement, gen_ecore_EParameter_ETypedElement, gen_ecore_EAttribute_EStructuralFeature, gen_ecore_EStructuralFeature_ETypedElement, gen_ecore_EReference_EStructuralFeature, gen_ecore_EEnum_EDataType, gen_ecore_EEnumLiteral_ENamedElement},
    metadata=None
)
