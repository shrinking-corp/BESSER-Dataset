...
public class ecore_EClassifier extends ENamedElement {
    ...
    public ecore_EClassifier(
        String instanceClassName,        String defaultValue,        String instanceClass,        String instanceTypeName    ) {
        super(
        );
    ...
    public ecore_EClassifier(
        String instanceClassName,        String defaultValue,        String instanceClass,        String instanceTypeName        ArrayList<ecore_ETypeParameter> ecore_etypeparameters    ) {
        this.instanceClassName = instanceClassName;
        this.defaultValue = defaultValue;
        this.instanceClass = instanceClass;
        this.instanceTypeName = instanceTypeName;
