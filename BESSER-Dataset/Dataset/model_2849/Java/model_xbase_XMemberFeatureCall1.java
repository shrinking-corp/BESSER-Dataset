...
public class model_xbase_XMemberFeatureCall1 extends XAbstractFeatureCall {
    ...
    public model_xbase_XMemberFeatureCall1(
        boolean explicitStatic,        boolean explicitOperationCall,        boolean staticWithDeclaringType,        boolean typeLiteral,        boolean indexedOperation,        boolean packageFragment,        boolean nullSafe    ) {
        super(
        );
    ...
    public model_xbase_XMemberFeatureCall1(
        boolean explicitStatic,        boolean explicitOperationCall,        boolean staticWithDeclaringType,        boolean typeLiteral,        boolean indexedOperation,        boolean packageFragment,        boolean nullSafe        ArrayList<XExpression> xexpressions    ) {
        this.explicitStatic = explicitStatic;
        this.explicitOperationCall = explicitOperationCall;
        this.staticWithDeclaringType = staticWithDeclaringType;
        this.typeLiteral = typeLiteral;
