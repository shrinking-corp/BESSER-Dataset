...
domain_model = DomainModel(
    name="simpleuml",
    types={simpleuml_Classifier, simpleuml_Class, simpleuml_Association, PackageElement, Classifier, simpleuml_Attribute, UMLModelElement, simpleuml_Package, simpleuml_PackageElement, simpleuml_PrimitiveDataType, simpleuml_UMLModelElement},
    ...
    generalizations={gen_simpleuml_Association_PackageElement, gen_simpleuml_Class_Classifier, gen_simpleuml_Attribute_UMLModelElement, gen_simpleuml_Classifier_PackageElement, gen_simpleuml_Package_UMLModelElement, gen_simpleuml_PackageElement_UMLModelElement, gen_simpleuml_PrimitiveDataType_Classifier},
    metadata=None
)
