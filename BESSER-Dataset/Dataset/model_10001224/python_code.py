...
class Order:
    ...
    def __init__(self, status: OrderStatus, number: int, ordered: date, shipped: bool, shipTo: str, total: float, account17: "Account" = None, payment19: "Payment" = None, items14: set["LineItem"] = None):
        self.status = status
        self.number = number
