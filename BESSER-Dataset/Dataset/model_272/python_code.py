...
class ecore_EPackage(ENamedElement):
    ...
    def __init__(self, nsPrefix: str, nsURI: str, EPackage: "ecore_EClassifier" = None, ePackage: set["ecore_EClassifier"] = None, EPackage40: "ecore_EPackage" = None, eSuperPackage: set["ecore_EPackage"] = None, EPackage43: "ecore_EPackage" = None, eSubpackages: "ecore_EPackage" = None):
...
class ecore_EClassifier(ENamedElement):
    ...
    def __init__(self, instanceClassName: str, instanceClass: str, defaultValue: str, instanceTypeName: str, ecore_EClassifier: "ecore_EOperation" = None, eClassifiers: "ecore_EPackage" = None, EClassifier: "ecore_EPackage" = None, ecore_EClassifier58: "ecore_ETypedElement" = None):
...
class ecore_EClass(EClassifier):
    ...
    def __init__(self, abstract: bool, interface: bool, ecore_EClass: "ecore_EClass" = None, ecore_EClass1: set["ecore_EClass"] = None, ecore_EClass21: set["ecore_EStructuralFeature"] = None, ecore_EClass24: "ecore_EClass" = None, ecore_EClass22: set["ecore_EClass"] = None, ecore_EClass26: "ecore_EAttribute" = None, eContainingClass29: set["ecore_EStructuralFeature"] = None, eContainingClass: set["ecore_EOperation"] = None, ecore_EClass5: set["ecore_EAttribute"] = None, ecore_EClass8: set["ecore_EReference"] = None, ecore_EClass10: set["ecore_EReference"] = None, ecore_EClass13: set["ecore_EAttribute"] = None, ecore_EClass16: set["ecore_EReference"] = None, ecore_EClass19: set["ecore_EOperation"] = None, EClass: "ecore_EOperation" = None, ecore_EClass51: "ecore_EReference" = None, EClass56: "ecore_EStructuralFeature" = None):
