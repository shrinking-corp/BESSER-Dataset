...
# Classes
units_Unit = Class(name="units_Unit", is_abstract=True)
units_LengthUnit = Class(name="units_LengthUnit", is_abstract=True)
Unit = Class(name="Unit")
units_Inch = Class(name="units_Inch")
units_Yard = Class(name="units_Yard")
units_Centimeter = Class(name="units_Centimeter")
MetricSystemUnit = Class(name="MetricSystemUnit")
LengthUnit = Class(name="LengthUnit")
units_Millimeter = Class(name="units_Millimeter")
units_Meter = Class(name="units_Meter")
units_Foot = Class(name="units_Foot")
ImperialSystemUnit = Class(name="ImperialSystemUnit")
units_Quantity = Class(name="units_Quantity", is_abstract=True)
units_MetricSystemUnit = Class(name="units_MetricSystemUnit", is_abstract=True)
units_ImperialSystemUnit = Class(name="units_ImperialSystemUnit", is_abstract=True)
units_AngleUnit = Class(name="units_AngleUnit", is_abstract=True)
units_Radian = Class(name="units_Radian")
AngleUnit = Class(name="AngleUnit")
units_Degree = Class(name="units_Degree")
units_Turn = Class(name="units_Turn")
units_Gradian = Class(name="units_Gradian")
units_LengthDistinct = Class(name="units_LengthDistinct")
units_LengthSmaller = Class(name="units_LengthSmaller")
units_LengthGreater = Class(name="units_LengthGreater")
units_AngleOperation = Class(name="units_AngleOperation", is_abstract=True)
units_AngleAdd = Class(name="units_AngleAdd")
AngleOperation = Class(name="AngleOperation")
units_AngleSubtract = Class(name="units_AngleSubtract")
units_AngleScalarMultiply = Class(name="units_AngleScalarMultiply")
units_AngleScalarDivide = Class(name="units_AngleScalarDivide")
units_AngleEquals = Class(name="units_AngleEquals")
units_Length = Class(name="units_Length")
Quantity = Class(name="Quantity")
units_Angle = Class(name="units_Angle")
units_QuantityOperation = Class(name="units_QuantityOperation", is_abstract=True)
units_LengthOperation = Class(name="units_LengthOperation", is_abstract=True)
QuantityOperation = Class(name="QuantityOperation")
units_LengthAdd = Class(name="units_LengthAdd")
LengthOperation = Class(name="LengthOperation")
QuantityHomogenousOperation = Class(name="QuantityHomogenousOperation")
units_LengthSubtract = Class(name="units_LengthSubtract")
units_LengthScalarMultiply = Class(name="units_LengthScalarMultiply")
QuantityScalarOperation = Class(name="QuantityScalarOperation")
units_LengthScalarDivide = Class(name="units_LengthScalarDivide")
units_LengthEquals = Class(name="units_LengthEquals")
units_AngleDistinct = Class(name="units_AngleDistinct")
units_AngleSmaller = Class(name="units_AngleSmaller")
units_AngleGreater = Class(name="units_AngleGreater")
units_QuantityArithmeticOperation = Class(name="units_QuantityArithmeticOperation", is_abstract=True)
units_QuantityComparisonOperation = Class(name="units_QuantityComparisonOperation", is_abstract=True)
units_QuantityHomogenousOperation = Class(name="units_QuantityHomogenousOperation", is_abstract=True)
units_QuantityScalarOperation = Class(name="units_QuantityScalarOperation", is_abstract=True)
...
units_LengthUnit_m_toCm: Method = Method(name="toCm", parameters={Parameter(name='units_value', type=StringType)})
...
units_Inch_m_toCm: Method = Method(name="toCm", parameters={Parameter(name='units_value', type=StringType)})
...
units_Yard_m_toCm: Method = Method(name="toCm", parameters={Parameter(name='units_value', type=StringType)})
...
units_Centimeter_m_toCm: Method = Method(name="toCm", parameters={Parameter(name='units_value', type=StringType)})
...
units_Millimeter_m_toCm: Method = Method(name="toCm", parameters={Parameter(name='units_value', type=StringType)})
...
units_Meter_m_toCm: Method = Method(name="toCm", parameters={Parameter(name='units_value', type=StringType)})
...
units_Foot_m_toCm: Method = Method(name="toCm", parameters={Parameter(name='units_value', type=StringType)})
units_Foot.methods={units_Foot_m_getSymbol, units_Foot_m_toCm}
...
units_AngleUnit_m_toRad: Method = Method(name="toRad", parameters={Parameter(name='units_value', type=StringType)})
...
units_Radian_m_toRad: Method = Method(name="toRad", parameters={Parameter(name='units_value', type=StringType)})
...
units_Degree_m_toRad: Method = Method(name="toRad", parameters={Parameter(name='units_value', type=StringType)})
...
units_Turn_m_toRad: Method = Method(name="toRad", parameters={Parameter(name='units_value', type=StringType)})
...
units_Gradian_m_toRad: Method = Method(name="toRad", parameters={Parameter(name='units_value', type=StringType)})
...
units_Angle.methods={units_Angle_m_print, units_Angle_m_toRad}
...
domain_model = DomainModel(
    name="units",
    types={units_Unit, units_LengthUnit, Unit, units_Inch, units_Yard, units_Centimeter, MetricSystemUnit, LengthUnit, units_Millimeter, units_Meter, units_Foot, ImperialSystemUnit, units_Quantity, units_MetricSystemUnit, units_ImperialSystemUnit, units_AngleUnit, units_Radian, AngleUnit, units_Degree, units_Turn, units_Gradian, units_LengthDistinct, units_LengthSmaller, units_LengthGreater, units_AngleOperation, units_AngleAdd, AngleOperation, units_AngleSubtract, units_AngleScalarMultiply, units_AngleScalarDivide, units_AngleEquals, units_Length, Quantity, units_Angle, units_QuantityOperation, units_LengthOperation, QuantityOperation, units_LengthAdd, LengthOperation, QuantityHomogenousOperation, units_LengthSubtract, units_LengthScalarMultiply, QuantityScalarOperation, units_LengthScalarDivide, units_LengthEquals, units_AngleDistinct, units_AngleSmaller, units_AngleGreater, units_QuantityArithmeticOperation, units_QuantityComparisonOperation, units_QuantityHomogenousOperation, units_QuantityScalarOperation},
    associations={unit0, lhs1, rhs3, lhs6},
    generalizations={gen_units_LengthUnit_Unit, gen_units_Inch_ImperialSystemUnit, gen_units_Inch_LengthUnit, gen_units_Yard_ImperialSystemUnit, gen_units_Yard_LengthUnit, gen_units_Centimeter_MetricSystemUnit, gen_units_Centimeter_LengthUnit, gen_units_Millimeter_MetricSystemUnit, gen_units_Millimeter_LengthUnit, gen_units_Meter_MetricSystemUnit, gen_units_Meter_LengthUnit, gen_units_Foot_ImperialSystemUnit, gen_units_Foot_LengthUnit, gen_units_MetricSystemUnit_Unit, gen_units_ImperialSystemUnit_Unit, gen_units_AngleUnit_Unit, gen_units_Radian_AngleUnit, gen_units_Degree_AngleUnit, gen_units_Turn_AngleUnit, gen_units_Gradian_AngleUnit, gen_units_LengthDistinct_LengthOperation, gen_units_LengthDistinct_QuantityHomogenousOperation, gen_units_LengthSmaller_LengthOperation, gen_units_LengthSmaller_QuantityHomogenousOperation, gen_units_LengthGreater_LengthOperation, gen_units_LengthGreater_QuantityHomogenousOperation, gen_units_AngleOperation_QuantityOperation, gen_units_AngleAdd_AngleOperation, gen_units_AngleAdd_QuantityHomogenousOperation, gen_units_AngleSubtract_AngleOperation, gen_units_AngleSubtract_QuantityHomogenousOperation, gen_units_AngleScalarMultiply_AngleOperation, gen_units_AngleScalarMultiply_QuantityScalarOperation, gen_units_AngleScalarDivide_AngleOperation, gen_units_AngleScalarDivide_QuantityScalarOperation, gen_units_AngleEquals_AngleOperation, gen_units_AngleEquals_QuantityHomogenousOperation, gen_units_Length_Quantity, gen_units_Angle_Quantity, gen_units_LengthOperation_QuantityOperation, gen_units_LengthAdd_LengthOperation, gen_units_LengthAdd_QuantityHomogenousOperation, gen_units_LengthSubtract_LengthOperation, gen_units_LengthSubtract_QuantityHomogenousOperation, gen_units_LengthScalarMultiply_LengthOperation, gen_units_LengthScalarMultiply_QuantityScalarOperation, gen_units_LengthScalarDivide_LengthOperation, gen_units_LengthScalarDivide_QuantityScalarOperation, gen_units_LengthEquals_LengthOperation, gen_units_LengthEquals_QuantityHomogenousOperation, gen_units_AngleDistinct_AngleOperation, gen_units_AngleDistinct_QuantityHomogenousOperation, gen_units_AngleSmaller_AngleOperation, gen_units_AngleSmaller_QuantityHomogenousOperation, gen_units_AngleGreater_AngleOperation, gen_units_AngleGreater_QuantityHomogenousOperation, gen_units_QuantityArithmeticOperation_QuantityOperation, gen_units_QuantityComparisonOperation_QuantityOperation, gen_units_QuantityHomogenousOperation_QuantityOperation, gen_units_QuantityScalarOperation_QuantityOperation},
    metadata=None
)
