...
def test_hyp_statesml_changeexpression_is_not_abstract():
    assert not inspect.isabstract(statesml_ChangeExpression)


def test_hyp_statesml_changeexpression_constructor_exists():
    assert callable(statesml_ChangeExpression.__init__)


def test_hyp_statesml_changeexpression_constructor_args():
...
def test_hyp_statesml_boolean_is_not_abstract():
    assert not inspect.isabstract(statesml_Boolean)


def test_hyp_statesml_boolean_constructor_exists():
    assert callable(statesml_Boolean.__init__)


def test_hyp_statesml_boolean_constructor_args():
    sig = inspect.signature(statesml_Boolean.__init__)
    params = list(sig.parameters.keys())



def test_hyp_statesml_integer_is_not_abstract():
    assert not inspect.isabstract(statesml_Integer)


def test_hyp_statesml_integer_constructor_exists():
    assert callable(statesml_Integer.__init__)


def test_hyp_statesml_integer_constructor_args():
    sig = inspect.signature(statesml_Integer.__init__)
    params = list(sig.parameters.keys())



def test_hyp_statesml_string_is_not_abstract():
    assert not inspect.isabstract(statesml_String)


def test_hyp_statesml_string_constructor_exists():
    assert callable(statesml_String.__init__)


def test_hyp_statesml_string_constructor_args():
    sig = inspect.signature(statesml_String.__init__)
    params = list(sig.parameters.keys())



def test_hyp_statesml_parametervalue_is_not_abstract():
    assert not inspect.isabstract(statesml_ParameterValue)


def test_hyp_statesml_parametervalue_constructor_exists():
    assert callable(statesml_ParameterValue.__init__)


def test_hyp_statesml_parametervalue_constructor_args():
...
def test_hyp_statesml_middlestate_is_not_abstract():
    assert not inspect.isabstract(statesml_MiddleState)


def test_hyp_statesml_middlestate_constructor_exists():
    assert callable(statesml_MiddleState.__init__)


def test_hyp_statesml_middlestate_constructor_args():
...
def test_hyp_statesml_functioncall_is_not_abstract():
    assert not inspect.isabstract(statesml_FunctionCall)


def test_hyp_statesml_functioncall_constructor_exists():
    assert callable(statesml_FunctionCall.__init__)


def test_hyp_statesml_functioncall_constructor_args():
...
def test_hyp_statesml_incomingparameter_is_not_abstract():
    assert not inspect.isabstract(statesml_IncomingParameter)


def test_hyp_statesml_incomingparameter_constructor_exists():
    assert callable(statesml_IncomingParameter.__init__)


def test_hyp_statesml_incomingparameter_constructor_args():
    sig = inspect.signature(statesml_IncomingParameter.__init__)
    params = list(sig.parameters.keys())



def test_hyp_statesml_returnparameter_is_not_abstract():
    assert not inspect.isabstract(statesml_ReturnParameter)


def test_hyp_statesml_returnparameter_constructor_exists():
    assert callable(statesml_ReturnParameter.__init__)


def test_hyp_statesml_returnparameter_constructor_args():
...
def test_hyp_statesml_statesystem_is_not_abstract():
    assert not inspect.isabstract(statesml_StateSystem)


def test_hyp_statesml_statesystem_constructor_exists():
    assert callable(statesml_StateSystem.__init__)


def test_hyp_statesml_statesystem_constructor_args():
    sig = inspect.signature(statesml_StateSystem.__init__)
    params = list(sig.parameters.keys())



def test_hyp_statesml_statesystemmodel_is_not_abstract():
    assert not inspect.isabstract(statesml_StateSystemModel)


def test_hyp_statesml_statesystemmodel_constructor_exists():
    assert callable(statesml_StateSystemModel.__init__)


def test_hyp_statesml_statesystemmodel_constructor_args():
...
def test_hyp_statesml_statesmodel_is_not_abstract():
    assert not inspect.isabstract(statesml_StatesModel)


def test_hyp_statesml_statesmodel_constructor_exists():
    assert callable(statesml_StatesModel.__init__)


def test_hyp_statesml_statesmodel_constructor_args():
    sig = inspect.signature(statesml_StatesModel.__init__)
    params = list(sig.parameters.keys())



def test_hyp_statesml_systemunitmodel_is_not_abstract():
    assert not inspect.isabstract(statesml_SystemUnitModel)


def test_hyp_statesml_systemunitmodel_constructor_exists():
    assert callable(statesml_SystemUnitModel.__init__)


def test_hyp_statesml_systemunitmodel_constructor_args():
...
def test_hyp_statesml_changeexpression_fulfilled_setter(instance):
...
def test_hyp_statesml_statesystemmodel_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_statesml_systemunitmodel_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
