...
# Classes
statesml_SystemUnitModel = Class(name="statesml_SystemUnitModel")
statesml_StatesModel = Class(name="statesml_StatesModel")
statesml_Attribute = Class(name="statesml_Attribute")
statesml_DataType = Class(name="statesml_DataType", is_abstract=True)
statesml_DataTypeLibrary = Class(name="statesml_DataTypeLibrary")
statesml_SystemUnitLibrary = Class(name="statesml_SystemUnitLibrary")
statesml_Function = Class(name="statesml_Function")
statesml_SystemUnit = Class(name="statesml_SystemUnit")
statesml_StateSystemModel = Class(name="statesml_StateSystemModel")
statesml_StateSystem = Class(name="statesml_StateSystem")
statesml_Node = Class(name="statesml_Node", is_abstract=True)
statesml_Edge = Class(name="statesml_Edge")
statesml_ReturnParameter = Class(name="statesml_ReturnParameter")
statesml_IncomingParameter = Class(name="statesml_IncomingParameter")
statesml_Parameter = Class(name="statesml_Parameter", is_abstract=True)
...
statesml_FunctionCall = Class(name="statesml_FunctionCall")
...
statesml_MiddleState = Class(name="statesml_MiddleState")
statesml_ChangeEvent = Class(name="statesml_ChangeEvent")
Event = Class(name="Event")
statesml_ParameterValue = Class(name="statesml_ParameterValue")
statesml_String = Class(name="statesml_String")
DataType = Class(name="DataType")
statesml_Integer = Class(name="statesml_Integer")
statesml_Boolean = Class(name="statesml_Boolean")
statesml_ChangeExpression = Class(name="statesml_ChangeExpression")
...
domain_model = DomainModel(
    name="statesml",
    types={statesml_SystemUnitModel, statesml_StatesModel, statesml_Attribute, statesml_DataType, statesml_DataTypeLibrary, statesml_SystemUnitLibrary, statesml_Function, statesml_SystemUnit, statesml_StateSystemModel, statesml_StateSystem, statesml_Node, statesml_Edge, statesml_ReturnParameter, statesml_IncomingParameter, statesml_Parameter, statesml_Event, statesml_SelectionConvergence, Parameter_, statesml_State, Node, statesml_FunctionCall, statesml_Transition, statesml_Trigger, statesml_SelectionDivergence, statesml_InitialState, State, statesml_TerminalState, statesml_MiddleState, statesml_ChangeEvent, Event, statesml_ParameterValue, statesml_String, DataType, statesml_Integer, statesml_Boolean, statesml_ChangeExpression},
    associations={systemunits0, attribute12, function15, datatype1, datatype18, datatypelibrary2, systemunitlibrary4, function6, systemunit8, statesystemmodel10, datatype25, statesystem27, node29, edge31, returnparameter21, incomingparameter23, outgoing38, incoming39, source41, target42, attribute33, event36, event46, attribute49, functioncall44, trigger45, function52, parametervalue55, changeexpression57, function58, incomingparameter61, incomingparameter64},
    generalizations={gen_statesml_SelectionConvergence_Node, gen_statesml_ReturnParameter_Parameter, gen_statesml_IncomingParameter_Parameter, gen_statesml_State_Node, gen_statesml_Transition_Node, gen_statesml_SelectionDivergence_Node, gen_statesml_InitialState_State, gen_statesml_TerminalState_State, gen_statesml_MiddleState_State, gen_statesml_ChangeEvent_Event, gen_statesml_String_DataType, gen_statesml_Integer_DataType, gen_statesml_Boolean_DataType},
    metadata=None
)
