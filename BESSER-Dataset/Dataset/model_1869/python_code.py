...
class statesml_SystemUnit:
    ...
    def __init__(self, name: str, statesml_SystemUnit13: set["statesml_Attribute"] = None, statesml_SystemUnit16: set["statesml_Function"] = None, statesml_SystemUnit: "statesml_SystemUnitLibrary" = None, statesml_SystemUnit11: "statesml_StateSystemModel" = None):
        self.name = name
...
class statesml_Function:
    ...
    def __init__(self, name: str, statesml_Function17: "statesml_SystemUnit" = None, statesml_Function: "statesml_DataType" = None, statesml_Function22: "statesml_ReturnParameter" = None, statesml_Function24: set["statesml_IncomingParameter"] = None, statesml_Function54: "statesml_FunctionCall" = None, statesml_Function60: "statesml_ChangeExpression" = None):
        self.name = name
...
class statesml_DataTypeLibrary:
    ...
    def __init__(self, name: str, statesml_DataTypeLibrary19: set["statesml_DataType"] = None, statesml_DataTypeLibrary: "statesml_SystemUnitModel" = None):
        self.name = name
...
class statesml_DataType(ABC):
    ...
    def __init__(self, name: str, statesml_DataType: "statesml_Attribute" = None, statesml_DataType20: "statesml_DataTypeLibrary" = None, statesml_DataType7: set["statesml_Function"] = None, statesml_DataType26: "statesml_Parameter" = None):
        self.name = name
...
class statesml_Attribute:
    ...
    def __init__(self, name: str, statesml_Attribute14: "statesml_SystemUnit" = None, statesml_Attribute: "statesml_DataType" = None, statesml_Attribute35: "statesml_StateSystem" = None, statesml_Attribute51: "statesml_IncomingParameter" = None):
        self.name = name
