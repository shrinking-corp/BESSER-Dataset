...
class mgraph_MEdge:
    ...
    def __init__(self, name: str, MEdge: "mgraph_MGraph" = None, to: "mgraph_MNode" = None, from_: "mgraph_MNode" = None, edges: "mgraph_MGraph" = None, MEdge13: "mgraph_MNode" = None, MEdge11: "mgraph_MNode" = None):
        self.name = name
        self.MEdge = MEdge
        self.to = to
        self.from_ = from_
    ...
    def from_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_mgraph_MEdge__from_", None)
        self.__from_ = value
...
class mgraph_MNode:
    ...
    def __init__(self, name: str, MNode4: "mgraph_MEdge" = None, MNode6: "mgraph_MEdge" = None, nodes: "mgraph_MGraph" = None, inComing: set["mgraph_MEdge"] = None, outGoing: set["mgraph_MEdge"] = None, MNode: "mgraph_MGraph" = None):
        self.name = name
        self.MNode4 = MNode4
        self.MNode6 = MNode6
        self.nodes = nodes
...
class mgraph_MGraph:
    ...
    def __init__(self, name: str, graph2: set["mgraph_MEdge"] = None, MGraph: "mgraph_MEdge" = None, MGraph9: "mgraph_MNode" = None, graph: set["mgraph_MNode"] = None):
        self.name = name
