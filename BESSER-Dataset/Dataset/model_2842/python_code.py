...
class alf_DocumentedStatement:
    ...
    def __init__(self, comment: str, alf_DocumentedStatement243: "alf_NonEmptyStatementSequence" = None, alf_DocumentedStatement: "alf_StatementSequence" = None, alf_DocumentedStatement200: "alf_Statement" = None):
...
class alf_SelectOrRejectOperation(SequenceExpansionExpression):
    ...
    def __init__(self, expr2: str, expr3: str, expr4: str, op: str, expr1: str):
        self.expr2 = expr2
        self.expr3 = expr3
        self.expr4 = expr4
        self.op = op
...
class alf_ShiftExpression:
    ...
    def __init__(self, op: str, alf_ShiftExpression100: set["alf_AdditiveExpression"] = None, alf_ShiftExpression: "alf_RelationalExpression" = None, alf_ShiftExpression98: "alf_RelationalExpression" = None):
        self.op = op
...
class alf_NameExpression(ValueSpecification, NonLiteralValueSpecification):
    ...
    def __init__(self, prefixOp: str, id: str, postfixOp: str, alf_NameExpression: "alf_QualifiedNamePath" = None, alf_NameExpression44: "alf_Tuple" = None, alf_NameExpression46: "alf_SequenceConstructionOrAccessCompletion" = None, alf_NameExpression48: "alf_SuffixExpression" = None, alf_NameExpression93: "alf_ClassificationExpression" = None, alf_NameExpression307: "alf_InvocationOrAssignementOrDeclarationStatement" = None):
...
class alf_QualifiedNameWithBinding:
    ...
    def __init__(self, id: str, alf_QualifiedNameWithBinding: "alf_TypeName" = None, alf_QualifiedNameWithBinding139: "alf_SequenceReductionExpression" = None, alf_QualifiedNameWithBinding58: "alf_NamedTemplateBinding" = None, alf_QualifiedNameWithBinding60: "alf_TemplateBinding" = None, alf_QualifiedNameWithBinding64: "alf_QualifiedNameWithBinding" = None, alf_QualifiedNameWithBinding62: "alf_QualifiedNameWithBinding" = None, alf_QualifiedNameWithBinding162: "alf_InstanceCreationExpression" = None, alf_QualifiedNameWithBinding205: "alf_LocalNameDeclarationStatement" = None, alf_QualifiedNameWithBinding305: "alf_QualifiedNameList" = None):
        self.id = id
