...
# Classes
alf_Operations = Class(name="alf_Operations")
...
alf_NUMBER_LITERAL_WITHOUT_SUFFIX = Class(name="alf_NUMBER_LITERAL_WITHOUT_SUFFIX")
alf_INTEGER_LITERAL_WITHOUT_SUFFIX = Class(name="alf_INTEGER_LITERAL_WITHOUT_SUFFIX")
NUMBER_LITERAL_WITHOUT_SUFFIX = Class(name="NUMBER_LITERAL_WITHOUT_SUFFIX")
alf_UNLIMITED_LITERAL_WITHOUT_SUFFIX = Class(name="alf_UNLIMITED_LITERAL_WITHOUT_SUFFIX")
alf_QualifiedNameWithBinding = Class(name="alf_QualifiedNameWithBinding")
alf_QualifiedNameList = Class(name="alf_QualifiedNameList")
alf_Test = Class(name="alf_Test")
...
alf_UNLIMITED_LITERAL = Class(name="alf_UNLIMITED_LITERAL")
alf_STRING_LITERAL = Class(name="alf_STRING_LITERAL")
alf_NameExpression = Class(name="alf_NameExpression")
NonLiteralValueSpecification = Class(name="NonLiteralValueSpecification")
alf_QualifiedNamePath = Class(name="alf_QualifiedNamePath")
alf_Tuple = Class(name="alf_Tuple")
alf_SequenceConstructionOrAccessCompletion = Class(name="alf_SequenceConstructionOrAccessCompletion")
alf_UnqualifiedName = Class(name="alf_UnqualifiedName")
alf_TemplateBinding = Class(name="alf_TemplateBinding")
alf_AssignmentCompletion = Class(name="alf_AssignmentCompletion")
alf_Statement = Class(name="alf_Statement")
alf_LITERAL = Class(name="alf_LITERAL")
ValueSpecification = Class(name="ValueSpecification")
alf_SuffixExpression = Class(name="alf_SuffixExpression")
alf_BOOLEAN_LITERAL = Class(name="alf_BOOLEAN_LITERAL")
LITERAL = Class(name="LITERAL")
SequenceElement = Class(name="SequenceElement")
alf_ConditionalTestExpression = Class(name="alf_ConditionalTestExpression")
...
alf_TupleElement = Class(name="alf_TupleElement")
...
alf_ValueSpecification = Class(name="alf_ValueSpecification")
alf_OperationCallExpression = Class(name="alf_OperationCallExpression")
SuffixExpression = Class(name="SuffixExpression")
alf_OperationCallExpressionWithoutDot = Class(name="alf_OperationCallExpressionWithoutDot")
alf_RelationalExpression = Class(name="alf_RelationalExpression")
alf_ShiftExpression = Class(name="alf_ShiftExpression")
alf_LinkOperationExpression = Class(name="alf_LinkOperationExpression")
alf_LinkOperationTuple = Class(name="alf_LinkOperationTuple")
alf_LinkOperationTupleElement = Class(name="alf_LinkOperationTupleElement")
alf_PropertyCallExpression = Class(name="alf_PropertyCallExpression")
alf_SequenceOperationExpression = Class(name="alf_SequenceOperationExpression")
alf_SequenceReductionExpression = Class(name="alf_SequenceReductionExpression")
alf_CollectOrIterateOperation = Class(name="alf_CollectOrIterateOperation")
alf_ForAllOrExistsOrOneOperation = Class(name="alf_ForAllOrExistsOrOneOperation")
alf_IsUniqueOperation = Class(name="alf_IsUniqueOperation")
alf_SequenceExpansionExpression = Class(name="alf_SequenceExpansionExpression")
alf_SelectOrRejectOperation = Class(name="alf_SelectOrRejectOperation")
SequenceExpansionExpression = Class(name="SequenceExpansionExpression")
alf_PartialSequenceConstructionCompletion = Class(name="alf_PartialSequenceConstructionCompletion")
alf_SequenceConstructionExpression = Class(name="alf_SequenceConstructionExpression")
alf_NullExpression = Class(name="alf_NullExpression")
alf_ThisExpression = Class(name="alf_ThisExpression")
alf_SuperInvocationExpression = Class(name="alf_SuperInvocationExpression")
alf_InstanceCreationExpression = Class(name="alf_InstanceCreationExpression")
alf_SequenceConstructionCompletion = Class(name="alf_SequenceConstructionCompletion")
alf_NonLiteralValueSpecification = Class(name="alf_NonLiteralValueSpecification")
alf_ParenthesizedExpression = Class(name="alf_ParenthesizedExpression")
alf_AccessCompletion = Class(name="alf_AccessCompletion")
Statement = Class(name="Statement")
alf_SequenceElement = Class(name="alf_SequenceElement")
alf_ClassExtentExpression = Class(name="alf_ClassExtentExpression")
...
alf_VariableDeclarationCompletion = Class(name="alf_VariableDeclarationCompletion")
alf_SuperInvocationStatement = Class(name="alf_SuperInvocationStatement")
...
alf_InvocationOrAssignementOrDeclarationStatement = Class(name="alf_InvocationOrAssignementOrDeclarationStatement")
alf_ThisInvocationStatement = Class(name="alf_ThisInvocationStatement")
alf_InstanceCreationInvocationStatement = Class(name="alf_InstanceCreationInvocationStatement")
...
alf_Multiplicity.attributes={alf_Multiplicity_ordered, alf_Multiplicity_nonUnique, alf_Multiplicity_sequence}
...
alf_NameExpression.attributes={alf_NameExpression_id, alf_NameExpression_postfixOp, alf_NameExpression_prefixOp}
...
alf_CollectOrIterateOperation.attributes={alf_CollectOrIterateOperation_expr1, alf_CollectOrIterateOperation_expr2, alf_CollectOrIterateOperation_expr3, alf_CollectOrIterateOperation_op, alf_CollectOrIterateOperation_expr4}
...
alf_ForAllOrExistsOrOneOperation.attributes={alf_ForAllOrExistsOrOneOperation_expr3, alf_ForAllOrExistsOrOneOperation_expr1, alf_ForAllOrExistsOrOneOperation_expr4, alf_ForAllOrExistsOrOneOperation_expr2, alf_ForAllOrExistsOrOneOperation_op}
...
alf_SelectOrRejectOperation.attributes={alf_SelectOrRejectOperation_expr1, alf_SelectOrRejectOperation_op, alf_SelectOrRejectOperation_expr2, alf_SelectOrRejectOperation_expr4, alf_SelectOrRejectOperation_expr3}
...
domain_model = DomainModel(
    name="alf",
    types={alf_Operations, alf_TypePart, alf_OperationDefinitionOrStub, alf_RedefinitionClause, alf_FormalParameterList, alf_FormalParameter, alf_TypeName, alf_OperationDeclaration, alf_Block, alf_FormalParameters, alf_NUMBER_LITERAL_WITHOUT_SUFFIX, alf_INTEGER_LITERAL_WITHOUT_SUFFIX, NUMBER_LITERAL_WITHOUT_SUFFIX, alf_UNLIMITED_LITERAL_WITHOUT_SUFFIX, alf_QualifiedNameWithBinding, alf_QualifiedNameList, alf_Test, alf_Expression, alf_Multiplicity, alf_MultiplicityRange, alf_NUMBER_LITERAL, alf_INTEGER_LITERAL, NUMBER_LITERAL, alf_UNLIMITED_LITERAL, alf_STRING_LITERAL, alf_NameExpression, NonLiteralValueSpecification, alf_QualifiedNamePath, alf_Tuple, alf_SequenceConstructionOrAccessCompletion, alf_UnqualifiedName, alf_TemplateBinding, alf_AssignmentCompletion, alf_Statement, alf_LITERAL, ValueSpecification, alf_SuffixExpression, alf_BOOLEAN_LITERAL, LITERAL, SequenceElement, alf_ConditionalTestExpression, Expression, alf_ConditionalOrExpression, alf_ConditionalAndExpression, alf_InclusiveOrExpression, alf_ExclusiveOrExpression, alf_AndExpression, alf_EqualityExpression, alf_ClassificationExpression, alf_NamedTemplateBinding, alf_TupleElement, alf_AdditiveExpression, alf_MultiplicativeExpression, alf_UnaryExpression, alf_PrimaryExpression, alf_ValueSpecification, alf_OperationCallExpression, SuffixExpression, alf_OperationCallExpressionWithoutDot, alf_RelationalExpression, alf_ShiftExpression, alf_LinkOperationExpression, alf_LinkOperationTuple, alf_LinkOperationTupleElement, alf_PropertyCallExpression, alf_SequenceOperationExpression, alf_SequenceReductionExpression, alf_CollectOrIterateOperation, alf_ForAllOrExistsOrOneOperation, alf_IsUniqueOperation, alf_SequenceExpansionExpression, alf_SelectOrRejectOperation, SequenceExpansionExpression, alf_PartialSequenceConstructionCompletion, alf_SequenceConstructionExpression, alf_NullExpression, alf_ThisExpression, alf_SuperInvocationExpression, alf_InstanceCreationExpression, alf_SequenceConstructionCompletion, alf_NonLiteralValueSpecification, alf_ParenthesizedExpression, alf_AccessCompletion, Statement, alf_SequenceElement, alf_ClassExtentExpression, alf_StatementSequence, alf_DocumentedStatement, alf_InlineStatement, alf_FinalClause, alf_ConcurrentClauses, alf_AnnotatedStatement, alf_NonFinalClause, alf_Annotation, alf_BlockStatement, alf_EmptyStatement, alf_LocalNameDeclarationStatement, alf_IfStatement, alf_SequentialClauses, alf_DoStatement, alf_SwitchStatement, alf_SwitchClause, alf_SwitchDefaultClause, alf_SwitchCase, alf_NonEmptyStatementSequence, alf_WhileStatement, alf_AcceptBlock, alf_ForStatement, alf_ForControl, alf_LoopVariableDefinition, alf_BreakStatement, alf_ReturnStatement, alf_AcceptStatement, alf_AcceptClause, alf_SimpleAcceptStatementCompletion, alf_CompoundAcceptStatementCompletion, alf_VariableDeclarationCompletion, alf_SuperInvocationStatement, alf_ClassifyStatement, alf_ClassificationClause, alf_ClassificationFromClause, alf_ClassificationToClause, alf_ReclassifyAllClause, alf_InvocationOrAssignementOrDeclarationStatement, alf_ThisInvocationStatement, alf_InstanceCreationInvocationStatement, ParameterDirection, BooleanValue, LinkOperationKind, SelectOrRejectOperator, CollectOrIterateOperator, ForAllOrExistsOrOneOperator, AnnotationKind, AssignmentOperator},
    associations={returnType7, operations0, redefinition9, formalParameterList11, formalParameter13, type15, declaration1, body3, formalParameters5, lower24, upper26, qualifiedName29, redefinedOperations31, expression33, typeName18, multiplicity20, range22, path42, invocationCompletion43, sequenceConstructionCompletion45, suffix47, namespace50, templateBinding52, assignExpression34, statements36, block38, suffix41, argument67, exp70, whenTrue72, whenFalse75, exp77, exp79, exp81, exp83, exp85, exp87, bindings54, actual56, binding59, remaining63, tupleElements65, exp99, exp101, exp103, exp105, prefix107, tuple109, suffix111, exp89, typeName91, left94, right96, index119, suffix121, tuple124, linkOperationTupleElement125, tuple114, suffix116, tuple133, suffix135, roleIndex127, objectValueSpec130, behavior138, suffix140, suffix143, accessCompletion171, sequenceCompletion173, casted149, expression175, suffix151, suffix154, operationCallWithoutDot156, operationCall158, constructor161, expr145, tuple163, sequenceConstuctionCompletion166, suffix168, expOrTypeCast147, accessIndex177, expression180, expression183, sequenceElement186, rangeUpper188, sequence191, statements193, finalClause210, conccurentClauses212, annotation195, block196, statement199, block202, type204, init206, sequentialClausses209, condition244, block246, block249, nonFinalClause214, condition216, block219, block222, expression225, switchClause227, defaultClause229, switchCase231, statementSequence233, expression235, statementSequence238, statement241, compoundAccept271, block273, acceptBlock276, condition251, control254, block255, loopVariableDefinition258, expression1260, expression2263, expression266, clause268, simpleAccept269, typePart_OR_assignedPart_OR_invocationPart306, variableDeclarationCompletion308, assignmentCompletion310, clause278, block281, qualifiedNameList284, expression287, clause289, classifyFromClause291, classifyToClause293, reclassyAllClause295, qualifiedNameList297, qualifiedNameList300, qualifiedName303, _super313, _this315, assignmentCompletion317, _new320, initValue322, rightHandSide325},
    generalizations={gen_alf_INTEGER_LITERAL_WITHOUT_SUFFIX_NUMBER_LITERAL_WITHOUT_SUFFIX, gen_alf_UNLIMITED_LITERAL_WITHOUT_SUFFIX_NUMBER_LITERAL_WITHOUT_SUFFIX, gen_alf_NUMBER_LITERAL_LITERAL, gen_alf_INTEGER_LITERAL_NUMBER_LITERAL, gen_alf_UNLIMITED_LITERAL_NUMBER_LITERAL, gen_alf_STRING_LITERAL_LITERAL, gen_alf_NameExpression_ValueSpecification, gen_alf_NameExpression_NonLiteralValueSpecification, gen_alf_LITERAL_ValueSpecification, gen_alf_BOOLEAN_LITERAL_LITERAL, gen_alf_Expression_SequenceElement, gen_alf_ConditionalTestExpression_Expression, gen_alf_OperationCallExpression_SuffixExpression, gen_alf_PropertyCallExpression_SuffixExpression, gen_alf_LinkOperationExpression_SuffixExpression, gen_alf_SequenceOperationExpression_SuffixExpression, gen_alf_SequenceReductionExpression_SuffixExpression, gen_alf_CollectOrIterateOperation_SequenceExpansionExpression, gen_alf_ForAllOrExistsOrOneOperation_SequenceExpansionExpression, gen_alf_IsUniqueOperation_SequenceExpansionExpression, gen_alf_SequenceExpansionExpression_SuffixExpression, gen_alf_SelectOrRejectOperation_SequenceExpansionExpression, gen_alf_NullExpression_ValueSpecification, gen_alf_ThisExpression_ValueSpecification, gen_alf_ThisExpression_NonLiteralValueSpecification, gen_alf_SuperInvocationExpression_ValueSpecification, gen_alf_SuperInvocationExpression_NonLiteralValueSpecification, gen_alf_InstanceCreationExpression_ValueSpecification, gen_alf_InstanceCreationExpression_NonLiteralValueSpecification, gen_alf_ParenthesizedExpression_ValueSpecification, gen_alf_ParenthesizedExpression_NonLiteralValueSpecification, gen_alf_InlineStatement_Statement, gen_alf_SequenceConstructionExpression_SequenceElement, gen_alf_AnnotatedStatement_Statement, gen_alf_BlockStatement_Statement, gen_alf_EmptyStatement_Statement, gen_alf_LocalNameDeclarationStatement_Statement, gen_alf_IfStatement_Statement, gen_alf_DoStatement_Statement, gen_alf_SwitchStatement_Statement, gen_alf_WhileStatement_Statement, gen_alf_ForStatement_Statement, gen_alf_BreakStatement_Statement, gen_alf_ReturnStatement_Statement, gen_alf_AcceptStatement_Statement, gen_alf_SuperInvocationStatement_Statement, gen_alf_ClassifyStatement_Statement, gen_alf_InvocationOrAssignementOrDeclarationStatement_Statement, gen_alf_ThisInvocationStatement_Statement, gen_alf_InstanceCreationInvocationStatement_Statement},
    metadata=None
)
