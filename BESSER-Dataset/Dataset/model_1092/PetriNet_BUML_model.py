...
petrinet_ArcSortant = Class(name="petrinet_ArcSortant")
petrinet_ArcEntrant = Class(name="petrinet_ArcEntrant")
Arc = Class(name="Arc")
petrinet_ReadArc = Class(name="petrinet_ReadArc")
...
petrinet_Reseau = Class(name="petrinet_Reseau")
...
domain_model = DomainModel(
    name="petrinet",
    types={petrinet_Place, Element, petrinet_Transition, petrinet_ArcSortant, petrinet_ArcEntrant, Arc, petrinet_ReadArc, ArcSortant, petrinet_Element, petrinet_Arc, petrinet_Reseau},
    associations={elements8, arcs9, predecesseurs0, successeurs1, successeur2, predecesseur3, successeur4, predecesseur6},
