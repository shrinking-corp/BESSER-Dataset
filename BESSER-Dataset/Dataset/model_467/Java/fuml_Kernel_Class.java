...
public class fuml_Kernel_Class extends BehavioredClassifier {
    ...
    public fuml_Kernel_Class(
        boolean active        ArrayList<Kernel_Property> kernel_propertys,        ArrayList<Kernel_Class> kernel_classs,        ArrayList<Kernel_Operation> kernel_operations,        ArrayList<Kernel_Classifier> kernel_classifiers    ) {
        this.active = active;
