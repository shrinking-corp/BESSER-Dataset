...
def test_hyp_fuml_basicbehaviors_parametervalue_is_not_abstract():
    assert not inspect.isabstract(fuml_BasicBehaviors_ParameterValue)


def test_hyp_fuml_basicbehaviors_parametervalue_constructor_exists():
    assert callable(fuml_BasicBehaviors_ParameterValue.__init__)


def test_hyp_fuml_basicbehaviors_parametervalue_constructor_args():
    sig = inspect.signature(fuml_BasicBehaviors_ParameterValue.__init__)
    params = list(sig.parameters.keys())



def test_hyp_kernel_extensionalvalue_is_not_abstract():
    assert not inspect.isabstract(Kernel_ExtensionalValue)


def test_hyp_kernel_extensionalvalue_constructor_exists():
    assert callable(Kernel_ExtensionalValue.__init__)


def test_hyp_kernel_extensionalvalue_constructor_args():
    sig = inspect.signature(Kernel_ExtensionalValue.__init__)
    params = list(sig.parameters.keys())



def test_hyp_fuml_locil1_locus_is_not_abstract():
    assert not inspect.isabstract(fuml_LociL1_Locus)


def test_hyp_fuml_locil1_locus_constructor_exists():
    assert callable(fuml_LociL1_Locus.__init__)


def test_hyp_fuml_locil1_locus_constructor_args():
    sig = inspect.signature(fuml_LociL1_Locus.__init__)
    params = list(sig.parameters.keys())



def test_hyp_fuml_locil1_semanticvisitor_is_not_abstract():
    assert not inspect.isabstract(fuml_LociL1_SemanticVisitor)


def test_hyp_fuml_locil1_semanticvisitor_constructor_exists():
    assert callable(fuml_LociL1_SemanticVisitor.__init__)


def test_hyp_fuml_locil1_semanticvisitor_constructor_args():
...
def test_hyp_fuml_kernel_value_is_not_abstract():
    assert not inspect.isabstract(fuml_Kernel_Value)


def test_hyp_fuml_kernel_value_constructor_exists():
    assert callable(fuml_Kernel_Value.__init__)


def test_hyp_fuml_kernel_value_constructor_args():
    sig = inspect.signature(fuml_Kernel_Value.__init__)
    params = list(sig.parameters.keys())



def test_hyp_locil1_locus_is_not_abstract():
    assert not inspect.isabstract(LociL1_Locus)


def test_hyp_locil1_locus_constructor_exists():
    assert callable(LociL1_Locus.__init__)


def test_hyp_locil1_locus_constructor_args():
    sig = inspect.signature(LociL1_Locus.__init__)
    params = list(sig.parameters.keys())



def test_hyp_compoundvalue_is_not_abstract():
    assert not inspect.isabstract(CompoundValue)


def test_hyp_compoundvalue_constructor_exists():
    assert callable(CompoundValue.__init__)


def test_hyp_compoundvalue_constructor_args():
    sig = inspect.signature(CompoundValue.__init__)
    params = list(sig.parameters.keys())



def test_hyp_fuml_kernel_datavalue_is_not_abstract():
    assert not inspect.isabstract(fuml_Kernel_DataValue)


def test_hyp_fuml_kernel_datavalue_constructor_exists():
    assert callable(fuml_Kernel_DataValue.__init__)


def test_hyp_fuml_kernel_datavalue_constructor_args():
    sig = inspect.signature(fuml_Kernel_DataValue.__init__)
    params = list(sig.parameters.keys())



def test_hyp_fuml_kernel_extensionalvalue_is_not_abstract():
    assert not inspect.isabstract(fuml_Kernel_ExtensionalValue)


def test_hyp_fuml_kernel_extensionalvalue_constructor_exists():
    assert callable(fuml_Kernel_ExtensionalValue.__init__)


def test_hyp_fuml_kernel_extensionalvalue_constructor_args():
    sig = inspect.signature(fuml_Kernel_ExtensionalValue.__init__)
    params = list(sig.parameters.keys())



def test_hyp_extensionalvalue_is_not_abstract():
    assert not inspect.isabstract(ExtensionalValue)


def test_hyp_extensionalvalue_constructor_exists():
    assert callable(ExtensionalValue.__init__)


def test_hyp_extensionalvalue_constructor_args():
    sig = inspect.signature(ExtensionalValue.__init__)
    params = list(sig.parameters.keys())



def test_hyp_fuml_kernel_object_is_not_abstract():
    assert not inspect.isabstract(fuml_Kernel_Object)


def test_hyp_fuml_kernel_object_constructor_exists():
    assert callable(fuml_Kernel_Object.__init__)


def test_hyp_fuml_kernel_object_constructor_args():
    sig = inspect.signature(fuml_Kernel_Object.__init__)
    params = list(sig.parameters.keys())



def test_hyp_kernel_object_is_not_abstract():
    assert not inspect.isabstract(Kernel_Object)


def test_hyp_kernel_object_constructor_exists():
    assert callable(Kernel_Object.__init__)


def test_hyp_kernel_object_constructor_args():
    sig = inspect.signature(Kernel_Object.__init__)
    params = list(sig.parameters.keys())



def test_hyp_structuredvalue_is_not_abstract():
    assert not inspect.isabstract(StructuredValue)


def test_hyp_structuredvalue_constructor_exists():
    assert callable(StructuredValue.__init__)


def test_hyp_structuredvalue_constructor_args():
    sig = inspect.signature(StructuredValue.__init__)
    params = list(sig.parameters.keys())



def test_hyp_fuml_kernel_compoundvalue_is_not_abstract():
    assert not inspect.isabstract(fuml_Kernel_CompoundValue)


def test_hyp_fuml_kernel_compoundvalue_constructor_exists():
    assert callable(fuml_Kernel_CompoundValue.__init__)


def test_hyp_fuml_kernel_compoundvalue_constructor_args():
    sig = inspect.signature(fuml_Kernel_CompoundValue.__init__)
    params = list(sig.parameters.keys())



def test_hyp_fuml_kernel_reference_is_not_abstract():
    assert not inspect.isabstract(fuml_Kernel_Reference)


def test_hyp_fuml_kernel_reference_constructor_exists():
    assert callable(fuml_Kernel_Reference.__init__)


def test_hyp_fuml_kernel_reference_constructor_args():
...
def test_hyp_fuml_kernel_integervalue_is_not_abstract():
    assert not inspect.isabstract(fuml_Kernel_IntegerValue)


def test_hyp_fuml_kernel_integervalue_constructor_exists():
    assert callable(fuml_Kernel_IntegerValue.__init__)


def test_hyp_fuml_kernel_integervalue_constructor_args():
...
def test_hyp_fuml_kernel_booleanvalue_is_not_abstract():
    assert not inspect.isabstract(fuml_Kernel_BooleanValue)


def test_hyp_fuml_kernel_booleanvalue_constructor_exists():
    assert callable(fuml_Kernel_BooleanValue.__init__)


def test_hyp_fuml_kernel_booleanvalue_constructor_args():
...
def test_hyp_fuml_kernel_stringvalue_is_not_abstract():
    assert not inspect.isabstract(fuml_Kernel_StringValue)


def test_hyp_fuml_kernel_stringvalue_constructor_exists():
    assert callable(fuml_Kernel_StringValue.__init__)


def test_hyp_fuml_kernel_stringvalue_constructor_args():
...
def test_hyp_fuml_kernel_unlimitednaturalvalue_is_not_abstract():
    assert not inspect.isabstract(fuml_Kernel_UnlimitedNaturalValue)


def test_hyp_fuml_kernel_unlimitednaturalvalue_constructor_exists():
    assert callable(fuml_Kernel_UnlimitedNaturalValue.__init__)


def test_hyp_fuml_kernel_unlimitednaturalvalue_constructor_args():
...
def test_hyp_fuml_kernel_featurevalue_is_not_abstract():
    assert not inspect.isabstract(fuml_Kernel_FeatureValue)


def test_hyp_fuml_kernel_featurevalue_constructor_exists():
    assert callable(fuml_Kernel_FeatureValue.__init__)


def test_hyp_fuml_kernel_featurevalue_constructor_args():
...
def test_hyp_fuml_kernel_link_is_not_abstract():
    assert not inspect.isabstract(fuml_Kernel_Link)


def test_hyp_fuml_kernel_link_constructor_exists():
    assert callable(fuml_Kernel_Link.__init__)


def test_hyp_fuml_kernel_link_constructor_args():
    sig = inspect.signature(fuml_Kernel_Link.__init__)
    params = list(sig.parameters.keys())



def test_hyp_kernel_featurevalue_is_not_abstract():
    assert not inspect.isabstract(Kernel_FeatureValue)


def test_hyp_kernel_featurevalue_constructor_exists():
    assert callable(Kernel_FeatureValue.__init__)


def test_hyp_kernel_featurevalue_constructor_args():
...
def test_hyp_fuml_kernel_primitivevalue_is_not_abstract():
    assert not inspect.isabstract(fuml_Kernel_PrimitiveValue)


def test_hyp_fuml_kernel_primitivevalue_constructor_exists():
    assert callable(fuml_Kernel_PrimitiveValue.__init__)


def test_hyp_fuml_kernel_primitivevalue_constructor_args():
    sig = inspect.signature(fuml_Kernel_PrimitiveValue.__init__)
    params = list(sig.parameters.keys())



def test_hyp_fuml_kernel_enumerationvalue_is_not_abstract():
    assert not inspect.isabstract(fuml_Kernel_EnumerationValue)


def test_hyp_fuml_kernel_enumerationvalue_constructor_exists():
    assert callable(fuml_Kernel_EnumerationValue.__init__)


def test_hyp_fuml_kernel_enumerationvalue_constructor_args():
    sig = inspect.signature(fuml_Kernel_EnumerationValue.__init__)
    params = list(sig.parameters.keys())



def test_hyp_fuml_kernel_structuredvalue_is_not_abstract():
    assert not inspect.isabstract(fuml_Kernel_StructuredValue)


def test_hyp_fuml_kernel_structuredvalue_constructor_exists():
    assert callable(fuml_Kernel_StructuredValue.__init__)


def test_hyp_fuml_kernel_structuredvalue_constructor_args():
...
fuml_BasicBehaviors_ParameterValue_strategy = st.builds(
    fuml_BasicBehaviors_ParameterValue,
)
Kernel_ExtensionalValue_strategy = st.builds(
    Kernel_ExtensionalValue,
)
fuml_LociL1_Locus_strategy = st.builds(
    fuml_LociL1_Locus,
)
...
LociL1_Locus_strategy = st.builds(
    LociL1_Locus,
)
...
def test_hyp_fuml_kernel_integervalue_value_setter(instance):
...
def test_hyp_fuml_kernel_booleanvalue_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_fuml_kernel_stringvalue_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_fuml_kernel_unlimitednaturalvalue_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_fuml_kernel_featurevalue_position_setter(instance):
