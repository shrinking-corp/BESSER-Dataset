...
# Classes
BookStorePackage_BookStore = Class(name="BookStorePackage_BookStore")
BookStorePackage_Book = Class(name="BookStorePackage_Book")
BookStorePackage_TypeParameterTest1_XClass = Class(name="BookStorePackage_TypeParameterTest1_XClass")
BookStorePackage_TypeParameterTest1_YClass = Class(name="BookStorePackage_TypeParameterTest1_YClass")
BookStorePackage_TypeParameterTest1_ZClass = Class(name="BookStorePackage_TypeParameterTest1_ZClass")
...
domain_model = DomainModel(
    ...
    types={BookStorePackage_BookStore, BookStorePackage_Book, BookStorePackage_TypeParameterTest1_XClass, BookStorePackage_TypeParameterTest1_YClass, BookStorePackage_TypeParameterTest1_ZClass},
    associations={books0},
    generalizations={},
    metadata=None
)
