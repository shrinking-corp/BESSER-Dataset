...
mil_Statement = Class(name="mil_Statement", is_abstract=True)
mil_Instruction = Class(name="mil_Instruction", is_abstract=True)
Statement = Class(name="Statement")
mil_JumpInstruction = Class(name="mil_JumpInstruction")
Jumper = Class(name="Jumper")
mil_ConditionalJumpInstruction = Class(name="mil_ConditionalJumpInstruction")
mil_Comparison = Class(name="mil_Comparison", is_abstract=True)
mil_EqualsComparison = Class(name="mil_EqualsComparison")
Comparison = Class(name="Comparison")
mil_NotEqualsComparison = Class(name="mil_NotEqualsComparison")
mil_LowerThanComparison = Class(name="mil_LowerThanComparison")
mil_LowerEqualsComparison = Class(name="mil_LowerEqualsComparison")
mil_GreaterThanComparison = Class(name="mil_GreaterThanComparison")
mil_GreaterEqualsComparison = Class(name="mil_GreaterEqualsComparison")
mil_YieldInstruction = Class(name="mil_YieldInstruction")
mil_PrintInstruction = Class(name="mil_PrintInstruction")
mil_JumpMarker = Class(name="mil_JumpMarker")
mil_Jumper = Class(name="mil_Jumper", is_abstract=True)
mil_CallInstruction = Class(name="mil_CallInstruction")
mil_ReturnInstruction = Class(name="mil_ReturnInstruction")
...
mil_MultInstruction = Class(name="mil_MultInstruction")
mil_SubInstruction = Class(name="mil_SubInstruction")
mil_DivInstruction = Class(name="mil_DivInstruction")
mil_BinaryOperation = Class(name="mil_BinaryOperation", is_abstract=True)
mil_UnaryOperation = Class(name="mil_UnaryOperation", is_abstract=True)
mil_NegateInstruction = Class(name="mil_NegateInstruction")
...
domain_model = DomainModel(
    name="mil",
    types={mil_MILModel, mil_Statement, mil_Instruction, Statement, mil_JumpInstruction, Jumper, mil_ConditionalJumpInstruction, mil_Comparison, mil_EqualsComparison, Comparison, mil_NotEqualsComparison, mil_LowerThanComparison, mil_LowerEqualsComparison, mil_GreaterThanComparison, mil_GreaterEqualsComparison, mil_YieldInstruction, mil_PrintInstruction, mil_JumpMarker, mil_Jumper, mil_CallInstruction, mil_ReturnInstruction, mil_LoadInstruction, Instruction, mil_Value, mil_StoreInstruction, UnaryOperation, mil_RegisterReference, mil_AddInstruction, BinaryOperation, mil_ConstantInteger, Value, mil_MultInstruction, mil_SubInstruction, mil_DivInstruction, mil_BinaryOperation, mil_UnaryOperation, mil_NegateInstruction},
    associations={statements0, jumpTarget3, value1, registerReference2},
    generalizations={gen_mil_Instruction_Statement, gen_mil_JumpInstruction_Instruction, gen_mil_JumpInstruction_Jumper, gen_mil_ConditionalJumpInstruction_UnaryOperation, gen_mil_ConditionalJumpInstruction_Jumper, gen_mil_Comparison_BinaryOperation, gen_mil_EqualsComparison_Comparison, gen_mil_NotEqualsComparison_Comparison, gen_mil_LowerThanComparison_Comparison, gen_mil_LowerEqualsComparison_Comparison, gen_mil_GreaterThanComparison_Comparison, gen_mil_GreaterEqualsComparison_Comparison, gen_mil_YieldInstruction_UnaryOperation, gen_mil_PrintInstruction_Instruction, gen_mil_JumpMarker_Statement, gen_mil_CallInstruction_Jumper, gen_mil_CallInstruction_Instruction, gen_mil_ReturnInstruction_Instruction, gen_mil_LoadInstruction_Instruction, gen_mil_StoreInstruction_UnaryOperation, gen_mil_AddInstruction_BinaryOperation, gen_mil_ConstantInteger_Value, gen_mil_RegisterReference_Value, gen_mil_MultInstruction_BinaryOperation, gen_mil_SubInstruction_BinaryOperation, gen_mil_DivInstruction_BinaryOperation, gen_mil_BinaryOperation_Instruction, gen_mil_UnaryOperation_Instruction, gen_mil_NegateInstruction_UnaryOperation},
    metadata=None
)
