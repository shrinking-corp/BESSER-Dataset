...
# Classes
sample_SampleClassC = Class(name="sample_SampleClassC")
sample_SampleClassB = Class(name="sample_SampleClassB")
sample_SampleClassA = Class(name="sample_SampleClassA")
SampleClassInterface = Class(name="SampleClassInterface")
sample_SampleClassInterface = Class(name="sample_SampleClassInterface", is_abstract=True)
...
sample_SampleClassInterface_m_doSomething: Method = Method(name="doSomething", parameters={Parameter(name='sample_input', type=StringType)}, type=StringType)
