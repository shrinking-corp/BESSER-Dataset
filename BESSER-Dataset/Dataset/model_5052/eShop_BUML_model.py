...
eShop_Product.attributes={eShop_Product_price, eShop_Product_stock}
...
domain_model = DomainModel(
    name="eShop",
    types={eShop_Sale, eShop_GoldCustomer, Customer, eShop_Customer, eShop_Portal, eShop_SaleLine, eShop_Product},
