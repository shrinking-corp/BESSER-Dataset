...
class EMOF_ReflectiveSequence(ReflectiveCollection):
    ...
    def __init__(self):
        ...
        pass
    def set(self, EMOF_index, EMOF_object) :
...
class EMOF_Class(Type):
    ...
    def __init__(self, isAbstract: str, EMOF_Class: set["Property"] = None, EMOF_Class2: set["Operation"] = None, EMOF_Class4: set["Class"] = None, Type34: "EMOF_TypedElement" = None, Type22: "EMOF_Package" = None, Type: "EMOF_Operation" = None):
...
class EMOF_Package(NamedElement):
    ...
    def __init__(self, uri: str, EMOF_Package: "Package" = None, EMOF_Package21: set["Type"] = None, nestingPackage: set["Package"] = None, NamedElement: "EMOF_Comment" = None):
        self.uri = uri
