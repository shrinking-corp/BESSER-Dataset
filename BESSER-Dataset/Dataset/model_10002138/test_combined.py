...
def test_hyp_imageicon_is_not_abstract():
    assert not inspect.isabstract(ImageIcon)


def test_hyp_imageicon_constructor_exists():
    assert callable(ImageIcon.__init__)


def test_hyp_imageicon_constructor_args():
    sig = inspect.signature(ImageIcon.__init__)
    params = list(sig.parameters.keys())



def test_hyp_listener_interface_is_not_abstract():
    assert not inspect.isabstract(Listener_Interface)


def test_hyp_listener_interface_constructor_exists():
    assert callable(Listener_Interface.__init__)


def test_hyp_listener_interface_constructor_args():
...
def test_hyp_connect_four_gui_circle_is_not_abstract():
    assert not inspect.isabstract(connect_four_gui_Circle)


def test_hyp_connect_four_gui_circle_constructor_exists():
    assert callable(connect_four_gui_Circle.__init__)


def test_hyp_connect_four_gui_circle_constructor_args():
    sig = inspect.signature(connect_four_gui_Circle.__init__)
    params = list(sig.parameters.keys())



def test_hyp_connect_four_gui_connect4constant_interface_is_not_abstract():
    assert not inspect.isabstract(connect_four_gui_Connect4Constant_Interface)


def test_hyp_connect_four_gui_connect4constant_interface_constructor_exists():
    assert callable(connect_four_gui_Connect4Constant_Interface.__init__)


def test_hyp_connect_four_gui_connect4constant_interface_constructor_args():
    sig = inspect.signature(connect_four_gui_Connect4Constant_Interface.__init__)
    params = list(sig.parameters.keys())



def test_hyp_connect_four_gui_gameoverpanel_is_not_abstract():
    assert not inspect.isabstract(connect_four_gui_GameOverPanel)


def test_hyp_connect_four_gui_gameoverpanel_constructor_exists():
    assert callable(connect_four_gui_GameOverPanel.__init__)


def test_hyp_connect_four_gui_gameoverpanel_constructor_args():
...
def test_hyp_connect_four_gui_gameoverpanel_has_winner():
...
def test_hyp_connect_four_gui_gameoverpanel_has_winnerDisplay():
...
def test_hyp_connect_four_gui_gameoverpanel_has_butPlayAgain():
...
def test_hyp_connect_four_gui_gameoverpanel_has_gui():
...
def test_hyp_connect_four_gui_gameoverpanel_has_labelGameOVer():
...
def test_hyp_connect_four_gui_gameoverpanel_has_butMainMenu():
...
def test_hyp_connect_four_gui_stage_is_not_abstract():
    assert not inspect.isabstract(connect_four_gui_stage)


def test_hyp_connect_four_gui_stage_constructor_exists():
    assert callable(connect_four_gui_stage.__init__)


def test_hyp_connect_four_gui_stage_constructor_args():
    sig = inspect.signature(connect_four_gui_stage.__init__)
    params = list(sig.parameters.keys())



def test_hyp_connect_four_gui_startmenu_is_not_abstract():
    assert not inspect.isabstract(connect_four_gui_StartMenu)


def test_hyp_connect_four_gui_startmenu_constructor_exists():
    assert callable(connect_four_gui_StartMenu.__init__)


def test_hyp_connect_four_gui_startmenu_constructor_args():
...
def test_hyp_connect_four_gui_startmenu_has_bStart():
...
def test_hyp_connect_four_gui_startmenu_has_bPlay():
...
def test_hyp_connect_four_gui_startmenu_has_startLabel():
...
def test_hyp_connect_four_gui_startmenu_has_bp():
...
def test_hyp_connect_four_gui_startmenu_has_label():
...
def test_hyp_connect_four_gui_startmenu_has_window():
...
def test_hyp_connect_four_gui_guiplayer_is_not_abstract():
    assert not inspect.isabstract(connect_four_gui_GUIPlayer)


def test_hyp_connect_four_gui_guiplayer_constructor_exists():
    assert callable(connect_four_gui_GUIPlayer.__init__)


def test_hyp_connect_four_gui_guiplayer_constructor_args():
...
def test_hyp_connect_four_gui_guiplayer_has_board():
...
def test_hyp_connect_four_gui_guiplayer_has_gpGUI():
...
def test_hyp_connect_four_gui_guiplayer_has_m_name():
...
def test_hyp_connect_four_gui_red_is_not_abstract():
    assert not inspect.isabstract(connect_four_gui_red)


def test_hyp_connect_four_gui_red_constructor_exists():
    assert callable(connect_four_gui_red.__init__)


def test_hyp_connect_four_gui_red_constructor_args():
    sig = inspect.signature(connect_four_gui_red.__init__)
    params = list(sig.parameters.keys())



def test_hyp_connect_four_gui_token_is_not_abstract():
    assert not inspect.isabstract(connect_four_gui_Token)


def test_hyp_connect_four_gui_token_constructor_exists():
    assert callable(connect_four_gui_Token.__init__)


def test_hyp_connect_four_gui_token_constructor_args():
...
def test_hyp_connect_four_gui_connect4gui_is_not_abstract():
    assert not inspect.isabstract(connect_four_gui_Connect4GUI)


def test_hyp_connect_four_gui_connect4gui_constructor_exists():
    assert callable(connect_four_gui_Connect4GUI.__init__)


def test_hyp_connect_four_gui_connect4gui_constructor_args():
...
def test_hyp_connect_four_gui_connect4gui_has_redToken():
...
def test_hyp_connect_four_gui_connect4gui_has_startUp():
...
def test_hyp_connect_four_gui_connect4gui_has_window():
...
def test_hyp_connect_four_gui_connect4gui_has_cpList():
...
def test_hyp_connect_four_gui_connect4gui_has_comp():
...
def test_hyp_connect_four_gui_connect4gui_has_gridBoard():
...
def test_hyp_connect_four_gui_connect4gui_has_tokenRoot():
...
def test_hyp_connect_four_gui_gamepanel_is_not_abstract():
    assert not inspect.isabstract(connect_four_gui_GamePanel)


def test_hyp_connect_four_gui_gamepanel_constructor_exists():
    assert callable(connect_four_gui_GamePanel.__init__)


def test_hyp_connect_four_gui_gamepanel_constructor_args():
...
def test_hyp_connect_four_gui_gamepanel_has_newColumnNum():
...
def test_hyp_connect_four_gui_gamepanel_has_board():
...
def test_hyp_connect_four_gui_gamepanel_has_game():
...
def test_hyp_connect_four_gui_gamepanel_has_pieces():
...
def test_hyp_connect_four_gui_gamepanel_has_players():
...
def test_hyp_connect_four_gui_gamepanel_has_isComputerEnabled():
...
def test_hyp_connect_four_gui_gamepanel_has_windows():
...
def test_hyp_connect_four_gui_gamepanel_has_justWon():
...
def test_hyp_connect_four_gui_gamepanel_has_whoPlayed():
...
def test_hyp_connect_four_gui_gamepanel_has_startUp():
...
def test_hyp_connect_four_gui_gamepanel_has_columnNum():
...
def test_hyp_connect_four_gui_gamepanel_has_newDrawPos():
...
def test_hyp_connect_four_gui_gamepanel_has_Connect4_GUI():
...
def test_hyp_connect_four_gui_gamepanel_has_turnNum():
...
def test_hyp_compute_column_external_is_not_abstract():
    assert not inspect.isabstract(Compute_Column_external)


def test_hyp_compute_column_external_constructor_exists():
    assert callable(Compute_Column_external.__init__)


def test_hyp_compute_column_external_constructor_args():
    sig = inspect.signature(Compute_Column_external.__init__)
    params = list(sig.parameters.keys())



def test_hyp_select_column_external_is_not_abstract():
    assert not inspect.isabstract(Select_Column_external)


def test_hyp_select_column_external_constructor_exists():
    assert callable(Select_Column_external.__init__)


def test_hyp_select_column_external_constructor_args():
    sig = inspect.signature(Select_Column_external.__init__)
    params = list(sig.parameters.keys())



def test_hyp_enter_name_external_is_not_abstract():
    assert not inspect.isabstract(Enter_Name_external)


def test_hyp_enter_name_external_constructor_exists():
    assert callable(Enter_Name_external.__init__)


def test_hyp_enter_name_external_constructor_args():
    sig = inspect.signature(Enter_Name_external.__init__)
    params = list(sig.parameters.keys())



def test_hyp_choose_how_many_players_external_is_not_abstract():
    assert not inspect.isabstract(Choose_how_many_Players_external)


def test_hyp_choose_how_many_players_external_constructor_exists():
    assert callable(Choose_how_many_Players_external.__init__)


def test_hyp_choose_how_many_players_external_constructor_args():
    sig = inspect.signature(Choose_how_many_Players_external.__init__)
    params = list(sig.parameters.keys())



def test_hyp_borderpane_is_not_abstract():
    assert not inspect.isabstract(BorderPane)


def test_hyp_borderpane_constructor_exists():
    assert callable(BorderPane.__init__)


def test_hyp_borderpane_constructor_args():
    sig = inspect.signature(BorderPane.__init__)
    params = list(sig.parameters.keys())



def test_hyp_vbox_is_not_abstract():
    assert not inspect.isabstract(VBox)


def test_hyp_vbox_constructor_exists():
    assert callable(VBox.__init__)


def test_hyp_vbox_constructor_args():
    sig = inspect.signature(VBox.__init__)
    params = list(sig.parameters.keys())



def test_hyp_hbox_is_not_abstract():
    assert not inspect.isabstract(HBox)


def test_hyp_hbox_constructor_exists():
    assert callable(HBox.__init__)


def test_hyp_hbox_constructor_args():
...
def test_hyp_list_token__is_not_abstract():
    assert not inspect.isabstract(List_Token_)


def test_hyp_list_token__constructor_exists():
    assert callable(List_Token_.__init__)


def test_hyp_list_token__constructor_args():
    sig = inspect.signature(List_Token_.__init__)
    params = list(sig.parameters.keys())



def test_hyp_connect_four_component_is_not_abstract():
    assert not inspect.isabstract(Connect_Four_Component)


def test_hyp_connect_four_component_constructor_exists():
    assert callable(Connect_Four_Component.__init__)


def test_hyp_connect_four_component_constructor_args():
    sig = inspect.signature(Connect_Four_Component.__init__)
    params = list(sig.parameters.keys())



def test_hyp_player_2_actor_is_not_abstract():
    assert not inspect.isabstract(Player_2_Actor)


def test_hyp_player_2_actor_constructor_exists():
    assert callable(Player_2_Actor.__init__)


def test_hyp_player_2_actor_constructor_args():
    sig = inspect.signature(Player_2_Actor.__init__)
    params = list(sig.parameters.keys())



def test_hyp_computer_ai_actor_is_not_abstract():
    assert not inspect.isabstract(Computer_AI_Actor)


def test_hyp_computer_ai_actor_constructor_exists():
    assert callable(Computer_AI_Actor.__init__)


def test_hyp_computer_ai_actor_constructor_args():
    sig = inspect.signature(Computer_AI_Actor.__init__)
    params = list(sig.parameters.keys())



def test_hyp_player_1_actor_is_not_abstract():
    assert not inspect.isabstract(Player_1_Actor)


def test_hyp_player_1_actor_constructor_exists():
    assert callable(Player_1_Actor.__init__)


def test_hyp_player_1_actor_constructor_args():
    sig = inspect.signature(Player_1_Actor.__init__)
    params = list(sig.parameters.keys())



def test_hyp_javax_swing_jtextfield_is_not_abstract():
    assert not inspect.isabstract(javax_swing_JTextField)


def test_hyp_javax_swing_jtextfield_constructor_exists():
    assert callable(javax_swing_JTextField.__init__)


def test_hyp_javax_swing_jtextfield_constructor_args():
    sig = inspect.signature(javax_swing_JTextField.__init__)
    params = list(sig.parameters.keys())



def test_hyp_javax_swing_jbutton_is_not_abstract():
    assert not inspect.isabstract(javax_swing_JButton)


def test_hyp_javax_swing_jbutton_constructor_exists():
    assert callable(javax_swing_JButton.__init__)


def test_hyp_javax_swing_jbutton_constructor_args():
...
def test_hyp_connect_four_gui_gameoverpanel_instantiation(instance):
    assert isinstance(instance, connect_four_gui_GameOverPanel)



@given(instance=connect_four_gui_GameOverPanel_strategy)
def test_hyp_connect_four_gui_gameoverpanel_winner_setter(instance):
...
@given(instance=connect_four_gui_GameOverPanel_strategy)
def test_hyp_connect_four_gui_gameoverpanel_winnerDisplay_setter(instance):
...
@given(instance=connect_four_gui_GameOverPanel_strategy)
def test_hyp_connect_four_gui_gameoverpanel_butPlayAgain_setter(instance):
...
@given(instance=connect_four_gui_GameOverPanel_strategy)
def test_hyp_connect_four_gui_gameoverpanel_gui_setter(instance):
...
@given(instance=connect_four_gui_GameOverPanel_strategy)
def test_hyp_connect_four_gui_gameoverpanel_labelGameOVer_setter(instance):
...
@given(instance=connect_four_gui_GameOverPanel_strategy)
def test_hyp_connect_four_gui_gameoverpanel_butMainMenu_setter(instance):
...
@settings(max_examples=50)
def test_hyp_connect_four_gui_startmenu_instantiation(instance):
    assert isinstance(instance, connect_four_gui_StartMenu)



@given(instance=connect_four_gui_StartMenu_strategy)
def test_hyp_connect_four_gui_startmenu_bStart_setter(instance):
...
@given(instance=connect_four_gui_StartMenu_strategy)
def test_hyp_connect_four_gui_startmenu_bPlay_setter(instance):
...
@given(instance=connect_four_gui_StartMenu_strategy)
def test_hyp_connect_four_gui_startmenu_startLabel_setter(instance):
...
@given(instance=connect_four_gui_StartMenu_strategy)
def test_hyp_connect_four_gui_startmenu_bp_setter(instance):
...
@given(instance=connect_four_gui_StartMenu_strategy)
def test_hyp_connect_four_gui_startmenu_label_setter(instance):
...
@given(instance=connect_four_gui_StartMenu_strategy)
def test_hyp_connect_four_gui_startmenu_window_setter(instance):
...
@settings(max_examples=50)
def test_hyp_connect_four_gui_guiplayer_instantiation(instance):
    assert isinstance(instance, connect_four_gui_GUIPlayer)



@given(instance=connect_four_gui_GUIPlayer_strategy)
def test_hyp_connect_four_gui_guiplayer_board_setter(instance):
...
@given(instance=connect_four_gui_GUIPlayer_strategy)
def test_hyp_connect_four_gui_guiplayer_gpGUI_setter(instance):
...
@given(instance=connect_four_gui_GUIPlayer_strategy)
def test_hyp_connect_four_gui_guiplayer_m_name_setter(instance):
...
def test_hyp_connect_four_gui_token_X_setter(instance):
    original = instance.X
    instance.X = original
...
@given(instance=connect_four_gui_Token_strategy)
def test_hyp_connect_four_gui_token_Y_setter(instance):
    original = instance.Y
    instance.Y = original
...
@given(instance=connect_four_gui_Token_strategy)
def test_hyp_connect_four_gui_token_red_setter(instance):
...
@settings(max_examples=50)
def test_hyp_connect_four_gui_connect4gui_instantiation(instance):
    assert isinstance(instance, connect_four_gui_Connect4GUI)



@given(instance=connect_four_gui_Connect4GUI_strategy)
def test_hyp_connect_four_gui_connect4gui_redToken_setter(instance):
...
@given(instance=connect_four_gui_Connect4GUI_strategy)
def test_hyp_connect_four_gui_connect4gui_startUp_setter(instance):
...
@given(instance=connect_four_gui_Connect4GUI_strategy)
def test_hyp_connect_four_gui_connect4gui_window_setter(instance):
    original = instance.window
    instance.window = original
    assert instance.window == original
...
@given(instance=connect_four_gui_Connect4GUI_strategy)
def test_hyp_connect_four_gui_connect4gui_cpList_setter(instance):
...
@given(instance=connect_four_gui_Connect4GUI_strategy)
def test_hyp_connect_four_gui_connect4gui_comp_setter(instance):
...
@given(instance=connect_four_gui_Connect4GUI_strategy)
def test_hyp_connect_four_gui_connect4gui_gridBoard_setter(instance):
...
@given(instance=connect_four_gui_Connect4GUI_strategy)
def test_hyp_connect_four_gui_connect4gui_tokenRoot_setter(instance):
...
@settings(max_examples=50)
def test_hyp_connect_four_gui_gamepanel_instantiation(instance):
    assert isinstance(instance, connect_four_gui_GamePanel)



@given(instance=connect_four_gui_GamePanel_strategy)
def test_hyp_connect_four_gui_gamepanel_newColumnNum_setter(instance):
...
@given(instance=connect_four_gui_GamePanel_strategy)
def test_hyp_connect_four_gui_gamepanel_board_setter(instance):
    original = instance.board
    instance.board = original
    assert instance.board == original
...
@given(instance=connect_four_gui_GamePanel_strategy)
def test_hyp_connect_four_gui_gamepanel_game_setter(instance):
...
@given(instance=connect_four_gui_GamePanel_strategy)
def test_hyp_connect_four_gui_gamepanel_pieces_setter(instance):
...
@given(instance=connect_four_gui_GamePanel_strategy)
def test_hyp_connect_four_gui_gamepanel_players_setter(instance):
...
@given(instance=connect_four_gui_GamePanel_strategy)
def test_hyp_connect_four_gui_gamepanel_isComputerEnabled_setter(instance):
...
@given(instance=connect_four_gui_GamePanel_strategy)
def test_hyp_connect_four_gui_gamepanel_windows_setter(instance):
...
@given(instance=connect_four_gui_GamePanel_strategy)
def test_hyp_connect_four_gui_gamepanel_justWon_setter(instance):
...
@given(instance=connect_four_gui_GamePanel_strategy)
def test_hyp_connect_four_gui_gamepanel_whoPlayed_setter(instance):
...
@given(instance=connect_four_gui_GamePanel_strategy)
def test_hyp_connect_four_gui_gamepanel_startUp_setter(instance):
    original = instance.startUp
    instance.startUp = original
    assert instance.startUp == original
...
@given(instance=connect_four_gui_GamePanel_strategy)
def test_hyp_connect_four_gui_gamepanel_columnNum_setter(instance):
...
@given(instance=connect_four_gui_GamePanel_strategy)
def test_hyp_connect_four_gui_gamepanel_newDrawPos_setter(instance):
...
@given(instance=connect_four_gui_GamePanel_strategy)
def test_hyp_connect_four_gui_gamepanel_Connect4_GUI_setter(instance):
...
@given(instance=connect_four_gui_GamePanel_strategy)
def test_hyp_connect_four_gui_gamepanel_turnNum_setter(instance):
