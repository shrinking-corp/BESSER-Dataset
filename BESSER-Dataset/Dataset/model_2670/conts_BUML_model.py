...
# Classes
conts_A = Class(name="conts_A")
Named = Class(name="Named")
conts_H = Class(name="conts_H")
conts_B = Class(name="conts_B")
conts_C = Class(name="conts_C")
conts_G = Class(name="conts_G")
conts_Named = Class(name="conts_Named")
conts_E = Class(name="conts_E")
B = Class(name="B")
conts_F = Class(name="conts_F")
...
domain_model = DomainModel(
    name="conts",
    types={conts_A, Named, conts_H, conts_B, conts_C, conts_G, conts_Named, conts_E, B, conts_F},
    associations={hs6, bs0, cs1, gs3, fs5},
    generalizations={gen_conts_A_Named, gen_conts_F_Named, gen_conts_G_Named, gen_conts_H_Named, gen_conts_B_Named, gen_conts_C_Named, gen_conts_E_Named, gen_conts_E_B},
    metadata=None
)
