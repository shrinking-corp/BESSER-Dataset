...
# Classes
Original_Metamodel_A = Class(name="Original_Metamodel_A")
Original_Metamodel_B = Class(name="Original_Metamodel_B")
Original_Metamodel_C = Class(name="Original_Metamodel_C")
Original_Metamodel_D = Class(name="Original_Metamodel_D")
