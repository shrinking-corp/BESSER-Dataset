...
class di_Diagram(ABC):
    ...
    def __init__(self, name: str, documentation: str, resolution: float, di_Diagram: set["di_Style"] = None, owningDiagram: "di_DiagramElement" = None, Diagram: "di_DiagramElement" = None):
        self.name = name
...
class di_Plane(Node):
    ...
    def plane_element_type(self, di_diagnostics, di_context) :
