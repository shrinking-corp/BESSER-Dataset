...
di_Plane_m_plane_element_type: Method = Method(name="plane_element_type", parameters={Parameter(name='di_context', type=StringType), Parameter(name='di_diagnostics', type=StringType)}, type=BooleanType)
...
domain_model = DomainModel(
    name="di",
    types={di_Node, DiagramElement, di_Edge, di_Point, di_Shape, Node, di_Bounds, di_DiagramElement, di_LabeledEdge, Edge, di_Diagram, di_Label, di_LabeledShape, di_EObject, di_Style, Shape, di_Plane},
    associations={ownedStyle9, rootElement11, source13, target15, waypoint18, bounds20, ownedLabel21, owningDiagram0, bounds22, owningElement2, ownedElement4, modelElement6, style7, planeElement27, ownedLabel25},
