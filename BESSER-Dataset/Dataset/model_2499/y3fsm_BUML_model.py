...
# Classes
y3fsm_Region = Class(name="y3fsm_Region")
AbstractState = Class(name="AbstractState")
y3fsm_AbstractState = Class(name="y3fsm_AbstractState", is_abstract=True)
y3fsm_Foo = Class(name="y3fsm_Foo")
...
domain_model = DomainModel(
    ...
    associations={subElements0, foos1, afooz3},
