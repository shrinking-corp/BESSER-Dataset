...
class y3fsm_Foo:
    ...
    def __init__(self, zoo: str, y3fsm_Foo: "y3fsm_AbstractState" = None, y3fsm_Foo5: "y3fsm_AbstractState" = None):
        self.zoo = zoo
...
class y3fsm_AbstractState(ABC):
    ...
    def __init__(self, id: str, y3fsm_AbstractState: "y3fsm_Region" = None, y3fsm_AbstractState2: set["y3fsm_Foo"] = None, y3fsm_AbstractState4: set["y3fsm_Foo"] = None):
        self.id = id
