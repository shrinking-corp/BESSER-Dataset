...
# Classes
Map_Map = Class(name="Map_Map")
Map_Address = Class(name="Map_Address")
...
Map_Address.attributes={Map_Address_downtown, Map_Address_telephone, Map_Address_latitude, Map_Address_longitude, Map_Address_pictures, Map_Address_name, Map_Address_description}
