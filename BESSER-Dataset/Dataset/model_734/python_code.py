...
class org_structure_ClassDefinition(GenericTypeDefinition):
    ...
    def __init__(self, isSingleton: str, isAbstract: str, isFinal: str, owningClass135: set["structure_Operation"] = None, invOwner: set["structure_Constraint"] = None, owningClass: set["structure_Property"] = None):
...
class org_structure_Class(ParameterizedType):
    ...
    def __init__(self, name: str, isAbstract: str, org_structure_Class: set["structure_Property"] = None, org_structure_Class108: set["structure_Operation"] = None, org_structure_Class111: set["structure_Class"] = None):
        self.name = name
        self.isAbstract = isAbstract
...
class org_structure_Package(structure_NamedElement, structure_ModelElementTypeDefinitionContainer):
    ...
    def __init__(self, uri: str, nestingPackage: set["structure_Package"] = None, nestedPackage: "structure_Package" = None, org_structure_Package: set["structure_AdaptationOperator"] = None):
        self.uri = uri
...
class org_structure_Property(structure_MultiplicityElement, structure_AbstractProperty):
    ...
    def __init__(self, isReadOnly: str, default: str, isComposite: str, isDerived: str, isID: str, isGetterAbstract: str, isSetterAbstract: str, ownedAttribute: "structure_ClassDefinition" = None, org_structure_Property: "structure_AbstractProperty" = None, org_structure_Property86: "behavior_Expression" = None, org_structure_Property89: "behavior_Expression" = None, org_structure_Property92: set["structure_UnresolvedProperty"] = None, structure_AbstractProperty: "org_structure_Property" = None):
...
class org_structure_Operation(structure_MultiplicityElement, structure_AbstractOperation):
    ...
    def __init__(self, uniqueName: str, isAbstract: str, org_structure_Operation80: set["structure_UnresolvedOperation"] = None, ownedOperation: "structure_ClassDefinition" = None, org_structure_Operation83: set["structure_TypeVariable"] = None, org_structure_Operation: set["structure_Type"] = None, operation: set["structure_Parameter"] = None, preOwner: set["structure_Constraint"] = None, postOwner: set["structure_Constraint"] = None, org_structure_Operation77: "behavior_Expression" = None):
...
class org_structure_UnresolvedProperty(structure_UnresolvedReference, structure_AbstractProperty):
    ...
    def __init__(self, propertyIdentifier: str, structure_UnresolvedReference: "org_structure_UseAdaptationOperator" = None, structure_AbstractProperty: "org_structure_Property" = None):
...
class org_structure_UnresolvedType(structure_UnresolvedReference, structure_TypeContainer, structure_Type):
    ...
    def __init__(self, typeIdentifier: str, org_structure_UnresolvedType: set["structure_Using"] = None, org_structure_UnresolvedType162: set["structure_Type"] = None, TypeContainer: "org_structure_Type" = None, structure_Type63: "org_behavior_UnresolvedCall" = None, structure_Type119: "org_structure_PrimitiveType" = None, structure_Type165: "org_structure_ProductType" = None, structure_Type16: "org_behavior_CallSuperOperation" = None, structure_Type121: "org_structure_TypedElement" = None, structure_Type71: "org_structure_Operation" = None, structure_Type: "org_behavior_Expression" = None, structure_Type102: "org_structure_TypeVariableBinding" = None, structure_Type163: "org_structure_UnresolvedType" = None, structure_Type8: "org_behavior_CallExpression" = None, structure_Type60: "org_behavior_UnresolvedCall" = None, Type: "org_structure_TypeContainer" = None, structure_Type170: "org_structure_FunctionType" = None, structure_Type104: "org_structure_TypeDefinition" = None, structure_Type167: "org_structure_FunctionType" = None, structure_Type150: "org_structure_TypeVariable" = None, structure_UnresolvedReference: "org_structure_UseAdaptationOperator" = None):
...
class org_structure_FunctionType(structure_Type, structure_TypeContainer):
    ...
    pass
class org_structure_UnresolvedOperation(structure_UnresolvedReference, structure_AbstractOperation, structure_TypeContainer):
...
class org_structure_ModelTypeDefinitionBinding(structure_ModelTypeDefinitionContainer, structure_KermetaModelElement):
    ...
    pass
class org_behavior_Expression(structure_KermetaModelElement, structure_TypeContainer):
