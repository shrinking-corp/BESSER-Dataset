...
domain_model = DomainModel(
    name="rdbms",
    types={rdbms_RDBMSModel, rdbms_Table, rdbms_Column, rdbms_ForeignKey},
    associations={containsTables0, containsColumns1, containsForeignKeys3, references14, columns17, foreignKeys5, columns8, primaryKey11},
    generalizations={},
    metadata=None
)
