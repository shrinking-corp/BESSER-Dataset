...
class rdbms_Column:
    ...
    def __init__(self, name: str, type: str, rdbms_Column: "rdbms_RDBMSModel" = None, rdbms_Column19: "rdbms_ForeignKey" = None, rdbms_Column10: "rdbms_Table" = None, rdbms_Column13: "rdbms_Table" = None):
        self.name = name
        self.type = type
...
class rdbms_Table:
    ...
    def __init__(self, name: str, rdbms_Table: "rdbms_RDBMSModel" = None, rdbms_Table16: "rdbms_ForeignKey" = None, rdbms_Table6: set["rdbms_ForeignKey"] = None, rdbms_Table9: set["rdbms_Column"] = None, rdbms_Table12: set["rdbms_Column"] = None):
        self.name = name
