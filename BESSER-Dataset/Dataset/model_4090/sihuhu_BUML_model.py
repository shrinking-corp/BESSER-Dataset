...
# Classes
sihuhu_World = Class(name="sihuhu_World")
NamedElement = Class(name="NamedElement")
sihuhu_Track = Class(name="sihuhu_Track")
sihuhu_Train = Class(name="sihuhu_Train")
sihuhu_Rail = Class(name="sihuhu_Rail")
sihuhu_Switch = Class(name="sihuhu_Switch")
sihuhu_TrackElement = Class(name="sihuhu_TrackElement", is_abstract=True)
TrackElement = Class(name="TrackElement")
sihuhu_Signal = Class(name="sihuhu_Signal")
sihuhu_SwitchConnection = Class(name="sihuhu_SwitchConnection")
Rail = Class(name="Rail")
sihuhu_NamedElement = Class(name="sihuhu_NamedElement", is_abstract=True)
...
domain_model = DomainModel(
    ...
    associations={train7, tracks0, trains1, rails3, switches5, allowedTo8, allowedFrom10, from_13, to15, connections18, connectedRails20, activeConnection23, nextElement26, onTracks29, nextRail30},
