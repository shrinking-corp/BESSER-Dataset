...
class MOFScriptModel_PointCut:
    ...
    def __init__(self, typeMatch: str, name: str, MOFScriptModel_PointCut: "MOFScriptModel_MOFScriptAspect" = None, MOFScriptModel_PointCut92: "MOFScriptModel_Advice" = None, MOFScriptModel_PointCut94: "MOFScriptModel_PointCutExpression" = None):
...
class MOFScriptModel_FunctionCall(SimpleExpression):
    ...
    def __init__(self, isSuperCall: bool, transformationContext: str, name: str, MOFScriptModel_FunctionCall: set["MOFScriptModel_ValueExpression"] = None, MOFScriptModel_FunctionCall105: "MOFScriptModel_SelectExpression" = None, MOFScriptModel_FunctionCall54: "MOFScriptModel_TransformationRule" = None, MOFScriptModel_FunctionCall61: "MOFScriptModel_FunctionCallStatement" = None):
    ...
    @property
    def transformationContext(self):
...
class MOFScriptModel_FileStatement(MOFScriptStatement):
    ...
    def __init__(self, append: bool, fileReference: str, use: bool, MOFScriptModel_FileStatement: "MOFScriptModel_ValueExpression" = None):
        self.append = append
...
class MOFScriptModel_MOFScriptObject(ABC):
    ...
    def __init__(self, column: int, line: int, MOFScriptModel_MOFScriptObject: set["MOFScriptModel_MOFScriptComment"] = None):
        self.column = column
        self.line = line
...
class MOFScriptModel_StatementBlock:
    ...
    def __init__(self, protected: bool, id: str, reference: str, MOFScriptModel_StatementBlock17: set["MOFScriptModel_MOFScriptStatement"] = None, MOFScriptModel_StatementBlock: "MOFScriptModel_MOFScriptStatementOwner" = None):
...
class MOFScriptModel_ValueExpression(Expression):
    ...
    def __init__(self, specification: str, MOFScriptModel_ValueExpression: "MOFScriptModel_IteratorStatement" = None, MOFScriptModel_ValueExpression39: "MOFScriptModel_IteratorStatement" = None, MOFScriptModel_ValueExpression42: "MOFScriptModel_IteratorStatement" = None, MOFScriptModel_ValueExpression52: "MOFScriptModel_FunctionCall" = None, MOFScriptModel_ValueExpression70: "MOFScriptModel_FileStatement" = None, MOFScriptModel_ValueExpression72: "MOFScriptModel_ComparisonExpression" = None, MOFScriptModel_ValueExpression75: "MOFScriptModel_ComparisonExpression" = None, MOFScriptModel_ValueExpression109: "MOFScriptModel_CreateExpressionParameter" = None, MOFScriptModel_ValueExpression63: "MOFScriptModel_PrintStatement" = None, MOFScriptModel_ValueExpression65: "MOFScriptModel_ArithmeticExpression" = None, MOFScriptModel_ValueExpression68: "MOFScriptModel_ArithmeticExpression" = None):
...
class MOFScriptModel_PointCutExpression:
    ...
    def __init__(self, expressionString: str, operator: str, combinationOperator: str, MOFScriptModel_PointCutExpression97: "MOFScriptModel_PointCutExpression" = None, MOFScriptModel_PointCutExpression95: set["MOFScriptModel_PointCutExpression"] = None, MOFScriptModel_PointCutExpression: "MOFScriptModel_PointCut" = None):
...
class MOFScriptModel_MOFScriptImport(MOFScriptObject):
    ...
    def __init__(self, name: str, type: str, uri: str, importSemantics: str, MOFScriptModel_MOFScriptImport: "MOFScriptModel_MOFScriptSpecification" = None):
        self.name = name
        self.type = type
        self.uri = uri
