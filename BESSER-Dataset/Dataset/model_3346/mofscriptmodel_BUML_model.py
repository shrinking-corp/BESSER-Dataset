...
# Classes
MOFScriptModel_TransformationRule = Class(name="MOFScriptModel_TransformationRule")
MOFScriptStatementOwner = Class(name="MOFScriptStatementOwner")
MOFScriptModel_MOFScriptTransformation = Class(name="MOFScriptModel_MOFScriptTransformation")
MOFScriptModel_MOFScriptParameter = Class(name="MOFScriptModel_MOFScriptParameter")
MOFScriptModel_MOFScriptStatementOwner = Class(name="MOFScriptModel_MOFScriptStatementOwner", is_abstract=True)
MOFScriptObject = Class(name="MOFScriptObject")
MOFScriptModel_MOFScriptStatement = Class(name="MOFScriptModel_MOFScriptStatement", is_abstract=True)
MOFScriptModel_MOFScriptComment = Class(name="MOFScriptModel_MOFScriptComment")
MOFScriptModel_Expression = Class(name="MOFScriptModel_Expression", is_abstract=True)
MOFScriptModel_ValueExpression = Class(name="MOFScriptModel_ValueExpression")
Expression = Class(name="Expression")
MOFScriptModel_VariableDeclaration = Class(name="MOFScriptModel_VariableDeclaration")
MOFScriptModel_StatementBlock = Class(name="MOFScriptModel_StatementBlock")
MOFScriptModel_MOFScriptObject = Class(name="MOFScriptModel_MOFScriptObject", is_abstract=True)
MOFScriptModel_IteratorStatement = Class(name="MOFScriptModel_IteratorStatement")
MOFScriptStatement = Class(name="MOFScriptStatement")
MOFScriptModel_SimpleExpression = Class(name="MOFScriptModel_SimpleExpression")
MOFScriptModel_LogicalExpression = Class(name="MOFScriptModel_LogicalExpression")
MOFScriptModel_MOFScriptImport = Class(name="MOFScriptModel_MOFScriptImport")
MOFScriptModel_CreateStatement = Class(name="MOFScriptModel_CreateStatement")
MOFScriptModel_ResultAssignment = Class(name="MOFScriptModel_ResultAssignment")
MOFScriptModel_GeneralAssignment = Class(name="MOFScriptModel_GeneralAssignment")
MOFScriptModel_Literal = Class(name="MOFScriptModel_Literal")
MOFScriptModel_Reference = Class(name="MOFScriptModel_Reference")
MOFScriptModel_FunctionCallStatement = Class(name="MOFScriptModel_FunctionCallStatement")
MOFScriptModel_PrintStatement = Class(name="MOFScriptModel_PrintStatement")
MOFScriptModel_ArithmeticExpression = Class(name="MOFScriptModel_ArithmeticExpression")
ValueExpression = Class(name="ValueExpression")
MOFScriptModel_FunctionCall = Class(name="MOFScriptModel_FunctionCall")
SimpleExpression = Class(name="SimpleExpression")
MOFScriptModel_ComparisonExpression = Class(name="MOFScriptModel_ComparisonExpression")
MOFScriptModel_IfStatement = Class(name="MOFScriptModel_IfStatement")
MOFScriptModel_MOFScriptSpecification = Class(name="MOFScriptModel_MOFScriptSpecification")
MOFScriptModel_BreakStatement = Class(name="MOFScriptModel_BreakStatement")
MOFScriptModel_WhileStatement = Class(name="MOFScriptModel_WhileStatement")
MOFScriptModel_MOFScriptAspect = Class(name="MOFScriptModel_MOFScriptAspect")
MOFScriptTransformation = Class(name="MOFScriptTransformation")
MOFScriptModel_Advice = Class(name="MOFScriptModel_Advice")
MOFScriptModel_PointCut = Class(name="MOFScriptModel_PointCut")
MOFScriptModel_FileStatement = Class(name="MOFScriptModel_FileStatement")
MOFScriptModel_SelectExpression = Class(name="MOFScriptModel_SelectExpression")
MOFScriptModel_CreateExpression = Class(name="MOFScriptModel_CreateExpression")
MOFScriptModel_CreateExpressionParameter = Class(name="MOFScriptModel_CreateExpressionParameter")
MOFScriptModel_ReturnStatement = Class(name="MOFScriptModel_ReturnStatement")
MOFScriptModel_VariableDeclarationStatement = Class(name="MOFScriptModel_VariableDeclarationStatement")
MOFScriptModel_DebugStatement = Class(name="MOFScriptModel_DebugStatement")
MOFScriptModel_PointCutExpression = Class(name="MOFScriptModel_PointCutExpression")
MOFScriptModel_Trace = Class(name="MOFScriptModel_Trace", is_abstract=True)
MOFScriptModel_M2MTrace = Class(name="MOFScriptModel_M2MTrace")
...
MOFScriptModel_TransformationRule_return_: Property = Property(name="return_", type=StringType)
...
MOFScriptModel_TransformationRule.attributes={MOFScriptModel_TransformationRule_name, MOFScriptModel_TransformationRule_return_, MOFScriptModel_TransformationRule_accessLevel, MOFScriptModel_TransformationRule_isAbstract, MOFScriptModel_TransformationRule_isEntryPoint}
...
MOFScriptModel_MOFScriptParameter.attributes={MOFScriptModel_MOFScriptParameter_name, MOFScriptModel_MOFScriptParameter_type, MOFScriptModel_MOFScriptParameter_typePrefix, MOFScriptModel_MOFScriptParameter_direction}
...
MOFScriptModel_MOFScriptComment.attributes={MOFScriptModel_MOFScriptComment_docStyle, MOFScriptModel_MOFScriptComment_singleLine, MOFScriptModel_MOFScriptComment_commentText}
...
MOFScriptModel_VariableDeclaration.attributes={MOFScriptModel_VariableDeclaration_constant, MOFScriptModel_VariableDeclaration_name, MOFScriptModel_VariableDeclaration_type}
...
MOFScriptModel_MOFScriptImport.attributes={MOFScriptModel_MOFScriptImport_name, MOFScriptModel_MOFScriptImport_type, MOFScriptModel_MOFScriptImport_uri, MOFScriptModel_MOFScriptImport_importSemantics}
...
MOFScriptModel_CreateStatement.attributes={MOFScriptModel_CreateStatement_name, MOFScriptModel_CreateStatement_type}
...
MOFScriptModel_ResultAssignment.attributes={MOFScriptModel_ResultAssignment_operator, MOFScriptModel_ResultAssignment_resultPart}
...
MOFScriptModel_Literal.attributes={MOFScriptModel_Literal_value, MOFScriptModel_Literal_type}
...
MOFScriptModel_PrintStatement.attributes={MOFScriptModel_PrintStatement_printCommand, MOFScriptModel_PrintStatement_context}
...
MOFScriptModel_FunctionCall.attributes={MOFScriptModel_FunctionCall_name, MOFScriptModel_FunctionCall_transformationContext, MOFScriptModel_FunctionCall_isSuperCall}
...
MOFScriptModel_Advice.attributes={MOFScriptModel_Advice_operator, MOFScriptModel_Advice_name, MOFScriptModel_Advice_pointCutRef, MOFScriptModel_Advice_code}
...
MOFScriptModel_PointCut.attributes={MOFScriptModel_PointCut_name, MOFScriptModel_PointCut_typeMatch}
...
MOFScriptModel_PointCutExpression.attributes={MOFScriptModel_PointCutExpression_expressionString, MOFScriptModel_PointCutExpression_combinationOperator, MOFScriptModel_PointCutExpression_operator}
...
MOFScriptModel_M2MTrace.attributes={MOFScriptModel_M2MTrace_name, MOFScriptModel_M2MTrace_id}
...
domain_model = DomainModel(
    name="MOFScriptModel",
    types={MOFScriptModel_TransformationRule, MOFScriptStatementOwner, MOFScriptModel_MOFScriptTransformation, MOFScriptModel_MOFScriptParameter, MOFScriptModel_MOFScriptStatementOwner, MOFScriptObject, MOFScriptModel_MOFScriptStatement, MOFScriptModel_MOFScriptComment, MOFScriptModel_Expression, MOFScriptModel_ValueExpression, Expression, MOFScriptModel_VariableDeclaration, MOFScriptModel_StatementBlock, MOFScriptModel_MOFScriptObject, MOFScriptModel_IteratorStatement, MOFScriptStatement, MOFScriptModel_SimpleExpression, MOFScriptModel_LogicalExpression, MOFScriptModel_MOFScriptImport, MOFScriptModel_CreateStatement, MOFScriptModel_ResultAssignment, MOFScriptModel_GeneralAssignment, MOFScriptModel_Literal, MOFScriptModel_Reference, MOFScriptModel_FunctionCallStatement, MOFScriptModel_PrintStatement, MOFScriptModel_ArithmeticExpression, ValueExpression, MOFScriptModel_FunctionCall, SimpleExpression, MOFScriptModel_ComparisonExpression, MOFScriptModel_IfStatement, MOFScriptModel_MOFScriptSpecification, MOFScriptModel_BreakStatement, MOFScriptModel_WhileStatement, MOFScriptModel_MOFScriptAspect, MOFScriptTransformation, MOFScriptModel_Advice, MOFScriptModel_PointCut, MOFScriptModel_FileStatement, MOFScriptModel_SelectExpression, MOFScriptModel_CreateExpression, MOFScriptModel_CreateExpressionParameter, MOFScriptModel_ReturnStatement, MOFScriptModel_VariableDeclarationStatement, MOFScriptModel_DebugStatement, MOFScriptModel_PointCutExpression, MOFScriptModel_Trace, MOFScriptModel_M2MTrace, Trace, ParameterDirection, ImportType, ImportSemantics, AssignmentOperator, AccessLevel, LiteralType, LogicalOperator, ArithmeticOperator, ComparisonOperator, PointCutOperator, PointCutCombinationOperator, AdviceOperator},
    associations={owner0, extends2, parameters3, context5, comment12, owner13, value14, statements16, variables18, constants20, parameters23, extends27, transformationrules29, statements8, variables9, blocks10, filterExpression31, source33, before35, between37, after40, part143, parameters51, transformationRule53, expression56, expression58, function60, printBody62, part245, part164, part266, additionalExpressionPart49, fileURI69, part271, part173, ifExpression76, elseBranch79, transformation81, imports83, condition85, advice87, pointcut88, pointcut90, combinedExpression96, filterExpression98, sourceReference100, appliedFunction103, parameters106, value107, expression110, variable112, pointcutexpression93, source114, target115},
    generalizations={gen_MOFScriptModel_TransformationRule_MOFScriptStatementOwner, gen_MOFScriptModel_MOFScriptStatementOwner_MOFScriptObject, gen_MOFScriptModel_MOFScriptComment_MOFScriptObject, gen_MOFScriptModel_MOFScriptStatement_MOFScriptStatementOwner, gen_MOFScriptModel_VariableDeclaration_MOFScriptObject, gen_MOFScriptModel_ValueExpression_Expression, gen_MOFScriptModel_Expression_MOFScriptObject, gen_MOFScriptModel_MOFScriptTransformation_MOFScriptObject, gen_MOFScriptModel_MOFScriptParameter_MOFScriptObject, gen_MOFScriptModel_IteratorStatement_MOFScriptStatement, gen_MOFScriptModel_LogicalExpression_Expression, gen_MOFScriptModel_MOFScriptImport_MOFScriptObject, gen_MOFScriptModel_CreateStatement_MOFScriptStatement, gen_MOFScriptModel_ResultAssignment_MOFScriptStatement, gen_MOFScriptModel_GeneralAssignment_MOFScriptStatement, gen_MOFScriptModel_Literal_SimpleExpression, gen_MOFScriptModel_Reference_SimpleExpression, gen_MOFScriptModel_FunctionCallStatement_MOFScriptStatement, gen_MOFScriptModel_PrintStatement_MOFScriptStatement, gen_MOFScriptModel_ArithmeticExpression_ValueExpression, gen_MOFScriptModel_SimpleExpression_ValueExpression, gen_MOFScriptModel_FunctionCall_SimpleExpression, gen_MOFScriptModel_ComparisonExpression_Expression, gen_MOFScriptModel_IfStatement_MOFScriptStatement, gen_MOFScriptModel_MOFScriptSpecification_MOFScriptObject, gen_MOFScriptModel_BreakStatement_MOFScriptStatement, gen_MOFScriptModel_WhileStatement_MOFScriptStatement, gen_MOFScriptModel_MOFScriptAspect_MOFScriptTransformation, gen_MOFScriptModel_Advice_MOFScriptStatementOwner, gen_MOFScriptModel_FileStatement_MOFScriptStatement, gen_MOFScriptModel_SelectExpression_ValueExpression, gen_MOFScriptModel_CreateExpression_Expression, gen_MOFScriptModel_CreateExpressionParameter_MOFScriptObject, gen_MOFScriptModel_ReturnStatement_MOFScriptStatement, gen_MOFScriptModel_VariableDeclarationStatement_MOFScriptStatement, gen_MOFScriptModel_DebugStatement_MOFScriptStatement, gen_MOFScriptModel_Trace_MOFScriptStatement, gen_MOFScriptModel_M2MTrace_Trace},
    metadata=None
)
