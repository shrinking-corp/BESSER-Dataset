...
# Classes
labels_TestDynamicEdgeLabel = Class(name="labels_TestDynamicEdgeLabel")
DynamicEdgeLabel = Class(name="DynamicEdgeLabel")
labels_TestLabel = Class(name="labels_TestLabel")
Label = Class(name="Label")
labels_TestStaticEdgeLabel = Class(name="labels_TestStaticEdgeLabel")
StaticEdgeLabel = Class(name="StaticEdgeLabel")
labels_TestStaticNodeLabel = Class(name="labels_TestStaticNodeLabel")
StaticNodeLabel = Class(name="StaticNodeLabel")
labels_TestDynamicLabel1 = Class(name="labels_TestDynamicLabel1")
DynamicLabel = Class(name="DynamicLabel")
labels_TestDynamicNodeLabel = Class(name="labels_TestDynamicNodeLabel")
DynamicNodeLabel = Class(name="DynamicNodeLabel")
labels_TestIntegerLabelValue = Class(name="labels_TestIntegerLabelValue")
...
domain_model = DomainModel(
    name="labels",
    types={labels_TestDynamicEdgeLabel, DynamicEdgeLabel, labels_TestLabel, Label, labels_TestStaticEdgeLabel, StaticEdgeLabel, labels_TestStaticNodeLabel, StaticNodeLabel, labels_TestDynamicLabel1, DynamicLabel, labels_TestDynamicNodeLabel, DynamicNodeLabel, labels_TestIntegerLabelValue, LabelValue},
    associations={},
    generalizations={gen_labels_TestDynamicEdgeLabel_DynamicEdgeLabel, gen_labels_TestLabel_Label, gen_labels_TestStaticEdgeLabel_StaticEdgeLabel, gen_labels_TestStaticNodeLabel_StaticNodeLabel, gen_labels_TestDynamicLabel1_DynamicLabel, gen_labels_TestDynamicNodeLabel_DynamicNodeLabel, gen_labels_TestIntegerLabelValue_LabelValue},
    metadata=None
)
