...
class build_Capability(INamedValue):
    ...
    def satisfies(self, build_requirement) :
...
class build_ContainerConfiguration:
    ...
    def __init__(self, documentation: str, name: str, build_ContainerConfiguration69: "build_IType" = None, build_ContainerConfiguration72: "build_BExpression" = None, build_ContainerConfiguration: "build_BuildUnit" = None):
...
class build_RequiredCapability(Capability):
    ...
    def __init__(self, versionRange: str, greedy: bool, max: int, min: int, build_RequiredCapability: "build_BuildUnit" = None, build_RequiredCapability154: "build_IRequiredCapabilityContainer" = None, build_RequiredCapability204: "build_EffectiveRequirementFacade" = None, build_RequiredCapability212: "build_BuilderCallFacade" = None, build_RequiredCapability257: "build_BuildCallSingle" = None, build_RequiredCapability259: "build_BuildCallOnDeclaredRequirement" = None, build_RequiredCapability261: "build_BuildCallOnReferencedRequirement" = None, build_RequiredCapability269: "build_FragmentHost" = None):
...
class build_IBuilder(IProvidedCapabilityContainer, IFunction):
    ...
    def __init__(self, unitType: str, build_IBuilder25: "build_BExpression" = None, build_IBuilder27: "build_BExpression" = None, build_IBuilder30: "build_BuilderInput" = None, build_IBuilder32: "build_PathGroup" = None, build_IBuilder34: "build_BPropertySet" = None, build_IBuilder37: "build_BExpression" = None, build_IBuilder40: "build_UnitParameterDeclaration" = None, build_IBuilder42: "build_PathGroup" = None, build_IBuilder: "build_BuildUnit" = None):
...
class VersionedCapability:
    ...
    pass
class build_BuildUnit(BFunctionContainer, VersionedCapability, IVarName, IProvidedCapabilityContainer, IRequiredCapabilityContainer):

    def __init__(self, documentation: str, executionMode: str, sourceLocation: str, outputLocation: str, platformFilter: str, build_BuildUnit14: set["build_ContainerConfiguration"] = None, build_BuildUnit16: set["build_BPropertySet"] = None, build_BuildUnit2: set["build_RequiredCapability"] = None, build_BuildUnit4: set["build_IType"] = None, build_BuildUnit6: set["build_BConcern"] = None, build_BuildUnit8: "build_BPropertySet" = None, build_BuildUnit10: set["build_Synchronization"] = None, build_BuildUnit12: set["build_Repository"] = None, build_BuildUnit: set["build_IBuilder"] = None, build_BuildUnit19: set["build_FirstFoundUnitProvider"] = None, build_BuildUnit21: "build_IBuildUnitContainer" = None, build_BuildUnit23: set["build_FragmentHost"] = None, build_BuildUnit191: "build_EffectiveUnitFacade" = None, build_BuildUnit266: "build_IBuildUnitContainer" = None, build_BuildUnit220: "build_UnitResolutionInfo" = None):
        self.documentation = documentation
    ...
    def getUnitProvider(self) :
        # TODO: Implement getUnitProvider method
        pass

    def getEffectiveFacade(self, build_ctx) :
...
class build_UnitParameterDeclaration(BParameterDeclaration):
    ...
    def hasCorrectState(self, build_map, build_chain) :
...
class build_BuilderInputCondition(BuilderInputDecorator):
    ...
    pass
class build_BuilderInputNameDecorator(BuilderInputDecorator, INamedValue):
...
class build_Branch:
    ...
    def __init__(self, name: str, documentation: str, branchPointType: str, mergeStrategy: str, checkout: str, acceptDirty: str, update: str, replace: str, build_Branch242: "build_BExpression" = None, build_Branch: "build_Repository" = None, build_Branch236: set["build_BNamePredicate"] = None, build_Branch239: set["build_BNamePredicate"] = None):
        self.name = name
        self.documentation = documentation
...
class build_BuildUnitRepository(IBuildUnitRepository):
    ...
    def __init__(self):
        ...
        pass
    def initialize(self, build_ctx, build_repository, build_options):
        # TODO: Implement initialize method
        pass

    def resolve(self, build_ctx, build_options, build_requiredCapability) :
...
class build_BuildSet(ITypedValueContainer):
    ...
    def merge(self, build_buildResult) :
...
class build_BeeHive:
    ...
    def getResolvedCapabilityContainer(self, build_requiredCapability) :
...
class BChainedExpression:
    ...
    pass
class build_BeeModel(BChainedExpression, IBuildUnitContainer):

    def __init__(self, build_BeeModel: set["build_IType"] = None, build_BeeModel169: set["build_IFunction"] = None, build_BeeModel171: set["build_BConcern"] = None, build_BeeModel174: set["build_BPropertySet"] = None, build_BeeModel177: set["build_Repository"] = None, build_BeeModel186: "build_BeeHive" = None, build_BeeModel180: set["build_FirstFoundUnitProvider"] = None, build_BeeModel183: "build_BPropertySet" = None, build_BeeModel218: "build_BeeModelRepository" = None):
...
class IBuilder:
    ...
    pass
class build_BuilderWrapper(IBuilder, BFunctionWrapper):
    ...
    @property
    def defaultPropertiesAdvised(self):
...
class BuildConcernContext:
    ...
    pass
class build_UnitConcernContext(BuildConcernContext, IRequiredCapabilityContainer):

    def __init__(self, sourceLocation: str, outputLocation: str, build_UnitConcernContext: set["build_BuilderConcernContext"] = None, build_UnitConcernContext95: "build_BExpression" = None, build_UnitConcernContext98: set["build_RequiresPredicate"] = None, build_UnitConcernContext101: set["build_ProvidesPredicate"] = None, build_UnitConcernContext104: set["build_CapabilityPredicate"] = None):
        self.sourceLocation = sourceLocation
        self.outputLocation = outputLocation
...
class build_BuilderConcernContext(BuildConcernContext):
    ...
    def __init__(self, varArgs: bool, outputAnnotationsRemovals: str, sourceAnnotationsRemovals: str, matchParameters: bool, removePreCondition: bool, removePostCondition: bool, removePostInputCondition: bool, build_BuilderConcernContext: "build_UnitConcernContext" = None, build_BuilderConcernContext107: "build_BExpression" = None, build_BuilderConcernContext146: "build_BPropertySet" = None, build_BuilderConcernContext124: set["build_BParameterPredicate"] = None, build_BuilderConcernContext126: "build_BExpression" = None, build_BuilderConcernContext129: "build_BExpression" = None, build_BuilderConcernContext110: set["build_BuilderInput"] = None, build_BuilderConcernContext113: set["build_InputPredicate"] = None, build_BuilderConcernContext116: set["build_ConditionalPathVector"] = None, build_BuilderConcernContext119: set["build_OutputPredicate"] = None, build_BuilderConcernContext121: "build_BExpression" = None, build_BuilderConcernContext132: "build_BExpression" = None, build_BuilderConcernContext135: set["build_ProvidesPredicate"] = None, build_BuilderConcernContext138: "build_BPropertySet" = None, build_BuilderConcernContext141: set["build_SourcePredicate"] = None, build_BuilderConcernContext143: set["build_ConditionalPathVector"] = None):
        ...
        pass
    @property
    def outputAnnotationsRemovals(self):
    ...
    @property
    def sourceAnnotationsRemovals(self):
    ...
    @property
    def removePostInputCondition(self):
...
class BConcernContext:
    ...
    pass
class build_BuildConcernContext(BConcernContext, IProvidedCapabilityContainer):
    ...
    def __init__(self, defaultPropertiesRemovals: str, build_BuildConcernContext: "build_BPropertySet" = None):
        ...
        pass
    @property
    def defaultPropertiesRemovals(self):
...
class build_Repository(BExpression):
    ...
    def __init__(self, documentation: str, handlerType: str, name: str, build_Repository62: "build_RepositoryUnitProvider" = None, build_Repository: "build_BuildUnit" = None, build_Repository178: "build_BeeModel" = None, build_Repository225: set["build_Branch"] = None, build_Repository227: set["build_RepoOption"] = None, build_Repository230: "build_IBuildUnitRepository" = None, build_Repository233: "build_BExpression" = None, build_Repository250: "build_UnitRepositoryDescription" = None):
        self.documentation = documentation
...
class build_RequiresPredicate(BExpression):
    ...
    def matches(self, build_candidate) :
...
class build_PathGroupPredicate(BExpression):
    ...
    def removeMatching(self, build_input) :
        # TODO: Implement removeMatching method
        pass

class build_CapabilityPredicate(BExpression):

    def __init__(self, versionRange: str, build_CapabilityPredicate78: "build_BNamePredicate" = None, build_CapabilityPredicate80: "build_BNamePredicate" = None, build_CapabilityPredicate85: "build_ProvidesPredicate" = None, build_CapabilityPredicate: "build_RequiresPredicate" = None, build_CapabilityPredicate105: "build_UnitConcernContext" = None, build_CapabilityPredicate157: "build_IRequiredCapabilityContainer" = None, build_CapabilityPredicate89: "build_InputPredicate" = None, build_CapabilityPredicate252: "build_BuildCallOnSelectedRequirements" = None):
        self.versionRange = versionRange
...
class build_UnitProvider(BExpression):
    ...
    def resolve(self, build_effectiveRequirement) :
        # TODO: Implement resolve method
        pass
...
class build_PathVector:
    ...
    def resolve(self, build_baseUri) :
        # TODO: Implement resolve method
        pass
