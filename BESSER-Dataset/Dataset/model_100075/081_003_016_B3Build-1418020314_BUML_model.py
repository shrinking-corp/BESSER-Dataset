...
build_BuildUnit.attributes={build_BuildUnit_platformFilter, build_BuildUnit_outputLocation, build_BuildUnit_executionMode, build_BuildUnit_sourceLocation, build_BuildUnit_documentation}
build_BuildUnit.methods={build_BuildUnit_m_getEffectiveFacade, build_BuildUnit_m_getUnitProvider}
...
build_Repository.attributes={build_Repository_documentation, build_Repository_handlerType, build_Repository_name}
...
build_RequiredCapability.attributes={build_RequiredCapability_versionRange, build_RequiredCapability_greedy, build_RequiredCapability_min, build_RequiredCapability_max}
...
build_BuilderConcernContext.attributes={build_BuilderConcernContext_varArgs, build_BuilderConcernContext_removePostInputCondition, build_BuilderConcernContext_outputAnnotationsRemovals, build_BuilderConcernContext_sourceAnnotationsRemovals, build_BuilderConcernContext_removePostCondition, build_BuilderConcernContext_matchParameters, build_BuilderConcernContext_removePreCondition}
...
build_BuilderWrapper.attributes={build_BuilderWrapper_outputAdvised, build_BuilderWrapper_sourceAdvised, build_BuilderWrapper_unitTypeAdvised, build_BuilderWrapper_defaultPropertiesAdvised, build_BuilderWrapper_providesAdvised, build_BuilderWrapper_inputAdvised}
...
build_BuildUnitRepository_m_resolve: Method = Method(name="resolve", parameters={Parameter(name='build_options', type=StringType), Parameter(name='build_ctx', type=StringType), Parameter(name='build_requiredCapability', type=StringType)}, type=StringType)
build_BuildUnitRepository_m_initialize: Method = Method(name="initialize", parameters={Parameter(name='build_repository', type=StringType), Parameter(name='build_options', type=StringType), Parameter(name='build_ctx', type=StringType)})
...
build_Branch.attributes={build_Branch_update, build_Branch_documentation, build_Branch_name, build_Branch_acceptDirty, build_Branch_checkout, build_Branch_branchPointType, build_Branch_replace, build_Branch_mergeStrategy}
build_Branch.methods={build_Branch_m_hasValidState, build_Branch_m_getEffectiveUpdate, build_Branch_m_getEffectiveReplace, build_Branch_m_getEffectiveAcceptDirty, build_Branch_m_getEffectiveMergeStrategy, build_Branch_m_getEffectiveCheckout}
...
domain_model = DomainModel(
    name="build",
    types={build_BuildUnit, VersionedCapability, BFunctionContainer, IRequiredCapabilityContainer, build_IType, build_BConcern, build_BPropertySet, build_Synchronization, build_Repository, IProvidedCapabilityContainer, IVarName, build_IBuilder, build_RequiredCapability, build_FirstFoundUnitProvider, build_IBuildUnitContainer, build_FragmentHost, build_ContainerConfiguration, IFunction, build_BExpression, build_BuilderInput, build_PathGroup, build_ConditionalPathVector, build_BuilderInputDecorator, BuilderInput, build_BuilderCall, build_BParameterList, build_Capability, INamedValue, build_UnitParameterDeclaration, build_VersionedCapability, Capability, build_RepositoryUnitProvider, UnitProvider, build_RepoOption, build_IBuildUnitRepository, build_CompoundUnitProvider, CompoundUnitProvider, build_BestFoundUnitProvider, build_PathVector, build_BuilderQuery, build_UnitProvider, BExpression, build_BNamePredicate, build_ImplementsPredicate, build_ProvidesPredicate, build_NameSpacePredicate, build_BuildConcernContext, BConcernContext, build_RequiresPredicate, build_CapabilityPredicate, build_BuilderConcernContext, build_OutputPredicate, build_UnitNamePredicate, CapabilityPredicate, build_BuilderNamePredicate, build_InputPredicate, build_UnitConcernContext, BuildConcernContext, build_SourcePredicate, build_PathGroupPredicate, build_AliasedRequiredCapability, RequiredCapability, build_BParameterPredicate, build_Builder, B3Function, IBuilder, build_BuilderJava, BJavaFunction, build_BuilderWrapper, BFunctionWrapper, build_BeeModel, BChainedExpression, IBuildUnitContainer, build_IFunction, build_IRequiredCapabilityContainer, build_IProvidedCapabilityContainer, build_ResolutionInfo, build_EffectiveFacade, IEffectiveFacade, build_BeeHive, EffectiveFacade, build_EffectiveCapabilityFacade, build_EffectiveRequirementFacade, build_BuilderCallFacade, build_BuildSet, ITypedValueContainer, build_EffectiveUnitFacade, build_BuildUnitRepository, IBuildUnitRepository, build_CompoundBuildUnitRepository, BuildUnitRepository, build_CompoundFirstFoundRepository, CompoundBuildUnitRepository, build_ExecutionStackRepository, build_BeeModelRepository, build_UnitResolutionInfo, ResolutionInfo, build_BExecutionContext, build_BuildResultContext, BInnerContext, PathGroupPredicate, build_Branch, build_SwitchUnitProvider, build_BSwitchExpression, build_DelegatingUnitProvider, build_UnitRepositoryDescription, build_BuildCallOnSelectedRequirements, BuildCallMultiple, build_BuildCallSingle, build_BuildCallOnDeclaredRequirement, BuildCallSingle, build_BuildCallOnReferencedRequirement, build_BuilderInputGroup, build_IEffectiveFacade, build_EffectiveBuilderCallFacade, BuilderCallFacade, build_BuilderInputNameDecorator, BuilderInputDecorator, build_BuilderInputContextDecorator, build_BWithExpression, build_BuilderInputCondition, build_BuildCallMultiple, BuilderCall, BParameterDeclaration, BranchPointType, TriState, MergeConflictStrategy},
    associations={metaRequiredCapabilities1, implements3, concerns5, defaultProperties7, synchronizations9, repositories11, builders0, providers18, parent20, fragmentHosts22, containers13, propertySets15, postcondExpr24, precondExpr26, input29, output31, defaultProperties33, postinputcondExpr36, pathVectors47, builderInput49, parameters51, condExpr52, explicitUnitType39, source41, annotations44, repository61, options63, buildUnitRepository65, providers67, agentType68, contextBlock71, condExpr54, pathVectors57, builderQueries59, namePredicate77, nameSpacePredicate79, type82, capabilityPredicate84, defaultPropertiesAdditions74, capabilityPredicate76, builderContexts93, query94, requiresRemovals97, providesRemovals100, requiredPredicatesRemovals103, query106, inputAdditions109, inputRemovals112, outputAdditions115, outputRemovals118, funcExpr120, namePredicate86, capabilityPredicate88, builderPredicate90, postinputcondExpr131, providesRemovals134, outputAnnotationAdditions137, sourceRemovals140, sourceAdditions142, sourceAnnotationAdditions145, pathVector148, pathPattern150, parameters123, precondExpr125, postcondExpr128, unitQuery163, imports166, functions168, concerns170, propertySets173, repositories176, requiredCapabilities153, requiredPredicates155, providedCapabilities158, builderQueries160, beeModels185, parent188, providers179, defaultProperties182, unit190, providedCapabilities192, requiredCapabilities194, metaRequiredCapabilities196, unitRequiredCapabilities199, requirement202, providedCapability205, builderReference208, requiredCapability210, repositories215, beeModels217, unit219, pathVectors213, branches224, options226, buildUnitRepository229, address232, include235, exclude238, context221, repoSwitch223, delegate244, expr246, repository249, requiredPredicate251, branchPoint241, requiredCapability256, requiredCapabilityDeclaration258, requiredCapabilityReference260, context262, buildUnits264, hostRequirements267, withExpr253, condExpr254},
    generalizations={gen_build_BuildUnit_VersionedCapability, gen_build_BuildUnit_BFunctionContainer, gen_build_BuildUnit_IRequiredCapabilityContainer, gen_build_BuildUnit_IProvidedCapabilityContainer, gen_build_BuildUnit_IVarName, gen_build_IBuilder_IProvidedCapabilityContainer, gen_build_IBuilder_IFunction, gen_build_BuilderInputDecorator_BuilderInput, gen_build_BuilderCall_BuilderInput, gen_build_Capability_INamedValue, gen_build_RequiredCapability_Capability, gen_build_VersionedCapability_Capability, gen_build_RepositoryUnitProvider_UnitProvider, gen_build_CompoundUnitProvider_UnitProvider, gen_build_FirstFoundUnitProvider_CompoundUnitProvider, gen_build_BestFoundUnitProvider_CompoundUnitProvider, gen_build_UnitProvider_BExpression, gen_build_CapabilityPredicate_BExpression, gen_build_ImplementsPredicate_BExpression, gen_build_ProvidesPredicate_BExpression, gen_build_BuildConcernContext_BConcernContext, gen_build_BuildConcernContext_IProvidedCapabilityContainer, gen_build_RequiresPredicate_BExpression, gen_build_BuilderConcernContext_BuildConcernContext, gen_build_UnitNamePredicate_CapabilityPredicate, gen_build_BuilderNamePredicate_BExpression, gen_build_InputPredicate_BExpression, gen_build_UnitConcernContext_BuildConcernContext, gen_build_UnitConcernContext_IRequiredCapabilityContainer, gen_build_PathGroupPredicate_BExpression, gen_build_AliasedRequiredCapability_RequiredCapability, gen_build_Builder_B3Function, gen_build_Builder_IBuilder, gen_build_BuilderJava_BJavaFunction, gen_build_BuilderJava_IBuilder, gen_build_BuilderWrapper_BFunctionWrapper, gen_build_BuilderWrapper_IBuilder, gen_build_BeeModel_BChainedExpression, gen_build_BeeModel_IBuildUnitContainer, gen_build_EffectiveUnitFacade_EffectiveFacade, gen_build_EffectiveRequirementFacade_EffectiveFacade, gen_build_EffectiveCapabilityFacade_EffectiveFacade, gen_build_EffectiveFacade_IEffectiveFacade, gen_build_SourcePredicate_PathGroupPredicate, gen_build_BuildUnitRepository_IBuildUnitRepository, gen_build_CompoundBuildUnitRepository_BuildUnitRepository, gen_build_CompoundFirstFoundRepository_CompoundBuildUnitRepository, gen_build_ExecutionStackRepository_BuildUnitRepository, gen_build_BeeModelRepository_BuildUnitRepository, gen_build_UnitResolutionInfo_ResolutionInfo, gen_build_BuildSet_ITypedValueContainer, gen_build_BuildResultContext_BInnerContext, gen_build_OutputPredicate_PathGroupPredicate, gen_build_SwitchUnitProvider_UnitProvider, gen_build_Repository_BExpression, gen_build_DelegatingUnitProvider_UnitProvider, gen_build_UnitRepositoryDescription_BuildUnitRepository, gen_build_BuildCallOnSelectedRequirements_BuildCallMultiple, gen_build_BuildCallSingle_BuilderCall, gen_build_BuildCallOnDeclaredRequirement_BuildCallSingle, gen_build_BuildCallOnReferencedRequirement_BuildCallSingle, gen_build_BuilderInputGroup_BuilderInputDecorator, gen_build_EffectiveBuilderCallFacade_BuilderCallFacade, gen_build_EffectiveBuilderCallFacade_IEffectiveFacade, gen_build_BuilderInputNameDecorator_BuilderInputDecorator, gen_build_BuilderInputNameDecorator_INamedValue, gen_build_BuilderInputContextDecorator_BuilderInputDecorator, gen_build_BuilderInputCondition_BuilderInputDecorator, gen_build_BuildCallMultiple_BuilderCall, gen_build_UnitParameterDeclaration_BParameterDeclaration},
    metadata=None
)
