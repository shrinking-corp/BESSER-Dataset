...
# Classes
statemodel_Activity = Class(name="statemodel_Activity")
statemodel_TransitionBlock = Class(name="statemodel_TransitionBlock")
statemodel_Transition = Class(name="statemodel_Transition")
statemodel_Model = Class(name="statemodel_Model")
statemodel_Import = Class(name="statemodel_Import")
statemodel_Element = Class(name="statemodel_Element")
statemodel_Annotation = Class(name="statemodel_Annotation")
statemodel_Statemachine = Class(name="statemodel_Statemachine")
Element = Class(name="Element")
statemodel_Entity = Class(name="statemodel_Entity")
statemodel_State = Class(name="statemodel_State")
...
statemodel_Transition.attributes={statemodel_Transition_guard, statemodel_Transition_action}
...
statemodel_State.attributes={statemodel_State_type, statemodel_State_name}
...
domain_model = DomainModel(
    name="statemodel",
    types={statemodel_Activity, statemodel_TransitionBlock, statemodel_Transition, statemodel_Model, statemodel_Import, statemodel_Element, statemodel_Annotation, statemodel_Statemachine, Element, statemodel_Entity, statemodel_State, Activity, StateType},
    associations={element8, transition10, state11, imports0, elements1, annotation3, name5, state6},
    generalizations={gen_statemodel_TransitionBlock_Activity, gen_statemodel_Statemachine_Element, gen_statemodel_State_Element, gen_statemodel_State_Activity},
    metadata=None
)
