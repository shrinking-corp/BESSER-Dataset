...
domain_model = DomainModel(
    name="bowling",
    types={bowling_Player, bowling_League, bowling_Matchup, bowling_Game, bowling_Tournament, TournamentType},
    associations={matchups1, games2, matchup3, player4, players0},
    generalizations={},
    metadata=None
)
