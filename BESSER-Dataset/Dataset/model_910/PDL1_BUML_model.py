...
# Classes
pDL1_Process = Class(name="pDL1_Process")
pDL1_ProcessElement = Class(name="pDL1_ProcessElement")
pDL1_WorkDefinition = Class(name="pDL1_WorkDefinition")
ProcessElement = Class(name="ProcessElement")
pDL1_WorkSequence = Class(name="pDL1_WorkSequence")
pDL1_Guidance = Class(name="pDL1_Guidance")
