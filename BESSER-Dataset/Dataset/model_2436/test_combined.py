...
def test_hyp_classdiagram_column_is_not_abstract():
    assert not inspect.isabstract(ClassDiagram_Column)


def test_hyp_classdiagram_column_constructor_exists():
    assert callable(ClassDiagram_Column.__init__)


def test_hyp_classdiagram_column_constructor_args():
...
def test_hyp_classdiagram_table_is_not_abstract():
    assert not inspect.isabstract(ClassDiagram_Table)


def test_hyp_classdiagram_table_constructor_exists():
    assert callable(ClassDiagram_Table.__init__)


def test_hyp_classdiagram_table_constructor_args():
    sig = inspect.signature(ClassDiagram_Table.__init__)
    params = list(sig.parameters.keys())



def test_hyp_classdiagram_named_is_not_abstract():
    assert not inspect.isabstract(ClassDiagram_Named)


def test_hyp_classdiagram_named_constructor_exists():
    assert callable(ClassDiagram_Named.__init__)


def test_hyp_classdiagram_named_constructor_args():
...
def test_hyp_classdiagram_named_name_setter(instance):
...
def test_ClassDiagram_Named_name_value_roundtrip():
    instance = ClassDiagram_Named(name="sample_text")
...
def test_ClassDiagram_Column_isa_Named():
    instance = ClassDiagram_Column()
    assert isinstance(instance, Named)


def test_ClassDiagram_Table_isa_Named():
    instance = ClassDiagram_Table()
    assert isinstance(instance, Named)


def test_ClassDiagram_Type_isa_Named():
...
ClassDiagram_Column_strategy = st.builds(ClassDiagram_Column)
...
ClassDiagram_Named_strategy = st.builds(ClassDiagram_Named, name=safe_text)
@given(instance=ClassDiagram_Named_strategy)
@settings(max_examples=25)
...
ClassDiagram_Table_strategy = st.builds(ClassDiagram_Table)
