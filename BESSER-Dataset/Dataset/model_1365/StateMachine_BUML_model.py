...
# Classes
statemachine_Class = Class(name="statemachine_Class")
BehavioredClassifier = Class(name="BehavioredClassifier")
statemachine_StateMachine = Class(name="statemachine_StateMachine")
Behavior = Class(name="Behavior")
statemachine_Region = Class(name="statemachine_Region")
statemachine_NamedElement = Class(name="statemachine_NamedElement")
statemachine_BehavioredClassifier = Class(name="statemachine_BehavioredClassifier")
statemachine_Behavior = Class(name="statemachine_Behavior")
statemachine_Vertex = Class(name="statemachine_Vertex", is_abstract=True)
statemachine_Transition = Class(name="statemachine_Transition")
statemachine_BehavioralFeature = Class(name="statemachine_BehavioralFeature")
statemachine_OpaqueBehavior = Class(name="statemachine_OpaqueBehavior")
NamedElement = Class(name="NamedElement")
statemachine_Constraint = Class(name="statemachine_Constraint")
statemachine_Trigger = Class(name="statemachine_Trigger")
statemachine_PseudoState = Class(name="statemachine_PseudoState")
...
statemachine_Event = Class(name="statemachine_Event")
statemachine_MessageEvent = Class(name="statemachine_MessageEvent")
Event = Class(name="Event")
statemachine_CallEvent = Class(name="statemachine_CallEvent")
MessageEvent = Class(name="MessageEvent")
statemachine_Operation = Class(name="statemachine_Operation")
...
statemachine_OpaqueBehavior.attributes={statemachine_OpaqueBehavior_body, statemachine_OpaqueBehavior_language}
...
domain_model = DomainModel(
    name="statemachine",
    types={statemachine_Class, BehavioredClassifier, statemachine_StateMachine, Behavior, statemachine_Region, statemachine_NamedElement, statemachine_BehavioredClassifier, statemachine_Behavior, statemachine_Vertex, statemachine_Transition, statemachine_BehavioralFeature, statemachine_OpaqueBehavior, NamedElement, statemachine_Constraint, statemachine_Trigger, statemachine_PseudoState, Vertex, statemachine_State, statemachine_FinalState, State, statemachine_Event, statemachine_MessageEvent, Event, statemachine_CallEvent, MessageEvent, statemachine_Operation, BehavioralFeature, PseudoStateKind},
    associations={region0, ownedBehavior1, machine2, subvertex3, transition4, specification5, context6, behaviortransition7, guard9, source10, target12, transitionregion14, trigger16, effect17, outgoing19, incoming21, regionvertex23, eventtrigger25, operation26, behavior27, triggertransition29, event32, constrainttransition33},
    generalizations={gen_statemachine_Class_BehavioredClassifier, gen_statemachine_StateMachine_Behavior, gen_statemachine_OpaqueBehavior_Behavior, gen_statemachine_Transition_NamedElement, gen_statemachine_Vertex_NamedElement, gen_statemachine_PseudoState_Vertex, gen_statemachine_State_Vertex, gen_statemachine_FinalState_State, gen_statemachine_MessageEvent_Event, gen_statemachine_CallEvent_MessageEvent, gen_statemachine_Operation_BehavioralFeature},
    metadata=None
)
