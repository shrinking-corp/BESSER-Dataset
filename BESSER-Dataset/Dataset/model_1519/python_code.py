...
class sm1_State:
    ...
    def __init__(self, name: str, src: set["sm1_Transition"] = None, tgt: set["sm1_Transition"] = None, sm1_State: "sm1_StateMachine" = None, State9: "sm1_Transition" = None, State11: "sm1_Transition" = None, State: "sm1_StateMachine" = None, states: "sm1_StateMachine" = None):
        self.name = name
...
class sm1_Transition:
    ...
    def __init__(self, event: str, Transition7: "sm1_State" = None, outgoing: "sm1_State" = None, incoming: "sm1_State" = None, sm1_Transition: "sm1_StateMachine" = None, Transition: "sm1_State" = None):
        self.event = event
