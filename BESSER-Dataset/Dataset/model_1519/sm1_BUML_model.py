...
# Classes
sm1_Transition = Class(name="sm1_Transition")
sm1_StateMachine = Class(name="sm1_StateMachine")
sm1_State = Class(name="sm1_State")
...
domain_model = DomainModel(
    name="sm1",
    types={sm1_Transition, sm1_StateMachine, sm1_State},
    associations={states1, edges2, sm4, outgoing5, incoming6, initialState0, src8, tgt10},
    generalizations={},
    metadata=None
)
