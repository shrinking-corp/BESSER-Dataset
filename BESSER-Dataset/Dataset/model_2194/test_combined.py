...
def test_hyp_tree_nonterminal_is_not_abstract():
    assert not inspect.isabstract(tree_NonTerminal)


def test_hyp_tree_nonterminal_constructor_exists():
    assert callable(tree_NonTerminal.__init__)


def test_hyp_tree_nonterminal_constructor_args():
    sig = inspect.signature(tree_NonTerminal.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tree_leaf_is_not_abstract():
    assert not inspect.isabstract(tree_Leaf)


def test_hyp_tree_leaf_constructor_exists():
    assert callable(tree_Leaf.__init__)


def test_hyp_tree_leaf_constructor_args():
    sig = inspect.signature(tree_Leaf.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tree_treenode_is_not_abstract():
    assert not inspect.isabstract(tree_TreeNode)


def test_hyp_tree_treenode_constructor_exists():
    assert callable(tree_TreeNode.__init__)


def test_hyp_tree_treenode_constructor_args():
...
def test_hyp_tree_treenode_data_setter(instance):
