...
# Classes
tree_TreeNode = Class(name="tree_TreeNode", is_abstract=True)
tree_Leaf = Class(name="tree_Leaf")
TreeNode = Class(name="TreeNode")
tree_NonTerminal = Class(name="tree_NonTerminal")
...
domain_model = DomainModel(
    ...
    associations={children2, parent1},
