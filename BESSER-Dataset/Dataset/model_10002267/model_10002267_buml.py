...
transaction_Transaction.attributes={transaction_Transaction_type, transaction_Transaction_amount, transaction_Transaction_id, transaction_Transaction_transactionTime}
...
mypackage_Login.attributes={mypackage_Login_password, mypackage_Login_securityQuestion, mypackage_Login_lastLoginTime, mypackage_Login_username, mypackage_Login_securityAnswer}
...
mypackage_Customer.attributes={mypackage_Customer_address, mypackage_Customer_dateOfBirth, mypackage_Customer_phoneNumber, mypackage_Customer_name, mypackage_Customer_emailAddress}
...
domain_model = DomainModel(
    name="a159a214_1547_4b20_9371_34b89418fef5",
