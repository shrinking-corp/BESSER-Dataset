...
domain_model = DomainModel(
    name="statemachine",
    types={statemachine_Vertex, statemachine_Transition, statemachine_State, Vertex, State, statemachine_Region, statemachine_Statemachine, Region, statemachine_Action, statemachine_LabeledTransition, Transition, statemachine_ComplexState, statemachine_Pseudostate, PseudostateKind},
    associations={outgoings0, region2, source4, target7, transitions10, actions12, states14, initial17, action19, super1},
    generalizations={gen_statemachine_State_Vertex, gen_statemachine_ComplexState_State, gen_statemachine_Statemachine_Region, gen_statemachine_LabeledTransition_Transition, gen_statemachine_Pseudostate_Vertex},
    metadata=None
)
