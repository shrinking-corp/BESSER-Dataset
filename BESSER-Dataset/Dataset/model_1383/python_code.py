...
class statemachine_Transition:
    ...
    def __init__(self, id: str, statemachine_Transition5: "statemachine_Vertex" = None, statemachine_Transition8: "statemachine_Vertex" = None, statemachine_Transition11: "statemachine_Statemachine" = None, statemachine_Transition: "statemachine_Vertex" = None):
        self.id = id
