...
metrics_MappingRDBMS.attributes={metrics_MappingRDBMS_password, metrics_MappingRDBMS_dateTimeFormat, metrics_MappingRDBMS_user, metrics_MappingRDBMS_query, metrics_MappingRDBMS_timeFormat, metrics_MappingRDBMS_dateFormat, metrics_MappingRDBMS_databaseType}
...
domain_model = DomainModel(
    name="metrics",
    types={metrics_IdentifierDataKind, DataKind, metrics_Mapping, Base, metrics_MappingColumn, metrics_DataKind, metrics_MappingCSV, Mapping, metrics_MappingRDBMS, metrics_MappingRecord, metrics_MappingStatistic, metrics_DateTimeRange, metrics_MappingXLS, metrics_Metric, metrics_Expression, metrics_MetricSource, metrics_Unit, metrics_MetricRetentionRule, metrics_MetricRetentionRules, metrics_MetricValueRange, metrics_Value, metrics_ValueDataKind, DatabaseTypeType, KindHintType, MetricRetentionPeriod, ObjectKindType, ValueKindType},
    associations={headerMappingColumns0, dataMappingColumns1, dataType4, failedRecords6, mappingDuration7, subStatistics13, metrics16, expressionRef17, periodEstimate9, metricSourceRef19, unitRef21, retentionExpression23, metricRetentionRules25, metricMapping27, statistics30, metricValues33, metricRef34},
