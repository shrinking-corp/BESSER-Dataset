...
class metrics_MappingRDBMS(Mapping):
    ...
    def __init__(self, query: str, timeFormat: str, user: str, dateTimeFormat: str, databaseType: str, dateFormat: str, password: str):
        self.query = query
...
class metrics_Metric(Base):
    ...
    def __init__(self, measurementKind: str, measurementPoint: str, name: str, description: str, metrics_Metric: "metrics_Metric" = None, metrics_Metric15: set["metrics_Metric"] = None, metrics_Metric18: "metrics_Expression" = None, metrics_Metric20: "metrics_MetricSource" = None, metrics_Metric22: "metrics_Unit" = None, metrics_Metric35: "metrics_ValueDataKind" = None):
...
class metrics_Mapping(Base):
    ...
    def __init__(self, firstDataRow: str, intervalHint: str, headerRow: str, metrics_Mapping: set["metrics_MappingColumn"] = None, metrics_Mapping2: set["metrics_MappingColumn"] = None, metrics_Mapping29: "metrics_MetricSource" = None):
