...
Administrator.attributes={Administrator_email, Administrator_adminID, Administrator_name}
...
Book.attributes={Book_title, Book_description, Book_category, Book_author, Book_bookID, Book_price}
...
Customer.attributes={Customer_email, Customer_username, Customer_CustomerID}
...
domain_model = DomainModel(
    ...
    associations={Customer_Search_Book, Administrator_Edit_Book, Administrator_Add_Book, Administrator_Confirm_Payment, Bank_Mobile_Money_Agent_Confirm_Payment, Administrator_Book, Administrator_Book2, Category_Category, Category_Book, Administrator_Administrator, Administrator_Customer, Customer_Book, Customer_Customer, Customer_Book2, Logout_Logout, Customer_Logout, Customer_Sign_up, Customer_Log_in, Customer_Add_book__to_cart, Customer_Make_Payment},
    generalizations={},
    metadata=None
)
