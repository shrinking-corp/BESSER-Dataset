...
# Classes
Program_Specialization = Class(name="Program_Specialization")
Program_Program = Class(name="Program_Program")
Program_Semester = Class(name="Program_Semester")
Program_SemesterCourse = Class(name="Program_SemesterCourse")
Program_Course = Class(name="Program_Course")
Program_Department = Class(name="Program_Department")
...
Program_Semester.attributes={Program_Semester_code, Program_Semester_name, Program_Semester_status}
...
Program_Course.attributes={Program_Course_credit, Program_Course_name, Program_Course_code}
...
domain_model = DomainModel(
    name="Program",
    types={Program_Specialization, Program_Program, Program_Semester, Program_SemesterCourse, Program_Course, Program_Department, SemesterStatus, CourseStatus},
    associations={specializations1, semesters3, specializations7, semesters0, semesterCourses9, course10, semester11, department12, programs13, courses15},
    generalizations={},
    metadata=None
)
