...
class Program_SemesterCourse:
    ...
    def __init__(self, status: str, SemesterCourse: "Program_Semester" = None, Program_SemesterCourse: "Program_Course" = None, semesterCourses: "Program_Semester" = None):
        self.status = status
...
class Program_Semester:
    ...
    def __init__(self, name: str, code: str, status: str, Program_Semester: "Program_Program" = None, semester: set["Program_SemesterCourse"] = None, Semester: "Program_SemesterCourse" = None, Program_Semester5: "Program_Specialization" = None):
        self.name = name
        self.code = code
        self.status = status
...
class Program_Program:
    ...
    def __init__(self, name: str, year: float, Program_Program: set["Program_Semester"] = None, Program_Program14: "Program_Department" = None, Program_Program2: set["Program_Specialization"] = None):
        self.name = name
        self.year = year
