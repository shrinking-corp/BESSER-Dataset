...
class SimpleTree_Node(Text):
    ...
    def __init__(self, startIndex: int, startLineIndex: int, stopIndex: int, stopLineIndex: int, Node: "SimpleTree_Attribute" = None, parentNode: set["SimpleTree_Text"] = None, node: set["SimpleTree_Attribute"] = None, Node13: "SimpleTree_Text" = None):
