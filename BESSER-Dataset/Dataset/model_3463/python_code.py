...
class featuremodels_Instance:
    ...
    def __init__(self, id: str, descritpion: str, featuremodels_Instance21: set["featuremodels_Feature"] = None, featuremodels_Instance: "featuremodels_FeatureModel" = None):
        self.id = id
