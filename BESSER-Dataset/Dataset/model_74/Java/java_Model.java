...
public class java_Model  {
    ...
    public java_Model(
        String name        ArrayList<java_Type> java_types,        ArrayList<java_UnresolvedItem> java_unresolveditems,        ArrayList<java_CompilationUnit> java_compilationunits,        ArrayList<java_Package> java_packages,        ArrayList<java_ClassFile> java_classfiles,        ArrayList<java_Archive> java_archives    ) {
        this.name = name;
