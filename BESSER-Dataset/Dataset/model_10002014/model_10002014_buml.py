...
domain_model = DomainModel(
    ...
    associations={Machine_Memory, Processor_Memory, Vendor2Adapter_Vendor2Sound, Machine_Card, AcceleratorCard_CPU, Program_Instruction, Machine_Processor, Processor_Program, Cache_RAM, ExtensionBoard_Card, Vendor1Adapter_Vendor1Sound},
    generalizations={},
    metadata=None
)
