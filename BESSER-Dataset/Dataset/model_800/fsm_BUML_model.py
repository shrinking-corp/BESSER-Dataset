...
domain_model = DomainModel(
    name="fsmSample",
    types={fsmSample_Transition, fsmSample_FSM, fsmSample_State, fsmSample_Action},
    associations={initialState1, finalState2, currentState5, owningFSM8, outgoingTransition9, incomingTransition10, source12, ownedState0, target14, action16},
    generalizations={},
    metadata=None
)
