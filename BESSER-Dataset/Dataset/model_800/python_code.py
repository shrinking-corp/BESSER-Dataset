...
class fsmSample_Action:
    ...
    def run(self, fsmSample_sync) :
        # TODO: Implement run method
        pass

class fsmSample_State:

    def __init__(self, name: str, fsmSample_State: "fsmSample_FSM" = None, fsmSample_State4: "fsmSample_FSM" = None, fsmSample_State7: "fsmSample_FSM" = None, ownedState: "fsmSample_FSM" = None, source: set["fsmSample_Transition"] = None, target: set["fsmSample_Transition"] = None, State13: "fsmSample_Transition" = None, State: "fsmSample_FSM" = None, State15: "fsmSample_Transition" = None):
        self.name = name
...
class fsmSample_FSM:
    ...
    def __init__(self, name: str, fsmSample_FSM: "fsmSample_State" = None, fsmSample_FSM3: set["fsmSample_State"] = None, fsmSample_FSM6: "fsmSample_State" = None, FSM: "fsmSample_State" = None, owningFSM: set["fsmSample_State"] = None):
        self.name = name
