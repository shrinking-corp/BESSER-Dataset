...
Metrics_MetricValue = Class(name="Metrics_MetricValue", is_abstract=True)
Metrics_StringMetricValue = Class(name="Metrics_StringMetricValue")
Metrics_BooleanMetricValue = Class(name="Metrics_BooleanMetricValue")
Metrics_Metric = Class(name="Metrics_Metric")
Metrics_IntegerMetricValue = Class(name="Metrics_IntegerMetricValue")
Metrics_DoubleMetricValue = Class(name="Metrics_DoubleMetricValue")
...
domain_model = DomainModel(
    name="Metrics",
    types={MetricValue, Metrics_MetricValue, Metrics_StringMetricValue, Metrics_BooleanMetricValue, Metrics_Metric, Metrics_IntegerMetricValue, Metrics_DoubleMetricValue},
