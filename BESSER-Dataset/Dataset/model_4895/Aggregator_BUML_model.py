...
aggregator_Aggregation = Class(name="aggregator_Aggregation")
...
aggregator_ValidationSet = Class(name="aggregator_ValidationSet")
...
aggregator_AvailableVersionsHeader = Class(name="aggregator_AvailableVersionsHeader")
aggregator_AvailableVersion = Class(name="aggregator_AvailableVersion")
...
aggregator_IdentificationProvider = Class(name="aggregator_IdentificationProvider", is_abstract=True)
...
aggregator_MetadataRepository = Class(name="aggregator_MetadataRepository")
...
aggregator_p2view_Licenses = Class(name="aggregator_p2view_Licenses")
...
p2view_aggregator_IUpdateDescriptor = Class(name="p2view_aggregator_IUpdateDescriptor")
p2view_aggregator_ICopyright = Class(name="p2view_aggregator_ICopyright")
...
p2view_aggregator_IInstallableUnit = Class(name="p2view_aggregator_IInstallableUnit")
aggregator_p2view_Products = Class(name="aggregator_p2view_Products")
Product = Class(name="Product")
p2view_aggregator_ILicense = Class(name="p2view_aggregator_ILicense")
aggregator_p2view_RepositoryBrowser = Class(name="aggregator_p2view_RepositoryBrowser")
...
p2view_aggregator_MetadataRepository = Class(name="p2view_aggregator_MetadataRepository")
...
p2view_aggregator_IProvidedCapability = Class(name="p2view_aggregator_IProvidedCapability")
aggregator_p2view_RepositoryReferences = Class(name="aggregator_p2view_RepositoryReferences")
p2view_aggregator_IRepositoryReference = Class(name="p2view_aggregator_IRepositoryReference")
...
aggregator_p2view_Requirements = Class(name="aggregator_p2view_Requirements")
RequirementWrapper = Class(name="RequirementWrapper")
aggregator_p2view_RequirementWrapper = Class(name="aggregator_p2view_RequirementWrapper")
IRequirement = Class(name="IRequirement")
p2view_aggregator_IRequirement = Class(name="p2view_aggregator_IRequirement")
aggregator_p2view_Touchpoints = Class(name="aggregator_p2view_Touchpoints")
p2view_aggregator_ITouchpointType = Class(name="p2view_aggregator_ITouchpointType")
p2view_aggregator_ITouchpointData = Class(name="p2view_aggregator_ITouchpointData")
...
aggregator_Aggregation_m_getAllMetadataRepositoryReferences: Method = Method(name="getAllMetadataRepositoryReferences", parameters={Parameter(name='aggregator_enabledOnly', type=StringType)}, type=StringType)
aggregator_Aggregation_m_getValidationSets: Method = Method(name="getValidationSets", parameters={Parameter(name='aggregator_enabledOnly', type=StringType)}, type=StringType)
aggregator_Aggregation_m_getAllContributions: Method = Method(name="getAllContributions", parameters={Parameter(name='aggregator_enabledOnly', type=StringType)}, type=StringType)
aggregator_Aggregation.attributes={aggregator_Aggregation_allowLegacySites, aggregator_Aggregation_mavenResult, aggregator_Aggregation_sendmail, aggregator_Aggregation_type, aggregator_Aggregation_versionFormat, aggregator_Aggregation_strictMavenVersions, aggregator_Aggregation_packedStrategy, aggregator_Aggregation_label, aggregator_Aggregation_buildRoot}
aggregator_Aggregation.methods={aggregator_Aggregation_m_getAllMetadataRepositoryReferences, aggregator_Aggregation_m_getAllContributions, aggregator_Aggregation_m_getValidationSets}
...
aggregator_ValidationSet_m_isExtensionOf: Method = Method(name="isExtensionOf", parameters={Parameter(name='aggregator_validationSet', type=StringType)}, type=BooleanType)
aggregator_ValidationSet.attributes={aggregator_ValidationSet_extension, aggregator_ValidationSet_label, aggregator_ValidationSet_abstract}
aggregator_ValidationSet.methods={aggregator_ValidationSet_m_getDeclaredContributions, aggregator_ValidationSet_m_getAllValidationRepositories, aggregator_ValidationSet_m_getAllContributions, aggregator_ValidationSet_m_isExtensionOf, aggregator_ValidationSet_m_getDeclaredValidationRepositories}
...
aggregator_MavenMapping_m_map: Method = Method(name="map", parameters={Parameter(name='aggregator_version', type=StringType), Parameter(name='aggregator_installableUnitID', type=StringType)}, type=StringType)
aggregator_MavenMapping_m_mapVersion: Method = Method(name="mapVersion", parameters={Parameter(name='aggregator_version', type=StringType)}, type=StringType)
aggregator_MavenMapping.attributes={aggregator_MavenMapping_versionPattern, aggregator_MavenMapping_namePattern, aggregator_MavenMapping_artifactId, aggregator_MavenMapping_groupId, aggregator_MavenMapping_versionTemplate}
aggregator_MavenMapping.methods={aggregator_MavenMapping_m_map, aggregator_MavenMapping_m_mapVersion}
...
aggregator_AvailableVersion.attributes={aggregator_AvailableVersion_versionMatch, aggregator_AvailableVersion_version, aggregator_AvailableVersion_availableFrom, aggregator_AvailableVersion_filter}
...
aggregator_InstallableUnitRequest_m_resolveAsSingleton: Method = Method(name="resolveAsSingleton", parameters={Parameter(name='aggregator_forceResolve', type=StringType)}, type=StringType)
aggregator_InstallableUnitRequest_m_resolveAvailableVersions: Method = Method(name="resolveAvailableVersions", parameters={Parameter(name='aggregator_updateOnly', type=StringType)})
...
aggregator_InstallableUnitRequest.methods={aggregator_InstallableUnitRequest_m_resolveAsSingleton, aggregator_InstallableUnitRequest_m_isBranchEnabled, aggregator_InstallableUnitRequest_m_resolveAsSingleton, aggregator_InstallableUnitRequest_m_resolveAvailableVersions, aggregator_InstallableUnitRequest_m_isMappedRepositoryBroken}
...
aggregator_EnabledStatusProvider.attributes={aggregator_EnabledStatusProvider_enabled, aggregator_EnabledStatusProvider_branchEnabled}
...
aggregator_MappedRepository_m_getMapRules: Method = Method(name="getMapRules", parameters={Parameter(name='aggregator_enabledOnly', type=StringType)}, type=MapRule)
aggregator_MappedRepository_m_getUnits: Method = Method(name="getUnits", parameters={Parameter(name='aggregator_enabledOnly', type=StringType)}, type=MappedUnit)
...
aggregator_MappedRepository.methods={aggregator_MappedRepository_m_getMapRules, aggregator_MappedRepository_m_getUnits, aggregator_MappedRepository_m_isMapExclusive}
...
aggregator_MetadataRepositoryReference.methods={aggregator_MetadataRepositoryReference_m_startRepositoryLoad, aggregator_MetadataRepositoryReference_m_getResolvedLocation, aggregator_MetadataRepositoryReference_m_getAggregation, aggregator_MetadataRepositoryReference_m_onRepositoryLoad, aggregator_MetadataRepositoryReference_m_isBranchEnabled, aggregator_MetadataRepositoryReference_m_cancelRepositoryLoad}
...
aggregator_MavenItem.attributes={aggregator_MavenItem_classifier, aggregator_MavenItem_mappedVersion, aggregator_MavenItem_artifactId, aggregator_MavenItem_groupId}
...
aggregator_p2view_Category.methods={aggregator_p2view_Category_m_getNotNullBundleContainer, aggregator_p2view_Category_m_getNotNullCategoryContainer, aggregator_p2view_Category_m_getNotNullProductContainer, aggregator_p2view_Category_m_getNotNullFeatureContainer, aggregator_p2view_Category_m_isNested, aggregator_p2view_Category_m_getNotNullFragmentContainer}
...
aggregator_p2view_InstallableUnits.methods={aggregator_p2view_InstallableUnits_m_getNotNullFragmentContainer, aggregator_p2view_InstallableUnits_m_getNotNullCategoryContainer, aggregator_p2view_InstallableUnits_m_getNotNullFeatureContainer, aggregator_p2view_InstallableUnits_m_getNotNullMiscellaneousContainer, aggregator_p2view_InstallableUnits_m_getNotNullBundleContainer, aggregator_p2view_InstallableUnits_m_getNotNullProductContainer}
...
aggregator_p2view_IUPresentation.attributes={aggregator_p2view_IUPresentation_description, aggregator_p2view_IUPresentation_filter, aggregator_p2view_IUPresentation_label, aggregator_p2view_IUPresentation_id, aggregator_p2view_IUPresentation_version, aggregator_p2view_IUPresentation_name, aggregator_p2view_IUPresentation_type}
...
aggregator_p2view_MetadataRepositoryStructuredView.attributes={aggregator_p2view_MetadataRepositoryStructuredView_location, aggregator_p2view_MetadataRepositoryStructuredView_loaded, aggregator_p2view_MetadataRepositoryStructuredView_name}
...
domain_model = DomainModel(
    name="aggregator",
    types={aggregator_Configuration, aggregator_CustomCategory, aggregator_Aggregation, DescriptionProvider, StatusProvider, InfosProvider, aggregator_ValidationSet, aggregator_ChildrenProvider, aggregator_Contact, aggregator_MavenMapping, aggregator_AvailableVersionsHeader, aggregator_AvailableVersion, aggregator_InstallableUnitRequest, aggregator_Bundle, MappedUnit, aggregator_Category, aggregator_DescriptionProvider, aggregator_EnabledStatusProvider, EnabledStatusProvider, aggregator_Contribution, IdentificationProvider, aggregator_MappedRepository, aggregator_Feature, aggregator_Product, aggregator_ExclusionRule, MapRule, aggregator_IdentificationProvider, aggregator_InfosProvider, aggregator_LabelProvider, MetadataRepositoryReference, aggregator_MetadataRepositoryReference, aggregator_MapRule, aggregator_MappedUnit, InstallableUnitRequest, aggregator_MavenItem, aggregator_MetadataRepository, aggregator_Property, aggregator_Status, aggregator_StatusProvider, aggregator_ValidConfigurationsRule, Products, Bundles, aggregator_p2view_Bundle, IUPresentationWithDetails, aggregator_p2view_Bundles, Bundle, aggregator_p2view_Category, IUPresentation, Categories, Features, Fragments, IUDetails, aggregator_p2view_Categories, Category, aggregator_p2view_Feature, aggregator_p2view_Features, Feature, aggregator_p2view_Fragment, aggregator_p2view_Fragments, Fragment, aggregator_p2view_InstallableUnits, aggregator_p2view_IUPresentationWithDetails, p2view_IUPresentation, p2view_IUDetails, aggregator_p2view_Licenses, Miscellaneous, aggregator_p2view_IUDetails, Requirements, ProvidedCapabilities, Properties, Touchpoints, p2view_aggregator_IUpdateDescriptor, p2view_aggregator_ICopyright, Licenses, aggregator_p2view_IUPresentation, p2view_aggregator_IInstallableUnit, aggregator_p2view_Products, Product, p2view_aggregator_ILicense, aggregator_p2view_RepositoryBrowser, MetadataRepositoryStructuredView, aggregator_p2view_MetadataRepositoryStructuredView, InstallableUnits, p2view_aggregator_MetadataRepository, RepositoryReferences, aggregator_p2view_Miscellaneous, OtherIU, aggregator_p2view_OtherIU, aggregator_p2view_Product, LabelProvider, p2view_aggregator_IProvidedCapability, aggregator_p2view_RepositoryReferences, p2view_aggregator_IRepositoryReference, aggregator_p2view_Properties, p2view_aggregator_Property, aggregator_p2view_ProvidedCapabilities, ProvidedCapabilityWrapper, aggregator_p2view_ProvidedCapabilityWrapper, IProvidedCapability, aggregator_p2view_Requirements, RequirementWrapper, aggregator_p2view_RequirementWrapper, IRequirement, p2view_aggregator_IRequirement, aggregator_p2view_Touchpoints, p2view_aggregator_ITouchpointType, p2view_aggregator_ITouchpointData, PackedStrategy, AggregationType, Architecture, AvailableFrom, InstallableUnitType, OperatingSystem, StatusCode, VersionMatch, WindowSystem, VersionFormat},
    associations={configurations1, customCategories3, validationSets0, contacts5, buildmaster6, buildmasterBackup8, mavenMappings11, availableVersions13, installableUnitRequest14, aggregation15, repositories16, contacts17, mavenMappings20, categories23, features24, products28, bundles30, availableVersionsHeader25, availableVersions26, features32, categories34, mapRules36, validConfigurations38, mavenMapping40, contributions44, validationRepositories47, metadataRepository42, status43, extends51, validConfigurations53, productContainer59, bundleContainer61, bundles55, categoryContainer56, featureContainer57, categoryContainer80, featureContainer83, fragmentContainer63, iuDetails65, categories67, featureContainer68, bundleContainer70, fragmentContainer73, features76, fragments78, allIUs79, productContainer86, bundleContainer89, fragmentContainer92, miscellaneousContainer95, requirementsContainer97, providedCapabilitiesContainer98, propertiesContainer100, touchpointsContainer102, updateDescriptor104, copyright106, licensesContainer108, installableUnit110, fragmentContainer127, products130, licenses111, repositories112, installableUnitList113, properties114, metadataRepository117, repositoryReferences119, others121, featureContainer122, bundleContainer124, genuine133, propertyList131, providedCapabilities132, repositoryReferences134, requirements135, genuine136, touchpointType137, touchpointDataList138},
    generalizations={gen_aggregator_Aggregation_DescriptionProvider, gen_aggregator_Aggregation_StatusProvider, gen_aggregator_Aggregation_InfosProvider, gen_aggregator_Bundle_MappedUnit, gen_aggregator_Category_MappedUnit, gen_aggregator_Configuration_EnabledStatusProvider, gen_aggregator_Contribution_EnabledStatusProvider, gen_aggregator_Contribution_DescriptionProvider, gen_aggregator_Contribution_StatusProvider, gen_aggregator_Contribution_InfosProvider, gen_aggregator_Contribution_IdentificationProvider, gen_aggregator_Feature_MappedUnit, gen_aggregator_CustomCategory_StatusProvider, gen_aggregator_CustomCategory_InfosProvider, gen_aggregator_ExclusionRule_MapRule, gen_aggregator_InstallableUnitRequest_StatusProvider, gen_aggregator_InstallableUnitRequest_InfosProvider, gen_aggregator_InstallableUnitRequest_DescriptionProvider, gen_aggregator_MappedRepository_MetadataRepositoryReference, gen_aggregator_MappedRepository_DescriptionProvider, gen_aggregator_MappedRepository_IdentificationProvider, gen_aggregator_MetadataRepositoryReference_EnabledStatusProvider, gen_aggregator_MetadataRepositoryReference_StatusProvider, gen_aggregator_MetadataRepositoryReference_InfosProvider, gen_aggregator_MappedUnit_InstallableUnitRequest, gen_aggregator_MappedUnit_EnabledStatusProvider, gen_aggregator_MappedUnit_IdentificationProvider, gen_aggregator_MapRule_InstallableUnitRequest, gen_aggregator_MapRule_DescriptionProvider, gen_aggregator_MapRule_EnabledStatusProvider, gen_aggregator_MavenMapping_StatusProvider, gen_aggregator_MavenMapping_InfosProvider, gen_aggregator_Product_MappedUnit, gen_aggregator_ValidationSet_EnabledStatusProvider, gen_aggregator_ValidationSet_DescriptionProvider, gen_aggregator_ValidationSet_StatusProvider, gen_aggregator_ValidationSet_InfosProvider, gen_aggregator_ValidationSet_IdentificationProvider, gen_aggregator_ValidConfigurationsRule_MapRule, gen_aggregator_p2view_Bundle_IUPresentationWithDetails, gen_aggregator_p2view_Category_IUPresentation, gen_aggregator_p2view_Feature_IUPresentationWithDetails, gen_aggregator_p2view_Fragment_Bundle, gen_aggregator_p2view_IUPresentationWithDetails_p2view_IUPresentation, gen_aggregator_p2view_IUPresentationWithDetails_p2view_IUDetails, gen_aggregator_p2view_OtherIU_IUPresentationWithDetails, gen_aggregator_p2view_Product_IUPresentationWithDetails, gen_aggregator_p2view_ProvidedCapabilityWrapper_LabelProvider, gen_aggregator_p2view_ProvidedCapabilityWrapper_IProvidedCapability, gen_aggregator_p2view_RequirementWrapper_IRequirement, gen_aggregator_p2view_RequirementWrapper_LabelProvider},
    metadata=None
)
