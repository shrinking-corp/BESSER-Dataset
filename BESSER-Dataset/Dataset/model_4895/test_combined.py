...
def test_hyp_versionformat_exists():
    # Check that the Enumeration exists
    assert VersionFormat is not None

def test_hyp_versionformat_has_all_literals():
    # Collect the names of literals in this Enumeration
...
@given(instance=aggregator_MavenItem_strategy)
def test_hyp_aggregator_mavenitem_mappedVersion_setter(instance):
...
@given(instance=aggregator_MavenItem_strategy)
def test_hyp_aggregator_mavenitem_classifier_setter(instance):
...
@given(instance=aggregator_MavenItem_strategy)
@settings(max_examples=30)
def test_hyp_aggregator_mavenitem_issources_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
        instance.isSources()
...
@given(instance=aggregator_MavenMapping_strategy)
def test_hyp_aggregator_mavenmapping_versionPattern_setter(instance):
...
@given(instance=aggregator_MavenMapping_strategy)
def test_hyp_aggregator_mavenmapping_versionTemplate_setter(instance):
...
@given(instance=aggregator_MavenMapping_strategy)
@settings(max_examples=30)
def test_hyp_aggregator_mavenmapping_mapversion_changes_state(instance):
    before = copy.deepcopy(instance)
    try:
        # Call operation with dummy parameters
        instance.mapVersion(
...
@given(instance=aggregator_Aggregation_strategy)
def test_hyp_aggregator_aggregation_versionFormat_setter(instance):
...
@given(instance=aggregator_Aggregation_strategy)
def test_hyp_aggregator_aggregation_strictMavenVersions_setter(instance):
...
@given(instance=aggregator_Aggregation_strategy)
def test_hyp_aggregator_aggregation_allowLegacySites_setter(instance):
