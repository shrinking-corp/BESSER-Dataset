...
domain_model = DomainModel(
    name="FSM",
    types={FSM_CompositeState, FSM_InitialState, AbstractState, FSM_StateMachine, FSM_Transition, FSM_AbstractState, FSM_RegularState},
    associations={source4, target5, stateMachine8, compositeState10, transitions0, states1, stateMachine3, states12},
