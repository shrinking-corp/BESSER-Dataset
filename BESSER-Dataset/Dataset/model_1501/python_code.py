...
class petriNet_Arc(PetriNetElt):
    ...
    def __init__(self, poids: int, typeArc: str, noeudsSuccesseurs: "petriNet_Noeud" = None, noeudsPredecesseurs: "petriNet_Noeud" = None, Arc: "petriNet_Noeud" = None, Arc2: "petriNet_Noeud" = None):
        self.poids = poids
...
class petriNet_Noeud(PetriNetElt):
    ...
    def __init__(self, name: str, Noeud: "petriNet_Arc" = None, Noeud5: "petriNet_Arc" = None, predecesseur: set["petriNet_Arc"] = None, successeur: set["petriNet_Arc"] = None):
        self.name = name
        self.Noeud = Noeud
        self.Noeud5 = Noeud5
