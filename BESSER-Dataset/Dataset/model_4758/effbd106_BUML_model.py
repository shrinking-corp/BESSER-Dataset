...
# Classes
effbd106_Sequence = Class(name="effbd106_Sequence", is_abstract=True)
effbd106_Flow = Class(name="effbd106_Flow")
effbd106_OutputPort = Class(name="effbd106_OutputPort")
effbd106_Function = Class(name="effbd106_Function")
SequenceNode = Class(name="SequenceNode")
ProcessNode = Class(name="ProcessNode")
effbd106_And = Class(name="effbd106_And")
Sequence = Class(name="Sequence")
effbd106_Or = Class(name="effbd106_Or")
effbd106_Start = Class(name="effbd106_Start")
effbd106_Final = Class(name="effbd106_Final")
effbd106_Loop = Class(name="effbd106_Loop")
Port = Class(name="Port")
effbd106_Port = Class(name="effbd106_Port", is_abstract=True)
effbd106_Item = Class(name="effbd106_Item")
effbd106_InputPort = Class(name="effbd106_InputPort")
effbd106_Description = Class(name="effbd106_Description")
effbd106_Token = Class(name="effbd106_Token")
effbd106_SequenceNode = Class(name="effbd106_SequenceNode", is_abstract=True)
effbd106_LoopExit = Class(name="effbd106_LoopExit")
effbd106_Iteration = Class(name="effbd106_Iteration")
effbd106_ProcessNode = Class(name="effbd106_ProcessNode", is_abstract=True)
...
effbd106_SequenceNode.attributes={effbd106_SequenceNode_name, effbd106_SequenceNode_tMax, effbd106_SequenceNode_tMin}
...
domain_model = DomainModel(
    name="effbd106",
    types={effbd106_Sequence, effbd106_Flow, effbd106_OutputPort, effbd106_Function, SequenceNode, ProcessNode, effbd106_And, Sequence, effbd106_Or, effbd106_Start, effbd106_Final, effbd106_Loop, Port, effbd106_Port, effbd106_Item, effbd106_InputPort, effbd106_Description, effbd106_Token, effbd106_SequenceNode, effbd106_LoopExit, effbd106_Iteration, effbd106_ProcessNode, FunctionDomain},
    associations={decompositions1, sequenceNodes2, flows4, outputPorts6, inputPorts8, descriptions10, tokens12, controlFlowEdge15, outputflowEdge21, inputflowEdge16, items19},
    generalizations={gen_effbd106_Function_SequenceNode, gen_effbd106_Function_ProcessNode, gen_effbd106_Sequence_SequenceNode, gen_effbd106_And_Sequence, gen_effbd106_Or_Sequence, gen_effbd106_Start_Sequence, gen_effbd106_Final_Sequence, gen_effbd106_Loop_Sequence, gen_effbd106_InputPort_Port, gen_effbd106_Flow_ProcessNode, gen_effbd106_LoopExit_Sequence, gen_effbd106_Iteration_Sequence, gen_effbd106_OutputPort_Port},
    metadata=None
)
