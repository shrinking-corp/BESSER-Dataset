...
class contentfwk_Element:
    ...
    def __init__(self, name: str, description: str, sourceDescr: str, ownerDescr: str, ID: str, Element: "contentfwk_Element" = None, isDelegatedBy: set["contentfwk_Element"] = None, Element232: "contentfwk_Element" = None, delegates: set["contentfwk_Element"] = None, ownedElements: set["contentfwk_Label"] = None, Element243: "contentfwk_Label" = None):
        self.name = name
...
class contentfwk_Actor(Element):
    ...
    def __init__(self, FTEs: str, actorGoal: str, actorTasks: str, contentfwk_Actor: "contentfwk_BusinessArchitecture" = None, Actor: "contentfwk_OrganizationUnit" = None, containsActors: "contentfwk_OrganizationUnit" = None, supportsActors: set["contentfwk_Function"] = None, isAssumedByActors: set["contentfwk_Role"] = None, involvesActors: set["contentfwk_Process"] = None, contentfwk_Actor81: set["contentfwk_Service"] = None, isResolvedByActors: set["contentfwk_Event"] = None, isGeneratedByActors: set["contentfwk_Event"] = None, Actor128: "contentfwk_Function" = None, Actor140: "contentfwk_Function" = None, containsActors86: "contentfwk_Location" = None, isPerformedByActors: set["contentfwk_Function"] = None, contentfwk_Actor92: "contentfwk_Actor" = None, contentfwk_Actor90: set["contentfwk_Actor"] = None, Actor94: "contentfwk_Role" = None, isSuppliedByActors: set["contentfwk_DataEntity"] = None, isConsumedByActors: set["contentfwk_DataEntity"] = None, Actor101: "contentfwk_DataEntity" = None, Actor103: "contentfwk_DataEntity" = None, Actor164: "contentfwk_Process" = None, Actor222: "contentfwk_Event" = None, Actor225: "contentfwk_Event" = None, Actor246: "contentfwk_Location" = None, contentfwk_Actor313: "contentfwk_Service" = None):
        self.FTEs = FTEs
...
class contentfwk_Label:
    ...
    def __init__(self, name: str, id: str, description: str, contentfwk_Label: "contentfwk_EnterpriseArchitecture" = None, Label: "contentfwk_Element" = None, Label238: "contentfwk_Container" = None, contentfwk_Label241: "contentfwk_Label" = None, contentfwk_Label239: set["contentfwk_Label"] = None, category: set["contentfwk_Element"] = None, labels: set["contentfwk_Container"] = None):
        self.name = name
        self.id = id
        self.description = description
...
class contentfwk_Container:
    ...
    def __init__(self, id: str, description: str, name: str, contentfwk_Container: "contentfwk_EnterpriseArchitecture" = None, contentfwk_Container236: "contentfwk_Container" = None, contentfwk_Container234: set["contentfwk_Container"] = None, containers: set["contentfwk_Label"] = None, Container: "contentfwk_Label" = None):
        self.id = id
        self.description = description
        self.name = name
