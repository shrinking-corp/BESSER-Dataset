...
public class contentfwk_LogicalTechnologyComponent extends TechnologyComponent, Element {
    ...
    public contentfwk_LogicalTechnologyComponent(
        String categoryTRM        ArrayList<contentfwk_PlatformService> contentfwk_platformservices,        ArrayList<contentfwk_PhysicalTechnologyComponent> contentfwk_physicaltechnologycomponents    ) {
        this.categoryTRM = categoryTRM;
