...
# Classes
library_OclExpression = Class(name="library_OclExpression")
...
library_OclExpression.attributes={library_OclExpression_query, library_OclExpression_name, library_OclExpression_description, library_OclExpression_context}
