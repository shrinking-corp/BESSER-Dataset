...
def test_hyp_library_oclexpression_is_not_abstract():
    assert not inspect.isabstract(library_OclExpression)


def test_hyp_library_oclexpression_constructor_exists():
    assert callable(library_OclExpression.__init__)


def test_hyp_library_oclexpression_constructor_args():
...
def test_hyp_library_ocllibrary_name_setter(instance):
...
def test_hyp_library_oclexpression_query_setter(instance):
...
@given(instance=library_OclExpression_strategy)
def test_hyp_library_oclexpression_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=library_OclExpression_strategy)
def test_hyp_library_oclexpression_context_setter(instance):
...
@given(instance=library_OclExpression_strategy)
def test_hyp_library_oclexpression_description_setter(instance):
