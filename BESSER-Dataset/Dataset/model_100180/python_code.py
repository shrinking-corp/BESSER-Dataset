...
class SimpleRDBMS_Column(RModelElement):
    ...
    def __init__(self, type: str, Column: "SimpleRDBMS_Table" = None, column: "SimpleRDBMS_Table" = None, column8: set["SimpleRDBMS_Key"] = None, column11: set["SimpleRDBMS_ForeignKey"] = None, Column19: "SimpleRDBMS_ForeignKey" = None, Column14: "SimpleRDBMS_Key" = None):
        self.type = type
        self.Column = Column
        self.column = column
