...
# Classes
ocl_uml_AnyType = Class(name="ocl_uml_AnyType")
ocl_uml_ElementType = Class(name="ocl_uml_ElementType")
Classifier = Class(name="Classifier")
types_ElementType = Class(name="types_ElementType")
ocl_uml_TypeType = Class(name="ocl_uml_TypeType")
ocl_uml_MessageType = Class(name="ocl_uml_MessageType")
uml_ocl_Property = Class(name="uml_ocl_Property")
ocl_uml_PrimitiveType = Class(name="ocl_uml_PrimitiveType")
ocl_uml_CollectionType = Class(name="ocl_uml_CollectionType")
ocl_uml_TupleType = Class(name="ocl_uml_TupleType")
ocl_uml_BagType = Class(name="ocl_uml_BagType")
ocl_uml_SetType = Class(name="ocl_uml_SetType")
ocl_uml_OrderedSetType = Class(name="ocl_uml_OrderedSetType")
uml_ocl_Operation = Class(name="uml_ocl_Operation")
ocl_uml_VoidType = Class(name="ocl_uml_VoidType")
ocl_uml_InvalidType = Class(name="ocl_uml_InvalidType")
ocl_uml_FeatureCallExp = Class(name="ocl_uml_FeatureCallExp", is_abstract=True)
ocl_uml_CallExp = Class(name="ocl_uml_CallExp", is_abstract=True)
ocl_uml_OCLExpression = Class(name="ocl_uml_OCLExpression", is_abstract=True)
ocl_uml_BooleanLiteralExp = Class(name="ocl_uml_BooleanLiteralExp")
ocl_uml_PrimitiveLiteralExp = Class(name="ocl_uml_PrimitiveLiteralExp", is_abstract=True)
ocl_uml_LiteralExp = Class(name="ocl_uml_LiteralExp", is_abstract=True)
ocl_uml_CollectionItem = Class(name="ocl_uml_CollectionItem")
ocl_uml_CollectionLiteralPart = Class(name="ocl_uml_CollectionLiteralPart", is_abstract=True)
ocl_uml_CollectionLiteralExp = Class(name="ocl_uml_CollectionLiteralExp")
ocl_uml_CollectionRange = Class(name="ocl_uml_CollectionRange")
ocl_uml_EnumLiteralExp = Class(name="ocl_uml_EnumLiteralExp")
ocl_uml_IfExp = Class(name="ocl_uml_IfExp")
ocl_uml_IntegerLiteralExp = Class(name="ocl_uml_IntegerLiteralExp")
ocl_uml_SequenceType = Class(name="ocl_uml_SequenceType")
ocl_uml_ExpressionInOCL = Class(name="ocl_uml_ExpressionInOCL")
ocl_uml_AssociationClassCallExp = Class(name="ocl_uml_AssociationClassCallExp")
ocl_uml_NavigationCallExp = Class(name="ocl_uml_NavigationCallExp", is_abstract=True)
ocl_uml_InvalidLiteralExp = Class(name="ocl_uml_InvalidLiteralExp")
ocl_uml_IterateExp = Class(name="ocl_uml_IterateExp")
ocl_uml_LoopExp = Class(name="ocl_uml_LoopExp", is_abstract=True)
ocl_uml_IteratorExp = Class(name="ocl_uml_IteratorExp")
ocl_uml_LetExp = Class(name="ocl_uml_LetExp")
ocl_uml_MessageExp = Class(name="ocl_uml_MessageExp")
ocl_uml_NullLiteralExp = Class(name="ocl_uml_NullLiteralExp")
ocl_uml_OperationCallExp = Class(name="ocl_uml_OperationCallExp")
ocl_uml_PropertyCallExp = Class(name="ocl_uml_PropertyCallExp")
ocl_uml_RealLiteralExp = Class(name="ocl_uml_RealLiteralExp")
ocl_uml_StateExp = Class(name="ocl_uml_StateExp")
ocl_uml_StringLiteralExp = Class(name="ocl_uml_StringLiteralExp")
ocl_uml_TupleLiteralExp = Class(name="ocl_uml_TupleLiteralExp")
ocl_uml_NumericLiteralExp = Class(name="ocl_uml_NumericLiteralExp", is_abstract=True)
ocl_uml_UnlimitedNaturalLiteralExp = Class(name="ocl_uml_UnlimitedNaturalLiteralExp")
ocl_uml_TupleLiteralPart = Class(name="ocl_uml_TupleLiteralPart")
ocl_uml_TypeExp = Class(name="ocl_uml_TypeExp")
ocl_uml_UnspecifiedValueExp = Class(name="ocl_uml_UnspecifiedValueExp")
ocl_uml_Variable = Class(name="ocl_uml_Variable")
ocl_uml_VariableExp = Class(name="ocl_uml_VariableExp")
ocl_uml_TemplateParameterType = Class(name="ocl_uml_TemplateParameterType")
...
domain_model = DomainModel(
    name="ocl",
    types={ocl_uml_AnyType, ocl_uml_ElementType, Classifier, types_ElementType, ocl_uml_TypeType, ocl_uml_MessageType, uml_ocl_Property, ocl_uml_PrimitiveType, ocl_uml_CollectionType, ocl_uml_TupleType, ocl_uml_BagType, ocl_uml_SetType, ocl_uml_OrderedSetType, uml_ocl_Operation, ocl_uml_VoidType, ocl_uml_InvalidType, ocl_uml_FeatureCallExp, ocl_uml_CallExp, ocl_uml_OCLExpression, ocl_uml_BooleanLiteralExp, ocl_uml_PrimitiveLiteralExp, ocl_uml_LiteralExp, ocl_uml_CollectionItem, ocl_uml_CollectionLiteralPart, ocl_uml_CollectionLiteralExp, ocl_uml_CollectionRange, ocl_uml_EnumLiteralExp, ocl_uml_IfExp, ocl_uml_IntegerLiteralExp, ocl_uml_SequenceType, ocl_uml_ExpressionInOCL, ocl_uml_AssociationClassCallExp, ocl_uml_NavigationCallExp, ocl_uml_InvalidLiteralExp, ocl_uml_IterateExp, ocl_uml_LoopExp, ocl_uml_IteratorExp, ocl_uml_LetExp, ocl_uml_MessageExp, ocl_uml_NullLiteralExp, ocl_uml_OperationCallExp, ocl_uml_PropertyCallExp, ocl_uml_RealLiteralExp, ocl_uml_StateExp, ocl_uml_StringLiteralExp, ocl_uml_TupleLiteralExp, ocl_uml_NumericLiteralExp, ocl_uml_UnlimitedNaturalLiteralExp, ocl_uml_TupleLiteralPart, ocl_uml_TypeExp, ocl_uml_UnspecifiedValueExp, ocl_uml_Variable, ocl_uml_VariableExp, ocl_uml_TemplateParameterType},
    associations={ownedOperation3, ownedOperation5, ownedOperation7, ownedAttribute9, ownedOperation0, ownedOperation1, ownedOperation11},
