...
# Classes
ocldriven_Library = Class(name="ocldriven_Library")
ocldriven_Media = Class(name="ocldriven_Media")
ocldriven_Member = Class(name="ocldriven_Member")
ocldriven_Loans = Class(name="ocldriven_Loans")
ocldriven_Dependancy = Class(name="ocldriven_Dependancy")
...
ocldriven_Media.attributes={ocldriven_Media_copies, ocldriven_Media_name}
...
domain_model = DomainModel(
    ...
    associations={library11, medias0, members1, loans3, dependancies4, library6, member7, media9, before13, after16},
    generalizations={},
    metadata=None
)
