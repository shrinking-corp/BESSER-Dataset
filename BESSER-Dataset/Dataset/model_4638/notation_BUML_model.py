...
notation_TextualElement = Class(name="notation_TextualElement")
...
notation_EAttribute = Class(name="notation_EAttribute")
notation_IdElement = Class(name="notation_IdElement", is_abstract=True)
notation_NotationElement = Class(name="notation_NotationElement", is_abstract=True)
notation_Definition = Class(name="notation_Definition")
notation_AttributeValue = Class(name="notation_AttributeValue")
Value = Class(name="Value")
notation_ReferenceValue = Class(name="notation_ReferenceValue")
notation_EReference = Class(name="notation_EReference")
...
notation_GraphicalElement.attributes={notation_GraphicalElement_fill, notation_GraphicalElement_height, notation_GraphicalElement_y, notation_GraphicalElement_x, notation_GraphicalElement_stroke, notation_GraphicalElement_width}
...
domain_model = DomainModel(
    name="notation",
    types={IdElement, notation_GraphicalElement, NotationElement, notation_Figure, GraphicalElement, notation_Rectangle, Figure, notation_Line, notation_Label, notation_TextualElement, notation_Token, TextualElement, notation_Keyword, notation_Value, notation_EAttribute, notation_IdElement, notation_NotationElement, notation_Definition, notation_AttributeValue, Value, notation_ReferenceValue, notation_EReference, notation_SyntaxOf, notation_Composite, Color},
    associations={text0, attribute1, subElements7, elements9, reference2, reference3, separator5},
    generalizations={gen_notation_NotationElement_IdElement, gen_notation_GraphicalElement_NotationElement, gen_notation_Figure_GraphicalElement, gen_notation_Rectangle_Figure, gen_notation_Line_GraphicalElement, gen_notation_Label_GraphicalElement, gen_notation_TextualElement_NotationElement, gen_notation_Token_TextualElement, gen_notation_Keyword_TextualElement, gen_notation_Value_TextualElement, gen_notation_AttributeValue_Value, gen_notation_ReferenceValue_Value, gen_notation_SyntaxOf_NotationElement, gen_notation_Composite_NotationElement},
    metadata=None
)
