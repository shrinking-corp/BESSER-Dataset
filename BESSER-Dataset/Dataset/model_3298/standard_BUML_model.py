...
# Classes
standard_DeterministicSEIRDiseaseModel = Class(name="standard_DeterministicSEIRDiseaseModel")
SEIR = Class(name="SEIR")
standard_DeterministicSIDiseaseModel = Class(name="standard_DeterministicSIDiseaseModel")
SI = Class(name="SI")
standard_DeterministicSIRDiseaseModel = Class(name="standard_DeterministicSIRDiseaseModel")
SIR = Class(name="SIR")
standard_DiseaseModel = Class(name="standard_DiseaseModel", is_abstract=True)
NodeDecorator = Class(name="NodeDecorator")
SanityChecker = Class(name="SanityChecker")
Modifiable = Class(name="Modifiable")
standard_DiseaseModelLabel = Class(name="standard_DiseaseModelLabel", is_abstract=True)
DynamicNodeLabel = Class(name="DynamicNodeLabel")
standard_PopulationLabel = Class(name="standard_PopulationLabel")
standard_DiseaseModelState = Class(name="standard_DiseaseModelState", is_abstract=True)
standard_DiseaseModelLabelValue = Class(name="standard_DiseaseModelLabelValue", is_abstract=True)
LabelValue = Class(name="LabelValue")
IntegrationLabelValue = Class(name="IntegrationLabelValue")
standard_Infector = Class(name="standard_Infector", is_abstract=True)
standard_StandardDiseaseModel = Class(name="standard_StandardDiseaseModel", is_abstract=True)
standard_SEIR = Class(name="standard_SEIR", is_abstract=True)
standard_SEIRLabel = Class(name="standard_SEIRLabel")
StandardDiseaseModelLabel = Class(name="StandardDiseaseModelLabel")
standard_SEIRLabelValue = Class(name="standard_SEIRLabelValue")
standard_PopulationModelLabel = Class(name="standard_PopulationModelLabel")
SIRLabelValue = Class(name="SIRLabelValue")
standard_SI = Class(name="standard_SI", is_abstract=True)
StandardDiseaseModel = Class(name="StandardDiseaseModel")
standard_SIDiseaseModelState = Class(name="standard_SIDiseaseModelState")
StandardDiseaseModelState = Class(name="StandardDiseaseModelState")
standard_SIInfector = Class(name="standard_SIInfector")
StandardInfector = Class(name="StandardInfector")
standard_SILabel = Class(name="standard_SILabel")
standard_SILabelValue = Class(name="standard_SILabelValue")
standard_SIR = Class(name="standard_SIR", is_abstract=True)
standard_SIRLabel = Class(name="standard_SIRLabel")
standard_SIRLabelValue = Class(name="standard_SIRLabelValue")
...
standard_StandardDiseaseModelLabel = Class(name="standard_StandardDiseaseModelLabel", is_abstract=True)
DiseaseModelLabel = Class(name="DiseaseModelLabel")
IntegrationLabel = Class(name="IntegrationLabel")
standard_StandardDiseaseModelLabelValue = Class(name="standard_StandardDiseaseModelLabelValue", is_abstract=True)
DiseaseModelLabelValue = Class(name="DiseaseModelLabelValue")
standard_StandardDiseaseModelState = Class(name="standard_StandardDiseaseModelState", is_abstract=True)
...
standard_StochasticSIDiseaseModel = Class(name="standard_StochasticSIDiseaseModel")
standard_StochasticSIRDiseaseModel = Class(name="standard_StochasticSIRDiseaseModel")
standard_SanityChecker = Class(name="standard_SanityChecker", is_abstract=True)
standard_IntegrationLabel = Class(name="standard_IntegrationLabel", is_abstract=True)
standard_IntegrationLabelValue = Class(name="standard_IntegrationLabelValue", is_abstract=True)
standard_IntegrationDecorator = Class(name="standard_IntegrationDecorator", is_abstract=True)
standard_AggregatingSIDiseaseModel = Class(name="standard_AggregatingSIDiseaseModel")
standard_AggregatingDiseaseModelState = Class(name="standard_AggregatingDiseaseModelState")
standard_AggregatingSEIRDiseaseModel = Class(name="standard_AggregatingSEIRDiseaseModel")
AggregatingSIRDiseaseModel = Class(name="AggregatingSIRDiseaseModel")
standard_AggregatingSIRDiseaseModel = Class(name="standard_AggregatingSIRDiseaseModel")
AggregatingSIDiseaseModel = Class(name="AggregatingSIDiseaseModel")
standard_StochasticDiseaseModel = Class(name="standard_StochasticDiseaseModel", is_abstract=True)
standard_StandardStochasticDiseaseModel = Class(name="standard_StandardStochasticDiseaseModel", is_abstract=True)
StochasticDiseaseModel = Class(name="StochasticDiseaseModel")
standard_SIRInoculator = Class(name="standard_SIRInoculator")
SIInfector = Class(name="SIInfector")
standard_StochasticPoissonSIDiseaseModel = Class(name="standard_StochasticPoissonSIDiseaseModel")
standard_StochasticPoissonSIRDiseaseModel = Class(name="standard_StochasticPoissonSIRDiseaseModel")
standard_StochasticPoissonSEIRDiseaseModel = Class(name="standard_StochasticPoissonSEIRDiseaseModel")
standard_InfectorInoculatorCollection = Class(name="standard_InfectorInoculatorCollection")
standard_StandardInfector = Class(name="standard_StandardInfector", is_abstract=True)
Infector = Class(name="Infector")
standard_StochasticSEIRDiseaseModel = Class(name="standard_StochasticSEIRDiseaseModel")
...
standard_DiseaseModel_m_getAdjustedBackgroundMortalityRate: Method = Method(name="getAdjustedBackgroundMortalityRate", parameters={Parameter(name='standard_timeDelta', type=StringType)}, type=FloatType)
...
standard_DiseaseModel_m_initializeDiseaseState: Method = Method(name="initializeDiseaseState", parameters={Parameter(name='standard_diseaseModelState', type=StringType), Parameter(name='standard_diseaseModelLabel', type=StringType)}, type=StringType)
standard_DiseaseModel_m_initializeDiseaseState: Method = Method(name="initializeDiseaseState", parameters={Parameter(name='standard_diseaseModelLabel', type=StringType)})
standard_DiseaseModel_m_createInfector: Method = Method(name="createInfector", parameters={}, type=StringType)
standard_DiseaseModel_m_getAdjustedBackgroundBirthRate: Method = Method(name="getAdjustedBackgroundBirthRate", parameters={Parameter(name='standard_timeDelta', type=StringType)}, type=FloatType)
standard_DiseaseModel.attributes={standard_DiseaseModel_backgroundBirthRate, standard_DiseaseModel_diseaseName, standard_DiseaseModel_backgroundMortalityRate, standard_DiseaseModel_finiteDifference, standard_DiseaseModel_relativeTolerance, standard_DiseaseModel_timePeriod, standard_DiseaseModel_frequencyDependent, standard_DiseaseModel_populationIdentifier}
standard_DiseaseModel.methods={standard_DiseaseModel_m_createInfector, standard_DiseaseModel_m_getAdjustedBackgroundBirthRate, standard_DiseaseModel_m_createDiseaseModelState, standard_DiseaseModel_m_getAdjustedBackgroundMortalityRate, standard_DiseaseModel_m_createDiseaseModelLabel, standard_DiseaseModel_m_initializeDiseaseState, standard_DiseaseModel_m_initializeDiseaseState, standard_DiseaseModel_m_createDiseaseModelLabelValue}
...
standard_DiseaseModelLabelValue_m_set: Method = Method(name="set", parameters={Parameter(name='standard_value', type=StringType)}, type=StringType)
standard_DiseaseModelLabelValue_m_add: Method = Method(name="add", parameters={Parameter(name='standard_value', type=StringType)}, type=StringType)
standard_DiseaseModelLabelValue_m_sub: Method = Method(name="sub", parameters={Parameter(name='standard_value', type=StringType)}, type=StringType)
standard_DiseaseModelLabelValue_m_scale: Method = Method(name="scale", parameters={Parameter(name='standard_scaleFactor', type=StringType)}, type=StringType)
standard_DiseaseModelLabelValue_m_zeroOutPopulationCount: Method = Method(name="zeroOutPopulationCount", parameters={})
standard_DiseaseModelLabelValue.attributes={standard_DiseaseModelLabelValue_diseaseDeaths, standard_DiseaseModelLabelValue_incidence, standard_DiseaseModelLabelValue_populationCount}
standard_DiseaseModelLabelValue.methods={standard_DiseaseModelLabelValue_m_add, standard_DiseaseModelLabelValue_m_scale, standard_DiseaseModelLabelValue_m_zeroOutPopulationCount, standard_DiseaseModelLabelValue_m_sub, standard_DiseaseModelLabelValue_m_set}
...
standard_Infector.attributes={standard_Infector_diseaseName, standard_Infector_populationIdentifier, standard_Infector_infectPercentage, standard_Infector_targetISOKey, standard_Infector_targetURI}
...
standard_StandardDiseaseModel_m_addToTotalPopulationCount: Method = Method(name="addToTotalPopulationCount", parameters={Parameter(name='standard_populationCount', type=StringType)})
...
standard_StandardDiseaseModel_m_addToTotalArea: Method = Method(name="addToTotalArea", parameters={Parameter(name='standard_area', type=StringType)})
standard_StandardDiseaseModel_m_calculateDelta: Method = Method(name="calculateDelta", parameters={Parameter(name='standard_labels', type=StringType), Parameter(name='standard_timeDelta', type=StringType), Parameter(name='standard_time', type=StringType)})
standard_StandardDiseaseModel_m_doModelSpecificAdjustments: Method = Method(name="doModelSpecificAdjustments", parameters={Parameter(name='standard_label', type=StringType)})
standard_StandardDiseaseModel.attributes={standard_StandardDiseaseModel_totalPopulationCountReciprocal, standard_StandardDiseaseModel_totalArea, standard_StandardDiseaseModel_totalPopulationCount, standard_StandardDiseaseModel_referencePopulationDensity}
standard_StandardDiseaseModel.methods={standard_StandardDiseaseModel_m_doModelSpecificAdjustments, standard_StandardDiseaseModel_m_addToTotalPopulationCount, standard_StandardDiseaseModel_m_calculateDelta, standard_StandardDiseaseModel_m_computeTotalPopulationCountReciprocal, standard_StandardDiseaseModel_m_addToTotalArea}
...
standard_SEIR_m_getAdjustedIncubationRate: Method = Method(name="getAdjustedIncubationRate", parameters={Parameter(name='standard_timeDelta', type=StringType)}, type=FloatType)
...
standard_SI_m_getAdjustedInfectiousMortalityRate: Method = Method(name="getAdjustedInfectiousMortalityRate", parameters={Parameter(name='standard_timeDelta', type=StringType)}, type=FloatType)
standard_SI_m_getAdjustedTransmissionRate: Method = Method(name="getAdjustedTransmissionRate", parameters={Parameter(name='standard_timeDelta', type=StringType)}, type=FloatType)
standard_SI_m_getAdjustedRecoveryRate: Method = Method(name="getAdjustedRecoveryRate", parameters={Parameter(name='standard_timeDelta', type=StringType)}, type=FloatType)
standard_SI_m_getEffectiveInfectious: Method = Method(name="getEffectiveInfectious", parameters={Parameter(name='standard_onsiteInfectious', type=StringType), Parameter(name='standard_diseaseLabel', type=StringType), Parameter(name='standard_node', type=StringType)}, type=FloatType)
standard_SI_m_getNormalizedEffectiveInfectious: Method = Method(name="getNormalizedEffectiveInfectious", parameters={Parameter(name='standard_onsiteInfectious', type=StringType), Parameter(name='standard_diseaseLabel', type=StringType), Parameter(name='standard_node', type=StringType)}, type=FloatType)
standard_SI.attributes={standard_SI_nonLinearityCoefficient, standard_SI_physicallyAdjacentInfectiousProportion, standard_SI_infectiousMortalityRate, standard_SI_recoveryRate, standard_SI_roadNetworkInfectiousProportion, standard_SI_transmissionRate, standard_SI_characteristicMixingDistance, standard_SI_infectiousMortality}
standard_SI.methods={standard_SI_m_getNormalizedEffectiveInfectious, standard_SI_m_getEffectiveInfectious, standard_SI_m_getAdjustedInfectiousMortalityRate, standard_SI_m_getAdjustedRecoveryRate, standard_SI_m_getAdjustedTransmissionRate}
...
standard_SIR_m_getAdjustedImmunityLossRate: Method = Method(name="getAdjustedImmunityLossRate", parameters={Parameter(name='standard_timeDelta', type=StringType)}, type=FloatType)
...
standard_StochasticDiseaseModel.attributes={standard_StochasticDiseaseModel_randomGenerator, standard_StochasticDiseaseModel_seed}
...
standard_SIRInoculator.attributes={standard_SIRInoculator_inoculatePercentage, standard_SIRInoculator_inoculatedPercentage}
...
domain_model = DomainModel(
    name="standard",
    types={standard_DeterministicSEIRDiseaseModel, SEIR, standard_DeterministicSIDiseaseModel, SI, standard_DeterministicSIRDiseaseModel, SIR, standard_DiseaseModel, NodeDecorator, SanityChecker, Modifiable, standard_DiseaseModelLabel, DynamicNodeLabel, standard_PopulationLabel, standard_DiseaseModelState, standard_DiseaseModelLabelValue, LabelValue, IntegrationLabelValue, standard_Infector, standard_StandardDiseaseModel, standard_SEIR, standard_SEIRLabel, StandardDiseaseModelLabel, standard_SEIRLabelValue, standard_PopulationModelLabel, SIRLabelValue, standard_SI, StandardDiseaseModel, standard_SIDiseaseModelState, StandardDiseaseModelState, standard_SIInfector, StandardInfector, standard_SILabel, standard_SILabelValue, standard_SIR, standard_SIRLabel, standard_SIRLabelValue, SILabelValue, DiseaseModel, IntegrationDecorator, standard_StandardDiseaseModelLabel, DiseaseModelLabel, IntegrationLabel, standard_StandardDiseaseModelLabelValue, DiseaseModelLabelValue, standard_StandardDiseaseModelState, DiseaseModelState, StandardDiseaseModelLabelValue, StandardStochasticDiseaseModel, standard_StochasticSIDiseaseModel, standard_StochasticSIRDiseaseModel, standard_SanityChecker, standard_IntegrationLabel, standard_IntegrationLabelValue, standard_IntegrationDecorator, standard_AggregatingSIDiseaseModel, standard_AggregatingDiseaseModelState, standard_AggregatingSEIRDiseaseModel, AggregatingSIRDiseaseModel, standard_AggregatingSIRDiseaseModel, AggregatingSIDiseaseModel, standard_StochasticDiseaseModel, standard_StandardStochasticDiseaseModel, StochasticDiseaseModel, standard_SIRInoculator, SIInfector, standard_StochasticPoissonSIDiseaseModel, standard_StochasticPoissonSIRDiseaseModel, standard_StochasticPoissonSEIRDiseaseModel, standard_InfectorInoculatorCollection, standard_StandardInfector, Infector, standard_StochasticSEIRDiseaseModel},
    associations={populationLabel0, label4, diseaseModel5, labelsToInfect6, deltaValue9, probeValue10, tempValue13, diseaseModelState1, populationModelLabel2, errorScale19, deltaValue22, probeValue23, tempValue26, originalValue29, originalValue16, deltaValue35, probeValue36, tempValue39, originalValue42, errorScale45, errorScale32, childrensLabels48, list50},
    generalizations={gen_standard_DeterministicSEIRDiseaseModel_SEIR, gen_standard_DeterministicSIDiseaseModel_SI, gen_standard_DeterministicSIRDiseaseModel_SIR, gen_standard_DiseaseModel_NodeDecorator, gen_standard_DiseaseModel_SanityChecker, gen_standard_DiseaseModel_Modifiable, gen_standard_DiseaseModelLabel_DynamicNodeLabel, gen_standard_DiseaseModelLabelValue_LabelValue, gen_standard_DiseaseModelLabelValue_IntegrationLabelValue, gen_standard_Infector_NodeDecorator, gen_standard_Infector_Modifiable, gen_standard_SEIR_SIR, gen_standard_SEIRLabel_StandardDiseaseModelLabel, gen_standard_SEIRLabelValue_SIRLabelValue, gen_standard_SI_StandardDiseaseModel, gen_standard_SIDiseaseModelState_StandardDiseaseModelState, gen_standard_SIInfector_StandardInfector, gen_standard_SILabel_StandardDiseaseModelLabel, gen_standard_SIR_SI, gen_standard_SIRLabel_StandardDiseaseModelLabel, gen_standard_SIRLabelValue_SILabelValue, gen_standard_StandardDiseaseModel_DiseaseModel, gen_standard_StandardDiseaseModel_IntegrationDecorator, gen_standard_StandardDiseaseModelLabel_DiseaseModelLabel, gen_standard_StandardDiseaseModelLabel_IntegrationLabel, gen_standard_StandardDiseaseModelLabelValue_DiseaseModelLabelValue, gen_standard_StandardDiseaseModelState_DiseaseModelState, gen_standard_SILabelValue_StandardDiseaseModelLabelValue, gen_standard_StochasticSEIRDiseaseModel_StandardStochasticDiseaseModel, gen_standard_StochasticSIDiseaseModel_SI, gen_standard_StochasticSIDiseaseModel_StandardStochasticDiseaseModel, gen_standard_StochasticSIRDiseaseModel_SIR, gen_standard_StochasticSIRDiseaseModel_StandardStochasticDiseaseModel, gen_standard_AggregatingSIDiseaseModel_SI, gen_standard_AggregatingDiseaseModelState_DiseaseModelState, gen_standard_AggregatingSEIRDiseaseModel_AggregatingSIRDiseaseModel, gen_standard_AggregatingSIRDiseaseModel_AggregatingSIDiseaseModel, gen_standard_StochasticDiseaseModel_DiseaseModel, gen_standard_StandardStochasticDiseaseModel_StochasticDiseaseModel, gen_standard_SIRInoculator_SIInfector, gen_standard_StochasticPoissonSIDiseaseModel_SI, gen_standard_StochasticPoissonSIRDiseaseModel_SIR, gen_standard_StochasticPoissonSEIRDiseaseModel_SEIR, gen_standard_InfectorInoculatorCollection_NodeDecorator, gen_standard_InfectorInoculatorCollection_Modifiable, gen_standard_StandardInfector_Infector, gen_standard_StochasticSEIRDiseaseModel_SEIR},
    metadata=None
)
