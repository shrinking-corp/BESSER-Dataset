...
class Ant_Delete(FileTask):
    ...
    def __init__(self, verbose: str, quiet: str, file: str, dir: str, failonerror: str, includeEmptyDirs: str, includes: str, includesfile: str, excludes: str, excludesfile: str, defaultexcludes: str):
...
class Ant_FormatTstamp:
    ...
    def __init__(self, unit: str, locale: str, property1: str, pattern: str, offset: str):
        self.unit = unit
        self.locale = locale
