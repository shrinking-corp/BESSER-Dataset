...
class extendedPetriNets_InputArc:
    ...
    def __init__(self, weight: int, extendedPetriNets_InputArc8: "extendedPetriNets_Transition" = None, extendedPetriNets_InputArc11: "extendedPetriNets_GenericPlace" = None, extendedPetriNets_InputArc: "extendedPetriNets_PetriNet" = None):
        self.weight = weight
...
class extendedPetriNets_Transition:
    ...
    def __init__(self, name: str, extendedPetriNets_Transition9: "extendedPetriNets_InputArc" = None, extendedPetriNets_Transition15: "extendedPetriNets_OutputArc" = None, extendedPetriNets_Transition: "extendedPetriNets_PetriNet" = None):
        self.name = name
...
class extendedPetriNets_GenericPlace(ABC):
    ...
    def __init__(self, name: str, capacity: int, numberOfTokens: int, extendedPetriNets_GenericPlace12: "extendedPetriNets_InputArc" = None, extendedPetriNets_GenericPlace18: "extendedPetriNets_OutputArc" = None, extendedPetriNets_GenericPlace: "extendedPetriNets_PetriNet" = None):
        self.name = name
...
class extendedPetriNets_PetriNet:
    ...
    def __init__(self, name: str, extendedPetriNets_PetriNet6: set["extendedPetriNets_OutputArc"] = None, extendedPetriNets_PetriNet: set["extendedPetriNets_GenericPlace"] = None, extendedPetriNets_PetriNet2: set["extendedPetriNets_Transition"] = None, extendedPetriNets_PetriNet4: set["extendedPetriNets_InputArc"] = None):
        self.name = name
