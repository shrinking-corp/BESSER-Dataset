...
domain_model = DomainModel(
    ...
    types={extendedPetriNets_OutputArc, extendedPetriNets_Place, GenericPlace, extendedPetriNets_OutputPort, extendedPetriNets_InputPort, extendedPetriNets_PetriNet, extendedPetriNets_GenericPlace, extendedPetriNets_Transition, extendedPetriNets_InputArc},
    associations={containsOutputArcs5, InputArcToTransition7, InputArcFromPlace10, OutputArcFromTransition13, OutputArcToPlace16, containsGenericPlaces0, containsTransitions1, containsInputArcs3},
    generalizations={gen_extendedPetriNets_Place_GenericPlace, gen_extendedPetriNets_OutputPort_GenericPlace, gen_extendedPetriNets_InputPort_GenericPlace},
    metadata=None
)
