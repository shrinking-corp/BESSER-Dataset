...
class ast_RelationalExpression(Expression):
    ...
    def __init__(self, operator: str, ast_RelationalExpression143: "ast_Expression" = None, ast_RelationalExpression: "ast_Expression" = None):
        self.operator = operator
...
class ast_CallableElement(ABC):
    ...
    def __init__(self, ast_CallableElement: "ast_DerivativeOperator" = None, ast_CallableElement170: "ast_FeatureCall" = None, ast_CallableElement223: "ast_ForStatement" = None, ast_CallableElement190: "ast_MemberVariableAccess" = None):
...
class ast_RecordFieldDeclaration:
    ...
    def __init__(self, name: str, ast_RecordFieldDeclaration5: "ast_DataTypeSpecifier" = None, ast_RecordFieldDeclaration: "ast_RecordDefinition" = None):
        self.name = name
