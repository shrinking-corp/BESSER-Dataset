...
public class ast_Check  {
    ...
    public ast_Check(
        ArrayList<ast_DataTypeSpecifier> ast_datatypespecifiers,        ArrayList<ast_DataTypeSpecifier> ast_datatypespecifiers,        ArrayList<ast_Expression> ast_expressions    ) {
