...
def test_hyp_ast_recordfielddeclaration_is_not_abstract():
    assert not inspect.isabstract(ast_RecordFieldDeclaration)


def test_hyp_ast_recordfielddeclaration_constructor_exists():
    assert callable(ast_RecordFieldDeclaration.__init__)


def test_hyp_ast_recordfielddeclaration_constructor_args():
...
def test_hyp_ast_recorddefinition_is_not_abstract():
    assert not inspect.isabstract(ast_RecordDefinition)


def test_hyp_ast_recorddefinition_constructor_exists():
    assert callable(ast_RecordDefinition.__init__)


def test_hyp_ast_recorddefinition_constructor_args():
...
def test_hyp_ast_recordfielddeclaration_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
