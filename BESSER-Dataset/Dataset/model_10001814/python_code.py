...
class Card:
    ...
    def __init__(self, suit: Suit, kind: Kind, player11: "Player" = None, deck1: "Deck" = None):
        self.suit = suit
        self.kind = kind
...
class Player(ABC):
    ...
    def __init__(self, name: str, cards10: set["Card"] = None, avatar4: "Avatar" = None, games7: set["Game"] = None):
        self.name = name
