...
relational_Field = Class(name="relational_Field", is_abstract=True)
...
domain_model = DomainModel(
    name="relational",
    types={Field, relational_ForeignKey, relational_Column, relational_DataBase, relational_Schema, relational_Table, relational_Field, relational_PrimaryKey, Type},
    associations={reference5, schemas0, tables1, fields3},
