...
def test_hyp_wappm_reference_is_not_abstract():
    assert not inspect.isabstract(wappm_Reference)


def test_hyp_wappm_reference_constructor_exists():
    assert callable(wappm_Reference.__init__)


def test_hyp_wappm_reference_constructor_args():
...
def test_hyp_wappm_attribute_is_not_abstract():
    assert not inspect.isabstract(wappm_Attribute)


def test_hyp_wappm_attribute_constructor_exists():
    assert callable(wappm_Attribute.__init__)


def test_hyp_wappm_attribute_constructor_args():
...
def test_hyp_wappm_indexpage_is_not_abstract():
    assert not inspect.isabstract(wappm_IndexPage)


def test_hyp_wappm_indexpage_constructor_exists():
    assert callable(wappm_IndexPage.__init__)


def test_hyp_wappm_indexpage_constructor_args():
...
def test_hyp_wappm_detailpage_is_not_abstract():
    assert not inspect.isabstract(wappm_DetailPage)


def test_hyp_wappm_detailpage_constructor_exists():
    assert callable(wappm_DetailPage.__init__)


def test_hyp_wappm_detailpage_constructor_args():
    sig = inspect.signature(wappm_DetailPage.__init__)
    params = list(sig.parameters.keys())



def test_hyp_wappm_webclass_is_not_abstract():
    assert not inspect.isabstract(wappm_WebClass)


def test_hyp_wappm_webclass_constructor_exists():
    assert callable(wappm_WebClass.__init__)


def test_hyp_wappm_webclass_constructor_args():
...
def test_hyp_wappm_dynamicpage_is_not_abstract():
    assert not inspect.isabstract(wappm_DynamicPage)


def test_hyp_wappm_dynamicpage_constructor_exists():
    assert callable(wappm_DynamicPage.__init__)


def test_hyp_wappm_dynamicpage_constructor_args():
    sig = inspect.signature(wappm_DynamicPage.__init__)
    params = list(sig.parameters.keys())



def test_hyp_wappm_staticpage_is_not_abstract():
    assert not inspect.isabstract(wappm_StaticPage)


def test_hyp_wappm_staticpage_constructor_exists():
    assert callable(wappm_StaticPage.__init__)


def test_hyp_wappm_staticpage_constructor_args():
    sig = inspect.signature(wappm_StaticPage.__init__)
    params = list(sig.parameters.keys())



def test_hyp_wappm_link_is_not_abstract():
    assert not inspect.isabstract(wappm_Link)


def test_hyp_wappm_link_constructor_exists():
    assert callable(wappm_Link.__init__)


def test_hyp_wappm_link_constructor_args():
    sig = inspect.signature(wappm_Link.__init__)
    params = list(sig.parameters.keys())



def test_hyp_wappm_page_is_not_abstract():
    assert not inspect.isabstract(wappm_Page)


def test_hyp_wappm_page_constructor_exists():
    assert callable(wappm_Page.__init__)


def test_hyp_wappm_page_constructor_args():
...
def test_hyp_wappm_contentlayer_is_not_abstract():
    assert not inspect.isabstract(wappm_ContentLayer)


def test_hyp_wappm_contentlayer_constructor_exists():
    assert callable(wappm_ContentLayer.__init__)


def test_hyp_wappm_contentlayer_constructor_args():
...
def test_hyp_wappm_hypertextlayer_is_not_abstract():
    assert not inspect.isabstract(wappm_HypertextLayer)


def test_hyp_wappm_hypertextlayer_constructor_exists():
    assert callable(wappm_HypertextLayer.__init__)


def test_hyp_wappm_hypertextlayer_constructor_args():
...
def test_hyp_wappm_webmodel_is_not_abstract():
    assert not inspect.isabstract(wappm_WebModel)


def test_hyp_wappm_webmodel_constructor_exists():
    assert callable(wappm_WebModel.__init__)


def test_hyp_wappm_webmodel_constructor_args():
    sig = inspect.signature(wappm_WebModel.__init__)
    params = list(sig.parameters.keys())
    assert "name" in params, "Missing parameter 'name'"


def test_hyp_apptypes_exists():
    # Check that the Enumeration exists
    assert AppTypes is not None

def test_hyp_apptypes_has_all_literals():
...
def test_hyp_wappm_reference_upBound_setter(instance):
...
@given(instance=wappm_Reference_strategy)
def test_hyp_wappm_reference_name_setter(instance):
...
@given(instance=wappm_Reference_strategy)
def test_hyp_wappm_reference_lowBound_setter(instance):
...
def test_hyp_wappm_attribute_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=wappm_Attribute_strategy)
def test_hyp_wappm_attribute_type_setter(instance):
...
def test_hyp_wappm_indexpage_size_setter(instance):
...
def test_hyp_wappm_webclass_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_wappm_page_path_setter(instance):
...
@given(instance=wappm_Page_strategy)
def test_hyp_wappm_page_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_wappm_contentlayer_contentName_setter(instance):
...
def test_hyp_wappm_hypertextlayer_hyperName_setter(instance):
...
def test_hyp_wappm_webmodel_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
