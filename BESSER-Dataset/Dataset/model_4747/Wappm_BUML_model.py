...
# Classes
wappm_WebModel = Class(name="wappm_WebModel")
wappm_HypertextLayer = Class(name="wappm_HypertextLayer")
wappm_ContentLayer = Class(name="wappm_ContentLayer")
wappm_Page = Class(name="wappm_Page")
wappm_Link = Class(name="wappm_Link")
wappm_StaticPage = Class(name="wappm_StaticPage")
Page = Class(name="Page")
wappm_DynamicPage = Class(name="wappm_DynamicPage")
wappm_WebClass = Class(name="wappm_WebClass")
wappm_DetailPage = Class(name="wappm_DetailPage")
DynamicPage = Class(name="DynamicPage")
wappm_IndexPage = Class(name="wappm_IndexPage")
wappm_Attribute = Class(name="wappm_Attribute")
wappm_Reference = Class(name="wappm_Reference")
...
wappm_Page.attributes={wappm_Page_path, wappm_Page_name}
...
wappm_Reference.attributes={wappm_Reference_upBound, wappm_Reference_name, wappm_Reference_lowBound}
...
domain_model = DomainModel(
    ...
    associations={hypertext0, content1, pages3, links5, displayedClass7, page8, classes11, attributes14, references16},
