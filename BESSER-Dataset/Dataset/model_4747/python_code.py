...
class wappm_WebClass:
    ...
    def __init__(self, name: str, wappm_WebClass: "wappm_DynamicPage" = None, wappm_WebClass13: "wappm_ContentLayer" = None, wappm_WebClass15: set["wappm_Attribute"] = None, wappm_WebClass17: set["wappm_Reference"] = None):
        self.name = name
