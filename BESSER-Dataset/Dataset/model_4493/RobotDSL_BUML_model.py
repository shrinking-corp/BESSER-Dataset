...
# Classes
robotDSL_Missions = Class(name="robotDSL_Missions")
robotDSL_Mission = Class(name="robotDSL_Mission")
robotDSL_Speed = Class(name="robotDSL_Speed")
robotDSL_Flag = Class(name="robotDSL_Flag")
robotDSL_Task = Class(name="robotDSL_Task")
robotDSL_Goal = Class(name="robotDSL_Goal")
robotDSL_Trigger = Class(name="robotDSL_Trigger")
robotDSL_Time = Class(name="robotDSL_Time")
robotDSL_Action = Class(name="robotDSL_Action")
robotDSL_Direction = Class(name="robotDSL_Direction")
robotDSL_ArmOp = Class(name="robotDSL_ArmOp")
robotDSL_Sound = Class(name="robotDSL_Sound")
robotDSL_Bool = Class(name="robotDSL_Bool")
robotDSL_Negation = Class(name="robotDSL_Negation")
robotDSL_Sensor = Class(name="robotDSL_Sensor")
robotDSL_Color = Class(name="robotDSL_Color")
robotDSL_Distance = Class(name="robotDSL_Distance")
...
robotDSL_Action.attributes={robotDSL_Action_degr, robotDSL_Action_cent, robotDSL_Action_duration}
...
domain_model = DomainModel(
    name="robotDSL",
    types={robotDSL_Missions, robotDSL_Mission, robotDSL_Speed, robotDSL_Flag, robotDSL_Task, robotDSL_Goal, robotDSL_Trigger, robotDSL_Time, robotDSL_Action, robotDSL_Direction, robotDSL_ArmOp, robotDSL_Sound, robotDSL_Bool, robotDSL_Negation, robotDSL_Sensor, robotDSL_Color, robotDSL_Distance, ColorName, DirectionVal, SpeedVal, ArmOpType, SoundName, SensorType, BoolType},
    associations={missionList0, speed21, turnDir23, trig26, flagsList1, taskList3, goal5, goalEvents7, timeout9, finishActions11, triggerList13, actionList16, moveDir19, rangeBool52, op29, sound31, flag33, bool36, boolType38, neg41, flag43, sensor46, color48, dist50},
    generalizations={},
    metadata=None
)
