...
domain_model = DomainModel(
    name="expressions",
    types={expressions_Function, expressions_Parameter, expressions_Expression, expressions_Number, Expression, expressions_ParameterAccess, expressions_BinaryOperator, expressions_Minus, expressions_Mul, expressions_Div, expressions_Neg, UnaryOperator, expressions_FunctionCall, expressions_Model, expressions_UnaryOperator, expressions_Plus, BinaryOperator},
    associations={parameters0, body1, parameter3, op15, function12, arguments14, functions17, op27, op10},
    generalizations={gen_expressions_Number_Expression, gen_expressions_ParameterAccess_Expression, gen_expressions_BinaryOperator_Expression, gen_expressions_Minus_BinaryOperator, gen_expressions_Mul_BinaryOperator, gen_expressions_Div_BinaryOperator, gen_expressions_Neg_UnaryOperator, gen_expressions_FunctionCall_Expression, gen_expressions_UnaryOperator_Expression, gen_expressions_Plus_BinaryOperator},
    metadata=None
)
