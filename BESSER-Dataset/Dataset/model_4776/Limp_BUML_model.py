...
# Classes
limp_LocalFunction = Class(name="limp_LocalFunction")
limp_VarBlock = Class(name="limp_VarBlock")
limp_Specification = Class(name="limp_Specification")
limp_Declaration = Class(name="limp_Declaration")
limp_Comment = Class(name="limp_Comment")
Declaration = Class(name="Declaration")
limp_Import = Class(name="limp_Import")
limp_ExternalFunction = Class(name="limp_ExternalFunction")
FunctionRef = Class(name="FunctionRef")
limp_InputArgList = Class(name="limp_InputArgList")
limp_OutputArg = Class(name="limp_OutputArg")
limp_ExternalProcedure = Class(name="limp_ExternalProcedure")
limp_OutputArgList = Class(name="limp_OutputArgList")
limp_AttributeBlock = Class(name="limp_AttributeBlock")
limp_ArrayTypeDef = Class(name="limp_ArrayTypeDef")
limp_Type = Class(name="limp_Type")
limp_AbstractTypeDef = Class(name="limp_AbstractTypeDef")
limp_EquationBlock = Class(name="limp_EquationBlock")
limp_LocalProcedure = Class(name="limp_LocalProcedure")
limp_StatementBlock = Class(name="limp_StatementBlock")
limp_TypeDeclaration = Class(name="limp_TypeDeclaration")
limp_EnumTypeDef = Class(name="limp_EnumTypeDef")
TypeDeclaration = Class(name="TypeDeclaration")
limp_EnumValue = Class(name="limp_EnumValue")
VariableRef = Class(name="VariableRef")
limp_RecordTypeDef = Class(name="limp_RecordTypeDef")
limp_RecordFieldType = Class(name="limp_RecordFieldType")
limp_Attribute = Class(name="limp_Attribute")
limp_Precondition = Class(name="limp_Precondition")
Attribute = Class(name="Attribute")
limp_Postcondition = Class(name="limp_Postcondition")
limp_ConstantDeclaration = Class(name="limp_ConstantDeclaration")
limp_Expr = Class(name="limp_Expr")
limp_GlobalDeclaration = Class(name="limp_GlobalDeclaration")
limp_VariableRef = Class(name="limp_VariableRef")
limp_InputArg = Class(name="limp_InputArg")
limp_LocalArg = Class(name="limp_LocalArg")
limp_Else = Class(name="limp_Else")
limp_WhileStatement = Class(name="limp_WhileStatement")
limp_DefineUseRef = Class(name="limp_DefineUseRef")
limp_Define = Class(name="limp_Define")
limp_Uses = Class(name="limp_Uses")
limp_Statement = Class(name="limp_Statement")
limp_VoidStatement = Class(name="limp_VoidStatement")
Statement = Class(name="Statement")
Equation = Class(name="Equation")
limp_AssignmentStatement = Class(name="limp_AssignmentStatement")
limp_IdList = Class(name="limp_IdList")
limp_IfThenElseStatement = Class(name="limp_IfThenElseStatement")
limp_RecordExpr = Class(name="limp_RecordExpr")
limp_RecordFieldExpr = Class(name="limp_RecordFieldExpr")
limp_ForStatement = Class(name="limp_ForStatement")
limp_LabelStatement = Class(name="limp_LabelStatement")
limp_GotoStatement = Class(name="limp_GotoStatement")
limp_Equation = Class(name="limp_Equation")
limp_FunctionRef = Class(name="limp_FunctionRef")
limp_ArrayExpr = Class(name="limp_ArrayExpr")
Expr = Class(name="Expr")
limp_AbstractType = Class(name="limp_AbstractType")
limp_NamedType = Class(name="limp_NamedType")
limp_ExprList = Class(name="limp_ExprList")
limp_TypeAlias = Class(name="limp_TypeAlias")
limp_SomeVarBlock = Class(name="limp_SomeVarBlock")
VarBlock = Class(name="VarBlock")
limp_NoVarBlock = Class(name="limp_NoVarBlock")
limp_VoidType = Class(name="limp_VoidType")
Type = Class(name="Type")
limp_BoolType = Class(name="limp_BoolType")
limp_IntegerType = Class(name="limp_IntegerType")
limp_RealType = Class(name="limp_RealType")
limp_StringType = Class(name="limp_StringType")
limp_EnumType = Class(name="limp_EnumType")
limp_RecordType = Class(name="limp_RecordType")
limp_ArrayType = Class(name="limp_ArrayType")
limp_BinaryExpr = Class(name="limp_BinaryExpr")
limp_SomeAttributeBlock = Class(name="limp_SomeAttributeBlock")
AttributeBlock = Class(name="AttributeBlock")
limp_NoAttributeBlock = Class(name="limp_NoAttributeBlock")
limp_BreakStatement = Class(name="limp_BreakStatement")
limp_ContinueStatement = Class(name="limp_ContinueStatement")
limp_ReturnStatement = Class(name="limp_ReturnStatement")
limp_ElseBlock = Class(name="limp_ElseBlock")
Else = Class(name="Else")
limp_ElseIf = Class(name="limp_ElseIf")
limp_NoElse = Class(name="limp_NoElse")
limp_IfThenElseExpr = Class(name="limp_IfThenElseExpr")
limp_ChoiceExpr = Class(name="limp_ChoiceExpr")
limp_ArrayUpdateExpr = Class(name="limp_ArrayUpdateExpr")
limp_BooleanLiteralExpr = Class(name="limp_BooleanLiteralExpr")
limp_UnaryNegationExpr = Class(name="limp_UnaryNegationExpr")
limp_UnaryMinusExpr = Class(name="limp_UnaryMinusExpr")
limp_RecordAccessExpr = Class(name="limp_RecordAccessExpr")
limp_RecordUpdateExpr = Class(name="limp_RecordUpdateExpr")
limp_ArrayAccessExpr = Class(name="limp_ArrayAccessExpr")
limp_IntegerLiteralExpr = Class(name="limp_IntegerLiteralExpr")
limp_IntegerWildCardExpr = Class(name="limp_IntegerWildCardExpr")
limp_RealLiteralExpr = Class(name="limp_RealLiteralExpr")
limp_StringLiteralExpr = Class(name="limp_StringLiteralExpr")
limp_InitExpr = Class(name="limp_InitExpr")
limp_SecondInit = Class(name="limp_SecondInit")
limp_IdExpr = Class(name="limp_IdExpr")
limp_FcnCallExpr = Class(name="limp_FcnCallExpr")
limp_TupleType = Class(name="limp_TupleType")
limp_FreshVariable = Class(name="limp_FreshVariable")
...
else_80: BinaryAssociation = BinaryAssociation(
    name="else_80",
    ends={
...
domain_model = DomainModel(
    name="limp",
    types={limp_LocalFunction, limp_VarBlock, limp_Specification, limp_Declaration, limp_Comment, Declaration, limp_Import, limp_ExternalFunction, FunctionRef, limp_InputArgList, limp_OutputArg, limp_ExternalProcedure, limp_OutputArgList, limp_AttributeBlock, limp_ArrayTypeDef, limp_Type, limp_AbstractTypeDef, limp_EquationBlock, limp_LocalProcedure, limp_StatementBlock, limp_TypeDeclaration, limp_EnumTypeDef, TypeDeclaration, limp_EnumValue, VariableRef, limp_RecordTypeDef, limp_RecordFieldType, limp_Attribute, limp_Precondition, Attribute, limp_Postcondition, limp_ConstantDeclaration, limp_Expr, limp_GlobalDeclaration, limp_VariableRef, limp_InputArg, limp_LocalArg, limp_Else, limp_WhileStatement, limp_DefineUseRef, limp_Define, limp_Uses, limp_Statement, limp_VoidStatement, Statement, Equation, limp_AssignmentStatement, limp_IdList, limp_IfThenElseStatement, limp_RecordExpr, limp_RecordFieldExpr, limp_ForStatement, limp_LabelStatement, limp_GotoStatement, limp_Equation, limp_FunctionRef, limp_ArrayExpr, Expr, limp_AbstractType, limp_NamedType, limp_ExprList, limp_TypeAlias, limp_SomeVarBlock, VarBlock, limp_NoVarBlock, limp_VoidType, Type, limp_BoolType, limp_IntegerType, limp_RealType, limp_StringType, limp_EnumType, limp_RecordType, limp_ArrayType, limp_BinaryExpr, limp_SomeAttributeBlock, AttributeBlock, limp_NoAttributeBlock, limp_BreakStatement, limp_ContinueStatement, limp_ReturnStatement, limp_ElseBlock, Else, limp_ElseIf, limp_NoElse, limp_IfThenElseExpr, limp_ChoiceExpr, limp_ArrayUpdateExpr, limp_BooleanLiteralExpr, limp_UnaryNegationExpr, limp_UnaryMinusExpr, limp_RecordAccessExpr, limp_RecordUpdateExpr, limp_ArrayAccessExpr, limp_IntegerLiteralExpr, limp_IntegerWildCardExpr, limp_RealLiteralExpr, limp_StringLiteralExpr, limp_InitExpr, limp_SecondInit, limp_IdExpr, limp_FcnCallExpr, limp_TupleType, limp_FreshVariable},
    associations={inputs10, output12, varBlock15, declarations0, inputs1, output2, inputs4, outputs6, attributeBlock8, baseType34, equationBlock17, inputs19, outputs21, varBlock24, attributeBlock27, statementblock30, enumerations32, fields33, expr57, fieldType35, type38, expr40, type42, inputArgs44, type46, type49, outputArgs51, type54, else_80, cond82, block84, expr59, referenceExpr61, elements63, elements65, statements67, expr69, ids71, rhs72, cond75, thenBlock77, exprList108, recordDefinition111, fieldExprList113, initStatement87, limitExpr89, incrementStatement92, block95, label98, whenExpr99, equations102, ids104, arrayDefinition106, arrayDef128, abstractDef130, alias131, fieldExpr115, exprList118, type120, locals122, enumDef124, recordDef126, first146, second148, left151, attributeList133, block134, ifThenElse136, condExpr138, thenExpr140, elseExpr143, access172, value174, right153, expr156, expr158, record160, record162, value164, array167, index169, id177, id179, id181, id183, exprs184, typeList187},
    generalizations={gen_limp_LocalFunction_Declaration, gen_limp_LocalFunction_FunctionRef, gen_limp_Comment_Declaration, gen_limp_Import_Declaration, gen_limp_ExternalFunction_Declaration, gen_limp_ExternalFunction_FunctionRef, gen_limp_ExternalProcedure_Declaration, gen_limp_ExternalProcedure_FunctionRef, gen_limp_ArrayTypeDef_TypeDeclaration, gen_limp_AbstractTypeDef_TypeDeclaration, gen_limp_LocalProcedure_Declaration, gen_limp_LocalProcedure_FunctionRef, gen_limp_TypeDeclaration_Declaration, gen_limp_EnumTypeDef_TypeDeclaration, gen_limp_EnumValue_VariableRef, gen_limp_RecordTypeDef_TypeDeclaration, gen_limp_Precondition_Attribute, gen_limp_Postcondition_Attribute, gen_limp_ConstantDeclaration_Declaration, gen_limp_ConstantDeclaration_VariableRef, gen_limp_GlobalDeclaration_Declaration, gen_limp_GlobalDeclaration_VariableRef, gen_limp_InputArg_VariableRef, gen_limp_LocalArg_VariableRef, gen_limp_OutputArg_VariableRef, gen_limp_WhileStatement_Statement, gen_limp_Define_Attribute, gen_limp_Uses_Attribute, gen_limp_VoidStatement_Statement, gen_limp_VoidStatement_Equation, gen_limp_AssignmentStatement_Statement, gen_limp_AssignmentStatement_Equation, gen_limp_IfThenElseStatement_Statement, gen_limp_RecordExpr_Expr, gen_limp_ForStatement_Statement, gen_limp_LabelStatement_Statement, gen_limp_GotoStatement_Statement, gen_limp_ArrayExpr_Expr, gen_limp_AbstractType_Type, gen_limp_NamedType_Type, gen_limp_TypeAlias_TypeDeclaration, gen_limp_SomeVarBlock_VarBlock, gen_limp_NoVarBlock_VarBlock, gen_limp_VoidType_Type, gen_limp_BoolType_Type, gen_limp_IntegerType_Type, gen_limp_RealType_Type, gen_limp_StringType_Type, gen_limp_EnumType_Type, gen_limp_RecordType_Type, gen_limp_ArrayType_Type, gen_limp_BinaryExpr_Expr, gen_limp_SomeAttributeBlock_AttributeBlock, gen_limp_NoAttributeBlock_AttributeBlock, gen_limp_BreakStatement_Statement, gen_limp_ContinueStatement_Statement, gen_limp_ReturnStatement_Statement, gen_limp_ElseBlock_Else, gen_limp_ElseIf_Else, gen_limp_NoElse_Else, gen_limp_IfThenElseExpr_Expr, gen_limp_ChoiceExpr_Expr, gen_limp_ArrayUpdateExpr_Expr, gen_limp_BooleanLiteralExpr_Expr, gen_limp_UnaryNegationExpr_Expr, gen_limp_UnaryMinusExpr_Expr, gen_limp_RecordAccessExpr_Expr, gen_limp_RecordUpdateExpr_Expr, gen_limp_ArrayAccessExpr_Expr, gen_limp_IntegerLiteralExpr_Expr, gen_limp_IntegerWildCardExpr_Expr, gen_limp_RealLiteralExpr_Expr, gen_limp_StringLiteralExpr_Expr, gen_limp_InitExpr_Expr, gen_limp_SecondInit_Expr, gen_limp_IdExpr_Expr, gen_limp_FcnCallExpr_Expr, gen_limp_TupleType_Type, gen_limp_FreshVariable_Expr},
    metadata=None
)
