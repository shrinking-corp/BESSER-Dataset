...
class limp_RecordFieldExpr:
    ...
    def __init__(self, fieldName: str, limp_RecordFieldExpr116: "limp_Expr" = None, limp_RecordFieldExpr: "limp_RecordExpr" = None):
...
class limp_RecordFieldType:
    ...
    def __init__(self, fieldName: str, limp_RecordFieldType: "limp_RecordTypeDef" = None, limp_RecordFieldType36: "limp_Type" = None):
        self.fieldName = fieldName
