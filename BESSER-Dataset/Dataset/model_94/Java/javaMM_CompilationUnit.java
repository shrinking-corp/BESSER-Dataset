...
public class javaMM_CompilationUnit extends NamedElement {
    ...
    public javaMM_CompilationUnit(
        String originalFilePath        ArrayList<javaMM_ImportDeclaration> javamm_importdeclarations,        ArrayList<javaMM_Comment> javamm_comments,        ArrayList<javaMM_AbstractTypeDeclaration> javamm_abstracttypedeclarations    ) {
        this.originalFilePath = originalFilePath;
