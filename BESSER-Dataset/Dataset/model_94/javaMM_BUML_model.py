...
javaMM_Block_m_emptyBlockIsDocumented: Method = Method(name="emptyBlockIsDocumented", parameters={Parameter(name='javaMM_context', type=StringType), Parameter(name='javaMM_diagnostics', type=StringType)}, type=BooleanType)
javaMM_Block.methods={javaMM_Block_m_emptyBlockIsDocumented}

# javaMM_AbstractMethodDeclaration class attributes and methods
javaMM_AbstractMethodDeclaration_m_localMethodIsUsed: Method = Method(name="localMethodIsUsed", parameters={Parameter(name='javaMM_diagnostics', type=StringType), Parameter(name='javaMM_context', type=StringType)}, type=BooleanType)
javaMM_AbstractMethodDeclaration_m_parametersEffectivelyFinal: Method = Method(name="parametersEffectivelyFinal", parameters={Parameter(name='javaMM_diagnostics', type=StringType), Parameter(name='javaMM_context', type=StringType)}, type=BooleanType)
...
javaMM_CatchClause_m_doesNotCatchDubiousExceptions: Method = Method(name="doesNotCatchDubiousExceptions", parameters={Parameter(name='javaMM_diagnostics', type=StringType), Parameter(name='javaMM_context', type=StringType)}, type=BooleanType)
javaMM_CatchClause_m_exceptionIsUsed: Method = Method(name="exceptionIsUsed", parameters={Parameter(name='javaMM_diagnostics', type=StringType), Parameter(name='javaMM_context', type=StringType)}, type=BooleanType)
javaMM_CatchClause.methods={javaMM_CatchClause_m_doesNotCatchDubiousExceptions, javaMM_CatchClause_m_exceptionIsUsed}
...
javaMM_Assignment_m_noRedundantAssignment: Method = Method(name="noRedundantAssignment", parameters={Parameter(name='javaMM_context', type=StringType), Parameter(name='javaMM_diagnostics', type=StringType)}, type=BooleanType)
...
javaMM_Modifier.attributes={javaMM_Modifier_transient, javaMM_Modifier_synchronized, javaMM_Modifier_strictfp, javaMM_Modifier_static, javaMM_Modifier_volatile, javaMM_Modifier_visibility, javaMM_Modifier_inheritance, javaMM_Modifier_native}
...
javaMM_ClassDeclaration_m_noCovariantCompareTo: Method = Method(name="noCovariantCompareTo", parameters={Parameter(name='javaMM_context', type=StringType), Parameter(name='javaMM_diagnostics', type=StringType)}, type=BooleanType)
javaMM_ClassDeclaration_m_hashCodeAndEquals: Method = Method(name="hashCodeAndEquals", parameters={Parameter(name='javaMM_context', type=StringType), Parameter(name='javaMM_diagnostics', type=StringType)}, type=BooleanType)
javaMM_ClassDeclaration_m_serialUIDInSerializableClass: Method = Method(name="serialUIDInSerializableClass", parameters={Parameter(name='javaMM_diagnostics', type=StringType), Parameter(name='javaMM_context', type=StringType)}, type=BooleanType)
javaMM_ClassDeclaration_m_equalsAndCompareTo: Method = Method(name="equalsAndCompareTo", parameters={Parameter(name='javaMM_context', type=StringType), Parameter(name='javaMM_diagnostics', type=StringType)}, type=BooleanType)
javaMM_ClassDeclaration_m_noRedundantInterfaceImpl: Method = Method(name="noRedundantInterfaceImpl", parameters={Parameter(name='javaMM_context', type=StringType), Parameter(name='javaMM_diagnostics', type=StringType)}, type=BooleanType)
javaMM_ClassDeclaration_m_cloneInCloneable: Method = Method(name="cloneInCloneable", parameters={Parameter(name='javaMM_diagnostics', type=StringType), Parameter(name='javaMM_context', type=StringType)}, type=BooleanType)
javaMM_ClassDeclaration_m_noCovariantEquals: Method = Method(name="noCovariantEquals", parameters={Parameter(name='javaMM_context', type=StringType), Parameter(name='javaMM_diagnostics', type=StringType)}, type=BooleanType)
javaMM_ClassDeclaration_m_noObscuredVariables: Method = Method(name="noObscuredVariables", parameters={Parameter(name='javaMM_diagnostics', type=StringType), Parameter(name='javaMM_context', type=StringType)}, type=BooleanType)
javaMM_ClassDeclaration_m_comparatorImplementsSerializable: Method = Method(name="comparatorImplementsSerializable", parameters={Parameter(name='javaMM_context', type=StringType), Parameter(name='javaMM_diagnostics', type=StringType)}, type=BooleanType)
javaMM_ClassDeclaration.methods={javaMM_ClassDeclaration_m_cloneInCloneable, javaMM_ClassDeclaration_m_comparatorImplementsSerializable, javaMM_ClassDeclaration_m_equalsAndCompareTo, javaMM_ClassDeclaration_m_hasHashcode, javaMM_ClassDeclaration_m_hasCompareTo, javaMM_ClassDeclaration_m_hasEquals, javaMM_ClassDeclaration_m_getMethods, javaMM_ClassDeclaration_m_noRedundantInterfaceImpl, javaMM_ClassDeclaration_m_noCovariantCompareTo, javaMM_ClassDeclaration_m_noCovariantEquals, javaMM_ClassDeclaration_m_serialUIDInSerializableClass, javaMM_ClassDeclaration_m_hashCodeAndEquals, javaMM_ClassDeclaration_m_noObscuredVariables}
...
javaMM_IfStatement_m_noDeadCode: Method = Method(name="noDeadCode", parameters={Parameter(name='javaMM_diagnostics', type=StringType), Parameter(name='javaMM_context', type=StringType)}, type=BooleanType)
javaMM_IfStatement_m_noUselessControlFlow: Method = Method(name="noUselessControlFlow", parameters={Parameter(name='javaMM_context', type=StringType), Parameter(name='javaMM_diagnostics', type=StringType)}, type=BooleanType)
javaMM_IfStatement.methods={javaMM_IfStatement_m_noUselessControlFlow, javaMM_IfStatement_m_noDeadCode}
...
javaMM_InfixExpression_m_equalsNotOnLiterals: Method = Method(name="equalsNotOnLiterals", parameters={Parameter(name='javaMM_context', type=StringType), Parameter(name='javaMM_diagnostics', type=StringType)}, type=BooleanType)
javaMM_InfixExpression_m_noRedundantComparison: Method = Method(name="noRedundantComparison", parameters={Parameter(name='javaMM_diagnostics', type=StringType), Parameter(name='javaMM_context', type=StringType)}, type=BooleanType)
javaMM_InfixExpression_m_equalsNotOnStrings: Method = Method(name="equalsNotOnStrings", parameters={Parameter(name='javaMM_context', type=StringType), Parameter(name='javaMM_diagnostics', type=StringType)}, type=BooleanType)
...
javaMM_MethodDeclaration_m_shouldStartWithLowerCase: Method = Method(name="shouldStartWithLowerCase", parameters={Parameter(name='javaMM_context', type=StringType), Parameter(name='javaMM_diagnostics', type=StringType)}, type=BooleanType)
...
javaMM_MethodInvocation_m_doesNotCallFinalize: Method = Method(name="doesNotCallFinalize", parameters={Parameter(name='javaMM_context', type=StringType), Parameter(name='javaMM_diagnostics', type=StringType)}, type=BooleanType)
javaMM_MethodInvocation_m_doesNotCallExit: Method = Method(name="doesNotCallExit", parameters={Parameter(name='javaMM_context', type=StringType), Parameter(name='javaMM_diagnostics', type=StringType)}, type=BooleanType)
javaMM_MethodInvocation_m_doesNotCallRunFinalizers: Method = Method(name="doesNotCallRunFinalizers", parameters={Parameter(name='javaMM_context', type=StringType), Parameter(name='javaMM_diagnostics', type=StringType)}, type=BooleanType)
javaMM_MethodInvocation.methods={javaMM_MethodInvocation_m_doesNotCallRunFinalizers, javaMM_MethodInvocation_m_doesNotCallExit, javaMM_MethodInvocation_m_doesNotCallFinalize}
...
javaMM_VariableDeclarationStatement_m_publicVariableIsFinal: Method = Method(name="publicVariableIsFinal", parameters={Parameter(name='javaMM_context', type=StringType), Parameter(name='javaMM_diagnostics', type=StringType)}, type=BooleanType)
...
javaMM_VariableDeclarationExpression_m_publicVariableIsFinal: Method = Method(name="publicVariableIsFinal", parameters={Parameter(name='javaMM_diagnostics', type=StringType), Parameter(name='javaMM_context', type=StringType)}, type=BooleanType)
...
javaMM_VariableDeclaration_m_variableIsUsed: Method = Method(name="variableIsUsed", parameters={Parameter(name='javaMM_context', type=StringType), Parameter(name='javaMM_diagnostics', type=StringType)}, type=BooleanType)
...
javaMM_SuperConstructorInvocation_m_noRedundantSuperCall: Method = Method(name="noRedundantSuperCall", parameters={Parameter(name='javaMM_context', type=StringType), Parameter(name='javaMM_diagnostics', type=StringType)}, type=BooleanType)
...
javaMM_SwitchStatement_m_moreThan3Cases: Method = Method(name="moreThan3Cases", parameters={Parameter(name='javaMM_context', type=StringType), Parameter(name='javaMM_diagnostics', type=StringType)}, type=BooleanType)
...
javaMM_SynchronizedStatement_m_hasStatements: Method = Method(name="hasStatements", parameters={Parameter(name='javaMM_diagnostics', type=StringType), Parameter(name='javaMM_context', type=StringType)}, type=BooleanType)
...
domain_model = DomainModel(
    name="javaMM",
    types={javaMM_Block, javaMM_AbstractMethodDeclaration, BodyDeclaration, javaMM_AbstractTypeDeclaration, Type, javaMM_BodyDeclaration, javaMM_SingleVariableDeclaration, javaMM_TypeAccess, javaMM_TypeParameter, javaMM_MethodRef, javaMM_AbstractMethodInvocation, ASTNode, javaMM_Expression, javaMM_Comment, javaMM_Package, javaMM_AbstractTypeQualifiedExpression, Expression, javaMM_AbstractVariablesContainer, javaMM_VariableDeclarationFragment, javaMM_Annotation, javaMM_AnnotationMemberValuePair, javaMM_Archive, NamedElement, javaMM_ClassFile, javaMM_Manifest, javaMM_AssertStatement, Statement, javaMM_ASTNode, javaMM_CompilationUnit, javaMM_AnnotationTypeMemberDeclaration, javaMM_AnnotationTypeDeclaration, AbstractTypeDeclaration, javaMM_AnonymousClassDeclaration, javaMM_ClassInstanceCreation, javaMM_ArrayAccess, javaMM_ArrayCreation, javaMM_ArrayInitializer, javaMM_CatchClause, javaMM_ArrayLengthAccess, javaMM_ArrayType, javaMM_Assignment, javaMM_Modifier, javaMM_BooleanLiteral, javaMM_BlockComment, Comment, javaMM_Statement, javaMM_BreakStatement, javaMM_LabeledStatement, javaMM_CastExpression, javaMM_CharacterLiteral, AbstractMethodInvocation, javaMM_ConstructorDeclaration, AbstractMethodDeclaration, javaMM_ConditionalExpression, javaMM_ConstructorInvocation, javaMM_ClassDeclaration, TypeDeclaration, javaMM_DoStatement, javaMM_ImportDeclaration, javaMM_ContinueStatement, javaMM_EmptyStatement, javaMM_EnhancedForStatement, javaMM_EnumConstantDeclaration, VariableDeclaration, javaMM_EnumDeclaration, javaMM_ExpressionStatement, javaMM_FieldAccess, javaMM_SingleVariableAccess, javaMM_FieldDeclaration, AbstractVariablesContainer, javaMM_ForStatement, javaMM_IfStatement, javaMM_InterfaceDeclaration, javaMM_Javadoc, javaMM_TagElement, javaMM_NamedElement, javaMM_InfixExpression, javaMM_Initializer, javaMM_InstanceofExpression, javaMM_LineComment, javaMM_ManifestAttribute, javaMM_ManifestEntry, javaMM_MemberRef, javaMM_MethodDeclaration, javaMM_MethodInvocation, javaMM_VariableDeclarationStatement, javaMM_VariableDeclarationExpression, javaMM_MethodRefParameter, javaMM_Model, javaMM_Type, javaMM_UnresolvedItem, javaMM_ParenthesizedExpression, javaMM_PostfixExpression, javaMM_NamespaceAccess, javaMM_NumberLiteral, javaMM_NullLiteral, javaMM_PackageAccess, NamespaceAccess, javaMM_ParameterizedType, javaMM_StringLiteral, javaMM_PrefixExpression, javaMM_PrimitiveType, javaMM_PrimitiveTypeBoolean, PrimitiveType, javaMM_PrimitiveTypeByte, javaMM_PrimitiveTypeChar, javaMM_PrimitiveTypeDouble, javaMM_PrimitiveTypeShort, javaMM_PrimitiveTypeFloat, javaMM_PrimitiveTypeInt, javaMM_PrimitiveTypeLong, javaMM_PrimitiveTypeVoid, javaMM_ReturnStatement, javaMM_VariableDeclaration, javaMM_TextElement, javaMM_SuperConstructorInvocation, javaMM_SuperFieldAccess, AbstractTypeQualifiedExpression, javaMM_SuperMethodInvocation, javaMM_SwitchCase, javaMM_SwitchStatement, javaMM_SynchronizedStatement, javaMM_TypeLiteral, javaMM_ThisExpression, javaMM_ThrowStatement, javaMM_TryStatement, javaMM_TypeDeclaration, javaMM_TypeDeclarationStatement, javaMM_UnresolvedItemAccess, javaMM_UnresolvedAnnotationDeclaration, AnnotationTypeDeclaration, UnresolvedItem, javaMM_UnresolvedAnnotationTypeMemberDeclaration, AnnotationTypeMemberDeclaration, javaMM_UnresolvedClassDeclaration, ClassDeclaration, javaMM_UnresolvedEnumDeclaration, EnumDeclaration, javaMM_UnresolvedInterfaceDeclaration, InterfaceDeclaration, javaMM_UnresolvedLabeledStatement, LabeledStatement, javaMM_UnresolvedMethodDeclaration, MethodDeclaration, javaMM_UnresolvedSingleVariableDeclaration, SingleVariableDeclaration, javaMM_UnresolvedType, javaMM_UnresolvedTypeDeclaration, javaMM_UnresolvedVariableDeclarationFragment, VariableDeclarationFragment, javaMM_WildCardType, javaMM_WhileStatement, AssignmentKind, InfixExpressionKind, InheritanceKind, PostfixExpressionKind, PrefixExpressionKind, VisibilityKind},
    associations={body0, parameters1, thrownExceptions2, typeParameters4, usagesInDocComments6, usages7, method9, arguments10, typeArguments11, bodyDeclarations14, commentsBeforeBody15, commentsAfterBody16, package19, superInterfaces20, qualifier23, type25, fragments27, type28, values30, classFiles32, manifest33, message35, type70, expressions73, expression37, comments40, originalCompilationUnit42, originalClassFile44, member47, value49, default52, type54, usages57, bodyDeclarations58, classInstanceCreation60, array61, index63, dimensions66, expression94, initializer68, type96, array76, elementType78, leftHandSide80, rightHandSide82, abstractTypeDeclaration85, annotations86, anonymousClassDeclarationOwner88, modifier90, statements91, label93, exception99, body101, type103, attachedSource106, package109, anonymousClassDeclaration111, expression113, type115, elseExpression118, expression120, thenExpression123, label139, expression141, superClass126, commentList128, imports131, package133, types136, body143, body146, expression148, parameter151, anonymousClassDeclaration153, arguments154, enumConstants157, expression159, field161, expression162, expression165, updaters167, initializers170, body173, leftOperand197, expression176, thenStatement178, elseStatement181, importedElement184, rightOperand185, leftOperand187, extendedOperands190, body193, rightOperand195, tags200, body201, usagesInBreakStatements203, usagesInContinueStatements204, mainAttributes206, entryAttributes208, attributes210, member213, qualifier214, returnType217, redefinedMethodDeclaration220, redefinitions222, variableDeclarationStatement254, variableDeclarationExpression256, expression224, method226, qualifier228, parameters230, type232, ownedElements235, orphanTypes237, unresolvedItems238, compilationUnits240, classFiles243, archives246, bodyDeclaration249, singleVariableDeclaration251, typeArguments278, expression281, usagesInImports258, ownedElements259, model261, ownedPackages264, package268, usagesInPackageAccess270, package272, qualifier275, type276, methodDeclaration300, catchClause302, enhancedForStatement303, operand283, operand285, expression287, variable289, qualifier290, modifier293, type295, annotations297, body315, expression317, fragments320, expression304, field306, expression308, expression310, statements312, declaration339, expression323, body325, finally_327, catchClauses330, usagesInTypeAccess333, type334, qualifier335, typeParameters337, type341, bounds343, element346, qualifier348, initializer351, usageInVariableAccess353, modifier354, annotations356, variablesContainer358, modifier359, annotations361, bound363, expression365, body367},
    generalizations={gen_javaMM_AbstractMethodDeclaration_BodyDeclaration, gen_javaMM_AbstractTypeDeclaration_BodyDeclaration, gen_javaMM_AbstractTypeDeclaration_Type, gen_javaMM_AbstractMethodInvocation_ASTNode, gen_javaMM_AbstractTypeQualifiedExpression_Expression, gen_javaMM_AbstractVariablesContainer_ASTNode, gen_javaMM_Annotation_Expression, gen_javaMM_Archive_NamedElement, gen_javaMM_AssertStatement_Statement, gen_javaMM_ArrayInitializer_Expression, gen_javaMM_AnnotationMemberValuePair_NamedElement, gen_javaMM_AnnotationTypeDeclaration_AbstractTypeDeclaration, gen_javaMM_AnnotationTypeMemberDeclaration_BodyDeclaration, gen_javaMM_AnonymousClassDeclaration_ASTNode, gen_javaMM_ArrayAccess_Expression, gen_javaMM_ArrayCreation_Expression, gen_javaMM_CatchClause_Statement, gen_javaMM_ArrayLengthAccess_Expression, gen_javaMM_ArrayType_Type, gen_javaMM_Assignment_Expression, gen_javaMM_BodyDeclaration_NamedElement, gen_javaMM_BooleanLiteral_Expression, gen_javaMM_BlockComment_Comment, gen_javaMM_Block_Statement, gen_javaMM_BreakStatement_Statement, gen_javaMM_CastExpression_Expression, gen_javaMM_CharacterLiteral_Expression, gen_javaMM_ClassFile_NamedElement, gen_javaMM_ClassInstanceCreation_Expression, gen_javaMM_ClassInstanceCreation_AbstractMethodInvocation, gen_javaMM_ConstructorDeclaration_AbstractMethodDeclaration, gen_javaMM_ConditionalExpression_Expression, gen_javaMM_ConstructorInvocation_Statement, gen_javaMM_ConstructorInvocation_AbstractMethodInvocation, gen_javaMM_ClassDeclaration_TypeDeclaration, gen_javaMM_DoStatement_Statement, gen_javaMM_Comment_ASTNode, gen_javaMM_CompilationUnit_NamedElement, gen_javaMM_ContinueStatement_Statement, gen_javaMM_EmptyStatement_Statement, gen_javaMM_EnhancedForStatement_Statement, gen_javaMM_EnumConstantDeclaration_BodyDeclaration, gen_javaMM_EnumConstantDeclaration_VariableDeclaration, gen_javaMM_EnumDeclaration_AbstractTypeDeclaration, gen_javaMM_Expression_ASTNode, gen_javaMM_ExpressionStatement_Statement, gen_javaMM_FieldAccess_Expression, gen_javaMM_FieldDeclaration_BodyDeclaration, gen_javaMM_FieldDeclaration_AbstractVariablesContainer, gen_javaMM_ForStatement_Statement, gen_javaMM_IfStatement_Statement, gen_javaMM_InterfaceDeclaration_TypeDeclaration, gen_javaMM_Javadoc_Comment, gen_javaMM_ImportDeclaration_ASTNode, gen_javaMM_InfixExpression_Expression, gen_javaMM_Initializer_BodyDeclaration, gen_javaMM_InstanceofExpression_Expression, gen_javaMM_LabeledStatement_NamedElement, gen_javaMM_LabeledStatement_Statement, gen_javaMM_LineComment_Comment, gen_javaMM_MemberRef_ASTNode, gen_javaMM_MethodDeclaration_AbstractMethodDeclaration, gen_javaMM_MethodInvocation_Expression, gen_javaMM_MethodInvocation_AbstractMethodInvocation, gen_javaMM_NamedElement_ASTNode, gen_javaMM_MethodRef_ASTNode, gen_javaMM_MethodRefParameter_ASTNode, gen_javaMM_Modifier_ASTNode, gen_javaMM_ParenthesizedExpression_Expression, gen_javaMM_PostfixExpression_Expression, gen_javaMM_NamespaceAccess_ASTNode, gen_javaMM_NumberLiteral_Expression, gen_javaMM_NullLiteral_Expression, gen_javaMM_Package_NamedElement, gen_javaMM_PackageAccess_NamespaceAccess, gen_javaMM_ParameterizedType_Type, gen_javaMM_Statement_ASTNode, gen_javaMM_StringLiteral_Expression, gen_javaMM_PrefixExpression_Expression, gen_javaMM_PrimitiveType_Type, gen_javaMM_PrimitiveTypeBoolean_PrimitiveType, gen_javaMM_PrimitiveTypeByte_PrimitiveType, gen_javaMM_PrimitiveTypeChar_PrimitiveType, gen_javaMM_PrimitiveTypeDouble_PrimitiveType, gen_javaMM_PrimitiveTypeShort_PrimitiveType, gen_javaMM_PrimitiveTypeFloat_PrimitiveType, gen_javaMM_PrimitiveTypeInt_PrimitiveType, gen_javaMM_PrimitiveTypeLong_PrimitiveType, gen_javaMM_PrimitiveTypeVoid_PrimitiveType, gen_javaMM_ReturnStatement_Statement, gen_javaMM_SingleVariableAccess_Expression, gen_javaMM_SingleVariableDeclaration_VariableDeclaration, gen_javaMM_TagElement_ASTNode, gen_javaMM_SuperConstructorInvocation_Statement, gen_javaMM_SuperConstructorInvocation_AbstractMethodInvocation, gen_javaMM_SuperFieldAccess_AbstractTypeQualifiedExpression, gen_javaMM_SuperMethodInvocation_AbstractTypeQualifiedExpression, gen_javaMM_SuperMethodInvocation_AbstractMethodInvocation, gen_javaMM_SwitchCase_Statement, gen_javaMM_SwitchStatement_Statement, gen_javaMM_SynchronizedStatement_Statement, gen_javaMM_TypeDeclarationStatement_Statement, gen_javaMM_TypeLiteral_Expression, gen_javaMM_TextElement_ASTNode, gen_javaMM_ThisExpression_AbstractTypeQualifiedExpression, gen_javaMM_ThrowStatement_Statement, gen_javaMM_TryStatement_Statement, gen_javaMM_Type_NamedElement, gen_javaMM_TypeAccess_Expression, gen_javaMM_TypeAccess_NamespaceAccess, gen_javaMM_VariableDeclarationExpression_Expression, gen_javaMM_VariableDeclarationExpression_AbstractVariablesContainer, gen_javaMM_TypeDeclaration_AbstractTypeDeclaration, gen_javaMM_TypeParameter_Type, gen_javaMM_UnresolvedItem_NamedElement, gen_javaMM_UnresolvedItemAccess_Expression, gen_javaMM_UnresolvedItemAccess_NamespaceAccess, gen_javaMM_UnresolvedAnnotationDeclaration_AnnotationTypeDeclaration, gen_javaMM_UnresolvedAnnotationDeclaration_UnresolvedItem, gen_javaMM_UnresolvedAnnotationTypeMemberDeclaration_AnnotationTypeMemberDeclaration, gen_javaMM_UnresolvedAnnotationTypeMemberDeclaration_UnresolvedItem, gen_javaMM_UnresolvedClassDeclaration_ClassDeclaration, gen_javaMM_UnresolvedClassDeclaration_UnresolvedItem, gen_javaMM_UnresolvedEnumDeclaration_EnumDeclaration, gen_javaMM_UnresolvedEnumDeclaration_UnresolvedItem, gen_javaMM_UnresolvedInterfaceDeclaration_InterfaceDeclaration, gen_javaMM_UnresolvedInterfaceDeclaration_UnresolvedItem, gen_javaMM_UnresolvedLabeledStatement_LabeledStatement, gen_javaMM_UnresolvedLabeledStatement_UnresolvedItem, gen_javaMM_UnresolvedMethodDeclaration_MethodDeclaration, gen_javaMM_UnresolvedMethodDeclaration_UnresolvedItem, gen_javaMM_UnresolvedSingleVariableDeclaration_SingleVariableDeclaration, gen_javaMM_UnresolvedSingleVariableDeclaration_UnresolvedItem, gen_javaMM_UnresolvedType_Type, gen_javaMM_UnresolvedType_UnresolvedItem, gen_javaMM_UnresolvedTypeDeclaration_AbstractTypeDeclaration, gen_javaMM_UnresolvedTypeDeclaration_UnresolvedItem, gen_javaMM_UnresolvedVariableDeclarationFragment_VariableDeclarationFragment, gen_javaMM_UnresolvedVariableDeclarationFragment_UnresolvedItem, gen_javaMM_VariableDeclaration_NamedElement, gen_javaMM_VariableDeclarationFragment_VariableDeclaration, gen_javaMM_VariableDeclarationStatement_Statement, gen_javaMM_VariableDeclarationStatement_AbstractVariablesContainer, gen_javaMM_WildCardType_Type, gen_javaMM_WhileStatement_Statement},
    metadata=None
)
