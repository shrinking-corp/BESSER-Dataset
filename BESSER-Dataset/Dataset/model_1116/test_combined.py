...
def test_hyp_analysis_pipelining_impactanalysisdata_is_not_abstract():
    assert not inspect.isabstract(analysis_pipelining_ImpactAnalysisData)


def test_hyp_analysis_pipelining_impactanalysisdata_constructor_exists():
    assert callable(analysis_pipelining_ImpactAnalysisData.__init__)


def test_hyp_analysis_pipelining_impactanalysisdata_constructor_args():
...
def test_hyp_actionsvariablepipeliningreport_is_not_abstract():
    assert not inspect.isabstract(ActionsVariablePipeliningReport)


def test_hyp_actionsvariablepipeliningreport_constructor_exists():
    assert callable(ActionsVariablePipeliningReport.__init__)


def test_hyp_actionsvariablepipeliningreport_constructor_args():
    sig = inspect.signature(ActionsVariablePipeliningReport.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pipelining_analysis_statisticaldata_is_not_abstract():
    assert not inspect.isabstract(pipelining_analysis_StatisticalData)


def test_hyp_pipelining_analysis_statisticaldata_constructor_exists():
    assert callable(pipelining_analysis_StatisticalData.__init__)


def test_hyp_pipelining_analysis_statisticaldata_constructor_args():
    sig = inspect.signature(pipelining_analysis_StatisticalData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pipelining_analysis_action_is_not_abstract():
    assert not inspect.isabstract(pipelining_analysis_Action)


def test_hyp_pipelining_analysis_action_constructor_exists():
    assert callable(pipelining_analysis_Action.__init__)


def test_hyp_pipelining_analysis_action_constructor_args():
    sig = inspect.signature(pipelining_analysis_Action.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_pipelining_actionvariablepipeliningdata_is_not_abstract():
    assert not inspect.isabstract(analysis_pipelining_ActionVariablePipeliningData)


def test_hyp_analysis_pipelining_actionvariablepipeliningdata_constructor_exists():
    assert callable(analysis_pipelining_ActionVariablePipeliningData.__init__)


def test_hyp_analysis_pipelining_actionvariablepipeliningdata_constructor_args():
...
def test_hyp_actionvariablepipeliningdata_is_not_abstract():
    assert not inspect.isabstract(ActionVariablePipeliningData)


def test_hyp_actionvariablepipeliningdata_constructor_exists():
    assert callable(ActionVariablePipeliningData.__init__)


def test_hyp_actionvariablepipeliningdata_constructor_args():
    sig = inspect.signature(ActionVariablePipeliningData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pipelining_analysis_network_is_not_abstract():
    assert not inspect.isabstract(pipelining_analysis_Network)


def test_hyp_pipelining_analysis_network_constructor_exists():
    assert callable(pipelining_analysis_Network.__init__)


def test_hyp_pipelining_analysis_network_constructor_args():
    sig = inspect.signature(pipelining_analysis_Network.__init__)
    params = list(sig.parameters.keys())



def test_hyp_balancedpipelinepartition_is_not_abstract():
    assert not inspect.isabstract(BalancedPipelinePartition)


def test_hyp_balancedpipelinepartition_constructor_exists():
    assert callable(BalancedPipelinePartition.__init__)


def test_hyp_balancedpipelinepartition_constructor_args():
    sig = inspect.signature(BalancedPipelinePartition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_partitioning_analysis_actor_is_not_abstract():
    assert not inspect.isabstract(partitioning_analysis_Actor)


def test_hyp_partitioning_analysis_actor_constructor_exists():
    assert callable(partitioning_analysis_Actor.__init__)


def test_hyp_partitioning_analysis_actor_constructor_args():
    sig = inspect.signature(partitioning_analysis_Actor.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_partitioning_comcostpartition_is_not_abstract():
    assert not inspect.isabstract(analysis_partitioning_ComCostPartition)


def test_hyp_analysis_partitioning_comcostpartition_constructor_exists():
    assert callable(analysis_partitioning_ComCostPartition.__init__)


def test_hyp_analysis_partitioning_comcostpartition_constructor_args():
...
def test_hyp_analysis_partitioning_balancedpipelinepartition_is_not_abstract():
    assert not inspect.isabstract(analysis_partitioning_BalancedPipelinePartition)


def test_hyp_analysis_partitioning_balancedpipelinepartition_constructor_exists():
    assert callable(analysis_partitioning_BalancedPipelinePartition.__init__)


def test_hyp_analysis_partitioning_balancedpipelinepartition_constructor_args():
...
def test_hyp_workloadbalancepartition_is_not_abstract():
    assert not inspect.isabstract(WorkloadBalancePartition)


def test_hyp_workloadbalancepartition_constructor_exists():
    assert callable(WorkloadBalancePartition.__init__)


def test_hyp_workloadbalancepartition_constructor_args():
    sig = inspect.signature(WorkloadBalancePartition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_partitioning_workloadbalancepartition_is_not_abstract():
    assert not inspect.isabstract(analysis_partitioning_WorkloadBalancePartition)


def test_hyp_analysis_partitioning_workloadbalancepartition_constructor_exists():
    assert callable(analysis_partitioning_WorkloadBalancePartition.__init__)


def test_hyp_analysis_partitioning_workloadbalancepartition_constructor_args():
...
def test_hyp_scheduledimpactanalysisdata_is_not_abstract():
    assert not inspect.isabstract(ScheduledImpactAnalysisData)


def test_hyp_scheduledimpactanalysisdata_constructor_exists():
    assert callable(ScheduledImpactAnalysisData.__init__)


def test_hyp_scheduledimpactanalysisdata_constructor_args():
    sig = inspect.signature(ScheduledImpactAnalysisData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_comcostpartition_is_not_abstract():
    assert not inspect.isabstract(ComCostPartition)


def test_hyp_comcostpartition_constructor_exists():
    assert callable(ComCostPartition.__init__)


def test_hyp_comcostpartition_constructor_args():
    sig = inspect.signature(ComCostPartition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_partitioning_analysis_network_is_not_abstract():
    assert not inspect.isabstract(partitioning_analysis_Network)


def test_hyp_partitioning_analysis_network_constructor_exists():
    assert callable(partitioning_analysis_Network.__init__)


def test_hyp_partitioning_analysis_network_constructor_args():
    sig = inspect.signature(partitioning_analysis_Network.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_buffers_optimalbufferdata_is_not_abstract():
    assert not inspect.isabstract(analysis_buffers_OptimalBufferData)


def test_hyp_analysis_buffers_optimalbufferdata_constructor_exists():
    assert callable(analysis_buffers_OptimalBufferData.__init__)


def test_hyp_analysis_buffers_optimalbufferdata_constructor_args():
    sig = inspect.signature(analysis_buffers_OptimalBufferData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_boundedbuffersreport_is_not_abstract():
    assert not inspect.isabstract(BoundedBuffersReport)


def test_hyp_boundedbuffersreport_constructor_exists():
    assert callable(BoundedBuffersReport.__init__)


def test_hyp_boundedbuffersreport_constructor_args():
    sig = inspect.signature(BoundedBuffersReport.__init__)
    params = list(sig.parameters.keys())



def test_hyp_optimalbufferdata_is_not_abstract():
    assert not inspect.isabstract(OptimalBufferData)


def test_hyp_optimalbufferdata_constructor_exists():
    assert callable(OptimalBufferData.__init__)


def test_hyp_optimalbufferdata_constructor_args():
    sig = inspect.signature(OptimalBufferData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_buffers_analysis_buffer_is_not_abstract():
    assert not inspect.isabstract(buffers_analysis_Buffer)


def test_hyp_buffers_analysis_buffer_constructor_exists():
    assert callable(buffers_analysis_Buffer.__init__)


def test_hyp_buffers_analysis_buffer_constructor_args():
    sig = inspect.signature(buffers_analysis_Buffer.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_buffers_boundedbufferdata_is_not_abstract():
    assert not inspect.isabstract(analysis_buffers_BoundedBufferData)


def test_hyp_analysis_buffers_boundedbufferdata_constructor_exists():
    assert callable(analysis_buffers_BoundedBufferData.__init__)


def test_hyp_analysis_buffers_boundedbufferdata_constructor_args():
...
def test_hyp_boundedbufferdata_is_not_abstract():
    assert not inspect.isabstract(BoundedBufferData)


def test_hyp_boundedbufferdata_constructor_exists():
    assert callable(BoundedBufferData.__init__)


def test_hyp_boundedbufferdata_constructor_args():
    sig = inspect.signature(BoundedBufferData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_buffers_analysis_network_is_not_abstract():
    assert not inspect.isabstract(buffers_analysis_Network)


def test_hyp_buffers_analysis_network_constructor_exists():
    assert callable(buffers_analysis_Network.__init__)


def test_hyp_buffers_analysis_network_constructor_args():
    sig = inspect.signature(buffers_analysis_Network.__init__)
    params = list(sig.parameters.keys())



def test_hyp_bottleneckswithschedulingreport_is_not_abstract():
    assert not inspect.isabstract(BottlenecksWithSchedulingReport)


def test_hyp_bottleneckswithschedulingreport_constructor_exists():
    assert callable(BottlenecksWithSchedulingReport.__init__)


def test_hyp_bottleneckswithschedulingreport_constructor_args():
    sig = inspect.signature(BottlenecksWithSchedulingReport.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_bottlenecks_doubletobottleneckswithschedulingreportmap_is_not_abstract():
    assert not inspect.isabstract(analysis_bottlenecks_DoubleToBottlenecksWithSchedulingReportMap)


def test_hyp_analysis_bottlenecks_doubletobottleneckswithschedulingreportmap_constructor_exists():
    assert callable(analysis_bottlenecks_DoubleToBottlenecksWithSchedulingReportMap.__init__)


def test_hyp_analysis_bottlenecks_doubletobottleneckswithschedulingreportmap_constructor_args():
...
def test_hyp_doubletobottleneckswithschedulingreportmap_is_not_abstract():
    assert not inspect.isabstract(DoubleToBottlenecksWithSchedulingReportMap)


def test_hyp_doubletobottleneckswithschedulingreportmap_constructor_exists():
    assert callable(DoubleToBottlenecksWithSchedulingReportMap.__init__)


def test_hyp_doubletobottleneckswithschedulingreportmap_constructor_args():
    sig = inspect.signature(DoubleToBottlenecksWithSchedulingReportMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_bottlenecks_scheduledimpactanalysisdata_is_not_abstract():
    assert not inspect.isabstract(analysis_bottlenecks_ScheduledImpactAnalysisData)


def test_hyp_analysis_bottlenecks_scheduledimpactanalysisdata_constructor_exists():
    assert callable(analysis_bottlenecks_ScheduledImpactAnalysisData.__init__)


def test_hyp_analysis_bottlenecks_scheduledimpactanalysisdata_constructor_args():
    sig = inspect.signature(analysis_bottlenecks_ScheduledImpactAnalysisData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_buffertodoublemap_is_not_abstract():
    assert not inspect.isabstract(BufferToDoubleMap)


def test_hyp_buffertodoublemap_constructor_exists():
    assert callable(BufferToDoubleMap.__init__)


def test_hyp_buffertodoublemap_constructor_args():
    sig = inspect.signature(BufferToDoubleMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_buffertointegermap_is_not_abstract():
    assert not inspect.isabstract(BufferToIntegerMap)


def test_hyp_buffertointegermap_constructor_exists():
    assert callable(BufferToIntegerMap.__init__)


def test_hyp_buffertointegermap_constructor_args():
    sig = inspect.signature(BufferToIntegerMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_bottlenecks_actionbottleneckswithschedulingdata_is_not_abstract():
    assert not inspect.isabstract(analysis_bottlenecks_ActionBottlenecksWithSchedulingData)


def test_hyp_analysis_bottlenecks_actionbottleneckswithschedulingdata_constructor_exists():
    assert callable(analysis_bottlenecks_ActionBottlenecksWithSchedulingData.__init__)


def test_hyp_analysis_bottlenecks_actionbottleneckswithschedulingdata_constructor_args():
...
def test_hyp_stringtodoublemap_is_not_abstract():
    assert not inspect.isabstract(StringToDoubleMap)


def test_hyp_stringtodoublemap_constructor_exists():
    assert callable(StringToDoubleMap.__init__)


def test_hyp_stringtodoublemap_constructor_args():
    sig = inspect.signature(StringToDoubleMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_actionbottleneckswithschedulingdata_is_not_abstract():
    assert not inspect.isabstract(ActionBottlenecksWithSchedulingData)


def test_hyp_actionbottleneckswithschedulingdata_constructor_exists():
    assert callable(ActionBottlenecksWithSchedulingData.__init__)


def test_hyp_actionbottleneckswithschedulingdata_constructor_args():
    sig = inspect.signature(ActionBottlenecksWithSchedulingData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_postprocessing_postprocessingdata_is_not_abstract():
    assert not inspect.isabstract(postprocessing_PostProcessingData)


def test_hyp_postprocessing_postprocessingdata_constructor_exists():
    assert callable(postprocessing_PostProcessingData.__init__)


def test_hyp_postprocessing_postprocessingdata_constructor_args():
    sig = inspect.signature(postprocessing_PostProcessingData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_bottlenecks_doubletobottlenecksreportmap_is_not_abstract():
    assert not inspect.isabstract(analysis_bottlenecks_DoubleToBottlenecksReportMap)


def test_hyp_analysis_bottlenecks_doubletobottlenecksreportmap_constructor_exists():
    assert callable(analysis_bottlenecks_DoubleToBottlenecksReportMap.__init__)


def test_hyp_analysis_bottlenecks_doubletobottlenecksreportmap_constructor_args():
...
def test_hyp_doubletobottlenecksreportmap_is_not_abstract():
    assert not inspect.isabstract(DoubleToBottlenecksReportMap)


def test_hyp_doubletobottlenecksreportmap_constructor_exists():
    assert callable(DoubleToBottlenecksReportMap.__init__)


def test_hyp_doubletobottlenecksreportmap_constructor_args():
    sig = inspect.signature(DoubleToBottlenecksReportMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_doubletodoublemap_is_not_abstract():
    assert not inspect.isabstract(DoubleToDoubleMap)


def test_hyp_doubletodoublemap_constructor_exists():
    assert callable(DoubleToDoubleMap.__init__)


def test_hyp_doubletodoublemap_constructor_args():
    sig = inspect.signature(DoubleToDoubleMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_bottlenecks_analysis_actorclass_is_not_abstract():
    assert not inspect.isabstract(bottlenecks_analysis_ActorClass)


def test_hyp_bottlenecks_analysis_actorclass_constructor_exists():
    assert callable(bottlenecks_analysis_ActorClass.__init__)


def test_hyp_bottlenecks_analysis_actorclass_constructor_args():
    sig = inspect.signature(bottlenecks_analysis_ActorClass.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_bottlenecks_impactanalysisdata_is_not_abstract():
    assert not inspect.isabstract(analysis_bottlenecks_ImpactAnalysisData)


def test_hyp_analysis_bottlenecks_impactanalysisdata_constructor_exists():
    assert callable(analysis_bottlenecks_ImpactAnalysisData.__init__)


def test_hyp_analysis_bottlenecks_impactanalysisdata_constructor_args():
    sig = inspect.signature(analysis_bottlenecks_ImpactAnalysisData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_bottlenecksreport_is_not_abstract():
    assert not inspect.isabstract(BottlenecksReport)


def test_hyp_bottlenecksreport_constructor_exists():
    assert callable(BottlenecksReport.__init__)


def test_hyp_bottlenecksreport_constructor_args():
    sig = inspect.signature(BottlenecksReport.__init__)
    params = list(sig.parameters.keys())



def test_hyp_impactanalysisdata_is_not_abstract():
    assert not inspect.isabstract(ImpactAnalysisData)


def test_hyp_impactanalysisdata_constructor_exists():
    assert callable(ImpactAnalysisData.__init__)


def test_hyp_impactanalysisdata_constructor_args():
    sig = inspect.signature(ImpactAnalysisData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_bottlenecks_actionbottlenecksdata_is_not_abstract():
    assert not inspect.isabstract(analysis_bottlenecks_ActionBottlenecksData)


def test_hyp_analysis_bottlenecks_actionbottlenecksdata_constructor_exists():
    assert callable(analysis_bottlenecks_ActionBottlenecksData.__init__)


def test_hyp_analysis_bottlenecks_actionbottlenecksdata_constructor_args():
...
def test_hyp_actionbottlenecksdata_is_not_abstract():
    assert not inspect.isabstract(ActionBottlenecksData)


def test_hyp_actionbottlenecksdata_constructor_exists():
    assert callable(ActionBottlenecksData.__init__)


def test_hyp_actionbottlenecksdata_constructor_args():
    sig = inspect.signature(ActionBottlenecksData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_bottlenecks_analysis_network_is_not_abstract():
    assert not inspect.isabstract(bottlenecks_analysis_Network)


def test_hyp_bottlenecks_analysis_network_constructor_exists():
    assert callable(bottlenecks_analysis_Network.__init__)


def test_hyp_bottlenecks_analysis_network_constructor_args():
    sig = inspect.signature(bottlenecks_analysis_Network.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_trace_markovmodelactiondata_is_not_abstract():
    assert not inspect.isabstract(analysis_trace_MarkovModelActionData)


def test_hyp_analysis_trace_markovmodelactiondata_constructor_exists():
    assert callable(analysis_trace_MarkovModelActionData.__init__)


def test_hyp_analysis_trace_markovmodelactiondata_constructor_args():
...
def test_hyp_markovmodelactiondata_is_not_abstract():
    assert not inspect.isabstract(MarkovModelActionData)


def test_hyp_markovmodelactiondata_constructor_exists():
    assert callable(MarkovModelActionData.__init__)


def test_hyp_markovmodelactiondata_constructor_args():
    sig = inspect.signature(MarkovModelActionData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_trace_comparedaction_is_not_abstract():
    assert not inspect.isabstract(analysis_trace_ComparedAction)


def test_hyp_analysis_trace_comparedaction_constructor_exists():
    assert callable(analysis_trace_ComparedAction.__init__)


def test_hyp_analysis_trace_comparedaction_constructor_args():
...
def test_hyp_comparedaction_is_not_abstract():
    assert not inspect.isabstract(ComparedAction)


def test_hyp_comparedaction_constructor_exists():
    assert callable(ComparedAction.__init__)


def test_hyp_comparedaction_constructor_args():
    sig = inspect.signature(ComparedAction.__init__)
    params = list(sig.parameters.keys())



def test_hyp_bottlenecks_analysis_action_is_not_abstract():
    assert not inspect.isabstract(bottlenecks_analysis_Action)


def test_hyp_bottlenecks_analysis_action_constructor_exists():
    assert callable(bottlenecks_analysis_Action.__init__)


def test_hyp_bottlenecks_analysis_action_constructor_args():
    sig = inspect.signature(bottlenecks_analysis_Action.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_trace_comparedtrace_is_not_abstract():
    assert not inspect.isabstract(analysis_trace_ComparedTrace)


def test_hyp_analysis_trace_comparedtrace_constructor_exists():
    assert callable(analysis_trace_ComparedTrace.__init__)


def test_hyp_analysis_trace_comparedtrace_constructor_args():
...
def test_hyp_comparedtrace_is_not_abstract():
    assert not inspect.isabstract(ComparedTrace)


def test_hyp_comparedtrace_constructor_exists():
    assert callable(ComparedTrace.__init__)


def test_hyp_comparedtrace_constructor_args():
    sig = inspect.signature(ComparedTrace.__init__)
    params = list(sig.parameters.keys())



def test_hyp_compressedtracereport_is_not_abstract():
    assert not inspect.isabstract(CompressedTraceReport)


def test_hyp_compressedtracereport_constructor_exists():
    assert callable(CompressedTraceReport.__init__)


def test_hyp_compressedtracereport_constructor_args():
    sig = inspect.signature(CompressedTraceReport.__init__)
    params = list(sig.parameters.keys())



def test_hyp_buffertolongmap_is_not_abstract():
    assert not inspect.isabstract(BufferToLongMap)


def test_hyp_buffertolongmap_constructor_exists():
    assert callable(BufferToLongMap.__init__)


def test_hyp_buffertolongmap_constructor_args():
    sig = inspect.signature(BufferToLongMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_porttolongmap_is_not_abstract():
    assert not inspect.isabstract(PortToLongMap)


def test_hyp_porttolongmap_constructor_exists():
    assert callable(PortToLongMap.__init__)


def test_hyp_porttolongmap_constructor_args():
    sig = inspect.signature(PortToLongMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_variabletolongmap_is_not_abstract():
    assert not inspect.isabstract(VariableToLongMap)


def test_hyp_variabletolongmap_constructor_exists():
    assert callable(VariableToLongMap.__init__)


def test_hyp_variabletolongmap_constructor_args():
    sig = inspect.signature(VariableToLongMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_guardtolongmap_is_not_abstract():
    assert not inspect.isabstract(GuardToLongMap)


def test_hyp_guardtolongmap_constructor_exists():
    assert callable(GuardToLongMap.__init__)


def test_hyp_guardtolongmap_constructor_args():
    sig = inspect.signature(GuardToLongMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_trace_compresseddependency_is_not_abstract():
    assert not inspect.isabstract(analysis_trace_CompressedDependency)


def test_hyp_analysis_trace_compresseddependency_constructor_exists():
    assert callable(analysis_trace_CompressedDependency.__init__)


def test_hyp_analysis_trace_compresseddependency_constructor_args():
...
def test_hyp_trace_analysis_action_is_not_abstract():
    assert not inspect.isabstract(trace_analysis_Action)


def test_hyp_trace_analysis_action_constructor_exists():
    assert callable(trace_analysis_Action.__init__)


def test_hyp_trace_analysis_action_constructor_args():
    sig = inspect.signature(trace_analysis_Action.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_trace_compressedstep_is_not_abstract():
    assert not inspect.isabstract(analysis_trace_CompressedStep)


def test_hyp_analysis_trace_compressedstep_constructor_exists():
    assert callable(analysis_trace_CompressedStep.__init__)


def test_hyp_analysis_trace_compressedstep_constructor_args():
...
def test_hyp_compresseddependency_is_not_abstract():
    assert not inspect.isabstract(CompressedDependency)


def test_hyp_compresseddependency_constructor_exists():
    assert callable(CompressedDependency.__init__)


def test_hyp_compresseddependency_constructor_args():
    sig = inspect.signature(CompressedDependency.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_trace_compressedvariabledependency_is_not_abstract():
    assert not inspect.isabstract(analysis_trace_CompressedVariableDependency)


def test_hyp_analysis_trace_compressedvariabledependency_constructor_exists():
    assert callable(analysis_trace_CompressedVariableDependency.__init__)


def test_hyp_analysis_trace_compressedvariabledependency_constructor_args():
    sig = inspect.signature(analysis_trace_CompressedVariableDependency.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_trace_compressedfsmdependency_is_not_abstract():
    assert not inspect.isabstract(analysis_trace_CompressedFsmDependency)


def test_hyp_analysis_trace_compressedfsmdependency_constructor_exists():
    assert callable(analysis_trace_CompressedFsmDependency.__init__)


def test_hyp_analysis_trace_compressedfsmdependency_constructor_args():
    sig = inspect.signature(analysis_trace_CompressedFsmDependency.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_trace_compressedtokensdependency_is_not_abstract():
    assert not inspect.isabstract(analysis_trace_CompressedTokensDependency)


def test_hyp_analysis_trace_compressedtokensdependency_constructor_exists():
    assert callable(analysis_trace_CompressedTokensDependency.__init__)


def test_hyp_analysis_trace_compressedtokensdependency_constructor_args():
    sig = inspect.signature(analysis_trace_CompressedTokensDependency.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_trace_compressedportdependency_is_not_abstract():
    assert not inspect.isabstract(analysis_trace_CompressedPortDependency)


def test_hyp_analysis_trace_compressedportdependency_constructor_exists():
    assert callable(analysis_trace_CompressedPortDependency.__init__)


def test_hyp_analysis_trace_compressedportdependency_constructor_args():
    sig = inspect.signature(analysis_trace_CompressedPortDependency.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_trace_compressedguarddependency_is_not_abstract():
    assert not inspect.isabstract(analysis_trace_CompressedGuardDependency)


def test_hyp_analysis_trace_compressedguarddependency_constructor_exists():
    assert callable(analysis_trace_CompressedGuardDependency.__init__)


def test_hyp_analysis_trace_compressedguarddependency_constructor_args():
    sig = inspect.signature(analysis_trace_CompressedGuardDependency.__init__)
    params = list(sig.parameters.keys())



def test_hyp_compressedstep_is_not_abstract():
    assert not inspect.isabstract(CompressedStep)


def test_hyp_compressedstep_constructor_exists():
    assert callable(CompressedStep.__init__)


def test_hyp_compressedstep_constructor_args():
    sig = inspect.signature(CompressedStep.__init__)
    params = list(sig.parameters.keys())



def test_hyp_trace_analysis_network_is_not_abstract():
    assert not inspect.isabstract(trace_analysis_Network)


def test_hyp_trace_analysis_network_constructor_exists():
    assert callable(trace_analysis_Network.__init__)


def test_hyp_trace_analysis_network_constructor_args():
    sig = inspect.signature(trace_analysis_Network.__init__)
    params = list(sig.parameters.keys())



def test_hyp_stringtolongmap_is_not_abstract():
    assert not inspect.isabstract(StringToLongMap)


def test_hyp_stringtolongmap_constructor_exists():
    assert callable(StringToLongMap.__init__)


def test_hyp_stringtolongmap_constructor_args():
    sig = inspect.signature(StringToLongMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_map_actiontodoublemap_is_not_abstract():
    assert not inspect.isabstract(analysis_map_ActionToDoubleMap)


def test_hyp_analysis_map_actiontodoublemap_constructor_exists():
    assert callable(analysis_map_ActionToDoubleMap.__init__)


def test_hyp_analysis_map_actiontodoublemap_constructor_args():
...
def test_hyp_actortolongmap_is_not_abstract():
    assert not inspect.isabstract(ActorToLongMap)


def test_hyp_actortolongmap_constructor_exists():
    assert callable(ActorToLongMap.__init__)


def test_hyp_actortolongmap_constructor_args():
    sig = inspect.signature(ActorToLongMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_map_stringtostringmap_is_not_abstract():
    assert not inspect.isabstract(analysis_map_StringToStringMap)


def test_hyp_analysis_map_stringtostringmap_constructor_exists():
    assert callable(analysis_map_StringToStringMap.__init__)


def test_hyp_analysis_map_stringtostringmap_constructor_args():
...
def test_hyp_actorselectionschedule_is_not_abstract():
    assert not inspect.isabstract(ActorSelectionSchedule)


def test_hyp_actorselectionschedule_constructor_exists():
    assert callable(ActorSelectionSchedule.__init__)


def test_hyp_actorselectionschedule_constructor_args():
    sig = inspect.signature(ActorSelectionSchedule.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_map_partitiontoactorselectionschedulemap_is_not_abstract():
    assert not inspect.isabstract(analysis_map_PartitionToActorSelectionScheduleMap)


def test_hyp_analysis_map_partitiontoactorselectionschedulemap_constructor_exists():
    assert callable(analysis_map_PartitionToActorSelectionScheduleMap.__init__)


def test_hyp_analysis_map_partitiontoactorselectionschedulemap_constructor_args():
...
def test_hyp_analysis_map_buffertodoublemap_is_not_abstract():
    assert not inspect.isabstract(analysis_map_BufferToDoubleMap)


def test_hyp_analysis_map_buffertodoublemap_constructor_exists():
    assert callable(analysis_map_BufferToDoubleMap.__init__)


def test_hyp_analysis_map_buffertodoublemap_constructor_args():
...
def test_hyp_analysis_map_buffertointegermap_is_not_abstract():
    assert not inspect.isabstract(analysis_map_BufferToIntegerMap)


def test_hyp_analysis_map_buffertointegermap_constructor_exists():
    assert callable(analysis_map_BufferToIntegerMap.__init__)


def test_hyp_analysis_map_buffertointegermap_constructor_args():
...
def test_hyp_map_analysis_procedure_is_not_abstract():
    assert not inspect.isabstract(map_analysis_Procedure)


def test_hyp_map_analysis_procedure_constructor_exists():
    assert callable(map_analysis_Procedure.__init__)


def test_hyp_map_analysis_procedure_constructor_args():
    sig = inspect.signature(map_analysis_Procedure.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_map_stringtodoublemap_is_not_abstract():
    assert not inspect.isabstract(analysis_map_StringToDoubleMap)


def test_hyp_analysis_map_stringtodoublemap_constructor_exists():
    assert callable(analysis_map_StringToDoubleMap.__init__)


def test_hyp_analysis_map_stringtodoublemap_constructor_args():
...
def test_hyp_map_analysis_port_is_not_abstract():
    assert not inspect.isabstract(map_analysis_Port)


def test_hyp_map_analysis_port_constructor_exists():
    assert callable(map_analysis_Port.__init__)


def test_hyp_map_analysis_port_constructor_args():
    sig = inspect.signature(map_analysis_Port.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_map_porttolongmap_is_not_abstract():
    assert not inspect.isabstract(analysis_map_PortToLongMap)


def test_hyp_analysis_map_porttolongmap_constructor_exists():
    assert callable(analysis_map_PortToLongMap.__init__)


def test_hyp_analysis_map_porttolongmap_constructor_args():
...
def test_hyp_map_analysis_guard_is_not_abstract():
    assert not inspect.isabstract(map_analysis_Guard)


def test_hyp_map_analysis_guard_constructor_exists():
    assert callable(map_analysis_Guard.__init__)


def test_hyp_map_analysis_guard_constructor_args():
    sig = inspect.signature(map_analysis_Guard.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_map_guardtolongmap_is_not_abstract():
    assert not inspect.isabstract(analysis_map_GuardToLongMap)


def test_hyp_analysis_map_guardtolongmap_constructor_exists():
    assert callable(analysis_map_GuardToLongMap.__init__)


def test_hyp_analysis_map_guardtolongmap_constructor_args():
...
def test_hyp_analysis_map_variabletolongmap_is_not_abstract():
    assert not inspect.isabstract(analysis_map_VariableToLongMap)


def test_hyp_analysis_map_variabletolongmap_constructor_exists():
    assert callable(analysis_map_VariableToLongMap.__init__)


def test_hyp_analysis_map_variabletolongmap_constructor_args():
...
def test_hyp_analysis_map_doubletodoublemap_is_not_abstract():
    assert not inspect.isabstract(analysis_map_DoubleToDoubleMap)


def test_hyp_analysis_map_doubletodoublemap_constructor_exists():
    assert callable(analysis_map_DoubleToDoubleMap.__init__)


def test_hyp_analysis_map_doubletodoublemap_constructor_args():
...
def test_hyp_analysis_map_stringtolongmap_is_not_abstract():
    assert not inspect.isabstract(analysis_map_StringToLongMap)


def test_hyp_analysis_map_stringtolongmap_constructor_exists():
    assert callable(analysis_map_StringToLongMap.__init__)


def test_hyp_analysis_map_stringtolongmap_constructor_args():
...
def test_hyp_analysis_map_buffertolongmap_is_not_abstract():
    assert not inspect.isabstract(analysis_map_BufferToLongMap)


def test_hyp_analysis_map_buffertolongmap_constructor_exists():
    assert callable(analysis_map_BufferToLongMap.__init__)


def test_hyp_analysis_map_buffertolongmap_constructor_args():
...
def test_hyp_analysis_map_actortolongmap_is_not_abstract():
    assert not inspect.isabstract(analysis_map_ActorToLongMap)


def test_hyp_analysis_map_actortolongmap_constructor_exists():
    assert callable(analysis_map_ActorToLongMap.__init__)


def test_hyp_analysis_map_actortolongmap_constructor_args():
...
def test_hyp_analysis_map_actiontolongmap_is_not_abstract():
    assert not inspect.isabstract(analysis_map_ActionToLongMap)


def test_hyp_analysis_map_actiontolongmap_constructor_exists():
    assert callable(analysis_map_ActionToLongMap.__init__)


def test_hyp_analysis_map_actiontolongmap_constructor_args():
...
def test_hyp_analysis_map_eoperatortostatisticaldatamap_is_not_abstract():
    assert not inspect.isabstract(analysis_map_EOperatorToStatisticalDataMap)


def test_hyp_analysis_map_eoperatortostatisticaldatamap_constructor_exists():
    assert callable(analysis_map_EOperatorToStatisticalDataMap.__init__)


def test_hyp_analysis_map_eoperatortostatisticaldatamap_constructor_args():
...
def test_hyp_map_analysis_actorclass_is_not_abstract():
    assert not inspect.isabstract(map_analysis_ActorClass)


def test_hyp_map_analysis_actorclass_constructor_exists():
    assert callable(map_analysis_ActorClass.__init__)


def test_hyp_map_analysis_actorclass_constructor_args():
    sig = inspect.signature(map_analysis_ActorClass.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_map_actorclasstostatisticaldatamap_is_not_abstract():
    assert not inspect.isabstract(analysis_map_ActorClassToStatisticalDataMap)


def test_hyp_analysis_map_actorclasstostatisticaldatamap_constructor_exists():
    assert callable(analysis_map_ActorClassToStatisticalDataMap.__init__)


def test_hyp_analysis_map_actorclasstostatisticaldatamap_constructor_args():
    sig = inspect.signature(analysis_map_ActorClassToStatisticalDataMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_map_analysis_variable_is_not_abstract():
    assert not inspect.isabstract(map_analysis_Variable)


def test_hyp_map_analysis_variable_constructor_exists():
    assert callable(map_analysis_Variable.__init__)


def test_hyp_map_analysis_variable_constructor_args():
    sig = inspect.signature(map_analysis_Variable.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_map_variabletostatisticaldatamap_is_not_abstract():
    assert not inspect.isabstract(analysis_map_VariableToStatisticalDataMap)


def test_hyp_analysis_map_variabletostatisticaldatamap_constructor_exists():
    assert callable(analysis_map_VariableToStatisticalDataMap.__init__)


def test_hyp_analysis_map_variabletostatisticaldatamap_constructor_args():
    sig = inspect.signature(analysis_map_VariableToStatisticalDataMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_map_proceduretostatisticaldatamap_is_not_abstract():
    assert not inspect.isabstract(analysis_map_ProcedureToStatisticalDataMap)


def test_hyp_analysis_map_proceduretostatisticaldatamap_constructor_exists():
    assert callable(analysis_map_ProcedureToStatisticalDataMap.__init__)


def test_hyp_analysis_map_proceduretostatisticaldatamap_constructor_args():
    sig = inspect.signature(analysis_map_ProcedureToStatisticalDataMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_map_analysis_buffer_is_not_abstract():
    assert not inspect.isabstract(map_analysis_Buffer)


def test_hyp_map_analysis_buffer_constructor_exists():
    assert callable(map_analysis_Buffer.__init__)


def test_hyp_map_analysis_buffer_constructor_args():
    sig = inspect.signature(map_analysis_Buffer.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_map_buffertostatisticaldatamap_is_not_abstract():
    assert not inspect.isabstract(analysis_map_BufferToStatisticalDataMap)


def test_hyp_analysis_map_buffertostatisticaldatamap_constructor_exists():
    assert callable(analysis_map_BufferToStatisticalDataMap.__init__)


def test_hyp_analysis_map_buffertostatisticaldatamap_constructor_args():
    sig = inspect.signature(analysis_map_BufferToStatisticalDataMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_map_analysis_action_is_not_abstract():
    assert not inspect.isabstract(map_analysis_Action)


def test_hyp_map_analysis_action_constructor_exists():
    assert callable(map_analysis_Action.__init__)


def test_hyp_map_analysis_action_constructor_args():
    sig = inspect.signature(map_analysis_Action.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_map_actiontostatisticaldatamap_is_not_abstract():
    assert not inspect.isabstract(analysis_map_ActionToStatisticalDataMap)


def test_hyp_analysis_map_actiontostatisticaldatamap_constructor_exists():
    assert callable(analysis_map_ActionToStatisticalDataMap.__init__)


def test_hyp_analysis_map_actiontostatisticaldatamap_constructor_args():
    sig = inspect.signature(analysis_map_ActionToStatisticalDataMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_map_analysis_statisticaldata_is_not_abstract():
    assert not inspect.isabstract(map_analysis_StatisticalData)


def test_hyp_map_analysis_statisticaldata_constructor_exists():
    assert callable(map_analysis_StatisticalData.__init__)


def test_hyp_map_analysis_statisticaldata_constructor_args():
    sig = inspect.signature(map_analysis_StatisticalData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_map_analysis_actor_is_not_abstract():
    assert not inspect.isabstract(map_analysis_Actor)


def test_hyp_map_analysis_actor_constructor_exists():
    assert callable(map_analysis_Actor.__init__)


def test_hyp_map_analysis_actor_constructor_args():
    sig = inspect.signature(map_analysis_Actor.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_map_actortostatisticaldatamap_is_not_abstract():
    assert not inspect.isabstract(analysis_map_ActorToStatisticalDataMap)


def test_hyp_analysis_map_actortostatisticaldatamap_constructor_exists():
    assert callable(analysis_map_ActorToStatisticalDataMap.__init__)


def test_hyp_analysis_map_actortostatisticaldatamap_constructor_args():
    sig = inspect.signature(analysis_map_ActorToStatisticalDataMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_map_stringtointegermap_is_not_abstract():
    assert not inspect.isabstract(analysis_map_StringToIntegerMap)


def test_hyp_analysis_map_stringtointegermap_constructor_exists():
    assert callable(analysis_map_StringToIntegerMap.__init__)


def test_hyp_analysis_map_stringtointegermap_constructor_args():
...
def test_hyp_analysis_profiler_tablerow_is_not_abstract():
    assert not inspect.isabstract(analysis_profiler_TableRow)


def test_hyp_analysis_profiler_tablerow_constructor_exists():
    assert callable(analysis_profiler_TableRow.__init__)


def test_hyp_analysis_profiler_tablerow_constructor_args():
    sig = inspect.signature(analysis_profiler_TableRow.__init__)
    params = list(sig.parameters.keys())



def test_hyp_tablerow_is_not_abstract():
    assert not inspect.isabstract(TableRow)


def test_hyp_tablerow_constructor_exists():
    assert callable(TableRow.__init__)


def test_hyp_tablerow_constructor_args():
    sig = inspect.signature(TableRow.__init__)
    params = list(sig.parameters.keys())



def test_hyp_accessdata_is_not_abstract():
    assert not inspect.isabstract(AccessData)


def test_hyp_accessdata_constructor_exists():
    assert callable(AccessData.__init__)


def test_hyp_accessdata_constructor_args():
    sig = inspect.signature(AccessData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_profiler_stringtoaccessdatamap_is_not_abstract():
    assert not inspect.isabstract(analysis_profiler_StringToAccessDataMap)


def test_hyp_analysis_profiler_stringtoaccessdatamap_constructor_exists():
    assert callable(analysis_profiler_StringToAccessDataMap.__init__)


def test_hyp_analysis_profiler_stringtoaccessdatamap_constructor_args():
...
def test_hyp_analysis_profiler_accessdata_is_not_abstract():
    assert not inspect.isabstract(analysis_profiler_AccessData)


def test_hyp_analysis_profiler_accessdata_constructor_exists():
    assert callable(analysis_profiler_AccessData.__init__)


def test_hyp_analysis_profiler_accessdata_constructor_args():
...
def test_hyp_profiler_analysis_procedure_is_not_abstract():
    assert not inspect.isabstract(profiler_analysis_Procedure)


def test_hyp_profiler_analysis_procedure_constructor_exists():
    assert callable(profiler_analysis_Procedure.__init__)


def test_hyp_profiler_analysis_procedure_constructor_args():
    sig = inspect.signature(profiler_analysis_Procedure.__init__)
    params = list(sig.parameters.keys())



def test_hyp_stringtoaccessdatamap_is_not_abstract():
    assert not inspect.isabstract(StringToAccessDataMap)


def test_hyp_stringtoaccessdatamap_constructor_exists():
    assert callable(StringToAccessDataMap.__init__)


def test_hyp_stringtoaccessdatamap_constructor_args():
    sig = inspect.signature(StringToAccessDataMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_profiler_memoryaccessdata_is_not_abstract():
    assert not inspect.isabstract(analysis_profiler_MemoryAccessData)


def test_hyp_analysis_profiler_memoryaccessdata_constructor_exists():
    assert callable(analysis_profiler_MemoryAccessData.__init__)


def test_hyp_analysis_profiler_memoryaccessdata_constructor_args():
    sig = inspect.signature(analysis_profiler_MemoryAccessData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_memoryaccessdata_is_not_abstract():
    assert not inspect.isabstract(MemoryAccessData)


def test_hyp_memoryaccessdata_constructor_exists():
    assert callable(MemoryAccessData.__init__)


def test_hyp_memoryaccessdata_constructor_args():
    sig = inspect.signature(MemoryAccessData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_profiler_statevariableaccessdata_is_not_abstract():
    assert not inspect.isabstract(analysis_profiler_StateVariableAccessData)


def test_hyp_analysis_profiler_statevariableaccessdata_constructor_exists():
    assert callable(analysis_profiler_StateVariableAccessData.__init__)


def test_hyp_analysis_profiler_statevariableaccessdata_constructor_args():
...
def test_hyp_analysis_profiler_localvariableaccessdata_is_not_abstract():
    assert not inspect.isabstract(analysis_profiler_LocalVariableAccessData)


def test_hyp_analysis_profiler_localvariableaccessdata_constructor_exists():
    assert callable(analysis_profiler_LocalVariableAccessData.__init__)


def test_hyp_analysis_profiler_localvariableaccessdata_constructor_args():
...
def test_hyp_analysis_profiler_sharedvariableaccessdata_is_not_abstract():
    assert not inspect.isabstract(analysis_profiler_SharedVariableAccessData)


def test_hyp_analysis_profiler_sharedvariableaccessdata_constructor_exists():
    assert callable(analysis_profiler_SharedVariableAccessData.__init__)


def test_hyp_analysis_profiler_sharedvariableaccessdata_constructor_args():
...
def test_hyp_analysis_profiler_bufferaccessdata_is_not_abstract():
    assert not inspect.isabstract(analysis_profiler_BufferAccessData)


def test_hyp_analysis_profiler_bufferaccessdata_constructor_exists():
    assert callable(analysis_profiler_BufferAccessData.__init__)


def test_hyp_analysis_profiler_bufferaccessdata_constructor_args():
...
def test_hyp_analysis_profiler_actionmemoryprofilingdata_is_not_abstract():
    assert not inspect.isabstract(analysis_profiler_ActionMemoryProfilingData)


def test_hyp_analysis_profiler_actionmemoryprofilingdata_constructor_exists():
    assert callable(analysis_profiler_ActionMemoryProfilingData.__init__)


def test_hyp_analysis_profiler_actionmemoryprofilingdata_constructor_args():
...
def test_hyp_actionmemoryprofilingdata_is_not_abstract():
    assert not inspect.isabstract(ActionMemoryProfilingData)


def test_hyp_actionmemoryprofilingdata_constructor_exists():
    assert callable(ActionMemoryProfilingData.__init__)


def test_hyp_actionmemoryprofilingdata_constructor_args():
    sig = inspect.signature(ActionMemoryProfilingData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_actiondynamicdata_is_not_abstract():
    assert not inspect.isabstract(ActionDynamicData)


def test_hyp_actiondynamicdata_constructor_exists():
    assert callable(ActionDynamicData.__init__)


def test_hyp_actiondynamicdata_constructor_args():
    sig = inspect.signature(ActionDynamicData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_profiler_proceduretocomplexdynamicdatamap_is_not_abstract():
    assert not inspect.isabstract(analysis_profiler_ProcedureToComplexDynamicDataMap)


def test_hyp_analysis_profiler_proceduretocomplexdynamicdatamap_constructor_exists():
    assert callable(analysis_profiler_ProcedureToComplexDynamicDataMap.__init__)


def test_hyp_analysis_profiler_proceduretocomplexdynamicdatamap_constructor_args():
    sig = inspect.signature(analysis_profiler_ProcedureToComplexDynamicDataMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_buffertostatisticaldatamap_is_not_abstract():
    assert not inspect.isabstract(BufferToStatisticalDataMap)


def test_hyp_buffertostatisticaldatamap_constructor_exists():
    assert callable(BufferToStatisticalDataMap.__init__)


def test_hyp_buffertostatisticaldatamap_constructor_args():
    sig = inspect.signature(BufferToStatisticalDataMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_proceduretocomplexdynamicdatamap_is_not_abstract():
    assert not inspect.isabstract(ProcedureToComplexDynamicDataMap)


def test_hyp_proceduretocomplexdynamicdatamap_constructor_exists():
    assert callable(ProcedureToComplexDynamicDataMap.__init__)


def test_hyp_proceduretocomplexdynamicdatamap_constructor_args():
    sig = inspect.signature(ProcedureToComplexDynamicDataMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_variabletostatisticaldatamap_is_not_abstract():
    assert not inspect.isabstract(VariableToStatisticalDataMap)


def test_hyp_variabletostatisticaldatamap_constructor_exists():
    assert callable(VariableToStatisticalDataMap.__init__)


def test_hyp_variabletostatisticaldatamap_constructor_args():
    sig = inspect.signature(VariableToStatisticalDataMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_proceduretostatisticaldatamap_is_not_abstract():
    assert not inspect.isabstract(ProcedureToStatisticalDataMap)


def test_hyp_proceduretostatisticaldatamap_constructor_exists():
    assert callable(ProcedureToStatisticalDataMap.__init__)


def test_hyp_proceduretostatisticaldatamap_constructor_args():
    sig = inspect.signature(ProcedureToStatisticalDataMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_eoperatortostatisticaldatamap_is_not_abstract():
    assert not inspect.isabstract(EOperatorToStatisticalDataMap)


def test_hyp_eoperatortostatisticaldatamap_constructor_exists():
    assert callable(EOperatorToStatisticalDataMap.__init__)


def test_hyp_eoperatortostatisticaldatamap_constructor_args():
    sig = inspect.signature(EOperatorToStatisticalDataMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_profiler_complexdynamicdata_is_not_abstract():
    assert not inspect.isabstract(analysis_profiler_ComplexDynamicData)


def test_hyp_analysis_profiler_complexdynamicdata_constructor_exists():
    assert callable(analysis_profiler_ComplexDynamicData.__init__)


def test_hyp_analysis_profiler_complexdynamicdata_constructor_args():
    sig = inspect.signature(analysis_profiler_ComplexDynamicData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_actiontolongmap_is_not_abstract():
    assert not inspect.isabstract(ActionToLongMap)


def test_hyp_actiontolongmap_constructor_exists():
    assert callable(ActionToLongMap.__init__)


def test_hyp_actiontolongmap_constructor_args():
    sig = inspect.signature(ActionToLongMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_actiontostatisticaldatamap_is_not_abstract():
    assert not inspect.isabstract(ActionToStatisticalDataMap)


def test_hyp_actiontostatisticaldatamap_constructor_exists():
    assert callable(ActionToStatisticalDataMap.__init__)


def test_hyp_actiontostatisticaldatamap_constructor_args():
    sig = inspect.signature(ActionToStatisticalDataMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_profiler_analysis_statisticaldata_is_not_abstract():
    assert not inspect.isabstract(profiler_analysis_StatisticalData)


def test_hyp_profiler_analysis_statisticaldata_constructor_exists():
    assert callable(profiler_analysis_StatisticalData.__init__)


def test_hyp_profiler_analysis_statisticaldata_constructor_args():
    sig = inspect.signature(profiler_analysis_StatisticalData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_profiler_analysis_buffer_is_not_abstract():
    assert not inspect.isabstract(profiler_analysis_Buffer)


def test_hyp_profiler_analysis_buffer_constructor_exists():
    assert callable(profiler_analysis_Buffer.__init__)


def test_hyp_profiler_analysis_buffer_constructor_args():
    sig = inspect.signature(profiler_analysis_Buffer.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_profiler_bufferdynamicdata_is_not_abstract():
    assert not inspect.isabstract(analysis_profiler_BufferDynamicData)


def test_hyp_analysis_profiler_bufferdynamicdata_constructor_exists():
    assert callable(analysis_profiler_BufferDynamicData.__init__)


def test_hyp_analysis_profiler_bufferdynamicdata_constructor_args():
...
def test_hyp_profiler_analysis_action_is_not_abstract():
    assert not inspect.isabstract(profiler_analysis_Action)


def test_hyp_profiler_analysis_action_constructor_exists():
    assert callable(profiler_analysis_Action.__init__)


def test_hyp_profiler_analysis_action_constructor_args():
    sig = inspect.signature(profiler_analysis_Action.__init__)
    params = list(sig.parameters.keys())



def test_hyp_profiler_analysis_actor_is_not_abstract():
    assert not inspect.isabstract(profiler_analysis_Actor)


def test_hyp_profiler_analysis_actor_constructor_exists():
    assert callable(profiler_analysis_Actor.__init__)


def test_hyp_profiler_analysis_actor_constructor_args():
    sig = inspect.signature(profiler_analysis_Actor.__init__)
    params = list(sig.parameters.keys())



def test_hyp_complexdynamicdata_is_not_abstract():
    assert not inspect.isabstract(ComplexDynamicData)


def test_hyp_complexdynamicdata_constructor_exists():
    assert callable(ComplexDynamicData.__init__)


def test_hyp_complexdynamicdata_constructor_args():
    sig = inspect.signature(ComplexDynamicData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_profiler_actiondynamicdata_is_not_abstract():
    assert not inspect.isabstract(analysis_profiler_ActionDynamicData)


def test_hyp_analysis_profiler_actiondynamicdata_constructor_exists():
    assert callable(analysis_profiler_ActionDynamicData.__init__)


def test_hyp_analysis_profiler_actiondynamicdata_constructor_args():
    sig = inspect.signature(analysis_profiler_ActionDynamicData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_profiler_actordynamicdata_is_not_abstract():
    assert not inspect.isabstract(analysis_profiler_ActorDynamicData)


def test_hyp_analysis_profiler_actordynamicdata_constructor_exists():
    assert callable(analysis_profiler_ActorDynamicData.__init__)


def test_hyp_analysis_profiler_actordynamicdata_constructor_args():
    sig = inspect.signature(analysis_profiler_ActorDynamicData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_bufferdynamicdata_is_not_abstract():
    assert not inspect.isabstract(BufferDynamicData)


def test_hyp_bufferdynamicdata_constructor_exists():
    assert callable(BufferDynamicData.__init__)


def test_hyp_bufferdynamicdata_constructor_args():
    sig = inspect.signature(BufferDynamicData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_actordynamicdata_is_not_abstract():
    assert not inspect.isabstract(ActorDynamicData)


def test_hyp_actordynamicdata_constructor_exists():
    assert callable(ActorDynamicData.__init__)


def test_hyp_actordynamicdata_constructor_args():
    sig = inspect.signature(ActorDynamicData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_codedata_is_not_abstract():
    assert not inspect.isabstract(CodeData)


def test_hyp_codedata_constructor_exists():
    assert callable(CodeData.__init__)


def test_hyp_codedata_constructor_args():
    sig = inspect.signature(CodeData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_profiler_complexcodedata_is_not_abstract():
    assert not inspect.isabstract(analysis_profiler_ComplexCodeData)


def test_hyp_analysis_profiler_complexcodedata_constructor_exists():
    assert callable(analysis_profiler_ComplexCodeData.__init__)


def test_hyp_analysis_profiler_complexcodedata_constructor_args():
    sig = inspect.signature(analysis_profiler_ComplexCodeData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_stringtointegermap_is_not_abstract():
    assert not inspect.isabstract(StringToIntegerMap)


def test_hyp_stringtointegermap_constructor_exists():
    assert callable(StringToIntegerMap.__init__)


def test_hyp_stringtointegermap_constructor_args():
    sig = inspect.signature(StringToIntegerMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_profiler_codedata_is_not_abstract():
    assert not inspect.isabstract(analysis_profiler_CodeData)


def test_hyp_analysis_profiler_codedata_constructor_exists():
    assert callable(analysis_profiler_CodeData.__init__)


def test_hyp_analysis_profiler_codedata_constructor_args():
...
def test_hyp_complexcodedata_is_not_abstract():
    assert not inspect.isabstract(ComplexCodeData)


def test_hyp_complexcodedata_constructor_exists():
    assert callable(ComplexCodeData.__init__)


def test_hyp_complexcodedata_constructor_args():
    sig = inspect.signature(ComplexCodeData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_profiler_analysis_network_is_not_abstract():
    assert not inspect.isabstract(profiler_analysis_Network)


def test_hyp_profiler_analysis_network_constructor_exists():
    assert callable(profiler_analysis_Network.__init__)


def test_hyp_profiler_analysis_network_constructor_args():
    sig = inspect.signature(profiler_analysis_Network.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysisreport_is_not_abstract():
    assert not inspect.isabstract(AnalysisReport)


def test_hyp_analysisreport_constructor_exists():
    assert callable(AnalysisReport.__init__)


def test_hyp_analysisreport_constructor_args():
    sig = inspect.signature(AnalysisReport.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_profiler_memoryprofilingreport_is_not_abstract():
    assert not inspect.isabstract(analysis_profiler_MemoryProfilingReport)


def test_hyp_analysis_profiler_memoryprofilingreport_constructor_exists():
    assert callable(analysis_profiler_MemoryProfilingReport.__init__)


def test_hyp_analysis_profiler_memoryprofilingreport_constructor_args():
...
def test_hyp_analysis_partitioning_comcostpartitioningreport_is_not_abstract():
    assert not inspect.isabstract(analysis_partitioning_ComCostPartitioningReport)


def test_hyp_analysis_partitioning_comcostpartitioningreport_constructor_exists():
    assert callable(analysis_partitioning_ComCostPartitioningReport.__init__)


def test_hyp_analysis_partitioning_comcostpartitioningreport_constructor_args():
...
def test_hyp_analysis_trace_tracesizereport_is_not_abstract():
    assert not inspect.isabstract(analysis_trace_TraceSizeReport)


def test_hyp_analysis_trace_tracesizereport_constructor_exists():
    assert callable(analysis_trace_TraceSizeReport.__init__)


def test_hyp_analysis_trace_tracesizereport_constructor_args():
...
def test_hyp_analysis_bottlenecks_scheduledimpactanalysisreport_is_not_abstract():
    assert not inspect.isabstract(analysis_bottlenecks_ScheduledImpactAnalysisReport)


def test_hyp_analysis_bottlenecks_scheduledimpactanalysisreport_constructor_exists():
    assert callable(analysis_bottlenecks_ScheduledImpactAnalysisReport.__init__)


def test_hyp_analysis_bottlenecks_scheduledimpactanalysisreport_constructor_args():
...
def test_hyp_analysis_pipelining_impactanalysisreport_is_not_abstract():
    assert not inspect.isabstract(analysis_pipelining_ImpactAnalysisReport)


def test_hyp_analysis_pipelining_impactanalysisreport_constructor_exists():
    assert callable(analysis_pipelining_ImpactAnalysisReport.__init__)


def test_hyp_analysis_pipelining_impactanalysisreport_constructor_args():
    sig = inspect.signature(analysis_pipelining_ImpactAnalysisReport.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_buffers_optimalbuffersreport_is_not_abstract():
    assert not inspect.isabstract(analysis_buffers_OptimalBuffersReport)


def test_hyp_analysis_buffers_optimalbuffersreport_constructor_exists():
    assert callable(analysis_buffers_OptimalBuffersReport.__init__)


def test_hyp_analysis_buffers_optimalbuffersreport_constructor_args():
...
def test_hyp_analysis_profiler_benchmarkreport_is_not_abstract():
    assert not inspect.isabstract(analysis_profiler_BenchmarkReport)


def test_hyp_analysis_profiler_benchmarkreport_constructor_exists():
    assert callable(analysis_profiler_BenchmarkReport.__init__)


def test_hyp_analysis_profiler_benchmarkreport_constructor_args():
...
def test_hyp_analysis_profiler_dynamicprofilingreport_is_not_abstract():
    assert not inspect.isabstract(analysis_profiler_DynamicProfilingReport)


def test_hyp_analysis_profiler_dynamicprofilingreport_constructor_exists():
    assert callable(analysis_profiler_DynamicProfilingReport.__init__)


def test_hyp_analysis_profiler_dynamicprofilingreport_constructor_args():
    sig = inspect.signature(analysis_profiler_DynamicProfilingReport.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_trace_tracecomparatorreport_is_not_abstract():
    assert not inspect.isabstract(analysis_trace_TraceComparatorReport)


def test_hyp_analysis_trace_tracecomparatorreport_constructor_exists():
    assert callable(analysis_trace_TraceComparatorReport.__init__)


def test_hyp_analysis_trace_tracecomparatorreport_constructor_args():
    sig = inspect.signature(analysis_trace_TraceComparatorReport.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_bottlenecks_bottleneckswithschedulingreport_is_not_abstract():
    assert not inspect.isabstract(analysis_bottlenecks_BottlenecksWithSchedulingReport)


def test_hyp_analysis_bottlenecks_bottleneckswithschedulingreport_constructor_exists():
    assert callable(analysis_bottlenecks_BottlenecksWithSchedulingReport.__init__)


def test_hyp_analysis_bottlenecks_bottleneckswithschedulingreport_constructor_args():
...
def test_hyp_analysis_trace_compressedtracereport_is_not_abstract():
    assert not inspect.isabstract(analysis_trace_CompressedTraceReport)


def test_hyp_analysis_trace_compressedtracereport_constructor_exists():
    assert callable(analysis_trace_CompressedTraceReport.__init__)


def test_hyp_analysis_trace_compressedtracereport_constructor_args():
...
def test_hyp_analysis_pipelining_actionsvariablepipeliningreport_is_not_abstract():
    assert not inspect.isabstract(analysis_pipelining_ActionsVariablePipeliningReport)


def test_hyp_analysis_pipelining_actionsvariablepipeliningreport_constructor_exists():
    assert callable(analysis_pipelining_ActionsVariablePipeliningReport.__init__)


def test_hyp_analysis_pipelining_actionsvariablepipeliningreport_constructor_args():
    sig = inspect.signature(analysis_pipelining_ActionsVariablePipeliningReport.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_buffers_boundedbuffersreport_is_not_abstract():
    assert not inspect.isabstract(analysis_buffers_BoundedBuffersReport)


def test_hyp_analysis_buffers_boundedbuffersreport_constructor_exists():
    assert callable(analysis_buffers_BoundedBuffersReport.__init__)


def test_hyp_analysis_buffers_boundedbuffersreport_constructor_args():
...
def test_hyp_analysis_partitioning_workloadbalancepartitioningreport_is_not_abstract():
    assert not inspect.isabstract(analysis_partitioning_WorkloadBalancePartitioningReport)


def test_hyp_analysis_partitioning_workloadbalancepartitioningreport_constructor_exists():
    assert callable(analysis_partitioning_WorkloadBalancePartitioningReport.__init__)


def test_hyp_analysis_partitioning_workloadbalancepartitioningreport_constructor_args():
    sig = inspect.signature(analysis_partitioning_WorkloadBalancePartitioningReport.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_bottlenecks_bottlenecksreport_is_not_abstract():
    assert not inspect.isabstract(analysis_bottlenecks_BottlenecksReport)


def test_hyp_analysis_bottlenecks_bottlenecksreport_constructor_exists():
    assert callable(analysis_bottlenecks_BottlenecksReport.__init__)


def test_hyp_analysis_bottlenecks_bottlenecksreport_constructor_args():
...
def test_hyp_analysis_trace_markowmodeltracereport_is_not_abstract():
    assert not inspect.isabstract(analysis_trace_MarkowModelTraceReport)


def test_hyp_analysis_trace_markowmodeltracereport_constructor_exists():
    assert callable(analysis_trace_MarkowModelTraceReport.__init__)


def test_hyp_analysis_trace_markowmodeltracereport_constructor_args():
    sig = inspect.signature(analysis_trace_MarkowModelTraceReport.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_bottlenecks_impactanalysisreport_is_not_abstract():
    assert not inspect.isabstract(analysis_bottlenecks_ImpactAnalysisReport)


def test_hyp_analysis_bottlenecks_impactanalysisreport_constructor_exists():
    assert callable(analysis_bottlenecks_ImpactAnalysisReport.__init__)


def test_hyp_analysis_bottlenecks_impactanalysisreport_constructor_args():
...
def test_hyp_analysis_partitioning_balancedpipelinepartitioningreport_is_not_abstract():
    assert not inspect.isabstract(analysis_partitioning_BalancedPipelinePartitioningReport)


def test_hyp_analysis_partitioning_balancedpipelinepartitioningreport_constructor_exists():
    assert callable(analysis_partitioning_BalancedPipelinePartitioningReport.__init__)


def test_hyp_analysis_partitioning_balancedpipelinepartitioningreport_constructor_args():
    sig = inspect.signature(analysis_partitioning_BalancedPipelinePartitioningReport.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_profiler_codeprofilingreport_is_not_abstract():
    assert not inspect.isabstract(analysis_profiler_CodeProfilingReport)


def test_hyp_analysis_profiler_codeprofilingreport_constructor_exists():
    assert callable(analysis_profiler_CodeProfilingReport.__init__)


def test_hyp_analysis_profiler_codeprofilingreport_constructor_args():
    sig = inspect.signature(analysis_profiler_CodeProfilingReport.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_analysisreport_is_not_abstract():
    assert not inspect.isabstract(analysis_AnalysisReport)


def test_hyp_analysis_analysisreport_constructor_exists():
    assert callable(analysis_AnalysisReport.__init__)


def test_hyp_analysis_analysisreport_constructor_args():
...
def test_hyp_analysis_scheduling_markovschedulingtransition_is_not_abstract():
    assert not inspect.isabstract(analysis_scheduling_MarkovSchedulingTransition)


def test_hyp_analysis_scheduling_markovschedulingtransition_constructor_exists():
    assert callable(analysis_scheduling_MarkovSchedulingTransition.__init__)


def test_hyp_analysis_scheduling_markovschedulingtransition_constructor_args():
...
def test_hyp_analysis_caseoptimal_caseoptimalactorselectionschedule_is_not_abstract():
    assert not inspect.isabstract(analysis_caseoptimal_CaseOptimalActorSelectionSchedule)


def test_hyp_analysis_caseoptimal_caseoptimalactorselectionschedule_constructor_exists():
    assert callable(analysis_caseoptimal_CaseOptimalActorSelectionSchedule.__init__)


def test_hyp_analysis_caseoptimal_caseoptimalactorselectionschedule_constructor_args():
    sig = inspect.signature(analysis_caseoptimal_CaseOptimalActorSelectionSchedule.__init__)
    params = list(sig.parameters.keys())



def test_hyp_partitiontoactorselectionschedulemap_is_not_abstract():
    assert not inspect.isabstract(PartitionToActorSelectionScheduleMap)


def test_hyp_partitiontoactorselectionschedulemap_constructor_exists():
    assert callable(PartitionToActorSelectionScheduleMap.__init__)


def test_hyp_partitiontoactorselectionschedulemap_constructor_args():
    sig = inspect.signature(PartitionToActorSelectionScheduleMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_caseoptimal_caseoptimalschedulereport_is_not_abstract():
    assert not inspect.isabstract(analysis_caseoptimal_CaseOptimalScheduleReport)


def test_hyp_analysis_caseoptimal_caseoptimalschedulereport_constructor_exists():
    assert callable(analysis_caseoptimal_CaseOptimalScheduleReport.__init__)


def test_hyp_analysis_caseoptimal_caseoptimalschedulereport_constructor_args():
...
def test_hyp_analysis_scheduling_markovschedulingstate_is_not_abstract():
    assert not inspect.isabstract(analysis_scheduling_MarkovSchedulingState)


def test_hyp_analysis_scheduling_markovschedulingstate_constructor_exists():
    assert callable(analysis_scheduling_MarkovSchedulingState.__init__)


def test_hyp_analysis_scheduling_markovschedulingstate_constructor_args():
...
def test_hyp_markovschedulingtransition_is_not_abstract():
    assert not inspect.isabstract(MarkovSchedulingTransition)


def test_hyp_markovschedulingtransition_constructor_exists():
    assert callable(MarkovSchedulingTransition.__init__)


def test_hyp_markovschedulingtransition_constructor_args():
    sig = inspect.signature(MarkovSchedulingTransition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_markovschedulingstate_is_not_abstract():
    assert not inspect.isabstract(MarkovSchedulingState)


def test_hyp_markovschedulingstate_constructor_exists():
    assert callable(MarkovSchedulingState.__init__)


def test_hyp_markovschedulingstate_constructor_args():
    sig = inspect.signature(MarkovSchedulingState.__init__)
    params = list(sig.parameters.keys())



def test_hyp_scheduling_analysis_actor_is_not_abstract():
    assert not inspect.isabstract(scheduling_analysis_Actor)


def test_hyp_scheduling_analysis_actor_constructor_exists():
    assert callable(scheduling_analysis_Actor.__init__)


def test_hyp_scheduling_analysis_actor_constructor_args():
    sig = inspect.signature(scheduling_analysis_Actor.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_scheduling_markovpartitionscheduler_is_not_abstract():
    assert not inspect.isabstract(analysis_scheduling_MarkovPartitionScheduler)


def test_hyp_analysis_scheduling_markovpartitionscheduler_constructor_exists():
    assert callable(analysis_scheduling_MarkovPartitionScheduler.__init__)


def test_hyp_analysis_scheduling_markovpartitionscheduler_constructor_args():
...
def test_hyp_scheduling_analysis_network_is_not_abstract():
    assert not inspect.isabstract(scheduling_analysis_Network)


def test_hyp_scheduling_analysis_network_constructor_exists():
    assert callable(scheduling_analysis_Network.__init__)


def test_hyp_scheduling_analysis_network_constructor_args():
    sig = inspect.signature(scheduling_analysis_Network.__init__)
    params = list(sig.parameters.keys())



def test_hyp_markovpartitionscheduler_is_not_abstract():
    assert not inspect.isabstract(MarkovPartitionScheduler)


def test_hyp_markovpartitionscheduler_constructor_exists():
    assert callable(MarkovPartitionScheduler.__init__)


def test_hyp_markovpartitionscheduler_constructor_args():
    sig = inspect.signature(MarkovPartitionScheduler.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_scheduling_markovsimpleschedulerreport_is_not_abstract():
    assert not inspect.isabstract(analysis_scheduling_MarkovSimpleSchedulerReport)


def test_hyp_analysis_scheduling_markovsimpleschedulerreport_constructor_exists():
    assert callable(analysis_scheduling_MarkovSimpleSchedulerReport.__init__)


def test_hyp_analysis_scheduling_markovsimpleschedulerreport_constructor_args():
    sig = inspect.signature(analysis_scheduling_MarkovSimpleSchedulerReport.__init__)
    params = list(sig.parameters.keys())



def test_hyp_fsmcombination_is_not_abstract():
    assert not inspect.isabstract(FSMCombination)


def test_hyp_fsmcombination_constructor_exists():
    assert callable(FSMCombination.__init__)


def test_hyp_fsmcombination_constructor_args():
    sig = inspect.signature(FSMCombination.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_scheduling_fsmcondition_is_not_abstract():
    assert not inspect.isabstract(analysis_scheduling_FSMCondition)


def test_hyp_analysis_scheduling_fsmcondition_constructor_exists():
    assert callable(analysis_scheduling_FSMCondition.__init__)


def test_hyp_analysis_scheduling_fsmcondition_constructor_args():
...
def test_hyp_analysis_scheduling_fsmcombination_is_not_abstract():
    assert not inspect.isabstract(analysis_scheduling_FSMCombination)


def test_hyp_analysis_scheduling_fsmcombination_constructor_exists():
    assert callable(analysis_scheduling_FSMCombination.__init__)


def test_hyp_analysis_scheduling_fsmcombination_constructor_args():
...
def test_hyp_fsmvar_is_not_abstract():
    assert not inspect.isabstract(FSMVar)


def test_hyp_fsmvar_constructor_exists():
    assert callable(FSMVar.__init__)


def test_hyp_fsmvar_constructor_args():
    sig = inspect.signature(FSMVar.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_scheduling_fsmoperation_is_not_abstract():
    assert not inspect.isabstract(analysis_scheduling_FSMOperation)


def test_hyp_analysis_scheduling_fsmoperation_constructor_exists():
    assert callable(analysis_scheduling_FSMOperation.__init__)


def test_hyp_analysis_scheduling_fsmoperation_constructor_args():
...
def test_hyp_fsmoperation_is_not_abstract():
    assert not inspect.isabstract(FSMOperation)


def test_hyp_fsmoperation_constructor_exists():
    assert callable(FSMOperation.__init__)


def test_hyp_fsmoperation_constructor_args():
    sig = inspect.signature(FSMOperation.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_scheduling_fsmvarupdate_is_not_abstract():
    assert not inspect.isabstract(analysis_scheduling_FSMVarUpdate)


def test_hyp_analysis_scheduling_fsmvarupdate_constructor_exists():
    assert callable(analysis_scheduling_FSMVarUpdate.__init__)


def test_hyp_analysis_scheduling_fsmvarupdate_constructor_args():
    sig = inspect.signature(analysis_scheduling_FSMVarUpdate.__init__)
    params = list(sig.parameters.keys())



def test_hyp_fsmtransition_is_not_abstract():
    assert not inspect.isabstract(FSMTransition)


def test_hyp_fsmtransition_constructor_exists():
    assert callable(FSMTransition.__init__)


def test_hyp_fsmtransition_constructor_args():
    sig = inspect.signature(FSMTransition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_scheduling_fsmtransitionwithstate_is_not_abstract():
    assert not inspect.isabstract(analysis_scheduling_FSMTransitionWithState)


def test_hyp_analysis_scheduling_fsmtransitionwithstate_constructor_exists():
    assert callable(analysis_scheduling_FSMTransitionWithState.__init__)


def test_hyp_analysis_scheduling_fsmtransitionwithstate_constructor_args():
    sig = inspect.signature(analysis_scheduling_FSMTransitionWithState.__init__)
    params = list(sig.parameters.keys())



def test_hyp_fsmvarupdate_is_not_abstract():
    assert not inspect.isabstract(FSMVarUpdate)


def test_hyp_fsmvarupdate_constructor_exists():
    assert callable(FSMVarUpdate.__init__)


def test_hyp_fsmvarupdate_constructor_args():
    sig = inspect.signature(FSMVarUpdate.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_scheduling_fsmstate_is_not_abstract():
    assert not inspect.isabstract(analysis_scheduling_FSMState)


def test_hyp_analysis_scheduling_fsmstate_constructor_exists():
    assert callable(analysis_scheduling_FSMState.__init__)


def test_hyp_analysis_scheduling_fsmstate_constructor_args():
...
def test_hyp_fsmcondition_is_not_abstract():
    assert not inspect.isabstract(FSMCondition)


def test_hyp_fsmcondition_constructor_exists():
    assert callable(FSMCondition.__init__)


def test_hyp_fsmcondition_constructor_args():
    sig = inspect.signature(FSMCondition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_scheduling_fsmtransition_is_not_abstract():
    assert not inspect.isabstract(analysis_scheduling_FSMTransition)


def test_hyp_analysis_scheduling_fsmtransition_constructor_exists():
    assert callable(analysis_scheduling_FSMTransition.__init__)


def test_hyp_analysis_scheduling_fsmtransition_constructor_args():
...
def test_hyp_analysis_scheduling_fsmvar_is_not_abstract():
    assert not inspect.isabstract(analysis_scheduling_FSMVar)


def test_hyp_analysis_scheduling_fsmvar_constructor_exists():
    assert callable(analysis_scheduling_FSMVar.__init__)


def test_hyp_analysis_scheduling_fsmvar_constructor_args():
...
def test_hyp_actorfire_is_not_abstract():
    assert not inspect.isabstract(ActorFire)


def test_hyp_actorfire_constructor_exists():
    assert callable(ActorFire.__init__)


def test_hyp_actorfire_constructor_args():
    sig = inspect.signature(ActorFire.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_scheduling_partitionedactorfire_is_not_abstract():
    assert not inspect.isabstract(analysis_scheduling_PartitionedActorFire)


def test_hyp_analysis_scheduling_partitionedactorfire_constructor_exists():
    assert callable(analysis_scheduling_PartitionedActorFire.__init__)


def test_hyp_analysis_scheduling_partitionedactorfire_constructor_args():
    sig = inspect.signature(analysis_scheduling_PartitionedActorFire.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_scheduling_sequence_is_not_abstract():
    assert not inspect.isabstract(analysis_scheduling_Sequence)


def test_hyp_analysis_scheduling_sequence_constructor_exists():
    assert callable(analysis_scheduling_Sequence.__init__)


def test_hyp_analysis_scheduling_sequence_constructor_args():
    sig = inspect.signature(analysis_scheduling_Sequence.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_scheduling_actorselectionschedule_is_not_abstract():
    assert not inspect.isabstract(analysis_scheduling_ActorSelectionSchedule)


def test_hyp_analysis_scheduling_actorselectionschedule_constructor_exists():
    assert callable(analysis_scheduling_ActorSelectionSchedule.__init__)


def test_hyp_analysis_scheduling_actorselectionschedule_constructor_args():
    sig = inspect.signature(analysis_scheduling_ActorSelectionSchedule.__init__)
    params = list(sig.parameters.keys())



def test_hyp_profiling_analysis_actor_is_not_abstract():
    assert not inspect.isabstract(profiling_analysis_Actor)


def test_hyp_profiling_analysis_actor_constructor_exists():
    assert callable(profiling_analysis_Actor.__init__)


def test_hyp_profiling_analysis_actor_constructor_args():
    sig = inspect.signature(profiling_analysis_Actor.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_profiling_intraactorcommunicationdata_is_not_abstract():
    assert not inspect.isabstract(analysis_profiling_IntraActorCommunicationData)


def test_hyp_analysis_profiling_intraactorcommunicationdata_constructor_exists():
    assert callable(analysis_profiling_IntraActorCommunicationData.__init__)


def test_hyp_analysis_profiling_intraactorcommunicationdata_constructor_args():
    sig = inspect.signature(analysis_profiling_IntraActorCommunicationData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_fsmstate_is_not_abstract():
    assert not inspect.isabstract(FSMState)


def test_hyp_fsmstate_constructor_exists():
    assert callable(FSMState.__init__)


def test_hyp_fsmstate_constructor_args():
    sig = inspect.signature(FSMState.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_scheduling_fsm_is_not_abstract():
    assert not inspect.isabstract(analysis_scheduling_FSM)


def test_hyp_analysis_scheduling_fsm_constructor_exists():
    assert callable(analysis_scheduling_FSM.__init__)


def test_hyp_analysis_scheduling_fsm_constructor_args():
...
def test_hyp_analysis_scheduling_actorfire_is_not_abstract():
    assert not inspect.isabstract(analysis_scheduling_ActorFire)


def test_hyp_analysis_scheduling_actorfire_constructor_exists():
    assert callable(analysis_scheduling_ActorFire.__init__)


def test_hyp_analysis_scheduling_actorfire_constructor_args():
...
def test_hyp_analysis_profiling_profilingstatsactordata_is_not_abstract():
    assert not inspect.isabstract(analysis_profiling_ProfilingStatsActorData)


def test_hyp_analysis_profiling_profilingstatsactordata_constructor_exists():
    assert callable(analysis_profiling_ProfilingStatsActorData.__init__)


def test_hyp_analysis_profiling_profilingstatsactordata_constructor_args():
...
def test_hyp_profilingstatsactordata_is_not_abstract():
    assert not inspect.isabstract(ProfilingStatsActorData)


def test_hyp_profilingstatsactordata_constructor_exists():
    assert callable(ProfilingStatsActorData.__init__)


def test_hyp_profilingstatsactordata_constructor_args():
    sig = inspect.signature(ProfilingStatsActorData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_profiling_profilingstatsreport_is_not_abstract():
    assert not inspect.isabstract(analysis_profiling_ProfilingStatsReport)


def test_hyp_analysis_profiling_profilingstatsreport_constructor_exists():
    assert callable(analysis_profiling_ProfilingStatsReport.__init__)


def test_hyp_analysis_profiling_profilingstatsreport_constructor_args():
...
def test_hyp_profiling_analysis_action_is_not_abstract():
    assert not inspect.isabstract(profiling_analysis_Action)


def test_hyp_profiling_analysis_action_constructor_exists():
    assert callable(profiling_analysis_Action.__init__)


def test_hyp_profiling_analysis_action_constructor_args():
    sig = inspect.signature(profiling_analysis_Action.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_profiling_intraactioncommunicationdata_is_not_abstract():
    assert not inspect.isabstract(analysis_profiling_IntraActionCommunicationData)


def test_hyp_analysis_profiling_intraactioncommunicationdata_constructor_exists():
    assert callable(analysis_profiling_IntraActionCommunicationData.__init__)


def test_hyp_analysis_profiling_intraactioncommunicationdata_constructor_args():
    sig = inspect.signature(analysis_profiling_IntraActionCommunicationData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_intraactioncommunicationdata_is_not_abstract():
    assert not inspect.isabstract(IntraActionCommunicationData)


def test_hyp_intraactioncommunicationdata_constructor_exists():
    assert callable(IntraActionCommunicationData.__init__)


def test_hyp_intraactioncommunicationdata_constructor_args():
    sig = inspect.signature(IntraActionCommunicationData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_profiling_analysis_statisticaldata_is_not_abstract():
    assert not inspect.isabstract(profiling_analysis_StatisticalData)


def test_hyp_profiling_analysis_statisticaldata_constructor_exists():
    assert callable(profiling_analysis_StatisticalData.__init__)


def test_hyp_profiling_analysis_statisticaldata_constructor_args():
    sig = inspect.signature(profiling_analysis_StatisticalData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_profiling_analysis_network_is_not_abstract():
    assert not inspect.isabstract(profiling_analysis_Network)


def test_hyp_profiling_analysis_network_constructor_exists():
    assert callable(profiling_analysis_Network.__init__)


def test_hyp_profiling_analysis_network_constructor_args():
    sig = inspect.signature(profiling_analysis_Network.__init__)
    params = list(sig.parameters.keys())



def test_hyp_intraactorcommunicationdata_is_not_abstract():
    assert not inspect.isabstract(IntraActorCommunicationData)


def test_hyp_intraactorcommunicationdata_constructor_exists():
    assert callable(IntraActorCommunicationData.__init__)


def test_hyp_intraactorcommunicationdata_constructor_args():
    sig = inspect.signature(IntraActorCommunicationData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_profiling_intraactioncommunicationreport_is_not_abstract():
    assert not inspect.isabstract(analysis_profiling_IntraActionCommunicationReport)


def test_hyp_analysis_profiling_intraactioncommunicationreport_constructor_exists():
    assert callable(analysis_profiling_IntraActionCommunicationReport.__init__)


def test_hyp_analysis_profiling_intraactioncommunicationreport_constructor_args():
    sig = inspect.signature(analysis_profiling_IntraActionCommunicationReport.__init__)
    params = list(sig.parameters.keys())



def test_hyp_actortostatisticaldatamap_is_not_abstract():
    assert not inspect.isabstract(ActorToStatisticalDataMap)


def test_hyp_actortostatisticaldatamap_constructor_exists():
    assert callable(ActorToStatisticalDataMap.__init__)


def test_hyp_actortostatisticaldatamap_constructor_args():
    sig = inspect.signature(ActorToStatisticalDataMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_postprocessing_analysis_statisticaldata_is_not_abstract():
    assert not inspect.isabstract(postprocessing_analysis_StatisticalData)


def test_hyp_postprocessing_analysis_statisticaldata_constructor_exists():
    assert callable(postprocessing_analysis_StatisticalData.__init__)


def test_hyp_postprocessing_analysis_statisticaldata_constructor_args():
    sig = inspect.signature(postprocessing_analysis_StatisticalData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_postprocessing_schedulercheckspartition_is_not_abstract():
    assert not inspect.isabstract(analysis_postprocessing_SchedulerChecksPartition)


def test_hyp_analysis_postprocessing_schedulercheckspartition_constructor_exists():
    assert callable(analysis_postprocessing_SchedulerChecksPartition.__init__)


def test_hyp_analysis_postprocessing_schedulercheckspartition_constructor_args():
    sig = inspect.signature(analysis_postprocessing_SchedulerChecksPartition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_schedulercheckspartition_is_not_abstract():
    assert not inspect.isabstract(SchedulerChecksPartition)


def test_hyp_schedulercheckspartition_constructor_exists():
    assert callable(SchedulerChecksPartition.__init__)


def test_hyp_schedulercheckspartition_constructor_args():
    sig = inspect.signature(SchedulerChecksPartition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_pipelining_analysis_actorclass_is_not_abstract():
    assert not inspect.isabstract(pipelining_analysis_ActorClass)


def test_hyp_pipelining_analysis_actorclass_constructor_exists():
    assert callable(pipelining_analysis_ActorClass.__init__)


def test_hyp_pipelining_analysis_actorclass_constructor_args():
    sig = inspect.signature(pipelining_analysis_ActorClass.__init__)
    params = list(sig.parameters.keys())



def test_hyp_actiontodoublemap_is_not_abstract():
    assert not inspect.isabstract(ActionToDoubleMap)


def test_hyp_actiontodoublemap_constructor_exists():
    assert callable(ActionToDoubleMap.__init__)


def test_hyp_actiontodoublemap_constructor_args():
    sig = inspect.signature(ActionToDoubleMap.__init__)
    params = list(sig.parameters.keys())



def test_hyp_postprocessing_analysis_actor_is_not_abstract():
    assert not inspect.isabstract(postprocessing_analysis_Actor)


def test_hyp_postprocessing_analysis_actor_constructor_exists():
    assert callable(postprocessing_analysis_Actor.__init__)


def test_hyp_postprocessing_analysis_actor_constructor_args():
    sig = inspect.signature(postprocessing_analysis_Actor.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_postprocessing_statisticalactorpartition_is_not_abstract():
    assert not inspect.isabstract(analysis_postprocessing_StatisticalActorPartition)


def test_hyp_analysis_postprocessing_statisticalactorpartition_constructor_exists():
    assert callable(analysis_postprocessing_StatisticalActorPartition.__init__)


def test_hyp_analysis_postprocessing_statisticalactorpartition_constructor_args():
...
def test_hyp_statisticalactorpartition_is_not_abstract():
    assert not inspect.isabstract(StatisticalActorPartition)


def test_hyp_statisticalactorpartition_constructor_exists():
    assert callable(StatisticalActorPartition.__init__)


def test_hyp_statisticalactorpartition_constructor_args():
    sig = inspect.signature(StatisticalActorPartition.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_postprocessing_postprocessingdata_is_not_abstract():
    assert not inspect.isabstract(analysis_postprocessing_PostProcessingData)


def test_hyp_analysis_postprocessing_postprocessingdata_constructor_exists():
    assert callable(analysis_postprocessing_PostProcessingData.__init__)


def test_hyp_analysis_postprocessing_postprocessingdata_constructor_args():
    sig = inspect.signature(analysis_postprocessing_PostProcessingData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_postprocessingdata_is_not_abstract():
    assert not inspect.isabstract(PostProcessingData)


def test_hyp_postprocessingdata_constructor_exists():
    assert callable(PostProcessingData.__init__)


def test_hyp_postprocessingdata_constructor_args():
    sig = inspect.signature(PostProcessingData.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_postprocessing_actorstatisticsreport_is_not_abstract():
    assert not inspect.isabstract(analysis_postprocessing_ActorStatisticsReport)


def test_hyp_analysis_postprocessing_actorstatisticsreport_constructor_exists():
    assert callable(analysis_postprocessing_ActorStatisticsReport.__init__)


def test_hyp_analysis_postprocessing_actorstatisticsreport_constructor_args():
...
def test_hyp_analysis_postprocessing_bufferblockingreport_is_not_abstract():
    assert not inspect.isabstract(analysis_postprocessing_BufferBlockingReport)


def test_hyp_analysis_postprocessing_bufferblockingreport_constructor_exists():
    assert callable(analysis_postprocessing_BufferBlockingReport.__init__)


def test_hyp_analysis_postprocessing_bufferblockingreport_constructor_args():
    sig = inspect.signature(analysis_postprocessing_BufferBlockingReport.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_postprocessing_actionstatisticsreport_is_not_abstract():
    assert not inspect.isabstract(analysis_postprocessing_ActionStatisticsReport)


def test_hyp_analysis_postprocessing_actionstatisticsreport_constructor_exists():
    assert callable(analysis_postprocessing_ActionStatisticsReport.__init__)


def test_hyp_analysis_postprocessing_actionstatisticsreport_constructor_args():
    sig = inspect.signature(analysis_postprocessing_ActionStatisticsReport.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_postprocessing_schedulerchecksreport_is_not_abstract():
    assert not inspect.isabstract(analysis_postprocessing_SchedulerChecksReport)


def test_hyp_analysis_postprocessing_schedulerchecksreport_constructor_exists():
    assert callable(analysis_postprocessing_SchedulerChecksReport.__init__)


def test_hyp_analysis_postprocessing_schedulerchecksreport_constructor_args():
    sig = inspect.signature(analysis_postprocessing_SchedulerChecksReport.__init__)
    params = list(sig.parameters.keys())



def test_hyp_postprocessing_analysis_network_is_not_abstract():
    assert not inspect.isabstract(postprocessing_analysis_Network)


def test_hyp_postprocessing_analysis_network_constructor_exists():
    assert callable(postprocessing_analysis_Network.__init__)


def test_hyp_postprocessing_analysis_network_constructor_args():
    sig = inspect.signature(postprocessing_analysis_Network.__init__)
    params = list(sig.parameters.keys())



def test_hyp_analysis_postprocessing_postprocessingreport_is_not_abstract():
    assert not inspect.isabstract(analysis_postprocessing_PostProcessingReport)


def test_hyp_analysis_postprocessing_postprocessingreport_constructor_exists():
    assert callable(analysis_postprocessing_PostProcessingReport.__init__)


def test_hyp_analysis_postprocessing_postprocessingreport_constructor_args():
...
def test_hyp_fsmop_exists():
    # Check that the Enumeration exists
    assert FSMOp is not None

def test_hyp_fsmop_has_all_literals():
...
def test_hyp_fsmcombinator_exists():
    # Check that the Enumeration exists
    assert FSMCombinator is not None

def test_hyp_fsmcombinator_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_optimizer_exists():
    # Check that the Enumeration exists
    assert Optimizer is not None

def test_hyp_optimizer_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_fsmcomparator_exists():
    # Check that the Enumeration exists
    assert FSMComparator is not None

def test_hyp_fsmcomparator_has_all_literals():
    # Collect the names of literals in this Enumeration
...
def test_hyp_analysis_pipelining_impactanalysisdata_cpReduction_setter(instance):
...
def test_hyp_analysis_pipelining_actionvariablepipeliningdata_pipelinable_setter(instance):
...
def test_hyp_analysis_partitioning_comcostpartition_internalCost_setter(instance):
...
@given(instance=analysis_partitioning_ComCostPartition_strategy)
def test_hyp_analysis_partitioning_comcostpartition_externalCost_setter(instance):
...
def test_hyp_analysis_partitioning_balancedpipelinepartition_workload_setter(instance):
...
@given(instance=analysis_partitioning_BalancedPipelinePartition_strategy)
def test_hyp_analysis_partitioning_balancedpipelinepartition_commonPredAvg_setter(instance):
...
@given(instance=analysis_partitioning_BalancedPipelinePartition_strategy)
def test_hyp_analysis_partitioning_balancedpipelinepartition_preWorkload_setter(instance):
...
def test_hyp_analysis_partitioning_workloadbalancepartition_workload_setter(instance):
    original = instance.workload
    instance.workload = original
    assert instance.workload == original
...
def test_hyp_analysis_buffers_boundedbufferdata_bitSize_setter(instance):
...
@given(instance=analysis_buffers_BoundedBufferData_strategy)
def test_hyp_analysis_buffers_boundedbufferdata_tokenSize_setter(instance):
...
def test_hyp_analysis_bottlenecks_doubletobottleneckswithschedulingreportmap_key_setter(instance):
...
def test_hyp_analysis_bottlenecks_actionbottleneckswithschedulingdata_totalWeight_setter(instance):
...
@given(instance=analysis_bottlenecks_ActionBottlenecksWithSchedulingData_strategy)
def test_hyp_analysis_bottlenecks_actionbottleneckswithschedulingdata_cpFirings_setter(instance):
...
@given(instance=analysis_bottlenecks_ActionBottlenecksWithSchedulingData_strategy)
def test_hyp_analysis_bottlenecks_actionbottleneckswithschedulingdata_cpWeight_setter(instance):
...
@given(instance=analysis_bottlenecks_ActionBottlenecksWithSchedulingData_strategy)
def test_hyp_analysis_bottlenecks_actionbottleneckswithschedulingdata_totalFirings_setter(instance):
...
def test_hyp_analysis_bottlenecks_doubletobottlenecksreportmap_key_setter(instance):
    original = instance.key
    instance.key = original
    assert instance.key == original
...
def test_hyp_analysis_bottlenecks_actionbottlenecksdata_totalVariance_setter(instance):
...
@given(instance=analysis_bottlenecks_ActionBottlenecksData_strategy)
def test_hyp_analysis_bottlenecks_actionbottlenecksdata_totalFirings_setter(instance):
    original = instance.totalFirings
    instance.totalFirings = original
    assert instance.totalFirings == original
...
@given(instance=analysis_bottlenecks_ActionBottlenecksData_strategy)
def test_hyp_analysis_bottlenecks_actionbottlenecksdata_totalWeight_setter(instance):
    original = instance.totalWeight
    instance.totalWeight = original
    assert instance.totalWeight == original
...
@given(instance=analysis_bottlenecks_ActionBottlenecksData_strategy)
def test_hyp_analysis_bottlenecks_actionbottlenecksdata_slackMin_setter(instance):
...
@given(instance=analysis_bottlenecks_ActionBottlenecksData_strategy)
def test_hyp_analysis_bottlenecks_actionbottlenecksdata_cpVariance_setter(instance):
...
@given(instance=analysis_bottlenecks_ActionBottlenecksData_strategy)
def test_hyp_analysis_bottlenecks_actionbottlenecksdata_cpWeight_setter(instance):
    original = instance.cpWeight
    instance.cpWeight = original
    assert instance.cpWeight == original
...
@given(instance=analysis_bottlenecks_ActionBottlenecksData_strategy)
def test_hyp_analysis_bottlenecks_actionbottlenecksdata_cpFirings_setter(instance):
    original = instance.cpFirings
    instance.cpFirings = original
    assert instance.cpFirings == original
...
@given(instance=analysis_bottlenecks_ActionBottlenecksData_strategy)
def test_hyp_analysis_bottlenecks_actionbottlenecksdata_slackMax_setter(instance):
...
def test_hyp_analysis_trace_markovmodelactiondata_successors_setter(instance):
...
@given(instance=analysis_trace_MarkovModelActionData_strategy)
def test_hyp_analysis_trace_markovmodelactiondata_first_setter(instance):
...
def test_hyp_analysis_trace_comparedaction_found_setter(instance):
...
@given(instance=analysis_trace_ComparedAction_strategy)
def test_hyp_analysis_trace_comparedaction_dIncomings_setter(instance):
...
@given(instance=analysis_trace_ComparedAction_strategy)
def test_hyp_analysis_trace_comparedaction_dOutgoings_setter(instance):
...
@given(instance=analysis_trace_ComparedAction_strategy)
def test_hyp_analysis_trace_comparedaction_dSteps_setter(instance):
...
def test_hyp_analysis_trace_comparedtrace_dDependencies_setter(instance):
...
@given(instance=analysis_trace_ComparedTrace_strategy)
def test_hyp_analysis_trace_comparedtrace_dSteps_setter(instance):
    original = instance.dSteps
    instance.dSteps = original
    assert instance.dSteps == original
...
@given(instance=analysis_trace_ComparedTrace_strategy)
def test_hyp_analysis_trace_comparedtrace_equal_setter(instance):
...
def test_hyp_analysis_trace_compresseddependency_count_setter(instance):
...
def test_hyp_analysis_trace_compressedstep_count_setter(instance):
    original = instance.count
    instance.count = original
    assert instance.count == original
...
def test_hyp_analysis_map_actiontodoublemap_value_setter(instance):
...
def test_hyp_analysis_map_stringtostringmap_key_setter(instance):
    original = instance.key
    instance.key = original
    assert instance.key == original
...
@given(instance=analysis_map_StringToStringMap_strategy)
def test_hyp_analysis_map_stringtostringmap_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_analysis_map_partitiontoactorselectionschedulemap_key_setter(instance):
    original = instance.key
    instance.key = original
    assert instance.key == original
...
def test_hyp_analysis_map_buffertodoublemap_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_analysis_map_buffertointegermap_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_analysis_map_stringtodoublemap_key_setter(instance):
    original = instance.key
    instance.key = original
    assert instance.key == original
...
@given(instance=analysis_map_StringToDoubleMap_strategy)
def test_hyp_analysis_map_stringtodoublemap_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_analysis_map_porttolongmap_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_analysis_map_guardtolongmap_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_analysis_map_variabletolongmap_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_analysis_map_doubletodoublemap_key_setter(instance):
    original = instance.key
    instance.key = original
    assert instance.key == original
...
@given(instance=analysis_map_DoubleToDoubleMap_strategy)
def test_hyp_analysis_map_doubletodoublemap_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_analysis_map_stringtolongmap_key_setter(instance):
    original = instance.key
    instance.key = original
    assert instance.key == original
...
@given(instance=analysis_map_StringToLongMap_strategy)
def test_hyp_analysis_map_stringtolongmap_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_analysis_map_buffertolongmap_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_analysis_map_actortolongmap_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_analysis_map_actiontolongmap_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_analysis_map_eoperatortostatisticaldatamap_key_setter(instance):
    original = instance.key
    instance.key = original
    assert instance.key == original
...
def test_hyp_analysis_map_stringtointegermap_key_setter(instance):
    original = instance.key
    instance.key = original
    assert instance.key == original
...
@given(instance=analysis_map_StringToIntegerMap_strategy)
def test_hyp_analysis_map_stringtointegermap_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_analysis_profiler_stringtoaccessdatamap_key_setter(instance):
    original = instance.key
    instance.key = original
    assert instance.key == original
...
def test_hyp_analysis_profiler_accessdata_max_setter(instance):
...
@given(instance=analysis_profiler_AccessData_strategy)
def test_hyp_analysis_profiler_accessdata_average_setter(instance):
...
@given(instance=analysis_profiler_AccessData_strategy)
def test_hyp_analysis_profiler_accessdata_total_setter(instance):
...
@given(instance=analysis_profiler_AccessData_strategy)
def test_hyp_analysis_profiler_accessdata_min_setter(instance):
...
@given(instance=analysis_profiler_AccessData_strategy)
def test_hyp_analysis_profiler_accessdata_accesses_setter(instance):
...
def test_hyp_analysis_profiler_statevariableaccessdata_name_setter(instance):
...
def test_hyp_analysis_profiler_localvariableaccessdata_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_analysis_profiler_sharedvariableaccessdata_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_analysis_profiler_bufferaccessdata_targetActor_setter(instance):
...
@given(instance=analysis_profiler_BufferAccessData_strategy)
def test_hyp_analysis_profiler_bufferaccessdata_targetPort_setter(instance):
...
@given(instance=analysis_profiler_BufferAccessData_strategy)
def test_hyp_analysis_profiler_bufferaccessdata_sourceActor_setter(instance):
...
@given(instance=analysis_profiler_BufferAccessData_strategy)
def test_hyp_analysis_profiler_bufferaccessdata_sourcePort_setter(instance):
...
def test_hyp_analysis_profiler_actionmemoryprofilingdata_actor_setter(instance):
...
@given(instance=analysis_profiler_ActionMemoryProfilingData_strategy)
def test_hyp_analysis_profiler_actionmemoryprofilingdata_action_setter(instance):
...
def test_hyp_analysis_profiler_bufferdynamicdata_unconsumedTokens_setter(instance):
...
def test_hyp_analysis_profiler_codedata_blockName_setter(instance):
...
@given(instance=analysis_profiler_CodeData_strategy)
def test_hyp_analysis_profiler_codedata_nol_setter(instance):
...
def test_hyp_analysis_profiler_memoryprofilingreport_networkName_setter(instance):
...
def test_hyp_analysis_partitioning_comcostpartitioningreport_bitAccurate_setter(instance):
...
def test_hyp_analysis_trace_tracesizereport_firings_setter(instance):
...
@given(instance=analysis_trace_TraceSizeReport_strategy)
def test_hyp_analysis_trace_tracesizereport_dependencies_setter(instance):
...
def test_hyp_analysis_bottlenecks_scheduledimpactanalysisreport_classLevel_setter(instance):
...
def test_hyp_analysis_buffers_optimalbuffersreport_bitAccurate_setter(instance):
    original = instance.bitAccurate
    instance.bitAccurate = original
    assert instance.bitAccurate == original
...
@given(instance=analysis_buffers_OptimalBuffersReport_strategy)
def test_hyp_analysis_buffers_optimalbuffersreport_pow2_setter(instance):
...
def test_hyp_analysis_profiler_benchmarkreport_column_names_setter(instance):
...
def test_hyp_analysis_bottlenecks_bottleneckswithschedulingreport_totalFirings_setter(instance):
    original = instance.totalFirings
    instance.totalFirings = original
    assert instance.totalFirings == original
...
@given(instance=analysis_bottlenecks_BottlenecksWithSchedulingReport_strategy)
def test_hyp_analysis_bottlenecks_bottleneckswithschedulingreport_cpFirings_setter(instance):
    original = instance.cpFirings
    instance.cpFirings = original
    assert instance.cpFirings == original
...
@given(instance=analysis_bottlenecks_BottlenecksWithSchedulingReport_strategy)
def test_hyp_analysis_bottlenecks_bottleneckswithschedulingreport_cpWeight_setter(instance):
    original = instance.cpWeight
    instance.cpWeight = original
    assert instance.cpWeight == original
...
@given(instance=analysis_bottlenecks_BottlenecksWithSchedulingReport_strategy)
def test_hyp_analysis_bottlenecks_bottleneckswithschedulingreport_cpBlockingTime_setter(instance):
...
@given(instance=analysis_bottlenecks_BottlenecksWithSchedulingReport_strategy)
def test_hyp_analysis_bottlenecks_bottleneckswithschedulingreport_executionTime_setter(instance):
...
@given(instance=analysis_bottlenecks_BottlenecksWithSchedulingReport_strategy)
def test_hyp_analysis_bottlenecks_bottleneckswithschedulingreport_totalWeight_setter(instance):
    original = instance.totalWeight
    instance.totalWeight = original
    assert instance.totalWeight == original
...
def test_hyp_analysis_trace_compressedtracereport_traceFile_setter(instance):
...
def test_hyp_analysis_buffers_boundedbuffersreport_bitSize_setter(instance):
    original = instance.bitSize
    instance.bitSize = original
    assert instance.bitSize == original
...
@given(instance=analysis_buffers_BoundedBuffersReport_strategy)
def test_hyp_analysis_buffers_boundedbuffersreport_tokenSize_setter(instance):
    original = instance.tokenSize
    instance.tokenSize = original
    assert instance.tokenSize == original
...
@given(instance=analysis_buffers_BoundedBuffersReport_strategy)
def test_hyp_analysis_buffers_boundedbuffersreport_bitAccurate_setter(instance):
    original = instance.bitAccurate
    instance.bitAccurate = original
    assert instance.bitAccurate == original
...
@given(instance=analysis_buffers_BoundedBuffersReport_strategy)
def test_hyp_analysis_buffers_boundedbuffersreport_pow2_setter(instance):
    original = instance.pow2
    instance.pow2 = original
    assert instance.pow2 == original
...
def test_hyp_analysis_bottlenecks_bottlenecksreport_cpWeight_setter(instance):
    original = instance.cpWeight
    instance.cpWeight = original
    assert instance.cpWeight == original
...
@given(instance=analysis_bottlenecks_BottlenecksReport_strategy)
def test_hyp_analysis_bottlenecks_bottlenecksreport_cpFirings_setter(instance):
    original = instance.cpFirings
    instance.cpFirings = original
    assert instance.cpFirings == original
...
@given(instance=analysis_bottlenecks_BottlenecksReport_strategy)
def test_hyp_analysis_bottlenecks_bottlenecksreport_totalVariance_setter(instance):
    original = instance.totalVariance
    instance.totalVariance = original
    assert instance.totalVariance == original
...
@given(instance=analysis_bottlenecks_BottlenecksReport_strategy)
def test_hyp_analysis_bottlenecks_bottlenecksreport_totalFirings_setter(instance):
    original = instance.totalFirings
    instance.totalFirings = original
    assert instance.totalFirings == original
...
@given(instance=analysis_bottlenecks_BottlenecksReport_strategy)
def test_hyp_analysis_bottlenecks_bottlenecksreport_totalWeight_setter(instance):
    original = instance.totalWeight
    instance.totalWeight = original
    assert instance.totalWeight == original
...
@given(instance=analysis_bottlenecks_BottlenecksReport_strategy)
def test_hyp_analysis_bottlenecks_bottlenecksreport_cpVariance_setter(instance):
    original = instance.cpVariance
    instance.cpVariance = original
    assert instance.cpVariance == original
...
def test_hyp_analysis_bottlenecks_impactanalysisreport_classLevel_setter(instance):
    original = instance.classLevel
    instance.classLevel = original
    assert instance.classLevel == original
...
def test_hyp_analysis_analysisreport_date_setter(instance):
...
@given(instance=analysis_AnalysisReport_strategy)
def test_hyp_analysis_analysisreport_algorithm_setter(instance):
...
def test_hyp_analysis_scheduling_markovschedulingtransition_firings_setter(instance):
    original = instance.firings
    instance.firings = original
    assert instance.firings == original
...
@given(instance=analysis_scheduling_MarkovSchedulingTransition_strategy)
def test_hyp_analysis_scheduling_markovschedulingtransition_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_analysis_caseoptimal_caseoptimalschedulereport_partitionFilePath_setter(instance):
...
@given(instance=analysis_caseoptimal_CaseOptimalScheduleReport_strategy)
def test_hyp_analysis_caseoptimal_caseoptimalschedulereport_traceFile_setter(instance):
    original = instance.traceFile
    instance.traceFile = original
    assert instance.traceFile == original
...
@given(instance=analysis_caseoptimal_CaseOptimalScheduleReport_strategy)
def test_hyp_analysis_caseoptimal_caseoptimalschedulereport_pipeline_setter(instance):
...
def test_hyp_analysis_scheduling_markovschedulingstate_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=analysis_scheduling_MarkovSchedulingState_strategy)
def test_hyp_analysis_scheduling_markovschedulingstate_firings_setter(instance):
    original = instance.firings
    instance.firings = original
    assert instance.firings == original
...
def test_hyp_analysis_scheduling_markovpartitionscheduler_partitionId_setter(instance):
...
def test_hyp_analysis_scheduling_fsmcondition_valName_setter(instance):
...
@given(instance=analysis_scheduling_FSMCondition_strategy)
def test_hyp_analysis_scheduling_fsmcondition_compval_setter(instance):
...
@given(instance=analysis_scheduling_FSMCondition_strategy)
def test_hyp_analysis_scheduling_fsmcondition_comp_setter(instance):
...
def test_hyp_analysis_scheduling_fsmcombination_combinator_setter(instance):
...
def test_hyp_analysis_scheduling_fsmoperation_var_setter(instance):
...
@given(instance=analysis_scheduling_FSMOperation_strategy)
def test_hyp_analysis_scheduling_fsmoperation_op_setter(instance):
...
@given(instance=analysis_scheduling_FSMOperation_strategy)
def test_hyp_analysis_scheduling_fsmoperation_val_setter(instance):
...
def test_hyp_analysis_scheduling_fsmstate_enumName_setter(instance):
...
def test_hyp_analysis_scheduling_fsmtransition_sourceStateEnumName_setter(instance):
...
@given(instance=analysis_scheduling_FSMTransition_strategy)
def test_hyp_analysis_scheduling_fsmtransition_targetStateEnumName_setter(instance):
...
def test_hyp_analysis_scheduling_fsmvar_type_setter(instance):
...
@given(instance=analysis_scheduling_FSMVar_strategy)
def test_hyp_analysis_scheduling_fsmvar_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=analysis_scheduling_FSMVar_strategy)
def test_hyp_analysis_scheduling_fsmvar_initialVal_setter(instance):
...
def test_hyp_analysis_scheduling_fsm_startState_setter(instance):
...
@given(instance=analysis_scheduling_FSM_strategy)
def test_hyp_analysis_scheduling_fsm_terminalState_setter(instance):
...
def test_hyp_analysis_scheduling_actorfire_partition_setter(instance):
...
@given(instance=analysis_scheduling_ActorFire_strategy)
def test_hyp_analysis_scheduling_actorfire_Actor_setter(instance):
    original = instance.Actor
    instance.Actor = original
    assert instance.Actor == original
...
@given(instance=analysis_scheduling_ActorFire_strategy)
def test_hyp_analysis_scheduling_actorfire_dependencyPartitions_setter(instance):
...
@given(instance=analysis_scheduling_ActorFire_strategy)
def test_hyp_analysis_scheduling_actorfire_Times_setter(instance):
...
def test_hyp_analysis_profiling_profilingstatsactordata_actorName_setter(instance):
...
@given(instance=analysis_profiling_ProfilingStatsActorData_strategy)
def test_hyp_analysis_profiling_profilingstatsactordata_schedulerWeight_setter(instance):
...
@given(instance=analysis_profiling_ProfilingStatsActorData_strategy)
def test_hyp_analysis_profiling_profilingstatsactordata_actionsWeight_setter(instance):
...
@given(instance=analysis_profiling_ProfilingStatsActorData_strategy)
def test_hyp_analysis_profiling_profilingstatsactordata_actionsWeightPercent_setter(instance):
...
@given(instance=analysis_profiling_ProfilingStatsActorData_strategy)
def test_hyp_analysis_profiling_profilingstatsactordata_schedulerWeightPercent_setter(instance):
...
def test_hyp_analysis_profiling_profilingstatsreport_networkName_setter(instance):
    original = instance.networkName
    instance.networkName = original
    assert instance.networkName == original
...
def test_hyp_analysis_postprocessing_statisticalactorpartition_occupancy_setter(instance):
...
@given(instance=analysis_postprocessing_StatisticalActorPartition_strategy)
def test_hyp_analysis_postprocessing_statisticalactorpartition_schedulingPolicy_setter(instance):
...
@given(instance=analysis_postprocessing_StatisticalActorPartition_strategy)
def test_hyp_analysis_postprocessing_statisticalactorpartition_actors_setter(instance):
...
def test_hyp_analysis_postprocessing_actorstatisticsreport_averageOccupancy_setter(instance):
...
@given(instance=analysis_postprocessing_ActorStatisticsReport_strategy)
def test_hyp_analysis_postprocessing_actorstatisticsreport_executionTime_setter(instance):
    original = instance.executionTime
    instance.executionTime = original
    assert instance.executionTime == original
...
@given(instance=analysis_postprocessing_ActorStatisticsReport_strategy)
def test_hyp_analysis_postprocessing_actorstatisticsreport_occupancyDeviation_setter(instance):
...
def test_hyp_analysis_postprocessing_postprocessingreport_time_setter(instance):
...
@given(instance=analysis_postprocessing_PostProcessingReport_strategy)
def test_hyp_analysis_postprocessing_postprocessingreport_deadlock_setter(instance):
