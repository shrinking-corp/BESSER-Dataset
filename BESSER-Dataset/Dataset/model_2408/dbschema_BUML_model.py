...
# Classes
dbschema_NamedElement = Class(name="dbschema_NamedElement", is_abstract=True)
dbschema_AttributeColumn = Class(name="dbschema_AttributeColumn")
Column = Class(name="Column")
dbschema_ForeignKeyColumn = Class(name="dbschema_ForeignKeyColumn")
dbschema_DBSchema = Class(name="dbschema_DBSchema")
NamedElement = Class(name="NamedElement")
dbschema_Table = Class(name="dbschema_Table")
dbschema_Column = Class(name="dbschema_Column", is_abstract=True)
...
dbschema_Column.attributes={dbschema_Column_size, dbschema_Column_type, dbschema_Column_primary}
...
domain_model = DomainModel(
    name="dbschema",
    types={dbschema_NamedElement, dbschema_AttributeColumn, Column, dbschema_ForeignKeyColumn, dbschema_DBSchema, NamedElement, dbschema_Table, dbschema_Column, ColumnType},
    associations={referencedColumn3, tables0, columns1},
    generalizations={gen_dbschema_Column_NamedElement, gen_dbschema_AttributeColumn_Column, gen_dbschema_ForeignKeyColumn_Column, gen_dbschema_DBSchema_NamedElement, gen_dbschema_Table_NamedElement},
    metadata=None
)
