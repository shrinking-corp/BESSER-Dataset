...
class family_Person(EModelElement):
    ...
    def __init__(self, birthDay: int, birthMonth: str, birthYear: int, birthCity: str, firstName: str, lastName: str, family_Person: "family_Man" = None, family_Person9: "family_Woman" = None, family_Person13: "family_Person" = None, family_Person11: set["family_Person"] = None):
