...
Login.attributes={Login_username, Login_securityQuestion, Login_password, Login_securityAnswer, Login_lastLoginTime}
...
Admin_aId: Property = Property(name="aId", type=StringType)
Admin_aName: Property = Property(name="aName", type=StringType)
Admin.attributes={Admin_aId, Admin_aName}
...
domain_model = DomainModel(
    name="_69291368_126c_4a87_a756_2411f9b655f9",
    types={Customer, Login, transaction_Transaction, transaction_DepositTransaction, transaction_WithdrawTransaction, transaction_TransferTransaction, account_SavingsAccount, account_CertificatesOfDepositAccount, account_CheckingAccount, account_Account, Admin, transaction_TransactionType, account_AccountType},
