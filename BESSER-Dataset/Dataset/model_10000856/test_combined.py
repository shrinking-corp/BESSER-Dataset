...
def test_hyp_admin_aId_setter(instance):
...
@given(instance=Admin_strategy)
def test_hyp_admin_aName_setter(instance):
...
def test_Admin_aId_value_roundtrip():
    instance = Admin(aId="sample_text", aName="sample_text")
    assert instance.aId == "sample_text"
    instance.aId = "sample_text_2"
    assert instance.aId == "sample_text_2"


def test_Admin_aName_value_roundtrip():
    instance = Admin(aId="sample_text", aName="sample_text")
...
Admin_strategy = st.builds(Admin, aId=safe_text, aName=safe_text)
@given(instance=Admin_strategy)
