...
def test_hyp_persons_localedelement_is_not_abstract():
    assert not inspect.isabstract(Persons_LocaledElement)


def test_hyp_persons_localedelement_constructor_exists():
    assert callable(Persons_LocaledElement.__init__)


def test_hyp_persons_localedelement_constructor_args():
...
Persons_LocaledElement_strategy = st.builds(Persons_LocaledElement)
