...
Persons_LocaledElement = Class(name="Persons_LocaledElement", is_abstract=True)
...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={Persons_Person, PersonsModel, Persons_Male, Person, Persons_Female, Persons_PersonsModel, Persons_LocaledElement, Persons_Employee},
