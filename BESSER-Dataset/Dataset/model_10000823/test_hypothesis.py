...
def test_consult_expense_external_is_not_abstract():
    assert not inspect.isabstract(Consult_Expense_external)


def test_consult_expense_external_constructor_exists():
    assert callable(Consult_Expense_external.__init__)


def test_consult_expense_external_constructor_args():
...
def test_send_an_expense_to_verification_external_is_not_abstract():
    assert not inspect.isabstract(Send_an_Expense_to_verification_external)


def test_send_an_expense_to_verification_external_constructor_exists():
    assert callable(Send_an_Expense_to_verification_external.__init__)


def test_send_an_expense_to_verification_external_constructor_args():
    sig = inspect.signature(Send_an_Expense_to_verification_external.__init__)
    params = list(sig.parameters.keys())



def test_expensetype_is_not_abstract():
    assert not inspect.isabstract(ExpenseType)


def test_expensetype_constructor_exists():
    assert callable(ExpenseType.__init__)


def test_expensetype_constructor_args():
...
def test_currency1_is_not_abstract():
    assert not inspect.isabstract(Currency1)


def test_currency1_constructor_exists():
...
def test_currency1_has_id():
    assert hasattr(Currency1, "id")
    descriptor = None
    for klass in Currency1.__mro__:
        if "id" in klass.__dict__:
            descriptor = klass.__dict__["id"]
...
def test_expense_is_not_abstract():
    assert not inspect.isabstract(Expense)


def test_expense_constructor_exists():
    assert callable(Expense.__init__)


def test_expense_constructor_args():
...
def test_expense_has_project_id():
    assert hasattr(Expense, "project_id")
    descriptor = None
    for klass in Expense.__mro__:
...
def test_expense_has_mission_id():
    assert hasattr(Expense, "mission_id")
    descriptor = None
    for klass in Expense.__mro__:
...
@given(instance=ExpenseType_strategy)
def test_expensetype_id_setter(instance):
...
@given(instance=ExpenseType_strategy)
def test_expensetype_price_setter(instance):
...
@given(instance=Currency1_strategy)
def test_currency1_abr_setter(instance):
...
@given(instance=Bill_strategy)
def test_bill_sum_setter(instance):
...
@given(instance=Bill_strategy)
def test_bill_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
@given(instance=Expense_strategy)
def test_expense_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
@given(instance=Expense_strategy)
def test_expense_project_id_setter(instance):
...
@given(instance=Expense_strategy)
def test_expense_manager_id_setter(instance):
...
@given(instance=Expense_strategy)
def test_expense_mission_id_setter(instance):
