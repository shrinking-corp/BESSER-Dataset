...
def test_hyp_consult_expense_external_is_not_abstract():
    assert not inspect.isabstract(Consult_Expense_external)


def test_hyp_consult_expense_external_constructor_exists():
    assert callable(Consult_Expense_external.__init__)


def test_hyp_consult_expense_external_constructor_args():
    sig = inspect.signature(Consult_Expense_external.__init__)
    params = list(sig.parameters.keys())
...
def test_hyp_send_an_expense_to_verification_external_is_not_abstract():
    assert not inspect.isabstract(Send_an_Expense_to_verification_external)


def test_hyp_send_an_expense_to_verification_external_constructor_exists():
    assert callable(Send_an_Expense_to_verification_external.__init__)


def test_hyp_send_an_expense_to_verification_external_constructor_args():
    sig = inspect.signature(Send_an_Expense_to_verification_external.__init__)
    params = list(sig.parameters.keys())



def test_hyp_expensetype_is_not_abstract():
    assert not inspect.isabstract(ExpenseType)


def test_hyp_expensetype_constructor_exists():
    assert callable(ExpenseType.__init__)


def test_hyp_expensetype_constructor_args():
...
def test_hyp_currency1_is_not_abstract():
    assert not inspect.isabstract(Currency1)


def test_hyp_currency1_constructor_exists():
    assert callable(Currency1.__init__)


def test_hyp_currency1_constructor_args():
...
def test_hyp_bill_has_sum():
    assert hasattr(Bill, "sum")
    descriptor = None
    for klass in Bill.__mro__:
...
def test_hyp_bill_has_attachment_id():
...
def test_hyp_bill_has_distance():
...
def test_hyp_bill_has_payment_method():
...
def test_hyp_expense_is_not_abstract():
    assert not inspect.isabstract(Expense)


def test_hyp_expense_constructor_exists():
    assert callable(Expense.__init__)


def test_hyp_expense_constructor_args():
    sig = inspect.signature(Expense.__init__)
    params = list(sig.parameters.keys())
    assert "id" in params, "Missing parameter 'id'"
...
def test_hyp_expensestatus_exists():
    # Check that the Enumeration exists
    assert ExpenseStatus is not None

def test_hyp_expensestatus_has_all_literals():
...
def test_hyp_paymentmethod_exists():
    # Check that the Enumeration exists
    assert PaymentMethod is not None

def test_hyp_paymentmethod_has_all_literals():
    # Collect the names of literals in this Enumeration
...
Consult_Expense_external_strategy = st.builds(
    Consult_Expense_external,
)
Delete_an_Expense_external_strategy = st.builds(
    Delete_an_Expense_external,
)
Send_an_Expense_to_verification_external_strategy = st.builds(
    Send_an_Expense_to_verification_external,
)
ExpenseType_strategy = st.builds(
    ExpenseType,
    id=
        safe_text,
    price=
...
def test_hyp_expensetype_id_setter(instance):
...
@given(instance=ExpenseType_strategy)
def test_hyp_expensetype_price_setter(instance):
...
@given(instance=ExpenseType_strategy)
def test_hyp_expensetype_name_setter(instance):
...
def test_hyp_currency1_abr_setter(instance):
...
@given(instance=Currency1_strategy)
def test_hyp_currency1_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=Currency1_strategy)
def test_hyp_currency1_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
@given(instance=Bill_strategy)
def test_hyp_bill_sum_setter(instance):
...
@given(instance=Bill_strategy)
def test_hyp_bill_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
@given(instance=Bill_strategy)
def test_hyp_bill_attachment_id_setter(instance):
...
@given(instance=Bill_strategy)
def test_hyp_bill_distance_setter(instance):
...
@given(instance=Bill_strategy)
def test_hyp_bill_payment_method_setter(instance):
...
@given(instance=Bill_strategy)
def test_hyp_bill_status_setter(instance):
...
def test_hyp_expense_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
@given(instance=Expense_strategy)
def test_hyp_expense_project_id_setter(instance):
...
@given(instance=Expense_strategy)
def test_hyp_expense_manager_id_setter(instance):
...
@given(instance=Expense_strategy)
def test_hyp_expense_mission_id_setter(instance):
...
@given(instance=Expense_strategy)
def test_hyp_expense_user_id_setter(instance):
    original = instance.user_id
    instance.user_id = original
    assert instance.user_id == original
...
def test_Comment_id_value_roundtrip():
    instance = Comment(id="sample_text", text="sample_text", user_id="sample_text")
...
def test_Currency1_abr_value_roundtrip():
    instance = Currency1(abr="sample_text", id="sample_text", name="sample_text")
    assert instance.abr == "sample_text"
    instance.abr = "sample_text_2"
    assert instance.abr == "sample_text_2"


def test_Currency1_id_value_roundtrip():
    instance = Currency1(abr="sample_text", id="sample_text", name="sample_text")
    assert instance.id == "sample_text"
    instance.id = "sample_text_2"
    assert instance.id == "sample_text_2"
...
def test_Currency1_name_value_roundtrip():
    instance = Currency1(abr="sample_text", id="sample_text", name="sample_text")
...
def test_Expense_id_value_roundtrip():
    instance = Expense(id="sample_text", manager_id="sample_text", mission_id="sample_text", project_id="sample_text", user_id="sample_text")
    assert instance.id == "sample_text"
    instance.id = "sample_text_2"
    assert instance.id == "sample_text_2"


def test_Expense_manager_id_value_roundtrip():
    instance = Expense(id="sample_text", manager_id="sample_text", mission_id="sample_text", project_id="sample_text", user_id="sample_text")
...
def test_Expense_mission_id_value_roundtrip():
    instance = Expense(id="sample_text", manager_id="sample_text", mission_id="sample_text", project_id="sample_text", user_id="sample_text")
...
def test_Expense_project_id_value_roundtrip():
    instance = Expense(id="sample_text", manager_id="sample_text", mission_id="sample_text", project_id="sample_text", user_id="sample_text")
...
def test_Expense_user_id_value_roundtrip():
    instance = Expense(id="sample_text", manager_id="sample_text", mission_id="sample_text", project_id="sample_text", user_id="sample_text")
    assert instance.user_id == "sample_text"
    instance.user_id = "sample_text_2"
    assert instance.user_id == "sample_text_2"
...
def test_ExpenseType_id_value_roundtrip():
    instance = ExpenseType(id="sample_text", name="sample_text", price="sample_text")
    assert instance.id == "sample_text"
    instance.id = "sample_text_2"
    assert instance.id == "sample_text_2"


def test_ExpenseType_name_value_roundtrip():
    instance = ExpenseType(id="sample_text", name="sample_text", price="sample_text")
    assert instance.name == "sample_text"
    instance.name = "sample_text_2"
    assert instance.name == "sample_text_2"
...
def test_ExpenseType_price_value_roundtrip():
    instance = ExpenseType(id="sample_text", name="sample_text", price="sample_text")
...
def test_assoc_Expense_Comment_link_reassign_clear():
    a = Expense(id="sample_text", manager_id="sample_text", mission_id="sample_text", project_id="sample_text", user_id="sample_text")
    b1 = Comment(id="sample_text", text="sample_text", user_id="sample_text")
    b2 = Comment(id="sample_text_2", text="sample_text_2", user_id="sample_text_2")
    _safe_set(a, 'Expense_Comment_042', {b1})
    assert _is_linked(a, 'Expense_Comment_042', b1)
    if hasattr(b1, 'Expense_Comment_143'):
        assert _is_linked(b1, 'Expense_Comment_143', a)
    _safe_set(a, 'Expense_Comment_042', {b2})
    assert _is_linked(a, 'Expense_Comment_042', b2)
    if hasattr(b1, 'Expense_Comment_143'):
        assert not _is_linked(b1, 'Expense_Comment_143', a)
    if hasattr(b2, 'Expense_Comment_143'):
        assert _is_linked(b2, 'Expense_Comment_143', a)
    _safe_set(a, 'Expense_Comment_042', set())
    assert not _is_linked(a, 'Expense_Comment_042', b2)
    if hasattr(b2, 'Expense_Comment_143'):
        assert not _is_linked(b2, 'Expense_Comment_143', a)
...
Comment_strategy = st.builds(Comment, id=safe_text, text=safe_text, user_id=safe_text)
@given(instance=Comment_strategy)
@settings(max_examples=25)
...
Consult_Expense_external_strategy = st.builds(Consult_Expense_external)
@given(instance=Consult_Expense_external_strategy)
@settings(max_examples=25)
def test_Consult_Expense_external_instantiation(instance):
    assert isinstance(instance, Consult_Expense_external)
...
Currency1_strategy = st.builds(Currency1, abr=safe_text, id=safe_text, name=safe_text)
@given(instance=Currency1_strategy)
@settings(max_examples=25)
...
Expense_strategy = st.builds(Expense, id=safe_text, manager_id=safe_text, mission_id=safe_text, project_id=safe_text, user_id=safe_text)
@given(instance=Expense_strategy)
@settings(max_examples=25)
...
ExpenseType_strategy = st.builds(ExpenseType, id=safe_text, name=safe_text, price=safe_text)
@given(instance=ExpenseType_strategy)
@settings(max_examples=25)
...
Send_an_Expense_to_verification_external_strategy = st.builds(Send_an_Expense_to_verification_external)
@given(instance=Send_an_Expense_to_verification_external_strategy)
@settings(max_examples=25)
def test_Send_an_Expense_to_verification_external_instantiation(instance):
    assert isinstance(instance, Send_an_Expense_to_verification_external)
