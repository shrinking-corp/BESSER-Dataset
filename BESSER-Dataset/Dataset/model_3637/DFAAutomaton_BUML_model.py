...
DFAAutomaton_Symbol = Class(name="DFAAutomaton_Symbol")
...
DFAAutomaton_State.attributes={DFAAutomaton_State_isInitial, DFAAutomaton_State_name, DFAAutomaton_State_isFinal}
...
domain_model = DomainModel(
    name="DFAAutomaton",
    types={DFAAutomaton_Automaton, DFAAutomaton_State, DFAAutomaton_Transition, DFAAutomaton_Symbol},
    associations={tar8, states0, transitions1, alphabet3, src5, symbol11},
    generalizations={},
    metadata=None
)
