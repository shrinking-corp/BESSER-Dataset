...
class DFAAutomaton_State:
    ...
    def __init__(self, name: str, isInitial: bool, isFinal: bool, DFAAutomaton_State10: "DFAAutomaton_Transition" = None, DFAAutomaton_State: "DFAAutomaton_Automaton" = None, DFAAutomaton_State7: "DFAAutomaton_Transition" = None):
        self.name = name
...
class DFAAutomaton_Automaton:
    ...
    def __init__(self, name: str, DFAAutomaton_Automaton: set["DFAAutomaton_State"] = None, DFAAutomaton_Automaton2: set["DFAAutomaton_Transition"] = None, DFAAutomaton_Automaton4: set["DFAAutomaton_Symbol"] = None):
        self.name = name
