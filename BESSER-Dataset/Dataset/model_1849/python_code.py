...
class libsys_UserAccount:
    ...
    def __init__(self, unpaidFeeAmount: int, lockIndication: bool, userData: str, userNumber: int, userClassification: str, userName: str, telephoneNumber: str, emailAddress: str, validUntilDate: date, postallAddress: str, libsys_UserAccount7: set["libsys_Instance"] = None, libsys_UserAccount10: set["libsys_Instance"] = None, libsys_UserAccount13: "libsys_UserAdministration" = None, libsys_UserAccount: "libsys_User" = None):
...
class libsys_User:
    ...
    def __init__(self, libsys_User: "libsys_UserAccount" = None, libsys_User25: "libsys_BorrowedEntry" = None, libsys_User28: "libsys_ReservationEntry" = None, libsys_User22: "libsys_Library" = None):
...
class libsys_Instance:
    ...
    def __init__(self, shelfmark: str, status: str, returnDate: date, location: str, rentalPeriod: str, comments: str, components: str, libsys_Instance: "libsys_Medium" = None, libsys_Instance8: "libsys_UserAccount" = None, libsys_Instance11: "libsys_UserAccount" = None, libsys_Instance2: set["libsys_ReservationEntry"] = None, libsys_Instance4: set["libsys_BorrowedEntry"] = None):
