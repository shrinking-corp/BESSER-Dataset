...
# Classes
libsys_Medium = Class(name="libsys_Medium")
libsys_Instance = Class(name="libsys_Instance")
libsys_Librarian = Class(name="libsys_Librarian")
libsys_UserAdministration = Class(name="libsys_UserAdministration")
libsys_MediaAdministration = Class(name="libsys_MediaAdministration")
libsys_Terminal = Class(name="libsys_Terminal")
libsys_ReservationEntry = Class(name="libsys_ReservationEntry")
libsys_BorrowedEntry = Class(name="libsys_BorrowedEntry")
libsys_User = Class(name="libsys_User")
libsys_UserAccount = Class(name="libsys_UserAccount")
libsys_Book = Class(name="libsys_Book")
Medium = Class(name="Medium")
libsys_Magazine = Class(name="libsys_Magazine")
libsys_SearchCriterion = Class(name="libsys_SearchCriterion")
libsys_StatusSignal = Class(name="libsys_StatusSignal")
libsys_ExtensionTime = Class(name="libsys_ExtensionTime")
libsys_UnpaidFee = Class(name="libsys_UnpaidFee")
libsys_IdentificationCard = Class(name="libsys_IdentificationCard")
libsys_BarCodeScanner = Class(name="libsys_BarCodeScanner")
libsys_Library = Class(name="libsys_Library")
libsys_CD = Class(name="libsys_CD")
libsys_Video = Class(name="libsys_Video")
...
libsys_Medium.attributes={libsys_Medium_partialShelfmark, libsys_Medium_publicationYear, libsys_Medium_keywords, libsys_Medium_title, libsys_Medium_authors, libsys_Medium_identificationCode, libsys_Medium_additionalTitle}
...
libsys_Instance.attributes={libsys_Instance_shelfmark, libsys_Instance_comments, libsys_Instance_location, libsys_Instance_returnDate, libsys_Instance_components, libsys_Instance_status, libsys_Instance_rentalPeriod}
libsys_Instance.methods={libsys_Instance_m_extendRentalPeriod, libsys_Instance_m_returnInstance, libsys_Instance_m_borrowInstance, libsys_Instance_m_reserveInstance}
...
libsys_MediaAdministration.methods={libsys_MediaAdministration_m_searchMedium, libsys_MediaAdministration_m_addNewMediaInstance, libsys_MediaAdministration_m_manageMedium, libsys_MediaAdministration_m_removeMediaInstance}
...
libsys_UserAccount.attributes={libsys_UserAccount_userNumber, libsys_UserAccount_userName, libsys_UserAccount_postallAddress, libsys_UserAccount_unpaidFeeAmount, libsys_UserAccount_userData, libsys_UserAccount_validUntilDate, libsys_UserAccount_telephoneNumber, libsys_UserAccount_userClassification, libsys_UserAccount_lockIndication, libsys_UserAccount_emailAddress}
...
libsys_Book.attributes={libsys_Book_placeOfPublication, libsys_Book_editor, libsys_Book_ISBN, libsys_Book_publisher}
...
libsys_UnpaidFee.attributes={libsys_UnpaidFee_amount, libsys_UnpaidFee_reason}
...
libsys_CD.attributes={libsys_CD_tracks, libsys_CD_artists, libsys_CD_genres}
...
domain_model = DomainModel(
    name="libsys",
    types={libsys_Medium, libsys_Instance, libsys_Librarian, libsys_UserAdministration, libsys_MediaAdministration, libsys_Terminal, libsys_ReservationEntry, libsys_BorrowedEntry, libsys_User, libsys_UserAccount, libsys_Book, Medium, libsys_Magazine, libsys_SearchCriterion, libsys_StatusSignal, libsys_ExtensionTime, libsys_UnpaidFee, libsys_IdentificationCard, libsys_BarCodeScanner, libsys_Library, libsys_CD, libsys_Video, MediumCode, InstanceStatus},
    associations={instances0, borrowedInstances6, reservationList9, userAccounts12, mediaEntries14, reservationList1, borrowingList3, userAccount5, user23, user26, media16, librarians18, users20},
    generalizations={gen_libsys_Book_Medium, gen_libsys_Magazine_Medium, gen_libsys_CD_Medium, gen_libsys_Video_Medium},
    metadata=None
)
