...
class petrinet_Node(ABC):
    ...
    def __init__(self, name: str, nodes: "petrinet_Network" = None, Node: "petrinet_Network" = None, Node11: "petrinet_Arc" = None, target: set["petrinet_Arc"] = None, source: set["petrinet_Arc"] = None, Node13: "petrinet_Arc" = None):
        self.name = name
        self.nodes = nodes
        self.Node = Node
        self.Node11 = Node11
...
class petrinet_Arc:
    ...
    def __init__(self, readOnly: bool, kind: str, tokensCount: int, Arc: "petrinet_Network" = None, arcs: "petrinet_Network" = None, successors: "petrinet_Node" = None, Arc5: "petrinet_Node" = None, Arc7: "petrinet_Node" = None, predecessors: "petrinet_Node" = None):
...
class petrinet_Network:
    ...
    def __init__(self, name: str, reseau2: set["petrinet_Arc"] = None, Network: "petrinet_Node" = None, reseau: set["petrinet_Node"] = None, Network9: "petrinet_Arc" = None):
        self.name = name
