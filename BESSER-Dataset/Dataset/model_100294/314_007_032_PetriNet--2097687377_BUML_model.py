...
domain_model = DomainModel(
    name="petrinet",
    types={petrinet_Network, petrinet_Arc, petrinet_Node, petrinet_Transition, Node, petrinet_Place, ArcKind},
    associations={arcs1, reseau3, nodes0, reseau8, source10, predecessors4, successors6, target12},
