...
def test_namedcapabilitymetadata1_is_not_abstract():
    assert not inspect.isabstract(NamedCapabilityMetadata1)


def test_namedcapabilitymetadata1_constructor_exists():
    assert callable(NamedCapabilityMetadata1.__init__)


def test_namedcapabilitymetadata1_constructor_args():
    sig = inspect.signature(NamedCapabilityMetadata1.__init__)
    params = list(sig.parameters.keys())
    assert "name" in params, "Missing parameter 'name'"

def test_namedcapabilitymetadata1_has_name():
    assert hasattr(NamedCapabilityMetadata1, "name")
    descriptor = None
    for klass in NamedCapabilityMetadata1.__mro__:
...
def test_namedcapabilitymetadata_is_not_abstract():
    assert not inspect.isabstract(NamedCapabilityMetadata)


def test_namedcapabilitymetadata_constructor_exists():
    assert callable(NamedCapabilityMetadata.__init__)


def test_namedcapabilitymetadata_constructor_args():
...
@given(instance=NamedCapabilityMetadata1_strategy)
def test_namedcapabilitymetadata1_name_setter(instance):
