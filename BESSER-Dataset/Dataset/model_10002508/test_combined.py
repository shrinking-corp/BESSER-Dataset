...
from python_code import (
    NamedCapabilityMetadata1,
    NamedCapabilityMetadata,
    ArrPrint,
    Print,
    Documents,
    Json,
...
def test_hyp_namedcapabilitymetadata1_is_not_abstract():
    assert not inspect.isabstract(NamedCapabilityMetadata1)


def test_hyp_namedcapabilitymetadata1_constructor_exists():
    assert callable(NamedCapabilityMetadata1.__init__)


def test_hyp_namedcapabilitymetadata1_constructor_args():
    sig = inspect.signature(NamedCapabilityMetadata1.__init__)
...
def test_hyp_namedcapabilitymetadata_is_not_abstract():
    assert not inspect.isabstract(NamedCapabilityMetadata)


def test_hyp_namedcapabilitymetadata_constructor_exists():
    assert callable(NamedCapabilityMetadata.__init__)


def test_hyp_namedcapabilitymetadata_constructor_args():
    sig = inspect.signature(NamedCapabilityMetadata.__init__)
    params = list(sig.parameters.keys())
...
NamedCapabilityMetadata1_strategy = st.builds(
    NamedCapabilityMetadata1,
    name=
        safe_text
)
NamedCapabilityMetadata_strategy = st.builds(
    NamedCapabilityMetadata,
)
...
@given(instance=NamedCapabilityMetadata1_strategy)
def test_hyp_namedcapabilitymetadata1_name_setter(instance):
...
def test_NamedCapabilityMetadata1_name_value_roundtrip():
    instance = NamedCapabilityMetadata1(name="sample_text")
...
NamedCapabilityMetadata_strategy = st.builds(NamedCapabilityMetadata)
@given(instance=NamedCapabilityMetadata_strategy)
@settings(max_examples=25)
def test_NamedCapabilityMetadata_instantiation(instance):
    assert isinstance(instance, NamedCapabilityMetadata)


NamedCapabilityMetadata1_strategy = st.builds(NamedCapabilityMetadata1, name=safe_text)
@given(instance=NamedCapabilityMetadata1_strategy)
@settings(max_examples=25)
def test_NamedCapabilityMetadata1_instantiation(instance):
    assert isinstance(instance, NamedCapabilityMetadata1)
