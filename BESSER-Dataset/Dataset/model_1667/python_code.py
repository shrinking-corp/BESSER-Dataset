...
class workbench101_RelatedTo(NamedElement):
    ...
    def __init__(self, since: str, RelatedTo: "workbench101_Thing" = None, relations: "workbench101_Thing" = None, workbench101_RelatedTo: "workbench101_Thing" = None):
        self.since = since
...
class workbench101_Thing(NamedElement):
    ...
    def __init__(self, id: int, fromThing: set["workbench101_RelatedTo"] = None, Thing: "workbench101_RelatedTo" = None, workbench101_Thing6: "workbench101_RelatedTo" = None, workbench101_Thing9: "workbench101_Thoughts" = None, workbench101_Thing: "workbench101_Workbench" = None):
        self.id = id
...
class workbench101_Workbench:
    ...
    def __init__(self, aprop: str, workbench101_Workbench2: set["workbench101_Thoughts"] = None, workbench101_Workbench: set["workbench101_Thing"] = None):
        self.aprop = aprop
