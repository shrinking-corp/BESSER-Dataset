...
def test_hyp_statemachine_firingelement_is_not_abstract():
    assert not inspect.isabstract(statemachine_FiringElement)


def test_hyp_statemachine_firingelement_constructor_exists():
    assert callable(statemachine_FiringElement.__init__)


def test_hyp_statemachine_firingelement_constructor_args():
...
def test_hyp_firingelement_is_not_abstract():
    assert not inspect.isabstract(FiringElement)


def test_hyp_firingelement_constructor_exists():
    assert callable(FiringElement.__init__)


def test_hyp_firingelement_constructor_args():
...
def test_hyp_statemachine_stateaction_is_not_abstract():
    assert not inspect.isabstract(statemachine_StateAction)


def test_hyp_statemachine_stateaction_constructor_exists():
    assert callable(statemachine_StateAction.__init__)


def test_hyp_statemachine_stateaction_constructor_args():
...
def test_hyp_statemachine_firingelement_action_setter(instance):
...
@given(instance=statemachine_FiringElement_strategy)
def test_hyp_statemachine_firingelement_trigger_setter(instance):
...
def test_hyp_statemachine_abstractstate_name_setter(instance):
