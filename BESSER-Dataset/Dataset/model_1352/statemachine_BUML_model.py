...
statemachine_FiringElement = Class(name="statemachine_FiringElement", is_abstract=True)
statemachine_State = Class(name="statemachine_State")
AbstractState = Class(name="AbstractState")
statemachine_StateAction = Class(name="statemachine_StateAction")
...
domain_model = DomainModel(
    name="statemachine",
    types={FiringElement, statemachine_StateMachine, statemachine_AbstractState, statemachine_Transition, statemachine_FiringElement, statemachine_State, AbstractState, statemachine_StateAction, statemachine_InitialState, statemachine_FinalState},
    associations={source7, target8, states0, transitions1, transitionsAsSource3, transitionsAsTarget4, internalActions6},
    generalizations={gen_statemachine_Transition_FiringElement, gen_statemachine_StateAction_FiringElement, gen_statemachine_State_AbstractState, gen_statemachine_InitialState_AbstractState, gen_statemachine_FinalState_AbstractState},
    metadata=None
)
