...
class statemachine_AbstractState(ABC):
    ...
    def __init__(self, name: str, AbstractState: "statemachine_Transition" = None, AbstractState9: "statemachine_Transition" = None, statemachine_AbstractState: "statemachine_StateMachine" = None, source: set["statemachine_Transition"] = None, target: set["statemachine_Transition"] = None):
        self.name = name
