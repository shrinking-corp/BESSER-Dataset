...
class attackimpact_Propagation:
    ...
    def __init__(self, severity: int, tags: str, type: str, attackimpact_Propagation: "attackimpact_Node" = None, attackimpact_Propagation7: "attackimpact_Vulnerability" = None, attackimpact_Propagation9: set["attackimpact_Node"] = None):
...
class attackimpact_Node:
    ...
    def __init__(self, name: str, description: str, tags: str, domains: str, attackimpact_Node: set["attackimpact_Vulnerability"] = None, attackimpact_Node2: set["attackimpact_Propagation"] = None, attackimpact_Node4: "attackimpact_EObject" = None, attackimpact_Node12: "attackimpact_Model" = None, attackimpact_Node10: "attackimpact_Propagation" = None):
        self.name = name
        self.description = description
        self.tags = tags
