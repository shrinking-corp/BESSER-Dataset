...
# Classes
attackimpact_Node = Class(name="attackimpact_Node")
attackimpact_Vulnerability = Class(name="attackimpact_Vulnerability")
attackimpact_Propagation = Class(name="attackimpact_Propagation")
attackimpact_EObject = Class(name="attackimpact_EObject")
attackimpact_Model = Class(name="attackimpact_Model")
...
attackimpact_Node.attributes={attackimpact_Node_description, attackimpact_Node_domains, attackimpact_Node_name, attackimpact_Node_tags}
...
attackimpact_Vulnerability.attributes={attackimpact_Vulnerability_description, attackimpact_Vulnerability_type, attackimpact_Vulnerability_severity, attackimpact_Vulnerability_tags, attackimpact_Vulnerability_name}
...
attackimpact_Propagation.attributes={attackimpact_Propagation_severity, attackimpact_Propagation_tags, attackimpact_Propagation_type}
...
domain_model = DomainModel(
    name="attackimpact",
    types={attackimpact_Node, attackimpact_Vulnerability, attackimpact_Propagation, attackimpact_EObject, attackimpact_Model, propagationType, vulnerabilityType},
    associations={vulnerabilities0, propagations1, relatedObject3, propagations5, nodes11, destinations8},
    generalizations={},
    metadata=None
)
