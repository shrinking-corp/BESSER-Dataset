...
cloudml_UploadCommand = Class(name="cloudml_UploadCommand")
cloudml_Provider = Class(name="cloudml_Provider")
cloudml_DeploymentModel = Class(name="cloudml_DeploymentModel")
cloudml_Artefact = Class(name="cloudml_Artefact")
cloudml_Node = Class(name="cloudml_Node")
cloudml_CloudMLElement = Class(name="cloudml_CloudMLElement", is_abstract=True)
cloudml_NamedElement = Class(name="cloudml_NamedElement", is_abstract=True)
CloudMLElement = Class(name="CloudMLElement")
cloudml_Property = Class(name="cloudml_Property")
NamedElement = Class(name="NamedElement")
cloudml_WithProperties = Class(name="cloudml_WithProperties", is_abstract=True)
cloudml_ArtefactPortInstance = Class(name="cloudml_ArtefactPortInstance")
cloudml_Binding = Class(name="cloudml_Binding")
cloudml_ArtefactInstance = Class(name="cloudml_ArtefactInstance")
cloudml_NodeInstance = Class(name="cloudml_NodeInstance")
cloudml_BindingInstance = Class(name="cloudml_BindingInstance")
cloudml_ArtefactPort = Class(name="cloudml_ArtefactPort", is_abstract=True)
cloudml_ServerPort = Class(name="cloudml_ServerPort")
ArtefactPort = Class(name="ArtefactPort")
cloudml_ClientPort = Class(name="cloudml_ClientPort")
cloudml_Composite = Class(name="cloudml_Composite")
cloudml_ServerPortInstance = Class(name="cloudml_ServerPortInstance")
ArtefactPortInstance = Class(name="ArtefactPortInstance")
cloudml_ClientPortInstance = Class(name="cloudml_ClientPortInstance")
...
cloudml_Resource.attributes={cloudml_Resource_configurationCommand, cloudml_Resource_deployingCommand, cloudml_Resource_retrievingCommand, cloudml_Resource_startCommand, cloudml_Resource_stopCommand}
...
cloudml_Node.attributes={cloudml_Node_imageID, cloudml_Node_location, cloudml_Node_minDisk, cloudml_Node_groupName, cloudml_Node_minCore, cloudml_Node_sshKey, cloudml_Node_securityGroup, cloudml_Node_minRam, cloudml_Node_privateKey, cloudml_Node_OS, cloudml_Node_is64os}
...
cloudml_ArtefactPort.attributes={cloudml_ArtefactPort_portNumber, cloudml_ArtefactPort_isRemote}
...
domain_model = DomainModel(
    name="cloudml",
    types={cloudml_Resource, WithProperties, cloudml_UploadCommand, cloudml_Provider, cloudml_DeploymentModel, cloudml_Artefact, cloudml_Node, cloudml_CloudMLElement, cloudml_NamedElement, CloudMLElement, cloudml_Property, NamedElement, cloudml_WithProperties, cloudml_ArtefactPortInstance, cloudml_Binding, cloudml_ArtefactInstance, cloudml_NodeInstance, cloudml_BindingInstance, cloudml_ArtefactPort, cloudml_ServerPort, ArtefactPort, cloudml_ClientPort, cloudml_Composite, cloudml_ServerPortInstance, ArtefactPortInstance, cloudml_ClientPortInstance},
    associations={properties0, uploadCommand1, providers2, artefactTypes3, nodeTypes5, destination15, resource17, provided20, required22, cloudProvider24, bindingTypes7, artefactInstances9, nodeInstances11, bindingInstances13, containedArtefacts42, client44, server47, clientResource50, serverResource53, type56, client59, server62, type27, type29, destination32, provided35, required37, type39},
    generalizations={gen_cloudml_Resource_WithProperties, gen_cloudml_Provider_WithProperties, gen_cloudml_DeploymentModel_WithProperties, gen_cloudml_NamedElement_CloudMLElement, gen_cloudml_Property_NamedElement, gen_cloudml_WithProperties_NamedElement, gen_cloudml_Artefact_WithProperties, gen_cloudml_Node_WithProperties, gen_cloudml_ArtefactPortInstance_WithProperties, gen_cloudml_ArtefactPort_WithProperties, gen_cloudml_ServerPort_ArtefactPort, gen_cloudml_ClientPort_ArtefactPort, gen_cloudml_Composite_NamedElement, gen_cloudml_Binding_WithProperties, gen_cloudml_BindingInstance_WithProperties, gen_cloudml_ServerPortInstance_ArtefactPortInstance, gen_cloudml_ClientPortInstance_ArtefactPortInstance, gen_cloudml_ArtefactInstance_WithProperties, gen_cloudml_NodeInstance_WithProperties},
    metadata=None
)
