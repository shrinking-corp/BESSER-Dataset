...
# Classes
diastyle_DNodeEdgeStyle = Class(name="diastyle_DNodeEdgeStyle", is_abstract=True)
EModelElement = Class(name="EModelElement")
DBaseStyle = Class(name="DBaseStyle")
diastyle_DStyle = Class(name="diastyle_DStyle")
diastyle_DBaseStyle = Class(name="diastyle_DBaseStyle", is_abstract=True)
diastyle_DGraph = Class(name="diastyle_DGraph")
diastyle_DStyleBridge = Class(name="diastyle_DStyleBridge")
diastyle_DGraphElement = Class(name="diastyle_DGraphElement")
diastyle_DNodeStyle = Class(name="diastyle_DNodeStyle")
DNodeEdgeStyle = Class(name="DNodeEdgeStyle")
diastyle_DEdgeStyle = Class(name="diastyle_DEdgeStyle")
diastyle_DNestingEdgeStyle = Class(name="diastyle_DNestingEdgeStyle")
...
diastyle_DNodeEdgeStyle.attributes={diastyle_DNodeEdgeStyle_lineWidth, diastyle_DNodeEdgeStyle_line, diastyle_DNodeEdgeStyle_icon, diastyle_DNodeEdgeStyle_textAlignment, diastyle_DNodeEdgeStyle_fontStyle, diastyle_DNodeEdgeStyle_fontColor, diastyle_DNodeEdgeStyle_fontSize, diastyle_DNodeEdgeStyle_fontName}
...
diastyle_DStyle_m_getBackgroundColor: Method = Method(name="getBackgroundColor", parameters={Parameter(name='diastyle_element', type=StringType)}, type=StringType)
diastyle_DStyle_m_getFigure: Method = Method(name="getFigure", parameters={Parameter(name='diastyle_element', type=StringType)}, type=StringType)
diastyle_DStyle_m_getIcon: Method = Method(name="getIcon", parameters={Parameter(name='diastyle_element', type=StringType)}, type=StringType)
diastyle_DStyle.attributes={diastyle_DStyle_styleHandler}
diastyle_DStyle.methods={diastyle_DStyle_m_getFigure, diastyle_DStyle_m_getIcon, diastyle_DStyle_m_getBackgroundColor}
...
diastyle_DBaseStyle.attributes={diastyle_DBaseStyle_color, diastyle_DBaseStyle_name, diastyle_DBaseStyle_parentName}
...
diastyle_DNodeStyle.attributes={diastyle_DNodeStyle_sizeY, diastyle_DNodeStyle_sizeX, diastyle_DNodeStyle_figure, diastyle_DNodeStyle_shape, diastyle_DNodeStyle_shapeData, diastyle_DNodeStyle_layout, diastyle_DNodeStyle_radius}
...
diastyle_DEdgeStyle.attributes={diastyle_DEdgeStyle_shape, diastyle_DEdgeStyle_arrowSize, diastyle_DEdgeStyle_arrowDirection}
...
domain_model = DomainModel(
    name="diastyle",
    types={diastyle_DNodeEdgeStyle, EModelElement, DBaseStyle, diastyle_DStyle, diastyle_DBaseStyle, diastyle_DGraph, diastyle_DStyleBridge, diastyle_DGraphElement, diastyle_DNodeStyle, DNodeEdgeStyle, diastyle_DEdgeStyle, diastyle_DNestingEdgeStyle, DColor, DLayout, DShape, DFontStyle, DFontName, DLine, DDirection, DAlignment},
