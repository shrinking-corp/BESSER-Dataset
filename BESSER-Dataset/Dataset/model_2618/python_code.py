...
class diastyle_DNodeStyle(DNodeEdgeStyle):
    ...
    def __init__(self, figure: str, shapeData: str, layout: str, sizeX: int, radius: int, shape: str, sizeY: int):
        self.figure = figure
...
class diastyle_DStyle(EModelElement):
    ...
    def getBackgroundColor(self, diastyle_element) :
        # TODO: Implement getBackgroundColor method
        pass

    def getFigure(self, diastyle_element) :
        # TODO: Implement getFigure method
        pass

    def getIcon(self, diastyle_element) :
