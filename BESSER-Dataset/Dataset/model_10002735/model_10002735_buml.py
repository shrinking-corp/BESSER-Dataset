...
User.attributes={User_Hiredate, User_Active, User_Roles___, User_DepartmentID, User_Google_plus_link, User_Facebook_link, User_Username, User_Settings, User_Linkedin_link, User_Position, User_About, User_Dateofbirth, User_UserID, User_Firstname, User_Lastname, User_TitleID, User_Email, User_Phone, User_Password}
...
Project.attributes={Project_Author, Project_PorjectID, Project_Description, Project_Assignee, Project_Deadline, Project_StatusID, Project_Subscriptions___, Project_Attachments___, Project_ProjectManager, Project_Activities___, Project_PriorityID, Project_Team___, Project_Title, Project_Created, Project_Comments___}
...
Activity.attributes={Activity_ActivityID, Activity_PrevValue, Activity_Seen, Activity_ActivitySubType, Activity_ActivityType, Activity_User, Activity_NewValue, Activity_Project}
...
Comment.attributes={Comment_Created, Comment_CommentID, Comment_User, Comment_Content, Comment_Project}
...
Attachment.attributes={Attachment_Extension, Attachment_Created, Attachment_Project, Attachment_Name, Attachment_Path, Attachment_User, Attachment_AttachmentID, Attachment_Size}
...
Role.attributes={Role_RoleID, Role_Description, Role_Name}
...
domain_model = DomainModel(
    name="d442bfbd_e7e4_4fc0_b8ac_fab12907dbda",
    types={User, Project, Activity, Comment, Attachment, Role, String},
    associations={User_Role, Project_User, User_Project, User_Project2, User_Project3, User_Activity, Project_Activity, Project_Comment, User_Comment, User_Attachment, Project_Attachment},
    generalizations={},
    metadata=None
)
