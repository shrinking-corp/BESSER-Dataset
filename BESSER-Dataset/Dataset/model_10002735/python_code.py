...
class User:
    ...
    def __init__(self, TitleID: int, Active: bool, Settings: str, Position: str, Hiredate: str, About: str, Facebook_link: str, Google_plus_link: str, Linkedin_link: str, Roles___: str, UserID: int, Username: str, Password: str, Firstname: str, Lastname: str, Dateofbirth: str, Email: str, Phone: str, DepartmentID: int, Role18: set["Role"] = None, Project21: "Project" = None, Author0: "Project" = None, ProjectMan_2: set["Project"] = None, Assignee4: set["Project"] = None, Activity6: set["Activity"] = None, Comment12: set["Comment"] = None, Attachment14: set["Attachment"] = None):
