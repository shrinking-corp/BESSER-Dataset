...
domain_model = DomainModel(
    name="dot",
    types={dot_Attribute, Statement, dot_GraphvizModel, dot_Graph, dot_Statement, dot_NodeStatement, dot_Node, dot_Port, dot_EdgeStatement, dot_EdgeTarget, dot_Subgraph, dot_AttributeStatement, EdgeOperator, GraphType, AttributeType},
    associations={graphs0, statements1, node3, attributes4, port6, sourceNode8, edgeTargets10, attributes12, targetSubgraph15, targetnode17, attributes20, statements22},
