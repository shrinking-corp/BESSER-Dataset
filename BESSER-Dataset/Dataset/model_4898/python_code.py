...
class aggregator_p2view_IUPresentation(ABC):
    ...
    def __init__(self, label: str, description: str, type: str, filter: str, id: str, version: str, name: str, aggregator_p2view_IUPresentation: "p2view_aggregator_IInstallableUnit" = None):
        self.label = label
...
class aggregator_p2view_Category(IUPresentation):
    ...
    def __init__(self, aggregator_p2view_Category: "Categories" = None, aggregator_p2view_Category53: "Features" = None, aggregator_p2view_Category57: "Bundles" = None, aggregator_p2view_Category59: "Fragments" = None, aggregator_p2view_Category61: "IUDetails" = None, aggregator_p2view_Category55: "Products" = None, IUPresentation: "aggregator_p2view_InstallableUnits" = None):
...
class EnabledStatusProvider:
    ...
    pass
class aggregator_MappedUnit(IdentificationProvider, EnabledStatusProvider, InstallableUnitRequest):
...
class aggregator_AvailableVersion:
    ...
    def __init__(self, version: str, filter: str, availableFrom: str, versionMatch: str, aggregator_AvailableVersion: "aggregator_AvailableVersionsHeader" = None, aggregator_AvailableVersion24: "aggregator_InstallableUnitRequest" = None):
        self.version = version
        self.filter = filter
...
class aggregator_Contribution(EnabledStatusProvider, IdentificationProvider, InfosProvider, DescriptionProvider, StatusProvider):
...
class aggregator_ValidationSet(EnabledStatusProvider, IdentificationProvider, InfosProvider, DescriptionProvider, StatusProvider):

    def __init__(self, label: str, abstract: bool, extension: bool, aggregator_ValidationSet: "aggregator_Aggregation" = None, aggregator_ValidationSet40: set["aggregator_Contribution"] = None, aggregator_ValidationSet43: set["aggregator_MetadataRepositoryReference"] = None, aggregator_ValidationSet47: "aggregator_ValidationSet" = None, aggregator_ValidationSet45: set["aggregator_ValidationSet"] = None):
        self.label = label
