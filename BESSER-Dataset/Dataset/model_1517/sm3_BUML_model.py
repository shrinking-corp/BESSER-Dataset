...
# Classes
sm3_StateMachine = Class(name="sm3_StateMachine")
sm3_State = Class(name="sm3_State")
sm3_Transition = Class(name="sm3_Transition")
...
domain_model = DomainModel(
    ...
    associations={sm4, outgoing5, incoming6, src8, initialState0, states1, edges2, tgt10},
    generalizations={},
    metadata=None
)
