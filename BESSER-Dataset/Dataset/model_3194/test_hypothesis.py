...
def test_uppaal_expressions_expression_has_exp():
    assert hasattr(uppaal_expressions_Expression, "exp")
    descriptor = None
    for klass in uppaal_expressions_Expression.__mro__:
...
def test_uppaal_declarations_declaration_has_exp():
    assert hasattr(uppaal_declarations_Declaration, "exp")
    descriptor = None
    for klass in uppaal_declarations_Declaration.__mro__:
        if "exp" in klass.__dict__:
            descriptor = klass.__dict__["exp"]
            break
    assert isinstance(descriptor, property)
...
@given(instance=uppaal_expressions_Expression_strategy)
def test_uppaal_expressions_expression_exp_setter(instance):
...
@given(instance=uppaal_declarations_Declaration_strategy)
def test_uppaal_declarations_declaration_exp_setter(instance):
    original = instance.exp
    instance.exp = original
    assert instance.exp == original
