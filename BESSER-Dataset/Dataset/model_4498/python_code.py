...
class ArduinoCard_Block(ABC):
    ...
    def __init__(self, pinNumber: int, isAnalogic: str, name: str, ArduinoCard_Block: "ArduinoCard_Card" = None):
...
class ArduinoCard_Transition:
    ...
    def __init__(self, name: str, ArduinoCard_Transition5: "ArduinoCard_State" = None, ArduinoCard_Transition8: set["ArduinoCard_Condition"] = None, ArduinoCard_Transition: "ArduinoCard_State" = None, ArduinoCard_Transition16: "ArduinoCard_Card" = None):
        self.name = name
...
class ArduinoCard_State:
    ...
    def __init__(self, name: str, isInitial: bool, ArduinoCard_State6: "ArduinoCard_Transition" = None, ArduinoCard_State13: "ArduinoCard_Card" = None, ArduinoCard_State: set["ArduinoCard_Transition"] = None, ArduinoCard_State2: set["ArduinoCard_Command"] = None):
        self.name = name
