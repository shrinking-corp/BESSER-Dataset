...
# Classes
ArduinoCard_Sensor = Class(name="ArduinoCard_Sensor")
Block = Class(name="Block")
ArduinoCard_Actuator = Class(name="ArduinoCard_Actuator")
ArduinoCard_Condition = Class(name="ArduinoCard_Condition")
BlockInteraction = Class(name="BlockInteraction")
ArduinoCard_Card = Class(name="ArduinoCard_Card")
ArduinoCard_State = Class(name="ArduinoCard_State")
ArduinoCard_Transition = Class(name="ArduinoCard_Transition")
ArduinoCard_Command = Class(name="ArduinoCard_Command")
ArduinoCard_Block = Class(name="ArduinoCard_Block", is_abstract=True)
ArduinoCard_BlockInteraction = Class(name="ArduinoCard_BlockInteraction", is_abstract=True)
...
ArduinoCard_Block.attributes={ArduinoCard_Block_name, ArduinoCard_Block_isAnalogic, ArduinoCard_Block_pinNumber}
...
ArduinoCard_BlockInteraction.attributes={ArduinoCard_BlockInteraction_name, ArduinoCard_BlockInteraction_isHigh}
...
domain_model = DomainModel(
    name="ArduinoCard",
    types={ArduinoCard_Sensor, Block, ArduinoCard_Actuator, ArduinoCard_Condition, BlockInteraction, ArduinoCard_Card, ArduinoCard_State, ArduinoCard_Transition, ArduinoCard_Command, ArduinoCard_Block, ArduinoCard_BlockInteraction},
    associations={Sensor3, nextState4, Condition7, Actuator10, States12, Transitions0, Command1, Transitions14, BlockInteractions17, Blocks19},
