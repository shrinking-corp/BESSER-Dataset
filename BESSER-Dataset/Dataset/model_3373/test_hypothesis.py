...
def test_ddl_text_is_not_abstract():
    assert not inspect.isabstract(DDL_Text)


def test_ddl_text_constructor_exists():
    assert callable(DDL_Text.__init__)


def test_ddl_text_constructor_args():
...
def test_ddl_column_has_scale():
    assert hasattr(DDL_Column, "scale")
    descriptor = None
    for klass in DDL_Column.__mro__:
...
def test_ddl_column_has_precision():
    assert hasattr(DDL_Column, "precision")
    descriptor = None
    for klass in DDL_Column.__mro__:
...
@given(instance=DDL_Column_strategy)
def test_ddl_column_scale_setter(instance):
...
@given(instance=DDL_Column_strategy)
def test_ddl_column_precision_setter(instance):
