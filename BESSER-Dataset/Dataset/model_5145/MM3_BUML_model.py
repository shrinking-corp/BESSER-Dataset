...
# Classes
testmerge_A3 = Class(name="testmerge_A3")
SuperA3 = Class(name="SuperA3")
testmerge_B3 = Class(name="testmerge_B3")
testmerge_SuperA3 = Class(name="testmerge_SuperA3")
...
testmerge_B3_m_getA: Method = Method(name="getA", parameters={Parameter(name='testmerge_paramB', type=StringType)}, type=StringType)
