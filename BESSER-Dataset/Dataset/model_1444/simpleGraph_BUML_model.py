...
domain_model = DomainModel(
    ...
    generalizations={gen_simpleGraph_Graph_GraphElement, gen_simpleGraph_Position_GraphElement, gen_simpleGraph_Nail_Position, gen_simpleGraph_Edge_GraphElement, gen_simpleGraph_Node_Position, gen_simpleGraph_Label_Position},
    metadata=None
)
