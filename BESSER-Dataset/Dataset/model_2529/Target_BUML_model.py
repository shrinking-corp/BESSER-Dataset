...
# Classes
target_G = Class(name="target_G")
F = Class(name="F")
target_E = Class(name="target_E")
target_F = Class(name="target_F")
target_H = Class(name="target_H")
...
domain_model = DomainModel(
    name="target",
    types={target_G, F, target_E, target_F, target_H},
    associations={f0},
