...
class simplePDL_WorkDefinition(ABC):
    ...
    def __init__(self, name: str, simplePDL_WorkDefinition: "simplePDL_Process" = None, linksToSuccessors: "simplePDL_WorkSequence" = None, linksToPredecessors: "simplePDL_WorkSequence" = None, simplePDL_WorkDefinition7: set["simplePDL_WorkDefinitionParameter"] = None, WorkDefinition: "simplePDL_WorkSequence" = None, WorkDefinition10: "simplePDL_WorkSequence" = None):
        self.name = name
