...
simplePDL_WorkDefinition = Class(name="simplePDL_WorkDefinition", is_abstract=True)
simplePDL_WorkSequence = Class(name="simplePDL_WorkSequence")
simplePDL_WorkDefinitionParameter = Class(name="simplePDL_WorkDefinitionParameter")
simplePDL_SubProcess = Class(name="simplePDL_SubProcess")
WorkDefinition = Class(name="WorkDefinition")
simplePDL_Activity = Class(name="simplePDL_Activity")
simplePDL_WorkProduct = Class(name="simplePDL_WorkProduct")
...
domain_model = DomainModel(
    name="simplePDL",
    types={simplePDL_Process, simplePDL_WorkDefinition, simplePDL_WorkSequence, simplePDL_WorkDefinitionParameter, simplePDL_SubProcess, WorkDefinition, simplePDL_Activity, simplePDL_WorkProduct, WorkSequenceType, ParameterDirectionKind},
    associations={activities0, workSequences1, predecessor3, successor4, parameters6, linksToSuccessors8, linksToPredecessors9, parameterType11},
