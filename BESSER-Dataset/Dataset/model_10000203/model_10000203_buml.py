...
domain_model = DomainModel(
    name="_192e0296_6985_4795_ac9f_310027f52ff1",
    ...
    associations={Login_View_Grades, Submit_Exam_Assignment_Login, School_Admin_Course, Student_Course, Exam_Question, Question_Answer, Course_Exam, Admin_Login, Admin_Logout, Instructor_Logout, Student_Logout, Instructor_Login, Login_Student, Login_Add_Student, Login_Add_Instructor, Login_Add_Course, Login_Add_Evalutaions_Assignments_Exams, Login_Generate_Report, Login_Register_drop_course},
    generalizations={},
    metadata=None
)
