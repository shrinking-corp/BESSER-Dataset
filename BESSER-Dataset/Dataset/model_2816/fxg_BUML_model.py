...
# Classes
fxg_Matrix = Class(name="fxg_Matrix")
fxg_ColorTransform = Class(name="fxg_ColorTransform")
fxg_Graphic = Class(name="fxg_Graphic")
fxg_Group = Class(name="fxg_Group")
fxg_Library = Class(name="fxg_Library")
fxg_Private = Class(name="fxg_Private")
FXGElement = Class(name="FXGElement")
fxg_Definition = Class(name="fxg_Definition")
fxg_Transform = Class(name="fxg_Transform")
fxg_Filter = Class(name="fxg_Filter", is_abstract=True)
fxg_PlaceObject = Class(name="fxg_PlaceObject")
fxg_Path = Class(name="fxg_Path")
fxg_Fill = Class(name="fxg_Fill", is_abstract=True)
fxg_Stroke = Class(name="fxg_Stroke", is_abstract=True)
fxg_Shape = Class(name="fxg_Shape", is_abstract=True)
fxg_Rect = Class(name="fxg_Rect")
Shape = Class(name="Shape")
fxg_Ellipse = Class(name="fxg_Ellipse")
fxg_Line = Class(name="fxg_Line")
fxg_RichText = Class(name="fxg_RichText")
...
fxg_RichTextContent = Class(name="fxg_RichTextContent", is_abstract=True)
fxg_RichTextContentContainer = Class(name="fxg_RichTextContentContainer")
RichTextContent = Class(name="RichTextContent")
fxg_rawtext = Class(name="fxg_rawtext")
fxg_ParagraphAttributes = Class(name="fxg_ParagraphAttributes", is_abstract=True)
fxg_ContainerAttributes = Class(name="fxg_ContainerAttributes", is_abstract=True)
fxg_CharacterAttributes = Class(name="fxg_CharacterAttributes", is_abstract=True)
fxg_BitmapFill = Class(name="fxg_BitmapFill")
fxg_div = Class(name="fxg_div")
RichTextContentContainer = Class(name="RichTextContentContainer")
fxg_p = Class(name="fxg_p")
fxg_tcy = Class(name="fxg_tcy")
fxg_a = Class(name="fxg_a")
fxg_img = Class(name="fxg_img")
fxg_span = Class(name="fxg_span")
fxg_br = Class(name="fxg_br")
fxg_tab = Class(name="fxg_tab")
fxg_linkNormalFormat = Class(name="fxg_linkNormalFormat")
fxg_linkHoverFormat = Class(name="fxg_linkHoverFormat")
fxg_linkActiveFormat = Class(name="fxg_linkActiveFormat")
fxg_BitmapImage = Class(name="fxg_BitmapImage")
fxg_SolidColor = Class(name="fxg_SolidColor")
Fill = Class(name="Fill")
fxg_LinearGradient = Class(name="fxg_LinearGradient")
fxg_RadialGradient = Class(name="fxg_RadialGradient")
fxg_RadialGradientStroke = Class(name="fxg_RadialGradientStroke")
fxg_SolidColorStroke = Class(name="fxg_SolidColorStroke")
Stroke = Class(name="Stroke")
fxg_GradientEntry = Class(name="fxg_GradientEntry")
fxg_LinearGradientStroke = Class(name="fxg_LinearGradientStroke")
fxg_BlurFilter = Class(name="fxg_BlurFilter")
Filter = Class(name="Filter")
fxg_GradientGlowFilter = Class(name="fxg_GradientGlowFilter")
fxg_GradientBevelFilter = Class(name="fxg_GradientBevelFilter")
fxg_ColorMatrixFilter = Class(name="fxg_ColorMatrixFilter")
fxg_DropShadowFilter = Class(name="fxg_DropShadowFilter")
fxg_BevelFilter = Class(name="fxg_BevelFilter")
fxg_FXGElement = Class(name="fxg_FXGElement", is_abstract=True)
fxg_ContainerElement = Class(name="fxg_ContainerElement")
...
fxg_Matrix.attributes={fxg_Matrix_d, fxg_Matrix_ty, fxg_Matrix_b, fxg_Matrix_tx, fxg_Matrix_c, fxg_Matrix_a}
...
fxg_ColorTransform.attributes={fxg_ColorTransform_blueMultiplier, fxg_ColorTransform_alphaOffset, fxg_ColorTransform_blueOffset, fxg_ColorTransform_redMultiplier, fxg_ColorTransform_greenOffset, fxg_ColorTransform_alphaMultiplier, fxg_ColorTransform_redOffset, fxg_ColorTransform_greenMultiplier}
...
fxg_Graphic.attributes={fxg_Graphic_scaleGridTop, fxg_Graphic_viewWidth, fxg_Graphic_version, fxg_Graphic_scaleGridBottom, fxg_Graphic_scaleGridLeft, fxg_Graphic_viewHeight, fxg_Graphic_scaleGridRight}
...
fxg_Group.attributes={fxg_Group_rotation, fxg_Group_scaleGridLeft, fxg_Group_scaleGridBottom, fxg_Group_y, fxg_Group_blendMode, fxg_Group_transformY, fxg_Group_id, fxg_Group_scaleGridTop, fxg_Group_transformX, fxg_Group_scaleY, fxg_Group_visible, fxg_Group_x, fxg_Group_scaleX, fxg_Group_alpha, fxg_Group_maskType, fxg_Group_scaleGridRight}
...
fxg_Path.attributes={fxg_Path_winding, fxg_Path_scaleX, fxg_Path_data, fxg_Path_blendMode, fxg_Path_alpha, fxg_Path_x, fxg_Path_scaleY, fxg_Path_visible, fxg_Path_rotation, fxg_Path_y}
...
fxg_Rect.attributes={fxg_Rect_radiusY, fxg_Rect_y, fxg_Rect_topLeftRadiusX, fxg_Rect_visible, fxg_Rect_blendMode, fxg_Rect_scaleY, fxg_Rect_height, fxg_Rect_bottomRightRadiusY, fxg_Rect_x, fxg_Rect_scaleX, fxg_Rect_rotation, fxg_Rect_bottomRightRadiusX, fxg_Rect_radiusX, fxg_Rect_bottomLeftRadiusY, fxg_Rect_topLeftRadiusY, fxg_Rect_alpha, fxg_Rect_width, fxg_Rect_topRightRadiusY, fxg_Rect_topRightRadiusX, fxg_Rect_bottomLeftRadiusX}
...
fxg_Ellipse.attributes={fxg_Ellipse_width, fxg_Ellipse_x, fxg_Ellipse_y, fxg_Ellipse_scaleX, fxg_Ellipse_scaleY, fxg_Ellipse_blendMode, fxg_Ellipse_alpha, fxg_Ellipse_visible, fxg_Ellipse_rotation, fxg_Ellipse_height}
...
fxg_Line.attributes={fxg_Line_scaleX, fxg_Line_alpha, fxg_Line_maskType, fxg_Line_visible, fxg_Line_y, fxg_Line_yFrom, fxg_Line_xFrom, fxg_Line_blendMode, fxg_Line_x, fxg_Line_xTo, fxg_Line_id, fxg_Line_rotation, fxg_Line_yTo, fxg_Line_scaleY}
...
fxg_RichText.attributes={fxg_RichText_scaleY, fxg_RichText_visible, fxg_RichText_width, fxg_RichText_height, fxg_RichText__tempcontent, fxg_RichText_blendMode, fxg_RichText_maskType, fxg_RichText_x, fxg_RichText_alpha, fxg_RichText_id, fxg_RichText_rotation, fxg_RichText_y, fxg_RichText_scaleX}
...
fxg_ParagraphAttributes.attributes={fxg_ParagraphAttributes_paragraphSpaceBefore, fxg_ParagraphAttributes_tabStops, fxg_ParagraphAttributes_paragraphSpaceAfter, fxg_ParagraphAttributes_paragraphStartIndent, fxg_ParagraphAttributes_textAlign, fxg_ParagraphAttributes_textJustify, fxg_ParagraphAttributes_textIndent, fxg_ParagraphAttributes_justificationStyle, fxg_ParagraphAttributes_leadingModel, fxg_ParagraphAttributes_textAlignLast, fxg_ParagraphAttributes_paragraphEndIndent, fxg_ParagraphAttributes_justificationRule}
...
fxg_ContainerAttributes.attributes={fxg_ContainerAttributes_paddingLeft, fxg_ContainerAttributes_lineBreak, fxg_ContainerAttributes_blockProgression, fxg_ContainerAttributes_columnGap, fxg_ContainerAttributes_firstBaselineOffset, fxg_ContainerAttributes_paddingTop, fxg_ContainerAttributes_columnWidth, fxg_ContainerAttributes_columnCount, fxg_ContainerAttributes_verticalAlign, fxg_ContainerAttributes_paddingBottom, fxg_ContainerAttributes_paddingRight}
...
fxg_CharacterAttributes.attributes={fxg_CharacterAttributes_kerning, fxg_CharacterAttributes_backgroundAlpha, fxg_CharacterAttributes_trackingLeft, fxg_CharacterAttributes_lineThrough, fxg_CharacterAttributes_dominantBaseline, fxg_CharacterAttributes_fontFamily, fxg_CharacterAttributes_digitWidth, fxg_CharacterAttributes_textAlpha, fxg_CharacterAttributes_digitCase, fxg_CharacterAttributes_color, fxg_CharacterAttributes_breakOpportunity, fxg_CharacterAttributes_textRotation, fxg_CharacterAttributes_baselineShift, fxg_CharacterAttributes_lineHeight, fxg_CharacterAttributes_backgroundColor, fxg_CharacterAttributes_fontSize, fxg_CharacterAttributes_typographicCase, fxg_CharacterAttributes_locale, fxg_CharacterAttributes_fontStyle, fxg_CharacterAttributes_textDecoration, fxg_CharacterAttributes_ligatureLevel, fxg_CharacterAttributes_whiteSpaceCollapse, fxg_CharacterAttributes_trackingRight, fxg_CharacterAttributes_alignmentBaseline, fxg_CharacterAttributes_fontWeight}
...
fxg_BitmapFill.attributes={fxg_BitmapFill_source, fxg_BitmapFill_y, fxg_BitmapFill_scaleX, fxg_BitmapFill_x, fxg_BitmapFill_scaleY, fxg_BitmapFill_fillMode, fxg_BitmapFill_rotation}
...
fxg_BitmapImage.attributes={fxg_BitmapImage_height, fxg_BitmapImage_blendMode, fxg_BitmapImage_y, fxg_BitmapImage_x, fxg_BitmapImage_visible, fxg_BitmapImage_rotation, fxg_BitmapImage_fillMode, fxg_BitmapImage_scaleY, fxg_BitmapImage_alpha, fxg_BitmapImage_scaleX, fxg_BitmapImage_source, fxg_BitmapImage_width}
...
fxg_LinearGradient.attributes={fxg_LinearGradient_x, fxg_LinearGradient_scaleX, fxg_LinearGradient_rotation, fxg_LinearGradient_y, fxg_LinearGradient_spreadMethod, fxg_LinearGradient_interpolationMethod}
...
fxg_RadialGradient.attributes={fxg_RadialGradient_x, fxg_RadialGradient_interpolationMethod, fxg_RadialGradient_y, fxg_RadialGradient_focalPointRatio, fxg_RadialGradient_scaleY, fxg_RadialGradient_scaleX, fxg_RadialGradient_rotation, fxg_RadialGradient_spreadMethod}
...
fxg_RadialGradientStroke.attributes={fxg_RadialGradientStroke_joints, fxg_RadialGradientStroke_pixelHinting, fxg_RadialGradientStroke_scaleMode, fxg_RadialGradientStroke_miterLimit, fxg_RadialGradientStroke_weight, fxg_RadialGradientStroke_focalPointRatio, fxg_RadialGradientStroke_scaleY, fxg_RadialGradientStroke_scaleX, fxg_RadialGradientStroke_y, fxg_RadialGradientStroke_spreadMethod, fxg_RadialGradientStroke_x, fxg_RadialGradientStroke_caps, fxg_RadialGradientStroke_interpolationMethod, fxg_RadialGradientStroke_rotation}
...
fxg_SolidColorStroke.attributes={fxg_SolidColorStroke_caps, fxg_SolidColorStroke_scaleMode, fxg_SolidColorStroke_joints, fxg_SolidColorStroke_alpha, fxg_SolidColorStroke_color, fxg_SolidColorStroke_pixelHinting, fxg_SolidColorStroke_miterLimit, fxg_SolidColorStroke_weight}
...
fxg_LinearGradientStroke.attributes={fxg_LinearGradientStroke_rotation, fxg_LinearGradientStroke_joints, fxg_LinearGradientStroke_caps, fxg_LinearGradientStroke_scaleMode, fxg_LinearGradientStroke_interpolationMethod, fxg_LinearGradientStroke_y, fxg_LinearGradientStroke_miterLimit, fxg_LinearGradientStroke_x, fxg_LinearGradientStroke_pixelHinting, fxg_LinearGradientStroke_scaleX, fxg_LinearGradientStroke_spreadMethod, fxg_LinearGradientStroke_weight}
...
fxg_GradientGlowFilter.attributes={fxg_GradientGlowFilter_blurX, fxg_GradientGlowFilter_inner, fxg_GradientGlowFilter_strength, fxg_GradientGlowFilter_blurY, fxg_GradientGlowFilter_angle, fxg_GradientGlowFilter_distance, fxg_GradientGlowFilter_quality, fxg_GradientGlowFilter_knockout}
...
fxg_GradientBevelFilter.attributes={fxg_GradientBevelFilter_quality, fxg_GradientBevelFilter_distance, fxg_GradientBevelFilter_blurY, fxg_GradientBevelFilter_angle, fxg_GradientBevelFilter_blurX, fxg_GradientBevelFilter_knockout, fxg_GradientBevelFilter_type, fxg_GradientBevelFilter_strength}
...
fxg_DropShadowFilter.attributes={fxg_DropShadowFilter_quality, fxg_DropShadowFilter_strength, fxg_DropShadowFilter_hideObject, fxg_DropShadowFilter_blurX, fxg_DropShadowFilter_angle, fxg_DropShadowFilter_color, fxg_DropShadowFilter_alpha, fxg_DropShadowFilter_knockout, fxg_DropShadowFilter_distance, fxg_DropShadowFilter_blurY, fxg_DropShadowFilter_inner}
...
fxg_BevelFilter.attributes={fxg_BevelFilter_highlightColor, fxg_BevelFilter_strength, fxg_BevelFilter_blurY, fxg_BevelFilter_knockout, fxg_BevelFilter_blurX, fxg_BevelFilter_distance, fxg_BevelFilter_angle, fxg_BevelFilter_shadowAlpha, fxg_BevelFilter_highlightAlpha, fxg_BevelFilter_shadowColor, fxg_BevelFilter_quality, fxg_BevelFilter_type}
...
domain_model = DomainModel(
    name="fxg",
    types={fxg_Matrix, fxg_ColorTransform, fxg_Graphic, fxg_Group, fxg_Library, fxg_Private, FXGElement, fxg_Definition, fxg_Transform, fxg_Filter, fxg_PlaceObject, fxg_Path, fxg_Fill, fxg_Stroke, fxg_Shape, fxg_Rect, Shape, fxg_Ellipse, fxg_Line, fxg_RichText, ParagraphAttributes, ContainerAttributes, CharacterAttributes, fxg_RichTextContent, fxg_RichTextContentContainer, RichTextContent, fxg_rawtext, fxg_ParagraphAttributes, fxg_ContainerAttributes, fxg_CharacterAttributes, fxg_BitmapFill, fxg_div, RichTextContentContainer, fxg_p, fxg_tcy, fxg_a, fxg_img, fxg_span, fxg_br, fxg_tab, fxg_linkNormalFormat, fxg_linkHoverFormat, fxg_linkActiveFormat, fxg_BitmapImage, fxg_SolidColor, Fill, fxg_LinearGradient, fxg_RadialGradient, fxg_RadialGradientStroke, fxg_SolidColorStroke, Stroke, fxg_GradientEntry, fxg_LinearGradientStroke, fxg_BlurFilter, Filter, fxg_GradientGlowFilter, fxg_GradientBevelFilter, fxg_ColorMatrixFilter, fxg_DropShadowFilter, fxg_BevelFilter, fxg_FXGElement, fxg_ContainerElement, BlendMode, TextDecoration, WhitespaceCollapse, Kerning, SpreadMethod, InterpolationMethod, Cap, Joint, ScaleMode, BevelFilterType, FillMode, TextAlign, JustificationRule, JustificationStyle, TextJustify, Winding, MaskType, FontStyle, FontWeight, BreakOpportunity, DigitCase, DigitWidth, DominantBaseline, AlignmentBaseline, LigatureLevel, TypographicCase, TextRotation, LeadingModel, BlockProgression, VerticalAlign, LineBreak},
    associations={matrix8, colorTransform10, mask0, transform1, filters3, mask6, transform12, filters14, mask17, fill20, stroke21, filters23, transform26, mask29, transform32, filters34, fill37, stroke40, mask43, transform46, filters48, fill51, stroke54, mask57, transform60, filters62, fill65, stroke68, mask71, content74, _children75, matrix79, matrix77, matrix81, matrix85, matrix83},
    generalizations={gen_fxg_Transform_FXGElement, gen_fxg_Private_FXGElement, gen_fxg_PlaceObject_FXGElement, gen_fxg_Matrix_FXGElement, gen_fxg_Path_FXGElement, gen_fxg_Shape_FXGElement, gen_fxg_Rect_Shape, gen_fxg_Ellipse_Shape, gen_fxg_Line_Shape, gen_fxg_RichText_FXGElement, gen_fxg_RichText_ParagraphAttributes, gen_fxg_RichText_ContainerAttributes, gen_fxg_RichText_CharacterAttributes, gen_fxg_RichTextContentContainer_RichTextContent, gen_fxg_rawtext_RichTextContent, gen_fxg_BitmapFill_Fill, gen_fxg_div_RichTextContent, gen_fxg_div_RichTextContentContainer, gen_fxg_p_RichTextContent, gen_fxg_p_RichTextContentContainer, gen_fxg_p_ParagraphAttributes, gen_fxg_tcy_RichTextContent, gen_fxg_tcy_RichTextContentContainer, gen_fxg_a_RichTextContent, gen_fxg_a_RichTextContentContainer, gen_fxg_img_RichTextContent, gen_fxg_span_RichTextContent, gen_fxg_span_RichTextContentContainer, gen_fxg_br_RichTextContent, gen_fxg_tab_RichTextContent, gen_fxg_linkNormalFormat_RichTextContent, gen_fxg_linkHoverFormat_RichTextContent, gen_fxg_BitmapImage_FXGElement, gen_fxg_Fill_FXGElement, gen_fxg_SolidColor_Fill, gen_fxg_Stroke_FXGElement, gen_fxg_SolidColorStroke_Stroke, gen_fxg_GradientEntry_FXGElement, gen_fxg_ColorTransform_FXGElement, gen_fxg_Filter_FXGElement, gen_fxg_BlurFilter_Filter, gen_fxg_BevelFilter_Filter, gen_fxg_ColorMatrixFilter_Filter, gen_fxg_DropShadowFilter_Filter, gen_fxg_ContainerElement_FXGElement},
    metadata=None
)
