...
# Classes
complexStateMachineMetaModel_ComplexStateMachine = Class(name="complexStateMachineMetaModel_ComplexStateMachine")
complexStateMachineMetaModel_State = Class(name="complexStateMachineMetaModel_State")
complexStateMachineMetaModel_Transition = Class(name="complexStateMachineMetaModel_Transition")
State = Class(name="State")
complexStateMachineMetaModel_CompositeState = Class(name="complexStateMachineMetaModel_CompositeState")
...
domain_model = DomainModel(
    ...
    types={complexStateMachineMetaModel_ComplexStateMachine, complexStateMachineMetaModel_State, complexStateMachineMetaModel_Transition, State, complexStateMachineMetaModel_CompositeState},
    associations={InitialState3, ComplexStateMachine4, Source6, Target8, ComplexStateMachine10, Outgoing12, States0, Transitions1, States18, InitialState21, Incoming14, CompositeState16},
