...
class complexStateMachineMetaModel_Transition:
    ...
    def __init__(self, Name: str, Transitions: "complexStateMachineMetaModel_ComplexStateMachine" = None, Outgoing: "complexStateMachineMetaModel_State" = None, Incoming: "complexStateMachineMetaModel_State" = None, Transition13: "complexStateMachineMetaModel_State" = None, Transition: "complexStateMachineMetaModel_ComplexStateMachine" = None, Transition15: "complexStateMachineMetaModel_State" = None):
        self.Name = Name
...
class complexStateMachineMetaModel_State:
    ...
    def __init__(self, Name: str, State7: "complexStateMachineMetaModel_Transition" = None, State9: "complexStateMachineMetaModel_Transition" = None, States: "complexStateMachineMetaModel_ComplexStateMachine" = None, Source: set["complexStateMachineMetaModel_Transition"] = None, State: "complexStateMachineMetaModel_ComplexStateMachine" = None, State20: "complexStateMachineMetaModel_CompositeState" = None, complexStateMachineMetaModel_State22: "complexStateMachineMetaModel_CompositeState" = None, Target: set["complexStateMachineMetaModel_Transition"] = None, States17: "complexStateMachineMetaModel_CompositeState" = None, complexStateMachineMetaModel_State: "complexStateMachineMetaModel_ComplexStateMachine" = None):
        self.Name = Name
        self.State7 = State7
        self.State9 = State9
        self.States = States
...
class complexStateMachineMetaModel_ComplexStateMachine:
    ...
    def __init__(self, Name: str, ComplexStateMachine5: "complexStateMachineMetaModel_Transition" = None, ComplexStateMachine11: "complexStateMachineMetaModel_State" = None, ComplexStateMachine: set["complexStateMachineMetaModel_State"] = None, ComplexStateMachine2: set["complexStateMachineMetaModel_Transition"] = None, complexStateMachineMetaModel_ComplexStateMachine: "complexStateMachineMetaModel_State" = None):
        self.Name = Name
