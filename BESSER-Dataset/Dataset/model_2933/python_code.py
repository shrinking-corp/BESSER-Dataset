...
class domainmodel_Feature:
    ...
    def __init__(self, required: bool, many: bool, name: str, domainmodel_Feature: "domainmodel_Entity" = None, domainmodel_Feature8: "domainmodel_Type" = None, domainmodel_Feature10: "domainmodel_Limits" = None):
