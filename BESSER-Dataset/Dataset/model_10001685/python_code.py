...
class Union:
    ...
    def __init__(self, dateUnion: str, pers13: set["Personne"] = None, personnes15: set["Personne"] = None):
        self.dateUnion = dateUnion
        self.pers13 = pers13 if pers13 is not None else set()
    ...
    @property
    def pers13(self):
        return self.__pers13
    @pers13.setter
    def pers13(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_Union__pers13", None)
        self.__pers13 = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "union12"):
                    opp_val = getattr(item, "union12", None)
    ...
    def personnes15(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "unionActuelles14"):
                    opp_val = getattr(item, "unionActuelles14", None)
                    
                    if opp_val == self:
                        setattr(item, "unionActuelles14", None)
        ...
        if value is not None:
            for item in value:
                if hasattr(item, "unionActuelles14"):
                    ...
                    setattr(item, "unionActuelles14", self)
...
class C2:
    ...
    def __init__(self, attC1: int, attC2: int, b9: "B2" = None):
        self.attC1 = attC1
        self.attC2 = attC2
        self.b9 = b9
    ...
    def b9(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_C2__b9", None)
        self.__b9 = value
...
class B2:
    ...
    def __init__(self, attB: int, a7: "A2" = None, c8: set["C2"] = None):
        self.attB = attB
        self.a7 = a7
    ...
    def c8(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_B2__c8", None)
    ...
    def a7(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_B2__a7", None)
        self.__a7 = value
...
class A2:
    ...
    def __init__(self, attA: str, r5: "R" = None, b6: set["B2"] = None):
        self.attA = attA
        self.r5 = r5
    ...
    def r5(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_A2__r5", None)
        self.__r5 = value
    ...
    def b6(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_A2__b6", None)
