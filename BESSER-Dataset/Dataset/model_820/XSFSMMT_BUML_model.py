...
fsm_StateMachine.methods={fsm_StateMachine_m_step, fsm_StateMachine_m_main, fsm_StateMachine_m_assignInitialValues}
...
domain_model = DomainModel(
    name="fsm",
    types={fsm_Transition, fsm_Variable, fsm_StateMachine, NamedElement, fsm_State, fsm_NumberGuard, Guard, fsm_EqualNumberGuard, NumberGuard, fsm_AssignValueAction, Action, fsm_LessThanNumberGuard, fsm_GreaterThanNumberGuard, fsm_IncreaseValueAction, fsm_Guard, fsm_Action, fsm_NamedElement, fsm_NumberVariable, Variable, fsm_DecreaseValueAction},
    associations={ownedStates0, initialState1, ownedTransitions2, variables4, currentState6, owningFSM9, outgoingTransitions10, incomingTransitions11, source13, source21, target22, target15, guard17, action19},
    generalizations={gen_fsm_State_NamedElement, gen_fsm_Transition_NamedElement, gen_fsm_StateMachine_NamedElement, gen_fsm_NumberGuard_Guard, gen_fsm_EqualNumberGuard_NumberGuard, gen_fsm_AssignValueAction_Action, gen_fsm_LessThanNumberGuard_NumberGuard, gen_fsm_GreaterThanNumberGuard_NumberGuard, gen_fsm_IncreaseValueAction_Action, gen_fsm_NumberVariable_Variable, gen_fsm_DecreaseValueAction_Action},
    metadata=None
)
