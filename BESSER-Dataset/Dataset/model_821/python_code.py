...
class fsm_StateMachine(NamedElement):
    ...
    def __init__(self, fsm_StateMachine3: set["fsm_Transition"] = None, fsm_StateMachine5: set["fsm_Variable"] = None, fsm_StateMachine7: "fsm_State" = None, StateMachine: "fsm_State" = None, owningFSM: set["fsm_State"] = None, fsm_StateMachine: "fsm_State" = None):
