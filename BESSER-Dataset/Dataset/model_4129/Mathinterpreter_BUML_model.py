...
# Classes
mathinterpreter_VariableDefinition = Class(name="mathinterpreter_VariableDefinition")
...
domain_model = DomainModel(
    ...
    types={mathinterpreter_VariableDefinition, MathExpression, mathinterpreter_Variable, mathinterpreter_Function, mathinterpreter_PMExpression, mathinterpreter_DefineExpr, DefParenthesis, mathinterpreter_EObject, mathinterpreter_MDExpression, PMExpression, mathinterpreter_PlusMinus, mathinterpreter_MultiplyDivide, mathinterpreter_Primary, MDExpression, mathinterpreter_VariableName, Primary, mathinterpreter_Model, mathinterpreter_MathExpression, mathinterpreter_Minus, mathinterpreter_Multiply, MultiplyDivide, mathinterpreter_Divide, mathinterpreter_Number, mathinterpreter_Positive, Number, mathinterpreter_Negative, mathinterpreter_PMParenthesis, mathinterpreter_DefParenthesis, mathinterpreter_Plus, PlusMinus},
    associations={variable1, expression2, variables3, expression5, expression8, left12, operator14, right16, mathexpression0, expression18},
    generalizations={gen_mathinterpreter_VariableDefinition_MathExpression, gen_mathinterpreter_Function_MathExpression, gen_mathinterpreter_DefineExpr_MathExpression, gen_mathinterpreter_DefineExpr_DefParenthesis, gen_mathinterpreter_MDExpression_PMExpression, gen_mathinterpreter_Primary_MDExpression, gen_mathinterpreter_VariableName_Primary, gen_mathinterpreter_Minus_PlusMinus, gen_mathinterpreter_Multiply_MultiplyDivide, gen_mathinterpreter_Divide_MultiplyDivide, gen_mathinterpreter_Number_Primary, gen_mathinterpreter_Positive_Number, gen_mathinterpreter_Negative_Number, gen_mathinterpreter_PMParenthesis_Primary, gen_mathinterpreter_DefParenthesis_Primary, gen_mathinterpreter_Plus_PlusMinus},
    metadata=None
)
