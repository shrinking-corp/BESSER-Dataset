...
class mathinterpreter_Variable:
    ...
    def __init__(self, name: str, mathinterpreter_Variable: "mathinterpreter_VariableDefinition" = None, mathinterpreter_Variable4: "mathinterpreter_DefineExpr" = None, mathinterpreter_Variable9: "mathinterpreter_PMExpression" = None):
        self.name = name
