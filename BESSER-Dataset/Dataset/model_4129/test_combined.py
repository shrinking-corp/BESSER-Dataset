...
def test_hyp_mathinterpreter_variabledefinition_is_not_abstract():
    assert not inspect.isabstract(mathinterpreter_VariableDefinition)


def test_hyp_mathinterpreter_variabledefinition_constructor_exists():
    assert callable(mathinterpreter_VariableDefinition.__init__)


def test_hyp_mathinterpreter_variabledefinition_constructor_args():
