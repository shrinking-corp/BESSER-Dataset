...
def test_hyp_oclinecorecst_referenceref_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_ReferenceRef)


def test_hyp_oclinecorecst_referenceref_constructor_exists():
    assert callable(oclinEcoreCST_ReferenceRef.__init__)


def test_hyp_oclinecorecst_referenceref_constructor_args():
    sig = inspect.signature(oclinEcoreCST_ReferenceRef.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oclinecorecst_importcs_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_ImportCS)


def test_hyp_oclinecorecst_importcs_constructor_exists():
    assert callable(oclinEcoreCST_ImportCS.__init__)


def test_hyp_oclinecorecst_importcs_constructor_args():
...
def test_hyp_oclinecorecst_documentcs_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_DocumentCS)


def test_hyp_oclinecorecst_documentcs_constructor_exists():
    assert callable(oclinEcoreCST_DocumentCS.__init__)


def test_hyp_oclinecorecst_documentcs_constructor_args():
    sig = inspect.signature(oclinEcoreCST_DocumentCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_datatyperef_is_not_abstract():
    assert not inspect.isabstract(DataTypeRef)


def test_hyp_datatyperef_constructor_exists():
    assert callable(DataTypeRef.__init__)


def test_hyp_datatyperef_constructor_args():
    sig = inspect.signature(DataTypeRef.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oclinecorecst_datatypecsref_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_DataTypeCSRef)


def test_hyp_oclinecorecst_datatypecsref_constructor_exists():
    assert callable(oclinEcoreCST_DataTypeCSRef.__init__)


def test_hyp_oclinecorecst_datatypecsref_constructor_args():
    sig = inspect.signature(oclinEcoreCST_DataTypeCSRef.__init__)
    params = list(sig.parameters.keys())



def test_hyp_datatypeorenumcs_is_not_abstract():
    assert not inspect.isabstract(DataTypeOrEnumCS)


def test_hyp_datatypeorenumcs_constructor_exists():
    assert callable(DataTypeOrEnumCS.__init__)


def test_hyp_datatypeorenumcs_constructor_args():
    sig = inspect.signature(DataTypeOrEnumCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oclinecorecst_datatypecs_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_DataTypeCS)


def test_hyp_oclinecorecst_datatypecs_constructor_exists():
    assert callable(oclinEcoreCST_DataTypeCS.__init__)


def test_hyp_oclinecorecst_datatypecs_constructor_args():
    sig = inspect.signature(oclinEcoreCST_DataTypeCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oclinecorecst_oclexpressioncs_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_OclExpressionCS)


def test_hyp_oclinecorecst_oclexpressioncs_constructor_exists():
    assert callable(oclinEcoreCST_OclExpressionCS.__init__)


def test_hyp_oclinecorecst_oclexpressioncs_constructor_args():
...
def test_hyp_oclinecorecst_parametercs_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_ParameterCS)


def test_hyp_oclinecorecst_parametercs_constructor_exists():
    assert callable(oclinEcoreCST_ParameterCS.__init__)


def test_hyp_oclinecorecst_parametercs_constructor_args():
    sig = inspect.signature(oclinEcoreCST_ParameterCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oclinecorecst_modelelementcs_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_ModelElementCS)


def test_hyp_oclinecorecst_modelelementcs_constructor_exists():
    assert callable(oclinEcoreCST_ModelElementCS.__init__)


def test_hyp_oclinecorecst_modelelementcs_constructor_args():
    sig = inspect.signature(oclinEcoreCST_ModelElementCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oclinecorecst_enumcs_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_EnumCS)


def test_hyp_oclinecorecst_enumcs_constructor_exists():
    assert callable(oclinEcoreCST_EnumCS.__init__)


def test_hyp_oclinecorecst_enumcs_constructor_args():
    sig = inspect.signature(oclinEcoreCST_EnumCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oclinecorecst_ereference_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_EReference)


def test_hyp_oclinecorecst_ereference_constructor_exists():
    assert callable(oclinEcoreCST_EReference.__init__)


def test_hyp_oclinecorecst_ereference_constructor_args():
...
def test_hyp_oclinecorecst_referencecsref_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_ReferenceCSRef)


def test_hyp_oclinecorecst_referencecsref_constructor_exists():
    assert callable(oclinEcoreCST_ReferenceCSRef.__init__)


def test_hyp_oclinecorecst_referencecsref_constructor_args():
    sig = inspect.signature(oclinEcoreCST_ReferenceCSRef.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oclinecorecst_ereferenceref_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_EReferenceRef)


def test_hyp_oclinecorecst_ereferenceref_constructor_exists():
    assert callable(oclinEcoreCST_EReferenceRef.__init__)


def test_hyp_oclinecorecst_ereferenceref_constructor_args():
    sig = inspect.signature(oclinEcoreCST_EReferenceRef.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oclinecorecst_edatatype_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_EDataType)


def test_hyp_oclinecorecst_edatatype_constructor_exists():
    assert callable(oclinEcoreCST_EDataType.__init__)


def test_hyp_oclinecorecst_edatatype_constructor_args():
    sig = inspect.signature(oclinEcoreCST_EDataType.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oclinecorecst_edatatyperef_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_EDataTypeRef)


def test_hyp_oclinecorecst_edatatyperef_constructor_exists():
    assert callable(oclinEcoreCST_EDataTypeRef.__init__)


def test_hyp_oclinecorecst_edatatyperef_constructor_args():
    sig = inspect.signature(oclinEcoreCST_EDataTypeRef.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oclinecorecst_eclassifier_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_EClassifier)


def test_hyp_oclinecorecst_eclassifier_constructor_exists():
    assert callable(oclinEcoreCST_EClassifier.__init__)


def test_hyp_oclinecorecst_eclassifier_constructor_args():
    sig = inspect.signature(oclinEcoreCST_EClassifier.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oclinecorecst_eclass_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_EClass)


def test_hyp_oclinecorecst_eclass_constructor_exists():
    assert callable(oclinEcoreCST_EClass.__init__)


def test_hyp_oclinecorecst_eclass_constructor_args():
    sig = inspect.signature(oclinEcoreCST_EClass.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oclinecorecst_eattribute_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_EAttribute)


def test_hyp_oclinecorecst_eattribute_constructor_exists():
    assert callable(oclinEcoreCST_EAttribute.__init__)


def test_hyp_oclinecorecst_eattribute_constructor_args():
    sig = inspect.signature(oclinEcoreCST_EAttribute.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oclinecorecst_attributeref_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_AttributeRef)


def test_hyp_oclinecorecst_attributeref_constructor_exists():
    assert callable(oclinEcoreCST_AttributeRef.__init__)


def test_hyp_oclinecorecst_attributeref_constructor_args():
...
def test_hyp_oclinecorecst_eattributeref_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_EAttributeRef)


def test_hyp_oclinecorecst_eattributeref_constructor_exists():
    assert callable(oclinEcoreCST_EAttributeRef.__init__)


def test_hyp_oclinecorecst_eattributeref_constructor_args():
    sig = inspect.signature(oclinEcoreCST_EAttributeRef.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oclinecorecst_attributecsref_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_AttributeCSRef)


def test_hyp_oclinecorecst_attributecsref_constructor_exists():
    assert callable(oclinEcoreCST_AttributeCSRef.__init__)


def test_hyp_oclinecorecst_attributecsref_constructor_args():
...
def test_hyp_oclinecorecst_referencecs_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_ReferenceCS)


def test_hyp_oclinecorecst_referencecs_constructor_exists():
    assert callable(oclinEcoreCST_ReferenceCS.__init__)


def test_hyp_oclinecorecst_referencecs_constructor_args():
...
def test_hyp_oclinecorecst_attributecs_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_AttributeCS)


def test_hyp_oclinecorecst_attributecs_constructor_exists():
    assert callable(oclinEcoreCST_AttributeCS.__init__)


def test_hyp_oclinecorecst_attributecs_constructor_args():
    sig = inspect.signature(oclinEcoreCST_AttributeCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oclinecorecst_detailcs_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_DetailCS)


def test_hyp_oclinecorecst_detailcs_constructor_exists():
    assert callable(oclinEcoreCST_DetailCS.__init__)


def test_hyp_oclinecorecst_detailcs_constructor_args():
...
def test_hyp_oclinecorecst_namedelementcs_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_NamedElementCS)


def test_hyp_oclinecorecst_namedelementcs_constructor_exists():
    assert callable(oclinEcoreCST_NamedElementCS.__init__)


def test_hyp_oclinecorecst_namedelementcs_constructor_args():
...
def test_hyp_oclinecorecst_annotationcs_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_AnnotationCS)


def test_hyp_oclinecorecst_annotationcs_constructor_exists():
    assert callable(oclinEcoreCST_AnnotationCS.__init__)


def test_hyp_oclinecorecst_annotationcs_constructor_args():
...
def test_hyp_oclinecorecst_classifierref_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_ClassifierRef)


def test_hyp_oclinecorecst_classifierref_constructor_exists():
    assert callable(oclinEcoreCST_ClassifierRef.__init__)


def test_hyp_oclinecorecst_classifierref_constructor_args():
...
def test_hyp_oclinecorecst_enumliteralcs_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_EnumLiteralCS)


def test_hyp_oclinecorecst_enumliteralcs_constructor_exists():
    assert callable(oclinEcoreCST_EnumLiteralCS.__init__)


def test_hyp_oclinecorecst_enumliteralcs_constructor_args():
...
def test_hyp_oclinecorecst_packagecs_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_PackageCS)


def test_hyp_oclinecorecst_packagecs_constructor_exists():
    assert callable(oclinEcoreCST_PackageCS.__init__)


def test_hyp_oclinecorecst_packagecs_constructor_args():
    sig = inspect.signature(oclinEcoreCST_PackageCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oclinecorecst_typedelementcs_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_TypedElementCS)


def test_hyp_oclinecorecst_typedelementcs_constructor_exists():
    assert callable(oclinEcoreCST_TypedElementCS.__init__)


def test_hyp_oclinecorecst_typedelementcs_constructor_args():
...
def test_hyp_oclinecorecst_typeparametercs_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_TypeParameterCS)


def test_hyp_oclinecorecst_typeparametercs_constructor_exists():
    assert callable(oclinEcoreCST_TypeParameterCS.__init__)


def test_hyp_oclinecorecst_typeparametercs_constructor_args():
    sig = inspect.signature(oclinEcoreCST_TypeParameterCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oclinecorecst_constraintcs_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_ConstraintCS)


def test_hyp_oclinecorecst_constraintcs_constructor_exists():
    assert callable(oclinEcoreCST_ConstraintCS.__init__)


def test_hyp_oclinecorecst_constraintcs_constructor_args():
...
def test_hyp_oclinecorecst_classifiercs_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_ClassifierCS)


def test_hyp_oclinecorecst_classifiercs_constructor_exists():
    assert callable(oclinEcoreCST_ClassifierCS.__init__)


def test_hyp_oclinecorecst_classifiercs_constructor_args():
...
def test_hyp_oclinecorecst_eclassifierref_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_EClassifierRef)


def test_hyp_oclinecorecst_eclassifierref_constructor_exists():
    assert callable(oclinEcoreCST_EClassifierRef.__init__)


def test_hyp_oclinecorecst_eclassifierref_constructor_args():
    sig = inspect.signature(oclinEcoreCST_EClassifierRef.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oclinecorecst_datatyperef_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_DataTypeRef)


def test_hyp_oclinecorecst_datatyperef_constructor_exists():
    assert callable(oclinEcoreCST_DataTypeRef.__init__)


def test_hyp_oclinecorecst_datatyperef_constructor_args():
    sig = inspect.signature(oclinEcoreCST_DataTypeRef.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oclinecorecst_classifiercsref_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_ClassifierCSRef)


def test_hyp_oclinecorecst_classifiercsref_constructor_exists():
    assert callable(oclinEcoreCST_ClassifierCSRef.__init__)


def test_hyp_oclinecorecst_classifiercsref_constructor_args():
...
def test_hyp_oclinecorecst_eclassref_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_EClassRef)


def test_hyp_oclinecorecst_eclassref_constructor_exists():
    assert callable(oclinEcoreCST_EClassRef.__init__)


def test_hyp_oclinecorecst_eclassref_constructor_args():
    sig = inspect.signature(oclinEcoreCST_EClassRef.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oclinecorecst_classcsref_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_ClassCSRef)


def test_hyp_oclinecorecst_classcsref_constructor_exists():
    assert callable(oclinEcoreCST_ClassCSRef.__init__)


def test_hyp_oclinecorecst_classcsref_constructor_args():
    sig = inspect.signature(oclinEcoreCST_ClassCSRef.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oclinecorecst_structuralfeaturecs_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_StructuralFeatureCS)


def test_hyp_oclinecorecst_structuralfeaturecs_constructor_exists():
    assert callable(oclinEcoreCST_StructuralFeatureCS.__init__)


def test_hyp_oclinecorecst_structuralfeaturecs_constructor_args():
    sig = inspect.signature(oclinEcoreCST_StructuralFeatureCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oclinecorecst_operationcs_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_OperationCS)


def test_hyp_oclinecorecst_operationcs_constructor_exists():
    assert callable(oclinEcoreCST_OperationCS.__init__)


def test_hyp_oclinecorecst_operationcs_constructor_args():
    sig = inspect.signature(oclinEcoreCST_OperationCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oclinecorecst_classref_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_ClassRef)


def test_hyp_oclinecorecst_classref_constructor_exists():
    assert callable(oclinEcoreCST_ClassRef.__init__)


def test_hyp_oclinecorecst_classref_constructor_args():
...
def test_hyp_oclinecorecst_datatypeorenumcs_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_DataTypeOrEnumCS)


def test_hyp_oclinecorecst_datatypeorenumcs_constructor_exists():
    assert callable(oclinEcoreCST_DataTypeOrEnumCS.__init__)


def test_hyp_oclinecorecst_datatypeorenumcs_constructor_args():
    sig = inspect.signature(oclinEcoreCST_DataTypeOrEnumCS.__init__)
    params = list(sig.parameters.keys())



def test_hyp_oclinecorecst_classcs_is_not_abstract():
    assert not inspect.isabstract(oclinEcoreCST_ClassCS)


def test_hyp_oclinecorecst_classcs_constructor_exists():
    assert callable(oclinEcoreCST_ClassCS.__init__)


def test_hyp_oclinecorecst_classcs_constructor_args():
...
def test_hyp_oclinecorecst_importcs_importedNamespace_setter(instance):
...
def test_hyp_oclinecorecst_referencecs_containment_setter(instance):
...
def test_hyp_oclinecorecst_detailcs_stringName_setter(instance):
...
@given(instance=oclinEcoreCST_DetailCS_strategy)
def test_hyp_oclinecorecst_detailcs_value_setter(instance):
...
@given(instance=oclinEcoreCST_DetailCS_strategy)
def test_hyp_oclinecorecst_detailcs_idName_setter(instance):
...
def test_hyp_oclinecorecst_namedelementcs_name_setter(instance):
...
def test_hyp_oclinecorecst_annotationcs_stringSource_setter(instance):
...
@given(instance=oclinEcoreCST_AnnotationCS_strategy)
def test_hyp_oclinecorecst_annotationcs_idSource_setter(instance):
...
def test_hyp_oclinecorecst_enumliteralcs_value_setter(instance):
    original = instance.value
    instance.value = original
    assert instance.value == original
...
def test_hyp_oclinecorecst_typedelementcs_upper_setter(instance):
...
@given(instance=oclinEcoreCST_TypedElementCS_strategy)
def test_hyp_oclinecorecst_typedelementcs_multiplicity_setter(instance):
...
@given(instance=oclinEcoreCST_TypedElementCS_strategy)
def test_hyp_oclinecorecst_typedelementcs_qualifiers_setter(instance):
...
@given(instance=oclinEcoreCST_TypedElementCS_strategy)
def test_hyp_oclinecorecst_typedelementcs_lower_setter(instance):
...
def test_hyp_oclinecorecst_constraintcs_stereotype_setter(instance):
...
def test_hyp_oclinecorecst_classifiercs_qualifiers_setter(instance):
    original = instance.qualifiers
    instance.qualifiers = original
    assert instance.qualifiers == original
...
@given(instance=oclinEcoreCST_ClassifierCS_strategy)
def test_hyp_oclinecorecst_classifiercs_instanceClassName_setter(instance):
