...
def test_hyp_others_is_not_abstract():
    assert not inspect.isabstract(Others)


def test_hyp_others_constructor_exists():
    assert callable(Others.__init__)


def test_hyp_others_constructor_args():
...
def test_hyp_others_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=Others_strategy)
def test_hyp_others_discription_setter(instance):
