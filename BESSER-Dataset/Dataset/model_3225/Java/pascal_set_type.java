...
public class pascal_set_type  {
    ...
    private pascal_base_type pascal_base_type;


    public pascal_set_type(
    ) {
    }
    ...
    public pascal_base_type getPascal_base_type() {
        return pascal_base_type;
    }

    public void setPascal_base_type(pascal_base_type pascal_base_type) {
        this.pascal_base_type = pascal_base_type;
    }
