...
# Classes
pascal_program = Class(name="pascal_program")
pascal_program_heading = Class(name="pascal_program_heading")
pascal_block = Class(name="pascal_block")
pascal_identifier_list = Class(name="pascal_identifier_list")
pascal_procedure_block = Class(name="pascal_procedure_block")
pascal_declaration_part = Class(name="pascal_declaration_part")
pascal_statement_part = Class(name="pascal_statement_part")
pascal_function_block = Class(name="pascal_function_block")
pascal_statement_sequence = Class(name="pascal_statement_sequence")
pascal_statement = Class(name="pascal_statement")
pascal_label = Class(name="pascal_label")
pascal_Begin = Class(name="pascal_Begin")
pascal_identifier = Class(name="pascal_identifier")
pascal_actual_parameter_list = Class(name="pascal_actual_parameter_list")
pascal_actual_parameter = Class(name="pascal_actual_parameter")
pascal_actual_value = Class(name="pascal_actual_value")
pascal_actual_variable = Class(name="pascal_actual_variable")
pascal_actual_procedure = Class(name="pascal_actual_procedure")
pascal_actual_function = Class(name="pascal_actual_function")
pascal_variable = Class(name="pascal_variable")
pascal_expression = Class(name="pascal_expression")
output_value = Class(name="output_value")
pascal_simple_statement = Class(name="pascal_simple_statement")
pascal_structured_statement = Class(name="pascal_structured_statement")
pascal_assignment_statement = Class(name="pascal_assignment_statement")
pascal_procedure_statement = Class(name="pascal_procedure_statement")
pascal_goto_statement = Class(name="pascal_goto_statement")
pascal_number = Class(name="pascal_number")
pascal_set = Class(name="pascal_set")
pascal_function_designator = Class(name="pascal_function_designator")
pascal_element_list = Class(name="pascal_element_list")
pascal_integer_number = Class(name="pascal_integer_number")
pascal_real_number = Class(name="pascal_real_number")
pascal_digit_sequence = Class(name="pascal_digit_sequence")
pascal_scale_factor = Class(name="pascal_scale_factor")
pascal_simple_expression = Class(name="pascal_simple_expression")
pascal_term = Class(name="pascal_term")
pascal_addition_operator = Class(name="pascal_addition_operator")
pascal_factor = Class(name="pascal_factor")
pascal_compound_statement = Class(name="pascal_compound_statement")
pascal_repetitive_statement = Class(name="pascal_repetitive_statement")
pascal_conditional_statement = Class(name="pascal_conditional_statement")
pascal_with_statement = Class(name="pascal_with_statement")
pascal_if_statement = Class(name="pascal_if_statement")
pascal_case_statement = Class(name="pascal_case_statement")
pascal_case_limb = Class(name="pascal_case_limb")
pascal_case_label_list = Class(name="pascal_case_label_list")
pascal_constant = Class(name="pascal_constant")
pascal_entire_variable = Class(name="pascal_entire_variable")
pascal_expression_list = Class(name="pascal_expression_list")
pascal_initial_expression = Class(name="pascal_initial_expression")
pascal_final_expression = Class(name="pascal_final_expression")
pascal_label_declaration_part = Class(name="pascal_label_declaration_part")
pascal_constant_definition_part = Class(name="pascal_constant_definition_part")
pascal_type_definition_part = Class(name="pascal_type_definition_part")
pascal_variable_declaration_part = Class(name="pascal_variable_declaration_part")
pascal_procedure_heading = Class(name="pascal_procedure_heading")
pascal_procedure_body = Class(name="pascal_procedure_body")
pascal_while_statement = Class(name="pascal_while_statement")
pascal_repeat_statement = Class(name="pascal_repeat_statement")
pascal_for_statement = Class(name="pascal_for_statement")
pascal_constant_definition = Class(name="pascal_constant_definition")
pascal_type_definition = Class(name="pascal_type_definition")
pascal_type = Class(name="pascal_type")
pascal_simple_type = Class(name="pascal_simple_type")
pascal_structured_type = Class(name="pascal_structured_type")
pascal_pointer_type = Class(name="pascal_pointer_type")
pascal_type_identifier = Class(name="pascal_type_identifier")
pascal_directive = Class(name="pascal_directive")
pascal_procedure_identification = Class(name="pascal_procedure_identification")
pascal_function_heading = Class(name="pascal_function_heading")
pascal_function_body = Class(name="pascal_function_body")
pascal_function_identification = Class(name="pascal_function_identification")
pascal_base_type = Class(name="pascal_base_type")
pascal_field_list = Class(name="pascal_field_list")
pascal_fixed_part = Class(name="pascal_fixed_part")
pascal_variant_part = Class(name="pascal_variant_part")
pascal_record_section = Class(name="pascal_record_section")
pascal_tag_field = Class(name="pascal_tag_field")
pascal_variant = Class(name="pascal_variant")
pascal_unpacked_structured_type = Class(name="pascal_unpacked_structured_type")
pascal_array_type = Class(name="pascal_array_type")
pascal_record_type = Class(name="pascal_record_type")
pascal_set_type = Class(name="pascal_set_type")
pascal_file_type = Class(name="pascal_file_type")
pascal_file_component_type = Class(name="pascal_file_component_type")
pascal_enumerated_type = Class(name="pascal_enumerated_type")
pascal_lower_bound = Class(name="pascal_lower_bound")
pascal_upper_bound = Class(name="pascal_upper_bound")
pascal_variable_declaration = Class(name="pascal_variable_declaration")
pascal_compiler_defined_directives = Class(name="pascal_compiler_defined_directives")
pascal_index_type = Class(name="pascal_index_type")
pascal_element_type = Class(name="pascal_element_type")
pascal_subrange_type = Class(name="pascal_subrange_type")
pascal_value_parameter_section = Class(name="pascal_value_parameter_section")
pascal_variable_parameter_section = Class(name="pascal_variable_parameter_section")
pascal_procedure_parameter_section = Class(name="pascal_procedure_parameter_section")
pascal_function_parameter_section = Class(name="pascal_function_parameter_section")
pascal_result_type = Class(name="pascal_result_type")
pascal_parameter_type = Class(name="pascal_parameter_type")
pascal_formal_parameter_list = Class(name="pascal_formal_parameter_list")
pascal_formal_parameter_section = Class(name="pascal_formal_parameter_section")
pascal_ordinal_type_identifier = Class(name="pascal_ordinal_type_identifier")
pascal_output_list = Class(name="pascal_output_list")
pascal_output_value = Class(name="pascal_output_value")
output_list = Class(name="output_list")
pascal_conformant_array_schema = Class(name="pascal_conformant_array_schema")
pascal_packed_conformant_array_schema = Class(name="pascal_packed_conformant_array_schema")
pascal_unpacked_conformant_array_schema = Class(name="pascal_unpacked_conformant_array_schema")
pascal_bound_specification = Class(name="pascal_bound_specification")
...
pascal_digit_sequence.attributes={pascal_digit_sequence_sign, pascal_digit_sequence_unsigned_digit_sequence}
...
pascal_constant.attributes={pascal_constant_sign, pascal_constant_boolean, pascal_constant_strings}
...
domain_model = DomainModel(
    name="pascal",
    types={pascal_program, pascal_program_heading, pascal_block, pascal_identifier_list, pascal_procedure_block, pascal_declaration_part, pascal_statement_part, pascal_function_block, pascal_statement_sequence, pascal_statement, pascal_label, pascal_Begin, pascal_identifier, pascal_actual_parameter_list, pascal_actual_parameter, pascal_actual_value, pascal_actual_variable, pascal_actual_procedure, pascal_actual_function, pascal_variable, pascal_expression, output_value, pascal_simple_statement, pascal_structured_statement, pascal_assignment_statement, pascal_procedure_statement, pascal_goto_statement, pascal_number, pascal_set, pascal_function_designator, pascal_element_list, pascal_integer_number, pascal_real_number, pascal_digit_sequence, pascal_scale_factor, pascal_simple_expression, pascal_term, pascal_addition_operator, pascal_factor, pascal_compound_statement, pascal_repetitive_statement, pascal_conditional_statement, pascal_with_statement, pascal_if_statement, pascal_case_statement, pascal_case_limb, pascal_case_label_list, pascal_constant, pascal_entire_variable, pascal_expression_list, pascal_initial_expression, pascal_final_expression, pascal_label_declaration_part, pascal_constant_definition_part, pascal_type_definition_part, pascal_variable_declaration_part, pascal_procedure_heading, pascal_procedure_body, pascal_while_statement, pascal_repeat_statement, pascal_for_statement, pascal_constant_definition, pascal_type_definition, pascal_type, pascal_simple_type, pascal_structured_type, pascal_pointer_type, pascal_type_identifier, pascal_directive, pascal_procedure_identification, pascal_function_heading, pascal_function_body, pascal_function_identification, pascal_base_type, pascal_field_list, pascal_fixed_part, pascal_variant_part, pascal_record_section, pascal_tag_field, pascal_variant, pascal_unpacked_structured_type, pascal_array_type, pascal_record_type, pascal_set_type, pascal_file_type, pascal_file_component_type, pascal_enumerated_type, pascal_lower_bound, pascal_upper_bound, pascal_variable_declaration, pascal_compiler_defined_directives, pascal_index_type, pascal_element_type, pascal_subrange_type, pascal_value_parameter_section, pascal_variable_parameter_section, pascal_procedure_parameter_section, pascal_function_parameter_section, pascal_result_type, pascal_parameter_type, pascal_formal_parameter_list, pascal_formal_parameter_section, pascal_ordinal_type_identifier, pascal_output_list, pascal_output_value, output_list, pascal_conformant_array_schema, pascal_packed_conformant_array_schema, pascal_unpacked_conformant_array_schema, pascal_bound_specification},
    associations={elements0, program_heading1, block3, identifier_list5, declaration_part7, statement_part8, declaration_part10, statement_part12, declaration_part15, statement_part18, statement_sequence21, statement23, procedure_identifier40, actual_parameter_list42, actual_parameter44, actual_value46, actual_variable48, actual_procedure50, actual_function52, function_identifier54, procedure_identifier57, variable60, expression62, variable64, function_identifier67, expression70, label25, simple_statement27, structured_statement29, assignment_statement31, procedure_statement33, goto_statement35, label37, variable84, number87, set89, identifier91, function_designator94, expression96, factor100, function_identifier102, actual_parameter_list105, element_list108, expression110, integer_number113, real_number115, digit_sequence117, digit_sequence2119, scale_factor122, simple_expression73, expression76, term78, addition_operator80, factor82, integer_number140, digit_sequence143, compound_statement146, repetitive_statement148, conditional_statement150, with_statement152, variable154, statement157, if_statement160, case_statement162, expression164, case_limb167, case_label_list169, statement171, digit_sequence124, entire_variable127, expression_list129, field_identifier131, identifier134, expression137, variable_identifier188, initial_expression191, final_expression193, statement195, expression198, expression201, statement_sequence204, expression207, expression210, statement213, statement_sequence216, label_declaration_part219, constant_definition_part221, type_definition_part223, variable_declaration_part225, procedure_heading227, constant174, expression176, statement179, while_statement182, repeat_statement184, for_statement186, label241, constant_definition244, identifier246, constant249, constant_identifier252, number255, type_definition258, identifier260, type263, simple_type265, structured_type267, pointer_type269, type_identifier271, identifier273, procedure_body229, directive231, procedure_identification233, function_heading235, function_body237, function_identification239, file_component_type289, type291, base_type294, type296, field_list299, fixed_part301, variant_part303, record_section305, identifier_list307, type310, tag_field313, type_identifier315, variant318, case_label_list320, field_list323, type_identifier276, unpacked_structured_type279, array_type281, record_type283, set_type285, file_type287, subrange_type339, enumerated_type341, identifier_list343, lower_bound346, upper_bound348, constant350, constant353, variable_declaration356, identifier_list358, type361, function_identifier364, function_block367, identifier370, compiler_defined_directives373, identifier326, index_type329, element_type331, type333, simple_type336, value_parameter_section388, variable_parameter_section390, procedure_parameter_section392, function_parameter_section394, function_heading396, identifier399, formal_parameter_list402, result_type405, type_identifier407, procedure_heading410, identifier_list413, parameter_type416, identifier_list418, parameter_type421, type_identifier424, procedure_heading375, procedure_block378, identifier381, formal_parameter_list384, formal_parameter_section386, conformant_array_schema438, identifier441, identifier2444, ordinal_type_identifier447, type_identifier449, bound_specification452, type_identifier455, output_value459, conformant_array_schema427, packed_conformant_array_schema429, unpacked_conformant_array_schema431, bound_specification433, type_identifier435},
