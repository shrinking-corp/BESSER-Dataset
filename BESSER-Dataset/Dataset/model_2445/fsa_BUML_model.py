...
# Classes
fsa_Transition = Class(name="fsa_Transition")
fsa_FSA = Class(name="fsa_FSA")
fsa_State = Class(name="fsa_State")
...
fsa_State.attributes={fsa_State_name, fsa_State_accepting}
...
domain_model = DomainModel(
    ...
    associations={transitions1, initialState3, states0, outgoingTransitions6, incomingTransitions7, fromState9, toState10},
    generalizations={},
    metadata=None
)
