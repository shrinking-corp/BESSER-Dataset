...
# Classes
helloWorld_Model = Class(name="helloWorld_Model")
helloWorld_Greeting = Class(name="helloWorld_Greeting")
helloWorld_KeywordsExample = Class(name="helloWorld_KeywordsExample")
...
domain_model = DomainModel(
    ...
    associations={greetings0, keywordsExample1},
    generalizations={},
    metadata=None
)
