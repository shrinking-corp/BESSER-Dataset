...
# Classes
testmodel_Model = Class(name="testmodel_Model")
testmodel_NamedElement = Class(name="testmodel_NamedElement", is_abstract=True)
NamedElement = Class(name="NamedElement")
testmodel_TypedElement = Class(name="testmodel_TypedElement")
testmodel_Class = Class(name="testmodel_Class")
ModelElement = Class(name="ModelElement")
testmodel_Attribute = Class(name="testmodel_Attribute")
TypedElement = Class(name="TypedElement")
testmodel_Group = Class(name="testmodel_Group")
Model = Class(name="Model")
testmodel_Association = Class(name="testmodel_Association")
testmodel_ModelElement = Class(name="testmodel_ModelElement", is_abstract=True)
...
domain_model = DomainModel(
    name="testmodel",
    types={testmodel_Model, testmodel_NamedElement, NamedElement, testmodel_TypedElement, testmodel_Class, ModelElement, testmodel_Attribute, TypedElement, testmodel_Group, Model, testmodel_Association, testmodel_ModelElement},
