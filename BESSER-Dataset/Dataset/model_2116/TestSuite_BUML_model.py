...
# Classes
test_TestStep = Class(name="test_TestStep", is_abstract=True)
test_APIRequest = Class(name="test_APIRequest")
TestStep = Class(name="TestStep")
test_TestSuite = Class(name="test_TestSuite")
NamedElement = Class(name="NamedElement")
test_TestCase = Class(name="test_TestCase")
test_HeaderExistsAssertion = Class(name="test_HeaderExistsAssertion")
test_HTTPStatusAssertion = Class(name="test_HTTPStatusAssertion", is_abstract=True)
test_InvalidStatusCodesAssertion = Class(name="test_InvalidStatusCodesAssertion")
HTTPStatusAssertion = Class(name="HTTPStatusAssertion")
test_ValidStatusCodesAssertion = Class(name="test_ValidStatusCodesAssertion")
test_Basic = Class(name="test_Basic")
Authorization = Class(name="Authorization")
test_Parameter = Class(name="test_Parameter")
test_Assertion = Class(name="test_Assertion", is_abstract=True)
test_Authorization = Class(name="test_Authorization", is_abstract=True)
test_NamedElement = Class(name="test_NamedElement", is_abstract=True)
test_ComplianceAssertion = Class(name="test_ComplianceAssertion", is_abstract=True)
Assertion = Class(name="Assertion")
test_PerformanceAssertion = Class(name="test_PerformanceAssertion", is_abstract=True)
test_ResponseMessageAssertion = Class(name="test_ResponseMessageAssertion", is_abstract=True)
test_ResponseMessageContainsAssertion = Class(name="test_ResponseMessageContainsAssertion")
ResponseMessageAssertion = Class(name="ResponseMessageAssertion")
test_ResponseMessageEqualsAssertion = Class(name="test_ResponseMessageEqualsAssertion")
test_SchemaComplianceAssertion = Class(name="test_SchemaComplianceAssertion")
ComplianceAssertion = Class(name="ComplianceAssertion")
test_SLAAssertion = Class(name="test_SLAAssertion")
PerformanceAssertion = Class(name="PerformanceAssertion")
test_HeaderAssertion = Class(name="test_HeaderAssertion", is_abstract=True)
test_HeaderEqualsAssertion = Class(name="test_HeaderEqualsAssertion")
HeaderAssertion = Class(name="HeaderAssertion")
InputProperty = Class(name="InputProperty")
test_ResponseProperty = Class(name="test_ResponseProperty")
OutputProperty = Class(name="OutputProperty")
test_InputProperty = Class(name="test_InputProperty", is_abstract=True)
Property_ = Class(name="Property")
test_OAuth2 = Class(name="test_OAuth2")
test_PropertyTransfer = Class(name="test_PropertyTransfer")
test_Property = Class(name="test_Property", is_abstract=True)
test_ParameterProperty = Class(name="test_ParameterProperty")
test_OutputProperty = Class(name="test_OutputProperty", is_abstract=True)
test_HeaderProperty = Class(name="test_HeaderProperty")
...
test_APIRequest.attributes={test_APIRequest_scheme, test_APIRequest_operationId, test_APIRequest_accept, test_APIRequest_contentType}
...
test_Parameter.attributes={test_Parameter_name, test_Parameter_value, test_Parameter_location}
...
test_Property.attributes={test_Property_expression, test_Property_pathLanguage}
...
domain_model = DomainModel(
    name="test",
    types={test_TestStep, test_APIRequest, TestStep, test_TestSuite, NamedElement, test_TestCase, test_HeaderExistsAssertion, test_HTTPStatusAssertion, test_InvalidStatusCodesAssertion, HTTPStatusAssertion, test_ValidStatusCodesAssertion, test_Basic, Authorization, test_Parameter, test_Assertion, test_Authorization, test_NamedElement, test_ComplianceAssertion, Assertion, test_PerformanceAssertion, test_ResponseMessageAssertion, test_ResponseMessageContainsAssertion, ResponseMessageAssertion, test_ResponseMessageEqualsAssertion, test_SchemaComplianceAssertion, ComplianceAssertion, test_SLAAssertion, PerformanceAssertion, test_HeaderAssertion, test_HeaderEqualsAssertion, HeaderAssertion, InputProperty, test_ResponseProperty, OutputProperty, test_InputProperty, Property_, test_OAuth2, test_PropertyTransfer, test_Property, test_ParameterProperty, test_OutputProperty, test_HeaderProperty, ParameterLocation, SchemeType, HTTPMethod, PathLanguage},
    associations={testSteps1, testCases0, parameters3, assertions4, authorization6, parameter12, source8, target9, request14},
    generalizations={gen_test_TestCase_NamedElement, gen_test_TestStep_NamedElement, gen_test_APIRequest_TestStep, gen_test_TestSuite_NamedElement, gen_test_HeaderExistsAssertion_HeaderAssertion, gen_test_HTTPStatusAssertion_Assertion, gen_test_InvalidStatusCodesAssertion_HTTPStatusAssertion, gen_test_ValidStatusCodesAssertion_HTTPStatusAssertion, gen_test_Basic_Authorization, gen_test_ComplianceAssertion_Assertion, gen_test_PerformanceAssertion_Assertion, gen_test_ResponseMessageAssertion_Assertion, gen_test_ResponseMessageContainsAssertion_ResponseMessageAssertion, gen_test_ResponseMessageEqualsAssertion_ResponseMessageAssertion, gen_test_SchemaComplianceAssertion_ComplianceAssertion, gen_test_SLAAssertion_PerformanceAssertion, gen_test_HeaderAssertion_Assertion, gen_test_HeaderEqualsAssertion_HeaderAssertion, gen_test_ParameterProperty_InputProperty, gen_test_ResponseProperty_OutputProperty, gen_test_InputProperty_Property, gen_test_OAuth2_Authorization, gen_test_PropertyTransfer_TestStep, gen_test_OutputProperty_Property, gen_test_HeaderProperty_OutputProperty},
    metadata=None
)
