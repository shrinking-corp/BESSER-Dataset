...
Interface_Actor = Class(name="Interface_Actor")
...
# Interface_Actor class attributes and methods
...
domain_model = DomainModel(
    name="fa7e2238_6b0f_42df_a88f_cc0f93963233",
    types={ShoppingCartExample_ShoppingCart, ShoppingCartExample_Order, ShoppingCartExample_LineItem, ShoppingCartExample_Account, ShoppingCartExample_Customer, Actor_Actor, User_Actor, Interface_Actor},
    associations={Account_ShoppingCart, Account_Customer, Order_Line, ShoppingCart_Order},
    generalizations={},
    metadata=None
)
