...
class SPL_WhenHeader(VariableDeclaration):
    ...
    def __init__(self, headerId: str, SPL_WhenHeader: "SPL_WhenStat" = None, SPL_WhenHeader100: "SPL_Constant" = None):
        self.headerId = headerId
...
class SPL_Method(Session):
    ...
    def __init__(self, direction: str, SPL_Method18: "SPL_Event" = None, SPL_Method: "SPL_Dialog" = None, SPL_Method20: "SPL_TypeExpression" = None, SPL_Method22: "SPL_MethodName" = None, SPL_Method24: set["SPL_Argument"] = None, SPL_Method26: set["SPL_Statement"] = None, SPL_Method28: set["SPL_Branch"] = None):
...
class SPL_Declaration(LocatedElement):
    ...
    def __init__(self, name: str, SPL_Declaration15: "SPL_Event" = None, SPL_Declaration: "SPL_Service" = None, SPL_Declaration6: "SPL_Registration" = None, SPL_Declaration11: "SPL_Dialog" = None, SPL_Declaration59: "SPL_DeclarationStat" = None, SPL_Declaration128: "SPL_Variable" = None):
        self.name = name
...
class SPL_Service(LocatedElement):
    ...
    def __init__(self, name: str, SPL_Service: "SPL_Program" = None, SPL_Service2: set["SPL_Declaration"] = None, SPL_Service4: set["SPL_Session"] = None):
        self.name = name
