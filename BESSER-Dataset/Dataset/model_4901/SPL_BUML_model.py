...
# Classes
SPL_LocatedElement = Class(name="SPL_LocatedElement", is_abstract=True)
SPL_TypeExpression = Class(name="SPL_TypeExpression", is_abstract=True)
SPL_Program = Class(name="SPL_Program")
LocatedElement = Class(name="LocatedElement")
SPL_Service = Class(name="SPL_Service")
SPL_Declaration = Class(name="SPL_Declaration", is_abstract=True)
SPL_Session = Class(name="SPL_Session", is_abstract=True)
SPL_Registration = Class(name="SPL_Registration")
Session = Class(name="Session")
SPL_Dialog = Class(name="SPL_Dialog")
SPL_Method = Class(name="SPL_Method")
SPL_Event = Class(name="SPL_Event")
SPL_SimpleType = Class(name="SPL_SimpleType")
TypeExpression = Class(name="TypeExpression")
SPL_SequenceType = Class(name="SPL_SequenceType")
SPL_MethodName = Class(name="SPL_MethodName", is_abstract=True)
SPL_Argument = Class(name="SPL_Argument")
SPL_Statement = Class(name="SPL_Statement", is_abstract=True)
SPL_Branch = Class(name="SPL_Branch")
VariableDeclaration = Class(name="VariableDeclaration")
SPL_SIPMethodName = Class(name="SPL_SIPMethodName")
MethodName = Class(name="MethodName")
SPL_ControlMethodName = Class(name="SPL_ControlMethodName")
SPL_DefaultBranch = Class(name="SPL_DefaultBranch")
Branch = Class(name="Branch")
SPL_NamedBranch = Class(name="SPL_NamedBranch")
SPL_StructureProperty = Class(name="SPL_StructureProperty")
SPL_FunctionCall = Class(name="SPL_FunctionCall")
SPL_DefinedType = Class(name="SPL_DefinedType")
SPL_VariableDeclaration = Class(name="SPL_VariableDeclaration")
Declaration = Class(name="Declaration")
SPL_Expression = Class(name="SPL_Expression", is_abstract=True)
SPL_FunctionDeclaration = Class(name="SPL_FunctionDeclaration", is_abstract=True)
SPL_RemoteFunctionDeclaration = Class(name="SPL_RemoteFunctionDeclaration")
FunctionDeclaration = Class(name="FunctionDeclaration")
SPL_LocalFunctionDeclaration = Class(name="SPL_LocalFunctionDeclaration")
SPL_StructureDeclaration = Class(name="SPL_StructureDeclaration")
SPL_Variable = Class(name="SPL_Variable")
SPL_WhenHeader = Class(name="SPL_WhenHeader")
SPL_CompoundStat = Class(name="SPL_CompoundStat")
Statement = Class(name="Statement")
SPL_SetStat = Class(name="SPL_SetStat")
SPL_Place = Class(name="SPL_Place", is_abstract=True)
SPL_DeclarationStat = Class(name="SPL_DeclarationStat")
SPL_ReturnStat = Class(name="SPL_ReturnStat")
SPL_IfStat = Class(name="SPL_IfStat")
SPL_WhenStat = Class(name="SPL_WhenStat")
SPL_SelectMember = Class(name="SPL_SelectMember", is_abstract=True)
SelectMember = Class(name="SelectMember")
SPL_ForeachStat = Class(name="SPL_ForeachStat")
SPL_SelectStat = Class(name="SPL_SelectStat")
SPL_SelectCase = Class(name="SPL_SelectCase")
SPL_SelectDefault = Class(name="SPL_SelectDefault")
SPL_FunctionCallStat = Class(name="SPL_FunctionCallStat")
SPL_ContinueStat = Class(name="SPL_ContinueStat")
SPL_BreakStat = Class(name="SPL_BreakStat")
SPL_PushStat = Class(name="SPL_PushStat")
SPL_Constant = Class(name="SPL_Constant", is_abstract=True)
SPL_RequestURIExp = Class(name="SPL_RequestURIExp")
SPL_PopExp = Class(name="SPL_PopExp")
SPL_FunctionCallExp = Class(name="SPL_FunctionCallExp")
SPL_ConstantExp = Class(name="SPL_ConstantExp")
Expression = Class(name="Expression")
SPL_OperatorExp = Class(name="SPL_OperatorExp")
SPL_ForwardExp = Class(name="SPL_ForwardExp")
SPL_WithExp = Class(name="SPL_WithExp")
SPL_MessageField = Class(name="SPL_MessageField", is_abstract=True)
SPL_BlockExp = Class(name="SPL_BlockExp")
SPL_ReasonExp = Class(name="SPL_ReasonExp")
SPL_BODYExp = Class(name="SPL_BODYExp")
SPL_SequenceConstant = Class(name="SPL_SequenceConstant")
SPL_ResponseConstant = Class(name="SPL_ResponseConstant")
SPL_Response = Class(name="SPL_Response", is_abstract=True)
SPL_SIPHeaderPlace = Class(name="SPL_SIPHeaderPlace")
Place = Class(name="Place")
SPL_VariablePlace = Class(name="SPL_VariablePlace", is_abstract=True)
SPL_PropertyCallPlace = Class(name="SPL_PropertyCallPlace")
VariablePlace = Class(name="VariablePlace")
SPL_ReasonMessageField = Class(name="SPL_ReasonMessageField")
MessageField = Class(name="MessageField")
SPL_HeadedMessageField = Class(name="SPL_HeadedMessageField")
SPL_BooleanConstant = Class(name="SPL_BooleanConstant")
Constant = Class(name="Constant")
SPL_IntegerConstant = Class(name="SPL_IntegerConstant")
SPL_StringConstant = Class(name="SPL_StringConstant")
SPL_URIConstant = Class(name="SPL_URIConstant")
SPL_SuccessResponse = Class(name="SPL_SuccessResponse")
Response = Class(name="Response")
SPL_ErrorResponse = Class(name="SPL_ErrorResponse")
SPL_ClientErrorResponse = Class(name="SPL_ClientErrorResponse")
ErrorResponse = Class(name="ErrorResponse")
SPL_GlobalErrorResponse = Class(name="SPL_GlobalErrorResponse")
SPL_RedirectionErrorResponse = Class(name="SPL_RedirectionErrorResponse")
SPL_ServerErrorResponse = Class(name="SPL_ServerErrorResponse")
...
SPL_LocatedElement.attributes={SPL_LocatedElement_commentsAfter, SPL_LocatedElement_location, SPL_LocatedElement_commentsBefore}
...
SPL_SequenceType.attributes={SPL_SequenceType_size, SPL_SequenceType_type, SPL_SequenceType_modifier}
...
domain_model = DomainModel(
    name="SPL",
    types={SPL_LocatedElement, SPL_TypeExpression, SPL_Program, LocatedElement, SPL_Service, SPL_Declaration, SPL_Session, SPL_Registration, Session, SPL_Dialog, SPL_Method, SPL_Event, SPL_SimpleType, TypeExpression, SPL_SequenceType, SPL_MethodName, SPL_Argument, SPL_Statement, SPL_Branch, VariableDeclaration, SPL_SIPMethodName, MethodName, SPL_ControlMethodName, SPL_DefaultBranch, Branch, SPL_NamedBranch, SPL_StructureProperty, SPL_FunctionCall, SPL_DefinedType, SPL_VariableDeclaration, Declaration, SPL_Expression, SPL_FunctionDeclaration, SPL_RemoteFunctionDeclaration, FunctionDeclaration, SPL_LocalFunctionDeclaration, SPL_StructureDeclaration, SPL_Variable, SPL_WhenHeader, SPL_CompoundStat, Statement, SPL_SetStat, SPL_Place, SPL_DeclarationStat, SPL_ReturnStat, SPL_IfStat, SPL_WhenStat, SPL_SelectMember, SelectMember, SPL_ForeachStat, SPL_SelectStat, SPL_SelectCase, SPL_SelectDefault, SPL_FunctionCallStat, SPL_ContinueStat, SPL_BreakStat, SPL_PushStat, SPL_Constant, SPL_RequestURIExp, SPL_PopExp, SPL_FunctionCallExp, SPL_ConstantExp, Expression, SPL_OperatorExp, SPL_ForwardExp, SPL_WithExp, SPL_MessageField, SPL_BlockExp, SPL_ReasonExp, SPL_BODYExp, SPL_SequenceConstant, SPL_ResponseConstant, SPL_Response, SPL_SIPHeaderPlace, Place, SPL_VariablePlace, SPL_PropertyCallPlace, VariablePlace, SPL_ReasonMessageField, MessageField, SPL_HeadedMessageField, SPL_BooleanConstant, Constant, SPL_IntegerConstant, SPL_StringConstant, SPL_URIConstant, SPL_SuccessResponse, Response, SPL_ErrorResponse, SPL_ClientErrorResponse, ErrorResponse, SPL_GlobalErrorResponse, SPL_RedirectionErrorResponse, SPL_ServerErrorResponse, Modifier, FunctionLocation, SIPHeader, Direction, SIPMethod, ControlMethod, PrimitiveType, SuccessKind, ClientErrorKind, GlobalErrorKind, RedirectionErrorKind, ServerErrorKind},
    associations={declarations14, methods16, service0, declarations1, sessions3, declarations5, sessions7, declarations10, methods12, type19, methodName21, arguments23, statements25, branches27, statements29, type45, type32, initExp34, returnType36, arguments38, statements41, properties43, idExp72, whenHeaders73, statements75, elseStatements78, function47, parameters49, statements52, target54, setValue55, declaration58, returnedValue60, branch62, condition64, thenStatements66, elseStatements69, value99, statements101, sequenceExp81, statements83, matchedExp86, selectCases88, selectDefault90, functionCall92, target94, pushedValue96, source121, functionCall123, values103, value106, leftExp108, rightExp110, exp113, exp115, msgFields117, exp119, values132, response134, source125, source126, exp129},
    generalizations={gen_SPL_Method_Session, gen_SPL_Program_LocatedElement, gen_SPL_Service_LocatedElement, gen_SPL_Session_LocatedElement, gen_SPL_Registration_Session, gen_SPL_Dialog_Session, gen_SPL_Event_Session, gen_SPL_SimpleType_TypeExpression, gen_SPL_SequenceType_TypeExpression, gen_SPL_Argument_VariableDeclaration, gen_SPL_MethodName_LocatedElement, gen_SPL_SIPMethodName_MethodName, gen_SPL_ControlMethodName_MethodName, gen_SPL_Branch_LocatedElement, gen_SPL_DefaultBranch_Branch, gen_SPL_NamedBranch_Branch, gen_SPL_TypeExpression_LocatedElement, gen_SPL_StructureProperty_LocatedElement, gen_SPL_FunctionCall_LocatedElement, gen_SPL_DefinedType_TypeExpression, gen_SPL_Declaration_LocatedElement, gen_SPL_VariableDeclaration_Declaration, gen_SPL_FunctionDeclaration_Declaration, gen_SPL_RemoteFunctionDeclaration_FunctionDeclaration, gen_SPL_LocalFunctionDeclaration_FunctionDeclaration, gen_SPL_StructureDeclaration_Declaration, gen_SPL_Statement_LocatedElement, gen_SPL_CompoundStat_Statement, gen_SPL_SetStat_Statement, gen_SPL_DeclarationStat_Statement, gen_SPL_ReturnStat_Statement, gen_SPL_IfStat_Statement, gen_SPL_WhenStat_Statement, gen_SPL_SelectMember_LocatedElement, gen_SPL_SelectDefault_SelectMember, gen_SPL_SelectCase_SelectMember, gen_SPL_ForeachStat_Statement, gen_SPL_SelectStat_Statement, gen_SPL_FunctionCallStat_Statement, gen_SPL_ContinueStat_Statement, gen_SPL_BreakStat_Statement, gen_SPL_PushStat_Statement, gen_SPL_WhenHeader_VariableDeclaration, gen_SPL_RequestURIExp_Expression, gen_SPL_PopExp_Expression, gen_SPL_FunctionCallExp_Expression, gen_SPL_Expression_LocatedElement, gen_SPL_ConstantExp_Expression, gen_SPL_OperatorExp_Expression, gen_SPL_ForwardExp_Expression, gen_SPL_WithExp_Expression, gen_SPL_BlockExp_Expression, gen_SPL_ReasonExp_Expression, gen_SPL_BODYExp_Expression, gen_SPL_SequenceConstant_Constant, gen_SPL_ResponseConstant_Constant, gen_SPL_Place_Expression, gen_SPL_SIPHeaderPlace_Place, gen_SPL_VariablePlace_Place, gen_SPL_PropertyCallPlace_VariablePlace, gen_SPL_Variable_VariablePlace, gen_SPL_MessageField_LocatedElement, gen_SPL_ReasonMessageField_MessageField, gen_SPL_HeadedMessageField_MessageField, gen_SPL_Constant_LocatedElement, gen_SPL_BooleanConstant_Constant, gen_SPL_IntegerConstant_Constant, gen_SPL_StringConstant_Constant, gen_SPL_URIConstant_Constant, gen_SPL_Response_LocatedElement, gen_SPL_SuccessResponse_Response, gen_SPL_ErrorResponse_Response, gen_SPL_ClientErrorResponse_ErrorResponse, gen_SPL_GlobalErrorResponse_ErrorResponse, gen_SPL_RedirectionErrorResponse_ErrorResponse, gen_SPL_ServerErrorResponse_ErrorResponse},
    metadata=None
)
