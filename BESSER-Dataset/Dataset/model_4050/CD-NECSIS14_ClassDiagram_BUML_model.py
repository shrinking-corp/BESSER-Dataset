...
# Classes
necsis14_classdiagram_ClassDiagram = Class(name="necsis14_classdiagram_ClassDiagram")
necsis14_classdiagram_Class = Class(name="necsis14_classdiagram_Class")
necsis14_classdiagram_Association = Class(name="necsis14_classdiagram_Association")
necsis14_classdiagram__QTable = Class(name="necsis14_classdiagram__QTable")
necsis14_classdiagram_NamedElement = Class(name="necsis14_classdiagram_NamedElement", is_abstract=True)
NamedElement = Class(name="NamedElement")
necsis14_classdiagram__QColumn = Class(name="necsis14_classdiagram__QColumn")
necsis14_classdiagram_Attribute = Class(name="necsis14_classdiagram_Attribute")
...
domain_model = DomainModel(
    ...
    types={necsis14_classdiagram_ClassDiagram, necsis14_classdiagram_Class, necsis14_classdiagram_Association, necsis14_classdiagram__QTable, necsis14_classdiagram_NamedElement, NamedElement, necsis14_classdiagram__QColumn, necsis14_classdiagram_Attribute},
    associations={classes0, associations1, _Qtables3, parent6, _Qcolumns16, _QprimaryKeys18, attributes8, source10, target13},
    generalizations={gen_necsis14_classdiagram_Class_NamedElement, gen_necsis14_classdiagram_Attribute_NamedElement, gen_necsis14_classdiagram__QTable_NamedElement, gen_necsis14_classdiagram__QColumn_NamedElement, gen_necsis14_classdiagram_Association_NamedElement},
    metadata=None
)
