...
class metamodel_Type(ABC):
    ...
    def __init__(self, name: str, metamodel_Type16: "metamodel_Feature" = None, metamodel_Type: "metamodel_Model" = None):
        self.name = name
...
class metamodel_Feature:
    ...
    def __init__(self, name: str, nullable: bool, xmltransient: bool, metamodel_Feature23: "metamodel_AssociationEntity" = None, metamodel_Feature15: "metamodel_Type" = None, metamodel_Feature: "metamodel_Entity" = None):
        self.name = name
...
class metamodel_Relation(Type):
    ...
    def __init__(self, unidirectional: bool, optional: bool, Relation25: "metamodel_AssociationEntity" = None, owns: "metamodel_Entity" = None, ownedBy: "metamodel_Entity" = None, relation: "metamodel_AssociationEntity" = None, Relation: "metamodel_Entity" = None, Relation6: "metamodel_Entity" = None):
