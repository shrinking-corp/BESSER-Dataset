...
# Classes
metamodel_DatabaseConnection = Class(name="metamodel_DatabaseConnection")
metamodel_Datatype = Class(name="metamodel_Datatype")
Type = Class(name="Type")
metamodel_Entity = Class(name="metamodel_Entity")
metamodel_Feature = Class(name="metamodel_Feature")
metamodel_Relation = Class(name="metamodel_Relation", is_abstract=True)
metamodel_idFeature = Class(name="metamodel_idFeature")
metamodel_Model = Class(name="metamodel_Model")
metamodel_Type = Class(name="metamodel_Type", is_abstract=True)
metamodel_ManyToMany = Class(name="metamodel_ManyToMany")
Feature = Class(name="Feature")
metamodel_AssociationEntity = Class(name="metamodel_AssociationEntity")
metamodel_OneToOne = Class(name="metamodel_OneToOne")
Relation = Class(name="Relation")
metamodel_OneToMany = Class(name="metamodel_OneToMany")
...
metamodel_DatabaseConnection.attributes={metamodel_DatabaseConnection_persistenceUnit, metamodel_DatabaseConnection_jdbcUrl, metamodel_DatabaseConnection_jdbcPrefix, metamodel_DatabaseConnection_jdbcDriver, metamodel_DatabaseConnection_jdbcPassword, metamodel_DatabaseConnection_jdbcUser}
...
metamodel_Feature.attributes={metamodel_Feature_nullable, metamodel_Feature_name, metamodel_Feature_xmltransient}
...
domain_model = DomainModel(
    name="metamodel",
    types={metamodel_DatabaseConnection, metamodel_Datatype, Type, metamodel_Entity, metamodel_Feature, metamodel_Relation, metamodel_idFeature, metamodel_Model, metamodel_Type, metamodel_ManyToMany, Feature, metamodel_AssociationEntity, metamodel_OneToOne, Relation, metamodel_OneToMany},
    associations={connector1, features3, owns4, ownedBy5, featuresId7, inherits10, types0, features22, relation24, bequeathesTo12, type14, owner17, slave19, associates21},
    generalizations={gen_metamodel_Datatype_Type, gen_metamodel_Entity_Type, gen_metamodel_ManyToMany_Relation, gen_metamodel_idFeature_Feature, gen_metamodel_AssociationEntity_Type, gen_metamodel_Relation_Type, gen_metamodel_OneToOne_Relation, gen_metamodel_OneToMany_Relation},
    metadata=None
)
