...
def test_hyp_conf_evaluation_is_not_abstract():
    assert not inspect.isabstract(conf_Evaluation)


def test_hyp_conf_evaluation_constructor_exists():
    assert callable(conf_Evaluation.__init__)


def test_hyp_conf_evaluation_constructor_args():
...
def test_hyp_conf_publication_is_not_abstract():
    assert not inspect.isabstract(conf_Publication)


def test_hyp_conf_publication_constructor_exists():
    assert callable(conf_Publication.__init__)


def test_hyp_conf_publication_constructor_args():
    sig = inspect.signature(conf_Publication.__init__)
    params = list(sig.parameters.keys())



def test_hyp_conf_researcher_is_not_abstract():
    assert not inspect.isabstract(conf_Researcher)


def test_hyp_conf_researcher_constructor_exists():
    assert callable(conf_Researcher.__init__)


def test_hyp_conf_researcher_constructor_args():
    sig = inspect.signature(conf_Researcher.__init__)
    params = list(sig.parameters.keys())



def test_hyp_conf_person_is_not_abstract():
    assert not inspect.isabstract(conf_Person)


def test_hyp_conf_person_constructor_exists():
    assert callable(conf_Person.__init__)


def test_hyp_conf_person_constructor_args():
    sig = inspect.signature(conf_Person.__init__)
    params = list(sig.parameters.keys())



def test_hyp_conf_revisionnote_is_not_abstract():
    assert not inspect.isabstract(conf_RevisionNote)


def test_hyp_conf_revisionnote_constructor_exists():
    assert callable(conf_RevisionNote.__init__)


def test_hyp_conf_revisionnote_constructor_args():
    sig = inspect.signature(conf_RevisionNote.__init__)
    params = list(sig.parameters.keys())



def test_hyp_conf_chapter_is_not_abstract():
    assert not inspect.isabstract(conf_Chapter)


def test_hyp_conf_chapter_constructor_exists():
    assert callable(conf_Chapter.__init__)


def test_hyp_conf_chapter_constructor_args():
    sig = inspect.signature(conf_Chapter.__init__)
    params = list(sig.parameters.keys())



def test_hyp_conf_contribution_is_not_abstract():
    assert not inspect.isabstract(conf_Contribution)


def test_hyp_conf_contribution_constructor_exists():
    assert callable(conf_Contribution.__init__)


def test_hyp_conf_contribution_constructor_args():
    sig = inspect.signature(conf_Contribution.__init__)
    params = list(sig.parameters.keys())



def test_hyp_conf_steeringcomitee_is_not_abstract():
    assert not inspect.isabstract(conf_SteeringComitee)


def test_hyp_conf_steeringcomitee_constructor_exists():
    assert callable(conf_SteeringComitee.__init__)


def test_hyp_conf_steeringcomitee_constructor_args():
    sig = inspect.signature(conf_SteeringComitee.__init__)
    params = list(sig.parameters.keys())



def test_hyp_conf_programcomitee_is_not_abstract():
    assert not inspect.isabstract(conf_ProgramComitee)


def test_hyp_conf_programcomitee_constructor_exists():
    assert callable(conf_ProgramComitee.__init__)


def test_hyp_conf_programcomitee_constructor_args():
    sig = inspect.signature(conf_ProgramComitee.__init__)
    params = list(sig.parameters.keys())



def test_hyp_conf_location_is_not_abstract():
    assert not inspect.isabstract(conf_Location)


def test_hyp_conf_location_constructor_exists():
    assert callable(conf_Location.__init__)


def test_hyp_conf_location_constructor_args():
...
def test_hyp_conf_session_is_not_abstract():
    assert not inspect.isabstract(conf_Session)


def test_hyp_conf_session_constructor_exists():
    assert callable(conf_Session.__init__)


def test_hyp_conf_session_constructor_args():
...
def test_hyp_conf_revisionprocess_is_not_abstract():
    assert not inspect.isabstract(conf_RevisionProcess)


def test_hyp_conf_revisionprocess_constructor_exists():
    assert callable(conf_RevisionProcess.__init__)


def test_hyp_conf_revisionprocess_constructor_args():
    sig = inspect.signature(conf_RevisionProcess.__init__)
    params = list(sig.parameters.keys())



def test_hyp_conf_conference_is_not_abstract():
    assert not inspect.isabstract(conf_Conference)


def test_hyp_conf_conference_constructor_exists():
    assert callable(conf_Conference.__init__)


def test_hyp_conf_conference_constructor_args():
    sig = inspect.signature(conf_Conference.__init__)
    params = list(sig.parameters.keys())



def test_hyp_conf_laboratory_is_not_abstract():
    assert not inspect.isabstract(conf_Laboratory)


def test_hyp_conf_laboratory_constructor_exists():
    assert callable(conf_Laboratory.__init__)


def test_hyp_conf_laboratory_constructor_args():
    sig = inspect.signature(conf_Laboratory.__init__)
    params = list(sig.parameters.keys())



def test_hyp_conf_admin_is_not_abstract():
    assert not inspect.isabstract(conf_Admin)


def test_hyp_conf_admin_constructor_exists():
    assert callable(conf_Admin.__init__)


def test_hyp_conf_admin_constructor_args():
    sig = inspect.signature(conf_Admin.__init__)
    params = list(sig.parameters.keys())



def test_hyp_conf_system_is_not_abstract():
    assert not inspect.isabstract(conf_System)


def test_hyp_conf_system_constructor_exists():
    assert callable(conf_System.__init__)


def test_hyp_conf_system_constructor_args():
...
def test_hyp_conf_location_name_setter(instance):
...
def test_hyp_conf_session_year_setter(instance):
