...
# Classes
conf_System = Class(name="conf_System")
conf_Admin = Class(name="conf_Admin")
conf_Laboratory = Class(name="conf_Laboratory")
conf_Conference = Class(name="conf_Conference")
conf_RevisionProcess = Class(name="conf_RevisionProcess")
conf_Session = Class(name="conf_Session")
conf_Location = Class(name="conf_Location")
conf_ProgramComitee = Class(name="conf_ProgramComitee")
conf_SteeringComitee = Class(name="conf_SteeringComitee")
conf_Contribution = Class(name="conf_Contribution")
conf_Chapter = Class(name="conf_Chapter")
conf_RevisionNote = Class(name="conf_RevisionNote")
conf_Person = Class(name="conf_Person")
conf_Researcher = Class(name="conf_Researcher")
conf_Publication = Class(name="conf_Publication")
Person = Class(name="Person")
conf_Evaluation = Class(name="conf_Evaluation")
...
domain_model = DomainModel(
    name="conf",
    types={conf_System, conf_Admin, conf_Laboratory, conf_Conference, conf_RevisionProcess, conf_Session, conf_Location, conf_ProgramComitee, conf_SteeringComitee, conf_Contribution, conf_Chapter, conf_RevisionNote, conf_Person, conf_Researcher, conf_Publication, Person, conf_Evaluation},
    associations={admin0, laboratories1, conferences3, revisionProcess5, location7, progcomit8, steercomit10, contributions12, locations14, writes26, reviews28, chapters30, revisonNotes33, scPerson36, pcPerson38, publication41, evPubli44, sessions17, researchers20, publications22, evaluations24},
