...
class trace_Trace:
    ...
    def addClassMapping(self, trace_proto, trace_image) :
        # TODO: Implement addClassMapping method
        pass

    def addAttributeMapping(self, trace_proto, trace_image):
        # TODO: Implement addAttributeMapping method
        pass

    def addReferenceMapping(self, trace_proto, trace_image, trace_type):
