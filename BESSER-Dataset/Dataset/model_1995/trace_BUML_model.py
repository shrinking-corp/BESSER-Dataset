...
trace_ClassMapping = Class(name="trace_ClassMapping")
trace_AttributeMapping = Class(name="trace_AttributeMapping")
trace_ReferenceMapping = Class(name="trace_ReferenceMapping")
trace_EAttribute = Class(name="trace_EAttribute")
trace_EReference = Class(name="trace_EReference")
trace_Trace = Class(name="trace_Trace")
trace_EPackage = Class(name="trace_EPackage")
...
trace_Trace_m_addClassMapping: Method = Method(name="addClassMapping", parameters={Parameter(name='trace_proto', type=StringType), Parameter(name='trace_image', type=StringType)}, type=StringType)
trace_Trace_m_addAttributeMapping: Method = Method(name="addAttributeMapping", parameters={Parameter(name='trace_proto', type=StringType), Parameter(name='trace_image', type=StringType)})
trace_Trace_m_addReferenceMapping: Method = Method(name="addReferenceMapping", parameters={Parameter(name='trace_proto', type=StringType), Parameter(name='trace_type', type=StringType), Parameter(name='trace_image', type=StringType)})
trace_Trace.methods={trace_Trace_m_addClassMapping, trace_Trace_m_addReferenceMapping, trace_Trace_m_addAttributeMapping}
...
domain_model = DomainModel(
    name="trace",
    types={trace_EClass, trace_ClassMapping, trace_AttributeMapping, trace_ReferenceMapping, trace_EAttribute, trace_EReference, trace_Trace, trace_EPackage, trace_EStructuralFeature, ReferenceMappingType},
