...
class gseq_Method:
    ...
    def __init__(self, name: str, Method: "gseq_Program" = None, gseq_Method: "gseq_Program" = None, executedBy: set["gseq_Operation"] = None, methods: "gseq_Program" = None, methodToCall: set["gseq_MethodCall"] = None, Method6: "gseq_Operation" = None, Method9: "gseq_MethodCall" = None):
        self.name = name
        self.Method = Method
...
class gseq_IntegerExpression(Operation):
    ...
    def __init__(self, gseq_IntegerExpression29: "gseq_Assign" = None, gseq_IntegerExpression31: "gseq_Plus" = None, gseq_IntegerExpression34: "gseq_Plus" = None, gseq_IntegerExpression36: "gseq_GreaterThan" = None, gseq_IntegerExpression: "gseq_Equality" = None, gseq_IntegerExpression20: "gseq_Equality" = None, gseq_IntegerExpression39: "gseq_GreaterThan" = None, gseq_IntegerExpression44: "gseq_While" = None):
...
class gseq_BooleanExpression(Operation):
    ...
    def __init__(self, gseq_BooleanExpression24: "gseq_And" = None, gseq_BooleanExpression27: "gseq_And" = None, gseq_BooleanExpression: "gseq_If" = None, gseq_BooleanExpression22: "gseq_Not" = None, gseq_BooleanExpression41: "gseq_While" = None):
...
class gseq_Operation(ABC):
    ...
    def __init__(self, Operation: "gseq_Method" = None, operations: "gseq_Method" = None, gseq_Operation: "gseq_Print" = None, gseq_Operation11: "gseq_If" = None, gseq_Operation14: "gseq_If" = None):
