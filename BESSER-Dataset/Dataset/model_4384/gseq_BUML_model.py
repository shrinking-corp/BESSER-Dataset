...
# Classes
gseq_Operation = Class(name="gseq_Operation", is_abstract=True)
gseq_MethodCall = Class(name="gseq_MethodCall")
gseq_Print = Class(name="gseq_Print")
Operation = Class(name="Operation")
IntegerExpression = Class(name="IntegerExpression")
gseq_BooleanExpression = Class(name="gseq_BooleanExpression", is_abstract=True)
gseq_If = Class(name="gseq_If")
gseq_Program = Class(name="gseq_Program")
gseq_Method = Class(name="gseq_Method")
gseq_And = Class(name="gseq_And")
gseq_Const = Class(name="gseq_Const")
gseq_Var = Class(name="gseq_Var")
gseq_Assign = Class(name="gseq_Assign")
gseq_Plus = Class(name="gseq_Plus")
gseq_GreaterThan = Class(name="gseq_GreaterThan")
gseq_True = Class(name="gseq_True")
BooleanExpression = Class(name="BooleanExpression")
gseq_False = Class(name="gseq_False")
gseq_Equality = Class(name="gseq_Equality")
gseq_IntegerExpression = Class(name="gseq_IntegerExpression", is_abstract=True)
gseq_Not = Class(name="gseq_Not")
gseq_While = Class(name="gseq_While")
...
gseq_BooleanExpression.methods={gseq_BooleanExpression_m_pretty, gseq_BooleanExpression_m_bvalue}
...
domain_model = DomainModel(
    name="gseq",
    types={gseq_Operation, gseq_MethodCall, gseq_Print, Operation, IntegerExpression, gseq_BooleanExpression, gseq_If, gseq_Program, gseq_Method, gseq_And, gseq_Const, gseq_Var, gseq_Assign, gseq_Plus, gseq_GreaterThan, gseq_True, BooleanExpression, gseq_False, gseq_Equality, gseq_IntegerExpression, gseq_Not, gseq_While},
    associations={operations2, inProgram3, calledBy4, executedBy5, toPrint7, methodToCall8, methods0, startMethod1, leftAnd23, rightAnd25, assignedExpression28, leftPlus30, rightPlus32, leftGreaterThan35, elseBranch10, thenBranch12, conditionIf15, leftEquality17, rightEquality18, notExpression21, rightGreaterThan37, whileCondition40, whileExpression42},
    generalizations={gen_gseq_Print_Operation, gen_gseq_MethodCall_IntegerExpression, gen_gseq_BooleanExpression_Operation, gen_gseq_If_Operation, gen_gseq_And_BooleanExpression, gen_gseq_IntegerExpression_Operation, gen_gseq_Const_IntegerExpression, gen_gseq_Var_IntegerExpression, gen_gseq_Assign_Operation, gen_gseq_Plus_IntegerExpression, gen_gseq_GreaterThan_BooleanExpression, gen_gseq_True_BooleanExpression, gen_gseq_False_BooleanExpression, gen_gseq_Equality_BooleanExpression, gen_gseq_Not_BooleanExpression, gen_gseq_While_Operation},
    metadata=None
)
