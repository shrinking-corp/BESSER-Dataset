...
transaction_Transaction.attributes={transaction_Transaction_type, transaction_Transaction_transactionTime, transaction_Transaction_amount, transaction_Transaction_id}
...
mypackage_Login.attributes={mypackage_Login_username, mypackage_Login_lastLoginTime, mypackage_Login_securityAnswer, mypackage_Login_password, mypackage_Login_securityQuestion}
...
mypackage_Customer.attributes={mypackage_Customer_dateOfBirth, mypackage_Customer_phoneNumber, mypackage_Customer_address, mypackage_Customer_name, mypackage_Customer_emailAddress}
...
domain_model = DomainModel(
    name="_305da00e_5d02_4709_ae7e_ac83d8f2b38d",
