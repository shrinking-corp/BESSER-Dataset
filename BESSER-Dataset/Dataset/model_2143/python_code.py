...
class WT_StateMachine:
    ...
    def __init__(self, name: str, isPublic: bool, WT_StateMachine: "WT_ControlSubsystem" = None, WT_StateMachine19: set["WT_Vertex"] = None, WT_StateMachine21: set["WT_Edge"] = None, WT_StateMachine32: "WT_Component" = None):
        self.name = name
        self.isPublic = isPublic
