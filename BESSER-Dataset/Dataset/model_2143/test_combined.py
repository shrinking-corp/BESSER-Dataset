...
def test_hyp_wt_connector_is_not_abstract():
    assert not inspect.isabstract(WT_Connector)


def test_hyp_wt_connector_constructor_exists():
    assert callable(WT_Connector.__init__)


def test_hyp_wt_connector_constructor_args():
...
def test_hyp_wt_port_isPublic_setter(instance):
