...
# Classes
WT_Architecture = Class(name="WT_Architecture")
WT_ControlSubsystem = Class(name="WT_ControlSubsystem")
WT_Component = Class(name="WT_Component")
WT_Connector = Class(name="WT_Connector")
WT_InPort = Class(name="WT_InPort")
WT_OutPort = Class(name="WT_OutPort")
WT_StateMachine = Class(name="WT_StateMachine")
WT_Vertex = Class(name="WT_Vertex", is_abstract=True)
WT_Edge = Class(name="WT_Edge")
WT_WTComponents = Class(name="WT_WTComponents")
WT_Subsystem = Class(name="WT_Subsystem")
WT_InitialState = Class(name="WT_InitialState")
Vertex = Class(name="Vertex")
WT_SimpleState = Class(name="WT_SimpleState")
WT_Port = Class(name="WT_Port", is_abstract=True)
Port = Class(name="Port")
WT_DocumentElt = Class(name="WT_DocumentElt", is_abstract=True)
...
WT_StateMachine.attributes={WT_StateMachine_isPublic, WT_StateMachine_name}
...
domain_model = DomainModel(
    name="WT",
    types={WT_Architecture, WT_ControlSubsystem, WT_Component, WT_Connector, WT_InPort, WT_OutPort, WT_StateMachine, WT_Vertex, WT_Edge, WT_WTComponents, WT_Subsystem, WT_InitialState, Vertex, WT_SimpleState, WT_Port, Port, WT_DocumentElt, DocumentElt},
    associations={subsystems0, subsystems2, ensembles4, beh6, elements8, connectors10, inPort12, outPort14, states16, states18, transitions20, incoming23, source25, target26, ports28, states30, outgoing22},
    generalizations={gen_WT_Edge_DocumentElt, gen_WT_InitialState_Vertex, gen_WT_SimpleState_Vertex, gen_WT_InPort_Port, gen_WT_OutPort_Port, gen_WT_Vertex_DocumentElt},
    metadata=None
)
