...
mm_pictograms_Diagram.attributes={mm_pictograms_Diagram_snapToGrid, mm_pictograms_Diagram_diagramTypeId, mm_pictograms_Diagram_name, mm_pictograms_Diagram_version, mm_pictograms_Diagram_showGuides, mm_pictograms_Diagram_gridUnit, mm_pictograms_Diagram_verticalGridUnit}
...
mm_algorithms_GraphicsAlgorithm.attributes={mm_algorithms_GraphicsAlgorithm_y, mm_algorithms_GraphicsAlgorithm_width, mm_algorithms_GraphicsAlgorithm_height, mm_algorithms_GraphicsAlgorithm_x}
...
mm_styles_Style.attributes={mm_styles_Style_verticalAlignment, mm_styles_Style_proportional, mm_styles_Style_angle, mm_styles_Style_description, mm_styles_Style_stretchV, mm_styles_Style_id, mm_styles_Style_stretchH, mm_styles_Style_horizontalAlignment}
...
mm_styles_AbstractStyle.attributes={mm_styles_AbstractStyle_lineVisible, mm_styles_AbstractStyle_lineStyle, mm_styles_AbstractStyle_transparency, mm_styles_AbstractStyle_filled, mm_styles_AbstractStyle_lineWidth}
...
mm_styles_Point.attributes={mm_styles_Point_before, mm_styles_Point_y, mm_styles_Point_x, mm_styles_Point_after}
...
style44: BinaryAssociation = BinaryAssociation(
    name="style44",
    ends={
        Property(name="styles_Style45", type=mm_algorithms_GraphicsAlgorithm, multiplicity=Multiplicity(1, 1)),
        Property(name="mm_algorithms_GraphicsAlgorithm", type=styles_Style, multiplicity=Multiplicity(0, 1))
    }
)
points46: BinaryAssociation = BinaryAssociation(
    name="points46",
    ends={
        Property(name="styles_Point47", type=mm_algorithms_Polyline, multiplicity=Multiplicity(1, 1)),
        Property(name="mm_algorithms_Polyline", type=styles_Point, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
font48: BinaryAssociation = BinaryAssociation(
    name="font48",
    ends={
        Property(name="styles_Font49", type=mm_algorithms_AbstractText, multiplicity=Multiplicity(1, 1)),
...
adaptedGradientColoredAreas52: BinaryAssociation = BinaryAssociation(
    name="adaptedGradientColoredAreas52",
    ends={
...
font53: BinaryAssociation = BinaryAssociation(
    name="font53",
    ends={
        Property(name="styles_Font54", type=mm_styles_Style, multiplicity=Multiplicity(1, 1)),
        Property(name="mm_styles_Style", type=styles_Font, multiplicity=Multiplicity(0, 1))
    }
)
styleContainer55: BinaryAssociation = BinaryAssociation(
    name="styleContainer55",
    ends={
        Property(name="styles_mm_StyleContainer", type=mm_styles_Style, multiplicity=Multiplicity(1, 1)),
        Property(name="mm_styles_Style56", type=styles_mm_StyleContainer, multiplicity=Multiplicity(1, 1))
    }
)
background57: BinaryAssociation = BinaryAssociation(
    name="background57",
    ends={
        Property(name="styles_Color58", type=mm_styles_AbstractStyle, multiplicity=Multiplicity(1, 1)),
        Property(name="mm_styles_AbstractStyle", type=styles_Color, multiplicity=Multiplicity(0, 1))
    }
)
foreground59: BinaryAssociation = BinaryAssociation(
    name="foreground59",
    ends={
        Property(name="styles_Color61", type=mm_styles_AbstractStyle, multiplicity=Multiplicity(1, 1)),
        Property(name="mm_styles_AbstractStyle60", type=styles_Color, multiplicity=Multiplicity(0, 1))
    }
)
styleRegions50: BinaryAssociation = BinaryAssociation(
    name="styleRegions50",
    ends={
        Property(name="styles_TextStyleRegion", type=mm_algorithms_AbstractText, multiplicity=Multiplicity(1, 1)),
        Property(name="mm_algorithms_AbstractText51", type=styles_TextStyleRegion, multiplicity=Multiplicity(0, 9999), is_composite=True)
    }
)
color64: BinaryAssociation = BinaryAssociation(
    name="color64",
    ends={
        Property(name="styles_Color65", type=mm_styles_GradientColoredLocation, multiplicity=Multiplicity(1, 1)),
...
end67: BinaryAssociation = BinaryAssociation(
    name="end67",
    ends={
        Property(name="styles_GradientColoredLocation69", type=mm_styles_GradientColoredArea, multiplicity=Multiplicity(1, 1)),
        Property(name="mm_styles_GradientColoredArea68", type=styles_GradientColoredLocation, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
gradientColor70: BinaryAssociation = BinaryAssociation(
    name="gradientColor70",
    ends={
...
adaptedGradientColoredAreas71: BinaryAssociation = BinaryAssociation(
    name="adaptedGradientColoredAreas71",
    ends={
...
renderingStyle62: BinaryAssociation = BinaryAssociation(
    name="renderingStyle62",
    ends={
        Property(name="styles_RenderingStyle", type=mm_styles_AbstractStyle, multiplicity=Multiplicity(1, 1)),
        Property(name="mm_styles_AbstractStyle63", type=styles_RenderingStyle, multiplicity=Multiplicity(0, 1), is_composite=True)
    }
)
font72: BinaryAssociation = BinaryAssociation(
    name="font72",
    ends={
        Property(name="styles_Font73", type=mm_styles_TextStyle, multiplicity=Multiplicity(1, 1)),
        Property(name="mm_styles_TextStyle", type=styles_Font, multiplicity=Multiplicity(0, 1))
    }
)
foreground74: BinaryAssociation = BinaryAssociation(
    name="foreground74",
    ends={
        Property(name="styles_Color76", type=mm_styles_TextStyle, multiplicity=Multiplicity(1, 1)),
        Property(name="mm_styles_TextStyle75", type=styles_Color, multiplicity=Multiplicity(0, 1))
    }
)
background77: BinaryAssociation = BinaryAssociation(
    name="background77",
    ends={
        Property(name="styles_Color79", type=mm_styles_TextStyle, multiplicity=Multiplicity(1, 1)),
        Property(name="mm_styles_TextStyle78", type=styles_Color, multiplicity=Multiplicity(0, 1))
    }
)
underlineColor80: BinaryAssociation = BinaryAssociation(
    name="underlineColor80",
    ends={
        Property(name="styles_Color82", type=mm_styles_TextStyle, multiplicity=Multiplicity(1, 1)),
        Property(name="mm_styles_TextStyle81", type=styles_Color, multiplicity=Multiplicity(0, 1))
    }
)
strikeoutColor83: BinaryAssociation = BinaryAssociation(
    name="strikeoutColor83",
    ends={
        Property(name="styles_Color85", type=mm_styles_TextStyle, multiplicity=Multiplicity(1, 1)),
        Property(name="mm_styles_TextStyle84", type=styles_Color, multiplicity=Multiplicity(0, 1))
    }
)
style86: BinaryAssociation = BinaryAssociation(
    name="style86",
    ends={
...
domain_model = DomainModel(
    name="mm",
    types={mm_Property, mm_PropertyContainer, mm_GraphicsAlgorithmContainer, PropertyContainer, mm_StyleContainer, styles_Style, mm_pictograms_Shape, AnchorContainer, ContainerShape, mm_pictograms_ContainerShape, Shape, mm_pictograms_Diagram, pictograms_ContainerShape, StyleContainer, Connection, mm_pictograms_PictogramElement, GraphicsAlgorithmContainer, GraphicsAlgorithm, mm_pictograms_Connection, Anchor, Diagram, ConnectionDecorator, mm_pictograms_Anchor, PictogramElement, mm_pictograms_AnchorContainer, styles_Color, styles_Font, PictogramLink, mm_pictograms_ChopboxAnchor, mm_pictograms_ConnectionDecorator, mm_pictograms_FreeFormConnection, mm_pictograms_ManhattanConnection, mm_pictograms_PictogramLink, pictograms_mm_EObject, mm_pictograms_AdvancedAnchor, mm_pictograms_CurvedConnection, styles_PrecisionPoint, mm_pictograms_CompositeConnection, CurvedConnection, mm_pictograms_FixPointAnchor, AdvancedAnchor, styles_Point, mm_pictograms_BoxRelativeAnchor, mm_algorithms_Polyline, mm_algorithms_Ellipse, mm_algorithms_Text, AbstractText, mm_algorithms_Polygon, Polyline, mm_algorithms_Rectangle, mm_algorithms_RoundedRectangle, mm_algorithms_Image, mm_algorithms_PlatformGraphicsAlgorithm, mm_algorithms_AbstractText, mm_algorithms_GraphicsAlgorithm, styles_AbstractStyle, mm_styles_RenderingStyle, styles_AdaptedGradientColoredAreas, mm_styles_Style, styles_mm_StyleContainer, mm_styles_AbstractStyle, styles_TextStyleRegion, mm_algorithms_MultiText, mm_styles_GradientColoredArea, styles_GradientColoredLocation, mm_styles_GradientColoredAreas, styles_GradientColoredArea, mm_styles_AdaptedGradientColoredAreas, styles_GradientColoredAreas, mm_styles_Font, mm_styles_Point, mm_styles_Color, styles_RenderingStyle, mm_styles_GradientColoredLocation, mm_styles_TextStyleRegion, styles_TextStyle, mm_styles_PrecisionPoint, mm_styles_TextStyle, Orientation, LocationType, UnderlineStyle, LineStyle},
    associations={properties0, styles1, container2, children3, connections4, graphicsAlgorithm10, link11, start14, end15, parent17, connectionDecorators18, parent19, outgoingConnections20, incomingConnections22, referencedGraphicsAlgorithm24, colors5, fonts6, pictogramLinks8, connection30, bendpoints32, pictogramElement34, businessObjects35, controlPoints36, children37, anchors26, location29, pictogramElement42, style44, points46, font48, graphicsAlgorithmChildren38, parentGraphicsAlgorithm40, adaptedGradientColoredAreas52, font53, styleContainer55, background57, foreground59, styleRegions50, color64, start66, end67, gradientColor70, adaptedGradientColoredAreas71, renderingStyle62, font72, foreground74, background77, underlineColor80, strikeoutColor83, style86},
    generalizations={gen_mm_GraphicsAlgorithmContainer_PropertyContainer, gen_mm_pictograms_Shape_AnchorContainer, gen_mm_pictograms_ContainerShape_Shape, gen_mm_pictograms_Diagram_pictograms_ContainerShape, gen_mm_pictograms_Diagram_StyleContainer, gen_mm_pictograms_PictogramElement_GraphicsAlgorithmContainer, gen_mm_pictograms_Connection_AnchorContainer, gen_mm_pictograms_Anchor_PictogramElement, gen_mm_pictograms_AnchorContainer_PictogramElement, gen_mm_pictograms_ChopboxAnchor_Anchor, gen_mm_pictograms_ConnectionDecorator_Shape, gen_mm_pictograms_FreeFormConnection_Connection, gen_mm_pictograms_ManhattanConnection_Connection, gen_mm_pictograms_PictogramLink_PropertyContainer, gen_mm_pictograms_AdvancedAnchor_Anchor, gen_mm_pictograms_CurvedConnection_Connection, gen_mm_pictograms_CompositeConnection_Connection, gen_mm_pictograms_FixPointAnchor_AdvancedAnchor, gen_mm_pictograms_BoxRelativeAnchor_AdvancedAnchor, gen_mm_algorithms_Polyline_GraphicsAlgorithm, gen_mm_algorithms_Ellipse_GraphicsAlgorithm, gen_mm_algorithms_Text_AbstractText, gen_mm_algorithms_Polygon_Polyline, gen_mm_algorithms_Rectangle_GraphicsAlgorithm, gen_mm_algorithms_RoundedRectangle_GraphicsAlgorithm, gen_mm_algorithms_Image_GraphicsAlgorithm, gen_mm_algorithms_PlatformGraphicsAlgorithm_GraphicsAlgorithm, gen_mm_algorithms_AbstractText_GraphicsAlgorithm, gen_mm_algorithms_GraphicsAlgorithm_GraphicsAlgorithmContainer, gen_mm_algorithms_GraphicsAlgorithm_styles_AbstractStyle, gen_mm_styles_Style_StyleContainer, gen_mm_styles_Style_styles_AbstractStyle, gen_mm_algorithms_MultiText_AbstractText},
    metadata=None
)
