...
Customer.attributes={Customer_phoneNumber, Customer_emailAddress, Customer_dateOfBirth, Customer_address, Customer_name}
...
Login.attributes={Login_username, Login_lastLoginTime, Login_securityAnswer, Login_password, Login_securityQuestion}
