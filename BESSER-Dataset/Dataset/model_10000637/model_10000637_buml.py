...
HouseHolds.attributes={HouseHolds_Alarm, HouseHolds_DishWasher, HouseHolds_TimeID, HouseHolds_WashingMachine, HouseHolds_Coffee}
...
domain_model = DomainModel(
    name="_4e5e4c06_f863_4a10_9c95_952d7eb6d169",
    ...
    associations={Sensor_Door, Door_Camera, HomeTheatre_Speakers, HouseHolds_Start_Of_Day, HouseHolds_End_Of_Day, MicroPhone_System, Home_Security_System_Alert, Sensor_System, System_HouseHolds, HomeTheatre_System, Home_Security_System_System, TV_Entertainment, Speakers_Entertainment, HomeTheatre_Entertainment, HomeTheatre_TV},
    generalizations={},
    metadata=None
)
