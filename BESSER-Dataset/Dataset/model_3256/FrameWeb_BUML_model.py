...
# Classes
frameweb_FramewebProject = Class(name="frameweb_FramewebProject")
Profile = Class(name="Profile")
frameweb_EntityModel = Class(name="frameweb_EntityModel")
FramewebModel = Class(name="FramewebModel")
frameweb_NavigationModel = Class(name="frameweb_NavigationModel")
frameweb_ApplicationModel = Class(name="frameweb_ApplicationModel")
frameweb_PersistenceModel = Class(name="frameweb_PersistenceModel")
frameweb_DomainAssociation = Class(name="frameweb_DomainAssociation")
Association = Class(name="Association")
frameweb_DomainAttribute = Class(name="frameweb_DomainAttribute")
Property_ = Class(name="Property")
frameweb_VersionAttribute = Class(name="frameweb_VersionAttribute")
DomainAttribute = Class(name="DomainAttribute")
frameweb_FramewebModel = Class(name="frameweb_FramewebModel", is_abstract=True)
frameweb_FrameworkProfile = Class(name="frameweb_FrameworkProfile")
Model = Class(name="Model")
frameweb_DateTimeAttribute = Class(name="frameweb_DateTimeAttribute")
frameweb_Page = Class(name="frameweb_Page")
NavigationClass = Class(name="NavigationClass")
frameweb_TagLib = Class(name="frameweb_TagLib")
frameweb_Template = Class(name="frameweb_Template")
frameweb_DAOInterface = Class(name="frameweb_DAOInterface")
Interface = Class(name="Interface")
frameweb_IdAttribute = Class(name="frameweb_IdAttribute")
frameweb_LOBAttribute = Class(name="frameweb_LOBAttribute")
frameweb_EmbeddedAttribute = Class(name="frameweb_EmbeddedAttribute")
frameweb_DecimalAttribute = Class(name="frameweb_DecimalAttribute")
frameweb_ResultDependency = Class(name="frameweb_ResultDependency")
NavigationDependency = Class(name="NavigationDependency")
frameweb_Result = Class(name="frameweb_Result")
frameweb_FrontControllerMethod = Class(name="frameweb_FrontControllerMethod")
frameweb_ResultConstraint = Class(name="frameweb_ResultConstraint")
frameweb_NavigationAssociation = Class(name="frameweb_NavigationAssociation")
Operation = Class(name="Operation")
frameweb_ServiceClass = Class(name="frameweb_ServiceClass")
frameweb_ServiceInterface = Class(name="frameweb_ServiceInterface")
frameweb_ServiceGeneralization = Class(name="frameweb_ServiceGeneralization")
Generalization_ = Class(name="Generalization_")
frameweb_DAOClass = Class(name="frameweb_DAOClass")
Class_ = Class(name="Class")
frameweb_DAORealization = Class(name="frameweb_DAORealization")
InterfaceRealization = Class(name="InterfaceRealization")
frameweb_FrontControllerClass = Class(name="frameweb_FrontControllerClass")
frameweb_IOParameter = Class(name="frameweb_IOParameter")
NavigationAttribute = Class(name="NavigationAttribute")
frameweb_UIComponentField = Class(name="frameweb_UIComponentField")
frameweb_MethodCosntraint = Class(name="frameweb_MethodCosntraint")
frameweb_PageDependency = Class(name="frameweb_PageDependency")
frameweb_PageConstraint = Class(name="frameweb_PageConstraint")
frameweb_ChainingDependency = Class(name="frameweb_ChainingDependency")
frameweb_ChainingConstraint = Class(name="frameweb_ChainingConstraint")
frameweb_DAOServiceAssociation = Class(name="frameweb_DAOServiceAssociation")
frameweb_NavigationAttribute = Class(name="frameweb_NavigationAttribute", is_abstract=True)
frameweb_ServiceControllerAssociation = Class(name="frameweb_ServiceControllerAssociation")
ServiceAssociation = Class(name="ServiceAssociation")
frameweb_DomainClass = Class(name="frameweb_DomainClass")
frameweb_FrontControllerDependency = Class(name="frameweb_FrontControllerDependency")
frameweb_DomainPackage = Class(name="frameweb_DomainPackage")
Package = Class(name="Package")
frameweb_ViewPackage = Class(name="frameweb_ViewPackage")
NavigationPackage = Class(name="NavigationPackage")
frameweb_ControllerPackage = Class(name="frameweb_ControllerPackage")
frameweb_PersistencePackage = Class(name="frameweb_PersistencePackage")
frameweb_ApplicationPackage = Class(name="frameweb_ApplicationPackage")
frameweb_UIComponent = Class(name="frameweb_UIComponent")
frameweb_ResultType = Class(name="frameweb_ResultType")
Stereotype = Class(name="Stereotype")
frameweb_NavigationPackage = Class(name="frameweb_NavigationPackage", is_abstract=True)
frameweb_DomainGeneralization = Class(name="frameweb_DomainGeneralization")
frameweb_Tag = Class(name="frameweb_Tag")
frameweb_NavigationCompositionPart = Class(name="frameweb_NavigationCompositionPart")
NavigationProperty = Class(name="NavigationProperty")
frameweb_NavigationCompositionWhole = Class(name="frameweb_NavigationCompositionWhole")
frameweb_NavigationProperty = Class(name="frameweb_NavigationProperty", is_abstract=True)
frameweb_ResultSet = Class(name="frameweb_ResultSet")
frameweb_NavigationConstraint = Class(name="frameweb_NavigationConstraint", is_abstract=True)
frameweb_NavigationClass = Class(name="frameweb_NavigationClass", is_abstract=True)
frameweb_DomainMethod = Class(name="frameweb_DomainMethod")
frameweb_DAOAttribute = Class(name="frameweb_DAOAttribute")
frameweb_ServiceMethod = Class(name="frameweb_ServiceMethod")
frameweb_ServiceAttribute = Class(name="frameweb_ServiceAttribute")
frameweb_ServiceAssociation = Class(name="frameweb_ServiceAssociation", is_abstract=True)
frameweb_NavigationDependency = Class(name="frameweb_NavigationDependency", is_abstract=True)
Dependency = Class(name="Dependency")
frameweb_DAOMethod = Class(name="frameweb_DAOMethod")
frameweb_FrameworkExtension = Class(name="frameweb_FrameworkExtension", is_abstract=True)
Extension = Class(name="Extension")
frameweb_TagExtension = Class(name="frameweb_TagExtension")
NavigationExtension = Class(name="NavigationExtension")
frameweb_FrameworkApplication = Class(name="frameweb_FrameworkApplication")
ProfileApplication = Class(name="ProfileApplication")
frameweb_ControllerExtension = Class(name="frameweb_ControllerExtension")
frameweb_Controller = Class(name="frameweb_Controller")
frameweb_ControllerSet = Class(name="frameweb_ControllerSet")
frameweb_ResultExtension = Class(name="frameweb_ResultExtension")
frameweb_ClassMappingExtension = Class(name="frameweb_ClassMappingExtension")
DomainExtension = Class(name="DomainExtension")
frameweb_AttributeMappingExtension = Class(name="frameweb_AttributeMappingExtension")
frameweb_ControllerExtensionEnd = Class(name="frameweb_ControllerExtensionEnd")
ExtensionEnd = Class(name="ExtensionEnd")
frameweb_TagExtensionEnd = Class(name="frameweb_TagExtensionEnd")
frameweb_ResultExtensionEnd = Class(name="frameweb_ResultExtensionEnd")
frameweb_ClassMappingExtensionEnd = Class(name="frameweb_ClassMappingExtensionEnd")
frameweb_AttributeMappingExtensionEnd = Class(name="frameweb_AttributeMappingExtensionEnd")
frameweb_ControllerProperty = Class(name="frameweb_ControllerProperty")
frameweb_TagProperty = Class(name="frameweb_TagProperty")
frameweb_ResultProperty = Class(name="frameweb_ResultProperty")
frameweb_ClassMappingPropery = Class(name="frameweb_ClassMappingPropery")
frameweb_AttributeMappingProperty = Class(name="frameweb_AttributeMappingProperty")
frameweb_SeviceRealization = Class(name="frameweb_SeviceRealization")
frameweb_NavigationExtension = Class(name="frameweb_NavigationExtension", is_abstract=True)
FrameworkExtension = Class(name="FrameworkExtension")
Constraint = Class(name="Constraint")
NavigationConstraint = Class(name="NavigationConstraint")
frameweb_NavigationGeneralization = Class(name="frameweb_NavigationGeneralization")
frameweb_DomainConstraints = Class(name="frameweb_DomainConstraints")
frameweb_DomainProperty = Class(name="frameweb_DomainProperty")
frameweb_DAOGeneralization = Class(name="frameweb_DAOGeneralization")
frameweb_MappingLib = Class(name="frameweb_MappingLib")
frameweb_ClassMapping = Class(name="frameweb_ClassMapping")
frameweb_AttributeMapping = Class(name="frameweb_AttributeMapping")
frameweb_DomainGeneralizationSet = Class(name="frameweb_DomainGeneralizationSet")
GeneralizationSet = Class(name="GeneralizationSet")
frameweb_VocabularyModel = Class(name="frameweb_VocabularyModel")
frameweb_Vocabulary = Class(name="frameweb_Vocabulary")
frameweb_Axiom = Class(name="frameweb_Axiom")
frameweb_Annotation = Class(name="frameweb_Annotation")
frameweb_DomainExtension = Class(name="frameweb_DomainExtension", is_abstract=True)
frameweb_NavigationGeneralizationSet = Class(name="frameweb_NavigationGeneralizationSet")
frameweb_DAOGeneralizationSet = Class(name="frameweb_DAOGeneralizationSet")
frameweb_ServiceGeneralizationSet = Class(name="frameweb_ServiceGeneralizationSet")
frameweb_SemanticPackage = Class(name="frameweb_SemanticPackage")
frameweb_VocabularyConstraints = Class(name="frameweb_VocabularyConstraints")
frameweb_Property = Class(name="frameweb_Property")
StructuralFeature = Class(name="StructuralFeature")
ConnectableElement = Class(name="ConnectableElement")
frameweb_IRI = Class(name="frameweb_IRI")
DeploymentTarget = Class(name="DeploymentTarget")
frameweb_DataType = Class(name="frameweb_DataType")
frameweb_Interface = Class(name="frameweb_Interface")
frameweb_Class = Class(name="frameweb_Class")
frameweb_ValueSpecification = Class(name="frameweb_ValueSpecification")
frameweb_Association = Class(name="frameweb_Association")
Classifier = Class(name="Classifier")
Relationship = Class(name="Relationship")
frameweb_Type = Class(name="frameweb_Type")
frameweb_VocabularyAssociation = Class(name="frameweb_VocabularyAssociation")
frameweb_VocabularyProperty = Class(name="frameweb_VocabularyProperty")
frameweb_VocabularyEntity = Class(name="frameweb_VocabularyEntity", is_abstract=True)
frameweb_ObjectProperty = Class(name="frameweb_ObjectProperty")
VocabularyEntity = Class(name="VocabularyEntity")
VocabularyAssociation = Class(name="VocabularyAssociation")
frameweb_DataProperty = Class(name="frameweb_DataProperty")
frameweb_AnnotationProperty = Class(name="frameweb_AnnotationProperty")
Individual = Class(name="Individual")
frameweb_VocabularyClassExpression = Class(name="frameweb_VocabularyClassExpression", is_abstract=True)
frameweb_VocabularyClass = Class(name="frameweb_VocabularyClass")
VocabularyClassExpression = Class(name="VocabularyClassExpression")
frameweb_AnonymousIndividual = Class(name="frameweb_AnonymousIndividual")
frameweb_Individual = Class(name="frameweb_Individual", is_abstract=True)
frameweb_VocabularyLiteral = Class(name="frameweb_VocabularyLiteral")
LiteralString = Class(name="LiteralString")
frameweb_VocabularyDataType = Class(name="frameweb_VocabularyDataType")
DataType = Class(name="DataType")
frameweb_NamedIndividual = Class(name="frameweb_NamedIndividual")
...
frameweb_DomainAssociation.attributes={frameweb_DomainAssociation_order, frameweb_DomainAssociation_cascade, frameweb_DomainAssociation_collection, frameweb_DomainAssociation_fetch}
...
frameweb_DomainAttribute.attributes={frameweb_DomainAttribute_isPersistent, frameweb_DomainAttribute_size, frameweb_DomainAttribute_isNull}
...
frameweb_DAOInterface.attributes={frameweb_DAOInterface_infix, frameweb_DAOInterface_sufix}
...
frameweb_DecimalAttribute.attributes={frameweb_DecimalAttribute_decimalPrecision, frameweb_DecimalAttribute_decimalScale}
...
frameweb_ResultDependency.attributes={frameweb_ResultDependency_execute, frameweb_ResultDependency_ajax, frameweb_ResultDependency_render}
...
frameweb_Property_m_subsetting_context_conforms: Method = Method(name="subsetting_context_conforms", parameters={Parameter(name='frameweb_diagnostics', type=StringType), Parameter(name='frameweb_context', type=StringType)}, type=BooleanType)
frameweb_Property_m_derived_union_is_read_only: Method = Method(name="derived_union_is_read_only", parameters={Parameter(name='frameweb_context', type=StringType), Parameter(name='frameweb_diagnostics', type=StringType)}, type=BooleanType)
frameweb_Property_m_multiplicity_of_composite: Method = Method(name="multiplicity_of_composite", parameters={Parameter(name='frameweb_context', type=StringType), Parameter(name='frameweb_diagnostics', type=StringType)}, type=BooleanType)
frameweb_Property_m_redefined_property_inherited: Method = Method(name="redefined_property_inherited", parameters={Parameter(name='frameweb_diagnostics', type=StringType), Parameter(name='frameweb_context', type=StringType)}, type=BooleanType)
frameweb_Property_m_subsetting_rules: Method = Method(name="subsetting_rules", parameters={Parameter(name='frameweb_context', type=StringType), Parameter(name='frameweb_diagnostics', type=StringType)}, type=BooleanType)
frameweb_Property_m_binding_to_attribute: Method = Method(name="binding_to_attribute", parameters={Parameter(name='frameweb_diagnostics', type=StringType), Parameter(name='frameweb_context', type=StringType)}, type=BooleanType)
frameweb_Property_m_derived_union_is_derived: Method = Method(name="derived_union_is_derived", parameters={Parameter(name='frameweb_context', type=StringType), Parameter(name='frameweb_diagnostics', type=StringType)}, type=BooleanType)
frameweb_Property_m_deployment_target: Method = Method(name="deployment_target", parameters={Parameter(name='frameweb_context', type=StringType), Parameter(name='frameweb_diagnostics', type=StringType)}, type=BooleanType)
frameweb_Property_m_subsetted_property_names: Method = Method(name="subsetted_property_names", parameters={Parameter(name='frameweb_context', type=StringType), Parameter(name='frameweb_diagnostics', type=StringType)}, type=BooleanType)
frameweb_Property_m_type_of_opposite_end: Method = Method(name="type_of_opposite_end", parameters={Parameter(name='frameweb_diagnostics', type=StringType), Parameter(name='frameweb_context', type=StringType)}, type=BooleanType)
frameweb_Property_m_qualified_is_association_end: Method = Method(name="qualified_is_association_end", parameters={Parameter(name='frameweb_context', type=StringType), Parameter(name='frameweb_diagnostics', type=StringType)}, type=BooleanType)
...
frameweb_Property_m_setBooleanDefaultValue: Method = Method(name="setBooleanDefaultValue", parameters={Parameter(name='frameweb_value', type=StringType)})
frameweb_Property_m_setDefault: Method = Method(name="setDefault", parameters={Parameter(name='frameweb_newDefault', type=StringType)})
frameweb_Property_m_setIntegerDefaultValue: Method = Method(name="setIntegerDefaultValue", parameters={Parameter(name='frameweb_value', type=StringType)})
frameweb_Property_m_setIsComposite: Method = Method(name="setIsComposite", parameters={Parameter(name='frameweb_newIsComposite', type=StringType)})
frameweb_Property_m_setIsNavigable: Method = Method(name="setIsNavigable", parameters={Parameter(name='frameweb_isNavigable', type=StringType)})
frameweb_Property_m_setNullDefaultValue: Method = Method(name="setNullDefaultValue", parameters={})
frameweb_Property_m_setStringDefaultValue: Method = Method(name="setStringDefaultValue", parameters={Parameter(name='frameweb_value', type=StringType)})
frameweb_Property_m_setUnlimitedNaturalDefaultValue: Method = Method(name="setUnlimitedNaturalDefaultValue", parameters={Parameter(name='frameweb_value', type=StringType)})
...
frameweb_Property_m_setOpposite: Method = Method(name="setOpposite", parameters={Parameter(name='frameweb_newOpposite', type=StringType)})
frameweb_Property_m_setRealDefaultValue: Method = Method(name="setRealDefaultValue", parameters={Parameter(name='frameweb_value', type=StringType)})
frameweb_Property.attributes={frameweb_Property_aggregation, frameweb_Property_isDerived, frameweb_Property_isDerivedUnion, frameweb_Property_default, frameweb_Property_isComposite, frameweb_Property_isID}
frameweb_Property.methods={frameweb_Property_m_setIntegerDefaultValue, frameweb_Property_m_setOpposite, frameweb_Property_m_setNullDefaultValue, frameweb_Property_m_multiplicity_of_composite, frameweb_Property_m_setUnlimitedNaturalDefaultValue, frameweb_Property_m_setStringDefaultValue, frameweb_Property_m_binding_to_attribute, frameweb_Property_m_getDefault, frameweb_Property_m_setRealDefaultValue, frameweb_Property_m_isNavigable, frameweb_Property_m_derived_union_is_read_only, frameweb_Property_m_isComposite, frameweb_Property_m_getOtherEnd, frameweb_Property_m_subsetted_property_names, frameweb_Property_m_setIsNavigable, frameweb_Property_m_derived_union_is_derived, frameweb_Property_m_subsetting_context_conforms, frameweb_Property_m_deployment_target, frameweb_Property_m_unsetDefault, frameweb_Property_m_setIsComposite, frameweb_Property_m_setDefault, frameweb_Property_m_subsettingContext, frameweb_Property_m_setBooleanDefaultValue, frameweb_Property_m_isAttribute, frameweb_Property_m_subsetting_rules, frameweb_Property_m_isSetDefault, frameweb_Property_m_getOpposite, frameweb_Property_m_qualified_is_association_end, frameweb_Property_m_redefined_property_inherited, frameweb_Property_m_type_of_opposite_end}
...
frameweb_Association_m_specialized_end_number: Method = Method(name="specialized_end_number", parameters={Parameter(name='frameweb_context', type=StringType), Parameter(name='frameweb_diagnostics', type=StringType)}, type=BooleanType)
frameweb_Association_m_specialized_end_types: Method = Method(name="specialized_end_types", parameters={Parameter(name='frameweb_context', type=StringType), Parameter(name='frameweb_diagnostics', type=StringType)}, type=BooleanType)
frameweb_Association_m_binary_associations: Method = Method(name="binary_associations", parameters={Parameter(name='frameweb_context', type=StringType), Parameter(name='frameweb_diagnostics', type=StringType)}, type=BooleanType)
frameweb_Association_m_association_ends: Method = Method(name="association_ends", parameters={Parameter(name='frameweb_context', type=StringType), Parameter(name='frameweb_diagnostics', type=StringType)}, type=BooleanType)
frameweb_Association_m_ends_must_be_typed: Method = Method(name="ends_must_be_typed", parameters={Parameter(name='frameweb_context', type=StringType), Parameter(name='frameweb_diagnostics', type=StringType)}, type=BooleanType)
...
class_41: BinaryAssociation = BinaryAssociation(
    name="class_41",
    ends={
...
gen_frameweb_ServiceGeneralization_Generalization = Generalization(general=Generalization_, specific=frameweb_ServiceGeneralization)
...
gen_frameweb_DomainGeneralization_Generalization = Generalization(general=Generalization_, specific=frameweb_DomainGeneralization)
...
gen_frameweb_NavigationGeneralization_Generalization = Generalization(general=Generalization_, specific=frameweb_NavigationGeneralization)
...
gen_frameweb_DAOGeneralization_Generalization = Generalization(general=Generalization_, specific=frameweb_DAOGeneralization)
...
domain_model = DomainModel(
    name="frameweb",
    types={frameweb_FramewebProject, Profile, frameweb_EntityModel, FramewebModel, frameweb_NavigationModel, frameweb_ApplicationModel, frameweb_PersistenceModel, frameweb_DomainAssociation, Association, frameweb_DomainAttribute, Property_, frameweb_VersionAttribute, DomainAttribute, frameweb_FramewebModel, frameweb_FrameworkProfile, Model, frameweb_DateTimeAttribute, frameweb_Page, NavigationClass, frameweb_TagLib, frameweb_Template, frameweb_DAOInterface, Interface, frameweb_IdAttribute, frameweb_LOBAttribute, frameweb_EmbeddedAttribute, frameweb_DecimalAttribute, frameweb_ResultDependency, NavigationDependency, frameweb_Result, frameweb_FrontControllerMethod, frameweb_ResultConstraint, frameweb_NavigationAssociation, Operation, frameweb_ServiceClass, frameweb_ServiceInterface, frameweb_ServiceGeneralization, Generalization_, frameweb_DAOClass, Class_, frameweb_DAORealization, InterfaceRealization, frameweb_FrontControllerClass, frameweb_IOParameter, NavigationAttribute, frameweb_UIComponentField, frameweb_MethodCosntraint, frameweb_PageDependency, frameweb_PageConstraint, frameweb_ChainingDependency, frameweb_ChainingConstraint, frameweb_DAOServiceAssociation, frameweb_NavigationAttribute, frameweb_ServiceControllerAssociation, ServiceAssociation, frameweb_DomainClass, frameweb_FrontControllerDependency, frameweb_DomainPackage, Package, frameweb_ViewPackage, NavigationPackage, frameweb_ControllerPackage, frameweb_PersistencePackage, frameweb_ApplicationPackage, frameweb_UIComponent, frameweb_ResultType, Stereotype, frameweb_NavigationPackage, frameweb_DomainGeneralization, frameweb_Tag, frameweb_NavigationCompositionPart, NavigationProperty, frameweb_NavigationCompositionWhole, frameweb_NavigationProperty, frameweb_ResultSet, frameweb_NavigationConstraint, frameweb_NavigationClass, frameweb_DomainMethod, frameweb_DAOAttribute, frameweb_ServiceMethod, frameweb_ServiceAttribute, frameweb_ServiceAssociation, frameweb_NavigationDependency, Dependency, frameweb_DAOMethod, frameweb_FrameworkExtension, Extension, frameweb_TagExtension, NavigationExtension, frameweb_FrameworkApplication, ProfileApplication, frameweb_ControllerExtension, frameweb_Controller, frameweb_ControllerSet, frameweb_ResultExtension, frameweb_ClassMappingExtension, DomainExtension, frameweb_AttributeMappingExtension, frameweb_ControllerExtensionEnd, ExtensionEnd, frameweb_TagExtensionEnd, frameweb_ResultExtensionEnd, frameweb_ClassMappingExtensionEnd, frameweb_AttributeMappingExtensionEnd, frameweb_ControllerProperty, frameweb_TagProperty, frameweb_ResultProperty, frameweb_ClassMappingPropery, frameweb_AttributeMappingProperty, frameweb_SeviceRealization, frameweb_NavigationExtension, FrameworkExtension, Constraint, NavigationConstraint, frameweb_NavigationGeneralization, frameweb_DomainConstraints, frameweb_DomainProperty, frameweb_DAOGeneralization, frameweb_MappingLib, frameweb_ClassMapping, frameweb_AttributeMapping, frameweb_DomainGeneralizationSet, GeneralizationSet, frameweb_VocabularyModel, frameweb_Vocabulary, frameweb_Axiom, frameweb_Annotation, frameweb_DomainExtension, frameweb_NavigationGeneralizationSet, frameweb_DAOGeneralizationSet, frameweb_ServiceGeneralizationSet, frameweb_SemanticPackage, frameweb_VocabularyConstraints, frameweb_Property, StructuralFeature, ConnectableElement, frameweb_IRI, DeploymentTarget, frameweb_DataType, frameweb_Interface, frameweb_Class, frameweb_ValueSpecification, frameweb_Association, Classifier, Relationship, frameweb_Type, frameweb_VocabularyAssociation, frameweb_VocabularyProperty, frameweb_VocabularyEntity, frameweb_ObjectProperty, VocabularyEntity, VocabularyAssociation, frameweb_DataProperty, frameweb_AnnotationProperty, Individual, frameweb_VocabularyClassExpression, frameweb_VocabularyClass, VocabularyClassExpression, frameweb_AnonymousIndividual, frameweb_Individual, frameweb_VocabularyLiteral, LiteralString, frameweb_VocabularyDataType, DataType, frameweb_NamedIndividual, Collection, Order, Cascade, Fetch, DateTimePrecision, Generation, FrameworkCategoryList, ConstantNameList, InheritanceMapping, FrameworkKindList},
    associations={compose0, configures1, pageTagLib3, templateTagLib4, resultResult7, resultMethod8, resultDependendencyCosntraint10, display6, method12, methodDependendencyConstraint14, pageDependencyCosntraint16, outMethod17, inMethod19, chainingDependendencyConstraint22, inject24, directlyImportsDocuments25, vocabularyIRI26, axioms29, annotations31, datatype33, interface34, associationEnd37, qualifier39, class_41, defaultValue43, opposite46, owningAssociation48, subsettedProperty53, association55, redefinedProperty50, endType57, memberEnd58, ownedEnd60, navigableOwnedEnd62, entityIRI65, vocabularyproperty67},
    generalizations={gen_frameweb_FrameworkProfile_Profile, gen_frameweb_EntityModel_FramewebModel, gen_frameweb_NavigationModel_FramewebModel, gen_frameweb_ApplicationModel_FramewebModel, gen_frameweb_PersistenceModel_FramewebModel, gen_frameweb_DomainAssociation_Association, gen_frameweb_DomainAttribute_Property, gen_frameweb_VersionAttribute_DomainAttribute, gen_frameweb_FramewebModel_Model, gen_frameweb_DateTimeAttribute_DomainAttribute, gen_frameweb_Page_NavigationClass, gen_frameweb_Template_NavigationClass, gen_frameweb_DAOInterface_Interface, gen_frameweb_IdAttribute_DomainAttribute, gen_frameweb_LOBAttribute_DomainAttribute, gen_frameweb_EmbeddedAttribute_DomainAttribute, gen_frameweb_DecimalAttribute_DomainAttribute, gen_frameweb_ResultDependency_NavigationDependency, gen_frameweb_NavigationAssociation_Association, gen_frameweb_FrontControllerMethod_Operation, gen_frameweb_ServiceClass_Class, gen_frameweb_ServiceInterface_Interface, gen_frameweb_ServiceGeneralization_Generalization, gen_frameweb_DAOClass_Class, gen_frameweb_DAORealization_InterfaceRealization, gen_frameweb_FrontControllerClass_Class, gen_frameweb_IOParameter_NavigationAttribute, gen_frameweb_PageDependency_NavigationDependency, gen_frameweb_ChainingDependency_NavigationDependency, gen_frameweb_DAOServiceAssociation_ServiceAssociation, gen_frameweb_ServiceControllerAssociation_ServiceAssociation, gen_frameweb_DomainClass_Class, gen_frameweb_Result_Class, gen_frameweb_FrontControllerDependency_NavigationDependency, gen_frameweb_DAOMethod_Operation, gen_frameweb_DomainPackage_Package, gen_frameweb_ViewPackage_NavigationPackage, gen_frameweb_ControllerPackage_NavigationPackage, gen_frameweb_PersistencePackage_Package, gen_frameweb_ApplicationPackage_Package, gen_frameweb_UIComponent_NavigationClass, gen_frameweb_ResultType_Stereotype, gen_frameweb_NavigationPackage_Package, gen_frameweb_DomainGeneralization_Generalization, gen_frameweb_UIComponentField_NavigationAttribute, gen_frameweb_TagLib_Package, gen_frameweb_Tag_Stereotype, gen_frameweb_NavigationCompositionPart_NavigationProperty, gen_frameweb_NavigationCompositionWhole_NavigationProperty, gen_frameweb_NavigationProperty_Property, gen_frameweb_ResultSet_Package, gen_frameweb_NavigationAttribute_Property, gen_frameweb_NavigationClass_Class, gen_frameweb_DomainMethod_Operation, gen_frameweb_DAOAttribute_Property, gen_frameweb_ServiceMethod_Operation, gen_frameweb_ServiceAttribute_Property, gen_frameweb_ServiceAssociation_Association, gen_frameweb_NavigationDependency_Dependency, gen_frameweb_FrameworkExtension_Extension, gen_frameweb_TagExtension_NavigationExtension, gen_frameweb_FrameworkApplication_ProfileApplication, gen_frameweb_ControllerExtension_NavigationExtension, gen_frameweb_Controller_Stereotype, gen_frameweb_ControllerSet_Package, gen_frameweb_ResultExtension_NavigationExtension, gen_frameweb_ClassMappingExtension_DomainExtension, gen_frameweb_AttributeMappingExtension_DomainExtension, gen_frameweb_ControllerExtensionEnd_ExtensionEnd, gen_frameweb_TagExtensionEnd_ExtensionEnd, gen_frameweb_ResultExtensionEnd_ExtensionEnd, gen_frameweb_ClassMappingExtensionEnd_ExtensionEnd, gen_frameweb_AttributeMappingExtensionEnd_ExtensionEnd, gen_frameweb_ControllerProperty_Property, gen_frameweb_TagProperty_Property, gen_frameweb_ResultProperty_Property, gen_frameweb_ClassMappingPropery_Property, gen_frameweb_AttributeMappingProperty_Property, gen_frameweb_SeviceRealization_InterfaceRealization, gen_frameweb_NavigationExtension_FrameworkExtension, gen_frameweb_NavigationConstraint_Constraint, gen_frameweb_PageConstraint_NavigationConstraint, gen_frameweb_ResultConstraint_NavigationConstraint, gen_frameweb_MethodCosntraint_NavigationConstraint, gen_frameweb_ChainingConstraint_NavigationConstraint, gen_frameweb_NavigationGeneralization_Generalization, gen_frameweb_DomainConstraints_Constraint, gen_frameweb_DomainProperty_Property, gen_frameweb_DAOGeneralization_Generalization, gen_frameweb_MappingLib_Package, gen_frameweb_ClassMapping_Stereotype, gen_frameweb_AttributeMapping_Stereotype, gen_frameweb_DomainGeneralizationSet_GeneralizationSet, gen_frameweb_VocabularyModel_FramewebModel, gen_frameweb_Vocabulary_Package, gen_frameweb_DomainExtension_FrameworkExtension, gen_frameweb_NavigationGeneralizationSet_GeneralizationSet, gen_frameweb_Axiom_Class, gen_frameweb_DAOGeneralizationSet_GeneralizationSet, gen_frameweb_ServiceGeneralizationSet_GeneralizationSet, gen_frameweb_Annotation_Class, gen_frameweb_SemanticPackage_Package, gen_frameweb_VocabularyConstraints_Constraint, gen_frameweb_Property_StructuralFeature, gen_frameweb_IRI_Property, gen_frameweb_Property_ConnectableElement, gen_frameweb_Property_DeploymentTarget, gen_frameweb_Association_Classifier, gen_frameweb_Association_Relationship, gen_frameweb_VocabularyAssociation_Association, gen_frameweb_VocabularyProperty_Property, gen_frameweb_VocabularyEntity_Classifier, gen_frameweb_ObjectProperty_VocabularyEntity, gen_frameweb_ObjectProperty_VocabularyAssociation, gen_frameweb_DataProperty_VocabularyEntity, gen_frameweb_DataProperty_VocabularyAssociation, gen_frameweb_AnnotationProperty_VocabularyEntity, gen_frameweb_NamedIndividual_Individual, gen_frameweb_VocabularyClassExpression_Class, gen_frameweb_VocabularyClass_VocabularyEntity, gen_frameweb_VocabularyClass_VocabularyClassExpression, gen_frameweb_AnonymousIndividual_Individual, gen_frameweb_Individual_Property, gen_frameweb_VocabularyLiteral_LiteralString, gen_frameweb_AnnotationProperty_VocabularyAssociation, gen_frameweb_VocabularyDataType_VocabularyEntity, gen_frameweb_VocabularyDataType_DataType, gen_frameweb_NamedIndividual_VocabularyEntity},
    metadata=None
)
