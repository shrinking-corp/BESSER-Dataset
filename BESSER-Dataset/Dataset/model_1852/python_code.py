...
class message_Message:
    ...
    def __init__(self, uid: str, name: str, message_Message2: set["message_Translation"] = None, message_Message: "message_MessageLibrary" = None):
        self.uid = uid
        self.name = name
...
class message_Language:
    ...
    def __init__(self, uid: str, lang: str, code: str, defaultLang: bool, message_Language: "message_Translation" = None):
        self.uid = uid
        self.lang = lang
        self.code = code
...
class message_MessageLibrary(Categorized):
    ...
    def __init__(self, uid: str, name: str, message_MessageLibrary: set["message_Message"] = None):
        self.uid = uid
        self.name = name
