...
# Classes
message_MessageLibrary = Class(name="message_MessageLibrary")
Categorized = Class(name="Categorized")
message_Language = Class(name="message_Language")
message_Message = Class(name="message_Message")
message_Translation = Class(name="message_Translation")
...
message_Language.attributes={message_Language_defaultLang, message_Language_code, message_Language_lang, message_Language_uid}
...
message_Message.attributes={message_Message_uid, message_Message_name}
...
domain_model = DomainModel(
    name="message",
    types={message_MessageLibrary, Categorized, message_Language, message_Message, message_Translation},
    associations={lang3, messages0, translatioins1},
