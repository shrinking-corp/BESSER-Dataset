...
class ref_unsettable_EU:
    ...
    def __init__(self, name: str, ids: str, labels: str, eu: set["DU"] = None):
        self.name = name
        self.ids = ids
        self.labels = labels
        self.eu = eu if eu is not None else set()
    ...
    def eu(self, value):
        ...
        old_value = getattr(self, f"_ref_unsettable_EU__eu", None)
        self.__eu = value if value is not None else set()
        
        # Remove self from old opposite end
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "DU81"):
                    opp_val = getattr(item, "DU81", None)
                    
                    if opp_val == self:
                        setattr(item, "DU81", None)
...
class ref_E:
    ...
    def __init__(self, name: str, ids: str, labels: str, E: "ref_D" = None, e: set["ref_D"] = None):
        self.name = name
        self.ids = ids
        self.labels = labels
        self.E = E
