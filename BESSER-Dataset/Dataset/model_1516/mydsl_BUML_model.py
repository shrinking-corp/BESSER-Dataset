...
domain_model = DomainModel(
    name="mydsl",
    types={mydsl_Initial, State, mydsl_FSM, mydsl_State, mydsl_Transition, mydsl_Final},
    associations={initial5, state7, state0, transition1, final3},
