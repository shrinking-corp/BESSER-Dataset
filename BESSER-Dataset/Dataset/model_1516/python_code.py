...
class mydsl_FSM:
    ...
    def __init__(self, name: str, mydsl_FSM6: "mydsl_Initial" = None, mydsl_FSM: set["mydsl_State"] = None, mydsl_FSM2: set["mydsl_Transition"] = None, mydsl_FSM4: "mydsl_Final" = None):
        self.name = name
