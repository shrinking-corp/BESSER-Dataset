...
class Ordonance:
    ...
    def __init__(self, id: int, date: str, produit15: "Produit" = None, rendez_vous_Medecin_Patient10: "Rendez_vous_Medecin_Patient_external" = None):
        self.id = id
        self.date = date
...
class Rendez_vous:
    ...
    def __init__(self, id: int, numero: str, date: str):
        self.id = id
        self.numero = numero
        self.date = date
