...
class fsm_Transition:
    ...
    def __init__(self, name: str, fsm_Transition8: "fsm_FSM" = None, fsm_Transition: "fsm_State" = None, fsm_Transition2: "fsm_State" = None):
        self.name = name
...
class fsm_FSM:
    ...
    def __init__(self, name: str, fsm_FSM7: set["fsm_Transition"] = None, fsm_FSM: set["fsm_State"] = None):
        self.name = name
