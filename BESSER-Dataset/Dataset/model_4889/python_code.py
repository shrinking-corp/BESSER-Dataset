...
class ArtifactRepository:
    ...
    pass
class p2_SimpleArtifactRepository(IFileArtifactRepository, ArtifactRepository):
...
class p2_IRepositoryReference(ABC):
    ...
    def __init__(self, options: int, nickname: str, location: str, type: int, p2_IRepositoryReference: "p2_MetadataRepository" = None):
...
class p2_IRepository(ABC):
    ...
    def setProperty(self, p2_key, p2_value, p2_monitor) :
...
class p2_IQueryable(ABC):
    ...
    def __init__(self):
        ...
        pass
    def query(self, p2_query, p2_progress):
...
class p2_IArtifactRepository(ABC):
    ...
    def getArtifacts(self, p2_requests, p2_monitor) :
    ...
    def getRawArtifact(self, p2_destination, p2_descriptor, p2_monitor) :
        # TODO: Implement getRawArtifact method
        pass

    def removeDescriptor(self, p2_key, p2_monitor):
    ...
    def addDescriptors(self, p2_monitor, p2_descriptors):
    ...
    def addDescriptor(self, p2_descriptor, p2_monitor):
    ...
    def removeDescriptors(self, p2_monitor, p2_keys):
    ...
    def getArtifact(self, p2_destination, p2_descriptor, p2_monitor) :
        # TODO: Implement getArtifact method
        pass

    def createArtifactKey(self, p2_classifier, p2_id, p2_version) :
