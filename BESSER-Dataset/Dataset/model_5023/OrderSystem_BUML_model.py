...
# Classes
ordersystem_InventoryItem = Class(name="ordersystem_InventoryItem")
ordersystem_Address = Class(name="ordersystem_Address")
ordersystem_Order = Class(name="ordersystem_Order")
ordersystem_Customer = Class(name="ordersystem_Customer")
ordersystem_LineItem = Class(name="ordersystem_LineItem")
ordersystem_Product = Class(name="ordersystem_Product")
ordersystem_OrderSystem = Class(name="ordersystem_OrderSystem")
ordersystem_Warehouse = Class(name="ordersystem_Warehouse")
ordersystem_Account = Class(name="ordersystem_Account")
ordersystem_special_PreferredCustomer = Class(name="ordersystem_special_PreferredCustomer")
Customer = Class(name="Customer")
ordersystem_special_LimitedEditionProduct = Class(name="ordersystem_special_LimitedEditionProduct")
...
ordersystem_InventoryItem.attributes={ordersystem_InventoryItem_nextStockDate, ordersystem_InventoryItem_restockThreshold, ordersystem_InventoryItem_inStock}
...
ordersystem_Address.attributes={ordersystem_Address_apartment, ordersystem_Address_city, ordersystem_Address_province, ordersystem_Address_postalCode, ordersystem_Address_country, ordersystem_Address_street, ordersystem_Address_number}
...
ordersystem_Order.attributes={ordersystem_Order_filledOn, ordersystem_Order_completed, ordersystem_Order_id, ordersystem_Order_placedOn}
...
ordersystem_Product.attributes={ordersystem_Product_price, ordersystem_Product_name, ordersystem_Product_sku}
...
ordersystem_Account.attributes={ordersystem_Account_paymentMethod, ordersystem_Account_accountNumber}
...
domain_model = DomainModel(
    name="ordersystem",
    types={ordersystem_InventoryItem, ordersystem_Address, ordersystem_Order, ordersystem_Customer, ordersystem_LineItem, ordersystem_Product, ordersystem_OrderSystem, ordersystem_Warehouse, ordersystem_Account, ordersystem_special_PreferredCustomer, Customer, ordersystem_special_LimitedEditionProduct, Product},
    associations={owner3, item5, location6, customer7, owner0, item1, owner2, order26, product10, warehouse12, owner15, product16, Warehouse17, product20, owner22, account24, owner29, billingAddress31, shippingAddress33},
