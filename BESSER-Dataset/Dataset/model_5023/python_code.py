...
class ordersystem_Warehouse:
    ...
    def __init__(self, name: str, warehouse: "ordersystem_OrderSystem" = None, Warehouse: set["ordersystem_InventoryItem"] = None, ordersystem_Warehouse: "ordersystem_Address" = None, Warehouse14: "ordersystem_OrderSystem" = None, Warehouse19: "ordersystem_InventoryItem" = None):
        self.name = name
...
class ordersystem_OrderSystem:
    ...
    def __init__(self, version: int, OrderSystem23: "ordersystem_Customer" = None, OrderSystem4: "ordersystem_Warehouse" = None, owner8: set["ordersystem_Customer"] = None, OrderSystem: "ordersystem_Product" = None, owner11: set["ordersystem_Product"] = None, owner13: set["ordersystem_Warehouse"] = None):
...
class ordersystem_Product:
    ...
    def __init__(self, name: str, sku: str, price: float, ordersystem_Product21: "ordersystem_InventoryItem" = None, product: "ordersystem_OrderSystem" = None, Product: "ordersystem_OrderSystem" = None, ordersystem_Product: "ordersystem_LineItem" = None):
        self.name = name
        self.sku = sku
        self.price = price
...
class ordersystem_Customer:
    ...
    def __init__(self, lastName: str, firstName: str, customer: "ordersystem_OrderSystem" = None, owner25: set["ordersystem_Account"] = None, Customer30: "ordersystem_Account" = None, Customer9: "ordersystem_OrderSystem" = None, Customer: "ordersystem_Order" = None, owner27: set["ordersystem_Order"] = None):
...
class ordersystem_Order:
    ...
    def __init__(self, placedOn: str, filledOn: str, completed: bool, id: str, order: "ordersystem_Customer" = None, owner: set["ordersystem_LineItem"] = None, Order28: "ordersystem_Customer" = None, Order: "ordersystem_LineItem" = None):
...
class ordersystem_Address:
    ...
    def __init__(self, number: str, street: str, apartment: str, city: str, province: str, postalCode: str, country: str, ordersystem_Address32: "ordersystem_Account" = None, ordersystem_Address35: "ordersystem_Account" = None, ordersystem_Address: "ordersystem_Warehouse" = None):
        self.number = number
        self.street = street
