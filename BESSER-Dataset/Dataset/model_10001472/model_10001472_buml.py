...
Guest.attributes={Guest_Address, Guest_Name}
...
Reservation.attributes={Reservation_Reservation_id, Reservation_Start, Reservation_End}
...
domain_model = DomainModel(
    name="_8yFVQEjWEemcCbHu8oEdZw",
    types={Make__Reservation_external, Hotel_System_Component, Check_in_Guest_UseCase, Check_out_Guest_UseCase, View_Month_s_Statistics_UseCase, Register_as_new_customer_UseCase, Look_up_Reservation_UseCase, Guest_Actor, Receptionist_Actor, Hotel_Manager_Actor, Guest, Reservation, Room, inte},
