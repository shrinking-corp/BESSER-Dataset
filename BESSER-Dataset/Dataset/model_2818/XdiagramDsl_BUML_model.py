...
# Classes
model_XDiagram = Class(name="model_XDiagram")
model_MetaModel = Class(name="model_MetaModel")
model_Diagram = Class(name="model_Diagram")
model_Feature = Class(name="model_Feature")
model_FeatureConditional = Class(name="model_FeatureConditional")
model_FeatureContainer = Class(name="model_FeatureContainer")
model_EAttribute = Class(name="model_EAttribute")
model_Value = Class(name="model_Value")
model_Node = Class(name="model_Node")
DiagramElement = Class(name="DiagramElement")
model_ConnectableElement = Class(name="model_ConnectableElement")
model_Link = Class(name="model_Link")
FeatureContainer = Class(name="FeatureContainer")
model_EReference = Class(name="model_EReference")
model_Decorator = Class(name="model_Decorator")
model_Colors = Class(name="model_Colors")
model_DiagramElement = Class(name="model_DiagramElement")
model_CustomFigure = Class(name="model_CustomFigure")
model_ImportStatement = Class(name="model_ImportStatement")
model_EClass = Class(name="model_EClass")
model_Contains = Class(name="model_Contains")
model_Color = Class(name="model_Color")
model_Custom = Class(name="model_Custom")
ConnectableElement = Class(name="ConnectableElement")
model_Rectangle = Class(name="model_Rectangle")
model_Anchor = Class(name="model_Anchor")
Feature = Class(name="Feature")
model_CustomColor = Class(name="model_CustomColor")
model_Arrow = Class(name="model_Arrow")
model_IntValue = Class(name="model_IntValue")
Value = Class(name="Value")
model_DoubleValue = Class(name="model_DoubleValue")
model_StringValue = Class(name="model_StringValue")
model_BooleanValue = Class(name="model_BooleanValue")
model_EnumValue = Class(name="model_EnumValue")
model_Label = Class(name="model_Label")
model_Image = Class(name="model_Image")
model_Invisible = Class(name="model_Invisible")
model_ColorFeature = Class(name="model_ColorFeature")
model_Rhombus = Class(name="model_Rhombus")
model_Ellipse = Class(name="model_Ellipse")
model_Polyline = Class(name="model_Polyline")
model_Triangle = Class(name="model_Triangle")
model_Line = Class(name="model_Line")
model_Corner = Class(name="model_Corner")
model_Layout = Class(name="model_Layout")
model_Visible = Class(name="model_Visible")
model_TextValue = Class(name="model_TextValue")
model_TextPart = Class(name="model_TextPart")
model_FontProperties = Class(name="model_FontProperties")
model_TextAlign = Class(name="model_TextAlign")
model_LineStyle = Class(name="model_LineStyle")
model_Transparency = Class(name="model_Transparency")
model_Size = Class(name="model_Size")
model_Point = Class(name="model_Point")
model_Position = Class(name="model_Position")
model_LineWidth = Class(name="model_LineWidth")
...
model_MetaModel.attributes={model_MetaModel_plugin, model_MetaModel_ecorePath}
...
model_Rectangle.attributes={model_Rectangle_rectangle, model_Rectangle_square}
...
model_Anchor.attributes={model_Anchor_max, model_Anchor_direction}
...
model_CustomColor.attributes={model_CustomColor_name, model_CustomColor_G, model_CustomColor_R, model_CustomColor_B}
...
model_StringValue.attributes={model_StringValue_null, model_StringValue_value}
...
model_Polyline.attributes={model_Polyline_polygon, model_Polyline_polyline}
...
model_FontProperties.attributes={model_FontProperties_bold, model_FontProperties_italics, model_FontProperties_face, model_FontProperties_size}
...
model_Size.attributes={model_Size_heightRelative, model_Size_width, model_Size_height, model_Size_resizable, model_Size_widthRelative}
...
model_Point.attributes={model_Point_x, model_Point_y}
...
model_Position.attributes={model_Position_xRelative, model_Position_y, model_Position_yRelative, model_Position_x}
...
domain_model = DomainModel(
    name="model",
    types={model_XDiagram, model_MetaModel, model_Diagram, model_Feature, model_FeatureConditional, model_FeatureContainer, model_EAttribute, model_Value, model_Node, DiagramElement, model_ConnectableElement, model_Link, FeatureContainer, model_EReference, model_Decorator, model_Colors, model_DiagramElement, model_CustomFigure, model_ImportStatement, model_EClass, model_Contains, model_Color, model_Custom, ConnectableElement, model_Rectangle, model_Anchor, Feature, model_CustomColor, model_Arrow, model_IntValue, Value, model_DoubleValue, model_StringValue, model_BooleanValue, model_EnumValue, model_Label, model_Image, model_Invisible, model_ColorFeature, model_Rhombus, model_Ellipse, model_Polyline, model_Triangle, model_Line, model_Corner, model_Layout, model_Visible, model_TextValue, model_TextPart, model_FontProperties, model_TextAlign, model_LineStyle, model_Transparency, model_Size, model_Point, model_Position, model_LineWidth, DefaultColor, AnchorDirection, Operator, BooleanLiteral, TextAlignValue, LineType},
    associations={metamodel0, diagram1, modelClass13, conditional16, features17, modelAttribute19, value21, rootFigure23, modelReference24, sourceReference25, targetReference28, decorators31, customColors3, elements5, figures7, modelClass9, contains11, custom40, children42, element45, figure48, element33, modelReference36, colors38, modelReference50, parts55, modelAttribute56, color53},
    generalizations={gen_model_Node_DiagramElement, gen_model_Link_DiagramElement, gen_model_Link_FeatureContainer, gen_model_ConnectableElement_FeatureContainer, gen_model_Custom_ConnectableElement, gen_model_Rectangle_ConnectableElement, gen_model_Anchor_Feature, gen_model_Arrow_FeatureContainer, gen_model_Contains_Feature, gen_model_IntValue_Value, gen_model_DoubleValue_Value, gen_model_StringValue_Value, gen_model_BooleanValue_Value, gen_model_EnumValue_Value, gen_model_Label_ConnectableElement, gen_model_Image_ConnectableElement, gen_model_Invisible_ConnectableElement, gen_model_ColorFeature_Feature, gen_model_Rhombus_ConnectableElement, gen_model_Ellipse_ConnectableElement, gen_model_Polyline_ConnectableElement, gen_model_Triangle_ConnectableElement, gen_model_Line_FeatureContainer, gen_model_Corner_Feature, gen_model_Layout_Feature, gen_model_Visible_Feature, gen_model_TextValue_Feature, gen_model_FontProperties_Feature, gen_model_TextAlign_Feature, gen_model_LineStyle_Feature, gen_model_Transparency_Feature, gen_model_Size_Feature, gen_model_Point_Feature, gen_model_Position_Feature, gen_model_LineWidth_Feature},
    metadata=None
)
