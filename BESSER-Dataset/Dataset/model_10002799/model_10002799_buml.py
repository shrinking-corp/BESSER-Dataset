...
Customer.attributes={Customer_phoneNumber, Customer_emailAddress, Customer_name, Customer_address, Customer_dateOfBirth}
...
transaction_Transaction.attributes={transaction_Transaction_id, transaction_Transaction_type, transaction_Transaction_transactionTime, transaction_Transaction_amount}
...
domain_model = DomainModel(
    name="dc870311_f597_4d3c_86d3_fe6044512698",
    types={account_Account, Customer, Login, transaction_Transaction, transaction_DepositTransaction, transaction_WithdrawTransaction, transaction_TransferTransaction, account_SavingsAccount, account_CertificatesOfDepositAccount, account_CheckingAccount, transaction_TransactionType, account_AccountType},
