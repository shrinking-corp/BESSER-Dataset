...
public class Customer  {
    ...
    public Customer(
        LocalDate dateOfBirth,        String phoneNumber,        String name,        String emailAddress,        String address    ) {
    ...
    public Customer(
        LocalDate dateOfBirth,        String phoneNumber,        String name,        String emailAddress,        String address        ArrayList<account_Account> account_accounts    ) {
        this.dateOfBirth = dateOfBirth;
        this.phoneNumber = phoneNumber;
        this.name = name;
        this.emailAddress = emailAddress;
