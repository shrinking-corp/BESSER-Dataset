...
library_Periodical = Class(name="library_Periodical", is_abstract=True)
library_AudioVisualItem = Class(name="library_AudioVisualItem", is_abstract=True)
Person = Class(name="Person")
library_BookOnTape = Class(name="library_BookOnTape")
AudioVisualItem = Class(name="AudioVisualItem")
library_Person = Class(name="library_Person")
library_VideoCassette = Class(name="library_VideoCassette")
...
library_AudioVisualItem.attributes={library_AudioVisualItem_minutesLength, library_AudioVisualItem_damaged, library_AudioVisualItem_title}
...
domain_model = DomainModel(
    name="library",
    types={library_Employee, library_Borrower, library_Item, library_Book, CirculatingItem, library_Writer, library_Library, Addressable, library_Lendable, library_CirculatingItem, Item, Lendable, library_Periodical, library_AudioVisualItem, Person, library_BookOnTape, AudioVisualItem, library_Person, library_VideoCassette, library_Addressable, BookCategory},
    associations={writers1, employees2, borrowers4, stock6, books8, branches11, author0, borrowers16, parentBranch13, books15, reader17, author18, cast21, borrowed23, manager25},
    generalizations={gen_library_Book_CirculatingItem, gen_library_Library_Addressable, gen_library_CirculatingItem_Item, gen_library_CirculatingItem_Lendable, gen_library_Periodical_Item, gen_library_AudioVisualItem_CirculatingItem, gen_library_Writer_Person, gen_library_BookOnTape_AudioVisualItem, gen_library_VideoCassette_AudioVisualItem, gen_library_Borrower_Person, gen_library_Person_Addressable, gen_library_Employee_Person},
    metadata=None
)
