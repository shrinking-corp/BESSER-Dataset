...
class library_Writer(Person):
    ...
    def __init__(self, name: str, library_Writer: "library_Library" = None, Writer: "library_Book" = None, author: set["library_Book"] = None, library_Writer20: "library_BookOnTape" = None):
        self.name = name
...
class library_Book(CirculatingItem):
    ...
    def __init__(self, title: str, pages: int, category: str, library_Book: "library_Library" = None, books: "library_Writer" = None, Book: "library_Writer" = None):
        self.title = title
        self.pages = pages
