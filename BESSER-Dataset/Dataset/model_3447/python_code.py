...
class classmate_Classroom:
    ...
    def __init__(self, name: str, classmate_Classroom: set["classmate_Student"] = None, classmate_Classroom6: "classmate_School" = None):
        self.name = name
...
class classmate_School:
    ...
    def __init__(self, name: str, classmate_School: "classmate_ClassmateSystem" = None, classmate_School5: set["classmate_Classroom"] = None):
        self.name = name
