...
# Classes
classmate_Student = Class(name="classmate_Student")
classmate_ClassmateSystem = Class(name="classmate_ClassmateSystem")
classmate_School = Class(name="classmate_School")
classmate_Friend = Class(name="classmate_Friend")
classmate_Classroom = Class(name="classmate_Classroom")
...
domain_model = DomainModel(
    name="classmate",
    types={classmate_Student, classmate_ClassmateSystem, classmate_School, classmate_Friend, classmate_Classroom},
    associations={students0, school1, friends2, classrooms4, fromStudent7, toStudent10},
    generalizations={},
    metadata=None
)
