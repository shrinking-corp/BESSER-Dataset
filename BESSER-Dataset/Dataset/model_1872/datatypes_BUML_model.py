...
# Classes
datatypes_SimpleType = Class(name="datatypes_SimpleType")
DataType = Class(name="DataType")
datatypes_ComplexType = Class(name="datatypes_ComplexType", is_abstract=True)
datatypes_RosIDLReference = Class(name="datatypes_RosIDLReference")
IDLReference = Class(name="IDLReference")
datatypes_TypesLibrary = Class(name="datatypes_TypesLibrary")
datatypes_DataType = Class(name="datatypes_DataType", is_abstract=True)
datatypes_VectorType = Class(name="datatypes_VectorType")
ComplexType = Class(name="ComplexType")
datatypes_CustomType = Class(name="datatypes_CustomType")
datatypes_Field = Class(name="datatypes_Field")
datatypes_IDLReference = Class(name="datatypes_IDLReference", is_abstract=True)
...
datatypes_RosIDLReference.attributes={datatypes_RosIDLReference_namespace, datatypes_RosIDLReference_rosPackage}
...
datatypes_Field.attributes={datatypes_Field_measureUnit, datatypes_Field_name, datatypes_Field_description}
...
domain_model = DomainModel(
    name="datatypes",
    types={datatypes_SimpleType, DataType, datatypes_ComplexType, datatypes_RosIDLReference, IDLReference, datatypes_TypesLibrary, datatypes_DataType, datatypes_VectorType, ComplexType, datatypes_CustomType, datatypes_Field, datatypes_IDLReference},
    associations={includes2, typesLibrary3, types0, template4, fields5, type6},
