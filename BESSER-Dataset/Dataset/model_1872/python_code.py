...
class datatypes_TypesLibrary:
    ...
    def __init__(self, name: str, datatypes_TypesLibrary: "datatypes_TypesLibrary" = None, datatypes_TypesLibrary1: set["datatypes_TypesLibrary"] = None, TypesLibrary: "datatypes_DataType" = None, typesLibrary: set["datatypes_DataType"] = None):
        self.name = name
