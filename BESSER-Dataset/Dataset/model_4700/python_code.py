...
class genealogy_Person:
    ...
    def __init__(self, name: str, age: int, alive: bool, genealogy_Person: "genealogy_Genealogy" = None, Person: "genealogy_Person" = None, children: set["genealogy_Person"] = None, Person5: "genealogy_Person" = None, parents: set["genealogy_Person"] = None):
        self.name = name
        self.age = age
        self.alive = alive
