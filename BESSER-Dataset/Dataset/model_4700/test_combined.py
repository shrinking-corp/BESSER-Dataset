...
def test_hyp_genealogy_person_is_not_abstract():
    assert not inspect.isabstract(genealogy_Person)


def test_hyp_genealogy_person_constructor_exists():
    assert callable(genealogy_Person.__init__)


def test_hyp_genealogy_person_constructor_args():
...
def test_hyp_genealogy_genealogy_is_not_abstract():
    assert not inspect.isabstract(genealogy_Genealogy)


def test_hyp_genealogy_genealogy_constructor_exists():
    assert callable(genealogy_Genealogy.__init__)


def test_hyp_genealogy_genealogy_constructor_args():
...
def test_hyp_genealogy_person_alive_setter(instance):
...
@given(instance=genealogy_Person_strategy)
def test_hyp_genealogy_person_name_setter(instance):
...
@given(instance=genealogy_Person_strategy)
def test_hyp_genealogy_person_age_setter(instance):
