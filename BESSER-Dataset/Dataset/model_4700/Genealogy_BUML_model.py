...
# Classes
genealogy_Genealogy = Class(name="genealogy_Genealogy")
genealogy_Person = Class(name="genealogy_Person")
...
genealogy_Person.attributes={genealogy_Person_age, genealogy_Person_alive, genealogy_Person_name}
...
domain_model = DomainModel(
    ...
    associations={persons0, parents2, children4},
    generalizations={},
    metadata=None
)
