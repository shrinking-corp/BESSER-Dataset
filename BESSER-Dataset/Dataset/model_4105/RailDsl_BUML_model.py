...
# Classes
railDsl_Station = Class(name="railDsl_Station")
NamedElement = Class(name="NamedElement")
railDsl_Declaration = Class(name="railDsl_Declaration", is_abstract=True)
railDsl_SegmentPosition = Class(name="railDsl_SegmentPosition")
railDsl_Derailer = Class(name="railDsl_Derailer")
SegmentObject = Class(name="SegmentObject")
railDsl_LevelCrossing = Class(name="railDsl_LevelCrossing")
railDsl_Signal = Class(name="railDsl_Signal")
railDsl_Platform = Class(name="railDsl_Platform")
railDsl_TrackObject = Class(name="railDsl_TrackObject", is_abstract=True)
Declaration = Class(name="Declaration")
RouteObject = Class(name="RouteObject")
railDsl_Vertex = Class(name="railDsl_Vertex")
railDsl_Segment = Class(name="railDsl_Segment")
TrackObject = Class(name="TrackObject")
railDsl_SegmentObject = Class(name="railDsl_SegmentObject", is_abstract=True)
railDsl_NamedElement = Class(name="railDsl_NamedElement", is_abstract=True)
railDsl_Train = Class(name="railDsl_Train")
railDsl_TrainSegment = Class(name="railDsl_TrainSegment")
railDsl_Point = Class(name="railDsl_Point")
railDsl_Track = Class(name="railDsl_Track")
railDsl_TrainRoutePoint = Class(name="railDsl_TrainRoutePoint")
TrainRouteObject = Class(name="TrainRouteObject")
railDsl_TrainRouteSegment = Class(name="railDsl_TrainRouteSegment")
railDsl_RouteObject = Class(name="railDsl_RouteObject", is_abstract=True)
railDsl_TrainRoute = Class(name="railDsl_TrainRoute")
railDsl_TrainRouteObject = Class(name="railDsl_TrainRouteObject")
...
railDsl_SegmentPosition.attributes={railDsl_SegmentPosition_side, railDsl_SegmentPosition_position, railDsl_SegmentPosition_atStart, railDsl_SegmentPosition_atEnd, railDsl_SegmentPosition_orientation}
...
railDsl_Signal.attributes={railDsl_Signal_main, railDsl_Signal_shunting}
...
railDsl_Point.attributes={railDsl_Point_locked, railDsl_Point_kind, railDsl_Point_selectedInput, railDsl_Point_selectedOutput}
...
railDsl_TrainRoute.attributes={railDsl_TrainRoute_kind, railDsl_TrainRoute_locked}
...
domain_model = DomainModel(
    name="railDsl",
    types={railDsl_Station, NamedElement, railDsl_Declaration, railDsl_SegmentPosition, railDsl_Derailer, SegmentObject, railDsl_LevelCrossing, railDsl_Signal, railDsl_Platform, railDsl_TrackObject, Declaration, RouteObject, railDsl_Vertex, railDsl_Segment, TrackObject, railDsl_SegmentObject, railDsl_NamedElement, railDsl_Train, railDsl_TrainSegment, railDsl_Point, railDsl_Track, railDsl_TrainRoutePoint, TrainRouteObject, railDsl_TrainRouteSegment, railDsl_RouteObject, railDsl_TrainRoute, railDsl_TrainRouteObject, PointKind, VertexKind, Orientation, Side, SpeedLimit, TrainRouteKind},
    associations={position7, distantFor10, declarations0, start1, end2, objects5, segments20, position21, segment11, inputs14, outputs16, elements19, originalPoint40, originalSegment42, position24, path27, startSignal28, endSignal31, protectionObjects34, conflictingRoutes38},
    generalizations={gen_railDsl_Station_NamedElement, gen_railDsl_SegmentObject_RouteObject, gen_railDsl_Derailer_SegmentObject, gen_railDsl_LevelCrossing_SegmentObject, gen_railDsl_Signal_SegmentObject, gen_railDsl_Platform_SegmentObject, gen_railDsl_Declaration_NamedElement, gen_railDsl_TrackObject_Declaration, gen_railDsl_TrackObject_RouteObject, gen_railDsl_Vertex_Declaration, gen_railDsl_Segment_TrackObject, gen_railDsl_SegmentObject_NamedElement, gen_railDsl_Train_Declaration, gen_railDsl_Point_TrackObject, gen_railDsl_Track_Declaration, gen_railDsl_TrainRoutePoint_TrainRouteObject, gen_railDsl_TrainRouteSegment_TrainRouteObject, gen_railDsl_TrainRoute_Declaration},
    metadata=None
)
