...
class railDsl_Vertex(Declaration):
    ...
    def __init__(self, kind: str, railDsl_Vertex: "railDsl_Segment" = None, railDsl_Vertex4: "railDsl_Segment" = None, railDsl_Vertex15: "railDsl_Point" = None, railDsl_Vertex18: "railDsl_Point" = None):
        self.kind = kind
...
class railDsl_TrainRoute(Declaration):
    ...
    def __init__(self, locked: bool, kind: str, railDsl_TrainRoute39: "railDsl_TrainRoute" = None, railDsl_TrainRoute37: set["railDsl_TrainRoute"] = None, railDsl_TrainRoute: set["railDsl_TrainRouteObject"] = None, railDsl_TrainRoute29: "railDsl_Signal" = None, railDsl_TrainRoute32: "railDsl_Signal" = None, railDsl_TrainRoute35: set["railDsl_TrainRouteObject"] = None):
        self.locked = locked
        self.kind = kind
...
class railDsl_SegmentPosition:
    ...
    def __init__(self, atStart: bool, atEnd: bool, position: float, side: str, orientation: str, railDsl_SegmentPosition: "railDsl_SegmentObject" = None, railDsl_SegmentPosition23: "railDsl_Train" = None, railDsl_SegmentPosition12: "railDsl_Segment" = None, railDsl_SegmentPosition26: "railDsl_TrainSegment" = None):
...
class NamedElement:
    ...
    pass
class railDsl_SegmentObject(RouteObject, NamedElement):
