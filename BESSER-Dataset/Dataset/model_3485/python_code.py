...
class featureModelMetamodel_Attribute:
    ...
    pass
class featureModelMetamodel_GroupMultiplicity(Multiplicity_):

    pass
class featureModelMetamodel_Feature:

    def __init__(self, variabilityType: str, id: str, name: str, featureModelMetamodel_Feature11: "featureModelMetamodel_FeatureModel" = None, featureModelMetamodel_Feature: "featureModelMetamodel_Feature" = None, featureModelMetamodel_Feature0: set["featureModelMetamodel_Feature"] = None, featureModelMetamodel_Feature3: "featureModelMetamodel_GroupMultiplicity" = None, featureModelMetamodel_Feature5: set["featureModelMetamodel_Attribute"] = None, featureModelMetamodel_Feature8: "featureModelMetamodel_Feature" = None, featureModelMetamodel_Feature6: "featureModelMetamodel_Feature" = None, featureModelMetamodel_Feature16: "featureModelMetamodel_FeatureModel" = None, featureModelMetamodel_Feature19: "featureModelMetamodel_GroupMultiplicity" = None, featureModelMetamodel_Feature21: "featureModelMetamodel_Selection" = None):
...
class featureModelMetamodel_AbstractFeature(Feature):
    ...
    pass
class featureModelMetamodel_Multiplicity_:
    ...
    def featureModelMetamodel_Multiplicity(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_featureModelMetamodel_Multiplicity___featureModelMetamodel_Multiplicity", None)
