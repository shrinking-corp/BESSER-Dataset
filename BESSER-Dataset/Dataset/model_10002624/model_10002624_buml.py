...
Employee.attributes={Employee_Emp_Department, Employee_Password, Employee_Emp_Name, Employee_Emp_Address, Employee_Emp_ContactNo, Employee_Emp_Email, Employee_Emp_Salary, Employee_Emp_Id}
...
Salary.attributes={Salary_Sly_Increment, Salary_Emp_Id, Salary_OverTime, Salary_Sly_Basic, Salary_Sly_Decrement, Salary_Sly_Netgross}
...
Leave.attributes={Leave_Leave_detail, Leave_leave_id, Leave_Leave_Status, Leave_Leave_EndDate, Leave_Emp_Id, Leave_Leave_Title}
...
Users1.attributes={Users1_id, Users1_password}
...
Admin1.attributes={Admin1_UserName, Admin1_password}
...
Employee1.attributes={Employee1_Emp_Dep, Employee1_Emp_Address, Employee1_UserName, Employee1_Salary, Employee1_name, Employee1_contact_no, Employee1_password, Employee1_attribute, Employee1_Email}
...
Customer_postal_code: Property = Property(name="postal_code", type=IntegerType)
Customer_country: Property = Property(name="country", type=StringType)
Customer.attributes={Customer_postal_code, Customer_country, Customer_UserName, Customer_address, Customer_password}
...
Order.attributes={Order_name, Order_id}
...
Manager1.attributes={Manager1_Name, Manager1_Manager_id, Manager1_Password}
...
Manager2.attributes={Manager2_name, Manager2_id, Manager2_password}
...
domain_model = DomainModel(
    name="c7cf499b_7bab_4a6e_a41a_a792866ce8b0",
