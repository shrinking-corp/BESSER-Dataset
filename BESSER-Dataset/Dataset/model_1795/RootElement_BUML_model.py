...
RootElement_SupportTicketWriter = Class(name="RootElement_SupportTicketWriter", is_abstract=True)
RootElement_MakeBooking = Class(name="RootElement_MakeBooking", is_abstract=True)
RootElement_FeedbackWriter = Class(name="RootElement_FeedbackWriter", is_abstract=True)
RootElement_Guest = Class(name="RootElement_Guest")
RootElement_Booking = Class(name="RootElement_Booking")
RootElement_RoomBooking = Class(name="RootElement_RoomBooking", is_abstract=True)
RootElement_ServiceItem = Class(name="RootElement_ServiceItem")
RootElement_Room = Class(name="RootElement_Room")
RootElement_RoomType = Class(name="RootElement_RoomType")
RootElement_RoomAttribute = Class(name="RootElement_RoomAttribute")
RootElement_Feedback = Class(name="RootElement_Feedback")
RootElement_Staff = Class(name="RootElement_Staff")
Cleaning = Class(name="Cleaning")
SupportTicketReader = Class(name="SupportTicketReader")
RootElement_Cleaning = Class(name="RootElement_Cleaning", is_abstract=True)
RootElement_SupportTicketReader = Class(name="RootElement_SupportTicketReader", is_abstract=True)
RootElement_SupportTicket = Class(name="RootElement_SupportTicket")
RootElement_Clerk = Class(name="RootElement_Clerk")
...
RootElement_ReceptionHandling = Class(name="RootElement_ReceptionHandling", is_abstract=True)
RootElement_ServiceItemHandling = Class(name="RootElement_ServiceItemHandling", is_abstract=True)
RootElement_Payment = Class(name="RootElement_Payment", is_abstract=True)
RootElement_Manager = Class(name="RootElement_Manager")
Clerk = Class(name="Clerk")
SysAdmin = Class(name="SysAdmin")
FeedbackReader = Class(name="FeedbackReader")
RootElement_FeedbackReader = Class(name="RootElement_FeedbackReader", is_abstract=True)
RootElement_SysAdmin = Class(name="RootElement_SysAdmin")
...
RootElement_RoomAttributeHandling = Class(name="RootElement_RoomAttributeHandling", is_abstract=True)
RootElement_RoomHandling = Class(name="RootElement_RoomHandling", is_abstract=True)
RootElement_RoomTypeHandling = Class(name="RootElement_RoomTypeHandling", is_abstract=True)
RootElement_BookingHandler = Class(name="RootElement_BookingHandler")
RootElement_RoomStructure = Class(name="RootElement_RoomStructure")
RoomFetcher = Class(name="RoomFetcher")
RootElement_FeedbackHandler = Class(name="RootElement_FeedbackHandler")
RootElement_SupportTicketHandler = Class(name="RootElement_SupportTicketHandler")
RootElement_CleaningHandler = Class(name="RootElement_CleaningHandler")
RootElement_PaymentHandler = Class(name="RootElement_PaymentHandler")
RootElement_DailyRoomBooking = Class(name="RootElement_DailyRoomBooking")
RoomBooking = Class(name="RoomBooking")
RootElement_HourlyRoomBooking = Class(name="RootElement_HourlyRoomBooking")
RootElement_HotelSystem = Class(name="RootElement_HotelSystem", is_abstract=True)
RootElement_RoomFetcher = Class(name="RootElement_RoomFetcher", is_abstract=True)
RootElement_Hotel = Class(name="RootElement_Hotel")
...
RootElement_SupportTicketWriter_m_newSupportTicket: Method = Method(name="newSupportTicket", parameters={Parameter(name='RootElement_description', type=StringType), Parameter(name='RootElement_roomName', type=StringType)})
...
RootElement_MakeBooking_m_getAvailableRooms: Method = Method(name="getAvailableRooms", parameters={Parameter(name='RootElement_endDate', type=StringType), Parameter(name='RootElement_nbrOfChildren', type=StringType), Parameter(name='RootElement_nbrOfAdults', type=StringType), Parameter(name='RootElement_startDate', type=StringType)}, type=StringType)
RootElement_MakeBooking_m_addRoom: Method = Method(name="addRoom", parameters={Parameter(name='RootElement_startDate', type=StringType), Parameter(name='RootElement_endDate', type=StringType), Parameter(name='RootElement_nbrOfAdults', type=StringType), Parameter(name='RootElement_nbrOfChildren', type=StringType), Parameter(name='RootElement_room', type=StringType), Parameter(name='RootElement_booking', type=StringType)}, type=StringType)
RootElement_MakeBooking_m_cancelBooking: Method = Method(name="cancelBooking", parameters={Parameter(name='RootElement_booking', type=StringType)}, type=StringType)
RootElement_MakeBooking_m_lookupBooking: Method = Method(name="lookupBooking", parameters={Parameter(name='RootElement_name', type=StringType), Parameter(name='RootElement_phoneNumber', type=StringType)}, type=StringType)
RootElement_MakeBooking_m_confirmBooking: Method = Method(name="confirmBooking", parameters={Parameter(name='RootElement_phone', type=StringType), Parameter(name='RootElement_passportNr', type=StringType), Parameter(name='RootElement_booking', type=StringType), Parameter(name='RootElement_nationality', type=StringType), Parameter(name='RootElement_nextDestination', type=StringType), Parameter(name='RootElement_mail', type=StringType), Parameter(name='RootElement_name', type=StringType)}, type=StringType)
RootElement_MakeBooking.methods={RootElement_MakeBooking_m_cancelBooking, RootElement_MakeBooking_m_confirmBooking, RootElement_MakeBooking_m_getAvailableRooms, RootElement_MakeBooking_m_lookupBooking, RootElement_MakeBooking_m_createBooking, RootElement_MakeBooking_m_addRoom}

# RootElement_FeedbackWriter class attributes and methods
RootElement_FeedbackWriter_m_giveFeedback: Method = Method(name="giveFeedback", parameters={Parameter(name='RootElement_rating', type=StringType), Parameter(name='RootElement_feedback', type=StringType)})
...
RootElement_Guest.attributes={RootElement_Guest_mail, RootElement_Guest_nationality, RootElement_Guest_phoneNumber, RootElement_Guest_name, RootElement_Guest_socialSecurityNumber, RootElement_Guest_nextDestination}
...
RootElement_ServiceItem.attributes={RootElement_ServiceItem_price, RootElement_ServiceItem_name, RootElement_ServiceItem_description}
...
RootElement_RoomType_m_removeRoomAttribute: Method = Method(name="removeRoomAttribute", parameters={Parameter(name='RootElement_roomAttribute', type=StringType)}, type=BooleanType)
RootElement_RoomType_m_addRoomAttribute: Method = Method(name="addRoomAttribute", parameters={Parameter(name='RootElement_roomAttribute', type=StringType)}, type=BooleanType)
RootElement_RoomType.attributes={RootElement_RoomType_name, RootElement_RoomType_capacity, RootElement_RoomType_price}
...
RootElement_Feedback.attributes={RootElement_Feedback_read, RootElement_Feedback_rating, RootElement_Feedback_feedbackDescription}
...
RootElement_Staff.attributes={RootElement_Staff_staffID, RootElement_Staff_name}
...
RootElement_Cleaning_m_markRoomAsCleaned: Method = Method(name="markRoomAsCleaned", parameters={Parameter(name='RootElement_room', type=StringType)})
RootElement_Cleaning_m_checkIfRoomCleaned: Method = Method(name="checkIfRoomCleaned", parameters={Parameter(name='RootElement_roomName', type=StringType)}, type=StringType)
RootElement_Cleaning.methods={RootElement_Cleaning_m_markRoomAsCleaned, RootElement_Cleaning_m_checkIfRoomCleaned, RootElement_Cleaning_m_getListOfUncleanRooms}
...
RootElement_SupportTicketReader_m_getSupportTicketsForRoom: Method = Method(name="getSupportTicketsForRoom", parameters={Parameter(name='RootElement_roomName', type=StringType)}, type=StringType)
RootElement_SupportTicketReader_m_markAsCompleted: Method = Method(name="markAsCompleted", parameters={Parameter(name='RootElement_supportTicket', type=StringType)})
RootElement_SupportTicketReader.methods={RootElement_SupportTicketReader_m_getUnfixedTickets, RootElement_SupportTicketReader_m_markAsCompleted, RootElement_SupportTicketReader_m_getSupportTicketsForRoom}
...
RootElement_SupportTicket.attributes={RootElement_SupportTicket_problemDescription, RootElement_SupportTicket_roomName, RootElement_SupportTicket_fixed}
...
RootElement_ReceptionHandling_m_checkIn: Method = Method(name="checkIn", parameters={Parameter(name='RootElement_booking', type=StringType)}, type=StringType)
RootElement_ReceptionHandling_m_checkOut: Method = Method(name="checkOut", parameters={Parameter(name='RootElement_booking', type=StringType)}, type=StringType)
RootElement_ReceptionHandling_m_findActiveBooking: Method = Method(name="findActiveBooking", parameters={Parameter(name='RootElement_roomName', type=StringType)}, type=StringType)
RootElement_ReceptionHandling_m_findBookings: Method = Method(name="findBookings", parameters={Parameter(name='RootElement_name', type=StringType)}, type=StringType)
...
RootElement_ServiceItemHandling_m_addServiceItem: Method = Method(name="addServiceItem", parameters={Parameter(name='RootElement_price', type=StringType), Parameter(name='RootElement_description', type=StringType), Parameter(name='RootElement_booking', type=StringType), Parameter(name='RootElement_name', type=StringType)})
RootElement_ServiceItemHandling_m_removeServiceItem: Method = Method(name="removeServiceItem", parameters={Parameter(name='RootElement_booking', type=StringType), Parameter(name='RootElement_serviceItem', type=StringType)})
RootElement_ServiceItemHandling_m_findAllServiceItems: Method = Method(name="findAllServiceItems", parameters={Parameter(name='RootElement_booking', type=StringType)}, type=StringType)
RootElement_ServiceItemHandling.methods={RootElement_ServiceItemHandling_m_findAllServiceItems, RootElement_ServiceItemHandling_m_removeServiceItem, RootElement_ServiceItemHandling_m_addServiceItem}

# RootElement_Payment class attributes and methods
RootElement_Payment_m_verifyCreditCard: Method = Method(name="verifyCreditCard", parameters={Parameter(name='RootElement_creditCard', type=StringType)}, type=StringType)
RootElement_Payment_m_debitCard: Method = Method(name="debitCard", parameters={Parameter(name='RootElement_creditCard', type=StringType), Parameter(name='RootElement_amount', type=StringType)}, type=StringType)
RootElement_Payment.methods={RootElement_Payment_m_verifyCreditCard, RootElement_Payment_m_debitCard}
...
RootElement_RoomAttributeHandling_m_addRoomAttribute: Method = Method(name="addRoomAttribute", parameters={Parameter(name='RootElement_name', type=StringType), Parameter(name='RootElement_description', type=StringType)}, type=StringType)
RootElement_RoomAttributeHandling_m_editRoomAttribute: Method = Method(name="editRoomAttribute", parameters={Parameter(name='RootElement_newName', type=StringType), Parameter(name='RootElement_newDescription', type=StringType), Parameter(name='RootElement_roomAttribute', type=StringType)}, type=StringType)
RootElement_RoomAttributeHandling_m_removeRoomAttribute: Method = Method(name="removeRoomAttribute", parameters={Parameter(name='RootElement_roomAttribute', type=StringType)}, type=StringType)
...
RootElement_RoomAttributeHandling_m_findRoomAttribute: Method = Method(name="findRoomAttribute", parameters={Parameter(name='RootElement_name', type=StringType)}, type=StringType)
RootElement_RoomAttributeHandling.methods={RootElement_RoomAttributeHandling_m_addRoomAttribute, RootElement_RoomAttributeHandling_m_findRoomAttribute, RootElement_RoomAttributeHandling_m_editRoomAttribute, RootElement_RoomAttributeHandling_m_getAllRoomAttributes, RootElement_RoomAttributeHandling_m_removeRoomAttribute}

# RootElement_RoomHandling class attributes and methods
RootElement_RoomHandling_m_addRoom: Method = Method(name="addRoom", parameters={Parameter(name='RootElement_roomType', type=StringType), Parameter(name='RootElement_roomName', type=StringType)}, type=StringType)
RootElement_RoomHandling_m_removeRoom: Method = Method(name="removeRoom", parameters={Parameter(name='RootElement_room', type=StringType)}, type=StringType)
RootElement_RoomHandling_m_editRoom: Method = Method(name="editRoom", parameters={Parameter(name='RootElement_newRoomName', type=StringType), Parameter(name='RootElement_newRoomType', type=StringType), Parameter(name='RootElement_room', type=StringType)}, type=StringType)
RootElement_RoomHandling_m_findRoom: Method = Method(name="findRoom", parameters={Parameter(name='RootElement_roomName', type=StringType)}, type=StringType)
RootElement_RoomHandling_m_getAllRooms: Method = Method(name="getAllRooms", parameters={}, type=StringType)
RootElement_RoomHandling.methods={RootElement_RoomHandling_m_editRoom, RootElement_RoomHandling_m_removeRoom, RootElement_RoomHandling_m_addRoom, RootElement_RoomHandling_m_getAllRooms, RootElement_RoomHandling_m_findRoom}

# RootElement_RoomTypeHandling class attributes and methods
RootElement_RoomTypeHandling_m_addRoomType: Method = Method(name="addRoomType", parameters={Parameter(name='RootElement_capacity', type=StringType), Parameter(name='RootElement_name', type=StringType), Parameter(name='RootElement_cost', type=StringType)}, type=StringType)
RootElement_RoomTypeHandling_m_editRoomType: Method = Method(name="editRoomType", parameters={Parameter(name='RootElement_newName', type=StringType), Parameter(name='RootElement_newCost', type=StringType), Parameter(name='RootElement_roomType', type=StringType), Parameter(name='RootElement_newCapacity', type=StringType)}, type=StringType)
RootElement_RoomTypeHandling_m_removeRoomType: Method = Method(name="removeRoomType", parameters={Parameter(name='RootElement_roomType', type=StringType)}, type=StringType)
RootElement_RoomTypeHandling_m_getAllRoomTypes: Method = Method(name="getAllRoomTypes", parameters={}, type=StringType)
RootElement_RoomTypeHandling_m_addAttributeToRoomType: Method = Method(name="addAttributeToRoomType", parameters={Parameter(name='RootElement_roomType', type=StringType), Parameter(name='RootElement_roomAttribute', type=StringType)}, type=StringType)
RootElement_RoomTypeHandling_m_removeAttributeFromRoomType: Method = Method(name="removeAttributeFromRoomType", parameters={Parameter(name='RootElement_roomAttribute', type=StringType), Parameter(name='RootElement_roomType', type=StringType)}, type=StringType)
RootElement_RoomTypeHandling_m_findRoomType: Method = Method(name="findRoomType", parameters={Parameter(name='RootElement_name', type=StringType)}, type=StringType)
RootElement_RoomTypeHandling.methods={RootElement_RoomTypeHandling_m_editRoomType, RootElement_RoomTypeHandling_m_getAllRoomTypes, RootElement_RoomTypeHandling_m_addAttributeToRoomType, RootElement_RoomTypeHandling_m_findRoomType, RootElement_RoomTypeHandling_m_removeRoomType, RootElement_RoomTypeHandling_m_addRoomType, RootElement_RoomTypeHandling_m_removeAttributeFromRoomType}
...
RootElement_HotelSystem_m_getStaff: Method = Method(name="getStaff", parameters={Parameter(name='RootElement_staffID', type=StringType)}, type=Staff)
RootElement_HotelSystem_m_getClerk: Method = Method(name="getClerk", parameters={Parameter(name='RootElement_staffID', type=StringType)}, type=Clerk)
...
RootElement_HotelSystem_m_getManager: Method = Method(name="getManager", parameters={Parameter(name='RootElement_staffID', type=StringType)}, type=StringType)
RootElement_HotelSystem.methods={RootElement_HotelSystem_m_getName, RootElement_HotelSystem_m_getClerk, RootElement_HotelSystem_m_getNationality, RootElement_HotelSystem_m_getStaff, RootElement_HotelSystem_m_getGuest, RootElement_HotelSystem_m_getManager, RootElement_HotelSystem_m_getSystemAdministrator}
...
RootElement_RoomFetcher.methods={RootElement_RoomFetcher_m_getBookableRooms, RootElement_RoomFetcher_m_getAllCleanableRooms, RootElement_RoomFetcher_m_getAvailableRooms}
...
domain_model = DomainModel(
    name="RootElement",
    types={SupportTicketWriter, FeedbackWriter, MakeBooking, RootElement_SupportTicketWriter, RootElement_MakeBooking, RootElement_FeedbackWriter, RootElement_Guest, RootElement_Booking, RootElement_RoomBooking, RootElement_ServiceItem, RootElement_Room, RootElement_RoomType, RootElement_RoomAttribute, RootElement_Feedback, RootElement_Staff, Cleaning, SupportTicketReader, RootElement_Cleaning, RootElement_SupportTicketReader, RootElement_SupportTicket, RootElement_Clerk, Staff, ReceptionHandling, ServiceItemHandling, Payment, RootElement_ReceptionHandling, RootElement_ServiceItemHandling, RootElement_Payment, RootElement_Manager, Clerk, SysAdmin, FeedbackReader, RootElement_FeedbackReader, RootElement_SysAdmin, RoomAttributeHandling, RoomHandling, RoomTypeHandling, RootElement_RoomAttributeHandling, RootElement_RoomHandling, RootElement_RoomTypeHandling, RootElement_BookingHandler, RootElement_RoomStructure, RoomFetcher, RootElement_FeedbackHandler, RootElement_SupportTicketHandler, RootElement_CleaningHandler, RootElement_PaymentHandler, RootElement_DailyRoomBooking, RoomBooking, RootElement_HourlyRoomBooking, RootElement_HotelSystem, RootElement_RoomFetcher, RootElement_Hotel, HotelSystem, BookingStatus},
    associations={supportTicketWriter0, makeBooking1, feedbackWriter3, roombooking5, guest6, serviceitem9, room11, roomType13, roomAttributes15, cleaning17, supportTicketReader18, supportTicketWriter20, receptionHandling23, serviceItemHandling24, makeBooking26, payment29, feedbackReader31, booking32, roomFetcher34, rooms36, roomTypes38, roomAttributes41, feedback44, supportticket45, roomFetcher46},
    generalizations={gen_RootElement_Guest_SupportTicketWriter, gen_RootElement_Guest_FeedbackWriter, gen_RootElement_Guest_MakeBooking, gen_RootElement_Staff_Cleaning, gen_RootElement_Staff_SupportTicketWriter, gen_RootElement_Staff_SupportTicketReader, gen_RootElement_Clerk_Staff, gen_RootElement_Clerk_ReceptionHandling, gen_RootElement_Clerk_ServiceItemHandling, gen_RootElement_Clerk_MakeBooking, gen_RootElement_Clerk_Payment, gen_RootElement_Manager_Clerk, gen_RootElement_Manager_SysAdmin, gen_RootElement_Manager_FeedbackReader, gen_RootElement_SysAdmin_RoomAttributeHandling, gen_RootElement_SysAdmin_RoomHandling, gen_RootElement_SysAdmin_RoomTypeHandling, gen_RootElement_BookingHandler_ReceptionHandling, gen_RootElement_BookingHandler_MakeBooking, gen_RootElement_BookingHandler_ServiceItemHandling, gen_RootElement_RoomStructure_RoomHandling, gen_RootElement_RoomStructure_RoomTypeHandling, gen_RootElement_RoomStructure_RoomAttributeHandling, gen_RootElement_RoomStructure_RoomFetcher, gen_RootElement_FeedbackHandler_FeedbackReader, gen_RootElement_FeedbackHandler_FeedbackWriter, gen_RootElement_SupportTicketHandler_SupportTicketReader, gen_RootElement_SupportTicketHandler_SupportTicketWriter, gen_RootElement_CleaningHandler_Cleaning, gen_RootElement_PaymentHandler_Payment, gen_RootElement_DailyRoomBooking_RoomBooking, gen_RootElement_HourlyRoomBooking_RoomBooking, gen_RootElement_Hotel_HotelSystem},
    metadata=None
)
