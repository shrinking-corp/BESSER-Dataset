...
public class Department  {
    ...
    public Department(
        None hod,        None teachers__,        None students__,        None course    ) {
        this.hod = hod;
    ...
    public Department(
        None hod,        None teachers__,        None students__,        None course        ArrayList<Student> students,        ArrayList<Employee_Interface> employee_interfaces    ) {
        this.hod = hod;
        this.teachers__ = teachers__;
        this.students__ = students__;
        this.course = course;
