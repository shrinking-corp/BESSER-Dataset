...
# Classes
PiServiceComposition_CompositionServiceModel = Class(name="PiServiceComposition_CompositionServiceModel")
PiServiceComposition_ActivityPartition = Class(name="PiServiceComposition_ActivityPartition", is_abstract=True)
PiServiceComposition_Activity = Class(name="PiServiceComposition_Activity", is_abstract=True)
PiServiceComposition_ActivityEdge = Class(name="PiServiceComposition_ActivityEdge", is_abstract=True)
PiServiceComposition_Policy = Class(name="PiServiceComposition_Policy")
PiServiceComposition_Variable = Class(name="PiServiceComposition_Variable")
PiServiceComposition_NamedElement = Class(name="PiServiceComposition_NamedElement", is_abstract=True)
NamedElement = Class(name="NamedElement")
PiServiceComposition_ActivityNode = Class(name="PiServiceComposition_ActivityNode", is_abstract=True)
PiServiceComposition_ControlFlow = Class(name="PiServiceComposition_ControlFlow")
ActivityEdge = Class(name="ActivityEdge")
PiServiceComposition_ObjectFlow = Class(name="PiServiceComposition_ObjectFlow")
PiServiceComposition_ExecutableNode = Class(name="PiServiceComposition_ExecutableNode", is_abstract=True)
ActivityNode = Class(name="ActivityNode")
PiServiceComposition_ControlNode = Class(name="PiServiceComposition_ControlNode", is_abstract=True)
PiServiceComposition_ObjectNode = Class(name="PiServiceComposition_ObjectNode")
PiServiceComposition_InitialNode = Class(name="PiServiceComposition_InitialNode")
ControlNode = Class(name="ControlNode")
PiServiceComposition_FinalNode = Class(name="PiServiceComposition_FinalNode", is_abstract=True)
PiServiceComposition_ForkNode = Class(name="PiServiceComposition_ForkNode")
PiServiceComposition_JoinNode = Class(name="PiServiceComposition_JoinNode")
PiServiceComposition_BussinessCollaborator = Class(name="PiServiceComposition_BussinessCollaborator")
ActivityPartition = Class(name="ActivityPartition")
PiServiceComposition_Rule = Class(name="PiServiceComposition_Rule")
PiServiceComposition_DecisionNode = Class(name="PiServiceComposition_DecisionNode")
PiServiceComposition_MergeNode = Class(name="PiServiceComposition_MergeNode")
PiServiceComposition_ActivityFinalNode = Class(name="PiServiceComposition_ActivityFinalNode")
FinalNode = Class(name="FinalNode")
PiServiceComposition_ServiceActivity = Class(name="PiServiceComposition_ServiceActivity")
Activity = Class(name="Activity")
PiServiceComposition_Action = Class(name="PiServiceComposition_Action")
...
PiServiceComposition_Variable.attributes={PiServiceComposition_Variable_type, PiServiceComposition_Variable_name}
...
PiServiceComposition_Rule.attributes={PiServiceComposition_Rule_event, PiServiceComposition_Rule_condition, PiServiceComposition_Rule_action, PiServiceComposition_Rule_name}
...
domain_model = DomainModel(
    ...
    types={PiServiceComposition_CompositionServiceModel, PiServiceComposition_ActivityPartition, PiServiceComposition_Activity, PiServiceComposition_ActivityEdge, PiServiceComposition_Policy, PiServiceComposition_Variable, PiServiceComposition_NamedElement, NamedElement, PiServiceComposition_ActivityNode, PiServiceComposition_ControlFlow, ActivityEdge, PiServiceComposition_ObjectFlow, PiServiceComposition_ExecutableNode, ActivityNode, PiServiceComposition_ControlNode, PiServiceComposition_ObjectNode, PiServiceComposition_InitialNode, ControlNode, PiServiceComposition_FinalNode, PiServiceComposition_ForkNode, PiServiceComposition_JoinNode, PiServiceComposition_BussinessCollaborator, ActivityPartition, PiServiceComposition_Rule, PiServiceComposition_DecisionNode, PiServiceComposition_MergeNode, PiServiceComposition_ActivityFinalNode, FinalNode, PiServiceComposition_ServiceActivity, Activity, PiServiceComposition_Action, ExecutableNode, ActionType, EventType},
    associations={partition0, activities1, edges3, compositionPolices5, vars7, node9, partition24, activity25, incoming28, outgoing30, redefinedElement33, partition35, APartition12, edges14, nodes15, target17, source19, redefinedElement22, hasPolices42, policy44, contains46, hasVars47, typeOperation50, action51, action37, hasPolices38, definePolices41},
    generalizations={gen_PiServiceComposition_Activity_NamedElement, gen_PiServiceComposition_ActivityPartition_NamedElement, gen_PiServiceComposition_ControlFlow_ActivityEdge, gen_PiServiceComposition_ObjectFlow_ActivityEdge, gen_PiServiceComposition_ActivityNode_NamedElement, gen_PiServiceComposition_ExecutableNode_ActivityNode, gen_PiServiceComposition_ControlNode_ActivityNode, gen_PiServiceComposition_ObjectNode_ActivityNode, gen_PiServiceComposition_InitialNode_ControlNode, gen_PiServiceComposition_FinalNode_ControlNode, gen_PiServiceComposition_ForkNode_ControlNode, gen_PiServiceComposition_JoinNode_ControlNode, gen_PiServiceComposition_ActivityEdge_NamedElement, gen_PiServiceComposition_BussinessCollaborator_ActivityPartition, gen_PiServiceComposition_DecisionNode_ControlNode, gen_PiServiceComposition_MergeNode_ControlNode, gen_PiServiceComposition_ActivityFinalNode_FinalNode, gen_PiServiceComposition_ServiceActivity_Activity, gen_PiServiceComposition_Action_ExecutableNode},
    metadata=None
)
