...
def test_hyp_relationaldatabase_taggable_is_not_abstract():
    assert not inspect.isabstract(relationaldatabase_Taggable)


def test_hyp_relationaldatabase_taggable_constructor_exists():
    assert callable(relationaldatabase_Taggable.__init__)


def test_hyp_relationaldatabase_taggable_constructor_args():
    sig = inspect.signature(relationaldatabase_Taggable.__init__)
    params = list(sig.parameters.keys())



def test_hyp_relationaldatabase_configuration_is_not_abstract():
    assert not inspect.isabstract(relationaldatabase_Configuration)


def test_hyp_relationaldatabase_configuration_constructor_exists():
    assert callable(relationaldatabase_Configuration.__init__)


def test_hyp_relationaldatabase_configuration_constructor_args():
    sig = inspect.signature(relationaldatabase_Configuration.__init__)
    params = list(sig.parameters.keys())



def test_hyp_relationaldatabase_tag_is_not_abstract():
    assert not inspect.isabstract(relationaldatabase_Tag)


def test_hyp_relationaldatabase_tag_constructor_exists():
    assert callable(relationaldatabase_Tag.__init__)


def test_hyp_relationaldatabase_tag_constructor_args():
...
def test_hyp_relationaldatabase_datatype_is_not_abstract():
    assert not inspect.isabstract(relationaldatabase_DataType)


def test_hyp_relationaldatabase_datatype_constructor_exists():
    assert callable(relationaldatabase_DataType.__init__)


def test_hyp_relationaldatabase_datatype_constructor_args():
...
def test_hyp_relationaldatabase_databasemodel_is_not_abstract():
    assert not inspect.isabstract(relationaldatabase_DatabaseModel)


def test_hyp_relationaldatabase_databasemodel_constructor_exists():
    assert callable(relationaldatabase_DatabaseModel.__init__)


def test_hyp_relationaldatabase_databasemodel_constructor_args():
    sig = inspect.signature(relationaldatabase_DatabaseModel.__init__)
    params = list(sig.parameters.keys())



def test_hyp_taggable_is_not_abstract():
    assert not inspect.isabstract(Taggable)


def test_hyp_taggable_constructor_exists():
    assert callable(Taggable.__init__)


def test_hyp_taggable_constructor_args():
...
def test_hyp_relationaldatabase_tag_documentation_setter(instance):
...
@given(instance=relationaldatabase_Tag_strategy)
def test_hyp_relationaldatabase_tag_name_setter(instance):
...
def test_hyp_relationaldatabase_column_unique_setter(instance):
...
@given(instance=relationaldatabase_Column_strategy)
def test_hyp_relationaldatabase_column_size_setter(instance):
...
@given(instance=relationaldatabase_Column_strategy)
def test_hyp_relationaldatabase_column_arrayDimensions_setter(instance):
...
@given(instance=relationaldatabase_Column_strategy)
def test_hyp_relationaldatabase_column_nullable_setter(instance):
...
@given(instance=relationaldatabase_Column_strategy)
def test_hyp_relationaldatabase_column_primaryKey_setter(instance):
...
@given(instance=relationaldatabase_Column_strategy)
def test_hyp_relationaldatabase_column_scale_setter(instance):
...
def test_hyp_relationaldatabase_foreignkey_targetUpperBoundary_setter(instance):
...
@given(instance=relationaldatabase_ForeignKey_strategy)
def test_hyp_relationaldatabase_foreignkey_sourceLowerBoundary_setter(instance):
...
@given(instance=relationaldatabase_ForeignKey_strategy)
def test_hyp_relationaldatabase_foreignkey_sourceUpperBoundary_setter(instance):
...
@given(instance=relationaldatabase_ForeignKey_strategy)
def test_hyp_relationaldatabase_foreignkey_targetLowerBoundary_setter(instance):
...
@given(instance=relationaldatabase_NamedElement_strategy)
def test_hyp_relationaldatabase_namedelement_documentation_setter(instance):
    original = instance.documentation
    instance.documentation = original
    assert instance.documentation == original
