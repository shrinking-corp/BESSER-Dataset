...
domain_model = DomainModel(
    name="Documentation",
    types={Documentation_Paragraph, Documentation_ParagraphValue, Documentation_TextualValue, ParagraphValue, Documentation_ItemizedListValue, Documentation_ItemizedListValueItem, Paragraph, Documentation_EmphasisValue, Documentation_XRefValue, Documentation_InformalTableValue, Documentation_InformalTableValueGroup, Documentation_Book, Documentation_Section, Documentation_InformalTableValueEntry, Documentation_InformalTableValueHead, Documentation_InformalTableValueBody, Documentation_InformalTableValueRow},
    associations={values1, section3, para5, items8, linkend9, tgroup11, content0, entry21, thead12, tbody14, rows16, rows18},
