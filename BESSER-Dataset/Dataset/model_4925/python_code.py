...
class web_Release:
    ...
    def __init__(self, buildId: str, type: str, name: str, releaseNotesLink: str, date: date, unqualifiedName: str, alternateMsiName: str, javadoc: bool, baseName: str, releases: "web_Version" = None, web_Release: "web_ReleaseSection" = None, Release: "web_Version" = None):
...
class web_Page(ABC):
    ...
    def __init__(self, id: str, name: str, pages: "web_Site" = None, Page: "web_Site" = None):
        self.id = id
        self.name = name
        self.pages = pages
        self.Page = Page
...
class web_Site:
    ...
    def __init__(self, description: str, name: str, web_Site7: set["web_Link"] = None, web_Site9: set["web_Version"] = None, web_Site11: set["web_Gallery"] = None, Site: "web_Page" = None, site: set["web_Page"] = None, web_Site: set["web_FooterEntry"] = None, web_Site3: set["web_NewsEntry"] = None, web_Site5: set["web_Author"] = None):
        self.description = description
        self.name = name
