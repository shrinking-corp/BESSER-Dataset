...
# Classes
web_Site = Class(name="web_Site")
web_Page = Class(name="web_Page", is_abstract=True)
web_Link = Class(name="web_Link")
web_Version = Class(name="web_Version")
web_Gallery = Class(name="web_Gallery")
web_Content = Class(name="web_Content", is_abstract=True)
web_HtmlContent = Class(name="web_HtmlContent")
Content = Class(name="Content")
Container = Class(name="Container")
web_FooterEntry = Class(name="web_FooterEntry")
web_NewsEntry = Class(name="web_NewsEntry")
web_Author = Class(name="web_Author")
web_Release = Class(name="web_Release")
web_ReleaseSection = Class(name="web_ReleaseSection")
web_Container = Class(name="web_Container", is_abstract=True)
web_NewsFeedPage = Class(name="web_NewsFeedPage")
Page = Class(name="Page")
web_ContentPage = Class(name="web_ContentPage")
web_SocialInformation = Class(name="web_SocialInformation")
web_Image = Class(name="web_Image")
web_GalleryContent = Class(name="web_GalleryContent")
web_SocialBar = Class(name="web_SocialBar")
...
web_Version.attributes={web_Version_state, web_Version_name}
...
web_NewsEntry.attributes={web_NewsEntry_title, web_NewsEntry_description, web_NewsEntry_date}
...
web_Author.attributes={web_Author_email, web_Author_name, web_Author_plusLink}
...
web_Release.attributes={web_Release_alternateMsiName, web_Release_unqualifiedName, web_Release_date, web_Release_baseName, web_Release_buildId, web_Release_javadoc, web_Release_name, web_Release_type, web_Release_releaseNotesLink}
...
web_SocialInformation.attributes={web_SocialInformation_twitterUrl, web_SocialInformation_facebookUrl, web_SocialInformation_url, web_SocialInformation_plusUrl}
...
domain_model = DomainModel(
    name="web",
    types={web_Site, web_Page, web_Link, web_Version, web_Gallery, web_Content, web_HtmlContent, Content, Container, web_FooterEntry, web_NewsEntry, web_Author, web_Release, web_ReleaseSection, web_Container, web_NewsFeedPage, Page, web_ContentPage, web_SocialInformation, web_Image, web_GalleryContent, web_SocialBar, ReleaseType, VersionState},
    associations={links6, versions8, galleries10, site12, author13, pages0, footer1, news2, author4, version17, release18, releases19, content16, information24, images20, gallery22},
    generalizations={gen_web_HtmlContent_Content, gen_web_NewsEntry_Container, gen_web_ReleaseSection_Content, gen_web_NewsFeedPage_Page, gen_web_ContentPage_Container, gen_web_ContentPage_Page, gen_web_GalleryContent_Content, gen_web_SocialBar_Content},
    metadata=None
)
