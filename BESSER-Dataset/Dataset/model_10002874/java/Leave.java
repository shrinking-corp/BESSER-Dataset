...
public class Leave  {
    ...
    public Leave(
        String Leave_Status,        LocalDate Leave_ApplyDate,        LocalDate Leave_StartDate,        int Leave_NoOfDays,        int Emp_Id,        String Leave_detail,        int leave_id,        String Leave_Title,        LocalDate Leave_EndDate    ) {
