...
Employee.attributes={Employee_Emp_Date_Of_Joint, Employee_Emp_DOB, Employee_Emp_Salary, Employee_Emp_Name, Employee_Emp_Id, Employee_Emp_NIC, Employee_Emp_Address, Employee_Emp_Position, Employee_Emp_ContactNo, Employee_Emp_Email, Employee_Emp_Department}
...
Salary.attributes={Salary_Sly_Basic, Salary_OverTime, Salary_Sly_Netgross, Salary_Sly_Increment, Salary_Emp_Id, Salary_Sly_Decrement}
...
Leave.attributes={Leave_Leave_detail, Leave_Leave_Status, Leave_Emp_Id, Leave_Leave_EndDate, Leave_Leave_Title, Leave_Leave_ApplyDate, Leave_Leave_NoOfDays, Leave_leave_id, Leave_Leave_StartDate}
...
domain_model = DomainModel(
    name="e53760c6_7abb_404e_a72b_6314c2148a68",
    types={Employee, Salary, Admin, Leave, Attendance, Login, Employee_Management_System_Component, Authentication_UseCase, Salary_Management_UseCase, Administrator_Actor, Employee_Actor, Login_external, Logout_external},
