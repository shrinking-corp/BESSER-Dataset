...
class swml_Attribute:
    ...
    def __init__(self, type: str, name: str, swml_Attribute: "swml_Class" = None, swml_Attribute14: "swml_Class" = None):
        self.type = type
        self.name = name
...
class swml_Class:
    ...
    def __init__(self, name: str, swml_Class11: set["swml_Attribute"] = None, swml_Class13: "swml_Attribute" = None, swml_Class18: "swml_DynamicPage" = None, swml_Class: "swml_ContentLayer" = None):
        self.name = name
