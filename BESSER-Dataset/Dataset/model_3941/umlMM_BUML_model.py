...
# Classes
UmlMM_DataType = Class(name="UmlMM_DataType")
Classifier = Class(name="Classifier")
UmlMM_Class = Class(name="UmlMM_Class")
UmlMM_UmlPackage = Class(name="UmlMM_UmlPackage")
UmlMM_Classifier = Class(name="UmlMM_Classifier")
UmlMM_Operation = Class(name="UmlMM_Operation")
UmlMM_Property = Class(name="UmlMM_Property")
UmlMM_Parameter = Class(name="UmlMM_Parameter")
...
UmlMM_Property.attributes={UmlMM_Property_lower, UmlMM_Property_upper, UmlMM_Property_name}
...
domain_model = DomainModel(
    name="UmlMM",
    types={UmlMM_DataType, Classifier, UmlMM_Class, UmlMM_UmlPackage, UmlMM_Classifier, UmlMM_Operation, UmlMM_Property, UmlMM_Parameter},
    associations={elements0, _UmlPackage1, type10, _Class12, operation2, _property3, _Class5, parameter6, type7, _Operation8},
