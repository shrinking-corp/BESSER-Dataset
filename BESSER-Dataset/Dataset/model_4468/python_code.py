...
class polybot_modelling_language_Robot:
    ...
    def __init__(self, debug: bool, polybot_modelling_language_Robot2: set["polybot_modelling_language_Instruction"] = None, polybot_modelling_language_Robot: "polybot_modelling_language_Scene" = None):
        self.debug = debug
