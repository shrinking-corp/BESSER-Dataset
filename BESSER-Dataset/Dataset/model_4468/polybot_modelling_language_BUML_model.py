...
# Classes
polybot_modelling_language_Scene = Class(name="polybot_modelling_language_Scene")
polybot_modelling_language_Robot = Class(name="polybot_modelling_language_Robot")
polybot_modelling_language_MoveStraight = Class(name="polybot_modelling_language_MoveStraight")
Instruction = Class(name="Instruction")
polybot_modelling_language_TurnRight = Class(name="polybot_modelling_language_TurnRight")
Turn = Class(name="Turn")
polybot_modelling_language_Instruction = Class(name="polybot_modelling_language_Instruction", is_abstract=True)
polybot_modelling_language_Release = Class(name="polybot_modelling_language_Release")
polybot_modelling_language_Catch = Class(name="polybot_modelling_language_Catch")
polybot_modelling_language_TurnLeft = Class(name="polybot_modelling_language_TurnLeft")
polybot_modelling_language_Turn = Class(name="polybot_modelling_language_Turn", is_abstract=True)
polybot_modelling_language_ComeHome = Class(name="polybot_modelling_language_ComeHome")
...
polybot_modelling_language_Instruction.attributes={polybot_modelling_language_Instruction_name, polybot_modelling_language_Instruction_nextInstructionFalse, polybot_modelling_language_Instruction_nextInstruction, polybot_modelling_language_Instruction_nextInstructionTrue}
...
domain_model = DomainModel(
    ...
    types={polybot_modelling_language_Scene, polybot_modelling_language_Robot, polybot_modelling_language_MoveStraight, Instruction, polybot_modelling_language_TurnRight, Turn, polybot_modelling_language_Instruction, polybot_modelling_language_Release, polybot_modelling_language_Catch, polybot_modelling_language_TurnLeft, polybot_modelling_language_Turn, polybot_modelling_language_ComeHome},
