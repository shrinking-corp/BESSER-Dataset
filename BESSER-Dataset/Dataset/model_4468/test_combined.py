...
def test_hyp_polybot_modelling_language_instruction_is_not_abstract():
    assert not inspect.isabstract(polybot_modelling_language_Instruction)


def test_hyp_polybot_modelling_language_instruction_constructor_exists():
    assert callable(polybot_modelling_language_Instruction.__init__)


def test_hyp_polybot_modelling_language_instruction_constructor_args():
...
def test_hyp_polybot_modelling_language_turnleft_is_not_abstract():
    assert not inspect.isabstract(polybot_modelling_language_TurnLeft)


def test_hyp_polybot_modelling_language_turnleft_constructor_exists():
    assert callable(polybot_modelling_language_TurnLeft.__init__)


def test_hyp_polybot_modelling_language_turnleft_constructor_args():
    sig = inspect.signature(polybot_modelling_language_TurnLeft.__init__)
    params = list(sig.parameters.keys())



def test_hyp_polybot_modelling_language_turnright_is_not_abstract():
    assert not inspect.isabstract(polybot_modelling_language_TurnRight)


def test_hyp_polybot_modelling_language_turnright_constructor_exists():
    assert callable(polybot_modelling_language_TurnRight.__init__)


def test_hyp_polybot_modelling_language_turnright_constructor_args():
...
def test_hyp_polybot_modelling_language_turn_is_not_abstract():
    assert not inspect.isabstract(polybot_modelling_language_Turn)


def test_hyp_polybot_modelling_language_turn_constructor_exists():
    assert callable(polybot_modelling_language_Turn.__init__)


def test_hyp_polybot_modelling_language_turn_constructor_args():
...
def test_hyp_polybot_modelling_language_catch_is_not_abstract():
    assert not inspect.isabstract(polybot_modelling_language_Catch)


def test_hyp_polybot_modelling_language_catch_constructor_exists():
    assert callable(polybot_modelling_language_Catch.__init__)


def test_hyp_polybot_modelling_language_catch_constructor_args():
    sig = inspect.signature(polybot_modelling_language_Catch.__init__)
    params = list(sig.parameters.keys())



def test_hyp_polybot_modelling_language_comehome_is_not_abstract():
    assert not inspect.isabstract(polybot_modelling_language_ComeHome)


def test_hyp_polybot_modelling_language_comehome_constructor_exists():
    assert callable(polybot_modelling_language_ComeHome.__init__)


def test_hyp_polybot_modelling_language_comehome_constructor_args():
    sig = inspect.signature(polybot_modelling_language_ComeHome.__init__)
    params = list(sig.parameters.keys())



def test_hyp_polybot_modelling_language_release_is_not_abstract():
    assert not inspect.isabstract(polybot_modelling_language_Release)


def test_hyp_polybot_modelling_language_release_constructor_exists():
    assert callable(polybot_modelling_language_Release.__init__)


def test_hyp_polybot_modelling_language_release_constructor_args():
    sig = inspect.signature(polybot_modelling_language_Release.__init__)
    params = list(sig.parameters.keys())



def test_hyp_polybot_modelling_language_movestraight_is_not_abstract():
    assert not inspect.isabstract(polybot_modelling_language_MoveStraight)


def test_hyp_polybot_modelling_language_movestraight_constructor_exists():
    assert callable(polybot_modelling_language_MoveStraight.__init__)


def test_hyp_polybot_modelling_language_movestraight_constructor_args():
...
def test_hyp_polybot_modelling_language_robot_is_not_abstract():
    assert not inspect.isabstract(polybot_modelling_language_Robot)


def test_hyp_polybot_modelling_language_robot_constructor_exists():
    assert callable(polybot_modelling_language_Robot.__init__)


def test_hyp_polybot_modelling_language_robot_constructor_args():
...
def test_hyp_polybot_modelling_language_scene_is_not_abstract():
    assert not inspect.isabstract(polybot_modelling_language_Scene)


def test_hyp_polybot_modelling_language_scene_constructor_exists():
    assert callable(polybot_modelling_language_Scene.__init__)


def test_hyp_polybot_modelling_language_scene_constructor_args():
...
def test_hyp_polybot_modelling_language_instruction_name_setter(instance):
...
@given(instance=polybot_modelling_language_Instruction_strategy)
def test_hyp_polybot_modelling_language_instruction_nextInstructionFalse_setter(instance):
...
@given(instance=polybot_modelling_language_Instruction_strategy)
def test_hyp_polybot_modelling_language_instruction_nextInstructionTrue_setter(instance):
...
@given(instance=polybot_modelling_language_Instruction_strategy)
def test_hyp_polybot_modelling_language_instruction_nextInstruction_setter(instance):
...
def test_hyp_polybot_modelling_language_turn_angle_setter(instance):
...
def test_hyp_polybot_modelling_language_movestraight_distance_setter(instance):
...
def test_hyp_polybot_modelling_language_robot_debug_setter(instance):
