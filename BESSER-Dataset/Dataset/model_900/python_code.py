...
class simplepdl_WorkSequence:
    ...
    def __init__(self, linkType: str, simplepdl_WorkSequence: "simplepdl_Process" = None, WorkSequence: "simplepdl_WorkDefinition" = None, WorkSequence5: "simplepdl_WorkDefinition" = None, linksToSuccessors: "simplepdl_WorkDefinition" = None, linksToPredecessors: "simplepdl_WorkDefinition" = None):
...
class simplepdl_WorkDefinition:
    ...
    def __init__(self, name: str, successor: set["simplepdl_WorkSequence"] = None, predecessor: set["simplepdl_WorkSequence"] = None, WorkDefinition: "simplepdl_WorkSequence" = None, WorkDefinition8: "simplepdl_WorkSequence" = None, simplepdl_WorkDefinition: "simplepdl_Process" = None):
        self.name = name
...
class simplepdl_Process:
    ...
    def __init__(self, name: str, simplepdl_Process2: set["simplepdl_WorkSequence"] = None, simplepdl_Process: set["simplepdl_WorkDefinition"] = None):
        self.name = name
