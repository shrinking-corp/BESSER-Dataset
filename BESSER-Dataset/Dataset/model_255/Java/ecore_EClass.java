...
public class ecore_EClass extends EClassifier {
    ...
    public ecore_EClass(
        boolean abstract,        boolean interface        ArrayList<ecore_EOperation> ecore_eoperations,        ArrayList<ecore_EGenericType> ecore_egenerictypes,        ArrayList<ecore_EAttribute> ecore_eattributes,        ArrayList<ecore_EStructuralFeature> ecore_estructuralfeatures,        ArrayList<ecore_EOperation> ecore_eoperations,        ArrayList<ecore_EAttribute> ecore_eattributes,        ArrayList<ecore_EGenericType> ecore_egenerictypes,        ArrayList<ecore_EReference> ecore_ereferences,        ArrayList<ecore_EClass> ecore_eclasss,        ArrayList<ecore_EReference> ecore_ereferences,        ArrayList<ecore_EStructuralFeature> ecore_estructuralfeatures,        ArrayList<ecore_EReference> ecore_ereferences    ) {
        this.abstract = abstract;
        this.interface = interface;
