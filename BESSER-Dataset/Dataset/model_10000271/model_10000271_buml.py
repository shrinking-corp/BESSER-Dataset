...
Doctor.attributes={Doctor_phno, Doctor_docid, Doctor_specialization, Doctor_name, Doctor_address, Doctor_department}
...
Department.attributes={Department_doctorid, Department_id, Department_name}
...
Patient.attributes={Patient_age, Patient_sex, Patient_id, Patient_roomno, Patient_name, Patient_address, Patient_telno}
...
domain_model = DomainModel(
    name="_215cc9ec_daa7_45dc_a686_1d0b5654d55a",
    types={Doctor, Department, Patient, Room, Receptionist, Person, Bill, Staff, Nurse},
    associations={Patient_Bill, receptions, manages, Doctor_Patient, Doctor_Department, Patient_Room, Room_Staff},
    generalizations={},
    metadata=None
)
