...
# Classes
dcps_DomainParticipant = Class(name="dcps_DomainParticipant")
DomainEntity = Class(name="DomainEntity")
dcps_Publisher = Class(name="dcps_Publisher")
dcps_Subscriber = Class(name="dcps_Subscriber")
dcps_EntityFactoryQosPolicy = Class(name="dcps_EntityFactoryQosPolicy")
dcps_Domain = Class(name="dcps_Domain")
Entity = Class(name="Entity")
dcps_DestinationOrderQosPolicy = Class(name="dcps_DestinationOrderQosPolicy")
dcps_DurabilityQosPolicy = Class(name="dcps_DurabilityQosPolicy")
dcps_HistoryQosPolicy = Class(name="dcps_HistoryQosPolicy")
dcps_LatencyBudgetQosPolicy = Class(name="dcps_LatencyBudgetQosPolicy")
dcps_LivelinessQosPolicy = Class(name="dcps_LivelinessQosPolicy")
dcps_OwnershipQosPolicy = Class(name="dcps_OwnershipQosPolicy")
dcps_ReliabilityQosPolicy = Class(name="dcps_ReliabilityQosPolicy")
dcps_ResourceLimitsQosPolicy = Class(name="dcps_ResourceLimitsQosPolicy")
dcps_UserDataQosPolicy = Class(name="dcps_UserDataQosPolicy")
dcps_PublisherSubscriber = Class(name="dcps_PublisherSubscriber", is_abstract=True)
dcps_GroupDataQosPolicy = Class(name="dcps_GroupDataQosPolicy")
dcps_PresentationQosPolicy = Class(name="dcps_PresentationQosPolicy")
dcps_PartitionQosPolicy = Class(name="dcps_PartitionQosPolicy")
PublisherSubscriber = Class(name="PublisherSubscriber")
dcps_DataReader = Class(name="dcps_DataReader")
dcps_DataWriter = Class(name="dcps_DataWriter")
dcps_DataReaderWriter = Class(name="dcps_DataReaderWriter", is_abstract=True)
dcps_DeadlineQosPolicy = Class(name="dcps_DeadlineQosPolicy")
DataReaderWriter = Class(name="DataReaderWriter")
dcps_ReaderDataLifecycleQosPolicy = Class(name="dcps_ReaderDataLifecycleQosPolicy")
dcps_TimeBasedFilterQosPolicy = Class(name="dcps_TimeBasedFilterQosPolicy")
dcps_TopicDescription = Class(name="dcps_TopicDescription")
dcps_DurabilityServiceQosPolicy = Class(name="dcps_DurabilityServiceQosPolicy")
dcps_OwnershipStrengthQosPolicy = Class(name="dcps_OwnershipStrengthQosPolicy")
dcps_TransportPriorityQosPolicy = Class(name="dcps_TransportPriorityQosPolicy")
dcps_WriterDataLifecycleQosPolicy = Class(name="dcps_WriterDataLifecycleQosPolicy")
dcps_LifespanQosPolicy = Class(name="dcps_LifespanQosPolicy")
dcps_Topic = Class(name="dcps_Topic")
...
domain_model = DomainModel(
    name="dcps",
    types={dcps_DomainParticipant, DomainEntity, dcps_Publisher, dcps_Subscriber, dcps_EntityFactoryQosPolicy, dcps_Domain, Entity, dcps_DestinationOrderQosPolicy, dcps_DurabilityQosPolicy, dcps_HistoryQosPolicy, dcps_LatencyBudgetQosPolicy, dcps_LivelinessQosPolicy, dcps_OwnershipQosPolicy, dcps_ReliabilityQosPolicy, dcps_ResourceLimitsQosPolicy, dcps_UserDataQosPolicy, dcps_PublisherSubscriber, dcps_GroupDataQosPolicy, dcps_PresentationQosPolicy, dcps_PartitionQosPolicy, PublisherSubscriber, dcps_DataReader, dcps_DataWriter, dcps_DataReaderWriter, dcps_DeadlineQosPolicy, DataReaderWriter, dcps_ReaderDataLifecycleQosPolicy, dcps_TimeBasedFilterQosPolicy, dcps_TopicDescription, dcps_DurabilityServiceQosPolicy, dcps_OwnershipStrengthQosPolicy, dcps_TransportPriorityQosPolicy, dcps_WriterDataLifecycleQosPolicy, dcps_LifespanQosPolicy, dcps_Topic},
    associations={domain0, publishers1, subscribers3, entity_factory5, destination_order22, durability24, history26, latency_budget28, liveliness30, ownership32, reliability34, user_data7, entity_factory9, group_data11, presentation13, partition15, readers17, writers19, deadline21, resource_limits36, user_data38, reader_data_lifecycle41, time_based_filter43, topic45, durability_service47, ownership_strength49, transport_priority51, writer_data_lifecycle53, lifespan55, topic57},
    generalizations={gen_dcps_DomainParticipant_DomainEntity, gen_dcps_Domain_Entity, gen_dcps_PublisherSubscriber_DomainEntity, gen_dcps_Subscriber_PublisherSubscriber, gen_dcps_Publisher_PublisherSubscriber, gen_dcps_DataReaderWriter_DomainEntity, gen_dcps_DataReader_DataReaderWriter, gen_dcps_DataWriter_DataReaderWriter},
    metadata=None
)
