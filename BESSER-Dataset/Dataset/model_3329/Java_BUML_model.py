...
Java_MethodSignature.attributes={Java_MethodSignature_isStatic, Java_MethodSignature_name, Java_MethodSignature_isPublic, Java_MethodSignature_isPrivate, Java_MethodSignature_isProtected}
...
Java_Field.attributes={Java_Field_isProtected, Java_Field_isPublic, Java_Field_isPrivate, Java_Field_isStatic, Java_Field_name}
...
Java_Return.attributes={Java_Return_objectId, Java_Return_fieldName}
...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={Java_Package, ObjectType, Java_Type, Java_VoidType, Type, Java_ObjectType, Package, Java_PrimitiveType, Java_Class, Interface, Class_, Field, Method_, Java_Interface, MethodSignature, Java_MethodSignature, Parameter_, Java_Method, Statement, Annotation, Java_Parameter, Java_Field, Java_Statement, Java_MethodCall, Java_Assignment, Java_Return, Java_Annotation, Java_VariableDeclaration},
    associations={content0, owner1, implements2, superclass3, field5, method7, methodDeclaration11, returnType13, parameters14, statements16, annotation17, type19, type21, owner23, superinterface9, type25},
    generalizations={gen_Java_VoidType_Type, gen_Java_ObjectType_Type, gen_Java_PrimitiveType_Type, gen_Java_Class_ObjectType, gen_Java_Interface_ObjectType, gen_Java_Method_MethodSignature, gen_Java_MethodCall_Statement, gen_Java_Assignment_Statement, gen_Java_Return_Statement, gen_Java_VariableDeclaration_Statement},
    metadata=None
)
