...
class Java_MethodCall(Statement):
    ...
    def __init__(self, methodName: str, variableName: str, Statement: "Java_Method" = None):
...
class Java_Class(ObjectType):
    ...
    def __init__(self, isPublic: bool, isStatic: bool, Java_Class: set["Interface"] = None, Java_Class4: "Class" = None, owner6: set["Field"] = None, Java_Class8: set["Method"] = None, ObjectType: "Java_Package" = None):
        self.isPublic = isPublic
        self.isStatic = isStatic
