...
StateMachineHyperedges_StateVertex = Class(name="StateMachineHyperedges_StateVertex")
...
domain_model = DomainModel(
    ...
    associations={trigger6, sources8, targets9, states0, transitions1, outgoing3, incoming4},
