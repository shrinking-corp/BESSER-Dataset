...
domain_model = DomainModel(
    name="Documentation",
    types={Documentation_Book, Documentation_Section, Documentation_Paragraph, Documentation_ParagraphValue, Documentation_TextualValue, ParagraphValue, Documentation_ItemizedListValue, Documentation_ItemizedListValueItem, Paragraph, Documentation_EmphasisValue, TextualValue, Documentation_XRefValue, Documentation_InformalTableValue, Documentation_InformalTableValueRow},
    associations={content0, values1, section3, items8, linkend9, bodyRows11, headRows12, para5, entry15},
