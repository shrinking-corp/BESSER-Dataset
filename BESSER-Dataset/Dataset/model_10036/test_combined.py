...
def test_hyp_constraint__is_not_abstract():
    assert not inspect.isabstract(Constraint_)


def test_hyp_constraint__constructor_exists():
    assert callable(Constraint_.__init__)


def test_hyp_constraint__constructor_args():
    sig = inspect.signature(Constraint_.__init__)
    params = list(sig.parameters.keys())
...
Constraint__strategy = st.builds(
    Constraint_,
)
...
def test_UML2_InteractionConstraint_isa_Constraint_():
    instance = UML2_InteractionConstraint()
    assert isinstance(instance, Constraint_)


def test_UML2_IntervalConstraint_isa_Constraint_():
...
def test_assoc_behavior35_link_reassign_clear():
    ...
    if hasattr(b1, 'UML2_Behavior36'):
        assert _is_linked(b1, 'UML2_Behavior36', a)
    _safe_set(a, 'UML2_OpaqueExpression', b2)
    assert _is_linked(a, 'UML2_OpaqueExpression', b2)
    if hasattr(b1, 'UML2_Behavior36'):
        assert not _is_linked(b1, 'UML2_Behavior36', a)
    if hasattr(b2, 'UML2_Behavior36'):
        assert _is_linked(b2, 'UML2_Behavior36', a)
    _safe_set(a, 'UML2_OpaqueExpression', None)
    assert not _is_linked(a, 'UML2_OpaqueExpression', b2)
    if hasattr(b2, 'UML2_Behavior36'):
        assert not _is_linked(b2, 'UML2_Behavior36', a)


def test_assoc_bodyCondition38_link_reassign_clear():
    a = UML2_Operation(isQuery=True)
    b1 = UML2_Constraint()
    b2 = UML2_Constraint()
    _safe_set(a, 'UML2_Operation39', b1)
    assert _is_linked(a, 'UML2_Operation39', b1)
    if hasattr(b1, 'UML2_Constraint'):
        assert _is_linked(b1, 'UML2_Constraint', a)
    _safe_set(a, 'UML2_Operation39', b2)
    assert _is_linked(a, 'UML2_Operation39', b2)
    if hasattr(b1, 'UML2_Constraint'):
        assert not _is_linked(b1, 'UML2_Constraint', a)
    if hasattr(b2, 'UML2_Constraint'):
        assert _is_linked(b2, 'UML2_Constraint', a)
    _safe_set(a, 'UML2_Operation39', None)
    assert not _is_linked(a, 'UML2_Operation39', b2)
    if hasattr(b2, 'UML2_Constraint'):
...
def test_assoc_classifier72_link_reassign_clear():
    a = UML2_Classifier(isAbstract=True)
    b1 = UML2_InstanceSpecification()
    b2 = UML2_InstanceSpecification()
    _safe_set(a, 'UML2_Classifier74', b1)
    assert _is_linked(a, 'UML2_Classifier74', b1)
    if hasattr(b1, 'UML2_InstanceSpecification73'):
        assert _is_linked(b1, 'UML2_InstanceSpecification73', a)
    _safe_set(a, 'UML2_Classifier74', b2)
    assert _is_linked(a, 'UML2_Classifier74', b2)
    if hasattr(b1, 'UML2_InstanceSpecification73'):
        assert not _is_linked(b1, 'UML2_InstanceSpecification73', a)
    if hasattr(b2, 'UML2_InstanceSpecification73'):
        assert _is_linked(b2, 'UML2_InstanceSpecification73', a)
    _safe_set(a, 'UML2_Classifier74', None)
    assert not _is_linked(a, 'UML2_Classifier74', b2)
    if hasattr(b2, 'UML2_InstanceSpecification73'):
        assert not _is_linked(b2, 'UML2_InstanceSpecification73', a)


def test_assoc_context_57_link_reassign_clear():
    a = UML2_Classifier(isAbstract=True)
    b1 = UML2_Action()
    b2 = UML2_Action()
...
def test_assoc_definingFeature67_link_reassign_clear():
    a = UML2_StructuralFeature(isReadOnly=True)
    b1 = UML2_Slot()
    b2 = UML2_Slot()
    _safe_set(a, 'UML2_StructuralFeature68', b1)
    assert _is_linked(a, 'UML2_StructuralFeature68', b1)
    if hasattr(b1, 'UML2_Slot'):
        assert _is_linked(b1, 'UML2_Slot', a)
    _safe_set(a, 'UML2_StructuralFeature68', b2)
    assert _is_linked(a, 'UML2_StructuralFeature68', b2)
    if hasattr(b1, 'UML2_Slot'):
        assert not _is_linked(b1, 'UML2_Slot', a)
    if hasattr(b2, 'UML2_Slot'):
        assert _is_linked(b2, 'UML2_Slot', a)
    _safe_set(a, 'UML2_StructuralFeature68', None)
    assert not _is_linked(a, 'UML2_StructuralFeature68', b2)
    if hasattr(b2, 'UML2_Slot'):
        assert not _is_linked(b2, 'UML2_Slot', a)


def test_assoc_end27_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b1 = UML2_LinkEndData()
    b2 = UML2_LinkEndData()
    _safe_set(a, 'UML2_Property29', b1)
    assert _is_linked(a, 'UML2_Property29', b1)
    if hasattr(b1, 'UML2_LinkEndData28'):
        assert _is_linked(b1, 'UML2_LinkEndData28', a)
    _safe_set(a, 'UML2_Property29', b2)
    assert _is_linked(a, 'UML2_Property29', b2)
    if hasattr(b1, 'UML2_LinkEndData28'):
        assert not _is_linked(b1, 'UML2_LinkEndData28', a)
    if hasattr(b2, 'UML2_LinkEndData28'):
        assert _is_linked(b2, 'UML2_LinkEndData28', a)
    _safe_set(a, 'UML2_Property29', None)
    assert not _is_linked(a, 'UML2_Property29', b2)
    if hasattr(b2, 'UML2_LinkEndData28'):
        assert not _is_linked(b2, 'UML2_LinkEndData28', a)


def test_assoc_feature75_link_reassign_clear():
    ...
    if hasattr(b1, 'UML2_Classifier76'):
        assert _is_linked(b1, 'UML2_Classifier76', a)
    _safe_set(a, 'UML2_Feature77', b2)
    assert _is_linked(a, 'UML2_Feature77', b2)
    if hasattr(b1, 'UML2_Classifier76'):
        assert not _is_linked(b1, 'UML2_Classifier76', a)
    if hasattr(b2, 'UML2_Classifier76'):
        assert _is_linked(b2, 'UML2_Classifier76', a)
    _safe_set(a, 'UML2_Feature77', None)
    assert not _is_linked(a, 'UML2_Feature77', b2)
    if hasattr(b2, 'UML2_Classifier76'):
        assert not _is_linked(b2, 'UML2_Classifier76', a)


def test_assoc_featuringClassifier45_link_reassign_clear():
    a = UML2_Feature(isStatic=True)
    b1 = UML2_Classifier(isAbstract=True)
    b2 = UML2_Classifier(isAbstract=False)
    _safe_set(a, 'UML2_Feature', {b1})
    assert _is_linked(a, 'UML2_Feature', b1)
    if hasattr(b1, 'UML2_Classifier46'):
        assert _is_linked(b1, 'UML2_Classifier46', a)
    _safe_set(a, 'UML2_Feature', {b2})
    assert _is_linked(a, 'UML2_Feature', b2)
    if hasattr(b1, 'UML2_Classifier46'):
        assert not _is_linked(b1, 'UML2_Classifier46', a)
    if hasattr(b2, 'UML2_Classifier46'):
        assert _is_linked(b2, 'UML2_Classifier46', a)
    _safe_set(a, 'UML2_Feature', set())
    assert not _is_linked(a, 'UML2_Feature', b2)
    if hasattr(b2, 'UML2_Classifier46'):
        assert not _is_linked(b2, 'UML2_Classifier46', a)


def test_assoc_general20_link_reassign_clear():
    a = UML2_Classifier(isAbstract=True)
    b1 = UML2_Generalization()
    b2 = UML2_Generalization()
    _safe_set(a, 'UML2_Classifier21', b1)
    assert _is_linked(a, 'UML2_Classifier21', b1)
    if hasattr(b1, 'UML2_Generalization'):
        assert _is_linked(b1, 'UML2_Generalization', a)
    _safe_set(a, 'UML2_Classifier21', b2)
    assert _is_linked(a, 'UML2_Classifier21', b2)
    if hasattr(b1, 'UML2_Generalization'):
    ...
    _safe_set(a, 'UML2_Classifier21', None)
    assert not _is_linked(a, 'UML2_Classifier21', b2)
    if hasattr(b2, 'UML2_Generalization'):
        assert not _is_linked(b2, 'UML2_Generalization', a)


def test_assoc_generalization81_link_reassign_clear():
    a = UML2_Classifier(isAbstract=True)
    b1 = UML2_Generalization()
    b2 = UML2_Generalization()
    _safe_set(a, 'UML2_Classifier82', {b1})
    assert _is_linked(a, 'UML2_Classifier82', b1)
    if hasattr(b1, 'UML2_Generalization83'):
        assert _is_linked(b1, 'UML2_Generalization83', a)
    _safe_set(a, 'UML2_Classifier82', {b2})
    assert _is_linked(a, 'UML2_Classifier82', b2)
    if hasattr(b1, 'UML2_Generalization83'):
        assert not _is_linked(b1, 'UML2_Generalization83', a)
    if hasattr(b2, 'UML2_Generalization83'):
        assert _is_linked(b2, 'UML2_Generalization83', a)
    _safe_set(a, 'UML2_Classifier82', set())
    assert not _is_linked(a, 'UML2_Classifier82', b2)
    if hasattr(b2, 'UML2_Generalization83'):
        assert not _is_linked(b2, 'UML2_Generalization83', a)


def test_assoc_importedElement59_link_reassign_clear():
...
def test_assoc_inheritedMember78_link_reassign_clear():
    a = UML2_NamedElement(name="sample_text", visibility="sample_text")
    b1 = UML2_Classifier(isAbstract=True)
    b2 = UML2_Classifier(isAbstract=False)
    _safe_set(a, 'UML2_NamedElement80', b1)
    assert _is_linked(a, 'UML2_NamedElement80', b1)
    if hasattr(b1, 'UML2_Classifier79'):
        assert _is_linked(b1, 'UML2_Classifier79', a)
    _safe_set(a, 'UML2_NamedElement80', b2)
    assert _is_linked(a, 'UML2_NamedElement80', b2)
    if hasattr(b1, 'UML2_Classifier79'):
        assert not _is_linked(b1, 'UML2_Classifier79', a)
    if hasattr(b2, 'UML2_Classifier79'):
        assert _is_linked(b2, 'UML2_Classifier79', a)
    _safe_set(a, 'UML2_NamedElement80', None)
    assert not _is_linked(a, 'UML2_NamedElement80', b2)
    if hasattr(b2, 'UML2_Classifier79'):
        assert not _is_linked(b2, 'UML2_Classifier79', a)


def test_assoc_member69_link_reassign_clear():
    a = UML2_NamedElement(name="sample_text", visibility="sample_text")
    b1 = UML2_Namespace()
    b2 = UML2_Namespace()
...
def test_assoc_memberEnd50_link_reassign_clear():
    ...
    b1 = UML2_Association()
    b2 = UML2_Association()
    _safe_set(a, 'UML2_Property52', b1)
    assert _is_linked(a, 'UML2_Property52', b1)
    if hasattr(b1, 'UML2_Association51'):
        assert _is_linked(b1, 'UML2_Association51', a)
    _safe_set(a, 'UML2_Property52', b2)
    assert _is_linked(a, 'UML2_Property52', b2)
    if hasattr(b1, 'UML2_Association51'):
        assert not _is_linked(b1, 'UML2_Association51', a)
    if hasattr(b2, 'UML2_Association51'):
        assert _is_linked(b2, 'UML2_Association51', a)
    _safe_set(a, 'UML2_Property52', None)
    assert not _is_linked(a, 'UML2_Property52', b2)
    if hasattr(b2, 'UML2_Association51'):
        assert not _is_linked(b2, 'UML2_Association51', a)


def test_assoc_nestedClassifier22_link_reassign_clear():
    a = UML2_Classifier(isAbstract=True)
    b1 = UML2_Class(isActive=True)
    b2 = UML2_Class(isActive=False)
    _safe_set(a, 'UML2_Classifier23', b1)
    assert _is_linked(a, 'UML2_Classifier23', b1)
    if hasattr(b1, 'UML2_Class'):
        assert _is_linked(b1, 'UML2_Class', a)
    _safe_set(a, 'UML2_Classifier23', b2)
    assert _is_linked(a, 'UML2_Classifier23', b2)
    if hasattr(b1, 'UML2_Class'):
        assert not _is_linked(b1, 'UML2_Class', a)
    if hasattr(b2, 'UML2_Class'):
        assert _is_linked(b2, 'UML2_Class', a)
    _safe_set(a, 'UML2_Classifier23', None)
    assert not _is_linked(a, 'UML2_Classifier23', b2)
    if hasattr(b2, 'UML2_Class'):
        assert not _is_linked(b2, 'UML2_Class', a)


def test_assoc_ownedEnd47_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b1 = UML2_Association()
    b2 = UML2_Association()
    _safe_set(a, 'UML2_Property49', b1)
    assert _is_linked(a, 'UML2_Property49', b1)
    if hasattr(b1, 'UML2_Association48'):
        assert _is_linked(b1, 'UML2_Association48', a)
    _safe_set(a, 'UML2_Property49', b2)
    assert _is_linked(a, 'UML2_Property49', b2)
    if hasattr(b1, 'UML2_Association48'):
        assert not _is_linked(b1, 'UML2_Association48', a)
    if hasattr(b2, 'UML2_Association48'):
        assert _is_linked(b2, 'UML2_Association48', a)
    _safe_set(a, 'UML2_Property49', None)
    assert not _is_linked(a, 'UML2_Property49', b2)
    if hasattr(b2, 'UML2_Association48'):
        assert not _is_linked(b2, 'UML2_Association48', a)


def test_assoc_ownedParameter37_link_reassign_clear():
...
def test_assoc_ownedReception24_link_reassign_clear():
    a = UML2_Class(isActive=True)
    b1 = UML2_Reception()
    b2 = UML2_Reception()
    _safe_set(a, 'UML2_Class25', {b1})
    assert _is_linked(a, 'UML2_Class25', b1)
    if hasattr(b1, 'UML2_Reception'):
        assert _is_linked(b1, 'UML2_Reception', a)
    _safe_set(a, 'UML2_Class25', {b2})
    assert _is_linked(a, 'UML2_Class25', b2)
    if hasattr(b1, 'UML2_Reception'):
        assert not _is_linked(b1, 'UML2_Reception', a)
    if hasattr(b2, 'UML2_Reception'):
        assert _is_linked(b2, 'UML2_Reception', a)
    _safe_set(a, 'UML2_Class25', set())
    assert not _is_linked(a, 'UML2_Class25', b2)
    if hasattr(b2, 'UML2_Reception'):
...
def test_assoc_qualifier32_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b1 = UML2_QualifierValue()
    b2 = UML2_QualifierValue()
    _safe_set(a, 'UML2_Property34', b1)
    assert _is_linked(a, 'UML2_Property34', b1)
    if hasattr(b1, 'UML2_QualifierValue33'):
        assert _is_linked(b1, 'UML2_QualifierValue33', a)
    _safe_set(a, 'UML2_Property34', b2)
    assert _is_linked(a, 'UML2_Property34', b2)
    if hasattr(b1, 'UML2_QualifierValue33'):
        assert not _is_linked(b1, 'UML2_QualifierValue33', a)
    if hasattr(b2, 'UML2_QualifierValue33'):
        assert _is_linked(b2, 'UML2_QualifierValue33', a)
    _safe_set(a, 'UML2_Property34', None)
    assert not _is_linked(a, 'UML2_Property34', b2)
    if hasattr(b2, 'UML2_QualifierValue33'):
        assert not _is_linked(b2, 'UML2_QualifierValue33', a)


def test_assoc_structuralFeature5_link_reassign_clear():
    a = UML2_StructuralFeature(isReadOnly=True)
...
def test_assoc_subsettedProperty11_link_reassign_clear():
    a = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b1 = UML2_Property(aggregation="sample_text", isComposite=True, isDerived=True, isDerivedUnion=True)
    b2 = UML2_Property(aggregation="sample_text_2", isComposite=False, isDerived=False, isDerivedUnion=False)
    _safe_set(a, 'UML2_Property', b1)
    assert _is_linked(a, 'UML2_Property', b1)
    if hasattr(b1, 'UML2_Property10'):
        assert _is_linked(b1, 'UML2_Property10', a)
    _safe_set(a, 'UML2_Property', b2)
    assert _is_linked(a, 'UML2_Property', b2)
    if hasattr(b1, 'UML2_Property10'):
        assert not _is_linked(b1, 'UML2_Property10', a)
    if hasattr(b2, 'UML2_Property10'):
        assert _is_linked(b2, 'UML2_Property10', a)
    _safe_set(a, 'UML2_Property', None)
    assert not _is_linked(a, 'UML2_Property', b2)
    if hasattr(b2, 'UML2_Property10'):
        assert not _is_linked(b2, 'UML2_Property10', a)
