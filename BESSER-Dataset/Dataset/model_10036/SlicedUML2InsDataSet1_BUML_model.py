...
# Classes
UML2_ProtocolConformance = Class(name="UML2_ProtocolConformance")
DirectedRelationship = Class(name="DirectedRelationship")
UML2_ActivityNode = Class(name="UML2_ActivityNode")
RedefinableElement = Class(name="RedefinableElement")
UML2_Vertex = Class(name="UML2_Vertex")
NamedElement = Class(name="NamedElement")
UML2_CreateObjectAction = Class(name="UML2_CreateObjectAction")
Action = Class(name="Action")
UML2_StructuralFeatureAction = Class(name="UML2_StructuralFeatureAction")
UML2_StructuralFeature = Class(name="UML2_StructuralFeature")
UML2_TimeConstraint = Class(name="UML2_TimeConstraint")
IntervalConstraint = Class(name="IntervalConstraint")
UML2_Abstraction = Class(name="UML2_Abstraction")
Dependency = Class(name="Dependency")
UML2_CentralBufferNode = Class(name="UML2_CentralBufferNode")
ObjectNode = Class(name="ObjectNode")
UML2_ObjectFlow = Class(name="UML2_ObjectFlow")
ActivityEdge = Class(name="ActivityEdge")
UML2_ParameterSet = Class(name="UML2_ParameterSet")
UML2_TemplateParameter = Class(name="UML2_TemplateParameter")
Element = Class(name="Element")
UML2_PackageMerge = Class(name="UML2_PackageMerge")
UML2_Deployment = Class(name="UML2_Deployment")
UML2_RedefinableTemplateSignature = Class(name="UML2_RedefinableTemplateSignature")
TemplateSignature = Class(name="TemplateSignature")
UML2_Message = Class(name="UML2_Message")
UML2_ForkNode = Class(name="UML2_ForkNode")
ControlNode = Class(name="ControlNode")
UML2_ClassifierTemplateParameter = Class(name="UML2_ClassifierTemplateParameter")
TemplateParameter = Class(name="TemplateParameter")
UML2_Port = Class(name="UML2_Port")
Property_ = Class(name="Property")
UML2_InvocationAction = Class(name="UML2_InvocationAction")
UML2_Classifier = Class(name="UML2_Classifier")
UML2_OutputPin = Class(name="UML2_OutputPin")
UML2_LiteralNull = Class(name="UML2_LiteralNull")
LiteralSpecification = Class(name="LiteralSpecification")
UML2_DataStoreNode = Class(name="UML2_DataStoreNode")
CentralBufferNode = Class(name="CentralBufferNode")
UML2_ActivityEdge = Class(name="UML2_ActivityEdge")
UML2_ConditionalNode = Class(name="UML2_ConditionalNode")
StructuredActivityNode = Class(name="StructuredActivityNode")
UML2_Element = Class(name="UML2_Element")
UML2_SendObjectAction = Class(name="UML2_SendObjectAction")
InvocationAction = Class(name="InvocationAction")
UML2_BehavioralFeature = Class(name="UML2_BehavioralFeature")
Namespace = Class(name="Namespace")
UML2_TimeInterval = Class(name="UML2_TimeInterval")
Interval = Class(name="Interval")
UML2_RemoveStructuralFeatureValueAction = Class(name="UML2_RemoveStructuralFeatureValueAction")
WriteStructuralFeatureAction = Class(name="WriteStructuralFeatureAction")
UML2_OperationTemplateParameter = Class(name="UML2_OperationTemplateParameter")
UML2_Connector = Class(name="UML2_Connector")
UML2_StateInvariant = Class(name="UML2_StateInvariant")
InteractionFragment = Class(name="InteractionFragment")
UML2_AddVariableValueAction = Class(name="UML2_AddVariableValueAction")
WriteVariableAction = Class(name="WriteVariableAction")
UML2_CallBehaviorAction = Class(name="UML2_CallBehaviorAction")
CallAction = Class(name="CallAction")
UML2_ExtensionEnd = Class(name="UML2_ExtensionEnd")
UML2_BroadcastSignalAction = Class(name="UML2_BroadcastSignalAction")
UML2_CommunicationPath = Class(name="UML2_CommunicationPath")
Association = Class(name="Association")
UML2_WriteLinkAction = Class(name="UML2_WriteLinkAction")
LinkAction = Class(name="LinkAction")
UML2_Extend = Class(name="UML2_Extend")
UML2_AcceptEventAction = Class(name="UML2_AcceptEventAction")
UML2_FlowFinalNode = Class(name="UML2_FlowFinalNode")
FinalNode = Class(name="FinalNode")
Feature = Class(name="Feature")
TypedElement = Class(name="TypedElement")
MultiplicityElement = Class(name="MultiplicityElement")
UML2_CollaborationOccurrence = Class(name="UML2_CollaborationOccurrence")
UML2_Interface = Class(name="UML2_Interface")
Classifier = Class(name="Classifier")
UML2_LiteralInteger = Class(name="UML2_LiteralInteger")
UML2_LoopNode = Class(name="UML2_LoopNode")
UML2_PrimitiveFunction = Class(name="UML2_PrimitiveFunction")
UML2_Lifeline = Class(name="UML2_Lifeline")
UML2_CallAction = Class(name="UML2_CallAction")
UML2_Manifestation = Class(name="UML2_Manifestation")
Abstraction = Class(name="Abstraction")
UML2_BehavioredClassifier = Class(name="UML2_BehavioredClassifier")
UML2_Behavior = Class(name="UML2_Behavior")
UML2_WriteVariableAction = Class(name="UML2_WriteVariableAction")
VariableAction = Class(name="VariableAction")
UML2_ReadExtentAction = Class(name="UML2_ReadExtentAction")
UML2_Property = Class(name="UML2_Property")
StructuralFeature = Class(name="StructuralFeature")
ConnectableElement = Class(name="ConnectableElement")
DeploymentTarget = Class(name="DeploymentTarget")
UML2_Association = Class(name="UML2_Association")
UML2_CreateLinkObjectAction = Class(name="UML2_CreateLinkObjectAction")
CreateLinkAction = Class(name="CreateLinkAction")
UML2_LiteralBoolean = Class(name="UML2_LiteralBoolean")
UML2_DestroyLinkAction = Class(name="UML2_DestroyLinkAction")
WriteLinkAction = Class(name="WriteLinkAction")
UML2_StartOwnedBehaviorAction = Class(name="UML2_StartOwnedBehaviorAction")
UML2_Continuation = Class(name="UML2_Continuation")
UML2_ReplyAction = Class(name="UML2_ReplyAction")
UML2_ValueSpecification = Class(name="UML2_ValueSpecification")
ParameterableElement = Class(name="ParameterableElement")
UML2_InteractionOperand = Class(name="UML2_InteractionOperand")
UML2_Package = Class(name="UML2_Package")
PackageableElement = Class(name="PackageableElement")
UML2_MessageEnd = Class(name="UML2_MessageEnd")
UML2_StringExpression = Class(name="UML2_StringExpression")
TemplateableElement = Class(name="TemplateableElement")
UML2_PackageableElement = Class(name="UML2_PackageableElement")
UML2_TypedElement = Class(name="UML2_TypedElement")
UML2_Type = Class(name="UML2_Type")
Pin = Class(name="Pin")
UML2_GeneralOrdering = Class(name="UML2_GeneralOrdering")
UML2_DecisionNode = Class(name="UML2_DecisionNode")
UML2_InputPin = Class(name="UML2_InputPin")
UML2_AddStructuralFeatureValueAction = Class(name="UML2_AddStructuralFeatureValueAction")
UML2_Generalization = Class(name="UML2_Generalization")
UML2_ClearVariableAction = Class(name="UML2_ClearVariableAction")
UML2_Class = Class(name="UML2_Class")
BehavioredClassifier = Class(name="BehavioredClassifier")
EncapsulatedClassifier = Class(name="EncapsulatedClassifier")
UML2_Reception = Class(name="UML2_Reception")
UML2_ReadSelfAction = Class(name="UML2_ReadSelfAction")
UML2_EventOccurrence = Class(name="UML2_EventOccurrence")
MessageEnd = Class(name="MessageEnd")
UML2_TimeObservationAction = Class(name="UML2_TimeObservationAction")
UML2_InteractionFragment = Class(name="UML2_InteractionFragment")
UML2_Variable = Class(name="UML2_Variable")
UML2_LinkEndData = Class(name="UML2_LinkEndData")
UML2_QualifierValue = Class(name="UML2_QualifierValue")
UML2_Interval = Class(name="UML2_Interval")
ValueSpecification = Class(name="ValueSpecification")
UML2_Pin = Class(name="UML2_Pin")
UML2_Node = Class(name="UML2_Node")
UML2_PartDecomposition = Class(name="UML2_PartDecomposition")
InteractionOccurrence = Class(name="InteractionOccurrence")
UML2_Model = Class(name="UML2_Model")
Package = Class(name="Package")
UML2_CombinedFragment = Class(name="UML2_CombinedFragment")
UML2_SignalTrigger = Class(name="UML2_SignalTrigger")
MessageTrigger = Class(name="MessageTrigger")
UML2_InteractionConstraint = Class(name="UML2_InteractionConstraint")
Constraint_ = Class(name="Constraint_")
UML2_Artifact = Class(name="UML2_Artifact")
DeployedArtifact = Class(name="DeployedArtifact")
UML2_EncapsulatedClassifier = Class(name="UML2_EncapsulatedClassifier")
StructuredClassifier = Class(name="StructuredClassifier")
UML2_RemoveVariableValueAction = Class(name="UML2_RemoveVariableValueAction")
UML2_ExpansionRegion = Class(name="UML2_ExpansionRegion")
UML2_StructuredClassifier = Class(name="UML2_StructuredClassifier")
UML2_Extension = Class(name="UML2_Extension")
UML2_Component = Class(name="UML2_Component")
Class_ = Class(name="Class")
UML2_MessageTrigger = Class(name="UML2_MessageTrigger")
Trigger = Class(name="Trigger")
UML2_DeploymentSpecification = Class(name="UML2_DeploymentSpecification")
Artifact = Class(name="Artifact")
UML2_Gate = Class(name="UML2_Gate")
UML2_Duration = Class(name="UML2_Duration")
UML2_ReclassifyObjectAction = Class(name="UML2_ReclassifyObjectAction")
UML2_Substitution = Class(name="UML2_Substitution")
Realization = Class(name="Realization")
UML2_CreateLinkAction = Class(name="UML2_CreateLinkAction")
UML2_Operation = Class(name="UML2_Operation")
BehavioralFeature = Class(name="BehavioralFeature")
UML2_Parameter = Class(name="UML2_Parameter")
UML2_Constraint = Class(name="UML2_Constraint")
UML2_ClearStructuralFeatureAction = Class(name="UML2_ClearStructuralFeatureAction")
StructuralFeatureAction = Class(name="StructuralFeatureAction")
UML2_LinkEndCreationData = Class(name="UML2_LinkEndCreationData")
LinkEndData = Class(name="LinkEndData")
UML2_TestIdentityAction = Class(name="UML2_TestIdentityAction")
UML2_EnumerationLiteral = Class(name="UML2_EnumerationLiteral")
InstanceSpecification = Class(name="InstanceSpecification")
UML2_DurationConstraint = Class(name="UML2_DurationConstraint")
UML2_Usage = Class(name="UML2_Usage")
UML2_Profile = Class(name="UML2_Profile")
UML2_TemplateableClassifier = Class(name="UML2_TemplateableClassifier")
UML2_PackageImport = Class(name="UML2_PackageImport")
UML2_OpaqueExpression = Class(name="UML2_OpaqueExpression")
UML2_ParameterableClassifier = Class(name="UML2_ParameterableClassifier")
UML2_ApplyFunctionAction = Class(name="UML2_ApplyFunctionAction")
UML2_LiteralString = Class(name="UML2_LiteralString")
UML2_Transition = Class(name="UML2_Transition")
UML2_Feature = Class(name="UML2_Feature")
UML2_StructuredActivityNode = Class(name="UML2_StructuredActivityNode")
ActivityGroup = Class(name="ActivityGroup")
UML2_IntervalConstraint = Class(name="UML2_IntervalConstraint")
UML2_Signal = Class(name="UML2_Signal")
UML2_ConnectionPointReference = Class(name="UML2_ConnectionPointReference")
Vertex = Class(name="Vertex")
UML2_ValuePin = Class(name="UML2_ValuePin")
InputPin = Class(name="InputPin")
UML2_DurationInterval = Class(name="UML2_DurationInterval")
UML2_ReadLinkAction = Class(name="UML2_ReadLinkAction")
UML2_ReadIsClassifiedObjectAction = Class(name="UML2_ReadIsClassifiedObjectAction")
UML2_VariableAction = Class(name="UML2_VariableAction")
UML2_RaiseExceptionAction = Class(name="UML2_RaiseExceptionAction")
UML2_ExecutionOccurrence = Class(name="UML2_ExecutionOccurrence")
UML2_Realization = Class(name="UML2_Realization")
UML2_TemplateSignature = Class(name="UML2_TemplateSignature")
UML2_TimeExpression = Class(name="UML2_TimeExpression")
UML2_ExtensionPoint = Class(name="UML2_ExtensionPoint")
UML2_LiteralUnlimitedNatural = Class(name="UML2_LiteralUnlimitedNatural")
UML2_Collaboration = Class(name="UML2_Collaboration")
UML2_ProtocolStateMachine = Class(name="UML2_ProtocolStateMachine")
StateMachine = Class(name="StateMachine")
UML2_ExpansionNode = Class(name="UML2_ExpansionNode")
UML2_InformationFlow = Class(name="UML2_InformationFlow")
UML2_CallOperationAction = Class(name="UML2_CallOperationAction")
UML2_AcceptCallAction = Class(name="UML2_AcceptCallAction")
AcceptEventAction = Class(name="AcceptEventAction")
UML2_LinkAction = Class(name="UML2_LinkAction")
UML2_DirectedRelationship = Class(name="UML2_DirectedRelationship")
UML2_SendSignalAction = Class(name="UML2_SendSignalAction")
UML2_Clause = Class(name="UML2_Clause")
UML2_FinalNode = Class(name="UML2_FinalNode")
UML2_Dependency = Class(name="UML2_Dependency")
UML2_ControlNode = Class(name="UML2_ControlNode")
ActivityNode = Class(name="ActivityNode")
UML2_Expression = Class(name="UML2_Expression")
OpaqueExpression = Class(name="OpaqueExpression")
UML2_Action = Class(name="UML2_Action")
ExecutableNode = Class(name="ExecutableNode")
UML2_ReadLinkObjectEndQualifierAction = Class(name="UML2_ReadLinkObjectEndQualifierAction")
UML2_JoinNode = Class(name="UML2_JoinNode")
UML2_InstanceValue = Class(name="UML2_InstanceValue")
UML2_TimeTrigger = Class(name="UML2_TimeTrigger")
Relationship = Class(name="Relationship")
UML2_FinalState = Class(name="UML2_FinalState")
State = Class(name="State")
UML2_Stop = Class(name="UML2_Stop")
EventOccurrence = Class(name="EventOccurrence")
UML2_DeploymentTarget = Class(name="UML2_DeploymentTarget")
UML2_TemplateBinding = Class(name="UML2_TemplateBinding")
UML2_CallTrigger = Class(name="UML2_CallTrigger")
UML2_InformationItem = Class(name="UML2_InformationItem")
UML2_ExecutableNode = Class(name="UML2_ExecutableNode")
UML2_ConnectableElementTemplateParameter = Class(name="UML2_ConnectableElementTemplateParameter")
UML2_Interaction = Class(name="UML2_Interaction")
UML2_GeneralizationSet = Class(name="UML2_GeneralizationSet")
UML2_InteractionOccurrence = Class(name="UML2_InteractionOccurrence")
UML2_MultiplicityElement = Class(name="UML2_MultiplicityElement")
UML2_MergeNode = Class(name="UML2_MergeNode")
UML2_WriteStructuralFeatureAction = Class(name="UML2_WriteStructuralFeatureAction")
UML2_Relationship = Class(name="UML2_Relationship")
UML2_Include = Class(name="UML2_Include")
UML2_NamedElement = Class(name="UML2_NamedElement")
UML2_Activity = Class(name="UML2_Activity")
Behavior = Class(name="Behavior")
UML2_ElementImport = Class(name="UML2_ElementImport")
UML2_ReadLinkObjectEndAction = Class(name="UML2_ReadLinkObjectEndAction")
UML2_DeployedArtifact = Class(name="UML2_DeployedArtifact")
UML2_Device = Class(name="UML2_Device")
Node = Class(name="Node")
UML2_ChangeTrigger = Class(name="UML2_ChangeTrigger")
UML2_State = Class(name="UML2_State")
UML2_ParameterableElement = Class(name="UML2_ParameterableElement")
UML2_Namespace = Class(name="UML2_Namespace")
UML2_TemplateableElement = Class(name="UML2_TemplateableElement")
UML2_InstanceSpecification = Class(name="UML2_InstanceSpecification")
UML2_Enumeration = Class(name="UML2_Enumeration")
DataType = Class(name="DataType")
UML2_TemplateParameterSubstitution = Class(name="UML2_TemplateParameterSubstitution")
UML2_ActivityParameterNode = Class(name="UML2_ActivityParameterNode")
UML2_ActivityGroup = Class(name="UML2_ActivityGroup")
UML2_Actor = Class(name="UML2_Actor")
UML2_AnyTrigger = Class(name="UML2_AnyTrigger")
UML2_DataType = Class(name="UML2_DataType")
UML2_Slot = Class(name="UML2_Slot")
UML2_Implementation = Class(name="UML2_Implementation")
Type = Class(name="Type")
UML2_ClearAssociationAction = Class(name="UML2_ClearAssociationAction")
UML2_ProtocolTransition = Class(name="UML2_ProtocolTransition")
Transition = Class(name="Transition")
UML2_ControlFlow = Class(name="UML2_ControlFlow")
UML2_Region = Class(name="UML2_Region")
UML2_Stereotype = Class(name="UML2_Stereotype")
UML2_PrimitiveType = Class(name="UML2_PrimitiveType")
UML2_ReadVariableAction = Class(name="UML2_ReadVariableAction")
UML2_ConnectableElement = Class(name="UML2_ConnectableElement")
UML2_Comment = Class(name="UML2_Comment")
UML2_ProfileApplication = Class(name="UML2_ProfileApplication")
PackageImport = Class(name="PackageImport")
UML2_DurationObservationAction = Class(name="UML2_DurationObservationAction")
UML2_ReadStructuralFeatureAction = Class(name="UML2_ReadStructuralFeatureAction")
UML2_ExecutionEnvironment = Class(name="UML2_ExecutionEnvironment")
UML2_Permission = Class(name="UML2_Permission")
UML2_InterruptibleActivityRegion = Class(name="UML2_InterruptibleActivityRegion")
UML2_ActivityPartition = Class(name="UML2_ActivityPartition")
UML2_AssociationClass = Class(name="UML2_AssociationClass")
UML2_ActivityFinalNode = Class(name="UML2_ActivityFinalNode")
UML2_ConnectorEnd = Class(name="UML2_ConnectorEnd")
UML2_Pseudostate = Class(name="UML2_Pseudostate")
UML2_ObjectNode = Class(name="UML2_ObjectNode")
UML2_DestroyObjectAction = Class(name="UML2_DestroyObjectAction")
UML2_LiteralSpecification = Class(name="UML2_LiteralSpecification")
UML2_StateMachine = Class(name="UML2_StateMachine")
UML2_UseCase = Class(name="UML2_UseCase")
UML2_Trigger = Class(name="UML2_Trigger")
UML2_ExceptionHandler = Class(name="UML2_ExceptionHandler")
UML2_RedefinableElement = Class(name="UML2_RedefinableElement")
UML2_InitialNode = Class(name="UML2_InitialNode")
...
UML2_Property.attributes={UML2_Property_isDerivedUnion, UML2_Property_aggregation, UML2_Property_isComposite, UML2_Property_isDerived}
...
gen_UML2_InteractionConstraint_Constraint = Generalization(general=Constraint_, specific=UML2_InteractionConstraint)
...
gen_UML2_IntervalConstraint_Constraint = Generalization(general=Constraint_, specific=UML2_IntervalConstraint)
...
# OCL Constraints
sfa1: Constraint = Constraint(
    name="sfa1",
    context=UML2_StructuralFeatureAction,
    expression="context StructuralFeatureAction inv: not self.structuralFeature.isStatic",
    language="OCL"
)
visibilityValid: Constraint = Constraint(
    name="visibilityValid",
    context=UML2_ElementImport,
    expression="context ElementImport inv: self.visibility = VisibilityKind_public or self.visibility = VisibilityKind_private",
    language="OCL"
)
sameGeneralClassifier: Constraint = Constraint(
    name="sameGeneralClassifier",
    context=UML2_GeneralizationSet,
    expression="context GeneralizationSet inv: self.generalization.general->asSet()->size() <= 1",
    language="OCL"
)
derivedUnionIsReadOnly: Constraint = Constraint(
    name="derivedUnionIsReadOnly",
    context=UML2_Property,
    expression="context Property inv: self.isDerivedUnion implies self.isReadOnly",
    language="OCL"
)
led2: Constraint = Constraint(
    name="led2",
    context=UML2_LinkEndData,
    expression="context LinkEndData inv: self.value.type = self.end.type",
    language="OCL"
)
isUniqueIsValid: Constraint = Constraint(
    name="isUniqueIsValid",
    context=UML2_OperationTemplateParameter,
    expression="context Operation inv: self.isUnique = ( if self.ownedParameter->select(par | par.direction = ParameterDirectionKind_return)->asSet()->notEmpty() then self.ownedParameter->select(par | par.direction = ParameterDirectionKind_return)->asSet()->any(true).isUnique else true endif)",
    language="OCL"
)
specializedAssociationsHasSameNumberOfEnds: Constraint = Constraint(
    name="specializedAssociationsHasSameNumberOfEnds",
    context=UML2_Association,
    expression="context Association inv: self.generalization.general->asSet()->forAll(p : Classifier | p.oclAsType(Association).memberEnd->size() = self.memberEnd->size())",
    language="OCL"
)
notConstrainingSelf: Constraint = Constraint(
    name="notConstrainingSelf",
    context=UML2_Constraint,
    expression="context Constraint inv: self.constrainedElement->excludes(self)",
    language="OCL"
)
bodyConditionOnlyIfIsQuery: Constraint = Constraint(
    name="bodyConditionOnlyIfIsQuery",
    context=UML2_OperationTemplateParameter,
    expression="context Operation inv: self.bodyCondition->notEmpty() implies self.isQuery",
    language="OCL"
)
rsa1: Constraint = Constraint(
    name="rsa1",
    context=UML2_ReadSelfAction,
    expression="context ReadSelfAction inv: self.context_->size() = 1",
    language="OCL"
)
noNestedClassifiers: Constraint = Constraint(
    name="noNestedClassifiers",
    context=UML2_Component,
    expression="context Component inv: self.nestedClassifier->isEmpty()",
    language="OCL"
)
coa1: Constraint = Constraint(
    name="coa1",
    context=UML2_CreateObjectAction,
    expression="context CreateObjectAction inv: not self.classifier.isAbstract",
    language="OCL"
)
onlyBinaryAssociationCanBeAggregations: Constraint = Constraint(
    name="onlyBinaryAssociationCanBeAggregations",
    context=UML2_Association,
    expression="context Association inv: self.memberEnd->exists(temp1:Property | temp1.aggregation <> AggregationKind_none) implies self.memberEnd->size() = 2",
    language="OCL"
)
oe1: Constraint = Constraint(
    name="oe1",
    context=UML2_OpaqueExpression,
    expression="context OpaqueExpression inv: self.behavior->notEmpty() implies (self.behavior.ownedParameterSet->select( p : Parameter | p.direction <> ParameterDirectionKind_return)->isEmpty())",
    language="OCL"
)
oe2: Constraint = Constraint(
    name="oe2",
    context=UML2_OpaqueExpression,
    expression="context OpaqueExpression inv: self.behavior->notEmpty() implies (self.behavior.ownedParameterSet->select( p : Parameter | p.direction = ParameterDirectionKind_return)->size() = 1)",
    language="OCL"
)
isCompositeIsValid: Constraint = Constraint(
    name="isCompositeIsValid",
    context=UML2_Property,
    expression="context Property inv: self.isComposite = (self.aggregation = AggregationKind_composite)",
    language="OCL"
)
oneStructuralFeatureDefinesAtMostOneSlotPerInstance: Constraint = Constraint(
    name="oneStructuralFeatureDefinesAtMostOneSlotPerInstance",
    context=UML2_InstanceSpecification,
    expression="context InstanceSpecification inv: self.classifier->forAll(c:Classifier| c.member->select(oclIsKindOf(Feature)).oclAsType(Feature)->asSet()->forAll(f:Feature| self.slot->select(s:Slot |  s.definingFeature = f)->size() <= 1))",
    language="OCL"
)
isAbstractDefined: Constraint = Constraint(
    name="isAbstractDefined",
    context=UML2_Classifier,
    expression="context Classifier inv: not self.isAbstract.oclIsUndefined()",
    language="OCL"
)
nAryAssociationsOwnTheirEnds: Constraint = Constraint(
    name="nAryAssociationsOwnTheirEnds",
    context=UML2_Association,
    expression="context Association inv: if self.memberEnd->size() > 2then self.ownedEnd->includesAll(self.memberEnd) else true endif",
    language="OCL"
)
coa3: Constraint = Constraint(
    name="coa3",
    context=UML2_CreateObjectAction,
    expression="context CreateObjectAction inv: self.result.type = self.classifier",
    language="OCL"
)
mustBeOwnedHasOwner: Constraint = Constraint(
    name="mustBeOwnedHasOwner",
    context=UML2_Element,
    expression="context Element inv: self.owner->notEmpty()",
    language="OCL"
)
bc1: Constraint = Constraint(
    name="bc1",
    context=UML2_BehavioredClassifier,
    expression="context BehavioredClassifier inv: not self.classifierBehavior.oclIsUndefined() implies self.ownedBehavior->forAll(temp1 : Behavior | temp1.specification.oclIsUndefined())",
    language="OCL"
)
subsetRequiresDifferentName: Constraint = Constraint(
    name="subsetRequiresDifferentName",
    context=UML2_Property,
    expression="context Property inv: self.subsettedProperty->notEmpty() implies self.subsettedProperty->forAll(sp: Property | sp.name <> self.name)",
    language="OCL"
)
coa2: Constraint = Constraint(
    name="coa2",
    context=UML2_CreateObjectAction,
    expression="context CreateObjectAction inv: not self.classifier.oclIsKindOf(AssociationClass)",
    language="OCL"
)
interfaceFeaturesArePublic: Constraint = Constraint(
    name="interfaceFeaturesArePublic",
    context=UML2_Interface,
    expression="context Interface inv: self.feature->forAll(f:Feature |  f.visibility = VisibilityKind_public)",
    language="OCL"
)
tia1: Constraint = Constraint(
    name="tia1",
    context=UML2_TestIdentityAction,
    expression="context TestIdentityAction inv: self.first.type->size() = 0 and self.second.type->size() = 0",
    language="OCL"
)
typeIsValid: Constraint = Constraint(
    name="typeIsValid",
    context=UML2_OperationTemplateParameter,
    expression="context Operation inv: self.type = ( if self.ownedParameter->select(par | par.direction = ParameterDirectionKind_return)->asSet()->notEmpty() then self.ownedParameter->select(par | par.direction = ParameterDirectionKind_return)->asSet()->any(true).type else null endif)",
    language="OCL"
)
led3: Constraint = Constraint(
    name="led3",
    context=UML2_LinkEndData,
    expression="context LinkEndData inv: self.qualifier->collect(temp1: QualifierValue | temp1.qualifier) = self.end.qualifier->asBag()",
    language="OCL"
)
doa1: Constraint = Constraint(
    name="doa1",
    context=UML2_DestroyObjectAction,
    expression="context DestroyObjectAction inv: self.target.type->size() = 0",
    language="OCL"
)
packageVisibilityValid: Constraint = Constraint(
    name="packageVisibilityValid",
    context=UML2_PackageImport,
    expression="context PackageImport inv: self.visibility = VisibilityKind_public or self.visibility = VisibilityKind_private",
    language="OCL"
)
sfa2: Constraint = Constraint(
    name="sfa2",
    context=UML2_StructuralFeatureAction,
    expression="context StructuralFeatureAction inv: self.structuralFeature.featuringClassifier->size() = 1",
    language="OCL"
)
inheritedMemberIsValid: Constraint = Constraint(
    name="inheritedMemberIsValid",
    context=UML2_Classifier,
    expression="context Classifier inv: self.inheritedMember->includesAll( self.generalization.general->asSet()->collect(p | p.member->select(m | if self.inheritedMember->includes(m) then m.visibility <> VisibilityKind_private else true endif ) ) )",
    language="OCL"
)
wsfa1: Constraint = Constraint(
    name="wsfa1",
    context=UML2_WriteStructuralFeatureAction,
    expression="context WriteStructuralFeatureAction inv: self.value.type->asSet() = self.structuralFeature.featuringClassifier",
    language="OCL"
)
languageAndBodiesAreValid: Constraint = Constraint(
    name="languageAndBodiesAreValid",
    context=UML2_OpaqueExpression,
    expression="context OpaqueExpression inv: self.language->notEmpty() implies (self.bodies->size() = self.language->size())",
    language="OCL"
)
derivedUnionIsDerived: Constraint = Constraint(
    name="derivedUnionIsDerived",
    context=UML2_Property,
    expression="context Property inv: self.isDerivedUnion implies self.isDerived",
    language="OCL"
)
upperIsValid: Constraint = Constraint(
    name="upperIsValid",
    context=UML2_OperationTemplateParameter,
    expression="context Operation inv: self.upper = ( if self.ownedParameter->select(par | par.direction = ParameterDirectionKind_return)->asSet()->notEmpty() then self.ownedParameter->select(par | par.direction = ParameterDirectionKind_return)->asSet()->any(true).upper else null endif)",
    language="OCL"
)
importedVisibilityValid: Constraint = Constraint(
    name="importedVisibilityValid",
    context=UML2_ElementImport,
    expression="context ElementImport inv: not self.importedElement.visibility.oclIsUndefined() implies self.importedElement.visibility = VisibilityKind_public",
    language="OCL"
)
definingFeaturIsFeatureOfClassifier: Constraint = Constraint(
    name="definingFeaturIsFeatureOfClassifier",
    context=UML2_InstanceSpecification,
    expression="context InstanceSpecification inv: self.slot->forAll(s:Slot | self.classifier->exists(c:Classifier |  c.member->select(oclIsKindOf(Feature)).oclAsType(Feature)->asSet()->includes(s.definingFeature)))",
    language="OCL"
)
class1: Constraint = Constraint(
    name="class1",
    context=UML2_Classifier,
    expression="context Class inv: not self.isActive implies self.ownedReception->isEmpty()",
    language="OCL"
)
isOrderedIsValid: Constraint = Constraint(
    name="isOrderedIsValid",
    context=UML2_OperationTemplateParameter,
    expression="context Operation inv: self.isOrdered = ( if self.ownedParameter->select(par | par.direction = ParameterDirectionKind_return)->asSet()->notEmpty() then self.ownedParameter->select(par | par.direction = ParameterDirectionKind_return)->asSet()->any(true).isOrdered else false endif)",
    language="OCL"
)
led1: Constraint = Constraint(
    name="led1",
    context=UML2_LinkEndData,
    expression="context LinkEndData inv: self.end.association->size() = 1",
    language="OCL"
)
lowerIsValid: Constraint = Constraint(
    name="lowerIsValid",
    context=UML2_OperationTemplateParameter,
    expression="context Operation inv: self.lower = ( if self.ownedParameter->select(par | par.direction = ParameterDirectionKind_return)->asSet()->notEmpty() then self.ownedParameter->select(par | par.direction = ParameterDirectionKind_return)->asSet()->any(true).lower else null endif)",
    language="OCL"
)
operationHasOnlyOneReturnParameter: Constraint = Constraint(
    name="operationHasOnlyOneReturnParameter",
    context=UML2_OperationTemplateParameter,
    expression="context Operation inv: self.ownedParameter->select(par:Parameter | par.direction = ParameterDirectionKind_return)->size() <= 1contextPackage",
    language="OCL"
)
ownedElementHasVisibility: Constraint = Constraint(
    name="ownedElementHasVisibility",
    context=UML2_OperationTemplateParameter,
    expression="context Operation inv: self.member->forAll(e:NamedElement| e.visibility->notEmpty() implies e.visibility = VisibilityKind_public or e.visibility = VisibilityKind_private)",
    language="OCL"
)
rsa2: Constraint = Constraint(
    name="rsa2",
    context=UML2_ReadSelfAction,
    expression="context ReadSelfAction inv: self.result.type = context_",
    language="OCL"
)
...
domain_model = DomainModel(
    name="UML2",
    types={UML2_ProtocolConformance, DirectedRelationship, UML2_ActivityNode, RedefinableElement, UML2_Vertex, NamedElement, UML2_CreateObjectAction, Action, UML2_StructuralFeatureAction, UML2_StructuralFeature, UML2_TimeConstraint, IntervalConstraint, UML2_Abstraction, Dependency, UML2_CentralBufferNode, ObjectNode, UML2_ObjectFlow, ActivityEdge, UML2_ParameterSet, UML2_TemplateParameter, Element, UML2_PackageMerge, UML2_Deployment, UML2_RedefinableTemplateSignature, TemplateSignature, UML2_Message, UML2_ForkNode, ControlNode, UML2_ClassifierTemplateParameter, TemplateParameter, UML2_Port, Property_, UML2_InvocationAction, UML2_Classifier, UML2_OutputPin, UML2_LiteralNull, LiteralSpecification, UML2_DataStoreNode, CentralBufferNode, UML2_ActivityEdge, UML2_ConditionalNode, StructuredActivityNode, UML2_Element, UML2_SendObjectAction, InvocationAction, UML2_BehavioralFeature, Namespace, UML2_TimeInterval, Interval, UML2_RemoveStructuralFeatureValueAction, WriteStructuralFeatureAction, UML2_OperationTemplateParameter, UML2_Connector, UML2_StateInvariant, InteractionFragment, UML2_AddVariableValueAction, WriteVariableAction, UML2_CallBehaviorAction, CallAction, UML2_ExtensionEnd, UML2_BroadcastSignalAction, UML2_CommunicationPath, Association, UML2_WriteLinkAction, LinkAction, UML2_Extend, UML2_AcceptEventAction, UML2_FlowFinalNode, FinalNode, Feature, TypedElement, MultiplicityElement, UML2_CollaborationOccurrence, UML2_Interface, Classifier, UML2_LiteralInteger, UML2_LoopNode, UML2_PrimitiveFunction, UML2_Lifeline, UML2_CallAction, UML2_Manifestation, Abstraction, UML2_BehavioredClassifier, UML2_Behavior, UML2_WriteVariableAction, VariableAction, UML2_ReadExtentAction, UML2_Property, StructuralFeature, ConnectableElement, DeploymentTarget, UML2_Association, UML2_CreateLinkObjectAction, CreateLinkAction, UML2_LiteralBoolean, UML2_DestroyLinkAction, WriteLinkAction, UML2_StartOwnedBehaviorAction, UML2_Continuation, UML2_ReplyAction, UML2_ValueSpecification, ParameterableElement, UML2_InteractionOperand, UML2_Package, PackageableElement, UML2_MessageEnd, UML2_StringExpression, TemplateableElement, UML2_PackageableElement, UML2_TypedElement, UML2_Type, Pin, UML2_GeneralOrdering, UML2_DecisionNode, UML2_InputPin, UML2_AddStructuralFeatureValueAction, UML2_Generalization, UML2_ClearVariableAction, UML2_Class, BehavioredClassifier, EncapsulatedClassifier, UML2_Reception, UML2_ReadSelfAction, UML2_EventOccurrence, MessageEnd, UML2_TimeObservationAction, UML2_InteractionFragment, UML2_Variable, UML2_LinkEndData, UML2_QualifierValue, UML2_Interval, ValueSpecification, UML2_Pin, UML2_Node, UML2_PartDecomposition, InteractionOccurrence, UML2_Model, Package, UML2_CombinedFragment, UML2_SignalTrigger, MessageTrigger, UML2_InteractionConstraint, Constraint_, UML2_Artifact, DeployedArtifact, UML2_EncapsulatedClassifier, StructuredClassifier, UML2_RemoveVariableValueAction, UML2_ExpansionRegion, UML2_StructuredClassifier, UML2_Extension, UML2_Component, Class_, UML2_MessageTrigger, Trigger, UML2_DeploymentSpecification, Artifact, UML2_Gate, UML2_Duration, UML2_ReclassifyObjectAction, UML2_Substitution, Realization, UML2_CreateLinkAction, UML2_Operation, BehavioralFeature, UML2_Parameter, UML2_Constraint, UML2_ClearStructuralFeatureAction, StructuralFeatureAction, UML2_LinkEndCreationData, LinkEndData, UML2_TestIdentityAction, UML2_EnumerationLiteral, InstanceSpecification, UML2_DurationConstraint, UML2_Usage, UML2_Profile, UML2_TemplateableClassifier, UML2_PackageImport, UML2_OpaqueExpression, UML2_ParameterableClassifier, UML2_ApplyFunctionAction, UML2_LiteralString, UML2_Transition, UML2_Feature, UML2_StructuredActivityNode, ActivityGroup, UML2_IntervalConstraint, UML2_Signal, UML2_ConnectionPointReference, Vertex, UML2_ValuePin, InputPin, UML2_DurationInterval, UML2_ReadLinkAction, UML2_ReadIsClassifiedObjectAction, UML2_VariableAction, UML2_RaiseExceptionAction, UML2_ExecutionOccurrence, UML2_Realization, UML2_TemplateSignature, UML2_TimeExpression, UML2_ExtensionPoint, UML2_LiteralUnlimitedNatural, UML2_Collaboration, UML2_ProtocolStateMachine, StateMachine, UML2_ExpansionNode, UML2_InformationFlow, UML2_CallOperationAction, UML2_AcceptCallAction, AcceptEventAction, UML2_LinkAction, UML2_DirectedRelationship, UML2_SendSignalAction, UML2_Clause, UML2_FinalNode, UML2_Dependency, UML2_ControlNode, ActivityNode, UML2_Expression, OpaqueExpression, UML2_Action, ExecutableNode, UML2_ReadLinkObjectEndQualifierAction, UML2_JoinNode, UML2_InstanceValue, UML2_TimeTrigger, Relationship, UML2_FinalState, State, UML2_Stop, EventOccurrence, UML2_DeploymentTarget, UML2_TemplateBinding, UML2_CallTrigger, UML2_InformationItem, UML2_ExecutableNode, UML2_ConnectableElementTemplateParameter, UML2_Interaction, UML2_GeneralizationSet, UML2_InteractionOccurrence, UML2_MultiplicityElement, UML2_MergeNode, UML2_WriteStructuralFeatureAction, UML2_Relationship, UML2_Include, UML2_NamedElement, UML2_Activity, Behavior, UML2_ElementImport, UML2_ReadLinkObjectEndAction, UML2_DeployedArtifact, UML2_Device, Node, UML2_ChangeTrigger, UML2_State, UML2_ParameterableElement, UML2_Namespace, UML2_TemplateableElement, UML2_InstanceSpecification, UML2_Enumeration, DataType, UML2_TemplateParameterSubstitution, UML2_ActivityParameterNode, UML2_ActivityGroup, UML2_Actor, UML2_AnyTrigger, UML2_DataType, UML2_Slot, UML2_Implementation, Type, UML2_ClearAssociationAction, UML2_ProtocolTransition, Transition, UML2_ControlFlow, UML2_Region, UML2_Stereotype, UML2_PrimitiveType, UML2_ReadVariableAction, UML2_ConnectableElement, UML2_Comment, UML2_ProfileApplication, PackageImport, UML2_DurationObservationAction, UML2_ReadStructuralFeatureAction, UML2_ExecutionEnvironment, UML2_Permission, UML2_InterruptibleActivityRegion, UML2_ActivityPartition, UML2_AssociationClass, UML2_ActivityFinalNode, UML2_ConnectorEnd, UML2_Pseudostate, UML2_ObjectNode, UML2_DestroyObjectAction, UML2_LiteralSpecification, UML2_StateMachine, UML2_UseCase, UML2_Trigger, UML2_ExceptionHandler, UML2_RedefinableElement, UML2_InitialNode, AggregationKind, VisibilityKind, ParameterDirectionKind},
    associations={owner4, structuralFeature5, classifier0, result1, ownedBehavior6, classifierBehavior7, subsettedProperty11, association12, type19, general20, nestedClassifier22, qualifier15, ownedReception24, result17, value26, end27, qualifier30, qualifier32, ownedParameter37, bodyCondition38, first40, second42, behavior35, featuringClassifier45, specification53, ownedParameterSet55, context_57, ownedEnd47, memberEnd50, importedElement59, generalization60, value62, definingFeature67, member69, slot70, classifier72, constrainedElement64, feature75, inheritedMember78, generalization81, target84},
    constraints={sfa1, visibilityValid, sameGeneralClassifier, derivedUnionIsReadOnly, led2, isUniqueIsValid, specializedAssociationsHasSameNumberOfEnds, notConstrainingSelf, bodyConditionOnlyIfIsQuery, rsa1, noNestedClassifiers, coa1, onlyBinaryAssociationCanBeAggregations, oe1, oe2, isCompositeIsValid, oneStructuralFeatureDefinesAtMostOneSlotPerInstance, isAbstractDefined, nAryAssociationsOwnTheirEnds, coa3, mustBeOwnedHasOwner, bc1, subsetRequiresDifferentName, coa2, interfaceFeaturesArePublic, tia1, typeIsValid, led3, doa1, packageVisibilityValid, sfa2, inheritedMemberIsValid, wsfa1, languageAndBodiesAreValid, derivedUnionIsDerived, upperIsValid, importedVisibilityValid, definingFeaturIsFeatureOfClassifier, class1, isOrderedIsValid, led1, lowerIsValid, operationHasOnlyOneReturnParameter, ownedElementHasVisibility, rsa2},
    generalizations={gen_UML2_ProtocolConformance_DirectedRelationship, gen_UML2_ActivityNode_RedefinableElement, gen_UML2_Vertex_NamedElement, gen_UML2_CreateObjectAction_Action, gen_UML2_StructuralFeatureAction_Action, gen_UML2_TimeConstraint_IntervalConstraint, gen_UML2_Abstraction_Dependency, gen_UML2_CentralBufferNode_ObjectNode, gen_UML2_ObjectFlow_ActivityEdge, gen_UML2_ParameterSet_NamedElement, gen_UML2_TemplateParameter_Element, gen_UML2_PackageMerge_DirectedRelationship, gen_UML2_Deployment_Dependency, gen_UML2_RedefinableTemplateSignature_RedefinableElement, gen_UML2_RedefinableTemplateSignature_TemplateSignature, gen_UML2_Message_NamedElement, gen_UML2_ForkNode_ControlNode, gen_UML2_ClassifierTemplateParameter_TemplateParameter, gen_UML2_Port_Property, gen_UML2_InvocationAction_Action, gen_UML2_LiteralNull_LiteralSpecification, gen_UML2_DataStoreNode_CentralBufferNode, gen_UML2_ActivityEdge_RedefinableElement, gen_UML2_ConditionalNode_StructuredActivityNode, gen_UML2_Lifeline_NamedElement, gen_UML2_SendObjectAction_InvocationAction, gen_UML2_BehavioralFeature_Namespace, gen_UML2_BehavioralFeature_Feature, gen_UML2_TimeInterval_Interval, gen_UML2_RemoveStructuralFeatureValueAction_WriteStructuralFeatureAction, gen_UML2_OperationTemplateParameter_TemplateParameter, gen_UML2_Connector_Feature, gen_UML2_StateInvariant_InteractionFragment, gen_UML2_AddVariableValueAction_WriteVariableAction, gen_UML2_CallBehaviorAction_CallAction, gen_UML2_ExtensionEnd_Property, gen_UML2_BroadcastSignalAction_InvocationAction, gen_UML2_CommunicationPath_Association, gen_UML2_WriteLinkAction_LinkAction, gen_UML2_Extend_NamedElement, gen_UML2_Extend_DirectedRelationship, gen_UML2_AcceptEventAction_Action, gen_UML2_FlowFinalNode_FinalNode, gen_UML2_StructuralFeature_Feature, gen_UML2_StructuralFeature_TypedElement, gen_UML2_StructuralFeature_MultiplicityElement, gen_UML2_CollaborationOccurrence_NamedElement, gen_UML2_Interface_Classifier, gen_UML2_LiteralInteger_LiteralSpecification, gen_UML2_LoopNode_StructuredActivityNode, gen_UML2_PrimitiveFunction_PackageableElement, gen_UML2_CallAction_InvocationAction, gen_UML2_Manifestation_Abstraction, gen_UML2_BehavioredClassifier_Classifier, gen_UML2_WriteVariableAction_VariableAction, gen_UML2_ReadExtentAction_Action, gen_UML2_Property_StructuralFeature, gen_UML2_Property_ConnectableElement, gen_UML2_Property_DeploymentTarget, gen_UML2_CreateLinkObjectAction_CreateLinkAction, gen_UML2_LiteralBoolean_LiteralSpecification, gen_UML2_DestroyLinkAction_WriteLinkAction, gen_UML2_StartOwnedBehaviorAction_Action, gen_UML2_Continuation_InteractionFragment, gen_UML2_ReplyAction_Action, gen_UML2_ValueSpecification_TypedElement, gen_UML2_ValueSpecification_ParameterableElement, gen_UML2_InteractionOperand_Namespace, gen_UML2_InteractionOperand_InteractionFragment, gen_UML2_Package_Namespace, gen_UML2_Package_PackageableElement, gen_UML2_MessageEnd_NamedElement, gen_UML2_StringExpression_TemplateableElement, gen_UML2_PackageableElement_NamedElement, gen_UML2_PackageableElement_ParameterableElement, gen_UML2_TypedElement_NamedElement, gen_UML2_OutputPin_Pin, gen_UML2_GeneralOrdering_NamedElement, gen_UML2_DecisionNode_ControlNode, gen_UML2_InputPin_Pin, gen_UML2_AddStructuralFeatureValueAction_WriteStructuralFeatureAction, gen_UML2_Generalization_DirectedRelationship, gen_UML2_ClearVariableAction_VariableAction, gen_UML2_Class_BehavioredClassifier, gen_UML2_Class_EncapsulatedClassifier, gen_UML2_ReadSelfAction_Action, gen_UML2_EventOccurrence_InteractionFragment, gen_UML2_EventOccurrence_MessageEnd, gen_UML2_TimeObservationAction_WriteStructuralFeatureAction, gen_UML2_InteractionFragment_NamedElement, gen_UML2_Variable_ConnectableElement, gen_UML2_Variable_TypedElement, gen_UML2_Variable_MultiplicityElement, gen_UML2_LinkEndData_Element, gen_UML2_QualifierValue_Element, gen_UML2_Interval_ValueSpecification, gen_UML2_Pin_ObjectNode, gen_UML2_Pin_MultiplicityElement, gen_UML2_Node_Class, gen_UML2_Node_DeploymentTarget, gen_UML2_PartDecomposition_InteractionOccurrence, gen_UML2_Model_Package, gen_UML2_CombinedFragment_InteractionFragment, gen_UML2_SignalTrigger_MessageTrigger, gen_UML2_InteractionConstraint_Constraint, gen_UML2_Artifact_Classifier, gen_UML2_Artifact_DeployedArtifact, gen_UML2_EncapsulatedClassifier_StructuredClassifier, gen_UML2_RemoveVariableValueAction_WriteVariableAction, gen_UML2_ExpansionRegion_StructuredActivityNode, gen_UML2_StructuredClassifier_Classifier, gen_UML2_Extension_Association, gen_UML2_Component_Class, gen_UML2_MessageTrigger_Trigger, gen_UML2_DeploymentSpecification_Artifact, gen_UML2_Gate_MessageEnd, gen_UML2_Duration_ValueSpecification, gen_UML2_ReclassifyObjectAction_Action, gen_UML2_Substitution_Realization, gen_UML2_CreateLinkAction_WriteLinkAction, gen_UML2_Operation_BehavioralFeature, gen_UML2_Operation_TypedElement, gen_UML2_Operation_MultiplicityElement, gen_UML2_Operation_ParameterableElement, gen_UML2_ClearStructuralFeatureAction_StructuralFeatureAction, gen_UML2_LinkEndCreationData_LinkEndData, gen_UML2_TestIdentityAction_Action, gen_UML2_EnumerationLiteral_InstanceSpecification, gen_UML2_DurationConstraint_IntervalConstraint, gen_UML2_Usage_Dependency, gen_UML2_Profile_Package, gen_UML2_TemplateableClassifier_Classifier, gen_UML2_PackageImport_DirectedRelationship, gen_UML2_OpaqueExpression_ValueSpecification, gen_UML2_ParameterableClassifier_Classifier, gen_UML2_ApplyFunctionAction_Action, gen_UML2_LiteralString_LiteralSpecification, gen_UML2_Transition_RedefinableElement, gen_UML2_Feature_RedefinableElement, gen_UML2_StructuredActivityNode_Action, gen_UML2_StructuredActivityNode_Namespace, gen_UML2_StructuredActivityNode_ActivityGroup, gen_UML2_IntervalConstraint_Constraint, gen_UML2_Signal_Classifier, gen_UML2_ConnectionPointReference_Vertex, gen_UML2_ValuePin_InputPin, gen_UML2_DurationInterval_Interval, gen_UML2_ReadLinkAction_LinkAction, gen_UML2_ReadIsClassifiedObjectAction_Action, gen_UML2_VariableAction_Action, gen_UML2_ExecutionOccurrence_InteractionFragment, gen_UML2_Realization_Abstraction, gen_UML2_TemplateSignature_Element, gen_UML2_TimeExpression_ValueSpecification, gen_UML2_ExtensionPoint_RedefinableElement, gen_UML2_LiteralUnlimitedNatural_LiteralSpecification, gen_UML2_Collaboration_BehavioredClassifier, gen_UML2_Collaboration_StructuredClassifier, gen_UML2_ProtocolStateMachine_StateMachine, gen_UML2_ExpansionNode_ObjectNode, gen_UML2_InformationFlow_PackageableElement, gen_UML2_InformationFlow_DirectedRelationship, gen_UML2_CallOperationAction_CallAction, gen_UML2_AcceptCallAction_AcceptEventAction, gen_UML2_LinkAction_Action, gen_UML2_Behavior_Class, gen_UML2_DirectedRelationship_Relationship, gen_UML2_SendSignalAction_InvocationAction, gen_UML2_Clause_Element, gen_UML2_FinalNode_ControlNode, gen_UML2_Dependency_PackageableElement, gen_UML2_Dependency_DirectedRelationship, gen_UML2_ControlNode_ActivityNode, gen_UML2_Expression_OpaqueExpression, gen_UML2_Action_ExecutableNode, gen_UML2_ReadLinkObjectEndQualifierAction_Action, gen_UML2_JoinNode_ControlNode, gen_UML2_RaiseExceptionAction_Action, gen_UML2_InstanceValue_ValueSpecification, gen_UML2_TimeTrigger_Trigger, gen_UML2_Association_Classifier, gen_UML2_Association_Relationship, gen_UML2_FinalState_State, gen_UML2_Stop_EventOccurrence, gen_UML2_DeploymentTarget_NamedElement, gen_UML2_TemplateBinding_DirectedRelationship, gen_UML2_CallTrigger_MessageTrigger, gen_UML2_InformationItem_Classifier, gen_UML2_ExecutableNode_ActivityNode, gen_UML2_Reception_BehavioralFeature, gen_UML2_ConnectableElementTemplateParameter_TemplateParameter, gen_UML2_Interaction_Behavior, gen_UML2_Interaction_InteractionFragment, gen_UML2_GeneralizationSet_PackageableElement, gen_UML2_InteractionOccurrence_InteractionFragment, gen_UML2_MultiplicityElement_Element, gen_UML2_MergeNode_ControlNode, gen_UML2_WriteStructuralFeatureAction_StructuralFeatureAction, gen_UML2_Relationship_Element, gen_UML2_Parameter_ConnectableElement, gen_UML2_Parameter_TypedElement, gen_UML2_Parameter_MultiplicityElement, gen_UML2_Include_NamedElement, gen_UML2_Include_DirectedRelationship, gen_UML2_NamedElement_TemplateableElement, gen_UML2_Activity_Behavior, gen_UML2_ElementImport_DirectedRelationship, gen_UML2_ReadLinkObjectEndAction_Action, gen_UML2_DeployedArtifact_NamedElement, gen_UML2_Device_Node, gen_UML2_ChangeTrigger_Trigger, gen_UML2_State_Namespace, gen_UML2_State_RedefinableElement, gen_UML2_State_Vertex, gen_UML2_ParameterableElement_Element, gen_UML2_Namespace_NamedElement, gen_UML2_TemplateableElement_Element, gen_UML2_InstanceSpecification_PackageableElement, gen_UML2_InstanceSpecification_DeploymentTarget, gen_UML2_InstanceSpecification_DeployedArtifact, gen_UML2_Enumeration_DataType, gen_UML2_TemplateParameterSubstitution_Element, gen_UML2_ActivityParameterNode_ObjectNode, gen_UML2_Type_PackageableElement, gen_UML2_ActivityGroup_Element, gen_UML2_Actor_Classifier, gen_UML2_Constraint_PackageableElement, gen_UML2_AnyTrigger_MessageTrigger, gen_UML2_DataType_Classifier, gen_UML2_Slot_Element, gen_UML2_Implementation_Realization, gen_UML2_Classifier_Namespace, gen_UML2_Classifier_Type, gen_UML2_Classifier_RedefinableElement, gen_UML2_ClearAssociationAction_Action, gen_UML2_ProtocolTransition_Transition, gen_UML2_ControlFlow_ActivityEdge, gen_UML2_Region_Namespace, gen_UML2_Region_RedefinableElement, gen_UML2_Stereotype_Class, gen_UML2_PrimitiveType_DataType, gen_UML2_ReadVariableAction_VariableAction, gen_UML2_ConnectableElement_NamedElement, gen_UML2_ConnectableElement_ParameterableElement, gen_UML2_Comment_TemplateableElement, gen_UML2_ProfileApplication_PackageImport, gen_UML2_DurationObservationAction_WriteStructuralFeatureAction, gen_UML2_ReadStructuralFeatureAction_StructuralFeatureAction, gen_UML2_ExecutionEnvironment_Node, gen_UML2_Permission_Dependency, gen_UML2_InterruptibleActivityRegion_ActivityGroup, gen_UML2_ActivityPartition_NamedElement, gen_UML2_ActivityPartition_ActivityGroup, gen_UML2_AssociationClass_Class, gen_UML2_AssociationClass_Association, gen_UML2_ActivityFinalNode_FinalNode, gen_UML2_ConnectorEnd_MultiplicityElement, gen_UML2_Pseudostate_Vertex, gen_UML2_ObjectNode_ActivityNode, gen_UML2_ObjectNode_TypedElement, gen_UML2_DestroyObjectAction_Action, gen_UML2_LiteralSpecification_ValueSpecification, gen_UML2_StateMachine_Behavior, gen_UML2_UseCase_BehavioredClassifier, gen_UML2_Trigger_NamedElement, gen_UML2_ExceptionHandler_Element, gen_UML2_RedefinableElement_NamedElement, gen_UML2_InitialNode_ControlNode},
    metadata=None
)
