...
public class UML2_Property extends DeploymentTarget, StructuralFeature, ConnectableElement {
    ...
    public UML2_Property(
        boolean isDerivedUnion,        boolean isDerived,        boolean isComposite,        String aggregation    ) {
        super(
        );
    ...
    public UML2_Property(
        boolean isDerivedUnion,        boolean isDerived,        boolean isComposite,        String aggregation        ArrayList<UML2_Property> uml2_propertys    ) {
        this.isDerivedUnion = isDerivedUnion;
        this.isDerived = isDerived;
        this.isComposite = isComposite;
        this.aggregation = aggregation;
