    ...
    def c2(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "genou3"):
                    opp_val = getattr(item, "genou3", None)
                    
                    if opp_val == self:
                        setattr(item, "genou3", None)
...
class C(ABC):
    ...
    def __init__(self, attC1: int, attC2: bool, genou3: "B" = None):
        self.attC1 = attC1
        self.attC2 = attC2
        self.genou3 = genou3
    ...
    @property
    def genou3(self):
        return self.__genou3
    @genou3.setter
    def genou3(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_C__genou3", None)
        self.__genou3 = value
...
class A(ABC):
    ...
    def __init__(self, attA: str, b0: set["B"] = None, r4: "R" = None):
        self.attA = attA
