...
class dfg_DfgEdge:
    ...
    def __init__(self, label: str, dfg_DfgEdge: "dfg_DfgGraph" = None, dfg_DfgEdge8: "dfg_DfgVertex" = None, dfg_DfgEdge10: "dfg_DfgVertex" = None, dfg_DfgEdge13: "dfg_DfgVertex" = None):
        self.label = label
...
class dfg_DfgVertex:
    ...
    def __init__(self, mappings: str, dfg_DfgVertex5: "dfg_DfgVertex" = None, dfg_DfgVertex3: set["dfg_DfgVertex"] = None, dfg_DfgVertex7: set["dfg_DfgEdge"] = None, dfg_DfgVertex11: "dfg_DfgEdge" = None, dfg_DfgVertex14: "dfg_DfgEdge" = None, dfg_DfgVertex: "dfg_DfgGraph" = None):
