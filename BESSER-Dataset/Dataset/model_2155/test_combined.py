...
def test_hyp_dfg_dfgedge_is_not_abstract():
    assert not inspect.isabstract(dfg_DfgEdge)


def test_hyp_dfg_dfgedge_constructor_exists():
    assert callable(dfg_DfgEdge.__init__)


def test_hyp_dfg_dfgedge_constructor_args():
...
def test_hyp_dfg_dfgvertex_is_not_abstract():
    assert not inspect.isabstract(dfg_DfgVertex)


def test_hyp_dfg_dfgvertex_constructor_exists():
    assert callable(dfg_DfgVertex.__init__)


def test_hyp_dfg_dfgvertex_constructor_args():
...
def test_hyp_dfg_dfggraph_is_not_abstract():
    assert not inspect.isabstract(dfg_DfgGraph)


def test_hyp_dfg_dfggraph_constructor_exists():
    assert callable(dfg_DfgGraph.__init__)


def test_hyp_dfg_dfggraph_constructor_args():
...
def test_hyp_dfg_dfgedge_label_setter(instance):
...
def test_hyp_dfg_dfgvertex_mappings_setter(instance):
