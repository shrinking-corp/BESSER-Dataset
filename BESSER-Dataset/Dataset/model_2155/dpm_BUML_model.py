...
# Classes
dfg_DfgGraph = Class(name="dfg_DfgGraph")
dfg_DfgVertex = Class(name="dfg_DfgVertex")
dfg_DfgEdge = Class(name="dfg_DfgEdge")
...
domain_model = DomainModel(
    ...
    associations={vertices0, edges1, neighbors4, connecting6, vertex19, vertex212},
    generalizations={},
    metadata=None
)
