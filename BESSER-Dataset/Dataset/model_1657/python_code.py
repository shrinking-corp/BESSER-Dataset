...
class simpleparts_RelatedTo(NamedElement):
    ...
    def __init__(self, since: str, relations: "simpleparts_Thing" = None, simpleparts_RelatedTo: "simpleparts_Thing" = None, RelatedTo: "simpleparts_Thing" = None):
        self.since = since
...
class simpleparts_Thing(NamedElement):
    ...
    def __init__(self, id: int, simpleparts_Thing3: set["simpleparts_Part"] = None, simpleparts_Thing5: set["simpleparts_Element"] = None, simpleparts_Thing7: set["simpleparts_Item"] = None, simpleparts_Thing9: set["simpleparts_Piece"] = None, Thing: "simpleparts_RelatedTo" = None, simpleparts_Thing12: "simpleparts_RelatedTo" = None, simpleparts_Thing: "simpleparts_World" = None, fromThing: set["simpleparts_RelatedTo"] = None):
        self.id = id
