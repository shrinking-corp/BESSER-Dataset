...
# Classes
featureDiagram_Feature = Class(name="featureDiagram_Feature")
featureDiagram_ConstraintEdge = Class(name="featureDiagram_ConstraintEdge")
featureDiagram_FeatureDiagram = Class(name="featureDiagram_FeatureDiagram")
FeatureElement = Class(name="FeatureElement")
featureDiagram_Opt = Class(name="featureDiagram_Opt")
Operator = Class(name="Operator")
featureDiagram_Mandatory = Class(name="featureDiagram_Mandatory")
featureDiagram_Or = Class(name="featureDiagram_Or")
featureDiagram_Alternative = Class(name="featureDiagram_Alternative")
featureDiagram_Card = Class(name="featureDiagram_Card")
featureDiagram_Operator = Class(name="featureDiagram_Operator")
featureDiagram_Attribute = Class(name="featureDiagram_Attribute")
featureDiagram_EObject = Class(name="featureDiagram_EObject")
featureDiagram_PrimitiveFeature = Class(name="featureDiagram_PrimitiveFeature")
Feature = Class(name="Feature")
featureDiagram_Constraint = Class(name="featureDiagram_Constraint", is_abstract=True)
featureDiagram_Mutex = Class(name="featureDiagram_Mutex")
featureDiagram_FeatureElement = Class(name="featureDiagram_FeatureElement")
featureDiagram_Require = Class(name="featureDiagram_Require")
...
domain_model = DomainModel(
    name="featureDiagram",
    types={featureDiagram_Feature, featureDiagram_ConstraintEdge, featureDiagram_FeatureDiagram, FeatureElement, featureDiagram_Opt, Operator, featureDiagram_Mandatory, featureDiagram_Or, featureDiagram_Alternative, featureDiagram_Card, featureDiagram_Operator, featureDiagram_Attribute, featureDiagram_EObject, featureDiagram_PrimitiveFeature, Feature, featureDiagram_Constraint, featureDiagram_Mutex, featureDiagram_FeatureElement, featureDiagram_Require, Constraint},
    associations={features0, root1, constraintEdges2, owningFeatureDiagram4, owningFeature20, features22, operator5, attributes6, owningOperator8, modelElements11, target13, constraint16, source17, owningFeature25, owningCE24},
    generalizations={gen_featureDiagram_Feature_FeatureElement, gen_featureDiagram_FeatureDiagram_FeatureElement, gen_featureDiagram_Opt_Operator, gen_featureDiagram_Mandatory_Operator, gen_featureDiagram_Or_Operator, gen_featureDiagram_Alternative_Operator, gen_featureDiagram_PrimitiveFeature_Feature, gen_featureDiagram_ConstraintEdge_FeatureElement, gen_featureDiagram_Operator_FeatureElement, gen_featureDiagram_Mutex_Constraint, gen_featureDiagram_Attribute_FeatureElement, gen_featureDiagram_Card_Operator, gen_featureDiagram_Constraint_FeatureElement, gen_featureDiagram_Require_Constraint},
    metadata=None
)
