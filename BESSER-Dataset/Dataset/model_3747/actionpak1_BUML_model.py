...
# Classes
actionpak1_ActionstepTest = Class(name="actionpak1_ActionstepTest")
ActionStep = Class(name="ActionStep")
DynamicValue = Class(name="DynamicValue")
actionpak1_CustomInitiator = Class(name="actionpak1_CustomInitiator", is_abstract=True)
ParameterizedInitiator = Class(name="ParameterizedInitiator")
actionpak1_IncomingCall2 = Class(name="actionpak1_IncomingCall2", is_abstract=True)
actionstep_ParameterizedInitiator = Class(name="actionstep_ParameterizedInitiator")
call_CallSource1 = Class(name="call_CallSource1")
actionpak1_InvokeSaflet2 = Class(name="actionpak1_InvokeSaflet2")
ParameterizedActionstep = Class(name="ParameterizedActionstep")
actionpak1_ScheduleSaflet = Class(name="actionpak1_ScheduleSaflet")
actionpak1_UnscheduleSaflet = Class(name="actionpak1_UnscheduleSaflet")
...
domain_model = DomainModel(
    name="actionpak1",
    types={actionpak1_ActionstepTest, ActionStep, DynamicValue, actionpak1_CustomInitiator, ParameterizedInitiator, actionpak1_IncomingCall2, actionstep_ParameterizedInitiator, call_CallSource1, actionpak1_InvokeSaflet2, ParameterizedActionstep, actionpak1_ScheduleSaflet, actionpak1_UnscheduleSaflet},
    associations={message0, targetSafletPath1, startDateTime11, endDateTime14, calendarName17, jobName20, jobNamePrefix3, targetSafletPath5, cronExpression8, jobName23},
