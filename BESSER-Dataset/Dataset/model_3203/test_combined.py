...
def test_hyp_idl_preproc_pragma_conn_type_is_not_abstract():
    assert not inspect.isabstract(idl_Preproc_Pragma_Conn_Type)


def test_hyp_idl_preproc_pragma_conn_type_constructor_exists():
    assert callable(idl_Preproc_Pragma_Conn_Type.__init__)


def test_hyp_idl_preproc_pragma_conn_type_constructor_args():
...
def test_hyp_idl_preproc_pragma_conn_type_valuePort_setter(instance):
...
@given(instance=idl_Preproc_Pragma_Conn_Type_strategy)
def test_hyp_idl_preproc_pragma_conn_type_valueConnType_setter(instance):
...
def test_idl_Preproc_Pragma_Conn_Type_valueConnType_value_roundtrip():
    instance = idl_Preproc_Pragma_Conn_Type(valueConnType="sample_text", valuePort="sample_text")
    assert instance.valueConnType == "sample_text"
    instance.valueConnType = "sample_text_2"
    assert instance.valueConnType == "sample_text_2"


def test_idl_Preproc_Pragma_Conn_Type_valuePort_value_roundtrip():
    instance = idl_Preproc_Pragma_Conn_Type(valueConnType="sample_text", valuePort="sample_text")
    assert instance.valuePort == "sample_text"
    instance.valuePort = "sample_text_2"
    assert instance.valuePort == "sample_text_2"
...
def test_idl_Preproc_Pragma_Conn_Type_isa_Preproc_Pragma():
    instance = idl_Preproc_Pragma_Conn_Type(valueConnType="sample_text", valuePort="sample_text")
    assert isinstance(instance, Preproc_Pragma)
...
idl_Preproc_Pragma_Conn_Type_strategy = st.builds(idl_Preproc_Pragma_Conn_Type, valueConnType=safe_text, valuePort=safe_text)
@given(instance=idl_Preproc_Pragma_Conn_Type_strategy)
@settings(max_examples=25)
