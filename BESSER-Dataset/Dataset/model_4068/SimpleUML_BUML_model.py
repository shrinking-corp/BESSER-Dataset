...
# Classes
simpleuml_Model = Class(name="simpleuml_Model")
Package = Class(name="Package")
simpleuml_Package = Class(name="simpleuml_Package")
Classifier = Class(name="Classifier")
Packageable = Class(name="Packageable")
simpleuml_Packageable = Class(name="simpleuml_Packageable", is_abstract=True)
simpleuml_Class = Class(name="simpleuml_Class")
DataType = Class(name="DataType")
simpleuml_Type = Class(name="simpleuml_Type", is_abstract=True)
simpleuml_DataType = Class(name="simpleuml_DataType")
simpleuml_Association = Class(name="simpleuml_Association")
simpleuml_PrimitiveType = Class(name="simpleuml_PrimitiveType")
Type = Class(name="Type")
simpleuml_Enumeration = Class(name="simpleuml_Enumeration")
simpleuml_EnumerationLiteral = Class(name="simpleuml_EnumerationLiteral")
simpleuml_Classifier = Class(name="simpleuml_Classifier", is_abstract=True)
simpleuml_ModelElement = Class(name="simpleuml_ModelElement", is_abstract=True)
simpleuml_TaggedValue = Class(name="simpleuml_TaggedValue")
simpleuml_Generalization = Class(name="simpleuml_Generalization")
simpleuml_Property = Class(name="simpleuml_Property")
ModelElement = Class(name="ModelElement")

# simpleuml_Model class attributes and methods
simpleuml_Model_m_getCustomProperty: Method = Method(name="getCustomProperty", parameters={Parameter(name='simpleuml_name', type=StringType)}, type=StringType)
...
simpleuml_TaggedValue.attributes={simpleuml_TaggedValue_value, simpleuml_TaggedValue_name}
...
domain_model = DomainModel(
    name="simpleuml",
    types={simpleuml_Model, Package, simpleuml_Package, Classifier, Packageable, simpleuml_Packageable, simpleuml_Class, DataType, simpleuml_Type, simpleuml_DataType, simpleuml_Association, simpleuml_PrimitiveType, Type, simpleuml_Enumeration, simpleuml_EnumerationLiteral, simpleuml_Classifier, simpleuml_ModelElement, simpleuml_TaggedValue, simpleuml_Generalization, simpleuml_Property, ModelElement},
    associations={ownedElements0, type2, owner3, source4, target6, attributes9, ownedLiteral11, taggedValue12, general13, owner16, generalizations1},
    generalizations={gen_simpleuml_Model_Package, gen_simpleuml_Package_Classifier, gen_simpleuml_Package_Packageable, gen_simpleuml_Association_ModelElement, gen_simpleuml_Association_Packageable, gen_simpleuml_PrimitiveType_Type, gen_simpleuml_DataType_Type, gen_simpleuml_Enumeration_Type, gen_simpleuml_Classifier_ModelElement, gen_simpleuml_Type_Classifier, gen_simpleuml_Type_Packageable, gen_simpleuml_Class_DataType, gen_simpleuml_Property_ModelElement},
    metadata=None
)
