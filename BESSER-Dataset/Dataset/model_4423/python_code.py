...
class iot_Board:
    ...
    def __init__(self, name: str, type: str, iot_Board: "iot_System" = None, iot_Board8: set["iot_HWComp"] = None):
        self.name = name
        self.type = type
...
class iot_HWComp(ABC):
    ...
    def __init__(self, name: str, iot_HWComp: set["iot_IotOperationDef"] = None, iot_HWComp2: "iot_System" = None, iot_HWComp9: "iot_Board" = None):
        self.name = name
