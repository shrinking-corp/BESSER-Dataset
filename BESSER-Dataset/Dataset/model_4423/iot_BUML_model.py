...
# Classes
iot_IotOperationDef = Class(name="iot_IotOperationDef", is_abstract=True)
iot_HWComp = Class(name="iot_HWComp", is_abstract=True)
...
iot_Board = Class(name="iot_Board")
iot_Sketch = Class(name="iot_Sketch")
iot_IotActivity = Class(name="iot_IotActivity", is_abstract=True)
...
iot_Board.attributes={iot_Board_name, iot_Board_type}
...
domain_model = DomainModel(
    ...
    associations={services0, components1, boards3, sketch5, components7, activity10},
