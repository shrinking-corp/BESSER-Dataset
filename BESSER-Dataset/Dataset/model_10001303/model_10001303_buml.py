...
Player.attributes={Player_inJail, Player_money, Player_INITIAL_POSITION, Player_INITIAL_MONEY, Player_name, Player_board, Player_isRetire, Player_property, Player_rand, Player_position, Player_isAI, Player_isBankrupt, Player_PASS_GO_MONEY}
...
Dice.attributes={Dice_secondValue, Dice_randomNumber, Dice_firstValue}
...
Jail.attributes={Jail_jailFine, Jail_JailPosition}
...
domain_model = DomainModel(
    name="_9f814c22_b79d_4312_aa8f_8b6492596d5e",
    types={FreeParking, Player, Class_, Random, Board, Money, Board1, Dice, AIPlayer, Jail, Chance, BoardGUI, JFrame, PlayerIcon, IncomeTax, Property_},
