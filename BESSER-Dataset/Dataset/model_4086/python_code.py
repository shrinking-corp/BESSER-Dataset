...
class simpleUML_SimpleClass:
    ...
    def __init__(self, simpleName: str, simpleUML_SimpleClass3: "simpleUML_SimpleClass" = None, simpleUML_SimpleClass1: set["simpleUML_SimpleClass"] = None, simpleUML_SimpleClass5: set["simpleUML_Generalization"] = None, simpleUML_SimpleClass7: set["simpleUML_UMLAttribute"] = None, simpleUML_SimpleClass10: "simpleUML_Generalization" = None, simpleUML_SimpleClass: "simpleUML_Model" = None):
