...
domain_model = DomainModel(
    name="statemachine",
    types={statemachine_Statemachine, Named, statemachine_AbstractState, statemachine_StateChange, statemachine_InitialState, AbstractState, statemachine_FinalState, statemachine_Named, statemachine_AbstractTransition, statemachine_StateValue, statemachine_State, statemachine_Transition, AbstractTransition, statemachine_ConditionalTransition, statemachine_AbstractCondition, statemachine_StateAttribute, statemachine_ConditionalState, statemachine_FieldCondition, AbstractCondition, statemachine_AttributeCondition, StateAttributeType, StateValueType},
    associations={states0, state3, stateChange6, transitions1, condition10, stateAttribute11, stateValue14, stateAttributeQuery9, stateValue16, stateAttribute19},
    generalizations={gen_statemachine_Statemachine_Named, gen_statemachine_AbstractTransition_Named, gen_statemachine_InitialState_AbstractState, gen_statemachine_FinalState_AbstractState, gen_statemachine_AbstractState_Named, gen_statemachine_State_AbstractState, gen_statemachine_Transition_AbstractTransition, gen_statemachine_ConditionalTransition_AbstractTransition, gen_statemachine_ConditionalState_AbstractState, gen_statemachine_FieldCondition_AbstractCondition, gen_statemachine_AttributeCondition_AbstractCondition},
    metadata=None
)
