...
class units_Quantity(ABC):
    ...
    def __init__(self, value: str, units_Quantity: "units_Unit" = None, units_Quantity7: "units_QuantityScalarOperation" = None, units_Quantity2: "units_QuantityHomogenousOperation" = None, units_Quantity5: "units_QuantityHomogenousOperation" = None):
        self.value = value
