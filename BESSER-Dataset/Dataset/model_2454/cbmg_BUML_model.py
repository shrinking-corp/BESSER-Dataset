...
# Classes
cbmg_State = Class(name="cbmg_State")
cbmg_Transition = Class(name="cbmg_Transition")
cbmg_RequestParameter = Class(name="cbmg_RequestParameter")
...
cbmg_State.attributes={cbmg_State_port, cbmg_State_requestURL, cbmg_State_isEndState, cbmg_State_localAddr, cbmg_State_localName, cbmg_State_isStartState}
...
cbmg_Transition.attributes={cbmg_Transition_probability, cbmg_Transition_method, cbmg_Transition_accept, cbmg_Transition_nbrOfTransitions, cbmg_Transition_condition, cbmg_Transition_thinkTime}
...
domain_model = DomainModel(
    ...
    associations={sourceState4, targetState7, outgoingTransitions0, incomingTransitions1, requestParameter_transition10, transition_RequestParameter12},
    generalizations={},
    metadata=None
)
