...
class cbmg_Transition:
    ...
    def __init__(self, probability: float, thinkTime: float, nbrOfTransitions: int, accept: str, condition: str, method: str, cbmg_Transition5: "cbmg_State" = None, cbmg_Transition8: "cbmg_State" = None, cbmg_Transition: "cbmg_State" = None, cbmg_Transition3: "cbmg_State" = None, cbmg_Transition11: set["cbmg_RequestParameter"] = None, cbmg_Transition14: "cbmg_RequestParameter" = None):
...
class cbmg_State:
    ...
    def __init__(self, requestURL: str, localAddr: str, port: int, localName: str, isStartState: bool, isEndState: bool, cbmg_State6: "cbmg_Transition" = None, cbmg_State9: "cbmg_Transition" = None, cbmg_State: set["cbmg_Transition"] = None, cbmg_State2: set["cbmg_Transition"] = None):
