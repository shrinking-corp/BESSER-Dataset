...
class mm_styles_Font:
    ...
    def __init__(self, size: int, italic: bool, bold: bool, name: str):
        self.size = size
        self.italic = italic
        self.bold = bold
        self.name = name
...
class mm_styles_AbstractStyle(ABC):
    ...
    def __init__(self, lineWidth: str, lineStyle: str, filled: str, lineVisible: str, transparency: str, mm_styles_AbstractStyle61: "styles_RenderingStyle" = None, mm_styles_AbstractStyle: "styles_Color" = None, mm_styles_AbstractStyle58: "styles_Color" = None):
...
class mm_pictograms_AdvancedAnchor(Anchor):
    ...
    def __init__(self, useAnchorLocationAsConnectionEndpoint: bool, Anchor: "mm_pictograms_Connection" = None, Anchor28: "mm_pictograms_AnchorContainer" = None, Anchor16: "mm_pictograms_Connection" = None):
...
class mm_pictograms_Diagram(StyleContainer, pictograms_ContainerShape):
    ...
    def __init__(self, snapToGrid: bool, showGuides: bool, verticalGridUnit: int, version: str, gridUnit: int, diagramTypeId: str, name: str, mm_pictograms_Diagram: set["styles_Color"] = None, mm_pictograms_Diagram7: set["styles_Font"] = None, mm_pictograms_Diagram9: set["PictogramLink"] = None, parent: set["Connection"] = None):
...
class mm_algorithms_PlatformGraphicsAlgorithm(GraphicsAlgorithm):
    ...
    def __init__(self, id: str, GraphicsAlgorithm25: "mm_pictograms_Anchor" = None, GraphicsAlgorithm41: "mm_algorithms_GraphicsAlgorithm" = None, GraphicsAlgorithm: "mm_pictograms_PictogramElement" = None, GraphicsAlgorithm39: "mm_algorithms_GraphicsAlgorithm" = None):
        self.id = id
...
class mm_algorithms_AbstractText(GraphicsAlgorithm):
    ...
    def __init__(self, horizontalAlignment: str, verticalAlignment: str, angle: str, value: str, mm_algorithms_AbstractText: "styles_Font" = None, mm_algorithms_AbstractText50: set["styles_TextStyleRegion"] = None, GraphicsAlgorithm25: "mm_pictograms_Anchor" = None, GraphicsAlgorithm41: "mm_algorithms_GraphicsAlgorithm" = None, GraphicsAlgorithm: "mm_pictograms_PictogramElement" = None, GraphicsAlgorithm39: "mm_algorithms_GraphicsAlgorithm" = None):
        self.horizontalAlignment = horizontalAlignment
        self.verticalAlignment = verticalAlignment
        self.angle = angle
        self.value = value
...
class mm_algorithms_RoundedRectangle(GraphicsAlgorithm):
    ...
    def __init__(self, cornerHeight: int, cornerWidth: int, GraphicsAlgorithm25: "mm_pictograms_Anchor" = None, GraphicsAlgorithm41: "mm_algorithms_GraphicsAlgorithm" = None, GraphicsAlgorithm: "mm_pictograms_PictogramElement" = None, GraphicsAlgorithm39: "mm_algorithms_GraphicsAlgorithm" = None):
...
class mm_algorithms_Image(GraphicsAlgorithm):
    ...
    def __init__(self, id: str, stretchH: str, stretchV: str, proportional: str, GraphicsAlgorithm25: "mm_pictograms_Anchor" = None, GraphicsAlgorithm41: "mm_algorithms_GraphicsAlgorithm" = None, GraphicsAlgorithm: "mm_pictograms_PictogramElement" = None, GraphicsAlgorithm39: "mm_algorithms_GraphicsAlgorithm" = None):
        self.id = id
        self.stretchH = stretchH
        self.stretchV = stretchV
        self.proportional = proportional
