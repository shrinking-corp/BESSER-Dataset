...
Customer.attributes={Customer_emailAddress, Customer_address, Customer_phoneNumber, Customer_name, Customer_dateOfBirth}
...
Login.attributes={Login_securityAnswer, Login_password, Login_securityQuestion, Login_username, Login_lastLoginTime}
...
transaction_Transaction.attributes={transaction_Transaction_amount, transaction_Transaction_type, transaction_Transaction_transactionTime, transaction_Transaction_id}
...
# Tescher class attributes and methods
Tescher_t_id: Property = Property(name="t_id", type=IntegerType)
Tescher_Name: Property = Property(name="Name", type=StringType)
Tescher_City: Property = Property(name="City", type=StringType)
Tescher.attributes={Tescher_City, Tescher_t_id, Tescher_Name}

# courses class attributes and methods
courses_c_name: Property = Property(name="c_name", type=StringType)
courses_cid: Property = Property(name="cid", type=IntegerType)
courses.attributes={courses_c_name, courses_cid}

# student class attributes and methods
student_s_id: Property = Property(name="s_id", type=IntegerType)
student_s_name: Property = Property(name="s_name", type=StringType)
student.attributes={student_s_name, student_s_id}
...
Tescher_student: BinaryAssociation = BinaryAssociation(
    name="Tescher_student",
    ends={
        Property(name="student6", type=student, multiplicity=Multiplicity(1, 9999)),
        Property(name="tescher7", type=Tescher, multiplicity=Multiplicity(1, 1))
    }
)
Tescher_courses: BinaryAssociation = BinaryAssociation(
    name="Tescher_courses",
    ends={
        Property(name="courses8", type=courses, multiplicity=Multiplicity(0, 9999)),
        Property(name="tescher9", type=Tescher, multiplicity=Multiplicity(0, 9999))
    }
)
courses_student: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="courses11", type=courses, multiplicity=Multiplicity(0, 9999))
    }
)

# Domain Model
domain_model = DomainModel(
    name="_3422d758_5233_44ab_9e5a_e600a21b8fe8",
    types={Customer, Login, transaction_Transaction, transaction_DepositTransaction, transaction_WithdrawTransaction, transaction_TransferTransaction, account_SavingsAccount, account_CertificatesOfDepositAccount, account_CheckingAccount, account_Account, Tescher, courses, student, transaction_TransactionType, account_AccountType},
    associations={association2, Account_Transaction, Customer_Login, Tescher_student, Tescher_courses, courses_student},
    generalizations={},
    metadata=None
)
