...
# Classes
traceability_Trace = Class(name="traceability_Trace")
traceability_TraceDiff = Class(name="traceability_TraceDiff")
traceability_EObject = Class(name="traceability_EObject")
traceability_TraceComment = Class(name="traceability_TraceComment")
traceability_LogEntry = Class(name="traceability_LogEntry")
traceability_Traces = Class(name="traceability_Traces")
traceability_DiffCategory = Class(name="traceability_DiffCategory")
traceability_TraceDiffs = Class(name="traceability_TraceDiffs")
traceability_Category = Class(name="traceability_Category")
...
traceability_TraceComment.attributes={traceability_TraceComment_date, traceability_TraceComment_username, traceability_TraceComment_comment, traceability_TraceComment_column}
...
traceability_LogEntry.attributes={traceability_LogEntry_messageType, traceability_LogEntry_comment, traceability_LogEntry_message, traceability_LogEntry_severity}
...
traceability_Traces.attributes={traceability_Traces_username, traceability_Traces_fullName, traceability_Traces_location, traceability_Traces_originalSourceURL, traceability_Traces_date, traceability_Traces_uriMap, traceability_Traces_comments}
...
traceability_DiffCategory.attributes={traceability_DiffCategory_modelIndex, traceability_DiffCategory_unequal, traceability_DiffCategory_name}
...
domain_model = DomainModel(
    name="traceability",
    types={traceability_Trace, traceability_TraceDiff, traceability_EObject, traceability_TraceComment, traceability_LogEntry, traceability_Traces, traceability_DiffCategory, traceability_TraceDiffs, traceability_Category},
    associations={sourceModel16, targetModel18, traces21, source0, target1, children5, parent7, comments9, participants11, comments13, participants24, comments26, diffs29, comparedTraces31, contents33, narrowDown35},
    generalizations={},
    metadata=None
)
