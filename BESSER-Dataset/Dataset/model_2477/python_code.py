...
class traceability_Traces:
    ...
    def __init__(self, username: str, fullName: str, date: date, location: str, comments: str, uriMap: str, originalSourceURL: str, traceability_Traces: "traceability_EObject" = None, traceability_Traces19: "traceability_EObject" = None, traceability_Traces22: set["traceability_EObject"] = None, traceability_Traces32: "traceability_TraceDiffs" = None):
