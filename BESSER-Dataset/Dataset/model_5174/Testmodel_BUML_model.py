...
# Classes
testmodel_SuperInterface = Class(name="testmodel_SuperInterface", is_abstract=True)
testmodel_SuperAbstractClass = Class(name="testmodel_SuperAbstractClass", is_abstract=True)
testmodel_SubAbstractClass7 = Class(name="testmodel_SubAbstractClass7", is_abstract=True)
testmodel_SubClass4 = Class(name="testmodel_SubClass4")
testmodel_SubClass5 = Class(name="testmodel_SubClass5")
testmodel_SubClass6 = Class(name="testmodel_SubClass6")
testmodel_SubClass7 = Class(name="testmodel_SubClass7")
testmodel_SuperClass = Class(name="testmodel_SuperClass")
testmodel_SubInterface1 = Class(name="testmodel_SubInterface1", is_abstract=True)
SuperInterface = Class(name="SuperInterface")
testmodel_SubInterface2 = Class(name="testmodel_SubInterface2", is_abstract=True)
SuperAbstractClass = Class(name="SuperAbstractClass")
testmodel_SubInterface3 = Class(name="testmodel_SubInterface3", is_abstract=True)
SuperClass = Class(name="SuperClass")
testmodel_SubAbstractClass1 = Class(name="testmodel_SubAbstractClass1", is_abstract=True)
testmodel_SubAbstractClass2 = Class(name="testmodel_SubAbstractClass2", is_abstract=True)
testmodel_SubAbstractClass3 = Class(name="testmodel_SubAbstractClass3", is_abstract=True)
testmodel_SubClass1 = Class(name="testmodel_SubClass1")
testmodel_SubClass2 = Class(name="testmodel_SubClass2")
testmodel_SubClass3 = Class(name="testmodel_SubClass3")
testmodel_SubInterface4 = Class(name="testmodel_SubInterface4", is_abstract=True)
SubInterface1 = Class(name="SubInterface1")
SubInterface2 = Class(name="SubInterface2")
testmodel_SubInterface5 = Class(name="testmodel_SubInterface5", is_abstract=True)
SubAbstractClass1 = Class(name="SubAbstractClass1")
testmodel_SubInterface6 = Class(name="testmodel_SubInterface6", is_abstract=True)
SubClass1 = Class(name="SubClass1")
testmodel_SubInterface7 = Class(name="testmodel_SubInterface7", is_abstract=True)
testmodel_SubAbstractClass4 = Class(name="testmodel_SubAbstractClass4", is_abstract=True)
testmodel_SubAbstractClass5 = Class(name="testmodel_SubAbstractClass5", is_abstract=True)
testmodel_SubAbstractClass6 = Class(name="testmodel_SubAbstractClass6", is_abstract=True)
testmodel_A = Class(name="testmodel_A")
testmodel_B = Class(name="testmodel_B")
A = Class(name="A")
testmodel_C = Class(name="testmodel_C")
B = Class(name="B")
testmodel_Source = Class(name="testmodel_Source")
testmodel_Target = Class(name="testmodel_Target")
...
testmodel_C.methods={testmodel_C_m_aOp, testmodel_C_m_bOp}
...
domain_model = DomainModel(
    name="testmodel",
    types={testmodel_SuperInterface, testmodel_SuperAbstractClass, testmodel_SubAbstractClass7, testmodel_SubClass4, testmodel_SubClass5, testmodel_SubClass6, testmodel_SubClass7, testmodel_SuperClass, testmodel_SubInterface1, SuperInterface, testmodel_SubInterface2, SuperAbstractClass, testmodel_SubInterface3, SuperClass, testmodel_SubAbstractClass1, testmodel_SubAbstractClass2, testmodel_SubAbstractClass3, testmodel_SubClass1, testmodel_SubClass2, testmodel_SubClass3, testmodel_SubInterface4, SubInterface1, SubInterface2, testmodel_SubInterface5, SubAbstractClass1, testmodel_SubInterface6, SubClass1, testmodel_SubInterface7, testmodel_SubAbstractClass4, testmodel_SubAbstractClass5, testmodel_SubAbstractClass6, testmodel_A, testmodel_B, A, testmodel_C, B, testmodel_Source, testmodel_Target},
    associations={one_one_no_yes17, one_one_no_no19, one_many_no_no21, zero_one_no_no0, zero_many_no_no1, zero_one_no_yes4, zero_many_no_yes7, one_one_no_no10, one_many_no_no11, many_many_no_no13, one_many_no_yes15, many_many_no_no24, one_many_no_yes27, one_one_no_yes30},
    generalizations={gen_testmodel_SubAbstractClass7_SubAbstractClass1, gen_testmodel_SubAbstractClass7_SubClass1, gen_testmodel_SubClass4_SubInterface1, gen_testmodel_SubClass4_SubInterface2, gen_testmodel_SubClass5_SubInterface1, gen_testmodel_SubClass5_SubAbstractClass1, gen_testmodel_SubClass6_SubInterface1, gen_testmodel_SubClass6_SubClass1, gen_testmodel_SubClass7_SubAbstractClass1, gen_testmodel_SubClass7_SubClass1, gen_testmodel_SubInterface1_SuperInterface, gen_testmodel_SubInterface2_SuperAbstractClass, gen_testmodel_SubInterface3_SuperClass, gen_testmodel_SubAbstractClass1_SuperInterface, gen_testmodel_SubAbstractClass2_SuperAbstractClass, gen_testmodel_SubAbstractClass3_SuperClass, gen_testmodel_SubClass1_SuperInterface, gen_testmodel_SubClass2_SuperAbstractClass, gen_testmodel_SubClass3_SuperClass, gen_testmodel_SubInterface4_SubInterface1, gen_testmodel_SubInterface4_SubInterface2, gen_testmodel_SubInterface5_SubInterface1, gen_testmodel_SubInterface5_SubAbstractClass1, gen_testmodel_SubInterface6_SubInterface1, gen_testmodel_SubInterface6_SubClass1, gen_testmodel_SubInterface7_SubAbstractClass1, gen_testmodel_SubInterface7_SubClass1, gen_testmodel_SubAbstractClass4_SubInterface1, gen_testmodel_SubAbstractClass4_SubInterface2, gen_testmodel_SubAbstractClass5_SubInterface1, gen_testmodel_SubAbstractClass5_SubAbstractClass1, gen_testmodel_SubAbstractClass6_SubInterface1, gen_testmodel_SubAbstractClass6_SubClass1, gen_testmodel_B_A, gen_testmodel_C_B},
    metadata=None
)
