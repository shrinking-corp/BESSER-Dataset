...
statemachine_Transition.attributes={statemachine_Transition_guardLabel, statemachine_Transition_sourceLabel, statemachine_Transition_guardExpression, statemachine_Transition_targetLabel, statemachine_Transition_actionStatement, statemachine_Transition_label, statemachine_Transition_actionLabel}
...
domain_model = DomainModel(
    name="statemachine",
    types={statemachine_StateMachineVariable, statemachine_Transition, Declaration, statemachine_State, statemachine_StateMachine, statemachine_Declaration, statemachine_NormalState, State, statemachine_InitialState, statemachine_FinalState, statemachine_Action},
    associations={declarations0, machineVariables1, source3, to_state4, successors8, entry16, reachable11, to_transitions13},
