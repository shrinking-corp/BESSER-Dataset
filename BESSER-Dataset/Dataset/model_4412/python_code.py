...
class arduino_Level(ModuleInstruction):
    ...
    pass
class arduino_Sensor(BooleanOperator, ModuleInstruction):

    pass
class arduino_Status(ModuleInstruction, Value):

    def __init__(self, status1: bool, Status: "arduino_Sensor" = None, status: "arduino_Sensor" = None):
    ...
    @status1.setter
    def status1(self, status1: bool):
        self.__status1 = status1
...
class arduino_Platform(NamedElement):
    ...
    def __init__(self, image: str, arduino_Platform: "arduino_Hardware" = None, arduino_Platform6: set["arduino_DigitalPin"] = None, arduino_Platform8: set["arduino_AnalogPin"] = None, arduino_Platform25: "arduino_Project" = None):
        self.image = image
...
class arduino_Module(NamedElement):
    ...
    def __init__(self, library: str, kind: str, image: str, level: bool, arduino_Module: "arduino_Hardware" = None, arduino_Module35: "arduino_ModuleInstruction" = None, arduino_Module22: "arduino_Project" = None, arduino_Module42: "arduino_Connector" = None):
...
class Instruction:
    ...
    pass
class arduino_Variable(Value, Instruction):
...
class arduino_Value(Instruction, Parameter):
    ...
    def __init__(self, value: str, arduino_Value46: "arduino_MathOperator" = None, arduino_Value49: "arduino_MathOperator" = None, arduino_Value: "arduino_Level" = None, arduino_Value53: "arduino_Set" = None):
        self.value = value
...
class arduino_Control(Instruction):
    ...
    pass
class arduino_MathOperator(Value, Instruction):
