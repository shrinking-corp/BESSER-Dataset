...
arduino_Function = Class(name="arduino_Function")
arduino_Project = Class(name="arduino_Project")
arduino_Hardware = Class(name="arduino_Hardware")
NamedElement = Class(name="NamedElement")
arduino_Platform = Class(name="arduino_Platform")
arduino_Module = Class(name="arduino_Module", is_abstract=True)
arduino_Connector = Class(name="arduino_Connector")
arduino_DigitalPin = Class(name="arduino_DigitalPin")
arduino_AnalogPin = Class(name="arduino_AnalogPin")
arduino_Status = Class(name="arduino_Status")
ModuleInstruction = Class(name="ModuleInstruction")
Value = Class(name="Value")
arduino_Sensor = Class(name="arduino_Sensor")
arduino_Level = Class(name="arduino_Level")
arduino_Value = Class(name="arduino_Value", is_abstract=True)
...
arduino_BooleanOperator = Class(name="arduino_BooleanOperator")
arduino_MathOperator = Class(name="arduino_MathOperator", is_abstract=True)
arduino_Utilities = Class(name="arduino_Utilities", is_abstract=True)
arduino_IO = Class(name="arduino_IO", is_abstract=True)
arduino_Delay = Class(name="arduino_Delay")
Utilities = Class(name="Utilities")
arduino_InputModule = Class(name="arduino_InputModule")
Module = Class(name="Module")
arduino_OutputModule = Class(name="arduino_OutputModule")
...
arduino_ParameterDefinition = Class(name="arduino_ParameterDefinition")
arduino_Parameter = Class(name="arduino_Parameter", is_abstract=True)
arduino_FunctionCall = Class(name="arduino_FunctionCall")
arduino_ParameterCall = Class(name="arduino_ParameterCall")
arduino_Variable = Class(name="arduino_Variable")
arduino_Set = Class(name="arduino_Set")
arduino_NumericalOperator = Class(name="arduino_NumericalOperator")
MathOperator = Class(name="MathOperator")
arduino_Constant = Class(name="arduino_Constant")
...
arduino_Module.attributes={arduino_Module_kind, arduino_Module_level, arduino_Module_image, arduino_Module_library}
...
domain_model = DomainModel(
    name="arduino",
    types={Pin, arduino_Pin, arduino_Sketch, Instruction, arduino_Instruction, arduino_Function, arduino_Project, arduino_Hardware, NamedElement, arduino_Platform, arduino_Module, arduino_Connector, arduino_DigitalPin, arduino_AnalogPin, arduino_Status, ModuleInstruction, Value, arduino_Sensor, arduino_Level, arduino_Value, arduino_ModuleInstruction, Parameter_, arduino_Control, arduino_While, arduino_BooleanOperator, arduino_MathOperator, arduino_Utilities, arduino_IO, arduino_Delay, Utilities, arduino_InputModule, Module, arduino_OutputModule, arduino_NamedElement, arduino_Repeat, Control, BooleanOperator, arduino_ParameterDefinition, arduino_Parameter, arduino_FunctionCall, arduino_ParameterCall, arduino_Variable, arduino_Set, arduino_NumericalOperator, MathOperator, arduino_Constant, arduino_If, OperatorKind, Time, ModuleKind, ParameterType, Library},
    associations={hardware9, instructions11, functions13, hardware15, sketch17, platforms0, modules1, connectors3, digitalPins5, analogPins7, sensor32, level33, module34, modules20, platform23, previous27, next30, status43, condition44, left45, right47, instructions36, pin38, module40, paramDefs56, instructions58, definition61, definition63, parameters65, definition68, variable50, value51, condition54},
    generalizations={gen_arduino_DigitalPin_Pin, gen_arduino_AnalogPin_Pin, gen_arduino_Sketch_NamedElement, gen_arduino_Sketch_Instruction, gen_arduino_Hardware_NamedElement, gen_arduino_Platform_NamedElement, gen_arduino_Module_NamedElement, gen_arduino_Status_ModuleInstruction, gen_arduino_Status_Value, gen_arduino_Level_ModuleInstruction, gen_arduino_ModuleInstruction_Instruction, gen_arduino_ModuleInstruction_Parameter, gen_arduino_Control_Instruction, gen_arduino_Sensor_BooleanOperator, gen_arduino_While_Control, gen_arduino_MathOperator_Value, gen_arduino_MathOperator_Instruction, gen_arduino_Utilities_Instruction, gen_arduino_Utilities_Parameter, gen_arduino_IO_Instruction, gen_arduino_Delay_Utilities, gen_arduino_InputModule_Module, gen_arduino_OutputModule_Module, gen_arduino_Repeat_Control, gen_arduino_Sensor_ModuleInstruction, gen_arduino_FunctionCall_Instruction, gen_arduino_ParameterCall_Instruction, gen_arduino_Variable_Value, gen_arduino_Variable_Instruction, gen_arduino_Set_Instruction, gen_arduino_NumericalOperator_MathOperator, gen_arduino_BooleanOperator_MathOperator, gen_arduino_Value_Instruction, gen_arduino_Value_Parameter, gen_arduino_Constant_Value, gen_arduino_If_Control},
    metadata=None
)
