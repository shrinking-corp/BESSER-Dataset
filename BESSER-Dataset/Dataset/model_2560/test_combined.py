...
def test_hyp_hlstree_hlsnode_is_not_abstract():
    assert not inspect.isabstract(HLSTree_HLSNode)


def test_hyp_hlstree_hlsnode_constructor_exists():
    assert callable(HLSTree_HLSNode.__init__)


def test_hyp_hlstree_hlsnode_constructor_args():
...
def test_hyp_hlstree_hlsnode_hls_setter(instance):
...
@given(instance=HLSTree_HLSNode_strategy)
def test_hyp_hlstree_hlsnode_name_setter(instance):
