...
Muhasebe_Actor = Class(name="Muhasebe_Actor")
Muhasebe2_Actor = Class(name="Muhasebe2_Actor")
muhasebe_Actor = Class(name="muhasebe_Actor")
personnel_info_Actor = Class(name="personnel_info_Actor")
Accountancy_Actor = Class(name="Accountancy_Actor")
...
# Muhasebe_Actor class attributes and methods

# Muhasebe2_Actor class attributes and methods

# muhasebe_Actor class attributes and methods

# personnel_info_Actor class attributes and methods

# Accountancy_Actor class attributes and methods
...
domain_model = DomainModel(
    name="_72e428b0_7756_4338_aace_8605e17fa979",
    types={ShoppingCartExample_ShoppingCart, ShoppingCartExample_Order, ShoppingCartExample_LineItem, ShoppingCartExample_Account, ShoppingCartExample_Customer, Muhasebe_Actor, Muhasebe2_Actor, muhasebe_Actor, personnel_info_Actor, Accountancy_Actor},
