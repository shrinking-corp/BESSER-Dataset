...
BankAccount_ClassA: BinaryAssociation = BinaryAssociation(
    name="BankAccount_ClassA",
    ends={
        Property(name="classA6", type=ClassA, multiplicity=Multiplicity(0, 1)),
        Property(name="bankAccount7", type=BankAccount, multiplicity=Multiplicity(0, 1))
    }
)

# Domain Model
domain_model = DomainModel(
    name="c5127f29_b010_40ba_9dd9_2ad6b2adcf07",
    ...
    associations={ClassD_ClassE, ClassD_ClassECopy, ClassD_ClassECopyCopy, BankAccount_ClassA},
    generalizations={},
    metadata=None
)
