...
def test_hyp_gast_statements_var_is_not_abstract():
    assert not inspect.isabstract(gast_statements_Var)


def test_hyp_gast_statements_var_constructor_exists():
    assert callable(gast_statements_Var.__init__)


def test_hyp_gast_statements_var_constructor_args():
...
def test_hyp_statements_flowinstr_is_not_abstract():
    assert not inspect.isabstract(statements_FlowInstr)


def test_hyp_statements_flowinstr_constructor_exists():
    assert callable(statements_FlowInstr.__init__)


def test_hyp_statements_flowinstr_constructor_args():
...
def test_hyp_gast_statements_param_is_not_abstract():
    assert not inspect.isabstract(gast_statements_Param)


def test_hyp_gast_statements_param_constructor_exists():
    assert callable(gast_statements_Param.__init__)


def test_hyp_gast_statements_param_constructor_args():
    sig = inspect.signature(gast_statements_Param.__init__)
    params = list(sig.parameters.keys())



def test_hyp_gast_statements_flowinstr_is_not_abstract():
    assert not inspect.isabstract(gast_statements_FlowInstr)


def test_hyp_gast_statements_flowinstr_constructor_exists():
    assert callable(gast_statements_FlowInstr.__init__)


def test_hyp_gast_statements_flowinstr_constructor_args():
...
def test_hyp_statements_blockstatement_is_not_abstract():
    assert not inspect.isabstract(statements_BlockStatement)


def test_hyp_statements_blockstatement_constructor_exists():
    assert callable(statements_BlockStatement.__init__)


def test_hyp_statements_blockstatement_constructor_args():
...
def test_hyp_gast_statements_var_name_setter(instance):
...
def test_hyp_gast_statements_flowinstr_txt_setter(instance):
