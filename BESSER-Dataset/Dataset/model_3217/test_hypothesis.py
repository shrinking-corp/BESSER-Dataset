...
def test_gast_statements_var_is_not_abstract():
    assert not inspect.isabstract(gast_statements_Var)


def test_gast_statements_var_constructor_exists():
    assert callable(gast_statements_Var.__init__)


def test_gast_statements_var_constructor_args():
    sig = inspect.signature(gast_statements_Var.__init__)
    params = list(sig.parameters.keys())
    assert "name" in params, "Missing parameter 'name'"

def test_gast_statements_var_has_name():
    assert hasattr(gast_statements_Var, "name")
    descriptor = None
    for klass in gast_statements_Var.__mro__:
...
def test_statements_flowinstr_is_not_abstract():
    assert not inspect.isabstract(statements_FlowInstr)


def test_statements_flowinstr_constructor_exists():
    assert callable(statements_FlowInstr.__init__)


def test_statements_flowinstr_constructor_args():
    sig = inspect.signature(statements_FlowInstr.__init__)
    params = list(sig.parameters.keys())
...
def test_gast_statements_param_is_not_abstract():
    assert not inspect.isabstract(gast_statements_Param)


def test_gast_statements_param_constructor_exists():
    assert callable(gast_statements_Param.__init__)


def test_gast_statements_param_constructor_args():
    sig = inspect.signature(gast_statements_Param.__init__)
    params = list(sig.parameters.keys())



def test_gast_statements_flowinstr_is_not_abstract():
    assert not inspect.isabstract(gast_statements_FlowInstr)


def test_gast_statements_flowinstr_constructor_exists():
    assert callable(gast_statements_FlowInstr.__init__)


def test_gast_statements_flowinstr_constructor_args():
    sig = inspect.signature(gast_statements_FlowInstr.__init__)
    params = list(sig.parameters.keys())
    assert "txt" in params, "Missing parameter 'txt'"

def test_gast_statements_flowinstr_has_txt():
    assert hasattr(gast_statements_FlowInstr, "txt")
    descriptor = None
    for klass in gast_statements_FlowInstr.__mro__:
...
def test_gast_statements_exit_is_not_abstract():
    assert not inspect.isabstract(gast_statements_Exit)


def test_gast_statements_exit_constructor_exists():
    assert callable(gast_statements_Exit.__init__)


def test_gast_statements_exit_constructor_args():
    sig = inspect.signature(gast_statements_Exit.__init__)
    params = list(sig.parameters.keys())
    assert "name" in params, "Missing parameter 'name'"

def test_gast_statements_exit_has_name():
    assert hasattr(gast_statements_Exit, "name")
    descriptor = None
    for klass in gast_statements_Exit.__mro__:
        if "name" in klass.__dict__:
            descriptor = klass.__dict__["name"]
            break
    assert isinstance(descriptor, property)
...
def test_statements_blockstatement_is_not_abstract():
    assert not inspect.isabstract(statements_BlockStatement)


def test_statements_blockstatement_constructor_exists():
    assert callable(statements_BlockStatement.__init__)


def test_statements_blockstatement_constructor_args():
    sig = inspect.signature(statements_BlockStatement.__init__)
    params = list(sig.parameters.keys())



def test_gast_statements_methods_is_not_abstract():
    assert not inspect.isabstract(gast_statements_Methods)


def test_gast_statements_methods_constructor_exists():
    assert callable(gast_statements_Methods.__init__)


def test_gast_statements_methods_constructor_args():
    sig = inspect.signature(gast_statements_Methods.__init__)
    params = list(sig.parameters.keys())
    assert "methodName" in params, "Missing parameter 'methodName'"

def test_gast_statements_methods_has_methodName():
    assert hasattr(gast_statements_Methods, "methodName")
    descriptor = None
    for klass in gast_statements_Methods.__mro__:
...
gast_statements_Var_strategy = st.builds(
    gast_statements_Var,
    name=
        safe_text
)
...
statements_FlowInstr_strategy = st.builds(
    statements_FlowInstr,
)
...
gast_statements_Param_strategy = st.builds(
    gast_statements_Param,
)
gast_statements_FlowInstr_strategy = st.builds(
    gast_statements_FlowInstr,
    txt=
        safe_text
)
...
statements_BlockStatement_strategy = st.builds(
    statements_BlockStatement,
)
...
@given(instance=gast_statements_Var_strategy)
def test_gast_statements_var_name_setter(instance):
...
@given(instance=gast_statements_FlowInstr_strategy)
def test_gast_statements_flowinstr_txt_setter(instance):
...
@given(instance=gast_statements_Exit_strategy)
def test_gast_statements_exit_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=gast_statements_Methods_strategy)
def test_gast_statements_methods_methodName_setter(instance):
