...
# Classes
SysML_ValueTypes_QUDV_ROOT_RESOURCE_SHAPE_CONTAINER = Class(name="SysML_ValueTypes_QUDV_ROOT_RESOURCE_SHAPE_CONTAINER")
...
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Integer = Class(name="SysML_ValueTypes_QUDV_PrimitiveValueTypes_Integer")
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Number = Class(name="SysML_ValueTypes_QUDV_PrimitiveValueTypes_Number", is_abstract=True)
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Complex = Class(name="SysML_ValueTypes_QUDV_PrimitiveValueTypes_Complex")
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Rational = Class(name="SysML_ValueTypes_QUDV_PrimitiveValueTypes_Rational")
Integer = Class(name="Integer")
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Real = Class(name="SysML_ValueTypes_QUDV_PrimitiveValueTypes_Real")
SysML_ValueTypes_QUDV_UnitAndQuantityKind_Unit = Class(name="SysML_ValueTypes_QUDV_UnitAndQuantityKind_Unit")
SysML_ValueTypes_QUDV_UnitAndQuantityKind_QuantityKind = Class(name="SysML_ValueTypes_QUDV_UnitAndQuantityKind_QuantityKind")
SysML_ValueTypes_QUDV_QUDV_ConversionBasedUnit = Class(name="SysML_ValueTypes_QUDV_QUDV_ConversionBasedUnit", is_abstract=True)
SysML_ValueTypes_QUDV_QUDV_AffineConversionUnit = Class(name="SysML_ValueTypes_QUDV_QUDV_AffineConversionUnit")
ConversionBasedUnit = Class(name="ConversionBasedUnit")
SysML_ValueTypes_QUDV_QUDV_DerivedUnit = Class(name="SysML_ValueTypes_QUDV_QUDV_DerivedUnit")
SysML_ValueTypes_QUDV_QUDV_Dimension = Class(name="SysML_ValueTypes_QUDV_QUDV_Dimension")
SysML_ValueTypes_QUDV_QUDV_DerivedQuantityKind = Class(name="SysML_ValueTypes_QUDV_QUDV_DerivedQuantityKind")
SysML_ValueTypes_QUDV_QUDV_LinearConversionUnit = Class(name="SysML_ValueTypes_QUDV_QUDV_LinearConversionUnit")
SysML_ValueTypes_QUDV_QUDV_GeneralConversionUnit = Class(name="SysML_ValueTypes_QUDV_QUDV_GeneralConversionUnit")
Rational = Class(name="Rational")
SysML_ValueTypes_QUDV_QUDV_PrefixedUnit = Class(name="SysML_ValueTypes_QUDV_QUDV_PrefixedUnit")
SysML_ValueTypes_QUDV_QUDV_Prefix = Class(name="SysML_ValueTypes_QUDV_QUDV_Prefix")
SysML_ValueTypes_QUDV_QUDV_QuantityKind = Class(name="SysML_ValueTypes_QUDV_QUDV_QuantityKind", is_abstract=True)
SysML_ValueTypes_QUDV_QUDV_SimpleQuantityKind = Class(name="SysML_ValueTypes_QUDV_QUDV_SimpleQuantityKind")
SysML_ValueTypes_QUDV_QUDV_QuantityKindFactor = Class(name="SysML_ValueTypes_QUDV_QUDV_QuantityKindFactor")
SysML_ValueTypes_QUDV_QUDV_SimpleUnit = Class(name="SysML_ValueTypes_QUDV_QUDV_SimpleUnit")
SysML_ValueTypes_QUDV_QUDV_SystemOfQuantities = Class(name="SysML_ValueTypes_QUDV_QUDV_SystemOfQuantities")
SysML_ValueTypes_QUDV_QUDV_SystemOfUnits = Class(name="SysML_ValueTypes_QUDV_QUDV_SystemOfUnits")
SysML_ValueTypes_QUDV_QUDV_Unit = Class(name="SysML_ValueTypes_QUDV_QUDV_Unit", is_abstract=True)
SysML_ValueTypes_QUDV_QUDV_UnitFactor = Class(name="SysML_ValueTypes_QUDV_QUDV_UnitFactor")
...
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Integer_m_equals: Method = Method(name="equals", parameters={Parameter(name='SysML_ValueTypes_QUDV_x', type=StringType)})
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Integer_m_lessOrEqual: Method = Method(name="lessOrEqual", parameters={Parameter(name='SysML_ValueTypes_QUDV_x', type=StringType)})
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Integer_m_lessThan: Method = Method(name="lessThan", parameters={Parameter(name='SysML_ValueTypes_QUDV_x', type=StringType)})
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Integer_m_plus: Method = Method(name="plus", parameters={Parameter(name='SysML_ValueTypes_QUDV_x', type=StringType)}, type=StringType)
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Integer_m_times: Method = Method(name="times", parameters={Parameter(name='SysML_ValueTypes_QUDV_x', type=StringType)}, type=StringType)
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Integer.methods={SysML_ValueTypes_QUDV_PrimitiveValueTypes_Integer_m_lessOrEqual, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Integer_m_plus, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Integer_m_lessThan, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Integer_m_equals, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Integer_m_times}
...
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Number_m_equals: Method = Method(name="equals", parameters={Parameter(name='SysML_ValueTypes_QUDV_x', type=StringType)})
...
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Complex_m_equals: Method = Method(name="equals", parameters={Parameter(name='SysML_ValueTypes_QUDV_x', type=StringType)})
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Complex_m_lessOrEqual: Method = Method(name="lessOrEqual", parameters={Parameter(name='SysML_ValueTypes_QUDV_x', type=StringType)})
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Complex_m_lessThan: Method = Method(name="lessThan", parameters={Parameter(name='SysML_ValueTypes_QUDV_x', type=StringType)})
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Complex_m_plus: Method = Method(name="plus", parameters={Parameter(name='SysML_ValueTypes_QUDV_x', type=StringType)}, type=StringType)
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Complex_m_times: Method = Method(name="times", parameters={Parameter(name='SysML_ValueTypes_QUDV_x', type=StringType)}, type=StringType)
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Complex.methods={SysML_ValueTypes_QUDV_PrimitiveValueTypes_Complex_m_lessThan, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Complex_m_plus, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Complex_m_equals, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Complex_m_lessOrEqual, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Complex_m_times}

# SysML_ValueTypes_QUDV_PrimitiveValueTypes_Rational class attributes and methods
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Rational_m_equivalent: Method = Method(name="equivalent", parameters={Parameter(name='SysML_ValueTypes_QUDV_r', type=StringType)})
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Rational_m_plus: Method = Method(name="plus", parameters={Parameter(name='SysML_ValueTypes_QUDV_r', type=StringType)}, type=StringType)
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Rational_m_times: Method = Method(name="times", parameters={Parameter(name='SysML_ValueTypes_QUDV_r', type=StringType)}, type=StringType)
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Rational.methods={SysML_ValueTypes_QUDV_PrimitiveValueTypes_Rational_m_equivalent, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Rational_m_plus, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Rational_m_times}

# Integer class attributes and methods

# SysML_ValueTypes_QUDV_PrimitiveValueTypes_Real class attributes and methods
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Real_m_equals: Method = Method(name="equals", parameters={Parameter(name='SysML_ValueTypes_QUDV_x', type=StringType)})
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Real_m_lessOrEqual: Method = Method(name="lessOrEqual", parameters={Parameter(name='SysML_ValueTypes_QUDV_x', type=StringType)})
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Real_m_lessThan: Method = Method(name="lessThan", parameters={Parameter(name='SysML_ValueTypes_QUDV_x', type=StringType)})
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Real_m_plus: Method = Method(name="plus", parameters={Parameter(name='SysML_ValueTypes_QUDV_x', type=StringType)}, type=StringType)
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Real_m_times: Method = Method(name="times", parameters={Parameter(name='SysML_ValueTypes_QUDV_x', type=StringType)}, type=StringType)
SysML_ValueTypes_QUDV_PrimitiveValueTypes_Real.methods={SysML_ValueTypes_QUDV_PrimitiveValueTypes_Real_m_plus, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Real_m_times, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Real_m_lessOrEqual, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Real_m_lessThan, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Real_m_equals}
...
SysML_ValueTypes_QUDV_UnitAndQuantityKind_Unit.attributes={SysML_ValueTypes_QUDV_UnitAndQuantityKind_Unit_name, SysML_ValueTypes_QUDV_UnitAndQuantityKind_Unit_definitionURI, SysML_ValueTypes_QUDV_UnitAndQuantityKind_Unit_description, SysML_ValueTypes_QUDV_UnitAndQuantityKind_Unit_symbol}
...
SysML_ValueTypes_QUDV_UnitAndQuantityKind_QuantityKind.attributes={SysML_ValueTypes_QUDV_UnitAndQuantityKind_QuantityKind_definitionURI, SysML_ValueTypes_QUDV_UnitAndQuantityKind_QuantityKind_symbol, SysML_ValueTypes_QUDV_UnitAndQuantityKind_QuantityKind_description, SysML_ValueTypes_QUDV_UnitAndQuantityKind_QuantityKind_name}
...
SysML_ValueTypes_QUDV_QUDV_GeneralConversionUnit.attributes={SysML_ValueTypes_QUDV_QUDV_GeneralConversionUnit_expression, SysML_ValueTypes_QUDV_QUDV_GeneralConversionUnit_expressionLanguageURI}
...
SysML_ValueTypes_QUDV_QUDV_SystemOfQuantities_m_getDimension: Method = Method(name="getDimension", parameters={Parameter(name='SysML_ValueTypes_QUDV_qk', type=StringType)}, type=StringType)
SysML_ValueTypes_QUDV_QUDV_SystemOfQuantities.attributes={SysML_ValueTypes_QUDV_QUDV_SystemOfQuantities_symbol, SysML_ValueTypes_QUDV_QUDV_SystemOfQuantities_definitionURI, SysML_ValueTypes_QUDV_QUDV_SystemOfQuantities_name, SysML_ValueTypes_QUDV_QUDV_SystemOfQuantities_description}
SysML_ValueTypes_QUDV_QUDV_SystemOfQuantities.methods={SysML_ValueTypes_QUDV_QUDV_SystemOfQuantities_m_allAccessibleSystemOfQuantities, SysML_ValueTypes_QUDV_QUDV_SystemOfQuantities_m_allAccessibleQuantityKinds, SysML_ValueTypes_QUDV_QUDV_SystemOfQuantities_m_allQuantityKinds, SysML_ValueTypes_QUDV_QUDV_SystemOfQuantities_m_allIncludedSystemOfQuantities, SysML_ValueTypes_QUDV_QUDV_SystemOfQuantities_m_getDimension, SysML_ValueTypes_QUDV_QUDV_SystemOfQuantities_m_allBaseQuantityKinds}
...
SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_getUnit: Method = Method(name="getUnit", parameters={Parameter(name='SysML_ValueTypes_QUDV_name', type=StringType)}, type=StringType)
...
SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_getAdoptedQuantityKindForAdoptedBaseUnitOfMeasurementUnit: Method = Method(name="getAdoptedQuantityKindForAdoptedBaseUnitOfMeasurementUnit", parameters={Parameter(name='SysML_ValueTypes_QUDV_u', type=StringType)}, type=StringType)
...
SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_getKindOfQuantitiesForMeasurementUnit: Method = Method(name="getKindOfQuantitiesForMeasurementUnit", parameters={Parameter(name='SysML_ValueTypes_QUDV_u', type=StringType)}, type=StringType)
SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_isCoherent: Method = Method(name="isCoherent", parameters={Parameter(name='SysML_ValueTypes_QUDV_du', type=StringType)})
...
SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_getAdoptedBaseUnitForMeasurementUnit: Method = Method(name="getAdoptedBaseUnitForMeasurementUnit", parameters={Parameter(name='SysML_ValueTypes_QUDV_u', type=StringType)}, type=StringType)
SysML_ValueTypes_QUDV_QUDV_SystemOfUnits.attributes={SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_symbol, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_description, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_definitionURI, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_name}
SysML_ValueTypes_QUDV_QUDV_SystemOfUnits.methods={SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_allPrefixes, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_allAccessibleUnits, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_getEffectiveSystemOfQuantities, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_allAccessibleSystemOfUnits, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_isCoherent, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_allIncludedSystemOfUnits, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_getAdoptedQuantityKindForAdoptedBaseUnitOfMeasurementUnit, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_getUnit, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_getKindOfQuantitiesForMeasurementUnit, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_isCoherent, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_allMeasurementUnitsDefinedForSomeQuantityKind, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_allBaseQuantityKinds, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_allUnits, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_allBaseUnits, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits_m_getAdoptedBaseUnitForMeasurementUnit}
...
SysML_ValueTypes_QUDV_QUDV_Unit.attributes={SysML_ValueTypes_QUDV_QUDV_Unit_isUnitForQuantityOfDimensionOne, SysML_ValueTypes_QUDV_QUDV_Unit_isUnitCountOfEntities}
...
domain_model = DomainModel(
    ...
    types={SysML_ValueTypes_QUDV_ROOT_RESOURCE_SHAPE_CONTAINER, Number, QuantityKind, Unit, Dimension, Prefix, QuantityKindFactor, SystemOfQuantities, SystemOfUnits, UnitFactor, Real, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Integer, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Number, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Complex, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Rational, Integer, SysML_ValueTypes_QUDV_PrimitiveValueTypes_Real, SysML_ValueTypes_QUDV_UnitAndQuantityKind_Unit, SysML_ValueTypes_QUDV_UnitAndQuantityKind_QuantityKind, SysML_ValueTypes_QUDV_QUDV_ConversionBasedUnit, SysML_ValueTypes_QUDV_QUDV_AffineConversionUnit, ConversionBasedUnit, SysML_ValueTypes_QUDV_QUDV_DerivedUnit, SysML_ValueTypes_QUDV_QUDV_Dimension, SysML_ValueTypes_QUDV_QUDV_DerivedQuantityKind, SysML_ValueTypes_QUDV_QUDV_LinearConversionUnit, SysML_ValueTypes_QUDV_QUDV_GeneralConversionUnit, Rational, SysML_ValueTypes_QUDV_QUDV_PrefixedUnit, SysML_ValueTypes_QUDV_QUDV_Prefix, SysML_ValueTypes_QUDV_QUDV_QuantityKind, SysML_ValueTypes_QUDV_QUDV_SimpleQuantityKind, SysML_ValueTypes_QUDV_QUDV_QuantityKindFactor, SysML_ValueTypes_QUDV_QUDV_SimpleUnit, SysML_ValueTypes_QUDV_QUDV_SystemOfQuantities, SysML_ValueTypes_QUDV_QUDV_SystemOfUnits, SysML_ValueTypes_QUDV_QUDV_Unit, SysML_ValueTypes_QUDV_QUDV_UnitFactor},
    associations={number0, quantityKind1, unit3, dimension5, prefix7, quantityKindFactor9, systemOfQuantities11, systemOfUnits13, unitFactor15, realPart17, imaginaryPart18, numerator21, denominator22, quantityKind25, factor27, offset29, referenceUnit32, factor34, factor36, factor38, factor40, factor42, dependsOnQuantityKinds45, general47, prefix43, exponent50, quantityKind52, includedSystemOfQuantities57, quantityKind60, usedSystemOfQuantities63, baseQuantityKind55, includedSystemOfUnits68, prefix71, baseUnit66, usedSystemOfUnits80, systemOfQuantities74, unit77, general85, exponent88, dependsOnUnits83, unit90},
    generalizations={gen_SysML_ValueTypes_QUDV_PrimitiveValueTypes_Integer_Number, gen_SysML_ValueTypes_QUDV_PrimitiveValueTypes_Complex_Number, gen_SysML_ValueTypes_QUDV_PrimitiveValueTypes_Rational_Number, gen_SysML_ValueTypes_QUDV_PrimitiveValueTypes_Real_Number, gen_SysML_ValueTypes_QUDV_QUDV_ConversionBasedUnit_Unit, gen_SysML_ValueTypes_QUDV_QUDV_AffineConversionUnit_ConversionBasedUnit, gen_SysML_ValueTypes_QUDV_QUDV_DerivedUnit_Unit, gen_SysML_ValueTypes_QUDV_QUDV_DerivedQuantityKind_QuantityKind, gen_SysML_ValueTypes_QUDV_QUDV_LinearConversionUnit_ConversionBasedUnit, gen_SysML_ValueTypes_QUDV_QUDV_GeneralConversionUnit_ConversionBasedUnit, gen_SysML_ValueTypes_QUDV_QUDV_PrefixedUnit_ConversionBasedUnit, gen_SysML_ValueTypes_QUDV_QUDV_QuantityKind_QuantityKind, gen_SysML_ValueTypes_QUDV_QUDV_SimpleQuantityKind_QuantityKind, gen_SysML_ValueTypes_QUDV_QUDV_SimpleUnit_Unit, gen_SysML_ValueTypes_QUDV_QUDV_Unit_Unit},
    metadata=None
)
