...
def test_hyp_architecturetool_classmember_is_not_abstract():
    assert not inspect.isabstract(architectureTool_classMember)


def test_hyp_architecturetool_classmember_constructor_exists():
    assert callable(architectureTool_classMember.__init__)


def test_hyp_architecturetool_classmember_constructor_args():
...
def test_hyp_architecturetool_method_is_not_abstract():
    assert not inspect.isabstract(architectureTool_Method)


def test_hyp_architecturetool_method_constructor_exists():
    assert callable(architectureTool_Method.__init__)


def test_hyp_architecturetool_method_constructor_args():
...
def test_hyp_architecturetool_attribute_is_not_abstract():
    assert not inspect.isabstract(architectureTool_Attribute)


def test_hyp_architecturetool_attribute_constructor_exists():
    assert callable(architectureTool_Attribute.__init__)


def test_hyp_architecturetool_attribute_constructor_args():
...
def test_hyp_architecturetool_system_is_not_abstract():
    assert not inspect.isabstract(architectureTool_System)


def test_hyp_architecturetool_system_constructor_exists():
    assert callable(architectureTool_System.__init__)


def test_hyp_architecturetool_system_constructor_args():
...
def test_hyp_architecturetool_interface_is_not_abstract():
    assert not inspect.isabstract(architectureTool_Interface)


def test_hyp_architecturetool_interface_constructor_exists():
    assert callable(architectureTool_Interface.__init__)


def test_hyp_architecturetool_interface_constructor_args():
    sig = inspect.signature(architectureTool_Interface.__init__)
    params = list(sig.parameters.keys())



def test_hyp_architecturetool_class_is_not_abstract():
    assert not inspect.isabstract(architectureTool_Class)


def test_hyp_architecturetool_class_constructor_exists():
    assert callable(architectureTool_Class.__init__)


def test_hyp_architecturetool_class_constructor_args():
    sig = inspect.signature(architectureTool_Class.__init__)
    params = list(sig.parameters.keys())



def test_hyp_architecturetool_component_is_not_abstract():
    assert not inspect.isabstract(architectureTool_Component)


def test_hyp_architecturetool_component_constructor_exists():
    assert callable(architectureTool_Component.__init__)


def test_hyp_architecturetool_component_constructor_args():
...
def test_hyp_architecturetool_port_is_not_abstract():
    assert not inspect.isabstract(architectureTool_Port)


def test_hyp_architecturetool_port_constructor_exists():
    assert callable(architectureTool_Port.__init__)


def test_hyp_architecturetool_port_constructor_args():
...
def test_hyp_architecturetool_classmember_name_setter(instance):
...
def test_hyp_architecturetool_method_parameter_setter(instance):
...
@given(instance=architectureTool_Method_strategy)
def test_hyp_architecturetool_method_visable_setter(instance):
...
@given(instance=architectureTool_Method_strategy)
def test_hyp_architecturetool_method_returnType_setter(instance):
...
@given(instance=architectureTool_Method_strategy)
def test_hyp_architecturetool_method_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_architecturetool_attribute_Visable_setter(instance):
    original = instance.Visable
    instance.Visable = original
    assert instance.Visable == original
...
@given(instance=architectureTool_Attribute_strategy)
def test_hyp_architecturetool_attribute_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=architectureTool_Attribute_strategy)
def test_hyp_architecturetool_attribute_type_setter(instance):
...
def test_hyp_architecturetool_system_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_architecturetool_component_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_architecturetool_port_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=architectureTool_Port_strategy)
def test_hyp_architecturetool_port_simple_setter(instance):
...
@given(instance=architectureTool_Port_strategy)
def test_hyp_architecturetool_port_provided_setter(instance):
...
@given(instance=architectureTool_Port_strategy)
def test_hyp_architecturetool_port_type_setter(instance):
    original = instance.type
    instance.type = original
    assert instance.type == original
...
@given(instance=architectureTool_Port_strategy)
def test_hyp_architecturetool_port_required_setter(instance):
