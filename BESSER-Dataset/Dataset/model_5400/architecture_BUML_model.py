...
# Classes
architectureTool_Port = Class(name="architectureTool_Port", is_abstract=True)
architectureTool_Component = Class(name="architectureTool_Component")
architectureTool_Class = Class(name="architectureTool_Class")
architectureTool_Interface = Class(name="architectureTool_Interface")
architectureTool_System = Class(name="architectureTool_System")
classMember = Class(name="classMember")
architectureTool_Attribute = Class(name="architectureTool_Attribute")
architectureTool_Method = Class(name="architectureTool_Method")
architectureTool_classMember = Class(name="architectureTool_classMember", is_abstract=True)
...
architectureTool_Port.attributes={architectureTool_Port_name, architectureTool_Port_type, architectureTool_Port_provided, architectureTool_Port_simple, architectureTool_Port_required}
...
architectureTool_Attribute.attributes={architectureTool_Attribute_Visable, architectureTool_Attribute_type, architectureTool_Attribute_name}
...
architectureTool_Method.attributes={architectureTool_Method_parameter, architectureTool_Method_name, architectureTool_Method_visable, architectureTool_Method_returnType}
...
class_4: BinaryAssociation = BinaryAssociation(
    name="class_4",
    ends={
...
domain_model = DomainModel(
    ...
    types={architectureTool_Port, architectureTool_Component, architectureTool_Class, architectureTool_Interface, architectureTool_System, classMember, architectureTool_Attribute, architectureTool_Method, architectureTool_classMember},
    associations={portOfComponent0, componentDependence2, SystemDependence28, componentOfSystem29, portOfSystem32, class_4, componentOfComponent7, interfaceOfComponent9, ComponentDependence11, Association13, InterfaceAbstract15, Generalization19, composition22, Aggregation25, InterfaceDependence59, requiredRealize61, System36, interfaceOfSystem38, ComponentDependence41, providedRealize43, portDependence47, requiredRealize49, providedRealize52, InterfaceRealize55, attribute64, method65},
    generalizations={gen_architectureTool_Class_classMember, gen_architectureTool_Interface_classMember},
    metadata=None
)
