...
class architectureTool_System:
    ...
    def __init__(self, name: str, architectureTool_System39: set["architectureTool_Interface"] = None, ComponentDependence42: set["architectureTool_Component"] = None, architectureTool_System: "architectureTool_System" = None, architectureTool_System27: set["architectureTool_System"] = None, architectureTool_System30: set["architectureTool_Component"] = None, architectureTool_System33: set["architectureTool_Port"] = None, System: "architectureTool_Component" = None, architectureTool_System37: "architectureTool_System" = None, architectureTool_System35: set["architectureTool_System"] = None):
        self.name = name
...
class architectureTool_Component:
    ...
    def __init__(self, name: str, Component: "architectureTool_System" = None, architectureTool_Component: set["architectureTool_Port"] = None, architectureTool_Component3: "architectureTool_Component" = None, architectureTool_Component1: set["architectureTool_Component"] = None, architectureTool_Component31: "architectureTool_System" = None, architectureTool_Component5: set["architectureTool_Class"] = None, architectureTool_Component8: "architectureTool_Component" = None, architectureTool_Component6: set["architectureTool_Component"] = None, architectureTool_Component10: set["architectureTool_Interface"] = None, ComponentDependence: set["architectureTool_System"] = None):
        self.name = name
...
class architectureTool_Port(ABC):
    ...
    def __init__(self, type: str, simple: str, provided: str, required: str, name: str, architectureTool_Port44: set["architectureTool_Interface"] = None, architectureTool_Port48: "architectureTool_Port" = None, architectureTool_Port46: set["architectureTool_Port"] = None, architectureTool_Port50: set["architectureTool_Interface"] = None, architectureTool_Port54: "architectureTool_Interface" = None, architectureTool_Port: "architectureTool_Component" = None, architectureTool_Port34: "architectureTool_System" = None, architectureTool_Port63: "architectureTool_Interface" = None):
        self.type = type
        self.simple = simple
