...
dutycalls_model_Dealer_SINGLEPLAYER.attributes={dutycalls_model_Dealer_SINGLEPLAYER_bet, dutycalls_model_Dealer_SINGLEPLAYER_allIn, dutycalls_model_Dealer_SINGLEPLAYER_main_userList, dutycalls_model_Dealer_SINGLEPLAYER_deck, dutycalls_model_Dealer_SINGLEPLAYER_openBet, dutycalls_model_Dealer_SINGLEPLAYER_tableValue, dutycalls_model_Dealer_SINGLEPLAYER_userList}
...
domain_model = DomainModel(
    name="ee3e7ba1_e366_44da_89ab_d84907b33026",
    types={dutycalls_view_JoinGame, dutycalls_view_PokerTable, dutycalls_view_WaitingForPlayer, dutycalls_view_User, dutycalls_model_AIUser, dutycalls_model_Dealer_SINGLEPLAYER, dutycalls_model_BestHand, dutycalls_model_Deck, dutycalls_model_Card, dutycalls_model_PlayerHand, dutycalls_model_PokerHand, dutycalls_model_GameType, dutycalls_model_WildHand, dutycalls_model_Suit, dutycalls_model_Value, dutycalls_model_User_S, dutycalls_contoller_Dealer_Control, dutycalls_contoller_HomeControl, dutycalls_view_About, dutycalls_view_Home, dutycalls_view_Instructions, List_Card_, List_User_S_},
    associations={},
    generalizations={},
    metadata=None
)
