...
Property_.attributes={Property__location, Property__property_type, Property__address, Property__property_id}
...
Payment.attributes={Payment_pay_mode, Payment_card_no, Payment_ex_date, Payment_pay_id, Payment_pay_amount}
...
Requirement.attributes={Requirement_req_description, Requirement_user_id, Requirement_requirement_location, Requirement_requirement_type}
...
Request.attributes={Request_request_details, Request_requser_id, Request_request_id, Request_request_type}
...
Advertiesment.attributes={Advertiesment_start_date, Advertiesment_end_date, Advertiesment_advertiser_id, Advertiesment_advertiesment_id}
...
domain_model = DomainModel(
    ...
    associations={Property_Buyer, Reg_User_Requirement, Property_Management, Payment_Reg_User, Payment_Property, User_Administrator, Advertiser_Advertiesment, Property_Seller, User_Request},
    generalizations={},
    metadata=None
)
