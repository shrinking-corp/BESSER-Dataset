...
# Classes
mapkey_Book = Class(name="mapkey_Book")
mapkey_StringToWriterMapEntry = Class(name="mapkey_StringToWriterMapEntry")
mapkey_Writer = Class(name="mapkey_Writer")
...
domain_model = DomainModel(
    name="mapkey",
    types={mapkey_Book, mapkey_StringToWriterMapEntry, mapkey_Writer},
