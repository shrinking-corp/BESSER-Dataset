...
def test_hyp_complworld_satellite_is_not_abstract():
    assert not inspect.isabstract(complworld_Satellite)


def test_hyp_complworld_satellite_constructor_exists():
    assert callable(complworld_Satellite.__init__)


def test_hyp_complworld_satellite_constructor_args():
...
def test_hyp_complworld_mars_is_not_abstract():
    assert not inspect.isabstract(complworld_Mars)


def test_hyp_complworld_mars_constructor_exists():
    assert callable(complworld_Mars.__init__)


def test_hyp_complworld_mars_constructor_args():
    sig = inspect.signature(complworld_Mars.__init__)
    params = list(sig.parameters.keys())



def test_hyp_complworld_thing_is_not_abstract():
    assert not inspect.isabstract(complworld_Thing)


def test_hyp_complworld_thing_constructor_exists():
    assert callable(complworld_Thing.__init__)


def test_hyp_complworld_thing_constructor_args():
...
def test_hyp_complworld_world_is_not_abstract():
    assert not inspect.isabstract(complworld_World)


def test_hyp_complworld_world_constructor_exists():
    assert callable(complworld_World.__init__)


def test_hyp_complworld_world_constructor_args():
...
def test_hyp_complworld_satellite_name_setter(instance):
...
def test_hyp_complworld_thing_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
