...
# Classes
complworld_World = Class(name="complworld_World")
complworld_Thing = Class(name="complworld_Thing")
complworld_Mars = Class(name="complworld_Mars")
complworld_Satellite = Class(name="complworld_Satellite")
...
domain_model = DomainModel(
    name="complworld",
    types={complworld_World, complworld_Thing, complworld_Mars, complworld_Satellite},
    associations={things0, satellites1},
    generalizations={},
    metadata=None
)
