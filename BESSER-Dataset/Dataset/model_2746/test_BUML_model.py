...
# Classes
samplemodel_CommonBaseClass = Class(name="samplemodel_CommonBaseClass", is_abstract=True)
samplemodel_UltimateContainer = Class(name="samplemodel_UltimateContainer")
samplemodel_LinkAtoC = Class(name="samplemodel_LinkAtoC")
samplemodel_LinkAtoC_Cardinality2 = Class(name="samplemodel_LinkAtoC_Cardinality2")
samplemodel_LinkAtoC_Cardinality1 = Class(name="samplemodel_LinkAtoC_Cardinality1")
samplemodel_LinkAtoA = Class(name="samplemodel_LinkAtoA")
samplemodel_Child = Class(name="samplemodel_Child")
samplemodel_Child2 = Class(name="samplemodel_Child2")
samplemodel_NodeTargetC = Class(name="samplemodel_NodeTargetC")
NodeTargetB = Class(name="NodeTargetB")
samplemodel_NodeTargetD = Class(name="samplemodel_NodeTargetD")
samplemodel_Link2Link = Class(name="samplemodel_Link2Link")
samplemodel_NodeSrcA = Class(name="samplemodel_NodeSrcA")
CommonBaseClass = Class(name="CommonBaseClass")
samplemodel_NodeTargetB = Class(name="samplemodel_NodeTargetB")
samplemodel_LinkFromLink = Class(name="samplemodel_LinkFromLink")
samplemodel_LinkCrossLink = Class(name="samplemodel_LinkCrossLink")
...
domain_model = DomainModel(
    name="samplemodel",
    types={samplemodel_CommonBaseClass, samplemodel_UltimateContainer, samplemodel_LinkAtoC, samplemodel_LinkAtoC_Cardinality2, samplemodel_LinkAtoC_Cardinality1, samplemodel_LinkAtoA, samplemodel_Child, samplemodel_Child2, samplemodel_NodeTargetC, NodeTargetB, samplemodel_NodeTargetD, samplemodel_Link2Link, samplemodel_NodeSrcA, CommonBaseClass, samplemodel_NodeTargetB, samplemodel_LinkFromLink, samplemodel_LinkCrossLink},
    associations={classLinkToC11, classLinkToC_Cardinality213, classLinkToC_Cardinality115, classLinkToA17, children1OfA19, children2OfA21, childrenOfB23, refLinkToLink26, classLinkToLink28, refLinkFromLink30, refLinkCrossLink34, trg36, all0, refLinkToB1, refLinkToB_Cardinality22, refLinkToB_Cardinality15, refLinkToA9, trg54, trg57, trg60, classLinkFromLink38, classLinkCrossLink40, trg42, trg45, trg48, innerChildrenOfBChild52},
    generalizations={gen_samplemodel_NodeTargetB_CommonBaseClass, gen_samplemodel_NodeTargetC_NodeTargetB, gen_samplemodel_NodeTargetD_NodeTargetB, gen_samplemodel_NodeSrcA_CommonBaseClass},
    metadata=None
)
