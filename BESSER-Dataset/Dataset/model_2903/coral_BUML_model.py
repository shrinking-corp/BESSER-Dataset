...
# Classes
coral_NamedElement = Class(name="coral_NamedElement", is_abstract=True)
coral_DataType = Class(name="coral_DataType")
Type = Class(name="Type")
coral_Entity = Class(name="coral_Entity")
coral_Feature = Class(name="coral_Feature")
coral_EntityModel = Class(name="coral_EntityModel")
coral_Type = Class(name="coral_Type", is_abstract=True)
...
domain_model = DomainModel(
    name="coral",
    types={coral_NamedElement, coral_DataType, Type, coral_Entity, coral_Feature, coral_EntityModel, coral_Type, NamedElement, FeatureKind},
    associations={features0, types1, type2},
    generalizations={gen_coral_DataType_Type, gen_coral_Entity_Type, gen_coral_Feature_NamedElement, gen_coral_Type_NamedElement},
    metadata=None
)
