...
class dronesSimulation_DroneInstance:
    ...
    def __init__(self, currentBattery: float, state: str, dronesSimulation_DroneInstance: "dronesSimulation_DronesSimulation" = None, dronesSimulation_DroneInstance6: "dronesSimulation_Drone" = None, dronesSimulation_DroneInstance8: "dronesSimulation_Position" = None, allocatedDrone: "dronesSimulation_RoleInstance" = None, dronesSimulation_DroneInstance11: set["dronesSimulation_Observation"] = None, DroneInstance: "dronesSimulation_RoleInstance" = None):
