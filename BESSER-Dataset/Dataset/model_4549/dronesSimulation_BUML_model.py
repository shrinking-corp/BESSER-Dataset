...
# Classes
dronesSimulation_Role = Class(name="dronesSimulation_Role")
dronesSimulation_DronesSimulation = Class(name="dronesSimulation_DronesSimulation")
dronesSimulation_Scenario = Class(name="dronesSimulation_Scenario")
dronesSimulation_TaskInstance = Class(name="dronesSimulation_TaskInstance")
dronesSimulation_DroneInstance = Class(name="dronesSimulation_DroneInstance")
dronesSimulation_Drone = Class(name="dronesSimulation_Drone")
dronesSimulation_Position = Class(name="dronesSimulation_Position")
dronesSimulation_RoleInstance = Class(name="dronesSimulation_RoleInstance")
dronesSimulation_Observation = Class(name="dronesSimulation_Observation", is_abstract=True)
dronesSimulation_Task = Class(name="dronesSimulation_Task")
dronesSimulation_ObstacleObservation = Class(name="dronesSimulation_ObstacleObservation")
Observation = Class(name="Observation")
dronesSimulation_Obstacle = Class(name="dronesSimulation_Obstacle")
dronesSimulation_DroneObservation = Class(name="dronesSimulation_DroneObservation")
...
dronesSimulation_DroneInstance.attributes={dronesSimulation_DroneInstance_currentBattery, dronesSimulation_DroneInstance_state}
...
dronesSimulation_Observation.attributes={dronesSimulation_Observation_id, dronesSimulation_Observation_time}
...
domain_model = DomainModel(
    ...
    types={dronesSimulation_Role, dronesSimulation_DronesSimulation, dronesSimulation_Scenario, dronesSimulation_TaskInstance, dronesSimulation_DroneInstance, dronesSimulation_Drone, dronesSimulation_Position, dronesSimulation_RoleInstance, dronesSimulation_Observation, dronesSimulation_Task, dronesSimulation_ObstacleObservation, Observation, dronesSimulation_Obstacle, dronesSimulation_DroneObservation, TaskState, DroneState},
    associations={role16, taskInstance17, scenario0, taskInstances1, droneInstances3, drone5, position7, currentRole9, observations10, task12, roleInstances14, allocatedDrone18, obstacle19, drone20, position22},
