...
Booking.attributes={Booking_email_id, Booking_contact_no, Booking_startTime, Booking_date, Booking_booking_id, Booking_customer_name, Booking_endTime, Booking_reservedTables}
...
Food.attributes={Food_served, Food_name, Food_prepared, Food_price, Food_food_id}
...
domain_model = DomainModel(
    name="_07ef3538_8821_4398_b043_15dcd45e1672",
    types={ReservationManagementSystem, Booking, Table, Report, Order, Food, Staff, Waiter, Chef, StaffUI, CustomerUI},
    associations={Table_Order, Table_Booking, Order_Food, Staff_StaffUI, Staff_ReservationManagementSystem, CustomerUI_ReservationManagementSystem, ReservationManagementSystem_Booking, ReservationManagementSystem_Report},
    generalizations={},
    metadata=None
)
