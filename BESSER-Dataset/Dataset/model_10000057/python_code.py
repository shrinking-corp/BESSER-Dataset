...
class Booking:
    ...
    def __init__(self, booking_id: int, date: date, startTime: str, endTime: str, reservedTables: str, customer_name: str, contact_no: int, email_id: str, reservedBy13: set["Table"] = None, ReservationManagementSystem_Booking_17: "ReservationManagementSystem" = None):
