...
company_Company_m_dummyInvariant: Method = Method(name="dummyInvariant", parameters={Parameter(name='company_diagnostics', type=StringType), Parameter(name='company_context', type=StringType)}, type=BooleanType)
...
company_Employee_m_noManagerImpliesDirectReports: Method = Method(name="noManagerImpliesDirectReports", parameters={Parameter(name='company_diagnostics', type=StringType), Parameter(name='company_context', type=StringType)}, type=BooleanType)
