...
def test_hyp_dml_ddl_text_is_not_abstract():
    assert not inspect.isabstract(DML_DDL_Text)


def test_hyp_dml_ddl_text_constructor_exists():
    assert callable(DML_DDL_Text.__init__)


def test_hyp_dml_ddl_text_constructor_args():
...
@given(instance=DML_DDL_Column_strategy)
def test_hyp_dml_ddl_column_scale_setter(instance):
...
@given(instance=DML_DDL_Column_strategy)
def test_hyp_dml_ddl_column_precision_setter(instance):
