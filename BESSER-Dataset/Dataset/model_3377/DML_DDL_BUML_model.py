...
# Classes
DML_DDL_Statement = Class(name="DML_DDL_Statement")
DML_DDL_DataDefinition = Class(name="DML_DDL_DataDefinition")
Statement = Class(name="Statement")
DML_DDL_DataType = Class(name="DML_DDL_DataType")
DML_DDL_Type = Class(name="DML_DDL_Type")
DML_DDL_DDLDefinition = Class(name="DML_DDL_DDLDefinition")
DML_DDL_Pk = Class(name="DML_DDL_Pk")
DML_DDL_Fk = Class(name="DML_DDL_Fk")
DML_DDL_Table = Class(name="DML_DDL_Table")
DML_DDL_Integer = Class(name="DML_DDL_Integer")
Exacto = Class(name="Exacto")
DML_DDL_Ck = Class(name="DML_DDL_Ck")
DML_DDL_ValuesCk = Class(name="DML_DDL_ValuesCk")
DML_DDL_Column = Class(name="DML_DDL_Column")
DML_DDL_Database = Class(name="DML_DDL_Database")
DataDefinition = Class(name="DataDefinition")
DML_DDL_Registry = Class(name="DML_DDL_Registry")
DML_DDL_Value = Class(name="DML_DDL_Value")
DML_DDL_CommentTable = Class(name="DML_DDL_CommentTable")
DML_DDL_CommentColumn = Class(name="DML_DDL_CommentColumn")
DML_DDL_Exacto = Class(name="DML_DDL_Exacto")
Type = Class(name="Type")
DML_DDL_SmallInteger = Class(name="DML_DDL_SmallInteger")
DML_DDL_Int = Class(name="DML_DDL_Int")
DML_DDL_SmallInt = Class(name="DML_DDL_SmallInt")
DML_DDL_Number = Class(name="DML_DDL_Number")
DML_DDL_Numeric = Class(name="DML_DDL_Numeric")
DML_DDL_Decimal = Class(name="DML_DDL_Decimal")
DML_DDL_Aproximado = Class(name="DML_DDL_Aproximado")
DML_DDL_Real = Class(name="DML_DDL_Real")
Aproximado = Class(name="Aproximado")
DML_DDL_DoublePrecision = Class(name="DML_DDL_DoublePrecision")
DML_DDL_Float = Class(name="DML_DDL_Float")
DML_DDL_Long = Class(name="DML_DDL_Long")
DML_DDL_LongRaw = Class(name="DML_DDL_LongRaw")
DML_DDL_Characters = Class(name="DML_DDL_Characters")
DML_DDL_Character = Class(name="DML_DDL_Character")
Characters = Class(name="Characters")
DML_DDL_CharacterVarying = Class(name="DML_DDL_CharacterVarying")
DML_DDL_Char = Class(name="DML_DDL_Char")
DML_DDL_VarChar = Class(name="DML_DDL_VarChar")
DML_DDL_VarChar2 = Class(name="DML_DDL_VarChar2")
DML_DDL_Text = Class(name="DML_DDL_Text")
DML_DDL_NVarChar2 = Class(name="DML_DDL_NVarChar2")
DML_DDL_NChar = Class(name="DML_DDL_NChar")
DML_DDL_CharVarying = Class(name="DML_DDL_CharVarying")
DML_DDL_NationalChar = Class(name="DML_DDL_NationalChar")
DML_DDL_NationalCharVarying = Class(name="DML_DDL_NationalCharVarying")
DML_DDL_NationalCharacter = Class(name="DML_DDL_NationalCharacter")
DML_DDL_NationalCharacterVarying = Class(name="DML_DDL_NationalCharacterVarying")
DML_DDL_NCharVarying = Class(name="DML_DDL_NCharVarying")
DML_DDL_Clob = Class(name="DML_DDL_Clob")
DML_DDL_NClob = Class(name="DML_DDL_NClob")
DML_DDL_Bits = Class(name="DML_DDL_Bits")
DML_DDL_Bit = Class(name="DML_DDL_Bit")
Bits = Class(name="Bits")
DML_DDL_BitVarying = Class(name="DML_DDL_BitVarying")
Bit = Class(name="Bit")
DML_DDL_Times = Class(name="DML_DDL_Times")
DML_DDL_Date = Class(name="DML_DDL_Date")
Times = Class(name="Times")
DML_DDL_Time = Class(name="DML_DDL_Time")
DML_DDL_Timestamp = Class(name="DML_DDL_Timestamp")
DML_DDL_Intervals = Class(name="DML_DDL_Intervals")
DML_DDL_YearMonth = Class(name="DML_DDL_YearMonth")
Intervals = Class(name="Intervals")
DML_DDL_DayTime = Class(name="DML_DDL_DayTime")
DML_DDL_Binaries = Class(name="DML_DDL_Binaries")
DML_DDL_BinaryDouble = Class(name="DML_DDL_BinaryDouble")
Binaries = Class(name="Binaries")
DML_DDL_BinaryFloat = Class(name="DML_DDL_BinaryFloat")
DML_DDL_BFile = Class(name="DML_DDL_BFile")
DML_DDL_Blob = Class(name="DML_DDL_Blob")
...
DML_DDL_Fk.attributes={DML_DDL_Fk_nameFk, DML_DDL_Fk_columnName, DML_DDL_Fk_status, DML_DDL_Fk_columnReference}
...
DML_DDL_Table.attributes={DML_DDL_Table_tableName, DML_DDL_Table_commentTable}
...
DML_DDL_ValuesCk.attributes={DML_DDL_ValuesCk_columnName, DML_DDL_ValuesCk_comparator, DML_DDL_ValuesCk_logConjuntion, DML_DDL_ValuesCk_value}
...
DML_DDL_Column.attributes={DML_DDL_Column_columnName, DML_DDL_Column_commentColumn, DML_DDL_Column_scale, DML_DDL_Column_precision, DML_DDL_Column_columnNull}
...
DML_DDL_CommentTable.attributes={DML_DDL_CommentTable_tableComment, DML_DDL_CommentTable_tableName}
...
DML_DDL_CommentColumn.attributes={DML_DDL_CommentColumn_columnName, DML_DDL_CommentColumn_columnComment, DML_DDL_CommentColumn_tableName}
...
domain_model = DomainModel(
    name="DML_DDL",
    types={DML_DDL_Statement, DML_DDL_DataDefinition, Statement, DML_DDL_DataType, DML_DDL_Type, DML_DDL_DDLDefinition, DML_DDL_Pk, DML_DDL_Fk, DML_DDL_Table, DML_DDL_Integer, Exacto, DML_DDL_Ck, DML_DDL_ValuesCk, DML_DDL_Column, DML_DDL_Database, DataDefinition, DML_DDL_Registry, DML_DDL_Value, DML_DDL_CommentTable, DML_DDL_CommentColumn, DML_DDL_Exacto, Type, DML_DDL_SmallInteger, DML_DDL_Int, DML_DDL_SmallInt, DML_DDL_Number, DML_DDL_Numeric, DML_DDL_Decimal, DML_DDL_Aproximado, DML_DDL_Real, Aproximado, DML_DDL_DoublePrecision, DML_DDL_Float, DML_DDL_Long, DML_DDL_LongRaw, DML_DDL_Characters, DML_DDL_Character, Characters, DML_DDL_CharacterVarying, DML_DDL_Char, DML_DDL_VarChar, DML_DDL_VarChar2, DML_DDL_Text, DML_DDL_NVarChar2, DML_DDL_NChar, DML_DDL_CharVarying, DML_DDL_NationalChar, DML_DDL_NationalCharVarying, DML_DDL_NationalCharacter, DML_DDL_NationalCharacterVarying, DML_DDL_NCharVarying, DML_DDL_Clob, DML_DDL_NClob, DML_DDL_Bits, DML_DDL_Bit, Bits, DML_DDL_BitVarying, Bit, DML_DDL_Times, DML_DDL_Date, Times, DML_DDL_Time, DML_DDL_Timestamp, DML_DDL_Intervals, DML_DDL_YearMonth, Intervals, DML_DDL_DayTime, DML_DDL_Binaries, DML_DDL_BinaryDouble, Binaries, DML_DDL_BinaryFloat, DML_DDL_BFile, DML_DDL_Blob},
    associations={types0, statements1, dataType2, references5, valuesCk6, columnType7, columns9, columnsPk12, columnsFk14, checks17, registries20, registryValues22, column24},
    generalizations={gen_DML_DDL_DataDefinition_Statement, gen_DML_DDL_Integer_Exacto, gen_DML_DDL_Database_DataDefinition, gen_DML_DDL_Table_DataDefinition, gen_DML_DDL_CommentTable_DataDefinition, gen_DML_DDL_CommentColumn_DataDefinition, gen_DML_DDL_Exacto_Type, gen_DML_DDL_SmallInteger_Exacto, gen_DML_DDL_Int_Exacto, gen_DML_DDL_SmallInt_Exacto, gen_DML_DDL_Number_Exacto, gen_DML_DDL_Numeric_Exacto, gen_DML_DDL_Decimal_Exacto, gen_DML_DDL_Aproximado_Type, gen_DML_DDL_Real_Aproximado, gen_DML_DDL_DoublePrecision_Aproximado, gen_DML_DDL_Float_Aproximado, gen_DML_DDL_Long_Aproximado, gen_DML_DDL_LongRaw_Aproximado, gen_DML_DDL_Characters_Type, gen_DML_DDL_Character_Characters, gen_DML_DDL_CharacterVarying_Characters, gen_DML_DDL_Char_Characters, gen_DML_DDL_VarChar_Characters, gen_DML_DDL_VarChar2_Characters, gen_DML_DDL_Text_Characters, gen_DML_DDL_NVarChar2_Characters, gen_DML_DDL_NChar_Characters, gen_DML_DDL_CharVarying_Characters, gen_DML_DDL_NationalChar_Characters, gen_DML_DDL_NationalCharVarying_Characters, gen_DML_DDL_NationalCharacter_Characters, gen_DML_DDL_NationalCharacterVarying_Characters, gen_DML_DDL_NCharVarying_Characters, gen_DML_DDL_Clob_Characters, gen_DML_DDL_NClob_Characters, gen_DML_DDL_Bits_Type, gen_DML_DDL_Bit_Bits, gen_DML_DDL_BitVarying_Bit, gen_DML_DDL_Times_Type, gen_DML_DDL_Date_Times, gen_DML_DDL_Time_Times, gen_DML_DDL_Timestamp_Times, gen_DML_DDL_Intervals_Type, gen_DML_DDL_YearMonth_Intervals, gen_DML_DDL_DayTime_Intervals, gen_DML_DDL_Binaries_Type, gen_DML_DDL_BinaryDouble_Binaries, gen_DML_DDL_BinaryFloat_Binaries, gen_DML_DDL_BFile_Binaries, gen_DML_DDL_Blob_Binaries},
    metadata=None
)
