...
def test_dml_ddl_text_is_not_abstract():
    assert not inspect.isabstract(DML_DDL_Text)


def test_dml_ddl_text_constructor_exists():
    assert callable(DML_DDL_Text.__init__)


def test_dml_ddl_text_constructor_args():
    sig = inspect.signature(DML_DDL_Text.__init__)
    params = list(sig.parameters.keys())
...
def test_dml_ddl_column_has_scale():
    assert hasattr(DML_DDL_Column, "scale")
    descriptor = None
    for klass in DML_DDL_Column.__mro__:
...
def test_dml_ddl_column_has_precision():
    assert hasattr(DML_DDL_Column, "precision")
    descriptor = None
    for klass in DML_DDL_Column.__mro__:
...
DML_DDL_Text_strategy = st.builds(
    DML_DDL_Text,
)
...
@given(instance=DML_DDL_Column_strategy)
def test_dml_ddl_column_scale_setter(instance):
...
@given(instance=DML_DDL_Column_strategy)
def test_dml_ddl_column_precision_setter(instance):
