...
class test100_A(B):
    ...
    def __init__(self, name: str, test100_A: "test100_C" = None, test100_A2: set["test100_B"] = None, test100_A4: set["test100_DsmlRelation"] = None, test100_A7: "test100_DsmlRelation" = None, test100_A10: "test100_DsmlRelation" = None):
        self.name = name
