...
# Classes
test100_C = Class(name="test100_C")
test100_A = Class(name="test100_A")
B = Class(name="B")
test100_B = Class(name="test100_B")
test100_DsmlRelation = Class(name="test100_DsmlRelation")
...
test100_DsmlRelation.attributes={test100_DsmlRelation_mandatory, test100_DsmlRelation_name, test100_DsmlRelation_details}
...
domain_model = DomainModel(
    name="test100",
    types={test100_C, test100_A, B, test100_B, test100_DsmlRelation},
    associations={as_0, bs1, relateds3, fromDsml5, toDsml8},
