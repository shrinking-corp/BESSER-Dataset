...
# Classes
jointPackage_Ecore2Maude_SrcEOperation = Class(name="jointPackage_Ecore2Maude_SrcEOperation")
jointPackage_Ecore2Maude_SrcEReference = Class(name="jointPackage_Ecore2Maude_SrcEReference")
jointPackage_Ecore2Maude_JointMM = Class(name="jointPackage_Ecore2Maude_JointMM")
jointPackage_Ecore2Maude_SrcEStringToStringMapEntry = Class(name="jointPackage_Ecore2Maude_SrcEStringToStringMapEntry")
jointPackage_Ecore2Maude_TrgEqualCond = Class(name="jointPackage_Ecore2Maude_TrgEqualCond")
jointPackage_Ecore2Maude_SrcEAttribute = Class(name="jointPackage_Ecore2Maude_SrcEAttribute")
SrcEStructuralFeature = Class(name="SrcEStructuralFeature")
jointPackage_Ecore2Maude_SrcEDataType = Class(name="jointPackage_Ecore2Maude_SrcEDataType")
jointPackage_Ecore2Maude_SrcEClass = Class(name="jointPackage_Ecore2Maude_SrcEClass")
SrcEClassifier = Class(name="SrcEClassifier")
jointPackage_Ecore2Maude_SrcEEnumLiteral = Class(name="jointPackage_Ecore2Maude_SrcEEnumLiteral")
jointPackage_Ecore2Maude_SrcENamedElement = Class(name="jointPackage_Ecore2Maude_SrcENamedElement", is_abstract=True)
jointPackage_Ecore2Maude_SrcEStructuralFeature = Class(name="jointPackage_Ecore2Maude_SrcEStructuralFeature", is_abstract=True)
jointPackage_Ecore2Maude_SrcEClassifier = Class(name="jointPackage_Ecore2Maude_SrcEClassifier", is_abstract=True)
SrcENamedElement = Class(name="SrcENamedElement")
jointPackage_Ecore2Maude_SrcEPackage = Class(name="jointPackage_Ecore2Maude_SrcEPackage")
jointPackage_Ecore2Maude_SrcEEnum = Class(name="jointPackage_Ecore2Maude_SrcEEnum")
SrcEDataType = Class(name="SrcEDataType")
SrcETypedElement = Class(name="SrcETypedElement")
jointPackage_Ecore2Maude_SrcEParameter = Class(name="jointPackage_Ecore2Maude_SrcEParameter")
jointPackage_Ecore2Maude_TrgEquation = Class(name="jointPackage_Ecore2Maude_TrgEquation")
jointPackage_Ecore2Maude_TrgRule = Class(name="jointPackage_Ecore2Maude_TrgRule")
jointPackage_Ecore2Maude_TrgMembershipCond = Class(name="jointPackage_Ecore2Maude_TrgMembershipCond")
TrgEquationalCond = Class(name="TrgEquationalCond")
jointPackage_Ecore2Maude_TrgBooleanCond = Class(name="jointPackage_Ecore2Maude_TrgBooleanCond")
jointPackage_Ecore2Maude_SrcETypedElement = Class(name="jointPackage_Ecore2Maude_SrcETypedElement", is_abstract=True)
jointPackage_Ecore2Maude_TrgMaudeSpec = Class(name="jointPackage_Ecore2Maude_TrgMaudeSpec")
jointPackage_Ecore2Maude_TrgMaudeTopEl = Class(name="jointPackage_Ecore2Maude_TrgMaudeTopEl", is_abstract=True)
jointPackage_Ecore2Maude_TrgMembership = Class(name="jointPackage_Ecore2Maude_TrgMembership")
TrgStatement = Class(name="TrgStatement")
jointPackage_Ecore2Maude_TrgTerm = Class(name="jointPackage_Ecore2Maude_TrgTerm", is_abstract=True)
jointPackage_Ecore2Maude_TrgSort = Class(name="jointPackage_Ecore2Maude_TrgSort")
jointPackage_Ecore2Maude_TrgModuleIdModExp = Class(name="jointPackage_Ecore2Maude_TrgModuleIdModExp")
jointPackage_Ecore2Maude_TrgModule = Class(name="jointPackage_Ecore2Maude_TrgModule", is_abstract=True)
jointPackage_Ecore2Maude_TrgTheoryIdModExp = Class(name="jointPackage_Ecore2Maude_TrgTheoryIdModExp")
jointPackage_Ecore2Maude_TrgTheory = Class(name="jointPackage_Ecore2Maude_TrgTheory", is_abstract=True)
jointPackage_Ecore2Maude_TrgParameter = Class(name="jointPackage_Ecore2Maude_TrgParameter")
TrgMaudeTopEl = Class(name="TrgMaudeTopEl")
jointPackage_Ecore2Maude_TrgMatchingCond = Class(name="jointPackage_Ecore2Maude_TrgMatchingCond")
jointPackage_Ecore2Maude_TrgModExpression = Class(name="jointPackage_Ecore2Maude_TrgModExpression", is_abstract=True)
jointPackage_Ecore2Maude_TrgInstModExp = Class(name="jointPackage_Ecore2Maude_TrgInstModExp")
TrgModExpression = Class(name="TrgModExpression")
jointPackage_Ecore2Maude_TrgView = Class(name="jointPackage_Ecore2Maude_TrgView")
jointPackage_Ecore2Maude_TrgRenModExp = Class(name="jointPackage_Ecore2Maude_TrgRenModExp")
jointPackage_Ecore2Maude_TrgRenMapping = Class(name="jointPackage_Ecore2Maude_TrgRenMapping", is_abstract=True)
jointPackage_Ecore2Maude_TrgCompModExp = Class(name="jointPackage_Ecore2Maude_TrgCompModExp")
TrgType = Class(name="TrgType")
jointPackage_Ecore2Maude_TrgSubsortRel = Class(name="jointPackage_Ecore2Maude_TrgSubsortRel")
jointPackage_Ecore2Maude_TrgModElement = Class(name="jointPackage_Ecore2Maude_TrgModElement", is_abstract=True)
jointPackage_Ecore2Maude_TrgFTheory = Class(name="jointPackage_Ecore2Maude_TrgFTheory")
TrgTheory = Class(name="TrgTheory")
jointPackage_Ecore2Maude_TrgSTheory = Class(name="jointPackage_Ecore2Maude_TrgSTheory")
jointPackage_Ecore2Maude_TrgFModule = Class(name="jointPackage_Ecore2Maude_TrgFModule")
TrgModule = Class(name="TrgModule")
jointPackage_Ecore2Maude_TrgSModule = Class(name="jointPackage_Ecore2Maude_TrgSModule")
jointPackage_Ecore2Maude_TrgModImportation = Class(name="jointPackage_Ecore2Maude_TrgModImportation")
TrgModElement = Class(name="TrgModElement")
jointPackage_Ecore2Maude_TrgCondition = Class(name="jointPackage_Ecore2Maude_TrgCondition", is_abstract=True)
jointPackage_Ecore2Maude_TrgType = Class(name="jointPackage_Ecore2Maude_TrgType", is_abstract=True)
jointPackage_Ecore2Maude_TrgEquationalCond = Class(name="jointPackage_Ecore2Maude_TrgEquationalCond", is_abstract=True)
TrgCondition = Class(name="TrgCondition")
jointPackage_Ecore2Maude_TrgKind = Class(name="jointPackage_Ecore2Maude_TrgKind")
jointPackage_Ecore2Maude_TrgOperation = Class(name="jointPackage_Ecore2Maude_TrgOperation")
jointPackage_Ecore2Maude_TrgStatement = Class(name="jointPackage_Ecore2Maude_TrgStatement", is_abstract=True)
jointPackage_Ecore2Maude_TrgTermMapping = Class(name="jointPackage_Ecore2Maude_TrgTermMapping")
jointPackage_Ecore2Maude_TrgSortMapping = Class(name="jointPackage_Ecore2Maude_TrgSortMapping")
TrgRenMapping = Class(name="TrgRenMapping")
jointPackage_Ecore2Maude_TrgRewriteCond = Class(name="jointPackage_Ecore2Maude_TrgRewriteCond")
jointPackage_Ecore2Maude_TrgConstant = Class(name="jointPackage_Ecore2Maude_TrgConstant")
TrgTerm = Class(name="TrgTerm")
jointPackage_Ecore2Maude_TrgRecTerm = Class(name="jointPackage_Ecore2Maude_TrgRecTerm")
jointPackage_Ecore2Maude_TrgVariable = Class(name="jointPackage_Ecore2Maude_TrgVariable")
jointPackage_Ecore2Maude_TrgViewMapping = Class(name="jointPackage_Ecore2Maude_TrgViewMapping", is_abstract=True)
TrgViewMapping = Class(name="TrgViewMapping")
jointPackage_Ecore2Maude_TrgOpTypedMapping = Class(name="jointPackage_Ecore2Maude_TrgOpTypedMapping")
jointPackage_Ecore2Maude_TrgOpMapping = Class(name="jointPackage_Ecore2Maude_TrgOpMapping")
jointPackage_Ecore2Maude_TrgLabelMapping = Class(name="jointPackage_Ecore2Maude_TrgLabelMapping")
...
jointPackage_Ecore2Maude_SrcEReference.attributes={jointPackage_Ecore2Maude_SrcEReference_containment, jointPackage_Ecore2Maude_SrcEReference_resolveProxies, jointPackage_Ecore2Maude_SrcEReference_container}
...
jointPackage_Ecore2Maude_SrcEStringToStringMapEntry.attributes={jointPackage_Ecore2Maude_SrcEStringToStringMapEntry_value, jointPackage_Ecore2Maude_SrcEStringToStringMapEntry_key}
...
jointPackage_Ecore2Maude_SrcEClass_m_isSuperTypeOf: Method = Method(name="isSuperTypeOf", parameters={Parameter(name='jointPackage_Ecore2Maude_someClass', type=StringType)}, type=BooleanType)
jointPackage_Ecore2Maude_SrcEClass_m_getFeatureCount: Method = Method(name="getFeatureCount", parameters={}, type=IntegerType)
jointPackage_Ecore2Maude_SrcEClass_m_getEStructuralFeature: Method = Method(name="getEStructuralFeature", parameters={Parameter(name='jointPackage_Ecore2Maude_featureID', type=StringType)}, type=SrcEStructuralFeature)
jointPackage_Ecore2Maude_SrcEClass_m_getFeatureID: Method = Method(name="getFeatureID", parameters={Parameter(name='jointPackage_Ecore2Maude_feature', type=StringType)}, type=IntegerType)
jointPackage_Ecore2Maude_SrcEClass_m_getEStructuralFeature: Method = Method(name="getEStructuralFeature", parameters={Parameter(name='jointPackage_Ecore2Maude_featureName', type=StringType)}, type=SrcEStructuralFeature)
...
jointPackage_Ecore2Maude_SrcEClass.methods={jointPackage_Ecore2Maude_SrcEClass_m_isSuperTypeOf, jointPackage_Ecore2Maude_SrcEClass_m_getFeatureID, jointPackage_Ecore2Maude_SrcEClass_m_getFeatureCount, jointPackage_Ecore2Maude_SrcEClass_m_getEStructuralFeature, jointPackage_Ecore2Maude_SrcEClass_m_getEStructuralFeature}
...
jointPackage_Ecore2Maude_SrcEStructuralFeature.attributes={jointPackage_Ecore2Maude_SrcEStructuralFeature_volatile, jointPackage_Ecore2Maude_SrcEStructuralFeature_changeable, jointPackage_Ecore2Maude_SrcEStructuralFeature_derived, jointPackage_Ecore2Maude_SrcEStructuralFeature_transient, jointPackage_Ecore2Maude_SrcEStructuralFeature_unsettable, jointPackage_Ecore2Maude_SrcEStructuralFeature_defaultValueLiteral}
...
jointPackage_Ecore2Maude_SrcEClassifier.attributes={jointPackage_Ecore2Maude_SrcEClassifier_instanceClassName, jointPackage_Ecore2Maude_SrcEClassifier_instanceTypeName}
...
jointPackage_Ecore2Maude_SrcEPackage_m_getEClassifier: Method = Method(name="getEClassifier", parameters={Parameter(name='jointPackage_Ecore2Maude_name', type=StringType)}, type=SrcEClassifier)
...
jointPackage_Ecore2Maude_SrcEEnum_m_getEEnumLiteral: Method = Method(name="getEEnumLiteral", parameters={Parameter(name='jointPackage_Ecore2Maude_name', type=StringType)}, type=StringType)
jointPackage_Ecore2Maude_SrcEEnum_m_getEEnumLiteral: Method = Method(name="getEEnumLiteral", parameters={Parameter(name='jointPackage_Ecore2Maude_value', type=StringType)}, type=StringType)
jointPackage_Ecore2Maude_SrcEEnum_m_getEEnumLiteralByLiteral: Method = Method(name="getEEnumLiteralByLiteral", parameters={Parameter(name='jointPackage_Ecore2Maude_literal', type=StringType)}, type=StringType)
jointPackage_Ecore2Maude_SrcEEnum.methods={jointPackage_Ecore2Maude_SrcEEnum_m_getEEnumLiteral, jointPackage_Ecore2Maude_SrcEEnum_m_getEEnumLiteralByLiteral, jointPackage_Ecore2Maude_SrcEEnum_m_getEEnumLiteral}
...
jointPackage_Ecore2Maude_SrcETypedElement.attributes={jointPackage_Ecore2Maude_SrcETypedElement_required, jointPackage_Ecore2Maude_SrcETypedElement_many, jointPackage_Ecore2Maude_SrcETypedElement_lowerBound, jointPackage_Ecore2Maude_SrcETypedElement_upperBound, jointPackage_Ecore2Maude_SrcETypedElement_unique, jointPackage_Ecore2Maude_SrcETypedElement_ordered}
...
jointPackage_Ecore2Maude_TrgOperation.attributes={jointPackage_Ecore2Maude_TrgOperation_atts, jointPackage_Ecore2Maude_TrgOperation_name}
...
jointPackage_Ecore2Maude_TrgStatement.attributes={jointPackage_Ecore2Maude_TrgStatement_label, jointPackage_Ecore2Maude_TrgStatement_atts}
...
jointPackage_Ecore2Maude_TrgOpTypedMapping.attributes={jointPackage_Ecore2Maude_TrgOpTypedMapping_to, jointPackage_Ecore2Maude_TrgOpTypedMapping_atts}
...
jointPackage_Ecore2Maude_TrgLabelMapping_from_: Property = Property(name="from_", type=StringType)
jointPackage_Ecore2Maude_TrgLabelMapping_to: Property = Property(name="to", type=StringType)
jointPackage_Ecore2Maude_TrgLabelMapping.attributes={jointPackage_Ecore2Maude_TrgLabelMapping_to, jointPackage_Ecore2Maude_TrgLabelMapping_from_}
...
from_142: BinaryAssociation = BinaryAssociation(
    name="from_142",
    ends={
...
from_147: BinaryAssociation = BinaryAssociation(
    name="from_147",
    ends={
...
from_149: BinaryAssociation = BinaryAssociation(
    name="from_149",
    ends={
...
from_151: BinaryAssociation = BinaryAssociation(
    name="from_151",
    ends={
...
domain_model = DomainModel(
    ...
    types={jointPackage_Ecore2Maude_SrcEOperation, jointPackage_Ecore2Maude_SrcEReference, jointPackage_Ecore2Maude_JointMM, jointPackage_Ecore2Maude_SrcEStringToStringMapEntry, jointPackage_Ecore2Maude_TrgEqualCond, jointPackage_Ecore2Maude_SrcEAttribute, SrcEStructuralFeature, jointPackage_Ecore2Maude_SrcEDataType, jointPackage_Ecore2Maude_SrcEClass, SrcEClassifier, jointPackage_Ecore2Maude_SrcEEnumLiteral, jointPackage_Ecore2Maude_SrcENamedElement, jointPackage_Ecore2Maude_SrcEStructuralFeature, jointPackage_Ecore2Maude_SrcEClassifier, SrcENamedElement, jointPackage_Ecore2Maude_SrcEPackage, jointPackage_Ecore2Maude_SrcEEnum, SrcEDataType, SrcETypedElement, jointPackage_Ecore2Maude_SrcEParameter, jointPackage_Ecore2Maude_TrgEquation, jointPackage_Ecore2Maude_TrgRule, jointPackage_Ecore2Maude_TrgMembershipCond, TrgEquationalCond, jointPackage_Ecore2Maude_TrgBooleanCond, jointPackage_Ecore2Maude_SrcETypedElement, jointPackage_Ecore2Maude_TrgMaudeSpec, jointPackage_Ecore2Maude_TrgMaudeTopEl, jointPackage_Ecore2Maude_TrgMembership, TrgStatement, jointPackage_Ecore2Maude_TrgTerm, jointPackage_Ecore2Maude_TrgSort, jointPackage_Ecore2Maude_TrgModuleIdModExp, jointPackage_Ecore2Maude_TrgModule, jointPackage_Ecore2Maude_TrgTheoryIdModExp, jointPackage_Ecore2Maude_TrgTheory, jointPackage_Ecore2Maude_TrgParameter, TrgMaudeTopEl, jointPackage_Ecore2Maude_TrgMatchingCond, jointPackage_Ecore2Maude_TrgModExpression, jointPackage_Ecore2Maude_TrgInstModExp, TrgModExpression, jointPackage_Ecore2Maude_TrgView, jointPackage_Ecore2Maude_TrgRenModExp, jointPackage_Ecore2Maude_TrgRenMapping, jointPackage_Ecore2Maude_TrgCompModExp, TrgType, jointPackage_Ecore2Maude_TrgSubsortRel, jointPackage_Ecore2Maude_TrgModElement, jointPackage_Ecore2Maude_TrgFTheory, TrgTheory, jointPackage_Ecore2Maude_TrgSTheory, jointPackage_Ecore2Maude_TrgFModule, TrgModule, jointPackage_Ecore2Maude_TrgSModule, jointPackage_Ecore2Maude_TrgModImportation, TrgModElement, jointPackage_Ecore2Maude_TrgCondition, jointPackage_Ecore2Maude_TrgType, jointPackage_Ecore2Maude_TrgEquationalCond, TrgCondition, jointPackage_Ecore2Maude_TrgKind, jointPackage_Ecore2Maude_TrgOperation, jointPackage_Ecore2Maude_TrgStatement, jointPackage_Ecore2Maude_TrgTermMapping, jointPackage_Ecore2Maude_TrgSortMapping, TrgRenMapping, jointPackage_Ecore2Maude_TrgRewriteCond, jointPackage_Ecore2Maude_TrgConstant, TrgTerm, jointPackage_Ecore2Maude_TrgRecTerm, jointPackage_Ecore2Maude_TrgVariable, jointPackage_Ecore2Maude_TrgViewMapping, TrgViewMapping, jointPackage_Ecore2Maude_TrgOpTypedMapping, jointPackage_Ecore2Maude_TrgOpMapping, jointPackage_Ecore2Maude_TrgLabelMapping},
    associations={eSuperTypes5, eOperations6, eAllAttributes7, eAllReferences10, eReferences12, sourceRoot0, targetRoot1, eAttributeType3, eLiterals34, eEnum35, eAttributes15, eAllContainments18, eAllOperations21, eAllStructuralFeatures23, eAllSuperTypes26, eIDAttribute28, eStructuralFeatures31, ePackage33, eOpposite50, eReferenceType52, eKeys55, eContainingClass36, eParameters37, eExceptions38, eClassifiers40, eSubpackages42, eSuperPackage45, eOperation47, lhs69, rhs71, lhs74, rhs76, rhs79, eContainingClass58, eType60, els62, printableEls63, term66, sort67, modExps93, module95, theory96, modExp97, rhs81, rhs83, modExp86, views87, modExp89, renamings91, subsortRels110, supersortRels111, els99, els100, params102, module105, theory106, imports108, conds123, lhs124, kind113, sorts114, subsorts115, supersorts117, coarity119, arity120, from_142, to144, rhs127, type129, args132, from_134, to137, els140, from_147, from_149, from_151},
    generalizations={gen_jointPackage_Ecore2Maude_SrcEAttribute_SrcEStructuralFeature, gen_jointPackage_Ecore2Maude_SrcEClass_SrcEClassifier, gen_jointPackage_Ecore2Maude_SrcEEnumLiteral_SrcENamedElement, gen_jointPackage_Ecore2Maude_SrcEClassifier_SrcENamedElement, gen_jointPackage_Ecore2Maude_SrcEDataType_SrcEClassifier, gen_jointPackage_Ecore2Maude_SrcEEnum_SrcEDataType, gen_jointPackage_Ecore2Maude_SrcEStructuralFeature_SrcETypedElement, gen_jointPackage_Ecore2Maude_SrcEOperation_SrcETypedElement, gen_jointPackage_Ecore2Maude_SrcEPackage_SrcENamedElement, gen_jointPackage_Ecore2Maude_SrcEParameter_SrcETypedElement, gen_jointPackage_Ecore2Maude_SrcEReference_SrcEStructuralFeature, gen_jointPackage_Ecore2Maude_TrgEquation_TrgStatement, gen_jointPackage_Ecore2Maude_TrgRule_TrgStatement, gen_jointPackage_Ecore2Maude_TrgMembershipCond_TrgEquationalCond, gen_jointPackage_Ecore2Maude_SrcETypedElement_SrcENamedElement, gen_jointPackage_Ecore2Maude_TrgMembership_TrgStatement, gen_jointPackage_Ecore2Maude_TrgModuleIdModExp_TrgModExpression, gen_jointPackage_Ecore2Maude_TrgTheoryIdModExp_TrgModExpression, gen_jointPackage_Ecore2Maude_TrgParameter_TrgModExpression, gen_jointPackage_Ecore2Maude_TrgTheory_TrgMaudeTopEl, gen_jointPackage_Ecore2Maude_TrgBooleanCond_TrgEquationalCond, gen_jointPackage_Ecore2Maude_TrgMatchingCond_TrgEquationalCond, gen_jointPackage_Ecore2Maude_TrgEqualCond_TrgEquationalCond, gen_jointPackage_Ecore2Maude_TrgInstModExp_TrgModExpression, gen_jointPackage_Ecore2Maude_TrgRenModExp_TrgModExpression, gen_jointPackage_Ecore2Maude_TrgCompModExp_TrgModExpression, gen_jointPackage_Ecore2Maude_TrgSort_TrgType, gen_jointPackage_Ecore2Maude_TrgSort_TrgModElement, gen_jointPackage_Ecore2Maude_TrgFTheory_TrgTheory, gen_jointPackage_Ecore2Maude_TrgSTheory_TrgTheory, gen_jointPackage_Ecore2Maude_TrgModule_TrgMaudeTopEl, gen_jointPackage_Ecore2Maude_TrgFModule_TrgModule, gen_jointPackage_Ecore2Maude_TrgSModule_TrgModule, gen_jointPackage_Ecore2Maude_TrgModImportation_TrgModElement, gen_jointPackage_Ecore2Maude_TrgEquationalCond_TrgCondition, gen_jointPackage_Ecore2Maude_TrgKind_TrgType, gen_jointPackage_Ecore2Maude_TrgSubsortRel_TrgModElement, gen_jointPackage_Ecore2Maude_TrgOperation_TrgModElement, gen_jointPackage_Ecore2Maude_TrgStatement_TrgModElement, gen_jointPackage_Ecore2Maude_TrgTermMapping_TrgViewMapping, gen_jointPackage_Ecore2Maude_TrgSortMapping_TrgRenMapping, gen_jointPackage_Ecore2Maude_TrgRewriteCond_TrgCondition, gen_jointPackage_Ecore2Maude_TrgConstant_TrgTerm, gen_jointPackage_Ecore2Maude_TrgRecTerm_TrgTerm, gen_jointPackage_Ecore2Maude_TrgVariable_TrgTerm, gen_jointPackage_Ecore2Maude_TrgView_TrgMaudeTopEl, gen_jointPackage_Ecore2Maude_TrgRenMapping_TrgViewMapping, gen_jointPackage_Ecore2Maude_TrgOpTypedMapping_TrgRenMapping, gen_jointPackage_Ecore2Maude_TrgOpMapping_TrgRenMapping, gen_jointPackage_Ecore2Maude_TrgLabelMapping_TrgRenMapping},
    metadata=None
)
