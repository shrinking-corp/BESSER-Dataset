...
public class jointPackage_Ecore2Maude_TrgSubsortRel extends TrgModElement {
    ...
    public jointPackage_Ecore2Maude_TrgSubsortRel(
    ) {
        super(
        );
    ...
    public jointPackage_Ecore2Maude_TrgSubsortRel(
        ArrayList<jointPackage_Ecore2Maude_TrgSort> jointpackage_ecore2maude_trgsorts,        ArrayList<jointPackage_Ecore2Maude_TrgSort> jointpackage_ecore2maude_trgsorts    ) {
