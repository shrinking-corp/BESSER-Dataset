...
public class jointPackage_Ecore2Maude_SrcEClass extends SrcEClassifier {
    ...
    public jointPackage_Ecore2Maude_SrcEClass(
        boolean interface,        boolean abstract        ArrayList<jointPackage_Ecore2Maude_SrcEOperation> jointpackage_ecore2maude_srceoperations,        ArrayList<jointPackage_Ecore2Maude_SrcEAttribute> jointpackage_ecore2maude_srceattributes,        ArrayList<jointPackage_Ecore2Maude_SrcEClass> jointpackage_ecore2maude_srceclasss,        ArrayList<jointPackage_Ecore2Maude_SrcEReference> jointpackage_ecore2maude_srcereferences,        ArrayList<jointPackage_Ecore2Maude_SrcEOperation> jointpackage_ecore2maude_srceoperations,        ArrayList<jointPackage_Ecore2Maude_SrcEAttribute> jointpackage_ecore2maude_srceattributes,        ArrayList<jointPackage_Ecore2Maude_SrcEReference> jointpackage_ecore2maude_srcereferences,        ArrayList<jointPackage_Ecore2Maude_SrcEReference> jointpackage_ecore2maude_srcereferences    ) {
        this.interface = interface;
        this.abstract = abstract;
