...
class statemachine_State:
    ...
    def __init__(self, name: str, statemachine_State7: "statemachine_Statemachine" = None, statemachine_State: "statemachine_Statemachine" = None, statemachine_State10: "statemachine_Transition" = None, statemachine_State16: "statemachine_Transition" = None):
        self.name = name
...
class statemachine_Statemachine:
    ...
    def __init__(self, name: str, statemachine_Statemachine6: "statemachine_State" = None, statemachine_Statemachine: set["statemachine_State"] = None, statemachine_Statemachine2: set["statemachine_Event"] = None, statemachine_Statemachine4: set["statemachine_Transition"] = None):
        self.name = name
