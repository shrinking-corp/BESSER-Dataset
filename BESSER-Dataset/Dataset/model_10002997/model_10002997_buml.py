...
User.attributes={User__P, User___M, User__F}
...
Message.attributes={Message_sender, Message_reciver, Message_message}
...
Account.attributes={Account_name, Account_entity, Account_email, Account_password}
...
domain_model = DomainModel(
    name="f3b6e415_2e75_4730_9f3d_0c1617b001a2",
    types={User, Friend, Message, Photos, HomePage, Account},
    associations={User_Message, User_Photos, User_Friend, User_HomePage},
    generalizations={},
    metadata=None
)
