...
class simpleClass_Attribute:
    ...
    def __init__(self, id: bool, name: str, simpleClass_Attribute14: "simpleClass_Classifier" = None, simpleClass_Attribute: "simpleClass_Class" = None):
        self.id = id
        self.name = name
...
class simpleClass_Classifier(ABC):
    ...
    def __init__(self, name: str, simpleClass_Classifier15: "simpleClass_Attribute" = None, simpleClass_Classifier: "simpleClass_ClassModel" = None):
        self.name = name
