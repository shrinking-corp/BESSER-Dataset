...
Poker.attributes={Poker_dealer, Poker_player1, Poker_player2}
...
Player.attributes={Player_hand, Player_name, Player_bank}
...
Dealer.attributes={Dealer_analyzeHand, Dealer_deck}
...
domain_model = DomainModel(
    name="_2bc10af2_f061_4df7_85cc_2955c2af369d",
    types={Poker, Card, Hand, Player, RecordBook, Deck, Dealer, HandStrength, Bank, Human, Computer},
    associations={Card_Deck, TexasHoldEm_RecordBook, Dealer_TexasHoldEm, Player_TexasHoldEm, Player_Hand, Hand_Card, Dealer_Deck, HandStrength_Dealer, Bank_Player},
    generalizations={},
    metadata=None
)
