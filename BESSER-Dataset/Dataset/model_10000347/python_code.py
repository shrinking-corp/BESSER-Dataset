...
class Player(ABC):
    ...
    def __init__(self, name: str, hand: Hand, bank: Bank, texasHoldEm6: "Poker" = None, hand28: "Hand" = None, bank217: "Bank" = None):
        self.name = name
        self.hand = hand
        self.bank = bank
...
class Hand:
    ...
    def __init__(self, handCollection: str, player9: "Player" = None, card10: set["Card"] = None):
...
class Card:
    ...
    def __init__(self, suit: str, name: str, val: str, img: str, hand11: "Hand" = None, deck0: "Deck" = None):
        self.suit = suit
        self.name = name
        self.val = val
        self.img = img
...
class Poker:
    ...
    def __init__(self, player1: Player, player2: Player, dealer: Dealer, player7: set["Player"] = None, recordBook2: "RecordBook" = None, dealer25: "Dealer" = None):
