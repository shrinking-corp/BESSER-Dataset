...
@given(instance=statemachine_Action_strategy)
def test_hyp_statemachine_action_actionStatement_setter(instance):
...
@given(instance=statemachine_Transition_strategy)
def test_hyp_statemachine_transition_actionStatement_setter(instance):
    original = instance.actionStatement
    instance.actionStatement = original
    assert instance.actionStatement == original
...
@given(instance=statemachine_Transition_strategy)
def test_hyp_statemachine_transition_guardExpression_setter(instance):
...
def test_statemachine_Action_actionLabel_value_roundtrip():
    instance = statemachine_Action(actionLabel="sample_text", actionStatement="sample_text")
    assert instance.actionLabel == "sample_text"
    instance.actionLabel = "sample_text_2"
    assert instance.actionLabel == "sample_text_2"


def test_statemachine_Action_actionStatement_value_roundtrip():
    instance = statemachine_Action(actionLabel="sample_text", actionStatement="sample_text")
...
def test_statemachine_Transition_actionLabel_value_roundtrip():
    instance = statemachine_Transition(actionLabel="sample_text", actionStatement="sample_text", guardExpression="sample_text", guardLabel="sample_text", label="sample_text", sourceLabel="sample_text", targetLabel="sample_text")
    assert instance.actionLabel == "sample_text"
    instance.actionLabel = "sample_text_2"
    assert instance.actionLabel == "sample_text_2"


def test_statemachine_Transition_actionStatement_value_roundtrip():
    instance = statemachine_Transition(actionLabel="sample_text", actionStatement="sample_text", guardExpression="sample_text", guardLabel="sample_text", label="sample_text", sourceLabel="sample_text", targetLabel="sample_text")
    assert instance.actionStatement == "sample_text"
    instance.actionStatement = "sample_text_2"
    assert instance.actionStatement == "sample_text_2"
...
def test_statemachine_Transition_guardExpression_value_roundtrip():
    instance = statemachine_Transition(actionLabel="sample_text", actionStatement="sample_text", guardExpression="sample_text", guardLabel="sample_text", label="sample_text", sourceLabel="sample_text", targetLabel="sample_text")
...
def test_assoc_entry16_link_reassign_clear():
    a = statemachine_Action(actionLabel="sample_text", actionStatement="sample_text")
...
def test_assoc_reachable11_link_reassign_clear():
    ...
    _safe_set(a, 'statemachine_State10', set())
...
def test_assoc_source3_link_reassign_clear():
    a = statemachine_Transition(actionLabel="sample_text", actionStatement="sample_text", guardExpression="sample_text", guardLabel="sample_text", label="sample_text", sourceLabel="sample_text", targetLabel="sample_text")
    b1 = statemachine_State(id=7, label="sample_text")
    b2 = statemachine_State(id=13, label="sample_text_2")
...
def test_assoc_successors8_link_reassign_clear():
    a = statemachine_State(id=7, label="sample_text")
    b1 = statemachine_State(id=7, label="sample_text")
    b2 = statemachine_State(id=13, label="sample_text_2")
...
def test_assoc_to_state4_link_reassign_clear():
    a = statemachine_Transition(actionLabel="sample_text", actionStatement="sample_text", guardExpression="sample_text", guardLabel="sample_text", label="sample_text", sourceLabel="sample_text", targetLabel="sample_text")
    b1 = statemachine_State(id=7, label="sample_text")
    b2 = statemachine_State(id=13, label="sample_text_2")
...
def test_assoc_to_transitions13_link_reassign_clear():
    a = statemachine_Transition(actionLabel="sample_text", actionStatement="sample_text", guardExpression="sample_text", guardLabel="sample_text", label="sample_text", sourceLabel="sample_text", targetLabel="sample_text")
    b1 = statemachine_State(id=7, label="sample_text")
    b2 = statemachine_State(id=13, label="sample_text_2")
    _safe_set(a, 'statemachine_Transition15', b1)
    assert _is_linked(a, 'statemachine_Transition15', b1)
    if hasattr(b1, 'statemachine_State14'):
        assert _is_linked(b1, 'statemachine_State14', a)
    _safe_set(a, 'statemachine_Transition15', b2)
    assert _is_linked(a, 'statemachine_Transition15', b2)
    if hasattr(b1, 'statemachine_State14'):
        assert not _is_linked(b1, 'statemachine_State14', a)
    if hasattr(b2, 'statemachine_State14'):
        assert _is_linked(b2, 'statemachine_State14', a)
    _safe_set(a, 'statemachine_Transition15', None)
    assert not _is_linked(a, 'statemachine_Transition15', b2)
    if hasattr(b2, 'statemachine_State14'):
        assert not _is_linked(b2, 'statemachine_State14', a)
...
statemachine_Action_strategy = st.builds(statemachine_Action, actionLabel=safe_text, actionStatement=safe_text)
@given(instance=statemachine_Action_strategy)
@settings(max_examples=25)
...
statemachine_Transition_strategy = st.builds(statemachine_Transition, actionLabel=safe_text, actionStatement=safe_text, guardExpression=safe_text, guardLabel=safe_text, label=safe_text, sourceLabel=safe_text, targetLabel=safe_text)
@given(instance=statemachine_Transition_strategy)
@settings(max_examples=25)
