...
class statemachine_Transition(Declaration):
    ...
    def __init__(self, guardLabel: str, actionLabel: str, label: str, sourceLabel: str, targetLabel: str, guardExpression: str, actionStatement: str, statemachine_Transition: "statemachine_State" = None, statemachine_Transition5: "statemachine_State" = None, statemachine_Transition15: "statemachine_State" = None):
