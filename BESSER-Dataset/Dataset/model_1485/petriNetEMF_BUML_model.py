...
# Classes
petriNetEMF_PetriNet = Class(name="petriNetEMF_PetriNet")
Identification = Class(name="Identification")
petriNetEMF_Place = Class(name="petriNetEMF_Place")
petriNetEMF_Transition = Class(name="petriNetEMF_Transition")
petriNetEMF_Arc = Class(name="petriNetEMF_Arc", is_abstract=True)
petriNetEMF_Identification = Class(name="petriNetEMF_Identification", is_abstract=True)
petriNetEMF_PlaceToTransitionArc = Class(name="petriNetEMF_PlaceToTransitionArc")
petriNetEMF_TransitionToPlaceArc = Class(name="petriNetEMF_TransitionToPlaceArc")
Arc = Class(name="Arc")
...
outgoingArcs5: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_", type=petriNetEMF_PlaceToTransitionArc, multiplicity=Multiplicity(0, 9999))
    }
)
...
outgoingArcs7: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="from_8", type=petriNetEMF_TransitionToPlaceArc, multiplicity=Multiplicity(0, 9999))
    }
)
...
domain_model = DomainModel(
    name="petriNetEMF",
    types={petriNetEMF_PetriNet, Identification, petriNetEMF_Place, petriNetEMF_Transition, petriNetEMF_Arc, petriNetEMF_Identification, petriNetEMF_PlaceToTransitionArc, petriNetEMF_TransitionToPlaceArc, Arc},
    associations={Places0, Transitions1, Arcs3, outgoingArcs5, incomingArcs6, outgoingArcs7, incomingArcs10, to13, from_14, from_15, to18},
    generalizations={gen_petriNetEMF_PetriNet_Identification, gen_petriNetEMF_Place_Identification, gen_petriNetEMF_Arc_Identification, gen_petriNetEMF_Transition_Identification, gen_petriNetEMF_PlaceToTransitionArc_Arc, gen_petriNetEMF_TransitionToPlaceArc_Arc},
    metadata=None
)
