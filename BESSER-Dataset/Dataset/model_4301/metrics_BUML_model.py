...
metrics_MappingRDBMS.attributes={metrics_MappingRDBMS_databaseType, metrics_MappingRDBMS_user, metrics_MappingRDBMS_timeFormat, metrics_MappingRDBMS_query, metrics_MappingRDBMS_dateFormat, metrics_MappingRDBMS_dateTimeFormat, metrics_MappingRDBMS_password}
...
domain_model = DomainModel(
    name="metrics",
    types={metrics_Mapping, Base, metrics_DataKind, metrics_IdentifierDataKind, DataKind, metrics_MappingCSV, Mapping, metrics_MappingColumn, metrics_MappingRDBMS, metrics_MappingRecord, metrics_Metric, metrics_MappingStatistic, metrics_DateTimeRange, metrics_MappingXLS, metrics_Expression, metrics_MetricSource, metrics_Unit, metrics_MetricRetentionRule, metrics_MetricRetentionRules, metrics_MetricValueRange, metrics_Value, metrics_ValueDataKind, KindHintType, DatabaseTypeType, MetricRetentionPeriod, ObjectKindType, ValueKindType},
    associations={headerMappingColumns0, dataMappingColumns1, dataType4, metrics16, failedRecords6, mappingDuration7, periodEstimate9, subStatistics13, retentionExpression23, expressionRef17, metricSourceRef19, unitRef21, metricRetentionRules25, metricMapping27, statistics30, metricRef34, metricValues33},
    generalizations={gen_metrics_Mapping_Base, gen_metrics_IdentifierDataKind_DataKind, gen_metrics_MappingCSV_Mapping, gen_metrics_MappingColumn_Base, gen_metrics_MappingRDBMS_Mapping, gen_metrics_MappingRecord_Base, gen_metrics_Metric_Base, gen_metrics_MappingStatistic_Base, gen_metrics_MappingXLS_Mapping, gen_metrics_MetricSource_Base, gen_metrics_ValueDataKind_DataKind},
    metadata=None
)
