...
public class metrics_MappingStatistic extends Base {
    ...
    public metrics_MappingStatistic(
        String intervalEstimate,        String message,        String totalRecords        ArrayList<metrics_MappingStatistic> metrics_mappingstatistics,        ArrayList<metrics_MappingRecord> metrics_mappingrecords    ) {
        this.intervalEstimate = intervalEstimate;
        this.message = message;
        this.totalRecords = totalRecords;
