...
domain_model = DomainModel(
    name="swml",
    types={swml_WebModel, swml_HypertextLayer, swml_Page, swml_Class, swml_Attribute, swml_ContentLayer, swml_StaticPage, swml_NCLink, Link, swml_CLink, swml_Link, swml_IndexPage, DynamicPage, swml_DetailsPage, swml_DynamicPage, Page, SWMLTypes},
    associations={pages3, homePage5, classes8, attributes10, representativeAttribute12, hypertext0, content1, displayedClass17, target19, links15},
