...
def test_hyp_errya_alias_is_not_abstract():
    assert not inspect.isabstract(errya_Alias)


def test_hyp_errya_alias_constructor_exists():
    assert callable(errya_Alias.__init__)


def test_hyp_errya_alias_constructor_args():
...
def test_hyp_errya_namedelement_is_not_abstract():
    assert not inspect.isabstract(errya_NamedElement)


def test_hyp_errya_namedelement_constructor_exists():
    assert callable(errya_NamedElement.__init__)


def test_hyp_errya_namedelement_constructor_args():
...
def test_hyp_errya_relatedto_is_not_abstract():
    assert not inspect.isabstract(errya_RelatedTo)


def test_hyp_errya_relatedto_constructor_exists():
    assert callable(errya_RelatedTo.__init__)


def test_hyp_errya_relatedto_constructor_args():
...
def test_hyp_errya_thing_is_not_abstract():
    assert not inspect.isabstract(errya_Thing)


def test_hyp_errya_thing_constructor_exists():
    assert callable(errya_Thing.__init__)


def test_hyp_errya_thing_constructor_args():
...
def test_hyp_errya_world_is_not_abstract():
    assert not inspect.isabstract(errya_World)


def test_hyp_errya_world_constructor_exists():
    assert callable(errya_World.__init__)


def test_hyp_errya_world_constructor_args():
...
def test_hyp_errya_alias_id_setter(instance):
...
def test_hyp_errya_namedelement_name_setter(instance):
...
def test_hyp_errya_relatedto_since_setter(instance):
...
def test_hyp_errya_thing_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
