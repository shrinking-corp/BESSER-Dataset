...
# Classes
databaseMetamodel_Column = Class(name="databaseMetamodel_Column")
databaseMetamodel_Database = Class(name="databaseMetamodel_Database")
databaseMetamodel_Relation = Class(name="databaseMetamodel_Relation")
...
databaseMetamodel_Column.attributes={databaseMetamodel_Column_hasPKOrder, databaseMetamodel_Column_name, databaseMetamodel_Column_type, databaseMetamodel_Column_hasFKOrder}
...
databaseMetamodel_Relation.attributes={databaseMetamodel_Relation_name, databaseMetamodel_Relation_isJoinTable, databaseMetamodel_Relation_isSelfJoinTable}
...
domain_model = DomainModel(
    ...
    associations={hasColumns1, hasPrimaryKey3, hasForeignKey6, referencesRelation10, isForeinKeyToColumn13, isForeignKeyToRelation15, relation0},
    generalizations={},
    metadata=None
)
