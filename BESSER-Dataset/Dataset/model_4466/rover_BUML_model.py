...
rover_Tansition = Class(name="rover_Tansition")
rover_Actuator = Class(name="rover_Actuator", is_abstract=True)
rover_GPS = Class(name="rover_GPS")
Sensor = Class(name="Sensor")
rover_DistanceSensor = Class(name="rover_DistanceSensor")
rover_directionFacing = Class(name="rover_directionFacing")
...
rover_Command = Class(name="rover_Command")
rover_Repeate = Class(name="rover_Repeate")
...
rover_SingleQuantity = Class(name="rover_SingleQuantity")
rover_PositionQuantity = Class(name="rover_PositionQuantity")
...
rover_Tansition.attributes={rover_Tansition_comparedQuantity, rover_Tansition_operationUsed}
...
domain_model = DomainModel(
    name="rover",
    types={rover_Rover, rover_Component, rover_Program, rover_Tansition, rover_Actuator, rover_GPS, Sensor, rover_DistanceSensor, rover_directionFacing, rover_Motor, Actuator, rover_Light, rover_Block, rover_Command, rover_Repeate, rover_Rotate, rover_Move, rover_Sensor, Component, rover_SingleQuantity, rover_PositionQuantity, rover_Compass, rover_Wait, rover_SetLightColor},
    associations={component0, program1, triggered3, block4, command6, tansition8, repeate11, rotate13, move15, setlightcolor19, outgoingTransition21, incomingTransition22, sourceCommand24, targetCommand25, wait17},
    generalizations={gen_rover_Actuator_Component, gen_rover_GPS_Sensor, gen_rover_DistanceSensor_Sensor, gen_rover_directionFacing_Sensor, gen_rover_Motor_Actuator, gen_rover_Light_Actuator, gen_rover_Sensor_Component, gen_rover_Compass_Sensor},
    metadata=None
)
