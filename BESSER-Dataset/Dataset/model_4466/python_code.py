...
class rover_Tansition:
    ...
    def __init__(self, comparedQuantity: str, operationUsed: str, rover_Tansition: "rover_Sensor" = None, rover_Tansition10: "rover_Block" = None, Tansition: "rover_Command" = None, Tansition23: "rover_Command" = None, outgoingTransition: "rover_Command" = None, incomingTransition: "rover_Command" = None):
