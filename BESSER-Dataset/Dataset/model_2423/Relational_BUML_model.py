...
Relational_ERModel = Class(name="Relational_ERModel")
...
Relational_FKey = Class(name="Relational_FKey")
...
domain_model = DomainModel(
    name="Relational",
    types={Relational_Type, Relational_ERModel, Relational_Named, Relational_Table, Named, Relational_Column, Relational_FKey},
    associations={owner4, keyOf5, type7, ref8, cols11, table14, type16, col0, key1, fkeys3},
