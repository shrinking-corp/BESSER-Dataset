...
def test_hyp_relational_ermodel_is_not_abstract():
    assert not inspect.isabstract(Relational_ERModel)


def test_hyp_relational_ermodel_constructor_exists():
    assert callable(Relational_ERModel.__init__)


def test_hyp_relational_ermodel_constructor_args():
    sig = inspect.signature(Relational_ERModel.__init__)
    params = list(sig.parameters.keys())



def test_hyp_relational_fkey_is_not_abstract():
    assert not inspect.isabstract(Relational_FKey)


def test_hyp_relational_fkey_constructor_exists():
    assert callable(Relational_FKey.__init__)


def test_hyp_relational_fkey_constructor_args():
...
Relational_ERModel_strategy = st.builds(Relational_ERModel)
...
Relational_FKey_strategy = st.builds(Relational_FKey)
