...
public class Relational_Column extends Named {
    ...
    private Relational_Type relational_type;
    ...
    public Relational_Type getRelational_type() {
        return relational_type;
    }

    public void setRelational_type(Relational_Type relational_type) {
        this.relational_type = relational_type;
    }
    public Relational_Table getRelational_table() {
        return relational_table;
    }
