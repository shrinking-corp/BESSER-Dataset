...
def test_hyp_library3simplified_book_is_not_abstract():
    assert not inspect.isabstract(library3Simplified_Book)


def test_hyp_library3simplified_book_constructor_exists():
    assert callable(library3Simplified_Book.__init__)


def test_hyp_library3simplified_book_constructor_args():
...
def test_hyp_library3simplified_bookinfo_is_not_abstract():
    assert not inspect.isabstract(library3Simplified_BookInfo)


def test_hyp_library3simplified_bookinfo_constructor_exists():
    assert callable(library3Simplified_BookInfo.__init__)


def test_hyp_library3simplified_bookinfo_constructor_args():
    sig = inspect.signature(library3Simplified_BookInfo.__init__)
    params = list(sig.parameters.keys())



def test_hyp_library3simplified_library_is_not_abstract():
    assert not inspect.isabstract(library3Simplified_Library)


def test_hyp_library3simplified_library_constructor_exists():
    assert callable(library3Simplified_Library.__init__)


def test_hyp_library3simplified_library_constructor_args():
    sig = inspect.signature(library3Simplified_Library.__init__)
    params = list(sig.parameters.keys())



def test_hyp_library3simplified_customer_is_not_abstract():
    assert not inspect.isabstract(library3Simplified_Customer)


def test_hyp_library3simplified_customer_constructor_exists():
    assert callable(library3Simplified_Customer.__init__)


def test_hyp_library3simplified_customer_constructor_args():
...
def test_hyp_library3simplified_book_pages_setter(instance):
...
@given(instance=library3Simplified_Book_strategy)
def test_hyp_library3simplified_book_title_setter(instance):
...
@given(instance=library3Simplified_Book_strategy)
def test_hyp_library3simplified_book_isbn_setter(instance):
...
@given(instance=library3Simplified_Book_strategy)
def test_hyp_library3simplified_book_author_setter(instance):
...
@given(instance=library3Simplified_Book_strategy)
def test_hyp_library3simplified_book_name_setter(instance):
...
def test_hyp_library3simplified_customer_firstName_setter(instance):
...
@given(instance=library3Simplified_Customer_strategy)
def test_hyp_library3simplified_customer_lastName_setter(instance):
...
def test_library3Simplified_Book_author_value_roundtrip():
    instance = library3Simplified_Book(author="sample_text", isbn="sample_text", name="sample_text", pages=7, title="sample_text")
...
def test_library3Simplified_Customer_firstName_value_roundtrip():
    instance = library3Simplified_Customer(firstName="sample_text", lastName="sample_text")
...
def test_assoc_bookInfo0_link_reassign_clear():
    a = library3Simplified_Book(author="sample_text", isbn="sample_text", name="sample_text", pages=7, title="sample_text")
...
def test_assoc_borrowedBookId1_link_reassign_clear():
    a = library3Simplified_Customer(firstName="sample_text", lastName="sample_text")
    b1 = library3Simplified_Book(author="sample_text", isbn="sample_text", name="sample_text", pages=7, title="sample_text")
    b2 = library3Simplified_Book(author="sample_text_2", isbn="sample_text_2", name="sample_text_2", pages=13, title="sample_text_2")
...
library3Simplified_Book_strategy = st.builds(library3Simplified_Book, author=safe_text, isbn=safe_text, name=safe_text, pages=st.integers(), title=safe_text)
@given(instance=library3Simplified_Book_strategy)
...
library3Simplified_Customer_strategy = st.builds(library3Simplified_Customer, firstName=safe_text, lastName=safe_text)
@given(instance=library3Simplified_Customer_strategy)
@settings(max_examples=25)
