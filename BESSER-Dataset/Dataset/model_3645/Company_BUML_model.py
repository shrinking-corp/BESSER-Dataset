...
company_Bug418716 = Class(name="company_Bug418716")
...
company_Company_m_dummyInvariant: Method = Method(name="dummyInvariant", parameters={Parameter(name='company_context', type=StringType), Parameter(name='company_diagnostics', type=StringType)}, type=BooleanType)
...
company_Employee_m_reportsTo: Method = Method(name="reportsTo", parameters={Parameter(name='company_manager', type=StringType)}, type=BooleanType)
company_Employee_m_hasNameAsOperation: Method = Method(name="hasNameAsOperation", parameters={}, type=BooleanType)
company_Employee_m_noManagerImpliesDirectReports: Method = Method(name="noManagerImpliesDirectReports", parameters={Parameter(name='company_context', type=StringType), Parameter(name='company_diagnostics', type=StringType)}, type=BooleanType)
company_Employee.attributes={company_Employee_name, company_Employee_hasNameAsAttribute}
company_Employee.methods={company_Employee_m_noManagerImpliesDirectReports, company_Employee_m_hasNameAsOperation, company_Employee_m_reportsTo}
...
domain_model = DomainModel(
    ...
    associations={manager2, company3, directReports5, allReports8, reportingChain11, employees0},
    generalizations={},
    metadata=None
)
