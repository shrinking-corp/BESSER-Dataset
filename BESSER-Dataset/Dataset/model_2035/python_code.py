...
class dsl_State:
    ...
    def __init__(self, name: str, dsl_State24: "dsl_Transition" = None, dsl_State10: "dsl_Statemachine" = None, dsl_State: "dsl_Statemachine" = None, dsl_State12: set["dsl_Command"] = None, dsl_State15: set["dsl_Transition"] = None, dsl_State18: "dsl_State" = None, dsl_State16: set["dsl_State"] = None):
        self.name = name
...
class dsl_Event:
    ...
    def __init__(self, name: str, code: str, dsl_Event21: "dsl_Transition" = None, dsl_Event: "dsl_Statemachine" = None, dsl_Event3: "dsl_Statemachine" = None):
        self.name = name
        self.code = code
