...
dsl_Command = Class(name="dsl_Command")
...
dsl_Command.attributes={dsl_Command_code, dsl_Command_name}
...
domain_model = DomainModel(
    name="dsl",
    types={dsl_Statemachine, dsl_Event, dsl_State, dsl_Transition, dsl_Command},
    associations={events0, resetEvents1, initialState4, actions11, transitions14, subState17, event19, state22, commands6, state8},
    generalizations={},
    metadata=None
)
