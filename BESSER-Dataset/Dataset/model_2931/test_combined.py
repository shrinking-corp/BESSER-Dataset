...
def test_hyp_domainmodel_method_is_not_abstract():
    assert not inspect.isabstract(domainmodel_Method)


def test_hyp_domainmodel_method_constructor_exists():
    assert callable(domainmodel_Method.__init__)


def test_hyp_domainmodel_method_constructor_args():
...
def test_hyp_domainmodel_method_body_setter(instance):
...
@given(instance=domainmodel_Method_strategy)
def test_hyp_domainmodel_method_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=domainmodel_Feature_strategy)
def test_hyp_domainmodel_feature_value_setter(instance):
