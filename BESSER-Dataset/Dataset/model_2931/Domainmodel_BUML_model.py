...
domainmodel_Method = Class(name="domainmodel_Method")
...
domainmodel_Feature.attributes={domainmodel_Feature_many, domainmodel_Feature_value, domainmodel_Feature_name}
...
domain_model = DomainModel(
    name="domainmodel",
    types={domainmodel_DataType, Type, domainmodel_Entity, domainmodel_Feature, domainmodel_Method, domainmodel_Domainmodel, domainmodel_AbstractElement, domainmodel_PackageDeclaration, AbstractElement, domainmodel_Import, domainmodel_Type},
    associations={superType4, features5, methods7, type9, elements0, elements1},
    generalizations={gen_domainmodel_DataType_Type, gen_domainmodel_Entity_Type, gen_domainmodel_PackageDeclaration_AbstractElement, gen_domainmodel_Import_AbstractElement, gen_domainmodel_Type_AbstractElement},
    metadata=None
)
