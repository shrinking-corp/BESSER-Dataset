...
def test_assoc_assignee33_link_reassign_clear():
    ...
    if hasattr(b1, 'activitydiagram_IntegerVariable34'):
        assert _is_linked(b1, 'activitydiagram_IntegerVariable34', a)
    ...
    if hasattr(b1, 'activitydiagram_IntegerVariable34'):
        assert not _is_linked(b1, 'activitydiagram_IntegerVariable34', a)
    if hasattr(b2, 'activitydiagram_IntegerVariable34'):
        assert _is_linked(b2, 'activitydiagram_IntegerVariable34', a)
    ...
    if hasattr(b2, 'activitydiagram_IntegerVariable34'):
        assert not _is_linked(b2, 'activitydiagram_IntegerVariable34', a)
...
def test_assoc_baseToken57_link_reassign_clear():
    ...
    if hasattr(b1, 'activitydiagram_Token58'):
        assert _is_linked(b1, 'activitydiagram_Token58', a)
    _safe_set(a, 'activitydiagram_ForkedToken', b2)
    assert _is_linked(a, 'activitydiagram_ForkedToken', b2)
    if hasattr(b1, 'activitydiagram_Token58'):
        assert not _is_linked(b1, 'activitydiagram_Token58', a)
    if hasattr(b2, 'activitydiagram_Token58'):
        assert _is_linked(b2, 'activitydiagram_Token58', a)
    _safe_set(a, 'activitydiagram_ForkedToken', None)
    assert not _is_linked(a, 'activitydiagram_ForkedToken', b2)
    if hasattr(b2, 'activitydiagram_Token58'):
        assert not _is_linked(b2, 'activitydiagram_Token58', a)
...
def test_assoc_executedNodes48_link_reassign_clear():
    a = activitydiagram_ActivityNode(running=True)
    ...
    if hasattr(b1, 'activitydiagram_Trace49'):
        assert _is_linked(b1, 'activitydiagram_Trace49', a)
    _safe_set(a, 'activitydiagram_ActivityNode', b2)
    assert _is_linked(a, 'activitydiagram_ActivityNode', b2)
    if hasattr(b1, 'activitydiagram_Trace49'):
        assert not _is_linked(b1, 'activitydiagram_Trace49', a)
    if hasattr(b2, 'activitydiagram_Trace49'):
        assert _is_linked(b2, 'activitydiagram_Trace49', a)
    _safe_set(a, 'activitydiagram_ActivityNode', None)
    assert not _is_linked(a, 'activitydiagram_ActivityNode', b2)
    if hasattr(b2, 'activitydiagram_Trace49'):
        assert not _is_linked(b2, 'activitydiagram_Trace49', a)
...
def test_assoc_holder46_link_reassign_clear():
    a = activitydiagram_ActivityNode(running=True)
    b1 = activitydiagram_Token()
    b2 = activitydiagram_Token()
    _safe_set(a, 'ActivityNode47', b1)
    assert _is_linked(a, 'ActivityNode47', b1)
    if hasattr(b1, 'heldTokens'):
        assert _is_linked(b1, 'heldTokens', a)
    _safe_set(a, 'ActivityNode47', b2)
    assert _is_linked(a, 'ActivityNode47', b2)
    if hasattr(b1, 'heldTokens'):
        assert not _is_linked(b1, 'heldTokens', a)
    if hasattr(b2, 'heldTokens'):
        assert _is_linked(b2, 'heldTokens', a)
    _safe_set(a, 'ActivityNode47', None)
    assert not _is_linked(a, 'ActivityNode47', b2)
    if hasattr(b2, 'heldTokens'):
...
def test_assoc_offers18_link_reassign_clear():
    ...
    _safe_set(a, 'activitydiagram_ActivityEdge19', set())
...
def test_assoc_operand241_link_reassign_clear():
    ...
    b1 = activitydiagram_BooleanVariable()
    b2 = activitydiagram_BooleanVariable()
    _safe_set(a, 'activitydiagram_BooleanBinaryExpression42', b1)
    assert _is_linked(a, 'activitydiagram_BooleanBinaryExpression42', b1)
    if hasattr(b1, 'activitydiagram_BooleanVariable43'):
        assert _is_linked(b1, 'activitydiagram_BooleanVariable43', a)
    _safe_set(a, 'activitydiagram_BooleanBinaryExpression42', b2)
    assert _is_linked(a, 'activitydiagram_BooleanBinaryExpression42', b2)
    if hasattr(b1, 'activitydiagram_BooleanVariable43'):
        assert not _is_linked(b1, 'activitydiagram_BooleanVariable43', a)
    if hasattr(b2, 'activitydiagram_BooleanVariable43'):
        assert _is_linked(b2, 'activitydiagram_BooleanVariable43', a)
    _safe_set(a, 'activitydiagram_BooleanBinaryExpression42', None)
    assert not _is_linked(a, 'activitydiagram_BooleanBinaryExpression42', b2)
    if hasattr(b2, 'activitydiagram_BooleanVariable43'):
        assert not _is_linked(b2, 'activitydiagram_BooleanVariable43', a)
...
def test_assoc_variable52_link_reassign_clear():
    ...
    _safe_set(a, 'activitydiagram_Variable54', b1)
    assert _is_linked(a, 'activitydiagram_Variable54', b1)
    if hasattr(b1, 'activitydiagram_InputValue53'):
        assert _is_linked(b1, 'activitydiagram_InputValue53', a)
    _safe_set(a, 'activitydiagram_Variable54', b2)
    assert _is_linked(a, 'activitydiagram_Variable54', b2)
    if hasattr(b1, 'activitydiagram_InputValue53'):
        assert not _is_linked(b1, 'activitydiagram_InputValue53', a)
    if hasattr(b2, 'activitydiagram_InputValue53'):
        assert _is_linked(b2, 'activitydiagram_InputValue53', a)
    _safe_set(a, 'activitydiagram_Variable54', None)
    assert not _is_linked(a, 'activitydiagram_Variable54', b2)
    if hasattr(b2, 'activitydiagram_InputValue53'):
        assert not _is_linked(b2, 'activitydiagram_InputValue53', a)
