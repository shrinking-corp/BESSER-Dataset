...
class activitydiagram_ActivityNode(NamedElement):
    ...
    def __init__(self, running: bool, holder: set["activitydiagram_Token"] = None, ActivityNode15: "activitydiagram_ActivityEdge" = None, ActivityNode17: "activitydiagram_ActivityEdge" = None, ActivityNode47: "activitydiagram_Token" = None, activitydiagram_ActivityNode: "activitydiagram_Trace" = None, source: set["activitydiagram_ActivityEdge"] = None, target: set["activitydiagram_ActivityEdge"] = None, nodes: "activitydiagram_Activity" = None, ActivityNode: "activitydiagram_Activity" = None):
...
class activitydiagram_Activity(NamedElement):
    ...
    def __init__(self, inputValuePath: str, activitydiagram_Activity: set["activitydiagram_ActivityEdge"] = None, activitydiagram_Activity3: set["activitydiagram_Variable"] = None, activitydiagram_Activity5: set["activitydiagram_Variable"] = None, activitydiagram_Activity8: "activitydiagram_Trace" = None, Activity: "activitydiagram_ActivityNode" = None, activity: set["activitydiagram_ActivityNode"] = None):
