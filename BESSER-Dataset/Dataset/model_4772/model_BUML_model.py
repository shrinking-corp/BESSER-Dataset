...
# Classes
model_MAttribute = Class(name="model_MAttribute")
MModelElementEx = Class(name="MModelElementEx")
model_MClass = Class(name="model_MClass")
model_BasicType = Class(name="model_BasicType")
Type = Class(name="Type")
model_IntegerType = Class(name="model_IntegerType")
BasicType = Class(name="BasicType")
model_MOperation = Class(name="model_MOperation")
model_MAssociation = Class(name="model_MAssociation")
model_Type = Class(name="model_Type")
model_MMVisitor = Class(name="model_MMVisitor")
model_MModel = Class(name="model_MModel")
model_MClassInvariant = Class(name="model_MClassInvariant")
model_MPrePostCondition = Class(name="model_MPrePostCondition")
model_MModelElement = Class(name="model_MModelElement")
model_MModelElementEx = Class(name="model_MModelElementEx")
MModelElement = Class(name="MModelElement")
model_SetType = Class(name="model_SetType")
CollectionType = Class(name="CollectionType")
model_ObjectType = Class(name="model_ObjectType")
model_BagType = Class(name="model_BagType")
model_VarDecl = Class(name="model_VarDecl")
model_RealType = Class(name="model_RealType")
model_StringType = Class(name="model_StringType")
model_Comparable = Class(name="model_Comparable", is_abstract=True)
model_CollectionType = Class(name="model_CollectionType")
model_MAggregationKind = Class(name="model_MAggregationKind")
model_EnumType = Class(name="model_EnumType")
model_OclAnyType = Class(name="model_OclAnyType")
model_SequenceType = Class(name="model_SequenceType")
model_BooleanType = Class(name="model_BooleanType")
model_MAssociationEnd = Class(name="model_MAssociationEnd")
model_MAssociationClass = Class(name="model_MAssociationClass")
MClass = Class(name="MClass")
MAssociation = Class(name="MAssociation")
model_MMultiplicity = Class(name="model_MMultiplicity")
model_MRange = Class(name="model_MRange")
model_Expression = Class(name="model_Expression")
model_MNavigableElement = Class(name="model_MNavigableElement")
model_VarDeclList = Class(name="model_VarDeclList")
model_VoidType = Class(name="model_VoidType")
model_OrderedSetType = Class(name="model_OrderedSetType")
model_Part = Class(name="model_Part")
model_TupleType = Class(name="model_TupleType")

# model_MAttribute class attributes and methods
model_MAttribute_m_processWithVisitor: Method = Method(name="processWithVisitor", parameters={Parameter(name='model_v', type=StringType)})
...
model_MClass_m_setAbstract: Method = Method(name="setAbstract", parameters={Parameter(name='model_b', type=StringType)})
model_MClass_m_addAttribute: Method = Method(name="addAttribute", parameters={Parameter(name='model_attr', type=StringType)})
model_MClass_m_addOperation: Method = Method(name="addOperation", parameters={Parameter(name='model_op', type=StringType)})
model_MClass_m_addAssociation: Method = Method(name="addAssociation", parameters={Parameter(name='model_a', type=StringType)})
model_MClass_m_addParent: Method = Method(name="addParent", parameters={Parameter(name='model_c', type=StringType)})
model_MClass_m_addChild: Method = Method(name="addChild", parameters={Parameter(name='model_c', type=StringType)})
model_MClass_m_processWithVisitor: Method = Method(name="processWithVisitor", parameters={Parameter(name='model_v', type=StringType)})
model_MClass.methods={model_MClass_m_processWithVisitor, model_MClass_m_getAbstract, model_MClass_m_addAssociation, model_MClass_m_setAbstract, model_MClass_m_addAttribute, model_MClass_m_addChild, model_MClass_m_addOperation, model_MClass_m_addParent}
...
model_MOperation_m_addVarDecl: Method = Method(name="addVarDecl", parameters={Parameter(name='model_vd', type=StringType)})
model_MOperation.methods={model_MOperation_m_addVarDecl}

# model_MAssociation class attributes and methods
model_MAssociation_m_addAssociationEnd: Method = Method(name="addAssociationEnd", parameters={Parameter(name='model_ae', type=StringType)})
model_MAssociation_m_processWithVisitor: Method = Method(name="processWithVisitor", parameters={Parameter(name='model_v', type=StringType)})
model_MAssociation.methods={model_MAssociation_m_addAssociationEnd, model_MAssociation_m_processWithVisitor}
...
model_MModel_m_addClass: Method = Method(name="addClass", parameters={Parameter(name='model_cls', type=StringType)})
model_MModel_m_addClassInvariant: Method = Method(name="addClassInvariant", parameters={Parameter(name='model_inv', type=StringType)})
model_MModel_m_addPrePostCondition: Method = Method(name="addPrePostCondition", parameters={Parameter(name='model_ppc', type=StringType)})
model_MModel_m_processWithVisitor: Method = Method(name="processWithVisitor", parameters={Parameter(name='model_v', type=StringType)})
model_MModel.methods={model_MModel_m_addClass, model_MModel_m_addClassInvariant, model_MModel_m_processWithVisitor, model_MModel_m_addPrePostCondition}
...
model_MClassInvariant.attributes={model_MClassInvariant_positionInModel, model_MClassInvariant_name}
model_MClassInvariant.methods={model_MClassInvariant_m_getHasVars, model_MClassInvariant_m_getIsExistential}
...
model_MPrePostCondition_m_setPre: Method = Method(name="setPre", parameters={Parameter(name='model_b', type=StringType)})
model_MPrePostCondition.attributes={model_MPrePostCondition_positionInModel}
model_MPrePostCondition.methods={model_MPrePostCondition_m_getIsPre, model_MPrePostCondition_m_setPre}
...
model_MModelElement_m_processWithVisitor: Method = Method(name="processWithVisitor", parameters={Parameter(name='model_v', type=StringType)})
model_MModelElement.methods={model_MModelElement_m_processWithVisitor, model_MModelElement_m_name}

# model_MModelElementEx class attributes and methods
model_MModelElementEx_name: Property = Property(name="name", type=StringType)
model_MModelElementEx_m_processWithVisitor: Method = Method(name="processWithVisitor", parameters={Parameter(name='model_v', type=StringType)})
...
model_MAggregationKind.attributes={model_MAggregationKind_name, model_MAggregationKind_kind}
...
model_EnumType_m_addLiteral: Method = Method(name="addLiteral", parameters={Parameter(name='model_literal', type=StringType)})
...
model_MAssociationEnd.methods={model_MAssociationEnd_m_getExplicitNavigation, model_MAssociationEnd_m_getOrdered, model_MAssociationEnd_m_getNavigation}

# model_MAssociationClass class attributes and methods
model_MAssociationClass_m_processWithVisitor: Method = Method(name="processWithVisitor", parameters={Parameter(name='model_v', type=StringType)})
...
model_MMultiplicity_m_addRange: Method = Method(name="addRange", parameters={Parameter(name='model_r', type=StringType)})
...
model_MRange.attributes={model_MRange_lower, model_MRange_upper}
...
model_MNavigableElement_m_getType: Method = Method(name="getType", parameters={Parameter(name='model_src', type=StringType)}, type=Type)
...
domain_model = DomainModel(
    name="model",
    types={model_MAttribute, MModelElementEx, model_MClass, model_BasicType, Type, model_IntegerType, BasicType, model_MOperation, model_MAssociation, model_Type, model_MMVisitor, model_MModel, model_MClassInvariant, model_MPrePostCondition, model_MModelElement, model_MModelElementEx, MModelElement, model_SetType, CollectionType, model_ObjectType, model_BagType, model_VarDecl, model_RealType, model_StringType, model_Comparable, model_CollectionType, model_MAggregationKind, model_EnumType, model_OclAnyType, model_SequenceType, model_BooleanType, model_MAssociationEnd, model_MAssociationClass, MClass, MAssociation, model_MMultiplicity, model_MRange, model_Expression, model_MNavigableElement, model_VarDeclList, model_VoidType, model_OrderedSetType, model_Part, model_TupleType},
    associations={owner0, operations6, associations8, type1, attributes3, parents11, children14, owner22, resultType25, classes16, classInvariant18, prePostCondition20, mClass35, varDecls28, type30, elemType33, aggregationKind39, associationEnds37, association41, mClass44, mMultiplicity47, kind49, ranges52, body64, expanded66, cls54, association56, vars59, cls61, operation69, expression72, type75},
    generalizations={gen_model_MAttribute_MModelElementEx, gen_model_BasicType_Type, gen_model_IntegerType_BasicType, gen_model_MClass_MModelElementEx, gen_model_MModel_MModelElementEx, gen_model_MOperation_MModelElementEx, gen_model_MModelElementEx_MModelElement, gen_model_SetType_CollectionType, gen_model_ObjectType_Type, gen_model_BagType_CollectionType, gen_model_RealType_BasicType, gen_model_StringType_BasicType, gen_model_CollectionType_Type, gen_model_MAssociationEnd_MModelElementEx, gen_model_EnumType_Type, gen_model_OclAnyType_Type, gen_model_SequenceType_CollectionType, gen_model_BooleanType_BasicType, gen_model_MAssociation_MModelElementEx, gen_model_MAssociationClass_MClass, gen_model_MAssociationClass_MAssociation, gen_model_MPrePostCondition_MModelElement, gen_model_MClassInvariant_MModelElement, gen_model_VoidType_Type, gen_model_OrderedSetType_CollectionType, gen_model_TupleType_Type},
    metadata=None
)
