...
class MClass:
    ...
    pass
class model_MAssociationClass(MAssociation, MClass):

    def __init__(self):
        
        pass
    def processWithVisitor(self, model_v):
        # TODO: Implement processWithVisitor method
        pass

class model_MAggregationKind:

    def __init__(self, kind: int, name: str, model_MAggregationKind: "model_MAssociation" = None, model_MAggregationKind51: "model_MAssociationEnd" = None):
        self.kind = kind
        self.name = name
...
class model_MClassInvariant(MModelElement):
    ...
    def __init__(self, positionInModel: int, name: str, model_MClassInvariant: "model_MModel" = None, model_MClassInvariant65: "model_Expression" = None, model_MClassInvariant67: "model_Expression" = None, model_MClassInvariant60: "model_VarDeclList" = None, model_MClassInvariant62: "model_MClass" = None):
        self.positionInModel = positionInModel
        self.name = name
...
class model_Type:
    ...
    def __init__(self, typeName: str, typeId: int, model_Type: "model_MAttribute" = None, model_Type27: "model_MOperation" = None, model_Type76: "model_Part" = None, model_Type32: "model_VarDecl" = None, model_Type34: "model_CollectionType" = None):
...
class model_EnumType(Type):
    ...
    def addLiteral(self, model_literal):
...
class model_MClass(MModelElementEx):
    ...
    def __init__(self, model_MClass: "model_MAttribute" = None, model_MClass7: set["model_MOperation"] = None, model_MClass9: set["model_MAssociation"] = None, model_MClass4: set["model_MAttribute"] = None, model_MClass12: "model_MClass" = None, model_MClass10: set["model_MClass"] = None, model_MClass15: "model_MClass" = None, model_MClass13: set["model_MClass"] = None, model_MClass24: "model_MOperation" = None, model_MClass17: "model_MModel" = None, model_MClass36: "model_ObjectType" = None, model_MClass46: "model_MAssociationEnd" = None, model_MClass55: "model_MNavigableElement" = None, model_MClass63: "model_MClassInvariant" = None):
    ...
    def addChild(self, model_c):
        # TODO: Implement addChild method
        pass

    def addParent(self, model_c):
    ...
    def addOperation(self, model_op):
    ...
    def addAttribute(self, model_attr):
        # TODO: Implement addAttribute method
        pass

    def setAbstract(self, model_b):
        # TODO: Implement setAbstract method
        pass

    def addAssociation(self, model_a):
...
class model_MAssociationEnd(MModelElementEx):
    ...
    def getExplicitNavigation(self) :
...
class model_MAssociation(MModelElementEx):
    ...
    def __init__(self, model_MAssociation: "model_MClass" = None, model_MAssociation40: "model_MAggregationKind" = None, model_MAssociation38: set["model_MAssociationEnd"] = None, model_MAssociation43: "model_MAssociationEnd" = None, model_MAssociation58: "model_MNavigableElement" = None):
    ...
    def addAssociationEnd(self, model_ae):
...
class model_MModel(MModelElementEx):
    ...
    def __init__(self, model_MModel: set["model_MClass"] = None, model_MModel19: set["model_MClassInvariant"] = None, model_MModel21: set["model_MPrePostCondition"] = None):
    ...
    def addClassInvariant(self, model_inv):
        # TODO: Implement addClassInvariant method
        pass

    def addPrePostCondition(self, model_ppc):
    ...
    def addClass(self, model_cls):
        # TODO: Implement addClass method
        pass

class model_MOperation(MModelElementEx):

    def __init__(self, model_MOperation: "model_MClass" = None, model_MOperation23: "model_MClass" = None, model_MOperation26: "model_Type" = None, model_MOperation71: "model_MPrePostCondition" = None, model_MOperation29: set["model_VarDecl"] = None):
