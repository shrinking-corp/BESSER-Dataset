...
# Classes
arduinoml_AMLMachine = Class(name="arduinoml_AMLMachine")
arduinoml_Brick = Class(name="arduinoml_Brick", is_abstract=True)
arduinoml_AMLState = Class(name="arduinoml_AMLState")
NamedElement = Class(name="NamedElement")
arduinoml_Transition = Class(name="arduinoml_Transition")
arduinoml_Action = Class(name="arduinoml_Action", is_abstract=True)
arduinoml_DigitalSensor = Class(name="arduinoml_DigitalSensor")
Brick = Class(name="Brick")
arduinoml_DigitalActuator = Class(name="arduinoml_DigitalActuator")
arduinoml_AnalogSensor = Class(name="arduinoml_AnalogSensor")
arduinoml_AnalogActuator = Class(name="arduinoml_AnalogActuator")
arduinoml_NamedElement = Class(name="arduinoml_NamedElement", is_abstract=True)
arduinoml_Condition = Class(name="arduinoml_Condition", is_abstract=True)
arduinoml_TimeCondition = Class(name="arduinoml_TimeCondition")
arduinoml_DigitalCondition = Class(name="arduinoml_DigitalCondition")
Condition = Class(name="Condition")
arduinoml_DigitalAction = Class(name="arduinoml_DigitalAction")
Action = Class(name="Action")
arduinoml_AnalogCondition = Class(name="arduinoml_AnalogCondition")
arduinoml_AnalogAction = Class(name="arduinoml_AnalogAction", is_abstract=True)
arduinoml_AnalogActionValue = Class(name="arduinoml_AnalogActionValue")
AnalogAction = Class(name="AnalogAction")
arduinoml_AnalogActionSensor = Class(name="arduinoml_AnalogActionSensor")
...
arduinoml_TimeCondition.attributes={arduinoml_TimeCondition_tComp, arduinoml_TimeCondition_time}
...
arduinoml_AnalogCondition.attributes={arduinoml_AnalogCondition_value, arduinoml_AnalogCondition_aComp}
...
domain_model = DomainModel(
    name="arduinoml",
    types={arduinoml_AMLMachine, arduinoml_Brick, arduinoml_AMLState, NamedElement, arduinoml_Transition, arduinoml_Action, arduinoml_DigitalSensor, Brick, arduinoml_DigitalActuator, arduinoml_AnalogSensor, arduinoml_AnalogActuator, arduinoml_NamedElement, arduinoml_Condition, arduinoml_TimeCondition, arduinoml_DigitalCondition, Condition, arduinoml_DigitalAction, Action, arduinoml_AnalogCondition, arduinoml_AnalogAction, arduinoml_AnalogActionValue, AnalogAction, arduinoml_AnalogActionSensor, DigitalState, TimeComparison, AnalogComparison},
    associations={bricks0, states1, start3, goto10, transitions6, actions8, actuator16, conditions13, sensor15, sensor19, sensor17, actuator18},
    generalizations={gen_arduinoml_AMLState_NamedElement, gen_arduinoml_Brick_NamedElement, gen_arduinoml_DigitalSensor_Brick, gen_arduinoml_DigitalActuator_Brick, gen_arduinoml_AnalogSensor_Brick, gen_arduinoml_AnalogActuator_Brick, gen_arduinoml_TimeCondition_Condition, gen_arduinoml_DigitalCondition_Condition, gen_arduinoml_DigitalAction_Action, gen_arduinoml_AnalogCondition_Condition, gen_arduinoml_AnalogAction_Action, gen_arduinoml_AnalogActionValue_AnalogAction, gen_arduinoml_AnalogActionSensor_AnalogAction},
    metadata=None
)
