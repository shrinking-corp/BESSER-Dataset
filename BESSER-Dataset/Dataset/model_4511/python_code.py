...
class arduinoml_AMLMachine:
    ...
    def __init__(self, frequency: int, arduinoml_AMLMachine: set["arduinoml_Brick"] = None, arduinoml_AMLMachine2: set["arduinoml_AMLState"] = None, arduinoml_AMLMachine4: "arduinoml_AMLState" = None):
