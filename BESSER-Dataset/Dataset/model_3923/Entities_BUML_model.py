...
entities_Package = Class(name="entities_Package")
entities_Entity = Class(name="entities_Entity")
entities_TypeDef = Class(name="entities_TypeDef")
entities_JAVAID = Class(name="entities_JAVAID")
PackagedType = Class(name="PackagedType")
entities_PackagedType = Class(name="entities_PackagedType")
...
domain_model = DomainModel(
    name="entities",
    types={entities_Model, entities_Package, entities_Entity, entities_TypeDef, entities_JAVAID, PackagedType, entities_PackagedType, entities_Type, entities_SimpleType, Type, entities_Property},
    associations={elements0, extends6, properties7, package10, mappedType1, properties2, type4},
    generalizations={gen_entities_Entity_Type, gen_entities_Package_PackagedType, gen_entities_Type_PackagedType, gen_entities_SimpleType_Type},
    metadata=None
)
