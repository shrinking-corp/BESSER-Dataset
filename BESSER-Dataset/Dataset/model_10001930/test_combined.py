...
def test_hyp_ff_is_not_abstract():
    assert not inspect.isabstract(ff)


def test_hyp_ff_constructor_exists():
    assert callable(ff.__init__)


def test_hyp_ff_constructor_args():
...
def test_hyp_ff_fd_setter(instance):
...
def test_hyp_e_ee_setter(instance):
...
@given(instance=Dept_strategy)
def test_hyp_dept_DeptName_setter(instance):
...
@given(instance=Bill_strategy)
def test_hyp_bill_Amt_setter(instance):
...
def test_hyp_receptionist_RecName_setter(instance):
...
@given(instance=Receptionist_strategy)
def test_hyp_receptionist_Receptionid_setter(instance):
