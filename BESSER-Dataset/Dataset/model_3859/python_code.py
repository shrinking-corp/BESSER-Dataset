...
class grammarSql_Column:
    ...
    def __init__(self, name: str, type: str, isNotNull: bool, grammarSql_Column: "grammarSql_PrimaryKey" = None, grammarSql_Column5: "grammarSql_ForeignKey" = None, grammarSql_Column13: "grammarSql_Reference" = None):
        self.name = name
        self.type = type
