...
# Classes
grammarSql_Model = Class(name="grammarSql_Model")
grammarSql_Table = Class(name="grammarSql_Table")
grammarSql_EObject = Class(name="grammarSql_EObject")
grammarSql_Column = Class(name="grammarSql_Column")
grammarSql_PrimaryKey = Class(name="grammarSql_PrimaryKey")
grammarSql_ForeignKey = Class(name="grammarSql_ForeignKey")
grammarSql_Reference = Class(name="grammarSql_Reference")
...
grammarSql_Column.attributes={grammarSql_Column_isNotNull, grammarSql_Column_name, grammarSql_Column_type}
...
domain_model = DomainModel(
    name="grammarSql",
    types={grammarSql_Model, grammarSql_Table, grammarSql_EObject, grammarSql_Column, grammarSql_PrimaryKey, grammarSql_ForeignKey, grammarSql_Reference},
    associations={fromC11, tables0, elements1, col3, localColumns4, ref6, fromT8},
    generalizations={},
    metadata=None
)
