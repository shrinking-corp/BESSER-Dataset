...
class tp4_Researcher:
    ...
    def __init__(self, name: str, forName: str, tp4_Researcher: set["tp4_Write"] = None, tp4_Researcher3: set["tp4_Review"] = None, authors: set["tp4_Paper"] = None, tp4_Researcher6: set["tp4_Skill"] = None, tp4_Researcher8: "tp4_Position" = None, Researcher: "tp4_Paper" = None, tp4_Researcher27: "tp4_PublicationStructure" = None):
        self.name = name
...
class tp4_Progress(Labelled):
    ...
    def __init__(self, percent: int, tp4_Progress: "tp4_PublicationProcess" = None, progress: "tp4_Paper" = None, Progress: "tp4_Paper" = None):
...
class tp4_Paragraph(Named, Counted):
    ...
    def __init__(self, content: str, tp4_Paragraph15: set["tp4_ReviewNote"] = None, tp4_Paragraph22: "tp4_Write" = None, tp4_Paragraph: "tp4_Paper" = None):
        self.content = content
