...
domain_model = DomainModel(
    name="tp4",
    types={tp4_Researcher, tp4_Write, tp4_Review, tp4_Paper, tp4_Skill, tp4_Position, tp4_PublicationProcess, Named, tp4_Phases, tp4_ReviewNote, Labelled, tp4_Paragraph, tp4_Progress, tp4_Keyword, Counted, tp4_Named, tp4_Counted, tp4_Labelled, tp4_PublicationStructure, tp4_PublicationSystem},
    associations={phases0, writes1, reviews2, res_papers4, skills5, position7, reviews14, process16, paper18, paragraph20, reviewNote23, paragraphs9, progress10, authors11, keywords12, processView31, structuralView33, positions36, allKeywords39, parent43, researchers26, papers28},
    generalizations={gen_tp4_Paper_Named, gen_tp4_PublicationProcess_Named, gen_tp4_ReviewNote_Named, gen_tp4_Progress_Labelled, gen_tp4_Write_Labelled, gen_tp4_Review_Labelled, gen_tp4_Paragraph_Counted, gen_tp4_Paragraph_Named, gen_tp4_Position_Named, gen_tp4_PublicationStructure_Named, gen_tp4_Keyword_Named, gen_tp4_PublicationSystem_Named},
    metadata=None
)
