...
eavlibrary_Book.attributes={eavlibrary_Book_category, eavlibrary_Book_pages, eavlibrary_Book_title, eavlibrary_Book_test}
...
domain_model = DomainModel(
    name="eavlibrary",
    types={eavlibrary_Book, eavlibrary_Writer, eavlibrary_Pen, eavlibrary_City, eavlibrary_Library, BookCategory},
    associations={author0, books2, books4, city5, writers1, pens7},
    generalizations={},
    metadata=None
)
