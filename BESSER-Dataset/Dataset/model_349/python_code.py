...
class eavlibrary_Library:
    ...
    def __init__(self, name: str, eavlibrary_Library3: set["eavlibrary_Book"] = None, eavlibrary_Library: set["eavlibrary_Writer"] = None):
        self.name = name
...
class eavlibrary_Writer:
    ...
    def __init__(self, name: str, image: str, abstract: str, Writer: "eavlibrary_Book" = None, author: set["eavlibrary_Book"] = None, eavlibrary_Writer6: "eavlibrary_City" = None, eavlibrary_Writer: "eavlibrary_Library" = None, eavlibrary_Writer8: set["eavlibrary_Pen"] = None):
        self.name = name
        self.image = image
