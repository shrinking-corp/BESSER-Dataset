...
# Classes
sourcecode_Statement = Class(name="sourcecode_Statement", is_abstract=True)
sourcecode_While = Class(name="sourcecode_While")
sourcecode_Program = Class(name="sourcecode_Program")
sourcecode_Assignment = Class(name="sourcecode_Assignment")
Statement = Class(name="Statement")
sourcecode_Decision = Class(name="sourcecode_Decision")
...
domain_model = DomainModel(
    ...
    associations={negative4, first7, last9, first12, next1, positive2},
