...
class Rendez_Vous:
    ...
    def __init__(self, numeroRdV: int, dateRDV: str, heure: str, lieuRDV: str, examen6: "Examen" = None, medecin8: "Medecin" = None, patient3: "Patient" = None, consultion4: "Consultion" = None):
