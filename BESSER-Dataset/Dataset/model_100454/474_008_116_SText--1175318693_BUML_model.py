...
domain_model = DomainModel(
    name="stext",
    types={ScopedElement, stext_Scope, stext_Root, stext_DefRoot, stext_StatechartRoot, DefRoot, stext_StatechartSpecification, stext_StateRoot, stext_StateSpecification, stext_TransitionRoot, stext_TransitionSpecification, Operation, stext_LocalReaction, Reaction, stext_Guard, stext_TransitionReaction, stext_StatechartScope, Scope, stext_InterfaceScope, StatechartScope, NamedElement, stext_InternalScope, stext_ImportScope, stext_Import, stext_EventDefinition, Event, stext_VariableDefinition, Variable, Property_, stext_Expression, stext_OperationDefinition, Declaration, stext_SimpleScope, stext_ReactionTrigger, Trigger, stext_EntryPointSpec, ReactionProperty, stext_ExitPointSpec, stext_EventSpec, stext_RegularEventSpec, EventSpec, stext_TimeEventSpec, stext_BuiltinEventSpec, stext_EntryEvent, BuiltinEventSpec, stext_ExitEvent, stext_AlwaysEvent, stext_ActiveStateReferenceExpression, stext_State, stext_DefaultTrigger, stext_ReactionEffect, Effect, stext_EventRaisingExpression, Expression, stext_EventValueReferenceExpression, Direction, TimeEventType, TimeUnit},
    associations={scope4, roots0, def_1, def_2, def_3, reaction6, imports8, initialValue9, expression10, event12, value14, value29, triggers16, guard17, actions20, event22, value24, value27},
    generalizations={gen_stext_StatechartSpecification_ScopedElement, gen_stext_StatechartRoot_DefRoot, gen_stext_StateRoot_DefRoot, gen_stext_TransitionRoot_DefRoot, gen_stext_OperationDefinition_Operation, gen_stext_LocalReaction_Declaration, gen_stext_LocalReaction_Reaction, gen_stext_TransitionReaction_Reaction, gen_stext_StatechartScope_Scope, gen_stext_InterfaceScope_StatechartScope, gen_stext_InterfaceScope_NamedElement, gen_stext_InternalScope_StatechartScope, gen_stext_ImportScope_StatechartScope, gen_stext_EventDefinition_Event, gen_stext_EventDefinition_Event, gen_stext_VariableDefinition_Variable, gen_stext_VariableDefinition_Property, gen_stext_OperationDefinition_Declaration, gen_stext_SimpleScope_Scope, gen_stext_EntryPointSpec_ReactionProperty, gen_stext_ExitPointSpec_ReactionProperty, gen_stext_RegularEventSpec_EventSpec, gen_stext_TimeEventSpec_EventSpec, gen_stext_BuiltinEventSpec_EventSpec, gen_stext_EntryEvent_BuiltinEventSpec, gen_stext_ExitEvent_BuiltinEventSpec, gen_stext_AlwaysEvent_BuiltinEventSpec, gen_stext_ActiveStateReferenceExpression_Expression, gen_stext_ReactionTrigger_Trigger, gen_stext_DefaultTrigger_Trigger, gen_stext_ReactionEffect_Effect, gen_stext_EventRaisingExpression_Expression, gen_stext_EventValueReferenceExpression_Expression},
    metadata=None
)
