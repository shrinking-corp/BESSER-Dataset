...
class yya_RelatedTo(NamedElement):
    ...
    def __init__(self, since: str, RelatedTo: "yya_Thing" = None, relations: "yya_Thing" = None, yya_RelatedTo: "yya_Thing" = None):
        self.since = since
...
class yya_Thing(NamedElement):
    ...
    def __init__(self, id: int, fromThing: set["yya_RelatedTo"] = None, Thing: "yya_RelatedTo" = None, yya_Thing: "yya_RelatedTo" = None):
        self.id = id
