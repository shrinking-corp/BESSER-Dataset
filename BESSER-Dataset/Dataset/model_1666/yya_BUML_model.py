...
# Classes
yya_Thing = Class(name="yya_Thing")
NamedElement = Class(name="NamedElement")
yya_RelatedTo = Class(name="yya_RelatedTo")
yya_NamedElement = Class(name="yya_NamedElement", is_abstract=True)
yya_Alias = Class(name="yya_Alias")
...
domain_model = DomainModel(
    ...
    associations={relations0, aliases1, fromThing2, toThing3},
