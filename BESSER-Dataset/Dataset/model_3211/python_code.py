...
class game_Function:
    ...
    def __init__(self, name: str, game_Function10: "game_Type" = None, game_Function13: set["game_Statement"] = None, game_Function: "game_Game" = None):
        self.name = name
...
class game_ComponentData:
    ...
    def __init__(self, name: str, game_ComponentData15: "game_Type" = None, game_ComponentData: "game_Game" = None):
        self.name = name
...
class game_System:
    ...
    def __init__(self, name: str, game_System18: set["game_Statement"] = None, game_System21: set["game_Query"] = None, game_System: "game_Game" = None):
        self.name = name
...
class game_Type:
    ...
    def __init__(self, namespace: str, name: str, valueType: bool, game_Type11: "game_Function" = None, game_Type16: "game_ComponentData" = None, game_Type51: "game_Expression" = None, game_Type109: "game_Type" = None, game_Type107: set["game_Type"] = None, game_Type: "game_Game" = None):
...
class game_Game:
    ...
    def __init__(self, name: str, version: str, game_Game2: set["game_System"] = None, game_Game4: set["game_ComponentData"] = None, game_Game6: "game_End" = None, game_Game8: set["game_Function"] = None, game_Game: set["game_Type"] = None):
        self.name = name
