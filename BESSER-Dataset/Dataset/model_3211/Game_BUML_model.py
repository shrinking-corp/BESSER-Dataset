...
# Classes
game_Statement = Class(name="game_Statement", is_abstract=True)
game_Query = Class(name="game_Query")
game_Access = Class(name="game_Access")
game_Selection = Class(name="game_Selection")
game_Game = Class(name="game_Game")
game_Type = Class(name="game_Type")
game_System = Class(name="game_System")
game_ComponentData = Class(name="game_ComponentData")
game_End = Class(name="game_End")
game_Function = Class(name="game_Function")
game_Orable = Class(name="game_Orable", is_abstract=True)
Expression = Class(name="Expression")
game_Andable = Class(name="game_Andable", is_abstract=True)
Orable = Class(name="Orable")
game_Equatable = Class(name="game_Equatable", is_abstract=True)
Andable = Class(name="Andable")
game_Comparable = Class(name="game_Comparable", is_abstract=True)
Equatable = Class(name="Equatable")
game_Addable = Class(name="game_Addable", is_abstract=True)
Comparable = Class(name="Comparable")
game_Multipliable = Class(name="game_Multipliable", is_abstract=True)
Addable = Class(name="Addable")
game_Setable = Class(name="game_Setable", is_abstract=True)
Multipliable = Class(name="Multipliable")
game_Or = Class(name="game_Or")
game_And = Class(name="game_And")
Statement = Class(name="Statement")
game_Expression = Class(name="game_Expression", is_abstract=True)
game_Iteration = Class(name="game_Iteration")
game_Forall = Class(name="game_Forall")
game_Variable = Class(name="game_Variable")
game_Assignment = Class(name="game_Assignment")
game_Subprocess = Class(name="game_Subprocess")
game_Call = Class(name="game_Call")
game_Primary = Class(name="game_Primary", is_abstract=True)
Primary = Class(name="Primary")
game_LogicalNot = Class(name="game_LogicalNot")
game_Cardinal = Class(name="game_Cardinal")
game_Collection = Class(name="game_Collection", is_abstract=True)
game_Brackets = Class(name="game_Brackets")
Collection = Class(name="Collection")
game_Join = Class(name="game_Join")
game_Equality = Class(name="game_Equality")
game_Comparison = Class(name="game_Comparison")
game_Addition = Class(name="game_Addition")
game_Multiplication = Class(name="game_Multiplication")
game_SetExpression = Class(name="game_SetExpression")
Setable = Class(name="Setable")
game_ImplicitSet = Class(name="game_ImplicitSet")
game_Atom = Class(name="game_Atom", is_abstract=True)
Index = Class(name="Index")
game_Index = Class(name="game_Index")
Atom = Class(name="Atom")
game_Cell = Class(name="game_Cell")
...
game_Game.attributes={game_Game_version, game_Game_name}
...
game_Type.attributes={game_Type_valueType, game_Type_namespace, game_Type_name}
...
domain_model = DomainModel(
    name="game",
    types={game_Statement, game_Query, game_Access, game_Selection, game_Game, game_Type, game_System, game_ComponentData, game_End, game_Function, game_Orable, Expression, game_Andable, Orable, game_Equatable, Andable, game_Comparable, Equatable, game_Addable, Comparable, game_Multipliable, Addable, game_Setable, Multipliable, game_Or, game_And, Statement, game_Expression, game_Iteration, game_Forall, game_Variable, game_Assignment, game_Subprocess, game_Call, game_Primary, Primary, game_LogicalNot, game_Cardinal, game_Collection, game_Brackets, Collection, game_Join, game_Equality, game_Comparison, game_Addition, game_Multiplication, game_SetExpression, Setable, game_ImplicitSet, game_Atom, Index, game_Index, Atom, game_Cell, EqualityKind, AccessKind, ComparisonKind, AdditiveKind, MultiplicativeKind},
    associations={type9, statements12, type14, statements17, queries20, accesses22, types0, systems1, components3, end5, functions7, type49, left52, right53, left55, condition24, positiveStatements25, negativeStatements28, condition31, statements33, condition36, statements38, variable41, atom43, expression45, call48, left75, right77, arguments79, expression82, expression84, expression86, entries88, right57, left59, right61, left63, right65, left67, right69, left71, right73, predicate90, variable92, index95, atom97, expression99, entity102, component104, parameters108},
    generalizations={gen_game_Orable_Expression, gen_game_Andable_Orable, gen_game_Equatable_Andable, gen_game_Comparable_Equatable, gen_game_Addable_Comparable, gen_game_Multipliable_Addable, gen_game_Setable_Multipliable, gen_game_Or_Orable, gen_game_And_Andable, gen_game_Selection_Statement, gen_game_Iteration_Statement, gen_game_Forall_Statement, gen_game_Assignment_Statement, gen_game_Subprocess_Statement, gen_game_SetExpression_Setable, gen_game_Primary_Setable, gen_game_Call_Primary, gen_game_LogicalNot_Primary, gen_game_Cardinal_Primary, gen_game_Collection_Primary, gen_game_Brackets_Collection, gen_game_Join_Collection, gen_game_Equality_Equatable, gen_game_Comparison_Comparable, gen_game_Addition_Addable, gen_game_Multiplication_Multipliable, gen_game_ImplicitSet_Collection, gen_game_Atom_Index, gen_game_Index_Primary, gen_game_Variable_Atom, gen_game_Cell_Atom},
    metadata=None
)
