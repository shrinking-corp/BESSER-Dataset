...
public class scxml_OnExit  {
    ...
    public scxml_OnExit(
        ArrayList<scxml_Validate> scxml_validates,        ArrayList<scxml_Log> scxml_logs,        ArrayList<scxml_If> scxml_ifs,        ArrayList<scxml_Send> scxml_sends,        ArrayList<scxml_Param> scxml_params,        ArrayList<scxml_Raise> scxml_raises,        ArrayList<scxml_Assign> scxml_assigns    ) {
