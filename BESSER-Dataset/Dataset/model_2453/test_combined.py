...
def test_hyp_scxml_finalize_is_not_abstract():
    assert not inspect.isabstract(scxml_Finalize)


def test_hyp_scxml_finalize_constructor_exists():
    assert callable(scxml_Finalize.__init__)


def test_hyp_scxml_finalize_constructor_args():
...
def test_hyp_scxml_servicetemplate_is_not_abstract():
    assert not inspect.isabstract(scxml_ServiceTemplate)


def test_hyp_scxml_servicetemplate_constructor_exists():
    assert callable(scxml_ServiceTemplate.__init__)


def test_hyp_scxml_servicetemplate_constructor_args():
...
def test_hyp_scxml_anchor_is_not_abstract():
    assert not inspect.isabstract(scxml_Anchor)


def test_hyp_scxml_anchor_constructor_exists():
    assert callable(scxml_Anchor.__init__)


def test_hyp_scxml_anchor_constructor_args():
...
def test_hyp_scxml_parallel_is_not_abstract():
    assert not inspect.isabstract(scxml_Parallel)


def test_hyp_scxml_parallel_constructor_exists():
    assert callable(scxml_Parallel.__init__)


def test_hyp_scxml_parallel_constructor_args():
...
def test_hyp_scxml_namedelement_is_not_abstract():
    assert not inspect.isabstract(scxml_NamedElement)


def test_hyp_scxml_namedelement_constructor_exists():
    assert callable(scxml_NamedElement.__init__)


def test_hyp_scxml_namedelement_constructor_args():
...
def test_hyp_scxml_elseif_cond_setter(instance):
...
def test_hyp_scxml_if_cond_setter(instance):
    original = instance.cond
    instance.cond = original
    assert instance.cond == original
...
def test_hyp_scxml_servicetemplate_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
@given(instance=scxml_ServiceTemplate_strategy)
def test_hyp_scxml_servicetemplate_version_setter(instance):
...
@given(instance=scxml_ServiceTemplate_strategy)
def test_hyp_scxml_servicetemplate_profile_setter(instance):
...
@given(instance=scxml_ServiceTemplate_strategy)
def test_hyp_scxml_servicetemplate_exmode_setter(instance):
...
@given(instance=scxml_ServiceTemplate_strategy)
def test_hyp_scxml_servicetemplate_xmlns_setter(instance):
...
def test_hyp_scxml_assign_dataid_setter(instance):
...
def test_hyp_scxml_anchor_type_setter(instance):
    original = instance.type
    instance.type = original
    assert instance.type == original
...
@given(instance=scxml_Anchor_strategy)
def test_hyp_scxml_anchor_snapshot_setter(instance):
...
def test_hyp_scxml_parallel_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
def test_hyp_scxml_historystate_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
def test_hyp_scxml_finalstate_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
def test_hyp_scxml_state_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
...
def test_hyp_scxml_transition_event_setter(instance):
    original = instance.event
    instance.event = original
    assert instance.event == original
...
@given(instance=scxml_Transition_strategy)
def test_hyp_scxml_transition_anchor_setter(instance):
...
@given(instance=scxml_Transition_strategy)
def test_hyp_scxml_transition_cond_setter(instance):
    original = instance.cond
    instance.cond = original
    assert instance.cond == original
