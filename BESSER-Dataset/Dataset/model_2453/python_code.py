...
class scxml_State(NamedElement):
    ...
    def __init__(self, id: str, scxml_State: set["scxml_OnEntry"] = None, scxml_State5: set["scxml_OnExit"] = None, scxml_State31: "scxml_ServiceTemplate" = None, scxml_State7: "scxml_InitialState" = None, scxml_State10: "scxml_State" = None, scxml_State8: set["scxml_State"] = None, scxml_State12: set["scxml_FinalState"] = None, scxml_State14: set["scxml_Parallel"] = None, scxml_State16: set["scxml_HistoryState"] = None, scxml_State18: set["scxml_Anchor"] = None, scxml_State20: set["scxml_Invoke"] = None, scxml_State111: "scxml_Parallel" = None):
        self.id = id
...
class scxml_Data:
    ...
    def __init__(self, src: str, expr: str, id: str, scxml_Data149: "scxml_Content" = None, scxml_Data: "scxml_DataModel" = None):
        self.src = src
        self.expr = expr
        self.id = id
...
class scxml_Validate:
    ...
    def __init__(self, location: str, schema: str, scxml_Validate91: "scxml_OnExit" = None, scxml_Validate: "scxml_OnEntry" = None, scxml_Validate145: "scxml_If" = None, scxml_Validate196: "scxml_Finalize" = None):
...
class scxml_Send:
    ...
    def __init__(self, event: str, eventexpr: str, target: str, targetexpr: str, type: str, typeexpr: str, id: str, idlocation: str, delay: str, delayexpr: str, namelist: str, hints: str, hintsexpr: str, scxml_Send88: "scxml_OnExit" = None, scxml_Send: "scxml_OnEntry" = None, scxml_Send142: "scxml_If" = None, scxml_Send151: set["scxml_Param"] = None, scxml_Send154: "scxml_Content" = None, scxml_Send193: "scxml_Finalize" = None):
        self.event = event
...
class scxml_Raise:
    ...
    def __init__(self, event: str, scxml_Raise85: "scxml_OnExit" = None, scxml_Raise: "scxml_OnEntry" = None, scxml_Raise139: "scxml_If" = None, scxml_Raise190: "scxml_Finalize" = None):
        self.event = event
...
class scxml_Param:
    ...
    def __init__(self, name: str, expr: str, scxml_Param82: "scxml_OnExit" = None, scxml_Param: "scxml_OnEntry" = None, scxml_Param136: "scxml_If" = None, scxml_Param152: "scxml_Send" = None, scxml_Param164: "scxml_Donedata" = None, scxml_Param187: "scxml_Finalize" = None, scxml_Param170: "scxml_Invoke" = None):
        self.name = name
        self.expr = expr
...
class scxml_ServiceTemplate:
    ...
    def __init__(self, name: str, xmlns: str, version: str, profile: str, exmode: str, scxml_ServiceTemplate30: set["scxml_State"] = None, scxml_ServiceTemplate33: "scxml_InitialState" = None, scxml_ServiceTemplate36: set["scxml_FinalState"] = None, scxml_ServiceTemplate39: set["scxml_Parallel"] = None, scxml_ServiceTemplate42: set["scxml_DataModel"] = None, scxml_ServiceTemplate45: "scxml_Script" = None, scxml_ServiceTemplate: set["scxml_Transition"] = None):
        self.name = name
        self.xmlns = xmlns
...
class scxml_FinalState(NamedElement):
    ...
    def __init__(self, id: str, scxml_FinalState37: "scxml_ServiceTemplate" = None, scxml_FinalState: "scxml_State" = None, scxml_FinalState93: set["scxml_OnEntry"] = None, scxml_FinalState96: set["scxml_OnExit"] = None, scxml_FinalState99: "scxml_Donedata" = None):
        self.id = id
