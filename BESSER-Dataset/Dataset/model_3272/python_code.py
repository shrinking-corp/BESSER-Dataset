...
class sm_Transition:
    ...
    def __init__(self, name: str, sm_Transition14: "sm_State" = None, sm_Transition17: "sm_State" = None, sm_Transition: "sm_StateMachine" = None):
        self.name = name
...
class sm_State:
    ...
    def __init__(self, name: str, sm_State15: "sm_Transition" = None, sm_State18: "sm_Transition" = None, sm_State: "sm_StateMachine" = None, sm_State4: "sm_StateMachine" = None, sm_State7: "sm_StateMachine" = None, sm_State11: set["sm_StateMachine"] = None):
        self.name = name
...
class sm_StateMachine:
    ...
    def __init__(self, name: str, sm_StateMachine: "sm_State" = None, sm_StateMachine3: set["sm_State"] = None, sm_StateMachine6: set["sm_State"] = None, sm_StateMachine9: set["sm_Transition"] = None, sm_StateMachine12: "sm_State" = None):
        self.name = name
