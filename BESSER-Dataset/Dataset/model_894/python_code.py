...
class simplepdl_WorkSequence(ProcessElement):
    ...
    def __init__(self, linkType: str, linksToSuccessors: "simplepdl_WorkDefinition" = None, WorkSequence: "simplepdl_WorkDefinition" = None, WorkSequence6: "simplepdl_WorkDefinition" = None, linksToPredecessors: "simplepdl_WorkDefinition" = None):
...
class simplepdl_WorkDefinition(ProcessElement):
    ...
    def __init__(self, name: str, WorkDefinition: "simplepdl_WorkSequence" = None, successor: set["simplepdl_WorkSequence"] = None, predecessor: set["simplepdl_WorkSequence"] = None, WorkDefinition9: "simplepdl_WorkSequence" = None):
        self.name = name
