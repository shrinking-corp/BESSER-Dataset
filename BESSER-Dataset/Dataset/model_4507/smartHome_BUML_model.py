...
# Classes
smartHome_Condition = Class(name="smartHome_Condition", is_abstract=True)
smartHome_Event = Class(name="smartHome_Event")
smartHome_Duration = Class(name="smartHome_Duration")
smartHome_Sensor = Class(name="smartHome_Sensor", is_abstract=True)
smartHome_SensorType = Class(name="smartHome_SensorType")
smartHome_IntegerSensor = Class(name="smartHome_IntegerSensor")
Sensor = Class(name="Sensor")
smartHome_BooleanSensor = Class(name="smartHome_BooleanSensor")
smartHome_Location = Class(name="smartHome_Location")
smartHome_AnalogSensorType = Class(name="smartHome_AnalogSensorType")
SensorType = Class(name="SensorType")
smartHome_BooleanSensorType = Class(name="smartHome_BooleanSensorType")
smartHome_SmartHome = Class(name="smartHome_SmartHome")
smartHome_Rule = Class(name="smartHome_Rule")
smartHome_BooleanCondition = Class(name="smartHome_BooleanCondition")
Condition = Class(name="Condition")
smartHome_IntegerCondition = Class(name="smartHome_IntegerCondition")
...
smartHome_IntegerCondition.attributes={smartHome_IntegerCondition_operator, smartHome_IntegerCondition_operand}
...
domain_model = DomainModel(
    name="smartHome",
    types={smartHome_Condition, smartHome_Event, smartHome_Duration, smartHome_Sensor, smartHome_SensorType, smartHome_IntegerSensor, Sensor, smartHome_BooleanSensor, smartHome_Location, smartHome_AnalogSensorType, SensorType, smartHome_BooleanSensorType, smartHome_SmartHome, smartHome_Rule, smartHome_BooleanCondition, Condition, smartHome_IntegerCondition, IntegerOperator, BooleanOperator, DurationUnit},
    associations={conditions10, event12, sensorType0, sensors1, locations3, sensorTypes5, rules8, duration14, sensor16, sensor17},
