...
metamodel_Query = Class(name="metamodel_Query")
metamodel_parameter = Class(name="metamodel_parameter")
...
metamodel_Feature.attributes={metamodel_Feature_name, metamodel_Feature_mappedBy, metamodel_Feature_annotation}
