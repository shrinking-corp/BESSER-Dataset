...
def test_hyp_helloworld123_alias_is_not_abstract():
    assert not inspect.isabstract(helloworld123_Alias)


def test_hyp_helloworld123_alias_constructor_exists():
    assert callable(helloworld123_Alias.__init__)


def test_hyp_helloworld123_alias_constructor_args():
...
def test_hyp_helloworld123_world_is_not_abstract():
    assert not inspect.isabstract(helloworld123_World)


def test_hyp_helloworld123_world_constructor_exists():
    assert callable(helloworld123_World.__init__)


def test_hyp_helloworld123_world_constructor_args():
    sig = inspect.signature(helloworld123_World.__init__)
    params = list(sig.parameters.keys())



def test_hyp_helloworld123_namedelement_is_not_abstract():
    assert not inspect.isabstract(helloworld123_NamedElement)


def test_hyp_helloworld123_namedelement_constructor_exists():
    assert callable(helloworld123_NamedElement.__init__)


def test_hyp_helloworld123_namedelement_constructor_args():
...
def test_hyp_helloworld123_relatedto_is_not_abstract():
    assert not inspect.isabstract(helloworld123_RelatedTo)


def test_hyp_helloworld123_relatedto_constructor_exists():
    assert callable(helloworld123_RelatedTo.__init__)


def test_hyp_helloworld123_relatedto_constructor_args():
...
def test_hyp_helloworld123_thing_is_not_abstract():
    assert not inspect.isabstract(helloworld123_Thing)


def test_hyp_helloworld123_thing_constructor_exists():
    assert callable(helloworld123_Thing.__init__)


def test_hyp_helloworld123_thing_constructor_args():
...
def test_hyp_helloworld123_alias_id_setter(instance):
...
def test_hyp_helloworld123_namedelement_name_setter(instance):
...
def test_hyp_helloworld123_relatedto_since_setter(instance):
...
def test_hyp_helloworld123_thing_id_setter(instance):
    original = instance.id
    instance.id = original
    assert instance.id == original
