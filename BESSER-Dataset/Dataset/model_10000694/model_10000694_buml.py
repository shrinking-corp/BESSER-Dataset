...
domain_model = DomainModel(
    name="_559f3728_d0c6_476c_9873_cac38bd7cd04",
    types={Card, Sound, GenericSound, Vendor1Adapter, Vendor2Adapter, Vendor1Sound, Vendor2Sound, ExtensionBoard, FastCard, CPU, Processor, AcceleratorCard, Cache, RAM, Machine, Program, Instruction, Memory_Interface, DeviceCard},
