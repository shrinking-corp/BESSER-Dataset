...
class ptnetLoLA_Node:
    ...
    def __init__(self, name: str, type: str, Node: "ptnetLoLA_Arc" = None, Node23: "ptnetLoLA_Arc" = None, ptnetLoLA_Node: "ptnetLoLA_Annotation" = None, target: set["ptnetLoLA_Arc"] = None, source: set["ptnetLoLA_Arc"] = None):
        self.name = name
        self.type = type
        self.Node = Node
        self.Node23 = Node23
...
class ptnetLoLA_Arc:
    ...
    def __init__(self, weight: int, outgoing: "ptnetLoLA_Node" = None, incoming: "ptnetLoLA_Node" = None, ptnetLoLA_Arc: "ptnetLoLA_PtNet" = None, Arc: "ptnetLoLA_Node" = None, Arc16: "ptnetLoLA_Node" = None):
        self.weight = weight
