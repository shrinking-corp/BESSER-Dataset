...
class SpecificationElement:
    ...
    pass
class sgraph_State(SpecificationElement, ReactiveElement, ScopedElement, CompositeElement, RegularState):
...
class sgraph_Statechart(SpecificationElement, ReactiveElement, ScopedElement, NamedElement, CompositeElement):
