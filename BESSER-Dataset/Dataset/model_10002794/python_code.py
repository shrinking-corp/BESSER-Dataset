...
class Admin:
    ...
    def __init__(self, name: str, mail_ID: str, student31: set["Student"] = None, faculty33: set["Faculty"] = None):
        self.name = name
...
class Faculty:
    ...
    def __init__(self, name: str, mail_ID: str, emp_ID: str, student29: set["Student"] = None, admin32: "Admin" = None):
        self.name = name
        self.mail_ID = mail_ID
        self.emp_ID = emp_ID
