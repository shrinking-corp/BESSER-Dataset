...
class KM3_Class(Classifier):
    ...
    def __init__(self, isAbstract: bool, KM3_Class1: set["KM3_Class"] = None, owner: set["KM3_StructuralFeature"] = None, Class: "KM3_StructuralFeature" = None, KM3_Class: "KM3_Class" = None):
