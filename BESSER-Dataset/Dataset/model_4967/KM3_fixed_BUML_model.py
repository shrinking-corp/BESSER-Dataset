...
KM3_StructuralFeature.attributes={KM3_StructuralFeature_isOrdered, KM3_StructuralFeature_isUnique, KM3_StructuralFeature_lower, KM3_StructuralFeature_upper}
...
domain_model = DomainModel(
    name="KM3",
    types={KM3_LocatedElement, KM3_ModelElement, LocatedElement, KM3_Classifier, ModelElement, KM3_DataType, Classifier, KM3_Enumeration, KM3_EnumLiteral, KM3_Class, KM3_StructuralFeature, KM3_Attribute, StructuralFeature, KM3_Reference, KM3_Package, KM3_Metamodel},
    associations={literals0, supertypes2, opposite7, contents8, metamodel9, contents10, structuralFeatures3, owner4, type5},
    generalizations={gen_KM3_ModelElement_LocatedElement, gen_KM3_Classifier_ModelElement, gen_KM3_DataType_Classifier, gen_KM3_Enumeration_Classifier, gen_KM3_EnumLiteral_ModelElement, gen_KM3_Class_Classifier, gen_KM3_Attribute_StructuralFeature, gen_KM3_Reference_StructuralFeature, gen_KM3_Package_ModelElement, gen_KM3_Metamodel_LocatedElement, gen_KM3_StructuralFeature_ModelElement},
    metadata=None
)
