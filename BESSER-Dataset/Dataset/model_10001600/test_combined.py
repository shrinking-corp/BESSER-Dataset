...
@given(instance=BANK_strategy)
def test_hyp_bank_attribute_setter(instance):
...
def test_BANK_Address_value_roundtrip():
    instance = BANK(Address="sample_text", Code="sample_text", attribute="sample_text")
...
def test_BANK_attribute_value_roundtrip():
    instance = BANK(Address="sample_text", Code="sample_text", attribute="sample_text")
...
def test_assoc_BANK_ATM_link_reassign_clear():
    a = BANK(Address="sample_text", Code="sample_text", attribute="sample_text")
...
BANK_strategy = st.builds(BANK, Address=safe_text, Code=safe_text, attribute=safe_text)
@given(instance=BANK_strategy)
@settings(max_examples=25)
