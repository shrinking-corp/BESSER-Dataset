...
BANK_attribute: Property = Property(name="attribute", type=StringType)
BANK.attributes={BANK_attribute, BANK_Code, BANK_Address}
...
Customer.attributes={Customer_DOB, Customer_Name, Customer_Pin, Customer_Card_num}
...
ATM__Transactions.attributes={ATM__Transactions_Type, ATM__Transactions_Amount, ATM__Transactions_Transaction_id, ATM__Transactions_Post_balance, ATM__Transactions_Date}
