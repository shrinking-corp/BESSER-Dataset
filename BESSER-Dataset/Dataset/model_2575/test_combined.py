...
def test_hyp_withcolumns_is_not_abstract():
    assert not inspect.isabstract(WithColumns)


def test_hyp_withcolumns_constructor_exists():
    assert callable(WithColumns.__init__)


def test_hyp_withcolumns_constructor_args():
...
def test_hyp_sql_withcolumns_is_not_abstract():
    assert not inspect.isabstract(sql_WithColumns)


def test_hyp_sql_withcolumns_constructor_exists():
    assert callable(sql_WithColumns.__init__)


def test_hyp_sql_withcolumns_constructor_args():
...
def test_hyp_sql_withquery_is_not_abstract():
    assert not inspect.isabstract(sql_WithQuery)


def test_hyp_sql_withquery_constructor_exists():
    assert callable(sql_WithQuery.__init__)


def test_hyp_sql_withquery_constructor_args():
...
def test_hyp_sql_withquery_w_setter(instance):
    original = instance.w
    instance.w = original
...
@given(instance=sql_WithQuery_strategy)
def test_hyp_sql_withquery_wname_setter(instance):
