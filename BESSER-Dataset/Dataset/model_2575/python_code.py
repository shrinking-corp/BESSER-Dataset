...
class sql_FromTableJoin:
    ...
    def __init__(self, join: str, sql_FromTableJoin: "sql_FromTable" = None, sql_FromTableJoin54: "sql_JoinCondition" = None, sql_FromTableJoin48: "sql_TableOrAlias" = None, sql_FromTableJoin51: "sql_OrExpr" = None):
        self.join = join
...
class sql_TableOrAlias:
    ...
    def __init__(self, alias: str, sql_TableOrAlias: "sql_FromTable" = None, sql_TableOrAlias61: "sql_TableFull" = None, sql_TableOrAlias63: "sql_SubQueryOperand" = None, sql_TableOrAlias65: "sql_FromValues" = None, sql_TableOrAlias67: "sql_PivotTable" = None, sql_TableOrAlias69: "sql_UnpivotTable" = None, sql_TableOrAlias49: "sql_FromTableJoin" = None, sql_TableOrAlias71: "sql_DbObjectName" = None):
        self.alias = alias
...
class sql_Select(SelectQuery):
    ...
    def __init__(self, select: str, sql_Select: "sql_SelectSubSet" = None, sql_Select31: "sql_FetchFirst" = None, sql_Select11: set["sql_SelectSubSet"] = None, sql_Select14: "sql_OrColumn" = None, sql_Select16: "sql_OrTable" = None, sql_Select18: "sql_OrExpr" = None, sql_Select20: "sql_OrGroupByColumn" = None, sql_Select22: "sql_OrExpr" = None, sql_Select25: "sql_OrOrderByColumn" = None, sql_Select27: "sql_Limit" = None, sql_Select29: "sql_Offset" = None):
        self.select = select
...
class sql_OperandList:
    ...
    pass
class sql_ScalarOperand(OperandList, RowValue):
...
class sql_POperand:
    ...
    def __init__(self, prm: str, sql_POperand215: "sql_Operand" = None, sql_POperand: "sql_LikeOperand" = None):
        self.prm = prm
...
class sql_OpFunctionCast:
    ...
    def __init__(self, type: str, p: str, p2: str, sql_OpFunctionCast205: "sql_Operand" = None, sql_OpFunctionCast257: "sql_Operands" = None, sql_OpFunctionCast: "sql_LikeOperand" = None):
        self.type = type
        self.p = p
        self.p2 = p2
...
class sql_FullExpression(OrExpr):
    ...
    def __init__(self, notPrm: str, isnull: str, c: str, sql_FullExpression125: "sql_FullExpression" = None, sql_FullExpression123: "sql_FullExpression" = None, sql_FullExpression127: "sql_ExprGroup" = None, sql_FullExpression130: "sql_FullExpression" = None, sql_FullExpression128: "sql_FullExpression" = None, sql_FullExpression132: "sql_XExpr" = None, sql_FullExpression134: "sql_InOper" = None, sql_FullExpression136: "sql_ExistsOper" = None, sql_FullExpression138: "sql_Operands" = None, sql_FullExpression141: "sql_Between" = None, sql_FullExpression143: "sql_Like" = None, sql_FullExpression145: "sql_Comparison" = None, sql_FullExpression: "sql_OrExpr" = None):
        self.notPrm = notPrm
        self.isnull = isnull
        self.c = c
...
class sql_OpFunction:
    ...
    def __init__(self, fname: str, star: str, sql_OpFunction: "sql_GroupByColumnFull" = None, sql_OpFunction210: "sql_Operand" = None, sql_OpFunction221: "sql_OpFunctionArg" = None, sql_OpFunction223: "sql_FunctionAnalytical" = None, sql_OpFunction163: "sql_LikeOperand" = None):
        self.fname = fname
        self.star = star
...
class sql_ExistsOper:
    ...
    def __init__(self, op: str, sql_ExistsOper: "sql_FullExpression" = None, sql_ExistsOper183: "sql_OperandListGroup" = None, sql_ExistsOper180: "sql_SubQueryOperand" = None):
        self.op = op
...
class sql_GroupByColumnFull(OrGroupByColumn):
    ...
    def __init__(self, grByInt: str, sql_GroupByColumnFull: "sql_OrGroupByColumn" = None, sql_GroupByColumnFull117: "sql_ColumnFull" = None, sql_GroupByColumnFull120: "sql_OpFunction" = None):
...
class sql_Col(ColumnFull):
    ...
    pass
class sql_DbObjectName(UsingCols, TableFull, ColumnFull, PivotCol):

    def __init__(self, dbname: str, sql_DbObjectName: "sql_ColumnOrAlias" = None, sql_DbObjectName59: "sql_UsingCols" = None, sql_DbObjectName72: "sql_TableOrAlias" = None, sql_DbObjectName254: "sql_AnalyticExprArg" = None, sql_DbObjectName285: "sql_Col" = None, sql_DbObjectName293: "sql_pcols" = None, sql_DbObjectName295: "sql_tbls" = None):
        self.dbname = dbname
