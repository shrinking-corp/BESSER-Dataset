...
# Classes
sql_WithQuery = Class(name="sql_WithQuery")
sql_SelectQuery = Class(name="sql_SelectQuery")
sql_WithColumns = Class(name="sql_WithColumns")
sql_FetchFirst = Class(name="sql_FetchFirst")
sql_UnsignedValue = Class(name="sql_UnsignedValue")
sql_Offset = Class(name="sql_Offset")
sql_Limit = Class(name="sql_Limit")
sql_SelectSubSet = Class(name="sql_SelectSubSet")
sql_Select = Class(name="sql_Select")
SelectQuery = Class(name="SelectQuery")
sql_Model = Class(name="sql_Model")
PivotForClause = Class(name="PivotForClause")
sql_ColumnOrAlias = Class(name="sql_ColumnOrAlias")
OrColumn = Class(name="OrColumn")
sql_Operands = Class(name="sql_Operands")
sql_DbObjectName = Class(name="sql_DbObjectName")
sql_DbObjectNameAll = Class(name="sql_DbObjectNameAll")
sql_ColumnFull = Class(name="sql_ColumnFull")
sql_FromTable = Class(name="sql_FromTable")
OrTable = Class(name="OrTable")
sql_TableOrAlias = Class(name="sql_TableOrAlias")
sql_FromTableJoin = Class(name="sql_FromTableJoin")
sql_OrColumn = Class(name="sql_OrColumn")
sql_OrTable = Class(name="sql_OrTable")
sql_OrExpr = Class(name="sql_OrExpr")
sql_OrGroupByColumn = Class(name="sql_OrGroupByColumn")
sql_OrOrderByColumn = Class(name="sql_OrOrderByColumn")
sql_Values = Class(name="sql_Values")
sql_FromValuesColumns = Class(name="sql_FromValuesColumns")
sql_FromValuesColumnNames = Class(name="sql_FromValuesColumnNames")
sql_ColumnNames = Class(name="sql_ColumnNames")
FromValuesColumnNames = Class(name="FromValuesColumnNames")
sql_Rows = Class(name="sql_Rows")
sql_Row = Class(name="sql_Row")
Rows = Class(name="Rows")
sql_RowValues = Class(name="sql_RowValues")
sql_RowValue = Class(name="sql_RowValue")
RowValues = Class(name="RowValues")
sql_PivotFunctions = Class(name="sql_PivotFunctions")
sql_JoinCondition = Class(name="sql_JoinCondition")
sql_UsingCols = Class(name="sql_UsingCols")
WithColumns = Class(name="WithColumns")
sql_TableFull = Class(name="sql_TableFull")
sql_SubQueryOperand = Class(name="sql_SubQueryOperand")
sql_FromValues = Class(name="sql_FromValues")
sql_PivotTable = Class(name="sql_PivotTable")
sql_UnpivotTable = Class(name="sql_UnpivotTable")
sql_PivotColumns = Class(name="sql_PivotColumns")
sql_UnpivotInClause = Class(name="sql_UnpivotInClause")
sql_UnpivotInClauseArg = Class(name="sql_UnpivotInClauseArg")
UnpivotInClauseArgs = Class(name="UnpivotInClauseArgs")
sql_Pivots = Class(name="sql_Pivots")
PivotColumns = Class(name="PivotColumns")
sql_PivotCol = Class(name="sql_PivotCol")
...
sql_OrderByColumnFull = Class(name="sql_OrderByColumnFull")
OrOrderByColumn = Class(name="OrOrderByColumn")
sql_GroupByColumnFull = Class(name="sql_GroupByColumnFull")
sql_PivotForClause = Class(name="sql_PivotForClause")
sql_PivotInClause = Class(name="sql_PivotInClause")
sql_PivotFunction = Class(name="sql_PivotFunction")
sql_UnpivotInClauseArgs = Class(name="sql_UnpivotInClauseArgs")
sql_ExprGroup = Class(name="sql_ExprGroup")
sql_XExpr = Class(name="sql_XExpr")
sql_InOper = Class(name="sql_InOper")
sql_ExistsOper = Class(name="sql_ExistsOper")
sql_Between = Class(name="sql_Between")
sql_Like = Class(name="sql_Like")
sql_Comparison = Class(name="sql_Comparison")
sql_Prms = Class(name="sql_Prms")
OrGroupByColumn = Class(name="OrGroupByColumn")
sql_OpFunction = Class(name="sql_OpFunction")
sql_FullExpression = Class(name="sql_FullExpression")
OrExpr = Class(name="OrExpr")
sql_LikeOperand = Class(name="sql_LikeOperand")
sql_OpFunctionCast = Class(name="sql_OpFunctionCast")
sql_POperand = Class(name="sql_POperand")
sql_OperandListGroup = Class(name="sql_OperandListGroup")
sql_JRParameter = Class(name="sql_JRParameter")
Prms = Class(name="Prms")
sql_ColumnOperand = Class(name="sql_ColumnOperand")
sql_FunctionExtract = Class(name="sql_FunctionExtract")
sql_SQLCaseOperand = Class(name="sql_SQLCaseOperand")
sql_ExpOperand = Class(name="sql_ExpOperand")
sql_ScalarOperand = Class(name="sql_ScalarOperand")
sql_OperandList = Class(name="sql_OperandList")
OpFunctionArgAgregate = Class(name="OpFunctionArgAgregate")
sql_Operand = Class(name="sql_Operand")
sql_WindowingClause = Class(name="sql_WindowingClause")
sql_WindowingClauseBetween = Class(name="sql_WindowingClauseBetween")
WindowingClause = Class(name="WindowingClause")
sql_WindowingClauseOperandPreceding = Class(name="sql_WindowingClauseOperandPreceding")
sql_WindowingClauseOperandFollowing = Class(name="sql_WindowingClauseOperandFollowing")
sql_AnalyticExprArg = Class(name="sql_AnalyticExprArg")
sql_OrderByClauseArgs = Class(name="sql_OrderByClauseArgs")
sql_OrderByClauseArg = Class(name="sql_OrderByClauseArg")
OrderByClauseArgs = Class(name="OrderByClauseArgs")
sql_AnalyticExprArgs = Class(name="sql_AnalyticExprArgs")
QueryPartitionClause = Class(name="QueryPartitionClause")
AnalyticExprArgs = Class(name="AnalyticExprArgs")
sql_OpFunctionArg = Class(name="sql_OpFunctionArg")
sql_FunctionAnalytical = Class(name="sql_FunctionAnalytical")
sql_AnalyticClause = Class(name="sql_AnalyticClause")
sql_QueryPartitionClause = Class(name="sql_QueryPartitionClause")
sql_OrderByClause = Class(name="sql_OrderByClause")
RowValue = Class(name="RowValue")
OperandList = Class(name="OperandList")
sql_SQLCaseWhens = Class(name="sql_SQLCaseWhens")
sql_SqlCaseWhen = Class(name="sql_SqlCaseWhen")
SQLCaseWhens = Class(name="SQLCaseWhens")
sql_OpFunctionArgOperand = Class(name="sql_OpFunctionArgOperand")
OpFunctionArg = Class(name="OpFunctionArg")
sql_OpFunctionArgAgregate = Class(name="sql_OpFunctionArgAgregate")
sql_IntegerValue = Class(name="sql_IntegerValue")
sql_Col = Class(name="sql_Col")
sql_abc = Class(name="sql_abc")
sql_UnipivotInClause = Class(name="sql_UnipivotInClause")
UnpivotInClause = Class(name="UnpivotInClause")
sql_uicargs = Class(name="sql_uicargs")
sql_Plus = Class(name="sql_Plus")
Operands = Class(name="Operands")
sql_Minus = Class(name="sql_Minus")
sql_Concat = Class(name="sql_Concat")
sql_Multiply = Class(name="sql_Multiply")
sql_Division = Class(name="sql_Division")
sql_OBCArgs = Class(name="sql_OBCArgs")
sql_pvcs = Class(name="sql_pvcs")
sql_pcols = Class(name="sql_pcols")
sql_tbls = Class(name="sql_tbls")
sql_OpList = Class(name="sql_OpList")
sql_OpFList = Class(name="sql_OpFList")
sql_WhenList = Class(name="sql_WhenList")
sql_AExpArgs = Class(name="sql_AExpArgs")
...
sql_FullExpression.attributes={sql_FullExpression_c, sql_FullExpression_isnull, sql_FullExpression_notPrm}
...
sql_ScalarOperand.attributes={sql_ScalarOperand_sodate, sql_ScalarOperand_soint, sql_ScalarOperand_soUInt, sql_ScalarOperand_sodbl, sql_ScalarOperand_sotime, sql_ScalarOperand_sostr, sql_ScalarOperand_sodt}
...
in_133: BinaryAssociation = BinaryAssociation(
    name="in_133",
    ends={
...
domain_model = DomainModel(
    name="sql",
    types={sql_WithQuery, sql_SelectQuery, sql_WithColumns, sql_FetchFirst, sql_UnsignedValue, sql_Offset, sql_Limit, sql_SelectSubSet, sql_Select, SelectQuery, sql_Model, PivotForClause, sql_ColumnOrAlias, OrColumn, sql_Operands, sql_DbObjectName, sql_DbObjectNameAll, sql_ColumnFull, sql_FromTable, OrTable, sql_TableOrAlias, sql_FromTableJoin, sql_OrColumn, sql_OrTable, sql_OrExpr, sql_OrGroupByColumn, sql_OrOrderByColumn, sql_Values, sql_FromValuesColumns, sql_FromValuesColumnNames, sql_ColumnNames, FromValuesColumnNames, sql_Rows, sql_Row, Rows, sql_RowValues, sql_RowValue, RowValues, sql_PivotFunctions, sql_JoinCondition, sql_UsingCols, WithColumns, sql_TableFull, sql_SubQueryOperand, sql_FromValues, sql_PivotTable, sql_UnpivotTable, sql_PivotColumns, sql_UnpivotInClause, sql_UnpivotInClauseArg, UnpivotInClauseArgs, sql_Pivots, PivotColumns, sql_PivotCol, PivotFunction, Pivots, ColumnFull, UsingCols, PivotCol, TableFull, sql_OrderByColumnFull, OrOrderByColumn, sql_GroupByColumnFull, sql_PivotForClause, sql_PivotInClause, sql_PivotFunction, sql_UnpivotInClauseArgs, sql_ExprGroup, sql_XExpr, sql_InOper, sql_ExistsOper, sql_Between, sql_Like, sql_Comparison, sql_Prms, OrGroupByColumn, sql_OpFunction, sql_FullExpression, OrExpr, sql_LikeOperand, sql_OpFunctionCast, sql_POperand, sql_OperandListGroup, sql_JRParameter, Prms, sql_ColumnOperand, sql_FunctionExtract, sql_SQLCaseOperand, sql_ExpOperand, sql_ScalarOperand, sql_OperandList, OpFunctionArgAgregate, sql_Operand, sql_WindowingClause, sql_WindowingClauseBetween, WindowingClause, sql_WindowingClauseOperandPreceding, sql_WindowingClauseOperandFollowing, sql_AnalyticExprArg, sql_OrderByClauseArgs, sql_OrderByClauseArg, OrderByClauseArgs, sql_AnalyticExprArgs, QueryPartitionClause, AnalyticExprArgs, sql_OpFunctionArg, sql_FunctionAnalytical, sql_AnalyticClause, sql_QueryPartitionClause, sql_OrderByClause, RowValue, OperandList, sql_SQLCaseWhens, sql_SqlCaseWhen, SQLCaseWhens, sql_OpFunctionArgOperand, OpFunctionArg, sql_OpFunctionArgAgregate, sql_IntegerValue, sql_Col, sql_abc, sql_UnipivotInClause, UnpivotInClause, sql_uicargs, sql_Plus, Operands, sql_Minus, sql_Concat, sql_Multiply, sql_Division, sql_OBCArgs, sql_pvcs, sql_pcols, sql_tbls, sql_OpList, sql_OpFList, sql_WhenList, sql_AExpArgs, XFunction, EXTRACT_VALUES},
    associations={wq0, query1, withCols3, query5, fetchFirst8, query9, fetchFirst30, entries33, ce35, colAlias37, dbAllCols39, entries41, table43, fjoin45, onTable47, joinExpr50, op10, cols13, tbl15, whereExpression17, groupByEntry19, havingEntry21, orderByEntry24, lim26, offset28, tblAlias70, values73, c75, fvCols77, rows79, entries81, rowValues83, entries85, pfun87, joinCond53, useCols55, entries57, tfull60, sq62, values64, pivot66, unpivot68, pcols98, pfor100, inop103, pcols105, cfuls107, entries110, colOrder112, entries114, pfor89, pin91, sq93, args96, efrag124, expgroup126, exp129, xexp131, in_133, exists135, op1137, between140, like142, comp144, expr146, col149, prm152, colGrBy116, gbFunction119, entries121, op2159, fop2161, fcast164, fparam166, op2168, op3171, subquery174, opList177, subquery179, entries154, op2156, left190, right192, column195, xop198, subq200, fcast203, fext206, func208, sqlcase211, param213, eparam216, scalar218, opList182, opGroup185, obc231, op1187, winc233, wcoP235, wcoF236, exp238, expr240, args243, col245, args247, args220, fan222, operand224, anClause227, abc229, cfull259, sel262, wop265, expr268, when271, wop273, expr275, ce249, colAlias252, op255, op256, entries284, entries286, args287, texp278, eexp281, entries296, entries289, entries291, entries292, entries294, entries300, entries302, entries304, entries298},
    generalizations={gen_sql_Select_SelectQuery, gen_sql_OrColumn_PivotForClause, gen_sql_ColumnOrAlias_OrColumn, gen_sql_ColumnFull_PivotForClause, gen_sql_FromTable_OrTable, gen_sql_ColumnNames_FromValuesColumnNames, gen_sql_Row_Rows, gen_sql_RowValue_RowValues, gen_sql_UsingCols_WithColumns, gen_sql_UnpivotInClauseArg_UnpivotInClauseArgs, gen_sql_Pivots_PivotColumns, gen_sql_PivotCol_PivotFunction, gen_sql_PivotCol_PivotColumns, gen_sql_PivotCol_Pivots, gen_sql_DbObjectName_ColumnFull, gen_sql_DbObjectName_UsingCols, gen_sql_DbObjectName_PivotCol, gen_sql_DbObjectName_TableFull, gen_sql_OrderByColumnFull_OrOrderByColumn, gen_sql_GroupByColumnFull_OrGroupByColumn, gen_sql_FullExpression_OrExpr, gen_sql_JRParameter_Prms, gen_sql_Operands_OpFunctionArgAgregate, gen_sql_WindowingClauseBetween_WindowingClause, gen_sql_WindowingClauseOperandPreceding_WindowingClause, gen_sql_OrderByClauseArg_OrderByClauseArgs, gen_sql_AnalyticExprArgs_QueryPartitionClause, gen_sql_AnalyticExprArg_AnalyticExprArgs, gen_sql_ScalarOperand_RowValue, gen_sql_ScalarOperand_OperandList, gen_sql_SqlCaseWhen_SQLCaseWhens, gen_sql_OpFunctionArgOperand_OpFunctionArg, gen_sql_Col_ColumnFull, gen_sql_abc_FromValuesColumnNames, gen_sql_UnipivotInClause_UnpivotInClause, gen_sql_uicargs_UnpivotInClauseArgs, gen_sql_OpList_OperandList, gen_sql_Plus_Operands, gen_sql_Minus_Operands, gen_sql_Concat_Operands, gen_sql_Multiply_Operands, gen_sql_Division_Operands, gen_sql_OBCArgs_OrderByClauseArgs, gen_sql_pvcs_Pivots, gen_sql_pcols_PivotCol, gen_sql_tbls_TableFull, gen_sql_OpFList_OpFunctionArg, gen_sql_WhenList_SQLCaseWhens, gen_sql_AExpArgs_AnalyticExprArgs},
    metadata=None
)
