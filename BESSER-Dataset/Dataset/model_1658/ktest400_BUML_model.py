...
# Classes
ktest400_World = Class(name="ktest400_World")
ktest400_Thing = Class(name="ktest400_Thing")
ktest400_Article = Class(name="ktest400_Article")
NamedElement = Class(name="NamedElement")
ktest400_RelatedTo = Class(name="ktest400_RelatedTo")
ktest400_Line = Class(name="ktest400_Line")
ktest400_NamedElement = Class(name="ktest400_NamedElement", is_abstract=True)
...
domain_model = DomainModel(
    ...
    associations={things0, e1s1, relations3, e0s4, src9, trg12, fromThing6, toThing7},
    generalizations={gen_ktest400_Thing_NamedElement, gen_ktest400_RelatedTo_NamedElement, gen_ktest400_Line_NamedElement, gen_ktest400_Article_NamedElement},
    metadata=None
)
