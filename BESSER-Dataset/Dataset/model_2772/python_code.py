...
class javascriptSupportTest_C2:
    ...
    def getSuffixedName(self, javascriptSupportTest_suffix):
        # TODO: Implement getSuffixedName method
        pass

class javascriptSupportTest_C1:

    def __init__(self, name: str, string1: str, int1: int, c1: set["javascriptSupportTest_C2"] = None, C1: "javascriptSupportTest_C2" = None):
        self.name = name
        self.string1 = string1
        self.int1 = int1
    ...
    def getPrefixedName(self, javascriptSupportTest_prefix):
        # TODO: Implement getPrefixedName method
        pass

    def createC2(self, javascriptSupportTest_name):
