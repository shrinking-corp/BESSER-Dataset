...
# Classes
javascriptSupportTest_C1 = Class(name="javascriptSupportTest_C1")
javascriptSupportTest_C2 = Class(name="javascriptSupportTest_C2")
javascriptSupportTest_C3 = Class(name="javascriptSupportTest_C3")
C2 = Class(name="C2")
...
javascriptSupportTest_C1_m_getPrefixedName: Method = Method(name="getPrefixedName", parameters={Parameter(name='javascriptSupportTest_prefix', type=StringType)})
javascriptSupportTest_C1_m_createC2: Method = Method(name="createC2", parameters={Parameter(name='javascriptSupportTest_name', type=StringType)})
javascriptSupportTest_C1.attributes={javascriptSupportTest_C1_name, javascriptSupportTest_C1_int1, javascriptSupportTest_C1_string1}
...
javascriptSupportTest_C2_m_getSuffixedName: Method = Method(name="getSuffixedName", parameters={Parameter(name='javascriptSupportTest_suffix', type=StringType)})
