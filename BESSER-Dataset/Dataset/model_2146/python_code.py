...
class graphdb_Edge(GraphElement):
    ...
    def __init__(self, type: str, name: str, Edge: "graphdb_Graph" = None, Edge5: "graphdb_Vertex" = None, Edge7: "graphdb_Vertex" = None, outEdges: "graphdb_Vertex" = None, inEdges: "graphdb_Vertex" = None, edges: "graphdb_Graph" = None):
        self.type = type
        self.name = name
        self.Edge = Edge
        self.Edge5 = Edge5
...
class graphdb_Vertex(GraphElement):
    ...
    def __init__(self, labels: str, name: str, Vertex: "graphdb_Graph" = None, head: set["graphdb_Edge"] = None, tail: set["graphdb_Edge"] = None, vertices: "graphdb_Graph" = None, Vertex10: "graphdb_Edge" = None, Vertex12: "graphdb_Edge" = None):
        self.labels = labels
        self.name = name
        self.Vertex = Vertex
