...
# Classes
qvtcore_cst_AreaCS = Class(name="qvtcore_cst_AreaCS", is_abstract=True)
TypeCS = Class(name="TypeCS")
qvtcore_cst_PatternCS = Class(name="qvtcore_cst_PatternCS", is_abstract=True)
IdentifiedCS = Class(name="IdentifiedCS")
GuardPatternCS = Class(name="GuardPatternCS")
BottomPatternCS = Class(name="BottomPatternCS")
qvtcore_cst_AssignmentCS = Class(name="qvtcore_cst_AssignmentCS")
OCLExpressionCS = Class(name="OCLExpressionCS")
qvtcore_cst_BottomPatternCS = Class(name="qvtcore_cst_BottomPatternCS")
...
qvtcore_cst_DirectionCS = Class(name="qvtcore_cst_DirectionCS")
PathNameCS = Class(name="PathNameCS")
IdentifierCS = Class(name="IdentifierCS")
qvtcore_cst_DomainCS = Class(name="qvtcore_cst_DomainCS")
AreaCS = Class(name="AreaCS")
qvtcore_cst_EnforcementOperationCS = Class(name="qvtcore_cst_EnforcementOperationCS")
CSTNode = Class(name="CSTNode")
OperationCallExpCS = Class(name="OperationCallExpCS")
qvtcore_cst_GuardPatternCS = Class(name="qvtcore_cst_GuardPatternCS")
qvtcore_cst_MappingCS = Class(name="qvtcore_cst_MappingCS")
MappingCS = Class(name="MappingCS")
DomainCS = Class(name="DomainCS")
qvtcore_cst_ParamDeclarationCS = Class(name="qvtcore_cst_ParamDeclarationCS")
UnrealizedVariableCS = Class(name="UnrealizedVariableCS")
qvtcore_cst_QueryCS = Class(name="qvtcore_cst_QueryCS")
cst_CSTNode = Class(name="cst_CSTNode")
cst_IHasName = Class(name="cst_IHasName")
ParamDeclarationCS = Class(name="ParamDeclarationCS")
qvtcore_cst_RealizeableVariableCS = Class(name="qvtcore_cst_RealizeableVariableCS", is_abstract=True)
qvtcore_cst_RealizedVariableCS = Class(name="qvtcore_cst_RealizedVariableCS")
RealizeableVariableCS = Class(name="RealizeableVariableCS")
qvtcore_cst_TopLevelCS = Class(name="qvtcore_cst_TopLevelCS")
TransformationCS = Class(name="TransformationCS")
QueryCS = Class(name="QueryCS")
qvtcore_cst_TransformationCS = Class(name="qvtcore_cst_TransformationCS")
DirectionCS = Class(name="DirectionCS")
qvtcore_cst_UnrealizedVariableCS = Class(name="qvtcore_cst_UnrealizedVariableCS")
...
in_17: BinaryAssociation = BinaryAssociation(
    name="in_17",
    ends={
...
domain_model = DomainModel(
    name="qvtcore",
    types={qvtcore_cst_AreaCS, TypeCS, qvtcore_cst_PatternCS, IdentifiedCS, GuardPatternCS, BottomPatternCS, qvtcore_cst_AssignmentCS, OCLExpressionCS, qvtcore_cst_BottomPatternCS, PatternCS, EnforcementOperationCS, RealizedVariableCS, qvtcore_cst_DirectionCS, PathNameCS, IdentifierCS, qvtcore_cst_DomainCS, AreaCS, qvtcore_cst_EnforcementOperationCS, CSTNode, OperationCallExpCS, qvtcore_cst_GuardPatternCS, qvtcore_cst_MappingCS, MappingCS, DomainCS, qvtcore_cst_ParamDeclarationCS, UnrealizedVariableCS, qvtcore_cst_QueryCS, cst_CSTNode, cst_IHasName, ParamDeclarationCS, qvtcore_cst_RealizeableVariableCS, qvtcore_cst_RealizedVariableCS, RealizeableVariableCS, qvtcore_cst_TopLevelCS, TransformationCS, QueryCS, qvtcore_cst_TransformationCS, DirectionCS, qvtcore_cst_UnrealizedVariableCS},
    associations={type28, guardPattern0, bottomPattern1, target3, initialiser4, enforcementOperations7, realizedVariables8, imports10, uses11, operationCall13, composedMappings14, domains15, in_17, middle20, refines23, identifier26, constraints30, unrealizedVariables32, inputParamDeclaration34, oclExpression35, pathName38, type41, type44, transformations46, queries47, mappings49, directions52, pathName53},
    generalizations={gen_qvtcore_cst_PatternCS_CSTNode, gen_qvtcore_cst_AreaCS_IdentifiedCS, gen_qvtcore_cst_AssignmentCS_OCLExpressionCS, gen_qvtcore_cst_BottomPatternCS_PatternCS, gen_qvtcore_cst_DirectionCS_IdentifiedCS, gen_qvtcore_cst_DomainCS_AreaCS, gen_qvtcore_cst_EnforcementOperationCS_CSTNode, gen_qvtcore_cst_GuardPatternCS_PatternCS, gen_qvtcore_cst_MappingCS_IdentifiedCS, gen_qvtcore_cst_ParamDeclarationCS_CSTNode, gen_qvtcore_cst_QueryCS_cst_CSTNode, gen_qvtcore_cst_QueryCS_cst_IHasName, gen_qvtcore_cst_RealizeableVariableCS_IdentifiedCS, gen_qvtcore_cst_RealizedVariableCS_RealizeableVariableCS, gen_qvtcore_cst_TopLevelCS_CSTNode, gen_qvtcore_cst_TransformationCS_cst_CSTNode, gen_qvtcore_cst_TransformationCS_cst_IHasName, gen_qvtcore_cst_UnrealizedVariableCS_RealizeableVariableCS},
    metadata=None
)
