...
l2_Create_m_client_and_supplier_are_classifiers: Method = Method(name="client_and_supplier_are_classifiers", parameters={Parameter(name='l2_context', type=StringType), Parameter(name='l2_diagnostics', type=StringType)}, type=BooleanType)
...
l2_Call_m_client_and_supplier_are_operations: Method = Method(name="client_and_supplier_are_operations", parameters={Parameter(name='l2_diagnostics', type=StringType), Parameter(name='l2_context', type=StringType)}, type=BooleanType)
...
l2_Instantiate_m_client_and_supplier_are_classifiers: Method = Method(name="client_and_supplier_are_classifiers", parameters={Parameter(name='l2_context', type=StringType), Parameter(name='l2_diagnostics', type=StringType)}, type=BooleanType)
...
domain_model = DomainModel(
    name="l2",
    types={l2_Usage, l2_Create, l2_Auxiliary, l2_Class, l2_Call, l2_File, l2_Artifact, l2_Entity, l2_BehavioralFeature, l2_Derive, l2_Abstraction, l2_ValueSpecification, l2_Destroy, l2_Document, File, l2_ImplementationClass, l2_Component, l2_Executable, l2_Focus, l2_Framework, l2_Package, l2_Implement, l2_Metaclass, l2_ModelLibrary, l2_Process, l2_Realization, l2_Instantiate, l2_Library, l2_Service, l2_Source, l2_Classifier, l2_Refine, l2_Responsibility, l2_Script, l2_Send, l2_Type, l2_Utility, l2_Specification, l2_Subsystem, l2_Trace},
    associations={base_Usage1, base_Class0, base_Artifact11, base_BehavioralFeature2, base_Usage3, base_Abstraction6, computation7, base_BehavioralFeature9, base_Component16, base_Component12, base_Class13, base_Package15, base_Class22, base_Package24, base_Component26, base_Class18, base_Usage20, base_Usage33, base_Component35, base_Classifier28, base_Abstraction29, base_Usage31, base_Class43, base_Classifier37, base_Component39, base_Abstraction41, base_Class45},
