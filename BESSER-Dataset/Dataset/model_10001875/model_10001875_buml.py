...
# boo class attributes and methods

# Relationships
Class5_C: BinaryAssociation = BinaryAssociation(
    name="Class5_C",
    ends={
        Property(name="c0", type=C, multiplicity=Multiplicity(0, 9999)),
        Property(name="class51", type=B, multiplicity=Multiplicity(0, 1))
    }
)
...
domain_model = DomainModel(
    name="_azx8YOwTEei9dNtZPq67hQ",
    types={R, Y, Z, A, B, C, C2, C3, boo},
    associations={Class5_C, A_B, R_A},
    generalizations={},
    metadata=None
)
