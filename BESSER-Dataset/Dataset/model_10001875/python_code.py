...
class C(ABC):
    ...
    def __init__(self, attC1: int, attC2: bool, class51: "B" = None):
        self.attC1 = attC1
        self.attC2 = attC2
        self.class51 = class51
    ...
    @property
    def class51(self):
        return self.__class51
    @class51.setter
    def class51(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_C__class51", None)
        self.__class51 = value
    ...
    def c0(self, value):
        ...
        if old_value is not None:
            for item in old_value:
                if hasattr(item, "class51"):
                    opp_val = getattr(item, "class51", None)
                    
                    if opp_val == self:
                        setattr(item, "class51", None)
