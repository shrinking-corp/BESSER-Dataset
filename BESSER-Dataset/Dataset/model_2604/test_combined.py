...
def test_hyp_personlist_livingplace_address_setter(instance):
...
def test_hyp_personlist_workplace_address_setter(instance):
    original = instance.address
    instance.address = original
    assert instance.address == original
...
def test_hyp_personlist_person_firstname_setter(instance):
...
@given(instance=PersonList_Person_strategy)
def test_hyp_personlist_person_lastname_setter(instance):
...
@given(instance=PersonList_Person_strategy)
def test_hyp_personlist_person_gender_setter(instance):
