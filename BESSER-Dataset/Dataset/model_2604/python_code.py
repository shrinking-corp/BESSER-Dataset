...
class PersonList_LivingPlace:
    ...
    def __init__(self, address: str, PersonList_LivingPlace: "PersonList_List" = None, LivingPlace: "PersonList_Person" = None, home: set["PersonList_Person"] = None):
...
class PersonList_Person:
    ...
    def __init__(self, firstname: str, lastname: str, gender: str, Person: "PersonList_List" = None, members: "PersonList_List" = None, persons: "PersonList_WorkPlace" = None, persons7: "PersonList_LivingPlace" = None, Person9: "PersonList_WorkPlace" = None, Person11: "PersonList_LivingPlace" = None):
