...
public class smm_Measure extends AbstractMeasureElement {
    ...
    public smm_Measure(
        String measurementLabelFormat,        String measureLabelFormat,        boolean visible    ) {
        super(
        );
    ...
    public smm_Measure(
        String measurementLabelFormat,        String measureLabelFormat,        boolean visible        ArrayList<smm_MeasureRelationship> smm_measurerelationships,        ArrayList<smm_RefinementMeasureRelationship> smm_refinementmeasurerelationships,        ArrayList<smm_MeasureCategory> smm_measurecategorys,        ArrayList<smm_EquivalentMeasureRelationship> smm_equivalentmeasurerelationships,        ArrayList<smm_EquivalentMeasureRelationship> smm_equivalentmeasurerelationships,        ArrayList<smm_RefinementMeasureRelationship> smm_refinementmeasurerelationships    ) {
        this.measurementLabelFormat = measurementLabelFormat;
        this.measureLabelFormat = measureLabelFormat;
        this.visible = visible;
