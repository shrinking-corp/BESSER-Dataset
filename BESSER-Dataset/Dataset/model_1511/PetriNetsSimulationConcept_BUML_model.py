...
# Classes
PetriNetSim_PetriNet = Class(name="PetriNetSim_PetriNet")
PetriNet = Class(name="PetriNet")
PetriNetSim_Place = Class(name="PetriNetSim_Place")
Place = Class(name="Place")
PetriNetSim_Transition = Class(name="PetriNetSim_Transition")
...
PetriNetSim_PetriNet_m_pick: Method = Method(name="pick", parameters={Parameter(name='PetriNetSim_s', type=StringType)}, type=StringType)
PetriNetSim_PetriNet_m_step: Method = Method(name="step", parameters={}, type=BooleanType)
PetriNetSim_PetriNet.methods={PetriNetSim_PetriNet_m_simulate, PetriNetSim_PetriNet_m_pick, PetriNetSim_PetriNet_m_step}

# PetriNet class attributes and methods

# PetriNetSim_Place class attributes and methods
PetriNetSim_Place_m_modify: Method = Method(name="modify", parameters={Parameter(name='PetriNetSim_t', type=StringType)}, type=BooleanType)
...
PetriNetSim_Transition_m_outWeight: Method = Method(name="outWeight", parameters={Parameter(name='PetriNetSim_p', type=StringType)}, type=IntegerType)
...
PetriNetSim_Transition_m_inWeight: Method = Method(name="inWeight", parameters={Parameter(name='PetriNetSim_p', type=StringType)}, type=IntegerType)
PetriNetSim_Transition.methods={PetriNetSim_Transition_m_fire, PetriNetSim_Transition_m_enabled, PetriNetSim_Transition_m_inWeight, PetriNetSim_Transition_m_outWeight}
