...
class sql_ScalarOperand(OperandList):
    ...
    def __init__(self, sodbl: str, sodate: date, sotime: date, sodt: date, soint: int, sostr: str, sql_ScalarOperand: "sql_Operand" = None, sql_ScalarOperand167: "sql_OpList" = None):
        self.sodbl = sodbl
        self.sodate = sodate
        self.sotime = sotime
        self.sodt = sodt
...
class sql_OpFunction:
    ...
    def __init__(self, fname: str, sql_OpFunction: "sql_LikeOperand" = None, sql_OpFunction138: "sql_OpFunctionArg" = None, sql_OpFunction128: "sql_Operand" = None):
        self.fname = fname
...
class sql_Like:
    ...
    def __init__(self, opLike: str, sql_Like91: "sql_LikeOperand" = None, sql_Like: "sql_FullExpression" = None):
        self.opLike = opLike
...
class sql_Between:
    ...
    def __init__(self, opBetween: str, sql_Between: "sql_FullExpression" = None, sql_Between100: "sql_Operands" = None, sql_Between97: "sql_Operands" = None):
...
class sql_XExpr:
    ...
    def __init__(self, xf: str, sql_XExpr81: "sql_Operands" = None, sql_XExpr84: "sql_Prms" = None, sql_XExpr: "sql_FullExpression" = None):
        self.xf = xf
...
class sql_Comparison:
    ...
    def __init__(self, operator: str, subOperator: str, sql_Comparison88: "sql_Operands" = None, sql_Comparison: "sql_FullExpression" = None):
...
class sql_FullExpression(OrExpr):
    ...
    def __init__(self, notPrm: str, c: str, isnull: str, sql_FullExpression70: "sql_InOper" = None, sql_FullExpression72: "sql_Between" = None, sql_FullExpression: "sql_OrExpr" = None, sql_FullExpression60: "sql_ExprGroup" = None, sql_FullExpression58: "sql_FullExpression" = None, sql_FullExpression56: "sql_FullExpression" = None, sql_FullExpression74: "sql_Like" = None, sql_FullExpression76: "sql_Comparison" = None, sql_FullExpression63: "sql_FullExpression" = None, sql_FullExpression61: "sql_FullExpression" = None, sql_FullExpression65: "sql_XExpr" = None, sql_FullExpression67: "sql_Operands" = None):
        self.notPrm = notPrm
        self.c = c
        self.isnull = isnull
...
class sql_Col(ColumnFull):
    ...
    pass
class sql_DbObjectName(TableFull, ColumnFull):

    def __init__(self, dbname: str, sql_DbObjectName44: "sql_TableOrAlias" = None, sql_DbObjectName: "sql_ColumnOrAlias" = None, sql_DbObjectName163: "sql_Col" = None, sql_DbObjectName165: "sql_tbls" = None):
        self.dbname = dbname
...
class sql_ColumnOrAlias(OrColumn):
    ...
    def __init__(self, alias: str, allCols: str, sql_ColumnOrAlias: "sql_OrColumn" = None, sql_ColumnOrAlias21: "sql_Operands" = None, sql_ColumnOrAlias25: "sql_DbObjectNameAll" = None, sql_ColumnOrAlias23: "sql_DbObjectName" = None):
        self.alias = alias
