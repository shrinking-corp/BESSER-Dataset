...
sql_OpFunctionCast.attributes={sql_OpFunctionCast_p, sql_OpFunctionCast_p2, sql_OpFunctionCast_type}
...
sql_ScalarOperand.attributes={sql_ScalarOperand_sotime, sql_ScalarOperand_sodate, sql_ScalarOperand_sodbl, sql_ScalarOperand_soint, sql_ScalarOperand_sostr, sql_ScalarOperand_sodt}
...
domain_model = DomainModel(
    name="sql",
    types={sql_Model, sql_SelectQuery, sql_SelectSubSet, sql_Select, SelectQuery, sql_OrColumn, sql_OrTable, sql_OrExpr, sql_OrGroupByColumn, sql_ColumnOrAlias, OrColumn, sql_Operands, sql_OrOrderByColumn, sql_ColumnFull, sql_FromTable, OrTable, sql_TableOrAlias, sql_FromTableJoin, sql_TableFull, sql_SubQueryOperand, ColumnFull, sql_DbObjectName, sql_DbObjectNameAll, sql_OrderByColumnFull, OrOrderByColumn, sql_GroupByColumnFull, TableFull, sql_FullExpression, sql_ExprGroup, OrExpr, OrGroupByColumn, sql_Comparison, sql_XExpr, sql_InOper, sql_Between, sql_Like, sql_Prms, sql_JRParameter, Prms, sql_OperandList, sql_LikeOperand, OpFunctionArgAgregate, sql_OpFunction, sql_Operand, sql_OpFunctionCast, sql_ColumnOperand, sql_POperand, sql_ExpOperand, sql_ScalarOperand, sql_OpFunctionArg, sql_SQLCaseOperand, sql_OpFunctionArgOperand, OpFunctionArg, sql_OpFunctionArgAgregate, sql_SQLCaseWhens, sql_SqlCaseWhen, SQLCaseWhens, OperandList, sql_Col, sql_Plus, Operands, sql_Minus, sql_Star, sql_Div, sql_Concat, sql_OpFList, sql_tbls, sql_OpList, sql_WhenList, XFunction},
    associations={query3, op4, cols7, tbl9, whereExpression11, groupByEntry13, havingEntry15, entries18, ce20, query0, orderByEntry1, dbAllCols24, entries26, table28, fjoin30, onTable32, joinExpr35, tfull38, sq40, tblAlias42, colAlias22, entries45, colOrder47, entries49, entries54, expgroup59, efrag57, colGrBy51, like73, comp75, exp62, xexp64, op166, in_69, between71, op287, expr77, col80, prm83, entries85, op399, subquery102, opList105, op290, fop292, op1107, fcast94, op296, right112, column115, xop118, subq120, fcast123, left110, param131, eparam133, scalar135, args137, func126, sqlcase129, op140, cfull143, op139, expr149, when152, expr154, sel146, entries162, texp156, eexp159, entries166, entries164, entries168, entries170},
    generalizations={gen_sql_Select_SelectQuery, gen_sql_ColumnOrAlias_OrColumn, gen_sql_FromTable_OrTable, gen_sql_DbObjectName_ColumnFull, gen_sql_OrderByColumnFull_OrOrderByColumn, gen_sql_DbObjectName_TableFull, gen_sql_FullExpression_OrExpr, gen_sql_GroupByColumnFull_OrGroupByColumn, gen_sql_JRParameter_Prms, gen_sql_Operands_OpFunctionArgAgregate, gen_sql_OpFunctionArgOperand_OpFunctionArg, gen_sql_SqlCaseWhen_SQLCaseWhens, gen_sql_ScalarOperand_OperandList, gen_sql_Col_ColumnFull, gen_sql_OpList_OperandList, gen_sql_Plus_Operands, gen_sql_Minus_Operands, gen_sql_Star_Operands, gen_sql_Div_Operands, gen_sql_Concat_Operands, gen_sql_OpFList_OpFunctionArg, gen_sql_tbls_TableFull, gen_sql_WhenList_SQLCaseWhens},
    metadata=None
)
