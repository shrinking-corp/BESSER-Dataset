...
model_ArchimateModelElement = Class(name="model_ArchimateModelElement", is_abstract=True)
...
model_Relationship = Class(name="model_Relationship", is_abstract=True)
...
model_InterfaceElement = Class(name="model_InterfaceElement", is_abstract=True)
model_ServiceElement = Class(name="model_ServiceElement", is_abstract=True)
...
model_BusinessLayerElement = Class(name="model_BusinessLayerElement", is_abstract=True)
model_BusinessActivity = Class(name="model_BusinessActivity")
...
model_RealisationRelationship = Class(name="model_RealisationRelationship")
model_SpecialisationRelationship = Class(name="model_SpecialisationRelationship")
model_TriggeringRelationship = Class(name="model_TriggeringRelationship")
model_UsedByRelationship = Class(name="model_UsedByRelationship")
...
model_CommunicationPath = Class(name="model_CommunicationPath")
model_Network = Class(name="model_Network")
model_InfrastructureInterface = Class(name="model_InfrastructureInterface")
model_InfrastructureService = Class(name="model_InfrastructureService")
model_Location = Class(name="model_Location")
model_ApplicationLayerElement = Class(name="model_ApplicationLayerElement", is_abstract=True)
...
model_TechnologyLayerElement = Class(name="model_TechnologyLayerElement", is_abstract=True)
model_Node = Class(name="model_Node")
model_InfrastructureFunction = Class(name="model_InfrastructureFunction")
...
model_ArchimateModel_m_getDefaultFolderForElement: Method = Method(name="getDefaultFolderForElement", parameters={Parameter(name='model_element', type=StringType)}, type=StringType)
...
model_ArchimateModel.methods={model_ArchimateModel_m_getDefaultFolderForElement, model_ArchimateModel_m_getDefaultDiagramModel, model_ArchimateModel_m_removeDerivedRelationsFolder, model_ArchimateModel_m_getDiagramModels, model_ArchimateModel_m_setDefaults, model_ArchimateModel_m_getFolder, model_ArchimateModel_m_addDerivedRelationsFolder}
...
model_DiagramModelObject_m_addConnection: Method = Method(name="addConnection", parameters={Parameter(name='model_connection', type=StringType)})
model_DiagramModelObject_m_setBounds: Method = Method(name="setBounds", parameters={Parameter(name='model_height', type=StringType), Parameter(name='model_width', type=StringType), Parameter(name='model_y', type=StringType), Parameter(name='model_x', type=StringType)})
model_DiagramModelObject_m_removeConnection: Method = Method(name="removeConnection", parameters={Parameter(name='model_connection', type=StringType)})
...
model_DiagramModelConnection.attributes={model_DiagramModelConnection_type, model_DiagramModelConnection_text}
...
model_FontAttribute.attributes={model_FontAttribute_fontColor, model_FontAttribute_font, model_FontAttribute_textAlignment, model_FontAttribute_textPosition}
...
model_DiagramModelArchimateObject_m_addArchimateElementToModel: Method = Method(name="addArchimateElementToModel", parameters={Parameter(name='model_parent', type=StringType)})
...
model_DiagramModelArchimateConnection_m_addRelationshipToModel: Method = Method(name="addRelationshipToModel", parameters={Parameter(name='model_parent', type=StringType)})
...
domain_model = DomainModel(
    name="model",
    types={model_Adapter, model_Metadata, model_Nameable, model_TextContent, model_Documentable, model_Identifier, model_Property, model_Properties, model_FolderContainer, model_Folder, model_ArchimateModel, FolderContainer, Nameable, Identifier, ArchimateModelElement, Properties, model_Cloneable, model_ArchimateModelElement, Adapter, Documentable, model_EObject, model_ArchimateElement, model_AndJunction, model_OrJunction, model_Relationship, model_AccessRelationship, Relationship, model_AggregationRelationship, Cloneable, model_JunctionElement, ArchimateElement, model_InterfaceElement, model_ServiceElement, model_Junction, JunctionElement, model_InfluenceRelationship, model_BusinessLayerElement, model_BusinessActivity, BusinessLayerElement, model_BusinessActor, model_BusinessCollaboration, model_Contract, model_BusinessEvent, model_BusinessFunction, model_AssignmentRelationship, model_AssociationRelationship, model_CompositionRelationship, model_FlowRelationship, model_RealisationRelationship, model_SpecialisationRelationship, model_TriggeringRelationship, model_UsedByRelationship, model_Meaning, model_BusinessObject, model_BusinessProcess, model_Product, model_Representation, model_BusinessRole, model_BusinessService, ServiceElement, model_Value, model_BusinessInteraction, model_BusinessInterface, InterfaceElement, model_Artifact, TechnologyLayerElement, model_CommunicationPath, model_Network, model_InfrastructureInterface, model_InfrastructureService, model_Location, model_ApplicationLayerElement, model_ApplicationCollaboration, ApplicationLayerElement, model_ApplicationComponent, model_ApplicationFunction, model_ApplicationInteraction, model_ApplicationInterface, model_DataObject, model_ApplicationService, model_TechnologyLayerElement, model_Node, model_InfrastructureFunction, model_Device, model_MotivationElement, model_SystemSoftware, model_Goal, model_Requirement, model_Constraint, model_Principle, model_ImplementationMigrationElement, model_Stakeholder, MotivationElement, model_Driver, model_Assessment, model_Plateau, model_Gap, model_DiagramModelComponent, model_WorkPackage, ImplementationMigrationElement, model_Deliverable, model_DiagramModelContainer, DiagramModelComponent, model_DiagramModel, FontAttribute, LineObject, model_DiagramModelObject, DiagramModelContainer, model_DiagramModelReference, DiagramModelObject, model_Bounds, model_DiagramModelConnection, model_DiagramModelImage, BorderObject, DiagramModelImageProvider, model_DiagramModelGroup, model_DiagramModelNote, TextContent, model_DiagramModelBendpoint, model_LineObject, model_FontAttribute, model_Lockable, model_ArchimateDiagramModel, model_BorderObject, model_DiagramModelImageProvider, DiagramModel, model_DiagramModelArchimateObject, model_SketchModel, model_SketchModelSticky, model_SketchModelActor, model_DiagramModelArchimateConnection, DiagramModelConnection, FolderType},
    associations={entries1, properties0, folders3, metadata4, archimateModel6, elements8, source10, target11, diagramModel14, children15, referencedModel16, bounds18, sourceConnections20, targetConnections22, bendpoints31, source25, target28, archimateElement33, relationship35},
    generalizations={gen_model_ArchimateModel_FolderContainer, gen_model_ArchimateModel_Nameable, gen_model_ArchimateModel_Identifier, gen_model_ArchimateModel_ArchimateModelElement, gen_model_ArchimateModel_Properties, gen_model_ArchimateModelElement_Adapter, gen_model_Folder_ArchimateModelElement, gen_model_Folder_FolderContainer, gen_model_Folder_Nameable, gen_model_Folder_Identifier, gen_model_Folder_Documentable, gen_model_Folder_Properties, gen_model_ArchimateElement_ArchimateModelElement, gen_model_ArchimateElement_Identifier, gen_model_AndJunction_JunctionElement, gen_model_OrJunction_JunctionElement, gen_model_Relationship_ArchimateElement, gen_model_AccessRelationship_Relationship, gen_model_AggregationRelationship_Relationship, gen_model_ArchimateElement_Cloneable, gen_model_ArchimateElement_Nameable, gen_model_ArchimateElement_Documentable, gen_model_ArchimateElement_Properties, gen_model_JunctionElement_ArchimateElement, gen_model_InterfaceElement_ArchimateElement, gen_model_ServiceElement_ArchimateElement, gen_model_Junction_JunctionElement, gen_model_InfluenceRelationship_Relationship, gen_model_BusinessLayerElement_ArchimateElement, gen_model_BusinessActivity_BusinessLayerElement, gen_model_BusinessActor_BusinessLayerElement, gen_model_BusinessCollaboration_BusinessLayerElement, gen_model_Contract_BusinessLayerElement, gen_model_BusinessEvent_BusinessLayerElement, gen_model_BusinessFunction_BusinessLayerElement, gen_model_AssignmentRelationship_Relationship, gen_model_AssociationRelationship_Relationship, gen_model_CompositionRelationship_Relationship, gen_model_FlowRelationship_Relationship, gen_model_RealisationRelationship_Relationship, gen_model_SpecialisationRelationship_Relationship, gen_model_TriggeringRelationship_Relationship, gen_model_UsedByRelationship_Relationship, gen_model_Meaning_BusinessLayerElement, gen_model_BusinessObject_BusinessLayerElement, gen_model_BusinessProcess_BusinessLayerElement, gen_model_Product_BusinessLayerElement, gen_model_Representation_BusinessLayerElement, gen_model_BusinessRole_BusinessLayerElement, gen_model_BusinessService_BusinessLayerElement, gen_model_BusinessService_ServiceElement, gen_model_Value_BusinessLayerElement, gen_model_BusinessInteraction_BusinessLayerElement, gen_model_BusinessInterface_BusinessLayerElement, gen_model_BusinessInterface_InterfaceElement, gen_model_Artifact_TechnologyLayerElement, gen_model_CommunicationPath_TechnologyLayerElement, gen_model_Network_TechnologyLayerElement, gen_model_InfrastructureInterface_TechnologyLayerElement, gen_model_InfrastructureInterface_InterfaceElement, gen_model_InfrastructureService_TechnologyLayerElement, gen_model_Location_BusinessLayerElement, gen_model_ApplicationLayerElement_ArchimateElement, gen_model_ApplicationCollaboration_ApplicationLayerElement, gen_model_ApplicationComponent_ApplicationLayerElement, gen_model_ApplicationFunction_ApplicationLayerElement, gen_model_ApplicationInteraction_ApplicationLayerElement, gen_model_ApplicationInterface_ApplicationLayerElement, gen_model_ApplicationInterface_InterfaceElement, gen_model_DataObject_ApplicationLayerElement, gen_model_ApplicationService_ApplicationLayerElement, gen_model_ApplicationService_ServiceElement, gen_model_TechnologyLayerElement_ArchimateElement, gen_model_InfrastructureService_ServiceElement, gen_model_InfrastructureFunction_TechnologyLayerElement, gen_model_Device_TechnologyLayerElement, gen_model_Node_TechnologyLayerElement, gen_model_SystemSoftware_TechnologyLayerElement, gen_model_Goal_MotivationElement, gen_model_Requirement_MotivationElement, gen_model_Constraint_MotivationElement, gen_model_Principle_MotivationElement, gen_model_ImplementationMigrationElement_ArchimateElement, gen_model_MotivationElement_ArchimateElement, gen_model_Stakeholder_MotivationElement, gen_model_Driver_MotivationElement, gen_model_Assessment_MotivationElement, gen_model_Plateau_ImplementationMigrationElement, gen_model_Gap_ImplementationMigrationElement, gen_model_DiagramModelComponent_Identifier, gen_model_DiagramModelComponent_Cloneable, gen_model_WorkPackage_ImplementationMigrationElement, gen_model_Deliverable_ImplementationMigrationElement, gen_model_DiagramModelContainer_DiagramModelComponent, gen_model_DiagramModelComponent_Adapter, gen_model_DiagramModelComponent_Nameable, gen_model_DiagramModelObject_DiagramModelComponent, gen_model_DiagramModelObject_FontAttribute, gen_model_DiagramModelObject_LineObject, gen_model_DiagramModel_ArchimateModelElement, gen_model_DiagramModel_DiagramModelContainer, gen_model_DiagramModel_Documentable, gen_model_DiagramModel_Properties, gen_model_DiagramModelReference_DiagramModelObject, gen_model_DiagramModelImage_DiagramModelObject, gen_model_DiagramModelImage_BorderObject, gen_model_DiagramModelImage_DiagramModelImageProvider, gen_model_DiagramModelConnection_DiagramModelComponent, gen_model_DiagramModelConnection_FontAttribute, gen_model_DiagramModelConnection_Properties, gen_model_DiagramModelConnection_Documentable, gen_model_DiagramModelConnection_LineObject, gen_model_DiagramModelGroup_DiagramModelObject, gen_model_DiagramModelGroup_DiagramModelContainer, gen_model_DiagramModelGroup_Documentable, gen_model_DiagramModelGroup_Properties, gen_model_DiagramModelNote_DiagramModelObject, gen_model_DiagramModelNote_TextContent, gen_model_DiagramModelBendpoint_Cloneable, gen_model_ArchimateDiagramModel_DiagramModel, gen_model_DiagramModelArchimateObject_DiagramModelObject, gen_model_DiagramModelArchimateObject_DiagramModelContainer, gen_model_SketchModel_DiagramModel, gen_model_SketchModelSticky_DiagramModelObject, gen_model_SketchModelSticky_DiagramModelContainer, gen_model_SketchModelSticky_TextContent, gen_model_SketchModelSticky_Properties, gen_model_SketchModelActor_DiagramModelObject, gen_model_SketchModelActor_Documentable, gen_model_SketchModelActor_Properties, gen_model_DiagramModelArchimateConnection_DiagramModelConnection},
    metadata=None
)
