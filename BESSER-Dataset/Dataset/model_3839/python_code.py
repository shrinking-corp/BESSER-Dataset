...
class sql4csv_Table:
    ...
    def __init__(self, name: str, sql4csv_Table17: "sql4csv_Column" = None, sql4csv_Table: "sql4csv_Query" = None, sql4csv_Table12: "sql4csv_Query" = None):
        self.name = name
...
class sql4csv_Column:
    ...
    def __init__(self, name: str, sql4csv_Column16: "sql4csv_Table" = None, sql4csv_Column19: "sql4csv_Equality" = None, sql4csv_Column: "sql4csv_Query" = None, sql4csv_Column7: "sql4csv_Query" = None, sql4csv_Column28: "sql4csv_ColumnEquality" = None):
        self.name = name
