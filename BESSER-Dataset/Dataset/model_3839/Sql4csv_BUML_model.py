...
# Classes
sql4csv_Equality = Class(name="sql4csv_Equality")
Condition = Class(name="Condition")
sql4csv_SQL4CSV = Class(name="sql4csv_SQL4CSV")
sql4csv_Program = Class(name="sql4csv_Program")
sql4csv_EObject = Class(name="sql4csv_EObject")
sql4csv_BinaryCondition = Class(name="sql4csv_BinaryCondition")
sql4csv_Query = Class(name="sql4csv_Query")
sql4csv_Column = Class(name="sql4csv_Column")
sql4csv_Table = Class(name="sql4csv_Table")
sql4csv_Condition = Class(name="sql4csv_Condition")
sql4csv_ColumnEquality = Class(name="sql4csv_ColumnEquality")
sql4csv_ValueEquality = Class(name="sql4csv_ValueEquality")
sql4csv_AndCondition = Class(name="sql4csv_AndCondition")
BinaryCondition = Class(name="BinaryCondition")
sql4csv_OrCondition = Class(name="sql4csv_OrCondition")
...
domain_model = DomainModel(
    name="sql4csv",
    types={sql4csv_Equality, Condition, sql4csv_SQL4CSV, sql4csv_Program, sql4csv_EObject, sql4csv_BinaryCondition, sql4csv_Query, sql4csv_Column, sql4csv_Table, sql4csv_Condition, sql4csv_ColumnEquality, sql4csv_ValueEquality, sql4csv_AndCondition, BinaryCondition, sql4csv_OrCondition},
    associations={conditions13, table15, left18, program0, right20, queries1, left22, column3, columns5, table8, tables10, right24, right27},
    generalizations={gen_sql4csv_Equality_Condition, gen_sql4csv_BinaryCondition_Condition, gen_sql4csv_AndCondition_BinaryCondition, gen_sql4csv_OrCondition_BinaryCondition},
    metadata=None
)
