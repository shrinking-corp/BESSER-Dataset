...
class study_StudyPlan:
    ...
    def chooseCourse(self, study_course, study_studyplan):
...
class study_Course:
    ...
    def __init__(self, name: str, code: str, credits: float, season: str, year: int, Course: "study_Department" = None, courses: "study_Department" = None, study_Course: "study_Semester" = None, study_Course45: "study_courseAllocation" = None):
        self.name = name
        self.code = code
...
class study_Department:
    ...
    def __init__(self, name: str, code: str, department6: set["study_Specialisation"] = None, department8: set["study_Semester"] = None, department: set["study_Course"] = None, department2: set["study_Program"] = None, department4: set["study_Student"] = None, Department: "study_Program" = None, Department13: "study_Student" = None, Department17: "study_Course" = None, Department27: "study_Specialisation" = None, Department33: "study_Semester" = None):
        self.name = name
        self.code = code
...
class study_Semester:
    ...
    def __init__(self, season: str, year: int, Semester: "study_Department" = None, Semester24: "study_Specialisation" = None, semesters: "study_Specialisation" = None, study_Semester: set["study_Course"] = None, semesters32: "study_Department" = None, study_Semester35: "study_StudyPlan" = None):
        self.season = season
        self.year = year
