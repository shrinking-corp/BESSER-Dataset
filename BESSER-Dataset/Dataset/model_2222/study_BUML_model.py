...
study_Program = Class(name="study_Program")
study_Student = Class(name="study_Student")
study_Specialisation = Class(name="study_Specialisation")
study_StudyPlan = Class(name="study_StudyPlan")
study_courseAllocation = Class(name="study_courseAllocation")
...
study_Department.attributes={study_Department_code, study_Department_name}
...
study_Course.attributes={study_Course_name, study_Course_year, study_Course_season, study_Course_credits, study_Course_code}
...
study_StudyPlan_m_chooseCourse: Method = Method(name="chooseCourse", parameters={Parameter(name='study_studyplan', type=StringType), Parameter(name='study_course', type=StringType)})
...
domain_model = DomainModel(
    name="study",
    types={study_Semester, study_Department, study_Course, study_Program, study_Student, study_Specialisation, study_StudyPlan, study_courseAllocation, grades},
    associations={specialisations5, semesters7, courses0, programs1, students3, department9, specialisations10, department12, studyPlan14, specialisations15, department16, program18, students20, semesters23, department25, specialisation28, courses30, department31, semester34, courses36, student38, studyPlan40, course43},
    generalizations={},
    metadata=None
)
