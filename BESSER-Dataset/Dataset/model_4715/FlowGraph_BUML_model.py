...
domain_model = DomainModel(
    name="flowgraph",
    types={flowgraph_Var, flowgraph_Stmt, Item, flowgraph_SimpleStmt, Stmt, FlowInstr, flowgraph_Block, flowgraph_If, Conditional, flowgraph_Expr, flowgraph_Item, flowgraph_Return, flowgraph_Method, Block, flowgraph_Exit, flowgraph_Loop, flowgraph_Conditional, flowgraph_JumpStmt, flowgraph_Label, flowgraph_Break, JumpStmt, flowgraph_Continue, flowgraph_FlowInstr, flowgraph_Param, Var},
    associations={vars7, stmts0, then1, else_3, exit6, users25, body8, expr10, label11, cfNext13, cfPrev15, def_17, use19, dfNext22, definers23, method27, stmt28, jumps30},
    generalizations={gen_flowgraph_Exit_FlowInstr, gen_flowgraph_Stmt_Item, gen_flowgraph_SimpleStmt_Stmt, gen_flowgraph_SimpleStmt_FlowInstr, gen_flowgraph_Block_Stmt, gen_flowgraph_If_Conditional, gen_flowgraph_Expr_FlowInstr, gen_flowgraph_Return_Stmt, gen_flowgraph_Return_FlowInstr, gen_flowgraph_Method_Block, gen_flowgraph_Method_FlowInstr, gen_flowgraph_Loop_Conditional, gen_flowgraph_Conditional_Stmt, gen_flowgraph_JumpStmt_Stmt, gen_flowgraph_JumpStmt_FlowInstr, gen_flowgraph_Break_JumpStmt, gen_flowgraph_Continue_JumpStmt, gen_flowgraph_FlowInstr_Item, gen_flowgraph_Var_Item, gen_flowgraph_Param_Var, gen_flowgraph_Label_Stmt},
    metadata=None
)
