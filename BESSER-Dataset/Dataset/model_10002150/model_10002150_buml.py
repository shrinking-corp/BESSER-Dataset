...
Order_Status.attributes={Order_Status_Deliveried, Order_Status_Paid, Order_Status_Create}
...
Customer.attributes={Customer_Contact, Customer_Name, Customer_Address}
