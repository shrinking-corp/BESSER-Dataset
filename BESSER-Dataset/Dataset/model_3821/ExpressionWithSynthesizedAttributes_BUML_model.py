...
expression_IntegerExpression = Class(name="expression_IntegerExpression")
expression_UnaryExpression = Class(name="expression_UnaryExpression")
expression_ExpressionStatement = Class(name="expression_ExpressionStatement")
...
domain_model = DomainModel(
    name="expression",
    types={expression_BinaryExpression, Expression, expression_Expression, expression_IntegerExpression, expression_UnaryExpression, expression_ExpressionStatement},
