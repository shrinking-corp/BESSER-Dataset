...
Doctor.attributes={Doctor_department, Doctor_name, Doctor_specialization, Doctor_docid, Doctor_phno, Doctor_address}
...
Department.attributes={Department_id, Department_doctorid, Department_name}
...
Patient.attributes={Patient_telno, Patient_sex, Patient_address, Patient_name, Patient_age, Patient_id, Patient_roomno}
...
Person.attributes={Person_name, Person_id, Person_type}
...
Bill.attributes={Bill_billno, Bill_patientname, Bill_amount}
...
domain_model = DomainModel(
    name="_97a10b0d_a472_4f10_8308_1169350bd9b3",
    types={Doctor, Department, Patient, Room, Receptionist, Person, Bill, Staff, Nurse},
    associations={receptions, manages, Doctor_Patient, Doctor_Department, Patient_Room, Room_Staff, Patient_Bill},
    generalizations={},
    metadata=None
)
