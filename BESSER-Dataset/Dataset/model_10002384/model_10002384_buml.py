...
parent_view_subject_wise_attendance: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="view_subject_wise_attendance22", type=view_subject_wise_attendance_external, multiplicity=Multiplicity(0, 1)),
        Property(name="parent23", type=parent_Actor, multiplicity=Multiplicity(0, 1))
    }
)
...
parent_logout: BinaryAssociation = BinaryAssociation(
    name="parent_logout",
    ends={
        Property(name="logout34", type=logout_external, multiplicity=Multiplicity(0, 1)),
...
admin_modify_list_of_students: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="modify_list_of_students36", type=modify_list_of_students_external, multiplicity=Multiplicity(0, 1)),
...
FACULTY_STUDENT: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="sTUDENT38", type=STUDENT, multiplicity=Multiplicity(1, 9999)),
        Property(name="fACULTY39", type=FACULTY, multiplicity=Multiplicity(1, 9999))
    }
)
...
STUDENT_ADMIN: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="sTUDENT43", type=STUDENT, multiplicity=Multiplicity(1, 9999))
    }
)
PARENT_ADMIN: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="pARENT45", type=PARENT, multiplicity=Multiplicity(1, 9999))
    }
)
...
faculty_post_attendance: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="post_attendance2", type=post_attendance_external, multiplicity=Multiplicity(0, 1)),
...
student_answer_attendance_call: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        Property(name="answer_attendance_call4", type=answer_attendance_call_external, multiplicity=Multiplicity(0, 1)),
...
domain_model = DomainModel(
    name="adaff9b8_17bc_472f_aee4_f79b50740c91",
    types={student_Actor, faculty_Actor, _Component, parent_Actor, admin_Actor, FACULTY, STUDENT, PARENT, ADMIN, send_attendance_sms_external, recieve_attendance_sms_external, modify_list_of_students_external, take_attendance_call_external, post_attendance_external, answer_attendance_call_external, view_subject_wise_attendance_external, view_cumiliative_attendance_external, login_external, logout_external},
    associations={admin_login, admin_logout, parent_view_subject_wise_attendance, faculty_send_attendance_sms, parent_recieve_attendance_sms, faculty_view_cumiliative_attendance, parent_view_cumiliative_attendance, parent_login, parent_logout, admin_modify_list_of_students, FACULTY_STUDENT, FACULTY_ADMIN, STUDENT_ADMIN, PARENT_ADMIN, faculty_give_attendance, faculty_post_attendance, student_answer_attendance_call, student_view_subject_wise_attendance, student_view_cumiliative_attendance, student_login, student_logout, faculty_login, faculty_logout},
    generalizations={},
    metadata=None
)
