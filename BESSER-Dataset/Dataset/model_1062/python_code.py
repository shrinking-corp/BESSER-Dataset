...
class PetriNet_Type:
    ...
    def __init__(self, name: str, PetriNet_Type13: "PetriNet_Place" = None, PetriNet_Type: "PetriNet_PetriNet" = None, PetriNet_Type8: set["PetriNet_PrimitiveAttribute"] = None):
        self.name = name
