...
domain_model = DomainModel(
    name="PetriNet",
    types={PetriNet_PetriNet, IdentifiableElement, PetriNet_Place, PetriNet_Transition, PetriNet_Arc, PetriNet_Token, PetriNet_PlaceToTransArc, Arc, PetriNet_TransToPlaceArc, PetriNet_IdentifiableElement, PetriNet_Type, PetriNet_PrimitiveAttribute},
    associations={places0, transitions1, arcs3, tokens9, type11, source14, target16, source19, target21, types5, components7},
    generalizations={gen_PetriNet_PetriNet_IdentifiableElement, gen_PetriNet_Place_IdentifiableElement, gen_PetriNet_Transition_IdentifiableElement, gen_PetriNet_PlaceToTransArc_Arc, gen_PetriNet_TransToPlaceArc_Arc},
    metadata=None
)
