...
@given(instance=ocl_cst_UnlimitedNaturalLiteralExpCS_strategy)
def test_hyp_ocl_cst_unlimitednaturalliteralexpcs_extendedIntegerSymbol_setter(instance):
...
@given(instance=ocl_cst_UnlimitedNaturalLiteralExpCS_strategy)
def test_hyp_ocl_cst_unlimitednaturalliteralexpcs_longSymbol_setter(instance):
...
def test_hyp_ocl_cst_integerliteralexpcs_extendedIntegerSymbol_setter(instance):
    original = instance.extendedIntegerSymbol
    instance.extendedIntegerSymbol = original
    assert instance.extendedIntegerSymbol == original
...
@given(instance=ocl_cst_IntegerLiteralExpCS_strategy)
def test_hyp_ocl_cst_integerliteralexpcs_longSymbol_setter(instance):
    original = instance.longSymbol
    instance.longSymbol = original
    assert instance.longSymbol == original
...
def test_ocl_cst_IntegerLiteralExpCS_extendedIntegerSymbol_value_roundtrip():
    instance = ocl_cst_IntegerLiteralExpCS(extendedIntegerSymbol="sample_text", integerSymbol="sample_text", longSymbol="sample_text")
...
def test_ocl_cst_IntegerLiteralExpCS_longSymbol_value_roundtrip():
    instance = ocl_cst_IntegerLiteralExpCS(extendedIntegerSymbol="sample_text", integerSymbol="sample_text", longSymbol="sample_text")
...
def test_ocl_cst_UnlimitedNaturalLiteralExpCS_extendedIntegerSymbol_value_roundtrip():
    instance = ocl_cst_UnlimitedNaturalLiteralExpCS(extendedIntegerSymbol="sample_text", integerSymbol="sample_text", longSymbol="sample_text")
    assert instance.extendedIntegerSymbol == "sample_text"
    instance.extendedIntegerSymbol = "sample_text_2"
    assert instance.extendedIntegerSymbol == "sample_text_2"
...
def test_ocl_cst_UnlimitedNaturalLiteralExpCS_longSymbol_value_roundtrip():
    instance = ocl_cst_UnlimitedNaturalLiteralExpCS(extendedIntegerSymbol="sample_text", integerSymbol="sample_text", longSymbol="sample_text")
    assert instance.longSymbol == "sample_text"
    instance.longSymbol = "sample_text_2"
    assert instance.longSymbol == "sample_text_2"
...
ocl_cst_IntegerLiteralExpCS_strategy = st.builds(ocl_cst_IntegerLiteralExpCS, extendedIntegerSymbol=safe_text, integerSymbol=safe_text, longSymbol=safe_text)
@given(instance=ocl_cst_IntegerLiteralExpCS_strategy)
@settings(max_examples=25)
...
ocl_cst_UnlimitedNaturalLiteralExpCS_strategy = st.builds(ocl_cst_UnlimitedNaturalLiteralExpCS, extendedIntegerSymbol=safe_text, integerSymbol=safe_text, longSymbol=safe_text)
@given(instance=ocl_cst_UnlimitedNaturalLiteralExpCS_strategy)
@settings(max_examples=25)
