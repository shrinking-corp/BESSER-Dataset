...
class tutorial_Book:
    ...
    def __init__(self, name: str, copies: str, Book: "tutorial_Library" = None, books: "tutorial_Library" = None, tutorial_Book: set["tutorial_Loan"] = None, tutorial_Book13: "tutorial_Member" = None):
        self.name = name
        self.copies = copies
        self.Book = Book
        self.books = books
    ...
    def isAvailable(self, tutorial_param1, tutorial_param2) :
...
class tutorial_Member:
    ...
    def __init__(self, name: str, Member: "tutorial_Library" = None, members: "tutorial_Library" = None, tutorial_Member: set["tutorial_Loan"] = None, tutorial_Member12: set["tutorial_Book"] = None, tutorial_Member18: "tutorial_Loan" = None):
        self.name = name
        self.Member = Member
...
class tutorial_Loan:
    ...
    def __init__(self, date: date, tutorial_Loan: "tutorial_Library" = None, tutorial_Loan6: "tutorial_Book" = None, tutorial_Loan10: "tutorial_Member" = None, tutorial_Loan15: "SubOrg1_sb1C" = None, tutorial_Loan17: "tutorial_Member" = None):
        self.date = date
