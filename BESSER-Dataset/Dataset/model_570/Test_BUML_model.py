...
# Classes
tutorial_Loan = Class(name="tutorial_Loan")
tutorial_Member = Class(name="tutorial_Member")
tutorial_Library = Class(name="tutorial_Library")
tutorial_Book = Class(name="tutorial_Book")
tutorial_Organization_Librarian = Class(name="tutorial_Organization_Librarian")
Employee = Class(name="Employee")
SubOrg2_sb2C = Class(name="SubOrg2_sb2C")
tutorial_Organization_Ref = Class(name="tutorial_Organization_Ref")
Library = Class(name="Library")
Organization_tutorial_Item = Class(name="Organization_tutorial_Item")
tutorial_SubOrg1_sb1C = Class(name="tutorial_SubOrg1_sb1C")
tutorial_SubOrg2_sb2C = Class(name="tutorial_SubOrg2_sb2C")
SubOrg1_sb1C = Class(name="SubOrg1_sb1C")
...
tutorial_Book_m_isAvailable: Method = Method(name="isAvailable", parameters={Parameter(name='tutorial_param2', type=StringType), Parameter(name='tutorial_param1', type=StringType)}, type=BooleanType)
...
domain_model = DomainModel(
    name="tutorial",
    types={tutorial_Loan, tutorial_Member, tutorial_Library, tutorial_Book, tutorial_Organization_Librarian, Employee, SubOrg2_sb2C, tutorial_Organization_Ref, Library, Organization_tutorial_Item, tutorial_SubOrg1_sb1C, tutorial_SubOrg2_sb2C, SubOrg1_sb1C, Type},
    associations={loans1, members2, books0, workOn19, RefOutsideEcore20, library4, loans5, library7, loans9, books11, book14, member16},
