...
COUNSELLOR = Class(name="COUNSELLOR")
...
# COUNSELLOR class attributes and methods
COUNSELLOR_id: Property = Property(name="id", type=StringType)
COUNSELLOR_password: Property = Property(name="password", type=StringType)
COUNSELLOR.attributes={COUNSELLOR_id, COUNSELLOR_password}
...
HOD_id: Property = Property(name="id", type=StringType)
HOD_password: Property = Property(name="password", type=StringType)
HOD.attributes={HOD_password, HOD_id}
...
FACULTY_STUDENT: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="counsellor41", type=COUNSELLOR, multiplicity=Multiplicity(1, 9999))
    }
)
FACULTY_ADMIN: BinaryAssociation = BinaryAssociation(
    name="FACULTY_ADMIN",
    ends={
        Property(name="hod42", type=HOD, multiplicity=Multiplicity(1, 1)),
        Property(name="FACULTY_ADMIN_143", type=COUNSELLOR, multiplicity=Multiplicity(1, 9999))
    }
)
STUDENT_ADMIN: BinaryAssociation = BinaryAssociation(
    name="STUDENT_ADMIN",
    ends={
        Property(name="hod44", type=HOD, multiplicity=Multiplicity(1, 1)),
...
domain_model = DomainModel(
    name="ced57988_a1b0_4df1_9d70_1b350dd2677c",
    types={student_Actor, faculty_Actor, _Component, parent_Actor, admin_Actor, COUNSELLOR, STUDENT, HOD, take_attendance_call_external, generate_class_wise_attendance_report_external, post_attendance_external, answer_attendance_call_external, view_subject_wise_attendance_external, view_cumiliative_attendance_external, login_external, logout_external, modify_list_of_students_external, send_attendance_sms_external, recieve_attendance_sms_external},
    associations={faculty_give_attendance, faculty_generate_class_wise_attendance_report, faculty_post_attendance, student_answer_attendance_call, student_view_subject_wise_attendance, student_view_cumiliative_attendance, student_login, student_logout, faculty_login, parent_recieve_attendance_sms, faculty_view_cumiliative_attendance, parent_view_cumiliative_attendance, parent_login, parent_logout, admin_modify_list_of_students, FACULTY_STUDENT, FACULTY_ADMIN, STUDENT_ADMIN, faculty_logout, admin_login, admin_logout, parent_view_subject_wise_attendance, faculty_send_attendance_sms},
    generalizations={},
    metadata=None
)
