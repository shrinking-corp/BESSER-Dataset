...
# Classes
Selects_NamedElement = Class(name="Selects_NamedElement", is_abstract=True)
Selects_Aplicacion = Class(name="Selects_Aplicacion")
Selects_Fichero = Class(name="Selects_Fichero")
NamedElement = Class(name="NamedElement")
Selects_Select = Class(name="Selects_Select")
Selects_From = Class(name="Selects_From")
Selects_Where = Class(name="Selects_Where")
Selects_Tabla = Class(name="Selects_Tabla")
Selects_Join = Class(name="Selects_Join")
Selects_Operando = Class(name="Selects_Operando")
