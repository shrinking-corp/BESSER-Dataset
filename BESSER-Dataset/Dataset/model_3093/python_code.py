...
class SimpleClass_Attribute:
    ...
    def __init__(self, name: str, is_primary: str, SimpleClass_Attribute10: "Class" = None, SimpleClass_Attribute: "Classifier" = None):
        self.name = name
...
class SimpleClass_Class(Classifier):
    ...
    def __init__(self, is_persistent: str, SimpleClass_Class: "Class" = None, SimpleClass_Class2: set["Attribute"] = None, Classifier: "SimpleClass_Attribute" = None):
