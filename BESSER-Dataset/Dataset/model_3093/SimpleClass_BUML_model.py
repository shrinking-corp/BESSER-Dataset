...
# Classes
SimpleClass_NonReferencedClass = Class(name="SimpleClass_NonReferencedClass")
...
domain_model = DomainModel(
    name="PrimitiveTypes",
    types={SimpleClass_NonReferencedClass, SimpleClass_Classifier, SimpleClass_Class, Classifier, Class_, Attribute, SimpleClass_PrimitiveDataType, SimpleClass_Association, SimpleClass_Attribute},
    associations={class_9, parent0, attrs1, src3, dest5, type8},
