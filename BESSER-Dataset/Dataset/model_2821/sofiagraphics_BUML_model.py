...
# Classes
sofiagraphics_Point = Class(name="sofiagraphics_Point")
sofiagraphics_Dimension = Class(name="sofiagraphics_Dimension")
sofiagraphics_Widget = Class(name="sofiagraphics_Widget", is_abstract=True)
sofiagraphics_Style = Class(name="sofiagraphics_Style")
sofiagraphics_Scene = Class(name="sofiagraphics_Scene")
sofiagraphics_Color = Class(name="sofiagraphics_Color")
sofiagraphics_Gesture = Class(name="sofiagraphics_Gesture")
sofiagraphics_Rectangle = Class(name="sofiagraphics_Rectangle")
Widget = Class(name="Widget")
sofiagraphics_RoundedRectangle = Class(name="sofiagraphics_RoundedRectangle")
Rectangle = Class(name="Rectangle")
sofiagraphics_Ellipse = Class(name="sofiagraphics_Ellipse")
sofiagraphics_Polyline = Class(name="sofiagraphics_Polyline")
sofiagraphics_Text = Class(name="sofiagraphics_Text")
...
sofiagraphics_Point.attributes={sofiagraphics_Point_x, sofiagraphics_Point_y, sofiagraphics_Point_yrelative, sofiagraphics_Point_xrelative}
...
sofiagraphics_Dimension.attributes={sofiagraphics_Dimension_hrelative, sofiagraphics_Dimension_noresize, sofiagraphics_Dimension_wrelative, sofiagraphics_Dimension_width, sofiagraphics_Dimension_height}
...
sofiagraphics_Widget.attributes={sofiagraphics_Widget_gestureOnly, sofiagraphics_Widget_portYPosition}
...
sofiagraphics_Style.attributes={sofiagraphics_Style_filled, sofiagraphics_Style_lineWidth}
...
sofiagraphics_Color.attributes={sofiagraphics_Color_a, sofiagraphics_Color_b, sofiagraphics_Color_r, sofiagraphics_Color_g}
...
sofiagraphics_Text.attributes={sofiagraphics_Text_halign, sofiagraphics_Text_valign, sofiagraphics_Text_attributeName, sofiagraphics_Text_text}
...
domain_model = DomainModel(
    name="sofiagraphics",
    types={sofiagraphics_Point, sofiagraphics_Dimension, sofiagraphics_Widget, sofiagraphics_Style, sofiagraphics_Scene, sofiagraphics_Color, sofiagraphics_Gesture, sofiagraphics_Rectangle, Widget, sofiagraphics_RoundedRectangle, Rectangle, sofiagraphics_Ellipse, sofiagraphics_Polyline, sofiagraphics_Text, Alignment},
    associations={parent1, style2, child4, object14, root16, point19, dimension22, color25, style27, gesture30, fgcolor32, pos6, dim8, corner10, point12, bgcolor35, widget38},
