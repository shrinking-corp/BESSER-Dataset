...
library_people_Writer = Class(name="library_people_Writer")
people_library_Book = Class(name="people_library_Book")
people_library_Car = Class(name="people_library_Car")
...
library_Library_m_reserve: Method = Method(name="reserve", parameters={Parameter(name='library_books', type=StringType)})
...
author0: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="books", type=Writer, multiplicity=Multiplicity(0, 1))
    }
)
...
domain_model = DomainModel(
    name="library",
    types={library_Book, Writer, library_people_Writer, people_library_Book, people_library_Car, library_Library, BookCategory},
    associations={author0, writers1, books3, books5, car6},
    generalizations={},
    metadata=None
)
