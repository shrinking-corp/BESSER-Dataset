...
# Classes
Expediente = Class(name="Expediente")
...
# Expediente class attributes and methods
Expediente_ownerName: Property = Property(name="ownerName", type=StringType)
Expediente_balance: Property = Property(name="balance", type=FloatType)
Expediente.attributes={Expediente_balance, Expediente_ownerName}
...
ClassA.attributes={ClassA_privateAttribute, ClassA_packageAttribute, ClassA_protectedAttribute, ClassA_publicAttribute}
...
ClassC.attributes={ClassC_packageAttribute, ClassC_protectedAttribute, ClassC_privateAttribute, ClassC_publicAttribute}
...
domain_model = DomainModel(
    name="_4c1cf9c3_fc35_4fec_84ff_8af3d6139f25",
    types={Expediente, ClassA, ClassB, ClassC, ClassD, ClassE, ClassF, ClassG, ClassJ, ClassH, ClassK, ClassL, ClassM, ClassN, ClassP, InterfaceO_Interface, ClassQ, ClassR, ClassS, ClassT, ClassU, ClassV},
