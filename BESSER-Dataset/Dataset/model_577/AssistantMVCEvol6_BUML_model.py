...
# Classes
AssistantMVC_ExamItemView = Class(name="AssistantMVC_ExamItemView")
AssistantMVC_OpenView = Class(name="AssistantMVC_OpenView")
ExamView = Class(name="ExamView")
AssistantMVC_MultipleChoiceView = Class(name="AssistantMVC_MultipleChoiceView")
ExamItemView = Class(name="ExamItemView")
AssistantMVC_Exam = Class(name="AssistantMVC_Exam")
Observable = Class(name="Observable")
AssistantMVC_ExamItem = Class(name="AssistantMVC_ExamItem", is_abstract=True)
AssistantMVC_Controller = Class(name="AssistantMVC_Controller", is_abstract=True)
AssistantMVC_View = Class(name="AssistantMVC_View", is_abstract=True)
AssistantMVC_Open = Class(name="AssistantMVC_Open")
ExamItem = Class(name="ExamItem")
AssistantMVC_MultipleChoice = Class(name="AssistantMVC_MultipleChoice")
AssistantMVC_Observable = Class(name="AssistantMVC_Observable")
AssistantMVC_Observer = Class(name="AssistantMVC_Observer")
Observer = Class(name="Observer")
AssistantMVC_ExamController = Class(name="AssistantMVC_ExamController")
Controller = Class(name="Controller")
AssistantMVC_ExamItemController = Class(name="AssistantMVC_ExamItemController", is_abstract=True)
AssistantMVC_MultipleChoiceController = Class(name="AssistantMVC_MultipleChoiceController")
ExamItemController = Class(name="ExamItemController")
AssistantMVC_OpenController = Class(name="AssistantMVC_OpenController")
AssistantMVC_ExamView = Class(name="AssistantMVC_ExamView")
...
domain_model = DomainModel(
    name="AssistantMVC",
    types={AssistantMVC_ExamItemView, AssistantMVC_OpenView, ExamView, AssistantMVC_MultipleChoiceView, ExamItemView, AssistantMVC_Exam, Observable, AssistantMVC_ExamItem, AssistantMVC_Controller, AssistantMVC_View, AssistantMVC_Open, ExamItem, AssistantMVC_MultipleChoice, AssistantMVC_Observable, AssistantMVC_Observer, Observer, AssistantMVC_ExamController, Controller, AssistantMVC_ExamItemController, AssistantMVC_MultipleChoiceController, ExamItemController, AssistantMVC_OpenController, AssistantMVC_ExamView, View},
    associations={oc9, examItems0, controllers1, views3, observers5, controller6},
    generalizations={gen_AssistantMVC_ExamItemView_View, gen_AssistantMVC_OpenView_ExamView, gen_AssistantMVC_MultipleChoiceView_ExamItemView, gen_AssistantMVC_Exam_Observable, gen_AssistantMVC_ExamItem_Observable, gen_AssistantMVC_Open_ExamItem, gen_AssistantMVC_MultipleChoice_ExamItem, gen_AssistantMVC_Controller_Observer, gen_AssistantMVC_View_Observer, gen_AssistantMVC_ExamController_Controller, gen_AssistantMVC_ExamItemController_Controller, gen_AssistantMVC_MultipleChoiceController_ExamItemController, gen_AssistantMVC_OpenController_ExamItemController, gen_AssistantMVC_ExamView_View},
    metadata=None
)
