...
class r1_Retrieve(Expression):
    ...
    def __init__(self, dateHighProperty: str, dateLowProperty: str, dateProperty: str, idProperty: str, scope: str, templateId: str, codeProperty: str, dataType: str, r1_Retrieve: "r1_Expression" = None, r1_Retrieve161: "r1_Expression" = None):
