...
public class r1_ValueSetDef extends Element {
    ...
    public r1_ValueSetDef(
        String version,        String id,        String accessLevel,        String name    ) {
        super(
        );
    ...
    public r1_ValueSetDef(
        String version,        String id,        String accessLevel,        String name        ArrayList<r1_CodeSystemRef> r1_codesystemrefs    ) {
        this.version = version;
        this.id = id;
        this.accessLevel = accessLevel;
        this.name = name;
