...
class machine_Symbol:
    ...
    def __init__(self, value: str, name: str, position: str, machine_Symbol34: "machine_Symbol" = None, machine_Symbol32: "machine_Symbol" = None, machine_Symbol37: "machine_Head" = None, machine_Symbol: "machine_Tape" = None):
        self.value = value
        self.name = name
...
class machine_Transition:
    ...
    def __init__(self, name: str, read: str, write: str, moveTo: str, machine_Transition: "machine_State" = None, machine_Transition2: "machine_State" = None, machine_Transition14: "machine_Machine" = None):
        self.name = name
        self.read = read
        self.write = write
        self.moveTo = moveTo
...
class machine_State:
    ...
    def __init__(self, name: str, machine_State: "machine_Transition" = None, machine_State3: "machine_Transition" = None, machine_State11: "machine_Machine" = None, machine_State31: "machine_Final" = None, machine_State19: "machine_Current" = None, machine_State22: "machine_Initial" = None):
        self.name = name
