...
pnmlcoremodel_ToolInfo.attributes={pnmlcoremodel_ToolInfo_version, pnmlcoremodel_ToolInfo_toolInfoGrammarURI, pnmlcoremodel_ToolInfo_formattedXMLBuffer, pnmlcoremodel_ToolInfo_tool}
...
pnmlcoremodel_Line.attributes={pnmlcoremodel_Line_color, pnmlcoremodel_Line_style, pnmlcoremodel_Line_shape, pnmlcoremodel_Line_width}
...
pnmlcoremodel_Font.attributes={pnmlcoremodel_Font_weight, pnmlcoremodel_Font_rotation, pnmlcoremodel_Font_align, pnmlcoremodel_Font_size, pnmlcoremodel_Font_style, pnmlcoremodel_Font_decoration, pnmlcoremodel_Font_family}
...
domain_model = DomainModel(
    name="pnmlcoremodel",
    types={pnmlcoremodel_PetriNetDoc, pnmlcoremodel_Page, pnmlcoremodel_PetriNet, PnObject, pnmlcoremodel_Name, pnmlcoremodel_ToolInfo, pnmlcoremodel_PnObject, pnmlcoremodel_NodeGraphics, Annotation, Graphics, pnmlcoremodel_Label, pnmlcoremodel_AnyObject, pnmlcoremodel_Node, pnmlcoremodel_Position, pnmlcoremodel_Dimension, pnmlcoremodel_Fill, pnmlcoremodel_Line, pnmlcoremodel_ArcGraphics, pnmlcoremodel_Offset, pnmlcoremodel_Graphics, pnmlcoremodel_Coordinate, Coordinate, pnmlcoremodel_AnnotationGraphics, pnmlcoremodel_Font, pnmlcoremodel_Annotation, pnmlcoremodel_Arc, pnmlcoremodel_PlaceNode, Node, pnmlcoremodel_RefPlace, pnmlcoremodel_Place, PlaceNode, TransitionNode, pnmlcoremodel_Transition, pnmlcoremodel_TransitionNode, pnmlcoremodel_RefTransition, pnmlcoremodel_Attribute, Label, PNType, Gradient, CSS2Color, LineShape, FontAlign, FontDecoration, CSS2FontFamily, CSS2FontSize, CSS2FontWeight, CSS2FontStyle, LineStyle},
    associations={pages1, nets0, name2, toolspecifics3, containerPetriNetDoc5, name11, objects6, containerPetriNet7, nodegraphics9, containerNamePetriNet17, containerNamePnObject19, toolspecifics13, containerPage15, toolspecifics30, containerPetriNet22, containerPnObject24, containerLabel27, toolInfoModel29, line35, containerNode37, containerPage38, position32, dimension33, fill34, containerArcGraphics43, containerPNodeGraphics41, fill48, line51, containerAnnotationGraphics44, containerDNodeGraphics45, offset47, containerNodeGraphics57, font54, containerAnnotationGraphics59, containerAnnotation56, containerNodeGraphics62, containerArcGraphics64, containerAnnotationGraphics67, line72, containerArc75, positions70, InArcs82, OutArcs84, nodegraphics86, source76, target78, arcgraphics80, containerAnnotationGraphics88, ref93, referencingPlaces90, referencingTransitions91, annotationgraphics95, ref94, containerToolInfo97},
    generalizations={gen_pnmlcoremodel_Page_PnObject, gen_pnmlcoremodel_Name_Annotation, gen_pnmlcoremodel_NodeGraphics_Graphics, gen_pnmlcoremodel_Offset_Coordinate, gen_pnmlcoremodel_Position_Coordinate, gen_pnmlcoremodel_Dimension_Coordinate, gen_pnmlcoremodel_AnnotationGraphics_Graphics, gen_pnmlcoremodel_Arc_PnObject, gen_pnmlcoremodel_ArcGraphics_Graphics, gen_pnmlcoremodel_Node_PnObject, gen_pnmlcoremodel_PlaceNode_Node, gen_pnmlcoremodel_Place_PlaceNode, gen_pnmlcoremodel_RefTransition_TransitionNode, gen_pnmlcoremodel_Transition_TransitionNode, gen_pnmlcoremodel_TransitionNode_Node, gen_pnmlcoremodel_Attribute_Label, gen_pnmlcoremodel_Annotation_Label, gen_pnmlcoremodel_RefPlace_PlaceNode},
    metadata=None
)
