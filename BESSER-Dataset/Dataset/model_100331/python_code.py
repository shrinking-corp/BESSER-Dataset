...
class pnmlcoremodel_Font:
    ...
    def __init__(self, family: str, rotation: str, size: str, style: str, align: str, decoration: str, weight: str, Font: "pnmlcoremodel_AnnotationGraphics" = None, font: "pnmlcoremodel_AnnotationGraphics" = None):
        self.family = family
...
class pnmlcoremodel_Line:
    ...
    def __init__(self, color: str, style: str, shape: str, width: str, Line: "pnmlcoremodel_NodeGraphics" = None, Line53: "pnmlcoremodel_AnnotationGraphics" = None, line: "pnmlcoremodel_NodeGraphics" = None, line65: "pnmlcoremodel_ArcGraphics" = None, line68: "pnmlcoremodel_AnnotationGraphics" = None, Line74: "pnmlcoremodel_ArcGraphics" = None):
        self.color = color
        self.style = style
        self.shape = shape
        self.width = width
...
class pnmlcoremodel_Fill:
    ...
    def __init__(self, gradientrotation: str, image: str, color: str, gradientcolor: str, Fill: "pnmlcoremodel_NodeGraphics" = None, Fill50: "pnmlcoremodel_AnnotationGraphics" = None, fill: "pnmlcoremodel_NodeGraphics" = None, fill60: "pnmlcoremodel_AnnotationGraphics" = None):
...
class pnmlcoremodel_PnObject(ABC):
    ...
    def __init__(self, id: str, containerNamePnObject: "pnmlcoremodel_Name" = None, PnObject: "pnmlcoremodel_Page" = None, PnObject21: "pnmlcoremodel_Name" = None, containerPnObject: set["pnmlcoremodel_ToolInfo"] = None, objects: "pnmlcoremodel_Page" = None, PnObject26: "pnmlcoremodel_ToolInfo" = None):
        self.id = id
...
class pnmlcoremodel_PetriNet:
    ...
    def __init__(self, type: str, id: str, PetriNet: "pnmlcoremodel_PetriNetDoc" = None, containerNamePetriNet: "pnmlcoremodel_Name" = None, containerPetriNet4: set["pnmlcoremodel_ToolInfo"] = None, nets: "pnmlcoremodel_PetriNetDoc" = None, PetriNet8: "pnmlcoremodel_Page" = None, PetriNet18: "pnmlcoremodel_Name" = None, PetriNet23: "pnmlcoremodel_ToolInfo" = None, containerPetriNet: set["pnmlcoremodel_Page"] = None):
        self.type = type
        self.id = id
