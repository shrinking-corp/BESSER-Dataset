...
def test_hyp_resourcepetrinet_genericplace_is_not_abstract():
    assert not inspect.isabstract(resourcePetriNet_GenericPlace)


def test_hyp_resourcepetrinet_genericplace_constructor_exists():
    assert callable(resourcePetriNet_GenericPlace.__init__)


def test_hyp_resourcepetrinet_genericplace_constructor_args():
...
def test_hyp_resourcepetrinet_petrinet_is_not_abstract():
    assert not inspect.isabstract(resourcePetriNet_PetriNet)


def test_hyp_resourcepetrinet_petrinet_constructor_exists():
    assert callable(resourcePetriNet_PetriNet.__init__)


def test_hyp_resourcepetrinet_petrinet_constructor_args():
...
def test_hyp_resourcepetrinet_place_is_not_abstract():
    assert not inspect.isabstract(resourcePetriNet_Place)


def test_hyp_resourcepetrinet_place_constructor_exists():
    assert callable(resourcePetriNet_Place.__init__)


def test_hyp_resourcepetrinet_place_constructor_args():
...
def test_hyp_resourcepetrinet_resource_is_not_abstract():
    assert not inspect.isabstract(resourcePetriNet_Resource)


def test_hyp_resourcepetrinet_resource_constructor_exists():
    assert callable(resourcePetriNet_Resource.__init__)


def test_hyp_resourcepetrinet_resource_constructor_args():
    sig = inspect.signature(resourcePetriNet_Resource.__init__)
    params = list(sig.parameters.keys())



def test_hyp_resourcepetrinet_outputarc_is_not_abstract():
    assert not inspect.isabstract(resourcePetriNet_OutputArc)


def test_hyp_resourcepetrinet_outputarc_constructor_exists():
    assert callable(resourcePetriNet_OutputArc.__init__)


def test_hyp_resourcepetrinet_outputarc_constructor_args():
...
def test_hyp_resourcepetrinet_inputarc_is_not_abstract():
    assert not inspect.isabstract(resourcePetriNet_InputArc)


def test_hyp_resourcepetrinet_inputarc_constructor_exists():
    assert callable(resourcePetriNet_InputArc.__init__)


def test_hyp_resourcepetrinet_inputarc_constructor_args():
...
def test_hyp_resourcepetrinet_transition_is_not_abstract():
    assert not inspect.isabstract(resourcePetriNet_Transition)


def test_hyp_resourcepetrinet_transition_constructor_exists():
    assert callable(resourcePetriNet_Transition.__init__)


def test_hyp_resourcepetrinet_transition_constructor_args():
...
def test_hyp_resourcepetrinet_genericplace_numberOfTokens_setter(instance):
...
@given(instance=resourcePetriNet_GenericPlace_strategy)
def test_hyp_resourcepetrinet_genericplace_name_setter(instance):
...
def test_hyp_resourcepetrinet_petrinet_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
...
def test_hyp_resourcepetrinet_place_capacity_setter(instance):
...
def test_hyp_resourcepetrinet_outputarc_weight_setter(instance):
...
def test_hyp_resourcepetrinet_inputarc_weight_setter(instance):
    original = instance.weight
    instance.weight = original
    assert instance.weight == original
...
def test_hyp_resourcepetrinet_transition_name_setter(instance):
    original = instance.name
    instance.name = original
    assert instance.name == original
