...
class resourcePetriNet_GenericPlace(ABC):
    ...
    def __init__(self, name: str, numberOfTokens: int, resourcePetriNet_GenericPlace9: "resourcePetriNet_InputArc" = None, resourcePetriNet_GenericPlace18: "resourcePetriNet_OutputArc" = None, resourcePetriNet_GenericPlace: "resourcePetriNet_PetriNet" = None):
        self.name = name
...
class resourcePetriNet_PetriNet:
    ...
    def __init__(self, name: str, resourcePetriNet_PetriNet2: set["resourcePetriNet_Transition"] = None, resourcePetriNet_PetriNet4: set["resourcePetriNet_InputArc"] = None, resourcePetriNet_PetriNet6: set["resourcePetriNet_OutputArc"] = None, resourcePetriNet_PetriNet: set["resourcePetriNet_GenericPlace"] = None):
        self.name = name
...
class resourcePetriNet_InputArc:
    ...
    def __init__(self, weight: int, resourcePetriNet_InputArc: "resourcePetriNet_PetriNet" = None, resourcePetriNet_InputArc8: "resourcePetriNet_GenericPlace" = None, resourcePetriNet_InputArc11: "resourcePetriNet_Transition" = None):
        self.weight = weight
