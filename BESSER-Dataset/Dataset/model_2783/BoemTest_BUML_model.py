...
# Classes
A = Class(name="A")
BoemTest_BNode = Class(name="BoemTest_BNode")
BoemTest_C = Class(name="BoemTest_C")
B = Class(name="B")
BoemTest_A = Class(name="BoemTest_A")
NamedElement = Class(name="NamedElement")
BoemTest_Node = Class(name="BoemTest_Node")
BoemTest_B = Class(name="BoemTest_B")
BoemTest_NamedElement = Class(name="BoemTest_NamedElement", is_abstract=True)
...
domain_model = DomainModel(
    name="BoemTest",
    types={A, BoemTest_BNode, BoemTest_C, B, BoemTest_A, NamedElement, BoemTest_Node, BoemTest_B, BoemTest_NamedElement, AnEnumeration},
    associations={childrenNodeB16, childNodeB18, childrenNodeBNode21, childrenNodeC23, childNodeC25, referencesNodeC28, referenceNodeC31, children35, childrenNodeA0, childrenNode2A1, childNodeA4, referencesNodeA7, referenceNodeA10, autoContainementA14},
    generalizations={gen_BoemTest_B_A, gen_BoemTest_C_B, gen_BoemTest_Node_NamedElement, gen_BoemTest_A_NamedElement},
    metadata=None
)
