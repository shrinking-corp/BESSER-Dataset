...
# Classes
simpliC_Model = Class(name="simpliC_Model")
simpliC_Function = Class(name="simpliC_Function")
simpliC_Type = Class(name="simpliC_Type")
simpliC_Stmt = Class(name="simpliC_Stmt")
simpliC_Call = Class(name="simpliC_Call")
simpliC_Expr = Class(name="simpliC_Expr")
simpliC_ExprCall = Class(name="simpliC_ExprCall")
Factor = Class(name="Factor")
simpliC_Ifstmt = Class(name="simpliC_Ifstmt")
simpliC_Whilestmt = Class(name="simpliC_Whilestmt")
simpliC_Return = Class(name="simpliC_Return")
simpliC_Decl = Class(name="simpliC_Decl")
simpliC_Args = Class(name="simpliC_Args")
simpliC_Block = Class(name="simpliC_Block")
Stmt = Class(name="Stmt")
simpliC_EObject = Class(name="simpliC_EObject")
simpliC_TFact = Class(name="simpliC_TFact")
simpliC_Factor = Class(name="simpliC_Factor")
simpliC_IDuse = Class(name="simpliC_IDuse")
simpliC_Typedef = Class(name="simpliC_Typedef")
simpliC_Assign = Class(name="simpliC_Assign")
...
domain_model = DomainModel(
    name="simpliC",
    types={simpliC_Model, simpliC_Function, simpliC_Type, simpliC_Stmt, simpliC_Call, simpliC_Expr, simpliC_ExprCall, Factor, simpliC_Ifstmt, simpliC_Whilestmt, simpliC_Return, simpliC_Decl, simpliC_Args, simpliC_Block, Stmt, simpliC_EObject, simpliC_TFact, simpliC_Factor, simpliC_IDuse, simpliC_Typedef, simpliC_Assign},
    associations={Program0, block7, functionID9, Paramlist11, functionID13, Paramlist15, cond18, Then20, Else23, cond26, Then28, value31, type1, Arglist3, body5, value40, rh42, lh44, terms47, lh49, name52, type54, oldtype57, type33, vtype35, value37},
    generalizations={gen_simpliC_Call_Stmt, gen_simpliC_ExprCall_Factor, gen_simpliC_Ifstmt_Stmt, gen_simpliC_Whilestmt_Stmt, gen_simpliC_Return_Stmt, gen_simpliC_Decl_Stmt, gen_simpliC_Block_Stmt, gen_simpliC_IDuse_Factor, gen_simpliC_Typedef_Stmt, gen_simpliC_Assign_Stmt},
    metadata=None
)
