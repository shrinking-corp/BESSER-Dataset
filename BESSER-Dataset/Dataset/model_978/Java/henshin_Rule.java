...
public class henshin_Rule extends Unit {
    ...
    public henshin_Rule(
        boolean checkDangling,        boolean injectiveMatching,        String javaImports        ArrayList<henshin_Rule> henshin_rules,        ArrayList<henshin_Mapping> henshin_mappings,        ArrayList<henshin_Mapping> henshin_mappings,        ArrayList<henshin_AttributeCondition> henshin_attributeconditions    ) {
        this.checkDangling = checkDangling;
        this.injectiveMatching = injectiveMatching;
        this.javaImports = javaImports;
