...
test_Person_m_isAgeValid: Method = Method(name="isAgeValid", parameters={Parameter(name='test_map', type=StringType), Parameter(name='test_diag', type=StringType)}, type=BooleanType)
