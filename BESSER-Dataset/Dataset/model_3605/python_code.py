...
class noop_MemberSelect(Expression):
    ...
    def __init__(self, hasArgs: bool, noop_MemberSelect: "noop_Expression" = None, noop_MemberSelect189: "noop_Member" = None, noop_MemberSelect192: set["noop_Expression"] = None, noop_MemberSelect195: set["noop_Index"] = None):
...
class noop_AssignmentExpression(Expression):
    ...
    def __init__(self, assignment: str, noop_AssignmentExpression69: "noop_Expression" = None, noop_AssignmentExpression: "noop_Expression" = None):
...
class noop_ForStatement(Statement):
    ...
    def __init__(self, name: str, noop_ForStatement: set["noop_Variable"] = None, noop_ForStatement39: set["noop_Expression"] = None, noop_ForStatement42: "noop_Expression" = None, noop_ForStatement45: set["noop_Expression"] = None, noop_ForStatement48: "noop_Block" = None):
        self.name = name
