...
# Classes
noop_NoopClass = Class(name="noop_NoopClass")
noop_Member = Class(name="noop_Member")
noop_Storage = Class(name="noop_Storage")
noop_Expression = Class(name="noop_Expression")
noop_Variable = Class(name="noop_Variable")
Member = Class(name="Member")
Statement = Class(name="Statement")
noop_Length = Class(name="noop_Length")
noop_Method = Class(name="noop_Method")
noop_Block = Class(name="noop_Block")
noop_IfStatement = Class(name="noop_IfStatement")
noop_ElseStatement = Class(name="noop_ElseStatement")
noop_ForStatement = Class(name="noop_ForStatement")
noop_ForeverStatement = Class(name="noop_ForeverStatement")
noop_Statement = Class(name="noop_Statement")
noop_ReturnStatement = Class(name="noop_ReturnStatement")
noop_Constructor = Class(name="noop_Constructor")
noop_ConstructorField = Class(name="noop_ConstructorField")
noop_Index = Class(name="noop_Index")
noop_ContinueStatement = Class(name="noop_ContinueStatement")
noop_BreakStatement = Class(name="noop_BreakStatement")
noop_AsmStatement = Class(name="noop_AsmStatement")
noop_AndExpression = Class(name="noop_AndExpression")
noop_BOrExpression = Class(name="noop_BOrExpression")
noop_BXorExpression = Class(name="noop_BXorExpression")
noop_BAndExpression = Class(name="noop_BAndExpression")
noop_EqualsExpression = Class(name="noop_EqualsExpression")
noop_DifferExpression = Class(name="noop_DifferExpression")
noop_AssignmentExpression = Class(name="noop_AssignmentExpression")
Expression = Class(name="Expression")
noop_OrExpression = Class(name="noop_OrExpression")
noop_LtExpression = Class(name="noop_LtExpression")
noop_LeExpression = Class(name="noop_LeExpression")
noop_InstanceOfExpression = Class(name="noop_InstanceOfExpression")
noop_LShiftExpression = Class(name="noop_LShiftExpression")
noop_RShiftExpression = Class(name="noop_RShiftExpression")
noop_GtExpression = Class(name="noop_GtExpression")
noop_GeExpression = Class(name="noop_GeExpression")
noop_MulExpression = Class(name="noop_MulExpression")
noop_DivExpression = Class(name="noop_DivExpression")
noop_ModExpression = Class(name="noop_ModExpression")
noop_CastExpression = Class(name="noop_CastExpression")
noop_ComplementExpression = Class(name="noop_ComplementExpression")
noop_NotExpression = Class(name="noop_NotExpression")
noop_AddExpression = Class(name="noop_AddExpression")
noop_SubExpression = Class(name="noop_SubExpression")
noop_DecExpression = Class(name="noop_DecExpression")
noop_IncExpression = Class(name="noop_IncExpression")
noop_MemberSelect = Class(name="noop_MemberSelect")
noop_ByteLiteral = Class(name="noop_ByteLiteral")
noop_BoolLiteral = Class(name="noop_BoolLiteral")
noop_StringLiteral = Class(name="noop_StringLiteral")
noop_ArrayLiteral = Class(name="noop_ArrayLiteral")
noop_SigNegExpression = Class(name="noop_SigNegExpression")
noop_SigPosExpression = Class(name="noop_SigPosExpression")
noop_MemberRef = Class(name="noop_MemberRef")
noop_This = Class(name="noop_This")
noop_Super = Class(name="noop_Super")
noop_NewInstance = Class(name="noop_NewInstance")
...
domain_model = DomainModel(
    name="noop",
    types={noop_NoopClass, noop_Member, noop_Storage, noop_Expression, noop_Variable, Member, Statement, noop_Length, noop_Method, noop_Block, noop_IfStatement, noop_ElseStatement, noop_ForStatement, noop_ForeverStatement, noop_Statement, noop_ReturnStatement, noop_Constructor, noop_ConstructorField, noop_Index, noop_ContinueStatement, noop_BreakStatement, noop_AsmStatement, noop_AndExpression, noop_BOrExpression, noop_BXorExpression, noop_BAndExpression, noop_EqualsExpression, noop_DifferExpression, noop_AssignmentExpression, Expression, noop_OrExpression, noop_LtExpression, noop_LeExpression, noop_InstanceOfExpression, noop_LShiftExpression, noop_RShiftExpression, noop_GtExpression, noop_GeExpression, noop_MulExpression, noop_DivExpression, noop_ModExpression, noop_CastExpression, noop_ComplementExpression, noop_NotExpression, noop_AddExpression, noop_SubExpression, noop_DecExpression, noop_IncExpression, noop_MemberSelect, noop_ByteLiteral, noop_BoolLiteral, noop_StringLiteral, noop_ArrayLiteral, noop_SigNegExpression, noop_SigPosExpression, noop_MemberRef, noop_This, noop_Super, noop_NewInstance, AssignmentType, StorageType},
    associations={superClass1, members2, storage4, location6, value8, type10, dimension13, params15, body17, value21, condition23, body25, else_28, body30, if_33, variables36, assignments38, condition41, expressions44, body47, statements19, vars52, fields54, variable55, value58, value61, value63, body50, left71, right73, left76, right78, left81, right83, left86, right88, left91, right93, left96, right98, left101, right103, left66, right68, right113, left116, right118, left121, right123, left126, type128, left131, right133, left136, right138, left106, right108, left111, left146, right148, left151, right153, left156, right158, left161, right163, left166, type168, dimension171, right174, left141, right143, right180, right182, right184, receiver186, member188, args191, indexes194, values197, right176, right178, constructor201, dimension204, member207, args209, indexes212, type199},
    generalizations={gen_noop_Variable_Member, gen_noop_Variable_Statement, gen_noop_Method_Member, gen_noop_IfStatement_Statement, gen_noop_ForStatement_Statement, gen_noop_ForeverStatement_Statement, gen_noop_ReturnStatement_Statement, gen_noop_Expression_Statement, gen_noop_ContinueStatement_Statement, gen_noop_BreakStatement_Statement, gen_noop_AsmStatement_Statement, gen_noop_AndExpression_Expression, gen_noop_BOrExpression_Expression, gen_noop_BXorExpression_Expression, gen_noop_BAndExpression_Expression, gen_noop_EqualsExpression_Expression, gen_noop_DifferExpression_Expression, gen_noop_AssignmentExpression_Expression, gen_noop_OrExpression_Expression, gen_noop_LtExpression_Expression, gen_noop_LeExpression_Expression, gen_noop_InstanceOfExpression_Expression, gen_noop_LShiftExpression_Expression, gen_noop_RShiftExpression_Expression, gen_noop_GtExpression_Expression, gen_noop_GeExpression_Expression, gen_noop_MulExpression_Expression, gen_noop_DivExpression_Expression, gen_noop_ModExpression_Expression, gen_noop_CastExpression_Expression, gen_noop_ComplementExpression_Expression, gen_noop_NotExpression_Expression, gen_noop_AddExpression_Expression, gen_noop_SubExpression_Expression, gen_noop_DecExpression_Expression, gen_noop_IncExpression_Expression, gen_noop_MemberSelect_Expression, gen_noop_ByteLiteral_Expression, gen_noop_BoolLiteral_Expression, gen_noop_StringLiteral_Expression, gen_noop_ArrayLiteral_Expression, gen_noop_SigNegExpression_Expression, gen_noop_SigPosExpression_Expression, gen_noop_MemberRef_Expression, gen_noop_This_Expression, gen_noop_Super_Expression, gen_noop_NewInstance_Expression},
    metadata=None
)
