...
class PetriNet_Arc:
    ...
    def __init__(self, weight: int, kind: str, Arc5: "PetriNet_Node" = None, Arc7: "PetriNet_Node" = None, incomings: "PetriNet_Node" = None, Arc: "PetriNet_PetriNet" = None, outgoings: "PetriNet_Node" = None, arcs: "PetriNet_PetriNet" = None):
        self.weight = weight
        self.kind = kind
        self.Arc5 = Arc5
        self.Arc7 = Arc7
...
class PetriNet_Node(ABC):
    ...
    def __init__(self, name: str, nodes: "PetriNet_PetriNet" = None, source: set["PetriNet_Arc"] = None, target: set["PetriNet_Arc"] = None, Node9: "PetriNet_Arc" = None, Node: "PetriNet_PetriNet" = None, Node11: "PetriNet_Arc" = None):
        self.name = name
        self.nodes = nodes
