...
# Classes
school_Classroom = Class(name="school_Classroom")
school_Student = Class(name="school_Student")
school_Diagram = Class(name="school_Diagram")
...
school_Classroom_m_validate: Method = Method(name="validate", parameters={Parameter(name='school_diagnostic', type=StringType), Parameter(name='school_context', type=StringType)}, type=BooleanType)
school_Classroom.attributes={school_Classroom_teacher, school_Classroom_name, school_Classroom_capacity, school_Classroom_rank}
...
school_Student_m_validate: Method = Method(name="validate", parameters={Parameter(name='school_context', type=StringType), Parameter(name='school_diagnostic', type=StringType)}, type=BooleanType)
school_Student.attributes={school_Student_age, school_Student_name, school_Student_nickname}
...
school_School.attributes={school_School_city, school_School_zipCode, school_School_director, school_School_name}
