...
class umltordbms_PrimitiveToName:
    ...
    def __init__(self, name: str, typeName: str, umltordbms_PrimitiveToName: "umltordbms_AttributeToColumn" = None, PrimitiveToName: "umltordbms_PackageToSchema" = None, primitivesToNames: "umltordbms_PackageToSchema" = None, umltordbms_PrimitiveToName33: "umltordbms_PrimitiveDataType" = None):
        self.name = name
...
class umltordbms_ClassToTable(ToColumn, FromAttributeOwner):
    ...
    def __init__(self, name: str, umltordbms_ClassToTable12: "umltordbms_Table" = None, umltordbms_ClassToTable14: "umltordbms_Key" = None, umltordbms_ClassToTable: "umltordbms_AssociationToForeignKey" = None, ClassToTable: "umltordbms_AssociationToForeignKey" = None, classesToTables: "umltordbms_PackageToSchema" = None, owner: set["umltordbms_AssociationToForeignKey"] = None, umltordbms_ClassToTable10: "umltordbms_Class" = None, ClassToTable24: "umltordbms_PackageToSchema" = None):
        self.name = name
