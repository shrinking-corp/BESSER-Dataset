...
# Classes
attroverridesecondarytable_NonEmployee = Class(name="attroverridesecondarytable_NonEmployee")
attroverridesecondarytable_Address = Class(name="attroverridesecondarytable_Address")
attroverridesecondarytable_Country = Class(name="attroverridesecondarytable_Country")
attroverridesecondarytable_Person = Class(name="attroverridesecondarytable_Person")
attroverridesecondarytable_Employee = Class(name="attroverridesecondarytable_Employee")
...
attroverridesecondarytable_Address.attributes={attroverridesecondarytable_Address_street, attroverridesecondarytable_Address_city, attroverridesecondarytable_Address_name}
...
domain_model = DomainModel(
    ...
    types={attroverridesecondarytable_NonEmployee, attroverridesecondarytable_Address, attroverridesecondarytable_Country, attroverridesecondarytable_Person, attroverridesecondarytable_Employee, Person},
    associations={address1, address3, country0},
    generalizations={gen_attroverridesecondarytable_NonEmployee_Person, gen_attroverridesecondarytable_Employee_Person},
    metadata=None
)
