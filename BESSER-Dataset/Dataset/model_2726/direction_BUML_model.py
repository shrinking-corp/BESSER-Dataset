...
# Classes
direction_C = Class(name="direction_C")
direction_A = Class(name="direction_A")
direction_B = Class(name="direction_B")
A = Class(name="A")
...
domain_model = DomainModel(
    name="direction",
    types={direction_C, direction_A, direction_B, A},
    associations={as_0, bs1},
