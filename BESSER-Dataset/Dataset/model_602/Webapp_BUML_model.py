...
webapp_Template.attributes={webapp_Template_structure, webapp_Template_style}
...
domain_model = DomainModel(
    name="webapp",
    types={webapp_Data, webapp_NamedElement, webapp_WebApp, NamedElement, webapp_Collection, webapp_Router, webapp_Model, webapp_Controller, webapp_Template, webapp_View, Data, webapp_Attribute, webapp_RouterBinding, webapp_PageController, Controller, webapp_ServiceController, DataType},
    associations={model13, subviews17, collections0, router1, models3, controllers5, templates7, views9, attributes11, template19, data22, bindings24, controller26, parameters29, page32},
    generalizations={gen_webapp_Data_NamedElement, gen_webapp_View_NamedElement, gen_webapp_WebApp_NamedElement, gen_webapp_Model_Data, gen_webapp_Collection_Data, gen_webapp_Template_NamedElement, gen_webapp_Controller_NamedElement, gen_webapp_PageController_Controller, gen_webapp_ServiceController_Controller, gen_webapp_Attribute_NamedElement},
    metadata=None
)
