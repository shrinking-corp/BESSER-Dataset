...
# Classes
iotsystem_Action = Class(name="iotsystem_Action")
iotsystem_Condition = Class(name="iotsystem_Condition")
iotsystem_Sensor = Class(name="iotsystem_Sensor")
Device = Class(name="Device")
iotsystem_Device = Class(name="iotsystem_Device", is_abstract=True)
NamedElement = Class(name="NamedElement")
iotsystem_Resource = Class(name="iotsystem_Resource")
iotsystem_DigitalArtifact = Class(name="iotsystem_DigitalArtifact")
iotsystem_Rule = Class(name="iotsystem_Rule")
iotsystem_Actuator = Class(name="iotsystem_Actuator")
iotsystem_Parameter = Class(name="iotsystem_Parameter")
iotsystem_PhysicalEntity = Class(name="iotsystem_PhysicalEntity")
iotsystem_IotSystem = Class(name="iotsystem_IotSystem")
iotsystem_NamedElement = Class(name="iotsystem_NamedElement")
...
iotsystem_Condition.attributes={iotsystem_Condition_relationalOperator, iotsystem_Condition_expectedValue}
...
iotsystem_Parameter.attributes={iotsystem_Parameter_value, iotsystem_Parameter_name}
...
domain_model = DomainModel(
    name="iotsystem",
    types={iotsystem_Action, iotsystem_Condition, iotsystem_Sensor, Device, iotsystem_Device, NamedElement, iotsystem_Resource, iotsystem_DigitalArtifact, iotsystem_Rule, iotsystem_Actuator, iotsystem_Parameter, iotsystem_PhysicalEntity, iotsystem_IotSystem, iotsystem_NamedElement, EnvironmentConditions, Actions, RelationalOperator},
    associations={actions5, condition7, consumes0, resources1, rules3, variable18, parameters9, devices11, physicalEntities13, digitalArtifacts15},
    generalizations={gen_iotsystem_Rule_NamedElement, gen_iotsystem_Sensor_Device, gen_iotsystem_Device_NamedElement, gen_iotsystem_DigitalArtifact_NamedElement, gen_iotsystem_Actuator_Device, gen_iotsystem_PhysicalEntity_NamedElement, gen_iotsystem_IotSystem_NamedElement},
    metadata=None
)
