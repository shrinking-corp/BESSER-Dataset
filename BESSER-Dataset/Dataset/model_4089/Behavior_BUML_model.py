...
# Classes
Behavior_Component = Class(name="Behavior_Component")
Behavior_Event = Class(name="Behavior_Event")
Behavior_State = Class(name="Behavior_State")
Behavior_Transition = Class(name="Behavior_Transition")
Behavior_System = Class(name="Behavior_System")
...
domain_model = DomainModel(
    name="Behavior",
    types={Behavior_Component, Behavior_Event, Behavior_State, Behavior_Transition, Behavior_System, NamedElement, Behavior_NamedElement},
    ...
    generalizations={gen_Behavior_Component_NamedElement, gen_Behavior_Event_NamedElement, gen_Behavior_Transition_NamedElement, gen_Behavior_System_NamedElement, gen_Behavior_State_NamedElement},
    metadata=None
)
