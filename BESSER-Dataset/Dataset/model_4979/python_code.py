...
class cloudml_core_ExternalComponentInstance(ComponentInstance):
    ...
    def __init__(self, ips: str, cloudml_core_ExternalComponentInstance: set["VMPortInstance"] = None, ComponentInstance89: "cloudml_core_ExecutionPlatformInstance" = None, ComponentInstance70: "cloudml_core_PortInstance" = None, ComponentInstance: "cloudml_core_CloudMLModel" = None):
        self.ips = ips
...
class cloudml_core_PuppetResource(Resource):
    ...
    def __init__(self, masterEndpoint: str, repositoryEndpoint: str, configureHostnameCommand: str, username: str, repositoryKey: str, configurationFile: str, manifestEntry: str, Resource49: "cloudml_core_Relationship" = None, Resource52: "cloudml_core_Relationship" = None, Resource: "cloudml_core_CloudMLElementWithProperties" = None):
...
class cloudml_core_ExternalComponent(Component):
    ...
    def __init__(self, endPoint: str, login: str, passwd: str, location: str, serviceType: str, Region: str, cloudml_core_ExternalComponent82: set["VMPort"] = None, cloudml_core_ExternalComponent: "Provider" = None, Component: "cloudml_core_CloudMLModel" = None, Component61: "cloudml_core_ComponentInstance" = None, Component87: "cloudml_core_ExecutionPlatform" = None, Component41: "cloudml_core_Port" = None):
