...
public class org_structure_ClassDefinition extends GenericTypeDefinition {
    ...
    public org_structure_ClassDefinition(
        String isFinal,        String isSingleton,        String isAbstract    ) {
        super(
        );
    ...
    public org_structure_ClassDefinition(
        String isFinal,        String isSingleton,        String isAbstract        ArrayList<structure_Constraint> structure_constraints,        ArrayList<structure_Operation> structure_operations,        ArrayList<structure_Property> structure_propertys    ) {
        this.isFinal = isFinal;
        this.isSingleton = isSingleton;
        this.isAbstract = isAbstract;
