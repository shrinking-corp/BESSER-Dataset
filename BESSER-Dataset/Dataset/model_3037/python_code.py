...
class basicfsm_State:
    ...
    def __init__(self, name: str, basicfsm_State: "basicfsm_Machine" = None, tgt: set["basicfsm_Trans"] = None, src: set["basicfsm_Trans"] = None, basicfsm_State7: set["basicfsm_VarDecl"] = None, State: "basicfsm_Trans" = None, State10: "basicfsm_Trans" = None):
        self.name = name
...
class basicfsm_Trans:
    ...
    def __init__(self, event: str, basicfsm_Trans12: "basicfsm_Guard" = None, basicfsm_Trans14: "basicfsm_Action" = None, basicfsm_Trans: "basicfsm_Machine" = None, Trans: "basicfsm_State" = None, Trans5: "basicfsm_State" = None, out: "basicfsm_State" = None, in_: "basicfsm_State" = None):
        self.event = event
    ...
    def in_(self, value):
        # Bidirectional consistency
        old_value = getattr(self, f"_basicfsm_Trans__in_", None)
        self.__in_ = value
