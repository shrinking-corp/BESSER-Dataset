...
# Classes
basicfsm_Trans = Class(name="basicfsm_Trans")
basicfsm_VarDecl = Class(name="basicfsm_VarDecl")
basicfsm_Machine = Class(name="basicfsm_Machine")
basicfsm_State = Class(name="basicfsm_State")
basicfsm_Guard = Class(name="basicfsm_Guard", is_abstract=True)
basicfsm_Action = Class(name="basicfsm_Action", is_abstract=True)
basicfsm_InitialState = Class(name="basicfsm_InitialState")
...
tgt9: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="in_", type=basicfsm_State, multiplicity=Multiplicity(0, 1))
    }
)
...
domain_model = DomainModel(
    name="basicfsm",
    types={basicfsm_Trans, basicfsm_VarDecl, basicfsm_Machine, basicfsm_State, basicfsm_Guard, basicfsm_Action, basicfsm_InitialState, State},
    associations={states0, trans1, in_3, out4, decls6, src8, tgt9, guard11, action13},
