...
class java_Model:
    ...
    def __init__(self, name: str, Model: "java_Package" = None, model: set["java_Package"] = None, java_Model: set["java_Type"] = None, java_Model239: set["java_UnresolvedItem"] = None, java_Model241: set["java_CompilationUnit"] = None, java_Model244: set["java_ClassFile"] = None, java_Model247: set["java_Archive"] = None):
        self.name = name
        self.Model = Model
...
class java_CompilationUnit(NamedElement):
    ...
    def __init__(self, originalFilePath: str, java_CompilationUnit: "java_ASTNode" = None, java_CompilationUnit129: set["java_Comment"] = None, java_CompilationUnit132: set["java_ImportDeclaration"] = None, java_CompilationUnit134: "java_Package" = None, java_CompilationUnit137: set["java_AbstractTypeDeclaration"] = None, java_CompilationUnit108: "java_ClassFile" = None, java_CompilationUnit242: "java_Model" = None):
        self.originalFilePath = originalFilePath
...
class java_Comment(ASTNode):
    ...
    def __init__(self, content: str, enclosedByParent: bool, prefixOfParent: bool, java_Comment18: "java_AbstractTypeDeclaration" = None, java_Comment41: "java_ASTNode" = None, java_Comment: "java_AbstractTypeDeclaration" = None, java_Comment130: "java_CompilationUnit" = None):
...
class java_Modifier(ASTNode):
    ...
    def __init__(self, visibility: str, inheritance: str, static: bool, transient: bool, strictfp: bool, synchronized: bool, volatile: bool, native: bool, Modifier: "java_BodyDeclaration" = None, modifier: "java_BodyDeclaration" = None, modifier252: "java_SingleVariableDeclaration" = None, modifier255: "java_VariableDeclarationStatement" = None, modifier257: "java_VariableDeclarationExpression" = None, Modifier355: "java_VariableDeclarationExpression" = None, Modifier360: "java_VariableDeclarationStatement" = None, Modifier294: "java_SingleVariableDeclaration" = None):
...
class java_NamedElement(ASTNode):
    ...
    def __init__(self, name: str, proxy: bool, NamedElement: "java_ImportDeclaration" = None, importedElement: set["java_ImportDeclaration"] = None, java_NamedElement: "java_MemberRef" = None):
        self.name = name
        self.proxy = proxy
...
class java_SingleVariableDeclaration(VariableDeclaration):
    ...
    def __init__(self, varargs: bool, SingleVariableDeclaration: "java_AbstractMethodDeclaration" = None, SingleVariableDeclaration152: "java_EnhancedForStatement" = None, SingleVariableDeclaration100: "java_CatchClause" = None, SingleVariableDeclaration253: "java_Modifier" = None, java_SingleVariableDeclaration: "java_TypeAccess" = None, java_SingleVariableDeclaration298: set["java_Annotation"] = None, parameters: "java_AbstractMethodDeclaration" = None, exception: "java_CatchClause" = None, parameter: "java_EnhancedForStatement" = None, singleVariableDeclaration: "java_Modifier" = None):
        self.varargs = varargs
