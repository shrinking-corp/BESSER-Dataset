...
class Account:
    ...
    def __init__(self, isClosed: bool, billingAddress: str, open: date, closed: date, p0: set["Payment"] = None, customer7: "Customer" = None, cart8: "ShoppingCart" = None, order16: set["Order"] = None):
