...
def test_hyp_dutycalls_view_instructions_has_Info():
    assert hasattr(dutycalls_view_Instructions, "Info")
    descriptor = None
    for klass in dutycalls_view_Instructions.__mro__:
...
@settings(max_examples=50)
def test_hyp_dutycalls_view_instructions_instantiation(instance):
    assert isinstance(instance, dutycalls_view_Instructions)



@given(instance=dutycalls_view_Instructions_strategy)
def test_hyp_dutycalls_view_instructions_Info_setter(instance):
