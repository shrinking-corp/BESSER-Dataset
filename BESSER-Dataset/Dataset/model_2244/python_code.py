...
class tdt4250case_ScheduledActivity:
    ...
    def __init__(self, timeslot: str, activity: str, room: str, tdt4250case_ScheduledActivity: "tdt4250case_Timetable" = None, tdt4250case_ScheduledActivity32: set["tdt4250case_Studyprogram"] = None):
...
class tdt4250case_CourseWork:
    ...
    def __init__(self, hours: int, type: str, tdt4250case_CourseWork: "tdt4250case_Course" = None):
        self.hours = hours
        self.type = type
...
class tdt4250case_CreditReductionCourse:
    ...
    def __init__(self, reduction: float, from_: date, to: date, tdt4250case_CreditReductionCourse13: "tdt4250case_Course" = None, tdt4250case_CreditReductionCourse: "tdt4250case_Course" = None):
...
class tdt4250case_Studyprogram:
    ...
    def __init__(self, code: str, studyprogram: set["tdt4250case_Course"] = None, Studyprogram: "tdt4250case_Course" = None, tdt4250case_Studyprogram: "tdt4250case_ScheduledActivity" = None):
        self.code = code
...
class tdt4250case_Course:
    ...
    def __init__(self, code: str, name: str, content: str, credits: float, tdt4250case_Course14: "tdt4250case_CreditReductionCourse" = None, Course: "tdt4250case_Studyprogram" = None, course: set["tdt4250case_Studyprogram"] = None, tdt4250case_Course: "tdt4250case_Course" = None, tdt4250case_Course1: set["tdt4250case_Course"] = None, tdt4250case_Course5: "tdt4250case_Course" = None, tdt4250case_Course3: set["tdt4250case_Course"] = None, tdt4250case_Course7: set["tdt4250case_CreditReductionCourse"] = None, course9: set["tdt4250case_CourseInstance"] = None, tdt4250case_Course11: set["tdt4250case_CourseWork"] = None, Course26: "tdt4250case_CourseInstance" = None):
        self.code = code
        self.name = name
...
class tdt4250case_Person:
    ...
    def __init__(self, username: str, name: str, tdt4250case_Person: "tdt4250case_CourseInstance" = None, person: set["tdt4250case_CourseRole"] = None, Person: "tdt4250case_CourseRole" = None, tdt4250case_Person35: "tdt4250case_Department" = None):
...
class tdt4250case_Department:
    ...
    def __init__(self, name: str, code: str, tdt4250case_Department: "tdt4250case_CourseInstance" = None, tdt4250case_Department34: set["tdt4250case_Person"] = None):
        self.name = name
        self.code = code
