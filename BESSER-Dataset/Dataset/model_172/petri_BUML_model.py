...
petri_EdgeToTransition = Class(name="petri_EdgeToTransition")
petri_EdgeToPlace = Class(name="petri_EdgeToPlace")
petri_Edge = Class(name="petri_Edge")
...
domain_model = DomainModel(
    name="petri",
    types={petri_PetriNet, petri_Transition, petri_Place, petri_EdgeToTransition, petri_EdgeToPlace, petri_Edge, Edge},
    associations={transitions0, places1, out3, out5, in_7, in_10},
    generalizations={gen_petri_EdgeToPlace_Edge, gen_petri_EdgeToTransition_Edge},
    metadata=None
)
