...
class petri_Place:
    ...
    def __init__(self, token: int, petri_Place: "petri_PetriNet" = None, petri_Place4: set["petri_EdgeToTransition"] = None, petri_Place9: "petri_EdgeToPlace" = None):
        self.token = token
...
class petri_Transition:
    ...
    def __init__(self, token: int, petri_Transition: "petri_PetriNet" = None, petri_Transition6: set["petri_EdgeToPlace"] = None, petri_Transition12: "petri_EdgeToTransition" = None):
        self.token = token
