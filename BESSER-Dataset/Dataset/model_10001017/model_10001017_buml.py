...
transaction_Class = Class(name="transaction_Class")
...
account_AccountManager = Class(name="account_AccountManager")
customerpackage_Customer = Class(name="customerpackage_Customer")
...
transaction_Transaction.attributes={transaction_Transaction_amount, transaction_Transaction_id, transaction_Transaction_type}
...
# transaction_Class class attributes and methods
...
account_Account.attributes={account_Account_balance, account_Account_type}

# account_AccountManager class attributes and methods
account_AccountManager_attribute: Property = Property(name="attribute", type=StringType)
account_AccountManager.attributes={account_AccountManager_attribute}

# customerpackage_Customer class attributes and methods
customerpackage_Customer_name: Property = Property(name="name", type=StringType)
customerpackage_Customer_dateOfBirth: Property = Property(name="dateOfBirth", type=DateType)
customerpackage_Customer_address: Property = Property(name="address", type=StringType)
customerpackage_Customer_phoneNumber: Property = Property(name="phoneNumber", type=StringType)
customerpackage_Customer_emailAddress: Property = Property(name="emailAddress", type=StringType)
customerpackage_Customer.attributes={customerpackage_Customer_emailAddress, customerpackage_Customer_dateOfBirth, customerpackage_Customer_phoneNumber, customerpackage_Customer_name, customerpackage_Customer_address}
...
Login.attributes={Login_password, Login_securityAnswer, Login_username, Login_securityQuestion, Login_lastLoginTime}
...
association2: BinaryAssociation = BinaryAssociation(
    name="association2",
    ends={
        Property(name="customer0", type=customerpackage_Customer, multiplicity=Multiplicity(1, 1)),
...
Customer_Login: BinaryAssociation = BinaryAssociation(
    ...
    ends={
        ...
        Property(name="customer5", type=customerpackage_Customer, multiplicity=Multiplicity(1, 1))
    }
)

# Domain Model
domain_model = DomainModel(
    name="_7b655562_7e73_46ea_a9b0_9ca23ab58102",
    types={transaction_Transaction, transaction_DepositTransaction, transaction_WithdrawTransaction, transaction_TransferTransaction, transaction_Class, account_SavingsAccount, account_CertificatesOfDepositAccount, account_CheckingAccount, account_Account, account_AccountManager, customerpackage_Customer, Login, NewClass, transaction_TransactionType, account_AccountType},
