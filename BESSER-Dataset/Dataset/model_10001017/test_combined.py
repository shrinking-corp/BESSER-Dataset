...
from python_code import (
    NewClass,
    Login,
    customerpackage_Customer,
    account_AccountManager,
    account_Account,
...
def test_hyp_customerpackage_customer_is_not_abstract():
    assert not inspect.isabstract(customerpackage_Customer)


def test_hyp_customerpackage_customer_constructor_exists():
    assert callable(customerpackage_Customer.__init__)


def test_hyp_customerpackage_customer_constructor_args():
    sig = inspect.signature(customerpackage_Customer.__init__)
    params = list(sig.parameters.keys())
...
def test_hyp_account_accountmanager_is_not_abstract():
    assert not inspect.isabstract(account_AccountManager)


def test_hyp_account_accountmanager_constructor_exists():
    assert callable(account_AccountManager.__init__)


def test_hyp_account_accountmanager_constructor_args():
    sig = inspect.signature(account_AccountManager.__init__)
    params = list(sig.parameters.keys())
...
def test_hyp_transaction_class_is_not_abstract():
    assert not inspect.isabstract(transaction_Class)


def test_hyp_transaction_class_constructor_exists():
    assert callable(transaction_Class.__init__)


def test_hyp_transaction_class_constructor_args():
    sig = inspect.signature(transaction_Class.__init__)
    params = list(sig.parameters.keys())
...
customerpackage_Customer_strategy = st.builds(
    customerpackage_Customer,
    phoneNumber=
        safe_text,
    name=
...
account_AccountManager_strategy = st.builds(
    account_AccountManager,
    attribute=
        safe_text
)
...
transaction_Class_strategy = st.builds(
    transaction_Class,
)
...
@given(instance=customerpackage_Customer_strategy)
def test_hyp_customerpackage_customer_phoneNumber_setter(instance):
...
@given(instance=customerpackage_Customer_strategy)
def test_hyp_customerpackage_customer_name_setter(instance):
...
@given(instance=customerpackage_Customer_strategy)
def test_hyp_customerpackage_customer_dateOfBirth_setter(instance):
...
@given(instance=customerpackage_Customer_strategy)
def test_hyp_customerpackage_customer_address_setter(instance):
...
@given(instance=customerpackage_Customer_strategy)
def test_hyp_customerpackage_customer_emailAddress_setter(instance):
...
@given(instance=account_AccountManager_strategy)
def test_hyp_account_accountmanager_attribute_setter(instance):
...
def test_account_AccountManager_attribute_value_roundtrip():
    instance = account_AccountManager(attribute="sample_text")
...
def test_customerpackage_Customer_address_value_roundtrip():
    instance = customerpackage_Customer(address="sample_text", dateOfBirth=date(2024, 1, 1), emailAddress="sample_text", name="sample_text", phoneNumber="sample_text")
    assert instance.address == "sample_text"
    instance.address = "sample_text_2"
    assert instance.address == "sample_text_2"


def test_customerpackage_Customer_dateOfBirth_value_roundtrip():
    instance = customerpackage_Customer(address="sample_text", dateOfBirth=date(2024, 1, 1), emailAddress="sample_text", name="sample_text", phoneNumber="sample_text")
...
def test_customerpackage_Customer_emailAddress_value_roundtrip():
    instance = customerpackage_Customer(address="sample_text", dateOfBirth=date(2024, 1, 1), emailAddress="sample_text", name="sample_text", phoneNumber="sample_text")
...
def test_customerpackage_Customer_name_value_roundtrip():
    instance = customerpackage_Customer(address="sample_text", dateOfBirth=date(2024, 1, 1), emailAddress="sample_text", name="sample_text", phoneNumber="sample_text")
...
def test_customerpackage_Customer_phoneNumber_value_roundtrip():
    instance = customerpackage_Customer(address="sample_text", dateOfBirth=date(2024, 1, 1), emailAddress="sample_text", name="sample_text", phoneNumber="sample_text")
...
def test_assoc_Customer_Login_link_reassign_clear():
    a = customerpackage_Customer(address="sample_text", dateOfBirth=date(2024, 1, 1), emailAddress="sample_text", name="sample_text", phoneNumber="sample_text")
...
account_AccountManager_strategy = st.builds(account_AccountManager, attribute=safe_text)
@given(instance=account_AccountManager_strategy)
@settings(max_examples=25)
def test_account_AccountManager_instantiation(instance):
    assert isinstance(instance, account_AccountManager)
...
customerpackage_Customer_strategy = st.builds(customerpackage_Customer, address=safe_text, dateOfBirth=st.dates(), emailAddress=safe_text, name=safe_text, phoneNumber=safe_text)
@given(instance=customerpackage_Customer_strategy)
@settings(max_examples=25)
def test_customerpackage_Customer_instantiation(instance):
    assert isinstance(instance, customerpackage_Customer)


transaction_Class_strategy = st.builds(transaction_Class)
@given(instance=transaction_Class_strategy)
@settings(max_examples=25)
def test_transaction_Class_instantiation(instance):
    assert isinstance(instance, transaction_Class)
