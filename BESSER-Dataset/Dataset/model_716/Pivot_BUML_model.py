...
pivot_Property.attributes={pivot_Property_isDerived, pivot_Property_isUnsettable, pivot_Property_defaultValueString, pivot_Property_isImplicit, pivot_Property_isComposite, pivot_Property_isResolveProxies, pivot_Property_isTransient, pivot_Property_isID, pivot_Property_defaultValue, pivot_Property_isReadOnly, pivot_Property_isVolatile}
...
pivot_BooleanLiteralExp_m_validateTypeIsBoolean: Method = Method(name="validateTypeIsBoolean", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_Operation_m_validateUniquePreconditionName: Method = Method(name="validateUniquePreconditionName", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_Operation.attributes={pivot_Operation_isValidating, pivot_Operation_isInvalidating, pivot_Operation_isTypeof}
pivot_Operation.methods={pivot_Operation_m_validateCompatibleReturn, pivot_Operation_m_validateLoadableImplementation, pivot_Operation_m_validateUniquePreconditionName, pivot_Operation_m_validateUniquePostconditionName}
...
pivot_Class.attributes={pivot_Class_isActive, pivot_Class_instanceClassName, pivot_Class_isAbstract, pivot_Class_isInterface}
...
pivot_Constraint_m_validateUniqueName: Method = Method(name="validateUniqueName", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_CallExp_m_validateTypeIsNotInvalid: Method = Method(name="validateTypeIsNotInvalid", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_CollectionType.attributes={pivot_CollectionType_isNullFree, pivot_CollectionType_upper, pivot_CollectionType_lower}
...
pivot_CollectionLiteralPart_m_validateTypeIsNotInvalid: Method = Method(name="validateTypeIsNotInvalid", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_State.attributes={pivot_State_isOrthogonal, pivot_State_isComposite, pivot_State_isSubmachineState, pivot_State_isSimple}
...
pivot_EnumLiteralExp_m_validateTypeIsEnumerationType: Method = Method(name="validateTypeIsEnumerationType", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_Feature.attributes={pivot_Feature_implementation, pivot_Feature_isStatic, pivot_Feature_implementationClass}
...
pivot_IterateExp_m_validateSafeSourceCanBeNull: Method = Method(name="validateSafeSourceCanBeNull", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_IteratorExp_m_validateClosureHasOneIterator: Method = Method(name="validateClosureHasOneIterator", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_IteratorExp_m_validateClosureSourceElementTypeIsBodyElementType: Method = Method(name="validateClosureSourceElementTypeIsBodyElementType", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_IteratorExp_m_validateCollectElementTypeIsFlattenedBodyType: Method = Method(name="validateCollectElementTypeIsFlattenedBodyType", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_IteratorExp_m_validateClosureBodyTypeIsConformanttoIteratorType: Method = Method(name="validateClosureBodyTypeIsConformanttoIteratorType", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_IteratorExp_m_validateSafeIteratorIsRequired: Method = Method(name="validateSafeIteratorIsRequired", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_IteratorExp_m_validateSortedByElementTypeIsSourceElementType: Method = Method(name="validateSortedByElementTypeIsSourceElementType", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_IteratorExp.methods={pivot_IteratorExp_m_validateClosureHasOneIterator, pivot_IteratorExp_m_validateSortedByIsOrderedIfSourceIsOrdered, pivot_IteratorExp_m_validateClosureSourceElementTypeIsBodyElementType, pivot_IteratorExp_m_validateSortedByIteratorTypeIsComparable, pivot_IteratorExp_m_validateSortedByElementTypeIsSourceElementType, pivot_IteratorExp_m_validateAnyBodyTypeIsBoolean, pivot_IteratorExp_m_validateClosureElementTypeIsSourceElementType, pivot_IteratorExp_m_validateClosureBodyTypeIsConformanttoIteratorType, pivot_IteratorExp_m_validateIteratorTypeIsSourceElementType, pivot_IteratorExp_m_validateSafeIteratorIsRequired, pivot_IteratorExp_m_validateSafeSourceCanBeNull, pivot_IteratorExp_m_validateCollectElementTypeIsFlattenedBodyType, pivot_IteratorExp_m_validateClosureTypeIsUniqueCollection, pivot_IteratorExp_m_validateAnyTypeIsSourceElementType, pivot_IteratorExp_m_validateCollectTypeIsUnordered, pivot_IteratorExp_m_validateUnsafeSourceCanNotBeNull, pivot_IteratorExp_m_validateAnyHasOneIterator}
...
pivot_LetExp_m_validateTypeIsInType: Method = Method(name="validateTypeIsInType", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_LoopExp_m_validateSourceIsCollection: Method = Method(name="validateSourceIsCollection", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
...
pivot_OperationCallExp_m_validateSafeSourceCanBeNull: Method = Method(name="validateSafeSourceCanBeNull", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
pivot_OperationCallExp.attributes={pivot_OperationCallExp_isVirtual}
pivot_OperationCallExp.methods={pivot_OperationCallExp_m_validateArgumentTypeIsConformant, pivot_OperationCallExp_m_validateSafeSourceCanBeNull, pivot_OperationCallExp_m_validateArgumentCount}
...
pivot_PropertyCallExp_m_validateCompatibleResultType: Method = Method(name="validateCompatibleResultType", parameters={Parameter(name='pivot_diagnostics', type=StringType), Parameter(name='pivot_context', type=StringType)}, type=BooleanType)
pivot_PropertyCallExp_m_validateNonStaticSourceTypeIsConformant: Method = Method(name="validateNonStaticSourceTypeIsConformant", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_PropertyCallExp.methods={pivot_PropertyCallExp_m_getSpecializedReferredPropertyType, pivot_PropertyCallExp_m_validateCompatibleResultType, pivot_PropertyCallExp_m_getSpecializedReferredPropertyOwningType, pivot_PropertyCallExp_m_validateUnsafeSourceCanNotBeNull, pivot_PropertyCallExp_m_validateNonStaticSourceTypeIsConformant, pivot_PropertyCallExp_m_validateSafeSourceCanBeNull}
...
pivot_SelfType_m_specializeIn: Method = Method(name="specializeIn", parameters={Parameter(name='pivot_expr', type=StringType), Parameter(name='pivot_selfType', type=StringType)}, type=Type)
...
pivot_ShadowExp_m_validateTypeIsNotInvalid: Method = Method(name="validateTypeIsNotInvalid", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_ShadowPart_m_validateTypeIsNotInvalid: Method = Method(name="validateTypeIsNotInvalid", parameters={Parameter(name='pivot_context', type=StringType), Parameter(name='pivot_diagnostics', type=StringType)}, type=BooleanType)
...
pivot_ValueSpecification.methods={pivot_ValueSpecification_m_booleanValue, pivot_ValueSpecification_m_isNull, pivot_ValueSpecification_m_unlimitedValue, pivot_ValueSpecification_m_isComputable, pivot_ValueSpecification_m_stringValue, pivot_ValueSpecification_m_integerValue}
...
domain_model = DomainModel(
    name="pivot",
    types={pivot_Annotation, NamedElement, pivot_Element, pivot_Detail, pivot_AnyType, Class_, pivot_AssociationClass, pivot_Property, pivot_AssociationClassCallExp, NavigationCallExp, pivot_BagType, CollectionType, pivot_Behavior, pivot_Transition, pivot_BooleanLiteralExp, PrimitiveLiteralExp, pivot_OCLExpression, pivot_CallOperationAction, pivot_Operation, pivot_Class, Type, Namespace, TemplateableElement, pivot_StereotypeExtender, pivot_Constraint, pivot_CallExp, OCLExpression, pivot_CollectionLiteralExp, LiteralExp, pivot_Package, pivot_CollectionItem, CollectionLiteralPart, pivot_CollectionRange, pivot_CollectionType, DataType, pivot_Type, pivot_Comment, Element, pivot_CollectionLiteralPart, TypedElement, pivot_OrphanCompletePackage, pivot_Model, pivot_PrimitiveCompletePackage, pivot_ConnectionPointReference, Vertex, pivot_Pseudostate, pivot_CompleteClass, pivot_CompletePackage, pivot_CompleteEnvironment, pivot_CompleteModel, pivot_StandardLibrary, pivot_Namespace, pivot_LanguageExpression, pivot_DataType, pivot_DynamicBehavior, Behavior, DynamicType, pivot_DynamicElement, pivot_State, Visitable, pivot_ElementExtension, pivot_Stereotype, pivot_EnumLiteralExp, pivot_EnumerationLiteral, pivot_DynamicProperty, pivot_DynamicType, DynamicElement, pivot_DynamicValueSpecification, ValueSpecification, pivot_ExpressionInOCL, LanguageExpression, pivot_Variable, pivot_Feature, pivot_FeatureCallExp, CallExp, pivot_FinalState, State, pivot_IfExp, pivot_Enumeration, InstanceSpecification, pivot_InstanceSpecification, pivot_Slot, pivot_IntegerLiteralExp, NumericLiteralExp, pivot_InvalidLiteralExp, pivot_InvalidType, pivot_IterateExp, pivot_Import, pivot_Iteration, Operation, pivot_Parameter, pivot_IteratorExp, LoopExp, ReferringElement, pivot_LambdaType, pivot_LetExp, pivot_Library, Package, pivot_Precedence, pivot_LiteralExp, pivot_LoopExp, pivot_MapLiteralExp, pivot_MapLiteralPart, pivot_MapType, pivot_MessageExp, pivot_SendSignalAction, pivot_MessageType, pivot_Signal, pivot_MorePivotable, pivot_Nameable, pivot_NamedElement, Nameable, pivot_NavigationCallExp, FeatureCallExp, pivot_NullLiteralExp, pivot_NumericLiteralExp, Feature, pivot_OperationCallExp, pivot_OppositePropertyCallExp, pivot_OrderedSetType, CompletePackage, pivot_ProfileApplication, VariableDeclaration, pivot_Pivotable, pivot_PrimitiveLiteralExp, pivot_PrimitiveType, pivot_Profile, pivot_PropertyCallExp, pivot_StateMachine, pivot_RealLiteralExp, pivot_ReferringElement, pivot_Region, pivot_Vertex, pivot_SelfType, pivot_SequenceType, pivot_SetType, pivot_ShadowExp, pivot_ShadowPart, pivot_ValueSpecification, pivot_Trigger, pivot_StateExp, pivot_StringLiteralExp, pivot_TemplateBinding, pivot_TemplateParameterSubstitution, pivot_TemplateableElement, pivot_TemplateSignature, pivot_TemplateParameter, pivot_WildcardType, pivot_TupleLiteralExp, pivot_TupleLiteralPart, pivot_TupleType, pivot_TypeExp, pivot_TypedElement, pivot_UnlimitedNaturalLiteralExp, pivot_UnspecifiedValueExp, pivot_VariableDeclaration, pivot_VariableExp, pivot_Visitable, pivot_VoidType, AssociativityKind, CollectionKind, PseudostateKind, TransitionKind},
    associations={ownedContents0, ownedDetails1, references3, unownedAttributes6, referredAssociationClass7, owningTransition8, ownedSource9, operation10, extenders11, ownedBehaviors12, ownedInvariants13, ownedOperations15, ownedItem23, ownedProperties16, owningPackage19, superClasses21, ownedFirst26, ownedLast28, elementType31, annotatedElements32, ownedParts25, orphanCompletePackage41, ownedCompletePackages42, owningCompleteEnvironment44, partialModels45, primitiveCompletePackage47, ownedCompleteClasses49, ownedCompletePackages51, owningCompleteModel54, owningCompletePackage57, partialPackages60, entries61, exits62, owningElement33, owningCompletePackage35, partialClasses36, ownedCompleteModel38, ownedStandardLibrary39, constrainedElements66, context69, ownedSpecification71, owningPostContext72, owningPreContext74, owningState76, owningTransition78, redefinedConstraints81, behavioralClass83, owningState65, annotatingComments90, ownedAnnotations92, ownedComments94, ownedExtensions96, base97, stereotype99, referredLiteral100, metaType85, referredProperty87, ownedDynamicProperties88, ownedBody103, ownedContext105, ownedParameters107, ownedResult110, ownedLiterals101, owningEnumeration102, importedNamespace121, classes123, ownedSlots125, ownedSpecification126, owningPackage128, ownedCondition113, ownedElse115, ownedThen118, ownedResult130, ownedAccumulators132, ownedIterators133, contextType136, parameterType138, resultType141, owningConstraint144, ownedIn145, ownedVariable147, ownedPrecedences150, ownedBody151, ownedIterators153, referredIteration156, ownedParts159, ownedKey160, ownedValue163, keyType166, valueType168, ownedArguments171, ownedCalledOperation173, ownedSentSignal176, ownedTarget178, referredOperation181, referredSignal183, ownedImports185, ownedPackages188, ownedConstraints191, navigationSource194, qualifiers196, bodyExpression202, ownedParameters205, ownedPostconditions206, ownedPreconditions208, owningClass210, precedence211, raisedExceptions214, typeValue199, redefinedOperations218, ownedArguments220, referredOperation222, referredProperty225, importedPackages228, ownedClasses230, ownedInstances232, ownedProfileApplications238, owningPackage241, owningOperation243, coercions245, profileApplications247, appliedProfile249, owningPackage250, ownedPackages235, associationClass252, keys254, opposite257, ownedExpression259, owningClass262, redefinedProperties265, referredProperty268, subsettedProperty271, referredProperty273, owningState275, owningStateMachine277, extendedRegion280, ownedSubvertexes281, ownedTransitions282, owningState285, owningStateMachine287, signal290, ownedParts293, ownedInit294, referredProperty297, ownedValues302, owningInstance304, owningCompleteEnvironment306, ownedConnectionPoints308, ownedConnections309, ownedDeferrableTriggers311, ownedDoActivity313, ownedEntry315, definingProperty300, ownedExit318, ownedRegions321, ownedStateInvariant323, redefinedState327, submachines329, referredState331, extendedStateMachines334, ownedConnectionPoints335, ownedRegions337, submachineStates340, ownedExtenders342, class_344, owningStereotype346, ownedSubstitutions347, owningElement348, templateSignature349, constrainingClasses350, owningSignature352, actual354, formal356, ownedWildcard359, owningBinding361, ownedParameters362, owningElement363, ownedSignature368, unspecializedElement372, ownedEffect373, ownedGuard374, ownedTriggers377, owningRegion380, source382, target384, owningState386, owningTransition388, ownedParts390, ownedInit391, ownedBindings365, referredType394, type396, ownedInit398, representedParameter401, typeValue404, referredVariable406, incomingTransitions408, outgoingTransitions410, owningRegion412, lowerBound414, upperBound417},
    generalizations={gen_pivot_Annotation_NamedElement, gen_pivot_AnyType_Class, gen_pivot_AssociationClass_Class, gen_pivot_AssociationClassCallExp_NavigationCallExp, gen_pivot_BagType_CollectionType, gen_pivot_Behavior_Class, gen_pivot_BooleanLiteralExp_PrimitiveLiteralExp, gen_pivot_CallOperationAction_NamedElement, gen_pivot_Class_Type, gen_pivot_Class_Namespace, gen_pivot_Class_TemplateableElement, gen_pivot_CallExp_OCLExpression, gen_pivot_CollectionLiteralExp_LiteralExp, gen_pivot_CollectionItem_CollectionLiteralPart, gen_pivot_CollectionRange_CollectionLiteralPart, gen_pivot_CollectionType_DataType, gen_pivot_Comment_Element, gen_pivot_CollectionLiteralPart_TypedElement, gen_pivot_CompleteModel_NamedElement, gen_pivot_CompletePackage_NamedElement, gen_pivot_ConnectionPointReference_Vertex, gen_pivot_CompleteClass_NamedElement, gen_pivot_CompleteEnvironment_Element, gen_pivot_DataType_Class, gen_pivot_Detail_NamedElement, gen_pivot_DynamicBehavior_Behavior, gen_pivot_DynamicBehavior_DynamicType, gen_pivot_DynamicElement_Element, gen_pivot_Constraint_NamedElement, gen_pivot_DynamicValueSpecification_ValueSpecification, gen_pivot_Element_Visitable, gen_pivot_ElementExtension_Class, gen_pivot_EnumLiteralExp_LiteralExp, gen_pivot_DynamicProperty_Element, gen_pivot_DynamicType_Class, gen_pivot_DynamicType_DynamicElement, gen_pivot_ExpressionInOCL_LanguageExpression, gen_pivot_Feature_TypedElement, gen_pivot_FeatureCallExp_CallExp, gen_pivot_FinalState_State, gen_pivot_IfExp_OCLExpression, gen_pivot_Enumeration_DataType, gen_pivot_EnumerationLiteral_InstanceSpecification, gen_pivot_InstanceSpecification_NamedElement, gen_pivot_IntegerLiteralExp_NumericLiteralExp, gen_pivot_InvalidLiteralExp_LiteralExp, gen_pivot_InvalidType_Class, gen_pivot_Import_NamedElement, gen_pivot_Iteration_Operation, gen_pivot_IteratorExp_LoopExp, gen_pivot_IteratorExp_ReferringElement, gen_pivot_IterateExp_LoopExp, gen_pivot_IterateExp_ReferringElement, gen_pivot_LambdaType_DataType, gen_pivot_LanguageExpression_ValueSpecification, gen_pivot_LetExp_OCLExpression, gen_pivot_Library_Package, gen_pivot_LiteralExp_OCLExpression, gen_pivot_LoopExp_CallExp, gen_pivot_MapLiteralExp_LiteralExp, gen_pivot_MapLiteralPart_Element, gen_pivot_MapType_DataType, gen_pivot_MessageExp_OCLExpression, gen_pivot_MessageType_Class, gen_pivot_Model_Namespace, gen_pivot_NamedElement_Element, gen_pivot_NamedElement_Nameable, gen_pivot_Namespace_NamedElement, gen_pivot_NavigationCallExp_FeatureCallExp, gen_pivot_NullLiteralExp_PrimitiveLiteralExp, gen_pivot_NumericLiteralExp_PrimitiveLiteralExp, gen_pivot_OCLExpression_TypedElement, gen_pivot_Operation_Feature, gen_pivot_Operation_Namespace, gen_pivot_Operation_TemplateableElement, gen_pivot_OperationCallExp_FeatureCallExp, gen_pivot_OperationCallExp_ReferringElement, gen_pivot_OppositePropertyCallExp_NavigationCallExp, gen_pivot_OrderedSetType_CollectionType, gen_pivot_OrphanCompletePackage_CompletePackage, gen_pivot_Package_Namespace, gen_pivot_Parameter_VariableDeclaration, gen_pivot_Precedence_NamedElement, gen_pivot_PrimitiveCompletePackage_CompletePackage, gen_pivot_PrimitiveLiteralExp_LiteralExp, gen_pivot_PrimitiveType_DataType, gen_pivot_Profile_Package, gen_pivot_ProfileApplication_Element, gen_pivot_Property_Feature, gen_pivot_PropertyCallExp_NavigationCallExp, gen_pivot_PropertyCallExp_ReferringElement, gen_pivot_Pseudostate_Vertex, gen_pivot_RealLiteralExp_NumericLiteralExp, gen_pivot_Region_Namespace, gen_pivot_SelfType_Class, gen_pivot_SendSignalAction_NamedElement, gen_pivot_SequenceType_CollectionType, gen_pivot_SetType_CollectionType, gen_pivot_ShadowExp_OCLExpression, gen_pivot_ShadowPart_TypedElement, gen_pivot_StandardLibrary_Element, gen_pivot_State_Namespace, gen_pivot_State_Vertex, gen_pivot_Signal_Class, gen_pivot_Slot_Element, gen_pivot_StateExp_OCLExpression, gen_pivot_StateMachine_Behavior, gen_pivot_StereotypeExtender_Element, gen_pivot_StringLiteralExp_PrimitiveLiteralExp, gen_pivot_TemplateBinding_Element, gen_pivot_TemplateParameter_Type, gen_pivot_TemplateParameterSubstitution_Element, gen_pivot_Stereotype_Class, gen_pivot_TemplateSignature_Element, gen_pivot_TemplateableElement_Element, gen_pivot_Transition_Namespace, gen_pivot_Trigger_NamedElement, gen_pivot_TupleLiteralExp_LiteralExp, gen_pivot_TupleLiteralPart_VariableDeclaration, gen_pivot_TupleType_DataType, gen_pivot_Type_NamedElement, gen_pivot_TypeExp_OCLExpression, gen_pivot_TypeExp_ReferringElement, gen_pivot_TypedElement_NamedElement, gen_pivot_UnlimitedNaturalLiteralExp_NumericLiteralExp, gen_pivot_UnspecifiedValueExp_OCLExpression, gen_pivot_ValueSpecification_TypedElement, gen_pivot_Variable_VariableDeclaration, gen_pivot_VariableDeclaration_TypedElement, gen_pivot_VariableExp_OCLExpression, gen_pivot_VariableExp_ReferringElement, gen_pivot_Vertex_NamedElement, gen_pivot_VoidType_Class, gen_pivot_WildcardType_Class},
    metadata=None
)
