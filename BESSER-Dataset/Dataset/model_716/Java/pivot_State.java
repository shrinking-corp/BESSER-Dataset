...
public class pivot_State extends Vertex, Namespace {
    ...
    public pivot_State(
        String isSimple,        String isSubmachineState,        String isOrthogonal,        String isComposite    ) {
        super(
        );
    ...
    public pivot_State(
        String isSimple,        String isSubmachineState,        String isOrthogonal,        String isComposite        ArrayList<pivot_Region> pivot_regions,        ArrayList<pivot_Trigger> pivot_triggers    ) {
        this.isSimple = isSimple;
        this.isSubmachineState = isSubmachineState;
        this.isOrthogonal = isOrthogonal;
        this.isComposite = isComposite;
