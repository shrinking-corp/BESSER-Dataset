...
Class__test: Property = Property(name="test", type=StringType)
Class__attribute: Property = Property(name="attribute", type=StringType)
Class_.attributes={Class__test, Class__attribute}
...
domain_model = DomainModel(
    name="_3188213f_2fc0_4803_b215_477c5c97450f",
    types={CPU, Processor, AcceleratorCard, Cache, RAM, Machine, Program, Instruction, Memory_Interface, DeviceCard, Card, Sound, GenericSound, Vendor1Adapter, Vendor2Adapter, Vendor1Sound, Vendor2Sound, ExtensionBoard, FastCard, Class_},
    associations={Program_Instruction, Machine_Processor, Machine_Memory, Processor_Memory, Processor_Program, Cache_RAM, ExtensionBoard_Card, Vendor1Adapter_Vendor1Sound, Vendor2Adapter_Vendor2Sound, Machine_Card, AcceleratorCard_CPU},
    generalizations={},
    metadata=None
)
