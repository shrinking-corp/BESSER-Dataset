...
@given(instance=Class_strategy)
def test_hyp_class_test_setter(instance):
...
def test_Class_attribute_value_roundtrip():
    instance = Class(attribute="sample_text", test="sample_text")
    assert instance.attribute == "sample_text"
    instance.attribute = "sample_text_2"
    assert instance.attribute == "sample_text_2"


def test_Class_test_value_roundtrip():
    instance = Class(attribute="sample_text", test="sample_text")
...
Class_strategy = st.builds(Class, attribute=safe_text, test=safe_text)
@given(instance=Class_strategy)
@settings(max_examples=25)
