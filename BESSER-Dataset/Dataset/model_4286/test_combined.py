...
def test_hyp_pokerleague_competition_constructor_args():
    ...
    assert "defaultTournamentInvitationContact" in params, "Missing parameter 'defaultTournamentInvitationContact'"
    ...
    assert "defaultTournamentInvitationClosure" in params, "Missing parameter 'defaultTournamentInvitationClosure'"
...
def test_hyp_pokerleague_tournament_constructor_args():
    ...
    assert "tournamentInvitationClosure" in params, "Missing parameter 'tournamentInvitationClosure'"
    assert "defaultBuyIn" in params, "Missing parameter 'defaultBuyIn'"
    assert "tournamentInvitationContact" in params, "Missing parameter 'tournamentInvitationContact'"
...
def test_hyp_pokerleague_settings_constructor_args():
    ...
    params = list(sig.parameters.keys())
    assert "smtpUser" in params, "Missing parameter 'smtpUser'"
    assert "adminPassword" in params, "Missing parameter 'adminPassword'"
    assert "smtpPassword" in params, "Missing parameter 'smtpPassword'"
    assert "defaultTimeZone" in params, "Missing parameter 'defaultTimeZone'"
    assert "smtpFrom" in params, "Missing parameter 'smtpFrom'"
    assert "smtpPort" in params, "Missing parameter 'smtpPort'"
    assert "id" in params, "Missing parameter 'id'"
    assert "urlBase" in params, "Missing parameter 'urlBase'"
...
@given(instance=pokerleague_Competition_strategy)
def test_hyp_pokerleague_competition_defaultTournamentInvitationContact_setter(instance):
    original = instance.defaultTournamentInvitationContact
    instance.defaultTournamentInvitationContact = original
    assert instance.defaultTournamentInvitationContact == original
...
@given(instance=pokerleague_Competition_strategy)
def test_hyp_pokerleague_competition_defaultTournamentInvitationClosure_setter(instance):
    original = instance.defaultTournamentInvitationClosure
    instance.defaultTournamentInvitationClosure = original
    assert instance.defaultTournamentInvitationClosure == original
...
@given(instance=pokerleague_Tournament_strategy)
def test_hyp_pokerleague_tournament_tournamentInvitationClosure_setter(instance):
    original = instance.tournamentInvitationClosure
    instance.tournamentInvitationClosure = original
    assert instance.tournamentInvitationClosure == original
...
@given(instance=pokerleague_Tournament_strategy)
def test_hyp_pokerleague_tournament_tournamentInvitationContact_setter(instance):
    original = instance.tournamentInvitationContact
    instance.tournamentInvitationContact = original
    assert instance.tournamentInvitationContact == original
...
def test_hyp_pokerleague_settings_smtpUser_setter(instance):
    original = instance.smtpUser
    instance.smtpUser = original
    assert instance.smtpUser == original
...
@given(instance=pokerleague_Settings_strategy)
def test_hyp_pokerleague_settings_smtpPassword_setter(instance):
    original = instance.smtpPassword
    instance.smtpPassword = original
    assert instance.smtpPassword == original
...
@given(instance=pokerleague_Settings_strategy)
def test_hyp_pokerleague_settings_smtpFrom_setter(instance):
    original = instance.smtpFrom
    instance.smtpFrom = original
    assert instance.smtpFrom == original



@given(instance=pokerleague_Settings_strategy)
def test_hyp_pokerleague_settings_smtpPort_setter(instance):
...
@given(instance=pokerleague_Settings_strategy)
def test_hyp_pokerleague_settings_urlBase_setter(instance):
    original = instance.urlBase
    instance.urlBase = original
    assert instance.urlBase == original



@given(instance=pokerleague_Settings_strategy)
def test_hyp_pokerleague_settings_smtpHost_setter(instance):
...
def test_pokerleague_Competition_defaultBuyIn_value_roundtrip():
    instance = pokerleague_Competition(defaultBuyIn=7, defaultMaxPlayers=7, defaultMinPlayers=7, defaultTournamentAnnouncementLead=7, defaultTournamentInvitationClosure=7, defaultTournamentInvitationContact="sample_text", endDate=date(2024, 1, 1), minimalAttendance=7, startDate=date(2024, 1, 1))
...
def test_pokerleague_Competition_defaultTournamentInvitationClosure_value_roundtrip():
    instance = pokerleague_Competition(defaultBuyIn=7, defaultMaxPlayers=7, defaultMinPlayers=7, defaultTournamentAnnouncementLead=7, defaultTournamentInvitationClosure=7, defaultTournamentInvitationContact="sample_text", endDate=date(2024, 1, 1), minimalAttendance=7, startDate=date(2024, 1, 1))
    assert instance.defaultTournamentInvitationClosure == 7
    instance.defaultTournamentInvitationClosure = 13
    assert instance.defaultTournamentInvitationClosure == 13


def test_pokerleague_Competition_defaultTournamentInvitationContact_value_roundtrip():
    instance = pokerleague_Competition(defaultBuyIn=7, defaultMaxPlayers=7, defaultMinPlayers=7, defaultTournamentAnnouncementLead=7, defaultTournamentInvitationClosure=7, defaultTournamentInvitationContact="sample_text", endDate=date(2024, 1, 1), minimalAttendance=7, startDate=date(2024, 1, 1))
    assert instance.defaultTournamentInvitationContact == "sample_text"
    instance.defaultTournamentInvitationContact = "sample_text_2"
    assert instance.defaultTournamentInvitationContact == "sample_text_2"
...
def test_pokerleague_Settings_adminPassword_value_roundtrip():
    instance = pokerleague_Settings(adminPassword="sample_text", defaultTimeZone="sample_text", id=7, smtpFrom="sample_text", smtpHost="sample_text", smtpPassword="sample_text", smtpPort="sample_text", smtpUser="sample_text", urlBase="sample_text")
...
def test_pokerleague_Settings_smtpFrom_value_roundtrip():
    instance = pokerleague_Settings(adminPassword="sample_text", defaultTimeZone="sample_text", id=7, smtpFrom="sample_text", smtpHost="sample_text", smtpPassword="sample_text", smtpPort="sample_text", smtpUser="sample_text", urlBase="sample_text")
    assert instance.smtpFrom == "sample_text"
    instance.smtpFrom = "sample_text_2"
    assert instance.smtpFrom == "sample_text_2"


def test_pokerleague_Settings_smtpHost_value_roundtrip():
    instance = pokerleague_Settings(adminPassword="sample_text", defaultTimeZone="sample_text", id=7, smtpFrom="sample_text", smtpHost="sample_text", smtpPassword="sample_text", smtpPort="sample_text", smtpUser="sample_text", urlBase="sample_text")
...
def test_pokerleague_Settings_smtpPassword_value_roundtrip():
    instance = pokerleague_Settings(adminPassword="sample_text", defaultTimeZone="sample_text", id=7, smtpFrom="sample_text", smtpHost="sample_text", smtpPassword="sample_text", smtpPort="sample_text", smtpUser="sample_text", urlBase="sample_text")
    assert instance.smtpPassword == "sample_text"
    instance.smtpPassword = "sample_text_2"
    assert instance.smtpPassword == "sample_text_2"


def test_pokerleague_Settings_smtpPort_value_roundtrip():
    instance = pokerleague_Settings(adminPassword="sample_text", defaultTimeZone="sample_text", id=7, smtpFrom="sample_text", smtpHost="sample_text", smtpPassword="sample_text", smtpPort="sample_text", smtpUser="sample_text", urlBase="sample_text")
...
def test_pokerleague_Settings_smtpUser_value_roundtrip():
    instance = pokerleague_Settings(adminPassword="sample_text", defaultTimeZone="sample_text", id=7, smtpFrom="sample_text", smtpHost="sample_text", smtpPassword="sample_text", smtpPort="sample_text", smtpUser="sample_text", urlBase="sample_text")
    assert instance.smtpUser == "sample_text"
    instance.smtpUser = "sample_text_2"
    assert instance.smtpUser == "sample_text_2"


def test_pokerleague_Settings_urlBase_value_roundtrip():
    instance = pokerleague_Settings(adminPassword="sample_text", defaultTimeZone="sample_text", id=7, smtpFrom="sample_text", smtpHost="sample_text", smtpPassword="sample_text", smtpPort="sample_text", smtpUser="sample_text", urlBase="sample_text")
    assert instance.urlBase == "sample_text"
    instance.urlBase = "sample_text_2"
    assert instance.urlBase == "sample_text_2"


def test_pokerleague_Tournament_defaultBuyIn_value_roundtrip():
    instance = pokerleague_Tournament(defaultBuyIn=7, maxPlayers=7, minPlayers=7, tournamentAnnouncementLead=7, tournamentEnd="sample_text", tournamentInvitationClosure=7, tournamentInvitationContact="sample_text", tournamentStart="sample_text")
    assert instance.defaultBuyIn == 7
    instance.defaultBuyIn = 13
    assert instance.defaultBuyIn == 13
...
def test_pokerleague_Tournament_tournamentInvitationClosure_value_roundtrip():
    instance = pokerleague_Tournament(defaultBuyIn=7, maxPlayers=7, minPlayers=7, tournamentAnnouncementLead=7, tournamentEnd="sample_text", tournamentInvitationClosure=7, tournamentInvitationContact="sample_text", tournamentStart="sample_text")
    assert instance.tournamentInvitationClosure == 7
    instance.tournamentInvitationClosure = 13
    assert instance.tournamentInvitationClosure == 13


def test_pokerleague_Tournament_tournamentInvitationContact_value_roundtrip():
    instance = pokerleague_Tournament(defaultBuyIn=7, maxPlayers=7, minPlayers=7, tournamentAnnouncementLead=7, tournamentEnd="sample_text", tournamentInvitationClosure=7, tournamentInvitationContact="sample_text", tournamentStart="sample_text")
    assert instance.tournamentInvitationContact == "sample_text"
    instance.tournamentInvitationContact = "sample_text_2"
    assert instance.tournamentInvitationContact == "sample_text_2"
...
def test_assoc_competition12_link_reassign_clear():
    a = pokerleague_Tournament(defaultBuyIn=7, maxPlayers=7, minPlayers=7, tournamentAnnouncementLead=7, tournamentEnd="sample_text", tournamentInvitationClosure=7, tournamentInvitationContact="sample_text", tournamentStart="sample_text")
    b1 = pokerleague_Competition(defaultBuyIn=7, defaultMaxPlayers=7, defaultMinPlayers=7, defaultTournamentAnnouncementLead=7, defaultTournamentInvitationClosure=7, defaultTournamentInvitationContact="sample_text", endDate=date(2024, 1, 1), minimalAttendance=7, startDate=date(2024, 1, 1))
    b2 = pokerleague_Competition(defaultBuyIn=13, defaultMaxPlayers=13, defaultMinPlayers=13, defaultTournamentAnnouncementLead=13, defaultTournamentInvitationClosure=13, defaultTournamentInvitationContact="sample_text_2", endDate=date(2025, 6, 15), minimalAttendance=13, startDate=date(2025, 6, 15))
...
def test_assoc_defaultPrizeMoneyRuleSet5_link_reassign_clear():
    a = pokerleague_Competition(defaultBuyIn=7, defaultMaxPlayers=7, defaultMinPlayers=7, defaultTournamentAnnouncementLead=7, defaultTournamentInvitationClosure=7, defaultTournamentInvitationContact="sample_text", endDate=date(2024, 1, 1), minimalAttendance=7, startDate=date(2024, 1, 1))
...
pokerleague_Competition_strategy = st.builds(pokerleague_Competition, defaultBuyIn=st.integers(), defaultMaxPlayers=st.integers(), defaultMinPlayers=st.integers(), defaultTournamentAnnouncementLead=st.integers(), defaultTournamentInvitationClosure=st.integers(), defaultTournamentInvitationContact=safe_text, endDate=st.dates(), minimalAttendance=st.integers(), startDate=st.dates())
@given(instance=pokerleague_Competition_strategy)
@settings(max_examples=25)
...
pokerleague_Settings_strategy = st.builds(pokerleague_Settings, adminPassword=safe_text, defaultTimeZone=safe_text, id=st.integers(), smtpFrom=safe_text, smtpHost=safe_text, smtpPassword=safe_text, smtpPort=safe_text, smtpUser=safe_text, urlBase=safe_text)
@given(instance=pokerleague_Settings_strategy)
@settings(max_examples=25)
...
pokerleague_Tournament_strategy = st.builds(pokerleague_Tournament, defaultBuyIn=st.integers(), maxPlayers=st.integers(), minPlayers=st.integers(), tournamentAnnouncementLead=st.integers(), tournamentEnd=safe_text, tournamentInvitationClosure=st.integers(), tournamentInvitationContact=safe_text, tournamentStart=safe_text)
@given(instance=pokerleague_Tournament_strategy)
@settings(max_examples=25)
