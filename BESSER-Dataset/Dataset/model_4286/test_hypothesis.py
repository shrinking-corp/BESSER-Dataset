...
def test_pokerleague_competition_has_defaultTournamentInvitationContact():
    assert hasattr(pokerleague_Competition, "defaultTournamentInvitationContact")
    descriptor = None
    for klass in pokerleague_Competition.__mro__:
        if "defaultTournamentInvitationContact" in klass.__dict__:
            descriptor = klass.__dict__["defaultTournamentInvitationContact"]
            break
    assert isinstance(descriptor, property)
...
def test_pokerleague_competition_has_defaultTournamentInvitationClosure():
    assert hasattr(pokerleague_Competition, "defaultTournamentInvitationClosure")
    descriptor = None
    for klass in pokerleague_Competition.__mro__:
        if "defaultTournamentInvitationClosure" in klass.__dict__:
            descriptor = klass.__dict__["defaultTournamentInvitationClosure"]
            break
    assert isinstance(descriptor, property)
...
def test_pokerleague_tournament_has_tournamentInvitationClosure():
    assert hasattr(pokerleague_Tournament, "tournamentInvitationClosure")
    descriptor = None
    for klass in pokerleague_Tournament.__mro__:
        if "tournamentInvitationClosure" in klass.__dict__:
            descriptor = klass.__dict__["tournamentInvitationClosure"]
            break
    assert isinstance(descriptor, property)
...
def test_pokerleague_tournament_has_tournamentInvitationContact():
    assert hasattr(pokerleague_Tournament, "tournamentInvitationContact")
    descriptor = None
    for klass in pokerleague_Tournament.__mro__:
        if "tournamentInvitationContact" in klass.__dict__:
            descriptor = klass.__dict__["tournamentInvitationContact"]
            break
    assert isinstance(descriptor, property)
...
def test_pokerleague_settings_has_smtpUser():
    assert hasattr(pokerleague_Settings, "smtpUser")
    descriptor = None
    for klass in pokerleague_Settings.__mro__:
        if "smtpUser" in klass.__dict__:
            descriptor = klass.__dict__["smtpUser"]
            break
    assert isinstance(descriptor, property)
...
def test_pokerleague_settings_has_smtpPassword():
    assert hasattr(pokerleague_Settings, "smtpPassword")
    descriptor = None
    for klass in pokerleague_Settings.__mro__:
        if "smtpPassword" in klass.__dict__:
            descriptor = klass.__dict__["smtpPassword"]
            break
    assert isinstance(descriptor, property)
...
def test_pokerleague_settings_has_smtpFrom():
    assert hasattr(pokerleague_Settings, "smtpFrom")
    descriptor = None
    for klass in pokerleague_Settings.__mro__:
        if "smtpFrom" in klass.__dict__:
            descriptor = klass.__dict__["smtpFrom"]
            break
    assert isinstance(descriptor, property)

def test_pokerleague_settings_has_smtpPort():
    assert hasattr(pokerleague_Settings, "smtpPort")
    descriptor = None
    for klass in pokerleague_Settings.__mro__:
...
def test_pokerleague_settings_has_urlBase():
    assert hasattr(pokerleague_Settings, "urlBase")
    descriptor = None
    for klass in pokerleague_Settings.__mro__:
        if "urlBase" in klass.__dict__:
            descriptor = klass.__dict__["urlBase"]
            break
    assert isinstance(descriptor, property)

def test_pokerleague_settings_has_smtpHost():
    assert hasattr(pokerleague_Settings, "smtpHost")
    descriptor = None
    for klass in pokerleague_Settings.__mro__:
...
@given(instance=pokerleague_Competition_strategy)
def test_pokerleague_competition_defaultTournamentInvitationContact_setter(instance):
...
@given(instance=pokerleague_Competition_strategy)
def test_pokerleague_competition_defaultTournamentInvitationClosure_setter(instance):
...
@given(instance=pokerleague_Tournament_strategy)
def test_pokerleague_tournament_tournamentInvitationClosure_setter(instance):
...
@given(instance=pokerleague_Tournament_strategy)
def test_pokerleague_tournament_tournamentInvitationContact_setter(instance):
...
@given(instance=pokerleague_Settings_strategy)
def test_pokerleague_settings_smtpUser_setter(instance):
...
@given(instance=pokerleague_Settings_strategy)
def test_pokerleague_settings_smtpPassword_setter(instance):
...
@given(instance=pokerleague_Settings_strategy)
def test_pokerleague_settings_smtpFrom_setter(instance):
...
@given(instance=pokerleague_Settings_strategy)
def test_pokerleague_settings_smtpPort_setter(instance):
...
@given(instance=pokerleague_Settings_strategy)
def test_pokerleague_settings_urlBase_setter(instance):
...
@given(instance=pokerleague_Settings_strategy)
def test_pokerleague_settings_smtpHost_setter(instance):
