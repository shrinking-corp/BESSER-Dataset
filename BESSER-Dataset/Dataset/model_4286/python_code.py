...
class pokerleague_Tournament(DescribedEntity):
    ...
    @property
    def tournamentInvitationClosure(self):
    ...
    @property
    def tournamentInvitationContact(self):
...
class pokerleague_Competition(DescribedEntity):
    ...
    @property
    def defaultTournamentInvitationContact(self):
    ...
    @property
    def defaultTournamentInvitationClosure(self):
