...
domain_model = DomainModel(
    name="wh",
    types={wh_Exprs, wh_Expr, wh_ExprSimple, Expr, wh_cons, ExprSimple, wh_Wh, wh_Program, wh_Definition, wh_Input, wh_Commands, wh_Output, wh_Command, wh_EObject, wh_Nop, wh_Affect, wh_Vars},
    associations={exp14, exprs16, elements0, definition1, input3, command5, output7, commands9, cmd11, vars13},
