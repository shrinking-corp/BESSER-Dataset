...
def test_hyp_exprsimple_is_not_abstract():
    assert not inspect.isabstract(ExprSimple)


def test_hyp_exprsimple_constructor_exists():
    assert callable(ExprSimple.__init__)


def test_hyp_exprsimple_constructor_args():
...
def test_hyp_wh_cons_list_setter(instance):
