...
fsm_Initial = Class(name="fsm_Initial")
State = Class(name="State")
fsm_Final = Class(name="fsm_Final")
fsm_State = Class(name="fsm_State")
fsm_Transition = Class(name="fsm_Transition")

# fsm_FSM class attributes and methods
fsm_FSM_m_execute: Method = Method(name="execute", parameters={Parameter(name='fsm_events', type=StringType)})
...
domain_model = DomainModel(
    name="fsm",
    types={fsm_FSM, fsm_Initial, State, fsm_Final, fsm_State, fsm_Transition},
    associations={fsm7, states0, transitions1, incoming2, outgoing4},
