...
class fsm_State:
    ...
    def __init__(self, name: str, fsm_State3: "fsm_Transition" = None, fsm_State6: "fsm_Transition" = None, fsm_State: "fsm_FSM" = None):
        self.name = name
...
class fsm_FSM:
    ...
    def __init__(self, fsm: set["fsm_Transition"] = None, FSM: "fsm_Transition" = None, fsm_FSM: set["fsm_State"] = None):
