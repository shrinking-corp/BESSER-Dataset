...
class simpleimperative_Expression(ABC):
    ...
    def __init__(self, simpleimperative_Expression: "simpleimperative_Conditional" = None, simpleimperative_Expression6: "simpleimperative_Loop" = None, simpleimperative_Expression11: "simpleimperative_VarDecl" = None, simpleimperative_Expression16: "simpleimperative_Assignation" = None):
    ...
    def eval(self, simpleimperative_context):
...
class simpleimperative_VarDecl(Statement):
    ...
    def __init__(self, name: str, simpleimperative_VarDecl: "simpleimperative_Expression" = None, simpleimperative_VarDecl13: "simpleimperative_Assignation" = None):
        self.name = name
