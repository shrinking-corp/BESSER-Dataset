...
# Classes
ptnetLoLA_Place = Class(name="ptnetLoLA_Place")
Node = Class(name="Node")
ptnetLoLA_PtNet = Class(name="ptnetLoLA_PtNet")
ptnetLoLA_Arc = Class(name="ptnetLoLA_Arc")
ptnetLoLA_Node = Class(name="ptnetLoLA_Node")
ptnetLoLA_Transition = Class(name="ptnetLoLA_Transition")
ptnetLoLA_Marking = Class(name="ptnetLoLA_Marking")
ptnetLoLA_Annotation = Class(name="ptnetLoLA_Annotation")
ptnetLoLA_PlaceReference = Class(name="ptnetLoLA_PlaceReference")
PlaceReference = Class(name="PlaceReference")
ptnetLoLA_RefMarkedPlace = Class(name="ptnetLoLA_RefMarkedPlace")
ptnetLoLA_TransitionExt = Class(name="ptnetLoLA_TransitionExt")
Transition = Class(name="Transition")
ptnetLoLA_PlaceExt = Class(name="ptnetLoLA_PlaceExt")
Place = Class(name="Place")
ptnetLoLA_ArcToPlace = Class(name="ptnetLoLA_ArcToPlace")
Arc = Class(name="Arc")
ptnetLoLA_ArcToTransition = Class(name="ptnetLoLA_ArcToTransition")
ptnetLoLA_ArcToPlaceExt = Class(name="ptnetLoLA_ArcToPlaceExt")
ArcToPlace = Class(name="ArcToPlace")
ptnetLoLA_ArcToTransitionExt = Class(name="ptnetLoLA_ArcToTransitionExt")
...
ptnetLoLA_TransitionExt.attributes={ptnetLoLA_TransitionExt_maxTime, ptnetLoLA_TransitionExt_cost, ptnetLoLA_TransitionExt_probability, ptnetLoLA_TransitionExt_minTime}
...
domain_model = DomainModel(
    name="ptnetLoLA",
    types={ptnetLoLA_Place, Node, ptnetLoLA_PtNet, ptnetLoLA_Arc, ptnetLoLA_Node, ptnetLoLA_Transition, ptnetLoLA_Marking, ptnetLoLA_Annotation, ptnetLoLA_PlaceReference, PlaceReference, ptnetLoLA_RefMarkedPlace, ptnetLoLA_TransitionExt, Transition, ptnetLoLA_PlaceExt, Place, ptnetLoLA_ArcToPlace, Arc, ptnetLoLA_ArcToTransition, ptnetLoLA_ArcToPlaceExt, ArcToPlace, ptnetLoLA_ArcToTransitionExt, ArcToTransition, NodeType},
    associations={arcs7, finalMarking9, annotation12, places0, transitions1, initialMarking3, annotation5, place19, source21, incoming14, outgoing15, places17, target22},
    generalizations={gen_ptnetLoLA_Place_Node, gen_ptnetLoLA_Transition_Node, gen_ptnetLoLA_RefMarkedPlace_PlaceReference, gen_ptnetLoLA_TransitionExt_Transition, gen_ptnetLoLA_PlaceExt_Place, gen_ptnetLoLA_ArcToPlace_Arc, gen_ptnetLoLA_ArcToTransition_Arc, gen_ptnetLoLA_ArcToPlaceExt_ArcToPlace, gen_ptnetLoLA_ArcToTransitionExt_ArcToTransition},
    metadata=None
)
