...
class ptnetLoLA_Annotation:
    ...
    def __init__(self, text: str, ptnetLoLA_Annotation13: "ptnetLoLA_Node" = None, ptnetLoLA_Annotation: "ptnetLoLA_PtNet" = None):
        self.text = text
...
class ptnetLoLA_Node:
    ...
    def __init__(self, name: str, type: str, ptnetLoLA_Node: "ptnetLoLA_Annotation" = None, Node: "ptnetLoLA_Arc" = None, target: set["ptnetLoLA_Arc"] = None, source: set["ptnetLoLA_Arc"] = None, Node23: "ptnetLoLA_Arc" = None):
        self.name = name
        self.type = type
...
class ptnetLoLA_Arc:
    ...
    def __init__(self, weight: int, ptnetLoLA_Arc: "ptnetLoLA_PtNet" = None, outgoing: "ptnetLoLA_Node" = None, Arc: "ptnetLoLA_Node" = None, Arc16: "ptnetLoLA_Node" = None, incoming: "ptnetLoLA_Node" = None):
        self.weight = weight
