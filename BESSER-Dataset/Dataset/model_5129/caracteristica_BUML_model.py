...
domain_model = DomainModel(
    name="caracteristica",
    types={caracteristica_Caracteristica, caracteristica_LPS, caracteristica_Elemento, caracteristica_ElementoCaracteristico, Elemento, caracteristica_Atributo, caracteristica_CaracteristicaMandatoria, caracteristica_VariacaoDois, caracteristica_Variacao, caracteristica_CaracteristicaRaiz, Caracteristica, caracteristica_CaracteristicaOpcional, ElementoCaracteristico, caracteristica_CaracteristicaAgrupada, caracteristica_PontoDeVariacao, PontoDeVariacao, caracteristica_Variante, Qualidade, TipoValor, OperadorLogico, Origem, Validade, OperadorAcaoLogico, CardinalidadeMaxima, OperadorRelacional, Presenca},
    associations={caracteristicaPai1, caracteristicaPai3, elementos0, caracteristicaFilha6, variacoes8, atributo10, LpsDoSistema12, variantes14, caracteristicaPai15, variacaoPai17},
    generalizations={gen_caracteristica_Caracteristica_Elemento, gen_caracteristica_ElementoCaracteristico_Elemento, gen_caracteristica_Atributo_Elemento, gen_caracteristica_CaracteristicaMandatoria_Caracteristica, gen_caracteristica_VariacaoDois_Caracteristica, gen_caracteristica_VariacaoDois_ElementoCaracteristico, gen_caracteristica_CaracteristicaRaiz_Caracteristica, gen_caracteristica_CaracteristicaOpcional_Caracteristica, gen_caracteristica_CaracteristicaOpcional_ElementoCaracteristico, gen_caracteristica_CaracteristicaAgrupada_Caracteristica, gen_caracteristica_CaracteristicaAgrupada_ElementoCaracteristico, gen_caracteristica_Variacao_PontoDeVariacao, gen_caracteristica_Variacao_Elemento, gen_caracteristica_Variante_PontoDeVariacao, gen_caracteristica_Variante_ElementoCaracteristico, gen_caracteristica_Variante_Caracteristica},
    metadata=None
)
