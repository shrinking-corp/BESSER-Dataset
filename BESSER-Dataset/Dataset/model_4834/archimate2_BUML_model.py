...
# Classes
archimateC2_ArchimateModel = Class(name="archimateC2_ArchimateModel")
archimateC2_ArchimateElement = Class(name="archimateC2_ArchimateElement", is_abstract=True)
archimateC2_BehaviorElement = Class(name="archimateC2_BehaviorElement", is_abstract=True)
archimateC2_ActiveStructure = Class(name="archimateC2_ActiveStructure", is_abstract=True)
archimateC2_PassiveStructure = Class(name="archimateC2_PassiveStructure", is_abstract=True)
ArchimateElement = Class(name="ArchimateElement")
archimateC2_Contract = Class(name="archimateC2_Contract")
archimateC2_BusinessService = Class(name="archimateC2_BusinessService")
archimateC2_Value = Class(name="archimateC2_Value")
PassiveStructure = Class(name="PassiveStructure")
archimateC2_Product = Class(name="archimateC2_Product")
archimateC2_Meaning = Class(name="archimateC2_Meaning")
archimateC2_Representation = Class(name="archimateC2_Representation")
archimateC2_ApplicationService = Class(name="archimateC2_ApplicationService")
archimateC2_InfrastructureService = Class(name="archimateC2_InfrastructureService")
BusinessObject = Class(name="BusinessObject")
archimateC2_BusinessObject = Class(name="archimateC2_BusinessObject")
archimateC2_Location = Class(name="archimateC2_Location")
archimateC2_BusinessEvent = Class(name="archimateC2_BusinessEvent")
archimateC2_BusinessBehaviorElement = Class(name="archimateC2_BusinessBehaviorElement", is_abstract=True)
archimateC2_DataObject = Class(name="archimateC2_DataObject")
archimateC2_BusinessInterface = Class(name="archimateC2_BusinessInterface")
BehaviorElement = Class(name="BehaviorElement")
archimateC2_BusinessActor = Class(name="archimateC2_BusinessActor")
archimateC2_BusinessRole = Class(name="archimateC2_BusinessRole")
archimateC2_ApplicationInterface = Class(name="archimateC2_ApplicationInterface")
archimateC2_ApplicationComponent = Class(name="archimateC2_ApplicationComponent")
archimateC2_BusinessProcess = Class(name="archimateC2_BusinessProcess")
BusinessBehaviorElement = Class(name="BusinessBehaviorElement")
archimateC2_BusinessFunction = Class(name="archimateC2_BusinessFunction")
archimateC2_BusinessInteraction = Class(name="archimateC2_BusinessInteraction")
ActiveStructure = Class(name="ActiveStructure")
archimateC2_Network = Class(name="archimateC2_Network")
archimateC2_CommunicationPath = Class(name="archimateC2_CommunicationPath")
archimateC2_Node = Class(name="archimateC2_Node")
archimateC2_Artifact = Class(name="archimateC2_Artifact")
archimateC2_BusinessCollaboration = Class(name="archimateC2_BusinessCollaboration")
BusinessRole = Class(name="BusinessRole")
archimateC2_ApplicationFunction = Class(name="archimateC2_ApplicationFunction")
archimateC2_ApplicationInteraction = Class(name="archimateC2_ApplicationInteraction")
ApplicationFunction = Class(name="ApplicationFunction")
ApplicationComponent = Class(name="ApplicationComponent")
archimateC2_ApplicationCollaboration = Class(name="archimateC2_ApplicationCollaboration")
archimateC2_InfrastructureInterface = Class(name="archimateC2_InfrastructureInterface")
archimateC2_SystemSoftware = Class(name="archimateC2_SystemSoftware")
Node = Class(name="Node")
archimateC2_Device = Class(name="archimateC2_Device")
...
archimateC2_BusinessProcess.attributes={archimateC2_BusinessProcess_processFullName, archimateC2_BusinessProcess_processDesign, archimateC2_BusinessProcess_processID, archimateC2_BusinessProcess_processType, archimateC2_BusinessProcess_missionary, archimateC2_BusinessProcess_importance}
...
domain_model = DomainModel(
    name="archimateC2",
    types={archimateC2_ArchimateModel, archimateC2_ArchimateElement, archimateC2_BehaviorElement, archimateC2_ActiveStructure, archimateC2_PassiveStructure, ArchimateElement, archimateC2_Contract, archimateC2_BusinessService, archimateC2_Value, PassiveStructure, archimateC2_Product, archimateC2_Meaning, archimateC2_Representation, archimateC2_ApplicationService, archimateC2_InfrastructureService, BusinessObject, archimateC2_BusinessObject, archimateC2_Location, archimateC2_BusinessEvent, archimateC2_BusinessBehaviorElement, archimateC2_DataObject, archimateC2_BusinessInterface, BehaviorElement, archimateC2_BusinessActor, archimateC2_BusinessRole, archimateC2_ApplicationInterface, archimateC2_ApplicationComponent, archimateC2_BusinessProcess, BusinessBehaviorElement, archimateC2_BusinessFunction, archimateC2_BusinessInteraction, ActiveStructure, archimateC2_Network, archimateC2_CommunicationPath, archimateC2_Node, archimateC2_Artifact, archimateC2_BusinessCollaboration, BusinessRole, archimateC2_ApplicationFunction, archimateC2_ApplicationInteraction, ApplicationFunction, ApplicationComponent, archimateC2_ApplicationCollaboration, archimateC2_InfrastructureInterface, archimateC2_SystemSoftware, Node, archimateC2_Device},
    associations={composedOfElementElement2, composesElementElement4, elements0, aggregatesElementElement7, aggregatedByElementElement10, aggregatesContractProduct14, aggregatesBusinessServiceProduct15, associatedWithProductValue12, associatedWithValueProduct13, associatedWithMeaningBusinessObject20, realizedByRepresentationBusinessObject21, aggregatedByProductApplicationService16, aggregatedByProductInfrastructureService17, aggregatedByProductContract18, realizesBusinessObjectRepresentation29, assignedToLocationBusinessObject22, accessesBusinessEventBusinessObject23, accessedByBusinessServiceBusinessObject24, accessedByBusinessBehaviorElementBusinessObject26, realizesBusinessObjectDataObject27, associatedWithBusinessObjectMeaning28, assignedToBusinessInterfaceBusinessService40, accessesBusinessObjectBusinessService41, assignedToLocationRepresentation31, aggregatedByProductBusinessService33, usedByBusinessActorBusinessService35, realizedByBusinessBehaviorElementBusinessService36, usedByBusinessBehaviorElementBusinessService38, triggersByBusinessEventBusinessBehaviorElement59, realisesBusinessServiceBusinessBehaviorElement61, usedByElementBusinessRoleBusinessService43, assigedToBusinessServiceApplicationInterface44, triggersToBusinessBehaviorElementBusinessBehaviorElement46, triggeredByBusinessBehaviorElementBusinessBehaviorElement49, flowsFromBusinessBehaviorElementBusinessBehaviorElement52, flowsToBusinessBehaviorElementBusinessBehaviorElement55, triggersBusinessEventBusinessBehaviorElement57, usesBusinessServiceBusinessBehaviorElement63, accessesBusinessObjectBusinessBehaviorElement65, assignedToBusinessRoleBusinessBehaviorElement67, usedByBusinessBehaviorElementApplicationservice69, assignedToApplicationComponentBusinessBehaviorElement71, triggersBusinessBehaviorElementBusinessEvent74, triggersByBusinessBehaviorElementBusinessEvent72, assignedFromBusinessActorLocation78, accessedByBusinessObjectBusinessEvent76, assignedFromLocationNode88, assignedFromLocationNetwork89, assignedFromBusinessObjectLocation80, assignedFromRepresentationLocation82, assignedToLocationDataObject84, assignedFromLocationApplicationComponent86, usedByBusinessRoleBusinessInterface97, assignedFromLocationCommunicationPath90, assignedFromLocationArtifact92, composesBusinessRoleBusinessInterface93, usedByBusinessActorBusinessInterface95, assignedToBusinessActorBusinessRole105, aggregatedByBusinessCollaborationBusinessRole107, assignedToBusinessServiceBusinessInterface99, composedOfBusinessInterfaceBusinessRole101, usesBusinessInterfaceBusinessRole103, assignedToBusinessBehaviorElementBusinessRole108, usesElementBusinessServiceBusinessRole110, usesBusinessRoleApplicationService112, usedByBusinessRoleApplicationInterface114, usesBusinessInterfaceBusinessActor122, aggregatesBusinessActorBusinessCollaboration116, aggregatesBusinessRoleBusinessCollaboration118, aggregatesByBusinessCollaborationBusinessActor120, usedByBusinessActorApplicationInterface132, assignedToBusinessRoleBusinessActor124, usesElementBusinessServiceBusinessActor126, assignedToLocationBusinessActor128, usesBusinessActorApplicationService130, accessedByApplicationFunctionDataObject134, accessedByApplicationServiceDataObject135, realizedByBusinessObjectDataObject137, assignedfromLocationDataObject139, realizedByDataObjectArtifact141, usedByBusinessRoleApplicationService155, usedByBusinessActorApplicationService157, realizedByApplicationFunctionApplicationService143, usedByApplicationFunctionApplicationService145, assignedToApplicationInterfaceApplicationService147, accessesDataObjectApplicationService149, aggregatesProductApplicationService151, usesBusinessBehaviorElementApplicationservice153, flowsToApplicationFunctionApplicationFunction166, flowsFromApplicationFunctionApplicationFunction169, triggeredByApplicationFunctionApplicationFunction160, triggersToApplicationFunctionApplicationFunction163, accessesDataObjectApplicationFunction177, usesApplicationFunctionInfrastructureService179, realizesApplicationServiceApplicationFunction171, assignedToApplicationComponentApplicationFunction173, usesApplicationServiceApplicationFunction175, usesBusinessRoleApplicationInterface189, assignedFromBusinessServiceApplicationInterface191, composesApplicationComponentApplicationInterface181, usedByApplicationComponentApplicationInterface183, assignedToApplicationServiceApplicationInterface185, usesBusinessActorApplicationInterface187, aggregatesApplicationComponentApplicationCollaboration209, aggregatedByApplicationCollaborationApplicationComponent193, assignedToApplicationFunctionApplicationComponent194, composedOfApplicationInterfaceApplicationComponent196, usesApplicationInterfaceApplicationComponent198, assignedToLocationApplicationComponent200, assignedFromApplicationComponentBusinessBehaviorElement202, realizedByApplicationComponentArtifact204, usesApplicationComponentInfrastructureInterface206, usesApplicationComponentInfrastructureService207, realizedByNodeInfrastructureService225, aggregatesProductInfrastructureService227, usedByApplicationComponentInfrastructureService229, accessedByInfrastructureServiceArtifact211, assignedToNodeArtifact213, assignedToLocationArtifact215, realizesDataObjectArtifact217, realizesApplicationComponentArtifact219, accessesArtifactInfrastructureService221, assignedToInfrastructureInterfaceInfrastructureService223, composedOfInfrastructureInterfaceNode244, usesInfrastructureInterfaceNode246, usedByApplicationFunctionInfrastructureService231, composesNodeInfrastructureInterface233, assignedToInfrastructureServiceInfrastructureInterface235, usedByNodeInfrastructureInterface237, usedByApplicationComponentInfrastructureInterface239, associatedWithCommunicationPathNode241, assignedToArtifactNode242, associatedWithNetworkDevice253, usesInfrastructureServiceNode248, assignedToLocationNode250, assignedToDeviceSystemSoftware252, assignedToSystemSoftwareDevice254, associatedWithNodeCommunicationPath255, realizedByNetworkCommunicationPath257, assignedFromLocationCommunicationPath259, realizesCommunicationPathNetwork262, associatedWithDeviceNetwork264, assignedFromLocationNetwork266},
    generalizations={gen_archimateC2_BehaviorElement_ArchimateElement, gen_archimateC2_ActiveStructure_ArchimateElement, gen_archimateC2_PassiveStructure_ArchimateElement, gen_archimateC2_Value_PassiveStructure, gen_archimateC2_Product_PassiveStructure, gen_archimateC2_Contract_BusinessObject, gen_archimateC2_BusinessObject_PassiveStructure, gen_archimateC2_Representation_PassiveStructure, gen_archimateC2_Meaning_PassiveStructure, gen_archimateC2_BusinessService_BehaviorElement, gen_archimateC2_BusinessBehaviorElement_BehaviorElement, gen_archimateC2_BusinessFunction_BusinessBehaviorElement, gen_archimateC2_BusinessProcess_BusinessBehaviorElement, gen_archimateC2_BusinessInteraction_BusinessBehaviorElement, gen_archimateC2_BusinessEvent_ArchimateElement, gen_archimateC2_Location_ActiveStructure, gen_archimateC2_BusinessInterface_ActiveStructure, gen_archimateC2_BusinessRole_ActiveStructure, gen_archimateC2_BusinessCollaboration_BusinessRole, gen_archimateC2_BusinessActor_ActiveStructure, gen_archimateC2_DataObject_ArchimateElement, gen_archimateC2_ApplicationService_ArchimateElement, gen_archimateC2_ApplicationFunction_ArchimateElement, gen_archimateC2_ApplicationInteraction_ApplicationFunction, gen_archimateC2_ApplicationComponent_ArchimateElement, gen_archimateC2_ApplicationInterface_ArchimateElement, gen_archimateC2_ApplicationCollaboration_ApplicationComponent, gen_archimateC2_Artifact_ArchimateElement, gen_archimateC2_InfrastructureService_ArchimateElement, gen_archimateC2_InfrastructureInterface_ArchimateElement, gen_archimateC2_Node_ArchimateElement, gen_archimateC2_Device_Node, gen_archimateC2_SystemSoftware_Node, gen_archimateC2_CommunicationPath_ArchimateElement, gen_archimateC2_Network_ArchimateElement},
    metadata=None
)
