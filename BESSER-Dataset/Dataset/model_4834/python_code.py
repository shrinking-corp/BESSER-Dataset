...
class archimateC2_BusinessRole(ActiveStructure):
    ...
    def __init__(self, rank: int, BusinessRole: "archimateC2_BusinessService" = None, BusinessRole68: "archimateC2_BusinessBehaviorElement" = None, BusinessRole98: "archimateC2_BusinessInterface" = None, BusinessRole94: "archimateC2_BusinessInterface" = None, assignedToBusinessRoleBusinessActor: set["archimateC2_BusinessActor"] = None, aggregatesBusinessRoleBusinessCollaboration: "archimateC2_BusinessCollaboration" = None, composesBusinessRoleBusinessInterface: set["archimateC2_BusinessInterface"] = None, usedByBusinessRoleBusinessInterface: set["archimateC2_BusinessInterface"] = None, assignedToBusinessRoleBusinessBehaviorElement: set["archimateC2_BusinessBehaviorElement"] = None, usedByElementBusinessRoleBusinessService: set["archimateC2_BusinessService"] = None, usedByBusinessRoleApplicationService: set["archimateC2_ApplicationService"] = None, usesBusinessRoleApplicationInterface: set["archimateC2_ApplicationInterface"] = None, BusinessRole125: "archimateC2_BusinessActor" = None, BusinessRole156: "archimateC2_ApplicationService" = None, BusinessRole190: "archimateC2_ApplicationInterface" = None, BusinessRole119: "archimateC2_BusinessCollaboration" = None):
        self.rank = rank
...
class archimateC2_Product(PassiveStructure):
    ...
    def __init__(self, contract: str, aggregatedByProductContract: set["archimateC2_Contract"] = None, aggregatedByProductBusinessService: set["archimateC2_BusinessService"] = None, Product: "archimateC2_Value" = None, associatedWithProductValue: set["archimateC2_Value"] = None, aggregatesProductApplicationService: set["archimateC2_ApplicationService"] = None, aggregatesProductInfrastructureService: set["archimateC2_InfrastructureService"] = None, Product19: "archimateC2_Contract" = None, Product34: "archimateC2_BusinessService" = None, Product152: "archimateC2_ApplicationService" = None, Product228: "archimateC2_InfrastructureService" = None):
...
class archimateC2_ArchimateElement(ABC):
    ...
    def __init__(self, elementName: str, description: str, ArchimateElement: "archimateC2_ArchimateElement" = None, composesElementElement: set["archimateC2_ArchimateElement"] = None, ArchimateElement5: "archimateC2_ArchimateElement" = None, composedOfElementElement: "archimateC2_ArchimateElement" = None, ArchimateElement8: "archimateC2_ArchimateElement" = None, aggregatedByElementElement: set["archimateC2_ArchimateElement"] = None, ArchimateElement11: "archimateC2_ArchimateElement" = None, aggregatesElementElement: "archimateC2_ArchimateElement" = None, archimateC2_ArchimateElement: "archimateC2_ArchimateModel" = None):
