...
# Classes
tExp_Domainmodel = Class(name="tExp_Domainmodel")
tExp_TraceExpression = Class(name="tExp_TraceExpression")
tExp_PrologExpression = Class(name="tExp_PrologExpression")
tExp_Term = Class(name="tExp_Term")
tExp_Role = Class(name="tExp_Role")
tExp_EventType = Class(name="tExp_EventType")
tExp_Msg = Class(name="tExp_Msg")
tExp_Partition = Class(name="tExp_Partition")
tExp_Constraint = Class(name="tExp_Constraint")
tExp_Channel = Class(name="tExp_Channel")
tExp_Expression = Class(name="tExp_Expression")
tExp_AtomExpression = Class(name="tExp_AtomExpression")
PrologExpression = Class(name="PrologExpression")
tExp_VariableExpression = Class(name="tExp_VariableExpression")
tExp_StringExpression = Class(name="tExp_StringExpression")
tExp_NumberExpression = Class(name="tExp_NumberExpression")
tExp_ListExpression = Class(name="tExp_ListExpression")
tExp_ShuffleExpr = Class(name="tExp_ShuffleExpr")
Expression = Class(name="Expression")
tExp_Together = Class(name="tExp_Together")
tExp_VarExpr = Class(name="tExp_VarExpr")
tExp_TerminalExpr = Class(name="tExp_TerminalExpr")
tExp_UnionExpr = Class(name="tExp_UnionExpr")
tExp_AndExpr = Class(name="tExp_AndExpr")
tExp_CatExpr = Class(name="tExp_CatExpr")
tExp_SeqExpr = Class(name="tExp_SeqExpr")
tExp_FilterExpr = Class(name="tExp_FilterExpr")
tExp_Singletons = Class(name="tExp_Singletons")
Constraint = Class(name="Constraint")
tExp_Size = Class(name="tExp_Size")
tExp_Cardinality = Class(name="tExp_Cardinality")
...
tExp_TraceExpression.attributes={tExp_TraceExpression_channelsL, tExp_TraceExpression_guiL, tExp_TraceExpression_partitionL, tExp_TraceExpression_name, tExp_TraceExpression_decentralizedL, tExp_TraceExpression_thresholdL, tExp_TraceExpression_threshold, tExp_TraceExpression_rolesL, tExp_TraceExpression_bodyL, tExp_TraceExpression_minimal, tExp_TraceExpression_modulesL, tExp_TraceExpression_typesL, tExp_TraceExpression_modules, tExp_TraceExpression_minimalL, tExp_TraceExpression_constraintsL, tExp_TraceExpression_decentralized, tExp_TraceExpression_gui}
...
tExp_Role_class_: Property = Property(name="class_", type=StringType)
tExp_Role_args: Property = Property(name="args", type=StringType)
tExp_Role.attributes={tExp_Role_name, tExp_Role_args, tExp_Role_class_}
...
tExp_Constraint.attributes={tExp_Constraint_parMin, tExp_Constraint_together, tExp_Constraint_parMax, tExp_Constraint_split}
...
tExp_Channel.attributes={tExp_Channel_name, tExp_Channel_reliability}
...
tExp_Singletons.attributes={tExp_Singletons_minSingletons, tExp_Singletons_maxSingletons}
...
tExp_Cardinality.attributes={tExp_Cardinality_minCardinality, tExp_Cardinality_maxCardinality}
...
domain_model = DomainModel(
    name="tExp",
    types={tExp_Domainmodel, tExp_TraceExpression, tExp_PrologExpression, tExp_Term, tExp_Role, tExp_EventType, tExp_Msg, tExp_Partition, tExp_Constraint, tExp_Channel, tExp_Expression, tExp_AtomExpression, PrologExpression, tExp_VariableExpression, tExp_StringExpression, tExp_NumberExpression, tExp_ListExpression, tExp_ShuffleExpr, Expression, tExp_Together, tExp_VarExpr, tExp_TerminalExpr, tExp_UnionExpr, tExp_AndExpr, tExp_CatExpr, tExp_SeqExpr, tExp_FilterExpr, tExp_Singletons, Constraint, tExp_Size, tExp_Cardinality},
    associations={elements0, left2, right4, terms6, roles8, types10, bodyVar21, typeFilter23, first26, exprs29, bodyFilter33, typeSeq35, bodySeq39, term41, expr45, expr47, exprs50, msgs53, partition12, constraints14, channels16, expr18, left81, right84, terms87, head89, tail91, left94, channel55, async_sender58, receiver61, sender64, async_receiver67, content70, conditions73, constraints76, roles78, filterExpr116, varExpr118, terminalExpr120, right96, left99, right101, left104, right106, left109, right111, seqExpr114},
    generalizations={gen_tExp_AtomExpression_PrologExpression, gen_tExp_VariableExpression_PrologExpression, gen_tExp_StringExpression_PrologExpression, gen_tExp_NumberExpression_PrologExpression, gen_tExp_ListExpression_PrologExpression, gen_tExp_ShuffleExpr_Expression, gen_tExp_VarExpr_Expression, gen_tExp_TerminalExpr_Expression, gen_tExp_UnionExpr_Expression, gen_tExp_AndExpr_Expression, gen_tExp_CatExpr_Expression, gen_tExp_SeqExpr_Expression, gen_tExp_FilterExpr_Expression, gen_tExp_Singletons_Constraint, gen_tExp_Size_Constraint, gen_tExp_Cardinality_Constraint},
    metadata=None
)
