...
# Classes
rankPL_Model = Class(name="rankPL_Model")
rankPL_AbstractDefinition = Class(name="rankPL_AbstractDefinition")
rankPL_Definition = Class(name="rankPL_Definition")
AbstractDefinition = Class(name="AbstractDefinition")
rankPL_Expression = Class(name="rankPL_Expression")
rankPL_DeclaredParameter = Class(name="rankPL_DeclaredParameter")
rankPL_Plus = Class(name="rankPL_Plus")
Expression = Class(name="Expression")
rankPL_Minus = Class(name="rankPL_Minus")
rankPL_FunctionCall = Class(name="rankPL_FunctionCall")
rankPL_Multi = Class(name="rankPL_Multi")
rankPL_Div = Class(name="rankPL_Div")
rankPL_NumberLiteral = Class(name="rankPL_NumberLiteral")
...
domain_model = DomainModel(
    name="rankPL",
    types={rankPL_Model, rankPL_AbstractDefinition, rankPL_Definition, AbstractDefinition, rankPL_Expression, rankPL_DeclaredParameter, rankPL_Plus, Expression, rankPL_Minus, rankPL_FunctionCall, rankPL_Multi, rankPL_Div, rankPL_NumberLiteral},
    associations={greetings0, expr1, left2, right4, left7, func22, right9, args24, left12, right14, left17, right19},
    generalizations={gen_rankPL_Definition_AbstractDefinition, gen_rankPL_DeclaredParameter_AbstractDefinition, gen_rankPL_Plus_Expression, gen_rankPL_Minus_Expression, gen_rankPL_FunctionCall_Expression, gen_rankPL_Multi_Expression, gen_rankPL_Div_Expression, gen_rankPL_NumberLiteral_Expression},
    metadata=None
)
