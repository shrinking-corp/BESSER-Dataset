...
henshin_Rule_m_getNode: Method = Method(name="getNode", parameters={Parameter(name='henshin_nodename', type=StringType), Parameter(name='henshin_isLhs', type=StringType)}, type=StringType)
...
henshin_Rule_m_containsMultiMapping: Method = Method(name="containsMultiMapping", parameters={Parameter(name='henshin_targetNode', type=StringType), Parameter(name='henshin_sourceNode', type=StringType)}, type=BooleanType)
...
henshin_Rule.methods={henshin_Rule_m_containsMapping, henshin_Rule_m_getKernelRule, henshin_Rule_m_getRootKernelRule, henshin_Rule_m_removeNode, henshin_Rule_m_getNode, henshin_Rule_m_containsMultiMapping, henshin_Rule_m_getMultiRule, henshin_Rule_m_removeEdge, henshin_Rule_m_getAllMultiRules, henshin_Rule_m_getTransformationSystem}
...
henshin_Graph.methods={henshin_Graph_m_removeNode, henshin_Graph_m_getEdges, henshin_Graph_m_isLhs, henshin_Graph_m_removeEdge, henshin_Graph_m_getNodes, henshin_Graph_m_isNestedCondition, henshin_Graph_m_getContainerRule, henshin_Graph_m_isRhs}
...
henshin_Node.methods={henshin_Node_m_getOutgoing, henshin_Node_m_getOutgoing, henshin_Node_m_getAttribute, henshin_Node_m_getIncoming, henshin_Node_m_getIncoming}
...
henshin_NestedCondition.methods={henshin_NestedCondition_m_isNAC, henshin_NestedCondition_m_isPAC}
