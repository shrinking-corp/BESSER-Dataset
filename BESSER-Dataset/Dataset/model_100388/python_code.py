...
class SpecificationElement:
    ...
    pass
class sgraph_State(CompositeElement, ScopedElement, SpecificationElement, RegularState, ReactiveElement):
...
class sgraph_Declaration(NamedElement):
    ...
    pass
class sgraph_Statechart(CompositeElement, ScopedElement, SpecificationElement, ReactiveElement, NamedElement):
