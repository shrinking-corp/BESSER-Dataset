...
persistence_Feature.attributes={persistence_Feature_encodeUriKey, persistence_Feature_pluralisedName, persistence_Feature_footerClass, persistence_Feature_displayClass, persistence_Feature_ordered, persistence_Feature_booleanIsHasChoice, persistence_Feature_collectionOrmAllowRemove, persistence_Feature_customiseSet, persistence_Feature_defaultDisplayValue, persistence_Feature_emptyDisplayValue, persistence_Feature_columnName, persistence_Feature_derived, persistence_Feature_collectionOrmAllowAdd, persistence_Feature_cardinality, persistence_Feature_title, persistence_Feature_primaryKey, persistence_Feature_singletonName, persistence_Feature_headerClass}
...
persistence_Persistence.attributes={persistence_Persistence_ormTechnology, persistence_Persistence_databaseTechnology, persistence_Persistence_timestampUpdates, persistence_Persistence_timestampCreation}
...
persistence_Entity.attributes={persistence_Entity_tableName, persistence_Entity_singletonName, persistence_Entity_implementsUserInterface, persistence_Entity_pluralisedName, persistence_Entity_autoKeyName, persistence_Entity_allowFormTypeCustomisation, persistence_Entity_autoKeyPersistentType, persistence_Entity_autoKeyGenerationStrategy}
...
persistence_Association.attributes={persistence_Association_targetFooterClass, persistence_Association_pivotTableName, persistence_Association_targetHeaderClass, persistence_Association_targetColumnName, persistence_Association_unique, persistence_Association_targetDisplayClass, persistence_Association_pseudo, persistence_Association_bidirectional, persistence_Association_targetDisplayLabel, persistence_Association_targetInputClass, persistence_Association_serializationMaxDepth, persistence_Association_targetPrimaryKey, persistence_Association_inputElementClass, persistence_Association_inputColumnClass, persistence_Association_targetFeatureName}
...
persistence_Attribute.attributes={persistence_Attribute_ormType, persistence_Attribute_interfaceType, persistence_Attribute_containerUnique, persistence_Attribute_persistentType, persistence_Attribute_validationPattern, persistence_Attribute_unique, persistence_Attribute_inputColumnClass, persistence_Attribute_inputElementClass, persistence_Attribute_hidden, persistence_Attribute_placeholder}
...
persistence_ResourceAttribute.attributes={persistence_ResourceAttribute_validUploadMimeTypes, persistence_ResourceAttribute_validUploadExtensions, persistence_ResourceAttribute_uploadsWithinWebsite, persistence_ResourceAttribute_maximumUploadSize}
...
domain_model = DomainModel(
    name="persistence",
    types={persistence_Feature, persistence_Persistence, persistence_SerializationGroup, persistence_DataType, persistence_Entity, NamedElement, persistence_Association, persistence_AssociationKey, NamedDisplayElement, persistence_Attribute, Feature, Label, persistence_Expression, persistence_Label, persistence_ModelLabel, persistence_ModelLabelFeature, persistence_ModelLabelAttribute, ModelLabelFeature, persistence_ModelLabelAssociation, Classifier, persistence_PathElement, persistence_DataTypeAttribute, Attribute, persistence_DateAttribute, persistence_UrlAttribute, persistence_ResourceAttribute, persistence_StaticPathElement, PathElement, persistence_DatePathElement, persistence_FileAttribute, ResourceAttribute, persistence_ImageAttribute, persistence_LocationAttribute, persistence_AssociationWithoutContainment, Association, persistence_AssociationWithContainment, isHasChoices, DatabaseTechnologies, OrmTechnologies, Cardinality, DateDetails},
    associations={serializationGroups0, dataTypes1, entities3, keys12, partOf5, serializationGroups6, slugFields9, defaultValue10, features28, attributes30, targetEntity13, labelFor15, features17, serializationGroups18, partOf20, attribute22, association24, dynamicLabel25, uploadPath56, associations33, associationEnds36, allFeatures37, allAssociations40, keys43, labels46, unique48, containerUnique51, dataType54, keyFor57, sourceFeature59, targetFeature61},
    generalizations={gen_persistence_SerializationGroup_NamedElement, gen_persistence_Association_Feature, gen_persistence_Feature_NamedDisplayElement, gen_persistence_Attribute_Feature, gen_persistence_Attribute_Label, gen_persistence_ModelLabel_NamedElement, gen_persistence_ModelLabel_Label, gen_persistence_ModelLabelAttribute_ModelLabelFeature, gen_persistence_ModelLabelAssociation_ModelLabelFeature, gen_persistence_Entity_Classifier, gen_persistence_DataTypeAttribute_Attribute, gen_persistence_DateAttribute_Attribute, gen_persistence_UrlAttribute_Attribute, gen_persistence_ResourceAttribute_Attribute, gen_persistence_StaticPathElement_PathElement, gen_persistence_DatePathElement_PathElement, gen_persistence_FileAttribute_ResourceAttribute, gen_persistence_ImageAttribute_ResourceAttribute, gen_persistence_LocationAttribute_Attribute, gen_persistence_AssociationWithoutContainment_Association, gen_persistence_AssociationWithContainment_Association},
    metadata=None
)
