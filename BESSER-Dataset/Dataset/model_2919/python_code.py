...
class persistence_ResourceAttribute(Attribute):
    ...
    def __init__(self, validUploadExtensions: str, uploadsWithinWebsite: bool, maximumUploadSize: int, validUploadMimeTypes: str, persistence_ResourceAttribute: set["persistence_PathElement"] = None):
...
class persistence_ModelLabelAssociation(ModelLabelFeature):
    ...
    def __init__(self, isSourceAssociation: bool, persistence_ModelLabelAssociation: "persistence_Association" = None, persistence_ModelLabelAssociation26: "persistence_ModelLabel" = None):
...
class Feature:
    ...
    pass
class persistence_Attribute(Label, Feature):

    def __init__(self, inputElementClass: str, hidden: bool, containerUnique: bool, persistentType: str, ormType: str, interfaceType: str, unique: bool, placeholder: str, validationPattern: str, inputColumnClass: str, persistence_Attribute: "persistence_Attribute" = None, persistence_Attribute8: set["persistence_Attribute"] = None, persistence_Attribute11: "persistence_Expression" = None, persistence_Attribute32: "persistence_Entity" = None, persistence_Attribute23: "persistence_ModelLabelAttribute" = None):
...
class persistence_Association(Feature):
    ...
    def __init__(self, bidirectional: bool, unique: bool, pivotTableName: str, targetFeatureName: str, targetPrimaryKey: bool, targetColumnName: str, targetDisplayLabel: str, targetHeaderClass: str, targetInputClass: str, targetDisplayClass: str, targetFooterClass: str, pseudo: bool, inputColumnClass: str, inputElementClass: str, serializationMaxDepth: int, associationEnds: "persistence_Entity" = None, persistence_Association: "persistence_ModelLabelAssociation" = None, persistence_Association35: "persistence_Entity" = None, Association: "persistence_Entity" = None, persistence_Association42: "persistence_Entity" = None, Association58: "persistence_AssociationKey" = None, keyFor: set["persistence_AssociationKey"] = None):
...
class persistence_ModelLabel(NamedElement, Label):
    ...
    def __init__(self, format: str, customise: bool, labels: "persistence_Entity" = None, partOf: set["persistence_ModelLabelFeature"] = None, persistence_ModelLabel: set["persistence_SerializationGroup"] = None, ModelLabel: "persistence_ModelLabelFeature" = None, persistence_ModelLabel27: "persistence_ModelLabelAssociation" = None, ModelLabel47: "persistence_Entity" = None):
        self.format = format
...
class persistence_Entity(Classifier):
    ...
    def __init__(self, pluralisedName: str, singletonName: str, tableName: str, autoKeyName: str, autoKeyPersistentType: str, autoKeyGenerationStrategy: str, implementsUserInterface: bool, allowFormTypeCustomisation: bool, partOf29: set["persistence_Feature"] = None, persistence_Entity31: set["persistence_Attribute"] = None, Entity14: "persistence_Association" = None, Entity16: "persistence_ModelLabel" = None, persistence_Entity34: set["persistence_Association"] = None, targetEntity: set["persistence_Association"] = None, persistence_Entity38: set["persistence_Feature"] = None, persistence_Entity41: set["persistence_Association"] = None, persistence_Entity44: set["persistence_Feature"] = None, labelFor: set["persistence_ModelLabel"] = None, persistence_Entity49: set["persistence_Feature"] = None, persistence_Entity52: set["persistence_Feature"] = None, persistence_Entity: "persistence_Persistence" = None, Entity: "persistence_Feature" = None):
    ...
    @property
    def allowFormTypeCustomisation(self):
...
class persistence_Feature(NamedDisplayElement):
    ...
    def __init__(self, cardinality: str, ordered: bool, primaryKey: bool, derived: bool, customiseSet: bool, booleanIsHasChoice: str, title: str, collectionOrmAllowAdd: bool, collectionOrmAllowRemove: bool, defaultDisplayValue: str, emptyDisplayValue: str, encodeUriKey: bool, singletonName: str, pluralisedName: str, columnName: str, headerClass: str, displayClass: str, footerClass: str, Feature: "persistence_Entity" = None, persistence_Feature39: "persistence_Entity" = None, persistence_Feature45: "persistence_Entity" = None, persistence_Feature50: "persistence_Entity" = None, persistence_Feature53: "persistence_Entity" = None, persistence_Feature60: "persistence_AssociationKey" = None, features: "persistence_Entity" = None, persistence_Feature: set["persistence_SerializationGroup"] = None, persistence_Feature63: "persistence_AssociationKey" = None):
    ...
    @property
    def collectionOrmAllowAdd(self):
    ...
    @property
    def collectionOrmAllowRemove(self):
