...
# Classes
digraph_Graph = Class(name="digraph_Graph")
digraph_GraphElement = Class(name="digraph_GraphElement", is_abstract=True)
digraph_Node = Class(name="digraph_Node")
GraphElement = Class(name="GraphElement")
digraph_Edge = Class(name="digraph_Edge")
...
domain_model = DomainModel(
    name="digraph",
    types={digraph_Graph, digraph_GraphElement, digraph_Node, GraphElement, digraph_Edge},
