...
class Product:
    ...
    def __init__(self, ProductId: int, CategoryId: int, ModelNumber: int, ModelName: str, UnitCost: int, Description: str, Product_Order_04: "Order" = None, Shopping_Cart_Product_17: "Shopping_Cart" = None):
        self.ProductId = ProductId
...
class Customer:
    ...
    def __init__(self, Full_Name: str, Email_Address: str, Password: str, Delivery_address: str, CustomerId: int, Customer_Shopping_Cart_00: "Shopping_Cart" = None):
