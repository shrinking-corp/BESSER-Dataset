...
Customer.attributes={Customer_Email_Address, Customer_Delivery_address, Customer_Password, Customer_Full_Name, Customer_CustomerId}
...
Product.attributes={Product_ProductId, Product_CategoryId, Product_ModelName, Product_ModelNumber, Product_UnitCost, Product_Description}
...
Shopping_Cart.attributes={Shopping_Cart_RecordId, Shopping_Cart_ProductId, Shopping_Cart_CartId, Shopping_Cart_Quantity, Shopping_Cart_DateCreated}
...
Order.attributes={Order_OrderDate, Order_ShipDate, Order_CustomerId, Order_OrderId}
...
OrderDetails.attributes={OrderDetails_ProductId, OrderDetails_Quantity, OrderDetails_OrderId, OrderDetails_UnitCost}
