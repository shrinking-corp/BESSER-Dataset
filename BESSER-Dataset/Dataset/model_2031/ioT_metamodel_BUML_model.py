...
# Classes
ioT_metamodel_Thing = Class(name="ioT_metamodel_Thing")
Entity = Class(name="Entity")
ioT_metamodel_VirtualThing = Class(name="ioT_metamodel_VirtualThing")
ioT_metamodel_Fog = Class(name="ioT_metamodel_Fog")
ioT_metamodel_PhysicalThing = Class(name="ioT_metamodel_PhysicalThing")
ioT_metamodel_Property = Class(name="ioT_metamodel_Property")
Active_Digital_Artifact = Class(name="Active_Digital_Artifact")
Passive_Digital_Artifact = Class(name="Passive_Digital_Artifact")
ioT_metamodel_InformationResource = Class(name="ioT_metamodel_InformationResource")
ioT_metamodel_Device = Class(name="ioT_metamodel_Device")
ioT_metamodel_Authorizor = Class(name="ioT_metamodel_Authorizor")
ioT_metamodel_VM = Class(name="ioT_metamodel_VM")
ioT_metamodel_Container = Class(name="ioT_metamodel_Container")
ioT_metamodel_Analytics_Engine = Class(name="ioT_metamodel_Analytics_Engine")
ioT_metamodel_Fog_Services = Class(name="ioT_metamodel_Fog_Services")
PhysicalThing = Class(name="PhysicalThing")
ioT_metamodel_Rule = Class(name="ioT_metamodel_Rule")
ioT_metamodel_DeviceState = Class(name="ioT_metamodel_DeviceState")
ioT_metamodel_Communicator = Class(name="ioT_metamodel_Communicator")
ioT_metamodel_On_Device_Resource = Class(name="ioT_metamodel_On_Device_Resource")
ioT_metamodel_Actuator = Class(name="ioT_metamodel_Actuator")
Device = Class(name="Device")
ioT_metamodel_FogNode = Class(name="ioT_metamodel_FogNode")
ioT_metamodel_Cloud = Class(name="ioT_metamodel_Cloud")
ioT_metamodel_Database = Class(name="ioT_metamodel_Database")
ioT_metamodel_Sensor = Class(name="ioT_metamodel_Sensor", is_abstract=True)
ioT_metamodel_Action = Class(name="ioT_metamodel_Action")
ioT_metamodel_ExternalSensor = Class(name="ioT_metamodel_ExternalSensor")
Sensor = Class(name="Sensor")
ioT_metamodel_DeviceActuator = Class(name="ioT_metamodel_DeviceActuator")
Actuator = Class(name="Actuator")
ioT_metamodel_ExternalActuator = Class(name="ioT_metamodel_ExternalActuator")
ioT_metamodel_CompositeState = Class(name="ioT_metamodel_CompositeState")
DeviceState = Class(name="DeviceState")
ioT_metamodel_Transition = Class(name="ioT_metamodel_Transition")
ioT_metamodel_Tag = Class(name="ioT_metamodel_Tag")
ioT_metamodel_Human_User = Class(name="ioT_metamodel_Human_User")
ioT_metamodel_Port = Class(name="ioT_metamodel_Port")
ioT_metamodel_Information = Class(name="ioT_metamodel_Information")
ioT_metamodel_Attribute = Class(name="ioT_metamodel_Attribute", is_abstract=True)
InformationResource = Class(name="InformationResource")
ioT_metamodel_Device_Resource = Class(name="ioT_metamodel_Device_Resource")
ioT_metamodel_Service_Resource = Class(name="ioT_metamodel_Service_Resource")
ioT_metamodel_Network_Resource = Class(name="ioT_metamodel_Network_Resource")
ioT_metamodel_Digital_Artifact = Class(name="ioT_metamodel_Digital_Artifact")
ioT_metamodel_Active_Digital_Artifact = Class(name="ioT_metamodel_Active_Digital_Artifact")
Digital_Artifact = Class(name="Digital_Artifact")
User = Class(name="User")
ioT_metamodel_Passive_Digital_Artifact = Class(name="ioT_metamodel_Passive_Digital_Artifact")
ioT_metamodel_User = Class(name="ioT_metamodel_User")
ioT_metamodel_Policy_Repository = Class(name="ioT_metamodel_Policy_Repository")
ioT_metamodel_Reference_Monitor = Class(name="ioT_metamodel_Reference_Monitor")
ioT_metamodel_AtomicData = Class(name="ioT_metamodel_AtomicData")
ioT_metamodel_DataStreams = Class(name="ioT_metamodel_DataStreams")
ioT_metamodel_DataStreamAttributes = Class(name="ioT_metamodel_DataStreamAttributes", is_abstract=True)
ioT_metamodel_AtomicDataAttributes = Class(name="ioT_metamodel_AtomicDataAttributes", is_abstract=True)
ioT_metamodel_Operations = Class(name="ioT_metamodel_Operations")
ioT_metamodel_Evaluators = Class(name="ioT_metamodel_Evaluators", is_abstract=True)
ioT_metamodel_JavaEvaluator = Class(name="ioT_metamodel_JavaEvaluator")
Evaluators = Class(name="Evaluators")
ioT_metamodel_Entity = Class(name="ioT_metamodel_Entity")
ioT_metamodel_ScriptEvaluator = Class(name="ioT_metamodel_ScriptEvaluator")
ioT_metamodel_DeviceSensor = Class(name="ioT_metamodel_DeviceSensor")
...
ioT_metamodel_Container.attributes={ioT_metamodel_Container_ID, ioT_metamodel_Container_IP_address}
...
ioT_metamodel_Communicator.attributes={ioT_metamodel_Communicator_Type, ioT_metamodel_Communicator_ports_number}
...
ioT_metamodel_Sensor.attributes={ioT_metamodel_Sensor_State, ioT_metamodel_Sensor_Name, ioT_metamodel_Sensor_frequency}
...
ioT_metamodel_DataStreamAttributes.attributes={ioT_metamodel_DataStreamAttributes_Timestamp, ioT_metamodel_DataStreamAttributes_DataFormat, ioT_metamodel_DataStreamAttributes_MaxBitrate, ioT_metamodel_DataStreamAttributes_MeanBitRate, ioT_metamodel_DataStreamAttributes_DeviceID, ioT_metamodel_DataStreamAttributes_DataEncoding, ioT_metamodel_DataStreamAttributes_Description}
...
domain_model = DomainModel(
    name="ioT_metamodel",
    types={ioT_metamodel_Thing, Entity, ioT_metamodel_VirtualThing, ioT_metamodel_Fog, ioT_metamodel_PhysicalThing, ioT_metamodel_Property, Active_Digital_Artifact, Passive_Digital_Artifact, ioT_metamodel_InformationResource, ioT_metamodel_Device, ioT_metamodel_Authorizor, ioT_metamodel_VM, ioT_metamodel_Container, ioT_metamodel_Analytics_Engine, ioT_metamodel_Fog_Services, PhysicalThing, ioT_metamodel_Rule, ioT_metamodel_DeviceState, ioT_metamodel_Communicator, ioT_metamodel_On_Device_Resource, ioT_metamodel_Actuator, Device, ioT_metamodel_FogNode, ioT_metamodel_Cloud, ioT_metamodel_Database, ioT_metamodel_Sensor, ioT_metamodel_Action, ioT_metamodel_ExternalSensor, Sensor, ioT_metamodel_DeviceActuator, Actuator, ioT_metamodel_ExternalActuator, ioT_metamodel_CompositeState, DeviceState, ioT_metamodel_Transition, ioT_metamodel_Tag, ioT_metamodel_Human_User, ioT_metamodel_Port, ioT_metamodel_Information, ioT_metamodel_Attribute, InformationResource, ioT_metamodel_Device_Resource, ioT_metamodel_Service_Resource, ioT_metamodel_Network_Resource, ioT_metamodel_Digital_Artifact, ioT_metamodel_Active_Digital_Artifact, Digital_Artifact, User, ioT_metamodel_Passive_Digital_Artifact, ioT_metamodel_User, ioT_metamodel_Policy_Repository, ioT_metamodel_Reference_Monitor, ioT_metamodel_AtomicData, ioT_metamodel_DataStreams, ioT_metamodel_DataStreamAttributes, ioT_metamodel_AtomicDataAttributes, ioT_metamodel_Operations, ioT_metamodel_Evaluators, ioT_metamodel_JavaEvaluator, Evaluators, ioT_metamodel_Entity, ioT_metamodel_ScriptEvaluator, ioT_metamodel_DeviceSensor},
    associations={virtual_entity0, fog1, physical_entity2, contains5, property7, represents9, is_associated_with12, has14, database18, define_control_policies_to20, runs_on_vm21, runs_in_container23, analytics_engine25, associates_with27, is_attached_to29, contains31, has_rules32, devicestate34, has_communicators36, hosts38, request_service15, fognode16, request_cloud_service17, monitors47, observes49, involves52, sensor_actions54, actuator_actions56, actuator_actions58, action60, acts40, observes42, identifies45, subscribes_invokes68, has_ports70, has_information_about72, has75, has_attributes77, contains_device_resource79, contains_service_resource81, contains_device_resource83, contains_service_resource85, incoming_states62, outgoing_states65, policy_repository90, interacts_with92, contains93, orchestrate_policies95, enforces96, connects_with98, atomicdata100, datastreams102, consists_of104, has_datastreamattributes107, has_atomicdataattributes109, respond_to_fog88, runs_in111, invokes114, invokes_fog_services117, exposes119, is_connected_with122, points_to_processing_logic125, runs_in127, subscribes_to130, sensor_actions133},
    generalizations={gen_ioT_metamodel_Thing_Entity, gen_ioT_metamodel_VirtualThing_Active_Digital_Artifact, gen_ioT_metamodel_VirtualThing_Passive_Digital_Artifact, gen_ioT_metamodel_Device_PhysicalThing, gen_ioT_metamodel_Actuator_Device, gen_ioT_metamodel_Sensor_Device, gen_ioT_metamodel_ExternalSensor_Sensor, gen_ioT_metamodel_DeviceActuator_Actuator, gen_ioT_metamodel_ExternalActuator_Actuator, gen_ioT_metamodel_CompositeState_DeviceState, gen_ioT_metamodel_Tag_Device, gen_ioT_metamodel_Human_User_User, gen_ioT_metamodel_On_Device_Resource_InformationResource, gen_ioT_metamodel_Network_Resource_InformationResource, gen_ioT_metamodel_Active_Digital_Artifact_Digital_Artifact, gen_ioT_metamodel_Active_Digital_Artifact_User, gen_ioT_metamodel_Passive_Digital_Artifact_Digital_Artifact, gen_ioT_metamodel_User_Entity, gen_ioT_metamodel_JavaEvaluator_Evaluators, gen_ioT_metamodel_ScriptEvaluator_Evaluators, gen_ioT_metamodel_Attribute_Entity, gen_ioT_metamodel_DeviceSensor_Sensor},
    metadata=None
)
