...
# Classes
PetriNet_PetriNode = Class(name="PetriNet_PetriNode")
...
PetriNet_PetriModel = Class(name="PetriNet_PetriModel")
PetriNet_PetriEdge = Class(name="PetriNet_PetriEdge")
...
PetriNet_PetriModel.attributes={PetriNet_PetriModel_description, PetriNet_PetriModel_name}
...
domain_model = DomainModel(
    name="PetriNet",
    types={PetriNet_PetriNode, PetriModel, PetriNet_Place, PetriNode, PetriNet_Token, PetriNet_Transition, PetriNet_Arc, PetriEdge, PetriNet_PetriModel, PetriNet_PetriEdge},
    associations={token0, test1, petriFrom2, petriTo4, petriModels8},
    generalizations={gen_PetriNet_PetriNode_PetriModel, gen_PetriNet_Place_PetriNode, gen_PetriNet_Token_PetriNode, gen_PetriNet_Transition_PetriNode, gen_PetriNet_Arc_PetriEdge, gen_PetriNet_PetriEdge_PetriModel},
    metadata=None
)
