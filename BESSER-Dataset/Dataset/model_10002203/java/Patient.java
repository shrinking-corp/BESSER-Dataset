...
public class Patient  {
    ...
    public Patient(
        String nomPatient,        String prenomPatien,        String lieuResidence,        String profession,        int agePatient,        int numeroPatien    ) {
    ...
    public Patient(
        String nomPatient,        String prenomPatien,        String lieuResidence,        String profession,        int agePatient,        int numeroPatien        ArrayList<DossierPatient> dossierpatients    ) {
        this.nomPatient = nomPatient;
        this.prenomPatien = prenomPatien;
        this.lieuResidence = lieuResidence;
        this.profession = profession;
