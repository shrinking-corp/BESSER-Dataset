...
DossierPatient.attributes={DossierPatient_infoAntecedant, DossierPatient_nomDossier, DossierPatient_numeroPatient, DossierPatient_dateCreation, DossierPatient_heure}
...
Patient.attributes={Patient_agePatient, Patient_profession, Patient_prenomPatien, Patient_lieuResidence, Patient_numeroPatien, Patient_nomPatient}
...
Rendez_Vous.attributes={Rendez_Vous_numeroRdV, Rendez_Vous_dateRDV, Rendez_Vous_lieuRDV, Rendez_Vous_heure}
...
Consultion.attributes={Consultion_description, Consultion_numeroConsultation, Consultion_dateConsultation, Consultion_heure}
...
Examen.attributes={Examen_motif, Examen_dateProvisoir, Examen_heure, Examen_numeroExamen}
...
Medecin.attributes={Medecin_prenomMedecin, Medecin_dateNaissance, Medecin_nomMedecin, Medecin_numeroMedecin, Medecin_specialite}
...
Service.attributes={Service_numeroService, Service_descriptionService, Service_nomService}
...
Programme.attributes={Programme_numeroProgramme, Programme_heure, Programme_date}
...
CentreHospitalier.attributes={CentreHospitalier_descriptionCentre, CentreHospitalier_numeroCentre, CentreHospitalier_nomCentre}
...
ResultatExamen.attributes={ResultatExamen_numeroResultat, ResultatExamen_infoResultat}
...
domain_model = DomainModel(
    ...
    associations={Rendez_Vous_Consultion, Rendez_Vous_Examen, Rendez_Vous_Medecin, Programme_Medecin, Medecin_Service, Service_CentreHospitalier, Secretaire_ResultatExamen, ResultatExamen_Medecin, Patient_ResultatExamen, DossierPatient_Patient, Patient_Rendez_Vous},
    generalizations={},
    metadata=None
)
