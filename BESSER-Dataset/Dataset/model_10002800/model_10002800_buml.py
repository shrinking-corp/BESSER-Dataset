...
Doctor.attributes={Doctor_docid, Doctor_specialization, Doctor_department, Doctor_address, Doctor_name, Doctor_phno}
...
Patient.attributes={Patient_sex, Patient_telno, Patient_roomno, Patient_id, Patient_age, Patient_address, Patient_name}
...
domain_model = DomainModel(
    name="dc8d916a_ff57_4b94_a9ea_d46bdd3faa08",
    types={Doctor, Department, Patient, Room, Receptionist, Person, Bill, Staff, Nurse, Class_, Class1},
