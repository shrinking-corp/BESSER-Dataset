...
VisualInterface_Text = Class(name="VisualInterface_Text")
VisualInterface_Symbol = Class(name="VisualInterface_Symbol")
VisualInterface_Primitive = Class(name="VisualInterface_Primitive", is_abstract=True)
VisualInterface_StringToStringMap = Class(name="VisualInterface_StringToStringMap")
VisualInterface_Cursor = Class(name="VisualInterface_Cursor", is_abstract=True)
VisualInterface_Dimension = Class(name="VisualInterface_Dimension")
VisualInterface_Connection = Class(name="VisualInterface_Connection")
VisualInterface_Container = Class(name="VisualInterface_Container", is_abstract=True)
Primitive = Class(name="Primitive")
VisualInterface_Shape = Class(name="VisualInterface_Shape", is_abstract=True)
Figure = Class(name="Figure")
VisualInterface_Rectangle = Class(name="VisualInterface_Rectangle")
VisualInterface_Child = Class(name="VisualInterface_Child")
VisualInterface_XYChild = Class(name="VisualInterface_XYChild")
Child = Class(name="Child")
VisualInterface_Position = Class(name="VisualInterface_Position")
VisualInterface_XYContainer = Class(name="VisualInterface_XYContainer")
Container = Class(name="Container")
VisualInterface_Line = Class(name="VisualInterface_Line")
VisualInterface_Figure = Class(name="VisualInterface_Figure", is_abstract=True)
VisualInterface_GridChild = Class(name="VisualInterface_GridChild")
VisualInterface_SymbolReference = Class(name="VisualInterface_SymbolReference")
VisualInterface_SystemCursor = Class(name="VisualInterface_SystemCursor")
Cursor = Class(name="Cursor")
VisualInterface_GridContainer = Class(name="VisualInterface_GridContainer")
VisualInterface_BorderContainer = Class(name="VisualInterface_BorderContainer")
VisualInterface_BorderChild = Class(name="VisualInterface_BorderChild")
VisualInterface_FigureContainer = Class(name="VisualInterface_FigureContainer")
VisualInterface_Image = Class(name="VisualInterface_Image")
VisualInterface_Ellipse = Class(name="VisualInterface_Ellipse")
VisualInterface_Arc = Class(name="VisualInterface_Arc")
VisualInterface_StackContainer = Class(name="VisualInterface_StackContainer")
...
VisualInterface_Text.attributes={VisualInterface_Text_textAlignment, VisualInterface_Text_text, VisualInterface_Text_textPlacement, VisualInterface_Text_fontSize, VisualInterface_Text_fontBold, VisualInterface_Text_iconAlignment, VisualInterface_Text_fontItalic, VisualInterface_Text_fontName, VisualInterface_Text_labelAlignment}
...
VisualInterface_Symbol.attributes={VisualInterface_Symbol_scriptModules, VisualInterface_Symbol_backgroundColor, VisualInterface_Symbol_onDispose, VisualInterface_Symbol_onInit, VisualInterface_Symbol_onUpdate}
...
VisualInterface_StringToStringMap.attributes={VisualInterface_StringToStringMap_key, VisualInterface_StringToStringMap_value}
...
VisualInterface_Dimension.attributes={VisualInterface_Dimension_width, VisualInterface_Dimension_height}
...
VisualInterface_Shape.attributes={VisualInterface_Shape_alpha, VisualInterface_Shape_lineWidth, VisualInterface_Shape_outline, VisualInterface_Shape_antialias, VisualInterface_Shape_fill}
...
VisualInterface_Figure.attributes={VisualInterface_Figure_opaque, VisualInterface_Figure_onClick, VisualInterface_Figure_toolTip, VisualInterface_Figure_foregroundColor, VisualInterface_Figure_onDoubleClick, VisualInterface_Figure_visible, VisualInterface_Figure_backgroundColor, VisualInterface_Figure_border}
...
VisualInterface_SymbolReference.attributes={VisualInterface_SymbolReference_zoom, VisualInterface_SymbolReference_onCreateProperties, VisualInterface_SymbolReference_uri}
...
VisualInterface_GridContainer.attributes={VisualInterface_GridContainer_horizontalSpacing, VisualInterface_GridContainer_marginWidth, VisualInterface_GridContainer_verticalSpacing, VisualInterface_GridContainer_equalWidth, VisualInterface_GridContainer_columns, VisualInterface_GridContainer_marginHeight}
...
domain_model = DomainModel(
    ...
    types={Shape, VisualInterface_Text, VisualInterface_Symbol, VisualInterface_Primitive, VisualInterface_StringToStringMap, VisualInterface_Cursor, VisualInterface_Dimension, VisualInterface_Connection, VisualInterface_Container, Primitive, VisualInterface_Shape, Figure, VisualInterface_Rectangle, VisualInterface_Child, VisualInterface_XYChild, Child, VisualInterface_Position, VisualInterface_XYContainer, Container, VisualInterface_Line, VisualInterface_Figure, VisualInterface_GridChild, VisualInterface_SymbolReference, VisualInterface_SystemCursor, Cursor, VisualInterface_GridContainer, VisualInterface_BorderContainer, VisualInterface_BorderChild, VisualInterface_FigureContainer, VisualInterface_Image, VisualInterface_Ellipse, VisualInterface_Arc, VisualInterface_StackContainer, Alignment, Orientation, SystemCursorType, GridAlignment},
    associations={root0, properties1, cursors3, designSize5, connections7, size19, element9, position11, dimension12, children15, points17, children26, cursor21, properties24, start30, children27, content28, end33, children36},
    generalizations={gen_VisualInterface_Rectangle_Shape, gen_VisualInterface_Text_Figure, gen_VisualInterface_Container_Primitive, gen_VisualInterface_Shape_Figure, gen_VisualInterface_XYChild_Child, gen_VisualInterface_XYContainer_Container, gen_VisualInterface_Line_Shape, gen_VisualInterface_Figure_Primitive, gen_VisualInterface_SymbolReference_Primitive, gen_VisualInterface_SystemCursor_Cursor, gen_VisualInterface_GridContainer_Container, gen_VisualInterface_BorderContainer_Container, gen_VisualInterface_BorderChild_Child, gen_VisualInterface_GridChild_Child, gen_VisualInterface_FigureContainer_Figure, gen_VisualInterface_Image_Figure, gen_VisualInterface_Ellipse_Shape, gen_VisualInterface_Arc_Shape, gen_VisualInterface_StackContainer_Container},
    metadata=None
)
