...
class VisualInterface_Figure(Primitive):
    ...
    def __init__(self, onClick: str, onDoubleClick: str, foregroundColor: str, backgroundColor: str, visible: bool, border: str, opaque: str, toolTip: str, VisualInterface_Figure: "VisualInterface_Dimension" = None, VisualInterface_Figure22: "VisualInterface_Cursor" = None):
...
class VisualInterface_StringToStringMap:
    ...
    def __init__(self, key: str, value: str, VisualInterface_StringToStringMap25: "VisualInterface_SymbolReference" = None, VisualInterface_StringToStringMap: "VisualInterface_Symbol" = None):
        self.key = key
        self.value = value
...
class VisualInterface_Primitive(ABC):
    ...
    def __init__(self, name: str, VisualInterface_Primitive32: "VisualInterface_Connection" = None, VisualInterface_Primitive29: "VisualInterface_FigureContainer" = None, VisualInterface_Primitive35: "VisualInterface_Connection" = None, VisualInterface_Primitive37: "VisualInterface_StackContainer" = None, VisualInterface_Primitive: "VisualInterface_Symbol" = None, VisualInterface_Primitive10: "VisualInterface_Child" = None):
        self.name = name
